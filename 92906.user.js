// ==UserScript==
// @name           KoC Gift Acceptor for Arondight244
// @version        1.0
// @namespace      KoC-AutoAcceptGifts
// @homepage       http://userscripts.org/
// @description    This script will automatically accept all of your Kingdoms of Camelot gifts in your Facebook Game Requests for domain named.
				...
				if(claim_gift){
					...
					if(domain_selector && (next_button1 || next_button2)){
						for(var i=0; i<domain_selector.options.length; i++){
							if(domain_selector.options[i].value == "244"){
