// ==UserScript==
// @name           Accepteur de Cadeaux - Caliburn197
// @version        0.1
// @namespace      KOCQuickWidgets-AutoAcceptGifts
// @homepage       http://userscripts.org/
// @description    Ce Script Vous Aide A Accepter Vos Cadeaux Dans KOC
...
// @require        http://sizzlemctwizzle.com/updater.php?id=100381
// ==/UserScript==
				...
				if(claim_gift){
					...
					if(domain_selector && (next_button1 || next_button2)){
						for(var i=0; i<domain_selector.options.length; i++){
							if(domain_selector.options[i].value == "197"){
