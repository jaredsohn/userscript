...
var s = document.getElementsByTagName('script');
  ...
  if (is_panel) {
      ...
      unsafeWindow.panels.push('odds');
      unsafeWindow.panelnames.push('Assault Odds');
      var loadValue = GM_getValue("oddsLoc");
      if(typeof(loadValue) != "undefined") {
          cMode=loadValue;
      }
      unsafeWindow.myOptions.panels[unsafeWindow.panels.indexOf('odds')]=["odds",cMode];
  }
  else {
  ...
  if (is_panel) {
      if (is_FF) {
          ...
          unsafeWindow.updatePanels = function() {
              var cMode = unsafeWindow.myOptions.panels[unsafeWindow.panels.indexOf('odds')][1];
              setTimeout(function() {
      ...
      (function() {
          ...
          this.updatePanels = function() {
              ...
              GM_setValue("oddsLoc",unsafeWindow.myOptions.panels[unsafeWindow.panels.indexOf('odds')][1]);
          };
      })();
      }
