...
function addPreferences(){
    var titDiv = matchNode('//div[@class="nv"]').snapshotItem(0);
    if(titDiv){
...
//    var resTables = matchNode('//table[tbody/tr/td/@class="f"][not(descendant::a[text() = "推广"])]', doc);
    var resTables = matchNode('//table[floor(@id div 1) = ceiling(@id div 1) or tbody/tr/td/@class="f"][not(descendant::a[text() = "推广"])]', doc);
