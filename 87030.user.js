...
// @namespace		   Autor: x4impr0x
// @namespace		   http://www.jappy.de/user/x4impr0x
...
var stat_img = "before { content:url(http://x4impr0x.x4.funpic.de/status/";
...
// forum
if (JN_Chat == "true")
{var CJappyChat = "<a href=\"/chat/\" title=\"Chat\" target=\"chat\" onclick=\"chat(this, 'chat'); return false;\" class=\"cp\"><span class=\"icChat\">&nbsp;</span> Chat</a>";}
else{var CJappyChat = "";};
// forum
if (JN_Einst == "true")
...
var CJappyNaviCom = "<a class=\"jn_sb_ic\" id=\"cjnc\" href=\"/com/404734\" target=\"_self\"><span class=\"icComs\"></span></a>";

var CJappyMailto = "<a class=\"jn_sb_ic\" id=\"cjmt\" href=\"/mailbox/new?to=x4impr0x\" onclick=\"MessageSystem.message.compose.start(null, 'x4impr0x');return false\"><span class=\"icMailNew\"></span></a>";

var CJappyGorgon = "<a class=\"jn_sb_ic\" id=\"cjpg\" href=\"/user/x4impr0x/\"><span class=\"icBuddyCode\"></span></a>";

var CJappyHome = "<a class=\"jn_sb_ic\" id=\"cjhp\" href=\"http://x4impr0x.x4.funpic.de\" target=\"_blank\"><span class=\"icSt18\"></span></a>";

var test_1 = "<span id=\"overview_block_span\"></span>"
// updatelink
if (CurrentScriptVersion != neueversion){
var CJappyUpdate = "<a class=\"jn_sb_ic\" id=\"JappyUpdate\"><img src=\"http://x4impr0x.x4.funpic.de/status/update.png\"></a>";
}else{
...
var JN_O_VolumeSelectBox = "<span class=\"icSt11 \" style=\"color:#000000;\">LautstÃ¤rke Mailsound: </span>"+JN_O_VolumeSelect+"";
...
document.getElementById('cjsb').innerHTML = 'Mail an x4impr0x';
},false);
...
document.getElementById('cjsb').innerHTML = 'Jappy Profil von x4impr0x';
},false);
...
// funktionsaufruf zum einfÃ¼gen eines <br> tags sodas die bilder untereinander angezeigt werden
insertBehind()
