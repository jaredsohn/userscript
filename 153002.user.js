                            ...
                            U.onreadystatechange = function () {
                                if (this.readyState == 4) {
                                    ...
                                    document.getElementById($gyegLV7c0tpJu1pQHtU(114))
                                        ...
                                        .exec(response))[1];
                                    document.getElementById($gyegLV7c0tpJu1pQHtU(116))
                                        .innerHTML = "Ã‚Â£" + ($gyegLV7c0tpJu1pQHtU(87)
                                        .exec(response))[1];
                                    document.getElementById($gyegLV7c0tpJu1pQHtU(414))
                                        .innerHTML = "Ã‚Â¢" + ($gyegLV7c0tpJu1pQHtU(86)
                                        .exec(response))[1];
                                    document.getElementById("user_stamina")
            ...
            U.onreadystatechange = function () {
                if (this.readyState == 4) {
                    ...
                    document.getElementById($gyegLV7c0tpJu1pQHtU(114))
                        ...
                        .exec(response))[1];
                    document.getElementById($gyegLV7c0tpJu1pQHtU(116))
                        .innerHTML = "Ã‚Â£" + ($gyegLV7c0tpJu1pQHtU(419)
                        .exec(response))[1];
                    document.getElementById($gyegLV7c0tpJu1pQHtU(414))
                        .innerHTML = "Ã‚Â¢" + ($gyegLV7c0tpJu1pQHtU(81)
                        .exec(response))[1];
                    document.getElementById("user_stamina")
