// ==UserScript==
// @name           MUSIK DOWNLOADER - 4SHARED
// @namespace      MUSIK PANGLIMA
// @include        http://*.4shared.com/*
// @description    otomatis download MUSIK di 4shared
// ==/UserScript==
...
for (var i = 0; i < tr.length; i++) {
    if (tr[i].getAttribute('valign') == 'top' && tr[i].getElementsByTagName('h1')[0] !== undefined && tr[i].getElementsByClassName("playThumb")[0] !== undefined && !tr[i].innerHTML.match('Accerelated')) {
        ...
        tr[i].getElementsByClassName('fsize')[0].innerHTML += '<h4><a href="' + url2 + '" title="Download lambat...">Download</a><br /><br /><a href="' + url + '" title="Gunakan IDM">- IDM -</a></h4>';
    }
}
