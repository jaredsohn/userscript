// ==UserScript==
// @name            DeviantART AD Remover (j2o)
// @namespace       Remove adverts in view page
// @description     Removes some DeviantART adverts
...
erase_it(window.document,document.getElementById('ad-blocking-makes-fella-sad'),null,null,null);
erase_it(window.document,document.getElementById('adso-magnifico'),null,null,null);
