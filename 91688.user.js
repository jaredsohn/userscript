...
// ==UserScript==
// @name           OnBux Manager with ID
// @require        http://ajax.googleapis.com/ajax/libs/jquery/1.3.2/jquery.min.js
// @require        http://userscripts.org/scripts/source/45988.user.js
// @namespace      www.onbux.dtwpt.com
// @description    Aggiunge delle informazioni riguardanti tutti i referenti
// @include        http://www.onbux.com/rented*
// @include        http://www.onbux.com/direct* http://www.onbux.com/*
// @include        http://www.onbux.com/*
// ==/UserScript==

USP.theScriptName = 'Onbux Manager';
USP.init({theName:'member', theText:'Tipo di conto?', 
          theValues:['Pioneer','Standard','Golden','Ultimate'], theDefault:'Standard'},
          {theName:'lang', theText:'Lingua?', 
          theValues:['PT','EN','ID'], theDefault:'ID'},
          {theName:'reciclagem', theText:'Calcola il guadagno conpresi i costi di riciclaggio:', theDefault:false},
          {theName:'renovar', theText:'Calcola il guadagno comprei i cosyi di rinnovo:', theDefault:false},
          {theName:'trenovar', theText:'Periodo rinnivi:', theDefault:30}

    );
GM_registerMenuCommand('Impostazioni per '+USP.theScriptName+'~', USP.invoke);
...
// -> O script corre nas duas linguas Portugues e Inglês(vou tentar adicionar mais em breve)
  ID : {
    ...
    'Golden': 'Golden',
    'Ultimate': 'Ultimate',
    'clickedtoday': 'Klik hari ini:',
    'clickedyesterday': 'Klik kemarin:',
    'neverclicked': 'Tidak pernah klik:',
    'tclicks': 'Jumlah klik:',
    'average': 'Rata - rata',
    'profit': 'Pendapatan',
    'timeago': 'Hari yang lalu',
  },
  ...
  EN : {
    ...
    'Golden': 'Golden',
    'Ultimate': 'Ultimate',
    'clickedtoday': 'Cliked Today:',
    'clickedyesterday': 'Cliked yesterday:',
    'neverclicked': 'Never click :',
  ...
  PT : {
    ...
    'clickedyesterday': 'Clik di ieri:',
    'neverclicked': 'Mai cliccato:',
    'tclicks': 'Clik totali:',
    'average': 'Media clik',
    'profit': 'Guadagno',
    'timeago': 'Giorni fà',
...
function localString(key,text) 
{
  ...
  else if('undefined' !== typeof onbuxLangStrings['it']) 
  {
