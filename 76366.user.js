...
// @exclude			http://*.die-staemme.de/game.php?*screen=overview_villages*
// ==/UserScript==
...
// 1.1.0: - Script-Regestrierung eingebaut
...
(function __DSRenameIncsInOverview() {
	...
	win.ScriptAPI.register('DSRenameTroupmovingsInOverview', 7.4, 'Heinzelmänchen', 'Heinzelmänchen@scripter.die-staemme.de');
