// ==UserScript==
// @name           Troll Emoticons Koaten's Edition - Firefox/Safari Version
// @namespace      http://thinqtek.com/
// @description    Use meme emoticons on popular websites! Unoffial version.
// @include        *
// @version        b2.1.10
// ==/UserScript==
			...
			//.replace(/:trollface:/g, "<style> .md img { display:inline; } .rageface { visibility:visible; } </style><img src=\'http://gbatemp.net/pix/183895/TrollFace.png\' title='There isn't a command here, problem?' />")
			...
			//Koaten's Scripts
			.replace(/:rainbowdashtwintowers:/g, "<style> .md img { display:inline; } .rageface { visibility:visible; } </style><img class='rageface' src=\'http://i1117.photobucket.com/albums/k585/Koaten2/rainbowdash911UMAD.jpg' /></div>")
			.replace(/:sovietmudkip:/g, "<style> .md img { display:inline; } .rageface { visibility:visible; } </style><img class='rageface' src=\'http://i1117.photobucket.com/albums/k585/Koaten2/sovietmudkip.jpg' /></div>")
			.replace(/:mustnotfap:/g, "<style> .md img { display:inline; } .rageface { visibility:visible; } </style><img class='rageface' src=\'http://media.ebaumsworld.com/mediaFiles/picture/120821/81102076.jpg' /></div>")
			.replace(/:facepaw:/g, "<style> .md img { display:inline; } .rageface { visibility:visible; } </style><img class='rageface' src=\'http://i1117.photobucket.com/albums/k585/Koaten2/facepaw-1.gif' /></div>")
			.replace(/:furryfapfapfap:/g, "<style> .md img { display:inline; } .rageface { visibility:visible; } </style><img class='rageface' src=\'http://i1117.photobucket.com/albums/k585/Koaten2/index-1.jpg' /></div>")
			.replace(/:heavyyes:/g, "<style> .md img { display:inline; } .rageface { visibility:visible; } </style><img class='rageface' src=\'http://i1117.photobucket.com/albums/k585/Koaten2/TF2YES.png' /></div>")
			.replace(/:Grammar-Time:/g, "<style> .md img { display:inline; } .rageface { visibility:visible; } </style><img class='rageface' src=\'http://t0.gstatic.com/images?q=tbn:ANd9GcSyo42trh8gsSDEckmZsbupdYxBUkkI-h4bZntxGDEXxRSAh8Q94w' /></div>")
			.replace(/:grammartime:/g, "<style> .md img { display:inline; } .rageface { visibility:visible; } </style><img class='rageface' src=\'http://t0.gstatic.com/images?q=tbn:ANd9GcSyo42trh8gsSDEckmZsbupdYxBUkkI-h4bZntxGDEXxRSAh8Q94w' /></div>")
			.replace(/:noexcuses:/g, "<style> .md img { display:inline; } .rageface { visibility:visible; } </style><img class='rageface' src=\'http://images.suite101.com/552528_com_noexcuses.jpg'/></div>")
			.replace(/:fuckthepolice:/g, "<style> .md img { display:inline; } .rageface { visibility:visible; } </style><img class='rageface' src=\'http://profile.ak.fbcdn.net/hprofile-ak-snc4/41590_319033922377_821987_q.jpg'/></div>")
			
			//Restoration Scripts 
			.replace(/:thumbsup:/g, "<style> .md img { display:inline; } .rageface { visibility:visible; } </style><img src=\'http://25851744656936.webs.com/memes/thumbsup.png\' title='thumbsup' />")
			.replace(/:challengeaccepted:/g, "<style> .md img { display:inline; } .rageface { visibility:visible; } </style><img src=\'http://25851744656936.webs.com/memes/challengeaccepted.png\' title='challengeaccepted' />")
			.replace(/:staredad:/g, "<style> .md img { display:inline; } .rageface { visibility:visible; } </style><img src=\'http://25851744656936.webs.com/memes/staredad.png\' title='staredad' />")
			.replace(/:iamdisappoint:/g, "<style> .md img { display:inline; } .rageface { visibility:visible; } </style><img src=\'http://25851744656936.webs.com/memes/imdisapointed.png\' title='iamdisappoint' />")
			.replace(/:hmmm:/g, "<style> .md img { display:inline; } .rageface { visibility:visible; } </style><img src=\'http://25851744656936.webs.com/memes/hmmm.png\' alt='=hmmm' />")
			.replace(/:grin:/g, "<style> .md img { display:inline; } .rageface { visibility:visible; } </style><img src=\'http://25851744656936.webs.com/memes/grin.png\' title='grin' />")
			.replace(/:troll:/g, "<style> .md img { display:inline; } .rageface { visibility:visible; } </style><img src=\'http://25851744656936.webs.com/memes/trollface.png\' title='There isn't a command here, problem?' />")
			.replace(/:trollface:/g, "<style> .md img { display:inline; } .rageface { visibility:visible; } </style><img src=\'http://25851744656936.webs.com/memes/trollface.png\' title='There isn't a command here, problem?' />")
			.replace(/:trollani:/g, "<style> .md img { display:inline; } .rageface { visibility:visible; } </style><img src=\'http://25851744656936.webs.com/memes/trollanim.gif\' title='trollani' />")
			.replace(/:trolldance:/g, "<style> .md img { display:inline; } .rageface { visibility:visible; } </style><img src=\'http://25851744656936.webs.com/memes/trolldance.gif\' title='trolldance' />")
			.replace(/:areufuckingkiddingme:/g, "<style> .md img { display:inline; } .rageface { visibility:visible; } </style><img src=\'http://25851744656936.webs.com/memes/areufuckingkiddingme.png\' title='areufuckingkiddingme' />")
			.replace(/:awesome:/g, "<style> .md img { display:inline; } .rageface { visibility:visible; } </style><img src=\'http://25851744656936.webs.com/memes/awesome.png\' title='awesome' />")
			.replace(/:awwyea:/g, "<style> .md img { display:inline; } .rageface { visibility:visible; } </style><img src=\'http://25851744656936.webs.com/memes/awwyea.png\' title='awwyea' />")
			.replace(/:happy:/g, "<style> .md img { display:inline; } .rageface { visibility:visible; } </style><img src=\'http://25851744656936.webs.com/memes/blessed.png\' title='happy' />")
			.replace(/:boring:/g, "<style> .md img { display:inline; } .rageface { visibility:visible; } </style><img src=\'http://25851744656936.webs.com/memes/boring.png\' alt='boring' />")
			.replace(/:cerealguy:/g, "<style> .md img { display:inline; } .rageface { visibility:visible; } </style><img src=\'http://25851744656936.webs.com/memes/cerealguy.png\' title='cerealguy' />")
			.replace(/:cry:/g, "<style> .md img { display:inline; } .rageface { visibility:visible; } </style><img src=\'http://25851744656936.webs.com/memes/cry.png\' title='cry' />")
			.replace(/:cryhappy:/g, "<style> .md img { display:inline; } .rageface { visibility:visible; } </style><img src=\'http://25851744656936.webs.com/memes/cryhappy.png\' title='cryhappy' />")
			.replace(/:fapfapfap:/g, "<style> .md img { display:inline; } .rageface { visibility:visible; } </style><img src=\'http://25851744656936.webs.com/memes/fapfapfap.png\' title='fapfapfap' />")
			.replace(/:feellikeaninja:/g, "<style> .md img { display:inline; } .rageface { visibility:visible; } </style><img src=\'http://25851744656936.webs.com/memes/feellikeaninja.png\' title='feellikeaninja' />")
			.replace(/:feellikeasir:/g, "<style> .md img { display:inline; } .rageface { visibility:visible; } </style><img src=\'http://25851744656936.webs.com/memes/feellikeasir.png\' title='feellikeasir' />")
			.replace(/:foreveralone:/g, "<style> .md img { display:inline; } .rageface { visibility:visible; } </style><img src=\'http://25851744656936.webs.com/memes/foreveralone.png\' title='foreveralone' />")
			.replace(/:foreveralonehappy:/g, "<style> .md img { display:inline; } .rageface { visibility:visible; } </style><img src=\'http://25851744656936.webs.com/memes/foreveralonehappy.png\' title='foreveralonehappy' />")
			.replace(/:friki:/g, "<style> .md img { display:inline; } .rageface { visibility:visible; } </style><img src=\'http://25851744656936.webs.com/memes/friki.png\' title='friki' />")
			.replace(/:fry:/g, "<style> .md img { display:inline; } .rageface { visibility:visible; } </style><img src=\'http://25851744656936.webs.com/memes/fry.png\' title='fry' />")
			.replace(/:fua:/g, "<style> .md img { display:inline; } .rageface { visibility:visible; } </style><img src=\'http://25851744656936.webs.com/memes/fua.png\' title='fua' />")
			.replace(/:fuckyea:/g, "<style> .md img { display:inline; } .rageface { visibility:visible; } </style><img src=\'http://25851744656936.webs.com/memes/fuckyea.png\' title='fuckyea' />")
			.replace(/:fuu:/g, "<style> .md img { display:inline; } .rageface { visibility:visible; } </style><img src=\'http://25851744656936.webs.com/memes/fuu.png\' title='fuu' />")
			.replace(/:girlfap:/g, "<style> .md img { display:inline; } .rageface { visibility:visible; } </style><img src=\'http://25851744656936.webs.com/memes/girlfap.png\' title='girlfap' />")
			.replace(/:girlfuckyea:/g, "<style> .md img { display:inline; } .rageface { visibility:visible; } </style><img src=\'http://25851744656936.webs.com/memes/girlfuckyea.png\' title='girlfuckyea' />")
			.replace(/:girlhappy:/g, "<style> .md img { display:inline; } .rageface { visibility:visible; } </style><img src=\'http://25851744656936.webs.com/memes/girlhappy.png\' title='girlhappy' />")
			.replace(/:girlhappy2:/g, "<style> .md img { display:inline; } .rageface { visibility:visible; } </style><img src=\'http://25851744656936.webs.com/memes/girlhappy2.png\' title='girlhappy2' />")
			.replace(/:girlrage:/g, "<style> .md img { display:inline; } .rageface { visibility:visible; } </style><img src=\'http://25851744656936.webs.com/memes/girlmad.png\' title='girlrage' />")
			.replace(/:girlmegusta:/g, "<style> .md img { display:inline; } .rageface { visibility:visible; } </style><img src=\'http://25851744656936.webs.com/memes/girlmegusta.png\' title='girlmegusta' />")
			.replace(/:girltroll:/g, "<style> .md img { display:inline; } .rageface { visibility:visible; } </style><img src=\'http://25851744656936.webs.com/memes/girltroll.png\' title='girltroll' />")
			.replace(/:girlmad:/g, "<style> .md img { display:inline; } .rageface { visibility:visible; } </style><img src=\'http://25851744656936.webs.com/memes/girlunhappy.png\' title='girlmad' />")
			.replace(/:girlwait:/g, "<style> .md img { display:inline; } .rageface { visibility:visible; } </style><img src=\'http://25851744656936.webs.com/memes/girlwait.png\' title='girlwait' />")
			.replace(/:girlyaoming:/g, "<style> .md img { display:inline; } .rageface { visibility:visible; } </style><img src=\'http://25851744656936.webs.com/memes/girlyaoming.png\' title='girlyaoming' />")
			.replace(/:gtfo:/g, "<style> .md img { display:inline; } .rageface { visibility:visible; } </style><img src=\'http://25851744656936.webs.com/memes/gtfo.png\' title='gtfo' />")
			.replace(/:inglip:/g, "<style> .md img { display:inline; } .rageface { visibility:visible; } </style><img src=\'http://25851744656936.webs.com/memes/inglip.png\' title='inglip' />")
			.replace(/:itsfree:/g, "<style> .md img { display:inline; } .rageface { visibility:visible; } </style><img src=\'http://25851744656936.webs.com/memes/itsfree.png\' title='itsfree' />")
			.replace(/:itssomething:/g, "<style> .md img { display:inline; } .rageface { visibility:visible; } </style><img src=\'http://25851744656936.webs.com/memes/itssomething.png\' title='itssomething' />")
			.replace(/:jelly:/g, "<style> .md img { display:inline; } .rageface { visibility:visible; } </style><img src=\'http://25851744656936.webs.com/memes/jelly.png\' title='jelly' />")
			.replace(/:lied:/g, "<style> .md img { display:inline; } .rageface { visibility:visible; } </style><img src=\'http://25851744656936.webs.com/memes/lied.png\' title='lied' />")
			.replace(/:lol:/g, "<style> .md img { display:inline; } .rageface { visibility:visible; } </style><img src=\'http://25851744656936.webs.com/memes/lol.png\' title='lol' />")
			.replace(/:megusta:/g, "<style> .md img { display:inline; } .rageface { visibility:visible; } </style><img src=\'http://25851744656936.webs.com/memes/megusta.png\' title='megusta' />")
			.replace(/:mentira:/g, "<style> .md img { display:inline; } .rageface { visibility:visible; } </style><img src=\'http://25851744656936.webs.com/memes/mentira.png\' title='mentira' />")
			.replace(/:miradafija:/g, "<style> .md img { display:inline; } .rageface { visibility:visible; } </style><img src=\'http://25851744656936.webs.com/memes/miradafija.png\' title='miradafija' />")
			.replace(/:motherofgod:/g, "<style> .md img { display:inline; } .rageface { visibility:visible; } </style><img src=\'http://25851744656936.webs.com/memes/motherofgod.png\' title='motherofgod' />")
			.replace(/:nervious:/g, "<style> .md img { display:inline; } .rageface { visibility:visible; } </style><img src=\'http://25851744656936.webs.com/memes/nervious.png\' title='nervious' />")
			.replace(/:no:/g, "<style> .md img { display:inline; } .rageface { visibility:visible; } </style><img src=\'http://25851744656936.webs.com/memes/no.png\' title='no' />")
			.replace(/:nothingtodohere:/g, "<style> .md img { display:inline; } .rageface { visibility:visible; } </style><img src=\'http://25851744656936.webs.com/memes/nothingtodohere.png\' title='nothingtodohere' />")
			.replace(/:okay:/g, "<style> .md img { display:inline; } .rageface { visibility:visible; } </style><img src=\'http://25851744656936.webs.com/memes/okay.png\' title='okay' />")
			.replace(/:omg:/g, "<style> .md img { display:inline; } .rageface { visibility:visible; } </style><img src=\'http://25851744656936.webs.com/memes/omg.png\' title='omg' />")
			.replace(/:pcguy:/g, "<style> .md img { display:inline; } .rageface { visibility:visible; } </style><img src=\'http://25851744656936.webs.com/memes/pc-guy.png\' title='pcguy' />")
			.replace(/:pedobear:/g, "<style> .md img { display:inline; } .rageface { visibility:visible; } </style><img src=\'http://25851744656936.webs.com/memes/pedobear.png\' title='pedobear' />")
			.replace(/:pfft:/g, "<style> .md img { display:inline; } .rageface { visibility:visible; } </style><img src=\'http://25851744656936.webs.com/memes/pfft.png\' title='pfft' />")
			.replace(/:pokerface:/g, "<style> .md img { display:inline; } .rageface { visibility:visible; } </style><img src=\'http://25851744656936.webs.com/memes/pokerface.png\' title='pokerface' />")
			.replace(/:pukerainbows:/g, "<style> .md img { display:inline; } .rageface { visibility:visible; } </style><img src=\'http://25851744656936.webs.com/memes/pukerainbows.png\' title='pukerainbows' />")
			.replace(/:serious:/g, "<style> .md img { display:inline; } .rageface { visibility:visible; } </style><img src=\'http://25851744656936.webs.com/memes/serious.png\' title='serious' />")
			.replace(/:siclaro:/g, "<style> .md img { display:inline; } .rageface { visibility:visible; } </style><img src=\'http://25851744656936.webs.com/memes/siclaro.png\' title='siclaro' />")
			.replace(/:suspicious:/g, "<style> .md img { display:inline; } .rageface { visibility:visible; } </style><img src=\'http://25851744656936.webs.com/memes/suspicious.png\' title='suspicious' />")
			.replace(/:sweetjesus:/g, "<style> .md img { display:inline; } .rageface { visibility:visible; } </style><img src=\'http://25851744656936.webs.com/memes/sweetjesus.png\' title='sweetjesus' />")
			.replace(/:thinking:/g, "<style> .md img { display:inline; } .rageface { visibility:visible; } </style><img src=\'http://25851744656936.webs.com/memes/thinking.png\' title='thinking' />")
			.replace(/:truestory:/g, "<style> .md img { display:inline; } .rageface { visibility:visible; } </style><img src=\'http://25851744656936.webs.com/memes/truestory.png\' title='truestory' />")
			.replace(/:why:/g, "<style> .md img { display:inline; } .rageface { visibility:visible; } </style><img src=\'http://25851744656936.webs.com/memes/why.png\' title='why' />")
			.replace(/:whynot:/g, "<style> .md img { display:inline; } .rageface { visibility:visible; } </style><img src=\'http://25851744656936.webs.com/memes/whynot.png\' title='whynot' />")
			.replace(/:yuno:/g, "<style> .md img { display:inline; } .rageface { visibility:visible; } </style><img src=\'http://25851744656936.webs.com/memes/yuno.png\' title='yuno' />")
			.replace(/:zomg:/g, "<style> .md img { display:inline; } .rageface { visibility:visible; } </style><img src=\'http://25851744656936.webs.com/memes/zomg.png\' title='zomg' />")
			.replace(/:infinitodesprecio:/g, "<style> .md img { display:inline; } .rageface { visibility:visible; } </style><img src=\'http://25851744656936.webs.com/memes/infinitodesprecio.png\' title='infinitodesprecio' />")
			.replace(/:foreverchacalone:/g, "<style> .md img { display:inline; } .rageface { visibility:visible; } </style><img src=\'http://25851744656936.webs.com/memes/foreverchacalone.png\' title='foreverchacalone' />")
			.replace(/:drunk:/g, "<style> .md img { display:inline; } .rageface { visibility:visible; } </style><img src=\'http://25851744656936.webs.com/memes/drunk.png\' title='drunk' />")
			.replace(/:nomegusta:/g, "<style> .md img { display:inline; } .rageface { visibility:visible; } </style><img src=\'http://25851744656936.webs.com/memes/nomegusta.png\' title='nomegusta' />")
			.replace(/:sad:/g, "<style> .md img { display:inline; } .rageface { visibility:visible; } </style><img src=\'http://25851744656936.webs.com/memes/sad.png\' title='sad' />")
			.replace(/:nyancat:/g, "<style> .md img { display:inline; } .rageface { visibility:visible; } </style><img src=\'http://25851744656936.webs.com/memes/nyancat.gif\' title='nyancat' />")
			.replace(/:sohardcore:/g, "<style> .md img { display:inline; } .rageface { visibility:visible; } </style><img src=\'http://25851744656936.webs.com/memes/sohardcore.png\' title='sohardcore' />")
			.replace(/:trollslap:/g, "<style> .md img { display:inline; } .rageface { visibility:visible; } </style><img src=\'http://25851744656936.webs.com/memes/trollslap.gif\' title='trollslape' />")
			.replace(/:rageanim:/g, "<style> .md img { display:inline; } .rageface { visibility:visible; } </style><img src=\'http://25851744656936.webs.com/memes/rageanim.gif\' title='rageanim' />")
			.replace(/:lmao:/g, "<style> .md img { display:inline; } .rageface { visibility:visible; } </style><img src=\'http://25851744656936.webs.com/memes/rofl.gif\' title='lmao' />")
			.replace(/:foreveralonedance:/g, "<style> .md img { display:inline; } .rageface { visibility:visible; } </style><img src=\'http://25851744656936.webs.com/memes/foreveralonedance.gif\' title='foreveralonedance' />")
			.replace(/:gaytroll:/g, "<style> .md img { display:inline; } .rageface { visibility:visible; } </style><img src=\'http://25851744656936.webs.com/memes/gaytroll.png\' title='gaytroll' />")
			.replace(/:facepalm:/g, "<style> .md img { display:inline; } .rageface { visibility:visible; } </style><img src=\'http://25851744656936.webs.com/memes/facepalm.png\' title='facepalm' />")
			
            .replace(/:pokerface:/g, "<img  src=\'http://i.min.us/icks2I.gif\' />")
			.replace(/:lol:/g, "<img  src=\'http://i.min.us/ick0Zo.gif\' />")	
			.replace(/:better:/g, "<img  src=\'http://i.min.us/icoPLK.gif\' />")
			.replace(/:foreveralone2:/g, "<img  src=\'http://i.min.us/ickO0E.gif\' />")
			.replace(/:itsomething:/g, "<img  src=\'http://i.min.us/ickQ8M.gif\' />")
			.replace(/:kiddingme:/g, "<img  src=\'http://i.min.us/icpnnk.gif\' />")
			.replace(/:motherofgod:/g, "<img  src=\'http://i.minus.com/iB30iOKJj1597.gif\' />")
			.replace(/:sospechoso:/g, "<img  src=\'http://i.minus.com/ibi8ox6dLuKsMp.gif\' />")
			.replace(/:yuno:/g, "<img  src=\'http://i.minus.com/i98TbHVXtZNr0.gif\' ")
			.replace(/:mentira:/g, "<img  src=\'http://i.minus.com/ibwwnu6hLDdnrN.gif\' />")
			.replace(/:inglip:/g, "<img  src=\'http://i.minus.com/ihJ1C4fzUnHt3.gif\' />")
			.replace(/:megusta:/g, "<img  src=\'http://i.minus.com/ibwjBi7nHsxcQD.gif\' />")	
			.replace(/:trolldad:/g, "<img  src=\'http://i.minus.com/ibmuNwfa6f6h9Y.gif\' />")
			.replace(/:whynot:/g, "<img  src=\'http://i.minus.com/ihJEO7RBcqQmK.gif\' />")
			.replace(/:yaoming:/g, "<img  src=\'http://i.minus.com/iy0YcL1H9nepC.gif\' />")
			.replace(/:pukerainbowns:/g, "<img  src=\'http://i.minus.com/itjCs923SsYhZ.gif\' />")
			.replace(/:ohgod:/g, "<img  src=\'http://i.minus.com/i0Nd3BBjTDESI.gif\' />")
			.replace(/:infinitodesprecio:/g, "<img  src=\'http://i.minus.com/i2RLKoO9mnxEs.gif\' />")
			.replace(/:itsfree:/g, "<img  src=\'http://i.minus.com/ibaolvVPF8nYqv.gif\' />")
			.replace(/:no:/g, "<img  src=\'http://i.minus.com/ibcoghHWFh8ULC.gif\' />")
			.replace(/:notbad:/g, "<img  src=\'http://i.minus.com/iI0hfiE5UTZ6z.gif\' />")
			.replace(/:nothingtodohere:/g, "<img  src=\'http://i.minus.com/ibkLxJCOWKqb7m.gif\' />")
			.replace(/:okay:/g, "<img  src=\'http://i.minus.com/i2S9RTyoHRg6e.gif\' />")
			.replace(/:venganza:/g, "<img  src=\'http://i.minus.com/igZCIWlQ1P2A5.gif\' />")
			.replace(/:siclaro:/g, "<img  src=\'http://i.minus.com/ibweUPAdHfi415.gif\' />")
			.replace(/:thefuck:/g, "<img  src=\'http://i.minus.com/ibpTjZCAil19BI.gif\' />")
