...
if( !done ) {
  if( location.pathname.match( 'publish-confirmation.g' ) ) {
    ...
    moveTagsToHeader();
    setTimeout(function(){$('titles').style.position = 'static';}, 500);
    setTimeout(function(){$('titles').style.position = 'static';}, 1000);
    setTimeout(function(){$('titles').style.position = 'static';}, 2000);
