// ==UserScript==
// @name        Konfigurasi Halaman Facebook
// @namespace   Edit Halaman Facebook
// @description Mengatur sendiri fungsi dan system halaman dari Facebook dengan program ini, Versi Indonesia dari Costumizable Express
...
// Last edited 2011-1-20

/*

This copyright section and all credits in the script must be included in modifications or redistributions of this script.

Rui Fujiwara Viewer is Copyright (c) 2011, Rui Fujiwara
Rui Fujiwara Viewer is licensed under a Creative Commons Attribution-Share Alike 3.0 Unported License
License information is available here: http://ruifujiwara.co.cc

Facebook is a registered trademark of Facebook, Inc.
Rui Fujiwara Viewer is not related to or endorsed by Facebook, Inc. in any way.
...
* Fixed a bug where Rui Fujiwara Viewer's bookmarks would appear underneath other items on the page.
...
* Added Macedonian and Korean to the drop down menu for Rui Fujiwara Viewer languages (I had forgotten to add them before).
...
var lang = {
	...
	en : {
		...
		'BookmarkNamePrompt' : 'Masukan nama dari bookmark ini :\n%s',
		'BookmarksConfirmRemoval' : 'Anda yakin akan menghapus isi dari Bookmark',
		'BookmarksManage' : 'Mengatur Bookmarks',
		'BookmarksRemoveSelected' : 'Remove Selected Bookmarks',
		'Bookmarks' : 'Bookmarks',
		'BrowserUnsupported' : 'Versi Browser Anda tidak mendukung fasilitas ini.',
		'CreatingFile' : 'Membuat File',
		'Close' : 'Tutup',
		'ConfigureFacebookFixer' : 'Konfigurasi Sistem Facebook',
		'ConfigureInstructions' : 'Program Ini untuk mengatur sistem pada halaman facebook dengan gaya dan selera anda sendiri dan berikut dibawah ini adalah fitur-fiturnya.',
		'ConfAge' : 'Show people\'s age on their profile (if they provide their full birthdate).',
		'ConfApplicationWhitelist' : ' Anda dapat menambahkan CSS atau Script dari Java Script Sendiri untuk mengatur halaman di Feed/Kabar seperti untuk mengatur kapabilitas jumlah tampilan pada tiap halaman atau jumlah yang dapat di lihat dalam setiap kali membuka halaman.',
		'ConfAutoBigAlbumPictures' : ' Secara otomatis menampilkan gambar album lebih besar saat halaman dibuka.',
		'ConfAutoLoadFullAlbum' : ' Otomatis memuat gambar tampak mini pada semua gambar dihalaman album dalam satu halaman.',
		'ConfAutoLoadTaggedPhotos' : Otomatis memuat gambar tampak mini pada semua gambar dihalaman tandai/ditandai foto dalam satu halaman.',
		'ConfAutoReadMore' : 'Automatically click on "see more" links.',
		'ConfBigAlbumPictures' : 'Tambahkan Link pada halaman album untuk melihat versi gambar lebih besar apada tiap gambar yang ada.',
		'ConfBigAlbumPicturesBorder' : 'Tambahkan bingkai tambahan pada halaman pembesaran gambar.',
		'ConfBookmarks' : 'Add a Bookmarks submenu to the top menu bar.',
		'ConfBottomBarHoverOpacity' : 'On mouse-over',
		'ConfBottomBarOpacity' : 'Transparansi Bar Menu',
		...
		'ConfChatHideIdle' : 'Sembunyikan aplikasi eksternal.',
		'ConfDelayPopupPics' : 'Tambahkan jeda waktu sebelum memperbesar gambar.',
		'ConfDelayPopupPicsTimeout' : 'Jeda Sebelum menampilkan Gambar versi Pembesaran, Dalam Milidetik (Normal=500):',
		'ConfDownloadVideo' : 'Tambahkan Link Download pada halaman. (You may need an <a href="http://en.wikipedia.org/wiki/Flash_Video#FLV_players" target="_blank">FLV player</a>)',
		'ConfErrorPageReload' : 'Otomatis refresh jika aplikasi terjadi kesalahan setelah 5 detik .',
		'ConfExport' : 'Menyalin setingan ini dan menjadikan dalam format teks',
		'ConfExternalPopup' : ' Perbesar tampilan gambar dari halaman lain facebook yang tampil di Wall/ Dinding. <sup>Uji Coba</sup>',
		'ConfFacebookFixerLanguage' : 'Language for Rui Fujiwara Viewer',
		'ConfFacebookTimestamps' : 'Tampilkan ctak waktu Facebook (Seperti. "3 hours ago").',
		'ConfFBFTimestamps' : 'Tambahkan Rui Fujiwara Viewer Perhitungan waktu dalam format Digital (contoh. "11:45").',
		'ConfFBFTimestamps24' : 'Tampilkan Rui Fujiwara Viewer Perhitungan waktu dalam format 24 jam.',
		'ConfFriendRequestCountInTitle' : 'Tampilkan jumlah permintaan teman baru dalam judul halaman.',
		'ConfGoogleApps' : 'Buat Kalender Google dengan Aplikasi Google',
		...
		'ConfHideApplicationStories' : 'Sembunyikan Aplikasi.',
		'ConfHideEgos' : 'Hide all "ego" sections (should hide most of Facebook\'s recommendations).',
		'ConfHideEventStories' : 'Sembunyikan Acara.',
		'ConfHideFacebookCountInTitle' : ' Sembuyikan hitungan pada kotak masuk/inbox pesan',
		'ConfHideFriendStories' : 'Sembunyikan Informasi Pertemanan.',
		'ConfHideGroupStories' : 'Sembunyikan Informasi Grup.',
		'ConfHideHovercards' : 'Hide hovercards (the popup that appears when you mouse-over a name).',
		'ConfHideLikeStories' : 'Sembunyikan Informasi Menyukai.',
		'ConfHideLinkStories' : ' Sembunyikan Informasi Link.',
		'ConfHideNoteStories' : ' Sembunyikan Informasi  Catatan.',
		'ConfHidePhotoStories' : ' Sembunyikan Informasi Foto.',
		'ConfHidePlaceStories' : ' Sembunyikan Informasi  Tempat.',
		'ConfHideProfilePicStories' : ' Sembunyikan Gambar Profil',
		'ConfHideRead' : ' Sembunyikan Informasi Kabar atau Kiriman Yang Telah Terbaca.',
		'ConfHideRelationshipStories' : ' Sembunyikan Informasi  Status Hubungan',
		'ConfHideStatusStories' : ' Sembunyikan Informasi Status.',
		'ConfHideVideoStories' : ' Sembunyikan Informasi  Video',
		'ConfHideWallStories' : ' Sembunyikan Informasi  Dinding/Wall',
		'ConfHomeBeta' : 'Tampilkan Halaman Facebook Bisnis Untuk Pengguna Berbayar dari Facebook',
		'ConfHomeChat' : 'Menampilkan bagian fitur Chat.',
		'ConfHomeChatNames' : 'Tampilkan nama pada fitur Chat',
		'ConfHomeEvents' : 'Tampilan Bagian Acara.',
		'ConfHomeFindFriends' : 'Tampilkan Bagian Informasi Fitur Facebook.',
		'ConfHomeLeftAlign' : 'Tampilkan pada sisi kiri isi bagian Home Page.',
		'ConfHomeLeftColumn' : 'Menampilkan kolom sisi kiri',
		'ConfHomeLeftColumnFixed' : 'Membiarkan kolom kiri tetap terlihat setelah posisi halaman di geser kebawah',
		'ConfHomeLink' : 'Show the Home link in the top menu bar.',
		'ConfHomeNavigation' : 'Menampilkan bagian navigasi.',
		'ConfHomePokes' : 'Tmpilkan bagian informasi colekan.',
		'ConfHomeProfile' : 'Menampilkan bagian profil.',
		'ConfHomeRecommendations' : 'Tampilkan bagian usulan ke orang-orang yang mungkin kita kenali.',
		'ConfHomeRequests' : 'Menampilkan bagian permintaan.',
		'ConfHomeRightColumn' : 'Tampilkan kolom sisi bagian kanan',
		'ConfHomeStretch' : 'Tampilan layar penuh pada Home Page/Halaman Utama facebook di Browser Anda',
		'ConfHomeStretchComments' : 'Tampilan penuh pada halaman komentar',
		...
		'ConfImport' : ' Untuk mengimpor pengaturan Anda kemudian, menimpa teks di bawah ini dengan teks yang disimpan sebelumnya dan klik "Impor".',
		'ConfInboxCountInTitle' : ' Menunjukkan jumlah kotak masuk pesan baru dalam judul halaman.',
		'ConfLogoutLink' : 'Tambahkan Fitur Log-Out/Keluar pada Menu',
		'ConfNotificationCountInTitle' : ' Menunjukkan jumlah pemberitahuan baru dalam judul halaman.',
		'ConfNewTabSearch' : ' Membuat hasil pencarian terbuka di tab baru / window ketika menekan CTRL + Enter untuk pencarian.',
		'ConfPageTitle' : 'Hapus Tulisan "Facebook |" Pada halaman Judul disetiap halaman/tabulasi.',
		'ConfPhotoPopup' : ' Perbesar gambar pada halaman Facebook hanya dengan meletakan pointer mouse diatas gambar.',
		'ConfPopupAutoClose' : 'Tutup halaman perbesaran gambar secara otomatis.',
		'ConfPopupSmartAutoClose' : 'Mencegah halaman pembesaran tertutup secara otomatis sewaktu mouse ada diatas gambar.',
		'ConfPopupPosition' : 'Pengaturan posisi tampil halaman pembesaran gambar',
		'ConfPopupWhileTagging' : 'Tampilan perbesar gambar tetap aktif walaupun di halaman gambar ukuran besar.',
		'ConfProcessInterval' : ' Interval pada untuk proses halaman, dalam milidetik (Normal = 1000):',
		'ConfProfileLink' : ' Tampilkan link Profil pada menu bar bagian atas.',
		'ConfProfilePicPopup' : ' Perbesar gambar untuk foto profil hanya dengan meletakan pointer mouse diatas gambar ',
		'ConfProtocolLinks' : ' Aktifkan ID messenger pada profil tersebut ke link yang memulai percakapan dengan mereka (Google Talk, Windows Live dll).',
		'ConfSectionAbout' : 'Tentang Rui Fujiwara Viewer',
		'ConfSectionAdvanced' : 'Tingkat Lanjut',
		'ConfSectionEvents' : 'Ulang Tahun/Acara,
		'ConfSectionImportExport' : 'Import/Export',
		'ConfSectionFeeds' : 'Kabar/Berita',
		'ConfSectionHomePage' : 'Home Page/Halaman Utama',
		'ConfSectionLiveFeed' : 'Kiriman Terbaru',
		'ConfSectionMenu' : 'Fitur/Chat',
		'ConfSectionOther' : 'Pengaturan Lain',
		'ConfSectionPageTitle' : 'Judul Halaman',
		'ConfSectionPictures' : 'Gambar',
		'ConfSectionShortcuts' : 'Kode Keyboard',
		'ConfSecureLinks' : 'Setting jalur akses facebook dengan media HTTPS.',
		'ConfShortcutList' : '<b>Keyboard Shortucts</b> (case sensitive):<br /><br /><i>From any page:</i><br />&nbsp;<b>A</b> - Albums/photos<br />&nbsp;<b>B</b> - Toggle buddy list (online friends)<br />&nbsp;<b>C</b> - Rui Fujiwara Viewer configuration<br />&nbsp;<b>D</b> - Birthdays<br />&nbsp;<b>E</b> - Events<br />&nbsp;<b>F</b> - Friends<br />&nbsp;<b>H</b> - Home page<br />&nbsp;<b>I</b> - Inbox<br />&nbsp;<b>K</b> - Add Bookmark<br />&nbsp;<b>L</b> - Select the logout link (press Enter afterwards to log out)<br />&nbsp;<b>N</b> - Notifications<br />&nbsp;<b>P</b> - Your profile<br />&nbsp;<b>R</b> - Requests<br />&nbsp;<b>S</b> - Jump to the search field<br />&nbsp;<b>T</b> - Translate selected text<br />&nbsp;<b>?</b> - Show Rui Fujiwara Viewer debug info<br />&nbsp;<b>&lt;escape&gt;</b> - Close pop-ups created by Rui Fujiwara Viewer<br /><br /><i>From the home page (filters)</i>:<br />&nbsp;<b>a</b> - Pages<br />&nbsp;<b>f</b> - Live feed<br />&nbsp;<b>g</b> - Groups<br />&nbsp;<b>l</b> - Links<br />&nbsp;<b>n</b> - News feed<br />&nbsp;<b>p</b> - Photos<br />&nbsp;<b>s</b> or <b>u</b> - Status updates<br />&nbsp;<b>t</b> - Notes<br />&nbsp;<b>v</b> - Videos<br /><br /><i>From profiles</i>:<br />&nbsp;<b>i</b> - Info<br />&nbsp;<b>p</b> - Photos<br />&nbsp;<b>w</b> - Wall<br />&nbsp;<b>x</b> - Boxes<br /><br /><i>From pages with pagination (previous, next, etc)</i><br />&nbsp;<b>&lt;left arrow&gt;</b> - Previous<br />&nbsp;<b>&lt;right arrow&gt;</b> - Next<br />&nbsp;<b>&lt;shift&gt; + &lt;left arrow&gt;</b> - First (when available)<br />&nbsp;<b>&lt;shift&gt; + &lt;right arrow&gt;</b> - Last (when available)<br /><br /><i>While viewing albums/photos:</i><br />&nbsp;<b>a</b> - Load all thumbnails (when available)<br />&nbsp;<b>b</b> - Show big pictures<br />&nbsp;<b>c</b> - View comments<br />&nbsp;<b>k</b> - Back to album<br />&nbsp;<b>m</b> - Photos of (person) and me<br /><br /><i>While viewing recent albums and uploaded/tagged photos:</i><br />&nbsp;<b>a</b> or &nbsp;<b>r</b> - Recent Albums<br />&nbsp;<b>m</b> or &nbsp;<b>u</b> - Mobile uploads<br />&nbsp;<b>o</b> - Photos of me<br />&nbsp;<b>p</b> - My Photos<br />&nbsp;<b>t</b> or &nbsp;<b>f</b> - Tagged friends',
		'ConfShortcuts' : 'Aktifkan Kode Keyboard',
		'ConfSign' : ' Tampilkan tanda di profil orang-orang jika mereka menyediakannya (jika mereka memberikan tanggal lahir mereka).',
		'ConfTopBarFixed' : 'Membiarkan tampilan Bar menu pada atas layar ketika bagian halaman digeser posisinya ke bawah.',
		'ConfTopBarHoverOpacity' : 'On mouse-over',
		'ConfTopBarOpacity' : 'Transparansi menu bar atas',
		'ConfUpdates' : 'Check Userscripts.org daily for updates to Rui Fujiwara Viewer. Or <a href="#" id="fbfUpdateLink" onclick="return false;">check now</a>.',
		'DownloadVideo' : 'Download Video',
		'ExportICalendarFile' : 'Ekspor file iCalendar',
		'ExportICalendarFileWarning' : '(Ini akan berlangsung beberapa saat apabila Anda memiliki banyak teman)',
		'FacebookFixerConflict' : 'Facebook Fixer is now known as Rui Fujiwara Viewer.<br /><br />Because of the name change you need to manually uninstall Facebook Fixer from your browser, or the two scripts will conflict with each other.<br /><br />If you are aren\'t sure how to uninstall a userscript, <a %s>click here for instructions</a>.',
		'fullAlbumLoaded' : 'Memuat seluruh isi halaman album',
		'Import' : 'Impor',
		'ImportConfirm' : ' Apakah Anda yakin ingin mengimpor pengaturan ini dan data sebelumnya akan hilang akan hilang?.',
		'ImportFailure' : 'Terjadi kesalahan pada aktifitas impor data',
		'ImportSuccess' : 'Impor data selesai dan anda harus me-refresh atau reload halaman',
		'Left' : 'Kiri',
		'LoadingAllPhotos' : 'Memuat seluruh isi album Foto...',
		'loadingFullAlbum' : 'Memuat seluruh isi album...',
		'LoadingPic' : 'Memuat gambar...',
		'LoadPhotosWarning' : 'Proses ini akan memakan waktu lama',
		...
		'ReloadErrorPage' : 'Coba lagi, Atau tunggu 5-10 detik lagi',
		'Refresh' : 'Refresh',
		'Remove' : 'Remove',
		'Right' : 'Kanan',
		'ShowBigPictures' : 'Tampilan gambar besar',
		...
		'UpdateAvailable1' : 'An update is available for Rui Fujiwara Viewer',
		'UpdateAvailable2' : 'Anda Menyetujui update program sekarang? Tertanda : Rui Fujiwara',
		'UpdateHomepage' : 'Kehalaman penyedia program',
		'UpdateInstall' : 'Install Sekarang',
		'UpdateTomorrow' : 'Install besok',
		'yearsOld' : '%s years old'
	},

	// Spanish - Contributed by Glen Farmer and Neo (20110626)
	es : {
		'_language' : 'Spanish',
		...
		'Close' : 'Cerrar',
		'ConfigureFacebookFixer' : 'Configuración de Rui Fujiwara Viewer',
		...
		'ConfFacebookFixerLanguage' : 'Lenguaje del Rui Fujiwara Viewer',
		'ConfFacebookTimestamps' : 'Mostrar cuanto hace que fue creado (Ejemplo: "Hace 3 horas").',
		'ConfFBFTimestamps24' : 'Mostrar las marcas de tiempo de Rui Fujiwara Viewer en formato 24 horas.',
		'ConfFBFTimestamps' : 'Añadir las marcas de tiempo de Rui Fujiwara Viewer después de las marcas de tiempo de Facebook (Por ejemplo "11:45").',
		...
		'ConfSectionAbout' : 'Acerca de Rui Fujiwara Viewer',
		...
		'ConfShortcutList' : '<b>Atajos de Teclado</b> (sensible a la diferencia entre minúsculas y mayúsculas):<br /><br /><i>Desde cualquier página:</i><br />&nbsp;<b>A</b> - Álbumes/Fotos<br />&nbsp;<b>B</b> - Activar/Desactivar lista de amigos (Amigos conectados)<br />&nbsp;<b>C</b> - Configuración de Rui Fujiwara Viewer<br />&nbsp;<b>D</b> - Cumpleaños<br />&nbsp;<b>E</b> - Eventos<br />&nbsp;<b>F</b> - Amigos<br />&nbsp;<b>H</b> - Página de Inicio<br />&nbsp;<b>I</b> - Bandeja de Entrada<br />&nbsp;<b>K</b> - Añadir Marcador<br />&nbsp;<b>L</b> - Seleccionar vínculo para terminar la sesión (presione Enter después para terminar la sesión)<br />&nbsp;<b>N</b> - Notificaciones<br />&nbsp;<b>P</b> - Perfil<br />&nbsp;<b>R</b> - Peticiones<br />&nbsp;<b>S</b> - Saltar a el campo de búsqueda<br />&nbsp;<b>T</b> - Traducir el texto seleccionado<br />&nbsp;<b>?</b> - Mostrar la información de depuración de Rui Fujiwara Viewer<br />&nbsp;<b><escape></b> - Cerrar la ventana emergente creada por Rui Fujiwara Viewer<br /><br /><i>Desde la página de inicio (filtros)</i>:<br />&nbsp;<b>a</b> - Páginas<br />&nbsp;<b>f</b> - Live feed<br />&nbsp;<b>g</b> - Grupos<br />&nbsp;<b>l</b> - Vínculos<br />&nbsp;<b>n</b> - Noticias<br />&nbsp;<b>p</b> - fotos<br />&nbsp;<b>s</b> or <b>u</b> - Estatus de las Actualizaciones<br />&nbsp;<b>t</b> - Notas<br />&nbsp;<b>v</b> - Vídeos<br /><br /><i>Desde los perfiles</i>:<br />&nbsp;<b>i</b> - Información<br />&nbsp;<b>p</b> - Fotos<br />&nbsp;<b>w</b> - Muro<br />&nbsp;<b>x</b> - Cajas<br /><br /><i>Desde las páginas con paginación (previo, siguiente, etc)</i><br />&nbsp;<b><left arrow></b> - Previo<br />&nbsp;<b><right arrow></b> - Siguiente<br />&nbsp;<b><shift> + <left arrow></b> - Primera (cuando este disponible)<br />&nbsp;<b><shift> + <right arrow></b> - Ultimo (cuando este disponible)<br /><br /><i>Al ver albumes/fotos:</i><br />&nbsp;<b>a</b> - Ver todas la miniaturas (cuando este disponible)<br />&nbsp;<b>b</b> - Ver fotos grandes<br />&nbsp;<b>c</b> - Ver comentarios<br />&nbsp;<b>k</b> - De vuelta al álbum<br />&nbsp;<b>m</b> - Fotos de (personas) y yo<br /><br /><i>Al ver albumes recientes y fotos subidas/marcadas:</i><br />&nbsp;<b>a</b> or &nbsp;<b>r</b> - Albumes Recientes<br />&nbsp;<b>m</b> or &nbsp;<b>u</b> - Fotos de Móviles<br />&nbsp;<b>o</b> - Fotos de mi<br />&nbsp;<b>p</b> - Mis Fotos<br />&nbsp;<b>t</b> or &nbsp;<b>f</b> - Amigos Marcados', 'ConfTopBarHoverOpacity' : 'Al pasar el ratón por encima', 'FacebookFixerConflict' : 'Facebook Fixer ahora se llama Rui Fujiwara Viewer.<br /><br />Por el cambio de nombre es necesario desinstalar Facebook Fixer manualmente de su navegador o los dos programas entraran en conflicto.<br /><br />Si no sabe como desinstalar un userscript, <a %s>haga clic aquí para ver instrucciones</a>.',
		...
		'ConfUpdates' : 'Revisar Userscripts.org diarimente por si hay actualizaciones en Rui Fujiwara Viewer. O <a href="#" id="fbfUpdateLink" onclick="return false;">revisar Ahora</a>.',
		...
		'FacebookFixerConflict' : 'Facebook Fixer ahora se llama Rui Fujiwara Viewer.<br /><br />Por el cambio de nombre es necesario desinstalar Facebook Fixer manualmente de su navegador o los dos programas entraran en conflicto.<br /><br />Si no sabe como desinstalar un userscript, <a %s>haga clic aquí para ver instrucciones</a>.',
		...
		'UpdateAvailable1' : 'Hay una actualización disponible para Rui Fujiwara Viewer',
	...
	// French - Contributed by Serge Thiry (20110329)
	fr : {
		'_language' : 'French',
		...
		'Close' : 'Fermer',
		'ConfigureFacebookFixer' : 'Configurer Rui Fujiwara Viewer',
		...
		'ConfFacebookFixerLanguage' : 'Langue de Rui Fujiwara Viewer',
		'ConfFacebookTimestamps' : 'Affichage de la datation Facebook (ex. "Il y a 3 heures").',
		'ConfFBFTimestamps' : 'Ajout de la datation Rui Fujiwara Viewer apr&egrave;s la datation Facebook (ex. "11:45").',
		'ConfFBFTimestamps24' : 'Affichage de la datation Rui Fujiwara Viewer au format 24 heures.',
		...
		'ConfSectionAbout' : 'A propos de Rui Fujiwara Viewer',
		...
		'ConfUpdates' : 'V&eacute;rifie quotidiennement si une mise &agrave; jour de Rui Fujiwara Viewer est disponible sur Userscripts.org. Ou <a href="#" id="fbfUpdateLink" onclick="return false;">v&eacute;rifier maintenant</a>.',
		...
		'FacebookFixerConflict' : 'Rui Fujiwara Viewer est maintenant devenu Rui Fujiwara Viewer. A cause du changement de nom, vous aurez besoin de d&eacute;sinstaller manuellement Rui Fujiwara Viewer de votre explorateur, ou les deux scripts rentreront en conflit. Si vous n\'&ecirc;tes pas s&ucirc;r de comment faire pour d&eacute;sinstaller un userscript, <a %s>cliquez ici pour la marche &agrave; suivre</a>.',
		...
		'Left' : 'Gauche',
		'ListeningRestarted' : 'Rui Fujiwara Viewer s\'est remit \340 l\'\351coute des changements \351ventuels.',
		'ListeningStopped' : 'Rui Fujiwara Viewer a arret\351 d\'\352tre \340 l\'\351coute des changements \351ventuels.\nAppuyez sur L (SHIFT + l) pour r\351-activer l\'\351coute',
		...
		'UpdateAvailable1' : 'Une mise &agrave; jour de Rui Fujiwara Viewer est disponible',
	...
	it : {
		...
		'Close' : 'Chiudi',
		'ConfigureFacebookFixer' : 'Impostazioni di Rui Fujiwara Viewer',
		...
		'ConfFacebookFixerLanguage' : 'Lingua di Rui Fujiwara Viewer',
		...
		'ConfSectionAbout' : 'Riguardo di Rui Fujiwara Viewer',
		...
		'FacebookFixerConflict' : 'Rui Fujiwara Viewer ha cambiato nome in Rui Fujiwara Viewer. A causa del cambiamento dovrai disinstallare manualmente Rui Fujiwara Viewer dal tuo browser, o i due script andranno in conflitto. Se non sei sicuro di come disinstallare un userscript <a %s>clicca qui per le istruzioni</a>.',
		...
		'Left' : 'Sinistra',
		'ListeningRestarted' : 'Registrazione dei cambiamenti da parte di Rui Fujiwara Viewer attivata.',
		'ListeningStopped' : 'Registrazione dei cambiamenti da parte di Rui Fujiwara Viewer disattivata.\nPremi L (SHIFT + l) per riabilitare la registrazione.',
		...
		'UpdateAvailable1' : 'È disponibile un update per Rui Fujiwara Viewer.',
	...
	de : {
		...
		'Close' : 'Schließen',
		'ConfigureFacebookFixer' : 'Rui Fujiwara Viewer konfigurieren',
		...
		'ConfFacebookFixerLanguage' : 'Sprache für Rui Fujiwara Viewer',
		...
		'ConfUpdates' : 'UÜberprüfen Sie Userscripts.org täglich auf Updates für Rui Fujiwara Viewer. <a href="#" id="fbfUpdateLink" onclick="return false;">Jetzt überprüfen</a>.',
		...
		'Left' : 'Links',
		'ListeningRestarted' : 'Rui Fujiwara Viewer reagiert wieder auf Änderungen.',
		'ListeningStopped' : 'Rui Fujiwara Viewer reagiert nicht auf Änderungen.\nL (SHIFT + l) drücken, um die Reaktion wieder zu aktvieren.',
		...
		'today' : 'heute',
		'UpdateAvailable1' : 'Es gibt ein Update für Rui Fujiwara Viewer',
	...
	bg : {
		...
		'Close' : 'Затваряне',
		'ConfigureFacebookFixer' : 'Конфигуриране на Rui Fujiwara Viewer',
		...
		'ConfFacebookFixerLanguage' : 'Език за Rui Fujiwara Viewer',
		...
		'ConfUpdates' : 'Проверяване на Userscripts.org ежедневно за ъпдейти на Rui Fujiwara Viewer. Или <a href="#" id="fbfUpdateLink" onclick="return false;">проверка сега</a>.',
		...
		'Left' : 'Отляво',
		'ListeningRestarted' : 'Rui Fujiwara Viewer възстанови проверките за промени.',
		'ListeningStopped' : 'Rui Fujiwara Viewer спря проверките за промени.\nНатиснете L (Shift + l) за повторно пускане',
		...
		'today' : 'днес',
		'UpdateAvailable1' : 'Излязло е обновление на Rui Fujiwara Viewer',
	...
	// Greek - Contributed by Dimitris DoSMaN Sarlis (20111024)
	el : {
		'_language' : 'Greek',
		...
		'Close' : 'Κλείσιμο',
		'ConfigureFacebookFixer' : 'Διαμόρφωση Rui Fujiwara Viewer',
		...
		'ConfFacebookFixerLanguage' : 'Γλώσσα για το Rui Fujiwara Viewer',
		'ConfFacebookTimestamps' : 'Εμφάνιση της ώρας του Facebook (πχ. "Πριν 3 ώρες").',
		'ConfFBFTimestamps' : 'Προσθήκη της ώρας του Rui Fujiwara Viewer μετά από την ώρα του Facebook (πχ. "11:45").',
		'ConfFBFTimestamps24' : 'Εμφάνιση της ώρας του Rui Fujiwara Viewer σε 24-ωρη μορφή.',
		...
		'ConfSectionAbout' : 'Σχετικά με το Rui Fujiwara Viewer',
		...
		'ConfUpdates' : 'Έλεγχος Userscripts.org καθημερινά για καινούργιες ενημερώσεις του Rui Fujiwara Viewer ή <a href="#" id="fbfUpdateLink" onclick="return false;">έλεγχος τώρα</a>.',
		...
		'UpdateAvailable1' : 'Υπάρχει καινούργια διαθέσιμη έκδοση του Rui Fujiwara Viewer',
	...
	// Slovak - Contributed by Peter Miksik (20110817)
	sk : {
		'_language' : 'Slovak',
		...
		'Close' : 'Zavrieť',
		'ConfigureFacebookFixer' : 'Konfigurovať Rui Fujiwara Viewer',
		...
		'FacebookFixerConflict' : 'Facebook Fixer sa odteraz nazýva Rui Fujiwara Viewer.<br /><br />Pretože sa zmenil názov, je potrebné ručne odinštalovať Facebook Fixer z prehliadača, inak budú v konflikte dva skripty medzi sebou navzájom.<br /><br />Ak neviete, ako skript odinštalovať, <a %s>kliknutím sem otvorte pokyny</a>.',
	...
	nl : {
		...
		'Close' : 'Sluit',
		'ConfigureFacebookFixer' : 'Configureer Rui Fujiwara Viewer',
		...
		'ConfFacebookFixerLanguage' : 'Taal voor Rui Fujiwara Viewer',
		'ConfFacebookTimestamps' : 'Laat Facebook timestamps zien (bijv. "3 uur geleden").',
		'ConfFBFTimestamps' : 'Rui Fujiwara Viewer timestamps toevoegen na Facebook timestamps (bijv. "11:45").',
		'ConfFBFTimestamps24' : 'Laat Rui Fujiwara Viewer timestamps zien in 24-uurs formaat.',
		...
		'ConfShortcutList' : '<b>Keyboard Shortucts</b> (case sensitive):<br /><br /><i>From any page:</i><br />&nbsp;<b>A</b> - Albums/photos<br />&nbsp;<b>B</b> - Toggle buddy list (online friends)<br />&nbsp;<b>C</b> - Rui Fujiwara Viewer configuration<br />&nbsp;<b>D</b> - Birthdays<br />&nbsp;<b>E</b> - Events<br />&nbsp;<b>F</b> - Friends<br />&nbsp;<b>H</b> - Home page<br />&nbsp;<b>I</b> - Inbox<br />&nbsp;<b>L</b> - Select the logout link (press Enter afterwards to log out)<br />&nbsp;<b>N</b> - Notifications<br />&nbsp;<b>P</b> - Your profile<br />&nbsp;<b>R</b> - Requests<br />&nbsp;<b>S</b> - Jump to the search field<br />&nbsp;<b>T</b> - Translate selected text<br />&nbsp;<b>?</b> - Show Rui Fujiwara Viewer debug info<br />&nbsp;<b>&lt;escape&gt;</b> - Close pop-ups created by Rui Fujiwara Viewer<br /><br /><i>From the home page (filters)</i>:<br />&nbsp;<b>a</b> - Pages<br />&nbsp;<b>f</b> - Live feed<br />&nbsp;<b>g</b> - Groups<br />&nbsp;<b>l</b> - Links<br />&nbsp;<b>n</b> - News feed<br />&nbsp;<b>p</b> - Photos<br />&nbsp;<b>s</b> or <b>u</b> - Status updates<br />&nbsp;<b>t</b> - Notes<br />&nbsp;<b>v</b> - Videos<br /><br /><i>From profiles</i>:<br />&nbsp;<b>i</b> - Info<br />&nbsp;<b>p</b> - Photos<br />&nbsp;<b>w</b> - Wall<br />&nbsp;<b>x</b> - Boxes<br /><br /><i>From pages with pagination (previous, next, etc)</i><br />&nbsp;<b>&lt;left arrow&gt;</b> - Previous<br />&nbsp;<b>&lt;right arrow&gt;</b> - Next<br />&nbsp;<b>&lt;shift&gt; + &lt;left arrow&gt;</b> - First (when available)<br />&nbsp;<b>&lt;shift&gt; + &lt;right arrow&gt;</b> - Last (when available)<br /><br /><i>While viewing albums/photos:</i><br />&nbsp;<b>a</b> - Load all thumbnails (when available)<br />&nbsp;<b>b</b> - Show big pictures<br />&nbsp;<b>c</b> - View comments<br />&nbsp;<b>k</b> - Back to album<br />&nbsp;<b>m</b> - Photos of (person) and me<br /><br /><i>While viewing recent albums and uploaded/tagged photos:</i><br />&nbsp;<b>a</b> or &nbsp;<b>r</b> - Recent Albums<br />&nbsp;<b>m</b> or &nbsp;<b>u</b> - Mobile uploads<br />&nbsp;<b>o</b> - Photos of me<br />&nbsp;<b>p</b> - My Photos<br />&nbsp;<b>t</b> or &nbsp;<b>f</b> - Tagged friends',
		...
		'ConfUpdates' : 'Check Userscripts.org dagelijks voor updates naar Rui Fujiwara Viewer. Of <a href="#" id="fbfUpdateLink" onclick="return false;">check nu</a>.',
		'DownloadVideo' : 'Download Video',
		...
		'today' : 'vandaag',
		'UpdateAvailable1' : 'Een update is beschikbaar voor Rui Fujiwara Viewer',
	...
	// Chinese (Taiwan) - Contributed by By Acedia.Liu (20110422)
	zh_tw : {
		...
		'CreatingFile' : '創建文件',
		'Close' : '關閉',
		'ConfigureFacebookFixer' : '設定 Rui Fujiwara Viewer',
		...
		'ConfFacebookFixerLanguage' : 'Rui Fujiwara Viewer的語言選項',
		'ConfFacebookTimestamps' : '顯示Facebook原來的時間戳記 (eg. "3 hours ago").',
		'ConfFBFTimestamps' : '新增Rui Fujiwara Viewer的顯示時間戳記 (eg. "11:45").',
		'ConfFBFTimestamps24' : 'Rui Fujiwara Viewer的時間戳記採用24小時制。',
		...
		'ConfSectionAbout' : '關於 Rui Fujiwara Viewer',
		...
		'ConfShortcutList' : '<b>鍵盤快捷鍵</b> (大小寫區分):<br /><br /><i>從任何頁面:</i><br />&nbsp;<b>A</b> - 相本/相片<br />&nbsp;<b>B</b> - 切換好友列表 (在線好友)<br />&nbsp;<b>C</b> - Rui Fujiwara Viewer 設置<br />&nbsp;<b>D</b> - 生日<br />&nbsp;<b>E</b> - 活動<br />&nbsp;<b>F</b> - 朋友<br />&nbsp;<b>H</b> - 首頁<br />&nbsp;<b>I</b> - 信箱<br />&nbsp;<b>L</b> - 選擇登出連結 (按下確定後登出)<br />&nbsp;<b>N</b> - 通知<br />&nbsp;<b>P</b> - 你的個人資料<br />&nbsp;<b>R</b> - 請求<br />&nbsp;<b>S</b> - 跳到搜索欄位<br />&nbsp;<b>T</b> - 翻譯選擇的內容<br />&nbsp;<b>?</b> - 顯示Rui Fujiwara Viewer除錯訊息<br />&nbsp;<b>&lt;escape&gt;</b> - 使用Rui Fujiwara Viewer關閉彈出視窗<br /><br /><i>從首頁 (過濾)</i>:<br />&nbsp;<b>a</b> - 頁面<br />&nbsp;<b>f</b> - 即時動態<br />&nbsp;<b>g</b> - 團體<br />&nbsp;<b>l</b> - 連結<br />&nbsp;<b>n</b> - 新的動態<br />&nbsp;<b>p</b> - 相片<br />&nbsp;<b>s</b> or <b>u</b> - 更新狀態<br />&nbsp;<b>t</b> - 筆記<br />&nbsp;<b>v</b> - 影片<br /><br /><i>從個人資料</i>:<br />&nbsp;<b>i</b> - 信息<br />&nbsp;<b>p</b> - 相片<br />&nbsp;<b>w</b> - 牆<br />&nbsp;<b>x</b> - 盒子<br /><br /><i>從網頁的頁碼 (previous, next, etc)</i><br />&nbsp;<b>&lt;left arrow&gt;</b> - Previous<br />&nbsp;<b>&lt;right arrow&gt;</b> - 下一個<br />&nbsp;<b>&lt;shift&gt; + &lt;left arrow&gt;</b> - 首先 (當可以使用)<br />&nbsp;<b>&lt;shift&gt; + &lt;right arrow&gt;</b> - 最後 (當可以使用)<br /><br /><i>當瀏覽相本/相片:</i><br />&nbsp;<b>a</b> - 讀取所有縮圖 (當可以使用)<br />&nbsp;<b>b</b> - 顯示大張的圖片<br />&nbsp;<b>c</b> - 查看留言<br />&nbsp;<b>k</b> - 返回相本<br />&nbsp;<b>m</b> - 照片 (個人) 和我<br /><br /><i>查看最近上傳/標記的相片:</i><br />&nbsp;<b>a</b> or &nbsp;<b>r</b> - 最新的相本<br />&nbsp;<b>m</b> or &nbsp;<b>u</b> - 手機上傳<br />&nbsp;<b>o</b> - 我的相片<br />&nbsp;<b>p</b> - 我的相片<br />&nbsp;<b>t</b> or &nbsp;<b>f</b> - 標記的朋友',
		...
		'ConfUpdates' : '檢查 Userscripts.org For Rui Fujiwara Viewer 的更新。 或是 <a href="#" id="fbfUpdateLink" onclick="return false;">立即確認</a>.',
		'DownloadVideo' : '下載影片',
		'ExportICalendarFile' : '輸出 iCalendar 檔案',
		'ExportICalendarFileWarning' : '(如果你有很多的朋友的話，將要一段時間)',
		'FacebookFixerConflict' : 'Facebook Fixer現在更名為Rui Fujiwara Viewer。<br /><br />由於更改名稱，你需要手動從瀏覽器中卸載舊的Facebook Fixer腳本，因為兩個腳本會相互衝突。<br /><br />如果你不確定如何去移除腳本， <a %s>點擊說明部份</a>.',
		...
		'today' : 'today',
		'UpdateAvailable1' : 'Rui Fujiwara Viewer 有可用的更新。',
	...
	// Turkish - Contributed by Gökhan Gurbetoğlu (20110817)
	tr : {
		'_language' : 'Turkish',
		...
		'Close' : 'Kapat',
		'ConfigureFacebookFixer' : 'Rui Fujiwara Viewer\'ı Yapılandır',
		...
		'ConfFacebookFixerLanguage' : 'Rui Fujiwara Viewer\'ın Dili',
		'ConfFacebookTimestamps' : 'Facebook\'un zaman etiketlerini göster (örn. "3 saat önce").',
		'ConfFBFTimestamps' : 'Facebook\'un zaman etiketlerinin ardından Rui Fujiwara Viewer zaman etiketlerini ekle (örn. "11:45").',
		'ConfFBFTimestamps24' : 'Rui Fujiwara Viewer zaman etiketlerini 24-saat biçiminde göster',
		...
		'ConfSectionAbout' : 'Rui Fujiwara Viewer Hakkında',
		...
		'ConfUpdates' : 'Rui Fujiwara Viewer güncellemeleri için her gün Userscripts.org\'u ziyaret et. Ya da <a href="#" id="fbfUpdateLink" onclick="return false;">şimdi kontrol et</a>.',
		...
		'FacebookFixerConflict' : 'Rui Fujiwara Viewer\'ın yeni adı artık Rui Fujiwara Viewer. İsim değişikliğinden dolayı Rui Fujiwara Viewer\'ı tarayıcınızdan kaldırmanız gerekiyor, yoksa bu iki script birbiriyle uyuşmazlık sorunları çıkaracaktır. Eğer bir userscript\'i nasıl kaldıracağınızdan emin değilseniz <a %s>buraya tıklayarak öğrenebilirsiniz</a>.',
		...
		'UpdateAvailable1' : 'Rui Fujiwara Viewer için bir güncelleme mevcut',
	...
	sr_rs : {
		...
		'Close' : 'Затвори',
		'ConfigureFacebookFixer' : 'Подеси Rui Fujiwara Viewer',
		...
		'ConfFacebookFixerLanguage' : 'Језик Rui Fujiwara Viewer-а',
		'ConfFacebookTimestamps' : 'Прикажи Фејсбук време (нпр. "пре 3 сата").',
		'ConfFBFTimestamps' : 'Додај Rui Fujiwara Viewer време после Фејсбук времена (нпр. "11:45").',
		'ConfFBFTimestamps24' : 'Прикажи Rui Fujiwara Viewer времена у 24-часовном облику.',
		...
		'ConfSectionAbout' : 'О додатку Rui Fujiwara Viewer',
		...
		'ConfUpdates' : 'Свакодневно проверавај Userscripts.org за надоградње Rui Fujiwara Viewer-а. Или <a href="#" id="fbfUpdateLink" onclick="return false;">провери сада</a>.',
		...
		'FacebookFixerConflict' : 'Rui Fujiwara Viewer се сада зове Rui Fujiwara Viewer. Због промене имена мораћете ручно да уклоните Rui Fujiwara Viewer из свог прегледача да не би дошло до ометања између ове две скрипте. Ако нисте сигурни како да уклоните скрипту, <a %s>кликните овде за упутство</a>.',
		...
		'UpdateAvailable1' : 'Доступне су надоградње за Rui Fujiwara Viewer',
	...
	// Serbian (Latin) - Contributed by Gorštak (20110817)
	sr : {
		...
		'Close' : 'Zatvori',
		'ConfigureFacebookFixer' : 'Podesi Rui Fujiwara Viewer',
		...
		'ConfFacebookFixerLanguage' : 'Jezik Rui Fujiwara Viewer-a',
		'ConfFacebookTimestamps' : 'Prikaži Fejsbuk vreme (npr. "pre 3 sata").',
		'ConfFBFTimestamps' : 'Dodaj Rui Fujiwara Viewer vreme posle Fejsbuk vremena (npr. "11:45").',
		'ConfFBFTimestamps24' : 'Prikaži Rui Fujiwara Viewer vremena u 24-časovnom obliku.',
		...
		'ConfSectionAbout' : 'O dodatku Rui Fujiwara Viewer',
		...
		'ConfShortcutList' : '<b>Prečice sa tastature</b> (razlikuju se mala i velika slova):<br /><br /><i>Sa bilo koje stranice:</i><br /> <b>A</b> - Albumi/fotografije<br /> <b>B</b> - Spisak dostupnih prijatelja<br /> <b>C</b> - Rui Fujiwara Viewer podešavanja<br /> <b>D</b> - Rođendani<br /> <b>E</b> - Događaji<br /> <b>F</b> - Prijatelji<br /> <b>H</b> - Početna stranica<br /> <b>I</b> - Primljene poruke<br /> <b>K</b> - dodaj zabelešku<br /> <b>L</b> - Označi vezu za odjavu (pritisnite Enter nakon toga za odjavljivanje)<br /> <b>N</b> - Obaveštenja<br /> <b>P</b> - Profil<br /> <b>R</b> - Zahtevi<br /> <b>S</b> - Prelazak na polje za pretragu<br /> <b>T</b> - Prevedi odabrani tekst<br /> <b>?</b> - Prikaži izveštaj o grešci Rui Fujiwara Viewer-a<br /> <b><escape></b> - Zatvori iskačuće prozore koje je napravio Rui Fujiwara Viewer<br /><br /><i>Sa početne stranice (filteri)</i>:<br /> <b>a</b> - Stranice<br /> <b>f</b> - Najnovije<br /> <b>g</b> - Grupe<br /> <b>l</b> - Veze<br /> <b>n</b> - Novosti<br /> <b>p</b> - Fotografije<br /> <b>s</b> ili <b>u</b> - Promene statusa<br /> <b>t</b> - Beleške<br /> <b>v</b> - Video<br /><br /><i>Sa profila</i>:<br /> <b>i</b> - Informacije<br /> <b>p</b> - Fotografije<br /> <b>w</b> - Zid<br /> <b>x</b> - Okviri<br /><br /><i>Sa stranica sa nabrajanjem (prethodna, sledća, itd.)</i><br /> <b><strelica levo></b> - Prethodna<br /> <b><strelica desno></b> - Sledeća<br /> <b><šift> + <strelica levo></b> - Prva (ako je dostupno)<br /> <b><šift> + <strelica desno></b> - Poslednja (ako je dostupno)<br /><br /><i>Prilikom pregledavanja albuma/fotografija:</i><br /> <b>a</b> - Učitaj sve sličice (ako je dostupno)<br /> <b>b</b> - Prikaži velike slike<br /> <b>c</b> - Prikaži komentare<br /> <b>k</b> - Nazad na album<br /> <b>m</b> - Fotografije sa (korisnikom) i sa mnom<br /><br /><i>Pri pregledavanju skorašnjih albuma i postavljenih/označenih fotografija:</i><br /> <b>a</b> ili  <b>r</b> - Skorašnji albumi<br /> <b>m</b> ili  <b>u</b> - Postavljeno preko mobilnog telefona<br /> <b>o</b> - Fotografije na kojima sam ja<br /> <b>p</b> - Moje fotografije<br /> <b>t</b> ili  <b>f</b> - Označeni prijatelji',
		...
		'ConfUpdates' : 'Svakodnevno proveravaj Userscripts.org za nadogradnje Rui Fujiwara Viewer-a. Ili <a href="#" id="fbfUpdateLink" onclick="return false;">proveri sada</a>.',
		...
		'FacebookFixerConflict' : 'Rui Fujiwara Viewer se sada zove Rui Fujiwara Viewer. Zbog promene imena moraćete ručno da uklonite Rui Fujiwara Viewer iz svog pregledača da ne bi došlo do ometanja između ove dve skripte. Ako niste sigurni kako da uklonite skriptu, <a %s>kliknite ovde za uputstvo</a>.',
		...
		'UpdateAvailable1' : 'Dostupne su nadogradnje za Rui Fujiwara Viewer',
	...
	// Danish - Contributed by Mads Jensen (20110210)
	da : {
		'_language' : 'Danish',
		...
		'Close' : 'Luk',
		'ConfigureFacebookFixer' : 'Konfigurér Rui Fujiwara Viewer',
		...
		'ConfFacebookFixerLanguage' : 'Sprog i Rui Fujiwara Viewer',
		'ConfFacebookTimestamps' : 'Vis Facebook tidsstempler (f.eks. "3 timer sider").',
		'ConfFBFTimestamps' : 'Tilføj Rui Fujiwara Viewer tidsstempler efter Facebook tidsstempler (f.eks. "11:45").',
		'ConfFBFTimestamps24' : 'Vis Rui Fujiwara Viewer tidsstempler i 24 timers format.',
		...
		'ConfSectionAbout' : 'Omkring Rui Fujiwara Viewer',
		...
		'ConfUpdates' : 'Undersøg Userscripts.org dagligt for opdateringer til Rui Fujiwara Viewer. Eller <a href="#" id="fbfUpdateLink" onclick="return false;">undersøg nu</a>.',
		...
		'FacebookFixerConflict' : 'Rui Fujiwara Viewer vil fremover hedde Rui Fujiwara Viewer. På grund af navneskiftet, skal du manuelt afinstallere Rui Fujiwara Viewer fra dine browsere, da de to scripts ellers vil komme i konflikt med hinanden. Hvis du er usikker på hvordan man afinstallerer et Userscript, så <a %s>tryk her for instruktioner</a>.',
		'fullAlbumLoaded' : 'Hele albummet hentet',
		'Left' : 'Venstre',
		'ListeningRestarted' : 'Rui Fujiwara Viewer lytter efter ændringer igen.',
		'ListeningStopped' : 'Rui Fujiwara Viewer er stoppet med at lytte efter ændringer.\nTryk L (SHIFT + l) for at starte igen',
		...
		'today' : 'i dag',
		'UpdateAvailable1' : 'En opdatering er tilgængelig til Rui Fujiwara Viewer',
	...
	// Czech - Contributed by Caken (20110823)
	cs : {
		'_language' : 'Czech',
		...
		'Close' : 'Zavřít',
		'ConfigureFacebookFixer' : 'Nastavení - Rui Fujiwara Viewer',
		...
		'ConfFacebookFixerLanguage' : 'Jazyk pro Rui Fujiwara Viewer',
		'ConfFacebookTimestamps' : 'Zobrazit časové značky Facebooku (t. j. "před 3 hodinami")',
		'ConfFBFTimestamps' : 'Přidat časové značky skriptu Rui Fujiwara Viewer za časové značky Facebooku (t. j. "11:45")',
		'ConfFBFTimestamps24' : 'Zobrazit časové značny skriptu Rui Fujiwara Viewer v 24-hodinovém formátě',
		...
		'ConfSectionAbout' : 'O Rui Fujiwara Vieweru',
		...
		'ConfShortcutList' : '<b>Klávesové zkratky</b> (rozlišují se malá/velká písmena):<br /><br /><i>Z libovolné stránky:</i><br />&nbsp;<b>A</b> - Alba/fotky<br />&nbsp;<b>B</b> - Přepnout seznam přátel (online přátel)<br />&nbsp;<b>C</b> - Konfigurace skriptu Rui Fujiwara Viewer<br />&nbsp;<b>D</b> - Narozeniny<br />&nbsp;<b>E</b> - Události<br />&nbsp;<b>F</b> - Přátelé<br />&nbsp;<b>H</b> - Domů<br />&nbsp;<b>I</b> - Přijaté zprávy<br />&nbsp;<b>K</b> - Přidej záložku<br />&nbsp;<b>L</b> - Odhlášení (po odhlášení stiskněte Enter)<br />&nbsp;<b>N</b> - Upozornění<br />&nbsp;<b>P</b> - Váš profil<br />&nbsp;<b>R</b> - Žádosti<br />&nbsp;<b>S</b> - Přeskočit na pole Hledat<br />&nbsp;<b>T</b> - Přeložit vybraný text<br />&nbsp;<b>?</b> - Zobrazit informace o ladění skriptu Rui Fujiwara Viewer<br />&nbsp;<b>&lt;escape&gt;</b> - Zavřít kontextová okna vytvořené skriptem Rui Fujiwara Viewer<br /><br /><i>Ze stránky Domů (filtry)</i>:<br />&nbsp;<b>a</b> - Stránky<br />&nbsp;<b>f</b> - Aktuality<br />&nbsp;<b>g</b> - Skupiny<br />&nbsp;<b>l</b> - Odkazy<br />&nbsp;<b>n</b> - Novinky<br />&nbsp;<b>p</b> - Fotky<br />&nbsp;<b>s</b> nebo <b>u</b> - Co dělají ostatní<br />&nbsp;<b>t</b> - Poznámky<br />&nbsp;<b>v</b> - Videa<br /><br /><i>Z profilů</i>:<br />&nbsp;<b>i</b> - Informace<br />&nbsp;<b>p</b> - Fotky<br />&nbsp;<b>w</b> - Zeď<br />&nbsp;<b>x</b> - Kontejner<br /><br /><i>Ze stránek s navigací (dozadu, dopredu atd.)</i><br />&nbsp;<b>&lt;levá šipka&gt;</b> - Předchozí<br />&nbsp;<b>&lt;pravá šipka&gt;</b> - Následující<br />&nbsp;<b>&lt;shift&gt; + &lt;levá šipka&gt;</b> - První (pokud je dispozici)<br />&nbsp;<b>&lt;shift&gt; + &lt;pravá šipka&gt;</b> - Poslední (pokud je k dispozici)<br /><br /><i>Při prohlížení alb/fotek:</i><br />&nbsp;<b>a</b> - Načítat všechny miniatury (pokud je k dispozici)<br />&nbsp;<b>b</b> - Zobrazit velké obrázky<br />&nbsp;<b>c</b> - Zobrazit komentáře<br />&nbsp;<b>k</b> - Zpět do alba<br />&nbsp;<b>m</b> - Fotky (osoby) a moje<br /><br /><i>Při prohlížení nejnovějších alb a nahraných/označených fotek:</i><br />&nbsp;<b>a</b> nebo &nbsp;<b>r</b> - Nejnovější alba<br />&nbsp;<b>m</b> nebo &nbsp;<b>u</b> - Nahrané z mobilu<br />&nbsp;<b>o</b> - Fotky mé osoby<br />&nbsp;<b>p</b> - Mé fotky<br />&nbsp;<b>t</b> nebo &nbsp;<b>f</b> - Označení přátelé',
		...
		'ConfUpdates' : 'Denně na Userscripts.org ověřovat aktualizace pro Rui Fujiwara Viewer, případně <a href="#" id="fbfUpdateLink" onclick="return false;">zkontrolovat nyní</a>.',
		...
		'FacebookFixerConflict' : 'Facebook Fifex je nyní znám jako Rui Fujiwara Viewer.<br /><br />Protože se změnilo jméno, musíte manuálně odinstalovat Facebook Fixer z vašeho prohlížeče.<br /><br />Pokud si nevíte jak na to <a %s>pokračujte zde</a>.',
		...
		'UpdateAvailable1' : 'K dispozici je aktualizace skriptu Rui Fujiwara Viewer.',
	...
	// Macedonian - Contributed by Goce Manevski (20110628)
	mk : {
		...
		'Close' : 'Затвори',
		'ConfigureFacebookFixer' : 'Конфигурирај го Rui Fujiwara Viewer',
		...
		'ConfFacebookFixerLanguage' : 'Јазик за Rui Fujiwara Viewer',
		'ConfFacebookTimestamps' : 'Прикажи Facebook маркер за времето (eg. "3 часа старо").',
		'ConfFBFTimestamps' : 'Додади Rui Fujiwara Viewer маркер за времето по Facebook маркерот за време (eg. "11:45").',
		'ConfFBFTimestamps24' : 'Прикажи Rui Fujiwara Viewer маркер за време во 24-часовен формат.',
		...
		'ConfHomeLeftAlign' : 'Sisi kiri pada isi/fitur di Home Page',
		...
		'ConfSectionAbout' : 'За Rui Fujiwara Viewer',
		...
		'ConfShortcutList' : '<b>Кратенки за тастатура</b> (case sensitive):<br /><br /><i>Од секоја страница:</i><br />&nbsp;<b>A</b> - Albums/photos<br />&nbsp;<b>B</b> - Вклучи корисници (вклучени пријатели)<br />&nbsp;<b>C</b> - Rui Fujiwara Viewer Конфигурација<br />&nbsp;<b>D</b> - Родендени<br />&nbsp;<b>E</b> - Настани<br />&nbsp;<b>F</b> - Пријатели<br />&nbsp;<b>H</b> - Почетна страница<br />&nbsp;<b>I</b> - Сандаче<br />&nbsp;<b>K</b> - Add Bookmark<br />&nbsp;<b>L</b> - Select the logout link (press Enter afterwards to log out)<br />&nbsp;<b>N</b> - Notifications<br />&nbsp;<b>P</b> - Your profile<br />&nbsp;<b>R</b> - Requests<br />&nbsp;<b>S</b> - Jump to the search field<br />&nbsp;<b>T</b> - Translate selected text<br />&nbsp;<b>?</b> - Show Rui Fujiwara Viewer debug info<br />&nbsp;<b>&lt;escape&gt;</b> - Close pop-ups created by Rui Fujiwara Viewer<br /><br /><i>From the home page (filters)</i>:<br />&nbsp;<b>a</b> - Pages<br />&nbsp;<b>f</b> - Live feed<br />&nbsp;<b>g</b> - Groups<br />&nbsp;<b>l</b> - Links<br />&nbsp;<b>n</b> - News feed<br />&nbsp;<b>p</b> - Photos<br />&nbsp;<b>s</b> or <b>u</b> - Status updates<br />&nbsp;<b>t</b> - Notes<br />&nbsp;<b>v</b> - Videos<br /><br /><i>From profiles</i>:<br />&nbsp;<b>i</b> - Info<br />&nbsp;<b>p</b> - Photos<br />&nbsp;<b>w</b> - Wall<br />&nbsp;<b>x</b> - Boxes<br /><br /><i>From pages with pagination (previous, next, etc)</i><br />&nbsp;<b>&lt;left arrow&gt;</b> - Previous<br />&nbsp;<b>&lt;right arrow&gt;</b> - Next<br />&nbsp;<b>&lt;shift&gt; + &lt;left arrow&gt;</b> - First (when available)<br />&nbsp;<b>&lt;shift&gt; + &lt;right arrow&gt;</b> - Last (when available)<br /><br /><i>While viewing albums/photos:</i><br />&nbsp;<b>a</b> - Load all thumbnails (when available)<br />&nbsp;<b>b</b> - Show big pictures<br />&nbsp;<b>c</b> - View comments<br />&nbsp;<b>k</b> - Back to album<br />&nbsp;<b>m</b> - Photos of (person) and me<br /><br /><i>While viewing recent albums and uploaded/tagged photos:</i><br />&nbsp;<b>a</b> or &nbsp;<b>r</b> - Recent Albums<br />&nbsp;<b>m</b> or &nbsp;<b>u</b> - Mobile uploads<br />&nbsp;<b>o</b> - Photos of me<br />&nbsp;<b>p</b> - My Photos<br />&nbsp;<b>t</b> or &nbsp;<b>f</b> - Tagged friends',
		...
		'ConfUpdates' : 'Провери Userscripts.org дневно за надоградби во Rui Fujiwara Viewer. Или <a href="#" id="fbfUpdateLink" onclick="return false;">провери сега</a>.',
		...
		'FacebookFixerConflict' : 'Facebook Fixer е сега Rui Fujiwara Viewer.<br /><br />За промена на име треба сами да го избришете Facebook Fixer од вашиот пребарувач, или двете скрипти ќе создаваат проблем една на друга.<br /><br />Ако не си сигурен како да ја избришеш скриптата, <a %s>кликни тука за инструкции</a>.',
		...
		'UpdateAvailable1' : 'Достапна е надоградба за Rui Fujiwara Viewer',
	...
	// Norwegian - Contributed by Eilif Nordseth (20110819)
	nb : {	
		'_language' : 'Norwegian',
		...
		'Close' : 'Lukk',
		'ConfigureFacebookFixer' : 'Rui Fujiwara Viewer - Alternativer',
		...
		'ConfFacebookFixerLanguage' : 'Språk til Rui Fujiwara Viewer',
		'ConfFacebookTimestamps' : 'Vis Facebook tidsangivelse (eg. "3 timer siden").',
		'ConfFBFTimestamps' : 'Legg til Rui Fujiwara Viewer tidsangivelser etter Facebook tider (eg. "11:45").',
		'ConfFBFTimestamps24' : 'Vis Rui Fujiwara Viewer tidsangivelser i 24-timers format.',
		...
		'ConfSectionAbout' : 'Om Rui Fujiwara Viewer',
		...
		'ConfUpdates' : 'Sjekk Userscripts.org daglig etter oppdateinger til Rui Fujiwara Viewer. Eller <a href="#" id="fbfUpdateLink" onclick="return false;">sjekk nå</a>.',
		...
		'FacebookFixerConflict' : 'Facebook Fixer er nå kjent som Rui Fujiwara Viewer.<br /><br />På grunn av navnebyttet må du manuelt avinstallere Facebook Fixer fra nettleseren din, ellers vil de to scriptene komme i konflikt med hverandre.<br /><br />Dersom du ikke er sikker på hvordan man avinstallerer et brukerscript, <a %s>klikk her for instruksjoner</a>.',
		...
		'UpdateAvailable1' : 'En oppdatering til Rui Fujiwara Viewer er tilgjengelig',
	...
	// Korean - Contributed by 박상빈 (20110823)
	ko : {
		'_language' : 'Korean',
		...
		'Close' : '닫기',
		'ConfigureFacebookFixer' : 'Rui Fujiwara Viewer 설정',
		...
		'ConfFacebookFixerLanguage' : 'Rui Fujiwara Viewer에 사용할 언어',
		'ConfFacebookTimestamps' : 'Facebook 형식의 타임스탬프 보이기 (예. "약 3시간 전").',
		'ConfFBFTimestamps' : 'Rui Fujiwara Viewer 형식의 타임스탬프를 Facebook 타임스탬프 뒤에 보이기 (예. "11:45").',
		'ConfFBFTimestamps24' : 'Rui Fujiwara Viewer 타임스탬프를 24시간 형식으로 보이기.',
		...
		'ConfSectionAbout' : 'Rui Fujiwara Viewer는...',
		...
		'ConfShortcutList' : '<b>키보드 단축키</b> (대소문자 구분):<br /><br /><i>모든 페이지에서 작동</i>:<br />&nbsp;<b>A</b> - 사진첩/사진<br />&nbsp;<b>B</b> - 접속된 친구 보이기/숨기기<br />&nbsp;<b>C</b> - Rui Fujiwara Viewer 설정<br />&nbsp;<b>D</b> - 생일<br />&nbsp;<b>E</b> - 이벤트<br />&nbsp;<b>F</b> - 친구<br />&nbsp;<b>H</b> - 첫 페이지<br />&nbsp;<b>I</b> - 쪽지<br />&nbsp;<b>K</b> - 즐겨찾기 더하기<br />&nbsp;<b>L</b> - 로그아웃 링크를 선택 (그다음 엔터키를 누르면 로그아웃)<br />&nbsp;<b>N</b> - 알림<br />&nbsp;<b>P</b> - 내 프로필<br />&nbsp;<b>R</b> - Requests<br />&nbsp;<b>S</b> - 검색 필드로 커서 이동<br />&nbsp;<b>T</b> - 선택한 텍스트를 번역<br />&nbsp;<b>?</b> - Rui Fujiwara Viewer 디버그 정보 보기<br />&nbsp;<b>&lt;ESC&gt;</b> - Rui Fujiwara Viewer 팝업 사진 닫기<br /><br /><i>홈페이지에서 작동(필터)</i>:<br />&nbsp;<b>a</b> - 페이지<br />&nbsp;<b>f</b> - 최신글<br />&nbsp;<b>g</b> - 그룹<br />&nbsp;<b>l</b> -링크<br />&nbsp;<b>n</b> - 뉴스 피드<br />&nbsp;<b>p</b> - 사진<br />&nbsp;<b>s</b> 또는 <b>u</b> - 상태 업데이트<br />&nbsp;<b>t</b> - 노트<br />&nbsp;<b>v</b> - 비디오<br /><br /><i>프로필 페이지에서 작동</i>:<br />&nbsp;<b>i</b> - 정보<br />&nbsp;<b>p</b> - 사진<br />&nbsp;<b>w</b> - 담벼락<br />&nbsp;<b>x</b> - Boxes<br /><br /><i>이동이 가능한 페이지에서 작동(이전, 다음, 등)</i>:<br />&nbsp;<b>&lt;←&gt;</b> - 이전<br />&nbsp;<b>&lt;→&gt;</b> - 다음<br />&nbsp;<b>&lt;Shift&gt; + &lt;←&gt;</b> - 처음 (가능할때만)<br />&nbsp;<b>&lt;Shift&gt; + &lt;→&gt;</b> - 마지막 (가능할때만)<br /><br /><i>사진첩/사진을 볼때 작동</i>:<br />&nbsp;<b>a</b> - 모든 썸네일 보기 (가능할때만)<br />&nbsp;<b>b</b> - 큰 사진 보이기<br />&nbsp;<b>c</b> - 댓글 보기<br />&nbsp;<b>k</b> - 사진첩으로 돌아가기<br />&nbsp;<b>m</b> - 내가(또는 친구가) 나온 사진<br /><br /><i>최근 사진첩이나 업로드/태그된 사진을 볼때 작동:</i><br />&nbsp;<b>a</b> 또는 &nbsp;<b>r</b> - 최근 사진첩<br />&nbsp;<b>m</b> 또는 <b>u</b> - 모바일 업로드<br />&nbsp;<b>o</b> - 내가 나온 사진<br />&nbsp;<b>p</b> -내 사진<br />&nbsp;<b>t</b> 또는 <b>f</b> - 태그 된 친구들',
		...
		'ConfUpdates' : '매일 Userscripts.org에서 Rui Fujiwara Viewer 업데이트를 확인하기. <a href="#" id="fbfUpdateLink" onclick="return false;">지금 확인</a>.',
		'DownloadVideo' : '비디오 다운로드',
		'ExportICalendarFile' : 'iCalender 파일로 가져오기',
		'ExportICalendarFileWarning' : '(친구가 많으면 오래 걸릴 수 있습니다)',
		'FacebookFixerConflict' : 'Facebook Fixer의 이름이 Rui Fujiwara Viewer로 바뀌었습니다.<br /><br />Facebook Fixer을 브라우저에서 제거하지 않으면 이름 변경 때문에 충돌이 일어납니다.<br /><br />userscript를 제거하는 방법을 모르겠으면 <a %s>여기를 참조하세요</a>.',
		...
		'today' : '오늘',
		'Translators' : '번역한 사람',
		'UpdateAvailable1' : 'Rui Fujiwara Viewer 업데이트가 나왔습니다',
	...
	// Vietnamese - Contributed by Trần Đức Thịnh (20110104)
	...
	vi : {
		...
		'Close' : 'Đóng',
		'ConfigureFacebookFixer' : 'Cài đặt Rui Fujiwara Viewer',
		...
		'ConfFacebookFixerLanguage' : 'Ngôn ngữ cho Rui Fujiwara Viewer',
		'ConfFacebookTimestamps' : 'Hiện mốc thời gian của facebook (ví dụ: "3 hours ago").',
		'ConfFBFTimestamps' : 'Thêm mốc thời gian của Rui Fujiwara Viewer sau mốc thời gian của Facebook (ví dụ: "11:45").',
		'ConfFBFTimestamps24' : 'Hiển thị mốc thời gian của Rui Fujiwara Viewer dạng 24 giờ.',
		...
		'ConfSectionAbout' : 'Thông tin về Rui Fujiwara Viewer',
		...
		'ConfShortcutList' : '<b>Keyboard Shortucts</b> (case sensitive):<br /><br /><i>From any page:</i><br />&nbsp;<b>A</b> - Albums/photos<br />&nbsp;<b>B</b> - Toggle buddy list (online friends)<br />&nbsp;<b>C</b> - Tùy Chỉnh Rui Fujiwara Viewer<br />&nbsp;<b>D</b> - Birthdays<br />&nbsp;<b>E</b> - Events<br />&nbsp;<b>F</b> - Friends<br />&nbsp;<b>H</b> - Home page<br />&nbsp;<b>I</b> - Inbox<br />&nbsp;<b>K</b> - Add Bookmark<br />&nbsp;<b>L</b> - Select the logout link (press Enter afterwards to log out)<br />&nbsp;<b>N</b> - Notifications<br />&nbsp;<b>P</b> - Your profile<br />&nbsp;<b>R</b> - Requests<br />&nbsp;<b>S</b> - Jump to the search field<br />&nbsp;<b>T</b> - Translate selected text<br />&nbsp;<b>?</b> - Show Rui Fujiwara Viewer debug info<br />&nbsp;<b>&lt;escape&gt;</b> - Close pop-ups created by Rui Fujiwara Viewer<br /><br /><i>From the home page (filters)</i>:<br />&nbsp;<b>a</b> - Pages<br />&nbsp;<b>f</b> - Live feed<br />&nbsp;<b>g</b> - Groups<br />&nbsp;<b>l</b> - Links<br />&nbsp;<b>n</b> - News feed<br />&nbsp;<b>p</b> - Photos<br />&nbsp;<b>s</b> or <b>u</b> - Status updates<br />&nbsp;<b>t</b> - Notes<br />&nbsp;<b>v</b> - Videos<br /><br /><i>From profiles</i>:<br />&nbsp;<b>i</b> - Info<br />&nbsp;<b>p</b> - Photos<br />&nbsp;<b>w</b> - Wall<br />&nbsp;<b>x</b> - Boxes<br /><br /><i>From pages with pagination (previous, next, etc)</i><br />&nbsp;<b>&lt;left arrow&gt;</b> - Previous<br />&nbsp;<b>&lt;right arrow&gt;</b> - Next<br />&nbsp;<b>&lt;shift&gt; + &lt;left arrow&gt;</b> - First (when available)<br />&nbsp;<b>&lt;shift&gt; + &lt;right arrow&gt;</b> - Last (when available)<br /><br /><i>While viewing albums/photos:</i><br />&nbsp;<b>a</b> - Load all thumbnails (when available)<br />&nbsp;<b>b</b> - Show big pictures<br />&nbsp;<b>c</b> - View comments<br />&nbsp;<b>k</b> - Back to album<br />&nbsp;<b>m</b> - Photos of (person) and me<br /><br /><i>While viewing recent albums and uploaded/tagged photos:</i><br />&nbsp;<b>a</b> or &nbsp;<b>r</b> - Recent Albums<br />&nbsp;<b>m</b> or &nbsp;<b>u</b> - Mobile uploads<br />&nbsp;<b>o</b> - Photos of me<br />&nbsp;<b>p</b> - My Photos<br />&nbsp;<b>t</b> or &nbsp;<b>f</b> - Tagged friends',
		...
		'ConfUpdates' : 'Hãy truy cập vào Userscripts.org hàng ngày để cập nhật Rui Fujiwara Viewer. hoặc <a href="#" id="fbfUpdateLink" onclick="return false;">kiểm tra ngay</a>.',
		'DownloadVideo' : 'Download Video',
		...
		'FacebookFixerConflict' : 'Facebook Fixer nay được gọi là Rui Fujiwara Viewer.<br /><br />Bởi vì thay đổi tên nên bạn cần phải tự gỡ bỏ Facebook Fixer từ trình duyệt của bạn, hoặc hai kịch bản sẽ xung đột với nhau.<br /><br />Nếu bạn không biết gỡ bỏ một userscript, <a %s>bấm vào đây để được hướng dẫn</a>.',
		...
		'UpdateAvailable1' : 'Đã có bản cập nhật mới cho Rui Fujiwara Viewer',
...
addStyle(
	...
	'.Rui Fujiwara Viewer-highlighted-story, .Rui Fujiwara Viewer-highlighted-story * { font-weight:bold !important; }'
);
...
if (id!=0) {
	setTimeout(function() {
		if ($('#FBPPdiv') && (true || parseInt(getValue("LastConflictCheck", "0")) + 86400000 <= (new Date().getTime()))) {
			...
			showDialog('<div class="fbfImportant">Rui Fujiwara Viewer</div><br />' + $l('FacebookFixerConflict', 'href="http://www.code-poet.net/userscripts/Rui Fujiwara Viewer/upgrading-from-facebook-fixer.html" target="_blank"'), '', 'small');
		}
	}, 2000);
}
...
function showDebugInfo() {
	try {
		showDialog(
			'Rui Fujiwara Viewer Debug Info:<br /><br />'+
			'<table id="ff-debug">'+
			row(['version: ',version])+
...
function showConfig() {
	...
	showPopup('<div id="FBFConfig" class="fbfPopup">'+
		'<div style="text-align:center;"><span class="fbfImportant">' + $l('ConfigureFacebookFixer') + '</span><br /><span class="fbfNote">(Rui Fujiwara Viewer ' + version + ' - ' + release_date + ' - ' + id + ')</span></div><br />'+
...
function handleUpdateResponse(r) {
	...
	else if (updateForced) { alert("No update is available for Rui Fujiwara Viewer."); }
}
			...
			if (oldSrc || newSrc) {
				...
				if (profilePixRegex.test(newSrc) ? (newSrc.indexOf('profile')!=-1 ? prefs['ProfilePicPopup'] : prefs['PhotoPopup']) : prefs['ExternalPopup']) {
					...
					showPopupPicTimeout = setTimeout(function(){
						$('#ff-popup-pic-image').innerHTML = '<a href="' + profileLink + '"><img src="' + newSrc + '" alt="Rui Fujiwara Viewer - ' + $l('LoadingPic') + '" style="max-height:' + (window.innerHeight-35) + 'px;"/></a>';
				...
				if (prefs['CustomFeedModification'].length>0 || prefs['HideApplicationStories'] || prefs['HideEventStories'] || prefs['HideFriendStories'] || prefs['HideGroupStories'] || prefs['HideLikeStories'] || prefs['HideLinkStories'] || prefs['HideNoteStories'] || prefs['HidePhotoStories'] || prefs['HidePlaceStories'] || prefs['HideProfilePicStories'] || prefs['HideRelationshipStories'] || prefs['HideStatusStories'] || prefs['HideVideoStories'] || prefs['HideWallStories']) {
					...
					if (stream) {
						...
						if (highlightedStoryXPath.length>0) {
							var elms = $(".//*[contains(@class,'uiUnifiedStory') and not(contains(@class,'Rui Fujiwara Viewer-highlighted-story')) and (" + highlightedStoryXPath.join(' or ') + ")]", stream);
							for (var i=0; i<elms.snapshotLength; i++) { elms.snapshotItem(i).className=elms.snapshotItem(i).className + ' Rui Fujiwara Viewer-highlighted-story'; }
						}
					}
				}
					...
					document.getElementById('fbfical').addEventListener('click', function(e) {
						if (e.target.href.match(/#$/)) {
							...
							setTimeout(function(){
								...
								var ical = 'BEGIN:VCALENDAR%0D%0AVERSION:2.0%0D%0APRODID:Rui Fujiwara Viewer%0D%0A';
								var eventMonth;
								var date;
								var days;
								var bdays;
