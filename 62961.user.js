// ==UserScript==
// @name         Direktlink 1.0.1
// @namespace    http://www.pennergame.de
// @author       sageo[http://berlin.pennergame.de/profil/id:1146285/]
// @description  Fügt häufig gebrauchte Links als Buttons im Menü "Mein Penner" sowie Direktlinks auf wichtige Plunder im Plundermenü hinzu (HH und B, PG-Version 4.0)
...
// ********************************************************************************************************************
	...
	if (content.indexOf("PgFunction") != -1 || content.indexOf('title="Neue Nachricht"') != -1) {
		...
		var divnumber = 18;
  // sonst: Es wird keine Hinweisbox
	} else {
		var divnumber = 16;
	}
