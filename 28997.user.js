// ==UserScript==
// @name           Youtube Alternate Video Player redone
// @namespace      userscripts.org
// @description    Replaces the youtube flash video player with JW FLV Media Player flash video player. EXTREMELY recomend this if u want faster youtube videos. DO NOT DOWNLOAD THIS IF U HAVE A HIGH DEFINITION MONITER!!! HIGH DEF MONITERS WILL SUPPORT HIGH QUALITY VIDEOS BETTER! THIS PLAYER IS SET TO LOW QUALITY BY DEFAULT TO ENSURE FASTER PLAYBACK SPEED!!! U WILL AUTOMATICALLY GET FAT PLAYBACK IF U HAVE A HIGH QUALITY MONITER!!! to change the players quality to high, or medium, search the script for quality=low:and change it to medium or high. but u will get slower playback with higher quality. your choice.
// @version        0.1
...
function timedCount(){
	...
	if( ( iCanHazSpanna && document.getElementById('tempLoader') )=== null){
		...
		pD.innerHTML = '<div id="tempLoader" style="position:;width:480px;height:395px; background-color:transparent;"><p style="position:relative;top:50%;left:40%;font-weight:bold;">Loading Player &nbsp; '+
		...
		window.setTimeout(timedCount,0);
		...
		'allowfullscreen="true" '+
                                    'quality="high" '+  
		'flashvars="height=395&width=480&file='+spanTex+'.flv&image=http://img.youtube.com/vi/'+vidID+'/default.jpg&overstretch=true&showdigits=true&autostart=true&bufferlength=1&repeat=true&volume=100&javascriptid=mediaplayer&autobuffer=true" '+
		'/>		';
