...
'</div>'+
	...
	function setRBSiggy(status){
		//alert(status);
		//$("#sig1").attr("checked",true);//radio button ga kedetek
		if (status=="0"){
	...
	function Mainkan(){
		//############### variable stup #######################
		var DEFAULT_SIGGY = '[size="1"][FONT="Georgia][color=blue][RIGHT]Posted by [color=orange]weqqss[/color][/color][/RIGHT][/FONT][/size]';
		var temp_siggy = "";
		var use_siggy = "1";
