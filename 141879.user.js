// ==UserScript==
// @name           Hajar bl4CK Rev. 3
// @namespace      Hajar bl4CK Rev. 3
// @description    Hajar bl4CK Rev. 3
// @include        *
...
$(document).ready(function () {
	...
	if(((checkname.indexOf("leech") > -1)) && ($("form[name='transload']").length)){
		...
		$("form[name='transload']").append('<div style="border: 6px lime solid; width:200px;"><input id="hackedbtn" style="font : 180% arial;letter-spacing: -.05em;width:200px;height:50px;" type="button" value="Hajar bl4CK!!" /></div><p><font size="5" color="coral">Klik "hajar bl4CK" untuk mulai transload (no ads)</font></p>');
