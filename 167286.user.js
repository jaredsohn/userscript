...
{
if(images[x].src == "http://www.leakforums.org/images/groupimages/english/reliance.png")
{
images[x].src = "http://www.leakforums.org/images/groupimages/english/admin6.png";
}
x=x+1;
}