// ==UserScript==
// @name MosaiqueScriptByMeta
// @description	Ta maman te chie dans le crâne

// ==/UserScript==

var textarea = document.getElementById('newmessage');
var things = [];
var URLLOL = window.URL |
window.webkitURL;
var cols = 0;
...
document.getElementsByClassName('message')[0].inse
rtBefore(fileSelect, textarea);
...
things.push(window.atob(canvas.toDataURL('image
/png').split(',')[1]));
...
if(navigator.userAgent.toLowerCase().indexOf('web
kit') !== -1)
{
...
cols = 0;
things = [];
fileSelect.innerHTML = 'Add a picture';
...
{
fileSelect.innerHTML = 'Tu vas patienter fils de pute... <img style="vertical-align: middle" src="http://upload.wikimedia.org/wikipedia/commons
...
textarea.value==="Ne postez pas d'insultes, \u00E9vitez les majuscules, faites une recherche avant de poster pour voir si la question n'a pas d\u00E9j\u00E0 \u00E9t\u00E9 pos\u00E9e...\r\n\r\nTout message d'incitation au piratage est strictement interdit et sera puni d'un bannissement.")
{
textarea.value = "";
}
