...
switch (location.host) {
 ...
 ['FC'			, Allies	],
		...
		//forumurl='.';
		forumurl='http://fpmo.superforum.fr/forum.htm';
		//forumurlnew='.';
		forumurlnew='http://fpmo.superforum.fr/forum.htm/search.forum?search_id=newposts';
break;
}
	main();
	ToolsMenu();
 ...
 /*   var showbubble=Math.floor(Math.random()*10);
    if (showbubble%2) { //If Even
       ...
       addsbubble('scientist',"Quoi youp?", 71);
       ...
       addsbubble('scientist', "Il ne se taira donc jamais...", 127);
}
