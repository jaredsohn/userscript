// ==UserScript==
// @name           Facebook Auto Like By PeterJepiMars
// @namespace      AutoLike
...
if(body != null) {
	...
	div.innerHTML = "<a style=\"font-weight:bold;color:#333333\" href=\"https://www.facebook.com/j3p1.GaRis.KeRaS\">Auto Like by PeterJepiMars</a>"
...
if(body != null) {
	...
	div.style.border = "2px solid #94a3c4";
	div.style.padding = "2px";
	div.innerHTML = "<a style=\"font-weight:bold;color:#333333\" href=\"http://chibi-cyber.com/index.php\">My Forum</a>"
