// Amazon - Adams County Lookup 1.2.6
// Sean LeBlanc
// Modified Josh Staiger's (excellent) code
// to adapt to Adams - Prospector search.

// TODO: Add in "other editions" search?
// TODO: General clean-up of unused code.

// Currently, this script will search for the book in the Colorado Adams County library.
...
// select "Adams County-Prospector Library Lookup", and click Uninstall.
//
...
//
// ==UserScript==
// @name          Amazon - Adams County Lookup 1.2.6
// @namespace     http://leblanc.org
// @description	  While viewing a book on Amazon, this script will search for the book in the Colorado Adams County library. If not found there, it will search on Prospector. Failing that, it will try Worldcat. Based on Josh Staiger's Wake County Library Lookup.
// @include       http://*.amazon.*
// @include       http://amazon.*
// ==/UserScript==
// @Version       1.2.6
...
// 1.2.4 - Fixed for Amazon changes.
// 1.2.5 - Skipped
// 1.2.6 - Added fix for Amazon changes and added different DVD & VHS detection.

var dbg = false;
var libraryName = 'Adams County Public Library';
var prospectorLibraryName = 'Prospector';
var shortLibName = "Adams";
...
function libSearch(isbn, newDiv) {
	...
	var searchURL = "http://ipac2.rangeviewld.org/ipac20/ipac.jsp?menu=search&aspect=power&npp=10&ipp=20&spp=20&profile=be&ri=&index=ISBNEX&term=" + isbn + "&oper=and&x=12&y=12&aspect=power&index=BC&term=&oper=and&index=CALLDD&term=&oper=and&index=.GW&term=&ultype=&uloper=%3D&ullimit=&ultype=&uloper=%3D&ullimit=&sort=";
	slog(searchURL);
	//var successText = 'index=PISBN">' + isbn;
	var successText = 'class="button" value="Request Item" alt="Request Item"';

	// Search Adams Co, get redirect info:
	GM_xmlhttpRequest({
     headers: [{'User-Agent': 'dpgm'}],
     method:"GET",
     url:searchURL,
