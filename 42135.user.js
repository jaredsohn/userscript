 ...
 * CONFIG START
 */
cfg['resolution'] =      1025;  // screen-width (can be custom value)
...
cfg['fitZoom'] =         false;  // fit unzoomed video to comment-width
cfg['wideZoom'] =        false;  // use full page-width in zoom-mode
...
function setPlayer(quality){
	...
	document.getElementById('watch-player-div').innerHTML = '<embed id="movie_player" src="'+cfg['url']['player']+'" width=\''+width+'\' height=\''+height+'\' bgcolor="#000000" allowscriptaccess="always" allowfullscreen="true" flashvars="file='+escape('http://www.youtube.com/v/'+video_id+'&ap=&fmt=22')+'&showsearch=0&rel=0&image='+escape('http://i2.ytimg.com/vi/'+video_id+'/hq1.jpg')+'&skin='+escape(cfg['url']['skin'])+'&stretching='+cfg['stretching']+'&controlbar=over&autostart='+cfg['autostart']+'&backcolor=000000&displayclick=play" quality="high" name="movieplayer" style="width: '+width+'px; height: '+height+'px;" />';
