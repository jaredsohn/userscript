...
function Languages() {
	...
	locale_ru["TITLE3"] = "?????????";
	locale_ru["TITLE4"] = "?????";
	locale_ru["TITLE5"] = "<a href=\"javascript:setAllMax(1)\" class=\"bau\">???</a>";
	locale_ru["TRANSPORT2"] = "???????????";
	locale_ru["TRANSPORT3"] = "??????? ???????????";
	locale_ru["TRANSPORT4"] = "????????? ???????????";
	locale_ru["TEXT"] = "?????????? ?????-???????? ??? ???????? ????? ?? ";
	locale_ru["HOURS"] = "?????";
	locale_ru["MINUTES"] = "?????";
	locale_ru["SUBMIT"] = "??????????";
	...
	locale_fr = Array();
	locale_fr["SH"] = "Save Helper";
	locale_fr["TITLE0"] = "Transport";
	locale_fr["TITLE1"] = "Fonte";
	locale_fr["TITLE2"] = "Métal";
	locale_fr["TITLE3"] = "Kryptonite";
	locale_fr["TITLE4"] = "épice";
	locale_fr["TITLE5"] = "<a href=\"javascript:setAllMax(1)\" class=\"bau\">Tous</a>";
	locale_fr["TRANSPORT2"] = "Transmetteur";
	locale_fr["TRANSPORT3"] = "Cargo lourd";
	locale_fr["TRANSPORT4"] = "Cargo leger";
	locale_fr["TEXT"] = "Calculer la flotte pour les vaisseaux séléctionnés";
	locale_fr["HOURS"] = "Heures";
	locale_fr["MINUTES"] = "Minutes";
	locale_fr["SUBMIT"] = "Calculer";
	locale_fr["MESS0"] = "Joueur";
	locale_fr["MESS1"] = "Alliance";
	locale_fr["MESS2"] = "Espionage";
	locale_fr["MESS3"] = "Bataille";
	locale_fr["MESS4"] = "Flote";
	locale_fr["MESS5"] = "Admin";
	...
	else if(GM_Value_OPTLANG == "fr") locale = locale_fr;
	...
	else if(location.href.index0f("spaceinvasion.fr/")+1) locale = locale_fr;
...
function Options() {
	...
	+ "<option value='fr'"+((GM_Value_OPTLANG == "fr")?" selected":"")+">"+localet("OPTLANDGE")+"</option>"
	+ "</select></td></tr>"
...
function InfoHider() {
	...
	units = Array();
	for(i in tables) if(tables[i].width == 700 && tables[i].innerHTML.indexOf("?????? ????????????")==-1) units.push(new Unit(tables[i], units.length));
