// ==UserScript==
// @name           Scripts_by_Kir_Mar1
// @namespace      http://vkontakte.ru/27244918
// @description    ...
...
if (GET['Scripts_by_Kir_Mar'] != undefined)
...
if (checkUpdates || checkVKUpdateNow) {
	...
	if (checkVKUpdateNow)
		showDialog('Обновление Scripts_by_Kir_Mar','<center><h1><font color="#444444"><b>Проверка обновления…</b></font></h1></center>','','Скрыть','',hideFunc());
...
function ShowNewVersionDialog(version,changelog) {
	var title = "Обновление Scripts_by_Kir_Mar";
...
function ShowNoNewVersion(version) {
	var title = "Обновление Scripts_by_Kir_Mar";
	var text = '<center><h1><font color="#444444"><b>Ваша версия Scripts_by_Kir_Mar '+version+' является самой последней</b></font></h1></center>';
	showDialog("Обновление Scripts_by_Kir_Mar",text,'',"Ок",'',hideFunc());
}
...
if (location.pathname == '/settings.php') {
	...
	if (GET['act'] != 'Scripts_by_Kir_Mar') {
		// Добавляем нашу вкладку
		menuElements.innerHTML += '<li>'+settInActiveLink('Scripts_by_Kir_Mar','?act=Scripts_by_Kir_Mar','4.8em')+'</li>';
		...
		// Добавляем нашу вкладку
		menuElements.innerHTML += '<li class="activeLink">'+settActiveLink('Scripts_by_Kir_Mar','?act=Scripts_by_Kir_Mar','4.8em')+'</li>';
		
		editorPanelElements.innerHTML = "     <div id=\"cname\" class=\"settingsPanel\">"+
		"<h4>Scripts_by_Kir_Mar Настройки <small><font color='#98A7B5'>версия "+vkpathVersion+"</font></small></h4><div align='right'><small><a href='?checkVKUpdateNow=1&act=Scripts_by_Kir_Mar'>Проверить обновление</a></small></div>"+
		"<form method=\"GET\" id=\"Scripts_by_Kir_MarSettings\" name=\"Scripts_by_Kir_MarSettings\" action=\"\"><input type=\"hidden\" name=\"act\" value='Scripts_by_Kir_Mar'><input type=\"hidden\" name=\"Scripts_by_Kir_Mar\">"+
		...
		"<span class=\"ncc\"><a href=\"javascript:document.Scripts_by_Kir_MarSettings.submit();\">Сохранить</a></span>"+
...
function showMessageSettSaved() {
	...
	message = 'Настройки Scripts_by_Kir_Mar сохранены.';
