...
var SE={
	...
	se_config : {
		"百度":{
			...
			"历史收录":{"show":1, cfg:["http://tool.chinaz.com/history/?domain=#d", "百度历史数据,", "查询", "找不到和您的查询"]},
			},
		"近期收录":{
			"show":1,
	   ...
	   "雅虎":{
			"show":0,
			"收录":{"show":1, cfg:["http://tool.cnzz.com/yahoo/search.php?q=http://#d", "被收录的网页：　共", "条", "<font color=#DA3145>", null, null, "gb2312"]}
			},
		"搜狗":{
			"show":0,
			"收录":{"show":1, cfg:["http://www.sogou.com/web?query=site%3A#d", "找到约", "条结果", "<font color=#DA3145>", null, null, "gb2312"]},
			"外链":{"show":1, cfg:["http://www.sogou.com/web?query=links%3A#d","找到约", "条结果", "<font color=#DA3145>", null, null, "gb2312"]},
...
//			},
		"即刻":{
			"show":0,
			"收录":{"show":1, cfg:["http://www.jike.com/so?q=site%3A#d", "找到约", "条结果", "<font color=#DA3145>", null, null, "gb2312"]},
			"外链":{"show":1, cfg:["http://www.jike.com/so?q=domain%3A#d", "找到约", "条结果", "<font color=#DA3145>", null, null, "gb2312"]},
			},
		"奇虎":{
			"show":0,
		...
		"必应":{
			"show":0,
			"收录":{"show":1, cfg:["http://cn.bing.com/search?q=site%3A#d", "<span class=\"sb_count\" id=\"count\">", "条结果", "o match", null, null, "utf-8"]},
			"外链":{"show":1, cfg:["http://cn.bing.com/search?q=link%3A#d", "<span class=\"sb_count\" id=\"count\">", "条结果", "<font color=#DA3145>", null, null, "gb2312"]},
			},
		"alexa":{
			"show":0,
...
//参数区域结束
			...
			SE_Tool.get_part(
				...
				function(){
					...
					if( GM_getValue('last_version')!=undefined && new Date(GM_getValue('last_version'))<new Date(s) ){
						$("#se_check_version").html("<span style='color:red'>有新版本</span>，<a href='http://www.heku.org/firefox.js' id='install_it'>点击此处安装</a>");
	...
	init : function(){
		...
		if( GM_getValue('last_version') == undefined ){
			...
			this.showConfig();
			$("#se_check_version").html("成功安装脚本：<span style='color:red'>SEO in China</span><br />点击浮动层右上角的 <span style='color:red'>?</span> 可以查看更新脚本" ).next().hide();
			SE_Tool.get_part(
				"http://www.heku.org/firefox.js",
				"// @uso:timestamp",
				"// @uso:installs",
