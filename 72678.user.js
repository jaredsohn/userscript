// ==UserScript==
// @name           Mendigogame, Clodogame (P, M, Enfer) et Bumrise NY: Status des dons et de la tache journaliere
// @namespace      gefixt by Boggler, adapted by Lordclodo for CG and BR NY
// @description    Fonctionne avec Clodogame Paris, Marseille, Mendigogame et Bumrise USA
// @version	   1.2
...
document.getElementsByClassName("el1")[2].innerHTML = '<span name="Points" style="position:absolute;top:105px;right:110px;font-size:100%;-moz-border-radius:20px;-moz-opacity:1.8;opacity:1.8;"><span style=" color:'+farbe+'"><b>DONATIONS:&nbsp</b><br></span>';
...
if(document.location.href.indexOf('enfer.clodogame.fr/')>=0) {
var TASK_URL = 'http://enfer.clodogame.fr/overview/';
var TASK_name = 'Tâche du jour';
GM_xmlhttpRequest({
  	method: 'GET',
   	url: 'http://enfer.clodogame.fr/overview/',
        onload: function(responseDetails) {
        	var content = responseDetails.responseText;
			var text1 = content.split('as réussi à récolter')[1];
			var text2 = text1.split(',')[0];
...
// copyright by basti1012 und Boggler und Lordclodo