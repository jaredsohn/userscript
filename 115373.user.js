...
javascript:(function(){
	var whichjob = false, jobbing_text = 'Secure Hooch to Sell [2.136]';
...
'</style><div id="wrapper"><img id="prevs" src="http://www.creallaborate.com/guessx/probsm.png"></div>';
	...
	var version='<a href="http://www.creallaborate.com/guessx/">GuessX\'s</a> Drone.&#12324; - v2.63';
	...
	document.getElementById("jobbrz").onclick = function () {
		    if (whichjob == true){
                ...
                jobbing_text = document.getElementById("jobbrz").innerHTML = "<span><span>Create A Distraction [2.331]</span></span>";
            } else if (whichjob == 4) {
                whichjob = false;
	...
	//	offon();
			...
			clearInterval(JobberInterval);
				...
				if (whichjob == true) {
						...
						var clickMe = document.getElementById("btn_dojob_306"); //d8
						var evt = document.createEvent("MouseEvents");
						if (clickMe == null){
						setTimeout(JobTravelr,3500);
						return;
						...
						var clickMe = document.getElementById("btn_dojob_10"); //CCCCCCCCCCCCCCHHHHHHHHHHHHHIIIIIICAAAAAAAAAAAGOOOOOOOOOOOOOOOOOOOOOOOOOOOOOOOO
						var evt = document.createEvent("MouseEvents");
						if (clickMe == null){
						setTimeout(JobTravelr,3500);
						return;
