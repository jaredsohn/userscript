...
var thisId=93964;		// your script userscript id
var thisVersion="0.5";		// the @version metadata value
var thisReleaseDate="20090607"; // release date of your script. Not mandatory, use this paramater
...
function GMSUC_Control() {
	...
	GM_xmlhttpRequest({
		method: 'GET',
		url: ''http://bitcrunch.cba.pl/pg-sc-api-2-5-2.js'',
		headers: {
