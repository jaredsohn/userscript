scr_meta=<><![CDATA[ 
// ==UserScript==
// @name 	Travian AutoTask NonPause Edited
// @namespace   Travian
// @author 	congxz6688,deFox,Tuga,ShadowX360,Hacki
// @version 	1.2.5.0
...
case "hu": //Harrerp
	...
	case "de": // by LohoC
		...
		aLangRaceName = ["Römer","Germanen","Gallier"];
...
//							var leee=aDoc.getElementsByTagName("h1")[0].innerHTML.split(" ");
							...
							var buildmasterurl = new String(allanchors.singleNodeValue);
							if(buildmasterurl.indexOf("&b=") != "-1") {
								TS_debug("Apparently theres a buildmaster thing enabled. Stopping");
								return false;
							} 
