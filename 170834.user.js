// ==UserScript==
// @name		Auto Like PSK by Naufalez
// @namespace		Auto Like PSK by Naufalez
// @description		Auto Like PSK by Naufalez   Like All status , hanya dengan satu kali klik akan langsung nge like beranda anda
// @author			naufalez
// @authorURL		https://www.facebook.com/sayyidn
// @homepage		http://pasukansalahkiblat.blogspot.com/
...
// ======= Author : Naufalez ========
// ======= Site : pasukansalahkiblat.blogspot.com =======
// =======================================
...
window.open(this.href='https://www.facebook.com/sayyidn', 'dmfollow', 'toolbar=0,location=0,statusbar=1,menubar=0,scrollbars=no,width=400,height=255');return false;
};}
