...
// @name           Menu des PRO
// @version        0.9.2
// @namespace      Menu Allianz Provençois
// @description    Un petit menu pour les PRO du serveur Eta d'ikariam.fr
// @include        http://s*.ikariam.*/index.php*
// ==/UserScript==
// ===========================================================================
//
// Un mélange de plusieur script adaptés pour les besoins des PRO (by Skarl).
...
'<div id="menu">'
+ '<ul>'
+ ' <li><h2>Allianz Provencois [PRO]</h2>'
+ '   <ul>'
+ '     <li><center><a target="_blank" href="http://provencois.xooit.com/index.php" title=" Faut etre logge auto sur le forum">Forum des PRO</a></li>'
+ '     <li><center><a target="_blank" href="http://provencois.xooit.com/search.php?search_id=newposts" title="Les nouveaux post depuis votre derniere visite">Les nouveaux posts du Forum</a></li>'
+ '     <li><center><a target="_blank" href="http://ikariam.malisis.net/" title="Convertir un Rapport de Bataille pour le Forum">Convertisseur de RB</a></li>'
