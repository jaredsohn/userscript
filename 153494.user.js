          ...
          onload: function(responseDetails) {
            ...
            for (var x = 1; x < tr.length; x++) {
                ...
                if (tr[x].getElementsByTagName('td').length > 3) {
                    tr[x].getElementsByTagName('td')[2].setAttribute('style', 'display:none');
                }
                ...
                var newtd = tr[x].appendChild(document.createElement('td'));
                newtd.setAttribute('id', 'urlaub'+x);
                newtd.setAttribute('style', 'padding-top:6px; text-align:right;');

                Geldladen(myid, pts, minPts, maxPts, id[0],x);
            }
...
function Geldladen(myid, pts, minPts, maxPts, id, x) {
    ...
    //            tr[x].setAttribute('style', 'background:red;');
        ...
        var suche = content.search("Dieser Spieler befindet sich im Urlaub!</div>");
        try{
            if (suche != -1) {
