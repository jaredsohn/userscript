...
-------------------------------------------------------------------------------------------------------- */
	...
	/* white text color */
	styleText+='.scroll-tree li a.tree-link-selected .name, .scroll-tree li a.tree-link-selected:hover .name, .tree-selected .tree-link-selected .name-text.folder-name-text , #lhn-selectors .selected a span, #lhn-selectors .selected a:hover span, #nav .selected a, #nav .selected a .text{color:#222 !important}'
...
-------------------------------------------------------------------------------------------------------- */
	...
	styleText+="#search-input {background:black;border-color:#222}";
