// ==UserScript==
// @author         updated by Miki
// @name           eRepublik SJeB Military Tracker(SJeB edition)
...
function preFetchMembers() {
	...
	GM_xmlhttpRequest({
		method: 'GET',
		url: 'https://spreadsheets.google.com/pub?key=0AhicnfMJNxfSdHFzdmFSOEp5Y2hVT09ibzd0TzJNY2c&hl=sr&single=true&gid=1&output=csv',
		onload:function(response) {
