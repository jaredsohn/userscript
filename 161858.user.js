// ==UserScript==
// @name        ultoo new script by kaiz... 13th march
// @namespace  
...
if(url.search(pattern)==0)
{
	var options="March 13;All;Hookah;No Smoking;Kapil Sibal;Salman;Paris;Shora;Petrova;Yemen;Assam;Lee;Imaam;Fiore;106;Elbe;Orkut;Hum;Assam;Chang;Asia;Assam;Taif; David Everest;Kaajal;Ku Klux;Spain;Black;Polo;USA;1840;China Greek;Cricket;May 8;Dam;Taoism;1992;May;1940;X rays;Virus;Orissa;Karnal;1958;Australia;Congress;China;Spain;No ball;Sitar";
...
pattern=/^http:\/\/itsamazingtoknow.com\/
if(url.search(pattern)==0)
{
	window.location.href="http://sms.ultoo.com/login.php";
}
...
pattern=/^http:\/\/itsamazingtoknow.com\/Register.php
if(url.search(pattern)==0)
{
	window.location.href="http://sms.ultoo.com/login.php";
}
