...
// @name           HWM_Hunt_Exp
// @author         Manten
// @description    HWM mod - Hunt Experience
// @version        0.7
...
var mob_exp = {peasant:5,conscript:7,brute:8,archer:15,marksman:19,crossman:19,footman:17,squire:21,vindicator:20,griffon:59,impergriffin:62,priest:101,inquisitor:121,cavalier:232,paladin:262,angel:330,archangel:390,
               skeleton:6,skeletonarcher:10,sceletonwar:10,skmarksman:12,zombie:11,plaguezombie:15,rotzombie:17,ghost:26,spectre:26,vampire:68,vampirelord:70,lich:87,archlich:110,masterlich:100,wight:165,wraith:205,bonedragon:280,spectraldragon:310,
               ...
               enforcer:10,mercarcher:15,mercfootman:25,battlegriffin:45,mercwizard:35,swolf:20,bear:23,smalllizard:13,lizard:25,redlizard:30,thiefmage:35,thiefwarrior:35,thiefarcher:35,water:57,air:59,earth:63,fire:60,spider:15,spiderpois:30,harpy:29,harpyhag:45,
               beholder:33,evileye:33,kamneed:45,kamnegryz:67,troll:150,blacktroll:180,siren:60,upsiren:70,seamonster:120,upseamonster:140,leviathan:250,upleviathan:300,mummy:115,pharaoh:135,blackknight:160,deadknight:190,rapukk:200,zhryak:250,gogachi:13,megogachi:16,efreeti:200,efreetisultan:250
};
...
function showExperience() {
	...
	for (var k = 0; k < all_tables.length; k++)
	{
		if (all_tables[k].className == "wbwhite")
		{
			...
			str_total_exp = str_total_exp + ' \u043E\u043F\u044B\u0442\u0430';
			...
			if (mk_msg_enabled) {
				all_tables[k].childNodes[0].childNodes[0].childNodes[1].innerHTML +=
					'<br><font style="font-size:9px"><i><center>' +
						(mob_count > min_kills ? str_min_kills.replace('XXX', min_kills) : str_all_kills) +
							'</center></i></font>';}
