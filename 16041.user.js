	...
	for(var j = 0; j < quotes.snapshotLength; ++j) {
		...
		for (k = 0; k < assholeList.length; k++) {
			...
			if (thisQuote.innerHTML.match("<h4>" + thisAsshole)) {
				...
				newContent = '<a onclick="toggleQuote(\'' + quoteId + '\')">Quote from ' + thisAsshole + ' blocked; click here to show or hide it</a><br /><br /><div style="display: none;" id="' + quoteId + '">' + oldContent + '</div>';
