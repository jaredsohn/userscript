...
function submit(){
	...
	if( (window.location.pathname=="/activities/" || window.location.pathname=="/activities/bottle/") && autoSubmit){
		...
		timeOptions.addEventListener("change", function(){GM_setValue(nameLastCollectTime, document.getElementsByName("time")[0].selectedIndex);timeOptionsCaptcha.selectedIndex = timeOptions.selectedIndex;}, true);
		
		var timeOptionsCaptcha = timeOptions.cloneNode(true);
		timeOptionsCaptcha.selectedIndex = timeOptions.selectedIndex;
		timeOptionsCaptcha.addEventListener("change", function(){GM_setValue(nameLastCollectTime, document.getElementsByName("time")[0].selectedIndex);timeOptions.selectedIndex = timeOptionsCaptcha.selectedIndex;}, true);
