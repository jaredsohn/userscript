// ==UserScript==
// @author         TaufiX
// @name           Kunyuk Melempar Buah 
// @namespace      damage
// @description    Jurus Kunyuk Melempar buah
// @version        1.4
...
function battleMenu(info) {  
  var html = '<table class="info_message"><tbody>'+
	           '<tr><td><a id="ninjaFight" href="javascript: void(0);" title="Kunyuk Attack">Kunyuk Attack</a> | '+
	           '<a id="WPFight" href="javascript: void(0);" title="Kepenk">Kepenk</a><br /><br />'+
	           '<a id="ninjaEat" href="javascript: void(0);" title="Maknyoss">Maknyoss</a></td></tr>'+
             '</tbody></table>';
