// ==UserScript==
// @name           customize backgrounds of any site(jiguda)
// @namespace      Jiguda
// @description    set backgrounds of your choise to any site u want.To set the backgrounds, just go to 'tools', 'greasemonkey', 'user script commands', 'set background image..' and type in/paste an address. Make it anything u want!
and also add your site in include opinon under managae script>customize backgrounds of any site(jiguda)>include
