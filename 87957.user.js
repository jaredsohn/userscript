...
var cell = document.createElement('td');
	...
	cell.setAttribute('align', 'center');
	cell.style.color='white';
	var cellText = document.createTextNode('click on FORM NUMBER');
	cell.appendChild(cellText);
	row.appendChild(cell);
	 tblBody.appendChild(row);
	 var row1='';
	...
	var cellText = document.createTextNode('__1__');
	cell.appendChild(cellText);
	row.appendChild(cell);
if(row1!=''){
...
var tbl     = document.createElement('table');
	...
	cell.setAttribute('align', 'center');
	cell.style.color='white';
	var cellText = document.createTextNode('Click for submit at 8:00:01');
	cell.appendChild(cellText);
	row.appendChild(cell);
	tblBody.appendChild(row);
...
var tbl     = document.createElement('table');
 ...
 elmNewContent0.appendChild(document.createTextNode('SUBMIT NOW'));
