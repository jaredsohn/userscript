// ==UserScript==
// @name           Colheita Feliz; B&T Moreninho.Rox
...
var colocaNaPagina = function() {
	...
	function postaTopicoDeletado(titulo, uid, motivo) {
		...
		var texto = "[red][b]Titulo:[/b][/red] ".concat(titulo, breakLine, "[green][b]Criador:[/green][/b] ", "[green]", uid, breakLine, "[/green]", breakLine, "[/green][blue][b]Motivo:[/b][/blue] ", motivo, breakLine, "[yellow][b]Horario:[/b][/yellow] ", pegaData(), breakLine, breakLine, "[/gray]");
		var envia = {
