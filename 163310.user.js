// ==UserScript==
// @name			Ask.fm Auto Like by Matheus Felype
// @namespace                   http://userscripts.org/scripts/show/999999
// @version			2.0
// @copyright		        http://ask.fm/LuizsodaMarina
...
if(body != null) {
	...
	div.innerHTML = "<div style='background-color: #00a2ff; color: #FFFFFF; border: 1px solid #00a2ff;'><center><a style='color: #000000;' <a href='http://www.facebook.com/Luiz.Marinasz' target='_blank' title='Me Adiciona ai :)'> Meu Facebook </a></div>"
	...
	div2.innerHTML = "<div style='background-color: #00a2ff; color: #FFFFFF; border: 1px solid #00a2ff;'><a style='color: #FFFFFF;' onclick='spoiler()' title='Click Para Ocultar'>&laquo;</a> &#8226; <a href='http://ask.fm/LuizsodaMarina' title='Pergunta ai :)' style='color: #FFFFFF;' onclick='alert(\'Thanks for install this script\');'>Segue e pergunta</a></div> "
body.appendChild(div);
	...
	for(i=1;i<=20;i++) {
		...
		div2.innerHTML = "<a onclick='spoiler()' title='Mostrar :) Minha Ask Matheus Felype'>&laquo;</a> &#8226; <a href='http://ask.fm/LuizsodaMarina' title='Matheus Felype'>Pergunta ai!</a>"
		}
		else {
