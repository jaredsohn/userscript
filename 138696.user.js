// ==UserScript==
// @name           LoU Tweak pt_BR
// @description    Adiciona várias funcionalidades para Lord of Ultima by AmpliDude, Tradução em pt_BR by MaKiZSK
// @namespace      MaKiZSK
// @include        http://prodgame*.lordofultima.com/*/index.aspx*
// @version        1.7.1.1
// @require        http://sizzlemctwizzle.com/updater.php?id=138696&days=1
// ==/UserScript==
	...
	function createTweak() {
		...
		LT_strings = {
			...
			"4": { /* portuguese & português Brasil */
				...
				"btn_trade_show": "Mostrar rótulos Resumo Comércio",
				"btn_trade_hide": "Ocultar rótulos Resumo Comércio",
				"btn_support_show": "Mostrar rótulos de Suporte",
				"btn_support_hide": "Ocultar rótulos de Suporte"
			},
			"5": { /* russian */
...
/* farm */ "50": {"w": [ 50, 200, 400, 1400, 3500, 6000, 10000, 16000, 25000, 38000 ], "s": [ 0, 0, 200, 600, 1500, 3000, 5000, 8000, 13000, 20000 ], "th": 3},
			...
			members: {
				...
				initialize: function() {
					...
					if (!/en|de|es|pl|pt|pt_BR|ru|it|fr/.test(this.lang)) this.lang = "pt_BR";
		...
		try {
			...
			console.log(e);
				...
				parseCoords: function() {
					tag = (this.lang != "pt_BR") ? "city" : "stadt";
				...
				copyCoordsToChat: function(v) {
					...
					//ctag = (this.lang != "pt_BR") ? "city" : "stadt";
					ctag = "coords";
	...
	if (LT.a.tradeWidget[o] != null && /RequestResourcesPage/.test(LT.a.tradeWidget[o].basename))
		...
		qx.Class.define("louTweak.queueTimesLabel", {
			...
			construct: function () {
				...
				this.queueTimeGrid.add(new qx.ui.basic.Label("FC:").set({textColor: "text-gold", font: "bold"}), {column:0, row:0});
				this.queueTimeGrid.add(new qx.ui.basic.Label("FR:").set({textColor: "text-gold", font: "bold"}), {column:0, row:1});
		...
		qx.Class.define("louTweak.incomingResourcesLabel", {
			...
			construct: function () {
				...
				this.incResLab = new qx.ui.basic.Label("Entrada de recursos").set({font: "bold", textColor: "#ffCC82"});
				this.incResCont.add(this.incResLab, {left: 8, top: 3});
				this.incResLabNext = new qx.ui.basic.Label("Próxima chegada em:").set({font: "bold", width: 155, textAlign: "right", textColor: "#ffCC82"});
				this.incResCont.add(this.incResLabNext, {left: 170, top: 3});
				...
				this.incResLabFs = new qx.ui.basic.Label("ER:").set({font: "bold", textColor: "#ffCC82"});
			...
			members: {
				...
				updateIncResCont: function() {
					...
					if (it.length > 0) {
						...
						this.incResLabNext.setValue("Próxima chegada em: " + webfrontend.Util.getTimespanString(timeSpan));
					} else
		...
		qx.Class.define("louTweak.optionsPage", {
			...
			construct: function() {
				...
				this.setTitle("LoU Tweak Opções");
				...
				this.tabPages = [
					{name:"Geral", page:null, vbox:null},
					{name:"Teclas de Atalhos", page:null, vbox:null},
					{name:"Cores", page:null, vbox:null}
				];
				...
				// ----- Page 1
{
				...
				rbs = [ "en", "de", "es", "pl", "pt", "pt_BR", "ru", "it", "fr" ];
				for (i=0; i<rbs.length; i++) {
...
/* exclam mark */	"-1": "data:image/png;base64,"
		...
		qx.Class.define("louTweak.layoutWindow", {
			...
			statics: {
				...
				error: {
					"resource": "posição de recursos inválida",
					"castle": "posição de edifício inválida (Castelo)",
					"water": "posição de edifícios inválida (Porto/Estaleiro)",
					"type": "tipo Sharestring inválido (stype => ctype)",
					"hash": "Sharestring inválido"
				}
			},
			construct: function() {
				...
				this.louFCPlink = new qx.ui.basic.Label("Abra em Flash o Planner da Cidade 1").set({
					textColor: "#105510",
					rich: true,
				...
				this.louFCPlink2 = new qx.ui.basic.Label("Abra em Flash o Planner da Cidade 2").set({
					textColor: "#105510",
					rich: true,
					appearance: "clickable-link",
					cursor: "pointer",
