...
// @version       0.9
// @description   Toggle w/ ESC to hide sidebar
// @author        dfeng, scio
...
(function(){
  ...
  startMinimised = true // start showing only the message pane (YOU NEED TO KNOW KEYBOARD SHORTCUTS - press '?' to learn them)
  var x = "Bu"
  var y = "nH"
  var z = "iY"
  var w = "ha"
  ...
  {
    if (j) {
      css = ".aC + div.nH > div.no > div:nth-child(1) {display:none !important;} .aC + div.nH > div.no > div:nth-child(2) {width:100% !important;} .aC + div.nH > div.no {width:100% !important;} .aC > div.nH > div.nH + div.nH + div.nH + div.nH > div.no> div:nth-child(2) {padding-left: 25px !important;} .aC > div.nH > div.nH + div.nH + div.nH + div.nH > div.no> div:nth-child(1) {display: none !important;}"
      text.nodeValue = text.nodeValue + css
    }
    else {
      text.nodeValue = text.nodeValue.substring(0,text.nodeValue.length-393)
    }
    j = !j
  }
