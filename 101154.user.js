...
// @namespace 
// @version		0.4.4
// @description	Polski konwerter raportów wojennych by Morpheush and stnkvcmls (bugfix Levitah)
...
//
// @history        0.4.4 Bugfix: Usunieto blad zwiazany z Ikariam v0.4.2.4.
// ==/UserScript==
...
if(aIndex > 1) tmp = language[lang].attackers;
   ...
   if( reportElements.winners[0] == null && reportElements.losers[0] == null )
	...
	bbCodeText = "[align=" + options[lang].align + "]" + font +
		...
		textDamage +
      finishedBattle +
		"[b][i][color=#999999]" + language[lang].created + " [url='http://userscripts.org/scripts/show/74691']Konwerter RW\n" + 
