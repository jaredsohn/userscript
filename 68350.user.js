// ==UserScript==
// @name           Ejercito de eChile - Ejercito de Chile
// @namespace      www.erepublik.com
// @description    Ordenes para eChile (eRepublik)
// @version        0.01
...
GM_xmlhttpRequest({
	method: 'GET',
	url: 'http://ffaa.icxusach.info/orders.php?Id=8',
	...
	onload:function(response){
		...
		columna=document.getElementById('battle_listing');
