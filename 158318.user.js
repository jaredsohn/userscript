// ==UserScript==
// @name         Hide youngvirgin from WarriorsWorld Main
// @namespace    hide_youngvirgin
...
function main() {
	...
	if (post != null){
		...
		var message = 'You have been saved from ' + e.length + ' posts by youngvirgin!';
