...
// @include       http://*.beta.tribalwars.net/*screen=forum*answer=true*
// @include       http://*.beta.tribalwars.net/*screen=forum*edit_post_id*
// @include       http://*.beta.tribalwars.net/*screen=forum*mode=new_thread*
// @include       http://*.beta.tribalwars.net/*screen=forum*mode=new_poll*
...
Funktioniert mit Firefox 4.0+ (GM 0.9.2+) und Opera 10+
...
const forum = url.indexOf('screen=forum') != -1 && (url.indexOf('answer=true') != -1 || url.indexOf('mode=new_thread') != -1 || url.indexOf('edit_post_id') != -1 || url.indexOf('mode=new_poll') != -1);
...
function mainmenu(ev) {
	...
	h2.appendChild(document.createTextNode('Main menu'));	
	div.appendChild(h2);
	...
	var th = document.createElement('th');	
	tr.appendChild(th);
	th.appendChild(document.createTextNode('Homepage:'));
	...
	var th = document.createElement('th');	
	tr.appendChild(th);
	th.appendChild(document.createTextNode('Quick Preview (Alpha Version):'));
	...
	footer.appendChild(document.createTextNode('Licensed under the CC Attribution-Noncommercial-Share Alike 3.0 license '));
    footer.appendChild(document.createElement('br'));	
	var a = document.createElement('a');
	a.setAttribute('href','http://creativecommons.org/licenses/by-nc-sa/3.0/de/legalcode');
	a.setAttribute('title','CC Attribution-Noncommercial-Share Alike 3.0');
	a.appendChild(document.createTextNode('http://creativecommons.org/licenses/by-nc-sa/3.0/de/legalcode'));
