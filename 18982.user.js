// ==UserScript==
// @name Classement Ogspy V1
// @description Ajout d'un lien pour visualiser la progression d'un joueur grace à votre Ogspy d'alliance [http://ogsteam.fr/]
	...
	while (f<optionnode.length){
			...
			while (j<trnode.length){
				...
				if (thnode.length==5){
					...
					//alert(PlayerName);
					thnode[2].innerHTML += '<a href="http://www.votreogspy.net/OGSpy/index.php?action=search&type_search=player&string_search='+escape(PlayerName)+'&strict=on" target="Hauptframe"><img src="http://img144.imageshack.us/img144/5875/icongrowthog3.gif" alt="Evolution" border="0" width="13" Height="11"></a>';
				}
				j++;
			}
}