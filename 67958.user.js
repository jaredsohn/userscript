...
//juanlola var newCSS  = '.menuTabs{width:250px;background:none;}#menu{background:url("http://i.t.net.ar/images/bgLogged.gif") repeat-x scroll 0 0 #CCCCCC}';
var newCSS  = '.menuTabs{width:250px;background:none;}#menu{background:url("http://i.t.net.ar/images/bgLogged.gif") repeat-x scroll 1 0 #CCCCCC}';
