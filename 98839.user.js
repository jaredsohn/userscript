...
// @description    Auto Click Ads On Bux.to. Auto relads after 2-4mins if no ads are present. By JoeSimmons Image Fixed by Digiserve Co.
...
// 2.7 - Fixed Non Loading Image By TinyUrl New Image Created and Hosted on Imageshack
///////////////////////////////////////////////////////////////////////////////
...
sec.setAttribute("style", "background:url('http://img853.imageshack.us/img853/5394/72425957.gif'); color:#ddd; border:8px ridge #000; padding:5em; position:absolute; top:"+window.innerHeight/3+"px; left:"+window.innerWidth/2+"px; text-align:center;");
