...
// @description     Google: Fully Customisable Skins (columns, font colors, bgc etc.) | AutoPaging with Lazy Load Support | Remove Tracking/Redirection | URL Cleaner | Quick Search Filter | URL Blacklisting | SSL Search | Multiple Search Services | Quick Links To Google Services | SafeSearch Toggle Ad Removal... 
// @version         2.1.41d
// @include         *www.google.*
// @require         http://userscripts.org/scripts/source/160308.user.js
// @require         http://userscripts.org/scripts/source/159301.user.js
// @resource  meta  http://userscripts.org/scripts/source/159750.meta.js
...
// @versioninfo     Schmoogle 2:<br />There will be a delay in release of 2.2 due to RL issues. Here is a little fix for small menu bugs. Please show your appreciation by becoming a Fan of the script on USO (Userscript.org).
// ==/UserScript==
...
Script's Homepage:              http://userscripts.org/scripts/show/159750
