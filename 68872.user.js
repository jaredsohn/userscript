...
// ==UserScript==
// @name           Война племён скрипт Kexs Edit
// @version        0.15.1 Beta
// @namespace      xkexsx@gmail.com
// @description    карта 30х30 , сигнализатор атак, автовыход, блокировшик рекламы
// @include        http://bg*.tribalwars.eu/*
// @include        http://www.tribalwars.br/logout.php
// @include        http://ru*.voyna-plemyon.ru*
// @include        http://www.voyna-plemyon.ru/logout.php
// @copyright      Copyright (c) 2010, Kexs edit
// ==/UserScript==
...
if(url.indexOf("logout.php") != -1){
	window.stop();
	window.location="http://www.tribalwars.eu/";}
...
if(frmsets.length > 0){
	...
	plugins.mapexpand = { // altera Размер карты
  ...
  'enhance_game_map': function(){
	  ...
	  var iHtml = '<table><tr><td colspan="2">&nbsp;</td></tr><tr><td align="right">Размер карты: </td><td><select id="map_size_select" onchange="resize_map()">';
...
if (lang  == "pt-br") {
	var Text1 = " Настройки звука "; 					
	var Text2 = " Общее звучание: On / Off ";
	var Text3 = " Повтор звука, время ";
	var Text4 = " Громкость: ";
	var Text5 = " - Главный звук: ";
	var Text6 = " - Когда на тебя нападают ";
	var Text7 = " Повторять оповещение в случае нападения?";
	var Text8 = " - Возвращение войск: ";
	var Text9 = " - Новое сообщение: ";
	var Text10 = " - Новый отчёт: ";
	var Text11 = " - Сообщение на форуме: ";
	var Text12 = " forum url: ";
	var Text13 = " - Конец сессии: ";
	var Text14 = " минут ";
	var Text15 = " Примечание: Вы должны QuickTime для оповещения могут функционировать."}
