...
// @name        	Sondeator 
// @version			4.8
// @description 	Colaboracion con OGamator por sondeos
// @updateURL 		http://userscripts.org/scripts/source/136161.meta.js
// @downloadURL 	https://userscripts.org/scripts/source/136161.user.js
...
(function(){
	...
	if(document.URL.indexOf("page=messages") > 0)
	{
		IdEspia = $("meta[name='ogame-player-id']").attr("content");
		var img = "http://www.ogamator.com/Media/ojo.gif";
		$("#rechts").append("<div style='text-align:center;margin:10px;'><img class='OG' src='" + img + "' alt='OG' /></div>");
		$(".OG").css({cursor: 'pointer'});
