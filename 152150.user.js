...
var Extra = {
  ...
  services : {/*
    ...
    rest : {
      ...
      hosts : "imgchili.com | imagearn.com | imagebam.com | imageswitch.com | imageporter.com | imagetwist.com | cocoimage.com | imagehaven.net | imagevenue.com | turboimagehost.com | pixhost.org | hotimg.com | imagecherry.com",
      css : "\
      ...
      fn : function () {
        ...
        if (a = g('skip_button')) {
          if (isOpera) Extra.doc.addEventListener("DOMAttrModified", function () {
            if (isUrl(a.href)) return Extra.go(a.href);
          }, false);
        ...
        if (
          ...
          if (regexx(rgx, pattern)) Extra.cdwn = 7000;
    ...
    mirrorcreator : {
      hosts : "mirrorcreator.com",
      fn : function () {
        if (a = c1(".//div[@id='redirectlink']/a")) {
          return Extra.go(a.href);
        }
      }
    },
