// ==UserScript==
// @name           travianerbar/SLO
// @namespace      http://
// @description    slovenski travianer
...
var menuinner = '<img style="position: absolute; top: 6px; left: 10px; z-index: 98;" src="img/icons/supporticon_rules.gif" width="17px" height="17px" onmouseout="hideToolTip();" onmouseover="showToolTipText(\'Travianer/Travians bar \');" id="addOnMinimizer"/>'+
...
'<div id="TitleName" class="chatHeader" style="width: 194px;">.Travianer/Travians bar</div>'+
'<b>Pojdi:</b><br/>'+
'<a onclick="xajax_changeLocation(BGlocation, BGlocationRoom, BGlocationOwner, -1, 0, -1, 0); return false;">Lastna Hisa</a> | '+
'<a onclick="xajax_click(6174, 5168, 6616, 5163, BGlocation, BGlocationOwner, 0, 0, 0, 0); return false; ">Aliansa(hisa) </a> | '+
...
'<a onclick="xajax_click(4328, 7003, 4349, 7038, \'bank<<\', BGlocation, BGlocationOwner, -2, 0, 0, 0); return false; ">Banka</a> | '+
'<a onclick="xajax_click(5898, 5313, 6015, 5414, BGlocation, BGlocationOwner, 0, 0, 0, 0); return false; ">Aliansa(skladisce) </a> | '+
'<a onclick="xajax_click(6886, 5311, 6808, 5133, BGlocation, BGlocationOwner, 0, 0, 0, 0); return false; ">Orozarna</a> | '+
...
'<hr>'+
'<b>Market:</b><br/>'+
'<a class=info href="http://www.pflock.de/travianer/npc/alle.txt">NPC-Nagrada<span></span></a><br/>'+
//'<div id="npc"><a href="http://www.pflock.de/travianer/npc/alle.txt">NPC-Preise</a></div><br/>'+
'<a onclick="xajax_showModule(\'trade\',\'offersedit\',\'\'); return false;">Igralski Market </a>'+
'<hr>'+
// Für die Einlagerung
//'<b>Einlagerung:</b><br/>'+
...
//'<hr>'+
'<b>Napoji:</b><br/>'+
'Zelen+Zelen = Zivljenje<br/>'+
'Zelen+Moder = Napad<br/>'+
'Moder+Zelen = Napad(tocke)<br/>'+
'Moder+Moder = Obramba<br/>'+
'<hr>'+
'<b>Uporabni linki:</b><br/>'+
