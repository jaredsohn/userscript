// ==UserScript==
// @name          Travian: Attack builder Bosanski B.N.K.
// @description   Attack builder - Virtual (B.N.K.@gmail.com)
...
case "bs":
default:
		text = ["Namah ga fisni","Nevazeca vrsta napada!","nema kordinata!","nemadovoljno trupa! (trupa #","nije unesena trupa","Pocinje","Vjerovatno lose kordinate","Nemate izvidjaca","Zavrseno","Raspored talasa :","Dodaj novi talas","Reset","Raspored napada:","Vrsta napada:","Normalan","Pojacanje","Pljacka","Izvidjac Res/Trupe","Izvidjac Odb/Trupe","Koordinate","Isprasi guze! =)","Vrijeme dolaska","Dolazak у:","Namjesti vremenski interval","Broj napada tog specificnog napada","pomocu '|' нпр: 0,0|1,1","Greska:","Ne mogu do aktivnog sela. Predpostavljam nalog sa jednim selom","Vrijeme dolaska namjesteno u:","Vrijeme izmedju talasa u мс: (startno 500) "];

		cataText = ["Oznaci metu =)","Nasumicno","Drvosjeca","Rudnik gline","Rudnik zeljeza","Zito","Pilana","Ciglana","Ljevaonica","Mlin","Pekara","Skladiste","Silos","Kovacnica oruzija","Kovacnica oklopa","Mejdan","Glavna zgrada","Mjesto okupljanja","Pijaca","Ambasada","Kasarna","Stala","Radioanica","Akademija","Opstina","Rezidencija","Dvorac","Trgovacki centar","Velika kasarna","Velika stala","Herojska vila","Veliko skladiste","Veliki silos","Svjetsko cudo","Zgrada za blago"];
		break;
