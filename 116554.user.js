// ==UserScript==
// @name           Evribadilays unfollower
// @namespace      openminded
// @description    Tumblr kullanıcı takip mekanizması
...
// @author		   evribadilays.tumblr.com
// @version        1.0.0
...
function crearListadoDesdePagina (pagina_requerida, tumblelog, id_contenedor, listado, contador, paginasTotales, mostrar){
    if (pagina_requerida.readyState == 4){
		if(pagina_requerida.status == 200 || window.location.href.indexOf ("http") == - 1){
			...
			i++;
			var pageText = (esEspanol)?'<a title=\"Cantidad de páginas de seguidores revisadas\">Páginas revisadas</a>':'<a title=\"Number of followers pages revised\">Kontrol edilen sayfalar</a>';
var pageText2 = (esEspanol)?'Yapımcı: <a href=\"http://evribadilays.tumblr.com\" target=\"_blank\">evribadilays</a> & <a href=\"http://stajyermafya.tumblr.com\" target=\"_blank\">stajyermafya</a> ':'<br />Yapımcı: <a href=\"http://evribadilays.tumblr.com\" target=\"_blank\">evribadilays</a> & <a href=\"http://stajyermafya.tumblr.com\" target=\"_blank\">stajyermafya</a> ';
			document.getElementById('pageCounter').innerHTML = '<center><b>'+pageText+':</b> '+i+'/'+paginasTotales+' <br />'+pageText2+'</center>';
			if(i==paginasTotales){
...
function obtenerListadoFollowers(){
	...
	if(localStorage[tumblelog+"_followersList"]==null){
		...
		if(esEspanol){
			...
			instruccion+="<tr><td><h2>evribadilays unfollower</h2></td></tr>";
			instruccion+="<tr><td><p>No se ha detectado una ejecución anterior del Unfollow Hater desde este navegador para el tumblelog "+tumblelog;
			...
			var instruccion = "<table align=\"center\"style=\"text-align:justify\" width=\"300px\">";
			instruccion+="<tr><td><h2>evribadilays unfollower</h2></td></tr>";
			instruccion+="<tr><td><p>Lütfen bekleyiniz "+tumblelog;
			instruccion+=" Urlsinin tüm takipci verileri çekiliyor program kurulumu tamamladığında bu kutu kapanacaktır. Üsteki istatistik butonundan unfolloweri başlatabilirsiniz.</p></td></tr>";
			instruccion+="</table>";			
			lista.innerHTML += instruccion;
		}
		setTimeout(function(){
...
function mostrarUnfollows(tumblelog){
	...
	listaStr+="<tr><td><h2>evribadilays unfollower</h2></td></tr>";
	listaStr+="<tr><td>";
	listaStr+="<table align=\"center\"style=\"text-align:left\" width=\"300px\">";
	listaStr+=(esEspanol)?"<tr><td colspan=\"3\"><b>Estado Followers:</b></td></tr>":"<tr><td><b>Takipçi istatistiği:</b></td></tr>";
	listaStr+="<tr><td></td>";
	listaStr+=(esEspanol)?"<td><b>Antes</b></td><td><b>Despues</td></tr>":"<td><b>Önce</b></td><td><b>Sonra</td></tr>";
	listaStr+=(esEspanol)?"<tr><td><a title=\"Tüm kullanıcı sayısı gösteriliyor\"><b>Tüm: </a></b></td>":"<tr><td><a title=\"Takip eden kullanıcı sayısı\"><b>Tümü: </b></td>";
	listaStr+="<td>"+actualFollowers+"</td>";
	listaStr+="<td>"+nuevoFollowers+"</td></tr>";
	listaStr+=(esEspanol)?"<tr><td><b><a title=\"Cantidad de usuarios que no son spam, bots y que no están bloqueados\">No bloqueados:</a></b></td>":"<tr><td><a title=\"Spam ve bot olmayan kullanıcı sayısı\"><b>Bloke dışı:</a></b></td>";
