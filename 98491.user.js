// ==UserScript==
// @name           Power Tools - Ayhan35
// @namespace      ayhan35
// @include        http://*.kingdomsofcamelot.com/*main_src.php*
// @include        http://*.kingdomsofcamelot.com/*main_src.php*
// @include	   http://corpr8.co.uk/newalert/html
// @description    Enhancements and bug fixes for Kingdoms of Camelot
// @require        http://sizzlemctwizzle.com/updater.php?id=98335
// ==/UserScript==

var Version = 'KIZIL SAVASCILAR';
...
//logit ( 'Options.ptWinPos: '+ inspect (Options.ptWinPos, 5, 1)); 
  ...
  AddMainTabLink('Ayhan Power Tools', eventHideShow, mouseMainTab);
}
    ...
    var now = unixTime();
      ...
      for(i=0; i < Cities.numCities; i++) {
        ...
        row[i] = rp[1] - usage;
          ...
          var msg = '';
          if (timeLeft<(Options.foodWarnHours*3600) && timeLeft>0) {
