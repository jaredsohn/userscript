...
// @name        hpbux
// @namespace   hpbux
// @include     *://*hpbux.com/index.php?view=click*
// @include     *://*hpbux.com/index.php?view=account&ac=click*
// @include     *://*hpbux.com/index.php?view=account&ac=ptra*
// @include     *://*hpbux.com/gpt.php?v=entry*
// @include     *://*hpbux.com/gpt.php?v=read*
// @include     *://*hpbux.com/view.php?id=*
...
if(
(wparent.location.href.indexOf('index.php?view=click') != -1 || 
