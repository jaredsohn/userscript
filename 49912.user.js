// ==UserScript==
// @name           Barry Larkin
// @namespace      Barry Larkin
// @description    Barry Larkin
...
function findName(test) {
    if (test.innerHTML.indexOf('/game/home.pl?user_id=300353', 0)>=0) return 1;
  return 0;
}
...
for(var i=0,j=els.length; i<j; i++) {
	if (findName(els[i])){
		...
		els[i].innerHTML = els[i].innerHTML + '<b>Hans Hammer</b><br/>'
