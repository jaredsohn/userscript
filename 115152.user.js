// ==UserScript==
// @name          viewforum by Seed Aid aux64
// @namespace     http://lib.pirat.ca/forum
// @description   viewforum
// @include       http://pirat.ca/viewforum.php*
...
function needHelp() {
$.each($('span.seedmed b'), f1);//подсветка <4
$.each($('div.torTopic a.torTopic'), f2);//добавление кнопок    
...
function f2() 
{
		...
		var seltor = $(this);
		var seltor2, seltor3, seltor4, seltor5, seltor6;
