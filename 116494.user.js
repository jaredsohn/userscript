// ==UserScript==
// @name            الحصول على نقاط بأسرع وقت
// @namespace       LyTeR
// @description  البعض يريد ان يجمع اكبر عدد من النقاط بأقل وقت ممكن هذآ السكربت سيساعدهم
// @version         2.1.0
// @injectframes    1
...
gebaudepunkte[gebaude.typ[1]][gebaude.stufe[1]] + " نـقـطـة</span>";
        }
    }
}
...
function addCaption()
{
  ...
  newTd.innerHTML = "الــتـــــعـريـــــب لعــــــيــون مـآهــر..أهـدآء مـن LyTeR</a> &nbsp;";
