// ==UserScript==
// @author       luckyman, modified by tomasz.frelik(at)enzo.pl, modified by herrjeanke(at)hotmail.com, modified by arandia.t(at)gmail.com
// @namespace    http://userscripts.org/users/64220/scripts
// @version      1.0.1
// @name         Resource Planning Tool for Travian
...
var d_none=-1, d_highest=0, d_hi=1, d_med=2, d_low=3, d_lowest=4;
//* d_none is for the final release - don't forget to set it before uploading
var d_level=d_none;/*/
var d_level=d_highest;//*/

// for indexing the arrays...
var wood=0, clay=1, iron=2, crop=3;
// Order is: [wood, clay, iron, crop]
var res = new Array(4);
var res_p = new Array(4);
var res_stock = new Array(4);
