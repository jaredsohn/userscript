// ==UserScript==
// @name          Middletown NJ Public Library
// @namespace     http://www.middletown.lib.nj.us
// @description   On Amazon, display book availability in the Middletown, NJ Library. Based on LibraryLookup by Jon Udell.
// @include       *.amazon.*/*
// ==/UserScript==
...
var libraryUrlPattern = 'http://hip.mtpl.org:81/ipac20/ipac.jsp?menu=search&aspect=basic_search&npp=10&ipp=20&spp=20&profile=mid&ri=&index=ISBN&term='
var libraryName = 'Middletown NJ';
...
var libraryLookup = 
    ...
    insertLink: function(isbn, hrefTitle, aLabel, color )
        ...
        link.setAttribute('href', libraryUrlPattern + isbn + '&x=0&y=0&aspect=basic_search');
