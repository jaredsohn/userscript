// ==UserScript==
// @name The West - Trabajos Favoritos
// @namespace http://userscripts.org/users/161234
// @description Almacena Trabajos favoritos
// @author JoeSmith
...
function getAuthor() {
	...
	return MoCheck.getString('author') + '&nbsp;<a href=\"' + hrefStr + '\">JoeSmith</a>';
}
...
function init() {
	MoCheck.resourceBundle = {
		'dialog.closeAll.popup':'Cerrar todo',
		'dialog.minimize.popup':'Minimizar',
		'dialog.close.popup':'Cerrar',

		'dialog.tab.work.titel':'Trabajo',
		'dialog.tab.work.nothingSelected.1':'No hay un Trabajo seleccionado!!!! XD',
		'dialog.tab.work.nothingSelected.2':'Tenés que abrir un Trabajo y seleccionarlo... ;)',
		'dialog.tab.work.tableHeader.work':'Trabajo',
		'dialog.tab.work.tableHeader.points':'Puntos de Trabajo',
		'dialog.tab.work.tableHeader.points.popup':'Total de Puntos de Trabajo para cada uno',
		'dialog.tab.work.tableHeader.wages':'Salario',
		'dialog.tab.work.tableHeader.experience':'Experiencia',
		'dialog.tab.work.tableHeader.luck':'Suerte',
		'dialog.tab.work.tableHeader.motivation':'Motivación',
		
		'dialog.tab.configuration.titel':'Configuración',
		'dialog.tab.configuration.availableColumns':'Listas disponibles:',
		'dialog.tab.configuration.actual':'Actual',
		'dialog.tab.configuration.btnDelete':'Eliminar',
		'dialog.tab.configuration.btnRename':'Renombrar',
		'dialog.tab.configuration.btnNew':'Nueva',
		'dialog.tab.configuration.visibleColumns':'Columnas visibles en la lista:',
	
		'select.option.minutes':'Minutos',
		'select.option.hour':'Hora',
		'select.option.hours':'Horas',
		
		'btnOk.label':'Ok',
		'btnAdd.popup':'Agregar trabajo a la lista',
		'btnCenter.popup':'Centrar en el mapa',
		'btnDelete.popup':'Eliminar de la lista',
	
		'message.error.unableToDeleteCurrentList':'Imposible eliminar esta lista',
		'message.deleteList':'Estás seguro de querer eliminar esta lista???? :S',
		'message.newName':'Nueva lista:',
		'message.addedWork':'Trabajo añadido... :D',
		'message.deleteFromList':'Eliminar de esta lista????',
		'message.listLoaded':'Lista cargada... :D',
		'message.listDeleted':'Lista eliminada... ;)',
		'message.listRenamed':'Lista renombrada... ;)',
		'message.listCreated':'Lista creada... :D',
		'message.error.nameAlreadyDefined': 'Nombre actualmente en uso!!!! :P',
