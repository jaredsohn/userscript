...
// @version 0.4.5.1008
// @description Facebook mod for ASS Family.
...
var MWAddonInfo = {
    version         : '0.4.5.1008',
    name            : 'FBMW ASS MOD',
    tag             : 'FBMWaddonASSmod_',
    url             : 'http://www.dnkdesign.com.mk/amod/',
    meta_url        : 'http://www.dnkdesign.com.mk/amod/ass-4.51.user.js',
...
var Util = {
    ...
    rgbToHex: function(color) {
        ...
        if (color.charAt(0) !== '#') {
            ...
            if ((rgx = /rgba?\((\d+)[,\s]*(\d+)[,\s]*(\d+)\)/.exec(color))) {
                ...
                rgb = 1 << 24 | parseInt(rgx[1]) << 16 | parseInt(rgx[2]) << 8
                        | parseInt(rgx[3]);
    ...
    parsePopup: function(htmlText) {
        try {
            var sHtml = this.doRgx(
                    /\$\('#popup_fodder'\).html\("(.*?)"\);\s*?MW.Popup.show/,
                    htmlText).$1;
            if (sHtml) {
                eval('sHtml = "' + sHtml + '";');
                return sHtml;
 ...
 * @return {jQuery}
 */
function domDropDownSelect(id, options) {
    var buttonElt = c$('div').css({
        'position': 'absolute',
        'cursor':'pointer',
        'width': 140,
        'z-index': 1
    ...
    var containerElt = c$('div').css({'width':140,'display':'block'}).appendTo(buttonElt);
    c$('div').appendTo(containerElt).css({
        'padding': 2,
    ...
    .append(c$('span').text('Select Cities'))
    .append(c$('img').css('float','right').attr('src',global.zGraphicsURL+'dropdown_travel_arrow.gif'));

    var menuElt = c$('div', 'id:'+id).appendTo(containerElt).css({
        'z-index': 20,
    ...
    $.each(options, function(id, name) {
        c$('div').appendTo(menuElt).text(name).css('cursor','pointer').attr({
            'id': String(id).toLowerCase(),
            'name':'checkbox',
            'class':'checkbox',
            'onclick':'$(this).toggleClass(\'checked\');return false;',
            'onmouseover': "$(this).css('background-color','#444')",
            'onmouseout': "$(this).css('background-color','#111')"
        });
    });
...
function createMenu() {
     ...
     */
    var defaultRootMenu = [
        {name:'<span style="padding-left:65px;color: #FFD927;">ASS  MOD SETTINGS</span>',        'click': Configuration,}, 
        {name:'-',                        'line' : true                                      },
        {name:'<image src="http://mwfb.static.zgncdn.com/mwfb/graphics/icon_cash_16x16_01.gif" style="background-position: 0 50% no-repeat;" /><span style="padding-left:3px;"><span style="padding-left:3px;">Collect All Cities</span>',       'click': CollectAllCities },
		{name:'<image src="http://mwfb.static.zgncdn.com/mwfb/graphics/item_mysterybag_blue.png" style="background-position: 0 50% no-repeat; height:16px; width:16px;" /><span style="padding-left:3px;"><span style="padding-left:3px;">Free Gifts Center</span>',        'click': FreeGiftsCenter  },
		{name:'<image src="http://mwfb.static.zgncdn.com/mwfb/graphics/buy_hiredguns_75x75_01.gif" style="background-position: 0 50% no-repeat; height:16px; width:16px;" /><span style="padding-left:3px;"><span style="padding-left:3px;">Home Feed Center</span>',         'click': HomeFeedCenter   },
		{name:'<image src="http://mwfb.static.zgncdn.com/mwfb/graphics/icon_energy_16x16_01.gif" style="background-position: 0 50% no-repeat;" /><span style="padding-left:3px;"><span style="padding-left:3px;">Repeat Job Beta</span>',          'click': Repeatjobbeta                                    },
		{name:'<image src="http://mwfb.static.zgncdn.com/mwfb/graphics/icon_stamina_16x16.png" style="background-position: 0 50% no-repeat;" /><span style="padding-left:3px;">Battlefield v2</span>',         'click': Battlefieldv2                                    },
		{name:'<image src="http://mwfb.static.zgncdn.com/mwfb/graphics/icon_stamina_16x16.png" style="background-position: 0 50% no-repeat;" /><span style="padding-left:3px;">Assassin-a-Nator</span>',          'click': Assanator                                    },
		{name:'<image src="http://mwfb.static.zgncdn.com/mwfb/graphics/icon_cash_16x16_01.gif" style="background-position: 0 50% no-repeat;" /><span style="padding-left:3px;"><span style="padding-left:3px;">Robber BG Beta</span>',          'click': Robberbgbeta                                    },
        {name:'<image src="http://mwfb.static.zgncdn.com/mwfb/graphics/icon_health_16x16_01.gif" style="background-position: 0 50% no-repeat;" /><span style="padding-left:3px;"><span style="padding-left:3px;">Autoheal</span>',         'click': Autohealing								    },
        {name:'<image src="http://mwfb.static.zgncdn.com/mwfb/graphics/v3/icon_gift_27x28_01.png" style="background-position: 0 50% no-repeat; height:16px; width:16px;" /><span style="padding-left:3px;"><span style="padding-left:3px;">Gifts Page (Short Links)</span>', 'click': tofreegiftsPage        },
        {name:'<image src="http://mwfb.static.zgncdn.com/mwfb/graphics/huge_item_carlift_01.png" style="background-position: 0 50% no-repeat; height:16px; width:16px;" /><span style="padding-left:3px;"><span style="padding-left:3px;">Craft Manager (NY Only)</span>',            'click': CraftManager     },
		{name:'<image src="http://mwfb.static.zgncdn.com/mwfb/graphics/huge_item_carlift_01.png" style="background-position: 0 50% no-repeat; height:16px; width:16px;" /><span style="padding-left:3px;"><span style="padding-left:3px;">ASS Craft Manager beta (All cities)</span>',            'click': asscraftmanager     },
        {name:'<image src="http://mwfb.static.zgncdn.com/mwfb/graphics/map_based_jobs/expert_view/icon_megaphone.png" style="background-position: 0 50% no-repeat; height:16px; width:16px;" /><span style="padding-left:3px;"><span style="padding-left:3px;">Operations Center(FIXED)</span>',        'click': OperationsCenter,     'timer':'operationscenter' },
        {name:'<image src="http://mwfb.static.zgncdn.com/mwfb/graphics/v3/icon_gift_27x28_01.png" style="background-position: 0 50% no-repeat; height:16px; width:16px;" /><span style="padding-left:3px;"><span style="padding-left:3px;">Multi Gifter</span>',             'click': MultiGifter                                      },
		{name:'<image src="http://mwfb.static.zgncdn.com/mwfb/graphics/v3/icon_sheet_25x24_01.png" style="background-position: 0 50% no-repeat; height:16px; width:16px;" /><span style="padding-left:3px;"><span style="padding-left:3px;">Plug-In Manager</span>',          'click': PluginManager, 'submenu': buildPlugInMenu            },
        {name:'<image src="http://mwfb.static.zgncdn.com/mwfb/graphics/v3/icon_mafia_hat_32x25_01.png" style="background-position: 0 50% no-repeat; height:16px; width:16px;" /><span style="padding-left:3px;"><span style="padding-left:3px;">Inventory Analizer</span>',       'click': InventoryAnalizer                                },
        {name:'<image src="http://mwfb.static.zgncdn.com/mwfb/graphics/item_missioncrew_01.png" style="background-position: 0 50% no-repeat; height:16px; width:16px;" /><span style="padding-left:3px;"><span style="padding-left:3px;">Mafia Wiper</span>',              'click': MafiaWiper                                       },
        {name:'<image src="http://mwfb.static.zgncdn.com/mwfb/graphics/v3/icon_sheet_25x24_01.png" style="background-position: 0 50% no-repeat; height:16px; width:16px;" /><span style="padding-left:3px;"><span style="padding-left:3px;">My Links</span>',                 'click': UserLinks                                        },
        {name:'<image src="http://images3.wikia.nocookie.net/__cb20091210014813/mafiawars/images/9/93/Item_bangkok_passport_75x75_01.gif" style="background-position: 0 50% no-repeat; height:16px; width:16px;" /><span style="padding-left:3px;"><span style="padding-left:3px;">Go Atlantic City</span>',        'click': toAtlanticCity               },
		{name:'-',                        'line' : true                                      },
		{name:'<span style="color:green;">3x</span> Daily spins',         'click': freespins, 'timer':'freespins',								},
		{name:'<span style="color:red;">Toolbar</span> Minipack',         'click': toolbarminipack, 'timer':'toolbarminipack',								},
		{name:'<span style="color:yellow;">Daily</span> Email bonus',         'click': Emailbonust, 'timer':'Emailbonust'							},
		{name:'-',                        'line' : true                                      },
		{name:'<image src="http://mwfb.static.zgncdn.com/mwfb/graphics/item_mysterybag_blue.png" style="background-position: 0 50% no-repeat; height:16px; width:16px;" /><span style="padding-left:3px;"><span style="padding-left:3px;">ASS Link-a-Nator</span>',        'click': asslinkanator,  },
		{name:'<image src="http://mwfb.static.zgncdn.com/mwfb/graphics/item_mysterybag_blue.png" style="background-position: 0 50% no-repeat; height:16px; width:16px;" /><span style="padding-left:3px;"><span style="padding-left:3px;">ASS Get-a-Nator</span>',        'click': assgetanator  },
		{name:'-',                        'line' : true                                      },
		{name:'{ASS} Clanpage',       'click': Assfbpage                                       },
		{name:'MW Lootlady blog',       'click': Mwldpage                            },
		{name:'<a class="nofallow" href="http://www.dnkdesign.com.mk/amod/" target="_blank" style="float:right;padding-right:15px;font:10px;">Version: '+ MWAddonInfo.version + '</a></div>',       'click': ASSlinkpage,                     }
    ];
    /**
     * Root Menu Container
     */
    ...
    var Events = {
        ...
        hide_menu: function() {
            ...
            $('#fbmw_menu').stop().animate({'left': '-241px'}, 'normal');
        }
    };
    /**
     * Generate Menu.
    ...
    c$('style').text(global.Base64.decode(
        'I2ZibXdfbWVudV9hcnJvdyB7Cglwb3NpdGlvbjogYWJzb2x1dGU7Cgl6LWluZGV4OiAyNTsKCXRv'+
		'cDogMTBweDsKCWxlZnQ6IDJweDsKCXdpZHRoOiA0MHB4OwoJaGVpZ2h0OiA0MHB4Owp9CiNmYm13'+
		'X21lbnUgewoJcG9zaXRpb246IGFic29sdXRlOwoJei1pbmRleDogMzA7Cgl0b3A6IDEwcHg7Cgl3'+
		'aWR0aDogMjQxcHg7CgltaW4td2lkdGg6IDI0MXB4OwoJLW1vei1ib3JkZXItcmFkaXVzOiAyMHB4'+
		'OwogICAgLXdlYmtpdC1ib3JkZXItcmFkaXVzOiAyMHB4OwogICAgLWtodG1sLWJvcmRlci1yYWRp'+
		'dXM6IDIwcHg7CiAgICBib3JkZXItcmFkaXVzOiAyMHB4OwoJYm9yZGVyOiAxcHggc29saWQgI0ZG'+
		'RjsKCWZvbnQtc2l6ZTogMTJweDsKCWZvbnQtd2VpZ2h0OiBib2xkOwoJbGVmdDogLTI0MXB4OwoJ'+
		'dGV4dC1hbGlnbjogbGVmdDsKCWJhY2tncm91bmQ6IHVybCgnaHR0cDovL3d3dy5kbmtkZXNpZ24u'+
		'Y29tLm1rL2ZibXcvaW1hZ2VzL2Fzcy1iZzMucG5nJykgIzAwMDAwMCBuby1yZXBlYXQ7CglwYWRk'+
		'aW5nLXRvcDoxMTBweDsKfQojZmJtd19tZW51IGRpdi5hZGRvbl9zdWJtZW51IHsKCWRpc3BsYXk6'+
		'IG5vbmU7Cglwb3NpdGlvbjogYWJzb2x1dGU7Cgl6LWluZGV4OiAzMTsKCXdpZHRoOiAxODBweDsK'+
		'CW1pbi13aWR0aDogMTgwcHg7Cglib3JkZXI6IDFweCBzb2xpZCB5ZWxsb3c7CiAgICAgICAgYmFj'+
		'a2dyb3VuZC1jb2xvcjogIzAwMDsKCWZvbnQtc2l6ZTogMTJweDsKCWZvbnQtd2VpZ2h0OiBib2xk'+
		'OwoJdGV4dC1hbGlnbjogbGVmdDsKfQojZmJtd19tZW51IGEuYnV0dG9uX2FjdGlvbiB7Cgljb2xv'+
		'cjogd2hpdGU7CglkaXNwbGF5OiBibG9jazsKCW92ZXJmbG93OiBoaWRkZW47CglwYWRkaW5nOiA1'+
		'cHggMHB4IDVweCAxMHB4Owp9CiNmYm13X21lbnUgYS5tYWluIHsKCWJvcmRlci1ib3R0b206IDFw'+
		'eCBzb2xpZCAjNkI2QjZCOwp9CiNmYm13X21lbnUgYS5idXR0b25fYWN0aW9uOmhvdmVyIHsKCWJh'+
		'Y2tncm91bmQtY29sb3I6ICMzMjMyMzI7Cgljb2xvcjogI0ZGRDkyNzsKCXRleHQtZGVjb3JhdGlv'+
		'bjogbm9uZTsKfQojZmJtd19tZW51IC5ub2hvdmVyIGE6aG92ZXIgeyBiYWNrZ3JvdW5kLWNvbG9y'+
		'OiB0cmFuc3BhcmVudDtjb2xvcjogI0ZGRDkyNzt0ZXh0LWRlY29yYXRpb246IG5vbmU7IH0K'
...
/**
 * Custom ASS MOD functions
 */
function Mwldpage() {
unsafeWindow.open('http://mwlootlady.blogspot.com/');
}
function ASSlinkpage() {
unsafeWindow.open('http://www.dnkdesign.com.mk/amod/index.html');
}
function Assfbpage() {
unsafeWindow.open('http://www.facebook.com/groups/assfamily/');
}
function Emailbonust() {
unsafeWindow.open('http://www.facebook.com/topic.php?uid=131902633521767&topic=556');
}
...
function assgetanator() {
location.href = 'javascript:(function(){var a%3Ddocument.createElement("script");a.type%3D"text/javascript";a.src%3D"http://slotmachine.spocklet.com/free_gift_get_a_nator.js%3F"%2BMath.random();document.getElementsByTagName("head")[0].appendChild(a)})();';
}

function asslinkanator() {
location.href = 'javascript:(function(){var a%3Ddocument.createElement("script");a.type%3D"text/javascript";a.src%3D"http://slotmachine.spocklet.com/link-a-nator.js%3F"%2BMath.random();document.getElementsByTagName("head")[0].appendChild(a)})();';
}

function asscraftmanager() {
location.href = 'javascript:(function(){var a%3Ddocument.createElement("script");a.type%3D"text/javascript";a.src%3D"http://www.dnkdesign.com.mk/amod/ass.mod.craft.manager.js%3F"%2BMath.random();document.getElementsByTagName("head")[0].appendChild(a)})();';
}


function Repeatjobbeta() {
...
function freespins(){
$slotlink='http://apps.facebook.com/inthemafia/track.php?next_controller=index&next_action=view&zy_track=feed&sendkey=a&ztrack_category=win_slot&next_params={%22playslots%22:%221%22,%22fromminifeed%22:%221%22,%22wins%22:%222%22,%22user_id%22:%22p|0%22}'
			unsafeWindow.open($slotlink);
			unsafeWindow.open($slotlink);
}
function Assanator() {
...
function Battlefieldv2()
{
    ...
    var fightStats = {
		...
		exp_per_ice    : function() {
            var n = (fightStats.total_ices / fightStats.total_fights) * 100;
            return isNaN(n) ? 0 : n.toFixed(2);
        },		
    ...
    var CSIce = function(fight_result) {
		...
		this.seasonIces_total = fight_result.ices_target - fight_result.ices_so_far;
        this.action = '';
    ...
    var Events = {
        ...
        saveSession_click: function() {
            ...
            $.each({
                ...
                'Players Attacked: '           :'foes_attacked',
                'Players ICED: '               :'iced',
                'Players KILLED: '             :'kill',
				...
				'Ices Per 100 Stamina: '  :'exp_per_ice',
                'Victory Coins: '           :'coins'
            },
            function(name, value) {
        ...
        autoMode_click: function() {
            ...
            options.fromDomElements();
            options.save();
            PlayerList.maxCache = 15;
            if ( options.get('useNewPlayerDelay') ) {
                PlayerList.maxCache -= (options.get('newPlayerDelay')*3);
            }
            log$('max. cache: '+PlayerList.maxCache);
            toFightScreen();
            if (options.get('forceStartingCity')) {
                StartCity = options.get('startingCity');
            }
    ...
    function genMainDom() {
        ...
        ).append(domDropDownSelect('travel_to_cities_menu', {
        ...
        .append(x$('bfopt_userapidfire', 'Rapid Fire! if attacks less than:'))
        .append(n$('bfopt_rapidfirewhen', 60))
        ...
        ).append(domDropDownSelect('back_to_cities_menu', {
        ...
        /*
        .append(c$('div').css('margin-left',370)
		...
		*/
        ...
        .append(x$('bfopt_keepattackafterwon', 'If i did won.'))
        ...
        // NEXT PAGE BUTTON
        c$('li').appendTo(divListElt)
        .append(n$('bfopt_healtimer', 'Heal Timer: you can heal every:', 60))
        ...
        .append(c$('input:text', 'bfopt_namefilterval').width(160))
        ...
        .append(x$('bfopt_skipifotherdamage', 'Skip if damage from others.'));
        ...
        c$('li').appendTo(divListElt)
        .append(x$('bfopt_keepfigthing', 'Keep running and resume after:'))
        .append(n$('bfopt_resumedelay', 60))
        .append(c$('span').text(' minutes.'));

        c$('li').appendTo(divListElt)
        .append(x$('bfopt_fighttime', 'Pause after:'))
        .append(n$('bfopt_fighttimeout', 60))
        .append(c$('span').text(' minutes.  And resume after: '))
        .append(n$('bfopt_fighttimeoutresume', 60))
        .append(c$('span').text(' minutes.'));
        ...
        c$('div').css({'float':'left','text-align':'left','margin':5,'width':500}).appendTo(listTab)
        .append(x$('bfopt_addusertowlist','Add to WhiteList if gain same or more than:'))
        ...
        $.each([
            ...
            {name:'Players Attacked:',     cls:'attack',              id:'foes_attacked'                      },
            {name:'Players ICED:',         cls:'stat_iced',           id:'iced'                               },
            {name:'Players KILLED:',       cls:'stat_kill',           id:'kill'                               },
            {name:'Total ICES:',   cls:'stat_kill',           id:'total_ices'                         },
			...
			{name:'ICES per 100 stamina:',  cls:'stamina',          id:'exp_per_ice'                        },
        ...
        popupElt.applyOptions({
            ...
            'bfopt_skipifhealth'    : {20:'> 20%', 40:'> 40%', 60:'> 60%', 80:'> 80%'},
    ...
    function genEnemyListDom() {
        ...
        PlayerList.each(function(index, pl) {
            ...
            .append(c$('div', 'class:update_icon').append(
                c$('img', {
                    'width': 40,
                    'height': 40,
                ...
                .html(( pl.title?pl.title+'<br>':'' ) + ' ' + pl.anchor() + '<br>Level: ' + pl.level)
    ...
    function addIcedToLog(ice, opp, killed) {
        ...
        if ( killed ) {
            fightStats.kill++;
            fightStats.total_ices += 2;
            eventText = ' KILLED ';
        }
        else {
            fightStats.iced++;
            fightStats.total_ices++;
        }
        ...
        if ( opp.isThief ) {
 		...
 		text += eventText + opp.anchor() + ' to get '+ ice.count + '.';
            text += '<br>Season ices: ' + ice.season_ices + '/' + ice.season_target + '.'; 
			text += '<br>' + ice.action;
    ...
    function preAttack() {
        ...
        if (op('usePowerAttack') && opp.pwratk) {
            ...
            if ( op('useRapidFire') && opp.fights_for_ice > 4 ) {
                if ( opp.fights_for_ice < op('rapidFireWhen') ) {
                    nRapidFire = Math.ceil(opp.fights_for_ice / 5) + 1;
                }
            }
        }
    ...
    function AttackWithRapidFire( url, nRapidFire ) {
        ...
        interval_id = setInterval(function() {
            httpAjaxRequest({'url':url,'liteLoad':1,'id':count,'success': rapidFireResponse});
            count++;
            if ( count >= nRapidFire ) {
                clearInterval(interval_id);
            }
    ...
    function parseAttack(htmlText, autoMode, bRapidFire) {
        ...
        // APPLY STATS
        fightStats.season_ices   = fight_result.ices_so_far;
        fightStats.season_target = fight_result.ices_target;
		fightStats.seasonIces_total = fight_result.ices_target - fight_result.ices_so_far;
        ...
        {
            if ( opponent.lastWon > 0 && attack_again === true && options.get('keepAttackAfterWon') ) {
                if ( !opponent.attackWithBoost && !bAttackerUsedBoost ) {
                    opponent.attackWithBoost = true;
                    addToLog('You lost after win '+opponent.lastWon+' figths.<br>Attack Boost activated to win!','blacklist',opponent.image);
                }
            } else {
                attack_again = false;
                ...
                if ( options.get('useBlacklist') ) {
                    if (PlayerList.addCurrentToBlackList()) {
                        ...
                        addToLog('"The Player" '+opponent.anchor()+' is too strong!, added to BlackList.','blacklist',opponent.image);
                    }
                }
            }
        }
    ...
    function updateFightResponse(response) {
        ...
        if (bAttackerUsedBoost !== (fight_result.boost.total_qty > 0)) {
...
function Configuration() {
    ...
    function createCheckBox(id, label) {
        ...
        return c$('div', {
            ...
            'name':'checkbox',
            'min-width': 50,
            'class':'checkbox clearfix'+(bChecked?' checked':''),
            'onclick':'$(this).toggleClass(\'checked\');return false;'
        }).text(label);
    }
    // add style
    ...
    function genMainDom() {
        ...
        $.each(checkboxes, function(index, item) {
            createCheckBox('main_'+item.id, item.label).appendTo( thisTab );
        });
        ...
        createCheckBox('main_usebitly', 'Use bit.ly service for shorting url.').appendTo(thisTab);
        ...
        createCheckBox('main_publishPreview', 'Use Facebook user interface.').appendTo(thisTab);
...
function FreeGiftsCenter()
{
    ...
    function genMainDom() {
        ...
        .append(c$('label','for:freegifts_collectnomafia').text('Collect gifts from non-mafia members.'))
        .appendTo(cnfgBody);
...
function HomeFeedCenter()
{
    ...
    var CSStream = function(feed) {
        ...
        var url_params, url_params, stream_action, group_name;
...
function ReminderChecker(url) {
    ...
    options.load(function() {
        ...
        $.each(options.get('all'), function(index, r) {
            ...
            if ( r.resetonload === true && testUrl(r.resetonloadurl) ) {
                c_reminder = r;
                log$('Reminder updated due resetonload: '+r.resetonloadurl+' url:'+url);
                updateReminder();
            }
            else if ( !r.time || r.time < now ) {
                log$('Reminder fired: '+r.name);
                c_reminder = r;
                showReminder();
                return false;
            }
    ...
    function updateReminder(time) {
        var now = Util.now();
        if (!Util.isSet(time)) {
            time = (c_reminder.every>0 ? c_reminder.every*60 : 30);
        }
        c_reminder.time = now + (parseInt(time)*60);
        log$('Reminder '+c_reminder.name+' Set to:'+Util.toDateString((c_reminder.time-now)*1000));
        options.save();
    }
...
function ReminderEditor() {
    ...
    var Events = {
        ...
        timer_change: function() {
            var rID = selectedReminderID();
            var reminder = options.get('all')[rID];
            reminder.time = Util.now() + (parseInt(reminder.every)*60);
            return false;
        },
    ...
    function addNewReminder(index, reminder) {
        c$('li', 'app_id:'+index).appendTo($('#app_list',popupElt.content))
        .click(Events.field_click).append(c$('span').text(reminder.name));
    }
    ...
    function saveSelectedReminder() {
        ...
        $('li[app_id='+rID+'] span').text(reminder.name);
        options.save();
    }
    ...
    function genMainDom() {
        ...
        .append(n$('setting_every', 'Remember every:').change(Events.timer_change))
 ...
 */
function PageClan() {
    var toWhitelist = c$('div');

    c$('div').text('BATTLEFIELD:').append(toWhitelist).insertAfter('#clan_profile_link').css({
        'padding':'0px 10px',
        'text-align':'left',
        'font-weight':'bold',
        'height': 50,
    ...
    c$('strong','class:good').css('font-size',12).appendTo(toWhitelist)
    .text('Click on "Add all users" to get all in your Whitelist.');

    b$('Add all users','class:short green').css('float','right').appendTo(toWhitelist).click(function()
    {
        var bfc = new Config('bfopt', defaults.bfopt);
        //var clanName = $('#clan_header h3').text();
        var n_added = 0;
        var wl;

        bfc.load(function() {
            wl = bfc.get('whiteList');
            showAskPopup('Clear WhiteList','Do you want to clear Whitelist before add the clan members?',clearwl,addMembers);
        });
        function clearwl() {
            bfc.set('whiteList', wl = new Object());
            addMembers();
        }
        function addMembers() {
            ...
            bfc.save(function() {
                showHelpPopup({
                    icon: 'info',
                    title: 'Adding clan members to WhiteList',
                    message: 'You\'ve added '+n_added+' users to Battlefield\'s Whitelist!',
                    autoclose: 5
                });
            });
        }
...
(function(){
    ...
    function addVersionText() {
        ...
        if (canvas_iframe !== null) {
			...
			'<a href="'+ scriptAppInfo2.appUnframe +'">Unframe Mafia Wars</a></span>';
