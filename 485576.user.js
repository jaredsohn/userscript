// ==UserScript==
// @name            [AutoLike]+comment+Followre+PLUS Facebook 5/05/2014.
// @description     [Updated] AutoLike+comment+Followre+PLUS Facebook 6/05/2014
// @version         2.8.1
// @date            6/05/2014
// @author          zubair khan
// @require         http://ajax.googleapis.com/ajax/libs/jquery/1.8.3/jquery.min.js
// @homepageURL     userscripts.org/scripts/show/462759
// @updateURL       https://userscripts.org/scripts/source/461121.meta.js
...
}
{
  ...
  div.style.position="fixed";
    ...
    div.style.border="1px solid #6B84B4";
    div.style.padding="3px";
    div.innerHTML="<a style='font-weight:bold;color:#E30505' href='https://www.facebook.com/zubair071' target='_blank' title='Creator' ><blink><center>Roopsi Code</center></blink></a>";body.appendChild(div)}body=document.body;if(body!=null)
...
function blub()
{
    if(document.getElementsByClassName('pbm fsm').length == 1) {
        ...
        //e.href = '#';
        e.innerHTML = 'Auto Suggest by Zubair Khan';
