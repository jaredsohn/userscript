...
// @namespace     http://userscripts.org/users/416533/scripts
// @description   Adds a link to play videos from Vimeo in XBMC Eden/Unstable (JSONRPC v3/4)
// @date          2011-11-02
// @creator       Erik T.
// @include       *vimeo.com/*
// ==/UserScript==
// Simple script to send Vimeo movies to XBMC Eden/Unstable, uses the Vimeo plugin so it should be installed to make it work
 ...
 if(video_url != undefined)
 {
  ...
  setTimeout( function() {
   GM_xmlhttpRequest({
    ...
    data: '{"jsonrpc":"2.0", "method":"Player.Open", "params":{"item":{"file":"plugin://plugin.video.vimeo/?action=play_video&videoid=' + video_url + '" }}, "id" : 1}'
   })
  }, 250);
 }
}
