...
var CurrentScriptVersion = '2.3.2';
...
// link 1 name
var jn_quicky_1_nam = GM_getValue("jn_quicky_1_namIn" + UserId , "Freund Empfehlen" );
// link 1 url
var jn_quicky_1_url = GM_getValue("jn_quicky_1_urlIn" + UserId , "http://anthek.de/?p=4009" );
...
// start linkkette 0
var CJappySupport = "<div id=\"cjsb\" class=\"main_point jn_box_shadow\">Anthek Navi "+CurrentScriptVersion+"</div>";

var CJappyNaviCom = "<a class=\"jn_sb_ic\" id=\"cjnc\" href=\"/com\" target=\"_self\"><span class=\"icComs\"></span></a>";

var CJappyMailto = "<a class=\"jn_sb_ic\" id=\"cjmt\" href=\"/mailbox/new?to=\" onclick=\"MessageSystem.compose(null, '');return false;\"><span class=\"icMailNew\"></span></a>";

var CJappyGorgon = "<a class=\"jn_sb_ic\" id=\"cjpg\" href=\"/user/\" onclick=\"return Jpy.popupProfile('')\"><span class=\"icBuddyCode\"></span></a>";

var CJappyHome = "<a class=\"jn_sb_ic\" id=\"cjhp\" href=\"http://www.lmgtfy.com/?q=anthek\" target=\"_blank\"><span class=\"icSt18\"></span></a>";
...
var anzeige_1 = "<div id=\"jpy_nav_upd_anz\" class=\"info cf\"><div class=\"icon cf\"><div class=\"text\">Jappy Navigator<br>Update</div><div class=\"green\"><div class=\"pointer\">&nbsp;</div></div></div>";
...
document.getElementById('cjsb').innerHTML = 'Anthek Navi Com';
},false);
document.getElementById("cjnc").addEventListener("mouseout", function anzeige () {
document.getElementById('cjsb').innerHTML = 'Anthek Navi '+CurrentScriptVersion+'';
},false);

// mouse over/out mail gorgon
document.getElementById("cjmt").addEventListener("mouseover", function anzeige () {
document.getElementById('cjsb').innerHTML = 'Mail an ';
},false);
...
document.getElementById('cjsb').innerHTML = 'Jappy-Profil von ';
},false);
...
document.getElementById('cjsb').innerHTML = 'Script-HP Anthek.de';
},false);
...
/* 2010-11-16 21:15 2.5      Update fÃ¼r geaendertes Jappy-Interface                    */
/*                                                                                     */
/***************************************************************************************/
/////////////////////////////////////////////////////////////////////////////////////////
...
function showSettingsScript()
{
  ...
  tbody.childNodes[4].childNodes[0].childNodes[0].innerHTML = "Mindestalter fÃ¼r besuchte Profile";
  tbody.childNodes[4].childNodes[1].appendChild(createNodeWithTwoProperties("input", getValue("minage"), "type", "text", "class", "inW2 w320"));

  tbody.childNodes[5].childNodes[0].childNodes[0].innerHTML = "Maximalalter fÃ¼r besuchte Profile";
