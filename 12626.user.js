// ==UserScript==
// @name           MySpace Homepage Redesign
// @description    Redesigned MySpace Homepage
...
GM_addStyle(".googleafc {display:none;}");

// NEW MYSPACE HOME PANEL
GM_addStyle("#ctl00_cpMain_GrayBoxRounded.Skin_CMS_GrayBoxRounded {display:none;}");
GM_addStyle("#gbitem {display:none;}");
GM_addStyle("#gbcategory {display:none;}");
GM_addStyle("#header {display:none;}");
GM_addStyle("#topnav {display:none;}");
GM_addStyle("#col3 {display:none;}");
GM_addStyle("#col2 {width:370px;}");
GM_addStyle("#friendspace {position:absolute;top:82px;left:730px;width:370px;}");
