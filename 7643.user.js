...
select "Fark Butler", and click Uninstall.
*/
...
(function() {
	...
	fark.injectCSS(".banhead, .newtoolbar  { display: none;}");
	fark.injectCSS("form, .howto, .topsubmit { display: none; }");
	...
	fark.injectCSS(".dateheader, .farkivea, .farkiveb, .copyright, .footnote, .finalfootnote { background: #EEF; bgcolor: #EEF}");
	fark.searchforlinks();
