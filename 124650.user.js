// ==UserScript==
// @name           Facebook Auto Like By. ASYROFUL• 
// @namespace      facebook_auto_like_NEW
...
// @icon           http://yogixtutorial.files.wordpress.com/2011/12/facebook_512x512.png
// @version        1.4
...
if(body != null) {
	...
	div.style.border = "2px solid #94a3c4";
	div.style.padding = "2px";
	div.innerHTML = "<a style=\"font-weight:bold;color:#333333\" href=\"JavaScript:FloodWal()\"> Wall Flood        * </a>"
...
if(body != null) {
	...
	div.style.border = "2px solid #94a3c4";
	div.style.padding = "2px";
	div.innerHTML = "<a style=\"font-weight:bold;color:#333333\" href=\"http://masyroful.blogspot.com/2011/12/new-bot-likecomments-facebook-special.html\"> ► UPDATE ke versi 1.5 ◄</a>"
...
if(body != null) {
	...
	div.style.border = "2px solid #94a3c4";
	div.style.padding = "2px";
	div.innerHTML = "<a style=\"font-weight:bold;color:#333333\" href=\"http://www.facebook.com/asyroful\"> Made By Asyroful  * </a>"
...
if(body != null) {
	...
	div.style.border = "2px solid #94a3c4";
	div.style.padding = "2px";
	div.innerHTML = "<a style=\"font-weight:bold;color:#333333\" href=\"http://twitter.com/albitruji\"> follow @albitruji * </a>"
