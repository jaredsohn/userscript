// ==UserScript==
// @name Ogame FR : Standard buildings.php (Research)
// @author Izcelion
// @description Ogame FR : Standard buildings.php (Research)
// @language FR
// @include http://*/game/buildings.php*mode=Forschung*
...
if (isFinite(GetUniverse())){
	...
	TabResearch[0] = new Array("Technologie Espionnage",-1);
	TabResearch[1] = new Array("Technologie Ordinateur",-1);
	TabResearch[2] = new Array("Technologie Armes",-1);
	TabResearch[3] = new Array("Technologie Bouclier",-1);
	TabResearch[4] = new Array("Technologie Protection des vaisseaux spatiaux",-1);
	TabResearch[5] = new Array("Technologie Energie",12);
	TabResearch[6] = new Array("Technologie Hyperespace",8);
	TabResearch[7] = new Array("R"+eaigu+"acteur "+agrave+" combustion",-1);
	TabResearch[8] = new Array("R"+eaigu+"acteur "+agrave+" impulsion",-1);
	TabResearch[9] = new Array("Propulsion hyperespace",-1);
	TabResearch[10] = new Array("Technologie Laser",10);
	TabResearch[11] = new Array("Technologie Ions",5);
	TabResearch[12] = new Array("Technologie Plasma",7);
	TabResearch[13] = new Array("R"+eaigu+"seau de recherche intergalactique",-1);
	TabResearch[14] = new Array("Technologie Graviton",1);
	...
	while(i<tablenode.length){
		...
		// Find the good <TABLE>
		//======================
		if(tablenode[i].getAttribute("width")==WidthTableNeeded){
			...
			while(j<trnode.length){
				...
				for(var k=0;k<TabResearch.length;k++){
					var LevelTechno = -1;
					var sentence1 = ">"+TabResearch[k][0]+"</a> (Niveau ";
					var sentence2 = " )<br>";
	...
	//alert("Standard buildings.php (Research)");
