...
my_country_code="ШТАТ";	//Ваш штат
my_name_1="Ivan";		//Ваше имя
my_name_2="Tagushev";	//Ваше имя
my_adress_1="USA, NewYork";	//Ваш адрес №1
my_adress_2="";			//Ваш адрес №2
my_city="NewYork";		//Ваш город
my_index="12345";		//Ваш индекс
my_phone_1="123"; 		//Первые 3 цифры телефона
my_phone_2="123"; 		//Вторые 3 цифры телефона
my_phone_3="1234"; 		//Третьи 4 цифры телефона
