...
(function () {
  ...
  var main = function () {
    ...
    var createTweak = function () {
      ...
      qx.Class.define("AlsiusTweak.Main", {
        ...
        members : {
          ...
          tweakEXT : function () {
            ...
            this.panel = new AlsiusTweak.ui.ExtraTools("Erzengel Tools v" + EXTversion + ' ~ ' + EXTgreeting + ' ~ ');
      ...
      qx.Class.define("AlsiusTweak.Tooltip", {
        ...
        statics : {
          ...
          _buildNoDataOrAccess : function (br) {
            br.add(bl3 + 'Erzengel Tools:' + m + nb + nb + nb + nb + nb + nb + nb + nb + nb + nb + webfrontend.gui.Util.convertBBCode(i18n('ext:no_data_or_credentials')) + l);
          },
          _buildProcessHeadline : function (br) {
            br.add(bl2 + 'Erzengel Tools: v' + EXTversion + l2 + kl + hl + l);
          },
      ...
      qx.Class.define("AlsiusTweak.Chat", {
        ...
        members : {
          ...
          addChatMessage : function (message, prefix, color) {
            ...
            _prefix = (prefix) ? 'Erzengel Tools: (' + AlsiusTweakVersion + ') ' : '',
      ...
      qx.Class.define("AlsiusTweak.ui.AboutWindow", {
        ...
        extend : qx.ui.window.Window,
        construct : function () {
          this.base(arguments, 'Erzengel Tools v' + EXTversion);
          this.buildUI();
        ...
        members : {
          ...
          buildUI : function () {
            ...
            var license = "Erzengel Tools - GreaseMonkey script for Lord of Ultima™";
                    ...
                    invoke : function (result, uuid) {
                      if (result.status && !result.error) {
                        ...
                        settle = {
                          ...
                          order : 9,
                          transport : 1,
                          createCity : (ct.get_UIType() === EMPTY_TYPE) ? 'Erzengel Dorf' : 'LL Erzengel',
                          timeReferenceType : 1,
                          referenceTimeUTCMillis : 0,
                          raidTimeReferenceType : 0,
                          raidReferenceTimeUTCMillis : 0,
  ...
  function debug(e) {
    if (window.console && typeof console.log === "function") {
      console.log('ErzTweak: ' + e);
    }
  }
  /* inject this script into the website */
  function injectMain() {
    debug('Injecting ErzTweak');
    var script = document.createElement("script"),
    txt = main.toString();
