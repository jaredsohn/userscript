// ==UserScript==
// @name           LoU Suite (Scrubs Edit)
// @description    Various Helpers for Lord Of Ultima
// @namespace      Naturalist
// @include        http://prodgame*.lordofultima.com/*/index.aspx*
// @version        1.1.1
// @require        http://sizzlemctwizzle.com/updater.php?id=127647&days=1
// ==/UserScript==
  ...
  function createSuite() {
    ...
    qx.Class.define("louSuite.main", {
      ...
      members: {
        ...
        startScript: function() {
          ...
          btn.set({width: 30, appearance: "button-text-small", toolTipText: "LoU Suite Einstellungen"});
    ...
    qx.Class.define("louSuite.optionsPage", {
      ...
      construct: function() {
        ...
        this.setTitle("LoU Scrubs Suite 2012 W12");
    ...
    qx.Class.define("lou_suite.gui.DungeonRaider", {
      ...
      construct: function() {
        ...
        this.setLabel("Höhlenjagd");
        this.setLayout(new qx.ui.layout.VBox(10));
        this.add(this._createToolBar());    
        this._tableModel = new qx.ui.table.model.Simple();
        var columnNames = [ "Id", "Row Info", "Höhlenart", "Level", "Koordinaten", "Stadtname", "Entfernung", "Stärke/Typ", "Attacke"];
        var columnIds = ["id", "row_info", "dungeon_type", "dungeon_level", "position", "name", "distance", "units", "actions"];
      ...
      members: {
          ...
          for (var d_key in dungeons['c' + selectedContinent]) {
            ...
            if (dungeon['state'] && (dungeon['level'] >= min_level)) {
              ...
              for (var cityId in LT.player.cities) {
                ...
                var units_to_send = this.getTroopsNeeded(dungeon['type'], dungeon['level'], units);
        ...
        getUnitsPerDungeon: function () {
          var units = {
            Berghöhle: {
              3: [35, 200, 450, 2500, 7000, 20000, 35000, 70000, 90000, 140000], // Jäger
              6: [35, 200, 450, 2500, 7000, 20000, 35000, 70000, 90000, 140000], // Berserker
              5: [40, 220, 450, 2700, 7500, 22000, 40000, 80000, 95000, 150000], // Templer   
              4: [35, 200, 450, 2500, 7000, 20000, 35000, 70000, 90000, 140000], // Piken
             11: [18, 100, 275, 1500, 3500, 8000, 20000, 32000, 45000, 70000], // Knight
             10: [13, 80, 250, 900, 2700, 6500, 13000, 23000, 36000, 55000], // Paladin
            },
            Hügelgrab: {
              6: [35, 160, 400, 2200, 6000, 18000, 30000, 55000, 85000, 140000], // Berserker
              3: [40, 180, 450, 3000, 8000, 20000, 32000, 60000, 90000, 140000], // Jäger
              7: [70, 350, 1000, 5600, 13000, 26000, 55000, 85000, 120000, 220000], // Magier
             12: [40, 170, 700, 2200, 6000, 13000, 30000, 50000, 70000, 110000], // Hexenmeister
             11: [20, 120, 350, 1700, 4200, 9000, 23000, 30000, 55000, 80000], // Ritter
            },
            Waldhöhle: {
              6: [32, 180, 500, 2400, 7000, 16000, 30000, 55000, 80000, 135000], // Berserker
              3: [35, 180, 500, 2800, 9000, 19000, 40000, 65000, 90000, 135000], // Jäger
              9: [20, 150, 325, 1600, 4000, 10000, 20000, 38000, 60000, 70000], // Armbrüste
              11: [20, 150, 325, 1600, 4000, 10000, 20000, 35000, 45000, 55000], // Knight
              10: [16, 120, 250, 1000, 4000, 10000, 20000, 38000, 60000, 70000], // Paladin
            },
            Piratenschiff: {
        ...
        getTroopsNeeded: function (dungeon_name, dungeon_level, units) {
        ...
        onTroopsSent: function (event, v) {
          ...
          switch (code) {
            ...
            case 4: // Not enough units
              message = "Nicht genug Truppen in der Stadt.";
              break;
            case 64: // No more command slots
              message = "Befehlslimit erreicht.";
              break;
            default:
        ...
        createCitiesContinentsSelectBox: function() {
          ...
          sb.setToolTipText("Auswahl des: <b>Kontinents</b>");
          ...
          for (var i = 0; i < list.length; i++) {
            var cont = list[i];
            sb.add(new qx.ui.form.ListItem("K" + cont, null, cont));
          }
        ...
        _createToolBar: function() {
          ...
          this.sbLevel.setToolTipText("Auswahl des: <b>min Level</b>");
          ...
          var btnViewRegion = new qx.ui.form.Button("Regionsansicht");
          ...
          this.btnUpdateView = new qx.ui.form.Button("Scanen");
          ...
          var btnRecount = new qx.ui.form.Button("Zähle Truppen");
    ...
    qx.Class.define("lou_suite.gui.BossRaider", {
      ...
      construct: function() {
        ...
        bos.gui.SummaryPage.call(this);
        this.setLabel("Bossjagd");
        this.setLayout(new qx.ui.layout.VBox(10));
        this.add(this._createToolBar());    
        this._tableModel = new qx.ui.table.model.Simple();
        var columnNames = [ "Id", "Row Info", "Boss", "Level", "Koordinaten", "Stadtname", "Entfernung", "Stärke/Typ", "Attacke"];
        ...
        getUnitsPerBoss: function () {
          var units = {
            Drache: {
              ...
              3: [84, 500, 3334, 6667, 16667, 25000, 33334, 50000, 75000, 100000], // Jäger
              5: [100, 600, 4000, 8000, 20000, 30000, 40000, 60000, 90000, 120000], // Templar
              9: [42, 250, 1700, 3300, 8300, 12500, 17000, 25000, 37500, 50000], // Armbrüste
              11: [19, 112, 756, 1467, 3689, 5556, 7556, 11112, 16667, 22223], // Knight
              7: [36, 215, 1429, 2858, 7143, 10715, 14286, 21429, 32143, 42858], // Mage
              12: [28, 185, 1034, 2200, 5167, 7250, 9334, 15500, 22750, 350000], // Warlock
            ...
            Moloch: {
              ...
              3: [84, 500, 3334, 6667, 16667, 25000, 33334, 50000, 75000, 100000], // Jäger
              5: [100, 600, 4000, 8000, 20000, 30000, 40000, 60000, 90000, 120000], // Templar
              9: [63, 375, 2500, 5000, 12500, 18750, 25000, 37500, 56250, 75000], // Armbrüste
              11: [28, 167, 1112, 2223, 5556, 8334, 11112, 16667, 25000, 33334], // Knight
              7: [24, 143, 972, 1886, 4743, 7143, 9715, 14286, 21429, 28572], // Mage
              12: [18, 100, 767, 2200, 4000, 7000, 8000, 12000, 18500, 20667], // Warlock
            ...
            Hydra: {
              ...
              3: [56, 334, 2267, 4400, 11067, 16667, 22667, 33334, 50000, 66667], // Jäger
              5: [68, 400, 2720, 5280, 13280, 20000, 27200, 40000, 60000, 80000], // Templar
              9: [63, 375, 2500, 5000, 12500, 18750, 25000, 37500, 56250, 75000], // Armbrüste
              11: [28, 167, 1112, 2223, 5556, 8334, 11112, 16667, 25000, 33334], // Knight
              7: [36, 215, 1429, 2858, 7143, 10715, 14286, 21429, 32143, 42858], // Mage
              12: [28, 225, 1034, 2067, 7167, 10250, 16334, 22500, 30750, 50000], // Warlock
              10: [42, 250, 1667, 3334, 8334, 12500, 16667, 25000, 37500, 50000], // Paladin
            },
            Octopus: {
              16: [2, 9, 57, 110, 277, 417, 567, 834, 1250, 1667], // Sloop
        ...
        onTroopsSent: function (event, v) {
          ...
          switch (code) {
            ...
            case 33554436: // Already ordered
              message = "Boss wurde schon angegriffen.";
              break;
            ...
            case 16781312: // Dungeon is closed
              ...
              break;
            case 4: // Not enough units
              message = "Nicht genug Truppen. Aktualisiere.";
              removeBoss = false;
              break;
            case 64: // No more command slots
              message = "Limit der Befehle erreicht.";
              removeBoss = false;
              break;
            default:
              message= "Unknown Error: " + code;
