...
// @exclude        http://www.krakow.menelgame.pl/profil/bande:*
// ==/UserScript==
  		...
  		var parser = new DOMParser();
			...
			var username = document.getElementById('angreifen'+x).getAttribute('username')
					if ((minPts <= points) && (points <= maxPts) && (parseInt(points - points * 0.2) > pts)) {
					  ...
					  document.getElementById('angreifen'+x).innerHTML = "<img height=\"18px\" src=\""+getPic("red")+"\""+
																														 	 " alt=\"n.Angreifbar\" title=\"Nie możesz go zaatakować gdyż "+username+" nie leży w twoim przedziale punktowym ani ty w jego przedziale.\">";
					}
        }
...
var reg = dom.getElementsByTagName('reg_since')[0].textContent;
				...
				document.getElementById('nachricht'+x).innerHTML = "<a href=\"/messages/write/?to="+id+"\"><img style\"margin:5px;\" src=\"http://static.pennergame.de/img/pv4/icons/new_msg.gif\" title=\"Wyślij wiadomość do "+username+"\"></a>";
		}
	});
...
var suche = content.search("Jest właśnie online");
		try{
			if (suche != -1) {
				var online2a = "<img src='http://static.pennergame.de/img/pv4/icons/on.png'>";
				}
			else {
				var online2a = "<img src='http://img715.imageshack.us/img715/6853/offtk.png'>";
			};
		}catch(e){
}
