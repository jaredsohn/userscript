// ==UserScript==
// @name           GLB Local Time 12
// @namespace      www.goallineblitz.com
// @description    Changes forum post time stamps to your local time (12 hour clock version)
...
return m_names[d.getMonth()]+' '+d.getDate()+', '+d.getFullYear()+' '+hours+':'+mins+':'+secs+' '+ampm;
