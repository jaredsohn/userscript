// ==UserScript==
// @name           A Little Newer KoC Toy
// @version        1.3.0
// @namespace      Gengar
// @description    Alliance report scanner - Kingdoms of Camelot KOC 
...
var Version = '1.3.0';
var Versiondate = '11.08.2012'; 
var Scriptname = 'KoC Alliance Report Scanner Post to Alliance Chat - Gengar';
var ScriptTabName = "'+ getMyAlliance()[1] +'";
var AllianzName = 'Kingdom of Camelot';
var ScriptLink = 'http://userscripts.org/scripts/show/140551';
...
<DIV id="hudResultsDiv" style="height:470px; max-height:470px; overflow:scroll;"></div>';
  ...
  DisplayReports : function (){
    ...
    var m = '<left><table><thead><th>Page #</th><th>Date</th><th>Attacker</th><th>Attacker<br>Coords</th><th>Alliance</th><th>Type</th><th>Target</th><th>Target<br>Coords</th></thead>';
    m += '<tbody>';
     var msg = '';
    ...
    for ( var i=0; i<t.data.length;i++) {
       var rpt = data[i];
          ...
          //    msg += '<tbody>';
            ...
            <td>'+rpt.side0Name+'</td>\
             <td>'+ pdxkoordlink(rpt.side0XCoord, rpt.side0YCoord)+'<td>\
             <td>'+unsafeWindow.formatDateByUnixTime(LastUnixTime)+'</td>\
            <tr>\
            </tr>';
     // sendChat("/" + Seed.player.name + ' ' + msg); // Whisper to myself       
     sendChat("/a " + msg); // Alliance chat
