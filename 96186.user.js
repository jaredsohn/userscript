// ==UserScript==
// @name Transporteurs sur Planete
// @namespace http://userscripts.org/users/djoby00
// @description Nombre de PT ou GT nécessaires pour le transport de toutes les ressources de la planète ou lune
// @version 0.1
// @creator AnTC
...
//	.fleft {    float:left;}
	...
	div1.title = "|Petit Transporteur nécessaire pour vider la colonie";
	div1.innerHTML = format(PT, 0, '.') + " PT";// + " Petit Transporteur" + (PT>1?"s":"");
...
//	.fright {   float:right;}
	...
	div2.title = "|Grand Transporteur nécessaire pour vider la colonie";
	div2.innerHTML = format(GT, 0, '.') + " GT";// + " Grand Transporteur" + (GT>1?"s":"");
