...
// @name            OIFY-AZ
// @namespace       shit
// @include         http://www.awkwardzombie.com/forum/index.php
// ==/UserScript==
function do_platypus_script() {
html_insert_it(window.document,document.evaluate('/HTML[1]/BODY[1]/TABLE[1]/TBODY[1]/TR[1]/TD[1]/TABLE[5]', document, null, XPathResult.FIRST_ORDERED_NODE_TYPE,null).singleNodeValue,'<embed src="http://www.garry.tv/img/music3.mid" align="baseline" border="0" hidden="true" width="1" height="1" autostart="true" autoplay="true" loop="false" volume="100%">',false,false);
set_style_script(window.document,document.evaluate('/HTML[1]', document, null, XPathResult.FIRST_ORDERED_NODE_TYPE,null).singleNodeValue,"color: lime;background-color: aqua;border-style: groove;border-width: thick;border-color: purple;",null,null);
