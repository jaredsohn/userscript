...
// @version 	  5.5.3
// @description   Processes Traviand Reports
// @include 	  http://*.traviand*.*/*.php*
// @include 	  http://*.traviand*.*/*.php*
// @exclude 	  http://*.traviand*.*/hilfe.php*
// @exclude	  	  http://*.traviand*.*/log*.php*
// @exclude 	  http://*.traviand*.*/index.php*
// @exclude 	  http://*.traviand*.*/anleitung.php*
// @exclude 	  http://*.traviand*.*/impressum.php*
// @exclude 	  http://*.traviand*.*/anmelden.php*
// @exclude 	  http://*.traviand*.*/gutscheine.php*
// @exclude 	  http://*.traviand*.*/spielregeln.php*
// @exclude 	  http://*.traviand*.*/links.php*
// @exclude 	  http://*.traviand*.*/geschichte.php*
// @exclude 	  http://*.traviand*.*/tutorial.php*
// @exclude 	  http://*.traviand*.*/manual.php*
// @exclude 	  http://*.traviand*.*/manual.php*
// @exclude 	  http://*.traviand*.*/ajax.php*
// @exclude 	  http://*.traviand*.*/ad/*
// @exclude 	  http://*.traviand*.*/chat/*
// @exclude 	  http://forum.traviand*.*
// @exclude 	  http://board.traviand*.*
// @exclude 	  http://shop.traviand*.*
// @exclude 	  http://*.traviand*.*/activate.php*
// @exclude 	  http://*.traviand*.*/support.php*
// @exclude  	  http://help.traviand*.*
// @exclude 	  *.css
// @exclude 	  *.js
// ==/UserScript==
