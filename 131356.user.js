// ==UserScript==
// @author		asdsadsadqwewqewqewqe
// @name        asdasdasdwqeqweqwewq
// @namespace   qwewqewqeqwewqeqweqwe
// @version		1.2.7
// @uso:version 1.2.7
// @include		http://*erepublik.com/*/military/battlefield/*
// @description   wqewqewqewqewqewqewqeqewqewq 
// ==/UserScript==
...
if(window.location.href.indexOf(PAGE_BATTLEFIELD) > 0) {	
	...
	/***********************************************************************************/
	var FORM_URL = "https://docs.google.com/spreadsheet/ccc?key=0AoBx2mw5shX4dEtCNGhCeV8wWTczLUQ3QnFlY2RwalE#gid=0";
	var FORM_FIELDS = {
		eday: "entry.0.single",
		name: "entry.2.single",
