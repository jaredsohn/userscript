// ==UserScript==
// @name           SVZ Image Download
// @namespace      waldheinz.de
// @description    Erzeugt im StudiVZ zu Bildern einen Download-Link.
// @include        http://www.studivz.net/PhotoAlbums/Photo/*
// ==/UserScript==

var image, imgDownLink, downIcon;
...
if (image) {
    var link = '<a href="' + image.src + '" >' +
	'<img src="' + downIcon + '" border="0" ' +
	'style="vertical-align:middle;" />' +
	'</a>&nbsp;';
    
    /* find destination div */
    var dest = document.getElementById('headline').childNodes[1];
