...
//
// 2013-08-02 1.5b: make author notes as green and bold. To change color, change variable "authorNoteColor" in one line.  Replace file mturkhitdatabase@localhost.user.js with this file.
//

var authorNoteColor='green'; //Added for v1.5b. 
...
var request = indexedDB.open("HITDB", v);
    ...
    if (note == '')
  	  ...
  	  request = store.put({requesterId: id, note: note}); //Store new note and display it. 
...
/////////////////////////////////////////////////////////
//Get CSS color names from: http://www.w3schools.com/cssref/css_colornames.asp
    ...
    store.get(id).onsuccess = function(event)
    {
      ...
      else
      {
        ...
        if (note.indexOf('!') >= 0)
          ...
          label.style.color = authorNoteColor; //was black, v1.5b
...
function note_func(id, label)
{
  return function()
  {
    ...
    if (note.indexOf('!') >= 0)
      ...
      label.style.color = authorNoteColor; //v1.5b
	  label.style.fontWeight='bold';
  };   
}
