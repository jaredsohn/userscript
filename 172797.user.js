// ==UserScript==
// @name        http://importbux.blogspot.com/
// @namespace   http://importbux.blogspot.com/
// @include     */click.php
...
if(wparent.location.href.indexOf('advertisements') != -1 && wparent.location.href.indexOf('click.php') == -1){
	var arr = [],ctr = 0;
	var div = $('<div>');
	var clickNum = ctr + 1 ;
	var loading = 0;
...
if(wparent.location.href.indexOf('click.php') != -1){
