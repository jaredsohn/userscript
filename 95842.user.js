...
"Furnace" : "ذوب آهن",
"The furnace increases metal production by 5% per level." : "با ارتقاء هر سطح ذوب آهن 5% به ميزان توليد کل آهن سياره شما افزوده خواهد شد",
...
"The wind farm generates energy from wind. Ice planets are subject to especially strong winds, which leads to an increase in energy production." : "اين ساختمان توسط باد انرژي توليد مي کند . سيارات يخي در معرض باد شديدي هستند و در نتيجه اين ساختمان ميزان انرژي بيشتري توليد خواهد کرد",
"Hydropower plant" : "نيروگاه برق آبي",
"Hydro power plant" : "نيروگاه برق آبي",
"The hydropower plant generates energy from flowing water. Aquatic planets with their large amount of precipitation are especially suited for hydropower plants." : "دراين نيروگاه از آبهاي روان انرژي و برق توليد مي کند ، براي سياره هاي آبي توصيه ميشود ",
"Fusion power plant" : "نيروگاه فيوژني",
"The fusion power plant generates energy from the fusion of deuterium to helium. With each upgrade, the fusion power plant increases its deuterium capacity." : "اين نيروگاه از همجوشي دتريوم و هليوم برق توليد مي کند ، به اين ترتيب کـه از ميزان توليد سوخت شما کم شده و تبديل به انرژي ميشود، هر چقدر سطح ساختمان بيشتر باشد از اين همجوشي مقدار انرژي بيشتري استخراج ميشود ",
"The Titan fusion power plant generates energy from the fusion of tritium to helium. With each upgrade, the fusion power plant increases its tritium capacity." : "اين نيروگاه براي نژاد تيتان ها ، تتريوم و هليوم را با همجوشي تبديل به انرژي مي کند. هرچقدر سطح ساختمان بيشتر باشد از اين همجوشي مقدار انرژي بيشتري استخراج ميشود",
"AEC" : " نيروگاه انرژي",
"This monument is thought to be the relic of an alien civilization. The AEC (Alien Energy Chamber) acts as an initial source of energy for each home world." : "گمان مي رود که اين مقبره يک يادگاري از تمدن بيگانگان است ، اين نيروگاه را مي توان به عنوان اولين منبع دسترسي به انرژي استفاده کرد",
...
"Shipyard" : "کارخانه سازنده جنگنده هاي نظامي",
"Ship yard" : "کارخانه سازنده جنگنده هاي نظامي",
...
"The Titan Scan Link System serves to keep an eye on fleet movements in the close vicinity of a particular planet. Depending on the level, hostile fleets on comets and uninhabited planets can be detected. With each upgrade of the Scan Link System, the scan radius increases by 1 field, the maximum range is 20 fields." : "سیستم کاوشگر نژاد تیتان به شما کمک می کند که حرکت هرگونه سفینه نظامی را در اطراف خود را (با توجه به سطح ساختمان) زیر نظر بگیرید. ناوگان نظامی دشمن و سیارات بدون سکنه قابل ردیابی هستند.با بالا بردن سطح این ساختمان در هر مرحله یک فیلد به سطح دسترسی آن افزوده شده و ماکزیمم تا 20 فیلد قابل افزایش است",
"The jammer interferes with signals emitted by espionage units. According to your wishes, you can adjust whether the amount of resources (and Qi-Units), the number of units, the level of you science and the levels of your buildings appear higher or lower than they really are." : "این ساختمان با سیگنال های صاتع شده از طرف نیروهای جاسوسی ایجاد تداخل کرده و با توجه به خواسته شما می تواند میزان منابع ، میزان واحدهای امتیازات ویژه ، تعداد نیروها ، سطح دسترسی به دانش در آکادمی و همچنین سطح ساختمان های شما را کمتر یا بیشتر ار آنچه که هست نشان دهد",
"The Transportal serves to transport ships between two own portals. With each upgrade of the Transportal, the energy costs for a transport decrease. The level of the target's planet does not matter. A Transportal level 1 is sufficient." : "ساختمان حمل و نقل آنی به شما کمک می کند که در یک لحظه سفینه های خود را بین دو دروازه جابجا کنید. با افزایش سطح این ساختمان انرژی مصرفی برای این کار کمتر می شود. این جابجایی به سطح ساختمان مقصد وابسته نیست و یک ساختمان حمل و نقل سطح یک در مقصد کفایت می کند",
...
"mark all" : "انتخاب همه",
"level:" : "سطح",
"Current Research:" : "تحقیق انتخابی",
"Research points" : "امتیاز تحقیق",
"Select" : "انتخاب",
"Field of Research" : "زمینه های تحقیق",
"Current credits of your account" : "میزان سکه موجود",
"Activate" : "فعال کردن",
"impossible" : "غیر قابل اجرا",
"Your purchase history" : "سوابق خرید",
"Here you can track all your credit purchases" : "در اینجا می توانید تمام خریدهای گذشته خود را بررسی کنید",
"Assets" : "دارایی",
"Advantages" : "مزایا",
"Rates" : "قیمت خرید سکه",
"FAQ" : "سوالات متداول",
"Description" : "تعریف",
"Duration" : "مدت زمان فعالیت",
"Coins" : "سکه",
"go to trader" : "برو به بازار",
"Purpose" : "نوع عملیات"
"Go TO" : "برو به :",
"OK" : "تاييد ",
"Building" : "ساختمان ",
...
"Board" : "</a><a href='http://forum.imperion.org/'>اسکريپت و فارسي ساز توسط  نيما کرماني-فروم</a>",
...
"Action" : "اجرا",
"Welcome" : "خوش آمديد",
"Logout" : "فارسی ساز ورژن 0.9.5.002  خروج",
"Plus" : "پلاس",
...
"Blueprint: Injector" : "پاشنده",
"Blueprint: Nanoblade" : "تیغه نانو",
"Blueprint: Boson accelerator" : "شتابدهنده بوزون",
...
"Blueprint: Heavy Cruiser" : "رزم ناو سنگين",
