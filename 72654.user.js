...
// @namespace      reddit
// @description    StackOverflow style comment preview
// @include        http://www.reddit.com/*
// ==/UserScript==

/*
   SHOWDOWN COMPRESSED
   Full source: http://www.attacklab.net
*/
var Showdown={};
...
function GM_wait() {
    ...
    else { $ = unsafeWindow.jQuery; jQuery_ready(); }
} GM_wait();
...
function jQuery_ready() {        
    ...
    $(document).ready(function() {
        ...
        $("textarea[name=text]").live("keyup", function() {
            ...
            if(parent.length > 0) {
                ...
                var id = parent.attr("id") + "_preview";
                ...
                if (preview.length > 0) {
                    ...
                    parent.append("<div style=\"padding: 3px; border: 1px dashed #CCC; width: 500px; display: block!important;\" id=\"" + id + "\"" +
                                    "class=\"usertext-body\"><div class=\"md\"></div></div>");
                }
