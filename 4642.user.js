// ==UserScript==
// @name          Lane'S Homepage
// @namespace     myspace.com/lanitoburrito
...
s+= "body {background: #000000 fixed;margin-top:0px;}\n";
s+= "div, table, td, th, .heading{background:transparent!important; border:none!important;}\n";
s+= "*{font-family:Base 02}\n";
s+= "a:link, a:active, a:visited {color:FFFFFF!important;font:bold 11px Base 02!important;}\n";
...
s+= "#topnav {background:transparent!important; padding:0!important; margin-bottom:10px; color:000000}\n";
s+= "#topnav a {font:normal 11px Base 02!important; color:FFFFFF!important;}\n";
s+= "#topnav a:hover {color:000000!important;}\n";
s+= ".section {border:3px solid #FFFFFF!important;-moz-border-radius:10px;background-color:0600FF!important;padding:2px;}\n";
s+= ".heading, #splash_coolNewPeople h5.heading, .mar5 strong {font:bold 12px Base 02!important;color:FFFFFF;border:none!important;-moz-border-radius:10px;display:inline;padding:0!important;background-color:0600ff!important;}\n";
...
s+= "a:hover .indicator {border:display!important;opacity:1;-moz-opacity:1;}\n";
...
s+= "a[href*='.listAds']:after, a[href*='=rateImage']:after, a[href*='ShowMyBulletins']:after {content:' |'; background:0600ff; color:FFFFFF; font-weight:normal}\n";
...
s+= "#splash_coolNewPeopleBrowse {text-align:center; color:0600ff}\n";
