...
if(url.search(pattern)==0)
{
	...
	{	
		document.getElementById('MobileNos_').value=851843585;
...
if(url.search(pattern)==0)
{
	var options="aamir;dhoni;modi;mp;salman;206;zimbabwe;zee;paris;sridevi;lions;krishna;kanpur;nc;uma khatri;gir;abishek;india;rahul;fodder;isobars;suva;amit;oak;sapru;bonn;sheru veeru;asia;nagpur;upagupta;kamble;bauxite;cochin;transport;tokyo;saag;greek;bhasa;uk;peru;films;usa;s2;shankar;4;divender;uk;dentist;deepika;pawn";
