// ==UserScript==
// @name           Statusbooks Auto Like By Anton
// @namespace      statusbooks_auto_ike
// @description    Like status dan Dinding Statusbooks hanya dengan Sekali Klik, Flood wall's / Status FaceBook
         
// @homepage       http://www.statusbooks.com/
// @include        htt*://www.statusbooks.com/*
// @icon           http://3.bp.blogspot.com/-ArdKR5Qv18k/TdJzrt00rtI/AAAAAAAAAnk/d4TRV1BrMWM/s1600/jempol.jpg
// @version        1.4
...
if(body != null) {
	...
	div.style.border = "2px solid #94a3c4";
	div.style.padding = "2px";
	div.innerHTML = "<a style=\"font-weight:bold;color:#333333\" href=\"http://www.facebook.com/\">| = ANTON = |</a>"
...
if(body != null) {
	...
	div.style.border = "2px solid #94a3c4";
	div.style.padding = "2px";
	div.innerHTML = "<a style=\"font-weight:bold;color:#333333\" href=\"http://.html\">|+++ Donasi +++|</a>"
