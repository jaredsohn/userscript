...
switch(sLang)
{
    ...
    case "net":
    case "it":
	text = ["Rompiamo qualche culo","Tipo di attacco non valido!","Coordinate non inserite!","Truppe non sufficienti! (Troop #","no troop input","Starting","Probably bad cords","No scout units","Done","Wave setup:","aggiungi","Reset","Attack setup:","Scegli il tipo di attacco:","Normale","Rinforzo","Raid","spie attacco/fake","spie difesa/fake","Coordinate","Spacca il culo! =)","Arrival time","Arrive at:","Set timed arrival","Number of attacks of that specific wave","with '|' ex: 10|11","ERROR:","Unable to get active village. Assuming one village account","Timed arrival set at:","tempo tra un attacco e l'altro in ms: (default 500) ",""]
...
var msg = "Le truppe sono state inviate :P vai alla caserma !! :P";
alert(msg);
		}else
			addCount(".");
	}
...
+text[29] +'<input class=\"fm\" style=\"color:blue;\" id=\"timebetween\" type=\"text\" value=\"50\" size=\"4\" />' +
