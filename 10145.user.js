...
// @include       http://sensibleerection.com/*
// @namespace     http://userscripts.org/scripts/show/10145
// @version       1.3vFH.04
// @author        steele.ero; f00m@nB@r; Rojo^; fedhax
// ==/UserScript==

(function () {
	var gSEWatchListVersion = '1.3vFH.04';
	...
	function Config() {
		...
		this.showConfig = function() {
			...
			boxSt.innerHTML = '#configBox { padding: 5px; white-space: nowrap; -moz-opacity: 1.0; z-index: 901; '
				...
				+'#overlay { width: '+ (w - 20) +'px; height: '+h+'px; background-color: #eee; -moz-opacity: 0.67; z-index: 900; '
