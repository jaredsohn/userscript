...
'<div id="menu">'
+ '<ul>'
+ ' <li><h2>Menu des pirates</h2>'
+ '   <ul>'
+ '     <li><center><a target="_blank" href="http://lolonnais.forumactif.net/index.htm" title=" Forum de l alliance des pirates">Forum des pirates</a></li>'
...
+ '	  <li><center><a target="_blank" href="http://ikariam.immortal-nights.com/ikafight/" title=" Simuler une bataille pour eviter le pire">Simuler une bataille</a></li>'
