...
// @name           Orkut Manager
// @namespace      System
// @description    Gerenciador de Orkut, Quote, Barra de Ferramentas, Resposta Rápida, Assinatura, Adicionar Cores Padrões, bookmarks, chat tópico.
// @include        http://*.orkut.*
...
/*
 * @author [Rw]Xaca!
 * @profile http://www.orkut.com.br/Main#Profile.aspx?uid=15721949893516680535
 */
...
var htmlQuoteB = "<div style='background: #C8E1FF; border: 2px solid #87CEFA; color: black; font-size: 100%; margin-left: 20px; margin-right: 20px; padding: 2px 3px 2px 3px'>";
var htmlQuoteE = "</div>";
...
var signature = "";
var htmlSignature = newLineFixer + "Coloque sua sign aqui =D"
