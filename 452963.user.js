// ==UserScript==
// @name        CnC Tiberium Alliances Pack for black mamba by cz
...
// @version     0.18
// @updateURL   http://userscripts.org/scripts/source/452963.meta.js
// @downloadURL http://userscripts.org/scripts/source/452963.user.js
...
// ==UserScript==
// @name           Tiberium Alliances RTViewer
// @description    Allows you to view full repair times on the offense view
// @namespace      https://prodgame*.alliances.commandandconquer.com/*/index.aspx* 
// @include        https://prodgame*.alliances.commandandconquer.com/*/index.aspx*
// @version        1.0
// @author         rusty149
// @require        http://sizzlemctwizzle.com/updater.php?id=150219
// ==/UserScript==
...
(function (){
	...
	function initialize() {
		console.log("RT Viewer Loaded"); 
		
		qx.Class.define("webfrontend.gui.PlayArea.RTViewer", {
		extend: qx.ui.container.Composite,
		...
		members: {
            ...
            var labelTitle = new qx.ui.basic.Label("<b>RTViewer</b>");
            ...
            this.containerMain=new qx.ui.container.Composite(new qx.ui.layout.VBox().set({alignX:"right"})).set({maxHeight:webfrontend.gui.PlayArea.RTViewer.SaverExpandedHeight,width:75,minHeight:32,allowShrinkY:true,decorator:new qx.ui.decoration.VBox().set({baseImage:"webfrontend/ui/common/bgr_mission_tracker.png"})});
          ...
          expand: function(bs) {
            if(!bs) {
              ...
              this.containerMain.setMaxHeight(webfrontend.gui.PlayArea.RTViewer.SaverCollapsedHeight);
            } else {
              this.buttonResize.setIcon("FactionUI/icons/icon_tracker_minimise.png");
              this.containerMain.setMaxHeight(webfrontend.gui.PlayArea.RTViewer.SaverExpandedHeight);
            }
          },
          ...
          update: function() {
            ...
            if(!formations[cityID][ownCityID]) {
              return;
                ...
                var toolTipText = "<div><span style='float: left'><b>Next Level</b></span><span style='float: right'>&nbsp;&nbsp;&nbsp;&nbsp;" + 0 + ":" + 0 + " " + 0 + "</span></div><div style='clear: both;'></div>";
				
                var labelLoad = new qx.ui.basic.Label("Aircraft: " + ClientLib.Data.MainData.GetInstance().get_Cities().get_CurrentOwnCity().get_CityUnitsData().GetRepairTimeFromEUnitGroup(ClientLib.Data.EUnitGroup.Aircraft, false));
                ...
                containerSaves.add(labelLoad, {row: 1, column: 1});
      ...
      windowSaver = new webfrontend.gui.PlayArea.RTViewer();
      windowSaver.hide();
      ...
      ClientLib.Data.MainData.GetInstance().get_Cities().set_CurrentCityId = function(a) {
		...
		function updateView() {
			switch(qx.core.Init.getApplication().getPlayArea().getViewMode()) {
				...
				case webfrontend.gui.PlayArea.PlayArea.modes.EMode_PlayerOffense:
					windowSaver.update();
					windowSaver.show();
					break;
				default:
            ...
            calculateCostsForNextMCV: function () {
              try {
                ...
                if (!this.mcvPopup) {
                  ...
                  this.mcvPopup.setPosition("left-center");
                  this.mcvPopup.setAutoHide(false);
                  this.mcvPopup.setBackgroundColor("#190B07");
                  this.mcvPopup.setOpacity(0.8);
                  this.mcvPopup.setShadow(null);
                  this.mcvPopup.setDecorator(new qx.ui.decoration.Background());
                  var target = this.repairPopup;
