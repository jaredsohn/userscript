...
// Version 2.5.3-r1 08/17/2009  Fixed the SortInv function to handle the revised HTML layout of the booze and food in the inventory (edited by Phaque)
// Version 2.5.3-r2 08/17/2009  Update food and booze node handling to accommodate changes to KoL new KoL inventory interface (edited by Phaque) 
const VERSION=252;
...
//if (window.location.pathname == "/inventory.php") {
    var drinkLinks = document.evaluate('//a[contains(@href,"inv_booze.php") and contains(@href,"&which=1")] | //s[contains(@rel,"inv_booze.php") and contains(@rel,"&which=1")]',document,null,XPathResult.UNORDERED_NODE_SNAPSHOT_TYPE,null);
    var foodLinks = document.evaluate('//a[contains(@href,"inv_eat.php") and contains(@href,"&which=1")] | //s[contains(@rel,"inv_eat.php") and contains(@rel,"&which=1")]',document,null,XPathResult.UNORDERED_NODE_SNAPSHOT_TYPE,null);
    ...
    for (var i=0;i<drinkLinks.snapshotLength;i++) {
        ...
        var whichDrink = parseInt((node.href != null) ? node.href.split("&whichitem=")[1].split("&")[0] : node.getAttribute('rel').split("&whichitem=")[1].split("&")[0]);
        ...
        if (node.href != null) {
            ...
            with (newDrinkNode) {
                ...
                if (node.href != null) href = 'javascript:void(0)';
                if (node.href == null) alert(node.nodeName);
            }
            node.parentNode.insertBefore(newDrinkNode,node);
        }
        else {
            ChangeTextContent(node,'[drink (' + drinkDrunkenness + ')]');
        }
        //Add to the array, for possible re-sorting
        if (window.location.pathname == "/inventory.php") {
            drinkNodeArray[i] = new Object();
            drinkNodeArray[i].node = document.evaluate('./ancestor::table[1]',node,null,XPathResult.FIRST_ORDERED_NODE_TYPE,null).singleNodeValue;
    ...
    for (var i=0;i<foodLinks.snapshotLength;i++) {
        ...
        var whichFood = parseInt((node.href != null) ? node.href.split("&whichitem=")[1].split("&")[0] : node.getAttribute('rel').split("&whichitem=")[1].split("&")[0]);
        
        if (foodNodeArray[i],name.indexOf('scarab') > -1) alert(foodNodeArray[i].advPer);
        ...
        if (window.location.pathname == "/inventory.php") {
            ...
            foodNodeArray[i].node = document.evaluate('./ancestor::table[1]',node,null,XPathResult.FIRST_ORDERED_NODE_TYPE,null).singleNodeValue;
...
function AddFullness(itemID) {
    if ((itemID==undefined)||(typeof itemID=='object')) {
        whichFood = parseInt((this.href != null) ? this.href.split("&whichitem=")[1].split("&")[0] : this.getAttribute('rel').split("&whichitem=")[1].split("&")[0]);
    }
    else {
        whichFood = itemID;
    }
...
function getdb(){
    ...
    if(tmp!=''){
        ...
        // add a bunch of items that are missing from the itemdb source //
        itemdb.items['3469'] = { descid : '811123211', type : 'food',   limiter : 3, adv : 3   };
        itemdb.items['3489'] = { descid : '946050609', type : 'food',   limiter : 1, adv : 2.5 };
        itemdb.items['3490'] = { descid : '493009120', type : 'food',   limiter : 1, adv : 2.5 };
        itemdb.items['3491'] = { descid : '930651591', type : 'food',   limiter : 1, adv : 2.5 };
        itemdb.items['3497'] = { descid : '316828573', type : 'booze',  limiter : 3, adv : 6   };
        itemdb.items['3501'] = { descid : '253194792', type : 'food',   limiter : 2, adv : 8.5 };
        itemdb.items['3502'] = { descid : '501342128', type : 'spleen', limiter : 2, adv : 4   };
        itemdb.items['3555'] = { descid : '650246339', type : 'food',   limiter : 1, adv : 2   };
        itemdb.items['3556'] = { descid : '722117387', type : 'food',   limiter : 1, adv : 2   };
        itemdb.items['3557'] = { descid : '954120912', type : 'food',   limiter : 1, adv : 2   };
        itemdb.items['3558'] = { descid : '231916006', type : 'food',   limiter : 1, adv : 2   };
        itemdb.items['3559'] = { descid : '717183259', type : 'food',   limiter : 1, adv : 2   };
        itemdb.items['3560'] = { descid : '842309952', type : 'food',   limiter : 1, adv : 2   };
        itemdb.items['3564'] = { descid : '700668810', type : 'booze',  limiter : 4, adv : 14  };
        itemdb.items['3565'] = { descid : '732107367', type : 'booze',  limiter : 4, adv : 14  };
        itemdb.items['3566'] = { descid : '212542824', type : 'booze',  limiter : 4, adv : 14  };
        itemdb.items['3582'] = { descid : '788629105', type : 'food',   limiter : 1, adv : 1.5 };
        itemdb.items['3584'] = { descid : '991734610', type : 'food',   limiter : 1, adv : 3   };
        itemdb.items['3585'] = { descid : '612504863', type : 'food',   limiter : 1, adv : 3   };
        itemdb.items['3586'] = { descid : '636841452', type : 'booze',  limiter : 3, adv : 7.5 };
        itemdb.items['3639'] = { descid : '508506361', type : 'food',   limiter : 2, adv : 9   };
        itemdb.items['3645'] = { descid : '880677333', type : 'booze',  limiter : 3, adv : 8.5 };
        itemdb.items['3646'] = { descid : '970160730', type : 'food',   limiter : 3, adv : 6.5 };
        itemdb.items['3650'] = { descid : '357577494', type : 'food',   limiter : 1, adv : 2   };
        itemdb.items['3652'] = { descid : '668910096', type : 'booze',  limiter : 3, adv : 8.5 };
        itemdb.items['3653'] = { descid : '411676372', type : 'food',   limiter : 3, adv : 8.5 };
        itemdb.items['3672'] = { descid : '208004985', type : 'food',   limiter : 3, adv : 8.5 };
        itemdb.items['3673'] = { descid : '310999359', type : 'booze',  limiter : 3, adv : 8.5 };
        itemdb.items['3678'] = { descid : '916726266', type : 'booze',  limiter : 2, adv : 5   };
        itemdb.items['3684'] = { descid : '763304904', type : 'food',   limiter : 1, adv : 6   };
        itemdb.items['3685'] = { descid : '747223912', type : 'food',   limiter : 1, adv : 5.5 };
        itemdb.items['3686'] = { descid : '294857873', type : 'food',   limiter : 1, adv : 5.5 };
        itemdb.items['3687'] = { descid : '403606686', type : 'food',   limiter : 1, adv : 1.5 };
        itemdb.items['3688'] = { descid : '586546677', type : 'food',   limiter : 1, adv : 1.5 };
        itemdb.items['3689'] = { descid : '518487280', type : 'food',   limiter : 1, adv : 4.5 };
        itemdb.items['3690'] = { descid : '854578505', type : 'food',   limiter : 1, adv : 3.5 };
        itemdb.items['3691'] = { descid : '706604984', type : 'food',   limiter : 1, adv : 1.5 };
        itemdb.items['3692'] = { descid : '506573795', type : 'food',   limiter : 1, adv : 1.5 };
        itemdb.items['3738'] = { descid : '487975834', type : 'food',   limiter : 1, adv : 1.5 };
        itemdb.items['3751'] = { descid : '609461468', type : 'food',   limiter : 2, adv : 6.5 };
        itemdb.items['3763'] = { descid : '223443099', type : 'booze',  limiter : 3, adv : 3   };
        itemdb.items['3764'] = { descid : '297181259', type : 'booze',  limiter : 3, adv : 3   };
        itemdb.items['3765'] = { descid : '786855294', type : 'booze',  limiter : 3, adv : 3   };
        itemdb.items['3766'] = { descid : '240705540', type : 'booze',  limiter : 3, adv : 5.5 };
        itemdb.items['3767'] = { descid : '637859602', type : 'booze',  limiter : 3, adv : 5.5 };
        itemdb.items['3768'] = { descid : '983511537', type : 'booze',  limiter : 3, adv : 5.5 };
        itemdb.items['3769'] = { descid : '614659845', type : 'booze',  limiter : 4, adv : 12  };
        itemdb.items['3770'] = { descid : '315178248', type : 'booze',  limiter : 4, adv : 12  };
        itemdb.items['3771'] = { descid : '832186108', type : 'booze',  limiter : 4, adv : 12  };
        itemdb.items['3772'] = { descid : '641864207', type : 'booze',  limiter : 1, adv : 2   };
        itemdb.items['3812'] = { descid : '561895660', type : 'food',   limiter : 3, adv : 3   };
        itemdb.items['3817'] = { descid : '663137394', type : 'food',   limiter : 1, adv : 2   };
        itemdb.items['3829'] = { descid : '191472664', type : 'food',   limiter : 1, adv : 6   };
        itemdb.items['3831'] = { descid : '182199050', type : 'booze',  limiter : 3, adv : 5.5 };
        itemdb.items['3832'] = { descid : '219381574', type : 'booze',  limiter : 4, adv : 12  };
        itemdb.items['3833'] = { descid : '913726874', type : 'booze',  limiter : 4, adv : 12  };
        itemdb.items['3834'] = { descid : '663681212', type : 'booze',  limiter : 4, adv : 12  };
        itemdb.items['4001'] = { descid : '236391368', type : 'spleen', limiter : 4, adv : 7.5 };
        itemdb.items['4037'] = { descid : '320343694', type : 'food',   limiter : 1, adv : 2.5 };
        itemdb.items['4038'] = { descid : '154656302', type : 'booze',  limiter : 1, adv : 2.5 };
        itemdb.items['4039'] = { descid : '388191568', type : 'spleen', limiter : 1, adv : 1.5 };
        itemdb.items['4052'] = { descid : '575582192', type : 'food',   limiter : 1, adv : 2   };
        itemdb.items['4053'] = { descid : '438971267', type : 'food',   limiter : 2, adv : 6.5 };
        itemdb.items['4054'] = { descid : '190759717', type : 'booze',  limiter : 3, adv : 5.5 };
        itemdb.items['4083'] = { descid : '840782535', type : 'food',   limiter : 2, adv : 5   };
        itemdb.items['4085'] = { descid : '176155931', type : 'food',   limiter : 2, adv : 7   };
        itemdb.items['4132'] = { descid : '319658078', type : 'booze',  limiter : 2, adv : 5.5 };
        itemdb.items['4160'] = { descid : '152129110', type : 'booze',  limiter : 1, adv : 1.5 };
        itemdb.items['4161'] = { descid : '243723339', type : 'food',   limiter : 2, adv : 8.5 };
        itemdb.items['4258'] = { descid : '253613208', type : 'food',   limiter : 2, adv : 8.5 };
        itemdb.items['4259'] = { descid : '452964956', type : 'booze',  limiter : 3, adv : 10  };
...
function SortInv(foodNodeArray,drinkNodeArray) {
    ...
    //Re-sort the arrays
    var foodParents = document.evaluate('//div[@id="section1"]//td[@class="i"]',document,null,XPathResult.ORDERED_NODE_SNAPSHOT_TYPE,null);
    var drinkParents = document.evaluate('//div[@id="section2"]//td[@class="i"]',document,null,XPathResult.ORDERED_NODE_SNAPSHOT_TYPE,null);
    
    //Re-add the food in the new order
    for (i=0;i<foodParents.snapshotLength;i++) {
