// Amazon Jeffco 1.2.7 Library Lookup
// Sean LeBlanc
// Modified Josh Staiger's (excellent) code
// to adapt to Jeffco-Prospector search.
...
// select "Amazon - JeffCo Lookup 1.2.7", and click Uninstall.

//
// ==UserScript==
// @name          Amazon - JeffCo Lookup 1.2.7
...
// 1.2.6 - Changed getTitleLocation() because of Amazon changes.

// 1.2.7 - Fixed getTitleLocation() again because of Amazon changes.


var dbg = false;
var jeffcoLibraryName = 'Jefferson County Public Library';
var shortLibName = "JeffCo";
...
function libSearch(isbn, newDiv) {
	var xmlUrlJeffco = "http://sable.jefferson.lib.co.us/search/?searchtype=i&searcharg=" + isbn + "&SORT=&searchscope=9";
