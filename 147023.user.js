// ==UserScript==
// @name        Tiberium Alliances MaelstromTools Dev
// @namespace   MaelstromTools
// @description Just a set of statistics & summaries about repair time and base resources. Mainly for internal use, but you are free to test and comment it.
// @version     0.1.2.2 beta RUS
// @author      Maelstrom, HuffyLuf, KRS_L and Krisan | translation 777lexa777
        ...
        qx.Class.define("MaelstromTools.Language", {
          ...
          members: {
            ...
            loadData: function (language) {
			  ...
			  this.Data["Repair all defense buildings"] = ["Отремонтировать всю оборонку"][l];
              ...
              this.Data["MaelstromTools Preferences"] = ["MaelstromTools настройки"][l];
              this.Data["Options"] = ["Настройки"][l];
              this.Data["Target out of range, no resource calculation possible"] = ["Целевая вне диапазона, нет ресурса расчет возможных"][l];
              ...
              this.Data["Show time to next MCV"] = ["Показывать время до след. МСЦ,"][l];
              this.Data["Show lootable resources (restart required)"] = ["Показывать lootable ресурсов (требуется перезагрузка)"][l];
              ...
              this.Data["Total resources"] = ["Общий обьём ресурсов"][l];
              this.Data["Max. storage"] = ["Max.Хранение"][l];
              this.Data["Storage full!"] = ["Заполненно"][l];
              this.Data["Storage"] = ["Хранилище"][l];
              ...
              this.Data["Gain/h"] = ["Доход/h"][l];
              this.Data["Factor"] = ["Коэф."][l];
              this.Data["Tib/gain"] = ["Тиб/gain"][l];
              this.Data["Pow/gain"] = ["Эн/gain"][l];
          ...
          members: {
            ...
            createTable: function (eType) {
              try {
                ...
                this.HT_Tables[eType].setColumnWidth(6, 65);
                this.HT_Tables[eType].setColumnWidth(7, 65);
                this.HT_Tables[eType].setColumnWidth(8, 65);
                this.HT_Tables[eType].setColumnWidth(9, 60);
                this.HT_Tables[eType].setColumnWidth(10, 70);
                this.HT_Tables[eType].setColumnWidth(11, 70);
            ...
            getPrioList: function (city, arTechtypes, eModPackageSize, eModProduction, bOnlyTopBuildings, bOnlyAffordableBuildings) {
              try {
                ...
                for (var i = 0; i < objbuildings.length; i++) {
                  ...
                  // Nutzen ins VerhA??’A†a€™A?a€sA‚A¤ltnis zu den Kosten setzten
