// ==UserScript==
// @name           Smileys Sup pour JVC by HapisteDuFutur v2
...
// @Auteur         HapisteDuFutur
// @Remerciements  -[Maxouben]- ; Xx-OvErKiLle-xX .
// ==/UserScript==
...
chaine=chaine.replace(reg,"<img border='0' src='http://s2.noelshack.com/old/up/slurp-2a59150d42.png' />")

var reg=new RegExp("(:ocoeur:)", "g");
chaine=chaine.replace(reg,"<img border='0' src='http://s2.noelshack.com/old/up/ouch2bavecoeur-159a356240.png' />")

var reg=new RegExp("(:foured:)", "g");
chaine=chaine.replace(reg,"<img border='0' src='http://s2.noelshack.com/old/up/fou-9133bfdb23.png' />")

var reg=new RegExp("(:contentbanzai:)", "g");
chaine=chaine.replace(reg,"<img border='0' src='http://s2.noelshack.com/uploads/images/7740489723615_contentbanzai.png' />")

var reg=new RegExp("(:sarcastichap:)", "g");
chaine=chaine.replace(reg,"<img border='0' src='http://s2.noelshack.com/old/up/sartastichap-a787977521.png' />")

var reg=new RegExp("(:hapfete:)", "g");
chaine=chaine.replace(reg,"<img border='0' src='http://s2.noelshack.com/old/up/hapfete-83a76de13.gif' />")

var reg=new RegExp("(:(^^):)", "g");
chaine=chaine.replace(reg,"<img border='0' src='http://s2.noelshack.com/old/up/ange-f2756edd3.png' />")

var reg=new RegExp("(:fiersournois:)", "g");
chaine=chaine.replace(reg,"<img border='0' src='http://s2.noelshack.com/uploads/images/11575719942237_fiersournois.png' />")

var reg=new RegExp("(:clowncoeur:)", "g");
chaine=chaine.replace(reg,"<img border='0' src='http://s2.noelshack.com/uploads/images/20788835658525_clowncoeur.png' />")

var reg=new RegExp("(:gbadiable:)", "g");
chaine=chaine.replace(reg,"<img border='0' src='http://www.noelshack.com/1/1/gbadiable-31ad673d38.png' />")

var reg=new RegExp("(:tirouge:)", "g");
chaine=chaine.replace(reg,"<img border='0' src='http://s2.noelshack.com/old/up/monoeilrouge-d7d600e46.png' />")

var reg=new RegExp("(:coeurbave:)", "g");
chaine=chaine.replace(reg,"<img border='0' src='http://s2.noelshack.com/old/up/coeurbave-422333e54.png' />")

var reg=new RegExp("(:bavecoeur:)", "g");
chaine=chaine.replace(reg,"<img border='0' src='http://s2.noelshack.com/old/up/bavecoeur-3b97f26416.png' />")

var reg=new RegExp("(:ouchcoeur:)", "g");
chaine=chaine.replace(reg,"<img border='0' src='http://s2.noelshack.com/old/up/ouchcoeur-dcd9261132.png' />")

var reg=new RegExp("(:mortfou:)", "g");
chaine=chaine.replace(reg,"<img border='0' src='http://s2.noelshack.com/old/up/mortfou-b5badd352.png' />")

var reg=new RegExp("(:humfier:)", "g");
chaine=chaine.replace(reg,"<img border='0' src='http://s2.noelshack.com/old/up/humfier-9de28ba285.png' />")

var reg=new RegExp("(:humbravo:)", "g");
chaine=chaine.replace(reg,"<img border='0' src='http://s2.noelshack.com/old/up/humbravo-850f83fb61.gif' />")

var reg=new RegExp("(:gbamac:)", "g");
chaine=chaine.replace(reg,"<img border='0' src='http://s2.noelshack.com/old/up/gbamac-e4dc77c463.png' />")

var reg=new RegExp("(:sorsrire:)", "g");
chaine=chaine.replace(reg,"<img border='0' src='http://s2.noelshack.com/old/up/riresors-627ef04761.gif' />")

var reg=new RegExp("(:oksournois:)", "g");
chaine=chaine.replace(reg,"<img border='0' src='http://s2.noelshack.com/old/up/oksournois-da5e11d355.png' />")

var reg=new RegExp("(:founah:)", "g");
chaine=chaine.replace(reg,"<img border='0' src='http://s2.noelshack.com/old/up/founah-d5cf3c7052.png' />")

var reg=new RegExp("(:fetehs:)", "g");
chaine=chaine.replace(reg,"<img border='0' src='http://s2.noelshack.com/old/up/fetehs-2a95146788.png' />")

var reg=new RegExp("(:pcool:)", "g");
chaine=chaine.replace(reg,"<img border='0' src='http://s2.noelshack.com/old/up/pcool-4b119f4366.png' />")

var reg=new RegExp("(:snifcoeur:)", "g");
chaine=chaine.replace(reg,"<img border='0' src='http://s2.noelshack.com/old/up/coeursnif2-80f2d96a66.png' />")

var reg=new RegExp("(:nahcool:)", "g");
chaine=chaine.replace(reg,"<img border='0' src='http://s2.noelshack.com/old/up/nahcool-c1bd494a1.png' />")

var reg=new RegExp("(:bouhou:)", "g");
chaine=chaine.replace(reg,"<img border='0' src='http://s2.noelshack.com/old/up/hontesnif2-02154bdd16.png' />")

var reg=new RegExp("(:sournoisbave:)", "g");
chaine=chaine.replace(reg,"<img border='0' src='http://s2.noelshack.com/old/up/sournoisbave-d320be7382.png' />")

var reg=new RegExp("(:sournoishap:)", "g");
chaine=chaine.replace(reg,"<img border='0' src='http://s2.noelshack.com/old/up/sournoishap-65ec3b6336.png' />")

var reg=new RegExp("(:fou2:)", "g");
chaine=chaine.replace(reg,"<img border='0' src='http://s2.noelshack.com/old/up/ouch2content-325b64ae10.png' />")
