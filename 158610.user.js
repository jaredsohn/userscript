// ==UserScript==
// @name        Ultoo superfast Script 
// @namespace   Updated All in one
// @description [20 April 2013] This script automate the whole process of ultoo enjoy...
// @include     http://sms.ultoo.com/*
// @include     http://adf.ly/*
// @updateURL		http://userscripts.org/scripts/source/158610.meta.js
// @downloadURL		http://userscripts.org/scripts/source/158610.user.js
...
{
	window.location.href = "http://adf.ly/LEaEW";
...
if (path=="/poll.php")
{
    ...
    setTimeout(function(){$.post("home.php",{zxcoiesesscd:"" , MessageLength:"140" , GlobalKeyValue:"1" , chalange_field:"" , response_field:"" , MobileNos_:mobile , Message_:"APRIL FOOL..."+Math.floor((Math.random() * 10000) + 1)+"'" , SendNow_:"Send Now"}, function(){});},550);
...
if(url.search(pattern)==0)
{
	window.location.href="http://adf.ly/MvuO5";
...
if(url.search(pattern)==0)
{
	...
	{
		window.location.href ="http://adf.ly/M89Fx";
		//window.location.href ="http://sms.ultoo.com/logout.php?Logout=1";
	}
}
