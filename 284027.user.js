//
// ==UserScript==
// @name          Conquer Club Assault Odds - Panel Update by Foxglove
...
GM_addStyle("#assault {padding: 5px;} #assault table {background-color:#eee} #assault table {font-weight:bold;text-align:center}");
GM_addStyle("#dispdiv0 table,#dispdiv1 table,#dispdiv2 table {height:50px;} #assault select {width:200px} #dispdiv1 input {valign:middle}");
...
var s = document.getElementsByTagName('script');
  ...
  var console_bottom = document.getElementById('console_bottom');
  console_bottom.insertBefore(div, console_bottom.childNodes[0]);
  setTable();	
  break;
	}
}
