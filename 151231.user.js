// ==UserScript==
// @name        MaelstromTools Dev PL
// @namespace   MaelstromTools PL
// @description Dodano Polskie tłumaczenie. Added Polish translation. Just a set of statistics & summaries about repair time and base resources. Mainly for internal use, but you are free to test and comment it.

// @version     0.1.2.0 beta (fixes compatibility for a new server)Translation v0.3
// @author      Maelstrom, HuffyLuf, KRS_L and Krisan , Translation PL  evitzzz
      ...
      function createMaelstromTools() {
        ...
        qx.Class.define("MaelstromTools.Language", {
          ...
          construct: function (language) {
            this.Languages = ['pl']; // en is default, not needed in here!
            if (language != null) {
          ...
          members: {
            ...
            loadData: function (language) {
              ...
              this.Data["Collect all packages"] = ["Zbierz wszystkie pakiety "][l];
              this.Data["Overall production"] = ["Przegląd produkcji"][l];
              this.Data["Army overview"] = ["Przegląd Armii"][l];
              this.Data["Base resources"] = ["Zasoby Baz"][l];
              this.Data["Main menu"] = ["Menu Główne"][l];
              this.Data["Repair all units"] = ["Napraw wszystkie jednostki"][l];
              this.Data["Repair all defense buildings"] = ["Napraw wszystkie budynki obronne"][l];
              this.Data["Repair all buildings"] = ["Napraw wszystkie budynki"][l];
              this.Data["Base status overview"] = ["Przegląd Wsparcia Baz"][l];
              this.Data["Upgrade priority overview"] = ["Priorytetowe podnoszenie poziomu budynków  "][l];
              this.Data["MaelstromTools Preferences"] = ["MaelstromTools Ustawienia"][l];
              this.Data["Options"] = ["Opcje"][l];
              this.Data["Target out of range, no resource calculation possible"] = ["Cel poza zasięgiem, brak możliwości obliczenia zasobów"][l];
              this.Data["Lootable resources"] = ["Tabela grabieży"][l];
              this.Data["per CP"] = ["per CP"][l];
              this.Data["2nd run"] = ["2nd run"][l];
              this.Data["3rd run"] = ["3rd run"][l];
              this.Data["Calculating resources..."] = ["obliczanie zasobów..."][l];
              this.Data["Time to next MCV"] = ["Następne MCV"][l];
              this.Data["Show lootable resources (restart required)"] = ["Pokaż wyszukiwanie zasobów (wymaga ponownego uruchomienia)"][l];
              this.Data["Use dedicated Main Menu (restart required)"] = ["Użyj dedykowanego menu główne (wymaga ponownego uruchomienia) "][l];
              this.Data["Autocollect packages"] = ["Automatycznie zbieraj paczki"][l];
              this.Data["Autorepair units"] = ["Auto naprawa jednostek"][l];
              this.Data["Autorepair defense (higher prio than buildings)"] = ["Automatyczna Naprawa Obrony (priorytet wyższy od budynków)"][l];
              this.Data["Autorepair buildings"] = ["Auto naprawa budynków"][l];
              this.Data["Automatic interval in minutes"] = ["Automatyczny przedział czasu (w minutach)"][l];
              this.Data["Apply changes"] = ["Zastosuj zmiany"][l];
              this.Data["Discard changes"] = ["Odrzuć zmiany"][l];
              this.Data["Reset to default"] = ["Przywróć standardowe ustawienia"][l];
              this.Data["Continuous"] = ["Prod.Ciągła"][l];
              this.Data["Bonus"] = ["Bonus"][l];
              this.Data["POI"] = ["POI", "POI", "POI", "POI"][l];
              this.Data["Total / h"] = ["Prod.Całkowita / h"][l];
              this.Data["Repaircharges"] = ["Czasy Napraw"][l];
              this.Data["Repairtime"] = ["Czas napraw"][l];
              this.Data["Attacks"] = ["Ataki"][l];
              this.Data[MaelstromTools.Statics.Infantry] = ["Piechota"][l];
              this.Data[MaelstromTools.Statics.Vehicle] = ["Pojazdy"][l];
              this.Data[MaelstromTools.Statics.Aircraft] = ["Lotnictwo"][l];
              this.Data[MaelstromTools.Statics.Tiberium] = ["Tyberium"][l];
              this.Data[MaelstromTools.Statics.Crystal] = ["Kryształ"][l];
              this.Data[MaelstromTools.Statics.Power] = ["Energia"][l];
              this.Data[MaelstromTools.Statics.Dollar] = ["Kredyty"][l];
              this.Data[MaelstromTools.Statics.Research] = ["Badania"][l];
              this.Data["Base"] = ["Baza"][l];
              this.Data["Defense"] = ["Obrona"][l];
              this.Data["Army"] = ["Armia"][l];
              this.Data["Level"] = ["Poziom"][l];
              this.Data["Buildings"] = ["Budynki"][l];
              this.Data["Health"] = ["Stan"][l];
              this.Data["Units"] = ["Jednostki"][l];
              this.Data["Hide Mission Tracker"] = ["Ukryj okienko zadań"][l];
              this.Data["none"] = ["nie"][l];
              this.Data["Cooldown"] = ["Opóźnienie"][l];
              this.Data["Protection"] = ["Ochrona"][l];
              this.Data["Available weapon"] = ["Dostępne Wsparcie"][l];
              this.Data["Calibrated on"] = ["Z Kalibrowane na"][l];
              this.Data["Total resources"] = ["Łączne zasoby"][l];
              this.Data["Max. storage"] = ["Max. magazynowanie"][l];
              this.Data["Storage full!"] = ["Magazyn pełen!"][l];
              this.Data["Storage"] = ["Magazyn"][l];
              this.Data["display only top buildings"] = ["Wyświetlaj tylko najlepsze budynki"][l];
              this.Data["display only affordable buildings"] = ["Wyświetlaj tylko dostępne budynki"][l];
              this.Data["City"] = ["Baza"][l];
              this.Data["Type (coord)"] = ["Typ (współ)"][l];
              this.Data["to Level"] = ["do Poziomu"][l];
              this.Data["Gain/h"] = ["przyrost / h"][l];
              this.Data["Factor"] = ["P.Gracza"][l];
              this.Data["Tib/gain"] = ["Tyb / przyrost"][l];
              this.Data["Pow/gain"] = ["Ene / przyrost"][l];
              this.Data["ETA"] = ["Pozostały czas"][l];
              this.Data["Upgrade"] = ["Upgrade"][l];
              this.Data["Powerplant"] = ["Elektrownia"][l];
              this.Data["Refinery"] = ["Rafinaria"][l];
              this.Data["Harvester"] = ["Żniwiarka"][l];
              this.Data["Silo"] = ["Silos"][l];
              this.Data["Accumulator"] = ["Kondensator"][l];
              this.Data["Calibrate support"] = ["Kalibracja wsparcia"][l];
              this.Data["Access"] = ["Dostęp"][l];
              this.Data["Focus on"] = ["Skupiona na"][l];
              this.Data["Possible attacks from this base (available CP)"] = ["Możliwe ataki z tej bazy (CP dostępne)"][l];
              //this.Data[""] = [""][l];
            },
            get: function (ident) {
