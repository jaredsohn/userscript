// ==UserScript==
// @name           GLB Player Builder v2 Experimental
// @namespace      monsterkill
// @description    what if player development time was cut in half
    ...
    if (day > 0 && day < 41) {
        ...
        if (getAge()<plateau_age) {
            ...
            if (level<16) {
                ...
                //rage increaseXP(daily_xp_factor * 25);
                increaseXP(daily_xp_factor * 45);
            }
        }
    ...
    if (day > 0 && day%2 == 1 && day <= 32) {
        if (getAge()<plateau_age) {
            ...
            if (level<16) {
                ...
                //rage increaseXP(game_xp_factor * 100);
                increaseXP(game_xp_factor * 200);
            }
        }
    }
    if (autoTrain) {
