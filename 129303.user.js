// ==UserScript==
// @name          Печеньки атакуют ver.4 
// @include       *travian*build.php?id=39&tt=2* 
// @version 13.04
...
function AttackBuilder(account){
	...
	this.onloadPostSecondPage = function(response) {
		...
		if (_this.countAttacksComplet >= _this.countAttacksPerCoord) {
			...
			addCount(".");
			addCount("<a href='build.php?id=39&tt=2&z=*'>"+text[8]+" ("+aMatch[0]+") x " + _this.countAttacksComplet + "("+_this.countAttacksPerCoord+")</a><br/>");
