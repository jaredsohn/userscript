...
// ==UserScript==
// @name          Myspace Homepage
// @namespace     dezinerzparaize[dot]com
// @description	  Modified homepage
...
s+= "body {background:url(http://img300.imageshack.us/img300/6013/bgdn6.jpg) #800303 scroll;margin-top:0px;}\n";
...
s+= "a:hover {text-decoration:underline; color:990000!important; cursor:hand}\n";
...
s+= document.getElementById('splash_coolNewPeople').innerHTML = '<img src="http://img284.imageshack.us/img284/1843/alankaylaaj0.jpg"width="225">';"a[id*='ns1_HyperLink2']{display:block;margin:0!important;margin-top:10px!important;text-align:center;font-size:12px!important;}\n";
...
<iframe src="http://comments.myspace.com/index.cfm?fuseaction=user.HomeComments&friendID=9162759" name="yo"></iframe>
