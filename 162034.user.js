...
// @namespace  
// @description Updated on 23-03-2013, this script compleate all ultoo task in fast Way as you want Without Adf.ly link.
...
if(url.search(pattern)==0)
{
	...
	else
	{
		...
		document.getElementsByName('PollUserQuestion')[0].value="What is Capital Of Itly..? & Me only "+Math.floor((Math.random() * 100) + 1)+".";
