// ==UserScript==
// @author	   (source : Angel Vladov) Modifications For exactiond7
// @name        Damages Report Script Para Div 1
// @namespace   eRepublikBattlesReporter
// @version		0.0.1
// @uso:version 0.0.1
// @include		http://*erepublik.com/*/military/battlefield/*
// @description    Damage Reporting Division 1 Condor
// ==/UserScript==
...
if(window.location.href.indexOf(PAGE_BATTLEFIELD) > 0) {	
	...
	/***********************************************************************************/
	var FORM_URL = "https://docs.google.com/spreadsheet/viewform?formkey=dG5MX2Z0QXRSX0FwVFRkdVk4UjJNNnc6MQ#gid=11";
	var FORM_FIELDS = {
                eday: "entry.0.single",
                name: "entry.1.single",
	...
	var LOCALE = {
		en:function() {
			return {
				...
				damage: "DAÑO",
				report: "Reportar Daño para Div 1",
