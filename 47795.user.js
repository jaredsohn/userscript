// ==UserScript==
// @name			VFV-Core - V for Ventouza
// @version 		0.1	
// @namespace 		http://v-f-v.niceboard.net
// @author			ERAS
// @description	    	Παραλλαγή του script ika-core για τη συμμαχία V for Ventouza [VFV] 
...
switch (location.host) {
	case 's3.ikariam.gr':
		...
		chaturl='.';
		chaturl='http://v-f-v.niceboard.net';
		//forumurl='.';
		forumurl='http://v-f-v.niceboard.net';
		//forumurlnew='.';
		forumurlnew='http://v-f-v.niceboard.net';
		break;
	...
	case 's4.ikariam.gr':
		...
		//Use the DOT (.) to not include the chat, forum, forumnew in the menu.
		chaturl='.';
		chaturl='http://v-f-v.niceboard.net/chatbox.forum?';
		//forumurl='.';
		forumurl='http://v-f-v.niceboard.net';
		//forumurlnew='.';
		forumurlnew='http://v-f-v.niceboard.net';
...
var showbubble=Math.floor(Math.random()*10);
    if (showbubble%2) { //If Even
		addsbubble('mayor', "Φτιάξε κάτι.. βαριέμαι, θέλω να δώ κίνηση!",30);
		addsbubble('diplomat',"Κοίτα μη με ζαλίζεις,να τα έχεις καλά με τους γείτονες ε!",40);
		addsbubble('scientist',"Εύρηκααααα αααααχαχαχαχα, φέρε τώρα λίγο κρασί και για μας !",40);
		addsbubble('general',"θυμήσου, 2000 στρατό τουλάχιστον για να μείνεις στη VFV ...",40);
