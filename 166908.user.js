...
// @description 视频去广告
// @version 0.2.2
// @namespace http://myhome.vipvip.me/noad/
// @updateURL http://myhome.vipvip.me/noad/noad.js
// @downloadURL http://myhome.vipvip.me/noad/noad.js
// @include http://*/*
// @include https://*/*
// @grant GM_xmlhttpRequest
// ==/UserScript==
//
// http://userscripts.org/users/Harv
// http://myhome.vipvip.me/noad/noad.js
// https://userscripts.org/scripts/source/119622.user.js
//
(function() {
    ...
    YoukuAntiAds.prototype = {
        ...
        get players() {
            if(!this._players) {
                this._players = {
                    'youku': 'http://myhome.vipvip.me/noad/player/loader.swf',
                    'ku6': 'http://myhome.vipvip.me/noad/player/ku6.swf',
                    'iqiyi': 'http://myhome.vipvip.me/noad/player/iqiyi.swf',
                    'iqiyi5': 'http://myhome.vipvip.me/noad/player/iqiyi5.swf',
                    'tudou': 'http://myhome.vipvip.me/noad/player/tudou.swf',
                    'tudou_olc': 'http://myhome.vipvip.me/noad/player/testmod/olc_8.swf',
                    'tudou_sp': 'http://myhome.vipvip.me/noad/player/testmod/sp.swf'
                };
            }
        ...
        initPreHandlers: function() {
            ...
            this.rules['tudou_out']['preHandle'] = function(elem, find, replace, player) {
                ...
                GM_xmlhttpRequest({
                    ...
                    url: isFx ? player : 'http://query.yahooapis.com/v1/public/yql?format=json&q=' + encodeURIComponent('use"http://myhome.vipvip.me/noad/firefox/tudou_redirect.yql.xml" as tudou; select * from tudou where url="' + player + '" and referer="' + window.location.href + '"'),
