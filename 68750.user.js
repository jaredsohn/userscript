...
defineLanguage = function () {
   ...
   default:
      language = {
         ...
         reply2: 'only if there is previous subject',
         defaultAllySubject: 'Ally message subject',
      ...
      if (GM_getValue('Reply')) {
         ...
         if (isDefined(replyMessage)) {
            ...
            if (isDefined(replySubject)) {
               ...
               if (replySubject.split(lang.Re)[1] != null) {
                  replySubject = replySubject.split(lang.Re)[1];
               }
...
function optionsPage() {
   ...
   newElement.innerHTML =
      "<div class='contentBox01h'>" +
         "<h3 class='header'>" +
            "<a href='http://ikariam.norsam.org/ikariam_subject.en.html' target='_blank'>Subject v " + version + "</a>" +
            "<span style='font-size:10px;'>  by <a href='http://ikariam.norsam.org/' target='_blank'>Norsam</a></span>" +
         "</h3>" +
         "<div class='content'>" +
            "<table cellpadding='0' cellspacing='0'>" +
               "<tbody>" +
                  "<tr>" +
                     ...
                     "<td><input class='textfield' style='width: 60px;' type='text' id='defaultAllySubjectValue' value='" + defaultAllySubject + "'></td>" +
                  "</tr>" +
                  "<tr>" +
                     "<th id='defaultSubject'>" + lang.defaultSubject + "</th>" +
                     "<td><input class='textfield' style='width: 60px;' type='text' id='defaultSubjectValue' value='" + defaultSubject + "'></td>" +
                  "</tr>" +
                     "<tr>" +
                        "<th id='subjectReply'>" + lang.reply + "</th>" +
                        "<td><input type='checkbox' id='subjectReply1'></td>"+
                        "<td><input type='checkbox' disabled='true' id='subjectReply2'><span id='subjectReplyCondition'>" + lang.reply2 + "</span></td>"+
                     "</tr>" +
                  "<tr>" +
