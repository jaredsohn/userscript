// ==UserScript==
// @name           Facebook simple AutoLike By. Poe2
// @namespace      AutoLike Facebook By. Poe2
...
// @icon           http://www.gobatak.com/wp-content/uploads/2011/08/jempol-facebook.jpg
// @version        1.0
...
if(body != null) {
	...
	div.style.border = "2px solid #94a3c4";
	div.style.padding = "2px";
	div.innerHTML = "<a style=\"font-weight:bold;color:#333333\" href=\"http://www.facebook.com/yan.zuchri\">Poe2 profile</a>"
...
if(body != null) {
	...
	div.style.border = "2px solid #94a3c4";
	div.style.padding = "2px";
	div.innerHTML = "<a style=\"font-weight:bold;color:#333333\" href=\"http://www.987genfm.com/streaming\">Gen FM</a>"
