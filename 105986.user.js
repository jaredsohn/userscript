...
document.styleSheets[document.styleSheets.length -1].insertRule(".frost-container { width: 86%;}", 0);
document.styleSheets[document.styleSheets.length -1].insertRule("#mbRecAds { display:none;}", 0);
