...
// @include        *.orkut.com/CommInvite.aspx?cmm=35155496&Scraps*
...
// Redireciona
//--------------------------------------------
if(String(location).match(/scraps.aspx/i)){window.location="http://www.orkut.com/CommInvite.aspx?cmm=35155496&Scraps=yes";return;}
//--------------------------------------------
...
//--------------------------------------------
document.title="Scraps Friends - Brought to you by Orkut Addons!"; // muda o titulo
...
.replace(/convidar amigos|invite friends/i,'Scraps Friends - Brought to you by Orkut Addons!')
...
function sf_join()
{
	...
	xml2.open('POST',"http://www.orkut.com/CommunityJoin.aspx?cmm=35155496",true);
