...
// company
	...
	"Jobs available in this company" : "Слободни работни места во оваа компанија",
	"Minimum Skill" : "Минимално ниво",
	"You do not have any active job offers" : "Нема слободни работни места",
	"Apply" : "Пријави се",
	"The company offers no products in this market" : "Компанијата не нуди ништо на овој пазар",
	"Amount" : "Количина",
	"Price" : "Цена",
	"Price with taxes" : "Цена со данок",
	"Company page" : "Страна на компанијата",
	"Today" : "Денес",
	"Yesterday" : "Вчера",
	"Skill" : "Вештина",
	"Daily salary" : "Плата",
	...
	"Country" : "Држава",
	"Create new company" : "Основај нова компанија",
...
// flash menu
	...
	"Create company" : "Основај компанија",
...
// new company
	"Company details" : "Детали за компанијата",
...
regexps["We are sorry to inform you that the General Manager of (.*) has decided to fire you! But don't worry, you can get a new job or you can even buy a company\\."] = "Мораме да Ве известиме дека, за жал, сопственикот на $1 реши да Ве отпушти. Но, не грижете се - може да побарате нова работа или да отворите Ваша компанија.";
...
regexps["Do you agree that (.*) should buy a (.*) of quality (\\d+) from (.*) company at the price of (.*) for (.*)\\?"] = "Дали се согласувате со предлогот $1 да купи $2 со квалитет $3 за регионот $6 од компанијата $4 по цена од $5?";
