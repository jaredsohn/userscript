// ==UserScript==
// @name            PC World article print
// @include         http://www.pcworld.com/*/article/*.html
// ==/UserScript==

function do_platypus_script() {
fix_page_it(window.document,'/HTML[1]',null,null,null);
isolate(window.document,document.getElementById('leftColumn'),null,null,null);
relax(window.document,document.getElementById('leftColumn'),null,null,null);
