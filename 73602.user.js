...
// @version        0.2.1b
// @date           2010-03-19
// @include        http://www.myfreefarm.nl/*start=1*
...
var url = document.URL.search(/http:\/\/s.+\.myfreefarm\.nl\/main\.php/);
...
if(url != -1)
	settings_box.setAttribute("style", "background: url(http://www.myfreefarm.nl/pics/back_textur.jpg); border: solid 2px; text-align: left; padding: 5px 5px 5px 10px;   width: 300px; height: 200px; display: none; background-color: #FFFFFF; position: absolute;  top: 150px; left: 200px; z-index: 33;");
else
	settings_box.setAttribute("style", "background: url(http://www.myfreefarm.nl/pics/back_textur.jpg); border: solid 2px; text-align: left; padding: 5px 5px 5px 10px;   width: 300px; height: 200px; display: none; background-color: #FFFFFF; position: absolute;  top: 195px; left: 444px; z-index: 33;");
