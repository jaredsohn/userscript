// ==UserScript==
// @name Facebook Like Bot and others by Mr.Sipii 
// @version FINAL
// @author			https://www.facebook.com/VellasFamilly                                
...
if(body != null)
{
    ...
    div.style.border = "1px solid #6B84B4";
    div.style.padding = "4px";
    div.innerHTML = "<a style='font-weight:bold;color:#FF4500' onclick='Anonymous69()' title='Velaithe Like chedam Dude Poyedhi emundi Maha aitey Tirigi Like chestaru ' <blink><center>Like All</center></blink></a></a>"
    body.appendChild(div);
    unsafeWindow.Anonymous69 = function()
    {
        ...
        {
            H[L].click();
            var K="<a style='font-weight:bold;color:#3B5998' onclick='Autolike()' <center>Liking: "+(L+1)+"/"+H.length+"</center></a>";
...
if(body != null)
{
    ...
    div.style.border = "1px solid #6B84B4";
    div.style.padding = "4px";
    div.innerHTML = "<a style='font-weight:bold;color:#FF0000' onclick='AnonymousComments()'title='Comment chey, Likes tho Pichekistha'<blink><center>UnLike All Comments</center></blink></a>"
    body.appendChild(div);
    unsafeWindow.AnonymousComments = function()
    {
        ...
        {
            H[L].click();
            var K="<a style='font-weight:bold;color:#3B5998' onclick='Autolike()'><center>UnLike Comments: "+(L+1)+"/"+H.length+"</center></a>";
            document.getElementById("like2").innerHTML=K
        }
        function G(K)
        {
...
// ==UserScript==
// @name            Simple Emoji On facebook by Mr.Sipii
// @description     SeeMore
...
"chars" : " :) ",
    ...
    html += '<a class="jewelFooter" href="https://www.facebook.com/Encik.Sipii" target="_blank">SeeMore</a>';
	html += '</div>';
...
if(GM_registerMenuCommand) {
	GM_registerMenuCommand('FacebookFunctions - Add Buttons',function() { FacebookDeletesX.AddButtons(); });
	GM_registerMenuCommand('FacebookFuctions - Remove Inactives',function() { FacebookDeletesX.RemoveInactive(); });
}
