// coding: utf-8
// ==UserScript==
// @name        	דוקטור צחוק מציג : איקרים נושא ימי הביניים
// @version 		0.1
// @author		דוקטור צחוק
// @description		לשרתים ישראלים בלבד - זה יוסיף סקין שיחליף את כל המבנים והיחידות למראה ימי הביניים.....
// @namespace		medieval.ikariam
// @include		http://s*.il.ikariam.*/index.php*
...
/*
	This is an adaptation of the Ikariam Medieval Theme made by bluesman ( http://userscripts.org/users/165018 ) for hebrew servers.
*/
...
Skin = {
	...
	addStyles : function ()
	{
		...
		var level = this.cityLevel > 18 ? 18 : this.cityLevel;
		...
		{
			if (this.position == 15) // for city wall
			{
