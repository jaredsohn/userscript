...
\
		...
		<div class=\"option tab_popular\" tooltip-alignh=\"right\" data-hover=\"tooltip\" title=\"By default, when entering comments, clicking Enter will submit the comment. Enable this option to restore the old functionality, where Enter = New Line, and to post the message you can click Tab-Enter.\">\
			<div class=\"desc\">\
									...
									var render_chat_item = function(id) {
										...
										if (uinfo) {
											...
											var h = _template( "\
												...
												</a>", style, id, uinfo.name, uinfo.thumbSrc, displayName, uinfo.uri);
