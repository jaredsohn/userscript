...
// @name        Damages Report Script for RA
// @namespace   eRepublikBattlesReporter_RA
// @version		0.0.1
// @uso:version 0.0.1
// @include		http://*erepublik.com/*/military/battlefield/*
// @description    eRepublik Damage Reporting script for RA
// ==/UserScript==
...
if(window.location.href.indexOf(PAGE_BATTLEFIELD) > 0) {	
	...
	/***********************************************************************************/
	var FORM_URL = "https://docs.google.com/spreadsheet/viewform?formkey=dE1MTDN6X1Y2ejRrbGxFNk43OWViMWc6MA#gid=0";
	var FORM_FIELDS = {
                eday: "entry.0.single",
                name: "entry.2.single",
