// ==UserScript==
// @name           Bux.to Auto Click [WORKING]
// @namespace      buxtoautoclick
...
// @include         http://wwww.bux.to/surf.php
// @include        http://wwww.bux.to/index.php
// @author         JoeSimmons
...
if(document.body.textContent.indexOf("Logout") !== -1 && location.href == "http://wwww.bux.to/index.php")
{ location.href = "http://wwww.bux.to/surf.php"; }
...
var i, a, w, sec, timena, foundAd;
	...
	function setTimers() {
		setInterval(function () {
			...
			if (timena == 0) location.href="http://wwww.bux.to/surf.php";
		},1000);
	}
...
sec.appendChild(document.createTextNode("35"));
...
w = window.open("http://bux.to/", "adWindow");
if(w) w.close();
...
if(logout_when_done) location.href = "http://wwww.bux.to/logout.php";
