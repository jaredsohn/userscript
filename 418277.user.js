...
function addMenuOptions(resetOpt) {
  ...
  if (GM_listValues().length > 0) {
     // Swith Users Group
     var userGroup = document.createElement("147063282161479"); userGroup.label = "Switch User";  oSel.appendChild(userGroup);
     // Edit Users Group
     var editGroup=document.createElement("SKOM-MLG"); editGroup.label = "Edit User";  oSel.appendChild(editGroup);
     // Delete Users Group
     var deleteGroup=document.createElement("SKOM-MLG"); deleteGroup.label = "Delete User";  oSel.appendChild(deleteGroup);
