		...
		function createClasses()
		{
			qx.Class.define("TGCTools", 
			{
				...
				construct: function()
				{
					try
					{
						...
						this.managerBtn = new qx.ui.form.Button("Менеджер").set({alignX: "center"});
						this.managerBtn.set
						({
							alignY: "middle",
							width: 75,
							height: 30,
							toolTipText: "Открывает окно скриптов",
							appearance: "button-text-small"
						});
						...
						({
							...
							width: 40,
							height: 40,
							toolTipText: "Открывает Сканер баз",
							appearance: "button-text-small"
						});
						...
						({
							...
							width: 40,
							height: 40,
							toolTipText: "Открывает опции настроек по ПОИ",
							appearance: "button-text-small"
						});
						...
						({
							...
							width: 40,
							height: 40,
							toolTipText: "Открывает опции автопостроек",
							appearance: "button-text-small"
						});
			...
			qx.Class.define("TGCTools.BaseScanner", 
			{
				...
				construct: function()
				{
					try
					{
						...
						var scanBtn = new qx.ui.form.Button("Поиск").set({
							allowGrowY: false,
							width: 60, 
							height: 20,
							toolTipText: "Начать сканирование баз",
							appearance: "button-text-small"
						});
						...
						stopBtn = new qx.ui.form.Button("Стоп").set({
							allowGrowY: false,
							width: 60, 
							height: 20,
							toolTipText: "Остановить поиск",
							appearance: "button-text-small"
						});
						this.stopScan = false;
						...
						this.cityTypeSelectBox.add(new qx.ui.form.ListItem("Тип баз (Все)", null, "0"));
						this.cityTypeSelectBox.add(new qx.ui.form.ListItem("Лагерь/Аванпост", null, "1"));
						this.cityTypeSelectBox.add(new qx.ui.form.ListItem("Лагерь/Аванпост/База", null, "2"));
						this.cityTypeSelectBox.add(new qx.ui.form.ListItem("Лагерь/Аванпост/Игрок", null, "3"));
						this.cityTypeSelectBox.add(new qx.ui.form.ListItem("База", null, "4"));
						this.cityTypeSelectBox.add(new qx.ui.form.ListItem("База/Игрок", null, "5"));
						this.cityTypeSelectBox.add(new qx.ui.form.ListItem("Игрок", null, "6"));
						
						var layoutBtn = new qx.ui.form.Button("Макеты").set({
							allowGrowY: false,
							width: 60, 
							height: 20,
							toolTipText: "Открыть окно с макетами расположений",
							appearance: "button-text-small"
						});
						...
						this.distanceSelectBox.add(new qx.ui.form.ListItem("Дистанция (Все)", null, "0"));
						for (var i = 1; i <= 20; i++)
						{
						...
						this.cpCostBox.add(new qx.ui.form.ListItem("По ОК (Все)", null, "0"));
						...
						var allLayouts =  new qx.ui.form.ListItem("Тип базы (All)", null, "0");
						var moreTib = new qx.ui.form.ListItem("7 Тиберий/5 Кристал", null, "1");
						var equalTibCry = new qx.ui.form.ListItem("6 Тиберий/6 Кристал", null, "2");
						var moreCry = new qx.ui.form.ListItem("5 Тиберий/7 Кристал", null, "3");
						...
						this.scanTableModel.setColumns(["Номер", "Уровень", "Название", "Владелец", "Место", "Дистанция", "Цена ОК", "Сбор", "Общий сбор", "Тиберий", "Кристалы", "Деньги", "ОИ"]);
				...
				members: 
				{
					...
					_scanBases: function(ownCity)
					{
						...
						this.scanStatus.setValue("Сканирование - найдено: " + count);
						//var ownCity = ClientLib.Data.MainData.GetInstance().get_Cities().get_CurrentOwnCity();
								...
								if (object != null)
								{
									...
									switch(cityAttr.type)
									{
										case ClientLib.Vis.VisObject.EObjectType.RegionNPCBase:
											cityAttr.name = "База";
											cityAttr.owner = "Забытые";
											break;
										case ClientLib.Vis.VisObject.EObjectType.RegionNPCCamp:
											cityAttr.name = "Лагерь/Аванпост";
											cityAttr.owner = "Забытые";
											break;
					...
					_getScannedCityData: function()
					{
						...
						this.scanStatus.setValue("Получение информации о базах: (" + (this.scanIdx + 1) + " из " + this.scannedCities.length + ")");						
					...
					_getNextScannedCity: function(status)
					{
						...
						{
							this.scanStatus.setValue("Поиск завершен: Показано " + this.tableData.length + " результатов.");	
							stopBtn.setEnabled(false);
						}
					},
			...
			qx.Class.define("TGCTools.POIWindow", 
			{
					...
					try
					{
						...
						this.poiData = 
						{
							labels:
							{
								total:
								{
									score: new qx.ui.basic.Label("Очки: "),
									qty: new qx.ui.basic.Label("Точки: "),
									bonus: new qx.ui.basic.Label("Бонус: "),
									nextTier: new qx.ui.basic.Label("До следующего Уровня: "),
									nextRank: new qx.ui.basic.Label("До следующего Ранга: "),
								},
								
								tier:
								{
									tier: new qx.ui.basic.Label("Уровни").set({textColor: "black"}),
									prev: new qx.ui.basic.Label("Предыдущий:").set({textColor: "red"}),
									curr: new qx.ui.basic.Label("Текущий:").set({textColor: "blue"}),
									next: new qx.ui.basic.Label("Следующий:").set({textColor: "green"}),
									
									lower: new qx.ui.basic.Label("Ниже").set({textColor: "black"}),
									upper: new qx.ui.basic.Label("Выше").set({textColor: "black"}),
									bonus: new qx.ui.basic.Label("Бонус").set({textColor: "black"}),
									diff:  new qx.ui.basic.Label("Разница +/-").set({textColor: "black"}),
								},
							
								rank:
								{
									rank: new qx.ui.basic.Label("Рейтинг").set({textColor: "black"}),
									prev: new qx.ui.basic.Label("Предыдущий:").set({textColor: "red"}),
									curr: new qx.ui.basic.Label("   Текущий:").set({textColor: "blue"}),
									next: new qx.ui.basic.Label(" Следующий:").set({textColor: "green"}),
									
									alliance: new qx.ui.basic.Label("Альянс").set({textColor: "black"}),
									score: new qx.ui.basic.Label("Счет").set({textColor: "black"}),
									multi: new qx.ui.basic.Label("Коэффициент").set({textColor: "black"}),
									diff: new qx.ui.basic.Label("Разница +/-").set({textColor: "black"}),
								},
								
								simulation:
								{
									sim: new qx.ui.basic.Label("Симуляция").set({textColor: "black"}),
									prev: new qx.ui.basic.Label("Предыдущий:").set({textColor: "red"}),
									curr: new qx.ui.basic.Label("Текущий:").set({textColor: "blue"}),
									...
									bonus: new qx.ui.basic.Label("Бонус").set({textColor: "black"}),
									multi: new qx.ui.basic.Label("Коэффициент").set({textColor: "black"}),
									totalBonus: new qx.ui.basic.Label("Макс. бонус").set({textColor: "black"}),
								},
							},
							...
							counts:
							{
								...
								rank:
								{
									prev:
									{
										alliance: new qx.ui.basic.Label("Недоступно").set({textColor: "red"}),
									...
									curr:
									{
										alliance: new qx.ui.basic.Label("Недоступно").set({textColor: "blue"}),
									...
									next:
									{
										alliance: new qx.ui.basic.Label("Недоступно").set({textColor: "darkgreen"}),
						...
						this.tableModel.setColumns(["Уровень", "Координаты", "Очки", "Потери", "Tier", "Ранг"]);
						...
						this.table.setToolTipText("Отображает данные по точкам ПОИ. Для перехода к точке дважды кликните мышкой по ПОИ."); 
						...
						this.selectBox.add(new qx.ui.form.ListItem("Тиберий", "webfrontend/ui/common/icn_res_tiberium.png", "4"));
						this.selectBox.add(new qx.ui.form.ListItem("Кристалы", "webfrontend/ui/common/icn_res_chrystal.png", "5"));
						this.selectBox.add(new qx.ui.form.ListItem("Реактор", "webfrontend/ui/common/icn_res_power.png", "6"));
						this.selectBox.add(new qx.ui.form.ListItem("Пехота", "FactionUI/icons/icon_alliance_bonus_inf.png", "7"));
						this.selectBox.add(new qx.ui.form.ListItem("Техника", "FactionUI/icons/icon_alliance_bonus_tnk.png", "8"));
						this.selectBox.add(new qx.ui.form.ListItem("Авиация", "FactionUI/icons/icon_alliance_bonus_air.png", "9"));
						this.selectBox.add(new qx.ui.form.ListItem("Защита", "FactionUI/icons/icon_def_army_points.png", "10"));
						this.selectBox.setToolTipText("Выберите ПОИ для просмотра.");
						...
						var updateBtn = new qx.ui.form.Button("Обновить").set({height: 35, allowGrowX: false, allowGrowY: false, alignX: "center", rich: true});
						var simulateBtn = new qx.ui.form.Button("Симуляция").set({height: 35, allowGrowX: false, allowGrowY: false, alignX: "center", rich: true});
						var listBtn = new qx.ui.form.Button("Добавить ПОИ").set({height: 35, allowGrowX: false, allowGrowY: false, alignX: "center", rich: true});
				...
				members:
				{
					...
					updatePOIStats: function(poiList, totalScore, rankData, baseValue)
					{
						...
						if (rankData.rank == 1)
						{
							var nextAlliance = "Недоступно";
							var nextScore = "Недоступно";
							var nextMulti = "Недоступно";
							var nextRankDiff = "Недоступно";
						}
						else
						{
						...
						if (this.currPOIType < 5)
							this.poiData["counts"]["total"].bonus.setValue(TGCTools.getInstance().numberWithCommas(totalBonus) + "/ч");
						else
						...
						if (this.currPOIType < 5)
						{
							this.poiData["counts"]["tier"]["prev"].bonus.setValue(TGCTools.getInstance().numberWithCommas(prevBonus) + "/ч");
							this.poiData["counts"]["tier"]["curr"].bonus.setValue(TGCTools.getInstance().numberWithCommas(currBonus) + "/ч");
							this.poiData["counts"]["tier"]["next"].bonus.setValue(TGCTools.getInstance().numberWithCommas(nextBonus) + "/ч");
						}
						else	
						{
					...
					calculatePOIData: function(poiList, totalScore, rankData, baseValue)
					{
						if (typeof poiList != 'undefined')
						{
							...
							for (var idx in poiList)
							{
								...
								var isNeededForTier = "Важно";
								if (tierBufferSum >= currTierLowerBound)
									isNeededForTier = "Не важно";
								tierBufferSum += poi.score;
								
								var isNeededForRank = "Важно";
								if (rankBufferSum >= currRankLowerBound)
									isNeededForRank = "Не важно";
					...
					showPOILocation: function(evt)
					{
						...
						coords = this.tableModel.getValueById("Координаты", row);
					...
					{		
						...
						if (this.currPOIType < 5)
						{
							this.poiData["counts"]["simulation"]["prev"].bonus.setValue(TGCTools.getInstance().numberWithCommas(prevBonus) + "/ч");
							this.poiData["counts"]["simulation"]["prev"].totalBonus.setValue(TGCTools.getInstance().numberWithCommas(prevTotalBonus) + "/ч");
							this.poiData["counts"]["simulation"]["curr"].bonus.setValue(TGCTools.getInstance().numberWithCommas(currBonus) + "/ч");
							this.poiData["counts"]["simulation"]["curr"].totalBonus.setValue(TGCTools.getInstance().numberWithCommas(currTotalBonus) + "/ч");
						}
						else
						{
			...
			qx.Class.define("TGCTools.UpgradeWindow", 
			{
				...
				construct: function()
				{
					...
					var baseLabel = new qx.ui.basic.Label("Уровень базы: ").set({allowGrowX: false, allowGrowY: false, font: "font_size_14_bold"});
					this.baseTextField = new qx.ui.form.TextField();
					this.baseTextField.setToolTipText("Введите желаемый уровень улучшения");
					var baseUpgradeBtn = new qx.ui.form.Button("","FactionUI/icons/icon_building_detail_upgrade.png");
					baseUpgradeBtn.setShow("icon");
					baseUpgradeBtn.setToolTipText("Улучшить постройки до желаемого уровня, если есть ресурсы.");
					...
					baseUpgradeOneBtn.setToolTipText("Улучшить все постройки на уровень, если есть ресурсы.");
					this.baseUpgradeMaximizeBtn = new qx.ui.form.Button("Максимум").set({allowGrowX: false, allowGrowY: false, height: 35});
					this.baseUpgradeMaximizeBtn.setToolTipText("Улучшить производственные постройки для увеличения прироста выбранного ресурса.");
					...
					this.baseUpgradeMaximizeSelect.add(new qx.ui.form.ListItem("Тиберий", "webfrontend/ui/common/icn_res_tiberium.png", "1"));
					this.baseUpgradeMaximizeSelect.add(new qx.ui.form.ListItem("Кристалы", "webfrontend/ui/common/icn_res_chrystal.png", "2"));
					this.baseUpgradeMaximizeSelect.add(new qx.ui.form.ListItem("Энергия", "webfrontend/ui/common/icn_res_power.png", "5"));
					this.baseUpgradeMaximizeSelect.add(new qx.ui.form.ListItem("Деньги", "webfrontend/ui/common/icn_res_dollar.png", "3"));
					this.baseUpgradeMaximizeSelect.setToolTipText("Выберите нужный ресурс для улучшения.");
