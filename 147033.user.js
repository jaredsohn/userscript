...
(function (){
  var tazoom_main = function() {
    function initialize() {
      ...
      var zoomMax = 0.08;	// Smaller number means able to zoom out further.
      var zoomInc = 0.03;	// Larger number for faster zooming, Smaller number for slower zooming.
