...
divArray[a].innerHTML=divArray[a].innerHTML.replace("</ul>", "<li><input value=\"multiquote\" type=\"button\" name=\""+post+"\" id=\""+buttonname+"\" onmousedown=\"window.buttonNum=document.getElementById('"+buttonname+"').getAttribute('name');\" style=\"background:#1b1d1f; color:#a3a3a4; border-color:#5c5d5f; border-width:1px; border-style:solid; margin-right:0px;\" onmouseover=\"thisButton=document.getElementById('"+buttonname+"'); thisButton.style.borderColor='#56AACD'; thisButton.style['background']='#17668a'; thisButton.style['color']='#FFFFFF'\" onmouseout=\"thisButton=document.getElementById('"+buttonname+"'); thisButton.style['background']='#1b1d1f'; thisButton.style.borderColor='#5c5d5f'; thisButton.style['color']='#a3a3a4'\" /></li></ul>")
