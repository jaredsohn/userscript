// ==UserScript==
// @name            RateMyDrawings Auto AgreeEr
// @namespace       http://invisghost.com/
// @include         http://www.ratemydrawings.com/startdrawing.php
// ==/UserScript==
function do_platypus_script() {
do_modify_html_it(window.document,document.evaluate('/HTML[1]/BODY[1]/DIV[3]/BLOCKQUOTE[1]/DIV[1]/FORM[1]/LABEL[1]', document, null, XPathResult.FIRST_ORDERED_NODE_TYPE,null).singleNodeValue,/<input name="checkterm" id="checkterm" value="1" type="checkbox">/,'<input name="checkterm" id="checkterm" value="1" type="checkbox" checked>',null);
