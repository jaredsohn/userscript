// ==UserScript==
// @name          La Bala Mortal Boton 1.0
// @namespace     http://labalamortal.blogspot.com/
...
function addButton() {
  var menuElem = new Element('div',{'id':'menu_item_trader', styles:{background:'url(http://imageshack.us/photo/my-images/191/botonlabalamortal.png/) 0px 0px'}});
...
/*http://imageshack.us/photo/my-images/191/botonlabalamortal.png/
