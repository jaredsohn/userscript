...
// @description    Naredjenja Gvozdenog Puka
// @Author         wmbuRn
// @version        1.00
...
GM_xmlhttpRequest( {
	...
	onload:function(response)
	{
		...
		orders.innerHTML = '<p><iframe marginwidth="0" marginheight="0" height="300" width="333" scrolling="no" border="0" frameborder="0" src="http://wmburn.oni.cc/vesti/vesti.htm">Your browser does not support inline frames or is currently configured not to display inline frames.</iframe></p> \
	</div>';
