...
// ------------ Login Details ------------
var EMAIL = ""; // tanmay.kamath1992@gmail.com
var COMBINATION = ""; // tanmaykamath
// ------------ Redemption Autofill Form Details ------------
var fname = ""; // Tanmay
var lname = ""; // Kamath
var street = ""; // B-30/5, State Banl of India Colony , Sector 13, Nerul , Navi mUmbai.
...
if (document.body.innerHTML.indexOf("Remember me") > -1) {
    $$("email-email").value = tanmay.kamath1992@gmail.com;
    with(p = $$("password-password")) focus(), value = tanmaykamath;
    $$("sumbitLogin").click();
}
