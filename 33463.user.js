// ==UserScript==
// @name           Quick Bio Change
// @namespace      Naquadah
// @description    Choose what bio message you want to display at the click of a button.
// @include        http://fallensword.com/*
// @include        http://www.fallensword.com/*

//------------------------------------------------------------------------------------------------------------------------------------------------
//Adds Bio One/Two buttons at the top left of the screen. 
...
//GM_log('start');
var allImages, bgImage, imageDiv, bioOne, bioTwo, xcValue, bioText
bioText = "&bio=";    
	...
	+ xcValue + bioText + offlineText + bioOne + '">'
	+ '<img src="http://i538.photobucket.com/albums/ff349/Naquadah2008/FallenSword/BioOne.png"></a>'	
	+ '<a href="http://fallensword.com/index.php?cmd=profile&subcmd=dochangebio&xc=' 
	+ xcValue + bioText + offlineText + bioTwo + '">'
	+ '<img src="http://i538.photobucket.com/albums/ff349/Naquadah2008/FallenSword/BioTwo.png"></a>';
