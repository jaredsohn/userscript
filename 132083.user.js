// ==UserScript==
// @author		Gislaine (source : ThomasRed/Angel Vladov)
// @name        TROLLS Script
// @namespace   eRepublikTROLLS
// @version		0.0.2
// @uso:version 0.0.2
// @include		http://*erepublik.com/*/military/battlefield/*
// @description    eRepublik Relatório de dano para milicia TROLLS
// ==/UserScript==
...
if(window.location.href.indexOf(PAGE_BATTLEFIELD) > 0) {	
	...
	/***********************************************************************************/
	var FORM_URL = "https://docs.google.com/spreadsheet/viewform?formkey=dHRtNEZsR1dLY1pZdU1QXzhpZlZwaEE6MQ#gid=0";
	var FORM_FIELDS = {
                eday: "entry.0.single",
                name: "entry.2.single",
