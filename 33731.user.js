// ==UserScript==
// @name           Travian: List of Attacks
// @version        0.2
// @description    Show all the attacks of your alliance. Visualizar toda la lista de ataques de tu alianza. 
// @author         Vaskkitto, updated by Christer82 with translations
// @date           2008-09-14
// @namespace      travian
...
function loadLanguage()
{
	...
	switch(ext) {
		case 'it': //Italian, translation by dbKiller
			...
			break;
	 	case 'en': //English, translation by christer82
			lang['EVENTSLOG'] = 'Eventslog';
			lang['DRAG'] = 'Drag';
			lang['MINIMIZE'] = 'Minimize';
			lang['MAXIMIZE'] = 'Maximize';
			lang['NEW_VERSION'] = 'E\' There is a new version of "Travian: Attacks List"';
			lang['UPDATE_NOW'] = 'Update now';
			break;
	 	case 'us': //English, translation by christer82
			lang['EVENTSLOG'] = 'Eventslog';
			lang['DRAG'] = 'Drag';
			lang['MINIMIZE'] = 'Minimize';
			lang['MAXIMIZE'] = 'Maximize';
			...
			lang['UPDATE_NOW'] = 'Update now';
			break;
		case 'fi': //Finnish, translation by Christer82
			lang['EVENTSLOG'] = 'Hyökkäyslista';
			lang['DRAG'] = 'Vedä';
			lang['MINIMIZE'] = 'Pienennä';
			lang['MAXIMIZE'] = 'Suurenna';
			lang['NEW_VERSION'] = 'E\' On uusi versio ohjelmasta "Travian: Attacks List"';
			lang['UPDATE_NOW'] = 'Päivitä nyt';
			break;
		case 'pt': // Portuguese, translation by BossDC
			lang['EVENTSLOG'] = 'Lista de Ataques';
			lang['DRAG'] = 'Arrastar';
			lang['MINIMIZE'] = 'Minimizar';
			lang['MAXIMIZE'] = 'Maximizar';
			lang['NEW_VERSION'] = 'Nova versão de "Travian: Attacks List" disponível';
			lang['UPDATE_NOW'] = 'Actualizar agora';
			break;
		case 'br': // Portuguese, translation by BossDC
			lang['EVENTSLOG'] = 'Lista de Ataques';
			lang['DRAG'] = 'Arrastar';
			lang['MINIMIZE'] = 'Minimizar';
			lang['MAXIMIZE'] = 'Maximizar';
