...
/*
	Edited to better align the custom emotes in a chat
	- Harrison Knox
*/
...
function createImageElement(token) {
	return '<img src="'+emoteMap[token]+'" style="height:28px;display:inline-block;margin:-5px 0px;vertical-align:bottom;"></img>';
}
