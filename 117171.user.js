// ==UserScript==
// @name              Chat Original
// @description       Utiliser l'ancien discussion instantanée
// @author            TheSP
			...
			try {
				...
				if (DOM.find($('pageNav'),'.tinyman')) {
					try {
						...
						//DOM.setContent(DOM.find($('pageNav'),'.tinyman');
					} catch (e) {}
				}
				*/ // QUITAR ESTA LINEA
