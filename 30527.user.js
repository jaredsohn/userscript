...
/* TODO:
* - fix newsfeed comment styling (what's with those backgrounds? FriendFeed got it right)
* - rename "boxes" to "apps"
* - add some more spacing, some breathing room pls, geeze dudes
*/