...
var bountyLimit   = parseInt(GM_getValue("bountyLimit",12576));
...
<input type=\"checkbox\" id=\"autoheal\" "+hchecked+" /> Heal when health is below <input type=\"text\" style=\"border: 1px solid white; width: 4em; color: #FA3434; background: black; text-align: center;\" id=\"healthlimit\" value=\""+healthLimit+"\" /> and check every <input type=\"text\" style=\"border: 1px solid white; width: 4em; color: #FA3434; background: black; text-align: center;\" id=\"healthtimer\" value=\""+healthTimer+"\" /> minutes<br>\
<input type=\"checkbox\" id=\"bounty\" "+bochecked+" /> bounty <input type=\"text\" style=\"border: 1px solid white; width: 4em; color: #FA3434; background: black; text-align: center;\"<br>\
<input type=\"checkbox\" id=\"hitlist\" "+schecked+" /> Autokill players below level <input type=\"text\" style=\"border: 1px solid white; width: 4em; color: #FA3434; background: black; text-align: center;\" id=\"hitlistlevel\" value=\""+hitlistLevel+"\" /> when stamina is at least <input type=\"text\" style=\"border: 1px solid white; width: 4em; color: #FA3434; background: black; text-align: center;\" id=\"hitlistammo\" value=\""+hitlistAmmo+"\" /><br>\
Auto list player <input type=\"text\" style=\"border: 1px solid white; width: 4em; color: #FA3434; background: black; text-align: center;\" id=\"autolistNum\" value=\""+autolistNum+"\" /> times\
...
//bounty
	if (document.getElementById('bounty').checked)
		GM_setValue("bountyLimit",true);
	else
		GM_setValue("bountyLimit",false);
...
if (page == "bounty")
{
	...
	form.getElementsByTagName('input')[0].value = 10000;
	if (autolistNum > 0)
	{
