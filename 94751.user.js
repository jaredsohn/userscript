// ==UserScript==
// @name            Daily Telegraph Au print
// @include         http://www.dailytelegraph.com.au/*/story-*
// ==/UserScript==

function do_platypus_script() {
fix_page_it(window.document,'/HTML[1]',null,null,null);
isolate(window.document,document.getElementById('story'),null,null,null);
relax(window.document,document.getElementById('story'),null,null,null);
relax(window.document,document.getElementById('story'),null,null,null);
