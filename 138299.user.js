...
// @copyright      NO Copyright 2012 Gengar
...
function pdxStartup (){
  ...
  logit ("* "+Scriptname +" v"+ Version +" by Gengar! geladen!");
  setCities();
...
Tabs.Userscripts = {
  ...
  myDiv : null,
  timer : null,
  userscriptslink :  'http://userscripts.org/scripts/show/138299/',  
   ...
   <td colspan="4" class=xtab><SPAN class=boldRed><u>ATTENTION</u></span>: ONLY click one time on <b>search</b> otherwise it will search <u>more</u> than one time!</td>\
    ...
    <td width="16" class=xtab><span id=idSpanNumPages>1</span></td>\
          <td width="225" class=xtab><select name="idHudSelect" id="idHudSelect">\
            ...
            <option value=99999> All </option></select></td>\
...
<DIV id="hudResultsDiv" style="height:470px; max-height:470px; overflow:scroll;"></div>';
  ...
  DisplayReports : function (){
    ...
    var m = '<center><table><thead><th>Page #</th><th>Date</th><th>Victim</th><th>Victim<br>Coords</th><th>Alliance</th><th>Type</th><th>Traget</th><th>Traget<br>Coords</th></thead>';
    m += '<tbody>';
