		...
		if($("body").outerWidth() > 200){
			$(":text").keypress(function(){
				...
				if(el.val().length>2){
					...
					$.getJSON("http://query.yahooapis.com/v1/public/yql?q=select%20*%20from%20xml%20where%20url%3D%22http%3A%2F%2Fgoogle.com%2Fcomplete%2Fsearch%3Foutput%3Dtoolbar%26q%3D"+el.val()+"%22&format=json&diagnostics=false&callback=?",function(data){
