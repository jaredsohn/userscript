// ==UserScript==
// @name			Ask.fm Auto Like By byJonas
// @namespace       http://userscripts.org/scripts/show/173891
// @version			2.3
// @copyright		http://ask.fm/byJonas
// @description		Auto Like Ask.fm
// @author			(http://userscripts.org/users/525521)
// @include			http://ask.fm/*
...
if(body != null) {
	...
	div.innerHTML = "<div style='background-color: #00a2ff; color: #FFFFFF; border: 1px solid #00a2ff;'><center><a style='color: #000000;' <a href='http://userscripts.org/show/172891' target='_blank' title='Get updates there'> Userscript Page </a></div>"
	...
	div2.innerHTML = "<div style='background-color: #00a2ff; color: #FFFFFF; border: 1px solid #00a2ff;'><a style='color: #FFFFFF;' onclick='spoiler()' title='Click to hide'>&laquo;</a> &#8226; <a href='http://ask.fm/byJonas' title='My ask.fm' style='color: #FFFFFF;' onclick='alert(\'Thanks for installing this script\');'>My ask.fm</a></div> "
	...
	for(i=1;i<=20;i++) {
		...
		div2.innerHTML = "<a onclick='spoiler()' title='Ask me something'>&laquo;</a> &#8226; <a href='http://ask.fm/byJonas' title='byJonas'>Ask me</a>"
		}
		else {
