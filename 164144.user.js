// ==UserScript==
// @name           Travian T4.2 Extra tools
// @namespace      Extra tools for travian
// @description    Extra Tools for travian version >= 4.2
// @author         hotzu
// @version        1.02.00
// @lastchanges    Travian 4.4 changes fixed
// @run-at         document-end
...
GM_registerMenuCommand("T4.2 ExtraTools Settings",showSet);
...
function warehouse()
{
    if(parseInt10(getCookie("Warehouse","1")))
    {
        ...
        var fa_text= "<span title=\"Full in\" class=\"wareHouseFullText\" style=\"color: #000;\">Full in:"+f_ora+":"+f_min+"</span>";
        ...
        var a_text= "<span title=\"Full in\" class=\"wareHouseFullText\" style=\"color: #000;\">Full in:"+a_ora+":"+a_min+"</span>";
        ...
        var v_text= "<span title=\"Full in\" class=\"wareHouseFullText\" style=\"color: #000;\">Full in:"+v_ora+":"+v_min+"</span>";
        ...
        if( termeles[3]>0 ){
            ...
            var b_text= "<span title=\"Full in\" class=\"wareHouseFullText\" style=\"color: #000;\">Full in:"+b_ora+":"+b_min+"</span>";
        }else{
