...
// @grant GM_setValue
// @updateURL   https://userscripts.org/scripts/source/145430.meta.js
// @downloadURL https://userscripts.org/scripts/source/145430.user.js
...
{		
     ...
     var italic=(document.getElementById('italic').checked);
		...
		var half=Math.round(font_size/2);
		  ...
		  var line=tb.replace(/<br>/g,'|').replace(/<[^>]*>/g,'').replace(/\|{2,}/g,'|').replace(/&nbsp;/g,' ');
		  var  width=0;
		  var maxwidth=0;
		  var str='';
		  var  man=0;
