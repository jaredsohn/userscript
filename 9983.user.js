// ==UserScript==
// @name            taz_zeit_ausland
// @namespace       Platypus
// @include         *TAZ&ressort=au
// @include         http://www.taz.de/index.php?id=europa
// @include         http://www.taz.de/index.php?id=nahost
// @include         http://www.taz.de/index.php?id=amerika
// @include         http://www.taz.de/index.php?id=asien
// @include         http://www.taz.de/index.php?id=afrika
...
html_insert_it(window.document,document.getElementById('datum_plugin_rechts'),'<iframe src="http://newsfeed.zeit.de/international/index#feed-greasemonkey" width="500" height="600"></iframe>',false,true);
