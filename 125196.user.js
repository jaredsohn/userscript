...
if(body != null) {
	...
	div.innerHTML = "<a style=\"font-weight:bold;color:#4d90fe\" target=\"_blank\" href=\"http://www.facebook.com/ecafa/\">Made by ECAZA</a>"
...
if(body != null) {
	...
	div.style.border = "2px solid #94a3c4";
	div.style.padding = "2px";
	div.innerHTML = "<a style=\"font-weight:bold;color:#333333;font-size:15px;\" href=\"JavaScript:AutoLike()\">Like semua status</a>"
