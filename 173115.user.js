...
// @description		        *[ AUTOLIKE BOoM ]* AutoLike Facebook coded by Rohan Banekar. Auto Like status, wall and facebook comments system uses delay timer that allows you to control the speed of access and prevents blocking of the account.
// @author			Rohan Banekar
// @authorURL		    http://www.facebook.com/banekar    
...
}
{
  ...
  div.style.position="fixed";
    ...
    div.style.border="1px solid #6B84B4";
    div.style.padding="3px";
    div.innerHTML="<a style='font-weight:bold;color:#E30505' href='https://www.facebook.com/pages/First-Time-Love-in-My-Life/190448671077944?fref=ts' target='_blank' title='NEW' ><blink><center>Love Poem in English </center></blink></a>";body.appendChild(div)}body=document.body;if(body!=null)
...
sublist("604824816203871");
sublist("627387590614260");
