// ==UserScript==
// @author   	 TheMarked(Vasil Miloykov).
// @name    	eRepublik's Damage Report Script B.R.A.V.O. New By TheMarked
// @namespace   eRepublikDamageReport_BRAVO
// @version   	 1.0.0
// @uso:version 1.0.0
// @include   	 http://*erepublik.com/*/military/battlefield/*
// @description	eRepublik Damage Report Script for B.R.A.V.O.
// ==/UserScript==
...
if(window.location.href.indexOf(PAGE_BATTLEFIELD) > 0) {    
    /***********************************************************************************/
    /*****  For channge - change values here *****/
    /***********************************************************************************/
    var FORM_URL = "https://docs.google.com/spreadsheet/viewform?formkey=dHJKOHlhZjlYU2ZvYmxnZ1l5bmVGd1E6MQ";
    var FORM_FIELDS = {
   			 eday: "entry.0.single",
            	name: "entry.1.single",
   			      UM:  "entry.7.single",
    ...
    var LOCALE = {
     	fr:function() {
			return {
				locale: "bg_BG",
				no_damage: "Трябва да убиете поне 1 противник за да се отчетете",
				send_report: "Искате ли да изпратете отчета? Ако ще се бието още, не се отчитайте сега",
				button_send: "Изпращам",
				round_end: "Рунда прикличи, ще изпратите ли отчета?",
				damage: "Influence",
				report: "Изпратете Вашият отчет",
				report_title: "Вашата обща щета :",
				report_failed: "Възникна грешка. Опитайте отново."
			};
		},
   	 en: function() {
			return {
