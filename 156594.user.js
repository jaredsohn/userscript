...
var NEW_DIV_CSS_TEXT = "position: absolute; top: 10px; right: 10px; display: none; z-index:1000; "
        + "width:620; font-size: 85%; background-color:lightgrey; padding:20px; overflow: auto; "
...
function processLink(_a) {
  ...
  return function(details) {
    if (details.responseText) {
      ...
      var START_TEXT = "<section id=\"userbody\">";
      var startIndex = details.responseText.indexOf(START_TEXT);
      var endIndex = details.responseText.indexOf("</section>", startIndex);
