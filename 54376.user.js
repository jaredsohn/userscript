...
function handleKeypress(e)
{
  ...
  if (e.target.nodeName.toLowerCase()!='input' && e.keyCode==79)
  {
    previewShortcut();
    e.preventDefault();
  }
...
addGlobalStyle('.entry-body{font-family:georgia;font-size:110%;line-height:150%;background-color: #f8f9f1;}');
addGlobalStyle('A.entry-title-link {font-family:georgia;font-size: 18px;background-color: #f8f9f1;}');

addGlobalStyle('#logo-container {background-color: #eeeeee;}');
addGlobalStyle('#logo {background-color: #eeeeee;}');
addGlobalStyle('#search {background-color: #eeeeee;}');
addGlobalStyle('#gbar, #guser, #global-info {background-color: #eeeeee;}');
addGlobalStyle('#entry {background-color: #eeeeee;}');
addGlobalStyle('body {background-color: #f8f9f1;}');
addGlobalStyle('.entry .entry-title {background-color: #f8f9f1;}');
addGlobalStyle('#box-item-container {background-color: #FFFDF3;}'); 
addGlobalStyle('.entry-container {background-color: #f8f9f1;}'); 
