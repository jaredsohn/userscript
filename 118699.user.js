// ==UserScript==
// @name           www version - Firefox/Safari Version
// @namespace      http://uroom.co.cc/
...
// ==/UserScript==
			...
			node.innerHTML = node.innerHTML
			//Reaction Faces
			.replace(/:yeah:/g, "<style>.md img { display:inline; } .rageface { visibility:visible; } </style><div id='lol' class='lol'><img  src=\'http://2.bp.blogspot.com/-Swwo2Em7fV8/ToKpcPcGQiI/AAAAAAAAAQY/YLzPgxjw-JY/s1600/20070217221102.gif\' title='fapfapfap' /></div>")
			.replace(/:blooding:/g, "<style> .md img { display:inline; } .rageface { visibility:visible; } </style><img src=\'http://2.bp.blogspot.com/-l46-noYtZ_c/ToKpcagh0lI/AAAAAAAAAQc/dKY2xeHi76E/s1600/20070217223338.gif\' title='thumbsup' />")
			.replace(/:aaaa:/g, "<style> .md img { display:inline; } .rageface { visibility:visible; } </style><img src=\'http://2.bp.blogspot.com/-HZTYRN4ZgNA/ToKpcvJUjQI/AAAAAAAAAQg/1QZKXgvLEuY/s1600/20070218174522.gif\' title='challengeaccepted' />")
			.replace(/:oh:/g, "<style> .md img { display:inline; } .rageface { visibility:visible; } </style><img src=\'http://2.bp.blogspot.com/-lmIDkq_NTVs/ToKpc8Yt5_I/AAAAAAAAAQk/EAwDst9QBy0/s1600/20070218174526.gif\' title='staredad' />")
			.replace(/:lovely:/g, "<style> .md img { display:inline; } .rageface { visibility:visible; } </style><img src=\'http://3.bp.blogspot.com/-oUM5uuvQpcY/ToKpdLSBUuI/AAAAAAAAAQo/UxGvFQFvLug/s1600/20070218174542.gif\' title='iamdisappoint' />")
			.replace(/:kiss:/g, "<style> .md img { display:inline; } .rageface { visibility:visible; } </style><img src=\'http://2.bp.blogspot.com/-EMEJGHxi1aE/ToKpdgsmPRI/AAAAAAAAAQs/Se90gAx1xvk/s1600/20070218185356.gif\' title='meh' />")
			.replace(/:heyhey:/g, "<style> .md img { display:inline; } .rageface { visibility:visible; } </style><img src=\'http://www.uroom.co.cc/gif.image/heyhey.gif\' alt='cyoot' />")
			.replace(/:hoho:/g, "<style> .md img { display:inline; } .rageface { visibility:visible; } </style><img src=\'http://3.bp.blogspot.com/-6NGCLKaGdrA/ToKpdsdVydI/AAAAAAAAAQw/ukNkBJvF5t0/s1600/20100624012010096.gif\' alt='=hmmm' />")
			.replace(/:dancing:/g, "<style> .md img { display:inline; } .rageface { visibility:visible; } </style><img src=\'http://3.bp.blogspot.com/-TgpNmUr5T2g/ToKpegLhh3I/AAAAAAAAAQ0/PDqSayF6YQ4/s1600/TCPAMA%25408UC%257B%2528%2524D2%255BW_YEAIE.gif\' title='grin' />")
			.replace(/:wowo:/g, "<style> .md img { display:inline; } .rageface { visibility:visible; } </style><img src=\'http://3.bp.blogspot.com/-EkEEJcyM9s8/ToKyc1GMwQI/AAAAAAAAAQ4/LqRFvO9WSC8/s1600/th_7dcda2aa1.gif\' title='There isn't a command here, problem?' />")
			.replace(/:hey:/g, "<style> .md img { display:inline; } .rageface { visibility:visible; } </style><img src=\'http://4.bp.blogspot.com/-S6tDX0k13E0/ToKydyNOuxI/AAAAAAAAAQ8/XxjKI6p0Dys/s1600/th_1382-05-19-2011.gif\' title='There isn't a command here, problem?' />")
			.replace(/:fdship:/g, "<style> .md img { display:inline; } .rageface { visibility:visible; } </style><img src=\'http://2.bp.blogspot.com/-QAwy9zZWMxc/ToKyesR6JJI/AAAAAAAAARA/j7wFe2wVSEs/s1600/th_1231478921150.gif\' title='stare' />")
			.replace(/:ohno:/g, "<style> .md img { display:inline; } .rageface { visibility:visible; } </style><img src=\'http://4.bp.blogspot.com/-TB7rxEiddMw/ToKyfglczEI/AAAAAAAAARE/hYTs54wZ4Fk/s1600/th_football5.gif\' title='thefuck' />")
			.replace(/:nice:/g, "<style> .md img { display:inline; } .rageface { visibility:visible; } </style><img src=\'http://4.bp.blogspot.com/-nXaxTx6qxiQ/ToKygFGJBKI/AAAAAAAAARI/71Z6a9EztP4/s1600/th_funny.gif\' title='ffff' />")
			.replace(/:yes:/g, "<style> .md img { display:inline; } .rageface { visibility:visible; } </style><img src=\'http://3.bp.blogspot.com/-Ag4jUJGR9-E/ToKygighSBI/AAAAAAAAARM/Py2MdYx3xEA/s1600/th_gif-1.gif\' title='ffff' />")
			.replace(/:right:/g, "<style> .md img { display:inline; } .rageface { visibility:visible; } </style><img src=\'http://1.bp.blogspot.com/-gjWFLwc86q4/ToKyiHkXRII/AAAAAAAAARQ/WcTmE6I0jHk/s1600/th_kTsXY.gif\' title='no' />")
			.replace(/:eating:/g, "<style> .md img { display:inline; } .rageface { visibility:visible; } </style><img src=\'http://4.bp.blogspot.com/-XFu4W1ntzkU/ToKyiasiRpI/AAAAAAAAARU/r24PaZmr5tQ/s1600/th_lol.gif\' title='yuno' />")
			.replace(/:pimp:/g, "<style> .md img { display:inline; } .rageface { visibility:visible; } </style><img src=\'http://2.bp.blogspot.com/-kWHCKQ8QwYU/ToKyir-NMXI/AAAAAAAAARY/NGqtB3bSb3Y/s1600/th_pimpfinishedgif-1.gif\' alt='letsdothis' />")
			.replace(/:tkiss:/g, "<style> .md img { display:inline; } .rageface { visibility:visible; } </style><img src=\'http://4.bp.blogspot.com/-arwHEVZjWeQ/ToKyjvl3b-I/AAAAAAAAARc/8fLYgRyc5KM/s1600/th_sandlotkiss.gif\' title='areyoufuckingkiddingme' />")
			.replace(/:return:/g, "<style> .md img { display:inline; } .rageface { visibility:visible; } </style><img src=\'http://3.bp.blogspot.com/-pGCwJjL3EkE/ToKykoLfi2I/AAAAAAAAARg/qclYoPFgjus/s1600/th_skills8.gif\' alt='f7u12' />")
			.replace(/:aa:/g, "<style> .md img { display:inline; } .rageface { visibility:visible; } </style><img src=\'http://4.bp.blogspot.com/-GvGBxTlEE2c/ToKylGEl7xI/AAAAAAAAARk/2d3dm1Tm1qk/s1600/th_trippy10.gif\' title='ilied' />")
			.replace(/:123:/g, "<style> .md img { display:inline; } .rageface { visibility:visible; } </style><img src=\'http://1.bp.blogspot.com/-YvYKZhXkpc4/ToKyl1jMgOI/AAAAAAAAARo/tGIZZo8hK9M/s1600/th_tumblr_le5hwuH6Cb1qblrdf.gif\' title='trolldad' />")
			.replace(/:ohyeah:/g, "<style> .md img { display:inline; } .rageface { visibility:visible; } </style><img src=\'http://3.bp.blogspot.com/-nvnWORNAVlE/ToKymYTdC2I/AAAAAAAAARs/fLKqcfMZbgo/s1600/th_tumblr_llr12lb6G01qi55qj.gif\' title='trololo' />")
			.replace(/:combaby:/g, "<style> .md img { display:inline; } .rageface { visibility:visible; } </style><img src=\'http://2.bp.blogspot.com/-q-2z2ra5RtA/ToKym96b5tI/AAAAAAAAARw/vzGiC7U9Ma8/s1600/th_yum.gif\' title='wtfisthat' />")
			.replace(/:seringue:/g, "<style> .md img { display:inline; } .rageface { visibility:visible; } </style><img src=\'http://paltalk.byethost7.com/upload/seringue.gif\' title='augh' />")
