...
// @author         ScratchZ (Update from Black_Blood)
...
//Map
//new farmImage by black_blood
var farmImage = "http://uppix.net/6/5/c/5a1db6d3cd43b79b7e29821012f95.gif";
...
function setLanguage() { //define language elements
	...
	lang = {
		...
		'marking' : "Mark farms in map"

	};

	//for other language

	if (ext == "ae") { //Language:arabic, Translator : kmmad1
		...
		lang = {
			...
			'SETREADREP' : " تحليل التقارير لتحديد اولوية النهب ",
