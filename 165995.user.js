...
(function(){
    function main() {
        ...
        if (data != null){
        	...
        	$(".download-file").append("<br /><center><img src='http://nightportal.net/uploads/posts/2013-04/1367095640_header_logo_bg.png'><br />Copyright © 2013 NightPortal.NET - NightPortaL.NET HD Film, Oyun, Müzik ve Program Paylaşım Portalı")
