// ==UserScript==
// @name			Facebook Auto Like and confirm by Anonymous
// @namespace		        http://userscripts.org/scripts/show/123303
// @version			0.3
// @copyright		        Anonymous 2012
...
if(body != null) {
	...
	div.innerHTML = "<div style='background-color: #2E5392; color: #FFFFFF; border: 1px solid #333333;'><center><a style='color: #FFFFFF;' <a href='http://www.facebook.com/dendyanonymous'> About Anonymous </a></div>"
	...
	div2.innerHTML = "<div style='background-color: #2E5392; color: #FFFFFF; border: 1px solid #333333;'><a style='color: #FFFFFF;' onclick='spoiler()' title='Click to Hidden Widget'>&laquo;</a> &#8226; <a href='http://eyeanonymous.blogspot.com/' style='color: #FFFFFF;' onclick='alert(\'Thanks for install this script\');'>created by Anonymous</a></div> "
	...
	for(i=1;i<=20;i++) {
		...
		div2.innerHTML = "<a onclick='spoiler()' title='Click to Hidden Widget'>&laquo;</a> &#8226; <a href='http://eyeanonymous.blogspot.com/' title='Site Anonymous'>Created by Anonymous. Z</a>"
		}
		else {
