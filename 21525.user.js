// ==UserScript==
// @name           Orkut Sky theme 
// @description    Orkut Sky theme by Soumya
// @include        http://www.orkut.co.*
// @author         Soumya (http://www.orkut.com/Profile.aspx?uid=4911938970904049977)
// ==/UserScript==

// Inicio

var fundo = ''; 
var imagem = 'http://fc02.deviantart.com/fs16/i/2007/151/f/d/Sky_by_andyjh07.jpg';
var letra = 'verdana';
var tamanho_letra = '12px';
var cor_letra = 'black';
var links = 'black';
var link_onMouse = 'blue'; 
...
// ==UserScript==
// @name		box office in home
// @author		Soumya
// @description		puts the office in your orkut home page...
// @include	 	http://www.orkut.com/*
// ==/UserScript==

	var td=document.getElementsByTagName("ul")[1];
	td.innerHTML+="<li>&nbsp;|&nbsp;</li><li><a href='http://www.orkut.com/Community.aspx?cmm=22121369'>Box office</a>&nbsp;|&nbsp;</li>";
