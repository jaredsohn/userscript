// ==UserScript==
    // @name           Sistema de mensajes del Bs
    // @namespace      www.erepublik.com
    // @description    Mensajes para los afiliados(eRepublik)
    // @version        0.01
    // @include        http://www.erepublik.com/en
    // @include        http://www.erepublik.com/es
    // @include        http://www.erepublik.com/en*
    // @include        http://www.erepublik.com/es*
    // @sources		   Blahblahblah.
    // ==/UserScript==

GM_xmlhttpRequest({
   method: 'GET',
   //edit devision ID in here.
   url: 'http://docs.google.com/Doc?tab=edit&dr=true&id=ddgwsdm7_37f93nsjs5',
   ...
   onload:function(response){
	  ...
	  var $box_str =    '   <div class="title">'+
			...
			'   </ul>'+
			'   <h3 style="clear: both;">'+
			'      <a href="http://bloquesocialista.forosactivos.com/forum.htm">'+
