...
//
// ==UserScript==
// @name           Tribal Wars Premium Barra do 1.15
// @namespace      www.tribalwars.com.br
// @description    Premium bar for Tribalwars (Edificio Principal, Quartel , Estábulo , Oficina , Academia , Ferreiro , Praça de Reunião , Mercado)  
...
if(String(document.location).indexOf("http://www.tribalwars.com.br/forum.php") > -1){
...
window.createQuickbarShortcuts = function() {
	"<tr>   " + 
	newShortcut("/graphic/buildings/main.png", "/game.php?village="+VillId+"&screen=main", "Edifico Principal");
	newShortcut("/graphic/buildings/barracks.png", "/game.php?village="+VillId+"&screen=barracks", "Quartel");
	newShortcut("/graphic/buildings/stable.png", "/game.php?village="+VillId+"&screen=stable", "Estábulo");
	newShortcut("/graphic/buildings/garage.png", "/game.php?village="+VillId+"&screen=garage", "Oficina");
    newShortcut("/graphic/buildings/snob.png", "/game.php?village="+VillId+"&screen=snob", "Academia");
	newShortcut("/graphic/buildings/smith.png", "/game.php?village="+VillId+"&screen=smith", "Ferreiro");
	+ "<tr>   " + 
	newShortcut("/graphic/buildings/place.png", "/game.php?village="+VillId+"&screen=place", "Praça");
newShortcut("/graphic/buildings/place.png", "/game.php?village="+VillId+"&screen=place&mode=sim", "Simulador");
    newShortcut("/graphic/buildings/market.png", "/game.php?village="+VillId+"&screen=market", "Mercado");
newShortcut("/graphic/delete.png", "/game.php?village="+VillId+"&screen=ally&mode=reservations", "Reserva");
tableIdIndex++;
	trIdIndex++;
}