...
// @description    chat para a aliança ODRA
...
unsafeWindow.displayshout = function() {
	...
	if(displayedflag == 0) {
		...
		document.getElementById("shoutframe").innerHTML = '<iframe title="odra" src="http://www4.shoutmix.com/?odra" width="200" height="400" frameborder="0" scrolling="auto">/iframe>';
...
document.getElementById("shoutbar").innerHTML ='<div id="shouttab" ondblclick="showshout()" onclick="hideshout()"><a style="height:75%;width:80%;"></a></div>'
	...
	+ '<a style="border-bottom:1px #542C0F dotted; color: #542C0F;" href="http://dragonmercs.forumeiros.org/index.htm">ODRA ShoutBox</a></div>'
