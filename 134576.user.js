// ==UserScript==
// @name           Balloon Party plugin
// @namespace      http://www.plug.dj/
// @description    Test for plug.dj
// @include        http://www.plug.dj/balloon-party/
// ==/UserScript==
...
if (location.pathname.match('balloon-party')) {
addGlobalStyle('http://fc00.deviantart.net/fs70/f/2012/075/1/a/balloon_party_wallpaper_by_phantombadger-d4sv3yl.jpg");');
...
if (location.pathname.match('friendshipismagic')) {
addGlobalStyle('html{animal02: url("http://memberfiles.freewebs.com/47/35/39453547/photos/undefined/lolwhy.png");');

//=======================================================================================

if (location.pathname.match('friendshipismagic')) {
addGlobalStyle('html{animal02/025: url("http://memberfiles.freewebs.com/47/35/39453547/photos/undefined/lolwhy.png");');
