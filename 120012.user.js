...
// @description	Version 4.3 Enables video streaming from 2shared, and megaupload/megaporn via www.icedivx.com. This script works closely with the high quality video links database www.icefilms.info
...
// ==/UserScript==
	...
	function iceEmbed(){
		var iframe = document.createElement("iframe");
		iframe.src = 'http://www.icedivx.com/video.php?w='+w+'&h='+(h-18)+'&vurl='+downloadlink+'&flash='+flashlink+'&t='+timers+'&v='+version;
		iframe.style.width = w+'px';
		iframe.style.height= h+'px';
		iframe.style.border= "0";
		iframe.style.margin= "0";
...
// mega
	...
	else if (!document.getElementById('iceQuickStream'))
	{
		...
		//	timer = document.getElementById('countertime').innerHTML;
		//}
