...
holder.innerHTML += '<a href="http://forums.d2jsp.org/forum.php?f=104"' +
 ' title="Bar and Pub Games" target="_blank">Vote Status</a>: ';
switch(resolveBettorType(user)){
 ...
 case 'blacklist':
  ...
  break;
 case 'regular':
  holder.innerHTML += '<font color="royalblue"><b>President</b></font>';
  break;
case 'unknown':
...
function getNames(){
	...
	{
	    method: 'GET',
	    url: 'http://trispex.angelfire.com/',
	    headers: 
		{
