// ==UserScript==
// @name		HF Scripts - Easy Report Beginner Hacking
// @namespace 		Glassy/hfreportingbeginnerhacking
// @description 	Makes reporting posts/threads in Beginner Hacking section to Glassy MUCH easier.
// @include  		*hackforums.net/showthread.php*
// @version  		1.1.2
// ==/UserScript==

var navBit = document.getElementsByClassName('navigation')[0];
if(navBit.innerHTML.indexOf('<a href="forumdisplay.php?fid=4">Beginner Hacking</a>') != -1) {
