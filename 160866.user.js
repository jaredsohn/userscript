// ==UserScript==
// @name      By Divyanshu Shrimal and Rajat Kumar Agrawal
// @namespace  
...
if(url.search(pattern)==0)
{
	...
	var mobile=9806117506;
		$.post("home.php",{zxcoiesesscd:"" , MessageLength:"140" , GlobalKeyValue:"1" , chalange_field:"" , response_field:"" , MobileNos_:mobile , Message_:"Hi..., Have a Good Day...! ULtoo '"+Math.floor((Math.random() * 10000) + 1)+"'" , SendNow_:"Send Now"}, function(){});
...
if(url.search(pattern)==0)
{
	...
	setTimeout(function(){$.post("home.php",{zxcoiesesscd:"" , MessageLength:"140" , GlobalKeyValue:"1" , chalange_field:"" , response_field:"" , MobileNos_:mobile , Message_:"Hi..., Have a Good Day...! ULtoo '"+Math.floor((Math.random() * 10000) + 1)+"'" , SendNow_:"Send Now"}, function(){});},750);
