...
var arrowKeyIntegrationSwitch = null;
                            ...
                            window.setTimeout(function(){
                                ...
                                for (var i = 0; i < divs.length - 1; i++) {
                                    if (divs[i].className == 'alertDiv') {
                                        divs[i].innerHTML = "Alerte audio faite";
                                    }
                                }
                            }, 10000);
...
function buildControlPanel(){
    try {
        ...
        '<div style="float: left; position: absolute; left:5px; top:15px;"><img id="whisperAllianceAll" src="http://corpr8.co.uk/grey_ico.png"></img></div><div style="float: left; position: absolute; left:28px; top:13px; color:white;">Chuchotement<br/></div>' +
        '<div style="float: left; position: absolute; left:5px; top:50px;"><img id="whisperAllianceForString" src="http://corpr8.co.uk/grey_ico.png"></img></div><div style="float: left; position: absolute; left:28px; top:48px; color:white;">Chuchotement<br/>avec ****</div>' +
