	...
	if(login) {
		...
		if(urls.length) {
			document.getElementById("adsclick").addEventListener('click', function(){
				autosurf = function() {
					msg.innerHTML = "Done! ........ Go to: <a href='http://www.sitedown.tk/forum' class='button' target='_blank'>Support</a>";
