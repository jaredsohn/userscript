...
// @name           Waheed
// @namespace      yamliat
// @description    ymli arabtechies
// @include        file:///Users/waheed/projects/arabtechies/codesprint2009/yamli/test/spike-simple.html
// ==/UserScript==
YAMLIAT = {
current_id: 0,
nextId: function() {
...
YAMLIAT.loadJsFile("http://api.yamli.com/js/yamli_api.js", function() {
	if (typeof(Yamli) == "object" && Yamli.init( { uiLanguage: "fr" , startMode: "onOrUserDefault", assumeDomReady: true } ))
	{
