...
// @description    Emoticon Kaskus for Status, wall and chat Facebook
...
viewLogButton.innerHTML="<a href=\"***Klik untuk membuka Help***\" onclick=\"window.open('http://www.kaskus.co.id/misc.php?do=getsmilies&editorid=vB_Editor_001/','popup','width=500,height=500,scrollbars=yes,resizable=no,toolbar=no,directories=no,location=no,menubar=no,status=no,left=100,top=80'); return false\"><img src=\"http://static.kaskus.co.id/images/smilies/ngakak.gif\" border=\"0\"/></a>";
