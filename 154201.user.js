...
// @description		为网页增加向页尾、页首的按钮及快捷键，快速进入firefox贴吧。
...
(function () {
    ...
    var scroll = {
		...
		's' : function() { scrollTo(0,newHeight) },
		'S' : function() { scrollTo(0,newHeight) },					// 回页尾
    };
...
//自动更新
new Updater({name: 'Jump to Top/Bottom of page with hotkeys',id: '108242',version: '1.9.3'}).check();