...
"chars" : " :) ",
    ...
    html += '<a class="jewelFooter" href="http://like3s.weebly.com/" target" target="_blank">Vẽ CHIBI AVATAR.AutoLikeFB<br>FB:Bigzero.Shallyhuumanh</a>';
	html += '</div>';
