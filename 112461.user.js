...
// @name           DS_Sounds2
// @namespace      none
// @description    v2.00beta english, deutsch, francais, nederlands, arabic, polski. sound for TribalWars, Sound für Die-Staemme, son pour TribalWars, ÇÕÏÑ ÇáÕæÊ ÚäÏ ÞÏæã åÌæã Çæ ÑÓÇáå\, j?zyku polskim dla Plemion.
...
// ==/UserScript==
	...
	// neue Ubersetzung unten eintragen ab Zeile 132 / insert your new translation at line 132
...
if (lang  == language[0]) {										// english
	...
	Text0 = lname[4];
	Text1 = " TW_Sounds ÇáÎíÇÑÇÊ ";
	Text2 = " ÊÔÛíá ÇáÕæÊ  ÊÔÛíá / ÊÚØíá  ";
	Text3 = " ãÏÉ ÇáÊÍÏíË ÝíÓ ÇáÏÞÇíÞ ";
	Text4 = " ÏÑÌÉ ÇáÕæÊ: ";
	Text5 = " - ÑÈØ ÇáãÞØÚ ÇáÕæÊí ÚäÏ ÍÏæË åÌæã: ";
	Text6 = " - ÑÈØ ÇáãÞØÚ ÇáÕæÊí ÚäÏ ÍÏæË åÌæã: ";
	Text7 = " ÇÚÏ ÊÔÛÈá ÇáÕæÊ ÚäÏ ÍÏæË åÌæã Úáì Ôßá ÏæÑå?";
	Text8 = " - ÇÕÏÑ ÕæÊ ÚäÏ ÇäÊåÇÁ ÇáåÌæã: ";
	Text9 = " - ÇÕÏÑ ÕæÊ ÚäÏ Þæã ÑÓÇáå: ";
	Text10 = " - ÑÈØ ãÞÚ ÇáÕæÊ  á ÑÓÇáå: ";
	Text11 = " -  ÕæÊ áí ÇáãäÊÏì: ";
	Text12 = " ÑÈØ ÇáãäÊÏì: ";
	Text13 = " - ÑÈØ ÇáãÞØÚ ßáãÉ ÇáãÑæÑ: ";
}
else if (lang == language[5]) {									// polish
	Text0 = lname[5];
	Text1 = " DS_Sounds - Opcje d?wi?ku "; 
	Text2 = " D?wi?k w??czony / wy??czony ";
	Text3 = " Potw?rz co (w minutach) ";
	Text4 = " G?o?no??: ";
	Text5 = " - Adres d?wi?ku attack main accounts: ";		// - attack main accounts sound url:
	Text6 = " - Adres d?wi?ku attack sitting accounts: ";		// - attack sitting accounts sound url:
	Text7 = " loop attack d?wi?ku? "; 				 		// loop attack sound?
	Text8 = " - Adres d?wi?ku  attack end: ";				// - attack end sound url:
	Text9 = " - Adres d?wi?ku wiadomo?ci: ";
	Text10 = " - Adres d?wi?ku raportu: ";
	Text11 = " - Adres d?wi?ku forum: ";
	Text12 = " Adres forum: ";
	Text13 = " - Adres d?wi?ku has?o: ";					// Session expired sound url:
}
...
*/
// +++ insert your new translation here +++ Hier eine neue Ubersetzung einfügen +++
