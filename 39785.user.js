...
// ==UserScript==
// @MOD author      ToRvaLDs
// @email	torvaldz@gmail.com
// @namespace	http://userscripts.org/
// @name		Travian Trooptool Updater ITA
...
switch(sLang) {
	case "sk":
		aLangStrings = ["VlastnÃ© jednotky", "NÃ¡vrat z", "Podpora pre", "Jednotky od", "Ãštok na", "LÃºpeÅ¾ proti", "Å pehovanie v", "PreskÃºmaÅ¥ opustenÃ© Ãºdolie", "ZajatÃ© jednotky od", "Prebehol pokus o aktualizÃ¡ciu.", "AktualizÃ¡cia ÃºspeÅ¡nÃ¡", "AktualizÃ¡cia zlyhala!", "NastaviÅ¥ Troop Tool Updater", "AktualizovaÅ¥ Troop Tool", "Troop tool Updater:", "SkopÃ­ruj sem autentifikaÄnÃ½ kÄ¾ÃºÄ zo svojho profilu v Troop Tool-e"];
		break;
	case "pt":
		aLangStrings = ["Próprias tropas", "A regressar de", "Reforço para", "Tropas de", "Ataque contra", "Assalto contra", "Espiar", "PreskÃºmaÅ¥ opustenÃ© Ãºdolie", "Captured at", "Tentativa de Update com resultado seconhecido.", "Tropas desta aldeia actualizadas.", "Update falhado!", "Troop Tool Updater setup", "Update Troop Tool", "Troop tool Updater:", "Enter the authentication key from your Troop tool profile"];
		break;
	case "it":
...
function detectLanguage() {
    ...
    if(!lang) {
        ...
        sLang = lang[1];
            _log(3, "detected language '" + sLang + "'");
        return true;
    }
}
