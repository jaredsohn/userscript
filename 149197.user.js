...
var UMs_full = ['Fuerza Elite eVenezolana', 'P.M.C. El Condor Guardian', 'Comando Especial de Mercenarios'];
var UMs_abrev = ['FEV', 'CONDOR', 'CEM'];

if(window.location.href.indexOf(PAGE_BATTLEFIELD) > 0) {    
    /***********************************************************************************/
    /***** Coonstants. If someone wants to reuse this script - change values here *****/
    /***********************************************************************************/
    var FORM_URL = "https://docs.google.com/spreadsheet/viewform?formkey=dGsyMk84UmZiaDlwNkdrSC00cEVmNGc6MA#gid=0";
    var FORM_FIELDS = {
   			    eday: "entry.0.single",
            	name: "entry.2.single",
   			    UM:  "entry.5.single",
            	...
            	DO: "entry.17.single",
            	dq6hit: "entry.20.single",
            	battle: "entry.8.single",
            	wall: "entry.10.single",
            	donate: "entry.1.single"
