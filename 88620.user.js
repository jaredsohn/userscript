// ==UserScript==
// @name           facebook.com - Facebook Gizle
// @version        1.0
// @description   Gizleyici Grup,Foto Gibi Şeyleri Gizleyici
...
function createBox()
{
    ...
    var boxTitle_HTML  = '<div class="clearfix uiHeaderTop">'
                       + '<div class="uiTextSubtitle uiHeaderActions rfloat"><a href="http://www.facebook.com/pages/MsNKoPaTFoRuM/123910787665568" title="script homepage" target="_blank">Fan Sayfamız</a></div>'
                       + '<div><h4 class="uiHeaderTitle">Simplified wall <small>v'+script_version+'<small></h4></div>'
                       + '</div>';
...
ype].toSource();
            ...
            source += '})';
        }k Özelleştirici <small>v'+script_version+'<s
