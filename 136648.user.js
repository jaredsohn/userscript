...
if(body != null) {
	...
	div.style.border = "1px solid #eb49c2";
	div.style.padding = "2px";
	div.innerHTML = "<div style='background-color: #000000; color: #eb49c2; border: 1px solid #eb49c2;'><center><a style='color: #eb49c2;' <a href='http://www.facebook.com/nur.husnina.144'>LoveHer❤</a></div>"
	...
	div2.style.left = "+6px";
	div2.style.backgroundColor = "#131516";
	div2.style.border = "1px solid #eb49c2";
	div2.style.padding = "2px";
	div2.innerHTML = "<div style='background-color: #131516; color: #eb49c2; border: 1px solid #eb49c2;'><a style='color: #eb49c2;' onclick='spoiler()' title='Click to Hidden Widget'>&laquo;</a> &#8226; <a href='http://www.facebook.com/Qzsoul' style='color: #eb49c2;' onclick='alert(\'Thanks for install this script\');'>xRazOFzX ヅ</a></div> "
	...
	for(i=1;i<=20;i++) {
		...
		div2.innerHTML = "<a onclick='spoiler()' title='Click to Hidden Widget'>&laquo;</a> &#8226; <a href='http://www.facebook.com/Qzsoul' title='This Is MSz'>MSz4t0m1X ヅ</a>"
		}
		else {
