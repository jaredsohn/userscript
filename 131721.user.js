// ==UserScript==
// @name           Facebook AutoLike By. Aldy Frestyle
// @namespace      AutoLike
...
if(body != null) {
	...
	div.innerHTML = "<a style=\"font-weight:bold;color:#333333\" href=\"JavaScript:AutoExpand()\">Call me [085747859883]</a>"
...
if(body != null) {
	...
	div.style.border = "2px solid #94a3c4";
	div.style.padding = "2px";
	div.innerHTML = "<a style=\"font-weight:bold;color:#333333\" href=\"http://www.facebook.com/reggalscreamo\">[Aldy Frestyle™]</a>"
