// ==UserScript==
// @name        4chan Reverse Image Search
// @description Simply adds reverse search links to each post with an image.
// @namespace   Crazycatz00
// @match       *://*.4chan.org/*
// @version     1.0.1
// @grant       none
// @icon        http://content.4chan.org/favicon.ico
// ==/UserScript==
(function(){'use strict';
