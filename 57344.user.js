// ==UserScript==
// @name           MABW Bettor Status for D2JSP
// @namespace      d2jsp
...
2.2 - changed some formatting things
**************************************/
...
function getNames(){
	GM_xmlhttpRequest(
	{
	    ...
	    onload: function(response)
		{
			...
			if(version != '2.1'){
				if(confirm('Your MABW Bettor Status script is not up-to-date.\n\nWould you like to update it?')){
					window.open('http://userscripts.org/scripts/show/57344');
				}
			}
