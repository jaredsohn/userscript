...
// @include        http://*.kingdomsofcamelot.com/*main_src.php*
// @require        http://sizzlemctwizzle.com/updater.php?id=89335&days=2
...
//logit ( 'Options.ptWinPos: '+ inspect (Options.ptWinPos, 5, 1)); 
  ...
  AddMainTabLink('PoC 3 PT', eventHideShow, mouseMainTab);
	...
	for (var i = 0; i < divs.length - 1; i++) {
		...
		bS = document.getElementsByTagName('b')
			for (var j = 0; j < bS.length - 1; j++) 
				if (bS[j].innerHTML == ' yacks at you:')
					AudioAlert.sound(true);
		}
	}
  },
