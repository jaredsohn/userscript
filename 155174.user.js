// ==UserScript==
// @name      Dollchan Extension Tools for Tinyboard
// @version     13.8.7.0-Tinyboard
// @namespace   http://www.freedollchan.org/scripts/*
// @author      Sthephan Shinkufag @ FreeDollChan
//          Tinyboard edit by Joseph
// @copyright   (C)2084, Bender Bending Rodriguez
// @description   Doing some profit for imageboards (Now including better Tinyboard support!)
// @icon  http://static.4chon.net/favicon.gif
// @run-at      document-start
// @include     *4chon.net/*
// @include     *wizardchan.org/*
// @include     *stormchan.org/*
// @include     *uboachan.net/*
// @include     *ota-ch.tk/*
// @include     *5chon.net/*
// @include     *altchan.net/*
// @include     *walpurgischan.net/*
// @exclude         */mod.php?/*
// @updateURL   http://userscripts.org/scripts/source/155174.user.js
// ==/UserScript==

var code = function() {
    var _styles = {'Futaba': "//static.4chon.net/stylesheets/futaba.css", 'Orange': "//static.4chon.net/stylesheets/testorange.css", 'Yotsuba': "//static.4chon.net/stylesheets/yotsuba.css", 'Yotsuba B': "", 'dark': "//static.4chon.net/stylesheets/dark.css", 'futabalight': "//static.4chon.net/stylesheets/futaba-light.css", 'gentoochan': "//static.4chon.net/stylesheets/gentoochan.css", 'jungle': "//static.4chon.net/stylesheets/jungle.css", 'luna': "//static.4chon.net/stylesheets/luna.css", 'miku': "//static.4chon.net/stylesheets/miku.css", 'photon': "//static.4chon.net/stylesheets/photon.css", 'szalet': "//static.4chon.net/stylesheets/szalet.css", 'terminal': "//static.4chon.net/stylesheets/terminal2.css", 'wasabi': "//static.4chon.net/stylesheets/wasabi.css", 'Ferus':"//static.4chon.net/stylesheets/ferus.css", 'RiceChan':"//static.4chon.net/stylesheets/ricechan.css", 'Hitler': 'https://dl.dropbox.com/u/22473819/hitler.css', 'Rommel': 'https://dl.dropbox.com/u/22473819/rommel.css', 'Avril': 'https://dl.dropboxusercontent.com/u/22473819/avril.css', 'Tinychan': 'https://dl.dropboxusercontent.com/u/22473819/l33t.css'};
    Object.defineProperty(window, 'styles', {
        configurable: true,
        get: function() { return _styles; }
    });
};
...
defaultCfg = {
	...
	'hideRefPsts':	1,		// hide post with references to hidden posts
	'delHiddPost':	1,		// delete hidden posts
	'updThread':	1,		// update threads [0=off, 1=auto, 2=click]
	'updThrDelay':	7,		//		threads update interval in sec
	'favIcoBlink':	1,		//		favicon blinking, if new posts detected
	'desktNotif':	1,		//		desktop notifications, if new posts detected
	...
	'linksOut':		100,	//		delay disappearance in ms
	...
	'addYouTube':	1,		// YouTube links embedder [0=off, 1=onclick, 2=player, 3=preview+player, 4=only preview]
	...
	'warnSubjTrip':	1,		// warn if subject field contains tripcode
    ...
    'scriptStyle':  0,    // script style [0=glass black, 1=glass blue, 2=solid grey, 3=semi-transparent black]
	...
	'rePageTitle':	0,		// replace page title in threads
...
Lng = {
	cfg: {
		...
		'removebanner': ['placeholder*', 'Remove the top banner*'],
	    ...
	    'scriptStyle': {
	      sel:    [['Glass black', 'Glass blue', 'Solid grey', 'semi-transparent Black'], ['Glass black', 'Glass blue', 'Solid grey', 'semi-transparent Black']],
...
function run4chonfixes() {  
	if (!localStorage['DESUhidden']) {
		var h = document.createElement('div');
		h.innerText = "THIS SCRIPT IS NO LONGER MAINTAINED. \n Have a nice day!";
		var a = document.getElementById('de-pform');
		h.style.top = "550px";
		h.style.right = "270px";
		h.style.fontSize = "29pt"
		h.style.setProperty ("color", "red", "important");
		a.appendChild(h)

		var hide = document.createElement('a');
		hide.innerText = '[Hide]';
		hide.style.setProperty ("color", "black", "important");
		hide.href = "#";
		a.appendChild(hide);

		hide.onclick = function() {
			localStorage['DESUhidden'] = 'true';
...
//Boards (4chon)
if (window.location.hostname === "4chon.net" && (window.location.href.search('index.html') !== -1 || window.location.href.search('res') !== -1)) {
  var boards = document.getElementsByClassName('boardlist');
  var newHTML = '[ <a href="/r9k/index.html">r9k</a> / <a href="/new/index.html">new</a> / <a href="/v/index.html">vidya</a> / <a href="/edu/index.html">edu</a> / <a href="/meta/index.html">meta</a> ] [ <a href="/azg/index.html">azg</a> / <a href="/azn/index.html">azn</a> / <a href="/ae/index.html">ae</a> / <a href="/duck/index.html">duck</a>  ] [ <a href="/">home</a> / <a href="/banners.html">banners</a> / <a href="/search.html">search</a> / <a href="http://wiki.4chon.net/">wiki</a> / <a href="http://archive.4chon.net/">archive</a> ]  [ <a href="/faq.html">FAQ</a> / <a href="/rules.html">rules</a> ]  [ <a href="http://status.4chon.net/">status</a> / <a href="/stats.html">statistics</a> / <a href="http://4chon.net/map.html">map</a> / <a href="http://4chon.net/mod_log.html">moderation</a> / <a href="/mob_rule.html">mob rule</a> / <a href="/care/index.html">care</a> ]  [ <a href="http://4chon.net/irc.html">irc</a> / <a href="/donate.html">donate</a> / <a href="/h/index.html">h</a> / <a href="/test/index.html">test</a> / <a href="/lock/index.html">lock</a> ]';
...
//var stylehtml = '<a class="selected" href="javascript:void(0);">[Yotsuba B]</a><a href="javascript:void(0);">[Yotsuba]</a><a href="javascript:void(0);">[Futaba]</a><a href="javascript:void(0);">[Orange]</a><a href="javascript:void(0);">[dark]</a><a href="javascript:void(0);">[miku]</a><a href="javascript:void(0);">[wasabi]</a><a href="javascript:void(0);">[Ferus]</a></div>'


  if (pr.name) {pr.name.autocomplete = 'on';}
  if (pr.mail) {pr.mail.autocomplete = 'on';}
  
  var postIs = document.createElement('div');
  var form = document.getElementById('de-pform');
  var postIsIn;
  if (TNum) { postIsIn = 'New Reply'; } else if (!TNum) { postIsIn = 'New Thread'; }
  postIs.innerHTML = postIsIn;
  postIs.id = 'posttype';
  form.parentNode.insertBefore(postIs, form);
  //postIs.attributes['style'].value = "color: #8D3232 !important; display: inline-block; font-weight: bold; font-size: 17pt;";

}

if (window.location.href !== "http://archive.4chon.net/" && !(document.getElementsByClassName('op')[1]) && document.getElementsByClassName('op')[0] && window.location.hostname === "4chon.net"){
  archive = document.createElement('div');
  archive.id = "Archive request";
  intro = document.getElementsByClassName('intro')[0];
  archivehtml = '<div align = "right"><a href="http://archive.4chon.net/" style="background: rgba(255, 255, 255, 0.84) !important; border: 2px solid !important; padding: 2px !important; border-color: #AFAAAA !important; font-size: 8pt;" class="archival_nominate"> [Nominate for Archival] </div>';
  archive.innerHTML = archivehtml;
  intro.appendChild(archive);
}
if ((window.location.href === "http://archive.4chon.net/" ||  window.location.href === "https://archive.4chon.net/") && document.referrer.length > 34) {
      archiveurl = document.getElementById('url');
      archiveurl.value = document.referrer;
      submit = document.getElementById('submit');
      submit.className = "electable";
      submit.disabled = false;
}

if (window.location.href === "http://4chon.net/" || window.location.href === "https://4chon.net/") {
	var community = document.getElementsByClassName('community');
	var communityhtml = '<li><a href="http://wiki.4chon.net">Wiki</a> — 4chon community wiki.</li><li><a href="http://opsimathia.datnode.net:9090/">IRC</a> — Our <a href="irc://irc.datnode.net/4chon"><code>#4chon</code></a> IRC channel on the <a href="http://datnode.net">DatNode IRC Network</a> is always populated with random discussion.</li><li><a href="http://steamcommunity.com/groups/4Chon">Steam</a> — Our unofficial Steam Community group.</li><li><a href="http://redpill.us">Synchtube</a> — /pol/, /int/ and /new/\'s unofficial synchtube.</li><li><a href="http://tinychat.com/4ch0n">Tinychat</a> — Our unofficial tinychat room.</li><li><a href="http://www.mumu.io/player/r9kcore">mumu</a> — /r9k/\'s mumu music sharing room.</li></ul>'
	community[0].innerHTML = communityhtml;

	var homeboards = document.getElementsByClassName('boardlist');
	var newhomehtml = '<li><li><a href="/azg/index.html"><h3>/<abbr title="azg">azg</abbr>/</h3></a><p>"We must secure the existence of our people and a future for White Children."</p></li><li><a href="/duck/index.html"><h3>/<abbr title="duck">duck</abbr>/</h3></a><p>Give a fuck, post a duck!</p></li><li><a href="/care/index.html"><h3>/<abbr title="care">care</abbr>/</h3></a><p>For any complaints, please refer to this board.</p></li><li><a href="/lock/index.html"><h3>/<abbr title="lock">lock</abbr>/</h3></a><p>All locked threads will be moved to this board, but open for replies.</p></li>';
	homeboards[0].innerHTML += newhomehtml;
}
...
function readCfg() {
	...
	if(Cfg['updThrDelay'] != 5) {
		Cfg['updThrDelay'] = 5;
	}
	if(!Cfg['saveSage']) {
		Cfg['sageReply'] = 0;
	}
	if(Cfg['passwValue'] != localStorage.password) {
		Cfg['passwValue'] = localStorage.password;
	}
	if(Cfg['removebanner']) {
...
function scriptCSS() {
	...
	x += '.de-block { display: block; }\
		...
		#de-cfg-head:lang(gr), #de-panel:lang(gr) { background: rgba(0,0,0,0.55) !important; }\
		...
		.de-cfg-body:lang(gr), #de-cfg-btns:lang(gr) { border-color: #616161 !important; }\
		...
		#de-cfg-bar:lang(gr) { background-color: rgba(0,0,0,0.55) !important; }\
		...
		.de-cfg-tab-back:lang(gr) { border-color: #616161 !important !important; }\
	...
	x += '#de-btn-logo { margin-right: 3px; cursor: pointer; }\
		...
		#de-panel-btns:lang(gr), #de-panel-info:lang(gr) { border-color: #ccc; }\
	...
	gif('#de-btn-heading:empty', '');
	...
	x += '.de-abtn { text-decoration: none !important; outline: none; }\
		...
		.de-refmap { margin: 10px 4px 4px 4px; font-size: 85%; font-style: italic; }\
...
function checkForUpdates(isForce, Fn) {
	...
	GM_xmlhttpRequest({
		'method': 'GET',
		'url': 'https://userscripts.org/scripts/source/155174.user.js',
			...
			if(xhr.status === 200) {
				...
				if(isUpd) {
					Fn('<a style="color: blue; font-weight: bold;" href="' +
						...
						'155174.user.js">' + Lng.updAvail[lang] + '</a>');
				} else if(isForce) {
...
PostForm.prototype = {
	...
	_setSage: function() {
		...
		if(this.mail.type === 'text') {
			this.mail.value = c ? 'sage' : aib.fch ? 'noko' : 'noko';
		} else {
			this.mail.checked = c;
		}
	},
...
ImageBoard.prototype = {
	_bDomains: {
		...
		'4chon.net': [{
			formButtons: { get: function() {
				return Object.create(this._formButtons, {
					'tag': { value: ['==', '\'\'\'', '\'\'', '', '', '**', 'code', '', '', '>'] },
					'bb': { value: [false, false, false, false, false, false, true, false, false] }
				});
			} },
	...
	_base: {
		...
		get _formButtons() {
			var bb = this.isBB;
			return {
				'id': ['heading', 'bold', 'italic', 'under', 'strike', 'spoil', 'code', 'sup', 'sub', 'quote'],
				'val': ['H', 'B', 'i', 'U', 'S', '%', 'C', 'v', '^', '&gt;'],
				'tag': bb ? ['h', 'b', 'i', 'u', 's', 'spoiler', 'code', '', '', 'q']
						: ['==', '**', '*', '', '^H', '%%', '`', '', '', 'q'],
