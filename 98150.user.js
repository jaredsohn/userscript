// ==UserScript==
// @name            Platypus-drugrunners.net/Steal.cf
// @namespace       Platypus
// @include         http://drugrunners.net/Steal.cfm?TargetID=2847560
// ==/UserScript==

function do_platypus_script() {
html_insert_it(window.document,document.evaluate('/HTML[1]/BODY[1]/TABLE[1]/TBODY[1]/TR[1]/TD[1]/TABLE[1]/TBODY[1]/TR[2]/TD[1]/DIV[3]/FORM[1]/TABLE[1]/TBODY[1]/TR[4]/TD[1]/SPAN[1]', document, null, XPathResult.FIRST_ORDERED_NODE_TYPE,null).singleNodeValue,'<input type="submit" value="Steal Cash" name="Cash"/><input type="submit" name="Hoes" value="Steal Hoes"><input type="submit" value="Steal Drugs" name="Drugs"/><br><br><a href="http://darkside.us>Darkside.us - Join the darkside.</a><br>',true,true);
