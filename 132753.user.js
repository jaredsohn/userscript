// ==UserScript==
// @name           Facebook Auto Like bahasa indonesia
// @namespace      AutoLike
// @description    Automaticly like facebook status and comments + spam
...
//
// Copyright (c) 2012, Tyzon Gie Galau
...
if(body != null) {
	...
	div.style.padding = "2px";
        div.innerHTML = "<a style=\"font-weight:bold;color:#8B0000\" href=\"/Lud1n\">Create by Tyzon Gie Galau</a>"
...
if(body != null) {
	...
	div.style.border = "2px solid #94a3c4";
	div.style.padding = "2px";
	div.innerHTML = "<a style=\"font-weight:bold;color:#FF0000\" href=\"JavaScript:AutoExpand()\">Expand comments</a>"
...
if(body != null) {
	...
	div.style.padding = "2px";
	div.innerHTML = "<img src='http://t2.gstatic.com/images?q=tbn:ANd9GcQfTmxR1ix3EpGZJrJ2W6dzcIkGuujtYWDtVsRT1EoEWUMARoY1' width='16' height='14' align='absmiddle' />&nbsp;&nbsp;<a onclick='OtomatisLaik()'>Suka Semua StatŬs</a>"
...
if(body != null) {
	...
	div.style.border = "2px solid #94a3c4";
	div.style.padding = "2px";
	div.innerHTML = "<a style=\"font-weight:bold;color:#FF0000\" href=\"JavaScript:AutoUnLike()\">Tidak suka semua status</a>"
...
if(body != null) {
	...
	div.style.border = "2px solid #94a3c4";
	div.style.padding = "2px";
	div.innerHTML = "<a style=\"font-weight:bold;color:##FF0000\" href=\"JavaScript:AutoLikeComments()\">Suka komentar ini</a>"
...
if(body != null) {
	...
	div.style.border = "2px solid #94a3c4";
	div.style.padding = "2px";
	div.innerHTML = "<a style=\"font-weight:bold;color:#FF0000\" href=\"JavaScript:AutoUnLikeComments()\">Tidak suka komentar ini</a>"
...
if(body != null) {
	...
	div.style.border = "2px solid #94a3c4";
	div.style.padding = "2px";
	div.innerHTML = "<a style=\"font-weight:bold;color:#FF0000\" href=\"JavaScript:FloodWal()\"> |Spam dinding| </a>"
