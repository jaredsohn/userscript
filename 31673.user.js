...
hTradeGoodsNames['value_wine'] = 'Wino';
hTradeGoodsNames['value_marble'] = 'Marmur';
hTradeGoodsNames['value_crystal'] = 'Kryszta&#322'; // That's why I cannot just strip the name and I have to create a Hash >o<
hTradeGoodsNames['value_sulfur']= 'Siarka';
...
function addDebugWindow () {
  ...
  oDiv.id = "debugID"
  addShortCut("index.php?view=resource&type=resource&id=",oDiv,"Materia&#322y budowlane: +"+getResourcePerHour(fResourcesDelta));
...
function addDinamicPanel () {
  ...
  var cityid2 = extractCityId();
  var Oli = "  ";   

  var oTitle = document.createElement('h3');
  oTitle.innerHTML="Surowce"
  ...
  newInfoCityElement("Materia&#322y budowlane:","index.php?view=resource&type=resource&id=",oListUl,"  +"+getResourcePerHour(fResourcesDelta));
  ...
  newInfoCityElement("Sojusz : ","index.php?view=sendAllyMessage&oldView=embassy&id="+cityid2.substr(0,5)+"&position=11&type=50&dupa=",oListUl,"Wiadomo&#347&#263 do wszystkich");
...
index.php?view=sendAllyMessage&oldView=embassy&id=65875&position=11&type=50 Wy&#347lij wiadomo&#347&#263 #
*/
function init () {
