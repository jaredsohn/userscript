// ==UserScript==
// @name           TinyURL restorer PLUS
// @namespace      Based on TinyURL restorer by http://jmblog.jp/ Edited by curropar.
// @description    Retrieves the TinyURL, shows the original URL in tooltip, and modifies the linked URL
...
function setTitle(elem, url) {
	...
	GM_xmlhttpRequest({
		...
		onload:function(results) {
			...
			elem.setAttribute('href', restored_url);
