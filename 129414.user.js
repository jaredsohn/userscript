// ==UserScript==
// @name          Facebook - Dark Shiny Green, transparency
// @namespace     http://userstyles.org
// @description	  Facebook themed like my other Dark Shiny Blue, transparency themes.
// @author        TJrulz
// @homepage      http://userstyles.org/styles/11922
...
{ 
color: #fff !important;
background: url("http://i795.photobucket.com/albums/yy232/DaedalusIcarusHelios/Wallpaper/tech2green.png") repeat fixed left center #053322 !important;
}
...
.uiSideNavCount, .jewelCount, .uiContextualDialogContent, .fbTimelineCapsule .fbTimelineTwoColumn > .timelineUnitContainer:hover, .timelineReportContainer:hover, .uiOverlayPageContent, .pagesTimelineButtonPagelet .counter, #pagelet_timeline_profile_actions .counter, .uiScaledImageContainer:hover {box-shadow: 0 0 1em 4px #9fc !important;}

.img_link:hover, .album_thumb:hover, .fbChatTourCallout .body, .fbSidebarGripper div {box-shadow: 0 0 3em #9fc;}

.shaded, .progress_bar_inner, .tickerStoryAllowClick {box-shadow: inset 0 0 1em #9fc !important}

.UIPhotoGrid_Table .UIPhotoGrid_TableCell:hover .UIPhotoGrid_Image, #myphoto:hover, .mediaThumbWrapper:hover, .uiVideoLink:hover, .mediaThumb:hover, #presence.fbx_bar #presence_ui #presence_bar .highlight, .fbNubFlyout:hover, .hovercard .stage, #fbDockChatBuddylistNub .fbNubFlyout:hover, .balloon-content  {box-shadow: 0 0 3em 5px #9fc !important;}

.fbNubFlyout {box-shadow: 0 0 3em 5px #000 !important;}

#blueBar {box-shadow: 0 0 1em 3px #000;}

.fill {box-shadow: inset 0 0 2em #af6, 0 0 1em #000 !important;}
...
input[type="text"]:focus, textarea:focus, .fbChatSidebar .fbChatTypeahead .textInput:focus {box-shadow: 0 0 .5em #9fc, inset 0 0 .25em #af6 !important;}
...
.checkableListItem:hover a, .selectedCheckable a  {background: #af6 !important; }
...
.timelineUnitContainer .audienceSelector .uiButtonNoText .customimg {margin: 2px 6px 0 6px !important;}
.audienceSelector .wrap .uiSelectorButton .customimg {margin-left: 2px !important;}
.audienceSelector .wrap .uiSelectorButton {width: 15px !important; margin: 3px 5px !important;}
...
.nub, #contentCurve, #pagelet_netego_ads, img.plus, .highlighter, .uiToolbarDivider, .bfb_sticky_note_arrow_border, .bfb_sticky_note_arrow, #ConfirmBannerOuterContainer, .uiStreamHeaderBorder, .topBorder, .bottomBorder, .middleLink:after, .sideNavItem .uiCloseButton, .mask {display: none !important;}
...
.storyInnerContent .uiSelectorRight .wrap .uiSelectorButton.uiCloseButton  {margin-right: 25px !important;}
...
.GBSearchBox_Button, button[title="Search"] {background: url("http://i795.photobucket.com/albums/yy232/DaedalusIcarusHelios/search.png")  center center !important;}
button[title="Search"] {width: 23px !important;height: 21px !important;top: 0 !important;background-position: 3px 2px !important;}
...
#pageLogo {margin-left: -1px !important; margin-top: 6px !important; }
...
#navSearch, .mainWrapper .uiSelectorButton { margin-top: 10px !important; }
...
.topNavLink > a:hover, #navAccount.openToggler, .uiSideNavCount, .uiStreamAttachments div embed, .jewelCount, .uiButton, .fbChatSidebarFooter .button, button[title="Search"], .uiSelectorButton, .pagesTimelineButtonPagelet .counter, #pagelet_timeline_profile_actions .counter {border-radius: 6px !important;}
...
.audienceSelector .uiButton {padding: 2px 0px 2px 0px !important;}
