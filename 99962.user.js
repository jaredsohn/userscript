...
//logit ('g_timeoff: '+ uW.g_timeoff);
  ...
  .xtabBR {padding-right: 5px; border:none; background:none;}\
    ...
    .ptChatAlliance {font-weight:bold}\
	  .ptChatScripter {color:#A56631; font-weight:bold;text-shadow: 1px 1px 1px #AAA; background-color:#B8B8B8;}\
    ...
    .ptChatNotice {color: #000; background: #CCF; font-weight:bold; text-decoration:blink;}\
	  .ptChatOfficers {color:#000; font-weight:bold; background-color:#B8B8B8;}\
...
var ChatStuff = {
 ...
 chatDivContentHook : function (msg){
	...
	if (Options.chatLeaders) {
		if (t.leaders[suid]) element_class = 'ptChatOfficers';
    }
