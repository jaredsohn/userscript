...
// @name           Youtube Black and Red
// @namespace      https://userscripts.org/scripts/show/170639
// @description    Dark Theme for Youtube (specially at night) based on Youtube Black Theme v1.11 from CHRIS
...
// Last updated : Wednesday, July 23, 2013.
...
addGlobalStyle('#guide-container {background: rgba(139, 1, 1, .95) !important;}');
...
/* Textareas */
addGlobalStyle('.comments-post-alert, .comments-textarea-container textarea {background: rgb(175, 73, 73); border: 1px solid rgb(255, 255, 255);}');
...
// Video name author
addGlobalStyle('#watch7-user-header .yt-user-name {color: rgb(214, 0, 0) !important;}')
