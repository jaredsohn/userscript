// ==UserScript==
// @name       		LoU Cleaner
// @namespace  		Waterfall012
// @version    		0.6
// @description  	Spolszczenie skryptu
            ...
            qx.Class.define("clTweak.Main", {
                ...
                members:{
                    initialize:function () {
                        ...
                        clearCenterBtn.set({width:17, appearance:"button-text-small", toolTipText:"Niszczenie pola złóż w centrum miasta."});
                        ...
                        clearAllBtn.set({width:17, appearance:"button-text-small", toolTipText:"Niszczenie pola złóż oprócz jezior."});
