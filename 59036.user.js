// ==UserScript==
// @name           eRepublik profIT!
// @version        0.2.10
// @namespace      http://userscripts.org/users/csupi
// @author         Csupi
// @description    eRepublik Daily Productivity Calculator
...
// v0.2.10:
// - a régió infót kivettem, mert egyrészről sok köze nincs az alap szkripthez, másrészről Plus-szal akad.
// ha hiányzik, eToolkit-ben benne van: http://www.erepublik.com/en/newspaper/monkey-wrench-204979/1
// v0.2.9:
// - azoknál a melósoknál, akik ma már dolgoztak, a tényleges productivity értékkel számol, nem az aktuális wellnessből
// - a company oldalon ha a Total productivity érték fölé állsz az egérrel, láthatod, mennyi termelés van még hátra a mai napon
// v0.2.8:
// - land cégben bugos volt a profit számítás, javítva
// v0.2.7:
// - valamit variáltak apival, amitől lehalt a piac lekérés, azt most javítottam
// - az összegeket goldban is láthatod, ha fölé állsz az egérrel
// v0.2.6 TEST:
// - country oldalon infók a régiókról (Plus-sal akad!)
// v0.2.5:
// - a 0 wellnessű "töltelék" emberkék salary és productivity értékeit nem veszi figyelembe
// - Buy raw materials linkje a fajlagosan legolcsóbb minőségre mutat
// - a total productivity érték minden cégnél látható, nem csak sajátnál
// v0.2.4:
// - a licenszek mellett Go to marketplace gomb
// v0.2.3:
// - áfa számítás is most már rendben van, remélem :) 
// v0.2.2:
// - egy nagyobb pittyputty volt a landos cégek product price számításánál :)
// - manu és const áfa számítás is esetenként hibás lehet, nemsokára javítom azt is
// v0.2.1
// - volt egy kis pitty-putty a raw számításnál
// - www2 alatt is megy már
// v0.2.0
// - áfa számítás
// - a fizukat nem kell már "szkenneltetni" az employees oldalon, a company oldalon automatikusan beolvasásra kerül
//