// ==UserScript==
// @name           Funtube Unlike
// @namespace      funtube_unlike
// @description    Funtube.me Videos ohne Like
// @include        http://funtube.me/*
// @include        http://www.funtube.me/*
// ==/UserScript==
...
//===============================================================================
var script_title = "Funtube Unlike";
var source_location = "http://userscripts.org/scripts/source/101065.user.js";
var current_version = "0.0.3";
var latest_version = " ";
var gm_updateparam = "funtubeunlike_lastupdatecheck";
...
var version_holder = "http://beautify.it/funtube_unlike.php";
...
document.getElementById('realplay').style.display = 'block';