...
// @namespace      YouTube
// @description    Scans the YouTube page for all formats, including download to .mp3 on selected videos. Designed to be lightweight and unobtrusive, it runs entirely on the page without contacting any external sites.
// @include        htt*://*.youtube.com/*
// @grant		   none
// @match          http://*.youtube.com/*
// @match          https://*.youtube.com/*
// @icon           http://s.ytimg.com/yt/img/logos/youtube_logo_onecolor_againstwhite-vflhSQ1Dt.png
// @version        2.2
// @encoding       UTF-8
// ==/UserScript==
...
var translation = {
	...
	"es": {
		errormsg: "Error: YouTube se actualizó y Video Download no esta disponible. ",
		errorlink: "Click aquí para buscar actualizaciones.",

		button: "Descargar",
		tomp3: "Descargar en .mp3",
		tip: "Guardar en el Disco Duro",

		low: "Calidad Baja",
		high: "Definición Baja",

		lowdef: "Definición Baja",
		stddef: "Definición Estandar",
		highdef: "Definición Alta",
		fhighdef: "Definición HD",

		origdef: "Definición Original",

		unknown: "Formato desconocido",

		dlheader: "Elige un formato para descargar",
		nofmts: "Error: No hay formatos.",
		update1: "Una nueva versión de YouTube Video Download esta disponible.",
		update2: "Click aquí para actualizar.",

		options: "opciones",
		updatetoggle: " Buscar actualizaciones",
		replacetoggle: " Remplazar el titulo del vídeo",
		vinfotoggle: " Poner la información del visitor en cookies (avanzado)",
		tformat: " Formato del titulo: ",
		apply: "Aplicar",
		tformatinfo: "%t - Titulo del vídeo\n%c - uploader\n%f - Numero de Formato\n%v - id del vídeo\n%% - Porcentage Literal",
	}, 
};
