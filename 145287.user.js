// ==UserScript==
// @name           KOC Throne Room Organizer Without Backdoor
// @version        20120916
// @namespace      mmm
...
// @updateURL      https://userscripts.org/scripts/source/145287.meta.js
...
Tabs.options = {
        ...
        init : function (div) {
            ...
            $('#trupdatenow').click(
                    function() { AutoUpdater_145287.call(true,true); }
            );
...
Tabs.upgrader = {
        ...
        qualities :  [ "Simple", 
                       ...
                       init : function (div){
                           ...
                           $("#trpplink")
                           .attr('href', 'https://www.paypal.com/cgi-bin/webscr?cmd=_donations&business=4PERJ7P5XHF8S&lc=GB&item_name=Throne%20Room%20Organizer&currency_code=GBP&bn=PP%2dDonationsBF%3abtn_donateCC_LG%2egif%3aNonHosted')
                           .attr('target', '_blank');
                           $("#trpp")
...
var AutoUpdater_145287 = {
        ...
        call: function(response, secure) {
            ...
            GM_xmlhttpRequest({
                ...
                onload: function(xpr) {AutoUpdater_145287.compare(xpr, response);},
                onerror: function(xpr) {if (secure) AutoUpdater_145287.call(response, false);}
            });
        },
        enable: function() {
            GM_registerMenuCommand("Enable "+this.name+" updates", function() {
                GM_setValue('updated_145287', new Date().getTime()+'');
                AutoUpdater_145287.call(true, true)
            });
        },
        ...
        compare: function(xpr,response) {
            ...
            if ( (this.xversion) && (this.xname[1] == this.name) ) {
                ...
                if ( (xpr.responseText.match("the page you requested doesn't exist")) || (this.xname[1] != this.name) ) {
                    // GM_setValue('updated_145287', 'off');
                }
                return false;
            }
            ...
            if ( updated ) {
                display_confirm('A new version of '+this.xname+' is available.\nDo you wish to install the latest version?',
                        ...
                        function(){
                    try {
                        location.href = 'https://userscripts.org/scripts/source/145287.user.js';
                    } catch(e) {}
                },
                // Cancel
                function(){
                    if ( AutoUpdater_145287.xversion ) {
                        if(confirm('Do you want to turn off auto updating for this script?')) {
                            // GM_setValue('updated_145287', 'off');
                            TRGlobalOptions.trUpdate = false;
                            GM_setValue ('TROptions_??', JSON2.stringify(TRGlobalOptions));
                            AutoUpdater_145287.enable();
        ...
        check: function(tf) {
            if (!tf){
                ...
                if (+this.time > (+GM_getValue('updated_145287', 0) + 1000*60*60*24*this.days)) {
                    GM_setValue('updated_145287', this.time+'');
 ...
 */) {
    try {
        if (unsafeWindow.frameElement === null) {
            AutoUpdater_145287.check(TRGlobalOptions.trUpdate);
        }
    } catch(e) {
        AutoUpdater_145287.check(TRGlobalOptions.trUpdate);
    }
