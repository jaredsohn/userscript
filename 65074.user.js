...
// Most Popular
	...
	list_calc_types[cnt] = TYPE_HEIGHT_CALC;
	cnt++;
// News Near You(Videos Near You)
	anchor_queries[cnt] = '//div[@id="feedmodule-GEO"]//div[contains(@class,"video-title")]//a[contains(@href,"/watch?")]';
	added_queries[cnt] = 'ancestor::div[@class="feedmodule-singleform-info"]|ancestor::div[@class="video-main-content"]';
	cell_queries[cnt] =  'ancestor::div[@class="feedmodule-singleform-info"]/..|ancestor::div[@class="video-main-content"]/..';
	cell_calc_types[cnt] = TYPE_HEIGHT_CALC;
	list_calc_types[cnt] = TYPE_HEIGHT_CALC;
...
case	MY_PURCHASES_PAGE:
	...
	var cnt = 0;
// List View
	anchor_queries[cnt] = '//tbody[@id="videos"]//span[@class="my-videos-tiny-thumb"]/following-sibling::a[contains(@href,"/watch?")]';
	added_queries[cnt] = '..';
	cell_queries[cnt] =  '..';
	cnt++;
// Expand View
	anchor_queries[cnt] = '//tbody[@id="videos"]//div[@class="video-title"]//a[contains(@href,"/watch?")]';
	added_queries[cnt] = '../../following-sibling::div[@class="video-buttons"]';
	cell_queries[cnt] =  '../../..';
	cnt++;
// Grid View
	anchor_queries[cnt] = '//tbody[@id="videos"]//a[@class="title" and contains(@href,"/watch?")]';
	added_queries[cnt] = '..';
	cell_queries[cnt] =  '..';
	cnt++;
...
// Uploaded by or Favorited by XXX
	anchor_queries[cnt] = '//div[contains(@class,"video-title")]//a[contains(@href,"/watch?")]';
	added_queries[cnt] = 'ancestor::div[@class="video-main-content"]';
	cell_queries[cnt] =  'ancestor::div[@class="video-main-content"]';
	cnt++;

// commented on YYY
	anchor_queries[cnt] = '//div[contains(@class,"feedmodule-cmt-vid")]//a[contains(@href,"/watch?")]';
...
//	Setup_Set_Check_Box(setup_box.list.favorites_id, custom.list.favorites);
	...
	node = Setup_Set_Check_Box(setup_box.list.ratings_id, custom.list.ratings);
	...
	node = Setup_Set_Check_Box(setup_box.list.avg_rating_id, custom.list.avg_rating);
