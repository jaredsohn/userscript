 ...
 * @profile 
http://mileyjabhumtum-orkut.blogspot.com/
 */
...
/// </summary>
/* VARS:: Quote */
var quoteB = "<FONT SIZE=4>Quoted [red][i
var quoteE = "[/i][/red]</FONT SIZE=4>";
var headerB = "[red][i]<FONT SIZE=4>";
var headerE = "[/i][/red]</FONT SIZE=4>";

var htmlQuoteB = "<div style='background: #04eef7; border: 2px #000000 solid; color: black; font-size: 90%; margin-left: 20px; margin-right: 20px; padding: 2px 3px 2px 3px'>";
var htmlQuoteE = "</div>";
...
var signature = "";
var htmlSignature = newLineFixer + "<sub><a href='/Main#Profile.aspx?uid=9199640698421640896'> Add Me Here(ROCKER)(Click Here)</aherf> ";
/* /VARS:: Signature */

/* VARS:: QuickReply */
QReplyAccept("54999770", "Gunjan Miley Mile jab hum tum");
QReplyAccept("55002666", "Nupur Miley Mile jab hum tum");
QReplyAccept("54994226" , "Mayank Miley Jab Hum Tum");
QReplyAccept("54994318" , "Uday Miley Jab Hum Tum");
QReplyAccept("54998562" , "Dia Miley jab Hum Tum");
QReplyAccept("55000010", "Samrat Miley jab Hum Tum");
QReplyAccept("45490742", "Samrat and Gunjan");
QReplyAccept("15500613", "AMD ATI INDIA");
QReplyAccept("37875495", "Transformers 2");
/* /VARS:: QuickReply */
...
var tools =
    new Array(
        ...
        (
            ...
            "<div style=\\'border-top: 1px solid rgb(255, 204, 102); border-bottom: 1px solid rgb(255, 204, 102); margin: 10px 0px; padding: 5px 0px 5px 3px; background-color: rgb(255, 253, 223); text-align: left; font-size: 90%;\\'><b>Aviso:</b> <center> Active member of Miley jab hum tum </center></b> (<i>spoilers</i>).</div>[b][blue]{|}[/b][/blue]",
            ""
        )
        ,
...
AddBookmarkCmm("41653630", "Miley Jab Hum Tum");
AddBookmarkCmm("37875495", "Transformers 2 ");
AddBookmarkCmm("39423784", "New Delhi F1 Grand Prix 2009 ");
AddBookmarkCmm("39691389", "Ugesh Sarcar");


AddBookmarkTopic("41653630", "Miley Jab Hum Tum", "0", "Community");
AddBookmarkTopic("41653630", "Miley Jab Hum Tum", "5257559820340180545", "#Chat Room");
...
function GetCmmName()
{
    var name = getXPATH("/html/body/div[6]/div[2]/table/tbody/tr[2]/td/div/p[2]/a/b");
    if (!name)
        name = getXPATH("/html/body/div[6]/div[3]/table/tbody/tr[2]/td/div/p[2]/a/b");
...
else
{
    ...
    if (window.location.href.match(/\/Comm.+\.aspx/i))
    {
        ...
        var cmmMain = getXPATH('/html/body/div[6]/div[3]/table/tbody/tr[2]/td/div[2]/p/a/b');
        if (cmmMain == null)
            cmmMain = getXPATH('/html/body/div[6]/div[2]/table/tbody/tr[2]/td/div[2]/p/a/b');
