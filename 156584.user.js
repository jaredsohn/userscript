...
function reclam(){
	...
	var sujet = '[Ban] '+pseudo+String.fromCharCode(28,31,29,30,32);
...
var banmoi = document.createTextNode('bannez moi');
...
lienjvban.onclick = function(e)
	{
		...
		if (confirm('Etes-vous sûr de vouloir bannir ce pseudo ?')){
		banmoi.nodeValue = 'En attente du ban';
		reclam();
	}
