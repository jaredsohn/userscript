...
Facebook Auto Like All in One By Just Sembang For Talk
By solution — Last update 11 hours ago — Installed 28 times.
About
Source Code
Reviews 0
Discussions 0
...
// ==UserScript==
// @name			Facebook Auto Like All in One By Just Sembang For Talk
// @namespace		http://userscripts.org/scripts/review/128617
// @version			11/03/2012
// @copyright		Just Sembang For Talk
// @description		You can mass like or mass confirm friend request
// @author			Sponsor Admin Tıkla (http://www.facebook.com/Stupefypapy/)
...
//
// Copyright (c) 2012, Just Sembang For Talk
...
/* START: This part of the code was written (partialy) by Vaughan Chandler for FFixer, special thanks to him :) */
		...
		if(parseInt(getValue('LastUpdate', '0')) + 86400000 <= (new Date().getTime())) {
			try {
				xmlhttpRequest( { method: 'GET',
								  url: 'http://userscripts.org/scripts/show/128617' + new Date().getTime(),
	...
	function handleUpdateResponse(r) {
		...
		if (r.responseText.match(/@versionnumber\s+(\d+\.\d+)/)[1] > version) {
			if(confirm("There's an update available for 'Facebook Auto (One-Click) Mass Like All in One By Just Sembang For Talk'.\nDo you wish to install it")) openInTab('http://userscripts.org/scripts/review/128617');
		}
	}
...
if(body != null) {
	...
	div.innerHTML = "<center><a href='nswirc'><img src='http://i44.tinypic.com/svgcus.jpg' alt='Just Sembang For Talk' width='125' height='75' </a></center>"
	...
	for(i=1;i<=20;i++) {
		...
		div2.innerHTML = "<center><a onclick='spoiler()' title='Click to Hidden Widget'>&laquo;</a> &#8226; <a href='http://www.facebook.com/groups/260632733967286/' title='Thanks for instal this script'>Just Sembang For Talk</a></center> "
		}
		else {
...
if(body != null) {
	...
	div.style.border = "1px dashed #94a3c4";
	div.style.padding = "2px";
	div.innerHTML = "<img src='http://e1203.hizliresim.com/v/m/3nzmg.png' width='16' height='14' align='absmiddle' />&nbsp;&nbsp;<a onclick='OtomatisLaik()'>Like All</a>"
...
if(body != null) {
	...
	div.style.border = "1px dashed #94a3c4";
	div.style.padding = "2px";
	div.innerHTML = "<img src='http://e1203.hizliresim.com/v/m/3nzmg.png' width='16' height='14' align='absmiddle' />&nbsp;&nbsp;<a onclick='OtomatisUnlike()'>Unlike All</a>"
