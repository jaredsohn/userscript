...
// @include 	http://*.redraviangame*.*
// @exclude		http://analytics.redraviangame*.*/*
// @exclude 	http://*.redraviangame*.*/hilfe.php*
// @exclude		http://*.travian*.*/logout.php*
// @exclude 	http://*.redraviangame*.*/index.php*
// @exclude 	http://*.redraviangame*.*/anleitung.php*
// @exclude 	http://*.redraviangame*.*/impressum.php*
// @exclude 	http://*.redraviangame*.*/anmelden.php*
// @exclude 	http://*.redraviangame*.*/gutscheine.php*
// @exclude 	http://*.redraviangame*.*/spielregeln.php*
// @exclude 	http://*.redraviangame*.*/links.php*
// @exclude 	http://*.redraviangame*.*/geschichte.php*
// @exclude 	http://*.redraviangame*.*/tutorial.php*
// @exclude 	http://*.redraviangame*.*/manual.php*
// @exclude 	http://*.redraviangame*.*/manual.php*
// @exclude 	http://*.redraviangame*.*/ajax.php*
// @exclude 	http://*.redraviangame*.*/ad/*
// @exclude 	http://*.redraviangame*.*/chat/*
// @exclude 	http://forum.redraviangame*.*
// @exclude 	http://board.redraviangame*.*
// @exclude 	http://shop.redraviangame*.*
// @exclude 	http://*.redraviangame*.*/activate.php*
// @exclude 	http://*.redraviangame*.*/support.php*
// @exclude  	http://help.redraviangame*.*
// @exclude 	*.css
// @exclude 	*.js
// @version     1.9.10c
