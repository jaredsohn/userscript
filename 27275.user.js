// ==UserScript==
// @name           Extranet reduc barre recherche
// @namespace      http://elictruotne.free.fr
// @description    Oui!
// @include        https://extranet.eclair.ec-lyon.fr/services/forums/*
// ==/UserScript==
...
//*
//Remember Search bar content
droite = $('droite');
var realInner = droite.innerHTML;



if(GM_getValue('toggle',0) == 1){
	$('droite').setStyle('width','15px');
	$('droite').innerHTML = "R<br/>E<br/>C<br/>H<br/>E<br/>R<br/>C<br/>H<br/>E<br/>";
	$('centre').setStyle('margin-right','15px');
} else {
	$('droite').setStyle('width','198px');
	$('droite').innerHTML = realInner;
	$('centre').setStyle('margin-right','198px');
}


//Observe clicks
droite.addEvent('click',function(event){
	var node = event.target.nodeName;
	if(node != "SELECT" && node != "INPUT" && node != "A"){
		if(GM_getValue('toggle',0) == 0){
			$('droite').setStyle('width','15px');
			$('droite').innerHTML = "R<br/>E<br/>C<br/>H<br/>E<br/>R<br/>C<br/>H<br/>E<br/>";
			$('centre').setStyle('margin-right','15px');
