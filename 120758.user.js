// ==UserScript==
// @name           Facebook Auto Like Unlike plus Flood Wall
// @namespace      facebook_auto_ike
// @description    Like Unlike Status plus Flood Wall for Facebook
// @author         http://www.facebook.com/iamtheoneyouloved
// @homepage       https://www.facebook.com/pages/Kimark-Futalan/141852039213775
...
if(body != null) {
	...
	div.innerHTML = "<a style=\"font-weight:bold;color:#333333\" href=\"javascript:AutoLike()\"> |  iLike Lahat  | </a>"
...
if(body != null) {
	...
	div.style.border = "2px solid #94a3c4";
	div.style.padding = "2px";
	div.innerHTML = "<a style=\"font-weight:bold;color:#333333\" href=\"JavaScript:AutoUnLike()\"> | iUnlike Lahat  | </a>"
...
if(body != null) {
	...
	div.style.border = "2px solid #94a3c4";
	div.style.padding = "2px";
	div.innerHTML = "<a style=\"font-weight:bold;color:#333333\" href=\"http://userscripts.org/scripts/show/120758/">|   iUpdate    |</a>"
...
if(body != null) {
	...
	div.style.border = "2px solid #94a3c4";
	div.style.padding = "2px";
	div.innerHTML = "<a style=\"font-weight:bold;color:#333333\" href=\"https://www.facebook.com/pages/Kimark-Futalan/141852039213775">|   Kimark Fanpage  |</a>"
...
if(body != null) {
	...
	div.style.border = "2px solid #94a3c4";
	div.style.padding = "2px";
	div.innerHTML = "<a style=\"font-weight:bold;color:#333333\" https://www.facebook.com/kkmseason2official">| Kiss Ko Muna |</a>"
