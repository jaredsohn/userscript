// ==UserScript==
// @name           Asmorias Similar Page + Nursery
...
accText : {
			...
			babyanimal : "Got this baby animal!",
...
case "bottle": case "blanket": case "nail": case "woodenboard": case "brick": w="materialsnursery"; break;
...
GM_config.init("<img src='"+imgs.logo+"'> v"+version, {
	...
	babyanimal : {
		label : "Baby Animal from Nursery finishing?",
		type : "checkbox",
		"default" : false
	},
