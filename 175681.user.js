// ==UserScript==
// @name        Warian Task Queue for Warian 4  [MoRGaNA]
// @namespace   http://userscripts.org/scripts/show/175681
// @author      Serj_LV, Pimp Trizkit (based on TTQ by Risi and further edited by Nevam and then Pimp Trizkit)
// @require  http://usocheckup.dune.net/175681.js
...
// @include		http://*.warianteam.*
// @exclude		http://analytics.warian*.*/*
...
var CURRENT_SERVER = "";    // Set this to the server's url to override automatic server detection (i.e. x1.warian.ir)
