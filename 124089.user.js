...
function openPopup() {
    ...
    massDiv = '<fieldset>' + '<legend>Mass config</legend>' + '<table border=0>' + '<tr>' + '<td colspan=10 class="bold_head">Cords:</td>' + '</tr>' + '<tr><td colspan=4 class="center">' + sel + '</td>' +

    '<td colspan=2 class="center">X:<input size="4" id="massX"></td>' + '<td colspan=2 class="center">Y:<input size="4" id="massY"></td>' +

    '<td colspan=4 class="center"><input type="button" id="massCords" value="Submit"></td>' + '</tr>' + '<tr>' + '<td colspan=10 class="bold_head">Ratios:</td>' + '<tr>' + '<td colspan=5><button id="fourth">1/4</button></td>' + '<td colspan=5><button id="third">1/3</button></td>' + '</tr>' + '</tr>' + '<tr>' + '<td><button id="leg"><img class="unit u1" src="img/x.gif"></button></td>' + '<td><button id="pret"><img class="unit u2" src="img/x.gif"></button></td>' + '<td><button id="imp"><img class="unit u3" src="img/x.gif"></button></td>' + '<td><button id="el"><img class="unit u4" src="img/x.gif"></button></td>' + '<td><button id="ei"><img class="unit u5" src="img/x.gif"></button></td>' + '<td><button id="ec"><img class="unit u6" src="img/x.gif"></button></td>' + '<td><button id="ram"><img class="unit u7" src="img/x.gif"></button></td>' + '<td><button id="kat"><img class="unit u8" src="img/x.gif"></button></td>' + '<td><button id="sen"><img class="unit u9" src="img/x.gif"></button></td>' + '<td><button id="set"><img  class="unit u10" src="img/x.gif"></button></td>' + '</tr>' + '<tr>' + '<td><button id="clu"><img class="unit u11" src="img/x.gif"></button></td>' + '<td><button id="spe"><img class="unit u12" src="img/x.gif"></button></td>' + '<td><button id="axe"><img class="unit u13" src="img/x.gif"></button></td>' + '<td><button id="sco"><img class="unit u14" src="img/x.gif"></button></td>' + '<td><button id="pal"><img class="unit u15" src="img/x.gif"></button></td>' + '<td><button id="tk"><img class="unit u16" src="img/x.gif"></button></td>' + '<td><button id="ram2"><img class="unit u17" src="img/x.gif"></button></td>' + '<td><button id="kat2"><img class="unit u18" src="img/x.gif"></button></td>' + '<td><button id="sen2"><img class="unit u19" src="img/x.gif"></button></td>' + '<td><button id="set2"><img class="unit u20" src="img/x.gif"></button></td>' + '</tr>' + '<tr>' + '<td><button id="pha"><img class="unit u21" src="img/x.gif"></button></td>' + '<td><button id="swo"><img class="unit u22" src="img/x.gif"></button></td>' + '<td><button id="pat"><img class="unit u23" src="img/x.gif"></button></td>' + '<td><button id="tt"><img class="unit u24" src="img/x.gif"></button></td>' + '<td><button id="dru"><img class="unit u25" src="img/x.gif"></button></td>' + '<td><button id="hae"><img class="unit u26" src="img/x.gif"></button></td>' + '<td><button id="ram3"><img class="unit u27" src="img/x.gif"></button></td>' + '<td><button id="kat3"><img class="unit u28" src="img/x.gif"></button></td>' + '<td><button id="sen3"><img class="unit u29" src="img/x.gif"></button></td>' + '<td><button id="set3"><img class="unit u30" src="img/x.gif"></button></td>' + '</tr>' + '<tr></tr><tr>' + '<td colspan=2 ><img class="r1" src="img/x.gif"><input size="5" id="r_wood"></td>' + '<td colspan=2><img class="r2" src="img/x.gif"><input size="5" id="r_clay"></td>' + '<td colspan=2><img class="r3" src="img/x.gif"><input size="5" id="r_iron"></td>' + '<td colspan=2><img class="r4" src="img/x.gif"><input size="5" id="r_wheat"></td>' + '<td colspan=2><input type="button" id="massRatios" value="Submit"></td>' + '</tr>' + '<tr>' + '<td  colspan=10 class="bold_head">Merchants:</td>' + '</tr>' + '</tr>' + '<tr>' + '<td><img class="r1" src="img/x.gif"></td><td><input size="2" id="m_wood"></td>' + '<td><img class="r2" src="img/x.gif"></td><td><input size="2" id="m_clay"></td>' + '<td><img class="r3" src="img/x.gif"></td><td><input size="2" id="m_iron"></td>' + '<td><img class="r4" src="img/x.gif"></td><td><input size="2" id="m_wheat"></td>' + '<td colspan=2><input type="button" id="massMerchants" value="Submit"></td>' + '</tr>' +
