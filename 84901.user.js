// ==UserScript==
// @name           IkArT BR
// @version 	   IkArt 1.4.9 BR
// @namespace 	   Ikariam
// @autor          Create by Typhon, Matheod, Quenquen407 and translated to portuguese by Matheus Faver&atilde;o
// @e-mail         minigrapheur@live.fr
// @e-mail         matheodikart@gmail.com
// @e-mail         quenquen407.ikart@gmail.com
// @description    IkArt BR : Viva o Ikariam com os períodos do dia alteráveis e com a resolução do jogo melhorada. 
...
// ---- !!! I, MATHEUS FAVER&Atilde;, ONLY TRANSLATED THIS SCRIPT !!! Not Protect by : http://www.iddn.org ----
...
// --- Fonctions qui définis quel style utilisé en fonction de l'heure ---
...
if(document.getElementById('options'))
{
	...
	var check = GM_getValue("allonger", false);
	var icheck = "";
	if(check == true) {icheck = ' checked="checked"';}
	var rep = GM_getValue("rep", "wonder");
	var irep1="";
	var irep2="";
	var irep3="";
	...
	document.getElementById('ikartoption').innerHTML = '<form name="formikart"><h3 class="header"><span class="textLabel">Op&ccedil;&otilde;es IkArt vers&atilde;o BR</span></h3><div class="content"><div><table><tr><th>Site Oficial IkArt</th><td><a href="http://ika-art.teknopop.com" target="_blank">Clique Aqui</a></td></tr></table></div><div><h3>Tema</h3><table><tr id="repid"><th>Vers&otilde;es</th><td><input type="radio" id="rep1" style="cursor: pointer;" name="rep" value="wonder"'+irep1+' />&nbsp;<label for="rep1" style="cursor:pointer;">Normal</label>&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;<input type="radio" disabled="disabled" id="rep2" name="rep" value="snow"'+irep2+' />&nbsp;<label for="rep2" style="color:grey;">Neve</label>&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;<input type="radio" disabled="disabled" id="rep3" name="rep" value="war"'+irep3+' />&nbsp;<label for="rep3" style="color:grey;">Guerra</label></td></tr><tr><th>Logo IkArt</th><td><input id="logo" type="text" size="35" value="'+GM_getValue('logo','http://ika-art.teknopop.com/ScriptIkart/logo.png')+'"><br /><b>Galeria :</b> <a onclick="document.getElementById(\'logo\').value=\'http://ika-art.teknopop.com/ScriptIkart/logo.png\';" style="cursor:pointer;">IkArt Normal</a> - <a onclick="document.getElementById(\'logo\').value=\'http://ika-art.teknopop.com/ScriptIkart/logo2.png\';" style="cursor:pointer;">IkArt Costumizado</a></td></tr></table></div><div><h3>Estendendo a vis&atilde;o</h3><table><tr><th>Ativo</th><td><input type="checkbox" '+icheck+' id="ikart_allonger" style="cursor:pointer;"></td></tr></table></div><div><h3>Configura&ccedil;&otilde;es dos Per&iacute;dos do Dia</h3><table><tr><th><b>Configura&ccedil;&otilde;es B&aacute;sicas:</b></th><td><a id="configIkart1" onclick="config1();"><img src="http://ika-art.teknopop.com/ScriptIkart/all.png" title="Configura&ccedil;&atilde;o Completa" /></a><a id="configIkart2" onclick="config2();"><img src="http://ika-art.teknopop.com/ScriptIkart/jour_nuit.png" title="Configura&ccedil;&atilde;oParcial" /></a><a id="configIkart3" onclick="config3();"><img src="http://ika-art.teknopop.com/ScriptIkart/jour.png" title="Configura&ccedil;&atilde;o: Somente Dia" /></a></td></tr><tr><th><b>Dicas:</b></th><td><img src="http://ika-art.teknopop.com/ScriptIkart/iconInfo.png" style="z-index: 33; position: relative; cursor: help;" onMouseOver="document.getElementById(\'aideOption\').setAttribute(\'style\',\'display:block !important;\');" onMouseOut="document.getElementById(\'aideOption\').setAttribute(\'style\',\'display:none;\');" /><div id="aideOption" style="cursor:help;" onMouseOver="document.getElementById(\'aideOption\').setAttribute(\'style\',\'display:block !important;\');" onMouseOut="document.getElementById(\'aideOption\').setAttribute(\'style\',\'display:none;\');" ><span><center><b>Bem Vindo ao Dicas!</b></center><br /><center>-------</center><br /><b>Lembretes:</b><br /><br />- Para excluir um per&iacute;odo do dia deve haver "-1" em ambas as caixas do mesmo per&iacute;odo, as ilustra&ccedil;&otilde;es acima mostram as escolhas poss&iacute;veis. <br /><br />- Nunca deixe um quadro em branco.<br /><br />- O preimero quadro deve estar sempre em "0" e o &uuml;ltimo em "23".<br /><br />- Sempre lembre de salvar suas configura&ccedil;&otilde;es.<br /><br /></span></td></tr><tr><th><b>Madrugada:</b></th><td><input type="text" id="nuit1" style="width:20px;" value="'+GM_getValue('nuit1', '0')+'">h00 &agrave; <input type="text" id="nuit2" style="width:20px;" value="'+GM_getValue('nuit2', '6')+'">h59<span class="ikartError" id="ikartError1"></span></td></tr><tr><th><b>Amanhecer:</b></th><td><input type="text" id="aube1" style="width:20px;" value="'+GM_getValue('aube1', '7')+'">h00 &agrave; <input type="text" id="aube2" style="width:20px;" value="'+GM_getValue('aube2', '8')+'">h59<span class="ikartError" id="ikartError2"></span></td></tr><tr><th><b>Dia e Tarde:</b></th><td><input type="text" id="jour1" style="width:20px;" value="'+GM_getValue('jour1', '9')+'">h00 &agrave; <input type="text" id="jour2" style="width:20px;" value="'+GM_getValue('jour2', '18')+'">h59<span class="ikartError" id="ikartError3"></span></td></tr><tr><th><b>Anoitecer:</b></th><td><input type="text" id="crepuscule1" style="width:20px;" value="'+GM_getValue('crepuscule1', '19')+'">h00 &agrave; <input type="text" id="crepuscule2" style="width:20px;" value="'+GM_getValue('crepuscule2', '20')+'">h59<span class="ikartError" id="ikartError4"></span></td></tr><tr><th><b>Noite:</b></th><td><input type="text" id="nuitbis1" style="width:20px;" value="'+GM_getValue('nuitbis1', '21')+'">h00 &agrave; <input type="text" id="nuitbis2" style="width:20px;" value="'+GM_getValue('nuitbis2', '23')+'">h59<span class="ikartError" id="ikartError5"></span></td></tr></div></table></div><div class="centerButton"><input onclick="for(i=0;i<=document.getElementById(\'repid\').getElementsByTagName(\'input\').length-1;i++){if(document.formikart.rep[i].checked){irep=document.formikart.rep[i].value;}}if(ikartsvg(document.getElementById(\'ikart_allonger\').checked,document.getElementById(\'nuit1\').value,document.getElementById(\'nuit2\').value,document.getElementById(\'aube1\').value,document.getElementById(\'aube2\').value,document.getElementById(\'jour1\').value,document.getElementById(\'jour2\').value,document.getElementById(\'crepuscule1\').value,document.getElementById(\'crepuscule2\').value,document.getElementById(\'nuitbis1\').value,document.getElementById(\'nuitbis2\').value,document.getElementById(\'logo\').value,irep)){alert(\'Configura&ccedil;&otilde;es Salvas!\');location.reload();}" class="button" value="Salvar as Configura&ccedil;&otilde;es!" type="button"></div></div><div class="footer"></div></div></form>';
	
	
	function config1() {
		document.getElementById('nuit1').value='0';
		document.getElementById('nuit1').disabled='';
		document.getElementById('nuit2').value='6';
		document.getElementById('nuit2').disabled='';
		document.getElementById('aube1').value='7';
		document.getElementById('aube1').disabled='';
		document.getElementById('aube2').value='8';
		document.getElementById('aube2').disabled='';
		document.getElementById('jour1').value='9';
		document.getElementById('jour1').disabled='';
		document.getElementById('jour2').value='18';
		document.getElementById('jour2').disabled='';
		document.getElementById('crepuscule1').value='19';
		document.getElementById('crepuscule1').disabled='';
		document.getElementById('crepuscule2').value='20';
		document.getElementById('crepuscule2').disabled='';
		document.getElementById('nuitbis1').value='21';
		document.getElementById('nuitbis1').disabled='';
		document.getElementById('nuitbis2').value='23';
		document.getElementById('nuitbis2').disabled='';
	}
	
	function config2() {
		document.getElementById('nuit1').value='0';
		document.getElementById('nuit1').disabled='';
		document.getElementById('nuit2').value='7';
		document.getElementById('nuit2').disabled='';
		document.getElementById('aube1').value='-1';
		document.getElementById('aube1').disabled='disabled';
		document.getElementById('aube2').value='-1';
		document.getElementById('aube2').disabled='disabled';
		document.getElementById('jour1').value='8';
		document.getElementById('jour1').disabled='';
		document.getElementById('jour2').value='19';
		document.getElementById('jour2').disabled='';
		document.getElementById('crepuscule1').value='-1';
		document.getElementById('crepuscule1').disabled='disabled';
		document.getElementById('crepuscule2').value='-1';
		document.getElementById('crepuscule2').disabled='disabled';
		document.getElementById('nuitbis1').value='20';
		document.getElementById('nuitbis1').disabled='';
		document.getElementById('nuitbis2').value='23';
		document.getElementById('nuitbis2').disabled='';
	}
	...
	function config3() {
		document.getElementById('nuit1').value='-1';
		document.getElementById('nuit1').disabled='disabled';
		document.getElementById('nuit2').value='-1';
		document.getElementById('nuit2').disabled='disabled';
		document.getElementById('aube1').value='-1';
		document.getElementById('aube1').disabled='disabled';
		document.getElementById('aube2').value='-1';
		document.getElementById('aube2').disabled='disabled';
		document.getElementById('jour1').value='0';
		document.getElementById('jour1').disabled='';
		document.getElementById('jour2').value='23';
		document.getElementById('jour2').disabled='';
		document.getElementById('crepuscule1').value='-1';
		document.getElementById('crepuscule1').disabled='disabled';
		document.getElementById('crepuscule2').value='-1';
		document.getElementById('crepuscule2').disabled='disabled';
		document.getElementById('nuitbis1').value='-1';
		document.getElementById('nuitbis1').disabled='disabled';
		document.getElementById('nuitbis2').value='-1';
		document.getElementById('nuitbis2').disabled='disabled';
	}
	
	unsafeWindow.ikartsvg = function (allonger,nuit1,nuit2,aube1,aube2,jour1,jour2,crepuscule1,crepuscule2,nuitbis1,nuitbis2,logo,irep) {
		
		// On vérifie toutes les erreur possible et on les indique
		var erreur = false;
		...
		if(parseInt(nuit1) != (-1) && parseInt(nuit2) != (-1) && parseInt(aube1) != (-1) && parseInt(aube2) != (-1) && parseInt(jour1) != (-1) && parseInt(jour2) != (-1) && parseInt(crepuscule1) != (-1) && parseInt(crepuscule2) != (-1) && parseInt(nuitbis1) != (-1) && parseInt(nuitbis2) != (-1)) {
			if(parseInt(nuit1) > parseInt(nuit2)) {erreur = true; erreurNuit1 = 'O primeiro campo deve conter um n&uacute;mero menor que o segundo, ';}
			if(parseInt(nuit1) != 0) {erreur = true; erreurNuit0 = 'O primeiro campo deve conter o valor 0. ';}
			if(parseInt(aube1) > parseInt(aube2)) {erreur = true; erreurAube1 = 'O primeiro campo deve conter um n&uacute;mero menor que o segundo. ';}
			if(parseInt(jour1) > parseInt(jour2)) {erreur = true; erreurJour1 = 'O primeiro campo deve conter um n&uacute;mero menor que o segundo. ';}
			if(parseInt(crepuscule1 )> parseInt(crepuscule2)) {erreur = true; erreurCrepuscule1 = 'O primeiro campo deve conter um n&uacute;mero menor que o segundo. ';}
			if(parseInt(nuitbis1) > parseInt(nuitbis2)) {erreur = true; erreurNuitBis1 = 'O primeiro campo deve conter um n&uacute;mero menor que o segundo. ';}
			if(parseInt(nuitbis2) != 23) {erreur = true; erreurNuitBis0 = 'O &uacute;ltimo campo deve conter o valor 23. ';}
			if(parseInt(nuitbis1) - parseInt(crepuscule2) != 1) {erreur = true; erreurNuitBisCrepuscule1 = 'O per&iacute;odo de tempo atual n&atilde;o faz coer&ecirc;ncia aos outros campos. ';}
			if(parseInt(crepuscule1) - parseInt(jour2) != 1) {erreur = true; erreurCrepusculeJour1 = 'O per&iacute;odo de tempo atual n&atilde;o faz coer&ecirc;ncia aos outros campos. ';}
			if(parseInt(jour1) - parseInt(aube2) != 1) {erreur = true; erreurJourAube1 = 'O per&iacute;odo de tempo atual n&atilde;o faz coer&ecirc;ncia aos outros campos. ';}
			if(parseInt(aube1) - parseInt(nuit2) != 1) {erreur = true; erreurAubeNuit1 = 'O per&iacute;odo de tempo atual n&atilde;o faz coer&ecirc;ncia aos outros campos. ';}
		}
		...
		// Si on utilise que le jour et la nuit
			...
			if(parseInt(nuitbis1) > parseInt(nuitbis2)) {erreur = true; erreurNuitBis1 ='O primeiro campo deve conter um n&uacute;mero menor que o segundo. ';}
			if(parseInt(nuitbis2) != 23) {erreur = true; erreurNuitBis0 = 'O &uacute;ltimo campo deve conter o valor 23. ';}
			if(parseInt(nuitbis1) - parseInt(jour2) != 1) {erreur = true; erreurNuitBisJour1 = 'O per&iacute;odo de tempo atual n&atilde;o faz coer&ecirc;ncia &agrave; noite. ';}
			if(parseInt(jour1) - parseInt(nuit2) != 1) {erreur = true; erreurJourNuit1 = 'O per&iacute;odo de tempo atual n&atilde;o faz coer&ecirc;ncia ao dia. ';}
		}
		
		// Si on utilise que le jour
		else if(parseInt(nuit1) == (-1) && parseInt(nuit2) == (-1) && parseInt(aube1) == (-1) && parseInt(aube2) == (-1) && parseInt(jour1) != (-1) && parseInt(jour2) != (-1) && parseInt(crepuscule1) == (-1) && parseInt(crepuscule2) == (-1) && parseInt(nuitbis1) == (-1) && parseInt(nuitbis2) == (-1)) {
			if(parseInt(jour1) > parseInt(jour2) || parseInt(jour1) != 0 || parseInt(jour2) != 23){erreur = true; erreurJour3 = 'Para definir apenas o dia, &eacute; necess&aacute;rio que o primeiro valor seja 0 e o segundo 23. ';}
		}
		
		// Si le premier champs est égal à -1 et l'autre non
		if(parseInt(nuit1) == (-1) && parseInt(nuit2) != (-1) || parseInt(nuit1) != (-1) && parseInt(nuit2) == (-1)) {erreur = true; erreurNuit2 = 'Um campo cont&eacute;m o valor -1. ';}
		if(parseInt(aube1) == (-1) && parseInt(aube2) != (-1) || parseInt(aube1) != (-1) && parseInt(aube2) == (-1)) {erreur = true; erreurAube2 = 'Um campo cont&eacute;m o valor -1. ';}
		if(parseInt(jour1) == (-1) || parseInt(jour2) == (-1)) {erreur = true; erreurJour2 = 'O per&iacute;odo do dia n&atilde;o pode ser desativado e, portanto, n&atilde;o pode conter nenhum campo com o valor -1. ';}
		if(parseInt(crepuscule1) == (-1) && parseInt(crepuscule2) != (-1) || parseInt(crepuscule1) != (-1) && parseInt(crepuscule2) == (-1)) {erreur = true; erreurCrepuscule2 = 'Um campo cont&eacute;m o valor -1. ';}
		if(parseInt(nuitbis1) == (-1) && parseInt(nuitbis2) != (-1) || parseInt(nuitbis1) != (-1) && parseInt(nuitbis2) == (-1)) {erreur = true; erreurNuitBis2 = 'Um campo cont&eacute;m o valor -1. ';}
		...
		if(parseInt(nuit1) == (-1) && parseInt(nuitbis1) == (-1) && parseInt(nuit2) == (-1) && parseInt(nuitbis2) == (-1)) {
			if(parseInt(aube1) != (-1) && parseInt(aube2) != (-1)) {erreur = true; erreurNuitAube3 = 'A noite est&aacute; desativada, por&eacute;m a madrugada n&atilde;o est&aacute;. ';}
			if(parseInt(crepuscule1) != (-1) && parseInt(crepuscule2) != (-1)) {erreur = true; erreurNuitCrepuscule3 = 'A noite est&aacute; desativada, por&eacute;m o anoitecer n&atilde;o est&aacute;. ';}
		}
		else if(parseInt(nuit1) == (-1) && parseInt(nuit2) == (-1) && parseInt(nuitbis1) != (-1) && parseInt(nuitbis2) != (-1)) {
			erreur = true;
			erreurNuitNuitBis3 = 'Altere a segunda parte da noite. ';
			if(parseInt(aube1) != (-1) && parseInt(aube2) != (-1)) {erreur = true; erreurNuitAube3 = 'A noite est&aacute; desativada, por&eacute;m a madrugada n&atilde;o est&aacute;. ';}
			if(parseInt(crepuscule1) != (-1) && parseInt(crepuscule2) != (-1)) {erreur = true; erreurNuitCrepuscule3 = 'A noite est&aacute; desativada, por&eacute;m o anoitecer n&atilde;o est&aacute;. ';}
		}
		else if(parseInt(nuitbis1) == (-1) && parseInt(nuitbis2) == (-1) && parseInt(nuit1) != (-1) && parseInt(nuit2) != (-1)) {
			erreur = true;
			erreurNuitBisNuit3 = 'Altere a primeira parte da noite. ';
			if(parseInt(aube1) != (-1) && parseInt(aube2) != (-1)) {erreur = true; erreurNuitAube3 = 'A noite est&aacute; desativada, por&eacute;m a madrugada n&atilde;o est&aacute;. ';}
			if(parseInt(crepuscule1) != (-1) && parseInt(crepuscule2) != (-1)) {erreur = true; erreurNuitCrepuscule3 = 'A noite est&aacute; desativada, por&eacute;m o anoitecer n&atilde;o est&aacute;. ';}
		}
		
		// Si l'aube est désactivé et que le crépuscule ne l'est pas ou si le crépuscule est activé et que l'aube ne l'est pas
		if(parseInt(aube1) == (-1) && parseInt(aube2) == (-1) && parseInt(crepuscule1) != (-1) && parseInt(crepuscule2) != (-1)) {erreur = true; erreurAubeCrepuscule3 = 'A madrugada est&aacute; desativada, por&eacute;m o anoitecer n&atilde;o est&aacute;. ';}
		if(parseInt(crepuscule1) == (-1) && parseInt(crepuscule2) == (-1) && parseInt(aube1) != (-1) && parseInt(aube2) != (-1)) {erreur = true; erreurCrepusculeAube3 = 'O anoitecer est&aacute; desativada, por&eacute;m a madrugada n&atilde;o est&aacute;. ';}
		...
		if(erreur == true) {
			...
			// Si la case allonger est cochée
			if(allonger) {checked = false;}
			else {checked = true;}
			
			window.setTimeout(function() {
				GM_setValue('allonger', checked);
...
//----- Icone Ressource Menu Déroulant ----
...
GM_addStyle('#ikartoption #aideOption {			z-index: 31; list-style-image:none; list-style-position:outside; list-style-type:none; background-color:#F1D7AD; border-color:#BE8D53; border-style:double; border-width:8px 3px 3px; color:#542C0F; display:none; font-size:11px; margin: auto -55px; top:270px; padding:4px 8px; position:absolute; white-space:nowrap; width:auto; max-width: 350px;	}');
GM_addStyle('#ikartoption #aideOption span {	z-index: 31; display:block; height:auto; left:0; width: auto; max-width: 350px; white-space:normal; float:left; overflow:auto; position:static;	}');
GM_addStyle('#ikartoption .ikartError {			padding-left: 10px; color: #f00f00; }');
GM_addStyle('#configIkart1, #configIkart2, #configIkart3 { cursor: pointer; }');
GM_addStyle('#configIkart2, #configIkart3 {		margin-left: 10px; display: inline-block; }');
