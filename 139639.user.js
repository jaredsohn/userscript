...
// @grant               GM_getValue
// @grant               GM_setValue
// @namespace      http://userscripts.org/users/57679
// @source             http://userscripts.org/scripts/show/139639
// @updateURL       https://userscripts.org/scripts/source/139639.meta.js
// @downloadURL   https://userscripts.org/scripts/source/139639.user.js
...
// @history            8.01 Fixed SenManga
// @history            8.02 Fixed Hotkeys blocking browser hotkeys, fixed batoto webtoon, adjust mangareader
// @history            8.03 Fixed MangaInn
// @history            8.04 Adjust Layout
// @history            8.05 Adjust Layout
// @history            8.06 Added MangaLyght
// @history            8.07 Fixed MangaChapter
// @history            8.08 Fixed MangaChapter
// @history            8.09 Fixed Fakku, added return link on the bottom
// @history            8.10 Added Update links
// @history            8.11 Fixed Starkana
// @history            8.12 Fixed SenManga Raw
// @history            8.13 Small tweak to FoOlSlide
// @history            8.14 Fixed SenManga Raw
// @history            8.15 Fixed Fufufuu
// @history            8.16 Fixed SenManga Raw and MangaDoom
// ==/UserScript==
...
(function (){
    ...
    function configCSS() {
        ...
        for (var i = 0; i < themes.length; i++) {
            ...
            css += '.' + themes[i][0] + ' .PageFunctions > span {background: none repeat scroll 0 0 ' + themes[i][4] + '; color: ' + themes[i][2] + ';}';
        ...
        return {
            ...
            page: function (i) {
                ...
                getHtml(self.url, function (html) {
                    addImg(i, $(html).find('img.mangaimg').attr('src'));
                    addAltImg(i, $(html).find('img.mangaimg').attr('onerror').match(/http:\/\/.*jpg/));
                    self.url = $(html).find("img.mangaimg").parent("a").attr("href");
                });
            }
        };
    }
    ...
    var Fufufuu = function () {
        return {
            ...
            series: "",
            quant: $(".m-page-jump option:visible").length,
            prev: "#",
            next: "#",
