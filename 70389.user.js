...
function init() {
	MoCheck.resourceBundle = {
		'dialog.closeAll.popup':'Close all window',
		'dialog.minimize.popup':'Minimize window',
		'dialog.close.popup':'Close window',
		'dialog.aktListInfo':'List: %1',

		'dialog.tab.work.titel':'Jobs',
		'dialog.tab.work.nothingSelected.1':'You not select any job!',
		'dialog.tab.work.nothingSelected.2':'Open need job and add it to list',
		'dialog.tab.work.tableHeader.work':'Work',
		'dialog.tab.work.tableHeader.points':'WP',
		...
		'dialog.tab.configuration.header':'Selecting lists',
		'dialog.tab.configuration.actual':'actual',
		'dialog.tab.configuration.btnLoad':'Load',
		'dialog.tab.configuration.btnDelete':'Deleteь',
		...
		'btnOk.label':'ОК',
		'btnAdd.popup':'Add job to list',
		'btnCenter.popup':'Map positions',
		'btnDelete.popup':'Delete from list',
	
		'message.error.unableToDeleteCurrentList':'Default list can not delete',
		'message.deleteList':'Delete list "%1"?',
		'message.newName':'New name:',
		'message.addedWork':'Work added',
		'message.deleteFromList':'Delete work "%1" from this list?',
		'message.listLoaded':'List "%1" loaded',
		'message.listDeleted':'List "%1" deleted',
		'message.listRenamed':'List renamed',
		'message.listCreated':'List created',
		'message.error.nameAlreadyDefined': 'This name already use'
	};
...
items=[];\
\
items[0] = {item_id:0, nshort:'nothing', name:'choke', type:'yield', level:0, price:0, image:'images/items/right_arm/clayjug.png', image_mini:'images/items/right_arm/mini/clayjug.png', characterClass:null, characterSex:null, speed:null, bonus:{skills:{}, attributes:{}}, set:{key:null, name:null}, shop:'nil'};\
\
items[1] = {item_id:1, nshort:'clayjug', name:'Broken clay jug', type:'right_arm', level:2, price:16, image:'images/items/right_arm/clayjug.png', image_mini:'images/items/right_arm/mini/clayjug.png', characterClass:null, characterSex:null, speed:null, bonus:{skills:{}, attributes:{}}, set:{key:null, name:null}, shop:'shop'};\
...
items[7] = {item_id:7, nshort:'rusty_razor', name:'Rusty razor blade', type:'right_arm', level:12, price:64, image:'images/items/right_arm/rusty_razor.png', image_mini:'images/items/right_arm/mini/rusty_razor.png', characterClass:null, characterSex:null, speed:null, bonus:{skills:{}, attributes:{}}, set:{key:null, name:null}, shop:'shop'};\
	...
	for(vv in bagazh.items){
		...
		if (!aWindow.bi2_uchet[tid]){
	    	...
	    	if (aWindow.items[tid]){
				...
				if (!cres.h)	{
					aWindow.einfo+='Part of data about an object is incorrect:\n';
					aWindow.assign_citem(tid, cobj);
					aWindow.einfo+=aWindow.print_citem(tid)+'\n';
				}
				else if(!cres.s){
					aWindow.winfo+='Wrong name of object:\n';
					aWindow.assign_citem(tid, cobj);
					aWindow.winfo+=aWindow.print_citem(tid)+'\n';
				}
			}
			else{
				aWindow.items[tid] = {item_id:tid, nshort:'nothing', name:'Choke', type:'yield', level:0, price:0, image:'images/items/right_arm/clayjug.png', image_mini:'images/items/right_arm/mini/clayjug.png', characterClass:null, characterSex:null, speed:null, bonus:{skills:{}, attributes:{}}, set:{key:null, name:null}, shop:'nil'};
				aWindow.assign_citem(tid, cobj);
				aWindow.einfo+='Description of object absents:\n';
				aWindow.einfo+=aWindow.print_citem(tid)+'\n';
			}
		}
    }
...
aWindow.bi2_res2html = function (){
    ...
    while (count_rab < 255){
        ...
        ihtm += '<span>Earnings:'+rres.dengi+'</span></td></tr></table></a>';
        ...
        ihtm += '<span>Experience:'+rres.opyt+'</span></td></tr></table></a>';
        ...
        ihtm += '<span>Luck:'+rres.vezenie+'</span></td></tr></table></a>';
        ...
        if ((count_rab<=101)||(count_rab>111)){
            ihtm += '<span title=\"Skill point\" class="calculation_visualisation img_plus" style=\"margin-left:0px;\">';
            ...
            ihtm += '<span title=\"Sets point\" class="calculation_visualisation img_plus" style=\"margin-left:0px;\">';
	    	ihtm += '<span class="skill_box_value green_text" style="text-align:center;">'+aWindow.resultaty[count_rab].ton+'</span></span>';
		    ihtm += '<span title=\"Work dificulty\" class="calculation_visualisation img_minus"  style=\"margin-left:0px;\">';
    		ihtm += '<span class="skill_box_value" style="text-align:center;">'+aWindow.raboty[count_rab].malus+'</span></span>';
	    	ihtm += '<span title=\"WP\" class="calculation_visualisation img_equal" style="margin-right:10px; margin-left:0px;">';
            ...
            ihtm += '<span title=\"Aim bonus\" class="calculation_visualisation img_plus" style=\"margin-left:0px;\">';
	...
	ihtm += '<tr><td><a href="javascript:bi2_auto_odev(\'n\','+count_rab+');void(0);" title="To get dressed" >';
	ihtm += '<img src="images/transparent.png" style="width :24px; height : 25px; background:url(../img.php?type=menu&dummy) -104px -51px" >';
	ihtm += '</a></td></tr>';
	ihtm += '<tr><td><a href="javascript:bi2_odev_add(\'n\','+count_rab+');void(0);" title="Save" >';
	ihtm += '<img src="images/transparent.png" style="width :24px; height : 25px; background:url(../img.php?type=menu&dummy) -104px -126px" >';
	ihtm += '</a></td></tr>';
	ihtm += '<tr><td><a href="javascript:bi2_odev_remove(\'n\','+count_rab+');void(0);" title="Delete" >';
	...
	for (ee = 0; ee < aWindow.bi2_types.length; ++ee){
		...
		ihtm += '<div style=\"display:inline; float:left;\"><table>';
		ihtm += '<tr><td><a href="javascript:bi2_auto_odev(\'z\','+count_rab+');void(0);" title="To get dressed" >';
		ihtm += '<img src="images/transparent.png" style="width :24px; height : 25px; background:url(../img.php?type=menu&dummy) -104px -51px" >';
		ihtm += '</a></td></tr>';
		ihtm += '<tr><td><a href="javascript:bi2_odev_add(\'z\','+count_rab+');void(0);" title="Save" >';
		ihtm += '<img src="images/transparent.png" style="width :24px; height : 25px; background:url(../img.php?type=menu&dummy) -104px -126px" >';
		ihtm += '</a></td></tr>';
		ihtm += '<tr><td><a href="javascript:bi2_odev_remove(\'z\','+count_rab+');void(0);" title="Delete" >';
		ihtm += '<img src="images/transparent.png" style="width :24px; height : 24px; background:url(../img.php?type=menu&dummy) -129px -101px" >';
		ihtm += '</a></td></tr>';
		ihtm += '</table></div>';
		...
		ihtm += '<div style=\"display:inline; float:left;\"><table>';
		ihtm += '<tr><td><a href="javascript:bi2_auto_odev(\'r\','+count_rab+');void(0);" title="To get dressed" >';
		ihtm += '<img src="images/transparent.png" style="width :24px; height : 25px; background:url(../img.php?type=menu&dummy) -104px -51px" >';
		ihtm += '</a></td></tr>';
		ihtm += '<tr><td><a href="javascript:bi2_odev_add(\'r\','+count_rab+');void(0);" title="Save" >';
		ihtm += '<img src="images/transparent.png" style="width :24px; height : 25px; background:url(../img.php?type=menu&dummy) -104px -126px" >';
		ihtm += '</a></td></tr>';
		ihtm += '<tr><td><a href="javascript:bi2_odev_remove(\'r\','+count_rab+');void(0);" title="Delete" >';
		ihtm += '<img src="images/transparent.png" style="width :24px; height : 24px; background:url(../img.php?type=menu&dummy) -129px -101px" >';
		ihtm += '</a></td></tr>';
		ihtm += '</table></div>';
...
aWindow.bi2_reporter2 = function(){
    ...
    grsort += '</td><strong>Sorting: </strong></td>';
    grsort += '<td style=\"width:10px; \" />';
    grsort += '<td style=\"width:2px; background-color:#321; padding: auto 3px;\" />';
    grsort += '<td><a href=\"javascript:bi2_sortir(\'name\', bi2_bezto);\">Title</a></td>';
    grsort += '<td style=\"width:2px; background-color:#321; padding: auto 3px;\" />';
    grsort += '<td><a href=\"javascript:bi2_sortir(\'malus\', bi2_bezto);\"><img style=\"width:23px; height:23px;\" src=\"images/task_points/minus.png\" title=\"Work dificulty\" /></a></td>';
    grsort += '<td style=\"width:2px; background-color:#321; padding: auto 3px;\" />';
    grsort += '<td><a href=\"javascript:bi2_sortir(\'to\', bi2_bezto);\"><img style=\"width:23px; height:23px;\" src=\"images/task_points/equal.png\" title=\"WP amount\" /></a></td>';
    grsort += '<td style=\"width:2px; background-color:#321; padding: auto 3px;\" />';
    grsort += '<td><a href=\"javascript:bi2_sortir(\'d0\', bi2_bezto);\"><img style=\"width:23px; height:23px;\" src=\"images/job/dollar.png\" title=\"Earnings\" /></a></td>';
    grsort += '<td style=\"width:2px; background-color:#321; padding: auto 3px;\" />';
    grsort += '<td><a href=\"javascript:bi2_sortir(\'o0\', bi2_bezto);\"><img style=\"width:23px; height:23px;\" src=\"images/job/experience.png\" title=\"Experience\" /></a></td>';
    grsort += '<td style=\"width:2px; background-color:#321; padding: auto 3px;\" />';
    grsort += '<td><a href=\"javascript:bi2_sortir(\'v0\', bi2_bezto);\"><img style=\"width:23px; height:23px;\" src=\"images/job/luck.png\" title=\"Luck\" /></a></td>';
    grsort += '<td style=\"width:2px; background-color:#321; padding: auto 3px;\" />';
    grsort += '<td><a href=\"javascript:bi2_sortir(\'boom\', bi2_bezto);\"><img style=\"width:23px; height:23px;\" src=\"images/job/danger.png\" title=\"Dangerous\" /></a></td>';
    grsort += '<td style=\"width:2px; background-color:#321; padding: auto 3px;\" />';
    grsort += '<td><a title=\"Earning and exp\" href=\"javascript:bi2_sortir(\'do\', bi2_bezto);\"><img style=\"width:23px; height:23px;\" src=\"images/job/dollar.png\" /><img style=\"width:23px; height:23px; margin-left:-5px;\" src=\"images/job/experience.png\" /></a></td>';
    grsort += '<td style=\"width:2px; background-color:#321; padding: auto 3px;\" />';
    grsort += '<td><a title=\"Earning and luck\" href=\"javascript:bi2_sortir(\'dv\', bi2_bezto);\"><img style=\"width:23px; height:23px;\" src=\"images/job/dollar.png\" /><img style=\"width:23px; height:23px; margin-left:-5px;\" src=\"images/job/luck.png\"" /></a></td>';
    grsort += '<td style=\"width:2px; background-color:#321; padding: auto 3px;\" />';
    grsort += '<td><a title=\"Exp and luck\" href=\"javascript:bi2_sortir(\'ov\', bi2_bezto);\"><img style=\"width:23px; height:23px;\" src=\"images/job/experience.png\" /><img style=\"width:23px; height:23px;\" src=\"images/job/luck.png\"" /></a></td>';
    grsort += '<td style=\"width:2px; background-color:#321; padding: auto 3px;\" />';
    grsort += '<td><a title=\"Earning, exp. and luck\" href=\"javascript:bi2_sortir(\'dov\', bi2_bezto);\"><img style=\"width:23px; height:23px;\" src=\"images/job/dollar.png\" /><img style=\"width:23px; height:23px; margin-left:-5px;\" src=\"images/job/experience.png\" /><img style=\"width:23px; height:23px;\" src=\"images/job/luck.png\"" /></a></td>';
    grsort += '<td style=\"width:2px; background-color:#321; padding: auto 3px;\" />';
...
aWindow.bi2_vreporter = function () {
    ...
    for (count_rab in aWindow.porabotaj){
        ...
        vrvr += '<span>Earning:'+rres.dengi+'</span></td></tr></table></a>';
        ...
        vrvr += '<span>Experience:'+rres.opyt+'</span></td></tr></table></a>';
        ...
        vrvr += '<span>Luck:'+rres.vezenie+'</span></td></tr></table></a>';
        ...
        vrvr += '<span>Dangerous:'+rres.boom+'</span></td></tr></table></a>';
...
bi2_rekurs_f = function (){\
    ...
    {\
        if (--rekurs_time <= 0){\
            ...
            rekurs_time = 20000;\
            ++rekurs_step;\
           	new HumanMessage('Surplus of things proceeds, step №'+rekurs_step, {type: 'success'});\
...
aWindow.bi2_error_window = function(err){
	...
	htm = '<hr><div style=\"font-weight:bold; color:black; text-align:center;\" >For filling of base of things these data need to be sent to the author of script<br />'; 
...
bi2_odev_add = function(va, irab){\
	if (va==='n')\
		...
		{rrab = resultaty_z[irab];index=raboty[irab].rus_name+'_(defence)'}\
	else if (va==='r')\
		{rrab = resultaty_r[irab];index=raboty[irab].rus_name+'_(movement)'}\
...
bi2_odev_remove = function(va, irab){\
	if (va==='n')\
		...
		{index=raboty[irab].rus_name+'_(defence)'}\
	else if (va==='r')\
		{index=raboty[irab].rus_name+'_(movement)'}\
...
bi2_odev_spam_option = function(){\
	...
	equip_select.innerHTML='<option value=\"0\">Saved sets</option>';\
	arra={};\
	jj=0;\
...
bi2_odev_spam_save = function(){\
	...
	if (bi2_odev_list[name]){\
		gu_gu = confirm('Rewrite list '+name+' ?');\
		if (!gu_gu) return;\
	}\
...
bi2_odev_spam = function(){\
	...
	store_set_link.setAttribute('title', 'Save current equipment as set');\
	store_set_link.setAttribute('onclick', 'bi2_odev_spam_save(); return false;');\
	store_set_link.textContent = 'Save  ';\
	...
	store_set_value.setAttribute('value',' - Set title -');\
	...
	store_rewrite_link.setAttribute('title', 'Change title of current set');\
	store_rewrite_link.setAttribute('onclick', 'bi2_odev_spam_rewrite(); return false;');\
	store_rewrite_link.textContent = '  Rename';\
	...
	delete_link.setAttribute('onclick', 'confirm (\"Delete set?\")?bi2_odev_spam_del():void(0); return false;');\
	...
	equip_link.textContent = 'To put on';\
...
bi2_odevalka = function(){\
	...
	if (ee >= bi2_types.length){\
		if (bi2_odev_stat) {document.getElementById('current_task').innerHTML='You got dressed!'}\
		else {document.getElementById('current_task').innerHTML='Devil! Again half undressed!'}\
		return;\
	}\
	if (bi2_odev_var==='n')\
...
aWindow.bi2_worker2 = function(schet){
	...
	if (!aWindow.bi2_inv_imported){
	    aWindow.bi2_iimport();
	    if (!aWindow.bi2_inv_imported){
	        new aWindow.HumanMessage('Need Backpack import before. Open and wait loading.<br />After full Backpack loading window can be minimize or close.');
	        aWindow.bi2_process=false;
	        return;
	    }
	}
...
aWindow.bi2_mulselect='<select title=\"Select of few works &mdash; with button Ctrl pressed\" class=\"bi2_sel\" multiple=\"multiple\" id=\"bi2_rabota\" size=\"6\" onchange=\"javascript:$(\'bi2_skol_rabot_n\').checked=true;\">';
aWindow.bi2_conselect='\
<option value=\"0\">	- Select work -	</option>\
<option value=\"101\">	Building of town/fort	</option>\
...
aWindow.bi2_show_shmot = function(irab){
    ...
    if (!bi2_shmot){
		...
		html2 += '<span>';
		html2 += '<a href=\"javascript:bi2_close_shmot();\"' + aWindow.bi2_tlink + ' title=\"Close\">*</a>';
		html2 += '</span>';
		html2 += '</div>'
...
aWindow.bi2_show_window = function(){
    ...
    if (!bi2_window){
		...
		html1 += '<span>';
		html1 += '<a href=\"javascript:bi2_minimize_window();\"' + aWindow.bi2_tlink + ' title=\"Minim\">&nbsp;_&nbsp;</a>&nbsp;';
...
var labor_points_text={en:'Labor points',cz:'Pracovni body',sk:'Pracovne body'};
var difficulty_text  ={en:'Difficulty',cz:'Obtiznost',sk:'Obtiaznost'};
...
function twpro_sortList(twpro_jobSortItem)
{
  ...
  {
    if(document.getElementById('twpro_wait').text == 'Reset')
    {
      document.getElementById('twpro_wait').text = 'Wait ...';
      ...
      document.getElementById('twpro_wait').text = 'Reset';
    }
    else
    {
      TWPro.twpro_jobs.sort(TWPro.twpro_sortJobs);
...
{
  if(TWPro.twpro_failure) return;
  $('twpro_jobsort_link_name').addMousePopup(new MousePopup('<b>by name</b>',100,{opacity:0.95}));
  $('twpro_jobsort_link_erfahrung').addMousePopup(new MousePopup('<b>by skill</b>',100,{opacity:0.95}));
  $('twpro_jobsort_link_lohn').addMousePopup(new MousePopup('<b>by loan</b>',100,{opacity:0.95}));
  $('twpro_jobsort_link_glueck').addMousePopup(new MousePopup('<b>by luck</b>',100,{opacity:0.95}));
...
{
  if(TWPro.twpro_failure) return;
  if(document.getElementById('twpro_wait').text != 'Wait...' && document.getElementById('twpro_wait').text != 'Reset')
  {
    document.getElementById('twpro_wait').text = 'Wait...';
...
function twpro_updateList()
{
  ...
  if(!TWPro.twpro_calculated)
  {
    ...
    TWPro.twpro_jobs[TWPro.twpro_jobs.length-1].name='Town construction';
...
footer_menu_left = document.getElementById('footer_menu_left');
  if (!footer_menu_left) { return; }
    ...
    addFooterIcon('javascript:if(Character.home_town != null) AjaxWindow.show(\'building_cityhall\',{town_id:Character.home_town.town_id},Character.home_town.town_id);','footer_building_cityhall','Town hall');
	...
	addFooterIcon('javascript:if(Character.home_town != null) ,{town_id:Character.home_town.town_id},Character.home_town.town_id);','footer_note','Notepad');
	addFooterIcon('javascript:bi2_show_panel();void(0)','bi2_footer_link','Сундучок');
	addFooterIcon('javascript:if(Character.home_town != null) AjaxWindow.show(\'fingerboard\',{town_id:Character.home_town.town_id},Character.home_town.town_id);','footer_finger','To town');
	addFooterIcon('javascript:MoCheck.openMotivationWindow(\'motivation\', \'work\')' ,'footer_motiv','Motivation');
}
