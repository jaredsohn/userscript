// ==UserScript==
// @name			Odin CRC
// @namespace		http://userscripts.org/users/466801
// @description		ODIN Compactador de Batallas 
// @version			0.1.1
// @author			eMyHeri
// @creator			eMyHeri
// @updateURL		http://userscripts.org/scripts/source/171560.meta.js
// @downloadURL		http://userscripts.org/scripts/source/171560.user.js
...
var SCRIPT = {
  name: "ODIN CRC"
  ,url: "http://Preguntaenlaali"
  ,version: "0.1.1"
  ,funciona_ok: "5.4.99.99"
  ,alianzaimg: "http://imagenes.we.bs/images/h1z5qlkpgdd6x2mu8jou.png"
  ,alianzatxt: "ODIN [ODIN]"
  ,alianzaurl: "http://uni120.ogame.com.es/game/allianceInfo.php?allianceId=96"
  ,jugadorimg: "http://imagenes.we.bs/images/rjs3wtcadvncwe8y6fxu.png"
  ,reciclaimg: "http://imagenes.we.bs/images/b6gpwc74xph0y7dx2mh.png"
  ,separadimg: "http://buddhism-for-vampires.com/images/b4v/resources_separator.gif"
};
...
function codificar(patron, tipo, version) {
    ...
    if(tipo == "HTML") {
        ...
        marcas = [
			[/{ODIN}/gi, '<a href="'+SCRIPT.alianzaurl+'" target="_ODIN" title="'+SCRIPT.alianzatxt+'"><img src="'+SCRIPT.alianzaimg+'" border=0 alt="'+SCRIPT.alianzatxt+'"></a>'],
			[/{ODIN_I}/gi, '<img src="'+SCRIPT.jugadorimg+'" border=0 alt="">'],
			[/{ODIN_R}/gi, '<img src="'+SCRIPT.reciclaimg+'" border=0 alt="">'],
			[/{ODIN_S}/gi, '<img src="'+SCRIPT.separadimg+'" border=0 alt="">'],
			[/{RECICLAJE}/gi, '</center><b>RECICLAJE:</b><br>&laquo;Comentario de lo reciclado aqui...&raquo;<center>'],
            [/{B}/gi, '<b>'],
            [/{\/B}/gi, '</b>'],
            [/{I}/gi, '<i>'],
            [/{\/I}/gi, '</i>'],
            ...
            [/{CENTER}/gi, '<center>'],
            [/{\/CENTER}/gi, '</center>'],
            [/{SIZE_PEQ}/gi, '<font style="font-size:9pt;">'],
    ...
    if(tipo == "OGame") {
        ...
        marcas = [
			[/{ODIN}/gi, '[url='+SCRIPT.alianzaurl+'][img]'+SCRIPT.alianzaimg+'[/img][/url]'],
			[/{ODIN_I}/gi, '[img]'+SCRIPT.jugadorimg+'[/img]'],
			[/{ODIN_R}/gi, '[img]'+SCRIPT.reciclaimg+'[/img]'],
			[/{ODIN_S}/gi, '[img]'+SCRIPT.separadimg+'[/img]'],
...
function getCuadrosBBCode(patron) {
   ...
   html += '<tr><td>'
   // foro ogame
   html += '<b><font color=#12EB24>Foro OGame: Pon Este</font></b><br>';
   ...
   html += '</td><td>'
   // foro phpBB
   html += '<b><font color=#FE3C2E>phpBBcolor-p-CC:</font></b><br>';
   ...
   html += '</td></tr><tr><td>'
   // foro phpBB3
   html += '<b><font color=#12EB24>Para CC-MP-s-color:</font></b><br>';
   html += '<textarea id="txtBB" name="txt_phpBB" style="background-color:#1F273C;width:200px;height:100px;border: 2px solid #FFFFFF;color:#FFFFFF" onFocus="javascript:this.select()">';
...
function compactar()  {
        ...
        if(numRondas == 1) {
			patron += '{SIZE_GRA}La batalla duró 1 ronda el día ' + getFecha() + '{/SIZE}{NL}';
        }
        else {
			patron += '{SIZE_GRA}La batalla duró ' + numRondas + ' rondas el día ' + getFecha() + '{/SIZE}{NL}';
        }
