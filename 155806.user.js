...
//Transform all instances of 'pony' in a string into 'ballsack'
function leopardize(str) {
	str = str.replace("pony", "ballsack")
	str = str.replace("ponies", "ballsacks")
	str = str.replace("Ponies", "Ballsacks")
  return str.replace("Pony", "Ballsack")
}
