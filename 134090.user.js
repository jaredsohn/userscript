// ==UserScript==
// @name                        douban_procrastination_helper_music_only
// @namespace              		douban_procrastination_helper_music_only
// @version                     1.1
// @author                      Mescoda on http://mescoda.com/
// @description              	http://userscripts.org/scripts/show/133988 的音乐版
// @include                     http://*.douban.com/*
// @require                     http://ajax.googleapis.com/ajax/libs/jquery/1.4.2/jquery.min.js
// @require						http://autoupdate.sinaapp.com/autoupdatehelper.js
// ==/UserScript==

typeof(Updater)!='undefined' && new Updater({name: "douban_procrastination_helper_music_only",id: "134090",version: "1.1"}).check();
