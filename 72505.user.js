...
var THISSCRIPTVERSION = "3.7.7";
var THISSCRIPTNAME = "Bandenprofil Deluxe  PG 4.0 Hamburg + Berlin + Muenchen";
var THISSCRIPTINSTALL_URL = 'http://userscripts.org/scripts/show/64195';          // URL für Hauptseite bei userscripts.org
var THISSCRIPTSOURCE_URL = 'http://userscripts.org/scripts/source/64195.user.js'; // Skript-URL bei userscripts.org
...
//				//newtr.setAttribute('class', 'tieritemA');
       ...
       newtd.innerHTML = "<u>Pennername</u>";
        newtd = newtr.appendChild(document.createElement('td'));
...
//		Tiere München		
		...
		else if(hausi2 == ''+statics+'shop/mu_DE/tiere/12536.jpg'){var petname  = "Nashorn [MU]";}	
...
//		Tierwerte Hamburg
		if(petname == 'Kakerlake'){var tiertooltip = '<font style=\"color:yellow; font-size:140%;\"><b>Kakerlake:</b></font><br><img src="'+statics+'shop/de_DE/tiere/00001.jpg" height="100" width="89"></img><br><u><b>Werte:</b></u><br>'+ATT+' 0 '+DEF+' 0 '+DEX+' 0 ';}
...
var suche = content.search("Ist gerade Online");
		try{
			...
			var online2a ="http://media.pennergame.de/img/off.gif";
