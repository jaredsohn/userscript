...
// ==UserScript==
// @name           FFWorkSpace
// @namespace      http://michd.net/gridempire
// @include        http://friendfeed.com/*
// ==/UserScript==
	var FFWorkSpace_version = "1.0";

	var defaultTabs = new Array();

	defaultTabs[0] = new Object();
	defaultTabs[0].name = "BrightKite";
	defaultTabs[0].url = "http://brightkite.com/";
	defaultTabs[0].favicon = "http://brightkite.com/favicon.ico";
	...
	defaultTabs[2].name = "Google Reader";
	defaultTabs[2].url = "http://google.com/reader";
	defaultTabs[2].favicon = "http://www.google.com/reader/ui/favicon.ico";
	defaultTabs[2].checked = "checked";

	defaultTabs[3] = new Object();
	defaultTabs[3].name = "HelloTxT";
	defaultTabs[3].url = "http://hellotxt.com/";
	defaultTabs[3].favicon = "http://hellotxt.com/favicon.ico";
	defaultTabs[3].checked = "checked";

	defaultTabs[4] = new Object();
	defaultTabs[4].name = "Identi.ca";
	defaultTabs[4].url = "http://identi.ca/";
	defaultTabs[4].favicon = "http://identi.ca/favicon.ico";
	defaultTabs[4].checked = "checked";

	defaultTabs[5] = new Object();
	defaultTabs[5].name = "Jaiku.com";
	defaultTabs[5].url = "http://jaiku.com/";
	defaultTabs[5].favicon = "http://jaiku.com/favicon.ico";
	defaultTabs[5].checked = "checked";

	defaultTabs[6] = new Object();
	defaultTabs[6].name = "Ping.Fm";
	defaultTabs[6].url = "http://ping.fm/dashboard/";
	defaultTabs[6].favicon = "http://ping.fm/favicon.ico";
	defaultTabs[6].checked = "checked";

	defaultTabs[7] = new Object();
	defaultTabs[7].name = "Plurk";
	defaultTabs[7].url = "http://plurk.com/m/";
	defaultTabs[7].favicon = "http://plurk.com/favicon.ico";
	defaultTabs[7].checked = "checked";

	defaultTabs[8] = new Object();
	defaultTabs[8].name = "Pownce";
	defaultTabs[8].url = "http://pownce.com/";
	defaultTabs[8].favicon = "http://pownce.com/img/favicon.ico";
	defaultTabs[8].checked = "checked";

	defaultTabs[9] = new Object();
	defaultTabs[9].name = "Twitter";
	defaultTabs[9].url = "http://twitter.com/";
	defaultTabs[9].favicon = "http://twitter.com/favicon.ico";
	defaultTabs[9].checked = "checked";
	
	defaultTabs[10] = new Object();
	defaultTabs[10].name = "Buzz";
	defaultTabs[10].url = "http://buzz.yahoo.com/";
	defaultTabs[10].favicon = "http://buzz.yahoo.com/favicon.ico";
	defaultTabs[10].checked = "checked";
	
	defaultTabs[11] = new Object();
	defaultTabs[11].name = "Delicious";
	defaultTabs[11].url = "http://del.icio.us/";
	defaultTabs[11].favicon = "http://del.icio.us/favicon.ico";
	defaultTabs[11].checked = "checked";

	defaultTabs[12] = new Object();
	defaultTabs[12].name = "Digg";
	defaultTabs[12].url = "http://digg.com/";
	defaultTabs[12].favicon = "http://digg.com/favicon.ico";
	defaultTabs[12].checked = "checked";

	defaultTabs[13] = new Object();
	defaultTabs[13].name = "Diigo";
	defaultTabs[13].url = "http://diigo.com/";
	defaultTabs[13].favicon = "http://diigo.com/favicon.ico";
	defaultTabs[13].checked = "checked";

	defaultTabs[14] = new Object();
	defaultTabs[14].name = "Mixx";
	defaultTabs[14].url = "http://mixx.com/";
	defaultTabs[14].favicon = "http://mixx.com/favicon.ico";
	defaultTabs[14].checked = "checked";

	defaultTabs[15] = new Object();
	defaultTabs[15].name = "Propeller";
	defaultTabs[15].url = "http://propeller.com/";
	defaultTabs[15].favicon = "http://propeller.com/favicon.ico";
	defaultTabs[15].checked = "checked";

	defaultTabs[16] = new Object();
	defaultTabs[16].name = "Reddit";
	defaultTabs[16].url = "http://reddit.com/";
	defaultTabs[16].favicon = "http://reddit.com/favicon.ico";
	defaultTabs[16].checked = "checked";

	defaultTabs[17] = new Object();
	defaultTabs[17].name = "StumbleUpon";
	defaultTabs[17].url = "http://stumbleupon.com/";
	defaultTabs[17].favicon = "http://stumbleupon.com/favicon.ico";
	defaultTabs[17].checked = "checked";

	defaultTabs[18] = new Object();
	defaultTabs[18].name = "Disqus";
	defaultTabs[18].url = "http://disqus.com/";
	defaultTabs[18].favicon = "http://media.disqus.com/images/dsq-favicon-16x16.ico";
	defaultTabs[18].checked = "checked";

	defaultTabs[19] = new Object();
	defaultTabs[19].name = "Facebook";
	defaultTabs[19].url = "http://facebook.com/";
	defaultTabs[19].favicon = "http://facebook.com/favicon.ico";
	defaultTabs[19].checked = "checked";

	defaultTabs[20] = new Object();
	defaultTabs[20].name = "LastFm";
	defaultTabs[20].url = "http://last.fm/";
	defaultTabs[20].favicon = "http://last.fm/favicon.ico";
	defaultTabs[20].checked = "checked";

	defaultTabs[21] = new Object();
	defaultTabs[21].name = "MySpace";
	defaultTabs[21].url = "http://myspace.com/";
	defaultTabs[21].favicon = "http://myspace.com/favicon.ico";
	defaultTabs[21].checked = "checked";

	defaultTabs[22] = new Object();
	defaultTabs[22].name = "Seesmic";
	defaultTabs[22].url = "http://seesmic.com/";
	defaultTabs[22].favicon = "http://seesmic.com/favicon.ico";
	defaultTabs[22].checked = "checked";

	defaultTabs[23] = new Object();
	defaultTabs[23].name = "UStream";
	defaultTabs[23].url = "http://ustream.tv/";
	defaultTabs[23].favicon = "http://ustream.tv/favicon.ico";
	defaultTabs[23].checked = "checked";

	defaultTabs[24] = new Object();
	defaultTabs[24].name = "Veoh";
	defaultTabs[24].url = "http://veoh.com/";
	defaultTabs[24].favicon = "http://veoh.com/favicon.ico";
	defaultTabs[24].checked = "checked";

	defaultTabs[25] = new Object();
	defaultTabs[25].name = "Vimeo";
	defaultTabs[25].url = "http://vimeo.com/";
	defaultTabs[25].favicon = "http://vimeo.com/favicon.ico";
	defaultTabs[25].checked = "checked";

	defaultTabs[26] = new Object();
	defaultTabs[26].name = "YouTube";
	defaultTabs[26].url = "http://youtube.com/";
	defaultTabs[26].favicon = "http://youtube.com/favicon.ico";
	defaultTabs[26].checked = "checked";
	...
	Settingsobject.prototype.get=function(name){
	  ...
	  if(value.indexOf("{b}")==0)
	    return !!parseInt(value.substr(26));
	  if(value.indexOf("{n}")==0)
	    return parseFloat(value.substr(26));
	...
	(function() {
	  ...
	  autoUpdateFromUserscriptsDotOrg({
		name: 'FFWorkSpace',
		url: 'http://userscripts.org/scripts/source/34101',
		version: FFWorkSpace_version,
	});	 	
	  ...
	  function showOptions() {	
		...
		if (div2==null)
		{
			...
			var text1="";
			text1+="<center><font size=\"+1\">FFWorkSpace</a> Options</font><br>By:&nbsp;<a href=\"http://gridempire.com\" target=\"_blank\">Grid Empire</a></center>";
	  ...
	  function tab_setup(name, url, favicon) {
		...
		$('.account').before('<td class="l_tab" style="padding-left: 3px;" id="tdtabtm"><div class="rounded bb" id="tabtm"><div class="t"><div class="l"><div class="r"><div class="tl"><div class="tr"><div class="body"><a id="tab-link-' + tabLink + '" href="#"><img width=16 height=16 src="' + favicon  + '"></a></div></div></div></div></div></div></div></td>');
		$('#tab-link-' + tabLink).click(function() {
				$('#subtabs').hide();
				$('#main').css("height","100%").html('<div class=iframe style="width:990px;height:880px;"><iframe id="content_iframe" marginWidth=0 marginHeight=0 src="' + url + '" frameBorder=0 style="width:990px;height:880px;overflow:auto;"></iframe></div>');
	  ...
	  function lets_jquery() {
		GM_registerMenuCommand('FFWorkSpace', showOptions);
