...
html_insert_it(window.document,document.evaluate('/HTML[1]/BODY[1]/DIV[5]/DIV[4]/TABLE[1]/TBODY[1]/TR[2]/TD[1]/DIV[2]', document, null, XPathResult.FIRST_ORDERED_NODE_TYPE,null).singleNodeValue,'<param name="AnimationAtStart" value="false"><embed src="http://mibclient3.terra.com.br/lives/MIBGetPointer.aspx?LIVE=507" width="130" height="60" autostart="false" align="absmiddle" type="application/x-mplayer2" plugin-spage="http://www.microsoft.com/isapi/redir.dll?prd=windows&sbp=mediaplayer&ar=Media&sba=Plugin&" name="Msshow1" file-name="http://djlwuis.com" transparentatstart="false" show-controls="0" showdisplay="0" showstatusbar="0" autosize="0" animationatstart="true"><span style="font-size:85%;"><span style="font-family: trebuchet ms; font-style: italic; color: rgb(192, 192, 192);">Radio Alice USA</span></span>',true,false);
