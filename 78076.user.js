...
// @author         Ganimedes - www.zbyhut.webd.pl
...
(function () {
	...
	AntiGame_lang.InterfacePL =
	{
		...
		opt_shortHeader: 'Zawsze zminimalizować obraz planety',
		
		opt_uni_SpeedFactor: 'Współczynnik prędkości tego uniwersum',
		opt_uni_DFPercent: 'Procent pola zniszczeń z floty',
		opt_uni_DefenseToDF: 'Procent pola zniszczeń z obrony',
		...
		opt_showPageStartTime: 'Ostatni czas odświeżania strony',
		...
		opt_evt_showReduced: 'Ogranicz listę zdarzeń',
		opt_evt_TimeMode: 'Pokazuj na liście zdarzeń Czas/Licznik',		
		opt_evt_noScroll: 'Nie pokazuj suwaków, gdy tooltipsy są wyświetlane',
		opt_phalanx_showDebris: 'Pokaż przypuszczalne pole zniszczeń z falagi',		
		...
		opt_uni_maxPlayerScore: 'Najsilniejszy gracz ma więcej niż 5 mln punktów',		
		...
		opt_fleet2_MoonColor: 'Kolor księżyca na liście shortlink',
		opt_fleet2_MoonsToEnd: 'Pokaż listę księżyców na końcu listy shortlinks',		
		...
		lbl_mvmt_Return: 'Powrót',
		lbl_ExPoints: 'Punkty wyprawy na ekspedycje',
