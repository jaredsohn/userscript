// ==UserScript==
// @name 		Travian v3 Village Overview Extension
// @description This script provides a more informative overview of your villages (Plus account only)
// @namespace 	http://www.nerocode.com/travian3/frozzmod
// @source 		http://cdn.nerocode.com/files/travian3/frozzmod
// @identifier 	http://cdn.nerocode.com/files/travian3/frozzmod/t3-frozzmod.user.js
// @version 	0.01
...
function processDorf3OverviewAttacksInfo()
{
	...
	for (var i = 0; i < snapAttClasses.snapshotLength; i++)
	{
		...
		for (var j = 0; j < snapHrefs.snapshotLength; j++)
		{
			...
			var title = arrImg[0].getAttribute("title");
