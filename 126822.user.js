...
West on the screen
Icons buildings in the city
Additional menu items
Best Items by PK & S Luchshie_veschi - ver3
The West - Center Jobs
Script Motivation (py version).
...
// ==UserScript==
// @name           tw_my_english_version
// @namespace      www.the-west.ru
// @description    Script tw_my(http://userscripts.org/scripts/review/82472) - english version by mcolla7
// @description    West on the screen, icons of the city buildings, additional menu items, shopping at the market, Luchshie_veschi - ver3
// @description	   Translation: mcolla7 for Beta World
// @include        http://*.the-west.*
// @include        http://*.beta.the-west.*
// @include        http://zz1w1.tw.innogames.net/game.php*
// @include        http://212.72.191.95/game.php*
...
//  }
  ...
  ForumSkripts_link.innerHTML = '<a id=\"TWF_ForumSkripts_link\" title=\"Forum: Scripts for the West\" href="http://forum.the-west.ru/showthread.php?t=9703" target="_blank"></a>';
  ...
  PKSkripts_link.innerHTML = '<a id=\"TWF_PKSkripts_link\" title=\"Update build scripts from: PorosyachiyKot\" href="http://userscripts.org/scripts/show/82472" target="_blank"></a>';
...
add_link_button = function (){
	...
	addFooterIcon('javascript:if(Character.home_town != null) Trader.open(\'gunsmith\', Character.home_town.town_id);','footer_building_gunsmith','Gunsmith');
	addFooterIcon('javascript:if(Character.home_town != null) Trader.open(\'tailor\', Character.home_town.town_id)','footer_building_tailor','Tailor');
	addFooterIcon('javascript:if(Character.home_town != null) Trader.open(\'general\', Character.home_town.town_id);','footer_building_general','General Store');
	...
	addFooterIcon('javascript:if(Character.home_town != null) ChurchWindow.open(Character.home_town.town_id);','footer_building_church','Church');
	addFooterIcon('javascript:if(Character.home_town != null) MorticianWindow.open(Character.home_town.town_id);','footer_building_mortician','Mortician');
	addFooterIcon('javascript:if(Character.home_town != null) CityhallWindow.open(Character.home_town.town_id);','footer_building_cityhall','City Hall');
	...
	addFooterIcon('javascript:if(Character.home_town != null) MarketWindow.open(Character.home_town.town_id, 10)','footer_building_market','Market');
	addFooterIcon('javascript:if(Character.home_town != null) AjaxWindow.show(\'building_sheriff\',{town_id:Character.home_town.town_id},Character.home_town.town_id);','footer_building_sheriff','Sheriff');
        addFooterIcon('javascript:Trader.open(\'item_trader\');','footer_building_trader','Trader');
        addFooterIcon('javascript:CharacterWindow.open();CharacterWindow.showTab(\'crafting\');','footer_building_Crafting','Crafting');
        addFooterIcon('javascript:dyMarketHelper.calculate();','footer_building_TradeMarket','Shopping at the market');
...
MoCheck.setAktListe = function(listenName) {
	listenName = $defined(listenName) ? listenName : 'by default';
...
MoCheck.addJobRow = function(job, index) {
	...
	for (var ii = 0; ii < PK_S3.cookies.save.length; ++ii){
		...
		td_insert ='<td>' +
		    '<div class="startWork task_control" style="margin:0 10px 0 0; padding:5px 0 0 0; width:100px; white-space:nowrap; float:right;" title="Dress up the saved set">' +
		    '<span>' +
...
// === menu "Motivation" ===
  ...
  moBtn.id="moBtn";
  moBtn.innerHTML = '<a id=\"TWF_moBtn\" title=\"Open the window Motivations\" href="javascript:MoCheck.openMotivationWindow(\'motivation\', \'work\');"></a>';
...
//			 '      </ul>';
	...
	//xhtml += '    					<div id="mojob.tab.1.div">';
										if(MoCheck.aktJobs.length <= 0) {
											...
											xhtml += '<a href="#" onClick="PK_S3.equip_add3()" style="padding:0px 5px; font-size:11px;">Wear</a>';
...
//			 '									<li>Ability to create a list of works suitable for you</li>' +
//			 '									<li>Send your character to work a mouse, without a long search</li>' +
//			 '									<li>Classification by the experience, motivation, earnings, and good luck</li>' +
//			 '								</ul>';
//	xhtml += '    						</div>';
//	xhtml += '    						<div style="float:left;">';
//	xhtml += '    							Learn more and skacht script you can here: <br />';
//	xhtml += '    							<a href="http://userscripts.org/scripts/show/63326" target="_blank">http://userscripts.org/scripts/show/63326</a>';
//	xhtml += '    							<br>Russian version: <br />';
...
//		'author':'translator: <b>Enfo</b>. author:'
	};	
...
menu_pk_s3.innerHTML = '<a id=\"_menu_pk_s3\" title=\"Open the Preferences window, trunk pereodevalki\" href=\"javascript:PK_S3.show_window_settings(false);void(0);\"></a>';
...
PK_S3.init = function(){
    ...
    PK_S3.types_name = ['Belt', 'Clothes', 'Shoes', 'Headdress', 'neck band', 'pants', 'mount', 'Dueling weapons', 'Fort weapons', 'products'];
...
PK_S3.items[4] = {item_id:4, nshort:'rotty_club', name:'rotten club', type:'right_arm', level:7, price:26, image:'/images/items/right_arm/rotty_club.png?1', image_mini:'/images/items/right_arm/mini/rotty_club.png?1', set:{}, traderlevel:2, auctionable:true, dropable:true, tradeable:true, sellable:true, damage:{damage_min:3, damage_max:9}, sub_type:'hand'};
    ...
    PK_S3.items[140] = {item_id:140, nshort:'collector_rifle', name:'Ружьё Плюшкина', type:'left_arm', level:100, price:10000, image:'/images/items/left_arm/collector_rifle.png?1', image_mini:'/images/items/left_arm/mini/collector_rifle.png?1', bonus:{skills:{repair:15, health:15}, attributes:{charisma:2, dexterity:2, flexibility:2, strength:2}}, set:{key:'collector_set', name:'Набор коллекционера'}, traderlevel:100, tradeable:true, damage:{damage_min:100, damage_max:300}};
...
PK_S3.items[506] = {item_id:506, nshort:'neckband_black', name:'Чёрный шарф', type:'neck', level:0, price:20, image:'/images/items/neck/neckband_black.png?1', image_mini:'images/items/neck/neckband_black.png?1', bonus:{skills:{swim:2, tactic:1, shot:1}}, set:{}, traderlevel:1, auctionable:true, dropable:true, tradeable:true, sellable:true};
    ...
    PK_S3.items[571] = {item_id:571, nshort:'geronimo_headband', name:'Бандана Джеронимо', type:'head', level:1, price:100, image:'/images/items/head/geronimo_headband.png?1', image_mini:'/images/items/head/mini/geronimo_headband.png?1', bonus:{skills:{tactic:10, leadership:10, health:10}}, set:{}, traderlevel:66, tradeable:true};
...
PK_S3.items[1709] = {item_id:1709, nshort:'gold', name:'Сокровища индейцев', type:'yield', level:0, price:26000, image:'/images/items/yield/gold.png?1', image_mini:'images/items/yield/gold.png?1', set:{}, auctionable:true, sellable:true};
...
PK_S3.items[1750] = {item_id:1750, nshort:'ponytail', name:'Коса',  type:'yield', level:0, price:66,  image:'/images/items/yield/ponytail.png?1',  image_mini:'images/items/yield/ponytail.png?1',  characterSex:null,  set:{key:null, name:null}, sellable:true};
...
PK_S3.items[1790] = {item_id:1790, nshort:'treeboat', name:'Выдолбленный ствол дерева', type:'yield', level:0, price:50, image:'/images/items/yield/treeboat.png?1', image_mini:'images/items/yield/treeboat.png?1', set:{}};
    ...
    PK_S3.items[1792] = {item_id:1792, nshort:'goldnugget', name:'Золото', type:'yield', level:0, price:5000, image:'/images/items/yield/goldnugget.png?1', image_mini:'images/items/yield/goldnugget.png?1', set:{}, auctionable:true, sellable:true};
    ...
    PK_S3.items[1807] = {item_id:1807, nshort:'sock', name:'Носок', type:'yield', level:0, price:0, image:'/images/items/yield/sock.png?1', image_mini:'images/items/yield/sock.png?1', set:{}, auctionable:true, sellable:true};
...
PK_S3.items[1892] = {item_id:1892, nshort:'fruitlicor', name:'Фруктовый ликёр', type:'yield', level:0, price:124, image:'/images/items/yield/fruitlicor.png?1', image_mini:'images/items/yield/fruitlicor.png?1', set:{}, auctionable:true, sellable:true};
    ...
    PK_S3.items[1894] = {item_id:1894, nshort:'lye', name:'Щёлок', type:'yield', level:0, price:139, image:'/images/items/yield/lye.png?1', image_mini:'images/items/yield/lye.png?1', set:{}, sellable:true};
...
PK_S3.items[1952] = {item_id:1952, nshort:'foodsac', name:'Мешок с зерном', type:'yield', level:0, price:50, image:'/images/items/yield/foodsac.png?1', image_mini:'images/items/yield/foodsac.png?1', set:{}, auctionable:true, sellable:true};
    ...
    PK_S3.items[1990] = {item_id:1990, nshort:'silvered_flask', name:'Hip flask', type:'yield', level:0, price:618, image:'/images/items/yield/silvered_flask.png?1', image_mini:'images/items/yield/silvered_flask.png?1', set:{}, auctionable:true, sellable:true};
    PK_S3.items[1991] = {item_id:1991, nshort:'modern_armor', name:'Modern armor', type:'yield', level:0, price:436, image:'/images/items/yield/modern_armor.png?1', image_mini:'images/items/yield/modern_armor.png?1', set:{}, auctionable:true, sellable:true};
...
PK_S3.items[10005] = {item_id:10005, nshort:'shredded_black', name:'Чёрные рваные штаны', type:'pants', level:3, price:95, image:'/images/items/pants/shredded_black.png?1', image_mini:'/images/items/pants/mini/shredded_black.png?1', bonus:{skills:{pitfall:1, endurance:1}, attributes:{strength:1}}, set:{}, traderlevel:1, auctionable:true, dropable:true, tradeable:true, sellable:true};
    ...
    PK_S3.items[10150] = {item_id:10150, nshort:'collector_pants', name:'Штаны Плюшкина', type:'pants', level:100, price:10000, image:'/images/items/pants/collector_pants.png?1', image_mini:'/images/items/pants/mini/collector_pants.png?1', bonus:{skills:{leadership:15, dodge:15}, attributes:{charisma:2, dexterity:2, flexibility:2, strength:2}}, set:{key:'collector_set', name:'Набор коллекционера'}, traderlevel:99, dropable:true, tradeable:true};
...
PK_S3.items[11003] = {item_id:11003, nshort:'cotton_green', name:'Зелёный шерстяной пояс', type:'belt', level:3, price:45, image:'/images/items/belt/cotton_green.png?1', image_mini:'/images/items/belt/mini/cotton_green.png?1', bonus:{skills:{repair:1, tough:1, build:1}}, set:{}, traderlevel:1, auctionable:true, dropable:true, tradeable:true, sellable:true};
    ...
    PK_S3.items[11020] = {item_id:11020, nshort:'fine_grey_belt', name:'Серый ремень', type:'belt', level:12, price:210, image:'/images/items/belt/fine_grey_belt.png?1', image_mini:'/images/items/belt/mini/fine_grey_belt.png?1', bonus:{skills:{tough:7}}, set:{}, traderlevel:3, auctionable:true, dropable:true, tradeable:true, sellable:true};
    ...
    PK_S3.items[11118] = {item_id:11118, nshort:'greenhorn_belt', name:'Кожаный ремень', type:'belt', level:4, price:375, image:'/images/items/belt/greenhorn_belt.png?1', image_mini:'/images/items/belt/mini/greenhorn_belt.png?1', bonus:{skills:{leadership:2, shot:3, build:3}}, set:{key:'greenhorn_set', name:'Набор чечако'}, sellable:true};
...
PK_S3.items[12710] = {item_id:12710, nshort:'xmas_present_mid', name:'Красивый подарок', type:'yield', level:0, price:39, image:'/images/items/yield/xmas_present_mid.png?1', image_mini:'images/items/yield/xmas_present_mid.png?1', set:{}, auctionable:true, sellable:true};
    ...
    PK_S3.raboty[1] = {rus_name:'Tending pigs', name:'swine', malus:2, navyki:{tough:1,endurance:1,leadership:1,animal:2}, resultaty:{dengi:3, opyt:1, vezenie:0, boom:1, produkty:{700:20}}};
    PK_S3.raboty[2] = {rus_name:'Scare birds off the field', name:'scarecrow', malus:1, navyki:{build:1,shot:1,pitfall:1,tactic:1,animal:1}, resultaty:{dengi:1, opyt:3, vezenie:2, boom:20, produkty:{757:20}}};
    PK_S3.raboty[3] = {rus_name:'putting up posters', name:'wanted', malus:1, navyki:{endurance:1,ride:1,hide:1,finger_dexterity:1,pitfall:1}, resultaty:{dengi:2, opyt:3, vezenie:0, boom:10, produkty:{743:40}}};
    PK_S3.raboty[4] = {rus_name:'Picking tobacco', name:'tabacco', malus:1, navyki:{tough:1,finger_dexterity:2,tactic:1,trade:1}, resultaty:{dengi:6, opyt:1, vezenie:2, boom:2, produkty:{702:100}}};
    PK_S3.raboty[5] = {rus_name:'Picking Cotton', name:'cotton', malus:2, navyki:{tough:1,endurance:1,finger_dexterity:1,leadership:1,trade:1}, resultaty:{dengi:1, opyt:4, vezenie:0, boom:3, produkty:{704:50}}};
    PK_S3.raboty[6] = {rus_name:'Picking sugar cane', name:'sugar', malus:4, navyki:{punch:1,tough:1,finger_dexterity:1,repair:1,trade:1}, resultaty:{dengi:5, opyt:2, vezenie:4, boom:1, produkty:{703:100}}};
    PK_S3.raboty[7] = {rus_name:'Stream fishing', name:'angle', malus:3, navyki:{hide:1,swim:3,repair:1}, resultaty:{dengi:1, opyt:0, vezenie:6, boom:2, produkty:{705:60, 782:3}}};
    PK_S3.raboty[8] = {rus_name:'Harvest fields', name:'cereal', malus:11, navyki:{punch:1,tough:1,endurance:1,ride:1,finger_dexterity:1}, resultaty:{dengi:2, opyt:6, vezenie:2, boom:4, produkty:{701:55}}};
    PK_S3.raboty[9] = {rus_name:'Picking berries', name:'berry', malus:16, navyki:{tough:2,hide:1,finger_dexterity:2}, resultaty:{dengi:2, opyt:6, vezenie:5, boom:6, produkty:{706:45}}};
    PK_S3.raboty[10] = {rus_name:'Tending sheeps', name:'sheeps', malus:12, navyki:{tough:1,endurance:1,leadership:1,animal:2}, resultaty:{dengi:3, opyt:5, vezenie:0, boom:2, produkty:{707:25}}};
    PK_S3.raboty[11] = {rus_name:'Selling Newspaper The Western Star', name:'newspaper', malus:9, navyki:{ride:2,trade:2,appearance:1}, resultaty:{dengi:6, opyt:1, vezenie:2, boom:1, produkty:{744:60}}};
    PK_S3.raboty[12] = {rus_name:'Mow Pasture', name:'cut', malus:22, navyki:{punch:1,ride:1,finger_dexterity:1,animal:2}, resultaty:{dengi:5, opyt:7, vezenie:3, boom:3, produkty:{765:5}}};
    PK_S3.raboty[13] = {rus_name:'Milling grains', name:'grinding', malus:25, navyki:{punch:1,tough:1,endurance:1,ride:1,finger_dexterity:1}, resultaty:{dengi:11, opyt:7, vezenie:0, boom:5, produkty:{745:40}}};
    PK_S3.raboty[14] = {rus_name:'Picking corn', name:'corn', malus:23, navyki:{finger_dexterity:1,tactic:1,trade:1,animal:1,appearance:1}, resultaty:{dengi:4, opyt:7, vezenie:8, boom:5, produkty:{748:25}}};
    PK_S3.raboty[15] = {rus_name:'Picking beans', name:'beans', malus:23, navyki:{endurance:1,finger_dexterity:1,leadership:1,tactic:1,animal:1}, resultaty:{dengi:9, opyt:7, vezenie:4, boom:5, produkty:{746:40}}};
    PK_S3.raboty[16] = {rus_name:'Guard the Fort', name:'fort_guard', malus:25, navyki:{reflex:1,shot:1,leadership:1,appearance:2}, resultaty:{dengi:3, opyt:9, vezenie:2, boom:7, produkty:{758:2}}};
    PK_S3.raboty[17] = {rus_name:'tanning deer skin', name:'tanning', malus:40, navyki:{tough:1,endurance:1,swim:1,finger_dexterity:1,trade:1}, resultaty:{dengi:12, opyt:15, vezenie:5, boom:18, produkty:{712:15}}};
    PK_S3.raboty[18] = {rus_name:'Prospecting', name:'digging', malus:31, navyki:{tough:1,reflex:1,swim:1,trade:2}, resultaty:{dengi:11, opyt:3, vezenie:5, boom:7, produkty:{708:17, 1791:1}}};
    PK_S3.raboty[19] = {rus_name:'Digging graves', name:'grave', malus:76, navyki:{build:1,punch:1,tough:1,endurance:1,ride:1}, resultaty:{dengi:16, opyt:12, vezenie:22, boom:9, produkty:{736:8}}};
    PK_S3.raboty[20] = {rus_name:'Hunting turkey', name:'turkey', malus:43, navyki:{reflex:1,hide:2,shot:1,pitfall:1}, resultaty:{dengi:3, opyt:14, vezenie:7, boom:21, produkty:{709:13}}};
    PK_S3.raboty[21] = {rus_name:'Laying railroad tracks', name:'rail', malus:45, navyki:{build:2,endurance:1,repair:1,leadership:1}, resultaty:{dengi:10, opyt:18, vezenie:5, boom:10, produkty:{766:25}}};
    PK_S3.raboty[22] = {rus_name:'Cowboy', name:'cow', malus:39, navyki:{ride:2,reflex:1,tactic:1,animal:1}, resultaty:{dengi:5, opyt:17, vezenie:0, boom:11, produkty:{710:15}}};
    PK_S3.raboty[23] = {rus_name:'Repair of the fence', name:'fence', malus:36, navyki:{finger_dexterity:1,repair:2,animal:2}, resultaty:{dengi:7, opyt:11, vezenie:5, boom:6, produkty:{747:11}}};
    PK_S3.raboty[24] = {rus_name:'Sawing wood', name:'saw', malus:64, navyki:{reflex:2,finger_dexterity:2,trade:1}, resultaty:{dengi:23, opyt:12, vezenie:6, boom:32, produkty:{742:10}}};
    PK_S3.raboty[25] = {rus_name:'Granite mining', name:'stone', malus:53, navyki:{punch:3,endurance:1,reflex:1}, resultaty:{dengi:17, opyt:8, vezenie:9, boom:33, produkty:{716:22}}};
    PK_S3.raboty[26] = {rus_name:'Straightening the River', name:'straighten', malus:85, navyki:{build:1,swim:3,tactic:1}, resultaty:{dengi:8, opyt:22, vezenie:15, boom:12, produkty:{795:5}}};
    PK_S3.raboty[27] = {rus_name:'Feeling trees', name:'wood', malus:48, navyki:{punch:2,endurance:1,reflex:1,appearance:1}, resultaty:{dengi:18, opyt:5, vezenie:2, boom:21, produkty:{711:25}}};
    PK_S3.raboty[28] = {rus_name:'Build irrigation system', name:'irrigation', malus:45, navyki:{build:1,ride:1,repair:1,leadership:1,tactic:1}, resultaty:{dengi:7, opyt:13, vezenie:15, boom:6, produkty:{736:6}}};
    PK_S3.raboty[29] = {rus_name:'Branding cattle', name:'brand', malus:50, navyki:{ride:1,reflex:1,pitfall:1,animal:2}, resultaty:{dengi:8, opyt:25, vezenie:0, boom:35, produkty:{740:13}}};
    PK_S3.raboty[30] = {rus_name:'Installing a barbed wire', name:'wire', malus:58, navyki:{build:1,finger_dexterity:2,pitfall:1,animal:1}, resultaty:{dengi:17, opyt:13, vezenie:6, boom:0, produkty:{739:10}}};
    PK_S3.raboty[31] = {rus_name:'Demolishing the dam', name:'dam', malus:54, navyki:{swim:2,tactic:2,animal:1}, resultaty:{dengi:4, opyt:18, vezenie:9, boom:41, produkty:{714:5}}};
    PK_S3.raboty[32] = {rus_name:'Searching for semi-precious stones', name:'gems', malus:75, navyki:{swim:2,finger_dexterity:1,trade:2}, resultaty:{dengi:25, opyt:7, vezenie:8, boom:4, produkty:{720:8}}};
    PK_S3.raboty[33] = {rus_name:'Carving out claims', name:'claim', malus:57, navyki:{build:1,endurance:1,swim:1,trade:1,appearance:1}, resultaty:{dengi:31, opyt:4, vezenie:4, boom:29, produkty:{755:25}}};
    PK_S3.raboty[34] = {rus_name:'Repairing a covered wagon', name:'chuck_wagon', malus:134, navyki:{ride:1,repair:2,leadership:1,trade:1}, resultaty:{dengi:5, opyt:23, vezenie:42, boom:11, produkty:{722:15}}};
    PK_S3.raboty[35] = {rus_name:'Breaking in horses', name:'break_in', malus:72, navyki:{ride:2,reflex:1,pitfall:1,animal:1}, resultaty:{dengi:13, opyt:32, vezenie:10, boom:52, produkty:{787:5}}};
    PK_S3.raboty[36] = {rus_name:'Trading', name:'trade', malus:85, navyki:{pitfall:1,trade:2,appearance:2}, resultaty:{dengi:15, opyt:3, vezenie:25, boom:12, produkty:{715:13, 774:1}}};
    PK_S3.raboty[37] = {rus_name:'Setting up telegraph poles', name:'mast', malus:75, navyki:{build:2,punch:1,swim:1,repair:1}, resultaty:{dengi:21, opyt:25, vezenie:3, boom:14, produkty:{767:14}}};
    PK_S3.raboty[38] = {rus_name:'Well drilling', name:'spring', malus:103, navyki:{build:1,endurance:1,swim:1,leadership:1,tactic:1}, resultaty:{dengi:9, opyt:33, vezenie:23, boom:19, produkty:{741:10}}};
    PK_S3.raboty[39] = {rus_name:'Beaver hunt', name:'beaver', malus:120, navyki:{hide:2,pitfall:3}, resultaty:{dengi:32, opyt:17, vezenie:6, boom:21, produkty:{714:17, 771:13}}};
    PK_S3.raboty[40] = {rus_name:'Coal mining', name:'coal', malus:86, navyki:{punch:2,reflex:1,finger_dexterity:1,trade:1}, resultaty:{dengi:30, opyt:14, vezenie:0, boom:13, produkty:{721:37}}};
    PK_S3.raboty[41] = {rus_name:'Printing newspaper The Western Star', name:'print', malus:83, navyki:{tough:1,endurance:1,finger_dexterity:1,repair:1,leadership:1}, resultaty:{dengi:30, opyt:20, vezenie:5, boom:7, produkty:{744:40}}};
    PK_S3.raboty[42] = {rus_name:'River fishing', name:'fishing', malus:91, navyki:{swim:2,pitfall:2,leadership:1}, resultaty:{dengi:6, opyt:23, vezenie:23, boom:38, produkty:{717:15, 705:5}}};
    PK_S3.raboty[43] = {rus_name:'Build railroad station', name:'trainstation', malus:113, navyki:{build:2,finger_dexterity:1,repair:1,leadership:1}, resultaty:{dengi:12, opyt:47, vezenie:7, boom:15, produkty:{759:7}}};
    PK_S3.raboty[44] = {rus_name:'Building windmills', name:'windmeel', malus:164, navyki:{build:1,endurance:1,ride:1,leadership:1,tactic:1}, resultaty:{dengi:42, opyt:43, vezenie:6, boom:18, produkty:{756:5}}};
    PK_S3.raboty[45] = {rus_name:'Exploration', name:'explore', malus:112, navyki:{endurance:1,shot:1,ride:1,swim:1,leadership:1}, resultaty:{dengi:1, opyt:45, vezenie:22, boom:37, produkty:{760:15}}};
    PK_S3.raboty[46] = {rus_name:'Rafting wood', name:'float', malus:138, navyki:{reflex:1,swim:3,tactic:1}, resultaty:{dengi:23, opyt:45, vezenie:0, boom:52, produkty:{711:30}}};
    PK_S3.raboty[47] = {rus_name:'Building a bridge', name:'bridge', malus:108, navyki:{build:1,endurance:1,swim:2,repair:1}, resultaty:{dengi:17, opyt:33, vezenie:18, boom:53, produkty:{761:8}}};
    PK_S3.raboty[48] = {rus_name:'Catching horses', name:'springe', malus:135, navyki:{endurance:1,ride:2,animal:2}, resultaty:{dengi:29, opyt:45, vezenie:0, boom:42, produkty:{749:22}}};
    PK_S3.raboty[49] = {rus_name:'Building coffins', name:'coffin', malus:119, navyki:{build:1,reflex:1,repair:2,appearance:1}, resultaty:{dengi:42, opyt:8, vezenie:15, boom:20, produkty:{734:25}}};
    PK_S3.raboty[50] = {rus_name:'Transport ammunition', name:'dynamite', malus:145, navyki:{ride:1,reflex:1,shot:1,finger_dexterity:1,appearance:1}, resultaty:{dengi:23, opyt:12, vezenie:64, boom:93, produkty:{737:5}}};
    PK_S3.raboty[51] = {rus_name:'Hunting coyotes', name:'coyote', malus:141, navyki:{endurance:2,shot:1,pitfall:1,hide:1}, resultaty:{dengi:15, opyt:43, vezenie:26, boom:45, produkty:{718:6}}};
    PK_S3.raboty[52] = {rus_name:'Hunting buffalo', name:'buffalo', malus:179, navyki:{ride:1,pitfall:1,leadership:1,tactic:1,animal:1}, resultaty:{dengi:24, opyt:62, vezenie:0, boom:72, produkty:{724:14}}};
    PK_S3.raboty[53] = {rus_name:'Construct manor-house', name:'fort', malus:225, navyki:{build:1,pitfall:1,repair:1,leadership:2}, resultaty:{dengi:33, opyt:71, vezenie:17, boom:35, produkty:{762:3}}};
    PK_S3.raboty[54] = {rus_name:'Trading with Indians', name:'indians', malus:224, navyki:{pitfall:1,trade:2,appearance:2}, resultaty:{dengi:11, opyt:14, vezenie:63, boom:34, produkty:{719:13}}};
    PK_S3.raboty[55] = {rus_name:'Clearing the forest', name:'clearing', malus:179, navyki:{punch:2,reflex:1,leadership:1,tactic:1}, resultaty:{dengi:62, opyt:8, vezenie:9, boom:16, produkty:{711:65}}};
    PK_S3.raboty[56] = {rus_name:'Silver Mining', name:'silver', malus:194, navyki:{punch:1,tough:1,finger_dexterity:1,trade:2}, resultaty:{dengi:76, opyt:8, vezenie:0, boom:32, produkty:{725:17}}};
    PK_S3.raboty[57] = {rus_name:'Guarding the stage coach', name:'diligence_guard', malus:404, navyki:{ride:1,shot:1,repair:1,leadership:2}, resultaty:{dengi:34, opyt:77, vezenie:45, boom:43, produkty:{780:12}}};
    PK_S3.raboty[58] = {rus_name:'Hunting wolves', name:'wolf', malus:208, navyki:{hide:2,pitfall:2,animal:1}, resultaty:{dengi:21, opyt:63, vezenie:15, boom:67, produkty:{763:11}}};
    ...
    PK_S3.raboty[60] = {rus_name:'Repairing a covered wagon', name:'ox', malus:238, navyki:{reflex:1,hide:1,pitfall:2,animal:1}, resultaty:{dengi:64, opyt:34, vezenie:18, boom:43, produkty:{787:13}}};
    PK_S3.raboty[61] = {rus_name:'Prison guard', name:'guard', malus:222, navyki:{punch:1,reflex:1,shot:1,appearance:2}, resultaty:{dengi:25, opyt:35, vezenie:38, boom:4, produkty:{750:1}}};
    PK_S3.raboty[62] = {rus_name:'Evangelizing', name:'bible', malus:236, navyki:{tough:1,ride:1,trade:1,appearance:2}, resultaty:{dengi:5, opyt:61, vezenie:52, boom:77, produkty:{768:1}}};
    ...
    PK_S3.raboty[64] = {rus_name:'Selling guns to Indians', name:'weapons', malus:258, navyki:{hide:1,shot:1,repair:1,trade:2}, resultaty:{dengi:15, opyt:35, vezenie:72, boom:82, produkty:{783:4}}};
    PK_S3.raboty[65] = {rus_name:'Grave robber', name:'dead', malus:266, navyki:{tough:1,hide:1,finger_dexterity:2,repair:1}, resultaty:{dengi:14, opyt:14, vezenie:90, boom:34, produkty:{774:1,723:1}}};
    PK_S3.raboty[66] = {rus_name:'Hunting grizzly bears', name:'grizzly', malus:281, navyki:{hide:1,shot:1,pitfall:2,animal:1}, resultaty:{dengi:25, opyt:78, vezenie:35, boom:71, produkty:{731:3}}};
    PK_S3.raboty[67] = {rus_name:'Drilling for oil', name:'oil', malus:295, navyki:{build:1,tough:1,endurance:1,leadership:1,trade:1}, resultaty:{dengi:83, opyt:25, vezenie:20, boom:7, produkty:{752:25}}};
    PK_S3.raboty[68] = {rus_name:'Treasure hunting', name:'treasure_hunting', malus:294, navyki:{hide:2,repair:2,tactic:1}, resultaty:{dengi:20, opyt:20, vezenie:83, boom:24, produkty:{726:1}}};
    PK_S3.raboty[69] = {rus_name:'Serving Army', name:'army', malus:299, navyki:{endurance:1,swim:1,shot:1,pitfall:1,appearance:1}, resultaty:{dengi:55, opyt:76, vezenie:17, boom:35, produkty:{727:2}}};
    PK_S3.raboty[70] = {rus_name:'Serving in the army', name:'steal', malus:372, navyki:{reflex:1,hide:1,shot:1,pitfall:1,finger_dexterity:1}, resultaty:{dengi:48, opyt:50, vezenie:74, boom:66, produkty:{728:4}}};
    PK_S3.raboty[71] = {rus_name:'Mercenary work', name:'mercenary', malus:332, navyki:{tough:1,swim:1,shot:1,repair:1,appearance:1}, resultaty:{dengi:92, opyt:52, vezenie:23, boom:65, produkty:{1708:85}}};
    PK_S3.raboty[72] = {rus_name:'Chasing bandits', name:'bandits', malus:385, navyki:{tough:1,endurance:1,hide:1,leadership:1,tactic:1}, resultaty:{dengi:28, opyt:75, vezenie:85, boom:83, produkty:{729:5}}};
    PK_S3.raboty[73] = {rus_name:'Ambush', name:'aggression', malus:422, navyki:{hide:2,pitfall:1,tactic:1,appearance:1}, resultaty:{dengi:78, opyt:27, vezenie:78, boom:86, produkty:{730:13,774:1}}};
    PK_S3.raboty[74] = {rus_name:'Ambush stagecoach', name:'diligence_aggression', malus:476, navyki:{shot:1,pitfall:1,leadership:1,tactic:1,appearance:1}, resultaty:{dengi:43, opyt:73, vezenie:95, boom:67, produkty:{733:15}}};
    PK_S3.raboty[75] = {rus_name:'Bounty hunter', name:'bounty', malus:426, navyki:{punch:1,endurance:1,shot:1,pitfall:1,appearance:1}, resultaty:{dengi:92, opyt:32, vezenie:79, boom:72, produkty:{1756:25}}};
    PK_S3.raboty[76] = {rus_name:'Transporting prisoners', name:'captured', malus:438, navyki:{endurance:1,reflex:1,hide:1,tactic:2}, resultaty:{dengi:23, opyt:69, vezenie:85, boom:44, produkty:{764:4}}};
    PK_S3.raboty[77] = {rus_name:'Robbing trains', name:'train', malus:506, navyki:{endurance:1,hide:1,shot:1,pitfall:1,trade:1}, resultaty:{dengi:67, opyt:87, vezenie:92, boom:96, produkty:{1755:1}}};
    PK_S3.raboty[78] = {rus_name:'burglary', name:'burglary', malus:518, navyki:{endurance:1,hide:2,tactic:1,trade:1}, resultaty:{dengi:80, opyt:34, vezenie:81, boom:26, produkty:{786:12}}};
    PK_S3.raboty[79] = {rus_name:'Charlatan', name:'quackery', malus:316, navyki:{hide:1,shot:1,pitfall:1,trade:1,appearance:1}, resultaty:{dengi:65, opyt:50, vezenie:52, boom:67, produkty:{794:9}}};
    PK_S3.raboty[80] = {rus_name:'Peace negotiations', name:'peace', malus:367, navyki:{endurance:1,hide:1,shot:1,trade:1,appearance:1}, resultaty:{dengi:33, opyt:68, vezenie:76, boom:44, produkty:{751:8}}};
    PK_S3.raboty[82] = {rus_name:'Steering a paddle steamer', name:'ship', malus:348, navyki:{punch:1,swim:2,leadership:2}, resultaty:{dengi:82, opyt:35, vezenie:15, boom:14, produkty:{788:12}}};
    PK_S3.raboty[83] = {rus_name:'Smuggling', name:'smuggle', malus:411, navyki:{hide:1,swim:1,shot:1,trade:1,appearance:1}, resultaty:{dengi:62, opyt:45, vezenie:83, boom:56, produkty:{729:22}}};
    PK_S3.raboty[84] = {rus_name:'Construct a ranch house', name:'ranch', malus:221, navyki:{build:2,endurance:1,ride:1,animal:1}, resultaty:{dengi:28, opyt:61, vezenie:17, boom:24, produkty:{784:45}}};
    PK_S3.raboty[85] = {rus_name:'Iron mining', name:'iron', malus:177, navyki:{build:1,punch:1,reflex:1,finger_dexterity:1,repair:1}, resultaty:{dengi:52, opyt:32, vezenie:15, boom:29, produkty:{790:38, 753:2}}};
    PK_S3.raboty[86] = {rus_name:'Picking agaves', name:'agave', malus:153, navyki:{punch:1,tough:2,endurance:1,finger_dexterity:1}, resultaty:{dengi:25, opyt:42, vezenie:12, boom:27, produkty:{792:12}}};
    PK_S3.raboty[87] = {rus_name:'Picking tomatoes', name:'tomato', malus:43, navyki:{ride:1,finger_dexterity:1,leadership:1,tactic:1,trade:1}, resultaty:{dengi:13, opyt:12, vezenie:7, boom:11, produkty:{793:33}}};
    PK_S3.raboty[88] = {rus_name:'Shoeing Horses', name:'horseshoe', malus:93, navyki:{punch:1,ride:2,animal:2}, resultaty:{dengi:14, opyt:28, vezenie:9, boom:23, produkty:{754:22}}};
    PK_S3.raboty[90] = {rus_name:'Fire fighter', name:'fire', malus:229, navyki:{build:1,tough:1,reflex:1,leadership:1,tactic:1}, resultaty:{dengi:15, opyt:41, vezenie:65, boom:45, produkty:{781:2}}};
    PK_S3.raboty[91] = {rus_name:'Picking Oranges', name:'orange', malus:67, navyki:{endurance:1,reflex:1,pitfall:1,repair:1,tactic:1}, resultaty:{dengi:14, opyt:25, vezenie:10, boom:21, produkty:{791:25}}};
    PK_S3.raboty[92] = {rus_name:'Mucking out the stables', name:'muck_out', malus:8, navyki:{tough:1,ride:1,repair:1,animal:2}, resultaty:{dengi:4, opyt:5, vezenie:2, boom:6, produkty:{797:5}}};
    PK_S3.raboty[93] = {rus_name:'Shining shoes', name:'shoes', malus:1, navyki:{hide:1,pitfall:1,finger_dexterity:1,trade:1,appearance:1}, resultaty:{dengi:3, opyt:2, vezenie:3, boom:2, produkty:{789:35}}};

    PK_S3.raboty[94] = {rus_name:'Darn socks', name:'socks_darn', malus:1, navyki:{tough:2,endurance:1,finger_dexterity:2}, resultaty:{dengi:1, opyt:4, vezenie:0, boom:2, produkty:{1807:75}}};
    PK_S3.raboty[95] = {rus_name:'Harvest potatoes', name:'potatoe', malus:113, navyki:{tough:2,endurance:2,finger_dexterity:1}, resultaty:{dengi:8, opyt:53, vezenie:5, boom:5, produkty:{1808:75}}};
    PK_S3.raboty[96] = {rus_name:'Feed the animals', name:'feed_animal', malus:147, navyki:{punch:1,tough:1,leadership:1,animal:2}, resultaty:{dengi:17, opyt:60, vezenie:10, boom:20, produkty:{1809:50}}};
    PK_S3.raboty[97] = {rus_name:'Harvest pumpkins', name:'pumpkin', malus:175, navyki:{punch:2,tough:1,endurance:1,tactic:1}, resultaty:{dengi:45, opyt:45, vezenie:10, boom:10, produkty:{1810:60}}};
    PK_S3.raboty[98] = {rus_name:'Picking Blueberries', name:'blueberries', malus:200, navyki:{punch:1,tough:1,ride:2,finger_dexterity:1}, resultaty:{dengi:52, opyt:35, vezenie:35, boom:15, produkty:{1811:65}}};
    PK_S3.raboty[99] = {rus_name:'Plant trees', name:'plant_trees', malus:226, navyki:{build:2,ride:1,finger_dexterity:1,tactic:1}, resultaty:{dengi:34, opyt:25, vezenie:54, boom:25, produkty:{1812:30}}};
    PK_S3.raboty[100] = {rus_name:'Collect eagle feathers', name:'gather_feathers', malus:276, navyki:{finger_dexterity:1, repair:2,tactic:1,trade:1}, resultaty:{dengi:47, opyt:23, vezenie:60, boom:15, produkty:{1813:20}}};
    PK_S3.raboty[101] = {rus_name:'Collect lotus flowers', name:'lotus_gathering', malus:351, navyki:{tough:1,swim:2,finger_dexterity:1,repair:1}, resultaty:{dengi:54, opyt:45, vezenie:35, boom:20, produkty:{1814:15}}};
    PK_S3.raboty[102] = {rus_name:'Catch crabs', name:'crab_hunting', malus:376, navyki:{tough:1,reflex:1,swim:2,finger_dexterity:1}, resultaty:{dengi:67, opyt:56, vezenie:35, boom:12, produkty:{1815:10}}};
    PK_S3.raboty[103] = {rus_name:'Teach', name:'teaching', malus:401, navyki:{endurance:1,pitfall:1,leadership:1,appearance:2}, resultaty:{dengi:54, opyt:79, vezenie:5, boom:23, produkty:{1816:25}}};
    PK_S3.raboty[104] = {rus_name:'Work as a sheriff', name:'sheriff_work', malus:411, navyki:{reflex:1,shot:2,leadership:1,appearance:1}, resultaty:{dengi:67, opyt:76, vezenie:56, boom:45, produkty:{1817:50}}};
    PK_S3.raboty[105] = {rus_name:'Mine sulfur', name:'sulfur_gathering', malus:421, navyki:{punch:2,reflex:2,repair:1}, resultaty:{dengi:76, opyt:34, vezenie:78, boom:32, produkty:{1818:10}}};
    PK_S3.raboty[106] = {rus_name:'White water transport', name:'wildwater', malus:426, navyki:{reflex:2,swim:2,tactic:1}, resultaty:{dengi:84, opyt:74, vezenie:30, boom:57, produkty:{999:25}}};
    PK_S3.raboty[107] = {rus_name:'Roam the land as a gambler', name:'gambler', malus:431, navyki:{reflex:1,hide:1,shot:1,trade:1,appearance:1}, resultaty:{dengi:67, opyt:57, vezenie:69, boom:63, produkty:{1819:25}}};
    PK_S3.raboty[108] = {rus_name:'Hunt snakes', name:'rattlesnake', malus:441, navyki:{reflex:2,hide:1,pitfall:1,animal:1}, resultaty:{dengi:72, opyt:46, vezenie:71, boom:73, produkty:{1820:15}}};
    PK_S3.raboty[109] = {rus_name:'Mine salpeter', name:'salpeter_gathering', malus:451, navyki:{tough:2,endurance:1,finger_dexterity:1,repair:1}, resultaty:{dengi:62, opyt:53, vezenie:58, boom:27, produkty:{1821:35}}};
    PK_S3.raboty[110] = {rus_name:'Transport horse', name:'horse_transport', malus:451, navyki:{ride:2,leadership:1,animal:2}, resultaty:{dengi:66, opyt:82, vezenie:69, boom:48, produkty:{1822:10}}};
    PK_S3.raboty[111] = {rus_name:'Organize a rodeo', name:'rodeo', malus:500, navyki:{endurance:1,ride:2,pitfall:1,animal:1}, resultaty:{dengi:76, opyt:56, vezenie:69, boom:78, produkty:{1823:5}}};
    PK_S3.raboty[112] = {rus_name:'Work as a traveling merchant', name:'travelling_salesman', malus:501, navyki:{tough:1,pitfall:1,trade:2,appearance:1}, resultaty:{dengi:59, opyt:46, vezenie:97, boom:67, produkty:{999:7}}};
    PK_S3.raboty[113] = {rus_name:'Marriage swindler', name:'con_artist', malus:521, navyki:{endurance:1,pitfall:1,tactic:1,trade:1,appearance:1}, resultaty:{dengi:78, opyt:89, vezenie:35, boom:83, produkty:{1836:2}}};
    PK_S3.raboty[114] = {rus_name:'Hunt pumas', name:'cougar', malus:541, navyki:{shot:2,pitfall:1,tactic:1,animal:1}, resultaty:{dengi:46, opyt:89, vezenie:39, boom:93, produkty:{1824:20}}};
    PK_S3.raboty[115] = {rus_name:'Pick indigo', name:'indigo_gathering', malus:591, navyki:{reflex:1,finger_dexterity:2,tactic:1,trade:1}, resultaty:{dengi:87, opyt:73, vezenie:29, boom:69, produkty:{1825:5}}};
    PK_S3.raboty[116] = {rus_name:'Transport alcohol', name:'alcohol', malus:601, navyki:{ride:1,hide:2,shot:1,leadership:1}, resultaty:{dengi:74, opyt:91, vezenie:34, boom:56, produkty:{1826:50}}};
    PK_S3.raboty[117] = {rus_name:'Mine lead', name:'lead_gathering', malus:621, navyki:{punch:1,finger_dexterity:1,repair:2,leadership:1}, resultaty:{dengi:89, opyt:72, vezenie:22, boom:72, produkty:{1827:30}}};
    PK_S3.raboty[118] = {rus_name:'Dig for rare gemstones', name:'gem_gathering', malus:641, navyki:{punch:2,endurance:1,shot:1,repair:1}, resultaty:{dengi:91, opyt:78, vezenie:23, boom:77, produkty:{721:45, 1828:2, 1829:1, 1830:2}}};
    PK_S3.raboty[119] = {rus_name:'Construct a mission', name:'mission', malus:571, navyki:{build:2,punch:1,endurance:1,repair:1}, resultaty:{dengi:92, opyt:82, vezenie:54, boom:38, produkty:{1831:3}}};
    PK_S3.raboty[120] = {rus_name:'Construct a casino', name:'casino', malus:651, navyki:{build:3,repair:1,leadership:1}, resultaty:{dengi:78, opyt:92, vezenie:23, boom:45, produkty:{1832:10}}};
    PK_S3.raboty[121] = {rus_name:'Work as a marshal', name:'marshall', malus:701, navyki:{ride:1,shot:2,pitfall:1,appearance:1}, resultaty:{dengi:87, opyt:90, vezenie:60, boom:94, produkty:{1833:1}}};
    PK_S3.raboty[122] = {rus_name:'Break up gangs', name:'shatter_gang', malus:726, navyki:{endurance:1,hide:2,pitfall:1,tactic:1}, resultaty:{dengi:84, opyt:70, vezenie:89, boom:99, produkty:{999:10}}};
    PK_S3.raboty[123] = {rus_name:'Rob a bank', name:'bankrobbery', malus:741, navyki:{hide:2,pitfall:1,leadership:1,trade:1}, resultaty:{dengi:93, opyt:84, vezenie:30, boom:89, produkty:{1837:1}}};
    PK_S3.raboty[124] = {rus_name:'Free slaves', name:'free_slaves', malus:751, navyki:{swim:1,shot:1,leadership:1,tactic:1,appearance:1}, resultaty:{dengi:84, opyt:93, vezenie:28, boom:92, produkty:{1834:5}}};
    PK_S3.raboty[125] = {rus_name:'Perform with Buffalo Bill', name:'buffelo_bill', malus:801, navyki:{ride:1,shot:1,animal:1,appearance:2}, resultaty:{dengi:92, opyt:94, vezenie:65, boom:70, produkty:{1835:5}}};
    PK_S3.raboty[126] = {rus_name:'Build palisade', name:'build_palisade', malus:301, navyki:{build:1,punch:1,endurance:1,repair:1,leadership:1}, resultaty:{dengi:33, opyt:65, vezenie:20, boom:30, produkty:{742:4, 747:5, 761:6, 765:5}}};

    PK_S3.raboty[PK_S3.raboty.build] = {rus_name:'!City Building / Fort', name:'build', malus:0, navyki:{build:3,repair:1,leadership:1}, resultaty:{dengi:0, opyt:0, vezenie:0, boom:0, produkty:{}}};
    PK_S3.raboty[PK_S3.raboty.moving] = {rus_name:'!Movement', name:'moving', malus:0, navyki:{ride:1}, resultaty:{dengi:0, opyt:0, vezenie:0, boom:0, produkty:{}}};
    PK_S3.raboty[PK_S3.raboty.health] = {rus_name:'!SON-Life', name:'health', malus:0, navyki:{health:1}, resultaty:{dengi:0, opyt:0, vezenie:0, boom:0, produkty:{}}};
    PK_S3.raboty[PK_S3.raboty.energy] = {rus_name:'!SON-energy', name:'energy', malus:0, navyki:{health:1}, resultaty:{dengi:0, opyt:0, vezenie:0, boom:0, produkty:{}}};
//
    PK_S3.raboty[301] = {rus_name:'Fort. attack', name:'attack', malus:0, navyki:{aim:.5,dodge:.5,endurance:1,leadership:1}, resultaty:{dengi:0, opyt:0, vezenie:0, boom:100, produkty:{}}};
    PK_S3.raboty[302] = {rus_name:'Fort. Attack (Accuracy)', name:'attack', malus:0, navyki:{aim:1,dodge:.001,endurance:1,leadership:1}, resultaty:{dengi:0, opyt:0, vezenie:0, boom:100, produkty:{}}};
    PK_S3.raboty[303] = {rus_name:'Fort. Attack (dodge)', name:'attack', malus:0, navyki:{aim:.001,dodge:1,endurance:1,leadership:1}, resultaty:{dengi:0, opyt:0, vezenie:0, boom:100, produkty:{}}};
    PK_S3.raboty[304] = {rus_name:'Fort. protection', name:'defend', malus:0, navyki:{aim:.5,dodge:.5,hide:1,leadership:1}, resultaty:{dengi:0, opyt:0, vezenie:0, boom:50, produkty:{}}};
    PK_S3.raboty[305] = {rus_name:'Fort. Protection (accuracy)', name:'defend', malus:0, navyki:{aim:1,dodge:.001,hide:1,leadership:1}, resultaty:{dengi:0, opyt:0, vezenie:0, boom:50, produkty:{}}};
    PK_S3.raboty[306] = {rus_name:'Fort. Defense (Dodge)', name:'defend', malus:0, navyki:{aim:.001,dodge:1,hide:1,leadership:1}, resultaty:{dengi:0, opyt:0, vezenie:0, boom:50, produkty:{}}};
//    
    PK_S3.raboty[401] = {rus_name:'!The shooter-shooter attacks', name:'sh_vs_sh_at', malus:0, navyki:{aim:1, dodge:1, shot:1, reflex:1, appearance:1}, resultaty:{dengi:0, opyt:0, vezenie:0, boom:100, produkty:{}}};
    PK_S3.raboty[402] = {rus_name:'!Shooter, shooter protection', name:'sh_vs_sh_de', malus:0, navyki:{aim:1, dodge:1, shot:1, reflex:1, tactic:1}, resultaty:{dengi:0, opyt:0, vezenie:0, boom:100, produkty:{}}};
    PK_S3.raboty[403] = {rus_name:'!Shooter-drummer attack', name:'sh_vs_me_at', malus:0, navyki:{aim:1, dodge:1, shot:1, tough:1, appearance:1}, resultaty:{dengi:0, opyt:0, vezenie:0, boom:100, produkty:{}}};
    PK_S3.raboty[404] = {rus_name:'!Gunner defense, drummer', name:'sh_vs_me_de', malus:0, navyki:{aim:1, dodge:1, shot:1, tough:1, tactic:1}, resultaty:{dengi:0, opyt:0, vezenie:0, boom:100, produkty:{}}};
    PK_S3.raboty[405] = {rus_name:'!Shooter-all protection', name:'sh_vs_al_de', malus:0, navyki:{aim:1, dodge:1, shot:1, tough:0.75, reflex:0.75}, resultaty:{dengi:0, opyt:0, vezenie:0, boom:100, produkty:{}}};
    PK_S3.raboty[406] = {rus_name:'!Drummer-arrow attack', name:'me_vs_sh_at', malus:0, navyki:{aim:1, dodge:1, punch:1, reflex:1, appearance:1}, resultaty:{dengi:0, opyt:0, vezenie:0, boom:100, produkty:{}}};
    PK_S3.raboty[407] = {rus_name:'!Drummer-shooter protection', name:'me_vs_sh_de', malus:0, navyki:{aim:1, dodge:1, punch:1, reflex:1, tactic:1}, resultaty:{dengi:0, opyt:0, vezenie:0, boom:100, produkty:{}}};
    PK_S3.raboty[408] = {rus_name:'!Drummer-percussionist attack', name:'me_vs_me_at', malus:0, navyki:{aim:1, dodge:1, punch:1, tough:1, appearance:1}, resultaty:{dengi:0, opyt:0, vezenie:0, boom:100, produkty:{}}};
    PK_S3.raboty[409] = {rus_name:'!Drummer-percussionist Protection', name:'me_vs_me_de', malus:0, navyki:{aim:1, dodge:1, punch:1, tough:1, tactic:1}, resultaty:{dengi:0, opyt:0, vezenie:0, boom:100, produkty:{}}};
    PK_S3.raboty[410] = {rus_name:'!Drummer-all protection', name:'me_vs_al_de', malus:0, navyki:{aim:1, dodge:1, punch:1, tough:0.75, reflex:0.75}, resultaty:{dengi:0, opyt:0, vezenie:0, boom:100, produkty:{}}};
//
    PK_S3.raboty[421] = {rus_name:'Bluff, accuracy', name:'duel421', malus:0, navyki:{appearance:1, aim:1}, resultaty:{dengi:0, opyt:0, vezenie:0, boom:100, produkty:{}}};
    PK_S3.raboty[422] = {rus_name:'Bluff, accuracy, shooting', name:'duel422', malus:0, navyki:{aim:1,shot:1,appearance:1}, resultaty:{dengi:0, opyt:0, vezenie:0, boom:100, produkty:{}}};
    PK_S3.raboty[423] = {rus_name:'Bluff, accuracy, impact', name:'duel423', malus:0, navyki:{aim:1,punch:1,appearance:1}, resultaty:{dengi:0, opyt:0, vezenie:0, boom:100, produkty:{}}};
    PK_S3.raboty[424] = {rus_name:'Bluff, accuracy, evasion', name:'duel424', malus:0, navyki:{aim:1,dodge:1,appearance:1}, resultaty:{dengi:0, opyt:0, vezenie:0, boom:100, produkty:{}}};
    PK_S3.raboty[425] = {rus_name:'Bluff, accuracy, evasion, shooting', name:'duel425', malus:0, navyki:{aim:1,dodge:1,appearance:1, shot:1}, resultaty:{dengi:0, opyt:0, vezenie:0, boom:100, produkty:{}}};
    PK_S3.raboty[426] = {rus_name:'Bluff, Dodge', name:'duel426', malus:0, navyki:{dodge:1,appearance:1}, resultaty:{dengi:0, opyt:0, vezenie:0, boom:100, produkty:{}}};
    PK_S3.raboty[427] = {rus_name:'Tactics, evasion', name:'duel427', malus:0, navyki:{dodge:1,tactic:1}, resultaty:{dengi:0, opyt:0, vezenie:0, boom:100, produkty:{}}};
    PK_S3.raboty[428] = {rus_name:'Tactics, accuracy, evasion', name:'duel428', malus:0, navyki:{aim:1,dodge:1,tactic:1}, resultaty:{dengi:0, opyt:0, vezenie:0, boom:100, produkty:{}}};
    PK_S3.raboty[429] = {rus_name:'Tactics, accuracy, evasion, shooting', name:'duel429', malus:0, navyki:{aim:1,dodge:1,tactic:1, shot:1}, resultaty:{dengi:0, opyt:0, vezenie:0, boom:100, produkty:{}}};
    PK_S3.raboty[430] = {rus_name:'Shooting, marksmanship', name:'duel430', malus:0, navyki:{aim:1,shot:1}, resultaty:{dengi:0, opyt:0, vezenie:0, boom:100, produkty:{}}};
    PK_S3.raboty[431] = {rus_name:'Shoot, dodge', name:'duel431', malus:0, navyki:{dodge:1,shot:1}, resultaty:{dengi:0, opyt:0, vezenie:0, boom:100, produkty:{}}};
    PK_S3.raboty[432] = {rus_name:'Blow, accuracy', name:'duel432', malus:0, navyki:{aim:1,punch:1}, resultaty:{dengi:0, opyt:0, vezenie:0, boom:100, produkty:{}}};
    PK_S3.raboty[433] = {rus_name:'The blow, the reaction', name:'duel433', malus:0, navyki:{punch:1,reflex:1,tough:0.5}, resultaty:{dengi:0, opyt:0, vezenie:0, boom:100, produkty:{}}};
    PK_S3.raboty[434] = {rus_name:'The impact, resistance', name:'duel434', malus:0, navyki:{punch:1,reflex:0.25,tough:1}, resultaty:{dengi:0, opyt:0, vezenie:0, boom:100, produkty:{}}};
    PK_S3.raboty[435] = {rus_name:'Blow, accuracy, reaction', name:'duel435', malus:0, navyki:{aim:1,punch:1,reflex:1,tough:0.25}, resultaty:{dengi:0, opyt:0, vezenie:0, boom:100, produkty:{}}};
    PK_S3.raboty[436] = {rus_name:'Blow, accuracy, stability', name:'duel436', malus:0, navyki:{aim:1,punch:1,reflex:0.25,tough:1}, resultaty:{dengi:0, opyt:0, vezenie:0, boom:100, produkty:{}}};
    PK_S3.raboty[437] = {rus_name:'Accuracy, reaction', name:'duel437', malus:0, navyki:{aim:1,reflex:1,tough:0.5}, resultaty:{dengi:0, opyt:0, vezenie:0, boom:100, produkty:{}}};
    PK_S3.raboty[438] = {rus_name:'Accuracy, stability', name:'duel438', malus:0, navyki:{aim:1,reflex:0.25,tough:1}, resultaty:{dengi:0, opyt:0, vezenie:0, boom:100, produkty:{}}};
    PK_S3.raboty[439] = {rus_name:'Accuracy, Dodge', name:'duel439', malus:0, navyki:{aim:1,dodge:1}, resultaty:{dengi:0, opyt:0, vezenie:0, boom:100, produkty:{}}};
    PK_S3.raboty[440] = {rus_name:'Bluff, accuracy, dodge, punch', name:'duel440', malus:0, navyki:{aim:1,dodge:1,appearance:1, punch:1}, resultaty:{dengi:0, opyt:0, vezenie:0, boom:100, produkty:{}}};
    PK_S3.raboty[441] = {rus_name:'Bluff, dodge, shooting', name:'duel441', malus:0, navyki:{dodge:1,appearance:1, shot:1}, resultaty:{dengi:0, opyt:0, vezenie:0, boom:100, produkty:{}}};
    PK_S3.raboty[442] = {rus_name:'Bluff, dodge, punch', name:'duel442', malus:0, navyki:{dodge:1,appearance:1, punch:1}, resultaty:{dengi:0, opyt:0, vezenie:0, boom:100, produkty:{}}};
    PK_S3.raboty[443] = {rus_name:'Tactics, accuracy, dodge, punch', name:'duel443', malus:0, navyki:{aim:1,dodge:1,tactic:1, punch:1}, resultaty:{dengi:0, opyt:0, vezenie:0, boom:100, produkty:{}}};
    PK_S3.raboty[444] = {rus_name:'Tactics, accuracy', name:'duel444', malus:0, navyki:{aim:1,tactic:1}, resultaty:{dengi:0, opyt:0, vezenie:0, boom:100, produkty:{}}};
    PK_S3.raboty[445] = {rus_name:'Stroke, Dodge', name:'duel445', malus:0, navyki:{dodge:1,punch:1}, resultaty:{dengi:0, opyt:0, vezenie:0, boom:100, produkty:{}}};
//
 ...
 */
	...
	if (div&&(div.id.indexOf('window_job')!=-1)){
	    ...
	    var span = document.createElement('span');
	    var html = '<a class="button_wrap button" style="padding: 0px 5px;"  href="#" onClick="PK_S3.four_init(\''+name+'\')">' + '<span class="button_left"></span><span class="button_middle">Calculation</span><span class="button_right"></span></a>';
	    span.innerHTML = html;
	    divb.appendChild(span);
	    jd.appendChild(divb);
	}
...
PK_S3.input_select_rdf = function(){
    ...
    var srab = [];
    srab[0]={id:0, name:'Choose a job, a duel, the Fort'};
    var opt = document.createElement('option');
    opt.value = 0;
    var txt = '';
    if ((i1 == 3)){
	txt = 'Selected specials. bust';
    }
    else if (j1 == 2){
	txt = 'select all ';
	if (i1 == 0){
	...
	txt = 'Designer selected skills';
    }
    else{
	txt = 'select ';
	if (i1 == 0) txt += 'work';
	if (i1 == 1) txt += ' dueling type';
	if (i1 == 2) txt += ' fighter gear';
    }
    opt.textContent = txt;
    opt.disabled = true;
    opt.selected = true;
...
PK_S3.minimize_window_settings2 = function(){
    ...
    bar.firstChild.firstChild.nextSibling.innerHTML='Pereodevalka';
}
...
PK_S3.show_window_settings = function(init){
    ...
    xhtml += '	<a class="window_refresh" href="javascript:PK_S3.show_window_settings(true);void(0)" title="<b>Redraw</b>"></a>'
    xhtml += '  <a href="javascript:AjaxWindow.closeAll();" class="window_closeall" title="<b>Close all windows</b>"></a>';
    //xhtml += '  <a href="javascript:AjaxWindow.toggleSize(\'' + name + '\', \'' + group + '\');" class="window_minimize" title="<b>Close the window</b>"></a>';
    xhtml += '  <a href="javascript:PK_S3.minimize_window_settings();" class="window_minimize" title="<b>Close the window</b>"></a>';
    xhtml += '  <a href="javascript:AjaxWindow.close(\'' + name + '\');" class="window_close" title="<b>Close the window</b>"></a>';
    ...
    var div_zakup_zag = new Element ('div', {'style':'clear: both; font-weight:bold; text-align:center;', 'title':'Let us look of all that occurs in the vast West!'});
    div_zakup_zag.textContent = 'Otsutvie (so far) things:';
    div_zakup.appendChild(div_zakup_zag);
    
    var div = new Element ('div', {'title':'The upper limit on the total cost of purchased items.'});
    var img = new Element('span', {'style':'width:23px; height:23px; background-image:url(http://www.the-west.ru/images/job/danger.png); float:left; margin: 2px 5px 2px 5px;', 'title':'Attention! can greatly slow down the search.'});
    div.appendChild(img);
    ...
    div.appendChild(inp);
    var span = document.createElement('span');
    span.textContent = 'There is a $ at stores';
    div.appendChild(span);
    div_zakup.appendChild(div);

    var div = new Element ('div', {'title':'Purchase of the stores for any amount.'});
    ...
    div.appendChild(inp);
    var span = document.createElement('span');
    span.textContent = 'Buy any of the traders';
    div.appendChild(span);
    div_zakup.appendChild(div);

    var div = new Element ('div', {'title':'Purchase of non-store at auction at par value.'});
    var inp = new Element ('input', {'id':'pk_s3_select_auction', 'type':'checkbox', 'style':'margin: 3px 5px;'});
    div.appendChild(inp);
    var span = document.createElement('span');
    span.textContent = 'Auction, except for store';
    div.appendChild(span);
    div_zakup.appendChild(div);

/*
    var div = new Element ('div', {'title':'Selection of any non-store drop. The cost is zero.'});
    var inp = new Element ('input', {'id':'pk_s3_select_drop', 'type':'checkbox', 'style':'margin: 3px 5px;'});
    div.appendChild(inp);
    var span = document.createElement('span');
    span.textContent = 'Any drop, except for store';
    div.appendChild(span);
    div_zakup.appendChild(div);
*/
    var div = new Element ('div', {'title':'Unique quest items. The cost is zero.'});
    var inp = new Element ('input', {'id':'pk_s3_select_unique', 'type':'checkbox', 'style':'margin: 3px 5px;'});
    div.appendChild(inp);
    var span = document.createElement('span');
    span.textContent = 'The unique thing';
    div.appendChild(span);
    div_zakup.appendChild(div);

    var div = new Element ('div', {'title':'The priority of a set of holiday.'});
    var inp = new Element ('input', {'id':'pk_s3_select_season', 'type':'checkbox', 'style':'margin: 3px 5px;'});
    div.appendChild(inp);
    var span = document.createElement('span');
    span.textContent = 'Priority for good luck';
    div.appendChild(span);
    div_zakup.appendChild(div);

//    div_left.appendChild(div_zakup);    

    var div = new Element('div', {'title':'We count for the character at the specified level.'});
    ...
    div.appendChild(inp);
    var span = document.createElement('span');
    span.textContent = 'The calculation for the level of';
    div.appendChild(span);
    div_zakup.appendChild(div);
    div_left.appendChild(div_zakup);    

//    var div_slots_zag = new Element ('div', {'style':'float:right; clear: both; font-weight:bold; text-align:center;'});
//    div_slots_zag.textContent = 'Things of the slots of equipment:';
//    div_left.appendChild(div_slots_zag);
    ...
    // <span id="submit_delete_reports"><a href="#" class="button_wrap button"><span class="button_left"></span><span class="button_middle">remove</span><span class="button_right"></span><span style="clear: both;"></span></a></span>
    var span = document.createElement('span');
    ...
    div_sel_rab_zag.textContent = 'Works:';
    ...
    div_sel_duel_zag.textContent = 'duels:';
    ...
    div.appendChild(inp);
    var span = document.createElement('span');
    span.textContent = 'several typecasting';
    div.appendChild(span);
    div_sel_duel.appendChild(div);
    ...
    div.appendChild(inp);
    var span = document.createElement('span');
    span.textContent = 'all types of the';
    div.appendChild(span);
    div_sel_duel.appendChild(div);
    ...
    div_sel_fort_zag.textContent = 'forts:';
    ...
    div.appendChild(inp);
    var span = document.createElement('span');
    span.textContent = 'one version of the';
    div.appendChild(span);
    ...
    var attribs = ['Strength (3 + skill) ',' Agility (3 + skill) ',' Dexterity (3 + skill) ',' Charm (3 + skill)']
    var skills = ['Construction', 'Blow', 'resistance', 'Endurance', 'Health', 'Riding', 'Reaction', 'Dodge', 'Hide', 'Sailing', 'Hit', 'shooting', 'Setting traps', 'Agility', 'repair', 'Guide', 'tactic', 'Trade', 'animal', 'Bluff'];
    var skills_color = ['#ff9999', '#99ff99', '#9999ff', '#ffff99'];
    var div = new Element('div', {'title':'All work with the selected skill. For attributes - three skills in the work.'});
    ...
    opt.textContent = 'Choose a skill (for work)';
    sel.appendChild(opt);
    for (var j = 0; j < 4; ++j)
    {
    ...
    var div = new Element('div', {'title':'All works, which give the selected product (surprises are not implemented).'});
    ...
    var opt = new Element ('option', {'value':'0', 'selected':'true', 'disabled':'true'});
    opt.textContent = 'Select the object obtained';
    sel.appendChild(opt);
    var drop = [];
    ...
    var div = new Element('div', {'title':'Search for things that do not apply on any of the calculated (not hidden) work / duels / Fort'});
    var inp = new Element ('input', {'id':'pk_s3_select_rab_ov', 'name':'pk_s3_raboty_radio', 'type':'radio', 'style':'margin: 5px 2px 0px 2px;'});
    div.appendChild(inp);
    var span = document.createElement('span');
    span.textContent = 'Search for unnecessary things';
    div.appendChild(span);
    div_sel_dop.appendChild(div);
...
/*
    ...
    var opt = new Element ('option', {'value':'0', 'selected':'true', 'disabled':'true'});
    opt.textContent = 'select the job';
    sel.appendChild(opt);
    var opt = new Element ('option', {'value':'1'});
    opt.textContent = 'Kill the three Mouse';
    sel.appendChild(opt);
    div.appendChild(sel);
    div_sel_dop.appendChild(div);
*/    
    ...
    var div = new Element('div', {title:'<b> Outlying forts will be found a set of </b> health is not less than the.'});
    var span = document.createElement('span');
    span.textContent = 'Health for the fort:';
    div.appendChild(span);
    ...
    div_zag.textContent = 'Designer skills:';
    ...
    */
	...
	var opt = document.createElement('option');
	opt.value = 99;
	opt.textContent = '(an empty slot)';
	sel.appendChild(opt);
	var opt = document.createElement('option');
	opt.value = 98;
	opt.textContent = '(of equipment)';
	sel.appendChild(opt);
    ...
    var skills2 = ['p', 'blow', 'stop', 'Con', 'Zdor', 'top', 'reaction', 'are confident', 'Mask', 'melting', 'label', 'p', 'fishing ',' wire ',' rem ',' hand ',' tact ',' bargain ',' alive ',' bluff '];
    var attrib2 = ['force', 'clever', 'CHOP', 'charm'];
...
PK_S3.minimize_window_informer2 = function(){
    ...
    bar.firstChild.firstChild.nextSibling.innerHTML='information';
};
...
PK_S3.show_window_informer = function (){
    ...
    xhtml += '<div class="window_borders">';
    xhtml += '  <h2 id="window_' + name + '_title" class="window_title"> </h2>';
    xhtml += '	<a class="window_refresh" href="javascript:AjaxWindow.close(\'' + name + '\'); PK_S3.show_window_informer();void(0)" title="<b>Redraw</b>"></a>'
    xhtml += '  <a href="javascript:AjaxWindow.closeAll();" class="window_closeall" title="<b>Close all windows</b>"></a>';
    //xhtml += '  <a href="javascript:AjaxWindow.toggleSize(\'' + name + '\', \'' + group + '\');" class="window_minimize" title="<b>Свернуть окно</b>"></a>';
    xhtml += '  <a href="javascript:PK_S3.minimize_window_informer();" class="window_minimize" title="<b>Close the window</b>"></a>';
    xhtml += '  <a href="javascript:AjaxWindow.close(\'' + name + '\');" class="window_close" title="<b>Close the window</b>"></a>';
    xhtml += '  <div id="window_' + name + '_content" class="window_content">';
    xhtml += '    	<table class="shadow_table" style="margin-left:6px; width:100%; height:390px">';
    xhtml += '    		<tr>';
...
PK_S3.print_raboty_to = function (arr){
	...
	var img0 = new Element ('img', {'style':'width:23px; height:23px; background:url(../img.php?type=menu&amp;dummy) -104px -126px; display:block; margin: 2px;', 'src':'/images/transparent.png', 'title':'Save a set of...'});
	aa0.appendChild(img0);
	tmp_div.appendChild(aa0);
	var aa1 = new Element ('a', {'href':'javascript:PK_S3.equip_items_delete('+arr[i].ind+')'});
	var img1 = new Element ('img', {'style':'width:23px; height:23px; background:url(../img.php?type=menu&amp;dummy) -129px -101px; display:block; margin: 2px;', 'src':'/images/transparent.png', 'title':'Delete a set of'});
	aa1.appendChild(img1)
	tmp_div.appendChild(aa1);
	var aa2 = new Element ('a', {'href':'javascript:PK_S3.except_raboty('+arr[i].ind+', true)'});
	var img2 = new Element ('img', {'style':'width:23px; height:23px; background:url(/images/window/window2_buttons.png) 0px -20px; display:block; margin: 2px;', 'src':'/images/transparent.png', 'title':'Hide work'});
	...
	var title = PK_S3.raboty[arr[i].ind].rus_name + '<hr />Click to wear selected items';
	...
	if (arr[i].ind <= PK_S3.raboty.max){
	    ...
	    var divIb1 = new Element('div', {'style':'width:110px; float:left;', 'title':'earnings'});
	    ...
	    var divIb3 = new Element('div', {'style':'float:left;', 'title':'good luck'});
	    ...
	    var divIb2 = new Element('div', {'style':'width:110px; float:left;', 'title':'experience'});
	    ...
	    var divIb4 = new Element('div', {'style':'float:left;', 'title':'danger'});
	...
	var title = 'Bonus equipment';
	if (arr[i].ind == PK_S3.raboty.moving){
	    title = 'Speed Bonus';
	}
	else if ((arr[i].ind == PK_S3.raboty.energy)||(arr[i].ind == PK_S3.raboty.health)){
	    title = 'Bonus to skill health';
	}
	else if ((arr[i].ind >= PK_S3.raboty.fort_min) && (arr[i].ind < PK_S3.raboty.fort_max)){
	    title = 'protection';
	}
	...
	tmp_div.innerHTML = '<img src="images/task_points/minus.png" width="20" height="20" title="The complexity of the" /> '+PK_S3.raboty[arr[i].ind].malus;
	divIIa1.appendChild(tmp_div);
	var tmp_div = new Element ('span', {'style':'float:left; clear:right; width:58px;'});
	var title = 'labor points';
	if (arr[i].ind == PK_S3.raboty.moving){
	    title = 'The total rate of';
	}
	else if (arr[i].ind == PK_S3.raboty.energy){
	    title = 'Percentage of recovery';
	}
	else if (arr[i].ind == PK_S3.raboty.health){
	    title = 'The resulting health'
	}
	else if ((arr[i].ind >= PK_S3.raboty.fort_min) && (arr[i].ind < PK_S3.raboty.fort_max)){
	    title = 'The value of the selected bonus';
	}
	...
	for (var j = 0; j < PK_S3.types.length; ++j){
		...
		if (iobj.speed){
		    ...
		    title += 'speed: '+Math.round(100/iobj.speed)+'%';
		}
		if ((iobj.type == 'left_arm')||(iobj.type == 'right_arm')){
		    if (!is_f){
			title += '<br />';
		    }
		    title += 'damage: ' + iobj.damage.damage_min + ' - ' + iobj.damage.damage_max + ' (' + parseInt((iobj.damage.damage_min + iobj.damage.damage_max)/2, 10) + ' cp.)';
		};
		title += '<hr />';
		if (iobj.set.key){
		    title += iobj.set.name +'<hr />';
		};
		title += 'level: ' + (iobj.level ? iobj.level : '0') + '<br />';
		title += 'price: ' + iobj.price + '$';
		title += '<hr />Click to put the subject'
	...
	if (no_item_fort){
	    ...
	    div1.textContent = 'Too much importance to health. There is no single set of satisfying the requirement!';
	    divIIb.appendChild(div1);
	}
...
PK_S3.vyvod_nenuzhnykh_items = function (){
	...
	if (!PK_S3.ispolzuemye[i]){
		...
		title += 'rate: '+Math.round(100/obj.speed)+'%';
	    }
	    if ((obj.type == 'left_arm')||(obj.type == 'right_arm')){
		if (!is_f){
		    title += '<br />';
		}
		title += 'damage: ' + obj.damage.damage_min + ' - ' + obj.damage.damage_max + ' (' + parseInt((obj.damage.damage_min + obj.damage.damage_max)/2, 10) + ' cp.)';
	    };
	    title += '<hr />';
	    if (obj.set.key){
		title += obj.set.name +'<hr />';
	    };
	    title += 'level: ' + (obj.level ? obj.level : '0') + '<br />';
	    title += 'price: ' + obj.price + '$';
	    var simple = false;
...
PK_S3.print_raboty = function (arr){
	...
	var tmp_div = new Element ('div', {'style':'float:left; padding: 2px;'});
	var aa0 = new Element ('a', {'href':'javascript:PK_S3.equip_items_save('+arr[i].ind+')'});
	var img0 = new Element ('img', {'style':'width:23px; height:23px; background:url("../images/window/messages/icons.png") repeat scroll -217px -2px transparent; display:block; margin: 2px;', 'src':'/images/transparent.png', 'title':'Save a set of...'});
	aa0.appendChild(img0);
	tmp_div.appendChild(aa0);
	var aa1 = new Element ('a', {'href':'javascript:PK_S3.equip_items_delete('+arr[i].ind+')'});
	var img1 = new Element ('img', {'style':'width:23px; height:23px; background:url("../images/window/messages/icons.png") repeat scroll -265px -2px transparent; display:block; margin: 2px;', 'src':'/images/transparent.png', 'title':'Delete a set of'});
	aa1.appendChild(img1)
	tmp_div.appendChild(aa1);
	var aa2 = new Element ('a', {'href':'javascript:PK_S3.except_raboty('+arr[i].ind+', true)'});
	var img2 = new Element ('img', {'style':'width:23px; height:23px; background:url("../images/window/messages/icons.png") repeat scroll -241px -2px transparent; display:block; margin: 2px;', 'src':'/images/transparent.png', 'title':'Hide work'});
	aa2.appendChild(img2)
	tmp_div.appendChild(aa2);
	divIo.appendChild(tmp_div);
	divI.appendChild(divIo);
	...
	if ((arr[i].ind >= PK_S3.raboty.fort_min) && (arr[i].ind < PK_S3.raboty.fort_max)){
	    tmp_div.innerHTML = '<img src="images/fort/battle/attacker_primary.png" title="attack" /> '+PK_S3.resultaty[arr[i].ind].selfTO;
	}
	else{
	    tmp_div.innerHTML = '<img src="images/task_points/plus.png" width="20" height="20" title="'+title+'" /> '+PK_S3.resultaty[arr[i].ind].selfTO;
	}
	...
	if ((arr[i].ind >= PK_S3.raboty.fort_min) && (arr[i].ind < PK_S3.raboty.fort_max)){
	    tmp_div.innerHTML = '<img src="images/fort/battle/defender_primary.png" title="protection" /> '+PK_S3.resultaty[arr[i].ind].bonus;
	}
	else{
	    tmp_div.innerHTML = '<img src="images/task_points/plus.png" width="20" height="20" title="'+title+'" /> '+PK_S3.resultaty[arr[i].ind].bonus;
	}
	...
	for (var s in PK_S3.raboty[arr[i].ind].navyki){
		...
		else{ // characteristic of the design
		    // class="skill_box skill_circle_flexibility"
		    var clas = 'skill_box skill_circle_'+s;
		    var span1 = new Element('span', {'class':clas, 'title':Character.attribute_titles[s]+': '+PK_S3.resultaty[arr[i].ind].skills[s]});
		    span1.innerHTML = '<span class="skill_value">'+PK_S3.resultaty[arr[i].ind].skills[s]+'</span>';
	...
	for (var j = 0; j < PK_S3.types.length; ++j){
		...
		if (iobj.speed){
		    ...
		    title += 'rate: '+Math.round(100/iobj.speed)+'%';
		}
		if ((iobj.type == 'left_arm')||(iobj.type == 'right_arm')){
		    if (!is_f){
			title += '<br />';
...
PK_S3.minimize_window_rezult2 = function(){
    ...
    bar.firstChild.firstChild.nextSibling.innerHTML='Results';
};
...
PK_S3.show_window_rezultat = function (){
    ...
    xhtml += '<div class="window_borders">';
    xhtml += '  <h2 id="window_' + name + '_title" class="window_title"> </h2>';
    xhtml += '	<a class="window_refresh" href="javascript:AjaxWindow.close(\'' + name + '\'); PK_S3.show_window_rezultat();void(0)" title="<b>Redraw</b>"></a>'
    xhtml += '  <a href="javascript:AjaxWindow.closeAll();" class="window_closeall" title="<b>Close all windows</b>"></a>';
    xhtml += '  <a href="javascript:PK_S3.minimize_window_rezult();" class="window_minimize" title="<b>Close the window</b>"></a>';
    xhtml += '  <a href="javascript:AjaxWindow.close(\'' + name + '\');" class="window_close" title="<b>Close the window</b>"></a>';
    xhtml += '  <div id="window_' + name + '_content" class="window_content">';
    xhtml += '    	<table class="shadow_table" style="margin-left:6px; width:100%; height:390px">';
    xhtml += '    		<tr>';
    ...
    span.innerHTML = '<a href="javascript:PK_S3.sortirovka_rabot(\'name\', PK_S3.vyvod.type)"><img src=\"../images/work/icons/work.png\" title=\"name\" /></a>'
    sortir.appendChild(span);
    var span = new Element('div', {'style':'padding: 3px; border-right: 2px solid #321; float:left; height:20px;', 'id':'pk_s3_sortirovka_opyt'});
    span.innerHTML = '<a href="javascript:PK_S3.sortirovka_rabot(\'opyt\', PK_S3.vyvod.type)"><img src=\"../images/work/icons/experience.png\" title=\"experience\" /></a>';
    sortir.appendChild(span);
    var span = new Element('div', {'style':'padding: 3px; border-right: 2px solid #321; float:left; height:20px;', 'id':'pk_s3_sortirovka_dengi'});
    span.innerHTML = '<a href="javascript:PK_S3.sortirovka_rabot(\'dengi\', PK_S3.vyvod.type)"><img src=\"../images/work/icons/dollar.png\" title=\"earnings\" /></a>';
    sortir.appendChild(span);
    var span = new Element('div', {'style':'padding: 3px; border-right: 2px solid #321; float:left; height:20px;', 'id':'pk_s3_sortirovka_vezenie'});
    span.innerHTML = '<a href="javascript:PK_S3.sortirovka_rabot(\'vezenie\', PK_S3.vyvod.type)"><img src=\"../images/work/icons/luck.png\" title=\"good luck\" /></a>';
    sortir.appendChild(span);
    var span = new Element('div', {'style':'padding: 3px; border-right: 2px solid #321; float:left; height:20px;', 'id':'pk_s3_sortirovka_boom'});
    span.innerHTML = '<a href="javascript:PK_S3.sortirovka_rabot(\'boom\', PK_S3.vyvod.type)"><img src=\"images/job/danger.png\" width="20" height="20" title=\"danger\" /></a>';
    sortir.appendChild(span);
    var span = new Element('div', {'style':'padding: 3px; border-right: 2px solid #321; float:left; height:20px;', 'id':'pk_s3_sortirovka_to'});
    span.innerHTML = '<a href="javascript:PK_S3.sortirovka_rabot(\'to\', PK_S3.vyvod.type)"><img src=\"../images/work/icons/workpoints.png\" title=\"labor points\" /></a>';
    sortir.appendChild(span);
    var span = new Element('div', {'style':'padding: 3px; border-right: 2px solid #321; float:left; height:20px;', 'id':'pk_s3_sortirovka_malus'});
    span.innerHTML = '<a href="javascript:PK_S3.sortirovka_rabot(\'malus\', PK_S3.vyvod.type)"><img src=\"../images/work/icons/malus.png\" title=\"Requirements\" /></a>';
    sortir.appendChild(span);
    var span = new Element('div', {'style':'padding: 3px; border-left: 2px solid #321; float:right; height:20px;'});
    var inp = new Element ('input', {'id':'pk_s3_sortirovka_native', 'title':'Take into account the effect of the current MOT', 'type':'checkbox', 'checked':'true', 'style':'margin: 5px 5px 5px 0px;'});
    ...
    var inp = new Element ('input', {'id':'pk_s3_sortirovka_valueto', 'type':'text', 'size':'3', 'value':valueto, 'title':'Cut off from the MOT, less than:', 'style':'background-color:#e8dab3; margin: 0px 5px;'});
    ...
    var img = new Element ('img', {'style':'width:23px; height:23px; background:url("../images/window/messages/icons.png") -25px -4px; display:inline; margin: 0px 2px;', 'src':'/images/transparent.png', 'title':'to restore the'});
...
PK_S3.second_init = function (){
    ...
    if (el.checked){
	PK_S3.raboty[999] = {rus_name:'designer', name:'constructor', malus:0, navyki:{}, resultaty:{dengi:0, opyt:0, vezenie:0, boom:0, produkty:{}}};
...
PK_S3.waiting_inventory = function (){
	...
	Wear.open();
	PK_S3.show_text_message('We expect the opening of luggage...',2000);
	...
	PK_S3.show_popup_message ('error', 'Pre-open the luggage');
    }
};
...
PK_S3.parsing_inventory = function (){
	...
	for (var vv in bagazh[typ]){
	    ...
	    if (compar.err||compar.mis||compar.opis){
	        ...
	        PK_S3.informer += compar.err ? 'Item information is incorrect:\n' : compar.mis ? 'Otsutvie / incomplete description of the subject:\n' : 'Нevernoe Subject:\n'
	...
	if (odezhda[PK_S3.types[i]]){
		...
		PK_S3.informer += compar.err ? 'Item information is incorrect:\n' : compar.mis ? 'Otsutvie / incomplete description of the subjectа:\n' : 'Invalid object name:\n'
...
PK_S3.prostoj_otbor_to = function(){
	...
	if (irabota==0) {PK_S3.show_popup_message('error', 'First, select a job, a duel, a fort, a designer or professional. bust'); setTimeout(PK_S3.otbor_nuzhnykh, 100);continue};
...
PK_S3.equip_start = function(){
	...
	PK_S3.show_text_message ('Expect to open the luggage...', 5000);
    }
...
PK_S3.equip_wait_bagazh = function(){
	...
	PK_S3.show_text_message ('Unable to open the luggage!', 5000);
	return;
    }
    if ((!wman.getById(Wear.uid)) || (!(Bag.loaded))){
...
PK_S3.equip_carring = function(){
	...
	if (Character.characterSex == 'male'){
	    PK_S3.show_text_message ('You re dressed!', 5000);
	}
	else{
	    PK_S3.show_text_message ('You re dressed!', 5000);
	}
    ...
    PK_S3.show_text_message ('dress!', 1000);
...
PK_S3.equip_wait_carry = function() {
	...
	PK_S3.show_text_message ('thing: '+PK_S3.items[PK_S3.odevalo4ka.items[0]].name+' failed to put!', 3000);
	PK_S3.odevalo4ka.items.shift();
	PK_S3.equip_carring();
	return;
    }
...
PK_S3.check_raboty = function (){
	...
	for (var i = 1; i < PK_S3.raboty.max; ++i){
	    if (JobList[i]&&JobList[i].name && (JobList[i].name != PK_S3.raboty[i].rus_name)){
	        PK_S3.informer += 'Incorrect work. The old name: "'+PK_S3.raboty[i].rus_name+'", new name: "'+JobList[i].name+'"\n';
...
PK_S3.save_nabory = function (){
    ...
    PK_S3.show_text_message ('Kits are stored', 1500);    
}
...
PK_S3.equip_motivation = function (job_name){
    ...
    PK_S3.show_text_message ('No saved set', 3000);
};
...
PK_S3.spam_bagazh = function(){
    ...
    var inp = new Element ('input', {'id':'pk_s3_odevalo4ka_input', 'type':'text', 'value':'A new set of', 'style':'width: 150px; background-color:#e8dab3; font-size:11px; height:13px;'});
...
var dyMarketHelperCode = function (currentVersion, scriptWebsite) {
	...
	function marketHelperTabClick(tabObj, tabId) {
		...
		if (tabId === prefix) {
//======++++=======
			setMessage("the city where you have to collect purchased items"); //towns from where you need to collect purchased items
//======++++=======
		} else {
...
//======++++=======
			tabName = "Shopping at the market", $marketHelperTab = null; //Market purchase
//======++++=======
		marketHelperTab = wman.open(prefix).setMiniTitle(tabName).setSize(840, 655)
			.addTab(tabName, prefix, marketHelperTabClick)
//======++++=======
			.addTab("help", prefix + "Help", marketHelperTabClick); //Help
//======++++=======
	...
	function populateFiltersBlock($filters) {
		...
		$filters.html("");
//======++++=======
		filtersHtml = "purchased items: "; //Purchased items:
//======++++=======
		//all
...
//======++++=======
			'title="Show all cities and things">Все</label>'; //Show all towns and items >< All
//======++++=======
		//finish
...
//======++++=======
			'title="Show only the city and the things that you can take now">finished</label>'; //Show only towns and items that you can collect now >< Finished
//======++++=======
		//progress
...
//======++++=======
			'title="Show only cities and things where you did not rate and the auction is over">not finished</label>'; //Show only towns and items from where you have placed bids and auction didn\'t finished >< Progress
//======++++=======
