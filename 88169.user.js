// ==UserScript==
// @author         Roktaal changed by Em The Great
// @co-author      asylume
				...
				try {
					...
					if(prodLevel == -1) {
						...
						if(workResultTD.text() != '') {
							...
							$('.p_container').eq(index).append('<div class="t" id="t_profit_' + profileId + '"><div id="hiddenHealth" style="display: none">' + t_health + '</div>t: <strong style="font-size: 11px; color:' + colorChoose(t_profit) + '">' + mathRound(t_profit, 2).toFixed(2) + '</strong><div class="ttip"><table><tr><td align="center" style="padding: 5px 5px 5px 5px;"><strong>Profit in theory</strong></td></tr><tr><td align="center" style="padding: 5px 3px 5px 6px;">Productivity</td></tr><tr><td align="center" style="padding: 5px 3px 5px 6px;"><strong>' + mathRound(t_productivity, 0) + '</strong></td></tr></table><table><tr><td colspan="2" align="center" style="padding: 5px 5px 5px 5px;">Worker state</td></tr><tr><td align="center" style="border-bottom: none;"><span class="t_health"><strong>' + t_health.toFixed(2) + '</strong></span></td></tr></table><table><tr><td colspan="2" align="center" style="padding: 5px 5px 5px 5px; border-top: 1px solid #eeeeee;">Salary</td></tr><tr><td valign="bottom" align="center" style="border-bottom: none; padding: 5px 3px 5px 6px;"><img src="http://www.erepublik.com/images/flags/S/' + currency_country[ecur] + '.gif"><br/><strong>' + mathRound(parseFloat(salary), 2).toFixed(2) + '</strong></td><td valign="bottom" align="center" style="border-bottom: none; padding: 5px 6px 5px 3px;"><img src="http://www.erepublik.com/images/parts/icon-gold.gif"><br/><strong>' + mathRound(parseFloat(salary) * ex_rate, 3).toFixed(3) + '</strong></td></tr></table></div></div>');
