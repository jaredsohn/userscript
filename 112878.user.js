...
// @namespace      Robert
// @version        1
// @description    Battle Pirates Screen
// @include        http://apps.facebook.com/battlepirates/*
// ==/UserScript==
...
if (document.URL.search(/apps.facebook.com\/battlepirates/i) >= 0){
  facebookInstance ();
  return;
}
if (document.URL.search(/battlepirates.com/i) >= 0){
  wideScreen ();
}
