//  Copyright (C) 2008 by fire_wraith MAIL: aberbittemitsahne45@web.de
...
// ==UserScript==
// @name          SVZ Sidebar *UPDATE v.1.41*
// @namespace     http://userscripts.org
// @description	  Zeigt alle Freunde die "online" sind auf jeder Seite in einer Sidebar an.
// @author         fire_wraith
// @homepage      http://userscripts.org/scripts/show/22559
// @include       http://schuelervz.net/Start*
// @include       https://schuelervz.net/Start*
// @include       http://*.schuelervz.net/Start*
// @include       https://*.schuelervz.net/Start*
// @include       http://schuelervz.net/Profile*
// @include       https://schuelervz.net/Profile*
// @include       http://*.schuelervz.net/Profile*
// @include       https://*.schuelervz.net/Profile*
// @include       http://schuelervz.net/Friends/All*
// @include       https://schuelervz.net/Friends/All*
// @include       http://*.schuelervz.net/Friends/All*
// @include       https://*.schuelervz.net/Friends/All*
// @include       http://schuelervz.net/Friends/PhotoAlbums*
// @include       https://schuelervz.net/Friends/PhotoAlbums*
// @include       http://*.schuelervz.net/Friends/PhotoAlbums*
// @include       https://*.schuelervz.net/Friends/PhotoAlbums*
// @include       http://schuelervz.net/Friends/PhotoAlbums/EditPhotos*
// @include       https://schuelervz.net/Friends/PhotoAlbums/EditPhotos*
// @include       http://*.schuelervz.net/Friends/PhotoAlbums/EditPhotos*
// @include       https://*.schuelervz.net/Friends/PhotoAlbums/EditPhotos*
// @include       http://schuelervz.net/Groups*
// @include       https://schuelervz.net/Groups*
// @include       http://*.schuelervz.net/Groups*
// @include       https://*.schuelervz.net/Groups*
// @include       http://schuelervz.net/Messages*
// @include       https://schuelervz.net/Messages*
// @include       http://*.schuelervz.net/Messages*
// @include       https://*.schuelervz.net/Messages*
// @include       http://schuelervz.net/Account*
// @include       https://schuelervz.net/Account*
// @include       http://*.schuelervz.net/Account*
// @include       https://*.schuelervz.net/Account*
// @include       http://schuelervz.net/Privacy*
// @include       https://schuelervz.net/Privacy*
// @include       http://*.schuelervz.net/Privacy*
// @include       https://*.schuelervz.net/Privacy*
// @include       http://schuelervz.net/Gruscheln/Status*
// @include       https://schuelervz.net/Gruscheln/Status*
// @include       http://*.schuelervz.net/Gruscheln/Status*
// @include       https://*.schuelervz.net/Gruscheln/Status*

// @include       http://studivz.net/Start*
// @include       https://studivz.net/Start*
// @include       http://*.studivz.net/Start*
// @include       https://*.studivz.net/Start*
// @include       http://studivz.net/Profile*
// @include       https://studivz.net/Profile*
// @include       http://*.studivz.net/Profile*
// @include       https://*.studivz.net/Profile*
// @include       http://studivz.net/Friends/All*
// @include       https://studivz.net/Friends/All*
// @include       http://*.studivz.net/Friends/All*
// @include       https://*.studivz.net/Friends/All*
// @include       http://studivz.net/Friends/PhotoAlbums*
// @include       https://studivz.net/Friends/PhotoAlbums*
// @include       http://*.studivz.net/Friends/PhotoAlbums*
// @include       https://*.studivz.net/Friends/PhotoAlbums*
// @include       http://studivz.net/Friends/PhotoAlbums/EditPhotos*
// @include       https://studivz.net/Friends/PhotoAlbums/EditPhotos*
// @include       http://*.studivz.net/Friends/PhotoAlbums/EditPhotos*
// @include       https://*.studivz.net/Friends/PhotoAlbums/EditPhotos*
// @include       http://studivz.net/Groups*
// @include       https://studivz.net/Groups*
// @include       http://*.studivz.net/Groups*
// @include       https://*.studivz.net/Groups*
// @include       http://studivz.net/Messages*
// @include       https://studivz.net/Messages*
// @include       http://*.studivz.net/Messages*
// @include       https://*.studivz.net/Messages*
// @include       http://studivz.net/Account*
// @include       https://studivz.net/Account*
// @include       http://*.studivz.net/Account*
// @include       https://*.studivz.net/Account*
// @include       http://studivz.net/Privacy*
// @include       https://studivz.net/Privacy*
// @include       http://*.studivz.net/Privacy*
// @include       https://*.studivz.net/Privacy*
// @include       http://studivz.net/Friends/Gruscheln/Status*
// @include       https://studivz.net/Friends/Gruscheln/Status*
// @include       http://*.studivz.net/Friends/Gruscheln/Status*
// @include       https://*.studivz.net/Friends/Gruscheln/Status*

// ==/UserScript==
var css = "@namespace url(http://www.w3.org/1999/xhtml); #shoutbox { position:fixed !important; }";
...
sbWidth = 210; //sidebar width in pixel
udMin = 30; //minimal update time in seconds
udMax = 60; //maximal update time in seconds
effects = true; //switch animations on/off (true/false)
...
getUsers = function() {
    ...
    //update time
    var now = new Date();
    var time = parseInt(now.getTime()+udMin*1000+Math.random()*(udMax-udMin)*1000).toString();
    GM_setValue('stvz_sb.time', time);
    timeOld = time;
    ...
    var xmlReq = GM_xmlhttpRequest({
        ...
        onload: function(originalRequest) {
            ...
            GM_setValue('stvz_sb.content', content);
            updateSidebar();
        }  
    })
}
...
updateSidebar = function () {
    //GM_log('update');
	var css = "@namespace url(http://www.w3.org/1999/xhtml); #GM_sb { position:fixed !important; }";
    var list = GM_getValue('stvz_sb.content', '');
    ...
    for(var i = 1; i < local_list.length; i += 4) {
        ...
        if(search >= 0)
            updateItem(list.slice(i,i+4), local_list.slice(i,i+4));
        else
    ...
    for(var i = 1; i < list.length; i += 4) {
        ...
        if(search == -1)
            insertItem(list.slice(i,i+4), search);
    }
...
updateItem = function (data, old) {
    if(data.join() != old.join()) {
        ...
        if(effects) {
            ...
            $(item).animate({ backgroundColor: "#FFE0E0" }, 500);
            $(item).animate({ backgroundColor: "white" }, 1500);
        }
    }
}
...
deleteItem = function (id) {
    ...
    if(effects) {
        ...
        $(item).queue(function () {item.parentNode.removeChild(item);});
    }
    else
...
writeItem = function (data) {
    var text = '<div class="commentMetaData" style="border-top: none"><table><tr><td style="vertical-align:top"><a href="'+url+'Profile/'+data[0]+'"><img src="'+data[3]+'" class="m"/></a></td>';
    text += '<td style="vertical-align:top"><b>' + data[1] + '</b><br/><br>';
    text += '<a href="'+url+'Profile/'+data[0]+'">[ Besuchen ]</a><br/>';
	text += '<a href="'+url+'Friends/All/'+data[0]+'/p/1">[ Alle Freunde ]</a><br/>';
	text += '<a href="'+url+'PhotoAlbums/User/'+data[0]+'">[ Falben ]</a><br/>';
    text += '<a href="'+url+'Gruscheln/DialogGruscheln/'+data[0]+'">[ Gruscheln ]</a><br/>';
	text += '<a href="'+url+'Messages/Write/'+data[0]+'">[ Nachricht schicken ]</a><br/>';
	text += '<a href="'+url+'Pinboard/'+data[0]+'/p/1">[ Zur Pinnwand ]</a><br/>';
    if(data[2])
        text += '<br/><span class="label" style="width: auto;">&raquo; ' + data[2] + ' &laquo;</span>';
...
insertItem = function (data, pos) {
    ...
    if(pos == -1)
        ...
        pos = document.getElementById('sb_'+local_list[pos]);
        if(pos.nextSibling)
            box.insertBefore(item, pos.nextSibling);
        else
            box.appendChild(item);
    }
...
initSidebar = function () {
    ...
    all.style.width = parseInt(getComputedStyle(all, '').width) - 170 + sbWidth + 'px';

    var lA = document.getElementById('leftAds');
    lA.style.width = parseInt(getComputedStyle(lA, '').width) + sbWidth + 'px';
    
    var main = document.getElementById('masterRight');
    main.style.width = parseInt(getComputedStyle(main, '').width) + sbWidth + 'px';

    //position header to the right and create overlay
    var top = document.getElementById('topHeader');
    top.style.width = parseInt(getComputedStyle(top, '').width) + sbWidth + 'px';
    top.style.backgroundPosition = 'right';
    
    var navi = document.getElementById('topNavi');
    var head = document.createElement('div');
    head.style.width = parseInt(getComputedStyle(top, '').width) - parseInt(getComputedStyle(navi, '').width) + 'px';
    ...
    foot.style.width = parseInt(getComputedStyle(ph, '').width) + 2 + 'px';
    ph.style.cssFloat = 'left';
    cont.style.cssFloat = 'left';
    foot.style.cssFloat = 'left';

    //create box
    var box = document.createElement('div');
    box.style.width = sbWidth + 'px';
    box.style.cssFloat = 'right';
    box.id = 'GM_sb';

    main.insertBefore(box,main.childNodes[2]);
}
...
checkUpdate = function () {
    ...
    var time = GM_getValue('stvz_sb.time', '0');
...
/* start here */
if( unsafeWindow.IVW.indexOf(';LoggedIn') != -1) {
    ...
    var now = new Date();
    var timeNow = now.getTime();
    if(GM_getValue('stvz_sb.time', '0') > (timeNow + udMax*1000))
        GM_setValue('stvz_sb.time', '0');
