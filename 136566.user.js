// ==UserScript==
// @name           eRepublik battle SPP
// @version        1.0.1
// @author         Opium
// @namespace      eRepublik battle SPP
// @description    http://userscripts.org/scripts/show/136566
...
var arrURL		= currURL.split('/');	// versiunea de matrice
...
function letsJQuery() {
	...
	var content = $j('div#pvp_battle_area');
        ...
        '<p id="pCurrentHit">'+ max_hit +' / ' +  Math.round(current_damage/max_hit) +'</p></div></td></tr>');
	...
	$j('div#enemy_defeated').before(
		...
		'<button id="heros_update">Update</button>&nbsp;&nbsp;Top 5 se updateaza automat, dar poti updata si apasand butonul din stanga' +
