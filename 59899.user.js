...
/**************************************
** VERSION 0.5 ************************
** COPYRIGHT Lolzbrudda@D2jsp.org ******
**************************************/
...
function createHTML(div,user){
	div.innerHTML += '<br/><b>Infinity Guild Rank: ';
	switch(resolveBettorType(user.toUpperCase())){
		case 'med':
			div.innerHTML += '<font color="green"><b>Shane</b></font>';
			break;
		case 'welcher':
			div.innerHTML += '<font color="red"><b>MinorBlood</b></font>';
			break;
		case 'active':
			div.innerHTML += '<font color="purple"><b>wat</b></font>';
			break;
		case 'welcherpaidback':
			div.innerHTML += '<font color="orange"><b>Member</b></font>';
			break;
		case 'trusted':
			div.innerHTML += '<font color="blue"><b><3 Boxxy</b></font>';
			break;
		case 'blacklisted':
			div.innerHTML += '<font color="silver"><b>Dylan</b></font>';
			break;
		case 'unknown':
			div.innerHTML += '<font color="gray"><b>Infinity Lives</b></font>';
			break;
	}
	div.innerHTML += '</b>';
};
