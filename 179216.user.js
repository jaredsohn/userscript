...
// @grant       GM_log
// @grant       GM_info
// @require     https://raw.github.com/sizzlemctwizzle/GM_config/ad3be51aa33944d78e9f2ea8087c2655daaa726b/gm_config.js
...
GM_config.init(vsstring,{
    ...
    'prettyPM':{
        'label':'Enable pretty PMs? (Warning: experimental)',
        'type':'checkbox',
        'default':false
    },
    'profileCiting':{
...
function addSpecialLinks(){
	...
	specialLinks.push('<a href="http://www.hackforums.net/forumdisplay.php?fid=203">Griefing Section</a>');
...
function addQuickMsg(){
    ...
    */
    ...
    GM_xmlhttpRequest({
        ...
        onload: function(response){
            $('#message')[0].innerText = $($($($($($.parseHTML(response.responseText)).filter("#container")[0].children).filter("#content")[0].children).filter(".quick_keys")[0].children).filter("form")[0][4])[0].innerText;
...
function getProfileName(){
    ...
    //GM_log("[HFES] Profile citation should be: "+profileGenerator);
        ...
        GM_xmlhttpRequest({
            ...
            onload: function(response){
                ...
                for(i=0; i<data.length; i++){
                    var url, tid;
                    if(data[i].innerHTML.indexOf('newfolder.gif"') != -1 || data[i].innerHTML.indexOf('newhotfolder.gif"') != -1 || data[i].innerHTML.indexOf('newlockfolder.gif"') != -1 || data[i].innerHTML.indexOf('newlockhotfolder.gif"') != -1){
...
function addfavlink(){
    ...
    //var elementLink = document.getElementById('favforum');
    //elementLink.addEventListener("click", addRemoveFavForum, true);
}

function addToMenu(){
    var menuFavorites, menuSupport, holder;
    menuFavorites = '<li><a href="/favorites.php"><img src="http://www.hackforums.net:8080/uploads/awards/6.jpg" alt="Favorites" title="Favorites">Favorites</a></li>';
    menuSupport = '<li><a href="/showthread.php?tid=3692117"><img src="http://www.sublyme.net/site_media/images/supportGold.png" alt="Support" title="Support HFES Development">Support HFES</a></li>';
...
function addQuoteToMulti(buttonId){
    ...
    if($('#'+buttonId)[0].innerHTML.indexOf('+') != -1){
        ...
        GM_xmlhttpRequest({
            method: "GET",
            url: 'http://www.hackforums.net/newreply.php?tid='+tid+'&pid='+pid,
            onload: function(response){
                try{
                    var tid, newmulti, pid;
                    tid = response.finalUrl.split('tid=')[1].split('&')[0];
                    pid = response.finalUrl.split('pid=')[1];
...
// Custom Emoticons
/*
    '<tr><td style="text-align: center"><img src="http://sublyme.net/site_media/images/smileys/rofl.gif" border="0" class="hfessmilie" alt=":rofl:" style="cursor: pointer;"></td><td style="text-align: center"><img src="http://sublyme.net/site_media/images/smileys/nerd.gif" border="0" class="hfessmilie" alt=":nerd:" style="cursor: pointer;"></td><td style="text-align: center"><img src="http://sublyme.net/site_media/images/smileys/heart.gif" border="0" class="hfessmilie" alt=":heart:" style="cursor: pointer;"></td></tr>',
    '<tr><td style="text-align: center"><img src="http://sublyme.net/site_media/images/smileys/devil.gif" border="0" class="hfessmilie" alt=":devil:" style="cursor: pointer;"></td><td style="text-align: center"><img src="http://sublyme.net/site_media/images/smileys/party.gif" border="0" class="hfessmilie" alt=":wacko:" style="cursor: pointer;"></td><td style="text-align: center"><img src="http://sublyme.net/site_media/images/smileys/kookoo.gif" border="0" class="hfessmilie" alt=":kookoo:" style="cursor: pointer;"></td></tr>',
    '<tr><td style="text-align: center"><img src="http://sublyme.net/site_media/images/smileys/doh.gif" border="0" class="hfessmilie" alt=":doh:" style="cursor: pointer;"></td><td style="text-align: center"><img src="http://sublyme.net/site_media/images/smileys/yawn.gif" border="0" class="hfessmilie" alt=":yawn:" style="cursor: pointer;"></td><td style="text-align: center"><img src="http://sublyme.net/site_media/images/smileys/orly.gif" border="0" class="hfessmilie" alt=":orly:" style="cursor: pointer;"></td></tr>',
    '<tr><td style="text-align: center"><img src="http://sublyme.net/site_media/images/smileys/moo.gif" border="0" class="hfessmilie" alt=":moo:" style="cursor: pointer;"></td><td style="text-align: center"><img src="http://sublyme.net/site_media/images/smileys/chicken.gif" border="0" class="hfessmilie" alt=":chicken:" style="cursor: pointer;"></td><td style="text-align: center"><img src="http://sublyme.net/site_media/images/smileys/oink.gif" border="0" class="hfessmilie" alt=":oink:" style="cursor: pointer;"></td></tr>',
    '<tr><td style="text-align: center"><img src="http://sublyme.net/site_media/images/smileys/dog.gif" border="0" class="hfessmilie" alt=":dog:" style="cursor: pointer;"></td><td style="text-align: center"><img src="http://sublyme.net/site_media/images/smileys/monkey.gif" border="0" class="hfessmilie" alt=":monkey:" style="cursor: pointer;"></td><td style="text-align: center"><img src="http://sublyme.net/site_media/images/smileys/buzz.gif" border="0" class="hfessmilie" alt=":buzz:" style="cursor: pointer;"></td></tr>',
    '<tr><td style="text-align: center"><img src="http://sublyme.net/site_media/images/smileys/nonono.gif" border="0" class="hfessmilie" alt=":nonono:" style="cursor: pointer;"></td><td style="text-align: center"><img src="http://sublyme.net/site_media/images/smileys/pray.gif" border="0" class="hfessmilie" alt=":pray:" style="cursor: pointer;"></td><td style="text-align: center"><img src="http://sublyme.net/site_media/images/smileys/alien.gif" border="0" class="hfessmilie" alt=":alien:" style="cursor: pointer;"></td></tr>',
    '<tr><td style="text-align: center"><img src="http://sublyme.net/site_media/images/smileys/yinyang.gif" border="0" class="hfessmilie" alt=":yinyang:" style="cursor: pointer;"></td><td style="text-align: center"><img src="http://sublyme.net/site_media/images/smileys/bigmoney.gif" border="0" class="hfessmilie" alt=":bigmoney:" style="cursor: pointer;"></td><td style="text-align: center"><img src="http://sublyme.net/site_media/images/smileys/omni.png" border="0" class="hfessmilie" alt=":omni:" style="cursor: pointer;"></td></tr>'
*/
...
function fixSmileyPage(){
    ...
    '<tr><td class="trow1" align="center"><img src="http://sublyme.net/site_media/images/smileys/dog.gif"></td><td class="trow1">Dog</td><td class="trow1">:dog:</td></tr>',
    ...
    for(i=0; i<posts.length; i++){
        ...
        if(donorKeys.indexOf(uid) != -1){
            if(donorList[uid][0]=='g'){
                donorStar = "<img src='http://sublyme.net/site_media/hfesdonorstuff/happystar.png' title='"+donorList[uid][2]+"'></img>";
                if(donorList[uid][1] != ''){
                ...
                donorStar = "<img src='http://sublyme.net/site_media/hfesdonorstuff/alert.png' title='"+donorList[uid][2]+"'></img>";
                if(donorList[uid][1] != ''){
                    donorStar = "<a href='"+donorList[uid][1]+"'>"+donorStar+"</a>";
                }
                $(posts[i]).prepend(donorStar);
...
function addDonorPerksProfile(donorList){
    ...
    if(donorKeys.indexOf(uid) != -1){
        ...
        if(donorList[uid][4] == 'g'){
            $('.largetext').attr("style","background-image:url('http://sublyme.net/site_media/images/shinyname.gif')");
            $('.largetext').attr("title","[HFES] Shiny Supporter");
        }          
    }
}
