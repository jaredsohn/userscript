...
// modified version by Ed Gaillard of original script by Simon Whitaker
// 6 August 2010: first modified version
// 10 August 2010: Fixed 'more' link with suggestion by woble
...
function getPhotoDiv() {
	...
	for (var i = 0; (element = allElements[i]) != null; i++) {
		...
		if (elementClass && elementClass.indexOf('photo-div') != -1)
			return element;
	}
	return null;
}
