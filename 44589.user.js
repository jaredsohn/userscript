...
// @include        http://ch*.staemme.ch/*screen=report*
// @include        http://ch*.staemme.ch/*screen=overview_villages&mode=commands*
// @include        http://ch*.staemme.ch/*screen=overview_villages&mode=incomings*
// @include        http://ch*.staemme.ch/*screen=mail
// @include        http://ch*.staemme.ch/*screen=mail&action=*
// ==/UserScript==
