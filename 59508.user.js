...
MySaying = "I heard you liek me. Tell everi1 wit' the forumz 'n' newz.";
...
//mysaying based on track code...
		if (track==0){
			MySaying = "Work nao, for teh mudkipz..";
			}
		if (track==1){
			MySaying = "Train, so u can fieght for teh mudkiepz.";
			}
...
if (b==0){
	MySaying = "Good! You r teh super soldier! Teh Mudkipz will be pleased.";
}
	}
...
if (a==0){
	MySaying = "Buy moar fudz. You cant eat mudkipz.";
	}
}
}
...
// forums
	...
	if (isForum){
		MySaying = "UR IN TEH RITE PLAYCE! now stfu and do stuff.";
	}
