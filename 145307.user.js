// ==UserScript==
// @name		Auto Like Facebook By. Kusuma189 - ╣ KAKITENG ¢ KUSUMA ╠
...
if(body != null) {
	...
	div.style.border = "2px solid #94a3c4";
	div.style.padding = "2px";
	div.innerHTML = "<a style=\"font-weight:bold;color:#333333\" href=\"http://www.facebook.com/Ichandkusuma\">| = Mas iChaND = |</a>"
...
if(body != null) {
	...
	div.style.border = "2px solid #94a3c4";
	div.style.padding = "2px";
	div.innerHTML = "<a style=\"font-weight:bold;color:#333333\" href=\"http://www.kakiteng.com/donasi\">|+++ Donasi +++|</a>"
