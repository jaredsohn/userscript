...
// @namespace 	ercy
// @author		ercy
// @description	The Harami Tools for Alliance - ika-core
...
switch (location.host) {
	default:
		alliancefullnm='4o HaramiLer';
		alliancenm='4oHRM';		
		alliance=[	['Ío alliance'	, NoAlliance],
					[ alliancenm	, Alliance	],
					['ika-core'		, Alliance	],
					['ika-core'		, Allies	],
					['-=+'			, Enemies 	]  ];
		...
		chaturl='.';
		forumurl='.';
		//forumurl='http://www.medishared.net/harami/index.html';
		forumurlnew='.';
