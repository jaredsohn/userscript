...
// боковые панели
set_style('workbar_left','marginTop','14px');
set_style('workbar_right','marginTop','14px');
//
...
addGlobalStyle('#current_task_box{position:absolute !important; top:66px !important;}');
...
addGlobalStyle('#scroll_to_fort_list{top: -585px !important; left: 128px !important;}');
...
(function(){
	...
	function convertBagInfo(div) {
		...
		sell_value['total'] = sell_value['neck'] + sell_value['head'] + sell_value['right_arm'] + sell_value['left_arm'] + sell_value['body'] + sell_value['yield'] + sell_value['foot'] + sell_value['animal'];
...
items[26] = {item_id:26, nshort:'nats_machete', name:'Мачете Ната', type:'right_arm', level:50, price:6750, image:'images/items/right_arm/nats_machete.png', image_mini:'images/items/right_arm/mini/nats_machete.png', characterClass:null, characterSex:null, speed:null, bonus:{skills:{leadership:6, tough:6}, attributes:{}}, set:{key:null, name:null}, shop:'drop'};\
...
items[261] = {item_id:261, nshort:'sleep_cap', name:'Ночной колпак', type:'head', level:45, price:1200, image:'images/items/head/sleep_cap.png', image_mini:'images/items/head/mini/sleep_cap.png', characterClass:null, characterSex:null, speed:null, bonus:{skills:{}, attributes:{}}, set:{key:'set_sleeper', name:'Набор сони'}, shop:'drop'};\
...
items[313] = {item_id:313, nshort:'poncho_black', name:'Чёрное пончо', type:'body', level:5, price:174, image:'images/items/body/poncho_black.png', image_mini:'images/items/body/mini/poncho_black.png', characterClass:null, characterSex:null, speed:null, bonus:{skills:{animal:4, shot:3, dodge:3}, attributes:{}}, set:{key:null, name:null}, shop:'shop'};\
...
items[357] = {item_id:357, nshort:'leather_coat_black', name:'Чёрная кожанка', type:'body', level:28, price:5000, image:'images/items/body/leather_coat_black.png', image_mini:'images/items/body/mini/leather_coat_black.png', characterClass:null, characterSex:null, speed:null, bonus:{skills:{leadership:11, repair:12, hide:11, tough:12}, attributes:{}}, set:{key:null, name:null}, shop:'shop'};\
...
items[362] = {item_id:362, nshort:'uniform', name:'Форма', type:'body', level:20, price:800, image:'images/items/body/uniform.png', image_mini:'images/items/body/mini/uniform.png', characterClass:'soldier', characterSex:null, speed:null, bonus:{skills:{appearance:2, hide:4}, attributes:{charisma:2}}, set:{key:null, name:null}, shop:'quest'};\
...
items[436] = {item_id:436, nshort:'slippers', name:'Тапочки', type:'foot', level:45, price:2000, image:'images/items/foot/slippers.png', image_mini:'images/items/foot/mini/slippers.png', characterClass:null, characterSex:null, speed:null, bonus:{skills:{}, attributes:{}}, set:{key:'set_sleeper', name:'Набор сони'}, shop:'drop'};\
...
items[834] = {item_id:834, nshort:'peacemaker_billy', name:'Кольт Миротворец Билли', type:'right_arm', level:75, price:10300, image:'images/items/right_arm/peacemaker_billy.png', image_mini:'images/items/right_arm/mini/peacemaker_billy.png', characterClass:null, characterSex:null, speed:null, bonus:{skills:{appearance:7, health:8}, attributes:{}}, set:{key:null, name:null}, shop:'drop'};\
...
items[1755] = {item_id:1755, nshort:'bag', name:'Мешок с добычей', type:'yield', level:null, price:2000, image:'images/items/yield/bag.png', image_mini:'images/items/yield/bag.png', characterClass:null, characterSex:null, speed:null, bonus:{skills:{}, attributes:{}}, set:{key:null, name:null}, shop:'drop'};\
items[1756] = {item_id:1756, nshort:'mask', name:'Маска', type:'yield', level:null, price:200, image:'images/items/yield/mask.png', image_mini:'images/items/yield/mask.png', characterClass:null, characterSex:null, speed:null, bonus:{skills:{}, attributes:{}}, set:{key:null, name:null}, shop:'drop'};\
...
items[1759] = {item_id:1759, nshort:'dfgrocket1a', name:'Фейерверк', type:'yield', level:null, price:2700, image:'images/items/yield/dfgrocket1a.png', image_mini:'images/items/yield/dfgrocket1a.png', characterClass:null, characterSex:null, speed:null, bonus:{skills:{}, attributes:{charisma:2, dexterity:2, flexibility:2, strength:2}}, set:{key:'season_set', name:'Праздничный наряд'}, shop:'quest'};\
items[1760] = {item_id:1760, nshort:'bucket', name:'Пустое ведро', type:'yield', level:null, price:20, image:'images/items/yield/bucket.png', image_mini:'images/items/yield/bucket.png', characterClass:null, characterSex:null, speed:null, bonus:{skills:{}, attributes:{}}, set:{key:null, name:null}, shop:'quest'};\
...
items[1762] = {item_id:1762, nshort:'bucket_fire', name:'Ведро', type:'yield', level:null, price:25, image:'images/items/yield/bucket_fire.png', image_mini:'images/items/yield/bucket_fire.png', characterClass:null, characterSex:null, speed:null, bonus:{skills:{}, attributes:{}}, set:{key:'fireworker_set', name:'Набор пожарного'}, shop:'quest'};\
items[1770] = {item_id:1770, nshort:'bloodycloth', name:'Окровавленный лоскут', type:'yield', level:null, price:1, image:'images/items/yield/bloodycloth.png', image_mini:'images/items/yield/bloodycloth.png', characterClass:null, characterSex:null, speed:null, bonus:{skills:{}, attributes:{}}, set:{key:null, name:null}, shop:'quest'};\
items[1771] = {item_id:1771, nshort:'photo', name:'Старая фотография', type:'yield', level:null, price:1, image:'images/items/yield/photo.png', image_mini:'images/items/yield/photo.png', characterClass:null, characterSex:null, speed:null, bonus:{skills:{}, attributes:{}}, set:{key:null, name:null}, shop:'quest'};\
items[1772] = {item_id:1772, nshort:'umbrella', name:'Зонтик', type:'yield', level:42, price:2800, image:'images/items/yield/umbrella.png', image_mini:'images/items/yield/umbrella.png', characterClass:null, characterSex:'female', speed:null, bonus:{skills:{trade:8, finger_dexterity:6, endurance:10}, attributes:{strength:1}}, set:{key:'set_dancer', name:'Туалет танцовщицы'}, shop:'quest'};\
items[1773] = {item_id:1773, nshort:'testament', name:'Завещание', type:'yield', level:null, price:1, image:'images/items/yield/testament.png', image_mini:'images/items/yield/testament.png', characterClass:null, characterSex:null, speed:null, bonus:{skills:{}, attributes:{}}, set:{key:null, name:null}, shop:'quest'};\
items[1774] = {item_id:1774, nshort:'engagementring', name:'Кольцо', type:'yield', level:null, price:1, image:'images/items/yield/engagementring.png', image_mini:'images/items/yield/engagementring.png', characterClass:null, characterSex:null, speed:null, bonus:{skills:{}, attributes:{}}, set:{key:null, name:null}, shop:'quest'};\
items[1775] = {item_id:1775, nshort:'birthcertificate', name:'Свидетельство о рождении', type:'yield', level:null, price:1, image:'images/items/yield/birthcertificate.png', image_mini:'images/items/yield/birthcertificate.png', characterClass:null, characterSex:null, speed:null, bonus:{skills:{}, attributes:{}}, set:{key:null, name:null}, shop:'quest'};\
items[1776] = {item_id:1776, nshort:'darkplans', name:'Коварные планы', type:'yield', level:null, price:1, image:'images/items/yield/darkplans.png', image_mini:'images/items/yield/darkplans.png', characterClass:null, characterSex:null, speed:null, bonus:{skills:{}, attributes:{}}, set:{key:null, name:null}, shop:'quest'};\
...
items[1778] = {item_id:1778, nshort:'brandingiron', name:'Гнутое тавро', type:'yield', level:null, price:1, image:'images/items/yield/brandingiron.png', image_mini:'images/items/yield/brandingiron.png', characterClass:null, characterSex:null, speed:null, bonus:{skills:{}, attributes:{}}, set:{key:null, name:null}, shop:'quest'};\
";
