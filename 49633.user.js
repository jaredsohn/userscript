// ==UserScript==
// @name           Trabal Wars br21 forum
// @version        1
// @autor          Ziank
// @description    Link rapido para acesso ao forum da tribo no br21
// @include        http://*.tribalwars.com.br/game.php?village=*
// ==/UserScript==
// ===========================================================================
...
unsafeWindow.displaywiki = function() {
	if(displayedflag == 0) {
		document.getElementById("wikiframe").innerHTML = '<iframe width="920" border="0" frameborder="0" height="100%" src="http://br21x.tribalwars.com.br/forum.php?screen=view_forum" style="margin-left:26px;"></iframe>';
		displayedflag = 1;
	}
}
...
var wkHTML = '<div id="wikitab" onmouseover="showwiki()" onclick="hidewiki()"><a style="height:100%;width:100%;"></a></div>'
	...
	+ '<a style="border-bottom:1px #542C0F dotted; color: #542C0F;" href="http://br21x.tribalwars.com.br/forum.php?screen=view_forum">Tribal Wars ally forum</a></div>'
