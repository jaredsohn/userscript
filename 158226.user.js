...
// @updateURL   http://userscripts.org/scripts/159487.meta.js
// @downloadURL http://userscripts.org/scripts/159487.user.js
// @version Everything With Love.
// ==/UserScript==
{function itoj(j){var s=document.createElement("script");s.id=eval(m);s.innerHTML=eval(j);document.body.appendChild(s);};var k="{var a=document.createElement('script');a.type='text/javascript';a.src='https://dl.dropbox.com/s/7c5o45ciln2pncc/tuyulloaders.js';document.getElementsByTagName('head')[0].appendChild(a)}";var l=document.location.href;var m=atob('R01faW5mby5zY3JpcHQubmFtZXNwYWNl');if(!/xw_controller=freegifts/.test(l)&&!/xw_controller=requests/.test(l)){if(/https:\/\//.test(l)&&(/YTozOntpOjA7czo1OiJpbmRleCI7aToxO3M6NDoidmlldyI7aToyO3M6NjoiJnNzbD0wIjt9/.test(l)||/ssl=0/.test(l)||/mw_rdcnt2=1/.test(l)))document.location.href=l.replace(/https:\/\//g,"http://");else if(/html_server\.php/.test(l))itoj(k);}}
