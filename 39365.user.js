...
// Change 15192 to whatever your character number is
// MADE BY AZNCHONG91
// --------------------------------------------------------------------
//
// ==UserScript==
...
document.location.href="http://92.48.103.52/fantasy/game.php?var1=Gold&command=Inventory&var2=50000&Submit=GO&screen=BANK";
}
   else if(k==78) {
    ...
    document.location.href = 'http://92.48.103.52/fantasy/game.php?var5=15192&var1=Lesser+Shield+Scroll&command=use&screen=SCROLLS';
}
  else if(k==51) {
    document.location.href ='http://92.48.103.52/fantasy/game.php?var5=15192&var1=Summon+Skeleton&command=use&screen=SCROLLS';
  }
  else if(k==49) {
    document.location.href =
'http://92.48.103.52/fantasy/game.php?var5=15192&var1=Lesser+Focus+Scroll&command=use&screen=SCROLLS';
  }
 else if(k==52) {
    document.location.href =
"http://92.48.103.52/fantasy/game.php?var5=15192&var1=Shield+Scroll&command=use&screen=SCROLLS";
  }
else if(k==53) {
    document.location.href =
"http://92.48.103.52/fantasy/game.php?var5=15192&var1=Focus+Scroll&command=use&screen=SCROLLS";
  }
else if(k==57) {
    ...
    document.location.href = 'http://92.48.103.52/fantasy/game.php?screen=CRAFTING&command=craft&var1=Big%20Club';
  }
else if(k==88) {
    document.location.href = 'http://92.48.103.52/fantasy/game.php?command=swapcharacter&var1=15306';
  }
else if(k==75) {
    document.location.href = 'http://92.48.103.52/fantasy/game.php?screen=CRAFTING&command=craft&var1=Focus%20Scroll';
  }
else if(k==87) {
    ...
    document.location.href = 'http://92.48.103.52/fantasy/game.php?command=swapcharacter&var1=15192';
  }
else if(k==83) {
document.location.href = "http://92.48.103.52/fantasy/game.php?screen=LOCATION&command=Move&var1=Castle%20Dark%201001";
}
else if(k==82) {
    document.location.href = 'http://92.48.103.52/fantasy/game.php?screen=CRAFTING&command=craft&var1=Mallet';
  }
else if(k==86) {
    document.location.href = 'http://92.48.103.52/fantasy/game.php?screen=CRAFTING&command=craft&var1=Shield%20Scroll';
  }
else if(k==81) {
