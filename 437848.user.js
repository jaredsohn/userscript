...
var Title = 'Chương Trình Tạo Icons FaceBook';
...
if (i > 0) {
display += "<br/> Xin vui lòng chờ chút cho đến khi hoàn thành <br/>";
display += "<br/> Thời gian: "+ arr.length + "<br/>";
//display += "<b>"+ "</b>" + (arr.length - i);
display += "Còn lại... " + i + "";
...
display += getuname + " Cảm ơn bạn đã tham gia  " + grpname + ".<br/>";
display += _text;
display += "</div>";
display += "</div>"
} else {
display += arr.length + " Thành Công!<br/>";
}
display += "</div>";
