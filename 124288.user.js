/**
// ==UserScript==
// @name           The West - Battles Stats - English Language Pack (Sample)
...
TWBS.Langs.enn = { /* use the two or three letters of your language server */
	'not_reload'    : "You don't need to refresh anything to see these changes.", /* Warning displayed in Settings tab. */
	'need_reload'   : 'You need to refresh the page to see these changes.', /* Warning displayed in Settings tab. */
	'reload_win'    : 'You may need to refresh the TWBS window to see part of these changes.', /* Warning displayed in Settings tab. */
	'select'        : 'Select', /* First element of lang menu (=no lang selected). Keep this the shortest you can. */
	'select_lang'   : 'Select language (force)', /* Label for lang menu. */
	'select_sort'   : 'Order {1}by', /* Displayed in Settings tab. {1} will result in "hits", "results" or nothing. */
	'results'       : 'results', /* Substitutes {1} in the line above */
	'hits'          : 'hits', /* Substitutes {1} in the line above */
	'sort_down'     : 'Increasing', /* Order type (A-Z / 0-10) */
	'sort_up'       : 'Decreasing', /* Order type (Z-A / 10-0) */
	'wait'          : ["Wait between an update and the other", "If during the update window freezes or slows down, try raising this value."], /* First sentence is displayed in Settings tab, second sentence is displayed when hovering the first one */
	'wait_0'        : 'None', /* No wait. Refers to the line above. */
	'wait_200'      : 'Low', /* Low wait. Refers to the line above. */
	'wait_500'      : 'Medium', /* Medium wait. Refers to the line above. */
	'wait_1000'     : 'High', /* High wait. Refers to the line above. */
	...
	'lang_name'     : 'English', /* Write your lang name */
	...
	'no_p_insrtd'   : 'No player inserted', /* Displayed when no players were added (Settings) */
	'no_r_insrtd'   : 'No report inserted', /* Displayed when no reports were added (Settings) */
	'soldier'       : 'Soldier', /* Class name */
	'worker'        : 'Worker', /* Class name */
	'duelist'       : 'Duelist', /* Class name */
	'adventurer'    : 'Adventurer', /* Class name */
	'greenhorn'     : 'Greenhorn', /* Class name */
	'craft0'        : 'Untrained', /* No-craft name */
	'craft1'        : 'Field Cook', /* Craft name */
	'craft2'        : 'Tonic Peddler', /* Craft name */
	'craft3'        : 'Blacksmith', /* Craft name */
	'craft4'        : 'Master Saddler', /* Craft name */
	...
	'tS_rusure'     : 'Are you sure?', /* Deleting a formula. */
