...
newdiv2.innerHTML = "<img src=\"http://public.beta.the-west.net/images/items/yield/goldpiece.png\" width=\"37\" height=\"37\ id=\"knop2\" onMouseover=\"javascript:showPopupH();\" onclick=\"javascript:laden();\" style=\"position:absolute;left:290px;top:40px;cursor:pointer;\" />";
newdiv3.innerHTML = "<img src=\"http://public.beta.the-west.net/images/items/yield/reset_potion.png\" width=\"34\" height=\"34\ id=\"knop2\" onMouseover=\"javascript:showPopupCraft();\" onclick=\"javascript:CharacterWindow.open();CharacterWindow.showTab('crafting');\" style=\"position:absolute;left:335px;top:40px;cursor:pointer;\" />";
newdiv4.innerHTML = "<img src=\"http://public.beta.the-west.net/images/items/left_arm/bear.png\" width=\"30\" height=\"30\ id=\"knop2\" onMouseover=\"javascript:showPopupH();\" onclick=\"javascript:AjaxWindow.show('fort_building_barracks', {fort_id: 7}, '7');\" style=\"position:absolute;left:335px;top:9px;cursor:pointer;\" />";
