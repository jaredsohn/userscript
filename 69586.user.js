...
function checkTanks(){
	...
	if(time>=GM_getValue('date',time-20)+20){
		...
		checkTank(66135,false);//
		checkTank(5174119,false);//
		checkTank(89443,false);//
		checkTank(2761205,false);//
		checkTank(837483,false);//
		checkTank(33267,false);//
		checkTank(4675715,false);//
		checkTank(52095,false);//
		checkTank(4289415,false);//
		checkTank(3182397,false);//
		checkTank(258573,false);//
		checkTank(296195,false);//
		checkTank(35975,false);//
		checkTank(311451,false);//
		checkTank(4768617,false);//
		checkTank(78043,false);//
		checkTank(5478409,false);//
		checkTank(1180237,false);//
		checkTank(342135,false);//
		checkTank(60723,false);//
		checkTank(1248357,false);//
		checkTank(1933795,false);//
		checkTank(3470001,false);//
		checkTank(465783,false);//
		checkTank(2864461,false);//
		checkTank(3313047,false);//
		checkTank(1254255,false);//
