...
// @include http://s3.travian.ir/*.php*
// @exclude http://s3.travian.ir/hilfe.php*
// @exclude http://s3.travian.ir/log*.php*
// @exclude http://s3.travian.ir/index.php*
// @exclude http://s3.travian.ir/anleitung.php*
// @exclude http://s3.travian.ir/impressum.php*
// @exclude http://s3.travian.ir/anmelden.php*
// @exclude http://s3.travian.ir/gutscheine.php*
// @exclude http://s3.travian.ir/spielregeln.php*
// @exclude http://s3.travian.ir/links.php*
// @exclude http://s3.travian.ir/geschichte.php*
// @exclude http://s3.travian.ir/tutorial.php*
// @exclude http://s3.travian.ir/ad/*
// @exclude http://s3.travian.ir/chat/*
// @exclude http://forum.travian.ir
// @exclude http://shop.travian.ir
// @version 1.10
...
function funcionPrincipal(e){
	...
	if (find('//table[@class="traders"]', XPFirst)) {
		...
		xpathResult2 = find('//table[@class="traders"]//td[@class="in"]', XPIter);
