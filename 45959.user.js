...
// @name	Trooptool Updater GR (gr3)
// @description	Update your troop tool with one click from the rally point. (Ready for s3.travian.gr)
...
var sLang = "gr";
var sGetParameters = "";
var sCurrentServer = "s3.travian.gr";    // Set this to the server's url to override automatic server detection
                            // (i.e. s1.travian.net)
                            // Dont set it if you're playing on multiple servers simultaneously!
							//Allready set for s3.travian.gr
