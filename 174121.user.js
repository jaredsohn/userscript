...
// @name           e-sim LT
// @namespace      e-sim LT
// @description    e-Sim in lithuanian
// @version        1.0
// @include        http://*.e-sim.org*
// @icon 		   http://e-sim.home.pl/testura/img/favicon.png
// @grant          none
// ==/UserScript==
//Lithuanian translation by donce151
//

menuLinkReplacements = {
	"work.html"				:["Work","Darbas"],
	"train.html"			:["Train","Treniruotės"],
	"equipment.html"		:["Equipment","Įranga"],
	"companies.html"		:["Companies","Kompanijos"],
	"newspaper.html"		:["Newspaper","Laikraštis"],
	"myParty.html"			:["Party","Partija"],
	"contracts.html"		:["Contracts","Kontraktai"],
	"myShares.html"		    :["Shares","Akcijos"],
	"myAuctions.html"		:["Auctions","Aukcionai"],
        "inviteFriends.html"	:["Invite friends","Pakviesk draugų!"],
	"myMilitaryUnit.html"	:["Military unit","Karinis burys"],
	"subscription.html"     :["Premium account","Privilegijos"],
	
	"productMarket.html"	:["Product market","Turgus"],
	"jobMarket.html"		:["Job market","Darbo birža"],
	"monetaryMarket.html"	:["Monetary market","Valiutų rinka"],

	"auctions.html"		    :["Auctions","Aukcionai"],
	"stockMarket.html"	    :["Stock market","Akcijų birža"],
	"companiesForSale.html"	:["Companies for sale","Parduodamos kompanijos"],
	"specialItems.html"		:["Special items","Papildai"],
	...
	"citizenStatistics.html"		:["Citizen statistics","Žaidėjų statistika"],
	"militaryUnitStatistics.html"	:["Military unit stats","Karinių burių statistika"],
        "stockCompanyStatistics.html"	:["stock market stats","AB statistika"],
...
"news.html\?newsType=TOP_ARTICLES"		:["Top articles","Geriausi straipsniai"],
	...
	"news.html\?newsType=MILITARY_EVENTS"	:["Military events","Karo veiksmai"],
	"news.html\?newsType=POLITICAL_EVENTS"	:["Political events","Politiniai įvykiai"],
	
	"battles.html"							:["Battles","Mūšiai"],
	"countryPoliticalStatistics.html"		:["War and politics","Seimas"],
	"countryEconomyStatistics.html"			:["Economy","Šalies ekonomika"],
	"countryLaws.html"						:["Laws","Šalies įstatymai"],
	"partyElections.html"					:["Party elections","Partijos rinkimai"],
	"congressElections.html"				:["Congress elections","Seimo rinkimai"],
	...
	"googleMap.html"						:["Map","Žemėlapis"],
        "newMap.html" :["New Map","Naujas žemėlapis"]

};

menuTextReplacements = {
	"myPlacesButton":["My places","Pagrindinis"],
	"marketButton":["Market","Turgus"],
	"statisticsButton":["Statistics","Statistikos"],
...
MonetaryMarketRemplacement = {
	"http://wiki.e-sim.org/en/MonetaryMarket"	:["Monetary market tutorial","Valiutų rinkos pamokos"],
};
...
function replaceBattleTime(obj) {
    if (obj.innerHTML.match(/[\d\.]+/g)== 1) {
        ...
        if (obj.innerHTML.match("day ago")) {
            obj.innerHTML = obj.innerHTML.replace(/(\d*) day ago/g,"Prieš dieną");
        }  
        ...
        if (obj.innerHTML.match("seconds ago")) {
            obj.innerHTML = obj.innerHTML.replace(/(\d*) seconds ago/g,"Prieš $1 sekundę");
        }  
        if (obj.innerHTML.match("minutes ago")) {
            obj.innerHTML = obj.innerHTML.replace(/(\d*) minutes ago/g,"Prieš $1 minutes");
        }  
        if (obj.innerHTML.match("hours ago")) {
            obj.innerHTML = obj.innerHTML.replace(/(\d*) hours ago/g,"Prieš $1 valandas");
        }  
        if (obj.innerHTML.match("days ago")) {
            obj.innerHTML = obj.innerHTML.replace(/(\d*) days ago/g,"Prieš $1 dienas");
        }  
        if (obj.innerHTML.match("months ago")) {
            obj.innerHTML = obj.innerHTML.replace(/(\d*) months ago/g,"Prieš $1 mėnesius");
        }
    }
}
