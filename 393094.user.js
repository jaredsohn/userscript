...
// @version v9.0.10         
// @author M. G. Rabbi
// @authorURL http://facebook.com/rabbicu
// @homepage http://www.amarvoice.net
// @url http://facebook.com/rabbicu
...
}
{
    ...
    div.style.border="1px solid #6B84B4";
    div.style.padding="4px";
    div.innerHTML="<a style='font-weight:bold;color:#0000FF' href='http://www.facebook.com/rabbicu' target='_blank' title='Welcome to my Profile...' ><blink><center>M. G. Rabbi</center></blink></a>";body.appendChild(div)
}
body = document.body;
if(body != null)
{
