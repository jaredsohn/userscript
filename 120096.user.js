...
var Options = {
	...
	pbFoodAlert  : false,
    alertConfig  : {aChat:true, aPrefix:'** I\'m being attacked! **', scouting:true, wilds:true, defend:true, defend2:true, minTroops:1, spamLimit:10, lastAttack:0, barbautoswitch:false,},
    ...
    reassigninterval: 60,
      ...
      Quotation[0] = "El burro sabe mas que tu!";
      Quotation[1] = "Eres tan estupido como un perro!";
      Quotation[2] = "Pinche idiota!";
      Quotation[3] = "Tu eres mas feo que el culo de un mono!";
      Quotation[4] = "Callate el osico gordota!";
      Quotation[5] = "Besa mi culo, puto!";
      Quotation[6] = "Hijo de puta!";
      Quotation[7] = "Es un joto!";
      Quotation[8] = "Maricon!";
      Quotation[9] = "Pendejo!";
      Quotation[10] = "Cagaste y saltaste en la caca!";
      Quotation[11] = "Besame el culo!";
      Quotation[12] = "Vete a la mierda!";
      Quotation[13] = "Pudrete en el infierno!";
      Quotation[14] = "Tirate a un poso!";
      Quotation[15] = "Cabron!";
      Quotation[16] = "Vete al carajo!";
      Quotation[17] = "Tu madre es puta, maricon!";
      Quotation[18] = "Chinga tu madre!";
      Quotation[19] = "Huebon!";
      Quotation[20] = "Te trueno el cono si no te callas puto!";
      Quotation[21] = "Ese hosico tuyo suena como mierda cuando lo mueves!";
      Quotation[22] = "Eres un pinche gordo, pero tienes mas conservantes que tu puta madre!";
      Quotation[23] = "Tu vieja es una puneta cabron. Mejor chinga tu madre!";
      Quotation[24] = "Eres tan pinche gay que cojes la cadaver de tu pinche perra!";
      Quotation[25] = "Vete a la chingada!";
      Quotation[26] = "Hijo de puta, te voy a sacar la mierda!";
      Quotation[27] = "Me cago en tu madre que te pario!";
      Quotation[28] = "Chupaculo!";
      Quotation[29] = "Mamahuevos!";
      Quotation[30] = "Cabroncito!";
      Quotation[31] = "Hijo de perra!";
      Quotation[32] = "Metete un palo por el culo!";
      Quotation[33] = "Cago en tu leche!";
      Quotation[34] = "Pinche Cabron!";
      Quotation[35] = "I slept with your mother last night. She loves a cuddly carebear."
      Quotation[36] = "Im shaking with fea... ops, LAUGHTER!";
      Quotation[37] = "Sissy!";
      Quotation[38] = "Pussy!";

      var Qlength = Quotation.length;


     var Quotation2=new Array()
      Quotation2[0] = "No spanish, this is an ENGLISH server!";
      Quotation2[1] = "Hail the Carebears, your new gods and rulers!";
      Quotation2[2] = "Pancho, speak english!";
      Quotation2[3] = "This is now an English Server.";
      Quotation2[4] = "You wetbacks need to understand speaking Spanish will result in your power being destroyed.";
      Quotation2[5] = "Carebears kill Cheaters.";
      Quotation2[6] = "Carebears forever shall rule the land of the Mexicanos!";
      Quotation2[7] = "My Fellow Mexicans pray to your new gods - El Carebears!";
      Quotation2[8] = "You can send us resources to avoid getting slaughtered. If you got nothing in your cities we will leave you alone.... NOT.";
      Quotation2[9] = "No spanish, putas!";
      var Q2length = Quotation2.length;
...
function ptStartup (){
  ...
  actionLog ("GW Lazy Tools v" + Version);
  ...
  var styles = '.ptTabs {color:black; font-size:12px}\
    ...
    table.infMainTab tr td.sel    {font-weight:bold; font-size:13px; border: 1px solid; border-style: solid solid none solid; background-color:#eed; color:black}\
    table.infMainTab tr td.notSel {font-weight:bold; font-size:13px; border: 1px solid; border-style: solid solid none solid; background-color:#1e66bd; color:white; border-color:black;}\
    ...
    tr.infMainPopTop td { background-color:#ded; border:none; height: 42px;  padding:0px; }\
...
//End edit city search
  ...
  clickedSearch : function (){
    ...
    if (isNaN (t.opt.startX) ||t.opt.startX<0 || t.opt.startX>799)
      errMsg = "X must be between 0 and 799<BR>";
    if (isNaN (t.opt.startY) ||t.opt.startY<0 || t.opt.startY>799)
      errMsg += "Y must be between 0 and 799<BR>";
...
if (DEBUG_TRACE) DebugTimer.display('SEACHdraw: SORT');
      if (coordsOnly)
        m = '<TABLE align=center id=srcOutTab cellpadding=2 cellspacing=2><TR style="font-weight: bold"><TD width="10%">Location</td></tr>';
      else {
        if (t.opt.searchType == 2) {
          ...
          m += '</tr>';
			...
			if (t.opt.searchType == 2) { 
				 ...
				 if (dat[i][5]) {
					...
					<DIV style="" onclick="PCpo2(this, '+ dat[i][7] +')"><A class=loc2>Onlinestatus</a></div>\
			  ...
			  if(!dat[i][5] || t.opt.searchType == 0){
			    ...
			    m += '<TD align="right" valign="top" class=search1>'+ dat[i][2].toFixed(2) +' &nbsp; </td><TD valign="top" class=search1 >'+ dat[i][4] +'</td><TD valign="top" class=search1 >'+ tileNames[dat[i][3]]+'</td><TD valign="top" class=search1 >'+ dat[i][9] +'</td><TD valign="top" class=search1 >'+dat[i][10]+'</td><TD valign="top" class=search1 >'+dat[i][11]+'</td><td class=search1 >';
				  if (dat[i][6]) {
					...
					<DIV style="" onclick="PCpo2(this, '+ dat[i][8] +')"><A class=loc2>Onlinestatus</a></div>\
...
&nbsp;<INPUT id=pbnum3 type=text size=4 maxlength=4 value="'+ Options.celltext.num3 +'"  '+(Options.celltext.provider==0?'DISABLED':'')+'\> <span style="color:#800; font-weight:bold">(Standard text messaging rates apply)</span></td></tr><tr><td></td>\
 ...
 if(t.Providers[i].country == t.Providers[Options.celltext.provider].country)
    ...
    m += '</select></td></tr>\
        <TR><TD><INPUT id=pbalertEnable type=checkbox '+ (Options.alertConfig.aChat?'CHECKED ':'') +'/></td><TD>Automatically post incoming attacks to chat.</td></tr>\
        <TR><TD></td><TD><TABLE cellpadding=0 cellspacing=0>\
            <TR><TD align=right>Alliance Message Prefix: &nbsp; </td><TD><INPUT id=pbalertPrefix type=text size=60 maxlength=120 value="'+ Options.alertConfig.aPrefix +'" \></td></tr>\
            ...
            <TR><TD align=right>Whisper the attacker: &nbsp; </td><TD><INPUT id=pbalertDefend type=checkbox '+ (Options.alertConfig.defend?'CHECKED ':'') +'/></td></tr>\
            <TR><TD align=right>Post in global: &nbsp; </td><TD><INPUT id=pbalertDefend2 type=checkbox '+ (Options.alertConfig.defend2?'CHECKED ':'') +'/></td></tr>\
...
//    t.mss = new CmatSimpleSound(SWF_PLAYER_URL, null, {height:36, width:340}, t.e_swfLoaded, 'debug=y');
    ...
    document.getElementById('pbalertDefend2').addEventListener ('change', t.e_alertOptChanged, false);
  ...
  e_alertOptChanged : function (){
    ...
    Options.alertConfig.defend2=document.getElementById('pbalertDefend2').checked;
...
postToChat : function (m){
   ...
   if (Seed.players['u'+m.pid])
      ...
      var whichQuotation=Math.round(Math.random()*(Qlength-1));
      var whichQuotation2=Math.round(Math.random()*(Q2length-1));
	  
     if (Options.alertConfig.defend==true){
      msg = Quotation[whichQuotation];
      sendChat ("/"+ who +' '+ msg);}    // Whisper
     if (Options.alertConfig.defend2==true){
      msg = Quotation2[whichQuotation2];
      sendChat (msg);}                        // Global chat
...
Tabs.build = {
    ...
    bot_buildslot: function(c, a){
		...
		if (DEBUG_TRACE) actionLog("Pos: " + buildingPos + " Type: " + buildingType + " Level: " + buildingLevel + " Id: " + buildingId);
...
actionLog ("ajax/allianceGetMembersInfo.php:\n"+ inspect (rslt, 5, 1));      
  ...
  var t = Tabs.AllianceList;
    ...
    t.dat = [];
    //actionLog ("gotPlayerLeaderboard2 -1 "+JSON2.stringify(rslt));
    var p = rslt.data;
    ...
    var now = unixTime();
      ...
      for(i=0; i < Cities.numCities; i++) {
        ...
        row[i] = rp[1] - usage;
          ...
          var msg = '';
        if (usage < 0) {
    if (Options.pbFoodAlert && timeLeft<(2*3600)) {
...
var CollectWH = {
  ...
  e_ajaxDone : function (rslt){
    var t = CollectWH;
    if (rslt.ok)
      actionLog ('Collected '+ rslt.gained.resource2 +' War Heads '+ t.colCityName, true);
    else
      actionLog ('Error collecting War Heads for '+ t.colCityName +': <SPAN class=boldRed>'+ unsafeWindow.ERROR_CODE[rslt.error_code] +'</span>', true);
  },
...
var CollectGold = {
  ...
  e_ajaxDone : function (rslt){
    var t = CollectGold;
    if (rslt.ok)
      actionLog ('Collected '+ rslt.gained.gold +' gold for '+ t.colCityName +' (happiness was '+ t.colHappy +')', true);
    else
...
var CollectFood = {
  ...
  e_ajaxDone : function (rslt){
    var t = CollectFood;
    if (rslt.ok)
      actionLog ('Collected '+ rslt.gained.resource1 +' Food for '+ t.colCityName, true);
    else
