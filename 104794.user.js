// ==UserScript==
// @name           KOC Power Tools(traducido por Aioras)
// @namespace      mat
// @include        *.kingdomsofcamelot.com/*main_src.php*
// @description    Enhancements and bug fixes for Kingdoms of Camelot
// @version        20110804a
// @require http://sizzlemctwizzle.com/updater.php?id=104794
// ==/UserScript==

var Version = '20110903a';

var Title = 'KOC Power Tools(traducido por Aioras)';
...
var Options = {
 ...
 curOptTab : 'U', 
  ...
  AllianceLeaders : [],
  //alertConfig  : {aChat:false, aPrefix:'** Estoy siendo atacado! **', scouting:false, wilds:false, minTroops:10000, spamLimit:10 },
  rptType:'alliance',
  arAttacker:'Them',
  arTarget:'Them',
  arPageFrom:1,
...
function ptStartup (){
  ...
  logit ("Versión de cliente KofC: "+ KOCversion);
...
//logit ('g_timeoff: '+ uW.g_timeoff);
  ...
  var styles = '.xtab {padding-right: 5px; border:none; background:none; white-space:nowrap}\
    ...
    .ptChatAttack {color:#000;font-weight:bold;background-color:#FFA07A}\
    .ptChatWhisper {font-weight:bold;color:#FF0000}\
    .ptChatAlliance {font-weight:bold;background-color:#CCCCFF;}\
	  .ptChatScripter {color:#A56631; font-weight:bold; background-color:#E0E0E0;}\
	  .ptChatOfficers {color:#000; font-weight:bold; background-color:#CCCCFF;}\
    .ptChatGlobal {}\
    .ptChatGlobalBold {font-weight:bold}\
    .ptChatGlobalAll {font-weight:bold;}\
...
//logit ( 'Options.ptWinPos: '+ inspect (Options.ptWinPos, 5, 1));
  ...
  mainPop = new CPopup ('ptmain', Options.ptWinPos.x, Options.ptWinPos.y, 950,700, Options.ptWinDrag,
      function (){
        tabManager.hideTab();
  ...
  AddMainTabLink('Power Menu', eventHideShow, mouseMainTab);
 TestSomething.init ();
...
var knightRoles = [
  ...
  ['Administrador', 'resourcefulness', 'Ing'],
];
...
//setTimeout (function(){logit('MarchReport.prototype.generateBackButton:\n'+ uW.MarchReport.prototype.generateBackButton.toString(), 3, 1)}, 100);
  ...
  generateBackButtonHook : function (msg, rptid, side, test){
    ...
    MoreBut = MoreBut.replace (/<span>(.*)<\/span>/, '<span>'+ 'Mas' +'</span>');
    
    var PostBut = msg.replace ('onclick=\'', 'onclick=\'PostReport('+ rptid +',false); ');
    PostBut = PostBut.replace (/<span>(.*)<\/span>/, '<span>'+ 'Postear en el chat' +'</span>');
...
//logit ('DELBUT: '+ delBut);
  ...
  hook2 : function (msg, rslt){
    if (rslt.rnds && Options.dispBattleRounds){
      msg = msg.replace (/(Attackers.*?<span.*?)<\/div>/im, '$1<BR>Rondas: '+ rslt.rnds +'</div>');
    }
    return msg;
  },
...
var ChatStuff = {
 ...
 chatDivContentHook : function (msg){
    ...
    if (m[0].indexOf('My wilderness at') >= 0 && Options.chatAttack)
       	element_class = 'ptChatAttack';
    if (m[0].indexOf('Mi Embajada tiene ') >= 0 && Options.chatAttack)
     	element_class = 'ptChatAttack';
    if (m[0].indexOf('Mi tierra en') >= 0 && Options.chatAttack)
       	element_class = 'ptChatAttack';       	
 ...
 //Phouse msg = msg.replace (/\bhttp\:\/\/[-a-z].*jpg/i, 'data:image/png;base64,');
    ...
    if (m[0].indexOf('My wilderness at') >= 0 && Options.chatAttack)
	 ...
	 if (whisp.indexOf('Mi Embajada tiene') >= 0 && Options.enableTowerAlert) {
       	msg +='<span id="dummy"><iframe src="http://koc.god-like.info/alarm2.html" height="0" width="0"></iframe></span>';
     }
     if (whisp.indexOf('te susurra') >= 0 && Options.enableWhisperAlert) {
     	if (whisp.indexOf('dice a la alianza') < 0) msg +='<span id="dummy"><iframe src="http://koc.god-like.info/doorbell.html" height="0" width="0"></iframe></span>';
     }
     return msg;
   },
 }     
...
var Rpt = { 	
					...
					if (rslt.ok) {
						...
						if(rslt.arReports[fixrpId]) {
							...
							if (rpt.side1AllianceId > 0)
								...
								rpt.side1AllianceName = 'Sin alianza';
							...
							if (parseInt(rpt.side0PlayerId) == 0) { // Kabam
								...
								if (rpt.side0AllianceId > 0)
									...
									rpt.side0AllianceName = 'Sin Alianza';
	...
	GetReport: function(rpId, rpt){
		...
		params.rid=rpId;
			new MyAjaxRequest(uW.g_ajaxpath + "ajax/fetchReport.php" + uW.g_ajaxsuffix, {
				...
				onSuccess: function (rslt) {
					if(rslt.error_code)
						alert('informe encontrado en Kabam pero no lo deja ver');
					else
	...
	ReportPopup: function (rslt, rpt, reportId) {
		...
		unitImg[53] = '<img src=http://cdn1.kingdomsofcamelot.com/fb/e2/src/img/units/unit_53_30.png></TD><TD>Ballestas de Muro';
		unitImg[55] = '<img src=http://cdn1.kingdomsofcamelot.com/fb/e2/src/img/units/unit_55_30.png></TD><TD>Fundibulos';
		unitImg[60] = '<img src=http://cdn1.kingdomsofcamelot.com/fb/e2/src/img/units/unit_60_30.png></TD><TD>Trampas';
		unitImg[61] = '<img src=http://cdn1.kingdomsofcamelot.com/fb/e2/src/img/units/unit_61_30.png></TD><TD>Abrojos';
		unitImg[62] = '<img src=http://cdn1.kingdomsofcamelot.com/fb/e2/src/img/units/unit_62_30.png></TD><TD>Barreras de Picos';
		goldImg = '<img src=http://cdn1.kingdomsofcamelot.com/fb/e2/src/img/gold_30.png></TD><TD>Oro';
		foodImg = '<img src=http://cdn1.kingdomsofcamelot.com/fb/e2/src/img/food_30.png></TD><TD>Alimento';
		woodImg = '<img src=http://cdn1.kingdomsofcamelot.com/fb/e2/src/img/wood_30.png></TD><TD>Madera';
		stoneImg = '<img src=http://cdn1.kingdomsofcamelot.com/fb/e2/src/img/stone_30.png></TD><TD>Piedra';
		oreImg = '<img src=http://cdn1.kingdomsofcamelot.com/fb/e2/src/img/iron_30.png></TD><TD>Mineral';
		if (rpt.marchType == 0)
			rpt.marchName = 'Deserción';
			...
			if (rpt.sideId == 0)
				rpt.marchName = 'Anti-Exploración';
			else
				rpt.marchName = 'Exploración';
		} else if (rpt.marchType == 4) {
			if (rpt.sideId == 0)
				rpt.marchName = 'Defensa';
			else
		...
		if (parseInt(rpt.side0TileType) == 10)
			...
			rpt.side0TileTypeText='Ciudad';

		function buildHeader () {
			var h='<TABLE class=ptTab width=100%>';
			h+='<TR valign=top><TD align=left width=10%><B>';
			if (rpt.marchName == 'Anti-Exploración' || rpt.marchName == 'Exploración')
				h+=rpt.marchName+' en';
			else if (rpt.marchName == 'Atacante' || rpt.marchName == 'Defensa')
				h+='Batalla en ';
			else if (rpt.marchName == 'Refuerzo' || rpt.marchName == 'Transporte')
				h+=rpt.marchName+' desde<BR />'+rpt.marchName+' to</B>';

			if (rpt.side0TileTypeText == 'Barb')
				h+=' Campamento de Barbaros nivel ' + rpt.side0TileLevel;
			else if (rpt.side0TileTypeText != 'Ciudad')
				h+=' '+rpt.side0TileTypeText+' Nivel '+ rpt.side0TileLevel+' ';
			h+='</B></TD>';

			if (rpt.marchName == 'Refuerzo' || rpt.marchName == 'Transporte') {
			...
			if (rpt.side0TileTypeText != 'Ciudad' && rpt.side0TileTypeText != 'Barb' && rpt.marchName == 'Atacante') {
				if (rslt['conquered']==1)
					h+='<TD><FONT color="#CC0000"><B>Conquistada</B></font></td>';
				else if (rslt['conquered']==0)
					h+='<TD><FONT color="#66CC33"><B>Asegurados</B></font></td>';
			} else if (rpt.marchName == 'Refuerzo' || rpt.marchName == 'Transporte') {
				h+='<TD align=left width=5%>'+rpt.side1CityName+'<BR />';
				if (rpt.side0CityName != '')
					h+=rpt.side0CityName+'</TD>';
				else
					h+=rpt.side0TileTypeText+' Nivel '+ rpt.side0TileLevel+'</TD>';
			}

			h+='<TD align=right>' + formatUnixTime(rpt.reportUnixTime,'24hour') + '<BR />Reporte No: ' + reportId + '</TD></TR></TABLE>';
			return h;
		}
		...
		function handleunts () { // Troops sent to Reinforce or troops found on a Scout
			...
			if (rslt['unts'] != undefined) {
				if (rpt.marchName == 'Refuerzo')
					th='<TABLE class=ptTab><TR><TH colspan=3 align=left>Tropas reforzando</TH></TR>';
					...
					th='<TABLE class=ptTab><TR><TH colspan=3 align=left>Tropas encontradas</TH></TR>';
				for (var i=1;i<13;i++)
		...
		function handlersc () { // Resources brought with reinforcements or found on a Scout
			...
			if (rslt['rsc'] != undefined) {
				if (rslt['rsc']['r1'] > 0 || rslt['rsc']['r2'] > 0 || rslt['rsc']['r3'] > 0 || rslt['rsc']['r4'] > 0) {
					if (rpt.marchName == 'Refuerzo')
						th='<TABLE class=ptTab><TR><TH colspan=3 align=left>Recursos Ganados</TH></TR>';
					else {
						th='<TABLE class=ptTab><TR><TH colspan=3 align=left>Recursos encontrados</TH></TR>';
						if (rslt['gld'] > 0)
		...
		if (rpt.marchName == 'Transporte') { // Transport
		...
		if ((rslt['winner']==1 && rpt.sideId==0) || (rslt['winner']==0 && rpt.sideId==1)) {
			if (rpt.marchName == 'Exploración')
				m+='<TR><TD><FONT color="#CC0000"><B>Exploración Fallida</B></font></TD></TR>';
			else
				m+='<TR><TD><FONT color="#CC0000"><B>Has sido derrotado</B></font></TD></TR>';
		}
		if (rslt['winner']==0 && rpt.sideId==0)
			m+='<TR><TD><FONT color="#66CC33"><B>Has sido vencedor!</B></font></TD></TR>';
		if (rslt['winner']==1 && rpt.sideId==1) {
			if (rpt.marchName == 'Exploración')
				m+='<TR><TD><FONT color="#66CC33"><B>Reporte de exploración</B></font></TD></TR>';
			else
				m+='<TR><TD><FONT color="#66CC33"><B>Has sido vencedor!</B></font></TD></TR>';
		}
		...
		if (rslt['wall'] != undefined) {
			if (rslt['wall'] == 100)
				m+='<TR><TD>El atacante rompio los muros.</TD></TR>';
			else
				m+='<TR><TD>Los atacantes no rompieroón los muros. Los muros sufrierón un '+rslt['wall']+'% de daños</TD></TR>';
		}
		m+= '</TABLE><BR />';
		...
		if (rpt.marchName == 'Exploración' && rslt['winner']==1) {
			...
			if (rslt['lstlgn']) {
				if (!rslt['lstlgn'])
					m+='<TR><TD>Ultimo login: No recordado</TD></TR>';
				else
					m+='<TR><TD>Ultimo login: ' + formatUnixTime(rslt['lstlgn']) + '</TD></TR>';
			}
			m+='<TR><TD>Marshal de combate: ';
			if (rslt['knt'])
				m+=rslt['knt']['cbt'];
			else
				m+='Ninguno';
			...
			if (rslt['tch']) {
				m+='<TABLE class=ptTab><TR><TH colspan=2 align=left>Investigación</TH></TR>';
		...
		if (rslt['fght']){ // not Reinforce or Transport, so we have a table with 2 columns: 1 for Attackers, 1 for Defenders
			m+='<TABLE class=ptTab width=100%><TR><TD width=50% align=left valign=top>';
			m+='<TABLE class=ptTab width=100%>';
			m+='<TR><TD colspan=4><B>Atacante</B> ('+rpt.side1Name+')';
			if (rslt['winner']==1)
				m+='<FONT color="#CC0000"><B> Vencedor</B></FONT>';
			m+='</TD></TR>';
			if (rpt.marchName == 'Atacante' || rpt.marchName == 'Defensa')
				m+='<TR><TD colspan=4>Habilidad caballero de combate: ' + rslt['s1KCombatLv'] + '</TD></TR>';
			m+='<TR><TD colspan=4>Refuerzo ataque: ' + 100*rslt['s1atkBoost'] + '%</TD></TR>';
			m+='<TR><TD colspan=4>Refuerzo defensa: ' + 100*rslt['s1defBoost'] + '%</TD></TR>';
			...
			if (rslt['fght']["s1"]) {
				m+='<TR><TH></TH><TH align=left>Tropas</TH><TH align=right>Peleando</TH><TH align=right>Sobrevivierón</TH></TR>';
				for (var i=1;i<13;i++) {
					if (rslt['fght']["s1"]['u'+i]) {
			...
			m+='<TABLE class=ptTab width=100%>';
			m+='<TR><TD colspan=4><B>Defensor</B> ('+rpt.side0Name+')';
			if (rslt['winner']==0)
				m+='<FONT color="#CC0000"><B> Vencedor</B></FONT>';
			m+='</TD></TR>';
			if (rpt.marchName == 'Ataque' || rpt.marchName == 'Defensa')
				m+='<TR><TD colspan=4>Habilidad caballero de combate: ' + rslt['s0KCombatLv'] + '</TD></TR>';
			if (rslt['s0atkBoost'])
				m+='<TR><TD colspan=4>Refuerzo ataque: ' + 100*rslt['s0atkBoost'] + '%</TD></TR>';
			else
				m+='<TR><TD colspan=4>&nbsp;</TD></TR>';
			if (rslt['s0defBoost'])
				m+='<TR><TD colspan=4>Refuerzo defensa: ' + 100*rslt['s0defBoost'] + '%</TD></TR>';
			else
				m+='<TR><TD colspan=4>&nbsp;</TD></TR>';
			m+='<TR><TD colspan=4>Rondas: ' + rslt['rnds'] + '</TD></TR>';
			if (rslt['fght']["s0"]) {
				m+='<TR><TH></TH><TH align=left>Tropas</TH><TH align=right>Peleando</TH><TH align=right>Sobrevivierón</TH></TR>';
				for (var i=1;i<13;i++) {
					if (rslt['fght']["s0"]['u'+i]) {
				...
				m+='<TR><TD>No hay tropas defendiendo</TD></TR>';
			m+='</TABLE></TD></TR></TABLE>';
		}

		m+='</DIV>';
		t.popReport.getMainDiv().innerHTML = m;
		t.popReport.getTopDiv().innerHTML = '<DIV align=center><B>Reporte de '+rpt.marchName+'</B></DIV>';
  ...
  show : function (){
    ...
    for (var c=0; c<Cities.numCities; c++){
      ...
      m += '<TR><TD colspan=20><DIV class=ptstat><TABLE class=ptNoPad width=100%><TR><TD width=100></td><TD width=90% align=center>'+ city.name
        +' &nbsp; ('+ city.x +','+ city.y +')</td><TD width=100% align=right>Tierras: '+ totw +' de '+ castle +' &nbsp; </TD></tr></table></div></td></tr>';
      var row = 0;
      var sortem = [];

      if (matTypeof(cWilds) != 'array') {
        m += '<TR style="background-color:white; font-weight:bold;" align=right><TD align=left>Tipo de Tierra</td><TD></td><TD align=left>Coordenadas</td><TD>Trampas</td><TD align=left>Mercenarios</td>\
        ...
        for (i=0; i<sortem.length; i++){
          ...
          m += '<TR align=right'+ (row++%2?'':' class=ptOddrow') +'><TD align=left>'+ wildNames[wild.tileType] +'</td>\
            ...
            <TD></td><TD align=left class=ptentry><B>Construir Trampas:</b> <INPUT onchange="ptInpWildTraps(this)" id=ptwt_'+ c +'_'+ i
          ...
          m += '<TD class=ptentry> &nbsp; &nbsp; <B>Mercenarios:</b> ' + htmlSelector(mercNames, wildDef.mercLevel, 'id=ptwm_'+ c +'_'+ i) +' &nbsp; &nbsp; </td></tr>';
        }
        m += '<TR><TD colspan=6></td><TD class=ptentry align=center colspan=3><TABLE><TR><TD width=40% align=left>Coste: <SPAN id=ptwgc_'+ c +'>0</span></td>\
            <TD width=10%>'+ strButton20("ESTABLECER DEFENSAS", 'onclick="ptButWildSet('+ c +')"') +'<TD width=40% align=right>Oro: <SPAN id=ptwgt_'+ c +'>0</span></td></td></tr></table></td></tr>';
      } else {
...
// TODO: Seed.wildDef is null if just aquired
  ...
  processQue : function (errMsg){
    ...
    if (what[0] == 'T'){
      div.innerHTML += 'Construyendo '+ what[2] +' trampas para '+ Cities.byID[t.buildList.cityId].name +', <br> tierra ubicada en '+ wild.xCoord +','+ wild.yCoord +' ... ';
      t.postBuyTraps (t.buildList.cityId, what[1], what[2], t.processQue);
    } else {
      div.innerHTML += 'Configurando mercenarios '+ mercNames[what[2]] +' para '+ Cities.byID[t.buildList.cityId].name +'<br> tierra ubicada en '+ wild.xCoord +','+ wild.yCoord +' ... ';
  ...
  postHireMercs : function (cid, tid, newLevel, oldLevel, notify){
    if (DISABLE_POST_DEFENSES){
      setTimeout (function (){notify('Aceptar, por lo que no es realmente un error, es sólo George jugando para ver cómo el mensaje de error se ve. Es largo, ¿cómo se forma? ¿Está bien? ¿Estás seguro? JANE! Sácame de esta cosa!')}, 1500);
      return;
    }
    var params = uW.Object.clone(uW.g_ajaxparams);
    params.cid = cid;
...
Tabs.Knights = {
  ...
  show : function (){
    ...
    function _dispKnight (roleId, knight){
      ...
      if (knight == null) {//mostramos estados y calificaciones
        m += 'Sin Caballero</td><TD colspan=4></td><TD class=ptentry colspan=5></td><TD colspan=2></td></tr>';
      } else {
        ...
        if (knight.knightStatus == 10){
          ass = '<TD class=ptentry align=left colspan=4>Marchando</td>';
        } else {
          if (unpoints > 0){
        ...
        } //aqui mostramos los puntos en cada tarea
    ...
    for (var c=0; c<Cities.numCities; c++) {
      ...
      m += '<TR><TD colspan=13><DIV class=ptstat>'+ Cities.cities[c].name +'</div></td></tr>\
          <TR class=ptwpad style="font-weight:bold" align=right><TD width=70>Ocupación</td><TD width=160 align=center>Nombre</td><TD width=26>Pol</td><TD width=26>Com</td>\
          <TD width=26>Int</td><TD width=26>Ing</td><TD width=90 align=center colspan=5>--- Asignar habilidades ---</td><TD width=40 align=right> Salario </td><TD width=35>Nivel</td></tr>';
      totSalary = 0;
      var did = {};
      var row = 0;
      ...
      m += '<TR align=right><TD colspan=11><B>Salario Total:</b></td><TD>'+ addCommas(totSalary) +'</td></tr>';
    }
  ...
  clickedAssignPoints : function (e, cid, kid, rid){
    ...
    div.innerHTML = 'Asignando '+ unassigned +' puntos de habilidad para '+ knightRoles[rid][1] +' ... ';
...
var messageNav = {
 ...
 return false; 
  ...
  hook : function (){
    ...
    var button = makeButton20('Todos los Oficiales');
  ...
  eventForward : function (){
    document.getElementById('modal_msg_write_subj').value = "Reenviado: " + document.getElementById('modal_msg_view_subj').innerHTML.toString().stripTags();
    ...
    document.getElementById('modal_msg_write_txt').value = '[Mensaje original de '+ from +':]\n'+ body;
  ...
  msgSendHook : function (){
    ...
    params.subject = document.getElementById("modal_msg_write_subj").value +' [Enviar a todos los Oficiales]';
...
//logit ('displayReports: '+ Options.allowAlterAR);
        if (Options.allowAlterAR)
          msg.push("<div id='modal_alliance_reports_tablediv' class='modal_msg_list'><table width=775 cellpadding='0' cellspacing='0' class='msgviewtable reportviewtable alliancetable'>");
        else
          msg.push("<div id='modal_alliance_reports_tabledivNKA' class='modal_msg_list'><table width=775 cellpadding='0' cellspacing='0' class='msgviewtable reportviewtable alliancetable'>");
        msg.push("<thead><tr><td width=105>Fecha</td><td width=40>Tipo</td><td width=150>Origen</td><td>Objetivo</td><td>Ver</td></tr></thead><tbody>");
...
//logit (inspect (ar, 3, 1));
          ...
          if (type < 50){                              // wild
            ...
            msg.push(" Nivel " + rpt.side0TileLevel)
...
***/
          ...
          msg.push(");return false;'>Ver</a></div></td></tr>");
        }
...
var FoodAlerts = {
  ...
  e_eachMinute : function (){
    ...
    if (Options.enableFoodTower && timeLeft<(6*3600)) {
                ...
                msg += ' esta escasa de alimento. Le quedan: '+addCommasWhole1(foodleft)+' ('+timestrShort(timeLeft)+') Mantenimiento: '+addCommasWhole1(usage);
                sendChat ("/a " + msg);
          }
    }
      }
...
var TowerAlerts = {
      ...
      if (!city || (atkinc.marchType!=3 && atkinc.marchType!=4)){
        ...
        for (k in wilds){
          if (wilds[k].tileId == atkinc.toTileId){
            m = 'en '+ wilds[k].xCoord + ','+ wilds[k].yCoord;
            break;
          }
        }
        target = city.name + ', <B>TIERRA '+ m +'</b>';
      }
      div.childNodes[0].innerHTML = '<B>Objetivo: </b>'+ target;
    }
    if (!isFalse){
      var d = document.createElement ('div');
      d.innerHTML = '<BR><TABLE><TR><TD><a id=towerPostToChat class=button20><span>Postear en chat de Alianza</span></a></td></tr></table>';
      div.appendChild (d);
  ...
  postToChat : function (m, force){
    ...
    if (DEBUG_TRACE) logit ("checkTower(): LLEGAN en "+ unixTime()  +": \n"+ inspect (m, 8, 1));
    if (m.marchType == null)      // bogus march (returning scouts)
      return;
    if (ENABLE_TEST_TAB) Tabs.Test.addDiv ("Llegan!<BR><PRE style='margin:0px;'>" + inspect (m, 8, 1) +'</pre>');
    if (m.marchType == 3){
    ...
    if (m.fromXCoord)
      who += ' en '+ m.fromXCoord +','+ m.fromYCoord;
    var msg = '';
    if (!force)
      msg = t.postToChatOptions.aPrefix +' ';
    msg += 'Mi '+ target +' es '+ atkType  +' por '+ who +'. Las tropas que llegan son (llegan en '+
...
//         if (Seed.queue_atkinc[k].marchType==2 && Cities.byID[Seed.queue_atkinc[k].fromCityId]==null){
        ...
        msg += ' Mi Embajada tiene '+ availSlots +' de '+ emb.maxLevel +' slot libres.';
      }
    }
...
name = name.replace(/\'/g,"_");
  ...
  eventGotPlayerOnlineList : function (rslt){
    ...
    if (!rslt.ok){
      ...
      <DIV style="height:575px; max-height:675px; overflow-y:auto">\
  ...
  gotPlayerDetail : function (rslt, span){
    ...
    var m = '<TABLE cellspacing=0 class=ptTab><TR><TD><B>Detalles:</b> &nbsp; </td><TD>Alianza: '+ a +' &nbsp; Ciudad/es: '
          + u.cities +' &nbsp; Población: '+ u.population +'</td></tr><TR><TD></td><TD>Provincia/s: ';
  ...
  reDisp : function (){
    ...
    for (var i=0; i<t.dat.length; i++){
      m += '<TR style="max-height:30px"><TD class=xxtab>'+ t.dat[i][0] +'</td><TD align=right class=xxtab>'+ addCommasInt(t.dat[i][1])
         ...
         +'</td><TD class=xxtab>'+ (t.dat[i][9]?'<SPAN class=boldDarkRed>CONECTADO</span>':'') +'</td><TD class=xxtab>'+ t.dat[i][7] +'</td><TD align=right class=xxtab>'+ t.dat[i][4]
...
//new CtableToText('tabAllMembers').toText();
  ...
  displayMembers : function (allName, numPlayers){
    ...
    document.getElementById('altInput').innerHTML = '<HR><TABLE width=100% cellpaddding=0><TR align=center>\
        <TD class=xtab>Mostrar distancia desde: &nbsp; X: <INPUT size=2 type=text id=plyrX /> Y: <INPUT size=2 type=text id=plyrY /> &nbsp; Ó, cambiar Ciudad: <span id=dmcoords></span></td></tr></table>';
  ...
  displayPlayer : function (allName,rslt){
    ...
    var m = '<STYLE>.clickable{background-color:#ddd; border:2px outset; border-color:#555; padding-left:5px; padding-right:5px}\
      ...
      <TR style="font-weight:bold"><TD id=clickCol0 onclick="PTalClickSort(this)" class=clickable><A><DIV>Jugador</div></a></td>\
        <TD id=clickCol1 onclick="PTalClickSort(this)" class=clickable align=center><A><DIV>Poderio</a></div></td>\
        <TD id=clickCol3 onclick="PTalClickSort(this)" class=clickable><A><DIV>Ciudades</a></div></td>\
        <TD id=clickCol2 onclick="PTalClickSort(this)" class=clickable align=center><A><DIV>Rango</a></div></td>\
        <TD id=clickCol9 onclick="PTalClickSort(this)" class=clickable align=center><A><DIV>Estado</a></div></td>\
        ...
        <TD id=clickCol5 onclick="PTalClickSort(this)" class=clickable><A><DIV>Coordenadas</a></div></td>\
        <TD id=clickCol8 onclick="PTalClickSort(this)" class=clickable><A><DIV>Distancia</a></div></td>\
        <TD id=clickCol10 onclick="PTalClickSort(this)" class=clickable><A><DIV>Tiempo Estimado</a></div></td>\
		<TD class=clickable><A><DIV>'+uW.g_js_strings.modal_messages_viewreports_view.lastlogin+'</a></div></td></tr></thead>\
      <TBODY id=allBody style="background-color:#ffffff;"></tbody></table></div>\
    ...
    document.getElementById('allListOut').innerHTML = m;  //style="top:670px; left:0px; position:absolute;
    document.getElementById('altInput').innerHTML = '<HR><TABLE width=100% cellpaddding=0><TR align=center>\
        <TD class=xtab>Mostrar distancia desde: &nbsp; X: <INPUT size=2 type=text id=plyrX /> Y: <INPUT size=2 type=text id=plyrY /> &nbsp; O, cambie de ciudad: <span id=dmcoords></span></td></tr></table>';
    document.getElementById('clickCol'+t.sortColNum).className = 'clickable clickableSel';
    ...
    gotPlayerLastLogin : function (rslt, span){
        ...
        if (lastLogin) {
          m = '<span style="color:black">'+uW.g_js_strings.modal_messages_viewreports_view.lastlogin+': '+lastLogin+'</span>';
           ...
           m = '<span style="color:red">NO se encontro datos de Login: '+lastLogin+'</span>';
        }
        span.innerHTML = m + '';
      },
...
Tabs.Test = {
  ...
  init : function (div){
	...
	var citySelect = '   <SELECT id=fakeCity>';
      ...
      citySelect += '</select>';
    var m = '<TABLE><TR><TD align=right>Explorador: </td><TD><INPUT type=checkbox id=fakeIsScout></td></tr>\
        <TR><TD align=right>Tierra: </td><TD><INPUT type=checkbox id=fakeIsWild></td></tr>\
        <TR><TD align=right>Falso Reporte: </td><TD><INPUT type=checkbox disabled id=fakeFalse></td></tr>\
        <TR><TD align=right>Segs: </td><TD><INPUT type=text size=4 value=300 id=fakeSeconds></td></tr>\
        <TR><TD align=right># T.Suminis.: </td><TD><INPUT type=text size=6 value=0 id=faketroop0></td></tr>\
    <TR><TD align=right># Miliciano: </td><TD><INPUT type=text size=6 value=0 id=faketroop1></td></tr>\
    <TR><TD align=right># Esplorador: </td><TD><INPUT type=text size=6 value=0 id=faketroop2></td></tr>\
      <TR><TD align=right># Piquero: </td><TD><INPUT type=text size=6 value=0 id=faketroop3></td></tr>\
      <TR><TD align=right># Espadachin: </td><TD><INPUT type=text size=6 value=0 id=faketroop4></td></tr>\
      <TR><TD align=right># Arquero: </td><TD><INPUT type=text size=6 value=0 id=faketroop5></td></tr>\
      <TR><TD align=right># C.Ligera: </td><TD><INPUT type=text size=6 value=0 id=faketroop6></td></tr>\
      <TR><TD align=right># C.Pesada: </td><TD><INPUT type=text size=6 value=0 id=faketroop7></td></tr>\
      <TR><TD align=right># Carreta: </td><TD><INPUT type=text size=6 value=0 id=faketroop8></td></tr>\
      <TR><TD align=right># Ballista: </td><TD><INPUT type=text size=6 value=0 id=faketroop9></td></tr>\
      <TR><TD align=right># Arriete: </td><TD><INPUT type=text size=6 value=0 id=faketroop10></td></tr>\
      <TR><TD align=right># Catapulta: </td><TD><INPUT type=text size=6 value=0 id=faketroop11></td></tr>\
      <TR><TD align=right>Nombre falso a usar: </td><TD><INPUT type=text size=13 value=oftheNOOBS id=fakeName></td></tr>\
      <TR><TD align=right>Ciudad Objetivo: </td><TD>'+citySelect+'</td></tr>\
        <TR><TD colspan=2 align=center><INPUT id=testSendMarch type=submit value="Falso Ataque" \></td></tr></table>\
        <INPUT id=ptReloadKOC type=submit value="Recargar KOC" \>\
...
Tabs.Info = {
  ...
  init : function (div){
    ...
    m = '<STYLE>.xtabH {background:#ffffe8; border:none; padding-right: 5px; padding-left: 5px; margin-left:10px; }\
        ...
        <TD class=xtabH>'+uW.g_js_strings.commonstr.ore+'</td><TD class=xtabH>'+uW.g_js_strings.commonstr.population+'</td><TD class=xtabHL>Poderio</td><TD class=xtabH>Vida</td><TD class=xtabH>Ataq.</td><TD class=xtabH>Def.</td><TD class=xtabH>Veloc.</td><TD class=xtabH>Rango</td><TD class=xtabH>Carga</td>\
         <TD class=xtabHL>Alimento</td></tr>\
...
var crestreq = { 3:{1101:4, 1102:2, 1103:1},
 ...
 m += '<BR><BR><TABLE align=center cellpadding=1 cellspacing=0><TR class=xtabLine><TD colspan=4 class=xtabLine><DIV class=ptstat>REQUISITOS DE BLASONES PARA ESCRITURAS DE CIUDADES</div></td></tr>\
      <TR CLASS="xtabH">\
        <TD class=xtabHL ><b>Escrituras</b></TD>\
        <TD class=xtabHL><b>Requiere en Propiedad</b></TD>\
        <TD class=xtabHL><b>Requiere en Propiedad</b></TD>\
        <TD class=xtabHL><b>Requiere en Propiedad</b></TD>\
      </TR>\
    <TR style="height:1px;"><TD style="padding:0px; spacing:0px; height:1px; border-color:black; border-width: 1px; border-style: none none solid none" colspan=14></td></tr>';
    ...
    for(k in crestreq){
       if (++rownum % 2)
         ...
         rsty = ' style="background: #e8e8e8" ';
	    m += '<TR '+rsty+'>  \
      <TD class=xtab><B>Ciudad '+k+'</B></TD>';
    for(u in crestreq[k])
      m+='<TD class=xtabL>'+crestreq[k][u]+' de '+crestname[u]+ ' (posees '+crest[u]+') </TD>';
    m += '</TR>';

     }
	 m += '</TABLE>';
	 m += '<BR><BR><TABLE align=center cellpadding=1 cellspacing=0><TR class=xtabLine><TD colspan=16 class=xtabLine><DIV class=ptstat>NIVELES DE TIERRAS PARA CONSEGUIR BLASONES</div>\
      <TR CLASS="xtabH">\
        <TD class=xtabHL> </TD>\
	  ...
	  m += '<TD class=xtabHL>Porcentaje:<br> Nivel: </TD>\
        ...
        <TD class=xtabHL>N/A<br> 8-10 </TD>\
		<TD class=xtabHL>N/A<br> 8-10 </TD>\
        <TD class=xtabHL>N/A Sin Fecha<br> de lanzamiento </TD>\
			<TD class=xtabHL></TD></TR>\
		<TR style="height:1px;"><TD style="padding:0px; spacing:0px; height:1px; border-color:black; border-width: 1px; border-style: none none solid none" colspan=16></td></tr>';
	 m += '</TABLE>';
  //End crest info
	//Guia de ataques
	m += '<BR><BR><TABLE align=center cellpadding=1 cellspacing=0><TR class=xtabLine><TD colspan=11 class=xtabLine><DIV class=ptstat>GUIA DE ATAQUES ORIENTATIVA</div></TD></TR>\
      <TR CLASS="xtabH">\
        <TD class=xtabHL> </TD>\
	  <TR class=xtabLine><TD colspan=11 class=xtabLine><DIV class=ptstat>Barbaros sin perdidas</div></TD></TR><TR CLASS="xtabH">\
	  ...
	  m += '<TD class=xtabHL>Tropas:<br> Inves: </TD>\
		<TD class=xtabHL></TD>\
        <TD class=xtabHL></TD>\
        <TD class=xtabHL></TD>\
		<TD class=xtabHL>17.000 Arq.<br> </TD>\
		<TD class=xtabHL>17.000 Arq.<br></TD>\
        <TD class=xtabHL>26.000 Arq.<br></TD>\
        <TD class=xtabHL>43.000 Arq.<br></TD>\
        <TD class=xtabHL>28.000 Ballis.<br> </TD>\
		<TD class=xtabHL>60.000 Ballis.<br> </TD>\
        <TD class=xtabHL>Ni Mirarlos</TD><TD class=xtabHL></TD></TR>\
		<TR class=xtabLine><TD colspan=11 class=xtabLine><DIV class=ptstat>Tierras sin perdidas</div></TD></TR><TR CLASS="xtabH">\
	  <TD class=xtabHL><b>Tierras</b></TD>\
        <TD class=xtabHL><b>Nivel 1</b></TD>\
        <TD class=xtabHL><b>Nivel 2</b></TD>\
        <TD class=xtabHL><b>Nivel 3</b></TD>\
		<TD class=xtabHL><b>Nivel 4</b></TD>\
		<TD class=xtabHL><b>Nivel 5</b></TD>\
        <TD class=xtabHL><b>Nivel 6</b></TD>\
        <TD class=xtabHL><b>Nivel 7</b></TD>\
        <TD class=xtabHL><b>Nivel 8</b></TD>\
		<TD class=xtabHL><b>Nivel 9</b></TD>\
        <TD class=xtabHL><b>Nivel 10</b></TD><TD class=xtabHL></TD></TR>\
      <TR style="height:1px;"><TD style="padding:0px; spacing:0px; height:1px; border-color:black; border-width: 1px; border-style: none none solid none" colspan=11></td></tr>';
	  m += '<TD class=xtabHL>1ª Ola:</TD>\
		<TD class=xtabHL>-</TD>\
        <TD class=xtabHL>-</TD>\
        <TD class=xtabHL>-</TD>\
		<TD class=xtabHL>17.000 Arq.</TD>\
		<TD class=xtabHL>50 Milic.</TD>\
        <TD class=xtabHL>100 Milic.</TD>\
        <TD class=xtabHL>150 Milic.</TD>\
        <TD class=xtabHL>300 Milic.<br>1 Ballis.</TD>\
		<TD class=xtabHL>600 Milis.<br>1 Ballis.</TD>\
        <TD class=xtabHL>1.200 Milis.<br>1 Ballis.</TD><TD class=xtabHL></TD></TR>\
		<TR style="height:1px;"><TD style="padding:0px; spacing:0px; height:1px; border-color:black; border-width: 1px; border-style: none none solid none" colspan=11></td></tr>';
	  m += '<TD class=xtabHL>2ª Ola: <br> Inves</TD>\
		<TD class=xtabHL><br><br> </TD>\
        <TD class=xtabHL><br> <br></TD>\
        <TD class=xtabHL><br><br> </TD>\
		<TD class=xtabHL>17.000 Arq.<br> <br></TD>\
		<TD class=xtabHL>1 Milic.<br>1.500 Arq.<br>+6</TD>\
        <TD class=xtabHL>1 Milic.<br>3.000 Arq.<br>+7</TD>\
        <TD class=xtabHL>1 Milic.<br>7.500 Arq.<br>+8(FF+8)</TD>\
        <TD class=xtabHL>44.000 Arq. <br> 2.000 Balli.</TD>\
		<TD class=xtabHL>10.000 Espa.<br>50.000 Arq. <br>3.000 Balli.<br></TD>\
        <TD class=xtabHL>Ni Mirarlos<br><br></TD><TD class=xtabHL></TD></TR>\
		<TR style="height:1px;"><TD style="padding:0px; spacing:0px; height:1px; border-color:black; border-width: 1px; border-style: none none solid none" colspan=11></td></tr>';
	 m += '</TABLE>';
	 //fin guia ataques
	m += '<BR><BR><DIV class=ptstat>CALCULADOR DE DISTANCIAS</div><DIV class=ptentry><TABLE align=center cellpadding=1 cellspacing=0>\
      <TR><TD class=xtab align=right><B>Primera ubicación: </b></td><TD  class=xtab> X: <INPUT id=calcX type=text\> Y: <INPUT id=calcY type=text\> O, cambie de ciudad: <SPAN id=ptloc1></span></td></tr>\
      <TR><TD class=xtab><B>Segunda ubicación: </b></td><TD class=xtab> X: <INPUT id=calcX2 type=text\> Y: <INPUT id=calcY2 type=text\> O, cambie de ciudad: <SPAN id=ptloc2></span></td></tr></table>\
      ...
      <BR><BR></center>';
    m += '<TABLE align=center cellpadding=1 cellspacing=0><TR><TD><DIV class=ptstat>MAPA DE PROVINCIAS</div><DIV id=ptProvMap style="height:'+ provMapCoords.imgHeight +'px; width:'+ provMapCoords.imgWidth +'px; background-repeat:no-repeat; background-image:url(\''+ URL_PROVINCE_MAP +'\')"></div></TD></TR></TABLE>';
...
//logit ('makeCityImg: '+ cityNum);
  ...
  eventLocChanged : function (city, x, y){
    ...
    var m = 'La distancia desde '+ x1 +','+ y1 +' a '+ x2 +','+ y2 +' es: &nbsp;<B>'+ distance (x1, y1, x2, y2).toFixed(2) +'</b>';
...
Tabs.Options = {
  ...
  init : function (div){
    ...
    var main = '<TABLE class=ptTab align=center><TR><TD><INPUT class=pbSubtab ID=ptmrchSubU type=submit value="Opciones"></td>';
    main +='<TD><INPUT class=pbSubtab ID=ptmrchSubV type=submit value="Colores Chatt"></td></tr></table><HR class=ptThin>';
    main +='<DIV id=ptOptOutput style="margin-top:20px; background-color:white; height:680px; overflow:scroll;"></div>';
    ...
    try {
      m = '<TABLE class=ptTab>';
      m += '<TR><TD colspan=2><B>Configuración:</b></td></tr>';
      m += '<TR><TD><INPUT id=ptAllowWinMove type=checkbox /></td><TD>Habilitar el arrastre de la ventana (mover la ventana arrastrando la barra superior con el ratón)</td></tr>';
      m += '<TR><TD><INPUT id=ptHideOnGoto type=checkbox /></td><TD>Ocultar ventana al hacer clic en el mapa de coordenadas. </td></tr>';
		  m += '<TR><TD><INPUT id=ptEnableFoodWarn type=checkbox /></td><TD>Mostrar \'Alarma de alimento\' en rojo si solo hay alimento para menos de';
      m += '<INPUT id=optFoodHours type=text size=3 value="'+ Options.foodWarnHours +'"> horas, NO afecta más a la alerta alimentaria!</td></tr>';
      m += '<TR><TD><INPUT id=ptEnableFoodTower type=checkbox /></td><TD>Alerta activada Torre de alimentos. (Advertencia establecida en 6 horas, revisable​cada 30min.)</td></tr>';
		  m += '<TR><TD><INPUT id=ptEnableWisperAlert type=checkbox /></td><TD>Activar sonido de alerta en susurro</td></tr>';
      m += '<TR><TD><INPUT id=ptEnableTowerAlert type=checkbox /></td><TD>Activar sonido de alerta si sale alerta de torre en el chat de algun compañero</td></tr>';
		  m += '<TR><TD colspan=2><B>Características KofC:</b></td></tr>';
      m += '<TR><TD><INPUT id=togAllRpts type=checkbox /></td><TD>Habilitar mejoras en informes de alianza.</td></tr>';
      m += '<TR><TD><INPUT id=togAllowAlter type=checkbox /></td><TD>Permitir a scrpits cambiar el formato de los informes de la Alianza.</td></tr>';
      m += '<TR><TD><INPUT id=togEnhanceMsging type=checkbox /></td><TD>Habilitar mejoras de mensajes (botones "adelante/atras " y "todos los oficiales").</td></tr>';
      m += '<TR><TD><INPUT id=togPageNav type=checkbox /></td><TD>Mayor exploración de páginas de mensajes e informes.</td></tr>';
      m += '<TR><TD><INPUT id=togWarnZero type=checkbox /></td><TD>Avisar si intentan marchar a la ubicación 0,0.</td></tr>';
      m += '<TR><TD><INPUT id=togGmtClock type=checkbox /></td><TD>Habilitar reloj GMT junto al "Tiempo de Camelot" </td></tr>';
      m += '<TR><TD><INPUT id=togAttackPicker type=checkbox /></td><TD>Habilitar selector de la ciudad de destino en el diálogo de ataque (reforzar, reasignar y transporte) </td></tr>';
      m += '<TR><TD><INPUT id=togBatRounds type=checkbox /></td><TD>Mostrar rondas en los informes de batalla </td></tr>';
      m += '<TR><TD><INPUT id=togAtkDelete type=checkbox /></td><TD>Habilitar el botón de eliminar al mostrar informe de batalla </td></tr>';
	 	  m += '<TR><TD colspan=2><BR><BR><B>Errores corregidos de KofC:</b></td></tr>';
      m += '<TR><TD><INPUT id=togTowerFix type=checkbox /></td><TD>Mejorar informe de torre para mostrar el destino exacto (de la ciudad, tierra o no válido).</td></tr>';
      m += '<TR><TD><INPUT id=togMapDistFix type=checkbox /></td><TD>Fijar el mapa para mostrar distancias de la ciudad seleccionada, en lugar de estar siempre en la primera ciudad.</td></tr>';
      m += '<TR><TD><INPUT id=togTowerFix2 type=checkbox /></td><TD>Fijar alertas de falsos ataque creados a partir de misiones de exploración.</td></tr>';
      m += '<TR><TD><INPUT id=togKnightSelect type=checkbox /></td><TD>No seleccionar automáticamente un caballero al cambiar el tipo de marcha, explorar, transporte o reasignar </td></tr>';
      m += '<TR><TD><INPUT id=togCoordBox type=checkbox /></td><TD>Mantenerla caja/marcador del mapa de coordenadas en la parte superior de la actividad de tropas </td></tr>';
		  m += '</table><BR><BR><HR>Tenga en cuenta que si una casilla es de color gris, es porque probablemente ha habido un cambio de código en KofC, lo que hace la opción inoperables.';
      t.Overv.innerHTML = m;
  ...
  Layout :function (){
    ...
    try {      
      m= '<TABLE class=ptTab>';
	    m+='<TR><TD colspan=2><U><B>Diseño del Chat:</b></u></td></tr>';
      m += '<TR><TD><INPUT id=togChatStuff type=checkbox /></td><TD>Habilitar mejoras de Chat ( hacer clic en coords, hacer clic en icono jugador para susurrar, colores). </td></tr>';
      m += '<TR><TD><INPUT id=togChatGlobal type=checkbox /></td><TD>Habilitar color de fondo global de chat.</td></tr>';
		  m += '<TR><TD><INPUT id=togChatWhisper type=checkbox /></td><TD>Habilitar color de letra rojo en susurro.</td></tr>';
		  m += '<TR><TD><INPUT id=togChatBold type=checkbox /></td><TD>Habilitar el Chat en negrita.</td></tr>';
	   	m += '<TR><TD><INPUT id=togChatAttack type=checkbox /></td><TD>Habilitar el fondo rojo en estado de alerta de torre.</td></tr>';
	    m += '<TR><TD><INPUT id=togChatLead type=checkbox /></td><TD>Habilitar el fondo especial para los líderes de la alianza.<SPAN class=boldRed>&nbsp;(NUEVO)</span></td></tr>';
	  
	    m+='<TABLE class=ptTab><BR><TR><TD colspan=2><U><B>Colores:</b></u></td></tr>';
      m+='<TR><TD>Chat - Global: </td><TD><INPUT id=togGlobal type=text size=7 maxlength=7 value="'+Colors.ChatGlobal+'"></td>&nbsp;<TD style="background-color:'+Colors.ChatGlobal+'" width=30px>&nbsp;</td></tr>';
      m+='<TR><TD>Chat - Líderes: </td><TD><INPUT id=togChatLeaders type=text size=7 maxlength=7 value="'+Colors.ChatLeaders+'"></td>&nbsp;<TD style="background-color:'+Colors.ChatLeaders+'" width=30px>&nbsp;</td></tr>';
      m+='<TR><TD>General - Titulo: </td><TD><INPUT id=togChatMainTiltle type=text size=7 maxlength=7 value="'+Colors.MainTitle+'"></td>&nbsp;<TD style="background-color:'+Colors.MainTitle+'" width=30px>&nbsp;</td></tr>';
      m+='<TR><TD>General - Línea oscura: </td><TD><INPUT id=togDarkRow type=text size=7 maxlength=7 value="'+Colors.DarkRow+'"></td>&nbsp;<TD style="background-color:'+Colors.DarkRow+'" width=30px>&nbsp;</td></tr>';
      m+='<TR><TD>General - Botón de Selección: </td><TD><INPUT id=togButClick type=text size=7 maxlength=7 value="'+Colors.ButtonSelected+'"></td>&nbsp;<TD style="background-color:'+Colors.ButtonSelected+'" width=30px>&nbsp;</td></tr>';
      ...
      m+='<TR><TD>Información general - Línea oscura:</td><TD><INPUT id=togOverDarkRow type=text size=7 maxlength=7 value="'+Colors.OverviewDarkRow+'"></td>&nbsp;<TD style="background-color:'+Colors.OverviewDarkRow+'" width=30px>&nbsp;</td></tr>';
      m+='</table><BR><BR><DIV>Colores HTML:&nbsp;&nbsp;&nbsp;';
      m+='<a href="http://html-color-codes.info/codigos-de-colores-hexadecimales/" target="_blank">Seleccionar color</a>&nbsp;&nbsp;&nbsp;/&nbsp;&nbsp;&nbsp;';
      m+='<a href="http://html-color-codes.info/codigos-de-colores-hexadecimales/" target="_blank">Colores</a>';
      m+='<HR>Para aplicar los colores tiene que actualizar!<BR>';
...
/*******  TROOPS  ******/
  ...
  clickTroopDo : function (){
    ...
    t.displayCityStats ();
	if (t.running){
      t.stopTraining('<SPAN class=boldRed>Entrenamiento cancelado por el usuario</span>');
      return;
    }
    if (perSlot<1){
    ...
    if (perSlot*numSlots > t.stats.MaxTrain){
      t.divTrainStatus.innerHTML = '<FONT COLOR=#550000>No se puede entrenar mas tropas ( maximo '+ t.stats.MaxTrain +' en total)</font>';
      return;
    }
...
/*******  DEF  ******/
  ...
  clickDefDo : function (){
    ...
    if (perSlot<1){
      //t.divTrainStatus.innerHTML = '<FONT COLOR=#550000>El numero de unidades por grupo debe ser mayor que 0.</font>';
      return;
    }
  ...
  doDefQueue : function (cityId, siege, que, errMsg){
    ...
    try {
      ...
      var cmd = que.shift();
      if (!cmd){
        t.stopTraining ('<B>Cola de defensas acabada.</b>');
        return;
      }
      if (cmd[0] == 'T'){
        t.dispTrainStatus ('Entrenando '+ cmd[2] +' '+  fortNamesShort[cmd[1]] +' en '+ Cities.byID[cityId].name +' ('+ que.length +' slots restantes)<BR>');
      ...
      if (q!=null && q.length>0 ){
        ...
        for (var i=0; i<q.length; i++){
          ...
          if (actual < 0)
            actual = 0;
          q[i][6] = cityId;
          m += '<TR align=right><TD width="5px"><A><DIV onclick="cancelTrain('+ q[i][0]+','+q[i][1]+','+q[i][2]+','+q[i][3]+','+q[i][5]+','+q[i][6]+','+i +')">Cancelar</div></a></td>';
      ...
      if (q!=null && q.length > 0 ){
        ...
        for (i=0; i<q.length; i++){
          ...
          if (actual < 0)
            actual = 0;
          q[i][7]=cityId;
          m += '<TR align=right><TD width="5px"><A><DIV onclick="cancelFort('+ q[i][0]+','+q[i][1]+','+q[i][2]+','+q[i][3]+','+q[i][5]+','+q[i][6]+','+q[i][7] +','+ i +')">Cancelar</div></a></td>'
...
Tabs.OverView = {
  ...
  init : function (div){
    ...
    main +='<TR align=left><TD><SPAN class=ptStatLight>Conectado desde:</span> '+ dt.toLocaleDateString() +'</td>';
    main +='<TD><SPAN class=ptStatLight>Poderio:</span> ' + addCommas(Seed.player.might) +'</td>';
    main +='<TD><SPAN class=ptStatLight>Alianza:</span> ' + getMyAlliance()[1] +'</td>';
    main +='<TD align=right><SPAN class=ptStatLight>Dominio:</span> ' + uW.domainName +'</td></tr></table></div>';
  ...
  showBuilds : function (){
    ...
    m += "<TD align=left width=85 style='background:#F0F0F0'><INPUT id=showReq type=checkbox " + (t.showReq?'CHECKED ':'') +">Mostrar requerimientos.</td>";
    for(i=0; i<Cities.numCities; i++) {
    ...
    m+='<TR valign=top align=right><TD width=85 style="background:#F0F0F0">Construyendo</td>';
    for(i=0; i<Seed.cities.length; i++) {
    ...
    m+='</tr>';
    m+='<TR valign=top align=right><TD width=85 style="background:#F0F0F0">Investigando</td>';
    for(i=0; i<Seed.cities.length; i++) {
    	city = 'city'+Seed.cities[i][0];
    	m+='<TD width=79 style="background:#FFFFFF">';
    ...
    for (i=0;i<Seed.cities.length;i++){
    	...
    	if (wall >=6 && blacksmith >=6 && fletching >=5 && max > 0) m+= '<br>Libres: ' + max +'</td>';
    	else if (t.showReq){
    			if (wall < 6) m+= '<br><FONT COLOR= "CC0000">Muro: ' + wall + '(6)</font>';
    			if (blacksmith < 6) m+= '<br><FONT COLOR= "CC0000">Herreria: ' + blacksmith + '(6)</font>';
    			if (fletching < 5) m+= '<br><FONT COLOR= "CC0000">F.Flechas: ' + fletching + '(5)</font>';
    			m+='</td>';
    		}
    }
    ...
    for (i=0;i<Seed.cities.length;i++){
    	...
    	if (wall >=8 && blacksmith >=8 && fletching >=7 && geometry>=7 && max > 0) m+= '<br>Libres: ' + max+'</td>';
    	else if (t.showReq){
    			if (wall < 8) m+= '<br><FONT COLOR= "CC0000">Muro: ' + wall + '(8)</font>';
    			if (blacksmith < 8) m+= '<br><FONT COLOR= "CC0000">Herreria: ' + blacksmith + '(8)</font>';
    			if (fletching < 7) m+= '<br><FONT COLOR= "CC0000">F.Flechas: ' + fletching + '(7)</font>';
    			if (geometry < 7) m+= '<br><FONT COLOR= "CC0000">Geometria: ' + geometry + '(7)</font>';
    			m+='</td>';
    	}
    }
    m+='<TR valign=top align=right><TD width=85 style="background:#F0F0F0">Def. de Muro</td>';
    for (i=0;i<Seed.cities.length;i++){
    	city = 'city'+Seed.cities[i][0];
    	wall = parseInt(Seed.buildings[city].pos1[1]);
    ...
    for (i=0;i<Seed.cities.length;i++){
    	...
    	if (wall >=4 && blacksmith >=4 && poisonededge>=4 && max>0) m+= '<br>Left: ' + max+'</td>';
    			...
    			if (poisonededge < 4) m+= '<br><FONT COLOR= "CC0000">F. Envenenado: ' + poisonededge + '(4)</font>';
    			m+='</td>';
    	}
    }
    ...
    for (i=0;i<Seed.cities.length;i++){
    	...
    	if (wall >=1 && metalalloys >=1 && max>0) m+= '<br>Libres: ' + max+'</td>';
    	else if (t.showReq){
    			if (wall < 1) m+= '<br><FONT COLOR= "CC0000">Muro: ' + wall + '(1)</font>';
    			if (metalalloys < 1) m+= '<br><FONT COLOR= "CC0000">Ale. de metales: ' + metalalloys + '(1)</font>';
    			m+='</td>';
    	}
    }
    ...
    for (i=0;i<Seed.cities.length;i++){
    	...
    	if (wall >=2 && blacksmith>=2 && logging>=2 && max>0) m+= '<br>Libres: ' + max+'</td>';
    	else if (t.showReq){
    ...
    m+='<TR valign=top align=right><TD width=85 style="background:#F0F0F0">Def. de Campo</td>';
    for (i=0;i<Seed.cities.length;i++){
    	city = 'city'+Seed.cities[i][0];
    	wall = parseInt(Seed.buildings[city].pos1[1]);
    ...
    m+='</tr><TR><TD colspan="8" style="background: #FFFFFF; border:none">&nbsp;</td></tr>';
    m+='<TR valign=top align=right><TD width=85 style="background:#F0F0F0">Esp. en ciudad</td>';
    ...
    m+='</tr>';
    m+='<TR valign=top align=right><TD width=85 style="background:#F0F0F0">Esp. en Campo</td>';
    ...
    m+='<TR valign=top align=right><TD width=85 style="background:#F0F0F0">Guardian</td>';
    for(i=0; i<Seed.cities.length; i++) {
    ...
    for (i in uW.techcost) {
    	...
    	if (t.showReq) {
    		...
    		switch (i) {
 case '1':
    				if (alchemylab < Seed.tech[i]) m+='<BR>Laboratorio '+ alchemylab+ '('+ (Seed.tech[i]) +')';
    				if (farm < Seed.tech[i]) m+='<BR>Granja '+ farm +'('+ (Seed.tech[i]+1) +')</td>';
    				break;
    			case '2':
    				if (alchemylab < Seed.tech[i]) m+='<BR>Laboratorio '+ alchemylab+ '('+ (Seed.tech[i]) +')';
    				if (sawmill < Seed.tech[i]) m+='<BR>Aserradero '+ sawmill +'('+ (Seed.tech[i]) +')';
    				break;
    			case '3':
    				if (alchemylab < Seed.tech[i]) m+='<BR>Laboratorio '+ alchemylab+ '('+ (Seed.tech[i]) +')';
    				if (quarry < Seed.tech[i]) m+='<BR>Cantera '+ quarry +'('+ (Seed.tech[i]) +')</td>';
    				break;
    			case '4':
    				if (alchemylab < Seed.tech[i]) m+='<BR>Laboratorio '+ alchemylab+ '('+ (Seed.tech[i]) +')';
    				if (mine < Seed.tech[i]) m+='<BR>Mina '+ mine +'('+ (Seed.tech[i]) +')';
    				break;
    			case '5':
    				if (alchemylab < 3) m+='<BR>Laboratorio '+ alchemylab +'(3)';
    				if (alchemylab >= 3 && alchemylab < Seed.tech[i]) m+='<BR>Laboratorio '+ alchemylab +'('+ (Seed.tech[i]) +')';
    				if (workshop < Seed.tech[i]) m+='<BR>Taller ' + workshop +'('+ (Seed.tech[i]) +')';
    				if (stoneworking < 2) m+='<BR>Trabajo de la piedra '+ stoneworking +'(2)';
    				break;
    			case '6':
    				if (alchemylab < 3) m+='<BR>Laboratorio '+ alchemylab +'(3)';
    				if (alchemylab >= 3 && alchemylab < Seed.tech[i]) m+='<BR>Laboratorio '+ alchemylab +'('+ (Seed.tech[i]) +')';
    				break;
    			case '8':
    				if (alchemylab < 2) m+='<BR>Laboratorio '+ alchemylab +'(2)';
    				if (alchemylab >= 2 && alchemylab < Seed.tech[i]) m+='<BR>Laboratorio '+ alchemylab +'('+ (Seed.tech[i]) +')';
    				if (barracks < 2) m+='<BR>Cuartel '+ barracks +'(2)';
    				break;
    			case '9':
    				if (alchemylab < 3) m+='<BR>Laboratorio '+ alchemylab +'(3)';
    				if (alchemylab >= 3 && alchemylab < Seed.tech[i]) m+='<BR>Laboratorio '+ alchemylab +'('+ (Seed.tech[i]) +')';
    				if (blacksmith < Seed.tech[i]) m+='<BR>Herreria '+ blacksmith+'('+ (Seed.tech[i]) +')';
    				if (mining < Seed.tech[i]) m+='<BR>Mineria '+ mining +'('+ (Seed.tech[i]) +')';
    				break;
    			case '10':
    				if (alchemylab < 4) m+='<BR>Laboratorio '+ alchemylab +'(4)';
    				if (alchemylab >= 4 && alchemylab < Seed.tech[i]) m+='<BR>Laboratorio '+ alchemylab +'('+ (Seed.tech[i]) +')';
    				break;
    			case '11':
    				if (alchemylab < 4) m+='<BR>Laboratorio '+ alchemylab +'(4)';
    				if (alchemylab >= 4 && alchemylab < Seed.tech[i]) m+='<BR>Laboratorio '+ alchemylab +'('+ (Seed.tech[i]) +')';
    				break;
    			case '12':
    				if (alchemylab < 5) m+='<BR>Laboratorio '+ alchemylab +'(5)';
    				if (alchemylab >= 5 && alchemylab < Seed.tech[i]) m+='<BR>Laboratorio '+ alchemylab +'('+ (Seed.tech[i]) +')';
    				if (stable < Seed.tech[i]) m+='<BR>Establo '+ stable +'('+ (Seed.tech[i]+1) +')';
    				if (metalalloys < Seed.tech[i]) m+='<BR>Aleaciones de metal '+ metalalloys +'('+ (Seed.tech[v]+1) +')';
    				break;
    			case '13':
    				if (alchemylab < 4) m+='<BR>Laboratorio '+ alchemylab +'(4)';
    				if (alchemylab >= 4 && alchemylab < Seed.tech[i]) m+='<BR>Laboratorio '+ alchemylab +'('+ (Seed.tech[i]) +')';
    				...
    				break;
    			case '14':
    				if (alchemylab < 6) m+='<BR>Laboratorio '+ alchemylab +'(6)';
    				if (alchemylab >= 6 && alchemylab < Seed.tech[i]) m+='<BR>Laboratorio '+ alchemylab +'('+ (Seed.tech[i]) +')';
    				if (storehouse < Seed.tech[i]) m+='<BR>Almacen '+ storehouse +'('+ (Seed.tech[i]) +')';
    				if (logging < 3) m+='<BR>Logging '+ logging+'(3)';
    				break;
    			case '15':
    				if (alchemylab < 6) m+='<BR>Laboratorio '+ alchemylab +'(6)';
    				if (alchemylab >= 6 && alchemylab < Seed.tech[i]) m+='<BR>Laboratorio '+ alchemylab +'('+ (Seed.tech[i]) +')';
    				if (featherweightpowder  < 3) m+='<BR>Polvo de peso pluma  '+ featherweightpowder +'(3)';
    				break;
    			case '16':
    				if (alchemylab < 5) m+='<BR>Laboratorio '+ alchemylab +'(5)';
    				if (alchemylab >= 5 && alchemylab < Seed.tech[i]) m+='<BR>Laboratorio '+ alchemylab +'('+ (Seed.tech[v]) +')';
    				if (logging  < 5) m+='<BR>Explotación florestal '+ logging +'(5)';
    				if (geometry  < 2) m+='<BR>Geometria  '+ geometry +'(2)';
    				break;
    		}
    		m+='</font>';
    	}
  ...
  showInfo : function (){
	  ...
	  var u='<DIV class=ptstat>ENLACES DE INTERÉS</div><DIV id=ptLinks><TABLE align=center cellpadding=1 cellspacing=0><TR>';
	  ...
	  u+='<TR><TD width="300px" style="background:#F0F0F0; border:none"><a href="http://userscripts.org/scripts/show/104794" target="_blank">KOC Power Tools Español(traducido por Aioras)</a></td>';
	  ...
	  u+='<TR><TD width="100px" style="background:#F0F0F0; border:none"><a href="http://userscripts.org/scripts/show/104793" target="_blank">KOC Power Bot Español(traducido por Aioras)</a></td>';
	  ...
	  u+='<TR><TD width="100px" style="background:#F0F0F0; border:none"><a href="https://addons.mozilla.org/en-US/firefox/addon/greasemonkey/versions/" target="_blank">Versiones Greasemonkey</a></td><TD width="100px" style="background:#F0F0F0; border:none"></td>';
	  ...
	  u+='<DIV class=ptstat>INFORMACIÓN DE TIERRAS</div><DIV id=ptLinks><TABLE align=center cellpadding=1 cellspacing=0><TR>';
...
if (Seed.quests[deed] ==1) u+='<TD 200px style="background:#CCFFCC">';
	  ...
	  fortmight = {
	      ...
	      u += '<STYLE>.xtabH {background:#ffffe8; border:none; padding-right: 5px; padding-left: 5px; margin-left:10px; }\
	              ...
	              .xtabL { background:none; border-width: 1px; border-style: none none none solid; padding-right:5px; padding-left: 5px; margin-left:10px; }\
	              .xtabLine { padding:0px; spacing:0px; height:1px; border-color:black; border-width: 1px; border-style: none none solid none }</style>\
	          <DIV style="overflow-y:auto; overflow-x:hidden"><DIV class=ptstat>INFORMACIÓN DE UNIDADES</div><TABLE align=center cellpadding=1 cellspacing=0>\
	          <TR align=center><TD class=xtab></td><TD class=xtabHL colspan=5><B>COSTES DE CONSTRUCCION</b></td><TD class=xtabHL colspan=7><B>ESTADISTICAS</b></td><TD class=xtabHL><B>Mantenimiento</b></td></tr>\
	          <TR valign=bottom align=right><TD class=xtab></td><TD class=xtabHL>Alimento</td><TD class=xtabH>Madera</td><TD class=xtabH>Piedra</td>\
	          <TD class=xtabH>mineral</td><TD class=xtabH>Pobla.</td><TD class=xtabHL>Poder</td><TD class=xtabH>Vida</td><TD class=xtabH>Atk</td><TD class=xtabH>Def</td><TD class=xtabH>Velocidad</td><TD class=xtabH>Rango</td><TD class=xtabH>Carga</td>\
	          <TD class=xtabHL>Alimento</td></tr>\
	          <TR style="height:1px;"><TD style="padding:0px; spacing:0px; height:1px; border-color:black; border-width: 1px; border-style: none none solid none" colspan=14></td></tr>';
	      for (ui=1; ui<13; ui++){
	        if (++rownum % 2)
  ...
  paintOld : function (){
    ...
    for(i=0; i<Cities.numCities; i++){
      ...
      Gate = parseInt(Seed.citystats[cityID].gate);
    if(Gate == 0)
      str += '<TD>Refugiando</td>';
    else
      str += '<TD><SPAN class=boldRed><blink>Defendiendo</blink></span></td>';
    }
      ...
      rownum = 0;
      str += _row ('Trop. Suminis.', rows[1]);
      str += _row ('Milicianos', rows[2]);
      str += _row ('Exploradores', rows[3]);
      str += _row ('Piqueros', rows[4]);
      str += _row ('Espadachin', rows[5]);
      str += _row ('Arqueros', rows[6]);
      str += _row ('C. Ligera', rows[7]);
      str += _row ('C. Pesada', rows[8]);
      str += _row ('Carretas', rows[9]);
      str += _row ('Ballistas', rows[10]);
      str += _row ('Arrietes', rows[11]);
      ...
      str += _row ('Cons. alimento', row, true);
      str += '<TR><TD><BR></td></tr>';
      ...
      str += _row ('Entre. Defensas', row, true);
      str += '<TR><TD class=xtab></td><TD class=xtab colspan=4><BR><INPUT type=CHECKBOX id=idCheck'+ (Options.includeMarching?' CHECKED':'') +'>Incluir Tropas/Recursos en marcha</td></tr>';
      str += '<TR><TD class=xtab></td><TD class=xtab colspan=4><INPUT type=CHECKBOX id=ptoverIncTraining'+ (Options.includeTraining?' CHECKED':'') +'>Incluir tropas entrenando</td></tr>';
		str += '<TR><TD class=xtab></td><TD class=xtab colspan=4><INPUT type=CHECKBOX id=ptOverOver'+ (Options.overviewAllowOverflow?' CHECKED':'') +'>Permitir desbordamiento de ancho \
        &nbsp; &nbsp; FONT SIZE: '+ htmlSelector ({9:9, 10:10, 11:11, 12:12}, Options.overviewFontSize, 'id=ptoverfont') +'</td></tr><BR>';
      str += "</table></div>";
	  str+= 'Version de Power Menu:' + Version;
...
Tabs.Rpt = {
  ...
  init : function (div){
    ...
    t.cont=div;
		...
		var tc = '<DIV class=ptstat>Buscar informes en bandeja de entrada o alianza</DIV><DIV class=ptentry><TABLE><TR align=center valign=center>';
		tc += '<TD class=xtab align=right>Tipo:&nbsp;<SELECT id="idRptType">';
		tc += '<OPTION value="alliance" ' + (Options.rptType=='alliance'?'SELECTED':'') + '>Alianza</OPTION>';
		tc += '<OPTION value="player" ' + (Options.rptType=='player'?'SELECTED':'') + '>Jugador</OPTION>';
		tc += '<OPTION value="inbox" ' + (Options.rptType=='inbox'?'SELECTED':'') + '>Entrada</OPTION>';
		tc += '<OPTION value="outbox" ' + (Options.rptType=='outbox'?'SELECTED':'') + '>Salida</OPTION></SELECT>';
		tc += '<BR />Paginas:&nbsp;<INPUT id="idRptPageFrom" size=1 value="' + Options.arPageFrom + '">&#8211;<INPUT id="idRptPageTo" size=1 value="' + Options.arPageTo + '"></TD>';
		tc += '<TD class=xtab align=right>Atacante:&nbsp;<SELECT id="idRptAttacker">'; // Options.arPageFrom - Options.arPageTo
		tc += '<OPTION value="Them" ' + (Options.arAttacker=='Them'?'SELECTED':'') + '>Ellos</OPTION>';
		tc += '<OPTION value="Us" ' + (Options.arAttacker=='Us'?'SELECTED':'') + '>Nosotros</OPTION>';
		tc += '<OPTION value="Both" ' + (Options.arAttacker=='Both'?'SELECTED':'') + '>Both</OPTION></SELECT>';
		tc += '<BR />Objetivo:&nbsp;<SELECT id="idRptTarget">';
		tc += '<OPTION value="Them" ' + (Options.arTarget=='Them'?'SELECTED':'') + '>Ellos</OPTION>';
		tc += '<OPTION value="Us" ' + (Options.arTarget=='Us'?'SELECTED':'') + '>Nosotros</OPTION>';
		tc += '<OPTION value="Both" ' + (Options.arTarget=='Both'?'SELECTED':'') + '>Both</OPTION></SELECT></TD>';
		tc += '<TD class=xtab align=right>Contiene:&nbsp;<INPUT id=idRptWhat type=text size=11 maxlength=50 value=""><BR />';
		tc += 'Pero no:&nbsp;<INPUT id=idRptWhatNot type=text size=11 maxlength=50 value=""></TD>';
		tc += '<TD class=xtab align=left><INPUT id=idRptAttack type=checkbox '+(Options.arAttack?'CHECKED':'')+' />&nbsp;Ataque<BR />';
		tc += '<INPUT id=idRptScout type=checkbox '+(Options.arScout?'CHECKED':'')+' />&nbsp;Exploración</TD>';
		tc += '<TD class=xtab align=left><INPUT id=idRptReinforce type=checkbox '+(Options.arReinforce?'CHECKED':'')+' />&nbsp;Refuerzo<BR />';
		tc += '<INPUT id=idRptTransport type=checkbox '+(Options.arTransport?'CHECKED':'')+' />&nbsp;Transporte</TD>';
		tc += '<TD class=xtab align=left><INPUT id=idRptSearch type=submit value="Iniciar busqueda" /></TD></TR></TABLE></DIV>';
	...
	handleRptSearch: function(){
		...
		t.handleRptPages();
		document.getElementById ('idRptSearch').value = 'Parar Busqueda';
		document.getElementById('idRptStatus').innerHTML = 'Búsqueda página ' + t.minPages + ' de ' + t.maxPages;
	...
	stopSearch: function (msg){
		...
		document.getElementById ('idRptSearch').value = 'Iniciar busqueda';
		t.searchRunning = false;
		if (Options.rptType == 'alliance' || Options.rptType == 'player')
			t.DisplayRpt();
		else
	...
	getMailCallback: function(rslt, page) {
		...
		if (rslt) {
			...
			if (parseInt(page)+1 <= t.maxPages && t.searchRunning) {
				document.getElementById("idRptStatus").innerHTML = 'Búscando página ' + (parseInt(page)+1) + ' de ' + t.maxPages;
		...
		if (rslt) {
			...
			if (rslt.arReports && page) {
				...
				for (var i = 0; i < rptkeys.length; i++) {
					...
					if (parseInt(rpt.side0TileType) == 10)
						t.report[reportId].side0TileTypeText='Pradera';
					else if (parseInt(rpt.side0TileType) == 11)
						t.report[reportId].side0TileTypeText='Lago';
					else if (parseInt(rpt.side0TileType) == 20)
						t.report[reportId].side0TileTypeText='Bosque';
					else if (parseInt(rpt.side0TileType) == 30)
						t.report[reportId].side0TileTypeText='Colina';
					else if (parseInt(rpt.side0TileType) == 40)
						t.report[reportId].side0TileTypeText='Montaña';
					else if (parseInt(rpt.side0TileType) == 50)
						t.report[reportId].side0TileTypeText='Planicie';
					else if (parseInt(rpt.side0CityId) ==0)
						t.report[reportId].side0TileTypeText='Barbaros';
					else
						t.report[reportId].side0TileTypeText='Ciudad';
					...
					if (rpt.marchType == 0)
						...
						t.report[reportId].marchName = 'Transporte';
					else if (rpt.marchType == 2)
						t.report[reportId].marchName = 'Refuerzo';
					else if (rpt.marchType == 3) {
						if (t.report[reportId].sideId == 0)
							t.report[reportId].marchName = 'Anti-Exploración';
						else
							t.report[reportId].marchName = 'Exploración';
					} else if (rpt.marchType == 4) {
						if (t.report[reportId].sideId == 0)
							t.report[reportId].marchName = 'Defensa';
						else
							t.report[reportId].marchName = 'Ataque';
					} else
			...
			if (parseInt(page)+1 <= t.maxPages && t.searchRunning) {
				document.getElementById("idRptStatus").innerHTML = 'Buscando pagina ' + (parseInt(page)+1) + ' de ' + t.maxPages;
	...
	DisplayMail: function (){
		...
		if(!t.data.length) {
			results.innerHTML = '<center>No se encontro ninguno</center>';
			return;
		}
		...
		for (var i=0; i<reportsSearched;i++) {
			...
			if ((t.what == '' || (rpt.subject.search(t.what, "i") != -1) || (rpt.displayName.search(t.what, "i") != -1))
				...
				reportsFound++;
				if (reportsFound == 1)
					t.content += '<center><table><thead><th>P</th><th>Fecha</th><th>desde</th><th>Tema</th></thead><tbody>';
		...
		if (reportsFound == 0 && reportsSearched > 0)
			t.content = '<center>No se encontrarón</center>';
		results.innerHTML = t.content;
		document.getElementById("idRptSearched").innerHTML = '&nbsp;Buscando: ' + reportsSearched;
		document.getElementById("idRptFound").innerHTML = 'Encontradas: ' + reportsFound;
	},
	...
	displayMailBody: function (messageBody) {
		...
		t.popMsg.getTopDiv().innerHTML = '<DIV align=center><B>Mensage</B></DIV>';
		t.popMsg.show(true);
	},
	...
	DisplayRpt: function (){
		...
		var results = document.getElementById("idRptResultsDiv");
		if(!t.data.length) {
			results.innerHTML = '<center>No se encontrarón</center>';
			return;
		}
		...
		for (var i=0; i<reportsSearched;i++) {
			...
			if ((((myAllianceId == parseInt(rpt.side1AllianceId) && Options.arAttacker != 'Them')
				...
				&& ((Options.arAttack && (rpt.marchName == 'Ataque' || rpt.marchName == 'Defensa'))
				|| (Options.arScout && (rpt.marchName == 'Exploración' || rpt.marchName == 'Anti-Exploración'))
				|| (Options.arReinforce && rpt.marchName == 'Refuerzo')
				|| (Options.arTransport && rpt.marchName == 'Transporte')))
				...
				if (((t.what == ''
					...
					if (reportsFound == 1) {
						if (Options.enableReportNumber)
							t.content += '<center><table><thead><th>P</th><th>Fecha</th><th>Reporte</th><th>Atacante</th><th>Desde</th>';
						else
							t.content += '<center><table><thead><th>P</th><th>Fecha</th><th>Atacante</th><th>Desde</th>';
						if (Options.arAttacker != 'Us')
							t.content += '<th>Alianza</th>';
						t.content += '<th>Acción</th><th>Objetivo</th><th>Tipo</th><th>En</th>';
						if (Options.arTarget != 'Us')
							t.content += '<th>Alianza</th>';
						t.content += '<th>Dist</th><th>Coordenadas</th></thead><tbody>';
					}
		...
		results.innerHTML = t.content;
		document.getElementById("idRptSearched").innerHTML = '&nbsp;Buscando: ' + reportsSearched;
		document.getElementById("idRptFound").innerHTML = 'Encontrados: ' + reportsFound;
	},
	...
	getReportBody: function(reportId){
		...
		if (params.side > -1) {
			...
			unsafeWindow.alert ('No se pudo determinar de qué lado del informe para ver - por favor, envíe los detalles para el desarrollador');
		}
	},
	...
	displayReportBody: function (rslt, reportId) {
		...
		unitImg[53] = '<img src=http://cdn1.kingdomsofcamelot.com/fb/e2/src/img/units/unit_53_30.png></TD><TD>Ballistas de Muro';
		unitImg[55] = '<img src=http://cdn1.kingdomsofcamelot.com/fb/e2/src/img/units/unit_55_30.png></TD><TD>Fundibulos';
		unitImg[60] = '<img src=http://cdn1.kingdomsofcamelot.com/fb/e2/src/img/units/unit_60_30.png></TD><TD>Trampas';
		unitImg[61] = '<img src=http://cdn1.kingdomsofcamelot.com/fb/e2/src/img/units/unit_61_30.png></TD><TD>Abrojos';
		unitImg[62] = '<img src=http://cdn1.kingdomsofcamelot.com/fb/e2/src/img/units/unit_62_30.png></TD><TD>Barrera de picos';
		goldImg = '<img src=http://cdn1.kingdomsofcamelot.com/fb/e2/src/img/gold_30.png></TD><TD>Oro';
		foodImg = '<img src=http://cdn1.kingdomsofcamelot.com/fb/e2/src/img/food_30.png></TD><TD>Alimento';
		woodImg = '<img src=http://cdn1.kingdomsofcamelot.com/fb/e2/src/img/wood_30.png></TD><TD>Madera';
		stoneImg = '<img src=http://cdn1.kingdomsofcamelot.com/fb/e2/src/img/stone_30.png></TD><TD>Piedra';
		...
		function buildHeader () {
			...
			if (rpt.marchName == 'Anti-Exploración' || rpt.marchName == 'Exploración')
				h+=rpt.marchName+' en';
			else if (rpt.marchName == 'Ataque' || rpt.marchName == 'Defensa')
				h+='Batalla en ';
			else if (rpt.marchName == 'Refuerzo' || rpt.marchName == 'Transporte')
				h+=rpt.marchName+' desde<BR />'+rpt.marchName+' a</B>';
			...
			if (rpt.side0TileTypeText != 'Ciudad' && rpt.side0TileTypeText != 'Barb' && rpt.marchName == 'Ataque') {
				if (rslt['conquered']==1)
					h+='<TD><FONT color="#CC0000"><B>Conquistada</B></font></td>';
				else if (rslt['conquered']==0)
					h+='<TD><FONT color="#66CC33"><B>Asegurados</B></font></td>';
		...
		function handlefrt () { // Fortifications found on a Scout
			...
			if (rslt['frt']) {
				if (rslt['frt']) {
					th='<TABLE class=ptTab><TR><TH colspan=3 align=left>Defensas encontrasdas</TH></TR>';
					if (rslt['frt']['f53'])
						tc+='<TR><TD>' + unitImg[53] + '</TD><TD align=right>'+addCommas(rslt['frt']['f53'])+'</TD></TR>';
					if (rslt['frt']['f55'])
						tc+='<TR><TD>' + unitImg[55] + '</TD><TD align=right>'+addCommas(rslt['frt']['f55'])+'</TD></TR>';
		...
		if ((rslt['winner']==1 && rpt.sideId==0) || (rslt['winner']==0 && rpt.sideId==1)) {
			if (rpt.marchName == 'Exploración')
				...
				m+='<TR><TD><FONT color="#CC0000"><B>Has sido vencido</B></font></TD></TR>';
		}
		if (rslt['winner']==0 && rpt.sideId==0)
			m+='<TR><TD><FONT color="#66CC33"><B>Defendiste satisfactoriamente!</B></font></TD></TR>';
		if (rslt['winner']==1 && rpt.sideId==1) {
			if (rpt.marchName == 'Exploración')
				m+='<TR><TD><FONT color="#66CC33"><B>Reporte de exploración</B></font></TD></TR>';
			else
		...
		if (rslt['wall']) {
			if (rslt['wall'] == 100)
				m+='<TR><TD>Los atacantes rompierón los muros.</TD></TR>';
			else
				m+='<TR><TD>Los atacantes no rompierón los muros. Los muros estan al '+rslt['wall']+'% </TD></TR>';
		}
		m+= '</TABLE><BR />';
		...
		if (rpt.marchName == 'Exploración' && rslt['winner']==1) {
			...
			if (rslt['lstlgn']) {
				if (!rslt['lstlgn'])
					m+='<TR><TD>Ultimo login: No se recuerda</TD></TR>';
				else
					m+='<TR><TD>Ultimo login: ' + formatUnixTime(rslt['lstlgn']) + '</TD></TR>';
			}
			m+='<TR><TD>Caballero de combate: ';
			if (rslt['knt'])
				m+=rslt['knt']['cbt'];
			else
				m+='Ninguno';
			...
			if (rslt['tch']) {
				m+='<TABLE class=ptTab><TR><TH colspan=2 align=left>Investigaciónes</TH></TR>';
				for (var tl in rslt.tch)
					tid = /[0-9]/.exec(tl);
		...
		if (rslt['fght']){ // not Reinforce or Transport, so we have a table with 2 columns: 1 for Attackers, 1 for Defenders
			...
			m+='</TD></TR>';
			if (rpt.marchName == 'Ataque' || rpt.marchName == 'Defensa')
				m+='<TR><TD colspan=4>Habilidad de Caballero: ' + rslt['s1KCombatLv'] + '</TD></TR>';
			m+='<TR><TD colspan=4>Refuerzo de ataque: ' + 100*rslt['s1atkBoost'] + '%</TD></TR>';
			m+='<TR><TD colspan=4>Refuerzo de defensa: ' + 100*rslt['s1defBoost'] + '%</TD></TR>';
			m+='<TR><TD colspan=4>(<A onclick="ptGotoMap('+ rpt.side1XCoord +','+ rpt.side1YCoord +')">'+ rpt.side1XCoord +','+ rpt.side1YCoord +'</a>) ' + rpt.side1CityName + '</TD></TR>';
			if (rslt['fght']["s1"] != undefined) {
				m+='<TR><TH></TH><TH align=left>Tropas</TH><TH align=right>Pelearón</TH><TH align=right>Sobrevivierón</TH></TR>';
				for (var i=1;i<13;i++) {
			...
			if (rslt['s0atkBoost'] !== undefined)
				m+='<TR><TD colspan=4>Refuerzo de ataque: ' + 100*rslt['s0atkBoost'] + '%</TD></TR>';
			else
				m+='<TR><TD colspan=4>&nbsp;</TD></TR>';
			if (rslt['s0defBoost'] !== undefined)
				m+='<TR><TD colspan=4>Refuerzo de defensa: ' + rslt['s0defBoost'] + '%</TD></TR>';
			else
				m+='<TR><TD colspan=4>&nbsp;</TD></TR>';
			m+='<TR><TD colspan=4>Rondas: ' + rslt['rnds'] + '</TD></TR>';
...
Tabs.Alliance = {
  ...
  init : function (div){    
    ...
    var m =  '<DIV class=ptstat>FUNCIONES DE ALIANZA</div><TABLE align=center cellpadding=1 cellspacing=0></table>';
    
    m +='<TABLE class=ptTab><TD width=200px>Listar Miembros de Alianza</td><TD>Mostrar por: <select id="searchAlli"><option value="name">Nonmbre</option>';
    m += '<option value="might">Poderio</option>';
    m += '<option value="login">'+uW.g_js_strings.modal_messages_viewreports_view.lastlogin+'</option>';
    m += '<option value="cities">Ciudades</option>';
    m += '<option value="position">Posición</option>';
    m += '<option value="dip">Dias en la posición (dip)</option></select></td>';
    m += '<TD><INPUT id=alList type=submit value="Lista"></td>';
    m += '<TD id=progress></td>';
    m += '<TR><TD width=200px>Mostrar diplomacia de Alianzas</td><TD><INPUT id=aldiplo type=submit value="Listar Diplomacias"></td></tr></table>';
    
    m+='<DIV class=ptstat>GENERAL</div><TABLE align=center cellpadding=1 cellspacing=0></table>';
  ...
  var t = Tabs.Alliance; 
    ...
    _addTab: function(Name,Might,LastLogin,Position,dip,uid,fbuid,Cities){
             ...
             row.vAlign = 'top';
             row.insertCell(0).innerHTML ='<A target="_tab" href="http://www.facebook.com/profile.php?id='+ fbuid +'">perfil</a>';
    ...
    var t = Tabs.Alliance;
        ...
        row.insertCell(2).innerHTML = "Poderio";
        row.insertCell(3).innerHTML = "Ciudades";
        row.insertCell(4).innerHTML = "Positioción";
        row.insertCell(5).innerHTML = "DIP(Dias en la Posición)";
        row.insertCell(6).innerHTML = "Ultimo Login";
      },   
    ...
    paintDiplomacy : function () {
    	document.getElementById('alOverviewTab').innerHTML ="";
    	document.getElementById('progress').innerHTML ="";
    	var m= '<TR><TD colspan=4 style=\'background: #33CC66;\' align=center><B>Amigable: </b></td></tr>';
    	if (Seed.allianceDiplomacies['friendly'] == null) m+='<TR><TD>No se encontrarón amigables...</td>';
    	else m += '<TABLE class=xtab><TR><TD>Nombre de Alianza</td><TD>Miembros</td></tr>';
    	...
    	m+='<TR></tr></table>';
    	m+= '<TR><TD colspan=4 style=\'background: #CC0033;\' align=center><B>Hostiles: </b></td></tr>';
    	if (Seed.allianceDiplomacies['hostile'] == null) m+='<TR><TD>No se encontrarón hostiles...</td>';
    	else m += '<TABLE class=xtab><TR><TD>Nombre de Alianza</td><TD>Miembros</td></tr>';
    	...
    	m+='<TR></tr></table>';
    	m+= '<TR><TD colspan=4 style=\'background: #FF6633;\' align=center><B>Amigables hacia nosotros: </b></td></tr>';
    	if (Seed.allianceDiplomacies['friendlyToYou'] == null) m+='<TR><TD>No se encontrarón amigables hacia nosotros...</td>';
    	else m += '<TABLE class=xtab><TR><TD>Nombre de Alianza</td><TD>Miembros</td></tr>';
...
Tabs.Marches = {
  ...
  /***   MARCHES SUBTAB  ***/
    showMarches : function (){
     ...
     if (t.widescreen) m += '<TR><TD><INPUT id=Wide type=checkbox checked=true>Pantalla ancha</td>';
     else  m += '<TR><TD><INPUT id=Wide type=checkbox unchecked=true>Pantalla ancha</td></tr></table>';
  ...
  showReinforcements : function (){
    var rownum = 0;
    var names = ['Tropa Sum.', 'Mili.', 'Explor.', 'Pique.', 'Espad.', 'Arquer.', 'C. Ligera', 'C. Pesada', 'Carretas', 'Ballistas', 'Arrietes', 'Catapultas'];
    var t = Tabs.Marches;
    clearTimeout (t.displayTimer);
...
//logit ("enc: "+ inspect (enc, 6, 1));    
    ...
    if (numSlots == 0){
      ...
      s += '<TABLE cellspacing=0 width=100%><TR align=right><TD align=left width=16%><B>Jugador (Habilidad Cab.)</b></td>';
...
// TODO: Only allow 'send home' if troops are here now  (marchStatus = ?)              
              s += '<TR align=right><TD align=left>'+ player + knight +' <A><SPAN onclick="r8x6Home('+ march.marchId +')">Regresar</span></a></td>'
              for (i=1; i<13; i++){
    ...
    s += '<BR><BR><INPUT type=CHECKBOX id=idCheck2 '+ (Options.encRemaining?'':' CHECKED ') +'> Mostrar tropas originales';
    s += '<BR><BR><DIV style="font-size: 10px">NOTA: Es necesario actualizar KofC para mostrar las tropas que quedan acampadas despues de una batalla.</div>';
  ...
  Cpager : function (a, b){
    ...
    function getHtmlElement (){
      ...
      div.innerHTML = '<STYLE>table.ptPageNav tr td  {border:none; text-align:center; padding:0px 1px;}\
        ...
        <TD width=20></td><TD>Pagina <INPUT id=ptPagerPageNum onChange="pageNavigatorView.e_inp()" type=text size=1> de <span id=ptPagerNumPages>?</span></td>\
        </tr></table>';
...
function dialogRetry (errMsg, seconds, onRetry, onCancel){
  ...
  pop.getTopDiv().innerHTML = '<CENTER>KOC Power Manu</center>';
  pop.getMainDiv().innerHTML = '<CENTER><BR><FONT COLOR=#550000><B>Ha ocurrido un error:</b></font><BR><BR><DIV id=paretryErrMsg></div>\
      <BR><BR><B>Reintentar automáticamente en <SPAN id=paretrySeconds></b></span> segundos ...<BR><BR><INPUT id=paretryCancel type=submit value="CANCELAR Reintento" \>';
