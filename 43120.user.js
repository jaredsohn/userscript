// ==UserScript==
// @name           Travian Map (ID) test
// @namespace      TRAVIAN MAP
// @author         Reza Revando Bawole
...
function addImage() {
	var content = document.getElementById('lright1');
	...
	img.setAttribute('style', 'position:absolute;  z-index:79; left:10px; top:10px;');
    ...
    'Nzc3Nzc3Nzc3Nzc3Nzc3Nzc3Nzc3Nzc3Nzc3Nzc3Nzc3Nzc3Nzc3Nzc3Nzf/wAARCAAtADUDASIA'+
    'AhEBAxEB/8QAGgAAAwEAAwAAAAAAAAAAAAAAAAUGBAIDB//EADAQAAIBAwEGAwcFAQAAAAAAAAEC'+
    'AwAEEQUGEhMhMUEUUWEVIiMygZHBUnGhsdHx/8QAGAEAAwEBAAAAAAAAAAAAAAAAAAECAwT/xAAd'+
    'EQEAAgIDAQEAAAAAAAAAAAABAAIRIQMSMUFR/9oADAMBAAIRAxEAPwD3GkWva54KVbaDJkPzFRkj'+
    '0H+np609qDtrd77Xb5nySs7j6bxA/qouuSp9jP2NbKLVbl+M7skTHO74t97H2xW2DUJba5aC4EhV'+
    'eZ4nUL+oEfMPPuK7Yn8JGA7hccuZ5Uj2l1SFbTixzKZ45U3AvPOWAI+oJFRevQyMY9nEsaKnm1O4'+
    'ksoo7MrGQigytgnOOw/7Way1C7sIlSeZnTi5ZpRlsE88fz96o5KsOjKqiiitJMw6tqtppFrx72Td'+
    'BOERRl5G8lHc1A7NbSe3dau59Ks5EmVi80WQyhOQByOpPcdsZGe+PbDQ9p9oNrZLaAvDb7pjErqe'+
    'GkJ55Vh1J6Edcjyqg0XTodkbbwGnLkk700zj3pW8z+BU2qWNxjibNormK4W1UxYlVgzZIwB3HPn1'+
    'x2pLcabNqGpI05CWcD70aKMb5/UfwPrTnWLkanpUkU8fxI/iROvUMP8AeY+tLLXUEuLRXhkLOI/k'+
    '5KCR6kVz8lUds0o61Oy5geLMg5KDyC5P39KDdl7OV7jcijRcFjzPpgdznFEl9bog4l0Qe+G3vp5U'+
    'llu5NVnC2kU9yQ+bdUXOfOQ4HQds96mlN68l2u42blnsrevqAu5XuW9xlj4ZbJGAcn+ccuXumiuG'+
    'x2kyWMNyLmwFursvDDMGO6M8uR7fmiusVMswTDGmrWVzcYe1mKMOq560r9kX0hHGYNjuTVNRTikq'+
    '9pNbNuyoQPPsalL/AGUuUmh9nPJMj5DBmCBD55AzivVGUMMMAR5Gs5soc5C7v7UrVLexinkmNJ2I'+
    '0+NYbi8zc3CHebI939gD2/un+k2Twca5uQvibhstjoijkqj0A/NbokEa4Fc6AxoihRRRThP/2Q==';
...
//	loadFalseData();
	...
	function createInfoBox() {
		...
		info.innerHTML = '<table class="f8 map_infobox_grey" width="100%" cellspacing="1" cellpadding="2">' +
				 '<tr><td class="c b" colspan="2" align="center">' + 'Rincian' + '</td></tr>' +
				 '<tr><td class="c s7" width="45%" >' + 'Pemain' + '</td><td class="c s7">-</td></tr>' +
				 '<tr><td class="c s7">' + 'Populasi :' + '</td><td class="c s7">-</td></tr>' +
				 '<tr><td class="c s7">' + 'Aliansi :' + '</td><td class="c s7">-</td></tr>' +
				 '</table>';
		return info;
	}
	...
	function createMapAreas() {
		var map = dst.cn('map');
		map.name = 'map2';
		map.innerHTML = '<area dir="north" href="#" coords="762,115,30" shape="circle" title="????">' +
				'<area dir="east"  href="#" coords="770,430,30" shape="circle" title="???">' +
				'<area dir="south" href="#" coords="210,430,30" shape="circle" title="????">' +
				'<area dir="west"  href="#" coords="200,115,30" shape="circle" title="???">';
		...
		return function() {
			...
			if (name) {
				var table = '<table cellspacing="1" cellpadding="2" class="tbg f8"><tr><td class="rbg f8" colspan="2"></a>' + name +
					    '</td></tr><tr><td width="45%" class="s7 f8">' + 'Pemain :' +
					    '</td><td class="s7 f8">' + owner +
					    '</td></tr><tr><td class="s7 f8">' + 'Populasi :' +
					    '</td><td class="s7 f8" id="ew">' + pop +
					    '</td></tr><tr><td class="s7 f8">' + 'Aliansi :' +
					    '</td><td class="s7 f8">' + ally +
					    '</td></tr></table>';
				info.innerHTML = table;
			}
			else {
				var table = '<table class="f8 map_infobox_grey" cellspacing="1" cellpadding="2"><tr><td class="c b" colspan="2" align="center"></a>' + 'Rincian :' +
					    '</td></tr><tr><td width="45%" class="c s7">' + 'Pemain :' +
					    '</td><td class="c s7">-</td></tr><tr><td class="c s7">' + 'Populasi :' +
					    '</td><td class="c s7">-</td></tr><tr><td class="c s7">' + 'Aliansi :' +
