// ==UserScript==
// @name           Youtube Video e Mp3 Downloader PT
// @namespace      YouTube
// @description    Baixe videos do Youtube como MP3 sem precisar instalar nenhum programa para isto.
...
var translation = {
	"pt": {
		errormsg: "Erro: YouTube foi atualizado e YouTube Video Download não é mais compatível. ",
		errorlink: "Por favor clique aqui para verificar se há atualizações.",

		button: "Baixar",
		tomp3: "Baixar como .mp3",
		tip: "Salvar video para o disco rigido",
	...
	function getTrans(str)
{
	...
	if (translation[language] && (ret = translation[language][str]))
		return ret;
	else if (ret = translation["pt"][str])
		return ret;
	else
		return "";
}
