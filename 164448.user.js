// ==UserScript==
// @name        GartnerTools
// @namespace   GartnerTools
// @description Borrowed Source from Maelstrom Tools 0.1.3.2 Trying to reformat some display items to suit personal usage.
// @version     0.1.0.0
// @author      Gartner
    ...
    var MaelstromTools_main = function () {
        try {
            ...
            function createMaelstromTools() {
                        ...
                        members: {
                            ...
                            initialize: function () {
                                try {
                                    ...
                                    this.createNewImage("BaseSummaryMenu", "ui/" + factionText + "/icons/icon_repair_all_button.png", fileManager);
                                    ...
                                    this.createNewWindow("BaseSummary", "L", 120, 60, 340, 140);
                                    ...
                                    //Collect Packages Button on Desktop
                                    ...
                                    //Overall Production Button in Main Menu
                                    ...
                                    //Base Resources Button in Main Menu
                                    ...
                                    //Repair All Units Button on Desktop
                                    ...
                                    //Repair all Buildings Button on Desktop
                                    ...
                                    //Army Overview button in Main Menu
                                    var openRepairTimeWindowButton = this.createDesktopButton(Lang.gt("Repair Time Summary"), "RepairTimeMenu", false, this.desktopPosition(desktopPositionModifier));
                                    openRepairTimeWindowButton.addListener("execute", function () {
                                        window.MaelstromTools.RepairTime.getInstance().openWindow("RepairTime", Lang.gt("Repair Time Summary"));
                                    }, this);
                                    
                                    //Base Status Overview in Main Menu
                                    var openBaseStatusOverview = this.createDesktopButton(Lang.gt("Base Support Summary"), "Crosshair", false, this.desktopPosition(desktopPositionModifier));
                                    openBaseStatusOverview.addListener("execute", function () {
                                        window.MaelstromTools.BaseStatus.getInstance().openWindow("BaseStatusOverview", Lang.gt("Base Support Summary"));
                                    }, this);
                                    
                                    //New Row++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++
                                    desktopPositionModifier++;
                                    var openHuffyUpgradeOverview = this.createDesktopButton(Lang.gt("Priority Upgrader"), "UpgradeBuilding", false, this.desktopPosition(desktopPositionModifier));
                                    openHuffyUpgradeOverview.addListener("execute", function () {
                                        window.HuffyTools.UpgradePriorityGUI.getInstance().openWindow("UpgradePriority", Lang.gt("Priority Upgrader"));
                                    }, this);
                                    
                                    //Base Summary button in Main Menu
                                    var openBaseSummaryWindowButton = this.createDesktopButton(Lang.gt("Base Summary"), "BaseSummaryMenu", false, this.desktopPosition(desktopPositionModifier));
                                    openBaseSummaryWindowButton.addListener("execute", function () {
                                        window.MaelstromTools.BaseSummary.getInstance().openWindow("BaseSummary", Lang.gt("Base Summary"));
                                    }, this);
                                    ...
                                    //This is where buttons get added into the main menu if the "use dedicated Main Menu" toggle is selected
                                    if (MT_Preferences.Settings.useDedicatedMainMenu) {
                                    ...
                                    this.addToMainMenu("BaseSummaryMenu", openBaseSummaryWindowButton);
                ...
                // define BaseSummary
                qx.Class.define("MaelstromTools.BaseSummary", {
                    type: "singleton",
                    extend: MaelstromTools.DefaultObject,
                    members: {
                        ...
                        updateCache: function () {
                            try {
                                ...
                                console.log("MaelstromTools.BaseSummary.updateCache: ", e);
                            } 
                        },
                        ...
                        setWidgetLabels: function () {
                            try {
                                ...
                                console.log("MaelstromTools.BaseSummary.setWidgetLabels: ", e);
                            }
                        },
                        ...
                        createOverviewLabels: function (rowIdx) {
                            try {
                                ...
                                MaelstromTools.Util.addLabel(this.Widget, rowIdx, colIdx, "Base", 55, 'center', 'bold');
                                colIdx += 5;
                                MaelstromTools.Util.addLabel(this.Widget, rowIdx, colIdx, "Defense", 55, 'center', 'bold');
                                colIdx += 5;
                                MaelstromTools.Util.addLabel(this.Widget, rowIdx, colIdx, "Army", 55, 'center', 'bold');
                                
                                rowIdx++;
                                colIdx = 1;
                                MaelstromTools.Util.addLabel(this.Widget, rowIdx, colIdx++, "Site", 80, 'left', 'bold');
                                MaelstromTools.Util.addLabel(this.Widget, rowIdx, colIdx++, "Level", 50, 'center');
                                MaelstromTools.Util.addLabel(this.Widget, rowIdx, colIdx++, "Structures", 55, 'center');
                                MaelstromTools.Util.addLabel(this.Widget, rowIdx, colIdx++, "Health", 50, 'center');
                                colIdx++;
                                MaelstromTools.Util.addLabel(this.Widget, rowIdx, colIdx++, "|", 20, 'center', 'bold');
                                MaelstromTools.Util.addLabel(this.Widget, rowIdx, colIdx++, "Level", 50, 'center');
                                MaelstromTools.Util.addLabel(this.Widget, rowIdx, colIdx++, "Units", 55, 'center');
                                MaelstromTools.Util.addLabel(this.Widget, rowIdx, colIdx++, "Health", 50, 'center');
                                colIdx++; 
                                MaelstromTools.Util.addLabel(this.Widget, rowIdx, colIdx++, "|", 20, 'center', 'bold');
                                MaelstromTools.Util.addLabel(this.Widget, rowIdx, colIdx++, "Level", 50, 'center');
                                ...
                                for (var cityName in this.Cache) {
                                    ...
                                    MaelstromTools.Util.addLabel(this.Widget, rowIdx, colIdx++, cityCache.Base.Level, 50, 'center');
                                    MaelstromTools.Util.addLabel(this.Widget, rowIdx, colIdx++, cityCache.Base.TotalHeadCount + " / " + cityCache.Base.UnitLimit, 55, 'center', null, (cityCache.Base.FreeHeadCount >= 1 ? "red" : "white"));
                                    MaelstromTools.Util.addLabel(this.Widget, rowIdx, colIdx++, cityCache.Base.HealthInPercent + "%", 50, 'center', null, (cityCache.Base.HealthInPercent < 25 ? "red" : (cityCache.Base.HealthInPercent < 100 ? "yellow" : "white")));
                                    MaelstromTools.Util.addElement(this.Widget, rowIdx, colIdx++, MaelstromTools.Util.getAccessBaseButton(cityName));
                                    MaelstromTools.Util.addLabel(this.Widget, rowIdx, colIdx++, "|", 20, 'center', 'bold');
                                    
                                    if (cityCache.Defense.UnitLimit > 0) {
                                        MaelstromTools.Util.addLabel(this.Widget, rowIdx, colIdx++, cityCache.Defense.Level, 50, 'center');
                                        MaelstromTools.Util.addLabel(this.Widget, rowIdx, colIdx++, cityCache.Defense.TotalHeadCount + " / " + cityCache.Defense.UnitLimit, 55, 'center', null, (cityCache.Defense.FreeHeadCount >= 5 ? "red" : (cityCache.Defense.FreeHeadCount >= 3 ? "yellow" : "white")));
                                        MaelstromTools.Util.addLabel(this.Widget, rowIdx, colIdx++, cityCache.Defense.HealthInPercent + "%", 50, 'center', null, (cityCache.Defense.HealthInPercent < 25 ? "red" : (cityCache.Defense.HealthInPercent < 100 ? "yellow" : "white")));
                                        MaelstromTools.Util.addElement(this.Widget, rowIdx, colIdx++, MaelstromTools.Util.getAccessBaseButton(cityName, PerforceChangelist >= 376877 ? ClientLib.Data.PlayerAreaViewMode.pavmPlayerDefense : webfrontend.gui.PlayArea.PlayArea.modes.EMode_PlayerDefense));
                                        MaelstromTools.Util.addLabel(this.Widget, rowIdx, colIdx++, "|", 20, 'center', 'bold');
                                    } else {
                                        colIdx += 3;
                                        MaelstromTools.Util.addElement(this.Widget, rowIdx, colIdx++, MaelstromTools.Util.getAccessBaseButton(cityName, PerforceChangelist >= 376877 ? ClientLib.Data.PlayerAreaViewMode.pavmPlayerDefense : webfrontend.gui.PlayArea.PlayArea.modes.EMode_PlayerDefense));
                                    ...
                                    if (cityCache.Offense.UnitLimit > 0) {
                                        MaelstromTools.Util.addLabel(this.Widget, rowIdx, colIdx++, cityCache.Offense.Level, 50, 'center');
                                        MaelstromTools.Util.addLabel(this.Widget, rowIdx, colIdx++, cityCache.Offense.TotalHeadCount + " / " + cityCache.Offense.UnitLimit, 55, 'center', null, (cityCache.Offense.FreeHeadCount >= 10 ? "red" : (cityCache.Offense.FreeHeadCount >= 5 ? "yellow" : "white")));
                                        MaelstromTools.Util.addLabel(this.Widget, rowIdx, colIdx++, cityCache.Offense.HealthInPercent + "%", 50, 'center', null, (cityCache.Offense.HealthInPercent < 25 ? "red" : (cityCache.Offense.HealthInPercent < 100 ? "yellow" : "white")));
                ...
                qx.Class.define("MaelstromTools.RepairTime", {
                    ...
                    members: {
                        ...
                        createRepairchargeLabels: function (rowIdx) {
                            try {
                                var colIdx = 1;
                                //MaelstromTools.Util.addLabel(this.Widget, rowIdx++, colIdx++, "Repair Charges", null, 'left', null, null, 3);
                                //colIdx = 2;
                                
                                MaelstromTools.Util.addLabel(this.Widget, rowIdx, colIdx++, "Site", 80, 'left', 'bold');
                                MaelstromTools.Util.addLabel(this.Widget, rowIdx, colIdx++, MaelstromTools.Statics.Infantry, 60, 'right', 'bold');
                                MaelstromTools.Util.addLabel(this.Widget, rowIdx, colIdx++, MaelstromTools.Statics.Vehicle, 60, 'right', 'bold');
                                MaelstromTools.Util.addLabel(this.Widget, rowIdx, colIdx++, MaelstromTools.Statics.Aircraft, 60, 'right', 'bold');
                                MaelstromTools.Util.addLabel(this.Widget, rowIdx, colIdx++, "Repairtime", 80, 'right', 'bold');
                                MaelstromTools.Util.addLabel(this.Widget, rowIdx, colIdx++, "Attacks", 60, 'right', 'bold');
                                MaelstromTools.Util.addLabel(this.Widget, rowIdx, colIdx++, "Level", 60, 'right', 'bold'); 
                                MaelstromTools.Util.addLabel(this.Widget, rowIdx, colIdx++, "Next at", 80, 'right', 'bold');
                                MaelstromTools.Util.addLabel(this.Widget, rowIdx, colIdx++, "Max+1 at", 80, 'right', 'bold');
                        ...
                        */
                        setWidgetLabels: function () {
                            try {
                                ...
                                //Build Table Headers
                                colIdx += 2;
                                MaelstromTools.Util.addLabel(this.Widget, rowIdx, colIdx, "Tiberium", 60, 'right', 'bold');
                                colIdx += 3;
                                MaelstromTools.Util.addLabel(this.Widget, rowIdx, colIdx, "Crystal", 60, 'right', 'bold');
                                colIdx += 3;
                                MaelstromTools.Util.addLabel(this.Widget, rowIdx, colIdx, "Power", 60, 'right', 'bold');
                                rowIdx++;
                                
                                
                                //Build Table Sub Headers
                                colIdx = 1;
                                MaelstromTools.Util.addLabel(this.Widget, rowIdx, colIdx++, "Base", 100, 'left', 'bold');
                                
                                //Build Sub Headers Tiberium
                                MaelstromTools.Util.addLabel(this.Widget, rowIdx, colIdx++, "Max", 80, 'right');
                                MaelstromTools.Util.addLabel(this.Widget, rowIdx, colIdx++, "Current", 60, 'right');
                                MaelstromTools.Util.addLabel(this.Widget, rowIdx, colIdx++, "Percent", 50, 'right');
                                //Build Sub Headers Crystal
                                MaelstromTools.Util.addLabel(this.Widget, rowIdx, colIdx++, "Max",  80, 'right');
                                MaelstromTools.Util.addLabel(this.Widget, rowIdx, colIdx++, "Current", 60, 'right');
                                MaelstromTools.Util.addLabel(this.Widget, rowIdx, colIdx++, "Percent", 50, 'right');
                                //Build Sub Headers Power
                                MaelstromTools.Util.addLabel(this.Widget, rowIdx, colIdx++, "Max", 80, 'right');
                                MaelstromTools.Util.addLabel(this.Widget, rowIdx, colIdx++, "Current", 60, 'right');
                                MaelstromTools.Util.addLabel(this.Widget, rowIdx, colIdx++, "Percent", 50, 'right');
                                rowIdx++;
                                ...
                                for (var cityName in this.Cache) {
                                    ...
                                    if (cityCache[MaelstromTools.Statics.Tiberium] < cityCache[MaelstromTools.Statics.Tiberium + 'Max']) {
                                        MaelstromTools.Util.addLabel(this.Widget, rowIdx, colIdx++, Math.round(cityCache[MaelstromTools.Statics.Tiberium] / cityCache[MaelstromTools.Statics.Tiberium + 'Max'] * 100) + '%', 50, 'right', null, (cityCache[MaelstromTools.Statics.Tiberium] >= (0.75 * cityCache[MaelstromTools.Statics.Tiberium + 'Max']) ? "yellow" : "white"));
                                    } else {
                                        MaelstromTools.Util.addLabel(this.Widget, rowIdx, colIdx++, Math.round(cityCache[MaelstromTools.Statics.Tiberium] / cityCache[MaelstromTools.Statics.Tiberium + 'Max'] * 100) + '%', 50, 'right', null, "red");
                                    }
                                    ...
                                    if (cityCache[MaelstromTools.Statics.Crystal] < cityCache[MaelstromTools.Statics.Crystal + 'Max']) {
                                        MaelstromTools.Util.addLabel(this.Widget, rowIdx, colIdx++, Math.round(cityCache[MaelstromTools.Statics.Crystal] / cityCache[MaelstromTools.Statics.Crystal + 'Max'] * 100) + '%', 50, 'right', null, (cityCache[MaelstromTools.Statics.Crystal] >= (0.75 * cityCache[MaelstromTools.Statics.Crystal + 'Max']) ? "yellow" : "white"));
                                    } else {
                                        MaelstromTools.Util.addLabel(this.Widget, rowIdx, colIdx++, Math.round(cityCache[MaelstromTools.Statics.Crystal] / cityCache[MaelstromTools.Statics.Crystal + 'Max'] * 100) + '%', 50, 'right', null, "red");
                                    }
                                    ...
                                    if (cityCache[MaelstromTools.Statics.Power] < cityCache[MaelstromTools.Statics.Power + 'Max']) {
                                        MaelstromTools.Util.addLabel(this.Widget, rowIdx, colIdx++, Math.round(cityCache[MaelstromTools.Statics.Power] / cityCache[MaelstromTools.Statics.Power + 'Max'] * 100) + '%', 50, 'right', null, (cityCache[MaelstromTools.Statics.Power] >= (0.75 * cityCache[MaelstromTools.Statics.Power + 'Max']) ? "yellow" : "white"));
                                    } else {
                                        MaelstromTools.Util.addLabel(this.Widget, rowIdx, colIdx++, Math.round(cityCache[MaelstromTools.Statics.Power] / cityCache[MaelstromTools.Statics.Power + 'Max'] * 100) + '%', 50, 'right', null, "red");
                                    }
                                ...
                                MaelstromTools.Util.addLabel(this.Widget, rowIdx, colIdx++, Math.round(Totals[MaelstromTools.Statics.Tiberium] / Totals[MaelstromTools.Statics.Tiberium + 'Max'] * 100) + '%', 50, 'right', 'bold');
                                MaelstromTools.Util.addLabel(this.Widget, rowIdx, colIdx++, MaelstromTools.Wrapper.FormatNumbersCompact(Totals[MaelstromTools.Statics.Tiberium + 'Max']), 80, 'right', 'bold');
                                ...
                                MaelstromTools.Util.addLabel(this.Widget, rowIdx, colIdx++, Math.round(Totals[MaelstromTools.Statics.Crystal] / Totals[MaelstromTools.Statics.Tiberium + 'Max'] * 100) + '%', 50, 'right', 'bold');
                                ...
                                MaelstromTools.Util.addLabel(this.Widget, rowIdx, colIdx++, Math.round(Totals[MaelstromTools.Statics.Power] / Totals[MaelstromTools.Statics.Power + 'Max'] * 100) + '%', 50, 'right', 'bold');
                            } catch (e) {
                                console.log("MaelstromTools.ResourceOverview.setWidgetLabels: ", e);
                            }
                        }
