// ==UserScript==
// @name         [Fr]MegaUpload DownLoad 05/2009
// @namespace    Angelus76
// @version       1.0 
// @description   Telecharger Directement ou avec Proxy.
...
var OptionGlobal = '<option value="#">Liste de Proxy</option>'+
...
for(e=0; e<Listetotal; e++){
	...
	UrlListe = UrlListe+'<option value="'+GM_getValue("Proxy_"+e)+'">Votre Proxy '+a+'</option>';
	a++;
	}
}
...
'</div> <div id="infoflux">'+
'<p> Nom : <span class="info">'+Nom+'</span> | Taille : <span class="info">'+Size+'</span> | Extention : <span class="info">'+Extention+'</span><br>Url a Copier/Coller : <span class="info">'+Origine+'</span></p>'+
'</div> <div id="Config" style="display:none;">'+
'<a href="#" id="AffConfig">Parametre</a>/<a href="#" id="AddProxy">Ajouter Proxy</a> ( <span id="Register">'+GM_getValue("ProxyId")+'</span> )'+
...
'<input type="submit" value="Ajouter" id="AddNewProxy" /></p>'+
'</div> </div> <div id="Iframe"><div style="padding-left:10Px;">'+
'Utilisé un Proxy ? : <select onchange="document.getElementById(\'proxyurl\').src= this.value;">'+
