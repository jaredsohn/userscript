...
minerali = new Array(	
	...
	'Flo++', 'index.php?mod=labor&lab=1&reiter=1&rez=9', 'Ferro:500 + Polenium:400 + Helenium:30 + Lab',	'L',
...
m_p = new Array(
'X',	'javascript:findenemy();',			'Ricerca avversari uguali (10 crediti)','mplus_m','Ric.Nemico', 	'',
'X',	'index.php?mod=hangar&reiter=2',		'Munizioni',			'mplus_m',	'Munizioni', 		'',
'S',	'index.php?mod=shop',				'Mercato',			'mplus_z',	'Mercato', 		'',
'B',	'index.php?mod=market',				'Mercato Nero',			'mplus_m',	'Mercato Nero',		'',
'T',	'index.php?mod=training',			'Allenamento',			'mplus_m',	'Allenamento',		'',
'O',	'index.php?mod=office',				'Ufficio reclutamento(Burocrate)','mplus_m',	'Burocrate',		'',
'J',	'index.php?mod=job',				'Lavoro',			'mplus_m',	'Lavoro',		'',
'P',	'index.php?mod=packages',			'Magazzino',			'mplus_m',	'Magazzino',		'',
'A',	'index.php?mod=auction',			'Asta',				'mplus_m',	'Asta',			'',
'L',	'index.php?mod=laborshop',			'Laboratorio',			'mplus_m',	'Laboratorio',		''
);

// ******* Impostazione collegamenti ally
m_a = new Array(
'W',	'index.php?mod=ally&submod=allyrecht',		'Messaggio Circolare Alleanza',	'mplus_m',	'Msg. Circolare', 	'',
'W',	'index.php?mod=ally&submod=allymembers',	'Membri Alleanza',		'mplus_m',	'Membri', 		'',
'W',	'index.php?mod=ally&submod=allyfights',		'Battaglie d`Alleanza',		'mplus_m',	'Battaglie',		'',
'W',	'index.php?mod=ally&submod=allycastle',		'Amplia il covo dell`Alleanza',	'mplus_m',	'Ampliamento',		''
);
// ******* Impostazione collegamenti Info
m_i = new Array(
'W',	'http://userscripts.org/scripts/search?q=basebogscript',		'clicca per cercare gli aggiornamenti',	'mplus_m',	'Versione '+Versione, 	'color:#884444'
);
...
replacements = {
	   ...
	   "Einsteinio": "Einsteinio (max 612.873)",
...
if (nome_settore!="N.D.") 
{
	...
	// ******* Gestione Menu Ally *******
	menuplus += '<div id="klammer-rechts"><ul><li style="position:relative;z-index:100"><img class="k-rechts" alt="" src="img/mk-rechts-klammer.jpg" /><a href="#" title="clicca per '+titolo_menually+' il Menu Ally" id="menually" style="'+stile_menually+'">Menu Ally</a></li></ul></div>';
	...
	menuplus += '<div id="klammer-links"><ul><li style="position:relative"><img class="k-links" alt="" src="img/mk-links-klammer.jpg" /><a href="#" title="clicca per '+titolo_menuminerali+' i Minerali Speciali" id="menuminerali" style="'+stile_menuminerali+'">Minerali Speciali</a></li></ul></div>';
	...
	// ******* Gestione Menu Info *******
	menuplus += '<div id="klammer-rechts"><ul><li style="position:relative"><img class="k-rechts" alt="" src="img/mk-rechts-klammer.jpg" /><a href="#" title="Informazioni sul tool" id="menuinfo" style="'+stileMenuAttivo+'">Info</a></li></ul></div>';
...
if(url.match('mod=map')) {
	...
	legend += '<p style="'+ft+bgc+pa+'width: 110px; left: 360px; top: 715px;'+zlivello+fnormale+   '">Normale</p>';
	legend += '<p style="'+ft+bgc+pa+'width: 110px; left: 360px; top: 730px;'+zlivello+flab+       '">Laboratorio</p>';
	legend += '<p style="'+ft+bgc+pa+'width: 110px; left: 360px; top: 745px;'+zlivello+fmercato+   '">Mercato</p>';
	legend += '<p style="'+ft+bgc+pa+'width: 110px; left: 360px; top: 760px;'+zlivello+fquartgen+  '">Quartier Generale</p>';
	legend += '<p style="'+ft+bgc+pa+'width: 110px; left: 360px; top: 775px;'+zlivello+fnominerali+'">Minerali Mancanti</p>';	
	...
	minerals += '<span style="'+ft+bgc+pa+'width: 140px; left: 610px; top: 505px;'+zlivello+'"><img src="img/item/6_14k.gif"'+imga+'><span style="'+pr+fminerali+fb+'">Ipolio</span> <span style="'+pr+fnormale+' left: 37px;">240.723</span></span>';

	minerals += '<span style="'+ft+bgc+pa+'width: 140px; left: 610px; top: 520px;'+zlivello+'"><img src="img/item/6_15k.gif"'+imga+'><span style="'+pr+fminerali+fb+'">Einsteinio</span> <span style="'+pr+fnormale+' left: 18px;">612.873</span></span>';


	nominerals =  '<span style="'+ft+bgc+pa+'width: 70px; left: 170px; top: 700px;'+zlivello+'"><img src="img/item/6_1k.gif"'+imga+'><span style="'+pr+fnominerali+'">Ferro</span></span>';
