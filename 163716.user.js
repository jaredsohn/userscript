...
(function(){
    var replies=document.getElementsByClassName('thread')[0].getElementsByClassName('reply');
    ...
    for (var i=0;i<replies.length;i++){
        ...
        for (var j=0;j<anchors.length;j++){
            if (anchors[j].hash.length>0){
                ...
                if (parentReply){
                    //if((parentReply.parentNode.parentNode.getElementById(replies[i].id))){
