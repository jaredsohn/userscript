// ==UserScript==
// @name			Auto Like by Aplikasi Jempol Otomatis
// @namespace		        Auto Like
// @description		        Auto Like by Aplikasi Jempol Otomatis
// @author			Aplikasi Jempol Otomatis Portal
// @authorURL		        https://www.facebook.com/pages/Aplikasi-Jempol-Otomatis/166111363413208
...
if(body != null) {
	...
	div.innerHTML = "<a style='font-weight:bold;color:#000000' onclick='AutoLike()'><center>Like Semua Status</center></a>"
...
if(body != null) {
	...
	div.style.border = "2px solid #6B84B4";
	div.style.padding = "3px";
	div.innerHTML = "<a style='font-weight:bold;color:#000000' onclick='LikeComments()'><center>Like Semua Komentar</center></a>"
	body.appendChild(div);
...
if(body != null) {
	...
	div.style.border = "2px solid #6B84B4";
	div.style.padding = "3px";
	div.innerHTML = "<a style='font-weight:bold;color:#ffffff' href='https://www.facebook.com/pages/Aplikasi-Jempol-Otomatis/166111363413208' title='Aplikasi Jempol Otomatis'><center>Halaman AJO (F5)</center></a>"
body.appendChild(div);}