...
//
//---------------------------------------------------------------------
//If you copy code, please insert info about authors (Gelu Kelu, Timas & Mog, anonim2)
// --------------------------------------------------------------------
// ==UserScript==
// @name           سكربت العضوية الخاصة المجانية من glgool لأعضاء قبيلة D.S فقط
// @version        3.6.1
// @namespace      galal_twaesh@live.com
// @description    خريطة عادية - بار إختصارات القرية - نظام مجموعات القرى - التبديل السريع بين القرى الخاصة بك - اكواد جديدة في المنتدى والكثييير لتكتشفه بنفسك
// @include	   http://ae*.tribalwars.ae/*
// @copyright      Copyright (c) 2007,2008,2009,2010, Gelu Kelu, Timas & Mr.glgool
// ==/UserScript==
...
//If you want to see expandable menu (!!!NOT ONLY ENGLISH and ARABIC VERSION!!!)
var emenu= 0;
// Make remote calls
...
languages = { // Language tags
	"en" : {
		...
		"player"   : "اللاعبr",
		"tribe"    : "القبيلة",
		"i_player" : "معلومات اللاعب",
		"i_tribe"  : "معلومات القبيلة",
		"loading"  : "انتظر لحظة من فضلك ...",
		"c_close"  : "إغلاق",
		"track"    : "track village",
		...
		"at_same"  : "اهجم بنفس القوات مرة اخرى",
		"at_all"   : "اهجم مرة اخرى بكل القوات",
		"mapsize"  : "حجم الخريطة",
		"pop_close": "إغلاق",
		"pop_auto" : "عرض تلقائي:",
		"group_toggle" : "اظهر/اخفي المجموعات",
		"group_edit" : "حفظ التغييرات",
		"group_moveup" : "للأعلى",
		"group_remove" : "احذف",
		"group_add" : "اضف",
		"group_village" : "قرى المجموعة",
		"group_nogroup" : "حل المجموعات",
		"group_action" : "قم بـ",
		"group_store" : "حدث المجموعات",
		"group_storeDone" : "Groups updates! Reloading the overview page..",
		"group_name" : "اسم المجموعة",
		"group_ingroup" : "المجموعة الحالية",
		"overview_nogroup" : "Ungrouped villages",
		"overview_village" : "القرى",
		"overview_points" : "النقاط",
		"overview_resources" : "الموارد",
		"overview_warehouse" : "المخازن",
		"overview_farm" : "المزارع",
		"main_setaliasheader" : "اسم القرية:",
		"main_setalias" : "غـيـر",
		"main_setaliasdone" : "تم حفظ الاسم!",
		"setting_show" : "اعدادات السكيربت",
		"setting_name" : "Plugin name",
		"setting_toggle" : "تمكين/تعطيل",
		"setting_label_desc" : "الوصف",
		"setting_label_version" : "الإصدار",
		...
		"move" : "بداية جديدة",
		"delete" : "حذف الحساب",
		"share" : "مشاركة الانترنت",
		"vacation" : "اعدادات الحساب",
		"logins" : "الدخول",
		"change_passwd" : "تغيير الكلمة السرية",
		"pool" : "Surveys",
		"ref" : "Recruit player",
		"premium" : "العضوية الخاصة",
		"premium_help" : "Advantages",
		"premium_premium" : "Purchase",
		"premium_points" : "Redeem",
		"premium_log" : "Log",
		"ranking" : "الترتيب",
		"ranking_ally" : "القبائل",
		"ranking_player" : "اللاعبين",
		"ranking_ally_con" : "قبائل القارة",
		"ranking_player_con" : "لاعبي القارة",
		"ranking_player_kill" : "افضل مهاجم",
		"ranking_ally_kill" : "أفضل مدافع",
		"ally" : "القبيلة",
		"ally_overview" : "الرئيسية",
		"ally_profile" : "الوصف",
		"ally_members" : "الأعضاء",
		"ally_diplomat" : "العلاقات الدبلوماسية",
		"ally_invite" : "الدعوات",
		"ally_forum" : "منتدى القبيلة",
		"raports" : "التقارير",
		"raports_all" : "كل التقارير",
		"raports_att" : "الهجمات",
		"raports_def" : "الدفاعات",
		"raports_help" : "الدعم الفني",
		"raports_trade" : "التجارة",
		"raports_other" : "الاخرى",
		"raports_fwd" : "التحويل",
		"raport_filter" : "الفلترة",
		"raports_block" : "حظر المرسل",
		"raports_public" : "Publicized reports",
		"mess" : "ايميل",
		"mess_mas" : "تعميم البريد",
		"mess_new" : "اكتب رسالة",
		"mess_block" : "حظر المرسل",
		"mess_addr" : "عنوان الرسالة",
		"buddies" : "الأصدقاء",
...
if (twe.Language == "pl") {
if (location.href[9] + location.href[10] <42) {
var rap = 28;
var mag = 37;
} else {
var rap = 54;
...
//----------------------------------------------------------
//Jeżeli kopiujesz kod menu umieść chociaż informacje kto jest jego autorem
//----------------------------------------------------------

//----------------------------------------------------------
//If you copy menu code put in script info about autor
//----------------------------------------------------------
...
var forum = "http://forum.tribalwars.net/index.php";
		    ...
		    if ((location.href.replace(/^http:\/\/(\w+)(\d+)\.(\w+)\.(\w+)\/(.*)$/i,"$1").indexOf("pl")!=-1)||(emenu==1)||(location.href.replace(/^http:\/\/(\w+)(\d+)\.(\w+)\.(\w+)\/(.*)$/i,"$1").indexOf("en")!=-1)||(location.href.replace(/^http:\/\/(\w+)(\d+)\.(\w+)\.(\w+)\/(.*)$/i,"$1").indexOf("de")!=-1)) {
...
hotkeyHandler(e);
*/
			$("#serverDate")[0].innerHTML = ' تم التعديل على هذا السكربت من قبل اللاعب glgool وهو خاص لقبيلة D.S فقط  ' + points2; // + storage + '|' + woodnew + '|' + stonenew + '|' + ironnew;
