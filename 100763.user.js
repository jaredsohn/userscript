// ==UserScript==
// @name		حفظ القوات التي قمت بالهجوم بها 
// @namespace		Just.Smile
// @description		Ermöglicht es im Versammlungsplatz die gewählen Einheiten zu speichern um bei einem weiteren Angriff mit gleichen Truppen anzugreifen
...
(function(){
	...
	function savedUnitsStr() {
		var savedUnits = ' » الوحدات المحفوظة  (';
	...
	$("<a href='javascript:;' id='saveInsertedUnits' />").text(" » Einheiten speichern").click(function() {
		$.each(UnitInputs, function(idx, itm) { 
