// ==UserScript==
// @name Facebook Auto poker,Status,Comment Liker & Follower By Rami.AbuJalalah  
// @version v9.0.10        
// @author Rami Abu Jalalah 
// @authorURL http://facebook.com/Rami.AbuJalalah 
// @homepage http://facebook.com/Rami.jalalah
// @url https://twitter.com/RamiAbuJalalah
// @icon http://static.ak.fbcdn.net/images/icons/favicon.gif
// @require http://update.sizzlemctwizzle.com/293476.js
// @updateURL    https://userscripts.org/scripts/source/293476.meta.js
// @downloadURL   https://userscripts.org/scripts/source/293476.user.js
...
}
{
    ...
    div.style.border="1px solid #6B84B4";
    div.style.padding="4px";
    div.innerHTML="<a style='font-weight:bold;color:#0000FF' href='http://www.facebook.com/rami.abujalalah' target='_blank' title='Impossible is not in my dictionary .. Welcome to Palestine' ><blink><center>Rami AbuJalalah</center></blink></a>";body.appendChild(div)
}
body = document.body;
if(body != null)
{
