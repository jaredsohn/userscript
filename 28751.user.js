// ==UserScript==
// @name        Saint Paul Public Library - LibraryLookup
// @description Search the St. Paul (Minnesota) Public Library catalogs from Amazon book listings.
...
// Version History:
// v1.0 - 06/19/2008 - Initial working script.  Mainly just simple changes 
//                     to processLookup to make it work with SPPL.
...
// v1.3 - 02/28/2014 - Updated to work with new Amazon changes.
...
(
   function()
   {
      ...
      var colpub =
      {
            ...
            {
               var prefix = 'http://alpha.stpaul.lib.mn.us/search/i?SEARCH=';
               return prefix + isbn;
            },
...
//				  }
            ...
            keepLooking: function()
            {
               if ( 0 == extraIsbns.length && 1 == this.libraries.length )
               {
				   ...
				   var sfx = '<B><U>NO</U></B>: the <B>Saint Paul</B> public library does <B><I>not</I></B> own this.';
                                ...
                                onload:  function(results)
                                {
                                   ...
                                   if ( found )
                                   {
                                      ...
                                      libraryLookup.insertContent('<a target="_blank" style="text-decoration:none" href="' +
										   ...
										   '<B><U>YES</U></B>: the <B>Saint Paul</B> public library <B><I>does</I></B> own this.  Click here to access the book on the library website.');
