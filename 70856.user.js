...
'<div style="padding-bottom:8px;"><span style="float:left; width:40%">التصحيح:</span> <input type="checkbox" name="debug" value="1" id="debug"></div>'+
'<div style="padding-bottom:8px;"><span style="float:left; width:40%">الوقت بين الهجمات:</span> <input type="text" class="text" name="timebetween" value="100" maxlength="4" style="width:30px" id="timebetween"> جزء في الثانية (الإفتراضي)</div>'+
'<div style="padding-bottom:8px;"><span style="float:left; width:40%">عدد الهجمات!:</span> <input type="text" class="text" name="amount" value="1" maxlength="2" style="width:20px" id="amount"> (الإفتراضي)</div>'+
'<input type="button" name="btn_eta" value="إضافة القوات المحددة" id="btn_eta">' +
'<input type="button" name="btn_attack" value="هجوم الآن !" id="btn_attack"></div>' +
...
function btnAddEvent(tbl, data, ind){
	...
	html = '<div id="form_'+ ind +'" ><table id="short_info"><tr><th>الهجوم في :</th><td><input type="text" style="width:80px" class="text" name="date_attack">&nbsp;<input type="text" style="width:50px" class="text" name="time_attack"><input type="hidden" name="input" value="'+data+'">&nbsp;&nbsp;<span id="div_time_attack"></div></td></tr><tr><th></th><td style="font-style:italic;font-size:13px;">&nbsp;&nbsp;dd-mm-yyyy&nbsp;&nbsp;&nbsp;hh:mm:ss</td></tr></table><form class="frmHeader" action="#" method="post">' + tbl + '</form></div><br/>';
...
function post3 (url, data) {
	GM_xmlhttpRequest({
		...
		onload: function(responseDetails) {			
			numberattacks++;
			addCount("<a href='build.php?id=39'>تم إرسال "+numberattacks+" من "+ (form_count) +" هجمات !</a><br/>");  //legg inn delay her					
		}
	});
}
