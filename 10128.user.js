// ==UserScript==
// @name            taz_zusatzressorts_10
// @namespace       Platypus
// @include         http://www.taz.de/index.php?id=dossiers
...
do_modify_html_it(window.document,document.getElementById('content_gesamt'),/dossiers([^>]+)>/,'dossiers$1 class="main_navi_element_aktiv">',null);
html_insert_it(window.document,document.getElementById('datum_plugin_rechts'),'<iframe src="http://www.feedity.com/?ADVRWINQ9G%252bcjpSJWh9WiA08K%252fiC%252fyQdCgmIzjUaXS9h8A%253dhttp://www.taz.de/index.php?id=grosse-fragen%40%40%40CAT%40%40%4017#feed-greasemonkey" width="500" height="600"></iframe>',false,true);
