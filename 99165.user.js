var meta = <><![CDATA[
// ==UserScript==
// @name 		Travian3 Beyond GotGs FX
// @author		Black_Cat. Original ms99 (Nux, Lux, onetmt, Velonis Petros, Richard Laffers, Szabka, Victor Garcia-aka Croc-) (minor fixes by Gotgs)
// @namespace 	T3
// @version 	3.8.8.9.7.3.12
// @description	Travian3 Beyond GotGs Fx - minor fixes to make it work with *Travian AutoTask GotGs FX*. 
// @source 		http://userscripts.org/scripts/show/99165
// @identifier 	http://userscripts.org/scripts/show/99165.user.js
...
* Upgrade Record:
*
* 11 March 2011 -- Minor fixes by Gotgs
*	(-) changed side_info width for rtl languages
*	(-) corrected footer relative position
*	(-) corrected bar position for rtl languages
*	(-) corrected profile/alliance link additions
*	(-) corrected troops training calculation
*
* 19 March 2011 -- now using meta.js when checking for new version
*
* 30 March 2011 (ver 3.8.8.9.7.3.10) -- disabled script on travian versions other than 3.6
*
* 30 March 2011 (ver 3.8.8.9.7.3.11) -- change default attack type on a2b.php only if it has not been explicitly set by c parameter in url
*
* 31 March 2011 (ver 3.8.8.9.7.3.12) -- reports/messages location is now remembered
*
*****************************************************************************/

function functionMain(e) {
	//GM_log ( "functionMain():: Starting!" );
	function checkVersion() {
		var tag = document.evaluate('.//div[@id="side_navi"]//a[contains(@href,"spieler.php")]', document, null, XPathResult.FIRST_ORDERED_NODE_TYPE, null).singleNodeValue;
		if ( tag != null ) {
			return "3.6";
		}
		return undefined;
	...
	//setup defaults values for the keys in TB3O.oldOpt
	TB3O.OD = [ // length is 92 ( 0 - 91 )
	...
	'3', '0', '0', '1', '1', '0', '1', '1', '0', '0', // 50 - 59
	'1', '1', '0', '1', '0', '',  '',  '',  '',  '0', // 60 - 69
	'1', '1', '1', '1', '1', ddX + '|150', ddX + '|170', ddX + '|210', ddX + '|190', ddX + '|220', // 70 - 79
	'1', '1', '1', '1', '1', '1', '1', '0', ddX + '|500', ddX + '|500', // 80 - 89
	ddX + '|500', ddX + '|90']; // 90 - 91
	...
	'serverversion2','removeadbanner','forcet31tcap','showbigiconmarket','showbigiconmilitary','showbigiconmilitary2','showbigiconmisc','alliance','showmenusection3','warsim',//1-10
	'repsite','showinouticons','showcentermapicon','showsendtroopsresources','showpphinvl','showccinvl','showpopinvl','showvl2table','showbipattinvl','showbookmarks',//11-20
	'floatbookmarks','noteblock','floatnoteblock','nbsize','nbheight','npcassistant','wsanalyser','showstatlinks','mapanalyser','showtravmapuserlinks',//21-30
	'showtravmapallylinks','showsearchbar','floatsearchbar','showcpinupgtables','showccinupgtables','showuntilthenresidue','showresupgradetable','showcolorreslevels','showresbartable','floatresbartable',//31-40
	'showbupgtable','showsortedbiupgt','showcenternumbers','showcolorbuildlevels','showbblink','showaddinfomarr','47','marketpreload','rpdefact','noofscouts',//41-50
	'51','52','showtroopinfotooltips','showrprinfotooltips','55','showcelltypeinfo','showdisttimes','showmaptable','mesreppreload','showmesopenlinks',//51-60
	'showrepdeltable','showigmlinkforme','showtb3battlereport','showbrstatdetails','cncolorneutral','cncolormaxlevel','cncolornoupgrade','cncolornpcupgrade','consoleloglevel','showresbartable_state',//61-70
	'showbookmarks_state','noteblock_state','showvl2table_state','showsearchbar_state','resbarXY','userBookmarksXY','noteblockXY','vList2XY','searchbarXY',	'80',//71-80
	'81','lockbookmarks','83', '84', '85', '86', '87', '88', '89', '90', //81-90
	'91']; // 91-91
	...
	" div#footer{position:relative;bottom:0px;}" +
...
//3.8.8.9.7.3
t['FINDREP'] = "ค้นหารายงานสุดท้ายของ";
t['IREPORT1'] = "โจมตีชนะโดยไม่สูญเสีย";
t['IREPORT2'] = "โจมตีชนะแต่มีการสูญเสีย";
t['IREPORT3'] = "โจมตีแพ้";
t['IREPORT4'] = "ป้องกันชนะโดยไม่สูญเสีย";
t['IREPORT5'] = "ป้องกันชนะแต่มีการสูญเสีย";
t['IREPORT6'] = "ป้องกันแพ้และมีการสูญเสีย";
break;
};
};
...
"vmkls":		imPNG + ''
	...
	function updScript() {
		...
		GM_xmlhttpRequest({
			method: 'GET',
			url: TB3O.metaUrl, //don't increase the 'installed' count; just checking
			onload: function(result) {
				...
				if (nv == TB3O.version) {
					...
					return;
				} else if (window.confirm(T('NVERAV') + ' (v ' + nv + ')!\n\n' + T('UPDSCR') + '\n'))  window.open (TB3O.usoL+'show/'+TB3O.usoNo,"mywindowx"); //window.location.href = TB3O.url;
			}});
	};
	...
	function log(level, msg) {if (console != undefined && level <= Number(TB3O.O[69])) console.log(msg);};//Custom log function (log level, message to log)
	...
	function getGeneralData() {
		//GM_log ( "getGeneralData():: Starting!" );
		//pre-logging
		TB3O.O[69] = "10";
		...
		if (!aTB3S || !aTB3S['SETUP']) {
			//GM_log ( "getGeneralData():: Initializing from TB3O.oldOpt !" );
			...
			//GM_log ( "getGeneralData():: Initializing from GM Values !" );
			TB3O.O = aTB3S['SETUP'];
		}
		
		//GM_log ( "getGeneralData():: TB3O.O.length: " + TB3O.O.length + ", TB3O.oldOpt.length: " + TB3O.oldOpt.length );
		//GM_log ( "getGeneralData():: TB3O.O[91]: " + TB3O.O[91] );
		if (TB3O.O.length != TB3O.oldOpt.length) {
			//GM_log ( "getGeneralData():: Adding additional values !" );
	...
	function showBigIconsBar(){
		...
		if (docDir[0] == 'left') biBar.style.left =  "300px"; else biBar.style.right = '300px'; // fix display Black_Cat
	...
	function addMrInPopup(aNode) {
		if (aNode.parentNode && aNode.parentNode.innerHTML.indexOf(imP) == -1) {
			var aBt = $a("&nbsp;&nbsp;", [['href', jsVoid], ['style', 'line-height: inherit; height: inherit; position:relative; float:' + docDir[1]]]);
			...
			return function() {
				ajaxRequest(aNode.href, 'GET', null, function(ajaxResp) {
					...
					if (aV) {
						...
						if (!tt) {
							var dW = 480;
							if (aV.className == "reports")
								dW = 550;
							/*var iLeft = 680;
							if (docDir[0] == 'right')
								iLeft = 400;*/
							//tt = $df(dW, iLeft, 90, '', '', "mr_tooltip", false);
							var dxy = TB3O.O[91].split("|");
							tt = $df(dW, dxy[0], dxy[1], '', '', "mr_tooltip", false);
						};
	...
	function playerLinks(idNode){
		...
		for(var i = 0; i < aL.length; i++) {
			//a player link
			if (aL[i].href.search(/spieler.php\?uid=(\d+)\b/) > 0) {
				var a = RegExp.$1;
				if (a == 0) continue;
			...
			//an alliance link
			} else if (aL[i].href.search(/allianz.php\?aid=(\d+)\b/) > 0){
				var a = RegExp.$1;
				if (a == 0) continue;
	...
	function defaultAttackType(){
		if ( crtPage.match(/\bc=/) == null ) { // do only if current page url does not have c parameter
	...
	function mouseUp(ev){
		if (dragObject) {
			...
			switch (dragObject.id) {
				...
				case "mr_tooltip": TB3O.O[91] = strXY; break;
			};
			setGMcookieV2('TB3Setup', TB3O.O, 'SETUP');
		};
		dragObject = null;
	...
	function showTBTotalRuntime(){
		...
		if (aD) {
			...
			var tu = $a(TB3O.version, [['href', jsVoid], ['title', T('CHKSCRV')], ['style', 'font-size:8pt; font-weight:bold; color:#0000FF']]);
			...
			$at(tt, [['style', 'z-index:2000; color:#444444; width:450px']]);
