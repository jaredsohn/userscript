...
var RANKS = ['vojak', 'desetnik', 'narednik', 'poročnik', 'kapitan', 'polkovnik', 'general', 'načelnik'];
var INDUSTRIES = ['', 'Hrana', 'Darila', 'Orožje', 'Letalske karte'];
var SKILLS = ['vse', 'industrija', 'poljedelstvo', 'gradbeništvo'];
var TOOLS = ['Badges', 'RSS Feed', 'ThirdParty', 'Forumi', 'eRepPlusSettings'];
...
function UpdateLinks() {
	var updateData = [
		{c: 'eR_RM', el: '#menu3 li:eq(0) a', 					p: /^tržnica/},
		{c: 'eR_MM', el: '#menu3 li:eq(1) a', 					p: /^exchange/},
		{c: 'eR_JM', el: '#menu3 li:eq(2) a', 					p: /^človek/},
		{c: 'eR_CM', el: '#menu3 li:eq(3) a', 					p: /^podjetja/},
		{c: 'eR_Ra', el: '#menu4 li:eq(0) a', 					p: /^ranking/},
		{c: 'eR_Co', el: '#menu4 li:eq(1) a', 					p: /^država\/(?!ekonomija|politika|vojska)/},
		{c: 'eR_Ce', el: '#menu4 li:eq(2) a', 					p: /^država\/ekon/},
		{c: 'eR_Cp', el: '#menu4 li:eq(3) a', 					p: /^država\/poli/},
		{c: 'eR_Cm', el: '#menu4 li:eq(4) a', 					p: /^država\/vojs/},
		{c: 'eR_El', el: '#menu5 li a:contains("Volitve")', 	p: /^election/},
		{c: 'eR_To', el: '#menu5 li a:contains("Tools")', 		p: /^badges/},
		{c: 'eR_To', el: '#menu5 li a:contains("Tools")', 		p: /^rss_menu/},
		{c: 'eR_Ne', el: '#menu5 li a:contains("News")', 		p: /^novice\//}
	];
...
function Main(e) {
	...
	var pagesFunctions = [
		...
		{p: 'Zaposleni/',	s:9, 	f: EmployeeMessageAndGifts},
		{p: 'Napiši članek', 		s:4, 	f: AddArticleButtons},
		{p: 'Uredi članek/',		s:4, 	f: AddArticleButtons},
		{p: 'forum',				s:4, 	f: AddArticleButtons},
		{p: 'Tržica/', 				s:8, 	f: calculateUnitPrice},
		{p: 'badges',				s:-1, 	f: ModifyTools},
		{p: 'rss_menu', 			s:-1, 	f: ModifyTools},
		{p: 'Članek/',				s:0, 	f: addAllCommentsAndTranslate},
		{p: 'Časopis/',			s:0, 	f: addAllCommentsAndTranslate},
		{p: 'igralec/profil/',		s:3, 	f: CalcTomorrowWellness},
		{p: 'država',				s:11, 	f: addInteractiveMap},
		{p: 'vojne/prikaži/',		s:16,	f: addBattleStats}
	];
