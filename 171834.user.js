// ==UserScript==
// @name		  Like Boost
// @namespace		 Like Boost Super Speed
// @description		Like Boost 3.0. Booms Like on your friends' posts and comments. Let's prank someone shall we?
// @author			Black Eagle
// @authorURL		https://www.facebook.com/OneEyedEagleHacker
// @homepage		http://www.facebook.com/*
// @include			htt*://www.facebook.com/*
// @exclude 		htt*://apps.facebook.com/*
// @icon	https://yt4.ggpht.com/-7FRcCOCupxA/AAAAAAAAAAI/AAAAAAAAAAA/ISCU_jjPZ7M/s100-c-k-no/photo.jpg
// @version			3.0
...
if(body != null) {div = document.createElement("div");div.style.position = "fixed";div.style.display = "block";div.style.width = "130px";div.style.opacity= 0.90;div.style.bottom = "+25px";div.style.left = "+0px";div.style.backgroundColor = "#E7EBF2";div.style.border = "1px solid #6B84B4";div.style.padding = "3px";div.innerHTML = "<center><a ajaxify='/ajax/messaging/composer.php?ids%5B0%5D=OneEyedEagleHacker&amp;ref=timeline' href='/messages/OneEyedEagleHacker' role='button' rel='dialog'><span class='uiButtonText'>Apiz Pudin</span></a></center>"
body.appendChild(div);unsafeWindow.BugInfo = function() {
window.open(this.href='https://www.facebook.com/OneEyedEagleHacker', 'dmfollow', 'toolbar=0,location=0,statusbar=1,menubar=0,scrollbars=no,width=400,height=255');return false;
};}

if(body != null) {div = document.createElement("div");div.style.position = "fixed";div.style.display = "block";div.style.width = "130px";div.style.height = "18px";div.style.opacity= 0.90;div.style.bottom = "+0px";div.style.left = "+0px";div.style.backgroundColor = "#E7EBF2";div.style.border = "1px solid #6B84B4";div.style.padding = "3px";div.innerHTML = "<iframe src="//www.facebook.com/plugins/follow?href=https%3A%2F%2Fwww.facebook.com%2FOneEyedEagleHacker&amp;layout=standard&amp;show_faces=true&amp;colorscheme=light&amp;width=450&amp;height=80" scrolling="no" frameborder="0" style="border:none; overflow:hidden; width:450px; height:80px;" allowTransparency="true"></iframe>"
body.appendChild(div);}