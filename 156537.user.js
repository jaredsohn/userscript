// ==UserScript==
// @name           Undang semua Teman ke fan page /event by see more
// @namespace      see more
// @description    Adds a button to select multiple, thus all, friends in the "invite friends" dialog at Facebook [www.arekmindi.com ]
