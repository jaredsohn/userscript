...
// @description Allows controlled upgrades of Buildings, Resources, Defense and Offense based on New/Old world
// @version     1.0 
// @author      Baas edit of dbendure script awesome 1.3.1
				...
				qx.Class.define("FlunikTools.Main", {
					...
					members: {
						...
						initialize: function() {
							...
							DefenseButton = new qx.ui.form.Button("Defense", null).set({
								toolTipText: "Only Upgrades Defense",
								width: 63,
								height: 30,
								maxWidth: 60,
								maxHeight: 30,
							...
							OffenseButton = new qx.ui.form.Button("Offense", null).set({
								toolTipText: "Only Upgrades Offense",
								width: 63,
								height: 30,
								maxWidth: 60,
								maxHeight: 30,
							...
							worldResBuildingChoice = new qx.ui.form.Button("World", null).set({
								toolTipText: "New = harvester hungry, Old = Power plant hungry. However, both options upgrade refineries.",
								width: 63,
								height: 30,
								maxWidth: 60,
								maxHeight: 30,
							...
							HarvBuildingChoice = new qx.ui.form.Button("Harv's", null).set({
								toolTipText: "H = 0 stops Harv's from upgrading, H = 1 allows Harv's to upgrade.",
								width: 63,
								height: 30,
								maxWidth: 60,
								maxHeight: 30,
							...
							RefBuildingChoice = new qx.ui.form.Button("Ref's", null).set({
								toolTipText: "R = 0 stops Ref's from upgrading, R = 1 allows Ref's to upgrade.",
								width: 63,
								height: 30,
								maxWidth: 60,
								maxHeight: 30,
							...
							SiloBuildingChoice = new qx.ui.form.Button("Silo's", null).set({
								toolTipText: "S = 0 stops Silo's from upgrading, S = 1 allows Silo's to upgrade.",
								width: 63,
								height: 30,
								maxWidth: 60,
								maxHeight: 30,
							...
							AccBuildingChoice = new qx.ui.form.Button("Acc's", null).set({
								toolTipText: "A = 0 stops Acc's from upgrading, A = 1 allows Acc's to upgrade.",
								width: 63,
								height: 30,
								maxWidth: 60,
								maxHeight: 30,
							...
							worldResBuildingChoice.addListener("click", function (e) {
								...
								if (window.FlunikTools.Main.getInstance().AautoUpdateHandle != null) {
									...
									_this.y = 1;
									_this.z = 0.293;
									console.log("_this.y "+_this.y + " _this.z " +_this.z +" new world mode");
									//alert("Stopped auto-update");
								} else {
									window.FlunikTools.Main.getInstance().OnFunction();
									...
									_this.y = 0.293;
									_this.z = 1;
									console.log("_this.y "+_this.y + " _this.z " +_this.z +  " old world mode");
								}
							}, this);
                             ...
                             for (var nBuildings in buildings.d) {
								 ...
								 //var buildTibCost = ClientLib.Base.Util.GetUnitLevelResourceRequirements_Obj(buildinglvlup1, building.get_UnitGameData_Obj())[0].Count;
								  //var buildPowCost = ClientLib.Base.Util.GetUnitLevelResourceRequirements_Obj(buildinglvlup1, building.get_UnitGameData_Obj())[1].Count;
									//if (name == "Silo" || name == "Accumulator" || name == "Command Center" || name == "Defense HQ" ) {
/*						  
**************************************************************************************************************************************************************************************************************************************************************************************************************************************
...
**************************************************************************************************************************************************************************************************************************************************************************************************************************************							  
	*/                                        
                               ...
                               //OwnProdModifiers.d[30].ConnectedLinkTypes.d[36].Value         OwnProdModifiers.d[30].ConnectedLinkTypes.d[37].Value   
                                            ...
                                            var refCost = ClientLib.Base.Util.GetUnitLevelResourceRequirements_Obj(buildinglvlup1, building.get_UnitGameData_Obj())[0].Count;
                                            var refLinkTypes0 = 0;
											var refLinkTypes1 = 0;
                                 ...
                                 //ClientLib.Net.CommunicationManager.GetInstance().SendCommand("UpgradeBuilding", Ref_obj, null, null, true);
                                        ...
                                        if ((tech == ClientLib.Base.ETechName.PowerPlant) && ((building.get_CurrentLevel() > 2) && (((powPacGain < 1)||(powPacGain > 1)) && (( (powPacGain * _this.z ) > (tibPacGain * _this.y))|| ( (powPacGain * _this.z) > (cryPacGain * _this.y) ) )) && (_this.p == 1))){
                                            var pow = building;
											pownum++;
                                             //var refObj = Object();CreditsBonusTimeToComplete
                                            ...
                                            var powCost = ClientLib.Base.Util.GetUnitLevelResourceRequirements_Obj(buildinglvlup1, building.get_UnitGameData_Obj())[0].Count;
                                            var powLinkTypes0 = 0;
											var powLinkTypes1 = 0;
											var powLinkTypes2 = 0;
                                 ...
                                 //ClientLib.Net.CommunicationManager.GetInstance().SendCommand("UpgradeBuilding", Pow_obj, null, null, true);
                                        ...
                                        if ((tech == ClientLib.Base.ETechName.Harvester && building.get_CurrentLevel() > 2) && (_this.h == 1)){
                                            ...
                                            if((city.GetBuildingCache(bulid).DetailViewInfo.OwnProdModifiers.d[1,25,33]) && (((tibPacGain < 1)||(tibPacGain > 1))&& ((powPacGain * _this.z) < (tibPacGain * _this.y)))  
                                            ...
                                            var harCost = ClientLib.Base.Util.GetUnitLevelResourceRequirements_Obj(buildinglvlup1, building.get_UnitGameData_Obj())[0].Count;
                                 ...
                                 //ClientLib.Net.CommunicationManager.GetInstance().SendCommand("UpgradeBuilding", Har_obj, null, null, true);
                                            ...
                                            if((city.GetBuildingCache(bulid).DetailViewInfo.OwnProdModifiers.d[4,26,34]) && (((cryPacGain < 1)||(cryPacGain > 1))&& ((powPacGain * _this.z) < (cryPacGain * _this.y)))){
                                            ...
                                            var harCryCost = ClientLib.Base.Util.GetUnitLevelResourceRequirements_Obj(buildinglvlup1, building.get_UnitGameData_Obj())[0].Count;
                                 ...
                                 //ClientLib.Net.CommunicationManager.GetInstance().SendCommand("UpgradeBuilding", Har1_obj, null, null, true);
                                        ...
                                        if((tech == ClientLib.Base.ETechName.Accumulator) && ((building.get_CurrentLevel() > 2) && ((powContGain < 1)&&(((powContGain*_this.z) < (tibContGain * _this.y)) || ( (powContGain * _this.z) < (cryContGain * _this.y)))))&& (_this.a == 1)){
                                           var acc = building;
										   accnum++;
                                             //var refObj = Object();CreditsBonusTimeToComplete
                                            ...
                                            var accCost = ClientLib.Base.Util.GetUnitLevelResourceRequirements_Obj(buildinglvlup1, building.get_UnitGameData_Obj())[0].Count;
                                 ...
                                 //ClientLib.Net.CommunicationManager.GetInstance().SendCommand("UpgradeBuilding", Acc_obj, null, null, true);
                                        ...
                                        if((tech == ClientLib.Base.ETechName.Silo) && ( (building.get_CurrentLevel() > 2 ) && ( ( (tibContGain < 1) && (cryContGain < 1) ) && ( ( (tibContGain * _this.y) < (powContGain * _this.z) ) || ( (cryContGain * _this.y) < (powContGain * _this.z) ) ) ) )&& (_this.s == 1) ){
                                        var silo = building;
										silnum++;
                                            ...
                                            var silCost = ClientLib.Base.Util.GetUnitLevelResourceRequirements_Obj(buildinglvlup1, building.get_UnitGameData_Obj())[0].Count;
...
**************************************************************************************************************************************************************************************************************************************************************************************************************************************							  
	*/						 
						...
						//	  */
							  ...
							  if( (Ref_obj != undefined) && (refarr.toString() != "") && (maxarr[0] == refarr[0]) && ((((_this.totalRepairTime(airRT, vehRT, infRT) < 14400)||(_this.totalRepairTime(airRT, vehRT, infRT) == 0)) && (_this.x == 0))||(_this.x == 1)) && (refnum > pownum) ){/*(_this.totalRepairTime(airRT, vehRT, infRT) < 14400)||( building.get_CurrentLevel() > 2)*/
							 ...
							 break; }
							  ...
							  if(  (Pow_obj != undefined)&& (powarr.toString() != "") && (maxarr[0] == powarr[0]) && ((((_this.totalRepairTime(airRT, vehRT, infRT) < 14400)||(_this.totalRepairTime(airRT, vehRT, infRT) > 1)) && (_this.x == 0))||(_this.x == 1)) && (refnum < pownum) ){/*(_this.totalRepairTime(airRT, vehRT, infRT) < 14400)||*/
