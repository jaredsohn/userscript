// ==UserScript==
// @name           4chan instant page loader (3 pages)
// @namespace      haluk
// @description    load first 3 pages
...
(function () {
    ...
    var bod = document.body,
        currPg = document.forms[1],
        pgFt = singleNode("//form/hr/following-sibling::center"),
        pgLnks = multiNode("//b/following-sibling::a[position()<=" + loadCount + "]"),
        init = function (e) { currPg.insertBefore(loadContent(e), pgFt); },
    ...
    pgLnks = null;
    len = null;
    (Boolean(window.chrome)) ? htmlList.forEach(initChrome) : htmlList.forEach(init);
    htmlList = null;
    throbber = bod.lastChild;
    bod.removeChild(throbber);
