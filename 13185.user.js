...
var customArtemisLink1Name = 'Maxisoft';
var customArtemisLink1URL = 'http://pardus.maxisoft.org/';
...
var customOrionLink1Name = 'Maxisoft';
var customOrionLink1URL = 'http://pardus.maxisoft.org/';
...
var customPegasusLink1Name = 'Maxisoft';
var customPegasusLink1URL = 'http://pardus.maxisoft.org/';
...
function getUniverseName()
{
  ...
  return msgframe.getElementsByTagName('img')[0].getAttribute('src').replace('http://static.pardus.at/various/universes/', '').replace('_16x16.png', '').replace(/^\s+|\s+$/g, '');
}
...
if(location.pathname.search(/main.php/i) != -1)
{
  ...
  {
	var span = document.getElementById('sector');
	span.innerHTML = '<a href="http://pardus.butterfat.net/pardusmapper/maps/' + getUniverseName() + '/' + getSectorName().replace(/\s/g, '') + '.html?universe=' + getUniverseName() + '&sector=' + getSectorName().replace(/\s/g, '') + '" target="_blank">' + span.innerHTML + '</a>';
  }
