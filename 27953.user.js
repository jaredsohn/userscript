// ==UserScript==
// @name           IkariamFriendlist(fuera de la ventana)
// @version        0.5
...
// The actual styles
addGlobalStyle(
'#flBox { height: 29px; width: 29px; position: absolute; margin:-10px 29px -18px 987px; z-index:31; }' + 
...
unsafeWindow.flToggleFrame = function(nr){
	...
	if(nr == 1){
		...
		document.getElementById("flBox").style.margin = '-10px 29px -18px 987px';
	}
	else{
