 ...
 ********************************************************************************/
// Script information
var Version = '20111027a_BETA'; // Year, Month, Day, Revision, Maturity (e.g. YYYMMDDa_BETA)
...
var kSecondValue = ' and 3600<BR>Second value must be at least 1 above the first value.';
...
var OptionsDefaults = {
  ...
  objAttack     : {enabled:false, repeatTime:3660, delayMin:1, delayMax:2, levelEnable:[], levelDist:[null,10,10,10,10,10,10,10,10,10,10], deleteObjAttacks:false, stopAttackOnLoss:false, logAttacks:true, maxMarches:10, troops:[], clearAllTargets:false},
  currentTab    : false,
  attackTab     : 0,
  mapTab        : 0,
  jobsTab       : 0,
...
//*** Attacks Tab - Stats Sub-tab ***
  ...
  // Data.options.objAttack {enabled:false, maxDist:7, repeatTime:3660, delayMin:1, delayMax:2, levelEnable:[]}
