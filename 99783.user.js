// ==UserScript==
// @name           KOC TorcyPower Tools
// @namespace      o.O'
// @include        http://*.kingdomsofcamelot.com/*main_src.php*
// @description    o.O'!!!
// ==/UserScript==

var Version = 'TorcyPower';
...
var URL_CASTLE_BUT = 'http://i51.tinypic.com/316wvgy.png';
var URL_CASTLE_BUT_SEL = 'http://i51.tinypic.com/14l0mio.png';
//var URL_PROVINCE_MAP = 'http://i51.tinypic.com/24c7ewg.jpg';
//var provMapCoords = {imgWidth:711, imgHeight:711, mapWidth:595, mapHeight:595, leftMargin:44, topMargin:39};  
var URL_PROVINCE_MAP = 'http://i51.tinypic.com/24c7ewg.jpg';
var provMapCoords = {imgWidth:711, imgHeight:711, mapWidth:671, mapHeight:671, leftMargin:31, topMargin:19};  
...
//logit ('g_timeoff: '+ unsafeWindow.g_timeoff);
  ...
  var styles = '.xtab {padding-right: 5px; border:none; background:none; white-space:nowrap;}\
    ...
    .ptChatWhisper {}\
    .ptChatAlliance {background-color: #c0c0c0}\
    .ptChatGlobal {background-color: #90EE90}\
    ...
    table.ptMainTab {empty-cells:show; margin-top:10px }\
    ...
    input.ptButCancel {background-color:#e00; font-weight:bold; color:#fff}\
...
//logit ( 'Options.ptWinPos: '+ inspect (Options.ptWinPos, 5, 1)); 
  ...
  AddMainTabLink('Angeli&Demoni', eventHideShow, mouseMainTab);
TestSomething.init ();  
...
Tabs.board = {
  ...
  tabLabel : 'Mappa',            // label to show in main window tabs
  myDiv : null,
  timer : null,
  forumlink :  'http://koc.dunno.com/index.sjs?f=KocMapViewer&server_id=167',  
...
Tabs.Wikia = {
  ...
  myDiv : null,
  timer : null,
  forumlink :  'http://it.kingodoms-of-camelot-ita.wikia.com/wiki/Kingdoms_of_Camelot_su_Facebook_in_Italiano_Wiki',  
  ...
  show : function (){         // called whenever this tab is shown
    var t = Tabs.Wikia;
    mainPop.div.style.width = 800 + 'px';
  },
}
...
Tabs.Addestramento = {
  tabOrder : 30,                    // order to place tab in top bar
  tabLabel : 'Addestramento',            // label to show in main window tabs
  myDiv : null,
  timer : null,
  forumlink :  'http://ilpadrinokoc.altervista.org/troop.html',  
  
  init : function (div){    // called once, upon script startup
    var t = Tabs.Addestramento;
    t.myDiv = div;
    div.innerHTML = '<CENTER><iframe src="'+ t.forumlink +'" width="100%" height="550" name="board_in_a_box" <p>Ihr Browser kann leider keine eingebetteten Frames anzeigen: Sie k&ouml;nnen die eingebettete Seite &uuml;ber den folgenden Verweis aufrufen: <a href="'+ t.forumlink +'">Truppen Spostamenti</a></p> </iframe> <BR></center>';
  },
...
Tabs.Spostamenti = {
  tabOrder : 30,                    // order to place tab in top bar
  tabLabel : 'Spostamenti',            // label to show in main window tabs
  myDiv : null,
  timer : null,
  forumlink :  'http://ilpadrinokoc.altervista.org/mt.html',  
  
  init : function (div){    // called once, upon script startup
    var t = Tabs.Spostamenti;
    t.myDiv = div;
    div.innerHTML = '<CENTER><iframe src="'+ t.forumlink +'" width="100%" height="550" name="board_in_a_box" <p>Ihr Browser kann leider keine eingebetteten Frames anzeigen: Sie k&ouml;nnen die eingebettete Seite &uuml;ber den folgenden Verweis aufrufen: <a href="'+ t.forumlink +'">Truppen Spostamenti</a></p> </iframe> <BR></center>';
  },
      ...
      for(i=0; i < Cities.numCities; i++) {
        ...
        row[i] = rp[1] - usage;
          ...
          if (timeLeft<0){
                ...
                msg += 'La mia città ' + Cities.cities[i].name.substring(0,10) + ' (' +
                       Cities.cities[i].x +','+ Cities.cities[i].y + ')';
                msg += ' ha poco cibo. Resto del cibo: '+addCommasWhole(foodleft)+' ('+timestrShort(timeLeft)+') Manutenzione: '+addCommas(usage);
                sendChat ("/a " + msg);
          }
      }  
...
//DebugTimer.start(); 
    try {
      ...
      str += "<TABLE class="+ tabClass +" cellpadding=0 cellspacing=0><TR valign=top align=right><TD width=65></td><TD width=88 style='background: #E0EEE0'><B>TOTAL</b></td>";
      for(i=0; i<Cities.numCities; i++) {
