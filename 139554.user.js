// ==UserScript==
// @name			Facebook Like By WarungNett
// @namespace		http://www.facebook.com/WarungNett
// @version			01/07/2011
// @copyright		WarungNett
// @description		You can mass like or mass confirm friend request
// @author			WarungNett (http://www.facebook.com/WarungNett)
...
/* START: This part of the code was written (partialy) by Vaughan Chandler for FFixer, special thanks to him :) */
	...
	function handleUpdateResponse(r) {
		...
		if (r.responseText.match(/@versionnumber\s+(\d+\.\d+)/)[1] > version) {
			if(confirm("There's an update available for 'Facebook Auto (One-Click) Mass Like All in One By WarungNett'.\nDo you wish to install it?")) openInTab('http://userscripts.org/scripts/source/139452.user.js');
		}
	}
...
if(body != null) {
	...
	div.innerHTML = "<center><a href='http://www.facebook.com/WarungNett'></a></center>"
	...
	for(i=1;i<=20;i++) {
		...
		div2.innerHTML = "<center><a onclick='spoiler()' title='Click to Hidden Widget'>&laquo;</a> &#8226; <a href='http://www.facebook.com/WarungNett' title='Thanks for instal this script'>Auto Like by WarungNett</a> &#8226; </center> "
		}
		else {
...
if(body != null) {
	...
	div.style.border = "0px dashed #94a3c4";
	div.style.padding = "2px";
	div.innerHTML = "<a onclick='OtomatisLaik()'>Like</a>"
...
if(body != null) {
	...
	div.style.border = "0px dashed #94a3c4";
	div.style.padding = "2px";
	div.innerHTML = "<a onclick='OtomatisUnlike()'>Unlike</a>"
...
if(body != null) {
	...
	div.style.border = "0px dashed #94a3c4";
	div.style.padding = "2px";
	div.innerHTML = "<a onclick='AutoExpand()'>Expand C</a>"
