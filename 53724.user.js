...
//
// ==UserScript==
// @name          TribalWars Toolbar arabic v0.1
...
'<a href="'+baseURL+'/game.php?village='+vID+'&screen=ally&mode=forum"><img src="'+baseURL+'/graphic/ally_forum.png" border="0"> منتدى القبيلة</a>'+
'</div></center>';
