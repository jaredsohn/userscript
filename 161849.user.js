// ==UserScript==
// @name Dead Frontier Map by AngelExterminador
...
genbutt("Arriba",function() { if(cpos[1] == map.height) { return; } cpos[1]++; redraw(); });
genbutt("Abajo",function() { if(cpos[1] == 1) { return; } cpos[1]--; redraw(); });
genbutt("Izquierda",function() { if(cpos[0] == 1) { return; } cpos[0]--; redraw(); });
genbutt("Derecha",function() { if(cpos[0] == map.width) { return; }  cpos[0]++; redraw(); });
nbut++;
genbutt("Marcar",function() { setMapMark(cpos,"cleared"); });
