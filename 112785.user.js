...
//Gestione grafica
var versione_fac = "ZOMBIE Edition";
var voglio_che_mi_segua = "si";
var colore_sfondo = "#99FF33";
var distanza_alto = "+250px";
var immagine_sfondo = "url(http://img12.imageshack.us/img12/4862/zombiedf.jpg)"; //attenti all'url()
...
//Inserisco la parte che visualizzerÃ  l'url completo di tag IMG	
	var versione = "<img id=\"button\" style=\"margin: 5px;\"  onclick=\"chiudi();\" src ='##'></img><input style=\" margin-left: 20px; width: 190px; border: 0px solid black; padding: 8px; background: transparent; border-bottom: 0px solid white; font-weight: bold; text-align: center; color: #4CC417;\" type=\"text\" id=\"copiaggio\" value=\".: " + versione_fac + " :.\">";
...
//	div.style.borderTop = "2px solid black";
	...
	div.style.boxShadow ="2px 2px 15px 2px #99FF33";
