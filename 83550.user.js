...
// und erneut veröffentlichst. S.a. Beschreibung unter http://userscripts.org/scripts/show/83550
// ******************************************************************************************
...
var Einsatzklassen = {
  ...
  //   http://userscripts.org/scripts/review/83548
};
...
var WikiLinks = {
  ...
  'Baum auf Straße'                : 'Baum_auf_Straße',
  ...
  'Brand in Gemeindehaus'          : 'Brand in Gemeindehaus',			
  'Brand in Kletterhalle'          : 'Brand_in_Kletterhalle',
  'Brand in Kühlhaus'              : 'Brand_in_Kühlhaus',
  ...
  'Mülleimer Brand'                : 'Mülleimerbrand',
  'Mähdrescherbrand'               : 'Mähdrescherbrand',		
  'Ölspur'                         : 'Ölspur',
    ...
    { var TDs = TR.getElementsByTagName("td");
      ...
      { TDs[0].style.backgroundColor="transparent";
        ...
        { var bgc="";
          ...
          if (FH && Ausb.match("Flughafen")==null) bgc="#226622";
          if (LB && Ausb.match("Löschboot")==null) bgc="#226622";
          if (bgc) 
...
{ 
  ...
  H += GM_getValue("AAO_Source","http://userscripts.org/scripts/review/83548") + "'> \n";
  H += "<input type='button' value='einlesen' id='AAO_downloadButton'><br>\n";
  H += "<font size='-1'>z.B.: http://userscripts.org/scripts/review/83548</font><br>\n";
...
{ mylog("doDownload");
  ...
  if (!AAOURL) AAOURL="http://userscripts.org/scripts/review/83548";
