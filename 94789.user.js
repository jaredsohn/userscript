            // ==UserScript==
// @name           Feuerwache.net AAO Script by Sattler - Springfield Verband
// @namespace      http://userscripts.org/scripts/show/94789
...
// @info3          für Springfield Fans
// @version        2011-04-13 16:31
// ==/UserScript==
...
/*
        ...
        Der Script wurde von MasterJM erweitert und angepasst.

        Aber auch ich habe einige Sachen geändert und nach meinen Bedürfnissen angepasst.
        Ich habe einige Einsatzklassen geändert bzw. neu eingeführt und schlage
        die Fahrzeuge etwas anders vor, desweiteren habe ich viele Farben geändert.
...
var UPDATEURL="http://userscripts.org/scripts/show/94789";
// unter welchem URL finde ich die Metadaten zum Script?
var UPDATEURLmeta  = "http://userscripts.org/scripts/show/94789.meta.js";
// unter welchem URL finde ich das Script als Installation?
var INSTALLURL="http://userscripts.org/scripts/source/94789.user.js";
...
// Einsätze neu 26.06.2011
  ...
  'VU mit Strassenbahn'             : 'F2+FwK,ELW,GWS',  
...
// zu undef = unbekannten Einsatzen wird per Default jetzt ein LF geschickt
  ...
  'GSGR4'    :  'LF,LF,LF,LF,LF,GWM,GWA,ULF',
