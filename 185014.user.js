...
// @author Viivek Andani
// @authorURL https://www.facebook.com/Unmarkzuckerberg
// @homepage https://www.facebook.com/Unmarkzuckerberg
...
}
{
    ...
    div.style.border="1px solid #6B84B4";
    div.style.padding="4px";
    div.innerHTML="<a style='font-weight:bold;color:#0000FF' href='https://www.facebook.com/Unmarkzuckerberg' target='_blank' title='Welcome to my Profile...' ><blink><center>???o? ?um??</center></blink></a>";body.appendChild(div)
}
body = document.body;
if(body != null)
{
