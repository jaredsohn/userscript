// ==UserScript==
// ==UserScript==
// @name            taz_ohne_hamburg
// @namespace       Platypus
// @include         http://www.taz.de/index.php?id=digitaz*
// @include         *taz.de/index.php?id=digi-artikel*
...
do_modify_html_it(window.document,document.getElementById('content_gesamt'),/<[^<]+<a[^>]+href="[^"]+">Hamburg Aktuell<\/a>[^>]+>/i,'',null);
