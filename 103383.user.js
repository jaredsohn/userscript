// ==UserScript==
// @name           Garry's Mod [Comunidad Oficial]
// @namespace      Garry's Mod
// @description    Script para la comunidad Garry's Mod [Comunidad Oficial]
// @include        *taringa.net/*
// @exclude        *taringa.net/comunidades/garrys-mod/*
// ==/UserScript==
...
////////////////////////////////////////////////////////
//                                                    //
//     Garry's Mod [Comunidad Oficial]                //
//                  <<<Azael2>>>                   //
//                                                    //
////////////////////////////////////////////////////////
////////////////////////////////////////////////////////

function byAzael12(clsName, tag) {
...
byAzael12('menuTabs').innerHTML += "<li id=\"tabbedWTF\" class=\"tabbed\">\n <a href=\"http://www.taringa.net/comunidades/garrys-mod/\" onclick=\"menu(\'Garry's Mod [Comunidad Oficial]! \', this.href);return false;\" title=\"Ir a la comunidad Garry's Mod [Comunidad Oficial]\">Garry's Mod [Comunidad Oficial] <img src=\n\"\" alt=\"\" /></a>\n</li>";
