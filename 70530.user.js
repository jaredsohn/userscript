// ==UserScript==
// @name           Ikariam - Better city - Arabic Adaptation
// @version	   1.3
// @namespace      http://s*.ikariam.*/*
// @description    Changes the images at the town view, gives them a better look and adds the effect of day and night for arabic servers.
// @include        http://s*.ikariam.*/*
// @exclude        http://s*.ikariam.*/skin/*
// @exclude        http://s*.ikariam.*/js/*
// @exclude        http://s*.ikariam.*/index.php?action=newPlayer
// @exclude        http://board.ikariam.*/*
// @history	   1.3 fixed the beachboys bug at city lvl 24
// @history	   1.2 ressources removed to increase the script's speed
// @history	   1.1 host server changed from imageshak to photobuket
//
//
// ==/UserScript==

// This is an adaptation of the Ikariam - Better city Script for the arabic servers
