// ==UserScript==
// @name           Facebook - KOC 169 Gift acceptor
// @version        0.1
// @namespace      KOCQuickWidgets-AutoAcceptGifts 169
// @homepage       http://userscripts.org/
// @description    This script will automatically accept gifts on 169 of KOC from your Facebook Game Requests. Works even if you play on multiple domains!
				...
				if(claim_gift){
					...
					if(domain_selector && (next_button1 || next_button2)){
						for(var i=0; i<domain_selector.options.length; i++){
							if(domain_selector.options[i].value == "169"){
