// ==UserScript==
// @name           Troll-emoticons v2 racocatala-mod
// @namespace      http://jeayese.com/
// @description    Use meme emoticons on popular websites!.
// @include        http*://*facebook.com/*
// @include        http*://*twitter.com/*
// @include	   http*://*racocatala.cat/*
// @version        2.8
// ==/UserScript==
...
function makeYahoo(node) {
	...
	.replace(/-lol-/g, "<img src=\'http://gapgames.net/images/ragefacescript/lol.png\' />")
...
function commonInsert(obj) {
	...
	replaceByClass('content', obj); //RacoCatala
