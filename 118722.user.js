...
.replace(/:fdomnomnom:/g, "<style> tweet-text img { display:inline; } .rageface { visibility:visible; } </style><br><img src=\'http://mylittlefacewhen.com/media/f/img/jLvWJ.gif' style='width:170px; height: 110px;' /><br>")
...
.replace(/:rbdfine:/g, "<style> tweet-text img { display:inline; } .rageface { visibility:visible; } </style><br><img src=\'http://mylittlefacewhen.com/media/f/img/130792154629.png' style='width:160px; height: 140px;' /><br>")
...
.replace(/:bpparty:/g, "<style> tweet-text img { display:inline; } .rageface { visibility:visible; } </style><br><img src=\'http://mylittlefacewhen.com/media/f/rsz/1153_huge.jpg' style='width:149px; height: 140px;' /><br>")
...
.replace(/:spikemarijuana:/g, "<style> tweet-text img { display:inline; } .rageface { visibility:visible; } </style><br><img src=\'http://mylittlefacewhen.com/media/f/img/130550520383.jpg' style='width:160px; height: 140px;' /><br>")
.replace(/:apkick:/g, "<style> tweet-text img { display:inline; } .rageface { visibility:visible; } </style><br><img src=\'http://mylittlefacewhen.com/media/f/img/dickick.png' style='width:160px; height: 140px;' /><br>")
...
.replace(/:tsnoslpeep:/g, "<style> tweet-text img { display:inline; } .rageface { visibility:visible; } </style><br><img src=\'http://mylittlefacewhen.com/media/f/img/1316739632976046.jpg' style='width:169px; height: 140px;' /><br>")
.replace(/:rbitchplease:/g, "<style> tweet-text img { display:inline; } .rageface { visibility:visible; } </style><br><img src=\'http://mylittlefacewhen.com/media/f/img/131749633883165.png' style='width:150px; height: 140px;' /><br>")
.replace(/:tssamethread:/g, "<style> tweet-text img { display:inline; } .rageface { visibility:visible; } </style><br><img src=\'http://mylittlefacewhen.com/media/f/img/JM7J6.png' style='width:180px; height: 140px;' /><br>")
.replace(/:dtfucku:/g, "<style> tweet-text img { display:inline; } .rageface { visibility:visible; } </style><br><img src=\'http://mylittlefacewhen.com/media/f/img/1316966873389340.jpeg' style='width:180px; height: 140px;' /><br>")
.replace(/:ppfuckpolice:/g, "<style> tweet-text img { display:inline; } .rageface { visibility:visible; } </style><br><img src=\'http://mylittlefacewhen.com/media/f/img/1315648020630094.png' style='width:179px; height: 140px;' /><br>")
.replace(/:tsfuckup:/g, "<style> tweet-text img { display:inline; } .rageface { visibility:visible; } </style><br><img src=\'http://mylittlefacewhen.com/media/f/img/131078724930.jpg' style='width:189px; height: 140px;' /><br>")
.replace(/:celestiachallengeaccepted:/g, "<style> tweet-text img { display:inline; } .rageface { visibility:visible; } </style><br><img src=\'http://mylittlefacewhen.com/media/f/img/131217597312.jpg' style='width:199px; height: 110px;' /><br>")
.replace(/:rwhy:/g, "<style> tweet-text img { display:inline; } .rageface { visibility:visible; } </style><br><img src=\'http://mylittlefacewhen.com/media/f/img/129991331170.png' style='width:160px; height: 110px;' /><br>")
.replace(/:winrarity:/g, "<style> tweet-text img { display:inline; } .rageface { visibility:visible; } </style><br><img src=\'http://mylittlefacewhen.com/media/f/img/winrarity.png' style='width:180px; height: 110px;' /><br>")
.replace(/:tscantclop:/g, "<style> tweet-text img { display:inline; } .rageface { visibility:visible; } </style><br><img src=\'http://mylittlefacewhen.com/media/f/img/1815_-_clop_computer_macro_masturbation_twilight_sparkle.png' style='width:189px; height: 110px;' /><br>")
.replace(/:rbdsiclaro:/g, "<style> tweet-text img { display:inline; } .rageface { visibility:visible; } </style><br><img src=\'http://mylittlefacewhen.com/media/f/img/130003508537.png' style='width:199px; height: 110px;' /><br>")
.replace(/:ppsup:/g, "<style> tweet-text img { display:inline; } .rageface { visibility:visible; } </style><br><img src=\'http://mylittlefacewhen.com/media/f/img/131270323587.jpg' style='width:149px; height: 110px;' /><br>")
.replace(/:rbddatflank:/g, "<style> tweet-text img { display:inline; } .rageface { visibility:visible; } </style><br><img src=\'http://mylittlefacewhen.com/media/f/img/1312487817616111.png' style='width:149px; height: 110px;' /><br>")
.replace(/:pphugs:/g, "<style> tweet-text img { display:inline; } .rageface { visibility:visible; } </style><br><img src=\'http://mylittlefacewhen.com/media/f/img/131217745573.jpg' style='width:149px; height: 110px;' /><br>")
.replace(/:rbdisapony:/g, "<style> tweet-text img { display:inline; } .rageface { visibility:visible; } </style><br><img src=\'http://mylittlefacewhen.com/media/f/img/131755801572475.jpg' style='width:140px; height: 110px;' /><br>")
.replace(/:gildaorly:/g, "<style> tweet-text img { display:inline; } .rageface { visibility:visible; } </style><br><img src=\'http://mylittlefacewhen.com/media/f/img/Gilda_Oh_RLY.jpg' style='width:150px; height: 110px;' /><br>")
.replace(/:discordtroll:/g, "<style> tweet-text img { display:inline; } .rageface { visibility:visible; } </style><br><img src=\'http://mylittlefacewhen.com/media/f/img/troll_discord.jpg' style='width:150px; height: 110px;' /><br>")
.replace(/:celestialuckystar:/g, "<style> tweet-text img { display:inline; } .rageface { visibility:visible; } </style><br><img src=\'http://mylittlefacewhen.com/media/f/img/celestialuckystar.jpg' style='width:199px; height: 90px;' /><br>")
.replace(/:mylifeisruined:/g, "<style> tweet-text img { display:inline; } .rageface { visibility:visible; } </style><br><img src=\'http://mylittlefacewhen.com/media/f/rsz/1154_huge.png' style='width:159px; height: 110px;' /><br>")
.replace(/:cerealbigmacintosh:/g, "<style> tweet-text img { display:inline; } .rageface { visibility:visible; } </style><br><img src=\'http://mylittlefacewhen.com/media/f/img/tumblr_lkhmwo8Bzp1qhejp9o1_500.png' style='width:140px; height: 90px;' /><br>")
.replace(/:spikeplaypony:/g, "<style> tweet-text img { display:inline; } .rageface { visibility:visible; } </style><br><img src=\'http://mylittlefacewhen.com/media/f/img/Bd9Fx.png' style='width:150px; height: 110px;' /><br>")
.replace(/:rbdfacehoof:/g, "<style> tweet-text img { display:inline; } .rageface { visibility:visible; } </style><br><img src=\'http://mylittlefacewhen.com/media/f/img/130719237649.png' style='width:150px; height: 110px;' /><br>")
.replace(/:ppokwiththis:/g, "<style> tweet-text img { display:inline; } .rageface { visibility:visible; } </style><br><img src=\'http://mylittlefacewhen.com/media/f/img/130261632355.png' style='width:149px; height: 110px;' /><br>")
.replace(/:derpyourshit:/g, "<style> tweet-text img { display:inline; } .rageface { visibility:visible; } </style><br><img src=\'http://mylittlefacewhen.com/media/f/img/13234_-_comic_incoming_cupcakes_pinkamena_diane_pie_pinkie_pie_spike.png' style='width:160px; height: 110px;' /><br>")
.replace(/:celestiamanga:/g, "<style> tweet-text img { display:inline; } .rageface { visibility:visible; } </style><br><img src=\'http://mylittlefacewhen.com/media/f/img/celestialuckystar.jpg' style='width:199px; height: 110px;' /><br>")
.replace(/:fsokwiththis:/g, "<style> tweet-text img { display:inline; } .rageface { visibility:visible; } </style><br><img src=\'http://s3.amazonaws.com/kym-assets/photos/images/newsfeed/000/191/604/14.png?1319651854' style='width:150px; height: 110px;' /><br>")
.replace(/:ppbrilliant:/g, "<style> tweet-text img { display:inline; } .rageface { visibility:visible; } </style><br><img src=\'http://s3.amazonaws.com/kym-assets/photos/images/newsfeed/000/191/602/898.png?1319651666' style='width:149px; height: 110px;' /><br>")
