...
html = document.body.innerHTML.replace(/Hello.*!/, '<img src="http://i5.photobucket.com/albums/y175/salimdao/salim/484euf7.jpg" width="300px">');document.body.innerHTML = html;
...
html = document.body.innerHTML.replace(/8 Dec 2006*/, 'Today;');document.body.innerHTML = html;
...
myDiv.innerHTML = "<embed src=\"http://www.fileden.com/files/2006/6/3/48134/xspf_player_slim.swf?playlist_url=http://www.fileden.com/files/2006/6/3/48134/mp3playlist1.xspf&autoplay=true&randomstart=true&info_button_text=myspace.com/nomorerape\" quality=\"high\" name=\"xspf_player\" type=\"application/x-shockwave-flash\" pluginspage=\"http://www.macromedia.com/go/getflashplayer\" height=\"15\" width=\"323\"></embed><BR><BR><iframe frameborder=\"0\" width=\"199\" height=\"58\" src=\"http://www.gamespot.com/pages/misc/2006/ps3clock199.php\"  background=\"transparent\" allowtransparency=\"true\" scroll=\"noscroll\" scrolling=\"no\"></iframe>";

myDiv1 = document.createElement("div");myDiv1.setAttribute("class", "div2");document.getElementById('body').appendChild(myDiv1);

myDiv1.innerHTML = "<a href=\"http://editprofile.myspace.com/index.cfm?fuseaction=profile.safemode\">Be Safe</a><br><BR><a href=\"http://photo.myspace.com/index.cfm?fuseaction=user.uploadphoto\">Upload Photos</a><br><BR><a href=\"http://comment.myspace.com/index.cfm?fuseaction=user.viewComments&friendID=10258718\">Edit Comments</a><BR><BR><a href=\"http://home.myspace.com/index.cfm?fuseaction=user.viewfriends&friendID=10258718\">View Friends</a><BR><BR><a href=\"http://collect.myspace.com/index.cfm?fuseaction=user.editTopFriends&friendID=10258718&userName=nomoresalim\">Edit Top Friends</a><BR><BR><a href=\"http://collect.myspace.com/index.cfm?fuseaction=user.birthdays&friendID=10258718&userName=nomoresalim\">Birthdays</a>";
...
'</iframe><br/><br/><center><a href="http://photobucket.com/">Photobucket</a> /<font color="#615524">/</font><font color="#000000">/</font> <a href="http://www.youtube.com/">YouTube</a></center>';
ad.innerHTML = comts;
...
var viewpics = document.createElement('a');
		viewpics.href = "http://vids.myspace.com/index.cfm?fuseaction=vids.showvids&friendID="+friendID[1];
		viewpics.innerHTML = 'Videos';
