// ==UserScript==
// @name           (Custom) DC Klaw Items, Nightshade, Candygrams, Boxes of Sunshine and "Gum"
// @namespace      http://userscripts.org/users/26909
// @description    Puts your Klaw Items, Nightshade, Candygrams, Boxes of Sunshine and "Gum" into your display case
...
switch(window.location.pathname){
	case "/managecollection.php":
		...
		if(x=getElementsByXPath('//form[@name="addgoodies"]//option[(starts-with(.,"stuffed") or starts-with(.,"rubber WW") or @value="2016" or @value="2018" or @value="1995" or @value="2017" or contains(.,"trading card") or @value="1999" or @value="1265" or @value="1187" or contains(.,"candygram")) and not(@value="403" or @value="743")]')){
