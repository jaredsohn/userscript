//-----------------------------------------------------------------------------
// [OA] Extra Statistics 1.0.0
// is a modified version of [WoD] Extra Statistics version 1.2.4
//
// Version 1.2.3, 2012-08-28
...
//
// Version 1.0.0, 2013-01-29 -- Gonor
// Modified for Old Ages games. Modifications are only in French
// Nota bene from Gonor : I am not an english traductor, and I am not a programmer, just a bidoulleur. Shit, how does I say that ? Yes ! I am just a do-it-yourselfer
// Rename action verb like used in Old Ages
// list of modifications :
// replace "magic attack" by "battage"
// rename action verb for natural attack : lance une force de la nature par agit comme un phénomène naturel
// rename action verb for social attack : déstabilise par influence
//
//
...
// ==UserScript==
// @name		[OA] Extra Statistics
// @version            1.0.0
// @description		Generate additional statistical data in the dungeon and duel report pages
// @include		http*://*.oldages.*/wod/spiel//*dungeon/report.php*
// @include		http*://*.oldages.*/wod/spiel/tournament/*duell.php?session_hero_id=*
// ==/UserScript==
		...
		_GetActionTypeAndKind: function(ActionText)
			...
			switch (ActionText)
				...
				case Local.OrigTextList_ActionType[1]:	// ranged
					return [1, 0];
				case Local.OrigTextList_ActionType[2]:	// magic // remplacé par Battage
					return [2, 0];
				case Local.OrigTextList_ActionType[3]:	// social // remplacè par Influence
					return [3, 0];
		...
		_GetDamageType: function(Text)
			...
			switch (Text)
				...
				case Local.OrigTextList_DamageType[10]:	// disarm trap
					return 10;
				case Local.OrigTextList_DamageType[11]:	// mana // ou Fatigue
					return 11;
				default:
					return null;
				}
...
var Contents = {
	...
	OrigText_LastRound		: ["Last round:",
					   "最后回合:",
					   "=Dernier tour="],
	OrigTextList_ActionType		: [["attacks", "ranged attacks", "BATTAGE", "socially attacks", "cunningly attacks", "activates on", "works as a force of nature upon", "infected", "casts an explosion at", "deactivated", "magic projectile", "curse", "scare", "DESORIENTATION", "ORIENTATION", "IMMOBILISATION", "heals with", "uses", "summons with", "is unable to do anything.", "looks around in boredom and waits."],
					   ["近战攻击", "远程攻击", "魔法攻击", "心理攻击", "偷袭", "触发", "做为自然灾害", "散布", "制造爆炸", "解除", "魔法投射", "诅咒", "恐吓", "治疗", "使用", "召唤", "不能执行任何动作.", "无聊的打量四周，等待着."],
					   /*         Mélée,                 Distance,                    Battage,                         Social,                         Embuscade,                         Piège,                                                    Nature,                                            Maladie,                Explosion,                 Désamorçage,             Eclaboussure,            Bannissement (pris avec Distances),         Effroi,                         Désorientation,                                  Orientation,                         Immobilisation,         Soin,                         Buff,                  Invocation,                         Ne rien faire,                                           Ne peut rien faire                             */
					   ["frappe avec", "tire avec", "lance", "influence avec", "s'embusque", "se déclenche avec", "agit comme un phénomène naturel", "infecte", "produit une explosion sur", "désamorce", "tire avec", "bannit", "terrorise", "désoriente avec", "cherche une solution avec", "lance", "soigne avec", "agit", "invoque avec", "ne peut rien faire.", "s'ennuie et attend la suite."]],
	OrigTextList_DamageType		: [["crushing damage", "cutting damage", "piercing damage", "fire damage", "ice damage", "lightning damage", "poison damage", "acid damage", "psychological damage", "holy damage", "disarm trap", "FATIGUE damage"],
					   ...
					   ["dégâts contondants", "dégâts tranchants", "dégâts perforants", "dégâts de feu", "dégâts de glace", "dégâts électriques", "dégâts de poison", "dégâts acides", "dégâts psychologiques", "dégâts saints", "dégâts de désamorçage", "dégâts de fatigue"]],
	...
	Text_Button_Default		: ["Default",
					   "默认",
					   "Reset"],
	TextList_AttackType		: [["melee", "ranged", "spell", "INFLUENCE", "ambush", "trap", "nature", "disease", "detonate", "disarm trap", "magic projectile", "curse", "scare"],
					   ["近战", "远程", "魔法", "心理", "偷袭", "陷阱", "自然", "疾病", "爆破", "解除陷阱", "魔法投射", "诅咒", "恐吓"],
					   ["Combat rapproché", "Combat à distance", "Battage", "Influence", "Embuscade", "Déclenchement", "Phénomène de la nature", "Maladie", "Explosion", "Désactivation", "Eclaboussure", "Bannissement", "Effroi", "Désorientation", "Orientation", "Immobilisation"]],
