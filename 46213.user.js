// ==UserScript==
// @name	Travian Big Map - in Hebrew
// @namespace	TRAVIAN MAP
// @author	Reza Revando Bawole & DMaster
// @description	Travian Big Map in Hebrew                        מפה גדולה למשחק טרוויאן
// @version	2.6.2.2
// @include	http://*.travian.*/karte.php*
// @include	http://*.travian3.*/karte.php*
// @exclude	http://*.travian.*/karte.php?newdid*
// ==/UserScript==
...
//	~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~
	function createInfoBox() {
		...
		info.innerHTML = '<table dir="rtl" class="f8 map_infobox_grey" width="100%" cellspacing="1" cellpadding="2">' +
				 '<tr><td class="c b" colspan="2" align="center">' + 'פרטים:' + '</td></tr>' +
				 '<tr><td class="c s7" width="45%" ><p align="right">' + 'שחקן:' + '</p></td><td class="c s7"><p align="center">-</p></td></tr>' +
				 '<tr><td class="c s7"><p align="right">' + 'תושבים:' + '</p></td><td class="c s7"><p align="center">-</p></td></tr>' +
				 '<tr><td class="c s7"><p align="right">' + 'ברית:' + '</p></td><td class="c s7"><p align="center">-</p></td></tr>' +
				 '</table>';
		return info;
	}
	...
	function createMapAreas() {
		var map = dst.cn('map');
		map.name = 'map2';
		map.innerHTML = '<area dir="north" href="#" coords="762,115,30" shape="circle" title="צפון">' +
				'<area dir="east"  href="#" coords="770,430,30" shape="circle" title="מזרח">' +
				'<area dir="south" href="#" coords="210,430,30" shape="circle" title="דרום">' +
				'<area dir="west"  href="#" coords="200,115,30" shape="circle" title="מערב">';
		...
		return function() {
			...
			if (name) {
				var table = '<table dir="rtl" cellspacing="1" cellpadding="2" class="tbg f8"><tr>'+
					    ...
					    '</td></tr><tr><td width="45%" class="s7 f8"><p align="right">' + 'שחקן:' +
					    '</p></td><td class="s7 f8">' + owner +
					    '</td></tr><tr><td class="s7 f8"><p align="right">' + 'תושבים:' +
					    '</p></td><td class="s7 f8" id="ew">' + pop +
					    '</td></tr><tr><td class="s7 f8"><p align="right">' + 'ברית:' +
					    '</td><td class="s7 f8">' + ally +
					    '</p></td></tr></table>';
				info.innerHTML = table;
			}
			else {
				var table = '<table dir="rtl" class="f8 map_infobox_grey" cellspacing="1" cellpadding="2"><tr><td class="c b" colspan="2" align="center"></a>' + 'פרטים:' +
					    '</td></tr><tr><td align="right" width="45%" class="c s7"><p align="right">' + 'שחקן:' +
					    '</p></td><td class="c s7"><p align="center">-</p></td></tr><tr><td class="c s7"><p align="right">' + 'תושבים:' +
					    '</p></td><td class="c s7"><p align="center">-</p></td></tr><tr><td class="c s7"><p align="right">' + 'ברית:' +
	...
	function makeEventMouseOut() {
		return function() {
			...
			var info = doc.getElementById('tb');
			var table = '<table dir="rtl" class="f8 map_infobox_grey" cellspacing="1" cellpadding="2"><tr><td class="c b" colspan="2" align="center"></a>' + 'פרטים:' +
					'</td></tr><tr><td width="45%" class="c s7"><p align="right">' + 'שחקן:' +
					'</p></td><td class="c s7"><p align="center">-</p></td></tr><tr><td class="c s7"><p align="right">' + 'תושבים:' +
					'</p></td><td class="c s7"><p align="center">-</p></td></tr><tr><td class="c s7"><p align="right">' + 'ברית:' +
					'</p></td><td class="c s7"><p align="center">-</p></td></tr></table>';
			info.innerHTML = table;
