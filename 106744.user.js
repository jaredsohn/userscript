...
function findName(test) {
    if (test.innerHTML.indexOf('/game/home.pl?user_id=182988', 0)>-1 || test.innerHTML.indexOf('/game/home.pl?user_id=182988', 0)>-1 || test.innerHTML.indexOf('/game/home.pl?user_id=4817', 0)>-1 ) 
return 1;
  return 0;
}
...
for(var i=0,j=els.length; i<j; i++) {
	if (findName(els[i])){
		...
		els[i].innerHTML = els[i].innerHTML + '<b>Rapped at your mom</b><br/>'
