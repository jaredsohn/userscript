...
function letsJQuery()
{
    $(document).ready(function () {
        ...
        var transferBaiduData = function(id,lng,lat,status){
            ...
            if(n_lng == '121' || n_lat == '38'|| n_lat == '39'|| n_lat == '0' || n_lat == '0'){
        ...
        function getLocalData(){
            $.getJSON("http://10.207.0.240/jsapi.php?type=getshop&city=dalian&callback=?",function(data){
                    var data = eval(data);
