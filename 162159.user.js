// ==UserScript==
// @name        Radio101_Superclassifica_mp3skull
// @namespace   marcoratto
// @description Button MP3skull for Radio 101 Superclassifica
// @include     http://www.r101.it/musica/superclassifica/*
// @version     0.1
// @grant          GM_getValue
// @grant          GM_setValue
// @grant          GM_log
...
function main() {
    ...
    allSingers = document.evaluate("id('tbl_superclassifica')/tbody//td[2]/div/span[1]",    
									document,
									null,
    ...
    allTitles = document.evaluate("id('tbl_superclassifica')/tbody//td[2]/div/span[2]",
								document,
								null,
								XPathResult.UNORDERED_NODE_SNAPSHOT_TYPE,
								null);
    if ((allTitles == null) || (allTitles.snapshotLength == 0)) {
    	Log4GM.warn("The xpath return an empty list!");
		return;
    }
	...
	Log4GM.debug("songAuthor=" + songAuthor);
	    var url = "http://mp3skull.com/search.php?q=" + escape(songAuthor + " " + songTitle);
		Log4GM.debug("url=" + url);
