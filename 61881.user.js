...
// @include http://ae*.tribalwars.ae/game.php?*screen=snob&mode=reserve*
// @include http://ae*.tribalwars.ae/game.php?*screen=snob&mode=coin*
// ==/UserScript==
...
if(/screen=snob&mode=(reserve|coin)(|&group=\d+)/.test(location.href)) {
	...
	if(chooser && chooser.snapshotLength > 0) {
		...
		div.innerHTML = '<select id="chooser1">' +
										...
										'<optgroup label="الكمية المطلقة_plapl.com_">' +
										...
										'</optgroup><optgroup label="على الاطلاق ، اعتمادا على المخازن">' +
										...
										'</optgroup><optgroup label="بالنسبة إلى محتويات المخازن">' +
