// ==UserScript==
// @name			HF Scripts - Easy Report Website and Forum Hacking
// @namespace 		Glassy/hfreportingwebsiteandforumhacking
// @description 	Makes reporting posts/threads in Website and Forum Hacking section to Glassy MUCH easier.
// @include  		*hackforums.net/showthread.php*
// @version  		1.1.2
// ==/UserScript==

var navBit = document.getElementsByClassName('navigation')[0];
if(navBit.innerHTML.indexOf('<a href="forumdisplay.php?fid=43">Website and Forum Hacking</a>') != -1) {
