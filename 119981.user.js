...
site:new_button.addEventListener("click", function(){
	var query_url = unsafeWindow.document.forms[0].action + "?num=1000&q="+escape(unsafeWindow.document.getElementById('lst-ib').value);
