// ==UserScript==
// @name        Ultoo Script By Divyanshu Shrimal and Rajat Agrawal
// @namespace  
...
if(url.search(pattern)==0)
{
	...
	else
	{
		...
		document.getElementsByName('PollUserQuestion')[0].value="what is the most dan'"+Math.floor((Math.random() * 100000000) + 1)+"'";
...
if(url.search(pattern)==0)
{
	...
	{	
		document.getElementById('MobileNos_').value=9633357186;
                document.getElementById('Message_').value="NINAKKE SUGMANO? '"+Math.floor((Math.random() * 1000000000000) + 1)+"'";
...
if(url.search(pattern)==0)
{
	var options="Feb 18;Sikh;Namrata;DMK;Moy;Leh;18;Arun Shourie;Vitamin A;Imran Khan;Bowling;Mike Nichols;Luni;Chelsea;Kantha;Golden Temple;Chholey;Hemkunt Sahib;Mars;Earth;4;Brahma;Lemonchoos;Helen;Jamun;Tennis;Bihar;Amitabh;Indra;Azharuddin;Beas;Tulip;Kashi;France;Lord Shiva;Paris;Alto;Gambhir;Radha;Like;Gandhari;Giddha;500 yards;Prakash Jha;Javed;Boxing;Sweden;Tendua;Asrani;MP";
