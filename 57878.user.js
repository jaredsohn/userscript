...
newth.innerHTML = 'Puntos- <br />banda';
...
newth_2.innerHTML = 'Dinero/ <br /> Fecha-Registro/ <br /> Alcohol';
...
function Geldladen(id,x) {
   ...
   alert ('Atencion: Mira a ' + name + ' un puto mendigo tontopoyas con mas de 15mil euros.');
