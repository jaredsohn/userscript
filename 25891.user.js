...
function build_shortcuts_menu(){
	...
	TW_Set_Function("tribe_info", function(){
		...
		window.open("http://ro.twstats.com/index.php?page=search&name=" + escape(tribe_name) + "&type=player");
	});
	...
	TW_Set_Function("ally_info", function(){
		...
		if(ally_name=="" || ally_name==TW_Lang["tribe"]){
			...
			window.open("http://ro.twstats.com/index.php?page=search&name=" + escape(ally_name) + "&type=tribe");
	});
...
function enhance_map_screen(){
	...
	var form = $$("form")[1];
	var sizes = [7, 10, 12, 15, 18, 20, 22, 24, 26, 28, 30, 500];
