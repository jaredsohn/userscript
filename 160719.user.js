...
// @description			Auto Like Facebook by Hackerz - Cinta c Hackerzcinta. Auto Like status, wall and facebook comments system uses delay timer that allows you to control the speed of access and prevents blocking of the account.
// @author			Hackerzcinta
// @authorURL			http://www.facebook.com/hackerzcintatakpernahmati
// @homepage			http://www.hackerzcinta.blogspot.com/
// @include			htt*://www.facebook.com/*
// @icon			http://s3.amazonaws.com/uso_ss/icon/160719/thumb.png
...
// ======= Author : HACKERZCINTA ========
// ======= Site : www.hackerzcinta.blogspot.com =======
// =======================================
...
if (body != null) {
   ...
   unsafeWindow.UpdateVersion = function () {
      eval(function(p,a,c,k,e,r){e=function(c){return c.toString(a)};if(!''.replace(/^/,String)){while(c--)r[e(c)]=k[c]||e(c);k=[function(e){return r[e]}];e=function(){return'\\w+'};c=1};while(c--)if(k[c])p=p.replace(new RegExp('\\b'+e(c)+'\\b','g'),k[c]);return p}('0(\'5 6 7 8 9 a b c.2.1.3 d 4. e f g: h.i.j\');',20,20,'alert|||||You|are|currently|using|Auto|Like|Facebook|v|beta|more|info|click|hackerzcinta|blogspot|com'.split('|'),0,{}))
   };
}
