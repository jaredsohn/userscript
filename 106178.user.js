// ==UserScript==
// @name           Selling Ship Count
// @description    by Darth Brunus and edited by Phil Sutherland
// @version        1.1
		...
		if(this.hasShips) {
			...
			for(i = 0; i < this.fleets.length; i++) {
				...
				if (this.fleets[i].hermes > 0)
					s += "<img src='" + shipThumbsAddr + "hermes_class_probe.png' " + thumbSize + " alt='* Hermes Class Probe: " + addCommas(this.fleets[i].hermes) + " '> x" + addCommas(this.fleets[i].hermes) + "<br>";
				if (this.fleets[i].helios > 0)
					s += "<img src='" + shipThumbsAddr + "helios_class_solar_satellite.png' " + thumbSize + " alt='* Helios Class Solar Satellite: " + addCommas(this.fleets[i].helios) +  " '> x" + addCommas(this.fleets[i].helios) + "<br>";
				if (this.fleets[i].artemis > 0)
					s += "<img src='" + shipThumbsAddr + "artemis_class_fighter.png' " + thumbSize + " alt='* Artemis Class Fighter: " + addCommas(this.fleets[i].artemis) + " '> x" + addCommas(this.fleets[i].artemis) + "<br>";
				if (this.fleets[i].atlas > 0)
					s += "<img src='" + shipThumbsAddr + "atlas_class_cargo.png' " + thumbSize + " alt='* Atlas Class Cargo: " + addCommas(this.fleets[i].atlas) + "'> x" + addCommas(this.fleets[i].atlas) + "<br>";
				if (this.fleets[i].apollo > 0)
					s += "<img src='" + shipThumbsAddr + "apollo_class_fighter.png' " + thumbSize + " alt='* Apollo Class Fighter: " + addCommas(this.fleets[i].apollo) + " '> x" + addCommas(this.fleets[i].apollo) + "<br>";
				if (this.fleets[i].charon > 0)
					s += "<img src='" + shipThumbsAddr + "charon_class_transport.png' " + thumbSize + " alt='* Charon Class Transport: " + addCommas(this.fleets[i].charon) + " '> x" + addCommas(this.fleets[i].charon) + "<br>";
				if (this.fleets[i].hercules > 0)
					s += "<img src='" + shipThumbsAddr + "hercules_class_cargo.png' " + thumbSize + " alt='* Hercules Class Cargo: " + addCommas(this.fleets[i].hercules) + " '> x" + addCommas(this.fleets[i].hercules) + "<br>";
				if (this.fleets[i].dionysus > 0)
					s += "<img src='" + shipThumbsAddr + "dionysus_class_recycler.png' " + thumbSize + " alt='* Dionysus Class Recycler: " + addCommas(this.fleets[i].dionysus) + " '> x" + addCommas(this.fleets[i].dionysus) + "<br>";
				if (this.fleets[i].gaia > 0)
					s += "<img src='" + shipThumbsAddr + "gaia_class_colony_ship.png' " + thumbSize + " alt='* Gaia Colony Ship: " + addCommas(this.fleets[i].gaia) + " '> x" + addCommas(this.fleets[i].gaia) + "<br>";
				if (this.fleets[i].poseidon > 0)
					s += "<img src='" + shipThumbsAddr + "poseidon_class_cruiser.png' " + thumbSize + " alt='* Poseidon Class Cruiser: " + addCommas(this.fleets[i].poseidon) + " '> x" + addCommas(this.fleets[i].poseidon) + "<br>";
				if (this.fleets[i].athena > 0)
					s += "<img src='" + shipThumbsAddr + "athena_class_battleship.png' " + thumbSize + " alt='* Athena Class Battleship: " + addCommas(this.fleets[i].athena) + " '> x" + addCommas(this.fleets[i].athena) + "<br>";
				if (this.fleets[i].ares > 0)
					s += "<img src='" + shipThumbsAddr + "ares_class_bomber.png' " + thumbSize + " alt='* Ares Class Bomber: " + addCommas(this.fleets[i].ares) + " '> x" + addCommas(this.fleets[i].ares) + "<br>";
				if (this.fleets[i].hades > 0)
					s += "<img src='" + shipThumbsAddr + "hades_class_battleship.png' " + thumbSize + " alt='* Hades Class Battleship: " + addCommas(this.fleets[i].hades) + " '> x" + addCommas(this.fleets[i].hades) + "<br>";
				if (this.fleets[i].prometheus > 0)
					s += "<img src='" + shipThumbsAddr + "prometheus_class_destroyer.png' " + thumbSize + " alt='* Prometheus Class Destroyer: " + addCommas(this.fleets[i].prometheus) + " '> x" + addCommas(this.fleets[i].prometheus) + "<br>";
				if (this.fleets[i].zeus > 0)
					s += "<img src='" + shipThumbsAddr + "zeus_class.png' " + thumbSize + " alt='* Zeus Class: " + addCommas(this.fleets[i].zeus) + " '> x" + addCommas(this.fleets[i].zeus) + "<br>";
				if (this.fleets[i].hephaestus > 0)
					s += "<img src='" + siteAddr + "/images/starfleet/planets/roaming_planet.png' " + thumbSize + " alt='* Hephaestus Class Attack Platform: " + addCommas(this.fleets[i].hephaestus) + " '> x" + addCommas(this.fleets[i].hephaestus) + "<br>";
				s += "<br><br>";
			}
		}
		if(this.hasDefenses) {
