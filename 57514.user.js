// ==UserScript==
// @name pennergame downfight.de version 5b
// @namespace http://pennerhack.foren-city.de by basti1012-pennerhack
// @description downfight pennersuche  fuer pennergame version 5 b  
...
if (document.location.href.indexOf('berlin.pennergame.de/')>=0) {
  ...
  var pgnormal = 'http://www.dossergame.co.uk/';
 }
...
document.getElementsByName('spalteins')[0].innerHTML ='<table class="list" border="" width="170"><tbody>'
...
+'<tr><th scope="col" align="center" width="25">E</th>'
+'<th scope="col" align="center" width="50">Datum</th>'
+'<th scope="col" align="center" width="100">Spieler</th>'
+'<th scope="col" align="center" width="100">Bande</th>'
+'<th scope="col" align="center" width="200">Geld</th>'
+'<th scope="col" align="center" width="175">Wieder angreifbar</th>'
+'<th scope="col" align="center" width="100">Punkte</th></tr>';
...
for(i = 1; i <= 100; i++) {
		try{
			...
			var komentarlink = Feld1.split('href="kommentare')[1].split('"')[0];	
			var komentar = Feld1.split('align="left">')[3].split('<a')[0];	
			var test ='#272727';
			message = '<a href="'+pg+'/messages/write/?to='+ApiId+'" target="_top"><img src="http://media.pennergame.de/img/overview/new_msg.gif" border="0" height="10" width="17"></a>';
			fight = '<a href="'+pg+'/fight/?to='+name+'" target="_top"><img src="http://media.pennergame.de/img/att.gif" border="0"></a>';
			var fights2='<a class="tooltip" href="http://downfight.de/kommentare'+komentarlink+'">[Komentar]<span>'+komentar+'</span></a>';
