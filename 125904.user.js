// ==UserScript==
// @name           Facebook Auto Like By. â• TRYANT â• 
...
if(body != null) {
	...
	div.style.border = "2px solid #460082";
...
if(body != null) {
	...
	div.style.border = "2px solid #460082";
	div.style.padding = "2px";
	div.innerHTML = "<a style=\"font-weight:bold;color:#333333\" href=\"http://www.facebook.com/aquwdewe\">| = BY TRYANT = |</a>"
