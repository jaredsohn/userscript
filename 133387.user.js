// ==UserScript==
// @name           4chan Neon Blue
// @description    Changes the 4chan boards to a neon blue theme
...
\
div.reply {\
	background-image: url(http://img221.imageshack.us/img221/3097/postgrad.png) !important;\
	border-color: -moz-use-text-color #0072BF #0072BF -moz-use-text-color !important;\
	background-color: #1a1a1a;\
	box-shadow: 0 0 8px #4CB7FF !important;\
}\
\
.reply:target, .highlight, .reply.highlight {\
	background: url(http://img51.imageshack.us/img51/5185/postgradhighlight.png) repeat scroll 0 0 #002A38 !important;\
	border-color: -moz-use-text-color #000B13 #000B13 -moz-use-text-color !important;\
	color:	#8BCFFF;\
}\
\
body {\
	background-image: url(http://img600.imageshack.us/img600/7044/73565683.png);\
