// ==UserScript==
// @author		ThomasRed (source : Angel Vladov). Modifications by Sunmannus and Dissintigrator
// @name        eVenezuelan MU DO Report Script
// @namespace   eRepublikDOBattlesReporter_VEN_basedinBelgiansParas
// @version		2.2.3
// @uso:version 2.2.3
// @include		http://*erepublik.com/*/military/battlefield/*
// @description    eRepublik DO Reporting script for The Army of eVenezuela
// ==/UserScript==
...
var UMs_full = ['Academia FAN', 'Fuerza Civil eVenezolana - FCV', 'P.M.C. El Condor Guardian', 'Fuerza Elite Venezolana - FEV'];
var UMs_abrev = ['aFAN', 'FCV', 'CONDOR', 'FEV'];

var FORM_URL_MU = ["https://spreadsheets.google.com/spreadsheet/formResponse?hl=en_US&formkey=dEFnOGNBT0ZzMmZCN3VvUWNQOHN6Tmc6MA&ifq",
					"https://spreadsheets.google.com/spreadsheet/formResponse?hl=en_US&formkey=dEJ6VkVSUUFPNDV0YnVpX0VJV2szaGc6MA&ifq",
					"https://spreadsheets.google.com/spreadsheet/formResponse?hl=en_US&formkey=dEFnOGNBT0ZzMmZCN3VvUWNQOHN6Tmc6MA&ifq",
					"https://spreadsheets.google.com/spreadsheet/formResponse?hl=en_US&formkey=dEx2ZkE2NkN1aFNXYlp4QlZqak9SQnc6MA&ifq"];
...
if(window.location.href.indexOf(PAGE_BATTLEFIELD) > 0) {	
	...
	/***********************************************************************************/
/*	var FORM_URL_aFAN = "https://spreadsheets.google.com/spreadsheet/formResponse?hl=en_US&formkey=dEFnOGNBT0ZzMmZCN3VvUWNQOHN6Tmc6MA&ifq";
	var FORM_URL_FEV = "https://spreadsheets.google.com/spreadsheet/formResponse?hl=en_US&formkey=dEx2ZkE2NkN1aFNXYlp4QlZqak9SQnc6MA&ifq";
	var FORM_URL_FCV = "https://spreadsheets.google.com/spreadsheet/formResponse?hl=en_US&formkey=dEJ6VkVSUUFPNDV0YnVpX0VJV2szaGc6MA&ifq"; */
	var FORM_URL = "https://docs.google.com/spreadsheet/viewform?formkey=dEFnOGNBT0ZzMmZCN3VvUWNQOHN6Tmc6MA#gid=0";
	var FORM_FIELDS = {
				eday: "entry.0.single",
                name: "entry.2.single",
				UM:  "entry.18.single",
		...
		this.createReportObject = function() {
			...
			$.ajax({
				...
				success: function(data) {
					...
					/*switch(military_unit)
					{
						case "aFAN":
							FORM_URL = FORM_URL_aFAN;
							break;
						case "FEV":
							FORM_URL = FORM_URL_FEV;
							break;
						case "FCV":
							FORM_URL = FORM_URL_FCV;
							break;
					}*/								
