// ==UserScript==
// @author cleverguide
// @name         سيربت إظهار الموارد والمزارع الخالية من تعريب أخوكم محمد احمد 20
// @description  V0.03 | سيكربت يقوم بعرض الموارد والمساحة الخالية من المزارع في الشكل العام
// @namespace none
...
function overview_production_table(){
	...
	if (!table) {
		GM_log("الجدول مع قرية خالية غير موجود")
		return
	}
...
*/
	...
	cell.innerHTML = villageCount+"-قريه"+"<من تعريب أخوكم محمد احمد 20</a>"
