// ==UserScript==
// @name           BBCodes para programadores de Taringa
// @namespace      PoscaBBCODER
// @description    BBCoder para Porgramadores de Taringa, se agrego el boton CODE
...
// @version        30.1
// @copyright      Copyright (c) 2010, David Posca
// @creator        Creacdo por Sharkale, Modificado por David Posca
// ==/UserScript==

// **COPYRIGHT NOTICE**
//
//    "BBCoder para programadores de Taringa!
//
...
var URL = 'http://www.trescirculos.com/iconos/';
...
function CrearBarraBBC(){
		...
		<a href="" onclick="botonPrompt(\'code\');return false;"><img src="'+URL+'code.png" alt="Codigo para programadores" title="insertar Codigo" border="0"></a>\
...
function Sharkale_Opciones(){
	...
	nuevaHTML += '    <a href="http://www.sharkale.com.ar/" target="_blank"><img src="http://imgur.com/Ku2Do.png" alt="..::Radio Sharkale®::.." width="740"/></a>';
	...
	nuevaHTML += '    <a href="https://addons.mozilla.org/es-ES/firefox/addon/1865" title="Añadir Adblock Plus a Firefox" target="_blank"><img src="http://imgur.com/AhqrK.png" align="absmiddle" /><img src="http://imgur.com/Uaf19.png" align="absmiddle" height="150"/></a><hr>';
	...
	nuevaHTML += '    <a href="https://addons.mozilla.org/es-ES/firefox/addon/3456" title="Añadir WOT a Firefox" target="_blank"><img src="http://imgur.com/AhqrK.png" align="absmiddle" /><img src="http://imgur.com/yuuF5.png" align="absmiddle" /><img src="http://imgur.com/kb4UT.png" align="absmiddle" /><img src="http://imgur.com/2LN4y.png" align="absmiddle" /></a>';
	nuevaHTML += '</b></div>';
	nuevaHTML += '<div id="opciones-5" align="justify"><b>';
	nuevaHTML += '    <b><u><span style="color: red;">Changelog versión 30.0:</span></u></b><br>* [Fixed] Imágenes de IMGur.<br>* [Fixed] Host de imágenes para crear post.<br>* [Fixed] Pack de emoticones.<br>* [Fixed] Imágenes hosteadas en server propio.<br>* [Fixed] Algunos host en el linkchecker.<br><b><u><span style="color: red;">Changelog versión 30.0:</span></u></b><br>* [Fixed] Varios errores.<br>* [Fixed] Imágenes del menú.<br>* [Add] Borradores en el Menú.<br>* [Add] Nuevo servidor para subir imagenes en crear post.<br>* [Fixed] Creador de reproductor de MixPod.<br>';
...
///////////////------------------Cambiar Iconos--------------------////////////////////
if(CambiarTheme) addStyle(eval(GM_getValue('theme'+(Tar? '':'Por'),'({fondofuera:"#F6F6F6", borde:"#044C92", fondodentro:"#FBF7F7", fondopost:"#E4E4E4" })')));
