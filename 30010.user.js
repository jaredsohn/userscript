// ==UserScript==
// @name				Skylife Omerta Beyond
// @version				1.1
// @date				13-09-2008
// @author				Skylife ( Skylife AT omertabeyond DOT gen.tr )
// @author				Skylife ( Skylife AT omertabeyond DOT com )
// @author				Skylife ( Skylife AT omertabeyond DOT com )
// @namespace			omertabeyond.gen.tr
// @identifier			http://www.omertabeyond.gen.tr/newbeyond.user.js
// @description			Omerta Beyond 1.7 (The greatest addon for Omerta available!)
// @include				http://www.omertabeyond.gen.tr/*
...
ScriptVersion = '1.7';
ScriptSubVersion = '16';
SiteLink = 'http://www.omertabeyond.gen.tr';
...
if((dlp + dls) == ('/user.php' + dls)){
	if(prefs[7]) { // if Remove ImageShack / PhotoBucket / XS links option is on
		var xpath = "//img[contains(@src, 'imageshack.us')] | //img[contains(@src, 'photobucket.gen.tr')] | //img[contains(@src, 'xs.to')]";
		var results = document.evaluate(xpath, document, null, 7, null);
...
if((dlp == '/' || dlp == '/index.php') && lh.indexOf('beyond') == -1 && prefs[20]) {
	...
	$X("//td[@background='homeinclude/img/bar.gif']").innerHTML = '<font color="#cccccc" size="1"><b><center><a href="'+PrefsLink+'" target="_blank">'+lang.prefsname+'</a> - <a href="http://www.omertabeyond.gen.tr/" target="_blank">Beyond</a> - <a href="http://www.fingon.be" target="_blank">Fingon\'s</a></center><br><br><br><br></b></font>';
