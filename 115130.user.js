// ==UserScript==
// @name            Moswar
// @author          Rds (new version) Original by PixoiD
...
try {
					...
					onload: function(resp) {
						...
						if(local_version!=-1){
							...
							if (remote_version > local_version){
								...
								alert('Новая версия "'+script_name+'." еще в разработке');
						} else
							GM_setValue('SUC_current_version', remote_version+'');
					}
				});
	...
	GM_registerMenuCommand(GM_getValue('SUC_target_script_name', 'Moswar') + ' - Обновить скрипт', function() {
		updateCheck(true);
	});
...
var messages = "<label>Авто переработка петриков: <input type='checkbox' name='petric' id='petric'/></label>";
Notify.settings = {
    mask: true,
    closeable: true,
    title: 'Настройки',
...
$(document).ready(function(){
	...
	if($Settings.get('petric') == 1){
		...
		player = player.replace('http://moswar.ru/register/','');
...
"data:image/png;base64,";
		...
		$('<dt><div><div>Набаблили</div></div></dt>').appendTo("#stats-accordion");
	...
	$("#wildwest-buttons").append(setButtonAjax('Раздеться','dressed1')+"&nbsp;");
	$("#wildwest-buttons").append(setButtonAjax('Одеться','dressed2')+"&nbsp;");
	...
	$("#wildwest-menu").append(setButton('Лечить','/home/heal/')+"&nbsp;");
	$("#wildwest-menu").append(setButton('Магаз','/shop/')+"&nbsp;");
	$("#wildwest-menu").append(setButton('Березка','/berezka/')+"&nbsp;");
	$("#wildwest-menu").append(setButton('Вjobывать','/shaurburgers/')+"&nbsp;");
	$("#wildwest-menu").append(setButton('Метро','/metro/')+"&nbsp;");
	$("#wildwest-menu").append(setButton('Нефть','/neft/')+"&nbsp;");
	$("#wildwest-menu").append(setButton('Банк','/bank/')+"&nbsp;");
	$("#wildwest-menu").append(setButton('MMM','/pyramid/')+"&nbsp;"+"<br>"+"&nbsp;");
	$("#wildwest-menu").append(setButton('ОК','/huntclub/')+"&nbsp;");
	$("#wildwest-menu").append(setButton('Совет','/sovet/')+"&nbsp;");
	$("#wildwest-menu").append(setButton('АЗ','/automobile/')+"&nbsp;");
	$("#wildwest-menu").append(setButton('Менты','/police/')+"&nbsp;");
	$("#wildwest-menu").append(setButton('Завод','/factory/')+"&nbsp;");
	$("#wildwest-menu").append(setButton('Казино','/casino/')+"&nbsp;");
	$("#wildwest-menu").append(setButton('Вжжж','/automobile/ride/')+"&nbsp;");
	$("#wildwest-menu").append(setButton('Задания','/nightclub/jobs/')+"&nbsp;");
	$("#wildwest-menu").append(setButton('Статистика Войны','/clan/profile/warstats/')+"&nbsp;");
