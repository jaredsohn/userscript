// ==UserScript==
// @name        Strategus Tool Belt (STB) Dev
// @namespace   chy_strat
...
function addJQuery(callback) {
  ...
  script.setAttribute("src", "http://code.jquery.com/jquery-2.0.0.min.js");
...
function main() {
	// CONSTANTS /////////////////////////////////////////////////////////////
	const GREEN_QUALITY = 'rgba(0, 100, 0, 0.2)';
	const RED_QUALITY = 'rgba(100, 0, 0, 0.2)';
	const LIGHTEST_GREY = 'rgba(0, 0, 0, 0.2)';
	const LIGHT_GREY = 'rgba(0, 0, 0, 0.5)';
	const TROOP_ICON = 'http://i.imgur.com/lzkgfYe.png';
	const GOLD_ICON = 'http://i.imgur.com/GsvcGtg.png';
	const TRADE_ICON = 'http://i.imgur.com/o5WoZPb.png';
	const UNKNOWN_ICON = 'http://i.imgur.com/TSKPuy0.png';
	const SIEGE_ICON = 'http://i.imgur.com/k5t4Gi2.png';
