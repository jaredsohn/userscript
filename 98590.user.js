// ==UserScript==
// @name           VurucuTiM Haberleşme (made by xX Uchiha Sasuke Xx)
// @version        1.04
...
var ordersurl = "http://owlsmerkez.ow.funpic.org/orders.php";

var selectedunit = GM_getValue("defaultunit");
if (selectedunit==undefined) selectedunit = 1;
var units = ["Duyurular", "Bilgiler", "Avatar", "Sirketler"];
...
for (x in units)
 ...
 box.appendChild(tabs).style.width = "468px";
 ...
 ordersdiv.style.padding = "20px";
 ordersdiv.style.width = "649px";
 ordersdiv.style.fontSize = "25px";
