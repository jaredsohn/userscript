// ==UserScript==
// @name            Valkiria Orders
// @namespace       www.erepublik.com
// @author          F@SO, modifed by silgur
// @description     aktualne rozkazy
// @version         0.41
...
(function(undefined)
{
    ...
    var url = 'http://docs.google.com/View?id=dgds8zc7_13gxnh82q7';
    var updateUrl = 'http://userscripts.org/scripts/show/70632';
    var updateUrlIE = 'http://iescripts.org/view-scripts-754p1.htm';

    /* ---------------------------------- */
    // Magic, do not touch! ;)
    var imEr = "http://4.bp.blogspot.com/_qIxhONAMjiU/SjuoQFISS7I/AAAAAAAAAG0/M-XyHlcY8q8/s400/iron%2Bfist.JPG";
    var imOK = "http://4.bp.blogspot.com/_qIxhONAMjiU/SjuoQFISS7I/AAAAAAAAAG0/M-XyHlcY8q8/s400/iron%2Bfist.JPG";
    ...
    var ORDERS = {
        "{1}": "JeĹźeli to Twoje ostatnie logowanie, walcz w:",
        "{2}": "Walcz kamikaze w bitwie:",
        "{3}": "Zignoruj inne powstania i walcz w:",
        "{4}": "Walcz w:",
    };
    ...
    function parseData(s)
    {
        ...
        try
        {
            ...
            mon = '<p><a href="'+mon+'">Valkiria Orders</a></p>';
        ...
        {
            displayErrFrame("BĹ?Ä?d odczytu rozkazĂłw, sprĂłbuj pĂłĹşniej. JeĹźeli bĹ?Ä?d powtarza siÄ? - zgĹ?oĹ? bĹ?Ä?d na IRC.");
            throw e;
        }
    }
    ...
    function displayFrame(orders, links, additional, date, mon, im)
    {
        ...
        ordersDiv.innerHTML = '\
        <div class="title"><h2 style="font-size: x-large;" id="RozkazyMON">Valkiria Orders</h2></div>\
    ...
    function loadURL_GM(url, xhr)
    {
        ...
        xhr({
            ...
            {
                displayErrFrame("(GM) BĹ?Ä?d "+response.status+" ("+response.statusText+") podczas Ĺ?adowania strony.");
            }
        });
    }
    ...
    function loadURL_XHR(url, xhr)
    {
        ...
        xhr.onreadystatechange = function()
        {
            if(xhr.readyState == 4)
            {
                ...
                {
                    displayErrFrame("BĹ?Ä?d "+xhr.status+" ("+xhr.statusText+") podczas Ĺ?adowania strony.");
                }
            }
        };
        xhr.timeout = 15000;
        ...
        {
            displayErrFrame("Przekroczenie czasu poĹ?Ä?czenia.");
        };
    ...
    try
    {
        ...
        else if(isOp)
        {
            ...
            {
                displayErrFrame("Niepoprawnie zainstalowany skrypt. ProszÄ? przeinstalowaÄ? zgodnie z instrukcjami.");
                return;
            }
    ...
    {
        displayErrFrame("Naruszenie zasad dostÄ?pu.");
        throw e;
    }
})();
