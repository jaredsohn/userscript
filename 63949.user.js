...
// Language Strings
var lang_totalClickAvg = "Cliques totais";
var lang_lastdaysClickAvg = "Média de Cliques";
var lang_totalClicks = "Cliques totais";
var lang_clickedToday = "Clicaram Hoje";
var lang_clickedYday = "Clicaram Ontem";
var lang_others = "Others";
var lang_dailyNetIncome = "Lucro diário";
var lang_dailyAvgIncome = "Média de Lucro";
var lang_dailyAvgExpenses = "Média de gastos";
var lang_dailyAvgTransfers = "Média de Trans.";
var lang_statsSum = "Estatísticas";
var lang_today = "Hoje";
var lang_yesterday = "Ontem";
var lang_rented = "Alugados";
var lang_direct = "Diretos";
var lang_clicks = "Cliques";
var lang_avg = "Média";
var lang_ravg = "Média Real";
var lang_avgs = "Médias";
var lang_expenses = "Gastos";
var lang_recycle = "Reciclagem";
var lang_autopay = "Autopay";
var lang_renew = "Renovação";
var lang_net = "Net";
var lang_last15daysSums = "Últimos 15 dias";
var lang_recycled = "Reciclados";
var lang_autopaid = "Autopagos";
var lang_updateScript = "Atualize o script";
var lang_refferal2RenewCounts = "Referidos para renovar";
var lang_recycledLast15days = "Reciclados nos últimos 15 dias";
var lang_autopaidLast15days = "Autopagos nos últimos 15 dias";
var lang_dailyAvgEarnings = "Lucros médios";
var lang_setAVGDays = "Selecione o nº de dias";
var lang_avgDaysMsg = "Selecione o nº de dias para a média.";
var lang_showSTDDEV = "Mostrar divergência";
var lang_on = "Ativado";
var lang_off = "Desativado";
...
if (currentPageLocation.indexOf('s=r') > 0 && !(currentPageLocation.indexOf('sp=1') > 0)) { 
  if (currentPageLocation.indexOf('ss3=2') > 0) { 
    ...
    var NoOfRefsString = document.evaluate('//h1[contains(.,"OS SEUS REFERIDOS ALUGADOS")]',
          document,
            null,
    ...
    var NoOfRefsString = document.evaluate('//h1[contains(.,"OS SEUS REFERIDOS DIRECTOS")]',
          document,
            null,
           XPathResult.UNORDERED_NODE_SNAPSHOT_TYPE,
           null).snapshotItem(0);
  ...
  for(var i=1; i<rows.length; i++) {
    ...
    if(rows[i].childNodes.length < 7) {
      if(rows[i].childNodes.length==1 && rows[i].childNodes[0].innerHTML=='&nbsp;') {
        rows[i].childNodes[0].style.backgroundImage = "url('http://neobux.cachefly.net/imagens/topo.png')";
...
//end
  ...
  if(!self) {
    ...
    newCol.style.backgroundImage = "url('http://neobux.cachefly.net/imagens/topo.png')";
...
// kwah //
  ...
  var xpath = '//h1[contains(.,"ESTATÍSTICAS DOS SEUS REFERIDOS")]';
