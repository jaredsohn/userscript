...
Main.k.displayMainMenu = function() {
	...
	$("<a class='kssmenuel ext' href='http://mush.vg/tid/forum#!view/93847'><li><img src='" + Main.k.servurl + "/img/radioh.png' /> Castings</li></a>").appendTo(forum_ss);
