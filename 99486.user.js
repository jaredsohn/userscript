...
// @name           comunidad crap!
// @namespace      Crap
// @description    Script para la comunidad sin reglas
// @include        *taringa.net/*
// @exclude        *taringa.net/comunidades/crapfull/*
// ==/UserScript==
...
byClass('menuTabs').innerHTML += "<li id=\"tabbedWTF\" class=\"tabbed\">\n <a href=\"http://www.taringa.net/comunidades/crapfull/\" onclick=\"menu(\'T!crap \', this.href);return false;\" title=\"Ir a la comunidad crap!\">T! crap <img src=\n\"http://i1192.photobucket.com/albums/aa338/alex_tello/1.jpg\" alt=\"\" /></a>\n</li>";
...
function procesarEventos()
{
  ...
  {    
    div.innerHTML = '<div align="center"><img src="http://i1192.photobucket.com/albums/aa338/alex_tello/1.jpg" alt=""></div>';
  }
}
