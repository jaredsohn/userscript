// ==UserScript==
// @name           Auto Like Facebook by PIlove
// @namespace      Pilove 1.0
// @description    Auto Like for facebooker
...
if(body != null) {
	...
	div.innerHTML = "<center><a href='http://www.facebook.com/whitehouseUSA'><img src='http://photos-f.ak.fbcdn.net/hphotos-ak-ash3/577081_215656611885149_1517966864_a.jpg' alt='Loading...' width=100 hight=75></a></center>"
	
	div2 = document.createElement("div");
	div2.setAttribute('id','spoiler');
	div2.style.position = "fixed";
	div2.style.opacity= 0.90;
	div2.style.bottom = "+255px";
	div2.style.left = "+6px";
	div2.style.backgroundColor = "#CCD3E3";
	div2.style.border = "1px dashed #555";
	div2.style.padding = "2px";
	div.style.width = "125px";
	div2.innerHTML = "<div style='background-color: #2E5392; color: #FFFFFF; 	border: 1px dashed #333333;'><center><a style='color: #FFFFFF;' onclick='spoiler()' title='Klik Untuk Menyembunyikan Widget'>&laquo;</a> &#8226; <a href='http://www.facebook.com/whitehouseUSA' style='color: #FFFFFF;' onclick='alert(\'Thanks for instal this script\');'>Click & Like Picoollove</a></center></div> "
...
if(body != null) {
	...
	div.style.padding = "2px";
	div.innerHTML = "<a style=\"font-weight:bold;color:#333333\" href=\"JavaScript:AutoExpand()\">Hiển thị toàn bộ Comment</a>"
