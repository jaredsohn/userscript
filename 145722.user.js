// ==UserScript==
// @name           LoU Baron Bar
// @namespace      LordGregGreg
// @license        Creative Commons Attribution-ShareAlike 3.0 Unported License - http://creativecommons.org/licenses/by-sa/3.0/
// @description    Add Baron information to the players title bar. Resurrected from "LoU UI MS Baron" script by OzGoober. Updated till v2.0.8 by orshee, Alchemist42 and DanT1. v2.0.9 + updated from 2012 by paulwratt (v3 rewrite). v3.0.11 by LordGregGreg
...
var BRB_mainFunction = function() {//
	...
	function BRB_BaronBarLoU(){
		...
		var BRB_BarToolTip = 'Total / Current / Recruiting / Available';
		var BRB_ResToolTip = 'Darkwood / Runestone / Veritum / Trueseed';
		...
		// Background
		var bbcontainer = new qx.ui.container.Composite(new qx.ui.layout.Basic()).set({
			decorator: new qx.ui.decoration.Background("background-application"),
			opacity: 1.0,
			width: 150,
			height: 70
		});
		bbPlayerBar.add(bbcontainer, { top: 1, left: BRB_LeftIdent});

		// Label: Castles
		bbCastleLabel = new qx.ui.basic.Label('Castles:');
		...
		bbPlayerBar.add(bbCastleValue, { top: 1, left: BRB_LeftIdent + 48 });
		...
		bbPurifiedResourcesLabel = new qx.ui.basic.Label('Purified Resources:');
