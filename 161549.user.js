// ==UserScript==
// @name           Hoverscript for bubbles popping up when you hover over their images
// @version        1.0
...
{	
	...
	var newleft = (curleft+75);
	var newtop = (curtop-25);
	...
	/*
	if ((newtop+180) > (totalHeight+scrollOffset))
		{
		newtop = (newtop - 230);
		newleft = (newleft + 0);
		padding_left = 35;
		
		if ( (newleft+180) > totalWidth )
			{
			newleft = (newleft - 550);
			padding_left = 14;
	...
	else if ((newleft+197) > totalWidth)
	*/
	if ((newleft+597) > totalWidth)
		{
		newleft = (newleft - 457);
		padding_left = 15;
