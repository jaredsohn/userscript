// ==UserScript==
// @name         Gigantic Queerbag
// @namespace    
// @description     There is no Dysentary, only gigantic queerbag.
...
(function() {
	...
	var ReplacementText = "GIGANTIC QUEER";
	
	//edit the words here
	//sorted alpha backwords to catch bad word groupings
	var badwords=['Dysentary'];
...
//
//Thanks for being a gigantic queer bag.
//
