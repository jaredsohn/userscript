// ==UserScript==
// @name Elite Traders Club {E.T.C}
// @namespace http://userscripts.org/scripts/show/114212
// @version 0.0.1
// @description http://userscripts.org/scripts/show/114212
// @copyright FB MW Addon-Dakam, Unlocked-GuessX, Spockholm, etc
...
//=====================================================================================
// 〤mod. MWAddon By Dakam
//=====================================================================================

var MWAddonInfo = {
    version         : '0.0.1',
    name            : 'Elite Traders Club {E.T.C}',
    tag             : 'Elite Traders Club {E.T.C}',
    url             : 'http://userscripts.org/scripts/show/114212',
    meta_url        : 'http://userscripts.org/scripts/source/114212.meta.js',
...
var global = {
    ...
    user_links: {
        ...
        mscrew       : {name:'Mission Crew',  req_type:'gift',   gift_id: 441,     gift_cat: 1  },
        bzcrew       : {name:'Brazil Crew',   req_type:'simple', req_name:'city_crew', city: 7  },
        cgcrew       : {name:'Chicago Crew',  req_type:'simple', req_name:'city_crew', city: 8  }
    },
...
var helpToolTips = {
    ...
    locale_info: {
        'en_US': {
            ...
            description: 'English Tooltip v1.2<br><br>Created by <a href="http://userscripts.org/users/250944" target="_black">dakam</a>.<br>Revision by <a href="http://userscripts.org/users/369082" target="_black">FAST EDDIE</a>.<br><a href="http://userscripts.org/topics/88938?page=1#posts-386670">More Info</a>.'
        },    
        'es_ES': {
            name: 'Spanish (Spain)',
    ...
    'de_DE': {
        ...
        'freegiftscenter_popup': {
            ...
            'freegifts_scantime': 'Scanning.<br>Setze das maximale Alter an Beiträgen, die gescannt werden.<br>Alle Beiträge, die älter sind, werden übersprungen.',
            ...
            'freegifts_filter': 'Parsing.<br>Füge die Namen ein der Gifts, die gesucht werden sollen.<br>Jeder Filter muss mit dem Zeichen "|" getrennt sein.<br>Beispiel: crime spree|stamina boost|rare|exotic|mystery',
            ...
            'freegifts_remonignore': 'Remove facebook requests.<br>Aktivieren, um einen Facebook Request zu löschen, wenn "ignored it" angeklickt wird.',
            'freegifts_sendthanksrequest': 'Send back.<br>Aktivieren, um Gifts zurück zu senden.<br>Funktioniert nur mit Gifts von Deiner Facebook Request Page.',
            'freegifts_sendbacktype': 'Send back.<br>Metode auswählen, um Gifts zurück zu senden.',
            'freegifts_usebackgiftfilter': 'Send back.<br>Aktivieren, um NUR ausgewählte Gifts zurück zu senden.<br>Du musst die Namen der Gifts in der Box unten eingeben.',
            'freegifts_thanksbackfilter': 'Send back.<br>Namen der Gifts eingeben, die zurück gesendet werden sollen, Gifts mit dem Zeichen "|" trennen.',
            'freegifts_ignorelimits': 'Collector.<br>Aktivieren, um weiter einzusammeln, auch wenn das Tageslimit des Gifts erreicht wurde.',
            'freegifts_skipsameuser': 'Collector.<br>Aktivieren, um Gifts zu überspringen von Spielern, von denen Du schon ein Gift geholt hast heute.<br>Überspringt ein Gift wenn es nicht älter als 24h ist.<br>Crime Spree und anderes wird nicht übersprungen von dem Spieler.<br>Deaktivieren, um alle Links zu prüfen von dem Spieler.',
            'freegifts_masssendback': 'Collector.<br>Aktivieren, damit der Massive Collector Gifts zurücksendet über Facebook Requests. (Täglich Limitiert)',
            'freegifts_collectnomafia': 'Collector.<br>Aktivieren, um Links von Spielern zu prüfen, die Du nicht in deiner Mafia hast.<br>Damit können Stadion Fans gesammelt werden.<br>Sonst nicht aktivieren. Nicht immer eingeschaltet lassen',
            'freegifts_csselect': 'Crime Spree.<br>Auswählen, ob Du Helfen oder Sabotieren willst.',
            'freegifts_csreward': 'Crime Spree.<br>Auswählen, welchen Bonus Du gerne hättest.',
            'freegifts_useexcludedgifts': 'Skipping.<br>Aktivieren, um Gifts zu überspringen, die in der "exclude list" sind.',
            'freegifts_excludedpattern': 'Skipping.<br>Text eintragen des Gifts in die "exclude list" einträgt.<br>Du kannst verschiedene Texte eingeben, kann mit dem Zeichen "|" getrennt werden.<br>Beispiel: reached your limit|gold mastery'
        },
        ...
        // MULTI GIFTER
        'multigifter_popup': {
            'multigift_giftpages': 'Pagination.<br>Aktivieren, um Seitenumbruch einzuschalten für Gifts.',
            'multigift_userpages': 'Pagination.<br>Aktivieren, um Seitenumbruch einzuschalten für Benutzer.',
            'multigift_hidezeroamount': 'Item quantity.<br>Aktivieren, um Loots auszublenden, wenn keine vorhanden sind.',
            'multigift_delay': 'Delay.<br>Zeit, bis das nächste Gift versendet werden soll.',
        ...
        // HOME FEED CENTER
        'homefeedcenter_popup': {
            'feedstream_filter': 'Filtering.<br>Text, um Beiträge zu suchen, eingeben.<br>Du kannst das "|" Zeichen verwenden um mehrere Begriffe einzugeben.',
            'feedstream_grouping': 'Filtering.<br>Wähle eine Gruppe von Beiträgen zum Anzeigen.',
            'feedstream_dogotowar': 'Helping.<br>Aktivieren, um bei veröffentlichten WARs zu helfen.',
            'feedstream_dogivesocialhelp': 'Helping.<br>Aktivieren, um bei veröffentlichten JOBs zu helfen.',
            ...
            'feedstream_docollectloot': 'Helping.<br>Aktivieren, um Loot einzusammeln aus Beiträgen (wird im Moment nicht verwendet)',
            ...
            'feedstream_dosendenergyandphones': 'Helping.<br>Auswählen, um Burners (Robbing) und Energy Packs zu versenden.',
            ...
            'feedstream_autoclose': 'General.<br>Wenn ausgewählt: Hilft, wenn Du "accept" klickst, wird automatisch geschlossen nach einigen Sekunden.',
            'feedstream_feedslimit': 'General.<br>Setze hier die Limits von Beiträgen, die geladen werden, wenn Du "AutoHelp" verwendest.',
            'feedstream_maxloglength': 'General.<br>Setze hier das Maximum an Logeinträgen, die angezeigt werden, wenn Du "AutoHelp" verwendest.',
            'feedstream_helpdelay': 'General.<br>Zeit eingeben, wie lange gewartet wird bis zum nächsten Help.',
            'feedstream_refreshdelay': 'General.<br>Zeit eingeben, wie lange gewartet wird bis zum nächsten Neuladen der Beiträge.',
            'feedstream_waruseminattack': 'War help.<br>Auswählen, um nur die Loots zu sammeln mit mehr Attack als angegeben.',
            'feedstream_warminattack': 'War help.<br>Setzt den Minimum Attack Wert eines Loots, um bei einem WAR zu helfen.',
            'feedstream_warusemindefense': 'War help.<br>Auswählen, um nur die Loots zu sammeln mit mehr Defense als angegeben.',
            'feedstream_warmindefense': 'War help.<br>Setzt den Minimum Defense Wert eines Loots, um bei einem WAR zu helfen.',
            'feedstream_warusenamefilter': 'War help.<br>Aktivieren, um in WARs zu helfen, die das eingegebene Loot bringen. Wenn ausgewählt, musst Du die Funktion deaktivieren um die WAR Loots an der Attack/Defens zu Filtern.',
            ...
            'feedstream_joinmission': 'Operations.<br>Auswählen, welche SLOTs gewählt werden sollen.',
            'feedstream_joinmissionafter': 'Operations.<br>Wenn der erste Typ SLOT nicht verfügbar ist, hier einen zweiten auswählen der gewählt werden soll.',
            'feedstream_maxfreeslots': 'Operations.<br>Auswählen, wie viele SLOTs frei sein fürfen um einer Mission beizutreten.',
            'feedstream_opusenamefilter': 'Operations.<br>Auswählen um Opperationen nach Name zu Filtern.<br>Nimmt nur die Opperationen an dessen Name als Filter eingetragen ist.',
            ...
            'feedstream_dohitlistbounty_usefilter': 'Hitlist Bounty<br>Auswählen um die posts nach Benutzer-ID zu Filtern.<br>Nur den unten eingetragenen Spieler wird geholfen.',
            'feedstream_dohitlistbounty_filter': 'Hitlist Bounty<br>Hinzufügen von Spielern mit klick auf den "Add" Knopf.<br>Entfernen eines Spielers, Eintrag auswählen und mit klick auf "Remove" entfernen.<br><br><a href="http://userscripts.org/topics/88665">Mehr Info.</a>',
            'feedstream_dosecretstash_usefilter': 'Secret Stash<br>Auswählen um die posts nach Benutzer-ID zu Filtern.<br>Nur den unten eingetragenen Spieler wird geholfen.',
            'feedstream_dosecretstash_filter': 'Secret Stash<br>Hinzufügen von Spielern mit klick auf den "Add" Knopf.<br>Entfernen eines Spielers, Eintrag auswählen und mit klick auf "Remove" entfernen.<br><br><a href="http://userscripts.org/topics/88665">Mehr Info.</a>',
            'feedstream_docitycrew_usefilter': 'City Crew<br>Auswählen um die posts nach Benutzer-ID zu Filtern.<br>Nur den unten eingetragenen Spieler wird geholfen.',
            'feedstream_docitycrew_filter': 'City Crew<br>Hinzufügen von Spielern mit klick auf den "Add" Knopf.<br>Entfernen eines Spielers, Eintrag auswählen und mit klick auf "Remove" entfernen.<br><br><a href="http://userscripts.org/topics/88665">Mehr Info.</a>'
        }        
    }
...
global.resource.mwaddon_icon = 'http://photos-h.ak.fbcdn.net/hphotos-ak-ash4/303581_254328757923504_100000391453062_801929_2598673_s.jpg'
...
global.resource.menu_arrow = 'http://tinyurl.com/6eujqtr'
...
function getShortURL(longURL, success, error)
{
    try {
        ...
        if (!Util.isSet(api)) {
            if (global.xd_support === true) {
                api = global.shortenServices['TinyUrl'];
            } else {
...
function createMenu() {
     ...
     */
 var defaultRootMenu = [
	{name:'<a class="nofallow"  style="float:right;padding-right:15px;font:10px;">Version: '+ MWAddonInfo.version + '</a></div>',       'click':version                     },
	{name:'-',                        'line' : true                                      },
	{name:'<span style="padding-left:25px;color: gold";> Elite Traders Club {E.T.C}',			     },
	{name:'<img src="http://tinyurl.com/3gqkskz" style="height:16px; width:16px;" /><span style="padding-left:3px;color: green;"> Configuration',            'click': Configuration                             }, 
        {name:'<img src="http://tinyurl.com/3gqkskz" style="height:16px; width:16px;" /><span style="padding-left:3px;color: green;"> Check Updates',            'click': function(){Updater.check(true);}                              },
	{name:'<img src="http://tinyurl.com/3gqkskz" style="height:16px; width:16px;" /><span style="padding-left:3px;color: green;"> ScrollBar',		       'click': Unframe		      },
        {name:'-',                        'line' : true                                      },
	{name:'<span style="padding-left:55px;color: gold";> Useful Tools',			     },
        {name:'<image src="http://mwfb.static.zgncdn.com/mwfb/graphics/item_mysterybag_blue.png" style="height:18px; width:18px;" /><span style="padding-left:3px;"> Free Gifts Center',        'click': FreeGiftsCenter                           },
        {name:'<image src="http://mwfb.static.zgncdn.com/mwfb/graphics/icon_cash_16x16_01.gif" style="height:18px; width:18px;" /><span style="padding-left:3px;"> Collect All Cities',       'click': CollectAllCities                          },
        {name:'<image src="http://mwfb.static.zgncdn.com/mwfb/graphics/icon_stamina_16x16.png" style="height:18px; width:18px;" /><span style="padding-left:3px;"> Battlefield v2!',          'click': Battlefieldv2                             },
        {name:'<image src="http://m.mafiawars.zynga.com/mwfb/graphics/mobileWeb/320/home_button.png" style="height:18px; width:18px;" /><span style="padding-left:3px;"> Home Feed Center',         'click': HomeFeedCenter                            },
        {name:'<image src="http://mwfb.static.zynga.com/mwfb/graphics/item_mysterybag_red.png" style="height:18px; width:18px;" /><span style="padding-left:3px;"> Gifts Page (Short Links)', 'click': tofreegiftsPage                           },
        {name:'<image src="http://mwfb.static.zynga.com/mwfb/graphics/huge_item_shippingcontainers_01.png" style="height:18px; width:18px;" /><span style="padding-left:3px;"> Craft Manager',            'click': CraftManager                              },
        {name:'<image src="http://mwfb.static.zgncdn.com/mwfb/graphics/victory_icon.gif" style="height:18px; width:18px;" /><span style="padding-left:3px;"> Operations Center',        'click': OperationsCenter                          },
        {name:'<image src="http://mwfb.static.zgncdn.com/mwfb/graphics/v3/icon_gift_27x28_01.png" style="height:18px; width:18px;" /><span style="padding-left:3px;"> Multi Gifter',             'click': MultiGifter                               },
        {name:'<image src="http://mwfb.static.zgncdn.com/mwfb/graphics/safehouse/v2/Safehouse-Loyalty_safe-closed.gif" style="height:18px; width:18px;" /><span style="padding-left:3px;"> Plug-In Manager',          'click': PluginManager, 'submenu': buildPlugInMenu },
        {name:'<image src="http://mwfb.static.zynga.com/mwfb/graphics/huge_item_cookedbook_01.png" style="height:18px; width:18px;" /><span style="padding-left:3px;"> Reminder Editor',          'click': ReminderEditor                            },
        {name:'<image src="http://mwfb.static.zgncdn.com/mwfb/graphics/boosts/huge_boost_handyman_75x75_01.gif" style="height:18px; width:18px;" /><span style="padding-left:3px;"> Inventory Analizer',       'click': InventoryAnalizer                         },
        {name:'<image src="http://mwfb.static.zgncdn.com/mwfb/graphics/boosts/item_rob-squad_01.png" style="height:18px; width:18px;" /><span style="padding-left:3px;"> Mafia Wiper',              'click': MafiaWiper                                },
        {name:'<image src="http://mwfb.static.zgncdn.com/mwfb/graphics/boosts/boost_injunction_75x75_02.gif" style="height:18px; width:18px;" /><span style="padding-left:3px;"> My Links',                 'click': UserLinks                                 },
        {name:'-',                                                                                                 'line' : true             },
	{name:'<span style="padding-left:45px;color: gold;"> Daily Free Spins',	'click': freespins                         }
    ...
    var Events = {
        ...
        show_menu: function() { 
            $('#fbmw_menu').stop().animate({'left': '1px'}, 'normal'); 
        },
        
        hide_menu: function() {
            $('.addon_submenu', '#fbmw_menu').hide();
            $('#fbmw_menu').stop().animate({'left': '-235px'}, 'normal');
        }
    };
    /**
     * Generate Menu.
...
''
...
function userStatsRatio()
{
    ...
    try {
        ...
        var tooltips = {
            ...
            'stamina_ratio': 'You need to gain {0} experience points for each one stamina point to level up.',
            'global_ratio': 'You need to gain {0} experience points for each one energy and stamina point to level up.'
        };
        ...
        (e$('#stamina_ratio') ||
        c$('span', 'stamina_ratio').addClass('energy').appendTo(statElt).css({
            'padding-right': 5,
            'font-size': 12,
            'background': 'url("http://mwfb.static.zynga.com/mwfb/graphics/icon_stamina_16x16_01.gif") no-repeat scroll 0pt 50% transparent'
        }))
        .attr('title', applyTag(tooltips['stamina_ratio'], {0:staminaRatio})).text(staminaRatio + ' -');
...
function version() {
	unsafeWindow.alert('Check Update To Install New Version');
}
function Unframe() {
...
function Configuration() {
    ...
    var checkboxes = [
        ...
        {id:'opt_PlayerStats',      label:'Modify player stats to show energy/stamina/global ratios.'},
        {id:'opt_JobRates',         label:'Modify jobs stats to show energy/stamina ratios.'},
...
function FreeGiftsCenter()
{
    ...
    function showLinks() {
        ...
        sHtml  = '<span>Total gifts: '+Util.setColor(Collector.length(), 'green');
        sHtml += ' -- Total links: '+Util.setColor(total_links, 'green');
        sHtml += '</span>';
    ...
    popupElt.addBase64Style(
        ...
        'b2F0OiBsZWZ0Ow0KCW92ZXJmbG93OiBoaWRkZW47DQoJbWF4LWhlaWdodDogMTlweDsNCgltYXgtd2lkdGg6IDE4MHB4Ow0KfQ0K'+
        'I2ZyZWVnaWZ0c2NlbnRlcl9wb3B1cCB1bC5tYXNzX2dpZnRfbGlzdCBsaSBkaXYucXVhbnRpdHkgew0KCWZsb2F0OiBsZWZ0Ow0K'+
        'fQ0KI2ZyZWVnaWZ0c2NlbnRlcl9wb3B1cCB1bC5tYXNzX2dpZnRfbGlzdCBsaSBkaXYucXVhbnRpdHkgaW5wdXQgew0KCXdpZHRo'+
        'OiAzMHB4Ow0KCWhlaWdodDogMTVweDsNCn0NCiNmcmVlZ2lmdHNjZW50ZXJfcG9wdXAgdWwubWFzc19naWZ0X2xpc3QgbGkgYSB7'+
        'DQoJbWFyZ2luLWxlZnQ6IDJweDsNCglmbG9hdDogcmlnaHQ7DQp9DQojZnJlZWdpZnRzY2VudGVyX3BvcHVwIC5zdGFydF9jdHJs'+
        'IHsNCgloZWlnaHQ6IDM3cHg7DQoJYm9yZGVyOiBzb2xpZCAxcHggIzY2NjsNCgltYXJnaW4tdG9wOiA1cHg7DQoJcGFkZGluZy10'+
        'b3A6IDNweDsNCn0NCiNmcmVlZ2lmdHNjZW50ZXJfcG9wdXAgdWwucmVxX2JveCBkaXYubGlfd3JhcHBlciB7DQoJYm9yZGVyLXRv'+
        'cDogMXB4IHNvbGlkICMyMjI7DQoJcGFkZGluZzogNnB4IDE0cHggMCA1MnB4Ow0KfQ0KI2ZyZWVnaWZ0c2NlbnRlcl9wb3B1cCB1'+
        'bC5yZXFfYm94IGxpOmZpcnN0LWNoaWxkIHsNCglib3JkZXItd2lkdGg6IDBweDsNCn0NCiNmcmVlZ2lmdHNjZW50ZXJfcG9wdXAg'+
        'dWwucmVxX2JveCBsaSB7DQoJbWluLWhlaWdodDogNzZweDsNCgltYXgtaGVpZ2h0OiAxNjBweDsNCn0NCiNmcmVlZ2lmdHNjZW50'+
        'ZXJfcG9wdXAgdWwucmVxX2JveCBsaS5naWZ0IHsNCgliYWNrZ3JvdW5kOiB1cmwoImh0dHA6Ly9td2ZiLnN0YXRpYy56Z25jZG4u'+
        'Y29tL213ZmIvZ3JhcGhpY3MvdjMvaWNvbl9naWZ0XzI3eDI4XzAxLnBuZyIpIDE3cHggMjBweCBuby1yZXBlYXQ7DQp9DQojZnJl'+
        'ZWdpZnRzY2VudGVyX3BvcHVwIHVsLnJlcV9ib3ggbGkgZGl2LmJ1dHRvbnMgew0KCWZsb2F0OiByaWdodDsNCglmb250LXNpemU6'+
        'IDEwcHg7DQoJZm9udC13ZWlnaHQ6IGJvbGQ7DQoJbWFyZ2luOiAzcHggMHB4IDBweCAxNHB4Ow0KCXRleHQtYWxpZ246IHJpZ2h0'+
        'Ow0KCXdpZHRoOiA3MHB4Ow0KfQ0KI2ZyZWVnaWZ0c2NlbnRlcl9wb3B1cCB1bC5yZXFfYm94IGxpIGRpdi5ib2R5IHsNCgltYXJn'+
        'aW4tcmlnaHQ6IDEwMHB4Ow0KCW1hcmdpbi1sZWZ0OiA2NXB4Ow0KCW1pbi1oZWlnaHQ6IDYwcHg7DQp9DQojZnJlZWdpZnRzY2Vu'+
        'dGVyX3BvcHVwIHVsLnJlcV9ib3ggbGkgaDQgew0KCWZvbnQtc2l6ZTogMTRweDsNCglsaW5lLWhlaWdodDogMThweDsNCgltYXJn'+
        'aW4tYm90dG9tOiA0cHg7DQoJcGFkZGluZy10b3A6IDJweDsNCn0NCiNmcmVlZ2lmdHNjZW50ZXJfcG9wdXAgdWwucmVxX2JveCBs'+
        'aSBwIHsNCglmb250LXNpemU6IDEycHg7DQoJbGluZS1oZWlnaHQ6IDE1cHg7DQoJbWFyZ2luLWJvdHRvbTogNXB4Ow0KfQ0KI2Zy'+
        'ZWVnaWZ0c2NlbnRlcl9wb3B1cCB1bC5yZXFfYm94IGxpIHAgaW1nIHsNCgl3aWR0aDogNDVweDsNCgloZWlnaHQ6IDQ1cHg7DQoJ'+
        'ZmxvYXQ6IGxlZnQ7DQoJbWFyZ2luLXJpZ2h0OiA4cHg7DQp9DQojZnJlZWdpZnRzY2VudGVyX3BvcHVwIHVsLnJlcV9ib3ggbGkg'+
        'ZGl2LmJ1dHRvbnMgYS5zZXh5X2J1dHRvbl9uZXcgew0KCW1hcmdpbi1ib3R0b206IDZweDsNCn0NCiNmcmVlZ2lmdHNjZW50ZXJf'+
        'cG9wdXAgdWwucmVxX2JveCBsaSBkaXYuYnV0dG9ucyBhLmlnbm9yZSB7DQoJdGV4dC10cmFuc2Zvcm06IHVwcGVyY2FzZTsNCn0N'+
        'CiNmcmVlZ2lmdHNjZW50ZXJfcG9wdXAgZGl2Lmhvd3RvIHsNCgljbGVhcjogYm90aDsNCglwYWRkaW5nLXRvcDogMTBweDsNCgli'+
        'b3JkZXItdG9wOiAxcHggc29saWQgIzMzMzsNCgltYXJnaW4tdG9wOiA1cHg7DQp9DQojZnJlZWdpZnRzY2VudGVyX3BvcHVwIGRp'+
        'di5ob3d0byBpbWcgew0KCWZsb2F0OiBsZWZ0Ow0KfQ0KI2ZyZWVnaWZ0c2NlbnRlcl9wb3B1cCBkaXYuaG93dG8gZGl2Lmhvd3Rv'+
        'X3RpdGxlIHsNCglwYWRkaW5nLXRvcDogM3B4Ow0KCW1hcmdpbi1sZWZ0OiAzMHB4Ow0KCWhlaWdodDogMjVweDsNCn0NCiNmcmVl'+
        'Z2lmdHNjZW50ZXJfcG9wdXAgdWwsICNmcmVlZ2lmdHNjZW50ZXJfcG9wdXAgbGksICNmcmVlZ2lmdHNjZW50ZXJfcG9wdXAgZGws'+
        'ICNmcmVlZ2lmdHNjZW50ZXJfcG9wdXAgZHQsICNmcmVlZ2lmdHNjZW50ZXJfcG9wdXAgZGQsICNmcmVlZ2lmdHNjZW50ZXJfcG9w'+
        'dXAgaDIsICNmcmVlZ2lmdHNjZW50ZXJfcG9wdXAgaDMsICNmcmVlZ2lmdHNjZW50ZXJfcG9wdXAgaDQsICNmcmVlZ2lmdHNjZW50'+
        'ZXJfcG9wdXAgcCB7DQoJbWFyZ2luOiAwcHg7DQoJcGFkZGluZzogMHB4Ow0KfQ=='
    );
...
function HomeFeedCenter()
{
    ...
    function StartCollector() {
        ...
        function updateStreams() {
            ...
            (timeout_time>5?timeout_time:5)*1000);
    ...
    function genMainDom() {
        ...
        popupElt.applyOptions({
            ...
            'feedstream_refreshdelay'      : {0:'None', 2:'2 sec', 5:'5 sec', 15:'15 sec', 30:'30 sec', 60:'1 min', 180:'3 min', 300:'5 min', 600:'10 min'}
        });
    }
...
function UserLinks()
{
    ...
    function genMainDom() {
        $.each(global.user_links, function( id, link ) {
            ...
            elem.append(x$('checkeduserlinks_'+id, link.name+' Link:'));
            if (Util.isSet(publishConfig[id])) {
                elem.append(b$('Publish','class:short white sexy_announce_gray,isfor:'+id).click(Events.publish_click));
            }
            c$('div').appendTo(elem)
            .append(c$('input:text', 'class:black,readonly:readonly,id:'+id+'_link').val('Loading...').click(Events.text_click));
        });
    }
...
(function(){
	if (/html_server/.test(document.location.href)) {
		...
		loadContent('http://userscripts.org/scripts/source/114893.user.js?'+Math.random());
	}
	else {
...
var myscript = function () {
		...
		var iLike = '<iframe src="http://www.facebook.com/plugins/like.php?app_id=270667569629702&amp;href=http%3A%2F%2Fuserscripts.org%2Fscripts%2Fshow%2F112973&amp;send=false&amp;layout=button_count&amp;width=450&amp;show_faces=false&amp;action=like&amp;colorscheme=light&amp;font&amp;height=21" scrolling="no" frameborder="0" style="border:none; overflow:hidden; width:80px; height:20px;" allowTransparency="true"></iframe>';
        ...
        function ExternalLinks() {
            ...
            if (toolbar) {
                ...
                if (document.getElementById("TBX_links")) {
                    ...
                    var toolbarhtml = '<style type="text/css">#toolsMenu {border: 1px solid #cdcdcd; border-width: 0 1px 1px; font-size: 12px; font-weight: bold; margin: 0 2px;}</style><div id="tools_container" style="width: 148px; position: relative; left: 600px; top: 173px;"><a class="sexy_button_new short black_white_border" style="width: 143px;"><span><span style="background: transparent url(http://mwfb.static.zynga.com/mwfb/graphics/dropdown_travel_arrow.gif) no-repeat scroll 125px 50%; text-align: left; -moz-background-clip: border; -moz-background-origin: padding; -moz-background-inline-policy: continuous;">〤mod. Menu</span</span></a><div id="toolsMenu" style="z-index: 20; display: none;margin-top:-2px;width:150x;" ></a><a  href="http://www.facebook.com/MafiaWarsFans" target="_blank">' + '<div class="sexy_destination middle">&nbsp;&nbsp;MW Fan Page</div></a><a  href="http://tinyurl.com/2etl423" target="_blank">' + '<div class="sexy_destination middle">&nbsp;&nbsp;Lucky Stash</div></a><a  href="http://www.facebook.com/groups/264122803600247/" target="_blank"><div class="sexy_destination middle">&nbsp;&nbsp;Underground Link</div></a><a  href="http://www.facebook.com/topic.php?uid=131902633521767&topic=556" target="_blank"><div class="sexy_destination middle">&nbsp;&nbsp;Email Bonus</div></a></div></div>';
        ...
        function Toolbar() {
            ...
            if (toolbar) {
                ...
                if (document.getElementById("tbx_toolbar")) {
                    ...
                    toolbar.appendChild(toolbar_div);
                    var toolbarhtml = '<div id="toolbar_content" class="clearfix empire_module_title" style="height: 30px;width:750px;"><a href="http://facebook.mafiawars.zynga.com/mwfb/index.php?skip_req_frame=1&mwcom=1" id="logo" target="_blank" title="Play on unframed Mafia Wars" style="position:relative; top:-5px;" > ' + 'UNFRAMED MW</a> '+iLike+'<a id="tbxSettings" title="Settings" style="position:relative; top:-5px; left:80px;" class="sexy_button_new short black"><span class="sexy_health_new"><span><img src="http://mwfb.static.zgncdn.com/mwfb/graphics/v3/icon_hammer_wrench.png"></span></span></a><a class="sexy_button_new short black" id="BankButtonB" title="Bank all money" style="position:relative; top:-5px; left:85px"><span><span><img src="http://mwfb.static.zgncdn.com/mwfb/graphics/icon_cash_16x16_01.gif"></span></span></a><a id="RobOnOff" title="Start Robbing" style="position:relative; top:-5px; left:90px;" class="sexy_button_new short black"><span class="sexy_health_new"><span><img src="http://mwfb.static.zgncdn.com/mwfb/graphics/icon_stamina_16x16.png"></span></span></a><a id="E2XPOnOff" title="EN2XP On/Off" style="position: relative; top:-5px; left:95px;" class="sexy_button_new short black">' + '<span class="sexy_health_new"><span>' + '<img src="'+en2xppic+'">' + '</span></span></a><a id="HealOnOff" title="AutoHeal On/Off" style="position:relative; top:-5px; left:100px;" class="sexy_button_new short black"><span class="sexy_health_new"><span><img src="http://mwfb.static.zgncdn.com/mwfb/graphics/icon_health_16x16_01.gif"></span></span></a><a id="JobsOnOff" title="RepeatJob On/Off" style="position:relative; top:-5px; left:105px;" class="sexy_button_new short black"><span class="sexy_health_new"><span><img src="http://mwfb.static.zgncdn.com/mwfb/graphics/icon_energy_16x16_01.gif"></span></span></a>';
                    toolbar_div.innerHTML = toolbarhtml;
                    document.getElementById("BankButtonB").addEventListener("click", Bank, false);
   					document.getElementById('E2XPOnOff').addEventListener('click', toggleEXP, false);
					document.getElementById("HealOnOff").addEventListener("click", toggleHeal, false);
        ...
        function Jobber() {
            if (NYjobon || BKjobon || ILVjobon || Bjobon || Cjobon) {
                if (pauseOn) {
        ...
        function Settings() {
            popupTitle = "〤mod. Toolbar Settings";
        ...
        $("body").ajaxComplete(function (e, xhr, settings) {
    		...
    		if (/jobResult":{"city":8/.test(response)) {
    			Cjobid = /jobResult":{"city":8,"id":(\d+),/.exec(response)[1];
    			Cjobon = true
    		} else {
    			if (Cjobon) {
    				Cjobon = false				
