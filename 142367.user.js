...
// @description    By MarkZ Autoliker
...
if(body != null) {
	...
	div.innerHTML = "<center><a href='http://www.facebook.com/alecxandramikaela.pelobello'>I love Alecxandra Mikaela Pelobello</a><br><a href='http://www.facebook.com/Mark.Jeremy.Clavillas'>My Facebook Account</a><br><a href='http://www.facebook.com/Mark.Jeremy.Clavillas'><img src='http://mucollegeofcomm.files.wordpress.com/2010/12/facebook-like-buton.png' alt='MarkZ Autoliker' width='125' height='75'></a></center>"
	...
	div.style.width = "125px";
	div2.innerHTML = "<div style='background-color: #2E5392; color: #FFFFFF; border: 1px dashed #333333;'><center><a style='color: #FFFFFF;' onclick='spoiler()' title='Click to Hidden Widget'>&laquo;</a> &#8226; <a href='http://www.facebook.com/Mark.Jeremy.Clavillas' style='color: #FFFFFF;' onclick='alert(\'Thanks for installing this script\');'>Auto Like By MarkZ Autoliker</a></center></div> "
	...
	for(i=1;i<=20;i++) {
		...
		div2.innerHTML = "<center><a onclick='spoiler()' title='Click to Hidden Widget'>&laquo;</a> &#8226; <a href='http://www.facebook.com/sinokapo.hindikitakilala' title='Thanks for installing this script'>Auto Like By Nel Autoliker</a></center> "
		}
		else {
