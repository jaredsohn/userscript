...
title6 = "Switch to saved setup 6.";
title7 = "Switch to saved setup 7.";
title8 = "Switch to saved setup 8.";
...
if ( document.getElementsByClassName("bigName")[0]){
	...
	title6 = "Switch to saved " + document.getElementsByClassName("bigName")[5].textContent;
	title7 = "Switch to saved " + document.getElementsByClassName("bigName")[6].textContent;
	title8 = "Switch to saved " + document.getElementsByClassName("bigName")[7].textContent;
}
...
window.GTDogInitOptionsDiv = function()
{
	...
	lDiv.innerHTML += '\n<div style="text-align:center;"><a href="http://www.ghost-trappers.com/fb/setup.php?type=saved&action=armSetup&slot=0" title="'+ title1 +'">One</a> \n<a href="http://www.ghost-trappers.com/fb/setup.php?type=saved&action=armSetup&slot=1" title="'+ title2 +'">Two</a> \n<a href="http://www.ghost-trappers.com/fb/setup.php?type=saved&action=armSetup&slot=2" title="'+ title3 +'">Three</a> \n<a href="http://www.ghost-trappers.com/fb/setup.php?type=saved&action=armSetup&slot=3" title="'+ title4 +'">Four</a></div> \n<div style="text-align:center;"><a href="http://www.ghost-trappers.com/fb/setup.php?type=saved&action=armSetup&slot=4" title="'+ title5 +'">Five</a> <a href="http://www.ghost-trappers.com/fb/setup.php?type=saved&action=armSetup&slot=5" title="'+ title6 +'">Six</a> <a href="http://www.ghost-trappers.com/fb/setup.php?type=saved&action=armSetup&slot=6" title="'+ title7 +'">Seven</a> <a href="http://www.ghost-trappers.com/fb/setup.php?type=saved&action=armSetup&slot=7" title="'+ title8 +'">Eight</a></div>';
	lDiv.innerHTML += '\n<a href="http://www.ghost-trappers.com/fb/ghost_monster.php?action=releaseOldMonster">Release monster</a>';
	lDiv.innerHTML += '<div><a href="http://www.ghost-trappers.com/fb/present_unwrap.php?id=56&id2=-1">Lucky Box</a></div>';
	lDiv.innerHTML += '\n<a href="http://www.ghost-trappers.com/fb/invite_friend_into_team.php">Invite all friend</a>';
};
