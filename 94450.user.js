...
// @description    Hide all images on your tumblr dash, until you mouseover them
...
(function(){
   ...
   var lock = 'data:image/png;base64,';
   var lockicon = 'data:image/png;base64,';

   var st = document.createElement('style');
   st.setAttribute('type','text/css');
   st.id = 'nsfwstyle';
   var opA;
   if (LS_getValue('tnsfw_State',0) == 0) {
      opA = 1;
   }
   else {
      opA = 0;
   ...
   **********************************/
   ...
   jQuery('.dashboard_nav_item .dashboard_subpages a[href^="/customize"]')
   ...
   jQuery('.video_thumbnail div:empty').live('mouseover', function() {
      ...
      if (LS_getValue('tnsfw_State',0)==1)
         jQuery(this).parent().find('.nsfwed').css('opacity','0');
   }); 

   jQuery('#nsfwctrl').click(function() {
      var state = 1-LS_getValue('tnsfw_State',0);
      LS_setValue('tnsfw_State',state);
      if (state == 0) {
         undoNSFW();
      }
      else {
   ...
   function doHide(item) {
      ...
      if (item.tagName == 'LI') {
         if (node.hasClass('notification')) {
            ...
            jQuery('img:not(.nsfwdone),embed.video_player:not(.nsfwdone),embed.photoset:not(.nsfwdone)',node).each(function(){
               var klass = "";
               var me = jQuery(this);
