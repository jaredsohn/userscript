...
// @name        Pokemons
// @namespace   gegh3gh3
// @include     http://www.pokemonsoulless.org/map.php*
// @version     1
// ==/UserScript==
...
function autoBattle() {
	try {
		...
		if (linkReturnToMap && linkReturnToMap.textContent.trim() == 'Return to the Map') {
			settings.data.nextBattle = new Date().getTime() + 7000;
