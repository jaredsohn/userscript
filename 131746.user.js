// ==UserScript==
// @name           Common Functions As275/MisticMar-Scripts
// @namespace      http://userscripts.org/scripts/show/131744
// @description    Common functions for INFO FARMERA
// @date           24.04.2012
// @version        1.0.01
// ==/UserScript==

const VERSIONfunctionFile = "1.0.01";
...
const STAT_SERVER = {"pl":"mff.i24.cc"};
const STAT_VIEW = {"de":"mff.i24.cc"}; // {"pl":"mff.i24.cc"};
const GAMEPAGES = {"pl":"wolnifarmerzy.pl"};
...
const sortObjFunctions = {
	...
	"productId":function(a,b){
		if(prodTyp[0][a[0]]==prodTyp[0][b[0]]){
			...
			return({"c":0,"v":1,"e":2,"o":3,"z":4}[prodTyp[0][a[0]]]-{"c":0,"v":1,"e":2,"o":3,"z":4}[prodTyp[0][b[0]]]);
		}
	}
};
