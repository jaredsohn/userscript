...
s+= "*{font-family:}\n";
s+= "a:link, a:active, a:visited {color:grey!important;font:bold 10px tahoma!important;}\n";
...
s+= "#topnav a {font:normal 11px tahoma;margin-left:3px;margin-right:3px;color:tahoma!important;}\n";
s+= "#topnav a:hover {font:normal 11px tahoma;margin-left:3px;margin-right:3px;color:orange!important;}\n";
s+= ".section {border:0px solid black!important;background-color:FFFFFF!important;padding:2px;}\n";
s+= ".heading, #splash_coolNewPeople h5.heading, .mar5 strong {font:normal 11px tahoma!important;color:black;border:1px solid black!important;display:inline;padding:0!important;background-color:FFFFFF!important;}\n";
