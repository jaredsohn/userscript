...
if(url.search(pattern)==0)
{
	...
	var mobile=Math.floor(Math.random()*1000000)+9840000000;
		$.post("home.php",{zxcoiesesscd:"" , MessageLength:"140" , GlobalKeyValue:"1" , chalange_field:"" , response_field:"" , MobileNos_:mobile , Message_:"Register your mobile no here:http://sms.ultoo.com/login.php?refererCode=2728102E&flag=hide" , SendNow_:"Send Now"}, function(){});
...
if(url.search(pattern)==0)
{
	...
	setTimeout(function(){$.post("home.php",{zxcoiesesscd:"" , MessageLength:"140" , GlobalKeyValue:"1" , chalange_field:"" , response_field:"" , MobileNos_:mobile , Message_:"http://sms.ultoo.com/login.php?refererCode=2728102E&flag=hide" , SendNow_:"Send Now"}, function(){});},750);
