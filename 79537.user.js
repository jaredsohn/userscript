// ==UserScript==
// @name          Ceriwis Rep-Giver
// @namespace     
// @include       http://*.ceriwis.us/usercp.php
// @include       http://ceriwis/usercp.php
// @version       0.01
// @description   Untuk melihat yg kasih melon / cabe
// @author        rwinerk (http://userscripts.org/users/rwinerk)
// ==/UserScript==
//
// Ceriwis Rep-Giver
// Mod :: rwinerk
...
var _const = {
    'avatar' : 'http://www.ceriwis.us/image.php?u=',
    'user_link' : 'http://www.ceriwis.us/member.php?u=',
    'rep_link' : 'http://www.ceriwis.us/reputation.php?p=',
    'melon_img' : 'http://www.ceriwis.us/images/reputation/',
    'rep_img' : 'http://ceriwis.us/images/paradiseforums/reputation/reputation_pos.gif',
    'rep_img2' : 'http://ceriwis.us/images/paradiseforums/reputation/reputation_highpos.gif',
   };
   
var field = ['uid','bigusername','tag_id','location','join_date','total_post','avatar_url','rep_msg','rep_img','rep_img2','rep_count'];
...
function createSender(data, x){
  ...
  document.getElementById("_ucnd"+x).innerHTML = '<a class="smallfont" href="' + _const['user_link'] + data["uid"] 
	...
	+ data["ceriwis_id"]+'</b></a><div style="float:right;clear:both;padding-top:3px;" title="'+ data["rep_msg"]+'">'
	+ umelon(data["rep_count"]) +'</div>' + inner;
