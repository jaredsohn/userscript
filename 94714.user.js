// ==UserScript==
// @name           UserBars PS [UPS] - MOD
// @namespace      editado por Koyote | uid=2755356580361810698
// @description    Script para facilitar o trabalho da Comunidade 109941116.
// @CFBT     www.orkut.com.br/Main#Community?cmm=109941116
// @include        *.orkut.*/Main#CommMsgs?cmm=109941116*
// @include        *.orkut.*/CommMsgs?cmm=109941116*
// @include        *.orkut.*/Main#CommMemberManage?cmm=109941116*
// @include        *.orkut.*/CommMemberManage?cmm=109941116*
// @include        *.orkut.*/Community?cmm=109941116*
// @include        *.orkut.*/Main#Community?cmm=109941116*
// ==/UserScript==
/*
+---------------------------------------------------------------------+
	...
	function captchaBAN(env) {
		...
		button.onclick = function() {
			if (document.getElementById("cs").value == "") alert("Esqueceu de digitar o captcha!");
				...
				ajax.open("POST", "CommMsgPost?cmm=109941116&tid=5562350615982365505", false);
	...
	function captchaONOFF(env, status) {
		...
		button.onclick = function() {
			if (document.getElementById("cs").value == "") alert("Esqueceu de digitar o captcha!");
				...
				var ajax = new XMLHttpRequest;
				env.cs = document.getElementById("cs").value;
				ajax.open("POST", "CommMsgPost?cmm=109941116&tid=5562351084133800769", false);
				ajax.setRequestHeader("Content-type", "application/x-www-form-urlencoded; charset=UTF-8");
				ajax.send(array_values(env));
