// coding: utf-8
// ==UserScript==
// @name	Empire Board Graphic AddOn(φασουλάδα)
// @namespace	Φασουλάδα
// @version	001
// @author      Φασουλάδα development team :)
// @description	Graphic add-on for Ikariam Empire Board(φασουλάδα) script
...
/**************************************************************************************************
Require "Ikariam Empire Board(φασουλάδα" scriptr priority than this add-on (see GreaseMonkey options)
http://userscripts.org/scripts/show/121623
**************************************************************************************************/
...
EmpireBoard.GraphicAddon.Apply_Styles = function()
	...
	#EmpireBoardArmy th.ship_submarine {background: url(skin/characters/fleet/40x40/ship_submarine_r_40x40.gif) no-repeat center 5px;}
	#EmpireBoardArmy th.ship_rocketship {background: url(skin/characters/fleet/40x40/ship_rocketship_r_40x40.gif) no-repeat center -2px;}
	#EmpireBoardArmy th.ship_paddlespeedship {background: url(skin/characters/fleet/40x40/ship_paddlespeedship_r_40x40.gif) no-repeat center -3px;}
	#EmpireBoardArmy th.ship_ballooncarrier {background: url(skin/characters/fleet/40x40/ship_ballooncarrier_r_40x40.gif) no-repeat center -1px;}
	#EmpireBoardArmy th.ship_tender {background: url(skin/characters/fleet/40x40/ship_tender_r_40x40.gif) no-repeat center -3px;}
