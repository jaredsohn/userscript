// ==UserScript==
// @name           Yahoo Hockey Farm Players Dynasty
// @namespace      http://glenncarr.com/greasemonkey
// @include        http://hockey.fantasysports.yahoo.com/hockey/7146*
...
var ELIGIBILITY_FOOTNOTE = '*Exceeds rookie eligibility requirements (>41 GP)';
...
function RookieEligibility( gamesStarted, gamesPlayed )
{
	...
	this.isEligible = function()
	{
		if ( this.gamesStarted ) 
			return ( this.gamesStarted <= 41 );
		else
			return ( this.gamesPlayed <= 41 );
	}
}
...
var FARM_ROSTERS_URL = "http://spreadsheets.google.com/pub?key=0ArHUB2OO6v-MdG1CU3FuV3k5WlJ6X3cwdm5CS242eXc&output=txt";
