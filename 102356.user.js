// ==UserScript==
// @name           Divertiringa! v3
// @namespace      Divertiringa!
// @description    Script para la comunidad Divertiringa!
// @include        *taringa.net/*
// @include        *taringa.net/comunidades/divertiringaoficial/*
// @include        *poringa.net/*
...
byClass('menuTabs').innerHTML += "<li id=\"tabbedWTF\" class=\"tabbed\">\n <a href=\"http://www.taringa.net/comunidades/divertiringaoficial/\" onclick=\"menu(\'Divertiringa! \', this.href);return false;\" title=\"Ir a la comunidad Divertiringa!\">Divertiringa! <img src=http://o2.t26.net/images/arrowdown.png\n\"\" alt=\"\" /></a>\n</li>";
