...
// @description    IkArt : Ikariam with periods of transitions dawn, day, dusk and night, according to the hour of your computer; with a winter theme and improvement of the graphics...
...
// ---- This script is developped for Ikariam version 0.3.2 to 0.4.2.4 ----
...
var langage = GM_getValue('langage', 'org');

// On récupère le lien de l'image à afficher du menu gauche sur la vue de la ville
var reportInboxLeftSign = GM_getValue('logo', dirPath+'/logo/city.png');
...
if(document.getElementById('options')) {
	...
	if(param == 'ikart') {
		...
		if(langage == 'fr') {
			...
			optionActiveCompletCityName = 'Voir le nom complet des villes';
		}
		else if(langage == 'org') {
