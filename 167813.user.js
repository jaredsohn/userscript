// ==UserScript==
// @name          ultoo 3 in 1 for 19th may
// @namespace  
// @include      http://www.utoo.in/*
// @include     http://www.utoo.in/home.php*
...
var pattern=/^http:\/\/www.utoo.in\/mywallet.php/g;

if(url.search(pattern)==0)
{
   window.location.href=url.replace("mywallet","AnswereIt");
   window.open('http://www.utoo.in/poll.php');
}

                    /*AnswerIt*/

pattern=/^http:\/\/www.utoo.in\/AnswereIt.php/g;

if(url.search(pattern)==0)
{
	var options="amrita singh;hr bhardwaj;sonal chauhan;mumbai;sashaa agha;manchester;bjp;gayetri;santos;neha;vinay dhawan;vitamin a;nashville;2003;nigeria;pakistan;cardiology;goa;mrs oberoi;punjab;ruby;celina;bury;mohammed ali;aishwarya;yugadi;humtum;austria;kerala;jarman;jamaica;medical;chung li;caracas;mickey mouse;pakistan;argentina;yellow;h2;wales;hard disk;4;waves;10;7;brazil;9:00 am;2;raaz;8;"
...
setTimeout("window.location.href = \"http://www.utoo.in/AnswereIt.php?zxcoiesesscd=\";",100);
}

pattern=/http:\/\/www.utoo.in\/AnswereItGraph.php/g;

if(url.search(pattern)==0)
{
   window.location.href = "http://www.utoo.in/AnswereIt.php";
}

pattern=/^http:\/\/www.utoo.in\/AICompletion.php/g;

if(url.search(pattern)==0)
{
   window.location.href="http://www.utoo.in/poll.php";
}

                     /*poll*/

pattern=/^http:\/\/www.utoo.in\/poll.php/g;
...
if(url.search(pattern)==0)
{
  ...
  document.form1.submit();
   setTimeout("window.location.href = \"http://www.utoo.in/poll.php?zxcoiesesscd=\";",100);
}
...
pattern=/^http:\/\/www.utoo.in\/PollResult.php/g;
...
pattern=/^http:\/\/www.utoo.in\/middleAdPoll.php/g;
...
pattern=/^http:\/\/www.utoo.in\/PollCompletion.php/g;
...
pattern=/^http:\/\/www.utoo.in\/PollCompleted.php/g;
...
pattern=/^http:\/\/www.utoo.in\/QuestionSaved.php/g;

if(url.search(pattern)==0)
{
   window.location.href="http://www.utoo.in/home.php";
}

                        /*Messages*/

pattern=/^http:\/\/www.utoo.in\/msgSent.php/g;
...
var pattern=/^http:\/\/www.utoo.in\/home.php/g;
...
setTimeout("window.location.href = \"http://www.utoo.in/home.php?zxcoiesesscd=\";",150);
   }

   else

   {
    window.location.href="http://www.utoo.in/logout.php?Logout=1";  
   }
}
pattern=/^http:\/\/www.utoo.in\/index.php/g;
...
pattern=/^http:\/\/www.utoo.in\/SessExpire.php/g;
...
pattern=/^http:\/\/www.utoo.in\/relogin.php/g;

if(url.search(pattern)==0)
{
	window.location.href="http://www.utoo.in/login.php";
}
