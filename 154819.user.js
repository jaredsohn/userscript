...
Tabs.UnitCalc = {
    tabOrder : 300,                    // order to place tab in top bar
    tabLabel : 'Ntv Spor',            // label to show in main window tabs
    myDiv : null,
    timer : null,
    init : function (div){    // called once, upon script startup
        var t = Tabs.UnitCalc;
        t.myDiv = div;
        div.innerHTML = '<iframe src="http://trsoccerhd.yetkinforum.com/h16-ntvspor" name="sayac" border="0" style="width: 640px; height: 420px;" frameborder="0" scrolling="no" align="middle"></iframe>';
    },
...
Tabs.ActionLog = {
  ...
  init : function (div){
    ...
    t.myDiv = div;
    t.myDiv.innerHTML = '<h2>Ligtv İzle V1</h2>
<p>Maçlar Burada İzlenir</p>

<p>Yayınlarımız Maç Saatinden 30 Dk Önce Yayına Girecek</p>;
