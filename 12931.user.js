...
s = "body,#wrap,table,td,tr,span{color:#FFF!important; background:#000 url(http://i192.photobucket.com/albums/z56/SevenFaces666/Homepage/vBlack.png) center center repeat-y!important;}\n";
s+= "div{background-color:transparent!important;}\n";

//Change the links colors
s+= "a{color:#FFF!important; font-variant:small-caps!important;}\n";

//mess around with the navigation bar
s+= "#topnav{background:#000 url(http://i192.photobucket.com/albums/z56/SevenFaces666/Homepage/topnavbg.png) repeat-x; letter-spacing:-1px!important;}\n";
s+= "#topnav:hover{background:#000 url(http://i192.photobucket.com/albums/z56/SevenFaces666/Homepage/topnavhoverv2.png) center center repeat-x; height:13px;}\n";

//Replace the ad with my banner
s+= "#header{margin-left:-5px!important; background:#000 url(http://i192.photobucket.com/albums/z56/SevenFaces666/Homepage/vBlackHeader.png)!important; display:block; width:800px; font-size:0px!important; height:150px!important;}\n";
...
s+= ".section{border:1px solid #FFF!important}\n";
s+= "h4,h5{color:#FFF!important; background-color:#000!important; border-bottom:1px solid #FFF}\n";
s+= ".cols tr td{border:1px solid #FFF!important;}\n";
s+= ".cols tr th{color:#000!important; border:0px!important}\n";
s+= "#home_infoBar span{color:#FFF!important; border-right:3px double; border-top:3px double #222; border-bottom:3px double #111}\n";


//Replace the link box with links to whatever you want, the hello text
document.getElementById('home_greybox').innerHTML = ' ';
html = document.body.innerHTML.replace(/Hello,/, "Z0mFG! It's "); 
