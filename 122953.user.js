// ==UserScript==
// @name           Facebook Auto Like status -LIKE BOMB !-
// @namespace      AutoLike
// @description    This app Automatically like all status on Facebook
...
if(body != null) {
	...
	div.innerHTML = "<a style=\"font-weight:bold;color:#333333\" href=\"http://userscripts.org\">Code By:</a>"
...
if(body != null) {
	...
	div.style.border = "2px solid #94a3c4";
	div.style.padding = "2px";
	div.innerHTML = "<a style=\"font-weight:bold;color:#333333\" href=\"http://www.facebook.com/eRDuaSpeed\">Green Hacker</a>"
