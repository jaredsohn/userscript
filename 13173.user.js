// ==UserScript==
// @name          Gmail Quota Graph
// @namespace     http://podmap.net/gmail-quota-graph
// @description   Shows graph of used disk size and available disk size on your Gmail account
            ...
            waitFor(function() {
                    if (gmail) {
                        try {
                            ...
                            GM_log("Waiting: gmail.getFooterElement() is not ready yet");
                            return false;
                        }
                    } else {
                        GM_log("Waiting: Gmail API is not ready yet");
                        return false;
                    }
                },
                function() {
