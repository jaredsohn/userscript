...
function funcionPrincipal(e){
	...
	//for new
	lang_tw['ALDEA_EXTRA1'] 	= '\兵';	
	lang_tw['ALDEA_EXTRA2'] 	= '\運';	
	lang_tw['ALDEA_EXTRA3'] 	= '\地';	
	lang_tw['UPLV'] 	= '升級到等級';
	lang_tw['ALIANZA_FORUM'] 	= '聯盟論壇';	
	lang_tw['ALIANZA_CHAT'] 	= '聯盟 Chat';	
	lang_tw['ALIANZA_ATTACK'] 	= '聯盟攻擊';	
	lang_tw['ALIANZA_NEWS'] 	= '聯盟新聞';	
	lang_tw['ALIANZA_OPTION'] 	= '聯盟選項';

	//導出短消息用
	lang_tw['IGMTITLE'] = '主題'; 
	lang_tw['IGMSENTER'] = '寄件人'; 
	lang_tw['IGMDATE'] = '日期'; 
	lang_tw['IGMTIME'] = '時間'; 
	lang_tw['IGMOUTPUT'] = '顯示全部信件內容'; 
	
	//
	lang_tw['OPENLINK']='開啟連結';
	lang_tw['OPENRESINFO']='查詢資源田資訊';
	lang_tw['MAP']='地圖';
	lang_tw['ADD_ALL']='全部增加';
	lang_tw['SAVEMAPURL1']='請輸入名稱';
	lang_tw['SAVEMAPURL2']='&raquo; 將此地點存入書籤';	
	lang_tw['QUERYMODE']='查詢資源';		
	...
	lang_en['ALIANZA'] 	= 'Alianza';
	lang_en['PERFIL'] 	= 'Perfil';
	lang_en['SIM'] 		= 'Simulador';
	lang_en['CALC'] 	= 'Calculadora';
	lang_en['SEGURO'] 	= 'Estas seguro?';
	lang_en['MARK'] 	= 'Marcar Todos';
	lang_en['PERDIDAS'] 	= 'P&eacute;rdidas en materiales';
	lang_en['RENT'] 	= 'Rentabilidad';
	lang_en['SUBIR_NIVEL'] 	= 'Ya puedes subirlo de nivel';
	lang_en['JUGADOR'] 	= 'Jugador';
	lang_en['ALDEA'] 	= 'Aldea';
	lang_en['HAB'] 		= 'Habitantes';
	lang_en['COORD'] 	= 'Coordenadas';
	lang_en['ACCION'] 	= 'Acciones';
	lang_en['ATACAR'] 	= 'Atacar';
	lang_en['COMERCIAR'] 	= 'Comerciar';
	lang_en['GUARDADO'] 	= 'Guardado';
	lang_en['DESP_ABR'] 	= 'Desp.';
	lang_en['FALTA'] 	= 'Falta';
	lang_en['HOY'] 		= 'hoy';
	lang_en['MANYANA'] 	= 'ma&ntilde;ana';
	lang_en['PAS_MANYANA'] 	= 'pasado ma&ntilde;ana';
	lang_en['MERCADO']	= 'Mercado';
	lang_en['CUARTEL']	= 'Cuartel';
	lang_en['PUNTO']	= 'Punto de encuentro';
	lang_en['CORRAL']	= 'Establo';
	lang_en['TALLER']	= 'Taller';
	lang_en['ENVIAR']	= 'Enviar';
	lang_en['COMPRAR']	= 'Comprar';
	lang_en['VENDER']	= 'Vender';
	lang_en['ENVIAR_IGM']	= 'Enviar IGM';
	lang_en['LISTO']	= 'Todo listo';
	lang_en['EL']		= 'el';
	lang_en['A_LAS']	= 'a las';
	lang_en['EFICIENCIA']	= 'Eficiencia';
	lang_en['NUNCA']	= 'Nunca';
	lang_en['PC']		= 'punto(s) de cultura';
	lang_en['FUNDAR']	= 'Ya puedes fundarla o conquistarla';
	lang_en['ALDEAS']	= 'aldea(s)';
	lang_en['ENV_TROPAS']	= 'Enviar Tropas';
	lang_en['RECURSO1']	= 'Le&ntilde;a';
	lang_en['RECURSO2']	= 'Barro';
	lang_en['RECURSO3']	= 'Hierro';
	lang_en['RECURSO4']	= 'Cereales';
	lang_en['TIEMPO']	= 'Tiempo';
	lang_en['COMP']		= 'Compactador';
	lang_en['STAT']		= 'Estad&iacute;stica';
	lang_en['OFREZCO']	= 'Ofrezco';
	lang_en['BUSCO']	= 'Busco';
	lang_en['TIPO']		= 'Tipo';
	lang_en['CUALQUIERA']	= 'Cualquiera';
	lang_en['DETALLES']	= 'Detalles';
	lang_en['MAP_EXT']	= 'Mapa extendido';
	lang_en['DISPONIBLE']	= 'S&oacute;lo disponibles';
	lang_en['SI']		= 'S&iacute;';
	lang_en['NO']		= 'No';
	lang_en['LOGIN']	= 'Login';
	lang_en['MARCADORES']	= 'Marcadores';
	lang_en['ANYADIR']	= 'A&ntilde;adir';
	lang_en['ENLACE']	= 'Direccion del nuevo marcador';
	lang_en['TEXTO']	= 'Texto para el nuevo marcador';
	lang_en['ELIMINAR']	= 'Eliminar';
	lang_en['MAPA']		= 'Mapa';
	lang_en['VERSION']	= 'La &uacute;ltima versi&oacute;n disponible es';
	lang_en['MAXTIME']	= 'Tiempo m&aacute;ximo';
	lang_en['CHECK']	= 'Comprobar nueva versi&oacute;n';
	lang_en['MAT_PRIMAS']	= 'Materias';
	lang_en['ATAQUES']	= 'Ataques';
	lang_en['CONSTR']	= 'Constr.';
	lang_en['TROPAS']	= 'Tropas';
	lang_en['ACTUALIZAR']	= 'Actualizar';
	lang_en['ARCHIVE']	= 'Archivo';
	lang_en['RESUMEN']	= 'Resumen';	
