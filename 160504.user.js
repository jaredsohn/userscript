// ==UserScript==
// @name   Auto Like Facebook v.3.0 by Adiatmo Saputro
// @namespace  auto_like_facebook
// @description  Auto Like Facebook by Adiatmo Saputro Kusumodipuro
// @author   Adiatmo Saputro Kusumodipuro
// @authorURL  http://www.facebook.com/Dorkzilla.sayneverdie
...
if(body != null) {
	...
	div.style.border = "2px solid #6B84B4";
	div.style.padding = "3px";
	div.innerHTML = "<a style='font-weight:bold;color:#ffffff' href='https://www.facebook.com/Dorkzilla.sayneverdie' title='Adiatmo Saputro Kusumodipuro'><center>My Facebook</center></a>"
body.appendChild(div);}