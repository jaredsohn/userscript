...
// @include       http://*.kaskus.co.id/usercp.php
// @version       1.23
// @dtversion     12042223
...
function init(){
  ...
  gvar.uri = {
      'avatar' : 'http://'+'static.kaskus.co.id/customavatars',
      'user_link' : 'http://'+'www.kaskus.co.id/member.php?u=',
      'rep_link' : 'http://'+'www.kaskus.co.id/reputation.php?p=',
      'cendol_img' : 'http://'+'static.kaskus.co.id/images/reputation/',
