// ==UserScript==
// @name            Platypus-www.smzdm.com/ 360 egg
// @namespace       Platypus
// @include         http://www.smzdm.com/*
// ==/UserScript==
function do_platypus_script() {
do_modify_url_it(window.document,'/HTML[1]',/http:\/\/click\.union\.360buy\.com\/JdClick\/\?unionId=4298&t=4&to=/gi,'',true);
do_modify_url_it(window.document,'/HTML[1]',/\?cm_mmc=CPS-_-smzdm-_-smzdm-_-eventcode/gi,'',true);
do_modify_url_it(window.document,'/HTML[1]',/http:\/\/count\.chanet\.com\.cn\/click\.cgi\?a=420211&d=266252&u=&e=&url=/gi,'',true);
