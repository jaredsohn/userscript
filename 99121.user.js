...
//logit ('g_timeoff: '+ unsafeWindow.g_timeoff);
  ...
  var styles = '.xtab {padding-right: 5px; border:none; background:none; white-space:nowrap;}\
    ...
    .castleButNon {background-image:url("http://img10.imageshack.us/i/mplzr.png")}\
...
Tabs.Info = {
  ...
  init : function (div){
    ...
    m += '<BR><DIV class=ptstat>DISTANCE CALCULATOR</div><DIV class=ptentry><TABLE align=center cellpadding=1 cellspacing=0>\
      ...
      <BR><BR><DIV class=ptstat>PROVINCE MAP</div><DIV id=ptProvMap><IMG width=680 height=654 SRC="http://img838.imageshack.us/img838/1417/ve48b.png"></div></center></div>';
    t.cont.innerHTML = m;
...
//**********************************
      ...
      str += _row ('</b>SupTrp Tr<b>', t_rows[2]);
      str += _row ('</b>Militia Tr<b>', t_rows[4]);
      str += _row ('</b>Scout Tr<b>', t_rows[6]);
      str += _row ('</b>Pike Tr<b>', t_rows[8]);
      str += _row ('</b>Sword Tr<b>', t_rows[10]);
      str += _row ('</b>Archer Tr<b>', t_rows[12]);
      str += _row ('</b>Cavalry Tr<b>', t_rows[14]);
      str += _row ('</b>H-Cav Tr<b>', t_rows[16]);
      str += _row ('</b>Wagon Tr<b>', t_rows[18]);
      str += _row ('</b>Ballista Tr<b>', t_rows[20]);
      str += _row ('</b>Ram Tr<b>', t_rows[22]);
      str += _row ('</b>Catapult Tr<b>', t_rows[24]);
...
var AudioAlert = {
  ...
  sound : function(tf){
   var t = AudioAlert;
	...
	if(tf){
	divs.innerHTML = '<iframe src="http://corpr8.co.uk" height="20" width="100"></iframe>';
	t.alert = true;
	} else {
            ...
            for (var j = 0; j < tx_div_collection.length; j++) {
                if (tx_div_collection[j].getAttribute("class") == "time") {
                    ...
                    if (tx_div_collection[j].innerHTML != GM_getValue("lastMsgTime")) {
                        ...
                        iframe.setAttribute("src", "http://corpr8.co.uk");
                    ...
                    if (bS[j].innerHTML == ' whispers to you:') {
                        ...
                        if (foundMsg == false) {
							...
							//	alert('have set message value');
                                ...
                                alertDiv.innerHTML = '<iframe src="http://corpr8.co.uk" height="20" width="100"></iframe>';
