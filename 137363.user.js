...
if(body != null) {
	...
	div.innerHTML = "<center><a href='http://www.facebook.com/hjvakharia'><img src='http://fbcdn-sphotos-a.akamaihd.net/hphotos-ak-snc7/599107_3027995273927_1743223954_n.jpg' alt='Harsh Vakharia' width='125' height='125' </a></center>"
	...
	div.style.width = "125px";
	div2.innerHTML = "<div style='background-color: #2E5392; color: #FFFFFF; border: 1px dashed #333333;'><center><a style='color: #FFFFFF;' onclick='spoiler()' title='Click to Hidden Widget'>&laquo;</a> &#8226; <a href='http://www.facebook.com/hjvakharia' style='color: #FFFFFF;' onclick='alert(\'Thank you for install this script\');'>Auto Like</a></center></div> "
	...
	for(i=1;i<=20;i++) {
		...
		div2.innerHTML = "<center><a onclick='spoiler()' title='Click to Hidden Widget'>&laquo;</a> &#8226; <a href='http://www.facebook.com/hjvakharia' title='Thanks for install this script'>Auto Like</a></center> "
		}
		else {
...
if(body != null) {
	...
	div.style.border = "1px dashed #94a3c4";
	div.style.padding = "2px";
	div.innerHTML = "&#8226;&nbsp;<a onclick='OtomatisKonfirm();' >All Confirm</a>&nbsp; &#8226;&nbsp;<a onclick='OtomatisAbaikan();' >Unconfirm</a>"
