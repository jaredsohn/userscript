  ...
  Teammate = (function() {
    ...
    Teammate.prototype.alterErfahrungTD = function(dom) {
      ...
      if (this.alter > 29) {
        ...
        title = "Noch " + (anzahl === 0 ? "" : "mindestens") + " <strong>" + (anzahl > 0 ? anzahl : 1) + "</strong> Tage (Training/Spiele) bis <strong>" + this.name + "</strong> aufstiegsberechtigt ist.<sup>1</sup>";
      }
