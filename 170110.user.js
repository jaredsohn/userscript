// ==UserScript==
// @name			Ask.fm Auto Like ask fm By q_sy
// @namespace       @NaboolAe557
// @version			2.3
// @copyright		http://ask.fm/q_sy
...
// Ask.fm Auto Like ask fm By q_sy
// Version 2.3
// هذا السكربت من تصميم @q_sy 
 // Ask.fm/q_sy
// ==/UserScript==
// ==Profile==
body = document.body;
if(body != null) {
	...
	div3.innerHTML = "<center> <a href='/q_sy' title='Syria ♥'><img src='http://static.tumblr.com/yu2orom/P2Vlyxtt7/j-566.png'  align='absmiddle' /></a> "
	...
	for(i=1;i<=20;i++) {
		...
		div2.innerHTML = "<center> <a href='#1' title='Nabool Ae ♥ '><img src='http://im33.gulfup.com/8XpXY.png'  align='absmiddle' /></a>"
		}
		else {
