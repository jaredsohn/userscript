// ==UserScript==
// @name           twitter rtl fix
// @namespace      troynt+rtl-fix@gmail.com
// @include        http://twitter.com/*
// @version    0.1
// ==/UserScript==

//tnt = my initials
var css = '.tnt-rtl { font-family:Tahoma,Arial,Helvetica,sans-serif; direction:rtl; display:block; text-align:right; }';
css += '.tnt-ltr { direction:ltr; }';
...
function init() {
  ...
  (function($){
    $.fn.bidi = function() {    
      return this.each(function() {
        var $t = $(this);
        var text = $t.text().replace(NOT_UNICODE_LETTER, "");
  ...
  $.fn.processTweet = function() {
    return $(this).find('.entry-content').bidi()
  };
