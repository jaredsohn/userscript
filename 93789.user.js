	...
	this.getPlusReport = function() {
		...
		if(this.hasShips) {
			...
			for(i = 0; i < this.fleets.length; i++) {
				...
				if (this.fleets[i].hermes > 0)
					s += "<img src='" + shipThumbsAddr + "hermes_class_probe.png' " + thumbSize + " alt='* Hermes Class Probe: " + addCommas(this.fleets[i].hermes) + " '> x" + addCommas(this.fleets[i].hermes) + " ";
				if (this.fleets[i].helios > 0)
					s += "<img src='" + shipThumbsAddr + "helios_class_solar_satellite.png' " + thumbSize + " alt='* Helios Class Solar Satellite: " + addCommas(this.fleets[i].helios) +  " '> x" + addCommas(this.fleets[i].helios) + " ";
				if (this.fleets[i].artemis > 0)
					s += "<img src='" + shipThumbsAddr + "artemis_class_fighter.png' " + thumbSize + " alt='* Artemis Class Fighter: " + addCommas(this.fleets[i].artemis) + " '> x" + addCommas(this.fleets[i].artemis) + " ";
				if (this.fleets[i].atlas > 0)
					s += "<img src='" + shipThumbsAddr + "atlas_class_cargo.png' " + thumbSize + " alt='* Atlas Class Cargo: " + addCommas(this.fleets[i].atlas) + "'> x" + addCommas(this.fleets[i].atlas) + " ";
				if (this.fleets[i].apollo > 0)
					s += "<img src='" + shipThumbsAddr + "apollo_class_fighter.png' " + thumbSize + " alt='* Apollo Class Fighter: " + addCommas(this.fleets[i].apollo) + " '> x" + addCommas(this.fleets[i].apollo) + " ";
				if (this.fleets[i].charon > 0)
					s += "<img src='" + shipThumbsAddr + "charon_class_transport.png' " + thumbSize + " alt='* Charon Class Transport: " + addCommas(this.fleets[i].charon) + " '> x" + addCommas(this.fleets[i].charon) + " ";
				if (this.fleets[i].hercules > 0)
					s += "<img src='" + shipThumbsAddr + "hercules_class_cargo.png' " + thumbSize + " alt='* Hercules Class Cargo: " + addCommas(this.fleets[i].hercules) + " '> x" + addCommas(this.fleets[i].hercules) + " ";
				if (this.fleets[i].dionysus > 0)
					s += "<img src='" + shipThumbsAddr + "dionysus_class_recycler.png' " + thumbSize + " alt='* Dionysus Class Recycler: " + addCommas(this.fleets[i].dionysus) + " '> x" + addCommas(this.fleets[i].dionysus) + " ";
				if (this.fleets[i].gaia > 0)
					s += "<img src='" + shipThumbsAddr + "gaia_class_colony_ship.png' " + thumbSize + " alt='* Gaia Colony Ship: " + addCommas(this.fleets[i].gaia) + " '> x" + addCommas(this.fleets[i].gaia) + " ";
				if (this.fleets[i].poseidon > 0)
					s += "<img src='" + shipThumbsAddr + "poseidon_class_cruiser.png' " + thumbSize + " alt='* Poseidon Class Cruiser: " + addCommas(this.fleets[i].poseidon) + " '> x" + addCommas(this.fleets[i].poseidon) + " ";
				if (this.fleets[i].athena > 0)
					s += "<img src='" + shipThumbsAddr + "athena_class_battleship.png' " + thumbSize + " alt='* Athena Class Battleship: " + addCommas(this.fleets[i].athena) + " '> x" + addCommas(this.fleets[i].athena) + " ";
				if (this.fleets[i].ares > 0)
					s += "<img src='" + shipThumbsAddr + "ares_class_bomber.png' " + thumbSize + " alt='* Ares Class Bomber: " + addCommas(this.fleets[i].ares) + " '> x" + addCommas(this.fleets[i].ares) + " ";
				if (this.fleets[i].hades > 0)
					s += "<img src='" + shipThumbsAddr + "hades_class_battleship.png' " + thumbSize + " alt='* Hades Class Battleship: " + addCommas(this.fleets[i].hades) + " '> x" + addCommas(this.fleets[i].hades) + " ";
				if (this.fleets[i].prometheus > 0)
					s += "<img src='" + shipThumbsAddr + "prometheus_class_destroyer.png' " + thumbSize + " alt='* Prometheus Class Destroyer: " + addCommas(this.fleets[i].prometheus) + " '> x" + addCommas(this.fleets[i].prometheus) + " ";
		...
		if(this.hasDefenses) {
			...
			if (this.defense.missileBatt > 0 && this.defense.missileBatt > 0)
				s += "<img src='" + defsThumbsAddr + "missile_battery.png' " + thumbSize + " alt='* Missile Battery: " + this.defense.missileBatt + " '> x" + this.defense.missileBatt + " ";
			if (this.defense.laserCannon > 0 && this.defense.laserCannon > 0)
				s += "<img src='" + defsThumbsAddr + "laser_cannon.png' " + thumbSize + " alt='* Laser Cannon: " + this.defense.laserCannon + " '> x" + this.defense.laserCannon + " ";
			...
			if (this.defense.plasmaCannon > 0 && this.defense.plasmaCannon > 0)
				s += "<img src='" + defsThumbsAddr + "plasma_cannon.png' " + thumbSize + " alt='* Plasma Cannon: " + this.defense.plasmaCannon + " '> x" + this.defense.plasmaCannon + " ";
			if (this.defense.abm > 0 || this.defense.ibm > 0)
				s += "<br>";
			if (this.defense.abm > 0 && this.defense.abm > 0)
				s += "<img src='" + defsThumbsAddr + "anti-ballistic_missile.png' " + thumbSize + " alt='* Anti-Ballistic Missile: " + this.defense.abm + " '> x" + this.defense.abm + " ";
			if (this.defense.ibm > 0 && this.defense.ibm > 0)
				s += "<img src='" + defsThumbsAddr + "interplanetary_ballistic_missile.png' " + thumbSize + " alt='* Interplanetary Ballistic Missile: " + this.defense.ibm + " '> x" + this.defense.ibm + " ";
			s += "<br><br>";
		}
