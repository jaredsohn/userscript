...
// @description    suka suka lw deh sekarang !!!!
// @version        3.0.0
// @author         Seven Yu
...
var waitForPreview = 0.5; // in reply to é¢„è§ˆå»¶æ—¶ (å•ä½:ç§’ sec)
...
var checkMaxTimes = getCookie('checkMaxTimes') || 15;  // æœ€åŽè®¿é—®ç‚¹æœ€å¤šæ£€æµ‹é¡µæ•° (pages)
...
function init()
{
    ...
    //æ¥è‡ª http://stackoverflow.com/questions/499126/jquery-set-cursor-position-in-text-area
    //æŽ§åˆ¶å…‰æ ‡ä½ç½®
...
function createUI()
{
    ...
    // å…¥ä¾µåˆ«äººçš„ listé¡µé¢ã€‚æ„Ÿè§‰æ²¡æ„ä¹‰ã€‚
    ...
    $('<div id="ts_setting_dialog"><label>' +
        ...
        '</div>')
    .appendTo('body').hide();
    $('.top-navigation').prepend('<li><a href="javascript:void 0;"  id="ts_setting">[Gratz]</a></li>');
...
function addShortcuts(){
    ...
    //æŠŠæŽ¨å‘é€å‡ºåŽ»ä¹‹åŽï¼Œä¼šåœ¨é¡¶éƒ¨æç¤ºæ­£åœ¨å‘é€çš„æŽ¨çš„å®Œæ•´å†…å®¹ã€‚æ–¹ä¾¿å‘é€å¤±è´¥çš„æ—¶å€™å¤åˆ¶ã€‚
    ...
    //å¿«æ·é”® 12345 å¯¹åº” homeï¼Œreplyï¼ŒDMï¼ŒFavï¼ŒRTã€‚æ¨¡ä»¿ GR çš„å¿«æ·é”®ã€‚
    ...
    //C ä¸€é”®æ¸…ç†å½“å‰æŽ¨ä»¥ä¸‹çš„ tweets
