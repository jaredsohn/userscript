...
var Version = '20110809aspam1minuto';
...
var Options = {
  ...
  spamconfig   : {aspam:true, spamvert:'bimbo recias!!', spammins:'1', atime:1 , spamstate:'a'},
  giftDomains  : {valid:false, list:{}},
  celltext     : {atext:true, provider:0, num1:"000", num2:"000", num3:"0000"},
  giftDelete   : 'e',
  currentTab   : null,
  hideOnGoto   : true,
  ...
  init : function (div){    // called once, upon script startup
    ...
    var m = '<DIV class=pbStat>Advertise</div><TABLE class=pbTab width=100% height=0% ><TR align="center">';
       ...
       m += '<DIV class=pbStat>Settings</div><TABLE class=pbTab>';
        m += '<tr><td>Automatically post every <INPUT id=pbSpamMin type=text size=1 maxlength=3 value="'+ Options.spamconfig.spammins +'"  \> minutes</td></tr><BR>\
