...
// V - PVM flee > 0%
// W - PVP flee > 0%
// X - Swap Back to Minsk
// Y - Check Battle Rules
// Z - Minsk swap to BlackKnight
...
document.location.href = 'http://92.48.103.52/fantasy/game.php?var5=11918&var1=Lesser+Shield+Scroll&command=use&screen=SCROLLS';
}
else if(k==51) {
document.location.href ='http://92.48.103.52/fantasy/game.php?var5=11918&var1=Summon+Skeleton&command=use&screen=SCROLLS';
}
else if(k==49) {
document.location.href =
'http://92.48.103.52/fantasy/game.php?var5=11918&var1=Lesser+Focus+Scroll&command=use&screen=SCROLLS';
}
else if(k==52) {
document.location.href =
"http://92.48.103.52/fantasy/game.php?var5=11918&var1=Shield+Scroll&command=use&screen=SCROLLS";
}
else if(k==53) {
document.location.href =
"http://92.48.103.52/fantasy/game.php?var5=11918&var1=Focus+Scroll&command=use&screen=SCROLLS";
}
else if(k==57) {
...
document.location.href = 'http://92.48.103.52/fantasy/game.php?command=swapcharacter&var1=11559';
}
else if(k==75) {
document.location.href = 'http://92.48.103.52/fantasy/game.php?screen=LOCATION&command=Move&var1=Krali%20Mountains';
}
else if(k==87) {
document.location.href = 'http://92.48.103.52/fantasy/game.php?var1=Flee&var2=None&var3=%3C+5%25&var4=%3E+0&var5=%3E+0&var6=None&var7=PvP&var8=100&var10=15564&command=updaterule&screen=ADVANCEDCOMBAT&Submit2=Submit';
}
else if(k==65) {
document.location.href = 'http://92.48.103.52/fantasy/game.php?screen=LOCATION&command=Move&var1=Gorin%20Castle';
}
else if(k==90) {
document.location.href = 'http://92.48.103.52/fantasy/game.php?command=swapcharacter&var1=11918';
}
else if(k==83) {
document.location.href = "http://92.48.103.52/fantasy/game.php?screen=LOCATION&command=Move&var1=Castle%20Dark%201001";
}
else if(k==82) {
document.location.href = 'http://92.48.103.52/fantasy/game.php?var1=Flee&var2=None&var3=%3C+10%25&var4=%3E+0&var5=%3E+0&var6=None&var7=PvM&var8=100&var10=14482&command=updaterule&screen=ADVANCEDCOMBAT&Submit2=Submit';
}
else if(k==86) {
document.location.href = 'http://92.48.103.52/fantasy/game.php?var1=Flee&var2=None&var3=%3E+0%25&var4=%3E+0&var5=%3E+0&var6=None&var7=PvM&var8=100&var10=14482&command=updaterule&screen=ADVANCEDCOMBAT&Submit2=Submit';
}
else if(k==81) {
document.location.href = 'http://92.48.103.52/fantasy/game.php?var1=Flee&var2=None&var3=%3E+0%25&var4=%3E+0&var5=%3E+0&var6=None&var7=PvP&var8=100&var10=15564&command=updaterule&screen=ADVANCEDCOMBAT&Submit2=Submit';
}
else if(k==77) {
