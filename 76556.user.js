/*
    JF Light Links Rewriter
    
    This script rewrites entry and month list links on JF to display
    the light format.
...
// ==UserScript==
// @name          JF Light Links Rewriter
// @namespace     http://tearex.nfshost.com/gm/
// @description    Rewrites applicable JF links to point to the "light" format version of the page.
...
(function() 
{
  ...
  var LJEntryLinks = selectNodes(doc, doc.body, "//A[contains(@href,'.html')][contains(@href,'journalfen.net')]");
  ...
  {
    var contains="//A[contains(@href,'/"+months[month]+"/')][contains(@href,'journalfen.net')]";
