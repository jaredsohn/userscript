...
// @namespace 	Gboz
// @author		Gboz
// @description	UNCO alliance Tools - ika-core
...
switch (location.host) {
	default:
		...
		chaturl='CHAT';
		//forumurl='.';
		forumurl='http://lmd.superforos.com/';
		//forumurlnew='.';
		forumurlnew='http://lmd.superforos.com/search.php?search_id=newposts';
		break;
	case 's1.ikariam.es':
		alliancefullnm='Union Corsaria';
		alliancenm='UnCo';	
