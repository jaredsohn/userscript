...
if (k == 66) {
    ...
    document.location.href = 'http://www.immortalnight.com/citygrid.php?action=east';
  } if (k == 70) {
    ...
    document.location.href = 'http://www.immortalnight.com/gym.php?stat=Labour&amnt=82';
  } if (k == 83) {
    document.location.href = 'http://www.immortalnight.com/citygrid.php?action=south';
  } if (k == 84) {
    ...
    document.location.href = 'http://www.immortalnight.com/citygrid.php?action=west';
  } if (k == 88) {
    ...
    document.location.href = 'http://www.immortalnight.com/gym.php?stat=Accuracy&amnt=82';
  } if (k == 52) {
    document.location.href = 'http://www.immortalnight.com/powergym.php?stat=Defense&amnt=82';
  } if (k == 53) {
    document.location.href = 'http://www.immortalnight.com/gym.php?stat=Strength&amnt=82';
  } if (k == 54) {
