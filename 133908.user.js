// ==UserScript==
// @author		fok33r
// @name        Damages Report Script for fok33r
// @namespace   eRepublikBattlesReporter_fok33r
// @version		0.0.1
// @uso:version 0.0.1
// @include		http://*erepublik.com/*/military/battlefield/*
// @description    eRepublik Damage Reporting script for fok33r MU
// ==/UserScript==
...
if(window.location.href.indexOf(PAGE_BATTLEFIELD) > 0) {	
	...
	/***********************************************************************************/
	var FORM_URL = "https://docs.google.com/spreadsheet/viewform?formkey=dHVxY1RCckEzbllObDlrN1ZJOE54OWc6MQ";
	var FORM_FIELDS = {
                eday: "entry.0.single",
                name: "entry.2.single",
	...
	var dm6=Math.floor((parseInt(rankl)+5)*(parseFloat(str)+400)*0.005*2.2);
