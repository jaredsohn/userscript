...
// @name	Travian ☣ Multi Message Script [T4.2]
...
var sidebar = document.getElementById('sidebarAfterContent');
if (sidebar) {
...
function getCParam(){
	var writeDiv = document.getElementById('content');
	var writeForm = writeDiv.getElementsByTagName('form')[0];
	var cParam = writeForm.getElementsByTagName('input')[2];
	if(cParam.name == "c") {
		return cParam.value;
	}
