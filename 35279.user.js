...
// @name           MsLvRTools
// @namespace      ikatips
// @description    Herraminetas para la alianza MaXiMuS LoVeR
// @include        http://*ikariam.*/index.php*
// @author         Acadian para MaXiMuS LoVeR
...
+ ' <li><h2>MsLvR</h2>'
+ '   <ul>'
+ '     <li><center><a target="_blank" href="http://iloveyou.mejorforo.net/index.htm" title=" Foro de la Alianza MsLvR ">Foro MsLvR</a></li>'
