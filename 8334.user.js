// ==UserScript==
// @name            Platypus-forum.ingame.de/broodwar
// @namespace       Platypus
// @include         http://forum.ingame.de/broodwar/*
function do_platypus_script() {
do_modify_html_it(window.document,document.evaluate('/HTML[1]/BODY[1]/TABLE[1]/TBODY[1]/TR[1]/TD[1]', document, null, XPathResult.FIRST_ORDERED_NODE_TYPE,null).singleNodeValue,/http:\/\/broodwar\.ingame\.de\/bwforum\/images\/carmen\.gif/,'http://img181.imageshack.us/img181/4945/fightclubcopyxe3.jpg',null);
