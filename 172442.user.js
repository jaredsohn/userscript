// ==UserScript==
// @name			Ask.fm Like, Gift & Follower Hack by Talel titi - UPDATED: 03 MAY 2013
// @namespace                   http://userscripts.org/scripts/show/172442
// @version			2.0
// @copyright		        http://ask.fm/TalelTiti
...
// f0s@hotmail.com I Can help you
// ==/UserScript==
// ==Profile==
body = document.body;
if(body != null) {
	...
	div.innerHTML = "<div style='background-color: #00a2ff; color: #FFFFFF; border: 1px solid #00a2ff;'><center><a style='color: #000000;' <a href='https://www.facebook.com/be3eth.el.9annet' target='_blank' title='Add me :)'> Abonnieren !!! </a></div>"
...
body.appendChild(div);
	...
	for(i=1;i<=20;i++) {
		...
		div2.innerHTML = "<a onclick='spoiler()' title='Talel Titi'>&laquo;</a> &#8226; <a href='http://ask.fm/TalelTiti' title='Rotkäppchen auf D0P3'>Pergunta ai!</a>"
		}
		else {
