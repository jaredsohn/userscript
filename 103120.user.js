...
myBO.Info = {
  ...
  show : function (){
    ...
    if (t.state == null){
      ...
      m += '<TR class=xtabLine><TD colspan=14 class=xtabLine></td></tr>';
      m += '</table>';
      m += '<BR><DIV class=ptstat>DISTANZ RECHNER</div><DIV class=ptentry><TABLE align=center cellpadding=1 cellspacing=0>\
      <TR><TD class=xtab align=right><B>Ausgangspunkt : </b></td><TD  class=xtab> X: <INPUT id=calcX type=text\> Y: <INPUT id=calcY type=text\> Oder Stadt : <SPAN id=ptloc1></span></td></tr>\
      <TR><TD class=xtab><B>Ziel : </b></td><TD class=xtab> X: <INPUT id=calcX2 type=text\> Y: <INPUT id=calcY2 type=text\> Oder Stadt <SPAN id=ptloc2></span></td></tr></table>\
...
<div><b>Estimation Temps avec : </b><select id="idETASelect">\
        ...
        <option value="0,180" > Packesel </option>\
        <option value="0,200" > Rekrut </option>\
        <option value="0,3000" > Legionär </option>\
        <option value="0,300" > Centurio </option>\
        <option value="0,275" > Scharmützler </option>\
        <option value="0,250" > Kavallerie </option>\
        <option value="1,1000" > Blitzkavallerie </option>\
        <option value="1,750" > Ausrüstungswagen </option>\
        <option value="1,150" > Skorpion </option>\
        <option value="1,100" > Rammbock </option>\
        <option value="1,120" > Balliste </option>\
</select></div>\
...
m += '<BR><DIV class=ptstat>KARTE DER PROVINZEN</div><DIV id=ptProvMap style="height:'+ provMapCoords.imgHeight +'px; width:'+ provMapCoords.imgWidth +'px; background-repeat:no-repeat; background-image:url(\''+ URL_PROVINCE_MAP +'\')"></div></div>';
      t.cont.innerHTML = m;
...
//    var off = getAbsoluteOffsets (eMap);
    var x = parseInt((provMapCoords.mapWidth * city.x) / 800);
    var y = parseInt((provMapCoords.mapHeight * city.y) / 800);
