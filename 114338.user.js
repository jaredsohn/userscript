...
var IkaTools = {
	...
	movementHanlders:[],
	maxBuildingLevel:50,
	buildingTypes:['academy', 'alchemist', 'architect', 'branchOffice', 'carpentering', 'embassy', 'fireworker', 'forester', 'glassblowing', 'museum', 'optician', 'palace', 'palaceColony', 'port', 'safehouse', 'shipyard', 'stonemason', 'temple', 'tavern', 'townHall', 'vineyard', 'wall','winegrower', 'workshop', 'dump'],
	...
	buildingIsMaxed:function(building) {
		...
		switch(building.type) {
			case 'Barracks': return parseInt(building.level) == 50;
			...
			case 'Museum': return parseInt(building.level) == 24;
			case 'Tavern': return parseInt(building.level) == 48;
			case 'TownHall': return parseInt(building.level) == 48;
...
IkaTools.text = {
	buildings:{
		...
		alchemist:{
			en:'Torre do Alquimista',
		},
		architect:{
			en:'Atelier de Arquitetura',
		}, 
		barracks:{
			en:'Quartel',
		},
