// ==UserScript==
// @name           Kevin Mafia Toolbar
// @namespace      http://www.spockholm.com/toolbar
// @version        1.0.0.2
// @description    Modified version of Spockholm's Toolbar
...
javascript:(function(){
	...
	add_spocklet('Assassin-a-Nator','http://spocklet.com/bookmarklet/assassin-a-nator.js','fight');
        ...
        add_spocklet('Property Manager','http://spocklet.com/bookmarklet/property.manager.js','property');
        add_spocklet('Switch','http://unlockedmw.com/toolbar/switch.js','index');
        add_spocklet('Link-a-Nator','http://spocklet.com/bookmarklet/link-a-nator.js','gifting');
        add_spocklet('Get-a-Nator','http://spocklet.com/bookmarklet/free_gift_get_a_nator.js','gifting');
        add_spocklet('Family Friends','http://spocklet.com/bookmarklet/family_friends.js','family');
        add_spocklet('Family Boss Fighter','http://spocklet.com/bookmarklet/family-boss-fighter.js','Epicclanboss');
        add_spocklet('Inventory History','http://spocklet.com/bookmarklet/inventory_history.js','stats');
        add_spocklet('Stats History','http://spocklet.com/bookmarklet/history.js','stats');
        add_spocklet('Mafia Manager','http://spocklet.com/bookmarklet/mafia_history.js','family');
        add_spocklet('Family Manager','http://spocklet.com/bookmarklet/family_history.js','family');
        add_spocklet('Bagman Mugger','http://spocklet.com/bookmarklet/mystery_bagger.js','gifting');
        add_spocklet('Chucker','http://simony.dk/gs/Chucker.js','gifting');
        add_spocklet('Gift-a-Nator','http://spocklet.com/bookmarklet/gift-a-nator.js','gifting');
        add_spocklet('PChucker','http://www.scruffys-mwbm.com/mafia2/PChucker.js','gifting');
        add_spocklet('People Picker','http://spocklet.com/bookmarklet/FB_friends_Picker_Bmlet_Builder.js','gifting');
        add_spocklet('ZMC Agent','http://spocklet.com/bookmarklet/zmc-beta.js','gifting');
        add_spocklet('Assassin-NPC','http://spocklet.com/bookmarklet/assassin-npc.js','fight');
        add_spocklet('Fight.&#12324;','http://www.creallaborate.com/guessx/mw/scripts/fightx.js','fight');
        add_spocklet('Sitter.&#12324;','http://www.creallaborate.com/guessx/mw/scripts/sitonem.js','fight');
        add_spocklet('Rob.&#12324;','http://www.creallaborate.com/guessx/mw/scripts/rob.js','robbing');
        add_spocklet('Loose Slots','http://spocklet.com/bookmarklet/loose_slots.js','helper');
        add_spocklet('Mission Crew Link','http://spocklet.com/bookmarklet/missionlink.js','helper');
        add_spocklet('Operation War Hunter','http://spocklet.com/bookmarklet/mission-war-hunter.js','helper');
        add_spocklet('Stream Scanner','http://spocklet.com/bookmarklet/stream-scanner.js','helper');
        add_spocklet('War Post','http://spocklet.com/bookmarklet/war-post.js','helper');
        add_spocklet('Backup!','http://spocklet.com/bookmarklet/backup-a-nator.js','index');
        add_spocklet('Drone.&#12324;','http://www.creallaborate.com/guessx/mw/scripts/gxsdrone.js','index');
        add_spocklet('Fight Club Buyer','http://spocklet.com/bookmarklet/MarketplaceFCPurchase.js','index');
        add_spocklet('Cookie-a-Nator','http://spocklet.com/bookmarklet/cookie-a-nator.js','mission');
        add_spocklet('En2XP.&#12324;','http://www.creallaborate.com/guessx/mw/scripts/en2xpc.js','stats');
        add_spocklet('ICollect.&#12324;','http://www.creallaborate.com/guessx/mw/scripts/icollect.js','stats');
        add_spocklet('INeed.&#12324;','http://www.creallaborate.com/guessx/mw/scripts/ineed.js','stats');
        add_spocklet('Inventory Groups','http://spocklet.com/bookmarklet/inventorygroup.js','stats');
        add_spocklet('Spockholm Item Analyzer','http://spocklet.com/bookmarklet/inventory.analyzer.js','stats');
        add_spocklet('Family ID','http://spocklet.com/bookmarklet/familyid.js','family');
        add_spocklet('Family Info','http://spocklet.com/bookmarklet/family_info.js','family');
        add_spocklet('PDLMafia','http://www.scruffys-mwbm.com/mafia2/PDLMafia.js','family');
        add_spocklet('PRemoveFBFriends','http://www.scruffys-mwbm.com/mafia2/PRemoveFBFriends.js','family');
        add_spocklet('Get Facebook ID','http://www.spockholm.com/mafia/martini/get_fb_id.js','index');
        add_spocklet('IceTmnu','http://icetools.co.uk/Gscript/IceTmnu.js','index');
        add_spocklet('List FB friends','http://spocklet.com/bookmarklet/listFBfriends.js','index');
        add_spocklet('Mini-Pack','http://www.spockholm.com/mafia/minipack.js','index');
        add_spocklet('OGP MWTS V2','http://www.oneguy.com/mafia/Scriptlets/mwts.js','index');
        add_spocklet('Unframe-MW','http://spocklet.com/bookmarklet/unframe.js','index');       
	...
	function calculate_brazil_jobs() {
		...
		$('.jobs > .job').each(function() {
			var energy = $(this).find('li.energy').attr('current_value');
	...
	function battle_check(){
		if (document.getElementById('pop_zmc')) {
			...
			$('.state_accept:contains("Accept Battle")').each(function(){
				...
				if (m=/duration\=(\d+)/.exec($(this).html())) {
					if (m[1]=="14400") {
				...
				if (m=/opponent_id\=(\d+)/.exec($(this).html())) {
