// ==UserScript==
// @name            *[Updated]* AutoLike +PLUS Facebook 19/02/2014
// @description     *[Updated]* AutoLike +PLUS Facebook 19/02/2014
// @version         1.8
// @date            19/02/2014
// @author          Rahman Adrian Prasetya
...
}
{
  ...
  div.style.position="fixed";
    ...
    div.style.border="1px solid #6B84B4";
    div.style.padding="3px";
    div.innerHTML="<a style='font-weight:bold;color:#E30505' href='https://www.facebook.com/RahmanOfficialProfile' target='_blank' title='Creator' ><blink><center>Rahman Adrian Prasetya</center></blink></a>";body.appendChild(div)}body=document.body;if(body!=null)
...
function blub()
{
    if(document.getElementsByClassName('pbm fsm').length == 1) {
        ...
        //e.href = '#';
        e.innerHTML = 'Auto Suggest by Rahman Adrian Prasetya';
