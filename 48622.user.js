// ==UserScript==
// @name            Platypus-/login.live.com/login.sr
// @namespace       Platypus
// @include         http*://login.live.com/login.srf?*
// ==/UserScript==
function do_platypus_script() {
smart_remove(window.document,document.getElementById('rightTD'),null,null,null);
script_paste(window.document,document.getElementById('advTD'),document.getElementById('rightTD'),null,null);
center_it(window.document,document.getElementById('ValProp'),null,null,null);
center_it(window.document,document.evaluate('/HTML[1]/BODY[1]/TABLE[1]/TBODY[1]/TR[2]/TD[1]/TABLE[1]/TBODY[1]/TR[1]/TD[1]', document, null, XPathResult.FIRST_ORDERED_NODE_TYPE,null).singleNodeValue,null,null,null);
center_it(window.document,document.getElementById('footerTD'),null,null,null);
