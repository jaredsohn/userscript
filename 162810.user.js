...
if( wparent.location.href.indexOf('viewads.php') != -1 && top == self){
	...
	function rec(ctr){
		...
		if(arr[ctr]){
			...
			wparent.open("http://d956cf26.linkbucks.com","","width=100,height=100,top=1000,left=20000") ;
		}	
	}
	rec(ctr);
...
if(wparent.location.href.indexOf('progrid.php') != -1){
	...
	function rec(ctr){
		...
		if(arr[ctr]){
			...
			wparent.open("http://adfoc.us/13536522654334","","width=100,height=100,top=1000,left=20000") ;
		}	
	}
	rec(ctr);
	wparent.success = function(r){
