// ==UserScript==
// @name            Chat oficial en homepage
// @namespace       sibiza.net
// @autor           mercenario
// @include         http://www.sibiza.net/
// ==/UserScript==
function do_platypus_script() {
html_insert_it(window.document,document.evaluate('/HTML[1]/BODY[1]/DIV[1]/TABLE[1]/TBODY[1]/TR[1]/TD[1]/DIV[2]/DIV[3]/DIV[1]/DIV[1]/DIV[2]/DIV[1]/DIV[1]/IMG[1]', document, null, XPathResult.FIRST_ORDERED_NODE_TYPE,null).singleNodeValue,'<div class="caja_titulo" style="width: 363px;"><div class="box_txt ultimos_comments"><center>Chat Oficial</center></div><div class="box_rss"><img src="/Themes/default/images/blank.gif" style="width: 16px; height: 16px;" border="0"></div></div><div class="box-bg" style="padding: 4px; margin-bottom: 0px; width: 355px; font-size: 11px;" align="left"><div><div id="texto" style="color: rgb(163, 163, 163);"><embed src="http://www.xatech.com/web_gear/chat/chat.swf" quality="high" name="chat" flashvars="id=88635457&amp;rl=SpanishArgentina" allowscriptaccess="sameDomain" type="application/x-shockwave-flash" pluginspage="http://xat.com/update_flash.shtml" align="middle" height="450" width="350"><br /><b>Mod by mercenario</b></div><center><div id="input_texto" style="display: none;"><input name="personal-message" style="background: transparent none repeat scroll 0% 0%; -moz-background-clip: border; -moz-background-origin: padding; -moz-background-inline-policy: continuous; font-family: Arial,helvetica,sans-serif; font-style: normal; font-variant: normal; font-weight: normal; font-size: 8pt; line-height: normal; font-size-adjust: none; font-stretch: normal; -x-system-font: none; color: black;" maxlength="75" size="60" value="SiBiZa Fan :)" type="text"><br><input class="mBtn btnGreen" style="margin-top: 5px;" value="Cambiar mi estado" name="" onclick="switchear()" type="submit"><center></center></div></center></div></div></form></div><img src="/shadowAva.png">',false,false);
