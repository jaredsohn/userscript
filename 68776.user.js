// ==UserScript==
// @name           The West - Ajutor Misiuni
// @namespace      http://www.puli.sk
// @description    Un script util cu ajutorul caruia veti putea vedea rapid date despre munca si despre produsul pe care trebuie sa il aduceti pentru misiune.
// @include        http://*.the-west.*/game.php*
// ==/UserScript==
var labor_points_text={en:'Labor points',cz:'Pracovní body',sk:'Pracovné body',ro:'Puncte de muncă'};
var difficulty_text ={en:'Difficulty',cz:'Obtížnost',sk:'Obtiažnosť',ro:'Dificultate'};
