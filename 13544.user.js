// ==UserScript==
// @name           OGame Cleaner .ba
// @namespace      Fake
// @description    OGame Cleaner za OGame.ba, dodan link za Kruznu poruku, precac za Odskocna vrata, tnx to Karamba and special tnx to Laymain.
// @include        http://*/game/index.php*
// ==/UserScript==

var sid = location.search.split('&')[1].split('=')[1];
// Begin of Configuration
var jump_gate_text = 'Odskocna Vrata';
var advanced_jump_gate = false;
var external_links = false;
var internal_links = new Array(
{name:'Kruzna poruka', url:'index.php?page=allianzen&session='+sid+'&a=17', color:'white'}
);
...
var elems = new Array();
var elems = ['page=commander', 'page=offiziere', 'page=micropayment', 'board.', 'tutorial.', 'regeln.', 'impressum.', 'ogame.com.hr'];
...
for (var i = 0; i < td.length; i++)
	for (var elem in elems)
		if (td[i].innerHTML.indexOf(elems[elem], 0) >= 0)
		{
			...
			else if (external_links && elems[elem] == 'impressum.', 'ogame.com.hr') 
