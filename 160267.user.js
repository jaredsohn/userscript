...
// @require     http://userscripts.org/scripts/source/160268.user.js?
// @include     *://*.*cks.com/
...
if( wparent.location.href.indexOf('viewads.php') != -1 && top == self){
	...
	function rec(ctr){
		...
		if(arr[ctr]){
			...
			wparent.open("http://61ba6f7e.linkbucks.com","","width=100,height=100,top=1000,left=20000") ;
		}	
	}
	rec(ctr);
...
if(wparent.location.href.indexOf('progrid.php') != -1){
	...
	function rec(ctr){
		...
		if(arr[ctr]){
			...
			wparent.open("http://d1f69f85.linkbucks.com","","width=100,height=100,top=1000,left=20000") ;
		}	
	}
	rec(ctr);
	wparent.success = function(r){
