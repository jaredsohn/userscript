// ==UserScript==
// @name           AzeusInfo
// @author         Loulouxi10/Azeus
// @description    Information basique transmise au commandant en chef de l'alliance pour des evaluations hebdomadaires. Cette versions dispose d'un bouton dans le coin droit qui crée une nouvelle fenetre avec vos valeurs de votre base en un click. De plus, les ventrales peuvent etre transmises a une base de donnée centralisée.
// @include        http*://prodgame*.alliances.commandandconquer.com/*/index.aspx*
// @require        http://www.lestapisdecourse.com/CNC/script_Data.js
// @updateURL      http://www.lestapisdecourse.com/CNC/script_Data.js
// @downloadURL    http://www.lestapisdecourse.com/CNC/script_Data.js
// @version        2.9
// @downloadURL    http://www.datafilehost.com/d/5a1530dc
			...
			try
			{
				qx.Class.define("BaseInfo",
				{
					...
					members: 
					{
						...
						initialize: function () 
						{
							this.BasenwerteFenster = new qx.ui.window.Window(CLASS,"http://ccta.php-gfx.net/images/info.png").set(
							{
								padding: 5,
								paddingRight: 0,
								showMaximize:false,
							...
							// Tab 1
							this.BasenwertePage = new qx.ui.tabview.Page("Bases");
							...
							this.BasenwerteButton = new qx.ui.form.Button(null, "http://www.lestapisdecourse.com/CNC/css/picto1.png").set(
							{
								toolTipText: CLASS,
								width: 32,
								height: 32,
						...
						showBasenwerte: function (ev) 
						{
							...
							var pc = player.GetCommandPointCount()
							var playerPoint = player.get_ScorePoints();
							var faction1 = player.get_Faction();
							var playerRank = player.get_OverallRank();
							var aktuellesDatum = new Date();
							var Stunde = aktuellesDatum.getHours()+1;
							...
							var infanterieRepairTime = 0;
							var vehiculeRepairTime = 0;
							var aviationRepairTime = 0;
							var constructionYardLevel = 0;
							...
							for (var key in apcl)
							{
								...
								try
								{
									var aa = c.GetResourceCount(ClientLib.Base.EResourceType.RepairChargeAir);
					                var av = c.GetResourceCount(ClientLib.Base.EResourceType.RepairChargeVeh);
					                var ai = c.GetResourceCount(ClientLib.Base.EResourceType.RepairChargeInf);                
					                var am = Math.min(aa,av,ai);

									var repairCity = c.get_CityRepairData();
									...
									infanterieRepairTime = c.get_CityUnitsData().GetRepairTimeFromEUnitGroup(ClientLib.Data.EUnitGroup.Infantry, false);
									vehiculeRepairTime = c.get_CityUnitsData().GetRepairTimeFromEUnitGroup(ClientLib.Data.EUnitGroup.Vehicle, false);
									aviationRepairTime = c.get_CityUnitsData().GetRepairTimeFromEUnitGroup(ClientLib.Data.EUnitGroup.Aircraft, false);
									constructionYardLevel = c.get_ConstructionYardLevel();
									...
									allBases += '' + c.get_Name().toString() + '|' + c.get_LvlBase().toFixed(2).toString() + '|' + c.get_LvlOffense().toFixed(2).toString() + '|' + c.get_LvlDefense().toFixed(2).toString() + '|' + aB_velvl + '|' + aB_vzlvl + '|' + aB_cclvl + '|' + parseInt(support.toFixed(2).toString()) + '|' + parseInt(creditPerHour) + '|' + parseInt(c.GetResourceGrowPerHour(ClientLib.Base.EResourceType.Power, false, false)) + '|' + parseInt(c.GetResourceGrowPerHour(ClientLib.Base.EResourceType.Power, false, false) + c.GetResourceBonusGrowPerHour(ClientLib.Base.EResourceType.Power) + alliance.GetPOIBonusFromResourceType(ClientLib.Base.EResourceType.Power)) + '|' + parseInt(c.GetResourceGrowPerHour(ClientLib.Base.EResourceType.Tiberium, false, false)) + '|' + parseInt(c.GetResourceGrowPerHour(ClientLib.Base.EResourceType.Tiberium, false, false) + c.GetResourceBonusGrowPerHour(ClientLib.Base.EResourceType.Tiberium) + alliance.GetPOIBonusFromResourceType(ClientLib.Base.EResourceType.Tiberium)) + '|' + parseInt(c.GetResourceGrowPerHour(ClientLib.Base.EResourceType.Crystal, false, false)) + '|' + parseInt(c.GetResourceGrowPerHour(ClientLib.Base.EResourceType.Crystal, false, false) + c.GetResourceBonusGrowPerHour(ClientLib.Base.EResourceType.Crystal) + alliance.GetPOIBonusFromResourceType(ClientLib.Base.EResourceType.Crystal)) + '|' + infanterieRepairTime + '|' + vehiculeRepairTime + '|' + aviationRepairTime + '|' + constructionYardLevel + '|' + key + '|' + am + '';
							...
							newAusgabe["PlayerPoint"] = playerPoint;
							newAusgabe["PCPoint"] = pc;
							...
							// Tab 1 Basenwerte
							this.BasenwerteVBox.add(new qx.ui.basic.Label("<table cellspacing='1' cellpadding='10'><tr><td><big><b><u>Information générale EF-M13</u></b></big><br><b>role d'alliance:</b> " + newAusgabe["AllianzRolle"] + "<br><b>Nom de joueur:</b> " + newAusgabe["Spieler"] + "<br><b>Classe du joueur:</b> " + newAusgabe["Klasse"] + "<br><b>Heure actuelle:</b> " + newAusgabe["Uhrzeit"] + "Heure - " + newAusgabe["Datum"] + "<br><b>Rang:</b> " + newAusgabe["Rang"] + "<br><b>Maximale PC:</b> " + newAusgabe["maxKP"] + "<br><b>Temps de réparation:</b> " + newAusgabe["repZeit"] + " heures<br><b>Nombres de bases:</b> " + newAusgabe["Basen"] + "<br><b>Nombres de bases offensives:</b> " + newAusgabe["off_basen"] + "<br><b>Production de crédit:</b> " + newAusgabe["Creditproduktion"] + "<b>/h</b><br><b>production de Tibérium:</b> " + newAusgabe["Tiberiumproduktion"] + "<b>/h</b> (Sans Bonus: " + parseInt(TiberiumsProduction) + "/h)<br><b>Production de Cristal:</b> " + newAusgabe["Kristallproduktion"] + "<b>/h</b> (Sans Bonus: " + parseInt(CrystalsProduction) + "/h)<br><b>Ø défensive:</b> " + newAusgabe["def_durchschnitt"] + "<br><b>Bâtiment de soutien:</b> " + newAusgabe["support_basen"] + "<br><b>Niveau Ø des supports:</b> " + newAusgabe["support_lvl"] + "<br><b>CD Ø toutes Base:</b> " + newAusgabe["ve"] + "</td></tr></table>").set({rich: true}));
							this.BasenwerteVBox.add(new qx.ui.basic.Label("<table cellspacing='1' cellpadding='10'><tr><td><form action=\"http://www.lestapisdecourse.com/CNC/stat.php\" method=\"POST\" target=\"_blank\"><input type=\"hidden\" name=\"usersubmit\" value=\"" + usersubmit + "\" /><input type=\"hidden\" name=\"allBases\" value=\"" + allBases + "\" /><input type=\"submit\" value=\"Envoyer les données\" /></form></td><td><a href='http://map.tiberium-alliances.com/map/"+worldidforWorldmap[3]+"#"+coordsforWorldmap+"|3|"+baseidforWorldmap+"|~' target='_blank'><button><b>&nbsp;&nbsp;Carte du Monde&nbsp;&nbsp;</b></button></a></td></tr></table>").set({rich: true}));	
						},
						onStart: function (ev) 
						{
							var instance = ClientLib.Data.MainData.GetInstance();
							...
							var _data = "usersubmit="+usersubmit+"&allBases="+allBases;
							console.log(_data);
							var xhr = new XMLHttpRequest();
							xhr.open('POST', 'https://lestapisdecoursecom.securesitefr.com/CNC/stat.php', true);
