// ==UserScript==
// @name           SkyblockSMP userscript
// @namespace      Bulletblast
// @description    For The Fuck of it!
// @author         bulletblast
// @copyright      bulletblast
...
//
// @match          *://*.skyblocksmp.com/forum/*
// @match          *://skyblocksmp.com/forum*
// @version        1.0
// @downloadURL    blank
// @updateURL      blank
//
// @icon           No Icon at the moment
// @icon64         No Icon at the moment
 ...
 * Copy this old shit if you want Text.  Updated one is in the compressed script.  It's not hard to edit either.
...
if(typeof(Storage)!=="undefined") {
    document.getElementsByClassName("logo")[0].getElementsByTagName("img")[0].setAttribute("src","Logolink here")
