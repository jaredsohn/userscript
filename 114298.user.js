// ==UserScript==
// @name           Login button autofocus
// @namespace      http://userscripts.org/
// @description    Focus on the login buton
// @include	       * 
// @version 	   0.1
// ==/UserScript==
...
/*
 ...
 Focuses the login button when there is username/password fields filled
...
***********************
 ...
 This script is a modified version of "Auto Select Login" script : http://userscripts.org/scripts/review/66350
...
if (array.length==2 && array[1].type=="button" && isCtrlInVP(array[1]) || array.length==1 && array[0].type=="password" && isCtrlInVP(array[0]) && (filledPassowrd==true) ) {
	array[0].focus();
