...
for (i = 0; i < uidList.length; i++ ) {
	...
	form += ' <input type="submit" class="bitButton" style="cursor:pointer" value="Add Rating" style="border:1px solid black;" onclick="window.open(\'http://www.hackforums.net/reputation.php\', \'myrepwindow\', \'status=1,width=400,height=350\')"/>';
	form += '</form>';
