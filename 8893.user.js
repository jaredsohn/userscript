// ==UserScript==
// @name	Only Fark News/Comments, Topmenu & Tabs
// @namespace	http://fark2.gedekran.com
// @author	Kristopher
// @description	Removes all content on Fark except News, Comments, Topmenu and Tabs.
...
head = document.getElementsByTagName('head')[0];
	if (head)
	{
		style = document.createElement('style');
			...
			'#headerTop, #topSearch, #bodyRightSideContainer, #footer, .mainerr, .ncbar, .notifyBigBrother, .comlinkcount { display: none; }\n' +
			'#topMenu { width: 100%;  min-width:0px; border-left: 0px; border-right:0px; border-bottom:solid #3d3d3d 2px;}\n' +
