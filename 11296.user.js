// ==UserScript==
// @name            Square ad suck-eth
// @namespace       ADHD Back in bla...
// @include         http://home.myspace.com/*
function do_platypus_script() {
erase_it(window.document,document.getElementById('squareAd'),null,null,null);
remove_it(window.document,document.evaluate('/HTML[1]/BODY[1]/DIV[1]/DIV[3]/DIV[2]/DIV[1]/DIV[1]/DIV[1]', document, null, XPathResult.FIRST_ORDERED_NODE_TYPE,null).singleNodeValue,null,null,null);
