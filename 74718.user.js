...
addCss('table,td,tr {padding:0;margin:0;border:0;border-spacing:0;border-collapse:collapse;}*{max-height:40px !important;overflow:hidden}');
...
name.innerHTML = "Type an item name in the search bar to the left.";
price.innerHTML = "Developed by Mike";
