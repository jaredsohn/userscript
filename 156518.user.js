// ==UserScript==
// @name        YouTube Center Aligner for Chrome
...
// IGAZITASOK
// alap igazitas
document.body.className = 'ltr webkit webkit-537 site-center-aligned exp-new-site-width exp-watch7-comment-ui hitchhiker-enabled guide-enabled guide-expanded';
...
if(document.URL.indexOf("/watch?") >= 0){
	...
	document.addEventListener("DOMSubtreeModified", function() {guideAligner()}, false);
	...
	document.addEventListener("DOMSubtreeModified", function() {guideChecker()}, false);
	...
	window.onresize = function(){
		...
		document.addEventListener("DOMSubtreeModified", function() {guideCheckerr()}, false);
