...
// @name           MSITools
// @namespace      ikatips
// @description    Herraminetas para la alianza MSI
// @include        http://*ikariam.*/index.php*
// @author         Original por Verx - Modificado por alkan para IKOS - Modificado por acadian para MSI
...
+ ' <li><h2>MSI</h2>'
+ '   <ul>'
+ '     <li><center><a target="_blank" href="http://msi.superforos.com" title=" Foro de la Alianza MSI ">Foro MSI</a></li>'
