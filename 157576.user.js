// ==UserScript==
// @name           Pokemon Vortex script (Kyurem's)
...
var legends = [
	// Custom
        'Kyurem (Black)','Dark Kyurem (Black)','Ancient Kyurem (Black)','Shiny Kyurem (Black)','MysticKyurem (Black)','Kyurem (White)','Ancient Kyurem (White)','Dark Kyurem (White)','Mystic Kyurem (White)','Shiny Kyurem (White)'
