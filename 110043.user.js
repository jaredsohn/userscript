...
function()
{
var librarySearchBase = 'http://librarycatalog.ebpl.org/ipac20/ipac.jsp?&menu=search&index=PISBN&term=';
var librarySearchTitle='http://librarycatalog.ebpl.org/ipac20/ipac.jsp?&index=.TW';
var libraryFirstPage = librarySearchBase;
...
var libraryName = 'East Brunswick Public Library';
			...
			GM_xmlhttpRequest
				...
				onload:function(results)
				{
					...
					if (searchFormPattern.test(page)) {
						...
						actionUrl = actionUrl + isbn;
						libraryLookup.doLookup(actionUrl);
					}
					else {
						var actionUrl = librarySearchBase + isbn;
						libraryLookup.insertLink (
							librarySearchTitle,
							"Error",
							"We couldn't automatically find the book you requested.  Click here and try a title search. ",
							"orange"
							);
					}
				}
            ...
            onload:function(results)
                ...
                if ( notFound.test(page) )
                    ...
                    libraryLookup.insertLink (
                        librarySearchTitle,
                        "Error",
                        "Error checking " + libraryName". Click here to try a title search.",
                        "orange"
                        );
                    }
                }
