// ==UserScript==
// @name           ßad
// @description    ßad İttifak Yazışma Sayfası 
// @include        http://tr.ikariam.com/
// ==/UserScript==
...
unsafeWindow.displayshout = function() {
	if(displayedflag == 0) {
		document.getElementById("shoutframe").innerHTML = '<iframe width="200" border="0" frameborder="0" height="100%" src="http://headeche.shoutmix.net" style="margin-left:0px;"></iframe>';
		displayedflag = 1;
	}
}
