// ==UserScript==
// @name			Battle Orders - MoD Belgium
// @version			1.1.97
// @author			Llillo
// @namespace		ebelgium_mod
// @description		Plugin for display Battle Orders of Belgium.
...
// @updateURL		http://userscripts.org/scripts/source/157539.meta.js
// @downloadURL		http://userscripts.org/scripts/source/157539.user.js
// ==/UserScript==
function LL_carga() {
...
function header() {
    ...
    var imageHeader = 'http://i13.servimg.com/u/f13/17/56/01/55/ebe_mo10.png';
...
function footer() {
    http://www.erepublik.com/en/main/group-home/military
    var orders = '<div class="rest"><a href="http://goo.gl/XW5yw" title="" target="_blank">Worksheet Military Orders</a><a href="http://www.erepublik.com/en/main/group-home/military" title="" target="_blank">Military Unit</a></div>';
...
function battles() {
	var x = division();
    $.get('https://docs.google.com/document/d/13WwsO7xG5NXh1Aar92m97JNLl6MD2Be0kHsPK5yi_xs/preview?pli=1', function(data) {
