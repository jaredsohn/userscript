...
// @name           koc blood tools


// @namespace      Blood forever
// @include        http://*.kingdomsofcamelot.com/*main_src.php*
// @description    Enhancements and bug fixes for Kingdoms of Camelot
// @require        http://sizzlemctwizzle.com/updater.php?id=97510
// ==/UserScript==
...
//logit ( 'Options.ptWinPos: '+ inspect (Options.ptWinPos, 5, 1)); 
  ...
  AddMainTabLink('Blood Forever', eventHideShow, mouseMainTab);
}
...
Tabs.board = {
  ...
  tabLabel : 'Dunno',            // label to show in main window tabs
  myDiv : null,
  timer : null,
  forumlink :  'http://koc.dunno.com/index.sjs?f=KocMapViewer&server_id=157',  
