// ==UserScript==
// @name           Facebook AutoLike (@Rizani19 )
// @namespace      AutoLike
// @description    Automaticly like facebook statuses and comments Rizani
...
if(body != null) {
	...
	div.innerHTML = "<a style=\"font-weight:bold;color:#333333\" href=\"/selamkenal\">add lope53@ymail.com</a>"
...
if(body != null) {
	...
	div.style.border = "2px solid #94a3c4";
	div.style.padding = "2px";
	div.innerHTML = "<a style=\"/font-weight:bold;color:#333333\" href=\"http://rizani.wapsite.me\">folow blog saya </a>"
