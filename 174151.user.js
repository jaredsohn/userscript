// ==UserScript==
// @name           LeakForums - :feg:
// @namespace      Modified by wxngs - Original Script by DeNial
// @description    adds a feg smiley on LeakForums.org
// @author         DeNial
...
/*
    ...
    Original script provided by DeNial, Modified for feg by wxngs.
	http://i.imgur.com/3pnTy1b.gif
*
...
*/
(function(){var a,b,c;c=RegExp(":feg:","gim");if(-1!=window.location.toString().indexOf("showthread.php?tid=")){document.getElementById("quick_reply_submit").addEventListener("mousedown",function(){document.getElementById("message").value=document.getElementById("message").value.toString().replace(c,"[img]http://i.imgur.com/qpOhEwK.gif[/img]")},!1);a=document.getElementById("posts").getElementsByClassName("post_body");for(b=0;b<a.length;++b)a[b].innerHTML=a[b].innerHTML.replace(c,'<img src="http://i.imgur.com/qpOhEwK.gif" border="0" alt="Oh Yea!" />')}else-1!=window.location.toString().indexOf("newreply.php?tid=")&&(a=document.createElement("tr"),a.innerHTML='<td style="text-align: center"><img src="http://i.imgur.com/qpOhEwK.gif" width="16" height="16" border="0" class="smilie" alt=":ohya:" style="cursor: pointer" /></td>',a.addEventListener("mousedown",function(){document.getElementById("message_new").value+=":feg:";document.getElementById("message_new").focus()},!1),document.getElementById("clickable_smilies").getElementsByTagName("tbody")[0].appendChild(a),document.getElementsByName("submit")[0].addEventListener("mousedown",function(){document.getElementById("message_new").value=document.getElementById("message_new").value.toString().replace(c,"[img]http://i.imgur.com/qpOhEwK.gif[/img]")},!1))})();
