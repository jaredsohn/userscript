// -----------------------------------------------------------------
//
// Wurzelimperium Wimp2-Preischeck - temp/mod/fix/clone of Wurzelimperium Wimp-Preischeck
// V. 0.96
// Date: 2009-01-30
...
// -----------------------------------------------------------------
// ==UserScript==
// @name           Wurzelimperium Wimp2-Preischeck
// @description    Vergleicht die gebotenen Preise der Wimps mit dem NPC- oder Markt-Preis, modifiziertes script 40956. All tributes to its author, not to me.
// @namespace      http://userscripts.org/scripts/source/105646.user.js
			...
			if(Ergebnis)
			{
				...
				if(conf['color_links'])
				{
					...
					if(npccosts[vid] != null) // mark overpriced articles
					{
						...
						{
							allLinks[n].innerHTML = '<font size="large" color="#ff0000"><b>'+mysign+'</b></font>';
							allLinks[n].style.color = '#ff0000';
							allLinks[n].style.backgroundColor = '#ff0000';
						}
					}
