...
// @include http://*.staemme.ch/game.php?*village=*&screen=map
// @include http://*.staemme.ch/game.php?*village=*&screen=report&mode=all&view=*
// @include http://*.staemme.ch/game.php?*village=*&screen=map&x=*&y=*
// @include http://*.staemme.ch/game.php?*village=*&screen=report&mode=attack&view=*
// @include http://*.staemme.ch/game.php?*screen=info_village&id=*
// ==/UserScript==
