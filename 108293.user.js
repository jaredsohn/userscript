...
const VERSION = '2.4.4 BETA';
const scriptlink = 'http://userscripts.org/scripts/show/108293'
...
if(deffenders.length>1) {results += 'es'; }
	...
	report += '<br/>[b][i]Compactado con: [url=' + scriptlink + ']Combat Report Auto-Converter[/url] v' + VERSION + ' © by [url=http://board.ikariam.es/index.php?page=User&userID=47984]WTF[/url], Modificado por [url=http://board.ve.ikariam.com/index.php?page=User&userID=6243]Madacol[/url][/i][/b]';
