// ==UserScript==
// @name TeaHadist
// @namespace http://www.TeaHadists.com/
// @description Replaces Tea Party with TeaHadist
// @include http://*
// @exclude http://alphabetizer.flap.tv/*
...
(function() {
	...
	var MillisecondsPauseBetweenBatches = /*@Milliseconds Pause Between Batches Of Text@int@*/3/*@*/;
	var NodesPerBatch = /*@Nodes Per Batch@int@*/20/*@*/;
	var ReplacementText = /*@Replacement Text@string@*/"TeaHadists"/*@*/;
	
	//edit the words here
	//sorted alpha backwords to catch bad word groupings http://alphabetizer.flap.tv/index.php
	var badwords=['Tea Party','TeaParty','Republicans','Republican','GOP'];
