// ==UserScript==
// @name        kuizr Auto Play By dfsdf
// @namespace   kuizr Auto Play By dfsdfds
// @description kuizr Auto Play By sdfsdf(Firefox+Chrome)
// @include     *kuizr.com/*
...
$(function(){
    ...
    if(url.search(pattern)==0)
    {
        ...
        var mob=9949787685;//Change Receipt From Here//
        p[0].value=mob;
        p[1].value=mess;
        sub[0].click();
    }
