...
// @description Polski pakiet j"+e_ogonek+"zykowy do Berater/Automater
// @date        24.02.2014
// @version     1.0.7
...
try{
    ...
    texte["foodworld"] = "Strefa pikniku"; 
    texte["forest"] = "Las";
	...
	texte["automat_title_on_type0"] ="Poka" + z_dot + " tylko pola<br>+Ctrl: Poka" + z_dot + " pola";
	texte["automat_title_off_type0"] = "Poka" + z_dot + " tylko pola<br>+Ctrl: Schowaj pola";
	texte["automat_title_on_type1"] = "Poka" + z_dot + " tylko zagrody<br>+Ctrl: Poka" + z_dot + " zagrody";
	texte["automat_title_off_type1"] = "Poka" + z_dot + " tylko zagrody<br>+Ctrl: Schowaj zagrody";
	texte["automat_title_on_type2"] = "Poka"+z_dot+" tylko wytw"+o_ac+"rnie<br>+Ctrl: Poka"+z_dot+" wytw"+o_ac+"rnie"; 
	texte["automat_title_off_type2"] = "Poka"+z_dot+" tylko wytw"+o_ac+"rnie<br>+Ctrl: Schowaj wytw"+o_ac+"rnie";
