...
var userGuideHTML = (<div id='ug-top' style="padding:15px;padding-top:5px;">
        ...
        <fieldset><legend><b>CONTENTS</b></legend>
               ...
               <a style='color:#333399;' href='#ug-gameplay'>GAMEPLAY</a>
                       ...
                       |  <a style='color:#333399;' href='#ug-Reinforce-phase'>reinforcement Phase</a>
        </fieldset>
        <br/><br/>
               ...
               <fieldset><legend id='ug-appearance'><b>Appearance</b></legend>
                       ...
                       <ul>
                               ...
                               <li>
                                      ...
                                      Regions--but only if that Regions is Assaultable from your own currently selected Regions.
                               </li>
                               <li>
                                      <i><b>Show From-Regions Marker:</b></i>                [ <b>Y</b> or <b>N</b> ] <br/>
                                      If set to 'Y', then a pulsing circle will appear over your currently selected Regions during
                                      Assault, advance, and reinforcement phases.
                               </li>
                               <li>
                                      <i><b>Show Advance-To Marker:</b></i>                         [ <b>Y</b> or <b>N</b> ] <br/>
                                      If set to 'Y', then after conquering a Regions, a small, flashing yellow circle will appear over that
                                      Regions until troops have been advanced.
                               </li>
                               <li>
                                      <i><b>Show Floating Troop Counter Over Map:</b></i>   [ <b>Y</b> or <b>N</b> ] <br/>
                                      If set to 'Y', then during the deploy, advance, and reinforcement phases, a small gray box will appear next to
                                      the Regions that is under the mouse pointer indicating how many troops are currently selected to deploy,
                               ...
                               <li>
                                      ...
                                      Regions to show what will happen when the mouse is clicked (if no tool-tip appears, then it is
                                      probably because the Regions being moused over cannot be acted upon, or because the mouse was not held
               ...
               <fieldset><legend id='ug-confirmations'><b>Confirmations</b></legend>
                               ...
                               <ul>
                                      <li>
                                              ...
                                              If set to 'Y', then every time you attempt to deploy troops on a Regions, a confirmation message will
                                      ...
                                      <li>
                                              ...
                                              If set to 'Y', then every time you attempt to Assault an enemy Regions, a confirmation message will
                                              appear with the Assaulting Regions and the target Regions.  This gives you a chance to cancel an
                                              Assault move and try again.
                                      </li>
                                      <li>
                                              <i><b>Confirm Auto-Assault?</b></i>   [ <b>Y</b> or <b>N</b> ] <br/>
                                              If set to 'Y', then every time you attempt to auto-Assault an enemy Regions, a confirmation message will
                                              appear with the Assaulting Regions and the target Regions.  This gives you a chance to cancel an
                                              auto-Assault move try again.
                                      </li>
                                      <li>
                                              <i><b>Confirm Advance?</b></i>        [ <b>Y</b> or <b>N</b> ] <br/>
                                              If set to 'Y', then every time you attempt advance troops to a conquered Regions, a confirmation
                                      ...
                                      <li>
                                              ...
                                              If set to 'Y', then every time you attempt to Reinforce troops from one Regions to another, a
                                              confirmation message will appear with the number of troops to be reinforced, the source Regions and the
                                              destination Regions.  This gives you a chance to cancel a reinforcement move and try again.
                                      </li>
                                      <li>
                                              <i><b>Confirm Phase End?</b></i>      [ <b>Y</b> or <b>N</b> ] <br/>
                                              If set to 'Y', then when 'End Assaults' or 'End reinforcement' is clicked, a
                                              confirmation message will appear offering you a chance to cancel.  A confirmation will also appear when
                                              attempting to Reinforce (unless reinforcement are set to 'unlimited').
                                      </li>
                               </ul>
                       ...
                       to that of the key that was pressed.</b></i>
                               <ul>
                                      <li>
                                              ...
                                              reinforcement' during the reinforcement phase.
                                      </li>
                                      <li>
        ...
        <fieldset id='ug-gameplay' style="color:#333399;"><legend><b>GAMEPLAY</b></legend>
               <fieldset><legend id='ug-deploy-phase'><b>Deploy Phase</b></legend>
                       <ul>
                               <li>
                                      Mouse over the Regions you want to deploy troops on. If the <a href='#ug-appearance'>Show Troop
                                      ...
                                      usual).  The counter will remain visible until you move your mouse away from the Regions. The counter
                               ...
                               <li>
                                      If you only want to deploy one troop at a time, then click on the desired Regions with the mouse button
                                      that is configured to deploy only 1 troop. Otherwise, once the desired number of troops is selected, click
                                      the Regions to deploy on using the mouse button that is configured to deploy the selected number of troops.
               ...
               <fieldset><legend id='ug-Assault-phase'><b>Assault Phase</b></legend>
                       <ul>
                               <li>
                                      First select the Regions that you want to Assault from by clicking on it (either right- or left-click). If
                                      the <a href='#ug-appearance'>Show From-Regions Marker</a> option is enabled, then a pulsing, red circle
                                      will appear around the Regions, showing that it is now selected as the Assaulting Regions. If not, then
                                      you can see which Regions is selected as the Assaulting Regions by looking in the action menu, as usual.
                                      If the Regions clicked does not become the Assaulting Regions (i.e. the from-Regions marker and/or
                                      action menu does not update), it is probably because that Regions is unable to make Assaults.
                               </li>
                               <li>
                                      Once the Assaulting Regions is selected, click an enemy Regions to Assault it. <b>Left-clicking</b> will
                               ...
                               <li>
                                      ...
                                      enter the minimum number of troops to leave on the Assaulting Regions (to be sure that the number of troops
                               ...
                               <li>
                                      <b>Auto-Advance</b>. If the <b>ALT</b> key is held while auto-Assaulting, then all remaining troops on the Assaulting Regions will
                                      be automatically advanced to the conquered Regions.  Works in conjunction with Auto-Assault[x].
                               </li>
                       </ul>
               ...
               <fieldset><legend id='ug-advance-phase'><b>Advance Phase</b></legend>
                       <ul>
                               <li>
                                      After conquering an enemy Regions, moving the mouse cursor over either the Assaulting Regions or the 
                                      conquered Regions will cause the <a href='#ug-troop-counter'>floating troop counter</a> to appear (if
                                      enabled). Use the <a href='#ug-controls'>mouse wheel or configured hotkeys</a> to select the number of
                                      troops to advance, then        click on the Regions just conquered to advance those troops.
                               </li>
                               <li>
                                      Clicking on the Regions that was just Assaulted <i>from</i> will always advance zero troops.
                               </li>
                               <li>
                               ...
                               <li>
                                      ...
                                      circle will    appear on the Regions that was just conquered.
                               </li>
                               <li>
               ...
               <p style='width:100%;text-align:right;'><a href='#ug-top'>[back to top]</a></p>
               <fieldset><legend id='ug-Reinforce-phase'><b>reinforcement Phase</b></legend>
                       <ul>
                               <li>
                                      Select the Regions that you want to Reinforce troops from by <b>left-clicking</b> on it. If
                                      the <a href='#ug-appearance'>Show From-Regions Marker</a> option is enabled, then a pulsing, green circle
                                      will appear around the Regions, showing that it is now selected as the source Regions. If not, then
                                      you can see which Regions is selected as the source Regions by looking in the action menu, as usual.
                                      If the Regions clicked does not become the source Regions (i.e. the from-Regions marker and/or
                                      action menu does not update), it is probably because that Regions is unable to be reinforced from.
                               </li>
                               <li>
                                      Mouse over the Regions you want to Reinforce troops to. If the <a href='#ug-appearance'>Show Troop
                                      Counter</a> option is enabled, then a small box will appear next to your cursor letting you know how many
                               ...
                               <li>
                                      Once the source Regions and the desired number of troops are selected, <b>right-click</b> (or hold
                                      <b>SHIFT</b> while left-clicking) the Regions you want to Reinforce troops to.
                               </li>
                               <li>
                                      If the <a href='#ug-confirmations'>Confirm Phase End</a> option is enabled and reinforcement for the current
                                      game are set to either <b>adjacent</b> or <b>chained</b>, then you will be warned that the reinforcement
                                      move will end your turn, and you will have a chance to cancel the move if desired.
                               </li>
                       </ul>
               </fieldset> <!-- end reinforcement phase -->
...
function updateXML(){
        ...
        GM_xmlhttpRequest({method: 'GET',url: 'http://www.conquerclub.com/maps/'+mapName+'.xml',headers: {'User-agent': 'Mozilla/4.0 (compatible) Greasemonkey/0.3' , 'Accept': 'application/xml,text/xml'},
               onload: function(response) {
                       ...
                       // get all "coordinates" tags since only Regionss will have coordinates sub tags, then assign the parentNodes to the cm_Regionss array.
                       c = new Array()
                       c = dom.getElementsByTagName('coordinates')
                       for (i=0;i<c.length;i++) {
                               cm_Regionss[i]=c[i].parentNode
                               // debug(cm_Regionss[i].getElementsByTagName('name')[0].textContent)
                       }
...
function updateAction() {
        ...
        // refresh the map and reload all Regionss
        oldMapSize = mapSize
        ...
        // set fromRegions and toRegions
        try {
               fromRegionsNum = document.getElementById('from_Regions').value
               fromRegions    = cm_Regionss[parseInt(fromRegionsNum)].getElementsByTagName('name')[0].textContent
        } catch(err){fromRegions = ''}
        try{
               toRegionsNum = document.getElementById('to_Regions').value
               toRegions    = cm_Regionss[toRegionsNum].getElementsByTagName('name')[0].textContent
        } catch(err){toRegions   = ''}
        ...
        if ( actionString.match('Advance') ) {
               ...
               doAction = 'Advance'
               AssaultedFromRegions = actionString.split(' from ')[1].split(' to ')[0]
               fromRegions = AssaultedFromRegions
               AssaultedToRegions = actionString.split(' to ')[1].split('<input')[0].replace('\n', '')
                if ( userPrefs['showFloatingQuantity'] == 'Y' ) {
                        floatingQuantity.style.visibility = 'visible'
               }
        }
        if ( actionString.match('Reinforce') || actionString.match('You cannot make any reinforcements.') ) {
               outerMap.style.borderColor = '#00ff00'
               doAction = 'Reinforce'
        }
        debug('new action: '+doAction)
        
        debug("fromRegions == '"+fromRegions+"' && toRegions == '"+toRegions+"'")
        if ( fromRegions == '' && toRegions == '' ) {
               if ( doAction == 'Advance' ) {
                       advanceFromMarker.style.visibility = 'visible'
               }
               debug('no from or toRegions. returning')
               return
        }
        for (i=0;i<cm_Regionss.length;i++) {
               title = cm_Regionss[i].getElementsByTagName('name')[0].textContent
               tX    = cm_Regionss[i].getElementsByTagName( mapx )[0].textContent
               tY    = cm_Regionss[i].getElementsByTagName( mapy )[0].textContent
               if ( title == fromRegions ) {
                       setCursor('pointer')
                       fromRegions_troops = troops[i].split('-')
                       if ( selectedQuantity >= parseInt(fromRegions_troops[1]) ) {
                               updateSelectedQuantity(parseInt(fromRegions_troops[1])-1)
                       }
                       remainingTroops = fromRegions_troops[1]
...
function updateMap(RegionsNumber, playerNumber, tTroops) {
        ...
        switch ( doAction ) {
               ...
               case 'Advance':
                       ...
                       } else if ( title == AssaultedToRegions ) { 
                               q = selectedQuantity
                               if ( userPrefs['showToolTips'] == 'Y' ) {
               ...
               case 'Assault':
                       if ( playerNumber == currentPlayerNumber ) {
                               if ( tTroops == 1 ) { return }
                               setCursor('pointer')
                               if ( userPrefs['showToolTips'] == 'Y' && title != fromRegions ) {
                                      t = 'Left-click: Set '+title+' as From-Regions.'
                                      try{document.getElementById('magicmap').title
                                                                     = t}catch(err){}
                                      crosshair.title = t
                                      innerMap.title  = t
                       ...
                       try {
                               document.getElementById('to_Regions').value = RegionsNumber
                       } catch (err) {return}
                       if ( document.getElementById('to_Regions').value != RegionsNumber ) {return}
                       setCursor('pointer')
                       ...
                       if ( userPrefs['showToolTips'] == 'Y' ) {
                               t = 'Left-click: Assault from '+fromRegions+' to '+title+'. Right-click/Shift-click: Auto-Assault.'
                               try{document.getElementById('magicmap').title
                                                             = t}catch(err){}
                               crosshair.title = t
                               innerMap.title  = t
               ...
               case 'Reinforce':
                       ...
                       if ( playerNumber == currentPlayerNumber ) {
                               setCursor('pointer')
                               if ( userPrefs['showToolTips'] == 'Y' ) {
                                      t = 'Right-click/Shift-click: Reinforce '+selectedQuantity+' troops from '+fromRegions+' to '+title
...
function onMapMouseMove(e) {
        ...
        for (i=0;i<cm_Regionss.length;i++) {
               ...
               if ( tX > mouseOverX - 15 && tX < mouseOverX + 15 && tY > mouseOverY - 15 && tY < mouseOverY + 15 ) {
                       // if we're over any Regions...
                       overRegions             = cm_Regionss[i]
                       tIndex                         = i
        ...
        if ( ! overRegions ) { return false }
        tName = overRegions.getElementsByTagName('name')[0].textContent
        return false
}
function onMapClick(e) {
        ...
        // see if a Regions was clicked
        for (i=0;i<cm_Regionss.length;i++) {
               title = cm_Regionss[i].getElementsByTagName('name')[0].textContent
               tX    = cm_Regionss[i].getElementsByTagName( mapx )[0].textContent
               tY    = cm_Regionss[i].getElementsByTagName( mapy )[0].textContent
               if ( tX > clickX - 15 && tX < clickX + 15 && tY > clickY - 15 && tY < clickY + 15 ) {
                       clickedRegions  = cm_Regionss[i]
                       tIndex                         = i
                       tTroops                        = troops[i].split('-')
                       playerNumber           = tTroops[0]
                       break
        ...
        if ( ! clickedRegions ) { debug('no Regions clicked. x:'+clickX+' y:'+clickY); wait('off'); return false }
        
        if ( e.button == 0 && ! e.shiftKey ) {
               try{document.getElementById('from_Regions').value = tIndex}catch(err){}
        }
        ...
        tName = clickedRegions.getElementsByTagName('name')[0].textContent
        
        try {          fromRegions = cm_Regionss[document.getElementById('from_Regions').value].getElementsByTagName('name')[0].textContent
        }catch(err){fromRegions = ''}
        
        try {          toRegions   = cm_Regionss[document.getElementById('to_Regions').value].getElementsByTagName('name')[0].textContent
        }catch(err){toRegions   = ''}
        
        try{selectFromRegions   = document.getElementById('from_Regions')}catch(err){}
        try{selectToRegions             = document.getElementById('to_Regions')}catch(err){}
        ...
        switch(doAction) {
               case 'Deploy':
                       selectToRegions.value = tIndex
                       if ( selectToRegions.value != tIndex ) { wait('off'); return } // an enemy Regions was clicked during deployment
                       toRegions = tName
                       if ( deployDeferred ) {
                               troopsLeftToDeploy        = actionString.split(' ')[2]
                               confirmMessage                   = 'Deploy '+troopsLeftToDeploy+' troops on '+toRegions+'?'
                       ...
                       if ( e.button == 2 ) { //right click
                               if ( userPrefs['deploymentClicks'] == 'Left-1 Right-Selected' ) {
                                      confirmMessage = 'Deploy '+selectQuantity.value+' troops on '+toRegions+'?'
                               } else {
                                      selectQuantity.value   = "1"
                                      confirmMessage                 = 'Deploy 1 troop on '+toRegions+'?'
                               }
                       } else if ( e.shiftKey ) {
                               troopsLeftToDeploy      = actionString.split(' ')[2]
                               selectQuantity.value   = troopsLeftToDeploy
                               confirmMessage                 = 'Deploy all '+troopsLeftToDeploy+' troops on '+toRegions+'?'
                       } else {
                               if ( userPrefs['deploymentClicks'] == 'Left-1 Right-Selected' ) {
                                      selectQuantity.value   = "1"
                                      confirmMessage                 = 'Deploy 1 troop on '+toRegions+'?'
               ...
               break
               case 'Assault':
                       if ( fromRegions == '' || toRegions == '' ) { wait('off'); return }
                       
                       // if freindly, then set from_Regions and return
                       if ( playerNumber == currentPlayerNumber ) {
                               if ( tTroops[1] == 1 ) { wait('off'); return }
                               // try to set from_Regions, but if there is an error (which would happen if a freindly Regions was clicked with no Assaultable enemies around it), then return
                               try{selectFromRegions.value = tIndex}catch(err){wait('off'); return}
                               try{unsafeWindow.filterTo(tIndex)}catch(err){}
                               if ( selectFromRegions.value != tIndex ) { wait('off'); return }
                               fromRegions = tName
                               wait('off')
                               return
                       // if enemy, set as to_Regions and continue to Assault
                       } else {
                               try{selectToRegions.value       = tIndex}catch(err){}
                               if ( selectToRegions.value != tIndex ) { wait('off'); setTimeout(function(){alert(tName+' is not accessible from '+fromRegions)}, 500); return }
                               if ( e.button == 2 || e.shiftKey ) {
                                      doAction = 'Auto-Assault'
                                      if ( e.ctrlKey ) {
                                              // this is an Auto-Assault[x]   (doAction will remain 'Assault')
                                              minTroops              = prompt('Enter the minimum number of troops to remain on the Assaulting Regions:')
                       ...
                       confirmMessage = doAction+' from '+fromRegions+' to '+toRegions+'?'
 
                       AssaultedFromRegions = fromRegions
               break
               case 'Advance':
                       if ( ! document.getElementById('quantity') ) { wait('off'); return }
                       debug('AssaultedFromRegions: '+AssaultedFromRegions)
                       toRegions = tName
                       if ( toRegions == '' ) { wait('off'); return }
                       if ( toRegions != AssaultedToRegions && toRegions != AssaultedFromRegions ) { wait('off'); return }
                       if ( toRegions == AssaultedFromRegions ) { selectQuantity.value = '0'; numTroops = '0'; }
               ...
               case 'Reinforce':
                       ...
                       if ( e.button == 2 || e.shiftKey ) {
                               ...
                               selectFromRegions.value = tIndex
                               fromRegions                     = tName
                               toRegions                              = ''
                               try{unsafeWindow.filterTo(tIndex)}catch(err){}
                               wait('off')
                       ...
                       if ( fromRegions == '' || toRegions == '' ) { wait('off'); return }
                       confirmMessage = 'Reinforce '+numTroops+' troops from '+fromRegions+' to '+toRegions+'?'
               break
        }
        ...
        switch ( e.which ) {
               case parseInt(userPrefs['phaseEndHotkey']) :
                       ...
                       if ( doAction == 'Reinforce' ) {
                               unsafeWindow.sendRequest("End reinforcement")
                       }
                       return
               break
...
function updateSelectedQuantity(q) {
        ...
        if ( parseInt(selectQuantity.value) >= parseInt(fromRegions_troops[1]) ) {
               selectQuantity.value = parseInt(fromRegions_troops[1]) - 1
        }
...
unsafeWindow.sendRequest = function(_cmd) {
        ...
        if ( _cmd == 'Reinforce' && reinforcementType != 'Unlimited' ) {
        ...
        if ( _cmd == 'End Assaults' || _cmd == 'End reinforcement' ) {
               if ( userPrefs['confirmPhaseEnd'] == 'Y' ) {
...
function initialize() {
        ...
        if ( document.getElementById('dashboard').innerHTML.match('reinforcements: <b>Unlimited</b>') ) {
               reinforcementType   = 'Unlimited'
        } else {
               reinforcementType     = ''
        }
        debug('reinforcementType: '+reinforcementType)
        // get teams
        try{
