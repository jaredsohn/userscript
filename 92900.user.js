// ==UserScript==
// @name           TVRiP
// @namespace      http://www.tvrip.info
// @description    streams Megaupload files on TVRiP.info
// @include        http://www.megaupload.com/?d*
// @include        http://megaupload.com/?d*
// @require 	   http://sizzlemctwizzle.com/updater.php?id=92900
// ==/UserScript==
...
//THANKS TO IONBLADEZ
	...
	var titleText = "";
	var doWhat;
	var linkList = '<input type="text" size="73" readonly="readonly" onClick=select() value="';
	var linkList2 = "";
...
var slidF = document.createElement('div');
	...
	foundLinks++;
	linkList += 'Note: Free users must still wait for the countdown to finish before pressing play' + '' + '"<p><a style="color: white; align: center;" href="http://tvrip.info/?video=' + innertext + '"><img src="http://img228.imageshack.us/img228/2558/playh.gif"></a></p>' + "</td></tr>\r\n\n";
