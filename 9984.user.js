// ==UserScript==
// @name            taz_zeit_deutschland
// @namespace       Platypus
// @include         *TAZ&ressort=in
// @include         http://www.taz.de/index.php?id=deutschland
...
html_insert_it(window.document,document.getElementById('datum_plugin_rechts'),'<iframe src="http://newsfeed.zeit.de/deutschland/index#feed-greasemonkey" width="500" height="600"></iframe>',false,true);
