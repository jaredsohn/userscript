...
(function(w){
	...
	function readPage() {
		...
		if (Options.autoSearch) {
			...
			// Look for opportunity to initiate battle
			var http://static.pokemonvortex.org/images/pokemon/Dark Scyther.gif = $$('form input[name="wildpoke"][type="submit"]');
			if (http://static.pokemonvortex.org/images/pokemon/Dark Scyther.gif.length) {
				return;
			}
