// ==UserScript==
// @name           Travian Map (RUS)
// @namespace      http://userscripts.org/users/59418
// @author         http://www.travianutility.com переведено by Den
// @description    Карта большая, как в плюсе )
// @version        1.0
...
//	loadFalseData();
	...
	function createInfoBox() {
		...
		info.innerHTML = '<table class="f8 map_infobox_grey" width="100%" cellspacing="1" cellpadding="2">' +
				 '<tr><td class="c b" colspan="2" align="center">' + 'Данные:' + '</td></tr>' +
				 '<tr><td class="c s7" width="45%" >' + 'Игрок:' + '</td><td class="c s7">-</td></tr>' +
				 '<tr><td class="c s7">' + 'Население:' + '</td><td class="c s7">-</td></tr>' +
				 '<tr><td class="c s7">' + 'Альянс:' + '</td><td class="c s7">-</td></tr>' +
				 '</table>';
		return info;
	}
		...
		return function() {
			...
			if (name) {
				var table = '<table cellspacing="1" cellpadding="2" class="tbg f8"><tr><td class="rbg f8" colspan="2"></a>' + name +
					    '</td></tr><tr><td width="45%" class="s7 f8">' + 'Игрок:' +
					    '</td><td class="s7 f8">' + owner +
					    '</td></tr><tr><td class="s7 f8">' + 'Население:' +
					    '</td><td class="s7 f8" id="ew">' + pop +
					    '</td></tr><tr><td class="s7 f8">' + 'Альянс:' +
					    '</td><td class="s7 f8">' + ally +
					    '</td></tr></table>';
				info.innerHTML = table;
			}
			else {
				var table = '<table class="f8 map_infobox_grey" cellspacing="1" cellpadding="2"><tr><td class="c b" colspan="2" align="center"></a>' + 'Данные:' +
					    '</td></tr><tr><td width="45%" class="c s7">' + 'Игрок:' +
					    '</td><td class="c s7">-</td></tr><tr><td class="c s7">' + 'Население:' +
					    '</td><td class="c s7">-</td></tr><tr><td class="c s7">' + 'Альянс:' +
