...
var Settings={
	default:{
	  ...
	  utt_strength_weakness:true, // StÃ¤rken und SchwÃ¤chen der Wesen in den Tooltips anzeigen
    ...
    guard_info:true,            // WÃ¤chtervorschau anzeigen
    guard_info_full:true,       // komplette WÃ¤chtervorschau
    guard_info_no_defeat:false, // Niederlage ausblenden
	  shaman:true,                // Extra-Infos fÃ¼r die SchamanenhÃ¼tte
	  hero_sorting:true,          // Helden nach EP sortieren
	  hero_pos_to_map:true,       // Helden-Position in Karte Ã¼bernehmen
  	res_calc:true,              // Produktionsberechnung zu den ProduktionsgebÃ¤uden hinzufÃ¼gen
  	cave_warning:false,         // KapazitÃ¤t der Geheimen Grotte im Resourcenlager Ã¼berwachen
	  br_info:true,               // umfassende Analyse der Kampfberichte hinzufÃ¼gen
	  br_info_basedata:true,      // Basiswerte
	  br_info_shaman:true,        // SchamanenhÃ¼tte
  ...
  data:{},
    ...
    $("#content").html("<h1>Extra<small> - Einstellungen fÃ¼r das Xhodon-Addon</small></h1><div class='profileTableContent paddingContent'>"+html_extra+"</div>");
  ...
  settingsFeature:function(options,indentation) {
      ...
      subcheckboxes:[
        {
        	...
        	text: "Titel anzeigen",
      		type:"checkbox",
        	tooltip:"Einen Titel mit grÃ¶sserem Einheiten-Bild, Einheiten-Namen und der Anzahl anzeigen."
        },
        {
        ...
        },
        {
        	...
        	text:"St&auml;rken/Schw&auml;chen anzeigen",
      		type:"checkbox",
        	tooltip:"StÃ¤rken/SchwÃ¤chen-Information in den Tooltips anzeigen."
        },
      ],
    },
    'xAddon_unit_totals':{
    ...
    'xAddon_guard_info':{
      ...
      text:"WÃ¤chter-Info anzeigen",
      type:"checkbox_group",
      tooltip: "Auf der Held Beladen-Seite werden zusÃ¤tzliche WÃ¤chter-Info angezeigt.\nDie WÃ¤chter-Referenzen werden aus den KB ermittelt.",
      img:["unit","default"],
      subcheckboxes:[
        {
        	id:"xAddon_guard_info_full",
        	text: "komplette WÃ¤chter-Vorschau anzeigen",
      		type:"checkbox",
        	tooltip:"Die komplette WÃ¤chter-Vorschau ab sehr gutem Sieg anzeigen."
        },
        {
        	id:"xAddon_guard_info_no_defeat",
        	text:"WÃ¤chter bei Niederlage nicht anzeigen",
      		type:"checkbox",
        	tooltip:"Die WÃ¤chterstufe, bei der der Held unterlegen ist, nicht anzeigen."
        },
      ]
    },
    'xAddon_shaman':{
      id:"xAddon_shaman",
      text:"Extra-Infos in der SchamanhÃ¼tte",
  		type:"checkbox",
      tooltip:"Zeigt weitere Infos in der SchamanenhÃ¼tte an, z.B. insgesamt benÃ¶tigte Pilze fÃ¼r die Wiederbelebung.",
    ...
    'xAddon_hero_pos_to_map':{
      ...
      text:"Heldenposition ins Auge Ã¼bernehmen",
  		type:"checkbox",
    ...
    'xAddon_res_calc':{
      ...
      text:"Rohstoffe pro Stunde / Tag / beliebig anzeigen",
  		type:"checkbox",
      tooltip:"In den Rohstoff-GebÃ¤ude-Seiten werden Werte in andere Zeiteinheiten umgerechnet.",
      img:["image","essenz.png"]
    },
    'xAddon_cave_warning':{
      id:"xAddon_cave_warning",
      text:"KapazitÃ¤t der Geheimen Grotte im Resourcenlager Ã¼berwachen",
  		type:"checkbox",
      tooltip:"Warnt, wenn der Lagerinhalt nicht in die Geheime Grotte passt.",
    },
    'xAddon_br_info':{
      id:"xAddon_br_info",
      text:"zusÃ¤tzliche Analyse der Kampfberichte",
      type:"checkbox_group",
      tooltip:"Zeigt zusÃ¤tzliche Infos in den Kampfberichten.",
      subcheckboxes:[
        {
        ...
        },
        {
        	...
        	text:"SchamanenhÃ¼tte",
      		type:"checkbox",
        	tooltip:"Bedarf an Pilzen und Kraftsteinen sowie die zugehÃ¶rigen Punkte werden angezeigt."
        },
        {
        	id:"xAddon_br_info_score",
        	text:"Machtliste",
      		type:"checkbox",
        	tooltip:"Die Gesamtpunktzahl fÃ¼r die Machtliste wird angezeigt."
        },
      ]
    },
    'xAddon_format_tick':{
...
var BaseData={
  ...
  unitData:{
      ...
      "elven_archer":          {id:"elven_archer",         name:'ElfenbogenschÃ¼tzen',      attack: 17,defense: 19,live:  64,speed: 2,points:  40,reviveMushrooms:  21,revivePowerStones:   840,strength:"",weakness:"",s_data:[],w_data:[]},
      ...
      "creep_23":              {id:"creep_23",             name:"SkrÃ¤linge",               attack:  4,defense:  4,live:  28,speed: 4,points:   1,reviveMushrooms:   0,revivePowerStones:     0,strength:"",weakness:"",s_data:[],w_data:[]},
      ...
      "creep_30":              {id:"creep_30",             name:"WerwÃ¶lfe",                attack:  9,defense:  9,live:  62,speed: 4,points:   2,reviveMushrooms:   0,revivePowerStones:     0,strength:"",weakness:"",s_data:[],w_data:[]},
      ...
      "creep_33":              {id:"creep_33",             name:"WeiÃŸadler",               attack: 12,defense: 12,live:  97,speed: 4,points:   3,reviveMushrooms:   0,revivePowerStones:     0,strength:"",weakness:"",s_data:[],w_data:[]},
      ...
      "creep_38":              {id:"creep_38",             name:"DÃ¤mon",                   attack: 17,defense: 17,live: 143,speed: 4,points:   5,reviveMushrooms:   0,revivePowerStones:     0,strength:"",weakness:"",s_data:[],w_data:[]},
      ...
      "creep_48":              {id:"creep_48",             name:"SandwÃ¼rmer",              attack: 50,defense: 50,live: 450,speed: 5,points:  15,reviveMushrooms:   0,revivePowerStones:     0,strength:"",weakness:"",s_data:[],w_data:[]},
      ...
      "elven_archer":          {id:"elven_archer",         name:'ElfenbogenschÃ¼tzen',      attack: 15,defense: 17,live:  58,speed: 4,points:  36,reviveMushrooms:  21,revivePowerStones:   840,strength:"",weakness:"",s_data:[],w_data:[]},
      ...
      "creep_30":              {id:"creep_30",             name:"WerwÃ¶lfe",                attack:  9,defense:  9,live:  56,speed: 4,points:   2,reviveMushrooms:   0,revivePowerStones:     0,strength:"",weakness:"",s_data:[],w_data:[]},
      ...
      "creep_33":              {id:"creep_33",             name:"WeiÃŸadler",               attack: 12,defense: 12,live:  88,speed: 4,points:   3,reviveMushrooms:   0,revivePowerStones:     0,strength:"",weakness:"",s_data:[],w_data:[]},
      ...
      "creep_38":              {id:"creep_38",             name:"DÃ¤mon",                   attack: 17,defense: 17,live: 130,speed: 4,points:   5,reviveMushrooms:   0,revivePowerStones:     0,strength:"",weakness:"",s_data:[],w_data:[]},
      ...
      "creep_48":              {id:"creep_48",             name:"SandwÃ¼rmer",              attack: 50,defense: 50,live: 390,speed: 5,points:  15,reviveMushrooms:   0,revivePowerStones:     0,strength:"",weakness:"",s_data:[],w_data:[]},
      ...
      "elven_archer":          {id:"elven_archer",         name:'ElfenbogenschÃ¼tzen',      attack: 17,defense: 19,live:  64,speed: 3,points:  40,reviveMushrooms:  21,revivePowerStones:   840,strength:"",weakness:"",s_data:[],w_data:[]},
      ...
      "fire_fay":              {id:"fire_fay",             name:'Feuerfeen',               attack: 19,defense: 19,live:  23,speed: 1,points:  30,reviveMushrooms:  19,revivePowerStones:   760,strength:"",weakness:"",s_data:[],w_data:[]},
      "storm_faerie":          {id:"storm_faerie",         name:'Sturmfeen',               attack:  1,defense:  8,live:  65,speed: 1,points:  33,reviveMushrooms:  20,revivePowerStones:   800,strength:"",weakness:"",s_data:[],w_data:[]},
      "dragon":                {id:"dragon",               name:'Drache der Alten',        attack:  0,defense:  0,live: 100,speed:10,points:9004,reviveMushrooms:12000,revivePowerStones:240000,strength:"",weakness:"",s_data:[],w_data:[]},
      "creep_17":              {id:"creep_17",             name:"Salamander",              attack:  1,defense:  1,live:   4,speed: 4,points:   1,reviveMushrooms:   0,revivePowerStones:     0,strength:"",weakness:"",s_data:[],w_data:[]},
      "creep_18":              {id:"creep_18",             name:"Wurzelwichte",            attack:  0,defense:  1,live:   8,speed: 2,points:   1,reviveMushrooms:   0,revivePowerStones:     0,strength:"",weakness:"",s_data:[],w_data:[]},
      "creep_19":              {id:"creep_19",             name:"Fleischhummeln",          attack:  2,defense:  2,live:  12,speed: 4,points:   0,reviveMushrooms:   0,revivePowerStones:     0,strength:"",weakness:"",s_data:[],w_data:[]},
      "creep_20":              {id:"creep_20",             name:"Skarabaeus",              attack:  2,defense:  2,live:  16,speed: 4,points:   0,reviveMushrooms:   0,revivePowerStones:     0,strength:"",weakness:"",s_data:[],w_data:[]},
      ...
      "creep_24":              {id:"creep_24",             name:"Warzengiftratten",        attack:  4,defense:  4,live:  32,speed: 4,points:   1,reviveMushrooms:   0,revivePowerStones:     0,strength:"",weakness:"",s_data:[],w_data:[]},
      "creep_25":              {id:"creep_25",             name:"Sylphen",                 attack:  5,defense:  5,live:  36,speed: 4,points:   1,reviveMushrooms:   0,revivePowerStones:     0,strength:"",weakness:"",s_data:[],w_data:[]},
      "creep_26":              {id:"creep_26",             name:"Midgardschlangen",        attack:  0,defense:  5,live:  40,speed: 2,points:   2,reviveMushrooms:   0,revivePowerStones:     0,strength:"",weakness:"",s_data:[],w_data:[]},
      "creep_27":              {id:"creep_27",             name:"Nymphen",                 attack:  6,defense:  6,live:  44,speed: 4,points:   2,reviveMushrooms:   0,revivePowerStones:     0,strength:"",weakness:"",s_data:[],w_data:[]},
      "creep_28":              {id:"creep_28",             name:"Schlingpflanzen",         attack:  7,defense:  7,live:  48,speed: 4,points:   2,reviveMushrooms:   0,revivePowerStones:     0,strength:"",weakness:"",s_data:[],w_data:[]},
      "creep_29":              {id:"creep_29",             name:"Meerjungfrauen",          attack:  8,defense:  8,live:  52,speed: 4,points:   2,reviveMushrooms:   0,revivePowerStones:     0,strength:"",weakness:"",s_data:[],w_data:[]},
      "creep_30":              {id:"creep_30",             name:"WerwÃ¶lfe",                attack:  9,defense:  9,live:  56,speed: 4,points:   2,reviveMushrooms:   0,revivePowerStones:     0,strength:"",weakness:"",s_data:[],w_data:[]},
      ...
      "creep_34":              {id:"creep_34",             name:"Morlocks",                attack: 13,defense: 13,live: 100,speed: 4,points:   3,reviveMushrooms:   0,revivePowerStones:     0,strength:"",weakness:"",s_data:[],w_data:[]},
      "creep_35":              {id:"creep_35",             name:"Riesen Marokspinnen",     attack: 14,defense: 14,live: 110,speed: 4,points:   4,reviveMushrooms:   0,revivePowerStones:     0,strength:"",weakness:"",s_data:[],w_data:[]},
      "creep_36":              {id:"creep_36",             name:"Feuerteufel",             attack:  0,defense: 15,live:  90,speed: 2,points:   4,reviveMushrooms:   0,revivePowerStones:     0,strength:"",weakness:"",s_data:[],w_data:[]},
      "creep_37":              {id:"creep_37",             name:"Fenriswolf",              attack: 16,defense: 16,live: 120,speed: 4,points:   4,reviveMushrooms:   0,revivePowerStones:     0,strength:"",weakness:"",s_data:[],w_data:[]},
      "creep_38":              {id:"creep_38",             name:"DÃ¤mon",                   attack: 17,defense: 17,live: 130,speed: 4,points:   5,reviveMushrooms:   0,revivePowerStones:     0,strength:"",weakness:"",s_data:[],w_data:[]},
      "creep_39":              {id:"creep_39",             name:"Horngolems",              attack: 18,defense: 18,live: 140,speed: 5,points:   5,reviveMushrooms:   0,revivePowerStones:     0,strength:"",weakness:"",s_data:[],w_data:[]},
      "creep_40":              {id:"creep_40",             name:"Sonnenpferde",            attack: 19,defense: 19,live: 150,speed: 5,points:   6,reviveMushrooms:   0,revivePowerStones:     0,strength:"",weakness:"",s_data:[],w_data:[]},
      ...
      "creep_42":              {id:"creep_42",             name:"Greifen",                 attack: 22,defense: 22,live: 190,speed: 5,points:   7,reviveMushrooms:   0,revivePowerStones:     0,strength:"",weakness:"",s_data:[],w_data:[]},
      "creep_43":              {id:"creep_43",             name:"Blutalben",               attack: 23,defense: 23,live: 210,speed: 5,points:   7,reviveMushrooms:   0,revivePowerStones:     0,strength:"",weakness:"",s_data:[],w_data:[]},
      "creep_44":              {id:"creep_44",             name:"Zyklopen",                attack:  0,defense: 25,live: 160,speed: 2,points:   8,reviveMushrooms:   0,revivePowerStones:     0,strength:"",weakness:"",s_data:[],w_data:[]},
      "creep_45":              {id:"creep_45",             name:"Mantikoren",              attack: 28,defense: 28,live: 230,speed: 5,points:   9,reviveMushrooms:   0,revivePowerStones:     0,strength:"",weakness:"",s_data:[],w_data:[]},
      "creep_46":              {id:"creep_46",             name:"Behemoth",                attack: 35,defense: 35,live: 260,speed: 5,points:  10,reviveMushrooms:   0,revivePowerStones:     0,strength:"",weakness:"",s_data:[],w_data:[]},
      "creep_47":              {id:"creep_47",             name:"Oger",                    attack: 40,defense: 40,live: 300,speed: 5,points:  12,reviveMushrooms:   0,revivePowerStones:     0,strength:"",weakness:"",s_data:[],w_data:[]},
      "creep_48":              {id:"creep_48",             name:"SandwÃ¼rmer",              attack: 50,defense: 50,live: 390,speed: 5,points:  15,reviveMushrooms:   0,revivePowerStones:     0,strength:"",weakness:"",s_data:[],w_data:[]},
      "creep_49":              {id:"creep_49",             name:"Todesengel",              attack:  0,defense: 60,live: 400,speed: 2,points:  20,reviveMushrooms:   0,revivePowerStones:     0,strength:"",weakness:"",s_data:[],w_data:[]},
      "creep_50":              {id:"creep_50",             name:"Goldene Sphinx",          attack: 80,defense: 80,live: 630,speed: 5,points:  24,reviveMushrooms:   0,revivePowerStones:     0,strength:"",weakness:"",s_data:[],w_data:[]},
      "creep_51":              {id:"creep_51",             name:"Feuerstacheldrachen",     attack:100,defense:100,live: 700,speed: 5,points:  30,reviveMushrooms:   0,revivePowerStones:     0,strength:"",weakness:"",s_data:[],w_data:[]},
      "creep_52":              {id:"creep_52",             name:"Eisaugendrachen",         attack:150,defense:150,live:920,speed: 5,points:  40,reviveMushrooms:   0,revivePowerStones:     0,strength:"",weakness:"",s_data:[],w_data:[]},
      "creep_53":              {id:"creep_53",             name:"Schlangenhalsdrachen",    attack:200,defense:200,live:1200,speed: 5,points:  50,reviveMushrooms:   0,revivePowerStones:     0,strength:"",weakness:"",s_data:[],w_data:[]},
...
var GetSetData={
  ...
  Grotte:function() {
  	var cave=$(".cave").text();
  	var ressi=/Deine geheime Grotte schÃ¼tzt jeweils eine Menge von\s+([0-9\.]*)\s+all deiner Rohstoffe/i.exec(cave);
  	var mana=/ZusÃ¤tzlich schÃ¼tzt deine geheime Grotte\s+([0-9\.]*)\s+Mana/i.exec(cave);
...
var AddHTML={
    ...
    $("#palace_resources table tbody tr td a").each(function () {
      ...
      if (item.get(0).tagName=="A") {
        if (!item.hasClass("xAddonItem")) {
          ...
          var limit_total="<br>HÃ¤ndler-Limit: ";
          switch(typ) {
  ...
  adjustUnitTooltip:function (count_item,item,tooltip,count,infos,infos_one) {
    ...
    tooltip.find(".xAddon_ut_strength").html("<span class='xAddon_ut_label_sw'>StÃ¤rken:</span> "+infos.strength);
    tooltip.find(".xAddon_ut_weakness").html("<span class='xAddon_ut_label_sw'>SchwÃ¤chen:</span> "+infos.weakness);
  },
  ...
  addGuardInfo:function(totalValues) {
    ...
    var max_guard_level=(typeof(WÃ¤chter[0])=="undefined")?0:WÃ¤chter[0].maxGuard;
    if(max_guard_level==0) {
    	alert("Es sind aktuell keine WÃ¤chter-Referenzen gespeichert.\nBitte lest eure KB, um WÃ¤chter-Referenzen anzulegen.");
    	return;
    }
    var guard_level=1;
    ...
    while(true) {
    	if(typeof(WÃ¤chter[guard_level])!="undefined") {
        var values=WÃ¤chter[guard_level];
    ...
    var guard_html=function (rating_level,guard_level,guard_values,rating) {
    	...
    	html_extra+="<td class='xAddon_gi_level'>WÃ¤chter "+guard_level+":</td>";
    ...
    html_extra+="<td class='gray_first' colspan=5>WÃ¤chtervorschau <small style='font-weight:normal;'>- stÃ¤rkster bekannter WÃ¤chter: Level "+max_guard_level+"</small></td>";
  ...
  addSchamaneInfo:function(totalValues) {
    ...
    var mushroomInfo=(mushroomDiff<=0)
      ...
      :"(<span style='color:red;'>noch "+DataConvert.FormatNumber(mushroomDiff)+" verfÃ¼gbar in "+DataConvert.FormatTimeFromTicks(mushroomTicks)+" Stunden</span>)";
  ...
  insertMsgButtons:function() {
    ...
    $("#messagecontainer .message-bottom .stSubmitBtn").each(function() {
      var button=$(this);
      if (button&&button.text().indexOf("LÃ¶schen")!=-1) msg_href=button.attr('href');
  ...
  addBRInfo:function() {
    ...
    var html_orig_defense=html_orig.substring(pos_defense);
		...
		var count_defense=0;
		var html_defense=[];
		var patt=/Erfahrung:|WÃ¤chter Le|Palast/g;
		var offset=0;
    ...
    var color_green="#008800";
		...
		var addData=function(data,kl) {
			...
			switch(data.html()[0]) {
				...
				case "W":
					typ="W";
					var typ_level=DataConvert.GetNumber(/WÃ¤chter Level:\s+([0-9]*)/.exec(data.html())[1]);
				  break;
				case "(":
				  typ="P";
				  break;
      ...
      var cols=0;
        ...
        for(var i=cols;i>0;i--) {
          ...
          if(values.reviveMushrooms!=0) {
			...
			if(Settings.data.br_info_basedata) {
  			...
  			html_extra+="<tbody>";
  			html_extra+="<tr><th style='text-align:left;'>Basiswerte</th><th style='text-align:right;'>Vorher</th><th style='text-align:right;'>Nachher</th><th style='text-align:right;'>Ã„nderung</th></tr>";
			...
			if(Settings.data.br_info_shaman&&(reviveMushrooms[3]>0)) {
  			html_extra+="<table class='kbTable designedTable xAddonTable'>";
  			html_extra+="<tbody>";
  			html_extra+="<tr><th style='text-align:left;'>SchamanenhÃ¼tte</th><th style='text-align:right;'>Pilze</th><th style='text-align:right;'>Kraftsteine</th><th style='text-align:right;'>Punkte</th></tr>";
  			html_extra+="<tr style='color: "+color_blue+";'>";
  			html_extra+="<td class='white_first'>SchamanenhÃ¼tte</td>";
			...
			if(Settings.data.br_info_score&&(typ!="W")) {
  			html_extra+="<table class='kbTable designedTable xAddonTable'>";
  			html_extra+="<tbody>";
  			html_extra+="<tr><th style='text-align:left;'>Punkte</th>"+((typ=="H")?"<th style='text-align:right;'>Erfahrung</th>":"")+"<th style='text-align:right;'>Wesen</th><th style='text-align:right;'>SchamanenhÃ¼tte</th></tr>";
  			html_extra+="<tr style='color: "+color_blue+";'>";
        ...
        html_extra+="<td style='text-align: right; color: "+((points[1]>points[2])?color_red:color_green)+";' class='clear_middle'>"+DataConvert.FormatNumber(points[2]-points[1])+"</td>";
			...
			if((typ=="W")&&(typ_level<99)) {
				if(typeof(WÃ¤chter[0])=="undefined") WÃ¤chter[0]={maxGuard:0};
				WÃ¤chter[0].maxGuard=Math.max(WÃ¤chter[0].maxGuard,typ_level);
				if(typeof(WÃ¤chter[typ_level])=="undefined") WÃ¤chter[typ_level]={defense:0, live:0};
				if((WÃ¤chter[typ_level].defense<defense)||(WÃ¤chter[typ_level].live<live)) alert("Neue Werte fÃ¼r WÃ¤chter Stufe "+typ_level+" ermittelt!");
				WÃ¤chter[typ_level].defense=Math.max(WÃ¤chter[typ_level].defense,defense[1]);
				WÃ¤chter[typ_level].live=Math.max(WÃ¤chter[typ_level].live,live[1]);
      	GM_setValue(server_name+".WÃ¤chter",DataIO.serialize(WÃ¤chter));
			}
...
unsafeWindow.ajax_load=function(display) {
	...
	if(display==false) {
      ...
      if (GM_getValue(server_name+".WÃ¤chter")) WÃ¤chter=DataIO.unserialize(GM_getValue(server_name+".WÃ¤chter")); else WÃ¤chter={};
