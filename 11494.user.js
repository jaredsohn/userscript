...
/**/	F   = document.createElement('input');
		...
		B.setAttribute('style', "-moz-outline-radius:4; cursor:pointer; border:none; margin:2px; margin-left:5px; width:18px;");
		...
		I.setAttribute('style', "-moz-outline-radius:4; width:18px; cursor:pointer; border:none; margin:2px; width:18px;");
		...
		U.setAttribute('style', "-moz-outline-radius:4; cursor:pointer; border:none; margin:2px; width:18px;");
		...
		COR.setAttribute('style', "-moz-outline-radius:4; cursor:pointer; border:none; margin:2px; width:18px;");
		...
		L.setAttribute('style', "-moz-outline-radius:4; cursor:pointer; border:none; margin:2px; margin-left:4px; width:18px;");
		...
		TL.setAttribute('style', "-moz-outline-radius:4; cursor:pointer; border:none; margin:2px; margin-left:4px; width:18px;");
		...
		IMG.setAttribute('style', "-moz-outline-radius:4; cursor:pointer; border:none; margin:2px; width:18px;");
		...
		S.setAttribute('style', "-moz-outline-radius:4; cursor:pointer; border:none; margin:2px; width:18px;");
		...
		SIG.setAttribute('style', "-moz-outline-radius:4; cursor:pointer; border:none; -moz-border-radius:4; margin:2px; width:18px;");
		...
		R.setAttribute('style', "-moz-outline-radius:4; cursor:pointer; border:none; margin:2px; width:18px;");
		...
		O.setAttribute('style', "-moz-outline-radius:4; cursor:pointer; border:none; margin:2px; margin-left:3px; width:18px;");
...
/**/	F.type = "button";
		...
		F.setAttribute('style', "-moz-outline-radius:4; cursor:pointer; border:none; margin:2px; margin-left:3px; width:18px;");
		...
		Barra.appendChild(O);
/**/	Barra.appendChild(F);
		Barra.appendChild(document.createTextNode(''+versao));
		...
		Cbar.id = "OKFT_CB";
		Cbar.setAttribute('style', "visibility:hidden; border:solid 1px #A1BBE4; background:#e5ecf4; padding:3px; position:absolute; left:400px; width:96px");
		for (var i = 0; i < cores.length; i++) {
		...
		Barra.style.width = field.clientWidth - ((field.clientWidth > 545) ? 30 : 0) - 2;
	...
	function OKFT_CriarRTE() {
		...
		RTE.style.width  = field.clientWidth - ((field.clientWidth > 545) ? 30 : 0);
