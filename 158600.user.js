// ==UserScript==
// @name           Google Reader Compact For Small Screen
// @namespace      ALI
// @description    Reduces margins on the new Google Reader layout (released in 2011), Changes link colors to something legible, add visible box around post, hide top header and navigation bar, hide feed title (Push 'W' to show/hide header and navigation bar)
...
#lhn-add-subscription-section {top:-16px !important; left:90px !important;} \
#logo-section {margin-bottom:-36px !important; height:26px !important; padding-top:3px !important;} \
");
