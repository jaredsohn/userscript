// ==UserScript==
// @name          Orkut Quote with box
// @version       0.5.1
// @author        Sahil
// @namespace     Created by Sahil
// @description   Makes Community Better. Also write in quote box in orkut communities.
// @include       http://www.orkut.*/*
// @exclude       http://www.orkut.*/Main#*
// @exclude       http://www.orkut.*/AdsIframe.aspx*
// ==/UserScript==
script_version = '0.5.1';
userscripts_id = 33882;
/* 
 Change History
 v 0.5.1
  - Minor change in behaviour of quote feature
 v 0.5 (Thanx to Anoop, Kevin, Navoj for suggestions)
  - Completely rewritten code
  - Added mycommunitiesbox stats clear feature
  - Added Feeds Application
  - Fixed some broken features
  - Added Script update check feature
 v 0.4.1 (Thanx Fabio M for this release)
  - Added forum shortcut links. This has been merged with the last page shortcuts
    link into a shortcut feature
  - Added fixing of insane table widths on Forum topics page    
 v 0.4.0
  - Added ability to configure script through settings page
  - Added skin switch
  - Minor changes in the code
 v 0.3.2
  -  Fixed false jumping on going to previous from last page (Thanx Anoop)
 v 0.3.1
  - Added return to last page on reply
  - Minor code modifications
 v 0.3.0
  - Added url shortener feature
  - Added Quote feature
  - Changed Quick reply button behaviour to toggle display of textbox
 v 0.2.1
  - Modified behaviour for the last page linkifier
 v 0.2.0
  - Added Better 'my communities' box feature
  - Some minor changes following change in layout of orkut page
*/
...
//			qt_arr[i] = qt_arr[i].replace(/<a\s+.*href=(?:'|")([^'"]*)(?:'|").*>(?:http|ftp|https):\/\/[\w\-_]+(?:\.[\w\-_]+)+(?:[\w\-\.,@?^=%&amp;:\/~\+#]*[\w\-\@?^=%&amp;\/~\+#])\.\.\.<\/a>/ig, '$1')
...
function checkUpdates(user) {
	...
	GM_xmlhttpRequest({
		...
		onload:function(response) {
			...
			$('body')
			.append('<div id="bo-update" style="position:fixed;top:0px;right:0px;width:150px;background-color:white;border:1px solid #81C6FD;"></p><a style="font-weight:bold" target="_blank" href="http://userscripts.org/scripts/show/'+userscripts_id+'">Better Orkut '+feed.value.items[0].content+' Available</a></p><p><a href="javascript:;">close</a></p></div>');
...
function main() {
	var page_url = window.location.href,
		...
		settings_form = {
			...
			feed_app       : {type:'checkbox', value:true, label:'Enable the feeds Application', no_divi:true},
			feed_app_count : {type:'text',     value:'10', label:'Feed entry count'},
			easy_link      : {type:'checkbox', value:true, label:'Enable last page and forum topic shortcut links'},
			qreply         : {type:'checkbox', value:true, label:'Enable Quick Reply & Quote in forums'},
			url_trunc      : {type:'checkbox', value:true, label:'Enable Truncation of long URL in forums posts'},
			quote_template : {type:'textarea', value:'[i][b][username][/b] said:[gray]\n[quote]\n[/gray][/i]', label:'Quote template'},
			lastpage_jump  : {type:'checkbox', value:true, label:'Enable Jump to last page on reply'},
			skin_switch    : {type:'checkbox', value:true, label:'Enable Skin Switching in other profiles'}
		},
		settings;
