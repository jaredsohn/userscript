// ==UserScript==
// @name           My Friend's Tanks - Booty Grab	
...
if(time>=GM_getValue('date',time-20)+20){
	...
	checkTank(2250019,true,"ME!");
	checkTank(4802263,true,"Katie");
	checkTank(14571,true,"Fyora");
	checkTank(379719,true,"Robots");
	checkTank(236535,true,"Hirome");
	checkTank(8259163,true,"Awlwyn");
	checkTank(122493,true,"Jupiter");
	checkTank(2912355,true,"Glacies");
        checkTank(8446079,true,"Gate");
        checkTank(7647761,true,"Butterfly");
        checkTank(3659563,true,"KandyKahne");
        checkTank(7890077,true,"Suki Aoi Hana");
        checkTank(4584217,true,"iheartshrooms");	
}
function addTank(){
