// ==UserScript==
// @name           Travianer/Travians Bar
// @namespace      http://
// @description    this is English version of skript just add travians page.
...
'<b>Go To:</b><br/>'+
'<a onclick="xajax_changeLocation(BGlocation, BGlocationRoom, BGlocationOwner, -1, 0, -1, 0); return false;">Own House </a> | '+
'<a onclick="xajax_click(6174, 5168, 6616, 5163, BGlocation, BGlocationOwner, 0, 0, 0, 0); return false; ">Gilde (house) </a> | '+
...
'<a onclick="xajax_click(5898, 5313, 6015, 5414, BGlocation, BGlocationOwner, 0, 0, 0, 0); return false; ">Gilde (Warehouse) </a> | '+
'<a onclick="xajax_click(6886, 5311, 6808, 5133, BGlocation, BGlocationOwner, 0, 0, 0, 0); return false; ">Armory</a> | '+
...
'<hr>'+
'<b>Market:</b><br/>'+
'<a class=info href="http://www.pflock.de/travianer/npc/alle.txt">NPC-Price <span></span></a><br/>'+
...
//'<hr>'+
'<b>Potions:</b><br/>'+
'Green+Green = Life points<br/>'+
'Green+Blue = Attack<br/>'+
'Blue+Green = Attack(Points)<br/>'+
'Blue+Blue = Defense<br/>'+
'<hr>'+
