...
{ 
    ...
    var updateUrl = 'http://userscripts.org/scripts/show/72032';
...
displayErrFrame("Tvoja verzija skripte je zastarela. (Trenutna: "+VERSION+" | aktualna: "+ver+")", splitLinks("Aktualiziraj!|"+uurl));
        ...
        {
            displayErrFrame("Prišlo je do napake pri branju komande. Prosim vas prijavite se na IRC kanalu #eSlovenija.");
            throw e;
        }
    }
