// ==UserScript==
// @name            HackForums TahomaBold - White/Pink
// @namespace       JaxonHF/hftahomawhitepink
// @description     Makes text tahoma and white/pink.
...
function form_submit(event) {
   ...
   for (var i = arTextareas.length - 1; i >= 0; i--) {
	   ...
	   elmTextarea.value = "[color=#f0b7b7][font=tahoma][b]" + elmTextarea.value + "[/font][/color][/b]";
   }
