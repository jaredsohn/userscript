...
// @namespace      none
// @include        http://ch*.staemme.ch/game.php?*screen=place*
// @include        http://ch*.staemme.ch/game.php?screen=place*
// @include        http://ch*.staemme.ch/game.php?*screen=place
// @exclude        http://ch*.staemme.ch/game.php?*screen=place&mode=units
// @exclude        http://ch*.staemme.ch/game.php?*screen=place&mode=sim
// @exclude        http://ch*.staemme.ch/game.php?*screen=place&mode=neighbor
// @exclude        http://ch*.staemme.ch/game.php?*screen=place&try=confirm
// ==/UserScript==
