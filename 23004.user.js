...
Userscripts.org
Source for "Asad's Automatic Orkut Fake Profile Creator"
...
Has 1 other script.
   ...
   1. // ==UserScript==
   2. // @name           Asad's Automatic Orkut Fake Profile Creator
  ...
  15. var email1="aakash's";                  /*first part of ur email id*/
  16. var email2="india.co.in";        /*last part of ur email id*/
  17. var password="wellcome222";      /*password(atleast 8 characters)*/
