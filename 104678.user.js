...
// @name            Shinobi - Tenues
// @namespace       http://
// @description     Sauvegarde de tenues prédéfinies
// @author          Plag
// @website         http://
// @include         http://*.shinobi.fr/
// @version         0.1
// ==/UserScript==
        ...
        var wardrobe_text={fr:'Tenues'};
        var new_name_text={fr:'Nouveau'};
        var cancel_button_text={fr:'Annuler'};
        var delete_button_text={fr:'Effacer'};
        var save_button_text={fr:'Enregistrer'};
        var save_message_text={fr:'Tenue enregistrée'};
        var confirm_overwrite_text={fr:'Voulez-vous vraiment modifier la tenue ?'};
        var save_choose_name_error_text={fr:'Vous devez choisir "Nouveau nom" ou une tenue existante !'};
        var save_invalid_name_error_text={fr:'Le nom de la tenue contient des caractères invalides !'};
        var delete_choose_name_error_text={fr:'Vous devez choisir une tenue existante !'};
        var changeOk_text={fr:'Changement effectué'};

        var  check_arm_text={fr:'Ne pas changer d\'arme'};
        var  check_armure_text={fr:'Ne pas changer d\'armure'};
        var  check_changeonselect={fr:'Configuration'};
        var  error_confmodenotactivated={fr:'Voulez vous activer le mode Configuration pour creer une nouvelle tenue ?'};
