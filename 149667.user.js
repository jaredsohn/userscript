...
var scriptUrl = "http://userscripts.org/scripts/show/149667";
...
function do_main() {
	...
	if (GM_getValue("valUpdate",true)) {
		...
		if(valLastUpdate=="") {
			GM_xmlhttpRequest({
				method: "GET",
				url: "http://userscripts.org/scripts/source/149667.meta.js",
				...
				onload: function(response) {
					...
					if (valLastUpdate!=serverversion) {
						...
						if(confirm(texte["confirmUpdate"])) {
							document.location.href = "http://userscripts.org/scripts/source/149667.user.js";
						}
					}
				}
			});
	...
	*/
	...
	// Neue Autobuttons
	var arrQuicklinks2 = [
	[texte["autoBuy"]],[texte["autoNurse"]], [texte["autoClean"]], [texte["autoDisposeMedi"],3]];
