...
// @name           taringa color 2
// @namespace      taringa
// @description    cambiarle el color a taringa
...
function setColours() {
  ...
  newDiv.setAttribute("style", "position: fixed; left: "+((window.innerWidth / 2) - 290)+"px; top: "+((window.innerHeight / 2) - 200)+"px; z-index: 1337; background: rgba(255, 255, 255, 0.9) !important;-moz-border-radius:7px;padding:7px !important;-moz-box-shadow:0px 0px 10px rgba(0, 0, 0, 0.8);width: 577px");
  newDiv.innerHTML += "<center><b><h2>Cambia colores taringa 2.0 - by Gonx_666<h2></b></center>";
...
function addStyle(setup) {
  ...
  style.innerHTML = "a{color:"+setup.dark+";}" +
                    ...
                    "#centro .box_txt{-moz-border-radius-topleft:6px;-moz-border-radius-topright:6px;background:url(http://i.t.net.ar/images/box_titlebg.gif);padding:5px;padding-left:10px;width:275px !important;}" +
                    ...
                    ".tags_cloud,#cuerpocontainer center iframe,ins,#monitor center object,#centro .box_rss,.banner,#logo,.tops_tags,.adsByT,.socialAds,#banner,#pie,#footer,.byYahoo,.container208,.byGoogle,.box_perfil_der iframe,.bbox,.cse-branding-logo,#mensaje-top,.rtop,.rbott,#derecha,.sticky,#estadisticasBox{display:none !important}" +
                    ".comunidades #derecha,.box_cuerpo  hr,.box_perfil hr,.container940 center,.container740 center{display:block !important}" +
                    ...
                    "input.login, .button,.mBtn,.btnOk{background-image:none !important;border:0px !important;-moz-border-radius:12px;color:#fff !important;text-shadow: 0 0 0 !important;}" +
                    ...
                    "#maincontainer{-moz-border-radius:10px;padding:12px;background:url("+ imagenes +"T-desing-head.png)no-repeat;}" +
                    "#maincontainer,input.login, .button,.mBtn,.btnOk{background-color:"+setup.light+" !important}" +
                    ".container740 .box_title,#temaComunidad,.temaBubble,#monitor #resultados,#monitor #showResult,.container400, #centroDerecha{width:940px !important;}" +
                    ".temaCont{width:780px !important;}.comunidades #izquierda{display:none}" +
                    ".infoPost{width:893px !important;}.comunidades #centro{width:674px !important;}.comunidades #centro .box_txt{width:660px !important;}" +
...
colores.innerHTML='<a href="javascript:void(O)" title="Cambia los colores de taringa"><img src="' +imagenes +'lapiz.png"></a>';
...
contenido.innerHTML='<iframe frameborder="0" width="940" height="400" src="http://www6.cbox.ws/box/?boxid=10708&amp;boxtag=wf731w&amp;sec=main" marginheight="2" marginwidth="2" scrolling="auto" allowtransparency="yes" name="cboxmain" style="border:#FFFFFF 1px solid;" id="cboxmain"></iframe><form name="cbox" target="cboxmain" action="http://www6.cbox.ws/box/index.php?boxid=10708&boxtag=wf731w&sec=submit" method="post" class="cfrm" onsubmit="return do_post();"><input type="hidden" name="key" value=""><input type="hidden" name="nme" value="'+user+'">\
<center><table border="0" cellpadding="0" cellspacing="0" width="936"><tr>\
<td width="20"><a href="http://www6.cbox.ws/box/index.php?boxid=10708&boxtag=wf731w&sec=main" target="cboxmain" onclick="return do_refresh();" id="rf"><span class="systemicons actualizar"></span></a></td>\
<td><input type="text" maxlength="1000" name="pst" autocomplete="off" size="9" value="" style="width:100%;"></td>\
<td width="50"><input type="submit" value="Enviar" name="sub" class="frmbtn" style="margin-left:5px;padding:3px;"></form></td></tr></table></center>';
}

function favos() {
  style = document.getElementsByTagName('head')[0].appendChild(document.createElement('style'));
  style.type = 'text/css';
  style.innerHTML = ".comunidades #izquierda{display:block !important}.comunidades #centroDerecha{width:767px !important;}";
}


function redireccionar() {location.href="http://www.taringa.net/posts/3359536/"}


GM_registerMenuCommand("Cambiar el color a taringa.", setColours);
