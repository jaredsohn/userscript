// ==UserScript==
// @name        Philly Free Library - LibraryLookup
// @description Check book availability in Philadelphia Free Library.  When you look at a book on Amazon.com, this script will check the Philadelphia Free Library catalog, then show you in the best link to get the book.  Written by Nick Baker, Reference and Web Services Librarian; adapted for Philly Free Library by David Manning.  Based on adapation for Chicago Public Library by Mike Harris.
...
(
   function()
   {
      ...
      var phillypub =
      {
            name: 'Philly Free Library',
			image: '',

            createSearchUrl: function(isbn)
            {
               var prefix = 'https://catalog.freelibrary.org/web2/tramp2.exe/do_ccl_search/guest?SETTING_KEY=English&servers=1home&index=bn&query=';
               return prefix + isbn
            },
            ...
            {
               var notFound = /found 0 titles in the/;
      ...
      // checked
      libraryLookup.libraries = [phillypub];
