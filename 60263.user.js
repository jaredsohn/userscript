...
// @description    Per site a note in de globalStorage. Use CTRL-M to open the note.
// @version        1
// @include        http://*/
// @include        https://*/
// @exclude        about:blank
...
script.innerHTML = <![CDATA[
   ...
   // Home/Copyright tab
   var Copyright = [
     [['Home'],['<font style="font-size:14;font-weight:bold;clear:both;">LightBox Notes</font>This is a note for every site you go to. The note changed will be saved automaticaly in the globalStorage of your browser. GlobalStorage is a feature of firefox which enables websites to store information per domain and the information is not send over the internet and so it is safe.<div style="padding: 1em 0em 0em; width: 596px;"><img style="border: 1px dotted #ccc; float: left; display: inline-block; clear: none;" src="http://www.gravatar.com/avatar.php?gravatar_id=fdd3cc761efe3e49ebd76438751b7e16&amp;r=PG&amp;s=80"><div style="padding: 1em; float: left;"><font style="font-size: 14px; font-weight: bold;">Copyright</font>&copy; NOWYEAR Jos van Nijnatten<br><a taget="_blank" href="http://userscripts.org/users/111706">Visit me on Userscripts.org</a></div></div>'],['']]
   ];
