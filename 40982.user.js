// ==UserScript==
// @name           InfoCompte (v0.84) adapted for PHPBB FORUMS
...
{ 	
	...
	/* ******************************BBcode********************************/	
	var BBcode="[quote][center][size=200][b]D"+eaigu+"tail de l'investissement des points[/b][/size]\n\n";
	BBcode+="[size=150]Points Total : [b][color=#ff0000]"+addPoints(PointsTotal)+"[/color][/b][/size]\n";
