...
//			"//div[@id='rotate']/div[@class='cardStatusDetail']/div[@class='statusDetail']/div[@class='left']/div[@class='illustMini']/a",
			"//div[@id='rotate']/div[@class='cardStatusDetail']",
			document,																	// 評価対象ノード
			null,																		// 名前空間
			XPathResult.ORDERED_NODE_ITERATOR_TYPE,										// 結果型
			null
		);

		var thisNode = xPathResult.iterateNext();
		while (thisNode) {
//			GM_log(thisNode.getAttribute('href'));

			var a = document.evaluate(
				"//div[@class='statusDetail']/div[@class='left']/div[@class='illustMini']/a",
				thisNode,																	// 評価対象ノード
				null,																		// 名前空間
				XPathResult.FIRST_ORDERED_NODE_TYPE,										// 結果型
				null
			).singleNodeValue;
			GM_log(a.getAttribute('href'));

			var id = a.getAttribute('href');

			var div = document.evaluate(
//				"//div[@class='statusDetail']/div[@class='otherDetail']/div[@class='useCp']",
				"//div[@class='statusDetail']/div[@class='otherDetail clearfix']",
				thisNode,																	// 評価対象ノード
				null,																		// 名前空間
				XPathResult.FIRST_ORDERED_NODE_TYPE,										// 結果型
				null
...
//<div id="rotate" class="file">
//<div class="cardStatusDetail">
//<div class="otherDetail clearfix">
//<div class="useCp false">ポイント振り直しは使用できません</div>
...
//<div class="left">
//<div class="illustMini">
//<a href="#TB_inline?height=340&amp;width=500&amp;inlineId=cardWindow_8700029" class="thickbox">


		// ポイント振りなおしの代わりに、各武将の固有番号を表示させる
		// cardWindow_8700029
		// <a href="#TB_inline?height=340&amp;width=500&amp;inlineId=cardWindow_8700029" class="thickbox">
		// <dev class="useCp">
	}
	...
	if (header != null && location.hostname.match(/^m\d+.3gokushi.jp$/)) {
		// 新しいヘッダ領域を作成
