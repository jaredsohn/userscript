// ==UserScript==
// @name ClanGloryPoints
// @author 		chuuddo
// @version 	0.8.9.2
// @include http://worldoftanks.ru/uc/clans/*
// @include http://worldoftanks.ru/community/clans/*
// @exclude http://worldoftanks.ru/uc/clans/*/provinces/
// @exclude http://worldoftanks.ru/community/clans/*/provinces/
// @exclude http://worldoftanks.ru/uc/clans/*/battles/
// @exclude http://worldoftanks.ru/community/clans/*/battles/
...
function render() {
  ...
  $(".t-table").append(    
    '<thead>'+
      '<tr>' +
        '<th>№</th>' +
        '<th><span class="b-sort-box">Имя</span></th>' +
        '<th><span class="b-sort-box">Должность</span></th>' +
        '<th><span class="b-sort-box">Дата вступления</span></th>' +
        '<th><span class="b-sort-box">Очки славы</span></th>' +
