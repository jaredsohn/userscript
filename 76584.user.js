...
loading_image.src = "http://emo.huhiho.com/set/beybeyfamily/130.gif";
...
function jQuery_start() 
{
	...
	$(".preview").toggle(function(e)
	{
		...
		$("body").append("<p id='prev_container'><img src='http://emo.huhiho.com/set/beybeyfamily/44.gif' style='padding-left:180px;' alt='Loading thread..'/></p>");
		$("#prev_container")		
				...
				$.ajax({
					...
					success: function(reply_html)
					{
						...
						$("#submit_reply").click(function(){			
							var app_sign = "\n\n[center][URL='http://www.kaskus.us/reputation.php?p=211026017'][IMG]http://i39.tinypic.com/t068n4.jpg[/IMG][/URL][/center]";
