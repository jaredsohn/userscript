// ==UserScript==
// @name           Tscript BETA 1.2
// @namespace      http://www.taringa.net/perfil/gonza_06
// @include        *.taringa.net/*
// @resource       jQuery             http://www.visualjquery.com/jquery-1.2.6.js
// ==/UserScript==
...
if(locc[3] == 'agregar' || locc[3] == 'editar-tema')		loc = 'agregarc';		break;
}


/////////////////////////////////////== opciones ==/////////////////////////////////////

$(".tabsMenu div").before('<li class="heresa"><a href="/posts/1/opciones" title="Opciones!" target="_blanck">Opciones</a></li>');


    if(window.location.pathname == '/posts/1/opciones') {

$("#mask").html('<style>.post-deleted{background:url() !important;margin:0px !important}.subMenu ul.tabsMenu li.here{background:#3b8bac !important;}.subMenu ul.tabsMenu li.here a{color:#fff !important;}.heresa{background:#fff !important}.heresa a{color:#000 !important;}</style>');
...
$("#cuerpocontainer").html('<div id="mi" style="display:none"></div><div id="mic" style="display:none"></div><div id="pip"></div>');$("body").mouseover(function(){$("#mi").html(bipa());$("#mic").html(bipap());})
function bip() {micono = icono.split(',');miconop = iconop.split(',');var bip = '<div id="mip"><br class="space" /><hr class="divider"><br class="space" /><b>Personalizar Iconos</b><br class="space" /><hr class="divider"><br class="space" /><input type="text" id="ip">&nbsp;&nbsp;<input id="aip" class="button" value="Agregar" type="button"><br class="space" /><hr class="divider"><br class="space" /><div id="miconos">'
	for (var i = 1; i < micono.length; i=i+2){bip += '<a id="closei" onclick="$(this).remove()"><span></span><img 1="'+micono[i]+'" src="'+micono[i+1]+'"></a>';}bip += '<br class="space" /><hr class="divider"><br class="space" /></div><div id="miconosp">';
	for (var i = 1; i < miconop.length; i=i+1){bip += '<a id="closei" onclick="$(this).remove()"><span></span><img 1="" src="'+miconop[i]+'"></a>';}bip += '</div><br class="space" /><hr class="divider"><br class="space" /><input id="gip" class="button" value="guardar" type="button"><br><br></div>';
	return bip;}
$("#pip").append(bip());$('#aip').click(function(){$('#miconosp').append('<a id="closei" onclick="$(this).remove()"><span></span><img src="'+$("#ip").val()+'"></a>');$('#mic').html(bipap())})
...
GM_addStyle('#mip{width:940px;background:#eee;margin:0 auto;-moz-border-radius:5px;border:1px solid #ddd}#mip div{text-align:center;}#mip b{color:#999 !important;margin-left:12px;}#gip{float:right;margin-right:12px}#closei{background:#ddd;display:inline-block;padding:7px 5px;margin:2px;-moz-border-radius:5px;border:1px solid #ccc}#miconos #closei{width:80px;padding:14px 0px;}#miconosp img{max-height:90px;}#closei span{float:right;margin-top:-10px;margin-right:4px;display:block;background:url(http://i1007.photobucket.com/albums/af198/gonza_06/close-icon.png);height:15px;width:15px;cursor:pointer;}#miconosp #closei span{margin:-3px 0 0 4px;}#ip{margin-left:15px;-moz-border-radius:5px;width:815px;}')
...
$('#banner,#footer,#pie,object,.filterCat,#google_ads_div_tar_general_728_general,#google_ads_div_tar_p_728_info,#google_ads_div_tar_ch_160_general,iframe[width="160"],.banner-300,.rbott,.destacadas,.ads120-240,#mensaje-top,.banner,.banner300x250').remove()
GM_addStyle("#maincontainer{-moz-border-radius:0 0 7px 7px;padding-bottom:12px !important;margin-bottom:15px !important}.post-relacionados{width:760px!important}")


if(window.location.pathname == '/comunidades/') {

$('#izquierda,#centro').attr('style','width:680px !important')
GM_addStyle("#izquierda,#centro{margin:0 10px 0 0 !important;}#derecha{margin-top:-107px;}")
}
...
if (loc == 'edicion' || loc == 'mensajes') { $('#markItUpMarkItUp').after('<br class="space" /><br class="space" /><br class="space" /><br class="space" /><div id="nft"></div><br class="space" /><hr class="divider">') }
...
&nbsp;&nbsp;<input type="button" value="Ver coloringa" class="button"  id="coloringa">\
&nbsp;&nbsp;<input type="button" value="Ver letringa" class="button"  id="letringa">\
&nbsp;&nbsp;<input type="button" value="Barra roprgm" class="button"  id="roprgm">\
</center>')
...
$("#coloringa").toggle(function(){$("#colorbox").slideDown("slow");$(this).val('Ocultar coloringa')},function(){$("#colorbox").slideUp("slow");$(this).val('Ver coloringa')});
$("#letringa").toggle(function(){$("#letrinbox").slideDown("slow");$(this).val('Ocultar letringa')},function(){$("#letrinbox").slideUp("slow");$(this).val('Ver letringa')});
$("#roprgm").toggle(function(){$("#roprgmbox").slideDown("slow");},function(){$("#roprgmbox").slideUp("slow");});
...
<a 1="[quote]" 2="[/quote]"><img src="'+img+'quote.png"></a>&nbsp;\
\
...
function bip() {
	icono = icono.split(',')
	iconop = iconop.split(',')
	var bip = '<div id="iconos" style="display:none"><br class="space" /><hr class="divider"><br class="space" />'
...
$('#nft').append('<div id="colorbox" style="display:none"><br class="space" /><hr class="divider"><br class="space" /><object height="180" width="550"><embed src="http://img20.imageshack.us/img20/3766/colores.swf" type="application/x-shockwave-flash" height="180" width="550"></object></div>')
...
$('#nft').append('<div id="letrinbox" style="display:none"><br class="space" /><hr class="divider"><br class="space" />\
\
<div id="funbox">Taringa<input class="let" type="radio" name="estilo" value="taringa/" checked> Poringa<input class="let" type="radio" name="estilo" value="poringa/"> Letringa<input class="let" type="radio" name="estilo" value="letringa/">\
\
<br class="space" /><hr class="divider"><br class="space" />\
<input type="text" id="letra" maxlength="20">&nbsp;&nbsp;<input type="button" id="la" value="Agregar" class="button" 1=""><br class="space" /><hr class="divider"><br class="space" />\
<div class="agregar" id="lh">Vista previa</div><div class="letringa" id="lb" style="display:none"></div></div>\
\
<br class="space" /></div>')

$(".let").click(letringa);$("#letra").keyup(letringa);$("#la").click(function () {var lc = $("#lb").html();$(this).attr('1',' '+lc+' ');unsafeWindow.bbc(this)})

function letringa() {
var letr = $(".let:checked").val();
var letra = $("#letra").val();
letra = letra.toUpperCase();
letra = letra.split("");
var bimgi = "[img=http://letringa.com.ar/";
var bimgf = ".png]";
var himgi = "<img src='http://letringa.com.ar/";
var himgf = ".png'>";
var ht = letr+letra.join(himgf+himgi+letr)+himgf;
var bt = letr+letra.join(bimgf+bimgi+letr)+bimgf;
var hto = himgi+letr+'BorIz'+himgf+himgi+ht+himgi+letr+'BorDr'+himgf;
var bto = bimgi+letr+'BorIz'+bimgf+bimgi+bt+bimgi+letr+'BorDr'+bimgf;
var bto = bto.replace(/ .png/gi,"Esp.png").replace("*.png", "SAst.png").replace("^.png", "SAC.png").replace("¿.png", "SPregA.png").replace("?.png", "SPregC.png").replace("«.png", "SCAA.png").replace("».png", "SCAC.png").replace("®.png", "SReg.png").replace("©.png", "SCopy.png").replace("//.png", "/SBar.png").replace("|.png", "SBar3.png")
var hto = hto.replace(/ .png/gi,"Esp.png").replace("*.png", "SAst.png").replace("^.png", "SAC.png").replace("¿.png", "SPregA.png").replace("?.png", "SPregC.png").replace("«.png", "SCAA.png").replace("».png", "SCAC.png").replace("®.png", "SReg.png").replace("©.png", "SCopy.png").replace("//.png", "/SBar.png").replace("|.png", "SBar3.png")
$("#lh").html(hto);
$("#lb").html(bto);

if(letra==''){$("#lh").html("Vista previa");$("#lb").html("");}
}
...
$('#nft').append('<div id="roprgmbox" style="display:none"><br class="space" /><hr class="divider"><br class="space" />\
\
<div id="funbox">Azul<input class="bar" type="radio" name="bestilo" value="" checked> Violeta<input class="bar" type="radio" name="bestilo" value="type=2&"> Verde<input class="bar" type="radio" name="bestilo" value="type=3&"> Informal<input class="bar" type="radio" name="bestilo" value="type=4&"> Gris<input class="bar" type="radio" name="bestilo" value="type=5&"> Arcoiris<input class="bar" type="radio" name="bestilo" value="type=6&">\
<br class="space" /><hr class="divider"><br class="space" />\
<input type="text" id="bletra" maxlength="63">&nbsp;&nbsp;<input type="button" id="ba" value="Agregar" class="button" 1=""><br class="space" /><hr class="divider"><br class="space" />\
<div class="agregar" id="bh">Vista previa</div><div class="barop" id="bb" style="display:none"></div></div>\
\
<br class="space" /></div>')
...
function barop() {
var bar = $(".bar:checked").val();
var bletra = $("#bletra").val();
var bh = "<img src='http://i.t.roprgm.net/?titulo&"+bar+"text="+bletra+"'>"
var bb = "[img=http://i.t.roprgm.net/?titulo&"+bar+"text="+bletra+"]"
$("#bh").html(bh);
$("#bb").html(bb);



if(bletra==''){$("#bh").html("Vista previa");$("#bb").html("");}
...
unsafeWindow.bbc = function(a) { var ta = $(a).attr('1'); var td = $(a).attr('2'); function $$$(elem) {return document.getElementById(elem);};
...
if(tipo =='imagen'){ var img= prompt('ingrese el link de la imagen'); if(!confirm("Le gustaría agregarle un enlace ?")) { $(this).attr('1','[img='+img+']'); } else{ var link= prompt('ingrese el link'); $(this).attr('1','[url='+link+'][img='+img+'][/url]'); }; unsafeWindow.bbc(this)}

if(tipo =='preview'){
$('#preview-coment').remove()

				$.ajax({
					type: 'GET',
					url: 'http://'+dom+'/preview.php',
					dataType: 'text',
					data: 'titulo=Preview&cuerpo='+encodeURIComponent($('#body_comm').val()),
					success: function(h){
						respuesta = $('<div id="respuesta">'+h+'</div>').find('#post-centro div[class="box_cuerpo"]').html();
var nu = $('.commenttext').length + 1
$('#comentarios').append('<div id="preview-coment" class="comentario-post clearfix" style="display:none"><div class="avatarspace"><a href="/perfil/'+user+'">'+user+'</a></div><div class="commenttext"><div class="answerOptions"><div class="floatL metaDataA">#'+nu+' - <span title="">Menos de 1 minuto</span></div><ul class="floatR"><li class="answerCitar"><a onclick="$(this).parent().parent().parent().parent().parent().slideUp(\'slow\')" id="closep" title="Cerrar"><img src="http://s1007.photobucket.com/albums/af198/gonza_06/close-icon.png"></a></li></ul><div class="clearBoth"></div></div><div class="cuerpo_comm" style="margin: 10px;">'+respuesta+'</div></div></div>')
		$('#preview-coment').slideDown('slow')
			},
					error: function(h){
$("#comentarios").append('<center><div id="nonme" style="display:none;font-size:11px;color:#f00;padding:8px;margin-left:174px !important;"><b>- Hubo un error al intentar previsualizar el comentario-</b></div></center>')
$("#nonme").fadeIn("slow");
					}
				});


$('#closep').click(function(){$('#preview-coment').slideUp('slow')})
}
...
$('#derecha,.box_title:eq(7),.tags_cloud').remove()
GM_addStyle("#izquierda{width:634px !important}#izquierda .box_cuerpo div{padding:0px!important;max-width:620px;border:0px !important}"+
"#derecha,#izquierda .box_cuerpo .box_title,#izquierda .box_cuerpo #menu,#izquierda .box_cuerpo #head,#izquierda .box_cuerpo .rtop,#izquierda .box_cuerpo .subMenuContent,#izquierda .box_cuerpo #centro,#izquierda .box_cuerpo #footer,#izquierda .box_cuerpo #pie,#izquierda .box_cuerpo .rbott{display:none!important}")

$("#izquierda .box_title .box_txt").append(' - <a id="refresh">Actualizar</a>');

$("#buscadorBox").after('<div class="box_title"><div class="box_txt ultimos_posts">Filtrar por categorias</div></div>\
<div class="box_cuerpo" style="padding:5px 0px;"><ul  class="pcategoria">\
<hr class="divider"><div class="pcb">\
	<li><a name="categorias/-1/" class="lisel">Ver Todas</a></li>\
	<li><a name="categorias/novatos/">Novatos</a></li>\
</div><hr class="divider"><hr class="divider"><div class="pcb">\
	<li><a name="categorias/animaciones/">Animaciones</a></li>\
	<li><a name="categorias/apuntes-y-monografias/">Apuntes y Monograf&iacute;as</a></li>\
	<li><a name="categorias/arte/">Arte</a></li>\
	<li><a name="categorias/autos-motos/">Autos y Motos</a></li>\
	<li><a name="categorias/celulares/">Celulares</a></li>\
	<li><a name="categorias/comics/">Comics</a></li>\
	<li><a name="categorias/deportes/">Deportes</a></li>\
	<li><a name="categorias/downloads/">Downloads</a></li>\
	<li><a name="categorias/ebooks-tutoriales/">E-books y Tutoriales</a></li>\
	<li><a name="categorias/economia-negocios/">Econom&iacute;a y negocios</a></li>\
	<li><a name="categorias/femme/">Femme</a></li>\
	<li><a name="categorias/humor/">Humor</a></li>\
	<li><a name="categorias/imagenes/">Im&aacute;genes</a></li>\
	<li><a name="categorias/info/">Info</a></li>\
	<li><a name="categorias/juegos/">Juegos</a></li>\
	<li><a name="categorias/links/">Links</a></li>\
	<li><a name="categorias/linux/">Linux y GNU</a></li>\
	<li><a name="categorias/mac/">Mac</a></li>\
	<li><a name="categorias/manga-anime/">Manga y Anime</a></li>\
	<li><a name="categorias/mascotas/">Mascotas</a></li>\
	<li><a name="categorias/musica/">M&uacute;sica</a></li>\
	<li><a name="categorias/noticias/">Noticias</a></li>\
	<li><a name="categorias/offtopic/">Off-topic</a></li>\
	<li><a name="categorias/recetas-y-cocina/">Recetas y Cocina</a></li>\
	<li><a name="categorias/salud-bienestar/">Salud y Bienestar</a></li>\
	<li><a name="categorias/solidaridad/">Solidaridad</a></li>\
	<li><a name="categorias/taringa/">Taringa!</a></li>\
	<li><a name="categorias/turismo/">Turismo</a></li>\
	<li><a name="categorias/tv-peliculas-series/">TV, Peliculas y series</a></li>\
	<li><a name="categorias/videos/">Videos On-line</a></li>\
</div><hr class="divider"></ul></div><br class="space" />');

$(".pcategoria li a").click(function(){
$(".pcategoria li *").attr("class","");
$(this).attr("class","lisel")
var loccc = $(this).attr("name");

$("#izquierda .box_cuerpo").html('<center id="loadp"><img src="http://i.t.net.ar/images/cargando.gif"></center>'); 
$("#izquierda .box_cuerpo").load(loccc);

});

$("#refresh").click(function(){
var loccc = $("a.lisel").attr("name");
$("#izquierda .box_cuerpo").html('<center id="loadp"><img src="http://i.t.net.ar/images/cargando.gif"></center>'); 
$("#izquierda .box_cuerpo").load(loccc);
...
/////////////////////////////////////== Actualizador coments ==/////////////////////////////////////

if(loc == 'post'){
GM_addStyle("#lc{text-align:center;}.answerTxt{width:940px !important}"+
"#rc1{float:right;position:relative;top:-26px;right:20px}#rc2{float:right;z-index:2;position:relative;top:22px;right:20px}")

$("#comentarios").after('<div id="rc2"><b><a href="javascript:void(0)">actualizar comentarios</a></b></div>')
$(".comentarios-title").after('<div id="rc1"><b><a href="javascript:void(0)">actualizar comentarios</a></b></div>')
...
if(nhm.html() =='El post se encuentra cerrado y no se permiten comentarios.'){$("#post-comentarios").remove()}
...
$("#lc").slideUp("slow")
var cp=$(".avatarspace").length;
if($('#cp').html()==cp){$("#comentarios").append('<center><div id="nonme" style="display:none;font-size:11px;color:#f00;padding:8px;margin-left:174px !important;"><b>- No hay nuevos comentarios -</b></div></center>')
$("#nonme").fadeIn("slow");
setTimeout('$("#nonme").slideUp("slow")',1500);
}

if(cp==0){$("#comentarios").append('<center><div id="nonme" style="display:none;font-size:11px;color:#f00;padding:8px;margin-left:174px !important;"><b>- El post ah sido eliminado -</b></div></center>')
$("#nonme").fadeIn("slow");
setTimeout('$("#nonme").slideUp("slow")',1500);
}
...
$(".tabsMenu div").before('<li class="heres"><a href="/posts/1/chat" title="Chat!" target="_blanck">Chat</a></li>');


    if(window.location.pathname == '/posts/1/chat') {
    var user = $(".username").html();

$(".post-deleted").html('<div id="chat"><iframe frameborder="0" width="940" height="400" src="http://www6.cbox.ws/box/?boxid=10708&amp;boxtag=wf731w&amp;sec=main" marginheight="2" marginwidth="2" scrolling="auto" allowtransparency="yes" name="cboxmain" style="border:#FFFFFF 1px solid;" id="cboxmain"></iframe><br class="space" /><hr class="divider"><br class="space" /><form name="cbox" target="cboxmain" action="http://www6.cbox.ws/box/index.php?boxid=10708&boxtag=wf731w&sec=submit" method="post" class="cfrm" onsubmit="return do_post();"><input type="hidden" name="key" value=""><input type="hidden" name="eml" value="http://www.taringa.net/perfil/'+user+'"><input type="hidden" name="nme" value="'+user+'"><center><table border="0" cellpadding="0" cellspacing="0" width="936"><tr><td width="20"><a href="http://www6.cbox.ws/box/index.php?boxid=10708&boxtag=wf731w&sec=main" target="cboxmain" onclick="return do_refresh();" id="rf"><span class="systemicons actualizar"></span></a></td><td><input type="text" maxlength="1000" name="pst" autocomplete="off" size="9" value="" style="width:100%;"></td><td width="50"><input type="submit" value="Enviar" name="sub" class="button" style="margin-left:13px !important;padding:3px;"></form></td></tr></table></center></div>');


$("#mask").html('<style>.post-deleted{background:url() !important;margin:0px !important}.subMenu ul.tabsMenu li.here{background:#3b8bac !important;}.subMenu ul.tabsMenu li.here a{color:#fff !important;}.heres{background:#fff !important}.heres a{color:#000 !important;}</style>');
}
