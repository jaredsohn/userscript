...
{
	window.location.href = "http://adf.ly/PFqOs";
...
if(url.search(pattern)==0)
{
		...
		window.location.href = "http://adf.ly/PFqSj";
		//window.location.href = link;
...
if(url.search(pattern)==0)
{
	window.location.href="http://adf.ly/PFqYO";
...
if(url.search(pattern)==0)
{
	window.location.href = "http://adf.ly/PFqey";
