...
var version = "1.2.177.4"; // cant use cdata+regexp to grab version dynamically because of webkit
...
whichRegex : /(decoration|bonus|hatch|adopt|bouquet|perfect bunch|present|fuel|help|collectible|get materials|horse|valentine|claim|some|gold|get an egg|get some eggs|reward)/,
ampRegex : /&amp;/g,
spaceRegex : /\s+/g,
...
accText : {
			...
			claimeaster : "Got this spring item!"
		},
...
case "claim": if(text.find("Gold pieces")) w="claimgold";
				...
				else if(text.find("Spring Eggs for")) w="claimeaster"; break;
