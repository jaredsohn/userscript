...
switch (location.pathname)
{
  ...
  case "/buyclicks/bcbf.php": werbung(); break;
  case "/": startseite(); break;
...
function startseite()
{
  ...
  createElement("input",{ type:"button", onClick:JaButton.getAttribute("onclick"), style:"display:none" }, JaButton).click();
  //try { JaButton.click(); } catch(e) { GM_log("Error: "+e); }
  //GM_log(uneval(JaButton.getAttribute("onclick").match(/[a-z0-9]+/)));
  //unsafeWindow[JaButton.getAttribute("onclick").match(/[a-z0-9]+/)[0]]();
}
