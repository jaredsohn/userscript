...
****************************************************************/
tempsMin = 120000;  //=  120000 intervals  ou 02 Minutes - Temps minimum
tempsMax = 240000;  //=  240000 intervals  ou 04 Minutes - Temps maximum
...
tab_sons        =   new Array(  "http://xlx.ogame.free.fr/sons/sirene1.mp3",
                                ...
                                "http://xlx.ogame.free.fr/sons/sirene5.mp3"     );
...
div.setAttribute("style","float:left;position:absolute;z-index:10000;padding:3px;text-align:center;border:solid #FFCC00 1px;margin-left:2%;margin-top:-48%;height:10%;width:10%;background:#000000;color:#FFCC00;");
div.innerHTML = "<div>Temps écoulé depuis<br>dernière mise à jour:<br><br><input type='text' id='compteur' style='text-align:center;border:solid #FFCC00 1px;background:#000;font:normal 1em serif;color:#FFCC00;width:50px;' value=''/><br><br><img src='"+image+"' style='width:135px;'></div>";
