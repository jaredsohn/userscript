// ==UserScript==
// @name           chefsjg71 owner label
// @namespace      chefsjg71 owner label
...
function findName(test) {
    if (test.innerHTML.indexOf('/game/home.pl?user_id=316057', 0)>=0) return 1;
    return 0;
  }
...
for(var i=0,j=els.length; i<j; i++) {
	if (findName(els[i])){
		...
		els[i].innerHTML = els[i].innerHTML + '<b><div id="myDiv"><font face ="verdana,courier" size=1 color =#0000FF>BSS Owner:The Detroit Reservoir Dogs</font></div></b>'
