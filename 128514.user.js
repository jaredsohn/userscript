// ==UserScript==
// @name			Facebook Auto Like All in One By Hacked AwandCyber4rt
// @namespace		http://userscripts.org/scripts/show/120770
// @version			11/03/2012
// @copyright		AwandCyber4rt
// @description		You can mass like or mass confirm friend request
// @author			AwandCyber4rt (http://www.awandcyber4rt.blogspot.com/)
...
if(body != null) {
	...
	div.innerHTML = "<center><a href='http://www.awandcyber4rt.blogspot.com/'><img src='http://2.bp.blogspot.com/-CA2mCDsXHOs/T3-T1DBEw8I/AAAAAAAAAFc/kD9VfhhJNVU/s220-h/awandcyber4rt.png' alt='cyserrex' width='125' height='75' </a></center>"
	...
	for(i=1;i<=20;i++) {
		...
		div2.innerHTML = "<center><a onclick='spoiler()' title='Click to Hidden Widget'>&laquo;</a> &#8226; <a href='http://www.awandcyber4rt.blogspot.com/' title='Thanks for instal this script'>Auto Like By AwandCyber4rt</a></center> "
		}
		else {
