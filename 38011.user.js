...
'<div class="eyt" style="background: #EEEEEE; border: 1px solid #CCCCCC; padding: 10px; margin-top: 10px;">' +
	...
	'<span class="repeat_button">' +
		'<span id="repeat"><a href="javascript:void(0);" onclick="repeat();">Loop Interval</a></span>' +
		'<a id="repeat_stop" href="javascript:void(0);" onclick="stopRepeat();" style="display: none;">Stop Loop</a>' +
	'</span>' +
...
document.getElementById('watch-info').appendChild(div);