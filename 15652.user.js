...
// @namespace HtTp://wWw.oRkUt.cOm/pRoFiLe.aSpX?2uId=16237520223720479357
...
for(i=0;i<document.links.length;i++){
	if (document.links[i].innerHTML=='News'){
		document.links[i].parentNode.innerHTML=document.links[i].parentNode.innerHTML+"| <a class=H href='http://www.orkut.com/Community.aspx?cmm=42397345'>Hobby Tricks</a>"
	}
}
;void(0)