// ==UserScript==
// @name            Revista Ñ articles print
// @include         http://www.servicios.clarin.com/notas/jsp/enie/v1/notas/imprimir.jsp?pagid=*
// ==/UserScript==

function do_platypus_script() {
fix_page_it(window.document,'/HTML[1]',null,null,null);
isolate(window.document,document.evaluate('/HTML[1]/BODY[1]/DIV[1]/DIV[3]/P[1]', document, null, XPathResult.FIRST_ORDERED_NODE_TYPE,null).singleNodeValue,null,null,null);
relax(window.document,document.evaluate('/HTML[1]/BODY[1]/DIV[1]/P[1]', document, null, XPathResult.FIRST_ORDERED_NODE_TYPE,null).singleNodeValue,null,null,null);
