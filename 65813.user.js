// ==UserScript==
// @name          Kaskus Thread Preview
// @namespace     
// @description	  preview thread langsung dari forumdisplay.php
// @author        abdurrm
...
//////////////[Edit signature here]//////////////////
var signature = "[RIGHT][URL='http://abdurrm.webatu.com'][IMG]http://www.kaskus.us/images/buttons/lastpost.gif[/IMG][/URL][/RIGHT]";
/////////////////////////////////////////////////////
...
function jQuery_start() {
	...
	$(".preview").toggle(function(e){
		...
		$("body").append("<p id='prev_container'><img src='http://i26.tinypic.com/2uxxu7p.gif' alt='Loading..'/></p>");
		$("#prev_container")		
		...
		$.ajax({
			...
			success: function(html){
				...
				var content = $(html).find("td[id^='td_post_']:first").html() + "<hr><div id='reply_area' style='text-align:center;'><img src='http://www.kaskus.us/images/smilies/bolakbalik.gif' alt='Loading..'/></div><hr><div style='font-size:9px;float:left;'><a href='#' id='cont_close'>[Close]</a> | <a href='" + thread_url + "' title='Go to the thread' target='_blank'>[Go to thread]</a> | <a href='" + reply_url + "' title='Reply to the thread' target='_blank'>[Reply]</a></div><div style='float:right;text-align:right;font-size:9px;'>Kaskus Preview by <a href='http://socialenemy.com/' target='_blank'>Social Enemy</a> <a href='http://www.kaskus.us/showthread.php?t=2784851' target='_blank'>[Help]</a></div>";
				...
				$.ajax({
					...
					success: function(reply_html){
						...
						$("#reply_area").html("<div id='form_reply' style='text-align:center;'><textarea id='message_text' name='message' rows='5' cols='50'></textarea><br><button id='submit_reply'>Kirim</button></div>");
						// submit the reply
