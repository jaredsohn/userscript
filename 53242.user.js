...
function main() {	
	...
	$xpath("/html/body/table[3]/tbody/tr/td/table/tbody/tr/td/table/tbody/tr/td/form/table/tbody/tr[2]/td[2]").innerHTML += "<hr /><b><img src=\"/graphic/buildings/barracks.png\" alt=\"Kaserne\"> <span id='arrived_atts'>" + GM_getValue("attacks_" + vilid, 0) + "</span></b> <a href='#' id='reset_link'>&raquo; Zur&uuml;cksetzen</a>";
