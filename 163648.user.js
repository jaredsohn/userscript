// ==UserScript==
// @name			Script Peseguidores
// @namespace                   http://userscripts.org/scripts/show/999999
// @version			2.0
// @copyright		        www.twitter.com/peseguidores
// @description		        Script Peseguidores perguntas
// @author			(http://userscripts.org/users/476758)
// @include			http://ask.fm/*
// @icon			http://s3.amazonaws.com/uso_ss/icon/138450/large.gif?1342345458
// Peseguidores Soluções
// Skype e msn: peseguidores@hotmail.com
// ==/UserScript==
// ==Profile==
body = document.body;
if(body != null) {
	...
	div.innerHTML = "<div style='background-color: #00a2ff; color: #FFFFFF; border: 1px solid #00a2ff;'><center><a style='color: #000000;' <a href='http://www.facebook.com/leitura.dospes' target='_blank' title='Quer saber mais? :)'> Meu Face </a></div>"
	...
	div2.innerHTML = "<div style='background-color: #00a2ff; color: #FFFFFF; border: 1px solid #00a2ff;'><a style='color: #FFFFFF;' onclick='spoiler()' title='Click Para Ocultar'>&laquo;</a> &#8226; <a href='http://ask.fm/Jeeennyalves' title='Pergunte :)' style='color: #FFFFFF;' onclick='alert(\'Thanks for install this script\');'>Pergunte e mande ideias</a></div> "
	...
	for(i=1;i<=20;i++) {
		...
		div2.innerHTML = "<a onclick='spoiler()' title='Mostrar :) Meu Ask'>&laquo;</a> &#8226; <a href='http://ask.fm/Jeeennyalves' title='Jenna'>Pergunte!</a>"
		}
		else {
