...
function modMenu()
{
    ...
    var menuOptions = [
        ...
        {name:'Battlefield vJT!',          'click': Battlefieldv2                                    },
...
function Battlefieldv2() 
{
    ...
    function genMainDom() {
        ...
        */
        ...
        .append(s$('bfopt_attackdelay', 20))
        .append(x$('bfopt_usenewplayerdelay', 'Delay when changing player:'))
        .append(s$('bfopt_newplayerdelay', 20));
    ...
    function addFightResumeCountdown() {
        ...
        fightResumeCountdown.start(delay*30)
    }
    ...
    function preAttack() {
        ...
        if (op('usePowerAttack') && opp.pwratk) {
            ...
            if ( op('useRapidFire') && opp.fights_for_ice > 2 ) {
                if ( opp.fights_for_ice < op('rapidFireWhen') ) {
                    nRapidFire = Math.ceil(opp.fights_for_ice / 6) + 2;
                }
            }
        }
