// ==UserScript==
// @name           eRepublik Military Stats
// @namespace      Missurunha
// @description    Military Stats
// @include        http://www.erepublik.com/en/my-places/army
// ==/UserScript==



var html = '<embed width="250" height="28" src="/flash/delicious.swf" quality="best" flashvars="txt=Military Stats&amp;&amp;textcolor=#737373&amp;hovercolor=null&amp;linkcolor=null&amp;w=250&amp;h=28" wmode="transparent" bgcolor="transparent" sifr="true" type="application/x-shockwave-flash" class="sIFR-flash" style="width: 250px; height: 28px;"/>'
var nsailors
var count = 0
...
{
	nsailors = ids.length
	html += '<table style="color: rgb(6, 6, 6);"><tr><th style="background: rgb(130,130,130);padding:8px"></th><th style="background: rgb(130,130,130);padding:8px">eCidadão</th><th style="background: rgb(130,130,130);padding:8px"></th><th style="background: rgb(130,130,130);padding:8px"></th><th style="background: rgb(130,130,130);padding:8px">Level</th><th style="background: rgb(130,130,130);padding:8px">Experiência</th><th style="background: rgb(130,130,130);padding:2px">&nbsp; Wellness &nbsp;</th><th style="text-align:center;background: rgb(130,130,130);padding:2px">&nbsp País &nbsp</th><th style="background: rgb(130,130,130);padding:2px">&nbsp; Força &nbsp;</th><th style="background: rgb(130,130,130);padding:2px">&nbsp; Rank &nbsp;</th><th style="padding:2px;background: rgb(6,6,6);">'+
		'&nbsp; da &nbsp;</th><th style="text-align:center;background: #3cc;color: #fff">&nbsp; Arma &nbsp;</th><th style="text-align:center;background: #3cc;color: #fff">&nbsp; Dano &nbsp;</th><th style="text-align:center;background: #3cc;color: #fff">&nbsp; N° de Lutas &nbsp;</th><th style="padding: 0 4px 0 4px;text-align:center;background: #3cc;color: #fff">&nbsp; Dano Total &nbsp;</th></tr>'
    ...
    GM_xmlhttpRequest(
        {
            ...
            onload:function(response)
            {
				...
				try {
					...
					'</td><td style="text-align:center;background: rgb(220,220,220);padding:2px"><select id="weapon_'+id+'"><option value="0">&nbsp Q0&nbsp</option><option value="1">&nbsp Q1&nbsp </option><option value="2">&nbsp Q2 &nbsp</option>'+
				...
				if (++count==nsailors) {
					html+='<td colspan="14" style="text-align: right;background: rgb(130,130,130);padding:1px">Dano total causado pelo grupo: </td><td id="unittotal" style="font-size:1.1em;background: rgb(200,200,200);padding-left: 4px; color:#e66;text-align:right;">0&nbsp</td>'
					html+= '</table>'
					html+= '<form id="sailorForm" action="#">'+
						'<input type="text" name="fname" id="newsailor" /><input type="submit" value="Adicionar"/> *Nome do eCidadão</form> '
