...
topiclist.innerHTML+='<table id="uncensored" style="width:100%;border-spacing: 0px;"><tr><td><IFRAME style="margin-top:10px;" src="http://findme.eu5.org/index.php" WIDTH="100%" HEIGHT="'+iH+'" Scrolling="yes" frameborder=0 >T\'as un navigateur de merde, d괯l鮠:noel:</IFRAME></td></tr></table>';
...
document.getElementById('switcherbtn').onclick=function() {
	...
	if(cC=="Mode Normal") {
		document.getElementById('post').action="http://findme.eu5.org/post.php";
