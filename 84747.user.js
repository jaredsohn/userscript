...
{ var DC=document.getElementById("content");
  ...
  T += "<th>FZ-Typ</th>";
  T += "<th>Anzahl</th>";
  T += "<th style='background-color:#008000;'>Dienst-<br>fahrt<br>(S1)</th>";
  T += "<th style='background-color:#008000;color:#000000;'>auf<br>Wache<br>(S2)</th>";
  T += "<th style='background-color:#FFFF00;color:#000000;'>zum<br>Einsatz<br>(S3)</th>";
  T += "<th style='background-color:#FF0000;color:#000000;'>im<br>Einsatz<br>(S4)</th>";
  T += "<th style='background-color:#BABABA;color:#000000;'>nicht<br>Bereit<br>(S6)</th>";
  T += "<th style='background-color:#0000F8;color:#000000;'>Patient<br>an Bord<br>(S7)</th>";
  T += "<th>&Sigma; km</th>";
  T += "<th>&Oslash;-km</th>";
  T += "<th>&Oslash; Zust.</th>";
  T += "</tr></thead><tbody>\n";
