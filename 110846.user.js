// ==UserScript==
// @name         TW-DB.info Quick Import Button PT-BR
// @version      1.2.2
// @description  Um novo botão ao lado do mini-mapa, que rapidamente inicia o script de importação do TW-DB
// @author       Petee
// @translator   JPezzi
...
+'img alt="TW-DB Import" id="TWDBI_import_button" style="position:absolute;left:2'+(TheWestApi.version=='1.35'?6:2)+'8px;top:-2px;cursor:pointer" title="<'
+'b>Iniciar importação do TW-DB.info<'+'/b>" onclick="wman.open(\'twdbi nominimize noreload\').addTab(\'Por favor, espere...\');jQuery.getScript(\'http://tw-db.info/cache/js/sDoImport_eng.js\');"'
