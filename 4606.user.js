...
while ((res = resultLinks.snapshotItem(i) ) !=null ){
	...
	var msgUsr = "http://mail.myspace.com/index.cfm?fuseaction=mail.message&friendID="+friendID[1];
        var friendForum = "http://forum.myspace.com/index.cfm?fuseaction=messageboard.viewCategory&CategoryID=0&GroupID=0&type=friendForum&friendID="+friendID[1];
	...
	var thisCell = resultCell.snapshotItem(i);
	   ...
	   newfriendForum = document.createElement('a');
	   newfriendForum.href = friendForum;
	   thisCell.parentNode.appendChild(newfriendForum);
	   newfriendForum.innerHTML = 'Forum';
