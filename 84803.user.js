...
function main()
{
	...
	for (var i=0; i<ss.length; i++) {
		var s = ss[i];
		if (s.textContent.indexOf("CreateControl") > 0) {
			eval(s.textContent);
		}
	}
}
...
script.textContent = regex_match + regex_match_msg + check_empty + check_number + check_length + getVersion + getState + passControlCheck + SHA1 + Base64Encode + encrypt;
if (typeof(pageProcessing)=="undefined") script.textContent += 'function pageProcessing(){}';
