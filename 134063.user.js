// ==UserScript==
// @name           eRepublik ROCAS battle pupil (Chrome test)
// @version        v1.0.9.44f
// @description    ROCAS的申報插件 
// @author         SDF_R98,modify by pat
// @author         maybefix by kamira in chrome
// @namespace      pat
...
// reference http://userscripts.org/scripts/show/127746
var rank = {
	'Recruit': 1,
	'Private': 2,
	'Private *': 3,
...
function showStats() {
	...
	if (cmcInf == 0 && eliteInf == 0) {
		tstats = '<tr><td style="text-align:center;font-weight:bold;"><a href="http://erep-roc.com/forum/forum.php?mod=viewthread&tid=8&extra=page%3D1" target="_blank">ROCAS 申報插件 v1.0.9f</a></td></tr>';
	}
