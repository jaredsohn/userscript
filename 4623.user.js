// ==UserScript==
// @name          Dominic's Homepage
// @namespace     dezinerzparaize[dot]com
// @description	  Dominic's LeBron James Homepage
...
s+= "body {background:url(http://photos.imageevent.com/dreamkast/cavs/o.bronwall3.jpg) #800303 fixed;margin-top:-50px;}\n";
...
s+= document.getElementById('splash_coolNewPeople').innerHTML = '<embed allowScriptAccess="never"                                        src="http://www.fileden.com/files/2006/5/29/42111/xspf_bwhite.swf?playlist_url=http://www.fileden.com/files/2006/5/29/42111/playlist44451.xml&autoplay=random" quality="high" name="xpsf_player" type="application/x-shockwave-flash" pluginspage="http://www.macromedia.com/go/getflashplayer" align="center" height="160" width="225"></embed>';"a[id*='ns1_HyperLink2']{display:block;margin:0!important;margin-top:10px!important;text-align:center;font-size:12px!important;}\n";
