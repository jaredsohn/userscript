...
cataText = ["Wybierz cel =)","Losowy cel","Las","Kopalnia gliny","Kopalnia żelaza","Pole","Tartak","Cegielnia","Huta żelaza","Młyn","Piekarnia","Magazyn","Spichlerz","Kuźnia","Zbrojownia","Plac turniejowy","Główny budynek","Miejsce zbiórki","Rynek","Ambasada","Koszary","Stajnia","Warsztat","Akademia","Ratusz","Rezydencja","Pałac","Targ","Duże koszary","Duża stajnia","Dwór bohaterów","Duży magazyn","Duży spichlerz","Cud :P"];
break; 
...
text = ["Pakrauti malkų =)","Klaidinga ataka!","Nepasirinktos koordinatės!","Nepakanka karių! (Troop #","Nepasirinkti kariai","Pradedama","Tikriausiai blogos koordinatės","Nėra žvalgų","Baigta","Bangos nustatymas:","Pridėti naują bangą","Iš naujo","Atakos nustatymas:","Atakos tipas:","Ataka","Pastiprinimas","Reidas","Žvalgyba Resursų/Karių","Žvalgyba Gynybos/Karių","Koordinatės","Pakrauti malkų! =)","Atvykimo laikas","Atvykti:","Nustatyti atvykimo laiką","Bangos numeris","su '|' pvz: 0,0|1,1","Klaida:","Neįmanoma rasti miesto. Išdidus gyventojas","Atvykimo laikas nustatytas:"];

cataText = ["Pasirinkite taikinį =)","Atsitiktinai","Medžių kirtavietė","Molio karjeras","Geležies kasykla","Grūdų ferma","Lentpjūvė","Plytinė","Liejykla","Malūnas","Kepykla","Sandėlis","Klėtis","Ginklų kalvė","Šarvų kalvė","Arena","Gyvenamasis pastatas","Susibūrimo vieta","Turgavietė","Ambasada","Kareivinės","Arklidė","Dirbtuvės","Akademija","Rotušė","Rezidencija","Valdovo rūmai","Prekybos rūmai","Didžiosios kareivinės","Didžioji arklidė","Karžygio namai","Didysis sandėlys","Didžioji klėtis","Pasaulio stebuklas"];
break;
