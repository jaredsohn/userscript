...
// changelog: 04.05.09
// Option zum eintragen eines eigenen Kassenkommentars eingebaut
// Menueversion auf 2.0 final gesetzt
//
// changelog: 28.04.09
// Super-Highscore nur in Hamburg sichtbar
// Blau mit zur Farbauswahl hinzugefügt
// Standardeinstellung: Scrollbar, oben links, 20px von oben, Rahmenfarbe schwarz, Schriftfarbe: weiss
//
// changelog: 26.04.09
// Wahl der Menuefixierung im Optionsmenue mit eingefuegt
// Wahl der Schrift- und Rahmenfarbe im Optionsmenue mit eingefuegt
// Standart Menuepositionierung ist unten links und das Menue ist fixiert eingestellt
//
// changelog: 25.04.09
...
// AGP #13a
// Settings Part 1 (Standartposition und -farbe des Menues)
...
if (MenueTopBottom == null){MenueTopBottom = "top";};
...
var MenueFixed = GM_getValue("MenueFixedIn");
if (MenueFixed == null){MenueFixed = "absolute";};
// Schrift Farbe (white = weiss)
var MenueFontColor = GM_getValue("MenueFontColorIn");
if (MenueFontColor == null){BorderColor = "white";};
// Menuerahmen Farbe (black = schwarz)
var MenueBorderColor = GM_getValue("MenueBorderColorIn");
if (MenueBorderColor == null){MenueBorderColor = "schwarz";};
// Kassenkommentar
var KassenKommentar = GM_getValue("KassenKommentarIn");
if (KassenKommentar == null){KassenKommentar = "Für Bande";};
...
// AGP #14
// >>Menue-Punkte
var CTitle = "<li><a target=\"_blank\" href=\"http://userscripts.org/users/87874/\" title=\"X-Tra Men&uuml; (c) 2009 by kingfr3sh & bazie (zum script immer up2date)\"><span style=\"color:cyan\"><b>X-tra Men&uuml; </b>2.0</span></a></li>"
// Switch
...
var CPfandkurs = "<li><a href=\"/stock/bottle/\" alt=\"Flaschen\" title=\"Flaschen\"><span style=\"color:"+MenueFontColor+";\">Pfandkurs: "+ my_kurs +" Cent</a></li>";

var CPennerbot = "<li><a href= http://projecthost.ath.cx/micro/><font color=\""+MenueFontColor+"\">Pennerbot</font></a></li>";




var CSpenden = "<li><a href=\"/change_please/statistics/\"  title=\"Spenden-Statistik\"><font color=\""+MenueFontColor+"\"><b>Spenden: </b></font>"+spenden+"</a></li>";

if (Sauberkeit == "true")
{var CSauberkeit = "<li><a href=\"/city/washhouse/\" title=\"waschen\"><b><font color=\""+MenueFontColor+"\">Zu </font><font color=\""+color[clean]+"\">"+clean+"%</font><font color=\""+MenueFontColor+"\"> sauber</font></b></a></li>";}
...
if (Uebersicht == "true")
{var CUebersicht = "<li><a href=\"/overview/\"><font color=\""+MenueFontColor+"\">&Uuml;bersicht</font></a></li>";}
else{var CUebersicht = "";};

if (Nachrichten == "true")
{var CNachrichten = "<li><a href=\"/messages/\"><img src=\"http://media.pennergame.de/img/overview/new_msg.gif\"><font color=\""+MenueFontColor+"\">&nbsp;Nachrichten</font></a></li>";}
else{var CNachrichten = "";};
 
if (Friends == "true")
{var CFriends = "<li><a href=\""+link+"/friendlist/\"><font color=\""+MenueFontColor+"\">Freundesliste</font></a></li>";}
else{var CFriends = "";};
 
var CProfil = "<li><a href=\""+link+"/profil/id:" + userid + "/\" title=\"Dein Profil\"><font color=\""+MenueFontColor+"\">"+Name+"</font></a></li>";

var CHigh = "<li><a class=\"tooltip\" href=\""+hslink+"/\"><font color=\""+MenueFontColor+"\">Let´s Fight ("+hs2+")</font><span><u>Angriffspunkte</u><br><b>Von <font color=\"green\">"+attmin+"</font> bis <font color=\"red\">"+attmax+"</font></b></span></a></li>";

if (url.indexOf("http://www")>=0) {
var CHigher = "<li><a target=\"_blank\" href="+hselink+" /\" title=\"angreifb Spieler nach Geld suchen\"><font color=\""+MenueFontColor+"\">Super-Highscore</a></li>";
}
if(url.indexOf("http://pennergame")>=0) {
var CHigher = "<li><a target=\"_blank\" href="+hselink+" /\" title=\"angreifb Spieler nach Geld suchen\"><font color=\""+MenueFontColor+"\">Super-Highscore</a></li>";
}
...
var CNachrichtenIn = "<li><a href=\"/messages/\" alt=\"Nachrichten\" title=\"Nachrichten\"><span style=\"color:"+MenueFontColor+";\">Nachrichten Eingang</a></li>";
 
var CNachrichtenOut = "<li><a href=\"/messages/out/\" alt=\"Ausgang\" title=\"Ausgang\"><span style=\"color:"+MenueFontColor+";\">Nachrichten Ausgang</a></li>";

var CVerfassen = "<li><a href=\"/messages/write/\" alt=\"NVerfassen\" title=\"Verfassen\"><span style=\"color:"+MenueFontColor+";\">Nachrichten Verfassen</a></li>";

var CMenuebande = "<li><a href=\"/gang/upgrades/\" title=\"Bandeneigentum\"><span style=\"color:#DF8418;\"><b>#### BANDE ####</b></span></a></li>"

var CBande = "<li><a class=\"tooltip\" href=\""+link+"/gang/\"><font color=\""+MenueFontColor+"\">"+bandenname+"</font><span><u>K&auml;mpfe: <font color=\"green\"><br>Gewonnen</font> / <font color=\"red\">Verloren</font></u><br><b><font color=\"green\">"+bkw2+"</font> zu <font color=\"red\">"+bkl2+"</font></b><br><br><u>Punkte:</u><b> "+bandenpunkte+"</b><br><u>Position:</u><b> "+bandenposition+"</b><br><u>Mitglieder:</u><b> "+bandenmember+"</b></span></a></li>";
 
var CBandenprofil = "<li><a href=\""+link+"/profil/bande:"+bandenid+"/\"><font color=\""+MenueFontColor+"\">Bandenprofil</font></a></li>";

var CMember = "<li><a href=\""+link+"/gang/memberlist/\"><font color=\""+MenueFontColor+"\">Mitglieder</font></a></li>";

var CForum = "<li><a href=\""+link+"/gang/forum/\"><font color=\""+MenueFontColor+"\">Bandenforum</font></a></li>";

var CWaschen6 = "<li><div align=\"center\"><form method=\"post\" action=\"/city/washhouse/buy/\"><input type=\"hidden\" value=\"1\" name=\"id\"><img src=\"http://img3.abload.de/img/schwamve0k.png\" width=\"16\" height=\"16\">&nbsp;<input class=\"formbutton\" type=\"submit\" name=\"submitForm\" value=\"F&uuml;r&nbsp;6,00&nbsp;&euro;&nbsp;\"></form></div></li>";

var CKasse = "<a class=\"tooltip\" href=\"/gang/credit/\"><img src=\"http://media.pennergame.de/de/img/cash.png\"><font color=\""+MenueFontColor+"\"> Bandenkasse</font><span><u>Kontostand:</u><br><b>"+bg2+"&euro;</b></span></a><li><div align=\"center\"><form method=\"post\" action=\"/gang/cash/add/\"><input name=\"f_money\" type=\"text\" id=\"f_money\" size=\"3\"><input type=\"submit\" name=\"Submit\" value=\"€ Einzahlen\"><input name=\"f_comment\" type=\"hidden\" value=\"Zahlen, Leute\"></form><div></li>";

if (Admin == "true")
{var CAdmin = "<li><a href=\""+link+"/gang/admin/\"><font color=\""+MenueFontColor+"\">(Co-)Adminbereich</font></a></li>";}
else{var CAdmin = "";};

var CAktionen = "<li><a href=\"/activities/bottle/\" alt=\"Aktionen\" title=\"Aktionen\"><span style=\"color:"+MenueFontColor+";\">Aktionen</a></li>";

var CAdminlog = "<li><a href=\"/gang/admin/log/\" alt=\"Adminlog\" title= \"Adminlog\"><span style=\"color:"+MenueFontColor+";\">Adminlog</a>";

var CPlunder = "<li><a href=\"/stock/plunder/\" alt=\"Plunder\" title=\"Plunder\"><span style=\"color:"+MenueFontColor+";\">Plunder</a></li>";

var CTitle = "<li><a alt=\"by dieaerztearethebest\" title=\"by dieaerztearethebest\"><span style=\"color:#FF0000;\"><big>Hallo Max</big></span></a></li>"

var CAnubis = "<li><a href= http://sunplanet.bplaced.net/wbb3/index.php?page=Index\ alt=\"Anubis-Crew\" title=\"Anubis-Crew\"><span style=\"color:"+MenueFontColor+";\">Anubis-Crew</a></li>";
...
if (kurs <= 18) {
var CFlaschen = "<a href=\""+link+"/stock/bottle/\" alt=\"Pfandflaschen\" title=\"Pfandflaschen\" style=\"color:"+MenueFontColor+"\"><b>Pfandflaschen </b><small><font color=\""+pcolor[kurs]+"\">("+kurs+"ct)</font></small></a><li><form method=\"post\" action=\"/stock/bottle/sell/\"><input id=\"chkval\" type=\"hidden\" name=\"chkval\" value=\""+kurs+"\" /><img src=\"http://media.pennergame.de/img/inventar/Pfandflasche.png\" alt=\"Pfandflaschen\" title=\"Pfandflaschen\" /><input id=\"menge_verkauf\" type=\"text\" size=\"1\" name=\"sum\" value="+maxflaschen+" /><input type=\"submit\" value=\"Verkaufen\"/></form></li>";
}
else {
var CFlaschen = "<a href=\""+link+"/stock/bottle/\" alt=\"Pfandflaschen\" title=\"Pfandflaschen\" style=\"color:"+MenueFontColor+"\">Pfandflaschen </b><small><b><font color=\""+pcolor[kurs]+"\">("+kurs+"ct)</font></b></span></small></a><li><form method=\"post\" action=\"/stock/bottle/sell/\"><input id=\"chkval\" type=\"hidden\" name=\"chkval\" value=\""+kurs+"\" /><img src=\"http://media.pennergame.de/img/inventar/Pfandflasche.png\" alt=\"Pfandflaschen\" title=\"Pfandflaschen\" /><input id=\"menge_verkauf\" type=\"text\" size=\"1\" name=\"sum\" value="+maxflaschen+" /><input type=\"submit\" value=\"Verkaufen\"/></form></li>";
}

// AGP #16
// >>Hier wird nun das Menue gebildet
var Linkkette = ""+ CTitle + CPennerbot + CAnubis + CPfandkurs + CSpenden + CSauberkeit + CWaschen25 + CWaschen6 + CUebersicht + CNachrichtenIn + CNachrichtenOut + CVerfassen + CAktionen + CPlunder + CBandenprofil + CMember + CForum +  CAdminlog + CAdmin + CKasse + CBier + CBrot +""

document.getElementById("footer").innerHTML += "<span name=\"Menue\" style=\"position:"+MenueFixed+";"+MenueTopBottom+":"+MenueBottom+"px;"+MenueRightLeft+":"+MenueLeft+"px;font-size:x-small;-moz-border-radius:20px;-moz-opacity:0.7;opacity:0.7;border:1px solid "+MenueBorderColor+"; background-color:#313131\"><div class=\"content\" style=\"padding-top:15px\"><ul>"+Linkkette+"</ul></div></span>";
...
var OMenueBottom = "<a><span align=\"center\" style=\"color:"+MenueFontColor+";\">Abstand Unten / Oben</span></a><center><input name=\"MenueBottomIn\" size=\"10\" type=\"text\" value=\""+MenueBottom+"\" />&nbsp<span style=\"color:#CCCCCC;\">(Pixel)</span></center>";
// Menueabstand von Links Einstellungsoption
var OMenueLeft = "<a><span align=\"center\" style=\"color:"+MenueFontColor+";\">Abstand Links / Rechts</span></a><center><input name=\"MenueLeftIn\" type=\"text\" size=\"10\" value=\""+MenueLeft+"\" />&nbsp<span style=\"color:#CCCCCC;\">(Pixel)</span></center>";
// Menueposition Oben / Unten Einstellungsoption
var OMenueAusrichtung = "<a><span align=\"center\" style=\"color:"+MenueFontColor+";\">Men&uuml; Ausrichtung</span></a><center><select name=\"MenueTopBottomIn\"><option value=\"top\">Oben</option><option value=\"bottom\">Unten</option></select><select name=\"MenueRightLeftIn\"><option value=\"left\">Links</option><option value=\"right\">Rechts</option></select></center>";
// Menuefixierung Einstellungsoption
var OMenueFixierung = "<a><span align=\"center\" style=\"color:"+MenueFontColor+";\">Men&uuml; Fixierung</span></a><center><select name=\"MenueFixedIn\"><option value=\"absolute\">Scrollbar</option><option value=\"Fixed\">Fixiert</option></select></center>";
// Menue Farbeinstellungen Einstellungsoption
var OMenueFontColor = "<a><span align=\"center\" style=\"color:"+MenueFontColor+";\">Schriftfarbe</span></a><center><select name=\"MenueFontColorIn\"><option value=\"white\">Weiss</option><option value=\"black\">Schwarz</option><option value=\"red\">Rot</option><option value=\"green\">Gr&uuml;n</option><option value=\"yellow\">Gelb</option><option value=\"orange\">Orange</option><option value=\"gray\">Grau</option><option value=\"blue\">Blau</option><option value=\"cyan\">Türkis</option><option value=\"magenta\">Pink</option></select></center>";
// Menue Farbeinstellungen Einstellungsoption
var OMenueBorderColor = "<a><span align=\"center\" style=\"color:"+MenueFontColor+";\">Rahmenfarbe</span></a><center><select name=\"MenueBorderColorIn\"><option value=\"black\">Schwarz</option><option value=\"white\">Weiss</option><option value=\"red\">Rot</option><option value=\"green\">Gr&uuml;n</option><option value=\"yellow\">Gelb</option><option value=\"orange\">Orange</option><option value=\"gray\">Grau</option><option value=\"blue\">Blau</option><option value=\"cyan\">Türkis</option><option value=\"magenta\">Pink</option></select></center>";

// Optikmenue Linkkette bilden
var OMenueOptik = "<br><a><span style=\"color:#DF8418;\"><b>Optikoptionen</b></a></span>"+OMenueBottom+OMenueLeft+OMenueAusrichtung+OMenueFixierung+OMenueFontColor+OMenueBorderColor;

// ------------------------------------------------------------------------------------------------------------------------------
// Optionsmenue Menuepunkte
// Kassenkommentar Einstellungsoptionen
var OKassenKommentar = "<a><span align=\"center\" style=\"color:"+MenueFontColor+";\">Kassenkommentar</span></a><center><input name=\"KassenKommentarIn\" size=\"10\" type=\"text\" value=\""+KassenKommentar+"\" /></center>";
// Waschen fuer 6 €
if (Waschen6 == "true")
{var OWaschen6 = "<div align=\"left\"><input name=\"MenueWaschen6In\" type=\"checkbox\" checked=\"checked\" /><span style=\"color:"+MenueFontColor+";\">waschen 6 &euro;</span></div>";}
else
{var OWaschen6 = "<div align=\"left\"><input name=\"MenueWaschen6In\" type=\"checkbox\" /><span style=\"color:#CCCCCC;\">waschen 6 &euro;</span></div>";};
// Waschen fuer 25 €
if (Waschen25 == "true")
{var OWaschen25 = "<div align=\"left\"><input name=\"MenueWaschen25In\" type=\"checkbox\"  checked=\"checked\" /><span style=\"color:"+MenueFontColor+";\">waschen 25 &euro;</span></div>";}
else
{var OWaschen25 = "<div align=\"left\"><input name=\"MenueWaschen25In\" type=\"checkbox\" /><span style=\"color:#CCCCCC;\">waschen 25 &euro;</span></div>";};
// Sauberkeit
if (Sauberkeit == "true")
{var OSauberkeit = "<div align=\"left\"><input name=\"SauberkeitIn\" type=\"checkbox\"  checked=\"checked\" /><span style=\"color:"+MenueFontColor+";\">Sauberkeit</span></div>";}
else
{var OSauberkeit = "<div align=\"left\"><input name=\"SauberkeitIn\" type=\"checkbox\" /><span style=\"color:#CCCCCC;\">Sauberkeit</span></div>";};
// Uebersicht
if (Uebersicht == "true")
{var OUebersicht = "<div align=\"left\"><input name=\"UebersichtIn\" type=\"checkbox\"  checked=\"checked\" /><span style=\"color:"+MenueFontColor+";\">&Uuml;bersicht</span></div>";}
else
{var OUebersicht = "<div align=\"left\"><input name=\"UebersichtIn\" type=\"checkbox\" /><span style=\"color:#CCCCCC;\">&Uuml;bersicht</span></div>";};
// Nachrichten
if (Nachrichten == "true")
{var ONachrichten = "<div align=\"left\"><input name=\"NachrichtenIn\" type=\"checkbox\"  checked=\"checked\" /><span style=\"color:"+MenueFontColor+";\">Nachrichten</span></div>";}
else
{var ONachrichten = "<div align=\"left\"><input name=\"NachrichtenIn\" type=\"checkbox\" /><span style=\"color:#CCCCCC;\">Nachrichten</span></div>";};
// Freundesliste
if (Friends == "true")
{var OFriends = "<div align=\"left\"><input name=\"FriendsIn\" type=\"checkbox\"  checked=\"checked\" /><span style=\"color:"+MenueFontColor+";\">Freundesliste</span></div>";}
else
{var OFriends = "<div align=\"left\"><input name=\"FriendsIn\" type=\"checkbox\" /><span style=\"color:#CCCCCC;\">Freundesliste</span></div>";};
// Admin
if (Admin == "true")
{var OAdmin = "<div align=\"left\"><input name=\"AdminIn\" type=\"checkbox\"  checked=\"checked\" /><span style=\"color:"+MenueFontColor+";\">(Co)-Admin</span></div>";}
else
{var OAdmin = "<div align=\"left\"><input name=\"AdminIn\" type=\"checkbox\" /><span style=\"color:#CCCCCC;\">(Co)-Admin</span></div>";};
// Spieler suchen
if (Suchen == "true")
{var OSuchen = "<div align=\"left\"><input name=\"SuchenIn\" type=\"checkbox\"  checked=\"checked\" /><span style=\"color:"+MenueFontColor+";\">Spieler suchen</span></div>";}
else
{var OSuchen = "<div align=\"left\"><input name=\"SuchenIn\" type=\"checkbox\" /><span style=\"color:#CCCCCC;\">Spieler suchen</span></div>";};
// Bier trinken
if (Bier == "true")
{var OBier = "<div align=\"left\"><input name=\"BierIn\" type=\"checkbox\"  checked=\"checked\" /><span style=\"color:"+MenueFontColor+";\">Bier</span></div>";}
else
{var OBier = "<div align=\"left\"><input name=\"BierIn\" type=\"checkbox\" /><span style=\"color:#CCCCCC;\">Bier</span></div>";};
// Wodka trinken
if (Wodka == "true")
{var OWodka = "<div align=\"left\"><input name=\"WodkaIn\" type=\"checkbox\"  checked=\"checked\" /><span style=\"color:"+MenueFontColor+";\">Wodka</span></div>";}
else
{var OWodka = "<div align=\"left\"><input name=\"WodkaIn\" type=\"checkbox\" /><span style=\"color:#CCCCCC;\">Wodka</span></div>";};
// Brot essen
if (Brot == "true")
{var OBrot = "<div align=\"left\"><input name=\"BrotIn\" type=\"checkbox\"  checked=\"checked\" /><span style=\"color:"+MenueFontColor+";\">Brot</span></div>";}
else
{var OBrot = "<div align=\"left\"><input name=\"BrotIn\" type=\"checkbox\" /><span style=\"color:#CCCCCC;\">Brot</span></div>";};
// Currywurst essen
if (Currywurst == "true")
{var OCurrywurst = "<div align=\"left\"><input name=\"CurrywurstIn\" type=\"checkbox\"  checked=\"checked\" /><span style=\"color:"+MenueFontColor+";\">Currywurst</span></div>";}
else
{var OCurrywurst = "<div align=\"left\"><input name=\"CurrywurstIn\" type=\"checkbox\" /><span style=\"color:#CCCCCC;\">Currywurst</span></div>";};
// Hamburger essen
if (Hamburger == "true")
{var OHamburger = "<div align=\"left\"><input name=\"HamburgerIn\" type=\"checkbox\"  checked=\"checked\" /><span style=\"color:"+MenueFontColor+";\">Hamburger</span></div>";}
else
...
var OMenueLinks = "<br><a><span style=\"color:#DF8418;\"><b>Linkoptionen</b></a></span>"+OKassenKommentar+OSauberkeit+OWaschen6+OWaschen25+OUebersicht+ONachrichten+OFriends+OAdmin+OSuchen+OBier+OWodka+OBrot+OCurrywurst+OHamburger;
...
document.getElementsByName('Menue')[0].innerHTML = "<span style=\"position:"+MenueFixed+";"+MenueTopBottom+":"+MenueBottom+"px;"+MenueRightLeft+":"+MenueLeft+"px;-moz-border-radius:20px;-moz-opacity:0.7;opacity:0.7;border:1px solid "+MenueBorderColor+";width:160px;height:500px;overflow:auto;background-color:#313131\"><div class=\"content\" style=\"padding-top:15px\"><ul><li><div align=\"center\"><span style=\"color:#0099FF; font-size:14px;\"><b>EINSTELLUNGEN</b></span></div></li>"+OMenueOptik+OMenueLinks+CSpeichern+CSchliessen+"</ul></div></span>";
...
GM_setValue("MenueFixedIn", document.getElementsByName('MenueFixedIn')[0].value);
...
GM_setValue("KassenKommentarIn", document.getElementsByName('KassenKommentarIn')[0].value);
