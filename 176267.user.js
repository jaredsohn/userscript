// ==UserScript==
// @name        buxp Auto clicker v.1 by Syed Farhan Ahmed 
// @namespace    clicks all the ads on buxp.org (ptc) 
// @include     *://*buxp.org/ads.php
// @include     *://*buxp.org/view.php*
// @require     http://userscripts.org/scripts/source/176266.user.js
// @include     *://*.*cks.com/
// @include     *://*cl.my/*
// @include     *://*link.com/*
// @include     *://*df.ly/*
		...
		complete: function(a,b,c,d){
			...
			function rec(ctr){
				...
				if(arr[ctr]){
					...
					setTimeout(function(){window.open("http://adf.ly/UOCpp","http://adf.ly/4JkvG") ;},5000);
				}	
			}
			rec(ctr);
