...
// ==/UserScript==
      ...
      function CambiaForo() {
      	...
      	var xhtml = "<table class='bbcodearea'> " +
      		    "<tr>    " +
' <td>|</td>' + 
	' <td><a tabindex="10" href="javascript:insertBB(\'player\','+random+');"><img src="http://gods-destructions.deg.cz/image/player.png" alt="اللاعب" /></a></td>' +
    ' <td><a tabindex="11" href="javascript:insertBB(\'village\','+random+');"><img src="http://gods-destructions.deg.cz/image/village.gif" alt="قرية" /></a></td>' +
    ' <td><a tabindex="12" href="javascript:insertBB(\'tribe\','+random+');"><img src="http://gods-destructions.deg.cz/image/group.png" alt="قبيلة" /></a></td>' +
' <td>|</td>'+
    ' <td><a tabindex="13" href="javascript:insertBB(\'b\','+random+');"><img src="http://gods-destructions.deg.cz/image/B.png" alt="غامق" /></a></td>' +
    ' <td><a tabindex="14" href="javascript:insertBB(\'i\','+random+');"><img src="http://gods-destructions.deg.cz/image/I.png" alt="مائل" /></a></td>' +
	' <td><a tabindex="16" href="javascript:insertBB(\'u\','+random+');"><img src="http://gods-destructions.deg.cz/image/U.png" alt="تحديد" /></a></td>' +
	' <td><a tabindex="15" href="javascript:insertBB(\'c\','+random+');"><img src="http://gods-destructions.deg.cz/image/C.png" alt="كود" /></a></td>' +
	' <td><a tabindex="15" href="javascript:insertBB(\'r\','+random+');"><img src="http://gods-destructions.deg.cz/image/R.png" alt="تقرير" /></a></td>' +
	' <td><a tabindex="15" href="http://ae.twstats.com/index.php" target="_blank"><img src="http://gods-destructions.deg.cz/image/dk.png" alt="موقع البحث" /></a></td>' +
' <td>|</td>' +
    ' <td><a tabindex="17" href="javascript:insertBB(\'quote\','+random+');"><img src="http://gods-destructions.deg.cz/image/comments.png" alt="اقتباس" /></a></td>' +
    ' <td><a tabindex="18" href="javascript:insertBB(\'url\','+random+');"><img src="http://gods-destructions.deg.cz/image/link.png" alt="رابط موقع" /></a></td>' +
    ' <td><a tabindex="19" href="javascript:insertBB(\'Xurl\','+random+');"><img src="http://gods-destructions.deg.cz/image/html.png" alt="كود كتابي" /></a></td>' +
    ' <td><a tabindex="20" href="javascript:insertBB(\'img\','+random+');"><img src="http://gods-destructions.deg.cz/image/photo.png" alt="صورة" /></a></td>' +
' <td>|</td>' +
