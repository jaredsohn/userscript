...
// @namespace      taringa
// @include        *taringa.net/*
// @exclude        *taringa.net/comunidades/dreamcast/*
// @creator        rodrigovazquez420 [user]
// ==/UserScript==
...
byClass('menuTabs').innerHTML += "<li id=\"tabbedDC\" class=\"tabbed\">\n <a href=\"http://www.taringa.net/comunidades/dreamcast/\" onclick=\"menu(\'DreamCast \', this.href);return false;\" title=\"Ir a la comu DreamCast\">DreamCast <img src=\n\"imagen\" alt=\"-rvz420\" /></a>\n</li>";
...
function procesarEventos()
{
  ...
  {    
    div.innerHTML = '<div align="center"><img src="imagen" alt="bunchie"></div>';
  }
}
