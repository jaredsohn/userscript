...
// @changes					Pitmm
// @version			0.59b
// @history			0.59b Improved integration with NEW ScriptUpdater (http://userscripts.org/scripts/show/98729) 
// @history			0.59b Added IkaTools.addOptionsLink() method (requires http://userscripts.org/scripts/show/98726)
// @history			0.59a Added dump
...
var IkaTools = {
	...
	addOptionsLink:function(scriptName) {
		if(typeof(Config) == 'undefined') {
			...
			if(c)
				document.location = "http://userscripts.org/scripts/show/98726";
		} else {
	...
	buildingIsMaxed:function(building) {
		...
		switch(building.type) {
			...
			case 'dump': return parseInt(building.level) == 32;
