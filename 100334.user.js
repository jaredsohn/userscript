// ==UserScript==
// @name           Professional searching
// @namespace      http://userscripts.org/users/316248
// @description    Keress egyszerűen zenét, filmeket, torrenteket, ebookokat, keress ftp-k tartalmában és fájlmegosztók szerint.
// @version		   1.0.0
...
newradio('Web', '');
newradio('Warezlinks.eu', 'site:warezlinks.eu');
...
newselect('Web', '');
newselect('Warezlinks.eu', 'site:Warezlinks.eu');
