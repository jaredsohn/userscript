...
var positionData = {
    "DE": {
        majors: ["speed","strength","vision"],
        minors: ["stamina","tackling","agility"],
        weightOptions: 18,
        heightOptions: 3
    },
    "DT": {
    ...
    "C": {
        ...
        minors: ["speed","confidence","vision"],
        weightOptions: 22,
        heightOptions: 2
    },
    "G": {
    ...
    "HB": {
        majors: ["vision","speed","agility","catching"],
        minors: ["jumping","stamina","confidence","carrying"],
        weightOptions: 20,
        heightOptions: 2
    },
    "WR": {
        majors: ["agility","jumping","vision","catching"],
        minors: ["confidence","carrying","speed","stamina"],
        weightOptions: 11,
        heightOptions: 2
    },
    "QB": {
        majors: ["speed","throwing","vision"],
        minors: ["strength","stamina","confidence"],
        weightOptions: 9,
        heightOptions: 3
    },
    "TE": {
        majors: ["speed","agility","catching","vision"],
        minors: ["carrying","stamina","jumping","confidence"],
        weightOptions: 22,
        heightOptions: 3
    },
    "FB": {
        majors: ["strength","carrying","agility","speed"],
        minors: ["catching","vision","stamina","blocking"],
        weightOptions: 15,
        heightOptions: 3
    },
    "LB": {
    ...
    "CB": {
        ...
        minors: ["speed","jumping","stamina","confidence"],
        weightOptions: 11,
        heightOptions: 3
    },
    "SS": {
