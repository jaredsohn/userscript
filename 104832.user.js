...
// @description     Script for The-West: TW Pro+ [SOM - Scripts-O-Maniacs] [Multilingual] (v3.0.0.0)
...
var twpro_lang = {
	info: ['1.31', '1.31 Uyumlu Türkçe Çeviri', 121212, '.w1.'],
		AUTHOR: 'Yazarlar',
		TRANSLATOR: 'Çevirmen',
		TWPRO_DISABLED: 'Script Kapatildi: The Westin kaynak kodu degistigi için scriptin güncellenmesi gerekiyor.',
		...
		LABORP: 'ÇP',
		CONSTRUCTION: ' \u25B7 Kurma',
		HPTOTAL: 'Toplam Hayat Puani',
		STARTCALC: 'Veriler hesaplaniyor , lütfen bekleyiniz...',
		CONVERT: 'Dönüştür !',
		MULTISEL: 'Birden fazla esya sat...',
		SELL: 'Seçili olanı sat',
		CONFIRMSELL: 'Gerçekten %1 yigin esya satmak istiyormusunuz ?',
		SELLING: 'Satılıyor...',
		SALEDONE: 'Seçili esyalar satildi !',
		NONESELECTED: 'En az bir esya seçmeniz gerekiyor !',
		JOBRANKSETTINGS: 'Çalisma Seviyesi Ayarlari',
		SEARCHINVENTORY: 'Envanterde Ara',
		NOSEARCHRESULT: 'Aradiginiz %1 için hiç sonuç bulunamadi.%2Tüm esyalari göster%3',
		DISABLEBESTFORJOB: 'Seçili aktivite için degersiz esyalarin gizlenmesini iptal et.',
		SEARCHHELP: 'Envanteri ara. Wildcards kullanabilirsin (* sifir veya daha fazla karakter için, ? bir karakter için)',
		DUELSHOOTINGATT: ' \u25B7 Atis Düellocusu (saldıran)',
		DUELSHOOTINGDEF: ' \u25B7 Atis Duellocusu (savunan)',
		DUELVIGOR: ' \u25B7 Vurus Duellocusu',
		FORTATTACK: ' \u25B7 Kale savasi (saldıran)',
		FORTDEFEND: ' \u25B7 Kale savasi (savunan)',
		FORTMESSAGE: 'Katilimcilara Telgraf Gönder',
		FORTMESSAGERCP: 'Katilimcilarin Sayisi',
		HIDEJOBS: 'Aktiviteler & Esya Setleri Yönetim Merkezi',
		CONFIRM: 'Onayla !',
		HIDEJOBDESC: 'Çalışmalar buradan kapatilabilir. Otomatik hesaplanmayacak tüm aktiviteleri isaretle, ve onayla butonuna tiklamalisiniz.',
		SHOWN: 'Etkin',
		HIDDEN: 'Pasif',
		SETTINGSSAVED: 'TW Pro Gelismis Envanter ayarlari uygulandi !',
		SETTINGSSAVEDSESSION: 'TW Pro Gelismis Envanter ayarlari uygulandi ! (Sadece bu oturum için)',
		PERSISTSETTINGS: 'Bu ayarlari daha sonraki oturumlari için kaydet.',
		CANNOTWEAR: 'Bu seti giyemezsiniz, ya da bu setin hesaplanmis aktivite için bir etkisi yoktur !',
		SETSETTINGS: 'Daha hizli hesaplama için setleri kapatabilirsiniz. Özel ve gereksinim olmayan setler kapatilmistir !',
		CUSTOMNAME: 'Aktivite için istediginiz bir isim verin !',
		CUSTOMCALCULATION: 'Geçerli TW Pro Gelismis Envanter hesaplamasini buraya girin.',
		CUSTOMENABLED: 'Aktiviteyi etkinlestirmek için seçili hale getirin !',
		NEW: 'Yeni',
		SPEED: ' \u25B7 Hiz',
		REGENERATION: ' \u25B7 Max Hayat Puani',
		SETSINFO: "Setler",
		WITHSETITEMS: '%1 Esyalar ile bonus',
		LABORPOINTS: 'Çalisma Puani',
		USEFULITEM: 'Bu sayi hesaplamada kullanilan esya miktarini gösterir !',
		PERCREGENERATION: 'Yenilenme',
		LUCK: 'Sans',
		PRAYING: 'Dua etme',
		NOITEMSETS: "Bu set için esyan yok !",
		AVERAGEDAMAGE: "Ortalama Hasar",
		PREFERENCES: "Seçenekler",
		DEFAULTSORTING: " \u25B7 Varsayilan Siniflandirma",
		FBHEALTHPRIORITY: "Hayat Puani Öncelik",
		FBHEALTHPRIORITYZERO: "Hiç",
		FBHEALTHPRIORITYLOW: "Düsük",
		FBHEALTHPRIORITYMEDIUM: "Orta",
		FBHEALTHPRIORITYHIGH: "Yüksek",
		FBHEALTHPRIORITYAUTO: "Otomatik",
		FBBATTLEUNIT: "Savas Birim Tipi",
		FBBATTLEUNITSKIRMISHER: "Çatisan (savulmak) | Ön Hat",
		FBBATTLEUNITLINEINFANTRYMAN: "Piyade (çok degerli) | Orta Hat",
		FBBATTLEUNITMARKSMAN: "Nisanci (nisan almak) | Arka Hat",
		DMGMIN: "Min",
		DMGMAX: "Mak",
		DMGAVG: "Ort",
		CHATWHISPER: "* Fısılda *\n\nOyuncu ismi giriniz",
		CHATCOLOR: "* Varsayılan renk (000-999) *\n\nRenk kodu giriniz",
		USEFULITEMS : "Etkin aktivite için tüm uygun eşyalari vurgula !",
		USEFULITEMSPOPUP : " \u25B7 Kutu | Ayrintilari ile vurgula"
		USEFULITEMSPOPUPDESC : "Bonuses by activities will be displayed on each useful item (process is a little longer).",
		SHOWALLJOBS : " \u25B7 Haritada tüm isleri göster",
		SHOWALLJOBSDESC : "Yeniledikten sonra aktif olacak (F5)",
		COLLECTORMODE : " \u25B7 Toplayici Mod",
		COLLECTORMODEDESC : "Items at merchants will be highlighted in blue if you don't own them yet.",
		HELP : "Yardım",
		WEBSTORAGEQUOTAEXCEEDED : "Web Depolama kota aşıldı !\n\n- Mevcut veriler eksik olacaktır.\n- Önbellek özelliği otomatik olarak devre dışı bırakıldı. \n- Bu sunucuda bazı hesapların önbelleğini boşaltın lütfen , ya da Yerel Depolama kota limitlerini arttırmak. (sadace firefox ve opera ile mümkündür).",
		CACHEGENERATE : "Önbellek oluşturuluyor...",
		CACHEGENERATENOW : "Şimdi yeni önbellek oluşturmak istiyor musunuz ?",
		CACHEINVENTORYCHANGES : "Envanter degisiklikleri tespit edildi.",
		CACHEGENERATECLICK : "Yeni önbellek oluşturmak için tıklayın.",
		CACHENEWITEMS : "Yeni eşyalar",
		CACHEDELETEDITEMS : "Eşyalar silindi",
		CACHESKILLSCHANGES : "Beceri degisiklikleri tespit edildi.",
		CACHEJOBSAFFECTED : "Activities affected",

		CACHEISEMPTY : "Önbellek boş.",
		CACHEINITIALIZE : "Baslatmak için buraya tiklayin.",
		...
		CACHENORMALMODE : "TW Pro sürecinde normal modundadır.",
		CACHEDISABLED : "Önbellek devredışı.",
		CACHEOPENSETTINGS : "Etkinleştirmek için TW Pro Ayarları'nı açın.",
		CACHEENABLE : " \u25B7 TW Pro önbellek etkinlestiriliyor",
		CACHEINDEXEDDBNOT : "IndexedDB is not supported by your browser.",
		CACHEINDEXEDDBDESC : "Ultra hızlı işlem. Önerilen tarayıcılar firefox 4+ versionlar , chrome 11+ versionlar.",
		CACHECOMPATIBILITY : "Uyumluluk detaylar",
		CACHEQUOTAS : "Kontenjanlar detaylar",
		CACHEQUOTASDESC : "<b>Click on 'Quotas infos' to know your browser WebStorage (LocalStorage) limits.<br>"
				  +"<br>Yerel Depolama sınırları nasıl arttırılır ?</b><br>"
				  +"<b>- Firefox:</b><br>"
				  +"Tip 'hakkında:config' in your adres çubuğu ve arama for the 'dom.storage.default_quota' seçenek.<br>"
				  +"Değeri kilobayt olanı, değiştirebilirsiniz . Depolama alanı dil sunucusu tarafından paylaşılır .,<br>"
				  +"Aynı sunucu üzerinde hesap başına 1500 civarında kB ihtiyacınız var.<br>"
				  +"<b>- Chrome:</b><br>"
				  +"Mümkün değil.<br>"
				  +"<b>- Opera:</b><br>"
				  ...
				  +"<b>- Safari:</b><br>"
				  +"Mümkün değil.",
		CACHEEMPTY : "TW Pro önbellek boş.",
		CACHEEMPTYDESC : "Kurtarma aracı. Veri tutarsızlık durumunda ağırlıklı kullanılacak.",
		CACHEWEBSTORAGEDESC : "Fast processing. Supported by most current browsers but may be subject to storage quota limits.",
		CACHEEMPTYNOW : "Şimdi bu önbelleği boşaltmak istiyor musunuz?",
		...
		FBCOMBOSUBMENUS : "Alt menüler modu",
		FBCOMBOSUBMENUSDESC : "Displays the combinations as submenus of the main Fortbattle activities.",
		FBCOMBOHELPDESC : "<b>When your dropdown menu is open:</b><br>- Hit [1] to expand the Attacking combinations submenu.<br>- Hit [2] to expand the Defending combinations submenu.<br>- Hit [Space] to expand both submenus.",
	...
	twpro_langs.fr = {
		...
		NOEQUIP: "Sans Ã©quipement",
		BESTEQUIP: "Avec votre meilleur Ã©quipement",
		...
		FBHEALTHPRIORITYZERO: "0| Aucune",
		FBHEALTHPRIORITYLOW: "1| Faible",
		FBHEALTHPRIORITYMEDIUM: "2| Moyenne",
		FBHEALTHPRIORITYHIGH: "3| ElevÃ©e",
		FBHEALTHPRIORITYAUTO: "4| Automatique",
		FBBATTLEUNIT: "Type d\'unitÃ©",
		FBBATTLEUNITSKIRMISHER: "1| Tirailleur (Ã©viter) | PemiÃ¨re ligne",
		FBBATTLEUNITLINEINFANTRYMAN: "2| Fantassin de ligne (polyvalent) | Soutien central",
		FBBATTLEUNITMARKSMAN: "3| Tireur d\'Ã©lite (viser) | Position arriÃ¨re",
		DMGMIN: "Min",
		DMGMAX: "Max",
		DMGAVG: "Moy",
		...
		USEFULITEMSPOPUPDESC : "Les bonus par activitÃ©s seront affichÃ©s sur chaque objet utile (le processus est un peu plus long).",
		SHOWALLJOBS : " \u25B7 Afficher tous les jobs sur la carte",
		SHOWALLJOBSDESC : "Sera actif aprÃ¨s actualisation (F5)",
		COLLECTORMODE : " \u25B7 Mode collectionneur",
		COLLECTORMODEDESC : "Les objets chez les marchands seront surlignÃ©s en bleu si vous ne les possÃ©dez pas encore.",
		HELP : "AIDE",
		WEBSTORAGEQUOTAEXCEEDED : "Quota WebStorage dÃ©passÃ©!\n\n- Vos donnÃ©es actuelles seront incomplÃ¨tes.\n- La fonction Cache a Ã©tÃ© dÃ©sactivÃ©e automatiquement.\n- Veuillez vider le cache de certains comptes sur ce serveur, ou augmentez le quota maximum de votre LocalStorage (possible uniquement avec Firefox ou Opera).",
		CACHEGENERATE : "GÃ©nÃ©rer le cache...",
		CACHEGENERATENOW : "Souhaitez-vous gÃ©nÃ©rer le cache maintenant?",
		CACHEINVENTORYCHANGES : "Changements dÃ©tectÃ©s dans l'inventaire.",
		CACHEGENERATECLICK : "Cliquez pour gÃ©nÃ©rer un nouveau cache.",
		CACHENEWITEMS : "Nouveaux objets",
		CACHEDELETEDITEMS : "Objets supprimÃ©s",
		CACHESKILLSCHANGES : "Changements dÃ©tectÃ©s dans les aptitudes.",
		CACHEJOBSAFFECTED : "ActivitÃ©s affectÃ©es.",
		CACHEISEMPTY : "Le cache est vide.",
		CACHEINITIALIZE : "Cliquez ici pour l'initialiser.",
		CACHEOK : "Cache OK.",
		CACHEREWRITE : "Si nÃ©cessaire, vous pouvez toujours rÃ©Ã©crire les donnÃ©es en cliquant ici.",
		CACHEEMPTYING : "Vidage de cache en cours...",
		CACHENORMALMODE : "TW Pro est en mode normal pendant la durÃ©e du processus.",
		CACHEDISABLED : "Cache dÃ©sactivÃ©.",
		CACHEOPENSETTINGS : "Ouvrez les rÃ©glages de TW Pro pour l'activer.",
		CACHEENABLE : " \u25B7 Activer le cache de TW Pro",
		CACHEINDEXEDDBNOT : "IndexedDB n'est pas supportÃ© par votre navigateur.",
		CACHEINDEXEDDBDESC : "Processus ultra rapide. RecommandÃ© pour Firefox 4+ et Chrome 11+.",
		CACHECOMPATIBILITY : "Infos compatibilitÃ©",
		CACHEQUOTAS : "Infos quotas",
		CACHEQUOTASDESC : "<b>Cliquez sur 'Infos quotas' pour connaÃ®tre les limites du WebStorage (LocalStorage) de votre navigateur.<br>"
				  ...
				  +"Cette valeur est en kilooctets, vous pouvez la changer. L'espace de stockage est partagÃ© par serveur de mÃªme<br>"
				  +"langue, vous aurez besoin d'environ 1500 ko par compte sur un mÃªme serveur.<br>"
				  +"<b>- Chrome:</b><br>"
				  +"Il n'est pas possible d'ajuster les quotas.<br>"
				  +"<b>- Opera:</b><br>"
				  +"Par dÃ©faut, votre navigateur vous invitera Ã  augmenter les limites si nÃ©cessaire. Toutefois vous pouvez<br>"
				  +"taper 'opera:webstorage' dans votre barre d'adresse et changer les paramÃ¨tres manuellement pour chaque domaine.<br>"
				  +"La valeur est en kilooctects. L'espace de stockage est partagÃ© par monde (sous-domaine), vous aurez besoin<br>"
				  +"d'environ 3000 ko par compte sur un mÃªme monde.<br>"
				  +"<b>- Safari:</b><br>"
				  +"Il n'est pas possible d'ajuster les quotas.",
		CACHEEMPTY : "Vider le cache de TW Pro.",
		CACHEEMPTYDESC : "Outil de secours. A utiliser principalement en cas d'incohÃ©rence des donnÃ©es.",
		CACHEWEBSTORAGEDESC : "Processus rapide. SupportÃ© par la majoritÃ© des navigateurs rÃ©cents mais peut Ãªtre sujet Ã  des quotas de stockage limitÃ©s.",
		CACHEEMPTYNOW : "Souhaitez-vous vider le cache maintenant?",
		CACHERECORDS : "enregistrements",
		CACHEEMPTIED : "Cache vidÃ©!",
		CACHERECORDSDELETED : "enregistrements supprimÃ©s.",
		CACHEEMPTYSLOWDESC : "Vous pouvez continuer Ã  jouer pendant le processus.",
		CACHEEMPTYFASTDESC : "Plus rapide mais peut bloquer le navigateur pendant le processus.",
		CACHEFASTMODE : "Mode rapide",
		NORMALMODE : "Mode normal",
		FBCOMBOFAVORITE : "Favori",
		FBCOMBOGENERATE : "GÃ©nÃ©rer toutes les combinaisons de Batailles de Fort",
		FBCOMBODESC : "Ceci ajoutera 30 activitÃ©s Ã  votre menu dÃ©roulant, mais vous pourrez ensuite les gÃ©rer dans l'onglet",
		FBCOMBONORMALDESC : "Affiche les combinaisons comme des activitÃ©s normales dans le menu dÃ©roulant.",
		FBCOMBOSUBMENUS : "Mode sous-menus",
		FBCOMBOSUBMENUSDESC : "Affiche les combinaisons en tant que sous-menus des activitÃ©s principales de Batailles de Fort.",
		FBCOMBOHELPDESC : "<b>Quand votre menu dÃ©roulant est ouvert:</b><br>- Appuyez sur [1] pour dÃ©ployer le sous-menu des combinaisons d'Attaque.<br>- Appuyez sur [2] pour dÃ©ployer le sous-menu des combinaisons de DÃ©fense.<br>- Appuyez sur [Espace] pour dÃ©ployer les 2 sous-menus.",
		FBCOMBOMOZTIP : "Les utilisateurs de Firefox peuvent aussi faire un clic-droit dans le menu dÃ©roulant, sur les<br>activitÃ©s principales de Batailles de Fort, afin de dÃ©ployer les sous-menus correspondants.",
	};
...
var twpro_minimap_coord = 'data:image/png;base64,'
	...
	var specialMessages = {
		...
		'job_hp': function(twpro_hp){
			return Character.skill_titles.health+": "+((9+Character.level)+(Character.skills.health+twpro_hp)*(Character.characterClass == "soldier"?(PremiumBoni.hasBonus('character')?2:1.5):1))*10;
		},
		'regeneration': function(twpro_job){
			return "<div style='position: relative; float: right; top: -1px;'>"+Character.skill_titles.health+": " + (twpro_job.maxlifes+(TWPro.prefs['useCache']=='true'?(((Character.skills.health-twpro_job.twpro_regeneration_skillhealth)*(Character.characterClass=='soldier'?(PremiumBoni.hasBonus('character')?20:15):10))+((Character.level-twpro_job.twpro_regeneration_level)*10)):0)) + " @ " + Math.round(TWPro.twpro_sleeperBonus(twpro_job.sleepCount)*10000)/100 + "%<\/div>";
...
//		TWPro.twpro_market_list = [];
		...
		TWPro.cacheMethod = TWPro.prefs['cacheMethod'];
		...
		if(TWPro.prefs['useCache']=='true') twproCache.initialize(Character.playerId);
	...
	//				var deleteRequest = deleteTransaction.objectStore("twpro_som").delete(escape([object.namespace, key].join("")));
		...
		if(TWPro.prefs['useCache']=='true' && TWPro.cacheMethod=="IndexedDB") twproCache_idb.initialize(Character.playerId);
		...
		for (var i in JobList) {
			...
			if (TWPro.prefs["showAllJobs"] == 'true') {
...
/*		if (TWPro.twpro_failureInject) {
	...
	function twpro_split_fortbattle(){
		if(TWPro.prefs['splitFortbattle']=='true'){
...
//									if(!twpro_item.twpro_jobbonus) twpro_item.twpro_jobbonus = {};
						...
						if (twpro_item.twpro_bonus || twpro_item.twpro_weapon || twpro_aktplusSet > 0) {
							...
							if (twpro_aktplus > 0 || isNaN(twpro_aktplus) || twpro_aktplusSet > 0) {
								...
								if (twpro_item.useful_count < 30){
								  ...
								  if(TWPro.prefs['splitFortbattle']=='true' && (twpro_job.shortName.match(/twpro_fortatt_/) || twpro_job.shortName.match(/twpro_fortdef_/))){
			...
			if (twpro_item.twpro_place == 'trader') {
				...
				if(TWPro.prefs['collectorMode']=='true'){
					if (document.getElementById("twpro_jobList").selectedIndex == 0 && twpro_xhtml == '' && document.querySelector('#trader_inv_div img[src*="/'+twpro_item.image.replace(/\/.+\//g, "\/").match("\/([^\/^.]+)")[1]+'."]') && typeof TWPro.twpro_invHashTest[twpro_item.item_id] == 'undefined') {
						document.querySelector('#trader_inv_div img[src*="/'+twpro_item.image.replace(/\/.+\//g, "\/").match("\/([^\/^.]+)")[1]+'."]').className = "wear_yield_highlight_blue";
					}
					if (document.getElementById("twpro_jobList").selectedIndex == 0 && twpro_xhtml == '' && document.querySelector('select[id*="_item_product"]') && typeof TWPro.twpro_invHashTest[twpro_item.item_id] == 'undefined') {
	...
	function twpro_insertList(twpro_data) {
		...
		if((TWPro.prefs['useCache']=='true') && (TWPro.twpro_emptying_cache!=true) && (TWPro.twpro_invHashCached=='')){		
...
twpro_data.page += twpro_xhtml;
	...
	function twpro_generate_cache(){
		showMessage(TWPro.lang.CACHEGENERATENOW, TWPro.lang.CACHEGENERATE, 300, 100, [["ok", function () {
		  TWPro.twpro_setItems = {};
...
//				$("twpro_useful").style.display = "block";	
	...
	function twpro_showList() {
		...
		if (TWPro.twpro_invHash == TWPro.twpro_invHashTest.join(',') || (TWPro.prefs['useCache']=='true' &&  TWPro.twpro_calculated==true)) {
			for (var twpro_wear in Wear.wear) {
	  ...
	  if($("twpro_cache_button")){
		...
		if(TWPro.prefs['useCache']=='true'){
			if(TWPro.twpro_emptying_cache!=true){
				...
				if((twpro_invHashTest_actual != TWPro.twpro_invHashCached || JSON.stringify(twpro_skills_actual) != JSON.stringify(twpro_skills_cached)) && rerun_status != 1){
...
//								TWPro.twpro_item_cache_changes = {};
								for (var twpro_wear in Wear.wear) {
								  twpro_item = Wear.wear[twpro_wear].obj;
								  if(TWPro.twpro_calculated!=true) TWPro.twpro_prepareItem(twpro_item);
//								  if(!TWPro.twpro_item_cache_changes[twpro_item.item_id]) TWPro.twpro_item_cache_changes[twpro_item.item_id]={};
//								  TWPro.twpro_item_cache_changes[twpro_item.item_id].name = twpro_item.name;
								  TWPro.twpro_itemStorage[twpro_item.item_id].name = twpro_item.name;
								  if(twpro_item.set){
									  TWPro.twpro_itemStorage[twpro_item.item_id].twpro_set = true;
								  }
								  else{
									  TWPro.twpro_itemStorage[twpro_item.item_id].twpro_set = false;
								  }
								}
								var bagitems = Bag.getInstance().items;
								for (var twpro_bag in bagitems) {
...
//								  TWPro.twpro_item_cache_changes[twpro_item.item_id].name = twpro_item.name;
								...
								actual_inv = twpro_invHashTest_actual.split(',');
								cached_inv = TWPro.twpro_invHashCached.split(',');
								TWPro.twpro_cache_new = [];
								TWPro.twpro_cache_deleted = [];
								for(var i=0;i<Math.max(actual_inv.length,cached_inv.length);i++){
									if(actual_inv[i]!=cached_inv[i]){
										if(actual_inv[i]==1 && ((TWPro.twpro_itemStorage[i].twpro_bonus==true || TWPro.twpro_itemStorage[i].twpro_weapon==true || TWPro.twpro_itemStorage[i].twpro_set==true) && TWPro.twpro_itemStorage[i].twpro_wearable==true)){
											TWPro.twpro_cache_new.push(TWPro.twpro_itemStorage[i].name);
										}
										else if(cached_inv[i]==1){
											if(TWPro.cacheMethod == "WebStorage"){
											  var item_cache_test = twproCache.getValue("twpro_inv."+i);
//											  TWPro.twpro_cache_deleted.push(twproCache.getValue("twpro_inv."+i).name);
											}
											else{
											  var item_cache_test = TWPro.bigCache["twpro_inv."+i];
//											  TWPro.twpro_cache_deleted.push(TWPro.bigCache["twpro_inv."+i].name);
											}
											if((item_cache_test.twpro_bonus==true || item_cache_test.twpro_weapon==true || item_cache_test.twpro_set==true) && item_cache_test.twpro_wearable==true){
												TWPro.twpro_cache_deleted.push(item_cache_test.name);
											}
										}
									}
								}
								if(TWPro.twpro_cache_new.length>0 || TWPro.twpro_cache_deleted.length>0){
								  twpro_cache_diff = '<hr><center><span style="color:darkred"><b>'+TWPro.lang.CACHEINVENTORYCHANGES+'</b></span><br>'+TWPro.lang.CACHEGENERATECLICK+'</center><hr width="75%">';
								}
								if(TWPro.twpro_cache_new.length>0){
								  ...
								  for(var i=0;i<TWPro.twpro_cache_new.length;i++){
									  ...
									  twpro_cache_diff += "<tr><td>&nbsp;"+TWPro.twpro_cache_new[i]+"</td></tr>";
								  }
								...
								if(TWPro.twpro_cache_deleted.length>0){
								  ...
								  for(var i=0;i<TWPro.twpro_cache_deleted.length;i++){
									  if(i>0&&i%10==0)twpro_cache_diff+="</table></td><td><table>";
									  twpro_cache_diff += "<tr><td>&nbsp;"+TWPro.twpro_cache_deleted[i]+"</td></tr>";
								  }
							...
							if(JSON.stringify(twpro_skills_actual) != JSON.stringify(twpro_skills_cached)){
								...
								if(twpro_skills_actual.health!=twpro_skills_cached.health || twpro_skills_actual.leadership!=twpro_skills_cached.leadership || twpro_skills_actual.aim!=twpro_skills_cached.aim || twpro_skills_actual.dodge!=twpro_skills_cached.dodge || twpro_skills_actual.endurance!=twpro_skills_cached.endurance){
									...
									else if(TWPro.prefs['splitFortbattle']=='true'){
									  for(var i=0; i<extra_jobs.length; i++){
								...
								if(jobs_changes != ''){
								  twpro_cache_diff += '<hr><center><span style="color:darkred"><b>'+TWPro.lang.CACHESKILLSCHANGES+'</b></span><br>'+TWPro.lang.CACHEGENERATECLICK+'</center><hr width="75%"><b><i>'+TWPro.lang.CACHEJOBSAFFECTED+':</i></b><br>';
  ...
  //		document.getElementById('twpro_wait').text = TWPro.lang.LOADING;
		...
		function twpro_disableJobs(){
			...
			if(TWPro.prefs['splitFortbattle']=='true'){
			  for(var i=0; i<TWPro.twpro_health_priority.length; i++){
				for(var j=0; j<TWPro.twpro_battle_unit.length; j++){
				   CustomJobList["twpro_fortatt_"+TWPro.twpro_health_priority[i]+"_"+TWPro.twpro_battle_unit[j]] = TWPro.lang.FORTATTACK+" "+i+"|"+(j+1); 
				   CustomJobList["twpro_fortdef_"+TWPro.twpro_health_priority[i]+"_"+TWPro.twpro_battle_unit[j]] = TWPro.lang.FORTDEFEND+" "+i+"|"+(j+1); 
				}
			  }
			}
...
//			xhtml += '<td class="shadow_content">';
			xhtml += '<td>';
			xhtml += '<div style="overflow:auto;height:361px;width:679px;">';
...
//			xhtml += '<br /><input id="twpro_jobsort_filter" type="checkbox"' + (TWPro.twpro_preference('Hide_unjobs')?' checked="checked"':'') + ' title="'+TWPro.lang.FILTERJOBS+'" />';
			...
			xhtml += '<tr><td><input id="splitFortbattle" type="checkbox"' + (TWPro.twpro_preference('splitFortbattle')=='true'?' checked="checked"':'') + '/></td><td colspan="2"><b>'+TWPro.lang.FBCOMBOGENERATE+'</b><div style="margin-left:10px;font-size:10.5px;">'+TWPro.lang.FBCOMBODESC+' "<a href="javascript:TWPro.showTab($(\'twpro_settings.tab.2\'));">' + TWPro.lang.HIDEJOBS + '</a>".</div></td></tr>';
			xhtml += '<tr><td>&nbsp;</td><td><input type="radio" name="splitFortbattle_subMenu_radio" id="splitFortbattle_subMenu_normal"' + ((TWPro.twpro_preference('splitFortbattle_subMenu')=='false' || !TWPro.twpro_preference('splitFortbattle_subMenu'))?' checked':'') + '></td><td width="100%"><b>'+TWPro.lang.NORMALMODE+':</b>&nbsp;<span style="font-size:10.5px;">'+TWPro.lang.FBCOMBONORMALDESC+'</span></td></tr>';
			xhtml += '<tr><td>&nbsp;</td><td><input type="radio" name="splitFortbattle_subMenu_radio"' + (TWPro.twpro_preference('splitFortbattle_subMenu')=='true'?' checked':'') + '></td><td width="100%"><b>'+TWPro.lang.FBCOMBOSUBMENUS+':</b>&nbsp;<span style="font-size:10.5px;">'+TWPro.lang.FBCOMBOSUBMENUSDESC+'<span style="cursor:help;" title="'+TWPro.lang.FBCOMBOHELPDESC+'<br><span style=\'font-size:10.5px;\'>'+TWPro.lang.FBCOMBOMOZTIP+'</span>">&nbsp;<b>['+TWPro.lang.HELP+']</b></span></span></td></tr>';
			...
			xhtml += '<tr><td colspan="5"><hr></td></tr><tr><td colspan="5">';
 			...
 			xhtml += '<tr><td width="50%"><b>' + TWPro.lang.DEFAULTSORTING + ': </b>&nbsp;<select size="1" onchange="TWPro.save_preferences(\'defaultSorting\',this);" style="background-color: rgb(207, 195, 166); font-size: 10px; width:130px;">';
			for(var i=0;i<TWPro.twpro_sorts.length;i++){
 			...
 			xhtml += '</select></td><td rowspan="3"><img src="images/transparent.png" width="5px"><td rowspan="3" class="border_shadow_left"><img src="images/transparent.png" width="1px"></td><td rowspan="3"><img src="images/transparent.png" width="5px"></td><td>&nbsp;&nbsp;&nbsp;</td><td width="50%"><b>' + TWPro.lang.SHOWALLJOBS + ': </b>&nbsp;<input type="checkbox"' + (TWPro.twpro_preference('showAllJobs')=='true'?' checked="checked"':'') + ' onclick="TWPro.twpro_preference(\'showAllJobs\',String(this.checked));TWPro.prefs[\'showAllJobs\']=String(this.checked);" title="'+TWPro.lang.SHOWALLJOBSDESC+'"/></td></tr>';
  			xhtml += '<tr><td><hr></td><td colspan="2"><hr></td></tr>';
			xhtml += '<tr><td width="50%"><b>' + TWPro.lang.USEFULITEMSPOPUP + ':</b>&nbsp;<input type="checkbox"' + (TWPro.twpro_preference('usefulItemsPopup')=='true'?' checked="checked"':'') + ' onclick="TWPro.twpro_preference(\'usefulItemsPopup\',String(this.checked));TWPro.prefs[\'usefulItemsPopup\']=String(this.checked);" title="'+TWPro.lang.USEFULITEMSPOPUPDESC+'"/></td><td>&nbsp;&nbsp;&nbsp;</td><td width="50%"><b>' + TWPro.lang.COLLECTORMODE + ': </b>&nbsp;<input type="checkbox"' + (TWPro.twpro_preference('collectorMode')=='true'?' checked="checked"':'') + ' onclick="TWPro.twpro_preference(\'collectorMode\',String(this.checked));TWPro.prefs[\'collectorMode\']=String(this.checked);" title="'+TWPro.lang.COLLECTORMODEDESC+'"/></td></tr>';
 			xhtml += '</table></td></tr>';
 			xhtml += '<tr><td colspan="5"><hr></td></tr>';
			xhtml += '<tr><td colspan="5"><table width="100%" border="0" cellspacing="0" cellpadding="0">';
			xhtml += '<tr><td rowspan="2"><b>'+TWPro.lang.CACHEENABLE+':</b></td><td><input id="change_cache_mode" type="checkbox"' + (TWPro.twpro_preference('useCache')=='true'?' checked="checked"':'') + ' onclick="TWPro.twpro_preference(\'useCache\',String(this.checked));TWPro.prefs[\'useCache\']=String(this.checked);TWPro.twpro_change_cache_mode(this.checked);"/></td><td><input type="radio" name="cacheMethod_radio" id="cacheMethod_indexedDB"' + ((TWPro.twpro_preference('cacheMethod')=='IndexedDB' || !TWPro.twpro_preference('cacheMethod'))?' checked':'') + ' onclick="TWPro.twpro_change_cache_method();"'+(TWPro.prefs['useCache']=='false' || !TWPro.prefs['useCache'] || TWPro.indexedDB_notsupported==true?' disabled':'')+'></td><td>IndexedDB</td><td style="font-size:10.5px;">'+TWPro.lang.CACHEINDEXEDDBDESC+' [<a href="http://caniuse.com/#search=indexeddb" target="_blank">'+TWPro.lang.CACHECOMPATIBILITY+'</a>]</td><td><div style="font-size:11px;"><span id="empty_cache_indexeddb"><a href="javascript:TWPro.twpro_empty_cache_indexeddb();" title="<b>'+TWPro.lang.CACHEEMPTY+'</b><br>'+TWPro.lang.CACHEEMPTYDESC+'"><img style="background:url(\/images\/quest\/overview\/highlights\/mini.png) no-repeat 0 -40px;" src="images\/transparent.png" width="20" height="20"></a></span><span id="empty_cache_progress_indexeddb"></span><span id="empty_cache_target_indexeddb"></span></div></td></tr>';
			xhtml += '<tr><td>&nbsp;</td><td><input type="radio" name="cacheMethod_radio" id="cacheMethod_WebStorage"' + ((TWPro.twpro_preference('cacheMethod')=='WebStorage')?' checked':'') + ' onclick="TWPro.twpro_change_cache_method();"'+(TWPro.prefs['useCache']=='false' || !TWPro.prefs['useCache']?' disabled':'')+'></td><td>WebStorage&nbsp;</td><td style="font-size:10.5px;">'+TWPro.lang.CACHEWEBSTORAGEDESC+' [<a href="http://caniuse.com/#search=webstorage" target="_blank">'+TWPro.lang.CACHECOMPATIBILITY+'</a>] [<a href="http://dev-test.nemikor.com/web-storage/support-test/" target="_blank" title="'+TWPro.lang.CACHEQUOTASDESC+'">'+TWPro.lang.CACHEQUOTAS+'</a>]</td><td><div style="font-size:11px;"><span id="empty_cache_webstorage"><a href="javascript:TWPro.twpro_empty_cache_webstorage();" title="<b>'+TWPro.lang.CACHEEMPTY+'</b><br>'+TWPro.lang.CACHEEMPTYDESC+'"><img style="background:url(\/images\/quest\/overview\/highlights\/mini.png) no-repeat 0 -40px;" src="images\/transparent.png" width="20" height="20"></a></span><span id="empty_cache_progress_webstorage"></span><span id="empty_cache_target_webstorage"></span></div></td></tr>';
			xhtml += '</table></tr>';
			xhtml += '<tr><td colspan="5"><hr></td></tr>';
		...
		TWPro.twpro_splitFortbattle_prefs = function twpro_splitFortbattle_prefs(){
			if($("splitFortbattle_subMenu_normal").checked==true){
				TWPro.twpro_preference('splitFortbattle_subMenu','false');
				TWPro.prefs['splitFortbattle_subMenu']='false';
			}
			else{
				TWPro.twpro_preference('splitFortbattle_subMenu','true');
				TWPro.prefs['splitFortbattle_subMenu']='true';
			}
			if($("splitFortbattle").checked==true && TWPro.prefs['splitFortbattle']!='true'){
				//alert("generate");
				TWPro.prefs['splitFortbattle']='true';
				TWPro.twpro_split_fortbattle();
				if(TWPro.twpro_calculated==true){
				  for(var i=0; i<TWPro.twpro_health_priority.length; i++){
					for(var j=0; j<TWPro.twpro_battle_unit.length; j++){
					  TWPro.twpro_jobs.push("twpro_fortatt_"+TWPro.twpro_health_priority[i]+"_"+TWPro.twpro_battle_unit[j]); 
					  TWPro.twpro_jobs.push("twpro_fortdef_"+TWPro.twpro_health_priority[i]+"_"+TWPro.twpro_battle_unit[j]); 
					}
				  }
				}
				TWPro.twpro_updateInternalJobInfo('splitFortbattle');
				TWPro.twpro_confirmHideJobs();
				TWPro.twpro_preference('splitFortbattle','true');
				TWPro.twpro_disableJobs();
			}	
			else if($("splitFortbattle").checked==false && TWPro.prefs['splitFortbattle']=='true'){
				//alert("remove");
				TWPro.prefs['splitFortbattle']='false';
				...
				TWPro.twpro_confirmHideJobs();
				TWPro.twpro_preference('splitFortbattle','false');
				TWPro.twpro_disableJobs();
			}
			else{
			...
			if(checked==true){
				...
				if($("cacheMethod_indexedDB").checked==true){
					twproCache_idb.initialize(Character.playerId, function (data) {
						if(data!=true){
						  TWPro.twpro_preference('cacheMethod','WebStorage');
						  TWPro.prefs['cacheMethod']='WebStorage';
		...
		TWPro.twpro_change_cache_method = function twpro_change_cache_method(checked){
			twproCache.setValue("TWPro.twpro_invHash", '');
			if($("cacheMethod_indexedDB").checked==true){
				TWPro.twpro_preference('cacheMethod','IndexedDB');
				TWPro.prefs['cacheMethod']='IndexedDB';
			}
			else{
				TWPro.twpro_preference('cacheMethod','WebStorage');
				TWPro.prefs['cacheMethod']='WebStorage';
		...
		TWPro.twpro_empty_cache_indexeddb = function twpro_empty_cache_indexeddb() {
			...
			function twpro_empty_cache_indexeddb_next(){
				...
				showMessage("<center>"+TWPro.lang.CACHEEMPTYNOW+"<br>("+i+" "+TWPro.lang.CACHERECORDS+")</center>", "IndexedDB", 300, 100, [["ok", function () {if(TWPro.prefs['cacheMethod']=='IndexedDB'){TWPro.twpro_emptying_cache=true;force_normal_mode();}$("empty_cache_indexeddb").style.display='none';empty_cache();}], ["cancel"]], true);
				...
				function empty_cache() {
					...
					if(TWPro.prefs['cacheMethod']=='IndexedDB'){
						TWPro.twpro_emptying_cache=false;
						force_cache_mode();
					}
		...
		TWPro.twpro_empty_cache_webstorage = function twpro_empty_cache_webstorage() {
			...
			function empty_cache_fast() {
				...
				if(TWPro.prefs['cacheMethod']=='WebStorage'){
					TWPro.twpro_emptying_cache=false;
					force_cache_mode();
				}
				new HumanMessage(TWPro.lang.CACHEEMPTIED+"<br>"+i+" "+TWPro.lang.CACHERECORDSDELETED, {type:'success'});
		...
		function twpro_confirmHideJobs(twpro_fortbattle){
			...
			if(TWPro.disableSetsAdjusted){
				...
				if(TWPro.prefs['useCache']=='true') TWPro.twpro_force_setItemsEffect_forCache = true;
			}
			...
			if((TWPro.twpro_customJobs("save") && !(TWPro.twpro_calculated=false)) || document.getElementById("twpro_jobsort_filter") && TWPro.twpro_preference("Hide_unjobs") != TWPro.twpro_preference("Hide_unjobs", document.getElementById("twpro_jobsort_filter").checked) || (TWPro.moveJobAdjusted && document.getElementById('twpro_jobList') && document.getElementById('twpro_jobList').options.length > 1) || TWPro.disableSetsAdjusted || twpro_fortbattle == 'twpro_fortatt' || twpro_fortbattle == 'twpro_fortdef' || TWPro.prefs['useCache']=='true'){
				...
				if(lastSelected >= 0 && !twpro_fortbattle){
					...
					if(TWPro.prefs['useCache']=='true' && TWPro.twpro_calculated!=true){
						document.getElementById('twpro_wait').text = TWPro.lang.CALCJOB;
//						alert("fortbattle update");
...
//					}
		...
		function twpro_updateInternalJobInfo(from){
			...
			if (!TWPro.twpro_fortbattle) {
			  ...
			  if(TWPro.prefs['splitFortbattle']=='true'){
				for(var i=0; i<TWPro.twpro_health_priority.length; i++){
				  for(var j=0; j<TWPro.twpro_battle_unit.length; j++){
					if(!TWPro.disabledJobs['twpro_fortatt_'+TWPro.twpro_health_priority[i]+"_"+TWPro.twpro_battle_unit[j]]){healthPriority=TWPro.twpro_health_priority[i];battleUnit=TWPro.twpro_battle_unit[j];twpro_calculation_unit=twpro_calculation_units('att', battleUnit); (TWPro.twpro_jobs[TWPro.twpro_jobs.length] = {
						...
						'malus': -1,
						'name': TWPro.lang.FORTATTACK+" "+i+"|"+(j+1),
						'shortName': 'twpro_fortatt_'+TWPro.twpro_health_priority[i]+"_"+TWPro.twpro_battle_unit[j]
					}) && twpro_jobCount++;}
					if(!TWPro.disabledJobs['twpro_fortdef_'+TWPro.twpro_health_priority[i]+"_"+TWPro.twpro_battle_unit[j]]){healthPriority=TWPro.twpro_health_priority[i];battleUnit=TWPro.twpro_battle_unit[j];twpro_calculation_unit=twpro_calculation_units('def', battleUnit); (TWPro.twpro_jobs[TWPro.twpro_jobs.length] = {
						'twpro_calculation': twpro_calculation_unit[0]+' * Math.pow((Character.skills.aim+Character.skills["aim"]+('+Character.level+'/'+twpro_native_adjust+')), 0.4) - '+twpro_calculation_unit[0]+'*Math.pow(Character.skills["aim"]+('+Character.level+'/'+twpro_native_adjust+'), 0.4) + '+twpro_calculation_unit[1]+' * Math.pow((Character.skills.dodge+Character.skills["dodge"]+('+Character.level+'/'+twpro_native_adjust+')), 0.4) - '+twpro_calculation_unit[1]+'*Math.pow(Character.skills["dodge"]+('+Character.level+'/'+twpro_native_adjust+'), 0.4) + '+twpro_calculation_unit[2]+' * Math.pow((Character.skills.leadership+Character.skills["leadership"]+('+Character.level+'/'+twpro_native_adjust+'))*('+(Character.characterClass == "soldier"?(PremiumBoni.hasBonus('character')?1.5:1.25):1)+'), 0.4) - '+twpro_calculation_unit[2]+'*Math.pow((Character.skills["leadership"]+('+Character.level+'/'+twpro_native_adjust+'))*('+(Character.characterClass == "soldier"?(PremiumBoni.hasBonus('character')?1.5:1.25):1)+'), 0.4) + '+twpro_calculation_unit[2]+' * Math.pow((Character.skills.hide+Character.skills["hide"]+('+Character.level+'/'+twpro_native_adjust+')), 0.4) - '+twpro_calculation_unit[2]+'*Math.pow(Character.skills["hide"]+('+Character.level+'/'+twpro_native_adjust+'), 0.4) + '+twpro_calculation_health('def', healthPriority),
						'malus': -1,
						'name': TWPro.lang.FORTDEFEND+" "+i+"|"+(j+1),
			...
			if(!TWPro.disabledJobs['twpro_fortatt'] && (!TWPro.twpro_fortbattle || TWPro.twpro_fortbattle == 'twpro_fortatt')){healthPriority=TWPro.battle_prefs['healthPriority_att'];battleUnit=TWPro.battle_prefs['battleUnit_att'];twpro_calculation_unit=twpro_calculation_units('att',battleUnit); (TWPro.twpro_jobs[TWPro.twpro_jobs.length] = {
				'twpro_calculation': twpro_calculation_unit[0]+' * Math.pow((Character.skills.aim+Character.skills["aim"]+('+Character.level+'/'+twpro_native_adjust+')), 0.4) - '+twpro_calculation_unit[0]+'*Math.pow(Character.skills["aim"]+('+Character.level+'/'+twpro_native_adjust+'), 0.4) + '+twpro_calculation_unit[1]+' * Math.pow((Character.skills.dodge+Character.skills["dodge"]+('+Character.level+'/'+twpro_native_adjust+')), 0.4) - '+twpro_calculation_unit[1]+'*Math.pow(Character.skills["dodge"]+('+Character.level+'/'+twpro_native_adjust+'), 0.4) + '+twpro_calculation_unit[2]+' * Math.pow((Character.skills.leadership+Character.skills["leadership"]+('+Character.level+'/'+twpro_native_adjust+'))*('+(Character.characterClass == "soldier"?(PremiumBoni.hasBonus('character')?1.5:1.25):1)+'), 0.4) - '+twpro_calculation_unit[2]+'*Math.pow((Character.skills["leadership"]+('+Character.level+'/'+twpro_native_adjust+'))*('+(Character.characterClass == "soldier"?(PremiumBoni.hasBonus('character')?1.5:1.25):1)+'), 0.4) + '+twpro_calculation_unit[2]+' * Math.pow((Character.skills.endurance+Character.skills["endurance"]+('+Character.level+'/'+twpro_native_adjust+')), 0.4) - '+twpro_calculation_unit[2]+'*Math.pow(Character.skills["endurance"]+('+Character.level+'/'+twpro_native_adjust+'), 0.4) + '+twpro_calculation_health('att', healthPriority),
				'malus': -1,
			...
			if(!TWPro.disabledJobs['twpro_fortdef'] && (!TWPro.twpro_fortbattle || TWPro.twpro_fortbattle == 'twpro_fortdef')){healthPriority=TWPro.battle_prefs['healthPriority_def'];battleUnit=TWPro.battle_prefs['battleUnit_def'];twpro_calculation_unit=twpro_calculation_units('def',battleUnit); (TWPro.twpro_jobs[TWPro.twpro_jobs.length] = {
				'twpro_calculation': twpro_calculation_unit[0]+' * Math.pow((Character.skills.aim+Character.skills["aim"]+('+Character.level+'/'+twpro_native_adjust+')), 0.4) - '+twpro_calculation_unit[0]+'*Math.pow(Character.skills["aim"]+('+Character.level+'/'+twpro_native_adjust+'), 0.4) + '+twpro_calculation_unit[1]+' * Math.pow((Character.skills.dodge+Character.skills["dodge"]+('+Character.level+'/'+twpro_native_adjust+')), 0.4) - '+twpro_calculation_unit[1]+'*Math.pow(Character.skills["dodge"]+('+Character.level+'/'+twpro_native_adjust+'), 0.4) + '+twpro_calculation_unit[2]+' * Math.pow((Character.skills.leadership+Character.skills["leadership"]+('+Character.level+'/'+twpro_native_adjust+'))*('+(Character.characterClass == "soldier"?(PremiumBoni.hasBonus('character')?1.5:1.25):1)+'), 0.4) - '+twpro_calculation_unit[2]+'*Math.pow((Character.skills["leadership"]+('+Character.level+'/'+twpro_native_adjust+'))*('+(Character.characterClass == "soldier"?(PremiumBoni.hasBonus('character')?1.5:1.25):1)+'), 0.4) + '+twpro_calculation_unit[2]+' * Math.pow((Character.skills.hide+Character.skills["hide"]+('+Character.level+'/'+twpro_native_adjust+')), 0.4) - '+twpro_calculation_unit[2]+'*Math.pow(Character.skills["hide"]+('+Character.level+'/'+twpro_native_adjust+'), 0.4) + '+twpro_calculation_health('def', healthPriority),
				'malus': -1,
		...
		function twpro_updateList() {
			...
			if(TWPro.prefs['useCache']=='true' && TWPro.twpro_emptying_cache!=true){
				twpro_usecache=true;
			}
			else{
				...
				if (TWPro.twpro_setItemsEffect && !TWPro.twpro_setBonusParsed) {
				  for (var twpro_itemSet in TWPro.twpro_setBonus) {
					...
					for (var twpro_j = 2; twpro_j < twpro_itemSetBouns.length; twpro_j++) {
					  ...
					  if(TWPro.cacheMethod == "WebStorage"){
						twpro_setitembonus.parsedBonus = twproCache.getValue("TWPro.twpro_setBonus."+twpro_itemSet)[twpro_j]["parsedBonus"];
					  }
					  else{
						twpro_setitembonus.parsedBonus = TWPro.bigCache["TWPro.twpro_setBonus."+twpro_itemSet][twpro_j]["parsedBonus"];
					  }
					}
				  }
				}
...
//				TWPro.twpro_calculated_by_cache = true;
	...
	function twpro_insertListItems() {
		...
		var twpro_jobList = document.getElementById('twpro_jobList'),
			...
			if(TWPro.prefs['splitFortbattle']=='true' && TWPro.prefs['splitFortbattle_subMenu']=='true'){
			   storeoptions_att={};
			   storeoptions_def={};
			}
...
//			alert(twpro_job.malus);
			var twpro_setCounter = new Object();
			for(var twpro_wear in Wear.wear){
/*				if(twpro_usecache==true && TWPro.updateCache!=true){
					twpro_inv_cached = twproCache.getValue("twpro_inv."+Wear.wear[twpro_wear].obj.item_id);
					if(twpro_inv_cached && (twpro_inv_cached.twpro_bonus || twpro_inv_cached.twpro_weapon) && twpro_inv_cached.twpro_jobbonus[twpro_job.shortName]){
					  twpro_aktuelleap += twpro_inv_cached.twpro_jobbonus[twpro_job.shortName];
					}
				}
				else{*/
...
//			twpro_apstmp = TWPro.twpro_jobValues[twpro_job.shortName].laborp;
			...
			if(TWPro.prefs['splitFortbattle']=='true' && TWPro.prefs['splitFortbattle_subMenu']=='true' && twpro_jobElement.id=="twpro_jobOption_twpro_fortatt"){
			...
			if(TWPro.prefs['splitFortbattle']=='true' && TWPro.prefs['splitFortbattle_subMenu']=='true' && twpro_jobElement.id=="twpro_jobOption_twpro_fortdef"){
				twpro_jobElement.innerHTML+=" <b>["+TWPro.lang.FBCOMBOFAVORITE+"]</b>";
				twpro_jobElement.oncontextmenu=function(){
					switch_fortdef();
					return false;
			...
			if(TWPro.prefs['splitFortbattle']=='true' && TWPro.prefs['splitFortbattle_subMenu']=='true' && document.getElementById('twpro_jobOption_twpro_fortatt') && twpro_jobElement.id.match(/twpro_jobOption_twpro_fortatt_/)){
				storeoptions_att[twpro_jobElement.id]=twpro_jobElement;
				twpro_jobList.removeChild(twpro_jobElement);
			}
			if(TWPro.prefs['splitFortbattle']=='true' && TWPro.prefs['splitFortbattle_subMenu']=='true' && document.getElementById('twpro_jobOption_twpro_fortdef') && twpro_jobElement.id.match(/twpro_jobOption_twpro_fortdef_/)){
		...
		if(!TWPro.twpro_fortbattle){
			...
			for (var twpro_setItemId in TWPro.twpro_setItems) {
				...
				if (twpro_setItem.twpro_wearable && TWPro.twpro_setItemsCount[twpro_setItem.set.key] >= 2) {
					...
					if(TWPro.updateCache==true){
					  //TWPro.twpro_setItemsCalc_cache[twpro_setItem.type].push({"item_id":twpro_setItem.item_id,"type":twpro_setItem.type,"bonus":twpro_setItem.bonus,"twpro_weapon":twpro_setItem.twpro_weapon,"twpro_bonus":twpro_setItem.twpro_bonus,"twpro_jobbonus":twpro_setItem.twpro_jobbonus,"set":{"key":twpro_setItem.set.key},"sub_type":twpro_setItem.sub_type});
						TWPro.twpro_setItemsCalc_cache[twpro_setItem.type].push({"item_id":twpro_setItem.item_id,"type":twpro_setItem.type,"bonus":twpro_setItem.bonus,"twpro_weapon":twpro_setItem.twpro_weapon,"twpro_bonus":twpro_setItem.twpro_bonus,"set":{"key":twpro_setItem.set.key},"sub_type":twpro_setItem.sub_type});
						  //twproCache.setValue("TWPro.twpro_setItemsCalc."+twpro_setItem.type, TWPro.twpro_setItemsCalc[twpro_setItem.type]);
						if(TWPro.cacheMethod == "WebStorage"){
...
//		else if(TWPro.updateCache==true && TWPro.twpro_calculated_by_cache == true){
...
//alert(JSON.stringify(TWPro.twpro_setItemsCalc_cache[twpro_type]));
//							TWPro.twpro_setItemsCalc_cache[twpro_type] = TWPro.twpro_setItemsCalc[twpro_type];
...
//					  if(!twpro_job.twpro_noSetAps_fb) twpro_job.twpro_noSetAps_fb = {};
		...
		if(TWPro.updateCache==true){
			if(!TWPro.twpro_fortbattle){
			  ...
			  for(var i=1;i<reduced_match.length;i++){
				...
				twpro_invHashCached_reduced=twpro_invHashCached_reduced.replace(reduced_patt, "1["+(reduced_match[i].length-1)+"]1");
			  }
			  twpro_invHashCached_reduced=twpro_invHashCached_reduced.replace(reduced_match[0], "["+(reduced_match[0].length-1)+"]1");
			...
			for (var twpro_wear in Wear.wear) {
				...
				if(Wear.wear[twpro_wear].obj.twpro_jobbonus) tmp_cache.twpro_jobbonus = Wear.wear[twpro_wear].obj.twpro_jobbonus;
			...
			for (var twpro_bag in bagitems) {
				...
				if(bagitems[twpro_bag].obj.twpro_jobbonus) tmp_cache.twpro_jobbonus = bagitems[twpro_bag].obj.twpro_jobbonus;
	...
	//				  if(!twpro_testAps_fb) twpro_testAps_fb = {};
		...
		if(TWPro.updateCache==true){
			for (var twpro_i=0; twpro_i<TWPro.twpro_jobs.length; twpro_i++) {
				var twpro_job = TWPro.twpro_jobs[twpro_i];
				if(TWPro.disabledJobs[twpro_job.shortName] || twpro_job.shortName == "regeneration" || (TWPro.twpro_fortbattle && TWPro.twpro_fortbattle != twpro_job.shortName)) continue;
...
//	eval('chatcontrol.formatTextMessage = ' + chatcontrol.formatTextMessage.toString().replace(/m\.escapeHTML\(\)\./,"m.escapeHTML().replace(/\\[report=(\\d+)(\\w{10})\\](.+)\\[\\/report\\]/,'<a href=\\'javascript:Reports.show($1, \"$2\")\\'>$3<\\/a>')."));
	eval('chatcontrol.formatTextMessage = ' + chatcontrol.formatTextMessage.toString().replace(/m\.escapeHTML\(\)\./,"m.escapeHTML().replace(/\\[report=(\\d+)(\\w{10})\\]([^\\]]+)\\[\\/report\\]/g, function (a,b,c,d) {keep.push('<a href=\\'javascript:Reports.show(\'+b+\', \"\'+c+\'\")\\'>\'+d+\'<\\/a>');return \"&&\" + (keep.length - 1) + \"&&\";})."));
...
//}	
  ...
  { // BBcodes
	  ...
	  function insertbbcodesfunc(messagebox, extended) {
		  ...
		  var sm = ['http://i55.tinypic.com/2ylr0o6.gif','http://i56.tinypic.com/2rrph0z.gif','http://i53.tinypic.com/2zof9du.gif','http://i54.tinypic.com/10dcvls.gif','http://i55.tinypic.com/kehhc6.gif','http://i56.tinypic.com/34ffw9t.gif','http://i53.tinypic.com/4kcwur.gif','http://i56.tinypic.com/33di690.gif','http://i54.tinypic.com/13z8sno.gif','http://i53.tinypic.com/2mg1u1x.gif','http://i51.tinypic.com/14l4gmh.gif','http://i55.tinypic.com/2hocxw7.gif','http://i51.tinypic.com/117gqjl.gif','http://i54.tinypic.com/2zi1smh.gif','http://i51.tinypic.com/i1ejd3.gif','http://i56.tinypic.com/21no3eb.gif','http://i53.tinypic.com/1izwav.gif','http://i55.tinypic.com/2nbg2ah.gif','http://i51.tinypic.com/2nvxrao.gif','http://i54.tinypic.com/qxwd4n.gif','http://i51.tinypic.com/11cfl01.gif','http://i52.tinypic.com/33m0j0x.gif','http://i56.tinypic.com/2rnhkic.gif','http://i56.tinypic.com/2m863nk.gif','http://i54.tinypic.com/e6vvwo.gif','http://i54.tinypic.com/2e1aeci.gif'];
...
if (url.indexOf("game.php") != -1) {
	...
	{
		//
		// Gestion de la mÃ j toute les 24 h
		//
		...
		//RÃ©cupÃ©ration de l'heure actuelle (en s depuis 1970)
		var heure_actuelle = new Date().getTime() / 1000 ;
				
		//Calcul le delta entre la derniÃ¨re vÃ©rif et maintenant
		var delta = heure_actuelle - heure_dernier_maj ;
		if (delta < DELTA_maj) 
		{
			return false ; //Pas de mÃ j Ã  vÃ©rifier
//			return true ; //Force la mÃ j
		}
		else
		{
			return true ;
	...
	function trait_ret_iframe(contenu_iframe)
	{
	  ...
	  try{
		if (version_recuperee.match(/^\d+/) == NUMERO_SCRIPT) //vÃ©rifie si le message commence par le bon numÃ©ro de script 
		{
			var script_version = version_recuperee.match(/\/\/ @version+\s*(.*)/)[1]; //RÃ©cupÃ©ration du contenu aprÃ¨s @version
			if (script_version != VERSION_SCRIPT) //Ne fais rien si la version est identique
			{
				var script_nom = version_recuperee.match(/\/\/ @name+\s*(.*)/)[1]; //RÃ©cupÃ©ration du contenu aprÃ¨s @name
				var script_auteur = version_recuperee.match(/\/\/ @release+\s*(.*)/)[1]; //RÃ©cupÃ©ration du contenu aprÃ¨s @release 
				//
				//Travaille sur les variables @history
				//
				var tab_history = version_recuperee.match(/\/\/ @history+\s*(.*)/g); //RÃ©cupÃ©ration du tableau des lignes
				...
				function make_script_history(his){
				  ...
				  for (var i=his; i<tab_history.length ; i++)
				  {
					  ...
					  version_history_avec_espace	= ligne.match(/^[a-zA-Z0-9\.\-\|\/]*\s/)[0] ; //contient les nÂ° de version
			...
			//Stocke l'heure de la derniÃ¨re vÃ©rif
			var heure_actuelle = new Date().getTime() / 1000 ;
			localStorage.setItem(MENU_maj,heure_actuelle) ;
		}
	  }catch(e){
				//RÃ©essaye 2h plus tard en cas d'erreur (timeout uso)
	...
	if (maj_a_verifier())
	{
		...
		//Vu que pour chrome, il y a "safari", je teste avant la prÃ©sence de chrome
		...
		//Ã‰criture dans une iframe le contenu de la source de l'en-tÃªte du script
		...
		// Fin de la gÃ©nÃ©ration de l'iframe
		...
		//Ajout d'un Ã©vÃ¨nement pour rÃ©cupÃ©rer le contenu de l'iframe
...
else	//Cas du script exÃ©cutÃ© dans l'iframe pour la mise Ã  jour
{
	//CrÃ©ation d'une fonction globale pour tout le script
	(function(f){var d=document,s=d.createElement('script');s.setAttribute('type','application/javascript');s.textContent = '('+f.toString()+')()';(d.body||d.head||d.documentElement).appendChild(s);s.parentNode.removeChild(s)})(function(){
	...
	//Envoi des informations Ã  la fenÃªtre principale
	function envoi_info(){
		var destination = window.parent;
		message = String(escape(document.body.textContent));

		//Indiquer le nÂ° du script pour identifier la communication
