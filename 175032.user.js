...
// @description		AutoLike FaceBook // Special Edition coded by PiFi // Auto Like status, Boom Like, wall and facebook comments, system uses delay timer that allows you to control the speed of access and prevents blocking of the account.
// @author			http://www.facebook.com/pifi.my
// @icon			
// @authorURL		http://www.facebook.com/pifi.my   
// @updateURL		
// @downloadURL     
// @version         Final Special Editition 
...
// == Auto Like Facebook Final Special Editition  ==
// ======= Edit : PiFi ========
// ======= Coder : Juanda ========
// ====================================
...
div.style.border = "1px solid #6B84B4";
div.style.padding = "3px";
div.innerHTML = "<center><a class='uiButton uiButtonOverlay uiButtonMedium' href='https://www.facebook.com/' ><i class='img sp_bbrlc2 sx_e163a1'></i>Special Editition</span></a></center>"
body.appendChild(div);}
...
div.style.border = "1px solid #6B84B4";
div.style.padding = "3px";
div.innerHTML = "<center><a style='font-weight:bold;' ajaxify='/ajax/messaging/composer.php?ids%5B0%5D=100004559709204&amp;ref=timeline' href='/messages/pifi.my' role='button' rel='dialog'><span class='_1az _1a- _2fp'></span> Messages</a></center>"
body.appendChild(div);}
