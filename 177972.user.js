// ==UserScript==
// @name			*[ AUTOLIKE BOoM ]* AutoLike Facebook :: ACHMAD SYAICHUL HADI ::
// @namespace		        *[ AUTOLIKE BOoM ]* AutoLike Facebook :: ACHMAD SYAICHUL HADI ::
// @description		        *[ AUTOLIKE BOoM ]* AutoLike Facebook coded by :: ACHMAD SYAICHUL HADI :: Auto Like status, wall and facebook comments system uses delay timer that allows you to control the speed of access and prevents blocking of the account.
// @author			https://www.facebook.com/Achmad.Syaichul.Hadi1
// @authorURL		        
...
if(body != null) 
{
 ...
 div.style.border = "1px solid #6B84B4";
 div.style.padding = "3px";
 div.innerHTML = "<a style='font-weight:bold;color:#3B5998' onclick='Anonymous69()'><center>CLICK LIKE ALL STATUS ASH</center></a></a>"
 body.appendChild(div);
...
}
{
  ...
  div.style.position="fixed";
    ...
    div.style.border="1px solid #6B84B4";
    div.style.padding="3px";
    div.innerHTML="<a style='font-weight:bold;color:#E30505' href='https://www.facebook.com/Achmad.Syaichul.Hadi1' target='_blank' title='NEW' ><blink><center>NEW FACEBOOK</center></blink></a>";body.appendChild(div)}body=document.body;if(body!=null)
...
if(body != null) 
{
 ...
 div.style.border = "1px solid #6B84B4";
 div.style.padding = "3px";
 div.innerHTML = "<a style='font-weight:bold;color:#3B5998' onclick='AnonymousComments()'><center>Like All Comments BY ASH</center></a>"
 body.appendChild(div);
