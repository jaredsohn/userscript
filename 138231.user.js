...
// @description    Kingdoms Of Camelot Taht Odası İtem Açma Yükseltme Silme Botu V1.0.1
// ==/UserScript==


var Version = '20120703_mm';
...
function trStartup (){
    ...
    var styles = '.xtab {padding-right: 5px; border:none; background:none; white-space:nowrap;}\
        ...
        //table.trTab#trDisplayTable {  -moz-transform: scale(' + TABLE_SCALE + ', '+ TABLE_SCALE + '); -moz-transform-origin: 0% 0%;  -webkit-transform: scale(' + TABLE_SCALE + ', '+ TABLE_SCALE + ');  -webkit-transform-origin: 0% 0%; } \
        ...
        table.trTabPadNW tr td {border:none; background:none; white-space:nowrap; padding: 2px 4px 2px 8px;}\
        table.trTabBR tr td {border:none; background:none;}\
        ...
        #main_body input.checkbox {display:inline; _top:0.5em; }\
        ...
        table.trMainTab { empty-cells: show;  margin-left: 5px;  margin-top: 4px; padding: 1px;  padding-left:30px;}\
        table.trMainTab tr td a {color:inherit }\
        table.trMainTab tr td   {height:60%; empty-cells:show; padding: 0px 4px 0px 4px;  margin-top:5px; white-space:nowrap; border: 1px solid; border-style: none none solid none; -moz-border-radius:5px; }\
        table.trMainTab tr td.spacer {padding: 0px 0px;}\
        table.trMainTab tr td.sel    {font-weight:bold; font-size:13px; border: 1px solid #000000; background: -moz-linear-gradient(top,#00a045 0%,#94eb9a 0%,#045c28);}\
        table.trMainTab tr td.notSel {font-weight:bold; font-size:13px; color: #ffffff; border: 1px solid #000000; background: -moz-linear-gradient(top,#00a045 0%,#94eb9a 0%,#045c28);}\
        ...
        .trPopMain  { border:1px solid #000000; -moz-box-shadow:inset 0px 0px 10px #6a6a6a; -moz-border-radius-bottomright: 20px; -moz-border-radius-bottomleft: 20px;}\
        .trPopup  {border:5px ridge #666; opacity:'+upgradeData.Opacity+'; -moz-border-radius:25px; -moz-box-shadow: 1px 1px 5px #000000;}\
        span.trTextFriendly {color: #080}\
        span.trTextHostile {color: #800}\
        .trButCancel {background-color:#a00; font-weight:bold; color:#fff}\
        ...
        div.trCard div.description div.briton.trophy{background:transparent url("http://kabam1-a.akamaihd.net/kingdomsofcamelot/fb/e2/src/img/throne/icons/70/briton_trophy_normal_1_5.png") top left no-repeat;}\
        ...
        div.trCard div.description div.druid.trophy{background:transparent url("http://kabam1-a.akamaihd.net/kingdomsofcamelot/fb/e2/src/img/throne/icons/70/druid_trophy_normal_1_5.png") top left no-repeat;}\
        ...
        div.trCard div.description div.fey.trophy{background:transparent url("http://kabam1-a.akamaihd.net/kingdomsofcamelot/fb/e2/src/img/throne/icons/70/fey_trophy_normal_1_5.png") top left no-repeat;}\
        ...
        div.trCard div.title{font:bold 16px Georgia;border-bottom:1px solid #703200;padding:4px 3px 5px 8px;background:transparent url("http://kabam1-a.akamaihd.net/kingdomsofcamelot/fb/e2/src/img/throne/panel/modal/item_bg.png") -20px -100px no-repeat;}\
        ...
        div.trCard li{padding:3px 0 0 5px;color:#3f2300;font-weight:bold;font-size:16px;}\
        ...
        #trhammer {	background-image: url("http://kabam1-a.akamaihd.net/kingdomsofcamelot/fb/e2/src/img/throne/modal/sm_hammer.png"); background-repeat: no-repeat; background-color: transparent; display: inline-block; width: 28px; height: 32px; margin: 2px; vertical-align: middle;}\
    ...
    mainPop = new trPopup ('tr', upgradeData.trWinPos.x, upgradeData.trWinPos.y, 750,800, true,
            function (){
        tabManager.hideTab();
...
function attachTab()
{
    ...
    '<li id="throneStatTab" class="inactive"> İstatistikler </li><li id="throneTest" class="inactive" onclick="hideShow()"> Kontroller </li><li id="trexecselect" class="inactive" onclick="execSelect()">Seç</li><li id="trexecupgrade" class="inactive" onclick="execUpgrade()">Yükseltme</li><li id="trexecsalvage" class="inactive" onclick="execSalvage()">Kurtarma</li><li id="trtimerdisp" class="inactive">Saat</li>');
...
var tabManager = {
        ...
        init : function (mainDiv){
            ...
            var m = '<TABLE cellspacing=3 class=trMainTab><TR>';
            for (var i=0; i<sorter.length; i++) {
                m += '<TD class=spacer></td><TD align=center class=notSel id=trtc'+ sorter[i][1].name +' ><A><SPAN>'+ sorter[i][1].label +'</span></a></td>';
...
function MyAjaxRequest (url, o, noRetryX){
    ...
    function mySuccess (msg){
        ...
        if (!rslt)
        {
            logit("Mesaj Hatası : " + inspect(msg,3,1));
            return;
        }
        var x;
...
Tabs.throneSalvage = {
        ...
        init : function (div) {
            ...
            if (salvageData.salvageActive == false) {
                m += '<tr><TD><div><INPUT id=trSalvagerPower type=submit value="Oto Silme = Kapalı"/></div></td>';
            } else {
                m += '<tr><TD><div><INPUT id=trSalvagerPower type=submit value="Oto Silme = Açık"/></div></td>';
            }
            m += '<td><b> City to put aetherstones: </b></td>';
            m += "<td><div id='trSalvageCity'></td><td></td></tr>";

            m += '<tr><td><div> Gelen İtemlerde : <select id="trSalvageQuality">';
            m += '<option value="1">Ortak</option>';
            m += '<option value="2">Nadir</option>';
            m += '<option value="3">Rare</option>';
            m += '<option value="4">Epic</option>';
            m += '<option value="5">Wondrous</option>';
            m += '</select> Ve Daha Yükseğini Silme..</div></td>';
            ...
            m += '  <option value="any">Hepsi</option>';
            m += '  <option value="fey">Karışık</option>';
            m += '  <option value="briton">Briton</option>';
            m += '  <option value="druid">Rahip</option>';
            m += '</select></span></div></td>';
            m += '<td alight="left"><div><span>Card type: <select id="trCardType">';
            m += '  <option value="any">Hepsi</option>';
            m += '  <option value="chair">Makam</option>';
            m += '  <option value="table">Tablo</option>';
            m += '  <option value="window">Pencere</option>';
            m += '  <option value="banner">Afis</option>';
            m += '  <option value="advisor">Danışman</option>';
            m += '  <option value="trophy">Ganimet</option>';
            m += '</select></span></div></td>';
            m += '<td align="right"><INPUT id=trAddRule type=submit value="Kartı Olustur"/></td>';
            m += '</tr></table>';
            m += '<TABLE  class=trTabPad width=100% id="trConditionTable"  style="padding-left: 5px;">';
            m += '<tr><td align=left colspan=1><INPUT id=trAddRow type=submit value="Yeni Kart Ekle"/></td>';
            m += '<td></td><td></td><td></td><td></td><td></td></tr>';
            m += '</table>';
            m += '</div><hr/>';
            m += '<div id="trSalvStatus" style="text-align: center;" >Sistem Yükleniyor Lütfen Bekleyin ... </div><hr/>';
            m += '<div class=trRulePane>';
            m += '<div align=center> <b> Sistem Seçili İtemleri Otomatik Olarak Bulup Tutacaktır </b></div><hr/>';
        ...
        buildRuleDisplay : function ()
        {
            ...
            for (i =0; i < salvageData.ruleSet.length; i++)
            {
                ...
                m += "</div></td>";
                m += "<td width=20%><INPUT id=trDelRule" + i + " type=submit value='Kart Sil' /></td>";
                m += '</tr>';
            }
        ...
        updateTRTab : function() {
            $("#trexecsalvage").html("Kart Yakalama " + (salvageData.salvageActive ? "Açık" : "Kapalı"));
        },
        ...
        togglePower: function(obj){
            ...
            if (salvageData.salvageActive == true) {
                ...
                btn.value = "Kart Yakalama = Kapalı";
                clearInterval(t.sTimer);
            } else {
                salvageData.salvageActive = true;
                var btn = document.getElementById('trSalvagerPower');
                btn.value = "Kart Yakalama = Açık";
                t.doSalvage();
                t.start();
            }
            t.updateTRTab();
        ...
        doSalvage : function() {
            ...
            t.deleting = true;
            t.setStatus('Kart Kurtarma Öğeleri');        
            ...
            if (t.delItems.length > 0) {
                ...
                t.deleting = false;
                t.setStatus('Kurtarılacak Kart Yok.Sistem Sonraki Döngü İçin Bekliyor.');
            }
        },
        ...
        doDelete : function(){
            ...
            new AjaxRequest(unsafeWindow.g_ajaxpath + "ajax/_dispatch53.php" + unsafeWindow.g_ajaxsuffix, {
                ...
                onSuccess: function (transport) {
                    ...
                    if(rslt.ok) {
                        trSalvageLog('Taht Odası İtem Silinmiş '+ throne_item.name);
                    ...
                    if (idx >=0)
                    {
                        t.delItems.splice(idx,1); // Remove item from array
                                                    // regardless
                    ...
                    if (t.delItems.length > 0) { // Check if the array is
                        ...
                        t.deleting = false;
                        t.setStatus('Kart Kurtarıldı.Bir Sonraki Döngü İçin Bekliyorum.');
                        return;
                    }
                },
                onFailure: function () {
...
Tabs.organizer = {
        ...
        init : function (div){
            ...
            // setup the tab
            var m = '<Div style="width: 720px; height:620px;"><DIV id=trOrganizer class=trStat style="width: 740px;">ORGANIZER</div>';
            ...
            // Sistemi Aktif Et "/></td>';
            m += '<TD width=20%><INPUT id=testSalvage type=submit value=" Sistemi Test Et"/></td><td id=trDelResults></td>';
            m += '</tr>';
            m += '<tr align="center"><td><div><span>Sıralama : <select id="trSortList">';
            
            m += '<option value="none">--Efekt--</option>';
            for (k in effects)
            {
            ...
            m += "  <option value='buff'>Deri</option>";
            m += "  <option value='debuff'>Debuff</option>";
            m += "</select></td>";
            
            m += '<td><INPUT id=trSortInactive type=checkbox '+ (  t.sortInactive ?' CHECKED':'') +'/> İnaktif Dahil</td>';
            m +='</tr></table>';

            m += "<div id='trScrollDiv' style='width: 740px; max-height:540px; height:540px; overflow-x: auto; overflow-y:scroll;'>";
            ...
            m += "<div id='trTableDiv' style='width: 740px; overflow: hidden;'>";
            m += '<TABLE id=trDisplayTable align=center width=92% height=0% class=trTab cellpadding=4 >';
            m += "<th>Chairs</th><th>Tablolar</th><th>Pencereler</th><th>Afişler</th><th>Danışmanlar</th><th>Kupalar</th>";
            m += '</table></div>';
            m += '</div>';
            m += '</div>';
            ...
            $("#trSortInactive").click( function(){
                t.sortInactive = $(this).is(':checked');
                t.show();
            });
        ...
        paintTable : function() {
            ...
            m += "<tr><th width=17%>Chairs</th><th width=17%>Tables</th><th width=17%>Windows</th><th width=17%>Banners</th><th width=16%>Advisors</th><th width=16%>Throphies</th></tr>";
            for (var k= 0; k < ii ; k++)
            {
                mm = '<TR>';
                for (i in t.itemTypes)
                {
                    ...
                    mm += '<TD style="overflow: hidden; border: 5px solid white;" id="' + id +'" >';
        ...
        sortValue : function (item)
        {
            ...
            for (e in item.effects)
            {
                ...
                if (B>= item.quality && !t.sortInactive) continue;
        ...
        buildCard : function(I){
            ...
            D.push("<div style='overflow: visible; position: relative; left: 0px; top: 0px; -moz-transform: scale(" + TABLE_SCALE + ", "+ TABLE_SCALE + "); -moz-transform-origin: 0% 0%;  -webkit-transform: scale(" + TABLE_SCALE + ", "+ TABLE_SCALE + ");  -webkit-transform-origin: 0% 0%;  ' onclick='trSelectCard(" + I.id + ");'>");
            if (I.isBroken)
            {
                D.push(" <div class='cardOverlay semi_transparent rot45'> Kırık </div>");
            }
            D.push(" <div class='trCard' style='white-space: normal; padding: 0px;' onclick='trSelectCard(" + I.id + ");'> ");
            D.push("<div class='section' style='overflow: hidden;' id = 'idsection'>");
...
Tabs.trActionLog = {
        ...
        init : function (div){
            ...
            t.myDiv = div;
            t.myDiv.innerHTML = '<INPUT id=trupdate type=checkbox '+ (TRGlobalOptions.trUpdate?'CHECKED ':'') +'/>Yeni Script İçin Siteye Gidiniz (all domains) &nbsp; &nbsp; <INPUT id=trupdatenow type=submit value="Script Yükseltmesi Var" />\
            <DIV class=trStat>Yükseltme Kayıtları Ve Versiyon: '+ Version+'</div><DIV style="height:535px; max-height:535px; overflow-y:auto">\
            <TABLE cellpadding=0 cellspacing=0 id=trsuccesslog class=trTabLined><TR><TD></td><TD width=95%></td></table>\
            <DIV class=trStat>Eylem Kayıtları</div>\
            <TABLE cellpadding=0 cellspacing=0 id=tractionlog class=trTabLined><TR><TD></td><TD width=95%></td></table>\
            <DIV class=trStat>Oturum Kayıtları</div>\
...
Tabs.upgrader = {
        ...
        init : function (div){
            ...
            // header stuff
            var m = '<Div id=trfield><DIV id=trUpgrader class=trStat>Otomatik Güncellemesi</div><TABLE id=trupgrader width=100% height=0% class=trTab>';
            m   += '<TR>';
            if (upgradeData.active == false) {
                m += '<TD><div class=indent25><INPUT id=trUpgraderPower type=submit value="Yükseltme = Kapalı"/></div></td>';
            } else {
                m += '<TD><div class=indent25><INPUT id=trUpgraderPower type=submit value="Yükseltme = Açık"/></div></td>';
            }

            if (upgradeData.enhanceAction == false) {
                m += '<TD><INPUT id=trUpgraderSelect type=submit value="Eylem = Yükseltme"/></td>';
            } else {
                m += '<TD><INPUT id=trUpgraderSelect type=submit value="Eylem = Artırmak"/></td>';
            }
            ...
            // upgrade selector
            m += '<TABLE id=trupdtable class=trTabPad2><tr><td><div><span>Yükseltme : <select id="trUpgradeList">';
            m += '<option value="0">--Items--</option>';
            for (k in unsafeWindow.kocThroneItems) {
                var throne_item = unsafeWindow.kocThroneItems[k];
                m += '<option value="'+k+'">'+throne_item.name+'</option>';
            }
            m += '</select></span></div></td><td></td>';
            m += '<td><div id=trUpgradeCost> <br> </div></td>';
            m += '</tr>';
            ...
            // id="trEnhanceList">';
            m += '<tr><td><div><span>Geliştirme : <select id="trEnhanceList">';
            m += '<option value="0">--Items--</option>';
            for (k in unsafeWindow.kocThroneItems) {
                var throne_item = unsafeWindow.kocThroneItems[k];
                m += '<option value="'+k+'">'+throne_item.name+'</option>';
            ...
            m += '<option value="1">Ortak</option>';
            m += '<option value="2">Nadir</option>';
            m += '<option value="3">Ender</option>';
            m += '<option value="4">Destansı</option>';
            m += '<option value="5">Harika</option>';
            m += '</select></div></td>';
            ...
            $("#trpplink")
               ...
               .attr('target', '_blank');
            $("#trpp")
               .attr( 'src', 'http://www.paypalobjects.com/en_US/i/btn/btn_donateCC_LG.gif')
               .attr( 'alt', 'dontae')
               .css( 'cursor', 'pointer');
...
function trPopup (prefix, x, y, width, height, enableDrag, onClose) {
    ...
    <TR><TD height=100% valign=top class="trPopMain '+ prefix +'_trPopMain" colspan=2 id="'+ prefix +'_main"></td></tr></table>';
        ...
        compare: function(xpr,response) {
            ...
            if ( updated ) {
                display_confirm('A new version of '+this.xname+' is available.\nDo you wish to install the latest version?',
                        ...
                        function(){
                    try {
                        location.href = 'http://userscripts.org/scripts/source/132329.user.js';
                    } catch(e) {}
                },
                // Cancel
                function(){
