...
//
// ==UserScript==
// @name           Bara premium pt triburile refacuta
// @namespace      www.triburile.ro @description    Bara premium pt triburile refacuta (Cladirea principala, cazarma , grajd , atelier , curtea nobila , Fierarie , Piata centrala , Targ)  
...
window.newShortcut = function(imgSrc, aHref, text){
	...
	if(tdIdIndex == 0){
		newTd.setAttribute("style", "border-width:1px; border-style:transparent; border-right-style:none; padding-left:4px; padding-right:4px; border-spacing:1px;"); 
	}
	else if(tdIdIndex == 5){
		newTd.setAttribute("style", "border-width:1px; border-style:transparent; border-left-style:none; padding-left:4px; padding-right:4px; border-spacing:1px;"); 
	}
	else{
		newTd.setAttribute("style", "border-width:1px; border-style:transparent; border-left-style:none; border-right-style:none; padding-left:4px; padding-right:4px; border-spacing:1px;");
	} 
...
window.createQuickbarShortcuts = function() {
	"<tr>   " + 
	newShortcut("http://ro5.triburile.ro/graphic/buildings/main.png", "/game.php?village="+VillId+"&screen=main", "Cladirea principala   ");
	newShortcut("http://ro5.triburile.ro/graphic/buildings/barracks.png", "/game.php?village=+VillId+&screen=barracks", "Cazarma   ");
	newShortcut("http://ro5.triburile.ro/graphic/buildings/stable.png", "/game.php?village="+VillId+"&screen=stable", "Grajd");
	newShortcut("http://ro5.triburile.ro/graphic/buildings/garage.png", "/game.php?village="+VillId+"&screen=garage", "Atelier   ");
	
newShortcut("http://ro5.triburile.ro/graphic/buildings/snob.png", "/game.php?village="+VillId+"&screen=snob", "Curtea nobila   ");
	newShortcut("http://ro5.triburile.ro/graphic/buildings/smith.png", "/game.php?village="+VillId+"&screen=smith", "Fierarie   ");
	newShortcut("http://ro5.triburile.ro/graphic/buildings/place.png", "/game.php?village="+VillId+"&screen=place", "Piata centrala   ");
	
newShortcut("http://ro5.triburile.ro/graphic/buildings/market.png", "/game.php?village="+VillId+"&screen=market", "Targ")	
tableIdIndex++;
	trIdIndex++;
}