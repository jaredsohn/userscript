...
*Please send me message via the userscripts.org mailing facility, for credits
*
...
function functionMain(e) {
	...
	TB3O.specBuildings = [0, 0, 0, 0, 0, 0, 0, 0, 0];//cpbuilding, barracks, big barracks, workshop, stable, big stable, tournament square, townhall, horse drinking through
	//race
	TB3O.crtUserRace = '';
	TB3O.dispUserRace = '';
	TB3O.deltaRaceImg = 1;
	...
	if (document.defaultView.getComputedStyle(document.body, null).getPropertyValue("direction") == 'rtl') docDir = ['right', 'left'];
	...
	function yTiT(tType, intNo, strName) {
		this.tType = tType;
		this.intNo = intNo;
	...
	vList = new Array();
	//active village
	aVillage = new xVillage('', 0, 0, -1000, -1000, '');
	
	arrTtT = new Array();

	vNames = '';
	//auto-fill own village names in market/rally point send troops

	defPosFloatDiv = "680px|150px";
	merchantsCapacity = 0;
	defaultMF = [5, 5, 4, 2, 4];
	var marketFilters;
	boolIsTroopsTrainingBuilding = false;
	var localGP = "";
	var wsSName;
	...
	var repSite = [
		["Travilog", "http://travilog.org.ua/"],
		["T-Reports.net", "http://travian-reports.net/"]
	];
	
	var wsURLTravianBox = "http://travianbox.com";
	var urlNow = window.location.pathname + window.location.search;
	var warsimExtLink = "http://travian.kirilloid.ru/warsim.php";
	...
	"table#showbookmarks tr, table#showbookmarks td.tb3cnb {width:auto; line-height:16px; font-size:13px; text-align:" + docDir[0] + "; vertical-align:middle; padding:0px 0px 0px 2px; margin:0px; white-space:nowrap; border-collapse:collapse; border:0px none transparent; }" +
	"table#showresbartable, table#showresbartable tr, table#showresbartable td.tb3c {border-collapse:collapse; border:1px solid #C0C0C0; background-color:white; width:auto; line-height:13px; font-size:8pt; padding:2px; margin:0px; white-space:nowrap;}" +
	"table#showresbartable td.tb3cvn {line-height:13px; text-align:center; font-weight:bold; font-size:8pt; color:blue; background-color:#ECECEC; padding:2px;}" +
	"table#showresbartable td.tb3chtot {line-height:13px; text-align:" + docDir[1] + "; font-weight:bold; font-size:8pt; border-" + docDir[0] + ":2px solid silver; background-color:#FFFFC0; padding:2px;}" +
	"table#showresbartable td.tb3ctot {line-height:13px; text-align:" + docDir[1] + "; font-size:8pt; border-" + docDir[0] + ":2px solid silver; background-color:#FFFFC0; padding:2px;}" +
	"table#showresbartable td.tb3ctotv {line-height:13px; text-align:" + docDir[1] + "; font-size:8pt; border-top:2px solid silver;border-bottom:2px solid silver; border-" + docDir[0] + ":1px solid silver; background-color:#ECECEC; padding:2px;}" +
	"table#vl2table {border-collapse; border:0px medium none; background-color:white; line-height:13px; font-size:10px; padding:2px; margin:0px}" +
	"table#showbookmarks {border-collapse; border:0px medium none; background-color:white; line-height:16px;}" +
	"div.fldiv {position:absolute; display:block; padding:1px; z-index:50; clear:both; border:2px solid #C0C0C0; background-color:#FFFFFF;}" +
	"div.dragdiv {text-align:center; font-weight:bold; height:20px; float:" + docDir[0] + "; cursor: pointer; border-bottom:1px solid #C0C0C0; background-color:#ECECEC;}" +
	...
	"div.CNbuildingtags {background-color:" + TB3O.CN_COL_NEUTRAL + "; border:#000000 thin solid; -moz-border-radius:2em; " +
	...
	".bttable		{width:100%; height:129px; text-align:left; border-collapse:collapse; background-color:white;}" +
	//"table.tbg tr.cbgx td, td.cbgx {background-color:#FFFFC0; text-align:center; border-collapse:collapse;}" +
	...
	"table#vlist tbody tr:hover{background-color:#E5E5F0}" +
...
xLang['DAYAFTERTOM'] = 'day after tomorrow';
...
xLang['WARSIM'] = "Combat simulator link to use:"; //menu left"
...
xLang['CONSOLELOGLEVEL'] = "Console Log Level<br>ONLY FOR PROGRAMMERS OR DEBUGGING<br>(Default = 0)";
...
//3.8.8.7
xLang['SHOWPPHINVL'] = "Show lumber, clay, iron production per hour in village list";
xLang['REPSITE'] = "Link to use for posting reports site";
...
xLang['EXTAV'] = 'Fejlesztés elérhetõ';
...
xLang['CHKSCRV'] = 'TBeyond frissítése';
...
xLang['NVERAV'] = "A szkript új verziója elérhetõ";
xLang['UPDATESCRIPT'] = "Frissíted most?";
xLang['CHECKUPDATE'] = "Szkript-frissítés keresése.<br>Kérlek várj...";
...
xLang['CONSOLELOGLEVEL'] = "Konzol naplózási szint<br>CSAK PROGRAMOZÓKNAK VAGY HIBAKERESÉSHEZ<br>(Alap = 0)";
...
xLang['SHOWBIGICONMILITARY'] = 'Gyülekezõtér/Kaszárnya/Mûhely/Istálló';
...
xLang['SHOWSENDTROOPSRESOURCES'] = "mutatja a 'katona küldése/anyagi javak küldése' a falu listában";
xLang['SHOWCPINUPGTABLES'] = "mutatja a CP/nap információt a feljavítási asztalokban";
xLang['UPGTABLES'] = "mezőket támogat/épít a feljavítási asztalokban";
xLang['SHOWCCINUPGTABLES'] = "mutatja a termés fogysztásta a feljavítási asztalokban";
xLang['SHOWCCINVL'] = "mutatja a tényleges termelést a falulistában";
xLang['RESBARTABLETITLE'] = "készlet pult";
xLang['SHOWRESBARTABLE'] = "mutatja a 'készlet pult' táblát";
xLang['FLOATRESBARTABLE'] = "mutatja a  'készlet pult' táblát úszó ablakként";
xLang['FLOATBOOKMARKS'] = "mutatja a 'felhasználói könyvjelzőket' úszó ablakként";
xLang['FLOATNOTEBLOCK'] = "mutatja a 'jegyzet blokkot' úszó ablakként";
xLang['SHOWPOPINVL'] = "mutatja a népességet a falu listán";
xLang['MAPANALYSER'] = 'Map Analyser használatra';
xLang['SHOWTRAVMAPUSERLINKS'] = 'Felhasználóknak mutat összeköttetéseket a térképhez';
xLang['SHOWTRAVMAPALLYLINKS'] = 'mutatja a linkeket szövetségesekhez a térképen';
//3.8.2
xLang['SHOWTB3BATTLEREPORT'] = 'mutatja a TB3 erősített csatajelentések';
//3.8.2.3
xLang['SHOWVL2TABLE'] = 'mutatja a további (2 oszlopok) falukat úszó ablakként';
//3.8.2.7
xLang['SHOWMESOPENLINKS'] = 'Linkek az üzenetek felugró ablakban mutatásához';
//3.8.5.1
xLang['SHOWSORTEDBIUPGT'] = 'név szerint épületeket rendez a feljavítási asztalokban';
//3.8.6.6
xLang['SHOWBIPATTINVL'] = 'Haladásban és csapatmozgásokban mutat épületekkel kapcsolatos információt<br>falusi listában';
xLang['SHOWSEARCHBAR'] = "mutatja a 'kereső pultot'";
xLang['FORCET31TCAP'] = 'T3.1 Legionnaire-t és Phalanx kapacitást kényszeríti számításra<br>(kevert T3.1 és T3.5 szerverekért)';
//3.8.7.1
xLang['FLOATSEARCHBAR'] = "mutatja a 'keresőpultot' úszó ablakként";
//3.8.7.5
xLang['SHOWUNTILTHENRESIDUE'] = "mutatja az 'amíg akkor/maradék' számítást fejlesztési/kiképzési táblában";
xLang['RESIDUE'] = 'A maradék ha építed ezt ';
xLang['RESOURCES'] = 'készlet';
//3.8.7.6.3
xLang['ACCINFOHELP'] = "Kinyitja a Profile-odnak automatikus főváros/koordináta-észlelését<br>kaszárnya faj épületek automatikus észlelését azután kinyitja a falusi központot;";
//3.8.7.7
xLang['SHOWADDINFOMARR'] = "további információ minden kereskedőérkezés számára";
//3.8.8.2
xLang['REMOVEADBANNER'] = 'Hirdetési zászlókat távolít el';
//3.8.8.7
xLang['SHOWPPHINVL'] = "mutatja a fa, agyag, vas, búza termelési óráját a falulistán";
xLang['REPSITE'] = "Link a felhasználó számára levél jelentési oldalért";
break;
};
};
...
"search":		imgPrPNG + ''
	...
	function getCrtUserName() {
		uLink = find ("//div[@id='" + dleft + "']//a[contains(@href, 'chatname')]", XPFirst);
	...
	function getCrtUserID() {
		uLink = find("//div[@id='" + dleft + "']//a[contains(@href, 'spieler.php')]", XPFirst);
	...
	function getLanguageAndPlusStatus() {
		...
		if (iP) {
			...
			//T3.1
			iP = find("//img[contains(@src, 'plus.gif')]", XPFirst);
			if (iP) {
				iP.src.search(/\/img\/([^\/]+)\//);
	...
	function getGMcookie(aName, addNewDid) {
		...
		return decodeURIComponent(GM_getValue(nC, false));;
	};
	...
	function img(ref, ld) {
		var imgPath = '';
		if (!ld) imgPath = localGP + "img/un/" + ref; else imgPath = localGP + "img/" + TB3O.language + '/' + ref;
		return imgPath;
	};
	...
	function getActiveVillage() {
		var aV = find("//td[@class='dot hl']", XPFirst);
		if (!aV) {
			aV = find("//div[@id='vlist']//table[@class='vlist']//tr[@class='sel']//a", XPFirst);
			if (!aV) aV = find('//a[@class="active_vl"]/../../td/table/tbody/tr/td', XPFirst);
		};
		...
		function getActiveVillageFromCookie() {
			...
			singleTown = getGMcookie('singleTownNI', false);
			if (singleTown != "false") {
				sArray = singleTown.split("|");
				vNewdid = getGMcookie('singleTownNEWDID', false);
				xy = id2xy(sArray[1]);
	...
	function deltaTopY(aTb){
		if (TB3O.T35 == false) {
			...
			if (docElem && docElem.firstChild) mapx = topx + 10 + parseInt(docElem.firstChild.clientHeight);
			...
			dfooter = get("footer");
			if (dfooter) maxTopY = dfooter.offsetTop + 50;
		};
		return maxTopY;
	};
	...
	function computeTextTime(aD){
		dtNow = new Date();
		h = ((aD.getTime() - dtNow.getTime()) / 1000 / 3600);
	...
	function addFillTimeRow() {
		tbe = get('l4').parentNode.parentNode;
		tbecn1 = tbe.childNodes[0];
		aRow = getFillTimeRow();
	...
	function getFillTimeRow() {
		...
		for (var i = 0; i < 4; i++){
			...
			var prodStr = (prodPerHour[i] < 0 ? prodStr = "<span style='color:#FF0000'>" + prodPerHour[i] + "</span>" : "" + prodPerHour[i] + "");
			aCell = newCell('(' + prodStr + ', ' + timeToFill[i][1] +')', [["style","font-size:9px; text-align:" + docDir[0] + "; padding-" + docDir[0] + ":25px; white-space:nowrap; vertical-align:top;"], ["colspan","2"]]);
			timeToFillRow.appendChild(aCell);
		};
		return timeToFillRow;
	};

	//translated xLang item if available
	function T(xT) {if (xLang[xT] != undefined) return xLang[xT]; else return '---';};
	...
	function getRaceV3() {
		...
		if (clName) {
			if (clName.indexOf("l1") != -1) {TB3O.crtUserRace = "Romans"; TB3O.deltaRaceImg = 1;};
			if (clName.indexOf("l2") != -1) {TB3O.crtUserRace = "Teutons"; TB3O.deltaRaceImg = 11;};
			if (clName.indexOf("l3") != -1) {TB3O.crtUserRace = "Gauls"; TB3O.deltaRaceImg = 21;};
	...
	function setRace(ti) {
		switch (ti) {
			case '1': TB3O.crtUserRace = "Romans"; TB3O.deltaRaceImg = 1; break;
			case '11': TB3O.crtUserRace = "Teutons"; TB3O.deltaRaceImg = 11; break;
			case '21': TB3O.crtUserRace = "Gauls"; TB3O.deltaRaceImg = 21; break;
		};
		//race GM cookie
		setGMcookie('raceV2', TB3O.crtUserRace, false);
	};
	...
	function getRace() {
		...
		if (TB3O.crtUserRace == "false" || TB3O.dispUserRace == "false") getRaceV3();
		if ((TB3O.crtUserRace == "false" || TB3O.dispUserRace == "false") && TB3O.boolIsAvBarracks == true) {
			...
			ajaxRequest(barracksLink, 'GET', null, function(AJAXrespX) {
				...
				aElem.innerHTML = AJAXrespX.responseText;
				aDoc.appendChild(aElem);
				var aValue = aDoc.evaluate("//img[starts-with(@class, 'unit')] | //img[@class='unit']", aElem, null, XPFirst, null).singleNodeValue;
				if (aValue) setRace(getTroopIndexTitleFromImage(aValue)[0]); //race recognition - first image in table of troops
			});
			getDisplayRace();
		};
		if (TB3O.crtUserRace != "false") TB3O.deltaRaceImg = (TB3O.crtUserRace == "Teutons" ? 11 : (TB3O.crtUserRace == "Gauls" ? 21 : 1));
		return TB3O.crtUserRace;
	};
	...
	function getGeneralData() {
		//game version
		if (!get(dTop5)) setT35Constants();

		//Path to the graphic pack (if available)
		//empty graphics set support added
		cssDeclaration = find("//link[starts-with(@href, 'file') and @rel='stylesheet']", XPFirst);
		if (cssDeclaration) {
		...
		//log level
		sLL = getGMcookie("consoleloglevel", false);
		if (sLL == "false") {
			sLL = "0";
		...
		if (spBcookie && spBcookie[aVillage.vNewdid]) TB3O.specBuildings = spBcookie[aVillage.vNewdid];
		...
		TB3O.boolShowPpHinVL = getGMcookie("showpphinvl", false);
		if (TB3O.boolShowPpHinVL == 'false') {
			setGMcookie("showpphinvl", '1', false);
			TB3O.boolShowPpHinVL = '1';
		};
		...
		TB3O.boolShowMenuSection3 = getGMcookie("showmenusection3", false);
		if (TB3O.boolShowMenuSection3 == 'false') {
	...
	function hideAd() {
		...
		if (TB3O.boolRemoveAdBanner == '1') {
			if (TB3O.T35 == true) {
				...
				divHeader = get('dynamic_header');
				if (divHeader) {
					divHeader.style.height = '30px';
					get("res").style.top = '100px';
				};
			} else {
				ad = find("//iframe", XPFirst);
				if (ad) {
					if (ad.id == '') {
						ad.style.display = 'none';
						headerTop = find("//html/body/div", XPFirst);
						if (headerTop) {
							headerTop.style.height = '30px';
							headerTop.style.backgroundImage = '';
						};
						header2 = find("//html/body/div[2]", XPFirst);
						if (header2) header2.style.display = 'none';
						header3 = find("//html/body/div[3]", XPFirst);
	...
	function leftMenuLinks() {
		menu = find("//td[@class='menu']", XPFirst);
		if (!menu) {
		...
		linkWarSim = warsimExtLink;
		warsimOption = getGMcookie('warsim', false);
		if (warsimOption != "1") {
		...
		if (TB3O.boolShowMenuSection3 == "1") {
			...
			TB3O.repSite = getGMcookie("repsite");
			if (TB3O.repSite == 'false') setGMcookie("repsite", "0", false);

			wsAnalyserOption = parseInt(TB3O.wsAnalyserOpt);
			mapAnalyserOption = parseInt(TB3O.mapAnalyserOption);
			...
			menuSection3Links = [
				...
				(TB3O.repSite != "1" ? [repSite[0][0], repSite[0][1] + TB3O.language + "/", "_blank"] : [repSite[1][0], repSite[1][1] + ttblangTR + "/", "_blank"]),
		...
		for (var i = 0; i < aL.length; i++) {
			if (aL[i]) {
				if (aL[i][1] != '') {
					yh = 20;
					if (aL[i][0].length > 17) yh = 40;
					aLink = newLink(aL[i][0], [['href', aL[i][1]], ['style', 'height:' + yh + 'px !important;']]);
	...
	function adaptDataToGameVersion() {
		...
		if (TB3O.T35 == false) {
			...
			for (var xi = 1; xi < 6; xi++) gIcons["b" + xi] = img("a/b" + xi + ".gif");
			...
			gIcons["capacity"] = '<img src="' + image["capacity"] + '">';
			for (var xi = 1; xi < 6; xi++) gIcons["b" + xi] = xGIF;
			gIcons["del"] = image["del"];
	...
	function TB3Setup(){
		...
		setupTb = newTable([['class', 'tb3tb'], ["id", "configuracion"]]);
		tRow = newRow("", [["class", "tb3rh"]]);
		topCell = newCell(T('TBSETUPLINK') + " - " + TB3O.versionText(), [['class', 'tb3chb'], ["width", "70%"]]);
		//save button
		sCell = newCell("", [['class', 'tb3ch'], ['width', '20%'], ["style", "text-align:center;"]]);
		sImg = newImage([['src', image["buttonSave"]], ['style', 'cursor:pointer;'], ['title', T('SAVE')]]);
		sImg.addEventListener("click", TB3SetupSave, 0);
		sCell.appendChild(sImg);
		//close setup
		xCell = newCell("", [['class', 'tb3ch'], ['width', '10%'], ["style", "text-align:center;"]]);
		xImg = newImage([['src', image["closeButton"]], ['style', 'cursor:pointer;'], ['title', T('CLOSE')]]);
		...
		for (var i = 0; i < aTBSetup.length; i++){
			if (aTBSetup[i][0] == 1) {
				sectionRow = elem(aTBSetup[i][2], "");
				sTC = newCell(T(aTBSetup[i][1].toUpperCase()), [["class", "tb3ch"], ['style', "text-align:" + docDir[0] + "; font-size:9pt; font-weight:bold; color:darkblue;"], ['colspan', '3']]);
				if (aTBSetup[i][3] != '') {
					aTN = elem("TEXTNODE", " ");
					aImg = newImage([['src', image["help"]]]);
				...
				setupRow = newRow("");
				setupRowLabel = newCell(T(aTBSetup[i][1].toUpperCase()), [['class', 'tb3c'], ['style', 'text-align:' + docDir[0] + '; font-size:8pt']]);
				setupRow.appendChild(setupRowLabel);
				cellInput = newCell("", [['class', 'tb3c'], ['style', 'text-align:' + docDir[0] + ';'], ['colspan', '2']]);
				aValue = getGMcookie(aTBSetup[i][1], false);
				sVal = (aValue != "false" ? aValue : '');
				switch (aTBSetup[i][2]) {
					case "checkbox":
						pS = newInput([['type', aTBSetup[i][2]]]);
		...
		//create the "Save" row
		saveRow = newRow("", [['class', 'tb3rh']]);
		bCell = newCell(T('TBSETUPLINK') + " - " + TB3O.versionText(), [['class', 'tb3chb'], ["width", "70%"]]);
		sCell2 = newCell("", [['class', 'tb3ch'], ["style", "text-align:center;"], ["width", "20%"]]);
		sImg2 = sImg.cloneNode(true);
		sImg2.addEventListener("click", TB3SetupSave, 0);
		sCell2.appendChild(sImg2);

		xCell2 = newCell("", [['class', 'tb3ch'], ["style", "text-align:center;"], ["width", "10%"]]);
		...
		function TB3SetupSave() {
			arrSelect = get("configuracion").getElementsByTagName("SELECT");
			arrInput = get("configuracion").getElementsByTagName("INPUT");
			for (var i = 0; i < arrInput.length; i++) {
				crtValue = arrInput[i].value;
	...
	function showBigIconsBar(){
		...
		if (TB3O.T35 == true) {
			hPH = '67';
			clearDiv = find("//div[@id='" + dTop5 + "']//div[@class='clear']", XPFirst);
		...
		//setup icon
		setupImg = newImage([['id', 'n9'], ['src', xGIF]]);
		setupLink = newLink("", [['title', T('TBSETUPLINK')], ['href', jsVoid], ['style', 'float:' + docDir[0] + '; ']]);
		setupLink.appendChild(setupImg);
		setupLink.addEventListener('click', TB3Setup, false);

		aPlus = find("//div[@id='" + dTop5 + "']//a[contains(@href, 'plus.php')]", XPFirst);
		...
		showBiMarket = getGMcookie("showbigiconmarket", false);
		showBiM2 = getGMcookie("showbigiconmilitary2", false);
		showBiM = getGMcookie("showbigiconmilitary", false);
		showBiMisc = getGMcookie("showbigiconmisc", false);
		...
		emptyImg = newImage([['src', xGIF], ['width', xM + 'px'], ['height', hPH + 'px'], ['style', 'float:' + docDir[0] + '; ']]);
	...
	function addGreyScaleSwitcher (icon) {
		...
		mouseover_fun = document.createElement ("script");
		mouseout_fun  = document.createElement ("script");
		div_id  = "";
		fun_id  = "";
		icon_gs = icon + "_gs";
	...
	function addReadMesRepInPopup(aNode) {
		if (aNode.parentNode) {
			if (aNode.parentNode.innerHTML.indexOf(imgPr) == -1) {
				...
				aBt.appendChild(newImage([['src', image['igmopen']]]));
				...
				ajaxRequest(aNode.href, 'GET', null, function(AJAXrespX) {
					...
					if (aValue) {
						...
						if (!tooltip) {
							...
							tooltip = createFloatingDiv(dW, iLeft, 90, '', '', "mr_tooltip", false);
						};
						...
						if (aCells.snapshotLength > 0) {
							...
							//	log(3, "tooltip.style.left = " + tooltip.style.left);
							//	log(3, "tooltip.style.top = " + tooltip.style.top);
							//	addAttr(tooltip, [['style', 'left:' + tooltip.style.left + '; right:' + tooltip.style.top + '; height:' + (TB3O.wH - tooltip.offsetTop - 6) + 'px; overflow: auto;']]);
	...
	function updProcResBarTooltip(i, procNo, prC) {
		prSpan = elem("SPAN", procNo + "%");
		addAttr(prSpan, [["id", "resbarProc_" + i], ["style", "color:" + prC + ";" + (procNo > 90 ? ' ;text-decoration:blink; ' : '')]]);
		return prSpan;
	};

	function updColTableResBarTooltip(i, procNo, prC) {
		bTable = newTable([['style', 'border-collapse:collapse; float:left; height:16px; width:100px; background-color:white'], ['id', 'resbarTable_' + i]]);
		bRow = newRow("");
	...
	function getColorResBarTooltip(p) {
		...
		return (p < 90 ? "rgb(" + parseInt(p / 90 * 255) + "," + (100 + p) + ",0)" : "rgb(255," + parseInt((100 - p) / (100 - 90) * 170) + ",0)");
	};
	...
	function updateResbarTooltip() {
		...
		for (var i = 0; i < 4; i++) {
			...
			aSpan = get("resbarProc_" + i);
			if (aSpan) {
				prSpan = updProcResBarTooltip(i, procNo, prC);
				aSpan.parentNode.replaceChild(prSpan, aSpan);
			};
			rbT = get("resbarTable_" + i);
			if (rbT != null) {
				bTable = updColTableResBarTooltip(i, procNo, prC);
	...
	function createFloatingDiv(dWidth, posX, posY, strTitle, sCookieN, divID, boolShowMinMax) {
		...
		var fDiv = newDiv("", [['id', divID], ['class', 'fldiv'], ['style', 'width:' + dWidth + 'px; top:' + iPy + 'px; left:' + iPx + 'px; ']]);
		if (strTitle == T('VILLAGELIST')) strTitle = "<a href='dorf3.php'>" + strTitle + "</a>";
		if (strTitle == '?') strTitle = "<img src='" + image["search"] + "'</img>";
		dragDiv = newDiv(strTitle, [['id', 'dragDiv_' + sCookieN], ['class', 'dragdiv'], ['style', 'width:' + (dWidth - wCMM) + 'px;']]);
		if (boolShowMinMax == true) {
			var newState = getGMcookie(sCookieN + "_state", false);
			if (newState == "false") newState = "max";
			var mmDiv = newDiv("", [['class', 'mmdiv']]);
			strImgMM = "minButton";
			if (newState == "min") strImgMM = "maxButton";
			var mmImage = newImage([['src', image[strImgMM]]]);
			mmImage.addEventListener("click", minmaxDiv, false);
			mmDiv.appendChild(mmImage);
		};
		var closeDiv = newDiv("", [['class', 'closediv']]);
		xImg = newImage([['src', image["closeButton"]], ['title', T('CLOSE')]]);
		xImg.addEventListener("click", function() {get(divID).style.display = "none"; if (sCookieN && sCookieN != "") setGMcookie(sCookieN, "0", false);}, false);
	...
	function showResBarTooltip() {
		...
		if (TB3O.boolFloatResBarTable != '1') {
			prbT = document.createElement("P");
			prbT.appendChild(rbT);
			rbT = prbT;
		} else {
			rbTminWidth = 200;
			xyC = getGMcookie("resbarXY", false);
			if (xyC == "false") {xyC = defPosFloatDiv; setGMcookie("resbarXY", xyC, false);};
			xy = xyC.split("|");
			div = createFloatingDiv(rbTminWidth, xy[0], xy[1], T('RESBARTABLETITLE'), "showresbartable", "showresbartable_tooltip", true);
			TB3O.nodeToAppendRbT = div;
		};
		TB3O.nodeToAppendRbT.appendChild(rbT);
		rbT = get("showresbartable");
		if (rbT && TB3O.boolFloatResBarTable == '1') adjustFloatDiv(rbT, rbTminWidth, "dragDiv_showresbartable");
	...
	function adjustFloatDiv(theTB, xmin, idDrag) {
		...
		var dragDiv = get(idDrag);
		if (dragDiv) dragDiv.style.width = (xmin - 50) + "px";
		return;
	};
	
	function createResBarTable() {
		var rbT = newTable([['id', 'showresbartable']]);
		crtState = getGMcookie("showresbartable_state", false);
		if (crtState == "min" && TB3O.boolFloatResBarTable == '1' ) rbT.style.display = 'none';
		hRow = newRow("", [['class', 'tb3r']]);
		hCell1 = newCell(aVillage.vName, [['class', 'tb3cvn'], ['colspan', '4']]);
		hRow.appendChild(hCell1);
		hCell2 = newCell(T('TOTAL') + " / 1h", [['class', 'tb3chtot']]);
		...
		for (var i = 0; i < vList.length; i++) {
			if (TB3O.VillageRes[vList[i].vID]) {
				for (var yi = 1; yi < 6; yi++) {tPpH[yi - 1] += TB3O.VillageRes[vList[i].vID][yi];};
			};
		};
		...
		for (var i = 0; i < 4; i++) {
			...
			if (procNo > 100) procNo = 100;
			prC = getColorResBarTooltip(procNo);
			aRow = newRow("", [['class', 'tb3r']]);
			aCell = newCell(gIcons["r" + (i+1)], [['class', 'tb3c']]);//, ['title', "" + prodPerHour[i]]]);

			bCell = newCell("", [['class', 'tb3c'], ['style', 'text-align:' + docDir[1] + ';']]);
			bCell.appendChild(updProcResBarTooltip(i, procNo, prC));

			var cCell = newCell("", [['class', 'tb3cresbar'], ['style', 'width:100px']]);
			cCell.appendChild(updColTableResBarTooltip(i, procNo, prC));

			strSpan = timeToFill[i][1];
			strSpanNew = strSpan.replace("font-weight:bold", "font-weight:normal;");
			dCell = newCell(strSpanNew, [['class', 'tb3c'], ['style', 'text-align:' + docDir[1] + ';']]);

			//intTpPh;
			if (i == 3) intTpPh = TB3O.tPpH[4]; else intTpPh = TB3O.tPpH[i];
			eCell = newCell(getLS(intTpPh), [['class', 'tb3ctot']]);
		...
		for (var i = 0; i < 3; i++) {
			intpph += prodPerHour[i];
			intPPH += TB3O.tPpH[i];
		};
		intpph += prodPerHour[4];
		intPPH += TB3O.tPpH[4];
		tRow = newRow("", [['class', 'tb3r']]);
		lCell = newCell(gIcons["r1"] + " + " + gIcons["r2"] + " + " + gIcons["r3"] + " + " + gIcons["r4"] + " / 1h", [['class', 'tb3ctotv'], ['colspan', '3']]);
		mCell = newCell(getLS(intpph), [['class', 'tb3ctotv']]);
		nCell = newCell(getLS(intPPH), [['class', 'tb3ctot'], ['style', 'border-top:2px solid silver; border-bottom:2px solid silver;']]);
		tRow.appendChild(lCell);
		tRow.appendChild(mCell);
		tRow.appendChild(nCell);
		rbT.appendChild(tRow);
		
		//append a row for total crop consumption
		bRow = newRow("", [['class', 'tb3r']]);
		fCell = newCell(gIcons["r5"], [['class', 'tb3c'], ['colspan', '2']]);
		e1Cell = newCell("", [['class', 'tb3c']]);
		gCell = newCell(getLS(prodPerHour[6]), [['class', 'tb3c'], ['style', 'text-align:' + docDir[1] + '; ']]);
		hCell = newCell(getLS(tPpH[4] - tPpH[3]), [['class', 'tb3ctot']]);
		bRow.appendChild(fCell);
		bRow.appendChild(e1Cell);
		bRow.appendChild(gCell);
		bRow.appendChild(hCell);
		rbT.appendChild(bRow);

		//append a row for effective crop production
		cRow = newRow("", [['class', 'tb3r']]);
		iCell = newCell(gIcons["r4"] + " - " + gIcons["r5"], [['class', 'tb3c'], ['colspan', '2']]);
		e2Cell = newCell("", [['class', 'tb3c']]);
		jCell = newCell(getLS(prodPerHour[3]), [['class', 'tb3c'], ['style', 'text-align:' + docDir[1] + ';']]);
		kCell = newCell(getLS(tPpH[3]), [['class', 'tb3ctot']]);
		cRow.appendChild(iCell);
		cRow.appendChild(e2Cell);
		cRow.appendChild(jCell);
		cRow.appendChild(kCell);
		...
		function captureDestination() {
			...
			if (xD != "" && yD != "") {
				...
				if (!parOK) {
					...
					//Travian Battle Analyser is not active
	...
	function getOrigBRTable() {
		var oT = find("//table[@class='tbg'] | //table[@class='std reports_read'] | //table[@class='reports std']", XPFirst);
	...
	function battleReportV2(aFrom){
		...
		if (aFrom == "orig") {
			...
			var p2 = elem("P", "");
			var ptable = newTable([['style', 'background-color:white;']]);
		...
		for (var g = 0; g < t.snapshotLength; g++){
			...
			for(var j = 1; j < 11; j++){
				...
				tInd = getTroopIndexTitleFromImage(tImg)[0];
			...
			if (g == 0) {
				//the attacking power
				attdefCell.setAttribute('style', 'font-size:8pt; color:#FF8000; text-align:center;');
				attdefCell.innerHTML = getLS(attdefPower[0]) + " " + gIcons["att_all"];
			} else {
				//the defense power of the defender (per table)
				attdefCell.setAttribute('style', 'font-size:8pt; color:green; text-align:center;');
		...
		var sTable = newTable([['id', 'br_table'], ['width', '100%'], ['style', 'border:1px solid #C2C2C2; text-align:center; spacing:0px; padding:0px; border:1px solid silver; border-collapse:collapse;']]);

		//add the title row
		var sTitleRow = newRow("", [['class', 'tb3r']]);
		sTitleRow.appendChild(newCell(T('STATISTICS'), [['class', 'tb3cbrh1']]));
		sTitleRow.appendChild(newCell(atkLabelCell, [['class', 'tb3cbrh2']]));
		sTitleRow.appendChild(newCell(defLabelCell, [['class', 'tb3cbrh3']]));
		sTable.appendChild(sTitleRow);

		//attack power row
		atkRow = newRow("");
		var atkIconCell = newCell(gIcons["att_all"], [['class', 'tb3cbr1']]);
		atkRow.appendChild(atkIconCell);
		var atkAPower = newCell(getLS(tadPower[0][0]), [['class', 'tb3cbr2']]);
		atkRow.appendChild(atkAPower);
		var atkDPower = newCell(getLS(tadPower[1][0]), [['class', 'tb3cbr2']]);
		atkRow.appendChild(atkDPower);
		sTable.appendChild(atkRow);

		//def power rows
		var defiRow = newRow("");
		var defiIconCell = newCell(gIcons["def_i"], [['class', 'tb3cbr1']]);
		defiRow.appendChild(defiIconCell);
		var defiAPower = newCell(getLS(tadPower[0][1]), [['class', 'tb3cbr2']]);
		defiRow.appendChild(defiAPower);
		var defiDPower = newCell(getLS(tadPower[1][1]), [['class', 'tb3cbr2']]);
		defiRow.appendChild(defiDPower);
		sTable.appendChild(defiRow);

		var defcRow = newRow("");
		var defcIconCell = newCell(gIcons["def_c"], [['class', 'tb3cbr1']]);
		defcRow.appendChild(defcIconCell);
		var defcAPower = newCell(getLS(tadPower[0][2]), [['class', 'tb3cbr2']]);
		defcRow.appendChild(defcAPower);
		var defcDPower = newCell(getLS(tadPower[1][2]), [['class', 'tb3cbr2']]);
		...
		var rewATotal = newCell(strRewATotal, [['class', 'tb3crb2'], ['style', 'font-weight:bold;']]);

		var rewRow1 = newRow("");
		var intDetailRowSpan = 1 + parseInt(TB3O.boolShowBRStatDetails);
		var rewLabelCell = newCell(labelReward, [['class', 'tb3cbr1'], ['rowspan', intDetailRowSpan]]);
		rewRow1.appendChild(rewLabelCell);

		if (TB3O.boolShowBRStatDetails == '1') {
			var rewA = '';
			for (var i = 1; i < 5; i++) {rewA += getLS(stBooty[i - 1]) + " " + imgRes[i - 1] + "<br>";};
			rewADetail = newCell(rewA, [['class', 'tb3cbr2']]);
			rewRow1.appendChild(rewADetail);
		} else rewRow1.appendChild(rewATotal);

		rewRow1.appendChild(newCell('-', [['class', 'tb3cbr2'], ['rowspan', intDetailRowSpan]]));
		sTable.appendChild(rewRow1);

		if (TB3O.boolShowBRStatDetails == '1') {
			var rewRow2 = newRow("");
			var rewATotal = newCell(getLS(booty) + " " + T('TOTAL'), [['class', 'tb3cbr2b']]);
		...
		var lossATotal = newCell(strLossATotal, [['class', 'tb3cbr2b']]);
		if (tadPower[0][3] > 0) lossATotal.setAttribute('class', 'tb3cbr2br');

		var strLossDTotal = getLS(tadPower[1][3] + booty) + (TB3O.boolShowBRStatDetails == '1' ? " " + T('TOTAL') : '');
		lossDTotal = newCell(strLossDTotal, [['class', 'tb3cbr2b']]);
		if (tadPower[1][3] + booty > 0) lossDTotal.setAttribute('class', 'tb3cbr2br');

		var lossRow1 = newRow("");
		var lossLabelCell = newCell(T('LOSS'), [['class', 'tb3cbr1'], ['rowspan', intDetailRowSpan]]);
		...
		if (TB3O.boolShowBRStatDetails == '1') {
			...
			var lossADetail = newCell(iLossA, [['class', 'tb3cbr2']]);
			if (tadPower[0][3] > 0) lossADetail.setAttribute('class', 'tb3cbr2r');
			lossRow1.appendChild(lossADetail);
			var lossDDetail = newCell(iLossD, [['class', 'tb3cbr2']]);
			if (tadPower[1][3] + booty > 0) lossDDetail.setAttribute('class', 'tb3cbr2r');
		...
		var ccRow = newRow("");
		var ccRowLabelCell = newCell(gIcons["r5"], [['class', 'tb3cbr1']]);
		ccRow.appendChild(ccRowLabelCell);
		ccACell = newCell(tadPower[0][10] + " (-" + tadPower[0][8] + ")", [['class', 'tb3cbr2']]);
		ccDCell = newCell(tadPower[1][10] + " (-" + tadPower[1][8] + ")", [['class', 'tb3cbr2']]);
	...
	function processDorf1() {
		...
		if (bRcC == "1") {
			...
			var posDIV = newDiv("", [['id', 'resDiv'], ['style', 'position:absolute; top:' + intTop + 'px; left:12px; z-index:11;']]);
			if (TB3O.T35 == false) {
				...
				for (var j = 0; j < 25; j++){
					if ((bIsC) || (!bIsC && j < 10)){
						if (grid[i][j] > 0 && bCost[i + 1][j+1] != null){
							...
							aLink = newLink("", [['href', "/build.php?id=" + grid[i][j]]]);
							aDiv = newDiv("", [['style', 'width:0%;']]);
							aDiv.appendChild(newImage([['src', image["upgr" + i]], ['title', T('RES' + (i + 1))]]));
	...
	function processDorf2() {
		...
		for (var i = 0; i < bImg.length; i++) {
			...
			switch (bData[i].gid) {
				case 25: TB3O.specBuildings[0] = 25;	break; //residence is available
				case 26: TB3O.specBuildings[0] = 26; break; //palace is available
				case 19: {TB3O.specBuildings[1] = 19; TB3O.boolIsAvBarracks = true; if (TB3O.crtUserRace == 'false' || TB3O.dispUserRace == 'false') getRace()}; break;
				case 29: TB3O.specBuildings[2] = 29;	break;
				case 21: TB3O.specBuildings[3] = 21;	break;
				case 20: TB3O.specBuildings[4] = 20;	break;
				case 30: TB3O.specBuildings[5] = 30;	break;
				case 14: TB3O.specBuildings[6] = bData[i].lvl; break;
				case 24: TB3O.specBuildings[7] = 24;	break;
				case 41: TB3O.specBuildings[8] = bData[i].lvl; break;
			};
		};
		setGMcookieV2('specBuildings', TB3O.specBuildings, aVillage.vNewdid);

		boolShowBUpgTable = getGMcookie("showbupgtable");
		...
		divmap2 = find("//div[starts-with(@class, 'village2_map d2_')]", XPFirst);
		if (divmap2 && bCN[0] == 1) {
		...
		for (var i = 0; i < k; i++) {
			if (bData[i].gid != -1 && bData[i].lvl != -1) {
				...
				if (bCN[0] == 1 && bLevel != -1) {
					...
					aDIV = createCNDiv(bData[i].lvl, strNewLevel, bCN[2]);
				...
				if (boolShowBUpgTable == '1') {
					...
					if (bCost[bData[i].gid] != null && bCost[bData[i].gid][bLevel + 1] != null) {
						...
						var tb2 = newTable([['class','bttable']]);
						td.appendChild(tb2);
						...
						if (restante != null) {
							...
							td3.setAttribute('style', 'vertical-align:middle;');
							var xTable = newTable([['class', 'tb3tbnb']]);
							var xRow = newRow("");
							xRow.appendChild(newCell('<a href="' + bData[i].link + '">' + T('EXTAV') + '</a>', [['class', 'tb3cnb'],['style', 'font-size:8pt; font-weight:bold;']]));
	...
	function sortTable(sTableID, iCol, sDataType) {
		return function(){
			...
			for (var i = 0; i < aRows.length; i++) aTRs[i] = aRows[i];
	...
	function createNoteBlock(){
		...
		addAttr(tArea, [["cols", dInfo[1]], ["id", "noteblockcontent"], ["nowrap", false], ["style", 'background-image: url(' + image["underline"] + '); border:1px solid silver; padding:0px 2px 0px 2px; overflow:auto; font-size:10pt; width:' + (dInfo[0] - 10) + 'px;']]);
	...
	function getMTime(qDist, xRace) {return Math.round(qDist * 3600 / mts[xRace] / (crtPage.match(/speed/) ? 3 : 1));};

	function getTroopsDetails(qDist, xRace, boolIgnoreTS) {
		arX = [qDist, 0, 0, 1, 1];
		if (boolIgnoreTS == false) {
			//get the tournament square level
			strtsLevel = TB3O.specBuildings[6];
			if (strtsLevel != 0) {
	...
	function createTimeTroopTable(pNode, x2, y2, boolAllRaces) {
		vID = xy2id(x2, y2);
		iHTML = getTroopMerchantTooltipHTML(vID, "blue", true, true, true, boolAllRaces);
		aTb = newTable([['class', 'tb3tbnb'], ['style', 'width:350px;']]);
		if (TB3O.T35 == false) aTb = newTable([['class', 'tb3tbnb']]);
		aTb.innerHTML = iHTML;
		aDiv = newDiv("", [['style', 'font-size:8pt;'], ['id', 'trooptimetable']]);
	...
	function createTimeMerchantTable(pNode, x2, y2) {
		...
		vID = xy2id(x2, y2);
		iHTML = getTroopMerchantTooltipHTML(vID, "blue", true, true, false);
		mWidth = '';
		if (TB3O.T35) mWidth = ' style=width:50%;';
		aDiv = newDiv('<table' + mWidth + ' class="tb3tbnb">' + iHTML + '</table>', [['style', 'font-size:8pt;']]);
	...
	function marketSend() {
		...
		merchantsCell = find("//td[@class='mer'] | //table[@class='f10']//tr//td[@colspan='2']", XPFirst);
		if (merchantsCell) {
			merchantsCellIHTML = merchantsCell.innerHTML;
			addCumulativeArrivals(maxC, merchantsCell.textContent);
			mName = merchantsCellIHTML.split(' ')[0];
			setGMcookie("merchantsName", mName, false);
			maxM = parseInt(merchantsCellIHTML.split(' ')[1].split('/')[0]);
		};
		...
		function mhRowUpdate() {
			...
			crtExceed = totTransport - max_transport;
			mhText = gIcons["merchant"] + "<b>" + " (" + mName + "): " + totMerchants + "/" + maxM + "<br>" + T('MAX') + ": " + maxM * maxC + "<br>";
			...
			mhCell = get("mhMerchants");
			if (!mhCell) {
				mhRow = newRow("");
				mhCell = newCell(mhText, [["id", "mhMerchants"], ["style", 'font-size:11px; color:' + mhColor + ';line-height:16px;'], ["colspan", '9']]);
				mhRow.appendChild(mhCell);
				resTb.appendChild(mhRow);
			} else {
				mhCell.innerHTML = mhText;
				addAttr(mhCell, [['style', 'font-size:11px; color:' + mhColor + ';line-height:16px;']]);
				//mhCell.setAttribute("style", 'font-size:11px; color:' + mhColor + '; line-height:16px;');
			};
		};
		...
		function addCumulativeArrivals(maxC, strAvTotM) {
			...
			for (var i = 0; i < sendReceive.snapshotLength; i++) {
				...
				if (nName == "TABLE") {
					...
					if (tdTime.offsetParent.nodeName == "P") tdTime = get('timer' + (i + 1)); //account in the deletion process
					var pTot = 0;
					...
					insertAfter(aTb.rows[2].cells[1].lastChild, elem("TEXTNODE", "<b> = " + getLS(pTot) + "</b>"));//arrRes[zi]));
	...
	function culturePoints(){
		...
		//var cpTable = newTable([['id', 'cptable']]);
		//header row 11
	...
	function getMarketOfferRatioCell(aRow) {
		if (aRow.cells.length > 7) {
			var aR = parseInt(aRow.cells[1].textContent) / parseInt(aRow.cells[3].textContent);
			var timeCell = aRow.cells[5];
			var actionCell = aRow.cells[6];
		} else {//M35 = 3;
			var aR = parseInt(aRow.cells[0].textContent) / parseInt(aRow.cells[1].textContent);
			var timeCell = aRow.cells[3];
			var actionCell = aRow.cells[4];
		};
		var aCol = ['black', 'white'];
		if (aR < 1.00) aCol = ['red', '#FFE1E1']; else if (aR > 1.00) aCol = ['darkgreen', '#C8FFC8'];
		var ratioCell = newCell(aR.toFixed(2), [["style", "font-size:8pt; background-color:" + aCol[1] + "; color:" + aCol[0] + ";"]]);
		if (timeCell) timeCell.setAttribute("style", "font-size:8pt");
		if (actionCell) actionCell.setAttribute("style", "font-size:8pt;");
		return ratioCell;
	};
	...
	function getMarketOfferAllianceCell(aRow) {
		...
		var noPC = 2;
		if (aRow.cells.length > 6) noPC = 4;
		var aName = aRow.cells[noPC].getAttribute('title');
		if (!aName || aName == "") aName = "-";
	...
	function addMarketOfferCellEvents(aRow) {
		var noC = [1, 4];
		if (aRow.cells.length > 7) noC = [3, 6];
		var cellA = aRow.cells[noC[0]];
		var cellB = aRow.cells[noC[1]];
		var quantity = cellA.textContent;
		...
		function showNeededMerchants(quantity) {
			return function() {
				...
				var aTb = newTable([['class', 'tb3tbnb']]);
				var aRow = newRow("", [['class', 'tb3rnb']]);
				aRow.appendChild(newCell(mTotal, [['class', 'tb3cnb'], ['style', 'font-size:8pt; font-weight:bold; color:blue; text-align:' + docDir[0] + ';']]));
				aTb.appendChild(aRow);
				if (aWaste > 0) {
					var bRow = newRow("", [['class', 'tb3rnb']]);
					bRow.appendChild(newCell(T('MTWASTED') + ": " + aWaste, [['class', 'tb3cnb'], ['style', 'font-size:8pt; color:red; text-align:' + docDir[0] + ';']]));
	...
	function addAllyColumnForMarketOffers() {
		...
		var aX = find("//*[@id='range'] | //*[@id='market_buy']", XPFirst);
		if (!aX) {
			aX = find("//tr[@class='rbg']", XPFirst);
			if (aX) aX = aX.parentNode;
		};
		...
		b[1].appendChild(newCell(T('ALLIANCE')));
		b[1].appendChild(newCell("%"));

		for(var i = 2; i < b.length - 1; i++){
			b[i].appendChild(getMarketOfferAllianceCell(b[i]));
			b[i].appendChild(getMarketOfferRatioCell(b[i]));
	...
	function marketBuy() {
		...
		function filterMarket(orOffersTb, aType, aOpt) {
			...
			for (var i = 2; i < orOffersTb.rows.length - 1; i++) {
				b = orOffersTb.rows[i];
				if (TB3O.T35 == false) {
					var isOfferPossible = true;
					if (b.childNodes.length > 8) var error = true; else var error = false;
					b.childNodes[error ? 1 : 0].firstChild.src.search(/\/(\d).gif$/);
					var rOffered = RegExp.$1;
					b.childNodes[error ? 4 : 2].firstChild.src.search(/\/(\d).gif$/);
					var rSearch = RegExp.$1;
					var qOffered = parseInt(b.childNodes[error ? 2 : 1].textContent);
					var qSearch = parseInt(b.childNodes[error ? 6 : 3].textContent);
					if (b.childNodes[error ? 11 : 6].className == 'c') var isOfferPossible = false;
					var trTime = toSeconds(b.childNodes[error ? 10 : 5].textContent);
				} else {
					if (b.cells[0].firstChild.className) {//M35 = 2;
						var rOffered = b.cells[0].firstChild.className.replace("r", "");
						var qOffered = parseInt(b.cells[1].textContent);
					} else {//M35 = 3;
						var rOffered = b.cells[0].getElementsByTagName("IMG")[0].className.replace("r", "");
						var qOffered = parseInt(b.cells[0].textContent);
					};
					var isOfferPossible = false;
					if (b.cells[2].firstChild.className) {//M35 = 2;
						...
						if (b.cells[6].className == 'act') isOfferPossible = true;
						...
						if (b.cells[5].className == 'act') isOfferPossible = true;
						var trTime = toSeconds(b.cells[4].textContent);
					};
				};
				log(3, "aType = " + aType + "; rOffered = " + rOffered + "; qOffered = " + qOffered + "; aOpt = " + aOpt + "; rSearch = " + rSearch + "; qSearch = " + qSearch);

				switch (aType) {
					case 0: if ((rOffered != aOpt) && aOpt != 5) setOfferFilter(b, "Ofrezco"); else quitMarketFilter(b, "Ofrezco", ["Busco", "Tipo", "Carencia", "Tiempo"]); break;
					case 1: if ((rSearch != aOpt) && aOpt != 5) setOfferFilter(b, "Busco"); else quitMarketFilter(b, "Busco", ["Ofrezco", "Tipo", "Carencia", "Tiempo"]); break;
					case 2: switch(aOpt) {
						case 1: if (qOffered <= qSearch) setOfferFilter(b, "Tipo"); else quitMarketFilter(b, "Tipo", ["Ofrezco", "Busco", "Carencia", "Tiempo"]); break;
						case 2: if (qOffered != qSearch) setOfferFilter(b, "Tipo"); else quitMarketFilter(b, "Tipo", ["Ofrezco", "Busco", "Carencia", "Tiempo"]); break;
						case 3: if (qOffered >= qSearch) setOfferFilter(b, "Tipo"); else quitMarketFilter(b, "Tipo", ["Ofrezco", "Busco", "Carencia", "Tiempo"]); break;
						case 4: quitMarketFilter(b, "Tipo", ["Ofrezco", "Busco", "Carencia", "Tiempo"]); break;
					} break;
					case 3: switch(aOpt) {
						case 1: if (isOfferPossible == false) setOfferFilter(b, "Carencia"); else quitMarketFilter(b, "Carencia", ["Ofrezco", "Busco", "Tipo", "Tiempo"]); break;
			...
			// el resto de su aType
			for (var i = 0; i < 5; i++){
				for (var j = 0; j < 6; j++){
					var aFilters = find("//td[@id='filtro" + i + j + "']", XPFirst);
					if (aFilters) {
						if (i == aType && j == (aOpt - 1)) aFilters.setAttribute("style", "background-color:#FFE4B5"); else if (i == aType) aFilters.removeAttribute("style");
					};
				};
			};
		};
	...
	function TimeToExplore() {
		...
		var arrY = find('//td[@class="required"] | //p[@id="contract"] | //table[@class="new_building"]//td[@class="res"] | //div[@id="' + dmid2 + '"]//table[@class="f10"]/tbody/tr[1]/td', XPList);
		if (arrY.snapshotLength > 0) {
			//log(3, "TimeToExplore => arrY.snapshotLength = " + arrY.snapshotLength);
			for (var i = 0; i < arrY.snapshotLength; i++) {
				var aY = arrY.snapshotItem(i);
				var arrayRes = getRequiredRes(aY);
		...
		var arrTNPC = find("//*[starts-with(@id, 'NPCTT_')]", XPList);
		var aTb = get("selecttraintroops");
		if (!aTb) {
			aTb = find("//table[@class='build_details']", XPFirst);
			if (aTb) {
				for (var i = 0; i < arrTNPC.snapshotLength; i++) {
					var ex = calculateResourceTime(arrTtT[i].aRes, "30");
					if (ex) {
						xNode = aTb.rows[i + 1].cells[aTb.rows[i + 1].cells.length - 1];
						xNode.innerHTML = '';
	...
	function defaultAttackType(){
		...
		if (crtPage.match(/a2b.php\?(.*)&o/)) act = 4; else {
			actDef = getGMcookie('rpdefact', false);
			act = 2;
		...
		rbAction = find("//input[@value='" + act + "' and @name='c']", XPFirst);
	...
	function showUserBookmarks() {
		...
		crtState = getGMcookie("showbookmarks_state", false);
		...
		if (TB3O.boolFloatUserBM != '1') {
			...
			ubCoords = getGMcookie("userBookmarksXY", false);
			if (ubCoords == "false") {
			...
			uBminWidth = 200;
			ubXY = ubCoords.split("|");
			div = createFloatingDiv(uBminWidth, ubXY[0], ubXY[1], T('MARCADORES'), 'showbookmarks', "showbookmarks_tooltip", true);
			div.appendChild(aTb);
		};
		playerLinks("showbookmarks");
		aTb = get('showbookmarks');
		if (aTb && TB3O.boolFloatUserBM == '1') adjustFloatDiv(aTb, uBminWidth, "dragDiv_showbookmarks");
		
		function getUserBookmarksTable() {
			aTb = newTable([['id', 'showbookmarks']]);
			//header row
			aTb.appendChild(newRow("").appendChild(getUserBookmarksHeader()));
			//bookmarks string
			strBookmarks = getGMcookie("marcadores", false);
			...
			if (strBookmarks != ''){
				...
				for (var i = 0; i < marcadores.length; i++) {
					...
					if (TB3O.boolLockBookmarks != "1") {
						...
						aCell = newCell("", [['class', 'tb3cnb']]);
						aCell.appendChild(delLink);
						bmRow.appendChild(aCell);

						bmRow.appendChild(newCell("&nbsp;", [['class', 'tb3cnb']]));

						upCell = newCell("", [['class', 'tb3cnb']]);
						if (i > 0) {
							upLink = newLink("", [['href', jsVoid]]);
						...
						bmRow.appendChild(newCell("&nbsp;", [['class', 'tb3cnb']]));
						editCell = newCell("", [['class', 'tb3cnb']]);
						editLink = newLink("", [['href', jsVoid]]);
						...
						aCell = newCell("<span>&#8226;&nbsp;&nbsp;</span>", [['class', 'tb3cnb'], ['style', 'width:10px; color:' + sCol + ';']]);
						bmRow.appendChild(aCell);
					};
					...
					if (marcadores[i][1].indexOf("*") != -1) {
						...
						iHTML = newLink(strBookmark);
						if (marcadores[i][1] != "#") addAttr(iHTML, [['href', marcadores[i][1].substring(0, marcadores[i][1].length)]]);
					};
					//bmCell = newCell("", [['class', 'tb3cnb'], ['style', 'white-space:nowrap'], ['style', 'font-size:10pt; text-align:' + docDir[0] + ';']]);
					bmCell = newCell("", [['class', 'tb3cnb']]);
			...
			function getUserBookmarksHeader() {
				...
				aL[2].addEventListener("click", function() {addGMcookieValue("marcadores", ["<hr size='2' width='100%' noshade color=black>", "#"], false); showUserBookmarks();}, 0);
				...
				var hCell = newCell("", [['class', 'tb3cnb'],['colspan', dInfo[3]]]);
		...
		function addUserBookmark(ubURL, ubLabel) {
			if (!ubURL) {
				ubURL = prompt(T('ENLACE'));
				if (!ubURL || ubURL == '') return;
			};
			ubLabel = prompt(T('TEXTO'));
		...
		function editUserBookmark(i) {
			return function() {
				...
				ubLabel = prompt(T('TEXTO'), tmpUb[0]);
				ubURL = null;
	...
	function getSingleTown() {
		...
		vTable = find("//div[@id='" + dlright1 + "']//table[@id='vlist'] | //div[@id='" + dlright1 + "']//table[@class='f10']", XPFirst);
	...
	function createVillageList(dlr1) {
		...
		stC = getGMcookie('singleTownNI', false);
		stNidC = getGMcookie('singleTownNEWDID', false);
		...
		if (stC != "false") {
			...
			if (TB3O.T35 == false) {
				...
				vLink = newLink('<span class="f10 c0 s7 b">' + T('VILLAGE') + ':</span>', [['href', 'dorf3.php']]);
				dlr1.insertBefore(vLink, dlr1.firstChild);
				vTable = newTable([['class', "f10"]]);
				aBody = elem("TBODY", "");
				vTable.appendChild(aBody);
				aRow = newRow("");
				aBody.appendChild(aRow);
				aCell = newCell('<span class="c2">&#8226;</span>&nbsp;&nbsp;', [['class', 'nbr']]);
				aRow.appendChild(aCell);
				bLink = newLink(stName, [['class', 'active_vl'], ['href', (stNidC == 'false' ? '?newdid=0' : '?newdid=' + stNidC)]]);
				aCell.appendChild(bLink);
				bCell = newCell("", [['class', 'right']]);
				aRow.appendChild(bCell);
				aTb = newTable([["class", "dtbl"]]);
				bCell.appendChild(aTb);
				bBody = elem("TBODY", "");
				aTb.appendChild(bBody);
				bRow = newRow("");
				bBody.appendChild(bRow);
				bRow.appendChild(newCell("(" + xy[0], [["class", "right dlist1"]]));
				bRow.appendChild(newCell("|", [["class", "center dlist2"]]));
				bRow.appendChild(newCell(xy[1] + ")", [["class", "left dlist3"]]));
				insertAfter(vLink, vTable);
			} else if (TB3O.M35 == 1) {
				vDiv = newDiv("", [['class', 'vlist']]);
				vTable = newTable([['class', 'vlist']]);
				tbody = elem("TBODY", "");
				aRow = newRow("", [['class', 'sel']]);
				aRow.appendChild(newCell("●", [['class', 'dot']]));
				aCell = newCell("", [['class', 'text']]);
				vLink = newLink(stName, [['href', (stNidC == 'false' ? '?newdid=0' : '?newdid=' + stNidC)]]);
				aCell.appendChild(vLink);
				aRow.appendChild(aCell);
				aRow.appendChild(newCell("(" + xy[0], [['class', "x"]]));
				aRow.appendChild(newCell("|"));
				aRow.appendChild(newCell(xy[1] + ")", [['class', "y"]]));
				...
				vTable = newTable([['id', 'vlist']]);
				ahead = elem("THEAD", "");
				hrow = newRow("");
				hCell = newCell("", [['colspan', '3']]);
				hLink = newLink(T('VILLAGE') + ':', [['href', 'dorf3.php'], ['accesskey', '9']]);
				hCell.appendChild(hLink);
				hrow.appendChild(hCell);
				ahead.appendChild(hrow);
				tbody = elem("TBODY", "");
				aRow = newRow("");
				aRow.appendChild(newCell("●", [['class', 'dot hl']]));
				bCell = newCell("", [['class', 'link']]);
				bLink = newLink(stName, [['href', (stNidC == 'false' ? '?newdid=0' : '?newdid=' + stNidC)]]);
				bCell.appendChild(bLink);
				cCell = newCell("", [['class', 'aligned_coords']]);
				xD = newDiv(" (" + xy[0], [['class', 'cox'], ['style', 'padding-' + docDir[0] + ':5px; float:' + docDir[0] + ';']]);
				piD = newDiv(" | ", [['class', 'pi'], ['style', 'float:' + docDir[0] + ';']]);
				yD = newDiv(xy[1] + ") ", [['class', 'pi'], ['style', 'padding-' + docDir[1] + ':5px; float:' + docDir[0] + ';']]);
	...
	function villageList() {
		//list of villages
		strPadding = 'padding-right:2px; padding-left:2px;';
		dlr1 = get(dlright1);

		vTable = get('vlist');
		if (!vTable) {
			vTable = find("//table[@class='vlist']", XPFirst);
			if (!vTable) vTable = find("//div[@id='" + dlright1 + "']//table[@class='f10']", XPFirst);
		};
		...
		addAttr(dlr1, [['style', 'position:absolute; top:97px; ' + docDir[0] + ':682px;']]);

		if (TB3O.VillageRes && TB3O.VillageRes[aVillage.vID]) TB3O.AVP = TB3O.VillageRes[aVillage.vID][0];
		for (var i = zi; i < vTable.rows.length; i++){
			...
			if (vNewdid != aVillage.vNewdid) vNames += '"' + vName + '",'; else addAttr(v, [['style', 'background-color:#F1F1F1;']]);
			...
			if (TB3O.boolShowPopInVL == '1') {
				...
				v.appendChild(newCell(" " + "<img src='" + image["pop"] + "'>", [['class', 'tb3cnb'], ['style', 'text-align:' + docDir[0] + ';white-space:nowrap;' + strPadding]]));
				v.appendChild(popCell);
			};

			//show res prod/h
			if (TB3O.boolShowPpHinVL == '1' && TB3O.VillageRes[vList[yi].vID]) {
				for (var xi = 1; xi < 4; xi++) {
					v.appendChild(newCell(" " + gIcons["r" + xi], [['class', 'tb3cnb'], ['style', 'text-align:' + docDir[0] + ';white-space:nowrap;' + strPadding]]));
					v.appendChild(newCell(TB3O.VillageRes[vList[yi].vID][xi], [['class', 'tb3cnb'], ['style', 'font-size:8pt; text-align:' + docDir[1] + '; white-space:nowrap;' + strPadding]]));
				};
			};
			...
			if (TB3O.boolShowCCinVL == "1") {
				...
				v.appendChild(newCell(" " + gIcons["r4"], [['class', 'tb3cnb'], ['style', 'text-align:' + docDir[0] + ';white-space:nowrap;' + strPadding]]));
				v.appendChild(newCell(cpph, [['class', 'tb3cnb'], ['style', 'font-size:8pt; color:' + cpphColor + '; text-align:' + docDir[1] + '; white-space:nowrap;' + strPadding]]));
			};

			if (bIOI == "1") {
				for (var xi = 1; xi < 3; xi++) {
					aCell = newCell("", [['class', 'tb3cnb'], ['style', strPadding]]);
					aLink = newLink("", [['href', 'dorf' + xi + '.php?newdid=' + vList[yi].vNewdid]]);
			...
			if (bCmI == '1') {
				aCell = newCell("", [['class', 'tb3cnb'], ['style', strPadding]]);
				aLink = newLink("", [['href', 'karte.php?z=' + vList[yi].vID]]);
			...
			if (crtPage.indexOf('karte') != -1) {
				if (TB3O.boolShowDistTimes == "1" && TB3O.xCrt != -1000 && TB3O.yCrt != -1000) {
					...
					v.appendChild(newCell(" " + "<img src='" + image["dist" + docDir[0].substr(0,1)] + "'>" + " " + lDist.toFixed(2), [['style', 'font-size:8pt; color:blue; white-space:nowrap;' + strPadding]]));
				};
			};
		};
	...
	function addVillageNamesScript() {
		...
		isAddV = get("build");
		if (!isAddV) isAddV = find('//form[@name="snd" and @action="a2b.php"]', XPFirst);
		iDN = document.getElementsByName("dname");
		if (isAddV && iDN.length > 0) {
			dorfnamen = document.createElement ("script");
	...
	function show2ndVillageList() {
		...
		vL2Tb = create2ndVLtable();
		vL2Coords = getGMcookie("vList2XY", false);
		if (vL2Coords == "false") {
			vL2Coords = defPosFloatDiv;
			setGMcookie("vList2XY", vL2Coords, false);
		};
		vL2XY = vL2Coords.split("|");
		div = createFloatingDiv(VL2minWidth, vL2XY[0], vL2XY[1], T('VILLAGELIST'), "showvl2table", "showvl2table_tooltip", true);
		TB3O.nodeToAppendvL2Tb = div;
		TB3O.nodeToAppendvL2Tb.appendChild(vL2Tb);
		vL2Tb = get("vl2table");
		if (vL2Tb) adjustFloatDiv(vL2Tb, VL2minWidth, "dragDiv_showvl2table");
	};

	function create2ndVLtable() {
		aTb = newTable([['class', "tb3tbnb"], ['id', 'vl2table'], ['style', 'font-size:10pt;']]);
		crtState = getGMcookie("showvl2table_state", false);
		if (crtState == "min") aTb.style.display = 'none';
		strBx = '<span>&#8226</span>';
		strBa = '<span class="c2">&#8226</span>';
		maxRows = Math.ceil(vList.length / 2);
		for (var i = 1; i <= maxRows; i++) {
			aRow = newRow("", [['class', 'tb3rnb']]);
			strBt = strBx;
			if (vList[i - 1].vID == aVillage.vID) strBt = strBa;
			aCell = newCell(strBt + '&nbsp;&nbsp;', [['class', 'tb3cnb'], ['style', 'font-size:10pt; text-align:' + docDir[0] + ';']]);
			aLink = newLink(vList[i - 1].vName, [['href', vList[i - 1].vLink]]);
			aCell.appendChild(aLink);
			aRow.appendChild(aCell);
			bCell = newCell("(" + vList[i - 1].vx + "|" + vList[i - 1].vy + ")", [['class', 'tb3cnb'], ['style', 'font-size:8pt; text-align:' + docDir[0] + ';']]);
			aRow.appendChild(bCell);
			...
			dummyC = newCell('', [['class', 'tb3cnb'], ['width', '10px']]);
			aRow.appendChild(dummyC);
			if (i + maxRows <= vList.length ) {
				strBt = strBx;
				if (vList[i - 1 + maxRows].vID == aVillage.vID) strBt = strBa;
				cCell = newCell(strBt + '&nbsp;&nbsp;', [['class', 'tb3cnb'], ['style', 'font-size:10pt; text-align:' + docDir[0] + ';']]);
				bLink = newLink(vList[i - 1 + maxRows].vName, [['href', vList[i - 1 + maxRows].vLink]]);
				cCell.appendChild(bLink);
				aRow.appendChild(cCell);
				dCell = newCell("(" + vList[i - 1 + maxRows].vx + "|" + vList[i - 1 + maxRows].vy + ")", [['class', 'tb3cnb'], ['style', 'font-size:8pt; text-align:' + docDir[0] + ';']]);
				aRow.appendChild(dCell);
				...
				cCell = newCell("", [['class', 'tb3cnb'], ['colspan', '4']]);
		...
		if (TB3O.crtUserRace != 'false') {
			...
			for (var xi = 0; xi < 8; xi++) {
				if ((TB3O.crtUserRace != 'Gauls' && xi != 4) || (TB3O.crtUserRace == 'Gauls' && xi != 3)) {
					tAv = get("troopsav_" + xi);
					if (tAv || boolShowAll) {
						aInput = newInput([['type', 'checkbox'], ['id', 'faketroop_' + (xi)], ['value', '1']]);
						aCell.appendChild(aInput);
						aImg = newImage([['src', gIcons["u" + (xi + TB3O.deltaRaceImg)]]]);
						if (TB3O.T35 != false) aImg.setAttribute('class', "unit u" + (xi + TB3O.deltaRaceImg));
	...
	function selectAllTroops() {
		iField = find("//input[@name='t1' and not (@type='hidden')]", XPFirst);
		if (iField == null) return;
		//add EventListener to all input fields
		for (var i = 1; i < 12; i++) {
			troopInput = find("//input[@name='t" + i + "']", XPFirst);
			if (troopInput) {
		...
		//original position
		header = find("//div[@id='" + dmid2 + "']//h1", XPFirst);
		...
		for (var i = 0; i < 3; i++) {
			aRow = newRow("", [['class', 'tb3rnb']]);
			aCell = newCell("", [['class', 'tb3cnb'], ['style', 'text-align:' + docDir[0] + '; font-size:8pt;']]);
			//change as suggested by Acr111
			//if (i == 0) aCell.setAttribute("colspan", "3");
			aLink = newLink(arrSelect[i][0], [['href', jsVoid]]);
			aLink.addEventListener("click", arrSelect[i][1], true);
			aCell.appendChild(aLink);
			aRow.appendChild(aCell);
			if (i == 0) {
				bCell = newCell("", [['colspan', '2']]);
				aRow.appendChild(bCell);
			};
			if (i == 1){
				//insert no of fakes cell
				bCell = newCell("");
				scoutInput = newInput([['type', 'text'], ['id', 'selectscoutnumber'], ['style', 'width:30px; font-size:8pt']]);
				noOfScouts = getGMcookie("noofscouts", false);
				if (noOfScouts == "false") {
				...
				//cCell = newCell("&nbsp;<input type='checkbox' id='savescoutnumber' value='1'></input>&nbsp;" + T('SAVE'));
				//aRow.appendChild(cCell);
			};
			if (i == 2) {
		...
		troopTable = get("troops");
		if (!troopTable) {
			troopTable = find("//table[@class='troops']", XPFirst);
			if (!troopTable) {
				troopTable = find("//table[@class='dashed']", XPFirst);
				if (!troopTable) {
					get("troops");
					if (!troopTable) troopTable = find("//table[@class='f10']", XPFirst);
				};
			};
		};
		
		//fix for unusual icons appearing under the list of villages - fr3nchlover
		tags7 = find("//div[@id='" + dmid2 + "']//td[@class='s7']", XPFirst);
		if ((TB3O.T35 == false && troopTable != null && !tags7) || (TB3O.T35 == true && troopTable != null)) {
			//add the "clear all" button
			aRow = newRow("");
			delCell = newCell("", [['colspan', '12'], ['style', 'text-align:center']]);
			clAllLink = newLink("<img src='" + image["buttonDel"] + "' title='" + T('MTCLEARALL') + "' alt='" + T('MTCLEARALL') + "'>");
			...
			if (TB3O.T35 == false) parX = find("//table[@class='p1']", XPFirst); else parX = troopTable;
			if (parX) {
				attdefTable = newTable([['class', 'tb3tb']]);
				hRow = newRow("", [['class', 'tb3r']]);
				hCell = newCell(T('STATISTICS') + " (* = " + T('MIN') + ")", [['colspan', '4'], ['style', 'text-align:center; font-weight:bold;'], ['class', 'tb3ch']]);
				hRow.appendChild(hCell);
				attdefTable.appendChild(hRow);

				//add the total attack, def_i and def_c power for the selected troops
				bRow = newRow("", [['style', 'text-align:' + docDir[0] + ';']]);

				aCell = newCell(gIcons["att_all"] + " *", [['id', "troopsattpower"], ['width', "33,3%"]]);
				bCell = newCell(gIcons["def_i"] + " *", [['id', "troopsdefipower"], ['colspan', "2"], ['width', "33,3%"]]);
				cCell = newCell(gIcons["def_c"] + " *", [['id', "troopsdefcpower"], ['width', "33,3%"]]);
				...
				//total capacity
				dCell = newCell(gIcons["capacity"], [['id', 'troopscapacity'], ['style', 'text-align:' + docDir[0] + ';'], ['colspan', "2"], ['width', '50%']]);

				//crop consumption
				eCell = newCell(gIcons["r5"], [['id', 'troopscropconsumption'], ['style', 'text-align:' + docDir[0] + ';'], ['colspan', "2"], ['width', '50%']]);
		...
		function updateTroopsPower() {
			...
			for (var i = 1; i < 11; i++) {
				...
				if (tInput) {
					...
					tType = getTroopIndexTitleFromImage(tImg)[0];
					if (tInput.value != "") {
		...
		function getScout() {
			...
			rbAction = find("//input[@value='4' and @name='c']", XPFirst);
			if (rbAction) rbAction.checked = true;

			troopsForm = document.forms.namedItem("snd");
			maxScout = find("//a[contains(@onclick, '" + indCol + "')]", XPFirst);
			if (maxScout) {
				...
				if (inputName != 't9' && inputName != 't10') {
					...
					iNoOfScouts = get('selectscoutnumber');
					...
					//scoutSave = get('savescoutnumber');
					//if (scoutSave && scoutSave.checked == true) setGMcookie("noofscouts", scoutInput.value, false);
					if (scoutInput.value != "" && parseInt(scoutInput.value) > 0) setGMcookie("noofscouts", scoutInput.value, false);
					updateTroopsPower();
				};
		...
		function getFakeUnitV2() {
			...
			rbAction = find("//input[@value='3' and @name='c']", XPFirst);
			if (rbAction) rbAction.checked = true;
			...
			if (nodeUnits.snapshotLength > 1) {
				...
				for (var xi = 1; xi < 9; xi++) {
					faketroopselected = get("faketroop_" + xi);
					if (faketroopselected && faketroopselected.checked) {
						faketroopavailable = get('troopsav_' + xi);
				...
				if (chk == false) {
					...
					tTroop = 2;
					faketroopavailable = get('troopsav_2');
	...
	function addAttDefInfoTable1() {
		tTable = find("//div[@id='troop_village']//table", XPFirst);
		if (!tTable) tTable = find("//div[@id='ltrm']/table | //div[@id='map_details']/table[@id='troops']", XPFirst);
		if (!tTable) return;
		...
		if (bS == true) {
			tDiv.innerHTML += " ";
			iImg = newImage([['src', image["info"]], ['style', 'width:16px; height:16px;']]);
	...
	function getTroopsAttDefInfoTable(tNTroops, bMap, bMin) {
		...
		for (var i = 0; i < tNTroops.rows.length; i++) {
			...
			if (aImg && aImg.src) {
				index = getTroopIndexTitleFromImage(aImg)[0];
	...
	function addTroopTimes() {
		...
		if (TB3O.xCrt != -1000 && TB3O.yCrt != -1000 && TB3O.boolShowDistTimes == "1") {
			lastRowActions = get('options');
			if (!lastRowActions) {
				idType = '@id';
				if (TB3O.T35 == false) idType = '@class';
				lastRowActions = find("//div[" + idType + "='map_details_actions']", XPFirst);
			};
			if (lastRowActions) {
				createTimeTroopTable(lastRowActions, TB3O.xCrt, TB3O.yCrt, true);
				imgOasis = find("//img[starts-with(@class, 'w')]", XPFirst);
				if (!imgOasis) {
					imgOasis = find("//img[starts-with(@id, 'w')]", XPFirst);
					if (!imgOasis) imgOasis = get("resfeld");
				};
				if (imgOasis) {
					...
					if (tNTroopsS) {
						...
						if (tNInfo != '') {
							if (tNTroops.id && tNTroops.id == 'troop_info') {
								...
								tNInfoT = newTable([['class', 'b'], ['style', 'width:100px; border:0px none white']]);
	...
	function showFieldInfoInTooltip(vID, fieldtype, animalsTable) {
		...
		if (fieldtype != 0) {
			...
			//an oasis
			ttHTML = getTroopsAttDefInfoTable(animalsTable, true);
			tDisplay = "block";
	...
	function showCellInfo(pos, aType) {
		...
		mcDiv = get('map_info_' + pos);
		if (mcDiv) {
			if (aType < 13) {
				itext = ['', '&nbsp;9', gIcons["r3"], '&nbsp;6', gIcons["r2"], gIcons["r1"], '15', '&nbsp;7', '&nbsp;7', '&nbsp;7', gIcons["r2"], gIcons["r3"], gIcons["r1"]];
	...
	function processMapCell(t, mev, crtPos) {
		...
		if (TB3O.T35 == false) {
			aField = ansdoc.evaluate("//img[@id='resfeld']", ans, null, XPFirst, null).singleNodeValue;
			if (aField) aField = aField.src.search(/\/w(\d+)\.jpg$/); else aField = ansdoc.evaluate("//img[starts-with(@id, 'w')]", ans, null, XPFirst, null).singleNodeValue;

			if (aField) {
				//this is an oasis
				if (crtPos) {
					animalsTable = ansdoc.evaluate("//table[@class='f10']", ans, null, XPFirst, null).singleNodeValue;
			...
			imgID = ansdoc.evaluate("//img[starts-with(@id, 'f')]", ans, null, XPFirst, null).singleNodeValue;
			...
			if (imgID) {
				...
				if (crtPos) {
					...
					if (imgID) {
						animalsTable = ansdoc.evaluate("//div[@id='map_details_troops']//table", ans, null, XPFirst, null).singleNodeValue;
						if (animalsTable) {
	...
	function getTroopMerchantTooltipHTML(vID, aColor, addCoords, addMTime, addTTime, boolAllRaces) {
		iHTML = "";
		xy = id2xy(vID);
		qDist = getDistance(xy[0], xy[1], aVillage.vx, aVillage.vy);
		//add the distance row
		if (aColor == undefined) aColor = 'black';
		strDist = '';

		aRow = newRow("", [['class', 'tb3rnb']]);
		aCell = newCell("", [['class', 'tb3cnb'], ["style", 'font-size:8pt; color:' + aColor + "; text-align:" + docDir[0] +";"]]);
		imgDist = newImage([['src', image["dist" + docDir[0].substr(0,1)]]]);
		aCell.appendChild(imgDist);
		aRow.appendChild(aCell);

		if (qDist != 0) {
			strDist = qDist.toFixed(2);
			bCell = newCell(strDist, [['class', 'tb3cnb'], ["style", 'font-size:8pt; color:' + aColor + "; text-align:" + docDir[1] +";"]]);
			aRow.appendChild(bCell);
			...
			if (strDist != "") {
				...
				cCell = newCell(strDist, [['class', 'tb3cnb'], ["style", 'font-size:8pt; color:' + aColor + "; text-align:" + docDir[1] +";"], ['colspan', intCols]]);
		...
		if (TB3O.crtUserRace != "false" && qDist != 0) {
			...
			clockCell = "<td class='tb3cnb' " + aColspan + aAlign + gIcons["clock"] + "</td> ";
			if (addTTime == true) {
				//add the clock row
			...
			if (addMTime == true) {
				...
				aTime = getMTime(qDist, TB3O.crtUserRace);
				aMalign = docDir[1];
			...
			if (addTTime == true) {
				...
				for (var iTT = 0; iTT < 10; iTT++) {
					imgNo = iTT + arX[3];
					imgName = "src='" + gIcons["u" + imgNo] + "'";
					if (TB3O.T35 != false) imgName = 'class="unit u' + imgNo + '" src="' + xGIF + '"';
					aTime = getTTime(iTT, TB3O.crtUserRace, arX);
					iHTML += "<tr class='tb3rnb'><td class='tb3cnb' ><img " + imgName + "></td><td class='tb3cnb' style='font-size:8pt; text-align:" + docDir[1] + ";'>" + "&nbsp;" + formatTime(aTime, 0) + " h</td>" + strDist;
					if (boolAllRaces) {
						imgNo = iTT + arY[3];
						imgName = "src='" + gIcons["u" + imgNo] + "'";
						if (TB3O.T35 != false) imgName = 'class="unit u' + imgNo + '" src="' + xGIF + '"';
						aTime = getTTime(iTT, arrRaces[0], arY);
						iHTML += "<td class='tb3cnb' ><img " + imgName + "></td><td class='tb3cnb' style='font-size:8pt; text-align:" + docDir[1] +";'>" + "&nbsp;" + formatTime(aTime, 0) + " h</td><td>&nbsp;&nbsp;&nbsp</td>";

						imgNo = iTT + arZ[3];
						imgName = "src='" + gIcons["u" + imgNo] + "'";
						if (TB3O.T35 != false) imgName = 'class="unit u' + imgNo + '" src="' + xGIF + '"';
						aTime = getTTime(iTT, arrRaces[1], arZ);
						iHTML += "<td class='tb3cnb' ><img " + imgName + "></td><td class='tb3cnb' style='font-size:8pt; text-align:" + docDir[1] + ";'>" + "&nbsp;" + formatTime(aTime, 0) + " h</td>";
					};
					iHTML += "</tr>";
				};
			};
	...
	function updateTooltip(e){
		...
		x = (e.pageX + 8);
		y = (e.pageY + 8);
		divHeight = ttDiv.clientHeight;
		divWidth = ttDiv.clientWidth;
	...
	function createTooltip() {
		ttDiv = newDiv("", [["id", "tb_tooltip"], ["style", "position:absolute; display:block; padding:2px; z-index:900; border:1px solid #00C000; background-color:#FEFFE3; display:none;"]]);
	...
	function mapFunctions() {
		...
		allArrows = find("//area[starts-with(@id, 'ma_n')]", XPList);
		...
		if (!get("tb_tooltip")) createTooltip();
		mapcontent = get('map_content');
		areas = find("//map//area[@shape='poly' and (@coords)]", XPList, mapcontent);
		...
		function addMapScanLink() {
			...
			if (TB3O.boolShowCellTypeInfo == '1' && TB3O.T35 == false) {
				...
				b = find("//form[@method='post']", XPFirst).parentNode;
				ctable = newTable([["id", "map_opts"]]);
				ctbody = document.createElement("TBODY");
				mapScanA = newLink(T('MAPSCAN'), [['id', 'mapscan'], ['href', jsVoid]]);
		...
		function genMapTable(){
			...
			var aTb = newTable([["id", "mapTable"], ["sortCol", -1], ["class", "tb3tb"]]);
	...
	function marketSell(){
		...
		var aX = find("//input[@type='image' and @name='s1']", XPFirst);
		aX.addEventListener("click", function(){
			saveofferoption = get('saveofferoption');
			saveofferglobal = get('saveofferglobal');
			bSaveOf = true;
			bSaveOfG = true;
			...
			if (bSaveOf == true) {
				...
				if (bSaveOfG == false) values[7] = aVillage.vID;
		...
		if (ventas.length > 0){
			aTb = newTable([["id", "ventas"], ["class", "tb3tb"]]);

			tr = newRow("", [["class", "rbg"]]);
			aTbHeader = [T('OFREZCO'), T('BUSCO'), T('MAXTIME'), T('ALLIANCE'), T('SELL'), T('ELIMINAR')];
			for (var i = 0; i < aTbHeader.length; i++) tr.appendChild(newCell(aTbHeader[i]));
			aTb.appendChild(tr);

			for (var i = 0; i < ventas.length; i++){
				tr = newRow("");
				tr.appendChild(newCell(gIcons["r" + (ventas[i][2])] + ' ' + ventas[i][0]));
				tr.appendChild(newCell(gIcons["r" + (ventas[i][3])] + ' ' + ventas[i][1]));
				tr.appendChild(newCell(ventas[i][5] == '1' ? ventas[i][4] : T('NO')));
				tr.appendChild(newCell(ventas[i][6] == '1' ? T('YES') : T('NO')));
				tr.appendChild(newCell('<a href=' + jsVoid + ' onClick = "sell.m1.value=' + ventas[i][0] + '; sell.m2.value=' + ventas[i][1] + '; sell.rid1.value=' + ventas[i][2] + '; sell.rid2.value=' + ventas[i][3] + '; sell.d2.value=' + ventas[i][4] + '; sell.d1.checked=' + (ventas[i][5] == '1') + '; sell.ally.checked=' + (ventas[i][6] == '1') + '; sell.submit();"><img src="' + image["buttonOK"] + '" title="' + T('SELL') + '" alt="' + T('SELL') + '"></a>'));
				aTb.appendChild(tr);

				aLink = newLink("", [['href', jsVoid]]);
				aLink.appendChild(newImage([['src', gIcons["del"]], ['style', 'width:12px; height:12px; border:0px none white; cursor:pointer'], ['title', T('ELIMINAR')]]));
				aLink.addEventListener("click", removeGMcookieValue("ventas", ventas[i][8] , true, marketSell, false), 0);
				td = newCell("");
				td.appendChild(aLink);
				tr.appendChild(td);;
			};
	...
	function getdorf3SelectedVinfo(ansdoc, ans) {
		...
		try {
			if (TB3O.T35 == false) {
				avLink = ansdoc.evaluate("//a[@class='active_vl']", ans, null, XPFirst, null).singleNodeValue;
				newdid = getNewdidFromLink(avLink.href);
				aX = ansdoc.evaluate('//a[@class="active_vl"]/../../td/table/tbody/tr/td', ans, null, XPFirst, null).singleNodeValue;
				if (aX) {
					X = parseInt(aX.innerHTML.replace("(", ""));
					aY = ansdoc.evaluate('//a[@class="active_vl"]/../../td/table/tbody/tr/td[3]', ans, null, XPFirst, null).singleNodeValue;
					if (aY) {
				...
				if (TB3O.M35 == 2) {
					aV = ansdoc.evaluate("//td[@class='dot hl']", ans, null, XPFirst, null).singleNodeValue;
					var tr = aV.parentNode;
					if (tr.cells.length > 3) {
					...
					aV = ansdoc.evaluate("//div[@id='vlist']//table[@class='vlist']//tr[@class='sel']//a", ans, null, XPFirst, null).singleNodeValue;
			...
			if (TB3O.VillageRes[vList[i].vID]) {
				for (var yi = 6; yi < 10; yi++) {
					...
					if (aCell) {
						...
						addAttr(aCell, [['style', 'background-color:' + bgC + '; font-size:8pt; text-align:' + docDir[1] + '; color:' + txC + '; ']]);
					};
				};
	...
	function processVillage43(t){
		...
		var a = ansdoc.evaluate("//td[@width='25%']//span[@id='timer1'] | //table[@class='under_progress']//span[@id='timer1']", ans, null, XPFirst, null).singleNodeValue;
		if (a) {
	...
	function processVillage44(t) {
		...
		if (villageID != 0) {
			...
			var allTables = ansdoc.evaluate("//div[@id='" + dmid2 + "']//table[@class='troop_details']//a[contains(@href, " + villageID + ")]/../../../..|//div[@id='" + dmid2 + "']/p[@class='b f16'] | //div[@id='" + dmid2 + "']//p[@class='info']", ans, null, XPathResult.ORDERED_NODE_SNAPSHOT_TYPE, null);
			if (allTables) {
				var aCell = get('aldea' + newdid + '_4_4');
				aCell.innerHTML = "";
				var aValue;
	...
	function processVillage45(t){
		...
		if (lvl != 0) {
			...
			//cpbuilding = TB3O.specBuildings[0];
		};
	...
	function createDorf35Table(newPar, topRowText, secRowText) {
		removeDorf3Table();
		var aTb = newTable([['id', 'dorf3table']]);
		...
		for (xi = 0; xi < 10; xi++) {
			...
			if (TB3O.crtUserRace != "false") {
				var imgName = 'class="unit u' + (xi + TB3O.deltaRaceImg) + '" src="' + xGIF + '"';
				if (TB3O.T35 == false) imgName = "src='" + gIcons["u" + (xi + TB3O.deltaRaceImg)] + "'";
	...
	function createDorf31Table(newPar, topRowText, secRowText, merchant) {
		removeDorf3Table();
		aTb = newTable([['id', 'dorf3table']]);
		trTop = newRow("", [["class", "tb3rhb"]]);
		updAllCell = createUpdAllCell(1);
		trTop.appendChild(updAllCell);
		tdTop = newCell(topRowText[0], [['class', 'tb3chnb'], ['colspan', '4'], ['style', ['font-weight:bold;']]]);
		trTop.appendChild(tdTop);
		aTb.appendChild(trTop);
		if (secRowText) {
			trTop2 = newRow("", [['class', 'tb3rh']]);
			for (xi = 0; xi < secRowText.length; xi++){
				tdTop2 = newCell(secRowText[xi], [['class', 'tb3chnb']]);
				if (xi == 3) {
					aS = 'd3Upd_1_3';
	...
	function createUpdAllCell(xi) {
		tdUA = newCell("", [['class', 'tb3chnb']]);
		if (xi == 4) {
			uAL = newLink(gIcons["reload_v"], [['href', jsVoid]]);
	...
	function createDorf3Checkbox() {
		return newInput([['type', 'checkbox'], ['value', '1'], ['checked', 'true']]);
	};

	function sumRowDorf3(pNode, maxTD, tabNo, merchant) {
		//Separator row
		trSeparator = newRow("", [['class', 'tb3r']]);
		trSeparator.appendChild(newCell("", [['class', 'tb3rnb'], ["colspan", "" + (maxTD + 1)]]));
		pNode.appendChild(trSeparator);

		//sum row
		trSum = newRow("", [['class', 'tb3r']]);
		//first sum cell
		ts1 = newCell(T('TOTAL'), [['class', 'tb3cnb'], ['style', 'font-weight:bold']]);
	...
	function updD3Bullets(newdid, intVal) {
		var aE = get('aldea' + newdid + '_boton');
		if (TB3O.T35 == false) aE.src = gIcons["b" + intVal]; else aE.className = "online" + intVal;
	};
	...
	function rowsDorf3(pNode, maxTD, tabNo, merchant) {
		for (var i = 0; i < vList.length; i++){
			...
			var nobr = elem("NOBR", "");
			if (tabNo == 4) {
				var aLink = newLink("<img class='online5' src='" + gIcons["b5"] + "' title='" + T('ACTUALIZAR') + " (" + vList[i].vName + "-" + vList[i].vNewdid + ")' id='aldea" + vList[i].vNewdid + "_boton'>", [['href', jsVoid]]);
	...
	function processDorf3() {
		var origParTop = find("//div[@id='" + dmid2 + "']//p | //div[@id='" + dmid2 + "']//*[@id='textmenu'] | //div[@id='" + dmid2 + "']//*[@class='txt_menue']", XPFirst);
		if (TB3O.plusAcc == true) {
			origParTop.innerHTML += ' | <a href="dorf3.php?s=6">' + T('ATTABLES') + '</a>';
			return;
		};

		var origT = find("//div[@id='" + dmid2 + "']//table[@id='overview'] | //div[@id='" + dmid2 + "']//table[@class='tbg']", XPFirst);
	...
	function showDeleteAccount(){
		var aP = find("//*[@class='deltimer'] | //p[parent::div[@id='" + dleft + "'] and @style]", XPFirst);
		if (aP) {
			moveElement(aP, document.body);
			addAttr(aP, [['class', 'delacc']]);
		};
	};
	...
	function marketSellMinMax() {
		var aX = find("//a[@class='selected' and contains(@href, '&t=2')] | //input[@name='d2'] | //input[@class='fm fm25']", XPFirst);
		if (!aX) return;
		maxRes = crtResUnits[0];
		minRes = crtResUnits[0];
		indexMaxRes = 0;
		indexMinRes = 0;
		pS = get('saveofferoption');
		...
		if (!pS) {
			...
			if (aTb) {
				...
				for (var i = 0; i < maxCells; i++) {sRow.appendChild(newCell(""));};
		...
		merchantsPar = find("//form//p | //form//p[@class='f10']", XPFirst);
		if (merchantsPar) {
		...
		rxI = find("//input[@class='text' and @name='m1'] | //input[@class='fm' and @name='m1']", XPFirst);
		if (rxI) rxI.addEventListener('keyup', function() {mhRowUpdate3(avMerchants);}, false);
		rxType = find("//select[@class='dropdown' and @name='rid1'] | //select[@class='fm' and @name='rid1']", XPFirst);
		if (rxType) rxType.addEventListener('change', function() {mhRowUpdate3(avMerchants);}, false);

		function mhRowUpdate3(maxM) {
			totalTransport = 0;
			maxC = parseInt(merchantsCapacity);
			...
			if (!mhCell) {
				mhRow = newRow("");
				mhRow.appendChild(newCell(mhText, [["id", "mhMerchants"], ["style", 'font-size:11px; color:' + mhColor + '; line-height:16px;'], ["colspan", '8']]));
	...
	function showHeroStatus() {
		hmLink = find("//div[@id='" + dmid2 + "']//a[contains(@href, '&rename')]", XPFirst);
		if (!hmLink) return;
		...
		xRow = newRow('', [['style', 'background-color:white']]);
		hCell = newCell("", [['colSpan', '5'], ['style', 'padding:1px 2px 1px 1px; margin:0px;']]);

		hTable = newTable([['class', 'tb3tb'], ['width', '100%'], ['style', 'border:1px solid silver;']]);
		aRow = newRow('');
		aCell = newCell(strLevel + " " + hLevel, [['class', 'tb3cbt']]);
		bCell = newCell("" + hPercent + "%", [['class', 'tb3cbt']]);
		cCell = newCell("" + (100 - hPercent) + "%", [['class', 'tb3cbt']]);
		dCell = newCell(strLevel + " " + (hLevel + 1), [['class', 'tb3cbt']]);
		aRow.appendChild(aCell);
		aRow.appendChild(bCell);
		aRow.appendChild(cCell);
		aRow.appendChild(dCell);
		...
		bRow = newRow('');
		a1Cell = newCell('', [['width', '100px'], ['class', 'tb3cbt']]);
		bRow.appendChild(a1Cell);
		b1Cell = newCell('', [['colSpan', 2], ['style', 'padding:2px 2px 1px 2px; border:0px medium none; margin:0px;']]);
		bRow.appendChild(b1Cell);

		graphBar = newTable([['style', 'height:16px; width:100%; margin:0px; border:0px medium none; border-collapse:collapse;']]);

		rX = newRow('', [['style', 'border:0px medium none; padding:0px; margin:0px;']]);

		x1Cell = newCell('', [['style', 'width: ' + hPercent + '%; background-color: blue; padding:0px; border:0px medium none; margin:0px;']]);
		x2Cell = newCell('', [['style', 'width: ' + (100 - hPercent) + '%; background-color: lightgrey; padding:0px; border:0px medium none; margin:0px']]);
		...
		c1Cell = newCell('', [['colSpan', 2], ['class','tb3cbt']]);
		bRow.appendChild(c1Cell);

		cRow = newRow('');
		a2Cell = newCell(crtLevelExp, [['class', 'tb3cbt']]);
		cRow.appendChild(a2Cell);
		b2Cell = newCell(expGainedCrtLevel, [['title', "" + crtLevelExp + " + " + expGainedCrtLevel + " = " + (crtLevelExp + expGainedCrtLevel)], ['class', 'tb3cbt']]);
		cRow.appendChild(b2Cell);
		c2Cell = newCell(expToLevelUp, [['class', 'tb3cbt']]);
		cRow.appendChild(c2Cell);
		d2Cell = newCell(nextLevelExp, [['class', 'tb3cbt']]);
	...
	function NPCUpdate() {
		...
		xpNeeded = xpathResultEvaluate("//*[@id='npcXX_1']");
		...
		if (xpNeeded.snapshotLength == 0) xpNeeded = xpathResultEvaluate('//*[starts-with(@id,"NPCTT")]');
		if (xpNeeded.snapshotLength != 0) NPCAssistant(2, xpNeeded, arrTrain);
	};
	
	
	function setTroopsNPC() {
		var aX = find('//div[@id="' + dmid2 + '"]//table[@class="build_details"]//td[@class="desc"]', XPList);
		for (var i = 0; i < aX.snapshotLength; i++) {
			var tdX = aX.snapshotItem(i);
			addAttr(tdX, [['id', 'NPCTT_' + (i + 1)]]);
			getRequiredRes(tdX);
		};
	};
	...
	function getRequiredRes(td) {
		...
		if (iktC != -1) {
			if (intC != -1 && intC > iktC + 1) {
				tC = strTC.substring(iktC + 1, intC);// - 1);
			} else if (intC != -1) {
			...
			tC = strTC.replace(/[a-zA-Z]/g, "");
			fiI = tC.search(/(\d+)/);
			if (fiI > 0) tC = strTC.substring(fiI);
		};
		dX = tC.split(":");
		...
		if (td.id.indexOf("NPCTT_") != -1) {
			...
			var aTtT = new xTtT(getTroopIndexTitleFromImage(aImg)[0], necRes, strTime, arX);
			td.id.search(/(\d)/);
			var index = RegExp.$1;
			arrTtT[index - 1] = aTtT;
	...
	function NPCAssistant(typeNPC, xpNeeded, arrTrain) {
		...
		for (var i = 0; i < xpNeeded.snapshotLength; i++) {
			...
			if (arrTrain) {
				...
				aLink = newLink(maxY, [['href', jsVoid]]);
	...
	function getBootyCellInfo(booty) {
		iHTML = '';
		for (var i = 0; i < 4; i++) {iHTML += gIcons["r" + (i + 1)] + booty[i] + (i < 3 ? ' + ' : ' = ' + booty[4]);};
		return iHTML;
	};
	...
	function getRaceM2(aRow) {
		...
		if (aValue && aValue.length > 0) setRace(getTroopIndexTitleFromImage(aValue[0])[0]);
		getDisplayRace();
		return TB3O.crtUserRace;
	};
	...
	function tableTotalVillageTroopsV3() {
		if (aVillage.vID != "") {
			...
			allTables = xpathResultEvaluate("//div[@id='" + dmid2 + "']//table[@class='troop_details']//a[contains(@href, " + aVillage.vID + ")]/../../../..|//div[@id='" + dmid2 + "']/p[@class='b f16'] | //div[@id='" + dmid2 + "']//p[@class='info']");
			...
			if (allTables.snapshotLength > 0) {
				...
				hdtLevel = 0;
				if (TB3O.specBuildings.length > 8) TB3O.specBuildings[8];
				...
				if (TB3O.crtUserRace == "false" || TB3O.dispUserRace == "false") getRaceM2(rowTrIcons);
				rowTrUnits = tTable.rows[2];
				if (tTable.rows.length == 4) {
					rowCc = tTable.rows[3];
					rowB = newRow("");
					b1Cell = newCell('<img src="' + image["capacity"] + '">', [['style', 'text-align:center;']]);
					strColspan = rowCc.cells[1].colSpan;
					b2Cell = newCell("0", [['colspan', strColspan], ['id','tb3bountycell']]);
				...
				for (var i = firstVillageTable + 1; i < allTables.snapshotLength; i++) {
					...
					if (aTb.rows[0].cells[0].textContent.indexOf(aVillage.vName) != -1) {
				...
				for (var j = 1; j < rowTrUnits.cells.length; j++) {
					...
					switch (j) {
						...
						default:
							...
							if (tImg[0]) {
								tType = getTroopIndexTitleFromImage(tImg[0])[0];
				...
				if (TB3O.T35 == false) {
					p = xpathResultEvaluate("//div[@id='" + dmid2 + "']/p[@class='txt_menue']").snapshotItem(0);
				} else {
					menu = xpathResultEvaluate("//div[@id='" + dmid2 + "']/p/a");
	...
	function diplayElements(aType) {
		uTable = get('upgTable');
		mapTable = get('mapTable');
		trooptimetable = get('trooptimetable');
		if (uTable) {
	...
	function allyCalculation() {
		if (crtPage.match(/allianz.php\?aid/)) {
			allyTable = find("//div[@id='" + dmid2 + "']//table | //div[@id='" + dmid2 + "']//table[@class='tbg']", XPFirst);
			if (allyTable) {
				iHTML = allyTable.rows[0].cells[0].innerHTML;
				if (TB3O.M35 == 2) {
					tbd = find("//td[@class='details']//table", XPFirst);
		...
		aTb = get("member");
		if (!aTb) {
			a = find("//div[@id='" + dmid2 + "']//table[@class='tbg']//td[@width='6%']", XPFirst);
		...
		if (aTb) {
			...
			popPerPlayer = Math.round(totalPop/(aTb.rows.length - 1));
			boolIsMyAlly = aTb.rows[1].cells.length == 5;

			rowTotal = newRow("", [['class', 'tb3r']]);
			aTb.appendChild(rowTotal);
			aCell = newCell(T('TOTAL'), [['class', 'tb3chnb'], ["colspan", "2"]]);
			rowTotal.appendChild(aCell);
			bCell = newCell(totalPop, [['class', 'tb3chnb'], ['style', 'text-align:center']]);
			rowTotal.appendChild(bCell);
			cCell = newCell(totalVil, [['class', 'tb3chnb'], ['style', 'text-align:center']]);
			...
			rowAv = newRow("", [['class', 'tb3r']]);
			aTb.appendChild(rowAv);
			dCell = newCell(T('AVPOPPERPLAYER'), [['class', 'tb3chnb'], ["colspan", "2"]]);
			rowAv.appendChild(dCell);
			eCell = newCell(popPerPlayer, [['class', 'tb3chnb'], ["colspan", "2"], ['style', 'text-align:center']]);
			rowAv.appendChild(eCell);
			if (boolIsMyAlly) rowAv.appendChild(newCell("", [['class', 'tb3chnb']]));

			//average population per village
			rowAv = newRow("", [['class', 'tb3r']]);
			aTb.appendChild(rowAv);
			dCell = newCell(T('AVPOPPERVIL'), [['class', 'tb3chnb'], ["colspan", "2"]]);
			rowAv.appendChild(dCell);
			eCell = newCell(Math.round(totalPop/totalVil), [['class', 'tb3chnb'], ["colspan", "2"], ['style', 'text-align:center']]);
			rowAv.appendChild(eCell);
			if (boolIsMyAlly) rowAv.appendChild(newCell("", [['class', 'tb3chnb']]));

			//number of bullets by type
			if (boolMyAlly) {
				rowBullets = newRow("", [['class', 'tb3r']]);
				cellBullets = newCell("", [['class', 'tb3chnb'], ['colspan', '5'], ['style', 'text-align:center']]);
				cBiHTML = "";
				addSpacer = " | ";
				for (var j = 0; j < 5; j++) {
					if (totalBullets[j][0] > 0) cBiHTML += "<img class='online" + (j + 1) + "' src='" + gIcons["b" + (j+1)] + "' title='" + totalBullets[j][1] + "' alt='" + totalBullets[j][1] + "'> = &nbsp;" + totalBullets[j][0] + addSpacer + " ";
				};
	...
	function isThisTheCapital() {
		xyCap = getGMcookie("capitalxy", false);
		valReturn = true;
		if (xyCap != "false") {
			capXY = xyCap.replace("(", "").replace(")", "").split("|");
			cID = xy2id(capXY[0], capXY[1]);
			if (cID != aVillage.vID) valReturn = false;
		};
		return valReturn;
	};

	function adjustTtT() {
		var aTb = find("//table[@class='build_details']", XPFirst);
		if (aTb) {
			aTb.rows[0].appendChild(newCell(gIcons["clock"] + " & " + gIcons["r5"]));
			for (var xi = 1; xi < aTb.rows.length; xi++) aTb.rows[xi].appendChild(newCell("", [['id', 'TtT_' + xi]]));
			aTb.id = "selecttraintroops";
		};
	};
	
	function adjustTiT() {
		var titTb = find("//table[starts-with(@class, 'under')]", XPFirst);
		if (titTb) {
			var csp = titTb.rows[titTb.rows.length - 1].cells[0].getAttribute("colspan");
			log(3, "csp = " + csp);
			var aCell = newCell(T('TOTALTROOPSTRAINING') + " & " + gIcons["r5"], [['class', 'tb3chnb'], ["colspan", csp], ['style', 'text-align:center;']]);
			var aRow = newRow("");
			aRow.appendChild(aCell);
			...
			for (var xi = 1; xi < titTb.rows.length - 2; xi++) {
				...
				var aX = getTroopIndexTitleFromImage(aImg);
				var intNo = parseInt(aInf.textContent.replace(/\n/g, ""));
				//log(3, "aX[0] = " + aX[0] + "; intNo = " + intNo + "; aX[1] = " + aX[1]);
				gata = -1;
			...
			for (var xi = 0; xi < arrTiT.length; xi++) {
				...
				aRow = newRow("", [['class', 'tb3rnb']]);
				if (TB3O.T35 != false) imgName = 'class="unit u' + arrTiT[xi].tType + '" src="' + xGIF + '"'; else imgName = "src='" + gIcons["u" + arrTiT[xi].tType] + "'";
				aRow.appendChild(newCell("<img " + imgName + ">", [['class', 'tb3cnb'], ['style', 'border:0px solid none;']]));
				aRow.appendChild(newCell(arrTiT[xi].strName, [['class', 'tb3cnb'], ['style', 'border:0px solid none;']]));
				aRow.appendChild(newCell(arrTiT[xi].intNo, [['class', 'tb3cnb'], ['style', 'text-align:center; border:0px solid none;']]));
				titTb.appendChild(aRow);
			};
			//crop consumption for training troops-matteo466
			var cRow = newRow("", [['class', 'tb3rnb']]);
			cRow.appendChild(newCell(gIcons["r5"] ,[['class', 'tb3cnb'], ["colspan", csp - 1], ['style', 'border:0px solid none;']]));
			cRow.appendChild(newCell(TotCropCons, [['class', 'tb3cnb'], ['style', 'text-align:center; border:0px solid none;']]));
	...
	function isThisTroopTrainingBuilding() {
		var retValue = false;
		var cValue = find("//input[starts-with(@name, 't')]", XPList);// | //input[starts-with(@name,'z')]", XPList);
		if (cValue.snapshotLength > 0) {
			var aValue = find("//div[@id='" + dmid2 + "']//img[starts-with(@class, 'unit')]", XPFirst);
			if (aValue) {
	...
	function calculateResourceTime(need, procWidth) {
		...
		resTable = newTable([['class', 'tb3tbnb'], ['style', 'background-color:white; border-collapse:collapse; width:' + procWidth + '%;']]);
		...
		for (var i = 0; i < 4; i++){
			...
			if (restante > 0) {
				...
				if (tiempo < 0 || capacity[i] - parseInt(need[i]) < 0) {
					maxTime = 'Infinity';
					aCell = newCell(gIcons["r" + (i + 1)], [['class', 'tb3cnb'], ['style', cSt[1]]]);
					bCell = newCell(' ' + restante +' ', [['class', 'tb3cnb'], ['style', cRTstyle], ['id', "timeout" + i]]);
					cCell = newCell(' ' + T('NEVER') + ' ', [['class', 'tb3cnb'], ['width', '220'], ['style', cRTstyle]]);
					boolTb = true;
				} else {
					if (tiempo > maxTime && maxTime !='Infinity') maxTime = tiempo;
					tiempo = formatTime(tiempo + 5, 0);
					aCell = newCell(gIcons["r" + (i + 1)], [['class', 'tb3cnb'], ['style', cSt[0]]]);
					bCell = newCell(' ' + restante +' ', [['class', 'tb3cnb'], ['style', cRTstyle], ['id', "timeout" + i]]);
					cCell = newCell(' ' + tiempo + ' ', [['class', 'tb3cnb'] , ['width', '60'], ['style', cRTstyle], ['id', 'timeouta']]);
					boolTb = true;
				};
				if (boolTb) {
					aRow = newRow("", [['class', 'tb3rnb']]);
		...
		if (maxTime == 'Infinity'){
			xRow = newRow("");
			xRow.appendChild(newCell(T('LISTO'), [['class', 'tb3cnb'], ['style', cVst[0]], ['colspan' ,"2"]]));
			xRow.appendChild(newCell(T('NEVER'), [['class', 'tb3cnb'], ['style', cVst[1]]]));
			...
			xRow.appendChild(newCell(T('LISTO'), [['class', 'tb3cnb'], ['style', cVst[0]], ['colspan', '2']]));
			xRow.appendChild(newCell(txtDate, [['class', 'tb3cnb'], ['style', cVst[1]]]));
			resTable.appendChild(xRow);
		...
		function createCRrows(aTitle, aV) {
			aTb = newTable([['class', 'tb3tbnb']]);
			xRow = newRow("");
			aCell = newCell(aTitle, [['class', 'tb3cnb'], ['style', cVst[0] + "border-top:1px solid silver;"], ['colspan', '3']]);
			xRow.appendChild(aCell);
			aTb.appendChild(xRow);
			for (var i = 0; i < 4; i++) {
				yRow = newRow("");
				bCell = newCell(gIcons["r" + (i + 1)], [['class', 'tb3cnb'], ['style', cVst[0]]]);
				cCell = newCell(aV[i], [['class', 'tb3cnb'], ['style', cVst[1]], ['colspan', '2']]);
	...
	function addTimeToTrainSelectedTroops() {
		var aTb = get("selecttraintroops");
		var arrInputs = find("//*[starts-with(@id, 'inputTroopNo_')]", XPList);
		var arrAddCells = find("//*[starts-with(@id, 'TtT_')]", XPList);
		var tCC = 0;
		var tTtT = 0;
		var sT = 0;
		var gHTML = '';
		for (var i = 0; i < arrInputs.snapshotLength; i++) {
			...
			if (!isNaN(vTtT)) {
				...
				var xaRow = newRow("", [['class', 'tb3rnb']]);
				var xbRow = newRow("", [['class', 'tb3rnb']]);
				var tT = toSeconds(arrTtT[i].tTime) * vTtT;
				tTtT += tT;
				var xaCell = newCell(formatTime(tT, 0), [['class', 'tb3cnb'], ['style', 'font-size:8pt;']]);
				tCC += uc[arrTtT[i].tType][9] * vTtT;
				var xbCell = newCell(gIcons["r5"] + " " + uc[arrTtT[i].tType][9] * vTtT, [['class', 'tb3cnb'], ['style', 'font-size:8pt;']]);
		...
		var aRow = get('aRselecttraintroops');
		if (!aRow) {
			var csp = aTb.rows[0].cells[0].getAttribute("colspan");
			aRow = newRow("", [['id', 'aRselecttraintroops'], ['class', 'tb3r']]);
			var aCell = newCell("", [['id', 'gTtT'], ['class', 'tb3cnb'], ['colspan', csp]]);
			var bCell = newCell(sT, [['id', 'sTtT'], ['class', 'tb3cnb']]);
			var cCell = newCell("", [['class', 'tb3cnb']]);
			var dCell = newCell("", [['id', 'tTtT'], ['class', 'tb3cnb']]);
			aRow.appendChild(aCell);
			aRow.appendChild(bCell);
			aRow.appendChild(cCell);
			aRow.appendChild(dCell);
		...
		//total cell
		var tTb = newTable([['class', 'tb3tbnb']]);
		var taRow = newRow("", [['class', 'tb3rnb']]);
		var tbRow = newRow("", [['class', 'tb3rnb']]);
		var taCell = newCell(formatTime(tTtT, 0), [['class', 'tb3cnb'], ['style', 'font-size:8pt;']]);
		var tbCell = newCell(gIcons["r5"] + " " + tCC, [['class', 'tb3cnb'], ['style', 'font-size:8pt;']]);
	...
	function addPlayerStatistics() {
		...
		if (aTb) {
			...
			aTb.appendChild(rowTotal);
			var aCell = newCell(T('TOTAL'), [['class', 'tb3chnb']]);
			rowTotal.appendChild(aCell);
			var bCell = newCell(totalPop, [['class', 'tb3chnb'], ['style', 'text-align:center;']]);
			rowTotal.appendChild(bCell);
			cCell = newCell("", [['class', 'tb3chnb'], ['colspan', csp]]);
			rowTotal.appendChild(cCell);

			//average population per village
			var rowAv = newRow("", [['class', 'tb3rnb']]);
			aTb.appendChild(rowAv);
			var dCell = newCell(T('AVPOPPERVIL'), [['class', 'tb3chnb']]);
			rowAv.appendChild(dCell);
			var eCell = newCell(Math.round(totalPop/totalVil), [['class', 'tb3chnb'], ['style', 'text-align:center;']]);
			rowAv.appendChild(eCell);
			var fCell = newCell("", [['class', 'tb3chnb'], ['colspan', csp]]);
	...
	function createTroopInfoTooltip(tt, tInfo) {
		return function() {
			...
			if (tInfo[1] != "") {
				aRow1 = newRow("");
				aRow1.appendChild(newCell(tInfo[1], [['style', 'text-align:center; font-size:8pt; font-weight:bold;'], ['colspan', '6']]));
				aTb.appendChild(aRow1);
			};
			aRow2 = newRow("");
			//attack power row
			aRow2.appendChild(newCell(gIcons["att_all"], [['style', cSt1 + cSt4]]));
			aRow2.appendChild(newCell(uc[tInfo[0]][5], [['style', cSt2 + cSt4 + cSt3]]));
			//def power infantry row
			aRow2.appendChild(newCell(gIcons["def_i"], [['style', cSt1 + cSt4]]));
			aRow2.appendChild(newCell(uc[tInfo[0]][6], [['style', cSt2 + cSt4 + cSt3]]));
			//def power cavalry row
			aRow2.appendChild(newCell(gIcons["def_c"], [['style', cSt1 + cSt4]]));
			aRow2.appendChild(newCell(uc[tInfo[0]][7], [['style', cSt2 + cSt4]]));
			...
			aRow3.appendChild(newCell("<img src='" + image[imgSpeed] + "'>", [['style', cSt1]]));
			aRow3.appendChild(newCell(tSpeed, [['style', cSt2 + cSt3]]));
			//can carry
			aRow3.appendChild(newCell(gIcons["capacity"], [['style', cSt1]]));
			aRow3.appendChild(newCell(uc[tInfo[0]][4], [['style', cSt2 + cSt3]]));
			//crop consumption
			aRow3.appendChild(newCell(gIcons["r5"], [['style', cSt1]]));
			aRow3.appendChild(newCell(uc[tInfo[0]][9], [['style', cSt2]]));
		...
		if (!get("s10")) {
			...
			if (sAcolspan) {
				if (sAcolspan == "2") {
					...
					if (TB3O.T35 == false) {
						bCell = newCell(sAcell.innerHTML, [['style', 'text-align:' + docDir[0] + ';']]);
					} else {
						bCell = elem("TH", sAcell.innerHTML);
						addAttr(bCell, [['class', 'buttons']]);
					};
	...
	function createDelRepTable(aLinks) {
		...
		intMax = aLinks.length;
		if (intMax > 5) intMax = 5;
		tRow = newRow("", [['class', 'tb3rh']]);
		tCell = newCell(T('MTCLEARALL'), [['colspan', intMax], ['class', 'tb3chbb'], ['style', cSt]]);
		tRow.appendChild(tCell);
		bRow = newRow("", [['class', 'tb3rh']]);
		cRow = newRow("");
		crtLink = crtPage;
		for (var i = 0; i < intMax; i++) {
			bTitle = aLinks[i].firstChild.nodeValue;
			bCell = newCell(bTitle, [['class', 'tb3chb'], ['style', cSt]]);
			bRow.appendChild(bCell);
			cLink = newLink("", [['href', jsVoid]]);
			cLink.appendChild(newImage([['src', image["buttonDel"]], ['title', bTitle]]));
			cLink.addEventListener('click', delete10Reports(i, aLinks), false);
			cCell = newCell("", [['class', 'tb3c'], ['style', cSt]]);
	...
	function MessageOptions(){
		if (crtPage.indexOf("nachrichten.php") != -1) {
			...
			if (document.evaluate) {
				arrInp = find("//textarea[@id='igm']", XPList);
		...
		topMenu = find("//p[@class='txt_menue']", XPFirst);
		...
		if (document.evaluate) {
			...
			navLinks = find("//div[@id='" + dmid2 + "']//a[contains(@href, 'berichte.php?s=')]", XPList);
		...
		var mrTable;
		mrTable = get("overview");
		if (!mrTable) {
			mrTable = find("//table[@class='reports std'] | //table[@class='tbg']", XPFirst);
			mrTable.id = "overview";
		};
		...
		if (mrpC == "false") {
			...
			if (intMRP > 5) {intMRP = 4; setGMcookie("mesreppreload", 4, false);};
		};
		...
		if (intMRP > 1) {
			...
			if (tdbfLinks) {
				...
				} else var aSpan = newLink("« ", [['style', 'font-weigth:bold'], ['href', genLink + X1 + addLink]]);
				var fwLink = newLink("»&nbsp;", [['style', 'font-weight:bold'], ['href', genLink + X2 + addLink]]);
				tdbfLinks.innerHTML = "";
				tdbfLinks.appendChild(aSpan);
				tdbfLinks.appendChild(fwLink);
			};
		...
		function processMrPage(t) {
			...
			var aTb = ansdoc.evaluate("//table[@id='overview'] | //table[@class='reports std'] | //table[@class='tbg']", ans, null, XPFirst, null).singleNodeValue;
			if (aTb) {
					...
					for (var xi = 1; xi < maxRows - 1; xi++) {
						...
						if (intNoOfCells > 1) {
							for (var yi = 0; yi < intNoOfCells; yi++) {
								...
								if (TB3O.bMO == "1" && (iHTML.indexOf("nachrichten.php?id=") != -1 || iHTML.indexOf("berichte.php?id=") != -1)) addReadMesRepInPopup(xCell.childNodes[0]);
								if (yi == 1) {
	...
	function deleteReports() {
		boolDeleteReports = getGMcookie("reportsDeleteAll", false);
		if (boolDeleteReports != '1') return;
		if (getGMcookie("reportsPageToDelete", false) == '') return;
		if (crtPage.indexOf("berichte.php") != -1) {
			pauseScript(500);
			allCB = find("//input[@type='checkbox' and not (@id)]", XPList);
			selectAllCB = document.getElementsByName("s10");
			delButton = document.getElementsByName("del");
	...
	function getStatisticsMenu() {
		...
		var tM = find("//div[@id='" + dmid2 + "']//p//a | //div[@id='" + dmid2 + "']//div[@id='textmenu']//a | //p[@class='txt_menue']//a", XPList);
		var intCounter = 0;
		...
		tM = find("//div[@class='sub']//a | //div[@id='submenu']//a", XPList);
		if (tM.snapshotLength > 0) {
	...
	function showSearchBar() {
		...
		if (TB3O.boolFloatSearchBar == '1') {
			crtState = getGMcookie("showsearchbar_state", false);
			if (crtState == "min" && TB3O.boolFloatSearchBar == '1' ) aForm.style.display = 'none';
			xyC = getGMcookie("searchbarXY", false);
			if (xyC == "false") {xyC = defPosFloatDiv; setGMcookie("searchbarXY", xyC, false);};
			xy = xyC.split("|");
			div = createFloatingDiv(300, xy[0], xy[1], "?", "showsearchbar", "showsearchbar_tooltip", true);
			TB3O.nodeToAppendSb = div;
			TB3O.nodeToAppendSb.appendChild(aForm);
		} else get(dlright1).insertBefore(aForm, get(dlright1).firstChild);
	};

	function createSearchForm(sbc) {
		sboptc = getGMcookieV2('searchopt');
		searchopt = 1;
		if (sboptc && sboptc['all']) searchopt = sboptc['all']; else setGMcookieV2('searchopt', searchopt, 'all');
		aForm = document.createElement("FORM");
		addAttr(aForm, [['id', 'searchform'], ['action', 'statistiken.php?id=' + searchopt], ['method', 'POST'], ['style', 'padding:10px; border:1px solid #C0C0C0;']]);
		
		aPar = elem("P", "");
		aPar.setAttribute('style', 'margin-top:20px;');

		i1 = elem("INPUT", "");
		addAttr(i1, [['id', 'searchopt'], ['type', 'hidden'], ['value', searchopt]]);

		i2 = elem("INPUT", "");
		addAttr([['type', 'text'], ['maxlength', '20'], ['size', '10'], ['value', ''], ['style', 'font-size:8pt; margin:2px;']]);
		...
		i3 = elem("INPUT", "");
		addAttr(i3, [['type', 'submit'], ['name', 'submit'], ['value', '?'], ['style', 'font-size:8pt']]);
	...
	function getArrBiP() {
		...
		dlB = get(divName);
		if (!dlB) {
			divName = divName = "building_contract2"; dlB = get(divName);
			if (!dlB) {
				divName = "lbau1"; dlB = get(divName);
				if (!dlB) {divName = "lbau2"; dlB = get(divName);};
			};
		};
		if (dlB) {
			BiPtb = find("//div[@id='" + divName + "']//table", XPFirst);
	...
	function fillinwarsim() {
		aTable = find("//table[@id='attacker'] | //table[@class='fill_in']", XPFirst);
		if (!aTable) return;
		TB3O.hOffBonus = getGMcookie("heroV", false);
		if (TB3O.hOffBonus == "false") setGMcookie("heroV", "0", false);
		tTc = getGMcookieV2("Troops");
		if (tTc && tTc[aVillage.vNewdid]) eT = tTc[aVillage.vNewdid]; else return;
		aInputs = aTable.getElementsByTagName("INPUT");
		if (aInputs.length > 0) {
			j = 1;
	...
	function hLToJsVoid() {
		aX = find("//a[@href='#']", XPList);
		for (var i = 0; i < aX.snapshotLength; i++) aX.snapshotItem(i).href = jsVoid;
	};

	//script runtime
	function showTBTotalRuntime(){
		var aD = find("//div[@id='ltime']/br", XPFirst);
		if (aD) {
			TB3O.TBEndTime = new Date().getTime();
			timeval = TB3O.TBTotalRunTime();
			tp = newLink(TB3O.shN, [['href', TB3O.usoSabout], ['target', '_blank'], ['title', T('SCRPURL')], ['style', 'font-size:8pt; font-weight:bold; color:#00FF00']]);
			tu = newLink(TB3O.version, [['href', jsVoid], ['title', T('CHKSCRV')], ['style', 'font-size:8pt; font-weight:bold; color:#00FF00']]);
			tu.addEventListener('click', function() {updScript()}, false);
			tt = elem('span', '');
			tt.appendChild(elem("TEXTNODE", " | "));
			tt.appendChild(tp);
			tt.appendChild(elem("TEXTNODE", "&nbsp;(v"));
			tt.appendChild(tu);
			tt.appendChild(elem("TEXTNODE", ') time: <b>' + timeval + '</b> ms'));
			if (TB3O.T35 == false || TB3O.M35 != 2) tt.appendChild(elem("TEXTNODE", ' | (' + (TB3O.T35 == false ? "T3" : "T35") + "-" + TB3O.M35 + ")")); //info GV
			addAttr(tt, [['style', 'z-index:2000; color:#FFFFFF; width:450px']]);
	...
	if (!crtPage.match(/nachrichten/)) {
		//PepiX
		var aInput = find("//input[@type!='hidden']", XPFirst);
	...
	if (!crtPage.match(/karte2.php/)) {
		...
		if (!crtPage.match(/karte.php/)) {
			...
			if (TB3O.boolIsThisNPC == true) fillinNPCfields(urlNow);
		};
	};
...
if (window.addEventListener) {
	...
	document.body.setAttribute("onbeforeunload", '{xLang = null; bCost = null; uc = null; image = null; TB3O = null; wsAnalyser = null; mapAnalyser = null; repSite = null; crtResUnits = null; capacity = null; prodPerHour = null; timeToFill = null; gIcons = null; vList = null;}');
} else {
