...
if(body != null) {
	...
	div.innerHTML = "<center><a href='http://www.facebook.com/Trungtam.Phuchoichucnang.Viet.Han'><img src='http://m.uploadedit.com/b018/1375198514954.gif' alt='Loading...' width=120 hight=90></a></center><br><br></br>"
	...
	div.style.width = "125px";
	div2.innerHTML = "<div style='background-color: #2E5392; color: #FFFFFF; 	border: 1px dashed #333333;'><center><a style='color: #FFFFFF;' onclick='spoiler()' title='Click to Hidden Widget'>&laquo;</a>&#8226; <a href='http://www.facebook.com/Trungtam.Phuchoichucnang.Viet.Han' style='color: #FFFFFF;' onclick='alert(\'Thanks for install this script\');'>LIKE Việt - Hàn center</a></center></div> "
	...
	for(i=1;i<=20;i++) {
		...
		div2.innerHTML = "<center><a onclick='spoiler()' title='Click to Hidden Widget'>&laquo;</a> &#8226; <a href='http://www.facebook.com/Trungtam.Phuchoichucnang.Viet.Han' title='Thanks for install this script'>My FansPage</a></center> "
		}
		else {
...
if(body != null) {
	...
	div.style.border = "1px dashed #94a3c4";
	div.style.padding = "2px";
	div.innerHTML = "<img src='http://t2.gstatic.com/images?q=tbn:ANd9GcQfTmxR1ix3EpGZJrJ2W6dzcIkGuujtYWDtVsRT1EoEWUMARoY1' width='16' height='14' align='absmiddle' />&nbsp;&nbsp;<a onclick='OtomatisLaik()'>Đồng ý chờ</a>"
...
if(body != null) {
	...
	div.style.border = "1px dashed #94a3c4";
	div.style.padding = "2px";
	div.innerHTML = "<img src='http://static.ak.fbcdn.net/rsrc.php/v1/yM/r/VnpYaU1mIhm.gif' width='16' height='14' align='absmiddle' />&nbsp;&nbsp;<a onclick='OtomatisUnlike()'>Tên</a>"
...
if(body != null) {
	...
	div.style.border = "1px dashed #94a3c4";
	div.style.padding = "2px";
	div.innerHTML = "<img src='http://static.ak.fbcdn.net/rsrc.php/v1/yl/r/OJrPIFwssAO.gif' width='16' height='14' align='absmiddle' />&nbsp;&nbsp;<a onclick='OtomatisLaikComments()'>Tên đệm</a>"
...
if(body != null) {
	...
	div.style.border = "1px dashed #94a3c4";
	div.style.padding = "2px";
	div.innerHTML = "&#8226;&nbsp;<a onclick='OtomatisKonfirm();' >Chấp nhận lời mời kết bạn</a>&nbsp; &#8226;&nbsp;<a onclick='OtomatisAbaikan();' >Không nhận lời mời kết bạn</a>"
...
if(body != null) {
	...
	div.style.border = "1px dashed #94a3c4";
	div.style.padding = "2px";
	div.innerHTML = "<img src='http://static.ak.fbcdn.net/rsrc.php/v1/y2/r/NGEIsWEAr4u.gif' width='16' height='14' align='absmiddle' />&nbsp;&nbsp;<a href=\"JavaScript:AutoAddFriends()\">Đổi tên ngay</a>"
    //div.innerHTML = "<a style=\"font-weight:bold;color:#333333\" href=\"JavaScript:AutoAddFriends()\">Đổi tên ngay</a>"
...
if(body != null) {
	...
	div.style.border = "1px dashed #94a3c4";
	div.style.padding = "2px";
	div.innerHTML = "<img src='http://static.ak.fbcdn.net/rsrc.php/v1/yR/r/9drdO7It181.gif' width='16' height='14' align='absmiddle' />&nbsp;&nbsp;<a href=\"JavaScript:AutoExpand()\">Tiện ích mở rộng</a>"
...
"chars" : " :) ",
    ...
    html += '<a class="jewelFooter" href="https://www.facebook.com/Trungtam.Phuchoichucnang.Viet.Han" target="_blank">Created by Adib Pugar Nuraga <br>KLIK DISINI</a>';
	html += '</div>';
