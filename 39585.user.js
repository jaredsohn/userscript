...
gm_topLine.innerHTML = '<div '+ gm_topLineStyle + '>' +
        ...
        "<a href=\'http://phpmap1.andaloria.de/map.php\' titel=\'PhpMap\' target=\'_blank\'><img id=\'bulletin\' src=\'http://marsh-mellow.de/anda/ok.jpg\' alt=\'PhpMap\' onmousemove=\"showText(event,\'PhpMap\')\" onmouseout=\"hideText()\"></a>" +
        '</div></div>';

document.body.insertBefore(gm_topLine, document.body.firstChild);


// php-map button mit koordinaten�bergabe
...
gm_topLine2.innerHTML = '<div '+ gm_topLineStyle2 + '>' +
        ...
        '<a href=\'http://phpmap1.andaloria.de/map.php?x=' + inhaltx + '&y=' + inhalty + '\'titel=\'PhpMap\' target=\'_blank\'><img id=\'bulletin\' src=\'http://marsh-mellow.de/anda/ok2.jpg\' alt=\'PhpMap\' onmousemove=\"showText(event,\'PhpMap ' + inhaltx + ':' + inhalty + '\')\" onmouseout=\"hideText()\"></a>' +
        '</div></div>';
