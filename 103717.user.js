...
var Options = {
  ...
  pbWideMap    : false,
  pbFoodAlert  : false,
  alertConfig  : {aChat:false, aPrefix:'** Saldýrý Var! **', scouting:false, wilds:false, defend:true, minTroops:10000, spamLimit:10, lastAttack:0 },
  ...
  spamconfig   : {aspam:false, spamvert:'Ittifakýmýza Katilin!!', spammins:'10', atime:2 , spamstate:'a'},
...
Tabs.tower = {
  ...
  towerMarches: [],
  Providers : {
		0: { 'country': "--Ulke--", 'provider': "--Gsm Operatoru--" },
        1: { 'country': "TURKEY", 'provider': "Vodafone" },
        2: { 'country': "TURKEY", 'provider': "Turkcell" },
        3: { 'country': "TURKEY", 'provider': "Avea" },
  ...
  init: function(div){
    ...
    var m = '<DIV class=pbStat>KALE ALARMLARI</div><TABLE class=pbTab><TR align=center>';
    ...
    m += '<BR><DIV class=pbStat>YAPILANDIRMA</div><TABLE class=pbTab>\
    <tr><td align=left><INPUT id=pbcellenable type=checkbox '+ (Options.celltext.atext?'CHECKED ':'') +'/></td>\
    <td align=left>Saldiri SmS Gidecek Cep Telefonu : <INPUT id=pbnum1 type=text size=4 maxlength=4 value="'+ Options.celltext.num1 +'"  '+(Options.celltext.provider==0?'DISABLED':'')+'\>\
&nbsp;<INPUT id=pbnum2 type=text size=3 maxlength=3 value="'+ Options.celltext.num2 +'"  '+(Options.celltext.provider==0?'DISABLED':'')+'\>\
&nbsp;<INPUT id=pbnum3 type=text size=4 maxlength=4 value="'+ Options.celltext.num3 +'"  '+(Options.celltext.provider==0?'DISABLED':'')+'\> <span style="color:#800; font-weight:bold">(Dikkat Mesaj Ucretli Olabilir !!)</span></td></tr><tr><td></td>\
    <TD align=left>Ulke: <select id="pbfrmcountry">';
    ...
    m += '</select>\
    <select id="pbfrmprovider" '+(Options.celltext.provider==0?'DISABLED':'')+'><option value=0 >--Operator--</option>';
    for (var i in t.Providers) {
 if(t.Providers[i].country == t.Providers[Options.celltext.provider].country)
    ...
    m += '</select></td></tr>\
        <TR><TD><INPUT id=pbalertEnable type=checkbox '+ (Options.alertConfig.aChat?'CHECKED ':'') +'/></td><TD>Gelen Saldiriyi Otomatik Olarak ittifak Sohbetine Yolla.</td></tr>\
        <TR><TD></td><TD><TABLE cellpadding=0 cellspacing=0>\
            <TR><TD align=right>Uyari Mesaji Text: &nbsp; </td><TD><INPUT id=pbalertPrefix type=text size=60 maxlength=120 value="'+ Options.alertConfig.aPrefix +'" \></td></tr>\
            <TR><TD align=right>Casus Uyarisi: &nbsp; </td><TD><INPUT id=pbalertScout type=checkbox '+ (Options.alertConfig.scouting?'CHECKED ':'') +'/></td></tr>\
            <TR><TD align=right>Bozkira Saldiri Uyarisi: &nbsp; </td><TD><INPUT id=pbalertWild type=checkbox '+ (Options.alertConfig.wilds?'CHECKED ':'') +'/></td></tr>\
            <TR><TD align=right>Savunma Bilgilerini Goster: &nbsp; </td><TD><INPUT id=pbalertDefend type=checkbox '+ (Options.alertConfig.defend?'CHECKED ':'') +'/></td></tr>\
            <TR><TD align=right>Bu Sayidan Yukarisini Uyar: &nbsp; </td><TD><INPUT id=pbalertTroops type=text size=7 value="'+ Options.alertConfig.minTroops +'" \> &nbsp; &nbsp; <span id=pbalerterr></span></td></tr>\
            </table></td></tr>\
        <TR><TD><BR></td></tr>\
        <TR><TD><INPUT id=pbSoundEnable type=checkbox '+ (Options.alertSound.enabled?'CHECKED ':'') +'/></td><TD>Casus Yada Normal Saldirida Sesle Uyar</td></tr>\
        <TR><TD></td><TD><DIV id=pbLoadingSwf>Loading SWF player</div><DIV style="display:none" id=pbSoundOpts><TABLE cellpadding=0 cellspacing=0>\
            ...
            <TR><TD align=right>Ses Seviyesi: &nbsp; </td><TD><TABLE cellpadding=0 cellspacing=0 class=pbTab><TR valign=middle><TD><SPAN id=pbVolSlider></span></td><TD width=15></td><TD align=right id=pbVolOut>0</td></td></table></td><TD align=center><SPAN id=pbLoadStat>xx</span></td></tr>\
            <TR><TD align=right><INPUT id=pbSoundRepeat type=checkbox '+ (Options.alertSound.repeat?'CHECKED ':'') +'/></td><TD> Her <INPUT id=pbSoundEvery type=text size=2 maxlength=5 value="'+ Options.alertSound.repeatDelay +'"> dakikada tekrarla</td></tr>\
            <TR><TD></td><TD> <INPUT id=pbSoundLength type=text size=3 maxlength=5 value="'+ Options.alertSound.playLength +'"> Saniye boyunca Cal</td></tr>\
            <TR><TD></td><TD><INPUT type=submit value="Simdi Cal" id=pbPlayNow></td></tr></table></div></td></tr>\
        </table><BR>';
  	t.myDiv.innerHTML = m;
...
// GM_log(document.getElementById("pbfrmcountry").value);
  ...
  displayDefMode : function (cityId){
    ...
    if (t.defMode[cityId]){
      ...
      but.value = 'Defans=ACIK';  
    } else {
      but.className = 'pbDefButOff';
      but.value = 'Defans=KAPALI';  
    }  
  },
            ...
            for (k in t.towerMarches) {
                if (typeof t.towerMarches[k].atkType != 'undefined') {
                    if (t.towerMarches[k].cityId == cityId) {
                        ...
                        s3 += '<TD width=15%  ><B>Konumu</b></td>';
                        s3 += '<TD width=15%  ><B>isim</b></td>';
						s3 += '<TD width=10%><B>Source: </b></td><TD width=10%>' + t.towerMarches[k].source + '</td>';
                        s3 += '<TD width=10%><B>Kudret: </b></td><TD width=10%>' + t.towerMarches[k].attackermight + '</td>';
                        s3 += '<TD width=10%><B>ittifak: </b></td><TD width=10%>' + t.towerMarches[k].allianceName + '</td>';
...
Tabs.build = {
    ...
    init: function(div){
        ...
        var m = '<DIV id=pbBuildDivF class=pbStat>INSAAT AYARLARI</div><TABLE id=pbbuildfunctions width=100% height=0% class=pbTab><TR>';
        if (t.buildStates.running == false) {
            m += '<TD><INPUT id=pbBuildRunning type=submit value="Otomatik Insaat = KAPALI"></td>';
        }
        else {
            m += '<TD><INPUT id=pbBuildRunning type=submit value="Otomatik Insaat = ACIK"></td>';
        }
		m += '<TD><INPUT id=pbBuildMode type=submit value="Insaat Modu = KAPALI"></td>';
		m += '<TD>Insaat Tipi: <SELECT id="pbBuildType">\
				<OPTION value=build>Yukseltme</option>\
				<OPTION value=max>En Yuksek Level</option>\
				<OPTION value=destruct>Yikma</option>\
				</select></td>';
		m += '<TD><INPUT id=pbHelpRequest type=checkbox '+ (t.buildStates.help?' CHECKED':'') +'\></td><TD>Yardima ihtiyacim Var</td>';
		m += '</tr></table></div>';
        m += '<DIV id=pbBuildDivQ class=pbStat>INSAAT SIRALARI</div><TABLE id=pbbuildqueues width=100% height=0% class=ptentry><TR>';
		for (var i = 0; i < Cities.cities.length; i++) {
        ...
        m += '</tr><TR>';
        for (var i = 0; i < Cities.cities.length; i++) {
            m += '<TD>Sayi:</td><TD id=pbbuildcount_' + Cities.cities[i].id + '>' + t["bQ_" + Cities.cities[i].id].length + '</td>';
        }
        m += '</tr><TR>';
        for (var i = 0; i < Cities.cities.length; i++) {
            ...
            m += '<TD>Sure:</td><TD id=pbbuildtotal_' + Cities.cities[i].id + '>' + timestring + '</td>';
        }
...
//				13:{'name':"-------",'x':375,'y':375},
    ...
    m = '<DIV class=ptentry><TABLE width=100% class=pbTab><TR><TD class=pbDetLeft>Arama Tipi: </td><TD width=99%>';
    m += htmlSelector ({0:"Barbar Kampi", 1:"Bozkir", 2:"Sehir"}, null, 'id=pasrcType'); 
	m += '&nbsp; &nbsp; &nbsp; <span class=pbDetLeft>Arama Stili: &nbsp;';
	m += htmlSelector({square:"Dörtgen", circle:"Dairesel"}, Options.srcdisttype, 'id=pbsrcdist');
    m += '</span></td></tr><TR><TD class=pbDetLeft>Koordinat: </td><TD class=xtab>X=<INPUT id=pasrchX type=text\> &nbsp;Y=<INPUT id=pasrchY type=text\>\
      &nbsp; Mesafe: <INPUT id=pasrcDist size=3 value=10 /> &nbsp; <SPAN id=paspInXY></span></tr>\
      <TR><TD class=pbDetLeft>Veya:</td><TD>Tüm Eyaletleri Ara: <select id="provinceXY"><option>--Eyaletler--</option>';
  ...
  clickedSearch : function (){
    ...
    m = '<CENTER><B>Aranan '+ typeName +'<BR>\
        ...
        <DIV class=ptentry><TABLE cellspacing=0 width=100%><TR align=center><TD class=xtab colspan=10><B>LýSTE SEÇENEGI:</b><BR></td></tr>';
        
    if (t.opt.searchType == 1 || t.opt.searchType == 0) {
      m += '<TR><TD class=xtab align=right>En Düsük Level:</td><TD class=xtab> <INPUT id=pafilMinLvl size=2 value='+ Options.srcMinLevel +' /></td></tr>\
        <TR><TD class=xtab align=right>En Yüksek Level:</td><TD class=xtab> <INPUT id=pafilMaxLvl size=2 value='+ Options.srcMaxLevel +' /></td></tr>';
		}
    if (t.opt.searchType == 1){
      m += '<TR><TD class=xtab align=right>Bozkir Tipi:</td><TD class=xtab><SELECT id=pafilWildType>';
      m += htmlOptions ( {1:'Cayir/Gol', 3:'Ormanlar', 4:'Tepeler', 5:'Daglar', 6:'Arazi', 0:'TÜMÜ'}, Options.wildType );
      m += '</select></td></tr><TR><TD class=xtab align=right>Sahipsizler:</td><TD class=xtab><INPUT id=pafilUnowned type=CHECKBOX '+ (Options.unownedOnly?' CHECKED':'') +'\><td></tr>';
    }
   if (t.opt.searchType == 1 || t.opt.searchType == 0) {
        m+= '<TR><TD class=xtab align=right>Sirala:</td><TD class=xtab><SELECT id=pafilSortBy>\
          ...
          <OPTION value="dist" '+ (Options.srcSortBy=='dist'?'SELECTED':'')  +'>Mesafe</option>\
			...
			<TR><TD class=xtab align=right>Yalniz Koordinat:</td><TD class=xtab><INPUT type=checkbox id=pacoordsOnly \></td></tr>\
		...
		m+= '<TR><TD class=xtab align=right>Dusman:</td><TD class=xtab><INPUT name=pbfil id=pafilHostile type=CHECKBOX '+ (Options.hostileOnly?' CHECKED':'') +'\><td></tr>';
		m+= '<TR><TD class=xtab align=right>Dost:</td><TD class=xtab><INPUT name=pbfil id=pafilFriendly type=CHECKBOX '+ (Options.friendlyOnly?' CHECKED':'') +'\><td></tr>';
		m+= '<TR><TD class=xtab align=right>Muttefik:</td><TD class=xtab><INPUT name=pbfil id=pafilAllied type=CHECKBOX '+ (Options.alliedOnly?' CHECKED':'') +'\><td></tr>';
		m+= '<TR><TD class=xtab align=right>Notr:</td><TD class=xtab><INPUT name=pbfil id=pafilNeutral type=CHECKBOX '+ (Options.neutralOnly?' CHECKED':'') +'\><td></tr>';
		m+= '<TR><TD class=xtab align=right>Ittifaksiz:</td><TD class=xtab><INPUT name=pbfil id=pafilunAllied type=CHECKBOX '+ (Options.unalliedOnly?' CHECKED':'') +'\><td></tr>';
		...
		<TR><TD class=xtab align=right>En Dusuk Guc:</td><TD class=xtab><INPUT type=text id=paminmight size=6 value='+ Options.minmight +'>\
        <TR><TD class=xtab align=right>Yalniz Koordinat:</td><TD class=xtab><INPUT type=checkbox id=pacoordsOnly \></td></tr>\
        </table></div><BR><SPAN id=pasrchSizeWarn></span><DIV id=pbSrcExp></div>';
  ...
  stopSearch : function (msg){
    ...
    document.getElementById ('pasrcStart').value = 'Aramaya Basla';
...
// TODO: save memory, remove city name ?   			
  ...
  gotPlayerInfo : function (rslt, span){
    ...
    m += '<TR><TD class=pbDetLeft>Player Name:</td><TD>'+ p.genderAndName +'</td></tr>\
      ...
      <TR valign=top><TD class=pbDetLeft>Eyaletler:</td><TD style="white-space:normal">'+ prov.join(', ') +'</td></tr>';
...
Tabs.Barb = {
  ...
  init : function (div){
    ...
    var m = '<DIV id=pbTowrtDivF class=pbStat>OTOMATIK BARBAR FONKSIYONU</div><TABLE id=pbbarbingfunctions width=100% height=0% class=pbTab><TR align="center">';
	 if (AttackOptions.Running == false) {
	       m += '<TD><INPUT id=AttSearch type=submit value="Barbar=KAPALI"></td>';
	       updatebotbutton("BOT");
	   } else {
	       m += '<TD><INPUT id=AttSearch type=submit value="Barbar=ACIK"></td>';
	       updatebotbutton("BOT (AA)");
	   }
	  m += '<TD><INPUT id=troopselect type=submit value="Asker Secimi"></td>';
	  m += '<TD><INPUT id=Options type=submit value="Ayarlar"></td>';
	  m += '</tr></table></div>';
	  
	  m += '<DIV id=pbTraderDivD class=pbStat>BARBAR SEHIRLERI</div>';
     ...
     m+='</tr></table>';
     m += '<DIV id=pbTraderDivD class=pbStat>BARBAR AYARLARI</div>';
  ...
  troopOptions: function(){
	 ...
	 var troopDef = [
	  ...
	  ['Katapult', 12],
  	 ...
  	 var z= '<DIV id=pbTraderDivD class=pbStat>ASKERI BIRLIK SECIMI</div><TABLE width=100%><TR>';
	 z+='<TD></td>';
	 for(var i=0; i<troopDef.length; i++)
		z+='<TD>'+troopDef[i][0]+'</td>';
	 z+='<TD>Min Msfe</td><TD>Max Msfe</td>';
	 for(i=0;i<10;i++){
  ...
  barbOptions: function(){
	 ...
	 t.barboptions.getTopDiv().innerHTML = '<CENTER><b>'+getServerId()+' Serveri barbar secenekleri</b></CENTER>';
  	var y = '<DIV style="max-height:400px; overflow-y:auto;"><DIV class=pbStat>RESETLE</div><TABLE width=100%>';
	   y +='<TR><TD style="margin-top:5px; text-align:center;"><INPUT id=pbresetbarbs type=submit value="Barbar Reset"></td>';
	   y +='<TD style="margin-top:5px; text-align:center;"><INPUT id=pbpaintbarbs type=submit value="Barbar Goster"></td>';
	   y += '<TD><SELECT id=pbcity type=list></td></tr></table>';
	   y +='<TD style="margin-top:5px; text-align:center;"><DIV class=pbStat> SECENEKLER </div></td><TABLE>';
     y +='<TR><TD>Saldiri Araligi: <INPUT id=pbsendint type=text size=4 maxlength=4 value='+ AttackOptions.SendInterval +' \> saniye</td></tr>';
     y +='<TR><TD>Max arama mesafesi: <INPUT id=pbmaxdist type=text size=4 maxlength=4 value='+ AttackOptions.MaxDistance +' \></td></tr>';
     y +='<TR><TD>Toplanma noktasinda<INPUT id=rallyclip type=text size=1 maxlength=2 value="'+AttackOptions.RallyClip+'" \> slot bos birak</td></tr>';
     y +='<TR><TD><INPUT id=pbreport type=checkbox '+(AttackOptions.MsgEnabled?'CHECKED':'')+'\> Barbar raporu gonder<INPUT id=pbmsgint type=text size=2 maxlength=2 value='+AttackOptions.MsgInterval+' \>saatte bir</td></tr>';
     y +='<TR><TD>Metod : '+htmlSelector({distance:'Saldiri Onceligi Kapali', level:'Once Yuksek levelden basla', lowlevel:'Once dusuk levelden basla'}, AttackOptions.Method, 'id=pbmethod')+'</td></tr>';
     y +='<TR><TD><INPUT id=deletetoggle type=checkbox '+(AttackOptions.DeleteMsg?'CHECKED':'')+' /> Barbar ve Nakliye raporlarini otomatik sil</td></tr>';
     y +='<TR><TD><INPUT id=deletes0toggle type=checkbox '+(AttackOptions.DeleteMsgs0?'CHECKED':'')+' /> Nakliye raporlarini otomatik sil</td></tr>';
     y +='<TR><TD>Otomatik silinecek barbar rapor seviyeleri: <BR>';
	 y +='<TABLE><TR>';
     for (w=1;w<=10;w++){
  ...
  toggleBarbState: function(obj){
	...
	if (AttackOptions.Running == true) {
		...
		obj.value = "Barbar=KAPALI";
		updatebotbutton("BOT");
		saveAttackOptions();
		t.nextattack = null;
	} else {
		AttackOptions.Running = true;
		obj.value = "Barbar=ACIK";
		updatebotbutton("BOT (AA)");
		saveAttackOptions();
		t.checkBarbData();
  ...
  mapCallback : function (left, top, width, rslt){
    ...
    if (t.curX > t.lastX){
      ...
      if (t.curY > t.lastY){
        ...
        document.getElementById(element).innerHTML = 'Bulunan: ' + t.mapDat.length;
...
Tabs.transport = {
  ...
  count:0,
	...
	t.e_tradeRoutes();
      ...
      if (t.traderState.running == false) {
          ...
          m += '<TD><INPUT id=pbTraderState type=submit value="Nakliye=ACIK"></td>';
      }
      m += '<TD><INPUT id=pbShowRoutes type=submit value="Rota Goster"></td>';
      m += '</tr></table></div>';
      m += '<DIV id=pbTraderDivDRoute class=pbStat>NAKLIYE ROTASI EKLE</div>';

      m += '<TABLE id=pbaddtraderoute width=95% height=0% class=pbTab><TR align="left">';
      m += '<TD>Bu Sehirden:</td> <TD width=310px><DIV style="margin-bottom:10px;"><span id=ptrescity></span></div></td></tr>';

      m += '<TR align="left">';
      m += '<TD>Bu Sehire:</td> <TD width=310px><DIV style="margin-bottom:10px;"><span id=ptcityTo></span></div></td>';
      m += '<TD>veya</td>';
      m += '<TD>X:<INPUT id=ptcityX type=text size=3\></td>';
      m += '<TD>Y:<INPUT id=ptcityY type=text size=3\></td></tr>';
	  
	  m += '<TR align="left">';
	  m += '<TD colspan=4><INPUT id=pbtransportinterval type=text size=2 value="'+Options.transportinterval+'"\> dakikada bir nakliye yap</td></tr></table>';
      m += '<TD colspan=4>Eger Araba Sayisi <INPUT id=pbminwagons type=text size=2 value="'+Options.minwagons+'"\> den az sa nakliye yapma. (Gereksiz Nakliye Onlenir)</td></tr></table>';
      
      m += '<DIV style="margin-top:10px;margin-bottom:5px;">Eger "Tutulacak" miktari 0 ise en yüksek "Miktar" tasinacaktir..</div>';
      ...
      m += '<TD>Tutulacak: <INPUT id=pbtargetamountFood type=text size=11 maxlength=11 value="0"\></td>';
      m += '<TD>Tasinacak: <INPUT id=pbtradeamountFood type=text size=11 maxlength=11 value="0"\></td></tr>';
      m += '<TR align="center">';
      ...
      m += '<TD>Tutulacak: <INPUT id=pbtargetamountWood type=text size=11 maxlength=11 value="0"\></td>';
      m += '<TD>Tasinacak: <INPUT id=pbtradeamountWood type=text size=11 maxlength=11 value="0"\></td></tr>';
      m += '<TR align="center">';
      ...
      m += '<TD>Tutulacak: <INPUT id=pbtargetamountStone type=text size=11 maxlength=11 value="0"\></td>';
      m += '<TD>Tasinacak: <INPUT id=pbtradeamountStone type=text size=11 maxlength=11 value="0"\></td></tr>';
      m += '<TR align="center">';
      ...
      m += '<TD>Tutulacak: <INPUT id=pbtargetamountOre type=text size=11 maxlength=11 value="0"\></td>';
      m += '<TD>Tasinacak: <INPUT id=pbtradeamountOre type=text size=11 maxlength=11 value="0"\></td></tr>';
      m += '<TR align="center">';
      ...
      m += '<TD>Tutulacak: <INPUT id=pbtargetamountGold type=text size=11 maxlength =11 value="0"\></td>';
      m += '<TD>Tasinacak: <INPUT id=pbtradeamountGold type=text size=11 maxlength=11 value="0"\></td></tr>'
      m += '</table>';

      m += '<DIV style="text-align:center; margin-top:15px"><INPUT id=pbSaveRoute type=submit value="Rotayi Ekle"></div>';
 ...
 e_tradeRoutes: function(){
	...
	showTradeRoutes: function () {
		...
		t.popTradeRoutes.getMainDiv().innerHTML = '</table></div>' + m;
		t.popTradeRoutes.getTopDiv().innerHTML = '<TD><B>Nakliye Rotalari:</td>';
		t.paintTradeRoutes();
		t._addTabHeader();
		t.popTradeRoutes.show(true)	;
	},
