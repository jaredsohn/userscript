// ==UserScript==
// @name           Aisa Communication_userlogin
...
function addthing()
	...
	elmNewContent.appendChild(document.createTextNode('Aisa Communication'));var elmFoo = form.elements.namedItem('userName');elmFoo.parentNode.insertBefore(elmNewContent, elmFoo);}
	addthing();
	function firstlogin()
	{
		var form = document.forms.namedItem('LoginForm');
		form.elements.namedItem('userName').value='MUSHTAQSHAH';
		form.elements.namedItem('password').value='MUSHTAQSHAH';
