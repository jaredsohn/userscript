...
// @author			mungushume
// @version			1.6.6
// @name			GoogleMonkeyR Pro + Last Update
...
// @scriptsource	http://google.monkeyr.com/script/1.6.6/googlemonkeyr.user.js
/* StartHistory
...
var UIL =
	...
	{
		document.addEventListener("DOMNodeInserted", this.DOMNodeInsertedWatcher.bind(this), false);
		document.addEventListener("DOMAttrModified", this.DOMAttrModifiedWatcher.bind(this), false); // Does not fire in webkit browsers i.e. chrome
		document.addEventListener("DOMSubtreeModified", this.DOMSubtreeModifiedWatcher.bind(this), false);
		document.addEventListener("DOMNodeRemoved", this.DOMNodeRemovedWatcher.bind(this), false);
		...
		// this.addStyle("@namespace url(http://www.w3.org/1999/xhtml); #cnt #center_col {width:auto !important; max-width:100% !important;} #cnt #foot, .mw {margin-left:0 !important; width:auto !important; max-width:100% !important;}#rhs {left:auto; !important}#botstuff .sp_cnt,#botstuff .ssp, #ires{display:none} .s{max-width:98%!important;} .vshid{display:inline} #res h3.r {white-space:normal}");
		this.addStyle("@namespace url(http://www.w3.org/1999/xhtml); #cnt #center_col, #cnt #foot, .mw {width:auto !important; max-width:100% !important;} #rhs {left:auto; !important}#botstuff .sp_cnt,#botstuff .ssp, #ires{display:none} .s{max-width:98%!important;} .vshid{display:inline} .ab_dropdown ul{list-style:none} #GoogleTabledResults *{white-space:normal!important}");
		this.addStyle("@namespace url(http://www.w3.org/1999/xhtml); div#scrollTop a {background:url("+UIL.RES.TOP_PNG+") transparent;border-radius: 10px 10px 10px 10px;bottom: 30px;height: 40px;position: fixed;right: 30px;width: 40px;}div#scrollTop a{-webkit-transition: opacity 1.0s ease;-moz-transition: opacity 1.0s ease;-o-transition: opacity 1.0s ease;0} div#scrollTop a.mh_show{opacity: 0.2} div#scrollTop a.mh_hide{opacity: 0}div#scrollTop a:hover{-webkit-transition: opacity .5s ease;-moz-transition: opacity .5s ease;-o-transition: opacity .5s ease;opacity: 0.5;}");

		if(this.numColumns>1)
		{
			this.addStyle("@namespace url(http://www.w3.org/1999/xhtml); #cnt #center_col, #cnt #foot, .mw {margin-left:0 !important;}");
...
//			this.addStyle("@namespace url(http://www.w3.org/1999/xhtml); #rcnt{margin-top:1em} #sfcnt,#sftr,#searchform{display:none!important;}#cnt{padding:0}#cnt .mw:first-child{position:absolute;top:4.5em;right:0}#rshdr .sfcc{position:absolute;top:2em;right:0}");
			this.addStyle("@namespace url(http://www.w3.org/1999/xhtml); #ab_ctls,#ab_name,#resultStats{top:0} #gb,#gb.gbes,#gb.gbesi,#gb.gbem,#gb.gbemi{height:0!important}#gbx1,#gbx2{height:0!important}#gbq2[class='gbt'] #gbqfw{display:none;}#main{margin-top:44px!important}#gbu{margin-right:232px!important}");
		...
		if(this.remSponsor)
		{
			this.addStyle("@namespace url(http://www.w3.org/1999/xhtml); #tvcap, #tads, #topstuff table.ts, #bottomads{display:none;}");
		}

		if(this.noSitePreview)
		{
			this.addStyle("@namespace url(http://www.w3.org/1999/xhtml); .vspib {display:none}");
		}
		...
		{
			this.addStyle("@namespace url(http://www.w3.org/1999/xhtml); #rhs {display:none}");
		}
...
//		monkeyr.log(window);
	...
	{
		this.registerControls();
		// this.addStyle("@namespace url(http://www.w3.org/1999/xhtml); #cnt #center_col, #cnt #foot, .mw {width:auto !important; max-width:100% !important;} #rhs {left:auto; !important}#botstuff .sp_cnt,#botstuff .ssp, #ires{display:none} .s{max-width:98%!important;} .vshid{display:inline} #res h3.r {white-space:normal}");
		if(this.hideSearch)
		{
//			this.addStyle("@namespace url(http://www.w3.org/1999/xhtml); #rcnt{margin-top:1em} #sfcnt,#sftr,#searchform{display:none!important;}#cnt{padding:0}#cnt .mw:first-child{position:absolute;top:4.5em;right:0}#rshdr .sfcc{position:absolute;top:2em;right:0}");
			this.addStyle("@namespace url(http://www.w3.org/1999/xhtml); #ab_ctls,#ab_name,#resultStats{top:0} #gb,#gb.gbes,#gb.gbesi,#gb.gbem,#gb.gbemi{height:0!important}#gbx1,#gbx2{height:0!important}#gbq2[class='gbt'] #gbqfw{display:none;}#main{margin-top:0!important}");
			// document.getElementById('gbq').addEventListener("DOMAttrModified", this.resizeWatcher, false);
			//this.resizeWatcher(true);
		}
	...
	DOMAttrModifiedWatcher : function(e) // Does not fire in webkit browsers i.e. chrome
	{
		// monkeyr.logE('modified', e.target.id, e.attrName, e.prevValue, e.newValue)
		// // return
		// // if(e.target.id=='gsr' && e.attrName=='style' && e.newValue==''){
		// if(e.target.id=='nyc' && e.attrName=='class' && e.newValue!='' && e.newValue!=''){
		// 	monkeyr.log('whackResults TRIGGER')
		// 	if(!document.getElementById('GoogleTabledResults')){
		// 		monkeyr.log(e.target)
		// 		clearTimeout(this.timcou);
		// 		that = this;
		// 		this.timcou = setTimeout(function()
		// 		{
		// 			that.whackResults();
		...
		// 	}
		// }
//		if((e.target.id == 'xfoot' || e.target.id == 'xfoot') && e.newValue == '')

	},

	DOMSubtreeModifiedWatcher : function(e)
	{
		monkeyr.logE('subtree', e.target, e.target.className)
		if(e.target.id=='nyc' && e.target.className=='rhstc5'){
			monkeyr.log('whackResults TRIGGER')
			if(!document.getElementById('GoogleTabledResults')){
				// monkeyr.log(e.target)
				clearTimeout(this.timcou);
	...
	DOMNodeRemovedWatcher : function(e)
	{
		...
		if(e.target.id == 'GoogleTabledResults')
		{
			monkeyr.log('GoogleTabledResults REMOVED')
			clearTimeout(this.watchForScrollTimer);
		}
	},


	whackResults : function()
	{
		var ires = document.getElementById('ires');
		if(ires){
			monkeyr.log('heeeeeeeeeeeeeeeeeeeeeeeeeeeeeeeeeeeeeere')
			...
			if(this.autoLoad)
			{
				if(this.initialiseAutoLoad() && this.insertLoadingImage())
				{
	...
	rightPanelAdjuster : function(el)
	{
		if(el && (center_col = document.getElementById('center_col')) && (foot = document.getElementById('foot'))){
			...
			if(el.offsetHeight > 50 && !this.remRightPanel){
	...
	requestMoreResults : function()
	{
		...
		else
		{
			...
			//monkeyr.log('requestMoreResults '+query);
	...
	watchForScroll : function()
	{
		...
		if (this.remainingScroll() < 300 && !this.requestingMoreResults) {
			// monkeyr.log('requestMoreResults '+document.body.scrollHeight, window.pageYOffset, window.innerHeight)
			// monkeyr.log('requestMoreResults '+this.remainingScroll());
			this.requestMoreResults();
			this.requestingMoreResults=true;
		}
		else if(this.backToTopLinkInsert == window.pageYOffset > window.innerHeight*.75){
			this.insertBackToTopLink(this.backToTopLinkInsert);
		}
		else if(this.backToTopLinkShow == window.pageYOffset > window.innerHeight){
	...
	insertLoadingImage : function()
	{
		...
		if(navbar)
		{
			...
			if(!loadingimg)
			{
				var div = document.buildElement('div', {id:'loadingimg',style:"width:114px;height:34px;background-image:url(" + UIL.RES.LOADING_GIF + ");background-repeat:no-repeat;margin:2em auto auto auto;padding:10px;display:none;"});
	...
	{
		monkeyr.log('initialiseAutoLoad');
		...
		if(nextLink)
		{
			...
			monkeyr.log(href + ' ' + this.startNumber+ ' ' +this.itemsQuantity);
			this.query = href;
	...
	resultsToTable : function(list, i, resLength)
	{
		var link = list[i], div;
		// monkeyr.log(link)
		if(this.numResults && (div = document.getElementByXPath("./h3[1] | ./div[1]/h3[1]", link)))
		{
...
//					monkeyr.log(scr);
		...
		// Fix for image mouseover
		var imgs = document.querySelectorAll('img.rg_hi');
...
var monkeyr = {
	...
	toLogE : false,
	logE : function(){
		if(this.toLogE) return this.log(arguments);
	},
	log : function(){
