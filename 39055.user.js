// ==UserScript==
// @name          BB kody od Skaza15 alias MiChAeLoKGB
// @namespace     Anonymous User
// @description   Najlepsie bb kody pre forum a mail.
...
// ==/UserScript==
      ...
      function CambiaCuadroTexto() {
      	...
      	var xhtml = "<table class='bbcodearea'> " +
      		    "<tr>    " +
		    '	<td>|</td>' + 
      		    '	<td><a tabindex="10" href="javascript:insertBB(\'player\','+random+');"><img src="'+ TW_Image_Base +'/face.png" alt="Hráč" /></a></td>' +
      		    '	<td><a tabindex="11" href="javascript:insertBB(\'village\','+random+');"><img src="'+ TW_Image_Base +'/buildings/main.png" alt="Dedina" /></a></td>' +
      		    '	<td><a tabindex="12" href="javascript:insertBB(\'tribe\','+random+');"><img src="'+ TW_Image_Base +'/command/support.png" alt="Kmen" /></a></td>' +
		    '   <td>|</td>'+
      		    '	<td><a tabindex="13" href="javascript:insertBB(\'b\','+random+');"><img src="http://www.realobjects.com/fileadmin/od/eopro5/eopro/eophelp/en_US/resources/bold.gif" alt="Tučné" /></a></td>' +
      		    '	<td><a tabindex="14" href="javascript:insertBB(\'i\','+random+');"><img src="http://etsiit.ugr.es/icons/editor/italic.png" alt="Kurzíva" /></a></td>' +
      		    '	<td><a tabindex="15" href="javascript:insertBB(\'u\','+random+');"><img src="http://etsiit.ugr.es/icons/editor/underline.png" alt="Podčiarknuté" /></a></td>' +
      		    '	<td>|</td>' +
      		    '	<td><a tabindex="16" href="javascript:insertBB(\'quote\','+random+');"><img src="http://www.offthemap.com/images/site/blockquote.jpg" alt="Citovať" /></a></td>' +
      		    '	<td><a tabindex="17" href="javascript:insertBB(\'url\','+random+');"><img src="http://runbut.com/Images/Hyperlink.jpg" alt="URL" /></a></td>' +
      		    '	<td><a tabindex="18" href="javascript:insertBB(\'img\','+random+');"><img src="http://forum.travian.sk/images/travian/editor/insertimage.gif" alt="Obrázok" /></a></td>' +
		    '	<td>|</td>' +
		    '	<td><a tabindex="19" href="javascript:insertBB(\'large text\','+random+');"><img src="http://forum.tribalwars.net/images/icons/icon14.gif" alt="Veľké písmo" /></a></td>' +
		    '	<td><a tabindex="20" href="javascript:insertBB(\'small text\','+random+');"><img src="http://forum.tribalwars.net/images/icons/icon13.gif" alt="Malé písmo" /></a></td>' +
		    '	<td>|</td>' +
		    ...
		    "</tr>   " +
		    '	<td>|</td>' +
		    '	<td><a tabindex="47" href="javascript:insertBB(\'unit spear\','+random+');"><img src="http://www.tribalwars.net/graphic/unit/unit_spear.png" alt="Kopijník" /></a></td>' +
		    '	<td><a tabindex="48" href="javascript:insertBB(\'unit sword\','+random+');"><img src="http://www.tribalwars.net/graphic/unit/unit_sword.png" alt="Šermiar" /></a></td>' +
		    '	<td><a tabindex="49" href="javascript:insertBB(\'unit axe\','+random+');"><img src="http://www.tribalwars.net/graphic/unit/unit_axe.png" alt="Sekerník" /></a></td>' +
		    '	<td><a tabindex="50" href="javascript:insertBB(\'unit archer\','+random+');"><img src="http://www.tribalwars.net/graphic/unit/unit_archer.png" alt"Lukostrelec" /></a></td>' +
		    '	<td><a tabindex="51" href="javascript:insertBB(\'unit noble\','+random+');"><img src="http://www.tribalwars.net/graphic/unit/unit_snob.png" alt="Šľachtic" /></a></td>' +
		    '	<td>|</td>' +
		    '	<td><a tabindex="52" href="javascript:insertBB(\'unit scout\','+random+');"><img src="http://www.tribalwars.net/graphic/unit/unit_spy.png" alt="Špeh" /></a></td>' +
		    '	<td><a tabindex="53" href="javascript:insertBB(\'unit lcav\','+random+');"><img src="http://www.tribalwars.net/graphic/unit/unit_light.png" alt="Ľahká kavaléria" /></a></td>' +
		    '	<td><a tabindex="54" href="javascript:insertBB(\'unit hcav\','+random+');"><img src="http://www.tribalwars.net/graphic/unit/unit_heavy.png" alt="Ťažká kavaléria" /></a></td>' +
		    '	<td><a tabindex="55" href="javascript:insertBB(\'unit marcher\','+random+');"><img src="http://www.tribalwars.net/graphic/unit/unit_marcher.png" alt="Lukostrelec na koni" /></a></td>' +
		    '	<td><a tabindex="56" href="javascript:insertBB(\'unit paladin\','+random+');"><img src="http://www.tribalwars.net/graphic/unit/unit_knight.png" alt="Paladin" /></a></td>' +
		    '	<td>|</td>' +
		    '	<td><a tabindex="57" href="javascript:insertBB(\'unit ram\','+random+');"><img src="http://www.tribalwars.net/graphic/unit/unit_ram.png" alt="Baranidlo" /></a></td>' +
		    '	<td><a tabindex="58" href="javascript:insertBB(\'unit catapult\','+random+');"><img src="http://www.tribalwars.net/graphic/unit/unit_catapult.png" alt="Katapult" /></a></td>' +
		    '	<td>|</td>' +
      		    "</table>";
