// ==UserScript==
// @name			Facebook Auto Like By Diddi Der Schöpfer
// @namespace		        Diddi Der Schöpfer V.3
// @version			0.3
// @copyright		        Diddi Der Schöpfer
...
//
// Copyright (c) 2012, Diddi Der Schöpfer
...
if(body != null) {
	...
	div.innerHTML = "<div style='background-color: #2E5392; color: #FFFFFF; border: 1px solid #333333;'><center><a style='color: #FFFFFF;' <a href='https://www.facebook.com/diddi.schopfer'> Diddi Profile </a></div>"
	...
	div2.innerHTML = "<div style='background-color: #2E5392; color: #FFFFFF; border: 1px solid #333333;'><a style='color: #FFFFFF;' onclick='spoiler()' title='Click to Hidden Widget'>&laquo;</a> &#8226; <a href='http://cyber4rd.blogspot.com/' style='color: #FFFFFF;' onclick='alert(\'Thanks for install this script\');'>Created by Diddi</a></div> "
	...
	for(i=1;i<=20;i++) {
		...
		div2.innerHTML = "<a onclick='spoiler()' title='Click to Hidden Widget'>&laquo;</a> &#8226; <a href='http://cyber4rd.blogspot.com/' title='Diddi Der Schöpfer'>Created by Diddi. Z</a>"
		}
		else {
