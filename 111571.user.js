...
//Gestione grafica
var versione_fac = "Faccinator 5.6";
...
var meno_a = "http://www.salonedelgusto.it/img_sito/grafica/meno_info.gif";
var piu_a = "http://www.salonedelgusto.it/img_sito/grafica/piu_info.gif";
...
//Inserisco la parte che visualizzerà l'url completo di tag IMG	
	var versione = "<img id=\"button\" style=\"margin: 5px;\"  onclick=\"chiudi();\" src ='##'></img><input style=\" margin-left: 26px; width: 190px; border: 0px solid black; padding: 8px; background: transparent; border-bottom: 1px solid white; font-weight: bold; text-align: center; color: #eee;\" type=\"text\" id=\"copiaggio\" value=\".: " + versione_fac + " :.\">";
