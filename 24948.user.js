...
// @name		Travian Task Queue Norwegian fix
...
switch(sLang) {
	...
	case "no":  //by Lordlarm @ S3 [*LORDS* 4 EVER]
        aLangBuildings = ["", "Tømmer", "Leire", "Jern", "Korn", "Sagbruk", "Murer", "Jern-smelteverk", "Mølle", "Bakeri", "Varehus", "Silo", "Rustningssmed", "Våpensmed", "Turneringsplass", "Hovedbygning", "Møteplass", "Markedsplass", "Ambassade", "Kaserne", "Stall", "Verksted", "Akademi", "Hemmelig jordkjeller", "Rådhus", "Residens", "Palass", "Skattekammer", "Handelskontor", "Stor Kaserne", "Stor Stall", "Bymur", "Jordmur", "Palisade", "Steinhugger", "Bryggeri", "Fallemaker", "Heltenes villa", "Stort varehus", "Stor silo", "Verdensunderverk"];
        aLangTasks = ["Bygg", "Oppgrader", "Angrip", "Utforsk", "Tren"];
        aLangStrings = ["Bygg senere", "Oppgrader senere", "Angrip senere", "Utforsk senere", "Planlegg denne oppgaven til senere.", "Vi har startet byggingen", " Ble forsøkt med ukjent resultat.", "Nivå", " Kan ikke bygges.", " Kan ikke viderebygges.", "Opgaven ble planlagt til senere.", "Nåvarende produksjon:", "Vi kan ikke planlegge denne oppgaven akkurat nå.", "Oppgaveplanlegging er ikke tilgjengelig!", "Planlagte oppgaver", "Slett", "Send senere", "Det ikke er tropper tilgjengelig.", "Dine tropper ble sendt til", "Dine tropper kunne ikke sendes til", "Support", "Angrip", "Plyndringstokt", "Katapultene skyter mot", "tilfeldig", "mot", "eller mot", "sekunder", "minutter", "timer", "dager", "Spioner på råstoffer og tropper", "Spioner på forsvarsverk og tropper", "away", "The attack cannot be scheduled because no destination was specified.", "at site no.", "Sort by:", "type ", "time ", "target ", "options ", "village "];
