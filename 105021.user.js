...
// @include		http://mousehunt.staging.hitgrab.com/*
// @include		http://www.mousehunt.staging.hitgrab.com/*
// @include		http://apps.facebook.com/mh_longtail/*
...
function exeScript()
{
	...
	if (showTimerInTitle)
	{
		...
		if (window.location.href.indexOf("apps.facebook.com/mh_longtail/") != -1)
		{
			...
			if (contentElement)
			{
				...
				breakFrameDivElement.innerHTML = "Timer cannot show on title page. You can <a href='http://www.mousehunt.staging.hitgrab.com/'>run MouseHunt without iFrame (Facebook)</a> to enable timer on title page";
	...
	if (window.location.href.indexOf("mousehunt.staging.hitgrab.com/canvas/") != -1)
	{
		// from facebook
		fbPlatform = true;
	}
	else if (window.location.href.indexOf("mousehunt.staging.hitgrab.com") != -1)
	{
		// from mousehunt game
		mhPlatform = true
	}
	...
	if (fbPlatform)
	{
		if (window.location.href == "http://www.mousehunt.staging.hitgrab.com/" ||
			window.location.href == "http://www.mousehunt.staging.hitgrab.com/#" ||
			window.location.href.indexOf("mousehunt.staging.hitgrab.com/canvas/index.php") != -1 ||
			window.location.href.indexOf("mousehunt.staging.hitgrab.com/canvas/turn.php") != -1 ||
			window.location.href.indexOf("mousehunt.staging.hitgrab.com/canvas/?ref=") != -1 ||
			window.location.href.indexOf("mousehunt.staging.hitgrab.com/canvas/?code=") != -1 ||
			window.location.href.indexOf("mousehunt.staging.hitgrab.com/canvas/?hglogin=") != -1)
		{
	...
	else if (mhPlatform)
	{
		if (window.location.href == "http://www.mousehunt.staging.hitgrab.com/" ||
			window.location.href == "http://www.mousehunt.staging.hitgrab.com/#" ||
			window.location.href.indexOf("mousehunt.staging.hitgrab.com/turn.php") != -1 ||
			window.location.href.indexOf("mousehunt.staging.hitgrab.com/index.php") != -1)
		{
			// page to execute the script!
...
function action()
{
	...
	else if (pauseAtInvalidLocation && (huntLocation != currentLocation))
	{
		...
		if (fbPlatform)
		{
			displayLocation("<font color='red'>" + currentLocation + "</font> [<a onclick='window.localStorage.removeItem(\"huntLocation\");' href='http://www.mousehunt.staging.hitgrab.com/\'>Hunt Here</a>] - <i>Script pause because you had move to a different location recently, click hunt here to continue hunt at this location.</i>");
		}
		else if (hiFivePlatform)
		{
	...
	if (showTimerInPage)
	{
		...
		if (headerElement)
		{
			...
			else
			{
				...
				if (fbPlatform)
				{
					helpTextElement.innerHTML = "<b>Note:</b> MouseHunt AutoBot will only run at <a href='http://www.mousehunt.staging.hitgrab.com/'>Hunter Camp</a>. This is to prevent the bot from interfering user's activity.";
				}
				else if (hiFivePlatform)
				{
				...
				{
					helpTextElement.innerHTML = "<b>Note:</b> MouseHunt AutoBot will only run at <a href='http://mousehunt.staging.hitgrab.com/'>Hunter Camp</a>. This is to prevent the bot from interfering user's activity.";
				}
...
function reloadPage(soundHorn)
{
	...
	if (fbPlatform)
	{
		if (soundHorn)
		{
			window.location.href = "http://www.mousehunt.staging.hitgrab.com/turn.php";
		}
		else
		{
			window.location.href = "http://www.mousehunt.staging.hitgrab.com/";
	...
	else if (mhPlatform)
	{
		...
		if (soundHorn)
		{
			window.location.href = "http://mousehunt.staging.hitgrab.com/turn.php";
		}
		else
		{
			window.location.href = "http://mousehunt.staging.hitgrab.com/";
		}
	}
}
