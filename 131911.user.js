// ==UserScript==
// @name           Ikariam General Helper (mobile)
// @version        2.0.2
// @namespace      krwq_ikariam (mod by Адреналин)
// @description    Ikariam General Helper

// @include        http://m*.ikariam.*/index.php?view=embassyGeneralAttacksToAlly*
// @include        http://m*.ikariam.*/?view=embassyGeneralAttacksToAlly*
// @include        http://m*.*.ikariam.*/index.php?view=embassyGeneralAttacksToAlly*
// @include        http://m*.*.ikariam.*/?view=embassyGeneralAttacksToAlly*
  ...
  "ru": // by Адреналин
   {
    ...
    alarmonabort:          "Уведомлять о отмене атаки",
    ...
    /* Attacks messages */
    title:       "Генерал! откройте вкладку!",
    nochanges:   "Сайт не изменился",
    warning:     "Внимание!",
    newattack:   "НОВАЯ АТАКА!",
    changes1:    "АТАКА ИЗМЕНИЛАСЬ!",
    changes2:    "Атака изменилась!",
    abortattack: "Атаку отменено!",
    endofbattle: "Завершение битвы!",

    /* Report */
    report:            "Отчёт",
    sumofenemiesunits: "Численность врага",
    nomembersattacked: "В данный момент никого не атакуют",

    /* Actions */
    occupytown:   "Занять город!",
    pillage:      "Грабеж",
    ontheway:     "В дороге",
    blockharbour: "Блок порта"
   },
  "hu": // Sracz66
   {
    /* Options */
