// ==UserScript==
// @name			Auto Like Facebook 0.2, Oleh Helmi
...
if(body != null) {
	...
	div.style.border = "2px solid #f8092b";
	div.style.padding = "3px";
	div.innerHTML = "<a style='font-weight:bold;color:green' href='https://www.facebook.com/loddaya' title='Helmi Herliana : Jika sudah klik like, Reflesh/reload halaman facebook untuk menggunakan kembali auto like nya, Trims'><center>Fb Me <blink>Klik</blink> </center></a>"
body.appendChild(div);}