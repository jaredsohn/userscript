// ==UserScript==
// @name            SN TrollSnip
// @namespace       fredludd@gmail.com,2009-07-11:sn#v7
// @description     Sadly,No! troll killer, with Autopsy
// @include         http://www.sadlyno.com/archives/*
// ==/UserScript==

/*  edit this to suit your taste */
var CHARLIMIT = 2048;
/*  it's the maximum number of characters allowed before the script declares logorrhea */
...
function allowAutopsy(header,toolong) {
    ...
    var logorrhea = /LOGORRHEA/;
    
    if(autopsy.exec(permlinkLine.innerHTML) == null) {
        if(toolong && !logorrhea.exec(permlinkLine.innerHTML)) {
            permlinkLine.insertBefore(document.createTextNode("[LOGORRHEA ADVISORY] "), permlinkLine.firstChild);
        }
