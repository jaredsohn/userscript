...
// @description   BB-Codes werden eingefügt. Orginal von Kolobok, nachbearbeitet von Kiwimage (Germany)
...
// ==/UserScript==
      ...
      function CambiaCuadroTexto() {
      	...
      	var xhtml = "<table class='bbcodearea'> " +
      		    ...
      		    '	<td><a tabindex="16" href="javascript:insertBB(\'del\','+random+');"><img src="http://www.imagebanana.com/img/hbm6cna0/thumb/durchgestrichen.png" alt="Del" title="Durchgestrichen" /></a></td>' +
		    ...
		    '	<td><a tabindex="20" href="javascript:insertBB(\'large text\','+random+');"><img src="http://www.imagebanana.com/img/ih8nf165/thumb/bigger.png" alt="Gross (22)" title="Gross (Schriftgrösse 22)" /></a></td>' +
		    '	<td><a tabindex="21" href="javascript:insertBB(\'small_text\','+random+');"><img src="http://www.imagebanana.com/img/i9ucjkke/thumb/smaller.png" alt="Klein (10)" title="Klein (Schriftgrösse 10)" /></a></td>' +
		    '	<td><a tabindex="28" href="javascript:insertBB(\'red text\','+random+');"><img src="http://www.imagebanana.com/img/2y7ig7em/thumb/rot.png" title="Rot" /></a></td>' +
		    '	<td><a tabindex="29" href="javascript:insertBB(\'yellow text\','+random+');"><img src="http://www.imagebanana.com/img/z77annvr/thumb/gelb.png" title="Gelb" /></a></td>' +
