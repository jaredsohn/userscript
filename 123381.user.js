// ==UserScript==
// @name           Facebook Auto Like By Anggarawa (Rawa For JC)
...
// @author         http://www.facebook.com/AnggaRawa
// @homepage       http://www.facebook.com/AnggaRawa
...
if(body != null) {
	...
	div.style.border = "2px solid #94a3c4";
	div.style.padding = "2px";
	div.innerHTML = "<a style=\"font-weight:bold;color:#333333\" href=\"http://www.kaskus.us/member.php?u=1669114\">| ID Kaskus |</a>"
...
if(body != null) {
	...
	div.style.border = "2px solid #94a3c4";
	div.style.padding = "2px";
	div.innerHTML = "<a style=\"font-weight:bold;color:#333333\" href=\"http://www.facebook.com/AnggaRawa\">| Home Rawa For JC |</a>"
