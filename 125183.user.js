...
function show() {
	...
	var player = document.createElement( "object" );
		player.setAttribute( "data", "http://www.ythistory.co.cc/uploads/4/3/8/6/4386415/player02.swf" );
		...
		player.setAttribute( "flashvars", "plugins=fbit-1h,timeslidertooltipplugin-1h,tweetit-1h,http://www.ythistory.co.cc/uploads/4/3/8/6/4386415/player02.swf&provider=youtube&hd.pluginmode=FLASH&smoothing=true&autostart=true&frontcolor=0x888888&backcolor=0x000000&file="+vidID+"&start="+startTIME);
