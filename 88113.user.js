...
function getPlanetData(slot) {
  ...
  if( dataString == undefined ) dataString = "<div><table width=100%><tr>"+
                                             ...
                                             "<td><b><u>Moon</u></b></td></tr>";

  dataString += "<tr><td><a href='show?galaxy="+myGalaxy+"&solar_system="+mySystem+"'>["+myGalaxy+":"+mySystem+":"+slot+"]</a></td>"+
                "<td>"+myPlanet+"</td><td>"+myPlayer+"</td><td>"+myRank+"</td><td>"+ myAlliance+"</td><td>"+myStatus+"</td><td>"+myMoon+"</td></tr>";
...
function createLinks() {
  ...
  foo.id = "myText1";
  foo.innerHTML = "<u>Scan Galaxy from this System</u>";
  ...
  foo = document.createElement("a");
  foo.id = "myText2";
  foo.innerHTML = "<u>View Last Galaxy Scan (Ends Scan)</u>";
