...
// @description   Modified version for La Vagie by Leon,stalin,nickmit,etc...
...
(function() {
 ...
 var version = '1.0.7'; // also, check meta-data field @version
...
(function() {
 ...
 function convert_unit( content ) {
	 ...
	 switch( content.factionEntityTagName ) {
	         ...
	         case "FORTRESS":
		         u = convert_fortress[content.unitEntityName];
			 break;
 ...
 function launch_jactari(switch_combat_side){
	 ...
	 try
	 {
	   donnees.saison = (HOMMK.player.content.worldSeasonNumber==2) || (HOMMK.player.content.worldSeasonNumber==3) ? 1 : 0;
		 ...
		 //if (hero.name == "Elendorn") {
		 //  donnees.a.tir_de_barrage = 10;
		 //}
	...
	if (!$dialog_about) {
		...
		$dialog_about = $('<div id="hommk-user-about"></div>')
			.html(
					...
					"\251 jeyries 2010"
					,'home page : <a href="http://userscripts.org/scripts/show/100365" class="ui-state-default" target="_blank">[userscript.org]</a>'
...
// Asbrand
	$('<button style="margin-top:5px; display:block;">Asbrand</button>')
	.button()
.appendTo($panel_extended)
	.click(function() {
			$(this).button('widget').removeClass( "ui-state-focus" );
			HOMMK_worldMap_center(70,24); // 6
			return false;
			});

// Berngeyr
	$('<button style="margin-top:5px; display:block;">Berngeyr</button>')
	.button()
.appendTo($panel_extended)
	.click(function() {
			$(this).button('widget').removeClass( "ui-state-focus" );
			HOMMK_worldMap_center(118,22); // 6
			return false;
			});

// Eirik
	$('<button style="margin-top:5px; display:block;">Eirik</button>')
	.button()
.appendTo($panel_extended)
	.click(function() {
			$(this).button('widget').removeClass( "ui-state-focus" );
			HOMMK_worldMap_center(172,17); // 6
			return false;
			});

// Fjori
	$('<button style="margin-top:5px; display:block;">Fjori</button>')
	.button()
.appendTo($panel_extended)
	.click(function() {
			$(this).button('widget').removeClass( "ui-state-focus" );
			HOMMK_worldMap_center(19,16); // 6
			return false;
			});

// Freywar
	$('<button style="margin-top:5px; display:block;">Freywar</button>')
	.button()
.appendTo($panel_extended)
	.click(function() {
			$(this).button('widget').removeClass( "ui-state-focus" );
			HOMMK_worldMap_center(71,68); // 6
			return false;
			});

// Frostfred
	$('<button style="margin-top:5px; display:block;">Frostfred</button>')
	.button()
.appendTo($panel_extended)
	.click(function() {
			$(this).button('widget').removeClass( "ui-state-focus" );
			HOMMK_worldMap_center(114,71); // 6
			return false;
			});

// Geirmir
	$('<button style="margin-top:5px; display:block;">Geirmir</button>')
	.button()
.appendTo($panel_extended)
	.click(function() {
			$(this).button('widget').removeClass( "ui-state-focus" );
			HOMMK_worldMap_center(167,70); // 6
			return false;
			});

// Gudmund
	$('<button style="margin-top:5px; display:block;">Gudmund</button>')
	.button()
.appendTo($panel_extended)
	.click(function() {
			$(this).button('widget').removeClass( "ui-state-focus" );
			HOMMK_worldMap_center(20,74); // 6
			return false;
			});

// Hring
	$('<button style="margin-top:5px; display:block;">Hring</button>')
	.button()
.appendTo($panel_extended)
	.click(function() {
			$(this).button('widget').removeClass( "ui-state-focus" );
			HOMMK_worldMap_center(70,117); // 6
			return false;
			});

// Hrottar
	$('<button style="margin-top:5px; display:block;">Hrottar</button>')
	.button()
.appendTo($panel_extended)
	.click(function() {
			$(this).button('widget').removeClass( "ui-state-focus" );
			HOMMK_worldMap_center(116,126); // 6
			return false;
			});

// Hyrkjolf
	$('<button style="margin-top:5px; display:block;">Hyrkjolf</button>')
	.button()
.appendTo($panel_extended)
	.click(function() {
			$(this).button('widget').removeClass( "ui-state-focus" );
			HOMMK_worldMap_center(167,124); // 6
			return false;
			});

// Icegerd
	$('<button style="margin-top:5px; display:block;">Icegerd</button>')
	.button()
.appendTo($panel_extended)
	.click(function() {
			$(this).button('widget').removeClass( "ui-state-focus" );
			HOMMK_worldMap_center(16,120); // 6
			return false;
			});

// Jarveg
	$('<button style="margin-top:5px; display:block;">Jarveg</button>')
	.button()
.appendTo($panel_extended)
	.click(function() {
			$(this).button('widget').removeClass( "ui-state-focus" );
			HOMMK_worldMap_center(68,166); // 6
			return false;
			});

// Knud
	$('<button style="margin-top:5px; display:block;">Knud</button>')
	.button()
.appendTo($panel_extended)
	.click(function() {
			$(this).button('widget').removeClass( "ui-state-focus" );
			HOMMK_worldMap_center(113,173); // 6
			return false;
			});

// Kolvard
	$('<button style="margin-top:5px; display:block;">Kolvard</button>')
	.button()
.appendTo($panel_extended)
	.click(function() {
			$(this).button('widget').removeClass( "ui-state-focus" );
			HOMMK_worldMap_center(166,166); // 6
			return false;
			});

// L'etolf
	$('<button style="margin-top:5px; display:block;">L\'etolf</button>')
	.button()
.appendTo($panel_extended)
	.click(function() {
			$(this).button('widget').removeClass( "ui-state-focus" );
			HOMMK_worldMap_center(25,165); // 6
			return false;
			});
