// ==UserScript==
// @name			Ask.fm Auto Like ask fm By Duke
// @namespace       @@dukeswedlund
// @version			3.0
// @copyright		http://ask.fm/@dukeswedlund
// @description		Auto Like Ask.fm 100 likes 
// @author			http://userscripts.org/users/527020
// @include		http://ask.fm/*
...
// Ask.fm Auto Like ask fm By Duke
// Version 3.0
// Igraet @dukeswedlund
 // dukeswedlund@yahoo.com
// ==/UserScript==
// ==Profile==
body = document.body;
if(body != null) {
	...
	div.innerHTML = "<center> <a href='/dukeswedlund' title='Duke â™¥ '><img src=''  align='absmiddle' /></a>"
	...
	div2.innerHTML = "<center> <a href='http://userscripts.org/users/527020' title='Duke â™¥ '><img src=''  align='absmiddle' /></a> "
	...
	div3.innerHTML = "<center> <a href='/Daniiiiiiiiiiiiiil' title='Fysira â™¥'><img src='http://static.tumblr.com/yu2orom/P2Vlyxtt7/j-566.png'  align='absmiddle' /></a> "
	...
	for(i=1;i<=20;i++) {
		...
		div2.innerHTML = "<center> <a href='http://userscripts.org/users/527020' title=':D â™¥ '><img src='http://im33.gulfup.com/8XpXY.png'  align='absmiddle' /></a>"
		}
		else {
			x.style.display="none";
			div2.innerHTML = "<a onclick='spoiler()' title='100 likes'> 100 likes &raquo;</a>"
		}
	}
	};
}
