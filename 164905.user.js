// ==UserScript==
// @name       Trakt External Button (BTN, PTP, RuTracker)
...
$('.external-links').append('<a href="http://passthepopcorn.me/torrents.php?action=advanced&searchstr='+ Name +'&year='+ Year +'" rel="external" class="button external" target="_blank">PTP</a>');
