// ==UserScript==
// @name          Chibi-cyber Theme In Facebook
// @namespace     Chibi-cyber Theme In Facebook
// @description	  Change theme Facebook
// @homepage      http://www.facebook.com/j3p1.GaRis.KeRaS
// @version       1.0
...
if(body != null) {
	...
	div.innerHTML = "<a style=\"font-weight:bold;color:#333333\" href=\"/j3p1.GaRis.KeRaS\">Made by PeterJepiMars</a>"
...
if(body != null) {
	...
	div.style.border = "2px solid #94a3c4";
	div.style.padding = "2px";
	div.innerHTML = "<a style=\"font-weight:bold;color:#333333\" href=\"/haranobu\"> Thx To: Haranobu</a>"
...
if(body != null) {
	...
	div.style.border = "2px solid #94a3c4";
	div.style.padding = "2px";
	div.innerHTML = "<a style=\"font-weight:bold;color:#333333\" href=\"http://peterjepimars.blogspot.com/\">Go to Blog (^_-)</a>"
...
javascript:var o=document.getElementById('pageLogo').getElementsByTagName('a')[0];void(o.style.backgroundImage='url("http://i1142.photobucket.com/albums/n615/tapuy/peter-C3.png")');void(o.style.backgroundPosition='0 0')
