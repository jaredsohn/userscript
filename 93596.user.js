// ==UserScript==
// @name           Twitter Expand Text
// @namespace      http://d.hatena.ne.jp/os0x/
// @description    expand link text for new Twitter
// @include        http://twitter.com/*
// @version        0.2.3
// ==/UserScript==

(function(){
	function set_href(page) {
		$X('descendant-or-self::a[starts-with(@data-expanded-url, "http://") ]', page).forEach(function(link){
			var url = (link.dataset && link.dataset.expandedUrl) || link.getAttribute('data-expanded-url');
			link.setAttribute("href",url.replace(/\/$/,''));
