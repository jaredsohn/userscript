// ==UserScript==
// @name YoukuAntiADs.John版
// @author Harv
// @description 视频去广告
// @version 20140228
// @namespace http://userscripts.org/users/Harv
// @updateURL https://userscripts.org/scripts/source/399500.meta.js
// @downloadURL https://userscripts.org/scripts/source/399500.user.js
// @include http://*/*
// @include https://*/*
...
(function () {
    ...
    YoukuAntiAds.prototype = {
        ...
        getplayers() {
            if (!this._players) {
                this._players = {
                    'youku_loader': 'http://johnzhang.fxox.cn/swf/loader.swf',
                    'youku_player': 'http://johnzhang.fxox.cn/swf/player.swf',
                    'ku6': 'http://johnzhang.fxox.cn/swf/ku6.swf',
                    'ku6_out': 'http://johnzhang.fxox.cn/swf/ku6_out.swf',
                    'iqiyi': 'http://johnzhang.fxox.cn/swf/iqiyi.swf',
                    'iqiyi5': 'http://johnzhang.fxox.cn/swf/iqiyi5.swf',
                    'iqiyi_out': 'http://johnzhang.fxox.cn/swf/iqiyi_out.swf',
                    'tudou': 'http://johnzhang.fxox.cn/swf/tudou.swf',
                    'tudou_olc': 'http://johnzhang.fxox.cn/swf/olc_8.swf',
                    'tudou_sp': 'http://johnzhang.fxox.cn/swf/sp.swf',
                    'letv': 'http://johnzhang.fxox.cn/swf/letv.swf'
                    'sohu': 'http://johnzhang.fxox.cn/swf/sohu.swf'
                    'pplive_live': 'http://johnzhang.fxox.cn/swf/pplive_live.swf'
                    'pplive': 'http://johnzhang.fxox.cn/swf/pplive.swf'
                };
            }
            ...
            if (!this._rules) {
                this._rules = {
                    ...
                    'sohu': {
                        ...
                        're': /http:\/\/tv\.sohu\.com\/upload\/swf(\/p2p(\/yc)?)?\/\d{8}\/(main|playershell)\.swf/i
                    }
                }
            }
            return this._rules;
