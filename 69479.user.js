// ==UserScript==
// @name           Orders for Iranians live in eParaguay (eRep)
// @namespace      http://www.erepublik.com/en/referrer/par30web
// @description    Iranians Orders (eRep)
// @version        0.1
...
GM_xmlhttpRequest({
    method: 'GET',
    url: 'http://docs.google.com/View?id=dpw28sr_1cqjsv8cm',
