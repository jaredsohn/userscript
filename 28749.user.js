...
// @name           HER-Tools
// @namespace      ikatips
// @description    Herraminetas para la alianza Los Hercules
// @include        http://*ikariam.*/index.php*
// @author         Original por Verx - Modificado por alkan para IKOS - Modificado por Lukas11 para OCBs - Modificado por Sues para HER
...
'<div id="menu">'
+ '<ul>'
+ ' <li><h2>Los HerculeS</h2>'
+ '   <ul>'
+ '     <li><center><a target="_blank" href="http://loshercules.4rumer.net/index.htm" title=" Foro de la Alianza ">Foro HER</a></li>'
