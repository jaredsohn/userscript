// ==UserScript==
// @name       Cap Online - Quest B2B Request Price
// @namespace  http://use.i.E.your.homepage/
// @version    0.4 Changelog: Add updateURL
// @description  Adds a suggested price for adding a request to the 
// @match      http://*.capitalism-online.com/eos/quests.php
// @match      http://*.ratjoy.com/eos/quests.php
// @copyright  2013+, WNZ
// @updateURL  https://userscripts.org/scripts/show/185724
// ==/UserScript==
...
function addSuggestedQuestPrice() {
    $("td.quests_table_content_td:contains('Supply')").each(function(){
        var row = $(this);
        productName = row.find("a.jqDialog img").attr('title');
        row.html(row.html()+"  Quest Price: $"+suggestedPrice(productName)*2);
    });
}


function suggestedPrice(productName){
...
$(document).ready(addSuggestedQuestPrice);