// ==UserScript==
// @name          Cass District Library Linky
// @namespace     http://fatknowledge.blogspot.com
// @description	  v1.01 Search the Cass District Library Catalog from Amazon book listings.  
// @include       http://*.amazon.*
// ==/UserScript==
...
// This version bassed entirely on the Seattle Public Library Linky

(function(){
//	GM_log('Amazon Cass District Library Linky');	
 
	var libraryUrlPattern = 'http://cdl.dnsalias.org/ipac20/ipac.jsp?index=ISBNEX&term='
	var libraryName = 'the Cass District Library';
