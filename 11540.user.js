...
if(div && title)
{
    ...
    buildCell(tr, "monova","http://search.monova.org/search.php?term="+txt+"&cat=1&verified=", img);
    ...
    buildCell(tr, "Kickass Torrents","http://www.kickasstorrents.com/torrents/search/?q="+txt+"&categories[]=movies", img)
