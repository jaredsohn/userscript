...
// @description    Comenzi Oficiale eRomania
// @version        1.00
// @include        http://www2.erepublik.com/en
// @include        http://www2.erepublik.com/en/wars/1
// ==/UserScript==

// script de pe erepstats.com modificat: user eRep: Cristy2005ro 
...
GM_xmlhttpRequest({
	...
	onload:function(responseDetails){
			...
			titlu_el.innerHTML='<h1 class=\"sIFR-replaced\"><embed class=\"sIFR-flash\" height=\"28\" width=\"250\" src=\"/flash/delicious.swf\" quality=\"best\" flashvars=\"txt=Azi se lupta aici:&&textcolor=#737373&hovercolor=null&linkcolor=null&w=250&h=28\" wmode=\"transparent\" bgcolor=\"transparent\" sifr=\"true\" type=\"application/x-shockwave-flash\" style=\"width: 250px; height: 28px;\"/></h1></div>'
