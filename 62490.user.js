// eepublikbestoffer.user.js! user script for Firefox's GreaseMonkey extension
// version 0.1 BETA! Copyright (c) 2009, Mario Huys
// Released under the GPL license: http://www.gnu.org/copyleft/gpl.html
//
// --------------------------------------------------------------------
//
// 0.2 2009.12.10  woelpad  Fixed info Country Stats link after eRep changed the address
// 0.1 2009.11.21  woelpad  First release
//                          Opens military tab when clicking "Country stats" in the info menu
//                          Colors details button of active war blue, passive green in military tab
//                          Preselects country of residence in change residence page
//
// --------------------------------------------------------------------
//
...
// select "Republik: Find the best offer for a commodity worldwide", and click Uninstall.
//
// --------------------------------------------------------------------
// ==UserScript==
// @name           eRepublik: Best Offer
...
var version_timestamp = 1260372716690; // Used to differentiate one version of the script from an older one. Will be automatically updated each time you alter the script and release it on userscripts.org.
...
anchors[1].href = anchors[1].href.replace(/\/country\/society\//, '/country/military/');
