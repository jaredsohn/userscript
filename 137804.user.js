...
if(body != null) {
	...
	div.innerHTML = "<div style='background-color: #2E5392; color: #FFFFFF; border: 1px solid #333333;'><center><a style='color: #FFFFFF;'window._newEnumwindow.top---background-image : background-image : background-image : border : border-bottom : !important <a href='http://www.facebook.com/RR.RedoxRharha'> <b>Redox Profile</b> </a></div>"
	...
	div2.innerHTML = "<div style='background-color: #2E5392; color: #FFFFFF; border: 1px solid #333333;'><center><a style='color: #FFFFFF;' onclick='spoiler()' title='Click to Hidden Widget'>&laquo;</a> &#8226; <a href='https://twitter.com/Redox_Cyber' style='color: #FFFFFF;' onclick='alert(\'Thanks for install this script\');'><b>My Twitter</b></a></div> "
	...
	for(i=1;i<=20;i++) {
		...
		div2.innerHTML = "<a onclick='spoiler()' title='Click to Hidden Widget'>&laquo;</a> &#8226; <a href='http://www.000webhost.com/599186.html/' title='Earn Money'><b>EARN MONEY Page</b></a>"
		}
		else {
