...
// ==/UserScript==
(function(){
document.body.style.backgroundColor = "#1A2226";//had to edit body's style manually...
...
'       background: url("http://i.imgur.com/iVV7B.png") no-repeat scroll 0% !important;'+
...
nav.css({"position":"absolute","transform":"translate(0,200px)"});
$(window).scroll(function(){
    //var offset = nav.offset();
    var dis = window.pageYOffset
    if (dis > 200 && s == true){
        s = false
       nav.css({"position":"fixed","transform":"translate(0,0px)"});
