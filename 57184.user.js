// ==UserScript==
 // @name            Apple Trailer Download (Fixed)
 // @namespace       http://mirzmaster.wordpress.com
...
function getDownloadLink() {
	...
	var nobjects = xpath(document, "//a[@class='large' or @class='small' or @class='medium' or @class='hd' or @class='target-quicktimeplayer']");
