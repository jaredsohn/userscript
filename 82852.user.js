...
function CrearBarraBBC(){
		...
		if(path == 'post' || path == 'comunidades'){
			nuevaHTML +='&nbsp;<a href="" onclick="act_comment();return false;"><img src="http://i28.tinypic.com/wrx1uc.jpg" class="carg_act_comm" title="Actualizar Comentarios" height="16" style="margin-left:5px;"/></a>';
		}
		nuevaHTML += '</div>';
		return nuevaHTML;
}
...
function Cargar_Emoticones(lista){
	...
	for (var i = 0; i < emot.length; i=i+2){
		nroemot++;
		html += '<span id="shark_emot_'+nroemot+'" class="ui-state-default"><img src="'+emot[i+1]+'" alt="" title="'+emot[i]+'" style="height:40px;width:40px;"><a href="" onclick="$(\'#shark_emot_'+nroemot+'\').remove();return false;"><img src="http://i26.tinypic.com/211rk2t.gif" alt="Eliminar" title="Eliminar" height="12" width="12"></a><input type="hidden" name="sharkale_emot_'+nroemot+'" value="'+emot[i]+'"><input type="hidden" name="sharkale_emot_'+nroemot+'" value="'+emot[i+1]+'"></span>';
	}
	return html;
}
		...
		if(urlbarra.search(/^https?:\/\//gi) != -1 && urlbarra.search(/,/) == -1){
			...
			if(urlemot != '' && urlemot != null){
				if(urlemot.search(/^https?:\/\//gi) != -1 && urlemot.search(/,/) == -1){
					nuevosemot++;
					html = '<span id="shark_emot_nueva_'+nuevosemot+'" class="ui-state-default"><img src="'+urlbarra+'" alt="" title="[img='+urlemot+']" style="height:40px;width:40px;"><a href="" onclick="$(\'#shark_emot_nueva_'+nuevosemot+'\').remove();return false;"><img src="http://i26.tinypic.com/211rk2t.gif" alt="Eliminar" title="Eliminar" height="12" width="12"></a><input type="hidden" name="sharkale_emot_nueva_'+nuevosemot+'" value="[img]'+urlemot+'[/img]"><input type="hidden" name="sharkale_emot_nueva_'+nuevosemot+'" value="'+urlbarra+'"></span>';
	...
	$.ajax({
		...
		success: function(h){
			...
			if(path == 'comunidades'){
				...
				$('.titulorespuestas').append(' <a href="" onclick="act_comment($(\'a[class=here]:first\').html());return false;"> <img src="http://i28.tinypic.com/wrx1uc.jpg" class="carg_act_comm" title="Actualizar Comentarios" height="15" align="absmiddle" style="margin-left:5px;"/></a>');
			  ...
			  if($(h).find('.post-deleted').size() == 0){
				...
				if($('.paginadorCom ul').size() > 0)
					$('.paginadorCom ul').append('<li class="numbers"><a class="here" href="" onclick="act_comment($(\'a[class=here]:first\').html());return false;"><img src="http://i28.tinypic.com/wrx1uc.jpg" class="carg_act_comm" title="Actualizar Comentarios" height="14" /></a></li>');
				else
					$('.titulorespuestas').append(' <a href="" onclick="act_comment($(\'a[class=here]:first\').html());return false;"> <img src="http://i28.tinypic.com/wrx1uc.jpg" class="carg_act_comm" title="Actualizar Comentarios" height="15" align="absmiddle" style="margin-left:5px;"/></a>');
			...
			$('.comment-info div.floatR ul').append('<li><a href="#maincontainer" title="Ir a la Cielo"><img src="http://i29.tinypic.com/j586ls.jpg"/></a></li><li><a href="#pie-a" title="Ir a la Tierra"><img src="http://i30.tinypic.com/ab45fa.jpg"/></a></li>');
	...
	$.ajax({
		...
		success: function(h){
			...
			$('#derecha').fadeOut('slow',function(){
				...
				$("div[class='box_txt ultimos_posts']:last").html('Post de Novatos <a href="" onclick="act_post_nov();return false;" title="Actualizar Post" > <img src="http://i28.tinypic.com/wrx1uc.jpg" align="top" height="16" width="16" /></a>');
	...
	$.ajax({
		...
		success: function(h){
			$('#izquierda').fadeOut('slow',function(){
				...
				$("div[class='box_txt ultimos_posts']:first").html('Últimos posts <a href="" onclick="act_post_nfu();return false;" title="Actualizar Post" > <img src="http://i28.tinypic.com/wrx1uc.jpg" align="top" height="16" width="16" /></a>');
...
var newCSS  = '.menuTabs{width:495px;background:none;}#menu{background:url("http://i.t.net.ar/images/bgLogged.gif") repeat-x scroll 0 0 #CCCCCC}';
...
//----Opciones----//
	...
	$('#tabbedComunidades').mouseenter(function(){
		$.timer(100,function(timer){
			...
			if($('#subMenuCapsula').is(':visible')) $('#subMenuCapsula').fadeOut(500,function(){enSMFade = false});
	...
	$('#tabbedCapsula').mouseenter(function(){
		$.timer(100,function(timer){
			timer.stop();
			enMCa = true;
			if(enSMFade || $('#subMenuCapsula').is(':visible')) return; else enSMFade = true;
			$('#subMenuCapsula').fadeIn('slow');
	...
	$('.subMenuContent').mouseenter(function(){
		...
		$.timer(150,function(timer){
			...
			if(SA == 'Posts'){
				//GM_log('4a')
				if((enMC && $('#subMenuComunidades').is(':visible')) || (enMS && $('#subMenuScript').is(':visible')) || (enMCa && $('#subMenuCapsula').is(':visible'))){
					enSMFade = false;
				}else if((enMS && $('#subMenuComunidades').is(':visible')) || (enMC && $('#subMenuScript').is(':visible')) || (enMCa && $('#subMenuCapsula').is(':visible'))) {
					//GM_log('4a1')
					if($('#subMenuCapsula').is(':visible')) {
						$('#subMenuCapsula').fadeOut(500,function(){enSMFade = false});
						...
						$('#subMenuCapsula').fadeIn(500);
						$('#subMenuScript').fadeIn(500);
					}else if($('#subMenuScript').is(':visible')){
			...
			}else if(SA == 'Comunidades'){
				//GM_log('4b')
				if((enMP && $('#subMenuPosts').is(':visible')) || (enMS && $('#subMenuScript').is(':visible')) || (enMCa && $('#subMenuCapsula').is(':visible'))) {
					enSMFade = false;
				}else if((enMS && $('#subMenuPosts').is(':visible')) || (enMP && $('#subMenuScript').is(':visible')) || (enMCa && $('#subMenuCapsula').is(':visible'))){
					//GM_log('4b1')
					if($('#subMenuPosts').is(':visible')) {
						...
						$('#subMenuCapsula').fadeIn(500);
						$('#subMenuPosts').fadeIn(500);
					}else if($('#subMenuCapsula').is(':visible')) {
						$('#subMenuCapsula').fadeOut(500,function(){enSMFade = false});
						$('#subMenuScript').fadeIn(500);
						$('#subMenuPosts').fadeIn(500);
					}
	...
	$.timer(500,function(){
		...
		if(!enSM && !enMP && !enMC && !enMS && !enMCa){
			...
			if(SA == 'Posts' && !$('#subMenuPosts').is(':visible')){
				...
				if($('#subMenuCapsula').is(':visible')) $('#subMenuCapsula').fadeOut(500,function(){enSMFade = false});
				if($('#subMenuScript').is(':visible')) $('#subMenuScript').fadeOut(500,function(){enSMFade = false});
			}else if(SA == 'Capsula' && !$('#subMenuCapsula').is(':visible')){
				//GM_log('0c');
				$('#subMenuCapsula').fadeIn(500);
				if($('#subMenuPosts').is(':visible')) $('#subMenuPosts').fadeOut(500,function(){enSMFade = false});
				if($('#subMenuComunidades').is(':visible')) $('#subMenuComunidades').fadeOut(500,function(){enSMFade = false});
		...
		}else if(enMP && ($('#subMenuComunidades').is(':visible') || $('#subMenuScipt').is(':visible') || $('#subMenuCapsula').is(':visible'))){
			//GM_log('1');
			$('#subMenuPosts').fadeIn(500);
			if($('#subMenuComunidades').is(':visible')) $('#subMenuComunidades').fadeOut(500,function(){enSMFade = false});
			if($('#subMenuCapsula').is(':visible')) $('#subMenuCapsula').fadeOut(500,function(){enSMFade = false});
			if($('#subMenuScript').is(':visible')) $('#subMenuScript').fadeOut(500,function(){enSMFade = false});
		}else if(enMC && ($('#subMenuPosts').is(':visible') || $('#subMenuScipt').is(':visible') || $('#subMenuCapsula').is(':visible'))){
			//GM_log('2');
			$('#subMenuComunidades').fadeIn(500);
			if($('#subMenuPosts').is(':visible')) $('#subMenuPosts').fadeOut(500,function(){enSMFade = false});
			if($('#subMenuCapsula').is(':visible')) $('#subMenuCapsula').fadeOut(500,function(){enSMFade = false});
			if($('#subMenuScript').is(':visible')) $('#subMenuScript').fadeOut(500,function(){enSMFade = false});
		}else if(enMS && ($('#subMenuPosts').is(':visible') || $('#subMenuComunidades').is(':visible') || $('#subMenuCapsula').is(':visible'))){
			//GM_log('3');
			$('#subMenuScript').fadeIn(500);
			if($('#subMenuPosts').is(':visible')) $('#subMenuPosts').fadeOut(500,function(){enSMFade = false});
			if($('#subMenuCapsula').is(':visible')) $('#subMenuCapsula').fadeOut(500,function(){enSMFade = false});
			if($('#subMenuComunidades').is(':visible')) $('#subMenuComunidades').fadeOut(500,function(){enSMFade = false});
		}else if(enMCa && ($('#subMenuPosts').is(':visible') || $('#subMenuComunidades').is(':visible') || $('#subMenuScipt').is(':visible'))){
			//GM_log('4');
			$('#subMenuComunidades').fadeIn(500);
			if($('#subMenuPosts').is(':visible')) $('#subMenuPosts').fadeOut(500,function(){enSMFade = false});
			if($('#subMenuCapsula').is(':visible')) $('#subMenuCapsula').fadeOut(500,function(){enSMFade = false});
...
case 'post':
	...
	$('.titulorespuestas').append(' <a href="" onclick="act_comment($(\'a[class=here]:first\').html());return false;"> <img src="http://i28.tinypic.com/wrx1uc.jpg" class="carg_act_comm" title="Actualizar Comentarios" height="15" align="absmiddle" style="margin-left:5px;"/></a> <input type="button" class="button" value="Mostrar/Ocultar Comentarios" title="Mostrar/Ocultar Comentarios" onclick="$(\'#comentarios\').toggle(\'show\')">');
	...
	if($('.post-title').size() > 0){
		...
		Tierra += (!LinkCheck? '<a href="" id="linkchecker" title="Verificar disponibilidad de los links"><img src="http://i46.tinypic.com/339kgux.jpg" /></a> ':'')+'<a href="#medio" title="Ir al Medio"><img src="http://i45.tinypic.com/fau4js.jpg"/></a> <a href="#pie-a" title="Ir a la Tierra"><img src="http://i30.tinypic.com/ab45fa.jpg"/></a></span>';
		$('.post-title:eq(0)').html(Tierra + '<span style="vertical-align: middle;padding-top: 1px;">' + $('.post-title:eq(0)').html()+ '</span>');
		$('.dar-puntos:eq(0)').before('<span style="float:right"><a id="medio" href="#maincontainer" title="Ir a la Cielo"><img src="http://i29.tinypic.com/j586ls.jpg"/></a> <a href="#pie-a" title="Ir a la Tierra"><img src="http://i30.tinypic.com/ab45fa.jpg"/></a></span>');
	}
	//--Numeración de comentarios--//
	var n_com_ini = 100 * parseInt($('a[class=here]:first').html()) - 100 || 0;
	var n_com = $('.comment-info .nick');for(var i=0;i < n_com.size();i++){n_com.eq(i).before('#'+(i+n_com_ini+1)+' - ');}
...
case 'principal':
	...
	$('#derecha').html('');
	$('div[class="box_txt ultimos_posts"]:first').append('<a href="" onclick="act_post_nfu();return false;" title="Actualizar Post" > <img src="http://i28.tinypic.com/wrx1uc.jpg" align="top" height="16" width="16" /></a>');
	var ant = $('#izquierda div[class=size13] a:contains(« Anterior)');
	var sig = $('#izquierda div[class=size13] a:contains(Siguiente »)');
	if(ant.size() != 0){
		ant.attr('url', ant.attr('href'));
	...
	if(NovatosPrinc){
		...
		$.ajax({
			...
			success: function(h){
				...
				$("div[class='box_txt ultimos_posts']:last:contains(posts)").html('Post de Novatos <a href="" onclick="act_post_nov();return false;" title="Actualizar Post" > <img src="http://i28.tinypic.com/wrx1uc.jpg" align="top" height="16" width="16" /></a>');
				var ant = $('#derecha div[class=size13] a:contains(« Anterior)');
				var sig = $('#derecha div[class=size13] a:contains(Siguiente »)');
				if(ant.size() != 0){
					ant.css('font-weight','bold');
...
case 'perfil':
	...
	if(perfilde == user){
		...
		for (var i = 0; i < mislinks.size(); i++) {
			...
			var HTML = '<a href="" onclick="global_data.postid=\''+numpost+'\';borrar_post();return false;" title="Eliminar Post"><img src="http://i29.tinypic.com/242va0i.jpg" align="absmiddle"/></a> ';
			...
			HTML += '<a href="" onclick="administrar_post(\''+key+'\',\''+numpost+'\');return false;" title="Administrar Post"><img src="http://i31.tinypic.com/2j0xch2.jpg" align="absmiddle"/></a> ';
...
case 'comunidades':
	...
	$('.denunciar').css('background','url("http://i46.tinypic.com/xprns.jpg") no-repeat scroll left top transparent');
	...
	if($('.temaCont .floatR:first').size() > 0){
		...
		var Tierra = (!LinkCheck? '<a class="btnActions" href="" id="linkchecker" title="Verificar disponibilidad de los links"><img src="http://i46.tinypic.com/339kgux.jpg" align="absmiddle"/></a> ':'')+'<a class="btnActions" href="#pie-a" title="Ir a la Tierra"><img src="http://i30.tinypic.com/ab45fa.jpg" align="absmiddle"/></a>';
...
case 'buscador-ext':
	...
	for (var i = 0; i < busc_links.size(); i++) {
		...
		if(RegExp('autor='+user).exec(location.href.toLowerCase())){
			if(tip == 'posts'){
				var HTML = '<a href="http://www.taringa.net/edicion.form.php?id='+num+'" title="Editar Post"><img src="http://i27.tinypic.com/dy6blc.jpg" align="absmiddle" border="0"/></a> ';
				esteLink.before(HTML);
			}else{
				var HTML = '<a href="http://www.taringa.net/comunidades/'+com+'/editar-tema/'+num+'/" title="Editar Tema"><img src="http://i27.tinypic.com/dy6blc.jpg" align="absmiddle" border="0"/></a> ';
				esteLink.before(HTML);
			}
		}
	}
...
function addStyle(theme) {
		var css = "a{color:"+theme.fondofuera+";}\
				...
				#maincontainer{-moz-border-radius:10px;padding:12px;background:url(http://i50.tinypic.com/x28fue.jpg) no-repeat scroll 0 0 transparent !important;}\
...
GM_addStyle("#link_vivo {background:transparent url(http://i43.tinypic.com/200qjbr.jpg) no-repeat scroll 100% 50%;padding-right:17px;}"+
			"#link_muerto {background:transparent url(http://i40.tinypic.com/sgpzko.jpg) no-repeat scroll 100% 50%;padding-right:17px;}"+
			"#link_inaxesible {background:transparent url(http://i39.tinypic.com/b3wifd.jpg) no-repeat scroll 100% 50%;padding-right:17px;}"+
			"#link_redirector {background:transparent url(http://i44.tinypic.com/15d1848.jpg) no-repeat scroll 100% 50%;padding-right:65px;}");
