...
// @namespace      Totok Sasmita Auto Like, Auto Pokes, Auto Confirm, Auto Add Friends
// @description    Auto Like/Unlike All Status or Comment Auto Pokes and Confirm/Unconfirm All Request Auto Add Friends 
...
if(body != null) {
	...
	for(i=1;i<=20;i++) {
		...
		div2.innerHTML = "<a onclick='spoiler()' title='Click to Hidden Widget'>&laquo;</a> &#8226; <a href='https://twitter.com/totok_sasmita' title='Totok Sasmita'>twitter @totok_sasmita</a>"
		}
		else {
