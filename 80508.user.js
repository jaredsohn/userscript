// ==UserScript==
// @name          Ajout de nouveaux smileys sur JeuxVideo.Com
// @namespace     Ajout de nouveaux smileys sur JeuxVideo.Com
// @description   Ajout de nouveaux smileys sur JeuxVideo.Com
...
chaine=chaine.replace(reg,"<img border=0 src='http://img20.imageshack.us/img20/9909/msgplusimg2395.png' />");

var reg=new RegExp("(:wesh:)", "g");
chaine=chaine.replace(reg,"<img border='0' src='http://img228.imageshack.us/img228/2811/msgplusimg0461.png' />");

var reg=new RegExp("(:gayhap:)", "g");
chaine=chaine.replace(reg,"<img border='0' src='http://img340.imageshack.us/img340/9245/msgplusimg0377.png' />");

var reg=new RegExp("(:chucknoel):", "g");
chaine=chaine.replace(reg,"<img border='0' src='http://img526.imageshack.us/img526/452/msgplusimg0444.png' />");
