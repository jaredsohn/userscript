...
function funcionPrincipal(e){
	...
	lang_en['VENDER'] 	= 'بيع';
	lang_en['ENVIAR_IGM'] 	= 'ارسال رسالة';
	lang_en['LISTO'] 	= 'يتاح';
	lang_en['EL'] 		= 'في';
	lang_en['A_LAS'] 	= 'في';
	...
	lang_en['FUNDAR']       = 'يمكنك امتلاك قرية جديدة';
	lang_en['ALDEAS']       = 'قرى';
	...
	lang_en['COMP']         = 'تقرير الضاغط';
	lang_en['STAT']		= 'الأحصائيات';
	lang_en['OFREZCO']	= 'عروض';
	lang_en['BUSCO']	= 'بحث';
	lang_en['TIPO']		= 'النوع';
	lang_en['DISPONIBLE']	= 'فقط متاحة';
	lang_en['CUALQUIERA']	= 'Any';
	lang_en['SI']		= 'نعم';
	lang_en['NO']		= 'لا';
        lang_en['MARCADORES']   = 'الروابط';
        lang_en['ANYADIR']      = 'إضافه';
        lang_en['ENLACE']       = 'الرابط';
        lang_en['TEXTO']        = 'الاسم';
	lang_en['ELIMINAR']	= 'حذف';
	lang_en['MAPA']		= 'الخريطه';
	lang_en['ARCHIVE']	= 'الارشيف';
	lang_en['RESUMEN']	= 'موجز';
