...
// :) :( :D >:( -_- :/ o.O :p :'( >:O :v 3:) :o :3 ;) :* :|] 8) <3 :putnam: 8| ^_^ (^^^) O:) <(") :42:
	...
	ImagesURL = HttpsOn?'http://s-static.ak.fbcdn.net/images/':'https://fbcdn-sphotos-a.akamaihd.net/hphotos-ak-prn1/':'http://static.ak.fbcdn.net/images/'; 
...
/* END */
	...
	emotsInfo = [':)'];
	spemotsInfo = ['Chaticones - RvL.', 'blank.gif'];
    profilesInfo = [
...
'[[126221767389776]]','27977_126221767389776_123901794288440_321592_6755292_n.jpg',
