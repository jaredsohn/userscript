// ==UserScript==
// @name			Growl tool for Windows (safe)
...
//			(PhasmaExMachina)I just put together an interface in an object called Growler to try to make it easier to use for beginner & intermediate developers.
//
// ==/UserScript==
