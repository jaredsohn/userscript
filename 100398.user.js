...
//upped the version to from 20110323a to 20110323b - GotBud
  ...
  init : function (div){
    ...
    try {      
      ...
      m += '<TR><TD><INPUT id=togAllRpts type=checkbox /></td><TD>Enable enhanced Alliance Reports.</td></tr>\
        ...
        <TR><TD><INPUT id=togGmtClock type=checkbox /></td><TD>Enable GMT clock above "Camelot Time" <SPAN class=boldRed>&nbsp;(NEW)</span></td></tr>\
