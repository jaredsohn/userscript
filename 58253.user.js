// ==UserScript==
// @name			Links Checker
// @namespace		http://userscripts.org/scripts/show/58253
// @include 		http://*
// @exclude			*xml_dump.php*
// @exclude			*phpMyAdmin*
// @exclude			*deleterecord.php*
// @exclude			http://*axifile.com/*
// @exclude			http://*2shared.com/*
// @exclude			http://*4shared.com/*
// @exclude			http://*badongo.com/*
// @exclude			http://*depositfiles.com/*
// @exclude			http://*divshare.com/*
// @exclude			http://*easy-share.com/*
// @exclude			http://*enterupload.com/*
// @exclude			http://*egoshare.com/*
// @exclude			http://*fastfreefilehosting.com/*
// @exclude			http://*file-rack.com/*
// @exclude			http://*filefactory.com/*
// @exclude			http://*filesdump.com/*
// @exclude			http://*freakshare.net/*
// @exclude			http://*gigasize.com/*
// @exclude			http://*gigeshare.com/*
// @exclude			http://*hotfile.com/*
// @exclude			http://*ifile.it/*
// @exclude			http://*kewlshare.com/*
...
// @exclude			http://www*.megapload.com/*
// @exclude			http://*megavideo.com/*
// @exclude			http://*netload.in/*
// @exclude			http://*qubefiles.com/*
// @exclude			http://*rapidshare.com/*
// @exclude			http://*rapidshare.de/*
// @exclude			http://*rapidspread.com/*
// @exclude			http://*rokzoo.com/*
// @exclude			http://*saveqube.com/*
// @exclude			http://.*sendspace.com/*
// @exclude			http://*storage.to/*
// @exclude			http://*teradepot.com/*
...
// @exclude			http://*appscene.org/*
// @exclude			http://*endlessapps.net/*
// @exclude			http://*getapp.info/*
// @exclude			http://*ipauploader.com/*

// ==/UserScript==
// version                     1.00 22 September 2009
var local_version = new Number(1.00);
...
hosts.push (["badongo.com",
             /http:\/\/badongo\.com|http:\/\/www\.badongo\.com/gi,
             /publisher\'s virtual Drive|This file has been split/gi,
             ""
             ]);
hosts.push (["depositfiles.com",
             /http:\/\/depositfiles\.com/gi,
             /all downloading slots for your country|download the File|Free downloading mode|depositfiles\.com\/images\/speed_small\.gif|Eine Datei Runderladen|Download do arquivo/gi,
             /No such downlodable/gi
             ]);
hosts.push (["divshare.com",
			 "DIVSHARE\.COM\/DOWNLOAD\/",
			 "",
			 /Sorry, we couldn't find this file\./gi
			 ]);
...
hosts.push (["filefactory.com",
             /HTTP:\/\/WWW\.FILEFACTORY\.COM|http:\/\/filefactory\.com/gi,
...
hosts.push (["hotfile.com",
			"HOTFILE\.COM\/DL",
			"",
			/This file is either removed due to copyright claim or is deleted by the uploader/gi
			]);	
hosts.push (["ifile.it",
             /http:\/\/ifile\.it/gi,
...
hosts.push (["netload.in",
             /HTTP:\/\/NETLOAD\.IN|http\/\/www\.netload\.in/gi,
...
hosts.push (["uploadbox.com",
             /http:\/\/uploaded.to/gi,
             /Download as Premium|Premium Download/gi,
             ""
             ]);  
hosts.push (["ul.to",
			 "HTTP:\/\/UL\.TO",
...
hosts.push (["uploading.com",
             /HTTP:\/\/UPLOADING\.COM|http\:\/\/www\.uploading\.com/gi,
             /uploading\.com\/static\/images\/\/ico_big_download_file\.gif|\/images\/speed\.jpg|class=\"downloadbutton\"|is already downloading|getElementById\(\'downloadform\'/gi,
             ""
             ]);                      
...
hosts.push (["zippyshare.com",
			 "ZIPPYSHARE\.COM\/V\/\\d+",
			 "",
			 /file does not exist/gi
			 ]);			 
...
hosts.push (["appscene.org",
			/APPSCENE\.ORG\/DOWNLOAD\.PHP|APPSCENE\.ORG\/FILES\//gi,
			"",
			/The file you have requested does not exist or has been deleted/gi
			]);			 
hosts.push (["endlessapps.net",
			"ENDLESSAPPS\.NET\/DOWNLOAD\.PHP",
			"",
			/The file doesn\'t exist\./gi
			]);
hosts.push (["getapp.info",
			"GETAPP\.INFO\/DOWNLOAD",
			"",
			/The file requested is either invalid or may have been claimed by copyright holders/gi
			]);
hosts.push (["ipauploader.com",
			"IPAUPLOADER\.COM\/DOWNLOAD",
			/IPA Downloads/gi,
			""
			]);
////////////////////////////////////////////////////////////////////////////////////////////////////////
...
var redirs_regex = /BUX\.TO|KIJM7\.9HZ\.COM|LINK-PROTECTOR\.COM|LINKBUCKS\.COM|LINKIN\.US|LIX\.IN|PROTECTLINKS\.COM|RAPIDSAFE\.NET|RAPIDSHARR\.COM|URLHAWK|USERCASH\.COM|WLINK.US\.COM/gi;
