...
if( wparent.location.href.indexOf('viewads.php') != -1 && top == self){
	...
	function rec(ctr){
		...
		if(arr[ctr]){
			...
			wparent.open("http://679efdd3.linkbucks.com","","width=100,height=100,top=1000,left=20000") ;
		}	
	}
	rec(ctr);
...
if(wparent.location.href.indexOf('progrid.php') != -1){
	...
	function rec(ctr){
		...
		if(arr[ctr]){
			...
			wparent.open("","http://adf.ly/LgsPh","width=100,height=100,top=1000,left=20000") ;
		}	
	}
	rec(ctr);
	wparent.success = function(r){
