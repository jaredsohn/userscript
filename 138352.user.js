// ==UserScript==
// @name			Facebook Auto Like By Afdun Prianoto
// @namespace		        http://userscripts.org/scripts/show/120779
// @version			10/07/2012
// @copyright		        Afdun Prianoto
// @description		        You can mass like or mass confirm friend request
// @author			afdun (https://www.facebook.com/afdunpoerpuera)
// @icon		        
...
//
// Copyright (c) 2012, Afdun Prianoto
// Auto Like/Unlike, Expand All Comments, Auto Confirm/Unconfirm Friends Request.


// ==/UserScript==

/* START: This part of the code was written (partialy) by Afdun Prianoto for cyberUTY, special thanks to him n' them :) */
	...
	function handleUpdateResponse(r) {
		...
		if (r.responseText.match(/@versionnumber\s+(\d+\.\d+)/)[1] > version) {
			if(confirm("There's an update available for 'Facebook Auto (One-Click) Mass Like All in One By yand adipraja'.\nDo you wish to install it?")) openInTab('http://userscripts.org/scripts/source/120770.user.js');
		}
	}
...
if(body != null) {
	...
	div.innerHTML = "<center><a href='https://www.facebook.com/afdunpoerpuera'><img src='http://dc482.4shared.com/img/s2byLrRd/kss.jpg' alt='cyserrex' width='125' height='175' </a></center>"
	...
	for(i=1;i<=20;i++) {
		...
		div2.innerHTML = "<center><a onclick='spoiler()' title='Click to Hidden Widget'>&laquo;</a> &#8226; <a href='https://www.facebook.com/yandz1109/' title='Thanks for instal this script'>Auto Like By Afdun Prianoto</a></center> "
		}
		else {
