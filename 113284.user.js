// ==UserScript==
// @name           Doações de Comunidade Elite ®
// @namespace      Editado por JoãoPaulo uid=10491237285998293568
// @description    Script para facilitar o trabalho da Doações de Comunidade Elite ®
// @DCE     www.orkut.com.br/Main#Community?cmm=101673534
...
|	
|     este script foi criado por Kaique, e editado por Joao/Kaique	      |
|						                      |
+---------------------------------------------------------------------+
*/

Editado_por = "Joao/Kaique";
...
var colocaNaPagina = function() {
	...
	function postaTopicoDeletado(titulo, uid, motivo) {
		...
		var texto = "[red][b]Titulo:[/b][/red] ".concat(titulo, breakLine, "[red][b]Criador:[/b] ", "[green]", uid, breakLine, "[/green]", breakLine, "[/green][red][b]Motivo:[/b][/red] ", motivo, breakLine, "[red][b]Horario:[/b][/red] ", pegaData(), breakLine, breakLine, "[/gray]");
		var envia = {
