...
function defineLanguage(langTDL) {
    switch (langTDL) {
        case "fr":
            ...
            fetch:"recherche ...",
            unknown:"inconnu",
            allyscore:"Points Alliance",
            score:"Points Perso",
            military:"Points Troupes",
            gold:"Or" };
            break;
        case "gr":
            language = { inline:"Πόντοι",
            fetch:"Fetching...",
            unknown:"Unknown",
            allyscore:"Πόντοι Συμαχίας",
            score:"Γενικοί Πόντοι",
        ...
        case "pl":
            ...
            unknown:"Unknown",
            allyscore:"Ally Score",
            score:"Calkowity Wynik",
            military:"Generalowie",
            gold:"Zapas Zlota" };
            break;
        case "ro":
            language = { inline:"Inline Score",
