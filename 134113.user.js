// ==UserScript==
// @author		JB (source : Angel Vladov)
// @name        Damages Report Script for GROM
// @namespace   eRepublikBattlesReporter_GROM
// @version		0.0.1
// @uso:version 0.0.1
// @include		http://*erepublik.com/*/military/battlefield/*
// @description    Damage Reporting for GROM
// ==/UserScript==
...
if(window.location.href.indexOf(PAGE_BATTLEFIELD) > 0) {	
	...
	/***********************************************************************************/
	var FORM_URL = "https://docs.google.com/spreadsheet/viewform?formkey=dHh4QlhWTmFZRndZMEZBTHktNnVaY3c6MQ#gid=0";
	var FORM_FIELDS = {
                eday: "entry.0.single",
                name: "entry.1.single",
	...
	var LOCALE = {
		...
		pl: function() {
			return {
				locale: "pl_PL",
				no_damage: "Musisz zabic przynajmniej 1 wroga, przed wyslaniem raportu",
				send_report: "Wyslac Raport?",
				button_send: "Raport Wyslano!",
				round_end: "Runda zakonczona. Czy chcesz wyslac raport?",
				damage: "Damage",
				report: "Raport",
				report_title: "Send Report",
				report_failed: "Nieznany blad. Sprobuj ponownie wyslac raport."
			};
		}
	};
