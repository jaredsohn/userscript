...
// @namespace    http://userscripts.org/scripts/source/36729.user.js
...
// @released    2010/08/28 00:55:00
// @frequency   10 hours
// @releaseURL  http://userscripts.org/scripts/source/36729.user.js
// @scriptURL   http://userscripts.org/scripts/source/36729.user.js
// @include     *
// ==/UserScript==
]]></>.toString();
...
pi_real +
"</span>";
if(pi_monkey < pi_real)
{
var _f1 = pi_real - pi_monkey;
...
{
var _f2 = pi_real*2 - pi_monkey;
pi_html += "<br /><span style='color:#FF0000'>You are short by " + _f2.toString() + " monkeys for 2 decoy fleets</span>";
}
if(pi_monkey > pi_real*2)
{
var _f3 = pi_monkey - pi_real*2;
...
//The below has been removed due to conflicts with the navbar div directly below it.
...
units['monkey']           = new evoUnit('Monkey'           ,UT_NATURAL ,3   ,5    ,3    ,4   ,4   ,3   ,0  ,40 ,true);
units['guerrilla ']       = new evoUnit('Guerrilla '       ,UT_NONE    ,24  ,30000,45000,5000,1   ,0  ,0  ,40 ,true);
units['spy']              = new evoUnit('spy'              ,UT_NONE    ,24  ,10000,5000 ,0  ,0   ,0   ,0  ,40 ,true);
units['sheep']            = new evoUnit('Sheep'            ,UT_NATURAL ,4   ,15   ,8    ,11  ,11  ,6   ,0  ,40 ,true);
units['wolf']             = new evoUnit('Wolf'             ,UT_NATURAL ,10  ,80   ,40   ,27  ,25  ,14  ,0  ,40 ,true);
units['python']           = new evoUnit('Python'           ,UT_NATURAL ,12  ,125  ,50   ,36  ,30  ,7   ,1  ,40 ,true);
units['kangaroo']         = new evoUnit('Kangaroo'         ,UT_NATURAL ,15  ,150  ,80   ,36  ,40  ,5   ,1  ,40 ,true);
units['walrus']           = new evoUnit('Walrus'           ,UT_NATURAL ,18  ,260  ,130  ,52  ,51  ,4   ,2  ,40 ,true);
units['cow']              = new evoUnit('Cow'              ,UT_NATURAL ,6   ,25   ,13   ,16  ,13  ,3   ,1  ,40 ,true);
units['hyena']            = new evoUnit('Hyena'            ,UT_NATURAL ,9   ,88   ,33   ,28  ,27  ,9   ,1  ,40 ,true);
units['ostrich']          = new evoUnit('Ostrich'          ,UT_NATURAL ,12  ,180  ,80   ,42  ,44  ,6   ,2  ,40 ,true);
units['bear']             = new evoUnit('Bear'             ,UT_NATURAL ,15  ,300  ,150  ,60  ,57  ,12  ,3  ,40 ,true);
units['elephant']         = new evoUnit('Elephant'         ,UT_NATURAL ,19  ,420  ,210  ,72  ,75  ,22  ,4  ,40 ,true);
units['horse']            = new evoUnit('Horse'            ,UT_NATURAL ,5   ,20   ,10   ,13  ,13  ,4   ,1  ,40 ,true);
units['fox']              = new evoUnit('Fox'              ,UT_NATURAL ,9   ,72   ,32   ,24  ,25  ,8   ,0  ,40 ,true);
units['puma']             = new evoUnit('Puma'             ,UT_NATURAL ,13  ,110  ,50   ,32  ,32  ,5   ,1  ,40 ,true);
units['lynx']             = new evoUnit('Lynx'             ,UT_NATURAL ,15  ,120  ,55   ,35  ,31  ,8   ,1  ,40 ,true);
units['lion']             = new evoUnit('Lion'             ,UT_NATURAL ,15  ,120  ,50   ,31  ,35  ,8   ,1  ,40 ,true);
units['cheetah']          = new evoUnit('Cheetah'          ,UT_NATURAL ,16  ,140  ,70   ,41  ,29  ,5   ,1  ,40 ,true);
units['panther']          = new evoUnit('Panther'          ,UT_NATURAL ,16  ,140  ,80   ,32  ,41  ,6   ,1  ,40 ,true);
units['tiger']            = new evoUnit('Tiger'            ,UT_NATURAL ,20  ,180  ,90   ,44  ,43  ,11  ,2  ,40 ,true);
units['rhino']            = new evoUnit('Rhino'            ,UT_NATURAL ,24  ,280  ,170  ,66  ,51  ,3   ,3  ,40 ,true);
units['centaur']          = new evoUnit('Centaur'          ,UT_ENG     ,5   ,48   ,24   ,22  ,23  ,10  ,1  ,40 ,true);
units['unicorn']          = new evoUnit('Unicorn'          ,UT_ENG     ,8   ,75   ,38   ,31  ,26  ,6   ,1  ,40 ,true);
units['gryphon']          = new evoUnit('Gryphon'          ,UT_ENG     ,12  ,105  ,53   ,36  ,36  ,8   ,2  ,40 ,true);
units['minotaur']         = new evoUnit('Minotaur'         ,UT_ENG     ,18  ,190  ,95   ,54  ,43  ,13  ,2  ,40 ,true);
units['dragon']           = new evoUnit('Dragon'           ,UT_ENG     ,24  ,300  ,150  ,76  ,67  ,9   ,3  ,40 ,true);
units['fire sprite']      = new evoUnit('Fire Sprite'      ,UT_ENG     ,4   ,50   ,25   ,25  ,18  ,4   ,0  ,40 ,true);
units['salamander']       = new evoUnit('Salamander'       ,UT_ENG     ,7   ,90   ,45   ,36  ,26  ,10  ,1  ,40 ,true);
units['phoenix']          = new evoUnit('Phoenix'          ,UT_ENG     ,10  ,146  ,73   ,44  ,35  ,6   ,1  ,40 ,true);
units['wyvern']           = new evoUnit('Wyvern'           ,UT_ENG     ,15  ,250  ,125  ,64  ,43  ,7   ,2  ,40 ,true);
units['demon']            = new evoUnit('Demon'            ,UT_ENG     ,20  ,340  ,170  ,93  ,58  ,5   ,3  ,40 ,true);
units['dryad']            = new evoUnit('Dyrad'            ,UT_ENG     ,7   ,36   ,27   ,21  ,21  ,13  ,1  ,40 ,true);
units['basilisk']         = new evoUnit('Baskilisk'        ,UT_ENG     ,10  ,58   ,44   ,29  ,24  ,21  ,1  ,40 ,true);
units['medusa']           = new evoUnit('Medusa'           ,UT_ENG     ,15  ,100  ,75   ,37  ,34  ,15  ,1  ,40 ,true);
units['cockatrice']       = new evoUnit('Cockatrice'       ,UT_ENG     ,21  ,180  ,135  ,54  ,45  ,23  ,2  ,40 ,true);
units['werewolf']         = new evoUnit('Werewolf'         ,UT_ENG     ,28  ,260  ,195  ,70  ,64  ,30  ,2  ,40 ,true);
units['avimimus']         = new evoUnit('Avimimus'         ,UT_ENG     ,4   ,36   ,18   ,22  ,17  ,2   ,1  ,40 ,true);
units['therizinosaurus']  = new evoUnit('Therizinosaurus'  ,UT_ENG     ,6   ,53   ,27   ,26  ,22  ,3   ,1  ,40 ,true);
units['styracosaurus']    = new evoUnit('Styracosaurus'    ,UT_ENG     ,8   ,94   ,47   ,33  ,35  ,8   ,2  ,40 ,true);
units['carnotaurus']      = new evoUnit('Carnotaurus'      ,UT_ENG     ,11  ,152  ,76   ,51  ,41  ,5   ,3  ,40 ,true);
units['giganotosaurus']   = new evoUnit('Giganotosaurus'   ,UT_ENG     ,14  ,240  ,120  ,75  ,56  ,4   ,4  ,40 ,true);
units['scarab beetle']    = new evoUnit('Scarab Beetle'    ,UT_ENG     ,8   ,60   ,30   ,25  ,25  ,7   ,0  ,40 ,true);
units['mummy']            = new evoUnit('Mummy'            ,UT_ENG     ,12  ,120  ,60   ,38  ,35  ,1   ,1  ,40 ,true);
units['sta']              = new evoUnit('Sta'              ,UT_ENG     ,18  ,190  ,95   ,46  ,44  ,12  ,1  ,40 ,true);
units['sphinx']           = new evoUnit('Sphinx'           ,UT_ENG     ,24  ,280  ,140  ,67  ,57  ,14  ,3  ,40 ,true);
units['anubis incarnate'] = new evoUnit('Anubis Incarnate' ,UT_ENG     ,32  ,420  ,210  ,93  ,78  ,7   ,3  ,40 ,true);
units['fort']             = new evoUnit('Fort'             ,UT_NONE    ,4   ,20   ,10   ,40  ,40  ,0   ,0  ,40 ,false);
units['satellite']        = new evoUnit('Satellite'        ,UT_NONE    ,6   ,70   ,35   ,70  ,60  ,0   ,0  ,40 ,false);
units['satellite mark 2'] = new evoUnit('Satellite Mark 2' ,UT_NONE    ,6   ,80   ,40   ,85  ,75  ,0   ,0  ,40 ,false);
units['test sat mark 2']  = new evoUnit('Test Sat mark 2'  ,UT_NONE    ,6   ,80   ,40   ,57  ,65  ,0   ,0  ,40 ,false);
units['nanowire wall']    = new evoUnit('Nanowire wall'    ,UT_NONE    ,9   ,100  ,40   ,75  ,65  ,0   ,0  ,40 ,false);
units['superstealthwall'] = new evoUnit('superstealthwall' ,UT_NONE    ,21  ,150  ,60   ,110 ,110 ,0   ,0  ,40 ,false);  
units['wave reflector']   = new evoUnit('Wave Reflector'   ,UT_NONE    ,4   ,20   ,20   ,0   ,0   ,0   ,0  ,0  ,false);
units['biochemical missile']     = new evoUnit('Biochemical Missile' ,UT_NONE ,12  ,100  ,200  ,0   ,0   ,0   ,0  ,0  ,false);
units['nanovirus missile']       = new evoUnit('Nanovirus Missile' ,UT_NONE    ,12  ,300  ,150  ,0   ,0   ,0   ,0  ,0  ,false);
units['bombs']                   = new evoUnit('Bombs'            ,UT_NONE    ,12  ,330  ,120   ,0   ,0   ,0   ,0  ,0  ,false);
units['neural reorganiser bomb'] = new evoUnit('Neural Reorganiser Bomb' ,UT_NONE ,24,500 ,320 ,0  ,0   ,0   ,0  ,0  ,false);
units['poison bombs']            = new evoUnit('Poison Bombs'     ,UT_NONE    ,16  ,160  ,120  ,0   ,0   ,0   ,0  ,0  ,false);
units['land scan']        = new evoUnit('Land Scan'        ,UT_NONE    ,4   ,10   ,20   ,0   ,0   ,0   ,0  ,0  ,false);
units['scan amplifier']   = new evoUnit('Scan Amplifier'   ,UT_NONE    ,4   ,10   ,10   ,0   ,0   ,0   ,0  ,0  ,false);
units['sector scan']      = new evoUnit('Sector Scan'      ,UT_NONE    ,8   ,20   ,40   ,0   ,0   ,0   ,0  ,0  ,false);
units['creature scan']    = new evoUnit('Creature Scan'    ,UT_NONE    ,8   ,30   ,60   ,0   ,0   ,0   ,0  ,0  ,false);
units['r&d scan']         = new evoUnit('R&D Scan'         ,UT_NONE    ,6   ,20   ,30   ,0   ,0   ,0   ,0  ,0  ,false);
units['news scan']        = new evoUnit('News Scan'        ,UT_NONE    ,18  ,100  ,200  ,0   ,0   ,0   ,0  ,0  ,false);
units['military scan']    = new evoUnit('Military Scan'    ,UT_NONE    ,12  ,60   ,120  ,0   ,0   ,0   ,0  ,0  ,false);
units['microwave pulse']  = new evoUnit('Microwave Pulse'  ,UT_NONE    ,20  ,5200  ,10400  ,0   ,0   ,0   ,0  ,0  ,false);
units['overload pulse']   = new evoUnit('Overload Pulse'   ,UT_NONE    ,24  ,16000  ,32000  ,0   ,0   ,0   ,0  ,0  ,false);
