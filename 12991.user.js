// ==UserScript==
// @name Orkut-Toolbar: More Smileys & Graphical-glittering texts V0.7.3.
// @author Sharath A.V | Smileys selection by Fenil
// @namespace http://technowise.blogspot.com
// @description Adds a toolbar for formatting & smilies in orkut(for scrap-book and community messages). It also features a toolbar button for inserting colorful and glittering text into scrap-book. More smileys added on demand of OUG.
// @include http://*orkut.*/Scrapbook.aspx*
// @include http://*orkut.*/Scrapbook.aspx?undefined*
