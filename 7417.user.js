...
s+= "a:link, a:active, a:visited {color:ff3300!important;font:bold 11px arial narrow!important;}\n";
s+= "a:hover {text-decoration:none; color:ff3300!important; cursor:crosshair}\n";
s+= "a[id*='friendImageLink']:hover img {border:2px solid #666666!important;}\n";
s+= "a[id*='friendImageLink'] img {border:2px solid #ff3300}\n";
s+= "#header {visibility:hidden}\n";
s+= "#header .left {visibility:visible; color:ff3300; position:relative; top:118px;}\n";
s+= "#header .left a {font-weight:normal!important}\n";
s+= "#topnav {background:transparent!important; padding:0!important; margin-bottom:10px; color:ff3300}\n";
s+= "#topnav a {font:normal 11px arial narrow!important; color:ff3300!important;}\n";
s+= "#topnav a:hover {color:ff3300!important;}\n";
s+= ".section {border:2px solid #ff3300!important;-moz-border-radius:10px;background-color:000000!important;padding:2px;}\n";
s+= ".heading, #splash_coolNewPeople h5.heading, .mar5 strong {font:bold 12px arial narrow!important;color:ff3300;border:none!important;-moz-border-radius:10px;display:inline;padding:0!important;background-color:000000!important;}\n";
s+= "#home_profileInfo .heading {font-size:11pt!important; font-weight:bold!important; color:ff3300}\n";
s+= "#home_profileInfo img {padding-top:3px;}\n";
s+= ".left center {color:ff3300}\n";
s+= ".indicator img {display:none}\n";
s+= ".indicator {margin-left:10px}\n";
s+= ".indicator a, .txtRed {color:ff3300!important; font-weight:normal!important}\n";
s+= "a:hover .indicator {border:none!important;opacity:1;-moz-opacity:1;}\n";
s+= "#home_bulletins th {color:ff3300!important;font-weight:bold!important;}\n";
s+= "#home_bulletins td {padding:3px;}\n";
s+= "td.bulletinDate {color:ff3300!important;}\n";
...
s+= "#home_infoBar span {color:ff3300}\n";
...
s+= ".left span a {color:ff3300!important; font-weight:normal!important}\n";
