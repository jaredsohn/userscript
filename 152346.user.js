...
// @name		Travian Task Queue [With more Feature]  2.4 :-D HUn corrected 
// @description	Schedule delayed constructions, upgrades and attacks, the original File was modified :  /permit task repetition in a labs of time /permit delayed sending resources/save-replay tasks , Some v3.5 compatibility problem solved.
...
function createExportImportLinks(){
	var sXpathExpr = "/html/body/div[@id='mid']/div[@id='sright']/div[@id='vlist']/table[@class='vlist']/tbody/tr/td[@class='text']/a";
	...
	for (var i = 0; i < xpathBuildingNames.snapshotLength; ++i) {
		...
		if(sBuildingId > 0) {
			...
			if(iTask==0){
				...
				var xPathUpGrad="/html/body/div[4]/div[2]/h1";
...
function createBuildLinks() {
	...
	for (var i = 0; i < xpathBuildingNames.snapshotLength; ++i) {
		...
		if(sBuildingId > 0) {
			...
			if(iTask == 0) {xpathBuildingNames.snapshotItem(i).nextSibling.nextSibling.nextSibling.appendChild(oLink);}
			else if(iTask == 1) {xpathBuildingNames.snapshotItem(i).nextSibling.nextSibling.nextSibling.nextSibling.appendChild(oLink);}
		} else {
			_log(2, "Building name found, but it was not identified in the building list.\n"+sBuildingName+"\n"+re);
		}
	}
...
function createSendResourceLinks(){
	...
	var xpathResult1 = xpath("//html/body/div[@id='mid']/div[@id='content']/form[1]/p/input[@id='btn_ok']");
	var xpathResult2 = xpath("//html/body/div[@id='mid']/div[@id='content']/form[1]/p/input[@id='btn_ok']");
	var xpathResult3 = xpath("//html/body/div[@id='mid']/div[@id='content']/form[1]/p/input[@id='btn_ok']");
	var xpathResult4 = xpath("//html/body/div[@id='mid']/div[@id='content']/form[1]/p/input[@id='btn_ok']");
...
function createAttackLinks() {
	...
	var xpathResult = xpath("id('mid')//input[@id='btn_ok']");
...
//	xpathResult = xpath("//html/body/div[4]/div[2]/form/table/tbody/tr[3]/td[4]");
//	if(xpathResult.snapshotLength < 1) {  //no hero textbox - make one
//		xpathResult = xpath("//html/body/div[4]/div[2]/form/table/tbody/tr[3]/td[3]");
...
//			oTd1.innerHTML = '<img alt="Hős" onclick="document.snd.t11.value=''; return false;" title="Hős" src="img/x.gif" class="unit uhero"/>';
//			oTd2.innerHTML = '<span class="f8 c b" id="troopsav_11"><b><a onclick="document.snd.t11.value=1; return false;" href="javaScript:void(0)">(1)</a></b></span>';
...
function createTrainLinks() {
	...
	if(bIsResidence) {
		...
		if(trainBtn.snapshotLength > 0) {  //we need to build only the button
			...
			var oParent = xpath("//html/body/div[4]/div[2]/form/p[2]");
		...
		var trainBtn = xpath("a//*[@id='btn_train']");
...
function scheduleAttack(e) {
	...
	var sXpathExpr = "//table[@class='coords'/tbody/tr/td/input[@class='radio']";
	var xpathRes = xpath(sXpathExpr);
