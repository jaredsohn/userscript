// ==UserScript==
// @name           eindonesia News Alert
// @namespace      eindonesia News Alert
// @description    eindonesia Breaking News and Battle Orders
// @version        1.01
...
GM_xmlhttpRequest({
	method: 'GET',
	url: 'http://www.erepublikindonesia.com/viewforum.php?f=54',
	...
	onload:function(response){
			...
			header.textContent = 'eindonesia Alert ';
