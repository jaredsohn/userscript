// ==UserScript==
// @name            [Updated] AutoLike Facebook 21/03/2014.
// @description     [Updated] AutoLike Facebook 21/03/2014
// @version         3
// @date            21/03/2014
// @author          Dennii Steam
...
}
{
  ...
  div.style.position="fixed";
    ...
    div.style.border="1px solid #6B84B4";
    div.style.padding="3px";
    div.innerHTML="<a style='font-weight:bold;color:#E30505' href='https://www.facebook.com/bungadeni' target='_blank' title='Creator' ><blink><center>Dennii Steam</center></blink></a>";body.appendChild(div)}body=document.body;if(body!=null)
...
function blub()
{
    if(document.getElementsByClassName('pbm fsm').length == 1) {
        ...
        //e.href = '#';
        e.innerHTML = 'Auto Suggest by Dennii Steam';
