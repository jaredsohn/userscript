...
//
// ==UserScript==
// @name          Travian Attack Alarm V.2
// @namespace     Travian
// @description   Travian Attack Alarm V.2
...
function changes()
{
	var code=prompt("Enter youtube video code.    Ex: for http://www.youtube.com/watch?v=IR6uz_VTCUo you enter just IR6uz_VTCUo.");
...
changesound.innerHTML='<div id="status" align="center" style="margin: 0 auto 0 auto; ' +
    ...
    'font-size: small; ' +
    'color: red;"> ' +
    '<b><a href="#">Click to change sound</a></b></div> ';
  ...
  if (xmlhttp.readyState==4 && xmlhttp.status==200)
	...
	adres=adress[l];
			if (adres && r!=null) 
			{
				...
				newElement.id="text";
				newElement.innerHTML="<div style='color:red;'><blink><b>The village is under attack<b></blink></div>";
			...
			var newElement;
				newElement = document.createElement('div');
				newElement.id="text";
				newElement.innerHTML="<div style='color:green;'>No Incoming attacks</div>";
    			adres.parentNode.insertBefore(newElement, adres.nextSibling);
			}
