...
function ptStartup (){
  ...
  if (metc.width==null || metc.width==0){
    ptStartupTimer = setTimeout (ptStartup, 1400);
    return;
  }
...
if (TEST_WIDE){
  ...
  while (numToAdd-- > 0){
    var cityId = Math.random() * 12345678;
...
//logit ( 'Options.ptWinPos: '+ inspect (Options.ptWinPos, 5, 1)); 
  ...
  mainPop = new CPopup ('ptmain', Options.ptWinPos.x, Options.ptWinPos.y, 749,775, Options.ptWinDrag, 
      function (){
        tabManager.hideTab();
...
// defense queue ....
 ...
 //Cancel set queues in train tab toops 
 ...
 //Cancel wall and field in train tab! 
