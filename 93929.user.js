// ==UserScript==
// @name           Facebook - Automatically Accept All Kingdoms of Camelot Gifts Cav250
// @version        0.1
...
// @require        http://sizzlemctwizzle.com/updater.php?id=93929
// ==/UserScript==
				...
				if(claim_gift){
					...
					if(domain_selector && (next_button1 || next_button2)){
						for(var i=0; i<domain_selector.options.length; i++){
							if(domain_selector.options[i].value == "250"){
