// ==UserScript==
// Author          Jonathan Hunt <jjh@42quarks.com>
// Copyright       Jonathan Hunt
// License         GPLv3.
// @name           Translink Geolocation
// @namespace      http://www.42quarks.com
// @description    Uses geolocation (new in Firefox 3.5) to automatically insert the name of your current location when using the Translink (Brisbane public transport) page when planning a journey
// @description    It would be nice to make this shows more useful maps one day.
...
var gkey = 'ABQIAAAAMwNOLrlyjvcx1m0FbLxeMxQS3EZHJyrWFlP6RBeix4kCPvenwhTVhB9Lbrwclf2S-vdDLeIjc2c_mA';

var stBox = document.getElementById('from-street');
var suburbBox = document.getElementById('from-suburb');
...
function gotAddress(geocodeInfo)
{
  ...
  if(address.indexOf('Queensland') == -1) {
