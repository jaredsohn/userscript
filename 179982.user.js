...
var LT_mainFunction = function() {
	...
	function createTweak() {
		...
		LT_strings = {
			"0": { /* english */
				"options_btn_tt": "LoU Tweak Seçenekleri",
				"layout_btn_tt": "Bulunduğum Şehri Düzenle",
				"chat_btn_city": "Şehir",
				"chat_btn_player": "Oyuncu",
				"chat_btn_alliance": "İttifak",
				"chat_btn_url": "Bağlantı",
				"copy_coords_btn": "Sohbetin Kordinatlarını Kopyala",
				"up_count_tt": "Yükseltme için kullanılabilir Binalar:",
				"opts_max_chatlines": "Sohbet Hatları:",
				"opts_chat_opacity": "Sohbet Arka Plan Saydamlığı:",
				"opts_switch_to_ally_tab": "İttifak Sekmesi",
				"opts_show_queue_win": "Bilgi Penceresi",
				"opts_limit_req_res": "Boş Alan Talep Kaynaklarını Sınırlandır",
				"opts_inc_res": {
					"lab": "Gelen Kaynakları Etiketle:",
					"disabled": "Özürlü",
				...
				"opts_hotkey_labels": {
					"lab1": "Kısayol Tuşları Oluştur:",
					"lab2": "Kısayol Tuşları Yükseltme:",
					"lab3": "Aytaşı Oluşturma Kısayol Tuşları:",
					"lab4": "Global Kısayol Tuşları:",
					"upgrade": "Bina Yükseltme",
					"downgrade": "Düşürme / Yıkmak (Shift+)",
					"minister": "Bakana Ata",
					"prev_city": "Önceki Şehir",
					"next_city": "Sonraki Şehir"
				},
				"opts_clr_inc_res": "Gelen Kaynakları Etiketle:",
				"opts_clr_chat": {
					"lab": "Sohbet Yazı Renkleri:",
					"all": "Hepsi:",
					"alliance": "İttihak:",
					"whisper": "Fısıltı ",
					"background": "Geçmiş:",
				...
				"opts": {
					...
					"export": "İhracat",
					"import": "İthalat",
					"export_lab": "Metin Dosyasına Kaydet.",
					"import_lab": "Kayıtlı Lou Düzenleyebilirsiniz Seçeneklerden Metin Alanına Basın.",
					"import_invalid": "Inserted string geçersiz"
				},
				"layout": {
					"city": "Şehir Düzeni",
					"overlay": "Kaplama Düzeni",
					"apply": "Düzen Uygulayın",
					"remove": "Düzeni Kaldır"
				},
				"opts_lang": {
				...
				"opts_minimap": {
					"enable_lab": "Küçük Haritayı Etkinleştir",
					"clrs_lab": "Küçük Harita Renkleri:",
					"show_cities": "Şehirler Göster",
					"show_none": "Hiçbiri",
					"show_noncastle": "Kale Olmayanlar",
					"show_castle": "Kale",
					"show_all": "Hepsi",
					"show_self": "Benim",
					"show_alliance": "İttifak",
					"show_allied": "Müttefik",
					"show_enemy": "Düşman",
					"show_nap": "NAP",
					"show_other": "Diğer",
					"show_lawless": "Kanunsuz",
					"show_moongate": "Moongates",
					"show_shrine": "Shrines",
					"clr_self": "Öz:",
					"clr_alliance": "İttifak:",
					"clr_allied": "Müttefik:",
					"clr_enemy": "Düşman:",
					"clr_nap": "NAP:",
					"clr_other": "Diğer:",
					"clr_lawless": "Kanunsuz:",
				...
				"opts_save_ss_cn": "Şehir Düzenini Kaydet",
				"opts_trade_lab_max_amount": "Görüntülenebilir Ticari Etiket Miktarı Özeti:",
				"show_get_use_btn_tt": "Kullan",
				"opts_hide_get_use": "Kullan",
				"btn_trade_show": "Fuar Özet Etiketi Göster",
				"btn_trade_hide": "Fuar Özet Etiketi Gizle",
				"btn_support_show": "Destek Etiketlerini Göster",
				"btn_support_hide": "Destek Etiketlerini Gizle",
