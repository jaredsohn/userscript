// ==UserScript==
// @name          Tribal eXtension! v3.0.1
// @namespace     http://none
// @description   Conjunto de Utilidades para TribalWars v3.0.1 by JonnyD traduit Par RoyalPopol
// @include       http://w*.tribalwars.*/game.php*
// @exclude       http://ds*.tribalwars.*/game.php*
// @exclude       http://tw*.tribalwars.*/game.php*
// @exclude 	  http://pl*new.plemiona.*/game.php*
// @exclude 	  http://ro*.triburile.*/game.php*
// @version       3.0
// ==/UserScript==
...
var extImgsPath = "http://i184.photobucket.com/albums/x195/twextension/"; // Ruta de las imágenes
var twImgsPath = "http://www.tribalwars.fr/graphic/"; 										//  Ruta para las imágenes originales de tw

var twUnitsNamesArray = new Array("spear", "sword", "axe", "spy", "light", "heavy", "ram", "catapult", "snob");
var twCostsByUnit = new Array( new Array(50,30,10), new Array(30,30,90), new Array(60,30,40), new Array(50,50,20), new Array(125,100,250), new Array(180,120,500), new Array(300,200,200), new Array(320,400,100), new Array(30000,50000,50000) );
var twFarmVillagersByUnit = new Array(1,1,1,2,4,6,5,8,100);
var twSpeedByUnit = new Array(12,15,12,6,6.5,7.5,20,24,30);
...
function twInitialize()
{
	...
	language = baseURL.match(/(es)|(fr)|(ro)|(nl)|(net)/g)
	if(language == null)
		language = "es";
...
twLanguage["es"]["mainMenu"] = new Array ("Sortir", "Forum", "Chat", "Aide", "Options", "Premium", "Classement", "Tribu", "Rapports", "Messages" ); 
twLanguage["es"]["mainSubMenu"] = new Array("Profil", "Courrier Electronique", "Options", "Commencer de nouveau", "Effacer Compte", "Connexion Partagée", "Mode Vacances", "Accès", "Changer Mot de Passe", "Enquêtes", "Support", "Classement Des Adversaires Vaincus en Attaque", "Classement Des Adversaires vaincus en Défense", "Classement Des Adversaires Vaincu au Total", "Vue generale", "des Sociétaires", "Profil", "Diplomatie", "Invitations", "Bienvenue", "Caractéristiques", "Tous", "Attaque", "Défense", "Appui", "Commerce", "Autres", "Entrée", "Sortie(Départ)", "classé", "Créer le Message", "Bloquer l'Expéditeur(Expéditrice)");
twLanguage["es"]["units"] = new Array("Lancier", "Porteur d'épée", "Bucheron", "Espion", "Cavalerie Légère", "Cavalerie Lourde", "Bélier", "Catapulte", "Nobles");
twLanguage["es"]["buildings"] = new Array ("Quartier g&eacute;n&eacute;ral","Casernes", "Écurie", "Atelier", "Académie", "Forge", "Point de ralliement", "Place du Marché", "Camp de bucherons", "Mine d'argile", "Mine de Fer", "Ferme", "Dépôt", "Cachette", "Mur");
twLanguage["es"]["resources"] = new Array ("Bois", "Argile", "Fer", "Villageois");
twLanguage["es"]["other"] = new Array("Carte", "Vue d'ensemble du village");
twLanguage["es"]["reportKeys"] = new Array("Butin:", "Dégat par Belier:", "Dégat par bombardement de catapulte:", "Changement de loyauté", "bâtiments:", "Espionnage", "Aller à la recherche de ressources:");
twLanguage["es"]["report"] = new Array("Butin:", "Dégat par Belier:", "Dégat par catapulte:", "Changement de loyauté", "bâtiments:", "Espionnage", "Aller à la recherche de ressources:");
	...
	twLinks["twMainMenuArray"]["forum"] = "http://board.tribalwars.fr/index.php";
	...
	twLinks["twMainMenuArray"]["settings"]= new Array();
		...
		twLinks["twMainMenuArray"]["settings"][10] = "http://www.tribalwars.fr/ticket_login.php";
	...
	twLinks["twMainMenuArray"]["ranking"] = new Array();
		...
		twLinks["twMainMenuArray"]["ranking"][2] = twUrlScreen+"village="+vID+"&screen=ranking&mode=kill_player&lit_player_id=&type=att";
		twLinks["twMainMenuArray"]["ranking"][3] = twUrlScreen+"village="+vID+"&screen=ranking&mode=kill_player&lit_player_id=&type=def";
		twLinks["twMainMenuArray"]["ranking"][4] = twUrlScreen+"village="+vID+"&screen=ranking&mode=kill_player&lit_player_id=&type=all";
	...
	twLinks["twMainMenuArray"]["reports"] = new Array(); 
		...
		twLinks["twMainMenuArray"]["reports"][5] = twUrlScreen+"village="+vID+"&screen=report&mode=other";
	...
	twLinks["twMainMenuArray"]["mails"] = new Array(); 
		...
		twLinks["twMainMenuArray"]["mails"][2] = twUrlScreen+"village="+vID+"&screen=mail&mode=arch";
		twLinks["twMainMenuArray"]["mails"][3] = twUrlScreen+"village="+vID+"&screen=mail&mode=new";
		twLinks["twMainMenuArray"]["mails"][4] = twUrlScreen+"village="+vID+"&screen=mail&mode=block";
...
function twShowBuildingsLevel()
{
	...
	else newDiv += '<div style="position:absolute;top:146px;left:984px;font-size:6pt;"><img src="'+twGlobalInfo["InterfaceItems"][12]+'" title="Batiment Non Construit"></div>';
	...
	else newDiv += '<div style="position:absolute;top:183px;left:984px;font-size:6pt;"><img src="'+twGlobalInfo["InterfaceItems"][12]+'" title="Batiment Non Construit"></div>';
	...
	else newDiv += '<div style="position:absolute;top:220px;left:984px;font-size:6pt;"><img src="'+twGlobalInfo["InterfaceItems"][12]+'" title="Batiment Non Construit"></div>';
	...
	else newDiv += '<div style="position:absolute;top:257px;left:984px;font-size:6pt;"><img src="'+twGlobalInfo["InterfaceItems"][12]+'" title="Batiment Non Construit"></div>';
	...
	else newDiv += '<div style="position:absolute;top:292px;left:984px;font-size:6pt;"><img src="'+twGlobalInfo["InterfaceItems"][12]+'" title="Batiment Non Construit"></div>';
	...
	else newDiv += '<div style="position:absolute;top:329px;left:984px;font-size:6pt;"><img src="'+twGlobalInfo["InterfaceItems"][12]+'" title="Batiment Non Construit"></div>';
	...
	else newDiv += '<div style="position:absolute;top:367px;left:984px;font-size:6pt;"><img src="'+twGlobalInfo["InterfaceItems"][12]+'" title="Batiment Non Construit"></div>';
	...
	else newDiv += '<div style="position:absolute;top:403px;left:984px;font-size:6pt;"><img src="'+twGlobalInfo["InterfaceItems"][12]+'" title="Batiment Non Construit"></div>';
...
function twShowInfoResources()
{
	...
	newDiv += "		<tbody>";
	newDiv += "			<tr>";
	newDiv += "				<th style='background-color:#804000;color:#fff;width:auto;height:29px;padding:2px 2px 2px 2px;margin-right:5px'>Ressources: </th>";
	newDiv += "				<td title='Madera' style='padding:0 0 0 15px'><img src='"+twLinks["twOtherImg"][0]+"' /></td><td>"+twGlobalInfo["resources"][0]+"</td>";
	newDiv += "				<td title='Barro'><img src='"+twLinks["twOtherImg"][1]+"' /></td><td>"+twGlobalInfo["resources"][1]+"</td>";
	newDiv += "				<td title='Hierro'><img src='"+twLinks["twOtherImg"][2]+"' /></td><td>"+twGlobalInfo["resources"][2]+"</td>";
	newDiv += "				<td title='Almac&eacute;n'><img src='"+twLinks["twOtherImg"][3]+"' /></td><td id='storage'>"+twGlobalInfo["resources"][3]+"</td>";
	newDiv += "			</tr>";
	newDiv += "		</tbody>";
	newDiv += "	</table>";
	newDiv += "</div>";
...
function twShowInfoFarm()
{
	...
	newDiv += "	<tbody>";
	newDiv += "		<tr>";
	newDiv += "			<th style='background-color:#804000;color:#fff;width:auto;height:29px;padding:2px 2px 2px 8px;'>Populations: </th>";
	newDiv += "			<td title='Espacios Ocupados' style='padding:0 0 0 12px'><img src='"+twLinks["twOtherImg"][4]+"' /></td><td>"+twGlobalInfo["farm"][0] +"</td>";
	newDiv += "			<td title='Capacidad total'><img src='"+twLinks["twOtherImg"][4]+"' /></td><td>"+twGlobalInfo["farm"][1]+"</td>";
	newDiv += "			<td title='Espacios Libres'><img src='"+twLinks["twOtherImg"][4]+"' /></td><td style='color:green;'><b>"+twGlobalInfo["farm"][2]+"</b></td>";
	newDiv += "		</tr>";
	newDiv += "	</tbody>";
	newDiv += "</table>";
	newDiv += "</div>";
...
function twShowInfoArmy(village_id)
{
	...
	newDiv += "	<tbody>";
	newDiv += "		<tr>";
	newDiv += "			<th style='background-color:#804000;color:#fff;width:auto;height:28px;padding:2px 2px 2px 2px;'>Troupes: </th>";
	for(var i=0;i<9;i++){
...
{
		var newHTML ="";
		newHTML += "<h2>Vos Troupe dans le Village</h2>";
		newHTML += "<table id='GlobalArmyInfo' width=100% style='text-align:left;'>"
		newHTML += "	<tr style='text-align:center'><th rowspan=2>Nombre</th><th rowspan=2>Points</th><th colspan=9 width:80% align='center'>Troupes</th></tr>";
		newHTML += "	<tr>";
		...
		//document.createTextNode("<tr><th>Nº</th><th>Pueblo</th><th colspan='9'>Unités</th");
...
{	
	try{
		...
		newDiv += '		<tbody>';
		newDiv += '			<tr>';
		newDiv += '				<td style="border-right:1px solid #804000"><a id="btnDataRefresh" href="javascript:void(0)"><img src="'+twGlobalInfo["InterfaceItems"][7]+'" title="Actualizar los datos" />&nbsp;</a></td>';
		newDiv += '				<td><a href="'+twLinks["twMainMenuArray"]["overview"]+'"><img src="'+twGlobalInfo["InterfaceItems"][4]+'" title="Vers la vue d\'ensemble classique du village" />&nbsp;</a></td>';
		newDiv += '				<td><a href="'+twLinks["twMainMenuArray"]["map"]+'"><img src="'+twGlobalInfo["InterfaceItems"][5]+'" title="Allez Sur la Carte" />&nbsp;</a></td>';
		newDiv += '				<td><a href="'+twLinks["twMainMenuArray"]["villages"]+'"><img src="'+twGlobalInfo["InterfaceItems"][8]+'" title="Resumé des villages" />&nbsp;</a></td>';
		newDiv += '				<td><a id="btnShowAllArmy" href="javascript:void(0)"><img src="'+twGlobalInfo["InterfaceItems"][6]+'" title="Resumé de Vos troupes" />&nbsp;</a></td>'
		newDiv += '			</tr>'
		newDiv += '		</tbody>';
		newDiv += '	</table>';
		newDiv += '</div>';
...
function twReportGenerator(reportInfo)
{
		...
		newReport[5] += '\n&nbsp; Troupes: [color=darkred]'+attackerLossesUnits+'[/color]/[b]'+attackerTotalUnits+'[/b] ([color=green]'+(attackerTotalUnits-attackerLossesUnits)+'[/color]) Unidad(es) ([b][color=blue]'+(Math.round((attackerLossesUnits*100/attackerTotalUnits)*10)/10)+'%[/color][/b]) Unidad(es)'
		newReport[5] += '\n&nbsp; Ressources: [img]'+twLinks["twOtherImg"][0]+'[/img]'+reportInfo['attacker']['lossesResources']['wood']+'[img]'+twLinks["twOtherImg"][1]+'[/img]'+reportInfo['attacker']['lossesResources']['stone']+'[img]'+twLinks["twOtherImg"][2]+'[/img]'+reportInfo['attacker']['lossesResources']['iron'];
		...
		if(parseInt(defenderTotalUnits) != 0)
		{
			...
			for(i=0;i<9;i++){
				if(reportInfo['defender']['army'][twUnitsNamesArray[i]]['total'] > 0	)
						newReport[8] += '[img]'+twLinks["twUnitsImg"][i]+'[/img]'+twLanguage["es"]['units'][i]+'[b] '+reportInfo['defender']['army'][twUnitsNamesArray[i]]['total']+' [/b].Perdi&oacute;: [color=darkred] '+reportInfo['defender']['army'][twUnitsNamesArray[i]]['losses']+' [/color]([color=green]'+(parseInt(reportInfo['defender']['army'][twUnitsNamesArray[i]]['total'])-parseInt(reportInfo['defender']['army'][twUnitsNamesArray[i]]['losses']))+'[/color])\n';
			}
			newReport[8] += '__________________________________________________________________________'
			newReport[8] += '\n[i][b]P&eacute;rdidas del Defensor:[/b]';
			newReport[8] += '\n&nbsp;Troupes: [color=darkred]'+defenderLossesUnits+'[/color]/[b]'+defenderTotalUnits+'[/b] ([color=green]'+(defenderTotalUnits-defenderLossesUnits)+'[/color]) Unidad(es) ([b][color=blue]'+(Math.round((defenderLossesUnits*100/defenderTotalUnits)*10)/10)+'%[/color][/b])';
			newReport[8] += '\n&nbsp;Ressources: [img]'+twLinks["twOtherImg"][0]+'[/img]'+reportInfo['defender']['lossesResources']['wood']+'[img]'+twLinks["twOtherImg"][1]+'[/img]'+reportInfo['defender']['lossesResources']['stone']+'[img]'+twLinks["twOtherImg"][2]+'[/img]'+reportInfo['defender']['lossesResources']['iron'];
...
function twPreviewReportGenerator(reportWithForumTags)
{
	...
	var reportPreview = "";
	var ForumTags = new Array('[b]', '[/b]', '[i]', '[/i]', '[u]', '[/u]', '\n', '[color=darkred]', '[color=sienna]','[color=purple]','[color=navy]', '[color=green]', '[color=red]', '[color=blue]', '[/color]', '[size=13]', '[size=15]', '[/size]','[img]http://www.tribalwars.fr/graphic/unit/unit_spear.png[/img]', '[img]http://www.tribalwars.fr/graphic/unit/unit_sword.png[/img]', '[img]http://www.tribalwars.fr/graphic/unit/unit_axe.png[/img]', '[img]http://www.tribalwars.fr/graphic/unit/unit_spy.png[/img]', '[img]http://www.tribalwars.fr/graphic/unit/unit_light.png[/img]', '[img]http://www.tribalwars.fr/graphic/unit/unit_heavy.png[/img]', '[img]http://www.tribalwars.fr/graphic/unit/unit_ram.png[/img]', '[img]http://www.tribalwars.fr/graphic/unit/unit_catapult.png[/img]', '[img]http://www.tribalwars.fr/graphic/unit/unit_snob.png[/img]','[img]http://www.tribalwars.fr/graphic/holz.png[/img]', '[img]http://www.tribalwars.fr/graphic/lehm.png[/img]', '[img]http://www.tribalwars.fr/graphic/eisen.png[/img]', '[img]http://www.tribalwars.fr/graphic/res.png[/img]');
	var HtmlTags = new Array('<b>', '</b>', '<i>', '</i>','<u>', '</u>', '<br>', '<span style="color:#C40000;">', '<span style="color: sienna;">','<span style="color: purple;">','<span style="color: navy;">','<span style="color: green;">', '<span style="color: red;">', '<span style="color: blue;">', '</span>', '<span style="font-size: 13px;">','<span style="font-size: 15px;">', '</span>','<img border="0" class="resizeImage" alt="" src="http://www.tribalwars.fr/graphic/unit/unit_spear.png"/>', '<img border="0" class="resizeImage" alt="" src="http://www.tribalwars.fr/graphic/unit/unit_sword.png"/>', '<img border="0" class="resizeImage" alt="" src="http://www.tribalwars.fr/graphic/unit/unit_axe.png"/>', '<img border="0" class="resizeImage" alt="" src="http://www.tribalwars.fr/graphic/unit/unit_spy.png"/>', '<img border="0" class="resizeImage" alt="" src="http://www.tribalwars.fr/graphic/unit/unit_light.png"/>', '<img border="0" class="resizeImage" alt="" src="http://www.tribalwars.fr/graphic/unit/unit_heavy.png"/>', '<img border="0" class="resizeImage" alt="" src="http://www.tribalwars.fr/graphic/unit/unit_ram.png"/>', '<img border="0" class="resizeImage" alt="" src="http://www.tribalwars.fr/graphic/unit/unit_catapult.png"/>', '<img border="0" class="resizeImage" alt="" src="http://tribalwars.fr/graphic/unit/unit_snob.png"/>', '<img border="0" class="resizeImage" alt="" src="http://www.tribalwars.fr/graphic/holz.png"/>', '<img border="0" class="resizeImage" alt="" src="http://www.tribalwars.fr/graphic/lehm.png"/>', '<img border="0" class="resizeImage" alt="" src="http://www.tribalwars.fr/graphic/eisen.png"/>', '<img border="0" class="resizeImage" alt="" src="http://www.tribalwars.fr/graphic/res.png"/>');
...
function twMainMenuNavigationBar()
{
	...
	if(	str.match("new_mail") != null)
		codeNavBar += 		'<li><a href="'+twLinks["twMainMenuArray"]["mails"][0]+'"><img src="'+twLinks["twOtherImg"][6]+'" />&nbsp;'+twLanguage["es"]["mainMenu"][9]+'</a>';
	else
		codeNavBar += 		'<li><a href="'+twLinks["twMainMenuArray"]["mails"][0]+'">&nbsp;'+twLanguage["es"]["mainMenu"][9]+'</a>';
	codeNavBar +=				'<ul>';
	codeNavBar +=					'<li><a href="'+twLinks["twMainMenuArray"]["mails"][3]+'">Crée Message</a></li>';
	codeNavBar +=					'<li><a href="'+twLinks["twMainMenuArray"]["mails"][0]+'">Message Recu</a></li>';
	codeNavBar +=					'<li><a href="'+twLinks["twMainMenuArray"]["mails"][1]+'">Message Envoyé</a></li>';
	codeNavBar +=					'<li><a href="'+twLinks["twMainMenuArray"]["mails"][2]+'">Archive</a></li>';
	codeNavBar +=					'<li><a href="'+twLinks["twMainMenuArray"]["mails"][4]+'">Bloquer</a></li>';
	codeNavBar +=				'</ul>';
	...
	codeNavBar +=				'<ul>';
	codeNavBar +=					'<li><a href="'+twLinks["twMainMenuArray"]["reports"][0]+'">Tous</a></li>';
	codeNavBar +=					'<li><a href="'+twLinks["twMainMenuArray"]["reports"][1]+'">Attaques</a></li>';
	codeNavBar +=					'<li><a href="'+twLinks["twMainMenuArray"]["reports"][2]+'">Defenses</a></li>';
	codeNavBar +=					'<li><a href="'+twLinks["twMainMenuArray"]["reports"][3]+'">Appuis</a></li>';
	codeNavBar +=					'<li><a href="'+twLinks["twMainMenuArray"]["reports"][4]+'">Commercial</a></li>';
	codeNavBar +=					'<li><a href="'+twLinks["twMainMenuArray"]["reports"][5]+'">Autres</a></li>';
	codeNavBar +=				'</ul>';
	codeNavBar +=			'</li>';
	...
	codeNavBar +=				'<ul>';
	codeNavBar +=					'<li><a href="'+twLinks["twMainMenuArray"]["ally"][0]+'">Vue Principale</a></li>';
	codeNavBar +=					'<li><a href="'+twLinks["twMainMenuArray"]["ally"][1]+'">Alliance</a></li>';
	codeNavBar +=					'<li><a href="'+twLinks["twMainMenuArray"]["ally"][2]+'">Profile</a></li>';
	codeNavBar +=					'<li><a href="'+twLinks["twMainMenuArray"]["ally"][3]+'">Diplomatie</a></li>';
	codeNavBar +=					'<li><a href="'+twLinks["twMainMenuArray"]["ally"][5]+'">Invitation</a></li>';
	codeNavBar +=					'<li><a href="'+twLinks["twMainMenuArray"]["ally"][6]+'">Bienvenue</a></li>';
	codeNavBar +=					'<li><a href="'+twLinks["twMainMenuArray"]["ally"][7]+'">Caracteristique</a></li>';
	...
	codeNavBar +=	'<li><a href="javascript:void(0)">&nbsp;Utilitaires</a>';
	codeNavBar +=		'<ul>';
	codeNavBar +=				'<li><a href="'+twLinks["twUtils"][7]+'" target="_blank">TW Tools</a></li>';
	codeNavBar +=				'<li><a href="'+twLinks["twUtils"][10]+'" target="_blank">Tribal Inspector</a></li>';
	codeNavBar +=				'<li><a href="javascript:void(0)">Compactadores</a>';
	codeNavBar +=					'<ul>';
	codeNavBar +=					'	<li><a href="'+twLinks["twUtils"][0]+'" target="_blank" >TWComp v2.0 by HuMoR</a></li>';	
	codeNavBar +=					'	<li><a href="'+twLinks["twUtils"][1]+'" target="_blank" >TribalPacker 0.9b by Juankar</a></li>';	
	codeNavBar +=					'	<li><a href="'+twLinks["twUtils"][2]+'" target="_blank" >Compactador Merlin by Prosur</a></li>';	
	codeNavBar +=					'</ul>';
	codeNavBar +=				'</li>';
	codeNavBar +=				'<li><a href="javascript:void(0)">Buscador de Pueblos</a>';
	codeNavBar +=					'<ul>';
	codeNavBar +=						'<li><a href="'+twLinks["twUtils"][3]+'" target="_blank" >Buscador by Kodomo</a></li>';	
	codeNavBar +=						'<li><a href="'+twLinks["twUtils"][4]+'" target="_blank">Buscador by guscreations</a></li>';
	codeNavBar +=					'</ul>';
	codeNavBar +=				'</li>';
	codeNavBar +=				'<li><a href="javascript:void(0)">Calculadoras</a>';
	codeNavBar +=					'<ul>';
	codeNavBar +=						'<li><a href="'+twLinks["twUtils"][5]+'" target="_blank">Calculadora de Tropas/Bot&iacute;n</a></li>';
	codeNavBar +=						'<li><a href="'+twLinks["twUtils"][6]+'" target="_blank">Calculadora de Granja</a></li>';	
	codeNavBar +=						'<li><a href="'+twLinks["twUtils"][8]+'" target="_blank">DS Plus Tropas</a></li>';	
	codeNavBar +=						'<li><a href="'+twLinks["twUtils"][9]+'" target="_blank">DS Plus Edificios</a></li>';	
	codeNavBar +=				'</ul>';
	codeNavBar +=			'</li>';
	codeNavBar +=		'</ul>';
	codeNavBar +=	'</li>';
	...
	codeNavBar +=					'<li><a href="'+twLinks["twMainMenuArray"]["settings"][2]+'">Option</a></li>';
	codeNavBar +=					'<li><a href="'+twLinks["twMainMenuArray"]["settings"][3]+'">Recommencer</a></li>';
	codeNavBar +=					'<li><a href="'+twLinks["twMainMenuArray"]["settings"][4]+'">Effacer le compte</a></li>';
	codeNavBar +=					'<li><a href="'+twLinks["twMainMenuArray"]["settings"][5]+'">Partage de connection internet</a></li>';
	codeNavBar +=					'<li><a href="'+twLinks["twMainMenuArray"]["settings"][6]+'">Compte sitté</a></li>';
	codeNavBar +=					'<li><a href="'+twLinks["twMainMenuArray"]["settings"][7]+'">Logins</a></li>';
	codeNavBar +=					'<li><a href="'+twLinks["twMainMenuArray"]["settings"][8]+'">Changer le mot de passe</a></li>';
	codeNavBar +=					'<li><a href="'+twLinks["twMainMenuArray"]["settings"][9]+'">Etudes</a></li>';
	codeNavBar +=					'<li><a href="'+twLinks["twMainMenuArray"]["settings"][10]+'">Connection pour les demandes de service</a></li>';
	codeNavBar +=				'</ul>';
	codeNavBar +=			'</li>';
	...
	codeNavBar +=					'<li><a href="'+twLinks["twMainMenuArray"]["ranking"][0]+'">Par Joueur</a></li>';
	codeNavBar +=					'<li><a href="'+twLinks["twMainMenuArray"]["ranking"][1]+'">Par Tribus</a></li>';
	codeNavBar +=					'<li><a href="'+twLinks["twMainMenuArray"]["ranking"][2]+'">Par Adversaire battu</a></li>';
	codeNavBar +=				'</ul>';
	codeNavBar +=			'</li>';
	...
	codeNavBar +=				'<ul>';
	codeNavBar +=					'<li><a href="'+twLinks["twMainMenuArray"]["help"]+'?mode=intro" target="_blank">Premiers Pas</a></li>';
	codeNavBar +=					'<li><a href="'+twLinks["twMainMenuArray"]["help"]+'?mode=late_start" target="_blank">Démarrage tardif</a></li>';
	codeNavBar +=					'<li><a href="'+twLinks["twMainMenuArray"]["help"]+'?mode=buildings" target="_blank">bâtiments</a></li>';
	codeNavBar +=					'<li><a href="'+twLinks["twMainMenuArray"]["help"]+'?mode=units" target="_blank">Unidades</a></li>';
	codeNavBar +=					'<li><a href="'+twLinks["twMainMenuArray"]["help"]+'?mode=fight" target="_blank">Sistma de Batalla</a></li>';
	codeNavBar +=					'<li><a href="'+twLinks["twMainMenuArray"]["help"]+'?mode=points" target="_blank">Puntos</a></li>';
	codeNavBar +=					'<li><a href="'+twLinks["twMainMenuArray"]["help"]+'?mode=reports" target="_blank">Informes</a></li>';
	codeNavBar +=					'<li><a href="'+twLinks["twMainMenuArray"]["help"]+'?mode=bb" target="_blank">C&oacute;digos BB</a></li>';
//	codeNavBar +=					'<li><a href="'+twLinks["twMainMenuArray"]["help"]+'?mode=external_igm" target="_blank">IGMs Externos</a></li>';

//	codeNavBar +=					'<li><a href="'+twLinks["twMainMenuArray"]["help"]+'?mode=map_data" target="_blank">Datos del Mundo</a></li>';
//	codeNavBar +=					'<li><a href="'+twLinks["twMainMenuArray"]["help"]+'?mode=banner" target="_blank">Banner de Tribalwars</a></li>';
//	codeNavBar +=					'<li><a href="'+twLinks["twMainMenuArray"]["help"]+'?mode=server_info" target="_blank">Informaci&oacute;n del Servidor</a></li>';

	codeNavBar +=					'<li><a href="http://www.tribalwars.fr/rules.php" target="_blank">Normas</a></li>';
	codeNavBar +=				'</ul>';
	codeNavBar +=			'</li>';
...
function twRankingBar()
{
	...
	newHTML += '<div style="position:absolute;top:115px;left:205px;width:700px;">';
		...
		newHTML += '	<div style="float:left;"><img  src="'+twGlobalInfo["InterfaceItems"][9]+'" width="30" height="28" border="0" alt=""  /></div>';
		newHTML += '	<div style="float:left;width:141px;height:22px;margin-top:3px;background-image:url(\''+twGlobalInfo["InterfaceItems"][10]+'\');background-repeat:repeat-x"><div style="margin:3px;color:#804000;font-weight:bold">Option Desactivée</div></div>';
		newHTML += '	<div style="float:left;margin-top:3px"><img  src="'+twGlobalInfo["InterfaceItems"][11]+'" width="9" height="22" border="0" alt="" /></div>';
		newHTML += '</div>';
...
function twBuildingsBar()
{
	...
	//	Enlaces
	//newHTML += '<div id="mMain" class="iconBuilding" style="width:120px;top:155px;margin-left:840px;"><a href="'+twLinks["twMainScreens"][0]+'">Quartier general</a></div>';
	//newHTML += '<div id="mBarracks" class="iconBuilding" style="width:55px;top:191px;margin-left:905px;" ><a href="'+twLinks["twMainScreens"][1]+'">Caserne</a></div>';
	//newHTML += '<div id="mStable" class="iconBuilding" style="width:55px;top:229px;margin-left:905px;" id="mStable"><a href="'+twLinks["twMainScreens"][2]+'">Ecurie</a></div>';
	//newHTML += '<div id="mGarage" class="iconBuilding" style="width:50px;top:265px;margin-left:910px;"><a href="'+twLinks["twMainScreens"][3]+'">Atelier</a></div>';
	//newHTML += '<div id="mSnob" class="iconBuilding" style="width:130px;top:301px;margin-left:828px;"><a href="'+twLinks["twMainScreens"][4]+'">Academie</a></div>';
	//newHTML += '<div id="mPlace" class="iconBuilding" style="width:135px;top:337px;margin-left:823px;"><a href="'+twLinks["twMainScreens"][6]+'">Point de ralliement</a></div>';
	//newHTML += '<div id="mSmith" class="iconBuilding" style="width:65px;top:375px;margin-left:895px;"><a href="'+twLinks["twMainScreens"][5]+'">Forge</a></div>';
	//newHTML += '<div id="mMarket" class="iconBuilding" style="width:130px;top:411px;margin-left:828px;"><a href="'+twLinks["twMainScreens"][7]+'">Marché</a></div>';
	...
	newHTML += '	<area id="MarketIcon" title="Marché" shape="poly" alt="" coords="0,287, 9,281, 29,281, 33,277, 40,277, 44,281, 45,288, 41,294, 36,295, 36,303, 29,310, 6,311, 0,304" href="'+twLinks["twMainScreens"][7]+'" />';
	newHTML += '	<area id="SmithIcon" title="Forge" shape="poly" alt="" coords="0,251, 9,245, 29,245, 33,241, 40,241, 44,245, 45,252, 41,258, 36,259, 36,267, 29,274, 6,275, 0,268" href="'+twLinks["twMainScreens"][5]+'" />';
	newHTML += '	<area id="PlaceIcon" title="Point de ralliement" shape="poly" alt="" coords="0,214, 9,207, 27,207, 33,202, 41,204, 44,208, 45,214, 42,219, 36,222, 36,230, 29,236, 8,236, 0,231" href="'+twLinks["twMainScreens"][6]+'" />';
	newHTML += '	<area id="SnobIcon" title="Academie" shape="poly" alt="" coords="0,176, 9,170, 29,170, 33,166, 40,166, 44,170, 45,177, 41,183, 36,184, 36,192, 29,199, 6,200, 0,193" href="'+twLinks["twMainScreens"][4]+'" />';
	newHTML += '	<area id="GarageIcon" title="Atelier" shape="poly" alt="" coords="0,142, 7,135, 28,136, 32,132, 37,130, 42,133, 45,140, 42,147, 36,150, 36,158, 29,165, 7,165, 0,159" href="'+twLinks["twMainScreens"][3]+'" />';
	newHTML += '	<area id="StableIcon" title="Ecurie" shape="poly" alt="" coords="0,105, 7,98, 29,98, 33,93, 40,93, 44,99, 45,106, 41,112, 36,113, 36,121, 29,128, 7,127, 0,122" href="'+twLinks["twMainScreens"][2]+'" />';
	newHTML += '	<area id="BarracksIcon" title="Caserne" shape="poly" alt="" coords="0,67, 9,61, 29,61, 33,57, 40,57, 44,61, 45,68, 41,74, 36,75, 36,83, 29,90, 6,91, 0,84" href="'+twLinks["twMainScreens"][1]+'" />';
	newHTML += '	<area id="MainIcon" title="Quartier general" shape="poly" alt="" coords="0,30, 9,24, 29,24, 33,20, 40,20, 44,24, 45,31, 41,37, 36,38, 36,46, 29,53, 6,54, 0,47" href="'+twLinks["twMainScreens"][0]+'" />';
	newHTML += '</map>';
...
function twSetReport()
{
	...
	// Comprobación: Informe reenviado (init = 5) o Informe propio (init = 3)
		...
		var attacker = '<a href="http://w5.tribalwars.fr/game.php?village='+vID+'&screen=place&mode=command&target='+id+'">'+str+'</a>';
		...
		id = id.substring( id.indexOf("id=",0)+3, id.indexOf("\">",0) );
		var defender = '<a href="http://w5.tribalwars.fr/game.php?village='+vID+'&screen=place&mode=command&target='+id+'">'+str+'</a>';
		...
		newHTML += '	</tr>';
		newHTML += '	<tr>';
		newHTML += '		<td><a id="twLinkSimu" href="'+baseURL+'/staemme.php?screen=place&mode=sim'+url+'" >&raquo; Simular</a></td>';
		newHTML += '	</tr>';
		newHTML += '	<tr>';
...
function TwSetVillageInfo()
{
	try{
		...
		newinfo_village += '			<tr><th>Informaci&oacute;n del Pueblo</th></tr>';
		newinfo_village += '			<tr><td>Coordonnées: <b>'+ CoordDestino +'</b></td></tr>';
		newinfo_village += '			<tr><td>Points: <b>'+ infoPlayer["Puntos"] +'</b</td></tr>';
		newinfo_village += '			<tr><td>Joueur: <a id="btnPlayerPopUp" href="javascript:void(0);">'+ infoPlayer["NombreJugador"] +'</a></td></tr>';
		newinfo_village += '			<tr><td>Tribu: '+ infoPlayer["Tribu"] +'</td></tr>';
		newinfo_village += '			<tr><th>Action</th></tr>';
		newinfo_village += '			<tr><td><a 	href= "'+twLinks["twMainMenuArray"]["map"]+'&x='+infoPlayer["CoordDestino"][0]+'&y='+infoPlayer["CoordDestino"][1]+'" >&raquo; La Carte</a></td></tr>';
		...
		newinfo_village += '		<tbody>';
		newinfo_village += '			<tr><th>Unidad</th><th>Temps</th></tr>';
		...
		newinfo_village += '		<tbody>';
		newinfo_village += '			<tr><th>Information Détaillée</th></tr>';
		newinfo_village += '			<tr><td><a href="javascript:alert(\'Deshabilitado.\');">&raquo; Voir l\'Historique du Joueur</a></td></tr>';
		newinfo_village += '			<tr><td><a href="javascript:alert(\'Deshabilitado.\');">&raquo; Voir l\'Historique de la Tribu</a></td></tr>';
		newinfo_village += '		</tbody>';
		newinfo_village += '	</table>';	
		newinfo_village += '</div>'; 
...
function twPlayerPopUp()
{
	...
	newInfo_village += '	<table>';
	newInfo_village += '		<tbody>';
	newInfo_village += '			<tr><th>Information Sur le Joueur</th><td><a id="btnPlayerPopUpClose" href="javascript:void(0);" >X</a></td></tr>';
	...
	newInfo_village += '			<tr><td colspan=2 ><a id="btnPlayerCurriculum" href="javascript:void(0)">Curriculum</a></td></tr>';
	newInfo_village += '			<tr><td colspan=2 ><a id="btnPlayerAllies" href="javascript:void(0)">Alliés les plus proches</a></td></tr>';
	newInfo_village += '		</tbody>';
	newInfo_village += '	</table>';
	newInfo_village += '</div>'
