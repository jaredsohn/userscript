// ==UserScript==
// @name Habrahabr Grammar Gravity
...
var nazi = 
{
	...
	{
		nazi.report(document.getElementById("report_form_container_textarea").value);
	...
	inject_report_form : function()
	{
		...
		//Overall styles
		report_link.innerHTML = "сообщить об ошибке";
		...
		report_container_note.innerHTML = "Если вы обнаружили какие-либо ошибки в статье автора, вы можете сообщить ему об этом напрямую, использовав форму ниже. Оформите свои замечания и предложения по статье, и автор обязательно увидит их. Мир вам!";
	...
	report : function(content)
	{
		...
		{
			alert("Заполните поле, пожалуйста, прошу вас!");
			return;
		}
		...
		request_string += "&message[title]=" + nazi.info.article + " (сообщение об ошибке)";
