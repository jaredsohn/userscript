// ==UserScript==
// @name           Travian T4.2 Extra Araclar Eklentisi
// @namespace      Travian icin extra araclar eklentisi
// @description    Travian 4 surumleri icin extra araclar eklentisi
// @author         TravianProgram.blogspot.com
// @version        00.00.01
// @run-at         document-end
...
if( unsafeWindow.Travian.Game.version !== "4.2" && unsafeWindow.Travian.Game.version !== "4.4" ){
    throw "Not supported travian version! (Supported versions: 4.2, 4.4)";
}
...
{
    alert("T4 Script | mertskaplan.com")
}
...
GM_registerMenuCommand("T4.2 Extra Araclar Ayarlari",showSet);

GM_registerMenuCommand("Yeni Versiyonu Kontrol Et",check_update);
/*
...
*/
GM_registerMenuCommand("Bagis Yap",donate);
...
GM_addStyle('@import "http://ajax.googleapis.com/ajax/libs/jqueryui/1.8.13/themes/'+StyleSheet[parseInt10(getCookie("Used_Style_Sheet","18"))]+'/jquery-ui.css";');
GM_addStyle('.dialogFixed {\n\
position: absolute !important;\n\
} \n\
.dialogFixed table tbody tr td,.dialogFixed table tbody tr,.dialogFixed table tbody,.dialogFixed table,.dialogFixed table tbody td{\n\
background:inherit !important;\n\
padding:0px;\n\
font:1em;\n\
} \n\
span.wareHouseFullText{\n\
position: absolute;\n\
width: 100%;\n\
top: 27px;\n\
right: 2px; \n\
...
var warehouseBox = "data:image/png;base64,";
...
var goldImage = "data:image/png;base64,";

//var ActiveVillage = $("#villageList li.active a").attr('title');
var ActiveVillage = $("#sidebarBoxVillagelist li.active a.active span.coordinates").html();
...
function showSet()
{
    ...
    s+='<tr><td style="background:none;color:'+SettingsFrameTextColor+';">'+tr.stylesheet+'</td><td style="background:none;"><select id="style_sheet">'+genOptions(StyleSheet,parseInt10(getCookie("Used_Style_Sheet","18")))+'</select></td></tr>';
    ...
    s+='<tr><td style="background:none;color:'+SettingsFrameTextColor+';">'+tr.c_finder+'</td><td style="background:none;"><select id="CropFinder"><option value="0" '+((parseInt10(getCookie("CropFinder","1"))==0)?'selected="selected"':'')+'>'+tr.OFF+'</option><option value="1" '+((parseInt10(getCookie("CropFinder","1"))==1)?'selected="selected"':'')+'>'+tr.ON+'</option></select></td></tr>';
    s+='<tr><td style="background:none;color:'+SettingsFrameTextColor+';">'+tr.e_finder+'</td><td style="background:none;"><select id="ElephantFinder"><option value="0" '+((parseInt10(getCookie("ElephantFinder","1"))==0)?'selected="selected"':'')+'>'+tr.OFF+'</option><option value="1" '+((parseInt10(getCookie("ElephantFinder","1"))==1)?'selected="selected"':'')+'>'+tr.ON+'</option></select></td></tr>';
    s+='<tr><td style="background:none;color:'+SettingsFrameTextColor+';">'+tr.warehouse+'</td><td style="background:none;"><select id="warehouse_stat"><option value="0" '+((parseInt10(getCookie("Warehouse","1"))==0)?'selected="selected"':'')+'>'+tr.OFF+'</option><option value="1" '+((parseInt10(getCookie("Warehouse","1"))==1)?'selected="selected"':'')+'>'+tr.ON+'</option></select></td></tr>';
    s+='<tr><td style="background:none;color:'+SettingsFrameTextColor+';">'+tr.show_troop_resc_button+'</td><td style="background:none;"><select id="villagelinks"><option value="0" '+((parseInt10(getCookie("VillageLinks","1"))==0)?'selected="selected"':'')+'>'+tr.OFF+'</option><option value="1" '+((parseInt10(getCookie("VillageLinks","1"))==1)?'selected="selected"':'')+'>'+tr.ON+'</option></select></td></tr>';
    s+='<tr><td style="background:none;color:'+SettingsFrameTextColor+';">'+tr.FarmListTools+'</td><td style="background:none;"><select id="FarmListTools"><option value="0" '+((parseInt10(getCookie("FarmListTools","0"))==0)?'selected="selected"':'')+'>'+tr.OFF+'</option><option value="1" '+((parseInt10(getCookie("FarmListTools","0"))==1)?'selected="selected"':'')+'>'+tr.ON+'</option></select></td></tr>';
    s+='<tr><td style="background:none;color:'+SettingsFrameTextColor+';">'+tr.AttackBuilderTools+'</td><td style="background:none;"><select id="AttackBuilderTools"><option value="0" '+((parseInt10(getCookie("AttackBuilderTools","0"))==0)?'selected="selected"':'')+'>'+tr.OFF+'</option><option value="1" '+((parseInt10(getCookie("AttackBuilderTools","0"))==1)?'selected="selected"':'')+'>'+tr.ON+'</option></select></td></tr>';
    s+='<tr><th colspan="2" style="background-color:#d6d6d6;"><center><strong>'+tr.n_reports+'</strong></center></th></tr>';
    s+='<tr><td style="background:none;color:'+SettingsFrameTextColor+';">'+tr.show_n_report+'</td><td style="background:none;"><select id="NReports"><option value="0" '+((parseInt10(getCookie("NeighbourReports","1"))==0)?'selected="selected"':'')+'>'+tr.OFF+'</option><option value="1" '+((parseInt10(getCookie("NeighbourReports","1"))==1)?'selected="selected"':'')+'>'+tr.ON+'</option></select></td></tr>';
    s+='<tr><td style="background:none;color:'+SettingsFrameTextColor+';">'+tr.player_info+'</td><td style="background:none;"><select id="PlayerInfo"><option value="0" '+((parseInt10(getCookie("PlayerInfo","1"))==0)?'selected="selected"':'')+'>'+tr.OFF+'</option><option value="1" '+((parseInt10(getCookie("PlayerInfo","1"))==1)?'selected="selected"':'')+'>'+tr.ON+'</option></select></td></tr>';
...
function SetBut()
{
    ...
    im.setAttribute( 'width', '24px' );
    im.setAttribute('title', 'T4 Script | mertskaplan.com');
    ...
    //$(butt).css( 'right','100px');
    sButton.appendChild( im );
    $('ul#outOfGame').width( $('ul#outOfGame').width() + im.width + 4 );
    $('ul#outOfGame').prepend( sButton );
...
var ShowHide_Own_Villages = function(){
    ...
    var x = parseInt10(document.getElementById('cooX').value);
    var y = parseInt10(document.getElementById('cooY').value);
...
var get_Villages_for_table = function(){
    ...
    zoom = parseInt10(document.getElementById('zoom').value);
    ...
    $.getJSON(tserver, "cmd=mapPositionData&data[x]=" + x + "&data[y]=" + y + "&data[zoomLevel]="+zoom+"&", function(data) {
        ...
        $(data.data.tiles).each(function(index,elem) {
            if ((elem.d) && (parseInt10(elem.d)>0) && ( elem.t.indexOf('{k.spieler} ') > -1 ) ) {
                var vil = [];
                ...
                vil.dist = Math.sqrt( Math.pow( parseInt10(elem.x) - x, 2 ) + Math.pow( parseInt10(elem.y) - y, 2 ) ).toPrecision(3);
...
var Draw_Village_Analyzer_tab = function(){
    ...
    var x = parseInt10( ActiveVillage.find('span.coordinateX').html().split('(')[1] );
    var y = parseInt10( ActiveVillage.find('span.coordinateY').html().split(')')[0] );
...
{
    eh=parseInt10(getErkezesiIdo().split(':')[0]);
    em=parseInt10(getErkezesiIdo().split(':')[1]);
    es=parseInt10(getErkezesiIdo().split(':')[2]);
...
function idozito_init(){
    ...
    $('form').submit(function(){
        return false;
    }).append('<p class="btn"><input type="button" alt="less" id="btn_back1" value="<<< Less" /> <input type="button" alt="More" id="btn_forward1" value="More >>" /></p><p class="btn"><input type="button" alt="Tamam" id="btn_ok1" value="Send" /></p>');

    //Add wave
    $('#btn_forward1').click(function(){
        //i++;	//Count waves
        $(what).clone().insertAfter(what)
        if(catapults.html())
    ...
    $(document).ready(function(){
        $('table.troop_details').append( makeTimerFields() );

        $('#start_ti').click(function(){
            $(this).everyTime(parseInt10(getCookie("timer_interv","500")),"idozito", function() {
                eido=getErkezesiIdo();
                eh=parseInt10(eido.split(':')[0]);
                if(eh==$('#h').val())
                {
                    em=parseInt10(eido.split(':')[1]);
                    if(em==$('#m').val())
                    {
                        es=parseInt10(eido.split(':')[2]);
                        if((es-$('#s').val())>=-parseInt10(getCookie("timer_offset","1")))
...
{
    var s='<span id="crop_tot">0</span> icinden <span id="crop_done">0</span> tarandi <br/>';
...
{
    var s='<span id="ele_tot">0</span> icinden <span id="ele_done">0</span> tarandi<br/>';
    s+='<input type="checkbox" id="croc_check"/> Ayni zamanda Timsah ara. <br/>';
...
{
    if(parseInt10(getCookie("CropFinder","1")))
    {
...
{
    if(parseInt10(getCookie("ElephantFinder","1")))
    {
        var div1=document.createElement('div');
...
{
    if(parseInt10(getCookie("NeighbourReports","1")))
    {
        var div1=document.createElement('div');
        div1.setAttribute('id', 'draggable2');
        div1.setAttribute('style', 'font-size:0.8em;position:inherited;height:'+getCookie("reports_window_height","300")+';width:'+getCookie("reports_window_width","250")+';font:1em;');
...
function getMap(x, y, rad) {
    ...
    var zoom=1;
    tserver+=document.location.href.split('/')[2];
    tserver+='/ajax.php?ajaxToken=' + unsafeWindow.window.ajaxToken + '&cmd=mapPositionData';
    ...
    $.ajax({
       url: 'ajax.php', 
       data: "ajaxToken=" + unsafeWindow.window.ajaxToken + "&cmd=mapPositionData&data[x]=" + x + "&data[y]=" + y + "&data[zoomLevel]="+zoom,
       dataType: "text",
       success: function( data ){
	   var adat = JSON.parse(data.replace('response','"response"'));
           //var adat = JSON.parse( data.replace(/[^a-zA-Z0-9 -]/g,"")/*.replace('response','"response"')*/ );
           $(adat.response.data.tiles).each(function(index,elem) {
            if (elem.c) {
                if (elem.c.indexOf("{k.f1}") >=0 ) {
                    $('<tr><td>9 Tarlali</td><td>' + elem.t + '</td></tr>').appendTo('#crop_fields');
                } else if (elem.c.indexOf("{k.f6}") >=0 ) {
                    $('<tr><td>15 Tarlali</td><td>' + elem.t + '</td></tr>').appendTo('#crop_fields');
                }	
            }
            $('#crop_done').html(parseInt10($('#crop_done').html())+1);	
        });
       }
    });
}
...
function getElephant(x,y,rad)
{
    ...
    tserver+=document.location.href.split('/')[2];
    mserver=tserver;
    mserver+='/ajax.php?ajaxToken=' + unsafeWindow.window.ajaxToken + '&cmd=mapPositionData';
    tserver+='/ajax.php';
    ...
    $.ajax({
       ...
       success: function( data ){
           ...
           $(adat.response.data.tiles).each(function(index,elem) {
            if (elem.c) {
                if (elem.c.indexOf("{k.fo}") >=0 ) {
                    $.ajax({
                        url: tserver,
                        data: "ajaxToken=" + unsafeWindow.window.ajaxToken + "&cmd=viewTileDetails&x="+elem.x+"&y="+elem.y,
                        dataType:"text",
                        async: false,
                        success: function(data){
                            if(data.split('u40')[1])
                                $('<tr><td>Fil</td><td>'+elem.t.split('</span></span>')[0]+'</span></span></td></tr>').appendTo('#elep_fields');
                            if((data.split('u38')[1])&&($("#croc_check").attr('checked')))
                                $('<tr><td>Timsah</td><td>'+elem.t.split('</span></span>')[0]+'</span></span></td></tr>').appendTo('#elep_fields');
                        }
                    });
                }	
            }
            $('#ele_done').html(parseInt10($('#ele_done').html())+1);	
        });
       }
    });
}
...
{
    $("#crop_fields").empty();
    var originalX = parseInt10($("#crop_x").val());
    var originalY = parseInt10($("#crop_y").val());
    var radius = parseInt10($("#rad").val());
    var tot=0;
    switch(radius)
    {
        case 4:
...
{
    $("#elep_fields").empty();
    var originalX = parseInt10($("#elep_x").val());
    var originalY = parseInt10($("#elep_y").val());
    var radius = parseInt10($("#rad_elep").val());
    var tot=0;
    switch(radius)
    {
        case 4:
...
function warehouse()
{
    if(parseInt10(getCookie("Warehouse","1")))
    {
        var termeles = [];
        var nyersanyag = [];
        var raktar = parseInt(window.wrappedJSObject.resources.maxStorage.l1);
        var magtar = parseInt(window.wrappedJSObject.resources.maxStorage.l4);
        /*var raktar = parseInt10( $('#stockBarWarehouse').html().replace(/[.]/g,'') );
        var magtar = parseInt10( $('#stockBarGranary').html().replace(/[.]/g,'') );*/
        //console.log( window.wrappedJSObject.resources.storage );
        for(var i = 0; i < 4; i++) {
            var val = parseInt(window.wrappedJSObject.resources.production["l" + (i + 1)]);
            var val2 = parseInt( window.wrappedJSObject.resources.storage["l" + (i + 1)]);
            nyersanyag[i] = isNaN(val2) ? 0 : val2;
            termeles[i] = isNaN(val) ? 0 : val;
            setCookie(ActiveVillage + '_resource_' + i, termeles[i]);
        }
        
        console.log(nyersanyag);
        console.log(termeles);
        /*$("table#production tr:gt(0)").each(function(i){
            var val = parseInt10( $('td.num',this).html().replace(/[^a-zA-Z0-9 -]/g,"") );
            //val = val.replace( ' ', '', 'g' );
            termeles[i] = isNaN( val )?0:val;
            setCookie( ActiveVillage+'_resource_'+i, termeles[i] );
        });*/
        //console.log( termeles );
        /*if( termeles.length < 4 ){
            for( i=0;i<=3;i++)
                termeles[i] = getCookie( ActiveVillage+'_resource_'+i, 0);
        }
        for(var i=0; i<=4; i++){
            nyersanyag[i-1] = parseInt10($("span#l"+i).html());
        }*/
        /*
        $("#stockBar li[id^='stockBarResource']").each(function(i){
            var val = parseInt10( $(this).html().replace('.','') )
            nyersanyag[i] = isNaN( val )?0:val;
        });*/
        //console.log( termeles );
        //console.log( nyersanyag );
        var f_ora=Math.floor(((raktar-nyersanyag[0])/termeles[0]));    
        var f_min=Math.floor((raktar-(f_ora*termeles[0])-nyersanyag[0])/(termeles[0]/60));
        if( f_ora < 100000){
            f_ora = ((f_ora<10)?('0'+f_ora):f_ora);
            f_min = ((f_min<10)?('0'+f_min):f_min);
        }else{
            f_ora = "&infin;";
            f_min = "&infin;";
        }
        var fa_text= "<span title=\"Tasacak\" class=\"wareHouseFullText\" style=\"color: #000;\">Tasacak:"+f_ora+":"+f_min+"</span>";
        
        var a_ora=Math.floor(((raktar-nyersanyag[1])/termeles[1]));    
        var a_min=Math.floor((raktar-(a_ora*termeles[1])-nyersanyag[1])/(termeles[1]/60));
        if( a_ora < 100000){
            a_ora = ((a_ora<10)?('0'+a_ora):a_ora);
            a_min = ((a_min<10)?('0'+a_min):a_min);
        }else{
            a_ora = "&infin;";
            a_min = "&infin;";
        }
        var a_text= "<span title=\"Tasacak\" class=\"wareHouseFullText\" style=\"color: #000;\">Tasacak:"+a_ora+":"+a_min+"</span>";
        
        var v_ora=Math.floor(((raktar-nyersanyag[2])/termeles[2]));    
        var v_min=Math.floor((raktar-(v_ora*termeles[2])-nyersanyag[2])/(termeles[2]/60));
        if( v_ora < 100000){
            v_ora = ((v_ora<10)?('0'+v_ora):v_ora);
            v_min = ((v_min<10)?('0'+v_min):v_min);
        }else{
            v_ora = "&infin;";
            v_min = "&infin;";
        }
        var v_text= "<span title=\"Tasacak\" class=\"wareHouseFullText\" style=\"color: #000;\">Tasacak:"+v_ora+":"+v_min+"</span>";
        
        if( termeles[3]>0 ){
            var b_ora=Math.floor(((magtar-nyersanyag[3])/termeles[3]));    
            var b_min=Math.floor((magtar-(b_ora*termeles[3])-nyersanyag[3])/(termeles[3]/60));
            if( b_ora < 100000){
                b_ora = ((b_ora<10)?('0'+b_ora):b_ora);
                b_min = ((b_min<10)?('0'+b_min):b_min);
            }else{
                b_ora = "&infin;";
                b_min = "&infin;";
            }
            var b_text= "<span title=\"Tasacak\" class=\"wareHouseFullText\" style=\"color: #000;\">Tasacak:"+b_ora+":"+b_min+"</span>";
        }else{
            b_ora=Math.floor( (-1) * nyersanyag[3]/termeles[3] );
            b_min=Math.floor( ((nyersanyag[3] + (b_ora*termeles[3]))/termeles[3])*(-60) );
            b_ora = ((b_ora<10)?('0'+b_ora):b_ora);
            b_min = ((b_min<10)?('0'+b_min):b_min);
            b_text= "<span title=\"Empty in\" class=\"granaryFullText\" style=\"color: #F00;\">Empty in:"+b_ora+":"+b_min+"</span>";
        }
        
        $("#stockBarResource1 div.middle").append( fa_text );
        $("#stockBarResource2 div.middle").append( a_text );
        $("#stockBarResource3 div.middle").append( v_text );
        $("#stockBarResource4 div.middle").append( b_text );
        
        $("ul#stockBar").css({
            'background-image': 'url('+warehouseBox+')',
            'height': '62px'});
    }
}
...
function village_links()
{
    if(parseInt10(getCookie("VillageLinks","1"))){
        $("div.innerBox.content ul li:not(.active) a[href^='?newdid=']").each(function(){
            var x = parseInt10( $(this).find('span.coordinateX').html().replace('(','') );
            var y = parseInt10( $(this).find('span.coordinateY').html().replace(')','') );
            var nyersanyag_link='http://'+document.location.href.split('/')[2]+'/build.php?gid=17&x='+x+'&y='+y + variables.url_extensions.market_place_send_view;
            ...
            egyseg_kep.setAttribute( 'style', 'margin-left: 13px;' );  
            
            egyseg_gomb.setAttribute( 'href', egyseg_link);
            egyseg_gomb.setAttribute('title', tr.send_troops);
            egyseg_gomb.appendChild( egyseg_kep );
            $("div.name",this).before( egyseg_gomb );
            ...
            nyersanyag_kep.setAttribute( 'style', 'margin-left: 26px;' );
            
            nyersanyag_gomb.setAttribute( 'href', nyersanyag_link);
            nyersanyag_gomb.setAttribute('title', tr.send_resources);
            nyersanyag_gomb.setAttribute('style', 'vertical-align:middle;');
            nyersanyag_gomb.appendChild( nyersanyag_kep );
            $("div.name",this).before( nyersanyag_gomb );
            ...
            $("div.name",this).prepend(gomb);
            $("div.name",this).prepend(gomb2);*/
        });/*
...
function ShowAgentStat(table_id)
{
    $('#'+table_id+' a[href*="spieler.php?uid="]').each(function(i,e)
    {
        ...
        player_id=parseInt10(player_profile.split('=')[1]);
        $sor.append('<a href="'+getCookie("AnalyzerLink","http://travian.ws/analyser.pl?s=hu6")+'&uid='+player_id+'" title="'+tr.Analyzer+'" target="_blank"><img src="'+analyser_icon+'" width="16" height="16" style="vertical-align: bottom;"></a>');
        info='';
        ...
        $.ajax({
            ...
            success: function(data){
                ...
                $('table#villages',data).find('.coordinates').each(function(){
                    x = parseInt10( $(this).find('.coordinateX').html().split('(')[1] );
                    y = parseInt10( $(this).find('.coordinateY').html().split(')')[0] );
                    if((x<0)&&(y<0))
                        max_dny++;
                    if((x>0)&&(y<0))
                        max_dk++;
...
function get_player_data(elem)
{
    ...
    $.ajax({
        ...
        async:false,
        success: function(data){
            attack_rank=parseInt10($(data).find('input[name="rank"]').val());
    ...
    $.ajax({
        ...
        async:false,
        success: function(data){
            defence_rank=parseInt10($(data).find('input[name="rank"]').val());
    ...
    if(piac)
    {
        ...
        for(i=0;i<nyersik.length;i++)
        {
            ...
            if(a[0].innerHTML != user)
            {
                ...
                chil=nyersik[i].getElementsByClassName('res')[0].getElementsByTagName('span')[0];
                k=1;
                if(isNaN(parseInt10(chil[k+1].nodeValue)) || isNaN(parseInt10(chil[k+1].nodeValue)) || isNaN(parseInt10(chil[k+1].nodeValue)) || isNaN(parseInt10(chil[k+1].nodeValue)))
                {
                ...
                fa+=isNaN(parseInt10(chil[k+1].nodeValue))?0:parseInt10(chil[k+1].nodeValue);
                agyag+=isNaN(parseInt10(chil[k+3].nodeValue))?0:parseInt10(chil[k+3].nodeValue);
                vas+=isNaN(parseInt10(chil[k+5].nodeValue))?0:parseInt10(chil[k+5].nodeValue);
                buza+=isNaN(parseInt10(chil[k+7].nodeValue))?0:parseInt10(chil[k+7].nodeValue);
                */
        ...
        adattabla.innerHTML='<tbody><tr class="res"><th>'+tr.Total+'</th><td colspan="2"><span><img class="r1" src="img/x.gif" alt="Fa" title="Fa" /> '+fa+'&nbsp;&nbsp;<img class="r2" src="img/x.gif" alt="Agyag" title="Agyag" /> '+agyag+'&nbsp;&nbsp;<img class="r3" src="img/x.gif" alt="VasÃ¯Â¿Â½rc" title="VasÃ¯Â¿Â½rc" /> '+vas+'&nbsp;&nbsp;<img class="r4" src="img/x.gif" alt="BÃ¯Â¿Â½za" title="BÃ¯Â¿Â½za" /> '+buza+'&nbsp;&nbsp;</td></tr></tbody>';
...
function main()
{
    ...
    switch(page)
    {
        ...
        case "allianz.php":
        {
            ...
            else
            {
                ...
                $(function(){
                    if(parseInt10(getCookie("PlayerInfo","1"))==1)
        ...
        case "build.php":
        {
            var container = $('div#build').attr('class').split(' ')[0];
            ...
            switch( container ){
                case "gid16":{ //Rallypoint
                    if( urlParams != "undefined" ){
                        tab_id = parseInt10(urlParams.tt); 
                    }
                    switch( tab_id ){
                        case 2:{ //send troops
                               
                            if( parseInt10(getCookie("AttackBuilderTools","0")) == 1 ){
                        ...
                        case 99:{ // Farm list
                            if( parseInt10(getCookie("FarmListTools","0")) == 1 )
    ...
    //alert( unsafeWindow.window.ajaxToken );
...
$(function() {
    // fenylo gold gomb kivevese
    $("li#n7").html('');
    $("li#n7").append( '<img src="'+goldImage+'" onclick="window.fireEvent(\'startPaymentWizard\', {});" style="cursor: pointer;"/>');
    ...
    $( "#draggable" ).dialog({
        ...
        title: tr.c_finder,
        minHeight:100,
        height: parseInt10(getCookie("Crop_finder_window_height","300")),
        width: parseInt10(getCookie("Crop_finder_window_width","250")),
        position: [parseInt10(getCookie("Crop_finder_window_left","100")),parseInt10(getCookie("Crop_finder_window_top","100"))],
        buttons: {
            "Tamam": SearchCropFields
        },
        closeOnEscape: false,
    ...
    $( "#draggable2" ).dialog({
        ...
        title: tr.n_reports,
        minHeight:100,
        height: parseInt10(getCookie("reports_window_height","300")),
        width: parseInt10(getCookie("reports_window_width","250")),
        position: [parseInt10(getCookie("reports_window_left","100")),parseInt10(getCookie("reports_window_top","100"))],
        //buttons: {"Tamam": },
        buttons: {
            "Yenile": RefreshNeighbourData
        },
        closeOnEscape: false,
        dragStop: function(event, ui) {
            var Stoppos = ui.position;
    ...
    $( "#draggable3" ).dialog({
        ...
        title: tr.e_finder,
        minHeight:100,
        height: parseInt10(getCookie("Elephant_finder_window_height","300")),
        width: parseInt10(getCookie("Elephant_finder_window_width","250")),
        position: [parseInt10(getCookie("Elephant_finder_window_left","100")),parseInt10(getCookie("Elephant_finder_window_top","100"))],
        buttons: {
            "Tamam": SearchElephants
        },
        closeOnEscape: false,
        dragStop: function(event, ui) {
            var Stoppos = ui.position;
...
function loadVersionVariables(){
    if( unsafeWindow.Travian.Game.speed > 0 ){
    ...
    switch(language)
    {
        case 'hu':
        {
            tr = {
                ...
                show_troop_resc_button: 'Egység/nyersanyag küldő gombok a falu listában',
                ON: 'Be',
                OFF: 'Ki',
                button_Save: 'Mentés',
                button_Cancel: 'Mégse',
                ...
                battle_rep_hide_deff: "Védekező elrejtése",
                ...
                Delete_Confirmation : 'Tényleg törőlni szeretnéd ezt az elemet?',
                ...
                Note_NoMainVillages : 'Megjegyzés: Fő falvak nincsenek megjelenítve!',
                FarmListTools : 'Farm lista eszközök használata',
                AttackBuilderTools: 'Támadás készítő használata'
            }//tr array
            break;
        }//case hu
        case 'ro':
        {
            tr = {
                ...
                refresh_rate : 'Rata de Ã¯Â¿Â½ncercare (in ms)',
                send_delay: 'Trimiterea trupelor mai repede cu (secunde)',
                tools: 'Unelte',
                c_finder: 'CautÃ¯Â¿Â½ lan de grÃ¯Â¿Â½u',
                arrives: 'Timpul sosirii',
                script_settings: 'SetÃ¯Â¿Â½ri script',
                stylesheet: 'Skin',
                n_reports: 'Ã¯Â¿Â½mprejurimi',
                show_n_report: 'AratÃ¯Â¿Â½ dialogul pentru Ã¯Â¿Â½mprejurimi',
                e_finder: 'CÃ¯Â¿Â½utÃ¯Â¿Â½tor de elefan?i',
                send_troops: 'Trimiterea trupelor', 
                send_resources: 'Trimiterea resurselor',
                warehouse: 'AratÃ¯Â¿Â½ starea hambarului',
                show_troop_resc_button: 'Se vÃ¯Â¿Â½d butoanele de trimitere trupe/resource Ã¯Â¿Â½n lista de sate',
                ON: 'On',
                OFF: 'Off',
                ...
                player_info: 'Informa?ii jucÃ¯Â¿Â½tor pe pagina alian?ei',
                parameters: 'Parametri',
                new_recp: 'Destinatar Nou',
                battle_rep: 'SalveazÃ¯Â¿Â½ raportul (travian-reports.net)',
                battle_rep_hide_deff: "Hide deffenders troop",
                Button_Village_Analyzer : 'Sate alÃ¯Â¿Â½turate',
                Button_Search_Text: 'CautÃ¯Â¿Â½',
                VillageTable_Name : 'Sat',
                VillageTable_Pop : 'Locuitori',
                VillageTable_Owner : 'Proprietar',
                VillageTable_Alli : 'Alian?Ã¯Â¿Â½',
                VillageTable_Dist : 'Dist.',
                Delete_Confirmation : 'Chiar vrei sÃ¯Â¿Â½ ?tergi acest farm?',
                SelectBox_Zoom_Small : 'Mic(Rapid)',
                SelectBox_Zoom_Medium : 'Mediu(Normal)',
                SelectBox_Zoom_Large : 'Mare(Lent)',
                CheckBox_ShowHideownvillages : 'AratÃ¯Â¿Â½/Ascunde satele proprii',
                CheckBox_ShowHideallyvillages : 'AratÃ¯Â¿Â½/Ascunde satele alian?ei',
                Text_Searching_center : 'Centrul cÃ¯Â¿Â½utÃ¯Â¿Â½rii',
                Note_NoMainVillages : 'NotÃ¯Â¿Â½: Capitalele (satele principale) nu sunt listate!',
        ...
        {
            tr = {
                troop_timer : 'Asker Zamanlari',
                refresh_rate : 'Yenilenme Zamani (in ms)',
                send_delay: 'Su saniyeden once gonder',
                tools: 'Araclar',
                c_finder: 'Tarla bulucu',
                arrives: 'Su zamanda varir',
                script_settings: 'Script Ayarlari',
                stylesheet: 'Gorunum',
                n_reports: 'Komsu Raporlari',
                show_n_report: 'Komsu Raporlarini Goster',
                e_finder: 'Fil Bulucu',
                send_troops: 'Asker Gonder', 
                send_resources: 'Hammadde Gonder',
                warehouse: 'Depolarin tasma suresini goster',
                show_troop_resc_button: 'Koy listesinde Hammadde ve Asker gonder butonlarini goster',
                ON: 'Acik',
                OFF: 'Kapali',
                button_Save: 'Kaydet',
                button_Cancel: 'Iptal',
                button_Remove: 'Kaldir',
                SW: 'SW',
                SE: 'SE',
                NW: 'NW',
                NE: 'NE',
                Total: 'Toplam',
                Analyzer: 'Analiz',
                analyzer_link: 'Bu serverin "Travian world analyzer" linki',
                player_info: 'Birlik sayfasindaki oyuncu istatistikleri',
                parameters: 'Diger Secenekler',
                new_recp: 'Yeni Alici',
                battle_rep: 'Savas Raporunu Kaydet ve Paylas (travian-reports.net)',
                battle_rep_hide_deff: "Savunma Askerlerini Gizle",
                Button_Village_Analyzer : 'Koyleri Al',
                Button_Search_Text: 'Ara',
                VillageTable_Name : 'Koy',
                VillageTable_Pop : 'Nufus',
                VillageTable_Owner : 'Sahibi',
                VillageTable_Alli : 'Birlik',
                VillageTable_Dist : 'Dist.',
                Delete_Confirmation : 'Bu girisi gercekten silmek istiyormusunuz?',
                SelectBox_Zoom_Small : 'Kucuk(Hizli)',
                SelectBox_Zoom_Medium : 'Orta(Normal)',
                SelectBox_Zoom_Large : 'Genis(Yavas)',
                CheckBox_ShowHideownvillages : 'Kendi koylerini Goster/Gizle',
                CheckBox_ShowHideallyvillages : 'Birlik koylerini Goster/Gizle',
                Text_Searching_center : 'Arastirma merkezi',
                Note_NoMainVillages : 'Not: Merkez koyler listeden cikartildi!',
                FarmListTools : 'Yagma listesi araclari',
