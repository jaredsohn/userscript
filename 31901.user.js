...
document.getElementById("shoutbar").innerHTML ='<div id="shouttab" onclick="showshout()" ondblclick="hideshout()"><a style="height:100%;width:100%;"></a></div>'
	...
	+ '<div id="shoutframe" style="position:absolute;top:60px;bottom:3px;righ:4px;""><iframe src=" adresse a mettre pour le chat" width="150" height="350" frameborder="0" allowtransparency="true"></iframe></div>'
