// ==UserScript==
// @name          Download FB Album mod دانلود کل آلبوم فیسبوک
// @version       0.13.6.7
...
if(document.querySelector('#dFA')||(location.href.indexOf('//www.facebook.com')<0&&location.href.indexOf('instagram.com')<0)){return;}
...
switch(request.type){
	...
	case 'export':
		...
		tHTML=tHTML+'<header id="hd"><div class="logo" id="logo"><div class="wrapper"><h1><a id="aName" href='+c.aLink+'>'+c.aName+'</a> '+((c.aAuth)?'- '+c.aAuth:"")+' <button onClick="cleanup()">ReStyle</button></h1><h1 class="msg">Press Ctrl+S (with Complete option) to save all photos. [Photos are located in _files folder]</h1></div></div></header>';
