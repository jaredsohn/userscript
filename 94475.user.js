// ==UserScript==
// @name           Army Orders(eRepublik)
// @namespace      www.erepublik.com
// @description    Orders for Army
// @author         Morion
// @version        0.0.1.8
...
GM_xmlhttpRequest({
  method: 'GET',
  url: 'http://www.consortiumignem.org/armyorders.php',
  ...
  onload:function(response){       
    ...
    integr=document.getElementsByClassName( pin_class, document.getElementById('content') )[0];   
     ...
     if (confirm('Доступна новая ('+tags[5]+') версия Orders for Army. Хотите скачать?'))  window.open('http://userscripts.org/scripts/source/94475.user.js', '_self');
                              }
    ...
    icons.innerHTML+= '<a href="http://egov4you.info/army/valuation/164" target="_blank"><img src="http://egov4you.info/favicon.ico" height="22" width="22" style="vertical-align: middle;">&nbsp;Stats</a>&nbsp;&nbsp;';
    ...
    icons.innerHTML+= '<a href="http://userscripts.org/scripts/show/94475" target="_blank"><img src="http://groups.google.com/groups/img/gsecs/pages_24.png" height="18" width="18" style="vertical-align: middle;">&nbsp;Script ver. '+ version +'</a>&nbsp;&nbsp;';
