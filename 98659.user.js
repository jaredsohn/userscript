...
// @description    Ninja
// @require        http://sizzlemctwizzle.com/updater.php?id=98659&days=1
// @include	   http://corpr8.co.uk/newalert/html
// ==/UserScript==


var Version = '07.04.2011';
var Title = 'Cameo Tools';
...
*/
          ...
          <TR><TD class=xtab>OR: </td><TD class=xtab> Enter all or part of an alliance name: &nbsp;</td>\
           ...
           <TR><TD class=xtab>OR: </td><TD class=xtab> &nbsp;\
            ...
            <TD class=xtab><INPUT align=right id=allGotoPage type=submit value="Page" />\
             ...
             <span align=right  Model ETA with: </span></td>\
  ...
  eventGotOtherAlliancePage : function (rslt){
    ...
    m += '</tbody></TABLE><div height:20px;width:560px; ><span> <a onclick="PTalClickPrev(-1)"> [Begin] </a><a onclick="PTalClickPrev(10)"> [-10] </a><a onclick="PTalClickPrev(5)"> [-5] </a><a onclick="PTalClickPrev(1)"> [Prev] </a> \
  ...
  init : function (div){
    ...
    try {      
      ...
      m += '<TR><TD><INPUT id=togAllRpts type=checkbox /></td><TD>Enable enhanced Alliance Reports.</td></tr>\
        ...
        <TR><TD><INPUT id=togChatStuff type=checkbox /></td><TD>Enable Chat enhancements (clickable coords, click on icon to whisper)</td></tr>\
...
if(document.getElementById("mod_comm_list1"))
  { document.getElementById("mod_comm_list1").style.backgroundColor = '#C24646';}

if(document.getElementById("mod_comm_list2"))
  { document.getElementById("mod_comm_list2").style.backgroundColor = '#46C246';}
