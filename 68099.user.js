...
// @include      http://backloggery.com/*
// @include      http://www.backloggery.com/*
...
var ddicons = new Array();
var miscIcons = new Array();
var icon_urls = new Array();

//Association between keywords and icons
ddicons['gog.com'] = 0; //Change to 1 to use the "gog" icon
ddicons['gog'] = 0; //Change to 1 to use the "gog" icon
...
icon_urls[0] = "http://www.gog.com/favicon.ico"; //"gog com" icon
icon_urls[1] = "http://www.gog.com/favicon.gif"; //"gog" icon
icon_urls[2] = "http://store.steampowered.com/favicon.ico";
icon_urls[3] = "http://i55.tinypic.com/bf4c9f.png";
icon_urls[4] = "http://i40.tinypic.com/vqtnpj.png";
icon_urls[5] = "http://i53.tinypic.com/2dbszr7.png";
icon_urls[6] = "http://impulsedriven.com/favicon.ico";
icon_urls[7] = "http://i42.tinypic.com/9q8g46.png";
icon_urls[8] = "http://www.gamersgate.com/favicon.ico";
icon_urls[9] = "http://amanita-design.net/favicon.ico";
icon_urls[10] = "http://www.tale-of-tales.com/favicon.ico";
icon_urls[11] = "http://i40.tinypic.com/2nw0ap0.png";
icon_urls[12] = "http://www.2dboy.com/favicon.ico";
icon_urls[13] = "http://i47.tinypic.com/1266vr7.jpg";
icon_urls[14] = "http://i40.tinypic.com/2a5j4x.png";
icon_urls[15] = "http://i44.tinypic.com/244366p.png";
icon_urls[16] = "http://i47.tinypic.com/2hnxnwg.png";
icon_urls[17] = "http://i45.tinypic.com/xmjp6t.png";
icon_urls[18] = "http://i45.tinypic.com/2w6a2hh.png";
icon_urls[19] = "http://i48.tinypic.com/2n9xdad.png";
icon_urls[20] = "http://battle.net/static/images/meta/favicon.ico";
icon_urls[21] = "http://live.xbox.com/Shell/images/favicon.ico";
icon_urls[22] = "http://i53.tinypic.com/mm7h4z.png";
icon_urls[23] = "http://getgamesgo.com/static/images/favicon.ico";
icon_urls[24] = "http://live.xbox.com/Shell/images/favicon.ico";
icon_urls[25] = "https://ssl.gstatic.com/android/market_images/web/favicon.ico";
icon_urls[26] = "http://i55.tinypic.com/2vnlxrk.png";
icon_urls[27] = "https://humblebundle-a.akamaihd.net/static/hashed/042851312dabcca12882f7282c6a7620bc1b4f42.png";
icon_urls[28] = "http://www.desura.com/favicon.ico";
icon_urls[29] = "http://www.beamdog.com/images/2.0/favicon.png";
icon_urls[30] = "http://www.casebookthegame.com/favicon.ico";
icon_urls[31] = "http://i51.tinypic.com/vndwlv.png";
icon_urls[32] = "http://drh.img.digitalriver.com/DRHM/Storefront/Site/ea/pb/images/Origin_favicon.ico";
icon_urls[33] = "http://www.nintendo.com/favicon.ico";
icon_urls[34] = "http://i.imgur.com/BEHlNk2.png";
icon_urls[35] = "http://www.sizefivegames.com/favicon.ico";
icon_urls[36] = "http://www.indieroyale.com/favicon.ico";
icon_urls[37] = "http://i44.tinypic.com/iz0u4p.png";
icon_urls[38] = "http://www.amazon.com/favicon.ico";
icon_urls[39] = "http://www.greenmangaming.com/static/favicon.ico";
icon_urls[40] = "http://static2.cdn.ubi.com/gamesites/uplay/201212201711/img/favicon.ico";
icon_urls[41] = "http://freebirdgames.com/favicon.ico";
icon_urls[42] = "http://www.indiegala.com/favicon.ico";
icon_urls[43] = "http://www.kickstarter.com/favicon.ico";
icon_urls[44] = "https://indiegamestand.com/favicon.ico";
icon_urls[45] = "https://g0.iggcdn.com/assets/favicon/favicon-32-0f9aeeb53db5c05c25bf147307b8a645.png";

//Variables for gathering statistics
var downloadServiceStatistics = new Object();
var yearStatistics = new Object();
var downloadServiceTotalCount = 0;
var yearTotalCount = 0;
var gamesSum = 0;
var systemCount = new Object();
var ownershipCount = new Array(4);
for (i = 0; i < ownershipCount.length; i++)
  ownershipCount[i] = 0;

//Process game list on games.php page
function gameListUpdated() {
  $("div#content")[0].removeEventListener("DOMNodeInserted", gameListUpdated, false);
  ...
  $("section.gamebox:not(.processed):not(.boxtop):not(.systemend)").each(function(index) {
    ...
    if ($(this).find('h2 img[alt="Comp"]').size() > 0) {
    ...
    if (system == "Steam")
      createIconsFromKeyWord("[Steam]", gameRow1);
    if (system == "GOG")
      createIconsFromKeyWord("[GOG]", gameRow1);
    
    //Get ownership information
    if (gameRow1.find('img[title="Formerly Owned"]').size() > 0)
      ownershipCount[1]++;
    else if (gameRow1.find('img[title="Borrowed/Rented"]').size() > 0)
      ownershipCount[2]++;
    else if (gameRow1.find('img[title="Ownership: Other"]').size() > 0)
      ownershipCount[3]++;
    else
      ownershipCount[0]++;
  
    //Parse words
    var words = gameRow2.text().split(" ");
    var hasYear = false;
    for (i in words) {
      var word = words[i];
  ...
  $("div#content")[0].addEventListener("DOMNodeInserted", gameListUpdated, false);
}

//Process now playing list
function processNowPlayingList() {
  $("div.npgame").each(function(index) {
    var progressDiv = $(this).children().eq(-2);
    var words = progressDiv.contents().get(0).data.split(" ");
    var hasYear = false;
    ...
    progressDiv.contents().get(1).data = words.join(" ");
  });
}
...
function processMultitap() {
  $("div.friend li").each(function(index) {
    ...
    var words = $(this).contents().get(3).data.split(" ");
    var hasYear = false;
    ...
    $(this).contents().get(3).data = words.join(" ");
  });
}

function createYearLabelFromKeyWord(word, yearNode) {
  year = /^\((\d{4})\)$/.exec($.trim(word));
  if (year) {
...
function updateCharts() {
  ...
  if (headerSection.find('div#chartDiv1').size() < 1)
    headerSection.append("<div id='chartDiv1'></div>");
  if (headerSection.find('div#chartDiv2').size() < 1)
...
function createOwnershipChartUrl() {
  var ownershipLabels = ["Owned", "Formerly Owned", 
    "Borrowed/Rented", "Other"];
    
  //Use chart colors similar to the ownership icons
  var colors = ["b6b718", "9bacff", "7a9e9c", "9b89b6"];
...
function log(message) {
  if (enableLogging) {
    ...
    displayMessage = addZero(now.getHours()) + ":" +
...
//setCookie and getCookie functions from w3schools.com
function setCookie(c_name,value,exdays) {
  var exdate=new Date();
  exdate.setDate(exdate.getDate() + exdays);
  var c_value=escape(value) + ((exdays==null) ? "" : "; expires="+exdate.toUTCString());
  document.cookie=c_name + "=" + c_value;
  log("Saved cookie " + c_name + " with value " + value);
}
...
function getCookie(c_name)
{
  ...
  for (i=0;i<ARRcookies.length;i++) {
    ...
    x=x.replace(/^\s+|\s+$/g,"");
    if (x==c_name) {
      log("Retrieved cookie " + c_name + " with value " + unescape(y));
      return unescape(y);
    }
  }
  log("Cookie " + c_name + " not found");
}

function getCookieOrDefaultValue(c_name, defaultValue) {
  var val = getCookie(c_name);
  if (isValidAndNotEmpty(val))
    return val;
  return defaultValue;
}

//Script update checker, based on http://userscripts.org/scripts/show/20145
//Modified for Chrome compatibility
var SUC_script_num = 68099;
function updateCheck(forced)
{
  if ((forced) || (parseInt(getCookieOrDefaultValue('tors_backloggery_scipt_last_update', '0')) + 86400000 <= (new Date().getTime()))) // Checks once a day (24 h * 60 m * 60 s * 1000 ms)
  {
    ...
    try
    {
      GM_xmlhttpRequest(
      {
        ...
        {
          log("Received response from userscripts.org");
          var local_version, remote_version, rt, script_name;
          rt=resp.responseText;
          setCookie('tors_backloggery_scipt_last_update', new Date().getTime()+'', 365);
          remote_version=parseInt(/@uso:version\s*(.*?)\s*$/m.exec(rt)[1]);
          local_version=parseInt(getCookieOrDefaultValue('tors_backloggery_scipt_current_version', '-1'));
          if(local_version!=-1)
          {
            log("Local version is "+local_version+", remote version is "+remote_version);
            ...
            if (remote_version > local_version)
            {
              if(confirm('There is an update available for the Greasemonkey script "'+script_name+'."\nWould you like to go to the install page now?'))
              {
                ...
                setCookie('tors_backloggery_scipt_current_version', remote_version, 365);
              }
            }
            else if (forced)
            ...
            log("Local version not set, setting value now");
            setCookie('tors_backloggery_scipt_current_version', remote_version+'', 365);
          }
        }
      });
    ...
    log("Update check skipped, less than 24h since last check");
  }
}
