// ==UserScript==
// @name           SRSMA Ban Button
// @description    Adds a button underneath a user to ban them from SRSMicroaggressions.
// @include        http://*.reddit.com/*
// @version        2012.10.23
// @credit         Credit to FarrahFawcett
// ==/UserScript==
...
function get_form(subr, username, userid) {
    ...
    s +=     '<a class="togglebutton" onclick="return toggle(this)" href="#">MAben</a>';
    s +=   '</span>';
    s +=   '<span class="option error">are you sure? ';
    s +=     '<a class="yes" onclick="var _r = reddit.post_site; reddit.post_site = \'SRSMicroaggressions\'; post_form(this.parentNode.parentNode, \'friend\'); reddit.post_site = _r;" href="javascript:void(0)">yis</a>';
    s +=     ' / ';
    s +=     '<a class="no" onclick="return toggle(this)" href="javascript:void(0)">naw</a>';
    s +=     ' / ';
    s +=     '<a class="unban" onclick="var _r = reddit.post_site; reddit.post_site = \'SRSMicroaggressions\'; change_state(this, \'unfriend\', function(form){$(form).find(\'.error\').not(\'.status\').hide();$(form).find(\'.status\').html(\'submitting...\').show();}); reddit.post_site = _r;" href="javascript:void(0);">unban</a>'
    s +=   '</span>';
