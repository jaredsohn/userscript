// ==UserScript==
// @name           Video Download Link (XH)
// @namespace      http://services.sample.me.uk/greasemonkey/vid_download_xh
...
//function addDownloadLink() {
    ...
    var regex = new RegExp("\'file\'\: \'([a-zA-Z0-9%:./+_-]*)\'","igm");
    var res = regex.exec(test);
    var vidurl = "";
    if (res.length > 0) {
        vidurl = 'http://xhamster.com/flv2/' + decode(res[1]);
    } else {
    ...
    if (vidurl != "") {
        Array.filter( document.getElementsByClassName('mTitle'), function(elem) {
            elem.innerHTML = '<a href="' + vidurl + '">Download</a> - ' + elem.innerHTML;
        });
    }
//}
