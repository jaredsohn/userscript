// ==UserScript==
// @name           OGame Redesign: Expo Fleet for Raider
// @namespace      8arlock
// @description    Auto calc expofleet for Raider
// @version        1.1.3
...
(function() 
{
    ...
    // shipsNoSat.push({id:202, name:"202", n:0, c:0, expo:12});   //Kleine Transporter
    // shipsNoSat.push({id:203, name:"203", n:0, c:0, expo:47});   //Grosse Transporter
    // shipsNoSat.push({id:204, name:"204", n:0, c:0, expo:12});   //Leichte Jaeger
    // shipsNoSat.push({id:205, name:"205", n:0, c:0, expo:110});  //Schwere Jaeger
    // shipsNoSat.push({id:206, name:"206", n:0, c:0, expo:47});   //Kreuzer
    // shipsNoSat.push({id:207, name:"207", n:0, c:0, expo:160});  //Schlachtschiff
    // shipsNoSat.push({id:208, name:"208", n:0, c:0, expo:30});   //Kolonieschiff
    // shipsNoSat.push({id:209, name:"209", n:0, c:0, expo:16});   //Recycler
    // shipsNoSat.push({id:210, name:"210", n:0, c:0, expo:1});    //Spionagesonde
    // shipsNoSat.push({id:211, name:"211", n:0, c:0, expo:75});   //Bomber
    // shipsNoSat.push({id:213, name:"213", n:0, c:0, expo:110});  //Zerstoerer
    // shipsNoSat.push({id:214, name:"214", n:0, c:0, expo:9000}); //Todesstern
    // shipsNoSat.push({id:215, name:"215", n:0, c:0, expo:70});   //Schlachtkreuzer

    shipsNoSat.push({id:202, name:"202", n:0, c:0, expo:20});    //Kleine Transporter
    shipsNoSat.push({id:203, name:"203", n:0, c:0, expo:60});    //Grosse Transporter
    shipsNoSat.push({id:204, name:"204", n:0, c:0, expo:20});    //Leichte Jaeger
    shipsNoSat.push({id:205, name:"205", n:0, c:0, expo:50});    //Schwere Jaeger
    shipsNoSat.push({id:206, name:"206", n:0, c:0, expo:135});   //Kreuzer
    shipsNoSat.push({id:207, name:"207", n:0, c:0, expo:300});   //Schlachtschiff
    shipsNoSat.push({id:208, name:"208", n:0, c:0, expo:150});   //Kolonieschiff
    shipsNoSat.push({id:209, name:"209", n:0, c:0, expo:80});    //Recycler
    shipsNoSat.push({id:210, name:"210", n:0, c:0, expo:5});     //Spionagesonde
    shipsNoSat.push({id:211, name:"211", n:0, c:0, expo:375});   //Bomber
    shipsNoSat.push({id:213, name:"213", n:0, c:0, expo:550});   //Zerstoerer
    shipsNoSat.push({id:214, name:"214", n:0, c:0, expo:45000}); //Todesstern
    shipsNoSat.push({id:215, name:"215", n:0, c:0, expo:350});   //Schlachtkreuzer
    ...
    function calcExp()
    {
        ...
        var bt_lim9 = (evaluemax == 9000 ? 150 : 200);
        var variant = 0;
        ...
        if (document.location.href.indexOf('page=fleet1') > -1) 
        {
            ...
            expofleet.innerHTML =	'<table cellspacing="5px" style="position: relative; left: 12px; top: 0px">' +
                            '<tr align="right">' +
                                ...
                                '<td><a href="#" id="eflbut2k"> <b>2500</b> </a></td>' +
                                '<td><a href="#" id="eflbut6k"> <b>6000</b> </a></td>' +
            ...
            calcExp ();
            text = fillexpofleet ();
            element = document.getElementById ("eflbut2k");
            ...
            calcExp ();
            text = fillexpofleet ();
            element = document.getElementById ("eflbut6k");
            element.setAttribute ("onclick", text.click);
            element.className = "tipsTitle selected expolink";
            element.title = text.title;			
            ...
            calcExp ();
            text = fillexpofleet ();
            element = document.getElementById ("eflbut9k");
            element.setAttribute ("onclick", text.click);
            element.className = "tipsTitle selected expolink";
            element.title = text.title;
