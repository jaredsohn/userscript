...
// @description    Script para la comunidad Game Ground
// @include        *taringa.net/*
// @exclude        *http://www.taringa.net/comunidades/tus-denuncias/*
// ==/UserScript==
...
byClass('menuTabs').innerHTML += "<li id=\"tabbedWTF\" class=\"tabbed\">\n <a href=\"http://www.taringa.net/comunidades/tus-denuncias/\" onclick=\"menu(\'Game Ground! \', this.href);return false;\" title=\"Ir a la comunidad Game Ground!\">Game Ground! <img src=\n\"http://k05.kn3.net/786C6F8D5.jpg\" alt=\"\" /></a>\n</li>";
...
function procesarEventos()
{
  ...
  {    
    div.innerHTML = '<div align="center"><img src="http://k05.kn3.net/786C6F8D5.jpg" alt=""></div>';
  }
}
