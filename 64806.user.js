// ==UserScript==
// @name            experienceproject-story
// @namespace       Platypus
// @include         http://www.experienceproject.com/stories/*
// @include         http://www.experienceproject.com/uw.php?e=*
// @description     Uses wide layout for experienceproject.com stories.
...
var main_div = document.getElementById('content-inner');  // EP may change this id from time to time!  
// Another way to index it is using the DIV number as follows:
// document.evaluate('/HTML[1]/BODY[1]/DIV[3]/DIV[2]/DIV[1]', document, null, XPathResult.FIRST_ORDERED_NODE_TYPE,null)

// EP keeps changing the page format so most of the following is commented out until it stabilizes:

// move group info from column 2 to column 1
// smart_remove(window.document,document.evaluate('./DIV[2]/DIV[1]/DIV[1]', main_div, null, XPathResult.FIRST_ORDERED_NODE_TYPE,null).singleNodeValue,null,null,null);
// script_paste(window.document,document.evaluate('./DIV[1]/DIV[1]/DIV[1]/P[2]', main_div, null, XPathResult.FIRST_ORDERED_NODE_TYPE,null).singleNodeValue,document.evaluate('./DIV[2]/DIV[1]/DIV[1]', main_div, null, XPathResult.FIRST_ORDERED_NODE_TYPE,null).singleNodeValue,null,null);

// remove "All Experiences"
// smart_remove(window.document,document.evaluate('./DIV[1]/DIV[1]/DIV[1]/P[1]/A[1]', main_div, null, XPathResult.FIRST_ORDERED_NODE_TYPE,null).singleNodeValue,null,null,null);

// remove "A STORY FROM THE GROUP"
// smart_remove(window.document,document.evaluate('./DIV[1]/DIV[1]/DIV[1]/P[2]', main_div, null, XPathResult.FIRST_ORDERED_NODE_TYPE,null).singleNodeValue,null,null,null);

// remove TOOLS block
smart_remove(window.document,document.evaluate('./DIV[1]/DIV[1]/DIV[1]/DIV[1]/DIV[1]/DIV[1]', main_div, null, XPathResult.FIRST_ORDERED_NODE_TYPE,null).singleNodeValue,null,null,null);

// remove rate-up
// smart_remove(window.document,document.evaluate('./DIV[1]/DIV[1]/DIV[1]/DIV[2]/P[2]', main_div, null, XPathResult.FIRST_ORDERED_NODE_TYPE,null).singleNodeValue,null,null,null);

// move image so it won't create a left margin
// smart_remove(window.document,document.evaluate('./DIV[1]/DIV[1]/DIV[1]/DIV[2]/A[1]', main_div, null, XPathResult.FIRST_ORDERED_NODE_TYPE,null).singleNodeValue,null,null,null);
// smart_remove(window.document,document.evaluate('./DIV[1]/DIV[1]/DIV[1]/DIV[2]/DIV[1]', main_div, null, XPathResult.FIRST_ORDERED_NODE_TYPE,null).singleNodeValue,null,null,null);
// script_paste(window.document,document.evaluate('./DIV[1]/DIV[1]/DIV[1]/DIV[2]/P[1]/A[1]', main_div, null, XPathResult.FIRST_ORDERED_NODE_TYPE,null).singleNodeValue,document.evaluate('./DIV[1]/DIV[1]/DIV[1]/DIV[2]/A[1]/IMG[1]', main_div, null, XPathResult.FIRST_ORDERED_NODE_TYPE,null).singleNodeValue,null,null);

// move text up so it won't have a left margin
// smart_remove(window.document,document.getElementById('story_div'),null,null,null);
// script_paste(window.document,document.evaluate('./DIV[1]/DIV[1]/DIV[1]/DIV[3]', main_div, null, XPathResult.FIRST_ORDERED_NODE_TYPE,null).singleNodeValue,document.getElementById('story_div'),null,null);

// smart_remove(window.document,document.evaluate('./DIV[1]/DIV[1]/DIV[1]/DIV[2]', main_div, null, XPathResult.FIRST_ORDERED_NODE_TYPE,null).singleNodeValue,null,null,null);
// script_paste(window.document,document.evaluate('./DIV[1]/DIV[1]/DIV[1]/DIV[4]/H3[1]', main_div, null, XPathResult.FIRST_ORDERED_NODE_TYPE,null).singleNodeValue,document.evaluate('./DIV[1]/DIV[1]/DIV[1]/DIV[2]', main_div, null, XPathResult.FIRST_ORDERED_NODE_TYPE,null).singleNodeValue,null,null);

// remove remainder of second column:
smart_remove(window.document,document.getElementById('sidebar'),null,null,null);

// Widen the page:
relax(window.document,document.getElementById('main'),null,null,null);
...
make_bw(window.document,document.evaluate('/HTML[1]/BODY[1]', document, null, XPathResult.FIRST_ORDERED_NODE_TYPE,null).singleNodeValue,null,null,null);

auto_repair_it(window.document,'/HTML[1]',null,null,null);
