// ==UserScript==
// @name           plug.dj KPHD Room Enhanced
// @namespace      Super
// @include        http://www.plug.dj/knifepartyhd-s-playhouse/
// @include        http://plug.dj/knifepartyhd-s-playhouse/
// @include        www.plug.dj/knifepartyhd-s-playhouse/
// @include        plug.dj/knifepartyhd-s-playhouse/
// @include        socketio.plug.dj/knifepartyhd-s-playhouse/
// @include        http://socketio.plug.dj/knifepartyhd-s-playhouse/
// @version        1.0
// @updateURL      https://raw.github.com/superimpega/KPHD.js/master/KPHDTEST.js
// @downloadURL    https://raw.github.com/superimpega/KPHD.js/master/KPHDTEST.js
// ==/UserScript==
...
function hhb_init() {
    ...
    if (typeof (unsafeWindow) === 'undefined' && (typeof (API) === 'undefined' || typeof (API.getSelf) === 'undefined' || typeof (API.getSelf().avatarID="monstercat === 'undefined')) {
...
function hhb_meanlist() {
    ...
    var a = unsafeWindow.API.getSelf().avatarID="monstercat"
    var mehlist = '';
    var wootlist = '';
    var undecidedlist = '';
    //alert(typeof(API));
    ...
    for (i in a) { //thanks to... (forgot)someone for the pointers
        ...
        //a[i].owner=true;
        ///}
        if (typeof (a[i].ambassador) !== 'undefined' && a[i].superuser == true) {
            str += 'chat-from-super ';
...
jsCode.setAttribute('src', 'https://raw.github.com/superimpega/KPHD.js/master/KPHDTEST.js');
