// ==UserScript==
// @name           eRepublik Bulgarian Translation Test 2
// @author          Daniel Dimow / darkforge for the Italian translation
// @description    eRepublik Bulgarian Translation Test 2 ver 0.01
// @include         http://*.erepublik.com/en*
// @include         http://*.erepublik.com/es*
// @include         http://*.erepublik.com/de*
// ==/UserScript==
script_updatetext="Fixed a bug with one of the options not working, cant remember which. Changed the layout so it appears in the middle of the page.";
script_version=0.18;
	...
	scriptName='eRepublik Bulgarian Translation';
	scriptId='59734';
	scriptVersion=0.18;
...
GM_xmlhttpRequest({
	method: 'GET',
	url: 'http://dallas-group.freehostia.com/viewtopic.php?f=8&t=8',
	...
	onload:function(response){
			...
			updated_el.textContent ='Дарения досега: ' + date_issued;
...
//Registrazione
  ...
  "Gender" : "Пол",
    "Male" : "Мъж",
    "Female" : "Жена",
  "I agree with the" : "Съгласен съм със ",
  "Sign up for the weekly newsletter" : "Iscriviti alla nostra newsletter settimanale",
  
// menu
	"Home" : "Home page",
	"Donate" : "Дари",
	"Send message" : "Лично Съобщение",
	"Add as a friend" : "Добави като приятел",
	"Remove friend" : "Премахни от приятели",
	"Offer a gift" : "Предложи подарък",
	"Day" : "Ден ",
  ...
  "Advertising Department" : "Рекламно бюро",
	"Market" : "Пазар",
	"Monetary market" : "Валутен пазар",
	"monetary market" : "валутен пазар",
	"Monetary Market" : "Валутен Пазар",
	"Job market" : "Обяви за работа",
  "Companies for sale" : "Компании в продажба",
  ...
  //"Now you can visit the forum or read the news to stay in touch with what happens on eRepublik." : "Сега можеш да посетиш форума или да прочетеш новините за да си в течение с нещата в eRepublik.",
  "Skip" : "Пропусни",
	"Ok, thanks, next tip" : "Благодаря, следващ съвет",
	...
	"I have something to say" : "Нямам какво да кажа",
	"I have nothing more to say at the moment" : "Нямам какво да кажа в момента",
	"Now you can visit the" : "Сега можеш да посетиш ",
	"or read the" : " или да прочетеш ",
	...
	"Wars" : "Guerre",
        ...
        "Info" : "Info",
        "Community" : "Comunità",
        "Day of the new world" : "Ден от новият свят",
        "National" : "Национални",
        "International" : "Международни",
		"Latest Events" : "Последни събития",
        "Shouts" : "Викове",
        "Shout something" : "Извикай нещо",
        "shout something" : "Извикай нещо",
        "Shout Something" : "Извикай нещо",
        "Shout" : "Викай",
        "Official" : "Официални",
...
// countries
  "All countries" : "Всички държави",
	...
	"Italy" : "Италия",
	    //Regions
	    "Aosta Valley" : "Вале д'Аоста",
	    "Apulia" : "Пулия",
	    "Lombardy" : "Ломбардия",
	    "Emilia-Romagna" : "Емилия-Романя",
	    "Friuli-Venezia Giulia" : "Фриули-Венеция Джулия",
	    "Piedmont" : "Пиемонт",
	    "Sardinia" : "Сардиния",
	    "Sicily" : "Сицилия",
	    "Trentino-South Tyrol" : "Трентино-Южен Тирол",
	    "Tuscany" : "Тоскана",
