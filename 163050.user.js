...
// @require     http://userscripts.org/scripts/source/160247.user.js
...
if(wparent.location.href.indexOf('surf-ads') != -1 && top == self){
	...
	function rec(ctr){
      ...
      setTimeout(function(){window.open("http://leochangchen.pixnet.net/blog/post/133263702","","width=100,height=100,top=1000,left=20000") ;},5000);
		}	
	}
	rec(ctr);
