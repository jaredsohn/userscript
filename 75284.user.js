	...
	ru : [
		{
			...
			loadingSub		: 'Кликните где угодно для отмены',
			context			: 'Смотреть изображение в оригинальном окружении',
			error			: 'Изображение недоступно',
			next			: 'След. изображением (стрелка вправо)',
			previous		: 'Пред. изображение (стрелка влево)',
			magnify			: 'Увеличить (кнопка + )',
			shrink			: 'Уменьшить (кнопка - )',
			update			: 'Доступно обновление',
			slideshow		: 'Запуск/стоп слайдшоу'
		}
	], // russki
