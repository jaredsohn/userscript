...
case "it": //by skejonte
text = ["Inviare truppe ! =)","Tipo d'attacco non correto !","Nessuna coordinata!","Truppe non sufficienti! (Truppa #","Nessuna truppa selezionata","Partenza","Coordinate errate","Nessuna spia","Parti","Ondata :","Nuova ondata","Resetta","Attacco :","Tipo d'attacco:","Normale","Rinforzo","Raid","Spia Risorse/Truppe","Spia Difese/Truppe","Coordinate","Invia truppe ! =)","Ora d'arrivo","Arrivo alle :","Decidi ora d'arrivo","Numero di attacchi di questa ondata","con '|' es: 0,0|1,1","ERRORE:","Impossibile ottenere i villaggi attivi. S'assume un solo villaggio","Ora d'arrivo fissata alle :"];

cataText = ["Selezionare un obiettivo =)","A caso","Segheria","Pozzo d'argilla","Miniera di Ferro","Campo di grano","Falegnameria","Fabbrica di mattoni","Fonderia","Mulino","Forno","Magazzino","Granaio","Fabbro","Armeria","Arena","centro del villaggio","campo d'addestramento","Mercato","Ambasciata","Caserma","Scuderia","Armi d'assedio","Accademia","Municipio","Residenza","Palazzo","Ufficio comerciale","Grande Caserma","Grande Scuderia","Circolo degli Eroi","Grande Magazzino","Grande Granaio","Meraviglie del Mondo(?)"];
break;
