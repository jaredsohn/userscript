...
// Minor Edits by BlueOni - I claim no ownership of this amazing tool
// originally developed by Julien Eyries
// And by Minor, I mean I've fixed some english translations...
//
// --------------------------------------------------------------------
//
...
// @description   improve HOMMK functionality
...
Message.prototype.from_HOMMK = function( content ) {
    ...
    case 'TROOP_SCOUTING':
        ...
        if (contentJSON.cityName)
            str.push( 'City Name: ' + contentJSON.cityName);
        
        if (contentJSON.cityFortificationName )
            str.push( 'Fortifications: ' + contentJSON.cityFortificationName );
        
        str.push( 'Scouting Results: '); 
        ...
        foreach( contentJSON.heroList, function(hero) {
                ...
                if (tmp.length) str.push( 'Artifact: '+ tmp.join(', ') );
...
function init() { 
    ...
    $dialog_panel.html(  "Version " + "B.O.E. " + "<br>" );
    ...
    $('<button id="hommk-user-scribe-button" style="margin-top:5px; display:block;">Scouting</button>')
        .button({disabled:true})
        .appendTo($panel_extended)
        .click(function() {
			$(this).button('widget').removeClass( "ui-state-focus" );
    ...
    $('<button style="margin-top:5px; display:block;">Troops</button>')
        .button()
        .appendTo($panel_extended)
        .click(function() {
			$(this).button('widget').removeClass( "ui-state-focus" );
    ...
    $('<button style="margin-top:5px; display:block;">Cartographer</button>')
        .button()
        .appendTo($panel_extended)
        .click(function() {
			$(this).button('widget').removeClass( "ui-state-focus" );
