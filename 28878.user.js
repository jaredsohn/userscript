...
// @description - Verión en Español, mejorada.
...
if(url.match('mod=map')) {
	...
	caption += '<p style="'+poz+pa+'width: 90px; left: 285px; top: 388px;'+z+fmodra+'">CoreLabs</p>';
	...
	caption += '<p style="'+poz+pa+'width: 70px; left: 315px; top: 558px;'+z+fmodra+'">MineLabs</p>';
	...
	caption += '<p style="'+poz+pa+'width: 100px; left: 530px; top: 460px;'+z+fmodra+'">StarLabs</p>';
	...
	caption += '<p style="'+poz+pa+'width: 80px; left: 455px; top: 662px;'+z+fmodra+'">TerraLabs</p>';
	...
	legend += '<p style="'+poz+pa+'width: 100px; left: 365px; top: 715px;'+z+fbila+'">Normal</p>';
	legend += '<p style="'+poz+pa+'width: 100px; left: 365px; top: 730px;'+z+fmodra+'">Laboratorio</p>';
	legend += '<p style="'+poz+pa+'width: 100px; left: 365px; top: 745px;'+z+fzelena+'">Comercio</p>';
	legend += '<p style="'+poz+pa+'width: 100px; left: 365px; top: 760px;'+z+ffialova+'">Mundo Principal</p>';
	
	minerals = '<span style="'+poz+pa+'width: 70px; left: 35px; top: 460px;'+z+fbila+'">Minerales:</span>';
	minerals += '<span style="'+poz+pa+'width: 140px; left: 40px; top: 475px;'+z+'"><img src="img/item/6_8k.gif"'+imga+'><span style="'+pr+fmodra+b+'">Megatan</span> <span style="'+pr+fbila+' left: 17px;">4 995</span></span>';
	minerals += '<span style="'+poz+pa+'width: 140px; left: 40px; top: 490px;'+z+'"><img src="img/item/6_9k.gif"'+imga+'><span style="'+pr+fmodra+b+'">Querell</span> <span style="'+pr+fbila+' left: 25px;">6 300</span></span>';
	minerals += '<span style="'+poz+pa+'width: 140px; left: 40px; top: 505px;'+z+'"><img src="img/item/6_10k.gif"'+imga+'><span style="'+pr+fmodra+b+'">Florisar</span> <span style="'+pr+fbila+' left: 23px;">8 167</span></span>';
	minerals += '<span style="'+poz+pa+'width: 140px; left: 40px; top: 520px;'+z+'"><img src="img/item/6_11k.gif"'+imga+'><span style="'+pr+fmodra+b+'">Warium</span> <span style="'+pr+fbila+' left: 21px;">3 132</span></span>';
	minerals += '<span style="'+poz+pa+'width: 70px; left: 605px; top: 460px;'+z+fbila+'">Minerales:</span>';
	minerals += '<span style="'+poz+pa+'width: 140px; left: 610px; top: 475px;'+z+'"><img src="img/item/6_12k.gif"'+imga+'><span style="'+pr+fmodra+b+'">Crisolita</span> <span style="'+pr+fbila+' left: 15px;">19 863</span></span>';
	minerals += '<span style="'+poz+pa+'width: 140px; left: 610px; top: 490px;'+z+'"><img src="img/item/6_13k.gif"'+imga+'><span style="'+pr+fmodra+b+'">Niciltar</span> <span style="'+pr+fbila+' left: 22px;">55 782</span></span>';
	minerals += '<span style="'+poz+pa+'width: 140px; left: 610px; top: 505px;'+z+'"><img src="img/item/6_14k.gif"'+imga+'><span style="'+pr+fmodra+b+'">Hipolio</span> <span style="'+pr+fbila+' left: 22px;">240 723</span></span>';
	minerals += '<span style="'+poz+pa+'width: 140px; left: 610px; top: 520px;'+z+'"><img src="img/item/6_15k.gif"'+imga+'><span style="'+pr+fmodra+b+'">Einsteinio</span> <span style="'+pr+fbila+' left: 6px;">650 000</span></span>';

	nominerals = '<span style="'+poz+pa+'width: 70px; left: 170px; top: 700px;'+z+'"><img src="img/item/6_1k.gif"'+imga+'><span style="'+pr+fcervena+'">Hierro</span></span>';	
	nominerals += '<span style="'+poz+pa+'width: 70px; left: 555px; top: 700px;'+z+'"><img src="img/item/6_7k.gif"'+imga+'><span style="'+pr+fcervena+'">Helenio</span></span>';	
	nominerals += '<span style="'+poz+pa+'width: 70px; left: 170px; top: 353px;'+z+'"><img src="img/item/6_6k.gif"'+imga+'><span style="'+pr+fcervena+'">Fosarita</span></span>';	
	nominerals += '<span style="'+poz+pa+'width: 70px; left: 560px; top: 353px;'+z+'"><img src="img/item/6_5k.gif"'+imga+'><span style="'+pr+fcervena+'">Melanita</span></span>';	
