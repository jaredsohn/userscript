...
var rkTool = (function() {
    ...
    {
        $('body').append('<form id="myStartWork" action="Action.php?action=338&amp;n=965&amp;t=mine" method="POST"><input type="hidden" name="duree" value="'+duration+'" id="Mine624"></form>');
        $('#myStartWork').submit();
    }
    ...
    function tmrSecnd()
    {
        ...
        else 
        {
            ...
            } else
            {
                ...
                if(timerGlobal > 240)
                {
                	window.location.href = 'http://www.kralliklar.com/EcranPrincipal.php?l=2';
                }
