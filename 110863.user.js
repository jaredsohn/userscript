...
var html='<a href='+link+(livingArea.id?' id=new':'')+'>Home</a> '+
	...
	'<a href='+link+'hospital>Heal</a> '+
	'<a href='+link+'gathering>Boards</a> '+
'<a href='+link+'pawn_shop>Pawn Shop</a> '+
'<a href='+link+'rats>Rats</a> '+
	'<br><br>'+ // add breaks to add another row

	'<a href='+link+'battle&do=phlist>Hitlist</a> '+
	'<a href='+link+'uni&do=spd>Speed</a> '+
	'<a href='+link+'shopping&do=buy&foodid=17>KFC</a> '+
	'<a href='+link+'711>7/11</a> '+
	'<a href='+link+'food>Food</a> '+
	'<a href='+link+'arcade&do=beg>Arcade</a>'+
	'<a href='+link+'improved_dumpster&action=rummage>Dive</a>'+
'<a href='+link+'slots&pay=4>Slots</a>';
