...
//////////////////////////////////////////////////////////////////////////////
// ==UserScript==
// @name        Profile Viewer (Fixed RG Link)
// @namespace   http://wiki.urbandead.com/index.php/User:Viktor_Suvorov
// @description Profile viewer, helps in finding (and exterminating) zergs, trenchies, PKers - updated by Spiderzed to have an updated RG link
...
/*
    Release log:
        0.2.17a- Updated URL of Rogues Gallery
        ...
        onload: function( req, id_copy )
            ...
            if( req.readyState == 4 )
                ...
                if( req.status == 200 )
                    ...
                    reg= /<span class="ptt">([A-Z0-9a-z' ]{1,64})<\/span>.*Class:<\/td><td class="slam">([A-Z][a-z]{1,20})<\/td>.*Level:<\/td><td class="slam">([0-9]{1,2})<\/td>.*XP:<\/td><td class="slam">([0-9]{1,6})<\/td>.*Group:<\/td><td class="slam">([^<]{1,64})<\/td>.*Joined:<\/td><td class="slam">(20[0-9][0-9]\-[0-9]{2}\-[0-9]{2} [0-9]{2}\:[0-9]{2}\:[0-9]{2})/;
...
function showAttackLinks()
    ...
    link_text= "Attack "+player.character+" with: <br />"+
        ...
        "<a href='http://rg.urbandead.net/profiles/view/"+player.udid+"'>Look for "+player.character+" in rogues gallery</a><br /><br />"+
