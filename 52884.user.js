// ==UserScript==
// @name           Dorpnotities bij rollover op kaart
// @namespace      none
// @description    Dorpnotities
// @version        1.00 - 200906300700
// @author         Peety, Simon Hilz (map-routine) translation: Bletnieehjom (.Nl)
// @include        http://nl*.tribalwars.*/game.php?*village=*&screen=map*
// @include        http://nl*.tribalwars.*/game.php?*screen=info_village&id=*
// ==/UserScript==
...
if(document.body.innerHTML.match(/input name=\"sid_refresh_password/)) {
	...
	del.setAttribute("title", "Verwijder");
	...
	opt.setAttribute("title", "Instellingen");
...
function options(pos, id) {					// Optionen anzeigen
	...
	// font bold
		...
		textweight.setAttribute("title", "Vet/ Dik gedrukt");
