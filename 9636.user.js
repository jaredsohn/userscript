// ==UserScript==
// @name          Wikipedia Image Link Fix
// @version       1.0
// @date          2009-04-24
// @description   On image pages, removes the link to the image if no larger version is available.
...
var imageLinkArea = document.getElementById('file');
if (imageLinkArea) {
   var imageLink = imageLinkArea.getElementsByTagName('a')[0];
   var image = imageLink.getElementsByTagName('img')[0];
   if (image) {
      if (imageLink.href == image.src) {
         // if the link to the image is the same is the actual image,
...
//      PARAMETERS       //
var scriptName = "Wikipedia Image Link Fix";
var scriptURL = "http://userscripts.org/scripts/show/9636";
var scriptVersion = 0.2;
var updateURL = "http://www.theworldofstuff.com/greasemonkey/wikipediaimage.txt";
