...
// ==UserScript==
// @name            experienceproject-profile
// @namespace       Platypus
// @include         http://www.experienceproject.com/profile.php*
// @description     Uses wide layout for experienceproject.com profiles.  Changes "Add them" action to skip confirmation dialog.  Changes "my experiences" links to go to "view all experiences" page.  Removes adult warning.  Moves profile content to top of page.
...
// var profile_main = document.getElementById('profile_main');  // EP may change this id from time to time!  
// location when last checked: /HTML[1]/BODY[1]/DIV[3]/DIV[2]/DIV[1]/DIV[1]/DIV[1]/DIV[1]/DIV[1]

// change "Add them" action to skip confirmation dialog:
do_modify_html_it(window.document,document.getElementById('profile_main'),/href="\/member_circle.php\?m=([-0-9]*)&amp;a=t"\>Add them/,'href="/member_circle.php?t=$1&m=$1&amp;ma=true">Add them',null);

// change "my experiences" links to go to "view all experiences" page:
do_modify_html_it(window.document,document.getElementById('profile_ct'),/\/member_groups.php\?m=/g,'/member_groups.php?k=y&sa=t&m=',null);
do_modify_html_it(window.document,document.getElementById('profile_pane'),/\/member_groups.php\?m=/g,'/member_groups.php?k=y&sa=t&m=',null);

// remove adult warning:
do_modify_html_it(window.document,document.evaluate('./DIV[1]/DIV[2]', main_copy, null, XPathResult.FIRST_ORDERED_NODE_TYPE,null).singleNodeValue,/You have <B>disabled adult filtering<\/B>, and may be exposed to mature content. You may <a href="\/member_account_settings.php">change your settings<\/a> at any time./i,'',null);

// move profile content to top of page:
smart_remove(window.document,document.getElementById('header_wrapper'),null,null,null);
script_paste(window.document,document.getElementById('footer-search'),document.getElementById('header_wrapper'),null,null);
remove_it(window.document,document.getElementById('footer-search'),null,null,null);
