// ==UserScript==
// @name           Facebook - Çoklu Hesap Giriş
// @namespace      http://userscripts.org/users/KaLpSiz
// @description    Hızlı Hesap Değiştirme..
...
GM_addStyle(AccMenuStyle);
	...
	//function LangSel(setLang){
		...
		switch (setLang)
		{
			default:
				...
				'ADDACCOUNTBUTTON'		:'Facebook Hesabı Ekle',
				'HAKKINDA'		:'Hakkımızda',
				'FVT'		:'Farmville Türkiye',
				'HAKKINDAM'		:'Bu Script Osman Çitçi Tarafından Yapılmıştır..',
				'NAMENULL'				:'Kullanıcı Adı yada Şifrede Nokta yada Virgül İçermez.',
				'CLSACCOUNT'			:'Hesapları Temizle',
				'CLSACCOUNTDOWN'		:'Temizleme Tamamlandı!',
				'LOGINACCOUNT'			:'Giriş Yap',
				'USERNICK'				:'Görünen İsim:',
				'USERNAME'				:'Facebook Hesabın:',
				'USERPASS'				:'Facebook Şifren:',
				'NONEED'				:'(Opsiyonel)',
				'OK'					:'Tamam',
				'CANCEL'				:'İptal',
				'UPDATEGM'				:'Scriptin Çalışması İçin Lütfen Greasemonkeyin Son Sürümünü Yükleyiniz.'
				}
			break;
		}
	...
	//function Start(){
		...
		if($('fb_menu_account') == null){
			...
			$elem("li",'<a style="" href="#" class="fb_menu_link">Facebook Çoklu Hesap Giriş</a>', {"class": "fb_menu","id":"fb_menu_account"}, {}, $('fb_menubar_mua'))
			...
			var t1 = $elem("div",'',{"class": "fb_menu_item acc_clsimg","id":"HAKKINDA"}, {}, t0);
			var t3 = $elem("a","<small> </small>"+ T('HAKKINDA') ,{"class":"fb_menu_item_link"}, {}, t1).addEventListener('click', HAKKINDA, false);
			var t1 = $elem("div",'',{"class": "fb_menu_item acc_clsimg","id":"FVT"}, {}, t0);
			var t3 = $elem("a","<small> </small>"+ T('<a style="" href="http://www.facebook.com/fvturkiye" class="fb_menu_item_link">Farmville Türkiye</a>') ,{"class":"fb_menu_item_link"}, {}, t1).addEventListener('click', A, false);
	...
	function addAccountBox(){
		...
		'						<tr><td>Görünen İsim</td><td><input id="usernicks" type="text" autocomplete="off" name="usernicks" size="20" />(Sadece Listede Görünür)</td></tr>'+
		'						<tr><td>Facebook Hesabın</td><td><input id="usernames" type="text" autocomplete="off" name="usernames" size="20" /></td></tr>'+
		'						<tr><td>Facebook Şifren</td><td><input id="passwords" type="password" name="passwords" size="20" /></td></tr>'+
		'					</table></div>'+
		'					<div class="dialog_buttons">'+
		'						<input class="inputsubmit" type="button" name="ok" id="ok" value="Tamam"/>'+
		'						<input class="inputsubmit inputaux" type="button" name="cancel" id="cancel"  value="İptal"/>'+
		'					</div>'+
		'				</div>'+
		'			</div>'+
		'		</div>'+
