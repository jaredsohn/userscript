...
for (i=0; i<textareas.snapshotLength; i++) {
  if (!textareas.snapshotItem(i).getAttribute('style') || textareas.snapshotItem(i).getAttribute('class').indexOf("growfieldDummy") == -1){
    ...
    var barHTML =
      ...
      "<img onclick='tagIt(\"\\n##\",\"\\n\","+ i +")' title='Font 1' style='background-color:white;' src='"+font2img+"' />\n " +
      "<img onclick='tagIt(\"\\n###\",\"\\n\","+ i +")' title='Font 1' style='background-color:white;' src='"+font3img+"' />\n " +
      "<img onclick='tagIt(\"\\n####\",\"\\n\","+ i +")' title='Font 1' style='background-color:white;' src='"+font4img+"' />\n " +
      "<img onclick='tagIt(\"\\n#####\",\"\\n\","+ i +")' title='Font 1' style='background-color:white;' src='"+font5img+"' />\n " +
      "<img onclick=\"tagIt('__','__',"+ i +")\" title='Bold' style='background-color:white;' src='"+boldimg+"' />\n " + 
      "<img onclick=\"tagIt('_','_',"+ i +")\" title='Italic' style='background-color:white;' src='"+italicimg+"' />\n " +
