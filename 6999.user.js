...
// @source        http://userscripts.org/scripts/show/6999
// @identifier    http://userscripts.org/scripts/source/6999.user.js
// @version       2.0
// @date          2007-01-05
...
words[0] = "[PHI]"; 
bgColors[0] = "lightgreen";
fgColors[0] = "Black";


words[1] = "---";
bgColors[1] = "lightGreen";
fgColors[1] = "Black";


words[2] = "[S0RR0W]";
bgColors[2] = "orangered";
fgColors[2] = "Black";
...
words[7] = "SCORPATTARIUS";
bgColors[7] = "White";
fgColors[7] = "Black";

words[8] = "TYR OF VASS";
bgColors[8] = "lightblue";
fgColors[8] = "Black";
...
html_insert_it(window.document,document.evaluate('/HTML[1]/BODY[1]/DIV[1]/DIV[1]/DIV[4]/DIV[2]/UL[1]/LI[1]/A[1]', document, null, XPathResult.FIRST_ORDERED_NODE_TYPE,null).singleNodeValue,'<li><a href="http://www.aokforums.com/confederatedcon/">Off Site Forum</a></li><li><a href="http://www.dvdmypictures.com/Phalanx/PHI/Mass-High-Guard.html">Mas.Msg (High Guard)</a></li><li><a href="http://www.dvdmypictures.com/Phalanx/PHI/AllAlliance.htm">Mas.Msg (Alliance)</a></li>',true,false);
html_insert_it(window.document,document.evaluate('/HTML[1]/BODY[1]/DIV[1]/DIV[1]/DIV[3]/DIV[2]/UL[1]/LI[4]/A[1]', document, null, XPathResult.FIRST_ORDERED_NODE_TYPE,null).singleNodeValue,'       <li><a href="http://www.ev5.mtggreer.com/">Att / Def Calc</a></li>       <li><a href="http://www.ev5.mtggreer.com/coord.php">Launch Table Calc</a></li>',false,false);
...
//boosts[UT_ALLY]	= Number(GM_getValue('boostally', maxBoosts[UT_ALLY]));
...
//			if( matchr = "0h ago"){
//			table.rows[i].cells[4].innerHTML = '<span style="color:purple"> Online!</span>';
			



		//	var cell5 = table.rows[i].cells[5];
		//	var target2 = cell5.textContent;
		//	if( target2 = "0h ago" ) cell5.style.color = 'chocolate';
		//	else if( target2 = "0h ago" ) cell5.style.color ='dodgerblue';
		//	else cell5.style.color = 'red';
...
GM_registerMenuCommand( "Add an ally ...", addally);
function addally() {
	var n;
		if ( (n = prompt("Tag Please", boostally))) //!= null && !isNaN(n = '---')
		GM_setValue('boostally', String(n));
		alert("HIYO  " + n);
		//alert("SHIT "+boostFleet);
		//  Figure out how fo do the boostfleet constant
