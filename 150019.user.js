// ==UserScript==
// @name           Travian Extra Tools
// @namespace      Timer
// @description    Extra Tools For Travian Version 4 (T4)
// @version        1.08.06
// @lastchanges    Marketplace total fix, player profile url fix
...
GM_registerMenuCommand("Travian T4 ExtraTools Settings",showSet);
...
function setLC() {// By Qusai Abu Hilal arabiz
...
function SetBut() 
{
    if($('#mtop')) 
    {
        ...
        im.setAttribute('title', 'T4 Script settings');
        im.setAttribute('style', 'border:none;height: 50px;position: absolute;left: 150px;top: 20px;width: 50px;z-index: 1;');
