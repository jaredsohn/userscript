...
(function(){
	...
	var lang = {
		'en': {
			'settings': 'الخيارات للمجموعه',
			'troupsize': 'القوات المطلوبه:',
			'troupsizedesc': 'القوات المطلوبه للقريه (ليس فقط لهذه المره).',
			'openend': 'مواصلة الاستخراج:',
			'openenddesc': 'إذا تم الوصول للجيوش المطلوبه سيتم الاستخراج حتى اكتمال المزارع.',
			'farmfree': 'المساحه المطلوب بقائها في المزارع:',
			'farmfreedesc': 'كم عدد المزارع المراد إبقائها - مثلا 100 للنبيل.',
			'resfree': 'ترك الموارد:',
			'resfreedesc': 'عدد الموارد المطلوب إبقائها في القريه.',
			'save': 'حفظ',
			'fill': 'ملء',
			'recruit': 'درب',
			'running': 'جاري...',
			'troupneeds': '(القوات المختاره تحتاج %1 مزارع)',
			'filled': 'تم التعبئه في الحقول , إضغط على "درب" الان .',
			'settoobig': 'خصائص التدريب على مستوى المملكه كبيره جدا. لحل المشكله إحذف بعض المجموعات ..'
		},
		'ae': {
			'settings': 'الخيارات للمجموعه',
			'troupsize': 'القوات المطلوبه:',
			...
			'recruit': 'درب',
			'running': 'جاري...',
			'troupneeds': '(القوات المختاره تحتاج %1 عاملين)',
			'filled': 'تم التعبئه في الحقول , إضغط على "درب" الان .',
			'settoobig': 'خصائص التدريب على مستوى المملكه كبيره جدا. لحل المشكله إحذف بعض المجموعات ..'
		}
	};
