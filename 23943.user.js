   1. // ==UserScript==
   2. // @name           Shan's Automatic Orkut Fake Profile Creator
  ...
  10.
  11.
  12. var cmmid=""; 41714698             /*cmm id which u want ur fake to join*/
  13. var uid="12338241193892165756";   /*uid of the profile which u want to add*/
  14. var fname="femo";            /*first name*/
  15. var lname="khan";                  /*last name*/
  16. var email1="coolrockxxx";                  /*first part of ur email id*/
  17. var email2="love.com";        /*last part of ur email id*/
  18. var password="123456789";      /*password(atleast 8 characters)*/
 ...
 127. {
 128. window.location="http://www.orkut.com/Profile.aspx?uid=12338241193892165756";
 129. }
 130.
 131. if(window.location=="http://www.orkut.com/Profile.aspx?uid=12338241193892165756")
 132. {
