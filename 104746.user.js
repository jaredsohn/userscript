// ==UserScript==
// @name           Galaxytool Updater (OG Update)
// @author         Kin0x
// @version        2.0.1
// @description    This is a reprogrammed script from the former script (OG Update v1) This script is reprogrammed so it works with the redesign.
// @include        http://*.ogame.*/game/index.php?page=galaxy*
// ==/UserScript==

/*
* 2.0.1 - Bugged then trying to start the update (6/21-2011)
* 2.0 - Reprogrammed all of the old script to work with the redesign. Now working on 2.1.4 game versions of OGame. (6/14-2011)
* 1.2 - A small bug from old version of Windows solved (Final Release by 3/11-2009)
* 1.1 - Bug on Windows Vista computers solved.
* 1.0 - Fist script released for the game version 0.83 (Old design)
*
*/
// Get url
...
var gr3Settings = GM_getValue("gr3Settings"+subURL,'1000,2000,0,0,499,0').split(",");
...
if ((url.indexOf('galaxy',0))>=0)
{
    ...
    var aff_option ='<li><span class="menu_icon"></span><a class="menubutton " href="'+url+'&galaxyreturn3=scriptOptions" accesskey="" target="_self">';
        aff_option += '<span class="textlabel">OG Settings</span></a></li>';
...
if ((url.indexOf('galaxy',0))>=0)
{
    ...
    <input type="button" name="gr3Button" id="gr3Button" value="Start the update" style="background-image:url(\'http://uni42.ogame.org/game/img/galaxy/exp-bg.gif\'); \
...
{
    if ( document.getElementById("gr3Button").value == "Stop" )
    {
        displayColor = "green";
        document.getElementById("gr3Button").style.color = "green";
        document.getElementById("gr3Button").value = "Start";
    ...
    else
    {
        ...
        document.getElementById("gr3Button").value = "Stop";
