// ==UserScript==
// @name           VCDQ - NZBIndex + The Pirtate Bay Searcher
// @namespace      Dink
// @description    Adds a "U" and "T" button to a release's line on the main page, and the release's page itself, on VCDQ.com - Search for releases on usenet (via NZBIndex.nl) or torrents (via The Pirate Bay.org) - Based on the original script created by Smiths *http://userscripts.org/scripts/show/10656*
// @include        http://www.vcdq.com/*


// ==/UserScript==
var searchurl = 'http://www.nzbindex.nl/index.php?go=search&searchitem=$1&x=31&y=16&age=500&results=100&sort=age_desc';
...
{ 
	...
	{	
			...
			searchurl = 'http://www.nzbindex.nl/search/?q=' + fulltitle + '&age=500&max=100&sort=agedesc&minsize=&maxsize=&poster=&nfo=&hidespam=0&hidespam=1&more=0';
			...
			unlink.innerHTML = "<img title='Search nzbindex.nl for " + fulltitle + "' src=" + uicon + " border='0'>";
