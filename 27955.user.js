...
(function() {
  ...
  autoUpdateFromUserscriptsDotOrg({
    name: 'FriendFeed Gribao',
		url: 'http://userscripts.org/scripts/source/27955.user.js',
		version: ffrb_version,
	});

  function Gribao_setup() {
		$('.settings').find('.l_tab:last').after('<td class="l_tab" style="padding-left: 10px;" id="tdtabtm"><div class="rounded bb" id="tabtm"><div class="t"><div class="l"><div class="r"><div class="tl"><div class="tr"><div class="body"><a id="tab-link-Gribao" href="#">G日报</a></div></div></div></div></div></div></div></td>');
    $('#tab-link-Gribao').click(function() {
			$('#subtabs').hide();
			$('#body').css("height","100%").html('<div class=iframe style="width:100%;height:100%;"><iframe id="content_iframe" marginWidth=0 marginHeight=0 src="http://gribao.com" frameBorder=0 style="width:100%;height:100%;overflow:auto;"></iframe></div>');
