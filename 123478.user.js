...
var Version = 'ver 1.1 ITALIANO by Tiestoale[ITA]';
var Versiondate = '20.05.2011';
var Scriptname = 'Torre Di Vedetta';
var ScriptTabName = 'Torre di Vedetta';
...
Tabs.Test = {
  ...
  init : function (div){
    ...
    var m = '<TABLE><TR><TD align=right>Esplorazione: </td><TD><INPUT type=checkbox id=pcfakeIsScout></td></tr>\
        ...
        <TR><TD align=right># di soldati semplici: </td><TD><INPUT type=text size=6 value=5000 id=pcfakeMilitia></td></tr>\
  ...
  createFakeAttack : function (cityNum, isScout, isWild, isFalse, secs, numMilitia){
    ...
    march.players.u1234567.n = 'Tiestoale[ITA]';
...
Tabs.Options = {
  ...
  init : function (div){
    ...
    m = '<DIV style="height:500px; max-height:500px; overflow-y:auto"><TABLE width=100% class=pcTabLined cellspacing=0 cellpadding=0>\
        ...
        </table><BR><BR><HR>Nota se un quadratino non si può attivare, vuol dire che Kabam ha disattivato quella funzione</div>';
    t.myDiv.innerHTML = m;
...
var TowerAlerts = {
  ...
  e_eachSecond : function (){   // check for incoming marches
	...
	postToChat: function(m, force){
		...
		var troopsnames = ['Trup. Rifornimento', 'Soldati Semplici', 'Esploratori', 'Lancieri', 'Spadaccini', 'Arcieri', 'Cav. leggera', 'Cav. pesante', 'Carri rifornimento', 'Baliste', 'Arieti', 'Catapulte'];
		var tot = [];
		...
		msg += 'La mia Città: ' + aCity + '. ';
		msg += 'Bersaglio: ' + target + '. ';
		...
		msg = msg.slice(0, -2);
		msg += ' (arrivano tra ' + unsafeWindow.timestr(parseInt(m.arrivalTime - unixTime())) + ' -> ' + arrivingDatetime +').' ;
