// ==UserScript==
// @name          ForumKL Opt Link Button
// @namespace     http://cnc-base-opt.de/
// @icon          http://cncopt.com/favicon.ico
// @description   Creates a Link to cnc-base-opt.de to optimize your C&C City
        ...
        var cncopt = {
          ...
          make_sharelink: function () {
            try {
              ...
              var link = "http://cnc-base-opt.de/?map=";
              link += "3|"; /* link version */
              ...
              for (var i in this) {
                try {
                  if (this[i] && this[i].basename == "Composite") {
                    var link = new qx.ui.form.Button("ForumKL", "http://cncopt.com/favicon.ico");
