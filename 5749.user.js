...
s+= "body {background:url() #000000 fixed;margin-top:-30px;}\n";
...
s+= "a:hover {text-decoration:none; color:990033!important; background-image:url(); cursor:crosshair}\n";
