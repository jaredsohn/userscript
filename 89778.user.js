// ==UserScript==
// @name            eKOA zapovijedi za gradjane
// @namespace       www.erepublik.com
// @author          F@zi / xivrox / Ktomislav
// @description     eKOA zapovijedi za gradjane
// @version         0.16
...
// modified for eCroatia by Ktomislav

(function(undefined)
{
    var VERSION = '0.16';

    var url = 'https://docs.google.com/View?id=dg4m6btj_7d4rkbmcn';
    var updateUrl = 'http://userscripts.org/scripts/show/89778';
    var updateUrlIE = 'http://iescripts.org/view-scripts-89778.htm';
        ...
        <div class="box">\
			<div class="item elem" style="background-color: #E9F5FA; padding: 1px 7px 1px 7px">\
			    <p style="color: #90BCC9; font-weight: bold; font-size: 11px">'+caption+': '+day+'</p>\
                        <div class="iconholder"><img class="test" src="'+'http://i55.tinypic.com/9kwm7t.jpg'+'" title="KOA"/></div>\
                <div class="holder" style="background-color: #FFFFFF; color: #666666; font-size: 14px; padding: 6px 4px 31px 4px; border: 1px solid #B5D6E1; width: 79%">'+orders+'</div>\
