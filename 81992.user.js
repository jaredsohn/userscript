// ==UserScript==
// @name           AntiGame 1.25 TR
// @namespace      atikiller
// @description    A couple of Neogame functions for Ogame Redesign - v1.25.1
// @version	1.25.1
...
/*
21.07.2010 v1.25.1
	- User-Redifined shortcuts to DF are now included in th expanded list. Fixed lang

16.07.2010 v1.24.1
	- User-difined shortcuts to DF are now included in th expanded list
	
15.07.2010 v1.24.0
	+ Option: re-designed universe (used in some formulas)
	+ Option: expand drop-down boxes (fleet2)

15.07.2010 v1.23.1
	- Fix for fleet details - Fleet Movement
	- Fix for Probe speed rounding issue (tnx to Bontchev)
	- Fix for Res Calculator (tnx to Bontchev)
	- Fix for time converting when the timezone difference with the server is negative (tnx to Entropy)
	- Fixed server name for Polish ogame

06.05.2010 v1.23.0
	+ Options: % of fleet to DF
	+ Options: % of defense to DF
	+ mouseover handler for speed select
	+ fast speed selecting with the links
	- Fix for clutips disabling
*/
...
var AntigameFunc = function()
{
	...
	AntiGame_lang.InterfaceTR =
	{
		...
		opt_showEventList: 'Katlanmamış Olay Listesini Genel Bakışta Göster',
		opt_evt_showOnTop: 'Genel Bakışın Ekrandaki Pozisyonu: ',
		opt_evt_noScroll: 'İpuçları Göründüğünde Çerçeveleri Gösterme',
		...
		opt_missHold: 'Görev Rengi: Defans',
	...
	var FleetSend = 
	{
		...
		fleet2_insertCSSRules: function()
		{
			...
			if (Options.fleet2_expandLists) {
				...
				Utils.insertCSSRule('#slPanel { padding-left: 15px; }');
