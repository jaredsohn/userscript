...
// ==UserScript==
// @name           clik - fleet2 - vybir Zavdannya -skor
// @author         VelMizar
// @date           16-04-2011
...
var infoTagInput = document.getElementsByTagName('input'); 
	 if (koordynataCP == "29583" || koordynataCP == "29625" || koordynataCP == "29682" || koordynataCP == "29698" || koordynataCP == "29700" || koordynataCP == "29743" && Deuterium>=1000000) {
    ...
    '<table width="188" cellpadding="0" cellspacing="0" style="margin: 5px 0px -15px 2px; font-size:14px;">'+
		...
		'<tr>'+
		  ...
		  '<br>'+
		   ...
		   '</td></tr>'+ 
        '</tbody></table></div>'+
  '<div style="background:url(http://uni101.ogame.ru/game/img/navigation/box_1_fuss.gif) no-repeat; height
  }  
  }  
collectElems();  
...
for (i = 0; i < infoTagInput.length; i++) {
			...
			var evt = document.createEvent('MouseEvents');
		        evt.initMocument.body.appendChild(myContainer);
