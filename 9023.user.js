// ==UserScript==
// @name           Fark Classic -silly
// @namespace      Fark Classic -silly
...
GM_addStyle("#bodyTabNotNews,#bodyTabGeek,#bodyTabSports,#bodyTabPolitics,#bodyTabShowbiz,#bodyTabVideo,#bodyTabMusic,#bodyTabVoting,#bodyTabFoobies,#bodyTabTF,#bodyTabTFDisc,#bodyTabTFAll,#bodyTabTFCom,#bodyTabTFVoting{position:absolute;top:1px;background:#669;font-weight:bold;border-bottom:0px; top:131px !important}");
...
GM_addStyle("#bodyTabNotNews{left:10% !important}");
GM_addStyle("#bodyTabGeek{left:25% !important}");
GM_addStyle("#bodyTabSports{left:35% !important}");
GM_addStyle("#bodyTabPolitics{left:45% !important}");
GM_addStyle("#bodyTabShowbiz{left:55% !important}");
GM_addStyle("#bodyTabVideo{left:65% !important}");
GM_addStyle("#bodyTabMusic{left:75% !important}");
GM_addStyle("#bodyTabVoting{left:85% !important}");
...
//GM_addStyle("#topAd728x90 {top:12px;  left:540px; width:54px; height:11px; background-image: url(http://img.fark.com/images/2003/totalfark.gif);background-repeat: no-repeat; background-position:30% 1pt;width: 230; border:0px; color:#333333  !important}");
...
GM_addStyle("#topSearch{position:absolute;top:1px;left:1005px;width:145px;border:0 !important}");
GM_addStyle("#bodyRightSideContainer,#TFbodyRightSideContainer{position:absolute;top:75px;left:1020px;width:135px;background:#fff !important}");
