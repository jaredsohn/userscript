...
// @description Download rom from rom list directly. If you have any suggestions or find any bugs, please email me(torshie at gmail dot com).
...
function hack() {
	...
	downloadUrl = detailUrl.replace(/\/rom\//, '/download/');
	GM_xmlhttpRequest({
			method: "GET",
			url: downloadUrl,
			headers: {
