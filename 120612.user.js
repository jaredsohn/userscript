// ==UserScript==
// @name			DoA Power Tools GD
// @namespace		Fixed
// @description		elemental dragons in wave tab.use at own risk 
...
var Styles = '\
    ...
    .hiding {background-color: #2FAC2F; color: orange; padding-left: 10px; padding-right: 10px; margin-right: -2px;}\
    .defending {background-color: #F80000; color: blue; padding-left: 10px; padding-right: 10px; margin-right: -2px;}\
    ...
    table.' + rndStyle['classPrefix'] + 'TabPad tr td {border:none; background:yellow; white-space:nowrap; padding: 1px 1px}\
    table.' + rndStyle['classPrefix'] + 'Tab tr td {border:none; background:green; white-space:nowrap; padding: 1px 1px;}\
    ...
    tr.' + rndStyle['classPrefix'] + 'Owned {background-color: #e80000; color:aqua}\
    ...
    table.' + rndStyle['classPrefix'] + 'MainTab tr td.notSel {font-weight:bold; font-size:13px; border: 1px solid; border-style: solid solid none solid; background-color:#0044a0; color:red; border-color:blue; cursor:hand; cursor:pointer; padding: 2px;}\
    ...
    input.butAttackOff:hover {width:130px; background-color:#f80000; color:yellow; font-weight:bold; cursor:hand; cursor:pointer;}\
...
//  .button:active {background: black; font-weight:bold; font-size:13px; color: white; border-style: none none none none;}\
    ...
    #hdRnd ul.tabs li.tab a.' + rndStyle['classPrefix'] + 'toolbutOn {background-color:#900 ! important; color:red ! important}\
...
console.log(rslt);
	...
	updateCity : function (city) {
		...
		if (city.outpost_type&&city.outpost_type=='WaterDragonOutpost') Seed.cities[5] = city;
		...
		if (city.outpost_type&&city.outpost_type=='SpectralDragonOutpost') Seed.cities[6] = city;
		if (city.outpost_type&&city.outpost_type=='IceDragonOutpost') Seed.cities[1] = city;
...
Tabs.Waves = {
	...
	cont : null,
	troopList : [kATrans, kLBM, kSSDrg, kBatDrg, kLavaJaw, kBanshee, kGrtDrg, kWatDrg, kStnDrg, kFreDrg, kWndDrg], 
	enabled : false,
	attackTimer : null,
	marchTimer: null,
	attackErrors : 0,
...
//*** Attacks Tab - Stats Sub-tab ***
  tabStats : function (){
    ...
    document.getElementById('pbatTargets').style.color = "orange"; 
    document.getElementById('pbatMaps').style.backgroundColor = BUTTON_BGCOLOR; 
    document.getElementById('pbatMaps').style.color = "yellow"; 
 ...
 // Data.options.campAttack {enabled:false, maxDist:7, repeatTime:3660, delayMin:15, delayMax:25, levelEnable:[], levelDist:[]}
  ...
  tabConfigLevels : function (){
    ...
    document.getElementById('pbatStats').style.color = "orange"; 
    document.getElementById('pbatMaps').style.backgroundColor = BUTTON_BGCOLOR; 
    document.getElementById('pbatMaps').style.color = "yellow"; 
...
//*** Attacks Tab - Maps Sub-tab ***
  tabMaps : function(){
    ...
    document.getElementById('pbatStats').style.color = "orange"; ;
    document.getElementById('pbatTargets').style.backgroundColor = BUTTON_BGCOLOR; 
    document.getElementById('pbatTargets').style.color = "yellow";
...
//    researchTimer   : null,
    ...
    outpost2City     : [kDarkPortal, kMausoleum, kDragonKeep],
	...
	tabJobInfo : function (){
        ...
        document.getElementById(rndStyle['subtab_build']).style.color = "blue"; 
        document.getElementById(rndStyle['subtab_research']).style.backgroundColor = JOB_BUTTON_BGCOLOR; 
        document.getElementById(rndStyle['subtab_research']).style.color = "orange"; 
        document.getElementById(rndStyle['subtab_train']).style.backgroundColor = JOB_BUTTON_BGCOLOR; 
        document.getElementById(rndStyle['subtab_train']).style.color = "purple"; 
	...
	tabJobTrain : function (){
        ...
        document.getElementById(rndStyle['subtab_info']).style.color = "orange";
        document.getElementById(rndStyle['subtab_build']).style.backgroundColor = JOB_BUTTON_BGCOLOR; 
        document.getElementById(rndStyle['subtab_build']).style.color = "red"; 
        document.getElementById(rndStyle['subtab_research']).style.backgroundColor = JOB_BUTTON_BGCOLOR; 
        document.getElementById(rndStyle['subtab_research']).style.color = "blue"; 
	...
	tabJobBuild : function (){
		var t = Tabs.Jobs;
	    document.getElementById(rndStyle['subtab_info']).style.backgroundColor = JOB_BUTTON_BGCOLOR; 
        document.getElementById(rndStyle['subtab_info']).style.color = "purple"; 
        document.getElementById(rndStyle['subtab_research']).style.backgroundColor = JOB_BUTTON_BGCOLOR; 
        document.getElementById(rndStyle['subtab_research']).style.color = "green"; 
        document.getElementById(rndStyle['subtab_train']).style.backgroundColor = JOB_BUTTON_BGCOLOR; 
        document.getElementById(rndStyle['subtab_train']).style.color = "yellow"; 
	...
	tabJobResearch : function (){
		var t = Tabs.Jobs;	
	    document.getElementById(rndStyle['subtab_info']).style.backgroundColor = JOB_BUTTON_BGCOLOR; 
        document.getElementById(rndStyle['subtab_info']).style.color = "blue"; 
        document.getElementById(rndStyle['subtab_build']).style.backgroundColor = JOB_BUTTON_BGCOLOR; 
        document.getElementById(rndStyle['subtab_build']).style.color = "yellow"; 
        document.getElementById(rndStyle['subtab_train']).style.backgroundColor = JOB_BUTTON_BGCOLOR; 
    ...
    checkBuildReqs : function(cityIdx, buildingType){
        ...
        switch (buildingType) {
            ...
            case kDarkPortal:       return t.checkGoldReqs(cityIdx, buildingType, 250, 2000, 1200, 500, 1500);
            case kMausoleum:        return t.checkStandardReqs(cityIdx, buildingType, 150, 1000, 500, 200);
            case kDragonKeep:      return t.checkGoldReqs(cityIdx, buildingType, 400, 1500, 2500, 1500);
            case kReapingStones:    return t.checkGoldReqs(cityIdx, buildingType, 100, 500, 500, 200, 300);
        }  
    },
    ...
    checkResearchReqs : function (researchType){
        ...
        switch(researchType) {
            ...
            case 'EnergyCollection':    return t.checkEnergyCollectionReqs();
            case 'WarriorRevival':    return t.checkWarriorRevivalReqs();
            case 'GuardianRevival':    return t.checkGuardianRevivalReqs();
        }
    },
