// ==UserScript==
// @name GameSpot Pirated Version
// @version 0.2
// @description    gamespot.com enhancer for pirates
...
if (validate())
{
	var titleElement = getElementsByClassName("module_title")[0];
	...
	html	+= "	<table><tr>";
	html    += "	<td><img style='padding:2px' id='malakoImage' width='16' weight='16' src='" + image + "' alt='Getting Results Please Wait' /></td>";
