...
{ document.getElementById("mod_comm_list2").style.backgroundColor = '#FF99FF';}
if(document.getElementById("mod_comm_list1"))
{ document.getElementById("mod_comm_list1").style.backgroundColor = '#00FF00';}
...
//logit ( 'Options.ptWinPos: '+ inspect (Options.ptWinPos, 5, 1));
  ...
  AddMainTabLink('Asgards-Army', eventHideShow, mouseMainTab);
}
