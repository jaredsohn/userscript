// ==UserScript==
// @name          Amazon MCPL Linky
// @description	  Search the Montgomery County Public Library Catalog from Amazon book listings.
// @include       http://*.amazon.*
// ==/UserScript==
...
// at the time of writeing Sirsi, the ILS for MCPL, is dreadfully slow.  It works but it takes a while
(

function()
{
var libraryUrlPattern = 'http://webcat.montgomerylibrary.org/uhtbin/cgisirsi/x/0/0/123?srchfield1=GENERAL^SUBJECT^GENERAL^^words+or+phrase&library=ALL&user_id=webserver&password=%22&searchdata1=';
var libraryName = 'Montgomery County, Maryland';
var libraryAvailability = /Book | Paperback/;
