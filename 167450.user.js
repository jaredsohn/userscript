// ==UserScript==
// @name 		The Green Cross - Tiberium Alliances Combat Simulator-pt
...
// @author 		Peluski17
// @grant 		none
// @translation     portugues-pt subzeroxp
// ==/UserScript==
		...
		function createClasses()
		{
				...
				construct: function()
				{
					...
					{						
						...
						({
							...
							width: 60,
							height: 28,
							toolTipText: "Opções do Simulador",
							appearance: "button-text-small"
						});
						...
						({
							...
							width: 60,
							height: 28,
							toolTipText: "Abrir/Fechar janela do simulador",
							appearance: "button-text-small"
						});
						...
						({
							...
							width: 60,
							height: 28,
							toolTipText: "Salvar/Deletar ou Carregar Formações",
							appearance: "button-text-small"
						});
						...
						unlockCmtBtn = new qx.ui.form.Button("Desbl.");
						unlockCmtBtn.set
						({
							alignY: "middle",
							width: 50,
							height: 50,
							toolTipText: "Desbloquear Botão de Combate",
							appearance: "button-text-small"
						});
						...
						unlockRTBtn = new qx.ui.form.Button("Desbl.");
						unlockRTBtn.set
						({
							alignY: "middle",
							width: 50,
							height: 50,
							toolTipText: "Desbloquear Botão de Reparo",
							appearance: "button-text-small"
						});
						...
						({
							...
							width: 30,
							height: 20,
							toolTipText: "Desloca unidades um espaço para cima",
							appearance: "button-text-small"
						});
						...
						({
							...
							width: 30,
							height: 20,
							toolTipText: "Desloca unidades um espaço para baixo",
							appearance: "button-text-small"
						});
						...
						({
							...
							width: 30,
							height: 20,
							toolTipText: "Desloca unidades um espaço para esquerda",
							appearance: "button-text-small"
						});
						...
						({
							...
							width: 30,
							height: 20,
							toolTipText: "Desloca unidades um espaço para direita",
							appearance: "button-text-small"
						});
						...
						({
							...
							width: 35,
							height: 35,
							toolTipText: "Espelhos do layout atual da formação do exército",
							appearance: "button-text-small"
						});
						...
						({
							...
							width: 35,
							height: 35,
							toolTipText: "Abilitar/desabilitar todas unidades",
							appearance: "button-text-small"
						});
						...
						({
							...
							width: 35,
							height: 35,
							toolTipText: "Muda para a formação anterior. Salvar formações clicando no botão Update ou Simular.",
							appearance: "button-text-small"
						});
						...
						({
							...
							width: 35,
							height: 35,
							toolTipText: "Salva a formação atual, sem presisar abrir a janela de Salvar Formação.",
							appearance: "button-text-small"
						});
						...
						({
							...
							height: 24,
							appearance: "button-text-small",
							toolTipText: "Abrir/fechar Simulador Stats"
						});
						...
						({
							...
							height: 24,
							appearance: "button-text-small",
							toolTipText: "Retornar para formação"
						});
			...
			qx.Class.define("Simulator.StatWindow", 
			{
				...
				construct: function()
				{
					...
					var enemyHealthTitle = new qx.ui.basic.Label("Dados do Inimigo").set({ alignX: "center", alignY: "top", font: "font_size_14_bold"});
					...
					var eHLabelOverall = new qx.ui.basic.Label("Total:");
					var eHLabelBase = new qx.ui.basic.Label("Base:");
					var eHLabelDefense = new qx.ui.basic.Label("Defesa:");
					var eHLabelCY = new qx.ui.basic.Label("Estaleiro:");
					var eHLabelDF = new qx.ui.basic.Label("IDD:");
					...
					var playerRepairTitle = new qx.ui.basic.Label("Tempos de Reparo").set({ alignX: "center", alignY: "top", font: "font_size_14_bold"});
					...
					var pRLabelStorage = new qx.ui.basic.Label("Total:");
					var pRLabelOverall = new qx.ui.basic.Label("Maior:");
					var pRLabelInf = new qx.ui.basic.Label("Infantaria:");
					var pRLabelVehi = new qx.ui.basic.Label("Veiculo:");
					var pRLabelAir = new qx.ui.basic.Label("Aereos:");
					...
					var miscTitle = new qx.ui.basic.Label("Situação").set({ alignX: "center", alignY: "top", font: "font_size_14_bold"});
					...
					var miscOutcome = new qx.ui.basic.Label("Status:");
					var miscBattleDuration = new qx.ui.basic.Label("Duração:");
					...
					var battleLootTitle = new qx.ui.basic.Label("Recursos da Batalha").set({ alignX: "center", alignY: "top", font: "font_size_14_bold"});
					...
					battleLootCry.setToolTipText("Cristal");
					battleLootCred.setToolTipText("Creditos");
					battleLootRP.setToolTipText("Pontos Investigação");
					battleLootTotal.setToolTipText("Total Recursos");
					...
					simStatBtn = new qx.ui.form.Button("Atualizar").set({allowGrowX: false});
					simStatBtn.setToolTipText("Atualizar Simulação");
					simStatBtn.addListener("click", this.simulateStats, this);
					
					simReplayBtn = new qx.ui.form.Button("Simular").set({allowGrowX: false});
					simReplayBtn.setToolTipText("Simular");
				...
				members: 
				{
					...
					getSimulationInfo: function(data)
					{
						...
						try
						{
							...
							{
								this.__labelMiscOutcome.setLabel("Vitoria");
			...
			qx.Class.define("Simulator.OptionWindow", 
			{
				...
				construct: function()
				{
					...
					var genPage = new qx.ui.tabview.Page("Geral");
					...
					var buttonsTitle = new qx.ui.basic.Label("Botões:");
					...
					this._buttonLocCB = new qx.ui.form.CheckBox("Lado Direito");
					this._buttonSizeCB = new qx.ui.form.CheckBox("Normal");
					...
					this._disableRTBtnCB = new qx.ui.form.CheckBox("Desabilitar botão de reparo");
					...
					this._disableCmtBtnCB = new qx.ui.form.CheckBox("Desabilitar botão de combate");
					...
					var simulatorTitle = new qx.ui.basic.Label("Simulador:");
					...
					this._autoSimulateCB = new qx.ui.form.CheckBox("Play automático ao simular");
					...
					var statWindowTitle = new qx.ui.basic.Label("Janela do Stats:");
					...
					this._autoOpenCB = new qx.ui.form.CheckBox("Abrir automaticamente ao entrar na base");
					...
					var repairSecTitle = new qx.ui.basic.Label("Modos do tempos de reparo:");
					...
					var repairDisplayOpt3 = new qx.ui.form.RadioButton("Só tempo");
					...
					var dividerTitle = new qx.ui.basic.Label("Traço de Divisão:");
					...
					var hideSecTitle = new qx.ui.basic.Label("Esconder Abas:");
					...
					this._hideHealthCB = new qx.ui.form.CheckBox("Danos");
					this._hideRepairCB = new qx.ui.form.CheckBox("Reparo");
					this._hideMiscCB = new qx.ui.form.CheckBox("Situação");
					this._hideLootCB = new qx.ui.form.CheckBox("Recursos");
					...
					var statPosTitle = new qx.ui.basic.Label("Atualizar alterações:").set({alignY: "middle"});
					statPosTitle.setFont("bold");
					var statPosBtn = new qx.ui.form.Button("Ok").set({allowGrowX: false, allowGrowY: false, height: 20});
				...
				{	
					...
					setButtonSize: function()
					{
						try
						{
							...
							if (value == true)
							{
								simBtn.setLabel("Simular");
								simBtn.setWidth(72);
								
								statBtn.setLabel("Stats");
								statBtn.setWidth(72);
								
								optionBtn.setLabel("Opções");
								optionBtn.setWidth(72);
								
								layoutBtn.setLabel("Formações");
								layoutBtn.setWidth(72);
							}
							else
							{
								simBtn.setLabel("S");
								...
								optionBtn.setWidth(25);
								
								layoutBtn.setLabel("L");
								layoutBtn.setWidth(25);
							}
			...
			qx.Class.define("Simulator.LayoutWindow", 
			{
				...
				construct: function()
				{
					...
					this.set({
						width: 200,
						caption: "Salvar/Deletar/Carregar",
						padding: 2,
						allowMaximize: false,
						showMaximize: false,
						allowMinimize: false,
					...
					var layoutListTitle = new qx.ui.basic.Label("Formações salvas").set({ alignX: "center", alignY: "top", font: "font_size_14_bold"});
					...
					var loadButton = new qx.ui.form.Button("Carregar");
					var deleteButton = new qx.ui.form.Button("Deletar");
					...
					var saveButton = new qx.ui.form.Button("Salvar");
					...
					this.persistentCheck = new qx.ui.form.CheckBox("Formação Fixa");
					this.persistentCheck.setTextColor("white");
					this.persistentCheck.setFont("bold");
					this.persistentCheck.setToolTipText("Se marcado, a formação será salvo e pode ser usado em outra batalha");
					...
					noticeText.setValue("<p align=\'justify\'><b>Se a formação não muda ao carregar, tente mover uma unidade e tente novamente.</b></p>"); 
					...
					var clearAllLayoutsBtn = new qx.ui.form.Button("Deletar Tudo").set({alignX: "center", width: 95});
				...
				members:
				{
					...
					loadLayout: function()
					{
						try
						{
							console.log("Carregando Formação");
							var ownCityID = ClientLib.Data.MainData.GetInstance().get_Cities().get_CurrentOwnCityId();
					...
					{				
						try
						{
							console.log("Deletar Formação");
							//Remove from our array too
							var rUSure = confirm('Tem certeza que deseja apagar essa formação?');
							if(!rUSure)
							{
								return;
							}
						...
						{
							console.log("Erro ao deletar Formação");
							console.log(e);
						}
					},
					...
					clearAllLayouts: function()
					{
						try
						{
							console.log("Apagar todas formações");
							var rUSure = confirm("Clicar em OK irá apagar todos os seus layouts salvos de cada base!");
							
							if (rUSure)
							{
								localStorage.removeItem('savedFormations');
								this.layoutsArray = new Array();
								alert("Todas suas formações salvas foram excluídas.");
								
								this.updateLayoutList();
							}
							else
							{
								alert("Não ha formações a serem apagadas.");
							}
						}
						catch(e)
						{
