...
***/
//with (unsafeWindow){
//  TM_eval ('unsafeWindow.modal_messages = '+ ft);
//  TM_eval ('modal_messages = function (){alert("xxx")}');
logit ("WITH");
  unsafeWindow.modal_messages = TM_eval ('function (){alert("xxx")}');
logit ("EVALED");
//}
setTimeout ( function(){
  ...
  msgSendHook : function (){
    ...
    new AjaxRequest(unsafeWindow.g_ajaxpath + "ajax/sendMessage.php" + unsafeWindow.g_ajaxsuffix, {
        ...
        onSuccess: function (message) {
            var rslt = TM_eval("(" + message.responseText + ")");
            if (rslt.ok) {
...
/*******  TROOPS  ******/  
  ...
  changeTroopSelect : function (){
    ...
    // unitcost: NAME, Food, Wood, Stone, Ore, Gold, Pop, ?
      if (!t.TTselType) return;
      console.log("#####" + t.TTselType);
...
var GMTclock = {
  ...
  everySecond : function (){
    ...
    GMTclock.span.innerHTML = ' &nbsp; ('+ now.toLocaleTimeString() +' GMT)';
  },
}
...
window.uwuwuwFunc = function (text){ 
...
//          document.body.appendChild(scr);
//        setTimeout ( function (){document.body.removeChild(scr);}, 500);
window.uwuwuwFunc(funcName +' = '+ t.funcNew);
          t.isEnabled = true;
      } else {
      var x = funcName.split('.');
      var f = unsafeWindow;
