// ==UserScript==
// @name           OGame Resource Screen compatible with v0.77
// @namespace      http://www.turl.com.ar/
// @description    A better Resource Screen compatible with v0.77 OGame version.
// @include        http://*ogame*/index.php?page=resources*
// ==/UserScript==
...
'<tr><td class="c" colspan="4">Extended Production</td></tr>'+
'<tr>'+
'<td class="c">&nbsp;</td>'+
'<th>Daily</th>'+
'<th>Weekly</th>'+
...
'<tr><td class="c" colspan="3">Storage Status</td></tr>'+
'<tr>'+
'<th>Metal</th>'+
'<th>'+EAlmM+'%</th>'+
