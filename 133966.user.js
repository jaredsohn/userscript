...
// @name        Damages Report Script for Guard
// @namespace   eRepublikBattlesReporter_Guard
// @version		0.0.1
// @uso:version 0.0.1
// @include		http://*erepublik.com/*/military/battlefield/*
// @description    eRepublik Damage Reporting script for Guard
// ==/UserScript==
...
if(window.location.href.indexOf(PAGE_BATTLEFIELD) > 0) {	
	...
	/***********************************************************************************/
	var FORM_URL = "https://docs.google.com/spreadsheet/viewform?formkey=dFpIcXZZalNsb0RaaHVicnZXbDZ1RFE6MQ#gid=0";
	var FORM_FIELDS = {
                eday: "entry.0.single",
                name: "entry.2.single",
