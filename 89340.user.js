...
$("#interface").html('<span>Сканить <select><option value="all" selected="selected">всех</option><option value="i">Ишки</option></select> начиная с <input type="text" id="min" size="3" /> заканчивая <input type="text" id="max" size="3" /><span id="all">, рейтинг игроков не выше <input type="text" id="rank" size="3" /></span>&nbsp;<input type="button" id="scanner" value="Вперёд" /></span>');
