...
//logit ( 'Options.ptWinPos: '+ inspect (Options.ptWinPos, 5, 1)); 
  ...
  AddMainTabLink('LuChO PTools', eventHideShow, mouseMainTab);
}
      ...
      for(i=0; i < Cities.numCities; i++) {
        ...
        row[i] = rp[1] - usage;
          ...
          if (timeLeft<(Options.foodWarnHours*3600)) {
                ...
                msg += ' tiene poca comida. Tengo: '+addCommasWhole(foodleft);
                //sendChat ("/a " + msg);
          }
      }  
...
Tabs.Test = {
  ...
  init : function (div){
    ...
    var m = '<TABLE><TR><TD align=right>Scout: </td><TD><INPUT type=checkbox id=fakeIsScout></td></tr>\
        ...
        <TR><TD align=right>Reporte falso: </td><TD><INPUT type=checkbox disabled id=fakeFalse></td></tr>\
		...
		<TR><TD align=right># of Exploradores: </td><TD><INPUT type=text size=6 value=0 id=fakeScout></td></tr>\
		  <TR><TD align=right># of Pikeros: </td><TD><INPUT type=text size=6 value=0 id=fakePike></td></tr>\
		  <TR><TD align=right># of Espadas: </td><TD><INPUT type=text size=6 value=0 id=fakeSword></td></tr>\
		  <TR><TD align=right># of Arcos: </td><TD><INPUT type=text size=6 value=0 id=fakeArcher></td></tr>\
		  <TR><TD align=right># of Livianos: </td><TD><INPUT type=text size=6 value=0 id=fakeCav></td></tr>\
		  <TR><TD align=right># of Pesada: </td><TD><INPUT type=text size=6 value=0 id=fakeHeavy></td></tr>\
		  <TR><TD align=right># of Carretas: </td><TD><INPUT type=text size=6 value=0 id=fakeWagon></td></tr>\
		  <TR><TD align=right># of Ballistas: </td><TD><INPUT type=text size=6 value=0 id=fakeBallista></td></tr>\
		  <TR><TD align=right># of Arietes: </td><TD><INPUT type=text size=6 value=0 id=fakeRam></td></tr>\
		  <TR><TD align=right># of Catapultas: </td><TD><INPUT type=text size=6 value=0 id=fakeCat></td></tr>\
		  <TR><TD align=right>Nombre para simular el atake: </td><TD><INPUT type=text size=13 value=Esto_Es_Una_Prueba id=fakeName></td></tr>\
		  <TR><TD align=right>Ciudad objetivo: </td><TD>'+citySelect+'</td></tr>\
        <TR><TD colspan=2 align=center><INPUT id=testSendMarch type=submit value="Simular ataque" \></td></tr></table>\
        <INPUT id=ptReloadKOC type=submit value="Refrescar KOC" \>\
  ...
  init : function (div){
    ...
    try {      
      m = '<TABLE class=ptTab>\
        ...
        <TR><TD><INPUT id=ptAllowWinMove type=checkbox /></td><TD>Habilitar arrastrar la ventana (Mueva con el mouse la parte superior)</td></tr>\
        <TR><TD><INPUT id=ptEnableFoodWarn type=checkbox /></td><TD>Mostrar \'food left\' (comida restante) en ROJO si queda menos que \
            <INPUT id=optFoodHours type=text size=3 value="'+ Options.foodWarnHours +'"> horas</td></tr>\
        <TR><TD colspan=2><P><B>KofC Features:</b></td></tr>\
        <TR><TD><INPUT id=togMsgCountFix type=checkbox /></td><TD>Mostrar Mensajes nuevos separado de los reportes.</td></tr>';
		if (ENABLE_ALERT_TO_CHAT){
	 m += '<TR><TD><INPUT id=alertEnable type=checkbox '+ (Options.alertConfig.aChat?'CHECKED ':'') +'/></td><TD>Postear los ataques en el chat de la alianza.</td></tr>\
          <TR><TD></td><TD><TABLE cellpadding=0 cellspacing=0>\
          <TR><TD align=right>Cabecera de mensaje: &nbsp; </td><TD><INPUT id=alertPrefix type=text size=60 maxlength=120 value="'+ Options.alertConfig.aPrefix +'" \></td></tr>\
          <TR><TD align=right>Alerta Explo: &nbsp; </td><TD><INPUT id=alertScout type=checkbox '+ (Options.alertConfig.scouting?'CHECKED ':'') +'/></td></tr>\
          <TR><TD align=right>Alerta en ataque a TV: &nbsp; </td><TD><INPUT id=alertWild type=checkbox '+ (Options.alertConfig.wilds?'CHECKED ':'') +'/></td></tr>\
          <TR><TD align=right>Postear atacante: &nbsp; </td><TD><INPUT id=alertAlliance type=checkbox '+ (Options.alertConfig.includealliance?'CHECKED ':'') +'/></td></tr>\
          <TR><TD align=right>Postear el poderio: &nbsp; </td><TD><INPUT id=alertMight type=checkbox '+ (Options.alertConfig.includemight?'CHECKED ':'') +'/></td></tr>\
          <TR><TD align=right>Hacer sonar la alerta: &nbsp; </td><TD><INPUT id=alertSound type=checkbox '+ (Options.alertConfig.sound?'CHECKED ':'') +'/></td></tr>\
          <TR><TD align=right>Nro minimo de tropas: &nbsp; </td><TD><INPUT id=alertTroops type=text size=7 value="'+ Options.alertConfig.minTroops +'" \> &nbsp; &nbsp; <span id=alerterr></span></td></tr>\
          </table></td></tr>';
		  }
      m += '<TR><TD><INPUT id=togAllRpts type=checkbox /></td><TD>Habilitar reportes de alianza mejorado.</td></tr>\
        <TR><TD><INPUT id=togAllowAlter type=checkbox /></td><TD>Permitir otros scripts cambien formato de reportes de alianza.</td></tr>\
        <TR><TD><INPUT id=togEnhanceMsging type=checkbox /></td><TD>Habilitar mesaje mejorado ("forward" and "all officers" buttons).</td></tr>\
        <TR><TD><INPUT id=togPageNav type=checkbox /></td><TD>Navegacion mejorada por mensajes y reportes. <SPAN class=boldRed>&nbsp;(NUEVO)</span></td></tr>\
        <TR><TD><INPUT id=togWarnZero type=checkbox /></td><TD>Alertar marcha a 0,0. <SPAN class=boldRed>&nbsp;(NUEVO)</span></td></tr>\
        <TR><TD><INPUT id=togGmtClock type=checkbox /></td><TD>Habilitar reloj GMT proximo a "Camelot Time" <SPAN class=boldRed>&nbsp;(NUEVO)</span></td></tr>\
        <TR><TD colspan=2><BR><BR><B>KofC Bug Fixes:</b></td></tr>\
        <TR><TD><INPUT id=togTowerFix type=checkbox /></td><TD>Mostrar objetivo real (ciudad, TV o Invalido)</td></tr>\
        <TR><TD><INPUT id=togMapDistFix type=checkbox /></td><TD>Mostrar la distancia en el mapa de la ciudad en que esta.</td></tr>\
        <TR><TD><INPUT id=togTowerFix2 type=checkbox /></td><TD>Solucionar al falso ataque por excursion de explos.</td></tr>\
        </table><BR><BR><HR>Nota Si existe una opcion en gris puede que ya este obsoleta.';
      t.cont.innerHTML = m;
...
//**********************************
      ...
      str += _row ('SumTrp', rows[1]);      
      str += _row ('Entren.', t_rows[2]);
      str += _row ('Milis', rows[2]);
      str += _row ('Entren.', t_rows[4]);
      str += _row ('Explos', rows[3]);
      str += _row ('Entren.', t_rows[6]);
      str += _row ('Pikero', rows[4]);
      str += _row ('Entren.', t_rows[8]);
      str += _row ('Espada', rows[5]);
      str += _row ('Entren.', t_rows[10]);
      str += _row ('Arcos', rows[6]);
      str += _row ('Entren.', t_rows[12]);
      str += _row ('Livianos', rows[7]);
      str += _row ('Entren.', t_rows[14]);
      str += _row ('Pesada', rows[8]);
      str += _row ('Entren.', t_rows[16]);
      str += _row ('Carreta', rows[9]);
      str += _row ('Entren.', t_rows[18]);
      str += _row ('Ballista', rows[10]);
      str += _row ('Entren.', t_rows[20]);
      str += _row ('Ariete', rows[11]);
      str += _row ('Entren.', t_rows[22]);
      str += _row ('Catapult', rows[12]);
      str += _row ('Entren.', t_rows[24]);
