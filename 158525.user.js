// ==UserScript==
// @name        PaisaLive by kunal Gharate 
// @namespace   http://wwws.paisalive.com/inbox.asp
...
$(function(){
	$("body").append('<div class="banner" style="height: 40px; width:100px; right:20px; color:white; padding:5px; border-radius:5px; top:3px; overflow:auto; display: block;"><a href="http://wwws.paisalive.com/inbox.asp" target="_blank" id="start">Click Here to Start Checking Mail</a></div>');
