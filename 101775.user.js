...
// @TESTE     www.orkut.com.br/Main#Community?cmm=109349130
// @include        *.orkut.*/Main#CommMsgs?cmm=109349130*
// @include        *.orkut.*/CommMsgs?cmm=109349130*
// @include        *.orkut.*/Main#CommMemberManage?cmm=109349130*
// @include        *.orkut.*/CommMemberManage?cmm=109349130*
// @include        *.orkut.*/Community?cmm=109349130*
// @include        *.orkut.*/Main#Community?cmm=109349130*
// ==/UserScript==
/*
+---------------------------------------------------------------------+
| 			                                              |
	...
	function captchaBAN(env) {
		...
		button.onclick = function() {
			if (document.getElementById("cs").value == "") alert("Esqueceu de digitar o captcha!");
				...
				ajax.open("POST", "CommMsgPost?cmm=109349130&tid=5589431153087885452", false);
