...
// @version         5.4
// @namespace       Travian
// @description     Travian: Village Center Numbers 5.4 (Thai language) เป็นภาษาไทย
...
function init(){
	...
	GM_registerMenuCommand('Travian: Center Number - ' + (_getValue('tm_enable_upgrade', '1') == '1' ? 'ปิดการใช้งานปุ่มอัพเกรดสะดวก' : 'เปิดการใช้งานปุ่มอัพเกรดสะดวก'), function(){if(_getValue('tm_enable_upgrade', '1') == '1') {_setValue('tm_enable_upgrade', '0')} else {_setValue('tm_enable_upgrade', '1')};window.location.reload()});
	GM_registerMenuCommand('Travian: Center Number - ' + (_getValue('tm_enable_level', '1') == '1' ? 'ปิดการแสดงระดับสิ่งก่อสร้าง' : 'เปิดการแสดงระดับสิ่งก่อสร้าง'), function(){if(_getValue('tm_enable_level', '1') == '1') {_setValue('tm_enable_level', '0')} else {_setValue('tm_enable_level', '1')};window.location.reload()});
