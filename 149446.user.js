        ...
        qx.Class.define("MaelstromTools.Language", {
          ...
          members: {
            ...
            loadData: function(language) {
              ...
              this.Data["Overall production"] = ["Produktionsübersicht", "ProduÃ§Ã£o global", "La production globale"][l];
              this.Data["Army overview"] = ["Truppenübersicht", "Vista Geral de ExÃ©rcito", "ArmÃ©e aperÃ§u"][l];
              ...
              this.Data["Repair all buildings"] = ["Alle Gebäurde reparieren", "Reparar todos os edifÃ­cios", "RÃ©parer tous les bÃ¢timents"][l];
              this.Data["Base status overview"] = ["Basisübersicht", "Estado geral da base", "aperÃ§u de l'Ã©tat de base"][l];
              this.Data["Upgrade priority overview"] = ["Upgrade Übersicht", "Prioridade de upgrades", "aperÃ§u des prioritÃ©s de mise Ã  niveau"][l];
              ...
              this.Data["Target out of range, no resource calculation possible"] = ["Ziel nicht in Reichweite, kann die plünderbaren Ressourcen nicht berechnen", "Alvo fora do alcance, nÃ£o Ã© possivel calcular os recursos", "Cible hors de portÃ©e, pas de calcul de ressources possible"][l];
              this.Data["Lootable resources"] = ["Plünderbare Ressourcen", "Recursos roubÃ¡veis", "Ressources Ã  piller"][l];
              ...
              this.Data["Time to next MCV"] = ["Nächstes MBF", "Tempo restante atÃ© ao prÃ³ximo MCV", "Prochain VCM :"][l];
              this.Data["Show time to next MCV"] = ["Zeige Zeit bis zum nächsten MBF", "Mostrar tempo restante atÃ© ao prÃ³ximo MCV", "Afficher l'heure pour le prochain VCM "][l];
              this.Data["Show lootable resources (restart required)"] = ["Zeige plünderbare Ressourcen (Neustart nötig)", "Mostrar recursos roubÃ¡veis (Ã© necessÃ¡rio reiniciar)", "Afficher les ressources fouiller (redÃ©marrage nÃ©cessaire)"][l];
              this.Data["Use dedicated Main Menu (restart required)"] = ["Verwende extra Hauptmenü (Neustart nötig)", "Usar botÃ£o para o Menu Principal (Ã© necessÃ¡rio reiniciar)", "Utiliser dÃ©diÃ©e du menu principal (redÃ©marrage nÃ©cessaire)"][l];
              ...
              this.Data["Autorepair buildings"] = ["Repariere Gebäude automatisch", "Auto reparar edifÃ­cios", "bÃ¢timents autorÃ©parÃ©"][l];
              ...
              this.Data["Reset to default"] = ["Auf Standard zurücksetzen", "DefiniÃ§Ãµes padrÃ£o", "RÃ©initialiser"][l];
              ...
              this.Data["Repairtime"] = ["Max. verfügbar", "Tempo de reparaÃ§Ã£o", "Temps de rÃ©paration"][l];
              ...
              this.Data["Buildings"] = ["Gebäude", "EdifÃ­cios", "BÃ¢timents"][l];
              ...
              this.Data["Protection"] = ["Geschützt bis", "ProtecÃ§Ã£o", "Protection"][l];
              this.Data["Available weapon"] = ["Verfügbare Artillerie", "Apoio disponÃ­vel", "arme disponible"][l];
              ...
              this.Data["Max. storage"] = ["Max. Kapazität", "Armazenamento MÃ¡x.", "Max. de stockage"][l];
              ...
              this.Data["display only top buildings"] = ["Nur Top-Gebäude anzeigen", "Mostrar apenas melhores edifÃ­cios", "afficher uniquement les bÃ¢timents principaux"][l];
              this.Data["display only affordable buildings"] = ["Nur einsetzbare Gebäude anzeigen", "Mostrar apenas edÃ­ficios acessÃ­veis", "afficher uniquement les bÃ¢timents abordables"][l];
              ...
              this.Data["Access"] = ["Öffne", "Aceder", "AccÃ¨s "][l];
