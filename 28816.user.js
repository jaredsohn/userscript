// ==UserScript==
// @name Travian3 Big Beyond  - BA - *Fixed* 
// @author Victor Garcia /plagiat by Adi 
...
// @version 2.5
// @description	 Beyond skripta + NPC Helper Quick maps, Hero status.... 
// ==/UserScript==
...
function funcionPrincipal(e){
	...
	var lang_us = lang_en;
        var lang_sk = lang_en;
	lang_en['ALIANZA'] 	= 'Alijansa';
	lang_en['PERFIL'] 	= 'Profile';
	...
	lang_en['RENT'] 	= 'Zisk';
	lang_en['SUBIR_NIVEL'] 	= 'Extension najdená';
	lang_en['JUGADOR'] 	= 'Igrac';
	lang_en['ALDEA'] 	= 'Ime sela';
	lang_en['HAB'] 		= 'Populacija';
	lang_en['COORD'] 	= 'Coords';
	lang_en['ACCION'] 	= 'Akcija';
	lang_en['ATACAR'] 	= 'Napad';
	lang_en['COMERCIAR'] 	= 'Poslati resurse';
	...
	// Bosanski/Bosnian (travian.ba)
	var lang_ba = new Array();
	var_lang_rs = lang_ba;
	var lang_si = lang_ba;
	lang_ba['ALIANZA'] 	= 'Aljiansa'; 
	lang_ba['PERFIL'] 	= 'Korisni&#269;ki profil'; 
	lang_ba['SIM'] 		= 'Simulator borbe'; 
	lang_ba['CALC'] 	= 'Travian Calc'; 
	lang_ba['SEGURO'] 	= 'Jeste li sigurni?'; 
	lang_ba['MARK'] 	= 'Ozna&#269;i sve'; 
	lang_ba['PERDIDAS'] 	= 'Gubitak'; 
	lang_ba['RENT'] 	= 'Profit'; 
	lang_ba['SUBIR_NIVEL'] 	= 'Nadogradnja dostupna'; 
	lang_ba['JUGADOR'] 	= 'Igra&#269;'; 
	lang_ba['ALDEA'] 	= 'Ime Sela'; 
	lang_ba['HAB'] 		= 'Populacija'; 
	lang_ba['COORD'] 	= 'Koordinate'; 
	lang_ba['ACCION'] 	= 'Akcije'; 
	lang_ba['ATACAR'] 	= 'Napad'; 
	lang_ba['COMERCIAR'] 	= 'Po&#353;alji Resurse'; 
	lang_ba['GUARDADO'] 	= 'Spremljeno'; 
	lang_ba['DESP_ABR'] 	= 'Korak'; 
	lang_ba['FALTA'] 	= 'Potrebno'; 
	lang_ba['HOY'] 		= 'danas'; 
	lang_ba['MANYANA'] 	= 'sutra'; 
	lang_ba['PAS_MANYANA'] 	= 'prekosutra'; 
	lang_ba['MERCADO'] 	= 'Tr&#382;nica'; 
	lang_ba['CUARTEL'] 	= 'Kasarna'; 
	lang_ba['PUNTO'] 	= 'Okupljali&#353;te'; 
	lang_ba['CORRAL'] 	= '&#352;tala'; 
	lang_ba['TALLER'] 	= 'Radionica'; 
	lang_ba['ENVIAR'] 	= 'Po&#353;alji resurse'; 
	lang_ba['COMPRAR'] 	= 'Kupi'; 
	lang_ba['VENDER'] 	= 'Prodaj'; 
	lang_ba['ENVIAR_IGM'] 	= 'Po&#353;alji poruku'; 
	lang_ba['LISTO'] 	= 'Dostupno'; 
	lang_ba['EL'] 		= ''; 
	lang_ba['A_LAS'] 	= 'u'; 
	lang_ba['EFICIENCIA'] 	= 'Efikasnost'; 
	lang_ba['NUNCA'] 	= 'Nikada'; 
	lang_ba['PC'] 		= 'Kulturalni bodovi'; 
	lang_ba['FUNDAR'] 	= 'Mo&#382;ete Izgraditi ili pokoriti novo naselje'; 
	lang_ba['ALDEAS'] 	= 'Naselja'; 
	lang_ba['ENV_TROPAS'] 	= 'Po&#353;alji vojsku'; 
	lang_ba['RECURSO1'] 	= 'Drvo'; 
	lang_ba['RECURSO2'] 	= 'Glina'; 
	lang_ba['RECURSO3'] 	= '&#381;eljezo'; 
	lang_ba['RECURSO4'] 	= 'Hrana'; 
	lang_ba['TIEMPO'] 	= 'Vrijeme'; 
	lang_ba['COMP'] 	= 'Report Compressor'; 
	lang_ba['STAT'] 	= 'Statistika'; 
	lang_ba['OFREZCO'] 	= 'Nudi'; 
	lang_ba['BUSCO'] 	= 'Tra&#382;i'; 
	lang_ba['TIPO'] 	= 'Tip'; 
	lang_ba['DISPONIBLE'] 	= 'Dostupno samo'; 
	lang_ba['CUALQUIERA'] 	= 'Bilo koji'; 
	lang_ba['SI'] 		= 'Da'; 
	lang_ba['NO'] 		= 'Ne'; 
	lang_ba['MARCADORES'] 	= 'Bookmarks'; 
	lang_ba['ANYADIR'] 	= 'Dodaj'; 
	lang_ba['ENLACE'] 	= 'Novi Bookmark URL'; 
	lang_ba['TEXTO'] 	= 'Novi Bookmark Text'; 
	lang_ba['ELIMINAR'] 	= 'Izbri&#353;i'; 
	lang_ba['MAPA'] 	= 'Karta'; 
	lang_ba['CHECK'] 	= 'Provjeri novu verziju'; 
	lang_ba['ARCHIVE'] 	= 'Arhiv'; 
	lang_ba['RESUMEN'] 	= 'Sa&#382;etak';
...
// Natares
	...
	var unitData = [
		...
		["Legionar","Legionar","40","35","50","120","100","180","40","1","6", 'build.php?gid=19'],
		["Pretorijanac","Pretorijanac","30","65","35","100","130","160","70","1","5",'build.php?gid=19'],
		["Imperijanac","Imperijanac","70","40","25","150","160","210","80","1","7", 'build.php?gid=19'],
		...
		["Ratni ovan","Ratni ovan","60","30","75","900","360","500","70","3","4",'build.php?gid=21'],
		["Vatreni katapult","Vatreni katapult","75","60","10","950","1350","600","90","6","3",'build.php?gid=21'],
		["Senator","Senator","50","40","30","30750","27200","45000","37500","4","4",'build.php?gid=21'],
		["Naseljenik","Naseljenik","0","80","80","5800","5300","7200","5500","1","5",],
// Teutonci
		["Batinar","Batinar","40","20","5","95","75","40","40","1","7",'build.php?gid=19'],
		["Kopljanik","Kopljanik","10","35","60","145","70","85","40","1","7",'build.php?gid=19'],
		["Borac sa sjekirom","Borac sa sjekirom","60","30","30","130","120","170","70","1","6",'build.php?gid=19'],
		["Izvidja&#269;","Izvidja&#269;","0","10","5","160","100","50","50","1","9",'build.php?gid=19'],
		["Paladin","Paladin","55","100","40","370","270","290","75","2","10",'build.php?gid=20'],
		["Teutonski Vitez","Teutonski Vitez","150","50","75","450","515","480","80","3","9",'build.php?gid=20'],
		["Ovan","Ovan","65","30","80","1000","300","350","70","3","4",'build.php?gid=21'],
		["Katapult","Katapult","50","60","10","900","1200","600","60","6","3",'build.php?gid=21'],
		["Poglavica","Poglavica","40","60","40","35500","26600","25000","27200","4","4",],
		["Naseljenik","Naseljenik","10","80","80","7200","5500","5800","6500","1","5",],
// GALI
        ["Falanga","Falanga","15","40","50","100","130","55","30","1","7",'build.php?gid=19'],
		["Ma&#269;evalac","Ma&#269;evalac","65","35","20","140","150","185","60","1","6",'build.php?gid=19'],
		["Izvidja&#269;","Izvidja&#269;","0","20","10","170","150","20","40","2","17",'build.php?gid=20'],
		["Teutateov grom","Teutateov grom","90","25","40","350","450","230","60","2","19",'build.php?gid=20'],
		["Druidski jaha&#269;","Druidski jaha&#269;","45","115","55","360","330","280","120","2","16",'build.php?gid=20'],
		["Heduan","Heduan","140","50","165","500","620","675","170","3","13",'build.php?gid=20'],
		["Ovan","Ovan","50","30","105","950","555","330","75","3","4",'build.php?gid=21'],
		["Katapult","Katapult","70","45","10","960","1450","630","90","6","3",'build.php?gid=21'],
		["Starjesina","Starjesina","40","50","50","30750","45400","31000","37500","4","5",],
		["Naseljenik","Naseljenik","0","80","80","5500","7000","5300","4900","1","5",],
...
//				[T('CALC'), "http://www.denibol.com/~victor/travian_calc/", "_blank"],
	...
	function setUnitStatsTooltip(unitNum)
	{
		...
		row = elem('tr','');
		table.appendChild(row);
		td = elem('td', 'Brzina: ' + getUnitSpeed(unitNum));
		td.setAttribute('colspan', '3');
		row.appendChild(td);
		
		row = elem('tr','');
		table.appendChild(row);
		td = elem('td', 'Moze nositi: ' + uc[unitNum][4]);
		td.setAttribute('colspan', '3');
		row.appendChild(td);
    ...
    delreport.innerHTML='<td class=rgb colspan=2>&nbsp;<input style="font-weight:bold; font-size:8pt; height:14pt" onClick="document.location.href=\''+delreporthref+'\'" type=button value="Obrsati">';
...
//  	var bookmarkRaid = '&nbsp;<input style="font-weight:bold; font-size:8pt; height:14pt" onClick="javascript:void(0);" value="Arhiva" type=button id=orange />';
...
//	  bookmarks.push('<span style="color:#ff5500;font-size:11px;">Trh</span>::build.php?gid=17');
	...
	function cityLinks(){
		...
		if (find("//img[contains(@src, 'travian1.gif')]", XPFirst)) //if Plus, then...
		{
			...
			var foo = '<TD><a href="dorf3.php"><span class="f10 c0 s7 b">Pregled\n</span></a></TD><TD><a href="dorf3.php?s=2"><span class="f10 c0 s7 b">Resursi\n</span></a></TD><TD><a href="dorf3.php?s=3"><span class="f10 c0 s7 b">Skladi&#353;te\n</span></a></TD><TD><a href="dorf3.php?s=4"><span class="f10 c0 s7 b">CP/KP\n</span></a></TD><TD><a href="dorf3.php?s=5"><span class="f10 c0 s7 b">Vojska\n</span></a></TD>';	
		...
		for (var i = 0; i < cities.childNodes.length; i++){
			...
			city.appendChild(elem("TD", "<a href='a2b.php?z=" + id + "&dname="+cityname+"'><img src='data:image/gif;base64," + imagenes["def1"] + "' width='12' border='0' title='Po&#353;alji vojsku'></a>"));
...
//			city.appendChild(elem("TD", "<a href='dorf1.php?newdid=" + newdid + "' title='Osada i okolice'>O</a>"));
	//		city.appendChild(elem("TD", "<a href='dorf2.php?newdid=" + newdid + "' title='Centar sela'>C</a>"));
...
switch (lang) {
	...
	case '.sk':
		...
		break;
	case '.ba':
		langfile = ['Trenutno','Sljedeci','Potrebno'];
		break;
	case ".hk":
	case '.tw':
		langfile = ['目前', '升級', '尚須'];
