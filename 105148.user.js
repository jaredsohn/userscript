...
var MyBoard = {
  ...
  boardsUrl :               "http://porkmeister62.webs.com",         //where to check for lists of other boards, most current version of MyBoard, etc.
  ...
  supportedDomains:         ["www.tnaboard.com",
                             "www.tnaxxhobby.com"],                  //Domains currently supported. All others are ignored.
  boardIds :                 ["tna", "tnaxx"],                       // Board ID's - Used to build persistent storage key names to keep keys seperate
  boardIdsByDomain:         { "www.tnaboard.com":"tna",              // Constant lookup array for board id's.
                              "www.tnaxxhobby.com" : "tnaxx"},
...
;
  ...
  //showPostsString= http://www.tnaboard.com/search.php?action=show_user_posts&user_id=<userId>
  thisNav = document.createElement("UL");
  thisNav.style.display="block";
...
//------------------------- Show topics -------------------------
//  http://www.tnaboard.com/search.php?action=show_user_topics&user_id=<userId>
  thisSubNav = document.createElement("LI");
  thisNav.appendChild(thisSubNav);
  tag = MyBoard.addManagementLink(thisSubNav,
