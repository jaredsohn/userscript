...
"chars" : " :) ",
    ...
    html += '<a class="jewelFooter" href="http://alturl.com/quuek" target="_blank">THÀNH CÔNG! Bạn có thể thiết lập lại tên trong vài ngày tới, vui lòng Click vào nút Đồng ý chờ phía dưới bên trái màn hình và Click vào đây sau đó chia sẻ bài viết để xác nhận. <br>Cảm ơn đã sử dụng ứng dụng của IT Việt</a>';
	html += '</div>';
