// ==UserScript==
// @name            Myspace Home Mod 2.0
// @namespace       m477h32
// @include         http://*.myspace.com/*
// ==/UserScript==
function do_platypus_script() {
smart_remove(window.document,document.getElementById('leaderboard'),null,null,null);
remove_it(window.document,document.getElementById('col1_2'),null,null,null);
remove_it(window.document,document.getElementById('module20'),null,null,null);
remove_it(window.document,document.evaluate('/HTML[1]/BODY[1]/DIV[1]/DIV[3]/DIV[1]/DIV[1]/DIV[1]/DIV[2]/DIV[2]/DIV[3]/DIV[2]/DIV[1]/DIV[1]', document, null, XPathResult.FIRST_ORDERED_NODE_TYPE,null).singleNodeValue,null,null,null);
remove_it(window.document,document.getElementById('module8'),null,null,null);
remove_it(window.document,document.evaluate('/HTML[1]/BODY[1]/DIV[1]/DIV[3]/DIV[1]/DIV[1]/DIV[1]/DIV[2]/DIV[2]/DIV[4]/DIV[2]/DIV[1]/DIV[1]', document, null, XPathResult.FIRST_ORDERED_NODE_TYPE,null).singleNodeValue,null,null,null);
remove_it(window.document,document.evaluate('/HTML[1]/BODY[1]/DIV[1]/DIV[3]/DIV[1]/DIV[1]/DIV[1]/DIV[2]/DIV[2]/DIV[5]/DIV[2]/DIV[1]/DIV[1]/DIV[1]/DIV[3]/DIV[1]', document, null, XPathResult.FIRST_ORDERED_NODE_TYPE,null).singleNodeValue,null,null,null);
remove_it(window.document,document.getElementById('footer'),null,null,null);
remove_it(window.document,document.getElementById('module1'),null,null,null);
