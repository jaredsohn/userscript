// ==UserScript==
// @name      Photo pop-up + Brown and Pink colors + gets rid of ads
// @version	1.0
// @author	Adam Booth
// @namespace   
// @description  Makes Facebook brown and pink and photos pop up + and removes ads
...
// GLOBAL COLOR DEFINITIONS ------------------- #8D0C33 #EB7B3C #F3C45C
dark1 = "#6c420b";
light1 = "#ff1493";
light2 = "#ff1493";

// TOP LOGO IMAGE LOCATIONS -------------------
toplogo = "http://i29.photobucket.com/albums/c286/adam8810/brownandpinkfb.jpg";
tophover = toplogo;

/*Turn this line on if you want to have a rollover image for the logo*/
tophover = "http://i29.photobucket.com/albums/c286/adam8810/brownandpinkhome.jpg";
...
addGlobalStyle('.tip {font:10px/12px Arial,Helvetica,sans-serif;border:0;padding:3px 3px 1px 3px;visibility:hidden;position:fixed;z-index:100;color:#ff1493;top:20px;left:90px;background-color:#FF00FF;}');
