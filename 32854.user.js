// ==UserScript==
// @name           Google Extra Türkçe
// @description    Aynı anda görüntü, video, wikipedi, dictionary.com aramaları yapabilirsiniz!!!
// @namespace      znerp
  ...
  GM_xmlhttpRequest({
      ...
      onload: function(result) {
        ...
        if (res.indexOf("Suggestions:") == -1) {
          imageDiv.innerHTML = '<table width="100%" cellspacing="0" cellpadding="0" border="0" class="znerp" style="margin-top: 4px;margin-bottom: 2px;" style="margin: 3px;"><td><span id="sd"><a href="'+imageurl+'">Resimler</a></span></td></table>'
          addTopImages("image");
...
function addVideos() {
  ...
  GM_xmlhttpRequest({
      ...
      onload: function(result) {
        res = result.responseText;
        if (res.indexOf("Suggestions:") == -1) {
          videoDiv.innerHTML = '<table width="100%" cellspacing="0" cellpadding="0" border="0" class="znerp" style="margin-top: 4px;margin-bottom: 2px;" style="margin: 3px;"><td><span id="sd"><a href="'+videourl+'">Videolar</a></span></td></table>'
          addTopImages("video");
...
function addWiki() {
  wikiurl = "http://tr.wikipedia.org/wiki/" + href.match(/[&?]q=([^&]*)(?:&|$)/)[1].replace(/%20|\+/g, "_").replace(/%22/g, "").replace(/_[a-z]/g, toUpCase);
  ...
  GM_xmlhttpRequest({
      ...
      onload: function(result) {
        ...
        if (res.indexOf('<p>', res.indexOf('<div id="contentSub">')) != -1) if (res.indexOf('Wikipedia does not have an article with this exact name') == -1) {
          wikiDiv.innerHTML = '<table width="100%" cellspacing="0" cellpadding="0" border="0" class="znerp" style="margin-top: 4px;margin-bottom: 2px;font-family:arial,sans-serif;" style="margin: 3px;"><td><span id="sd"><a href="'+wikiurl+'">tr.wikipedia.org</a></span></td></table>'
          addTopImages("wiki");
          if (eval(GM_getValue("show", "[true,true,true,true,true]"))[2]) {
           ...
           wikiDiv.innerHTML += "<div class='wikiContent'>" +
                                ...
                                wiki.replace(/href=\"\//g, "href=\"http://tr.wikipedia.org/") + 
                                "</div>";
          }
...
function addForeignWiki() {
  foreignWikiurl = "http://" + GM_getValue("wiki address", "tr") + ".wikipedia.org/wiki/" + href.match(/[&?]q=([^&]*)(?:&|$)/)[1].replace(/%20|\+/g, "_").replace(/%22/g, "").replace(/_[a-z]/g, toUpCase);
  ...
  GM_xmlhttpRequest({
      ...
      onload: function(result) {
        res = result.responseText;
        if (res.indexOf('<p>', res.indexOf('<div id="contentSub">')) != -1) if (res.indexOf('Wikipedia does not have an article with this exact name') == -1) {
          foreignWikiDiv.innerHTML = '<table width="100%" cellspacing="0" cellpadding="0" border="0" class="znerp" style="margin-top: 4px;margin-bottom: 2px;font-family:arial,sans-serif;" style="margin: 3px;"><td><span id="sd"><a href="'+foreignWikiurl+'">'+GM_getValue("wiki address", "tr")+'.wikipedia.org</a></span></td></table>'
          ...
          if (eval(GM_getValue("show", "[true,true,true,true,true]"))[4]) {
           ...
           foreignWikiDiv.innerHTML += "<div class='wikiContent'>" +
                                       ((res.indexOf('class="image"') != -1) ? wikiImage : "") +
                                       wiki.replace(/href=\"\//g, "href=\"http://"+GM_getValue("wiki address", "tr")+".wikipedia.org/") + 
                                       "</div>";
          }
