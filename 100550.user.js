// ==UserScript==
// @name        Facebook: Hapus Aktivitas by: maha.web.id
// @namespace   Maha Abdillah
...
function createButton()
{
    if (!button)
    {
        ...
        <span style='margin-bottom: 10px;padding:3px 8px' class='uiButton uiButtonDefault uiButtonMedium'>Remove Recent Activity</span></div></center>";
