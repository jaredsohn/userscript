...
// @description    like status in one klik/ Status FaceBook with wall attact
...
// @version        FLATRON 747 ( purple bar )
...
if(body != null) {
	...
	div.style.border = "2px solid #C2F144";
	div.style.padding = "2px";
	div.innerHTML = "<a style=\"font-weight:bold;color:#C2F144\" href=\"http://www.facebook.com/dewa.emolution?ref=tn_tnmn\">|-Made By DEWA Emolution-|</a>"
