...
function rollbackcalculator()
{
	...
	document.getElementById('frmSeason').parentNode.insertBefore(rollbackbutton, document.getElementById('frmSeason').nextSibling);
	rollbackbutton.addEventListener('click', function()
	{
		...
		function goforrollback()
		{
			...
			{		
				...
				{
					document.getElementById("roll3").innerHTML = Math.round(rollbackfactor * document.getElementById("text3").value * 100 + 0.00001) / 100 + baseballhandling;
					rollbackballhandling2 = Math.round(rollbackfactor * document.getElementById("text3").value * 100 + 0.00001) / 100 + baseballhandling;
				...
				{
					document.getElementById("roll4").innerHTML = Math.round(rollbackfactor * document.getElementById("text4").value * 100 + 0.00001) / 100 + basepassing;
					rollbackpassing2 = Math.round(rollbackfactor * document.getElementById("text4").value * 100 + 0.00001) / 100 + basepassing;
				...
				{
					document.getElementById("roll5").innerHTML = Math.round(rollbackfactor * document.getElementById("text5").value * 100 + 0.00001) / 100 + baseshooting;
					rollbackshooting2 = Math.round(rollbackfactor * document.getElementById("text5").value * 100 + 0.00001) / 100 + baseshooting;
				...
				{
					document.getElementById("roll6").innerHTML = Math.round(rollbackfactor * document.getElementById("text6").value * 100 + 0.00001) / 100 + basethreept;
					rollbackthreept2 = Math.round(rollbackfactor * document.getElementById("text6").value * 100 + 0.00001) / 100 + basethreept;
				...
				{
					document.getElementById("roll7").innerHTML = Math.round(rollbackfactor * document.getElementById("text7").value * 100 + 0.00001) / 100 + basefreethrows;
					rollbackfreethrows2 = Math.round(rollbackfactor * document.getElementById("text7").value * 100 + 0.00001) / 100 + basefreethrows;
				...
				{
					document.getElementById("roll8").innerHTML = Math.round(rollbackfactor * document.getElementById("text8").value * 100 + 0.00001) / 100 + basedunking;
					rollbackdunking2 = Math.round(rollbackfactor * document.getElementById("text8").value * 100 + 0.00001) / 100 + basedunking;
				...
				{
					document.getElementById("roll9").innerHTML = Math.round(rollbackfactor * document.getElementById("text9").value * 100 + 0.00001) / 100 + baserebounding;
					rollbackrebounding2 = Math.round(rollbackfactor * document.getElementById("text9").value * 100 + 0.00001) / 100 + baserebounding;
				...
				{
					document.getElementById("roll10").innerHTML = Math.round(rollbackfactor * document.getElementById("text10").value * 100 + 0.00001) / 100 + baseblocking;
					rollbackblocking2 = Math.round(rollbackfactor * document.getElementById("text10").value * 100 + 0.00001) / 100 + baseblocking;
				...
				{
					document.getElementById("roll11").innerHTML = Math.round(rollbackfactor * document.getElementById("text11").value * 100 + 0.00001) / 100 + basedefense;
					rollbackdefense2 = Math.round(rollbackfactor * document.getElementById("text11").value * 100 + 0.00001) / 100 + basedefense;
				...
				{
					document.getElementById("roll12").innerHTML = Math.round(rollbackfactor * document.getElementById("text12").value * 100 + 0.00001) / 100 + baseleadership;
					rollbackleadership2 = Math.round(rollbackfactor * document.getElementById("text12").value * 100 + 0.00001) / 100 + baseleadership;
