// ==UserScript==
// @name           Add links to SDCL 15-6
// @namespace      http://userscripts.org/users/23652
// @include        http://legis.state.sd.us/statutes/DisplayStatute.aspx?Statute=15-6*
// ==/UserScript==

function do_platypus_script() {
html_insert_it(window.document,document.evaluate('/HTML[1]/BODY[1]/FORM[1]/DIV[3]/DIV[2]/DIV[2]/DIV[1]/DIV[2]', document, null, XPathResult.FIRST_ORDERED_NODE_TYPE,null).singleNodeValue,'<a href="http://legis.state.sd.us/statutes/DisplayStatute.aspx?Type=Statute&Statute=15-6-86(a)">Link to Appendix A</a><br><a href="http://legis.state.sd.us/statutes/DisplayStatute.aspx?Type=Statute&Statute=15-6-86(b)">Link to Appendix B</a><br><a href="http://legis.state.sd.us/statutes/DisplayStatute.aspx?Type=Statute&Statute=15-6-86(c)">Link to Appendix of Forms</a><hr>',false,false);
