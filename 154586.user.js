// ==UserScript==
// @name        eRepublik Albanian MoD
// @namespace   ShqiponjaT
// @include     http://www.erepublik.com/*
// @version     3.0.1
// @description	eRepublik Albanian MoD
// ==/UserScript==
...
function GM_wait() {
	if (typeof unsafeWindow.jQuery == 'undefined') {
		...
		GM_xmlhttpRequest({
			url: 'https://docs.google.com/spreadsheet/pub?key=0Av5vIo_E0LkNdHEtSjZGaHpzMjZLNFlBeEpjVXNTY0E&output=txt',
			method: 'GET',
//			
//
			onload: function(response) {
				$(document).ready(function() {
					...
					var imageHeader = "http://img201.imageshack.us/img201/1016/1staw.jpg";
