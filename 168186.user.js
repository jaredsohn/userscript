...
// @include     *://*clixten.info/index.php?view=account&ac=click*
// @include     *://*clixten.info/index.php?view=account&ac=ptra*
// @include     *://*clixten.info/gpt.php?v=entry*
// @include     *://*clixten.info/gpt.php?v=read*
// @include     *://*clixten.info/view.php?id=*
...
top == self){
	...
	setTimeout(function(){
		...
		if($('.texttitle').size()){
			if($('.texttitle').text().indexOf('D_ 0 - . N 0 T _ C. L.1,c_k')>=0){
				$('.texttitle').parents('.ptclink:last').remove()
			}
		}
		if($('.texttitle').size()){
			if($('.texttitle').text().indexOf('do not click here---this is a anticheat link')>=0){
				$('.texttitle').parents('.ptclink:last').remove()
			}
		}
		if($('.texttitle').size()){
			if($('.texttitle').text().indexOf('Cheat Check! Do Not Click Here')>=0){
				$('.texttitle').parents('.ptclink:last').remove()
			}
		}
