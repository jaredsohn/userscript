...
var Version = '0.0.01';
var Versiondate = '10.03.11';
var Scriptname = 'Extra Tools';
var ScriptTabName = 'Extra Tools';
...
Tabs.map = {
  ...
  myDiv : null,
  timer : null,
  serverlink :  'http://koc.dunno.com/index.sjs?f=ListServers',  
  
  init : function (div){    // called once, upon script startup
    var t = Tabs.map;
    t.myDiv = div;
    div.innerHTML = '<iframe src="'+ t.serverlink +'" width="100%" height="550" name="board_in_a_box" <p>Your browser does not support frames, you can call the embedded page with this link: <a href="'+ t.serverlink +'">Server Map</a></p> </iframe> <BR>';
  },
...
/****************************  Marching Calculator Tab   ******************************/
Tabs.mCalc = {
  tabOrder : 50,                    // order to place tab in top bar
  tabLabel : 'March Calc',            // label to show in main window tabs
  myDiv : null,
  timer : null,
  calclink :  'http://free.7host06.com/carlmc29670/troopspeed.html',  
  
  init : function (div){    // called once, upon script startup
    var t = Tabs.mCalc;
    t.myDiv = div;
    div.innerHTML = '<CENTER><iframe src="'+ t.calclink +'" width="100%" height="700" name="board_in_a_box" <p>Your browser does not support frames, you can call the embedded page with this link: <a href="'+ t.calclink +'">Marching Calculator</a></p> </iframe> <BR></center>';
  },
