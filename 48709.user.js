...
//                  (usando o codico do erig como base)
// ==/UserScript==

// --------------------------------------------------------------------
//
// Para usa esse script irá precisa do Greasemonkey.
//
// Para istalar entre em https://addons.mozilla.org/en-US/firefox/addon/748
// coloquer em add to firefox espere reinicie o firefox
// volte para esse site http://userscripts.org/scripts/show/48709
// e coloquer em install e pronto :)
//
//
// 
// 
...
(function() {
    ...
    hideonline = function() {
        ...
        header.innerHTML = header.origHTML + ' (<a href="/" onclick="return showonline()" style="color: green">Quem está Online</a>) <span style="font-size: 9px">Guild Members: ' + members + '</span>';
        return false;
    }
    ...
    httprecv = function() {
        ...
        while((m = regex.exec(text)) != null) {
            ...
            if (players[m[1]] != null) {
                ...
                if (voc == 'Knight')               voc = 'Knight (Free';
                else if (voc == 'Elite Knight')    voc = 'Elite Knight(Premium';
                else if (voc == 'Paladin')         voc = 'Paladin (Free';
                else if (voc == 'Royal Paladin')   voc = 'Royal Paladin (Premium';
                else if (voc == 'Sorcerer')        voc = 'Sorcerer (Free';
                else if (voc == 'Master Sorcerer') voc = 'Master Sorcerer (Premium';
                else if (voc == 'Druid')           voc = 'Druid (Free';
                else if (voc == 'Elder Druid')     voc = 'Elder Druid (Premium';
                else if (voc == 'None')            voc = 'Rookgaard';
                else                               voc = '?';
        ...
        header.innerHTML = header.origHTML + ' (<a href="/" onclick="return hideonline()" style="color: red">Volta ao normal</a>) <span style="font-size: 9px">Guild Members: ' + members + ' &nbsp; Guild Online: ' + onlinecount + ' &nbsp; Total Online em ' + world + ': ' + matches + '</span>';
    };
