// ==UserScript==
// @name           Grepolis Relatorio de Batalha
// @namespace      http://userscripts.org/scripts/show/65163
// @description    Gera a partir da imagem relatorio BB Code 
...
if(location.href.match(/action=view/)) { 
  ...
  var BerichtTitel = "[b][player]"+townOwner[0]+"[/player] da cidade [town]"+townName[0]+"[/town] atacando [player]"+townOwner[1]+"[/player][/b]";
  for(var c = 0; c < document.getElementsByTagName('div').length; c++) {
  ...
  if (document.getElementById('report_booty_bonus_fight')) {
    ...
    var fight_bonus = "[b]Bonus aplicados:\n"+fight_bonus+"[/b]";
  }
  if (document.getElementById('resources')) {
    ...
    if (wood) resourcesOutput+="[b]Madeira[/b] "+wood+" ";
    if (stone) resourcesOutput+="[b]Pedra[/b] "+stone+" ";
    if (iron) resourcesOutput+="[b]Prata[/b] "+iron+" ";
  }
  ...
  for(var c = 0; c < document.getElementsByTagName('script').length; c++) {
    if (document.getElementsByTagName('script')[c].innerHTML.match(/ReportViewer.initialize/)) {
      ...
      } else var dulOutput = 'Keine '; 
      if (document.getElementById('ReportTextArea')) {
        document.getElementById('ReportTextArea').innerHTML = "[quote]"+BerichtTitel+"\n\n"+fight_bonus+resourcesOutput+"\n\n[b]Atacante:[/b] [player]"+townOwner[0]+"[/player]\n"+auhOutput+"\n[b]Baixas:[/b]\n"+aulOutput+"\n\n[b]Defensor:[/b] [player]"+townOwner[1]+"[/player]\n"+duhOutput+"\n[b]Baixas:[/b]\n"+dulOutput+"[/quote]";
      }
      break;
    }
  }  
