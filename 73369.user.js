// ==UserScript==
// @name		Grepolis test
// @author		Dreambreaker -> edited by Dark Princess
// @license		Creative Commons
// @version           	0.9.2
// @namespace		Grepolis Test
// @description		An edited version of Grepolis Tools by Dreambreaker.
...
$(document).ready(function(){
	...
	//Widgets
		...
		//Links Widget
			...
			$('#widget_links').append('<div style="text-align:center;font-size:12px;margin-bottom:4px;">Links</div>');
			//Links
