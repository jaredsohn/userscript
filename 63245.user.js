...
function defineLanguage(langTDL) {
    switch (langTDL) {
        case "fr":
            language = { inline:"www.ikariam-score.tk",
            fetch:"recherche... ",
            unknown:"Inconnu ",
            allyscore:"Alliance ",
