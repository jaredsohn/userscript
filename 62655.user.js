// ==UserScript==
// @name           MKAgent Beta
// @namespace      MKAgent Beta :)
// @include        *.mittkvarter.se*
// @description    MKAgent Beta
// ==/UserScript==
...
for(i=0;i<images.length;i++){if(images[i].src=="http://static.mittkvarter.se/img/smiley/smiley12.png")
...
for(i=0;i<links.length;i++) {
 if(links[i].innerHTML=="Arrangementer") {
  links[i].innerHTML="Konserter / Møter";
  links[i].style.color="#333333"; {
  }
 }
}
