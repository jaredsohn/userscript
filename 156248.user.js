...
// @version			1.1.96
// @author			Llillo
// @namespace		evenezuela_mod
// @description		Plugin para visualizar las Ordenes de Batalla de eVenezuela.
...
// @updateURL		http://userscripts.org/scripts/source/156248.meta.js
// @downloadURL		http://userscripts.org/scripts/source/156248.user.js
// ==/UserScript==
function LL_carga() {
...
function header() {
    ...
    var imageHeader = 'http://s14.postimage.org/rn0eik981/e12_defensa.jpg';
...
function footer() {
    ...
    var linkDiv = '';
    switch (x) {
        case 1: linkDiv = 'http://goo.gl/7AzkA'; break;
        case 2: linkDiv = 'http://goo.gl/7AzkA'; break;
        case 3: linkDiv = 'http://goo.gl/7AzkA'; break;
        case 4: linkDiv = 'http://goo.gl/7AzkA'; break;
        default: linkDiv = 'XX';
    }
    var orders = '<div class="rest"><a href="http://goo.gl/mxG2m" title="" target="_blank">Planilla Ordenes Militares</a><a href="' + linkDiv + '" title="" target="_blank">Canal de Coordinación</a></div>';
...
function battles() {
    var x = division();
    $.get('https://docs.google.com/document/d/19AdWZhFtd4qGHlGCMbHorVXt9xDe2Cpa3l0T3xj_7us/preview?pli=1', function(data) {
