...
// Ensuite télécharger le script là :
...
//
// ==UserScript==
// @name           Toolbar Pour The West Cody
// @namespace      Toolbar Pour The West Cody
// @description    Toolbar Pour The West Cody ( En Français ) (Salle Polyvalente, Saloon, Église, Banque, Hôtel, Armurier, Tailleur, L'Épicerie, Ordonnateur de Pompes Funèbres ). Autres Instructions : A la place de tous les "xx" ligne 113, 114, 116, 118, 119, 121, 123, remplacer les par l'ID de votre ville ( Visible dans le classement, déposer la souris sur le nom de votre ville et dans la barre d'état ce sera écrit )
...
newShortcut("http://nsm01.casimages.com/img/2009/05/02//090502044443577973584859.png", "javascript:AjaxWindow.show('building_church',{town_id:2440},'2440');", "Église");
newShortcut("http://nsm01.casimages.com/img/2009/05/02//090502044443577973584858.png", "javascript:AjaxWindow.show('building_bank',{town_id:2440},'2440');", "Banque");

newShortcut("http://nsm01.casimages.com/img/2009/05/02//090502044444577973584860.png", "javascript:AjaxWindow.show('building_hotel',{town_id:2440},'2440');", "Hôtel");

newShortcut("http://nsm01.casimages.com/img/2009/05/02//090502044442577973584857.png", "javascript:AjaxWindow.show('building_gunsmith',{town_id:2440},'2440');", "Armurier");
newShortcut("http://nsm01.casimages.com/img/2009/05/02//090502044447577973584865.png", "javascript:AjaxWindow.show('building_tailor',{town_id:2440},'2440');", "Tailleur");

newShortcut("http://nsm01.casimages.com/img/2009/05/02//090502044444577973584861.png", "javascript:AjaxWindow.show('building_general',{town_id:2440},'2440');", "L'Épicerie");

newShortcut("http://nsm01.casimages.com/img/2009/05/02//090502044445577973584862.png", "javascript:AjaxWindow.show('building_mortician',{town_id:2440},'2440');", "Ordonnateur de Pompes Funèbres");
