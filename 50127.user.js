// ==UserScript==
// @name			Ampliador de Edificios
// @version			1.1.1
// @namespace		http://ikariam.org/
// @description		Añade un número que corresponde al nivel del edificio y muestra los recursos que faltan o sobran si se desea ampliar.
...
// Registro de la versión (en inglés):
//		v1.1.1 (26. May 2009)
...
if (view == "options") {
    ...
    child = '<h3 class="header"><span class="textLabel">Ampliador de Edificios de Ikariam</span></h3><div class="content"><form action="index.php" method="GET"><input type=hidden name=view value="options"><table cellpadding="0" cellspacing="0"><tr><th>Mostrar cuadro de información</th><td><input type="radio" name="iuwInfoBox" value="true" '+checkedYes+'> Sí<br><input type="radio" name="iuwInfoBox" value="false" '+checkedNo+'> No</td></tr></table><div class="centerButton"><input class="button" type="submit" value="Guardar cambios" /></div></form></div><div class="footer"></div></div>';
...
if (view == "city") {
	...
	if (buildingList) {
		...
		for (var i = 0; i < spot.length; i++) {
			...
			if (isDefined(building, 0) && building[0].className != 'flag' && building[0].className != 'constructionSite') {		
				...
				switch (buildingType) {
					case 'palace':
						...
						if (isDefined(BUILDINGS[buildingType][upLevel]) && BUILDINGS[buildingType][upLevel]["wood"] != 0) {
							...
							if (showInfoBox) {
								...
								addOnMouseOverEventPalace(iconId, building[0], buildingType, reqWood, reqWine, reqMarble, reqCrystal, reqSulfur);
							}
					...
					case 'academy':
						...
						if (isDefined(BUILDINGS[buildingType][upLevel]) && BUILDINGS[buildingType][upLevel]["wood"] != 0) {
							...
							if (showInfoBox) {
								// Adding the event to the icon
								addOnMouseOverEventDefault(iconId, building[0], buildingType, reqWood, reqCrystal, true);
							}
					...
					default:
						if (isDefined(POSITIONS[buildingType]) && isDefined(BUILDINGS[buildingType])) {
							posTop = POSITIONS[buildingType][0]["y"];
							posRight = POSITIONS[buildingType][0]["x"];
							...
							if (isDefined(BUILDINGS[buildingType][upLevel]) && BUILDINGS[buildingType][upLevel]["wood"] != 0) {
								...
								if (showInfoBox) {
									// Adding the event to the icon
									addOnMouseOverEventDefault(iconId, building[0], buildingType, reqWood, reqMarble);
								}
...
function createIcon(obj, id, top, right, img, level) {
	obj.innerHTML = '<div id="'+ id +'" style="float: right; position: relative; z-index: 501; padding-top: 5px; height: 19px; width: 24px; text-align: center; margin-top: '+ top +'px; margin-right: '+ right +'px; background-image: url(\'' + imgURL + img +'.png\');">'+ level +'</div>';
}
 ...
 * @return void
 */
function addOnMouseOverEventPalace(id, target, type, resWood, resWine, resMarble, resCrystal, resSulfur) {
	...
	div.style.marginTop = POSITIONS[type][1]["y"].toString() + "px";
	div.style.marginLeft = POSITIONS[type][1]["x"].toString() + "px";
 ...
 * @return void
 */
function addOnMouseOverEventDefault(id, target, type, resWood, res2, isCrystal) {
	var element = document.getElementById(id);
	var div = document.createElement("div");
...
function loadDB() {
	...
	POSITIONS = {
		...
		"palace" : [
			...
			{ "x" : 10, "y" : 46 },	// positioning the info box
		],
	...
	BUILDINGS = {
		...
		"palace" : [
			...
			{ "wood" : 2612944, "wine" : 717254, "marble" : 794994, "crystal" : 678760, "sulfur" : 919013 }	// nivel 10
		],
		...
		"academy" : [
			...
			{ "wood" : 243929, "crystal" : 408877 }		// nivel 25
		],
		...
		"townHall" : [
			...
			{ "wood" : 314902, "marble" : 515592 }	// nivel 29
		],
		...
		"architect" : [
			...
			{ "wood" : 65251, "marble" : 28141 }	// nivel 32
		],
		...
		"safehouse" : [
			...
			{ "wood" : 53221, "marble" : 24867 }	// nivel 32
		],
		...
		"wall" : [
			...
			{ "wood" : 350387, "marble" : 370605 }	// nivel 32
		],
		...
		"shipyard" : [
			...
			{ "wood" : 95107, "marble" : 84814 }	// nivel 25
		],
		...
		"port" : [
			...
			{ "wood" : 94250, "marble" : 85042 }	// nivel 27
		],
		...
		"glassblowing" : [
			...
			{ "wood" : 122021, "marble" : 67485 }	// nivel 21
		],
		...
		"warehouse" : [
			...
			{ "wood" : 783398, "marble" : 407790 }	// nivel 40
		],
		...
		"museum" : [
			...
			{ "wood" : 765124, "marble" : 933272 }	// nivel 16
		],

		// workshop, wood, marble, faltan 2 niveles (30 y 31)
		"workshop" : [
			{ "wood" : 383, "marble" : 167 },
			{ "wood" : 569, "marble" : 251 },
			{ "wood" : 781, "marble" : 349 },
			...
			{ "wood" : 0, "marble" : 0 },
			{ "wood" : 0, "marble" : 0 },
			{ "wood" : 58462, "marble" : 38447 }	// nivel 31
		],
		...
		"forester" : [
			...
			{ "wood" : 160157, "marble" : 91013 }	// nivel 22
		],
		...
		"optician" : [
			...
			{ "wood" : 42904, "marble" : 32447 }	// nivel 32
		],
		...
		"barracks" : [
			...
			{ "wood" : 186750, "marble" : 128687 }	// nivel 31
		],
		...
		"carpentering" : [
			...
			{ "wood" : 46930, "marble" : 33798 }	// nivel 32
		],
		...
		"embassy" : [
			...
			{ "wood" : 266778, "marble" : 437985 }	// nivel 32
		],
		...
		"stonemason" : [
			...
			{ "wood" : 268524, "marble" : 148680 }	// nivel 24
		],
		...
		"fireworker" : [
			...
			{ "wood" : 22987, "marble" : 26164 }	// nivel 28
		],
		...
		"vineyard" : [
			...
			{ "wood" : 42419, "marble" : 46457 }	// nivel 32
		],
		...
		"tavern" : [
			...
			{ "wood" : 247577, "marble" : 245231 }	// nivel 34
		],
		...
		"branchOffice" : [
			...
			{ "wood" : 75448, "marble" : 45481 }	// nivel 21
		]
	};
}