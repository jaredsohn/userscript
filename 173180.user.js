...
function testSet(){
	if ((getQueryParam('tete') != false) && (getQueryParam('haut') != false) && (getQueryParam('lebas') != false)){
		var tabVet = ["Sanglant","Mortel","Runique","Chamaniste","Renforce","Tigre","Pare-balles"];
		var tete = remplaceExpr(recupObjetsReg('tete')[0].toString(),"_"," ");
		var haut = remplaceExpr(recupObjetsReg('haut')[0].toString(),"_"," ");
		var lebas = remplaceExpr(recupObjetsReg('lebas')[0].toString(),"_"," ");
		for(var i=0;i<tabVet.length;i++){
			if((tete.indexOf(tabVet[i])!=-1) && (haut.indexOf(tabVet[i])!=-1) && (lebas.indexOf(tabVet[i])!=-1)){
				validSet(tabVet[i]);
			}
		}
	}
	if ((getQueryParam('doigt1') != false) && (getQueryParam('doigt2') != false) && (getQueryParam('cou') != false)){
		var tabBijoux = ["Bronze","Argent","Or","Platine","Titane","Emeraude","Rubis","Diamant","Noir","Vindicati","Fausse","Insidieu","Plastique","Solaire","Faucon","Araignee","Distingue","Astucieu","Hypnotique","Ours","Dur","Fauve","Astral","Elastique","Dansant","Cardinal","Necroman","Archaique"];
		var doigt1 = remplaceExpr(recupObjetsReg('doigt1')[0].toString(),"_"," ");
		var doigt2 = remplaceExpr(recupObjetsReg('doigt2')[0].toString(),"_"," ");
		var cou = remplaceExpr(recupObjetsReg('cou')[0].toString(),"_"," ");
		for(var i=0;i<tabBijoux.length;i++){
			if((cou.indexOf(tabBijoux[i])!=-1) && (doigt1.indexOf(tabBijoux[i])!=-1) && (doigt2.indexOf(tabBijoux[i])!=-1)){
				validSet(tabBijoux[i]);
			}
		}
	}
}

function validSet(typeset){
	if(!document.getElementById('testSet')){
		monDiv = document.createElement("div");
		monDiv.setAttribute('style','float: left; width: auto; height: auto; padding: 20px; text-align: left;');
		monDiv.id = 'testSet';
		monDiv.className = 'set';
		monDiv.innerHTML = "<b>Bonus de set d'objets : </b><br /><br />";
		var endroit = document.getElementById("testStuff");
		endroit.appendChild(monDiv);
	}
	switch (typeset)
	{
		case 'Sanglant':
			monDiv.innerHTML += "Set Sanglant : <a href='http://wiki.fr.bloodwars.net/index.php?title=Bonus_de_sets_Moria#Sanglant' target=_blank> voir le bonus set</a><br /><br />";
			monDiv.innerHTML += "Perception <input type=text size='1' name='setPerception' value='0'> <br /> ";
			monDiv.innerHTML += "Précision des armes blanches <input type=text size='1' name='setPrecisionCac' value='0'> <br /> ";
			break;
		case 'Mortel':
			monDiv.innerHTML += "Set Mortel : <a href='http://wiki.fr.bloodwars.net/index.php?title=Bonus_de_sets_Moria#Mortel' target=_blank> voir le bonus set</a><br /><br />";
			monDiv.innerHTML += "Dégats de chaque arme <input type=text size='1' name='setDom' value='0'> <br /> ";
			monDiv.innerHTML += "<input type=text size='1' name='setNbatk' value='0'> attaque supplémentaire pour chaque arme <br /> ";
			break;
		case 'Runique':
			monDiv.innerHTML += "Set Runique : <a href='http://wiki.fr.bloodwars.net/index.php?title=Bonus_de_sets_Moria#Runique' target=_blank> voir le bonus set</a><br /><br />";
			monDiv.innerHTML += "Chance <input type=text size='1' name='setChance' value='0'> <br /> ";
			monDiv.innerHTML += "Défense du personnage <input type=text size='1' name='setDef' value='0'> <br /> ";
			monDiv.innerHTML += "Défense augmentée de <input type=text size='1' name='setDefLvl' value='0'> pour chaque 4 niveaux d`expérience <br /><br />";
			break;
		case 'Chamaniste':
			monDiv.innerHTML += "Set Chamaniste : <a href='http://wiki.fr.bloodwars.net/index.php?title=Bonus_de_sets_Moria#Chamaniste' target=_blank> voir le bonus set</a><br /><br />";
			monDiv.innerHTML += "Points de Sang <input type=text size='1' name='setPtssang' value='0'> <br /> ";
			monDiv.innerHTML += "Résistance <input type=text size='1' name='setResist' value='0'> <br /> ";
			monDiv.innerHTML += "Intelligence <input type=text size='1' name='setIntel' value='0'> <br /> ";
			monDiv.innerHTML += "Savoir <input type=text size='1' name='setSavoir' value='0'> <br /> ";
			break;
		case 'Renforce':
			monDiv.innerHTML += "Set Renforcé : <a href='http://wiki.fr.bloodwars.net/index.php?title=Bonus_de_sets_Moria#Renforc.C3.A9' target=_blank> voir le bonus set</a><br /><br />";
			monDiv.innerHTML += "Défense du personnage <input type=text size='1' name='setDef' value='0'> <br /> ";
			monDiv.innerHTML += "+<input type=text size='1' name='setPdvperhit' value='0'> de PTS DE VIE à chaque juste frappe<br /> ";
			break;
		case 'Tigre':
			monDiv.innerHTML += "Set Tigre : <a href='http://wiki.fr.bloodwars.net/index.php?title=Bonus_de_sets_Moria#Tigre' target=_blank> voir le bonus set</a><br /><br />";
			monDiv.innerHTML += "Chance d`un coup critique <input type=text size='1' name='setCc' value='0'> <br /> ";
			monDiv.innerHTML += "Esquive contre les armes blanches <input type=text size='1' name='setEsquiveCac' value='0'><br /> ";
			break;
		case 'Pare-balles':
			monDiv.innerHTML += "Set Pare-balles : <a href='http://wiki.fr.bloodwars.net/index.php?title=Bonus_de_sets_Moria#Pare_Balle' target=_blank> voir le bonus set</a><br /><br />";
			monDiv.innerHTML += "Résistance <input type=text size='1' name='setResist' value='0'> <br /> ";
			monDiv.innerHTML += "Esquive contre les armes à feux <input type=text size='1' name='setEsquiveFeu' value='0'>%<br /> ";
			break;
		case 'Bronze':
			monDiv.innerHTML += "Set Bronze : <a href='http://wiki.fr.bloodwars.net/index.php?title=Bonus_de_sets_Moria#Bronze' target=_blank> voir le bonus set</a><br /><br />";
			monDiv.innerHTML += "Charisme <input type=text size='1' name='setCharisme' value='0'> <br /> ";
			monDiv.innerHTML += "Réputation <input type=text size='1' name='setReputation' value='0'> <br /> ";
			break;
		case 'Argent':
			monDiv.innerHTML += "Set Argent : <a href='http://wiki.fr.bloodwars.net/index.php?title=Bonus_de_sets_Moria#Argent' target=_blank> voir le bonus set</a><br /><br />";
			monDiv.innerHTML += "Intelligence <input type=text size='1' name='setIntel' value='0'> <br /> ";
			monDiv.innerHTML += "Savoir <input type=text size='1' name='setSavoir' value='0'> <br /> ";
			break;
		case 'Or':
			monDiv.innerHTML += "Set Or : <a href='http://wiki.fr.bloodwars.net/index.php?title=Bonus_de_sets_Moria#Or' target=_blank> voir le bonus set</a><br /><br />";
			monDiv.innerHTML += "Charisme <input type=text size='1' name='setCharisme' value='0'> <br /> ";
			monDiv.innerHTML += "Savoir <input type=text size='1' name='setSavoir' value='0'> <br /> ";
			break;
		case 'Platine':
			monDiv.innerHTML += "Set Platine : <a href='http://wiki.fr.bloodwars.net/index.php?title=Bonus_de_sets_Moria#Platine' target=_blank> voir le bonus set</a><br /><br />";
			monDiv.innerHTML += "Charisme <input type=text size='1' name='setCharisme' value='0'> <br /> ";
			monDiv.innerHTML += "Réputation <input type=text size='1' name='setReputation' value='0'> <br /> ";
			monDiv.innerHTML += "Savoir <input type=text size='1' name='setSavoir' value='0'> <br /> ";
			break;
		case 'Titane':
			monDiv.innerHTML += "Set Titane : <a href='http://wiki.fr.bloodwars.net/index.php?title=Bonus_de_sets_Moria#Titane' target=_blank> voir le bonus set</a><br /><br />";
			monDiv.innerHTML += "Force <input type=text size='1' name='setForce' value='0'> <br /> ";
			monDiv.innerHTML += "Résistance <input type=text size='1' name='setResist' value='0'> <br /> ";
			break;
		case 'Emeraude':
			monDiv.innerHTML += "Set Emeraude : <a href='http://wiki.fr.bloodwars.net/index.php?title=Bonus_de_sets_Moria#Emeraude' target=_blank> voir le bonus set</a><br /><br />";
			monDiv.innerHTML += "Intelligence <input type=text size='1' name='setIntel' value='0'> <br /> ";
			monDiv.innerHTML += "Savoir <input type=text size='1' name='setSavoir' value='0'> <br /> ";
			monDiv.innerHTML += "+<input type=text size='1' name='setLitreSang' value='0'> litres de sang par heure<br /> ";
			break;
		case 'Rubis':
			monDiv.innerHTML += "Set Rubis : <a href='http://wiki.fr.bloodwars.net/index.php?title=Bonus_de_sets_Moria#Rubis' target=_blank> voir le bonus set</a><br /><br />";
			monDiv.innerHTML += "Charisme <input type=text size='1' name='setCharisme' value='0'> <br /> ";
			monDiv.innerHTML += "Réputation <input type=text size='1' name='setReputation' value='0'> <br /> ";
			monDiv.innerHTML += "Intelligence <input type=text size='1' name='setIntel' value='0'> <br /> ";
			monDiv.innerHTML += "Régénère <input type=text size='1' name='setRegenHp' value='0'> HP après chaque round de combat<br /> ";
			break;
		case 'Diamant':
			monDiv.innerHTML += "Set Platine : <a href='http://wiki.fr.bloodwars.net/index.php?title=Bonus_de_sets_Moria#Platine' target=_blank> voir le bonus set</a><br /><br />";
			monDiv.innerHTML += "Charisme <input type=text size='1' name='setCharisme' value='0'> <br /> ";
		...
		case 'Noir':
			...
			break;
		case 'Vindicati':
			monDiv.innerHTML += "Set Vindicatif : <a href='http://wiki.fr.bloodwars.net/index.php?title=Bonus_de_sets_Moria#Vindicatif' target=_blank> voir le bonus set</a><br /><br />";
			monDiv.innerHTML += "Charisme <input type=text size='1' name='setCharisme' value='0'> <br /> ";
			monDiv.innerHTML += "Réputation <input type=text size='1' name='setReputation' value='0'> <br /> ";
			monDiv.innerHTML += "<input type=text size='1' name='setNbatk' value='0'> attaque supplémentaire pour chaque arme <br /> ";
			break;
