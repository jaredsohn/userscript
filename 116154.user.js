...
// @description    eRepublik Reporting Damage Script 
// ==/UserScript==

//var pd_form_url = "https://docs.google.com/spreadsheet/viewform?formkey=dHN4WVZjSmVHaDBtZVVhdDM1TjhCamc6MQ";
//var pd_form_url = "https://docs.google.com/spreadsheet/viewform?formkey=dHN4WVZjSmVHaDBtZVVhdDM1TjhCamc6MQ";
var pd_form_url = "http://www.pm-army.info/application/online";
...
if(window.location.href.substr(0, 49) == "http://www.erepublik.com/en/military/battlefield/" | window.location.href.substr(0, 49) == "http://www.erepublik.com/bg/military/battlefield/")
{
	...
	earmy.reportDamage = function(name, dmg, round, battle, eday, time, wall)
	{
		...
		form.action="http://www.pm-army.info/application/online";
	...
	earmy.getDamage = function()
	{
		...
		return parseInt(document.getElementById("total_damage").innerHTML.replace("<small>My influence</small>", "").replace("<strong>", ""));
	...
	{
		var round = 1;
		var pos = document.body.innerHTML.indexOf("crowns no") + 9;
		round += (document.body.innerHTML[pos] * 1);
		pos = document.body.innerHTML.indexOf("crowns no", pos) + 9;
		round += (document.body.innerHTML[pos] * 1);
		return round;
	}
