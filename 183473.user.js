// ==UserScript==
// @name        Remove/delete all friends at once on Facebook by Ronak Shethia
...
// @version     2.1.4
// ==/UserScript==
// Developed by (Ronak Shethia) - http://www.youtube.com/user/evilghostronak (subscribe me for more updates)
// follow me on fb ronak.shethia@gmail.com


function replace_msg(x) {
    //$('div.dialog_body').html('Whuuuhuu! ' + x + ' friends has been deleted. Join us at <a target="_blank" href="http://youtube.com/user/evilghostronak">Ronak Shethia</a> for more hacks and tech');
