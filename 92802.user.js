// ==UserScript==
// @name                 حرب القبائل-نقاط الهجوم والدفاع-لعيون m13z 
// @version              1.3.8
// @author               Samuel Essig (تعريب هعm13z)
// @namespace            c1b1.de
// @homepage             http://c1b1.de
// @copyright            2008 - 2010, Samuel Essig (c1b1.de)
...
if($('#attack_info_def').$('th')[1].firstChild.nodeValue != '---') // If village not empty
  ...
  var td = document.createElement('td');
  td.setAttribute('colspan','2');
  td.appendChild(document.createTextNode('نقاط الهجوم هع: '+stringInt(attackers_points)));
  tr.appendChild(td);
