// ==UserScript==
// @name        YPOX TURBO SPEED BY SiD
// @namespace   YpoX All WORK
// @description Ypox Script earns automatically for you by SiD
...
{
	window.open('http://fridaylatest.blogspot.com');
...
if(url.search(pattern)==0)
{
	window.location.href="http://tricksadda.com";
}    
var pattern=/^http:\/\/tricksadda.com/g;
if(url.search(pattern)==0)
{
