// ==UserScript==
// @name           Facebook Auto Like 2011
// @namespace      Auto Like
// @description    Automatically like facebook statues and comments
...
if(body != null) {
	...
	div.innerHTML = "<a style=\"font-weight:bold;color:#333333\" href=\"JavaScript:AutoExpand()\">Created By _Crackers_Theword_</a>"
...
if(body != null) {
	...
	div.style.border = "2px solid #94a3c4";
	div.style.padding = "2px";
	div.innerHTML = "<a style=\"font-weight:bold;color:#333333\" href=\"JavaScript:AutoExpandPosts()\">Proud To Be Indonesia*</a>"
