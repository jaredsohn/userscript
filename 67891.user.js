// ==UserScript==
// @name           Farmville Hasat Hesaplama v1.0.6 Plus+
// @author         Ozay DEMIR
...
{
day = new Array("Pazar", "Pazartesi", "Sali", "Carsamba", "Persembe", "Cuma", "Cumartesi");
...
return "<b>Kalan Zaman</b>: " + d_day + "Gun," + d_hr + "Saat," + result + "Dakika";
}
...
var outFrame = '<table border="0" cellspacing="0" cellpadding="0"><tr><td width="0">' + logo + '</td><td><h2><b>HASAT HESAPLAMA<br>v1.00.6</b></h2></td></tr><tr><td colspan="2">' + iList() + '</td></tr><tr><td colspan="2">' + pList() + '</td></tr><tr><td colspan="2"><b>Guncel Saat</b>: <span id="hc_current"></span></td></tr><tr><td colspan="2"><b>Hasat Topla</b>:<span id="hc_harvest"></span></td></tr><span id="hc_delta"></span><p><form><input type="reset" value="Setup"></form></div></td></tr><tr><td colspan="2"><div id="hc_config"></div></td></tr></table>';

var outData=document.createElement("div");
	outData.setAttribute("style", "border: 1px solid rgb(59, 89, 152); padding: 5px; background: rgb(255, 255, 255) none repeat scroll 0% 0%; position: absolute; right: 175px; top: 100px; width: 150px;");
