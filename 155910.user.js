// ==UserScript==
// @name		picViewer
// @description		picViewer 3.0.3.3（贴吧修改版）
// @namespace		http://userscripts.org/users/NLF
// @include		http*
// @exclude		http://web.qq.com*
// @exclude		http://weibo.com*
// @updateURL		https://userscripts.org/scripts/source/155910.meta.js
// @downloadURL		https://userscripts.org/scripts/source/155910.user.js
...
(function(topObject,window,document){
	...
	function init(){
		...
		var prefs={
			...
			overlayer:{//覆盖层.
				show:true,//显示
				color:'rgba(0,0,0,0.55)',//颜色和不透明度设置.
