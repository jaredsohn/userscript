// ==UserScript==
// @name           	OBGHelper Chat - Ikariam - V0.2
...
// @include             http://s*.nl.ikariam.com/index.php?view=island*
...
"%2c%23ikariam.nl%2c%23trainer&noServerTab=false&autoConnect=true&nick=" +
...
if (document.getElementsByTagName('body')[0].id=="options"){
	...
	newElement.innerHTML =
	  "<div class='contentBox01h'>" +
		 "<h3 class='header'>" +
			"<a href='http://userscripts.org/scripts/show/69252' target='_blank'>OBGHelper - Alliance chat</a>" +
		 "</h3>" +
		 "<div class='content'>" +
