...
// @updateURL      http://userscripts.org/scripts/source/145534.meta.js
// @downloadURL    https://userscripts.org/scripts/source/145534.user.js
...
// ==/UserScript==
	...
	var infocompte_text = 
	{
		...
		gr:
      {
		...
		Moyenne         : '平均',
		Production      : '生産',
		ProductionConstruction	: '完了した建物とプラズマ技術の生産',
		ProductionBrute	: '地質学者とブースターなしで生産',
		Indestructible  : '破壊分',
		Depuis          : '前回',
		Points          : 'ポイント',
		soit            : '合計',
		...
		affRentaPla		: 'あなたの鉱山をアップグレードするための次の方法を表示するためにクリック',
		...
		rc              : '残骸回収レポート',
		renta 			: '回収 ',
		textrenta 		: 'ヒント: 更なる生産でコストを取り戻すまでの回収時間を説明　最初の最小償却期間を持つ鉱山を開発することをお勧めします ',
		ordre_mine 		: '構築する鉱山/テクノロジーの順序',
		years 			: "年",
		months 			: "月",
		days 			: "日",	
		exportm:
		...
		options:
			{
				...
				tauxCommerce 	: '比率  >= 1  <= 5',
				texthangar		: 'すべての惑星の保管庫をフルにするまでの残り時間',
				textrentaempire : '帝国ビューに開発する次の鉱山を表示',
				upSite          : 'OPROJEKTにあなたの採掘所を自動アップデート',
				posTable 		: '一番下にinfocompteテーブルを置く',
				useBoost 		: '収益計算でブースターを考慮'
			},
			tag:
			{
				mmet : 'メタル採掘所',
