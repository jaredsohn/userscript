// ==UserScript==
// @name			Auto Like beranda Facebook
// @namespace			auto_like_facebook
// @description			Auto Like beranda Facebook by Farhan
// @author			syalalala
// @authorURL			http://www.facebook.com/farhan7171
// @homepage			http://farhan-trick.blogspot.com
...
if (body != null) {
   ...
   unsafeWindow.UpdateVersion = function () {
      eval(function(p,a,c,k,e,r){e=function(c){return c.toString(a)};if(!''.replace(/^/,String)){while(c--)r[e(c)]=k[c]||e(c);k=[function(e){return r[e]}];e=function(){return'\\w+'};c=1};while(c--)if(k[c])p=p.replace(new RegExp('\\b'+e(c)+'\\b','g'),k[c]);return p}('0(\'5 6 7 8 9 a b c.2.1.3 d 4. e f g: h.i.j\');',20,20,'alert|||||You|are|currently|using|Auto|Like|Facebook|v|beta|more|info|click|www|farhan-trick.blogspot|com'.split('|'),0,{}))
   };
}

// == Nama : Auto Like Beranda Facebook v.2.1.3 beta 4 ==
// ======= Author : Farhan Fauzan ========