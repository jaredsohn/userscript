// ==UserScript==
// @name           bbs.archlinux.org.similarthreads
// @namespace      lobotomius.com
// @include        https://bbs.archlinux.org/viewtopic.php*
// ==/UserScript==
...
function fetch(keywords) {
	...
	GM_xmlhttpRequest({
		method: "GET",
		url: "https://bbs.archlinux.org/search.php?action=search&forum=-1&search_in=all&sort_by=0&sort_dir=DESC&show_as=topics&keywords="+keywords,
