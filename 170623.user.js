...
// @name NoAdPlayer
// @author KenYM
// @description 通过替换swf播放器的方式来解决优酷的黑屏广告 http://noadplayer.duapp.com/
// @version 1.0
// @icon http://noadplayer.cdn.duapp.com/images/youku.png
// @include http://*/*
// @include https://*/*
// ==/UserScript==
...
(function() {
    ...
    YoukuAntiAds.prototype = {
        ...
        get players() {
            if(!this._players) {
                this._players = {
                    'youku': 'http://noadplayer.cdn.duapp.com/v/loader.swf',
                    'ku6': 'http://noadplayer.cdn.duapp.com/v/ku6.swf',
                    'iqiyi': 'http://noadplayer.cdn.duapp.com/v/iqiyi.swf',
                    'iqiyi5': 'http://noadplayer.cdn.duapp.com/v/iqiyi5.swf',
                    'tudou': 'http://noadplayer.cdn.duapp.com/v/tudou.swf',
                    'tudou_olc': 'http://noadplayer.cdn.duapp.com/v/olc_8.swf',
                    'tudou_sp': 'http://noadplayer.cdn.duapp.com/v/sp.swf',
					'letv': 'http://noadplayer.cdn.duapp.com/v/letv.swf'
                };
            }
