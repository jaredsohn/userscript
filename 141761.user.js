...
ss.innerHTML = "/* OV Small Image Frames */ div.smallImgFrame { display: table-cell; vertical-align: middle; } div.smallImgFrame img { display: block; margin-left: auto; margin-right: auto; width: auto; height: auto; } .friendsArray .frame tr { border-spacing: 0; } /* OV Logo Fix */ td.header a.logolink { margin-right: 15px; }";
