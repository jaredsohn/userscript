...
function addDownloadLink(){
	...
	document.getElementById("watch-vid-title").innerHTML = parseHTML(title);
}
...
function addDownloadBox() {
	...
	downloadBox.innerHTML = parseHTML('<a title="Download" target="_blank" href="' + dl_url + '"><img src="' + keepTubeIcon + '" width="16" height="16" /> Download</a>');
}