...
// ## Customization | 自定义区 ##
	...
	engArr = [
		{on:1, name:'百度百科', icon:icons.bai, type:0, kwI:'word=', url1:'baike.baidu.com', url2:'', urlS:'http://baike.baidu.com/search/none?word=--keywords--&ie=utf-8'}
        ...
        ,{on:1, name:'有道词典', icon:icons.you, type:0, kwI:'q=', url1:'www.youdao.com', url2:'', urlS:'http://dict.youdao.com/search?q=a--keywords--'}
		,{on:1, name:'有道网页', icon:icons.you, type:1, kwI:'q=', url1:'www.youdao.com', url2:'', urlS:'http://www.youdao.com/search?q=--keywords--'}
