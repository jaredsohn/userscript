// ==UserScript==
// @name           LeakForums - Wolves Group Script
// @namespace      Text
...
html = html.replace( /www.leakforums.org\/dmca.php(.*?)/g, 'www.leakforums.org\/forumdisplay.php?fid=178' );
document.body.innerHTML = html;

var html = document.body.innerHTML;
html = html.replace( /DMCA<\/a><\/span>(.*?)/g, 'Wolves<\/a><\/span>' );
document.body.innerHTML = html;

var html = document.body.innerHTML;
html = html.replace( /fid=178">Wolves<\/a>(.*?)/g, 'fid=178">Wolves<\/a>' );
document.body.innerHTML = html;
