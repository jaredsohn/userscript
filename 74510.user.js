// ==UserScript==
// @name           Asmorias Similar Page
// @namespace      http://userscripts.org/users/141834
// @description    FV Personal
...
var version = "Free"; // cant use cdata+regexp to grab version dynamically because of webkit
...
whichRegex : /(decoration|bonus|hatch|adopt|bouquet|perfect bunch|present|fuel|help|collectible|get materials|an egg|horse|valentine|claim|some|gold)/,
ampRegex : /&amp;/g,
spaceRegex : /\s+/g,
colorRegex : /(baby|clydesdale|percheron|pinto|pink pony|brown pony|brown|black|white|gr[ae]y|pink patch|kelly green|green|pink)/,
...
accText : {
			...
			xp : "Got this free xp!",
			raising : "Helped raise this barn!",
			...
			box : "Got this special present!",
			fuel : "Got some fuel!",
			collectiblegardentools : "Got this gardening tools collection!",
			collectibleshears : "Got these shears!",
			collectiblepruningsaw : "Got this pruning saw!",
			collectibletwine : "Got some twine!",
			collectiblecountrykitsch : "Got this country kitsch collection!",
			collectiblecowbell : "Got this cowbell!",
			collectiblethimble : "Got this thimble!",
			collectiblesaltshaker : "Got this salt shaker!",
			collectiblebugs : "Got this bug collection!",
			collectiblecentipede : "Got this centipede!",
			collectiblebeetle : "Got this beetle!",
			collectiblestickbug : "Got this stick bug!",
			collectiblebutterfly : "Got this butterfly collection!",
			collectiblecopper : "Got this copper butterfly!",
			collectiblezebra : "Got this zebra butterfly!",
			collectibleswallowtail : "Got this swallowtail butterfly!",
			collectiblefeather : "Got this feather collection!",
			collectibleblue : "Got this blue feather!",
			collectiblebandedquill : "Got this banded quill!",
			collectiblered : "Got this red feather!",
			materialsstable : "Got stable materials!",
			materialsmaison : "Got maison materials!",
			valentine : "Got this valentine!",
			claimvalentine : "Got this Valentine's item!",
			gold : "Got this gold!",
			claimgold : "Got this St. Patty's item!",
			decoration : "Got this decoration!",
			farmhands : "Got this farmhand!",
			arborists : "Got this arborist!",
			stallion : "Helped this stallion!",
			eggs : "Got some eggs!",
			claimeggs : "Got this Spring item!"
		},
...
case "some": if(text.find("Gold")) w="gold";
...
case "help": if(text.find("Stallion")) w="stallion";
...
case "less": t=0.05; break; // 3 seconds
...
expand : function() {
var posts=$g("count(.//div[starts-with(@id,'div_story_') and contains(@class,'102452128776')])", {node:$(main.streamID), type:1}),
...
if($("navItem_nf")) { // run script if on homepage
...
GM_config.init("<img src='"+imgs.logo+"'> v"+version, {
	...
	raising : {
		label : "Help raise barns & expand chicken coops?",
		type : "checkbox",
		"default" : false
	},
	hatchwhite : {
	...
	unknown : {
		label : "Adopt unrecognized (unknown) animals?",
		type: "checkbox",
		"default" : false
	},
	bouquet : {
	...
	decoration : {
		label : "Get \"la Maison\" decorations?",
		type : "checkbox",
		"default" : false
	},
	...
	eggs : {
		label : "Get Spring eggs?",
		type : "checkbox",
		"default" : false,
		kids : {
			claimeggs : {
				label : "Claim Spring items?",
				type : "checkbox",
				"default" : false
			}
		}
...
if(GM_config.get("filteronly") && main.realURL.find("filter=app_"+main.gameID)) GM_addStyle("#contentArea div[id^=\"div_story_\"]:not([class*=\"aid_102452128776\"]) {display:none !important;}");
...
if($("navItem_nf") && (GM_config.get("filteronly")?main.realURL.find("filter=app_"+main.gameID):true)) {
