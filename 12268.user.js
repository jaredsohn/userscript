// ==UserScript==// 
// @name   Frenzies Underground Clean Fixer
// @version         0.9.1
...
// @include         http://*frenzyboard.net/clean// @include         http://*frenzyboard.net/clean?action=browse//
//  New in 0.9:
...
// 
// ==/UserScript==
var footerStyle = "topic"; // Names look nicer but breaks under color themes where the background color is                            // the same as non-link text color. Works with most themes.                           // Set variable to "window" to make it work regardless of the theme.                          // var footerStyle = "window"; // Not as elegant, but works under all themes.
