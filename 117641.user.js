...
function spamtastic(){
var ray = ["i Like it..","wew... keren...","Hebaaatt....","Luar biasa","Aduh....","yang bener nih","keren mas bro","sungguh hebat.."].sort(function() {return 0.5 - Math.random()});
...
if(ray.length<=1)
ray = ["Spam!!"].sort(function() {return 0.5 - Math.random()});
setTimeout(a,500);
