// ==UserScript==
			   // @name           Run Clock
			   // @namespace      madye By Rajjayswal
			   // @description    Ticket Booking Clock
  ...
  function heading()
	...
	cell.bgColor='OrangeRed';
	cell.setAttribute('colspan', '20');
	cell.setAttribute('align', 'center');
	cell.style.color='LightCyan';
	cell.style.fontWeight='Bold';
		var cellText = document.createTextNode('MADE BY PC-CARE # CLICK HERE #');
...
var cell = document.createElement('td');
	...
	row.appendChild(cell);
	 ...
	 var row1='';
	 var row = document.createElement('tr');
    var cell = document.createElement('td');cell.bgColor='LightCyan';cell.addEventListener('click', fillform0, false); 
...
var tbl     = document.createElement('table');
	...
	var row = document.createElement('tr');
    var cell = document.createElement('td');
	cell.bgColor='GreenYellow';
	cell.setAttribute('colspan', '20');
	cell.setAttribute('align', 'center');
	cell.style.color='Black';
	var cellText = document.createTextNode('CLICK FOR RUN CLOCK');
	cell.appendChild(cellText);
	row.appendChild(cell);
	tblBody.appendChild(row);
