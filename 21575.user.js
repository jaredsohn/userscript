// ==UserScript==
// @name      Facebook Taylor University Colors
// @version	0.2
// @author	Brad Wood
// @namespace   http://randombrad.com
// @description  Makes Facebook Taylor University Colors
// @include    *.facebook.com/*
// ==/UserScript==

/*
Copyright (C) 2007 by Alan Kelly, Modified for Taylor University by Brad Wood.
...
GM_addStyle(" #sidebar a.go_home {background-image: url(" + toplogo + ")!important} ");
GM_addStyle(" #sidebar a.go_home:hover {background-image: url(" + tophover + ")!important} ");
...
// ==== VARIABLE DEFS ====
var cTitleColour	= "#000000";
var cTitleColour2	= "#FFFFFF";			// Dark Green        = #339966
var cHeadingColour	= "#632852";			// Medium Grey/Green = #99CC99
var cSectionColour	= "#ffc721";			// Very Light Green  = #CCFFCC
...
document.getElementById("sidebar_content").style.Color = cTitleColour;
...
for (var i = 0; i < mylinks.length; i++) {
	...
	if (mylinks[i].className.toLowerCase() == "wallheader") {
			mylinks[i].style.backgroundColor = cTitleColour;
	}		
...
for (var i = 0; i < mylinks.length; i++) {
	if (mylinks[i].className.toLowerCase() == "go_home") {
		mylinks[i].style.background = "url(http://randombrad.com/fb2.jpg)";
	}
}

// ==== Now manipulate the BODY's font and background etc. ===
//document.body.style.fontFamily = "Gill Sans MT";
document.getElementById("content").style.backgroundColor = cSectionColour;
document.body.style.backgroundImage = "url(http://www.taylor.edu/images/athleticBckgrd.jpg)";
