...
// @author		PMTF FTW!
// @name        PMTF F!
// @namespace   BattlesReporter_PMTF
// @version		0.0.1
// @uso:version 0.0.1
// @include		http://*erepublik.com/*/military/battlefield/*
// @description    Damage Reporting for PMTF
// ==/UserScript==
...
if(window.location.href.indexOf(PAGE_BATTLEFIELD) > 0) {	
	...
	/***********************************************************************************/
	var FORM_URL = "https://docs.google.com/spreadsheet/viewform?formkey=dGVmWHMxQXBFNHJzUi1MLThXQzVTX1E6MQ#gid=0";
	var FORM_FIELDS = {
                eday: "entry.0.single",
                name: "entry.1.single",
	...
	function BattlePage() {
        ...
        var dmgq6=Math.floor((parseInt(rankl) - 1) / 20 + 0.3) * ((parseFloat(str) / 10) + 40) * (1 + 200 / 100);
...
//				name: $("#pvp .battle_stats .repeat .content .info .you .two").text(),
                damage: dmg,
                dq6hit: dmgq6hit,
                battle: battleid,
                ...
                round: $("#selectzone").text(),
				version: $("#selectdivision").text(),
//				version: $("#pvp .blockUI blockMsg blockElement .battle_stats .repeat .content .info personal .you .two strong").text(),
