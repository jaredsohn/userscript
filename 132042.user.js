// ==UserScript==
// @name           LoU Suite | Guigo`s Edit | 
// @description    Q cosa mas Grande!!!
// @namespace      “Don Guigo”
		...
		function createSuite() {
			...
			qx.Class.define("louSuite.main", {
				...
				members: {
					...
					startScript: function() {
						...
						btn.set({width: 30, appearance: "button-text-small", toolTipText: "Tengo otro script Fenomenal! Como no seais generoso, Jamas os dejare usarlo! Piensalo!!!"});
			...
			qx.Class.define("louSuite.optionsPage", {
				...
				construct: function() {
					...
					this.setTitle("Te gusto? Te sirvio? Enviame oro coño!!!!");
...
//           		7: [125000, 138000, 145000, 150000, 165000, 176000, 190000, 200000, 210000, 225000],
					...
					getTroopsNeeded: function (dungeon_name, dungeon_level, dungeon_progress, units) {
						...
						for (var u_key in units) {
							...
							if (unit['count'] > 0) {
try {
dungeon_progress = (dungeon_progress + (100- dungeon_progress) / 1;
