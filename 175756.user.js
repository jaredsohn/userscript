 ...
 *        Changed BotX Functionality to use MercBot instead.  Added "-" button to remove the lowest level cottage.
 ...
 * 4.6.4 - change location some images were loaded from.  seems to helped with an issue of merc tools baron info flashing.
 * 
 */
(function() {
	var main = function() {
		...
		var createTweak = function() {
			...
			qx.Class.define("paTweak.Main", {
				...
				members : {
					...
					tweakPA : function() {
						...
						this.panel = new paTweak.ui.ExtraTools("MERC Tools v" + paTweak.Version.PAversion);
						...
						try {
							...
							// REMOVED askBotxHistoryBtn.setToolTipText("Get player history from MercBot");
							...
							// REMOVED 	webfrontend.data.Chat.getInstance().addMsg("/whisper MercBot !history," + cityPlayerName);
							// REMOVED });
							// REMOVED var askBotxAllianceBtn = new qx.ui.form.Button("Alliance history");
							// REMOVED askBotxAllianceBtn.setToolTipText("Get alliance history from MercBot");
							...
							// REMOVED 	webfrontend.data.Chat.getInstance().addMsg("/whisper MercBot !alliance," + cityAllianceName);
							// REMOVED });
							// REMOVED var askBotxCityBtn = new qx.ui.form.Button("City history");
							// REMOVED askBotxCityBtn.setToolTipText("Get city history from MercBot");
							...
							// REMOVED 	webfrontend.data.Chat.getInstance().addMsg("/whisper MercBot !city," + citycoords[0] + ":" + citycoords[1]);
							// REMOVED });
							...
							// REMOVED askBotxHistoryBtn.setToolTipText("Get scouting reports for this city from MercBot");
							// REMOVED row.add(askBotxHistoryBtn, {
							// REMOVED 	flex : 1
							// REMOVED });
							// REMOVED askBotxHistoryBtn.addListener("execute", function() {
							// REMOVED 	var selectedCity = (app.cityDetailView || app.getCityDetailView()).city;
							// REMOVED 	var citycoords = paTweak.CombatTools.cityIdToCoords(selectedCity.get_Coordinates());
							// REMOVED 	webfrontend.data.Chat.getInstance().addMsg("/whisper MercBot !report," + citycoords[0] + ":" + citycoords[1] + ",scout,8");
							// REMOVED });
							// REMOVED var askBotxAllianceBtn = new qx.ui.form.Button("Offense reports");
							// REMOVED askBotxAllianceBtn.setToolTipText("Get offense reports for this city from MercBot");
							// REMOVED row.add(askBotxAllianceBtn, {
							// REMOVED 	flex : 1
							// REMOVED });
							// REMOVED askBotxAllianceBtn.addListener("execute", function() {
							// REMOVED 	var selectedCity = (app.cityDetailView || app.getCityDetailView()).city;
							// REMOVED 	var citycoords = paTweak.CombatTools.cityIdToCoords(selectedCity.get_Coordinates());
							// REMOVED 	webfrontend.data.Chat.getInstance().addMsg("/whisper MercBot !report," + citycoords[0] + ":" + citycoords[1] + ",offense,8");
							// REMOVED });
							// REMOVED var askBotxCityBtn = new qx.ui.form.Button("Defense reports");
							// REMOVED askBotxCityBtn.setToolTipText("Get defense reports for this city history from MercBot");
							// REMOVED row.add(askBotxCityBtn, {
							// REMOVED 	flex : 1
							// REMOVED });
							// REMOVED askBotxCityBtn.addListener("execute", function() {
							// REMOVED 	var selectedCity = (app.cityDetailView || app.getCityDetailView()).city;
							// REMOVED 	var citycoords = paTweak.CombatTools.cityIdToCoords(selectedCity.get_Coordinates());
							// REMOVED 	webfrontend.data.Chat.getInstance().addMsg("/whisper MercBot !report," + citycoords[0] + ":" + citycoords[1] + ",defense,8");
							// REMOVED });
							// REMOVED row = new qx.ui.container.Composite();
							// REMOVED row.setLayout(new qx.ui.layout.HBox(2));
							// REMOVED targetContainer.add(row);
							...
							// REMOVED askBotxAllianceBtn.setToolTipText("Get offense reports excluding fakes for this city from MercBot");
							// REMOVED row.add(askBotxAllianceBtn, {
							// REMOVED 	flex : 1
							// REMOVED });
							// REMOVED askBotxAllianceBtn.addListener("execute", function() {
							// REMOVED 	var selectedCity = (app.cityDetailView || app.getCityDetailView()).city;
							// REMOVED 	var citycoords = paTweak.CombatTools.cityIdToCoords(selectedCity.get_Coordinates());
							// REMOVED 	webfrontend.data.Chat.getInstance().addMsg("/whisper MercBot !report," + citycoords[0] + ":" + citycoords[1] + ",offense,8,f");
							// REMOVED });
							...
							// REMOVED 	var selectedCity = (app.cityDetailView || app.getCityDetailView()).city;
							// REMOVED 	var citycoords = paTweak.CombatTools.cityIdToCoords(selectedCity.get_Coordinates());
							// REMOVED 	webfrontend.data.Chat.getInstance().addMsg("/whisper MercBot !report," + citycoords[0] + ":" + citycoords[1] + ",defense,8,f");
							// REMOVED });
						} catch(e) {
							paDebug(e);
						}
						...
						try {
							...
							// FIXED row.add(btn);
							// FIXED btn.setToolTipText("Ask MercBot to find members with no updates in the last 3 days");
							// FIXED btn.addListener("click", function() {
							// FIXED 	webfrontend.data.Chat.getInstance().addMsg("/whisper MercBot !ai," + qx.core.Init.getApplication().getAllianceInfoPage().getAllianceId() + ",3");
							// FIXED }, false);

							// FIXED var allianceBtn = new qx.ui.form.Button("Alliance history");
							// FIXED allianceBtn.setToolTipText("Get alliance history from MercBot");
							// FIXED row.add(allianceBtn, {
							// FIXED 	flex : 1
							// FIXED });
							// FIXED allianceBtn.addListener("execute", function() {
							// FIXED 	webfrontend.data.Chat.getInstance().addMsg("/whisper MercBot !alliance," + qx.core.Init.getApplication().getAllianceInfoPage().getData().sName);
							// FIXED });
							...
							// FIXED row.add(btn);
							// FIXED btn.setToolTipText("Get player history from MercBot");
							// FIXED btn.addListener("click", function() {
							// FIXED 	webfrontend.data.Chat.getInstance().addMsg("/whisper MercBot !history," + qx.core.Init.getApplication().getPlayerInfoPage().getData().sName);
							// FIXED }, false);
					...
					emotifyIcons : function() {
						...
						// REMOVED emotify.emoticons('http://Merc.somee.com/images/Yahoo.AdiumEmoticonset/', smilies);
					}
				}
			});
			...
			qx.Class.define("paTweak.Inception", {
				...
				members : {
					...
					outputMsgIntercept : function(eY, fa, fb) {
						...
						if (t.test(eY) || (fa.indexOf("MercWeb") >= 0)) {
			...
			qx.Class.define("paTweak.Command", {
				...
				members : {
					...
					cm : function(data, sender) {
						if (sender == 'MercWeb') {
							// REMOVED paTweak.Chat.getInstance().addChatMessage(i18n('ext:merc_message') + ': ' + data.charAt(0).toUpperCase() + data.slice(1));
						}
						return false;
					},
					...
					showMessageWindow : function() {
						if (this._msgWin == null) {
							var win = new qx.ui.window.Window("Merc Messages");
			...
			function rpt(m)
			{
				// REMOVED chat.addMsg("/whisper MercBot !LoU.rpt," + m);
			}
			function upl(m, cn)
			{
				// REMOVED chat.addMsg("/whisper MercBot !LoU.upl," + cn + "," + m);
			}
			...
			qx.Class.define("paTweak.ui.RaidingWindow", {
				...
				members : {
					...
					interceptSetDungeon : function(bn, bo) {
						...
						dv.mercRaid.curDungeon = bn;
						dv.mercRaid.addDungeonToRaid(bn);
					},
					interceptSetCity : function(bT) {
						var app = qx.core.Init.getApplication();
						var cv = (app.cityDetailView || app.getCityDetailView());
						cv.originalSetCity(bT);
						cv.mercRaid.curCity = bT;
						cv.mercRaid.addCityToRaid(bT);
					},
						...
						if (webfrontend.res.Main.getInstance().dungeons[d.get_Type()].b == 0) {
							...
							if (!found) {
								...
								if (d.hasOwnProperty("get_StartStep")) {
									btn.addListener("click", function() {
										this.mercWin.curDungeon = this.d;
			...
			qx.Class.define("paTweak.ui.PlayerReportsWindow", {
				...
				members : {
					...
					buildUI : function() {
						...
						wcLabel = new qx.ui.basic.Label("MERC Format").set({
							font : "bold"
						});
						this.add(wcLabel);
			...
			qx.Class.define("paTweak.ui.ExtraTools", {
				...
				members : {
					...
					buildUI : function() {
						...
						// REMOVED flattr.setValue("<iframe id='flattrbtn' title='Flattr' height='20' width='110' frameborder='0' style='border-width=0px;' src='//api.flattr.com/button/view/?uid=Uldrich&button=compact&category=software&tags=lou,MercTools&title=MercTools&description=A collection of tools for Lord of Ultima.  Donations support maintenance and updates of MercTools.&url=http%3A%2F%2Fab6s.com%2F' />");
