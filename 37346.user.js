...
// --------------------------------------------------------------------
// ==UserScript==
// @name           Klan Premium Görünüm v2.1.1
// @version        0.1f
// @namespace      Ahm
// @description    Raklamsız. 15x15 Harita. Fazlalaştırılmış Kısayol Erişim Çubuğu. Türkçe ve daha fazlası!
// @include        http://s*.klansavaslari.net/*
// @copyright      Copyright (c) 2007 - 2008, Ahm
// @maintainer     ahm
// ==/UserScript==
...
"en" : {
	...
	"pop_close": "Kapat",
	"pop_auto" : "Üzerine gelince göster"
}
...
function build_shortcuts_menu(){
	...
	menu_xhtml += '<td><a href="/game.php?village=' + TW_Village_Id + '&screen=place&mode=sim"><img src="' + TW_Image_Base + 'buildings/place.png" style="margin:0px 2px" title=" ' + TW_Lang["sim"] + ' " /></a></td>';
	...
	menu_xhtml += '<td><a href="/game.php?village=' + TW_Village_Id + '&screen=statue"><img src="' + TW_Image_Base + 'buildings/statue.png" style="margin:0px 2px" title=" ' + TW_Lang["statue"] + ' " /></a></td>';
