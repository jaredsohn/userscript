// ==UserScript==
// @name           Creative Farm Ville Wall Manager
// @namespace      http://userscripts.org/users/141834
// @description    FV Creative
...
var version = " Creative "; // cant use cdata+regexp to grab version dynamically because of webkit
...
var imgs = {
bg : "http://i40.tinypic.com/2dlksiu.jpg",
logo : "http://i43.tinypic.com/2alw6e.jpg",
...
GM_config.init("<img src='"+imgs.logo+"'> v"+version, {
	...
	hatchwhite : {
                label : "Hatch White Egg",
		type: "checkbox",
		"default" : false,
		kids : {
			hatchbrown : {
				label : "Hatch Brown Egg",
				type : "checkbox",
				"default" : false
			},
                        hatchblack : {
				label : "Hatch Black Egg",
				type : "checkbox",
				"default" : false
			},
                        hatchgold : {
				label : "Hatch Golden Egg",
				type : "checkbox",
				"default" : false
			}
		}
