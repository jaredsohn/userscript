...
#viewer-header-container { height:35px;border: none; } \
...
//{top:0px;}\
,\
 #viewer-container { top:22px;overflow: hidden !important; margin-bottom: 33px !important; } \
...
#title-and-status-holder { background-color: #F1F1F1; z-index: 2;left:50%; width: 20%; \
//border-bottom: #aaa solid 2px;\
 top: 77px; position: fixed;\
 //-moz-box-shadow: 2px 5px 6px -3px #aaa; \
 //box-shadow: 2px 5px 6px -3px #aaa;\
 //-webkit-box-shadow: 2px 5px 6px -3px #aaa; \
 } \
#nav { width: 270px; } \
...
#viewer-header, #lhn-add-subscription-section, #top-bar { height: 35px; overflow: hidden; } \
