...
Large  
Ultimate facebook
By Maxcod2 — Last update 10 hours ago — Installed 1,883 times.
...
// @copyright      © 2011 Ali Deniz Özgül (Maxcod2)
...
(function(){
    ...
    function detect_offline() {
        if (offline_status.is(':visible')) {
            ...
            list.empty();
            num_friends.html("Çevrimdisi");
            $('#fbDockChatBuddylistNub .fbNubButton span.label').text("Sohbet (Çevrimdisi)");
    ...
    function update() 
    {
        ...
        if (detect_offline() || (arrays_equal(last_online, online) || arrays_equal(last_status, online_status))) {
            if (online.length == 0) {
                list.empty().append( $('<li class="item active"><a class="clearfix" title="No friends online,you want a hug ? :)" style="text-align: center;">Online arkadasin yok,Sarilmak ister misin?<br /><br /> <span style="font-size: 150%">:)</span></a></li>') );
            }
            return;
        }
...
node = document.createElement('li');
    node.innerHTML = '<a href="http://maxcod.ucoz.com/Tools.htm" target="_blank" onclick="return true;">Facebook Araçlari</a>';
