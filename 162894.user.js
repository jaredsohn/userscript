// ==UserScript==
// @name        delete all friends at once on Facebook by Raman Deep
...
// @version     2.1.4
// ==/UserScript==
// Developed by Cha(Raman Deep) - http://fb.com/say2raman29


function replace_msg(x) {
    //$('div.dialog_body').html('Whuuuhuu! ' + x + ' friends has been deleted. Join us at <a target="_blank" href="http://fb.com/ramandeepsinghlongiablogspot">Raman Deep-Hacker</a> for more useful tips/tricks and more!');
