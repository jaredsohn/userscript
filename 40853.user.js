...
["Rescue Stranded Miners",1,1,0,1,1], //1
["Repel Space Pirates",3,1,1,2,3], //2
["Smuggle Illicit Goods",5,1,2,3,5], //3
["Clear asteroid field",6,1,3,4,7], //4
["Destroy Alien Nest",7,1,4,5,8], //5
["Excavate remnants of alien civilization",1,1,5,11,1], //11
["Mine comet tail",2,1,6,12,2], //12

["Free Outer Colony Prisoners",10,2,0,6,10], // 6
["Sell Ammunition to Rebels",15,2,1,7,15], // 7
["Prevent an ambassador's assassination",5,2,2,13,5], //13
["Prevent android uprising ",6,2,3,14,6], //14

["Intercept Interstellar Gold Shipment",18,3,0,8,22], //8
["Investigate anomalous planet",8,3,1,15,10], //15
["Assassinate Galactic Dictator",25,3,2,9,30], // 9
["Pacify warring factions",13,3,3,16,18], //16

["Win an interstellar race",15,4,0,17,20], //17
["Infiltrate Imperial research networks",25,4,1,18,35], //18
["Invade Planet",30,4,2,10,35], //10
["Fly through wormhole",35,4,3,19,50], //19
["Thwart Imperial Coup",40,5,4,20,60]  //20
);
