...
// @name          Ogame alarm
// @author	  Karamba
// @description	  Multi language alarm for all servers Special Thanks to Laymain
// @include  http://*/game/*
// 
// 
// ==/UserScript==
var listaElementos, elementoActual; //nos sirven para recorrer
var espionajeSound = "http://3lib.ukonline.co.uk/pocketinfo/sounds/dogbark.wav";
var ataqueSound    = "http://3lib.ukonline.co.uk/pocketinfo/sounds/smokwatr.wav";
var mensajeSound   = "http://3lib.ukonline.co.uk/pocketinfo/sounds/SPACE.WAV";
...
var MIN = 180;  // segundos (MINIMO)
var MAX = 420; // segundos (MAXIMO)
...
function autoReload()
{
	...
	for (var i = publi.length - 1; i >= 0; i--)
	{
		...
		if (htmldentro.indexOf('index.php?page=messages', 0) != -1)
			sonido=mensajeSound;
	}
