...
var SCRIPT = {
	name: 'DWO Test (dynamic)',
	namespace: 'crohllf',
	source: 'http://userscripts.org/scripts/show/92865',
	identifier: 'http://userscripts.org/scripts/source/92865.user.js',
	meta: 'http://userscripts.org/scripts/source/92865.meta.js',
	version: '1.9.0',
	date: '2010-08-07',
};

var threadURL = 'http://goallineblitz.com/game/forum_thread.pl?thread_id=4421875';
var postId = '39919144';
// Debug location, top of page 2:
// var threadURL = 'http://goallineblitz.com/game/forum_thread.pl?thread_id=4421875&page=2';
// var postId = '39919274';
var forumAccessURL = 'http://goallineblitz.com/game/forum_private_access.pl?forum_id=7983';
...
//						data.html(data.html().replace(n + '</a>', n + '</a> (real name: ' + realName.replace('(banned)', '<b><i>(banned)</i></b>') + ')'));
			...
			$.each(names, function(id, name) {
				if (!(id = parseInt(id))) return;
					...
					++nonMemberAddicts;
					$('#fam_list_family a[href$="/new_message.pl?to=' + id + '"]').after(') (<a href="/game/forum_private_access.pl?forum_id=7983&action=Invite&user_name=' + escape(name) + '"><b style="color: #008787;">invite</b></a>');
				} else if (list.apprentice.member[id]) {
					$('#fam_list_apprentice a[href$="/new_message.pl?to=' + id + '"]').after(') (<a href="/game/forum_private_access.pl?forum_id=7983&action=Invite&user_name=' + escape(name) + '"><b style="color: #008787;">invite</b></a>');
				} else if (list.waitlist.member[id]) {
					$('#fam_list_waitlist a[href$="/new_message.pl?to=' + id + '"]').after(') (<a href="/game/forum_private_access.pl?forum_id=7983&action=Invite&user_name=' + escape(name) + '"><b style="color: #008787;">invite</b></a>');
				} else if (list[idToList[id]].forumAccess == 1) {
					$('#post_content_' + postId + ' a[href$="/new_message.pl?to=' + id + '"]').after(') (<a href="/game/forum_private_access.pl?forum_id=7983&action=Invite&user_name=' + escape(name) + '"><b style="color: #008787;">invite</b></a>');
				}
			});
			var prefix = ' (';
