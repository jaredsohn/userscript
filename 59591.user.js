...
// @name            R.I.P. Buckwild
// @namespace       Sixx
// @include         http://goallineblitz.com/game/team.pl?team_id=1604
// @include         http://goallineblitz.com/game/team.pl?team_id=2012
// @include         http://goallineblitz.com/game/team.pl?team_id=4466
// @include         http://goallineblitz.com/game/team.pl?team_id=5508
// ==/UserScript==
function do_platypus_script() {
html_insert_it(window.document,document.getElementById('team'),'In memory of <a platypus-background-color="" style="" href="http://goallineblitz.com/game/home.pl?user_id=14229">Buckwild</a><br>        R.I.P. 9/29/09',false,true);
remove_it(window.document,document.evaluate('/HTML[1]/BODY[1]/DIV[2]/DIV[5]/DIV[4]', document, null, XPathResult.FIRST_ORDERED_NODE_TYPE,null).singleNodeValue,null,null,null);
html_insert_it(window.document,document.evaluate('/HTML[1]/BODY[1]/DIV[2]/DIV[5]/DIV[2]', document, null, XPathResult.FIRST_ORDERED_NODE_TYPE,null).singleNodeValue,'In memory of <a platypus-background-color="" style="" href="http://goallineblitz.com/game/home.pl?user_id=14229">Buckwild</a><br>        R.I.P. 9/29/09',false,true);
set_style_script(window.document,document.evaluate('/HTML[1]/BODY[1]/DIV[2]/DIV[5]/DIV[3]', document, null, XPathResult.FIRST_ORDERED_NODE_TYPE,null).singleNodeValue,"color: navy;text-align: center;font-weight: bold;font-size: x-large;",null,null);
remove_it(window.document,document.evaluate('/HTML[1]/BODY[1]/DIV[2]/DIV[5]/DIV[2]', document, null, XPathResult.FIRST_ORDERED_NODE_TYPE,null).singleNodeValue,null,null,null);
