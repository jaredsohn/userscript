// ==UserScript==
// @name            HackForums Neil - [color=#00BFFF] and bold
// @namespace       Yellows/[color=#00BFFF]andbold
// @description     Makes text bold and [color=#00BFFF].
...
function form_submit(event) {
   ...
   for (var i = arTextareas.length - 1; i >= 0; i--) {
	   ...
	   elmTextarea.value = "[color=#00BFFF][b]" + elmTextarea.value + "[/color][/b]";
   }
