...
function exeScript()
{
	...
	else if (window.location.href.indexOf("apps.facebook.com/mousehunt") != -1)
	{
		// from facebook
		fbPlatform = true;
	}
...
function timeformat(time)
{
	...
	var sec = (Math.floor(time) % 3600 % 60) % 60;
...
function reloadPage(soundHorn)
{
	...
	if (fbPlatform)
	{
		if (soundHorn)
		{
			if(confirm("It's time to sound the horn!\nDo you want to sound it now?\n\nNOTE: By clicking OK, the horn will be sounded on this tab, so please click cancel if you are in the middle of completing a form. FB"))
			window.location.href = "http://mousehuntgame.com/canvas/turn.php";
		}
		else
		{
			window.location.href = "http://mousehuntgame.com/canvas/";
		}
	}
	else if (hiFivePlatform)
	{
	...
	else if (mhPlatform)
	{
		...
		if (soundHorn)
		{
			if(confirm("It's time to sound the horn!\nDo you want to sound it now?\n\nNOTE: By clicking OK, the horn will be sounded on this tab, so please click cancel if you are in the middle of completing a form. MH"))
			window.location.href = "http://www.mousehuntgame.com/turn.php";
		}
		else
		{
