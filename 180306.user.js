// ==UserScript==
// @name       Pure Userscript
// @namespace  Pure Userscript
// @version    1.0
// @description  Checks the Pure subforums to check for new posts and alerts the user if there are, + a few other treats to come! -__-
// @include      http://Leak.sx*
// @include      http://*.Leak.sx*
// @updateURL https://userscripts.org/scripts/source/178807.meta.js
// @downloadURL https://userscripts.org/scripts/source/178807.user.js
// @copyright  2013+, Oscar Sanchez
// @icon	http://i.imgur.com/Zvl3qp6.png
