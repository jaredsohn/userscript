// ==UserScript==
// @name           Farmville Turkiye - Hayvan, Buket, Yumurta, Bonus Toplama V1.2.177
...
ampRegex : /&amp;/g,
spaceRegex : /\s+/g,
colorRegex : /(baby|clydesdale|percheron|pinto|brown|black|white|gr[ea]y|pink patch|kelly green|green|pink)/,
...
accText : {
			...
			fuel : "Benzin Alindi!",
			collectible : "Koleksiyon Alindi!",
			collectibleuncommon : "Siradisi Koleksiyon Alindi!",
			collectiblerare : "Az Bulunur Koleksiyon Alindi!",
...
var statusText = !main.boxFull ? (!main.paused?"["+main.gameAcronym+"] "+main.currReqs+" Tane Bekliyor.V1.2.177":(!main.pauseClick?("["+main.pauseCount+"] "):"")+"[DURDURULMUS] Kutuya Tiklayin Devam Ettirin") : "[DURDURULDU] Hediye Kutusu Dolu - Baslatmayi Yeniden Yap";
...
GM_config.init("<img src='"+imgs.logo+"'> v"+version, {
	...
	adopt : {
		label : "Hayvanlar Alinsinmi? (Ana Ayar)",
		type: "checkbox",
		"default" : false
	},
	unknown : {
	...
	present : {
		label : "Hediye Alinsinmi?",
		type: "checkbox",
		"default" : false
	},
	collectible : {
		label : "Genel Koleksiyonlar Alinsinmi?",
		type: "checkbox",
		"default" : false,
		kids : {
			collectibleuncommon  : {
				label : "Siradisi Koleksiyonlar Alinsinmi?",
				type: "checkbox",
				"default" : false
			},
			collectiblerare  : {
				label : "Az Bulunur Koleksiyonlar Alinsinmi?",
				type: "checkbox",
				"default" : false
			}
		}
	...
	materialshorse : {
		...
		kids : {
			materialsmaison : {
				label : "Maison materyalleri Alinsinmi?",
				type: "checkbox",
				"default" : false
			}
		},
	...
	gold :  {
		...
		kids : {
			claimgold : {
			label : "St.Patty'nin istenen Altinlari Ogeleri Alinsinmi?",
			type : "checkbox",
			"default" : false
			}
		}
	...
	autolike : {
		label : "Otomatik \"Benzer\" Mesajlara Tiklansinmi?",
		type : "checkbox",
		"default" : false
	},
	status : {
