...
// @description Show Sets Owned [muestra los conjuntos que se tienen en inventario]				
...
(function(func) {				
	...
	TW_Widgets.MenuButton = function(image, title, onclick) {			
     ...
     var TW_Sets = [{				
            ...
            name: "Set Matasanos",				
            items: [527, 224, 11085, 435, 340, 10085, 854, 794, 191,44020]				
        }, {				
            name: "Set Gruñón mañanero",				
            ...
            name: "Set Cabalgata de Christopher",				
            ...
            name: "Set Rayos y Truenos",				
            items: [902, 94, 190]				
		}, {		
            name: "Set Pesadilla",				
            items: [41044, 42032, 40074, 10217, 11206, 43006]				
        }, {				
            name: "Set Confederado",				
            ...
            name: "Herramientas de Invierno",				
            items: [905, 97, 191, 667, 2539]				
        }, {				
            name: "Artículos Bonus Energía",				
            ...
            name: "Artículos Bonus Puntos de Vida",				
            ...
            name: "Artículos Bonus Suerte",				
            items: [2247, 2248, 2249, 2250, 2251, 2270]				
        }, {				
            name: "Artículos Bonus Carácter",				
    ...
    TW_QuickSearch.name = "Set y Bonus";				
    TW_QuickSearch.gui = {};				
   ...
   TW_QuickSearch.init = function() {
    ...
    TW_QuickSearch.findSet = function(id) {
        ...
        if (invItems.length > 0) {
            ...
            var dlg = new west.gui.Dialog("Buscar Set", "¡¡ No encontrado !!");				
            dlg.addButton("ok");				
