...
// @exclude 	http://forum.travian5.*
// @exclude 	http://*.travian5.*/index.php*
// @exclude 	http://*.travian5.*/anleitung.php*
// @exclude 	http://*.travian5.*/login.php*
// @exclude 	http://*.travian5.*/logout.php*
// @exclude 	http://*.travian5.*/chat.php*
// @exclude 	http://*.travian5.*/impressum.php*
// @exclude 	http://*.travian5.*/karte2.php*
// @exclude 	http://www.travian.*
// ==/UserScript==
...
function onLoad(){ // runs the differnt functions and procedures, 
	...
	if(!lang) {
	lang = loc.match(/travian5(\.[a-zA-Z]{2,3})+/ ).pop(); } 
	else {
