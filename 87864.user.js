// ==UserScript==
// @name           Twitter retweet Button RT
// @description    Add RT button.
// @author         cmfcknw
// @version        1.0
// @date           10102010
  ...
  return <>
    <li>
      <span class="reply" id="_quote_">
        ...
        <a id="__RT__" title={"retweet " + user_name}
         href={"/?status= RT @" + user_name + " " + body +
         "&in_reply_to_status_id=" + status_id +
         "&in_reply_to=" + user_name}>retweet</a>
      </span>
    </li>
  </>.toXMLString();
}
