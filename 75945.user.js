...
//--// AYARLAR //--//
    ...
    var Ayarlar = {
        ...
        // KimdirNedir++ Ayarlari
        kimdirNedirPlusPlus : 1,

        sosyalAgListesi : [
            {name : "sözlükçülerin facebook sayfaları", regex : "facebook.com", title : "facebook'ta", image : "http://i.imgur.com/6mAYq.png"},
            {name : "sözlükçülerin twitter sayfaları", regex : "twitter.com", title : "twitter'da", image : "http://i.imgur.com/VpqK8.png"},
            {name : "sözlükçülerin tumblr sayfaları", regex : "tumblr.com", title : "tumblr'da", image : "http://i.imgur.com/ET3zZ.png"},
            {name : "sözlükçülerin formspring sayfaları", regex : "formspring.me", title : "formspring'de", image : "http://i.imgur.com/h3yUU.png"},
            {name : "sözlükçülerin last.fm sayfaları", regex : "last", title : "lastfm'de", image : "http://i.imgur.com/B51ZT.png"},
            {name : "sözlükçülerin google+ sayfaları", regex : "plus.google.com", title : "google+'ta", image : "http://i.imgur.com/8HtW2.png"},
            {name : "sözlükçülerin deviantart sayfaları", regex : "deviantart.com", title : "deviantart'ta", image : "http://i.imgur.com/qSkiu.png"},
            {name : "sözlükçülerin myspace sayfaları", regex : "myspace.com", title : "myspace'de", image : "http://i.imgur.com/CBYvf.png"},
            {name : "sözlükçülerin friendfeed sayfaları", regex : "friendfeed.com", title : "friendfeed'de", image : "http://i.imgur.com/d1bfA.png"},
            {name : "sözlükçülerin blogları", regex : "http", title : "kişisel blogu", image : "http://i.imgur.com/ZmW44.png"},
            {name : "sözlükçülerin web sayfaları", regex : "http", title : "kişisel web sayfası", image : "http://i.imgur.com/caD1z.png"},
            {name : "sözlükçülerin connected2.me sayfaları", regex : "connected2.me", title : "connected2me'de", image : "http://i.imgur.com/zx7zO.png"},
            {name : "sözlükçülerin soundcloud sayfaları", regex : "soundcloud.com", title : "soundcloud'da", image : "http://i.imgur.com/QFvEZ.png"},
            {name : "sözlükçülerin onioning sayfaları", regex : "onioning.com", title : "onioning'de", image : "http://i.imgur.com/dqZ2c.png"},
            {name : "sözlükçülerin about.me sayfaları", regex : "about.me", title : "about.me'de", image : "http://i.imgur.com/XmFVV.png"},
            {name : "sözlükçülerin elestirbeni.com sayfaları", regex : "elestirbeni.com", title : "elestirbeni.com'da", image : "http://i.imgur.com/tC2dX.png"},
            {name : "sözlükçülerin flickr sayfaları", regex : "flickr.com", title : "flickr'da", image : "http://i.imgur.com/aoMyC.png"},
            {name : "sözlükçülerin youtube sayfaları", regex : "youtube.com", title : "youtube'da", image : "http://i.imgur.com/PkA3U.png"},
            {name : "sözlükçülerin 8tracks sayfaları", regex : "8tracks.com", title : "8tracks'te", image : "http://i.imgur.com/Mi658.png"},
            {name : "sözlükçülerin fotokritik sayfaları", regex : "fotokritik.com", title : "fotokritik'te", image : "http://i.imgur.com/oVsTm.png"},
            {name : "sözlükçülerin criticker sayfaları", regex : "criticker.com", title : "criticker'da", image : "http://i.imgur.com/DrnXE.png"},
            {name : "sözlükçülerin github sayfaları", regex : "github.com", title : "github'da", image : "http://i.imgur.com/BARoU.png"}
        ],
    ...
    var System = {
        ...
        hazirTemaListesi : {
            ...
            'beslenir ki bu (nihavent uvertur)' : 'http://antik.eksisozluk.com/css/bkb.css',
            'cok pis (carmilla)' : 'http://antik.eksisozluk.com/css/cokpis.css',
            'her zamanki enhanced (rotten)' : 'http://antik.eksisozluk.com/css/he.css',
            'absolut (soulforge)' : 'http://antik.eksisozluk.com/css/absolut.css',
            'obsessed with blue (clairvoyant)' : 'http://antik.eksisozluk.com/css/cressidablue.css',
            'diet coke (clairvoyant)' : 'http://antik.eksisozluk.com/css/dietcoke.css',
            'yesil limon eksiliginde sozluk (carmilla)' : 'http://antik.eksisozluk.com/css/yles.css',
            'ssg\'nin rengi (clairvoyant)' : 'http://antik.eksisozluk.com/css/ssg.css',
            'yigit ozgur de mi (pipican ve kukucan)' : 'http://antik.eksisozluk.com/css/yigitozgurdemi.css',
            'gece goru$u (carsamba)' : 'http://antik.eksisozluk.com/css/geceGorusu.css',
            'askimizin meyvesi (misuf)' : 'http://antik.eksisozluk.com/css/aytek.css',
            'kamuflaj for plazas (malezya plantasyon tiki)' : 'http://antik.eksisozluk.com/css/kfpcss.css',
            'enee (ssl)' : 'http://antik.eksisozluk.com/css/enee.css',
            'her zamanki enhanced purple (rotten)' : 'http://antik.eksisozluk.com/css/he_p.css',
            'requiem 4 a dream (muzbaligi)' : 'http://antik.eksisozluk.com/css/muz.css',
            'not enough coffee in (rotten)' : 'http://antik.eksisozluk.com/css/nth.css',
            'ek$i simpsons (clairvoyant)' : 'http://antik.eksisozluk.com/css/simpsons.css',
            'her zamanki enhanced blue (rotten)' : 'http://antik.eksisozluk.com/css/he_blue.css',
            'eksilicious (rotten)' : 'http://antik.eksisozluk.com/css/eksilicious.css',
            'minima black (hopi)' : 'http://antik.eksisozluk.com/css/minimablack.css',
            'yaz gune$i (muzbaligi)' : 'http://antik.eksisozluk.com/css/turunc.css',
            'mac osman x (can sebahattin dere & eleanor rigby)' : 'http://antik.eksisozluk.com/css/osman.css',
            'jack daniels (soulforge)' : 'http://antik.eksisozluk.com/css/jack_daniels.css',
            'ek$i tefter (saparatus)' : 'http://antik.eksisozluk.com/css/tefter.css',
            'firat (efsane yazar)' : 'http://antik.eksisozluk.com/css/firat.css',
            'her zamanki enhanced black (rotten)' : 'http://antik.eksisozluk.com/css/he_k.css',
            'cok pis bloody edition (carmilla)' : 'http://antik.eksisozluk.com/css/cokpisbloody.css',
            'sozluk-u ali osmani (bloodorbloom)' : 'http://antik.eksisozluk.com/css/sao.css',
            'lite ek$imel (melyche)' : 'http://antik.eksisozluk.com/css/liteeksimel.css',
            'fenerbahce (sivil)' : 'http://antik.eksisozluk.com/css/fenerbahce.css',
            'powered by intel (rotten)' : 'http://antik.eksisozluk.com/css/intel.css',
            'her zamanki enhanced pink (rotten)' : 'http://antik.eksisozluk.com/css/he_pink.css',
            'darkhead (byron)' : 'http://antik.eksisozluk.com/css/t_darkhead_b.css',
            'kamuflaj for plazas v2 (ocanal)' : 'http://antik.eksisozluk.com/css/kfpv2.css',
            '1601 snoopy lovers (poison)' : 'http://antik.eksisozluk.com/css/1601.css',
            'bize eksi de trabzon (oziloz)' : 'http://antik.eksisozluk.com/css/bedt.css',
            'southpark v3 (assert h)' : 'http://antik.eksisozluk.com/css/spv3.css',
        },
    ...
    var shortUrlPattern = new RegExp(
            ...
            "xurl\\.jp|y\\.ahoo\\.it|yatuc\\.com|ye\\.pe|yep\\.it|yhoo\\.it|yiyd\\.com|yuarel\\.com|z0p\\.de|zi\\.ma|"+
...
//--// FONKSIYONLAR, ISLEMLER, EMEKCILER //-//
    ...
    function sosyalAgDropDownListesi() {
        var list = "";
        for (var sosyalAg in Ayarlar.sosyalAgListesi) {
            list += "<option value='"+escape(Ayarlar.sosyalAgListesi[sosyalAg].name)+"'>"+Ayarlar.sosyalAgListesi[sosyalAg].name+"</option>";
        }
        return list;
    }
    ...
    function sosyalAgEkle(yeniSosyalAgName, yeniSosyalAgIkon) {
        tumAyarlariYukle();
        for (var i = 0; i < Ayarlar.sosyalAgListesi.length; i++) {
            if (Ayarlar.sosyalAgListesi[i].name == yeniSosyalAgName) {
                return false; // Var zaten listede...
            }
        }
        Ayarlar.sosyalAgListesi.push({name : yeniSosyalAgName, regex : "http", title : yeniSosyalAgName, image : yeniSosyalAgIkon});
        tumAyarlariKaydet();
        if (debug) EppAPI_log("Baslik '" + yeniSosyalAgName + "' sosyal ag listesine eklendi!");
        return true;
    }

    function sosyalAgSil(eskiSosyalAg) {
        tumAyarlariYukle();
        var yeniSosyalAgListesi = new Array();
        var j = 0;
        for (var i = 0; i < Ayarlar.sosyalAgListesi.length; i++) {
            if (Ayarlar.sosyalAgListesi[i].name != eskiSosyalAg) {
                yeniSosyalAgListesi[j++] = Ayarlar.sosyalAgListesi[i];
            }
        }
        Ayarlar.sosyalAgListesi = yeniSosyalAgListesi;
        tumAyarlariKaydet();
        
        if (debug) EppAPI_log("Baslik '" + eskiSosyalAg + "' sosyal ag listesinden cikarildi!");

        return yeniSosyalAgListesi;
    }
    ...
    function ayarMenusunuGoster() {
        ...
        "</fieldset><br/><div id='epp_messageBox6' style='text-align:center;' tabindex='-1'>&nbsp;</div>"+
        "<fieldset style='padding-left:1em;'>"+
            "<legend><b>| EksiFavori |</b></legend>"+
            "<br/>"+
            "<input id='epp_eksiFavoriCB' type='checkbox'> <b>EksiFavori</b>'yi kullan (entry'leri favorilere ekleme ozelligi getirir)<br/><br/>"+
            "<textarea id='epp_favoriImportExportTA' rows='5' cols='50' style='display:none;'></textarea>"+
            "EksiFavori listesi <b>aktarim</b> islemleri: <button class='but' id='epp_favoriExportBut'>ihrac et</button>&nbsp;<button class='but' id='epp_favoriImportBut'>ithal et</button>&nbsp;<button class='but' id='epp_favoriRemoveAllBut'>bosalt</button><br/><br/>"+
        "</fieldset><br/><div id='epp_messageBox7' style='text-align:center;' tabindex='-1'>&nbsp;</div>"+
        "<fieldset style='padding-left:1em;'>"+
            "<legend><b>| Kimdir Nedir++ |</b></legend>"+
            "<br/>"+
            "<input id='epp_kimdirNedirPlusPlusCB' type='checkbox'> <b>Kimdir Nedir++</b>'i kullan (gelistirilmis kimdir nedir sayfasi)<br/><br/>"+
            "Yeni bir sosyal ag eklemek icin:<br/>"+
            "Kontrol edilecek <b>baslik</b> <input id='epp_sosyalAgEkleBaslik' type='text' style='min-width: 20em;'> Ikon linki (50x50) <input id='epp_sosyalAgEkleIkon' type='text' style='min-width: 20em;'>  <button class='but' id='epp_sosyalAgEkleBut'>Ekle</button><br/><br/>"+
            "Sosyal ag <b>sil</b> <select id='epp_sosyalAgSilDD' style='min-width: 20em;'>"+sosyalAgDropDownListesi()+"</select> <button class='but' id='epp_sosyalAgSilBut'>Sil</button><br/><br/>"+
        "</fieldset><div id='epp_messageBox4' style='text-align:center;' tabindex='-1'>&nbsp;</div>"+
        "<fieldset style='padding-left:1em;'>"+
            ...
            "<input id='epp_miniKimdirNedirCB' type='checkbox'> <b>Mini kimdir nedir</b> ozelligini kullan (Entry altlarindaki yazar nick'lerine tiklandiginda mini kimdir nedir penceresi gosterir) "+"<b style='color:red'>Yeni!</b>"+"<br/><br/>"+
        ...
        var favoriImportBut = idGet("epp_favoriImportBut");
        var favoriExportBut = idGet("epp_favoriExportBut");
        var favoriRemoveAllBut = idGet("epp_favoriRemoveAllBut");
        var sosyalAgEkleBut = idGet("epp_sosyalAgEkleBut");
        var sosyalAgEkleBaslik = idGet("epp_sosyalAgEkleBaslik");
        var sosyalAgEkleIkon = idGet("epp_sosyalAgEkleIkon");
        var sosyalAgSilDD = idGet("epp_sosyalAgSilDD");
        var sosyalAgSilBut = idGet("epp_sosyalAgSilBut");
        ...
        var miniKimdirNedirCB = idGet("epp_miniKimdirNedirCB");
        ...
        var kimdirNedirPlusPlusCB = idGet("epp_kimdirNedirPlusPlusCB");
        ...
        miniKimdirNedirCB.checked = Ayarlar.miniKimdirNedir;
        ...
        kimdirNedirPlusPlusCB.checked = Ayarlar.kimdirNedirPlusPlus;
        ...
        favoriImportBut.addEventListener("click", function(){
            var dataTA = idGet("epp_favoriImportExportTA");
            if (dataTA.style.display == "none") {
                //Once kutuyu acalim...
                dataTA.style.display = "";
                alert("Lutfen daha onceden ihrac ederek kaydetmis oldugunuz listeyi acilan alana yapistirip, bir kere daha 'ithal' tusuna basin");
                ...
                try {
                    EppAPI_log("Ithal edilecek veri: " + dataTA.value);
                    var list = JSON.parse(dataTA.value);
                    var toplamEntry = 0;
                    for (var i = 0;i < list.length;i++) {
                        if (addToFavourites(list[i].title,list[i].entryid))
                            toplamEntry++;
                    }
                    ayarMenusuDerki("<b>"+toplamEntry+"</b> tane entry favorilere <b>eklendi</b>!", 6);
                } catch(e) {
                    alert("Ithalat basarisiz oldu. Listede bir gariplik olmasin?");
                }
            }
        ...
        favoriExportBut.addEventListener("click", function(){
            var dataTA = idGet("epp_favoriImportExportTA");
            dataTA.style.display = "";
            dataTA.value = JSON.stringify(Ayarlar.favoriEntryListesi);
            alert("Favori listenizi ihrac etmek icin acilan kutudaki verinin tamamini aynen kopyalayin ve kaydedin");
        }, true);
        
        favoriRemoveAllBut.addEventListener("click", function(){
            if (confirm("Favori entry listeniz tamamen silinecek, emin misiniz?")) {
                removeAllFromFavourites();
                ayarMenusuDerki("Tum favori entry'leriniz <b>silindi</b>!", 6);
            }
        }, true);

        sosyalAgEkleBut.addEventListener("click", function(){ 
            tumAyarlariYukle();
            sosyalAgEkle(sosyalAgEkleBaslik.value, sosyalAgEkleIkon.value);
            ayarMenusuDerki("<b>"+sosyalAgEkleBaslik.value+"</b> sosyal ag listesine <b>eklendi</b>!", 7);
            sosyalAgEkleBaslik.value = '';
            sosyalAgEkleIkon.value = '';
            sosyalAgSilDD.innerHTML = sosyalAgDropDownListesi();
        }, true);

        sosyalAgSilBut.addEventListener("click", function(){ 
            tumAyarlariYukle();
            if (sosyalAgSilDD.value) {
                sosyalAgSil(unescape(sosyalAgSilDD.value));
                ayarMenusuDerki("<b>"+unescape(sosyalAgSilDD.value)+"</b> sosyal ag listesinden <b>cikarildi</b>!", 7);
                sosyalAgSilDD.innerHTML = sosyalAgDropDownListesi();
            } else {
                alert("Hangi baslik?");
            }
        ...
        eksiFavoriCB.addEventListener("change", function(){ 
            ...
            tumAyarlariKaydet();
            ayarMenusuDerki((this.checked?"<b>EksiFavori ozelligi aktif</b>":"<b>EksiFavori ozelligi kapatildi</b>"), 6);
        }, true);
        
        kimdirNedirPlusPlusCB.addEventListener("change", function(){ 
            tumAyarlariYukle();
            Ayarlar.kimdirNedirPlusPlus = this.checked;
            tumAyarlariKaydet();
            ayarMenusuDerki((this.checked?"<b>Kimdir Nedir++ ozelligi aktif</b>":"<b>Kimdir Nedir++ ozelligi kapatildi</b>"), 7);
        }, true);
        ...
        */
        ...
        miniKimdirNedirCB.addEventListener("change", function(){ 
            tumAyarlariYukle();
            Ayarlar.miniKimdirNedir = this.checked;
            tumAyarlariKaydet();
            ayarMenusuDerki("'Mini kimdir nedir penceresi' ozelligi<b>"+(this.checked?"akfit":"devre disi")+"</b>!", 4);
        }, true);
    ...
    function youtubeGomucu(link) {
        if (link.getAttribute("epp_status") == "youtube_open") {
            ...
            var videoId = ((link.href.match(/v=([^#&]+)/)) || (link.href.match(/\/([^\/#&]+)$/)))[1];
            videoId += "?fs=1";
    ...
    function gomulebilirLinkDuzenle() {
        ...
        for (var i=0; i<linkler.snapshotLength; i++) {
            ...
            if(Ayarlar.youtubeGomme && link.href.match(/(youtube\.com\/.*v=)|(youtu\.be\/)/)) {
                link.setAttribute("epp_status","youtube_closed");
    ...
    function entryGomucu(entryLinki) {
        if (!entryLinki.getAttribute("entryGomulu")) {
            ...
            entryBoxWrap.style.zIndex = ++lastGomuluZindex;
            ...
            if (entryHTML) {
                ...
                if (Ayarlar.eksiFavori) {
                    var menuRow = xpath(".//ol/li/table/tbody/tr", entryBox).snapshotItem(0);
                    var entryID = xpath(".//td[@class='ei']", entryBox).snapshotItem(0).id.replace(/\D/g,'');
                    var entryBaslik = xpath(".//h2[@class='title']/a", entryBox).snapshotItem(0).innerHTML;
                    
                    var containerTd = newElem("td");
                    var favoributton = yeniEksiTusu("a","eksifavori_"+entryID);
                    favoributton.style.paddingLeft = "2px";
                    favoributton.style.paddingRight = "2px";
                    if (!isInFavouriteList(entryID)) {
                    ...
                    }})(entryBaslik,entryID),true);
                    
                    containerTd.appendChild(favoributton);
                    menuRow.appendChild(containerTd);
                }
            } else {
            ...
            entryLinki.nextSibling.style.zIndex = ++lastGomuluZindex;
    ...
    function kimdirNedirGetir(yazarUrl, yazarNick) {
        var req =  new XMLHttpRequest();
        var resultDiv = newElem("div");
        req.open("GET", yazarUrl, false);
        req.send(null);
        var tempDom = newElem("div");
        var sosyalAgDiv = newElem("div");
        tempDom.innerHTML = req.responseText;
        var karma = xpath(".//div/span", tempDom).snapshotItem(0);
        var genelIstatistik = xpath(".//span[@class='msg']", tempDom).snapshotItem(0);
        var sonEntry = xpath(".//div[@id='inf_le']/table/tbody/tr/td[2]/a", tempDom).snapshotItem(0);
        var sonOylanan = xpath(".//div[@id='inf_lvtd']/table/tbody/tr/td[2]/a", tempDom).snapshotItem(0);
        var dikkatCeken = xpath(".//div[@id='inf_lwbo']/table/tbody/tr/td[2]/a", tempDom).snapshotItem(0);
        var enBegenilen = xpath(".//div[@id='inf_bof']/table/tbody/tr/td[2]/a", tempDom).snapshotItem(0);
        var basucu = xpath(".//div[@id='inf_bt']/table/tbody/tr/td[2]/a", tempDom).snapshotItem(0);
        var zamanininOtesinde = xpath(".//div[@id='inf_wof']/table/tbody/tr/td[2]/a", tempDom).snapshotItem(0);
        resultDiv.appendChild(sosyalAgDiv);

        if (karma) {
            resultDiv.appendChild(karma);
            resultDiv.appendChild(newElem("br"));
        }
        if (genelIstatistik) {
            resultDiv.appendChild(genelIstatistik);
            resultDiv.appendChild(newElem("br"));
            resultDiv.appendChild(newElem("br"));
        }
        if (sonEntry) {
            resultDiv.innerHTML += "son entry'si : ";
            resultDiv.appendChild(sonEntry);
            resultDiv.appendChild(newElem("br"));
        }
        if (sonOylanan) {
            resultDiv.innerHTML += "son oylanan entry'si : ";
            resultDiv.appendChild(sonOylanan);
            resultDiv.appendChild(newElem("br"));
        }
        if (dikkatCeken) {
            resultDiv.innerHTML += "en dikkat ceken entry'si : ";
            resultDiv.appendChild(dikkatCeken);
            resultDiv.appendChild(newElem("br"));
        }
        if (enBegenilen) {
            resultDiv.innerHTML += "en begenilen entry'si : ";
            resultDiv.appendChild(enBegenilen);
            resultDiv.appendChild(newElem("br"));
        }
        if (basucu) {
            resultDiv.innerHTML += "basucu eseri : ";
            resultDiv.appendChild(basucu);
            resultDiv.appendChild(newElem("br"));
        }
        if (zamanininOtesinde) {
            resultDiv.innerHTML += "zamaninin en otesindeki entry'si : ";
            resultDiv.appendChild(zamanininOtesinde);
            resultDiv.appendChild(newElem("br"));
        }
    ...
    function miniKimdirNedirGomucu(yazarLinki) {
        if (!yazarLinki.getAttribute("miniKimdirNedirGomulu")) {
            var yazarUrl = yazarLinki.href;
            yazarUrl = yazarUrl.replace("sozluk.sourtimes.org","antik.eksisozluk.com"); //Domain degisikligi onlemi
            yazarUrl = yazarUrl.replace("info.asp","info2.asp");
            var kimdirNedirBox = document.createElement("div");
            var kimdirNedirBoxWrap = document.createElement("div");
            var kapatTusu = yeniEksiTusu("input");
            var dahadaTusu = newElem("a");
            var loadingImg = newElem("img");
            
            kimdirNedirBoxWrap.style.zIndex = ++lastGomuluZindex;
            kimdirNedirBoxWrap.style.maxWidth = (window.innerWidth-100)+"px";
            kimdirNedirBoxWrap.style.padding = "6px";
            kimdirNedirBoxWrap.style.marginRight = "130px";
            kimdirNedirBoxWrap.style.right = "0px";
            kimdirNedirBoxWrap.style.backgroundColor = "rgb(0,0,0)"; //fallback
            kimdirNedirBoxWrap.style.backgroundColor = "rgba(0,0,0,.5)";
            kimdirNedirBoxWrap.style.position = "absolute";
            
            kimdirNedirBox.position = "relative";
            kimdirNedirBox.style.padding = "1em";
            kimdirNedirBox.style.paddingBottom = "3em";
            kimdirNedirBox.style.minWidth = "35em";
            kimdirNedirBox.style.textAlign = "left";
            kimdirNedirBox.style.lineHeight = "140%";
            kimdirNedirBox.style.backgroundColor = window.getComputedStyle(document.body, null).getPropertyValue("background-color");
            kimdirNedirBox.style.backgroundImage = window.getComputedStyle(document.body, null).getPropertyValue("background-image");
            kimdirNedirBox.style.border = "1px solid rgb(255,255,255)"; //fallback
            kimdirNedirBox.style.border = "1px solid rgba(255,255,255,0.5)";
            kimdirNedirBox.innerHTML = "<b>Eksi++</b> Bir seyler geliyor... ";
            ...
            kapatTusu.addEventListener("click", function(){  
                this.parentNode.parentNode.style.display = "none";
                this.parentNode.parentNode.previousSibling.setAttribute("miniKimdirNedirGomulu", 2);
            }, true);

            dahadaTusu.innerHTML = "daha da »";
            dahadaTusu.href = yazarLinki.href;
            dahadaTusu.style.cssFloat = "left";
            dahadaTusu.style.marginTop = "1em";

            loadingImg.style.cssFloat = "right";
            loadingImg.style.position = "relative";
            loadingImg.style.top = "10px";
            loadingImg.src = "http://i.imgur.com/oInr7.gif";
            
            kimdirNedirBoxWrap.appendChild(kimdirNedirBox);
            yazarLinki.parentNode.insertBefore(kimdirNedirBoxWrap, yazarLinki.nextSibling);
            
            var yazarHTML = kimdirNedirGetir(yazarUrl, yazarLinki.innerHTML);
            if (yazarHTML) {
                kimdirNedirBox.innerHTML = yazarHTML;
            } else {
                kimdirNedirBox.innerHTML = "<b>Eksi++</b> Bir sorun var gibi, bilemedim!";
            }
            
            function sosyalAgButonuEkle(url, sosyalAg) {
                var tempbut = document.createElement('a');
                tempbut.innerHTML = "<img height='20px' width='20px' src='"+sosyalAg.image+"' />";
                tempbut.style.padding = "3px";
                tempbut.style.cssFloat = "right";
                tempbut.target = "_blank";
                tempbut.title = sosyalAg.title;
                tempbut.href = url;
                kimdirNedirBox.appendChild(tempbut);
            }

            function sosyalAgRemoveLoadingImage() {
                if (loadingImg)
                    loadingImg.parentNode.removeChild(loadingImg);
            }

            kimdirNedirBox.appendChild(loadingImg);
            sosyalAglariBul(yazarLinki.innerHTML, sosyalAgButonuEkle, sosyalAgRemoveLoadingImage);

            kimdirNedirBox.appendChild(kapatTusu);
            kimdirNedirBox.appendChild(dahadaTusu);
            
            yazarLinki.setAttribute("miniKimdirNedirGomulu", 1);
            
            // Gomulu uzun kimdir nedir pencelerelerinin gorunmesi engellenemez!
            var divTopic = idGet("topic");
            if (divTopic) {
                divTopic.style.overflow = "visible";
            }
        } else if (yazarLinki.getAttribute("miniKimdirNedirGomulu") == 2) {
            yazarLinki.nextSibling.style.zIndex = ++lastGomuluZindex;
            yazarLinki.nextSibling.style.display = "";
            yazarLinki.setAttribute("miniKimdirNedirGomulu", 1);
        } else {
            yazarLinki.nextSibling.style.display = "none";
            yazarLinki.setAttribute("miniKimdirNedirGomulu", 2);
        }
    }
    ...
    function gomulebilirEntryleriDuzenle() {
        ...
        for (var i=0; i<length; i++) {
            ...
            if (link.className.match(/(gb|id|b)/) && link.innerHTML.match(/(#|\/)\d+$/)) {
                ...
                link.setAttribute("epp_processed", "true");
            } else if (link.className.match(/(gb|b)/) && link.innerHTML.length < 41) { 
                //en fazla 40 karakterlik bir bkz ise alt+click ile kimdir nedir sayfasina gidilebilsin 
                link.addEventListener("click", (function(pLink) { return function(e){ 
                    if (e.altKey) { 
                        document.location.href = "/info2.asp?n="+encodeURIComponent(pLink.innerHTML);
                        e.preventDefault();  
                        return false;
                    }
                }; })(link), true);
    ...
    /* Kimdir Nedir++ Fonksiyonlari */
    function sosyalAglariBul(nick, callbackButonEkle, callbackOnReady) {
        for (var j = 0; j < Ayarlar.sosyalAgListesi.length; j++) {
            var req =  new XMLHttpRequest();
            var result = "";
            var requrl = "http://antik.eksisozluk.com/show.asp?t="+encodeURIComponent(Ayarlar.sosyalAgListesi[j].name)+"&kw=%40"+nick;
            req.open("GET", requrl, true);
            req.onreadystatechange = function (j) {
                return function() {
                    if (this.readyState == 4) {

                        if (callbackOnReady && (j+1) == Ayarlar.sosyalAgListesi.length) 
                            callbackOnReady();

                        if (this.status == 200) {
                            var tempDom = document.createElement("div");
                            tempDom.innerHTML = this.responseText;
                            if (!tempDom.getElementsByTagName("ol").length) {
                                return;
                            }
                            var entryler = tempDom.getElementsByTagName("li");
                            ...
                            if (entryler.length > 0) {
                                for (var i = 0; i < entryler.length; i++) {
                                    ...
                                    var filterbyurl = xpath(".//a[contains(@href,'"+Ayarlar.sosyalAgListesi[j].regex+"') and @class='url']", entryler[i]);
                                    if (filterbyurl.snapshotLength > 0) { //bu entry'de link var mı, varsa geri gönder
                                        callbackButonEkle(filterbyurl.snapshotItem(0).href, Ayarlar.sosyalAgListesi[j]);
                                        return;
                                    }
                                }
                            }    
    ...
    function AyarMerkeziEngine() {
        ...
        function mesajlariDuzenle() {
            ...
            var opencloseallBtn = newElem("a");
            opencloseallBtn.innerHTML = "hepsini goster";
            opencloseallBtn.style.cssFloat = "right";
            opencloseallBtn.style.marginRight = "5px";
            opencloseallBtn.style.fontWeight = "bold";
            opencloseallBtn.style.cursor = "pointer";
            opencloseallBtn.title = "tum mesaj gruplarini goster/gizle";
            opencloseallBtn.setAttribute("epp_collapseStatus", 0);
            opencloseallBtn.addEventListener("click", function(e){ 
                var colStatus = this.getAttribute("epp_collapseStatus");
                this.value = "hepsini " + ((colStatus == 0)?"gizle":"goster");
                this.setAttribute("epp_collapseStatus", (parseInt(colStatus)+1)%2);
                var groupHeads = xpath("//li[@epp_headofthread]");
                for (var i = 0; i < groupHeads.snapshotLength; i++) {
                    var head = groupHeads.snapshotItem(i);
                    head.setAttribute("epp_collapseStatus", (parseInt(colStatus)+1)%2);
                }
                var allMsgList = xpath("//li[@epp_msgthread]");
                for (var i = 0; i < allMsgList.snapshotLength; i++) {
                    var msg = allMsgList.snapshotItem(i);
                    if (msg.getAttribute("epp_unread")) //Sadece mesajlar, 'yeni mesaj' kutusu degil
                        msg.style.display = (colStatus == 0)?"":"none";
                }
            }, false);
            topluIslemKutusu.appendChild(opencloseallBtn);
    ...
    function UstFrameEngine() {
        ...
        function favoriButonuEkle() {
            if (!Ayarlar.eksiFavori)
               return;
               
            /* eksifavori "f" butonu */
            var fbutton = yeniEksiTusu("td");
            fbutton.setAttribute("onclick","top.sozindex.location.href='index.asp?a=sr&so=y&kw=*'");
    ...
    function SolFrameEngine() {        
        ...
        function basliklariDuzenle() {
            ...
            if (!window.location.href.match(/(stats\.asp|\?a=fl|\?a=fv)/)) {
                regexFiltrele();
                donuzFiltrele();
        ...
        function favoriListesiniOlustur() {
            if (!window.location.href.match(/\/index\.asp\?a=sr&so=y&kw=\*$/) || !Ayarlar.eksiFavori)
                return;
                
            var bodyel = xpath("//body").snapshotItem(0);
            var eksiFavoriListDiv = newElem('div');
            eksiFavoriListDiv.id = "eksifavorilistdiv";
            
            bodyel.innerHTML = "";
            bodyel.className = "bgleft";
            bodyel.appendChild(eksiFavoriListDiv);
            favoriListesiniDoldur(0);
        }
        
        function favoriListesiniDoldur(p) {
            tumAyarlariYukle();
            var maxEntry = 50;
            var eksiFavoriListDiv = idGet('eksifavorilistdiv');
            ...
            if (maxp > 1) {
                ...
                thispage.id = "eksifavori_" + "thispage";
    ...
    //--// Sol Frame Engine - GIRIS //--//
        this.basla = function () {
            ...
            try { favoriListesiniOlustur(); } catch (err) { EppAPI_log("HATA: 'favoriListesiniOlustur()' patladi! >> " + err); }
        }
    }
    ...
    function SagFrameEngine() {
        ...
        var eksiFavorilastIndex = Ayarlar.favoriEntryListesi.length-1;
        ...
        function kimdirNedirTusuDuzenle(pGirdi) {
            if (!Ayarlar.miniKimdirNedir)
               return;

            var yazarTusu = xpath(".//div[@class='aul']/a", pGirdi).snapshotItem(0);
            yazarTusu.addEventListener("click", function(e) {
                if (!e.ctrlKey && e.which != 2) {
                    miniKimdirNedirGomucu(this);
                    e.preventDefault();
                    return false;  
                }
            }, true);
        ...
        function girdileriDuzenle() {
            ...
            for (var i = 0; i < girdiler.snapshotLength; i++) {
                ...
                if (!donuzGirdisiFiltrele(girdi, yazar)) {
                    ...
                    favoriTusuEkle(girdi);
                    kimdirNedirTusuDuzenle(girdi);
        ...
        function pencereBasligiDuzenle() {
            ...
            if (topDocument.title.indexOf(baslikFull)) { 
                if (debug) EppAPI_log("Sekme basligi yamuk!");
                topDocument.title = baslikFull + " - ekşi sözlük";
                if (debug) EppAPI_log("Sekme basligi duzeltildi: " + topDocument.title);
        ...
        function basligiSabitle() {
            ...
            sabitBaslik = baslik;
            var usttenBosluk = parseInt(baslik.offsetHeight);
        ...
        function entryOnizleme() {
          ...
          if(box) {
            box.addEventListener("keyup", function() {
              ...
              entryText = entryText.replace(/\[(\b(https?|ftp|file):\/\/[-A-Z0-9+&@#\/%?=~_|!:,.;]*[-A-Z0-9+&@#\/%=~_|]) (.{1,100}?)\]/ig, "<a class=\"url\" target=\"_blank\" href=\"$1\">$3</a>"); //[url word]
        ...
        function yeniEntryDuzenle(gomEntryLi) {
            ...
            newLi.addEventListener("mouseover", function(){
                ...
                var shareLinks = xpath(".//div[@class='entrymenu']/span/a",this);
        ...
        function nickBasligiKontrolu() {
            ...
            var kimdirNedirTusu = newElem("a");
            kimdirNedirTusu.style.paddingLeft = "4px";
            kimdirNedirTusu.innerHTML = '<img src="http://i.imgur.com/qQZcW.png">';
            kimdirNedirTusu.href = kimdirNedirPopupHref;
            baslik.appendChild(kimdirNedirTusu);
        }
        
        function baslikLinkiKopyalamaTusuEkle() {
            var baslik = xpath("//h1[@class='title']").snapshotItem(0);
            var baslikText = xpath(".//a",baslik).snapshotItem(0).innerHTML;
            var kopyalamatusu = newElem("a");
            kopyalamatusu.style.display = "none";
            kopyalamatusu.style.cursor = "pointer";
            kopyalamatusu.style.paddingLeft = "4px";
            kopyalamatusu.innerHTML = '<img src="http://i.imgur.com/Owpqo.png">';
            kopyalamatusu.addEventListener("click", function() {
                prompt('"'+baslikText+'" basliginin adresi', 'http://antik.eksisozluk.com/show.asp?t='+encodeURIComponent(baslikText));
            });
            
            baslik.appendChild(kopyalamatusu);
            baslik.addEventListener("mouseover", (function(tus) { return function() {
                tus.style.display = "";
            }})(kopyalamatusu),true);
            
            baslik.addEventListener("mouseout", (function(tus) { return function() {
        ...
        function ucanKontrolPaneli() {
            ...
            document.addEventListener("keydown", function(e){
                if (e.ctrlKey && e.shiftKey) {
                    ...
                    var gomuluEntryler = xpath("//a[@entrygomulu='1']");
                    for (var i = 0; i < gomuluEntryler.snapshotLength; i++) {
                        var gomuluEntry = gomuluEntryler.snapshotItem(i);
                        gomuluEntry.setAttribute("entrygomulu", 2);
                        gomuluEntry.nextSibling.style.display = "none";
                    }
                }
            }, true);
        ...
        function arayuzElemanlariniEkle() {
            ...
            //Bugun tusu
            if (!document.URL.match(/&a=td/)) {
                var bugunun = yeniEksiTusu("input");
                bugunun.value = "bugun girilenler";
                bugunun.addEventListener("click", function() {
                    window.location = "http://antik.eksisozluk.com/show.asp?t="+encodeURIComponent(baslikFull)+"&a=td";
                });
                bugunun.style.marginLeft = "1em";
                ucanKontrolPaneliContent.appendChild(bugunun);
            }
        ...
        /* EksiFavori sag frame */
        
        function favoriTusuEkle(pGirdi, pBaslik) {
            if (!Ayarlar.eksiFavori)
               return;
            ...
            var entryID = pGirdi.id.replace(/\D/g,'');
            var hidden_ul = xpath(".//div[@class='entrymenu']/ul",pGirdi).snapshotItem(0);
        ...
        function eksiFavoriEntryleriniListele() {
            if (!window.location.href.match(/show.asp\?t=__eksifavori_listesi__$/) || !Ayarlar.eksiFavori)
                return;
            ...
            if (eksiFavorilastIndex > 10)
                var entrylimiter = eksiFavorilastIndex - 10;
            else 
                var entrylimiter = 0;  
            for (var i = eksiFavorilastIndex; i >= entrylimiter ;i--) {
    ...
    //--// Sag Frame Engine - GIRIS //--//
        this.basla = function() {
            ...
            try { baslikLinkiKopyalamaTusuEkle(); } catch (err) { EppAPI_log("HATA: 'baslikLinkiKopyalamaTusuEkle()' patladi! >> " + err); }
            ...
            try { eksiFavoriEntryleriniListele(); } catch (err) { EppAPI_log("HATA: 'eksiFavoriEntryleriniListele()' patladi! >> " + err); }
        }
    }
    ...
    function KimdirNedirEngine() {
        ...
        var nick_as = xpath("//h1[@class='title']/a").snapshotItem(0).innerHTML;
        ...
        function eksiStatsVerileriniEkle() {
            EppAPI_JSONRequest({
                url: "http://www.eksistats.com/api.php?id=author&nick="+encodeURIComponent(nick_as),
                method: "GET",
                data: "",
                onload: function(json) {
                    try {
                        var statsList = "";
                        for (var i = 0; i < json.statlist.length; i++) {
                            if (json.statlist[i].statu == "1") {
                                statsList += ''+
                                '<tr>'+
                                  '<td><a href="stats.asp?id=eksistats-'+json.statlist[i].statsid+'" target="sozmain">'+json.statlist[i].statsname+'</a></td>'+
                                  '<td style="text-align:right">'+json.statlist[i].ordnumber+'.</td>'+
                                '</tr>';
                            }
                        }
                        if (statsList != "") {
                            var statsTab = xpath("//div[@id='inf_auh']/table/tbody").snapshotItem(0);
                            if (statsTab) {
                                statsTab.innerHTML += statsList;
                            } else {
                                var container = idGet("ipleft");
                                var statsHTML = ''+
                                '<div class="infopane">'+
                                  '<div class="highlight infopanehdr" onclick="return sc(\'inf_auh\')">&nbsp;istatistik kategorileri&nbsp;</div>'+
                                  '<div class="infocontent" style="display:block" id="inf_auh">'+
                                    '<table class="msg"><tbody><tr><th>kategori</th><th>sıra</th></tr>'+statsList+'</tbody></table>'+
                                  '</div>'+
                                '</div>';
        ...
        function kimdirNedirPlusPlusBasla() {
            if (!Ayarlar.kimdirNedirPlusPlus) return;
            
            var elemipleft = document.getElementById('ipright');
            var sosyal_knpp_div_display = (/*sosyalData.sosyalStatus*/false) ? "block" : "none";
            
            var menuhtml = "<div class='infopane'>"+
                              "<div class='highlight infopanehdr' id='sosyal_knpp' onclick=\"return sc('sosyal_knpp_div')\">&nbsp;sosyal paylaşım bağlantıları &nbsp;</div>"+
                              "<div class='infocontent' style='display:"+sosyal_knpp_div_display+"' id='sosyal_knpp_div'></div>"+
                           "</div>";
            
            elemipleft.innerHTML = menuhtml + elemipleft.innerHTML;
                           
            var sosyal_knppBt = idGet('sosyal_knpp');
            sosyal_knppBt.addEventListener("click", function() {
                if (!sosyal_knpp_status) {
                    sosyalAglariBul(nick_as, sosyalAgButonuEkle, sosyalAgRemoveLoadingImage);
                    var loadingImg = newElem("img");
                    loadingImg.id = "sosyal_knnp_loadingImg";
                    loadingImg.style.paddingLeft = "5px";
                    loadingImg.style.margin = "auto";
                    loadingImg.src = "http://i.imgur.com/oInr7.gif";
                    sosyal_knppBt.appendChild(loadingImg);
        ...
        function sosyalAgButonuEkle(url, sosyalAg) {
            var sosyal_knpp_div = idGet('sosyal_knpp_div');
            var tempbut = document.createElement('a');
            tempbut.innerHTML = "<img height='50px' width='50px' src='"+sosyalAg.image+"' />";
            tempbut.style.padding = "3px";
            tempbut.target = "_blank";
            tempbut.title = sosyalAg.title;
            tempbut.href = url;
        ...
        function sosyalAgRemoveLoadingImage() {
            var loadingImg = idGet("sosyal_knnp_loadingImg");
            if (loadingImg)
                loadingImg.parentNode.removeChild(loadingImg);
        }
    ...
    //--// Kimdir Nedir Engine - GIRIS //--//
        this.basla = function() {
            ...
            try { eksiStatsVerileriniEkle(); } catch (err) { EppAPI_log("HATA: 'eksiStatsVerileriniEkle()' patladi! >> " + err); }
            try { kimdirNedirPlusPlusBasla(); } catch (err) { EppAPI_log("HATA: 'kimdirNedirPlusPlusBasla()' patladi! >> " + err); }
        }    
    }
