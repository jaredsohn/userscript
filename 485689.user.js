...
// @author      Winns & Mef45
// @copyright   27.04.2014, Winns & Mef45
...
// @resource    peka2tv_chat_css https://raw.githubusercontent.com/Mef45/prm_mod/master/peka2tv_chat.css
// ==/UserScript==
(function () {
	...
	/* ====== Functions ====== */
		...
		function getMessageStyle( data ) {
			...
			switch (data.role) {
                ...
                case 'color-red':			style.nick = 'wchat-user-prime'; break;
                case 'userstream-editor':	style.nick = 'wchat-fun-editor'; break;   
