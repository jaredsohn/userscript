...
// @version        0.12
// @license        Creative Commons: Attribution - Share Alike 3.0 (http://creativecommons.org/licenses/by-sa/3.0/en/)
	...
	var grepoFarmer = ( function() {
		...
		var unitQuantity = function() {
			...
			if ($("#attack_type_input").val() == 'farm_attack') {
				...
				if (strength_now + strength_prev >= 100) {
				...
				var total = Math.floor(res / booty);
				var maxU = $this.find("span.black").text();
		...
		var sendUnits_new = function() {
		    ...
		    if (strength_prev + strength_now >= 100) {
			    TownInfo.setAttackType('attack_type_input', 'ask_farm_for_resources');
			}
