// ==UserScript==
// @name          Alliance Online RUS
// @version       0.5
// @description   Скрипт добавляет статусы активности около городов соаловцев и в дипломатии. 
...
// @history       0.5  Добавлено автообновление и исправлена часть кода
// @history       0.4  Исправлена ошибка отображения городов с одинаковыми названиями
...
// @history       0.3  Исправлена ошибка с неправильным отображением на острове и с городами, содержищими '-' в названии
// @history       0.3  Переделана часть кода для использования jquery
// @history       0.2  Добавлен новый вид острова
// @history       0.1  Релиз

// ==/UserScript==

// --ScriptUpdater (added by ika-info.ucoz.ru)--
ScriptUpdater.check(64506, '0.5');
// --/ScriptUpdater--
