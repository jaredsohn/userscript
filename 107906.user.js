// ==UserScript==
// @name		TuentiPack
// @namespace	TuentiPack Team
// @description	Complemento para personalizar Tuenti
...
//ESTILOS PERMANENTES:
//-------------------------------------------------------------------------------------------//
//Imágenes y botones de la cabecera
addStyle(".ico{border: 1px; padding: 0; background-color: transparent;}  #tab_settings{font-weight:bold;} #tab_logout{font-weight:bold;} #header{padding:0 !important;} #subheader{padding:0 !important;}");
...
//Botón para descargar vídeos
addStyle("button.descargarvideo span {-moz-background-clip:border;-moz-background-inline-policy:continuous;-moz-background-origin:Padding;background:transparent url(http://estaticosak1.tuenti.com/layout/web2/images/icons.31266.gif) no-repeat scroll -6px -3324px;width:18px;display:block;margin:0 auto;overflow:hidden;padding:0;position:Static;text-indent:-1000px;width:12px;}button.descargarvideo:hover span{background-position:1px -1525px !important;}");
...
function Menu(){
	if (document.getElementById('divmenu') == null){
		...
		menu.innerHTML += '<div style="position:absolute;"><h3>Patrocinador:<br><a href="http://www.tuentiadictos.es/"><img width="100%" height="100%" src="http://img5.imageshack.us/img5/456/tuentiadictos2mr4.gif"/></a></h3></div>';
		menu.innerHTML += '<br><center><a href="http://tuentipack.com/" target="_blanck"><img class="ico" src="http://img704.imageshack.us/img704/3127/asssg.png" style="border:none;" width="50%"></a><br><br><h1><b>Creado por DJMeu, To_Net, ShiveR, NodSert, DemonDary y ·PAsKU·.</b></h1><br><br><p style="font-size:large;">Si tienes alguna duda, idea, etc. entra en la <b>web oficial: </b><a href=" http://tuentipack.com"> http://tuentipack.com</a></p></center><br>';
		menu.innerHTML += '<form method="post" action="https://www.paypal.com/cgi-bin/webscr" style="text-align: right;"><input type="hidden" value="_s-xclick" name="cmd"/><input type="hidden" value="7684825" name="hosted_button_id"/><input type="image" class="ico" border="0" alt="PayPal. La forma rápida y segura de pagar en Internet." name="submit" src="https://www.paypal.com/es_ES/ES/i/btn/btn_donate_LG.gif"/></form>';
		menu.innerHTML += '<h1>'+scriptname+' <b>v'+version+'</b> --> <a href="https://addons.mozilla.org/es-ES/firefox/addon/14036">Ir a la web de descarga del script</a></h1><hr>';
		...
		menu.innerHTML += 'Ampliar imágenes al pasar el ratón por encima. <b>(BETA)</b><br>';
		...
		menu.innerHTML += 'Mostrar a la izquierda el número de usuarios online usando '+scriptname+'.<br>';
		...
		menu.innerHTML += 'Mostrar reloj integrado<br>';

		menu.innerHTML += '<table><td align="right">';

		menu.innerHTML += '<hr><img src="http://i48.tinypic.com/6f1euq.png" class="ico" width="30%"><br>';
		...
		menu.innerHTML += '<hr><img class="ico" width="30%" src="http://i49.tinypic.com/fw58ig.png"/><br>';
...
function reset(recargar){
	...
	GM_setValue(id+'checkboximagenampliada', true);
...
function menuradio(){
	if (document.getElementById("radio") == null){
		...
		radio.innerHTML += '  Radio "Masia"<br>';
		...
		if (GM_getValue(id+'textradio') == undefined) GM_setValue(id+'textradio',"");
		radio.innerHTML += '<h3> Si la radio no funciona prueba instalando <a href="http://port25.technet.com/videos/downloads/wmpfirefoxplugin.exe">esto</a>.</h3><br>';
		...
		document.getElementById('textradio').value = GM_getValue(id+'textradio');
	}else removeDiv()();
};
function iniciarradio(){
	noradio()
	GM_setValue(id+'textradio', document.getElementById('textradio').value);
	...
	if(document.getElementById('radioradio8').checked == true) radiosrc="http://94.23.2.141:8199/";
	...
	divradioheader.innerHTML += '<div class="chatDockDialog open" id="divradiocontainer" style="width: 320px; position: static;"><div class="chatActions"><a title="Minimizar la radio" href="javascript:void(0)" id="botonocultarradio" class="chatMinimize"></a><a title="Cerrar la radio" href="javascript:void(0)" id="botonnoradio" class="chatClose"> </a></div><h3 title="Radio de '+scriptname+'"><strong>Radio de '+scriptname+'</strong></h3></div>';
...
function xat(){
	if (document.getElementById('divxat') == null){
		...
		divxat.innerHTML += '<center><embed class="container" src="http://www.xatech.com/web_gear/chat/chat.swf" quality="high" width="640" height="480" name="chat" FlashVars="id=75230604&rl=Castilian" align="middle" allowScriptAccess="sameDomain" type="application/x-shockwave-flash" pluginspage="http://xat.com/update_flash.shtml" /></center>';
...
function botones(){
	...
	document.getElementById('tab_settings').parentNode.parentNode.insertBefore(liherramientas,document.getElementById('tab_settings').parentNode);
	...
	//liconfiguracion.innerHTML += '<a id="botonconfiguracion" href="javascript:void(0)" title="Abre el menú de configuración de '+scriptname+'"><b>Configuración</b></a><li id="configuracion" class="hide" style="position: absolute; text-align: right; padding: 5px; display: block; z-index: 200000; background-color: #538FBB !important;"><a id="editar" href="javascript:void(0)"><span>Editar Tuenti <Img class="ico" SRC="http://famfamfam.com/lab/icons/mini/icons/icon_wand.gif" width="12" height="12" border="0"></span></a><a id="about" href="javascript:void(0)"><span>Acerca de... <Img class="ico" SRC="http://famfamfam.com/lab/icons/mini/icons/icon_info.gif" width="12" height="12" border="0"></span></a></li></ul>';
	liconfiguracion.innerHTML += '<a id="botonconfiguracion" href="javascript:void(0)" title="Abre el menú de configuración de '+scriptname+'"><b>Configuración</b></a></ul>';
	document.getElementById('tab_settings').parentNode.parentNode.insertBefore(liconfiguracion,document.getElementById('tab_settings').parentNode);
	...
	document.getElementById("botonconfiguracion").addEventListener("click", function(){Menu()}, true);
...
function menuviejo(){
	...
	botonherramientas = document.createElement("button");
	botonherramientas.appendChild(document.createTextNode("Herramientas"));
	botonherramientas.setAttribute("onclick",function(){menuherramientas()});
	botonherramientas.addEventListener("click", function(){menuherramientas()}, true);
	...
	caja.appendChild(botonherramientas);
	caja.appendChild(botonmenu);
	if (document.getElementById('css_monitors') != null) document.getElementById("css_monitors").appendChild(caja);
	...
	function menuherramientas(){
		if (document.getElementById("menuherramientas") == null) {
			var menuherramientas = document.createElement("div");
			menuherramientas.setAttribute("id","menuherramientas");
			...
			menuherramientas.appendChild(botonpasarpagina);
			...
			menuherramientas.appendChild(botonradio);
			...
			menuherramientas.appendChild(botonborrareventos);

			botoncerrarmenufoto = document.createElement("button");
			botoncerrarmenufoto.appendChild(document.createTextNode("Cerrar"));
			botoncerrarmenufoto.setAttribute("onclick",function(){cerrarmenuherramientas()});
			botoncerrarmenufoto.addEventListener("click", function(){cerrarmenuherramientas()}, true);
			menuherramientas.appendChild(botoncerrarmenufoto);

			if (document.getElementById('css_monitors') != null) document.getElementById("css_monitors").appendChild(menuherramientas);
		}else cerrarmenuherramientas();
	};
	function cerrarmenuherramientas(){
		if (document.getElementById("css_monitors") != null) document.getElementById("css_monitors").removeChild(document.getElementById('menuherramientas'));
	};
};
...
function TPNoticias(){
	GM_xmlhttpRequest({
	    ...
	    onload: function(noticias) {
			...
			if (document.getElementById('friends_updates') != null&&document.getElementById('TPNoticias') == null&¬icias.indexOf("item") != -1)document.getElementById('friends_updates').parentNode.insertBefore(divnoticias,document.getElementById('friends_updates'));
	    }
	});
};
