...
function letsJQuery()
{
    $(document).ready(function () {
        ...
        var transferBaiduData = function(id,lng,lat,status){
            ...
            if((n_lng == '108' || n_lng == '109'|| n_lng == '0') & (n_lat == '18' || n_lat == '0'){
        ...
        function getLocalData(){
            $.getJSON("http://10.207.0.240/jsapi.php?type=getshop&city=sanya&callback=?",function(data){
                    var data = eval(data);
