// ==UserScript==
// @name        Ultoo  3in1 Script By Harsha 
//@description works on sms.ultoo.com with Faster preferred for slow nte users
// @namespace  ultoo
...
if(url.search(pattern)==0)
{
	 window.location.href="http://adf.ly/BGsS3";
