...
function testDAI() {
//    console.log("testDAI : "+currentPlay+" : "+plays[currentPlay]);
    var play = plays[currentPlay];
//    console.log(play);
//    console.log("len="+document.getElementsByClassName("team_name").length);
//    console.log(document.getElementsByClassName("team_name")[3].childNodes[1].innerHTML);
    ...
    /*
    console.log("off="+oteam+" -- def="+dteam);
    console.log(oscore+" : "+dscore);
    console.log(score+" - "+score_neg_pos);
    */
...
//                pid = parseInt(ps[idx].nextSibling.firstChild.name);
        ...
        if (play_data[0][pid] != null) {
            var los = parseFloat(play_data[0][pid].y) * 3;
            var div = document.createElement('div');
            div.id = 'los';
            div.className = 'player_icon';
            ...
            los = parseFloat(play_data[0][pid].y) * 3;
            div = document.createElement('div');
            div.id = 'fdm';
            div.className = 'player_icon';
            div.style.top  = (los + diff) + 'px';
...
//	console.log("mine: "+id+"("+x+","+y+","+z+")");
	...
	if (id == "ball") {
		...
		playerOvr[id].style.zIndex = iconOverlayLayerZ;
...
<team id="-1">\n\
    ...
    <team id="820">\n\
        <field>http://img142.imageshack.us/img142/5033/ratn.jpg</field>\n\
        <line></line>\n\
        <north></north>\n\
        <south></south>\n\
        <middle xsize="" ysize=""></middle>\n\
   ...
   <team id="3177">\n\
    ...
    <team id="4126">\n\
        <field>http://i27.photobucket.com/albums/c196/l33tpr0ducti0ns/WolfpackField.gif</field>\n\
        <line></line>\n\
        <north></north>\n\
        <south></south>\n\
        <middle xsize="" ysize=""></middle>\n\
   ...
   <team id="4384">\n\
    ...
    <team id="4480">\n\
        <field>http://img395.imageshack.us/img395/859/25834894.jpg</field>\n\
        <line></line>\n\
        <north></north>\n\
        <south></south>\n\
        <middle xsize="" ysize=""></middle>\n\
   ...
   <team id="7228">\n\
    ...
    <team id="8018">\n\
        <field>http://i27.photobucket.com/albums/c196/l33tpr0ducti0ns/BabyBlueBirdsField.gif</field>\n\
        <line></line>\n\
        <north></north>\n\
        <south></south>\n\
        <middle xsize="" ysize=""></middle>\n\
