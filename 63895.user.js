...
do_modify_url_it(window.document,'/HTML[1]',/http:\/\/www\.gonzo-movies\.com\/out\.php\?urls=/g,'',true);
do_modify_url_it(window.document,'/HTML[1]',/http:\/\/www\.magicmovies\.com\/outss\.php\?urls=/g,'',true);
do_modify_url_it(window.document,'/HTML[1]',/http:\/\/www\.pornorama\.com\/outsss\.php\?urls=/g,'',true);
do_modify_url_it(window.document,'/HTML[1]',/http:\/\/www\.dreammovies\.com\/outss\.php\?urls=/g,'',true);
