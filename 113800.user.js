 ...
 ********************************************************************************/
// Script information
var Version = 'ProEkipWNA_Zero'; // Year, Month, Day, Revision, Maturity (e.g. YYYMMDDa_BETA)
...
//    researchTimer   : null,
    ...
    trainJobs       : [],
    capitolResearch : {Agriculture:'Tarim', Woodcraft:'Ormancilik', Masonry:'Duvarcilik', Mining:'Alasimlar', Clairvoyance:'Telepati', RapidDeployment:'Hizli Sevkiyat', Ballistics:'Silah Kalibrasyonu', Metallurgy:'Metaruloji', Medicine:'TIP', Dragonry:'Dragon Bilimi', Levitation:'Levatasyon', Mercantilism:'Tuccarlik', AerialCombat:'Hava Carpismasi'},
	...
	init : function (div){
		...
		div.innerHTML =  '<TABLE width=100% bgcolor=#ffffd0 align=center><TR><TD>\
			<INPUT class=button type=submit value="Is Bilgileri" id=' + rndStyle['subtab_info'] + '></INPUT>\
