...
/*
 * 2010-10-15   add download link
 *
 * 2010-10-10	Some Fixes
 * 				Beautify the code
 *
 * 2010-10-08	Switched to JQuery
 * 				Some Fixes
 *
 * 2010-10-01	Initial Version
 */
 ...
 *
 */
addSite(".+\.flickr\.com", ".+\.static\.flickr\.com\.+?_(s|t)\.(jpg|gif|png)", "\_(s|t)\.", "_m.", "_b.", 1 );
addSite(".+\.net", "^.+_(s|t)\.(jpg|gif|png)", "\_(s|t)\.", "_m.", "_o.", 1 );
