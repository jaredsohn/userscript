...
var Board = {
	...
	Link : function(given_size){
		...
		link.innerHTML = "  Ukuran Peta " + given_size + "X" + given_size;
	...
	ShowDetails : function(cell,tempX,tempY){
		...
		Dhtml += "<tr>";
			...
			Dhtml += "<td style='width: 200px;'>";
				Dhtml += "<img class='r1' title='Kayu' alt='Kayu' src='img/x.gif'/>" + maptype[0];
				Dhtml += "<img class='r2' title='Liat' alt='Liat' src='img/x.gif'/>" + maptype[1];
				Dhtml += "<img class='r3' title='Besi' alt='Besi' src='img/x.gif'/>" + maptype[2];
				Dhtml += "<img class='r4' title='Gandum' alt='Gandum' src='img/x.gif'/>" + maptype[3];
			Dhtml += "</td>";
		Dhtml += "</tr>";
		if (box.length > 6){
			Dhtml += "<tr>";
				Dhtml += "<td>Nama Desa</td>";
