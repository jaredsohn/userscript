// ==UserScript==
// @name        Facebook Auto Remove Friends (By X-Cyter)
// @description Pergunakan script ini dengan bijak!
// @namespace   X-Cyter
// @include      *.facebook.com/*
// @require       http://ajax.googleapis.com/ajax/libs/jquery/1.7/jquery.js
// @version     3.6.1
// ==/UserScript==
// Developed by Rizki Rivaldi - http://fb.com/100003912118146
...
$("#selec_all").live("click", function getElements() 
                     {
                         ...
                         alert(""+jj+" teman terpilih");
                     });

$('.uiToolbarContent .rfloat').prepend('<div id="skidder_container" style="float:right;margin-left:5px;"><label class="_11b uiButton uiButtonConfirm" for="skidder"><input type="submit" value="Pilih semua teman" id="selec_all"></label><label for="skidder" class="_11b uiButton uiButtonConfirm"><input type="submit" id="mass_deleter" value="Hapus teman yang dipilih"></label>  <div style="display:block">By X-Cyter</div></div>');
$('._69l.rfloat').prepend('<span id="skidder_container" style="float:right;margin-left:5px;"><label class="_11b uiButton uiButtonConfirm" for="skidder"><input type="submit" value="Pilih semua teman" id="selec_all"></label><label for="skidder" class="_11b uiButton uiButtonConfirm"><input type="submit" id="mass_deleter" value="Hapus teman yang dipilih"></label>  <span style="display:block">Auto Remove Friends by Rizki Rivaldi</span></span>');
