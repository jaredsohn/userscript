// ==UserScript==
// @name           Ice Hackers mod
// @namespace      By: raul | www.tudoemcelularepc.blogspot.com
// @description    Script feito para facilitar o trabalho dos moderadores Ice.
// @tudoemcelularepc.tk  orkut.com.br/Community?cmm=93210312
// @include        *.orkut.*/Main#CommMsgs?cmm=93210312*
// @include        *.orkut.*/CommMsgs?cmm=93210312*
// @include        *.orkut.*/Main#CommMemberManage?cmm=93210312*
// @include        *.orkut.*/CommMemberManage?cmm=93210312*
// @include        *.orkut.*/Community?cmm=93210312*
// @include        *.orkut.*/Main#Community?cmm=93210312*
// ==/UserScript==
		...
		button.onclick = function(){
			if (document.getElementById("cs").value == "")alert("Esqueceu de digitar o captcha!");
			else
				{
					...
					ajax.open("POST","CommMsgs?cmm=93210312&tid=5395708826670296049", false);
		...
		button.onclick = function(){
			if (document.getElementById("cs").value == "")alert("Esqueceu de digitar o captcha!");
			else
				{
					var ajax = new XMLHttpRequest;
					env["cs"] = document.getElementById("cs").value;
					ajax.open("POST","CommMsgPost?cmm=93210312&tid=5395708427238337521", false);
					ajax.setRequestHeader("Content-type","application/x-www-form-urlencoded; charset=UTF-8");
					ajax.send(array_values(env));
