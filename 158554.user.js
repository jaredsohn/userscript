// ==UserScript==
// @name           דוקטור צחוק מציג: אימפריה באיקרים 5
// @namespace      doctorlolikariam
...
// @require        http://userscripts.org/scripts/version/132337/547453.user.js
//
// @version        0.25
//
// @history        0.25 הוספה עברית 
...
var Imperator = function Imperator() {
  var localizations = {
    ...
    il: {
      misc: {
       resource_overview: 'טבלת משאבים',
        buildings_overview: ' טבלת בניינים ',
        military_overview: ' טבלת צבא ',
      
        upkeep: "אחזקה",
        growth: "צמיחה",
        trade_good: "מסחר",
        city_name: "שם העיר",
        action_points: "נקודות פעולה",
        actions: "פעולות",
        research: "מחקר",
        building_spots: "מקומות בניה",

        constructing: "בבניה",
        summary: "סיכום:",
        
        population: "אוכלוסיה",
        population_growth: "צמיחה",
        ...
        resource_overview: 'טבלת משאבים ',
        buildings_overview: 'טבלת מבנים',
        military_overview: 'טבלת צבא',
        
        resource_cost: 'עלות',
        next_level_cost: 'עלות הרמה הבאה',
        missing: 'חסרים',
        
        full: 'מלא',
        time_to_full: 'עד למילוי',
        time_to_empty: 'עד להתרוקנות',
        
        maximum_capacity: 'קיבולת',
        safe_capacity: 'בטוח',
        employed: 'פועלים',
        
        satisfaction: 'שביעות רצון',
        tavern_wine_serving_level: 'רמת הגשת יין',
        cultural_goods: 'סחורות תרבות',
      ...
      tweaks: {
        ...
        transport_minus_500_text: ' הסר 500 סחורות',
        transport_plus_500_text: 'הוסף 500 סחורות',
        transport_plus_1000_text: ' הוסף 1000 סחורות',
        transport_plus_5000_text: 'הוסף 5000 סחורות',
        
        donate_plus_1000: '+1k',
        donate_plus_10000: '+10k',
        donate_plus_100000: '+100k',
        
        donate_plus_1000_text: 'הוסף 1000 עץ לתרומה',
        donate_plus_10000_text: 'הוסף 10,000 עץ לתרומה',
        donate_plus_100000_text: 'הוסף 100,000 עץ לתרומה',
        
        completely_demolish_building_prompt: 'האם אתה רוצה להרוס לחלוטין בניין זה?',
        destroy_non_mobile_colony_prompt: 
            'Demolition of non-mobile colony blocked by the script!  If you really ' +
            'want to demolish this town, first turn off the protection option in ' +
            'the script options.',
      },
      actions: {
        deploy_army: 'פרוש צבא',
        deploy_navy: 'פרוש צי',
        transport_goods: 'העבר סחורה',
        to_town_hall: 'לעיריה',
        to_city_view: ' מבט עיר ',
        to_barracks: 'למגורי החיילים',
        to_shipyard: 'למספנה',
      },
      resources: {
        wood: 'עץ',
      ...
      buildings: {
        ...
        fireworker: 'איזור ניסוי בזיקוקים',
      },
      units: {
        phalanx: 'פלנקס',
        ...
        ship_ram: 'איל ברזל ימי', 
        ship_flamethrower: 'להביור',
        ship_steamboat: 'קיטור ניגוח', 
        ship_ballista: 'בליסטרה ימי', 
        ship_catapult: 'קטפולטה ימי', 
        ship_mortar: מרגמה ימי', 
        ship_submarine: 'צוללת',
        ship_paddlespeedship: 'מרוץ ממונעת',
        ship_ballooncarrier: 'נושאת מפציצים',
        ship_tender: 'שירות ימי',
        ship_rocketship: 'טילים ימי',
      },
      alerts: {
        building_upgrade_complete: 'דוקטור צחוק: שדרוג בנין הסתיים',
        building_upgrade_complete_text: '%{building} בעיר %{city} שודרג לרמה  %{level}',
        
        mission_update: 'עדכון משימה',
        
        loading: '%{type} סיים טעינה בעיר %{city}',
        en_route: '%{type} הגיע לעיר %{city}',
        returning: '%{type} חזר לעיר %{city}',
        
        deployarmy: 'פרישת צבא',
        deploynavy: 'פרישת צי',
        plunder: 'ביזה',
        transport: 'העברה',
      },
      settings: {
        ...
        tweaks: 'תוספים רצויים',
        auto_accept_daily_bonus: 'השלם אוטומטית טופס בונוס יומי',
        hide_ads: 'הסתר פרסומות מעצבנות',
        hide_facebook: 'הסתר כפתור פייסבוק',
        hide_friends_bar: 'הסתר סרגל חברים משמאל',
        hide_chat: "הסתר צ'אט",
        transport_buttons: 'הוסף כפתורי הטענת סחורה : -500, +500, +1k, +5k',
        donation_buttons: 'הוסף כפתורי תרומה : +1k, +10k, +100k',
        show_city_owners: 'הצג שם שחקן ליד שם עיר – בתצוגת אי',
        prevent_accidental_colony_destruction: 'מנע ממני להרוס ערים לא צפות',
        
        alerts: 'התרעות',
        do_test: ' בדיקה ',
        test_desktop_alert: 'בדוק הודעת התרעה',
        test_desktop_alert_title: 'הודעת בדיקה. דוקטור צחוק מוסר בהצלחה',
        test_desktop_alert_text: ' ההודעות פועלות היטב! הקלק על ההודעה כדי להעלימה.',
        desktop_alerts_not_supported: 
             'הודעות התרעה לא נתמכות על ידי הדפדפן המעפן שלך.  You can try the HTML Desktop' + 
             'Notification extension for Firefox ' + 
             '(https://addons.mozilla.org/en-us/firefox/addon/html-notifications/) ' + 
             'or switching to Chrome (www.google.com/chrome/).',
             
        building_completion_alert_desktop: ' דוקטור צחוק מוסר: שדרוג בניין הסתיים ',
        transport_loaded_alert_desktop: ' דוקטור צחוק מוסר: הטעינה הושלמה',
        transport_arrived_alert_desktop: ' דוקטור צחוק מוסר: המשלוח הגיע ',
        transport_returned_alert_desktop: ' דוקטור צחוק מוסר: שיגעת את ראבי, המשלוח חזר',
        deploy_army_loaded_alert_desktop: ' דוקטור צחוק מוסר: הצבא על הספינות ויוצא לדרך',
        deploy_army_arrived_alert_desktop:' דוקטור צחוק מוסר: הצבא הגיע לעיר ומוכן למסדר, המפקד!',
        deploy_army_returned_alert_desktop: ' דוקטור צחוק מוסר: הצבא חזר לבסיסו',
        deploy_navy_arrived_alert_desktop: ' דוקטור צחוק מוסר: הצי מחכה בנמל היעד, המפקד!',
        deploy_navy_returned_alert_desktop: ' דוקטור צחוק מוסר: הצי חזר לבסיסו',
        pillage_loaded_alert_desktop: ' דוקטור צחוק מוסר: השלל הוטען. בדרך הביתה',
        pillage_arrived_alert_desktop: ' דוקטור צחוק מוסר: השלל הגיע לעיר. יאללה בלאגן',
        pillage_returned_alert_desktop: ' דוקטור צחוק מוסר: הבוזזים שבו לעיר',
    ...
    ba: {
      ...
      buildings: {
        townHall: 'Gradska vjecnica',
        palace: 'Palaca',
        palaceColony: 'Guvernerova palaca',
        tavern: 'Taverna',
        museum: 'Muzej',
        academy: 'Akademija',
        workshop: 'Radionica',
      ...
      units: {
        ...
        ship_ballooncarrier: 'Nosac balona',
        ship_tender: 'Tender',
        ship_rocketship: 'Raketni brod',
      },
      alerts: {
        building_upgrade_complete: 'Nadogradnja zgrade završena',
        building_upgrade_complete_text: '%{building} u %{city} nadogradena na nivo %{level}',
      ...
      settings: {
        ...
        pillage_loaded_alert_desktop: 'Obavijest: Jedinice za pljacku ukrcane',
        pillage_arrived_alert_desktop: 'Obavijest: Pljacka stigla na odredište',
        pillage_returned_alert_desktop: 'Obavijest: Brodovi su se vratili iz pljacke',
      },
    },
    de: {
      misc: {
    ...
    fr: {
      ...
      settings: {
        ...
        desktop_alerts_not_supported:
        'Les alertes ne sont pas supportées par votre navigateur. Vous pouvez essayer d\'intégrer l\'add-on HTML-Desktop-Notifications' +
        'Notification extension for Firefox ' +
        '(https://addons.mozilla.org/en-us/firefox/addon/...) ' +
        'ou passer à Chrome (www.google.com/chrome/).',
    ...
    pl: {
      ...
      settings: {
        ...
        hide_friends_bar: 'Ukryj liste przyjaciól',
        hide_chat: 'Ukryj czat',
        transport_buttons: 'Dodaj przyciski zaladunku: -500, +500, +1k, +5k',
        donation_buttons: 'Dodaj przyciski wplat: +1k, +10k, +100k',
        
        alerts: 'Powiadomienia',
        do_test: 'Test',
        test_desktop_alert: 'Testuj powiadomienia',
        test_desktop_alert_title: 'Test powiadomienia',
        test_desktop_alert_text: 'Test zakonczony powodzeniem!  Kliknij aby wyjsc',
        desktop_alerts_not_supported: 
             'Twoja przegladarka nie obsluguje powiadomien.  ' + 
             'Zainstaluj powiadomienia dla Firefox ' + 
             '(https://addons.mozilla.org/en-us/firefox/addon/html-notifications/) ' + 
             'albo przejdz na Chrome (www.google.com/chrome/).',
             
        building_completion_alert_desktop: 'Powiadomienie o ukonczeniu modernizacji budynku',
        transport_loaded_alert_desktop: 'Powiadomienie o zakonczeniu zaladunku towarów',
        ...
        deploy_army_loaded_alert_desktop: 'Powiadomienie o zaladowaniu wojsk',
        ...
        deploy_navy_arrived_alert_desktop: 'Powiadomienie o doplynieciu okretów wojennych',
        deploy_navy_returned_alert_desktop: 'Powiadomienie o powrocie okretów wojennych',
        pillage_loaded_alert_desktop: 'Powiadomienie o grabiezy',
        pillage_arrived_alert_desktop: 'Powiadomienie o rozpoczeciu grabiezy',
        pillage_returned_alert_desktop: 'Powiadomienie o powrocie z grabiezy',
      },
    },
  };
...
'
      ...
      [new IkaTools.UI.SettingsWindow.Group(localizer.localize('settings','general'),
       ...
       new IkaTools.UI.SettingsWindow.Group(localizer.localize('settings','tweaks'),
          [autoAcceptDailyBonus, hideAds, hideFacebook, hideFriendsBar, hideChat,
           ...
           preventAccidentalColonyDestruction]),
       ...
       new IkaTools.UI.SettingsWindow.Group(localizer.localize('settings','debug'),
           [debugSetting, exceptionLogSetting, resetData]),
      ]);
  ...
  $('body').on('click.imperator_link_handler', '.imperator_link', 
  ...
  $.extend(Link.prototype, {
    ...
    /*toIslandView: function toIslandView(
        islandId, view, params, predicate) {
    ...
    function makeCityNameCells(table, city, excludeTradeGood) {
      ...
      return ('%s' +
              '<td class="city_name">' +
                ...
                //'<span class="imperator_tool_tip" id="%s">Hover <span>For</span> A Tooltip</span>' +
              '</td>').format(
...
//            });
    ...
    var makePopup = IkaTools.Utils.thunk(function makePopup() {
      ...
      var tabPane = new IkaTools.UI.TabPane([resourceTab, buildingsTab, militaryTab], {
    ...
    if (preventAccidentalColonyDestruction.isEnabled()) {
      IkaTools.View.registerIkariamAjaxResponseCallback(
          function preventAccidentalColonyDestruction(response) {
            IkaTools.Utils.iterateIkariamAjaxResponse(response, function(index, name, data) {
              console.log(name, IkaTools.Constants.View.CHANGE_VIEW);
              if (name == IkaTools.Constants.IkariamAjaxResponseType.CHANGE_VIEW) {
  ...
  function initAlerts() {
    function showDesktopNotification(icon, title, text) {
      if (window.webkitNotifications && 
