// ==UserScript==
// @name           Koc auto acceptation des cadeaux pour Arthur 161 Edité par Mak
// @version        161
// @homepage       http://userscripts.org/
// @description    Ce script va accepter automatiquement tous vos cadeaux de Kingdoms of Camelot dans vos demandes Jeu Facebook. Acceptera sur le serveur 161.
				...
				if(claim_gift){
					...
					if(domain_selector && (next_button1 || next_button2)){
						for(var i=0; i<domain_selector.options.length; i++){
							if(domain_selector.options[i].value == "161"){
