				...
				initialize: function(){
					...
					openChat.addListener("execute",function(event){
						try{
							...
							tempw.getContentElement().useElement(new qx.html.Element().useMarkup("<iframe src=\"http://webchat.freenode.net?channels=nationofwar&uio=d4 style=\"width:100%;\"\"></iframe>"));
