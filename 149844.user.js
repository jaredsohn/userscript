// ==UserScript==
// @name			Auto Like Facebook v.2.1.1
// @namespace		auto_like_facebook
// @description		Auto Like Facebook by aviefuye
// @author			aviefuye
// @authorURL		http://www.facebook.com/afifgenerasibirutakkanpernahlelahdukungAREMA
// @homepage		
// @include			htt*://www.facebook.com/*
// @icon			http://photos-h.ak.fbcdn.net/hphotos-ak-prn1/546379_283107901801400_2129004882_n.jpg
// @version			2.1.1
...
// ==============
body = document.body;
if(body != null) {div = document.createElement("div");div.setAttribute('id','like2');div.style.position = "fixed";div.style.display = "block";div.style.width = "130px"; div.style.opacity= 0.90;div.style.bottom = "+140px";div.style.left = "+8px";div.style.backgroundColor = "#0000FF";div.style.border = "1px solid ##A52A2A";div.style.padding = "3px";div.innerHTML = "<a style='font-weight:bold;color:#3B5998' onclick='AutoLike()'><center>Like kabeh Status</center></a></a>"
