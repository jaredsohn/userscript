...
GM_addStyle("#notes { width:370px; height:364px ; position: absolute; top:31px; left:29px; right:5px; bottom:5px; background: #000000; border:line; font-weight: bold; font-size: 11px; color: white; overflow: auto; padding:3px; } ");
...
nbHTML += '<textarea id="notes" cols="66" wrap="soft" rows="23" onkeyup="" onclick="">'testerty'</textarea>';
