...
// ==UserScript==
// @name           Facebook - Automatically Accept All Kingdoms of Camelot Gifts 247
// @version        0.1
// @namespace      KOCQuickWidgets-AutoAcceptGifts
// @homepage       http://userscripts.org/
// @description    This script will automatically accept all of your Kingdoms of Camelot gifts in your Facebook Game Requests. Domain 247 Works even if you play on multiple domains!

// @include        *kingdomsofcamelot.com/fb/e2/src/claimGift_src.php*
// @include        *kingdomsofcamelot.com/fb/e2/src/claimDailyGift_src.php*

// @require        http://sizzlemctwizzle.com/updater.php?id=92403
// ==/UserScript==
				...
				if(claim_gift){
					...
					if(domain_selector && (next_button1 || next_button2)){
						for(var i=0; i<domain_selector.options.length; i++){
							if(domain_selector.options[i].value == "247"){
