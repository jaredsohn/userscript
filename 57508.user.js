...
// @name           eRepublik Citizen Military Tracker
// @namespace      http://www.erepublik.com/en/organization/1859111
// @description    eRepublik Citizen Military Tracker, you can follow other players wellness and location , and now even DAMAGE and also calculate the damage per fight and total damage! Add players using id
// @version        3.0.1
...
function fetchCitizensWellness (ids)
{
	...
	html += '<table style="color: rgb(153, 153, 153);"><tr><th style="background: rgb(220,220,220);padding:2px">Sl No.</th><th style="background: rgb(220,220,220);padding:2px">Name</th><th style="text-align:center;background: rgb(220,220,220);padding:2px">Wellness</th><th style="text-align:center;background: rgb(220,220,220);padding:2px">Location</th><th style="text-align:center;background: rgb(220,220,220);padding:2px">Strength</th><th style="text-align:center;background: rgb(220,220,220);padding:2px">Rank</th><th style="text-align:center;background: rgb(220,220,220);padding:2px">Damage</th><th style="text-align:center;background: rgb(220,220,220);padding:2px">Donate</th><th style="text-align:center;background: rgb(220,220,220);">&nbsp;Message</th><th style="text-align:center;background: rgb(220,220,220);">'+
...
//--------------------------------------------------------------------------------------------------------
//Update version     Date                       Change log
//
// v1.1           8/10/2009       Updated to work with new eRepublik link
//
// v1.2          13/10/2009       Edited error : login button not working
//
// v1.3          14/10/2009       Added Simple features
//
// v2.0          14/10/2009       Major Feature added : Damage to be done and damage per weapon
//
// v2.0.3        21/10/2009       Version Checker added
//
// v2.0.5        27/10/2009       Small Change to version checker
//
// v2.1.0        27/10/2009       Total Damage added
//
// v3.0.0         2/11/2009       1)Now eRepublik Player Monitor is eRepublik Citizen Military tracker
//                                2)Bug Fix : Unittotal Damage rounded off
//
// v3.0.1         5/11/2009       Now use player ids not Name
//
// v3.1.0         5/1/2010        Now donate feature is added
//
// v3.1.1         19/3/2010       Minute changes
//-------------------------------------------------------------------------------------------------------