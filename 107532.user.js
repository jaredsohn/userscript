...
// @version        1.2.2
// @date           29.12.10
// @require        http://vulcan.ist.unomaha.edu/~medleymj/updater/55571.js
// ==/UserScript==
		...
		if(!holodeck.__timestamp){
			...
			ChatDialogue.MESSAGE_TEMPLATE.evaluate = function(args){
				...
				if (holodeck._timeFormat == 12){
							time =(month<13?"0":"")+month+"/"+(day<32?"":"")+day+"|"+(hours<10?(hours==0?"12":"0"+hours):(hours>12?(hours>21?hours-12:"0"+(hours-12)):hours))+":"+(minutes<10?"0":"")+minutes+(holodeck._showSeconds?(":"+(seconds<10?"0":"")+seconds):"")+(hours>11?" PM":" AM"); 
						} else {
