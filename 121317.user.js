...
// @namespace       Bigandrewgold/hftahomawhitefont
...
if (localStorage_available) {//Credit to PyroStorm
				opening=localStorage.getItem("HF_post_opening");
				closing=localStorage.getItem("HF_post_closing");
                if (opening === null) {
				if (closing === null) {
                    opening="";
					closing="";
                ...
                opening = GM_getValue("HF_post_opening", "");
				closing = GM_getValue("HF_post_closing", "");
            }
...
function myfunction () {//handle when the checkbox is changed
	...
	var b;
            ...
            if (localStorage_available) {
                localStorage.setItem("HF_post_opening", a);
				localStorage.setItem("HF_post_closing", b);
				
            } else {
                GM_setValue("HF_post_opening", a);
				GM_setValue("HF_post_closing", b);
            }
}
