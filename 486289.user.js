...
// @match         *://torrentz.de/*
// @match         *://tz.ai/*
// @downloadURL   http://userscripts.org/scripts/source/486289.user.js
// @updateURL     http://userscripts.org/scripts/source/486289.user.js
// @icon          http://i.imgur.com/XN2jS.png
// @screenshot    http://i.imgur.com/gYIlR.png
// @screenshot    http://cl.ly/6kwz/b.png
// @version       2014.1.10.crouz.2
...
function bfr_t_activate() {
	...
	".qt_magnet, .qt_cache{width:18px !important; background-repeat: no-repeat; background-position: 2px top;}",
	".dnotblockmebro{position: absolute; display: none; }",
	...
	"#thesearchbox {width: 900px !important; background-position: 880px !important;}",
	"div.results > dl > dd{width: 370px !important;} ",
	...
	"span.Magnet, .qt_magnet           {background-image: url('http://upload.wikimedia.org/wikipedia/commons/c/c2/Magnet-icon.gif')}",
	"span.Torrage, .qt_cache.Torrage   {background-image: url('http://torrage.com/favicon.png')}",
	"span.Torcache, .qt_cache.Torcache {background-image: url('http://torcache.net/favicon.ico')}",
