// ==UserScript==
// @name			Ordenes de Batalla - MoD eParaguay
// @version			1.1.94
// @author			Llillo
// @namespace		eparaguay_mod
// @description		Plugin para visualizar las Ordenes de Batalla de eParaguay.
...
// @updateURL		http://userscripts.org/scripts/source/155095.meta.js
// @downloadURL		http://userscripts.org/scripts/source/155095.user.js
// ==/UserScript==
function LL_carga() {
...
function header() {
    ...
    //var orders = '<h4>Prioridades de eParaguay (Beta v1.1)</h4><div id="mod_orders"></div>';
    ...
    var imageHeader = 'http://i.imgur.com/SyvbH.jpg';
    var orders = '<div id="mod_orders"><img src="'+ imageHeader + '" style="float: none; margin-top:-5px; margin-bottom:-2px" alt="Prioridades de Combate - MoD eParaguay (Beta v1.1)"/></div>';
...
function footer() {
	...
	var linkDiv = '';
    switch(x) {
    case 1: linkDiv = 'http://goo.gl/D8yV0'; break;
    case 2: linkDiv = 'http://goo.gl/uQj6G'; break;
    case 3: linkDiv = 'http://goo.gl/1VqBN'; break;
    case 4: linkDiv = 'http://goo.gl/69jyt'; break;
    default: linkDiv = 'XX';
    }    
    var orders = '<div class="rest"><a href="http://goo.gl/Hgy69" title="" target="_blank">Planilla Ordenes Militares</a><a href="' + linkDiv + '" title="" target="_blank">Canal de Coordinación</a></div>';
...
function battles() {
	var x = division();
    $.get('https://docs.google.com/document/d/1ODLotNs1bbs05Yu2ohl76Cjo_HkFZ-DFt_A-f-uy9ZY/preview?pli=1', function(data) {
