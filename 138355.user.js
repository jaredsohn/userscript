...
/* farm */				"50": {"w": [ 50, 200, 400, 1400, 3500, 6000, 10000, 16000, 25000, 38000 ], "s": [ 0, 0, 200, 600, 1500, 3000, 5000, 8000, 13000, 20000 ], "th": 3},
		 ...
		 // }
				...
				appPerformAction: function(e) {
					...
					switch (key) {
						...
						case 'L':
							...
							break;
						case 'K':
							this.upgradeLowestLevelBuilding("A76", shft);
							break;
						case 'E':
						...
						case 'W':
							if (shft)
								this.upgradeLowestLevelBuilding("F76", false);
							break;
						case 'S':
							if (shft)
								this.upgradeLowestLevelBuilding("F76", true);
							break;
						default:
							return;
					}
					// 76: { added hotkeys (K, W, and S) for upgrading highest level buildings }
				},
				...
				upgradeLowestLevelBuilding: function(_type, _minis) {
					...
					ud = {"wl":tw, "sl":ts,"a":[]};
					for (j=0; j<freeS; j++) {
						if (isHigh == 0)	_bTable.sort(function(a,b){return a[1]-b[1];});
						if (isHigh == 1)	_bTable.sort(function(a,b){return b[1]-a[1];});
						// 76: { if isHigh = 1, reverse sort so that we get highest level building }
						_bType = "";
