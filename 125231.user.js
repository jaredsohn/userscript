// ==UserScript==
// @name           Yahoo Fantasy NHL Bench 'Em  Public
// @namespace      http://userscripts.org/users/Trecetratops/benchemall
// @description    Provides a couple of buttons next to "Submit Changes" ones to bench every player with night off for PUBLIC
// @include        http://hockey.fantasysports.yahoo.com/hockey/68134/*
...
/*
   ...
   Change log:
      2012-Feb-08   Now attempting to make this work for Hockey (first without Goalies)
      2012-Feb-08   Attempting to apply this script to Custom Leagues w/other Roster req's.
   ...
   Credits:
       Tracertops who mod'd this in Dec 2010
...
var doBench = function(event) {
  ...
  var allElements;
  var thisElement;
  var myLineup = { "C":2, "LW":2, "RW":2, "D":4, };
