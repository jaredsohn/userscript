// ==UserScript==
// @name        Add All Friends To Group by ZiZiGooLoo
...
var locales = {
	...
	"en": {
		"addbstr": "دعوت تمام دوستان",
		"dlgtstr": "افزودن دوستان در گروه",
		"dlgwstr": "به گروه زیزیگولو بپیوندید : www.facebook.com/groups/zizigooloo/",
		"dlgastr": "در حال افزودن ... لطفا دقایقی صبر کنید",
		"dlgfstr": "کل دوستان",
		"dlgpstr": "در حال انجام",
		"dlgrstr": "باقی مانده",
		"dlgsstr": "موفق ها",
		"dlgistr": "نا موفق ها",
		"dlgostr": "پایان",
		"dlgfsstr": "افزوده نشده ها",
		"dlgffstr": "افزوده شده ها",
		"dlgcnstr": "انصراف",
		"dlgclstr": "بستن"
	}
};
