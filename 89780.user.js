...
// ==UserScript==
// @name           Escrever para Varios avatares 
// @namespace      Escrever para Varios avatares
// @author         James Maxwel
// @description    Envia mensagem para varios avatares
// @version        0.1.7
...
function init() {
	...
	a.appendChild(document.createTextNode("Escrever para Varios"));
