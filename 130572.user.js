// ==UserScript==
// @author		Zena Warrior
// @name        eRepublik Damage 8 POLK
// @namespace   8 POLK
// @version		0.2.7
// @uso:version 0.2.7
// @include		http://*erepublik.com/*/military/battlefield/*
// @description    eRepublik Damage Reporting script for EMC UKRAINE
// ==/UserScript==
...
if(window.location.href.indexOf(PAGE_BATTLEFIELD) > 0) {	
	...
	/***********************************************************************************/
	var FORM_URL = "https://docs.google.com/spreadsheet/viewform?formkey=dGpOeThKR0t0YzR6VGwwdnF0QWJUSHc6MQ#gid=0";
	var FORM_FIELDS = {
		eday: "entry.0.single",
		name: "entry.2.single",
