// ==UserScript==
// @name           PowerTools By Dark Side of Moon
// @namespace      DSOM
// @include        http://*.kingdomsofcamelot.com/*main_src.php*
// @description    Utility per Kingdoms of Camelot
...
var Version = '1.0';22110415
var Title = 'KOC Power Tools By Dark Side of Moon';
...
//logit ( 'Options.ptWinPos: '+ inspect (Options.ptWinPos, 5, 1)); 
  ...
  AddMainTabLink('Dark Side of Moon', eventHideShow, mouseMainTab);
}
...
Tabs.Wikia = {
  ...
  myDiv : null,
  timer : null,
  wikialink :  'http://koc.wikia.com/wiki/Kingdoms_of_Camelot_Wiki',
  
  init : function (div){    // called once, upon script startup
    var t = Tabs.Wikia;
    t.myDiv = div;
    div.innerHTML = '<CENTER><iframe src="'+ t.wikialink +'" width="100%" height="550" name="board_in_a_box" <p><a href="'+ t.wikia +'"/a></p> </iframe> <BR></center>';
  },
  ...
  init : function (div){
    ...
    var m = '<TABLE><TR><TD align=right>Eaplorazione: </td><TD><INPUT type=checkbox id=fakeIsScout></td></tr>\
		...
		<TR><TD align=right># di Esploratori: </td><TD><INPUT type=text size=6 value=0 id=faketroop2></td></tr>\
		  ...
		  <TR><TD align=right>Nome di chi ti attaca: </td><TD><INPUT type=text size=13 value=oftheNOOBS id=fakeName></td></tr>\
  ...
  init : function (div){
    ...
    try {      
      m = '<TABLE class=ptTab>\
        ...
        <TR><TD><INPUT id=ptAllowWinMove type=checkbox /></td><TD>Attiva movimento finestra (ti permette di muovere la finestra de \'Dark Side of Moon\' col mouse)</td></tr>\
        <TR><TD><INPUT id=togWhisperOn type=checkbox /></td><TD>Attiva audio avviso in caso di bisbiglio <SPAN class=boldRed>&nbsp;(NUOVO)</span></td></tr>\
	 ...
	 m += '<TR><TD><INPUT id=alertEnable type=checkbox '+ (Options.alertConfig.aChat?'CHECKED ':'') +'/></td><TD>Posta automaticamente l\'attacco in chat alleanza.</td></tr>\
          ...
          <TR><TD align=right>Allerta su esplorazioni: &nbsp; </td><TD><INPUT id=alertScout type=checkbox '+ (Options.alertConfig.scouting?'CHECKED ':'') +'/></td></tr>\
          <TR><TD align=right>Allerta su attacco terre: &nbsp; </td><TD><INPUT id=alertWild type=checkbox '+ (Options.alertConfig.wilds?'CHECKED ':'') +'/></td></tr>\
          <TR><TD align=right>Stato diplomazia tra le alleanze: &nbsp; </td><TD><INPUT id=alertAlliance type=checkbox '+ (Options.alertConfig.includealliance?'CHECKED ':'') +'/></td></tr>\
          <TR><TD align=right>Potere di chi attacca: &nbsp; </td><TD><INPUT id=alertMight type=checkbox '+ (Options.alertConfig.includemight?'CHECKED ':'') +'/></td></tr>\
      ...
      m += '<TR><TD><INPUT id=togAllRpts type=checkbox /></td><TD>Abilita report rinforzi in chat alleanza.</td></tr>\
        ...
        <TR><TD><INPUT id=togPageNav type=checkbox /></td><TD>Migliora la navigazione dei messaggi e dei reports.</td></tr>\
        <TR><TD><INPUT id=togWarnZero type=checkbox /></td><TD>Avvisa invio attacco alle coordinate 0,0.</td></tr>\
...
clickedPlayerDetail : function (span, uid){
  ...
  gotPlayerLeaderboard : function (rslt, span){
    ...
    if (rslt.totalResults == 0){
      span.innerHTML = '<B>Informazioni:</b> Non trovato! (sarà sotto nebbia ?)';
      return;
    }
    var p = rslt.results[0];
    var an = p.allianceName;
...
m += '<TABLE class=ptTab width=100%><TR align=center>\
        ...
        <TD width=8%><B>Cavalli:</b></td><TD width=8%><B>Cavalloni:</b></td><TD width=8%><B>Carretti:</b></td>\
...
//**********************************
      ...
      str += _row ('<i><span style="color:green">Coda Cavalli</span></i>', t_rows[14]);
      ...
      str += '<TR><TD></td><TD colspan=4>PowerTools by DarkSideOfMoon</td></tr>';
      str += "</table>";
      if (DEBUG_BUTTON)
...
Tabs.Marce = {
  ...
  showReinforcements : function (){
    var rownum = 0;
    var names = ['Truppe Trasporto', 'Soldati Semplici', 'Esploratori', 'Lancieri', 'Spadaccini', 'Arcieri', 'Cavalli', 'Cavalloni', 'Carretti', 'Baliste', 'Arieti', 'Catapulte'];
    var t = Tabs.Marce;
    clearTimeout (t.displayTimer);
...
function CdialogCancelContinue (msg, canNotify, contNotify, centerElement){
  ...
  pop.getTopDiv().innerHTML = '<CENTER>KOC Power Tools - DarkSideOfMoon</center>';
