// ==UserScript==
// @name           KoC Toolkit i18n en Francais
// @namespace      KoC Toolkit i18n en Francais 
// @homepage       http://userscripts.org/scripts/show/91173
// @description    Kingdoms of Camelot Toolkit en Francais
// @version        02122010 Build 01 i18n FR
// @include       *kingdomsofcamelot*
// @require       http://ajax.googleapis.com/ajax/libs/jquery/1.3.2/jquery.min.js 
// @require       http://sizzlemctwizzle.com/updater.php?id=91173
// ==/UserScript==
...
////////////////////////////////////////////////////////////////////////////////////
// Declaration des  Variables Text 
////////////////////////////////////////////////////////////////////////////////////
var ErrorMSG = "ERREUR:";
var ERRORwhilebuildingGUI = 'Erreur lors de la construction de l\'interface graphique<br><br>erreur:';
var ERRORwhilebuildingCHAT = 'Erreur lors de la construction du chat<br><br>erreur:';
var ERRORwhileBuilding = 'Erreur lors de la construction <br><br> erreur:';
var ERRORwhileclearinglogs = 'Erreur lors de la mise &agrave; jour du journal<br><br>erreur:';
var ERRORwhilehidePopups = 'Erreur en masquant les fen&ecirc;tres pop-up';
var ERRORwhilecheckAutoBuild = 'Erreur lors de la v&eacute;rification automatique de la version<br><br>erreur:';
var ERRORwhilecheckImpendingAttack = 'Erreur lors de la v&eacute;rification d\'une attaque imminente<br><br>erreur: ';
var Toolkitdatawillbecleared = "Les donn&eacute;es de Koc Toolkit seront effac&eacute;es Etes-vous s&ucirc;r?";
var Toolkitdatahasbeencleared = "Les donn&eacute;es de Koc Toolkit ont &eacute;t&eacute; effac&eacute;e";
var KoCToolkitneedstoberestarted = "KoC Toolkit doit &ecirc;tre red&eacute;marr&eacute;! Proc&eacute;dez au rafra&icirc;chissement...?";
var ToolkitdatahasNOTbeencleared = "Les donn&eacute;es de Koc Toolkit NON PAS &eacute;t&eacute; effac&eacute;es!";
var maximumLinesReached = 'lignes maximum atteint';
var LogCurrentlyEmpty = 'Log Actuellement vide';
var autoCloseAfterTenSec = "fermeture automatiquement dans 10 secondes";
var ToolkitDataDoesNotExist = 'La banque de donn&eacute;es de Koc Toolkit existe pas. Cr&eacute;ation en cour';
var ToolkitDataSeemsIncomplete = 'La banque de donn&eacute;es de Koc Toolkit est incomplete.';
var CheckingForAttacks = 'V&eacute;rification des attaques';
var CheckingForScouts = 'V&eacute;rification des Eclaireur';
var CheckingForFakeattacks = 'V&eacute;rification des Fausse attaques';
var InstalledVersion = "Version Instaler";
var SendTravellingFaire = 'Envoyer une Foire &agrave; un ami';
var TravellingFaireBlocked = 'La Foire a &eacute;t&eacute; bloqu&eacute;e';
var invitedToVisitCourt = 'a le plaisir de vous invit&eacute; &agrave; visiter leurs Cour';
var InvitationBlocked = 'Invitation bloqu&eacute;';
var currentBuildingLevel = "Le niveau de la construction est";
var DueToBuildingRequirements = 'En raison des exigences de construction (DI), les b&acirc;timents au dessus du niveau 9\ndoivent &ecirc;tre construite manuellement.';
var ConnectionError = "Erreur de connexion! S\'il vous pla&icirc;t essayer &agrave; nouveau plus tard";
var BuildingVAR = 'B&acirc;timent';
var lvlVAR = 'Niveau';
var inVAR = 'dans';
var CurrentlyBuilding = 'Actuellement en construction';
var ReadytoBuild = 'Pr&ecirc;t &agrave; construire';
var CancelVAR = 'Suprimer';
var KoCToolkitneedstorestartedtoapply = "KoC Toolkit doit &ecirc;tre red&eacute;marr&eacute; pour appliquer vos param&egrave;tres! Proc&eacute;dez au rafra&icirc;chissement ...?";
var OFFVAR = 'NON'; // NO 
var ONVAR = 'OUI'; // YES 
var AttackInformerOptions = 'Attaque Information Options';
var AlertonAttacksAbove = 'Alerte sur l\'arriver des attaques';
var AlertonScoutsAbove = 'Alerte sur l\'arriver d\'eclaireurs';
var ChatOptions = 'Options du Chat';
var ChatChannel = 'Chat Channel (EX: debug)';
var NoBuild = 'Aucune Construction';
var NoLogs = 'Aucun journal d\'activit&eacute;es';
var NoAttacks = 'Aucune Attaques';
var NoScouting = 'Aucun Eclaireur';
var NoFakeAttacks = 'Aucune fausse Attaque';
var cannotFindInfoBox = 'Boite d\'information introuvable pour';
var AutoBuildOFF = 'Const. Auto = NON';
var AutoBuildON = 'Const. Auto = OUI';
var DestructON = 'Destruction = OUI';
var AlertOFF = 'Alerte = NON'; 
var AlertON  = 'Alerte = OUI';
var HelpOFF = 'Aide = NON';
var HelpON = 'Aide = OUI';
var NoDisplayFor = 'Pas d\'affichage pour';
var refreshtoApplyYourChanges = "Vous devez rafra&icirc;chir la page pour appliquer vos modifications";
////////////////////////////////////////////////////////////////////////////////////
// FIN de la declaration des Variables Text 
////////////////////////////////////////////////////////////////////////////////////
...
function DD_GLOBAL_INIT(){
    ...
    try {
        ...
        GUI.modalmessage(ERRORwhilebuildingGUI +'&nbsp;'+ e);
    ...
    if (GUI.usechat == true && GUI.chatchannel != "") {
        try {
            ...
            GUI.modalmessage(ERRORwhilebuildingCHAT +'&nbsp;'+ e);
            console.error(ErrorMSG +" "+ e);
        }
    }
...
function DD_MAIN_APP(){
    ...
    window.setTimeout('MAIN.update();', updateIntervall);
        ...
        try {
            ...
            GUI.modalmessage(ERRORwhileclearinglogs +' '+ e);
            console.error(ErrorMSG +" "+ e);
        }
        /*
         //POPUP BLOCKER
         ...
         GUI.modalmessage(ERRORwhilehidePopups +' '+ e);
         console.error(ErrorMSG +" "+ e);
         }
         */
        //BUILDER
        try {
            ...
            GUI.modalmessage(ERRORwhilecheckAutoBuild +' '+ e);
            console.error(ErrorMSG +" "+ e);
        }
        ...
        try {
            ...
            GUI.modalmessage(ERRORwhilecheckImpendingAttack +' '+ e);
            console.error(ErrorMSG +" "+ e);
        }
    }
}
...
function DD_POC_GUI(){
    ...
    window.GUI.clearstorage = function(){
        if (confirm(Toolkitdatawillbecleared)) {
            tk_data = "";
            window.tk_data = new DD_POC_DATA();
            handler.saveObject(tk_data); 
            alert(Toolkitdatahasbeencleared);
			
            if (confirm(KoCToolkitneedstoberestarted)) {
            ...
            alert(ToolkitdatahasNOTbeencleared);
        }
        ...
        for (i = 0; i <= storageLength; i++) {
            ...
            for (j = 0; j <= values.length; j++) {
				if (j <= max_storage_lines) {
					...
					storageContent += '<br>' + maximumLinesReached + '...';
				}
			}
        ...
        if (storageContent == "") 
            storageContent = '<li class="empty">' + LogCurrentlyEmpty + '</li>';
    ...
    window.GUI.modalmessage = function(message){
		var timeout = 10000;
        var content = autoCloseAfterTenSec + "...<br><br>"
		content += message;
    ...
    window.GUI.build = function(){
        ...
        if (data == null) {
            alert(ToolkitDataDoesNotExist + '...');
            window.tk_data = new DD_POC_DATA();
            
            var s = tk_data.states = new Object();
            
            //default values
            s.ScriptVersion = '02122010 Build 01 i18n FR';
            s.details = false;
            s.tabselected = 'log';
            s.mode = 0;
        ...
        if (typeof tk_data.states.ScriptVersion == 'undefined' || typeof tk_data.states.details == 'undefined' || typeof tk_data.states.tabselected == 'undefined' || typeof tk_data.states.mode == 'undefined' || typeof tk_data.states.pocbuildaction == 'undefined' || typeof tk_data.states.isnotrunning == 'undefined' || typeof tk_data.states.ispaused == 'undefined' || typeof tk_data.states.alerterOn == 'undefined' || typeof tk_data.states.ask4help == 'undefined' || typeof tk_data.options.widemap == 'undefined' || typeof tk_data.options.onattack == 'undefined' || typeof tk_data.options.minattack == 'undefined' || typeof tk_data.options.onscouts == 'undefined' || typeof tk_data.options.minscouts == 'undefined' || typeof tk_data.options.usechat == 'undefined' || typeof tk_data.options.chatchannel == 'undefined') {
	            alert(ToolkitDataSeemsIncomplete + '...');
            tk_data = "";
        ...
        GUI.logscout.clear();
        GUI.logfake.clear();
        GUI.poclog.add("<b>Version Instalée: 02122010 Build 01 i18n FR</b><br><br>"); 
        /*
        ...
        */
        GUI.logattack.add(CheckingForAttacks);
        GUI.logscout.add(CheckingForScouts); 
        GUI.logfake.add(CheckingForFakeattacks);   
    }
    
    window.GUI.hidePopups = function(){
    
        if (document.getElementsByTagName('body')[0].innerHTML.indexOf(SendTravellingFaire) > 0) {
            GUI.poclog.add(TravellingFaireBlocked); 
            Modal.hideModal();
        }
        
        if (document.getElementsByTagName('body')[0].innerHTML.indexOf(invitedToVisitCourt) > 0 || document.getElementsByTagName('body')[0].innerHTML.indexOf('herzlich eingeladen sie an ihren Hof zu besuchen') > 0) {
            GUI.poclog.add(InvitationBlocked);
            Modal.hideModal();
        }
    }
...
function DD_POC_FUNCTIONS(){
    ...
    window.GUI.pocbuild.add = function(c, a){
        ...
        if (window.DEBUG) {
            console.info(currentBuildingLevel + " " + w)
        }; //
        

    if (GUI.currentBuildMode == "build") {  
        if( w >= 9) {  
            GUI.modalmessage(DueToBuildingRequirements);  
            return;  
        }  
    }
    ...
    window.GUI.pocbuild.destruct = function(c){
        ...
        params.lv = curlvl - 1;
        if (curlvl > 0) {
            params.bid = seed.buildings["city" + currentcityid]["pos" + citpos];
        }
        params.type = bdgid;
...
function DD_POC_VARIABLES(){
    ...
    window.pochtmls.controls['options'] = '<a id="con_refresh" class="gem_button" onclick="GUI.pocgui.control.onclick(this)"><span id="refresh_text">NO refresch needed!</span></a>';
    ...
    window.pochtmls.mainbody = '<table class="tabs_engagement" id="pochmain" style="position:fixed; top:0px; left:740px;" cellspacing="0" border="0" width="450"> \
								...
								<td style="background-color:#FFF; border: 1px solid #A56631;" colspan="2">Functions:  \
