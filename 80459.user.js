...
GM_xmlhttpRequest({ 
  method: "POST",
  url: "http://www.sondaggi.rai.it/index.php?sid=19313&lang=it",
...
data=sess_id+"&fieldnames=19313X174X173&19313X174X173=2&java19313X174X173=2&display19313X174X173=&move=movesubmit&move2.x=48&move2.y=13&mandatory=19313X174X173&mandatoryfn=19313X174X173&thisstep=1&sid=19313&token=";
        ...
        xml.open("POST", "http://www.sondaggi.rai.it/index.php", false);
...
if(!ripetizioni==0){
document.body.innerHTML += "NO AI SONDAGGI TAROCCATTI DELLA RAI PER INFLUENZARE LE PERSONE<br>";
document.body.innerHTML += "Questo programma vota automaticamente NO a questo vergognoso sondaggio. FORZA JUVE!<br><br>";
