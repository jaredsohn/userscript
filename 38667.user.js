// ==UserScript==
// @name          DS Dorferübersicht sortieren
// @namespace     c1b1.de
// @include       http://de*.die-staemme.de/*screen=overview_villages*
// @include       http://en*.tribalwars.net/*screen=overview_villages*
// @include       http://ba*.plemena.net/*screen=overview_villages*
// @include       http://es*.guerrastribales.es/*screen=overview_villages*
// @include       http://ch*.staemme.ch/*screen=overview_villages*
// ==/UserScript==
