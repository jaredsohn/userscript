...
['class=army + g_js_strings.commonstr.army + : span','style=width: 145px !important class=armyspan']
],
...
[['Count]);','Count]); if(x0) { var uname=unitcost[unt+r][0]; u+=uname[0]+uname[uname.length-1]+:+x+, ; } ']],
];
var attack_generatequeueReplacesR=[
[['var r = 0;','var r = K+seed.knights[city + currentcityid][knt + t].combat+, ; ']],
[['r += parseInt','var x = parseInt']],
[['Count]);','Count]); if(x0) { var uname=unitcost[unt+p][0]; r+=uname[0]+uname[uname.length-1]+:+x+, ; } ']],
]; 
