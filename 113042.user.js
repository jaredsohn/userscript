...
/*********************************  Cresting Tab ***********************************/
 Tabs.Crest = {
  ...
  init : function (div){
    ...
    setInterval(t.ThirdRound,10000);
    setInterval(t.sendCrestReport, 1*60*1000);
    setInterval(t.sendSecondReport, 1*60*1000);
    t.myDiv = div;
    ...
    m += '<DIV id=pbOpt class=pbStat>SECOND CRESTING OPTIONS</div><TABLE id=pbcrestopt	 width=100% height=0% class=pbTab><TR align="center"></table>';
    m += '<DIV style="margin-bottom:10px;">Crest from city: <span id=Crest1City></span></div>';
    
    m += '<TABLE class=ptTab><TR><TD>Wild coords: X:<INPUT id=pbcrestx1 type=text size=3 maxlength=3 value="'+CrestOptions.CX+'"</td>';
    m += '<TD>Y:<INPUT id=pbcresty1 type=text size=3 maxlength=3 value="'+CrestOptions.CY+'"</td></tr></table>';
   
    m += '<TABLE class=ptTab><TR><TD>Wave <b>1</b>: </td><TD><img src=http://cdn1.kingdomsofcamelot.com/fb/e2/src/img/units/unit_2_30.png></td><TD><INPUT id=R3MM type=text size=5 maxlength=5 value="'+CrestOptions.R3MM+'" (When left 0 it will not send out a first wave, for whatever reason you want to do that...)</td>';
    m += '</td><TD></td><TD><TD><img src=http://cdn1.kingdomsofcamelot.com/fb/e2/src/img/units/unit_10_30.png></td><TD><INPUT id=R3Ball type=text size=5 maxlength=5 value="'+CrestOptions.R3Ball+'"</td>';
    m += '<TD><img src=http://cdn1.kingdomsofcamelot.com/fb/e2/src/img/units/unit_12_30.png></td><TD><INPUT id=R3Cat type=text size=5 maxlength=5 value="'+CrestOptions.R3Cat+'"</td></tr>';
    
    m += '<TR><TD>Wave <b>2</b>: </td><TD><img src=http://cdn1.kingdomsofcamelot.com/fb/e2/src/img/units/unit_2_30.png></td><TD><INPUT id=R4MM type=text size=5 maxlength=5 value="'+CrestOptions.R4MM+'"</td>';
    m += '<TD><img src=http://cdn1.kingdomsofcamelot.com/fb/e2/src/img/units/unit_4_30.png></td><TD><INPUT id=R4Pike type=text size=5 maxlength=5 value="'+CrestOptions.R4Pike+'"</td>';
    m += '<TD><img src=http://cdn1.kingdomsofcamelot.com/fb/e2/src/img/units/unit_5_30.png></td><TD><INPUT id=R4Sword type=text size=5 maxlength=5 value="'+CrestOptions.R4Sword+'"</td>';
    m += '<TD><img src=http://cdn1.kingdomsofcamelot.com/fb/e2/src/img/units/unit_6_30.png></td><TD><INPUT id=R4Arch type=text size=5 maxlength=5 value="'+CrestOptions.R4Arch+'"</td>';
    m += '<TD><img src=http://cdn1.kingdomsofcamelot.com/fb/e2/src/img/units/unit_10_30.png></td><TD><INPUT id=R4Ball type=text size=5 maxlength=5 value="'+CrestOptions.R4Ball+'"</td>';
    m += '<TD><img src=http://cdn1.kingdomsofcamelot.com/fb/e2/src/img/units/unit_11_30.png></td><TD><INPUT id=R4Ram type=text size=5 maxlength=5 value="'+CrestOptions.R4Ram+'"</td>';
    m += '<TD><img src=http://cdn1.kingdomsofcamelot.com/fb/e2/src/img/units/unit_12_30.png></td><TD><INPUT id=R4Cat type=text size=5 maxlength=5 value="'+CrestOptions.R4Cat+'"</td></tr></table>';
	...
	for (var i=0;i<Seed.cities.length;i++){
		if (CrestOptions.Crest1City == Seed.cities[i][0]){
			selbut=i;
			break;
		}
	}

    t.tcpto = new CdispCityPicker ('crestcitys', document.getElementById('Crest1City'), true, t.clickcityselect, selbut);
    
    if (CrestOptions.Crest1City == 0) {
    	CrestOptions.Crest1City = t.tcpto.city.id
    	saveCrestOptions();
    }
	...
	document.getElementById('Crest1City').addEventListener('click', function(){CrestOptions.Crest1City = t.tcpto.city.id; saveCrestOptions();} , false);
    document.getElementById('pbcrestx1').addEventListener('change', function(){CrestOptions.CX = document.getElementById('pbcrestx1').value; saveCrestOptions();} , false);
    document.getElementById('pbcresty1').addEventListener('change', function(){CrestOptions.CY = document.getElementById('pbcresty1').value; saveCrestOptions()} , false);
    document.getElementById('R3MM').addEventListener('change', function(){CrestOptions.R3MM = document.getElementById('R3MM').value; saveCrestOptions()} , false);
    document.getElementById('R3Ball').addEventListener('change', function(){CrestOptions.R3Ball = document.getElementById('R3Ball').value; saveCrestOptions()} , false);
    document.getElementById('R3Cat').addEventListener('change', function(){CrestOptions.R3Cat = document.getElementById('R3Cat').value; saveCrestOptions()} , false);
    document.getElementById('R4MM').addEventListener('change', function(){CrestOptions.R4MM = document.getElementById('R4MM').value; saveCrestOptions()} , false);
    document.getElementById('R4Pike').addEventListener('change', function(){CrestOptions.R4Pike = document.getElementById('R4Pike').value; saveCrestOptions()} , false);
    document.getElementById('R4Sword').addEventListener('change', function(){CrestOptions.R4Sword = document.getElementById('R4Sword').value; saveCrestOptions()} , false);
    document.getElementById('R4Arch').addEventListener('change', function(){CrestOptions.R4Arch = document.getElementById('R4Arch').value; saveCrestOptions()} , false);
    document.getElementById('R4Ball').addEventListener('change', function(){CrestOptions.R4Ball = document.getElementById('R4Ball').value; saveCrestOptions()} , false);
    document.getElementById('R4Ram').addEventListener('change', function(){CrestOptions.R4Ram = document.getElementById('R4Ram').value; saveCrestOptions()} , false);
    document.getElementById('R4Cat').addEventListener('change', function(){CrestOptions.R4Cat = document.getElementById('R4Cat').value; saveCrestOptions()} , false);
  },
  ...
  helpPop : function (){
    ...
    pop.centerMe (mainPop.getMainDiv());  
    pop.getMainDiv().innerHTML = helpText;
    pop.getTopDiv().innerHTML = '<CENTER><B>PowerKoc Help: Cresting</b></center>';
    pop.show (true);
  },
  ...
  toggleCrestState: function(obj){
		...
		updatebotbutton('Crest - ON', 'pbcresttab');
            for (crest in Options.Creststatus){
            		...
            		Options.Crest1Level = 0;
            		Options.Crest1Type = 0;
    ...
    sendSecondReport: function(){
        ...
        message += '%0A Crests Gained (for '+ Options.CrestMsgInterval +' hour of cresting) on a Level: '+Options.Crest1Level+' '+wildtype+'%0A';
        for (crest in Options.Creststatus){
        	owned = Seed.items['i'+crest];
        	if (owned == undefined) owned=0;
    	...
    	message += '%0A Numbers of 1st Wave send: '+ Options.Crest3Count +'%0A';
    	message += 'Numbers of 2nd Wave send: '+ Options.Crest4Count +'%0A';
  ...
  ThirdRound: function(){
      ...
      var buzy = false;
      if (!CrestOptions.Running) return;
      cityID = 'city' + CrestOptions.Crest1City;
      var abandon=0;
      for (var k in Seed.wilderness[cityID] ){
           if (Seed.wilderness[cityID][k]['xCoord']==CrestOptions.CX && Seed.wilderness[cityID][k]['yCoord']==CrestOptions.CY && t.error_code!=401) {
             t.abandonWilderness(Seed.wilderness[cityID][k]['tileId'],Seed.wilderness[cityID][k]['xCoord'],Seed.wilderness[cityID][k]['yCoord'],CrestOptions.Crest1City);
           }
      }
      if (parseInt(Seed.units[cityID]['unt2']) < CrestOptions.R3MM || parseInt(Seed.units[cityID]['unt10']) < CrestOptions.R3Ball || parseInt(Seed.units[cityID]['unt12']) < CrestOptions.R3Cat || parseInt(Seed.units[cityID]['unt2']) < CrestOptions.R3MM || parseInt(Seed.units[cityID]['unt2']) < CrestOptions.R4MM || parseInt(Seed.units[cityID]['unt4']) < CrestOptions.R4Pike || parseInt(Seed.units[cityID]['unt5']) < CrestOptions.R4Sword || parseInt(Seed.units[cityID]['unt6']) < CrestOptions.R4Arch || parseInt(Seed.units[cityID]['unt10']) < CrestOptions.R4Ball || parseInt(Seed.units[cityID]['unt11']) < CrestOptions.R4Ram || parseInt(Seed.units[cityID]['unt12']) < CrestOptions.R4Cat) return;
      for (var k in Seed.queue_atkp[cityID]){
        if (Seed.queue_atkp[cityID][k]['toXCoord']==CrestOptions.CX && Seed.queue_atkp[cityID][k]['toYCoord']==CrestOptions.CY)  buzy=true;
      }
      if (!buzy)  {
        CrestOptions.RoundThree=true;
        CrestOptions.RoundFour=true;
        saveCrestOptions();
      }
      if(!CrestOptions.RoundThree) return;
      
      if (CrestOptions.R3MM == 0 && CrestOptions.R3Ball==0 && CrestOptions.R3Cat==0){
      CrestOptions.RoundThree = false;
      saveCrestOptions();
      setTimeout (function(){t.FourthRound();}, 1000);
      return;
      }
      ...
      slots=0;
	   ...
	   if (CrestOptions.R3MM > parseInt(Seed.units[cityID]['unt2']) || CrestOptions.R3Ball > parseInt(Seed.units[cityID]['unt10']) || CrestOptions.R3Cat > parseInt(Seed.units[cityID]['unt12'])){return;}
          
	    var params = unsafeWindow.Object.clone(unsafeWindow.g_ajaxparams);
  		params.cid=CrestOptions.Crest1City;
  		params.type=4;
  	    params.kid=kid;
  		params.xcoord = CrestOptions.CX;
  		params.ycoord = CrestOptions.CY;
        if (now < (parseInt(CrestOptions.lastRoundTwo) + 300)) { 
        	params.u2= (CrestOptions.R3MM / 10);
        	params.u2 = params.u2.toFixed(0);	
        	if (params.u2 < (CrestOptions.R3MM / 10)) params.u2++;
        }	
  		else params.u2= CrestOptions.R3MM;
  		params.u10=CrestOptions.R3Ball;
  		params.u12=CrestOptions.R3Cat;
  		...
  		new AjaxRequest(unsafeWindow.g_ajaxpath + "ajax/march.php" + unsafeWindow.g_ajaxsuffix, {
  		         ...
  		         CrestOptions.RoundThree = false;
  		         Options.Crest3Count++;
  		         Options.Crest1Level = rslt.tileLevel;
  		         Options.Crest1Type = rslt.tileType;
  		         saveCrestOptions();
  		         setTimeout (function(){t.FourthRound();}, 10000);
               } else {
               		//setTimeout (function(){t.ThirdRound();}, 5000);
  		         //unsafeWindow.Modal.showAlert(printLocalError((rslt.error_code || null), (rslt.msg || null), (rslt.feedback || null)))
  		         }
  		         },
  		         onFailure: function () {}
    ...
    FourthRound: function(){
      var t = Tabs.Crest;
      if (!CrestOptions.Running || !CrestOptions.RoundFour) return;
      var params = unsafeWindow.Object.clone(unsafeWindow.g_ajaxparams);
      cityID = 'city' + CrestOptions.Crest1City;
      ...
      slots=0;
       ...
       var kid = t.knt[0].ID;
  		...
  		params.xcoord = CrestOptions.CX;
  		params.ycoord = CrestOptions.CY;
  		params.u2=CrestOptions.R4MM;
  		params.u4=CrestOptions.R4Pike;
  		params.u5=CrestOptions.R4Sword;
  		params.u6=CrestOptions.R4Arch;
  		params.u10=CrestOptions.R4Ball;
  		params.u11=CrestOptions.R4Ram;
  		params.u12=CrestOptions.R4Cat;
  		...
  		new AjaxRequest(unsafeWindow.g_ajaxpath + "ajax/march.php" + unsafeWindow.g_ajaxsuffix, {
  		         ...
  		         unsafeWindow.update_seed(rslt.updateSeed);
  		         if(rslt.updateSeed){unsafeWindow.update_seed(rslt.updateSeed)};
  		         CrestOptions.RoundFour = false;
               var now = new Date().getTime()/1000.0;
               now = now.toFixed(0);
               CrestOptions.lastRoundFour = now;
               Options.Crest4Count++;
  		         saveCrestOptions();
               } else {
               setTimeout (function(){t.SecondRound();}, 5000);
