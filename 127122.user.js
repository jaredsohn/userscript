...
(function(){
	...
	if($('a[type^="video/cappuccino"]').attr('class') == 'video'){

		GM_xmlhttpRequest({
			method: "GET",
			dataType: "html",
			url: $('a[type^="video/cappuccino"]').attr('href'),
			onload: function(response) {
				...
				btn = '<a href="'+finalUrl+'" target="blank">Lien vers ce programme</a><br/>';
				btn += $('.description').html();
				$('.description').html(btn);
			}
		});
	}
