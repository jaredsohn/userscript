// ==UserScript==
// @name           Feuerwache.net AAO und Tool Script by MasterJM
...
// @author         MasterJM
// @info1          Hinweis: das original Script stammt von "sawos" und ist hier auch erhaeltlich
// @info2          special thx to "Ereglam" for his support :)
// @info3          http://syslord.org/feuerwache.net/
// @version        2011-07-22 10:00
// ==/UserScript==
...
// Einsätze neu 12.05.2011
  'Unfall mit Gefahrgut-Transport'  : 'GSG2+FwK,GWA|TUIS',
  'Gefahrstoff-Austritt in Firma'   : 'GSG+LF,GWL,GWA|TUIS',  
// Einsätze neu 26.06.2011
  'Waldbrand'                       : 'F4+GWL',
  'Türöffnung'                      : 'F1', 
  'Küchenbrand'                     : 'F1',
  'Brand in Betankungsanlage'       : 'GSGR4|LF', 
  'VU mit Strassenbahn'             : 'TH2+FwK,ELW,GWS',  
  'VU mit Straßenbahn'              : 'TH2+FwK,ELW,GWS',
//Ergäzung thejo  
  'Kleintier in Not'              : 'LF',
...
// zu undef = unbekannten Einsatzen wird per Default jetzt ein LF geschickt
  ...
  'GSGR2'    :  'LF,LF,LF,LF,LF,RW,ELW,GWM,GWL,GWÖl,TUIS,ULF',
  'GSGR3'    :  'LF,LF,LF,LF,LF,RW,ELW,GWG,GWM,DL,GWL,TLF,FwK,TUIS,ULF',
  'GSGR4'    :  'LF,LF,LF,LF,LF,RW,GWG,GWM,GWA,ULF,TUIS',
...
// Einsätze neu 26.06.2011
  ...
  'Türöffnung'                      : 'http://wiki.feuerwache.net/wiki/T%C3%BCr%C3%B6ffnung', 
  'Küchenbrand'                     : 'http://wiki.feuerwache.net/wiki/K%C3%BCchenbrand',
