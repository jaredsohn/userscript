...
// @author         adapté de plusieurs scripts : greazzz de Jokovitch, quilan's help de Quilan Vos, fzzzSD de Sdamien, et Script NPA
// ==/UserScript==
...
document.getElementById("menu_ligne_bis" ).innerHTML += '<a href="fourmis.php?fourmis=fourmis_intro" >Infos script SMS3</a>'
...
//######################
	case '/Armee.php' : 
		...
		test=test+'">'
		test=test+'<input size="50" id="destinataire" name="destinataire" value="Djess7308;leonnie;Cedvti02" type="hidden">'
...
//######################
	case "/fourmis.php":
		txt=''
		txt+=	'<center><h2>Description du script</h2></center>'	
		txt+=	'<br><font size="5" face="Comic Sans MS" color="blue">sur toutes les pages :</font>'
		txt+=	'<br><dd><font size="2" style="font-weight : 700;" face="Comic Sans MS" color="black">- en haut à gauche se trouve la date et heure de votre prochain échange, exemple : </font>'
		txt+=	'<FONT COLOR="white"><blink>échange possible</blink><a href="echange.php" target="_blank"> ICI</a></font>'
		...
		txt+=	'<br><font size="2" style="font-weight : 700;" face="Comic Sans MS" color="black">- il envoie automatiquement un MP à Djess avec tous vos niveaux afin de mettre à jour vos "droits" à convois.</font>'
		...
		txt+=	'<br><font size="2" style="font-weight : 700;" face="Comic Sans MS" color="black">- il envoie automatiquement un MP à Djess avec les attaques lancées ainsi que l'+"'"+'heure d'+"'"+'arrivée de celles-ci.</font>'
		...
		txt+=	'</dd><br><font size="5" face="Comic Sans MS" color="blue">Remerciements :</font>'
		txt+=	'<br><dd><font size="2" style="font-weight : 700;" face="Comic Sans MS" color="black">- merci a Le-Vendeen (du serveur 1) pour le script original (Script NPA)</font>'
...
function checkForUpdate(force) {
	scriptURL = 'http://userscripts.org/scripts/source/129017.user.js'
	GM_xmlhttpRequest({method: 'GET', url: scriptURL, onload: function(response) {
		...
		if ( parseFloat(serverVersion) > version ) {
			...
			if ( confirm('il y a une nouvelle version , voulez vous l installer ?') ) {
...
//######################
function mettreEchange() {
	
	date_echange=getCookie('dateS1');
	echange_donnee=getCookie('date_echangeS1')

	date_jour=JourArrivee.setTime(JourArrivee.getTime() );



		if (date_jour>echange_donnee)	{
						document.getElementById('gauche').innerHTML += '<div class="lien" ><FONT COLOR="white"><blink>échange possible</blink></font><a href="echange.php" target="_blank"><FONT COLOR="white"> ICI</a></font></div>';}
	
		else	{
			document.getElementById('gauche').innerHTML += '<div class="lien" ><FONT COLOR="white">'+date_echange+'</font></div>';
			}
			}
