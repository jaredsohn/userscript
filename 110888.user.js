...
holder.innerHTML += '<a href="http://forums.d2jsp.org/forum.php?f=104"' +
 ' title="Bar and Pub Games" target="_blank">Multi Status</a>: ';
switch(resolveBettorType(user)){
 case 'med':
  holder.innerHTML += '<font color="chartreuse"><b>Mediator</b></font>';
  break;
 case 'welcher':
  holder.innerHTML += '<font color="purple"><b>Multi</b></font>';
  break;
 case 'active':
  holder.innerHTML += '<font color="">red<b>Active</b></font>';
  break;
...
function getNames(){
	...
	{
	    method: 'GET',
	    url: 'http://d2jsplist.alwaysdata.net/multi/multilists.html',
	    headers: 
		{
