// ==UserScript==
// @name           bbs.archlinux.org.newtopic
// @namespace      lobotomius.com
// @include        https://bbs.archlinux.org/post.php?fid*
// ==/UserScript==
...
function fetch(keywords) {
	...
	GM_xmlhttpRequest({
		method: "GET",
		url: "https://bbs.archlinux.org/search.php?action=search&forum=-1&search_in=all&sort_by=2&sort_dir=DESC&show_as=topics&keywords="+keywords,
