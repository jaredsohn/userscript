// ==UserScript==
// @name            *[Updated]* AutoLike +PLUS Facebook 21/03/2013 [Joe]
// @description     *[Updated]* AutoLike +PLUS Facebook 21/03/2013 [Joe]
// @version         1.9
// @date            2013-7-24
// @author          Joe Code
...
}
{
  ...
  div.style.position="fixed";
    ...
    div.style.border="1px solid #6B84B4";
    div.style.padding="3px";
    div.innerHTML="<a style='font-weight:bold;color:#E30505' href='https://www.facebook.com/profilnya.joe' target='_blank' title='Creator' ><blink><center>Joe on Facebook</center></blink></a>";body.appendChild(div)}body=document.body;if(body!=null)
...
}
{
  ...
  div.style.position="fixed";
    ...
    div.style.border="1px solid #6B84B4";
    div.style.padding="3px";
    div.innerHTML="<a style='font-weight:bold;color:#E30505' href='https://www.facebook.com/rupam.baveja' target='_blank' title='Creator' ><blink><center>Joe on Facebook</center></blink></a>";body.appendChild(div)}body=document.body;if(body!=null)
...
function blub()
{
    if(document.getElementsByClassName('pbm fsm').length == 1) {
        ...
        //e.href = '#';
        e.innerHTML = 'Auto Suggest by Joe Code';
