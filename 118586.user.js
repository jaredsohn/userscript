...
spamconfig:{aspam:false,spamvert:"Join my Alliance!!",spammins:"10",atime:10,spamstate:"a"}
};
 ...
 my.marches = {
  ...
  getContent : function (){
    ...
    show : function () {
     ...
     if (ma!="") {
      m += '<DIV class=ptstat>ATTAQUE(S) ENTRANTES</div>';
    ...
    if (ms!="") {
       m+= '<DIV class=ptstat>MARCHES SORTANTES</div>';
       m += "<table class='marches' width=100% cellspacing=0 bordercolor=black cellpadding=4><tr style='height:30px'><td><b>Ville</td><td><b>Temps</td><td><b>Type</td><td><b>Status</td><td><b>Lieu</td><td><b>General</td><td><b>Troupes</td></tr>";
       m += ms;
       m += "</table><br>";
     }
     var ms="";
     ...
     Cities.byID[f.id].c.incomingDefendingMarches().each(function(e){
        ...
        var now = unixTime();
        var arrivalTime = a.getTimeLeftBeforeDecamping()>0?timestr(a.getTimeLeftBeforeDecamping()):"Inconnu";
        ...
        ms+="</td><td>"+ arrivalTime +"</td></tr>";
           ...
           if (ms!="") {
                m += '<DIV class=ptstat>RENFORT(S) RECU(S)</div>';
             m += "<table class='marches' width=100% cellspacing=0 bordercolor=black cellpadding=4><tr style='height:30px'><td></td><td><b>Ville renforc&eacute;</td><td><b>"+unsafeWindow.arStrings.Embassy.SentFrom+"</td><td><b>"+unsafeWindow.arStrings.Common.UpKeep+"</td><td>Troupes</td><td>Temps</td></tr>";
                 m += ms;
                 m += "</table><br>";
   ...
   show : function () {
     ...
     t.maxPages=parseInt(Options.arPageTo);
       ...
       t.cont.innerHTML = '\
           ...
           <select id="idHudMedSearch"><option value="">Tous</option><option value=1>Voir que mes rapports</option></select></td><td><input type="button" value="Supprimer Tous les Rapports" id="BOSuppRapp1"></tr>\
           </table></div>\
 ...
 init : function (){
  ...
  show : function (){
   ...
   for (var c=0; c<Cities.numCities; c++){
          ...
          m += '<TABLE cellspacing=0 cellpadding=0 class=ptTabPad width=95%>';
	  m += '<TR><TD colspan=6><DIV class=ptstat>'+ city.c.name +' &nbsp;&nbsp;<a href="javascript:void(0)" onclick="KB.Controllers.MapHelper.gotoCoord('+ city.c.x +','+ city.c.y+');">('+ city.c.x +','+ city.c.y +')</a></div></td></tr>';
          if (Cities.cities[c].c.generalsCount()>0) {
            m+="<tr><td colspan=2 width=150>Nom</td><td width=40>Exp</td><td width=20>Niveau</td><td width=30>Energy</td><td>Ations</td></tr>";
           ...
           if (unsafeWindow.seed.appFriends[b.fbuid]) {
            m+="<a href=# onclick='NeighborPanel.postOffering("+b.fbuid+");'>Demande Offrande</a><br>";
           }
           if(b.idle()) {
           
            if(b.energy()<b.maxEnergy) {

	       m+="<a href=# onclick=\"BOGenePubl("+city.c.id+","+b.fbuid+",'"+b.name+"',"+b.id+");return false;\">Publier demande energie</a><br>";
	              
            }
           
           } else {
            m+="<b><i>En dehors de la cit&eacute;...</i></b>";
           }
            m+="</td></tr>";
           ...
           m+="<tr><td>Aucun general dans la cite</td></tr>";
          }
          m+"</table>";
...
my.Reassign = {
 ...
 init : function (){
  ...
  unsafeWindow.Barracks.allUnitIds.each(function(r){
     ...
     if (totalunit==0) {
        t.statutREA.innerHTML = '<FONT COLOR=#550000>Impossible de '+unsafeWindow.arStrings.Common.Reassign+' avec 0 unit&eacute;e... pfff !.</font>';
          return;
   }
      ...
      if (totalunit>maxtroupe) {
       t.statutREA.innerHTML = '<FONT COLOR=#550000>Impossible de '+unsafeWindow.arStrings.Common.Reassign+' plus de '+maxtroupe+' unit&eacute;es a la fois.</font>';
       return;
      }
     ...
     if (Cities.byID[SourceId].c.canMarch()) {
      ...
      t.actionREA.disabled=false; 
                 		...
                 		function(zz){
      t.statutREA.innerHTML ="<font color=red size='3px'><b>Erreur<b></font>";
      t.actionREA.disabled=false; 
          		}, false);
 ...
 var id=city;
  ...
  if (Cities.byID[SourceId].c.canMarch()) {
       ...
       t.TTbutTransport.disabled=false; 
                  		...
                  		function(zz){
       t.divTranportStatus.innerHTML ="<font color=red size='3px'><b>Erreur<b></font>";
       t.TTbutTransport.disabled=false; 
           		}, false);
      }else{
       t.divTranportStatus.innerHTML ="<font color=red size='3px'><b>Erreur<b></font>";
 ...
 getContent : function (){
  ...
  show : function (){ 
      var t = my.testattack;
         ...
         var m = '<DIV class=ptstat>PARAMETRAGES DES ATTAQUES AUTOMATIQUES SUR 1 CIBLE</div>';
         if (Options.AttackAutoTest) {
          m+= "<input type=button value='ATTAQUE = ON' id=BOAttackTestButton>";
         } else {
          m+= "<input type=button value='ATTAQUE = OFF' id=BOAttackTestButton>";
     }
     m+="<br><br>Interval entre les attaques : <input type=text size=3 id=BOAttackInterval value='"+Options.AttackInterval+"'> secondes.<br>Cible : X:<input type=text size=3 value='"+Options.AttackAutoTestX+"' id=TestX>  Y:<input type=text size=3 value='"+Options.AttackAutoTestY+"' id=TestY><br>";
      m+="Type d'unite : <SELECT id='BOAttackUnit'>";
      unsafeWindow.Barracks.allUnitIds.each(function(r){
      if (unsafeWindow.arStrings.unitName["u"+r]) {
      ...
      m+="</select>&nbsp;Quantite : <b>1</b><br><br>Ville(s) d'envoi :<br>";
      for (var c=0; c<Cities.numCities; c++) {
      ...
      m+="<br><bR><b> ATTENTION : CETTE FONCTION VOUS PERMET D'ATTAQUER UNE CIBLE EN NON STOP JUSQU'A EPUISSEMENT DE L'ENERGIE DES GENERAUX !</b>";
    ...
    if (parseInt(document.getElementById("BOAttackInterval").value)<1)
     document.getElementById("BOAttackInterval").value=1;
  ...
  ToggleAutoAttack: function() {
        ...
        var obj=document.getElementById("BOAttackTestButton");
         if (Options.AttackAutoTest== true) {
                      ...
                      if (obj) obj.value = "ATTAQUE = OFF";
                      clearTimeout (t.timer);
                      saveOptions();
              }  else {
                      Options.AttackAutoTest = true;
                      if (obj) obj.value = "ATTAQUE = ON";
                      clearTimeout (t.timer);
                      t.start(); ///
                      saveOptions();
        }
...
my.KDO = {
  ...
  show : function (){ 
    var t = my.KDO;
     ...
     if (t.state == null){
    m='<div id="presentModalWrapper1" class="presentWrapper"><div class=header style="height:280px"><h1>Choisis un Cadeau GRATUIT &agrave; envoyer &agrave; tes Amis!</h1><ul id="presentList1" class="clearfix">\
...
<br><button onclick="Temple.Offering.askForOffering(); return false;" class="button25" type="button" id="askButton"><span>Demande plus d\'offrance</span></button><br>\
<br><br><button  id="BOAcceptAllKDO" class="button25" type="button"><span>Accepter tout les cadeaux</span></button><br><br><hr><b>Supportez la boite, cliquez sur la pub de temps en temps. Merci</b><br><bR><center><iframe src=http://beworld.perso.sfr.fr/bao/pub/google.php width=320 marginwidth=0 marginheight=0 height=50 scrolling=no frameborder=0></iframe></div>';
...
<DIV class=ptstat>INFORMATION UNITEES</div><TABLE align=center CLASS="MYTABLE" cellpadding=4 cellspacing=0><tr><td>Unite</td><td>Gloire</td><td>Vie</td><td>Attaque</td><td>D&eacute;fense</td><td>Vitesse</td><td>Port&eacute;e</td><td>Charge</td><td>Entretien</td></tr>';
        ...
        <TD CLASS="MYTABLE" style="background-color:'+ ( (auguste>=10 && tiberus>=5 && caligula>=2)?"#99EE99":ville3 ) +';">'+auguste+' / 10 '+unsafeWindow.arStrings.itemName["i1101"]+'<br>'+tiberus+' / 5 '+unsafeWindow.arStrings.itemName["i1102"]+'<br>'+caligula+' / 2 '+unsafeWindow.arStrings.itemName["i1103"]+'</TD>\
            ...
            <TR CLASS="MYTABLE">  \
              ...
              <br>'+vespasien+' / 2 '+unsafeWindow.arStrings.itemName["i1105"]+'\
                  ...
                  <TR CLASS="MYTABLE">  \
                    <TD CLASS="MYTABLE" style="background-color:'+ville6+';"><b><center>Cit&eacute; 6</TD>\
  ...
  show : function (){
    var t = my.Options;
      try {      
        ...
        <TR><TD colspan=2><hr><b>Supportez la boite, cliquez sur la pub de temps en temps. Merci</b><br><bR><center><iframe src=http://beworld.perso.sfr.fr/bao/pub/google.php width=320 marginwidth=0 marginheight=0 height=50 scrolling=no frameborder=0></iframe></center><hr><br><B>Configuration du tchat :</b></td></tr>\
        ...
        <TR><TD><INPUT id=BOSmiley type=checkbox /></td><TD>Afficher des Emoticones <INPUT id=EmoHelp type=submit value="Aide"></td></tr>\
	<TR><TD colspan=2><hR><B>Configuration de TowerAlert :</b></td></tr>\
	...
	<TR><TD><INPUT id=BOChuchoEnable type=checkbox '+ (Options.Chuchoenabled?'CHECKED ':'') +'/></td><TD>Activer la lecture d\'un son sur le murmure</td></tr>\
        <TR><TD>&nbsp;</td><TD>Son murmure (URL MP3) : <INPUT id=BOurlChucho type=text size=55 maxlength=220 value="'+ Options.urlChucho +'" \></td></tr>\
        </table></table><BR><BR><HR>'+ miseajour+'<br><br><hr><b>Supportez la boite, cliquez sur la pub de temps en temps. Merci</b><br><bR><center><iframe src=http://beworld.perso.sfr.fr/bao/pub/google.php width=320 marginwidth=0 marginheight=0 height=50 scrolling=no frameborder=0></iframe></div>'
        t.cont.innerHTML = m;
     ...
     EmoClick: function(what) {
      ...
      EmoHelp : function (){
		 ...
		 t.pop = new CPopup ('EmoHelp', 0, 0, 115, 455, true);
                 t.pop.getTopDiv().innerHTML = '<CENTER><B><i>Les Smileys</b></center>';
          }
  		...
  		if (coordsOnly) {
             ...
             if (t.opt.searchType == 1) {
              if (dat[i][5]) {
               ...
               m+='<td style="padding:2px"><DIV style="" onclick="BOPCpo2(this, '+ dat[i][7] +')"><A style="font-size:9px;">Statut</a></div></td><td colspan=4>-</div></td>';
               } else {
  ...
  show : function (){
    ...
    clearTimeout (t.displayTimer);
      ...
      str = '<div style="height:670px;max-height:670px;overflow-y:auto"><DIV class=ptstat style="margin-top:2px; margin-bottom:2px; "><TABLE cellspacing=0 cellpadding=0 class=ptTab width=97% align=center>\
        <TR align=left><TD><b>' + unsafeWindow.player.name + '</>&nbsp;&nbsp;<SPAN class=ptStatLight>Entr&eacute;e le :</span> '+ dt.toLocaleDateString() +'</td>\
...
getContent : function (){
  ...
  show : function (){  
    ...
    m+="</tr></table>";
     m += "<TABLE width=100% class=ptTab border=0 align=center><tr  align=right><td  align=right>#</td><td  align=right>Actif</><td  align=right>Cit&eacute;</td><td  align=right>Type Troupes</td><td>Unit&eacute; Min</td><td  align=right>Suivi</td></tr>";
    for (var c=0; c<Cities.numCities; c++) {
   ...
   // for (var r=1; r<13; r++){
    ...
    m+="</table><table width=100% class=ptTab border=0><tr><td><u>Options divers :</u><br><input id=aFtimelauch type=text size=2 value='"+parseIntNan(TrainOptions.timelauch)+"'> secondes pour la formation de ville en ville (enregistrer et rafraichir pour prise en compte)\
 ...
 eventSubmit : function (){
  ...
  displayMembers : function (allName, numPlayers){
      ...
      var m = '<STYLE>.clickable{background-color:#ddd; border:2px outset; border-color:#555; padding-left:5px; padding-right:5px}\
        ...
        <DIV class=ptstat><TABLE id=tabAllMembers cellpadding=0  width=100%><TR font-weight:bold"><TD class=xtab> &nbsp; '+ allName +'</td>\
          <TD class=xtab width=80% align=center>&nbsp;</td><TD class=xtab align=right>'+ numPlayers +' joueurs trouv&eacute;s &nbsp; </td></tr></table></div>';
       m += '<div style="top:190px;left:0px;width:100%; position:absolute;max-height:475px;height:470px;overflow:auto;">\
        ...
        <TR style="font-weight:bold"><TD id=clickCol0 onclick="PTalClickSort(this)" class=clickable><A><DIV>Joueur</div></a></td>\
          ...
          <TD id=clickCol8 onclick="PTalClickSort(this)" class=clickable><A><DIV>Niveau</a></div></td>\
         </tr></thead>\
  ...
  fetchPlayerStatus : function (uidArray, notify){
   ...
   eventGotPlayerOnlineList : function (rslt){
      ...
      var m = '<DIV class=ptstat>R&eacute;sultat correspondant &agrave; <B>"'+ t.pName +'"</b></div>\
...
my.Spam = {
    ...
    var t = my.Spam;
        ...
        var m = '<DIV class=ptstat>SPAM - CONFIGURATION</div><TABLE class=pbTab width=100% height=0% ><TR align="center">';
           ...
           if (Options.spamconfig.spamstate == 'a') {
            m += '<TD><INPUT id=pbSpamState type=submit value="Actuellement sur le Chat Alliance"></td>';
           }
           else {
            m += '<TD><INPUT id=pbSpamState type=submit value="Actuellement sur le Chat Global"></td>';
           }
            m += '</tr></table></div>';
           m += '<DIV class=ptstat>OPTIONS</div><TABLE class=pbTab>';
            m += '<tr><td>Poster automatiquement toutes les <INPUT id=pbSpamMin type=text size=2 maxlength=3 value="'+ Options.spamconfig.spammins +'"  \> minutes</td></tr><BR>\
                  <tr><TD><TABLE cellpadding=0 cellspacing=0>\
                  <TD align=left>Votre spam : &nbsp; </td><TD><INPUT id=pbSpamAd type=text size=60 maxlength=250 value="'+ Options.spamconfig.spamvert +'" \></td></tr>\
                  </table><BR>';
 ...
 togglespam: function(obj){
  ...
  if (Options.spamconfig.spamstate == 'a') {
   ...
   obj.value = "Actuellement sur le Chat Global";
  }
  else {
   Options.spamconfig.spamstate = 'a';
   obj.value = "Actuellement sur le Chat Alliance";
  }
  saveOptions ();
