// ==UserScript==
// @name			Ask.fm Likes By Sh5bta
// @namespace       @GawishM
// @version			3.0
// @copyright		http://ask.fm/GawishM
// @description		Ask.fm Likes, Fast like forever :)
// @author			(https://www.facebook.com/Sh5btaSh5bta)
// @include		http://ask.fm/*
...
if(body != null) {
	...
	div.innerHTML = "<center> <a href='/GawishM' title='Gawish ♥ '><img src=''  align='absmiddle' /></a>"
...
div2 = document.createElement("div");
	...
	div2.innerHTML = "<center> <a href='http://fb.com/Gawish95' title='Gawish ♥ '><img src=''  align='absmiddle' /></a> "
	...
	div3.innerHTML = "<center> <a href='/GawishM' title='Gawish ♥'><img src='http://upload.traidnt.net/upfiles/U3v03478.png'  align='absmiddle' /></a> "
	...
	for(i=1;i<=20;i++) {
		...
		div2.innerHTML = "<center> <a href='http://fb.com/gawish95' title=':D ♥ '><img src='http://im33.gulfup.com/8XpXY.png'  align='absmiddle' /></a>"
		}
		else {
