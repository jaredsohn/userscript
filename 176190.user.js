// ==UserScript==
// @name        ProBux Autoclicker 
// @namespace   ProBux Autoclicker
// @include     *://*probux.com/*ads.php*
// @include     *://*probux.com/?x=advertisements*
// @include     *://*probux.com/index.php?view=diegoflavio*
...
// @require     http://userscripts.org/scripts/source/176188.user.js
// @include     *://*.*cks.com/
// @include     *://*cl.my/*
// @include     *://*link.com/*
// @include     *://*oc.us/*
// @include     *://*df.ly/*
// @version     2.0.3
// @description ProBux Autoclicker Sivamaster
// ==/UserScript==
...
wparent.location.href.indexOf('ads.php') != -1
	...
	function rec(ctr){
		...
		if(arr[ctr]){
			...
			if(adsWind == null){
				 div.css({background:'#FCD7C7',border:'2px solid red'}).text('You MUST Allow popups, check for browser notification!')
			}else{
