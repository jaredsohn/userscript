...
api = win.ScriptAPI;
api.register( 'Farmhelfer', [8.4, 8.5], 'picnik', 'picnik2@online.de' );
...
function fh_popup(heading,text,options){
    ...
    "<div class='fh-ui-popup-close' style='width:100%; text-align: right;'><a href=# onclick=\"$('.fh-ui-popup').fadeOut('slow')\">اغلاق</a></div>" +
...
(function($){
    ...
    $(document).ready(function(){
        ...
        // innerhalb eines berichts
            ...
            $('a[href*="type=same"]').html("» مهاجمة القرية بنفس عدد الجيش (s)");
        }
        ...
        // versammlungsplatz
            ...
            // fuege dem linken menu einen link zu den مديرالوحدات einstellungen hinzu
            // dieser oeffnet ein popup in dem der user seine vorlagen bearbeiten kann
            $(".modemenu").append("<tr><td><a href='#' class='fh-ui-link'>مديرالوحدات</a></td></tr>");
            ...
            $(".fh-ui-link").live('click',function() {
                ...
                var html = '<form class="fh-ui-form" style="text-align: center;">' +
                    ...
                    html += '</table><br><input type="submit" value="تطبيق"></form>';

                // popup anzeigen
                fh_popup("مديرالوحدات - محررالمجموعات",html,popup_options);
            ...
            $(".fh-ui-form").live('submit',function(e) {
                ...
                UI.InfoMessage("Deine Daten wurden gespeichert.\nDu kannst sie jederzeit auf dem Versammslungsplatz unter 'Farmhelfer' bearbeiten.",5000);
            });
        }
    });
