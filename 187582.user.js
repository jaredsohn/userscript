...
// @downloadURL     http://userscripts.org/scripts/source/187582.user.js
// @updateURL       http://userscripts.org/scripts/source/187582.meta.js
// ==/UserScript==
...
function announce_init_blocks() {
    if ($('#orderContainer').length > 0) {
        ...
        GM_xmlhttpRequest({
            method  : 'Get',
            url : 'http://DSW.erep.ir/announce?id=' + parseFloat(unsafeWindow.flc.getVariable("citizen_id")),
