...
fnCheckShortcut = function(e){
	...
	} else if(e.ctrlKey && e.shiftKey && e.keyCode == 69){ // Ctrl + Shift + E will open Editing profile
		window.location.href = "http://www.orkut.com/EditSummary.aspx";
	} else if(e.ctrlKey && e.shiftKey && e.keyCode == 50){ // Ctrl + Shift + A will open Album
		window.location.href = "http://www.orkut.com/AlbumList.aspx";
	} else if(e.ctrlKey && e.shiftKey && e.keyCode == 55){ // Ctrl + Shift + V will open Videos
		window.location.href = "http://www.orkut.com/FavoriteVideos.aspx";
	} else if(e.ctrlKey && e.shiftKey && e.keyCode == 60){ // Ctrl + Shift + M will open Messages
