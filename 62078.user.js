// ==UserScript==
// @name KingsAge : Auto update script
// @namespace http://userscripts.org/scripts/admin/62078
// @description Auto update units in village
// @date 2009-11-16
// @creator NUT
// @include http://*.kingsage.bg/game.php?village=*&s=build_barracks&m=recruit
// @exclude
// ==/UserScript==
...
(function(){
	...
	if (text.search("/") != -1) { temp_voiski = text.split(' / '); voiski[j]=temp_voiski[1];j=j+1; }
	else { if (text.length > 30) { voiski[j]=0; j=j+1;} }
  	}
	for (i=j; i<11; i++){ voiski[i]=0; }

	voiska = username + "|" + name_village + "|" + x + "|" + y + "|";
	for (i=1; i<11; i++){ voiska=voiska+voiski[i]; voiska=voiska+"|"; }
	table2 = document.getElementsByTagName('table');
	table = table2[24].getElementsByTagName('tr');
			var oLink = document.createElement("td");
			oLink.innerHTML = "<a href='http://kings.x10hosting.com/auto_update.php?voiska="+voiska+"' target='_blank'><b>&#1040;&#1042;&#1058;&#1054;&#1052;&#1040;&#1058;&#1048;&#1063;&#1053;&#1054; &#1054;&#1041;&#1053;&#1054;&#1042;&#1071;&#1042;&#1040;&#1053;&#1045;!</b></a>";
			oLink.title = "Update";
