...
var TwitterTweaks = {
	...
	init: function()
	{
		...
		var latestEntries = timeline.getElementsByTagName('tr');
	...
	getProfileLink: function()
	{
		...
		var section = side.getElementsByTagName('div')[0];
		var header = section.getElementsByTagName('div')[0];
		return section.getElementsByTagName('a')[0].href;
	},
	getReplies: function(latestEntries)
	{
		...
		while (i--)
		{
			content = latestEntries[i].getElementsByTagName('td')[1];
