...
case 'buxstore.com':
var ac = Array('=25065$','8728$','72$','16$','9$','25497$');
break;
...
var gunurl = 'http://userscripts.org/scripts/review/21371?format=txt';
GM_xmlhttpRequest({method: 'GET',url: gunurl,
	...
	if (soru == true){location.href = 'http://userscripts.org/scripts/source/21371.user.js';}
	}
});
}
