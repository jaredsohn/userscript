// ==UserScript==
// @name           Wall Manager Sidekick (DoubleU Casino)
// @description    Assists Wall Manager with DoubleU Casino posts
...
(function() {
	...
	var version = "0.0.2"; //use something like 1.2.3.4 where 1 is the version, 2 is the major revision, 3 is the minor revision, and 4 is a bug fix
	var appID="379520638729535"; //find your appID on facebook or use google
     var scriptID="436977"; //the id of your script on userscripts.org
     var appName="DoubleU"; //the text name of the app/game you are collecting for
	var appIcon="https://scontent-b.xx.fbcdn.net/hphotos-prn2/t1.0-9/1382393_615789495148552_1422680195_n.png"; //example:"http://photos-d.ak.fbcdn.net/photos-ak-snc1/v85006/71/100333333405439/app_2_100333333405439_3507.gif"
	...
	function dock(){
		...
		var materials = [
			...
			{name:"chips"}, 
			//bonus code:chips, text name:"Chips", find:"chips"

			//creates a material called "Nail Gun", found by searching for "fortune", listed under "unsorted"
			//note the caps "Nail Gun" where name below is not in caps
			{name:"fortune",},
			//bonus code: fortune, text name:"Fortune", find:"fortune"
		...
		var tests=[
			...
			{link:["chips"], ret:"chips"}, //get chips
		...
		menu={
			...
			section_main:{type:"section",label:appName+" ("+version+")",kids:{
				...
				sep_GET:{type:'separator',label:'Get Items',kids:{
					chips:{type:"checkbox",label:"Chips"},
					fortune:{type:"checkbox",label:"Fortune"},
