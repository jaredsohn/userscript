...
// @namespace      tmall
// @version      2012100102
// @include        http://www.pepsitmall.com/utc/product/l_dream001/detail.htm*
// ==/UserScript==
...
function checkProductCount() {
  $.getJSON('http://www.pepsitmall.com/utc/product/1807/l_dream001/getInventory.json?r=' + (new Date()).getTime(), function(json){
...
function refreshValidateCode() {
    $("#validateCode").attr("src", 'http://www.pepsitmall.com/utc/getValidateCodePic.htm?productCode=l_dream001&a=' + new Date());
    $('#checkCode').focus();
}