...
// @name           ASTools
// @namespace      AStips
// @description    Herramientas para la alianza -AS-
// @include        http://*ikariam.*/index.php*
// @author         Original por Verx - Modificado por MacMesias para -AS-
// @version        20080615 102433
// ==/UserScript==

var ASToolsIds  = new Array("opclos","FontForm","buscaBox","worldBox");
...
'<div id="menu">'
+ '<ul>'
+ ' <li><h2>Elite Sardaukar</h2>'
+ '   <ul>'
+ '     <li><center><a target="" href="http://s1.ikariam.es/index.php?view=sendAllyMessage&oldView=diplomacyAdvisor&watch=4&id=38467&position=13&type=50" title="Envia mensaje Circular">Mensaje Circular</a></li>'
+ '     <li><center><a target="_blank" href="http://www.alianzasilmarillion.com.ar" title=" Web de la Alianza -AS- ">Web Elite Sardaukar</a></li>'
+ '     <li><center><a target="_blank" href="http://www.alianzasilmarillion.com.ar/foro" title=" Foro de la Alianza -AS- ">Foro Elite Sardaukar</a></li>'
...
//+ '     <li><a href="#" title="Cambia il font" onclick="showTools(1)">Font <input style="margin-left:10px; visibility:hidden;" id="c'+ASToolsIds[0]+'" type=CheckBox CHECKED DISABLED /></a></li>'
...
//+ '     <li><a href="#" title="Cerca un bersaglio" onclick="showTools(3)">Scansione <input style="margin-left:10px; visibility:hidden;" id="c'+ASToolsIds[3]+'" type=CheckBox CHECKED DISABLED/></a></li>'
...
elemToShow = document.getElementById(ASToolsIds[toolID[i]]);

if (elemToShow) {
 if ((toolID[i] == 0) || (toolID[i] == 1)) {if (document.getElementById(ASToolsIds[0]).style.visibility == 'hidden') {
 document.getElementById(ASToolsIds[0]).style.visibility = 'visible';
 document.getElementById(ASToolsIds[1]).style.visibility = 'visible';
 if (document.getElementById('c'+ASToolsIds[0])) document.getElementById('c'+ASToolsIds[0]).style.visibility='visible';
 } else {
 document.getElementById(ASToolsIds[0]).style.visibility = 'hidden';
 document.getElementById(ASToolsIds[1]).style.visibility = 'hidden';
 if (document.getElementById('c'+ASToolsIds[0])) document.getElementById('c'+ASToolsIds[0]).style.visibility='hidden';
 }  } else {
 if (elemToShow.style.visibility == 'hidden') {elemToShow.style.visibility = 'visible'; if (document.getElementById('c'+ASToolsIds[toolID[i]])) document.getElementById('c'+ASToolsIds[toolID[i]]).style.visibility='visible';}
 else {elemToShow.style.visibility = 'hidden'; if (document.getElementById('c'+ASToolsIds[toolID[i]])) document.getElementById('c'+ASToolsIds[toolID[i]]).style.visibility='hidden';}
 }
}
}
}
...
var elemTrigger = document.getElementById(ASToolsIds[0]);
