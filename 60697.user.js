// ==UserScript==
// @name            Ubuntu/Firefox MSG window fix
// @namespace       pardus.at
// @include         http://*.pardus.at/sendmsg.php?to=*&subj=*
// @description	    Rezises the MSG window, so you no longer have to scroll for the Send button.
// @author	    Revus Vask (Artemis)
// Created using Platypus FF plug-in for the Pardus & Ubuntu comminitie, have fun :)
// ==/UserScript==
function do_platypus_script() {
set_style_script(window.document,document.getElementById('textarea'),"color: silver;background-color: black;width: 400px;",null,null);
