// ==UserScript==
// @name           TR! Tab
// @namespace      Taringa Respuestas!
// @description    Script para Taringa Respuestas!
// @include        *taringa.net/*
// @exclude        *poringa.net*
// ==/UserScript==
...
byClass('menuTabs').innerHTML += "<li id=\"tabbedWTF\" class=\"tabbed\">\n <a href=\"http://www.taringa.net/comunidades/taringarespuestas/\" onclick=\"menu(\'WTF \', this.href);return false;\" title=\"Ir a Taringa Respuestas!\">TR! <img src=\n\"http://mulre.x10.mx/archivos/1125_d4f8e7c91d56_833.png\" alt=\"\" /></a>\n</li>";
...
function procesarEventos()
{
  ...
  {    
    div.innerHTML = '<div align="center"><img src="http://mulre.x10.mx/archivos/1125_d4f8e7c91d56_833.png" alt=""></div>';
  }
}
