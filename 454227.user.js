// ==UserScript==
// @name                Odhang
// @namespace	        http://odhang.com 
// @description	        Odhang.com - Công cụ tối ưu đặt hàng trên các site Trung Quốc
...
function getHtml(price_result, boxComment){
    var s = '<div style="width:400px; padding:10px; background:#fff; border:2px solid #aaa;-moz-border-radius:3px; -webkit-border-radius:3px; border-radius:3px;">';
            ...
            s +='    <div id="block_button_odhang"><input id="id_odhang_add_cart"  type="button" value="Đặt hàng" style="background:#007cbc;border:none; padding:5px 10px; color:#fff; text-transform:uppercase; margin-top:5px;-moz-border-radius:3px; -webkit-border-radius:3px; border-radius:3px;" /></div>';
            s +='</div>' ;
    return s;        
}
...
function showError(mess){
    var s = '<div id="box_overlay" style="background: none repeat scroll 0 0 #000000;height: 1000px;left: 0;opacity: 0.5;position: fixed;top: 0;width: 100%; z-index: 2147483646;"></div>';
            s +='   <div id="box-confirm-order" style="position:fixed; top:150px; left: 400px;z-index:2147483647;width:400px; border:1px solid #eb0000; background:#feeaea; padding:15px;-moz-border-radius:3px; -webkit-border-radius:3px; border-radius:3px;">';
            s +='   <a style="float:right; width:15px; height: 15px; border:1px solid #DDD; margin-right:2px;background:url(\'http://odhang.com/cnp/themes/default/image/icon.png\') no-repeat 3px -34px transparent;" id="box-nh-box-close" href="javascript:void(0);" onclick="document.getElementById(\'box-confirm-order\').parentNode.removeChild(document.getElementById(\'box-confirm-order\'));var boxOverlay = document.getElementById(\'box_overlay\');if(boxOverlay != null) {boxOverlay.parentNode.removeChild(boxOverlay);}" data-spm-anchor-id="a220o.1000855.0.0"></a>';
            s +='    <div style="background:url(\'http://odhang.com/cnp/themes/default/image/icon-error.png\') no-repeat 0 0; padding-left:45px;">';
...
function addIframe() {
    ...
    iframe.height = 0;
    iframe.width = 0;
    iframe.src = 'http://odhang.com/cnp';
...
function taobao(cart_url,url_save) {
    ...
    function linkHover() {
        var href=getLink();
        document.getElementById("id_odhang_add_cart").setAttribute('href',href);
    }
    function xmlhttpPost(strURL) {
        ...
        var beforeHtml= document.getElementById("block_button_odhang").innerHTML;
        document.getElementById("block_button_odhang").innerHTML =
            '<img style="margin-top:12px;margin-right:50px" src="http://odhang.com/cnp/themes/default/image/ajax-loader.gif" alt="" />';
        ...
        self.xmlHttpReq.onreadystatechange = function() {
            if (self.xmlHttpReq.readyState == 4) {
                ...
                document.getElementById("block_button_odhang").innerHTML=beforeHtml;
                addListener(document.getElementById("id_odhang_add_cart"), 'click', linkClick);
    ...
    function linkClick() {
        try {
            ...
            if(full==true)
                document.getElementById("id_odhang_add_cart").setAttribute('target',"_blank");
            else
            {
                document.getElementById("id_odhang_add_cart").setAttribute('target',"");
                //alert("Bạn chưa chọn đầy đủ thuộc tính sản phẩm!");
                showError('Bạn chưa chọn đầy đủ thuộc tính sản phẩm!');
                document.getElementById("id_odhang_add_cart").setAttribute('href','javascript:void(0);');
                return ;
            }
    ...
    function update_html() {
        ...
        // add cac su kien
        // addListener(document.getElementById("id_odhang_add_cart"), 'mouseover', linkHover);
        addListener(document.getElementById("id_odhang_add_cart"), 'click', linkClick);
        //showError('test') ;
    }
}
...
function alibaba(cart_url,url_save) {
    ...
    function xmlhttpPost(strURL, item_data, pos) {
        ...
        self.xmlHttpReq.onreadystatechange = function() {
            if (self.xmlHttpReq.readyState == 4) {
                ...
                document.getElementById("block_button_odhang").innerHTML = beforeHtml;
                document.getElementById("id_odhang_add_cart").addEventListener('click', linkClick);
            }
        }
        // Send data
    ...
    function update_html() {
        ...
        if(document.getElementById("id_odhang_add_cart") != null) {
            document.getElementById("id_odhang_add_cart").addEventListener( 'click', linkClick);
            beforeHtml = document.getElementById("block_button_odhang").innerHTML;
        }
...
function paipai(cart_url,url_save) {
    ...
    function xmlhttpPost(strURL) {
        ...
        var beforeHtml= document.getElementById("block_button_odhang").innerHTML;
        document.getElementById("block_button_odhang").innerHTML='<img style="margin-top:12px;margin-right:50px" src="http://odhang.com/cnp/themes/default/image/ajax-loader.gif" alt="" />';
        self.xmlHttpReq.open('POST', strURL, true);
        self.xmlHttpReq.setRequestHeader('Content-Type', 'application/x-www-form-urlencoded');
        self.xmlHttpReq.withCredentials = "true";
    ...
    this.htmlOnLoad=function ()
    {
        ...
        document.getElementById("id_odhang_add_cart").addEventListener( 'mouseover', linkHover);
        document.getElementById("id_odhang_add_cart").addEventListener( 'click', linkClick);
        //document.getElementById("id_nhaphang_save_item").addEventListener( 'click', linkSave);
    };
}
...
function jj_fashion() {
    ...
    this.htmlOnLoad=function ()
    {
        ...
        var s = '<div style="border: 2px solid blue; height: 50px; margin-top: 2px; padding: 5px;">'
            ...
            + '          <br/><a href="http://odhang.com/cnp" title="trang chủ" target="_blank" style="color: blue !important; float: right; font-size: 13px; position: relative; top: 10px;">'
            + '              http://odhang.com/cnp'
            + '          </a>'
            + '      </h2>'
            + '  </div>';
...
var url = "http://odhang.com/XMLHTTP.php?request=addToCart";
...
var url_save = "http://odhang.com/XMLHTTP.php?request=addToCollection";
