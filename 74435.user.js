...
// @version        $Id: infozentrale.user.js 21 2014-05-05 06:28:42Z mkl $
...
// Eigene Icons
var imgPrefix = new Array('http://www.image-upload.de/image/', 'http://www.bilder-upload.eu/upload/', 'http://www.bilderdepot.eu/images/');
var ICON_FIGHT_OK = 'nkzdhR/06e766f7ab.gif#f025e7-1389558340.gif#1389869045.gif';                  // Icon Kampfstärke OK (icon_fight_ok.gif)
var ICON_FIGHT_WEAK = 'MJbM9l/20da776d6d.gif#ccc4fa-1389558439.gif#1390637776.gif';                // Icon Kampfstärke NICHT OK (icon_fight_weak.gif)
var ICON_FIGHT_DANG = 'ya6gDp/1146914224.png#5d62dc-138955847#1389947864.png';                     // Icon Kampfstärke Gefahr (rottotenkopf.png)
var ICON_NEW = 'eakOip/4f445c6bdc.png#5445d6-1389558511.png#1390240000.png';                       // Icon für Ergebnisänderungen ("NEU") (new.png)
var ICON_WUTAKTIV = '3Udzek/26d67c826c.gif#bb1de2-1389558549.gif#1390472941.gif';                  // Icon für Wut AKTIV (icon_wutaktiv.gif)
var ICON_WUTINAKTIV = '3Ru5jz/a7a4bd2afa.gif#61563b-1389561074.gif#1389987211.gif';                // Icon für Wut INAKTIV (icon_wutinaktiv.gif)
var ICON_ERROR = 'maxjdj/a168eff1fd.png#1ec4c3-1389558621.png#1390093136.png';                     // Icon für Fehler beim Abrufen einer Seite (503.png)
var ICON_ATTDEFWPNBACK = new Array();                         // Icon ATT/DEF/WPN-Hintergrund
    ICON_ATTDEFWPNBACK[0] = 'HA6DN6/8efe50f155.png#fce4f5-1388268403.png#1390489908.png';          // attdefwpn.png
    ICON_ATTDEFWPNBACK[1] = '32FqJg/6d5edd0fd9.gif#543915-1388267689.gif#1390133937.gif';          // attdefwpn.gif
var ICON_ATTDEFJOBBACK = new Array();                         // Icon ATT/DEF/JOB-Hintergrund
    ICON_ATTDEFJOBBACK[0] = 'C7uBE9/2861c2d3b0.png#fe6bc6-1388268441.png#1389879238.png';          // attdefjob.png
    ICON_ATTDEFJOBBACK[1] = 'C7uBE9/2861c2d3b0.png#fe6bc6-1388268441.png#1389879238.png';          // attdefjob.png
var ICON_PLNDWUTPOWERBACK = new Array();                      // Icon Hintergrund für Plunder, Wut und Power
    ICON_PLNDWUTPOWERBACK[0] = '6ASitw/c5f1298f32.png#61adc1-1388268510.png#1390571761.png';       // plndwutpower.png
    ICON_PLNDWUTPOWERBACK[1] = '0pdaVx/23cfb1ae62.gif#a9be42-1388268559.gif#1390689622.gif';       // plndwutpower.gif
var ICON_PLNDWIWUPOWERBACK = new Array();                     // Icon Hintergrund für Plunder, WiWu und Power
    ICON_PLNDWIWUPOWERBACK[0] = 'L1m4gY/bdd713c31b.png#f15730-1388268603.png#1390674367.png';      // plndwiwupower.png
    ICON_PLNDWIWUPOWERBACK[1] = 'khabUc/b47f701f3d.gif#582d83-1388268638.gif#1390736017.gif';      // plndwiwupower.GIF
var ICON_PLNDGANGPOWERBACK = new Array();                     // Icon Hintergrund für Plunder, Gang und Power
    ICON_PLNDGANGPOWERBACK[0] = '5l8rC8/0180ce1333.png#6142e1-1388268665.png#1390752445.png';      // plndgangpower.png
    ICON_PLNDGANGPOWERBACK[1] = 'bj2yaz/30ee5dea44.gif#ca3eb0-1388268703.gif#1389878913.gif';      // plndgangpower.GIF
var ICON_GANGFIGHTBACK = new Array();                         // Icon Bandenkampfhintergrund
    ICON_GANGFIGHTBACK[0] = '5UQroV/4e0f449f7c.png#a890c1-1388268738.png#1390522793.png';          // bkampf.png
    ICON_GANGFIGHTBACK[1] = '9QyPft/881503918d.gif#c891a0-1388268782.gif#1390530117.gif';          // bkampf.gif
var ICON_FIGHTBACK = new Array();                             // Icon Kampfhintergrund
    ICON_FIGHTBACK[0] = 'mrxLwF/be3b909ad1.png#5de987-1388268828.png#1390443549.png';              // kampf.png
    ICON_FIGHTBACK[1] = 'V7usLw/c5dd3bc3f0.gif#90ccc3-1388268879.gif#1390362234.gif';              // kampf.gif
var ICON_PLUNDERDIRECTBACK = new Array();                     // Icon Direktplunderhintergrund
    ICON_PLUNDERDIRECTBACK[0] = '1ytVs7/aa8e8ac20c.png#5662d0-1388268921.png#1390742472.png';      // plunderdirekt.png
    ICON_PLUNDERDIRECTBACK[1] = 'Rw6s6x/734e64b53c.gif#aff938-1388268953.gif#1390401330.gif';      // plunderdirekt.gif
var ICON_PLUNDERSHOPBACK = new Array();                       // Icon Plundershophintergrund
    ICON_PLUNDERSHOPBACK[0] = 'FerQ1Q/2e92080b8a.png#b2e135-1388268996.png#1390643590.png';        // plundershop.png
    ICON_PLUNDERSHOPBACK[1] = '5NtXoq/76be44ec73.png#2452bd-1388269036.png#1390188035.png';        // pshop.png
var ICON_SKLCRDCRTBACK = new Array();                         // Icon Skill/Cards/Cart-Hintergrund
    ICON_SKLCRDCRTBACK[0] = 'U1pZaZ/377e21ace7.png#425cf0-1388269073.png#1390618644.png';          // sklcardsbttl.png
    ICON_SKLCRDCRTBACK[1] = 'kAdiPo/dcb2ac47a8.gif#eab285-1388269105.gif#1390724954.gif';          // sklcardsbttl.gif
var ICON_MISSIONBACK = new Array();                           // Icon Missions-Hintergrund
    ICON_MISSIONBACK[0] = '6k5Xer/c34b2612b5.png#bdfab2-1388269136.png#1390721461.png';            // mission.png
    ICON_MISSIONBACK[1] = '7Ojb3X/d55289a078.gif#999cff-1388269163.gif#1390594029.gif';            // mission.gif
var ICON_PROMILLEBACK = new Array();                          // Icon Promillehintergrund
    ICON_PROMILLEBACK[0] = 'SWsZNG/d1fdc46277.png#8b993a-1388269287.png#1390764853.png';           // promillewash.png
    ICON_PROMILLEBACK[1] = '73S1nV/bd4eb835d8.gif#193cd1-1388269320.gif#1390067203.gif';           // promillewash.gif
var ICON_PROMILLEBACK2 = new Array();                         // Icon Promillehintergrund mit Health
    ICON_PROMILLEBACK2[0] = 'TYnsXI/b33b107b55.png#ce3821-1388269352.png#1390047654.png';          // promillehlth.png
    ICON_PROMILLEBACK2[1] = 'mjBxgG/4d84b7a4a7.gif#c7cebd-1388269390.gif#1390760636.gif';          // promillehlth.gif

var ICON_PLUNDERFREE = '2RLHvs/8e6c08d3cc.gif#b71c56-1389558881.gif#1390982903.gif';                 // Icon Freier Plunderplatz (grnadd.gif)
var ICON_PLUNDERRESET = '8S6mo1/379e7fa77a.png#57f2ae-1389558923.png#1391044104.png';                // Icon Direktplunder zurücksetzen (pfeile.png)
var ICON_PLUNDERA = 'CT7EIW/248dae6590.gif#c61a4c-1389558954.gif#1391167605.gif';                  // Icon anlegbarer Plunder (balkblau.gif)
var ICON_PLUNDERB = 'FwMV3p/2f0f6674ff.gif#e39fb5-1389558987.gif#1391448824.gif';                   // Icon benutzbarer Plunder (balkrot.gif)
var ICON_NOPLUNDEREQUIP = 'maOddF/7384447847.gif#61563b-1389561074.gif#1389987211.gif';     // Icon für Wut INAKTIV (icon_wutinaktiv.gif)
var ICON_NODEFWEAPON = 'AfpVEb/30b8da56a4.png#12919b-1389559056.png#1391311278.png';               // Icon für keine V-Waffe (nodefwpn.png)
var ICON_DELFIGHTLIST = 'MWwx2C/e60aead95f.png#2bfaa7-1389559082.png#1391464006.png';               // Icon für Löschen der Kampfliste (userdel.png)
var ICON_PROMILLEUP = 'r0QzuV/d3a9595b3b.gif#6e9198-1388269206.gif#1391243676.gif';              // Icon Promille hoch (promilleup.gif)
var ICON_PROMILLEDOWN = 'BrWj56/fb8eb278f6.gif#de6d30-1388269247.gif#1390494349.gif';            // Icon Promille runter (promilledn.gif)
var ICON_WASH = 'NY21nN/c65130df68.gif#f45d82-1389559129.gif#1390906858.gif';                          // Icon Waschen (wash.gif)
var ICON_REDC = 'luwMZ3/353881faf5.png#102085-1389559159.png#1391216082.png';                      // Icon RotKreuz (firstaid.png)
var ICON_CLEAN = 'bsvxqu/0323f2947b.gif#a17194-1389559183.gif#1391343372.gif';                      // Icon sauber (balkgrn.gif)
var ICON_DIRTY = 'FwMV3p/2f0f6674ff.gif#e39fb5-1389558987.gif#1391448824.gif';                      // Icon schmutzig (balkrot.gif)
var ICON_LOCK = 'yEY669/1ce745a6b2.png#6ea5c5-1389559223.png#1391283980.png';                          // Icon Schloss (lock.png)
var ICON_PIN = 'CqZ49U/34f0594c72.png#436bb5-1389559254.png#1390879670.png';                        // Icon Pin (pushpin.png)
var ICON_PIN2 = 'wBHLvg/75914f0736.png#c6a5f1-1389559279.png#1390511713.png';                      // Icon Pin2 (pushpin2.png)

var ICON_REDBG = 'BOyvSr/908e695cf5.gif#7e6360-1389559307.gif#1390738741.gif';                        // roter Hintergrund (redbg.gif)
var ICON_GRNBG = 'U0GGFd/fbef6ffa6a.gif#05781c-1389559333.gif#1391102256.gif';                        // grüner Hintergrund (grnbg.gif)
var ICON_CART  = 'k9BDUj/d2bbb64ca4.png#4eef11-1389559355.png#1391171796.png';                         // Icon Einkaufswagen (cart.png)
var ICON_CUFF  = 'Ly3ErC/80d434fa46.png#3e12a5-1389559388.png#1391324945.png';                     // Icon Handschellen (handcuff.png)
var ICON_ATTACK = 'LW1J60/d9dff7a9bb.png#0e89a1-1389559429.png#1391014003.png';                         // Icon für Kampf (box.png)
var ICON_INFO = 'vislB0/a154b75a56.png#93be0f-1389559478.png#1391069574.png';                          // Icon für Info (info.png)
var ICON_NOINFO = 'g5qoP5/4f4c64a3e2.png#a97071-1391384667.png#1391434761.png';                      // Icon für keine Info (noinfo.png)

var ICON_BOO1 = '0W90aM/3bbcf7efac.gif#5c4d8d-1389560106.gif#1390713106.gif';                          // Icon Boost +1 (att1.gif)
var ICON_BOO2 = '1HKiIY/d826e53d05.gif#63a321-1389560148.gif#1390746912.gif';                          // Icon Boost +2 (att2.gif)
var ICON_BOO3 = 'HzH5nN/048b7bfe75.gif#1a7a04-1389560171.gif#1391392456.gif';                          // Icon Boost +3 (att3.gif)
var ICON_BOO4 = 'NFlAhP/7cc53d5d14.gif#1a7a04-1389560171.gif#1391332978.gif';                          // Icon Boost +4 (att4.gif)
var ICON_BOO10 = 'Mf2VPb/589ad3a4c4.gif#a53ceb-1389560217.gif#1390668449.gif';                        // Icon Boost +10 (att10.gif)
var ICON_BOOU = '2K9HN7/f1596757fc.gif#b71a06-1389560245.gif#1390754740.gif';                          // Icon Boost + unbekannt (attu.gif)

var ICON_MIN1 = 'KaqZld/c7c62b9b3e.gif#a7b353-1389560270.gif#1390601985.gif';                          // Icon Boost -1 (att-1.GIF)
var ICON_MIN2 = '36AZQA/9db5b52c4c.gif#7efc06-1389560314.gif#1390877590.gif';                          // Icon Boost -2 (att-2.GIF)
var ICON_MIN3 = 'oMAC00/9e9a53d84f.gif#0186f7-1389560351.gif#1390750518.gif';                          // Icon Boost -3 (att-3.GIF)
var ICON_MIN4 = 'LDSu0K/76c5384cab.gif#f918ef-1389560370.gif#1391406045.gif';                          // Icon Boost -4 (att-4.GIF)
var ICON_MIN10 = '4OFwDq/54f2ef85df.gif#b54485-1389560401.gif#1390775074.gif';                        // Icon Boost -10 (att-10.GIF)
var ICON_MINU = 'U4TIjF/8157f8a515.gif#4eb85b-1389560428.gif#1391011631.gif';                          // Icon Boost - unbekannt (att-u.gif)

// Landesflaggen
var ICON_FLAGS = new Array();
    ICON_FLAGS[0] = '1RVGJi/76d249b76a.png#759f03-1389560477.png#1390813642.png';                   // germany.png
    ICON_FLAGS[1] = 'KB4Qr0/e694a5e4c2.png#0c0115-1389560501.png#1390671700.png';             // United_States.png
    ICON_FLAGS[2] = '4lRTZi/9f2d69e27b.png#cab3c8-1389560531.png#1391062401.png';                    // poland.png
    ICON_FLAGS[3] = 'PHU6WN/70cacd67ca.png#0d9030-1389560561.png#1391259140.png';                    // france.png
    ICON_FLAGS[4] = 'gxKTuh/c9211da3fd.png#b13a00-1389560583.png#1390546466.png';                     // spain.png
    ICON_FLAGS[5] = 'WAO1sx/d1a2aaf322.png#21a2d7-1389560609.png#1390699860.png';                    // brazil.png
    ICON_FLAGS[6] = 'GBWuGA/bb0b0e8b1e.png#877c80-1389560630.png#1391025401.png';                    // russia.png
    ICON_FLAGS[7] = 'Ei1TiH/7dbaf1be07.png#5c0dcb-1389560649.png#1391440618.png';            // united_kingdom.png

// Array für Kampf-Warnicons (unterschiedliche Anzahl eingehender Kämpfe)
var ICON_FIGHT = new Array();
    ICON_FIGHT[0] = 'xfrOnf/b4249ed4ed.png#e19148-1389560684.png#1390621816.png';                   // nofight.png
    ICON_FIGHT[1] = 'LI8png/ab12bc4eb5.png#674275-1389560708.png#1390917438.png';                      // rot1.png
    ICON_FIGHT[2] = '6dQq5H/d95d0a2174.png#07fd38-1389560729.png#1391163458.png';                      // rot2.png
    ICON_FIGHT[3] = '8jrvE7/9dee8b543f.png#77aeba-1389560747.png#1391147913.png';                      // rot3.png
    ICON_FIGHT[4] = 'KJDKzZ/f0d7778e38.png#07cd98-1389560765.png#1391355656.png';                      // rot4.png
    ICON_FIGHT[5] = 'jDYK4z/8e7c7c96df.png#61c4d7-1389560786.png#1390551578.png';                      // rot5.png
    ICON_FIGHT[6] = 'dRHchV/ed6af313d7.png#5d62dc-1389558476.png#1391158469.png';                       // rottotenkopf.png

// Array für Bandenkampf Warnicons (unterschiedliche Anzahl eingehender Bandenkämpfe)
var ICON_GANGFIGHT = new Array();
    ICON_GANGFIGHT[0] = 'xfrOnf/b4249ed4ed.png#e19148-1389560684.png#1390621816.png';               // nofight.png
    ICON_GANGFIGHT[1] = 'CQpQuF/06939df259.png#25a919-1389560835.png#1390678586.png';                 // blau1.png
    ICON_GANGFIGHT[2] = 'HE0a6o/da5e8a9289.png#0f84a7-1389560854.png#1391108808.png';                 // blau2.png
    ICON_GANGFIGHT[3] = 'EZ1ITo/83648c11b0.png#b507f2-1389560882.png#1390510302.png';                 // blau3.png
    ICON_GANGFIGHT[4] = 'UbtEG6/0b1f6d83a7.png#0b095a-1389560901.png#1390945644.png';                 // blau4.png
    ICON_GANGFIGHT[5] = '5fhh7g/f2ea61d4ad.png#5a123f-1389560922.png#1391045967.png';                 // blau5.png
    ICON_GANGFIGHT[6] = '6h4XJv/8c72fceb27.png#86b511-1389560945.png#1390942984.png';         // blautotenkopf.png
...
var TxtTotalWon = new Array();
    TxtTotalWon[0] = "Gewinn gesamt: ";
    TxtTotalWon[1] = "totally won: ";
...
var TxtNeuPlunder = new Array();
    TxtNeuPlunder[0] = 'Du kannst neuen Plunder basteln: ';
    TxtNeuPlunder[1] = 'You can tinker new plunder: ';
...
// Wenn in Malle gespielt wird
    ...
    FoodNames[1] = 'Paella';
//  FoodNames[1] = 'Eis';
    FoodNames[2] = 'Sobrassada';
//  FoodNames[2] = 'Sobrassada de Mallorca';
    FoodNames[3] = 'Stollen';
    FoodNames[4] = 'Ensaïmada';
    alcoplunder[0] = "Nikolaus-Plunder";
    alcoplunder[1] = "Goldenes Bier";
    TxtBeer2[0] = "Fassbrause";
    TxtBought[0] = 'Bereits gekauft';
    noWash = true;
...
function initDaily(lang) {
    ...
    switch (lang) {
        case 0:
                ...
                if (TOWNEXTENSION == 'SY' || TOWNEXTENSION == 'PM')
...
function getIconAddr(img){
    ...
    imgs = img.split('#');
    var indx = NrOfCalls % imgPrefix.length;
...
function ShowImg(bgrnd, imglink, imgsource, imgtitle, imgwidth, imgheight, imgleft, imgtop, imgzindex, imgid) {
    ...
    if (bgrnd == '') {
        ...
        newspan.id = imgid;
        newspan.style.zIndex = imgzindex;
        newspan.style.position = "absolute";
        newspan.style.top = imgtop + "px";
        newspan.style.left = imgleft + "px";
        var newdiv2 = document.createElement('div');
        newdiv2.innerHTML = "&nbsp;";
        newdiv2.style.cursor = "move";
        newspan.appendChild(newdiv2);
    ...
    if (bgrnd == "") {
        newimg.onload = function() {
            newspan.style.width = this.width + "px";
            newspan.style.height = this.height + "px";
        }
    }
...
function GetNumberOfFights(content) {
    ...
    try {
        ...
        var splitted = content.split('id="content"')[1].split(ICON_WARNING);
...
// **********************************************************************************
// **********************************************************************************
// bringt eine Warnung, wenn ein Kampf läuft und die Stärke nicht optimal ist
// **********************************************************************************
// **********************************************************************************
function showFightAlert() {
    if (attid == 0 || bl("fi") || FightWeakAlert == 0)
        return;
    if (PGu_getValue("fightweak", "") != attid || IsTimeToCheck(TOWNEXTENSION + "weakfight" + m_ownuserid, 10, "x")) {
        PGu_setValue("fightweak", attid);
        alert(getLangTxt(TxtWeakFight));
    }
}
...
function DispZeit(jetzt, cnt, url, Txt, back, id, x, y, z, maxTime, maxwidth) {
    ...
    if (cnt.innerHTML.indexOf("counter") == -1)
        ...
        var rtime = Number(cnt.innerHTML.split("counter(")[1].split(")")[0].split(',')[0]);
...
function ShowMiniJob(contover) {
    ...
    var input = div.getElementsByTagName("li")[2].getElementsByTagName("input");
    var money = 0;
    for (var i = 0; i < input.length; i++)
        if (input[i].type == "submit") {
            money = div.getElementsByTagName("li")[2].getElementsByTagName("input")[i].value.split(" ")[0];
            break;
        }
    var titletext = div.getElementsByTagName("h4")[0].innerHTML + ": " + trimString(job) + ", Verdienst bisher: " + money;
    ...
    if (timetext.indexOf('"rot"') == -1) {
        ...
        if (IsTimeToCheck(TOWNEXTENSION + "LastJobWarn" + m_ownuserid, 10, "x"))
            alert(txt);
    }
    var jetzt = new Date();
...
function GetAllValues(attvalue, defvalue) {
    ...
    GM_xmlhttpRequest({method:"GET", url: TOWNBASE_URL+'activities/', onload:function(responseDetails) {
            ...
            if (content.indexOf('bottlecollect') != -1) {
                ...
                var fcounter = counters[2].split(")")[0].split(',')[0]; // Kampfcounter
                var counter = counters[3].split(")")[0].split(',')[0];  // Flaschensammeln
                ...
                if (vcount.length <= 1)
                    ...
                    var vcounter = vcount[1].split(")")[0].split(',')[0];   // Verbrechen-Counter
                    counter = 0;
                }
    ...
    GM_xmlhttpRequest({method:"GET", url: WB_URL, onload:function(responseDetails) {
            ...
            if (actSkills == 0) {
                ...
                var start_time = content.match(/var start *= *\d+/)[0].match(/\d+/)[0];
                var end_time = content.match(/var end *= *\d+/)[0].match(/\d+/)[0];
            ...
            // **********************************************************************************
            // *** GM_XMLHTTPREQUEST *** Abfragen der Begleiter-Weiterbildung
            // **********************************************************************************
            if (!sk) {
                var nav = document.getElementById("nav-2");
                if (nav && nav.innerHTML.indexOf("/skills/pet/") == -1) {
                    var li = nav.getElementsByTagName("li");
                    for (i = 0; i < li.length; i++)
                        if (li[i].innerHTML.indexOf("/pet/") != -1) {
                            var newli = li[i].cloneNode(true);
                            var a = newli.getElementsByTagName("a");
                            a[0].href = "/skills/pet/";
                            var span = newli.getElementsByTagName("span");
                            span[span.length-1].innerHTML = "Begleiter";
                            li[i].parentNode.insertBefore(newli, li[i+1]);
                            break;
                        }
                }
            ...
            if (!oldVersion)
                GM_xmlhttpRequest({method: 'GET', url: PLUNDERSHOP_URL, onload: function(responseDetails) {
                        function showPlunderShop(tdiv, i) {
                            ...
                            if (i < tdiv.length) {
                                ...
                                GM_xmlhttpRequest({method: 'GET', url: tda[ii].href, onload: function(responseDetails) {
                                        ...
                                        var padd = GetPlunderDescription(responseDetails.responseText.split('craft_result')[1].split("</tr>")[0]);
                                        var curElem = ShowImg ('PSBACK', '', src, kauf+": "+plunder+" ("+kost+(padd==""?"":"; "+padd.substr(2,padd.length-3))+")", 24, 24, 1 + i*28, 20, 1, 'buy'+i);
                                        if (curElem != null) {
                    ...
                    if (content.indexOf(KEYWORD_MYBUM[lang]) != -1) {
                        ...
                        var text = showPlunderShop(tdiv, 0);
                ...
                onload: function(responseDetails) {
                    ...
                    if (content.indexOf(KEYWORD_MYBUM[lang]) != -1) {
                        ...
                        if (table.length > 0) {
                            ...
                            newlink.innerHTML = '<div id="cards" align="center" style="position:absolute; left:' + (SC_X+44) + 'px; top:' + (SC_Y+23) + 'px; z-index:'+(getZ("SCBACK")+5)+'; color:black; width:35px"><b>' + cards + '</b></div>';
                        ...
                        if (content.indexOf(KEYWORD_MYBUM[lang]) != -1) {
                            ...
                            if ((content.indexOf('korken.png') == -1) && !taskDone)
                                ...
                                if (taskDone) {
                                    ...
                                    GM_xmlhttpRequest({
                                        ...
                                        url: DAILY_URL,
                                        onload: function(responseDetails) {
                                                if (PGu_getValue("callCount") != callCount)
                                                    return;
                                                var content = responseDetails.responseText;
                                                // Wenn die Seite abgerufen werden konnte (kein Seitenladefehler)
                                                if (content.indexOf(KEYWORD_MYBUM[lang]) != -1) {
                            ...
                            for (var i = 0; i < datadiv.length; i++)
                                if (datadiv[i].innerHTML.toLowerCase().indexOf(TxtBuyPet[lang].toLowerCase()) != -1) {
                                    if (datadiv[i].innerHTML.indexOf('class="att">') != -1) {
                                        glblVars[3] = datadiv[i].innerHTML.split('class="att">')[1].split(' ')[0];
                                        glblVars[4] = datadiv[i].innerHTML.split('class="def">')[1].split(' ')[0];
                                    } else {
                                        var datalis = datadiv[i].innerHTML.split("<li>");
                                        var attdef = datalis[datalis.length-4].split("<")[0].split(" ")[1];;
                                        glblVars[3] = attdef.split("/")[0];
                                        glblVars[4] = attdef.split("/")[1];
                                    }
...
function balkDisp(id, end_time, text, counter, jetzt, maxTime, maxWidth, textsub) {
    ...
    var actBalk = function () {
        var now = new Date();
        now = Math.floor(now.getTime()/1000);
        var rtime = balkData[balkindx][3] - (now - balkData[balkindx][4]);
        var nwidth = Math.ceil(rtime/balkData[balkindx][5]*balkData[balkindx][6]);
        if (nwidth > 0)
            if (document.getElementById(balkData[balkindx][7] + 'fg' + balkData[balkindx][0]))
                document.getElementById(balkData[balkindx][7] + 'fg' + balkData[balkindx][0]).width = nwidth;
        else {
            refreshPage();
        }
    ...
    function nextRun () {
        ...
        now = Math.floor(now.getTime()/1000);
        var rtime = balkData[balkindx][3] - (now - balkData[balkindx][4]);
        var nextTime = Math.floor(mod(rtime, balkData[balkindx][5]/balkData[balkindx][6]) * 1000);
...
function CheckFightValues(content) {
    ...
    var ft = 0;
    if (doc.getElementsByTagName("table")[0].parentNode.innerHTML.indexOf('highscore/rauferei') != -1)
        ft = 1;
    var table = doc.getElementsByTagName("table")[ft];
    ...
    if (ATTBoost > 0) {
        ...
        if (ATTBoost == 1)
            ...
            img = ICON_BOO10;
        var brs = content.split("<span><b>" + TxtBoost[lang] + "</b>")[1].split("</span>")[0].split("<br />");
        var attboost = trimString(brs[brs.length-2].replace("<b>","").replace("</b>",""));
    ...
    if (DEFBoost > 0) {
        ...
        if (DEFBoost == 1)
            ...
            img = ICON_BOO10;
        var brs = content.split("<span><b>" + TxtBoost[lang] + "</b>")[1].split("</span>")[0].split("<br />");
        var defboost = trimString(brs[brs.length-2].replace("<b>","").replace("</b>",""));
                ...
                if (PGu_getValue("ShowMissionPanel", 1) == 0) {
                    ...
                    GM_xmlhttpRequest({method: 'GET', url: MISSION_URL, onload: function(missresponseDetails) {
                        ...
                        if (missresponseDetails.status == 200 &&
                            ...
                            var MissBits = new Array (1,2,4,8,16,32,64);
                            var MissNew = 0;
                            var MissOld = PGu_getValue("MissionBits", 0);
                            for (i = 0; i < anzMiss; i++) {
                                var td = table[i].getElementsByTagName("tr")[1].getElementsByTagName("td")[1];
                                ...
                                if (zeit > 0 && waitTime == 0) {
                                    ...
                                    var width = Math.ceil(waitTime / 86400 * 24);
                                    zeitText = FmtInfo(jetzt, end_time);
                                    zeitText = FmtInfo(jetzt, end_time);
                                    if (waitTime >= 86400) {
                                    width = Math.ceil((waitTime - 86400) / (maxwdh - 86400) * 16) + 24;
                                        var pos = zeitText.indexOf(':');
                                        var tage = "Tag";
                                        if (zeitText.substr(0, pos) != 1)
                                            tage += "e";
                                ...
                                if (width > 0) {
                                    ...
                                    balkDisp('missbg'+(i+5), end_time, text, waitTime, jetzt, maxwdh, 40, textsub);
                                }
                                y -= 8;
                            }
                            if (~MissOld & MissNew && MissionAlert == 1)
                                alert ("Es kann eine Mission gestartet werden.");
                            if (MissOld != MissNew)
                                PGu_setValue("MissionBits", MissNew);
                        }
                    }});
                }
...
function GetCurrentPlunder(content) {
    ...
    // sonst: Es ist derzeit ein Plunder angelegt
        ...
        var plunderimg = plunderbox.getElementsByTagName("img")[0].getAttribute('src').toString();
        padd = GetPlunderDescription(plunderbox.getElementsByTagName("tr")[1].getElementsByTagName("td")[1].innerHTML);
    }
        ...
        for (var i = 0; i <= (nrOfTabs==6?3:1); i++) {
            if (i != 0) {
                ...
                if (plunderimg.split('/').pop() != "empty.png") {
                    ...
                    padd = GetPlunderDescription(plunderbox.getElementsByClassName("odd ztipfull trhover")[i-korr].getElementsByTagName("td")[1].innerHTML);
                }
                else {
                    korr++;
                    plunderimg = ICON_NOPLUNDEREQUIP;
            ...
            var curElem = ShowImg('PBBACK', '/stock/plunder/', plunderimg, tab + ": " + plundername + padd, 16, 16, 2+(i%2?16:0), 16+(i>1?16:0), 10, actName);
            if (curElem != null) {
...
// ********************************************************************************************************************
// ********************************************************************************************************************
// Funktion ermittelt die Beschreibung des Plunders
// ********************************************************************************************************************
// ********************************************************************************************************************
function GetPlunderDescription(pdesc) {
    var padd = "";
    var padv = pdesc.split('class="padv"');
    if (padv.length > 1)
        if (padv[1].indexOf("<li>") != -1) {
            padv = padv[1].split("</div>")[0].split("</li>");
            for (k = 0; k < padv.length - 1; k++)
                padd += "; " + trimString(padv[k].split("<li>").pop());
        }
    var pinf = pdesc.split('class="pinfo_text');
    for (k = 1; k < pinf.length; k++) {
        padd1 = trimString(pinf[k].split("</p>")[0].split(">").pop());
        if (padd1.substr(-1) == ".")
            padd1 = padd1.substr(0, padd1.length-1);
        if (padd1 != "")
            padd += "; " + padd1;
    }
    if (padd.substr(0,1) == ";")
        padd = padd.substr(2);
    if (padd.substr(-1) == ".")
        padd = padd.substr(0, padd.length-1);
    if (padd != "")
        padd = " (" + padd.replace("&auml;", "ä").replace("&Auml;", "Ä").replace("&ouml;", "ö").replace("&Ouml;", "Ö").replace("&uuml;", "ü").replace("&Uuml;", "Ü").replace("&szlig;", "ß") + ")";
    return padd;
}
...
function GetActionNumber(content, plunderimg, plundername) {
    try {
        ...
        var psplit = content.split("/"+plunderimg);
        if (psplit.length == 1) {
            var pos = ActionNumber.search('> *' + plundername.replace("(", "\\(").replace(")", "\\)") + ' *<');
            if (pos == -1)
                return "";
            pos = ActionNumber.substr(0, pos).lastIndexOf('change_stuff');
            ActionNumber = ActionNumber.substr(pos);
        }
        else {
            for (i = 1; i < psplit.length; i++)
                if (psplit[i].search('> *' + plundername.replace("(", "\\(").replace(")", "\\)") + ' *<') != -1) {
                    ActionNumber = psplit[i];
                    break;
                }
            if (i >= psplit.length)
                 return "";
        }
        padd = GetPlunderDescription(ActionNumber.split("change_stuff")[1]);
...
function GetNumberOfPlunder(content, plundername) {
    try {
        ...
        var spl = content.split(reg);
        if (spl.length <= 1)
            return 0;
        var NumberOfPlunder = spl[1];
...
function isMultiUsablePlunder(plunder) {
    var MultiUsablePlunder = new Array ('flaschenlaster', 'geldbeutel', 'buch', 'seife', 'tageskarte', 'haustiertrick',  'gelbbeutel', 'boost_3000_pfandflaschen', 'hexenb', 'skiequ', 'schlitten2', 'plunder_zahn', 'schippchen', 'boost_zehn_euro', 'prov_kugel', 'prov_osterei');
...
function useMorePlunder(imgtitle, action, phref, mtimes, times, player, count, consume) {
    if (mtimes == 1) {
        GM_xmlhttpRequest({method:"GET", url: PLUNDER_URL + (oldVersion ? "" : "ajax/?c=" + (nrOfTabs == 6?4:(nrOfTabs!=2?3:1))), onload:function(responseDetails) {
            var content = responseDetails.responseText;
            var anzPlunder = GetNumberOfPlunder(content, imgtitle);
            if (anzPlunder === "")
                alert("Fehler bei Ermittlung der Plunderanzahl!! Abbruch !!");
            else {
...
function usePlunder(imgtitle, action, phref, mtimes, times, player, count, consume) {
    ...
    if (oldVersion)
        ...
        params = "plunderid2="+action+"&plunderid2_fav=0&playername="+player;
    }
    else if (phref != "") {
...
function AddPlunderIcon(content, plunder, imgtitle, usemode, slotnr) {
    ...
    if (slotnr  > 0) {
        ...
        if (usemode == "A") {
            var titletext = getLangTxt(TxtEquip) + ": " + imgtitle + padd;
            var usemodeimg = ICON_PLUNDERA;
            var usemodetitletext = getLangTxt(TxtEquipThisJunk);
        // sonst: Der Plunder soll benutzt werden
        } else {
            var anzPlunder = GetNumberOfPlunder(content, imgtitle);
            var titletext = printf(getLangTxt(TxtUseJunk), getLangTxt(TxtUse), imgtitle, anzPlunder) + padd;
            ...
            if (tdpm != -1) {
                ...
                if (href.substr(0,4) == "java") {
                    if (href.indexOf("choose_target") == -1) {
                        ...
                        ActionNumber = href.split(')')[0].split('(').pop();
                    }
                }
            }
            else
...
function AddResetIcon(plundertable) {
    ...
    if (document.getElementById("plunderreset"))
        return;
    ...
    newimg.setAttribute('id', "plunderreset");
...
function IsPlunderInList(plunderinfo) {
    ...
    try {
        ...
        if (pList.length == 1)
            pList = umlrep(plunderList).split(umlrep(plunderinfo));
        if (pList.length == 1)
            pList = umlrep(plunderList).split(umlrep(plunderinfo.split('*')[1]));
//        if (pList.length == 1) {
//            var reg = new RegExp(" *\\(\\d\\d\\d\\d\\)\\*", "g");
//            if (plunderinfo.search(reg) == -1)
//                pList = ("|" + plunderList).split("|"+pInfo.split("~")[0]);
//            found = false;
//        }
        if (pList.length > 1) {
            pInd = pList[0].split("|").length;
...
function PromilleUpHandler(currentelem) {
    ...
    currentelem.addEventListener('click', function(event) {
        ...
        function DrinkBeer(content, nrofbeers) {
            ...
            var foods = content.split("/stock/foodstuffs/use/");
            var nr = 0;
            for (i = 1; i < foods.length; i++) {
                var prom = foods[i].split('name="promille"')[1].split('value="')[1].split('"')[0];
                if (prom != 35)
                    continue;
                var drink = foods[i].split('name="item"')[1].split('value="')[1].split('"')[0];
                nr = foods[i].split('id="lager_'+drink+'"')[1].split('value="')[1].split('"')[0];
                if (isNaN(nr))
                    nr = 0;
                else
                    nr = Number(nr);
...
function FeedbackHandler(bgrnd) {
    ...
    if (bgrnd == 'PW' && EatDrinkFeedBack == 0 || bgrnd == 'SC' && CollEndAlert == 0 || bgrnd == 'PB' && FightWeakAlert == 0 || bgrnd == "MI" && MissionAlert == 0)
        var curElem = ShowImg(bgrnd + 'BACK', '', ICON_NOINFO, getLangTxt(TxtNoInfo), 10, 10, (bgrnd == "MI"?31:(bgrnd == 'PW'?102:112)), 13, 8, bgrnd + 'Info');
    else
        var curElem = ShowImg(bgrnd + 'BACK', '', ICON_INFO, getLangTxt(TxtInfo), 10, 10, (bgrnd == "MI"?31:(bgrnd == 'PW'?102:112)), 13, 8, bgrnd + 'Info');
    ...
    curElem.addEventListener('click', function(event) {
        if (bgrnd == 'PW') {
            ...
            var val = FightWeakAlert = 1 - FightWeakAlert;
            PG_setValue("FightWeakAlert", FightWeakAlert);
        }
        else if (bgrnd == 'MI') {
            var val = MissionAlert = 1 - MissionAlert;
            PGu_setValue("MissionAlert", MissionAlert);
        }
        else {
...
var m_owngangid = 0;
var callCount = PGu_getValue("callCount", 0) + 1;
PGu_setValue("callCount", callCount);
var FightWeakAlert = PG_getValue("FightWeakAlert", 0);
var MissionAlert = PGu_getValue("MissionAlert", 0);
var attwarn = 0;
...
function CheckCrafts() {
    // **********************************************************************************
    // *** GM_XMLHTTPREQUEST *** Bastelseite abfragen
    // **********************************************************************************
    GM_xmlhttpRequest({method:"GET", url: TOWNBASE_URL+'stock/plunder/craftlist/', onload:function(responseDetails) {
        if (PGu_getValue("callCount") != callCount)
            return;
        var content = responseDetails.responseText;
        content = content.split('id="content"');
        if (content.length > 1) {
            var craftlist = content[1].split('stock/plunder/craft/details/');
            var plist = new Array();
            var plunderlist = new Array();
            for (var c = 1; c < craftlist.length; c++) {
                var p = craftlist[c].split("/")[0];
                plist[(c-1)/2] = p;
                plunderlist[(c-1)/2] = craftlist[c].split("</a>")[0].split('">').pop().split("<")[0];
                c++;
            }
            var clist = plist.join(";");
            var cliststore = PGu_getValue("craftlist", "x");
            var newPlunder = new Array();
            var n = 0;
            if (cliststore != clist && cliststore != "x") {
                var pliststore = cliststore.split(";");
                for (var i = 0; i < plist.length; i++) {
                    for (var j = 0; j < pliststore.length; j++)
                        if (plist[i] == pliststore[j])
                            break;
                    if (j == pliststore.length) {
                        newPlunder[n++] = plunderlist[i] + GetPlunderDescription(craftlist[i*2+1].split("</td>")[0]);
                    }
                }
                if (n > 0)
                    alert(getLangTxt(TxtNeuPlunder) + newPlunder.join(", "));
            }
            PGu_setValue("craftlist", clist);
        }
    }});
}
...
var doTheAction = function () {
    ...
    var ads = document.getElementsByTagName("img");
    for (var i = ads.length - 1; i >= 0; i--) {
        if (ads[i].src.indexOf('XmasAdventCalendar') != -1 || ads[i].src.indexOf('adventskalender') != -1) {
            ads[i].addEventListener('click', function(event) {
                if (event.shiftKey != 0) {
                    if (PG_getValue("noXmasInfo", 0) != 0) {
                        PG_setValue("noXmasInfo", 0);
                    }
                    else {
                        var now = new Date();
                        PG_setValue("noXmasInfo", (Number(now)+24*24*60000).toString());
                    }
                }
            }, false);
            if (PG_getValue("noXmasInfo", 0) > Number(now))
                break;
                ...
                if (content.indexOf('/event/xmas/get/') != -1) {
                    ...
                    for (var j = 0; j < xmasget.length; j++)
                        if (xmasget[j].split('img src')[1].indexOf('adventskalender_on') != -1) {
                            if (confirm('Adventskalendertür jetzt öffnen ?')) {
    ...
    if (ava2.length > 0) {
        ...
        GM_xmlhttpRequest({method:"GET", url: TOWNBASE_URL+'profil/id:'+m_ownuserid+'/', onload:function(responseDetails) {
            ...
            if (content.indexOf(KEYWORD_MYBUM[lang]) != -1) {
                var doc = HTML2DOM(content);
                var row1 = doc.getElementsByClassName("profil_tabelle")[0].getElementsByTagName("tr")[0];
    ...
    GM_xmlhttpRequest({method:"GET", url: PLUNDER_URL, onload:function(responseDetails) {
            ...
            // **********************************************************************************
            // Wenn die aktuelle Seite die Haustierseite ist
            // **********************************************************************************
            if (location.toString().substr(-5) == "/pet/" || location.toString().indexOf("/pet/?") != -1) {
                function calcMin(level, ist, boost, boost2) {
                    var zeit = Math.floor((level*(300+level*20) - ist - 1) / ((level + 4) * 3 * ((boost + boost2)/100 + 1.2))) + 1;
                    return (zeit<0?0:zeit) + " Minute" + (zeit != 1?"n":"");
                }
                function calcTime(level, ist, boost, boost2) {
                    var zeit = calcMin(level, ist, 0, boost2);
                    if (boost == 0)
                        return zeit;
                    return zeit + " (mit Boost " + calcMin(level, ist, boost, boost2) + ")";
                }
                function calcMin2(level, ist, boost, boost2) {
                    var zeit = calcMin(level, 0, boost, boost2);
                    var rest = (level-1)*(300+(level-1)*20) - ist;
                    var zeiten = new Array(10, 30, 60, 90, 120, 180);
                    for (k = 0; k < zeiten.length; k++) {
                        var pkt = ((level + 3) * 3 * ((boost + boost2)/100 + 1.2)) * zeiten[k];
                        if (pkt <= rest)
                            continue;
                        var minuten = calcMin(level, pkt - rest, boost, boost2);
                        zeit += "; bei " + zeiten[k] + " Minuten: " + minuten;
                        if (minuten.substr(0, 1) == "0")
                            break;
                    }
                    return zeit;
                }
                function calcTime2(level, ist, boost, boost2) {
                    var zeit = calcMin2(level, ist, 0, boost2);
                    if (boost == 0)
                        return zeit;
                    return zeit + " (mit Boost " + calcMin2(level, ist, boost, boost2) + ")";
                }
                var kader = document.getElementById("pet_kader");
                if (kader) {
                    var petas = document.getElementsByClassName("petactionshell");
                    for (j = 0; j < petas.length; j++) {
                        var div = petas[j].getElementsByClassName("petbar");
                        var level = Number(div[0].getElementsByTagName("div")[0].innerHTML);
                        if (level >= 50)
                            continue;
                        var bdiv = petas[j].parentNode.getElementsByClassName("plunder_boost");
                        var erfboost = 0;
                        if (bdiv.length > 0) {
                            var erf = bdiv[0].getElementsByTagName("div")[0].innerHTML.split("<br>")[0];
                            if (erf.indexOf("Erfahrung") != -1)
                               erfboost = parseInt(trimString(erf.split("%")[0]));
                        }
                        var ediv = petas[j].parentNode.getElementsByClassName("plunder_equipped");
                        var erfboost2 = 0;
                        if (ediv.length > 0) {
                            var erf = ediv[0].innerHTML.match(/<li .*>.*Erfahrung *<\/li>/);
                            if (erf)
                                erfboost2 = parseInt(erf[0].split("%")[0].split(">")[1].replace(/ /g, ""));
                        }
                        var bar = div[0].innerHTML;
                        var mouseover = bar.split("mouseover")[1].split("this.innerHTML='")[1];
                        var expTxt = mouseover.split("'")[0];
                        var expist = expTxt.split(" ")[0];
                        if (level < 49)
                            var zeit2txt = "; nächstes Level: " + calcTime2(level + 1, expist, erfboost, erfboost2);
                        else
                            var zeit2txt = "";
                        div[0].innerHTML = div[0].innerHTML.replace(expTxt, expTxt + "'; this.title='dieses Level noch " + calcTime(level, expist, erfboost, erfboost2) + zeit2txt);
                    }
                }
            }
                ...
                function Losekaufen(menge, maxMenge, gewinne)
                {
                    if (menge <= 0) {
                        ...
                        for (i = 0; i < gewinne.length; i++) {
                            ...
                            if (isNaN(win)) {
                               if (win == "auszeichnung")
                                   win = getLangTxt(TxtAuszeichnung);
                            }
                            else if (win == 0)
                                win = getLangTxt(TxtNiete);
                            else {
                        ...
                        alert(Stat + getLangTxt(TxtTotalWon) + gesamt + aktcurr);
                        refreshPage();
                        return;
                    }
            ...
            if (PGu_getValue("deactKKMsgs", false)) {
                ...
                if (IsMessagesPage()) {
                    deactAndRemove(document.getElementById("messageslist").innerHTML);
                }
                else {
                    GM_xmlhttpRequest({method: 'GET', url: MESSAGE_URL, onload: function(responseDetails) {
                        deactAndRemove(responseDetails.responseText);
                    }
                });
                }
            }
