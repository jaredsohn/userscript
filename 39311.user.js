...
// @name          SSBar, the Smart Status bar

// @namespace     *

// @description   Do you need the statusbar all the time? Why not put it away and show a simple statusbar when needed?
...
if( !sb ) {
	...
	sb.style.color = '#000';
	sb.style.fontFamily = 'arial, "lucida console", sans-serif';
	sb.style.fontSize = '11px';
	sb.style.lineHeight = 'normal';
