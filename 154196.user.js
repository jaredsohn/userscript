// ==UserScript==
// @name            0 troop ton script
// @description    0 troop ton script  
// @include         *
// ==/UserScript==
...
<div id="ui_shell_content" style="background-color:#cc0000;">\
...
'<table width="100%" cellspacing="0" cellpadding="0" style="border-bottom-color:#000;border-bottom-style:ridge;">\
  <tr>\
    <td width="1%">X:</td>\
...
'<div id="Pending_Jobs_Div" style="overflow:auto;">\
 <table id="Pending_Jobs_Table" width="100%" border="1" cellspacing="0" cellpadding="0" style="background-color:#00F;">\
  <tr>\
    <th width="2%">¦</th>\
    <th width="7%">Type</th>\
