// ==UserScript==
// @name           Ika-Core DOD
// @namespace      http://d.o.dpote.xooit.com
// @description    Script de configuration de Ika-Core pour l'alliance DOD
...
switch (location.host) {
	case 's5.ikariam.fr':
		...
		//chaturl='.';
		chaturl='http://d.o.dpote.xooit.com';
		//forumurl='.';
		forumurl='http://d.o.dpote.xooit.com';
		//forumurlnew='.';
		forumurlnew='http://d.o.dpote.xooit.com';
		break;
	}
	main();
	ToolsMenu();
