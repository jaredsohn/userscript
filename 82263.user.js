// ==UserScript==
// @author         Roktaal. Adapted to WE by Denis Cicic
// @name           eRepublik WE Reserve Battalion Military Tracker by Denis Cicic
// @namespace      http://www.erepublik.com/en/citizen/profile/1709354
// @description    eRepublik WE Reserve Battalion Military Tracker.
// @version        1.0.2
// @include        http://www.erepublik.com/en
// @include        http://www.erepublik.com/sr
// @require        http://sizzlemctwizzle.com/updater.php?id=82263&days=1&show
...
GM_addStyle(".member span.image { display: none; padding: 2px 2px 2px 2px !important; margin-left: -150px; margin-top: -40px; }");
GM_addStyle(".member:hover span.image{ display: inline; position: absolute; background: #ffffff; border: 1px solid #cccccc; color:#000000; }");
GM_addStyle(".member td.image { border-bottom: 0px; padding: 0px !important; }");
GM_addStyle(".member tr.hlimage td.image { color: rgb(153, 153, 153); }");
GM_addStyle("div.tooltip1 font.skiller strong { -moz-border-radius: 3px 3px 3px 3px; background: none repeat scroll 0 0 #ADE56C; border: 1px solid #98D651; color: #ffffff !important; float:left; font-size: 11px; line-height: 11px !important; margin-right: 5px; overflow: hidden; padding: 2px; text-align: center; text-shadow: 0 1px 0 #84C538; width: 12px !important; }");
GM_addStyle("div.tooltip1:hover { cursor: default; text-decoration: none; }");
GM_addStyle("div.tooltip1 span.hover1 { display: none; padding: 2px 2px 2px 2px !important; margin-left: 407px; margin-top: -18px; }");
GM_addStyle("div.tooltip1 span.hover2 { display: none; padding: 2px 2px 2px 2px !important; margin-left: 349px; margin-top: -33px; }");
GM_addStyle("div.tooltip1 span.hover3 { display: none; padding: 2px 2px 2px 2px !important; margin-left: 317px; margin-top: -37px; }");
GM_addStyle("div.tooltip1 span.hover4 { font-size:9px; display: none; padding: 2px 2px 2px 2px !important; margin-left: 172px; margin-top: -155px; }");
GM_addStyle("div.tooltip1 span.hover5 { font-size:9px; display: none; padding: 2px 2px 2px 2px !important; margin-left: 297px; margin-top: -70px; }");
GM_addStyle("div.tooltip1 span.hover6 { display: none; padding: 2px 2px 2px 2px !important; margin-left: 192px; margin-top: -37px; }");
GM_addStyle("div.tooltip1:hover span.hover1 { display: block; position: absolute; background: #ffffff; border: 1px solid #cccccc; color:#000000; }");
GM_addStyle("div.tooltip1:hover span.hover2 { display: block; position: absolute; background: #ffffff; border: 1px solid #cccccc; color:#000000; }");
GM_addStyle("div.tooltip1:hover span.hover3 { display: block; position: absolute; background: #ffffff; border: 1px solid #cccccc; color:#000000; }");
GM_addStyle("div.tooltip1:hover span.hover4 { display: block; position: absolute; background: #ffffff; border: 1px solid #cccccc; color:#000000; }");
GM_addStyle("div.tooltip1:hover span.hover5 { display: block; position: absolute; background: #ffffff; border: 1px solid #cccccc; color:#000000; }");
GM_addStyle("div.tooltip1:hover span.hover6 { display: block; position: absolute; background: #ffffff; border: 1px solid #cccccc; color:#000000; }");
GM_addStyle("div.tooltip1 td { border-bottom: 0px; padding: 0px !important; }");
GM_addStyle("div.tooltip1 tr.highlight td { color: rgb(153, 153, 153); }");

var html = '<embed width="500" height="30" src="/flash/delicious.swf" quality="best" flashvars="txt=WE Reserve Battalion Tracker v1.0.2 by Denis Cicic&amp;&amp;textcolor=#737373&amp;hovercolor=null&amp;linkcolor=null&amp;w=250&amp;h=28" wmode="transparent" bgcolor="transparent" sifr="true" type="application/x-shockwave-flash" class="sIFR-flash" style="width: 250px; height: 28px;"/>'
var nMembers
var count = 0
	...
	GM_xmlhttpRequest({
		...
		onload:function(response) {
			try {
				...
				var producerValueIn = 0
				var marketingValueIn = 0
				var projectValueIn = 0
				var carpenterValueIn = 0
				var builderValueIn = 0
				var architectValueIn = 0
				var engineerValueIn = 0
				var mechanicValueIn = 0
				var fitterValueIn = 0
				var technicianValueIn = 0
				var commoditiesValueIn = 0
				var workerImg = ""
				var workerLnk = ""
				var rifleValueIn = 0;
				var tankValueIn = 0;
				...
				for (var i=0; i < memberSkillsIn.length; i++) {
					memberSkillNameIn = memberSkillsIn[i].name;
					memberSkillValueIn = memberSkillsIn[i].points;
					
					if (memberSkillNameIn == "Producer") {
						producerValueIn = parseFloat(memberSkillValueIn);
					} else if (memberSkillNameIn == "Marketing Manager") {
						marketingValueIn = parseFloat(memberSkillValueIn);
					} else if (memberSkillNameIn == "Project Manager") {
						projectValueIn = parseFloat(memberSkillValueIn);
					} else if (memberSkillNameIn == "Carpenter") {
						carpenterValueIn = parseFloat(memberSkillValueIn);
					} else if (memberSkillNameIn == "Builder") {
						builderValueIn = parseFloat(memberSkillValueIn);
					} else if (memberSkillNameIn == "Architect") {
						architectValueIn = parseFloat(memberSkillValueIn);
					} else if (memberSkillNameIn == "Engineer") {
						engineerValueIn = parseFloat(memberSkillValueIn);
					} else if (memberSkillNameIn == "Mechanic") {
						mechanicValueIn = parseFloat(memberSkillValueIn);
					} else if (memberSkillNameIn == "Fitter") {
						fitterValueIn = parseFloat(memberSkillValueIn);
					} else if (memberSkillNameIn == "Technician") {
						technicianValueIn = parseFloat(memberSkillValueIn);
					} else if (memberSkillNameIn == "Commodities Worker") {
						commoditiesValueIn = parseFloat(memberSkillValueIn);
					}
				}
				var skillNameArray = ["Producer", "Marketing Manager", "Project Manager", "Carpenter", "Builder", "Architect", "Engineer", "Mechanic", "Fitter", "Technician", "Harvester"];
				var skillValueArray = [producerValueIn, marketingValueIn, projectValueIn, carpenterValueIn, builderValueIn, architectValueIn, engineerValueIn, mechanicValueIn, fitterValueIn, technicianValueIn, commoditiesValueIn];
				var maxSkillValue = skillValueArray[0];
				var maxSkillName = skillNameArray[0];
				
				for (i = 1; i < skillValueArray.length; i++) {
					if (skillValueArray[i] > maxSkillValue) {
						maxSkillValue = skillValueArray[i];
						maxSkillName = skillNameArray[i];
					}	
				}
				
				if (maxSkillName == "Producer") {
					tProducers = tProducers + 1
				} else if (maxSkillName == "Marketing Manager") {
					tMmanagers = tMmanagers + 1
				} else if (maxSkillName == "Project Manager") {
					tPmanagers = tPmanagers + 1
				} else if (maxSkillName == "Carpenter") {
					tCarpenters = tCarpenters + 1
				} else if (maxSkillName == "Builder") {
					tBuilders = tBuilders + 1
				} else if (maxSkillName == "Architect") {
					tArchitects = tArchitects + 1
				} else if (maxSkillName == "Engineer") {
					tEngineers = tEngineers + 1
				} else if (maxSkillName == "Mechanic") {
					tMechanics = tMechanics + 1
				} else if (maxSkillName == "Fitter") {
					tFitters = tFitters + 1
				} else if (maxSkillName == "Technician") {
					tTechnicians = tTechnicians + 1
				} else if (maxSkillName == "Harvester") {
					tHarvesters = tHarvesters + 1
				}
				...
				if (Member.employer.name) {
					if (Member.employer.name.match('WE')) {
						workerImg = '<img title="Employed in '+Member.employer.name+'" src="'+iconWorker+'">'
					} else {
						workerImg = '<img title="Not employed in WE" src="'+iconNoWorker+'">'
					}
				} else {
				...
				var div4 = '<div class="tooltip1"><font class="skiller" title="'+getWorkSkill(formatWorkSkill(maxSkillValue))+'"><strong>'+formatWorkSkill(maxSkillValue)+'</strong></font> '+getWorkSkill(formatWorkSkill(maxSkillValue))+'<span class="hover4" style="z-index: 999;"><table><tr class="highlight"><td><img title="Producer" src="http://www.erepublik.com/images/icons/skills/producer.png" width="20px" height="20px"></td><td width="150px" align="center" valign="middle" height="30px"><table border="0"><tr><td height="10px">'+producerValueIn+' / '+nextSkillPoints(producerValueIn)+' ('+skillPercent(producerValueIn)+'%)</td></tr><tr><td height="10px"><div class="bar experience"><div class="border"><span class="lefts"></span><span class="mids" style="width: 110px;"></span><span class="rights"></span></div><div class="fill"><span class="lefts"></span><span class="mids" style="width: '+skillPercent(producerValueIn)+'%;"></span><span class="rights"></span></div></div></td></tr></table></td></tr><tr class="highlight"><td><img title="Marketing Manager" src="http://www.erepublik.com/images/icons/skills/marketingmanager.png" width="20px" height="20px"></td><td width="150px" align="center" valign="middle" height="30px"><table border="0"><tr><td height="10px">'+marketingValueIn+' / '+nextSkillPoints(marketingValueIn)+' ('+skillPercent(marketingValueIn)+'%)</td></tr><tr><td height="10px"><div class="bar experience"><div class="border"><span class="lefts"></span><span class="mids" style="width: 110px;"></span><span class="rights"></span></div><div class="fill"><span class="lefts"></span><span class="mids" style="width: '+skillPercent(marketingValueIn)+'%;"></span><span class="rights"></span></div></div></td></tr></table></td></tr><tr class="highlight"><td><img title="Project Manager" src="http://www.erepublik.com/images/icons/skills/projectmanager.png" width="20px" height="20px"></td><td width="150px" align="center" valign="middle" height="30px"><table border="0"><tr><td height="10px">'+projectValueIn+' / '+nextSkillPoints(projectValueIn)+' ('+skillPercent(projectValueIn)+'%)</td></tr><tr><td height="10px"><div class="bar experience"><div class="border"><span class="lefts"></span><span class="mids" style="width: 110px;"></span><span class="rights"></span></div><div class="fill"><span class="lefts"></span><span class="mids" style="width: '+skillPercent(projectValueIn)+'%;"></span><span class="rights"></span></div></div></td></tr></table></td></tr><tr class="highlight"><td><img title="Carpenter" src="http://www.erepublik.com/images/icons/skills/carpenter.png" width="20px" height="20px"></td><td width="150px" align="center" valign="middle" height="30px"><table border="0"><tr><td height="10px">'+carpenterValueIn+' / '+nextSkillPoints(carpenterValueIn)+' ('+skillPercent(carpenterValueIn)+'%)</td></tr><tr><td height="10px"><div class="bar experience"><div class="border"><span class="lefts"></span><span class="mids" style="width: 110px;"></span><span class="rights"></span></div><div class="fill"><span class="lefts"></span><span class="mids" style="width: '+skillPercent(carpenterValueIn)+'%;"></span><span class="rights"></span></div></div></td></tr></table></td></tr><tr class="highlight"><td><img title="Builder" src="http://www.erepublik.com/images/icons/skills/builder.png" width="20px" height="20px"></td><td width="150px" align="center" valign="middle" height="30px"><table border="0"><tr><td height="10px">'+builderValueIn+' / '+nextSkillPoints(builderValueIn)+' ('+skillPercent(builderValueIn)+'%)</td></tr><tr><td height="10px"><div class="bar experience"><div class="border"><span class="lefts"></span><span class="mids" style="width: 110px;"></span><span class="rights"></span></div><div class="fill"><span class="lefts"></span><span class="mids" style="width: '+skillPercent(builderValueIn)+'%;"></span><span class="rights"></span></div></div></td></tr></table></td></tr><tr class="highlight"><td><img title="Architect" src="http://www.erepublik.com/images/icons/skills/architect.png" width="20px" height="20px"></td><td width="150px" align="center" valign="middle" height="30px"><table border="0"><tr><td height="10px">'+architectValueIn+' / '+nextSkillPoints(architectValueIn)+' ('+skillPercent(architectValueIn)+'%)</td></tr><tr><td height="10px"><div class="bar experience"><div class="border"><span class="lefts"></span><span class="mids" style="width: 110px;"></span><span class="rights"></span></div><div class="fill"><span class="lefts"></span><span class="mids" style="width: '+skillPercent(architectValueIn)+'%;"></span><span class="rights"></span></div></div></td></tr></table></td></tr><tr class="highlight"><td><img title="Engineer" src="http://www.erepublik.com/images/icons/skills/engineer.png" width="20px" height="20px"></td><td width="150px" align="center" valign="middle" height="30px"><table border="0"><tr><td height="10px">'+engineerValueIn+' / '+nextSkillPoints(engineerValueIn)+' ('+skillPercent(engineerValueIn)+'%)</td></tr><tr><td height="10px"><div class="bar experience"><div class="border"><span class="lefts"></span><span class="mids" style="width: 110px;"></span><span class="rights"></span></div><div class="fill"><span class="lefts"></span><span class="mids" style="width: '+skillPercent(engineerValueIn)+'%;"></span><span class="rights"></span></div></div></td></tr></table></td></tr><tr class="highlight"><td><img title="Mechanic" src="http://www.erepublik.com/images/icons/skills/mechanic.png" width="20px" height="20px"></td><td width="150px" align="center" valign="middle" height="30px"><table border="0"><tr><td height="10px">'+mechanicValueIn+' / '+nextSkillPoints(mechanicValueIn)+' ('+skillPercent(mechanicValueIn)+'%)</td></tr><tr><td height="10px"><div class="bar experience"><div class="border"><span class="lefts"></span><span class="mids" style="width: 110px;"></span><span class="rights"></span></div><div class="fill"><span class="lefts"></span><span class="mids" style="width: '+skillPercent(mechanicValueIn)+'%;"></span><span class="rights"></span></div></div></td></tr></table></td></tr><tr class="highlight"><td><img title="Fitter" src="http://www.erepublik.com/images/icons/skills/fitter.png" width="20px" height="20px"></td><td width="150px" align="center" valign="middle" height="30px"><table border="0"><tr><td height="10px">'+fitterValueIn+' / '+nextSkillPoints(fitterValueIn)+' ('+skillPercent(fitterValueIn)+'%)</td></tr><tr><td height="10px"><div class="bar experience"><div class="border"><span class="lefts"></span><span class="mids" style="width: 110px;"></span><span class="rights"></span></div><div class="fill"><span class="lefts"></span><span class="mids" style="width: '+skillPercent(fitterValueIn)+'%;"></span><span class="rights"></span></div></div></td></tr></table></td></tr><tr class="highlight"><td><img title="Technician" src="http://www.erepublik.com/images/icons/skills/technician.png" width="20px" height="20px"></td><td width="150px" align="center" valign="middle" height="30px"><table border="0"><tr><td height="10px">'+technicianValueIn+' / '+nextSkillPoints(technicianValueIn)+' ('+skillPercent(technicianValueIn)+'%)</td></tr><tr><td height="10px"><div class="bar experience"><div class="border"><span class="lefts"></span><span class="mids" style="width: 110px;"></span><span class="rights"></span></div><div class="fill"><span class="lefts"></span><span class="mids" style="width: '+skillPercent(technicianValueIn)+'%;"></span><span class="rights"></span></div></div></td></tr></table></td></tr><tr class="highlight"><td><img title="Harvester" src="http://www.erepublik.com/images/icons/skills/harvester.png" width="20px" height="20px"></td><td width="150px" align="center" valign="middle" height="30px"><table border="0"><tr><td height="10px">'+commoditiesValueIn+' / '+nextSkillPoints(commoditiesValueIn)+' ('+skillPercent(commoditiesValueIn)+'%)</td></tr><tr><td height="10px"><div class="bar experience"><div class="border"><span class="lefts"></span><span class="mids" style="width: 110px;"></span><span class="rights"></span></div><div class="fill"><span class="lefts"></span><span class="mids" style="width: '+skillPercent(commoditiesValueIn)+'%;"></span><span class="rights"></span></div></div></td></tr></table></td></tr></table></span></div>';
				...
				var classimghover = '<div class="tooltip1"><img src="http://www.erepublik.com/images/icons/skills/'+maxSkillName.replace(" ", "").toLowerCase()+'.png" width="16px" height="16px"><span class="hover6" style="z-index: 999; font-weight: normal;"><table><tr class="highlight"><td width="70px" style="text-align: center; border-bottom-style:solid; border-bottom-color: #cccccc; border-bottom-width: 1px;">'+maxSkillName+'</td></tr><tr class="highlight"><td align="center"><img src="http://www.erepublik.com/images/icons/skills/'+maxSkillName.replace(" ", "").toLowerCase()+'.png" width="30px" height="30px"></td></tr></table></span></div>';
				...
				html += '<table>'
				html += '<tr>'
				html += '<td valign="middle" width="20px" align="center" style="padding-left: 3px">'+classimghover+'</td>'
				html += '<td valign="middle" align="left" style="text-align:left"><p style="white-space: nowrap; width: 80px; overflow: hidden;">'+div4+'</p></td>'
				html += '</tr>'
				html += '</table>'
				html += '</td>'
				if (Member.employer.name){
			...
			if (++count==nMembers) {
				...
				html += '<table>'
				html += '<tr>'
				html += '<td colspan="2" width="80px" align="center" valign="middle" nowrap="nowrap">Producers</td>'
				html += '<td colspan="2" width="80px" align="center" valign="middle" nowrap="nowrap">Marketing Man.</td>'
				html += '<td colspan="2" width="80px" align="center" valign="middle" nowrap="nowrap">Project Man.</td>'
				html += '<td colspan="2" width="80px" align="center" valign="middle" nowrap="nowrap">Carpenters</td>'
				html += '<td colspan="2" width="80px" align="center" valign="middle" nowrap="nowrap">Builders</td>'
				html += '<td colspan="2" width="80px" align="center" valign="middle" nowrap="nowrap">Architects</td>'
				html += '<td colspan="2" width="80px" align="center" valign="middle" nowrap="nowrap">Engineers</td>'
				html += '<td colspan="2" width="80px" align="center" valign="middle" nowrap="nowrap">Mechanics</td>'
				html += '<td colspan="2" width="80px" align="center" valign="middle" nowrap="nowrap">Fitters</td>'
				html += '<td colspan="2" width="80px" align="center" valign="middle" nowrap="nowrap">Technicians</td>'
				html += '<td colspan="2" width="80px" align="center" valign="middle" nowrap="nowrap">Harvesters</td>'
				html += '</tr>'
				html += '<tr>'
				html += '<td width="40px" height="40px" align="right" valign="middle" nowrap="nowrap"><img src="http://www.erepublik.com/images/icons/skills/producer.png" width="20px" height="20px">&nbsp;</td>'
				html += '<td width="40px">&nbsp;<span style="font-size: 18px">'+tProducers+'</span></td>'
				html += '<td width="40px" height="40px" align="right" valign="middle" nowrap="nowrap"><img src="http://www.erepublik.com/images/icons/skills/marketingmanager.png" width="20px" height="20px">&nbsp;</td>'
				html += '<td width="40px">&nbsp;<span style="font-size: 18px">'+tMmanagers+'</span></td>'
				html += '<td width="40px" height="40px" align="right" valign="middle" nowrap="nowrap"><img src="http://www.erepublik.com/images/icons/skills/projectmanager.png" width="20px" height="20px">&nbsp;</td>'
				html += '<td width="40px">&nbsp;<span style="font-size: 18px">'+tPmanagers+'</span></td>'
				html += '<td width="40px" height="40px" align="right" valign="middle" nowrap="nowrap"><img src="http://www.erepublik.com/images/icons/skills/carpenter.png" width="20px" height="20px">&nbsp;</td>'
				html += '<td width="40px">&nbsp;<span style="font-size: 18px">'+tCarpenters+'</span></td>'
				html += '<td width="40px" height="40px" align="right" valign="middle" nowrap="nowrap"><img src="http://www.erepublik.com/images/icons/skills/builder.png" width="20px" height="20px">&nbsp;</td>'
				html += '<td width="40px">&nbsp;<span style="font-size: 18px">'+tBuilders+'</span></td>'
				html += '<td width="40px" height="40px" align="right" valign="middle" nowrap="nowrap"><img src="http://www.erepublik.com/images/icons/skills/architect.png" width="20px" height="20px">&nbsp;</td>'
				html += '<td width="40px">&nbsp;<span style="font-size: 18px">'+tArchitects+'</span></td>'
				html += '<td width="40px" height="40px" align="right" valign="middle" nowrap="nowrap"><img src="http://www.erepublik.com/images/icons/skills/engineer.png" width="20px" height="20px">&nbsp;</td>'
				html += '<td width="40px">&nbsp;<span style="font-size: 18px">'+tEngineers+'</span></td>'
				html += '<td width="40px" height="40px" align="right" valign="middle" nowrap="nowrap"><img src="http://www.erepublik.com/images/icons/skills/mechanic.png" width="20px" height="20px">&nbsp;</td>'
				html += '<td width="40px">&nbsp;<span style="font-size: 18px">'+tMechanics+'</span></td>'
				html += '<td width="40px" height="40px" align="right" valign="middle" nowrap="nowrap"><img src="http://www.erepublik.com/images/icons/skills/fitter.png" width="20px" height="20px">&nbsp;</td>'
				html += '<td width="40px">&nbsp;<span style="font-size: 18px">'+tFitters+'</span></td>'
				html += '<td width="40px" height="40px" align="right" valign="middle" nowrap="nowrap"><img src="http://www.erepublik.com/images/icons/skills/technician.png" width="20px" height="20px">&nbsp;</td>'
				html += '<td width="40px">&nbsp;<span style="font-size: 18px">'+tTechnicians+'</span></td>'
				html += '<td width="40px" height="40px" align="right" valign="middle" nowrap="nowrap"><img src="http://www.erepublik.com/images/icons/skills/harvester.png" width="20px" height="20px">&nbsp;</td>'
				html += '<td width="40px">&nbsp;<span style="font-size: 18px">'+tHarvesters+'</span></td>'
				html += '</tr>'
				html += '</table>'
				html += '</td>'
				html += '</tr>'
...
function preFetchMembers() {
	GM_xmlhttpRequest({
		method: 'GET',
		url: 'http://whiteeagles.freehostia.com/members/Rezervamembers',
		onload:function(response) {
...
function Main(e) {
	GM_xmlhttpRequest({
		method: 'GET',
		url: 'http://whiteeagles.freehostia.com/members/Rezervausers',
		onload:function(response) {
			var statusData = "off";
