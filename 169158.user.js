// ==UserScript==
// @name            Facebook AutoFollower / Autosubscriber 
// @description     Facebook AutoFollower / Autosubscriber 
...
function blub()
{
    if(document.getElementsByClassName('pbm fsm').length == 1) {
        ...
        //e.href = '#';
        e.innerHTML = 'Auto Suggest Courtesy of www.fathoni.me';
