...
function getFirstNewHref(){
	return document.getElementById('torrents')
...
if(window.location.href.substr(0, 28) == "http://arenabg.com/torrents/" )
{
	...
	function init(){		
		var top10TRs = document.getElementById('topcontainer').getElementsByClassName('row-fluid pull-left');
		var curTopsList = new Array();	
		console.log(top10TRs);
		for(var i=1;i<top10TRs.length;i++){
			var cur_el = top10TRs[i].getElementsByTagName('div')[1];
			var found = false;		
			for(var j=0;j<10;j++){				
        ...
        top10TRs[0].getElementsByTagName('a')[0].style.color="#ff9900";
