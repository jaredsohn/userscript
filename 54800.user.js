...
xLang['ACTUALIZAR'] = 'เมือง frissítése';
...
xLang['SHOWCOLORRESLEVELS'] = 'สรุปlelőhelyek szinezése';
...
xLang['SHOWRESUPGRADETABLE'] = "Mutassa a สรุปot fejlesztési táblátját";
...
xLang['RESOURCEFIELDS'] = 'สรุปtermelők';
...
//3.5.4.7
xLang['SHOWMAPTABLE'] = 'Mutassa a เมือง, oázisok listáját a térképnél';
//3.5.4.7.2
...
//3.7.4
xLang['SHOWSENDTROOPSRESOURCES'] = "Egységek küldése/สรุป küldése gomb mutatása";
//3.7.8.1
xLang['SHOWCPINUPGTABLES'] = "Mutassa a KP/nap-ot az épület-táblánál";
xLang['UPGTABLES'] = "สรุปtermelő/épület tábla";
...
xLang['RESBARTABLETITLE'] = "สรุปok";
//3.7.9.2
xLang['SHOWRESBARTABLE'] = "Mutassa a สรุปokat külön ablakban is";
xLang['FLOATRESBARTABLE'] = "สรุปok mutatása mozgatható ablakban";
xLang['FLOATBOOKMARKS'] = "Könyvjelzők mozgatható ablakban lévő mutatása";
//3.7.9.3
xLang['SHOWPOPINVL'] = "Népesség mutatása a เมือง listájánál";
...
//3.8.2.3
xLang['SHOWVL2TABLE'] = 'Mozgatható ablakban mutassa a เมืองat(2 oszlopban)';
//3.8.2.7
...
//3.8.6.6
xLang['SHOWBIPATTINVL'] = 'Informáciük mutatása az épitésekről és az egységmozgásokról<br>a เมือง listájában';
...
xLang['SHOWRPRINFOTOOLTIPS'] = 'Távolság és ido mutatása เมืองhoz<br>(Gyülekezotér & Jelentések)';
xLang['EDIT'] = 'EDIT';
xLang['NPCOPTIONS'] = 'NPC segíto beállításai';
xLang['NPCASSISTANT'] = 'NPC segíto számítások és linkek mutatása';
xLang['SHOWMAPTABLE'] = 'Játékosok/เมือง/oázisok mutatása a térképnél';
		...
		if (TB3O.crtUserRace != "false" && qDist != 0) {
			...
			if (addMTime == true) {
				...
				if (boolAllRaces) {
					...
					aMalign = docDir[1];
					iHTML += "<td class='tb3cnb' >" + gIcons["merchant"] + "</td><td class='tb3cnb' style='font-size:8pt; color:blue; text-align=" + aMalign +";'>" + formatTime(aTime) + " h</td><td>&nbsp;&nbsp;&nbsp</td>";
			...
			if (addTTime == true) {
				...
				for (iTT = 0; iTT < 10; iTT++) {
					...
					if (boolAllRaces) {
						...
						iHTML += "<td class='tb3cnb' ><img " + imgName + "></td><td class='tb3cnb' style='font-size:8pt; text-align:" + properAlign +";'>" + "&nbsp;" + formatTime(aTime) + " h</td><td>&nbsp;&nbsp;&nbsp</td>";
