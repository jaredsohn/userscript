...
/* farm */				"50": {"w": [ 50, 200, 400, 1400, 3500, 6000, 10000, 16000, 25000, 38000 ], "s": [ 0, 0, 200, 600, 1500, 3000, 5000, 8000, 13000, 20000 ], "th": 3},
		...
		// try {
					...
					for (i=0; i<btns.length; i++) {
						...
						cont.add(btn, {row: 1, column: i});
					}
					this.chat.add(cont, {top: 0, left: 15});
		...
		qx.Class.define("louTweak.queueTimesLabel", {
			...
			construct: function () {
				...
				this.queueTimeGrid2.add(TitleResearch.set({textColor: "#40C849", font: "bold"}), {column:2, row:0});
				...
				updateQueueTimes: function() {
					...
					if (p != null) {
					 ...
					 if (tech != null) {
					  ...
					  var Purificado = tech.__fx[283][InvestigacaoAtual].r[5];

					  var TitleResearchValue = ( (Castelos >= ValorBonus) && ((InvestigacaoAtual +2) % 4 == 0)) ? "Título!" : "- - - -";					  
					  ...
					  var TotalFalta = (CstlFalta > 0) ? RecFalta + "Ou obtenha mais <b><font color=#40C849>" + CstlFalta + "</font></b> Castelo(s)." : RecFalta;
					  TitleResearch.set({textColor: "#FF0000" })
					  TitleResearch.setToolTipText("Purificados Faltantes:<hr>" + TotalFalta);

					  if (TitleResearchValue == "Título!")
					  {
						  TitleResearch.set({textColor: "#40C849" })
						  TitleResearch.setToolTipText("Investigação de Título - Bônus de Castelo");
					  }

					  if ((TitleResearchValue != "Título!") && (pr != null)) {
						 if ((pr[3][1] >= Purificado) && (pr[2][1] >= Purificado) && (pr[1][1] >= Purificado) && (pr[0][1] >= Purificado)) {
						   TitleResearchValue = "Título!";
						   TitleResearch.set({textColor: "#40C849" });
						   TitleResearch.setToolTipText("Investigação de Título - Valor de Purificado Alcançado");
						 }
					  }
