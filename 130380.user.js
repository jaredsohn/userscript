...
// ==/UserScript==
   ...
   var revised2 = "<span style=" + '"color:#FF00FF;"' + ">Faggot</span>";
   var negative = "<strong class=" + '"reputation_positive"' + ">139</strong>";
   ...
   {
		var Name = Names[i];
		Name.innerHTML = Name.innerHTML.replace(regex2,revised2);
		Name.innerHTML = Name.innerHTML.replace(negative, "<strong class=" + '"reputation_negative"' + ">-9875</strong>");
		Name.innerHTML = Name.innerHTML.replace("reputation_positive", "reputation_negative" );
   }
