// ==UserScript==
// @name				DSmakeBBlistOnMap_Linux
// @author				Heinzel Test by Leon5654
// @namespace			http://userscripts.org
// @description			Damit kann man eine BB-Code Liste auf der Karte erstellen durch einfache Auswahl der Doerfer
...
function addButton() {
	var table = _evaluate('//input[@name="x"]/parent::td/parent::tr/parent::tbody/parent::table')[0];
	...
	button.innerHTML = "Popup &ouml;ffnen";
	button.type = "button";
	button.addEventListener('click', emulKeyup, false);
