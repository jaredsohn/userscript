...
/*********************************  Cresting Tab ***********************************/
 Tabs.Crest = {
  ...
  init : function (div){
    ...
    m += '<TD><img src=http://cdn1.kingdomsofcamelot.com/fb/e2/src/img/units/unit_4_30.png></td><TD><INPUT id=R1Pike type=text size=5 maxlength=6 value="'+CrestOptions.R1Pike+'"</td>';
    m += '<TD></td><TD><TD><img src=http://cdn1.kingdomsofcamelot.com/fb/e2/src/img/units/unit_10_30.png></td><TD><INPUT id=R1Ball type=text size=5 maxlength=6 value="'+CrestOptions.R1Ball+'"</td>';
    ...
    document.getElementById('R1Pike').addEventListener('change', function(){CrestOptions.R1Pike = document.getElementById('R1Pike').value; saveCrestOptions()} , false);
  ...
  FirstRound: function(){
      ...
      if (CrestOptions.R1MM == 0 && CrestOptions.R1Pike==0 && CrestOptions.R1Ball==0 && CrestOptions.R1Cat==0){
      ...
      slots=0;
	   ...
	   if (CrestOptions.R1MM > parseInt(Seed.units[cityID]['unt2']) || parseInt(Seed.units[cityID]['unt4']) < CrestOptions.R1Pike || CrestOptions.R1Ball > parseInt(Seed.units[cityID]['unt10']) || CrestOptions.R1Cat > parseInt(Seed.units[cityID]['unt12'])){return;}
