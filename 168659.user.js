...
// @id             
// @name           hasbromlp 
// @version        2.01 05/02/2013
// @author         H hasbromlp
// @description    This script is for the emotes in the hasbromlpcytube room
// @include        http://cytube.calzoneman.net/index.html?channel=hasbromlp*
// @include        http://cytube.calzoneman.net/?channel=hasbromlp*
// @include        http://cytube.calzoneman.net/r/hasbromlp*
// @include        http://synchtube.6irc.net/r/hasbromlp*
// @include        http://cytube.calzoneman.net/r/hasbromlp
//// @run-at         document-end
// ==/UserScript==
...
":derpy:":'<img src="http://i.imgur.com/k06YC.gif" width="80: height="80">',
