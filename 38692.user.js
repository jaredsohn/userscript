...
// ==UserScript==
// @name            platypus-hi5-group-list
// @namespace       Platypus
// @include         http://*hi5.com/friend/profile/displayGroups.do*
// @description     Changes hi5.com group tab links to bring up the Most Recent list of topics, skips the "View All Topics" step.  See http://www.hi5.com/friend/group/displayTopic.do?groupId=1021&topicId=15398321
// @date            9 March 2009
...
// Change group links to bring up the Most Recent list of topics instead of the "Introduction to the Group" (Front) page:
do_modify_html_it(window.document,document.evaluate('./DIV[3]/DIV[1]/DIV[2]/DIV[1]/TABLE[1]/TBODY[1]/TR[1]/TD[1]/DIV[1]', main_div, null, XPathResult.FIRST_ORDERED_NODE_TYPE,null).singleNodeValue,/--front-html/g,'--topics-html',null);
