// ==UserScript==
// @name         delicious tags
// @namespace    http://netroworx.com/
// @description   Shows your delicious tags on any tagged pages  
// @includes     *
...
/*
Author: Original: Lucas Richter  + Enhancements by: Greg Pagendam-Turner
License: Creative Commons Attribution-ShareAlike 2.5 (http://creativecommons.org/licenses/by-sa/2.5/)
*/

	var debug = true;
	const MINUTES_BETWEEN_GET_ALL = 15;
    	const USER_AGENT = '/delicious_tags.user.js';
...
//alert('setcache: '+temp)
	...
	function showTaste(aUrl, found, tags) {
	  ...
	  GM_addStyle('#taste {background: url(http://images.del.icio.us/static/img/delicious.gif) no-repeat top left white; border: 2px solid green; position: fixed; z-index: 32766; bottom: 2px; right: 0; padding: 0 0 0 20px; height: 16px; font-family: Arial, Verdana, sans; font-size: 14px; padding-right: 2px; padding-top: 2px;}');
