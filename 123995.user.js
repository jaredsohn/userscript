...
javascript: (function () {
    if (document.getElementsByClassName('canvas_iframe_util')[0]) {
        ...
        var healththreshold = parseInt(25);
        ...
        if ((0 < healththreshold) && (healththreshold < maxHealth)) {
            function checkhealth() {
                ...
                function request() {
                    //var preurl = 'http://facebook-ca2.mafiawars.zynga.com/mwfb/remote/';
                ...
                if (autohealelt = document.getElementById("autoheal")) {
                    ...
                    healthelt.innerHTML += '<span id="autoheal"><a href="#">Auto-Heal (' + healththreshold + ') ' + healcity + '</a></span>';
                }
                //timer =	setInterval(function() {
                //do_ajax('inner_page', hospital_url.replace("http://facebook-ca2.mafiawars.zynga.com/mwfb",""), 1, 0);
                ...
                if (cur_health < healththreshold) {
                    //do_ajax('inner_page', healurl.replace("http://facebook-ca2.mafiawars.zynga.com/mwfb",""), 1, 1);
                    //do_ajax('', 'remote/html_server.php?xw_controller=hospital&xw_action=heal&xw_city=4', 1, 0, null, hospital_onload);
                    //do_ajax('', hospital_url.replace("http://facebook-ca2.mafiawars.zynga.com/mwfb",""), 1, 0)
                    setTimeout(function () {
                    http ='http://';
                    if (/https/.test(document.location)) {
						http = 'https://';
					}
                        do_ajax('', healurl.replace(http+ "facebook-ca2.mafiawars.zynga.com/mwfb", ""), 1, 0, null);
                    }, 1000)
                }
                //}, 2000);
            }
