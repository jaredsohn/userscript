// ==UserScript==
// @name        iRix - itix plugins [V]
// @namespace   http://itix.nl/beheer/anonieme_verkoop
// @description Vergemakkelijkt verkoop in Itix op dnk.nl (Verkoop)
// @include     http://dnk.nl/beheer*
// @include     http://www.dnk.nl/beheer*
// @version     1.7.1.5
// @downloadURL https://userscripts.org/scripts/source/167983.user.js
// @updateURL   https://userscripts.org/scripts/source/167983.meta.js
...
//Strippenkaart Valkvoucher/Dinerbon
var prijs_13_1=22;
var prijs_13_2=-1; //Altijd -1
var prijs_13_3="ValkVoucher/Dinerbon";
var prijs_13_4=6.5;
var prijs_13_5="false";
	...
	$("div#window_voorstellingen_reservering .link.reserveer_voorstelling.categorie_film").live("click", function(){
		...
		function adjustRes(){
			if($("div#window_voorstellingboeking_nieuw div#voorstellingboeking_nieuw_betaling_box select#voorstellingboeking_nieuw_betaalwijze_0").attr("class")=="input_check"){
				...
				connectPriceChange(prijs_13_1, prijs_13_2, prijs_13_3, prijs_13_4, prijs_13_5); //Valkvoucher/Dinerbon
...
//				$("div#window_voorstellingboeking_nieuw div#voorstellingboeking_nieuw_betaling_box select#voorstellingboeking_nieuw_betaalwijze_0_overlay option[value='Podium Cadeaukaart']").remove();
				...
				$("div#window_voorstellingboeking_nieuw div#voorstellingboeking_nieuw_betaling_box select#voorstellingboeking_nieuw_betaalwijze_0_overlay option[value='PLATEAU PAS']").remove();
				$("div#window_voorstellingboeking_nieuw div#voorstellingboeking_nieuw_betaling_box select#voorstellingboeking_nieuw_betaalwijze_0_overlay option[value='ValkVoucher/Dinerbon']").remove();
