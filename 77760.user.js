// ==UserScript==
// @name           Ikariam Aide-Memoire (Donations)
// @namespace      http://userscripts.org/scripts/show/77760
// @author         Martynius (http://userscripts.org/users/68307)
// @license        GNU GPL v3 (http://www.gnu.org/copyleft/gpl.html)
// @homepage       http://userscripts.org/scripts/show/77760
// @description    Shows the Donations points of a player in the island view afer you have looked it up in the highscores.
...
if ( PAGE_ID !== undefined ) {
	new IkariamAideMemoire( {
		SCORE_TYPE: "donations",
		SCRIPT_ID: 77760,
		SCRIPT_VERSION:	"1.0.0",
		SCRIPT_NAME: "Ikariam Aide-Memoire (Donations)"
	});
}