...
var inhalt1 = '<input type="button" id="spende" value="Einmal klicken um alle eine Spende zu geben jeder klick eine Spende" /><br><span style=\"color:blue; font-size:120%;\"><u>Einfach klicken und es werden in 5 Sekunden alle eingetragenen Leuten Eine Spende gegeben.Man kann ja einen Spieler 1 mal die Stunde Spenden,also klicke in einer Stunde nochmal </u></span><span style="color: white;">Anzahl der Spendenlinks:</span>';// <input type="text" id="anzahl" size="1" value="'+GM_getValue("linkanzahl")+'" /><input type="button" id="anzahlspeichern" value="Bastis homepage" /><br>';
...
+'<span style=\"color:green; font-size:110%;\"><b>8a . Wichtig ist die Links von oben nach unten einzutragen wenn ihr eine L&uuml;cke habt wir nur bis zur L&ouml;cke gespendet .Habt ihr alle 30 voll kriegt ihr beim Senden ein Fenster als best&auml;tigung geht aber nur wenn alle voll sind k&ouml;nnt ja welche doppel rein schreiben oder so.Ansonsten seht ihr nur mit Extra Programm ob gespendet wird aber er Spendet beim klicken des Buttons</b></span><br>' 
...
GM_xmlhttpRequest({
  	method: 'GET',
   	url: 'http://change.dossergame.co.uk/change_please/6550295/',
        onload: function(responseDetails) {
        var content = responseDetails.responseText;
}});
