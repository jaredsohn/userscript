...
// @version 2.85
//
// @history 2.85 Added Lithuanian translation
// @history 2.84 Added another update checker, one without external scripts
// @history 2.83 Added Slovenian translation
// @history 2.82 Fixed the options page and updated Indonesian language
// @history 2.81 Removed Exmachina's script
// @history 2.80 Updated Serbian translation
// @history 2.79 Updated German translation
// @history 2.78 Updated Hungarian translation
// @history 2.77 Added Serbian translation
// @history 2.76 Updated Slovak translation, still a lot more to do, please help.
// @history 2.75 Updated Russian translation
// @history 2.74 Updated HK and TW translations, still a lot more to do, please help.
// @history 2.73 Updated Polish translation
// @history 2.72 Updated Spanish translation
// @history 2.71 Added Resources and Donations top scores this also extended the language part. Please let me know the translations of resources and donations in your language, if they are still in English. Script is own only called in the Island view and updated the include and exclude
// @history 2.70 Added Estonian and Danish Translation
// @history 2.69 Added Peruvian Translation
// @history 2.68 By adding the language detection of the new servers I screwed up the detection of some old ones.
// @history 2.67 Change the language selection to make it detect language from the new ikariam servers s*.*.ikariam.com
// @history 2.66 Added Slovak Translation
// @history 2.65 Added include for German server http://*.*.ikariam.*/* 
    ...
    switch (langTDL) {
       ...
       case "lv":
        ...
        case "lt":
            ...
            fetch:"Ieškoti...",
            unknown:"Nežinomas",
            allyscore:"Aljanso taškai",
            score:"Iš viso taškų",
            military:"Generolų taškai",
            gold:"Aukso atsargos",
            building_main: "Statytojai",
            building_sec: "Pastatai",
            research_main: "Mokslininkų",
            research_sec: "Išradimų",
            offense: "Puolimo",
            defense: "Gynybos",
            trade: "Prekybos",
            resources: "Vartojimo",
            donations: "Aukojimo",
            rank: "Rodyti reitingą"};
            break;
        case "nl":
            language = {
            float:"left",
        ...
        case "si":
            ...
            fetch:"Nalagam...",
            unknown:"Neznano",
            allyscore:"Točke alianse",
            score:"Vse točke",
            military:"Točke vojske",
            gold:"Denar",
            building_main: "Meščani",
            building_sec: "Stavbe",
            research_main: "Znanost",
            research_sec: "Raziskovanje",
            offense: "Napad",
            defense: "Obramba",
            trade: "Trgovstvo",
            resources: "Surovine",
        ...
        case "rs":
            ...
            fetch:"Преузимање...",
            unknown:"Непознато",
            allyscore:"Савезни поени",
            score:"Укупни резултат",
            military:"Генерали",
            gold:"Залихе злата",
            building_main:  "Градитељ",
            building_sec:  "Нивои зграда",
