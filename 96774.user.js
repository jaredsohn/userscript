// ==UserScript==
// @name	TWCR BetaUp
// @namespace	http://userscripts.org/scripts/show/96774
// @include	http://*.the-west.*/game.php*
// @include	http://userscripts.org/scripts/review/96774
// @include	http://userscripts.org/scripts/source/96774.meta.js
...
if (url.indexOf(".the-west.") != -1) {
        ...
        //MISE À JOUR
        var VERSION                     = "1.4" ;
        var NUMERO_SCRIPT               = "96774" ;
        var NB_HISTORY                  = 5 ;
        var MENU_maj                    = "GZA_" + NUMERO_SCRIPT + "_MAJ" ;
        var DELTA_maj                   = 3600 ; // 24*3600 24 h en s
	function maj_a_verifier() {
        ...
        function trait_ret_iframe(contenu_iframe) {
				...
				var myhref ='';
				myhref = safari ? 'href="http://userscripts.org/scripts/show/'+ NUMERO_SCRIPT +'"':'href="http://userscripts.org/scripts/source/'+ NUMERO_SCRIPT +'.user.js"';
                                var ferme_maj = "javascript:AjaxWindow.close('Mise_a_jour_Maj');" ;
                                contenu_fenetre_history += "<TABLE WIDTH=100%><TR>" ;
                                contenu_fenetre_history += "<TD ALIGN='center'><SPAN><A id='myAinstaller'  CLASS='button_wrap button' "+ myhref +" ><SPAN CLASS='button_left'></SPAN><SPAN CLASS='button_middle'>Installer</SPAN><SPAN CLASS='button_right'></SPAN></SPAN></A></SPAN></TD>";
                                ...
                                AjaxWindow.show("Mise_a_jour", undefined, "Maj", contenu_fenetre_history, {title:script_nom}, true);
                                //Titre en centré
                                document.getElementById("window_Mise_a_jour_Maj").getElementsByTagName("h2")[0].style.cssText = "text-align:center";
				
				var funcIframeInstaller = function (evt) {
					javascript:AjaxWindow.close('Mise_a_jour_Maj');
				}
				$('myAinstaller').addEvent('click', funcIframeInstaller);
                        }
...
/**/
	...
	this.uriParam='';
	this.loadParam();
	this.serverMib = 'http://wbe03.mibbit.com/?settings=655b397c88cdfeb5fd5aec7bb968d015&server=irc.Mibbit.Net&channel=%23som'+this.uriParam+'&PromptPass=true';
	this.addCRButton();
	}
...
//z-index -1 ok chrome & safari
		...
		xhtml += '									<option value="wbe03">wbe03.mibbit.com</option>';
