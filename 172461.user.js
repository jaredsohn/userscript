// ==UserScript==
// @name		حفظ تشكيلة معينة 
// @namespace		agrafix.net
// @description		يسمح هذا بحفظ تشكيلة معينة لاستعملها في وقت لاحق
...
(function(){
	...
	function savedUnitsStr() {
		var savedUnits = ' >استعمال هذه التشكيلة (';
	...
	$("<a href='javascript:;' id='saveInsertedUnits' />").text(">حفظ تشكيلة").click(function() {
		$.each(UnitInputs, function(idx, itm) { 
