...
var autoPlayUpDownRiskMethod = getValue("config_autoPlayUpDownRiskMethod__", "manual");
...
function autoPlayOn()
{
    if( autoPlay )
    {
        ...
        if( (!unsafeWindow.MAP || unsafeWindow.MAP.map != 'map') )
        {
            ...
            {
                oLog.innerHTML += "Voltando para a Minha Rua ...";
        ...
        else if( userLife < autoPlayMinLife )
        {
            ...
            oLog.innerHTML = "AutoPlay ON (Hospital!)<br>Curando ...";
        ...
        else if( userStamina < autoPlayMinStamina )
        {
            ...
            else
            {
              ...
              oLog.innerHTML = "AutoPlay ON (Drink!)<br>Tomando drink...";
        ...
        else if( autoPlayDirection == "downToxic" || userToxic > autoPlayMaxToxic )
        {
            ...
            oLog.innerHTML = "AutoPlay ON (Desintoxicando)<br>Esprando um pouco antes de voltar";
