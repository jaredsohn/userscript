...
document.location.href="http://92.48.103.52/fantasy/game.php?var1=Gold&command=Inventory&var2=70000&Submit=GO&screen=BANK";
    ...
    document.location.href = 'http://92.48.103.52/fantasy/game.php?var5=14861&var1=Lesser+Shield+Scroll&command=use&screen=SCROLLS';
}
  else if(k==51) {
    document.location.href ='http://92.48.103.52/fantasy/game.php?var5=14861&var1=Summon+Skeleton&command=use&screen=SCROLLS';
  }
  else if(k==49) {
    document.location.href =
'http://92.48.103.52/fantasy/game.php?var5=14861&var1=Lesser+Focus+Scroll&command=use&screen=SCROLLS';
  }
 else if(k==52) {
    document.location.href =
"http://92.48.103.52/fantasy/game.php?var5=14861&var1=Shield+Scroll&command=use&screen=SCROLLS";
  }
else if(k==53) {
    document.location.href =
"http://92.48.103.52/fantasy/game.php?var5=14861&var1=Focus+Scroll&command=use&screen=SCROLLS";
  }
else if(k==57) {
    ...
    document.location.href = 'http://92.48.103.52/fantasy/game.php?command=swapcharacter&var1=14861';
  }
else if(k==75) {
    ...
    document.location.href = 'http://92.48.103.52/fantasy/game.php?command=swapcharacter&var1=14938';
  }
else if(k==83) {
