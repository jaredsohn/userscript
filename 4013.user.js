/* -*-mode:JavaScript;coding:latin-1;-*- Time-stamp: "2006-09-02 00:13:10 AKDT"
...
// @description	  Make every Amazon book page link to its Powell's page
// @version       0.0.3
// @include       http://*.amazon.*
...
link on that page to the Powell's page for that book, so you can
compare prices, etc.

This script is based directly on jmills's "Amazon PDX Linky" script,
but is a near-complete rewrite of it.
...
function my_link (a, isbn) {
  a.setAttribute('href', 'http://www.powells.com/biblio/' + isbn);
  a.setAttribute('accesskey','p');
  a.setAttribute('title',"[alt-p]  Look this up at Powell\'s Books");
  a.appendChild( document.createTextNode( "\xBBPowell's" )); //\u2192
  a.style.color = '#efefde';
  a.style.backgroundColor = '#5b848b';
  return a;
}
