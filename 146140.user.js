...
// @namespace	http://www.ajk007.byethost8.com/pardus/infocenter/
// @description	Enables to share combat/hack/payment logs and missions bullettin board with NS Infocenter [ http://www.ajk007.byethost8.com/pardus/infocenter/ ]
...
var servers = [ 
	{ 
		name: "Natural Selection", //the name you want to be displayed in the combo box 
		url: "http://www.ajk007.byethost8.com/pardus/infocenter", //the exact url to your Infocenter, no trailing slashes 
		accounts: { //the user names you wont to use; to disable a universe, just delete the line, but look twice at commas!!! 
			...
			artemis: {name: "Natural-Selection", password: "827ccb0eea8a706c4c34a16891f84e7b"}
		 } 
	} 
,
	{
		name: "Union Infocenter",
