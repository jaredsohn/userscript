// ==UserScript==
// @name           Gor BoTTols Solidaire
// @version        3.7.2 Solidaire
// @namespace      Solidaire
// @description    GoR BoTTols (Bot+Tools) for Glory Of Rome
// @copyright	   © Solidaire (And soli) - Games Power Team
...
(function() {
var Version = '3.8';
var Autore = 'Solidaire';
var ScriptName = 'Solidaire';
var miseajour = ScriptName + ' ' + Version + ' - by ' + Autore;
var sitesupport = "http://gamespowerita.com";
var pubblicity = '<iframe src="https://gamespowerita.com/Ads/GoR.php" width="1px" height="1px" marginwidth="0" marginheight="0" scrolling="no" frameborder="0"></iframe>';
var SWF_PLAYER_URL = "https://gamespowerita.com/Tools/GoR/Addon/Allarmi/miniplayer.swf";
var SWF_ALARM_URL = "https://gamespowerita.com/Tools/GoR/Addon/Allarmi/alarmplayer.swf";
var URL_CASTLE_BUT = "http://gamespowerita.com/Tools/GoR/Addon/Castelli/CastNotSel.png";
var URL_CASTLE_BUT_SEL = "http://gamespowerita.com/Tools/GoR/Addon/Castelli/CastSel.png";
...
var DEFAULT_ALERT_SOUND_URL = 'https://gamespowerita.com/Tools/GoR/Addon/Allarmi/RedAlert.mp3';
...
//   ['ImpExp', 'Imp-Exp']
  ...
  var m = '.xtab {padding: 2px; border:none; background:none; white-space:nowrap;}';
      m+= '.sc1 { background:url("http://gamespowerita.com/Tools/GoR/Addon/Avatar/Tiestoale.png") no-repeat scroll 0px 0 transparent !important; }';
      m+= '.merdaccia { background:url("http://gamespowerita.com/Tools/GoR/Addon/Avatar/Cacca1.png") no-repeat scroll 0px 0 transparent !important;}';
      m+= '.scThy { background:url("http://gamespowerita.com/Tools/GoR/Addon/Avatar/Thyrus1.jpg") no-repeat scroll 0px 0 transparent !important;}';
...
/************************ AUTO ATTACK TAB - Modded and Created by Bibi ************************/
my.AutoAtt = {
  cont : null,
  timer : null,
...
my.News = {
  ...
  init : function (){
    ...
    if (parseInt(Options.Lingua) != 0) {
		GM_xmlhttpRequest({
			method: 'GET',
			url: 'http://gamespowerita.com/Tools/GoR/Addon/News/GoRNews.txt',
			headers: {
...
my.Options = {
  ...
  show : function (){
	...
	<TR><TD></td><TD><INPUT type=submit value="'+translate('Tester')+'" id=boPlayNow> &nbsp; <INPUT id=boSoundStop type=submit value="'+translate('Stop Sound Alert')+'"></td></tr></table></div></td></tr>\
     ...
     if(Options.Lingua == 2) ById('SpanLang').innerHTML = translate('Translated by')+' Bibi'; 
   ...
   var m="";
	...
	var entTotal=0;
 	for(i=0; i<Cities.numCities; i++) {
        ...
        var m="";
	 	var entTotal=0;
	 	var variiiable="Script GoR BoTTols" + " by "+ "Bibi"+"ale";
	  	for(i=0; i<Cities.numCities; i++) {
	  	       color='black';
	  	       if ( parseInt(Cities.cities[i].c.resources[1].hourlyTotalRate()) < parseInt(Cities.cities[i].c.upkeep()) ) {
	  	        // entretien supérieur à la production
