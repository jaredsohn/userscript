// ==UserScript==
// @name Travian Multi a/c
// @author  LordKernel
// @include http://*.travian.*/login.php
// @include http://*.travian.*/login.php?asid=*
// @version 1.0
// @Created On 2009/Nov/02
// @description Script provides quick change of account. Never enter your sitting account long name again. In future with your support we plan to dev multi a/c with multi village manager with task queue controller. this script is dedicated to Marathas.
// ==/UserScript==

//--- Settings ---

	var userIds = [["LoginUserName01", "s1"], ["LoginUserName02", "s2"],["LoginUserName03", "s3"]];
    //example -> var userIds = [["lordkernel", "s1"]]; 
