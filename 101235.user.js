...
var Version = '20110322';
var Title = 'Lavendar Tools';
  ...
  init : function (div){
    ...
    try {      
      m = '<TABLE class=ptTab>\
		...
		<TR><TD><INPUT id=optEnableFoodAlert type=checkbox /></td><TD>Send warning message to Alliance Chat if food will run out in less than \
	  ...
	  t.togOpt ('optEnableFoodAlert', 'enableFoodAlert');
