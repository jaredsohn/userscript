...
if (document.getElementById('content-body') != undefined){
	document.getElementById('content-body').style.width="1200px";
}

for(var i=0;i<document.getElementsByTagName('*').length;i++){
	if(document.getElementsByTagName('*')[i].className == 'entry-content'){
		document.getElementsByTagName('*')[i].style.width = '1000px';
		document.getElementsByTagName('*')[i].style.marginleft = '160px';
