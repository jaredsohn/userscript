// ==UserScript==
// @name           Facebook - Ex Amigos (BETA)
// @namespace      facebook_amigosex
// @description    Script para saber quien te borro del facebook.
// @author         http://www.facebook.com/pablinnm
// @homepage       http://www.forondanga.com/
...
//
//
//                            Facebook Ex Amigos(c)2010, by Edouard Gatouillat
//                                           http://www.unfriendfinder.fr
// Facebook Ex Amigos is licensed under a Creative Commons Attribution-Noncommercial-No Derivative Works 3.0 Unported License
...
//
//
// Unfriend Finder (Changelog)
// Last changes: 29/09/2010 11:36pm, dev build 21.980
//
// Main Changes:
//
// Version 21:
...
var Params = {
    ...
    links: {
        ...
        ffpage: 'http://www.facebook.com/pages/Ex-Amigo/146025395443716',
        group: 'http://www.facebook.com/group.php?gid=98534953863',
...
function footer() {
    if (!getFromId('footerUF')) {
        if (getFromId('footerContainer')) getFromId('footerContainer').firstChild.nextSibling.innerHTML = getFromId('footerContainer').firstChild.nextSibling.innerHTML + ' · Desarrollado por <a id="footerUF" onclick="window.open(this.href); return false;" title="Facebook del Desarrollador" accesskey="0" href="http://facebook.com/pablinnm">Pablo Macaluso</a>';
    }
...
$fr_FR = {
    ...
    hidemenubar:"Masquer Unfriends dans la menubar",
    dissociateLists:"Dissocier Requêtes acceptées et ignorées",
    showTime:"Afficher la date de découverte de l'ami en moins",
    disabled:"désactivé",
    editable:"activé",
    ok:"Ok",
    error:"Erreur",
    ...
    rvoid:"Va remettre toutes les données du script à zéro. Attention à ce que vous faites.",
    ...
    text_accepted:"A accepté votre demande d'ami",
    ...
    text_error:"Erreur dannulation de la demande.",
    text_hideu:"Masquer l'unfriend",
    text_hide:"Masquer",
    text_alwayshide:"Toujours Masquer",
    text_removec:"Annuler la demande",
    text_missing:"Infos manquantes.",
    hasignored:"a ignoré une de vos demande d'ami",
    ...
    importData:"Import de données",
    text_export:"Exporter",
    text_import:"Importer",
    dataToExport:"Données à exporter",
    back1:"La liste des amis en moins est locale. Cela veux dire que si vous utilisez facebook sur un autre ordinateur, ou sur une autre session, vous ne pourrez pas récupérer vos unfriends.",
    back2:"Utilisez cet outil de sauvegarde pour exporter et importer vos listes sur un autre navigateur.",
    hideOwnUnfriends:"Masquer les amis que vous supprimez",
    wontAppear:"Ce profil ne s'affichera pas parmis vos amis en moins.",
    today:"Aujourd'hui",
    yesterday:"Hier",
...
$it_IT = {
    ...
    btn_delete:"Elimina",
    btn_next:"Avanti",
    usesetting:"Usare queste impostazioni per gestire il comportamento dello script",
    deactivated:"Profili disattivato",
    reactivated:"Profili riattivato",
    ...
    hidemenubar:"Nascondi la voce 'Unfriends' nella barra dei menù",
    dissociateLists:"Separa le richieste accettate e ignorate",
    showTime:"Mostra le date di controllo unfriends",
    ...
    rvoid:"ATTENZIONE!: resettare lo script cancellerà i dati di Unfriends.",
    creset:"Premere per resettare",
    resettitle:"Riporta i valori a quelli di default",
    resetbody:"Sicuro di voler resettare ?",
    selectall:"Seleziona Tutti",
    selectnone:"Seleziona Nessuno",
    use:"Usa",
    display:"Mostra",
    text_ignored:"ignorato tua richiesta di amicizia.",
    text_unfriend:"non è più nella tua lista d'amici.",
    text_reactivated:"Profilo riattivato",
    text_deactivated:"Profilo cancellato o nascosto",
    text_being:"Il profilo è in corso di riattivazione",
    text_unavailable:"Profilo indisponibile",
    ...
    nomessages:"Nessun Messaggi",
    text_noa:"Nessuna richiesta d'amicizia in attesa",
    text_nou:"Nessun Unfriends",
    text_error:"Errore durante la rimozione della connessione.",
    text_hideu:"Nascondi Unfriend",
    text_hide:"Nascondi",
    text_alwayshide:"Sempre Nascondi",
    text_removec:"Disconnetti",
    text_missing:"Informazioni non reperibili.",
    hasignored:"ignorato una delle tue richieste d'amicizia",
    new_version:"Nuova versione",
    notif_version:"Una nuova versione è disponibile",
    here:"qui",
    wasunfriend:"è stata nella vostra lista amici.",
    ...
    back1:"La lista degli \'unfriends\' è locale: ciò comporta che usando facebook su altro computer o in un\'altra sessione, non potrai avere la tua lista di \'unfriends\'.",
    back2:"Usare questa funzione di \'backup\' per esportare verso (o importare da) un altro navigatore",
    hideOwnUnfriends:"Hascondi gli amici che rimuovi",
...
$de_DE = {
    ...
    hide_perm:"Wollen Sie dauerhaft ausblenden {name} ?",
    header_unfriends:"Unfriends",
    header_reappeared:"Reaktiviert",
    header_ignored:"Anfragen ignoriert",
    header_accepted:"Anfragen akzeptierte",
    header_both:"Anfragen akzeptierte",
    header_pending:"Anfragen Anstehend"
};
$tr_TR = {
    langname:"Türkçe",
    unfriends:"Silenler",
...
$pt_BR = {
    ...
    header_accepted:"Pedidos Aceitos",
...
$sq_AL = {
    ...
    deactivated:"Profili u deaktivizua",
    reactivated:"Profili u reaktivizua",
    ...
    resettitle:"Rifresko valutat për gjendjen e mëparshme të skriptit",
    ...
    text_reactivated:"Profili u reaktivizua",
    text_deactivated:"Profili u shlye ose u mshef",
    text_being:"Profili është duke u shkyqyr",
    text_unavailable:"Profili nuk është në dispozicion",
    text_accepted:"Kërkesa për miqësi u pranua",
    text_canceled:"Kërkesa për miqësia u ndalua",
    text_pending:"Kërkesa për miqësi në pritje",
    nomessages:"Nuk Mesazhet",
    text_noa:"Nuk ka kërkesa në pritje",
    text_nou:"Nuk ka Joshoqëri",
    text_error:"Gabim duke hequr lidhjen",
    text_hideu:"Mshef Joshoqërin",
    text_hide:"Mshef",
    ...
    new_version:"Verzion i ri",
    notif_version:"Verzioni i ri është ne dispozicion",
    here:"këtu",
    ...
    text_export:"Exporto",
    text_import:"Importo",
    dataToExport:"Të dhënat për export",
    back1:"Lista e joshoqëris është lokale. Kjo do të thot qe nëse ju e përdorni facebook-un ne ndonjë kompjuter tjetra,ose në ndonjë sezon tjetër te firefoxi, ju nuk do të jeni në gjendje të shikoni joshoqërin.",
    ...
    hide_perm:"A do ta fshehësh Pëgjithmon {name} ?",
...
var template = {
    ...
    Donate: function() {
        ...
        return ''+
        '<div style="margin-bottom:20px; text-align:center; padding:5px;" class="uiTextHighlight" id="uf_donation">'+
    ...
    UnfriendLists: function() {
        ...
        '       <div class="uiHeader uiHeaderBottomBorder uiHeaderGroup"><div class="clearfix uiHeaderTop"><div class="lfloat"><h3 class="uiHeaderTitle">'+LANG.header_reappeared+'</h3></div></div></div>'+
        '       <ul id="reappearedContentUL"></ul>'+
        '   </div>'+
        '   <div id="groupUnfriends" style="display:none;">'+
        '       <div class="uiHeader uiHeaderBottomBorder uiHeaderGroup"><div class="clearfix uiHeaderTop"><div class="lfloat"><h3 class="uiHeaderTitle">'+LANG.header_unfriends+'</h3></div></div></div>'+
        '       <ul id="unfriendsContentUL"></ul>'+
        '   </div>'+
        '   <div id="groupAcceptedIgnored" style="display:none;">'+
        '       <div class="uiHeader uiHeaderBottomBorder uiHeaderGroup"><div class="clearfix uiHeaderTop"><div class="lfloat"><h3 class="uiHeaderTitle">'+LANG.header_both+'</h3></div></div></div>'+
        '       <ul id="acceptedignoredContentUL"></ul>'+
        '   </div>'+
        '   <div id="groupIgnored" style="display:none;">'+
        '       <div class="uiHeader uiHeaderBottomBorder uiHeaderGroup"><div class="clearfix uiHeaderTop"><div class="lfloat"><h3 class="uiHeaderTitle">'+LANG.header_ignored+'</h3></div></div></div>'+
        '       <ul id="ignoredContentUL"></ul>'+
        '   </div>'+
        '   <div id="groupAccepted" style="display:none;">'+
        '       <div class="uiHeader uiHeaderBottomBorder uiHeaderGroup"><div class="clearfix uiHeaderTop"><div class="lfloat"><h3 class="uiHeaderTitle">'+LANG.header_accepted+'</h3></div></div></div>'+
        '       <ul id="acceptedContentUL"></ul>'+
        '   </div>'+
        '   <div id="groupPending" style="display:none;">'+
        '       <div class="uiHeader uiHeaderBottomBorder uiHeaderGroup"><div class="clearfix uiHeaderTop"><div class="lfloat"><h3 class="uiHeaderTitle">'+LANG.header_pending+'</h3></div></div></div>'+
        ...
        '       <div class="uiHeader uiHeaderBottomBorder uiHeaderGroup mtl">'+
        '           <div class="clearfix uiHeaderTop">'+
        '               <div class="lfloat"><h3 class="uiHeaderTitle">'+LANG.debug+'</h3></div>'+
        '               <div class="rfloat"><h5 style="position:relative; top:3px;"><a onclick="div = this.parentNode.parentNode.parentNode.parentNode.parentNode; div.className = (div.className == \'visible\'?\'closed\':\'visible\');"><span class="changeLink">'+LANG.change+'</span><span class="hideLink">'+LANG.hide+'</span></a></h5></div>'+
        '           </div>'+
        '       </div>'+
        '       <div class="desc">'+ 
        '           <div class="lfloat">'+LANG.usedebug+'</div>' +
        '       </div>'+ 
        '       <div class="hiddenContent">'+
        ...
        '                       <tr>' +
        '                           <th class="no_border"></th>' + 
        '                           <th class="even_column no_border">'+LANG.activate+'</th>' +
        '                       </tr>' +
        '                       <tr>' +
        '                           <th class="iconPlace">' +
        ...
        '                       </tr>' +
        '                       <tr class="settings row">' +
        '                           <td class="action_text">'+LANG.adebug+'</td>' +
        '                           <td class="even_column">' +
        '                               <input type="checkbox" value="display_deactivated_profiles_disabled" name="settings.debug" id="debug"' + (settings.debug == 1 ? ' checked="checked"' : '') + '" title="'+LANG.adebug+'" class="inputcheckbox "/>' +
        '                           </td>' +
        '                       </tr>' +
        '                   </tbody>' +
        '               </table>' +
    ...
    UnfriendFinderBox: function() {
        return '<div class="UIHomeBox UITitledBox" style="margin-top:-2px;">'+
        '   <div class="uiHeader uiHeaderTopAndBottomBorder mbm pbs">'+
        '      <div class="clearfix uiHeaderTop">'+
        ...
        '          </div>'+
        '          <div>'+
        '              <h4 class="uiHeaderTitle">Ex-Amigos <small style="font-size:8px;">por Pablo Macaluso</small></h4>'+
        '          </div>'+
        '      </div>'+
        '   </div>'+
        ...
        '        <div class="emu_ad">'+
        '            <div>'+
        '                <strong><a id="becomeFan_title" href="http://www.facebook.com/pages/Ex-Amigo/146025395443716">Hazte Fan</a>&nbsp;&nbsp;<strong id="joinGroup_dot" style="display:none;">·</strong>&nbsp;&nbsp;<a style="display:none;" id="joinGroup_title" href="http://www.forondanga.com/">Visita Forondanga.com</a></strong>'+
        '            </div>'+
        '            <div class="UIImageBlock clearfix" style="margin-top:5px;">'+
        '                <a style="display:none;" id="ufPageIMG" class="UIImageBlock_Image UIImageBlock_SMALL_Image ad_image" href="http://forondanga.com"><img src="http://external.ak.fbcdn.net/safe_image.php?d=244df5cd4c5103221ffe46dcaa1aadbe&w=90&h=90&url=http%3A%2F%2Fwww.forondanga.com%2Fstyles%2Fdefault%2Fxenforo%2Flogoforondanga.og.png" class="img"></a>'+
        '                <a style="display:none;" id="ufGroupIMG" class="UIImageBlock_Image UIImageBlock_SMALL_Image ad_image" href="http://forondanga.com"><img src="http://external.ak.fbcdn.net/safe_image.php?d=244df5cd4c5103221ffe46dcaa1aadbe&w=90&h=90&url=http%3A%2F%2Fwww.forondanga.com%2Fstyles%2Fdefault%2Fxenforo%2Flogoforondanga.og.png" class="img"></a>'+
        '                <div class="UIImageBlock_Content UIImageBlock_SMALL_Content">'+
        '                    <a class="ads_text" href="'+Params.links.page+'">Unite a la comunidad de foros mas copada de argentina, conoce amigos y divertite! Todo eso y mas en Forondanga!</a>'+
        '                </div>'+
    ...
    Welcome_en_US: function() {
        return '<div style="background: transparent url(\'http://www.unfriendfinder.fr/images/Unfriend-69.png\') no-repeat center; position: relative; text-align:left;">'+
        '<span style="font-size:12px;">Ya instalaste el Ex-Amigo, te voy a contar un poco como se usa !</span><br /><br />'+
        'Una vez instalado, tomara un momento en que se estabilize, despues de unas horas el programa ya estara listo para ser usado.<br />'+
        'Ahora puedes enviar peticion de amigo a alguien y ver si te ignora o no, tambien recibiras notificaciones si alguien te borro de su facebook.<br /><br />'+
        '<span style="font-weight:bold;">Apalala! Cuidado:</span> No podras ver a la gente que te haya eliminado antes de usar este programa. Este script no puede viajar al pasado (aun).<br /><br />'+
        'Pudes configurar el script haciendo click en "Opciones" , o despues haciendo click en "Ajustes".<br /><br />'+
        'Para mas informacion, o preguntas visita la pagina de Fans.<br />'+
        '</div>';
    },
    Contextual_menu_en_US: function() {
        return 'Para identificar facilmente el numero de ex-amigos, un contador de color rojo se muestra junto a este enlace, con el numero de ex-amigos.<br />'+
        'Para verlos, solo haz click.<br />'+
        'A continuacion, seras redirigido a la lista de ex-amigos.<br /><br />'+
        'No olvides visitar www.forondanga.com!<br />';
    },
    Contextual_filter_en_US: function() {
        return 'Este es el nuevo filtro, te mostrara quien te ignoro o borro del Facebook.<br />'+
        'Este filtro es accesible solo en la pagina principal y es muy facil de ingresar.';
    },
    Contextual_awaitings_en_US: function() {
        return 'Usa este link para acceder a tus solicitudes de amistad pendientes. Y busca quien acepto o ignoro tu solicitud.';
    },
    Contextual_settings_en_US: function() {
        return 'Puedes entrar a los ajustes de Ex-Amigo aqui.<br />'+
        'Pudes configurarlo a tu gusto, como por ej:<br />'+
        'ocultar o mostrar el link en la barra de arriba,<br />'+
        'mostrar los ex amigos por fecha,<br />'+
        'ocultar o mostrar notificaciones, y mas.';
    },
...
var UnfriendFinderBox = function() {
    ...
    ufbox.show = function() {
        ...
        getFromId('like_box').src = 'http://www.facebook.com/plugins/likebox.php?id=146025395443716&width=237&connections=10&stream=false&header=true&height=287';
        core.reValidateLang();
        void(r = rand(122))
...
var Handler = function($target, $extra) {
        ...
        for (var n = 0;n<filters.length;n++) {
            if (filters[n]) {
                ...
                if (/navItem_/.test(filter.id)) {
                    ...
                    if (filter.id == _id) {
                        CSS3.addClass(filter, 'selected opened');
                        CSS3.addClass(document.body, 'uflist');
                        CSS3.removeClass(document.body, 'nonuflist');
                    }
                    else {
                        CSS3.removeClass(filter, 'selected opened open'); 
    ...
    handler.showUnfriendLayer = function() {
        ...
        if (!handler.showingSettings) CSS3.setClass(getFromId('navItem_unfriends'), 'selected opened'); 
    ...
    handler.setUFHeader = function($type) {
        ...
        switch ($type) {
            ...
            case 'messages' :
                n = 0;
                CSS3.setClass(getFromId('iconHeader'), 'uiHeaderImage img spritemap_8s11zo sx_e9c8d3');
    ...
    handler.clickHeaderToShowUnfriends = function() {
        ...
        CSS3.setClass(getFromId('navItem_unfriends'), 'selected opened');
    ...
    handler.clickHeaderToShowAwaitings = function() {
        if (getFromId('UFfilterAwaitings').parentNode.className == 'selected') return;
        ...
        CSS3.setClass(getFromId('UFfilterAwaitings').parentNode, 'selected'); 
        CSS3.setClass(getFromId('UFfilterSettings').parentNode, ''); 
        CSS3.setClass(getFromId('UFfilterMessages').parentNode, '');
        core._showAwaitings();
    ...
    handler.clickHeaderToShowSettings = function() {
        if (getFromId('UFfilterSettings').parentNode.className == 'selected') return;
        CSS3.hide(getFromId('loadingIndicatorAwaitings')); 
        CSS3.hide(getFromId('loadingIndicatorUnfriends')); 
        CSS3.hide(getFromId('loadingIndicatorMessagess')); 
        CSS3.display(getFromId('bubblelink_unfriends'), 'inline');
        ...
        CSS3.setClass(getFromId('UFfilterAwaitings').parentNode, '');
        CSS3.setClass(getFromId('UFfilterMessages').parentNode, '');
        CSS3.setClass(getFromId('UFfilterSettings').parentNode, 'selected'); 
    ...
    handler.clickHeaderToShowMessages = function() {
        //if (getFromId('UFfilterMessages').parentNode.className == 'selected') return;
        ...
        CSS3.setClass(getFromId('UFfilterAwaitings').parentNode, '');
        CSS3.setClass(getFromId('UFfilterSettings').parentNode, '');
        CSS3.setClass(getFromId('UFfilterMessages').parentNode, 'selected'); 
...
var ContextualFacebox = function(__constructor) {
    ...
    contextualfacebox.Build = function() {
        ...
        contextualfacebox.dialog = new xHTMLElement({
            ...
            '            <h2 class="dialog_title" style="font-size:14px;">'+contextualfacebox.title+'</h2>'+
            '            <div class="dialog_content">'+
            '                <div class="dialog_body">'+contextualfacebox.body+'</div>'+
            '                <div class="dialog_buttons clearfix" id="contextual_buttons_'+contextualfacebox.id+'"></div>'+
            '            </div>'+
            '        </div>'+
            '    </div>'
        }).getElement();
    ...
    _beeper.Add = function($icon, $message, _id, $status) {
        ...
        if (getFromId('UFBeeper_'+$icon+'_'+_id)) {
            ...
            if ($icon == 'unfriend') {
                ...
                _beeper.icon = '<img src="'+Params.images.blank+'" class="UFBeep_Icon UIImageBlock_Image UIImageBlock_ICON_Image spritemap_8s11zo sx_e9c8d3" alt="" />';
            }
            ...
            new xHTMLElement({
                element: 'div',
                innerHTML: ''+
                '                <div class="UFBeep_NonIntentional status_'+$status+'" style="cursor:default;">'+
                '                    <div class="UFBeep_Icon">'+_beeper.icon+'</div>'+
                '                    <div class="UFBeep_Title" id="UFBeeper_'+$icon+'_'+_id+'" style="cursor:default;">'+_beeper.message+'</div>'+
                '                </div>',
                parentNode: beepsBox
            });
            if ($icon == 'messages') {
    ...
    _useritem.Build = function() {
        if (getFromId('homeUnfriends')) {
            ...
            _useritem.element = new xHTMLElement({
                ...
                innerHTML: ''+
                '   <div class="UIImageBlock clearfix UIImageBlock_Entity from'+_useritem.status+'">'+
...
var UnfriendFinder = function($Env) {
    ...
    core.addStyles = function() {
        ...
        "#like_box { border: none; margin-bottom: 20px; position: relative; float: right; overflow: hidden; width: 240px; height: 287px; left: 5px; }\n"+
    ...
    core.notify = function(_id, $name, $type, $status) {
        if (getFromId('jewelNotifs')) {
            ...
            if ($type == 'ignored') {
                ...
                try {
                    core.Beeper.Add('version', '<a href="'+Params.links.page+'">'+Params._0x4d22[0]+'</a>: '+LANG.notif_version+' <a onclick="window.open(this.href); return false;" id="versionLink" href="'+Params.links.update+'">'+LANG.here+'</a>.', _id);
                }
                catch (exception) { ; }
            }
        }
                ...
                if (core.uidChecked.hasOwnProperty(uid)) {
                    ...
                    if (core.uidChecked[uid] == 'deactivated') {
                        if (core.reappeared.Items[uid]) {     
                            var delta = (Math.round((new Date()).getTime() / 1000) - core.reappeared.Items[uid].time);
                            if (delta < 86400) {
                                aHide = true;
                            ...
                            core.deactivated.Add(uid, core.reappeared.Items[uid]);
                            core.unfriends.Add(uid, core.reappeared.Items[uid]);
                            } */
                        }
            ...
            for (var user in core.reappeared.Items) {
                if (core.reappeared.Items.hasOwnProperty(user)) {
                    if (core.reappeared.Items[user].hidden) {
                        var delta = (Math.round((new Date()).getTime() / 1000) - core.reappeared.Items[user].time);
                        if (delta > (86400 * 5)) {
    ...
    core.check = function($_first) { 
        ...
        var $typeahead_correct = {
            method: 'get',
            headers: Params.Ajax.Headers,
            url: 'http://www.facebook.com/ajax/typeahead/friends_page_search.php?1-1-1&u='+core.user_id+'&__a=1&time='+Math.floor((new Date()).getTime() / 1000),
            onload: function($result) {
            ...
            if (h <= 0) {
                ...
                if (settings.dissociateLists) {
                    if (getFromId('acceptedContentUL')) {
                        if (document.evaluate("count(//*[@id='acceptedContentUL']/li)", document, null, 0, null).numberValue == 0) {
                            ...
                            if (document.evaluate("count(//*[@id='pendingContentUL']/li)", document, null, 0, null).numberValue > 0) CSS3.setClass(document.evaluate("//*[@id='groupPending']/div", document, null, 9, null).singleNodeValue, 'uiHeader uiHeaderBottomBorder uiHeaderGroup mtl');
                        }
                    }
                    if (getFromId('ignoredContentUL')) {
                        if (document.evaluate("count(//*[@id='ignoredContentUL']/li)", document, null, 0, null).numberValue == 0) {
                            ...
                            if (document.evaluate("count(//*[@id='acceptedContentUL']/li)", document, null, 0, null).numberValue > 0) CSS3.setClass(document.evaluate("//*[@id='groupAccepted']/div", document, null, 9, null).singleNodeValue, 'uiHeader uiHeaderBottomBorder uiHeaderGroup');
                        }
                        if ((document.evaluate("count(//*[@id='ignoredContentUL']/li)", document, null, 0, null).numberValue == 0) && (document.evaluate("count(//*[@id='acceptedContentUL']/li)", document, null, 0, null).numberValue == 0)) CSS3.setClass(document.evaluate("//*[@id='groupPending']/div", document, null, 9, null).singleNodeValue, 'uiHeader uiHeaderBottomBorder uiHeaderGroup');
                    }
                }
                ...
                if (getFromId('reappearedContentUL')) {
                    if (document.evaluate("count(//*[@id='reappearedContentUL']/li)", document, null, 0, null).numberValue == 0) {
                        ...
                        CSS3.setClass(document.evaluate("//*[@id='groupUnfriends']/div", document, null, 9, null).singleNodeValue, 'uiHeader uiHeaderBottomBorder uiHeaderGroup');
                    }
                }
    ...
    core.showAwaitingRequests = function() {
        CSS3.hide(getFromId('FriendsPage_BlankStateContainer'));
        if (getFromId('FriendsPage_NewContentContainer')) getFromId('FriendsPage_NewContentContainer').innerHTML = '<ul><li id="loadingIndicatorAwaitings_"><div style="height:200px; text-align:center; line-height:200px;"><img src="'+Params.images.bigIndicator+'" /></div></div></li></ul>';
        CSS3.display(getFromId('loadingLists'), 'block');
        if (getFromId('pendingContentUL')) getFromId('pendingContentUL').innerHTML = '<li id="loadingIndicatorAwaitings_"><div style="height:200px; text-align:center; line-height:200px;"><img src="'+Params.images.bigIndicator+'" /></div></div></li>';
        if (getFromId('acceptedignoredContentUL')) getFromId('acceptedignoredContentUL').innerHTML = '<li id="loadingIndicatorAwaitings_"><div style="height:200px; text-align:center; line-height:200px;"><img src="'+Params.images.bigIndicator+'" /></div></div></li>';
        $url = 'http://www.facebook.com/ajax/typeahead/friends_page_search.php?1-2-3&u='+core.user_id+'&__a=1&time='+Math.floor((new Date()).getTime() / 1000);
                ...
                try {
                    ...
                    if (myJson.payload.entries.length > 0) {
                        ...
                        if (getFromId('homeUnfriends')) { 
                            ...
                            if (getFromId('loadingIndicatorAwaitings_')) getFromId('loadingIndicatorAwaitings_').parentNode.removeChild(getFromId('loadingIndicatorAwaitings_')); 
                            ...
                            for (i = z; i > 0; i--) {
                                ...
                                if (core.friends.Items[uid]) {
                                    if (settings.accepted) {
                                        a$++;
                                        if (getFromId('groupPending')) CSS3.setClass(document.evaluate("//*[@id='groupPending']/div", document, null, 9, null).singleNodeValue, 'uiHeader uiHeaderBottomBorder uiHeaderGroup mtl');
                                ...
                                //ignored
                                    ...
                                    if (settings.ignored) {
                                        i$++;
                                        if (getFromId('groupAccepted')) CSS3.setClass(document.evaluate("//*[@id='groupAccepted']/div", document, null, 9, null).singleNodeValue, 'uiHeader uiHeaderBottomBorder uiHeaderGroup mtl');
                                        if (getFromId('groupPending')) CSS3.setClass(document.evaluate("//*[@id='groupPending']/div", document, null, 9, null).singleNodeValue, 'uiHeader uiHeaderBottomBorder uiHeaderGroup mtl');
                            ...
                            if ((i$ == 0) && (settings.dissociateLists) && (getFromId('groupAccepted'))) CSS3.setClass(document.evaluate("//*[@id='groupAccepted']/div", document, null, 9, null).singleNodeValue, 'uiHeader uiHeaderBottomBorder uiHeaderGroup');
                            ...
                            if (t$ > 0) ;
                                ...
                                if (getFromId('groupPending')) CSS3.setClass(document.evaluate("//*[@id='groupPending']/div", document, null, 9, null).singleNodeValue, 'uiHeader uiHeaderBottomBorder uiHeaderGroup');
                            }
                ...
                if (settings.reappeared) {
                    for (n in core.reappeared.Items) {
                        if (core.reappeared.Items.hasOwnProperty(n)) {
                            if (getFromId('groupUnfriends')) CSS3.setClass(document.evaluate("//*[@id='groupUnfriends']/div", document, null, 9, null).singleNodeValue, 'uiHeader uiHeaderBottomBorder uiHeaderGroup mtl');
                            CSS3.display(getFromId('groupReappeared'), 'block');
                            new UserItem({
    ...
    core.blockProfile = function($uid) {
        ...
        var buffered = div_rightContent.innerHTML; //temp
    ...
    core.getName = function() {
        if (getFromId('profile_name')) return getFromId('profile_name').innerHTML;
    };

    core.loadCheckProfile = function() {
        //setTimeout(core.loadCheckProfile, 2000);
                            ...
                            if (!getFromId('hasIgnored')) {
                                if (core.hasIgnored.Items[tuid]) {
                                    ...
                                    new xHTMLElement({
                                        ...
                                        innerHTML: core.getName()+' '+LANG.hasignored.replace('.', '')+'. '+core.genTime(core.awaitingsIgnored.Items[tuid].time)+' · <span class="buttonWrap"><label class="uiCloseButton uiCloseButtonSmall" style="margin-top:-2px;"><input type="submit" title="'+LANG.btn_delete+'" id="reset_hasIgnored_'+tuid+'"></label></span>',
                                        parentNode: box
                                    });
                            ...
                            if (!getFromId('wasUnfriend')) {
                                if (core.wasUnfriend.Items[tuid]) {
                                    ...
                                    new xHTMLElement({
                                        ...
                                        innerHTML: core.getName()+' '+LANG.wasunfriend.replace('.', '')+'. '+core.genTime(core.unfriends.Items[tuid].time)+' · <span class="buttonWrap"><label class="uiCloseButton uiCloseButtonSmall" style="margin-top:-2px;"><input type="submit" title="'+LANG.btn_delete+'" id="reset_wasUnfriend_'+tuid+'"></label></span>',
                                        parentNode: box
                                    });
    ...
    core.removeConnectionWith = function($uid) {
        $divContent = getFromId('div_rightContent_'+$uid);
        $el = getFromId($uid);

        d = $divContent.innerHTML; //temp
    ...
    core.checkFanGroupStatus = function() {
        if (!core.payload) {
            ...
            for(i=0;i<core.payload.length;i++) {
                //Fanpage
                if (core.payload[i].i == '146025395443716') isFan = true;
                //Group
    ...
    core.bindKeys = function() {
        ...
        EventMgr.addListener(binder, 'DOMNodeInserted', function(e){
            ...
            else document.body.className = document.body.className.replace(/\s(shifted|nonshift|ctrlShifted)/g, '')+' '+innerDOM;
        });
        inject("document.onkeydown = function(e) {"+
        "    if (e.keyCode == 27) {"+
        ...
        "   }"+
        "}");
        inject("document.onkeyup = function(e) {"+
        ...
        "    document.getElementById('bindKeys').appendChild(s);"+
        "}");
        inject("document.onblur = function(e) {"+
    ...
    core.showMessages = function() {
        ...
        for (var i = 0;i<tempmessages.length;i++) {
            ...
            new xHTMLElement({
                ...
                innerHTML: template.messagePreview(message.id, Params._0x4d22[0], 'http://www.forondanga.com/', 'http://profile.ak.fbcdn.net/hprofile-ak-snc4/hs326.snc4/41590_148784361800841_9853_q.jpg', message.title, message.preview, message.date, message.unread),
    ...
    core.showMessage = function(_id) {
        ...
        if (message) {
            ...
            new xHTMLElement({
                element: 'div',
                innerHTML: template.messageContent(message.id, Params._0x4d22[0], 'http://www.forondanga.com', 'http://profile.ak.fbcdn.net/hprofile-ak-snc4/hs326.snc4/41590_148784361800841_9853_q.jpg', message.title, message.content, message.date),
