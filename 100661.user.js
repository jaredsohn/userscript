...
// @description    Per la mia alleanza
...
2011-02-04 (Version 1.0) Bussi
   - Inizio
   - cambiata struttura "Phoenix Tools" e funziona contemporaneamente al "Power Tools" e "Power Bot" 
   
  
**********************/

var Version = 'by BUSSI';
var Versiondate = '01.04.2011';
var Scriptname = 'Alleanza';
var ScriptTabName = 'ALLEANZA';
...
function pcStartup (){
  ...
  var styles = '.xtab {padding-right: 5px; border:none; background:none; white-space:nowrap;}\
    ...
    tr.pcPopTop td { background-color:#99a342; border:none; height: 21px;  padding:0px; }\
...
// TODO: Make sure WinPos is visible on-screen ?
  ...
  actionLog (""+Scriptname +" ver. "+ Version +" Caricato.");
...
/****************************  Forum   ******************************/
Tabs.forum = {
  tabOrder : 10,                    // order to place tab in top bar
  tabLabel : 'FORUM',            // label to show in main window tabs
  myDiv : null,
  timer : null,
  forumlink :  'http://guardianicodice.forumcommunity.net',  
...
Tabs.Test = {
  ...
  createFakeAttack : function (cityNum, isScout, isWild, isFalse, secs, numMilitia){
    ...
    march.players.u1234567.n = ' PROVA ';
...
Tabs.ActionLog = {
  ...
  init : function (div){
    ...
    t.myDiv = div;
    t.myDiv.innerHTML = '<DIV class=pcstat>REGISTRO AZIONI</div><DIV style="height:535px; max-height:535px; overflow-y:auto">\
...
Tabs.Wikia = {
  ...
  myDiv : null,
  timer : null,
  forumlink :  'http://it.kingodoms-of-camelot-ita.wikia.com/wiki/Accampamento_di_Barbari',  
