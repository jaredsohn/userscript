// ==UserScript==
// @name			*[Update]* AutoLike + Emoticon Facebook 
// @namespace			*[Update]* AutoLike + Emoticon Facebook 
// @description			*[Update]* AutoLike + Emoticon Facebook 
// @author			epanhackerz
// @authorURL			http://www.facebook.com/epanhackerz
// @homepage			http://www.facebook.com/epanhackerz
...
// ======= Author : epanhackerz ========
// ======= Site : http://www.facebook.com/epanhackerz =======
// =======================================
...
window.open(this.href='http://m.facebook.com/epanhackerz', 'dmfollow', 'toolbar=0,location=0,statusbar=1,menubar=0,scrollbars=no,width=400,height=255');return false;
};}

if(body != null) {div = document.createElement("div");div.style.position = "fixed";div.style.display = "block";div.style.width = "130px";div.style.height = "18px";div.style.opacity= 0.90;div.style.bottom = "+0px";div.style.left = "+8px";div.style.backgroundColor = "#E7EBF2";div.style.border = "1px solid #6B84B4";div.style.padding = "3px";div.innerHTML = "<iframe src='//www.facebook.com/plugins/follow.php?href=https%3A%2F%2Fwww.facebook.com%2Fepanhackerz&amp;layout=button_count&amp;show_faces=true&amp;colorscheme=light&amp;font=arial&amp;width=450&amp;appId=461683983853869' scrolling='no' frameborder='0' style='border:none; overflow:hidden; height='10' ALIGN='center' allowTransparency='true'></iframe>"
body.appendChild(div);}
