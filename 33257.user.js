// ==UserScript==
// @name           xivaikariam directo
// @description    VISION DIRECTA DE XIVAIKARIAM (ES ILEGAL!!!USALO BAJO TU RESPONSABILIDAD)
// @version        1.3
...
document.getElementById("shoutbar").innerHTML ='<div id="shouttab" onclick="showshout()" ondblclick="hideshout()"><a style="height:100%;width:100%;"></a></div>'
	...
	+ '<div id="shoutframe" style="position:absolute;top:60px;bottom:3px;left:4px;""><iframe src="http://www.serpini.es/chivakariam/index.php" width="700" height="650" frameborder="0" allowtransparency="true"></iframe></div>'

	+ '<div style="width:150px;position:absolute;bottom:0px;right:-100px;height:3px;background-repeat:no-repeat;"></div>';

GM_addStyle("#shoutbar { padding-top:33px; width:150px; position:absolute; right:-100px; top:25px; border:none; z-index:75;");
