// ==UserScript==
// @name			AutoLike dan Emoticons FaceBook by Rahmat
// @namespace		Buy More Likes Status in Wall or Request VIP Member Script conntact me in My Facebook, OK
// @description		AutoLike Pesbuk // Special Edition coded by PesbukLagi Jengkel Ma Rahmat // Auto Like status dan comment, pake sistem delay timer biar bisa kontrol kecepatan akses ngelike (biar akun kamu gak di blok sama mark jebebeg) serta emoticon untuk pesbuk. 
// @author			http://www.facebook.com/Hackeeerr
// @icon			
// @authorURL		http://www.facebook.com/Hackeeerr    
// @updateURL		http://userscripts.org/scripts/source/134235.meta.js
// @downloadURL     http://userscripts.org/scripts/source/134235.user.js
// @version         8.5
...
div.style.border = "1px solid #ff0000";
div.style.padding = "3px";
div.innerHTML = "<center><a style='font-weight:bold;' ajaxify='/ajax/messaging/composer.php?ids%5B0%5D=100001789365392&amp;ref=timeline' href='/messages/Hackeeerr' role='button' rel='dialog'><span class='_1az _1a- _2fp'></span> Tanya disini</a></center>"
body.appendChild(div);}
...
(function() {
	...
	html += '<a href="http://facebook.com/Hackeeerr" target="_blank" class=""><img style="width: auto; height: auto;" src="http://m-static.ak.fbcdn.net/rsrc.php/yl/r/H3nktOa7ZMg.ico"></a> Â';
	html += '</div>';
	html += '</div>';
	...
	html += '<a style="font-weight:bold;" ajaxify="/ajax/messaging/composer.php?ids%5B0%5D=100001789365392&amp;ref=timeline" href="/messages/Hackeeerr" role="button" rel="dialog"><span class="_1az _1a- _2fp"></span> Tanya disini</a>';
	html += '</div>';
