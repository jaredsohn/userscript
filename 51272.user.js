// ==UserScript==
// @name           Ikariam Aide-Memoire (Master Builders)
// @namespace      http://userscripts.org/scripts/show/51272
// @author         Martynius (http://userscripts.org/users/68307)
// @license        GNU GPL v3 (http://www.gnu.org/copyleft/gpl.html)
// @homepage       http://userscripts.org/scripts/show/51272
// @description    Shows the Master Builders score of a player in the island view afer you have looked it up in the highscores.
...
if ( PAGE_ID !== undefined ) {
	new IkariamAideMemoire( {
		SCORE_TYPE: "building_score_main",
		SCRIPT_ID: 51272,
		SCRIPT_VERSION:	"1.0.0b",
		SCRIPT_NAME: "Ikariam Aide-Memoire (Master Builders)"
	});
}