...
function appendSpan(i,isFollowed,user){
	var strFollowed =  isFollowed == "1"?"<font color=green>是</font>":"<font color=red>否</font>";
	$(".listWrapper .userNums").eq(i).append("<span><a href='/"+user+"'>已收听我:<strong style='font-size:12px;'>"+strFollowed+"</strong></span>");
}
