// ==UserScript==
// @name        IKARIAM PIRATES tools
// @version 	86
// @namespace 	ΘΕΣΣΑΛΟΝΙΚΗ
// @author	ΘΕΣΣΑΛΟΝΙΚΗ
...
switch (location.host) {
	default:
		alliancefullnm='IKARIAM PIRATES';
		alliancenm='I-P';
		...
		//chaturl='.';		
	chaturl='http://irc2go.com/webchat/?room=ikariam-pirates&net=GRNet&name=webchat';
		//forumurl='http://ikariampirates.blogspot.com';
		forumurlnew='.';
		break;
   ...
   var showbubble=Math.floor(Math.random()*10);
    if (showbubble%2) { //If Even
       ...
       addsbubble('mayor', "IKARIAM PIRATES!!!", 130);
       addsbubble('mayor', "I P!!!", 133);
    } else {
       ...
       addsbubble('general', "ΔΕΛΤΑ-NZG-IP AC, the best!!!", 107);
       addsbubble('mayor', "I P", 110);
    }