...
// @version	      1.0
// @author 	      Stian Olsen > Jan Schroeder (Jan is no longer developing)
// ==/UserScript==
...
function insertIntoBody() {
	var copyright = document.createElement('span');
  	copyright.innerHTML = '<br><br><center><a href="http://www.facebook.com/pages/F-Chatty/214712198577261">Like our facebook-page!</a> - F-Chatty is based on FB Chat Enchancer! Jan stopped develop on this. and i continue.</center></b>';
 ...
 function ProfilLinks() {
	...
	if( !GM_getValue('fce_firstload') || fce_version != GM_getValue('fce_inst_version')) {
		jQuery.facebox('<center><h3>Hello, and thanks for using F-Chatty!</h3><br>' +
				'<h2>Please like the F-Chatty fanpage!!<br><a href="http://www.facebook.com/pages/F-Chatty/214712198577261">Click Here</a><br>' +
    ...
    function load () {
		...
		sideMenu.append('<li class="uiMenuItem" data-label="FB Chat Enhancer Fanpage"><a  class="itemAnchor" href="http://www.facebook.com/pages/F-Chatty/214712198577261"><span class="itemLabel fsm">F-Chatty Fanpage!</span></a></li>');
		sideMenu.append('<li class="uiMenuItem" data-label="hajanet.de"><a  class="itemAnchor" href="http://www.facebook.com/pages/F-Chatty/214712198577261"><span class="itemLabel fsm">&copy; stian olsen</span></a></li>');
                    ...
                    '<div id="closeFBChat" class="bb">' +
                        '<div class="clearfix fbNubFlyoutTitlebar titlebar">' +
                            '<div class="titlebarLabel clearfix">' +
                                '<div class="titlebarTextWrapper"><span class="titlebarText">Chat (<span id="numFriends">fixed by jan > Continue fixed by stian</span>)</span></div>' +
                            '</div>' +
                        '</div>' +
                    '</div>'
                )
