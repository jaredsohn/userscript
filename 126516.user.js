// ==UserScript==
// @name           Khanwars4 script
// @namespace      *
// @description    Khanwars 4.0 script
// @include        http://riteriai6.draugas.lt/*
// @include        http://riteriai3new.draugas.lt/*
// @version        1.01
// ==/UserScript==
...
function functionMain(e) {
	...
	if (lang == 'lt_LT') {
		...
		langArr['SCOPTIONS'] = 'Script Options';
		langArr['SAVE'] = 'Save';
		langArr['CANCEL'] = 'Cancel';
		langArr['EXIT'] = 'Exit';
		langArr['AND'] = 'and';
		langArr['MAPDETAILS'] = ' Map details table';
		...
		langArr['BARRACKS'] = 'Barracks';
		langArr['MARKET'] = 'Market';
		langArr['STABLE'] = 'Stable';
		langArr['BUILDINGS'] = 'Buildings';
		langArr['MARCHES'] = 'Marches';
		langArr['BLACKSMITH'] = 'Blacksmith';
		langArr['ORDER'] = 'Order';
		langArr['WORKSHOP'] = 'Workshop';
		langArr['COORDSLEVEL'] = 'Coords Level';
		langArr['KHANNAME'] = 'Khan name';
		langArr['EXPERIENCE'] = 'Experience';
		langArr['CLAN'] = 'Clan';
		langArr['BATTLE'] = 'Battle';
		langArr['REMAINS'] = 'remains';
		langArr['VIPSEARCH'] = 'VIP Search';
		langArr['FACTOR'] = 'Resource change factor';
		langArr['TOWER'] = 'Tower';
