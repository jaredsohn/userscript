...
autoPlayUpRiskOrder[0] = "newcar.rob";
autoPlayUpRiskOrder[1] = "newcar.rob";
autoPlayUpRiskOrder[2] = "newcar.rob";
autoPlayUpRiskOrder[3] = "newcar.rob";
autoPlayUpRiskOrder[4] = "newcar.rob";
autoPlayUpRiskOrder[5] = "newcar.rob";
autoPlayUpRiskOrder[6] = "newcar.rob";

// Lista de URL para baixar o risco (ajudar)
var autoPlayDownRiskOrder = new Array();

autoPlayDownRiskOrder[0] = "drugdealer.police";
autoPlayDownRiskOrder[1] = "drugdealer.police";
autoPlayDownRiskOrder[2] = "drugdealer.police";
autoPlayDownRiskOrder[3] = "sdrugdealer.police";
autoPlayDownRiskOrder[4] = "drugdealer.police";
