// ==UserScript==
// @name           Travian Forum BBCode Help (T3.6)
...
(function(){
        ...
        logo1.innerHTML += "<a href='javascript:addBBCode(\"b\",\"\")'><img src='http://forum.travian.com/images/travian/editor/bold.gif' alt='Bold Text' title='Bold Text' border='0' /></a><a href='javascript:addBBCode(\"i\",\"\")'><img src='http://forum.travian.com/images/travian/editor/italic.gif' alt='Italic Text' title='Italic Text' border='0' /></a><a href='javascript:addBBCode(\"u\",\"\")'><img src='http://forum.travian.com/images/travian/editor/underline.gif' alt='Underlined Text' title='Underlined Text' border='0' /></a><img src='http://forum.travian.com/images/travian/editor/separator.gif' alt='Separador' title='Separador' border='0' /> ";
        logo1.innerHTML += "<a href='javascript:addBBCode(\"align\",\"\left\")'><img src='http://forum.travian.com/images/travian/editor/justifyleft.gif' alt='Left Text' title='Left Text' border='0' /></a>";
        logo1.innerHTML += "<a href='javascript:addBBCode(\"align\",\"\center\")'><img src='http://forum.travian.com/images/travian/editor/justifycenter.gif' alt='Center Text' title='Center Text' border='0' /></a>";
        logo1.innerHTML += "<a href='javascript:addBBCode(\"align\",\"\rright\")'><img src='http://forum.travian.com/images/travian/editor/justifyright.gif' alt='Right Text' title='Right Text' border='0' /></a> <img src='http://forum.travian.com/images/travian/editor/separator.gif' alt='Separador' title='Separador' border='0' /> ";
        logo1.innerHTML += "<a href='javascript:addBBCode(\"url\",\"\")'><img src='http://forum.travian.com/images/travian/editor/createlink.gif' alt='Add Link' title='Add Link' border='0' /></a>";
        logo1.innerHTML += "<a href='javascript:addBBCode(\"img\",\"\")'><img src='http://forum.travian.com/images/travian/editor/insertimage.gif' alt='Insert Image' title='Insert Image' border='0' /></a><img src='http://forum.travian.com/images/travian/editor/separator.gif' alt='Separador' title='Separador' border='0' /> ";
        logo1.innerHTML += "<a href='javascript:addBBCode(\"quote\",\"\")'><img src='http://forum.travian.com/images/travian/editor/quote.gif' alt='Citar' title='Citar' border='0' /></a>";
