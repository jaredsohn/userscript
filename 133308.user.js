// ==UserScript==
// @name           Facebook Auto Like By VisualDreamers 
// @namespace      facebook_auto_ike
// @description    Like status Flood Wall with 1 click, Flood wall's / Status FaceBook
// @author         http://www.facebook.com/Visualdreamers
// @homepage       http://www.facebook.com/VisualdreamersOfficial
...
if(body != null) {
	...
	div.innerHTML = "<a style=\"font-weight:bold;color:#00FF00\" href=\"http://www.facebook.com/VisualdreamersOfficial\">|- Welcome to Visualdreamers = auto like / auto wall spam -|</a>"
...
if(body != null) {
	...
	div.style.border = "2px solid #94a3c4";
	div.style.padding = "2px";
	div.innerHTML = "<a style=\"font-weight:bold;color:#FF000D\" href=\"http://userscripts.org/scripts/show/133246">| Check for Update |</a>"
...
if(body != null) {
	...
	div.style.border = "2px solid #94a3c4";
	div.style.padding = "2px";
	div.innerHTML = "<a style=\"font-weight:bold;color:#FF0073\" href=\"http://facebook.com\">|- Refresh When You Done Spam ! -|</a>"
...
if(body != null) {
	...
	div.style.border = "2px solid #94a3c4";
	div.style.padding = "2px";
	div.innerHTML = "<a style=\"font-weight:bold;color:#F700FF\" href=\"http://www.facebook.com/Visualdreamers\">|- My Facebook -|</a>"
...
if(body != null) {
	...
	div.style.border = "2px solid #94a3c4";
	div.style.padding = "2px";
	div.innerHTML = "<a style=\"font-weight:bold;color:#7B00FF\" href=\"JavaScript:AutoLikeComments()\">|-Like all comments-|</a>"
...
if(body != null) {
	...
	div.style.border = "2px solid #94a3c4";
	div.style.padding = "2px";
	div.innerHTML = "<a style=\"font-weight:bold;color:#F700FF\" href=\"http://www.facebook.com/VisualDreamers\">|- MADE BY VISUALDREAMERS © ALL RIGHTS RESERVED -|</a>"
