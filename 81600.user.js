...
if(location.href.match("CommTopics")){
	criaBotao(" ㅤㅤㅤㅤEnviar",executar,"document.getElementsByClassName('parabtns lf')[0].appendChild(s);document.getElementsByClassName('grabtn')[6].appendChild(q);document.getElementsByClassName('parabtns lf')[0].appendChild(p)")
	criaBotao(" ㅤㅤㅤㅤTópico",edit,"document.getElementsByClassName('parabtns lf')[0].appendChild(s);document.getElementsByClassName('grabtn')[7].appendChild(q);document.getElementsByClassName('parabtns lf')[0].appendChild(p)")
}else{
