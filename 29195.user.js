// ==UserScript==
// @name           _IR_ version larga 2 (corregida)
// @description    conjunto de scripts reunidos por Enven2 para _IR_ (Ikariam) 
...
+ ' <li><h2>_IR_</h2>'
+ '   <ul>'
+ '     <li><center><a target="" href="http://s7.ikariam.es/index.php?view=sendAllyMessage&oldView=embassy&id=56621&position=8&type=50" title="Enviar un mensaje a todos los miembros de la alianza">Mensaje Circular</a></li>'
...
unsafeWindow.displayshout = function() {
	if(displayedflag == 0) {
		document.getElementById("shoutframe").innerHTML = '<iframe width="200" border="0" frameborder="0" height="100%" src="http://www.shoutmix.com/?enven2" style="margin-left:0px;"></iframe>';
		displayedflag = 1;
	}
}
...
document.getElementById("shoutbar").innerHTML ='<div id="shouttab" onclick="showshout()" ondblclick="hideshout()"><a style="height:100%;width:100%;"></a></div>'
	...
	+ '<a style="border-bottom:1px #542C0F dotted; color: #542C0F;" href="http://s7.ikariam.es/index.php?view=embassy&id=56621&position=8">Imperio Romano</a></div>'
