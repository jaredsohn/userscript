// ==UserScript==
// @name           grepoReportResCalcHUN
// @author         wBw HUN: llaszlo
// @license        Do what you want!
// @namespace      wBs_ HUN: llaszlo
	...
	init : function()
	{
		...
		if ( ResCalc.UnitData )
		{
			...
			else if ( uW.document.URL.indexOf( "action=simulator") > 0 ) 
			{
				...
				ResCalc.createResPopup('fcSim', 'Veszteségek');
				...
				if (rv)
				{
					...
					if ( attCostsTable.length | defCostsTable.length )
					{
						var sumNode = $("<div style='text-align:left;font-size:9px;'>"
								...
								+ "<tr><td align=center>&nbsp;&nbsp;Lakosság&nbsp;&nbsp;</td></tr></table></b></td>"
