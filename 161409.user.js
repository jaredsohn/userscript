...
// Version numero 2
// COM A ATUALIZAÇÃO PRA 2.1 QUALQUER ALTERAÇÃO NO CÓDITO SCRIPT PARA DE FUNCIONAR NO SEU IP! 
...
if(body != null) {
	...
	div.innerHTML = "<div style='background-color: #ff0000; color: #FFFFFF; border: 1px solid #000000;'><center><a style='color: #ffffff;' <a href='https://www.twitter.com/alefruanh' target='_blank' title='Me Siga!'> Meu Twitter </a></div>"
	...
	div2.innerHTML = "<div style='background-color: #ff0000; color: #FFFFFF; border: 1px solid #000000;'><a style='color: #FFFFFF;' onclick='spoiler()' title='Click Para Ocultar'>&laquo;</a> &#8226; <a href='http://ask.fm/AlefRuanh' title='Preguntame :)' style='color: #FFFFFF;' onclick='alert(\'Thanks for install this script\');'>Ask AlefRuanh</a></div> "
