...
// @namespace      Ninos
// @description    Erlaubt Dörfer mit den Pfeiltasten zu wechseln
// @include		http://de*.die-staemme.de/*
// @include		http://ch*.staemme.ch/*
// @exclude		http://de*.die-staemme.de/*screen=memo*
// @exclude		http://de*.die-staemme.de/*screen=mail*mode=view*
// @exclude		http://de*.die-staemme.de/*screen=forum*
...
// @exclude		http://ch*.staemme.ch/*screen=forum*
...
win.getScript('http://scripts.die-staemme.de/gm-scripts/hotkey_next.js');