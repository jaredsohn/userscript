// ==UserScript==
// @name Travian3 Beyond - all language
// @author Victor Garcia (aka Croc), Szabka
// @namespace   t3
// @version 2.6cm
// @description  Travian v3 addons originally written by Victor Garcia (aka Croc) updated by Szabka; last UPDATE 5. may 2008
...
function funcionPrincipal(e){
    ...
    var cssStyle = "";
    cssStyle += "#resumen {position: relative; width:1200px; float: bottom;}";
    cssStyle += "#tabla_mapa {position: relative; width:1200px; margin-top: 16px; float: bottom;}";
...
//		td2.setAttribute("colspan", 2);
		...
		if (areas.snapshotLength>0) {
			...
			for(var i=1;i<50;i++){
				var j= ((i-1) % 7) * 7 + 7 - Math.round(((i-1) / 7)-0.5 );
				var divs=elem('div','<div id="map_info_'+j+'" t="0" style="position:relative;left:31px;top:43px;border: solid 1px #00C000; background-color: #FEFFE3;-moz-border-radius: 8px; display: none"></div>')
				divs.className='mt'+i;
