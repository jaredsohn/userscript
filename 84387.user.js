// ==UserScript==
// @name           BBCodes para Taringa (by SharkaleÂ® Personalizado)
...
// @Modding        Version Modificada por Juampi_Mix
// @uso:script     84387
// @svc:version    [30.1.2]
// ==/UserScript==
...
// ==Variables==
var urlscript = 'http://www.sharkale.com.ar/bbcoder/script/';
...
var CategoriasT = new Array(-1,"","Ver Todas",7,"animaciones","Animaciones",18,"apuntes-y-monografias","Apuntes y MonografÃ­as",4,"arte","Arte",
	25,"autos-motos","Autos y Motos",17,"celulares","Celulares",33,"ciencia-educacion","Ciencia y EducaciÃ³n",19,"comics","Comics e Historietas",
	16,"deportes","Deportes",9,"downloads","Downloads",23,"ebooks-tutoriales","E-books y Tutoriales",34,"ecologia","EcologÃ­a",
	29,"economia-negocios","EconomÃ­a y Negocios",24,"femme","Femme",35,"hazlo-tu-mismo","Hazlo tu mismo",26,"humor","Humor",
	1,"imagenes","ImÃ¡genes",12,"info","Info",0,"juegos","Juegos",2,"links","Links",15,"linux","Linux y GNU",22,"mac","Mac",
	32,"manga-anime","Manga y Anime",30,"mascotas","Mascotas",8,"musica","MÃºsica",10,"noticias","Noticias",5,"offtopic","Off-topic",
	21,"recetas-y-cocina","Recetas y Cocina",27,"salud-bienestar","Salud y Bienestar",20,"solidaridad","Solidaridad",28,"taringa","Taringa!",
	31,"turismo","Turismo",13,"tv-peliculas-series","TV, PelÃ­culas y Series",3,"videos","Videos On-line");
var CategoriasP = new Array(-1,"","Ver Todas",7,"animaciones","Animaciones",9,"downloads","Downloads",8,"gay","Gay",1,"imagenes","ImÃ¡genes",
	12,"info","Info",2,"links","Links",10,"noticias","Noticias",5,"offtopic","Off-topic",4,"poringueras","Poringueras",
	0,"relatos","Relatos",13,"tv-peliculas-series","TV, PelÃ­culas y Series",3,"videos","Videos On-line");
// ==/Variables==
...
$('head').append('<link type="text/css" href="http://jqueryui.com/latest/themes/base/ui.all.css" rel="stylesheet"/><link href="'+GM_getValue('sharkale-theme','http://ajax.googleapis.com/ajax/libs/jqueryui/1.7.2/themes/dark-hive/jquery-ui.css')+'" type="text/css" rel="Stylesheet" class="ui-theme">');
...
if(GM_getValue("inicio") == undefined || GM_getValue("inicio") == true){
	...
	GM_setValue("PunFav",false);
	GM_setValue("EmotVis",false);
	GM_setValue("NovatosPrinc",true);
	GM_setValue("CambiarTheme",true);
	GM_setValue("HideComment",true);
	GM_setValue("inicio",false);
}

var aSWF = GM_getValue("aSWF",true);
var PunFav = GM_getValue("PunFav",false);
var EmotVis = GM_getValue("EmotVis",false);
var NovatosPrinc = GM_getValue("NovatosPrinc",true);
var CambiarTheme = GM_getValue("CambiarTheme",true);
var HideComment = GM_getValue("HideComment",true);
	
	if(CambiarTheme) GM_registerMenuCommand("BBCoder para T! y P! - Cambiar el theme de la pÃ¡gina", Cambiar_Theme);
...
function CrearBarraBBC(){
		...
		if(path != 'post' && path != 'comunidades'){
			nuevaHTML += '<a href="" onclick="insertarBBC(\'[align=left]\', \'[/align]\');return false;"><img src="'+URL+'izquierdo.png" alt="L" title="AlineaciÃ³n Izquierda" border="0"></a>\
			<a href="" onclick="insertarBBC(\'[align=center]\', \'[/align]\');return false;"><img src="'+URL+'centrado.png" alt="C" title="AlineaciÃ³n Centrada" border="0"></a>\
			<a href="" onclick="insertarBBC(\'[align=right]\', \'[/align]\');return false;"><img src="'+URL+'derecho.png" alt="R" title="AlineaciÃ³n Derecha" border="0"></a>\
			<select id="colordefont"style="font-size: 10px;position:relative; top:-4px; min-height: 16px; max-height: 16px;" onchange="insertarBBC(\'[color=\' + $$(\'colordefont\').options[$$(\'colordefont\').selectedIndex].value + \']\', \'[/color]\');this.selectedIndex=0;">\
				...
				<option style="color: brown;" value="brown"		>MarrÃ³n</option>\
		...
		<a href="" onclick="botonPrompt(\'goear\');return false;"><img src="'+URL+'goear.png" alt="GE" title="Insertar una CanciÃ³n de GoEar" border="0"></a>\
		<a href="" onclick="botonPrompt(\'esnips\');return false;"><img src="'+URL+'esnips.png" alt="EN" title="Insertar una CanciÃ³n de eSnips" border="0"></a>\
...
function Procesar_Datos(datos){
	if(datos == 'Disculpas! Hubo un error al procesar lo solicitado. Por favor, int&eacute;ntalo nuevamente en unos minutos.'){
		...
		switch(datos["error"]["code"]){
			case 1: return 'MÃ©todo Perdido.';break;
			case 2: return 'Clave para API InvÃ¡lida.';break;
			case 3:	return 'Formato InvÃ¡lido.';break;
			case 4: return 'MÃ©todo InvÃ¡lido.';break;
			case 5: return 'Faltan ParÃ¡metros..';break;
			case 6: return 'Nick de Usuario InvÃ¡lido.';break;
			case 7: return 'ParÃ¡metro InvÃ¡lido.';break;
			case 8: return 'Sin Datos.';break;
			case 9: return 'Post Eliminado.';break;
			case 10: return 'Post Privado.';break;
			case 11: return 'LÃ­mite de pedidos por minuto superado.';break;
...
function Agregar_PostGuardados(){
	...
	}else unsafeWindow.mydialog.alert("Archivo de Posts - SharkaleÂ®",'Debe elegirle un nombre al Post para guardarlo.');
}

function Guardar_PostGuardados(){
	if(confirm('Â¿EstÃ¡s seguro que deseas guardar los cambios en el Archivo de Posts?\n\nEste cambio es permanente.')){
...
Taringa_Set_Function("Obtener_PostGuardados", function(pos){
	var resp = confirm("Â¿EstÃ¡s seguro que deseas ver el post archivado?\n\nEsta acciÃ³n borrarÃ¡ cualquier post que estes realizando actualmente.");
	if(resp){
...
function Backup_on_off(){
	if(timer_backup == undefined || $('#Btn_Backup').attr('activo') == 'si'){
		var resp = confirm("Â¿EstÃ¡s seguro que deseas activar el autobackup?\n\nEsta acciÃ³n borrarÃ¡ cualquier backup previamente realizado.\n\nEl fondo del formulario de Agregar Post titilarÃ¡ de amarillo cada vez que se actualice el backup.");
		if(resp){
...
function Ver_backup(){
	var resp = confirm("Â¿EstÃ¡s seguro que deseas ver el backup guardado?\n\nEsta acciÃ³n borrarÃ¡ cualquier post que estes realizando actualmente.");
	if(resp){
		...
		if(backup != ''){
			...
			unsafeWindow.mydialog.alert("Backup de post - SharkaleÂ®",'No hay backup guardado.');
		}
	}
}
...
function Agregar_BBCguardados(){
	...
	if(seleccion != ''){
		...
		}else unsafeWindow.mydialog.alert("BBCodes Personalizados - SharkaleÂ®",'Debe elegirle un nombre al BBC para guardarlo.');
	}else unsafeWindow.mydialog.alert("BBCodes Personalizados - SharkaleÂ®",'Seleccione un texto a guardar.');
}

function Guardar_BBCguardados(){
	if(confirm('Â¿EstÃ¡s seguro que deseas guardar los cambios en los BBCodes?\n\nEste cambio es permanente.')){
...
function Exportar_Emoticones(){
	...
	GM_xmlhttpRequest({
		...
		data: 'user='+user+'&paste='+encodeURIComponent(emot),
		headers: {'Content-type':'application/x-www-form-urlencoded'},
		onload: function(h) {
			h = h.responseText;
			switch(h.charAt(0)){
				case '0': //Error
					unsafeWindow.mydialog.alert('Emoticones Exportados','<h2 style="text-shadow:2px 2px 1px #999">Antiflood: Puedes crear otro pack en '+h.substring(2)+' segundo'+(h.substring(2) != '1'? 's':'')+'</h2>');
					break;
				case '1': //Creado
					unsafeWindow.mydialog.alert('Emoticones Exportados','<h2 style="text-shadow:2px 2px 1px #999">C&oacute;digo de Referencia a sus emoticones: <span style="color:red">'+h.substring(2)+'</span></h2>');
					break;
			}
		},
		onerror: function(h) {
...
function Importar_Emoticones(pack){
	var id = prompt('CÃ³digo de referencia '+(pack? 'al pack de':'de los')+' emoticones');
	...
	$.timer(1000,function(timer){
		...
		GM_xmlhttpRequest({
			...
			data: 'id='+encodeURIComponent(id)+(pack? '&script=1':''),
			headers: {'Content-type':'application/x-www-form-urlencoded'},
			onload: function(h) {
				if(h.responseText == 'paste_no_exist' || h.responseText.substring(0,14) != 'Emot_Sharkale:' || h.responseText.substring(14).lenght < 20){
					unsafeWindow.mydialog.alert('Importar'+(pack? ' pack de ':' ')+'Emoticones','No hay '+(pack? 'pack de ':'')+'emoticones asignados a ese cÃ³digo de referencia.');
				}else{
					unsafeWindow.mydialog.alert((pack? 'Pack de ':'')+'Emoticones Importados',(pack? 'El pack de':'Los')+' emoticones '+(pack? 'fue':'fueron')+' importado'+(pack? '':'s')+' satisfactoriamente.<br><br>Si desea conservarlos tienes que guardar los cambios, de lo contrario permanecerÃ¡n los viejos emoticones.');
					if(pack)
						$('#emoticones_personalizados').append(Cargar_Emoticones(h.responseText.substring(14).split(',')));
					else
						$('#emoticones_personalizados').html(Cargar_Emoticones(h.responseText.substring(14).split(',')));
				}
			},
...
function Cargar_Emoticones(lista){
	...
	for (var i = 0; i < emot.length; i=i+2){
		nroemot++;
		html += '<span id="shark_emot_'+nroemot+'" class="ui-state-default"><img src="'+emot[i+1]+'" alt="" title="'+emot[i]+'" style="height:40px;width:40px;"><a href="" onclick="$(\'#shark_emot_'+nroemot+'\').remove();return false;"><img src="http://imgur.com/SItxU.gif" alt="Eliminar" title="Eliminar" height="12" width="12"></a><input type="hidden" name="sharkale_emot_'+nroemot+'" value="'+emot[i]+'"><input type="hidden" name="sharkale_emot_'+nroemot+'" value="'+emot[i+1]+'"></span>';
	}
	return html;
}

function Agregar_Emoticones(){
	var urlbarra = prompt('Ingrese la direcciÃ³n URL vÃ¡lida del emoticon que serÃ¡ mostrado en tu barra.');
	if(urlbarra != '' && urlbarra != null){
		if(urlbarra.search(/^https?:\/\//gi) != -1 && urlbarra.search(/,/) == -1){
			var urlemot = prompt('Ingrese la direcciÃ³n URL vÃ¡lida del emoticon que serÃ¡ mostrado a los demÃ¡s.');
			if(urlemot != '' && urlemot != null){
				if(urlemot.search(/^https?:\/\//gi) != -1 && urlemot.search(/,/) == -1){
					nuevosemot++;
					html = '<span id="shark_emot_nueva_'+nuevosemot+'" class="ui-state-default"><img src="'+urlbarra+'" alt="" title="[img='+urlemot+']" style="height:40px;width:40px;"><a href="" onclick="$(\'#shark_emot_nueva_'+nuevosemot+'\').remove();return false;"><img src="http://imgur.com/SItxU.gif" alt="Eliminar" title="Eliminar" height="12" width="12"></a><input type="hidden" name="sharkale_emot_nueva_'+nuevosemot+'" value="[img]'+urlemot+'[/img]"><input type="hidden" name="sharkale_emot_nueva_'+nuevosemot+'" value="'+urlbarra+'"></span>';
					$('#emoticones_personalizados').append(html);
				}else{
					alert('La direcciÃ³n URL del emoticon es invÃ¡lida.\n\nAsegurese de que comienza con "http://" y que no contiene comas ","');
				}
			}
		}else{
			alert('La direcciÃ³n URL del emoticon es invÃ¡lida.\n\nAsegurese de que comienza con "http://" y que no contiene comas ","');
...
function Guardar_Emoticones(){
	if(confirm('Â¿EstÃ¡ seguro que desea guardar los cambios en los emoticones?\n\nEste cambio es permanente.')){
		...
		GM_xmlhttpRequest({
			...
			onload: function(h) {
				if(h.responseText == 'paste_no_exist' || h.responseText.substring(0,14) != 'Emot_Sharkale:' || h.responseText.substring(14).lenght < 20){
					...
					unsafeWindow.mydialog.alert('Emoticones Orignales','Los emoticones originales fueron importados satisfactoriamente.<br><br>Si desea conservarlos tienes que guardar los cambios, de lo contrario permanecerÃ¡n los viejos emoticones.');
					$('#emoticones_personalizados').html(Cargar_Emoticones(h.responseText.substring(14).split(',')));
				}
			},
			onerror: function(resultado) {
...
// ==Funciones que serÃ¡n agregadas a la pÃ¡gina==
...
case 'vyoutube': //YouTube
	var msg = prompt("Ingrese la direcciÃ³n del video de YouTube:");
	if(msg != '' && msg != null){
		...
		if(msg.length < 5 || msg.length > 20) {
			alert("DirecciÃ³n del video invÃ¡lida");
		} else {
...
case 'vgoogle': //Google Video
	var msg = prompt("Ingrese la direcciÃ³n del video de Google:");
	if(msg != '' && msg != null){
...
case 'vmegavideo': //Megavideo
	var msg = prompt("Ingrese el cÃ³digo entero que provee la pÃ¡gina a travÃ©s del link \"Video Incrustado\" en cada video de MegaVideo:");
	if(msg != '' && msg != null){
	...
	if(msg != '' && msg != null){
		...
		if (enc != null && enc[1] != null && enc[2] != null) {
			...
			if(msg.length < 30 || msg.indexOf("/") == -1){
				alert("DirecciÃ³n de la mÃºsica invÃ¡lida");
			} else {
				unsafeWindow.insertarBBC('[swf]' + msg + '[/swf]');
			}
		}else alert("DirecciÃ³n de la mÃºsica invÃ¡lida");
	}
	break;
case 'goear': //Cancion GoEar
	var msg = prompt("Ingrese la direcciÃ³n URL Ã³ el cÃ³digo HTML Ã³ la ID de la canciÃ³n deseada de GoEar:");
	if(msg != '' && msg != null){
		var regexp = /file=([\w]*)/i;
		var enc = regexp.exec(msg);
		if (enc != null) {
...
case 'swf': //Flash
    if(seleccion.substring(0,7) != 'http://'){
		var msg = prompt("Ingrese la direcciÃ³n URL del archivo SWF",'http://');
		if(msg != '' && msg != null)
			unsafeWindow.insertarBBC('[swf]' + msg + '[/swf]\nFuente: [url]'+msg+'[/url]');
...
case 'image': //Imagen
    if(seleccion.substring(0,7) != 'http://'){
	var msg = prompt("Ingrese la direcciÃ³n URL completa de la imÃ¡gen",'http://');
	if(msg != '' && msg != null)
...
case 'imageclick': //Imagen clickeable
    var msg = prompt("Ingrese la direcciÃ³n URL completa de la imÃ¡gen",'http://');
    if(msg != '' && msg != null){
	var msg2 = prompt("Ingrese la direcciÃ³n URL completa del link",'http://');
	if(msg2 != '' && msg2 != null)
...
case 'link': //Link
	...
	if(msg != '' && msg != null){
		if(inicio == fin) {
		   var msg2 = prompt("Â¿Desea agregarle una etiqueta a la URL?");
		   if(msg2 != '' && msg2 != null)
	...
	break;
case 'url2bbc': //Link
	if(!confirm('Â¿EstÃ¡s seguro que deseas agregarle BBC a todas las URL\'s?\n\nPuede no funcionar correctamente con algunas URL.')) return;
...
Taringa_Set_Function("preview", function(){
  ...
  if(path == 'mensajes' || path == 'comunidades' || path == 'comuagregar'){
	if(jQuery.trim(txt.value) == ''){
		$(".msg_add_comment").hide(1000).html("Debes escribir algo para realizar la previsualizaciÃ³n").show(1000);
	} else {
		...
		$('#return_agregar_comentario').slideUp(1000, function(){
			...
			HTML += '<br /><img src="'+URL+'cargando.gif" alt="CARGANDO..." title="Cerrar PrevisualizaciÃ³n" border="0" /><br /><br />';
 			HTML += '<span style="font-weight: bold">Cerrar PrevisualizaciÃ³n</span><br /><br />';
			HTML += '</div>';
			...
			$.ajax({
					...
					data: 'titulo=Preview&cuerpo='+encodeURIComponent(txt.value),
 					success: function(h){
						...
						if(path == 'mensajes'){
							var HTML = '<br><div class="cita" style="color:#464646;text-shadow:0 1px 0 #CCCCCC;"><img src="'+URL+'cerrar.gif" alt="[X]" title="Cerrar PrevisualizaciÃ³n" border="0" onclick="($(\'#return_agregar_comentario\').slideUp(1000))" style="margin-right:5px" onmouseover="this.style.cursor=\'pointer\'" />PrevisualizaciÃ³n - SharkaleÂ®</div>';
							HTML += '<div class="citacuerpo">'+respuesta+'</div><br>';
						}else{
							var HTML = '<div class="respuesta clearfix"><div class="answerInfo"></div>';
							HTML += '<div class="answerTxt"><div class="answerContainer"><div class="Container" style="padding:0"><div class="answerOptions"><div class="floatL metaDataA"><img src="'+URL+'cerrar.gif" alt="[X]" title="Cerrar PrevisualizaciÃ³n" border="0" onclick="($(\'#return_agregar_comentario\').slideUp(1000))" align="absmiddle" style="margin-right:5px" onmouseover="this.style.cursor=\'pointer\'" />PrevisualizaciÃ³n - SharkaleÂ®</div></div><div style="margin: 10px !important;" class="cuerpo_comm">'+respuesta+'</div></div></div></div></div>';
						}
 						$('#return_agregar_comentario').slideUp(1000, function(){
	...
	if(jQuery.trim(txt.value) == '' || txt.value == $(txt).attr('title')){
		$(".miComentario .error").html("Debes escribir algo para realizar la previsualizaciÃ³n").show('slow');
	} else {
		...
		$('#post').slideUp(1500, function(){
			...
			HTML += '<br /><br /><img src="'+URL+'cargando.gif" alt="CARGANDO..." title="Cerrar PrevisualizaciÃ³n" border="0" /><br /><br />';
			HTML += '<span style="font-weight: bold">Cerrar PrevisualizaciÃ³n</span><br /><br />';
			HTML += '</div></div></div>';
			$('#post').html(HTML).slideDown(1500, function(){
				$.ajax({
					...
					success: function(h){
						...
						HTML += '<div class="comment-box"><div class="dialog-c"></div><div class="comment-info clearbeta"><div class="floatL"><img src="'+URL+'cerrar.gif" alt="[X]" align="absmiddle" title="Cerrar PrevisualizaciÃ³n" border="0" onclick="$(\'#post\').slideUp(1000)" style="margin-right:5px" onmouseover="this.style.cursor=\'pointer\'" /> <b>PrevisualizaciÃ³n - SharkaleÂ®</b></div></div><div class="comment-content">'+respuesta+'</div></div></div>';
						$('#post').slideUp(1500, function(){
...
Taringa_Set_Function("validate_form", function(form, elementos){
	...
	if(cuerpo == ''){errores += '<li style="list-style-type:disc"> El tema estÃ¡ vacio.</li>';}
	if(titulo == ''){errores += '<li style="list-style-type:disc"> El tema no tiene tÃ­tulo.</li>';}
	...
	if(errores != ''){
		unsafeWindow.mydialog.alert('Error al Crear Tema - SharkaleÂ®','<div align="left" style="padding:0px 20px"><b>Se han encontrado los siguientes errores:<br><br><ul style="margin-left:20px">'+errores+'</ul></b></div>');
		return false;
	}
...
Taringa_Set_Function("show_preview", function(titulo,cuerpo,tags,f,forzar){
	...
	if($(":radio:checked[name='categoria']:first").val() == -1){errores += '<li style="list-style-type:disc"> No se eligiÃ³ la categorÃ­a.</li>';}
	if(cuerpo == ''){errores += '<li style="list-style-type:disc"> El post estÃ¡ vacio.</li>';}
	if(titulo == ''){errores += '<li style="list-style-type:disc"> El post no tiene tÃ­tulo.</li>';}
	if(tags == ''){errores += '<li style="list-style-type:disc"> No se ingresaron los TAG\'s</li>';}else{
		var separar_tags = tags.split(",");separar_tags = unico(separar_tags);
		if(separar_tags.length < 4){errores += '<li style="list-style-type:disc"> Tiene que haber por lo menos 4 TAG\'s separados por coma y diferentes.</li>';}
	}
	if(errores != ''){
		unsafeWindow.mydialog.alert('Error al Crear Post - SharkaleÂ®','<div align="left" style="padding:0px 20px"><b>Se han encontrado los siguientes errores:<br><br><ul style="margin-left:20px">'+errores+'</ul></b></div>');
		return false;
	}
	...
	$.ajax({
		...
		success: function(h){
			...
			$('#derecha').fadeOut('slow',function(){
				...
				var ant = $('#derecha div[class=size13] a:contains(Â« Anterior)');
				var sig = $('#derecha div[class=size13] a:contains(Siguiente Â»)');
				if(ant.size() != 0){
	...
	$.ajax({
		...
		success: function(h){
			$('#izquierda').fadeOut('slow',function(){
				...
				$("div[class='box_txt ultimos_posts']:first").html('Ãšltimos posts <a href="" onclick="act_post_nfu();return false;" title="Actualizar Post" > <img src="'+urlimg+'act_comment.png" align="top" height="16" width="16" /></a>');
				var ant = $('#izquierda div[class=size13] a:contains(Â« Anterior)');
				var sig = $('#izquierda div[class=size13] a:contains(Siguiente Â»)');
				if(ant.size() != 0){
					ant.attr('url', ant.attr('href'));
...
Taringa_Set_Function("administrar_post", function(key, numpost){
	...
	$.ajax({
		...
		success: function(h){
			...
			if(comment["error"]) {
				$('#SharkaleAdmTexto').html("<b>Error al obtener datos del post.<br /><br />NÃºmero de error: "+comment["error"]["code"]+"<br />RazÃ³n: "+comment["error"]["msg"]+"</b>");
				if($('SharkaleAdmPost').size() == 0) $('#SharkaleAdmPost').dialog({title: 'Error al cargar el Administrador de Post - SharkaleÂ®',width: 900, modal: true, position:['center',30], resizable: false, draggable: false });
				comment = null;
				return;
			}
			var HTML = '<hr>';
			...
			if($('div[role="dialog"]').size() == 0 || $('#SharkaleAdmPost').is(':hidden'))$('#SharkaleAdmPost').dialog({title: 'Administrador de Post - SharkaleÂ®',width: 900, modal: true, position:['center',30], resizable: false, draggable: false });
		},
		error: function(h){
			alert("No se pudo consultar los datos del post. Intente nuevamente mÃ¡s tarde.");
		}
	});
});
...
Taringa_Set_Function("JS_miarrobatag207890", function(cual){
	...
	if( cual.miarrobatag207890_msg.value=='' || cual.miarrobatag207890_msg.value=='Tu mensaje aquÃ­' ) mensaje += '+ Tienes que escribir el mensaje\n';
	...
	if( mensaje!='' ){
		...
		cual.miarrobatag207890_msg.value = 'Tu mensaje aquÃ­';
	...
	$.ajax({
		...
		success: function(h){
			...
			if($(h).find('div[class=box_cuerpo]:contains(no existe)').size() != 0){
				...
				var id = $(h).find('a[class=rssP]:first').attr('href').split('/')[3];
...
Taringa_Set_Function("block_notas", function() {
	...
	nuevaHTML += '	<span class="ui-dialog-title" id="ui-dialog-title-SharkaleOpciones" unselectable="on" style="-moz-user-select: none;">Block de Notas del Script - Sharkale&reg;</span>';
...
Taringa_Set_Function("chat_script", function() {
	...
	var widget = '<div id="widget" align="center" style="display: block; position: relative; overflow: hidden; outline: 0px none; height: auto; width: 954px;" class="ui-dialog ui-widget ui-widget-content ui-corner-all " tabindex="-1" role="dialog" aria-labelledby="ui-dialog-title-SharkaleOpciones">';
	var nuevaHTML = '<div class="ui-dialog-titlebar ui-widget-header ui-corner-all ui-helper-clearfix" style="-moz-user-select: none;margin-bottom:3px;">';
	nuevaHTML += '	<span class="ui-dialog-title" id="ui-dialog-title-SharkaleOpciones" unselectable="on" style="-moz-user-select: none;">Chat Oficial del Script - Sharkale&reg;</span>';
	nuevaHTML += '	<a href="" onclick="$(\'#widget\').remove();$(\'#cuerpocontainer\').show();return false;" onmouseover="$(this).addClass(\'ui-state-hover\');" onmouseout="$(this).removeClass(\'ui-state-hover\');" class="ui-dialog-titlebar-close ui-corner-all" unselectable="on" style="-moz-user-select: none;">';
	nuevaHTML += '		<span class="ui-icon ui-icon-closethick" unselectable="on" style="-moz-user-select: none;">close</span>';
	nuevaHTML += '	</a>';
	nuevaHTML += '</div>';
nuevaHTML += '<embed src="http://www.everywherechat.com/everywherechat.swf?defaultRoom=sharkale_radio&fontSize=12&roomList=false&theme=night" quality="high" width="728" height="486"/>';	if($('#widget').size() == 0) $('#cuerpocontainer').before(widget+nuevaHTML+'</div>'); else $('#widget').html(nuevaHTML);
});
...
function add_favs_tema(temaid){
	...
	if(favs != ''){
		...
		for (var i = 0; i < favs.length-1; i=i+3){
			if(favs[i] == temaid){
				unsafeWindow.mydialog.alert("Favoritos de Comunidades - SharkaleÂ®",'Esta tema ya esta guardado en favoritos.');
				return;
			}
		}
		GM_setValue('temasFavs',favs.join('//#//')+'//#//'+aguardar);
		unsafeWindow.mydialog.alert("Favoritos de Comunidades - SharkaleÂ®",'El tema fue guardado correctamente!');
	}else{
		unsafeWindow.mydialog.alert("Favoritos de Comunidades - SharkaleÂ®",'El tema fue guardado correctamente!');
...
function Guardar_Opciones(){
	...
	PunFav = GM_getValue("PunFav",false);
	EmotVis = GM_getValue("EmotVis",false);
	NovatosPrinc = GM_getValue("NovatosPrinc",true);
	CambiarTheme = GM_getValue("CambiarTheme",true);
	HideComment = GM_getValue("HideComment",true);
...
function Sharkale_Opciones(){
	...
	var nuevaHTML = '<div class="ui-dialog-titlebar ui-widget-header ui-corner-all ui-helper-clearfix" style="-moz-user-select: none;margin-bottom:3px;">';
	nuevaHTML += '	<span class="ui-dialog-title" id="ui-dialog-title-SharkaleOpciones" unselectable="on" style="-moz-user-select: none;">Opciones Avanzadas del Script - Sharkale&reg;</span>';
	nuevaHTML += '	<a href="" onclick="$(\'#widget\').remove();$(\'#cuerpocontainer\').show();return false;" onmouseover="$(this).addClass(\'ui-state-hover\');" onmouseout="$(this).removeClass(\'ui-state-hover\');" class="ui-dialog-titlebar-close ui-corner-all" unselectable="on" style="-moz-user-select: none;">';
	nuevaHTML += '		<span class="ui-icon ui-icon-closethick" unselectable="on" style="-moz-user-select: none;">close</span>';
	nuevaHTML += '	</a>';
	nuevaHTML += '</div>';
	...
	nuevaHTML += '	<label><input type="checkbox" id="shark_NovatosPrinc" '+(NovatosPrinc? 'checked':'')+'> Post de Novatos en la PÃ¡gina Principal.</label><br/>';
	...
	nuevaHTML += '  <div id="mensaje-opciones" class="ui-state-highlight ui-corner-all" style="display:none;padding: 0pt 0.7em; margin-top: 20px;"><p><span class="ui-icon ui-icon-info" style="float: left; margin-right: 0.3em;"></span><strong>Guardado Correcto:</strong> La nueva configuraciÃ³n se guardo correctamente en la memoria de Firefox. Ahora al actualizar el script la configuraciÃ³n no se perderÃ¡.</p></div>';
	nuevaHTML += ' </b></div>';
	...
	nuevaHTML += '	Cerrar SesiÃ³n <img id="previe-mcs" src="'+MenuCerrarSesion+'" width="25" height="25" align="absmiddle"/>';
	...
	nuevaHTML += '	Nueva ActualizaciÃ³n del Script <img id="previe-ma" src="'+MenuActualizacion+'" width="25" height="25" align="absmiddle"/>';
	...
	nuevaHTML += '	TamaÃ±o de los iconos: <label><input name="ms" value="15" type="radio" '+(MenuSize == 15? 'checked="checked"':'')+'>15x15</label><label><input name="ms" value="17" type="radio" '+(MenuSize == 17? 'checked="checked"':'')+'>17x17</label><label><input name="ms" value="19" type="radio" '+(MenuSize == 19? 'checked="checked"':'')+'>19x19</label><label><input name="ms" value="21" type="radio" '+(MenuSize == 21? 'checked="checked"':'')+'>21x21</label><label><input name="ms" value="23" type="radio" '+(MenuSize == 23? 'checked="checked"':'')+'>23x23</label><label><input id="ms" name="ms" value="25" type="radio" '+(MenuSize == 25? 'checked="checked"':'')+'>25x25</label></div><hr/>';
	nuevaHTML += '	<input type="button" value="Guardar Cambios de ImÃ¡genes" id="Btn_Guardar_Imagenes" title="Guardar cambios de imÃ¡genes en la memoria de Firefox" class="ui-state-default ui-corner-all"/>';
	nuevaHTML += '	<input type="button" value="Restablecer Cambios" id="Btn_Restablecer_Imagenes" title="Restablecer a los imÃ¡genes originales del script" class="ui-state-default ui-corner-all"/>';
	nuevaHTML += '	<input type="button" value="Restablecer Originales de Taringa" id="Btn_Restablecer_Imagenes_T" title="Restablecer a los imÃ¡genes originales del menÃº de Taringa" class="ui-state-default ui-corner-all"/><hr>';
	nuevaHTML += '	* la previsualizaciÃ³n puede tardar un rato en cargar la imagen.';
	nuevaHTML += '    <div id="mensaje-imagenes" class="ui-state-highlight ui-corner-all" style="display:none;padding: 0pt 0.7em; margin-top: 20px;"><p><span class="ui-icon ui-icon-info" style="float: left; margin-right: 0.3em;"></span><strong>Guardado Correcto:</strong> La nueva configuraciÃ³n se guardo correctamente en la memoria de Firefox. Ahora al actualizar el script la configuraciÃ³n no se perderÃ¡.</p></div>';
	nuevaHTML += ' </b></div>';
	nuevaHTML += ' <div id="imagenes-3" align="justify">';
	nuevaHTML += '  Al agregar un emoticon se deberÃ¡ ingresar la direcciÃ³n URL de la imÃ¡gen o emoticon y una direcciÃ³n URL de una imÃ¡gen o emoticon que es la que aparecerÃ¡ en la parte para elegir. Hago incapiÃ© en esto porque si eligen un GIF de 5MB y lo ponen tambiÃ©n como miniatura para el emoticon, el script lo escalarÃ¡ para no deformar la pÃ¡gina pero no le bajarÃ¡ el peso. Por lo tanto, si eligen uno capaz no sea problema pero si ponen 5 o 10 GIF pesados con la misma URL para la imÃ¡gen que para la miniatura, cada vez que cargue un post van a cargar todos los GIF pesados gastando ancho de banda inutilmente. Con esto aclarado pueden utilizarlo.<hr><b>Un truquito para los gif de tinypic es agregarle un "_th" antes del punto. Por ejemplo a <u>http://i44.tinypic.com/2e2nxjb.gif</u> que pesa 2.60MB le agregamos el "_th" antes del punto quedando <u>http://i44.tinypic.com/2e2nxjb_th.gif</u> con un peso de 0.60MB. No es huy que liviano pero son 2 megas menos y nada de ediciÃ³n.</b><hr>';
	nuevaHTML += '  Otra forma un poquito mÃ¡s larga pero mÃ¡s eficiente es la siguiente. Abrimos el block de notas y dejamos ahi la URL original de la imÃ¡gen. Luego vamos a <b>http://www.tinypic.com</b> y seleccionamos la opciÃ³n <b>URL</b> en <b>"Tipo de archivo"</b> y ponemos la URL del block de notas, seleccionamos <b>avatar(100x75)</b> en el menÃº de <b>"Cambiar el TamaÃ±o"</b>. A continuaciÃ³n subimos la imagen y una vez terminada hacemos click en <b>"Editar"</b> que estÃ¡ debabajo de la previsualizaciÃ³n de la imagen que acabamos de subir. Una vez finalizado de cargar el editor simplemente hacemos click en <b>"Save a copy"</b> y de esta manera genera una imagen sin movimiento de 5KB con su correspondiente URL. Ahora con esta URL y la que tenemos en el block de notas las usamos para agregar la imagen al administrador de emoticones y no tener pesado el post con muchos gif de 6MB al cargar.<hr>';
	nuevaHTML += '  <b>Las URL al ser guardadas se almacenan en el Firefox, dicho espacio es limitado. Pero la ventaja es que al actualizar el script estos cambios no se modifican, por lo tanto no tendrÃ¡s que agregarlos una y otra vez.<hr>';
	nuevaHTML += '	<input type="button" value="Agregar Emoticon Personalizado" id="Btn_Agregar_Emoticones" title="Guardar cambios de imÃ¡genes en la memoria de Firefox" class="ui-state-default ui-corner-all"/>';
	...
	nuevaHTML += '	<div id="tagboard">Deja tu opiniÃ³n aquÃ­, ya que no voy a crear nuevos post debido a que me lo cierran por pavadas:';
	...
	nuevaHTML += '		<br><input type="text" id="tb_msg" name="miarrobatag207890_msg" title="Escribe aquÃ­ el mensaje que aparecerÃ¡ en el Tagboard" value="Tu mensaje aquÃ­" maxlength="250" class="ui-state-default ui-corner-all" style="width:870px;">';
	...
	nuevaHTML += '		<br><input type="submit" id="miarrobatag207890_submit" title="Enviar mensaje al Tagboard" name="miarrobatag207890_submit" value="EnvÃ­ar Mensaje" class="ui-state-default ui-corner-all" style="width:910px;">';
	nuevaHTML += '	</form></div>';
	nuevaHTML += '</div>';
	...
	nuevaHTML += '	  <input type="button" value="Abrir chat en otra pestaÃ±a" id="Btn_Chat" title="Abrir el chat en otra pestaÃ±a" class="ui-state-default ui-corner-all"/>';
	nuevaHTML += '</div>';
	nuevaHTML += '<div id="opciones-4"><b>';
	nuevaHTML += '    <hr>Juega al mejor juego de Guerra Medieval Online junto a miles de jugadores.';
	nuevaHTML += '    <a href="http://www.guerrastribales.es/585151-es4.html" target="_blank"><img src="http://imgur.com/cTaTK.gif" alt="Unite al Mundo 4 de este espectacular juego online"/></a>';
	nuevaHTML += '    <hr>..::Descargas Sweetdani::.. - Peliculas, Juegos, Series y MÃºsica.<br/>';
	...
	nuevaHTML += '    ..::Radio SharkaleÂ®::.. - Proyecto personal de radio propia. =P<br/>';
	nuevaHTML += '    <a href="http://www.sharkale.com.ar/" target="_blank"><img src="http://imgur.com/Ku2Do.png" alt="..::Radio SharkaleÂ®::.." width="740"/></a>';
	...
	nuevaHTML += '    Â¿Alguna vez te han molestado todos esos anuncios e imÃ¡genes en internet que, normalmente, hacen que tarde en cargar mÃ¡s el resto de la pÃ¡gina? InstalaAdblock Plus ahora y olvÃ­date de ello.<br/>';
	nuevaHTML += '    <a href="https://addons.mozilla.org/es-ES/firefox/addon/1865" title="AÃ±adir Adblock Plus a Firefox" target="_blank"><img src="http://imgur.com/AhqrK.png" align="absmiddle" /><img src="http://imgur.com/Uaf19.png" align="absmiddle" height="150"/></a><hr>';
	nuevaHTML += '    Web of Trust le mantiene seguro mientras navega y compra en Internet. Los sÃ­mbolos con cÃ³digo de color de WOT le ayudan a evitar timos en lÃ­nea, robo de identidad, sitios de compra no fiables y amenazas de seguridad antes de que haga clic. Navegue mÃ¡s seguro y aÃ±ada WOT a Firefox ahora mismo.<br>';
	nuevaHTML += '    <a href="https://addons.mozilla.org/es-ES/firefox/addon/3456" title="AÃ±adir WOT a Firefox" target="_blank"><img src="http://imgur.com/AhqrK.png" align="absmiddle" /><img src="http://imgur.com/yuuF5.png" align="absmiddle" /><img src="http://imgur.com/kb4UT.png" align="absmiddle" /><img src="http://imgur.com/2LN4y.png" align="absmiddle" /></a>';
	nuevaHTML += '</b></div>';
	nuevaHTML += '<div id="opciones-5" align="justify"><b>';
	nuevaHTML += '    <b><u><span style="color: red;">Changelog versiÃ³n 30.0:</span></u></b><br>* [Fixed] ImÃ¡genes de IMGur.<br>* [Fixed] Host de imÃ¡genes para crear post.<br>* [Fixed] Pack de emoticones.<br>* [Fixed] ImÃ¡genes hosteadas en server propio.<br>* [Fixed] Algunos host en el linkchecker.<br><b><u><span style="color: red;">Changelog versiÃ³n 30.0:</span></u></b><br>* [Fixed] Varios errores.<br>* [Fixed] ImÃ¡genes del menÃº.<br>* [Add] Borradores en el MenÃº.<br>* [Add] Nuevo servidor para subir imagenes en crear post.<br>* [Fixed] Creador de reproductor de MixPod.<br>';
	nuevaHTML += '    <b><u><span style="color: red;">Changelog versiÃ³n 29.0:</span></u></b><br>* [Fixed] Lag al escribir en Agregar Post, causado por el contador de caracteres.<br>* [Fixed] Arreglado que al filtrar no filtraba los ultimos comentarios.<br>* [Fixed] Ultimos iconos para editar post en el perfil.<br>* [Rem] El menu contextual de "Mi cuenta" aunque todaiva peuden camiar el avatar por uno con direccion http y modificar las fotos de uno poniendo mas de 9 .<br>* [Fixed] Solapa Clima. Ahora utiliza la ubicacion guardada en "Mi Cuenta".<br>* [Fixed] Avatares al actualizar comentarios.<br>* [Fixed] Ir al Cielo y a la Tierra en cada comentario.<br>* [Fixed] Agregado "Administrar Usuario" al menu contextual del avatar para Mods y Admins de Comunidades.<br>* [Fixed] Barra de BBC y Colores adaptado al nuevo de activarse la barra de Taringa.<br>* [Add] NÃºmeracion en comentarios y respuestas.<br>* [Add] Multi alerta de errores al crear posts o temas.<br>* [Add] Ensanchados los comentarios y agrandados un poco los avatares.<br>* [Add] PrevisualizaciÃ³n automÃ¡tica de la Letrota.<br>* [Fixed] No recargar la pÃ¡gina al guardar cambio del Theme.<br>* [Add] Color del borde del comentario del creador del tema o post acorde al theme.<br>* [Add] Sus posts y Sus comentarios al menÃº contextual del avatar.<br>* [Add] Solapa clima en comunidades.<br>* [Add] Cambio dinÃ¡mico del submenÃº al pasar sobre el menÃº "Posts" Ã³ "Comunidades".<br>* [Fixed] Compatibilidad con formato de Poringa! (Gracias sweetdani por avisar xD)<br>* [Fixed] Aspecto del Previsualizador.<br>* [Fixed] Ocultar previsualizaciÃ³n al comentar.<br>* [Add] Compartir la lista de emoticones con quien desees pasando solo 5 caracteres.<br>* [Add] Sus temas al menÃº contextual del avatar.<br>* [Add] Sombra de color para tus comentarios, respuestas y quotes.<br>* [Add] VisualizaciÃ³n de multiples quotes en comunidades.<br>* [Add] Archivos SWF ocultos por defecto.<br>* [Add] PÃ¡gina para crear packs de emoticones y/o swf.<br>* [Add] Agregar packs de emoticones y/o swf a la lista actual.<br>* [Add] BotÃ³n de 99polls.<br>* [Fixed] Capturador de codigo de GoEar.<br>* [Add] Links al agregar videos de YouTube, swf, etc.<br>* [Fixed] DepuraciÃ³n de gran cantidad de cÃ³digo Ahora es mas liviano y las librerias se cargan 1 sola vez externamente al instalarlo.<br>* [Add] Block de notas autoguardable y accesible en todo momento.<br>* [Fixed] Limitado a 5 los quotes en comunidades.<br>* [Fixed] Mejorado el spoiler de archivos flash.<br>* [Fixed] Mejoradas las opciones avanzadas.<br>* [Add] Solapa chat.<br>* [Fixed] Block de Notas.<br>* [Add] BotÃ³n de MixPod.<br>* [Fixed] PÃ¡gina del Script.<br>* [Fixed] Barra de BBCodes.<br>* [Fixed] Crear Packs, Exportar Emoticones.<br>* [Add] Solapa Script con SubmenÃº animado.<br>* [Add] Ocultar Comenarios.<br>* [Add] MÃ¡s Opciones Configurables.<br>* [Fixed] DepuraciÃ³n de cÃ³digo.<br>* [Fixed] Categorias.<br>* [Fixed] Filtrado de Categorias.<br>* [Fixed] DepuraciÃ³n de cÃ³digo.<br>* [Fixed] Mejoradas varias funciones.<br>* [Fixed] Script mucho mÃ¡s liviano.<br>* [Fixed] Iniciar SesiÃ³n en plugin de TinyPicÂ®.<br>* [Fixed] Esteticas menores.<br>';
	nuevaHTML += '    <b><u><span style="color: red;">Changelog versiÃ³n 28.4:</span></u></b><br>* [Add] Crear imÃ¡genes para comentar con texto gigante.<br>* [Add] Avatares largos en posts.<br>* [Add] BotÃ³n de "Editar Tema" o "Editar Post" en el nuevo buscador.<br>* [Add] Link "Ãšltima PÃ¡gina" en cada resultado del nuevo buscador.<br>* [Add] Link "Mis Temas" en el menÃº contextual.<br>* [Add] Tops de las categorias filtradas en el principal.<br>* [Add] Posibilidad de guardar tu ciudad para acceso directo a tu clima.<br>* [Fixed] PestaÃ±a del clima.<br>* [Fixed] Actualizador de comentarios de los post.<br>* [Fixed] Buscador superior.<br>* [Fixed] Bordes transparentes compatibles con cambio de color de fondo.<br>* [Fixed] BotÃ³n "Siguiente" de los post NFU en Ãºltimos post.<br>* [Fixed] Mejorado el actualizador de comentarios, y algÃºn que otro bugs que pase por alto. (Reconoce la pagina en la que uno esta y el ultimo comentario. Solucionando la aparecion de comentarios repetidos al comentar)<br>* [Fixed] Al usar Actualizar con el boton de la imagen de actualizar ahora se actualiza esa misma pÃ¡gina y no va a la ultima.<br>* [Fixed] Posibilidad de click derecho y "Abrir en una nueva pestaÃ±a" las paginas de comentarios. (Imposible con CTRL)<br>* [Fixed] Mis post. Para los que tienen a los novatos desactivados.<br>* [Fixed] Perfil. Para los qeu tienen novatos desactivos.<br>* [Fixed] Botones de la barra de pÃ¡ginas de "Mis Comunidades".<br>* [Fixed] Ejecucion del script en temas que poseian videos de YouTube y no usaban el Themer.<br>* [Fixed] Filtrado de comunidades de Poringa!.<br>* [Rem] Filtrado de Novatos. (No existe)<br>';
	nuevaHTML += '    <b><u><span style="color: red;">Changelog versiÃ³n 28.1:</span></u></b><br>* [Add] Mejor diseÃ±o del buscador de usuarios.<br>* [Fixed] BotÃ³n de mostrar emoticones no aparecia en temas.<br>* [Fixed] Botones del "Acerca de..." en las opciones.<br>* [Fixed] Arreglos pequeÃ±os.<br><b><u><span style="color: red;">Changelog versiÃ³n 28.0:</span></u></b><br>* [Add] Buscador de usuarios en comunidades.<br>* [Add] Actualizador dinÃ¡mico de pÃ¡ginas de comentarios y respuestas.<br>* [Add] Votar temas desde Agregar Respuesta.<br>* [Add] Compatibilidad con logo aleatorio de Taringa.<br>* [Add] Filtro dinÃ¡mico de categorÃ­as.<br>* [Fixed] Ir al Medio.<br>* [Fixed] Ir a la Ãºltima pÃ¡gina en temas viejos.<br>* [Fixed] Alerta de nuevos comentarios en post propios.<br>* [Fixed] Fullscreen en videos de YouTube con color de borde acorde al tema.<br>* [Fixed] Crear comunidades.<br>* [Fixed] Cargador de TinyPic.<br>* [Fixed] Previsualizar temas.<br>* [Fixed] AlineaciÃ³n de los nicks en respuestas de los temas.<br>* [Fixed] Cambiador dinÃ¡mico de pÃ¡ginas de Ãºltimos posts.<br>* [Fixed] Buscador de actualizaciones.<br>* [Fixed] Acentos en paises en perfil.<br>* [Fixed] Buscador de Google.<br>* [Fixed] Algunos host del linkchecker.<br>';
	nuevaHTML += '    <b><u><span style="color: red;">Changelog versiÃ³n 27.5:</span></u></b><br>* [Add] Ver estado Online y Offline de los usuarios. [BETA]<br>* [Add] Guardar temas de las comunidades en favoritos.<br>* [Add] Videos en pantalla completa.<br>* [Add] Ahora el linkchecker se puede desactivar y por medio de un link ejecutarse cuando se lo desea.<br>* [Add] Preguntar si realmente desea agregar BBC a todas las URL escritas.<br>* [Add] BotÃ³n de restablecer imÃ¡genes originales del menÃº de taringa en las opciones avanzadas.<br>* [Add] Buscador de Google en el menÃº desplegable.<br>* [Fixed] Mostrar/Ocultar Emoticones en algunas pÃ¡ginas.<br>';
	nuevaHTML += '    <b><u><span style="color: red;">Changelog versiÃ³n 27.1:</span></u></b><br>* [Add] Ir a la Ãºltima pÃ¡gina de comentarios en los temas de las comunidades.<br>* [Add] Actualizar comentarios en comunidades.<br>* [Add] Tags checkers en editar temas para evitarse disgustos.<br>* [Add] Nueva interfaz de la barra general.<br>* [Fixed] Boton de comunidades para algunos.<br>* [Fixed] Plugin de TinyPic mejorado.<br>* [Fixed] PrevisualizaciÃ³n de comentarios en comunidades.<br>* [Rem] Align y Size en comentarios de las comunidades.<br>';
	nuevaHTML += '    <b><u><span style="color: red;">Changelog versiÃ³n 27.0:</span></u></b><br>* [Add] Compatibilidad total con poringa.<br>* [Add] Taringa y Poringa contienen posibilidad de tener themes diferentes.<br>* [Add] Cargador de TinyPic en "Agregar Post".<br>* [Add] Opciones directas para administrar usuarios de comunidades en temas y comentarios.<br>* [Add] Auto-Backup del post al ser creado.<br>* [Add] Archivo de posts que uno desee.<br>* [Add] BBCode en editar temas.<br>* [Fixed] Quotear imÃ¡genes en comunidades.<br>* [Fixed] Estilo descuajeringado del administrador de usuarios de Taringa.<br>';
	nuevaHTML += '    <b><u><span style="color: red;">Changelog versiÃ³n 26.4:</span></u></b><br>* [Add] BBCodes personalizados en Agregar Post.<br>* [Fixed] Actualizador de comentarios.<br><b><u><span style="color: red;">Changelog versiÃ³n 26.3:</span></u></b><br>* [Add] Botonera de "Ir al Cielo", "Ir al Medio" o "Ir a la Tierra" en comentarios.<br>* [Add] Boton de actualizar comentarios en barra de BBCode.<br>* [Add] Ocultar emoticones en "Agregar Post".<br>* [Rem] Orientacion de texto en agregar comentario.<br>* [Fixed] Comentar dos veces.<br>* [Fixed] Al guardar opciones se abria el cambiador de theme.<br>* [Fixed] Botones en "Cambiador de Theme" para usuarios con monitor WIDE.<br>* [Fixed] Al actualizar comentarios va directo a la Ãºltima pÃ¡gina dinÃ¡micamente.<br>* [Fixed] Mejoras visuales variadas.<br>* [Fixed] OptimizaciÃ³n de cÃ³digo (BÃºsqueda y desecho de cÃ³digo desactualizado).<br>* [Fixed] Actualizador de script mejorado.<br>';
	nuevaHTML += '    <b><u><span style="color: red;">Changelog versiÃ³n 26.2:</span></u></b><br>* [Add] Actualizador de comentarios.<br>* [Fixed] Editar y Borrar post en Perfil y Buscador.<br><b><u><span style="color: red;">Changelog versiÃ³n 26.1:</span></u></b><br>* [Add] Link de Bloqueados en el MenÃº.<br>* [Add] Comunidades ordenadas en el Perfil.<br>* [Add] Contador de caracteres en Agregar Post.<br>* [Rem] TamaÃ±o y tipo de letra en comentarios.<br>* [Fixed] Problema al citar.<br>* [Fixed] Links en comentarios del monitor.<br>* [Fixed] PrevisualizaciÃ³n del MP.<br>* [Fixed] BBCode de YouTube.<br>* [Fixed] Icono de Sticky en secciÃ³n Novatos.<br>* [Fixed] Perdida del foco del cursor al usar BBC sin tener nada escrito.<br>';
	nuevaHTML += '    <b><u><span style="color: red;">Changelog versiÃ³n 26.0:</span></u></b><br>* [Fixed] BBCode y comentarios en los Post.<br>* [Fixed] Perfil.<br>* [Fixed] Mis Post.<br>* [Fixed] Arreglos varios.<br>* [Fixed] OptimizaciÃ³n de cÃ³digo.<br>* [Fixed] Administrador de Post.<br>* [Rem] Sacado el "Soyez le premier". <br>* [Fixed] Previzualizador de comentarios.<br>* [Fixed] Puntos, Denunciar y Favoritos en comentarios.<br>';
	nuevaHTML += '    <b><u><span style="color: red;">Changelog versiÃ³n 25.0:</span></u></b><br>* Compatiblidad nuevo perfil.<br>* Arreglado administrador de post que se abria mÃ¡s de una vez al actualizar.<br>* Opciones de editar, borrar y administrar tus post desde el buscador.<br>* OpciÃ³n de bloquear usuario directamente desde los MP.<br>* Habilitado buscador de google.<br>* Nuevo mÃ©todo de bÃºsqueda de actualizaciÃ³n menos persistente y nueva interfaz grÃ¡fica.<br>';
	nuevaHTML += '    <b><u><span style="color: red;">Changelog versiÃ³n 24.6:</span></u></b><br>* Arreglado perfil y Puntos en Negrita.<br>* Arreglado el actualizador de comentarios.<br><b><u><span style="color: red;">Changelog versiÃ³n 24.5:</span></u></b><br>* BBCode en comunidades.<br>* Preview en Comunidades.<br>* [Fixed] Bugs BBCode en comunidades.<br>* Avatares en comunidades modificados.<br>* Nueva cÃ³digo para previsualizar mÃ¡s eficÃ¡z.<br>* Tops desactivados. (Taringa! desactivÃ³ la api para los tops. Parece que manolo y su ram de mierda de 64MB no la soporta)<br>';
	nuevaHTML += '    <b><u><span style="color: red;">Changelog versiÃ³n 24.0:</span></u></b><br>* Nuevo logo de Taringa.<br>* ActualizaciÃ³n general del cambiador de theme a jQuery. (Chupala Gonx lame chota!!!)<br><b><u><span style="color: red;">Changelog versiÃ³n 23.6:</span></u></b><br>* Nuevas Opciones en el Cambiador de Theme.<br><b><u><span style="color: red;">Changelog versiÃ³n 23.5:</span></u></b><br>* Arreglos Varios.<br><b><u><span style="color: red;">Changelog versiÃ³n 23.4:</span></u></b><br>* Color de Fondo Configurable.<br><b><u><span style="color: red;">Changelog versiÃ³n 23.3:</span></u></b><br>* Actualizador de Comentarios (incluido para post privados).<br><b><u><span style="color: red;">Changelog versiÃ³n 23.2:</span></u></b><br>* Bugs, Bugs, Bugs y mÃ¡s Bugs.<br>';
	nuevaHTML += '    <b><u><span style="color: red;">Changelog versiÃ³n 23.0:</span></u></b><br>* Compatibilidad con Faceboringa.<br>* Barra de comentarios en las comunidades.<br>* Agregados Ir al Cielo y la Tierra que no estÃ¡n. <br>* Buscador de Taringa! predeterminado en el buscador.<br>* Redimensionados los comentarios en el las comunidades.<br>* Redimensionado el Monitor.<br>';
	nuevaHTML += '    <b><u><span style="color: red;">Changelog versiÃ³n 22.6:</span></u></b><br>* [Fixed] Bug de novatos en sus propios post.<br>* [Fixed] Bug de texto no se pueden votar por solidarios al quedarse sin puntos.<br>* Doble hospedaje de script por si se cae alguno. <a href="http://radio.sharkale.com.ar" target="_blank">http://radio.sharkale.com.ar</a> | <a href="http://radio.proyectod.com.ar" target="_blank">http://radio.proyectod.com.ar</a><br>* [Fixed] Problema de ancho de barra principal en Poringa!.<br>* Optmizada la barra de colores en cÃ³digo.<br>* [Fixed a Taringa] [br] en comentarios.<br>';
	nuevaHTML += '    <b><u><span style="color: red;">Changelog versiÃ³n 22.5:</span></u></b><br>* Nueva barra de taringa con menÃºs desplegables.<br>* Optimizado cÃ³digo de cambiador de theme.<br>* Nuevo servidor de hospedaje del script. <a href="http://radio.sharkale.com.ar" target="_blank">http://radio.sharkale.com.ar</a><br>* Compatibilidad con script de lea87crzz.<br>* [Fixed] En Link Checker al agregar prefijos a los links.<br>';
	nuevaHTML += '    <b><u><span style="color: red;">Changelog versiÃ³n 22.0:</span></u></b><br>* SecciÃ³n de tops totalmente realizada por mi.<br>* PrevizualizaciÃ³n de MP<br>* Acentos en Tagboard<br>* [Fixed] Quote, Fecha y Alertas de Error en Actualizador de Comentarios<br>* ImÃ¡genes de los botones de opciones en el MenÃº<br>* Cambiar TamaÃ±o de las ImÃ¡genes del MenÃº<br>* Cambiar Theme de Taringa!<br>* [Fixed] En Link Checker<br>* BotÃ³n de Postear sin Previsualizar.<br>* BotÃ³n de actualizar todos o Ãºltimos comentarios.<br>* [Fixed] Actualizadores de Ãºltimos post en principal.<br>* [Fixed] Estilos de bordes en la pÃ¡gina principal.<br>* Nuevo estilo de quotes.<br>* OptimizaciÃ³n del cÃ³digo antigÃ¼o a una nueva versiÃ³n. (40% hecho)<br>* Pie de pÃ¡gina limpia.<br>* [Fixed] Alertas de errores en envio y actualizaciÃ³n de comentarios.<br>* Botones de Taringa a la par con el Theme elegido.<br>* [Fixed] Agregar BBCode a todas las URL escritas.<br>';
	nuevaHTML += '    <b><u><span style="color: red;">Changelog versiÃ³n 21.0:</span></u></b><br>* Arreglados la mayoria de los host del link checker y agregados un par.<br>* OptimizaciÃ³n de cÃ³digo.<br>* Script un poco mÃ¡s pesado pero de ejecuciÃ³n mÃ¡s rÃ¡pida.<br>* Actualizador de comentarios. (BETA)<br>* SecciÃ³n estilo post en las opciones, para comentar sobre el script.<br>* Administrador de emoticones.<br>* Agregados temas para el script. Pueden elegir dentro de una gama, el que mÃ¡s les guste.<br>* Agregada previsualizaciÃ³n de fotos en el la secciÃ³n Mis Fotos.<br>* [Fixed] Bug con el texto de los carteles de los botones del bbcoder.<br>* [Fixed] Bug con el texto en las opciones de imÃ¡genes.<br>* [Fixed] Varios bug mÃ­nimos que hacian que se cuelgue el script.<br>';
	nuevaHTML += '    <b><u><span style="color: red;">Changelog versiÃ³n 19.0:</span></u></b><br>* Nueva forma de actualizar el script.<br>* Arreglado el salto de linea de la barra de bbcode en mensajes.<br>* Nuevo menÃº de opciones.<br>* Iconos del menÃº configurables desde el menÃº y no se borrarÃ¡ al actualizar.<br>* Chat en las opciones.<br>* El administrador de post ahora carga la lista en forma descendente.<br><b><u><span style="color: red;">Changelog versiÃ³n 18.0:</span></u></b><br>* Administrador de Posts.<br>* Arreglos varios.<br><b><u><span style="color: red;">Changelog versiÃ³n 17.5:</span></u></b><br>* Configurable todas sus opciones.<br>* Agregado actualizador de posts.<br><b><u><span style="color: red;">Changelog versiÃ³n 17.0:</span></u></b><br>* Compatibilidad Total con Taringa y Poringa Brasil.<br>* Pagina Principal con Post de Novatos a la Derecha.<br>* Mejora en aspecto varios.<br>* Nuevos botones para el Menu.<br>* Sin propaganda en la pagina principal.<br>* Nuevos Botones de Borrar y Editar tus post en tu perfil para tus ultimos post.<br>* Posibilidad de activar el asimilador de Poringa para dejarlo con el aspecto de Taringa.<br>* Escala de Grises en los colores.<br>* Optimizacion del codigo para una carga mas veloz.<br>* Arreglo de algunos host de archivos para el link checker.<br>* Buscador de Taringa por defecto.<br><b><u><span style="color: red;">Changelog versiÃ³n 16.0:</span></u></b><br>* Arreglado el iconito de cerrar sesiÃ³n.<br>* Agregado un link checker para unos 50 hosts de archivos echo en un 80% por mi.<br><b><u><span style="color: red;">Changelog versiÃ³n 15.5:</span></u></b><br>* [Bug Fixed] Previsualizar Comentarios.<br>* [Bug Fixed] Al agregar Post de "Manga y Anime" se creaba como "Mac".<br>* [Bug Fixed] Emoticones que no se mostraban en mensajes al activar emoticones ocultos.<br>* Nueva forma mÃ¡s fÃ¡cil de agregar nuevos iconos al cÃ³digo.<br>* OptimizaciÃ³n del cÃ³digo.<br><b><u><span style="color: red;">Changelog versiÃ³n 15.0:</span></u></b><br>* Compatibilidad total con Poringa.<br><b><u><span style="color: red;">Changelog versiÃ³n 14.5:</span></u></b><br>* Arreglo general de la secciÃ³n de ediciÃ³n, agregado y envio y respuesta de mensajes.<br>* Agregada barra de emoticones en ediciÃ³n, agregado y envio y respuesta de mensajes.  <img id="imagen" src="http://imgur.com/iV8UO.gif" border="0"> <br>* Compatibilidad total con funciones de ediciÃ³n y agregado de post.<br>* Mejorada la forma de previsualizaciÃ³n.<br><b><u><span style="color: red;">Changelog versiÃ³n 14.1:</span></u></b><br>* [Bug Fixed] Categoria Manga y Anime e icono.<br>';
	nuevaHTML += '    <b><u><span style="color: red;">Changelog versiÃ³n 14.0:</span></u></b><br>* Mejoras en aspectos. (?)<br>* BotÃ³n de "Agregar BBCode a todas las URL escritas"<br>* Nuevo lugar de descarga.<br>* MÃ¡s opciones configurables.<br><b><u><span style="color: red;">Changelog versiÃ³n 13.4:</span></u></b><br>* Nuevo aspecto del botÃ³n de Flash <img id="imagen" src="http://i268.photobucket.com/albums/jj27/sharkale/taringa/swf.png" border="0"> y del botÃ³n de imagÃ©n <img id="imagen" src="http://i268.photobucket.com/albums/jj27/sharkale/taringa/imagen.png" border="0"><br>* Nuevo botÃ³n para crear una imagÃ©n clickeable <img id="imagen" src="http://i268.photobucket.com/albums/jj27/sharkale/taringa/imagen-click.png" border="0"><br>* Nuevo selector de categorÃ­as en creaciÃ³n y ediciÃ³n de post con las imagenes de cada categorÃ­a.<br><b><u><span style="color: red;">Changelog versiÃ³n 13.3:</span></u></b><br>* Cambiar tamaÃ±o de los reproductores de eSnips a su tamaÃ±o original (328x94)<br>* Ahora tambiÃ©n el cuadro de eSnips permite que se ponga el cÃ³digo HTML de la canciÃ³n.<br><b><u><span style="color: red;">Changelog versiÃ³n 13.2:</span></u></b><br>* Nuevo botÃ³n para ocultar y mostrar los emoticones.<br>* Los emoticones ahora estÃ¡n ocultos por defecto.<br><b><u><span style="color: red;">Changelog versiÃ³n 13.1:</span></u></b><br>* [Bug Fixed] Redimensionamiendo de los reproductores de GoGear.<br><b><u><span style="color: red;">Changelog versiÃ³n 13.0:</span></u></b><br>* MÃ¡s iconos.<br>* BotÃ³n de Megavideo. <img id="imagen" src="http://i268.photobucket.com/albums/jj27/sharkale/taringa/megavideo.png" border="0"><br>* BotÃ³n de GoEar. <img id="imagen" src="http://i268.photobucket.com/albums/jj27/sharkale/taringa/goear.png" border="0"><br>* MÃ¡s Fuentes.<br>* MÃ¡s tamaÃ±os de letra.<br>* Nueva barra de colores en comentarios, con decenas de colores.<br>* Se cambia el tamaÃ±o de los reproductores de GoEar a su original (353x132)<br>* Se arreglo el problema con las dimensiÃ³n de los SWF en los comentarios.<br>* Mejorada la captura de datos de los botones. Ejemplos en los botones de YouTube, Google, MegaVideo, GoEar, eSnips se puede poner cualquier tipo de info. Como serÃ­a la URL Ã³ el Codigo HTML o directamente la ID que el script se encargara de generar el cÃ³digo correcto no importa lo que se ingrese.<br><b><u><span style="color: red;">Changelog versiÃ³n 12.0:</span></u></b><br>* Nuevo aspecto de botones<br>* Botones comunes de formato <img id="imagen" src="http://i268.photobucket.com/albums/jj27/sharkale/taringa/izquierdo.png" border="0"> <img id="imagen" src="http://i268.photobucket.com/albums/jj27/sharkale/taringa/centrado.png" border="0"> <img id="imagen" src="http://i268.photobucket.com/albums/jj27/sharkale/taringa/derecho.png" border="0"> <img id="imagen" src="http://i268.photobucket.com/albums/jj27/sharkale/taringa/negrita.png" border="0"> <img id="imagen" src="http://i268.photobucket.com/albums/jj27/sharkale/taringa/cursiva.png" border="0"> <img id="imagen" src="http://i268.photobucket.com/albums/jj27/sharkale/taringa/subrayado.png" border="0"><br>(<b>Negrita</b>, <em>cursiva</em>, <u>subrayado</u>, alineaciÃ³n de texto[izq,cen,der])<br>* MenÃº desplegable para colores bÃ¡sicos.<br>* MenÃº desplegable para tamaÃ±os de fuete bÃ¡sicos.<br>* MenÃº desplegable para tipos de fuentes.<br>* Botones para reproductor de videos de YouTube y Google Videos. <img id="imagen" src="http://i268.photobucket.com/albums/jj27/sharkale/taringa/youtube.png" border="0"> <img id="imagen" src="http://i268.photobucket.com/albums/jj27/sharkale/taringa/google.png" border="0"><br>* BotÃ³n para reproductor de mÃºsica eSnips. <img id="imagen" src="http://i268.photobucket.com/albums/jj27/sharkale/taringa/esnips.png" border="0"><br>* Botones para arhivos flash "SWF", imagenes, links, quote. <img id="imagen" src="http://i268.photobucket.com/albums/jj27/sharkale/taringa/swf.png" border="0"> <img id="imagen" src="http://i268.photobucket.com/albums/jj27/sharkale/taringa/imagen.png" border="0"> <img id="imagen" src="http://i268.photobucket.com/albums/jj27/sharkale/taringa/link.png" border="0"> <img id="imagen" src="http://i268.photobucket.com/albums/jj27/sharkale/taringa/cita.png" border="0"><br>* BotÃ³n para preview de los comentarios. <img id="imagen" src="http://i268.photobucket.com/albums/jj27/sharkale/taringa/preview.png" border="0"><br>* Cambio de botÃ³n para cerrar sesiÃ³n.<br>* BotÃ³n para cerrar preview de comentario.<br>* Botones de "Ir a tierra" en el tÃ­tulo del post y en el tÃ­tulo de comentarios.<br>* Botonera de opciones para el post en agregar comentario. <br>(mensajes, favoritos, denuncia y puntaje)<br>* MenÃº de opciones para activar o desactivar muchas funciones del script.<br><b><u><span style="color: red;">Changelog versiÃ³n 11.1:</span></u></b><br>* Arreglado bug con los videos de YouTube <span style="color: green;">(Gracias eloffset)</span><br><b><u><span style="color: red;">Changelog versiÃ³n 11.0:</span></u></b><br>* Bueno la tan pedida barra de emoticones la eh finalizado.<br>Algunos iconos fueron cambiados de tamaÃ±o para no molestar. Esto no significa que en el comentario se vean chicos.<br><b><u><span style="color: red;">Changelog versiÃ³n 10.8:</span></u></b><br>* Cambiado el tiempo de intervalo de actualizaciÃ³n a 30seg ya que recibi varias quejas de que era muy rÃ¡pido. Ahora hay tiempo suficiente para leerlo completo.<br>';
	nuevaHTML += '    <b><u><span style="color: red;">Changelog versiÃ³n 10.7:</span></u></b><br>* Actualizador automÃ¡tico de Ãºltimos comentarios en la pÃ¡gina principal (Cada 10seg)<br>* Nuevo icono para reproducir canciones. <img id="imagen" src="http://i268.photobucket.com/albums/jj27/sharkale/taringa/esnips.png" border="0"><br><b><u><span style="color: red;">Changelog versiÃ³n 10.6:</span></u></b><br>* PequeÃ±a correcciÃ³n que no aparecia la barra en crear nuevo mensaje privado <span style="position: relative;"><img src="http://i.t.net.ar/images/big2v5.gif" style="position: absolute; top: -574px; clip: rect(572px, 16px, 588px, 0px);"><img src="http://i.t.net.ar/images/space.gif" style="width: 16px; height: 12px;"></span><br><b><u><span style="color: red;">Changelog versiÃ³n 10.5:</span></u></b><br>* Cambio de la barra en agregar post, mensajes privado y comentarios.<br>* Agregado botÃ³n de Google Videos.<br>* Mejorados los selectores de YouTube y Google Videos permitiendo ingresar cualquier referencia del video como la URL, el codigo HTML o la ID que devolverÃ¡ un BBCode vÃ¡lido para dicho video.<br>* Mejorados los BBC de los demÃ¡s botones, como posibilidad de agregarle el una etiqueta a una URL o que directamente ponga el BBC a una URL seleccionada, a una URL de una imÃ¡gen, una URL a un texto seleccionado y demÃ¡s.<br>* PrevisualizaciÃ³n del tipo de fuente en el selector.<br>* Achicado el volÃºmen de la barra para prevenir el desborde de los que tienen baja resoluciÃ³n.<br><b><u><span style="color: red;">Changelog versiÃ³n 10.1:</span></u></b><br>* Para todos los que molestaron con la [X] de cerrar sesiÃ³n. (@#$%&amp;#)<br><b><u><span style="color: red;">Changelog versiÃ³n 10.0:</span></u></b><br>* Mejoradas las funciones de los botones de video de youtube, flash, imagenes, url y quote.<br>* Ahora la URL puede ponerse a un texto seleccionado o solo la URL.<br>* En los videos de YouTube ya no hay 2 iconos, sino que ahora pregunta si es o no de alta definiciÃ³n.<br>* Agregado el botonocito de cerrar previsualizacion.<br>* Agregado vinculo "Ir a la Tierra" en el titulo de los comentarios<br><b><u><span style="color: red;">Changelog versiÃ³n 9.8:</span></u></b><br>* Compatibilidad con la nueva barra T!.<br><b><u><span style="color: red;">Changelog versiÃ³n 9.7:</span></u></b><br>* Desactivo momentaneamente las barras de BBC porque Taringa va a poner en funcionamiento la nueva barra, la cual no es compatible con mi script. Luego del lanzamiento vere que hago con el script. si vale o no la pena mejorarlo. No me llenen la casilla con MP Â¬Â¬<br><b><u><span style="color: red;">Changelog versiÃ³n 9.6:</span></u></b><br>* Agregados botones de Enviar, Favoritos y Denunciar en comentario.<br><b><u><span style="color: red;">Changelog versiÃ³n 9.5:</span></u></b><br>* A pedido de muchos agregado el botÃ³n de Quote<br>Y un pequeÃ±ito enlace a mi post arriba a la dereca en el menÃº <span style="position: relative;"><img src="http://i.t.net.ar/images/big2v5.gif" style="position: absolute; top: -332px; clip: rect(330px, 16px, 346px, 0px);"><img src="http://i.t.net.ar/images/space.gif" style="width: 16px; height: 12px;"></span> <span style="position: relative;"><img src="http://i.t.net.ar/images/big2v5.gif" style="position: absolute; top: -332px; clip: rect(330px, 16px, 346px, 0px);"><img src="http://i.t.net.ar/images/space.gif" style="width: 16px; height: 12px;"></span> <br><b><u><span style="color: red;">Changelog versiÃ³n 9.0:</span></u></b><br>* Agregado al comentario una barrita para poner los puntos desde ahi. <br>Â¡Â¡Â¡TodavÃ­a estÃ¡ BETA!!!<br>* Pude poner el "Ir a la Tiera" en la derecha jaja<br><b><u><span style="color: red;">Changelog versiÃ³n 8.3:</span></u></b><br>* Arreglados combobox y fuentes.<br><b><u><span style="color: red;">Changelog versiÃ³n 8.2:</span></u></b><br>* Alguien que otro bugsito en las fuentas y el tamaÃ±o. <br><b><u><span style="color: red;">Changelog versiÃ³n 8.1:</span></u></b><br>* Le saque el loguito de navidad <span style="position: relative;"><img src="http://i.t.net.ar/images/big2v5.gif" style="position: absolute; top: -574px; clip: rect(572px, 16px, 588px, 0px);"><img src="http://i.t.net.ar/images/space.gif" style="width: 16px; height: 12px;"></span><br>';
	nuevaHTML += '    <b><u><span style="color: red;">Changelog versiÃ³n 8.0:</span></u></b><br>* Mejoras en el script. Ahora con autoactualizador.<br><b><u><span style="color: red;">Changelog versiÃ³n 7.5:</span></u></b><br>* Arreglado el problema con los videos en los comentarios <span style="position: relative;"><img src="http://i.t.net.ar/images/big2v5.gif" style="position: absolute; top: -310px; clip: rect(308px, 16px, 324px, 0px);"><img src="http://i.t.net.ar/images/space.gif" style="width: 16px; height: 12px;"></span><br><b><u><span style="color: red;">Changelog versiÃ³n 7.0:</span></u></b><br>* Ahora el script es compatible con Poringa! <br><b><u><span style="color: red;">Changelog versiÃ³n 6.0:</span></u></b><br>* Varias Mejoras encuanto a los comentarios la barra, interface y preview de los comentarios.<br><b><u><span style="color: red;">Changelog versiÃ³n 5.5:</span></u></b><br>* Cambiado el formato de como creaba la barra de BBCodes, haber si ahora se les soluciona el problema que tienen algunos que no le aparecen bien los iconos.<br><b><u><span style="color: red;">Changelog versiÃ³n 5.2:</span></u></b><br>* Para todos a los que se les ve mal la nueva versiÃ³n y a los que no tambien. Bajen esta versiÃ³n donde eh achicado el texto en los combos para que ocupe menos espacio.<br><b><u><span style="color: red;">Changelog versiÃ³n 5.1:</span></u></b><br>* Arreglada la imagen que estaba en portugues <span style="position: relative;"><img src="http://i.t.net.ar/images/big2v5.gif" style="position: absolute; top: -354px; clip: rect(352px, 16px, 368px, 0px);"><img src="http://i.t.net.ar/images/space.gif" style="width: 16px; height: 12px;"></span><br><b><u><span style="color: red;">Changelog versiÃ³n 5.0:</span></u></b><br>* Agregado el preview beta de comentarios que se mejorara pronto.<br><b><u><span style="color: red;">Changelog versiÃ³n 4.5:</span></u></b><br>* Mejorados los reproductores de video. Aca les dejo una muestra. Aparte de la combinacion de colores con taringa.<br><b><u><span style="color: red;">Changelog versiÃ³n 4.0:</span></u></b><br>* Bueno eh cambiado la barra de bbcodes en "Agregar post" y "Edicion de post" y tambien no permitiendo que este se mueva hacia arriba cuando se agrega uno de los emoticones de abajo o con cualquier bbcode.<br>* Y tambien cambie el signito de taringa por uno mÃ¡s modernito que hice <span style="position: relative;"><img src="http://i.t.net.ar/images/big2v5.gif" style="position: absolute; top: -354px; clip: rect(352px, 16px, 368px, 0px);"><img src="http://i.t.net.ar/images/space.gif" style="width: 16px; height: 12px;"></span><br><b><u><span style="color: red;">Changelog versiÃ³n 3.5:</span></u></b><br>* Le agregue un link para ir al fondo de la pÃ¡gina en los post <span style="position: relative;"><img src="http://i.t.net.ar/images/big2v5.gif" style="position: absolute; top: -574px; clip: rect(572px, 16px, 588px, 0px);"><img src="http://i.t.net.ar/images/space.gif" style="width: 16px; height: 12px;"></span> para los que le jode usar la barra o mantener el boton de RePÃ¡g apretado.<br><b><u><span style="color: red;">Changelog versiÃ³n 3.0:</span></u></b><br>* Agregado el BBCode para videos de youtube. Con la posibilidad de reproducir videos de alta calidad.<br><b><u><span style="color: red;">Changelog versiÃ³n 2.0:</span></u></b><br>* Cuando se utilizan las opciones para dar formato al texto sucede exactamente lo mismo que cuando uno va a <em>Agregar</em> y a hacer un post: si, por ejemplo, pongo <b>negrita</b>, <b>automÃ¡ticamente, el texto se mueve hacia arriba, con lo que hay que buscar la parte Ãºltima en la que se insertÃ³ el cÃ³digo</b> haciendo un poco incÃ³modo la insersiÃ³n de un post o comentario.<br>* La version 2 del script. Ahora ya no sucede esto, es mÃ¡s, el texto seleccionado al que le damos formato sigue seleccionado para poder seguir agregandole BBC sin necesidad de volverlo a seleccionar.<br>Y cuando no se selecciono texto, la posiciÃ³n del cursor se situa justo donde tenemos que ingresar los datos del BBC.<br>* Tambien arregle el campo de texto que se desbordaba un poco de la interface. Achicandolo a el tamaÃ±o ideal.<br><b><u><span style="color: red;">Changelog versiÃ³n 1.0:</span></u></b><br>* Bueno cansado de cada vez que le quiero poner algo a algun comentario escribir los BBC, eh escrito este script que introduce la botonera de BBCodes. Como no esta en la misma pÃ¡gina de crear un post no puedo hacer un "copy-paste" asi que diseÃ±e todas las funciones en el script para poder ingresar estos BBC dentro del cuadro de texto.<br>* Como me gusto como ah quedado me gustarÃ­a compartirlo con ustedes.<br>* Antes que nada pueden ver el cÃ³digo antes de instalarlo y verificar que no tiene nada malisioso. Igual si no entienden mucho de JavaScript les doy la palabra que no hace nada malo. O lo podrÃ­a revisar algun miembro de Taringa para darle el OK.';
	nuevaHTML += '</b></div>';
	...
	nuevaHTML += '    <span style="font-size:30px;font-family:Arial Black">SharkaleÂ® 2010</span><br/><br/><br/>';
	nuevaHTML += '    <span style="font-size:15px;">VersiÃ³n instalada actualmente: '+ultversion+'</span><br/><br/>';
	...
	if(user){ 
		...
		$('#miarrobatag207890_submit').attr('value', 'Debes logearte en la pÃ¡gina antes de utilizar el tagboard!');
	}
	...
	$('#tb_msg').focus(function() {
		if($('#tb_msg').val() == 'Tu mensaje aquÃ­')
			$('#tb_msg').val('');
	});
	$('#tb_msg').blur(function() {
		if($('#tb_msg').val() == '')
			$('#tb_msg').val('Tu mensaje aquÃ­');
	});
...
var newCSS  = '.menuTabs{width:400px;background:none;}#menu{background:url("http://i.t.net.ar/images/bgLogged.gif") repeat-x scroll 0 0 #CCCCCC}';
	...
	menu += '<ul class="tMenu">';
//----Actualizar----//
	menu += '	<li id="MenuAct" style="display:none;"><a href="" id="Sharkale_Actualizar" title="Hay una nueva versiÃ³n disponible del Script" style="text-decoration:blink;"><img src="'+MenuActualizacion+'" style="width: '+MenuSize+'px; height: '+MenuSize+'px;" align="absmiddle" /> Nueva VersiÃ³n</a></li>';
//----Inicio----//
	...
	menu += '		<li><a href="/juegos/">Juegos</a><ul class="tSubMenu"></li>';
	...
	menu += '		<li><b>Busqueda Rapida en el sitio</b><form method="get" action="http://'+Dom+'/posts/buscador/taringa/"><input name="q" title="Buscador RÃ¯Â¿Â½pido" style="border: 0px none; font-size: 10px; width:171px;padding-bottom:2px;" type="text"></form></li>';
	menu += '		<li><a href="http://br.taringa.net/">Taringa Brasil!</a></li>';
    menu += '	</ul>';
	menu += '	</li>';
//----Mensaje----/
...
//----Mi Perfil----//
    ...
    menu += '		<li><a href="http://buscar.taringa.net/posts?q=&engine=taringa&autor='+user+'">Mis Posts</a></li>';
	menu += '		<li><a href="http://buscar.taringa.net/comunidades?type=temas&q=&autor='+user+'">Mis Temas</a></li>';
    menu += '	</ul>';
	menu += '	</li>';
//----Logout----//
	menu += '	<li><a href="/logout.php?key='+datospag.user_key+'" title="Cerrar SesiÃ³n"><img src="'+MenuCerrarSesion+'" style="width: '+MenuSize+'px; height: '+MenuSize+'px;" align="absmiddle" alt="X" border="0"/></a></li>';
//----Opciones----//
	...
	menu += '	<a href="http://www.taringa.net/comunidades/bbcoder/" title="Entrar a la Comunidad del ScriptÂ®" style="">Script <img alt="Drop Down" src="http://i.t.net.ar/images/arrowdown.png"></a>';
	menu += '</li>';
	...
	submenu += '	<li><a title="Comunidad Oficial del ScriptÂ®" href="http://www.taringa.net/comunidades/bbcoder/">Comunidad Oficial</a></li>';
	submenu += '	<li><a title="PÃ¡gina Oficial del ScriptÂ®" href="http://www.sharkale.com.ar/bbcoder/" target="_blank">P&aacute;gina Oficial</a></li>';
	...
	submenu += '	<li><a title="Radio SharkaleÂ®" href="http://www.sharkale.com.ar/" target="_blank">Radio Sharkale&reg;</a></li>';
...
var regComu = /\/comunidades\/(bbcoder|ps2games|steamoficial|4chan|canallamania)\//gi;
}
...
GM_addStyle('.especial2 .comment-box, blockquote.especial2, div.citacuerpo.especial2 {-moz-box-shadow:0 0 10px #004000;border:1px solid #004000;}blockquote {-moz-border-radius:5px;}\
			#post-comentarios .miComentario .answerTxt {width:862px !important;margin-left:13px;}#post-comentarios #body_comm{margin-bottom:0px;}.answerTxt .Container{-moz-border-radius:5px 5px 5px 5px;}.comment-box{-moz-border-radius:5px 5px 0 0;}.comment-info {-moz-border-radius:5px 5px 0 0;}');
switch(path) {
case 'post':
	...
	if($('.miComentario').size() != 0){
		...
		$.timer(100,function(timer){
			timer.stop();
			$('.markItUpHeader').html('<div style="width:640px;float:left;"><span style="float:left;text-align:left;">'+CrearBarraBBC()+'</span></div><div style="float:right;">'+CrearBarraColores()+'</div>');
		...
		BotonOcultar = '<input class="button" value="Mostrar/Ocultar Emoticones" onclick="$(\'#Sharkale_TaringaEmoticones\').toggle(\'blind\');" type="button" title="Mostrar/Ocultar la barra de emoticones rÃ¡pidos">';
	...
	if($('.post-title').size() > 0){
		$('a[href="#cielo"]').attr('id','pie-a').removeClass('irCielo').attr('href','#maincontainer').html('<img src="'+urlimg+'arriba.png" title="Ir al Cielo"/>').before('<a href="#medio" title="Ir al Medio"><img src="'+urlimg+'medio_arriba.png"/></a> ');
		var Tierra = '<span style="vertical-align: middle;float: right;padding-top: 1px;padding-right: 30px">';
		Tierra += '<a href="#medio" title="Ir al Medio"><img src="'+urlimg+'medio_abajo.png"/></a> <a href="#pie-a" title="Ir a la Tierra"><img src="'+urlimg+'abajo.png"/></a></span>';
	...
	if($('span[class="given-name"]').html() == "Sharkale"){
		...
		mod_sharkale.find('img[title="Ultra Mega User"]').attr('style','position: absolute; top: -109px; clip: rect(109px, 16px, 126px, 0px);').attr('title','SharkaleÂ® La envidia de los Mods...');
...
case 'edicion':
	...
	$.timer(1,function(timer){
		...
		var html = '<br><label><span class="categoriaPost" style="width:50px"><input type="radio" name="categoria" value="-1" checked="">Elija una Categor&iacute;a</label></span><br>';
		if(Tar){
			for (var i = 3; i < CategoriasT.length; i=i+3) {
				html += '<label><span class="categoriaPost '+CategoriasT[i+1]+'" style="width:50px"><input type="radio" name="categoria" value="'+CategoriasT[i]+'">'+CategoriasT[i+2]+'</label></span><br>';
			}
		}else{
			for (var i = 3; i < CategoriasP.length; i=i+3) {
				html += '<label><span class="categoriaPost '+CategoriasP[i+1]+'" style="width:50px"><input type="radio" name="categoria" value="'+CategoriasP[i]+'">'+CategoriasP[i+2]+'</label></span><br>';
			}
		}
	...
	var HTML = '<br><input class="button" value="Mostrar/Ocultar Emoticones" onclick="$(\'#Sharkale_TaringaEmoticones\').toggle(\'blind\');" type="button" title="Mostrar/Ocultar la barra de emoticones rÃ¡pidos"><input onclick="$(\'#SharkaleColores\').toggle(\'slide\');" class="button" value="Mostrar/Ocutar Coloringa" title="Mostrar/Ocutar Coloringa" type="button"><div id="SharkaleColores" style="display:none;"><object width="550" height="180"><br><embed src="http://img20.imageshack.us/img20/3766/colores.swf" width="550" height="180"  type="application/x-shockwave-flash"/></object><br /><span>VersiÃ³n modificada del COLORINGA! de <a href="http://flashosfera.com.ar/2008/05/coloringa.html" target="_blank">Flashosfera</a></span></div>';
	...
	var html = '<input id="Btn_Agregar_BBCguardados" class="button" type="button" title="Guardar el BBCode del texto seleccionado para utilizarlo en futuras ocaciones" value="Agregar BBC del texto seleccionado"/>';
		...
		html +='<input id="Btn_Backup" class="button" type="button" activo="no" title="Backup del Ãºltimo script realizado" value="Activar Auto-Backup"/><input id="Btn_Ver_Backup" type="button" class="button" title="Transferir post guardado por el autobackup al Agregar Post" value="Ver" /><br/><br/>';
		html +='<iframe src="http://www.sharkale.com.ar/bbcoder/script/imagenes.php" scrolling="no" frameborder="0" width="235" height="339"></iframe>';
...
case 'mensajes':
	...
	var HTML = '<br><input class="button" value="Mostrar/Ocultar Emoticones" onclick="$(\'#Sharkale_TaringaEmoticones\').toggle(\'blind\');" type="button" title="Mostrar/Ocultar la barra de emoticones rÃ¡pidos"></div>';
	$('#emoticons').html(HTML+CrearBarraEmoticones()).attr('style','text-align:center');
	$('a[href="javascript:openpopup()"]').remove();
...
case 'principal':
	...
	$('#topsPostBox div.box_cuerpo,#topsUserBox div.box_cuerpo').css('height','260px').find('ol.filterBy').css('height','225px');
...
case 'perfil':
	...
	if(perfilde == "Sharkale"){
		...
		$('.perfil-info a[href*="bloquear"]').attr('href','javascript:alert("Â¿CÃ³mo vas a ser tan sorete de bloquear al creador del script que estas usando? ^^")');
	}
	...
	$.ajax({
		...
		success: function(h){
			...
			$('.basicData').prepend('<li><strong> Sexo:</strong> <span>'+sexo+'</span></li><li><strong> PaÃ­s:</strong> <span>'+pais+'</span></li>');
...
case 'comunidades':
	...
	if($('.bubbleCont').size() >= 1){
		...
		for(var i=0;i<comu_links.size();i++){
			...
			comu_links.eq(i).find('span').append(' - <a href="'+location.href+comu_link[3]+'.ultima/'+comu_link[4]+'">Ir a la Ãºltima pÃ¡gina</a>');
		}
	}
	if($('.temaCont .floatR:first').size() > 0){
		...
		var Tierra = '<a class="btnActions" href="#pie-a" title="Ir a la Tierra"><img src="'+urlimg+'abajo.png" align="absmiddle"/></a>';
	...
	if($("#body_resp").size() != 0){
		...
		$.timer(100,function(timer){
			timer.stop();
			$('.markItUpHeader').html('<div style="width:640px;float:left;"><span style="float:left;text-align:left;">'+CrearBarraBBC()+'</span><span style="float:right;text-align:left;">'+puntuar.html()+'</span></div><div style="float:right;">'+CrearBarraColores()+'</div>');
		});
		///////////////-----------------------Agregar Emoticones-------------------------////////////////////
...
case 'buscador-ext':
	...
	for (var i = 0; i < busc_links.size(); i++) {
		...
		esteLink.after(' <a href="http://www.taringa.net/'+tip+'/'+com+'/'+num+'.ultima/'+tit+'" style="color:#7777CC;font-size:11px">â€¢ Ãšltima PÃ¡gina</a>');
...
////////////////////////////////////////////////////////////////////////////////////////////
var SVC = {
	currentVersion: "30.1.2", 
	scriptName: "BBCodes para Taringa (by SharkaleÂ® Personalizado)", 
	scriptNum: 84387, 
	...
	manualErrorMsg: function () {
		var reply = confirm('Alerta!\n\n\nLa bÃƒÂºsqueda de actualizaciÃƒÂ³n para ~ ' + SVC.scriptName + ' ~ no tubo ÃƒÂ©xito .\n\nIntÃƒÂ©ntelo nuevamente mas tarde,  o visite ahora la pagina del script para comprobar si hay actualizaciones disponibles. /nPara su informaciÃƒÂ³n, la versiÃƒÂ³n actualmente instalada es ' + SVC.currentVersion + '. \n\nQuieres visitar ahora la pagina del Script para comprobar alguna actualizaciÃƒÂ³n?\n\n  ');
		if (reply) GM_openInTab("http://userscripts.org/scripts/show/" + SVC.scriptNum);
	},
};
GM_registerMenuCommand("BBCoder para T! y P! - Buscar Actualizacion", SVC.versionInfo.manualChecking);
