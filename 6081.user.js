...
s = '#topnav{background:#A3A3A3!important; color:#FFFFFF!important; padding-top:55px!important; font-size:10px; font-family:arial;}\n';
...
s+= 'input {border:1px #a3a3a3 solid; padding:2px; position:relative; left:-120px; background-color:#FFFFFF; color:#a3a3a3; font-size:10px; font-family:arial;}\n';
...
s+= 'a.weightN {font-size:9; font-family:arial; color:#a3a3a3; text-align:center; display:block; width:150px;}\n';
s+= 'a.weightN:hover {font-size:9; font-family:arial; color:#000000; text-align:center; letter-spacing:1px; background-color:#a3a3a3;}\n';

s+= 'textarea {margin-left:-200px; border:1px #a3a3a3 solid; padding:3px; width:750px !important; height:600px; display:block; position:relative; left:200px; margin-bottom:50px; font-size:10px; font-family:arial;}\n';
s+= 'ul {text-align:center !important; display:block; width:800px;}\n';
s+= 'li a {color:#a3a3a3 !important; visibility:visible; font-family:arial; font-size:9px; display:block; margin-left:5px; margin-right:5px; letter-spacing:1px; background-color:#FFFFFF; border:1px solid #a3a3a3; padding:4px;}\n';
...
s+= '#ctl00_ctl00_Main_ProfileEditContent_editInterests_PreviewTop {position:relative; top:-110px; left:-150px;}\n';
s+= '#ctl00_ctl00_Main_ProfileEditContent_editInterests_HeadlineText {position:relative; top:-35px;}\n';
s+= 'h3 {font-size:9; font-family:arial; color:#a3a3a3; display:block; text-align:center; letter-spacing:1px;}\n';
s+= 'a.weightN {font-size:9; font-family:arial; color:#a3a3a3; text-align:center;}\n';
s+= 'a.weightN:hover {font-size:9; font-family:arial; color:#000000; text-align:center; letter-spacing:1px;}\n';
s+= '.alignR br {display:none;}\n';

if(location.href.match(/profileedit\.myspace\.com.*ProfileEdit*/)) 
{
s+= '.txtRed {font-size:9px; font-family:arial; background-color:FFFFFF; border:0px #a3a3a3 solid; color:#a3a3a3; display:block; margin-top:-42px;} \n';
