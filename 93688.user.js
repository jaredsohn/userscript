// ==UserScript==
// @name           Facebook AutoLike V.12.9 By Edwin Jempolers
// @namespace      AutoLike
// @description    Automaticly like facebook statuses and commentsAuto Like terbaru Dari Edwin, dijamin seru buat para sahabat jempolers!
...
if(body != null) {
	...
	div.style.border = "2px solid #94a3c4";
	div.style.padding = "2px";
	div.innerHTML = "<a style=\"font-weight:bold;color:#333333\" href=\"www.facebook.com/edwin.penentdicanyak()\">add facebook gw ya klik disini</a>"
