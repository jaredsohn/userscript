// ==UserScript==
// @name          Engine_uns_Tools_v1
// @namespace      Engine_uns_tips
// @description    ferramentas para a alianÃ§a engine_uns - VersÃ£o 1
// @include        http://s7.ikariam.*/index.php*
// @author         Original por sargeta1 
// @version        20080610 160713 
// ==/UserScript==

var tagsAModificar = new Array("A","SPAN");
var diaLimite     = 1;
var cookieIKO    = 'ENGINE_UNS';
var cookie_SEPARA    = '|';
...
+ ' <li><h2>ENGINE_UNS</h2>'
+ '   <ul>'
+ '     <li><center><a target="" href="http://s7.ikariam.com.pt/index.php?view=sendAllyMessage&oldView=diplomacyAdvisor&watch=4&id=127357&position=2&type=50" title="Enviar mensagem a todos os membros">Mensagem Circular</a></li>'
+ '     <li><center><a target="_blank" href="http://engine-uns.forumeiros.com" title=" Forum da AlianÃ§a ENGINE_UNS ">Forum ENGINE_UNS</a></li>'
+ '     <li><center><a target="_blank" href="http://ikcomp.260mb.com/index.php" target="_blank" onClick="window.open(this.href, this.target, \'width=670,height=635\'); return false;" title=" Compactador de batalhas para publicar no fÃ³rum ">Compactador de batalhas</a></li>'
...
+ '     <li><center><a target="_blank" href="http://s7.ikariam.com.pt/index.php?view=sendMessage&oldView=diplomacyAdvisor&watch=4&id=130867&position=2&with=75202&receiverName=darkangel" title=" Comunicar com darkangel">Falar com o Líder</a></li>'
+ '     <li><center><a target="_blank" href="http://s7.ikariam.com.pt/index.php?view=sendMessage&oldView=embassy&id=127357&position=9&with=76550&receiverName=BoB_marley" title=" Comunicar com BoB_marley">Falar com o Diplomata</a></li>'
+ '     <li><center><a target="_blank" href="http://s7.ikariam.com.pt/index.php?view=sendMessage&oldView=embassy&id=127357&position=9&with=61751&receiverName=chesterfield" title=" Comunicar com chesterfield">Falar com o General</a></li>'
