// ==UserScript==
// @name           Facebook Dost Silme (By Dagli Balasi (ReFi)
// @namespace      Facebook Dost SIlme (by Dagli Balasi (ReFi)
...
//<a href="javascript:;" id="fbdelete_reload">Reload friend list</a><br /><br />
	var html= '<div>' +
		...
		'<b style="padding-left:5px;font-size:1.4em;" title="Facebook Dost Silme Programi.  Acib baqlamaq ucun sol mausu klik ele.">Facebook dost silme programi by Dagli Balasi (ReFi):</b></div>' +
...
PutMouseOverMessage:function(show) {
	...
	var div=document.createElement('div');
	div.id=id;
	div.innerHTML="Xayie edirik Mausu Dostlarinizin adinin ustune getirin ve bir nece saniye gozleyin";
