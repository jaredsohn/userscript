...
// @require        http://sizzlemctwizzle.com/updater.php?id=98198
// ==/UserScript==


var Version = '20110326b';
...
var DEFAULT_ALERT_SOUND_URL = 'http://uploads.mp3songurls.com/1061736.mp3';
...
function pbStartup (){
  ...
  var styles = '.xtab {padding-right: 5px; border:none; background:none; white-space:nowrap;}\
    ...
    table.pbTabPad tr td.ptentry {background-color:#000000; padding-left: 8px;}\
    table.ptNoPad tr td {border:none; background:none; white-space:nowrap; padding:0px}\
    .pbDetLeft {padding:0 5px 0 0 !important; font-weight:bold; text-align:right}\
    .pbStat {border:1px solid; border-color:#ffffff; font-weight:bold; padding-top:2px; padding-bottom:2px; text-align:center; color:#ffffff; background-color:#000000}\
    .ptentry {padding: 7px; border:1px solid; border-color:#000000; background-color:#000000; white-space:nowrap;}\
    ...
    table.pbMainTab tr td.notSel {font-weight:bold; font-size:13px; border: 1px solid; border-style: solid solid none solid; background-color:#000000; color:white; border-color:white;}\
    tr.pbPopTop td { background-color:#000000; border:none; height: 21px;  padding:0px; }\
    tr.pbretry_pbPopTop td { background-color:#a00; color:#fff; border:none; height: 21px;  padding:0px; }\
    .CPopup .CPopMain { background-color:#000000; padding:6px;}\
    .CPopup  {border:3px ridge #ffffff\
...
// TODO: Make sure WinPos is visible on-screen ?
  ...
  AddMainTabLink('GARUDA', eventHideShow, mouseMainTab);
  kocWatchdog ();
  WideScreen.init ();
...
Tabs.tower = {
  ...
  init: function(div){
    ...
    var m = '<DIV class=pbStat>TOWER ALERTS</div><TABLE class=pbTab><TR align=center>';
      ...
      m += '<TD width=95><SPAN id=pbtacity_'+ i +'><SPAN class=ptStatLight><B>' + Cities.cities[i].name + '</b></span></span></td>';
    ...
    m += '<BR><DIV class=pbStat>CONFIGURATION</div><TABLE class=pbTab>\
        <TR><TD><INPUT id=pbalertEnable type=checkbox '+ (Options.alertConfig.aChat?'CHECKED ':'') +'/></td><TD><SPAN class=ptStatLight>Automatically post incoming attacks to alliance chat.</span></td></tr>\
        <TR><TD></td><TD><TABLE cellpadding=0 cellspacing=0>\
            <TR><TD align=right><SPAN class=ptStatLight>Message Prefix: &nbsp; </span></td><TD><INPUT id=pbalertPrefix type=text size=60 maxlength=120 value="'+ Options.alertConfig.aPrefix +'" \></td></tr>\
            <TR><TD align=right><SPAN class=ptStatLight>Alert on scouting: &nbsp; </span></td><TD><INPUT id=pbalertScout type=checkbox '+ (Options.alertConfig.scouting?'CHECKED ':'') +'/></td></tr>\
            <TR><TD align=right><SPAN class=ptStatLight>Alert on wild attack: &nbsp; </span></td><TD><INPUT id=pbalertWild type=checkbox '+ (Options.alertConfig.wilds?'CHECKED ':'') +'/></td></tr>\
            <TR><TD align=right><SPAN class=ptStatLight>Minimum # of troops: &nbsp; </td><TD><INPUT id=pbalertTroops type=text size=7 value="'+ Options.alertConfig.minTroops +'" \> &nbsp; &nbsp; <span id=pbalerterr></span></span></td></tr>\
            </table></td></tr>\
        <TR><TD><BR></td></tr>\
        TR><TD><INPUT id=pbSoundEnable type=checkbox '+ (Options.alertSound.enabled?'CHECKED ':'') +'/></td><TD><SPAN class=ptStatLight>Play sound on incoming attack/scout</span></td></tr>\
        <TR><TD></td><TD><DIV id=pbLoadingSwf><SPAN class=ptStatLight>Loading SWF player</span></div><DIV style="display:none" id=pbSoundOpts><TABLE cellpadding=0 cellspacing=0>\
            <TR><TD align=right><SPAN class=ptStatLight>Sound file: &nbsp; </span></td><TD><INPUT id=pbsoundFile type=text size=55 maxlength=160 value="'+ Options.alertSound.soundUrl +'" \>\
             &nbsp; </td><TD><INPUT id=pbSoundLoad type=submit value=Load><INPUT id=pbSoundDefault type=submit value=Default></td></tr>\
            <TR><TD align=right><SPAN class=ptStatLight>Volume: &nbsp; </span></td><TD><TABLE cellpadding=0 cellspacing=0 class=pbTab><TR valign=middle><TD><SPAN id=pbVolSlider></span></td><TD width=15></td><TD align=right id=pbVolOut><SPAN class=ptStatLight><SPAN class=ptStatLight>0</span></span></td></td></table></td><TD align=center><SPAN id=pbLoadStat><SPAN class=ptStatLight>xx</span></span></td></tr>\
            <TR><TD align=right><INPUT id=pbSoundRepeat type=checkbox '+ (Options.alertSound.repeat?'CHECKED ':'') +'/></td><TD><SPAN class=ptStatLight> Repeat every <INPUT id=pbSoundEvery type=text size=2 maxlength=5 value="'+ Options.alertSound.repeatDelay +'"> minutes</span></td></tr>\
            <TR><TD></td><TD><SPAN class=ptStatLight>Play for <INPUT id=pbSoundLength type=text size=3 maxlength=5 value="'+ Options.alertSound.playLength +'"> seconds</span></td></tr>\
...
Tabs.build = {
    ...
    init: function(div){
		...
		m += '<TD><SPAN class=ptStatLight>Build Type: <SELECT id="pbBuildType">\
				<OPTION value=build>level up</option>\
				<OPTION value=max>level max</option>\
				<OPTION value=destruct>destruct</option>\
				</select></td>';
		m += '<TD><INPUT id=pbHelpRequest type=checkbox '+ (t.buildStates.help?' CHECKED':'') +'\></td><TD><SPAN class=ptStatLight>Ask for help?</span></td>';
		m += '</tr></table></div>';
...
//				13:{'name':"-------",'x':375,'y':375},
    ...
    m = '<DIV class=ptentry><TABLE width=100% class=pbTab><TR><TD class=pbDetLeft><SPAN class=ptStatLight>Search for: </span></td><TD width=99%>';
    m += htmlSelector ({0:"Barb Camp", 1:"Wilderness", 2:"Cities"}, null, 'id=pasrcType'); 
    m += '</td></tr><TR><TD class=pbDetLeft><SPAN class=ptStatLight>At: </span></td><TD class=xtab>X=<INPUT id=pasrchX type=text\> &nbsp;Y=<INPUT id=pasrchY type=text\>\
      &nbsp;<SPAN class=ptStatLight> Radius: </span><INPUT id=pasrcDist size=3 value=10 /> &nbsp; <SPAN id=paspInXY></span>\
      <TR><TD class=pbDetLeft><SPAN class=ptStatLight>Or:</span></td><TD><SPAN class=ptStatLight>Search entire province: </span><select id="provinceXY"><option>--provinces--</option>';
  ...
  clickedSearch : function (){
    ...
    if (isNaN (t.opt.maxDistance) ||t.opt.maxDistance<1 || t.opt.maxDistance>750)
      errMsg += "Radius (distance) must be between 1 and 750<BR>";
    if (errMsg != ''){
      document.getElementById('pasrcResults').innerHTML = '<FONT COLOR=#ff3300><blink>ERROR:</blink></font><BR><BR>'+ errMsg;
      return;
    }
    ...
    m = '<DIV class=pbStat><TABLE width=100% cellspacing=0><TR><TD class=xtab width=125><DIV id=pastatSearched></div></td>\
        ...
        <TD class=xtab align=right width=125><DIV id=pastatFound></div></td></tr></table></div>\
          <TABLE width=100%><TR valign=top>\
            ...
            <TD width=100% height=100% style="background:#000000; height:100%; padding:5px"><DIV id=padivOutOpts></div></td>\
          </table>';
    ...
    if (t.opt.searchShape == 'square')
      ...
      var distName = 'Radius';
    m = '<CENTER><B><SPAN class=ptStatLight>Search for '+ typeName +'<BR>\
        Center: '+ t.opt.startX +','+ t.opt.startY +'  &nbsp; '+ distName +': '+ t.opt.maxDistance +'</span><BR></center>\
        <DIV class=ptentry><TABLE cellspacing=0 width=100%><TR align=center><TD class=xtab colspan=10><B><SPAN class=ptStatLight>LIST OPTIONS:</span></b><BR></td></tr>';
        
    if (t.opt.searchType == 1 || t.opt.searchType == 0) {
      m += '<TR><TD class=xtab align=right><SPAN class=ptStatLight>Min. level to show:</span></td><TD class=xtab> <INPUT id=pafilMinLvl size=2 value='+ Options.srcMinLevel +' /></td></tr>\
        <TR><TD class=xtab align=right><SPAN class=ptStatLight>Max. level to show:</span></td><TD class=xtab> <INPUT id=pafilMaxLvl size=2 value='+ Options.srcMaxLevel +' /></td></tr>';
		}
    if (t.opt.searchType == 1){
      m += '<TR><TD class=xtab align=right><SPAN class=ptStatLight>Wilderness Type:</span></td><TD class=xtab><SELECT id=pafilWildType>';
      m += htmlOptions ( {1:'Glassland/Lake', 3:'Woodlands', 4:'Hills', 5:'Mountain', 6:'Plain', 0:'ALL'}, Options.wildType );
      m += '</select></td></tr><TR><TD class=xtab align=right><SPAN class=ptStatLight>Unowned Only:</span></td><TD class=xtab><INPUT id=pafilUnowned type=CHECKBOX '+ (Options.unownedOnly?' CHECKED':'') +'\><td></tr>';
    }
   if (t.opt.searchType == 1 || t.opt.searchType == 0) {
         m+= '<TR><TD class=xtab align=right><SPAN class=ptStatLight>Sort By:</span></td><TD class=xtab><SELECT id=pafilSortBy>\
          ...
          <OPTION value="dist" '+ (Options.srcSortBy=='dist'?'SELECTED':'')  +'>Distance</option>\
			...
			<TR><TD class=xtab align=right><SPAN class=ptStatLight>Coordinates only:</span></td><TD class=xtab><INPUT type=checkbox id=pacoordsOnly \></td></tr>\
			</table></div><BR><SPAN id=pasrchSizeWarn></span><DIV id=pbSrcExp></div>';
    } else {
		m+= '</select></td></tr><TR><TD class=xtab align=right><SPAN class=ptStatLight>Misted Only:</span></td><TD class=xtab><INPUT id=pafilMisted type=CHECKBOX '+ (Options.mistedOnly?' CHECKED':'') +'\><td></tr>';
		m+= '<TR><TD class=xtab align=right><SPAN class=ptStatLight>Hostile Only:</span></td><TD class=xtab><INPUT id=pafilHostile type=CHECKBOX '+ (Options.hostileOnly?' CHECKED':'') +'\><td></tr>';
		m+= '<TR><TD class=xtab align=right><SPAN class=ptStatLight>Sort By:</span></td><TD class=xtab><SELECT id=pafilSortBy>\
...
Tabs.Test = {
  ...
  init : function (div){
    ...
    var m = '<TABLE><TR><TD align=right>Scout: </td><TD><INPUT type=checkbox id=pbfakeIsScout></td></tr>\
        ...
        <BR><SPAN class=ptStatLight>Force ajax errors : </span><INPUT type=checkbox id=pbajaxErr>\
        <BR><SPAN class=ptStatLight>Send alliance chat alert as whisper : </span><INPUT type=checkbox id=pbalertWhisper CHECKED>\
        <BR><DIV id=pbtestDiv style="background-color:#000000; maxwidth:675; maxheight:350px; height:350px; overflow-y:auto;"></div>';
    div.innerHTML = m;
...
Tabs.Gifts = {
  ...
  helpPop : function (){
    var helpText = '<BR><SPAN class=ptStatLight>The GIFTS tab helps you accept gifts easier than going through facebook. To use it, first hit the \'Check for Gifts\'\
        ...
        \'Check for Gifts\' button again to see what gifts are available.</span></ul>';
    var pop = new CPopup ('giftHelp', 0, 0, 500, 400, true);
    pop.centerMe (mainPop.getMainDiv());  
    pop.getMainDiv().innerHTML = helpText;
    pop.getTopDiv().innerHTML = '<CENTER><B><SPAN class=ptStatLight>Power Bot Help</b>: Accepting gifts</span></center>';
    pop.show (true);
  },
  ...
  e_clickedGifts : function  (){     // (also cancel accepting)
    ...
    document.getElementById('giftDiv').innerHTML = '<SPAN class=ptStatLight>Fetching Facebook gifts page ...</span>';
...
//logit (inspect (t.gifts, 8, 1));     
      var m = '<DIV class=pbStat><CENTER<SPAN class=ptStatLight>>KofC gifts &nbsp; &nbsp; &nbsp; ('+ t.gifts.length +' found)</span<</center></div>';
      if (t.gifts.length<1){
        document.getElementById('giftDiv').innerHTML = m + '<BR><BR><CENTER><SPAN class=ptStatLight>No gifts found!</span></center>';
        return;
      }
     m += '<TABLE class=pbTab align=center><TR><TD align=right><SPAN class=ptStatLight>Server to apply gifts to: </span></td><TD>'
        + htmlSelector (Options.giftDomains.list, getServerId(), 'id=pbGiftServers') +'</td></tr>\
          <TR><TD align=right><SPAN class=ptStatLight>Delete gifts after accepting</span></td><TD>'
        + htmlSelector ({y:'Always', e:'Only if Error', n:'Never'}, Options.giftDelete, 'id=pbGiftDel')
        + '</td></tr><TR><TD><SPAN class=ptStatLight>Select gifts you want to accept and hit: </span></td><TD width=250><INPUT type=submit id=pbGiftDo value="Accept Gifts">\
      ...
      for (var i=0; i<t.gifts.length; i++){
        ...
        m += '<TR><TD><INPUT type=checkbox id=pbgchk_'+ i +'><SPAN class=ptStatLight> &nbsp;'+ giftName +'</span></td><TD><SPAN class=ptStatLight>'+ date +'</span></td>\
              <TD><SPAN class=ptStatLight>'+ t.gifts[i].giver +' ('+ t.gifts[i].args.exs +')</span></td></tr>';
      }
