// coding: utf-8
// ==UserScript==
// @name           	Khanwars 4 Persian Script
// @namespace      	www.apadananetwork.net
// @description    	KhanWars 4.5 Script
...
function functionMain(e) {
	...
	function addMoreLinks() {
		...
		"<li><a><span>"+"===================="+"</span></a></li>"+
            ...
            "<li><a href=\"buildings.php\"><span>"+"ساختمانها"+"</span></a></li>"+
            "<li><a href=\"tower.php\"><span>"+"پناهگاه"+"</span></a></li>"+
            
        "<li><a><span>"+"=بخش آموزش یگانها======"+"</span></a></li>"+
            
            "<li><a href=\"barracks.php?unit_type=1\"><span>"+"پیاده نظام"+"</span></a></li>"+
            "<li><a href=\"barracks.php?unit_type=2\"><span>"+"سواره نظام"+"</span></a></li>"+
            "<li><a href=\"barracks.php?unit_type=4\"><span>"+"یگانهای محاصره"+"</span></a></li>"+
            "<li><a href=\"barracks.php?unit_type=3\"><span>"+"یگانهای ویژه"+"</span></a></li>"+

		"<li><a><span>"+"=بخش ارتقای یگانها======"+"</span></a></li>"+
		
            "<li><a href=\"upgrades.php?u_type=1\"><span>"+"پیاده نظام"+"</span></a></li>"+
            "<li><a href=\"upgrades.php?u_type=2\"><span>"+"سواره نظام"+"</span></a></li>"+
            "<li><a href=\"upgrades.php?u_type=4\"><span>"+"یگانهای محاصره"+"</span></a></li>"+
            "<li><a href=\"upgrades.php?u_type=3\"><span>"+"یگانهای ویژه"+"</span></a></li>"+
		
		"<li><a><span>"+"===================="+"</span></a></li>"+

		      "<li><a href=\"http://apadananetwork.net/0khandagh/khanwars\" TARGET='_blank'><span>"+"به دست آوردن منابع"+"</span></a></li>"+
	...
	function options_window() {
		...
		var sCloseBtn = "http://forum.madmoo.com/styles/khanwars/theme/images/icon_logout.png";
		...
		createElem('input',	'radio',	'autoBuilding',		'ساخت ساختمانهایی که منابع کافی برای ساخت دارند'	);
		...
		input.setAttribute('value','ذخیره و خارج شدن');
		input.setAttribute('title','Save & Exit');
		...
		input.setAttribute('class','buttons');
		input.setAttribute('title','Cancel');
		input.setAttribute('onMouseOver','goLite(this.form.name,this.name)');
		input.setAttribute('onMouseOut','goDim(this.form.name,this.name)');
		form.appendChild(input);
