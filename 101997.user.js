// ==UserScript==
// @name           Facebook - Automatically Accept KoC Gifts for Pridwen303
// @namespace      http://userscripts.org/scripts/show/101997
// @description    This script will automatically accept all of your Kingdoms of Camelot gifts in your Facebook Game Requests for the domain of Pridwen303.
				...
				if(claim_gift){
					...
					if(domain_selector && (next_button1 || next_button2)){
						for(var i=0; i<domain_selector.options.length; i++){
							if(domain_selector.options[i].value == "303"){
