...
function addIconText(){
  ...
  var myScript = "window.addEvent('domready', function(){ $('footer_building_gunsmith').addMousePopup(new MousePopup('Оружейник')); $('footer_building_tailor').addMousePopup(new MousePopup('Портной')); $('footer_building_general').addMousePopup(new MousePopup('Магазин')); $('footer_building_hotel').addMousePopup(new MousePopup('Отель')); $('footer_building_bank').addMousePopup(new MousePopup('Банк')); $('footer_building_church').addMousePopup(new MousePopup('Церковь')); $('footer_building_mortician').addMousePopup(new MousePopup('Могильщик')); $('footer_building_cityhall').addMousePopup(new MousePopup('Мэрия')); $('footer_building_saloon').addMousePopup(new MousePopup('Салун')); });";
  ...
  left_header = document.getElementById('head_title');
  pozL_left_header = parseInt(left_header.offsetLeft)-137;
  footer_menu_left_more.setAttribute('id', 'footer_menu_left_more');
  footer_menu_left_more.setAttribute('class', 'homeless');
  footer_menu_left_more.setAttribute('style', 'left:'+ pozL_left_header +'px; top: -40px; width: 340px; height: 40px; position: absolute; z-index:20;');
