// ==UserScript==
// @version        1.3
// @updateURL    http://userscripts.org/scripts/source/170736.meta.js
// @downloadURL    http://userscripts.org/scripts/source/170736.user.js
// @name           Shaun ZenCog
...
if (CJP.USER_EMAIL == "shaun@zencog.com") {
	...
	if (title == "Estimate" || title == "Invoice"){
        if (document.nodeName == "#document" && (href.indexOf("/estimate/") != -1 || href.indexOf("/invoice/") != -1)) {
            ...
            $('<td class="customFieldsLabelTD" nowrap="">Sales&nbsp;Rep<input id="custom1" value="Shaun" type="text" name="custom1" maxlength="30" align="middle"></td>').insertAfter("#selectCustomerTD");
