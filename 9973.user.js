...
do_modify_html_it(window.document,document.getElementById('content_gesamt'),/<li[^<]+<a href="index.php\?id=berlin">Berlin<\/a[^<]+<\/li>/i,'',null);

do_modify_html_it(window.document,document.getElementById('content_gesamt'),/<a href="[^"]+TAZB[^°]+TAZB[^<]+<\/a[^<]+/,'',null);
