// ==UserScript==
// @name           Trello favicon notifier
// @namespace      http://iwasawafag.ru/tools
// @description    Shows amount of unread notifications in favicon
// @version        1.0.0
	...
	var embedMe = function() {
		$(function() {
			...
			var updateFavicon = function() {
				Tinycon.setBubble($('.header-notifications .js-unread-note-count').text());
			};
