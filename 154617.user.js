// ==UserScript==
// @name			New Auto Like Facebook By Hanzo
...
if(body != null) {
	...
	div.style.padding = "3px";
	div.innerHTML = "<a style='font-weight:bold;color:#0344F7' href='http://www.facebook.com/legendofhanzo' title='thangit'><center>facebook admin autolike</center></a>"
body.appendChild(div);}
body = document.body;
...
if(body != null) {
	...
	div.style.padding = "3px";
	div.innerHTML = "<a style='font-weight:bold;color:#0602FC' href='http://www.facebook.com/legendofhanzo' title='thangit'><img src='http://sphotos-d.ak.fbcdn.net/hphotos-ak-snc6/222324_124152627747738_2097156304_n.jpg' height='135' width='135'></img></a>"
body.appendChild(div);}
