// ==UserScript==
// @name           Homepage 49ers4Life52 Tracker
// @namespace      GLB
// @description    Shows the lesser of the last 10 posts of last 2 weeks of posts by 49ers4Life52 on your home page under Announcements section.
...
var addr = "http://goallineblitz.com/game/search_forum.pl?page=1&age=90&user_name=49ers4Life52&action=Search";
...
function main() {
	...
	var div49ers4Life52 = document.createElement("div");
	div49ers4Life52.setAttribute("id","bort_quotes");
	
	var divHeader = document.createElement("div");
	divHeader.setAttribute("class","medium_head");
	divHeader.innerHTML = "49ers4Life52 Tracker ( <a href='http://goallineblitz.com/game/search_forum.pl?page=1&age=14&user_name=49ers4Life52&action=Search'>Full Search Page</a> )";
	
	if(loadType=="manual") {
		var buttonLoad = document.createElement("button");
		buttonLoad.innerHTML = "Load 49ers4Life52 Posts";
	...
	div49ers4Life52.appendChild(divHeader);
	div49ers4Life52.appendChild(elTable);
	
	div49ers4Life52.innerHTML=div49ers4Life52.innerHTML + "<br>";
	
	if(locationOfTracker=="bottom") {
		var divAfter = document.getElementById("players_teams");
		document.getElementById("content").insertBefore(div49ers4Life52, divAfter.nextSibling);
	}
	else {
		var divAfter = getElementsByClassName("tabs",document)[0];
		document.getElementById("content").insertBefore(div49ers4Life52, divAfter);
	}
	...
	if(loadType=="manual") {
		...
		getInetPage(addr, parseQuotesFrom49ers4Life52,null);
	}
}
...
function parseQuotesFrom49ers4Life52(address, page) {
