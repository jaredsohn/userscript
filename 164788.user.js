// ==UserScript==
// @name           D-League Challenge - SS Season 34
// @namespace      GLB_Chris465
// @description    Collect the stats for the D-League Challenge, Season 34, SS.
...
//var playerList = [4273182,4273183];
var playerList = [4449452,4445948,4433917,4448855,4436130,4445136,4444188,4441918,4433357,4441416,4436458,4436136,4448878,4444163,4443816,4438282,4436668,4437904,4448418,4446304,4449340,4447252,4436932,4449611,4441719,4438310,4439940,4445147,4441544,4438616,4442187,4438557,4442817,4449443,4444302,4447219];
var season = 34;
//
// End
...
var headings = [];
headings["Defense"] = ["Ply","Tk","MsTk","Sack","Hry","TFL","FFum","FumR","Targ","RecAlw","KL","PD","Int","DefTD"];

//headings["Receiving"] = ["Plays","Targ","Rec","Yds","Avg","YAC","TD","Drop","TargRZ","Targ3d","Fum","FumL"];
//headings["Rushing"] = ["BrTk"];
//headings["Offensive Line"] = ["Pancakes"];
//headings["Kick/Punt Return"] = ["KR","KYds","KTD","PR","PYds","PTD"];
...
var points = [];
points["Defense"] = ["0","1","-1","3","1","1","4","3","0","-0.5","1","1","5","6"];

//points["Receiving"] = ["0","0","1","0.15","0","0","6","-1","0","0","-3","0"];
//points["Rushing"] = ["1"];
//points["Offensive Line"] = ["0.02"];
//points["Kick/Punt Return"] = ["0","0.01","2","0","0.01","2"];
//points["Defense"] = ["1","-2","1","1","3","6","1","6","10","2","2","-0.1",".1"];
//safety = 5

var agents = [];
 agents["4449452"]="blitzboy";
 agents["4445948"]="dusk883";
 agents["4433917"]="fogie55";
 agents["4448855"]="o The Boss x";
 agents["4436130"]="1hottie";
 agents["4445136"]="dlcurt";
 agents["4444188"]="Rayto87";
 agents["4441918"]="AD2K";
 agents["4433357"]="F8n4tune";
 agents["4441416"]="vladykins";
 agents["4436458"]="Ahrens858";
 agents["4436136"]="jetsown09";
 agents["4448878"]="mhayes";
 agents["4444163"]="AlaskanRaven";
 agents["4443816"]="chopper409";
 agents["4438282"]="Dr. Brawler";
 agents["4436668"]="Pena_FIN";
 agents["4437904"]="Robbnva";
 agents["4448418"]="xhail2skinsx";
 agents["4446304"]="ZoSo1";
 agents["4449340"]="CyberNinja";
 agents["4447252"]="Dave Mr Majors";
 agents["4436932"]="JackBeQuick";
 agents["4449611"]="nuts_ty RUF";
 agents["4441719"]="ProfessionalKop";
 agents["4438310"]="upsair";
 agents["4439940"]="AlBarsch";
 agents["4445147"]="Baustin";
 agents["4441544"]="Buzz42day";
 agents["4438616"]="Chris465 DTD";
 agents["4442187"]="Jay Gold";
 agents["4438557"]="an_old_dude";
 agents["4442817"]="Barlol";
 agents["4449443"]="DAWG";
 agents["4444302"]="GABBYn4MOM";
 agents["4447219"]="ig";
...
//console.log("boxSetup");
    ...
    button.setAttribute("value","Collect SS Stats");
...
//console.log(statName+" : "+value);		
				...
				if ((heading == "Receiving") && (statName == "Rec")){
					rec = value;
				}
				if ((heading == "Kick/Punt Return") && (statName == "KR")){
					kret = value;
				}
				if ((heading == "Kick/Punt Return") && (statName == "PR")){
					pret = value;
					temp = 2;
				}	
				
				if ((heading == "Receiving") &&(statName == "YAC")){
					value = Math.round((value / 1)*10)/10;
				}	
				if ((heading == "Kick/Punt Return") && (statName == "KAvg")){
					console.log("KAvg");
				}
			...
			//console.log(heading);
			if (heading == "Receiving"){
				//console.log(players[pid].stats[heading])
			}
...
console.log("getting totals");
	...
	for each (var player in players) {
		...
		//trying to get YAC average, instead of total
		if (player.stats["Receiving"] != null) {
			player.stats["Receiving"]["YAC"] = player.stats["Receiving"]["YAC"] / player.stats["Receiving"]["Rec"];
			console.log(player.stats["Receiving"]["YAC"]);
		}
				...
				for (var i = 0; i>= 0; i--){
					//Loop through the available stat columns
						...
						for each (var h in headings[type]) {
								...
								if (h == "KAvg") {
									result = Math.round(parseFloat(kretyds / kret));
									//console.log(kretyds + " / " + kret + " = KAvg:" + result);
								}
								else if (h == "PAvg") {
									result = Math.round(parseFloat(pretyds / pret));
									//console.log("PAvg:" + result);
								}
