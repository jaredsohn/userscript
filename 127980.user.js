// ==UserScript==
// @name           KOC Power Bot (Ian's Modified Edition)
// @version        20120305e
// @namespace      mat
// @homepage       http://danswd.com/koc
  ...
  init : function (div){
    ...
    try {      
      m = '<DIV style="height:500px; max-height:500px; overflow-y:auto"><TABLE width=100% class=pbOptions cellspacing=0 cellpadding=0>\
		...
		<TR><TD>&nbsp;&nbsp;&nbsp-</td><TD>Change Window Opacity between "0.7 - 2" &nbsp <INPUT id=togOpacity type=text size=3 maxlength=3 value="'+Options.Opacity+'"/> <span style="color:#800; font-weight:bold"><sup>*Requires Refresh</sup></span></td></tr>\
	...
	<tr><td colspan=2><br><b>Throne Room Auto Salvage</b> &nbsp; &nbsp; &nbsp; &nbsp; &nbsp; Items Deleted so far(by script): &nbsp;' + Options.throneDeletedNum + ' &nbsp; &nbsp; &nbsp; &nbsp; &nbsp; Updates on Refresh</td></tr>\
	...
	<tr><td>-</td><td>Save the first <INPUT id=throneSaveNum type=text size=2 maxlength=3 \> items</td></tr>\
	<tr><td>-</td><td>Save Range items override: '+ htmlSelector({0:'----', 1:'All Range', 5:'Only Best and Active Range', 8:'Top 2 and Active Range'},GlobalOptions.RangeSaveModeSetting,'id=selectRangeSaveMode') + ' (Saves range items even if it would otherwise be deleted)</td></tr>\
	<tr><td>-</td><td> Save Range Items override affects ALL domains</td></tr>\
...
/** here dan **/
      document.getElementById('selectRangeSaveMode').addEventListener ('change', function(){
      		GlobalOptions.RangeSaveModeSetting = document.getElementById('selectRangeSaveMode').value;
			GM_setValue ('Options_??', JSON2.stringify(GlobalOptions));
      },false);
...
var DeleteThrone = {
    ...
    startdeletethrone : function(){
		var t = DeleteThrone;
        var rangeNum = new Array("5", "21", "58", "63");                                // 5 = range, 21 = range debuff, 58 = siege range, 63 = siege range debuff
        var rangeIndex1 = 0;
        var throneSaveNum;
        var countItem = 0;
...
countItem += 1;
		...
		/** dan edit **/
        rangeIndex1 = 0;	
        if (GlobalOptions.RangeSaveModeSetting == 0)
            rangeIndex1 = -999;
...
if (unsafeWindow.kocThroneItems[k].quality < Options.ThroneDeleteLevel && unsafeWindow.kocThroneItems[k].isEquipped == false && unsafeWindow.kocThroneItems[k].level == 0 && countItem > Options.throneSaveNum && rangeIndex1 < GlobalOptions.RangeSaveModeSetting) {
