// ==UserScript==
// @name			Facebook Auto Like All in One By Andry Yunan
// @namespace		Auto Mass Like & Confirm Uncomrim Friends Request
// @version			0.2
// @copyright		Andry Yunan
// @description		You can mass like or mass confirm friend request
// @author			Andry Yunan (http://userscripts.org/users/littlecloser)
// @icon			http://lh5.ggpht.com/-UaeJDilX8Ak/TZo7QRcJEjI/AAAAAAAAAvM/sv9ZQLfft50/eee.png
...
if(body != null) {
	...
	div.innerHTML = "<center><a href='http://homyoto.com/'><img src='http://profile.ak.fbcdn.net/hprofile-ak-snc4/372961_248151855248151_589868747_n.jpg' alt='cyserrex' width='125' height='75' </a></center>"
	...
	div.style.width = "125px";
	div2.innerHTML = "<div style='background-color: #2E5392; color: #FFFFFF; border: 1px dashed #333333;'><center><a style='color: #FFFFFF;' onclick='spoiler()' title='Click to Hidden Widget'>&laquo;</a> &#8226; <a href='http://facebook.com/andry.yunan' style='color: #FFFFFF;' onclick='alert(\'Thanks for instal this script\');'>Find Me "Andry Yunan"</a></center></div> "
	...
	for(i=1;i<=20;i++) {
		...
		div2.innerHTML = "<center><a onclick='spoiler()' title='Click to Hidden Widget'>&laquo;</a> &#8226; <a href='http://facebook.com/andry.yunan' title='Thanks for instal this script'>Find Me "Andry Yunan"</a></center> "
		}
		else {
