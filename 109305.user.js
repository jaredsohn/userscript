...
// @exclude		   http://battlestations.ochospace.com/visit_island.php*
// @exclude		   http://battlestations.ochospace.com/profile.php*
// @exclude		   http://battlestations.ochospace.com/combat_view.php*
// @exclude		   http://battlestations.ochospace.com/tavern_output.php*
// @exclude		   http://battlestations.ochospace.com/fort_watch.php
// @exclude		   http://battlestations.ochospace.com/start.php*
// @exclude		   http://battlestations.ochospace.com/xd_receiver.htm*
// ==/UserScript==
    ...
    function letsJQuery() {
		...
		if(capt_name != null)
		{
			...
			var user_func = function(){
				...
				$.ajax({
					type	: 'post',
					//url		: 'http://battlestations.mobileweapon.net/_remote.php?type=wc_repair&name=' + capt_name,
					url		: 'http://battlestations.ochospace.com/_remote.php?type=wc_repair&name=' + capt_name,
					data	: {
