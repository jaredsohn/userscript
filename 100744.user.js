  ...
  "il": // Dannidin
   {
    /* Options */
    options:               "אפשרויות",
    lastrefresh1:          "עדכון אחרון",
    lastrefresh2:          "שניות",
    alarminlastingbattles: "התראה על קרב בעיצומו",
    alarmonendofbattle:    "התראה על סיום קרב",
    alarmonabort:          "התראה על הפסקת קרב",
    optionpos:             "מיקום חלון",
    refreshinterval:       "קצב עדכון (0=כבוי)",
    testmode:              "ניסוי צופרים",
    testedalarmtype:       "ניסוי ההתראות השונות (1-5)",
    sound:                 "צליל",
    on:                    "פעיל",
    off:                   "לא פעיל",
    top:                   "עליון", //top: "עליון", 
    bottom:                "תחתון",
    change:                "שינוי ערך",
    enterinterval:         "הכנס קצב רענון (בשניות)",
    enteralarmtype:        "סוג התראה מבוקש (1-5)",
    badvalue1:             "ערך שגוי!",
    badvalue2:             "ערך שגוי (1-5)!",

    /* Attacks messages */
    title:                 "גנרל! פתח את הלשונית!",
    nochanges:             "אין שינוי.",
    warning:               "אזהרה!",
    newattack:             "התקפה חדשה!",
    changes1:              "שינוי בהתקפה!",
    changes2:              "התקפה שונתה!",
    abortattack:           "התקפה הופסקה!",
    endofbattle:           "הקרב נגמר!",

    /* Report */
    report:            "דוח",
    sumofenemiesunits: ":מספר יחידות אוייב",
    nomembersattacked: "אין חברי ברית מותקפים בשעה זו",

    /* Actions */
    occupytown:   "כבוש את העיר",
    pillage:      "בזיזה",
    ontheway:     "שלח כוחות",
    blockharbour: "חסום נמל"
   },
  "gr": // vassilis
   {
    /* Options */
    options: "Επιλογές",
    lastrefresh1: "Τελευταία ενημέρωση",
    lastrefresh2: "δευτερόλεπτα πρίν",
    alarminlastingbattles: "Ενημέρωση Μάχη σε εξέλιξη",
    alarmonendofbattle: "Ενημέρωση τέλος μάχης",
    alarmonabort: "Ενημέρωση ακυρωμένη επιθεση",
    optionpos: "επιλογή θέση",
    refreshinterval: "ρυθμός ανανέωσης (0 - Κλειστό)",
    testmode: "δοκιμή",
    testedalarmtype: "Τύπος συναγερμού γιά δοκιμή (1-5)",
    sound: "ήχος",
    on: "ενεργό",
    off: "ανενεργό",
    top: "επάνω",
    bottom: "κάτω",
    change: "αλλαγή",
    enterinterval: "Επιλογή ρυθμού ανανέωσης (σε δευτερ)",
    enteralarmtype: "Επιλογή είδους επίθεσης (1-5)",
    badvalue1: "λάθος τιμή!",
    badvalue2: "λάθος τιμή (1-5)!",

    /* Attacks messages */
    title: "Στρατηγός! Άνοιξε την καρτελα!",
    nochanges: "Καμία αλλαγη.",
    warning: "ΠΡΟΕΙΔΟΠΟΙΗΣΗ!!!",
    newattack: "ΝΕΑ ΕΠΙΘΕΣΗ!",
    changes1: "Η ΕΠΙΘΕΣΗ ΑΛΛΑΞΕ!",
    changes2: "Η ΕΠΙΘΕΣΗ ΑΛΛΑΞΕ!",
    abortattack: "Η ΕΠΙΘΕΣΗ ΑΚΥΡΩΘΗΚΕ!",
    endofbattle: "τέλος μαχης!",

    /* Report */
    report: "Αναφορά μάχης",
    sumofenemiesunits: "Σύνολο εχθρικών δυναμεων",
    nomembersattacked: "Κανένα μέλος τής Σύμμαχιας σου δέν δέχεται επιθεση αυτη την στιγμή.",

    /* Actions */
    occupytown: "Κατάλαβε την πόλη!",
    pillage: "Λεηλασία",
    ontheway: "Καθ`οδόν",
    blockharbour: "Φράξε το λιμάνι!"
  },
  "fr": // randalph (Thanks To Anank for her help)
   {
    /* Options */
    options:               "Options",
    lastrefresh1:          "Dernière actualisation depuis: ",
  ...
  "dk": // MicCo
   {
    ...
    badvalue1:             "Dårlig værdi!",
    badvalue2:             "Dårlig værdi (1-5)!",

    /* Attacks messages */
    title:        "General! Åbn fanen!",
    nochanges:    "Siden ændrede sig ikke.",
    warning:      "ADVARSEL!",
    newattack:    "NYT ANGREB!",
    changes1:     "ANGREB ÆNDRET!",
    changes2:     "Angreb ændret!",
    abortattack:  "Angreb afbrudt!",
    endofbattle:  "SLut på kamp!",
  ...
  "net": // ercy
   {
    ...
    alarmonabort:          "İptal Edilmis Atagı Bildir",
  ...
  "lt": // edita
   {
    ...
    lastrefresh2:          "prieš sekundžių",
    alarminlastingbattles: "Įspėti apie vykstančius mūšius",
    alarmonendofbattle:    "Įspėti apie mūšio pabaigą",
    alarmonabort:          "Įspėti apie nutrauktą ataką",
    optionpos:             "IGH lango vieta",
    refreshinterval:       "Atnaujinimo intervalas (0 - išjungta)",
    testmode:              "Testavimo rėžimas",
    testedalarmtype:       "Testuojamas įspėjimo signalas (1-5)",
    sound:                 "garsas",
    on:                    "įjungtas",
    off:                   "išjungtas",
    top:                   "viršus",
    bottom:                "apačia",
    change:                "keisti",
    enterinterval:         "Įveskite atnaujinimo intervalą (sekundėmis)",
    enteralarmtype:        "Įveskite atakos tipą (1-5)",
    badvalue1:             "Blogas nustatymas!",
    badvalue2:             "Blogas nustatymas (1-5)!",

    /* Attacks messages */
    title:       "Pagrindinis! atidaryti naujoje kortelėje!",
    nochanges:   "Puslapis nepasikeitė",
    warning:     "ĮSPĖJIMAS",
    newattack:   "NAUJAS PUOLIMAS!",
    changes1:    "PUOLIMAS PASIKEITĖ!",
    changes2:    "Puolimas pasikeitė!",
    abortattack: "Puolimas atšauktas!",
    endofbattle: "Mušio pabaiga!",

    /* Report */
    report:            "Ataskaita",
    sumofenemiesunits: "Priešo vienetų kiekis",
    nomembersattacked: "Šiuo metu puolamų aljanso narių nėra.",
  ...
  "rs": // general_rs
   {
    ...
    /* Actions */
    occupytown:    "Окупирај град!",
    pillage:       "Пљачка",
    ontheway:      "на путу",
    blockharbour:  "Блокирај луку!"
   },
  "ru": // Zeratull
   {
    /* Options */
    options:               "Опции",
    lastrefresh1:          "Последнее обновление",
    lastrefresh2:          "секунд назад",
    alarminlastingbattles: "Уведомлять о прошедших битвах",
    alarmonendofbattle:    "Уведомлять о завершении битвы",
    alarmonabort:          "Уведомлять об отмене атаки",
    optionpos:             "Позиция опций",
    refreshinterval:       "Интервал обновления (0 - выкл)",
    testmode:              "Режим тестирования",
    testedalarmtype:       "Протестированный тип сирены (1-5)",
    sound:                 "звук",
    on:                    "вкл",
    off:                   "выкл",
    top:                   "верх",
    bottom:                "низ",
    change:                "изменить",
    enterinterval:         "Введите интервал обновления (в секундах)",
    enteralarmtype:        "Введите тип атаки (1-5)",
    badvalue1:             "Неверное значение!",
    badvalue2:             "Неверное значение (1-5)!",

    /* Attacks messages */
    title:       "Общие! Откройте вкладку!",
    nochanges:   "Сайт не изменился",
    warning:     "ВНИМАНИЕ!",
    newattack:   "НОВАЯ АТАКА!",
    changes1:    "АТАКА ИЗМЕНИЛАСЬ!",
    changes2:    "Атака изменилась!",
    abortattack: "Атака отменена!",
    endofbattle: "Завершение битвы!",

    /* Report */
    report:            "Отчёт",
    sumofenemiesunits: "Численность неприятеля",
    nomembersattacked: "В данный момент ваши соаловцы в безопасности.",

    /* Actions */
    occupytown:   "Занять город!",
    pillage:      "Набег",
    ontheway:     "по дороге",
    blockharbour: "Блокада"
   },
  "hu": // Sracz66
   {
    /* Options */
  ...
  "it": // mrmauz
   {
    ...
    /* Report */
    report:            "Rapporto",
    sumofenemiesunits: "Totale Unità Nemiche",
    nomembersattacked: "Nessun Membro della tua Alleanza è Sotto Attacco al momento.",

    /* Actions */
    occupytown:   "Occupa città!",
    pillage:      "Saccheggia",
    ontheway:     "in corso",
...
"bg": // Димитър Славов
   {
    /* Options */
    options:               "Опции",
    lastrefresh1:          "Последно обновяване",
    lastrefresh2:          "Преди няколко секунди",
    alarminlastingbattles: "Съобщи за постоянните битки",
    alarmonendofbattle:    "Съобщи за край на битката",
    alarmonabort:          "Съобщи за прекъсната атака",
    optionpos:             "IGH позиция на прозореца",
    refreshinterval:       "Интервал на опресняване (0 - изключено)",
    testmode:              "Тестови режим",
    testedalarmtype:       "Изпробване на типа аларма (1-5)",
    sound:                 "Звук",
    on:                    "Включи",
    off:                   "Изключи",
    top:                   "Горе",
    bottom:                "Долу",
    change:                "Промени",
    enterinterval:         "Въведете интервал на опресняване (в секунди)",
    enteralarmtype:        "Въведете вид атака (1-5)",
    badvalue1:             "Грешна стойност!",
    badvalue2:             "Грешна стойност (1-5)!",

    /* Attacks messages */
    title:       "Генерал! Отвори прозореца!",
    nochanges:   "Сайтът не се е променил.",
    warning:     "ВНИМАНИЕ!",
    newattack:   "НОВА АТАКА!",
    changes1:    "АТАКАТА Е ПРОМЕНЕНА!",
    changes2:    "Атаката е променена!",
    abortattack: "Атаката е прекъсната!",
    endofbattle: "Край на битката!",

    /* Report */
    report:            "Справка",
    sumofenemiesunits: "Вражески единици",
    nomembersattacked: "В момента няма атаки над членове от съюза Ви.",

    /* Actions */
    occupytown:   "Окупирай града!",
    pillage:      "Ограби",
    ontheway:     "на поход",
    blockharbour: "Блокирай пристанището!"
   },
  "ee": // nightwisher
   {
    /* Options */
    ...
    alarmonendofbattle:    "Teavita lahingu lõpust",
  ...
  "lv": // davispuh
   {
    /* Options */
    options:               "Opcijas",
    lastrefresh1:          "Pēdējo reizi atjaunots pirms",
    lastrefresh2:          "sekundēm",
    alarminlastingbattles: "Ziņot par beigušajām kaujām",
    alarmonendofbattle:    "Ziņot par kaujas beigām",
    alarmonabort:          "Ziņot par atceltajiem uzbrukumiem",
    optionpos:             "IGH loga atrašanās vieta",
    refreshinterval:       "Atjaunošanas intervāls (0 - izslēgts)",
    testmode:              "Testa režīms",
    testedalarmtype:       "Testa brīdinājuma tips (1-5)",
    sound:                 "Skaņa",
    on:                    "ieslēgts",
    off:                   "izslēgts",
    top:                   "augšā",
    bottom:                "apakšā",
    change:                "mainīt",
    enterinterval:         "Ievadi atjaunošanās intervālu (sekundēs)",
    enteralarmtype:        "Ievadi uzbrukuma tipu (1-5)",
    badvalue1:             "Nepareiza vērtība!",
    badvalue2:             "Nepareiza vērtība (1-5)!",

    /* Attacks messages */
    title:        "Ģenerāli! Atver cilni!",
    nochanges:    "Nekas nav mainījies.",
    warning:      "BRĪDINĀJUMS!",
    newattack:    "JAUNS UZBRUKUMS!",
    changes1:     "UZBRUKUMS MAINĪJIES!",
    changes2:     "Uzbrukums mainījies!",
    abortattack:  "Uzbrukums atcelts!",
    endofbattle:  "Kaujas beigas!",

    /* Report */
    report:            "Atskaite",
    sumofenemiesunits: "Pretinieka vienību skaits",
    nomembersattacked: "Dotājā momentā nevienam no jūsu alianses biedriem neuzbrūk.",

    /* Actions */
    occupytown:    "Okupēt pilsētu!",
    pillage:       "Izlaupīt",
    ontheway:      "ceļā",
    blockharbour:  "Bloķēt ostu!"
   },
  "ae": // Samerramez
   {
    /* Options */
    options:               "خيارات",
    lastrefresh1:          "آخر تحديث",
    lastrefresh2:          "من ثواني",
    alarminlastingbattles: "تنبيهات آخر معركة",
    alarmonendofbattle:    "تنبيهات انتهاء المعركة",
    alarmonabort:          "تنبيهات الغاء المعركة",
    optionpos:             "مكان تعديل الخيارات",
    refreshinterval:       "فترة التحديث (0 - ايقاف)",
    testmode:              "الوضع التجريبي",
    testedalarmtype:       "الصوت التجريبي (1-5)",
    sound:                 "الصوت",
    on:                    "تشغيل",
    off:                   "ايقاف",
    top:                   "الأعلى",
    bottom:                "الأسفل",
    change:                "تغيير",
    enterinterval:         "ادخل فترة التحديث  (بالثواني)",
    enteralarmtype:        "ادخل نوعية القتال (1-5)",
    badvalue1:             "معلومات خاطئة!",
    badvalue2:             "قيمة خاطئة (1-5)!",

    /* Attacks messages */
    title:        "جنرال! افتح صفحه جديدة!",
    nochanges:    "الموقع لم يتغير.",
    warning:      "تحذيــر!",
    newattack:    "هجوم جديد!",
    changes1:     "تم تغيير الهجوم!",
    changes2:     "تم تغير الهجوم!",
    abortattack:  "تم الغاء الهجوم!",
    endofbattle:  "نهاية المعركة!",

    /* Report */
    report:            "التقرير",
    sumofenemiesunits: "مجموع الأعداء' الوحدات",
    nomembersattacked: "لا أحد من اعضاء حلفك يتعرض للهجوم الآن .",

    /* Actions */
    occupytown:    "أحتلال!",
    pillage:       "نهب",
    ontheway:      "في الطريق",
    blockharbour:  "محاصرة المرفأ!"
   },
  ...
  "tr": // jarasur
   {
    ...
    alarminlastingbattles: "Saldırılar sürdüğünde uyar",
    alarmonendofbattle: "Saldırı bitince uyar",
    alarmonabort: "Saldırı iptal edildiğinde uyar",
    ...
    enteralarmtype: "Saldırı tipi (1-5)",
    badvalue1: "Yanlış değer!",
    badvalue2: "Yanlış değer (1-5)!",

    /* Attacks messages */
    title: "Genel! Sayfa aç!",
    nochanges: "Sayfa değiştirilemedi",
    warning: "UYARI!",
    newattack: "YENİ SALDIRI!",
    changes1: "SALDIRI DEĞİŞTİ!",
    changes2: "Saldırı değişti!",
    abortattack: "Saldırı iptal edildi!",
    endofbattle: "Savaş sonu!",

    /* Report */
    report: "Rapor",
    sumofenemiesunits: "Toplam düşman, birimler",
    nomembersattacked: "Şu anda hiçbir ittifak üyeniz saldırı almıyor.",

    /* Actions */
    occupytown: "İşgal!",
    pillage: "Yağma",
    ontheway: "Underway ne",
    blockharbour: "Limanı engelle!" 
   },
  "ir": // farhoud
   {
    /* Options */
    options: "تنظیمات",
    lastrefresh1: "آخرین بارگذاری صفحع",
    lastrefresh2: "ثانیه پیش",
    alarminlastingbattles: "اعلام آخرین درگیری",
    alarmonendofbattle: "اعلام پایان درگیری",
    alarmonabort: "اعلام حمله منحل شده",
    optionpos: "مکان",
    refreshinterval: "زمان تکرار بارگزاری (۰ تا خاموش)",
    testmode: "حالت امتحان",
    testedalarmtype: "نوع آلارم (۱ تا ۵)",
    sound: "صدا",
    on: "روشن",
    off: "خاموش",
    top: "بالا",
    bottom: "پایین",
    change: "تغییر",
    enterinterval: "زمان تکرار بارگزاری را وارد کنید(به ثانیه)",
    enteralarmtype: "نوع آلارم را برای هر حمله مشخص کنید(۱ تا ۵)",
    badvalue1: "ورودی اشتباه!",
    badvalue2: "ورودی اشتباه(۱ تا ۵)!",

    /* Attacks messages */
    title: "جنرال! تب را باز کن!",
    nochanges: "هیچ تغییری رخ نداده.",
    warning: "هشدار!",
    newattack: "حمله جدید!",
    changes1: "حمله تغییر کرد!",
    changes2: "حمله تغیرر کرده!",
    abortattack: "حمله منحل شده!",
    endofbattle: "پایان جنگ!",

    /* Report */
    report: "گزارشات",
    sumofenemiesunits: "مجموع نیروهای دشمن.",
    nomembersattacked: "به هیچ یک از اعضا اتحاد حمله نشده.",

    /* Actions */
    occupytown: "شهر را تصرف کن!",
    pillage: "غارت",
    ontheway: "در حال حرکت",
    blockharbour: "بستن بندر!"
   },
  "ua": // by feelimon
   {
    /* Options */
    options:               "Опції",
    lastrefresh1:          "Останнє оновлення",
    lastrefresh2:          "секунд тому",
    alarminlastingbattles: "Повідомляти про минулі битви",
    alarmonendofbattle:    "Повідомляти про завершення битви",
    alarmonabort:          "Повідомляти про відміну атаки",
    optionpos:             "Позиція опцій",
    refreshinterval:       "Інтервал оновлення (0 - вимк)",
    testmode:              "Режим тестування",
    testedalarmtype:       "Протестований тип сирени (1-5)",
    sound:                 "звук",
    on:                    "увімк",
    off:                   "вимкн",
    top:                   "верх",
    bottom:                "низ",
    change:                "змінити",
    enterinterval:         "введіть інтервал оновлення (в секундах)",
    enteralarmtype:        "Введіть тип атаки (1-5)",
    badvalue1:             "Невірне значення!",
    badvalue2:             "Невірне значення (1-5)!",

    /* Attacks messages */
    title:       "Генерал! відкрийте вкладку!",
    nochanges:   "Сайт не змінився",
    warning:     "УВАГА!",
    newattack:   "НОВА АТАКА!",
    changes1:    "АТАКА ЗМІНИЛАСЬ!",
    changes2:    "Атака змінилась!",
    abortattack: "Атаку відмінено!",
    endofbattle: "Завершення битви!",

    /* Report */
    report:            "Звіт",
    sumofenemiesunits: "Чисельність ворога",
    nomembersattacked: "Наразі нікого не атакують",

    /* Actions */
    occupytown:   "Зайняти місто!",
    pillage:      "Грабіж",
    ontheway:     "в дорозі",
    blockharbour: "Блок порту"
   },
  "ph": // by sonihei
   {
    /* Options */
...
const flashurl  = "http://interconf.efa.gr/apps/php/maki.swf";
