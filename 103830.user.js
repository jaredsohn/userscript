...
// @namespace      Lithuanian translation
// @author         samanaslt
// @description    eRepublik vertimas
// @version        0.0.1
// @include        http://*.erepublik.com/*
// @require        http://sizzlemctwizzle.com/updater.php?id=99636&days=2&show
// ==/UserScript==
...
// * Index Page
	...
	// * Military campaigns
	"Military campaigns":"Karinės kampanijos"
	"Allies' Campaigns":"Sąjugininkų kampanijos",
	"Victory":"Pergalė",
	"More military campaigns":"Daugiau karinių kampanijų",
	"Campaign of the day":"Dienos mūšis",
	
	// * News
	"Top rated" : "本日熱門",
	"Latest" : "最新新聞",
	"International" : "國際焦點新聞",
	"posted in:" : "發表於:",
...
//	"more news" : "更多新聞",
	...
	"Newspaper subscriptions" : "閱讀已訂閱報紙及管理",
...
// * PM and Sub system
	...
	"Select all":"選擇全部",
	"Delete":"刪除",	
	"Only active conversations from the last 14 days are shown.":"14天內有收到或是寄出訊息的對話才會被保留",
	"Subject":"主旨",
...
// * Work and train page
	...
	// * not employed
	"You do not have a job":"您還沒擁有一個工作",
	"The best way to earn money fast is to find a job and work for a company. The company will pay you by the hour. And the higher your skill is, the more money you will earn.":"最好的賺錢方法就是找到一份好工作。公司每日都會給付日薪給您。您的工作技能等級越高，相對的薪水也會向上提高。",
	"Find a job":"去找工作",
	"Run your own company":"運行您的公司",
	"Running a company is a great way to become rich in eRepublik. But be careful: Before your company becomes profitable you need to pay your employees on a daily basis and know the market you are in.":"在eRepublik裡面，經營公司很容易讓您變成有錢人。但是要注意，若想要有盈利，要衡量市場以及員工的薪資。",
	
	/* "Workplace":"工作場所",
	"Own a company":"擁有公司",
	"Having your own company may be a major source of wealth, but first you will need to make sure you have enough money to pay your future employees' salaries so that you don't go bankrupt.":"擁有自己的公司可能是一個主要的財富來源，但是首先您要確保您有足夠的錢來支付您的未來僱員的薪酬，這樣您才不會破產。",
	"work":"工作",
	"company details":"公司的詳細資料",
	"Find out more":"了解更多",
	"Buy from market" : "去公司轉讓市場",
	"Create new" : "建立新的",	*/
	
	// * Work page
	//"Choose an action to boost your Economy skill and Productivity":"選擇一種提升工作效率的方法來提高您的工作技能和生產力 ^_^",
	//"Single Espr...":"來一杯咖啡",
	//"Double Espr...":"兩倍濃度咖啡",
	//"Brainstorm ...":"一同腦力激盪",
	//"After work ...":"下班後的派對",
	//"Invite Friend":"按此邀請朋友",
	//"Choose 2 invited friends to boost your Economy skill and Productivity":"選擇2個朋友來幫助您提高工作效率",
	//"Start working":"開始工作",
	...
	"Workday results":"本日工作的成果",
	"Today's salary":"本次工作的薪水",
	...
	"more days to receive your 'Hard Worker' Medal":"天就可以獲得 ''勤勞工人'' 的成就獎章。",
	...
	"Free Land":"尚未開發之空地",
	"Not Passed":"未通過",
	"Select building type":"產業種類",
	"Construct":"建立公司",
	"Select building":"選擇種類",
	...
	"Offers":"薪資",
	"Select skill":"選擇欲招募的員工等級",
	"Save":"儲存",
		
	"Company setup & product design":"公司產品屬性升級或降級",
	//////////////////////////////////////////////
	
	"Migrate company":" 變更公司產業",
	"Edit details":" 編輯公司資料",
	"Sell company":" 公司轉讓",
	...
	"Company description":"Company description 公司介紹",
	...
	"Dissolving a company will empty the land on which it has been built, allowing you to build another company on it.":"解散一間公司將可以空出土地以供創立新公司用",
...
// * Training grounds
	...
	"Choose an action to boost your strength":"選擇一種提升效率的方法來提高您的力量",
	"Choose 2 invited friends to boost your strength":"選擇2個朋友來幫助您提高力量",
	"View train results":"查看訓練成果",
	"Train results":"訓練成果",
	"Strength:":"力量:",
	"Experience":"經驗值",
	"Training details":"訓練結果細節",
...
// * My land and Profile
	...
	"Media Mogul" : "媒體大亨",
	"Reached 1000 subscribers to your newspaper": "訂閱您報紙的讀者達到 1000 人",
	"Battle Hero" : "戰鬥英雄",
	...
	"The first ticket found in your storage that will cover the required distance will be used." : "符合飛行距離並且順序最前面的機票將會被優先使用",
	"Moving distance:":"Distance 飛行距離:",
	"New location":"欲前往的地方",
	"Do you wish to apply for citizenship in your new country?":"您是否需要提出此國的入籍申請？",
	"Apply for citizenship":"同意入籍申請",
	"No, thanks":"不需要",
		
	// * Storage
	"Final products":"可用物品區",
	"Resources":"原料區",
	"Sell":"販售",
	"post new offer":"將物品放到市場販售",
	"from marketplace":"從市場購買東西",
...
// * Market place
	...
	"Health Restore":"可以恢復的提力值",
	"Search for product":"搜尋產品",
	"Select minimum quality":"選擇品質",
	"Show results":"顯示結果",
...
// * Company for sale
	...
	"Product details":"產品屬性",
	"There are no companies for sale matching you search.":"您搜尋的產業類別沒有待售中的公司。",
...
// * My party and election
	...
	//"Supporting parties":"支持的政黨",	 //buging
...
// * Country administration and other info
	...
	// * Region details
	"No direct transport route to the Capital":"沒有與首都直達的路徑",
	"Country - Society":"回到社會地理主頁",
   	"Population":"人口數",
   	"Constructions":"本地建設",
   	"Resource":"富產之資源",
   	"Resistance War" : "起義戰爭資訊", //bug
   	"You cannot start a resistance war in this region because it already belongs to its original owner country." : "您不能於此地區發動起義戰爭，因該地區已屬於其原有的國家。",
	"In order to start a resistance war, you need 10000 local currency of the country that originally owned the region." : "您必須擁有該地的原擁有國的貨幣1萬元才能發動起義",
	   	"Neighbors" : "鄰近地區",
	
	// * Economy
	"Country resources":"資源列表",
	"Regions":"產地",
	"Not available":"無",
	"Treasury":"國庫資訊",
	"All accounts":"所有貨幣帳戶",
	...
	// * Proposal
	"Propose a law":"提出一則法案",
	"New citizen fee":"新生公民福利金變更案",
	"Provide citizenship":"國籍審核",	
	"Minimum wage":"最低工資案",
	"President Impeachment":"總統彈劾案",
	"details" : "詳情",
	"Accepted" : "已通過",
	"Rejected" : "己被否決",
	"ACCEPTED" : "已通過",
	...
	"Value Added Tax":"增值稅",
	"Buy Constructions":"購買建設標案",
	"Peace Proposal":"和平協議條約",
	"Natural Enemy":"世仇宣告",
	"Alliance" : "結盟條約",
	"New Citizen Message":"新公民歡迎訊息",
	...
	// * Tax
	"Tax change: Food":"稅率變更案: 食物",
	"Tax change: Moving Tickets":"稅率變更案: 機票",
	"Tax change: Weapons":"稅率變更案: 武器",
	"Tax change: House":"稅率變更案: 房屋",
	"Tax change: Defense System":"稅率變更案: 防禦系統",
	"Tax change: Hospital":"稅率變更案: 醫院",
	"Tax change: Stone":"稅率變更案: 石材",
	"Tax change: Oil":"稅率變更案: 石油",
	"Tax change: Grain":"稅率變更案: 穀物",
	"Tax change: Iron":"稅率變更案: 鋼鐵",
	...
	// * Common page
	"The law voting process takes 24 hours.":"該法的投票過程需要進行24小時。",
	"Yes":"贊成",
	"No":"反對",
	
	"Only congress members and country presidents have the right to vote.":"只有國會議員和總統才有投票權。",
	"For this law to be considered accepted it needs 66% of the Congress votes.":"本法案需要超過66%的議員席次投票同意才可通過。",
	"Show all law proposals":"顯示所有法律提案",
	
	"Value added tax (VAT)" : "增值稅 (VAT)",
	"New":"新",
	"Old":"舊",
	"Attention: No VAT tax for raw materials":"注意：原料並無課徵增值稅",
	"Debate Area":"辯論區",
...
////////////////////////////////////////////////////////////////////////////////////////////
	...
	"Good job! You are on the way to a Hardworker Medal. Please prove you are human." : "做的好！您正邁向「模範員工」獎章之路。請先證明您確實是真人。",
	"Good job! Please prove you are human.":"做的好！請輸入驗證碼證明您確實是真人。",
	"Continue":"繼續",
	...
	"Welcome to the New World! I'm Carla, your eRepublik advisor. Let's get acquainted, then I'll show you around.":"",
...
regexps["has transferred (.*) (.*) to your storage.$"] = " 丟了 $1 個 $2 到您的倉庫";
...
regexps["^has transfered (.*) to your account.$"] = "已經轉入$1到您的帳戶。";
regexps["^We inform you that (.*) (.*) have been sold for (.*) (.*) from the citizen account using the offer posted on the$"] = "在此通知您 $1 $2 已經以 $3 $4的價格賣出，請至";
regexps["monetary market$"] = "外匯市場確認";
regexps["commented on your"] = "已經在你的狀態留言。";
regexps["commented on this"] = "已經在此狀態留言。";
regexps["and (.*)others commented on this$"] = "  還有$1人留言";
regexps["post$"] = " 按此查看留言";
regexps["has accepted your friendship request"] = "已經接受你的好友邀請";
//regexps["applied for your job \\(minimum skill level (\\d*) \\) and now works for"] = "已經應徵了職缺(技能是LV $1)於";
regexps["^Unfortunately, you have been removed by$"] = "壞消息，你已經被從";
regexps["^from his friends list.$"] = "的好友名單上給移除了";
regexps["wants to add you to (.*) friends list\\. Will you accept\\?"] = "想要加您為好友，請問您同意嗎?";
regexps["A new law proposal is now waiting for the Congress vote. To debate on this situation and to place your vote you can access the law proposal page"] = "目前議會中有人提出一個新法案，請前往討論或是投票";
regexps["Proposal"] = "按此看法案內容";
...
regexps["Expires tomorrow"] = " 明天後到期";
...
regexps["Still active"] = "戰爭持續中";
regexps["started on"] = "目前戰場開啟自";
...
regexps["Battles I can Fight in"] = "我可以加入的戰鬥";
regexps["My land"] = "我的領域";
regexps["Economy Skill \\:"] = "工作技能 :";


//訓練
regexps["Strength level: (.*) / (.*) for the next Super Soldier Medal"] = "目前力量: $1。滿$2可獲得超級大兵的成就";
regexps["Awesome performance,  (.*)! Can't wait to have the next training session with you!"] = "表現真棒 $1，我等不及在明天的訓練課遇見你！";
regexps["Welcome, (.*)\\! I am Lana\\. Ready for your daily military training\\? Remember\\: the more trained you are\\, the more damage you do in battles and the more Super Soldier Medals you win\\! Good luck\\!"] = "歡迎你 $1，我是你的訓練員Lana，準備好要開始每日的例行訓練了嗎?請記得，你訓練得越多，你就可以在戰場上得到更高的攻擊力以及得到更多的超級英雄獎章，祝你好運!";
...
regexps["Active wars in (.*)"] = "目前在$1境內的可參與的戰爭";
...
regexps["Next election in"] = " 距離下次選舉： ", //bug
regexps["(\\d*) days"] = " $1 天後",
regexps["(\\d*)candidates"] = " 個候選人", //bug

//邀請朋友
regexps["Invite your friends and get 10% of all Gold they will receive in eRepublik from Treasure Maps and purchases. Check the"] = "邀請您的朋友並獲得從朋友那開啟的藏寶圖、或是儲值黃金的10%回饋。查看您邀請的";
//選舉
...
regexps["President of (.*) proposed a mutual protection pact with (.*)"] = "$1的總統提出了與$2簽訂共同防禦條約(MMP)的法案";
regexps["Do you agree that (.*) should buy a Defense System of quality (.*) from (.*) at the price of (.*) (.*) for"] = "你是否同意$1應該購買等級$2的防禦設施從製造商$3 \(價格是$4 $5\)，並且放置在";
regexps["Do you agree that (.*) should buy a Hospital of quality (.*) from (.*) at the price of (.*) (.*) for"] = "你是否同意$1應該購買等級$2的醫院從製造商$3 \(價格是$4 $5\)，並且放置在";
regexps["The President of (.*) demanded a sum of (.*) gold from your National Treasury in return to a peace treaty with (.*)"] = "$1的總統要求從國庫索取$2 Gold換取和平停戰條約";
regexps["Do you want the current president of (.*) to end this office?"] = "請問您是否同意彈劾目前$1的總統?";
...
////////////////////////////////////////////////////////////////////////////////////////////////////
	...
	*/
	...
	//Add treasure map
	$("#menu2 a").after('<ul><li><a href="http://www.erepublik.com/'+lang+'/work" target="_blank">工作</a></li>'+
						'<li><a href="http://economy.erepublik.com/'+lang+'/train" target="_blank">訓練</a></li>'+
	...
	$("#menu2 > ul > li > a").css({'background':'url("http://i.imgur.com/u1h0F.png") no-repeat scroll 0 -940px transparent', 'color':'#808080', 'display':'block', 'float':'left', 'font-size':'12px', 'height':'27px', 'padding':'13px 15px 0 28px', 'text-decoration':'none', 'width':'135px'});
	$("#menu2 > ul > li > a").hover(function(){
		this.style.background = 'url("http://i.imgur.com/u1h0F.png") no-repeat scroll 0 -899px transparent';
		this.style.color = '#FFFFFF';
		}, function() {
		this.style.background = 'url("http://i.imgur.com/u1h0F.png") no-repeat scroll 0 -940px transparent';
...
$("div#eatFoodTooltip").html(
								"<img src=\"http://www.erepublik.com/images/modules/sidebar/yellow_arrow_tip.png\" class=\"tip\" alt=\"\" />"+
								"<p>如果您的體力低於100，你可以按這裡吃<strong>物品欄位中第一個食物</strong>來恢復。</p>"+
...
function getVersion() {
	GM_xmlhttpRequest({
		method: 'GET',
		url: 'http://userscripts.org/scripts/show/99636',
		headers: {
		...
		onload: function(responseDetails) {
			...
			if(parseFloat(nVersion) > parseFloat(currVersion)) {
				$('div##maildisplay').after('<a title="Update available! New version: v ' + newVersion + '" href="http://userscripts.org/scripts/show/80226" target="_blank" style="color: #ff0000; font-weight: bold;">v ' + VERSION + '</a>');
			}
		}
	});
}
