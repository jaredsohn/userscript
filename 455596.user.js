// ==UserScript==
// @name        Howrse Horse Image Swap-Gypsy Vanner
// @namespace   myHowrse
...
if(document.body.textContent.indexOf("Breed: Gypsy Vanner") > 0)
{
...
//	Until Owlient decides to delete the old coats, we can continue to use their copy of the old coat here.
		...
		if(document.body.textContent.indexOf("Coat: Cherry bay Tobiano") > 0)
		...
		else if(document.body.textContent.indexOf("Bay") > 0)
			newSrc = subDir + "bai-grand.png";
		else if(document.body.textContent.indexOf("Chestnut") > 0)
			newSrc = subDir + "alz-grand.png";
		else if(document.body.textContent.indexOf("Dun") > 0)
