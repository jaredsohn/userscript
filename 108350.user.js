...
org.hattrick.PsicoTSI = function () {
   ...
   const LOCALIZATION = {
      ...
      "bs-BA": {
         "name": "Bosanski",
         "twoMainSkills": "UPOZORENJE: Ovaj igrac ima dve glavne vještine: Greška u predvidanju može biti veoma velika",
         "injuredPlayer": "UPOZORENJE: Igrac je povreden, glavna vještina je podcenjena",
         "oldPlayer": "UPOZORENJE: Igrac ima više od 27 godina, pa je njegova glavna vještina podcenjena",
         "isGoalkeeper": "PsicoTSI ne predvida podnivoe za golmane",
         "skillsNotAvailable": "Vještine ovog igraca nisu dostupne",
         "form": "Forma",
         "wage": "Plata",
         "high": "Visoka",
         "average": "Prosjecna",
         ...
         "skillKeeper": "Golman",
         "limitLow": "Ovom igracu je nedavno porastao nivo vještine ili su njegove sekundarne vještine i/ili forma veoma niske",
         "limitHigh": "Ovaj igrac je blizu rasta nivoa vještine ili su njegove sekundarne vještine i/ili forma veoma visoke"
      },
      "cz": {
         "name": "Ceština",
         "twoMainSkills": "UPOZORNENÍ: Tento hrác má 2 hlavní dovednosti, nepresnost predpovedi muže být velmi vysoká.",
         "injuredPlayer": "UPOZORNENÍ: Zranený hrác, hlavní dovednost podcenena.",
         "oldPlayer": "UPOZORNENÍ: Tento hrác je starší 27 let, hlavní dovednost podcenena.",
         "isGoalkeeper": "PsicoTSI nepredpovídá hlavní dovednost Chytání.",
         "skillsNotAvailable": "Dovednosti hráce nejsou dostupné.",
         "form": "Forma",
         "wage": "Plat",
         "high": "Vysoká",
         "average": "Prumerná",
         ...
         "skillWinger": "Krídlo",
         "skillScoring": "Zakoncování",
         "skillPassing": "Prihrávky",
         "skillDefending": "Bránení",
         "skillKeeper": "Chytání",
         "limitLow": "Tento hrác se nedávno zlepšil nebo jeho sekundární vlastnost a/nebo forma má velmi nízkou úroven.",
         "limitHigh": "Tento hrác je blízko k zlepšení v hlavní dovednosti nebo jeho sekundární vlastnost a/nebo forma mají velmi vysokou úroven."
      },
      "de-DE": {
         "name": "Deutsch",
      ...
      "gr": {
         "name": "????????",
         "twoMainSkills": "???S???: ??t?? ? p???t?? ??e? 2 ????e? ??a??t?te?: ? ap????s? t?? p??ß?e??? µp??e? ?a e??a? p??? µe????",
         "injuredPlayer": "???S???: ??a?µat?sµ???? pa??t??, ? ????a ??a??t?ta e??a? ?p?t?µ?µ???",
         "oldPlayer": "???S???: ??t?? ? pa??t?? e??a? µe?a??te??? ap? 27 ??????, ? ????a ??a??t?ta e??a? ?p?t?µ?µ???",
         "isGoalkeeper": "?? PsicoTSI de? p??ß??pe? t? ?p?ep?ped? t?? ??a??t?ta? t?? t??µat??",
         "skillsNotAvailable": "?? ??a??t?te? a?t?? t?? pa??t? de? e??a? d?a??s?µe?",
         "form": "F??µa",
         "wage": "??s???",
         "high": "?????",
         "average": "??t??a",
         ...
         "skillDefending": "?µ??a",
         "skillKeeper": "???µa",
         "limitLow": "??t?? ? pa??t?? a??ßase p??sfata ep?ped? ??a??t?ta? ? ?? de?te?e???se? ??a??t?t?? t?? ?/?a? ? f??µa t?? ????? p??? ?aµ??? ?p?ep?ped?",
         "limitHigh": "??t?? ? pa??t?? e??a? ???t? st? ?a a?eß?se? ep?ped? ??a??t?ta? ? ?? de?te?e???se? ??a??t?t?? t?? ?/?a? ? f??µa t?? ????? p??? ????? ?p?ep?ped?"
      },
      "hr": {
         "name": "Hrvatski",
         "twoMainSkills": "WARNING: Ovaj igrac ima 2 glavne vještine: Greška u predvidanju može biti vrlo velika",
         "injuredPlayer": "WARNING: Ozlijeden igrac, glavna vještina je podcijenjena",
         "oldPlayer": "WARNING: Ovaj igrac je stariji od 27 godina, glavna vještina je podcijenjena",
         "isGoalkeeper": "PsicoTSI ne predvida podrazine vještine za golmane",
         "skillsNotAvailable": "Vještine ovog igraca nisu dostupne",
         "form": "Forma",
         "wage": "Placa",
         "high": "Visoka",
         ...
         "limitLow": "Ovaj igrac je nedavno napredovao ili su njegove sporedne vještine i/ili forma na vrlo niskoj podrazini",
         "limitHigh": "Ovaj igrac je blizu napretka u glavnoj vještini ili su njegove sporedne vještine i/ili forma na vrlo visokoj podrazini"
      },
      "hu": {
         "name": "Magyar",
         "twoMainSkills": "WARNING: Ennek a játékosnak 2 fo képessége van: A becsült érték így nagyon magas lehet",
         "injuredPlayer": "WARNING: Sérült játékos, a fo képesség becslése alacsonyabb",
         "oldPlayer": "WARNING: Ez a játékos 27 éves elmúlt, a fo képesség becslése alacsonyabb",
         "isGoalkeeper": "A PsicoTSI a védés képesség szintjét nem képes megbecsülni",
         "skillsNotAvailable": "A játékos képességei nem elérhetoek",
         "form": "Forma",
         "wage": "Fizetés",
         "high": "Magas",
         "average": "Átlagos",
      ...
      "lv": {
         "name": "Latviešu",
         "twoMainSkills": "WARNING: Speletajam ir 2 galvenas prasmes: Paregojuma kluda var but loti liela",
         "injuredPlayer": "WARNING: Traumets speletajs, galvena prasme nav pienacigi noverteta",
         "oldPlayer": "WARNING: Speletajs ir vecaks par 27 gadiem, galvena prasme nav pienacigi noverteta",
         "isGoalkeeper": "PsicoTSI neparego prasmju apakšlimei vartu sargiem",
         "skillsNotAvailable": "Speletaja prasmes nav pieejamas",
         "form": "Gataviba spelei",
         "wage": "Alga",
         "high": "Augsts apakšlimenis",
         "average": "Videjais apakšlimenis",
         "low": "Zems apakšlimenis",
         "skillPlaymaking": "Saspele",
         "skillWinger": "Flangos",
         "skillScoring": "Realizacija",
         "skillPassing": "Piespeles",
         "skillDefending": "Aizsardziba",
         "skillKeeper": "Vartos",
         "limitLow": "Speletajs nesen uzlaboja pamatprasmi, vai sekundara prasme un/vai gataviba spelei ir ar loti zemu apakšlimeni",
         "limitHigh": "Speletajs driz uzlabos pamatprasmi, vai sekundara prasme un/vai gataviba spelei ir ar loti augstu apakšlimeni"
      },
      "nl-BE": {
         "name": "Vlaams",
      ...
      "pl": {
         "name": "Polski",
         "twoMainSkills": "UWAGA: Ten gracz ma dwie równorzedne umiejetnosci. Blad w pomiarze moze byc bardzo duzy",
         ...
         "isGoalkeeper": "PsicoTSI nie mierzy podpoziomu umiejetnosci bramkarskich",
         "skillsNotAvailable": "Podglad umiejetnosci tego gracza jest niedostepny.",
         "form": "Forma",
         "wage": "Pensja",
         "high": "Wysoka",
         "average": "Srednia",
         ...
         "limitLow": "Ten gracz poprawil ostatnio swoja umiejetnosc albo jego drugorzedne umiejetnosci i/lub forma maja bardzo niski podpoziom",
         "limitHigh": "Ten gracz jest bardzo blisko poprawienia swojej umiejetnosci albo jego drugorzedne umiejetnosci i/lub forma maja bardzo wysoki podpoziom"
      },
      "pt-BR": {
      ...
      "ro": {
         ...
         "average": "Medie",
         "low": "Mica",
         "skillPlaymaking": "Construc?ie",
         "skillWinger": "Extrema",
         "skillScoring": "Atac",
         "skillPassing": "Pase",
         "skillDefending": "Aparare",
         "skillKeeper": "Portar",
      ...
      "sk": {
         "name": "Slovencina",
         "twoMainSkills": "POZOR: Tento hrác má dve primárne schopnosti - Riziko chybného odhadu je velmi vysoké",
         "injuredPlayer": "POZOR: Zranený hrác, jeho primárna schopnost je podhodnotená",
         "oldPlayer": "POZOR: Tento hrác je starší ako 27 rokov, jeho primárna schopnost je podhodnotená",
         "isGoalkeeper": "PsicoTSI neodhaduje úroven schopnosti chytania",
         "skillsNotAvailable": "Schopnosti tohto hráca nie sú k dispozícii",
         "form": "Forma",
         "wage": "Plat",
         "high": "Vysoká",
         "average": "Priemerná",
         ...
         "skillScoring": "Zakoncovanie",
         "skillPassing": "Prihrávky",
         "skillDefending": "Bránenie",
         "skillKeeper": "Chytanie",
         "limitLow": "Schopnost tohto hráca sa v nedávnej dobe zlepšila alebo jeho sekundárne schopnosti a/alebo forma majú velmi nízku podúroven",
         "limitHigh": "Tento hrác je velmi blízko k zlepšeniu svojej schopnosti alebo jeho sekundárne schopnosti a/alebo forma majú velmi vysokú podúroven"
      },
      "sr": {
         "name": "??????",
         "twoMainSkills": "?????????: ???? ????? ??? ??? ?????? ???????: ?????? ? ?????????? ???? ???? ????? ??????",
      ...
      "tr": {
         "name": "Türkçe",
         "twoMainSkills": "DIKKAT: Oyuncunun 2 ana yetenegi var. Hata payi çok yüksek olabilir.",
         "injuredPlayer": "DIKKAT: Oyuncu sakat, ana yetenegi düsük hesaplanmistir.",
         "oldPlayer": "DIKKAT: Oyuncu 27 yasini geçmis, ana yetenegi düsük hesaplanmastir.",
         ...
         "skillKeeper": "Kaleci",
         "limitLow": "Oyuncu yeni seviye atlamis veya yan yetenek ve/veya form ara degerleri çok düsük.",
         "limitHigh": "Oyuncu seviye atlamak üzere veya yan yetenek ve/veya form ara degerleri çok yüksek."
      },
      "ua": {
         "name": "??????????",
         "twoMainSkills": "?????: ??? ??????? ??? 2 ??????? ???????: ??????? ????????????? ???? ???? ???? ???????",
   ...
   if (SHOW_CURRENCIES) {
      ...
      var total = 0;
      for (var i in HATTRICK_CURRENCIES)++total;
      var current = 1;
   ...
   if (SHOW_LANGUAGES) {
      var elem_per_page = 15;
      var total = 0;
      for (var i in LOCALIZATION)++total;
      var current = 1;
  ...
  number_format = function (number, decimals, dec_point, thousands_sep) {
   ...
   getAge = function (HTMLDocument) {
      ...
      try {
         ...
         if (ageDiv.snapshotLength > 0) {
          age = ageDiv.snapshotItem(0).textContent.match(/\d+/)[0];
         }
         if (age < 17 || age > 99) throw "Age (" + age + ") out of bounds";
      } catch (e) {
   ...
   playerPagePsicoTSI = function (HTMLDocument) { /* GETTING SKILLS */
      ...
      if (links.snapshotLength == 14) {
         //New Table
         var goa = getValueFromLink(links.snapshotItem(7).href)
         var def = getValueFromLink(links.snapshotItem(8).href)
         var pla = getValueFromLink(links.snapshotItem(9).href)
         var win = getValueFromLink(links.snapshotItem(10).href)
         var pas = getValueFromLink(links.snapshotItem(11).href)
         var sco = getValueFromLink(links.snapshotItem(12).href)
         var sp = getValueFromLink(links.snapshotItem(13).href)
         entryPoint = links.snapshotItem(7).parentNode.parentNode.parentNode.parentNode.parentNode;
      } else if (links.snapshotLength == 15) {
         //Old Table
         var goa = getValueFromLink(links.snapshotItem(8).href)
         var def = getValueFromLink(links.snapshotItem(12).href)
         var pla = getValueFromLink(links.snapshotItem(9).href)
         var win = getValueFromLink(links.snapshotItem(11).href)
         var pas = getValueFromLink(links.snapshotItem(10).href)
         var sco = getValueFromLink(links.snapshotItem(13).href)
         var sp = getValueFromLink(links.snapshotItem(14).href)
         entryPoint = links.snapshotItem(8).parentNode.parentNode.parentNode.parentNode.parentNode;
      } else if (links.snapshotLength == 16) {
         //Old Table
         var goa = getValueFromLink(links.snapshotItem(9).href)
         var def = getValueFromLink(links.snapshotItem(13).href)
         var pla = getValueFromLink(links.snapshotItem(10).href)
         var win = getValueFromLink(links.snapshotItem(12).href)
         var pas = getValueFromLink(links.snapshotItem(11).href)
         var sco = getValueFromLink(links.snapshotItem(14).href)
         var sp = getValueFromLink(links.snapshotItem(15).href)
      ...
      if (!isGK) {
         ...
         valMaxSkillWage = calcMaxSkillWage(playerskills, currWAGE);
      } else {
      ...
      drawMessage(HTMLDocument, entryPoint, isGK, undef, injured, age > 27, maxSkill, valMaxSkillHigh, valMaxSkillAvg, valMaxSkillLow, valMaxSkillWage, limit)
   };
   ...
   searchPagePsicoTSI = function (HTMLDocument) {
      ...
      for (var i = 0, l = playerInfoDivs.snapshotLength; i < l; ++i) {
        ...
        var sta = parseInt(getValueFromLink(links.snapshotItem(3).href));

        var frm = parseInt(getValueFromLink(links.snapshotItem(2).href));
        var goa = parseInt(getValueFromLink(links.snapshotItem(4).href));
        var def = parseInt(getValueFromLink(links.snapshotItem(8).href));
        var pla = parseInt(getValueFromLink(links.snapshotItem(5).href));
        var win = parseInt(getValueFromLink(links.snapshotItem(7).href));
        var pas = parseInt(getValueFromLink(links.snapshotItem(6).href));
        var sco = parseInt(getValueFromLink(links.snapshotItem(9).href));
        var sp = parseInt(getValueFromLink(links.snapshotItem(10).href));

        var ageCell = contextNode.childNodes[9].childNodes[1].childNodes[3].rows[1].cells[1];
        var tsiCell = contextNode.childNodes[9].childNodes[1].childNodes[3].rows[2].cells[1];

        var age = parseInt(ageCell.textContent.replace(/[\s]*/gi, ""));
        var currTSI = parseInt(tsiCell.textContent.replace(/[\s]*/gi, ""));
   ...
   playersPagePsicoTSI = function (HTMLDocument) {
      ...
      for (var i = 0, l = playerInfoDivs.snapshotLength; i < l; ++i) {
        ...
        if (links.snapshotLength > 4) try {
            ...
            var sta = parseInt(getValueFromLink(links.snapshotItem(1).href));
            var frm = parseInt(getValueFromLink(links.snapshotItem(0).href));
            
            var goa, def, pla, win, pas, sco, sp;
            
            if (links.snapshotLength === 11) {     
              goa = parseInt(getValueFromLink(links.snapshotItem(4).href));
              def = parseInt(getValueFromLink(links.snapshotItem(5).href));
              pla = parseInt(getValueFromLink(links.snapshotItem(6).href));
              win = parseInt(getValueFromLink(links.snapshotItem(7).href));
              pas = parseInt(getValueFromLink(links.snapshotItem(8).href));
              sco = parseInt(getValueFromLink(links.snapshotItem(9).href));
              sp = parseInt(getValueFromLink(links.snapshotItem(10).href));
            } else if (links.snapshotLength === 12) {
              goa = parseInt(getValueFromLink(links.snapshotItem(5).href));
              def = parseInt(getValueFromLink(links.snapshotItem(9).href));
              pla = parseInt(getValueFromLink(links.snapshotItem(6).href));
              win = parseInt(getValueFromLink(links.snapshotItem(8).href));
              pas = parseInt(getValueFromLink(links.snapshotItem(7).href));
              sco = parseInt(getValueFromLink(links.snapshotItem(10).href));
              sp = parseInt(getValueFromLink(links.snapshotItem(11).href));
            } else {
              continue;
            }

            var ageAndTSIText = contextNode.childNodes[5].childNodes[0].textContent;
   ...
   drawMessage = function (HTMLDocument, entryPoint, isGK, isUndefinedMainskill, isInjured, isOld, maxSkill, valMaxSkillHigh, valMaxSkillAvg, valMaxSkillLow, valMaxSkillWage, limit) {
      ...
      if (!tableExists(HTMLDocument)) {
         ...
         td1.appendChild(img);
         td2.appendChild(HTMLDocument.createTextNode(STR_SKILL_NOT_AVAIL));
         tr.appendChild(td1);
         tr.appendChild(td2);
         ...
         td2.appendChild(HTMLDocument.createElement("br"));
         if (!isGK) {
            td2.appendChild(HTMLDocument.createTextNode(mainSkillText + " [" + STR_WAGE + "=" + HATTRICK_CURRENCIES[CURRENCY].shortname + "]=" + valMaxSkillWage));
            td2.appendChild(HTMLDocument.createElement("br"));
         }
         tr.appendChild(td1);
         tr.appendChild(td2);
      ...
      if (!SETT_HIDE_UNDER_SKILLS) {
         ...
         var optionDiv = HTMLDocument.createElement("div");
         ...
         var innerdivobj = HTMLDocument.createElement("div");
      ...
      if (SETT_PREF_LEFT) {
        ...
        if (!tableExists(HTMLDocument)) {
         ...
         if (!isGK) {
            var wageNGK = "[" + STR_WAGE + "=" + HATTRICK_CURRENCIES[CURRENCY].shortname + "]=" + valMaxSkillWage + "<br>";
         } else {
            var wageNGK = " ";
         }
   ...
   calcMaxSkillWage = function (playerskills, salary) {
      ...
      var sublevel = 0;
      var err = 10000;
      var newWAGE = simWage(level + sublevel, mainSkill, playerskills[1]);
      var cont = 0;
      while (err > 1 && cont < 100) {
         if (newWAGE > salary) {
            sublevel = sublevel - Math.pow(0.5, cont);
         ...
         newWAGE = simWage(level + sublevel, mainSkill, playerskills[1]);
   ...
   pub.main = function () {
      ...
      try {
         ...
         else if (SHOW_PSICOTSI_IN_PLAYERS_PAGE && isHattrickPlayersPage(href)) playersPagePsicoTSI(HTMLDocument);
      } catch(e) { 
        //GM_log(e)
      }
   };
