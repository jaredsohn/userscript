...
//125  =   }     126  =   ~
//
// A - Chat Grand Poobar 65
// B - Attack Boss 66
// C – logout 67
// D – Login as Ryna 68
// E - Sheild scroll x 6 69
// F – PvM 100% flee 70
// G - Swap to Star 71
// H - Swap to Ryna 72
// I – 1802 73
...
// Space - Hunting Rank PvM 40% flee
...
if (k == 66) {
    ...
    document.location.href = 'http://92.48.103.52/fantasy/game.php?username=Tzaryna&password=Delightful1&Submit=Submit';
  } if (k == 69) {
    document.location.href = 'http://92.48.103.52/fantasy/game.php?var1=Focus+Scroll&var2=6&var3=2884&Submit=GO&command=Transfer&screen=TRANSFER';
  } if (k == 70) {
    ...
    document.location.href = 'http://92.48.103.52/fantasy/game.php?command=swapcharacter&var1=15964';
  } if (k == 72) {
    document.location.href = 'http://92.48.103.52/fantasy/game.php?command=swapcharacter&var1=2884';
  } if (k == 73) {
    ...
    document.location.href = 'http://92.48.103.52/fantasy/game.php?var1=Lesser+Healing+Potion&var2=100&var3=2884&Submit=GO&command=Transfer&screen=TRANSFER';
  } if (k == 78) {
    ...
    document.location.href = 'http://92.48.103.52/fantasy/game.php?screen=CHAT&var2=15357';
  } if (k == 82) {
    ...
    document.location.href = 'http://92.48.103.52/fantasy/game.php?screen=CHAT&var2=4105';
  } if (k == 88) {
    document.location.href = 'http://92.48.103.52/fantasy/game.php?var1=Shield+Scroll&var2=6&var3=2884&Submit=GO&command=Transfer&screen=TRANSFER';
  } if (k == 89) {
    document.location.href = 'http://92.48.103.52/fantasy/game.php?var1=Lesser+Shield+Scroll&var2=6&var3=2884&Submit=GO&command=Transfer&screen=TRANSFER';
  } if (k == 90) {
    document.location.href = 'http://92.48.103.52/fantasy/game.php?var1=Lesser+Focus+Scroll&var2=6&var3=2884&Submit=GO&command=Transfer&screen=TRANSFER';
  } if (k == 49) {
    document.location.href = 'http://92.48.103.52/fantasy/game.php?var5=2884&var1=Lesser+Shield+Scroll&command=use&screen=SCROLLS';
  } if (k == 50) {
    document.location.href = 'http://92.48.103.52/fantasy/game.php?var5=2884&var1=Lesser+Focus+Scroll&command=use&screen=SCROLLS';
  } if (k == 51) {
    document.location.href = 'http://92.48.103.52/fantasy/game.php?var5=2884&var1=Summon+Skeleton&command=use&screen=SCROLLS';
  } if (k == 52) {
    document.location.href = 'http://92.48.103.52/fantasy/game.php?var5=2884&var1=Shield+Scroll&command=use&screen=SCROLLS';
  } if (k == 53) {
    document.location.href = 'http://92.48.103.52/fantasy/game.php?var5=2884&var1=Focus+Scroll&command=use&screen=SCROLLS';
  } if (k == 54) {
    ...
    document.location.href = 'http://92.48.103.52/fantasy/game.php?screen=PVP&command=Attack&var1=11558';
  } if (k == 32) {
