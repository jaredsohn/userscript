// ==UserScript==
// @name            Stats Formatting
// @namespace       Dead Awaken - Stats Formatting
// @include         http://www.deadawaken.com/game.php?sec=train&scr=statstore&r=*
// ==UserScript==
function do_platypus_script() {
html_insert_it(window.document,document.evaluate('/HTML[1]/BODY[1]/DIV[1]/DIV[6]/DIV[1]/TABLE[1]/TBODY[1]/TR[1]/TD[1]/A[1]/B[1]', document, null, XPathResult.FIRST_ORDERED_NODE_TYPE,null).singleNodeValue,'<br>',false,false);
html_insert_it(window.document,document.evaluate('/HTML[1]/BODY[1]/DIV[1]/DIV[6]/DIV[1]/TABLE[1]/TBODY[1]/TR[1]/TD[1]/A[2]/B[1]', document, null, XPathResult.FIRST_ORDERED_NODE_TYPE,null).singleNodeValue,'<br>',false,false);
html_insert_it(window.document,document.evaluate('/HTML[1]/BODY[1]/DIV[1]/DIV[6]/DIV[1]/TABLE[1]/TBODY[1]/TR[1]/TD[1]/A[3]/B[1]', document, null, XPathResult.FIRST_ORDERED_NODE_TYPE,null).singleNodeValue,'<br>',false,false);
html_insert_it(window.document,document.evaluate('/HTML[1]/BODY[1]/DIV[1]/DIV[6]/DIV[1]/TABLE[1]/TBODY[1]/TR[1]/TD[1]/A[4]/B[1]', document, null, XPathResult.FIRST_ORDERED_NODE_TYPE,null).singleNodeValue,'<br>',false,false);
html_insert_it(window.document,document.evaluate('/HTML[1]/BODY[1]/DIV[1]/DIV[6]/DIV[1]/TABLE[1]/TBODY[1]/TR[1]/TD[1]/A[5]/B[1]', document, null, XPathResult.FIRST_ORDERED_NODE_TYPE,null).singleNodeValue,'<br>',false,false);
