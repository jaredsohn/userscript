// ==UserScript==
// @name           Kyo KOC Throne Room Organizer
// @version        20140313b
// @namespace      We Do Not Forgive We do not forget Expect us all
// @homepage       https://userscripts.org/scripts/show/411206
// @delay 2000
// @priority -10
// @include        *.kingdomsofcamelot.com/*main_src.php*
// @include        *kabam.com/kingdoms-of-camelot/play*
// @resource       jqcss http://code.jquery.com/ui/1.9.2/themes/base/jquery-ui.css
// @updateURL      https://userscripts.org/scripts/show/411206.js
// @downloadURL    http://userscripts.org/scripts/show/411206.js
...
Tabs.organizer = {
        ...
        init : function (div){
            ...
            m += "<tr align=center valign=top><th width=10%>Chairs</th><th width=10%>Tables</th><th width=10%>Windows</th><th width=10%>Banners</th><th width=10%>Advisors</th><th width=10%>Throphies</th><th width=10%>Candelabra</th><th width=10%>Heroes</th><th width=10%>Statues</th><th width=10%>Pet</th></tr>";
            m += '</table></div>';
            m += '</div>';
            m += '</div>';
            t.myDiv.innerHTML = m;
                                        ...
                                        uW.g_js_strings ?uW.g_js_strings.throneRoom.epic : "Epic",
                                                ...
                                                doEnhance : function(eItem) {
                                                    ...
                                                    try {
                                                        ...
                                                        params.buffItemId = 0;
//lesser protection stone, use on rare and higher
        if(parseInt(unsafeWindow.seed.items['i20001'])>0  && y.quality > 2) {
            params.buffItemId = 20001;
            unsafeWindow.cm.InventoryView.removeItemFromInventory(20001);
 }
                                                        params.cityId = Seed.cities[num_city][0];
