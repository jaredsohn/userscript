// ==UserScript==
// @name          Misc CB2 Enhancements
// @namespace     http://www.defhoboz.biz/
// @description   CB Enhancements Script
...
Misc CB2 Enhancements user script
Version 3.47
12/10/07
Copyright (c) 2006 & 2007, Brendan Crosser-McGay
verifex@gmail.com
...
----------------------------------------------------------------
v3.47
-Fixed training page calculation

v3.46
-Fixed pages (forge, training, home) to work with new template system

v3.45
-Fixed forge link (thanks sooka)
-Changed auto-update checking

v3.44
-Added new gui to compose reply in forums
-Fixed sound toggle
-Fixed link/refresh links on home page
-Changed getElem to $
-Changed many dom access operations to use XPath

v3.43
-Added refresh link on homepage
-Added link to char page on home page
-Changed formulas to work
-Changed forging to save every step (thanks Mian!)
-Changed forum code to "hopefully" not need tweaking for a long time
-Added botcheck alarm w/Toggle

v3.42
-Fixed Enforcer's xbow damage formula

v3.41 (Thanks for the patch Mian)
-Fixed forging formulas
-Fixed forum sorting

v3.40 (Thanks again Mian!)
-Added Mageseeker formula
-Forging formula calculations changed to only use 2 numbers
-Refresh button added to home page
-Code optimizations
-New functions added
--getPic (retreive base64 encoded pictures)
--buildStateFunc (build JS code for button changing logic)
--repeatStr (repeat a string X number of times)
--childNoder (childNode builder, for slimming down code)

v3.30 (Thanks Miandrital!)
-Added save current forge step
-Fixed Amulet of AC formula
-Changed active threads page
-Changed training page with more info

v3.20
-Added Fight Pane toggle (For Ranger)
-Fixed transfer log links
-Added more auction links to transfer log

----------------------------------------------------------------
   Thanks goes out to the following people for their support!
----------------------------------------------------------------
...
function getPrefs(){
  if (typeof prefs == "undefined") {
    ...
    var defaultpref=pane_x+"px|"+pane_y+"px|1|0|1|1|1|0|PBP: OnLose|Posts: New|Advance: On|0|1"
