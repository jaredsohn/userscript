...
//
// ==UserScript==
// @name           DS Premium Features
// @namespace      http://ch1.ds.ingames.net
// @description    Premium-Features fuer Die-Staemme, allerdings noch in der Anfangsphase.
// @include        http://ch1.ds.ignames.net/staemme.php?*
// @include        http://ch1.ds.ignames.net/game.php?*
// @include        http://ch1.ds.ignames.net/forum.php*
...
window.createQuickbarShortcuts = function() {
	"<tr>   " + 
	newShortcut("http://nl1.tribalwars.nl/graphic/ally_rights/found.png", "http://en1.tribalwarsmap.com/nl/?x=53&y=408", "Extern Map");
	newShortcut("http://nl1.tribalwars.nl/graphic/new_mail.png", "/game.php?village="+VillId+"&screen=mail&mode=new", "New Mail");
	newShortcut("http://nl1.tribalwars.nl/graphic/ally_forum.png", "/game.php?village="+VillId+"&screen=ally&mode=forum", "Ally Forum");
	newShortcut("http://www.tribalwars.nl/graphic/rabe.png", "http://en.twstats.com", "TWStats");
	newShortcut("http://www.kenniscentrumsv.nl/gfx/but_text_plus.gif", "http://en1.twplus.org/world/", "TWPlus");
	newShortcut("http://img212.imageshack.us/img212/1788/scripticonxz8.png", "http://userscripts.org/scripts/search?q=tribalwars", "UserScripts.org");
	tableIdIndex++;
	trIdIndex++;
}