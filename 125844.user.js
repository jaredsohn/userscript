// ==UserScript==
// @name           Feuerwache.net nextGen Ereglam's AAO Edit by Tobias1992
...
// @description    Alarm- und Ausrückordnung, sowie weitere Tools für das Browserspiel Feuerwache.net für die Beta Welten
// @require        http://userscripts.org/scripts/source/121220.user.js
// @require        http://userscripts.org/scripts/source/121239.user.js
// @icon           http://www.beta.feuerwache.net/favicon.ico
// @include        http://www.beta.feuerwache.net/*
// @exclude        http://www.beta.feuerwache.net/forum/*
// @author         Ereglam/Edittiert bei Tobias1992
// @info           komplete Neuentwicklung auf Basis von Ereglam's AAO Edit by Tobias1992
// @version        1.1.5
// ==/UserScript==
const VERSION      = '1.1.5'
versions['Feuerwache.net nextGen Ereglam\'s AAO Edit by Tobias1992'] = VERSION;
/* ******************************************************************************************
ACHTUNG
...
WENN DU DIESEN ABSCHNITT NICHT 100% VERSTANDEN UND BEFOLGT HAST, STELLE DAS GEÄNDERTE SCRIPT NICHT ONLINE!
   ******************************************************************************************/
const USERSCRIPTID = '274529'; // diese Konstante ist anzupassen
...
*/
  ...
  'Feuer im Personenzug (Tunnel)'  : {mld: 'F3S+GWL'                     , storm: false, ab: {FW: 65}, wiki: 'Feuer_im_Personenzug_(Tunnel)'},
  'Brand in Fahrkartenautomat'     : {mld: 'F1'                          , storm: false, ab: {FW: 65}, wiki: 'Brand_in_Fahrkartenautomat'},
  ...
  'Güterzug entgleist (Bahnhof)'   : {mld: 'TH3GG+LF/HLFS,LF/HLFS,LF/HLFS/TS/TLF+GWS', storm: false, ab: {FW: 65}, wiki: 'G%C3%BCterzug_entgleist_(Bahnhof)'},
  'Rangierunfall'                  : {mld: 'TH3+GWS,GWÖl'                , storm: false, ab: {FW: 65}, wiki: 'Rangierunfall'},
  ...
  'Brand im Casino'                : {mld: 'F4L+LF/HLFS,GTLF,GWA,GWL|LF/HLFS,LF/HLFS,LF/HLFS', storm: false, ab: {FW: 50}, wiki: 'Brand_in_Casino'},
  ...
  'Brand in Betankungsanlage'      : {mld: 'F5RG+GWA|LF/HLFS/ULF'        , storm: false, ab: {FW: 64}, wiki: 'Brand_in_Betankungsanlage'},
  ...
  'Brand in Eishalle'              : {mld: 'TH2+LF/HLFS,GTLF,ELW,DLK,GWL', storm: false, ab: {FW:  5}, wiki: 'Brand_in_Eishalle'},
  'Brand in Gärtnerei'             : {mld: 'GSG+DLK'                     , storm: false, ab: {FW:  8}, wiki: 'Brand_in_G%C3%A4rtnerei'},
  ...
  'Brand in Kühlhaus'              : {mld: 'GSG+DLK,GWL|LF/HLFS,LF/HLFS' , storm: false, ab: {FW: 20}, wiki: 'Brand_in_K%C3%BChlhaus'},
  ...
  'Brand in Lackfabrik'            : {mld: 'GSG2'                        , storm: false, ab: {FW: 25}, wiki: 'Brand_in_Lackfabrik'},
  'Brand in Metzgerei'             : {mld: 'F3+DLK,GWL'                  , storm: false, ab: {BF:  2}, wiki: 'Brand_in_Metzgerei'},
  'Brand in Raffinerie'            : {mld: 'F5RG+DLK,FwK,TUIS|LF/HLFS/ULF,LF/HLFS/ULF', storm: false, ab: {FW: 64}, wiki: 'Brand_in_Raffinerie'},
  'Brand in Reifenlager'           : {mld: 'GSG+GWL|LF/HLFS,LF/HLFS'     , storm: false, ab: {FW: 20}, wiki: 'Brand_in_Reifenlager'},
  'Brand in Schloss'               : {mld: 'F3L'                         , storm: false, ab: {FW: 20}, wiki: 'Brand_in_Schloss'},
  ...
  'Brennender Güterzug'            : {mld: 'F1S+ELW,GWG,GWM,GWL,TUIS'    , storm: false, ab: {FW: 65}, wiki: 'Brennender_G%C3%BCterzug'      },
  'Brennender LKW'                 : {mld: 'F1|ELW,TUIS'                 , storm: false, ab: {FW:  1}, wiki: 'Brennender_LKW'},
  ...
  'Chemieunfall (an Schule)'       : {mld: 'GSG'                         , storm: false, ab: {BF:  2}, wiki: 'Chemieunfall_(an_Schule)'},
  'Chlorgas Alarm (Schwimmbad)'    : {mld: 'GSG+RW'                      , storm: false, ab: {BF:  3}, wiki: 'Chlorgas_Alarm_(Schwimmbad)'},
  ...
  'Feuer im Personenzug'           : {mld: 'F1S+ELW,GWL,TLF'             , storm: false, ab: {FW: 65}, wiki: 'Feuer_im_Personenzug'},
  'Güterzug entgleist'             : {mld: 'THS+ELW,DLK,RW,GWS,GWG,GWM,TUIS', storm: false, ab: {FW: 65}, wiki: 'G%C3%BCterzug_entgleist'},
  ...
  'Gefahrstoff-Austritt in Firma'  : {mld: 'GSG+GWA,GWL|LF/HLFS,TUIS'    , storm: false, ab: {FW: 40, BF: 2}, wiki: 'Gefahrstoff-Austritt_in_Firma' },
  ...
  'Kioskbrand'                     : {mld: 'F1'                          , storm: false, ab: {FW:  2}, wiki: 'Kioskbrand'},
  ...
  'Unfall mit Gefahrgut-Transport' : {mld: 'TH2GG+GWA|TUIS'              , storm: false, ab: {FW: 40, BF: 2}, wiki: 'Unfall_mit_Gefahrgut-Transport'},
  ...
  'Wohnblockbrand'                 : {mld: 'F4+LF/HLFS,GWA|LF/HLFS,LF/HLFS', storm: false, ab: {FW: 45}, wiki: 'Wohnblockbrand'},
...
*/
  'F1Gr'     :  {txt: 'Feuer, klein',                    vhc: 'LF/HLFS/TS'},
  ...
  'F3G'      :  {txt: 'Feuer, mittelgroß, Gefahrgut',    vhc: 'LF/HLFS,LF/HLFS,LF/HLFS/TS/TLF,ELW,RW,GWM,GWG'},
  ...
  'F5R'      :  {txt: 'Großbrand, Raffinerie',           vhc: 'LF/HLFS/ULF,LF/HLFS/ULF,LF/HLFS/ULF,LF/HLFS/ULF,LF/HLFS/ULF/TS/TLF,ELW'},
  'F5RG'     :  {txt: 'Großbrand, Raffinerie, Gefahrgut',vhc: 'LF/HLFS/ULF,LF/HLFS/ULF,LF/HLFS/ULF,LF/HLFS/ULF,LF/HLFS/ULF/TS/TLF,ELW,RW,GTLF,GWL,GWM,GWG'},
  'F1S'      :  {txt: 'Feuer, klein, Bahn',              vhc: 'LF/HLFS/TS/TLF'},
  'F3S'      :  {txt: 'Feuer, mittelgroß, Bahn',         vhc: 'HLFS,HLFS,HLFS,ELW'},
  'F4S'      :  {txt: 'Feuer, groß, Bahn',               vhc: 'HLFS,HLFS,HLFS,HLFS,ELW'},
  ...
  'TH2GG'    :  {txt: 'erw. techn. Hilfel. - Gefahrgut', vhc: 'LF/HLFS,LF/HLFS/TS/TLF,ELW,RW,FwK,GWG,GWM'},
  'TH3GG'    :  {txt: 'gr. techn. Hilfel. - Gefahrgut',  vhc: 'LF/HLFS,LF/HLFS/TS/TLF,LF/HLFS/TS/TLF,ELW,RW,FwK,GWG,GWM'},
  'THS'      :  {txt: 'einf. techn. Hilfel., Bahn',      vhc: 'LF/HLFS/TS/TLF'},
  'TH2S'     :  {txt: 'erw. techn. Hilfel., Bahn',       vhc: 'LF/HLFS,LF/HLFS/TS/TLF'},
  'TH3S'     :  {txt: 'große techn. Hilfel., Bahn',      vhc: 'ELW,RW,GWS,LF/HLFS,LF/HLFS,LF/HLFS/TS/TLF'},
  'RTZ'      :  {txt: 'Rettungszug',                     vhc: 'LF/HLFS,LF/HLFS,LF/HLFS,LF/HLFS'},
  'GSG'      :  {txt: 'Gefahrguteinsatz',                vhc: 'LF/HLFS,LF/HLFS,LF/HLFS/TS/TLF,ELW,GWM,GWG'},
  'GSG2'     :  {txt: 'erw. Gefahrguteinsatz',           vhc: 'LF/HLFS,LF/HLFS,LF/HLFS,LF/HLFS/TS/TLF,ELW,GWM,GWG,DLK,GWA'},
...
var locationLst = {
  ...
  'Bahnlinie': {text: 'Bahnlinie', from: {x:   1, y: 152}, to: {x: 100, y: 152}},
  ...
  'Neustadt': {text: 'Neustadt', from: {x:   1, y: 101}, to: {x: 100, y: 200}},
}
...
{ var station = conf.stationList.getStation(iNum);
  ...
  var name = '';
  var evalText = xPath.getNodes("./text()", nodeH1);
  for (iTxt = 0; iTxt < evalText.snapshotLength; iTxt++)
  { var nodeText = evalText.snapshotItem(iTxt).nodeValue.trim();
...
{ function cntListCls()
  { var list = {};
    ...
    { for (fGrp in list)
      { fGrp.toString()+': cnt = '+cnt+'; free = '+free;
      }
    }
  }
  ...
  { var stations = {};
    ...
    { for each(nodeItem in cnt.getNodes())
      { if (!nodeItem.isClicked())
        ...
        { switch(true)
          { case fhz.needsTraining():
              if (nodeItem.getFhzGrp() == conf.specFGrp.rtw.getName() && conf.getOptVal('limitRTWcall'))
              { if (nodeItem.getTime().getSeconds() > (parseInt(conf.getOptVal('limitRTWcallMin')) * 60) && !userSel)
  ...
  { // Tabelle mit Einsatzinformationen
    ...
    { // in erster Tabelle zu 'Rückmeldungen und Fakten' die Zeile mit der Position finden
      ...
      { var [posX, posY] = node.innerHTML.replace(/Andere Stadt -[\s|  ]*/, '').split(' - ');
        node.alt = getAreaDescription(parseInt(posX.trim()), parseInt(posY.trim()));
        if (parseInt(posY.trim()) > 100 && conf.getOptVal('highlightCityExtension'))
        { node.style.color = conf.getOptVal('highlightCityExtColour');
        }

        if (conf.getOptVal('addLocationDescription'))
        { node.parentNode.appendChild(createText(': ' + node.alt));
        }
      }
    }
...
Die gültigen Fahrzeuggruppen seht Ihr unter "));
  ...
  cell = row.getNewCell({'style': 'width: 130px;',
                         'title': 'zusätzliche Fahrzeuggruppen'}, true);
  cell.addText('zus. Fahrz.');

  // optionale Fahrzuege
  cell = row.getNewCell({'style': 'width: 130px;',
                         'title': 'optionale Fahrzeuggruppen'}, true);
  ...
  { row = new tableRowCls();
    ...
    var nodeSel = new Element('select',
                              {'class': 'fontSmall',
                               'style': 'width: 200px;',
                               'id'   : 'sel.' + mld.getName(),
                               'title': 'Tooltipp in Liste zeigt Fahrzeuggruppen'});
...
Das eigene Anlegen von Alarmierungsstichworten ist (noch) nicht möglich."));
  ...
  cell = row.getNewCell({'style': 'width: 250px;',
                         'colspan' : '2',
                         'title': 'zu alarmierende Fahrzeuggruppen zum Stichwort'}, true);
