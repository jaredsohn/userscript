/*
	FriendFeedHolic Tab
	Get FFholic.com content on a custom FriendFeed Tab
	code modified from http://ffapps.com/tabs/
*/

// ==UserScript==
// @name           FriendFeedHolic Tab
// @namespace      http://www.ffholic.com
// @description    Add FriendFeedHolic Tab to FriendFeed
...
(function() {
  ...
  autoUpdateFromUserscriptsDotOrg({
    name: 'FriendFeedHolic Tab',
		url: 'http://userscripts.org/scripts/source/33579.user.js',
		version: ffrb_version,
	});

  function FFholic_setup() {
		$('.settings').find('.l_tab:last').after('<td class="l_tab" style="padding-left: 10px;" id="tdtabtm"><div class="rounded bb" id="tabtm"><div class="t"><div class="l"><div class="r"><div class="tl"><div class="tr"><div class="body"><a id="tab-link-FFholic" href="#"><img src="http://www.ffholic.com/favicon.ico" align="absmiddle"> FriendFeedHolic</a></div></div></div></div></div></div></div></td>');
    $('#tab-link-FFholic').click(function() {
			$('#subtabs').hide();
			$('#body').css("height","100%").html('<div class=iframe style="width:100%;height:100%;"><iframe id="content_iframe" marginWidth=0 marginHeight=0 src="http://www.ffholic.com" frameBorder=0 style="width:100%;height:100%;overflow:auto;"></iframe></div>');
