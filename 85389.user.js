// ==UserScript==
// @name           Zabilješke za Basketsim igru(Samo Droxi :)
// @creator        Alijansa
// @namespace      http://www.basketsim.com
// @description    Zabilješke za Basketsim igru-Droxi
// @version        1.0
...
/* Insert CSS */
  ...
  menuCode.push("#gm_notebook {-moz-opacity:0.9;position:fixed;bottom:40px;right:5px;border:1px solid #ccc;font-size:10px;color:#333;background:#f1f1f1;padding:3px 5px 5px 5px;font-family:Arial,sans-serif}#gm_notebook a {color:#4AA02C;margin:2px;cursor:pointer}");
  menuCode.push("#gm_tobehiden {display:none;width:250px;height:450px;padding:5px}");  // Change display to block to show the notebook by default 
