...
// @description    はてなダイアリーの記事編集のページに[校正する]ボタンを追加する
...
(function(){
  ...
  'load',
  function() {
    var kakunin=document.getElementsByName("preview")[0];
    cnt++;
    if (kakunin && (cnt == 1)) {
      ...
      kousei.addEventListener('click',function() {
        var sendText = "TcheckON" + document.getElementsByName("title")[0].value;
