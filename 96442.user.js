...
// @require        http://sizzlemctwizzle.com/updater.php?id=96442
// ==/UserScript==
...
var Version = '0.2.7';
var Versiondate = '08.02.2011';
var Scriptname = 'KOC PhoenixTools';
...
Tabs.board = {
  ...
  myDiv : null,
  timer : null,
  forumlink :  'https://voxli.com/templier',  
  
  init : function (div){    // called once, upon script startup
    var t = Tabs.board;
    t.myDiv = div;
    div.innerHTML = '<CENTER><iframe src="'+ t.forumlink +'" width="100%" height="550" name="board_in_a_box" <p>Ihr Browser kann leider keine eingebetteten Frames anzeigen: Sie k&ouml;nnen die eingebettete Seite &uuml;ber den folgenden Verweis aufrufen: <a href="'+ t.forumlink +'">Vox Des Templiers</a></p> </iframe> <BR></center>';
  },
