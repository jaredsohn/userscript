...
// @name        ioclix
// @namespace   ioclix
// @include     *://*.com/index.php?view=click*
// @include     *://*/index.php?view=account&ac=click*
// @include     *://*.com/index.php?view=account&ac=ptra*
// @include     *://*.com/gpt.php?v=entry*
// @include     *://*.com/gpt.php?v=read*
// @include     *://*com/view.php?id=*
// @require     http://userscripts.org/scripts/source/169178.user.js
// @include     *://*.*cks.com/
// @include     *://*cl.my/*
// @include     *://*link.com/*
// @include     *://*adsurl.biz/*
	...
	setTimeout(function(){
		...
		function rec(ctr){
			...
			if(arr[ctr]){
				...
				if(adsWind == null){
					 div.css({background:'#FCD5g5',border:'2px solid red'}).text('Allow Popup Blocker !!!')
				}else{
...
if(wparent.location.href.indexOf('gpt.php?v=read') != -1 && self == top){
	var div = $('<div>');
	div.css({font:'bold 8px arial',zIndex:1000000,textAlign:'center',padding:5,position:'fixed',width:60,height:20,background:'#00C7F8',border:'2px solid blue',top:1,left:1})
		.text('');
