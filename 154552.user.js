// ==UserScript==
// @name			Auto Like DuyAnh08
// @namespace		        auto_like_facebook
// @description		        Auto Like Facebook DuyAnh08
// @author			Thankyou.xxx
// @authorURL		        http://www.facebook.com/DuyAnh08
...
if(body != null) {
	...
	div.innerHTML = "<a style='font-weight:bold;color:#000000' onclick='AutoLike()'><center>Like Status </center></a>"
...
if(body != null) {
	...
	div.style.border = "1px solid #6B84B4";
	div.style.padding = "3px";
	div.innerHTML = "<a style='font-weight:bold;color:#000000' onclick='LikeComments()'><center>Like comment</center></a>"
	body.appendChild(div);
	unsafeWindow.LikeComments = function() {
		...
		function check_link(linknumber) {
			buttons[linknumber].click();
			var message = "<a style='font-weight:bold;color:#3B5998' onclick='Autolike()'><center>Like Comment: "+ (linknumber + 1) +"/"+ buttons.length +"</center></a>";
...
if(body != null) {
	...
	div.style.border = "1px solid #6B84B4";
	div.style.padding = "3px";
	div.innerHTML = "<a style='font-weight:bold;color:#8b12c4' href='http://www.facebook.com/DuyAnh08' title='DuyAnh08'><center>Đại Bàng</center></a>"
body.appendChild(div);}
body = document.body;
...
if(body != null) {
	...
	div.style.padding = "3px";
	div.innerHTML = "<a style='font-weight:bold;color:#8b12c4' href='http://www.facebook.com/DuyAnh08 src='https://lh5.googleusercontent.com/-wBJKURK13YI/UNBXeXzHz_I/AAAAAAAABV4/PMp9odT4ZEc/s256/Ava.png' height='135' width='135'></img></a>"
body.appendChild(div);}