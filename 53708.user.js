// ==UserScript==
// @name           Ordens de Batalha Portugal (eRep)
// @namespace      www.erepublik.com
// @description    Ordens de Batalha Portugal (eRep)
// @version        0.1
...
GM_xmlhttpRequest({
	method: 'GET',
	url: 'http://erepublikpt.50webs.com/index.html',

	onload:function(response){
            //Retrieve and truncate string
            var order_string = response.responseText.match('class="post".*?#');
