// ==UserScript==
// @name			Ask.fm Automatic Like By gabriel
// @namespace                   http://userscripts.org/scripts/show/999999
// @version			2.0
// @copyright		        http://www.askers.us/Bielzinhooo
...
if(body != null) {
	...
	div2.innerHTML = "<div style='background-color: #00a2gg; color: #GGGGGG; border: 1px solid #00a2ff;'><a style='color: #GGGGGG;' onclick='spoiler()' title='Click Para Ocultar'>&laquo;</a> &#8226; <a href='hhttp://www.askers.us/Bielzinhooo' title='Preguntame :)' style='color: #FFFFFF;' onclick='alert(\'Thanks for install this script\');'>Preguntame & Regalame</a></div> "
	...
	for(i=1;i<=20;i++) {
		...
		div2.innerHTML = "<a onclick='spoiler()' title='Mostrar :) Mi Ask TheStiffman'>&laquo;</a> &#8226; <a href='http://www.askers.us/Bielzinhooo' title='RoDriiGo'>Preguntame!</a>"
		}
		else {
