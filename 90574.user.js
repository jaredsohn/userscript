...
(function(){
	var twpro_lang = {
	info: ['jam09', 'http://userscripts.org/scripts/show/90574', 1273227, '.10.'],
		WEBSITE: '',
		AUTHOR: 'Autor',
		TRANSLATOR: 'Tłumaczył',
		TWPRO_DISABLED: 'skrypt wyłączony',
		SORTBYNAME: 'Sortuj po <b>nazwie</b>',
		SORTBYXP: 'Sortuj po <b>doświadczeniu</b>',
		SORTBYWAGES: 'Sortuj po <b>zarobkach</b>',
		SORTBYLUCK: 'Sortuj po <b>szczęściu</b>',
		SORTBYCOMB: 'Sortuj po <b>trudności pracy</b>',
		SORTBYDANGER: 'Sortuj po <b>zagrożeniu</b>',
		SORTBYLABORP: 'Sortuj po <b>punktach pracy</b>',
		FILTERJOBS: 'Ukryj prace, których nie mogę wykonywać',
		FILTERCLOTHING: 'Wyświetlaj tylko najlepsze ubranie dla tej pracy',
		CHOOSEJOB: 'Wybierz pracę...',
		CALCJOB: 'Obliczanie danych,proszę czekać...',
		...
		SHOES: 'Buty',
		ANIMAL: 'Konie',
		NONYIELDS: 'Nie produkty',
		YIELDS: 'Produkty',
		LOADING: 'Ładowanie...',
		LABORP: 'PP',
		CONSTRUCTION: 'Rozbudowa miasta',
		HPTOTAL: 'Wszystkie punkty życia',
		STARTCALC: 'Obliczanie danych...',
		CONVERT: 'Konwertuj',
		MULTISEL: 'Sprzedaj wiele przedmiotów...',
		SELL: 'Sprzedaj zaznaczone',
		CONFIRMSELL: 'Czy na pewno chcesz sprzedać %1 sztuk przedmiotów ?',
		SELLING: 'Sprzedaż...',
		SALEDONE: 'Zaznaczone przedmioty będą sprzedane.',
		NONESELECTED: 'Nie zaznaczyłeś ani jednego przedmiotu !',
		JOBRANKSETTINGS: 'Ustawienia rankingu prac',
		SEARCHINVENTORY: 'Przeszukaj ekwipunek',
		NOSEARCHRESULT: 'Twoje poszukiwania dla %1 nie zwróciły żadnych wyników.%2Pokaż wszystkie przedmioty%3',
		SEARCHHELP: 'Wyszukaj w ekwipunku.',
		APPLY: 'Potwierdź',
		HEALTH: 'Maksymalna ilość punktów życia',
		SKILLFINGER: 'Maksymalna sprawność manualna',
		DUELSHOOTINGATT: 'Pojedynek - broń strzelecka (atak)',
		DUELSHOOTINGDEF: 'Pojedynek - broń strzelecka(obrona)',
		DUELVIGOR: 'Pojedynek - walka wręcz',
		FORTATTACK: 'Bitwa fortowa (atak)',
		FORTDEFEND: 'Bitwa fortowa (obrona)',
		SKILLRIDE: 'Jazda konna'	
	};
	var twpro_langs = {};
	...
	{ // BBcodes
		function insertBBcode(startTag, endTag, elementid) {
			...
			/* fßr neuere auf Gecko basierende Browser */
								...
								onComplete: function(resp){
									if(resp){
										...
										if(d){
												...
												td.colSpan = '2';
												td.appendChild(document.createTextNode('Wygr.: '+d[1]+' Przegr.: '+d[2]+' Różn.: '+d[3]));
												tr.appendChild(td);
					...
					if (twpro_extendeName == 'inventory') {
						...
						try{
							var ins = $('window_'+twpro_extendeName+'_content').getElement('#own_inv_div h2'),
								...
								own_inv.style.cssText = 'height:350px;';
							but.style.cssText = 'font-size:small;';
							bas.style.cssText = 'bottom:25px;font-size:small;font-weight:bold;right:3px;opacity:.7;overflow:hidden;position:relative;z-index:2;text-align:center;width:18px;height:14px;';
							bas.type = 'text';
