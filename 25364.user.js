// ==UserScript==
// @name            Travianer Bonus Buttons
// @namespace       Platypus
// @include         http://travianer.de/game.php
function do_platypus_script() {
html_insert_it(window.document,document.evaluate('/HTML[1]/BODY[1]/TABLE[1]', document, null, XPathResult.FIRST_ORDERED_NODE_TYPE,null).singleNodeValue,'<div style="background-image:url(http://travianer.de/img/hihaholz.gif);"><img src="img/icons/Icon_friendtree.gif"><a href="" onclick='xajax_showModule("friendtree","buddylist","0"); closeUserMenu(); return false;'>Freundesliste</a><img src="img/icons/Icon_attributes.gif"><a href="" onclick='xajax_showModule("attributes","attributes","209650"); closeUserMenu(); return false;'>Attribute</a><img src="img/icons/Icon_inventory.gif"><a href="" onclick='xajax_showModule("inventory","209650",""); closeUserMenu(); return false;'>Ausrüstung</a><img src="img/icons/Icon_friendtree.gif"><a href="" onclick='xajax_showModule("friendtree","buddylist","0"); closeUserMenu(); return false;'>Freundesliste</a><img src="img/icons/Icon_mail.gif"><a href="" onclick='xajax_showModule("blogs","news","209650"); closeUserMenu(); return false;'>Blog</a><img src="img/icons/Icon_minigame.gif"><a href="" onclick='xajax_showModule("profile","show","209650-games"); closeUserMenu(); return false;'>Spielestatistik</a><img src="img/icons/Icon_questlog.gif"><a href="" onclick='xajax_showModule("questlog","",""); closeUserMenu(); return false;'>Tagebuch</a></div>',false,false);
