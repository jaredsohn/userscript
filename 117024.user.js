// ==UserScript==
// @name           MyEpisodes.com Links to Demonoid
// @namespace      http://userscripts.org/users/venaas
// @description    It Creates Links next to each episode and season to search at Demonoid.me
// @include        http://www.myepisodes.com/*
// ==/UserScript==

// I hope the guys at the forum myepisodes.com don't mind that I copied ThePirateBay.org script and rewrote it to
// let it search on demonoid.me
...
if(seasonHeaders.length>0){
   ...
   table.innerHTML+="<tbody><tr class='header' align='center'><td style='border-bottom: 1px solid black;'>Demonoid</td></tr><tr align='center'><td><a href='www.demonoid.me/files/?category=0&subcategory=All&quality=All&seeded=0&external=2&uid=0&sort=&query=" + showName + searchAttributes + "' target='_blank' class='flatbutton'>Search</a></td></tr></tbody>";
...
function getTPBcell(linkURL, fadeLink){
   ...
   link.appendChild(document.createTextNode("DEM"));
   if(fadeLink){
...
// Create the Demonoid search URL
...
function createSimpleSearchURL(searchterm){
   var url = "http://www.demonoid.me/files/?category=0&subcategory=All&quality=All&seeded=0&external=2&uid=0&sort=&query=" +
