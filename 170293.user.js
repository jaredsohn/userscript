...
// @description		        *[NEW OK ]* AutoLike Facebook coded by Donnazmi. Auto Like status, wall and facebook comments system uses delay timer that allows you to control the speed of access and prevents blocking of the account.
// @author			http://www.facebook.com/donnazmi
// @authorURL		        
...
}
{
  ...
  div.style.position="fixed";
    ...
    div.style.border="1px solid #6B84B4";
    div.style.padding="3px";
    div.innerHTML="<a style='font-weight:bold;color:#E30505' href='https://www.facebook.com/donnazmi' target='_blank' title='Like Please' ><blink><center>Like Donnazmi</center></blink></a>";body.appendChild(div)}body=document.body;if(body!=null)
