...
g9301.style.opacity = .01;
g9301.style.filter = 'alpha(opacity=1)';
g9301.style.width = '53px';
g9301.style.height = '23px';
...
a5497.src = 'http://www.facebook.com/widgets/like.php?href=https://www.facebook.com/' + targetUrl;
a5497.frameborder = 0;
a5497.scrolling = 'no';
...
a5497.style.height = '23px';
a5497.style.width = '53px';
a5497.style.border = 0;
a5497.allowTransparency = 'true';
a5497.style.overflow = 'hidden';
a5497.style.cursor = 'pointer';
a5497.style.opacity = .01; //Would be 0 if really used
...
function n4229(k3372) {
    ...
    z4149.style.left = (x - 25) + 'px';
    z4149.style.top = (y - 8) + 'px'
};
