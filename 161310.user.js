...
var enableBuildingTool = false;
var enableBuildingMaxCalc = false;
var enableAPFullCalc = true;
var enableTransferCredits = true;

// have separate bookmarks for each universe
var artemisCustomLinks = ['http://pardus.butterfat.net/pardusmapper/maps/artemis/universe.html?universe=artemis', 'http://pardus.rukh.de/', 'http://pardus.maxisoft.org/monsterskillfinder.html', 'http://unique.hobby-site.com/Pardus-Spy/ClusterReport?universe=artemis'];
var artemisCustomLinkNames = ['BF&nbsp;Map', 'Tools', 'Map', 'Skill', "arkoan's&nbsp;map"];
'http://pardus.tux.com.au/';

var orionCustomLinks = ['http://federation.bernieke.com/', 'http://redcell.dayvmattt.com/index.php', 'http://www.thebluesuncorporation.com/pardusmap/Orion/sectors.html', 'http://pardus.butterfat.net/pardusmapper/maps/orion/universe.html', 'http://pardus.rukh.de/', 'http://www.cs.elte.hu/~terpai/tcc_alt.html', 'http://federation.danyweb.net/index.php', 'http://centic.awardspace.com/index.php'];
var orionCustomLinkNames = ['FED', 'RC', 'BSC&nbsp;Map', 'BF&nbsp;Map', 'Tools', 'Travel', 'Logger','Sector'];

var pegasusCustomLinks = ['http://pardus.butterfat.net/pardusmapper/maps/pegasus/universe.html?universe=pegasus', 'http://pardus.rukh.de/', 'http://mapper.pardus-alliance.com/pegasus/', 'http://pardus.maxisoft.org/monsterskillfinder.html', 'http://unique.hobby-site.com/Pardus-Spy/ClusterReport?universe=pegasus'];
var pegasusCustomLinkNames = ['BF&nbsp;Map', 'Tools', 'Map', 'Skill', "arkoan's&nbsp;map"];
