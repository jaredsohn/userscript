...
*
* Hungarian translation, bug fix for Thermal Baths and separate building report for ships by cszolee, 2010.08.15.
**/
function functionMain(e) {
	...
	" #GB_Builds, #GB_Movements, #GB_Trainings, #GB_Trainings2 { font-size: 10px; } "+
	...
	function L_hu(){
		var t = [];
		t["CONSTR"] = "Építkezések";
		t["NONE"] = "Semmi";
		t["IFINI"] = "elkészül:";
		t["MOVEM"] = "Csapatmozgások";
		t["RETRNF"] = "Visszatérés innen:";
		//t["IN"] = "ennyi idő múlva: ";
		t["IN"] = ":";
		t["UPDCHECK"] = "Frissítések ellenőrzése";
		t["SPBT"] = "SupportBar";
		t["LINKS"] = "Hivatkozások";
		t["BKMRKP"] = "Könyvjelző Oldal";
		t["BKMRKTP"] = "Mentés A Könyvjelzőkhöz?";
		t["DELLINK"] = "Biztosan törölni akarod ezt a hivatkozást?";
		t["URLLINK"] = "A hivatkozás URL-je?";
		t["TXTLINK"] = "A hivatkozás neve/szöveg?";
		t["URLLINKN"] = "A hivatkozás új URL-je?";
		t["TXTLINKN"] = "A hivatkozás új neve?";
		t["UPDCHCKN"] = "Script frissítés keresése.&nbsp;&nbsp;Várjál...";
		t["UPDLATEST"] = "A legfrissebb verzió van telepítve.";
		t["UPDBETA"] = "Lehet hogy bétaverziót használsz.";
		t["UPDNEW"] = "A script újabb verziója letölthető.";
		t["CL"] = "Kattints";
		t["HR"] = "ide";
		t["TUPD"] = "a frissítéshez!";
		t["UP"] = "Fel";
		t["DWN"] = "Le";
		t["DEL"] = "Töröl";
		t["EDIT"] = "Szerkeszt";
		t["FARMASK"] = "Fosztogatás";
		t["FARMSTR"] = "Erő növelése";
		t["LANDATK"] = "Szárazföldi támadás";
		t["TRAIN"] = "Egységek gyártása";
		t["TRAIN2"] = "Hajók gyártása";
		//t["PRODC"] = "Termelés ";
		t["PRODC"] = " ";
		t["ATTACKR"] = "Támadó";
		t["DEFENDR"] = "Védő";
		t['EFF'] = "Hatékonyság";
		t['PROFF'] = "Profit";
		t["STPT"] = "Grepolis Beyond Beállítás";
		t["STP"] = "Beállítás";
		t["UBBC"] = "Fórum UBB Kód";
		t["CITY"] = "Város";
		t["ATK"] = "támadja";
		t["AN"] = " ";
		t["CITB"] = "HarciBónusz";
		...
		t["PINK"] = "Rózsaszín";
		t["ORANGE"] = "Narancs";	
		t["NOTEPAD"] = "Jegyzettömb";
		t["SAVE"] = "Mentés";
		t["HOMEP"] = "Script Honlap";	
		t["PRODCOLOR"] = "Szín";
		t["POS"] = "Helyzet";
		t["POSU"] = "Nyersanyagok alatt";
		t["POSA"] = "Nyersanyagok felett";
		t["ENABL"] = "Engedélyezve";
		t["NOTEB"] = "Viselkedés";
		t["NOTES"] = "Statikus méret";
		t["NOTED"] = "Auto méret. a tartalomhoz";
		t["LINKC"] = "Forrás";
		t["PRODCOUNT"] = "Termelés számlálók";
		t["REPORT"] = "Jelentés";
		t["HANI"] = "Animáció elrejtése";
		t["EFORMAT"] = "Extra info mutatása";
		//t[""] = "";
		GB.Lang['hu'] = t;
	};
	L_hu();
	...
	GB_spbHTML += '</span><br />'+L('TRAIN2')+':<br /><span id="GB_Trainings2" >';
	...
	function GB_Trainings(){
		...
		for(var i in GB.Trainings){
			var Traing1 = GB.Trainings[i];
			if(Traing1.to_be_completed_at-GB.time > 0){
				Pcount++;
				P.innerHTML += '<span id="GB_T'+Traing1.created_at+'_E" > '+L('PRODC')+(Traing1.units_left+1)+' '+GB.Units[Traing1.unit_id].name+'(s) '+L('IN')+' <span id="GB_T'+Traing1.created_at+'" >' + ft(Traing1.to_be_completed_at-GB.time) + '</span><br /></span>';
				GB.counters['GB_T'+ Traing1.created_at] = ['GB_T'+ Traing1.created_at,Traing1.to_be_completed_at-GB.time,'GB_T'+ Traing1.created_at + '_E'];
			}
		}
		if(Pcount == 0){ P.innerHTML = '&nbsp;&nbsp;&nbsp;&nbsp;'+ L('NONE') + '<br />'; }
	}
	function GB_Trainings2(){
		if(GB.Game.controller == 'building_docks'){GB.Trainings2 = uW.UnitOrder.orders; GB_setValue("Trainings2"+GB.Game.townId,GB.Trainings2);GB.Units2 = uW.UnitOrder.units; GB_setValue("Units2"+GB.Game.townId,GB.Units2);}
		else{GB.Trainings2 = GB_getValue("Trainings2"+GB.Game.townId);GB.Units = GB_getValue("Units2"+GB.Game.townId);}
		var P = $g("GB_Trainings2");
		P.innerHTML = '';
		var Pcount = 0;
		for(var i in GB.Trainings2){
			var Traing2 = GB.Trainings2[i];
			if(Traing2.to_be_completed_at-GB.time > 0){
				Pcount++;
				P.innerHTML += '<span id="GB_T'+Traing2.created_at+'_E" > '+L('PRODC')+(Traing2.units_left+1)+' '+GB.Units[Traing2.unit_id].name+'(s) '+L('IN')+' <span id="GB_T'+Traing2.created_at+'" >' + ft(Traing2.to_be_completed_at-GB.time) + '</span><br /></span>';
				GB.counters['GB_T'+ Traing2.created_at] = ['GB_T'+ Traing2.created_at,Traing2.to_be_completed_at-GB.time,'GB_T'+ Traing2.created_at + '_E'];
			}
		}
		if(Pcount == 0){ P.innerHTML = '&nbsp;&nbsp;&nbsp;&nbsp;'+ L('NONE') + '<br />'; }
	}
	...
	*/
	...
	if(GB.Game.controller == "building_barracks"){
		...
		uW.UnitOrder.updateOrders = function(){
			...
			window.setTimeout(GB_Trainings2,0);
			window.setTimeout(GB_ProdInfo,0);
	...
	function GB_LoadSettings(){ 
		...
		if(GB.S[11] == undefined || (GB.S[11] != 0 && GB.S[11] != 1)) {GB.S[11] = 1;}
	}
