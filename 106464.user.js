// ==UserScript==
// @name The West - Motivasyon Scripti
// @namespace      http://www.the-west.ru
// @include        http://*.the-west.*/game.php*
// @description    The West - Motivasyon Scripti
// @author         JoeSmith
// @translator     AlcatrazMovieKnight
// ==/UserScript==
...
function setAktListe(listenName) {
	listenName = $defined(listenName) ? listenName : '?? ?????????';
...
function addMotivationButton() {
	...
	menuElem.innerHTML = '<a href="#" onclick="MoCheck.openMotivationWindow();">' +
						 '  <span style="display:block; width:105px; font-weight:normal; color:#fff; margin-left:25px; padding-top:5px;"><b>?????????</b></span>' +
						 '</a>';
...
function getLanguage(lang) {
	res = new Array();
	res['tr'] = {
		'dialog.closeAll.popup':'Hepsini kapat',
		'dialog.minimize.popup':'Azaltmak',
		'dialog.close.popup':'Kapat',

		'dialog.tab.work.titel':'Çalışmalar ve Listeler',
		'dialog.tab.about.titel':'Hakkında',
		'dialog.tab.work.nothingSelected.1':'Zaten bu çalışma listede mevcut !',
		'dialog.tab.work.nothingSelected.2':'Bir çalışmayı açın ve listeye ekleyin.',
		'dialog.tab.work.tableHeader.work':'Çalışma',
		'dialog.tab.work.tableHeader.points':'Yetenek puanları',
		'dialog.tab.work.tableHeader.money':'Ücret',
		'dialog.tab.work.tableHeader.experience':'Tecrübe puanı',
		'dialog.tab.work.tableHeader.luck':'Şans',
		'dialog.tab.work.tableHeader.motivation':'Motivasyon',
		
		'dialog.tab.configuration.actual':'Gerçek',
		'dialog.tab.configuration.btnDelete.popup':'Listeyi sil',
		'dialog.tab.configuration.btnRename.popup':'Listeyi yeniden adlandır',
		'dialog.tab.configuration.btnNew.popup':'Yeni liste oluştur',
	
		'select.option.minutes':'dakika',
		'select.option.hours':'saat',
		
		'btnOk.label':'Tamam',
		'btnAdd.popup':'Çalışma ekle',
		'btnCenter.popup':'<b>Transit süresi:</b> %1h',
		'btnDelete.popup':'Çalışmayı listeden sil',
		
		'sortIcon.popup.money':'<b>Ücrete</b> göre sırala',
		'sortIcon.popup.luck':'<b>Şansa</b> göre sırala',
		'sortIcon.popup.experience':'<b>Tecrübe Puanına</b> göre sırala',
		'sortIcon.popup.motivation':'<b>Motivasyona</b> göre sırala',
		
		'visibleIcon.popup.money':'<b>Ücrete</b> göre /liste\ gösterilemiyor',
		'visibleIcon.popup.luck':'<b>Şansa</b> göre /liste\ gösterilemiyor',
		'visibleIcon.popup.experience':'<b>Tecrübe Puanına</b> göre /liste\ gösterilemiyor',
		'visibleIcon.popup.motivation':'<b>Motivasyona</b> göre /liste\ gösterilemiyor',
		
		'jobImage.popup':'Çalışma: <b>%1</b><br />Yetenek puanları: <b>%2</b>',
	
		'message.error.unableToDeleteCurrentList':'Güncel liste silinilemiyor.',
		'message.deleteList':'Listeyi sil %1?',
		'message.newName':'Yeni ad:',
		'message.addedWork':'Çalışma eklendi.',
		'message.deleteFromList':'Listen %1 silmek istiyor musunuz?',
		'message.listLoaded':'Yüklendi %1.',
		'message.listDeleted':'Silindi %1.',
		'message.listRenamed':'Liste yeniden adlandırıldı.',
		'message.listCreated':'Liste oluşturuldu.',
		'message.error.nameAlreadyDefined': 'Ad %1 zaten kullanılıyor.',
