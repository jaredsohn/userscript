// ==UserScript==
// @name           BBCodes para Taringa Corregido por 
// @namespace      SharkaleBBCODER Corregido por 
// @description    BBCoder para T! (Crear post, comentarios, menú)
// @include        http://*taringa.net/*
// @exclude        http://br.taringa.net/*
// @version        25.0 Corregido por Otto10k
// @copyright      Copyright (c) 2009, Sharkale Corregido por 
// @creator        Sharkale (Alejandro Barreiro) ® 2009 Corregido por 
// ==/UserScript==
			...
			$('#procesando').html(HTML).slideDown(1000, function(){
				$.ajax({
					...
					success: function(h){
						...
						var HTML = '<div class="cita" style="color:#464646;text-shadow:0 1px 0 #CCCCCC;"><img src="'+URL+'cerrar.gif" alt="[X]" title="'+tarLang["Preview"][3]+'" border="0" onclick="javascript:($(\'#procesando\').slideUp(1000))" style="margin-right:5px" onmouseover="this.style.cursor=\'pointer\'" />'+tarLang["Preview"][4]+' - Sharkale® Corregido por Otto10k</div>';
...
///////////////-----------------Agregar Emoticones------------------////////////////////
	...
	if($('div[typeof="foaf:Person"]').find('a[href="/perfil/Otto10k"]').length != 0){
		...
		mod_sharkale.find('img[title="Ultra Mega User"]').attr('style','position: absolute; top: -109px; clip: rect(109px, 16px, 126px, 0px);').attr('title','Otto10k La otra envidia de los Mods...');
