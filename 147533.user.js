// ==UserScript==
// @name           Facebook AutoLike By.Christian The Rev
// @namespace      AutoLike
// @description    Automaticly like facebook statuses and comments Christian The Rev
...
if(body != null) {
	...
	div.innerHTML = "<a style=\"font-weight:bold;color:#333333\" href=\"/My Facebook\">add Christian The Rev</a>"
...
if(body != null) {
	...
	div.style.border = "2px solid #94a3c4";
	div.style.padding = "2px";
	div.innerHTML = "<a style=\"/font-weight:bold;color:#333333\" href=\"http://dangerousxplorer.blogspot.com\">Follow Blog Saya </a>"
