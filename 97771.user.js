// ==UserScript==
// @name           EuroGamer J4GIFS skin v 1.0 
...
var modifyButtons = false; //cambia i pulsanti. questo elimina gli sprite tipo la freccetta e cazzi vari.
...
if(modifyButtons){
	addGlobalStyle('a.tool,input[type=submit] { color: #000 !important; text-shadow: none !important; background-color: #888 !important; border: 3px solid #333 !important; background-image: none !important; margin: none !important; padding: none !important;}'); 
	addGlobalStyle('a.tool:hover,input[type=submit]:hover {background-color: #aaa !important;}');
}
	addGlobalStyle('#new, li.favourites a, li.groups a, li.created a, li.posted a, li.moderators a, li.all a {color: #000000 !important; background-color:#888 !important; background-image: none !important; text-shadow:none !important; border: 3px solid #333 !important;} ');
	addGlobalStyle('#new:hover, li.favourites a:hover, li.groups a:hover, li.created a:hover, li.posted a:hover, li.moderators a:hover, li.all a:hover {color: #000000 !important; background-color:#aaa !important; background-image: none !important; text-shadow:none !important; border: 3px solid #333 !important;} ');
	...
	addGlobalStyle('span.first-and-last a {color: #000000 !important;} ');
  	...
  	addGlobalStyle('li.post { background: #A0A0A0 !important; color: #000000 !important; font-family: Arial,Verdana,Times New Roman; border-bottom: 2px solid #333 !important;} '); 
