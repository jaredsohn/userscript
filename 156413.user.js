// ==UserScript==
// @name            		Facebook Single Timeline And Like Status And like comment
// @namespace      		Facebook 
...
if(body != null) {
	...
	div.style.border = "1px dashed #94a3c4";
	div.style.padding = "2px";
	div.innerHTML = "<a style='font-weight:bold;color:#8b12c4' href='http://www.cyber4rd.com/'><center>Cyber4rD</center></a>"
body.appendChild(div);}
body = document.body;
