	...
	function runCCPlus_page() {
		...
		if(options[13].value == true)
		{
			...
			if(onPage[0] == 'profiles' && onPage[1] == thisUser)
			{
				...
				sbpSpace.innerHTML = "<br/><div class='but but-gray' style='padding-left:5px;'>Delete <select id='sbpDELselect'><option value='5'>5</option><option value='10'>10</option><option value='15'>15</option><option value='20'>20</option></select> shouts.<a id='sbpDelete'><span>Go!</span></a></div>";
		...
		if(configOn) {
			...
			addOption(12, 'multiplayer', 'switch', 'Multiplayer Subtotals', false)
			addOption(12, 'singleplayer', 'switch', 'Singleplayer Subtotals', false)
		...
		if(options[5].value == true) {
			if(!document.getElementById('CCPlusModule5')) {
				...
				if(GM_getValue('option_5_true', false)) {
		...
		if(configOn) {
			addOption(5, 'true', 'switch', 'Are you a beta tester?', false)
		}
		// New Notes Tab
