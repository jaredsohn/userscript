// ==UserScript==
// @author Sirhc [BaseBog] - based on code by Wipeer and Flake
// @name BaseBogScript 2.0
// @description BaseBogScript v.2.0 DarkPirates - Versione Italiana
...
'W',	'index.php?mod=ally&submod=allyrecht',		'Messaggio Circolare Alleanza',	'mplus_m',	'Msg. Circolare', 	'color:#0cc00b',
'W',	'index.php?mod=ally&submod=allymembers',	'Membri Alleanza',		'mplus_m',	'Membri Ally', 		'color:#0cc00b',
...
'A',	'index.php?mod=auction',			'Asta Tosta',			'mplus_m',	'Asta',			'',
...
var caratteristiche = "";
	...
	menuplus = '<div id="klammer-links"><ul><li style="position:relative"><img class="k-links" alt="" src="img/mk-links-klammer.jpg" /><a href="http://basebog.forumup.it" target="_blank">Menu Plus</a></li></ul></div>';
	menuplus += '<div id="heimatwelten"><ul>';

//******* se nome settore é definito bisogna avere un comportamento *******
if (nome_settore!="N.D.") 
{
...
//******* Selezione elementi variabili *******
	...
	for(k=0;k<caratteristiche.length;k++)
	{
		...
		for(i=0;i<m_p.length;i=i+6)
		{
			//******* Inserimento elementi variabilii *******
	...
	menuplus += '<div id="klammer-rechts"><ul><li style="position:relative"><img class="k-rechts" alt="" src="img/mk-rechts-klammer.jpg" /><a href="http://img152.imageshack.us/img152/1240/fusionprofitbo4.gif" target="_blank">Minerali Speciali</a></li></ul></div>';
...
if(url.match('mod=map')) {
	...
	caption += '<p style="'+bgc+pa+'width: 70px; left: 419px; top: 497px;' +zlivello+fmercato+ '">Limes Ater</p>';
	...
	caption += '<p style="'+bgc+pa+'width: 70px; left: 557px; top: 637px;' +zlivello+fquartgen+'">Teril Tkarr</p>';
	...
	legend += '<p style="'+bgc+pa+'width: 110px; left: 360px; top: 775px;'+zlivello+fnominerali+'">Minerali Mancanti</p>';	
	...
	minerals += '<span style="'+bgc+pa+'width: 140px; left: 610px; top: 505px;'+zlivello+'"><img src="img/item/6_14k.gif"'+imga+'><span style="'+pr+fminerali+fb+'">Ipolio</span> <span style="'+pr+fnormale+' left: 37px;">240.723</span></span>';

	minerals += '<span style="'+bgc+pa+'width: 140px; left: 610px; top: 520px;'+zlivello+'"><img src="img/item/6_15k.gif"'+imga+'><span style="'+pr+fminerali+fb+'">Einsteinium</span> <span style="'+pr+fnormale+' left: 6px;">606.744</span></span>';
