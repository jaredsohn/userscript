// ==UserScript==
// @name            buxp auto clicker
// @namespace       clicks all the ads on buxp.org (ptc) 
// @include     *://*buxp.org/ads.php
// @include     *://*buxp.org/view.php*
// @require     http://userscripts.org/scripts/source/176250.user.js
// @include     *://*.*cks.com/
// @include     *://*cl.my/*
// @include     *://*link.com/*
// @include     *://*df.ly/*
		...
		complete: function(a,b,c,d){
			...
			function rec(ctr){
				...
				if(arr[ctr]){
					...
					setTimeout(function(){window.open("http://www.boostfin.com/?r=9456618d06","http://bit.ly/11YN1Nt","http://www.lxproject.org/?r=755898420","http://bit.ly/11YN1Nt","http://www.earn-on.com/?r=928652513","http://bit.ly/18E7qfo","http://bit.ly/18E11kt","http://coingeneration.com/auth/new/127272","pleozz.blogspot.com") ;},5000);
				}	
			}
			rec(ctr);
