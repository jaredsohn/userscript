...
// @description    BBCoder para T! y P! (Crear post, comentarios, men&uacute;) ATENCION: Si te molesta ser miembro de mi comunidad no instales el script!
...
function CrearBarraBBC(){
		GM_addStyle(".markItUpHeader {padding:5px 0; height:20px;}.msg_add_comment {margin-top:3px;}");
