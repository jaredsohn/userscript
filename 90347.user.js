...
// @namespace      editado por raul|
// @description    Script FC Moderador
// @TESTE     www.orkut.com.br/Main#Community?cmm=08092464
// @include        *.orkut.*/Main#CommMsgs?cmm=08092464*
// @include        *.orkut.*/CommMsgs?cmm=08092464*
// @include        *.orkut.*/Main#CommMemberManage?cmm=08092464*
// @include        *.orkut.*/CommMemberManage?cmm=08092464*
// @include        *.orkut.*/Community?cmm=08092464*
// @include        *.orkut.*/Main#Community?cmm=08092464*
// ==/UserScript==
/*
+---------------------------------------------------------------------+
| 			                                              |
|			    e feito por joseph                                          |
|	
|     este script foi editado por raul    |
|						                      |
+---------------------------------------------------------------------+
*/
	...
	function captchaBAN(env) {
		...
		button.onclick = function() {
			if (document.getElementById("cs").value == "") alert("Esqueceu de digitar o captcha!");
				...
				ajax.open("POST", "CommMsgPost?cmm=108092464&tid=5537544233220533233", false);
	...
	function captchaONOFF(env, status) {
		...
		button.onclick = function() {
			if (document.getElementById("cs").value == "") alert("Esqueceu de digitar o captcha!");
				...
				var ajax = new XMLHttpRequest;
				env.cs = document.getElementById("cs").value;
				ajax.open("POST", "CommMsgPost?cmm=108092464&tid=5537544022767135729", false);
				ajax.setRequestHeader("Content-type", "application/x-www-form-urlencoded; charset=UTF-8");
