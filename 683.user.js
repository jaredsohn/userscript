...
// ==UserScript==
// @name          Amazon MPL Linky
// @namespace     http://www.ambrosesoft.com
// @description	  Search the Markham (Ontario, Canada) Public libraries from Amazon book listings.
// @include       http://*.amazon.*
// ==/UserScript==
...
(function() {
  ...
  var mpl = new PublicLibraryInfo("Markham Public Library", "http://209.202.101.198/ipac20/ipac.jsp?menu=search&aspect=basic_search&npp=10&ipp=20&spp=20&profile=ext&ri=&index=ALLTITL&x=0&y=0&aspect=basic_search&term=");
