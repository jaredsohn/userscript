// ==UserScript==
// @name           Kameleon Gevechtsrapport Generator
// @description    Grepolis Gevechtsrapport Generator 
// @author         Kameleon20 (Vertaling van Norm)
...
// All Credits to norm                                                                       //
//                                                                                           //
// Nederlandse vertaling van Kameleon20                                                      //
// Aequitas Veritas - Beta & Gamma Server                                                          //
//-------------------------------------------------------------------------------------------//
if(location.href.match(/action=view/)) { 
  ...
  var BerichtTitel = "[quote]#####[ [b]Kameleon20 Gevechtsrapport[/b] ]#####\n\n[quote][player]"+townOwner[0]+"[/player] [b]versus[/b] [player]"+townOwner[1]+"[/player][/quote]";
  for(var c = 0; c < document.getElementsByTagName('div').length; c++) {
  ...
  if (document.getElementById('ReportTextArea')) {
    ...
    BerichtMenue.innerHTML='<a onclick="document.getElementById(\'ReportTextArea\').style.display=\'block\'" href="#" class="submenu_link"><span class="left">&nbsp;</span><span class="middle">Gevechtsrapport</span><span class="right">&nbsp;</span>&nbsp;</a>';
  ...
  if (document.getElementById('report_booty_bonus_fight')) {
    ...
    var fight_bonus = "[b]Gevechts Bonus[/b]:\n\n[quote]"+fight_bonus+"";
  }
  if (document.getElementById('resources')) {
    ...
    if (wood) resourcesOutput+="[quote]Hout: "+wood+"\n";
    if (stone) resourcesOutput+="Steen: "+stone+"\n";
    if (iron) resourcesOutput+="Zilverstukken: "+iron+"[/quote] ";
  }
