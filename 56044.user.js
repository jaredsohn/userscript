// ==UserScript==
// @name           Bandenprofil DeluXe b auf neue api angepasst hamburg berlin
// @namespace      schickimicky.pennergame.de
// @author         Verbessert by Zimtfisch
// @description    Erweitert die Bandenprofilansicht um einige Punkte .Neue Version
				...
				for (var x = 0; x < tr.length; x++) {
				  ...
				  var points = parseInt(document.getElementById('angreifen'+x).getAttribute('points'));
					...
					if ((minPts <= points) && (points <= maxPts) && (parseInt(points - points * 0.2) > pts)) {
 					  document.getElementById('angreifen'+x).innerHTML = "<a href=\"'+pgurl+'/fight/?to="+username+"\">"+
...
newdiv.setAttribute('style', 'padding-bottom:10px;padding-left:30px;margin-top:-20px;color:#fff;background:url(http://mediaberlin.pennergame.de/img/content_31.jpg);position:relative;');
newdiv.innerHTML = '<strong>Neue Version bei Zimtfisch</strong>' +
								 	 '  <ul>' +
									 '    <li>' +
...
function Geldladen(id,x) {
    ...
    onload: function(responseDetails) {
    	...
    	var dom = parser.parseFromString(responseDetails.responseText, "application/xml");
        	...
        	document.getElementById('geld'+x).innerHTML = '<span style="font-size:10px; color:#555555;">N/A</span>';
				...
				document.getElementById('nachricht'+x).innerHTML = "<a href=\"'+pgurl+'/messages/write/?to="+id+"\"><img style\"margin:5px;\" src=\"http://media.pennergame.de/img/overview/new_msg.gif\" title=\""+username+" eine Nachricht schreiben.\"></a>";
		}
	});
    ...
    onload: function(responseDetails) {
			...
			var q1 = /mediaberlin.pennergame.de\/cache\/bl_DE\/premium\/pets\/[0-9]+.jpg\"><\/div><div/;
			var ptier = q1.exec(content);
			var q2 = /berlin.pennergame.de\/img\/tiere\/([0-9]+).jpg\"><\/div><div/;
			var tier = q2.exec(content);
			if (ptier){
			  var q = /auf den Basiswerten von <b>([\w\s\u00C4\u00D6\u00DC\u00E4\u00F6\u00FC]+)<\/b><br \/><br \/>/;
				var btier = q.exec(content);
				if (btier) {
				  document.getElementById('tier'+x).innerHTML = '<span style="color:#3BF905;font-style:italic;" title=\"Selbsterstelltes Haustier auf der Basis des '+btier[1]+'.\">'+btier[1]+'*</span>';
				}else{
				  document.getElementById('tier'+x).innerHTML = getTier('xxxxx');
				}
			}else if (tier){
			  document.getElementById('tier'+x).innerHTML = getTier(tier[1]);			
			}else{
			  document.getElementById('tier'+x).innerHTML = '<span style="font-size:9px;color:#1511EE;font-style:italic;">[deaktiviert]</span>';
			}
			if(content.match(/Ist gerade Online/)){
			  document.getElementById('onlinestatus'+x).innerHTML = '<img src=\"http://mediaberlin.pennergame.de/img/on.png\" title=\"Ist gerade Online\" alt=\"Online\" />';//AAAAAAAAAAAAAAa
			}else{
			  document.getElementById('onlinestatus'+x).innerHTML = '<img src=\"'+getPic("off")+'\" title=\"Ist zurzeit Offline\" alt=\"Offline\" />';
			}
		}
	});
}
...
function getTier(id){
  var tiere = new Array();
  tiere['00000'] = "Dressierte Maus";
  tiere['48264'] = "Silberfisch";
  tiere['75284'] = "Laubfrosch";
  tiere['92653'] = "Rotkehlchen";
  tiere['02634'] = "Clownfich";
  tiere['01743'] = "Erdmaechnchen";
  tiere['31451'] = "Moewe";
  tiere['66294'] = "Opossum";
  tiere['11634'] = "Streifenhoernchen";
  tiere['11743'] = "Igel";
  tiere['47838'] = "Hausschwein";
  tiere['94652'] = "Schneeeule";
  tiere['65384'] = "Bisamratte";
  tiere['18540'] = "Moorschnucke/Schaf";
  tiere['32563'] = "Mops";
  tiere['64133'] = "Maeusebussard";
  tiere['28463'] = "Golden Retriver";
  tiere['98641'] = "Deutsche Dogge";
  tiere['48256'] = "Australian Shepard";
  tiere['76538'] = "Pekinese";
  tiere['85242'] = "Zebra";
  tiere['88643'] = "Tapir";
  tiere['99624'] = "Kamel";
  tiere['13323'] = "Riesenschildkroete";
  tiere['83290'] = "Leopard";
  tiere['37551'] = "Waschbaer";
  tiere['96242'] = "Elch";
  tiere['73526'] = "T-Rex";
  tiere['16342'] = "Braunbaer";
