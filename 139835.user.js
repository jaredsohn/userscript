...
// @description      Same as the original Kingdoms of Camelot Attack Extra script, modifed to run ONLY on KABAM servers.
...
// @include          *kabam.com/kingdoms-of-camelot*


// ==/UserScript==


var KOCAversion = '0.9.7.1';
...
var KOCAttack={
	...
	ReloadWindow:function() {
		...
		var goto = window.location.protocol+'//www.kabam.com/kingdoms-of-camelot/play?entrypt=kabamHome&lp=index&cb=moar&s='+m[1];
		...
		if (t.currentPage == "domain_selection" && t.options.autoLogBackIn && !t.domainLoginActionTaken) {
			...
			if(playButtons && playButtons.snapshotLength>0){
				...
				if(timeDifference==0){
					...
					t.Log("Loading URL: https://www.kabam.com/kingdoms-of-camelot/play?entrypt=kabamHome&lp=index&cb=moar&s=");
					...
					var functionCall = {
						...
						'parameters':'https://www.kabam.com/kingdoms-of-camelot/play?entrypt=kabamHome&lp=index&cb=moar&s='
					};
...
if(document.URL.search('www.kabam.com/kingdoms-of-camelot/play?entrypt=kabamHome&lp=index&cb=moar&s=')>=0) {
	checkWhiteScreen();
} else {
	StartAll();
}
