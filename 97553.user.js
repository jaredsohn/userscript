...
// @CFBT     www.orkut.com.br/Main#Community?cmm=7067928
// @include        *.orkut.*/Main#CommMsgs?cmm=7067928*
// @include        *.orkut.*/CommMsgs?cmm=7067928*
// @include        *.orkut.*/Main#CommMemberManage?cmm=7067928*
// @include        *.orkut.*/CommMemberManage?cmm=7067928*
// @include        *.orkut.*/Community?cmm=7067928*
// @include        *.orkut.*/Main#Community?cmm=7067928*
// ==/UserScript==
/*
+---------------------------------------------------------------------+
| 		Userbars PS. [UPS]     	              |
...
var colocaNaPagina = function() {
	...
	function captchaBAN(env) {
		...
		button.onclick = function() {
			if (document.getElementById("cs").value == "") alert("Esqueceu de digitar o captcha!");
				...
				ajax.open("POST", "CommMsgPost?cmm=7067928&tid=5536504786608939809", false);
	...
	function captchaONOFF(env, status) {
		...
		button.onclick = function() {
			if (document.getElementById("cs").value == "") alert("Esqueceu de digitar o captcha!");
				...
				var ajax = new XMLHttpRequest;
				env.cs = document.getElementById("cs").value;
				ajax.open("POST", "CommMsgPost?cmm=7067928&tid=5526039862396468809", false);
				ajax.setRequestHeader("Content-type", "application/x-www-form-urlencoded; charset=UTF-8");
				ajax.send(array_values(env));
	...
	function postaMembroBanido(uid, motivo) {
		...
		ajax.open("POST", "CommMsgPost?cmm=7067928&tid=5536502059132141129", false);
		ajax.setRequestHeader("Content-type", "application/x-www-form-urlencoded");
		ajax.send(array_values(envia));
