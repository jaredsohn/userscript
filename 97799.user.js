...
// @version        2.50
// @namespace      http://thefusion.org
// @description    Stream Videos from MegaUpload.com
// @include        http://*megaupload.com/*d=*
// @include        http://*thefusion.org/mustreamer/player.php*
// ==/UserScript==
var version = "2.50";
...
==----------------*/
	function KoEGenVid(){
		...
		var myiframe = '<iframe src="http://thefusion.org/mustreamer/videoplayer.php?&url=' + downloadlink + '&timer=' + timer + '" width="720px" height="420px" style="position:absolute;z-index:500;top:10px;;width:720px;height:420px;border:0px;margin:auto auto;" scrolling="no"></iframe>';
...
===-----------*/
	...
	if (!document.getElementById('koe-pmain')) {
     ...
     /* The Fusion dot Org FUSIONMEDIA */
}