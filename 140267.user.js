// ==UserScript==
// @author		At - Elah - Adaptado por Este Banano
// @name        Reporte Black Shield
// @version		1.0.0
// @uso:version	1.0.0
// @include		http://*erepublik.com/*
// @description    Reporte Black Shield
// ==/UserScript==

var FORM_URL = "https://docs.google.com/spreadsheet/viewform?formkey=dHdxQ0Q4R0VOWDQ5ZlFERUxfakJSb1E6MQ#gid=0";
...
var LOCALE = {
	...
	bg: function() {
		return {
			locale: "es_ES",
			no_damage: "Tenes que hacer dao antes de enviar un reporte. Apreta F5 si el contador esta buggeado.",
			send_report: "Estas listo para enviar el reporte a Black Shield?",
...
function BattlePage() {
	...
	this.createReportObject = function() {
		...
		var data = {
			...
			damage: parseInt($.find("#total_damage strong").text().replace('&nbsp;','') ), //innerHTML
...
var main = function() {
	...
	$.find("#logo").append(
		...
		'<div><b><u>Reporte BLACK SHIELD</u></b></div>' +
	...
	<a title="Reportar a BLACK SHIELD" href="javascript:;" id="bs_report_pop_send">Reportar a BLACK SHIELD</a>                                         \
