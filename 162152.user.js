// ==UserScript==
// @name        Blokowanie rozgrywek ligowych na gry-planszowe.pl
...
(function(){
var results =document.evaluate("//a[@href='./viewforum.php?f=48']", document, null,XPathResult.ANY_TYPE, null);
var resultNodes = [];
   var aResult;
...
results =document.evaluate("//a[@href='./viewforum.php?f=49'] | //a[@href='./viewforum.php?f=50'] | //a[@href='./viewforum.php?f=51']", document, null,XPathResult.ANY_TYPE, null);
resultNodes = [];
   while (aResult = results.iterateNext()){resultNodes.push(aResult);} 
   for (var i in resultNodes) {
