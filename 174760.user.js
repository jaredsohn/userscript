// ==UserScript==
// @name        Social Media Security Advisor Tools
...
var str1 = new 
Array("arse","arsehole","ass","ass-hat","ass-jabber","ass-pirate","assbag","assbandit","assbanger","assbite",
...
"assjacker","asslick","asslicker","assmonkey","assmunch",
 "assmuncher", "assnigger","asspirate","ass-shit","asshole","asssucker",
"asswad","asswipe","axwound","bampot","bastard","beaner","bitch","bitchas","bitches","bitchtits",
 "bitchy","blow job", "blowjob",
"bollocks","bollox","boner","brotherfucker", 
...
alert("Thank you for not posting inappropriate content!");
