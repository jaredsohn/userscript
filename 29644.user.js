// ==UserScript==
// @name           IkariamFriendlist (0.2.6)
// @namespace      Guthix
// @description    Ikariam friends list compatible with 0.2.6
//
...
unsafeWindow.flToggleFrame = function(nr){
	...
	if(nr == 1){
		document.getElementById("flButtonArea").innerHTML = '<div id="flHeader" onClick="flToggleFrame(0);">Friend List</div>';
...
flHTML += '<div style="text-align:center;"><hr>Add a friend<br><input type="text" name ="flNewName" id="flNewName" value="Name" onFocus="javascript:if(this.value == this.defaultValue) this.value = \'\';" onblur="javascript:if(this.value == \'\') this.value = this.defaultValue;" /><p><a onClick="javascript:flInsertCurrentURL();" style="font-size: 9px; cursor: pointer;">Use current URL</a></p><input type="text" name ="flNewLink" id="flNewLink" value="URL" onFocus="javascript:if(this.value == this.defaultValue) this.value = \'\';" onblur="javascript:if(this.value == \'\') this.value = this.defaultValue;" /><br /><br /><a href="javascript:flAddFriend();" class="button">&nbsp;&nbsp;&nbsp;Add&nbsp;&nbsp;&nbsp;</a><br><p style="padding-top: 8px;"><a href="javascript:flExport();" class="flSmall" style="font-size: 10px;">Export</a> | <a href="javascript:flImport();" class="flSmall" style="font-size: 10px;">Import</a></p> <p><a href="javascript:flRemplaza();" class="flSmall" style="font-size: 10px;">To replace</a></p></div>';
