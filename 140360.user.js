      ...
      qx.Class.define("TASuite.main", {
        ...
        members: {
          ...
          initialize: function () {
            ...
            this.buttons.attack.simulate = new qx.ui.form.Button("Simular");
      ...
      qx.Class.define("TASuite.main", {
        ...
        members: {
          ...
          initializeStats: function (tabView) {
            // ////////////////Stats ////////////////////
            this.statsPage = new qx.ui.tabview.Page("Estatísticas");
            ...
            eHBox1.add(new qx.ui.basic.Label("Base Inimiga: "));
            ...
            eHBox4.add(new qx.ui.basic.Label("Defesas: "));
            ...
            eHBox5.add(new qx.ui.basic.Label("Edifícios"));
            ...
            eHBox2.add(new qx.ui.basic.Label("Estaleiro: "));
            ...
            eHBox3.add(new qx.ui.basic.Label("Instalação de Defesa: "));
            ...
            eHBox6.add(new qx.ui.basic.Label("Centro de Comando: "));
            ...
            tHBox1.add(new qx.ui.basic.Label("Tempo de Reparo: "));
            ...
            tHBox5.add(new qx.ui.basic.Label("Global: "));
            ...
            tHBox2.add(new qx.ui.basic.Label("Infantaria: "));
            ...
            tHBox3.add(new qx.ui.basic.Label("Veículo: "));
            ...
            tHBox4.add(new qx.ui.basic.Label("Aeronave: "));
            ...
            hBox2.add(new qx.ui.basic.Label("Resultado: "));
            ...
            hBox1.add(new qx.ui.basic.Label("Tempo de Batalha: "));
          ...
          initialize: function () {
            ...
            this.buttons.attack.tools = new qx.ui.form.Button("Ferramentas");
            ...
            this.battleResultsBox = new qx.ui.window.Window("Simulador de Batalha");
