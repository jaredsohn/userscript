...
var data_hu= new Array(6)  //http://data.hu/get/1413984/Playstation_2_BIOS_.html
 data_hu[0]='data\.hu\/get\/(?:.*?)/(?:.*?)\.html';  //name and search string in link to get description
 data_hu[1]='A következő fájl letöltése';                       // file_is_alive
 data_hu[2]='nem létezik';                            // file_is_dead
