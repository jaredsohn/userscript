...
//----Monitor----//
    ...
    menu += '		<li><a href="/sharkaleBBC" target="_blank" title="Dejar la página abierta para que el script verifique nuevos comentarios">Receptor de comentarios</a></li>';
    menu += '	</ul>';
	menu += '	</li>';
//----Favoritos----//
...
//----Opciones----//
	...
	menu += '	<a href="http://www.taringa.net/comunidades/whatthefuck/" title="Entrar a la Comunidad del Script®" style="">Script <img alt="Drop Down" src="http://i.t.net.ar/images/arrowdown.png"></a>';
	menu += '</li>';
	...
	submenu += '	<li><a title="Comunidad WTF" href="http://www.taringa.net/comunidades/whatthefuck/">Comunidad WTF</a></li>';
	submenu += '	<li><a title="Página Oficial WTF" href="http://www.comunidad-wtf.net" target="_blank">P&aacute;gina Oficial WTF</a></li>';
	...
	submenu += '	<li><a title="Ayuda" href="http://www.sharkale.com.ar/bbcoder/faq/index.php" target="_blank">Ayuda</a></li>';
	submenu += '	<li><a title="Poringa" href="http://www.poringa.net/" target="_blank">Poringa</a></li>';
...
var regComu = /\/comunidades\/(whatthefuck|whattheporn|misimagenesygifs|valeria8|xjesuschristx|lastaringueras|sisosvirgen|mundogay|ElFantasmaUAC|crazyfrogbros|society|gamers|juegostaringa|fansolcitosol19)\//gi;
}
