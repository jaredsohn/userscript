// ==UserScript==
// @name           bw_ORDERS_ek8
// @namespace      bw_ORDERS_ek8
// @description    bw_ORDERS_ek8
// @include        http://www.erepublik.com/*
// ==/UserScript==

GM_xmlhttpRequest({
	method: 'GET',
	url: 'http://egermany.itg-em.de/ede/viewtopic.php?f=63&t=1971&p=16243#p16242',
	...
	onload:function(response){
			...
			header.textContent = 'VIII. Expeditionskorp: ';
