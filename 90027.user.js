...
with (ids[i])
if (href&&(href.search('nyaatorrents.org')!=-1||href.search('nyaa.eu')!=-1)&&(text.search('Website')<0))
		{
...
function add_Script()
{
	...
	if (navigator.userAgent.charAt(nav+8)=='3')
		...
		//Chrome and others
		embedded_Script = 'function go(alink){var text1=\'<HTML><HEAD><meta http-equiv="Refresh" content="0;URL=\'+alink+\'"></Head><body></body></HTML>\';var newWin=window.open("", "hide_referer", "menubar=no,location=no,resizable=no,scrollbars=no,status=no");newWin.document.open();newWin.document.write(text1);newWin.document.close();return true;}';
	}
