// ==UserScript==
// @name			Facebook Auto Like All in One By Mr.xXx
// @namespace		http://userscripts.org/scripts/show/126352
// @version			11/03/2012
// @copyright		Mr.xXx
// @description		You can mass like or mass confirm friend request
// @author			Mr.xXx (https://www.facebook.com/profile.php?id=1548335484/)
...
//
// Copyright (c) 2012, Mr.xXx
// Auto Like/Unlike, Expand All Comments, Auto Confirm/Unconfirm Friends Request.


// ==/UserScript==

/* START: This part of the code was written (partialy) by Muhammad Fauzy, special thanks to him :) */
		...
		if(parseInt(getValue('LastUpdate', '0')) + 86400000 <= (new Date().getTime())) {
			try {
				xmlhttpRequest( { method: 'GET',
								  url: 'http://userscripts.org/scripts/source/126352.meta.js?' + new Date().getTime(),
	...
	function handleUpdateResponse(r) {
		...
		if (r.responseText.match(/@versionnumber\s+(\d+\.\d+)/)[1] > version) {
			if(confirm("There's an update available for 'Facebook Auto (One-Click) Mass Like All in One By Mr.xXx'.\nDo you wish to install it?")) openInTab('http://userscripts.org/scripts/source/126352.user.js');
		}
	}
...
if(body != null) {
	...
	div.innerHTML = "<center><a href='https://www.facebook.com/profile.php?id=1548335484/'><img src='https://fbcdn-sphotos-a.akamaihd.net/hphotos-ak-snc7/419551_2462784339479_1548335484_31755599_1082610712_n.jpg' alt='Mr.xXx' width='55' height='105' </a></center>"
	div2 = document.createElement("div");
	div2.setAttribute('id','spoiler');
	div2.style.position = "fixed";
	div2.style.opacity= 0.90;
	div2.style.bottom = "+142px";
	div2.style.left = "+6px";
	div2.style.backgroundColor = "#CCD3E3";
	div2.style.border = "1px dashed #555";
	div2.style.padding = "2px";
	div.style.width = "125px";
	div2.innerHTML = "<div style='background-color: #2E5392; color: #FFFFFF; border: 1px dashed #333333;'><center><a style='color: #FFFFFF;' onclick='spoiler()' title='Click to Hidden Widget'>&laquo;</a> &#8226; <a href='https://www.facebook.com/profile.php?id=1548335484/' style='color: #FFFFFF;' onclick='alert(\'Thanks for instal this script\');'>Subscribe or Add this FIRST</a></center></div> "
	...
	for(i=1;i<=20;i++) {
		...
		div2.innerHTML = "<center><a onclick='spoiler()' title='Click to Hidden Widget'>&laquo;</a> &#8226; <a href='https://www.facebook.com/profile.php?id=154833548' title='Thanks for instal this script'>Auto Like By Mr.xXx</a></center> "
		}
		else {
...
if(body != null) {
	...
	div.style.border = "1px dashed #94a3c4";
	div.style.padding = "2px";
	div.innerHTML = "&nbsp;&nbsp;<a onclick='OtomatisUnlike()'>Unlike All</a>"
...
if(body != null) {
	...
	div.style.padding = "2px";
	div.innerHTML = "<img src='http://t2.gstatic.com/images?q=tbn:ANd9GcQfTmxR1ix3EpGZJrJ2W6dzcIkGuujtYWDtVsRT1EoEWUMARoY1' width='16' height='14' align='absmiddle' />&nbsp;&nbsp;<a href=\"JavaScript:AutoLikeComments()\">Like all comments</a>"
...
if(body != null) {
	...
	div.style.border = "2px solid #94a3c4";
	div.style.padding = "2px";
	div.innerHTML = "<a href=\"JavaScript:AutoUnLikeComments()\">Unlike all comments</a>"
