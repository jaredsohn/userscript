// ==UserScript==
// @name           OFM DE2 - Vereinsseite - Nationensammler Info-Panel
// @namespace      spommie2912
// @description    Adds an additional element to the team page, if the manager is collecting players of one nation.
// @include        http://server2.onlinefussballmanager.de/*php*
// @version        1.0.2
// @license        MIT
// @copyright      2013 spommie2912
// @date           2013-04-04
// @grant          none
// ==/UserScript==
...
var injuredImage = "http://server2.onlinefussballmanager.de/bilder/kreuz.gif";
var suspendedImage1 = "http://server2.onlinefussballmanager.de/bilder/rot1.gif";
var suspendedImage2 = "http://server2.onlinefussballmanager.de/bilder/rot2.gif";
var suspendedImage3 = "http://server2.onlinefussballmanager.de/bilder/rot3.gif";
var suspendedImage4 = "http://server2.onlinefussballmanager.de/bilder/rot4.gif";
var suspendedImage5 = "http://server2.onlinefussballmanager.de/bilder/rot5.gif";
var friendlyActive = "http://server2.onlinefussballmanager.de/db/images/ingame/aufgestellt_friendly2.png";
var funcupActive = "http://server2.onlinefussballmanager.de/db/images/ingame/aufgestellt_funcup2.png"
var substitute =  "http://server2.onlinefussballmanager.de/db/images/ingame/aufgestellt_reserve2.png"
...
function getOCRow (strength){
	return "<tr><td><font color=white><b>Gegnerst. (DE2)</b></font></td><td><font color=white><b>\<="+strength+"</b></font></td></tr>";
}
...
if (location.pathname == "/vereinsseite/kader/vereinsseite_kader.php") {
	...
	// only if the team is a collector of nations
		...
		else if (maxStrength >=35 && maxStrength < 39.5){
			rowOC = getOCRow(maxStrength+5);			
		}
		else if (maxStrength >=40 && maxStrength < 49.5){
			rowOC = getOCRow(maxStrength+10);
		}
		else if (maxStrength >=50 && maxStrength < 59.5){
