// ==UserScript==
// @name           Wall Manager Sidekick (FV) With Updater Removed
...
(function() { 
	...
	var newItems={
		...
		items2:[
			...
			"sendholidaygarland",
			"sendwoodcanteen",
			"sendstringedsnowflake",
			"sendexploringlantern",
			"egg_winter",
			"adopt_calfholidaybull",
			"adopt_calfcamilla",
			"adopt_calfholly",
			"adopt_calfholidaydwarf",
			"adopt_foalwhitebelgian",
			"adopt_foalborealis",
			"adopt_foalharrietta",
			"adopt_foalholidaydrum",
			"adopt_foalwintermagic",
			"adopt_foalwinterhollow",
			"adopt_foaleugene",
			"adopt_foalglittercorn",
			"adopt_foalunicornucopia",
			"tree_giantbark",
			"tree_giantfrostedmaple",
			"tree_giantfrostholly",
			"tree_giantglitterholiday",
			"tree_giantgoldholly",
			"tree_giantgreentinsel",
			"tree_gianthangingsnowflake",
			"tree_giantfallharvest",
			"tree_giantholidaycard",
			"tree_giantholidayfeather",
			"tree_giantholidaylight",
			"tree_gianthotchocolate",
			"tree_giantmoonlitholiday",
			"tree_giantpoinsettialantern",
			"tree_giantreindeer",
			"tree_giantsilveraluminum",
			"tree_giantsilverjingle",
			"tree_giantsnowglobe",
			"tree_giantsnowglow",
			"tree_giantsugarplumfairy",
			"tree_gianttoytrain",
			"tree_giantwintermagic",
			"mat_holidaycowpasture",
			"mat_holidaylivestockpen",
			"mat_holidayzoo",
			"mat_holidaypetrun",
			"mat_holidaysquare",
			"mat_animalworkshop",
			...
			"bushel_flintcorn",
			"bushel_frostholly",
			"bushel_holidaycactus",
			"bushel_holidaypoinsettia",
			"bushel_hollowberry",
			"bushel_honeyginger",
			"bushel_jingleberry",
			"bushel_lightorchid",
			"bushel_potatornament",
			"bushel_rudolphradish",
			"bushel_waxbeans",
			"bushel_whitecranberry",
			"bushel_wintergrain",
			"bushel_wintersquash",
			"bulb_silverpoinsettiabloom",
		],
		items3:[
			"mat_seedlingnursery",
			"fertilizerstake",
		...
		items4:[
			...
			"mat_bigwindmill",
			"mat_ferriswheel",
			"mat_deadlylivestockpen",
			"mat_hauntedpasture",
			"mat_horrendouspetrun",
			"mat_nightmarezoo",
			"woodencog",
			"woodenshaft",
			"bearings",
			...
			"adopt_calftreat",
			"adopt_foalmusic",
			"adopt_foalblackberry",
			"adopt_foalcrystalball",
			"adopt_foalvioletsmini",
			"adopt_foalfestivepegacorn",
			"adopt_foalmarigoldpegasus",
			"adopt_foalpicado",
			"adopt_foaldewdropspony",
			"adopt_foalspectralpegasus",
			"adopt_foalpurpleghost",
			"tree_larosa",
			"tree_beehive",
			"tree_sapphirepixie",
			"tree_calaveritas",
			...
			"tree_tresleches",
			"tree_paperflower",
			"tree_giantdarkcandle",
			"tree_giantdarkjewel",
			"tree_giantdarkrose",
			"tree_gianthallowwillow",
			"tree_giantseasons",
			"tree_bonsaibobbingapple",
			"tree_bonsaicandycorn",
			"tree_bonsaililac",
			"tree_bonsaiwhitejasmin",
			"tree_bonsaidesertrose",
			"bulb_marigold",
			"bulb_patadeleon",
			"bulb_poinsettia",
			"bulb_skullcap",
		...
		items5:[
			...
			"tree_fallflowers",
			"tree_keyboard",
			"tree_glittermicrophone",
			"tree_pie",
			"tree_squash",
			"tree_stagelights",
			"tree_bassclef",
			"tree_gianteggnog",
			"tree_giantfallbouquet",
			"tree_giantfallcandle",
			"tree_giantfallcupcake",
			"tree_giantcornucopiaii",
			"tree_giantpaperfire",
			"tree_gianttarotcard",
			"tree_bonsaimagicmaple",
			"tree_bonsaimagicgum",
			"egg_tambourine",
			"adopt_calfgourd",
			"adopt_calfgreenapple",
			"adopt_calfnewwave",
			"adopt_calfsugar",
			"adopt_foalboss",
			"adopt_foalcelestialgypsy",
			"adopt_foalleafy",
			"adopt_foalmetalhair",
			"adopt_foalandalusianpegacorn",
			"adopt_foalfallpega",
			"adopt_foalpunkpegacorn",
			"adopt_foalsugarpega",
			"adopt_foalsugar",
			"adopt_foalmohawkunicorn",
			"bushel_redcabbage",		
			"mat_sally'sseedshop",
			"mat_bigbarnyard",
			"slopbucket",
			...
			"timetonic",
			"adopt_calfbathat",
			"adopt_calfmadammorgan",
			"adopt_calfrhinestone",
			"adopt_calfvampire",
			"adopt_foaldoleyellow",
			"adopt_foalfairydonkey",
			"adopt_foalvampiredonkey",
			"adopt_foalbutterflypegacorn",
			"adopt_foalmoonpegasus",
			"adopt_foalsunpegasus",
			"adopt_foaledwardian",
			"adopt_foalglowstick",
			"adopt_foalhalfnhalf",
			"adopt_foalprincessmini",
			"adopt_foalbat",
			"adopt_foallacepegacorn",
			"adopt_foalsparkle",
			"adopt_foalspider",
			"adopt_foalblacklight",
			"adopt_foalhalloweenpartycorn",
			"adopt_foalpartygame",
			"egg_fire",
			"egg_ice",
			"egg_madhatter",
			"egg_werechicken",
			"tree_giantbanapple",
			"tree_giantcarvedlantern",
			"tree_giantsolareclipse",
			"tree_giantstonewillow",
			"tree_giantwispwillow",
			"tree_giantambermaple",
			"tree_broomstick",
			"tree_cattopiary",
			"tree_monsterpuff",
			"tree_halloweenglass",
			...
			"tree_sweettooth",
			"tree_staircase",
			"bushel_floatingflower",
			"bushel_orangecauliflower",
			"bulb_batfacecuphea",
			"bulb_blackrose",
			"bulb_orangechrysanths",
			"mat_treeoflife",
			"lifeessence",
			"magicbubble",
			"puffycloud",
			...
			"adopt_calfmonster",
			"adopt_calfwerewolf",
			"adopt_foalfrankenbride",
			"adopt_foalfrankenstallion",
			"adopt_foalbewitchedblack",
			"adopt_foalsilverbatacorn",
			"adopt_foaldraculapegacorn",
			"adopt_foalghostpegacorn",
			"adopt_foalnightmarepegacorn",
			"adopt_foalprincesspegacorn",
			"adopt_foalpureheart",
			"adopt_foalghostpegasus",
			"adopt_foalmummypony",
			"adopt_foalash",
			"adopt_foaldraculaunicorn",
			"adopt_foallavaunicorn",
			"adopt_foalpumpkinunicorn",
			"adopt_foalteepee",
			"adopt_foalwebunicorn",
			"adopt_foalvamp",
			"adopt_foalweb",
			"tree_garlic",
			"tree_mummy",
			...
			"tree_vampirebat",
			"tree_fang",
			"tree_giantchocolatepickle",
			"tree_giantdeadlynightshade",
			"tree_giantdrumstick",
			"tree_giantenchantedyew",
			"tree_giantghostdecoration",
			"tree_gianthollowlantern",
			"tree_giantjellybean",
			"tree_giantjellyblob",
			"tree_giantnote",
			"tree_giantpixie",
			"tree_giantpurpleangeltrumpet",
			"tree_giantsandalwood",
			"tree_giantsoundwave",
			"tree_giantspookymoss",
			"tree_giantteslacoil",
			"tree_gianttrebleclef",
			"tree_giantwolffullmoon",
			"bulb_blackhollyhockbloom",
			"bulb_hemlockbloom",
			"bushel_bugleweed",
			"bushel_vuvuzela",
			"bushel_trumpetcreeper",
			"bushel_viola",
			"bushel_blackpumpkin",
			"bushel_lyreleavedsage",
			"perfectjob",
			"adopt_calfbeefalo",
			"adopt_calfblackrosebull",
			"adopt_calfcornucalfpia",
			"adopt_calfgolfcourse",
			"adopt_calfhustlin'",
			"adopt_calfdzo",
			"adopt_foalbuckingham",
			"adopt_foalzebroid",
			"adopt_foalharvest",
			"adopt_foalhippie",
			"adopt_foallantern",
			"adopt_foaloffice",
			"adopt_foalblackpegacorn",
			"adopt_foalfakepegacorn",
			"adopt_foalpurplebatwing",
			"adopt_foalicywizardpony",
			"adopt_foalpumpkinmini",
			"adopt_foalmaplemini",
			"adopt_foalskeletonmini",
			"adopt_foalghostmini",
			"adopt_foalghastlymini",
			"adopt_foalblackroseunicorn",
			"adopt_foalsamuraiwarrior",
			"adopt_foalfirewizard",
			"egg_hammer",
			"egg_skeleton",
			"tree_acorn",
			"tree_blackpumpkin",
			"tree_darkdogwood",
			"tree_ghostlybanana",
			"tree_pumpkincarriage",
			"tree_firegreenapple",
			"tree_glowy",
			"tree_wintersquash",
			"tree_giantbeachplum",
			"tree_giantcauldron",
			"tree_giantwitchhatii",
			"tree_giantfirecherry",
			"tree_giantghostwillow",
			"tree_gianthaybale",
			"tree_giantlaceyparasol",
			"tree_giantlavalamp",
			"tree_giantphantomoak",
			"tree_giantpumpkinlight",
			"tree_giantscarecrow",
			"tree_giantscaryhaunted",
			"tree_giantspiderweb",
			"tree_giantspookycrystal",
			"tree_gianttp",
			"tree_giantume",
			"tree_giantwickerbasket",
			"tree_giantwitchpumpkin",
			"tree_bonsaidwarfplum",
			"tree_bonsaikeylime",
			"tree_bonsailavenderstar",
			"bushel_sorghum",
			"bushel_ivy",
			"bushel_licoriceplant",
			"bushel_cherryblossom",
			"bushel_dumplingsquash",
			"bushel_peaceflower",
			"bulb_blackorchid",
			"bulb_mandrake",
			"bulb_pumpkinflower",
			...
			"bulb_witchhazel",
			"bulb_wolfsbane",
			"mat_witchin'cauldron",
			"ladle",
			"enchantediron",
			"gummytentacle",
			"tree_giantelephantear",
			"tree_giantalbinoredwood",
			"tree_giantjuicyapple",
			"tree_giantjuicypear",
			"tree_giantdracaenadraco",
			"tree_giantfireorange",
			"tree_giantsigillaria",
			"tree_gianthimilayanyew",
			"tree_gianttravelerspalm",
			"tree_vitex",
			"tree_southwesternchitalpa",
			"tree_magicalsugarmaple",
			"tree_amurmaple",
			"tree_batwing",
			"tree_fallingleaves",
			"tree_blackthorn",
			...
			"egg_dragon",
			"egg_giantprairie",
			"adopt_calfchrysanths",
			"adopt_calfapplejuice",
			"adopt_calffrightened",
			"adopt_foalzorse",
			"adopt_foalhaunted",
			"adopt_foalorangejuice",
			"adopt_foalsteampegacorn",
			"adopt_foalsteam",
			"adopt_foalwalkaloosa",
			"adopt_foalmaplepegacorn",
			"adopt_foalchrysanths",
			"bulb_chinesebellflower",
			"bulb_helenium",
			"bulb_fallcorcus",	
			"mat_tombtreasure",
			"stonepick",
			...
			"rustypost",
			"bushel_wolfsbane",
			"bushel_jacko'lantern",
			"bushel_tombstone",
			"bushel_zombie",
			"bushel_sage",
			"bushel_greentoadstool",
			"bushel_ghoulgarlic",
			"bushel_spectreberries",
			"bushel_frankenfruit",
			"bushel_wormwood",
			"bushel_phantomfrond",
			"bushel_candiedcorn",
			...
			"adopt_calfredhorned",
			"adopt_calfwizard",
			"adopt_calfhorsecostume",
			"adopt_calfglow-in-the-dark",
			"adopt_calffoal",
			"adopt_foaltopiary",
			"adopt_foalspectral",
			"adopt_foalfranken",
			"adopt_foalblacksteed",
			"adopt_foalzebracostume",
			"adopt_foalpinkskeleton",
			"adopt_foalpurplenightmare",
			"adopt_foaldark",
			"adopt_foalzombie",
			"adopt_foalnight",
			"tree_giantwitchvine",
			"tree_gianthaunted",
			"tree_gianttwilightwillow",
			"tree_giantghost",
			"tree_giantbluejackolantern",
			"tree_giantwitchhat",
			"tree_giantpinkskull",
			"tree_giantspookylantern",
			"tree_giantrottenapple",
			"tree_giantdecoratedhalloween",
			"tree_giantbrightcandycorn",
			"tree_giantdarkbramble",
			"tree_giantspooky",
			"tree_giantthorny",
			"tree_giantvampire",
		]
	...
	function dock(){
		...
		var otherBushels=["aloe vera","jade bamboo","basil","black tea","kona coffee","chinese cotton","lowland ginger",
				...
				"udon","lollipop","bugleweed","vuvuzela","trumpet creeper","viola","lyre leaved sage",
			].fixOrder();
		...
		var flowerTypes=["red tulip","purple popp","morning glory","pink rose","white rose","orange dais","electric lil",
				...
				"orange marigold","licorice plant","cherry blossom","peace flower",
		...
		var mistletoeBushels=["choco mint","cider apple","flint corn","frost holly","holiday cactus","holiday poinsettia",
				"hollowberry","honey ginger","jingleberry","light orchid","potatornament","rudolph radish","wax beans",
				"white cranberry","winter grain","winter squash"].toDefinitions("bushel_");
		
		//this array used to clear highlights
		var allCraftBushels=[].concat(bakeryBushels,pubBushels,wineryBushels,craftshopBushels,spaBushels,restrauntBushels,sweetshoppeBushels,tikibarBushels,teagardenBushels,potionshopBushels,mistletoeBushels);
		...
		var craftTypes=[].concat(craftBakery,craftSpa,craftWinery,craftPub,craftShop,craftRestraunt,craftSweetShoppe,craftTikiBar,craftTeaGarden,craftPotionShop,craftMistletoeLane,craftUnidentified);	
		...
		var treeTypes=[//multiple words
				...
				"paper bag","la rosa","sapphire pixie","dew drop flower","dewdrops web","tres leches","paper flower",
				"citrus wreath","fall flowers","glitter microphone","stage lights","bass clef","hair comb","paint brush",
				"panda toy","pocket watch","needle & thread",
		...
		var treeTypes2=[//multiple words
				...
				"autumn umbrella","black dragon","silver fir","french fry","frozen yogurt","hot pink","metallic fir",
				...
				"hot chocolate","moonlit holiday","poinsettia lantern","silver aluminum","silver jingle","snow globe","snow glow",
				"sugar plum fairy","toy train","winter magic",
				...
				"skyline","wutong","zipper","bark","reindeer",
			].fixOrder();
		...
		var buildings=["maison","nursery barn","botanical garden","japanese barn","beehive","garage","pig pen","haunted house",
				...
				"nightmare zoo","deadly livestock pen","haunted pasture","horrendous pet run","bloom mastery billboard","cow pasture",
				"horse paddock","livestock pen","aviary","zoo","pet run","wishing fountain","bonsai garden","holiday square",
			].fixOrder();
		...
		var standardMaterials=["goo ","haunted brick","knockers","creepy candle","clay brick","wooden board","harness","horseshoe",
				...
				"grain of sugar","lamp post","cobblestone","bench","lumberjack saw","power saw",
			].fixOrder();
		...
		var fixTitles={
				...
				mat_floatingcastle:"Cloud Brick, Enchanted Bamboo, Hovering Charm",mat_dragonlair:"Magic Boulder, Talisman, Chisel",
				mat_holidaylivestockpen:"Steel Beam, Water Pump, Wire",mat_wildlifecave:"Fence Post, Grazing Grass, Shrub",
				mat_holidaypetrun:"Fence Post, Painted Wood, Water Pump",mat_holidayzoo:"Pipe, Shrub, Wrench",
				mat_scaryaviary:"Clamp, Hinge, Screwdriver",mat_holidaycowpastaure:"Hay Bundle, Stone, Tin Sheet",
				mat_spookypaddock:"Bridle, Log, Saddle",mat_hauntedmansion:"Cobweb, Deadwood, Old Fence",
				mat_monsterlab:"Rusty Gear, Rusty Post, Thunder Cloud",mat_seedlingnursery:"Fertilizer Stake, Mulch, Seedling Tray",
				"mat_witchin'cauldron":"Ladle, Enchanted Iron, Gummy Tentacle",mat_treeoflife:"Puffy Cloud, Magic Bubble, Life Essence",
				"mat_sally'sseedshop":"Drying Rack, Pepper Packet, Flower Apron",mat_nightmarezoo:"Shrub, Wrench, Pipe",
				mat_horrendouspetrun:"Painted Wood, Water Pump, Fence Post",mat_hauntedpasture:"Hay Bundle, Tin Sheet, Stone",
				mat_deadlylivestockpen:"Water Pump, Steel Beam, Wire",mat_bumpercars:"Bumper, Seatbelt, Steering Wheel",
				mat_bigwindmill:"Windmill Blade, Wooden Cog, Wooden Shaft",mat_ferriswheel:"Bearings, Carnival Light, Gondola",
				mat_bigbarnyard:"Barnyard Shingle, Slop Bucket, Trough",mat_bloommasterybillboard:"Green Tape, Yellow Paper, Purple Roller",
		};
		...
		var otherConsumables=["watering can","puppy kibble","arborist","farmhand","white truffle","flower food",
				...
				"gardener","mystery bulb","dog treat","coins","mystery game dart","zp","pig chow","sp"].fixOrder();
		...
		var specialMaterials=["fruit cake","beach toys","apple","treats","tricks","bonfire supplies","holiday gifts",
				...
				"perfect pet","charming vineyard","picnic basket","dream drop","statue","perfect job","gem",
				"perfect costume","time tonic","fall fashion"].fixOrder();
		...
		var questItems=[//multiple words
				...
				"candy corn mold","tasty fish","wrapped candy","apple basket","horsehead rake","popcorn machine","map pieces",
				...
				"magic bean","treasure pick","mineral paint","stone chisel","mining permit","mine cart track","mine cart",
				"track switch","building crew","mining helmet","flume panel","flume post","flume filter","gem tower plan",
				"wash tub","wash solution","gem polish","gem runner","dragon armor","dragon bait","dragon shield","dry leaf",
				"training manual","dragon saddle","dragon treat","scale brush","dragon wax","juice siphon","juice press",
				"juice funnel","juice strainer","juice bottle","juice label","juice pouch","juice straw","mini plant",
				"tree bark","palm seed","monster seed","monster mix","bug juice","potion sprayer","plant mister","potion vial",
				"snooze pollen","witch fire","night herb vial","witchvine root","graveyard windchime","toad wax","alchemy bag",
				"recipe scrap","plant monster pad","steel garden glove","wiggle weed","freaky fungus","nightshade sundae",
				"vampire bulb","witch feather","murk tonic","thorn seed","miracle glow","firefalfa sprig","riding cloak",
				"sugar bowl","water wand","toy skeleton","black light","trick or treat bag","chocolate bar","green light",
				"monster bait","monster bed","monster blankie","monster brush","monster chow","monster collar","monster leash",
				"monster net","monster tag","orange light","toy bat","ghost manual","ghost marshmallow","pumpkin carving kit",
				"ghost net","ghost trap","ghost vision goggles","jars of slime","old blanket","night root","stone scarab",
				"wisp catcher","witch's spoon","eye of newt","beast whistle","witches' dust","creaky floorboard","large pail",
				"dinosaur teeth","gator claw","water balloon","chocolate pickle","dragon scale","candy corn","blue face paint",
				"empty candy wrapper","enchanted wool","eye of newt","floating candle","garlic gum","griffin feather",
				"hand buzzer","hemlock nectar","hollyhock petal","luminescent dust","mares mane","mystical horn","toy ghost",
				"nightshade blossom","plastic spider","salt pixie stick","sandalwood bark","yew sprig","toothpaste taffy",
				"witch's recipe","black cape","garlic necklace","garlic net","halloween ballot","silver cage","vampire novel",
				"werewolf movie","wolfsbane perfume","wolf totem","fey dust","lycansbane leaves","medusa mud","moonlight candle",
				"pickled melon rind","polymorph pollen","pumpkin fungus stew","splice cream","sun smoothie","wisp seed",
				"witchly watering can","witch water","moldy sponge","gummy worm stew","allseason seed","frost nectar",
				"twilight twig","witch chest","witch's glue","books of spells","candle flame","tomato juice",
				"cookie sheet","dark candle","dusty duster","ghostly hay","grass souffle","insta-cobweb spray","spectral apple",
				"sheet music","cornucopia basket","gourd basket","bonsai clipper","caramel cube","egg nog glass","fall flower",
				"frosting bag","hanging candle","holiday decoration","maple tree sprout","pumpkin sign","turkey feather",
				"cow sugar skull","duck sugar skull","pig sugar skull","orange marigold","yellow marigold","red marigold",
				"pan de muerto","harvest bin","sheaf tie","tractor polish","winnowing fan","bamboo box","bamboo frame",
				"boiling water","mulberry leaf","silk worm","pitch pamphlet","wood bundle","campaign gift","campaign button",
				"campaign flag","campaign mug","campaign sign","campaign sticker","fabric flower","float flower","mascot outfit",
				"sign paint","silver bell","stuffed toy","animal scarf","antler seed","bell bundle","brass spy glass",
				"exploring lantern","flower lantern seed","frosted acorn","gem detector","holiday garland","holly bucket",
				"holly horn","holly whistle","light garland","moonlit light","night sky dust","pine cone powder","reindeer moss",
				"poinsettia pot","stringed snowflake","winterbit grass","wood canteen",
				...
				"palette","ink","mallet","brush","gemologist","waterbucket","grasshopper","grass","wheat","corn","berry",
				"lance","cauldron","jack-o-lantern","cardboard","ducttape","noisemaker","vine","trunk","perch","parchment",
				"crumble","marshmallow","wax","chocolate","amalgum","flag","flail","sickle","thermos","tire","gauze","megaphone",
				"elfalfa","woodberry",
			].fixOrder();
		...
		var calfTypes=[//multiple words
				...
				"colonial","quilted","camilla","holly",
			].fixOrder();
		...
		var bullTypes=["pink patch bull","holstein bull","randall bull","irish moiled bull","flower bull","wagyu bull",
				"groom bull","black rose bull","holiday bull","bull",
			].fixOrder();
		...
		var foalTypes=[//mini
				...
				"skeleton mini","princess mini","violets mini",
				...
				"bedazzled pegacorn","rainbow pegapony",
				...
				"moon pegasus","sun pegasus","spectral pegasus","marigold pegasus",

				//pegafoal
				"fall pega","sugar pega",
		...
		var duckTypes=["belted","party","ugly","red-billed","red","brown","yellow","aztec","blue","campbell","cayuga",
				...
				"wizard","wood","orange","banjo","fighting irish","white grape","nerd","diving","hippie","goth"
			].fixOrder();
		...
		var cowTypes=["brown","chocolate","dexter","disco","fan","groovy","irish moiled","longhorn","pink patch",
				...
				"flannel","caroling","smitten","red","mini longhorn","ghengis","real ca milk","golfcourse"
			].fixOrder();
		...
		var otherAnimals=["pink lamb","baby lamb","dorking chicken","persian cat","baby turkey",
				...
				"moon pegasus","sun pegasus","turtle","lemon dragon",
			].fixOrder();
		...
		var bulbTypes=["anemone","damask rose","fire sunflower","fire weed","orange tulip","pink boat orchid","purple carnation",
				...
				"orange chrysanths","bat face cuphea","marigold","pat de leon","poinsetta","skull cap","candy corn","cosmos",
		...
		var decorOther=["japanese relief flag","fireworks","english hat","hanging flowers","japanese trellis","warrior i",
				...
				"enchanted tree ii","valet gnome","vintnor gnome","oak barrel rack","grape crushing barrel","fairy rose",
				"jumping fountain","rainbow barrel","arborist flag","farmhand flag","sapphire fountain","mystical unicorn",
		];
	...
	//	var t9 = createAccTextFromArray(craftTypes,"sample_"," Sample");
		...
		var t21 = {
			...
			tarot_present:"Tarot Card (Present)",tarot_future:"Tarot Card (Future)",tarotcard:"Tarot Card",
		};
		...
		*/	icon:"http://photos-g.ak.fbcdn.net/photos-ak-snc7/v85005/144/102452128776/app_2_102452128776_1457410780.gif", //fv3
		desc:"FarmVille Sidekick",
			...
			alterLink:{
				...
				conversionChart:{
					...
					grainofspice:"part_spice",lumberjacksaw:"part_lumberjacksaw",powersaw:"part_powersaw",
			...
			accText: mergeJSON(t1,t2,t3,t4,t5,t6,t7,t8,t9,t10,t11,t12,t13,t14,t15,t16,t17,t18,t19,t20,t21,t22,t23,t29,t27,t30,t31,t32,t33,t34,t35,t36,t37,t38,t39,t40),
			...
			tests: [
				...
				{search:["title","caption"],find:["helping","looking for"],ret:"none",kids:[
					{link:"get {%1}",subTests:questItems,ret:"send{%1}"},
				]},
			...
			//	{link:["magic snowflake","magic top hat","shooting star","mound of snow","aurora dust","starry scarf"],ret:"snowmanparts"},
				...
				{search:["title","caption"],find:["Extra Large Treestump","Large Treestump"],ret:"powersaw"},
				{search:["title","caption"],find:["Medium Treestump","Small Treestump"],ret:"lumberjacksaw"},
				...
				{search:["title","caption"],find:"is sharing",ret:"none",kids:[
					{title:"is sharing {%1}",subTests:materials,ret:"{%1}"},
					{title:"is sharing {%1}",subTests:questItems,ret:"send{%1}"},
				]},
				...
				{caption:["send a","needs a few","is sharing extra"],ret:"none",kids:[
			...
			menu: {
				...
				matsep:{type:'tab',label:"Materials",kids:{
					...
					matBlock5:{type:'optionblock',label:"Tarot Cards:",newitem:true,kids:{
				...
				equinetab:{type:'tab',label:"Horses & Foals",kids:{
					horseBlock:{type:'optionblock',label:"Horses:",kids:{
						...
						adopt_batpegacorn:{type:'checkbox',label:"Bat Pegacorn",newitem:true},
						...
						adopt_butterflypegacorn:{type:'checkbox',label:"Butterfly Pegacorn",newitem:true},
						...
						adopt_fairydonkey:{type:'checkbox',label:"Fairy Donkey",newitem:true},
						...
						adopt_moonpegasus:{type:'checkbox',label:"Moon Pegasus",newitem:true},
						...
						adopt_horsesparkle:{type:'checkbox',label:"Sparkle",newitem:true},
						adopt_horsespider:{type:'checkbox',label:"Spider",newitem:true},
						adopt_sunpegasus:{type:'checkbox',label:"Sun Pegasus",newitem:true},
						adopt_horsesundae:{type:'checkbox',label:"Sundae"},
						adopt_summerdonkey:{type:'checkbox',label:"Summer Donkey"},
						adopt_vampiredonkey:{type:'checkbox',label:"Vampire Donkey",newitem:true},
				...
				othertab:{type:'tab',label:"Other",kids:{
					...
					cuttingblock:{type:'optionblock',label:"Bonsai Cuttings:",kids:createMenuFromArray(cuttingTypes,"cutting_"),newitem:true},
					spiritblock:{type:'optionblock',label:"Animal Spirit:",kids:createMenuFromArray(spiritTypes,"spirit_"),newitem:true},
				}},
				...
				bushelsep:{type:'tab',label:"Bushels",kids:{
					hlbushelblock:{type:'optionblock',label:"Highlight Bushels By Crafting Cottage",hideSelectAll:true,kids:{
						...
						btnmistletoelane:{type:'button_highlight',label:"Mistletoe Lane",options:mistletoeBushels,clearfirst:allCraftBushels},
		...
		mistletoeTypes=null;mistletoeBushels=null;
		...
		t36=null;t37=null;t38=null;t39=null;t40=null;t41=null;
	};
