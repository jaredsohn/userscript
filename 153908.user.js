// ==UserScript==
// @name        MafiaWars SuperSwitch
// @namespace   mafiawars
// @description Superswitch addition for mafiawars
...
if(typeof(GM_info)=='object'){ changePage($(document));} // Handle older GM Versions which don't support run-at
