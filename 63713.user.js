...
function findName(test) {
    if (test.innerHTML.indexOf('/game/forum_thread_list.pl?forum_id=3419', 0)>=0) return 1;
  return 0;
}

function findName(test) {
    if (test.innerHTML.indexOf('/game/forum_thread_list.pl?forum_id=4492', 0)>=0) return 1;
  return 0;
}
