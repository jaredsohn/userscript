// ==UserScript==
// @name           Style Switcher (J_Mobile)
// @namespace      -Sheldon-C-
// @version		   0.74.23
// @description    Der besste Weg langweilige webseiten auf zu peppen  
// @include        http://m.jappy.*
// @include        https://m.jappy.*
...
loadcss.setAttribute("rel", "stylesheet");
loadcss.setAttribute("type", "text/css");
loadcss.setAttribute("href", "https://dl.dropboxusercontent.com/u/168600348/css/jappyMobil/update.css");
document.getElementsByTagName("head")[0].appendChild(loadcss);
...
facebook.innerHTML += '<iframe src="//www.facebook.com/plugins/likebox.php?href=https%3A%2F%2Fwww.facebook.com%2Fpages%2FPimp-My-Side%2F117619278333445%3Fref%3Dtn_tnmn&amp;width=292&amp;height=62&amp;show_faces=false&amp;colorscheme=dark&amp;stream=false&amp;border_color&amp;header=true" scrolling="no" frameborder="0" style="border:none; overflow:hidden;float: left; width:auto; height:62px;" allowTransparency="true"></iframe>';
