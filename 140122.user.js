...
var LT_mainFunction = function() {
	...
	function createTweak() {
		...
		LT_strings = {
			"en": {
				"options_btn_tt": "Appuyer pour voir les Options",
				"layout_btn_tt": "Click to generate layout Sharestring for current city",
				"chat_btn_city": "Ville",
				"chat_btn_player": "Joueur",
				"chat_btn_alliance": "Alliance",
				"chat_btn_url": "Lien",
				"copy_coords_btn": "Copier les coordonés sur le chat",
				"up_count_tt": "Batiments disponible pour upgrade:",
				"opts_max_chatlines": "Lignes Maximum chat:",
				"opts_chat_opacity": "Transparence du chat:",
				"opts_switch_to_ally_tab": "Mettre le Chat sur alliance au demarrage",
				...
				"opts_city_tag": {
					"lab": "[city] tag shows:",
					"info": "Info ville",
					"region": "Vue de region"
				},
				"opts_lowest_lvl": {
					"lab1": "Selectionner le batiment a upgrader en appuyant 'L (upgrade plis petit niveau)' Raccourci",
					"lab2": "Definir le niveau maximum a upgrader 'L' va arretter d upgrader",
					"towers": "Tours:",
					"military": "Militaire:",
					"resource": "Ressource:",
					"cottage": "Cottage:",
				...
				"opts_set_hotkeys": "Appuyer sur un des boutons pour définir le raccourci",
				"opts_hotkey_labels": {
					"lab1": "Raccourci construction:",
					"lab2": "Raccourci Upgrade:",
					"lab3": "Raccourci creation pierre de lune:",
					"lab4": "Raccourci general:",
					"upgrade": "Upgrade Batiment",
					"downgrade": "Downgrade / Demolir (Shift+)",
				...
				"purify_btn_tt": "Appuyer pour ouvrir la fenetre de purification",
				"opts_minimap": {
					"enable_lab": "Activer MiniMap",
					"clrs_lab": "Couleurs MiniMap:",
					"show_cities": "Voir Villes",
					"show_none": "Aucun",
					"show_noncastle": "Sans chateau",
					"show_castle": "Avec chateau",
					"show_all": "Tous",
					"show_self": "Moi",
				...
				"no": "Non",
				"yes": "Oui",
				"req_restart": "(redemarrage requis)",
...
// sg:end
			...
			members: {
				...
				tweakLoU: function() {
					...
					// ***** Options button ***** //
					this.optBtn = new qx.ui.form.Button("Opt");
				...
				updateAutoButtonLabel: function(btn) {
					if (LT.options.enableAutoPilot) {
						btn.setLabel("Stopper");
					} else {
						btn.setLabel("Demarrer");
					}
				},
		...
		qx.Class.define("louTweak.optionsPage", {
			...
			construct: function() {
				...
				this.tabPages = [
					...
					{name:"Raccourcis", page:null, vbox:null},
					{name:"Couleurs", page:null, vbox:null},
					{name:"Turbo" , page:null, vbox:null}
				];
...
{				
				...
				cont = new qx.ui.container.Composite(new qx.ui.layout.HBox());
				cb = new qx.ui.form.CheckBox("Activer le changement de ville automatique");
				...
				btn = new qx.ui.form.Button("Rafraichir les villes").set({appearance: "button-text-small"});
				btn.addListener("click", function(){
				...
				applyCurrentToAllBtn = new qx.ui.form.Button("Appliquer a toutes les villes").set({appearance: "button-text-small"});
				cont.add(applyCurrentToAllBtn);
				cont.add(new qx.ui.core.Spacer(10));
				
				cb = new qx.ui.form.CheckBox("Par defaut sur toutes les villes");
				...
				cont = new qx.ui.container.Composite(new qx.ui.layout.HBox());			
				cb = new qx.ui.form.CheckBox("Activer ajout auto de batiment");
				refreshCBArray=new Array();
				refreshCBArray.push(cb);
				this.setupTurboCheckbox(cb,cityList,"autoAddBuildings");
				cont.add(cb);
				
				cb = new qx.ui.form.CheckBox("Activer Auto Upgrade");				
				refreshCBArray.push(cb);
				...
				cont = new qx.ui.container.Composite(new qx.ui.layout.HBox());
				cb = new qx.ui.form.CheckBox("Activer les attaques auto");
				refreshCBArray.push(cb);
				this.setupTurboCheckbox(cb,cityList,"autoSendAttack");
				cont.add(cb);
				
				cb = new qx.ui.form.CheckBox("Activer auto purification");
				refreshCBArray.push(cb);
				...
				cont.add(new qx.ui.core.Spacer(10));
				lab = new qx.ui.basic.Label("Purification  %:").set({paddingTop: 4});
				cont.add(lab);
				...
				try {
					cont = new qx.ui.container.Composite(new qx.ui.layout.HBox());
					lab = new qx.ui.basic.Label("Concentrer l Upgrade sur");
					cont.add(lab);
					this.tabPages[3].vbox.add(cont);

					rg = new qx.ui.form.RadioGroup();
					rbs = [ "Cottage", "Bois", "Pierre", "Fer", "Blé", "Millitaire", "Caserne", "Tour", "Upgrade ceux choisis dans onglet géneral" ];
				...
				cont = new qx.ui.container.Composite(new qx.ui.layout.HBox());
				cont.add(new qx.ui.core.Spacer(20));
				lab = new qx.ui.basic.Label("Attente minimum pour upgrade (secs)").set({paddingTop: 4});
				cont.add(lab);
				cont.add(new qx.ui.core.Spacer(10));
				...
				cont = new qx.ui.container.Composite(new qx.ui.layout.HBox());
				cont.add(new qx.ui.core.Spacer(20));
				lab = new qx.ui.basic.Label("Attente avant de changer de ville (secs)").set({paddingTop: 4});
				cont.add(lab);
				cont.add(new qx.ui.core.Spacer(10));
				...
				btn = new qx.ui.form.Button("Rafraichir Messages").set({appearance: "button-text-small"});
				btn.addListener("click", function(){
					LT.main.turboUtils.displayMessages();
				}, this);
				cont.add(btn, {row:0, column:1});
				btn = new qx.ui.form.Button("Effacer").set({appearance: "button-text-small"});
				btn.addListener("click", function(){
