...
self == top){
	...
	if($('frame:nth(1)').attr('src').indexOf('cheat') >= 0 ){
		...
		if(wparent.location.host.indexOf('thedailyclix')!=-1)cheatCheck = [];
		if(wparent.location.host.indexOf('hpbux')!=-1)cheatCheck = [];
		if(wparent.location.host.indexOf('x-click')!=-1)cheatCheck = [];
		if(wparent.location.host.indexOf('clickbux')!=-1)cheatCheck = [];
		if(wparent.location.host.indexOf('ceoclix')!=-1)cheatCheck = [];
		if(wparent.location.host.indexOf('idw-silverclix')!=-1)cheatCheck = [];
		if(wparent.location.host.indexOf('juicybux')!=-1)cheatCheck = [];
		if(wparent.location.host.indexOf('happyclix')!=-1)cheatCheck = [];
		if(wparent.location.host.indexOf('cashtravel')!=-1)cheatCheck = [];
		if(wparent.location.host.indexOf('votre-part-degains-ptc')!=-1)cheatCheck = [];
		if(wparent.location.host.indexOf('arrowptc')!=-1)cheatCheck = [];
		if(wparent.location.host.indexOf('pybux')!=-1)cheatCheck = [];
		if(wparent.location.host.indexOf('luckyptc')!=-1)cheatCheck = [];
		if(wparent.location.host.indexOf('moderob')!=-1)cheatCheck = [];
		if(wparent.location.host.indexOf('mediaclickads')!=-1)cheatCheck = [];		
