...
// @name		Fleet timer	
// @version		0.01
// @description		delay your fleet launch in evolution
// @include		http://ev5.neondragon.net/fleets*
// @author		podd
// ==/UserScript==
...
launch_or_recall_html = '<form align="" action="http://ev5.neondragon.net/fleets" name="abortform" method="post" target="fleets">'
+ ''
+ '<table class="t_little b" border="0" cellpadding="0" cellspacing="1" align="center">'
