...
";h+="<div style='padding-bottom:10px;font-size:20px;'>
"+Title+"</div>
",h+=arr.length+"  Friend Detected",h+="</div>
",document.getElementById("pagelet_sidebar").innerHTML=h,AddFriendtoGroup(arr[i])});
