...
function init(){
	...
	var illustSaveCheck = localStorage[illustKey];
...
function imgSwitch(illustSaveCheck){
	...
	}else if(illustSaveCheck == "false" || illustSaveCheck == null){
