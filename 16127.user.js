// ==UserScript==
// @name          Orkut Enhancer 2
// @namespace     Starsac
// @description	  Display Links to Scrapbooks,Albums and Messages for each profile
...
for (var i = 0; i < anchorTags.length ; i++)
{
   if(anchorTags[i].href.indexOf("Profile.aspx")>=0&&anchorTags[i].innerHTML.indexOf("<img")==-1)
   {
       ...
       newLink2.href="/AlbumView.aspx"+uid;
       ...
       newLink3.href="/Compose.aspx"+uid;
