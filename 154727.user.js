// ==UserScript==
// @name           Xunlei.Any.Player.fixed
// @namespace      Xunlei.Any.Player.fixed
...
IMG
http://i.imm.io/Q2CY.jpeg
AVI
ed2k://|file|[失落的房间].[YYeTs][The.Lost.Room][S01E04][CN][DVDVrip][720X408].avi|360220672|2974B9B9DAD913B8DBEAC9B575CAEAF0|/

Item, "Xunlei VOD"=Go to page, "javascript:void(window.open('http://www.x2yun.com/#!u=%l'))"
...
function main(Global){
	var CONSTANTS = {
tips: '<div class="tips_container"><div class="close"></div><form autocomplete="off" class="url_form"><input type="text" placeholder="粘贴链接或者拖入种子 需要登录迅雷账号" name="url" /><input  type="submit" value="\u64ad\u653e" /></form><select class="record"></select><a href="#" class="record_clear" name="clear">\u6e05\u7a7a</a><a name="anyplayer" href="#"></a></div>',
css: '.tips_container *{height:48px ;font: normal normal 400 18px/46px 微软雅黑;color: #555555;} .tips_container input[type="text"]{width:100%;margin: 0px 10px;border-radius:6px ;border: 2px #f00;}  .tips_container{position:fixed;bottom:-57px;z-index:98;background-color:#fafafa;width:360px;right:-200px;border-radius: 10px 0px;box-shadow: -4px  1px 15px #ababab;}  .tips_container:hover{width:95%;right:0px;-webkit-transition: .3s ease-in;-o-transition: .3s ease-in;-moz-transition: .3s ease-in;} .tips_container .close{display:none !important} .tips_container  input[type="submit"]{right:2px ;z-index:99}' ,
	...
	function play(e ,opts){
		...
		/*  FIX.HERE  */
			var cssplayer = document.createElement("style");
                cssplayer.type="text/css";
				cssplayer.innerHTML = ' body.content_got_bg > #XL_CLOUD_VOD_PLAYER{position:fixed;top:50%;left:50%;margin:-25%}  body.content_got_bg{background:#222 } ';
