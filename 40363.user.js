// ==UserScript==
// @name            Ogame anti liens inutiles (v0.84)
// @namespace       the KBX
// @include        *ogame*game*index.php?page=*
// ==/UserScript==

function do_platypus_script() {
smart_remove(window.document,document.evaluate('/HTML[1]/BODY[1]/DIV[3]/CENTER[1]/DIV[1]/TABLE[1]/TBODY[1]/TR[15]/TD[1]/A[1]/B[1]', document, null, XPathResult.FIRST_ORDERED_NODE_TYPE,null).singleNodeValue,null,null,null);
smart_remove(window.document,document.evaluate('/HTML[1]/BODY[1]/DIV[3]/CENTER[1]/DIV[1]/TABLE[1]/TBODY[1]/TR[18]/TD[1]/DIV[1]/FONT[1]/A[1]', document, null, XPathResult.FIRST_ORDERED_NODE_TYPE,null).singleNodeValue,null,null,null);
smart_remove(window.document,document.evaluate('/HTML[1]/BODY[1]/DIV[3]/CENTER[1]/DIV[1]/TABLE[1]/TBODY[1]/TR[25]/TD[1]/DIV[1]/FONT[1]/A[1]', document, null, XPathResult.FIRST_ORDERED_NODE_TYPE,null).singleNodeValue,null,null,null);
smart_remove(window.document,document.evaluate('/HTML[1]/BODY[1]/DIV[3]/CENTER[1]/DIV[1]/TABLE[1]/TR[1]/TD[1]', document, null, XPathResult.FIRST_ORDERED_NODE_TYPE,null).singleNodeValue,null,null,null);
};
