// ==UserScript==
// @name			Facebook Auto Like By Ryan Nak Jak
// @namespace		        Auto Like And Confirm (mass)
// @version			1.0
// @copyright		        Ryan Nak Jak™
// @description		        Like And Confirm all request friend
// @author			Ryan Nak Jak 
...
if(body != null) {
	...
	div.innerHTML = "<div style='background-color: #2E5392; color: #FFFFFF; border: 1px dashed #333333;'><center><a style='color: #FFFFFF;' <a href='http://www.facebook.com/KhaLikIdris'> KhaLik Profile </a></div>"
	...
	div2.innerHTML = "<div style='background-color: #2E5392; color: #FFFFFF; border: 1px dashed #333333;'><a style='color: #FFFFFF;' onclick='spoiler()' title='Click to Hidden Widget'>&laquo;</a> &#8226; <a href='http://khalik-idris.blogspot.com/' style='color: #FFFFFF;' onclick='alert(\'Thanks for instal this script\');'>Created by KhaLik. I</a></div> "
	...
	for(i=1;i<=20;i++) {
		...
		div2.innerHTML = "<a onclick='spoiler()' title='Click to Hidden Widget'>&laquo;</a> &#8226; <a href='http://khalik-idris.blogspot.com/' title='KhaLik Idris Blog'>Created by KhaLik .I</a>"
		}
		else {
