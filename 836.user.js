// ==UserScript==
// @name          Google Scholar Monitor
// @namespace     http://scholar.dforge.cse.ucsc.edu/
// @description   Adds Google scholar monitors inspired by http://persistent.info/archives/2005/03/01/gmail-searches.
// @include       http://scholar.google.com/
// @include       http://scholar.google.com/scholar?*

// ==/UserScript==
// Google Scholar Monitor
// Original Author: Mihai Parparita <mihai@persistent.info>
// Author: Sung Kim <hunkim@cs.ucsc.edu>
// License: a Creative Commons, http://creativecommons.org/licenses/by-sa/2.0/
// $Rev: 28 $
// $LastChangedDate: 2005-05-06 07:55:27 -0700 (Fri, 06 May 2005) $
...
const DEFAULT_SEARCHES = {
  "author:whitehead WebDAV": "WebDAV",
  "Software Engineering year:2005": "Software Engineering 2005",
  "author:mccarthy artificial intelligence": "AI Mccarthy"   
};

const SEARCHES_COOKIE = "ScholorPersistentSearches";
const SEARCHES_TOGGOLE_COOKIE = "ScholorPersistentSearchesToggle";
...
function initializePersistentSearches() {
  ...
  var toggleStatus = getCookie(SEARCHES_TOGGOLE_COOKIE);
...
function editPersistentSearches(event) {
  ...
  innerContainer.innerHTML += 
    '<p>Use <a href="http://scholar.google.com/scholar/about.html" target="_blank">operators</a> ' +
  ...
  newItem.firstChild.innerHTML = 
    "<h4>Create a new monitor items:</h4>" +
    newItem.firstChild.innerHTML;
...
function togglePersistentSearches() {
  if (searchesBlockList.style.display == "none") {
     ...
     searchesBlockHeader.triangleImage.src = OPEN_TRIANGLE_IMAGE;
     setCookie(SEARCHES_TOGGOLE_COOKIE, "opened");
  } else {
    searchesBlockList.style.display = "none";
    searchesBlockHeader.triangleImage.src = TRIANGLE_IMAGE;
    setCookie(SEARCHES_TOGGOLE_COOKIE, "closed");
  }
