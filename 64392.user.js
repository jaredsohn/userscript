...
var smilie = "<img src=\"http://bazie.spacequadrat.de/pennergame/smiley902.gif\"/>";
...
if (url.indexOf("malle.pennergame")>=0) {var gamelink = "http://malle.pennergame.de"}
...
addGlobalStyle('div#container_pet_training { position:absolute; top:100px; left:50%; margin-left:-300px; width:270px; }')
	...
	url: gamelink+"/skills/",
		onload: function(response) {
			var content = response.responseText;
				...
				var container_2_zeile_1 = "<span class=\"Head\">Weitere Weiterbildung:</span><br/>";
				var container_2_zeile_2 = "In Warteschlange: <font color=\"#FFFFFF\">"+w_end_wait+" ["+w_end_wait_stufe+"]</font><br/>";
...
GM_xmlhttpRequest({
  ...
  url: gamelink+"/overview/",
      ...
      var content = response.responseText;
		...
		// menue bilden
		Weiterbildung.innerHTML = "<div id=\"main_container\" >"+inhalt_container_2+"<div class=\"inhalt_container\"><span class=\"Head\">Weiterbildung Penner :</span><br/>Aktuelle Weiterbildung: <span style=\"color:#FFFFFF;\">"+w_type1+" ["+w_type1_stufe+"]</span><br/>"+weiterbildung_0_1+"<br/>"+weiterbildung_0_2+"</div></div>";
	...
	url: gamelink+"/skills/pet/",
		onload: function(response) {
			...
			try {
				...
				// menue bilden
				pettraining.innerHTML = "<div id=\"container_pet_training\"><div class=\"inhalt_container\"><span class=\"Head\">Weiterbildung Haustier:</span><br/>Aktuelle Weiterbildung: <span style=\"color:#FFFFFF;\">"+w_type1+" ["+w_type1_stufe+"]</span><br/>"+weiterbildung_0_1+"<br/>"+weiterbildung_0_2+"</div></div>";
