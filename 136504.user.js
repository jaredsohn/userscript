...
if(localStorage.getItem("cerezReserved")==null) localStorage.setItem("cerezReserved", "|capua genclik|");	//ilk kurulum ayari
if(localStorage.getItem("cerezSakat")==null) localStorage.setItem("cerezSakat", "|behcet oturucum acti |");		//ilk kurulum ayari
...
//	if(gelenAdres!="http://cerez.sozlukspot.com/" )	funCerceveGetir();
