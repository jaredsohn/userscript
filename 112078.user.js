...
// @include		http://ae*.tribalwars.ae/game.php?village=*&screen=place&try=confirm*
...
function main() {
	...
	if (dsData["screen"] == "settings") {
		...
		th.innerHTML = "Notizzettel bei Angriffsbestätigung";
		thr.appendChild(th);
		...
		td1.innerHTML = "auf der Karte anzeigen:";
