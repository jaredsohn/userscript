...
// @version     Awesome 1.2.3.011
// @author      dbendure - modified by RyanHN for person use: All credits to them
				...
				qx.Class.define("FlunikTools.Main", {
					...
					members: {
						...
						initialize: function() {
							...
							// ** RyanHN - Should remove this block. button not needed
							...
							button = new qx.ui.form.Button("Auto.Upgd"); // ** RyanHN
							...
							AutoUpdateButton.addListener("click", function (e) {
                                ...
                                if (window.FlunikTools.Main.getInstance().autoUpdateHandle != null) {
									...
									AutoUpdateButton.setLabel("ALL.OFF");
									...
									AutoUpdateButton.setLabel("ALL.ON");
							...
							// **RyanHN popup.add(AutoUpdateButton, {row: 0, column: 0});
...
/*The Building Function*/BuildingautoUpgrade : function() {
                           var _this = window.FlunikTools.Main.getInstance();
                            ...
                            var baselvl = city.get_LvlBase();
                             ...
                             // ** RyanHN get left 3 characters of baseName
                             // ** 
                             var strName =  baseName.substr(baseName,3);
                ...
                console.log(Ref_obj, refarr);console.log(Pow_obj, powarr);console.log(Har_obj, hararr); console.log(Har1_obj, hararr1);console.log(Acc_obj, accarr);console.log(Sil_obj, silarr);
							...
							*/
                             ...
                             // ** RyanHN -- Put structure here
                                 
                             // alert(strName); //&& (maxarr[0] == refarr[0])&& ((_this.totalRepairTime(airRT, vehRT, infRT) < 99999)||(Ref_obj.buildinglevel < 40))){
                             
                             if (strName=="Ref"){
                                 	//alert("Ref Detected");
                                 if( (Ref_obj != undefined) && (refarr.toString() != "")){ 
                                        console.log(Ref_obj, refarr);
                                       //alert("Refinery Upgraded!");
                                        ClientLib.Net.CommunicationManager.GetInstance().SendCommand("UpgradeBuilding", Ref_obj, null, null, true);
                                        Ref_obj = {};
                                        refarr = [];
                                        maxarr = [];
                             ...
                             if (strName=="Acc"){
                                 //alert("Acc Detected");
                                 if((Acc_obj != undefined) && (accarr.toString() != "")){ 
                                    console.log(Acc_obj, accarr);
                                    //alert("Acc Processed");
                                    ClientLib.Net.CommunicationManager.GetInstance().SendCommand("UpgradeBuilding", Acc_obj, null, null, true);
                                    Acc_obj = {};
                             ...
                             if (strName=="Pwr"){
                                 if((Pow_obj != undefined)&& (powarr.toString() != "")){
