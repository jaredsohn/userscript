// ==UserScript==
// @name           Add video 2 Tagoo (YouTube)
...
// @description    download: http://tagoo.ru/opt/user_scripts/add_video_2_tagoo_youtube.user.js
...
if (typeof(unsafeWindow) == 'undefined')
	unsafeWindow = window;
unsafeWindow.customizeEmbed(unsafeWindow.isWidescreen);
...
function get_embed()
{
	unsafeWindow.onChangeRelated(false);
	unsafeWindow.onChangeBorder(false);
	unsafeWindow.onChangeDelayedCookies(false);
	unsafeWindow.onChangeColor('blank');
	unsafeWindow.onChangeSize('large');
	unsafeWindow.generateEmbed();
