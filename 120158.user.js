...
// @namespace       heroeswm
// @name            HWM Group Hunt
// @description     Удобная помощь в охоте.
// @version         3.12.11p
// @grant           GM_setValue
// @grant           GM_getValue
...
// http://www.heroeswm.ru/ranger_list.php
// <a style="text-decoration:none;" href="pl_info.php?id=3951336">Пьяный Корсар</a> [8]&nbsp;<img src="http://dcdn.heroeswm.ru/i/r1.gif" title="Рыцарь" align="absmiddle" border="0" height="15" width="15">

// http://www.heroeswm.ru/group_wars.php
// <a class="pi" href="pl_info.php?id=4003325"><font color="red">mamba3</font></a><font color="red">[4]&nbsp;<img src="http://dcdn.heroeswm.ru/i/r3.gif" title="Маг" align="absmiddle" border="0" height="15" width="15"></font> vs 

// http://www.heroeswm.ru/clan_info.php?id=5640
// &nbsp;<a href="clan_info.php?id=6285"><img src="http://dcdn.heroeswm.ru/i_clans/l_6285.gif?v=25" title="#6285 Братство буревестника." alt="#6285" align="absmiddle" border="0" height="15" width="20"></a><img src="http://dcdn.heroeswm.ru/i/transparent.gif" alt="" align="absmiddle" height="15" width="2"><a href="pl_info.php?id=2743869" class="pi">AlexanderNevsky</a>&nbsp;<img src="http://dcdn.heroeswm.ru/i/r6.gif" title="Темный эльф" align="absmiddle" border="0" height="15" width="15">

// http://www.heroeswm.ru/forum_messages.php?tid=508247
// <b><a href="pl_info.php?id=137081" style="none;text-decoration: none;">Kuzya88</a></b>

// http://www.heroeswm.ru/pl_warlog.php?id=3951336
// <a class="pi" href="pl_info.php?id=2948842">Гротекс[8]</a>, <a class="pi" href="pl_info.php?id=3951336"><font color="red">Пьяный Корсар[8]</font></a>

// http://www.heroeswm.ru/fast_tour_hist.php?id=21394
// <img src="i/transparent.gif" alt="" align="absmiddle" height="15" width="2"><a class="pi" href="pl_info.php?id=3147443"><b>михастик</b></a> [8], <img src="i/transparent.gif" alt="" align="absmiddle" height="15" width="2"><a class="pi" href="pl_info.php?id=3951336"><b><font color="blue">Пьяный Корсар</font></b></a> [8]<br><img src="i/transparent.gif" alt="" align="absmiddle" height="15" width="2"><a class="pi" href="pl_info.php?id=1794376">Lexus_</a> [8], <img src="i/transparent.gif" alt="" align="absmiddle" height="15" width="2"><a class="pi" href="pl_info.php?id=2879669">ТриКаплиЯДа</a> [8]


/** Интерфейс предпросмотра героя
*
* @param Element ref
* @param Boolean modeMouseOver
* @param Boolean showTalents
* @param Boolean showSkills
* @param Boolean autoclose
* @param Boolean supMode
*/
function UIHeroPreview(ref, modeMouseOver, showTalents, showSkills, autoclose, supMode) {
    
    
    /** Переключение предпросмотра
    * @param Node refNode
    * @param Number heroId
    * @param String heroNick
    */
    function togglePreview(refNode, heroId, heroNick) {
        ...
        function previewCreate() {
            ...
            */
            function onFrameLoad(frameDoc, block, refNode) {
                ...
                var page = new PagePlayerInfo(frameDoc);
                page.parse();
                
                if (page.state === 1) {
                    var i = 0;
                
                    var table = block.ownerDocument.createElement('table');
                    var row = table.insertRow(i++);
                    var cell = row.appendChild(block.ownerDocument.importNode(page.nodes.playerName.parentNode, true));
                    ...
                    if (showSkills) {
                        ...
                        var str = 'Умения:' + '&nbsp;';
                        for (var j = 0; j < page.playerSkills.length; j++) {
                            var raceTitle = page.playerSkills[j].raceTitle;
                            var raceSkill = page.playerSkills[j].value;
                            var isActive = page.playerSkills[j].active;
                            if (raceSkill === 0)
                                continue;
                            var url = 'http://dcdn.heroeswm.ru/i/r' + (j + 1) + '.gif';
                            str += "<img src='" + url + "' title='" + raceTitle + "'/>" + raceSkill + '&nbsp';
                        }
                        cell.innerHTML = str;
                        cell.setAttribute('colspan', 2);
                    ...
                    var row = table.insertRow(i++);
                    var cell = row.appendChild(block.ownerDocument.importNode(page.nodes.playerParams, true));
                    var cell = row.appendChild(block.ownerDocument.importNode(page.nodes.playerEquipment, true));
                    
                    var row = table.insertRow(i++);
                    var cell = row.insertCell(0);
                    cell.setAttribute('colspan', 2);
                    var node = cell.appendChild(block.ownerDocument.importNode(page.nodes.playerArmy, true));
                    ...
                    if (showTalents) {
                        var row = table.insertRow(i++);
                        var cell = row.appendChild(block.ownerDocument.importNode(page.nodes.playerTalents, true));
                        cell.setAttribute('colspan', 2);
                    }
                    ...
                    divContent.firstChild.textContent = 'Ошибка.';
            ...
            function createCtrlRefresh() {
                ...
                $(result).style({'cursor': 'pointer', 'margin-left': '10px'}).text('Обновить').click(
                    function() { delete block.parentNode.removeChild(block); togglePreview(refNode, heroId, heroNick); }
                );
                return result;
            }
            ...
            function createCtrlClose() {
                var result = refNode.ownerDocument.createElement('i');
                $(result).style({'cursor': 'pointer', 'margin-left': '10px'}).text('Закрыть').click(
                    function() { togglePreview(refNode, heroId, heroNick); }
                );
                return result;
            }
            ...
            var divCtrls = refNode.ownerDocument.createElement('div');
            ...
            var divContent = refNode.ownerDocument.createElement('div');
            divContent.style.padding = '5px';
            
            var p = refNode.ownerDocument.createElement('p');
            p.style.margin = '0pt';
            p.style.padding = '0pt';
            ...
            var iframe = frameManager.createFrame('iframe_' + popupId, 'playerInfo', popupRef);
            if (heroId !== undefined)
                iframe.attr('heroId', heroId);
            if (heroNick !== undefined)
                iframe.attr('heroNick', heroNick);
            iframe.bind('load', function(){ 
                onFrameLoad(iframe.prop('contentDocument'), block, refNode); 
            });
            
            togglePreview(refNode, heroId, heroNick);
            
        }
        
        // Идентификатор и ссылка всплывающего окна
        var popupId = (heroId !== undefined) ? 'id_' + heroId : 'nick_' + heroNick;
        var popupRef = (heroId !== undefined) ? 'id=' + heroId : 'nick=' + heroNick;
        popupId = 'popupHero_' + popupId;
        popupRef = url.attr('protocol') + '://' + url.attr('host') + '/pl_info.php?' + popupRef;
    ...
    */
    function attachPreview(node, heroId, heroNick) {
        if (modeMouseOver) {
            $(node).mouseover( function() {togglePreview(node, heroId, heroNick);} );
            $(node).mouseout( function() {togglePreview(node, heroId, heroNick);} );
        } else {
            $(node).click( function() {togglePreview(node, heroId, heroNick);} );
        }
    }
    
    
    // Отсеивание ссылок на гильдию оружейников
    if (ref.href[ref.href.length - 1] == '#')
        return false;
    
    
    // Значения по умолчанию
    if (modeMouseOver === undefined)
        modeMouseOver = false;
        
    if (showTalents === undefined)
        showTalents = true;
        
    if (showSkills === undefined)
        showSkills = true;
    
    if (autoclose === undefined)
        autoclose = true;

    if (supMode === undefined)
        supMode = false;
    
    
    // Контейнер блоков предпросмотра
    var container = ref.ownerDocument.getElementById('heroPreview');
    if (container === null) {
        container = ref.ownerDocument.createElement('div');
        container.id = 'heroPreview';
    ...
    // Определение номера или ника героя по ссылке
    var heroId = undefined;
    var heroNick = undefined;
    
    var url = $.url(ref.href);
    if (url.attr('path') != '/pl_info.php')
        return false;
    
    heroId = url.param('id');
    heroNick = url.param('nick');
    if (heroId !== undefined)
    ...
    if (modeMouseOver) {
        ...
        // Если предпросмотр при наведении - просто подцепляем его
        attachPreview(ref, heroId, heroNick);
        
    } else {
        
        if (supMode) {
            
            // Если предпросмотр по клику - создаем элемент для клика
            ...
            img.title = 'Предпросмотр';
            ref.parentNode.insertBefore(img, ref.nextSibling);
            
            // Подцепляем предпросмотр
            attachPreview(img, heroId, heroNick);
...
Home.parseSkills = function(skillsNode) {
    ...
    for (var i = 0; i < nodes.length; i++) {
        ...
        playerSkills[playerSkills.length] = playerSkill;
        
        //GreaseMonkey.log(playerSkills[playerSkills.length - 1][0] + ': ' + playerSkills[playerSkills.length - 1][1]);
...
Home.parseGuilds = function(guldsNode) {
    ...
    // Гильдия рабочих
    var re = new RegExp("Гильдия\\s*Рабочих:\\s*(\\d+)\\s*\\((\\w+)\\)", 'g');
...
/*
    Все ячейки заявки с текущим игроком имеют bgcolor="#FDFFD7".
*/

/** Страница групповых боев
* @param Document doc 
* @param Game game
* @link http://www.heroeswm.ru/group_wars.php
*/
function PageGroupWars(doc, game) {

    this.constructor.parent.prototype.constructor.apply(this, arguments);
    
    this.nodes.content = null;
    this.nodes.table = null;
    
    this.battles = [];
    this.heroBattleId = null;
    
}


PageGroupWars.extends(Page);


/** Парсинг страницы
* @return Boolean Результат
*/
PageGroupWars.prototype.parse = function() {
    ...
    try {
        ...
        if (!this.parseContent())
            throw new Error('Ошибка распознавания содержимого');
...
* @return Boolean Результат
*/
PageGroupWars.prototype.parseContent = function() {
    
    try {
    
        this.nodes.content = XPath.findFirst('/html/body/center/table/tbody/tr/td/table/tbody/tr/td', this.doc);
        if (this.nodes.content === null)
            throw new Error('Содержимое не надено');
        
        var nodes = this.nodes.content.childNodes;
        for (var i = 0; i < nodes.length; i++) {

            if (this.nodes.table === null)
                if (this.parseTable(nodes[i]))
                    continue;
                    
        }

        if (this.nodes.table === null)
            throw new Error('Таблица боев не найдена');
...
/** Парсинг таблицы заявок
* @param Element table Элемент
* @return Boolean Результат
*/
PageGroupWars.prototype.parseTable = function(table) {
    try {
        ...
        for (var i = 0; i < table.rows.length; i++) {
            ...
            // Парсим заявку
            var battle = null;
            var text = String.trim(row.cells[3].textContent);
            try {
                switch (text) {
                    case 'Охотник': battle = this.parseRowHunter(row); break;
                    case 'По желанию': battle = this.parseRowOptional(row); break;
                    case 'По желанию+exp': battle = this.parseRowOptional(row); break;
                    case 'Равномерно': battle = this.parseRowEvenly(row); break;
                    case 'Равномерно+exp': battle = this.parseRowEvenly(row); break;
                    case 'Каждый сам за себя': battle = this.parseRowOneself(row); break;
                    case 'Каждый сам за себя+exp': battle = this.parseRowOneself(row); break;
                    case 'Случайно': battle = this.parseRowRandom(row); break;
                    case 'Случайно+exp': battle = this.parseRowRandom(row); break;
                }
            } catch (e) {
                GM_log(Time.toString() + ' Ошибка анализа заявки типа "' + text + '":\n' + e.message);
                continue;
            }
            ...
            this.battles[this.battles.length] = battle;
            
            // Проверяем, подписан ли игрок на заявку
            var bgcolor = row.cells[0].getAttribute('bgcolor');
            if (bgcolor == '#FDFFD7')
                this.heroBattleId = this.battles.length - 1;
...
* @return Object
*/
PageGroupWars.prototype.newBattle = function(row) {
    
    var battle = {
        row: row,
        typeId: null,
        timeText: String(row.cells[0].textContent),
        countText: String(row.cells[1].textContent),
        levelsText: String(row.cells[2].textContent),
        typeText: String(row.cells[3].textContent),
        delayText: String(row.cells[4].textContent),
        descText: String(row.cells[5].textContent),
        descHtml: String(row.cells[5].innerHTML),
        playersText: String(row.cells[6].textContent),
        playersHtml: String(row.cells[6].innerHTML),
        players: [],
        urls: [],
        enabled: false,
        auto: false
    ...
    // Проверка на автобой
    var re = new RegExp('авто');
    battle.auto = re.test(battle.delayText);
    
    // Проходимся по всем ссылкам
    var refs = row.cells[6].getElementsByTagName('A');
    for (var i = 0; i < refs.length; i++) {
        
        // Если это ссылка на вступление в бой
        if (Page.isBattleGroupJoinURL(refs[i].href) === true) {
            battle.enabled = true;
            battle.urls[battle.urls.length] = refs[i].href;
            continue;
        }
        
        // Если это ссылка на игрока
        var player = Page.parsePlayerURL(refs[i].href);
        if (player !== null) {
            try {
                player.url = refs[i].href;
                player.name = refs[i].textContent;
                var res = /\[(\d+)\]/ig.exec(refs[i].nextSibling.textContent);
                player.level = Number(res[1]);
            } catch (e) {
                // Do nothing
            }
            battle.players[battle.players.length] = player;
            continue;
        }
...
/** Парсинг строки заявки Охотник
* @param Element row
* @return Object
*/
PageGroupWars.prototype.parseRowHunter = function(row) {
    
    var battle = this.newBattle(row);
    battle.typeId = 'hunter';
    battle.creatureName = null;
    battle.creatureCount = null;
    battle.regionText = null;
    
    // Анализ существ
    try {
        // <a class="pi" href="pl_info.php?id=1885621"><font color="red">царь-гоблинов</font></a><font color="red">[9]&nbsp;<img src="http://im.heroeswm.ru/i/r5.gif" title="Варвар" height="15" align="absmiddle" border="0" width="15"></font> vs <i><font color="black">Рогатые демоны(1257)</font></i>
        var fonts = row.cells[6].getElementsByTagName('FONT');
        var text = fonts[fonts.length - 1].textContent;
        var res = /(.+)\((\d+)\)/ig.exec(text);
        battle.creatureName = res[1];
        battle.creatureCount = Number(res[2]);
    } catch (e) {
        throw new Error('Ошибка анализа существ');
    }
    
    // Анализ района
    try {
        battle.regionText = battle.descText;
    } catch (e) {
...
/** Парсинг строки заявки По желанию
*/
PageGroupWars.prototype.parseRowOptional = function(row) {

    var battle = this.newBattle(row);
    battle.typeId = 'optional';
...
/** Парсинг строки заявки Равномерно
*/
PageGroupWars.prototype.parseRowEvenly = function(row) {
    
    var battle = this.newBattle(row);
    battle.typeId = 'evenly';
...
/** Парсинг строки заявки Каждый сам за себя
*/
PageGroupWars.prototype.parseRowOneself = function(row) {
    
    var battle = this.newBattle(row);
    battle.typeId = 'oneself';
...
/** Парсинг строки заявки Случайно
*/
PageGroupWars.prototype.parseRowRandom = function(row) {

    var battle = this.newBattle(row);
    battle.typeId = 'random';
...
/** Представление в строке
*/
PageGroupWars.prototype.toString = function() {
    var str = 'Парсер страницы групповых боев';
    if (this.doc.location === null)
        return str;
    return str + '\n' + this.doc.location.href;
}
...
/** Файл описания одноименного класса.
*
* @file pagePlayerInfo.js
* @version 2.6.0
* @author hotamateurxxx
* @link http://userscripts.org/users/362572
* @license GPL
...
* @link http://www.heroeswm.ru/pl_info.php?nick=*
*/
...
PagePlayerInfo.prototype.truncate = function() {
    ...
    try {
        ...
        if (this.nodes.content === null)
            throw new Error('Не могу найти содержимое для урезания');
...
PagePlayerInfo.prototype.parseContent = function() {
    this.nodes.content = XPath.findFirst('/html/body/center/table/tbody/tr/td', this.doc);
    if (this.nodes.content === null)
        return false;
    ...
    // Следующей может идти таблица подарков
    if (this.parseTableGifts(tables[i]))
        i++;    
...
PagePlayerInfo.prototype.parseTableBase = function(table) {
    ...
    var str = table.rows[0].cells[0].firstChild.firstChild.textContent;
    var matches = /(\S.+\S)\s+\[(\d+)\]/g.exec(str);
    if (matches !== null) {
        this.playerName = matches[1];
        this.playerLevel = matches[2];
    }
...
PagePlayerInfo.prototype.parseTableSkills = function(table) {
    try {
        ...
        this.parsePlayerSkills();
        this.parsePlayerGuilds();
...
*/
PagePlayerInfo.prototype.parsePlayerSkills = function() {
    var nodes = this.nodes.playerSkills.childNodes;
    for (var i = 0; i < nodes.length; i++) {
        ...
        if (this.playerSkills === null)
            this.playerSkills = [];
        this.playerSkills[this.playerSkills.length] = playerSkill;
        
        /*
        GM_log(
            this.playerSkills[this.playerSkills.length - 1][0] + ': ' +
            this.playerSkills[this.playerSkills.length - 1][1]
        );
        */
...
*/
PagePlayerInfo.prototype.parsePlayerGuilds = function() {
    // Do nothing by now
}
...
* @param Node table
*/
PagePlayerInfo.prototype.parseTableGifts = function(table) {
    try {
...
PagePlayerInfo.prototype.parsePlayerResources = function() {
    try {
        ...
        GM_log(
            this + '\n' + 
            'Ошибка распознования баланса игрока' + '\n' +
            e
        );
...
PagePlayerInfo.prototype.toString = function() {
    var str = 'Парсер страницы информации об игроке';
    if (this.doc.location === null)
        return str;
    return str + '\n' + this.doc.location.href;
}
...
/** @todo Сделать проверку на сложность охоты используя страницу 
* "http://www.heroeswm.ru/pl_hunter_stat.php?id=<playerId>"
*/
...
if (window === top) {
    ...
    var desc = {
        'details':
              '<ul>'
            + '<li>При наличии на странице ярлыка "Охотнику нужна помощь" создает всплывающее окно с указанием игрока, существ и ссылкой прямо на бой.</li>'
            +'</ul>',
    ...
    var conf = {
        ...
        //'autojoin': {'title': 'Автовход', 'type': 'bool', 'def': false, 'desc': 'Автоматический вход в ответ на запрос помощи в охоте.'},
        //'showall': {'type': 'bool', 'title': 'Показывать все', 'def': false, 'desc': 'Показывать все заявки на помощь (а не только те, в которых можно принять участие).'},
        'preview': {'type': 'bool', 'title': 'Предпросмотр', 'def': false, 'desc': 'Предпросмотр героя с всплывающего окна.'},
        'reloadTime': {'title': 'Время перезагрузки', 'def': 0, 'desc': 'Время перезагрузки страницы в секундах (0 - отключено).'},
        //'creatureMaxMult': {'title': 'Макс. коэф. количества', 'def': 2.0, 'desc': 'Максимальное соотношение количества существ на охоте к количеству убитых в одиночку существ для автоматического входа'},
    }
...
/** Обработчик загрузки страницы групповых боев
* @param Document resp
*/
function onGroupWarsLoad(doc) {
    
    var page = new PageGroupWars(doc);
    page.parse();
    top.document.title = PageState.getPageTitle(undefined, page.state);
...
/** Проверка страницы групповых боев
* @param Page page
*/
function checkGroupWars(page) {

    // Удаление старых сообщений
    if ((page.doc.location === null) || (window !== top))
        tgui.destroyPopupClass('GroupHunt');
    
    var playerId = GM_getValue('playerId', false);
    var autojoin = GM_getValue('autojoin', false);
    var showall = GM_getValue('showall', false);
    var preview = GM_getValue('preview', false);
    var joinTimeMap = GreaseMonkey.loadObject('joinTimeMap', {});
    
    for (var i = 0; i < page.battles.length; i++) {
        var battle = page.battles[i];
        if (battle.typeId != 'hunter')
            continue;
        
        var logMessage = 'Помощь ' + battle.players[0].name + ' в охоте на ' + battle.creatureName + ' (' + battle.creatureCount + ').';
        
        // Создание уведомления
        if ((page.doc.location === null) || (window !== top)) {
            if ((showall) || (battle.enabled)) {
                var popup = tgui.createPopup(['GroupHunt' + battle.players[0].id], 'Помощь охотнику в <b>' + battle.regionText + '</b>', battle.timeText + ' ' + battle.playersHtml);
                $('.Header', popup).css({'font-weight': 'normal'});
                popup.attr('popupClass', 'GroupHunt');
                
                if (preview) {
                    var refs = $('a', popup);
                    for (var j = 0; j < refs.length; j++)
                        UIHeroPreview(refs.get(j), false, true, true, true, false);
                }
            }
        }
        
        var lastJoin = Number(GM_getValue('lastJoin', 0));
        var joinTime = (joinTimeMap[battle.players[0].id] !== undefined) ? joinTimeMap[battle.players[0].id] : 0;
        
        // Проверка удачно ли был проведен прошлый заход
        if (lastJoin == battle.players[0].id)
            if (Time.toNumber() - joinTime < 10)
                if (battle.enabled) {
                    GreaseMonkey.log(logMessage + ' Не удалось вступить.');
                } else {
                    GreaseMonkey.log(logMessage + ' Заявка подана.');
                    // Снимаем флаг обработанной ссылки
                    GM_setValue('huntHandled', false);
                }
        
        // Исключение двойного перенаправления (таймаут 10 сек)
        if (Time.toNumber() - joinTime < 10)
            continue;
        
        // Автоматический вход в охоту
        if (autojoin)
            if (battle.enabled) {
                
                var creatureMaxMult = GM_getValue('creatureMaxMult', 2.0);    
                var maxCountMap = GreaseMonkey.loadObject('maxCountMap', {});
                
                if (maxCountMap[battle.creatureName] == undefined) {
                    
                    GreaseMonkey.log(logMessage + ' Отказано: неизвестные существа.');
                   
                } else {
                    
                    var creatureMult = battle.creatureCount / maxCountMap[battle.creatureName];
                    if (creatureMult > creatureMaxMult) {
                        
                        GreaseMonkey.log(logMessage + ' Отказано: существ слишком много (в одиночку макс. ' + maxCountMap[battle.creatureName] + ').');
                        
                    } else {
                        
                        GreaseMonkey.log(logMessage + ' Принято.');
                        joinTimeMap[battle.players[0].id] = Time.toNumber();
                        GreaseMonkey.saveObject('joinTimeMap', joinTimeMap);
                        GM_setValue('lastJoin', battle.players[0].id);
                        GreaseMonkey.loadDoc(battle.urls[0], onGroupWarsLoad);
                        break;
...
if (!disabled) {
    ...
    // На странице рекордов игрока
    if (url.attr('path') == '/pl_hunter_stat.php')
        if (url.param('id') == GM_getValue('playerId'))
            try {
                
                // Ищем таблицу достижений
                var xpath = '/html/body/center/table/tbody/tr/td/table/tbody/tr[2]/td/table';
                var node = XPath.findFirst(xpath, document);
                if (node == null)
                    throw new Error('Не удается разобрать страницу личных достижений на охоте.');
                
                // Запоминаем всех существ
                var maxCountMap = {};
                for (var i = 1; i < node.rows.length; i++) {
                    
                    var href = $('a', node.rows[i].cells[0]).attr('href');
                    var res = /name=(.+)/ig.exec(href);
                    var name = res[1];
                    var title = String.trim($(node.rows[i].cells[0]).text());
                    var maxCount = Number($(node.rows[i].cells[2]).text());
                    maxCountMap[title] = maxCount;
                    
                }
                GreaseMonkey.saveObject('maxCountMap', maxCountMap);
    ...
    // Если мы зашли на страницу групповых боев
    if (url.attr('path') == '/group_wars.php') {
        
        var page = new PageGroupWars(document);
        page.parse();
        top.document.title = PageState.getPageTitle(undefined, page.state);
        ...
        if (page.state === 1)
            if (window === top) {
                ...
                var reloadTime = Number(GM_getValue('reloadTime', 0));
                if (reloadTime > 0) {
                    
                    // Кнопка обновления страницы групповых боев
                    var reloadEnabled = GM_getValue('reloadEnabled', true);
                    var bReload = gui.createMenuButton(['HuntReload'], 'Обновление');
                    bReload.css({'color': reloadEnabled ? 'black' : 'silver'});
                    bReload.click(function() { 
                        var reloadEnabled = GM_getValue('reloadEnabled', true);
                        reloadEnabled = !reloadEnabled;
                        GM_setValue('reloadEnabled', reloadEnabled);
                        GreaseMonkey.log('Собственное обновление страницы групповых боев ' + (reloadEnabled ? 'включено' : 'выключено') + '.');
                        bReload.css({'color': reloadEnabled ? 'black' : 'silver'});
                    });
                    var reloadCounter = reloadTime;
                    setInterval(function () {reloadCounter--; bReload.val('Обновление' + (reloadEnabled ? ' (' + reloadCounter + ')' : ''));}, 1000);
                    var reloadEnabled = GM_getValue('reloadEnabled', true);
                    if (reloadEnabled) {
                        setTimeout(
        ...
        // Анализируем любую другую страницу
        ...
        if (page.state === 1) {
            ...
            // Если на странице есть ссылка 'Охотнику нужна помощь'
            if (page.groupJoinHunt) {
                
                // Обработана ли ссылка?
                var huntHandled = GM_getValue('huntHandled', false);
                if (!huntHandled) {
                    // Помечаем ссылку как обработанную
                    GM_setValue('huntHandled', true);
                    GreaseMonkey.log('Охотнику нужна помощь.');
                    var src = 'http://' + document.location.hostname + '/group_wars.php?filter=hunt';
                    GreaseMonkey.loadDoc(src, onGroupWarsLoad);
                }
    ...
    // Кнопка отключеня автовхода
    if (window === top) {
        
        if (conf.autojoin !== undefined) {
            var autojoin = GM_getValue('autojoin', false);
            var bAuto = gui.createMenuButton(['HuntAutoJoin'], 'Помощь на охоте');
            bAuto.css({'color': autojoin ? 'black' : 'silver'});
            bAuto.click(function() { 
                var autojoin = GM_getValue('autojoin', false);
                autojoin = !autojoin;
                GM_setValue('autojoin', autojoin);
                GreaseMonkey.log('Автоматический вход на помощь в охоте ' + (autojoin ? 'включен' : 'выключен') + '.');
                bAuto.css({'color': autojoin ? 'black' : 'silver'});
            });
        }
