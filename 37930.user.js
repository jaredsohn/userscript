// ==UserScript==
// @name           customizeGoogle - UK
// @namespace      Blake123
// @include        http://www.google.co.uk/
// @include       http://images.google.co.uk/imghp?hl=en&tab=wi
// @include        http://www.google.co.uk/webhp?hl=en&tab=iw
// @include        http://images.google.co.uk/
// @include        http://images.google.co.uk/imghp?hl=en&*
// ==/UserScript==

var name = "Blake"; //Your Name
var initial = "B"; //Your First Initial of your first name
var picLoc = "http://blakehymer.homedns.org/scripts/blak.bmp"; //src location of the picture that will replace the Google image
