// ==UserScript==
// @name        Webbox-192.168.1.168/plant_devices
// @namespace   Webbox
// @description Tracker Numbers in webbox
// @include     http://192.168.1.168/plant_devices_devfrm_multi.htm?DevKey=Sunny%20Tripower&DevClass=Sunny%20Tripower&group=CLASS
// @version     1
// ==/UserScript==
function do_platypus_script() {
html_insert_it(window.document,document.evaluate('/HTML[1]/BODY[1]/DIV[2]/TABLE[1]/TBODY[1]/TR[1]/TD[3]/A[1]', document, null, XPathResult.FIRST_ORDERED_NODE_TYPE,null).singleNodeValue,'3_',true,false);
html_insert_it(window.document,document.evaluate('/HTML[1]/BODY[1]/DIV[2]/TABLE[1]/TBODY[1]/TR[2]/TD[3]/A[1]', document, null, XPathResult.FIRST_ORDERED_NODE_TYPE,null).singleNodeValue,'6_',true,false);
html_insert_it(window.document,document.evaluate('/HTML[1]/BODY[1]/DIV[2]/TABLE[1]/TBODY[1]/TR[3]/TD[3]/A[1]', document, null, XPathResult.FIRST_ORDERED_NODE_TYPE,null).singleNodeValue,'1_',true,false);
html_insert_it(window.document,document.evaluate('/HTML[1]/BODY[1]/DIV[2]/TABLE[1]/TBODY[1]/TR[4]/TD[3]/A[1]', document, null, XPathResult.FIRST_ORDERED_NODE_TYPE,null).singleNodeValue,'2_',true,false);
html_insert_it(window.document,document.evaluate('/HTML[1]/BODY[1]/DIV[2]/TABLE[1]/TBODY[1]/TR[5]/TD[3]/A[1]', document, null, XPathResult.FIRST_ORDERED_NODE_TYPE,null).singleNodeValue,'4_',true,false);
html_insert_it(window.document,document.evaluate('/HTML[1]/BODY[1]/DIV[2]/TABLE[1]/TBODY[1]/TR[6]/TD[3]/A[1]', document, null, XPathResult.FIRST_ORDERED_NODE_TYPE,null).singleNodeValue,'5_',true,false);
