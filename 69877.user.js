// ==UserScript==
// @author         ulla_ca
// @name           Komando Militer
// @namespace      http://www.erepublik.com/en/organization/1859111
// @description    Liat aja sendiri efeknya bro...!!! 
// @version        1.0.1
...
// ===============================================================================
// sy tidak bertanggung jawab akan kehancuran yang anda akan alami
// wkwkwkwk :P
// ===============================================================================

var html = '<embed width="500" height="30" src="/flash/delicious.swf" quality="best" flashvars="txt=Komando Militer by. ulla ca&amp;&amp;textcolor=#737373&amp;hovercolor=null&amp;linkcolor=null&amp;w=250&amp;h=28" wmode="transparent" bgcolor="transparent" sifr="true" type="application/x-shockwave-flash" class="sIFR-flash" style="width: 250px; height: 28px;"/>'
var nCitizens
var count = 0
...
function fetchCitizensWellness (ids)
{
	...
	html += '<table style="color: rgb(153, 153, 153);"><tr><th style="background: rgb(220,220,220);padding:2px">Name</th><th style="text-align:center;background: rgb(220,220,220);padding:2px">Wellness</th><th style="text-align:center;background: rgb(220,220,220);padding:2px">Location</th><th style="text-align:center;background: rgb(220,220,220);padding:2px">Strength</th><th style="text-align:center;background: rgb(220,220,220);padding:2px">Rank</th><th style="text-align:center;background: rgb(220,220,220);padding:2px">Damage</th><th style="text-align:center;background: rgb(220,220,220);padding:2px">Donate</th><th style="text-align:center;background: rgb(220,220,220);">&nbsp;Message</th><th style="text-align:center;background: rgb(220,220,220);">'+
		'&nbsp;Delete</th><th style="text-align:center;background: rgb(220,220,220);padding:2px">Weapon</th><th style="text-align:center;background: rgb(220,220,220);padding:2px">Damage per Fight</th><th style="text-align:center;background: rgb(220,220,220);padding:2px">Fights</th><th style="text-align:center;background: rgb(220,220,220);padding:2px">Total Damage</th></tr>'
    ...
    GM_xmlhttpRequest(
        {
            ...
            onload:function(response)
            {
				...
				try {
					...
					html += '<tr><td style="text-align:left"><a href="http://www.erepublik.com/citizen/images?id='+Citizen.id+'" target="_blank"><img src="'+Citizen.avatar_link+'" height="14" width="14"><a href="/en/citizen/profile/'+Citizen.id+'">'+Citizen.name+'</a></td><td style="text-align:center">'+Citizen.wellness+
				...
				if (++count==nCitizens) {
					...
					html+= '<form id="CitizenForm" action="#">'+
						'<input type="text" name="fname" id="newCitizen" /><input type="submit" value="add more"/>UPDATE: use Ids, no Names</form> '
...
//
// v1.0.1          25/02/2010       semuanya sudah saya update jadi rasakan sendiri bruuu
//-------------------------------------------------------------------------------------------------------