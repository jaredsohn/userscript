// ==UserScript==
// @name           Smoother yahoo sign in page
// @namespace      jksnc
// @include        https://login.yahoo.com/config/mail?.intl=us
// ==/UserScript==

// ==UserScript==
// @name            Platypus-/login.yahoo.com/config/
// @namespace       Platypus
// @include         https://login.yahoo.com/config/mail?.intl=us
function do_platypus_script() {
isolate(window.document,document.evaluate('/HTML[1]/BODY[1]/DIV[1]/DIV[1]/DIV[1]/DIV[1]/DIV[1]', document, null, XPathResult.FIRST_ORDERED_NODE_TYPE,null).singleNodeValue,null,null,null);
