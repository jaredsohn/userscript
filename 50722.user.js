...
var chatURL = GM_getValue('chatURL', 'http://www.ricoshive.pl/ergichat/chat/');
...
var lang={
  ...
  dk: {'send': 'sende', 'sh': 'Vis/Skjul', 'msg': 'Besked...', 'cnf': 'Configuration', 'switch': 'Skift Chatrum', 'dele': 'Slet Chatrum', 'add': 'Tilfoj Chatrum', 'err_noname': 'Tekst er pakravet!', 'room_alredy_present': 'Chatrummet findes allerede'},
  ...
  it: {'send': 'Invia', 'sh': 'Visualizza/Nascondi', 'msg': 'Messaggio...', 'cnf': 'Configurazione', 'switch': 'Cambia Chat Room', 'dele': 'Elimina Chat Room', 'add': 'Aggiungi Chat Room', 'err_noname': 'Testo necessario!', 'room_alredy_present': 'Chat Room gia presente'},

  gr: {'send': '????????', 'sh': '?µ?????? ????????', 'msg': '????µ?...', 'cnf': 'Configuration', 'switch': 'Change Chat Room', 'dele': 'Delete Chat Room', 'add': 'Add Chat Room', 'err_noname': 'Text is mandatory!', 'room_alredy_present': 'Chat Room already present'},

  jp: {'send': '??', 'sh': '??/???', 'msg': '???—?...', 'cnf': 'Configuration', 'switch': 'Change Chat Room', 'dele': 'Delete Chat Room', 'add': 'Add Chat Room', 'err_noname': 'Text is mandatory!', 'room_alredy_present': 'Chat Room already present'},
  ...
  ru: {'send': '?????????', 'sh': '????????/??????', 'msg': '?????????...', 'cnf': '?????????', 'switch': '???????? ???', 'dele': '??????? ???', 'add': '???????? ???', 'err_noname': 'Text is mandatory!', 'room_alredy_present': '????? ??? ??? ???????????'},
