...
// @name        fire-ptc
// @namespace   fire-ptc
// @include     *://*fire-ptc.com/index.php?view=account&ac=click*
// @include     *://*fire-ptc.com/gpt.php?v=entry*
...
if(wparent.location.href.indexOf('index.php?view=account') != -1 && top == self){
	var arr = [],ctr = 0;
	var div = $('<div>');
	var clickNum = ctr + 1 ;
	var loading = 0;
