// ==UserScript==
// @name           HiG - (fronter) - Auto-Login
// @namespace      HigG - (fronter) - Auto-Login
// @description    Auto login for fronter.com/hig (HiG, Norway)
// @include        *://fronter.com/hig/*
// ==/UserScript==
...
if(!html.match(/fronter_main_frameset/) && html.match(/Om personopplysninger i Fronter/)) {
	for(i=0;i<document.getElementsByTagName('input').length;i++) {
		if(document.getElementsByTagName('input')[i].name=="username") {
			...
			for(i=0;i<document.getElementsByTagName('form').length;i++) {
				if(document.getElementsByTagName('form')[i].action=="https://fronter.com/hig/main.phtml") {
