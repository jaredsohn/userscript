// ==UserScript==
// @name           Organized Crime Tools
// @namespace      mat
// @include        http://*.kingdomsofcamelot.com/*main_src.php*
// @resource       PROTOTYPEJS   
...
//logit ('g_timeoff: '+ unsafeWindow.g_timeoff);
  ...
  GM_addStyle ('.xtab {padding-right: 5px; border:none; background:none; white-space:nowrap;}\
    ...
    .ptstat {border:1px solid; border-color:#ffffff; font-weight:bold; padding-top:2px; padding-bottom:2px; text-align:center; color:#ffffff; background-color:#347}\
  ...
  try {
    ...
    pop.getTopDiv().innerHTML = '<CENTER>OC Tools ERROR!</center>';
    pop.getMainDiv ().innerHTML = '<DIV style="font-size:18px; font-weight:bold;"><CENTER><p>The dependency "prototype.js" was not found.<BR> Please reinstall Organized Crime Tools <A HREF="http://userscripts.org/scripts/show/92347">here.</a></div>';
...
//FoodAlerts.init();
  ...
  AddMainTabLink('Organized Crime', eventHideShow, mouseMainTab);
}
