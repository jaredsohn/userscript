// ==UserScript==
// @name          TribalWars.it Navigation Toolbar v0.1
// @namespace     http://otinademoniac.spaces.live.com/
// @description   Fatto da O.T.Nad! Garanzia...
// @include       http://w*.tribalwars.it/game.php*
// ==/UserScript==
  ...
  //if (GM_getValue('villageDropdown') == null) {
    ...
    $.get(gameURL,
      ...
      function(data) {
        ...
        pTable.innerHTML = sDropDown + '</select> - <a href="'+gameURL+'&screen=overview_villages">Miei Villaggi</a> - <a href="'+gameURL+'&screen=map">Mappa</a> - <a href="'+gameURL+'&screen=overview">Cartina Villaggio</a>';
      }
    );
  //}
}
...
/* Forum */
menuBarTop += '    <li><a class="hide" href="http://board.tribalwars.it/">Forum</a></li>';

/* Chat */
menuBarTop += '    <li><a class="hide" href="chat.php">Chat</a></li>';

/* Settings */
menuBarTop += '    <li><a class="hide" href="'+gameURL+'&screen=settings">Impostazioni</a>';
menuBarTop += '    	<ul>';
menuBarTop += '       <li><a href="help.php">Aiuto</a></li>';
menuBarTop += '      	<li><a href="'+gameURL+'&screen=settings&mode=profile">Profilo</a></li>';
menuBarTop += '      	<li><a href="'+gameURL+'&screen=settings&mode=email">Email</a></li>';
menuBarTop += '      	<li><a href="'+gameURL+'&screen=settings&mode=settings">Impost.</a></li>';
menuBarTop += '      	<li><a href="'+gameURL+'&screen=settings&mode=move">Re Inizia</a></li>';
menuBarTop += '      	<li><a href="'+gameURL+'&screen=settings&mode=delete">Canc Acct</a></li>';
menuBarTop += '      	<li><a href="'+gameURL+'&screen=settings&mode=share">Cond Conn</a></li>';
...
menuBarTop += '      	<li><a href="'+gameURL+'&screen=settings&mode=change_passwd">Cambia Pass</a></li>';
menuBarTop += '      	<li><a href="'+gameURL+'&screen=settings&mode=poll">Sondaggi</a></li>';
menuBarTop += '      </ul>';
menuBarTop += '    </li>';

/* Ranking */
menuBarTop += '    <li><a class="hide" href="'+gameURL+'&screen=ranking">Classifica</a>';
menuBarTop += '    	<ul>';
menuBarTop += '      	<li><a href="'+gameURL+'&screen=ranking&mode=ally">Tribu</a></li>';
menuBarTop += '      	<li><a href="'+gameURL+'&screen=ranking&mode=player">Giocatori</a></li>';
menuBarTop += '      	<li><a href="'+gameURL+'&screen=ranking&mode=con_ally">Cont Tribu</a></li>';
menuBarTop += '      	<li><a href="'+gameURL+'&screen=ranking&mode=con_player">Cont Gioc</a></li>';
menuBarTop += '      	<li><a href="'+gameURL+'&screen=ranking&mode=kill_player">Sconfitti</a></li>';
menuBarTop += '      </ul>';
menuBarTop += '    </li>';
...
menuBarTop += '    	<ul>';
menuBarTop += '      	<li><a href="'+gameURL+'&screen=ally&mode=overview">Riepilogo</a></li>';
menuBarTop += '      	<li><a href="'+gameURL+'&screen=ally&mode=profile">Profilo</a></li>';
menuBarTop += '      	<li><a href="'+gameURL+'&screen=ally&mode=members">Membri</a></li>';
menuBarTop += '      	<li><a href="'+gameURL+'&screen=ally&mode=contracts">Diplomazia</a></li>';
menuBarTop += '      	<li><a href="'+gameURL+'&screen=ally&mode=invite">Inviti</a></li>';
...
menuBarTop += '    <li><a class="hide" href="'+gameURL+'&screen=report">'+newReport+'Resoconti</a>';
menuBarTop += '    	<ul>';
menuBarTop += '      	<li><a href="'+gameURL+'&screen=report&mode=all">Tutti</a></li>';
menuBarTop += '      	<li><a href="'+gameURL+'&screen=report&mode=attack">Attacchi</a></li>';
menuBarTop += '      	<li><a href="'+gameURL+'&screen=report&mode=defense">Difese</a></li>';
menuBarTop += '      	<li><a href="'+gameURL+'&screen=report&mode=support">Supporti</a></li>';
menuBarTop += '      	<li><a href="'+gameURL+'&screen=report&mode=trade">Commerci</a></li>';
menuBarTop += '      	<li><a href="'+gameURL+'&screen=report&mode=other">Varie</a></li>';
menuBarTop += '      	<li><a href="'+gameURL+'&screen=report&mode=forwarded">Inoltrato</a></li>';
menuBarTop += '      	<li><a href="'+gameURL+'&screen=report&mode=filter">Filtro</a></li>';
menuBarTop += '      	<li><a href="'+gameURL+'&screen=report&mode=block">Blocca Mittente</a></li>';
menuBarTop += '      </ul>';
menuBarTop += '    </li>';
...
menuBarTop += '    <li style="border-right:2px solid #804000"><a class="hide" href="'+gameURL+'&screen=mail">'+newMail+'Posta</a>';
menuBarTop += '    	<ul>';
menuBarTop += '      	<li><a href="'+gameURL+'&screen=mail&mode=in">Posta</a></li>';
menuBarTop += '      	<li><a href="'+gameURL+'&screen=mail&mode=mass_out">Circolari Mail</a></li>';
menuBarTop += '      	<li><a href="'+gameURL+'&screen=mail&mode=new">Scrivi Msg</a></li>';
menuBarTop += '      	<li><a href="'+gameURL+'&screen=mail&mode=block">Blocca utente</a></li>';
menuBarTop += '      </ul>';
menuBarTop += '    </li>';
...
menuBar += '    	<ul>';
menuBar += '      	<li><a href="'+gameURL+'&screen=main&mode=build">Costruisci</a></li>';
menuBar += '      	<li><a href="'+gameURL+'&screen=main&mode=destroy">Demolisci</a></li>';
menuBar += '      </ul>';
menuBar += '    </li>';

/* Barracks */
menuBar += '    <li><a class="hide" href="'+gameURL+'&screen=barracks"><img src="'+baseURL+'/graphic/buildings/barracks.png" border="0">&nbsp;Caserma</a></li>';

/* Stable */
menuBar += '    <li><a class="hide" href="'+gameURL+'&screen=stable"><img src="'+baseURL+'/graphic/buildings/stable.png" border="0">&nbsp;Stalla</a></li>';

/* Workshop */
menuBar += '    <li><a class="hide" href="'+gameURL+'&screen=garage"><img src="'+baseURL+'/graphic/buildings/garage.png" border="0">&nbsp;Officina</a></li>';

/* Academy */
menuBar += '    <li><a class="hide" href="'+gameURL+'&screen=snob"><img src="'+baseURL+'/graphic/buildings/snob.png" border="0">&nbsp;Acc.</a>';
menuBar += '    	<ul>';
menuBar += '      	<li><a href="'+gameURL+'&screen=snob&mode=fetch">Crea Nobili</a></li>';
menuBar += '      </ul>';
menuBar += '    </li>';

/* Smithy */
menuBar += '    <li><a class="hide" href="'+gameURL+'&screen=smith"><img src="'+baseURL+'/graphic/buildings/smith.png" border="0">&nbsp;Fabbro</a></li>';

/* Rally Point */
menuBar += '    <li><a class="hide" href="'+gameURL+'&screen=place"><img src="'+baseURL+'/graphic/buildings/place.png" border="0">&nbsp;Raduno</a>';
menuBar += '    	<ul>';
menuBar += '      	<li><a href="'+gameURL+'&screen=place&mode=command">Comandi</a></li>';
menuBar += '      	<li><a href="'+gameURL+'&screen=place&mode=units">Truppe</a></li>';
menuBar += '      	<li><a href="'+gameURL+'&screen=place&mode=sim">Simulatore</a></li>';
menuBar += '      </ul>';
menuBar += '    </li>';

/* Market */
menuBar += '    <li style="border-right:2px solid #804000"><a class="hide" href="'+gameURL+'&screen=market"><img src="'+baseURL+'/graphic/buildings/market.png" border="0">&nbsp;Mercato</a>';
menuBar += '    	<ul>';
menuBar += '      	<li><a href="'+gameURL+'&screen=market&mode=send">Manda Ris.</a></li>';
menuBar += '      	<li><a href="'+gameURL+'&screen=market&mode=own_offer">Tue Offerte</a></li>';
menuBar += '      	<li><a href="'+gameURL+'&screen=market&mode=other_offer">Altre Offerte</a></li>';
menuBar += '      	<li><a href="'+gameURL+'&screen=market&mode=traders">Mercanti</a></li>';
menuBar += '      </ul>';
menuBar += '    </li>';
menuBar += '  </ul>';
menuBar += '</div>';
