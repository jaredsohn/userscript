// ==UserScript==
// @name           OGame Redesign: Fleet Expedition.
// @namespace      userscripts.org
// @description   Easy to send best expedition fleet.
// @version        0.1
...
// ЗС 9000
	...
	try {
        ...
        if (document.location.href.indexOf('page=fleet1') > -1) 
        {
            ...
            var tit01='|'+name203+' : 37<br />'+name205+' : 64<br />'+name210+' : 1<br />'+name213+' : 0';
var tit02='|'+name203+' : 35<br />'+name205+' : 66<br />'+name210+' : 1<br />'+name213+' : 2';
            ...
            expofleet.innerHTML =   '<table><tr>'+
                                    ...
                                    '<td><BUTTON TYPE="SUBMIT" ONCLICK="alert(0); return false;"  id="efbut0"  style="position: relative; left: 24px; top: 2px" class="tipsStandard" title="'+tit01+'"> 37/66/1/0</BUTTON></td>'+
                                    '<td><BUTTON TYPE="SUBMIT" ONCLICK="alert(0); return false;"  id="efbut01" style="position: relative; left: 28px; top: 2px" class="tipsStandard" title="'+tit02+'"> 37/64/1/2</BUTTON></td>'+
                                                                      '</tr></table>';
            ...
            expscript.innerHTML = '\n'+
                "document.getElementById('efbut0').onclick=function(){\n"+
                    ...
                    "document.getElementById('ship_205').value = 66;\n"+
                    "document.getElementById('ship_205').onchange();\n"+
                    "document.getElementById('ship_203').value = 37;\n"+
            ...
            expscript.innerHTML = '\n'+
                "document.getElementById('efbut01').onclick=function(){\n"+
                    "document.getElementById('ship_210').value = 1;\n"+
                    "document.getElementById('ship_210').onchange();\n"+
                    "document.getElementById('ship_213').value = 2;\n"+
                    "document.getElementById('ship_213').onchange();\n"+
                    "document.getElementById('ship_205').value = 64;\n"+
                    "document.getElementById('ship_205').onchange();\n"+
                    "document.getElementById('ship_203').value = 37;\n"+
                    "document.getElementById('ship_203').onchange();\n"+
                    "document.getElementsByName('mission')[0].value = 15;\n"+
