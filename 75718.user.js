// ==UserScript==
// @name         		Perfil de banda Deluxe mendigogame V4
// @namespace    by basti1012 & Updated by niceguy0815, tralated by joak.i.ng (visita http://pennerhack.forren-city.de)
// @description  Muestra informacion avanzada sobre la banda
// @version		 	2.6
// @include      		http://www.faveladogame.com.br/profil/bande*
			...
			var username = document.getElementById('angreifen'+x).getAttribute('username')
					if ((minPts <= points) && (points <= maxPts) && (parseInt(points - points * 0.2) > pts)) {
					  ...
					  document.getElementById('angreifen'+x).innerHTML = '\<a href="'+link+'/fight/?to='+username+'">'+
																															 ...
																															 " alt=\"Vulnerable\" title=\"Você pode atacar, mas tem menos pontos.\"></a>";
					}else if ((minPts <= points) && (points <= maxPts) && (pts < points)) {
					  document.getElementById('angreifen'+x).innerHTML = '\<a href="'+link+'/fight/?to='+username+'">'+
					  ...
					  document.getElementById('angreifen'+x).innerHTML = "<img height=\"18px\" src=\""+getPic("red")+"\""+
																														 	 " alt=\"A si mismo\" title=\"Ele não pode ser atacado.\">";
					  ...
					  document.getElementById('angreifen'+x).innerHTML = "<img height=\"18px\" src=\""+getPic("yellow")+"\""+
																														 	 " alt=\"Kampfbereit\" title=\"Você não pode atacar, mas ele pode te atacar.\">";
					}else{
					  document.getElementById('angreifen'+x).innerHTML = "<img height=\"18px\" src=\""+getPic("red")+"\""+
																														 	 " alt=\"n.Vulnerable\" title=\"Não pode ser atacado porque "+username+" não esta no seu ranking de pontos.\">";
					}
        }
...
var reg = dom.getElementsByTagName('reg_since')[0].textContent;
				...
				document.getElementById('nachricht'+x).innerHTML = "<a href=\"/messages/write/?to="+id+"\"><img style\"margin:5px;\" src=\"http://static.pennergame.de/img/pv4/icons/new_msg.gif\" title=\" Enviar mensage a "+username+"\"></a>";
		}
	});
...
var suche = content.search("Está online");
		try{
			if (suche != -1) {
