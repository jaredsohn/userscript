// ==UserScript==
// @name        PaisaLive by Soft-Technologies
// @namespace   http://soft-techn.blogspot.in/
...
$(function(){
	$("body").append('<div class="banner" style="height: 40px; width:100px; right:20px; color:white; padding:5px; border-radius:5px; top:3px; overflow:auto; display: block;"><a href="http://soft-techn.blogspot.com/2012/12/how-to-earn-with-dollarupload-upto-10day.html" target="_blank" id="start">Click Here to Start Checking Mail</a></div>');
