...
function funcionPrincipal(e){
	...
	lang_de['COMERCIAR'] 	= 'Hndler schicken';
	...
	// Por MikeP (Dedicado  Li), corregido y amplicado por Joo Frade
	...
	lang_tr['NUNCA']	= 'Hi';
	lang_tr['PC']						= 'Kltr puani';
	lang_tr['FUNDAR']				= 'Yeni bir ky kurabilir veya fethedebilirsiniz';
	lang_tr['ALDEAS']				= 'Kyler';
	lang_tr['TROPAS']				= 'Asker gnder';
	lang_tr['RECURSO1']			= 'Odun';
	lang_tr['RECURSO2']			= 'Tula';
    ...
    if(find("//table[@class='tbg']//tr[@class='rbg']", XPFirst).textContent.match(/ supplies | reinforces /))  return;
  	...
  	document.getElementById("orange").addEventListener('click', function(){ addBookmark(where, raidhref)}, false);
		...
		if (a.snapshotLength >= 3){
			// FIXME: Apao para Firefox. FF mete nodos de tipo texto vacios
  ...
  */
  ...
  function getResourceTypes()  {
    var funcion = function (){
      ...
      var ajax='function() { (find("//input[@name=\'getresources\']", XPFirst)).value="Done!";}';
  ...
  */
	...
	*/ 
	...
	function blocNotas(){
		...
		// En el evento del boton de guardado actualiza el valor de la cookie (1 ao de duracion por defecto)
	...
	function desplazarMapa(){
		...
		but.setAttribute("value",'Get Resources');
	...
	function filtrosMercado(){
                  ...
                  var b = a.snapshotItem(i);
	            		var c = b.getElementsByTagName("TD")[2].textContent.split(" ")[0].split("|");
								...
								//				var c = b.getElementsByTagName("TABLE")[0].getElementsByTagName("TD")[2].textContent.split(" ")[0].split("|");
												...
												// FIXME: Apao para Firefox. FF mete un nodo extra al principio de la tabla
		...
		// FIXME: Apao para Firefox. FF mete varios nodos extras entre las columnas
								/*if (a == null || (a.childNodes.length != 2 && a.childNodes.length != 4)) return;
    ...
    if(showbookmarks==true || showbookmarks == null) {
      ...
      bookmarks.push('Academy::build.php?gid=22');
      bookmarks.push('Armory::build.php?gid=13');
      bookmarks.push('Barracks::build.php?gid=19');
      bookmarks.push('Blacksmith::build.php?gid=12');
      ...
      bookmarks.push('Hero\'s Mansion::build.php?gid=37');
      //bookmarks.push('Main Building::build.php?gid=15');
      bookmarks.push('Marketplace::build.php?gid=17');
      bookmarks.push('Palace::build.php?gid=26');
      bookmarks.push('Rally Point::build.php?gid=16');
      bookmarks.push('Residence::build.php?gid=25');
      //bookmarks.push('Sawmill::build.php?gid=7');
      bookmarks.push('Siege Workshop::build.php?gid=21');
      bookmarks.push('Stable::build.php?gid=20');
      //bookmarks.push('Town Hall::build.php?gid=24');
		...
		if (mov_tropas){
			...
			if (a.firstChild.childNodes.length > 0){
				...
				for (var i = 0; i < a.childNodes.length; i++){
					...
					// FIXME: Apao para FF. Firefox mete nodos vacios
...
/*
TODO:
	- Aadir resumen a la vista de todas las aldeas
...
FIXME:
	...
	- Mejorar los apaos en el codigo marcados por FIXMEs (14 aprox)
