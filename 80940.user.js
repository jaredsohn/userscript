// ==UserScript==
// @name           Ikariam İttifak Renklendirici
// @author         PhasmaExMachina
// @namespace      PhasmaExMachina
// @description    İttifak renklerini kendinize göre kolayca ayarlayın (www.ikariam.forumm.biz)
	...
	addAllianceColorSelector:function(a) {
		...
		if(allianceId) {
			...
			div.innerHTML = '<img src="' + AllianceColor.icons.color + '"/><div>\
				<a href="javascript:allianceColorSet(' + allianceId + ', \'none\')" style="color:#7E2D04;">Renksiz</a>\
				<a href="javascript:allianceColorSet(' + allianceId + ', \'red\');" style="color:#cc0000;">Kırmızı</a>\
				<a href="javascript:allianceColorSet(' + allianceId + ', \'green\');" style="color:#00cc00;">Yeşil</a>\
				<a href="javascript:allianceColorSet(' + allianceId + ', \'blue\');" style="color:#0000cc;">Mavi</a>\
				<a href="javascript:allianceColorSet(' + allianceId + ', \'purple\');" style="color:#880088;">Pembe</a>\
				</div>\
			';
			$(a).after(div);
		}
