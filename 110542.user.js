...
IkaTools.text = 
{
  ...
  { //English
    ...
    autoBuild:
    {
      ...
      {      
        ...
        downInQueue:'down in queue', // used in "Move [building name] down in queue"
  ...
  { //Hebrew
    ...
    { 
	  ...
	  to:'  ל  ',
	  worldMapOverView:'סיקור מפת העולם',
	  Search:'חפש',
	  Now:'עכשיו',
      Capacity:'קיבולת',
      Safe:'בטוח',
      ...
      Points:'נקודות',
      Rank:'מיקום',
      reloadMilitary:'טען את כל המידע הצבאי',
      inTransitTo: 'במעבר לקראת',
      trainingBarracks:'אימון במגורי החיילים',
      StationFleets: 'צי ימי',
      DeployTroops:'פרוס כוחות',
      ViewCityIsland:'הראה עיר על האי',
      GoToShiyard:'לך למספנה',
      GoToBarracks:'לך למגורי חיילים',
      UnderConstrution:'מבנים בבנייה',
      TransportResources:'שלח סחורה אל',
      ...
      Destination:'יעד',
      Action:'פעולה',
      Circular:'הודעת שרשרת',
      NewCircular:'כתוב הודעת שרשרת',
      NewCircularText: 'כתוב הודעה לכל חברי הברית',
      CircularMessage:'הודעת שרשרת',
      CulturalMessage:'חוזה תרבות',
      TreatyMessage:'הודעה לכל חברי הברית',
      PersonalMessage:'הודעה אישית',
      ReplyCircular:'השב להודעה זו בהודעת שרשרת',
      HideOffline:'הסתר מנותקים',
      ShowOffline:'הראה מנותקים',
      SellOffers:'הצעות מכירה',
      BuyOffers:'הצעות קנייה',
      ShowCitiesMap:'הראה ערים על המפה',
      AddTarget:'הוסף מטרה',
      HaveASpy:'יש לך מרגל בעיר הזאת',
      TestServer:'שרת מבחן',
      DisableAutoLogin:'לחץ לנטרול כניסה אוטומטית',
      SetAutoLogin:'לחץ בשביל לבחור מידע זה לכניסה אוטומטית',
      HaveACulturalTreaty:'יש לך חוזה תרבות עם השחקן הזה',
      RequestedCulturalTreaty:'ביקשת חוזה תרבות עם השחקן הזה',
      openSlots:'מקומות פנויים',
      of:'של',
	  worldSearch:'חיפוש בעולם',
      RequestCT:'בקש חוזה תרבות',
	  AcceptCT: 'אשר חוזה תרבות',
      ReloadResearch:'רענן את כל המחקרים',
      ReloadResearchTime:'זה יכול לקחת דקה',
      TroopMovements:'תנועת כוחות',
      CombatReports:'דוחות קרב',
      Inbox:'דואר נכנס',
      Alliance:'ברית',
      Library:'ספרייה',
	  dayshort:'י',
	  ...
	  ship_flamethrower: "להביור",
	  ship_steamboat: "אייל ברזל מושט",
    ...
    pillageHelper:
    {
      PillageHelper: 'עזר בזיזות',
      City:'עיר',
      Player:'שחקן',
      Wall:'שלב חומה',
      Mortars:'מרגמות נחוצות',
      Port:'שלב נמל',
      Resources:'משאבים זמינים',
      lastReport:'מאז הדו"ח האחרון',
      none:'כלום',
      MilitaryScore:"נקודות גנרלים של השחקן",
      CityLevel:'שלב עיר',
      Garrison:'מידע יחידות בעיר',
      SpyCount:'מרגלים במקום',
      SpyCountIn:'מספר המרגלים ב',
      Wood:'עץ זמין לבזיזה',
      Wine:'יין זמין לבזיזה',
      Marble:'שיש זמין לבזיזה',
      Crystal:'קריסטל זמין לבזיזה',
      Sulphur:'גופרית זמינה לבזיזה',
      Ships:'ספינות סחר נדרשות',
      Time:'זמן הגעה',
      Reload:'רענן את כל המרגלים',
      Updated:'עודכן',
      ...
      Pillage:'בזוז', 
      Blockade:'הסגר ימי',
      UpdateData: 'עדכן מידע',
      UpdateDataTxt: 'עדכן מידע עם דו"ח זה',
      SendSpy:'שלח מרגל אל',
      RemoveCity:'הסר עיר מהרשימה',
      CantRemoveCity:'יש לך עדיין מרגלים בעיר זו',
      Resources:'משאבים',
      TargetOccupied:'עיר היעד נמצאת תחת כיבוש'
    },
    autoBuild:
    {
      AddBuildingToQueue:'הוסף את המבנה הזה לרשימת הבנייה',
      AutoUpgrade:'שדרוג אוטומטי',
      AutoUpgradeAll: 'שדרוג אוטומטי להכל',
      AutoUpgradeAllTxt: 'הוסף את כל המבנים בעיר הזאת לשדרוג האוטומטי',      
      totalForLevel:'סה"כ לשלב',
      moreForTrade:'עוד בשביל מסחר אחד לאחד',
      RemoveAutoUpgrade:'הסר מהשדרוג האוטומטי',
      addToQueue:'הוסף לרשימה',
      autoBuild:'בנייה אוטומטית',  // name of script
      demolishConfirm:'האם אתה רוצה להרוס את המבנה הזה לחלוטין (לרמה 0) ?',
      options:
      {
        by:'מאת',  // used in "Auto Build by PhasmaExMachina"
        descriptions:{
          smartChecking:'השתמש בבדיקה חכמה',
          autoDisable:'נטרל אם הסקריפט כבוי להרבה זמן',
          highlightRows:'הדגש כל שורה שנייה בתיבת המידע של בנייה אוטומטית',
        },
        help:
        {
          smartChecking:'בדיקה חכמה תבדוק אוטומטי כל 30 שניות לראות אם משהו מרשימת הבנייה או מרשימת השדרוג האוטומטי יכול להיבנות. זה קורה בלי לפגוע לך במשחק.',
        ...
        labels:
        {
		  to:'ל',
          show:'הראה',
          reCheckEvery:'בדוק את רשימת הבנייה בין ',
          smartChecking:'בדיקה חכמה',
          autoDisable:'נטרול אוטומטי',
          highlightRows:'הדגשת שורות',
        },
        minute:'דקה',
        minutes:'דקות',
        show:
        {
          ...
          currentCity:'רק מבנים בעיר נוכחית',
        },
        updatesAndHistory:'סקריפט עדכונים והיסטוריה',
        v:'v',  // used to label version number (e.g. "v0.36")
      },
      queue:
      {      
        ...
        change:'שנה',
        clearAll:'הסר הכל',
        clearAllDesc:'הסר את כל המבנים מרשימת הבנייה',
        downInQueue:'למטה ברשימה', // used in "Move [building name] down in queue"
        emptyNotice:'רשימת הבנייה ריקה.',
        enableAutoBuild:'אפשר בנייה אוטומטית',
        enableDisableAutoUpgrades:'אפשר/נטרל שדרוג אוטומטי',
        expandOrCollapse:
        {
          autoBuild:'הרחב או כווץ את רשימת הבנייה',
          autoUpgrades:'הרחב או כווץ את שדרוג אוטומטי',
        },
        fromAutoUpgrades:'מ שדרוג אוטומטי',  // used in "Remove [building name] from auto upgrades"
        fromQueue:'מרשימת הבנייה',  // used in "Remove [building name] from queue"
        move:'הזז את', // used in "Move [building name] up/down in queue"
        queue:'רשימת בנייה',
        showing:
        {
        ...
        upInQueue:'למעלה ברשימה', // used in "Move [building name] up in queue"
        remove:'הסר', // used in "Remove [building name] from ..."
        timeUntilNextDesc:'זמן לבדיקה הבאה (לחץ בשביל עכשיו)',
      }      
    },
    scriptOptions:
    {
      settings:'הגדרות',
      footer:'הערה: אתה אולי תצטרך לרענן את הדף בשביל לראות את השינויים',
      cancel:'ביטול',
      save:'שמור',
      CheckUpdates: 'בדוק לעדכונים'
    },
    optionsTexts:
    {
      externalArmyHelper: 'הראה כוחות במסכי פריסה',
      keyboardShortcuts:'הקש 1 עד # מספר הערים שלך בשביל לעבור ערים',
      antiPlus:'הסר את כל אפשרויות הפלוס',
      resourceLinks:'הפוך את סמלי המשאבים לקישורים',
      expandCargo:'הראה מטען תמיד בתנועת הכוחות',
      messagePreviews:'הראה שורה ראשונה של הודעהבמקום נושא',
      ajaxNextMessages:'הוסף הודעות הבאות לתחתית הרשימה כשהוקש הבא',
      stripAds:'הסר באנרים (אין בשרת הישראלי)',
      stripFacebook:'הסר לחצני פייסבוק',
      sessionExpireRedirect:'לך לדף הכניסה אם תקופת החיבור הסתיימה',
      leftAlign:'חלון המשחק בצד ימין כדי לפנות מקום בצד שמאל',
      autoBuildFeaturesEnabled:'אפשר רשימת בנייה (במבחן)',
      allianceColor:'מאפשר להדגיש בריתות שונות בצבעים שונים',
      hideFriendsBar:'הסתר את סרגל החברים',
      empireOverview:'סקירת האימפריה',
      buildingsOverview:'סקירה של המבנים',
      militaryOverview:'סקירה של הכוחות',
      militaryOverviewOnlyOwned:'סקור רק ערים בבעלותך',
      targetsOverview:'סקירת ריגול תחת יועץ המחקר',
      movementsOverview:'תנועת כוחות נפתח מהלחצן מפת האי',
      buildingList:'רשימת מבנים נפתחת מהלחצן מפת העיר',
      tradeOverview:'הראה את כל הצעות המסחר בתחנת הסחר',
      worldOverview:'לחצן מפת העולם לסקירה של מפת העולם',
      museumOverview:'הראה מצבי זמינות וחופשה יחד עם שם העיר במוזאון',
      resourceDetails:'הראה פירוט מידע על משאבים',
      showBuildingLevels:'הראה שלבי מבנים במפת העיר',
      showBuildingNames:'הראה שמות מבנים במפת העיר',
      biggerWorldMap:'הגדל את גובה מפת העולם',
      splitPersonalities:'פיצול קישורי יועצים',
      events:'הגדרות הודעה כלליות',
      ikariamNotifyEnabled:'אפשר הודעת האירוע',
      ikaNotifyShowTimer:'הראה זמן לבדיקה הבאה לאירועים',
      emailNoticeUrl:'כתובת של שרת האימייל לשימוש',
      pillaging:'כלים ועזרים לבזיזה',
      islandShowSpies:'הראה סמל מרגל ליד עיר עם מרגל בתצוגת האי',
      islandBlinkInactives:'שמות של בלתי זמינים מהבהבים',
      islandMarkLoners:'שמות של אנשים בלי ברית באדום',
      playerCitiesInIslandView:'הראה רשימת ערי שחקן בתצוגת האי',
      treaties:'בחר את המקומות שבהם תרצה לראות סמלי חוזה וריגול:',
      ctAlliance:'הראה סמלים ליד שחקן בתצוגות הברית',
      ctInbox:'הראה סמלים ליד הודעות בדואר נכנס',
      ctIslandView:'הראה סמלים ליד שמות הערים בתצוגת האי',
      ctTradeTreaties:'הראה סמלים ליד שם השחקן בתצוגות חוזים',
      search:'איפה תרצה לראות סמלי חיפוש (סמל המשקפת) ?',
      searchIconsWhere:'איפה תרצה לראות סמלי חיפוש (סמל המשקפת) ?',
      searchIconIslandPlayer:'ליד שם שחקן בתצוגת האי',
      searchIconOccupier:'ליד שם הכובש במפת העיר',
      searchIconHighscore:'ליד שמות השחקנים בניקוד',
      searchIconInbox:'ליד שמות השחקנים בדואר נכנס',
      searchIconAlliancePlayers:'ליד שמות שחקנים בברית',
      searchIconMuseum:'ליד שמות ובריתות במוזאון',
      searchScoresHtml:'הראה את סוגי הניקוד הבאים בתצוגת האי:',
      searchScore: 'הראה ניקוד בתצוגת האי (התשמש ברשימה הבאה)',
      scoreTotal:'הראה ניקוד כללי בתצוגת האי',
      scoreMilitary:'הראה ניקוד גנרלים בתצוגת האי',
      scoreOffense:'הראה נקודות התקפה בתצוגת האי',
      scoreDefense:'הראה נקודות הגנה בתצוגת האי', 
      scoreResources:'הראה נקודות משאבים בתצוגת האי', 
      scoreGold:'הראה מלאי זהב בתצוגת האי', 
      scoreBuilder:'הראה ניקוד בונים מוסמכים בתצוגת האי', 
      scoreBuildings:'הראה שלבי בנייה בתצוגת האי', 
      scoreScientists:'הראה ניקוד מדענים בתצוגת האי', 
      scoreResearch:'הראה ניקוד שלבי המחקר בתצוגת האי', 
      scoreTrading:'הראה ניקוד מסחר בתצוגת האי', 
      scoreDonations:'הראה ניקוד תרומה בתצוגת האי', 
      debugMode:'הראה ביצוע זמן סקריפט'
    },
    optionsLabels:
    {
      general:"כללי",
      keyboardShortcuts:'קיצורי דרך מקלדת',
      resourceLinks:'קישורי משאבים',
      expandCargo:'הראה מטען',
      messagePreviews:'תצוגה מקדימה הודעות',
      ajaxNextMessages:'הודעות הוספה לסוף',
      stripAds:'הסר באנרים',
      stripFacebook:'הסר קישורי פייסבוק',
      sessionExpireRedirect:'הפניה לדף הכניסה',
      leftAlign:'ישור לימין',
      autoBuildFeaturesEnabled:'בנייה אוטומטית',
      allianceColor:'מדגיש בריתות',
      hideFriendsBar:'הסתר חברים',
      overviews:"סיקורים",
      empireOverview:'אימפריה',
      buildingsOverview:'מבנים',
      militaryOverview:'צבא',
      militaryOverviewOnlyOwned:'צבא',
      targetsOverview:'ריגול',
      movementsOverview:'תנועת כוחות',
      buildingList:'רשימת מבנים',
      tradeOverview:'מסחר',
      worldOverview:'מפת עולם',
      museumOverview:'מוזאון',
      resourceDetails:'פרטים משאבים',
      showBuildingLevels:'שלבי מבנים',
      showBuildingNames:'שמות מבנים',
      biggerWorldMap:'מפה גדולה',
      splitPersonalities:'יועצים מחולקים',
      events:"אירועים",
      ikariamNotifyEnabled:'אפשר',
      ikaNotifyShowTimer:'הראה טיימר',
      emailNoticeUrl:'שרת',
      pillaging:"בזיזה",
      islandShowSpies:'סמלי ריגול',
      islandBlinkInactives:'הבהוב לא זמיניםם',
      islandMarkLoners:'סמן חסרי ברית',
      playerCitiesInIslandView:'רשימ ערים',
      treaties:"חוזים",
      ctAlliance:'ברית',
      ctInbox:'דואר נכנס',
      ctIslandView:'אי',
      ctTradeTreaties:'חוזה',
      search:"חיפוש",
      searchIconIslandPlayer:'שחקנים באי',
      searchIconOccupier:'כובשים',
      searchIconHighscore:'ניקוד',
      searchIconInbox:'דואר נכנס',
      searchIconAlliancePlayers:'ברית',
      searchIconMuseum:'מוזאון',
      searchScore:'הראה ניקוד',
      scoreTotal:'כללי',
      scoreMilitary:'גנרלים',
      scoreOffense:'התקפה',
      scoreDefense:'הגנה',
    ...
    buildings:
    {
      ...
      dump:'מאגר',
      embassy:'שגרירות',
      fireworker:'איזור ניסויים בחומרי נפץ',
      forester:'בית היערן',
      glassblowing:'נפח זכוכית',
      museum:'מוזאון',
      optician:'משרד האופטיקאי',
      palace:'ארמון',
    ...
    buildingsShortNames: 
    {
      ...
      "fireworker": "איזור ניסויים בחומרי נפץ",
      "vineyard": "מרתף יין",
      "architect": "משרג האדריכל",
      "buildingGround": "אדמת בנייה"
    }
  },
  uk: 
  {
