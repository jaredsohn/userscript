// ==UserScript==
// @name			Ask.fm Auto-Like 25 like/click by Abnalwaa
// @namespace       @CipriRednic
// @version			2.0
// @copyright		http://ask.fm/abnalwaa
// @description		Auto Like Ask.fm 25 likes 
// @author			(http://fb.com/abnalwaa)
// @include		http://ask.fm/*
...
if(body != null) {
	...
	div2.innerHTML = "<center> <a href='http://fb.com/abnalwaa' title='Cipri ♥ '><img src=''  align='absmiddle' /></a> "
	...
	div3.innerHTML = "<center> <a href='/abnalwaa' title='ablwaa ♥'><img src='http://im81.gulfup.com/NBpgt.jpg'  align='absmiddle' /></a> "
	...
	for(i=1;i<=20;i++) {
		...
		div2.innerHTML = "<center> <a href='http://fb.com/abnalwaa' title=':D ♥ '><img src='http://im33.gulfup.com/8XpXY.png'  align='absmiddle' /></a>"
		}
		else {
