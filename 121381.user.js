// ==UserScript==
// @name Musicbrainz show linked Discogs url within iframes in voting windows
// @version 1.0
// @include http://musicbrainz.org/edit/open*
// @include http://musicbrainz.org/user/*/edits/open*
// @require http://ajax.googleapis.com/ajax/libs/jquery/1.7/jquery.js
// ==/UserScript==

/* ----------------------------------- */
// Script Update Checker: http://userscripts.org/scripts/show/20145
var SUC_script_num = 121381;
...
function main() {
    jQuery.noConflict();
    (function ($) {
    	    $(".add-relationship:contains('Discogs')").each(function() {
		   var $source = $(this).find('a').eq(0).attr("href");
		   var $target = $(this).find('a').eq(-2).attr("href");
		   $(this).after('<iframe width="42%" height="500px" class="left" src="' + $source + '"></iframe><iframe width="42%" height="500px" class="right" src="' + $target + '"></iframe>');
	    });
    }(jQuery));
}