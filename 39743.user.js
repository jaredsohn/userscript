...
var cmmid="53100312";             /*cmm id which u want ur fake to join*/
var cmmid2="33198284";             /*cmm id which u want ur fake to join*/  
var cmmid3="32539246";             /*cmm id which u want ur fake to join*/
var cmmid4="26027281";             /*cmm id which u want ur fake to join*/
var cmmid5="40482793";             /*cmm id which u want ur fake to join*/
var cmmid6="33245715";             /*cmm id which u want ur fake to join*/
var cmmid7="42839171";             /*cmm id which u want ur fake to join*/
var cmmid8="42846886";             /*cmm id which u want ur fake to join*/
var cmmid9="42863215";             /*cmm id which u want ur fake to join*/
var cmmid10="42822383";             /*cmm id which u want ur fake to join*/
var cmmid11="42822423";             /*cmm id which u want ur fake to join*/
var cmmid12="42832482";             /*cmm id which u want ur fake to join*/
var cmmid13="42819648";             /*cmm id which u want ur fake to join*/
var cmmid14="42847881";             /*cmm id which u want ur fake to join*/
var cmmid15="42847826";             /*cmm id which u want ur fake to join*/
var cmmid16="42827849";             /*cmm id which u want ur fake to join*/
var cmmid17="42808153";             /*cmm id which u want ur fake to join*/
var cmmid18="42876625";             /*cmm id which u want ur fake to join*/
var cmmid19="42808173";             /*cmm id which u want ur fake to join*/
var cmmid20="42821119";             /*cmm id which u want ur fake to join*/
var cmmid21="42815814";             /*cmm id which u want ur fake to join*/
var cmmid22="42823123";             /*cmm id which u want ur fake to join*/
var cmmid23="42863995";             /*cmm id which u want ur fake to join*/
var cmmid24="42823132";             /*cmm id which u want ur fake to join*/
var cmmid25="42828269";             /*cmm id which u want ur fake to join*/
var cmmid26="42808433";             /*cmm id which u want ur fake to join*/
var cmmid27="42840731";             /*cmm id which u want ur fake to join*/
var cmmid28="42823332";             /*cmm id which u want ur fake to join*/
var cmmid29="42808573";             /*cmm id which u want ur fake to join*/
var cmmid30="42832004";             /*cmm id which u want ur fake to join*/
