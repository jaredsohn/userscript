// ==UserScript==
// @name          Skyrock erdo4413
// @namespace     http://erdo4413.skyrock.com
// @description   Modifications Sky
// @version       1.5
...
if(unsafeWindow.user_pseudo && adresse[0] != 'http://www.skyrock.com/blog/add_comment.php') // Si on est connecté
{
	...
	if((menua = document.getElementById('header_right')))
	{
		if ((menu = menua.getElementsByTagName('li')[4]))
		{
			...
			newMenu2.innerHTML = '<a href="http://www.skyrock.com/poker/"><font face="Comic Sans MS" color=#FF0000><b>Poker</b></font></a> ';
		...
		var comsp = menua.getElementsByTagName('li')[5];
	
		alerts = getElementsByAttribute(messagerie,'strong','class','unread');
		for(var i = 0; i in alerts; i++)
		{
		messagerie.innerHTML = '<a href="http://www.skyrock.com/m/messages/"><font face="Comic Sans MS" color=#FF0000><b>Mes msgs :</b></font></a><a href="http://www.skyrock.com/m/messages/messages_index.php?unread=1"><strong style="text-decoration:blink;color:red;">'+alerts[i].innerHTML+'</strong></a>';
		}
		
		alerts = getElementsByAttribute(amis,'strong','class','unread');
		for(var i = 0; i in alerts; i++)
		{
		amis.innerHTML = '<a href="http://www.skyrock.com/m/friends/"><font face="Comic Sans MS" color=#FF0000><b>Amis</b></font></a><a href="http://www.skyrock.com/m/friends/invit_receive.php"><strong style="text-decoration:blink;color:red;">'+alerts[i].innerHTML+'</strong></a>';
		}
		...
		for(var i = 0; i in alerts; i++)
		{
		coms.innerHTML = '<a href="http://www.skyrock.com/m/blog/"><font face="Comic Sans MS" color=#FF0000><b>Blog :</b></font></a><a href="http://www.skyrock.com/m/blog/unread_comments.php"><strong style="text-decoration:blink;color:red;">'+alerts[i].innerHTML+'&nbsp;com(s)</strong></a>';
		}
				
				alerts = getElementsByAttribute(comsp,'strong','class','unread');
		for(var i = 0; i in alerts; i++)
		{
		comsp.innerHTML = '<a href="http://www.skyrock.com/m/profile/"><font face="Comic Sans MS" color=#FF0000><b>Profil :</b></font></a><a href="http://www.skyrock.com/m/profile/commentaires.php"><strong style="text-decoration:blink;color:red;">'+alerts[i].innerHTML+'&nbsp;com(s)</strong></a>';
		}
	}
	...
	if(athome == true && onablog == true)
	{
		...
		if(taille <= 10)
		{
			...
			for(var i = 0; i in tableau; i++)
			{
				...
				newElement.innerHTML = '<a href="http://www.skyrock.com/m/blog/article_edit.php?id='+tableau[i]+'"><img src="http://static.v41.skyrock.com/img/icons/adm-edit.png" alt="Modifier" title="Cliquer ici pour modifier cet article" /></a>';
...
for(var friend = 0; friend in friends; friend++)
{
	...
	friends[friend].getElementsByTagName('p')[3].innerHTML = '<br /><a href="http://www.boverie.eu/skyblog/aleatoire/comonlastarticle.php?blog='+pseudo+'"onclick="window.open(this.href); return false;"><img src="http://static.v41.skyrock.com/img/icons/comment-add.png" /> Commenter</a><br />' + friends[friend].getElementsByTagName('p')[3].innerHTML;
log(pseudo);
}
...
if (create2) {
    newitemmenu = document.createElement('li');
	newitemmenu.innerHTML = '<a href="http://www.skyrock.com/m/account/api.php?gestion"><img src="http://static.v41.skyrock.com/img/icons/message_vocal.png" />Gestion</a>';
