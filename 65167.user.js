...
// @namespace      mediafire
// @description    Saca las publicidades de mediafire.com y evita que se abran popups. Creado por Gregorio Troncoso para Truchinga?.org.
// @include        http://www.mediafire.com/*
// ==/UserScript==
function do_platypus_script() {
erase_it(window.document,document.evaluate('/HTML[1]/BODY[1]/DIV[4]/DIV[1]/DIV[7]/DIV[1]', document, null, XPathResult.FIRST_ORDERED_NODE_TYPE,null).singleNodeValue,null,null,null);
erase_it(window.document,document.getElementById('remove_ads_button1'),null,null,null);
erase_it(window.document,document.evaluate('/HTML[1]/BODY[1]/DIV[4]/DIV[1]/DIV[8]/DIV[3]/TABLE[1]/TBODY[1]/TR[1]/TD[2]/DIV[2]/DIV[2]', document, null, XPathResult.FIRST_ORDERED_NODE_TYPE,null).singleNodeValue,null,null,null);
erase_it(window.document,document.evaluate('/HTML[1]/BODY[1]/DIV[4]/DIV[1]/DIV[8]/DIV[3]/TABLE[1]/TBODY[1]/TR[1]/TD[2]/DIV[2]/DIV[4]/DIV[1]', document, null, XPathResult.FIRST_ORDERED_NODE_TYPE,null).singleNodeValue,null,null,null);
erase_it(window.document,document.getElementById('catfish_div'),null,null,null);
erase_it(window.document,document.evaluate('/HTML[1]/BODY[1]/DIV[6]/DIV[1]', document, null, XPathResult.FIRST_ORDERED_NODE_TYPE,null).singleNodeValue,null,null,null);
