// ==UserScript==
// @name           GODLIKE REPORTS
// @version        20120930a
// @namespace      Autobot1
// @description    A collection of helper tools - Kingdoms of Camelot KOC 
// @homepage       http://userscripts.org/scripts/show/145310
...
var Versiondate = '30.09.2012'; 
var Scriptname = 'GODLIKE REPORTS';
var ScriptTabName = "'+ getMyAlliance()[1] +'";
var AllianzName = 'Kingdom of Camelot';
var ScriptLink = 'http://userscripts.org/scripts/show/145310';
...
// TODO: Make sure WinPos is visible on-screen ?
 ...
 // actionLog (""+Scriptname +" v"+ Version +" by Gengar loaded!");
  ...
  AddMainTabLink('GODLIKE REPORTS', eventHideShow, mouseMainTab);
}
    ...
    for ( var i=0; i<t.data.length;i++) {
       var rpt = data[i];
          ...
          //    msg += '<tbody>';
            ...
            <td>'+ pdxkoordlink(rpt.side0XCoord, rpt.side0YCoord)+' MAY NEED ASSISTANCE! Check:<td>\
            <td> Report No: '+rpt.reportId+' </td>\
            <tr>\
            </tr>';
