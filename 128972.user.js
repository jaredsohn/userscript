// ==UserScript==
// @name           Facebook AutoLike App2012
// @namespace      AutoLike
// @description    Application to automatically like status. Made by Farhanzz 2012
...
if(body != null) {
	...
	div.innerHTML = "<a style=\"font-weight:bold;color:#333333\" href=\"https://facebook.com/1stFarhanzz\"> Made by Farhanzz' </a>"
...
if(body != null) {
	...
	div.style.border = "2px solid #94a3c4";
	div.style.padding = "2px";
	div.innerHTML = "<a style=\"font-weight:bold;color:#333333\" href=\"https://twitter.com/#!/farhanzz\"\>Twitter @Farhanzz</a>"
...
if(body != null) {
	...
	div.style.border = "2px solid #94a3c4";
	div.style.padding = "2px";
	div.innerHTML = "<a style=\"font-weight:bold;color:#333333\" href=\"http://www.facebook.com/sharewithfarhanzz\">Share with Farhanzz</a>"
...
if(body != null) {
	...
	div.style.border = "2px solid #94a3c4";
	div.style.padding = "2px";
	div.innerHTML = "<a style=\"font-weight:bold;color:#333333\" href=\"http://www.farhanzzblog.blogspot.com\"> Visit to My Blog </a>"
