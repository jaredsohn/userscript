    ...
    switch(language) {
        case "us":
            nbo_lang.trans = {
                ...
                refsClickedToday: "Mai Ref. click",
                refsClickedYesterday: "Tegnapi Ref. click",
                otherRefs: "Other refs.",
                refsWithoutClicks: "Nem kattintott a Refs.",
                totalProfit: "Total profit",
                neobuxoxSays: "NeoBuxOxHungaryan says",
                ...
                abbreviationOfDirect: "Direkt",
                abbreviationOfRented: "Bérelt",
                abbreviationOfUpdate: "Upd",
                update: "Frissítés",
                today: "Ma",
                real: "Valódi",
                earnings: "Kereset", //Plural
                rented: "Bérelt",
                direct: "Direkt",
                both: "Összes",
                net: "Net",
                ...
                renewing: "Megújítás",
                autoPay: "AutoPay",
                totalExpenses: "Ráfordítások összesen",
                yesterday: "Tegnap",
                avg: "Átlagok",
                avgRented: "Bérelt átlag",
                avgDirect: "Direkt átlag",
                avgBoth: "Összes átlag",
                days: "Nap",
                //Stript options
                renewingFor: "Ennyi napra újítok",
                save: "Mentés",
                availableOptions: "Rendelkezésre álló lehetőségek",
                showGlobalProfit: "A bérelt referálok listázásai mutatják, a teljes profitot?",
...
if( location.href.indexOf("www.neobux.com/c/rs") != -1 )
{
    ...
    try
    {
        ...
        nbo_sspan = document.createElement("span");
        nbo_sspan.innerHTML = "&nbsp;&nbsp;"+nbo_lang.trans.totalProfit+": ";
        nbo_sdiv.appendChild(nbo_sspan);
...
if( location.href == "http://www.neobux.com/c/")
{
    ...
    if(nbo_showed_directs != null && nbo_showed_rented != null)
    {
        ...
        nbo_span.innerHTML = "<span style=\"color:#707070\">"+nbo_lang.trans.total+":</span> " + (Number(nbo_showed_directs) + Number(nbo_showed_rented));
    ...
    nbo_span.setAttribute("style","float:right;font-size:11px;");
    nbo_span.innerHTML = "<span style=\"color:#707070\">"+nbo_lang.trans.total+":</span> " + (Number(nbo_viewed_user) + Number(nbo_viewed_referrals));
    ...
    nbo_script_content = document.createTextNode("mk_tt('nbo_user_clicks_avg','rm','"+
        nbo_lang.trans.dailyAvg.format((Number(nbo_viewed_user)/Number(nbo_registered_days)).toFixed(3))+"');");
    nbo_script.appendChild(nbo_script_content);
