// ==UserScript==
// @name           TM Help to League
// @include        http://trophymanager.com/league.php*
...
//		alert ("case f")
	...
	skillsumspan_HL.innerHTML="<div>TB-Rating</div>";
...
appdiv.innerHTML = '<div id="tbuddy" style="position: fixed; top: 110px; left: 25px; height: 200px; width: 140px; -moz-opacity: .8; text-align: left; border: 2px #333333 outset; display:inline;"><img src="http://imbx.us/Pro.gif"><p style="text-decoration: underline;">Critérios do Rebaixamento</p><ul><li><a href="" target="_self" style="font-size: 10px;" title="Vamo pangaré, ainda dá pra não cair!!">- 13º: Primeiro grupo</a></li></ul><ul><li><a href="" target="_self" style="font-size: 10px;" title="Tá com medo de cair né? haha">- 14º: Segundo grupo</a></li></ul><ul><li><a href="" target="_self" style="font-size: 10px;" title="Acho que dessa você não sai">- 15º: Terceiro grupo</a></li></ul><ul><li><a href="" target="_self" style="font-size: 10px;" title="Que zica hein1, boa sorte na divisão abaixo">- 16º: Primeiro grupo</a></li></ul><ul><li><a href="" target="_self" style="font-size: 10px;" title="Dessa você não escapa">- 17º: Segundo grupo</a></li></ul><ul><li><a href="" target="_self" style="font-size: 10px;" title="HAHA, O carrinho apagou e só sobrou a lanterna né?! haha">- 18º: Terceiro grupo</a></li></ul></div>';
}
//Transferseite
...
skillsumspan2_value.innerHTML="<th><strong>Taxa</strong></th>";
