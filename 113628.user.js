...
// Terrain types
var gAnthropusCamp = 'AnthropusCamp';		
var gCity = 'City';			
...
var gRookery = 'Rookery';			
var gTheater = 'Theater';			
var gFortress = 'Fortress';			
var gGarrison = 'Garrison';		
var gSentinel = 'Sentinel';			
var gDragonKeep = 'DragonKeep';		
var gMetalsmith = 'Metalsmith';			
var gMusterPoint = 'MusterPoint';	
var gStorageVault = 'StorageVault';	
var gScienceCenter = 'ScienceCenter';		
var gOfficerQuarter = 'OfficerQuarter';		
var gTrainingCamp = 'TrainingCamp';	
var gSilo = 'Silo';			
var gFarm = 'Farm';			
var gMine = 'Mine';				
var gQuarry = 'Quarry';			
var gLumbermill = 'Lumbermill';		

//Research
var gAgriculture = 'Agriculture';
var gWoodcraft = 'Woodcraft';
var gMasonry = 'Masonry';
var gMining = 'Mining';
var gClairvoyance = 'Clairvoyance';
var gRapidDeployment = 'RapidDeployment';
var gBallistics = 'Ballistics';
var gMetallurgy = 'Metallurgy';
var gMedicine = 'Medicine';
var gDragonry = 'Dragonry';
var gLevitation = 'Levitation';
var gMercantilism = 'Mercantilism';
var gAerialCombat = 'AerialCombat';

// Troops				
var gPorter = 'Porter';			
var gConscript = 'Conscript';			
var gSpy = 'Spy';				
var gHalberdsman = 'Halberdsman';		
var gMinotaur = 'Mino';			
var gLongbowman = 'LBM';		
var gSwiftStrikeDragon = 'SSDrg';	
var gBattleDragon = 'BattleDragon';		
var gArmoredTransport = 'ATrans';	
var gGiant = 'Giant';				
var gFireMirror = 'FireM.';		
var gAquaTroop = 'AquaTrp';			
var gStoneTroop = 'StoneTrp';
var gWindTroop = 'WindTrp';
var gFireTroop = 'FireTrp';		
var gGreatDragon = 'GreatDrg';		
var gWaterDragon = 'WaterDrg';	
var gStoneDragon = 'StoneDrg';
var gFireDragon = 'FireDrg';
var gWindDragon = 'WindDrg';
...
var gTower = 'Tower';	
var kAutoResearchOn = 'AutoResearchOn';
var kAutoResearchOff = 'AutoResearchOff';

var kLevel = 'level ';
var kLevel1 = ' Level';
var kResearch = 'Research';
var kResearchErr = 'ResearchErr: ';
var kTooManyResearchErrs = 'TooManyResearchErrs.';
...
var translateSPArray = {
 'Actualizar DoA':'Actualizar DoA',
    ...
    'Attack One Target in Waves':'Attack One Target in Waves',
    'Information': 'Information',
    'TestroniusPowder':'TestroniusPowder',
    'GlowingShields':'GlowingShields',
    'MassNullifier':'MassNullifier',
    'RenameProclamation':'RenameProclamation',
    'CeaseFireTreaty':'CeaseFireTreaty',
    'CompletionGrant':' CompletionGrant',
    'CrimsonBull':'CrimsonBull�',
    'PurpleBones':'PurpleBones',
    'TranceMarchDrops':'TranceMarchDrops',
    'ForcedMarchDrops':'ForcedMarchDrops',
    'DarkWarpDevice':'DarkWarpDevice',
    'OutpostWarp':'OutpostWarp',
    'DragonHearts':'DragonHearts',
    'Actualizar DoA':'Actualizar DoA',
    'Auto Upgrade Buildings': 'Auto Upgrade Buildings',
    'Attack One Target in Waves': 'Attack One Target in Waves',
    'Information': 'Information',
    'Target Coords':'Target Coords',
    'Troops for Wave Attack':'Troops for Wave Attack',
    'Delete battle reports':'Delete battle reports',
    'Stop if any troops lost':'Stop if any troops lost',
    'Delay Between attacks':'Delay Between attacks',
    'to':'to',
    'seconds':'seconds',
    'minutes':'minutes',
    'Reset Stats':'Reset Stats',
    'Attacks OFF':'Attacks OFF',
    'Attacks ON':'Attacks ON',
    'Auto Build OFF':'Auto Build OFF',
    'Auto Build ON':'Auto Build ON',
    'Auto-Train ON':'Auto-Train ON',
    'Auto-Train OFF':'Auto-Train OFF',
    'Auto ON':'Auto ON',
    'Auto OFF':'Auto OFF',
    'Terre':'Terre',
    'Accampamenti':'Accampamenti',
    'Run Time':'Run Time',
    'Attacks':'Attacks',
    'Garrison':'Garrison',
    'Home':'Home',
    ...
    'Conscript':'Conscript',
    'Spy':'Spy',
    'Halberdsman':'Halberdsman',
    'Minotaur':'Minotaur',
    'Longbowman':'Longbowman',
    'SwiftStrikeDragon':'SwiftStrikeDragon',
    'BattleDragon':'BattleDragon',
    'ArmoredTransport':'ArmoredTransport',
    'Giant':'Giant',
    'FireMirror':'FireMirror',
    'StoneTroop':'StoneTroop',
    'WindTroop':'WindTroop',
    'GreatDragon':'GreatDragon',
    'WaterDragon':'WaterDragon',
    'StoneDragon':'StoneDragon',
    'AquaTroop':'AquaTroop',
    ...
    'Targets':'Targets',
    'Stats':'Statu',
    'Anthropus Camp Auto-Attacks':'Anthropus Camp Auto-Attacks',
    'Auto-attack Camp Levels':'Auto-attack Camp Levels',
    'Auto-attack Configuration':'Auto-attack Configuration',
    'Enable':'Enable',
    'Random delay between attacks':'Random delay between attacks',
    'Same target delay':'Same target delay',
    'Log attacks':'Log attacks',
    'Delete March Reports':'Delete March Reports',
    'Stop if any troops lost':'Stop if any troops lost',
    'Maximum simultaneous marches':'Maximum simultaneous marches',
    'Enable window drag move window by dragging <BR>top bar with mouse':'Enable window drag move window by dragging <BR>top bar with mouse',
    'Auto-collect resources at outpost every 8 hours':'Auto-collect resources at outpost every 8 hours',
    'Attack':'Attack',
    'Config':'Config',
    'Features':'Features',
    'Sending Attack':'Sending Attack',
    'Last Attack':'Last Attack',
    'ACTION LOG':'ACTION LOG',
    'DOA Power Tools Options':'DOA Power Tools Options',
    'Auto-attack Stats':'Auto-attack Stats',
    'Clear Stats':'Clear Stats',
    'Attacks':'Attacks',
    'Stats started at':'Stats started at',
    'Run time':'Run time',
    'Resources':'Resources',
    'Stats by Camp Level':'Stats by Camp Level',
    'No Troops Defined':'No Troops Defined',
     'gold':'gold',
    'hr':'s',
    'year':'Year',
    'day':'day',
    ...
    'Respirator-100':'100 Respirator',
    'Respirator-500':'500 Respirator',
    'Respirator-1000':'1000 Respirator',
    'Mandrakes':'Mandrake',
    'Mandrake-100':'100 Mandrake',
    'Mandrake-500':'500 Mandrake',
    'Mandrake-1000':'1000 Mandrake',
    ...
    'No targets/troops available':'No targets/troops available',
    'Attacking level':'Attacking level',
    'camp at':'camp at',
    'Max Dist':'Max Dist',
    'Attack Now':'Attack Now',
    'Building level':'Building level',
    'of':'of',
    'at':'de',
    'Wave sent to':'Wave sent to',
    'Wave attack sent to':'Wave attack sent to',
    'Muster Point Full':'Muster Point Full',
    'User-set maximum marches reached.':'User-set maximum marches reached',
    'marching':'marching',
    'returning':'returning',
    'encamped':'encamped',
    'Too many errors, disabling auto-train':'Too many errors, disabling auto-train',
    'No Generals Available':'No Generals Available',
    'Escondido':'Atack',
    'Defendiendo':'Defended',
...
var Seed = {
  ...
  tick : function (){     // called once per second - to check for job completion
    ...
    for (var pm in t.marches){
      ...
      if ((march.run_at < now-30) || (march.status=='Returning' && march.run_at < now-2) || (march.status=='returning' && march.run_at < now-2)){
        delete (t.marches[pm]);
        --Seed.numMarches;
      }
    }
    ...
    for (var pcity in t.jobs){
      for (var pjob in t.jobs[pcity]){
        ...
        if (job.run_at < (now - 300)){
          ...
          if (march && job.queue=='march' && (march.status=='Marching' || march.status=='marching')){  // march just reached target
...
Tabs.Utiles = {
  ...
  init : function (div){
    ...
    try {      
      ...
      <TABLE width=100%>\
          <TD><INPUT type=submit value="L.Troops" id=pbtropafue></input></td>\
        </tr>\
          <TD><INPUT type=submit value="Silo" id=pbtropagua></input></td>\
        </tr>\
        <TR><TD><BR></td></tr>\
      </table>\
      <TABLE width=100%>\
        <TR>\
          <TD>Map Taramasi:\
                ...
                <INPUT class=short id=smcoordy maxlength=4 type=text value=0> - Dist:\
      ...
      <TABLE width=100%>\
        <TR><TD class=pbTabLeft>G ster: city :</td><TD><INPUT id=smciudad type=checkbox></td></tr>\
        <TR><TD class=pbTabLeft>Outpost:</td>         <TD><INPUT id=smavanza type=checkbox></td></tr>\
        <TR><TD class=pbTabLeft>Hill:</td>         <TD><INPUT id=smdesier type=checkbox></td></tr>\
        <TR><TD class=pbTabLeft>Stoped  :</td>         <TD><INPUT id=smparamo type=checkbox></td></tr>\
        <TR><TD><BR></td></tr>\
      </table>\
      <TABLE width=100%>\
      ...
      <TABLE width=100%>\
        <TR>\
          <TD><CENTER><INPUT id=pmarraycer type=submit value=" Clear Map " ></CENTER></td>\
          <TD><CENTER><INPUT id=pmverarray type=submit value=" Map "         ></CENTER></td>\
          <TD><CENTER><INPUT id=pmexparray type=submit value=" Exp. Map "    ></CENTER></td>\
          <TD><CENTER><INPUT id=pmversinsc type=submit value=" Search" ></CENTER></td>\
          <TD><CENTER><INPUT id=pmborrarlo type=submit value=" Clear Logs "   ></CENTER></td>\
        </tr>\
        <TR><TD><BR></td></tr>\
      </table>\
      </table>\
      <TABLE cellpadding=1 cellspacing=1 id=pbtextos width=100%>\
        <TR>\
          <TD Align=Center>\
            <textarea id="pmcoordespias" rows=5 cols=62>Please Paste Cord. For Atack ! </textarea>\
          </td>\
        </tr>\
      </table>\
...
Tabs.Info = {
  ...
  init : function (div){
    ...
    t.cont.innerHTML = '<DIV class=pbTitle>ProEkip BETA v:  '+ Version +'<BR>'+ WebSite +'<BR>If you want to new news please Visit fun page'+'<BR>'+ Publi +'</div>\
      <TABLE width=100%><TR><TD><INPUT type=submit value=" Refresh " id=pbinfRefresh></input><INPUT id=pcReloadTools type=submit \
      value=" Page Refresh " \></td><TD align=right><SPAN id=pbinfGmt></span></td><TD align=right>\
  ...
  showStuff : function (){
    ...
    m += '<TABLE style="margin-top:3px" width=100%>\
          <TR bgcolor=#dde align=center><TD style="border-right: 1px solid; border-bottom: 1px solid;"><B>Research - Rescores</b></td></tr></table>';
    ...
    m += '<TABLE style="margin-top:3px" width=100%>\
          <TR bgcolor=#dde align=center><TD style="border-right: 1px solid; border-bottom: 1px solid;"><B>City And Outposts</b></td></tr></table>';
...
//    for (var ig=0; ig<Seed.generals.length; ig++){
    ...
    for (var ig in Seed.generals) {
      ...
      m += (Seed.generals[ig].busy?' <SPAN class=boldRed>Busy</span>':'') +'</td>';
      if (col == 0)
        col = 1;
      else {
        m += '</tr>';
    ...
    function dispRecursos (){
      ...
      m += '<TR><TD class=pbTabLeft>Food:</td><TD>'+ miles(recursos.food)  +'</td>';
      m +=     '<TD class=pbTabLeft>Wood:  </td><TD>'+ miles(recursos.wood)  +'</td></tr>';
      m += '<TR><TD class=pbTabLeft>Metal:   </td><TD>'+ miles(recursos.ore)   +'</td>';
      m +=     '<TD class=pbTabLeft>Stone:  </td><TD>'+ miles(recursos.stone) +'</td></tr>';
      return m;
    }
...
Tabs.Research = {
  ...
  cont            : null,
  timer           : null,
  capitolResearch : {Agriculture:'Agriculture', Woodcraft:'Woodcraft', Masonry:'Masonry', Mining:'Mining', Clairvoyance:'Clairvoyance',   RapidDeployment :'RapidDeployment', Ballistics:'Ballistics', Metallurgy:'Metallurgy', Medicine:'Medicine', Dragonry:'Dragonry',   Levitation      :'Levitation', Mercantilism:'Mercantilism', AerialCombat:'AerialCombat'},
  ...
  tabJobResearch : function (){
    var t = Tabs.Research;
    var n = '<DIV class=pbSubtitle> Auto Research</div>\
    ...
    m += '<DIV class=pbSubtitle>Researchlar</div><TABLE class=pbTab><TR valign=top><TD><TABLE class=pbTab>';
...
Tabs.Azar = {
  ...
  init : function (div){
    ...
    t.cont = div;
    t.elementosDeseados = new Array("TestroniusPowder","Blink","Jump","Leap","PurpleBones","GlowingShields", "OutpostWarp", "Ateskes Antlasmasi","CompletionGrant","KIRMIZI Boga","Mor Kemikler", "TranceMarchDrops","ForcedMarchDrops","Kor Isinlanma","Kasaba Projektoru","DragonHearts");

    try {      
      htmIFrame = "";
	  
      htmIFrame += "<div align='center'>What You want to pls click !</div>";
      htmIFrame += "Are you want to item.<br>";
      htmIFrame += "Note: (Max : 5 Items<br>";
      ...
      htmIFrame += "</DIV></DIV>";
      htmIFrame += "<INPUT type=submit value='Start' id='btnAzar'><br>";
