...
google Enhanced BLACK v3.2.5
By gabedibble — Last update 16 hours ago — Installed 567,471 times.
...
There are 79 previous versions of this script.
...
// General Google pg
	...
	/* footers */			(uHideFooters?"#footer,#footer_promos,#footerwrap,P FONT[size='-2'],TABLE[class='t n bt'][width='100%'][cellpadding='2'],DIV[align='center'][style='white-space: nowrap;'],FONT[class='p'][size='-1'],FONT[size='-1'][color='#6f6f6f'],DIV.div-copyright,SPAN.copyr,DIV.content DIV.footer,DIV#footarea,TABLE[width='99%'][cellpadding='3'][bgcolor='#c3d9ff'][align='center'][style='margin-bottom: 5px;'],CENTER > DIV[style='padding: 2px;'] > FONT[size='-1'],CENTER > CENTER > P > FONT[size='-1'],BODY.search > DIV[align='center'] > SMALL > FONT[size='-1'][face='Arial,sans-serif'],BODY > TABLE[width='100%'][height='100%'][style='margin-bottom: 1px;'] > TBODY > TR > TD[valign='top'] > CENTER > FONT[size='-1'],BODY > CENTER > TABLE[width='100%'][cellspacing='0'][cellpadding='2'][border='0'] *,DIV[class='padt10 padb10'] > TABLE[width='100%'] > TBODY > TR > TD[class='fontsize1 padt5'][align='center'],BODY[marginheight='3'][bgcolor='#000000'][dir='ltr'][topmargin='3'] > CENTER > FONT[size='-1'],BODY > DIV[style='width: 100%; clear: both;'] > FORM[name='langform'] > DIV[align='center'] > FONT[size='-1'] {display:none;}":"")+

	// Preferences
		/* pre title line */	"BODY[vlink='#551a8b'][text='#000000'][link='#0000cc'][bgcolor='#000000'][alink='#ff0000'] > DIV[style='width: 100%; clear: both;'] > FORM > TABLE TBODY TR TD[bgcolor='#3366cc'],BODY> DIV[style='width: 100%; clear: both;'] > FORM > TABLE TBODY TR TD[bgcolor='#3366cc'] {display:none;}"+
		/* title hdr txt */	"BODY[vlink='#551a8b'][text='#000000'][link='#0000cc'][bgcolor='#000000'][alink='#ff0000'] > DIV[style='width: 100%; clear: both;'] > FORM > TABLE TBODY TR TD[bgcolor='#e5ecf9'] FONT B {color:#999 !important;}"+
		/* hdrs */		"BODY[vlink='#551a8b'][text='#000000'][link='#0000cc'][bgcolor='#000000'][alink='#ff0000'] > DIV[style='width: 100%; clear: both;'] > FORM > TABLE TBODY TR TD[bgcolor='#e5ecf9'],TABLE TBODY TR[bgcolor='#e5ecf9'],TABLE > TBODY > TR > TD[bgcolor='#e5ecf9'] {background-color:#000;}"+
		/* global borders */	"BODY[vlink='#551a8b'][text='#000000'][link='#0000cc'][bgcolor='#000000'][alink='#ff0000'] > DIV[style='width: 100%; clear: both;'] > FORM > TABLE > TBODY > TR > TD[bgcolor='#cbdced'] {display:none;}"+
		/* pg txt */		"BODY[vlink='#551a8b'][text='#000000'][link='#0000cc'][bgcolor='#000000'][alink='#ff0000'] > DIV[style='width: 100%; clear: both;'] > FORM H1,BODY[vlink='#551a8b'][text='#000000'][link='#0000cc'][bgcolor='#000000'][alink='#ff0000'] > DIV[style='width: 100%; clear: both;'] > FORM H2,BODY[vlink='#551a8b'][text='#000000'][link='#0000cc'][bgcolor='#000000'][alink='#ff0000'] > DIV[style='width: 100%; clear: both;'] > FORM LABEL,TABLE#gsea_table > TBODY > TR > TD DIV {color:#ccc !important;}"+
		/* subscribed links */	"BODY[vlink='#551a8b'][text='#000000'][link='#0000cc'][bgcolor='#000000'][alink='#ff0000'] > DIV[style='width: 100%; clear: both;'] > FORM > TABLE > TBODY > TR > TD[valign='top'] > IFRAME[src='http://www.google.com/coop/sl/pref'] {padding-left:9px; background-color:#fff; "+bS('radiusAll')+":14px;}"+
...
// Web srch Results pg
	...
	// Quality Form
		/* hdr bar */		"BODY[marginheight='3'][bgcolor='#000000'][topmargin='3'] > FORM > TABLE[width='100%'][cellpadding='2'] > TBODY > TR > TD[class='t bt'] {padding-left:10px; background-color:#333; border:0; "+bS('radiusAll')+":14px;}"+
		/* form box bg */	"BODY[marginheight='3'][bgcolor='#000000'][topmargin='3'] > FORM > BLOCKQUOTE > P > TABLE[cellpadding='10'][bgcolor='#cbdced'] {background-color:#000 !important;}"+
		/* bottom line */	"BODY[marginheight='3'][bgcolor='#000000'][topmargin='3'] > CENTER > DIV[class='t n bt'][style='padding: 2px;'] {display:none;}"+

	// Language Tools
		/* top line */		"BODY[vlink='#551a8b'][link='#0000cc'][bgcolor='#000000'][alink='#ff0000'][onload='ht();'] TABLE.header TD,BODY[vlink='#551a8b'][link='#0000cc'][bgcolor='#000000'][alink='#ff0000'] > TABLE > TBODY > TR > TD > TABLE.header > TBODY > TR > TD[bgcolor='#e5ecf9'] {border-top:0 none;}"+
		/* hdr bars */		"BODY[vlink='#551a8b'][link='#0000cc'][bgcolor='#000000'][alink='#ff0000'][onload='ht();'] H4,BODY[vlink='#551a8b'][link='#0000cc'][bgcolor='#000000'][alink='#ff0000'] H4 {background-color:#333; border:0; "+bS('radiusAll')+":14px;}"+
		/* srch across box */	"BODY[vlink='#551a8b'][link='#0000cc'][bgcolor='#000000'][alink='#ff0000'][onload='ht();'] > TABLE[width='100%'][cellpadding='3'] > TBODY > TR[bgcolor='#000000'] > TD,BODY[vlink='#551a8b'][link='#0000cc'][bgcolor='#000000'][alink='#ff0000'] > TABLE[width='100%'][cellpadding='3'] > TBODY > TR[bgcolor='#000000'] > TD {background-color:#000;}"+
	...
	// Help Central
		...
		/* hdr bg */		"BODY.search > TABLE[width='95%'] > TBODY > tr[valign='top'] > TD[width='99%'][valign='top'][bgcolor='#000000'],BODY.search > TABLE[width='95%'] > TBODY > tr[valign='top'] > TD[width='99%'][valign='top'][bgcolor='#000000'] > TABLE > TBODY > TR {background-color:#000;}"+
...
// News Results
	...
	/* top red line */		"BODY[marginwidth='0'][marginheight='3'][bgcolor='white'][rightmargin='0'][leftmargin='0'][topmargin='3'] > TABLE#topSection > TBODY > TR > TD[valign='top'] > TABLE[width='100%'][cellspacing='0'][cellpadding='0'][border='0'] > TBODY > TR > TD[width='100%'][bgcolor='#aa0033'][colspan='2'],BODY[marginheight='2'][bgcolor='#000000'][topmargin='2'] > TABLE[width='100%'][cellspacing='0'][cellpadding='0'][border='0'] > TBODY > TR > TD > TABLE[width='100%'][cellspacing='0'][cellpadding='0'][border='0'] > TBODY > TR > TD[width='100%'][bgcolor='#aa0033'][colspan='2'],BODY[marginheight='0'][bgcolor='#000000'][topmargin='0'] > TABLE[width='100%'][cellspacing='0'][cellpadding='0'][border='0'] > TBODY > TR > TD[width='100%'][bgcolor='#aa0033'][colspan='2'] {display:none;}"+
	...
	/* left nav spacing */		".leftnav TABLE TABLE TBODY TR TD[bgcolor='#000000'] {display:none;}"+
...
// Product srch / Shopping
	...
	/* sponsored linx */		(uHideAds?"DIV[style='padding-top: 11px;'] > DIV[style='font-size: small; background-color: rgb(255,249,221);'],BODY[vlink='#551a8b'][text='#000000'][marginheight='3'][link='#0000cc'][alink='#ff0000'][topmargin='3'] > TABLE[cellspacing='0'][cellpadding='0'][border='0'][bgcolor='#000000'][align='right'][style=''] {display:none;}":"")+
...
// Groups
	...
	// Advanced srch
		/* logo img */		"BODY[marginheight='3'][bgcolor='#000000'][topmargin='3'] > TABLE[width='100%'][cellpadding='0'][border='0'] > TBODY > TR > TD[valign='middle'].tc > A#logo > IMG {display:none;}"+
		...
		/* highlighted bgs */	"TABLE.advsearch-s > TBODY > TR > TD > DIV.outer-box > DIV.qbuilder-env > DIV#gen-query,TABLE.advsearch-s > TBODY > TR > TD > DIV.outer-box > FORM[name='f'].block > DIV > TABLE > TBODY > TR[bgcolor='#000000'],TABLE.advsearch-s > TBODY > TR > TD > FORM[name='msgid'].block > DIV > TABLE > TBODY > TR[bgcolor='#000000'] {background-color:#000; color:#fff !important;}"+
	...
	// Admin
		...
		/* settings bgs */	"TABLE[class='wdth100 overflow-hide'] > TBODY > TR[valign='top'] >  TD.overflow-hide DIV.mnghdrttl,TABLE[class='wdth100 overflow-hide'] > TBODY > TR[valign='top'] >  TD.overflow-hide DIV.mngbottombox DIV,TD.padall6 > TABLE > TBODY > TR > TD > TABLE[width='500'][bgcolor='#000000'] {background-color:#000 !important;}"+
...
// Books
	/* logo img */			"BODY TABLE#top_search_box > TBODY > TR > TD:first-child > A > IMG[height='40'],BODY[bgcolor='#000000'] > TABLE > TBODY > TR > TD[valign='top'][rowspan='2'] > A > IMG,BODY[marginheight='3'][bgcolor='#000000'][topmargin='3'] > DIV[style='margin: 3px 8px;'] > TABLE[style='margin: 7px 0pt 10px; clear: both;'] > TBODY > TR:first-child > TD[valign='top'][rowspan='2']:first-child > A > IMG[height='40'] {display:none;}"+
...
// Toolbar
	...
	/* download box */		"BODY[bgcolor='#000000'][topmargin='3'] CENTER TABLE TBODY TR TD TABLE#download TBODY TR TD {background-color:#000; border:0 !important;}"+
...
// Notebook
	...
	/* faq logo img */		"BODY[bgcolor='#000000'] > TABLE[cellpadding='5'][align='center'] > TBODY > TR[valign='middle'] > TD[width='1%'] > A[href='http://www.google.com/notebook'] > IMG {display:none;}"+
	/* faq title block */		"BODY[bgcolor='#000000'] > TABLE[cellpadding='5'][align='center'] > TBODY > TR[valign='middle'] > TD > TABLE[width='100%'][bgcolor='#c3d9ff'][align='center'][style='margin-bottom: 5px;'] TBODY TR TD {background-color:#000;}"+
	/* faq title block corners */	"BODY[bgcolor='#000000'] > TABLE[cellpadding='5'][align='center'] > TBODY > TR[valign='middle'] > TD > TABLE[width='100%'][bgcolor='#c3d9ff'][align='center'][style='margin-bottom: 5px;'] TBODY TR TD IMG {display:none;}"+
...
// BRUTE-FORCE for "less cooperative" sites (each URI validated)
	...
	function Ge(){
		...
		/* 404 error hdr */	sIR("BODY[text='#000000'][bgcolor='#000000'] TABLE[width='100%'] > TBODY > TR > TD[bgcolor='#3366cc']:first-child {background-color:#000;}");
...
//,BODY > TABLE[width='95%'] > TBODY > TR:first-child > TD[width='1%']:first-child > IMG
	...
	if((iO(lH,".google.")>-1&&(iO(lH,"/Login?")>-1||iO(lH,"/ServiceLogin?")>-1)||iO(lH,"/ServiceLoginAuth")>-1||iO(lH,"/accounts/Login")>-1)||(iO(lH,"https%3A%2F%2Fwww.google.com%2Fvoice%2Faccount%2Fsignin%2F")>-1)){
		...
		/* hdrBubbleSides */	sIR("BODY > TABLE[width='95%'] > TBODY > TR[valign='top']:first-child > TD[bgcolor='#000000'][width='99%'][valign='top'] > TABLE > TBODY > TR > TD > TABLE[bgcolor='#c3d9ff'][width='100%'] > TBODY > TR > TD.tl,BODY > TABLE[width='95%'] > TBODY > TR[valign='top']:first-child > TD[bgcolor='#000000'][width='99%'][valign='top'] > TABLE > TBODY > TR > TD > TABLE[bgcolor='#c3d9ff'][width='100%'] > TBODY > TR > TD.tr,BODY > TABLE[width='95%'] > TBODY > TR[valign='top']:first-child > TD[bgcolor='#000000'][width='99%'][valign='top'] > TABLE > TBODY > TR > TD > TABLE[bgcolor='#c3d9ff'][width='100%'] > TBODY > TR > TD.br,BODY > TABLE[width='95%'] > TBODY > TR[valign='top']:first-child > TD[bgcolor='#000000'][width='99%'][valign='top'] > TABLE > TBODY > TR > TD > TABLE[bgcolor='#c3d9ff'][width='100%'] > TBODY > TR > TD.bl {display:none;}");
	...
	// Web: Advanced srch
		...
		/* lower box bg */	sIR("TABLE[width='99%'] > TBODY > TR[bgcolor='#cbdced'] > TD TABLE[width='100%'] > TBODY > TR[bgcolor='#000000'],TABLE[width='99%'] > TBODY > TR[bgcolor='#cbdced'] > TD > TABLE[width='100%'] > TBODY > TR[bgcolor='#000000'] TD,BODY > FORM[name='f'] > FONT > TABLE > TBODY > TR > TD,BODY > FORM[name='f'] > FONT > TABLE > TBODY > TR > TD TD {background-color:#000 !important; color:#ccc !important;}");
	...
	// Custom srch Engine
		...
		/* logo img [hide] */	sIR("BODY > DIV#content TD[style='padding-right: 25px; padding-top: 8px;'] > A > IMG,BODY > DIV#parent > DIV#header > DIV#title:first-child > TABLE:first-child > TBODY > TR:first-child > TD[valign='middle']:first-child > A#logo > IMG,BODY > DIV#parent > DIV#header > TABLE:first-child > TBODY > TR:first-child > TD:first-child > A > IMG,BODY > DIV#content > DIV[style='padding: 10px;']:first-child > A > IMG,BODY > DIV[align='left']:first-child > TABLE:first-child > TBODY > TR > TD[width='1'] > IMG,IMG[src='/images/poweredby_transparent/poweredby_000000.gif'] {display:none;}");
	...
	// Notebook
		...
		/* faq logo img */	sIR("BODY[bgcolor='#000000'] > TABLE[cellpadding='5'][align='center'] > TBODY > TR[valign='middle'] > TD[width='1%'] > A[href='http://www.google.com/notebook'] > IMG {display:none;}");
		/* faq title block */	sIR("BODY[bgcolor='#000000'] > TABLE[cellpadding='5'][align='center'] > TBODY > TR[valign='middle'] > TD > TABLE[width='100%'][bgcolor='#c3d9ff'][align='center'][style='margin-bottom: 5px;'] TBODY TR TD {background-color:#000;}");
		/* faqtitle bcorners */	sIR("BODY[bgcolor='#000000'] > TABLE[cellpadding='5'][align='center'] > TBODY > TR[valign='middle'] > TD > TABLE[width='100%'][bgcolor='#c3d9ff'][align='center'][style='margin-bottom: 5px;'] TBODY TR TD IMG {display:none;}");
	...
	// Groups
		...
		/* activity body */	sIR("TD.group-restricted,DIV[style='border-top: 15px solid white; border-bottom: 10px solid white;'],#stat_cal,#stat_cal TD[bgcolor='#000000'] {background-color:#222; border-top-color:#222 !important; border-bottom-color:#222 !important;}");
		/* activity sub */	sIR("#stat_cal TABLE[bgcolor='#000000'] {background-color:#151515 !important; border-top-color:#222 !important; border-bottom-color:#222 !important; "+bS('radiusAll')+":14px;}");
		...
		/* manage table hdr */	sIR("BODY > TABLE > TBODY > TR > TD > TABLE[bgcolor='#e8eef7'] > TBODY > TR > TD > FORM > TABLE[bgcolor='#000000'] > TBODY > TR[bgcolor='#e8eef7'],BODY > TABLE > TBODY > TR > TD > TABLE[bgcolor='#e8eef7'] > TBODY > TR > TD > FORM > TABLE[bgcolor='#000000'] > TBODY > TR[bgcolor='#e8eef7'] > TD[bgcolor='#e8eef7'] {background-color:#222 !important;}");
		/* manage table bgs */	sIR("BODY > TABLE > TBODY > TR > TD > TABLE[bgcolor='#e8eef7'],BODY > TABLE > TBODY > TR > TD > TABLE[bgcolor='#e8eef7'] > TBODY > TR > TD > FORM > TABLE[bgcolor='#000000'],DIV.mnghdrttl,DIV.mngtabbox > DIV > TABLE > TBODY > TR > TD,DIV.mngtabbox > DIV > TABLE > TBODY > TR > TD > DIV,DIV.mnghdrbtm,DIV.mnghdrbtmitem,DIV.mngcontentbox > TABLE > TBODY > TR > TD.padall6 > TABLE > TBODY > TR > TD TABLE[bgcolor='#000000'],TABLE.membertabs TD[bgcolor='#d9d9d9'],DIV.mngcontentbox > TABLE[bgcolor='#d9d9d9'],TABLE[bgcolor='#000000'].memlist,DIV[style='padding: 4px 4px 3px; background-color: rgb(217, 217, 217);'],TR[style='background-color: rgb(238, 238, 238);'],TD[style='background-color: rgb(238, 238, 238);'],DIV[style='background-color: rgb(238, 238, 238);'],DIV[style='background-color: rgb(238, 238, 238); padding: 4px 10px;'],DIV[style='width: 32ex; background-color: rgb(238, 238, 238);'],DIV[style='padding: 4px 4px 3px; background-color: rgb(217, 217, 217); display: block;'],DIV#GE_optionsPane_botcorner > DIV > TABLE > TBODY > TR > TD > DIV,DIV#GE_optionsPane_botcorner > DIV > TABLE > TBODY > TR > TD[bgcolor='#7799dd'],DIV.maincontheaderboxatt TD[bgcolor='#e8eeff'] {background:#000 none !important;}");
		...
		/* about archiveTblI */	sIR("DIV.maincontbox > TABLE > TBODY > TR > TD.padb5 TD[bgcolor='#e8eef7'] > TABLE[bgcolor='#000000'] {background-color:#333;}");
		...
		/* advSrch tblRows */	sIR("FORM.block > DIV > TABLE > TBODY > TR[bgcolor='#000000'],FORM.block > DIV > TABLE > TBODY > TR[bgcolor='#000000'] TD,FORM.block > DIV > TABLE > TBODY > TR[bgcolor='#000000'] B {background-color:#000; color:#999;}");
	...
	// Scholar
		...
		/* advSrch lowerBody */	sIR("BODY > FORM > TABLE[width='99%'][cellpadding='3'] TR[bgcolor='#dcf6db'],BODY > FORM > TABLE[width='99%'][cellpadding='3'] TR[bgcolor='#000000'] {background-color:#000;}");
	...
	// Patents: Advanced srch
		...
		/* inner bg */		sIR("BODY > FORM > TABLE TR[bgcolor='#000000'] TD{background-color:#000; color:#ccc;}");
	...
	// Gmail
	 ...
	 if(iO(lH,"/mail/help/")>-1&&(iO(lH,".html")>-1||iO(lH,"/tasks/")>-1)){ //supportingPages
		...
		/* logo img */		sIR("BODY[bgcolor='#000000'] > TABLE[width='100%'] > TBODY > TR:first-child > TD[width='143'] > H1 > A > IMG {display:none;}");
		...
		/* msg-list row normal */sIR("BODY > TABLE[width='100%'] > TBODY > TR > TD[valign='top'] > TABLE[width='100%'] > TBODY > TR > TD > FORM[name='f'] > TABLE.th > TBODY > TR[bgcolor='#000000'] {background-color:#000;}");
		...
		/* contactsList bg */	sIR("BODY > TABLE[width='100%'] > TBODY > TR > TD[valign='top'] > TABLE[width='100%'] > TBODY > TR > TD > TABLE[bgcolor='#000000'].th,BODY > TABLE[width='100%'] > TBODY > TR > TD[valign='top'] > TABLE[width='100%'] > TBODY > TR > TD[bgcolor='#fff7d7'] {background-color:#000;}");
		/* contactsListTbTxt */	sIR("BODY > TABLE[width='100%'] > TBODY > TR > TD[valign='top'] > TABLE[width='100%'] > TBODY > TR > TD > TABLE[bgcolor='#000000'].th > TBODY > TR > TD {color:#ccc !important;}");
		/* settings selTab */	sIR("BODY > TABLE[width='100%'] > TBODY > TR > TD[valign='top'] > TABLE[width='100%'] > TBODY > TR > TD > TABLE[bgcolor='#000000'].th,BODY > TABLE[width='100%'] > TBODY > TR > TD[valign='top'] > TABLE[width='100%'] > TBODY > TR > TD[bgcolor='#fff7d7'] DIV.nav > UL > LI.on {background-color:#333; color:#fff;}");
	...
	// Web History & Bookmarks
		...
		/* r-Calendar u-row */	sIR("TD[align='center'][style='border: 1px solid rgb(201, 215, 241); padding: 6px;'] > TABLE[cellpadding='1']:first-child > TBODY > TR[bgcolor='#000000']:first-child {background-color:transparent;}");
		/* r-Calendar u-rnd */	sIR("TD[align='center'][style='border: 1px solid rgb(201, 215, 241); padding: 6px;'] > TABLE[cellpadding='1']:first-child > TBODY > TR[bgcolor='#000000']:first-child > TD {background-color:#fff; "+bS('border-radius-topright')+":8px; "+bS('border-radius-topleft')+":8px;}");
	...
	// My Account
		...
		/* pass strgnth box */	sIR("BODY > DIV.body FORM[action='UpdatePasswd'] > TABLE[cellpadding='2'] > TBODY > TR > TD[valign='top'] > TABLE[bgcolor='#000000'],TD#passwdBarDiv {background-color:#000;}");
	...
	// Alerts
		...
		/* create box body */	sIR("TABLE[width='320'][cellpadding='1'] > TBODY > TR:first-child > TD[bgcolor='#3366cc'] > TABLE[bgcolor='#000000'] {background-color:#222; "+bS('border-radius-bottomright')+":14px; "+bS('border-radius-bottomleft')+":14px;}");
	...
	// Answers
		...
		/* logo img [rem] */	sIR("TABLE.top > TBODY > TR:first-child > TD:first-child > IMG[src='answers/answers-logo-sm.gif'],BODY[bgcolor='#000000'] > TABLE[width='100%'][cellpadding='2']:first-child > TBODY > TR:first-child > TD[width='1%']:first-child > A > IMG[width='143'] {display:none;}");
		/* logo img [ins] */	sIR("TABLE.top > TBODY > TR:first-child > TD:first-child,BODY[bgcolor='#000000'] > TABLE[width='100%'][cellpadding='2']:first-child > TBODY > TR:first-child > TD[width='1%']:first-child {width:150px !important; height:50px !important; background:transparent url('"+gL+"') no-repeat scroll 0 !important;}");
		/* hdrs */		sIR("BODY > TABLE[width='100%'][cellpadding='2'] > TBODY > TR > TD[width='100%'][bgcolor='#49188f'][colspan='6'],BODY[bgcolor='#000000'] > TABLE[width='100%'][cellpadding='2']:first-child > TBODY > TR:first-child > TD > TABLE[width='100%'][cellpadding='2'] > TBODY > TR > TD[bgcolor='#49188f'],BODY[bgcolor='#000000'] > DIV#answers > DIV > TABLE[width='98%'] > TBODY > TR > TD[bgcolor='#eeeeee'] {padding-left:0.5em; background-color:#333; border:0 none; color:#fff; "+bS('radiusAll')+":14px;}");
		...
		/* sResults tblC */	sIR("BODY > TABLE[width='100%'][cellpadding='4'] > TBODY > TR[valign='top'] > TD[bgcolor='#000000'],BODY > CENTER > TABLE[width='98%'] > TBODY > TR[bgcolor='#eeeeee'],BODY > CENTER > TABLE[width='98%'] > TBODY > TR > TD[bgcolor='#eeeeee'] {background-color:#181818;}");
