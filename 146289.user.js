...
// @namespace      http://www.facebook.com/frozenboy1992
...
.replace(/:sexygirl:/g, "<style>.md img { display:inline; } .rageface { visibility:visible; } </style><img  src=\'http://www.geocities.ws/tainppd00015/emo/sexygirl.png\' title='Sexy' />")
...
.replace(/:sexy:/g, "<style>.md img { display:inline; } .rageface { visibility:visible; } </style><img  src=\'http://vozforums.com/images/smilies/Off/sexy_girl.gif\' title='Sexy' />")
...
.replace(/\:\)\)/g, "<style> .md img { display:inline; } .rageface { visibility:visible; } </style><img src=\'http://l.yimg.com/us.yimg.com/i/mesg/emoticons7/21.gif\' title=\'cuoito\' />")
...
.replace(/\:\(/g, "<style> .md img { display:inline; } .rageface { visibility:visible; } </style><img src=\'http://l.yimg.com/us.yimg.com/i/mesg/emoticons7/2.gif\' title=\'buon\' />")
...
.replace(/\:\-ss/g, "<style> .md img { display:inline; } .rageface { visibility:visible; } </style><img src=\'http://l.yimg.com/us.yimg.com/i/mesg/emoticons7/42.gif\' title=\'so\' />")
...
.replace(/\=\)\)/g, "<style> .md img { display:inline; } .rageface { visibility:visible; } </style><img src=\'http://l.yimg.com/us.yimg.com/i/mesg/emoticons7/24.gif\' title=\'cuoilan\' />")
