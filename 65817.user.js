// ==UserScript==
// @name           Color Picker for Slow Kaos II game
// @namespace      slow_kaos_ii_colors.user.js
// @description    Show available colors for Slow Kaos II game
...
// ==/UserScript==
/**
 * A script to pick available colors in Slow Kaos II LG game
 * @author Brian Banner (based on original script by Jakub Caban)
...
var oLast = CreateButtonWithTD("Slow Kaos II Pick Color", "Find an available color in Slow Kaos II game");
...
function LastResortColor(){
	...
	for(i in toAr){
        ...
        MyColors[MyColors.length] = new RGBColor('#67fc43');
        MyColors[MyColors.length] = new RGBColor('#0083fd');
        MyColors[MyColors.length] = new RGBColor('#52f444');
        MyColors[MyColors.length] = new RGBColor('#b36d01');
        MyColors[MyColors.length] = new RGBColor('#f63208');
