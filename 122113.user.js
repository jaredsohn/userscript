...
// @name DS Assistent2
// @key DS Assistent2
// @description DS Assistent2
// @author Hypix
// @developer Hans Solo
// @version 8.2-1.0.1
// @homepage http://userscripts.org/scripts/show/122113
// @supportURL http://sourceforge.net/projects/dsassistent2/

// @contributionURL https://www.paypal.com/cgi-bin/webscr?cmd=_s-xclick&hosted_button_id=6D9WFJ45XNX7G
...
// @include http://*.die-staemme.de/sid_wrong.php*
...
//win.ScriptAPI.register( 'DS Assistent', 8.0, 'Hypix', 'ds_scripte@hypix.de' );

var msg = "";
var ownPid,curVillage;
var dsVersion = "8.2";
//Aufbau
//DS Version - Technische Version . Programm Version . Bugfix Version
//Technische Version = Ab hier wird ein neuer Datenimport notwendig
var version = "8.2-1.0.1";
    ...
    gui: {
      ...
      settings: {
        ...
        map: {
          ...
          saveHours: ["Beute der letzten ", " Stunden speichern"],
        ...
        place: {
          ...
          okOnPlayer: ["Ok-Button auf der Bestätigungsseite bei Angriff auf ein Spieler- oder reserviertes Dorf", "belassen", "Rot färben", "Rot färben und Dorf sperren" ],
          ...
          farmlist: ["Farmliste", "Farmen mit mehr als ", " Rohstoffen im Umkreis von","Feldern"],
          maxAttAge: "max. Alter der Angriffsmarker in Stunden",
          minEQ: "Minimaler Erfolgsquotient",
          colorFLRes: "Rohstoffe der Farmen je nach Füllmenge farblich hinterlegen",
        ...
        misc: {
          ...
          fixHead: "Schnell- und Titelleiste fixiern",
          ...
          ctxCtrl: "Kontextmenü's nur bei Strg+Rechtsklick anzeigen",
          moveAtts: ["Position der Angriff und Unterstützungsanzeige", "links", "mitte links", "mitte", "mitte rechts", "rechts" ],
          removeAMIcons: "Icons des Account-Managers aus der Menüzeile entfernen",
          privateNames: "Private Dorfnamen verwenden",
        },
        prod: {
        ...
        sounds: {
          ...
          support: "Unterstützung gestartet",
          supportDone: "Unterstützung eingetroffen",
        },
        build: {
          showOVLoyalty: "Zustimmung in der Gebäudeübersicht anzeigen",
          showMissingRes: "Fehlende Resourcen hinter den Kosten anzeigen",
          enhancedOV: "Varianten in Gebäudeübersicht benutzen",
          toBuildColor: "Hintergrundfarbe für auszubauende Gebäude",
          toDestroyColor: "Hintergrundfarbe für abzureissende Gebäude",
          queueCostColor: "Hintergrundfarbe für die Bauschleife, wenn Zusatzkosten entstehen",
        },
      },
      ...
      hotKeyLabels: { common: { title: "Allgemein",
                      ...
                      map: { title: "Karte",
                                hks: { title0: "Aktion bei \"Klick auf Dorf\" auswählen:", villageinfo: "Dorfinfos", sendunits: "Truppen schicken", getunits: "Truppen holen", market: "Rohstoffe schicken", getress: "Rohstoffe holen", centermap: "Karte zentzrieren", removeinfo: "Infos löschen", selectvillage: "Dort auswählen", togglenofarm: "Farmlistensperre ändern", coordlist: "Koordinatenliste", 
                                       title1: "Overlay für eigene Dörfer auswählen:", ownNone: "Nichts", ownUnits: "Einheiten", ownGroups: "Gruppen", ownCoords: "Koordinaten", ownName: "Name", ownPoints: "Punkte", ownResource: "Rohstoffe", ownDef: "Def-Bewertung", ownAttsNSups: "Angriffe und Unterstützungen",
                                       title2: "Overlay für fremde Dörfer auswählen:", otherNone: "Nichts", otherFarmInfo: "Farminfos", otherPlayer: "Spieler", otherCoords: "Koordinaten", otherName: "Name", otherPoints: "Punkte", /*otherMoral: "Moral",*/ otherAlly: "Stamm", otherAttsNSups: "Angriffe und Unterstützungen",
                      ...
                      villageinfo: { title: "Dorfinfos",
                                     hks: { centermap: "Karte zentzrieren", sendunits: "Truppen schicken", getunits: "Truppen holen", market: "Rohstoffe schicken", getress: "Rohstoffe holen", reserve: "Dorfreservierung", togglefav: "Zu den Favoriten hinzufügen bzw. entfernen", markonmap: "Auf der Karte markieren", removeinfos: "Farmmanager-Infos löschen", togglenofarm: "Farmlistensperre", reseteq: "EQ zurücksetzen", overview: "Dorfübersicht", modgroups: "Gruppenzugehörigkeit bearbeiten", ap: "Zum Adelsplaner" } 
                                   },
                    },
      reportGroups: {
        attack_luck:      "Glück",
...
//      ovlMoral: "Moral",
      ...
      ovlAttsNSups: "Angriffe/Unterstützungen",
      ...
      knockDown: "Abriss läuft",
      buildingUp: "Ausbau läuft",
      buildTime: "Bauzeit",
      required: "Benötigt:",
      ...
      confirmAssignBuildVariant: "Diese Gebäudekonfiguration für alle Dörfer dieser Gruppe festlegen?",
      ...
      village: "Dorf",
      support_detail: "Unterstützungen von:",
      away_detail: "Unterstützungen bei:",
      all_detail: "Allen",
      muster: "Appell",
      noMusterTime: "Bitte zuerst Appellzeit angegeben! Format: (TT.MM. hh:mm)",
      reset: "Zurücksetzen",
      fake: "Fake",
      newVersion: ["Neue Version vorhanden", "Aktuelle Version:", "Forenthread", "Wiki", "Nicht mehr an diese Version erinnern", "Neue Version"],
      groupTitle: ["Map", "Reihenfolge", "Vorschau", "Name", "Farbe", "Symbol", "Umbruch", "Löschen"],
      doesntExist: "(nicht vorhanden)",
      requires: "Benötigt: ",
      publicName: "Öffentlicher Name",
      privateName: "Privater Name",
      showAllBuildings: "Alle Gebäude anzeigen",
      hideCompletedBuildings: "Fertig ausgebaute Gebäude ausblenden",
      lastAtt: "Alter",
      //forumThread: "http://forum.die-staemme.de/showpost.php?p=2810431",  //HS_ LCHKV 001
      forumThread: "https://sourceforge.net/projects/dsassistent2/", //HS_ LCHKV 001
      forumWiki: "http://sourceforge.net/apps/mediawiki/dsassistent2/", //HS _ SE 002
      forumDonate: "https://www.paypal.com/cgi-bin/webscr?cmd=_s-xclick&hosted_button_id=6D9WFJ45XNX7G", //HS_ SE 002
      forumLinkToDSAssistent: "http://sourceforge.net/projects/dsassistent2/files/In%20Arbeit/", //HS_ LCHKV 001
    },
    regex: {
      reportTitle: /<[Hh]3>Der Angreifer|Verteidiger hat gewonnen<\/[Hh]3>/,
      reportSupport: /unterstützt/,
      villageLink: /\((\d{1,3})\|(\d{1,3})\) K(\d+)\s*$/, // hier ist eigentlich nur das "K" für Kontintent anzupassen
      sendDate: /Gesendet<\/td><td>([^<]+)<\/td>/,
      ...
      commands: {
        attacked: /greift (.*) \((\d{1,3})\|(\d{1,3})\) K(\d{1,2}) an\s*$/,
        conquer: /erobert (.*) \((\d{1,3})\|(\d{1,3})\) K(\d{1,2})\s*$/,
        attack: /Angriff auf (.*) \((\d{1,3})\|(\d{1,3})\) K(\d{1,2})\s*$/,
        comeback: /Rückkehr von (.*) \((\d{1,3})\|(\d{1,3})\) K(\d{1,2})\s*$/, 
        abort: /Abgebrochener Befehl nach (.*) \((\d{1,3})\|(\d{1,3})\) K(\d{1,2})\s*$/,
        support: /Unterstützung für (.*) \((\d{1,3})\|(\d{1,3})\) K(\d{1,2})\s*$/,
        callback: /Rückzug von (.*) \((\d{1,3})\|(\d{1,3})\) K(\d{1,2})\s*$/,
        sentback: /Zurückgeschickt von (.*) \((\d{1,3})\|(\d{1,3})\) K(\d{1,2})\s*$/,
      },
    },
    locale: {
      nrgroupsign: ".",
      timeStr2Sec: function(str) {
        var res = str.match(/(am (\d{2})\.(\d{2})\.(\d{2})?|morgen|heute) um (\d{2}):(\d{2}):?(\d{2})?:?(\d{3})?/);
        if( !res )
  ...
  ch: {
    ...
    regex: {
      ...
      visit: /<h3>Besuch<\/h3>/i,
      commands: {
        attacked: /grift (.*) \((\d{1,3})\|(\d{1,3})\) K(\d{1,2}) a\s*$/,
        conquer: /erobert (.*) \((\d{1,3})\|(\d{1,3})\) K(\d{1,2})\s*$/,
        attack: /Agriff uf (.*) \((\d{1,3})\|(\d{1,3})\) K(\d{1,2})\s*$/,
        comeback: /Rückkehr vo (.*) \((\d{1,3})\|(\d{1,3})\) K(\d{1,2})\s*$/, 
        abort: /Abgebrochener Befehl nach (.*) \((\d{1,3})\|(\d{1,3})\) K(\d{1,2})\s*$/,
        support: /Unterstützung für (.*) \((\d{1,3})\|(\d{1,3})\) K(\d{1,2})\s*$/,
        callback: /Rückzug von (.*) \((\d{1,3})\|(\d{1,3})\) K(\d{1,2})\s*$/,
        sentback: /Zurückgeschickt von (.*) \((\d{1,3})\|(\d{1,3})\) K(\d{1,2})\s*$/,
    ...
    locale: {
      nrgroupsign: ".",
      timeStr2Sec: function(str) {
        var res = str.match(/(am (\d{2})\.(\d{2})\.(\d{2})?|morn|hüt) um (\d{2}):(\d{2}):?(\d{2})?:?(\d{3})?/);
        if( !res )
          res = str.match(/((\d{2})\.(\d{2})\.(\d{2})?) (\d{2}):(\d{2}):?(\d{2})?:?(\d{3})?/);
        sec = 0;
        if( res ) {
...
//      farmColFloating: true,
  ...
  defHotKeys : {
    ...
    "villageinfo":{
      ...
      "overview":{"keyCode":59,"text":" [Ü]","modifier":0},
  ...
  defSounds : { 
    ...
    support:     { active: true, volume: 75, url: "http://www.mediacollege.com/downloads/sound-effects/crowd/marching-01.wav", loop: false },
    supportDone: { active: true, volume: 75, url: "http://www.mediacollege.com/downloads/sound-effects/office/elevator-door-01.wav", loop: false },
  ...
  showSettings : function() {
    ...
    //row.insertCell(-1).innerHTML = '<a href="http://hypix.de/staemme/spenden.html" target="_blank">'+texts[lib.lang].gui.donate+'</a>'; //HSX
...
*/
  ...
  loadFarmList : function() {
    ...
    Place.farmlist = [];
    for(var key in otherVillages) {
      if( nofarms.indexOf(key) == -1 ) {
        coords = key.split("_");
        ...
        if( dist < Settings.settings.place.farmDist ) {
          ...
          if( village.res.timestamp > 0 ) {
            ...
            if( village.buildings.timestamp > 0 ) {
              var max = serverInfo.getStorageSize(village)-serverInfo.getHideSize(village.buildings.hide.level);
              var sum = 0;
              var entry = { lastAtt: village.lastreport.timestamp, "dst": {x: coords[0], y:coords[1]}, "dist": dist, "eq": Math.max(Settings.settings.place.minEQ,village.eq), "color": village.color, "wood": 0, "woodcolor": 0, "stone": 0, "stonecolor":0, "iron": 0, "ironcolor": 0, "sum": 0, "storage": max, "sumcolor": 0, wall: village.buildings.wall.level, hasAtt: cmds[key] && cmds[key].attacks.length > 0 };
              ...
              for( var res in resInfos ) {
                ...
                if( Settings.settings.place.colorFLRes )
                  entry[res+"color"] = Storage.getColors("resource",val*100 / max);
              }
              ...
              var sum = 0;
              var entry = { lastAtt: village.lastreport.timestamp, "dst": {x: coords[0], y:coords[1]}, "dist": dist, "eq": Math.max(Settings.settings.place.minEQ,village.eq), "color": village.color, "wood": 0, "woodcolor": {text:"rgb(0,38,255)",background:""}, "stone": 0, "stonecolor":{text:"rgb(0,38,255)",background:""}, "iron": 0, "ironcolor": {text:"rgb(0,38,255)",background:""}, "sum": 0, "storage": max, "sumcolor": 3, wall: "?", hasAtt: cmds[key] && cmds[key].attacks.length > 0 }
              for( var res in resInfos ) {
    ...
    Place.farmlist.sort(Place.compareFarms);
  },
  showFarmList : function(event) {
    ...
    cell = row.appendChild(ce("th"));
    cell.innerHTML = '<img src="/graphic/holz.png" alt="'+texts[lib.lang].resources.wood+'" title="'+texts[lib.lang].resources.wood+'"/>';
    cell.style.textAlign = "center";
    cell = row.appendChild(ce("th"));
    cell.innerHTML = '<img src="/graphic/lehm.png" alt="'+texts[lib.lang].resources.stone+'" title="'+texts[lib.lang].resources.stone+'"/>';
    cell.style.textAlign = "center";
    cell = row.appendChild(ce("th"));
    cell.innerHTML = '<img src="/graphic/eisen.png" alt="'+texts[lib.lang].resources.iron+'" title="'+texts[lib.lang].resources.iron+'"/>';
    cell.style.textAlign = "center";
    cell = row.appendChild(ce("th"));
...
var BuildAssist = {
  ...
  updateMain : function() {
    ...
    for( var b in serverInfo.buildingInfo ) {
	  ...
	  if( lib.params.get("t",0) != 0 )
		html += "t="+lib.params.t+"&";
	  cell.innerHTML = html + 'village='+lib.game_data.village.id+'&screen='+b+'"><img alt="" title="'+texts[lib.lang].buildings[b]+'" src="graphic/buildings/'+b+'.png?1"> '+texts[lib.lang].buildings[b]+'</a> '+txt;
      if( req != "" ) {
        cell = row.insertCell(-1);
        cell.colSpan=6;
        cell.align = "center";
  ...
  onUpdateOVRow : function(e) {
    ...
    if( e.target.nodeName == "LI" && e.type == "DOMNodeRemoved" )
        e.target.getElementsByClassName("build-status-light")[0].style.backgroundColor = "";
  ...
  updateOVRow : function(row,id) {
    ...
    if( order.length > 0 ) {
      ...
      for( var i = 0; i < li.length; i++ ) {
        var statusLight = li[i].getElementsByClassName("build-status-light")[0];
        var dif = 0;
  ...
  getRequirements : function(key) {
    ...
    if( typeof(BuildAssist.requirements[key]) != "undefined" ) {
      ...
      for( var b in BuildAssist.requirements[key] ) {
        ret += '<img alt="" src="graphic/buildings/main.png?1"> '+texts[lib.lang].buildings[b]+" ("+texts[lib.lang].gui.level+" "+BuildAssist.requirements[key][b]+") ";
...
var Report = {
  ...
  setHotKeys : function() {
    if( Settings.settings.misc.useHotKeys ) {
      var res = document.evaluate("//td[@class='nopad']/table[@class='vis']",document,null,XPathResult.ORDERED_NODE_SNAPSHOT_TYPE,null);
  ...
  parse : function(isPublicReport) {
    ...
    var table = document.evaluate("//td[@class='nopad']/table[@class='vis']",document,null,XPathResult.ORDERED_NODE_SNAPSHOT_TYPE,null).snapshotItem(1);
  ...
  doUnitsDetail : function(type) {
    ...
    for( var i = 0; i < OV.tab.tBodies[0].rows.length; i++ ) {
      ...
      if( /units_away/.test(row.className) ) {
        ...
        var coords2 = row.cells[0].textContent.match(/ \((\d+)\|(\d+)\) K\d+/);
      ...
      switch( type ) {
        ...
        case "villages":
          for( var j = start + 1; j < end; j++ ) {
            var coords = OV.tab.rows[j].cells[0].textContent.match(/ \((\d+)\|(\d+)\) K\d+/);
            if( coords ) {
...
var PrivateVillageName = {
  ...
  modMain : function() {
    var tab = document.evaluate("//form[contains(@action,'change_name')]/table", document, null, XPathResult.ORDERED_NODE_SNAPSHOT_TYPE, null ).snapshotItem(0);
    var row = tab.insertRow(-1);
    var cell = row.insertCell(-1);
    var input = cell.appendChild(ce("input"));
    input.type = "text";
    ...
    input.addEventListener("click", function() {
        ...
        var a = document.evaluate("//td[@id='menu_row2_village']/a", document, null, XPathResult.ORDERED_NODE_SNAPSHOT_TYPE, null ).snapshotItem(0);
        if( name == "" ) {
  ...
  submitPrivateEdit : function() {
    ...
    var a = document.evaluate("//td[@id='menu_row2_village']/a[contains(@href,'village="+id+"')]",document,null,XPathResult.ORDERED_NODE_SNAPSHOT_TYPE,null).snapshotItem(0);
  ...
  modVillageInfo : function(tab) {
    ...
    var h2 = document.evaluate("//td[@id='content_value']/h2",document,null,XPathResult.ORDERED_NODE_SNAPSHOT_TYPE,null).snapshotItem(0);
