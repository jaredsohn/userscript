// ==UserScript==
      // @name   Write your name in Heart Shape
      // @author  Someone
      // @provided by http://softwaresforyou.blogspot.com
      // @description use it with the page on
      // @Edited by Aaron
      // ==/UserScript==
...
function createHeart(sourceId, resultId) {
    ...
    heart += "- powered by softwaresforyou.blogspot.com"; 
