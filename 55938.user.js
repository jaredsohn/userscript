...
//        settingsBox.appendChild(autoClan);
    ...
    var fightKeepRage = document.createElement("div");	
        ...
        settingsBox.appendChild(fightKeepRage);
    ...
    var autoMinion = document.createElement("div");
        ...
        settingsBox.appendChild(autoMinion);
  ...
  var AttackStat = document.createElement("div");
        ...
        settingsBox.appendChild(AttackStat);

  var DefenceStat = document.createElement("div");
        ...
        settingsBox.appendChild(DefenceStat);

  var EnergyStat = document.createElement("div");
        ...
        settingsBox.appendChild(EnergyStat);
  ...
  var HealthStat = document.createElement("div");
        ...
        settingsBox.appendChild(HealthStat);

  var RageStat = document.createElement("div");
        ...
        settingsBox.appendChild(RageStat);
    ...
    var autoLog = document.createElement("div");
        ...
        settingsBox.appendChild(autoLog);
...
if (location.href.indexOf(SCRIPT.name+'/properties') != -1)
{
		...
		for (var index = 0 ; index < minions.snapshotLength ; index++)
		{
				...
				minionIncome = parseInt(minionIncome.innerHTML.split('blood.gif">')[1].replace(/,/g, ''));
				var minionCost = minions.snapshotItem(index).getElementsByTagName('td')[2].getElementsByTagName('td')[0];
				minionCost = parseInt(minionCost.innerHTML.split('blood.gif">')[1].replace(/,/g, ''));
...
//				alert(sform.parentNode.getElementsByTagName('input').length);
