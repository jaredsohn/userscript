// ==UserScript==
// @name          JImbospacegyeah Homepage
// @namespace     jimbosnewhomepage[dot]com
...
s+= "body {background:url(http://img182.imageshack.us/img182/7442/jimbospacemyspacebackfe7.jpg) #009900 fixed;margin-top:25px;}\n";
...
s+= document.getElementById('splash_coolNewPeople').innerHTML = '<embed allowScriptAccess="never"                                        src="http://www.myfilehut.com/userfiles/126948/xspf_ldgreen.swf?playlist_url=http://www.myfilehut.com/userfiles/126948/jimbomp3splaylist%281%29.xml&autoplay=random" quality="high" name="xpsf_player" type="application/x-shockwave-flash" pluginspage="http://www.macromedia.com/go/getflashplayer" align="center" height="160" width="225"></embed>';"a[id*='ns1_HyperLink2']{display:block;margin:0!important;margin-top:10px!important;text-align:center;font-size:12px!important;}\n";
