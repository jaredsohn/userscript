// ==UserScript==
// @name           professional-bux
// @namespace      
// @description    auto clicks pro-bux ads
// @include        http://professional-bux.977mb.com//surf.php
// ==/UserScript==
...
function getLinks(){
	...
	for(var i=0;i<links.snapshotLength;i++){
		...
		if ((item.href.substring(0,47)=='http://professional-bux.977mb.com//view.php?ad=') &&
			!(item.href=='http://professional-bux.977mb.com//view.php?ad='))
			work.push(item);
	}
