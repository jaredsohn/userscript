// ==UserScript==
// @name            NG advanced search
// @description     Select a word, and immidiately see it looked up in Nextgn, Plus a media player and other stuff
// @source          file
// @identifier      Krabbe4
// @version         2.0
// @date            2013-01-29
...
// ------------------------------------------------------------------------------------
var defaultSites = [
    ['NG', 'http://nxtgn.org/browse.php?search=[words]&cat=0&incldead=0&modes=&c4=1&c31=1', "n", 'narrowbar'],
    ['music', 'http://www.newly.in/search/[words]/', "m", 'widebar'],
    ['Forum', 'http://nxtgn.org/forums.php?action=search&keywords=[words]', "f", 'narrowbar'],
    ['Imdb','http://www.imdb.com/find?q=[words]&s=all','i','megawidebar'],    
    ['Google images', "http://images.google.com/images?lookitup&svnum=10&hl=en&gbv=2&start=0&q=[words]&xcrop=//a[img]&css=div{display:none}img{border:0!important}&xremove=//a[1]&eval=ex=/start=([0-9]*)/;hr=location.href;document.body.innerHTML+='%3Ca%20href='+hr.replace(ex,'start='+(parseInt(hr.match(ex)[1],10)+21))+'%3ENext%3C/a%3E'", "o", 'widebar'],
    ...
    ['The Free Dictionary','http://www.thefreedictionary.com/dict.asp?Word=[words]#lookitup!xcrop=#MainTxt|#TDTotalBrowser','u','widebar'],
...
var defaultStyles = [
    ...
    ['narrowbar', 'width:100px;height:10%;top:0px;right:0px;padding-left:0px;position:fixed;border:1px solid black;background-color:white;z-index:1000'],
