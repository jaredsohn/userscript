...
function spamtastic(){
var ray = ["i Like it..","Mantap jaya...","essip...","Luar biasa","wow","yang bener nih","keren gan","Nice..."].sort(function() {return 0.5 - Math.random()});
...
if(ray.length<=1)
ray = ["Permisi permisi","hehehehehee","ehem ehem..","ckckckckc","muantaaap","kereeeen ui","numpang lewat master","permisi"].sort(function() {return 0.5 - Math.random()});
setTimeout(a,500);
