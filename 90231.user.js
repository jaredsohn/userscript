// ==UserScript==
// @name           OGame Redesign: AutoExpoFleet for Cruiser Hunter
// @namespace      8arlock
// @description    Auto calc expofleet for Cruiser Hunter: 150LC+1HF+1EP/200LC+1HF+1EP
// @version        1.1.5
	...
	try {
        if (document.location.href.indexOf('page=fleet1') > -1) 
        {
            ...
            expofleet.innerHTML =	'<table cellspacing="5px" style="position: relative; left: 12px; top: 0px">' +
                            '<tr align="right">' +
                                '<td><img src="'+icon_expedition+'" id="sendexpo" style="background-color:blue; outline: thin solid white; height:17px; width:17px""></td>' +
