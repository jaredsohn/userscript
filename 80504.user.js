// ==UserScript==
// @name           Premium_Bar_Untuk_Dunia_3  
// @namespace      www.perangkaum.net
// @description    Premium bar untuk dunia 3 pada perangkaum.net   
// @include        http://id3.perangkaum.*
// @include        https://id3.perangkaum.*  
// @version        1.0
// ==/UserScript==
...
function functionMain(e) {
	...
	if (b==null) {
		...
		var langArr = new Array(8);
                if (lang == "ina") {   // Indonesia
			langArr[0] = "Balai Desa";
			langArr[1] = "Rekrut";
			langArr[2] = "Istal";
			langArr[3] = "Bengkel";
			langArr[4] = "Rumah Adat";
			langArr[5] = "Pandai Besi";
			langArr[6] = "Alun-Alun";
			langArr[7] = "Pasar";
		}
		if (lang == "en") {   // English
