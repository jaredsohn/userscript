// ==UserScript==
// @name         The West - Ajudante para Mercado (WH)

// @name         Ajudante para Mercado (WH)

// @version      1.2.5

// @description  Organize suas compras e ganhe tempo nas coletas de itens, com esse maravilhoso script.
...
var dyMarketHelperCode = function (currentVersion, scriptWebsite) {
        ...
        if (location.items) {
            ...
            if (displayHeadingInfo) {
                ...
                if (playerAtLocation) {
                    ...
                    itemCollectHtml = "Para retirar todos os itens, você precisa estar na cidade " + locationName + "";
            ...
            for (itemId in locationItems) {
                ...
                if (!isNaN(itemId) && itemId > 0) {
                    ...
                    locationItemTitle = locationItemTitle + '<br/> Você pode retirar ' + locationItemCountToCollect + ', ' +

                        locationItemCountInAuction + ' que ainda está em leilão';
    ...
    function townPurchasedItemsWindow(location) {
        ...
        $tabHeader = jQuery("<h2>").attr({"class": prefix + "Message"}).html("Itens a serem adquiridos da cidade " + locationName);
    ...
    function paintTown(location) {
        ...
        $townEl = jQuery("<div>")
            ...
            .attr({"id": baseLocationId + "OnMap", "class": setClass, "style": townStyle, "title": "Centralizar mapa em: " + locationName})
        ...
        $locationTownCenter = jQuery("<div>")
            ...
            .attr({"class": prefix + "TownCenter", "title": "Centralizar mapa em: " + locationName})
        ...
        $locationCollect = jQuery("<div>")
            ...
            .attr({"class": baseId + "Collect", "title": "Clique para ver os itens que podem ser coletados da cidade " + locationName})
        ...
        if (location.itemsCount && location.itemsCount > 0) {
            ...
            $locationTown
                ...
                .attr({"title": "Abrir a cidade " + locationName})
    ...
    function populateFiltersBlock($filters) {
        ...
        purchasedItemsFinishLabel = '<label for="' + prefix + 'PurchasedItemsFilterFinish" ' +
            ...
            'title="Mostrar apenas cidades e itens que você já pode retirar do mercado">Terminados</label>';
        ...
        purchasedItemsProgressLabel = '<label for="' + prefix + 'PurchasedItemsFilterProgress" ' +
            ...
            'title="Mostrar apenas as cidades e os itens onde você deu lances e onde leilão ainda não terminou">Em Progresso</label>';
...
var dyMarketHelperCode = function (currentVersion, scriptWebsite) {
	...
	function buildWindow() {
		...
		marketHelperTab = wman.open(prefix).setMiniTitle(tabName).setSize(840, 655)
			.addTab(tabName, prefix, marketHelperTabClick)
			.addTab("Sobre", prefix + "Sobre", marketHelperTabClick);
		//console.log(marketHelperTab);
		marketHelperTabContent = jQuery(marketHelperTab.divMain).find(".tw2gui_window_content_pane");
		marketHelperTabLoader = jQuery(marketHelperTab.divMain).find(".tw2gui_window_pane  div.loader");
		marketHelperTabContent.append(html);
