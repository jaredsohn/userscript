...
//					console.log(scr);
    ...
    registerControls : function()
    {
        ...
        if (controls && !link)
        {
            ...
            link = document.buildElement('a',{href:'#',id:'GoogleMonkeyRLink','class':'ab_dropdownlnk'},'GoogleMonkeyR settings','click',UIL.UI.preferencesShow.bind(UIL.UI));
			li.appendChild(link);
