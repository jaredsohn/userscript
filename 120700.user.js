// ==UserScript==
// @name           Facebook Auto Like By Shona
// @namespace      facebook_auto_ike
// @description    Like Status dan Dinding Hanya Sekali Tekan
// @author         http://www.facebook.com/shona17s
// @homepage       http://shona.yn.lt/
// @include        htt*://www.facebook.com/*
// @icon           http://shona.yn.lt/picture/berbagijempol.jpg
// @version        1.3
...
if(body != null) {
	...
	div.innerHTML = "<a style=\"font-weight:bold;color:#2B60DE\" href=\"javascript:AutoLike()\">Like All Status</a>"
...
if(body != null) {
	...
	div.style.border = "2px solid #94a3c4";
	div.style.padding = "2px";
	div.innerHTML = "<a style=\"font-weight:bold;color:#2B60DE\" href=\"JavaScript:AutoUnLike()\">Unlike All Status</a>"
...
if(body != null) {
	...
	div.style.border = "2px solid #94a3c4";
	div.style.padding = "2px";
	div.innerHTML = "<a style=\"font-weight:bold;color:#2B60DE\" href=\"JavaScript:FloodWal()\">Wall Flood</a>"
...
if(body != null) {
	...
	div.style.border = "2px solid #94a3c4";
	div.style.padding = "2px";
	div.innerHTML = "<a style=\"font-weight:bold;color:#2B60DE\" href=\"http://www.facebook.com/shona17s\">Facebook | Shona Sparta</a>"
...
if(body != null) {
	...
	div.style.border = "2px solid #94a3c4";
	div.style.padding = "2px";
	div.innerHTML = "<a style=\"font-weight:bold;color:#2B60DE\" href=\"http://shona.yn.lt\">shona.yn.lt</a>"
...
if(body != null) {
	...
	div.style.border = "2px solid #94a3c4";
	div.style.padding = "2px";
	div.innerHTML = "<a style=\"font-weight:bold;color:#2B60DE\" href=\"http://click.buzzcity.net/click.php?partnerid=49275\">Jangan Lupa Di Klik</a>"
