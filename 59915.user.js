// ==UserScript==
// @name           United Colors of Leprosorium
// @namespace      ryotsuke
// @description    Разноцветные рамки для подсветки комментариев пользователей
...
w.allUserPosts = function(className){
	...
	var css = ""
	css += "." + className + " ." + className + " .dt {border:1px solid " + color + "; border-width:1px 1px 0 1px; padding:5px 5px 0.5em 5px;} ";
	css += "." + className + " ." + className + " .dd .p {border:1px solid " + color + "; border-width:0 1px 1px 1px; padding:0 5px 5px 5px;} ";
