// ==UserScript==
// @name			eRepublik Newspaper Ignore for Opera
...
function GM_setValue(cookieName,cookieValue) {
	document.cookie = escape( cookieName ) + "=" + escape( cookieValue ) +
		";expires=Thu, 2 Jan 2020 00:00:00 UTC;path=/";
}
...
if(GM_getValue("newspapers")==null) {
	GM_setValue("newspapers",0);
}

if(GM_getValue("comments")==null) {
...
if(document.body.id=="media") {
	...
	res0.setAttribute("style","position: absolute; min-width: 150px; padding: 10px; color: white; opacity: 0.8; background-color: black; left: 93px; border-radius: 10px; display: none;");
	res.appendChild(res0);
	if(window.location.toString().search("/bg/")!=-1)
		msg="&#1063;&#1077;&#1088;&#1077;&#1085; &#1089;&#1087;&#1080;&#1089;&#1098;&#1082;";
	else
