...
// @include        http://th*.tribalwars.asia/*
...
languages = { // Language tags
	    "th" : {
          ...
          "player"   : "ผู้เล่น",
          "tribe"    : "เผ่า",
          "i_player" : "แสดงข้อมูลผู้เล่น",
          "i_tribe"  : "แสดงข้อมูลเผ่า",
          "loading"  : "โหลด...",
          "c_close"  : "คลิกเพื่อปิด",
          "track"    : "ติดตามหมู่บ้าน",
          "tracked"  : "หมู่บ้านติดตาม",
          "untrked"  : "หมู่บ้านไม่ติดตาม",
          "untrack"  : "ไม่ติดตามหมู่บ้าน",
          "cltrack"  : "ทำให้สะอาดทั้งหมด",
          "notrack"  : "ไม่มีหมู่บ้านติดตาม",
          "oktrack"  : "ติดตามหมู่บ้าน",
          "at_none"  : "โจมตีอีกครั้ง",
          "at_same"  : "โจมตีอีกครั้งกับทหารชุดเดิม",
          "at_all"   : "โจมตีอีกครั้งกับทหารทั้งหมด",
          "mapsize"  : "ขนาดแผนที่",
          "pop_close": "ปิด",
          "pop_auto" : "แสดงโดยอัตโนมัติ:",
          "group_toggle" : "แสดง/ซ่อน การตั้งค่ากลุ่ม",
          "group_edit" : "บันทึกการเปลี่ยนแปลง",
          "group_moveup" : "ย้ายกลุ่มนี้ขึ้น",
          "group_remove" : "ลบ",
          "group_add" : "เพิ่ม",
          "group_village" : "หมู่บ้าน",
          "group_nogroup" : "ไม่มีกลุ่ม",
          "group_action" : "ทำงาน",
          "group_store" : "อัพเดทกลุ่ม",
          "group_storeDone" : "อัพเดทกลุ่ม! โหลดหน้าภาพรวม..",
          "group_name" : "ชื่อกลุ่ม",
          "group_ingroup" : "กลุ่มปัจจุบัน",
          "overview_nogroup" : "หมู่บ้าน ไม่มีกลุ่ม",
          "overview_village" : "หมู่บ้าน",
          "overview_points" : "คะแนน",
          "overview_resources" : "ทรัพยากร",
          "overview_warehouse" : "โกดัง",
          "overview_farm" : "ฟาร์ม",
          "main_setaliasheader" : "เปลี่ยนชื่อหมู่บ้าน:",
          "main_setalias" : "บันทึกชื่อหมู่บ้าน",
          "main_setaliasdone" : "บันทึกเสร็จแล้ว!",
          "setting_show" : "TW Enhancer",
          "setting_name" : "ชื่อปลั๊กอิน",
          "setting_toggle" : "ทำงาน/ไม่ทำงาน",
          "setting_label_desc" : "คำอธิบาย",
          "setting_label_version" : "รุ่น",
          "setting_label_dev" : "ผู้พัฒนา",
          "setting_label_exec" : "สำหรับ",
          "tw_scan" : "TribalWars พยายามตรวจสอบสคริปต์ที่คุณใช้!"
       },
