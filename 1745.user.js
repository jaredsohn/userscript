...
var antal_idoler = 2; // eller 2, eller 3, eller 4, ...
var idoler = new Array(antal_idoler);
idoler[0] = "maxim";
idoler[1] = "Cassius Clay";

// den f?rg du vill ge dina idoler
var idolcolor ="#99CC99";
// ----------------------------------------------------------------------------------------------------
...
// ==UserScript==
// @name	dscPlus
// @description	Ny layout till dagensskiva.com diskussioner. Tema Orange. Blockerar idioter & highlightar dina idoler.
