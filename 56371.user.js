// ==UserScript==
// @name           Quiz-be-gone! v1.1.1
// @namespace      http://userscripts.org/scripts/show/56371
// @description    Removes quizzes from the facebook news feed and lists the number removed under the filter list, with support for YU quizzes.
// @include        http://*.facebook.com*home.php*
// ==/UserScript==

// based on https://userscripts.org/scripts/show/45892
...
function enumerateFacebookQuizzes(){
	...
	for(i = 0; i < storydivs.length; i++){
		div = storydivs[i];
		if(div.innerHTML.match(/.+ (took|completed|rije.ili|re.ili|решили|ријешили).+(the.+quiz|квиз|kviz).+/) != null){
			quizzes.push(div);
		}
	}
