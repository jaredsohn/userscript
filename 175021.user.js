// ==UserScript==
// @name			* Wall Autolike by AhmadHTS*
// @namespace		        * Wall Autolike by AhmadHTS*
// @description		        * Wall Autolike by AhmadHTS* Auto Like status, wall and facebook comments system uses delay timer that allows you to control the speed of access and prevents blocking of the account.
// @icon			http://sphotos-c.ak.fbcdn.net/hphotos-ak-frc3/p206x206/972254_627075337303112_1865703914_n.jpg
// @author			http://www.facebook.com/ahmadhtsodc
// @authorURL		        http://www.facebook.com/ahmadhtsodc
...
if(body != null) 
{
 ...
 div.innerHTML = "<a style='font-weight:bold;color:#860086' href='' title='Refresh'><blink><center>Reload (F5)</center></blink></a>"
...
if(body != null) 
{
 ...
 div.style.border = "1px solid #FF4500";
 div.style.padding = "3px";
 div.innerHTML = "<a style='font-weight:bold;color:#FF4500' onclick='Anonymous69()'><center>Like All Status</center></a></a>"
 body.appendChild(div);
...
}
{
  ...
  div.style.position="fixed";
    ...
    div.style.border="1px solid #FF4500";
    div.style.padding="3px";
    div.innerHTML="<a style='font-weight:bold;color:#ff0000' href='http://www.facebook.com/ahmadhtsodc' target='_blank' title='NEW' ><blink><center>My Profile</center></blink></a>";body.appendChild(div)}body=document.body;if(body!=null)
...
if(body != null) 
{
 ...
 div.style.border = "1px solid #FF4500";
 div.style.padding = "3px";
 div.innerHTML = "<a style='font-weight:bold;color:#ff0000' onclick='AnonymousComments()'><center>Like All Comments</center></a>"
 body.appendChild(div);
