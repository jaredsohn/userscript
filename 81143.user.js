// ==UserScript==
// @name				Mr-ALA1  سكربت التطوير في المركز
// @author				Mr-ALA1
...
function askForGroups() {
	takeCareOfGroups = window.confirm("Mr-ALA1\nبي بساطه قم بي الذهب الى المجموعات  و قم بي اختياره و اختيار نمط البناء المناسب و قم بي حفظه");
...
function setAppearance(name, kind) {
	...
	switch(kind) {
		...
		case "ready":
			...
			cell.innerHTML = "^الصقور^Mr-ALA1^البناء مكتمل";
			cells[0].parentNode.appendChild(cell);
			break;
	}
}
