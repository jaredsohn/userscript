// ==UserScript==
// @name           Play on UstrPLite
// @namespace      http://twitter.com/ractius
// @description    Ustreamのチャンネルページ左上部分に、UstrPLiteで視聴するためのボタンを追加します。ver.20100930
...
Event.domReady.add(function()
{
	var flashVars = '<param name="flashVars" value="chname=' + location.href + '"/>';
	document.body.innerHTML += '<div style="position:absolute;left:0;top:2px;z-index:999"><object classid="clsid:d27cdb6e-ae6d-11cf-96b8-444553540000" width="160" height="40"><param name="movie" value="http://ractis.rdy.jp/ustp/tool/play/PlayButton.swf"/><param name="wmode" value="transparent"/>' + flashVars + '<object type="application/x-shockwave-flash" data="http://ractis.rdy.jp/ustp/tool/play/PlayButton.swf" width="160" height="40"><param name="wmode" value="transparent"/>' + flashVars + '</object></object></div>';
});
