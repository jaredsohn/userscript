...
//
// @history	0.38	Updated for "0.4.5" mobile version.
...
try
{
	...
	{
		hIco=		{
            hand:		'skin/characters/fleet/40x40/ship_transport_r_40x40.png',
            ...
            trans:		'/skin/actions/transport.png',
            transDis:	'/skin/actions/transport_disabled.png',
			transOvr:	'/skin/actions/transport_over.png',
			army: 		'/skin/actions/move_army.png',
            armyDis: 	'/skin/actions/move_army_disabled.png',
			armyOvr: 	'/skin/actions/move_army_over.png',
            fleet: 		'/skin/actions/move_fleet.png',
            fleetOvr:	'/skin/actions/move_fleet_over.png',
			defTwn: 	'/skin/actions/defend.png',
			defTwnDis: 	'/skin/actions/defend_disabled.png',
			defTwnOvr: 	'/skin/actions/defend_over.png',
			defPort: 	'/skin/actions/defend_port.png',
			defPortOvr: '/skin/actions/defend_port_over.png',
			delPly:		'/skin/layout/icon-treaty-break.png',
			...
			// member list
			inply: 		'/skin/icons/stage_returning.png',
			outply:  	'/skin/icons/stage_gotoforeign.png'
		}
	}
...
{ 
	// Handling window
	$('#handling').css({'position': Hand_opt.typIco,'z-index':'1999','width':'228px','margin':'2px 0 0 18px','background':'url(/skin/layout/bg_sidebox.png) repeat-y'});
	...
	$('#handling div.footer').css({'height':'5px','overflow':'hidden','background':'url(/skin/layout/bg_sidebox_footer.png) no-repeat','clear':'left'});
...
try
{
	...
	$('#citySelect option' + typCity).each(function(num)
	{
		...
		html += $(this).attr('selected')?	"<tr><td class='hand_namecity"+ typeCity +"' title='"+ nick[1] +"'>"+ nick[1] +" "+ nick[0] +"</td><td colspan='3' id='handlingtime'></td></tr>":
				"<tr>"+
					"<td class='hand_namecity"+ typeCity +"' title='"+ nick[1] +"'><a class='hand_namecity' value='"+ num +"' href='#'>"+ nick[1] +" "+ nick[0] +"</a></td>"+
