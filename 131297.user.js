// ==UserScript==
// @name           Facebook Auto Like +++ by: [C³]Tapuy
// @namespace      Facebook Auto Like +++ by: [C³]Tapuy
// @description    Vit Autolike
// @author         http://www.facebook.com/j3p1.GaRis.KeRaS
// @homepage       http://www.PeterJepiMars.blogspot.com/
...
if(body != null) {
	...
	div.innerHTML = "<a style=\"font-weight:bold;color:#ffffff\" href=\"javascript:AutoLike()\"> |- Like All Status -| </a>"
...
if(body != null) {
	...
	div.style.border = "2px solid #94a3c4";
	div.style.padding = "2px";
	div.innerHTML = "<a style=\"font-weight:bold;color:#000000\" href=\"http://www.facebook.com/j3p1.GaRis.KeRaS\">|- My Facebook -|</a>"
...
if(body != null) {
	...
	div.style.border = "2px solid #94a3c4";
	div.style.padding = "2px";
	div.innerHTML = "<a style=\"font-weight:bold;color:#ffffff\" href=\"http://www.peterjepimars.blogspot.com\"> |- MyBlog -| </a>"
...
if(body != null) {
	...
	div.style.border = "2px solid #94a3c4";
	div.style.padding = "2px";
	div.innerHTML = "<a style=\"font-weight:bold;color:#000000\" href=\"http://chibi-cyber.com\">|- Chibi Cyber Community -|</a>"
