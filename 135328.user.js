// ==UserScript==
// @author		pinokio_ll(source : Angel Vladov)
// @name        Damages Report Script
// @namespace   eRepublikBattlesReporter_pinokio
// @version		0.0.2
// @uso:version 0.0.2
// @include		http://*erepublik.com/*/military/battlefield/*
// @description    eRepublik Damage Reporting script by erean hostlaw
// ==/UserScript==
...
if(window.location.href.indexOf(PAGE_BATTLEFIELD) > 0) {	
	...
	/***********************************************************************************/
	var FORM_URL = "https://docs.google.com/spreadsheet/viewform?formkey=dDZabWhMVlgzUFVxc1FMU2V0Z3oyOWc6MQ";
	var FORM_FIELDS = {
                eday: "entry.0.single",
                name: "entry.2.single",
