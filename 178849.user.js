// ==UserScript==
// @name       Greed Userscript
// @namespace  Greed Userscript
// @version    1.0
// @description  Checks the greed subforums to check for new posts and alerts the user if there are; Credits to Oscar/osc-rwar/HypnoToad/Gnome
// @include      http://leakforums.org*
// @include      http://*.leakforums.org*
// @updateURL https://userscripts.org/scripts/source/178849.meta.js
// @downloadURL https://userscripts.org/scripts/source/178849.user.js
// @copyright  2013+, Oscar Sanchez
// @icon	http://x.leakforums.org/uploads/ficons/ficongreed.png
