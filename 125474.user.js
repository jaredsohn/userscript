// ==UserScript==
// @name           איקרים סופר מרקט (דוקטור צחוק)
...
// @include        http://s*.il.ikariam.*/index.php?*view=branchOffice*
...
IkariamSuperMarket.prototype.prepareScreen = function() {
  ...
  selectorList.append(woodSelector);
  selectorList.append(marbleSelector);
  selectorList2.append(crystalSelector);
