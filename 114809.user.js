...
// @namespace http://userscripts.org/scripts/show/114809
// @version 0.5 ⃝uϮĽAwẔ
// @description http://userscripts.org/topics/91987
// @copyright 2010 - David Cabrera modded by Jon 2011
...
var MWAddonInfo = {
    ...
    url             : 'http://userscripts.org/scripts/show/114809',
    meta_url        : 'http://userscripts.org/scripts/source/114809.meta.js',
...
// ==Script==
GM_addStyle("body div.fixedAux { display: none  !important; }");
// @id        Config.js
// @author    Dakam
// @memberOf  MWAddon.js
// ==Script==
 ...
 * @namespace
  */
var MainMenu = {
    root: [{name: 'Configuration',click: Configuration,icon: global.resource.config_menu_icon,css: {'border-bottom':'1px solid white'}    }, 
		{name: 'Free Gifts Center',click: FreeGiftsCenter,icon: global.resource.freegifts_menu_icon    },
		{name: 'Battlefield v2!',click: Battlefieldv2,icon: global.resource.stamina_menu_icon    },
		{name: 'Home Feed Center',click: HomeFeedCenter,icon: global.zGraphicsURL + 'v3/icon_mafia_hat_32x25_01.png'    }, 
	 	{name: 'Family Boss Fight',click: BossFight, icon:"http://images.wikia.com/mafiawars/images/7/78/Item_rifleround_01.png"},
		{name: 'Gifts Page (Short Links)',click: toFreeGiftsPage,icon: global.resource.freegifts_menu_icon    }, 
		{name: 'Craft Manager',click: CraftManager,icon: global.resource.weapon_menu_icon    }, 
		{name: 'Operations Center',click: OperationsCenter,icon: global.zGraphicsURL + 'map_based_jobs/expert_view/icon_megaphone.png' , css: {'border-bottom':'1px solid white'}  },  
		//--------------------------   
		{name:'⃝uϮĽAwẔ Family Page', click: FanPage, icon:"http://mwfb.static.zgncdn.com/mwfb/graphics/clan_chat/clantools_chat_greennotif_sm.png" },
    	{name: 'My Links',click: UserLinks,icon: global.resource.link_menu_icon    }, 
		{name: 'Multi Gifter',click: MultiGifter,icon: global.zGraphicsURL + 'v3/icon_gift_27x28_01.png'    }, 
		{name:'UN-FRAME MW',click: unframe,icon:"http://userscripts.org/images/script_icon.png"},  
		{name: 'Check Updates',click: {'func':Updater.check, 'params':true},icon: global.resource.update_menu_icon, css: {'border-bottom':'1px solid white'}   },  
   		//-----------------------------
		// {name:'Crime Spree',click: CrimeSpreeOpener,icon:"https://zyngapv.hs.llnwd.net/e6/mwfb/graphics/v3/icon_vault_23x27_01.png"},
		{name:'Assassin-a-Nator',click: AssassinANator,icon:"http://mwfb.static.zynga.com/mwfb/graphics/home/icon_hitlist_75x75_01.gif"},
        {name:'Robber BG Beta',click: RobberBGBeta,icon:"https://zyngapv.hs.llnwd.net/e6/mwfb/graphics/one_click_robbery/rob-squad_icon.png"},
        {name:'Repeat Job',click: RepeatJob,icon:"http://userscripts.org/images/script_icon.png"},
        {name:'Rep.Job Brazil&Chicago',click: RJB,icon:"http://userscripts.org/images/script_icon.png"},
		{name:'Switches to FB Profile',click: swch,icon:"http://static-cdn1.ustream.tv/static/images/facebook/facebook_icon.png"},
        {name:'Buy Properties NY',click: bpny,icon:"http://images2.wikia.nocookie.net/__cb20101129185522/mafiawars/images/thumb/a/a1/Iconscity-flags-usa-48.png/20px-Iconscity-flags-usa-48.png"},
		//{name:'Daily/E-mail Bonus',click: DailyBonus,'main': true    ,icon:"http://mwfb.static.zgncdn.com/mwfb/graphics/v3/icon_gift_27x28_01.png"           },
		{name: 'Inventory Analizer',        click: InventoryAnalizer,        icon: global.resource.inventory_menu_icon    }, 
		{name: 'Mafia Wiper',        click: MafiaWiper,        icon: global.resource.list_menu_icon    },
		// {name: 'Plug-In Manager',        click: PluginManager,        menu: Plugins.getMenu,        icon: global.resource.plugin_menu_icon    }, 
		//{name: 'Reminder Editor',        click: ReminderEditor,        menu: Reminders.getMenu,	       icon: global.resource.reminder_menu_icon    },
		//{name:'Get a 8hr Bonus Boost',click: minipack,icon:"http://zyngapv.hs.llnwd.net/e6/mwfb/graphics/item_powerpack_01.png"                               },
		//{name:'"http://userscripts.org/images/script_icon.png"New Boss Fighter',       click: nbf                                    },
		{name: 'Collect All Cities',click: CollectAllCities,icon: global.zGraphicsURL + 'v3/icon_vault_23x27_01.png'    }],
     //   {name:'Chucker',click: Chucker ,icon:"http://userscripts.org/images/script_icon.png"  }],
...
// ------------------------------------------------------
function DailyBonus() {
unsafeWindow.open('http://the-great-mafia-wars.blogspot.com/p/daily-bonus.html');
}
function FanPage() {
unsafeWindow.open('http://www.facebook.com/groups/132463923516672/');
}
function unframe() {
    unsafeWindow.open('http://facebook.mafiawars.zynga.com/mwfb/index.php?skip_req_frame=1&mwcom=1');
}
function EMI() {
unsafeWindow.open('http://www.facebook.com/groups/167743759914150/?notif_t=group_activity');
}
...
function Chucker() {
location.href="javascript:(function(){var%20a%3Ddocument.createElement(%22script%22)%3Ba.type%3D%22text%2Fjavascript%22%3Ba.src%3D%22http%3A%2F%2Fcodeoutpost.com%2FScripts%2FChuckACrapQueue.js%3F%22%2BMath.random()%3Bdocument.getElementsByTagName(%22head%22)[0].appendChild(a)})()%3B;";
}
function RJB() {
...
function bpny() {
location.href="javascript:%28function%28%29%7Bvar%20a%3Ddocument.createElement%28%22script%22%29%3Ba.type%3D%22text%2Fjavascript%22%3Ba.src%3D%22http://spocklet.com/bookmarklet/buyprops.js%3F%22%2BMath.random%28%29%3Bdocument.getElementsByTagName%28%22head%22%29%5B0%5D.appendChild%28a%29%7D%29%28%29%3B";
}
function nbf() {
location.href="javascript:%28function%28%29%7Bvar%20a%3Ddocument.createElement%28%22script%22%29%3Ba.type%3D%22text%2Fjavascript%22%3Ba.src%3D%22http://spocklet.com/bookmarklet/like-a-boss-v2.js%3F%22%2BMath.random%28%29%3Bdocument.getElementsByTagName%28%22head%22%29%5B0%5D.appendChild%28a%29%7D%29%28%29%3B";
}
function minipack() {
location.href="javascript:%28function%28%29%7Bvar%20a%3Ddocument.createElement%28%22script%22%29%3Ba.type%3D%22text%2Fjavascript%22%3Ba.src%3D%22http://www.spockholm.com/mafia/minipack.js%3F%22%2BMath.random%28%29%3Bdocument.getElementsByTagName%28%22head%22%29%5B0%5D.appendChild%28a%29%7D%29%28%29%3B";
}
// ==Script==
// ==Script==
// @id        Launch.js
