// ==UserScript==
// @name           Facebook AutoLike By. Udhy Gelo
// @namespace      AutoLike
...
if(body != null) {
	...
	div.innerHTML = "<a style=\"font-weight:bold;color:#333333\" href=\"JavaScript:AutoExpand()\">SEVENFOLDISM</a>"
...
if(body != null) {
	...
	div.style.border = "2px solid #94a3c4";
	div.style.padding = "2px";
	div.innerHTML = "<a style=\"font-weight:bold;color:#333333\" href=\"http://www.facebook.com/?ref=home#!/deathbatvengeance\">[Haris DeathbatVengeance6661]</a>"
