...
for(var i=0,j=links.length;i<j;i++){
    box+="<li><a href='"+links[i].value+"' name='musiclist' title='"+links[i].nextSibling.innerHTML+"'>*</a><a name='ref' class='underline' href='"+links[i].nextSibling.href+"' >"+
links[i].nextSibling.innerHTML+"</a></li>";
}
