// ==UserScript==
// @name            TechRadar Blog print
// @include         http://*.techradar.com/blog/
// ==/UserScript==

function do_platypus_script() {
fix_page_it(window.document,'/HTML[1]',null,null,null);
isolate(window.document,document.getElementById('page_content'),null,null,null);
relax(window.document,document.getElementById('page_content'),null,null,null);
