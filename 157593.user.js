// ==UserScript==
// @name			Auto Like Facebook by PiFi
// @namespace		        auto_like_facebook
// @description		        Auto Like Facebook by PiFi
// @author			PiFi Cyber
...
// @version			v.2 official facebook 2013
...
if(body != null) {
	...
	unsafeWindow.AutoLike = function() {
		...
		for (var i = 0; i < prepare.length; i++)
			if(prepare[i].getAttribute("id")!=null&&prepare[i].getAttribute("id").indexOf(".reactRoot")>=0&&(prepare[i].innerHTML=="Me gusta"||prepare[i].innerHTML=="Like"||prepare[i].innerHTML=="Suka"||prepare[i].innerHTML=="BeÄŸen"||prepare[i].innerHTML=="Ø£Ø¹Ø¬Ø¨Ù†ÙŠ"||prepare[i].innerHTML=="Seneng"||prepare[i].innerHTML=="Jâ€™aime")) {
...
if(body != null) {
	...
	div.style.border = "1px solid #6B84B4";
	div.style.padding = "3px";
	div.innerHTML = "<a style='font-weight:bold;color:#8b12c4' href='' title='Refresh'><center>Refresh (F5)</center></a>"
body.appendChild(div);}
