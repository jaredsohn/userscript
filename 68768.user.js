...
if(location.href.match(/action=view/)) { 
  ...
  var BerichtTitel = "[b]Stadt [town]"+townName[0]+"[/town] greift [town]"+townName[1]+"[/town] an[/b]";
  for(var c = 0; c < document.getElementsByTagName('div').length; c++) {
  ...
  if (document.getElementById('ReportTextArea')) {
    ...
    BerichtMenue.innerHTML='<a onclick="document.getElementById(\'ReportTextArea\').style.display=\'block\'" href="#" class="submenu_link"><span class="left">&nbsp;</span><span class="middle">Bericht formatieren</span><span class="right">&nbsp;</span>&nbsp;</a>';
  ...
  if (document.getElementById('resources')) {
    ...
    if (wood) resourcesOutput+="[b]Holz:[/b] "+wood+" ";
    if (stone) resourcesOutput+="[b]Stein:[/b] "+stone+" ";
    if (iron) resourcesOutput+="[b]Eisen:[/b] "+iron+" ";
  }
