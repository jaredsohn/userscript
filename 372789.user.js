// ==UserScript==
// @name        projetAPENK
// @namespace   projetAPENK
// @description projetAPENK
...
// ==/UserScript==   
	...
	function main() {
		   var ongletAPE = '<div style="width: 50px; height: 33px; float: left; background: none repeat scroll 0% 0% transparent;" onmouseout="$(this).css(\"background\", \"transparent\");" onmouseover="$(this).css(\"background\", \"url(http://static.worldofstargate.fr/wosv2/button_hover.png) no-repeat\");>';
			ongletAPE +='<a href="http://www.worldofstargate.fr/index.php?page=action&type=explore&utype=0&id=4507"><img style="margin-top:13px" src="http://imageshack.com/a/img35/747/qytv.png"></img></a>';  
			ongletAPE += '</div>';
