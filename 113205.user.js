// ==UserScript==
// @name                    DOA Viejoku 1.1
// @namespace      Libre de humo, Rev. Version Publica..c.0
...
// @description    " Libertad, Sin Botas "
// @version        1.1 alpha 
// ==/UserScript==
(function() {

var Version = 'Viejoku';
var Title = 'Drafons of Atlantis Español 1.1';
var WebSite = 'The kame ';
var Publi = '#DoAPower';
...
var gWaterDragon = 'Dragon Agua';	
var gStoneDragon = 'Dragon Piedra';
var gFireDragon = 'Dragon Fuego';
var gWindDragon = 'Draon Cefiro';
...
var gPyro = 'Magma';
var gWind= 'Banshee';
var gGrtDrg = 'Gran Dragon';			
var gWatDrg = 'Dragon Agua';				
var gStnDrg = 'Dragon Piedra';
var gFirDrg = 'Dragon Fuego';
var gWinDrg = 'Dragon Cefiro';
...
var kTooManyResearchErrs = 'Demasiados errores, Desabilitando auto-investigar';
...
var translateSPArray = {
    ...
    'RenameProclamation':'Proclama de toponimo',
    'CeaseFireTreaty':'Tratado de tregua',
    'CompletionGrant':' Acta de finalizaciÃ³n',
    'CrimsonBull':'Toro carmesÃ­',
    'PurpleBones':'Hueso purpura',
    'TranceMarchDrops':'Elixir de trance 50%',
    'ForcedMarchDrops':'Elixir de marcha 25%',
    'DarkWarpDevice':'Teletransporte oscuro',
    'OutpostWarp':'Vortice de puesto avanzado',
    'DragonHearts':'Corazon de dragon',
    'Actualizar DoA':'Actualizar Juego',
    'Auto Upgrade Buildings': 'Auto-Construccion',
    ...
    'Woodcraft':'Carpinteriaa',
    'Masonery':'Mamposteriaa',
    'Mining':'Aleaciones',
    ...
    'Targets':'Objetivos',
    'Stats':'Estadisticas',
    'Anthropus Camp Auto-Attacks':'Ataque automatico Antropus',
    'Auto-attack Camp Levels':'AutoAtaque a Campamentos por Nivel',
    'Auto-attack Configuration':'Configuracionn AutoAtaque',
    'Enable':'Activar',
    ...
    'Maximum simultaneous marches':'Maximo de marchas simultneas',
    ...
    'Auto-collect resources at outpost every 8 hours':'Autorecoleccion de recursos Avanzadas',
    'Attack':'Atacar',
    'Config':'Configuracion',
    ...
    'Auto-attack Stats':'Estadisticas de Autoataque',
    ...
    'Bounce':'SaltoT8h',
    'Leap':'Pirueta',
    'WaterDragonEgg':'Huevo Agua',
    'StoneDragonEgg':'Huevo Piedra',
    'FireDragonEgg':'Huevo Fuego',
    'WindDragonEgg':'Huevo Cefiro',
    'GD Armor-1':'Armadura Gran Dragon',
    'GD Armor-2':'Casco Gran Dragon',
    'GD Armor-3':'Cola Gran Dragon',
    'GD Armor-4':'Garras Gran Dragon',
    'WD Armor-1':'Armadura Dragon de Agua',
    'WD Armor-2':'Casco Dragon de Agua',
    'WD Armor-3':'Cola Dragon de Agua',
    'WD Armor-4':'Garras Dragon de Agua',
    'SD Armor-1':'Armadura Dragon de Piedra',
    'SD Armor-2':'Casco Dragon de Piedra',
    'SD Armor-3':'Cola Dragon de Piedra',
    'SD Armor-4':'Garras Dragon de Piedra',
    ...
    'Mandrake-100':'100 MandrÃ¡goras',
    'Mandrake-500':'500 MandrÃ¡goras',
    'Mandrake-1000':'1000 MandrÃ¡goras',
    ...
    'Building level':'Construccion nivel',
    'of':'de',
    'at':'en',
...
var OptionsDefaults = {
  ...
  centinela    : false,
  ptWinPos     : {x: 760, y: 93 },
  campAttack   : {enabled:false, repeatTime:60, delayMin:5, delayMax:60, levelEnable:[], levelDist:[null,10,10,10,10,10,10,10,10,10,10], deleteCampAttacks:false, stopAttackOnLoss:false, logAttacks:true, maxMarches:10},
  currentTab   : false,
...
function dtStartup (){
  ...
  if (++startupCount > 10){
    dialogFatal ('<B>Error Al inicia Viejoku:</b><BR><BR>Unable to find SWF element');
    return;
  }
  try {  
    var swf = null;
  ...
  try {
    ...
    dialogFatal ('<B>Error al Iniciar Viejoku:</b><BR><BR>'+  e);
    logit (inspect (e, 8, 1));
  }  
}
...
function initSeed () {
    ...
    Seed.init(function(rslt){
      if (rslt.ok){
        ...
        dialogFatal ('Error al iniciar Viejoku:<BR>'+ rslt.errmsg);
        return;
      }
    });
    
    logit ("* DOA Viejoku v"+ Version +" "+translate( 'Loaded' ) );
...
Tabs.Waves = {
  ...
  waveAttackTick : function (){
    ...
    if (marchCount >= Data.options.waves.maxMarches){
      t.dispFeedback ('MÃ¡ximo de Marchas simultÃ¡neas alcanzado');
      t.attackTimer = setTimeout (t.waveAttackTick, 5000);
      return;
    }
...
Tabs.Info = {
  ...
  init : function (div){
    ...
    t.cont.innerHTML = '<DIV class=pbTitle>DOA EspaÃ±ol - version:  '+ Version + '</div>\
  ...
  tabJobOpc : function () {
    ...
    try {      
      m = '<DIV class=pbTitle style="margin-bottom:10px">Configuraciones Varias</div><TABLE class=pbTab>\
        ...
        <TABLE class=pbTab>\
          <TR valign=center><TD><INPUT id=pboptACol type=checkbox> AutorecolecciÃ³n de recursos cada \
...
//            logit( wordToTranslate+' traduccido by Fnk' )
        }
    }
    return returnWord;
}
