// ==UserScript==
// @author		LongerWarrior (source : Angel Vladov modifikacija Robin)
// @name        Damages Report Script for SVS
// @namespace   eRepublikBattlesReporter_FAS
// @version		0.0.1
// @uso:version 0.0.1
// @include		http://*erepublik.com/*/military/battlefield/*
// @description    eRepublik Damage Reporting script for SVS
// ==/UserScript==
...
if(window.location.href.indexOf(PAGE_BATTLEFIELD) > 0) {	
	...
	/***********************************************************************************/
	var FORM_URL = "https://docs.google.com/spreadsheet/viewform?formkey=dG5WYi1nZXVGQ2tFakxMdXl0R19SSnc6MQ";
	var FORM_FIELDS = {
                E-dan: "entry.0.single",
                Nik u e-republik: "entry.2.single",
                Runda: "entry.4.single",
                Steta: "entry.6.single",
                Oruzje: "entry.14.single",
                Bitka: "entry.8.single",
                Zid: "entry.10.single",
                Link dinacija: "entry.12.single"
