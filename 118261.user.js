// ==UserScript==
// @name	Google Plus Search Assist Tabber
// @version	1.04
// @namespace	Google Plus Search Assist Tabber
// @description	Reclaim the + away from Google+ back to search, select a word or phrase and you will be presented with options to add or remove the words from the search.
...
var searchAssist = {
	...
	init: function () {
		...
		document.body.addEventListener('onmouseover', function () {
		...
		document.body.addEventListener('click', function (e) {
			e.stopPropagation();
			var strSearch = document.getElementById("lst-ib").value;
