// ==UserScript==
// @name           Koc 7Help
// @namespace      AlgesevenVEVO
// @description    Nouveau Script
...
// @icon           http://img339.imageshack.us/img339/3563/kingdomsofcamelot.jpg
// @require			http://koc.god-like.info/update/auto-updater.php?id=102158

// ==/UserScript==


var Version = '0.1';
var Versiondate = '02.06.2011'; 
var Scriptname = 'Koc 7Help';
var ScriptTabName = "'+ getMyAlliance()[1] +'";
var AllianzName = 'Kingdom of Camelot';
var ScriptLink = 'http://userscripts.org/scripts/show/102158';
...
// TODO: Make sure WinPos is visible on-screen ?
  ...
  actionLog (""+Scriptname +" v"+ Version +" by PDX! loaded!");
...
Tabs.Test = {
  ...
  init : function (div){
    ...
    var m = '<TABLE><TR><TD align=right>Scout: </td><TD><INPUT type=checkbox id=pcfakeIsScout></td></tr>\
       ...
       <BR><DIV id=pctestDiv style="background-color:#ffffff; maxwidth:675; height:100%; max-height:100% overflow-y:auto;"></div>';
    div.innerHTML = m;
...
Tabs.Options = {
  ...
  citySelect += '</select>';
     ...
     m = '<DIV style="height:100%;  overflow-y:auto"><TABLE width=100% class=pdxTabLined cellspacing=0 cellpadding=0>\
        <TR><TD colspan=2><B><u>Koc 7Help - Réglages</u></b></td></tr><TR>\
          <TD><INPUT id=pdxwidescreenEnable type=checkbox '+ (Options.widescreen?'CHECKED ':'') +'/></td>\
          <TD>Fixer la taille de Koc 7Help <font color=#FF0000>(Requiert l'option "WeedScreen)</font></td></tr>\
		  <TD><INPUT id=pdxHideOnGoto type=checkbox /></td><TD>Fermer KoC 7Help Après avoir cliquer sur des coordonées</td></tr>\
        <TR><TD colspan=2><B><u>"Tour De Controle" - Réglages</u></b></td></tr>\
        <TR><TD width="6%"><INPUT id=pdxalertEnable type=checkbox '+ (Options.alertConfigPDX.aChat?'CHECKED ':'') +'/></td><TD width="94%">Poster les Attaques sur le chat de l'alliance</td></tr>\
        <TR><TD><span style=\"font-size:10px; color:#600000; line-height:18px; \"><b>Important</b></span></b>:</td>\
        <TD><span style=\"font-size:10px; color:#555; line-height:18px; \">Configurez Bien le Script!!</span></td></tr>\
    <TR><TD></td><TD><TABLE cellpadding=0 cellspacing=0><TR>\
      <TR><TD align=right>Message: &nbsp; </td><TD><INPUT id=pdxTowermsg type=text size=50 value="'+ Options.alertConfigPDX.towermsg +'" \> &nbsp; &nbsp;</td></tr>\
      <TD align=right>on scouting: &nbsp; </td><TD><INPUT id=pdxalertScout type=checkbox '+ (Options.alertConfigPDX.scouting?'CHECKED ':'') +'/></td></tr>\
      <TR><TD align=right>on wild attack: &nbsp; </td><TD><INPUT id=pdxalertWild type=checkbox '+ (Options.alertConfigPDX.wilds?'CHECKED ':'') +'/></td></tr>\
      <TR><TD align=right>Minimum # of troops: &nbsp; </td><TD><INPUT id=pdxalertTroops type=text size=7 value="'+ Options.alertConfigPDX.minTroops +'" \> &nbsp; &nbsp; <span id=pdxalerterr></span></td></tr>\
      <TR><TD align=right>Show troops in embassy: &nbsp; </td><TD><INPUT id=pdxalertEmbassy type=checkbox '+ (Options.alertConfigPDX.embassy?'CHECKED ':'') +'/></td></tr>\
      <TR><TD align=right>Show own troops: &nbsp; </td><TD><INPUT id=pdxalertMytroops type=checkbox '+ (Options.alertConfigPDX.mytroops?'CHECKED ':'') +'/></td></tr>\
      <TR><TD align=right>Show food useage: &nbsp; </td><TD><INPUT id=pdxalertFood type=checkbox '+ (Options.alertConfigPDX.food?'CHECKED ':'') +' /></td></tr>\
      <TR><TD align=right>Show Def: &nbsp; </td><TD><INPUT id=pdxalertDefense type=checkbox '+ (Options.alertConfigPDX.defense?'CHECKED ':'') +' /></td></tr>\
      <TR><TD align=right>Your HQ: &nbsp; </td><TD>'+ citySelect +'&nbsp; &nbsp;</td></tr>\
	  <TR><TD align=right>Show def status: &nbsp; </td><TD><INPUT id=pdxalertDefend type=checkbox '+ (Options.alertConfigPDX.defend?'CHECKED ':'') +' /></td></tr>\
      <TR><TD align=right>Post to Alliance Chat: &nbsp; </td><TD><INPUT id=pdxalertSendToAlly type=checkbox '+ (Options.alertConfigPDX.sendtoAlly?'CHECKED ':'') +' /></td></tr>\
      <TR><TD align=right>Whisper to you: &nbsp; </td><TD><INPUT id=pdxalertSendAsWhisper type=checkbox '+ (Options.alertConfigPDX.sendasWhisper?'CHECKED ':'') +' /></td></tr>\
    </table></td></tr>\
        </table><BR><BR><HR><u>Note</u>: if a box is not clickable KoC made some Updates!<BR><font color=#FF0000><u>IMPORTAN</u></font>: if you want to get the Map Tab to work, you need to install (<a href="http://userscripts.org/scripts/show/96308" target="_blank">KOCtools: The Script</a>). <BR>(deactivate it if you never use it!)<HR>' + AllianzName + ' - Allianz Extra - Update: <a href="'+ ScriptLink+'" target="_blank">' +Scriptname+ '</a> - Version: '+ Version +'</div>';
    t.myDiv.innerHTML = m;
...
﻿  ﻿  msg += Options.alertConfigPDX.towermsg;
    ...
    msg += 'TRAGET: ' + target + ' = ';
          // boldtext VICTIM
    msg += 'VICTIM: ' + who + ' (' + addCommas(attackermight) + ', ' + diplomacy + ') ';
...
Tabs.Karte = {
  ...
  myDiv : null,
  timer : null,
  maplink :  'http://koc.dunno.com/index.sjs?f=KocMapViewer&server_id='+GetServerId()+'',  
  
  init : function (div){    // called once, upon script startup
    var t = Tabs.Karte;
    t.myDiv = div;
    div.innerHTML = '<CENTER><iframe src="'+ t.maplink +'" width="100%" height="550" name="board_in_a_box" <p>Ihr Browser kann leider keine eingebetteten Frames anzeigen: Sie k&ouml;nnen die eingebettete Seite &uuml;ber den folgenden Verweis aufrufen: <a href="'+ t.maplink +'">Truppen Spostamenti</a></p> </iframe> <BR></center>';
  },
...
Tabs.Gebiete = {
  ...
  tabLabel : 'Territories',            // label to show in main window tabs
  myDiv : null,
  timer : null,
  territorieslink :  'http://koctools.com/index.php?pageid=servers',  
  
  init : function (div){    // called once, upon script startup
    var t = Tabs.Gebiete;
    t.myDiv = div;
    div.innerHTML = '<CENTER><iframe src="'+ t.territorieslink +'" width="100%" height="550" name="board_in_a_box" <p>Ihr Browser kann leider keine eingebetteten Frames anzeigen: Sie k&ouml;nnen die eingebettete Seite &uuml;ber den folgenden Verweis aufrufen: <a href="'+ t.territorieslink +'">KoC Server Gebiete</a></p> </iframe> <BR></center>';
  },
...
Tabs.Teamspeak = {
  ...
  myDiv : null,
  timer : null,
  tslink :  'http://ts3.god-like.info/tsviewpub.php?skey=0&port=31337&showicons=right&bgcolor=none&fontcolor=000000',  
  
  init : function (div){    // called once, upon script startup
    var t = Tabs.Teamspeak;
    t.myDiv = div;
    div.innerHTML = '<CENTER><iframe allowtransparency="true" src="'+ t.tslink +'" width="100%" height="550" name="board_in_a_box" <p>Ihr Browser kann leider keine eingebetteten Frames anzeigen: Sie k&ouml;nnen die eingebettete Seite &uuml;ber den folgenden Verweis aufrufen: <a href="'+ t.tslink +'">god-like.org - Teamspeak Server</a></p> </iframe> <BR></center>';
  },
...
/****************************  Wiki Tab   ******************************/
Tabs.Wiki = {
  tabOrder : 90,                    // order to place tab in top bar
  tabLabel : 'Wiki',            // label to show in main window tabs
  myDiv : null,
  timer : null,
  wikilink :  'http://koc.wikia.com',  
  ...
  show : function (){         // called whenever this tab is shown
    ...
    mainPop.div.style.width = 750 + 'px';
    if (Options.widescreen==true)mainPop.div.style.width = 1100 + 'px';
	 div.innerHTML = '<CENTER><iframe src="'+ t.wikilink +'" width="100%" height="550" name="board_in_a_box" <p>Ihr Browser kann leider keine eingebetteten Frames anzeigen: Sie k&ouml;nnen die eingebettete Seite &uuml;ber den folgenden Verweis aufrufen: <a href="'+ t.wikilink +'">Kingdom of Camelot - Wiki - English</a></p> </iframe> <BR></center>';
  },
}
/*********************************** Log Tab ***********************************/
Tabs.ActionLog = {
...
Tabs.msg = {
  ...
  init : function (div){
    ...
    var m = '<DIV class=pdxStat>INBOX, OUTBOX AND REPORTS</div>';
    m += '<DIV class=pdxEntry><table>';
    m += '<TABLE width=95% class=pdxTab><TD>Search in: <select id="searchSelect"><option value="Reports">Reports</options>';
    m += '<option value="inbox">inbox</option>';
    m += '<option value="outbox">outbox</option></select></td>';
    
    m += '<TD><select disabled=true id="searchForSelect"><option value="Subject">Subject</options>';
    m += '<option value="User">Player</option></select></td>';
	
    m += '<TD>Keyword: <INPUT id=searchString disabled=true type=text size=10 maxlength=25 value=""</td>';
    ...
    m += '<TD><INPUT id=StartSearch type=submit value="Search"></td><TD><DIV id="searchStatus"></div></td>';
    m += '</table><BR></div><DIV id="ReportResults" ></div>';
    ...
    document.getElementById('StartSearch').addEventListener ('click', function(){ 
        	 if (document.getElementById('searchSelect').value == "Reports") {t.data=[];t.handleArcSearch();}
        	 	...
        	 	t.data=[];
        	 	t.content = '<center><table><thead><th>Read Message</th><th>Page</th><th>Date</th><th>from</th><th>Subject</th></thead><tbody>';
        	 	t.searchMail("",1); 
        	 }
        }, false);
  ...
  searchMail : function() {
    ...
    results.innerHTML = '<center><b>Start searching in '+t.maxPages+' pages!</b></center>';
    t.data=[];
  ...
  DisplayReports : function (){
    ...
    var results=document.getElementById("ReportResults");
    if(!t.data.length) {
       results.innerHTML = '<center>Search done... no attacks on your alliance :)</center>';
       return;
    }
    var m = '<center><table><thead><th>Page</th><th>Date</th><th>Victim</th><th>Victim<br>Coord</th><th>Alliance</th><th>Type</th><th>Traget</th><th>Traget<br>Coord</th></thead>';
    m += '<tbody>';
       ...
       if (rslt.arReports && page) {
         ...
         for (var i = 0; i < rptkeys.length; i++) {
              ...
              if (rpt.marchType == 1)
                  ...
                  rpt.marchName = '<SPAN class=atk> Attack</span>';
  ...
  searchMail : function(rslt, pageNum) {
    ...
    if (parseInt(pageNum) <= t.maxPages) {
          ...
          document.getElementById('searchStatus').innerHTML = "<b>Fertig!</b>";
       } 
  },
  ...
  showBody: function (messageBody) {
  	...
  	t.popMsg.getTopDiv().innerHTML = '<TD><B>Message</b></td>';
  	t.popMsg.show(true)	;
   },
  ...
  searchInMail: function(rslt,pageNum){
	   ...
	   for (k in myarray) {
	      ...
	      if (lookup.search(what, "i") != -1){
	        t.content += '<TR><TD><A><SPAN onclick="getmsg('+ myarray[k]['messageId'] +')">Read</span></a></td>'
  ...
  show : function (){
	   var t = Tabs.msg;
	  	  mainPop.div.style.width = 750 + 'px';
   if (Options.widescreen==true)mainPop.div.style.width = 835 + 'px';
  },
