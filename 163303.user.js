...
// ==UserScript==
// @name          add skipper
// @namespace     http://galihrezah.blogspot.com/
// @author        google
// @description   skip Ads, clean internet
// @version       1.2
// @updateURL     http://userscripts.org/scripts/source/163303.user.js
...
// mirrorcreator :
// ===========================================================
// @match         http://*.mirrorcreator.com/redirec*
...
function isUrl(s){return /^((ftp|https?):\/\/)+([\w\d\.]+([\w]{2,6})?)/ig.test(s.trim());}
...
var Extra = {
  init : function () {
    ...
    Extra.cdwn = Extra.inval = Extra.passed = 0;
  },
