...
var browsebar = document.getElementsByName("go")[0].parentNode;
browsebar.innerHTML = browsebar.innerHTML + "<br> <input type=\"button\" value=\"Conglomerate Gallery\" onclick=\"FAGC_getLinks();\">";