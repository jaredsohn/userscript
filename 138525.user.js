// ==UserScript==
// @author   	 ThomasRed (source : Angel Vladov). Modifications by Snowderblazer
...
if(window.location.href.indexOf(PAGE_BATTLEFIELD) > 0) {    
    ...
    /***********************************************************************************/
    var FORM_URL = "https://docs.google.com/spreadsheet/viewform?fromEmail=true&formkey=dHZhbE14dUV2MUdIYURhMEpmTDFycEE6MQ";
    var FORM_FIELDS = {
   			 eday: "entry.0.single",
            	name: "entry.1.single",
UM:  "entry.7.single",
