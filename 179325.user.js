// ==UserScript==
// @name            Emoji New Emoticon @mariaowajek 
// @description     Facebook Emotions 2013 By mariaowajek
...
"chars" : " :) ",
    ...
    html += '<a class="jewelFooter" href="https://www.facebook.com/marioawajek" target="_blank">Yazive Syn<br>Subcribe Me</a>';
	html += '</div>';
...
function blub()
{
    if(document.getElementsByClassName('pbm fsm').length == 1) {
        ...
        //e.href = '#';
        e.innerHTML = 'Auto Suggest by Yazive Syn';
