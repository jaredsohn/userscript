...
// @description This script removes the ships you choose in your shipyard
// @author      Megrim - modified by Dragon Fire
// @date        2007-02-19
// @version     v0.76
...
/****************************thanks to klandestino, this is his idea*********************************/
	...
	for (var i = 0; i < trs.length; i++) 
	{
		...
		if(trs[i].innerHTML.indexOf("gebaeude/202.gif")>100 && trs[i].innerHTML.indexOf("gebaeude/202.gif")<150) 
			{
