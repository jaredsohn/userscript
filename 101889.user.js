// ==UserScript==
// @name               The West - Motivation [PL] by szymmirr
// @source namespace   http://userscripts.org/scripts/show/85632
// @namespace          http://userscripts.org/scripts/show/101889
// @description        Monitorowanie motywacji prac w The-West. Skrypt na podstawie rosyjskiej wersji 2.0 oryginalnego skryptu autorstwa JoeSmith.
// @source author      JoeSmith
// @author             szymmirr
// @website            http://userscripts.org/users/323648
...
function setAktListe(listenName) {
    listenName = $defined(listenName) ? listenName : 'Domyślne';
...
function addMotivationButton() {
    ...
    menuElem.innerHTML = '<a href="#" onclick="MoCheck.openMotivationWindow();">' +
                         '  <span style="display:block; width:105px; font-weight:normal; color:#fff; margin-left:25px; padding-top:5px;"><b>Motywacja</b></span>' +
                         '</a>';
...
function openMotivationWindow() {
    ...
    xhtml += '                                <h2>The West - Motywacja</h2>';
    xhtml += '                                <ul style="margin-top:10px;text-align:left;">' +
            '                                    <li>Możliwość tworzenia list prac odpowiednich dla Ciebie</li>' +
            '                                    <li>Bezpośrednie rozpoczynanie prac jednym kliknięciem, bez długich poszukiwań</li>' +
            '                                    <li>Klasyfikacja prac według punktów doświadczenia, motywacji, wynagrodzenia i szczęścia</li>' +
            '                                </ul>';
    xhtml += '                            </div>';
    xhtml += '                            <div style="float:left;">';
    xhtml += '                                Tutaj możesz dowiedzieć się więcej i pobrać skrypt: <br />';
    xhtml += '                                <a href="http://userscripts.org/scripts/show/101889" target="_blank">http://userscripts.org/scripts/show/63326</a>';
    xhtml += '                                <br>Oparty jest on na rosyjskiej wersji oryginalnego skryptu: <br />';
    xhtml += '                                <a href="http://userscripts.org/scripts/show/85632" target="_blank">http://userscripts.org/scripts/show/85632</a>';
    xhtml += '                                <br>Który oparty jest na oryginalnym, nieistniejącym już skrypcie autorstwa JoeSmith.<br />';
    ...
    xhtml += '                                    <img src="https://www.paypal.com/de_DE/DE/i/btn/btn_donateCC_LG.gif" alt="Wesprzyj" />';
    xhtml += '                                </a>';   
    xhtml += '                            </div>';   
    xhtml += '                        </div>';
    xhtml += '                    </div>';
...
function getAuthor() {
    ...
    switch(window.location.hostname.substr(0,window.location.hostname.search(/\./))) {
       ...
       case 'de9':
           ...
           break;
       default:
           hrefStr = 'http://userscripts.org/users/323648';
    }
    return '<a href=\"' + hrefStr + '\">szymmirr</a>';
}
...
res['pl'] = {
       'dialog.closeAll.popup':'Zamknij wszystkie okna',
       'dialog.minimize.popup':'Zminimalizuj okno',
       'dialog.close.popup':'Zamknij okno',

       'dialog.tab.work.titel':'Prace',
       'dialog.tab.about.titel':'O skrypcie',
       'dialog.tab.work.nothingSelected.1':'Nie wybrałeś żadnej pracy!',
       'dialog.tab.work.nothingSelected.2':'Musisz otworzyć pracę i dodać ją.',
       'dialog.tab.work.tableHeader.work':'Praca',
       'dialog.tab.work.tableHeader.points':'Punkty pracy',
       'dialog.tab.work.tableHeader.money':'Wynagrodzenie',
       'dialog.tab.work.tableHeader.experience':'Punkty doświadczenia',
       'dialog.tab.work.tableHeader.luck':'Szczęście',
       'dialog.tab.work.tableHeader.motivation':'Motywacja',
      
       'dialog.tab.configuration.actual':'aktualne',
       'dialog.tab.configuration.btnDelete.popup':'Usuń listę',
       'dialog.tab.configuration.btnRename.popup':'Zmień nazwę listy',
       'dialog.tab.configuration.btnNew.popup':'Utwórz nową listę',
  
       'select.option.minutes':'m',
       'select.option.hours':'h',
      
       'btnOk.label':'Ok',
       'btnAdd.popup':'Dodaj pracę',
       'btnCenter.popup':'<b>Czas podróży:</b> %1h',
       'btnDelete.popup':'Usuń pracę z listy',
      
       'sortIcon.popup.money':'Ułóż według <b>wynagrodzenia</b>',
       'sortIcon.popup.luck':'Ułóż według <b>szczęścia</b>',
       'sortIcon.popup.experience':'Ułóż według <b>punktów doświadczenia</b>',
       'sortIcon.popup.motivation':'Ułóż według <b>motywacji</b>',
      
       'visibleIcon.popup.money':'Pokazuj / nie pokazuj <b>wynagrodzenia</b>',
       'visibleIcon.popup.luck':'Pokazuj / nie pokazuj <b>szczęścia</b>',
       'visibleIcon.popup.experience':'Pokazuj / nie pokazuj <b>punktów doświadczenia</b>',
       'visibleIcon.popup.motivation':'Pokazuj / nie pokazuj <b>motywacji</b>',
      
       'jobImage.popup':'Job: <b>%1</b><br />Punkty pracy: <b>%2</b>',
  
       'message.error.unableToDeleteCurrentList':'Nie można usunąć bieżącej listy.',
       'message.deleteList':'Usunąć listę %1?',
       'message.newName':'Nazwa nowej listy:',
       'message.addedWork':'Dodano pracę.',
       'message.deleteFromList':'Usunąć %1 z listy?',
       'message.listLoaded':'Załadowano %1.',
       'message.listDeleted':'Usunięto %1.',
       'message.listRenamed':'Zmieniono nazwę listy.',
       'message.listCreated':'Utworzono listę.',
       'message.error.nameAlreadyDefined': 'Nazwa %1 jest już w użyciu.',
      
       'author':'Autor: <b>JoeSmith</b>. Tłumacz:'
    };   

    return (res[lang] != null ? res[lang] : res['pl']);
}
