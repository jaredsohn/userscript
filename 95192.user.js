...
function GoTeamPage()
{
	...
	eval(menucell.href.split(":")[1].replace(/document\.(\w+)\.submit/, "document.forms.namedItem(\"$1\").submit"));	
...
function BuyJutsu(jutsu)
{
	...
	document.forms.namedItem("jutsu").submit();
...
function EnableMegamissions()
{
    ...
    {
	document.forms.namedItem("megamis").submit();
...
function GoMissionPage(rank)
{
	...
	eval("document.forms.namedItem(\"misform" + objMissionLookup[rank] + "\").submit();");
...
function GoQuestPage()
{
    ...
    {
	document.forms.namedItem("questcontinue").submit();
...
function GoJutsuEnhancePage()
{
    ...
    {
	if (document.forms.namedItem("jenhance"))
	{
	    document.forms.namedItem("jenhance").submit();
...
function GetStalker3()
{
	...
	else
	{
	    ...
	    if (document.forms.namedItem("r00t"))
	    {
		document.forms.namedItem("r00t").submit();
    ...
    if (LocationTest("/bvs/village.html"))
    {
	if (document.forms.namedItem("fieldmenu"))
	{
	    document.forms.namedItem("fieldmenu").submit();
...
function BlindQuestAttempt()
{
	...
	document.forms.namedItem("goquest").submit();
}
...
function MissionAttempt(jutsu)
{
    ...
    if (document.forms.namedItem("domission"))
	document.forms.namedItem("domission").submit();
    if (document.forms.namedItem("attempt"))
    {
	if (jutsu.code > -1)
	    document.getElementById("jutsu" + jutsu.code).checked = true;
	document.forms.namedItem("attempt").submit();    
    }
...
function DoGenericQuest(quest, endstep, jutsu)
{
    ...
    {
	eval("document.forms.namedItem(\"quest" + quest.code + "\").submit()");
	return;
    }
    ...
    if (jutsu && document.forms.namedItem("attack"))
...
function TeamChange(ally1, ally2, ally3)
{
    ...
    if (document.forms.namedItem("conteam"))
    {
	// Confirm the team without thinking
	document.forms.namedItem("conteam").submit();
	return;
    }
    ...
    // Submit the form
    document.forms.namedItem("maketeam").submit();
}
...
function ChuninExamQuest1()
{
    ...
    if (document.forms.namedItem("questchu1"))
    {
	document.forms.namedItem("questchu1").submit();
	return;
    }

    if (document.forms.namedItem("skipchu"))
    {
	document.forms.namedItem("skipchu").submit();
	return;
    }
}
...
function GetLevel12()
{
    ...
    // Check termination conditions
    if (document.forms.namedItem("domission") && GetLevel() >= 12)
    {
	IncrementTask();
...
function GetTimmy30()
{
    ...
    // Check termination conditions
    if (document.forms.namedItem("domission") && resultsTimmyMissions &&
...
function GetPinky2()
{
    ...
    // Check termination conditions
    if (document.forms.namedItem("domission") && data.TestFlag("Pinky Lvl. 2"))
    {
	IncrementTask();
	document.forms.namedItem("minim2").submit();
	throw new Error("Task Complete!");
...
function GetStalkergirl2()
{
    ...
    // Check termination conditions
    if (document.forms.namedItem("domission") && data.TestFlag("Stalkergirl Lvl. 2"))
    {
	IncrementTask();
	document.forms.namedItem("minim2").submit();
	throw new Error("Task Complete!");
...
function GetMrSmith()
{
    ...
    // Check termination conditions
    if (document.forms.namedItem("domission") && data.TestFlag("Mr. Smith"))
    {
	IncrementTask();
	document.forms.namedItem("minim2").submit();
	throw new Error("Task Complete!");
...
function GetBruceSr()
{
    ...
    // Check termination conditions
    if (document.forms.namedItem("domission") && data.TestFlag("Bruce Sr."))
    {
	IncrementTask();
	document.forms.namedItem("minim2").submit();
	throw new Error("Task Complete!");
...
function GetBilly2()
{
    ...
    // Check termination conditions
    if (document.forms.namedItem("domission") && data.TestFlag("Billy Lvl. 2"))
    {
	IncrementTask();
	document.forms.namedItem("minim2").submit();
	throw new Error("Task Complete!");
...
function GetLevel60()
{
    ...
    // Check termination conditions
    if (document.forms.namedItem("domission") && GetLevel() >= 60)
    {
	IncrementTask();
	document.forms.namedItem("minim2").submit();
	throw new Error("Task Complete!");
...
function GetTaiLevel35()
{
    ...
    // Check termination conditions
    if (document.forms.namedItem("domission") && GetMaxSingleLevel() >= 35)
    {
	IncrementTask();
	document.forms.namedItem("minim2").submit();
	throw new Error("Task Complete!");
...
function UseArenaFight(useall)
{
    ...
    if (document.forms.namedItem("arenafight"))
    {
	if (useall)
	{
	...
	document.forms.namedItem("arenafight").submit();
