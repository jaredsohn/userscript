// ==UserScript==
// @name			Ordenes de Batalla - COL
// @version			1.0
// @author			Bort
// @namespace		orders_cua
// @description		Plugin para visualizar las Ordenes de Batalla de COL.
...
// @updateURL		http://userscripts.org/scripts/source/158992.meta.js
// @downloadURL		http://userscripts.org/scripts/source/158992.user.js
// ==/UserScript==
function LL_carga() {
...
function header() {
    ...
    //var orders = '<h4>Prioridades de CUA</h4><div id="mod_orders"></div>';
    ...
    var imageHeader = 'http://oi44.tinypic.com/e16hkg.jpg';
    var orders = '<div id="mod_orders"><img src="'+ imageHeader + '" style="float: none; margin-top:-5px; margin-bottom:-2px" alt="Prioridades de Combate - CUA"/></div>';
...
function footer() {
	...
	var linkDiv = '';
    switch(x) {
    case 1: linkDiv = 'http://tinyurl.com/div1ecol'; break;
    case 2: linkDiv = 'http://tinyurl.com/div2ecol'; break;
    case 3: linkDiv = 'http://tinyurl.com/div3ecol'; break;
    case 4: linkDiv = 'http://tinyurl.com/div4ecol'; break;
    default: linkDiv = 'XX';
    }    
    var orders = '<div class="rest">#Rezpekt <a href="http://tinyurl.com/planillacol" title="" target="_blank">Planilla Ordenes COL</a><a href="' + linkDiv + '" title="" target="_blank">Canal de Coordinación</a></div>';
...
function battles() {
	var x = division();
    $.get('https://docs.google.com/document/d/1MOHGRy9eFAuwyxU8McZRSvEuwRjzu9PUmQsRM4a2hRQ/preview', function(data) {
