...
// --------------------------------------------------------------------
// ==UserScript==
// @name         سكيربت saudi16 المقدم من آبو عبدآلله
// @version        3a
// @namespace     alsufrrat.com/vb
...
languages = { // Language tags
	"en" : {
		...
		"mapsize"  : "حجم الخريطة",
		"pop_close": "أغلق",
		"pop_auto" : "اعرض تلقائياً:",
		"group_toggle" : "اعرض/اخفي مجموعات القرى",
		"group_edit" : "غير",
		"group_moveup" : "فوق",
		"group_remove" : "حذف",
		"group_add" : "اضافة ",
		...
		"group_ingroup" : "المجموعة",
		"overview_nogroup" : "Ungrouped villages",
		"overview_village" : " للقرى",
		"overview_points" : "النقاط",
		"overview_resources" : "الموارد",
		"overview_warehouse" : "المخزن",
		"overview_farm" : "المزارع",
		"main_setaliasheader" : "تغيير اسم القرية:",
		"main_setalias" : "غير الآن",
		"main_setaliasdone" : "تـم التغيير!",
		"setting_show" : "سكيربت saudi16",
		"setting_name" : "اسم البرنامج المساعد",
		"setting_toggle" : "تمكين/تعطيل",
		"setting_label_desc" : "الوصف",
		"setting_label_version" : "النص",
		"setting_label_dev" : "المظهر",
		"setting_label_exec" : "Runs for",
  		"tw_scan" : " حاولنا قدر المستطاع ان نطور السكيربت الى ما هو عليه !"
	},
 		...
 		//make sure twe.curVillage is initalized
			...
			setFunc("tool_info", function(type){
				...
				if (type == 'player') {
					...
					window.open("http://ae.twstats.com/index.php");                                        
				}
			});
