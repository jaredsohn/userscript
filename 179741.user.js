...
function FR_CFG_CREATE() {
   ...
   return {
        ...
        'SETTINGS': {
            ...
            'FO_PostScore': ['TOGG', false, 'Post Score', 'Show post scores at the top right of posts', ['FO_PostStats']],
            'FO_AutoHidePosts': ['TOGG', true, 'Autohide Posts', 'Automatically hide posts based on post score', ['FO_PostStats']],
            'FO_SuperHidden': ['TOGG', false, 'SuperHidden', 'Make hidden posts completely vanish', ['FO_PostStats']],
			'FO_ScoreIgnoreOP': ['TOGG', false, 'Ignore OP', 'When calculating post score, ignore the first post', ['FO_PostStats']],
   ...
   return {
        ...
        'MODLIST': {
			...
			'RETIRED': [
				...
				["4201", "Captain Bald"],["401", "Cheeez"],["15625", "chris0132"],["89526", "compwhizii"],["2416", "Crocodile_Hunter"],
				...
				["632", "Megiddo"],["50757", "mikfoz"],["101037", "mm3guy"],["8217", "Monkeyjoe"],["9571", "Moocow"],["20274", "mrchaos58"],
...
#navbarlinks { overflow:hidden; height: auto; }\
        ...
        */
        ...
        init: function(){
			...
			for (var i = 0; i < imgs.length; i++) {
				...
				imgs[i].src = FR_CFG.ICONS['goatse'];
				imgs[i].setAttribute("style","width:"+width+"px; height:"+height+"px;");
			}
            ...
            if( FR_FUN.GLOBALS.URLREWRITE ) {
                ...
                if ( window.location.pathname.indexOf("showthread.php") !== -1 ) {
                    ...
                    // grab the last result, which should be the subforum we're in
                    FR_FUN.GLOBALS.SubforumName = thissubforum.snapshotItem(thissubforum.snapshotLength - 1).childNodes[1].textContent;
                    FR_FUN.GLOBALS.SubforumID   = parseInt(thissubforum.snapshotItem(thissubforum.snapshotLength - 1).childNodes[1].getAttribute("href").replace(/forumdisplay\.php\?f=/, ""), 10);
                ...
                //NEWREPLY
                    ...
                    thissubforum = document.evaluate("//span[@class='navbit']",document, null, XPathResult.ORDERED_NODE_SNAPSHOT_TYPE, null);
                    FR_FUN.GLOBALS.SubforumName = thissubforum.snapshotItem(thissubforum.snapshotLength - 2).childNodes[1].textContent;
                    FR_FUN.GLOBALS.SubforumID   = parseInt(thissubforum.snapshotItem(thissubforum.snapshotLength - 2).childNodes[1].getAttribute("href").replace(/forumdisplay\.php\?f=/, ""), 10);
