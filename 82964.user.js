...
//
// ==UserScript==
// @name          Ikariam Destek V.1
// @namespace     http://ikariam.org/
// @description   İkariam Destek :) ( www.ikariam.forumm.biz)
...
if (chaturl == '') {
  chaturl = "http://ikariam.forumm.biz";
}
...
if (navigationLinks) {
  ...
  spanelement.appendChild(document.createTextNode("İkariam Destek"));
...
if (document.getElementById('allyinfo') != null) {
    ...
    textTablecolumn1.appendChild(document.createTextNode("İkariam Destek:"));
    ...
    aelement.title = 'Chat!';
    aelement.target = '_blank';
    aelement.appendChild(document.createTextNode("Tıkların."));
