...
// @creator        yasserock (yasserock) Â® 2011
// ==/UserScript==
			...
			$.ajax({
					...
					data: 'ie=1&titulo=Preview&cuerpo='+encodeURIComponent(txt.value),
 					success: function(h){
						...
						if(path == 'mensajes'){
							var HTML = '<br><div class="cita" style="color:#464646;text-shadow:0 1px 0 #CCCCCC;"><img src="'+URL+'cerrar.gif" alt="[X]" title="Cerrar PrevisualizaciÃ³n" border="0" onclick="($(\'#return_agregar_comentario\').slideUp(1000))" style="margin-right:5px" onmouseover="this.style.cursor=\'pointer\'" />PrevisualizaciÃ³n - yasserockÂ®</div>';
							HTML += '<div class="citacuerpo">'+respuesta+'</div><br>';
						}else{
							var HTML = '<div class="respuesta clearfix"><div class="answerInfo"></div>';
							HTML += '<div class="answerTxt"><div class="answerContainer"><div class="Container" style="padding:0"><div class="answerOptions"><div class="floatL metaDataA"><img src="'+URL+'cerrar.gif" alt="[X]" title="Cerrar PrevisualizaciÃ³n" border="0" onclick="($(\'#return_agregar_comentario\').slideUp(1000))" align="absmiddle" style="margin-right:5px" onmouseover="this.style.cursor=\'pointer\'" />PrevisualizaciÃ³n - yasserockÂ®</div></div><div style="margin: 10px !important;" class="cuerpo_comm">'+respuesta+'</div></div></div></div></div>';
						}
 						$('#return_agregar_comentario').slideUp(1000, function(){
...
//----Opciones----//
	...
	menu += '	<a href="http://www.taringa.net/comunidades/scriptsbbcoders/" title="Entrar a la Comunidad del ScriptÂ®" style="">Script <img alt="Drop Down" src="http://i.t.net.ar/images/arrowdown.png"></a>';
	menu += '</li>';
	...
	submenu += '	<li><a title="Comunidad Oficial del ScriptÂ®" href="http://www.taringa.net/comunidades/scriptsbbcoders/">Comunidad Oficial</a></li>';
...
var regComu = /\/comunidades\/(scriptsbbcoders|comunidaduruguayos|cannabis|dejatumensaje|denuncias-t|nacional-|ps2games|steamoficial|4chan|canallamania)\//gi;
}
...
case 'post':
	...
	///////////////-------------------Agregar BotÃ³n Denunciar - Barra de titulo del post-----------------------------//////////////////////
...
case 'edicion':
	...
	$('div.end-form').append('<input name="postear" type="submit" value="Postear sin Previsualizar Â»Â»" class="mBtn btnGreen floatL" style="width: auto; margin-left: 5px;">');
...
hosts.push (["megaupload.com", // OK
			 ...
			 /downloadlink/gi,
			 /Enlace no vÃ¡lido|archivo ha sido borrado|el enlace seleccionado no estÃ¡ disponible/,
			 /[\d.]+ [KM]B/
			 ]);
