// ==UserScript==
// @name		TNeI Military Unit Order Battle
...
// @contributor		RyGnwn http://www.erepublik.com/en/citizen/profile/2152215
...
function header() {
	var imageHeader = 'http://s4.postimage.org/wi0slchql/top_3_zps444646c6.png';;
	$('#new_orders').append('<img src="'+ imageHeader + '" style="float: none; margin-top:0px; margin-bottom:-3px"/>');
}

function footer() {
	var footer = 'http://s7.postimage.org/j5w9byrej/bottom_zpsc5a59b52.png';
