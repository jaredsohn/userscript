// ==UserScript==
// @name			HF Scripts - Easy Report Hacking Tutorials
// @namespace 		Glassy/hfreportinghackingtutorials
// @description 	Makes reporting posts/threads in Hacking Tutorials section to Glassy MUCH easier.
// @include  		*hackforums.net/showthread.php*
// @version  		1.1.2
// ==/UserScript==

var navBit = document.getElementsByClassName('navigation')[0];
if(navBit.innerHTML.indexOf('<a href="forumdisplay.php?fid=47">Hacking Tutorials</a>') != -1) {
