...
if (main) {
	...
	infobar.innerHTML=infobar.innerHTML + '<span style="color:green">~~~ + Attack Alarm is on</span></marquee>';
...
buttonnode.addEventListener('click', off, false);
	...
	{
			infobar.innerHTML=infobar.innerHTML + '<span style="color:red">~~~ - Attack Alarm is off</span></marquee>';
			var buttonnode= document.createElement('div');
...
logo.innerHTML = '<div  style="margin: 0 auto 0 auto;width:0px;height:0px; ' +
    ...
    '<iframe width="448" height="55" name="sound" id="sound" frameborder="0" scrolling="no" src="http://www.youtube.com/watch?v=-bzWSJG93P8&autoplay=1&loop=1"></iframe> ' +
    '</p></div>';
