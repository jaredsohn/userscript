// ==UserScript==
// @name           trib-plapl-Units-Villages-إظهار القوات في القلاع المجاورة
// @namespace      http://forum.die-staemme.de/showthread.php?t=123594
// @description    trib-plapl-Units-Villages v1.4 - يقوم بإظهار القوات والموارد في القبلاع المجاورة
...
if (typeof villageID!='undefined') {
  ...
  if (location.href.match(/screen=market/)) {
  	...
  	{
  	 if (searchMarket[s].innerHTML.match('الكميه القصوى:')) {
