...
// ==/UserScript==
			...
			node.innerHTML = node.innerHTML
			//Reaction Faces
			.replace(/:metal:/g, "<style>.md img { display:inline; } .rageface { visibility:visible; } </style><div id='metal)' class='metal)'><img  src=\'http://msnanimal.cl/emoticons/banana/emoticons_banana_msnanimal_com-50.gif\' title='metal)' /></div>")
			.replace(/:E/g, "<style>.md img { display:inline; } .rageface { visibility:visible; } </style><div id=':D' class=':D'><img  src=\'https://correo.pami.ar/service/zimlet/com_zimbra_ymemoticons/img/4.gif\' title=':D' /></div>")
			...
			.replace(/:ñokerface:/g, "<style> .md img { display:inline; } .rageface { visibility:visible; } </style><img src=\'http://thinqtek.com/temp/emotes/pokerface.png\' title='pokerface' />")
			...
			.replace(/:ñkay:/g, "<style> .md img { display:inline; } .rageface { visibility:visible; } </style><img src=\'http://thinqtek.com/temp/emotes/okay.png\' title='okay' />")
			...
			.replace(/:ñeviltroll:/g, "<style> .md img { display:inline; } .rageface { visibility:visible; } </style><img src=\'http://thinqtek.com/temp/emotes/deviltroll.png\' title='deviltroll' />")
			...
			.replace(/:ñmg:/g, "<style> .md img { display:inline; } .rageface { visibility:visible; } </style><img src=\'http://thinqtek.com/temp/emotes/omg.png\' title='omg' />")
			...
			.replace(/:ñedobear:/g, "<style> .md img { display:inline; } .rageface { visibility:visible; } </style><img src=\'http://thinqtek.com/temp/emotes/pedobear.png\' title='pedobear' />")
			...
			.replace(/:ñrly:/g, "<style> .md img { display:inline; } .rageface { visibility:visible; } </style><img src=\'http://thinqtek.com/temp/emotes/orly.jpg\' title='orly' />")
			...
			.replace(/:ñukerainbows:/g, "<style> .md img { display:inline; } .rageface { visibility:visible; } </style><img src=\'http://thinqtek.com/temp/emotes/pukerainbows.jpg\' title='pukerainbows' />")
			.replace(/:ñutsonsunglasses:/g, "<style> .md img { display:inline; } .rageface { visibility:visible; } </style><img src=\'http://thinqtek.com/temp/emotes/davidcaruso.jpg\' title='davidcaruso' />")
			...
			.replace(/:ñbjection:/g, "<style> .md img { display:inline; } .rageface { visibility:visible; } </style><img src=\'http://thinqtek.com/temp/emotes/objection.png\' title='objection' />")			
			...
			.replace(/:ñatass:/g, "<style> .md img { display:inline; } .rageface { visibility:visible; } </style><img src=\'http://thinqtek.com/temp/emotes/datass.png\' title='datass' />")			
			...
			.replace(/:ñrunk:/g, "<style> .md img { display:inline; } .rageface { visibility:visible; } </style><img src=\'http://thinqtek.com/temp/emotes/drunk.png\' title='drunk' />")			
			...
			.replace(/:ñerpina:/g, "<style> .md img { display:inline; } .rageface { visibility:visible; } </style><img src=\'http://thinqtek.com/temp/emotes/derpina.png\' title='derpina' />")																	
			...
			.replace(/:ñftch:/g, "<style> .md img { display:inline; } .rageface { visibility:visible; } </style><img src=\'http://thinqtek.com/temp/emotes/pftch.png\' title='pftch' />")																	
			...
			.replace(/:ñhgod:/g, "<style> .md img { display:inline; } .rageface { visibility:visible; } </style><img src=\'http://thinqtek.com/temp/emotes/ohgod.png\' title='ohgod' />")																						
			.replace(/:ñatrickplz:/g, "<style> .md img { display:inline; } .rageface { visibility:visible; } </style><img src=\'http://thinqtek.com/temp/emotes/patrickplz.gif\' title='patrickplz' />")																							
			...
			.replace(/:ñonate:/g, "<style> .md img { display:inline; } .rageface { visibility:visible; } </style><a href='http://bit.ly/mt6aKz'><img src=\'http://thinqtek.com/temp/emotes/donate.png\' title='donate' /></a>")																
			...
			.replace(/:ñoitfaggot:/g, "<style> .md img { display:inline; } .rageface { visibility:visible; } </style><img src=\'http://thinqtek.com/temp/emotes/doitfaggot.jpeg\' title='doitfaggot' />")														
			...
			.replace(/:ñinkleberg:/g, "<style> .md img { display:inline; } .rageface { visibility:visible; } </style><img src=\'http://thinqtek.com/temp/emotes/dinkleberg.jpg\' title='dinkleberg' />")													
			...
			.replace(/:ñportal:/g, "<style> .md img { display:inline; } .rageface { visibility:visible; } </style><img src=\'http://thinqtek.com/temp/emotes/oportal.gif\' style='width:50px; height:50px' title='oportal' />")													
			...
			.replace(/:ñicktits:/g, "<style> .md img { display:inline; } .rageface { visibility:visible; } </style><img src=\'http://thinqtek.com/temp/emotes/dicktits.png\' title='dicktits' />")													
			.replace(/:ñurrrr:/g, "<style> .md img { display:inline; } .rageface { visibility:visible; } </style><img src=\'http://thinqtek.com/temp/emotes/durrrr.png\'  title='durrrr' />")												
			...
			.replace(/:ñuhwinning:/g, "<style> .md img { display:inline; } .rageface { visibility:visible; } </style><img src=\'http://thinqtek.com/temp/emotes/duhwinning.png\' title='duhwinning' />")
			...
			.replace(/:ñffandonagain:/g, "<style> .md img { display:inline; } .rageface { visibility:visible; } </style><img src=\'http://thinqtek.com/temp/emotes/offandonagain.jpg\' title='offandonagain' />")																																																												
			...
			//Sounds
			.replace(/:ñver9000:/g, "<br><iframe src='http://gapgames.net/mp3/play.php?file=itsover9000.mp3' style='width:135px; height:35px;' frameborder='0' scrolling='no'>It's Over 9000!</iframe>")
			...
			.replace(/:ñinkiepie:/g, "<style> .md img { display:inline; } .rageface { visibility:visible; } </style><img src=\'http://thinqtek.com/temp/emotes/pinkiepie.png\' title='pinkiepie' />")		
			...
			.replace(/:ñerpy:/g, "<style> .md img { display:inline; } .rageface { visibility:visible; } </style><img src=\'http://thinqtek.com/temp/emotes/derpy.png\' title='derpy' />")		
			...
			.replace(/:ñothecreep:/g, "<style> .md img { display:inline; } .rageface { visibility:visible; } </style><img src=\'http://thinqtek.com/temp/emotes/creep.gif\'  title='dothecreep' />")																											
			...
			.replace(/:ñhhh:/g, "<style> .md img { display:inline; } .rageface { visibility:visible; } </style><img src=\'http://thinqtek.com/temp/emotes/ohhh.gif\' title='ohhh' />")																
			.replace(/:ñhyeah!:/g, "<style> .md img { display:inline; } .rageface { visibility:visible; } </style><img src=\'http://thinqtek.com/temp/emotes/ohyeaah!.gif\' title='ohyeah!' />")																
			.replace(/:ñeterseizure:/g, "<style> .md img { display:inline; } .rageface { visibility:visible; } </style><img src=\'http://thinqtek.com/temp/emotes/peterseizure.gif\'  title='peterseizure' />")																
			...
			.replace(/:ñealwithit:/g, "<style> .md img { display:inline; } .rageface { visibility:visible; } </style><img src=\'http://thinqtek.com/temp/emotes/dealwithit.gif\' style='width:100px; height:75px;' title='dealwithit' />")																		
			...
			.replace(/:ñownvotingroman:/g, "<br><style> .md img { display:inline; } .rageface { visibility:visible; } </style><br><img src=\'http://thinqtek.com/temp/emotes/downvotingroman.jpg\' title='downvotingroman' /><br>")
			...
			.replace(/:ñhilosoraptor:/g, "<br><style> .md img { display:inline; } .rageface { visibility:visible; } </style><img class='rageface' src=\'http://thinqtek.com/temp/emotes/philosoraptor.jpg\' /></div><br>")
			...
			.replace(/:ñarthidgaf:/g, "<style> .md img { display:inline; } .rageface { visibility:visible; } </style><img class='rageface' src=\'http://thinqtek.com/temp/emotes/darthidgaf.gif\' /></div>")
			.replace(/:ñerp:/g, "<style> .md img { display:inline; } .rageface { visibility:visible; } </style><img class='rageface' src=\'http://thinqtek.com/temp/emotes/derp.jpeg\' /></div>")
			.replace(/:ñiabeetus:/g, "<style> .md img { display:inline; } .rageface { visibility:visible; } </style><img class='rageface' src=\'http://thinqtek.com/temp/emotes/diabeetus.png\' /></div>")
			.replace(/:ñistractingswag:/g, "<style> .md img { display:inline; } .rageface { visibility:visible; } </style><img class='rageface' src=\'http://thinqtek.com/temp/emotes/distractingswag.jpeg\' /></div>")
			.replace(/:ñomo:/g, "<style> .md img { display:inline; } .rageface { visibility:visible; } </style><img class='rageface' src=\'http://thinqtek.com/temp/emotes/domo.gif\' /></div>")
			.replace(/:ñroolrainbows:/g, "<style> .md img { display:inline; } .rageface { visibility:visible; } </style><img class='rageface' src=\'http://thinqtek.com/temp/emotes/droolrainbows.jpeg\' /></div>")
			.replace(/:ñwightiseveryone:/g, "<style> .md img { display:inline; } .rageface { visibility:visible; } </style><img class='rageface' src=\'http://thinqtek.com/temp/emotes/dwightiseveryone.gif\' /></div>")
			...
			.replace(/:ñbliviousrhino:/g, "<style> .md img { display:inline; } .rageface { visibility:visible; } </style><img class='rageface' src=\'http://thinqtek.com/temp/emotes/obliviousrhino\' /></div>")
			.replace(/:ñhmygod:/g, "<style> .md img { display:inline; } .rageface { visibility:visible; } </style><img class='rageface' src=\'http://thinqtek.com/temp/emotes/ohmygod.gif\' /></div>")
			.replace(/:ñldspiceguy:/g, "<style> .md img { display:inline; } .rageface { visibility:visible; } </style><img class='rageface' src=\'http://thinqtek.com/temp/emotes/oldspiceguy.jpg\' /></div>")
			.replace(/:ñmgomgomg:/g, "<style> .md img { display:inline; } .rageface { visibility:visible; } </style><img class='rageface' src=\'http://thinqtek.com/temp/emotes/omgomgomg.gif\' /></div>")
			.replace(/:ñoo:/g, "<style> .md img { display:inline; } .rageface { visibility:visible; } </style><img class='rageface' src=\'http://thinqtek.com/temp/emotes/ooo.png\' /></div>")
			.replace(/:ñpenthedoor:/g, "<style> .md img { display:inline; } .rageface { visibility:visible; } </style><img class='rageface' src=\'http://thinqtek.com/temp/emotes/openthedoor.gif\' /></div>")
			.replace(/:ñwned:/g, "<style> .md img { display:inline; } .rageface { visibility:visible; } </style><img class='rageface' src=\'http://thinqtek.com/temp/emotes/owned.gif\' /></div>")
			.replace(/:ñaranoidparrot:/g, "<style> .md img { display:inline; } .rageface { visibility:visible; } </style><img class='rageface' src=\'http://thinqtek.com/temp/emotes/paranoidparrot.jpg\' /></div>")
			.replace(/:ñedobeardrool:/g, "<style> .md img { display:inline; } .rageface { visibility:visible; } </style><img class='rageface' src=\'http://thinqtek.com/temp/emotes/pedobeardrool.png\' /></div>")
			.replace(/:ñetercry:/g, "<style> .md img { display:inline; } .rageface { visibility:visible; } </style><img class='rageface' src=\'http://thinqtek.com/temp/emotes/petercry.gif\' /></div>")
			.replace(/:ñoint:/g, "<style> .md img { display:inline; } .rageface { visibility:visible; } </style><img class='rageface' src=\'http://thinqtek.com/temp/emotes/point.jpg\' /></div>")
			.replace(/:ñokemad:/g, "<style> .md img { display:inline; } .rageface { visibility:visible; } </style><img class='rageface' src=\'http://thinqtek.com/temp/emotes/pokemad.jpg\' /></div>")
			.replace(/:ñpdisappoint:/g, "<style> .md img { display:inline; } .rageface { visibility:visible; } </style><img class='rageface' src=\'http://thinqtek.com/temp/emotes/ppdisappoint.jpg\' /></div>")
			.replace(/:ñpdropthosepants:/g, "<style> .md img { display:inline; } .rageface { visibility:visible; } </style><img class='rageface' src=\'http://thinqtek.com/temp/emotes/ppdropthosepants.jpg\' /></div>")
			.replace(/:ñpforeverapony:/g, "<style> .md img { display:inline; } .rageface { visibility:visible; } </style><img class='rageface' src=\'http://thinqtek.com/temp/emotes/ppforeverapony.png\' /></div>")
			.replace(/:ñpmoar:/g, "<style> .md img { display:inline; } .rageface { visibility:visible; } </style><img class='rageface' src=\'http://thinqtek.com/temp/emotes/ppmoar.png\' /></div>")
			.replace(/:ñpohyoumad:/g, "<style> .md img { display:inline; } .rageface { visibility:visible; } </style><img class='rageface' src=\'http://thinqtek.com/temp/emotes/ppohyoumad.jpg\' /></div>")
			.replace(/:ñprapetime:/g, "<style> .md img { display:inline; } .rageface { visibility:visible; } </style><img class='rageface' src=\'http://thinqtek.com/temp/emotes/pprapetime.jpg\' /></div>")
			.replace(/:ñpstop:/g, "<style> .md img { display:inline; } .rageface { visibility:visible; } </style><img class='rageface' src=\'http://thinqtek.com/temp/emotes/ppstop.jpg\' /></div>")
			.replace(/:ñpthatpostgavemecancer:/g, "<style> .md img { display:inline; } .rageface { visibility:visible; } </style><img class='rageface' src=\'http://thinqtek.com/temp/emotes/ppthatpostgavemecancer.png\' /></div>")
			.replace(/:ñpthefuckisthis:/g, "<style> .md img { display:inline; } .rageface { visibility:visible; } </style><img class='rageface' src=\'http://thinqtek.com/temp/emotes/ppthefuckisthis.png\' /></div>")
			.replace(/:ñpthisismegivingafuck:/g, "<style> .md img { display:inline; } .rageface { visibility:visible; } </style><img class='rageface' src=\'http://thinqtek.com/temp/emotes/ppthisismegivingafuck.png\' /></div>")
			.replace(/:ñpumad:/g, "<style> .md img { display:inline; } .rageface { visibility:visible; } </style><img class='rageface' src=\'http://thinqtek.com/temp/emotes/ppumad.jpg\' /></div>")
			.replace(/:ñpyeahimad:/g, "<style> .md img { display:inline; } .rageface { visibility:visible; } </style><img class='rageface' src=\'http://thinqtek.com/temp/emotes/ppyeahimad.jpg\' /></div>")
			.replace(/:ñrepareyouranus:/g, "<style> .md img { display:inline; } .rageface { visibility:visible; } </style><img class='rageface' src=\'http://thinqtek.com/temp/emotes/prepareyouranus.jpg\' /></div>")
			...
			.replace(/original=\"/g, "src=\"");
				...
				function commonInsert(obj) {
					if(typeof(obj)=="object") {
						...
						replaceByClass('body', obj); //Zimbra
						replaceByClass('ZmChatWindowChat', obj); //Zimbra
						replaceByClass('ZmChatWindowChatEntry ZmChatWindowChatEntryMe', obj); //Zimbra
						replaceByClass('ZmChatWindowChatEntry ZmChatWindowChatEntryThem', obj); //Zimbra
					}
				}
