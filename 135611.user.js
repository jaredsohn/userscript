// ==UserScript==
// @author		kamira(source : Angel Vladov)
// @name        Damages Report Script for nothing
// @namespace   eRepublikBattlesReporter_none
// @version		0.0.2
// @uso:version 0.0.2
// @include		http://*erepublik.com/*/military/battlefield/*
// @description    eRepublik Damage Reporting script for none
// ==/UserScript==
...
if(window.location.href.indexOf(PAGE_BATTLEFIELD) > 0) {	
	...
	/***********************************************************************************/
	var FORM_URL = "https://docs.google.com/spreadsheet/viewform?formkey=dGVyLVhrWHBuVE9iYnJVVWNUaUVYQ1E6MQ#gid=0";
	var FORM_FIELDS = {
                eday: "entry.0.single",
                name: "entry.1.single",
	...
	var LOCALE = {
		en:function() {
			return {
				locale: "en_US",
				no_damage: "不好意思，沒有貢獻的人是不能回報的喔!",
				send_report: "你確定你要回報嗎?",
				button_send: "確定",
				round_end: "這回合結束了，你想要回報嗎?",
				damage: "傷害",
				report: "回報",
				report_title: "寄送回報",
				report_failed: "喔!不!錯誤發生了。 請再試一次看看。"
			};
		}
	};
