// ==UserScript==
// @name           Calculadora Travian
// @namespace      Calculadora Travian
...
for(var i = 0; i < theads.length; i++){
	...
	var tdText = document.createTextNode("Distância: " + dist + " > ");
	var ttc = document.createElement("a");
	var ttcURL = "http://www.menthadesignz.com/Stuff/calculadora/index.html?toursqr=&datetype=date_end";
	...
	var ttcText = document.createTextNode("???? ");
        ttc.style.backgroundImage="url(http://img46.imageshack.us/img46/4958/clockv.gif)" ;
        ttc.style.color="transparent"
        ttc.style.cursor="help"
	...
	showButton.setAttribute("id","newBtn" + i);
        showButton.setAttribute("value","");
	showButton.setAttribute("name",attackURL);
        showButton.style.backgroundImage="url(http://img594.imageshack.us/img594/2752/att.gif)";
        showButton.style.color="transparent"
        showButton.style.border="transparent"
        showButton.style.cursor="help"
...
function post(url, tdId) {
	GM_xmlhttpRequest({
		...
		onload: function(responseDetails) {					
					...
					newTd.innerHTML = newTd.innerHTML + " Jogador: " + user + ", Ally: " + clan;
				}
	});
}
