		...
		GM_xmlhttpRequest({
			...
			onerror: function(response) {
				...
				var orders = '<br/><div id="mon_orders_error" style="text-align: center" />Erro ao carregar planilha de ordens <br />'+
							'<a target="_blank" href="http://goo.gl/kFUUz">Verificar atualizações do script</a></div><br/>';		
				$('#battle_listing').prepend(orders);
			}
		});
	}
...
function footer() {
	...
	$('#mon_orders').append('<a target="_blank" href="http://goo.gl/zmeXu"><img src="'+ footer + '" style="margin-top:0;"/></a><br/>');
