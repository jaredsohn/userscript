...
// @description		The West : Raccourcis [SOM] - (multilingue) (version 1.32a)
// @author		Gzahab
// @author              Danosaure
...
if (url.indexOf(".the-west.") != -1 && url.indexOf("game.php") != -1) {
	...
	var MENU_icone_fort_barracks	= "images/hotel_stars/star5.png";
	...
	function programme_principal() 
	{
		...
		if (footer_menu_left)
		{
			...
			if(Character.home_town != null)
			{
				...
				//Barracks
				var world = window.location.href.substring(7,11);
				var idf = 1;
				switch (world){
				case 'w1.p':
					idf = 62;
				...
				ajoute_icone("javascript:javascript:AjaxWindow.show('fort_building_barracks',{fort_id:" + idf + "},'" + idf + "');",
					"icone_fort_barracks",
					MENU_icone_fort_barracks) ;
				ajout_commentaire_icone("icone_fort_barracks", ALT_commentaires["fort_building_barracks"]);
			}
			else
			{
				//
