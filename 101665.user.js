...
//drag smoothing by Eike and Spockholm
	...
	loadContent('http://www.google-analytics.com/ga.js');
	try {
		var pageTracker = _gat._getTracker("UA-20419663-2");
		pageTracker._trackPageview("/wizard/Scripts/One"); 
	} catch(err) {}
})()