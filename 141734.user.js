...
Userscripts.org
    ...
    People
    Blog
Lorenzo's Flash Games (code By: W35l3y)
...
function init (doc) {	// script scope
	...
	// + avatar games
		...
		"1347": [20000, 2134, 49, 1, "a53.gif", "A53 - LIKE A BOSS"],
	},
	...
	if (!doc.error && !doc.link && !isNaN(id) && (id in games || GM_getValue("generic", false)) && (!doc.shockwave || GM_getValue("scoresender", false))) {
		...
		copy = {
			"gr-ctp-settings-btn" : {
				...
				execute : function (node, p) {
					if (!p) {
						...
						GM_addStyle((<><![CDATA[
						#gr-ctp-avatar-btn {
						  background: url("http://i48.tinypic.com/u93ls.png") no-repeat scroll 0 0 transparent;
						  bottom: 0px;
						  height: 30px;
						  right: inherit;
						  position: relative;
			...
			"gr-ctp-settings" : {
				...
				<div id="gr-ctp-avatar" class="popup">
						...
						<table>
							...
							<tr>
								<td colspan="5" align="center">
									<a href="#" id="ctp-settings-save"><img src="http://images.neopets.com/games/pages/popups/buttons/use-these-settings.png" alt="Use These Settings" /></a>
								</td>
							</tr>
						</table>
					</form>
		...
		if (!doc.shockwave && !~ss.indexOf(id)) {
