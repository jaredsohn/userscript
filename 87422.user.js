// ==UserScript==
// @name           HDC Moderacao
// @namespace      editado por EvertonxD | uid=8363754007393508974
// @description    Script para facilitar o trabalho da moderacao HDC
// @HDC          www.orkut.com.br/Main#Community?cmm=1595661
...
/*
+---------------------------------------------------------------------+
| 		Visite a comunidade HDC no orkut 	              |
|		http://www.orkut.com.br/Community?cmm=1595661	      |
|	
|     este script foi criado por josep,e editado por EvertonxD	      |
|						                      |
+---------------------------------------------------------------------+
*/

Editado_por = "EvertonxDl";
...
var colocaNaPagina = function() {
	...
	function online() {
		...
		var texto = String("[b]quase [green]VIVO![/green][/b]").concat("\n\n[silver]", String(Math.random()), "[/silver]");
		var envia = {
			"POST_TOKEN": JSHDF["CGI.POST_TOKEN"],
			"signature": encodeURIComponent(JSHDF["Page.signature.raw"]),
	...
	function offline() {
		...
		var texto = String("[b]Vazei tô [red]MORTO![/red][/b]").concat("\n\n[silver]", String(Math.random()), "[/silver]");
		var envia = {
			"POST_TOKEN": JSHDF["CGI.POST_TOKEN"],
			"signature": encodeURIComponent(JSHDF["Page.signature.raw"]),
			"subjectText": encodeURIComponent(""),
