...
// ==UserScript==
// @name           איקרים אזעקת אמת - דוקטור צחוק
// @description    מזהיר אותך כאשר אחד היועצים צהוב - ומעיר אותך כאשר היועץ הצבאי מדמם - This script alerts you with custom sounds if something changed from the last view of ikariam
...
var sa_SoundNotify 	= 'http://gigel.atspace.com/resources/warning.wav';
var sa_SoundWarning = 'http://gigel.atspace.com/resources/alarm.wav';
var sa_SoundAlert 	= 'http://gigel.atspace.com/resources/alarm.wav';
var sa_RandStart = 2; // random value start from X minutes
