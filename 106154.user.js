...
// @require 	   http://sizzlemctwizzle.com/updater.php?id=104135
// ==/UserScript==

var Version = '0.2.3';
var miseajour="Version "+Version +" by BeWorld 2011";
...
var TowerAlerts = {
  ...
  postToChat: function(f, c, force){
    ...
    var mess = "Depechez vous car je suis pas patiente mon chargeur marche pas et mon alerte non plus alors bougez vous le cul ou ca va peter " + a +" par " + " " +attaquant + " " + msg;
   ...
   var ModelCity = {};
    ...
    if (t.state == null) {  
      ...
      m += "<TABLE width=100% class=ptTab border=0 cellpadding=3>\
       ...
       <tr align=center><td colspan=1>Unit&eacute : <select id=typetrp><option selected value='1'>"+unsafeWindow.arStrings.unitName["u1"]+"</option><option selected value='9'>"+unsafeWindow.arStrings.unitName["u9"]+"</option></select>\
...
<TABLE CLASS="MYTABLE" CELLPADDING=3 CELLSPACING=0 align=center>\
    <CAPTION CLASS="MYTABLE"><center><b>Les armoiries n&eacute;cessaires pour les cit&eacute;s</CAPTION>\
    \
    <THEAD >\
      <TR CLASS="MYTABLE">\
    ...
    if (t.state == null){
     ...
     var m = '<DIV class=ptentry><TABLE width=100% cellpadding=0>\
            ...
            <TR><TD class=xtab>OU </td><TD class=xtab>Nom alliance (Contient) : &nbsp;</td>\
             <TD class=xtab><INPUT id=allAllName type=text /> &nbsp; <INPUT id=allSubmit DISABLED type=submit value="Cherche Alliance" /></td>\
   ...
   eventGotPlayerOnlineList : function (rslt){
      ...
      for (k in t.playerList){
        ...
        m += '<TR '+ cl +'valign=top><TD>'+ u.genderAndName +'<br>'+alliancenammme+'<br><A target="_tab" href="http://www.facebook.com/profile.php?id='+ u.fbuid +'">profile</a></td><TD align=center>&nbsp;'+ addCommasInt(u.might) +'&nbsp;</td>\
           ...
           <TD><SPAN onclick="PTpd(this, '+ u.userId +')"><A>D&eacute;tails</a></span><br><SPAN onclick="PCplo(this, \''+ u.userId +'\')"><A>Derniere connexion</a></span></td></tr>';
      }
      m += '</table></div>';
