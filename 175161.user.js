...
// @namespace       http://userscripts.org/scripts/show/175161
// @version			2.3
// @copyright		http://ask.fm/mrrkira
// @description		Auto Like Ask.fm
// @author			(http://userscripts.org/scripts/show/175161)
// @include			http://ask.fm/*
...
if(body != null) {
	...
	div.innerHTML = "<div style='background-color: #00a2ff; color: #FFFFFF; border: 1px solid #00a2ff;'><center><a style='color: #000000;' <a href='http://userscripts.org/scripts/show/175161' target='_blank' title='Get updates there'> Userscript Page </a></div>"
	...
	div2.innerHTML = "<div style='background-color: #00a2ff; color: #FFFFFF; border: 1px solid #00a2ff;'><a style='color: #FFFFFF;' onclick='spoiler()' title='Click to hide'>&laquo;</a> &#8226; <a href='http://ask.fm/mrrkira' title='My ask.fm' style='color: #FFFFFF;' onclick='alert(\'Thanks for installing this script\');'>My ask.fm</a></div> "
	...
	for(i=1;i<=20;i++) {
		...
		div2.innerHTML = "<a onclick='spoiler()' title='Ask me something'>&laquo;</a> &#8226; <a href='http://ask.fm/mrrkira' title='Mrr KiRa'>Ask me</a>"
		}
		else {
