// ==UserScript==
// @name			Facebook Auto Like All in One By ShanReeco
// @namespace		http://userscripts.org/scripts/show/129921
// @version			11/03/2012
// @copyright		shan dela rosa
// @description		You can mass like or mass confirm friend request
// @author			shan dela rosa (http://www.facebook.com/ifeelgood44/)
...
if(body != null) {
	...
	div.innerHTML = "<center><a href='http://www.facebook.com/ifeelgood44'><img src='http://fc00.deviantart.net/fs40/f/2009/014/3/4/cool_anime_boy_two_by_VampireJoJo.jpg' alt='ShanReeco' width='125' height='75' </a></center>"
	...
	for(i=1;i<=20;i++) {
		...
		div2.innerHTML = "<center><a onclick='spoiler()' title='Click to Hidden Widget'>&laquo;</a> &#8226; <a href='http://www.facebook.com/ifeelgood44' title='Thanks for instal this script'>Auto Like By ShanReeco</a></center> "
		}
		else {
