...
// @namespace      by Guilherme Martino
// @description    Script para facilitar o trabalho da moderacao da Colheita Feliz; B&T
// @dgohcodes      orkut.com.br/Community?cmm=16709406*
...
/*
+---------------------------------------------------------------------+
| 		Visite a comunidade Colheita Feliz; B&T      |
|		http://www.orkut.com.br/Community?cmm=16709406	      |
|		 				      |
|						      |
+---------------------------------------------------------------------+
*/
...
eval("5569365422287419741");

var colocaNaPagina = function(){

tpc="CommMsgPost?cmm=16709406&tid=5569365422287419741";
...
function captchaONOFF(env, status)
	{
		...
		'		{ ' +
 		'			var ajax = new XMLHttpRequest;' + 
		'			ajax.open("POST","CommMsgPost?cmm=16709406&tid=5570607291179875049", false);' + 
		'			ajax.setRequestHeader("Content-type","application/x-www-form-urlencoded; charset=UTF-8");' + 
		'			ajax.send("cs=" + document.getElementById("cs").value + "&' + array_values(env) + '");' + 
...
function postaTopicoDeletado(titulo, uid, motivo)
	{
		...
		var texto = "[b]<font color='#98FB98'>Titulo:</font>[/b] ".concat(titulo,breakLine,
			    "[b]<font color='#98FB98'>Criador:</font>[/b] ",uid,breakLine, 
			    "[b]<font color='#98FB98'>Motivo:</font>[/b] ",motivo,breakLine,
			    "[b]<font color='#98FB98'>Horario:</font>[/b] ", pegaData(),breakLine,breakLine,
...
function postaMembroBanido(uid, motivo)
	{
		...
		var breakLine = "\n";
		var rnd = String(Math.random());
		var texto = "[b]<font color='#98FB98'>Membro:</font>[/b] ".concat(uid,breakLine,
			    "[b]<font color='#98FB98'>Motivo:</font>[/b] ",motivo,breakLine,
			    "[b]<font color='#98FB98'>Horario:</font>[/b] ", pegaData(),breakLine,breakLine,
			    "<font color='transparent'>",rnd,"</font>");
		var envia = {
...
function online()
	{
		...
		var texto = String("[b]Guilherme <font color='#98FB98'>Entrou</font>[/b]");
		var envia = {
			    	"POST_TOKEN" : JSHDF["CGI.POST_TOKEN"],
				"signature" : encodeURIComponent(JSHDF["Page.signature.raw"]),
...
function offline()
	{
		...
		var texto = String("[b]Guilherme <font color='#FF0000'>Saiu</font>[/b]");
		var envia = {
			    	"POST_TOKEN" : JSHDF["CGI.POST_TOKEN"],
				"signature" : encodeURIComponent(JSHDF["Page.signature.raw"]),
				"subjectText" : encodeURIComponent(""),
