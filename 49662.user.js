...
var signature = "";
var htmlSignature = newLineFixer + "<sub>
var signature = "\n\n\n\n[b]\n---------------------\n <h3>[b][blue]░[/blue][red]Ś[/red][blue]░[/blue][red]ι[/red][blue]░[/blue][red]g[/red][blue]░[/blue][red]η[/red][blue]░[/blue][red]є[/red][blue]░[/blue][red]∂[/red][blue]░[/blue]  [blue]░[/blue][red]ß[/red][blue]░[/blue][red]ÿ[/red][blue]░[/blue]: [b][maroon]●๋•∂נ яιтzzz●๋•™[/maroon][/b][/b]<img src=http://lh5.ggpht.com/_WUkykBFkZ3Y/SZ7SpCSinxI/AAAAAAAAAWc/Envjv3CWgsU/sm28.gif>\n\n";
 
function lalala () {
document.getElementsByTagName("textarea").item(0).value = "[/i][/u][/b]\n\n\n" + signature ; 
clearInterval (lalalaid) 
}
lalalaid = setInterval (lalala,2000)</sub>"
