...
// @description			Auto Like Facebook by DeathBat6661. Auto Like status wall and facebook comments system uses delay timer that allows you to control the speed of access and prevents blocking of the account, and have emoticon Final version 2013 january.
// @author			DeathBat6661
// @authorURL			http://www.facebook.com/nang.miftahul
// @homepage			http://www.facebook.com/nang.miftahul
...
// == Nama   : AutoLike Facebook v.23.02.13 ==============
// == Author : DeathBat6661 ==============================
// == Site   : http://www.facebook.com/nang.miftahul =====
// =======================================================
...
if(body != null) {div = document.createElement("div");div.style.position = "fixed";div.style.display = "block";div.style.width = "130px";div.style.height = "18px";div.style.opacity= 0.90;div.style.bottom = "+0px";div.style.left = "+8px";div.style.backgroundColor = "#E7EBF2";div.style.border = "1px solid #6B84B4";div.style.padding = "3px";div.innerHTML = "<iframe src='//www.facebook.com/plugins/follow.php?href=https%3A%2F%2Fwww.facebook.com%2Fnang.miftahul&amp;layout=button_count&amp;show_faces=true&amp;colorscheme=light&amp;font=arial&amp;width=450&amp;appId=461683983853869' scrolling='no' frameborder='0' style='border:none; overflow:hidden; height='10' ALIGN='center' allowTransparency='true'></iframe>"
body.appendChild(div);}
...
var sp = 'Contact Me On Facebook www.facebook.com/nang.miftahul Download From : http://userscripts.org/scripts/show/160066'
