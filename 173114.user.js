// ==UserScript==
// @name           MERC Tools RUS
// @description    Добавляет некоторый функционал в LoU
// @namespace      Maddock
...
* 4.0 rus- Fix for support only russian lang
* 4.1 rus Исправлен подсчет магов на подземельях. Еще маленько руссифицировал.
* 4.2 rus Исправлена загрузка изображений
*/
(function () {
    var main = function () {
        ...
        function LoUPakMap() {
            try {
                ...
                //<table cellspacing="0"><tr><td width="75">Name:</td><td>Dragon</td></tr><tr><td>Since:</td><td>Yesterday 22:04:43</td></tr><tr><td>Level:</td><td>7</td></tr>
                //<table cellspacing="0"><tr><td width="75">Type:</td><td>Подземелье в лесу</td></tr><tr><td>Since:</td><td>31.07. 01:15:18</td></tr><tr><td>Level:</td><td>9</td></tr><tr><td>Progress:</td><td>94%</td></tr>
                
                var sHdr = '<table cellspacing="0"><tr><td width="75">';
                var sRow = "</td><td>";
                var pId = sHdr.length;
                var pRow = sRow.length;
                var weakT = 'Уязвимость:' + sRow;
                var progressT = 'СВ+прогресс' + sRow;
                var zergT = 'Мин СВ:' + sRow;
                ...
                // "Name" or "Type", Boss or Dungeon если Имя, то босс, если тип, то данж
                // Desc offset
                ...
                //название подземелий
                var forstC = r.dungeons["5"].dn;
                var mountC = r.dungeons["4"].dn;
                var hillC = r.dungeons["3"].dn;
                var seaC = r.dungeons["2"].dn;
                
                //получить уязвимость по названию Босса
                ...
                //получить уязвимость по названию подземелия
                function getDungeonWeakness(nameDungeon) {
                    
                    //paDebug(nameDungeon);
                    //return "ha-ha-ha";
                    
                    if (nameDungeon.indexOf(forstC) >= 0)
                        return cavT;
                    else if (nameDungeon.indexOf(mountC) >= 0)
                        return infT;
                    else if (nameDungeon.indexOf(hillC) >= 0)
                        return magT;
                    else if (nameDungeon.indexOf(seaC) >= 0)
                        return artT;
                    else
                        return "";
                ...
                // всплывающее окно на боссе или данже
                        ...
                        if (mode == 'c' || mode == 'd') {
                            ...
                            if (text != null || text.length > pId) {
                                ...
                                if (type == nameC) { // Name:
                                    ...
                                    var zergs777 = webfrontend.gui.Util.formatNumbers(parseInt((bossKill[ parseInt(level) - 1] / bonus7) * 0.72));
                                    if (weak == "Magic")
                                        zergs777 = webfrontend.gui.Util.formatNumbers(parseInt((bossKill[ parseInt(level) - 1] / bonus7) * 0.67 * 0.72));
                                    ...
                                    if (weak == "Artillery") {
                                        ...
                                        sb.add(text, sHdr, weakT, weak, "</td></tr><tr><td>", zergT6, zergs6, "</td></tr></td></tr><tr><td>", zergT10, zergs10, "</td></tr></td></tr><tr><td>", zergT11, zergs11, "</td></tr><tr><td>", zergT7, zergs777, "</td></tr><tr><td>", zergT12, zergs12, "</td></tr></table>");
                                    }
                                    tip.setLabel(sb.get());
                                    ...
                                    var tttt = text.substr(pDName, 30);
                                    var weak = getDungeonWeakness(tttt); //getDungeonWeakness(text.charAt(pDName));
                                    ...
                                    var progress = text.substr(text.indexOf(progressP) + 18, 2);
        ...
        var createTweak = function () {
            ...
            qx.Class.define("paTweak.Version", {
                ...
                statics:{
                    PAversion:"4.1 rus",
                    PAbuild:"21 марта 2013",
                    PAcodename:"",
                    PAauthors:"Michal Dvořák (Mikee)",
                    PAcontrib:"William Leemans (Maddock), MousePak, Uldrich and WatchmanCole, руссифицировал maxim2000",
            ...
            */
                ...
                members:{
                    ...
                    tweakPA:function () {
                        ...
                        try {
                            ...
                            var assaultButton = new qx.ui.form.Button("Атаковать");
                            assaultButton.orderId = this.ATTACK_ORDER_ID;
                            assaultButton.setToolTipText("Атаковать город всеми доступными войсками");
                            assaultButton.addListener("execute", this.sendTroops, this);
                            
                            var plunderButton = new qx.ui.form.Button("Грабеж");
                            plunderButton.orderId = this.PLUNDER_ORDER_ID;
                            plunderButton.setToolTipText("Ограбить город всеми доступными войсками");
                            plunderButton.addListener("execute", this.sendTroops, this);
                            
                            var siegeButton = new qx.ui.form.Button("Осада");
                            siegeButton.orderId = this.SIEGE_ORDER_ID;
                            siegeButton.setToolTipText("Осадить город всеми доступными войсками");
                            siegeButton.addListener("execute", this.sendTroops, this);
                            
                            var supportButton = new qx.ui.form.Button("Поддержать");
                            supportButton.orderId = this.SUPPORT_ORDER_ID;
                            supportButton.setToolTipText("Поддержать город всеми доступными войсками");
                    ...
                    */
                        ...
                        try {
                            ...
                            if (errorCode.r0 != 0) {
                                if (cityStatusText) 
                                {
                                    ...
                                    cityStatusText.setValue("Войска НЕ посланы");
                                    window.setTimeout(clearCityStatusText, 2000);
                                }
                                window.console.debug("Войска НЕ посланы");
                            }
                            else
                            {
                                if (cityStatusText) 
                                {
                                    ...
                                    cityStatusText.setMaxHeight(20);
                                    cityStatusRow.setVisibility("visible");
                                    cityStatusText.setValue("Войска посланы");
                                    window.setTimeout(clearCityStatusText, 2000);
                                }
                            }
                    ...
                    createRaidApplyToAll: function () {
                        ...
                        orderPage.applyAllBtn = new webfrontend.ui.SoundButton("Применить ко всем");
                        orderPage.applyAllThisDungeonBtn = new webfrontend.ui.SoundButton("Применить ко всем подземельям");
            ...
            function checkFortune()
            {
                ...
                if (dif < 0)
                {
                    ...
                    fortuneAvailImg.setToolTipText("Гадалка готова к работе.");
                    fortuneAvailImg.setSource(fortuneAvailImg.getSource().replace("red", "green"));
                }
                else
                {
                    fortuneAvailImg.setToolTipText("Гадалка будет в " + remainingTime + " @ " + nfTime);
            ...
            qx.Class.define("paTweak.ui.IncomingAttacksWindow", {
                ...
                construct:function () {
                    this.base(arguments, 'Атаки на Альянс');
                    this.buildUI();
                ...
                members:{
                    ...
                    buildUI:function () {
                        ...
                        var page1 = new qx.ui.tabview.Page("Таблица", "");
                        ...
                        this._filterOwn = new qx.ui.form.CheckBox("Мои города");
                        this._filterOwn.setToolTipText("Показать только мои города");
                        ...
                        this._subText.set({toolTipText:"Сообщить мне, если есть атаки на одного из этого списка. (ники через запятую)"});
                        ...
                        page1.add(table);
                        tabView.add(page1);
                        var page2 = new qx.ui.tabview.Page("Экспорт атак", "");
                        ...
                        for( i = 0; i < children.length; i++ )
                        {
                            if( children[i] instanceof qx.ui.core.Spacer )
                            {
                                ...
                                if(fm.hasOwnProperty("r")&&fm.r!=null && fm.hasOwnProperty("a")&&fm.a!=null)
                                {
                                    ...
                                    var rrHeader = new qx.ui.basic.Label( "Итог похода:" );
            ...
            qx.Class.define("paTweak.ui.RaidingWindow", {
                ...
                members:{
                    ...
                    addDungeonToRaid: function( d )
                    {
                        if(webfrontend.res.Main.getInstance().dungeons[d.get_Type()].b == 0)
                        {
                            ...
                            if( !found )
                            {
                                ...
                                btn = new qx.ui.form.Button("+").set( {paddingLeft: 6, paddingRight: 6, paddingTop: 0, paddingBottom: 0} );
                    ...
                    createIdleUnitsPage: function()
                    {
                        ...
                        this.autoUpdate = new qx.ui.form.CheckBox("Обновлять").set( {marginLeft:20} );;
                        this.autoUpdate.setToolTipText("Если выключено, то обновляйте кнопкой<br/>Может привести к мерцанию экрана.");
                        ...
                        this.excludeShips = new qx.ui.form.CheckBox("Без кораблей").set( {marginLeft:5} );;
                        this.excludeShips.setToolTipText("Список без кораблей, если включено.");
                        ...
                        this.excludeTs.set({toolTipText:"Исключить города с СВ меньше указанного."});
                        var app = qx.core.Init.getApplication();
                        ...
                        var excludeLabel = new qx.ui.basic.Label().set( {alignY:"middle",marginRight:4,marginLeft:4} );
                        excludeLabel.setValue("Исключить");
                        container.add(excludeLabel);
                        
                        value = localStorage.getItem("mt__excludeIdleRefs");
                        this.excludeIf = new qx.ui.form.TextField();
                        this.excludeIf.set({toolTipText:"Исключить города, в характеристике которых написано. (comma separated list)"});
                    ...
                    {
                        var bossPage = new qx.ui.tabview.Page( "Боссопоходы" );
                        bossPage.setLayout(new qx.ui.layout.VBox(2));
                        
                        var container = new qx.ui.container.Composite();
                        container.setLayout( new qx.ui.layout.HBox );
                        
                        var btn = new qx.ui.form.Button( "Мир" );
                        btn.addListener( "click", function() 
                                        {
                        ...
                        btn = new qx.ui.form.Button( "Поиск Боссов" );
                        ...
                        var columnNames = ["Тип", "Уровень", "Коры", "Раст", "Трава", "Войска" ];
                    ...
                    {
                        var dungeonPage = new qx.ui.tabview.Page( "Подземелья" );
                        ...
                        layoutContainer.add( new qx.ui.basic.Label("Цели") );
                        
                        var container = new qx.ui.container.Composite();
                        container.setLayout( new qx.ui.layout.Basic );
                        container.add( new qx.ui.basic.Label("Тип").set({alignY:"middle"}),    {top: 0, left: 80} );
                        container.add( new qx.ui.basic.Label("Прогресс").set({alignY:"middle"}),    {top: 0, left: 130} );
                        container.add( new qx.ui.basic.Label("Коры").set({alignY:"middle"}),    {top: 0, left: 180} );
                        container.add( new qx.ui.basic.Label("Раст").set({alignY:"middle"}),    {top: 0, left: 230} );
                        container.add( new qx.ui.basic.Label("Макс").set({alignY:"middle"}),   {top: 0, left: 280} );
                        container.add( new qx.ui.basic.Label("Сред").set({alignY:"middle"}),   {top: 0, left: 330} );
                        var sel = new qx.ui.form.SelectBox().set( {width:77,alignY:"middle",paddingLeft:4,paddingRight:4,paddingTop:0,paddingBottom:0} );
                        sel.add( new qx.ui.form.ListItem( "Макс+90%" ) );
                        sel.add( new qx.ui.form.ListItem( "Макс+60%" ) );
                        sel.add( new qx.ui.form.ListItem( "Макс+30%" ) );
                        sel.add( new qx.ui.form.ListItem( "Макс+20%" ) );
                        sel.add( new qx.ui.form.ListItem( "Макс+15%" ) );
                        sel.add( new qx.ui.form.ListItem( "Макс" ) );
                        ...
                        subContainer.add( new qx.ui.basic.Label( "Доступные войска" ).set( {alignY:"middle"} ) );
                        
                        this.split = new qx.ui.form.CheckBox("Разделить").set( {marginLeft:20} );;
                        this.split.setToolTipText("Если указано, добавлет несколько групп, в пределах уровня.");
                        this.split.initValue(false);
                        subContainer.add(this.split);
                        subContainer.add( new qx.ui.core.Spacer(), {flex:1} );
                        
                        subContainer.add( new qx.ui.basic.Label( "Тип отношения:" ).set( {alignY:"middle"} ) );
                        sel = new qx.ui.form.SelectBox().set( {width:80,alignY:"middle"} );
                        sel.add( new qx.ui.form.ListItem( "Доступные" ) );
                        sel.add( new qx.ui.form.ListItem( "Все" ) );
                        sel.add( new qx.ui.form.ListItem( "не указано" ) );
                        ...
                        sel.addListener( "changeSelection", function(e) {
                            var readOnly = false;
                            if( e.getData()[0].getLabel() == "Доступные" )
                                this.rw.ratioMode = "count";
                            else if( e.getData()[0].getLabel() == "Все" )
                        ...
                        sel.add( new qx.ui.form.ListItem( "Прибытие", null, webfrontend.gui.SendArmyWindow.timings.arrive ) );
                        sel.add( new qx.ui.form.ListItem( "Отправление", null, webfrontend.gui.SendArmyWindow.timings.depart ) );
                        sel.add( new qx.ui.form.ListItem( "Сейчас", null, webfrontend.gui.SendArmyWindow.timings.now ) );
                        sel.setSelection( [sel.getChildren()[2]] );
                        sel.rw = this;
                        sel.addListener( "changeSelection", function(e) {
                            var ch = this.getLayoutParent().getChildren();
                            var vis = "visible";
                            if( e.getData()[0].getLabel() == "Сейчас" )
                                vis = "hidden";
                            for( var i = 1; i <= 6; i++ )
                        ...
                        sel.add( new qx.ui.form.ListItem( "7 дней" ,null,7) );
                        sel.add( new qx.ui.form.ListItem( "6 дней" ,null,6) );
                        sel.add( new qx.ui.form.ListItem( "5 дней" ,null,5) );
                        sel.add( new qx.ui.form.ListItem( "4 дня" ,null,4) );
                        sel.add( new qx.ui.form.ListItem( "3 дня" ,null,3) );
                        sel.add( new qx.ui.form.ListItem( "2 дня" ,null,2) );
                        sel.add( new qx.ui.form.ListItem( "Завтра" ,null,1) );
                        sel.add( new qx.ui.form.ListItem( "Сегодня" ,null,0) );
                        ...
                        btn = new qx.ui.form.Button("Отправить").set( { paddingLeft: 8, paddingRight: 8, paddingTop: 2, paddingBottom: 2, alignY:"center", enabled:false} );
                        btn.rw = this;
                        ...
                        sel.add( new qx.ui.form.ListItem( "1 раз",null,webfrontend.gui.SendArmyWindow.timings.once-webfrontend.gui.SendArmyWindow.timings.once ) );
                        sel.add( new qx.ui.form.ListItem( "Возвращение",null,webfrontend.gui.SendArmyWindow.timings.latest-webfrontend.gui.SendArmyWindow.timings.once ) );
                        sel.add( new qx.ui.form.ListItem( "Пройден",null,webfrontend.gui.SendArmyWindow.timings.completed-webfrontend.gui.SendArmyWindow.timings.once ) );
                        sel.setSelection( [sel.getChildren()[2]] );
                        sel.addListener( "changeSelection", function(e) {
                            var ch = this.getLayoutParent().getChildren();
                            var vis = "hidden";
                            if( e.getData()[0].getLabel() == "Возвращение" )
                                vis = "visible";
                            for( var i = 1; i <= 6; i++ )
                                ch[i].setVisibility( vis );
                        });
                    ...
                    onAddRaidButton: function( addButton )
                    {
                        ...
                        if( this.ratioMode != "none" )
                        {
                            ...
                            else if (atype == "Макс+60%")
                            {
                                mul = 1.6;
                            }
                            else if( atype == "Макс+30%" )
                            {
                                mul = 1.3;
                            }
                            else if( atype == "Макс+20%" )
                            {
                                mul = 1.2;
                            }
                            else if( atype == "Макс+15%" )
                            {
                                mul = 1.15;
                            }
                            else if( atype == "Макс" )
                    ...
                    */
                    ...
                    onRaidSent: function( comm, result, v )
                    {
                        ...
                        else
                        {
                            switch( result.r0 )
                            {
                                    ...
                                    */
                                case 0:
                                    logEntry = "Войска отправлены.";
                                    break;
                                case (1<<2):
                                    logEntry = "Недостаточно войск.";
                                    break;
                                case (1<<6):
                                    logEntry = "Нет свободных команд.";
                                    break;
                                case (1<<22):
                                    logEntry = "Повторите приказ позже.";
                                    break;
                                default:
                                    logEntry = "Что-то пошло не так: " + result;
                                    break;
                            }
                    ...
                    updateAvailableUnits : function()
                    {
                        ...
                        if( uk.length == 0 )
                        {
                            var lbl = new qx.ui.basic.Label( "Нет доступных войск" );
                            lbl.setRich( true );
            ...
            qx.Class.define("paTweak.ui.PalaceItemsWindow", {
                ...
                extend:qx.ui.window.Window,
                construct:function () {
                    this.base(arguments, 'Дворцовые арты');
                    this.buildUI();
                ...
                members:{
                    ...
                    buildUI:function () {
                        ...
                        var wcLabel = new qx.ui.basic.Label("Выберите город, затем арт для использования");
                        ...
                        // Close button
                        var closeButton = new qx.ui.form.Button("Закрыть");
                    ...
                    fillItemRow:function()
                    {
                        ...
                        for (var ii = 178; ii < 188; ++ii)
                        {
                            ...
                            if (i.hasItem(ii) && itemUseable)
                            {
                                ...
                                itemImg.set({padding:5,toolTipText:"Вы владеете " + String(num) + " артифактом(ами) <br/>" + bS.items[ii].dn + "<br/>" + bS.items[ii].sds });
                                itemImg.setWidth(40);
                        ...
                        if (itemCount == 0)
                        {
                            this.palaceItemMessageLabel.setValue("Нет доступных дворцовых артов.");
                        }
                        /*
                        178 - Valorite Arch
                        179 - Verite Arch
                    ...
                    useItem:function (e) 
                    {
                        ...
                        {
                            this.palaceItemMessageLabel.setValue("Выберите просвященный город!");
                            return;
                        }
                        if (selectedCity.get_AllianceName().iCompare(myAllianceName))
                        {
                            this.palaceItemMessageLabel.setValue("Просвященный город должен входить в " + myAllianceName);
                            return;
                        }
                        var i = webfrontend.data.Inventory.getInstance();
                        if (!i.hasItem(itemId))
                        {
                            this.palaceItemMessageLabel.setValue("Вы не владеете выбранный артом.(и как он сюда попал?)");
                            return;
                        }
                        
                        var bS = webfrontend.res.Main.getInstance();
                        var coords = selectedCity.get_Coordinates();
                        this.palaceItemMessageLabel.setValue("Ждите, используется 1 " + bS.items[itemId].dn);
                        var commandManager = webfrontend.net.CommandManager.getInstance();
            ...
            qx.Class.define("paTweak.ui.AllianceMailingListWindow", {
                ...
                construct:function (cityAllianceName, cityAllianceID) {
                    this.base(arguments, 'Списки рассылки');
                    this.buildUI();
                ...
                members:{
                    ...
                    buildUI:function () {
                        ...
                        var wcLabel = new qx.ui.basic.Label("Список рассылки по альянсу").set({font:"bold"});
                        this.add(wcLabel);
                        
                        this._wcText = new qx.ui.form.TextArea();
                        this._wcText.set({readOnly:true, allowGrowY:false, autoSize:false, tabIndex:303, height:280});
                        app.setElementModalInput(this._wcText);
                        this._wcText.setValue("Загрузка...");
                    ...
                    gotPlayerInfo:function (ok, response) 
                    {
                        ...
                        if (ok)
                        {
                            ...
                            if (this._count == 0)
                            {
                                ...
                                {
                                    this._wcText.setValue(this._wcText.getValue() + "Континент " + this._continents[ii] +"\r\n" + this._lists[this._continents[ii]] + "\r\n\r\n");
                                }
                            }
                        }
                    }
            ...
            qx.Class.define("paTweak.ui.ReturnByWindow", {
                ...
                extend:qx.ui.window.Window,
                construct:function () {
                    this.base(arguments, 'Возвратить рейды в');
                    this.buildUI();
                ...
                members:{
                    ...
                    buildUI:function () {
                        ...
                        var wcLabel = new qx.ui.basic.Label("Возвратить все рейды в:").set({font:"bold"});
                        this.add(wcLabel);
                        
                        this._returnTime = new paTweak.ui.components.TimePicker("Время:");
                        ...
                        // Apply button
                        var applyButton = new qx.ui.form.Button("Применить");
            ...
            qx.Class.define("paTweak.ui.PlayerReportsWindow",
                            {
                                ...
                                extend: qx.ui.window.Window,
                                construct: function () {
                                    this.base(arguments, 'Отчеты Разведки');
                                    this.buildUI();
                                },
                                members:
                                {
                                    ...
                                    buildUI: function () {
                                        ...
                                        var wcLabel = new qx.ui.basic.Label("Отчеты Разведки").set({ font: "bold" });
                                        this.add(wcLabel);
            ...
            qx.Class.define("paTweak.ui.components.LeftPanel", {
                ...
                members:{
                    ...
                    buildPanelUI:function (labelText) {
                        ...
                        var background = new qx.ui.basic.Image('http://eaassets-a.akamaihd.net/lougame/cdn/406071/resource/webfrontend/ui/menues/main_menu/bgr_subheader_citinfo_scaler.png');
                        background.set({width:338, scale:true, allowGrowY:true});
                        this.add(background, {left:0, top:27, bottom:34});
                        
                        background = new qx.ui.basic.Image('http://eaassets-a.akamaihd.net/lougame/cdn/406071/resource/webfrontend/ui/menues/main_menu/bgr_subheader_citinfo_end.png');
                        background.set({width:338, height:35});
                        this.add(background, {left:0, bottom:0});
                        
                        background = new qx.ui.basic.Image("http://eaassets-a.akamaihd.net/lougame/cdn/406071/resource/webfrontend/ui/menues/main_menu/bgr_subheader_citinfo_wide.png");
                        ...
                        this.closeMercToolsBtn.set({width: 20, appearance: "button-text-small", toolTipText: "Скрыть Merc Tools"});
                        ...
                        this.aboutMercToolsBtn.set({appearance: "button-text-small", toolTipText: "О Merc Tools"});
                        ...
                        this.showIncomingAttacksBtn.set({visibility: "hidden", width: 20, appearance: "button-text-small", toolTipText: "Входящие атаки"});
                        ...
                        this.showCombatButtonBtn.set({visibility: "hidden", width: 20, appearance: "button-text-small", toolTipText: "Комбат"});
                        ...
                        this.showRaidButtonBtn.set({visibility: "hidden", width: 20, appearance: "button-text-small", toolTipText: "Походы"});
                        ...
                        this.showReportsBtn.set({visibility: "hidden", width: 20, appearance: "button-text-small", toolTipText: "Отчеты разведки"});
                        ...
                        this.showMailingListBtn.set({visibility: "hidden", width: 20, appearance: "button-text-small", toolTipText: "Списки рассылки"});
                        ...
                        */
                        ...
                        this.showPalaceItemsBtn.set({visibility: "hidden", width: 20, appearance: "button-text-small", toolTipText: "Дворцовые арты"});
                    ...
                    toggleMercTools:function () {
                        ...
                        if (!this.content.getVisibility().iCompare("visible"))
                        {
                            ...
                            this.closeMercToolsBtn.setToolTipText("Показать Merc Tools");
                        ...
                        else
                        {
                            ...
                            this.closeMercToolsBtn.setToolTipText("Скрыть Merc Tools");
                        }
            ...
            qx.Class.define("paTweak.ui.components.TimePicker", {
                ...
                members:{
                    ...
                    buildUI:function (caption) {
                        ...
                        this._dateSelect.add(new qx.ui.form.ListItem("Сегодня", null, 0));
                        this._dateSelect.add(new qx.ui.form.ListItem("Завтра", null, 1));
                        this._dateSelect.add(new qx.ui.form.ListItem("2 Дня", null, 2));
                        this._dateSelect.add(new qx.ui.form.ListItem("3 Дня", null, 3));
                        this._dateSelect.add(new qx.ui.form.ListItem("4 Дня", null, 4));
                        this._dateSelect.add(new qx.ui.form.ListItem("5 Дней", null, 5));
                        this._dateSelect.add(new qx.ui.form.ListItem("6 Дней", null, 6));
                        this._dateSelect.add(new qx.ui.form.ListItem("7 Дней", null, 7));
            ...
            qx.Class.define("paTweak.ui.CancelOrderPanel", {
                ...
                statics:{
                    ...
                    */
                    ...
                    cancelAll:function (callback, self) {
                        ...
                        // Issue order
                        paDebug("Отменить приказов: " + orderList.length);
                ...
                members:{
                    ...
                    buildUI:function () {
                        ...
                        // Return By
                        this._returnByButton = new qx.ui.form.Button("Взвр");
                        this._returnByButton.set({width:30, maxWidth:30, appearance:"button-text-small", toolTipText:"Все рейды вернуть к XX:XX:XX"});
                        this._returnByButton.addListener("execute", this.returnBy, this);
                        
                        // Cancel All
                        this._cancelAllButton = new qx.ui.form.Button("ВСЁ");
                        this._cancelAllButton.set({width:45, maxWidth:45, appearance:"button-text-small", toolTipText:"Отменить ВСЕ приказы. Осторожноl!"});
                        this._cancelAllButton.addListener("execute", this.cancelAll, this);
                        
                        // Cancel Raids
                        this._cancelRaidsButton = new qx.ui.form.Button("Отм.походы");
                        this._cancelRaidsButton.set({width:75, maxWidth:75, appearance:"button-text-small", toolTipText:"Отменить все походы."});
                    ...
                    cancelAll:function () {
                        // Check user
                        if (!confirm("Ду ю уонт ту кансел ол ордерс? :-)")) {
                            return;
                        }
            ...
            qx.Class.define("paTweak.ui.CombatWindow", {
                ...
                members:{
                    ...
                    buildUI:function () {
                        ...
                        this._copyButton = new qx.ui.form.Button("Капировать");
                        ...
                        var importButton = new qx.ui.form.Button("Загрузка/Выгрузка");
                        importButton.set({appearance:"button-text-small", allowGrowX:false, toolTipText:"Загрузка или выгрузка конфигурации атак."});
                        ...
                        // Reset button
                        this._resetButton = new qx.ui.form.Button("Сброс");
                        this._resetButton.set({appearance:"button-text-small", allowGrowX:false, toolTipText:"Сброс всех значений в окне."});
                        this._resetButton.addListener("execute", function () {
                            if (confirm("Сбросить все значения, точно точно?")) {
                                this.reset();
                            }
                        }, this);
                        ...
                        // Include check
                        this._includeActive = new qx.ui.form.CheckBox("Включать войска вне города");
                        this._includeActive.setToolTipText("Войска вне города(данжи/боссы) буду включены в атаку. Позаботтесь сами, чтобы они были в городе вовермя!");
                        this._includeActive.initValue(true);
                        this._includeActive.addListener("changeValue", this.refresh, this);
                        
                        // Allow partial check
                        this._allowPartial = new qx.ui.form.CheckBox("Разрешить частичную морскую атаку");
                        this._allowPartial.setToolTipText("Позволяет отправить в атаку столько пехоты, сколько помещается во Фригаты, а не отменять атаку из-за излишка пехоты.");
                        
                        // Use scouts
                        this._useScouts = new qx.ui.form.CheckBox("Включать разведов в атаку");
                        this._useScouts.setToolTipText("Все разведу будут отправлены в атаки. Если разведов много, то они будут добавлены и в спам тоже.");
                        this._useScouts.setValue(true);
                        this._useScouts.addListener("changeValue", this.refresh, this);
                        
                        // Use smallest for fakes
                        this._useSmallestForFakes = new qx.ui.form.CheckBox("Посылать на спам меньшее кол-во войск, чем на основной нап.");
                        this._useSmallestForFakes.setToolTipText("По умолчанию больше юнитов направляется на спам. Это зименит приказы наоборот.");
                        this._useSmallestForFakes.setEnabled(false);
                        this._useSmallestForFakes.exclude(); // Hidden for now
                        
                        // Force 3000 min score
                        this._forceMsCheck = new qx.ui.form.CheckBox("Всегда использовать 3000 min СВ");
                        this._forceMsCheck.set({toolTipText:"Всегда использовать 3000 min СВ"});
                        this._forceMsCheck.setValue(true);
                        
                        // Exclude Defense
                        this._excludeDefenseCheck = new qx.ui.form.CheckBox("Исключить деф");
                        this._excludeDefenseCheck.set({toolTipText:"Не использовать оборонных солдат."});
                        this._excludeDefenseCheck.setValue(true);
                        this._excludeDefenseCheck.addListener("changeValue", this.refresh, this);
                        
                        // Travel mode
                        var travelModeLabel = new qx.ui.basic.Label("Режим передвижения");
                        var autoMode = new qx.ui.form.RadioButton("Авто");
                        autoMode.set({model:"auto", toolTipText:"Войска будут посланы пешком, если цель на том-же континенте, иначе будут использованы фригаты."});
                        var navyMode = new qx.ui.form.RadioButton("Морем");
                        navyMode.set({model:"navy", toolTipText:"Войска будут посланы на фригатах, даже если цель на том-же континента."});
                        var landMode = new qx.ui.form.RadioButton("Пешком (Врата)");
                        landMode.set({model:"land", toolTipText:"Войска будут посланы пешком или через врата. Фригаты НЕ используются."});
                        ...
                        var refreshButton = new qx.ui.form.Button("Обновить");
                        ...
                        resetCounterButton.set({appearance:"button-text-small", toolTipText:"Сбросить указательный счетчик."});
                        ...
                        // Add button
                        var addButton = this._addButton = new qx.ui.form.Button("+");
                        addButton.set({appearance:"button-text-small", allowGrowX:false, toolTipText:"Добавить новую цель."});
                        addButton.addListener("execute", this.addRow, this);
                        
                        this.add(addButton);
                        
                        // Note
                        var noteLabel = new qx.ui.basic.Label("<em>PS: Посылайте спам перед реальной атакой.</em>");
            ...
            qx.Class.define("paTweak.ui.IdleRaidUnitsTable",
                            {
                                ...
                                {
                                    var tableModel = new qx.ui.table.model.Simple();
                                    var columnNames = ["CityID", "СВ", "Тип", "Город", "Комент", "Конт", "Коры"];
            ...
            function checkForSubAttacks( results, thisObj )
            {
                try
                {
                    ...
                    if (hasAttacks.length > 0)
                    {
                        ...
                        {
                            subIncomingImg.setSource('http://eaassets-a.akamaihd.net/lougame/cdn/406071/resource/webfrontend/ui/icons/icon_attack_warning.gif');
                            subIncomingImg.setToolTipText("Incoming for " + hasAttacks);
                        }
                    }
                    else
                    {
                        subIncomingImg.setSource('http://eaassets-a.akamaihd.net/lougame/cdn/406071/resource/webfrontend/ui/icons/icon_alliance_outgoing_attack_warning_inactive.png');
            ...
            qx.Class.define("paTweak.ui.ExtraTools", {
                ...
                members:{
                    ...
                    buildUI:function () {
                        ...
                        fillQueueButton.set({width:25, appearance:"button-text-small", toolTipText:"Заполнить очередь строительства"});
                        ...
                        payQueueButton.set({width:25, appearance:"button-text-small", toolTipText:"Преобразовать очередь строительства"});
                        ...
                        IncomingAttacksButton.set({width:25, appearance:"button-text-small", toolTipText:"Входящие атаки"});
                        ...
                        var combatButton = new qx.ui.form.Button("Комбат");
                        combatButton.set({width:65, appearance:"button-text-small", toolTipText:"Показать окно отправки атак."});
                        combatButton.addListener("execute", this.showCombatWindow, this);
                        row.add(combatButton);
                        
                        var raidButton = new qx.ui.form.Button("Походы");
                        raidButton.set({width:75, appearance:"button-text-small", toolTipText:"Походы в данжи и на боссов"});
                        ...
                        subIncomingImg = new qx.ui.basic.Image('http://eaassets-a.akamaihd.net/lougame/cdn/406071/resource/webfrontend/ui/icons/icon_attack_warning.gif');
                        ...
                        fortuneAvailImg = new qx.ui.basic.Image('http://eaassets-a.akamaihd.net/lougame/cdn/406071/resource/webfrontend/ui/icons/icon_alliance_red_17.png');
                        ...
                        var reportsButton = new qx.ui.form.Button("Отчеты");
                        reportsButton.set({width:55, appearance:"button-text-small", toolTipText:"Просканировать мои отчеты о разведке"});
                        reportsButton.addListener("execute", this.showReports, this);
                        row.add(reportsButton);
                        
                        var mailListButton = new qx.ui.form.Button("Спис.рассылки");
                        mailListButton.set({width:65, appearance:"button-text-small", toolTipText:"Создает списки рассылки по альянсу. Оч. удобно!"});
                        ...
                        var itemsButton = new qx.ui.form.Button("Дворцовые арты");
                        itemsButton.set({width:100, appearance:"button-text-small", toolTipText:"Использование дворцовых артов ниже уровнем."});
                        ...
                        try {
                            ...
                            var ToolTip = "Всего / Готово / Вербуется / Доступно";
                            
                            BaronLabel = new qx.ui.basic.Label(" ");
                            BaronLabel.setRich(true);
                            BaronLabel.setValue('<div style="-moz-transform: scaleX(1);background-image:url(http://eaassets-a.akamaihd.net/lougame/cdn/406071/resource/webfrontend/theme/tree/open.png);background-repeat:no-repeat;width:16px;height:16px;font-weight:bold;padding-left:15px;"><img src="http://eaassets-a.akamaihd.net/lougame/cdn/406071/resource/webfrontend/ui/icons/units/icon_units_baron.png"  style="align:absmiddle;-moz-transform: scaleX(1); width: 16px; height: 16px; padding-left:4px;" /></div>');
                            ...
                            var cToolTip = "Есть/Требуется";
                            CastleLabel = new qx.ui.basic.Label(" ");
                            CastleLabel.setRich(true);
                            CastleLabel.setValue('<div style="-moz-transform: scaleX(1);background-image:url(http://eaassets-a.akamaihd.net/lougame/cdn/406071/resource/webfrontend/ui/icons/icon_playerinfo_townicon_castle_land.png);background-repeat:no-repeat;;width:21px;height:16px;font-weight:bold;margin-left:10px;"></div>');
                        ...
                        prevCityBtn = new qx.ui.form.Button("", 'http://eaassets-a.akamaihd.net/lougame/cdn/406071/resource/webfrontend/theme/scrollbar/scrollbar-left.png');
                        ...
                        nextCityBtn = new qx.ui.form.Button("", 'http://eaassets-a.akamaihd.net/lougame/cdn/406071/resource/webfrontend/theme/scrollbar/scrollbar-right.png');
                        ...
                        refreshCityBtn = new qx.ui.form.Button("Обновить");
                        refreshCityBtn.set({width: 50, appearance: "button-text-small", toolTipText: "Обновить список городов"});
                    ...
                    toggleTable:function () {
                        ...
                        {
                            BaronLabel.setValue('<div style="-moz-transform: scaleX(1);background-image:url(http://eaassets-a.akamaihd.net/lougame/cdn/406071/resource/webfrontend/theme/tree/closed.png);background-repeat:no-repeat;width:16px;height:16px;font-weight:bold;padding-left:15px;"><img src="http://eaassets-a.akamaihd.net/lougame/cdn/406071/resource/webfrontend/ui/icons/units/icon_units_baron.png"  style="align:absmiddle;-moz-transform: scaleX(1); width: 16px; height: 16px; padding-left:4px;" /></div>');
                    ...
                    updateNeededResources:function () {
                        ...
                        if (title >= 3) 
                        {
                            ...
                            if (pr) {
                                ...
                                var woodImg = '<img src="http://eaassets-a.akamaihd.net/lougame/cdn/406071/resource/webfrontend/ui/icons_ressource_voidWood_16.png" style="align:absmiddle;-moz-transform: scaleX(1); width: 10px; height: 10px; padding-right:2px;">';
                                var stoneImg = '<img src="http://eaassets-a.akamaihd.net/lougame/cdn/406071/resource/webfrontend/ui/icons_ressource_voidStone_16.png" style="align:absmiddle;-moz-transform: scaleX(1); width: 10px; height: 10px; padding-right:2px;">';
                                var ironImg = '<img src="http://eaassets-a.akamaihd.net/lougame/cdn/406071/resource/webfrontend/ui/icons_ressource_voidIron_16.png" style="align:absmiddle;-moz-transform: scaleX(1); width: 10px; height: 10px; padding-right:2px;">';
                                var foodImg = '<img src="http://eaassets-a.akamaihd.net/lougame/cdn/406071/resource/webfrontend/ui/icons_ressource_voidFood_16.png" style="align:absmiddle;-moz-transform: scaleX(1); width: 10px; height: 10px; padding-right:2px;">';
                                var goldImg = '<img src="http://eaassets-a.akamaihd.net/lougame/cdn/406071/resource/webfrontend/ui/icons_ressource_gold.png" style="align:absmiddle;-moz-transform: scaleX(1); width: 10px; height: 10px; padding-right:2px;">';
                                //var woodImg = '/';
                                //var stoneImg = '/';
                                //var ironImg = '/';
                                //var foodImg = '/';
                                ...
                                if ((ix - 5)%4 == 0)
                                {
                                    ...
                                    {
                                        //MissingResourcesValue.setValue("<span style='v-align: middle'>Еще " + (numCastlesNeeded - playerCastles) + " замок или " + woodImg + this.formatNumber(Math.max(0, resNeeded - pr[3][1])) + " " + stoneImg +  this.formatNumber(Math.max(0, resNeeded - pr[2][1])) + " " + ironImg + this.formatNumber(Math.max(0, resNeeded - pr[1][1])) + " " + foodImg + this.formatNumber(Math.max(0, resNeeded - pr[0][1])) + " " + goldImg + this.formatNumber(Math.max(0, goldNeeded - curGold)) + "</span>");
                                        sb.add(String(numCastlesNeeded - playerCastles), " замок(ов) или ");
                    ...
                    updatePurifiedResources:function () {
                        ...
                        if (pr) {
                            ...
                            var ironImg = '<img src="http://eaassets-a.akamaihd.net/lougame/cdn/406071/resource/webfrontend/ui/icons_ressource_voidIron_16.png" style="align:absmiddle;-moz-transform: scaleX(1); width: 10px; height: 10px; padding-right:2px;">';
                            var foodImg = '<img src="http://eaassets-a.akamaihd.net/lougame/cdn/406071/resource/webfrontend/ui/icons_ressource_voidFood_16.png" style="align:absmiddle;-moz-transform: scaleX(1); width: 10px; height: 10px; padding-right:2px;">';
                            //var goldImg = '<img src="http://eaassets-a.akamaihd.net/lougame/cdn/406071/resource/webfrontend/ui/icons_ressource_gold.png" style="-moz-transform: scaleX(1); width: 10px; height: 10px; padding-right:2px;">';
