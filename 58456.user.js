...
//	.fleft {    float:left;}
	...
	div1.title = "|Naves de Carga Pequeña que se necesitan para vaciar el planeta";
	div1.innerHTML = format(sc, 0, '.') + " Carga Pequeña";// + " Carga Pequeña" + (sc>1?"s":"");
...
//	.fright {   float:right;}
	...
	div2.title = "|Naves de Carga Grande que se necesitan para vaciar el planeta";
	div2.innerHTML = format(lc, 0, '.') + " Carga Grande";// + " Carga Grande" + (lc>1?"s":"");
