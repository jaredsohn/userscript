// ==UserScript==
// @name           Facebook ChatBar +
// @description    Gives you a collection of emoticons that you can click for a simpler way to experience emoticons in facebook chat. 
// @include        http://www.facebook.com/*
// @include        http://apps.facebook.com/*
// @version        1.0.4.2
// @author         Mike Shamory, Fixed by DMaster
// @author	   bitMAN
// ==/UserScript==
//
...
// :) :( :D >:( -_- :/ o.O :p :'( >:O :v 3:) :o :3 ;) :* :|] 8) <3 :putnam: 8| ^_^ (^^^) O:)
	...
	emotsInfo[46] = '<(")';		emotsInfo[47] = 518;
	emotsInfo[48] = ':putnam:';		emotsInfo[49] = 572;
	emotsInfo[50] = '*msg*';		emotsInfo[51] = 554;
	emotsInfo[52] = '_msg_';		emotsInfo[53] = 538;
