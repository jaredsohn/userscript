// ==UserScript==
// @name            The West - TW Pro - Oğuzhan ÜNAL
// @namespace       http://userscripts.org/scripts/show/106540
// @description     The West - TW Pro - Oğuzhan ÜNAL (v3.1.0.8)
// @author          Oğuzhan ÜNAL
// @release         Oğuzhan ÜNAL
// @website         
...
// @version         3.1.0.8
//
// @history         3.1.0.8|19/12/2011 <b>Announcement:</b><br><br>This is probably one of the last updates I do for TW Pro.<br><br>The future version of The West (v1.34) will represent too much work to upgrade the script and unfortunately I do not have enough free time from now to get into that work.<br><br>However, the good news is that the TW-DB team is currently working on a new equipment calculator.<br>A working beta version is already available <a href="http://forum.westbeta.innogames.de/showthread.php?t=1577" target="_blank">here</a> and is very promising.<br>Good job guys, keep it up!<br><br>For my part, it was a pleasure to improve TW Pro during 1 year and I hope you enjoyed my work.<br><br>I would like to especially thank all the beta testers from the SOM team: Gzahab, Dun, Y., Tanes, TontonJohn, Milly, Roland Gamelle, Ren33, Mariache320, Danosaure, Blacklimber, Tungunska ... and also Bluep (.de) for his regular feedbacks and ideas.<br><br>Thanks also to Nexton (.de), the original script author of TW Pro, and to Lekensteyn (.nl) for his awesome work in 2010.<br><br>And finally thank you to everyone who encouraged me and thanked me during this year!<br><br>Best wishes for 2012 and see you soon,<br>Zyphir<br><br><b>PS for InnoGames:</b><br>Feel free to thank me at the last minute in any way you want. Even a simple word would have made me happy during this year... but maybe you just don't like scripts :p<br><br>
// @history         3.1.0.8|19/12/2011 Profile stats fixed (thx to Narulez for the fix).
// @history         3.1.0.8|19/12/2011 Greenhorn Set bonuses updated (reported 2 month ago by AnaDoro, sorry for the late ;))
// @history         3.1.0.8|19/12/2011 Workaround to avoid errors on Beta server version 1.34 (you will keep some TW Pro features on Beta but the main part of the script will be disabled).
...
var twpro_lang = {
	info: ['Oğuzhan ÜNAL', 'mailto:oguzhanunalgs@mynet.com', 4343, '.w1.'],
		AUTHOR: 'Çeviri',
		TRANSLATOR: 'Çeviri',
		TWPRO_DISABLED: 'Script kapatıldı: The-West kaynak kodu değiştiği için scriptin güncellenmesi gerek',
		SORTBYNAME: 'Sırala <b>ada göre</b>',
		SORTBYXP: 'Sırala <b>tecrübeye göre</b>',
		SORTBYWAGES: 'Sırala <b>paraya göre</b>',
		SORTBYLUCK: 'Sırala <b>şansa göre</b>',
		SORTBYCOMB: 'Sırala <b>yapılma oranına göre</b>',
		SORTBYDANGER: 'Sırala <b>tehlikeye göre</b>',
		SORTBYLABORP: 'Sırala <b>çalışma puanına göre</b>',
		FILTERJOBS: "Yapamadığım işleri gizle",
		FILTERCLOTHING: 'Bu iş için sadece en iyi kıyafetleri göster',
		CHOOSEJOB: 'Çalışmayı Seç',
		CALCJOB: 'Değerler hesaplanıyor, lütfen bekleyin',
		INVENTSTATS: 'Envanter İstatistiklerin',
		...
		LABORP: 'ÇP',
		CONSTRUCTION: ' \u25B7 Kurma',
		HPTOTAL: 'Maksimum sağlık',
		STARTCALC: 'Hesapla',
		CONVERT: 'Çevir',
		MULTISEL: 'Çoklu satış',
		SELL: 'Satış ürününü seç',
		CONFIRMSELL: 'Gerçekten %1 satmak istiyor musun?',
		SELLING: 'Satılıyor',
		SALEDONE: 'Satış gerçekleşti.',
		NONESELECTED: 'En az bir ürün seçmelisin!',
		JOBRANKSETTINGS: 'İş ayarları',
		SEARCHINVENTORY: 'Envanterde ara',
		NOSEARCHRESULT: '%1 araman için sonuç yok.%2Tüm eşyaları göster%3',
		DISABLEBESTFORJOB: 'Önemsiz eşyaları gizle.',
		SEARCHHELP: 'Envanterde ara. (* sıfır ve daha fazla karakter için, ? bir karakter için)',
		DUELSHOOTINGATT: ' \u25B7 Atışçı (saldırı)',
		DUELSHOOTINGDEF: ' \u25B7 Atışçı (savunma)',
		DUELVIGOR: ' \u25B7 Vuruş düellocusu',
		FORTATTACK: ' \u25B7 Kale savaşı (saldırı)',
		FORTDEFEND: ' \u25B7 Kale savaşı (savunma)',
		FORTMESSAGE: 'Müttefiklere mesaj gönder',
		FORTMESSAGERCP: 'Alıcı sayısı',
		HIDEJOBS: 'Çalışmalar & İtem setleri Yönetimi',
		CONFIRM: 'Onayla',
		HIDEJOBDESC: 'İşleri buradan gizleyebilirsiniz. Seçin ve onaylayın.',
		SHOWN: 'Gösterilenler',
		HIDDEN: 'Gizlenenler',
		NOEQUIP: "Malzeme olmadan",
		BESTEQUIP: "En iyi malzeme ile",
		SETTINGSSAVED: 'Ayarlar uygulandı!',
		SETTINGSSAVEDSESSION: 'Ayarlar uygulandı! (sadece bu oturum)',
		PERSISTSETTINGS: 'Ayarlar sürekli kayıtlı kalsın.',
		CANNOTWEAR: 'Bu setten eşyanız yoktur.',
		SETSETTINGS: 'Daha hızlı hesaplamalar için setleri devre dışı bırak.',
		CUSTOMNAME: 'Bu çalışma için isim girin',
		CUSTOMCALCULATION: 'Hesap için değer seçin.',
		CUSTOMENABLED: 'Çalışmayı onaylamak için kutuyu işaretleyin',
		NEW: 'Yeni',
		SPEED: ' \u25B7 Hız',
		REGENERATION: ' \u25B7 Hızlı yaşam puanı',
		SETSINFO: "Setler",
		WITHSETITEMS: '%1 eşya ile bonus',
		LABORPOINTS: 'Çalışma puanı',
		USEFULITEM: 'Sahip olduğunuz/kullanabildiğiniz eşya sayısı',
		PERCREGENERATION: 'Yenilenme',
		LUCK: 'Şans',
		PRAYING: 'dua',
		NOITEMSETS: "Bu setten eşyan yok",
		AVERAGEDAMAGE: "Ortalama hasar",
		PREFERENCES: "Tercihler",
		DEFAULTSORTING: " \u25B7 Varsayılan sıralama",
		FBHEALTHPRIORITY: "Sağlık puanına öncelik",
		FBHEALTHPRIORITYZERO: "Yok",
		FBHEALTHPRIORITYLOW: "Düşük",
		FBHEALTHPRIORITYMEDIUM: "Orta",
		FBHEALTHPRIORITYHIGH: "Yüksek",
		FBHEALTHPRIORITYAUTO: "Otomatik",
		FBBATTLEUNIT: "Savaş birimi türü",
		FBBATTLEUNITSKIRMISHER: "Çatışan (saldıran) | Ön hat",
		FBBATTLEUNITLINEINFANTRYMAN: "Piyade (çok değerli) | Orta hat",
		FBBATTLEUNITMARKSMAN: "Nişancı (atışçı) | Arka hat",
		...
		USEFULITEMS : "Yapabildiğim çalışmalar için işe yarar her eşyayı göster",
		USEFULITEMSPOPUP : " \u25B7 Kutu | Ayrıntılar ile göster",
		USEFULITEMSPOPUPDESC : "Çalışmalarda her yararlı eşya bonusları ile gösterilir (biraz uzun sürer).",
		SHOWALLJOBS : " \u25B7 Haritadaki tüm çalışmaları göster",
		SHOWALLJOBSDESC : "Sayfa yenilendikten sonra aktif olacak (F5)",
		COLLECTORMODE : " \u25B7 Toplayıcı modu",
		COLLECTORMODEDESC : "Henüz sahip olmadığın eşyalar tüccarda mavi gösterilir.",
		HELP : "YARDIM",
		WEBSTORAGEQUOTAEXCEEDED : "Web'de Saklama Kotası aşıldı!\n\n- Geçerli veriler eksik olacaktır.\n- Saklama özelliği otomatik olarak devre dışı bırakıldı.\n- Lütfen bu sunucudaki bazı hesapların önbelleğini boşaltın, Yerel Saklama kotası limitini arttırın (yalnızca Firefox ve Opera ile mümkün).",
		CACHEGENERATE : "Önbellek oluştur...",
		CACHEUPDATE : "Önbelleği güncelleştir",
		CACHEFORCEOK : "Tespit edilen değişiklikler iptal edilsin.",
		CACHEFORCEOKDESC : "Hesaplama yapılırken önbellek durumunu güçlendir.",
		CACHEGENERATENOW : "Şimdi yeni önbellek oluşturmak istiyor musun?",
		CACHEUPDATENOW : "Şimdi önbelleği güncelleştirmek istiyor musun?",
		CACHEINVENTORYCHANGES : "Envanter değişiklikleri tespit edildi.",
		CACHEGENERATECLICK : "Yeni önbellek oluşturmak için tıkla.",
		...
		CACHEINITIALIZE : "Başlatmak için buraya tıklayın.",
		...
		CACHENEWJOBSDETECTED : "Yeni çalışmalar tespit edildi.",
		CACHENEWJOBDETECTED : "Yeni çalışma tespit edildi: %1<br>Lütfen önbelleği güncelleştirin.",
		CACHEENABLE : " \u25B7 TW Pro önbelleği etkinleştir",
		CACHEINDEXEDDBNOT : "IndexedDB tarayıcın tarafından desteklenmiyor.",
		CACHEINDEXEDDBDESC : "Ultra hızlı işlem. Firefox 4+ ve Chrome 11+ tavsiye edilir.",
		CACHECOMPATIBILITY : "Uyumluluk bilgileri",
		CACHEQUOTAS : "Kota bilgileri",
		CACHEQUOTASDESC : "<b>Tarayıcının Web Saklama (Yerel Saklama) limitlerini bilmek için 'Kota bilgilerine' tıklayın.<br>"
				  +"<br>Yerel Saklama limitlerini nasıl arttırırsın?</b><br>"
				  +"<b>- Firefox:</b><br>"
				  +"Adres çubuğuna 'about:config' yazıp gir ve 'dom.storage.default_quota' seçeneğini ara.<br>"
				  +"Bu kilobyte değeridir, onu değiştirebilirsin. Saklama alanı sunucu dili tarafından paylaşılır,<br>"
				  +"aynı sunucu üzerindeki hesap başına 1500 kB gerekir.<br>"
				  +"<b>- Chrome:</b><br>"
				  +"Kotaları ayarlamak mümkün değil.<br>"
				  +"<b>- Opera:</b><br>"
				  +"Varsayılan olarak tarayıcın gerektiğinde limitleri arttırmak isteyecektir. Ancak adres çubuğuna<br>"
				  +"opera:webstorage' yazıp girerek her alan için ayarları elle değiştirebilirsin.<br>"
				  +"Bu kilobyte değeridir.Saklama dünya tarafından paylaşılır (alan bazlı), aynı dünya<br>"
				  +"üzerindeki hesap başına 3000 kB gerekir.<br>"
				  +"<b>- Safari:</b><br>"
				  +"Kotaları ayarlamak mümkün değil.",
		CACHEEMPTY : "TW Pro önbelleği boşalt.",
		CACHEEMPTYDESC : "Kurtarma aracı. Veri tutarsızlığı durumunda ağırlıklı kullanılacak.",
		CACHEWEBSTORAGEDESC : "Hızlı işlem. Kota saklama limitleri ancak en güncel tarayıcılar tarafından desteklenir.",
		CACHEEMPTYNOW : "Bu önbelleği şimdi boşaltmak istiyor musun?",
		...
		SAFEMODE : " \u25B7 Güvenli modu etkinleştir",
		SAFEMODEDESC : "Tarayıcınız için hesaplama işlemi yavaşlar fakat askıya alma, donma ve çökme sorunu olmaz.",
		SAFEMODEFBEXCL : "Kale savaşı ayarlarını elle kullanırken güvenli modu çalıştırma.",
		SAFEMODERUNNING : "Güvenli mod çalışıyor...",
		SAFEMODERUNNINGDESC : ["İşlem esnasında:", "- Envanterini kapatma ve yenileme.", "- Eşya alımı veya satımı yapma.", "- Eşya giyme veya çıkarma.", "- Yeteneklerinde değişiklik yapma.", "Tamam, dikkate alacağım. Şimdi envanterimizi görebiliriz..."],
		SAFEMODECOMPLETED : "Güvenli mod tamamlandı!",
		ACTIVITIES : "Çalışmalar",
		ITEMS : "Eşyalar",
		ITEMSETSCOMBI : "Set kombinasyonları",
		TESTSRUN : "Yapılan testlerin sayısı.",
		CALCTIME : "Hesaplama süresi",
		NOJOBSAFFECTED : "Değişiklikler mevcut çalışmaları etkilemedi.",
...
//JobList[126] = new JobInfo('Palisade bauen', 'build_palisade', 300, '1 * skills.build + 1 * skills.punch + 1 * skills.endurance + 1 * skills.repair + 1 * skills.leadership + 0', 'Kräftige Stämme müssen in den Boden gerammt werden, um Schutz vor angreifern zu gewähren.', [null], [{'name': 'Random product', 'icon': 'images/items/unknown.png', 'short': ''},null]);
	...
	TWPro.twpro_setBonus.set_dancer[7].parsedBonus = {};
			...
			TWPro.twpro_setBonus.greenhorn_set[3].jobBonus.wood = 40;
			...
			TWPro.twpro_setBonus.greenhorn_set[4].jobBonus.tanning = 25;
			TWPro.twpro_setBonus.greenhorn_set[4].jobBonus.wood = 40;
			...
			TWPro.twpro_setBonus.greenhorn_set[5].jobBonus.tanning = 25;
			TWPro.twpro_setBonus.greenhorn_set[5].jobBonus.wood = 40;
			...
			TWPro.twpro_setBonus.greenhorn_set[6].jobBonus.cow = 30;
			TWPro.twpro_setBonus.greenhorn_set[6].jobBonus.turkey = 20;
			TWPro.twpro_setBonus.greenhorn_set[6].jobBonus.tanning = 25;
			TWPro.twpro_setBonus.greenhorn_set[6].jobBonus.wood = 40;
			...
			TWPro.twpro_setBonus.greenhorn_set[7].jobBonus.cow = 30;
			TWPro.twpro_setBonus.greenhorn_set[7].jobBonus.turkey = 20;
			TWPro.twpro_setBonus.greenhorn_set[7].jobBonus.tanning = 25;
			TWPro.twpro_setBonus.greenhorn_set[7].jobBonus.wood = 40;
			...
			TWPro.twpro_setBonus.greenhorn_set[8].jobBonus.cow = 30;
			TWPro.twpro_setBonus.greenhorn_set[8].jobBonus.turkey = 20;
			TWPro.twpro_setBonus.greenhorn_set[8].jobBonus.tanning = 25;
			TWPro.twpro_setBonus.greenhorn_set[8].jobBonus.wood = 40;
		...
		if (parseFloat(TheWestApi.version.substr(0,4)) < 1.34){
		...
		twpro_supportLink.href = 'http://userscripts.org/scripts/show/106540';
		...
		$(twpro_supportAuthor.id).addMousePopup(new MousePopup('<table cellspacing="0" cellpadding="0"><tr><td>Çeviri:</td><td><img src="images/forum/icon/gold.png" height="13" width="13" style="margin-top:-3px">&nbsp;</td><td>Oğuzhan ÜNAL<div style="float:right;margin-left:3px;margin-top:3px;background:url('+flags+')0px;width:17px;height: 10px;"></div></td></tr><tr><td>Çeviri:</td><td><img src="images/forum/icon/gold.png" height="13" width="13" style="margin-top:-3px">&nbsp;</td><td>Oğuzhan ÜNAL<div style="float:right;margin-left:3px;margin-top:3px;background:url('+flags+')-17px;width:15px;height: 10px;"></div></td></tr><tr><td>Çeviri:</td><td><img src="images/forum/icon/bronze.png" height="13" width="13" style="margin-top:-3px">&nbsp;</td><td>Oğuzhan ÜNAL<div style="float:right;margin-left:3px;margin-top:3px;background:url('+flags+')-32px;width:15px;height: 10px;"></div></td></tr><tr><td>Çeviri:</td><td><img src="images/forum/icon/bronze.png" height="13" width="13" style="margin-top:-3px">&nbsp;</td><td>Oğuzhan ÜNAL<div style="float:right;margin-left:3px;margin-top:3px;background:url('+flags+')0px;width:17px;height: 10px;"></div></td></tr><tr><td>Çeviri:</td><td><img src="images/forum/icon/silver.png" height="13" width="13" style="margin-top:-3px">&nbsp;</td><td>Oğuzhan ÜNAL<div style="float:right;margin-left:3px;margin-top:3px;background:url('+flags+')-62px;width:15px;height: 10px;"></div></td></tr><tr><td>Çeviri:</td><td><img src="images/forum/icon/silver.png" height="13" width="13" style="margin-top:-3px">&nbsp;</td><td>Oğuzhan ÜNAL<div style="float:right;margin-left:3px;margin-top:3px;background:url('+flags+')-77px;width:15px;height: 10px;"></div></td></tr><tr><td>Çeviri:</td><td><img src="images/forum/icon/bronze.png" height="13" width="13" style="margin-top:-3px">&nbsp;</td><td>Oğuzhan ÜNAL<div style="float:right;margin-left:3px;margin-top:3px;background:url('+flags+')-92px;width:15px;height: 10px;"></div></td></tr><tr><td>Çeviri:</td><td><img src="images/forum/icon/gold.png" height="13" width="13" style="margin-top:-3px">&nbsp;</td><td>Oğuzhan ÜNAL<div style="float:right;margin-left:3px;margin-top:3px;background:url('+flags+')-47px;width:15px;height: 10px;"></div></td></tr></table>'));
/*		if (TWPro.twpro_failureInject) {
			TWPro.twpro_throwFailure();
		}*/
	}
			...
			//alert("js");
				if ((twpro_extendeName == 'inventory') || (twpro_extendeName.substr(0, 15) == 'building_tailor') || (twpro_extendeName.substr(0, 17) == 'building_gunsmith') || (twpro_extendeName.substr(0, 16) == 'building_general')) {
					...
					try{
						...
						var who = twpro_data.response.text.match(/telegram', \{insert_to:\s*'([^']+)'\}/);
						if(who){
							try{
...
//}
  ...
  { // BBcodes
	  ...
	  function insertbbcodesfunc(messagebox, extended) {
		  ...
		  bbbar.style.cssFloat = 'left';
		  bbbar.style.marginTop = '25px';
		  bbbar.id = 'new_bbbar';
