// ==UserScript==
// @name           Neopets: Money Tree : Grab Codestones
...
function checkmoney() {
var i,highest=0,am=new Array(),amounts = $x("//b[contains(text(), 'Codestone')]",7);
if(amounts.length==0) {window.location.reload(300);}
