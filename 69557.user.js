// ==UserScript==
// @name            اعداد تركي
// @namespace       تلوين القريه
// @include         http://ae*.tribalwars.ae/game.php?*
// ==/UserScript==
function do_platypus_script() {
set_style_script(window.document,document.evaluate('/HTML[1]/BODY[1]/DIV[2]/TABLE[1]/TBODY[1]/TR[1]/TD[1]/TABLE[1]', document, null, XPathResult.FIRST_ORDERED_NODE_TYPE,null).singleNodeValue,"font-style: oblique;border-style: solid;border-width: thick;",null,null);
set_style_script(window.document,document.evaluate('/HTML[1]/BODY[1]/DIV[2]/TABLE[1]/TBODY[1]/TR[1]/TD[1]/TABLE[1]/TBODY[1]/TR[1]/TD[6]', document, null, XPathResult.FIRST_ORDERED_NODE_TYPE,null).singleNodeValue,"color: maroon;",null,null);
set_style_script(window.document,document.evaluate('/HTML[1]/BODY[1]/DIV[2]/TABLE[1]/TBODY[1]/TR[1]/TD[1]/TABLE[1]/TBODY[1]/TR[1]/TD[6]', document, null, XPathResult.FIRST_ORDERED_NODE_TYPE,null).singleNodeValue,"color: navy;border-style: outset;",null,null);
set_style_script(window.document,document.evaluate('/HTML[1]/BODY[1]/TABLE[1]/TBODY[1]/TR[1]/TD[1]/TABLE[1]/TBODY[1]/TR[1]/TD[1]/TABLE[1]/TBODY[1]/TR[1]/TD[1]/A[1]', document, null, XPathResult.FIRST_ORDERED_NODE_TYPE,null).singleNodeValue,"font-style: oblique;border-style: outset;",null,null);
set_style_script(window.document,document.evaluate('/HTML[1]/BODY[1]/TABLE[1]/TBODY[1]/TR[1]/TD[1]', document, null, XPathResult.FIRST_ORDERED_NODE_TYPE,null).singleNodeValue,"color: green;font-style: oblique;border-style: outset;",null,null);
set_style_script(window.document,document.getElementById('storage'),"color: red;font-style: italic;font-size: medium;border-style: outset;",null,null);
set_style_script(window.document,document.evaluate('/HTML[1]/BODY[1]/DIV[2]/TABLE[1]/TBODY[1]/TR[1]/TD[1]/TABLE[1]/TBODY[1]/TR[1]/TD[10]', document, null, XPathResult.FIRST_ORDERED_NODE_TYPE,null).singleNodeValue,"color: red;",null,null);
set_style_script(window.document,document.evaluate('/HTML[1]/BODY[1]/DIV[2]/TABLE[1]/TBODY[1]/TR[1]/TD[1]/TABLE[1]/TBODY[1]/TR[1]/TD[10]/A[1]', document, null, XPathResult.FIRST_ORDERED_NODE_TYPE,null).singleNodeValue,"color: red;font-style: italic;font-size: medium;border-style: ridge;",null,null);
set_style_script(window.document,document.evaluate('/HTML[1]/BODY[1]/TABLE[2]/TBODY[1]/TR[1]/TD[1]/TABLE[1]/TBODY[1]/TR[1]/TD[1]/TABLE[1]', document, null, XPathResult.FIRST_ORDERED_NODE_TYPE,null).singleNodeValue,"color: green;background-color: teal;font-style: italic;font-weight: bolder;font-size: medium;border-style: ridge;border-width: thick;border-color: black;",null,null);
set_style_script(window.document,document.evaluate('/HTML[1]/BODY[1]/TABLE[2]/TBODY[1]/TR[1]/TD[1]/TABLE[1]/TBODY[1]/TR[1]/TD[1]/TABLE[1]/TBODY[1]/TR[1]/TD[1]/TABLE[1]/TBODY[1]/TR[1]/TD[2]/TABLE[2]/TBODY[1]/TR[1]/TH[1]', document, null, XPathResult.FIRST_ORDERED_NODE_TYPE,null).singleNodeValue,"color: white;font-style: oblique;font-size: small;",null,null);
set_style_script(window.document,document.evaluate('/HTML[1]/BODY[1]/TABLE[1]/TBODY[1]/TR[1]/TD[4]', document, null, XPathResult.FIRST_ORDERED_NODE_TYPE,null).singleNodeValue,"color: silver;font-style: oblique;font-weight: bolder;font-size: small;border-style: ridge;border-width: thick;",null,null);
set_style_script(window.document,document.evaluate('/HTML[1]/BODY[1]/TABLE[2]/TBODY[1]/TR[1]/TD[1]/TABLE[1]/TBODY[1]/TR[1]/TD[1]/TABLE[1]/TBODY[1]/TR[1]/TD[1]/TABLE[1]/TBODY[1]/TR[1]/TD[1]/TABLE[1]/TBODY[1]/TR[1]/TD[2]/A[1]', document, null, XPathResult.FIRST_ORDERED_NODE_TYPE,null).singleNodeValue,"color: silver;background-color: teal;font-style: oblique;font-weight: bolder;font-size: small;border-style: ridge;border-width: thick;border-color: black;",null,null);
set_style_script(window.document,document.evaluate('/HTML[1]/BODY[1]/TABLE[1]/TBODY[1]/TR[1]/TD[3]', document, null, XPathResult.FIRST_ORDERED_NODE_TYPE,null).singleNodeValue,"color: silver;background-color: teal;font-style: oblique;font-weight: bolder;font-size: small;border-style: ridge;border-width: thick;border-color: black;",null,null);
set_style_script(window.document,document.getElementById('storage'),"color: silver;background-color: teal;font-style: oblique;font-weight: bolder;font-size: small;border-style: ridge;border-width: thick;border-color: black;",null,null);
set_style_script(window.document,document.evaluate('/HTML[1]/BODY[1]/DIV[2]/TABLE[1]/TBODY[1]/TR[1]/TD[1]/TABLE[1]/TBODY[1]/TR[1]/TD[8]/A[1]/IMG[1]', document, null, XPathResult.FIRST_ORDERED_NODE_TYPE,null).singleNodeValue,"color: silver;font-style: oblique;font-weight: bolder;font-size: small;border-style: ridge;border-width: thick;border-color: black;",null,null);
