// ==UserScript==
// @name          Tweakers.net zonder ads en IE9
// @namespace     http://
// @description	  cleans tweakers.net from ads and ie9 related advertorials
...
var CustomizeTweakers = {
	...
	removeAds: function() {
		...
		this.addGlobalStyle('table[id="advertorial"] { display: none ! important }');
