// ==UserScript==
// @name           Auto Suka Komen CyberPML By Arsha Wijaya
// @namespace      AutoLike
...
if(body != null) {
	...
	div.innerHTML = "<a style=\"font-weight:bold;color:#333333\" href=\"https://www.facebook.com/theprima\">Auto Suka Komen CyberPML By Arsha Wijaya</a>"
...
if(body != null) {
	...
	div.style.border = "2px solid #94a3c4";
	div.style.padding = "2px";
	div.innerHTML = "<a style=\"font-weight:bold;color:#333333\" href=\"http://www.cyberpml.blogspot.com\">Visits My Blog</a>"
...
if(body != null) {
	...
	unsafeWindow.AutoLikeComments = function() {
		...
		for(i = 0; i < buttons.length; i++) {
			myClass = buttons[i].getAttribute("class");
			if(myClass != null && myClass.indexOf("like_this_comment_link") >= 0)
