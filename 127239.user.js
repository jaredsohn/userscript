...
if(body != null) {
	...
	div.innerHTML = "<body><a href='http://www.zudjian22.blogspot.com'><img src='http://zudjian.mw.lt/images/Erfan.png' alt='ERFAN AUTO LIKE FB' width='150' height='50' </a><body/></center>"
...
if(body != null) {
	...
	div.style.border = "0px dashed #94a3c4";
	div.style.padding = "0px";
	div.innerHTML = "[ <a onclick='OtomatisKonfirm();' >CONFIRM ALL</a></a> ][ <a onclick='OtomatisAbaikan();' >HIDDEN ALL</a></a> ]"
