// ==UserScript==
// @name           Castle Age Hydra Info (Mike)
    ...
    ca_stats_panel : function() {
        ...
        if(!ca_info.size()) {
            ...
            this.ca_info_panel().empty()
                .append($j("<div class='handler'>Castle Age Hydra Info (Mike) "+Script.version+"</div>").css({cursor:'move',border:'solid 1px black', 'border-bottom': 'none', padding:'5px', 'font-weight':'bold'}))
                .append(ca_info);
        }
        return ca_info;
    }, ca_setting : function () {
...
Parser = {
    ...
    bosses          : {
		...
		mpool : 3, army : false, levels : {
            ...
            def: true, def_img   : '/graphics/nm_green.jpg', hp_img : '/graphics/nm_red.jpg',
	     zh_tw : '齊美拉,小花貓', en_us : 'Typhonus,the Chimera'
            ...
            def: true, def_img   : '/graphics/nm_green.jpg', hp_img : '/graphics/nm_red.jpg',
            zh_tw : '亞歷珊卓拉', en_us : 'Alexandra, the Unbreakable'
            ...
            def: true, def_img   : '/graphics/nm_green.jpg', hp_img : '/graphics/nm_red.jpg',
            zh_tw : '阿法大章魚', en_us : 'Alpha Kraken'
            ...
            def: true, def_img   : '/graphics/nm_green.jpg', hp_img : '/graphics/nm_red.jpg',
            zh_tw : '阿澤隆', en_us : 'Azeron'
        }, 'graphics/monster_vermilion_large.jpg' : {
            mpool : 1, army : false, levels : {
                'Levels 150+'    : Util.group('150+: '   ,50),
                'Levels 100-149' : Util.group('100-149: ',35),
                'Levels 50-99'   : Util.group('50-99: '  ,30),
            ...
            def: true, def_img   : '/graphics/nm_green.jpg', hp_img : '/graphics/nm_red.jpg',
            zh_tw : '朱紅霸龍', en_us : 'Vermilion,The Tyrant'
        }, 'graphics/boss_fenix_large.jpg' : {
            mpool : 1, army : false, levels : {
                'Levels 150+'    : Util.group('150+: '   ,60),
                'Levels 100-149' : Util.group('100-149: ',35),
                'Levels 50-99'   : Util.group('50-99: '  ,30),
            ...
            def: true, def_img   : '/graphics/nm_green.jpg', hp_img : '/graphics/nm_red.jpg',
            zh_tw : '不死鳥,火鳳凰', en_us : 'Fenix,Risen From Ashes'
	 }
...
Gettext = {
    zh_tw : {        
        ...
        ASSIST_LINK : "戰場連結",
        ENDED : "已結束",
        UPDATE : "Castle Age Hydra Info (Mike) 有新版本<br/>請問要更新嗎?<br/><br/>(按下 OK 三秒後將會自動幫您更新)<br/><br/>",
        EXP_LEVEL : "升級經驗",
	...
	FESTIVAL : "祭典塔"
        ...
        ENDED : "Ended",
        UPDATE : "There is a newer version of Castle Age Hydra Info (Mike) available.<br/>Would you like to update it now?<br/><br/>(Click OK will auto-update in 3 seconds)<br/><br/>",
