...
// @namespace      org.grid-iron
// @description    Adds a filter for game type in the match archive display
// @include        http://grid-iron.org/index.php?page=club&subpage=marchive&team_id=*
// @include        http://www.grid-iron.org/index.php?page=club&subpage=marchive&team_id=* 
// @version        0.0.0.2
// ==/UserScript==
...
var matchTypes = new Array("Cup", "Friendly", "League", "AFLC");
