...
// ==/UserScript==
			...
			node.innerHTML = node.innerHTML
			//Reaction Faces
			.replace(/:trollbro:/g, "<style>.md img { display:inline; } .rageface { visibility:visible; } </style><div id='lol' class='lol'><img  src=\'http://a2.sphotos.ak.fbcdn.net/hphotos-ak-ash4/409454_3267447610271_1389723876_3174259_1448561140_n.jpg\' title='trollbro' /></div>")
