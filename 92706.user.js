...
DF.ToolBar = new function ToolBar() {
	...
	var innerHTML =
		'<fieldset class="windowbg2" style="' + row1Style + ' position: fixed; right: 0px; top: 0px; padding: 0px; display: none; ' +
			...
			'<button style="' + buttonStyle + '">&darr; Custom</button>' +	// Show button
			'<div style="display: none;">' +
				...
				'<address style="padding: 0.5em; text-align: right; ' +
					...
					'<a style="' + creditAStyle + '" href="http://userscripts.org/scripts/show/92706" target="_blank" title="Get the latest version">' +
						'Custom Dead Frontier</a> ' +
					'by <a style="' + creditAStyle + '" href="mailto:highmagician@gmail.com" target="_blank">High Magician</a> 2011' +
				'</address>' +
			'</div>' +
		'</fieldset>';
	var outerHTML = document.createElement("div");
