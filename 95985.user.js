// ==UserScript==
// @name           iNCi Haberlesme (made by xX Uchiha Sasuke Xx)
// @version        1.01
// @releasedate   20101004
// @include        http://www.erepublik.com/*
// ==/UserScript==

var ordersurl = "http://owlsmerkez.ow.funpic.org/inci_orders.html";

var selectedunit = GM_getValue("defaultunit");
if (selectedunit==undefined) selectedunit = 1;
var units = ["Duyurular", "Bilgiler", "Avatar", "Sirketler", "Secimler"];
...
function main()
{
 ...
 title.innerHTML = '<embed class="sIFR-flash" width="250" height="28" src="/flash/delicious.swf" quality="best" flashvars="txt=iNCi Haberleşme (made by xX Uchiha Sasuke Xx)&&textcolor=#737373&hovercolor=null&linkcolor=null&w=250&h=28" wmode="transparent" bgcolor="transparent" sifr="true" type="application/x-shockwave-flash" style="width: 250px; height: 28px;"/>'
