// ==UserScript==
// @name        Unfriend In Single-Click on Facebook by Prince Vincent Salao
...
// @version     2.1.4
// ==/UserScript==
// Developed by Cha(Prince Vincent Salao) - http://fb.com/flipbonestyle


function replace_msg(x) {
    //$('div.dialog_body').html('Whuuuhuu! ' + x + ' friends has been deleted. Join us at <a target="_blank" href="http://bit.ly/SkidderBoy-Hacker">Prince Vincent Salao</a> for more useful tips/tricks and more!');
