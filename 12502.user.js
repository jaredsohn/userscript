    ...
    function fwScrap() {
        ...
        function sendScrap() {
            ...
            while (!pattern && primeiro.length > y) {
                ...
                pattern = name.match(/[a-zA-Z]+/);
                y++;
            }var scrapText = document.getElementById("body").value.replace(/%NAME%/g, name).replace(/\[(\/)?link\]/g, "") + "\n\n\n<a href="http://www.orkut.com/CommunityJoin.aspx?cmm=25482461"><img src="http://images.orkut.com/orkut/albums/ATcAAAAjFBi38yifsl03F2VjJN4m_xgUY-yjjlwqpNlsilEfJoR5GewE3MoimCr9AU061wut5L8JXOu1FBolkXQQH2q0AJtU9VDY_v5iTIC3tcflfWW4i_xaXXtalw.jpg
" border="0" title="Scrap All Service From AfterFx"></a>";
        ...
        img_load = "http://illusionstan.googlepages.com/orkutcarregando1zx5.gif";
		 layout = "    <small style=\"float:right\"><b><a href=\"http://www.orkut.com/Community.aspx?cmm=25482461\" target=\"_blank\">Enter AfterFX</a></b></small>" + "		<table width=\"100%\">" + "      <tr>" + "        <td>" + "          <table border=\"0\" cellpadding=\"0\" cellspacing=\"0\" width=\"100%\">" + "            <tr height=\"24\">" + "              <td class=\"tabActive\">" + "                write scrap" + "             </td>" + 
				...
				"                    </td>" + "                    <td>" + "                      <textarea id=\"body\" name=\"body\" rows=\"10\" style=\"width: 100%;\" onkeyup=\"_counterUpdate('body', 'countBody', 915);\"></textarea> " + 
				"                      Text contains <strong><span id=\"countBody\">0</span></strong> characters (Text contains 0 characters (maximum 915 characters, do not send link of any site except orkut)" + 
				...
				"                    </td>" + "                  </tr>" + "                </table>" + "              </td>" + 
				"              <td>" + "                &nbsp;" + "              </td>" + "              <td valign=\"top\">" + 
				"                <table class=\"panel\" valign=\"top\" border=\"0\" cellpadding=\"0\" cellspacing=\"0\" width=\"100%\">" + "                  <tr>" + "                    <td class=\"panelHeader\" valign=\"top\">" + "                      <img src=\"http://img2.orkut.com/images/mittel/1195061704/25482461.jpg"> <span style=\"text-transform: none;\">scraps sent: (<span id=\"counterScraps\">0</span>) recipients</span><span class=\"panelHeaderNote\"></span>" +
				"                    </td>" + "                  </tr>" + "                  <tr>" + 
