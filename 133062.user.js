...
var atk_icon =	'data:image/gif;base64,R0lGODlhPAA8AMIDACMZ2Pn5%2BP%2F%2F%2Fv%2F%2F%2F%2F%2F%2F%2F%2F%2F%2F%2F%2F%2F%2F%2F%2F%2F%2F%2FyH%2FC05FVFNDQVBFMi4wAwEAAAAh%2FhFDcmVhdGVkIHdpdGggR0lNUAAh%2BQQJHgAEACwAAAAAPAA8AAADl0i63P4wykmrvTjrzbv%2FYCiOZGmeaKqubOu%2BcCzPdG3feK7vfO%2F%2FwOBPQAQKAEgBTrkgIp%2FMJuwYPT6hiwEg2qIqrNetQst1ecFXJZl2DhO9tfb2Lb6h3Tr6vMizlnd%2BRkmCdT6Bhod9TgABAXxLfmCPcZGNkXZJXIkyi5Nfc2yZD5dTpKOiL6YQmyxvFq5CsbKztLW2FQkAIfkEAR4ABwAsAAAAADwAPAAAA5x4utz%2BMMpJq7046827%2F2AojmRpnmiqrmzrvnAsz3Rt33iu77wp%2FL2FAEAU4IzCIbHYQLqGTuWSqRgAnC2oQjpFWrHP64G7NH5pWvJPW0sX1%2BIbuauDX9c9JXinD26pQX1%2BgnmEfD9EAQFAOYh3ZXsyjj%2BKepEwlgyGMZN7UJcsmQ6iL50RpFlvE5sreBWufrGys7S1tre4ubq7FQkAOw%3D%3D';
...
//}
//window.setTimeout(function() { infoinfo();}, 1000);
//infoinfo();
...
function getNPCCastleInfo() {
	...
	for (var i=0; i<areas.snapshotLength; i++) {
		...
		var pictImg = '<a href="' + rowText2 + '">'
			      + '<img src="/20120510-01/extend_project/w945/img/common/sidebar/icon_base.gif" onmouseover="'
				...
				if( (list2 != null) && (list2 != undefined) ){
					...
					if( (autoroute == AUTO_ROUTE_EDIT_LAST) && (autoroute_f[0] == list2[1]) && (autoroute_f[1] == list2[2]) ){
						...
						if( elemhtml.indexOf("<b>") >= 0 ){
							newhtml = elemhtml.replace(/<b>.*<\/b>/,"<font style=\"font-size: 10px; text-shadow: -1px -1px 0 #FFF, 1px -1px 0 #FFF, -1px 1px 0 #FFF, 1px 1px 0 #FFF; color:red; border-style: solid; border-color: cyan; background-color:cyan;\">" + vtext + "</font>");
						}
						else{
							newhtml = elemhtml.replace(/<font.*>.*<\/font>/,"<font style=\"font-size: 10px;text-shadow: -1px -1px 0 #FFF, 1px -1px 0 #FFF, -1px 1px 0 #FFF, 1px 1px 0 #FFF; border-style: solid; border-color: cyan; color:red; background-color:cyan;\">" + vtext + "</font>");
						}
...
//									text = text + data + "&nbsp;☆" + landLevel + "&nbsp;(" + list[1] + "-" + list[2] + "-" + list[3] + "-" + list[4] + ")";
									text = text + data + "&nbsp;(" + list[1] + "-" + list[2] + "-" + list[3] + "-" + list[4] + ")";
								}
								else{
...
function makeAutoRoute_51(checkmode)
{
	...
	for( var i = maxpos; i >= 0; i-- ){
		...
		if( elem.innerHTML.indexOf("<b>") >= 0 ){
			newhtml = elem.innerHTML.replace(/<b>.*<\/b>/,"<font style=\"font-size:10px;background-color:cyan;\">○</font>");
		}
		else{
			if( (elem.innerHTML.indexOf(">S</font>") >= 0) || (elem.innerHTML.indexOf(">E</font>") >= 0) ){
				...
				newhtml = elem.innerHTML.replace(/<font.*>.*<\/font>/,"<font style=\"font-size:10px;background-color:cyan;\">○</font>");
			}
		}
		elem.innerHTML = newhtml;
