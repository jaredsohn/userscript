// ==UserScript==
// @name       Radio MegapolisFM on TMD
// @namespace  merge dar inca testez
// @version    0.1
// @description  Adauga un player radio la MegapolisFM pe TMD
...
// @include     http://www.torrentsmd.*/forum.php?action=viewtopic&topicid=*&page=*
// @include     http://www.torrentsmd.*/forum.php?action=viewtopic&topicid=*&page=p*#*
// @include     http://www.torrentsmd.*/details.php?id=*
// @include     http://www.torrentsmoldova.*/forum.php?action=viewtopic&topicid=*&page=p*#*
// @include     http://www.torrentsmoldova.*/details.php?id=*
// @include     http://*.torrentsmd.*/forum.php?action=viewtopic&topicid=*&page=p*#*
// @include     http://*.torrentsmd.*/details.php?id=*
// @include     http://*.torrentsmoldova.*/forum.php?action=viewtopic&topicid=*&page=p*#*
// @include     http://*.torrentsmoldova.*/forum.php?action=viewtopic&topicid=*&page=*
// @include     http://*.torrentsmoldova.*/details.php?id=*
// @copyright  2012+, DRAKULABOY for TMD
// ==/UserScript==
// gkol 89.28.22.181:8000
// rkol 89.28.22.181:8000
URL = "http://89.28.22.181:8000/"
