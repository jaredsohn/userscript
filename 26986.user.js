...
function enhance_mail_screen() {
	...
	var xhtml = "<table class='bbcodearea'> " +
		    "<tr>    " +
		    '	<td><a tabindex="10" href="javascript:insertBB(\'Jogador\','+random+');"><img src="'+ TW_Image_Base +'/face.png" alt="Insert player BB code" /></a></td>' +
		    '	<td><a tabindex="11" href="javascript:insertBB(\'Aldeia\','+random+');"><img src="'+ TW_Image_Base +'/buildings/main.png" alt="Insert village BB code" /></a></td>' +
		    '	<td><a tabindex="12" href="javascript:insertBB(\'Tribo\','+random+');"><img src="'+ TW_Image_Base +'/command/support.png" alt="Insert tribe BB code" /></a></td>' +
		    '   <td>|</td>'+
      		    ...
      		    '	<td>|</td>' +
      		    '	<td><a tabindex="16" href="javascript:insertBB(\'citar\','+random+');"><img src="http://www.offthemap.com/images/site/blockquote.jpg" alt="Cita" /></a></td>' +
		    ...
		    '	<td>|</td>' +
                    '	<select>'+
                    '	<option onclick="javascript:insertBB(\'Minúsculo\','+random+');">Minúsculo</option>'+
                    ...
                    '</select>'+
		    "</tr>   " +
                    '	<td><a tabindex="29" href="javascript:insertBB(\'smily lol\','+random+');"><img src="http://forum.sysemp.net/Smileys/tango/smile.png" /></a></td>' +
                    '	<td><a tabindex="30" href="javascript:insertBB(\'smily smile\','+random+');"><img src="http://forum.sysemp.net/Smileys/tango/wink.png" /></a></td>' +
                    '	<td><a tabindex="31" href="javascript:insertBB(\'smily idea\','+random+');"><img src="http://forum.sysemp.net/Smileys/tango/grin.png" /></a></td>' +
                    '	<td><a tabindex="32" href="javascript:insertBB(\'smily wink\','+random+');"><img src="http://forum.sysemp.net/Smileys/tango/biggrin.png" /></a></td>' +
                    '	<td><a tabindex="33" href="javascript:insertBB(\'smily evil\','+random+');"><img src="http://forum.sysemp.net/Smileys/tango/tongue.png" /></a></td>' +
		    '	<td><a tabindex="34" href="javascript:insertBB(\'smily twisted\','+random+');"><img src="http://forum.sysemp.net/Smileys/tango/cool.png" /></a></td>' +
                    '	<td><a tabindex="35" href="javascript:insertBB(\'smily eek\','+random+');"><img src="http://forum.sysemp.net/Smileys/tango/blush.png" /></a></td>' +
                    '	<td><a tabindex="36" href="javascript:insertBB(\'smily surprised\','+random+');"><img src="http://forum.sysemp.net/Smileys/tango/laughing.png" /></a></td>' +
                    '	<td><a tabindex="37" href="javascript:insertBB(\'smily cry\','+random+');"><img src="http://forum.sysemp.net/Smileys/tango/thinking.png" /></a></td>' +
                    '	<td><a tabindex="38" href="javascript:insertBB(\'smily smile2\','+random+');"><img src="http://forum.sysemp.net/Smileys/tango/wacko.png" /></a></td>' +
		    '	<td><a tabindex="39" href="javascript:insertBB(\'smily cool\','+random+');"><img src="http://forum.sysemp.net/Smileys/tango/cry.png" /></a></td>' +
		    '	<td><a tabindex="40" href="javascript:insertBB(\'smily sad\','+random+');"><img src="http://forum.sysemp.net/Smileys/tango/sad.png" /></a></td>' +
   		    "   </tr>   " +
                    '	<td><a tabindex="41" href="javascript:insertBB(\'smily confused\','+random+');"><img src="http://forum.sysemp.net/Smileys/tango/angry.png" /></a></td>' +
		    '	<td><a tabindex="42" href="javascript:insertBB(\'smily rolleyes\','+random+');"><img src="http://forum.sysemp.net/Smileys/tango/shock.png" /></a></td>' +
		    '	<td><a tabindex="43" href="javascript:insertBB(\'smily briggin\','+random+');"><img src="http://forum.sysemp.net/Smileys/tango/blink.png" /></a></td>' +
		    '	<td><a tabindex="44" href="javascript:insertBB(\'smily redface\','+random+');"><img src="http://forum.sysemp.net/Smileys/tango/thumbs_up.png" /></a></td>' +
		    '	<td><a tabindex="45" href="javascript:insertBB(\'smily razz\','+random+');"><img src="http://forum.sysemp.net/Smileys/tango/beer.png" /></a></td>' +
		    '	<td><a tabindex="46" href="javascript:insertBB(\'smily neutral\','+random+');"><img src="http://i30.tinypic.com/e00imp.jpg" /></a></td>' +
		    '	<td><a tabindex="47" href="javascript:insertBB(\'enfadado\','+random+');"><img src="http://forum.sysemp.net/Smileys/tango/treat.gif" /></a></td>' +
		    '	<td><a tabindex="48" href="javascript:insertBB(\'risas\','+random+');"><img src="http://forum.sysemp.net/Smileys/tango/happy.png" /></a></td>' +
		    '	<td><a tabindex="49" href="javascript:insertBB(\'beso\','+random+');"><img src="http://forum.sysemp.net/Smileys/tango/getlost.png" /></a></td>' +
		    '	<td><a tabindex="50" href="javascript:insertBB(\'corazon\','+random+');"><img src="http://www.dzinerstudio.com/Smileys/new/verymad.gif" /></a></td>' +
		    '	<td><a tabindex="51" href="javascript:insertBB(\'leon\','+random+');"><img src="http://forum.sysemp.net/Smileys/tango/devil.png" /></a></td>' +
		    '	<td><a tabindex="52" href="javascript:insertBB(\'hormiga\','+random+');"><img src="http://forum.sysemp.net/Smileys/tango/sick.png" /></a></td>' +
		    "</table>";
	...
	TW_Set_Function("insertBB", function(insertType, ident){
			...
			switch (insertType) {
				...
				case 'smily smile2':
      					...
      					break;
				case 'smily cool':
      					txtinsertBefore = "[img]http://forum.sysemp.net/Smileys/tango/cry.png";
      					txtinsertAfter = "[/img]";
      					insertButton = '11';
      					break;
				case 'smily sad':
