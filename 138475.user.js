...
This is probably only useful if you have a clipboard listener like my 'DotD raid link spammer' which may (or may not) be linked in the forums.";
		...
		load: function (fails) {
			if (typeof holodeck == 'object' && typeof ChatDialogue == 'function' && typeof activateGame == 'function' && typeof document.getElementById('kong_game_ui') != 'null') {
				...
				holodeck.addChatCommand("version", function(deck,text) {
					...
					d += '<a href="http://userscripts.org/scripts/show/138475" target="_blank">Go to script page</a>';
					SRDotDX.echo(d);
					return false;
				});
				holodeck.addChatCommand("update", function(deck,text) {
					window.open("http://userscripts.org/scripts/source/138475.user.js");
		...
		raids: {
			...
			corrupterebus:{name: 'Corrupted Erebus', shortname: 'Corrupted', id: 'corrupterebus', stat: 'ESH', size:90000, duration:72, health: ['Unlimited','Unlimited','Unlimited','Unlimited','Unlimited','Unlimited']},
			...
			trololol:{name: 'TROLL RAID', shortname: 'TROLL',  id: 'trololol', stat: 'S', size:250, duration:96, health: [250000000000000,250000000000000,250000000000000,250000000000000,,]}
		},
		reload: function () {
