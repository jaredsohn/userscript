...
window.GM_4rthur_quickBox = function(clickedLink, boxType)
{
  ...
  if(boxType == "edit")
  {
    ...
    formBlock.setAttribute("action", "edit.php");
  ...
  if(boxType == "reply")
  {
    ...
    formBlock.setAttribute("action", "post.php");
...
window.document.addEventListener('click', function(event)
{
  ...
  if(event.target.innerHTML == 'reply' && event.target.href.indexOf("4rthur.com/board/post.php") != -1)
  {
    GM_4rthur_quickBox(event.target, "reply");
    eventCaptured = true;
  }
  if(event.target.innerHTML == 'edit' && event.target.href.indexOf("4rthur.com/board/edit.php") != -1)
  {
