...
// @version        0.691
// ==/UserScript==
// Updated by Vhandrix to include code to replace the side bar ads in farmville with a frame showing some calculators and charts to assist in game play.
...
function dCleaner(sVal,sAttrib) {
    ...
    case 'class':
		...
		if (sVal = "UIStandardFrame_SidebarAds")  // code added by Vhandrix
			{
				aDivs[0].innerHTML = '<iframe id="calculator" src="http://www.fvgametips.com/InGameGuide.aspx" height="640px"></iframe>';
				break;
			}
        var a;
...
function fWindex() {
		dCleaner('UIStandardFrame_SidebarAds', 'class'); // code added by Vhandrix
