// ==UserScript==
// @name			goear.com - MP3 Downloader (New Version of Goear/Nueva version de Goear)
// @description		Simply modded script to clarify "Download MP3" button. Creates a toolbar button to download the MP3 from the song that you are listening./ Script de Andre Gil modificado para que el boton "Descargar MP3" este mas a la vista.
// @version			0.42
// @date			01/15/2010
// @author			Dani Mediavilla (original from Andre Gil)
...
(function () {
	...
	function getMP3Path() {
		...
		if( songCode != "" )
		{
			GM_xmlhttpRequest({
				method: 'GET',
				url: 'http://www.goear.com/localtrackhost.php?f=' + songCode,
				onload: parseXml
			});
		}
