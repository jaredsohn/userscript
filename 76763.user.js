...
//Uncomment the following six lines to keep the top menu
...
//Comment the following three lines to keep the sidebar
AddStyle ("#sidebar {display:none; width:1px;}");
AddStyle ("#main {margin-right: 0px;}");
AddStyle (".nocolwrap {margin-right: 0px;}"); 

//Footer; Comment these two lines to restore the footer
