...
var Options = {
  ...
  alertSound   : {enabled:false, soundUrl:DEFAULT_ALERT_SOUND_URL, repeat:true, 
...
var JSON2 = JSON; 
playLength:20, repeatDelay:0.5, volume:100, alarmActive:false, expireTime:0},
...
//end of added21mar
    m += '<TABLE class=ptTab width=100%><TR align=center>\
        ...
        <TD width=16%><SPAN id=puttr_stone><B>Stone:</b><BR>'+ addCommasInt(t.stats.stone) +'</span></td>\
