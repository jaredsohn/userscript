// ==UserScript==
// @name        northclicks new 08/2013
// @namespace   northclicks new 08/2013
// @include     *://*northclicks.com/index.php?view=ads
// @include     *://*northclicks.com/?view=ads
// @include     *://*northclicks.com/index.php?view=surfer*
// @include     *://*northclicks.com/fixedads_surfer.php?view=surfer*
// @require     http://userscripts.org/scripts/source/175524.user.js
...
self == top){
	...
	var intersAds = setInterval(function(){
		...
		if(iframeLoad == 20){
			$('body iframe.surfer_frame').attr('src','http://www.picturecoin.com/7td47');
		}
	},1000)
