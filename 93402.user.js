// ==UserScript==
// @name            Link-a-nator alt
// @description     Backup Link-a-nator
...
javascript: (function() {
    //try { //begin big try
		...
		//freegifts['Stone Column'] = new giftObject('Stone Column*',403,'#00CC00'); removed from freegiftables by Zynga
		//freegifts['Terracotta Tiles'] = new giftObject('Terracotta Tiles*',404,'#00CC00'); removed from freegiftables by Zynga
		//Vegas Build
		...
		//Mbags
		//freegifts['Ornaments'] = new giftObject('Mbag3',431,'#B80000');
	  ...
	  '<tr id="select_row">'+
		'<td valign="top">Select links:<br /><a href="#" id="common" style="color:#FFFFFF;">Common</a><br /><a href="#" id="armory" style="color:#FF9966;">Armory</a><br /><a href="#" id="vegas" style="color:#FFCC00;">Vegas</a><br /><a href="#" id="italy" style="color:#00CC00;">Italy</a><br /><a href="#" id="zoo" style="color:#996633;">Zoo</a></td>'+
	  ...
	  '<tr><td></td><td colspan="2"><span class="more_in">Items marked with * are manually added and could stop working at any time.<br />Stone Column and Terracotta Tiles are not possible to free gift, only Zynga can fix those again.</span></td>'+
