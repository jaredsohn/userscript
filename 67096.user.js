// ==UserScript==
// @name           Lepszy ekwipunek by Darius II
...
\n\
\n\
items[700] = {item_id:700, nshort:'ham', name:'Szynka', type:'yield', level:null, price:10, image:'images/items/yield/ham.png?1', image_mini:'images/items/yield/ham.png?1', characterClass:null, characterSex:null, speed:null, bonus:{skills:{}, attributes:{}}, set:{key:null, name:null}, shop:'drop'};\n\
...
items[1712] = {item_id:1712, nshort:'key3', name:'Stary klucz', type:'yield', level:null, price:7500, image:'images/items/yield/key3.png?1', image_mini:'images/items/yield/key3.png?1', characterClass:null, characterSex:null, speed:null, bonus:{skills:{}, attributes:{}}, set:{key:null, name:null}, shop:'shop'};\n\
...
items[1763] = {item_id:1763, nshort:'threekeynote', name:'Kartka z trzema kluczami...', type:'yield', level:null, price:2, image:'images/items/yield/threekeynote.png?1', image_mini:'images/items/yield/threekeynote.png?1', characterClass:null, characterSex:null, speed:null, bonus:{skills:{}, attributes:{}}, set:{key:null, name:null}, shop:'drop'};\n\
items[1764] = {item_id:1764, nshort:'treasuremap', name:'Mapa skarbu!', type:'yield', level:null, price:5543, image:'images/items/yield/treasuremap.png?1', image_mini:'images/items/yield/treasuremap.png?1', characterClass:null, characterSex:null, speed:null, bonus:{skills:{}, attributes:{}}, set:{key:null, name:null}, shop:'drop'};\n\
items[1765] = {item_id:1765, nshort:'treasurebox', name:'Skrzynia ze skarbem', type:'yield', level:null, price:23402, image:'images/items/yield/treasurebox.png?1', image_mini:'images/items/yield/treasurebox.png?1', characterClass:null, characterSex:null, speed:null, bonus:{skills:{}, attributes:{}}, set:{key:null, name:null}, shop:'shop'};\n\
...
items[12701] = {item_id:12701, nshort:'xmas_licorice', name:'Lukrecja', type:'yield', level:null, price:15, image:'images/items/yield/xmas_licorice.png?1', image_mini:'images/items/yield/xmas_licorice.png?1', characterClass:null, characterSex:null, speed:null, bonus:{skills:{}, attributes:{}}, set:{key:null, name:null}, shop:'drop'};\n\
items[12702] = {item_id:12702, nshort:'xmas_oat', name:'Owies', type:'yield', level:null, price:32, image:'images/items/yield/xmas_oat.png?1', image_mini:'images/items/yield/xmas_oat.png?1', characterClass:null, characterSex:null, speed:null, bonus:{skills:{}, attributes:{}}, set:{key:null, name:null}, shop:'drop'};\n\
items[12703] = {item_id:12703, nshort:'xmas_cracker', name:'Bożonarodzeniowy krakers', type:'yield', level:null, price:27, image:'images/items/yield/xmas_cracker.png?1', image_mini:'images/items/yield/xmas_cracker.png?1', characterClass:null, characterSex:null, speed:null, bonus:{skills:{}, attributes:{}}, set:{key:null, name:null}, shop:'drop'};\n\
items[12704] = {item_id:12704, nshort:'xmas_lebkuchen', name:'Piernik', type:'yield', level:null, price:31, image:'images/items/yield/xmas_lebkuchen.png?1', image_mini:'images/items/yield/xmas_lebkuchen.png?1', characterClass:null, characterSex:null, speed:null, bonus:{skills:{}, attributes:{}}, set:{key:null, name:null}, shop:'drop'};\n\
items[12705] = {item_id:12705, nshort:'xmas_cookie', name:'Ciastko czekoladowe', type:'yield', level:null, price:29, image:'images/items/yield/xmas_cookie.png?1', image_mini:'images/items/yield/xmas_cookie.png?1', characterClass:null, characterSex:null, speed:null, bonus:{skills:{}, attributes:{}}, set:{key:null, name:null}, shop:'drop'};\n\
items[12706] = {item_id:12706, nshort:'xmas_potato', name:'Kartofelek marcepanowy', type:'yield', level:null, price:39, image:'images/items/yield/xmas_potato.png?1', image_mini:'images/items/yield/xmas_potato.png?1', characterClass:null, characterSex:null, speed:null, bonus:{skills:{}, attributes:{}}, set:{key:null, name:null}, shop:'shop'};\n\
items[12707] = {item_id:12707, nshort:'xmas_coal', name:'Kawałek węgla', type:'yield', level:null, price:2, image:'images/items/yield/xmas_coal.png?1', image_mini:'images/items/yield/xmas_coal.png?1', characterClass:null, characterSex:null, speed:null, bonus:{skills:{}, attributes:{}}, set:{key:null, name:null}, shop:'drop'};\n\
items[12708] = {item_id:12708, nshort:'xmas_sphere', name:'Szklany marmur', type:'yield', level:null, price:35, image:'images/items/yield/xmas_sphere.png?1', image_mini:'images/items/yield/xmas_sphere.png?1', characterClass:null, characterSex:null, speed:null, bonus:{skills:{}, attributes:{}}, set:{key:null, name:null}, shop:'drop'};\n\
\n\
...
aWindow.bi2_res2html = function (){
	...
	ihtm += '</a></td></tr>';
	ihtm += '<tr><td><a href="javascript:bi2_odev_add(\'n\','+count_rab+');void(0);" title="Dopisz do listy" >';
	...
	for (ee = 0; ee < aWindow.bi2_types.length; ++ee){
		...
		ihtm += '<img src="images/transparent.png" style="width :24px; height : 25px; background:url(../img.php?type=menu&dummy) -104px -51px" >';
		ihtm += '</a></td></tr>';
		ihtm += '<tr><td><a href="javascript:bi2_odev_add(\'z\','+count_rab+');void(0);" title="Dopisz do listy" >';
		ihtm += '<img src="images/transparent.png" style="width :24px; height : 25px; background:url(../img.php?type=menu&dummy) -104px -126px" >';
		ihtm += '</a></td></tr>';
		...
		ihtm += '<img src="images/transparent.png" style="width :24px; height : 25px; background:url(../img.php?type=menu&dummy) -104px -51px" >';
		ihtm += '</a></td></tr>';
		ihtm += '<tr><td><a href="javascript:bi2_odev_add(\'r\','+count_rab+');void(0);" title="Dopisz do listy" >';
		ihtm += '<img src="images/transparent.png" style="width :24px; height : 25px; background:url(../img.php?type=menu&dummy) -104px -126px" >';
		ihtm += '</a></td></tr>';
...
//    grsort += '<td style=\"width:10px; vertical-align:middle; padding:5px; \" />';
    ...
    if (aWindow.bi2_khlam){
        grgr+='<hr><table><tbody><tr><th colspan=\"8\" style=\"text-align:center;\">Przedmioty, które można sprzedać. Te przedmioty nie są wykorzystane lub inne przedmioty nadają siębardziej do prac</th></tr><tr>';
        babosy=0;
        tdcount=0;
...
bi2_odev_spam = function(){\n\
	...
	if (!reopen){\n\
		...
		store_set_link.textContent = 'Dopisz do listy';\n\
		...
		store_set_value.setAttribute('onfocus', 'if (this.value==\"Nazwa nowego zestawu ...\") { this.value=\"\"; }');\n\
		store_set_value.setAttribute('onblur', 'if (this.value==\"\") { this.value=\"Nazwa nowego zestawu ...\"; }');\n\
	...
	store_rewrite_link.setAttribute('title', 'Zmień nazwę wybranego zestawu');\n\
	store_rewrite_link.setAttribute('onclick', 'bi2_odev_spam_rewrite(); return false;');\n\
	store_rewrite_link.textContent = 'Zmień nazwę';\n\
...
aWindow.bi2_show_panel = function(){
	...
	if (!bi2_title) {
		...
		html0 += '<input type=\"button\" value=\"Dalej\" style=\"float:right; font-weight:bold\" onclick=\"javascript:bi2_worker(true)\"/>';
...
<form id=\"bi2_form\">\n\
	...
	<input type= \"button\" title=\"Pokazuje, nie więcej niż siedem elementów każdego typu (posiadanych w plecaku) o największych współczynnikach, z wyłączeniem zestawów (kompletów).\" value=\"Przedmioty z PP\" style=\"float:right\" onclick=\"javascript:bi2_worker(false)\"/>\n\
	<div style=\"float:right; clear:right; font-size: 11px\" >&nbsp;Autor:&nbsp;' + getAuthor() + '&nbsp;w:'+getMoCheckVersion()+'&nbsp;</div>\n\
	<input id=\"bi2_skol_rabot_v\" name=\"bi2_skol_rabot\" type=\"radio\" value=\"v\" style=\"margin:auto 5px;\" />Wszystko\n\
	<input id=\"bi2_skol_rabot_r\" name=\"bi2_skol_rabot\" type=\"radio\" value=\"r\" style=\"margin:auto 5px;\" />Wszystkie&nbsp;prace<br />\n\
	<input id=\"bi2_skol_rabot_o\" name=\"bi2_skol_rabot\" type=\"radio\" value=\"o\" checked=\"checked\" style=\"margin:auto 5px;\" onchange=\"javascript:bi2_vselect(false);void(0)\" />Jedna&nbsp;praca\n\
	<input id=\"bi2_skol_rabot_n\" name=\"bi2_skol_rabot\" type=\"radio\" value=\"n\" style=\"margin:auto 5px;\" onchange=\"javascript:bi2_vselect(true);void(0)\" />Wybrane&nbsp;prace<br /><br />\n\
	<input id=\"bi2_skol_rabot_s\" name=\"bi2_skol_rabot\" type=\"radio\" value=\"s\" style=\"margin:auto 5px;\" />Umiejętność&nbsp;&nbsp;';
	...
	<!--<div style=\"text-align:left; font-weigth:normal; color:#b8a080; background-color:black; padding-left: 30px;\">Wszystkie&nbsp;prace</div>-->\n\
		<span title=\"Po sortowaniu wszystkich prac, skrypt może wykryć rzeczy, które nie są wykorzystywane i obliczyć cenę sprzedaży tych rzeczy (w tej wersji nadal słabo działa). Jeśli nie ma wystarczających środków, te rzeczy można śmiało sprzedawać.\"><input id=\"bi2_khlam\" type=\"checkbox\" style=\"margin:auto 24px auto 27px;\" />\n\
	...
	<!--<div style=\"text-align:left; font-weigth:normal; color:#b8a080; background-color:black; padding-left: 30px;\"><span id=\"bi2_sk_rabot\">Одна&nbsp;работа&nbsp;&nbsp;&nbsp;&nbsp;</span>\n\
		...
		<span title=\"Dodatkowo jest wyszukiwany zestaw z maksymalną prędkością oraz dostępnością przedmiotów. Przydatne do dalekiego wysłania, a następnie natychmiast ubraniu w normalne rzeczy.\">\n\
		<input id=\"bi2_skorost\" type=\"checkbox\" style=\"margin:auto 21px auto 27px;\" />\n\
		Uwzględnić&nbsp;szybkość&nbsp;do&nbsp;pracy?<br /></span>\n\
	<div' + aWindow.bi2_vblock + '>\n\
		<span id=\"sp_tst_st3456\" style=\"display:block; background-color:#CFB98E; width:100%\" title=\"Chcesz pracować jednak brakuje Tobie parę punktów PP? Skrypt pomoże Tobie dobrać odpowiedni ekwipunek.\">\n\
		<input id=\"bi2_pokupka\" type=\"checkbox\" style=\"margin:auto 21px auto 25px;\" onchange=\"javascript:if (checked) {$(\'bi2_ukr_bablo\').style.display=\'block\'}else{$(\'bi2_ukr_bablo\').style.display=\'none\'};void(0)\" />&nbsp;Chcesz kupić ekwipunek?<br /></span>\n\
		...
		<span title=\"Przeszukuje przedmioty, które będą najlepszymi do wykonywanej pracy. Nie ważne czy je posiadasz czy też ich nie masz. Skrypt poszuka i poda te najodpowiedniejsze.\">\n\
		<input id=\"bi2_vse_vse\" type=\"checkbox\" style=\"margin:auto 21px auto 25px;\" />&nbsp;Chcesz&nbsp;znaleźć&nbsp;najlepsze;&nbsp;przedmioty&nbsp;do&nbsp;pracy?<br /></span>\n\
		<div' + aWindow.bi2_vblock + '>\n\
		<span style=\"display:block; background-color:#CFB98E;width:100%\" title=\"Tutaj możesz wybrać niektóre przedmioty (rzeczy) i sprawdzić, ile i czy będzie on używany w pracach.\">\n\
		<input id=\"bi2_khochuka\" type=\"checkbox\" style=\"margin:auto 23px auto 23px;\" onchange=\"javascript:if (checked) {$(\'bi2_ukr_khochuka\').style.display=\'block\'}else{$(\'bi2_ukr_khochuka\').style.display=\'none\';bi2_ovselect();};void(0)\" />Przydatność brakujących elementów</span>\n\
...
html0 += '</select></div></div>\n\
		<span title=\"Zaznaczenie tej opcji i wpisaniu cyfry od 1 do 5. Spowoduje że możesz sprawdzić przedmioty, które możesz użyć za 1-5 poziomów. Nie zmienia cech ani umiejek tylko umożliwia założenie przedmiotów, których przy obecnym poziomie nie moższ użyć.\"><input id=\"bi2_uroven\" type=\"text\" value=\"0\" size=\"5\" onchange=\"javascript:value = parseInt(value,10);if(isNaN(value))value=0;void(0)\" />\n\
		&nbsp;&laquo;wyższy&raquo;&nbsp;poziom<br /></span>\n\
	<div' +
		aWindow.bi2_vblock +
		'>\n\
		<span title=\"Po zaznaczeniu tego pola, skrypt nie dobiera ekwipunku do max PP. Tylko ustawia minimum na PP a resztę na umiejętności obronne.\"><input id=\"bi2_zaschita\" type=\"checkbox\" style=\"margin:auto 21px auto 23px;\" onchange=\"javascript:if (checked) {$(\'bi2_ukr_zaschita\').style.display=\'block\'}else{$(\'bi2_ukr_zaschita\').style.display=\'none\'};void(0)\" />&nbsp;Obrona&nbsp;przed&nbsp;napastnikiem?<br /></span>\n\
	...
	<div' +
		aWindow.bi2_vblock +
		'>\n\
		<span title=\"Tutaj możesz wybrać typy (część ciała), które zostaną pobrane. Skrypt nie będzie pobierać tych typów przedmiotów (ubierać się), które zostały oznaczone.\"><input id=\"bi2_sloty\" value=\"bi2_sloty\" type=\"checkbox\" onchange=\"javascript:if (checked) {$(\'bi2_sloty_content\').style.display=\'block\'}else{$(\'bi2_sloty_content\').style.display=\'none\'};void(0)\" style=\"margin:auto 23px auto 23px;\" />Typy ekwipunku:<br /></span>\n\
	...
	<div' +
		...
		<input id=\"bi2_yield\" type=\"checkbox\" checked=\"1\" style=\"margin:auto 23px auto 21px;\" />Produkt<br />\n\
		</div></div></div>\n\
	<div' +
		aWindow.bi2_vblock +
		'>\n\
