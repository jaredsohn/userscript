// ==UserScript==
// @name            stock.xchng relinker
// @description    	Replaces links to image previews on sxc.hu with direct links to images.
// @author          Zeke Sikelianos (Credit due to Platypus)
// @version         0.1 (February 15, 2006)
// @include         http://*.sxc.hu/*
// ==/UserScript==


function do_platypus_script() {
do_modify_html_it(window.document,document.evaluate('/HTML[1]', document, null, XPathResult.FIRST_ORDERED_NODE_TYPE,null).singleNodeValue,/photo\//g,'browse.phtml?f=download&id=',null);
do_modify_html_it(window.document,document.evaluate('/HTML[1]', document, null, XPathResult.FIRST_ORDERED_NODE_TYPE,null).singleNodeValue,/photo\//g,'browse.phtml?f=download&id=',null);
