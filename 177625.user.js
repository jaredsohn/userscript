...
function letsJQuery()
{
    $(document).ready(function () {
        ...
        var transferBaiduData = function(id,lng,lat,status){
            ...
            if(n_lng == '125' || n_lat == '43' || n_lat == '44'|| n_lat == '0' || n_lat == '0'){
        ...
        function getLocalData(){
            $.getJSON("http://10.207.0.240/jsapi.php?type=getshop&city=changchun&callback=?",function(data){
                    var data = eval(data);
