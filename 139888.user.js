// ==UserScript==
// @name			HF Scripts - Easy Report Graphics
// @namespace 		Glassy/hfreportinggraphics
// @description 	Makes reporting posts/threads in Graphics section to Glassy MUCH easier.
// @include  		*hackforums.net/showthread.php*
// @version  		1.1.2
// ==/UserScript==

var navBit = document.getElementsByClassName('navigation')[0];
if(navBit.innerHTML.indexOf('<a href="forumdisplay.php?fid=6">Graphics</a>') != -1) {
