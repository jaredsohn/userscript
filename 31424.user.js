// ==UserScript==
// @name Ikariam: Script para Alex
// @author Alex
// @include http://*.ikariam.*/index.php*
// @version 0.1
// @description Conjunto de scripts que yo utilizo.
// ==/UserScript==
...
// ==UserScript==
// @name           arriba transporter y aqui links
// @namespace      ikatips
// @description    Herraminetas para la alianza 
// @include        http://*ikariam.*/index.php*
// @author         Original por Verx - Modificado por ALEX 
...
newElement.innerHTML = '<h3 class="header">Informacion general</h3>'
						+ '<div class="content">'
							...
							newElement.innerHTML += '<p><span style="padding-left: 15px"><b>' + keywords[2][14] + ':</b></span><br>'
								+ '<span style="padding-left: 30px">» <a href=' + shortcuts[1] + '>' + keywords[1][0] + '</a></a></span><br>'
                                                                + '<span style="padding-left: 30px">» <a href=' + shortcuts[4] + '>' + keywords[3] + '</a></a></span></p><br>';
							} catch(e) {
							}
...
+ 'overviewPopup.innerHTML = \'<h3 style="border-bottom:thick double #F2E4B5; height:20px; padding-top:2px; font-weight:bold; text-align: center; background-color: #DEAB5C"><table border="0" width="100%"><tr><td>Ikariam General Overview v1.5    (by <a href="Alexandreedgarcobo[at]hotmail.com">Alex</a>)</td><td><a href="#" onclick="showHide();">' + keywords[2][1] + '</a></td></tr></table></h3>'
							+ table_buildsLvl
							+ table_resources
							+ '<p>' + keywords[2][4] + '</p>'
							+ '\';'												
...
function defineLanguage(langTDL) {
    switch (langTDL) {
        ...
        case "ikariam":
            ...
            break;
        default:
            language = { inline:"Puntuación en linea",
            fetch:"Buscando...",
            unknown:"Desconocido...",
...
// @description    	cazaparasitos por colores.
// @include       	 http://s*.ikariam.*/*
// @exclude        	http://board.ikariam.*/*
// ==/UserScript==
// Original script built by Leecher Checker v 1.2.3
// New script built by Alex
	var lversion = "0.1.9";
