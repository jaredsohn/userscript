						...
						qx.Class.define("BaseInfo", {
							...
							members: {
								...
								initialize: function () {
									...
									// Tab 1
									this.BasenwertePage = new qx.ui.tabview.Page("Üs Bilgisi");
									...
									// Tab 2
									this.MembersPage = new qx.ui.tabview.Page("Üyeler");
									...
									// Tab 3
									this.AboutPage = new qx.ui.tabview.Page("Bilgi");
								...
								showBasenwerte: function (ev) {
									...
									// Tab 1 Basenwerte
									this.BasenwerteVBox.add(new qx.ui.basic.Label("<table cellspacing='1' cellpadding='10'><tr><td><big><b><u>Genel Bilgiler</u></b></big><br><b>İttifaktaki Rolü:</b> " + newAusgabe["AllianzRolle"] + "<br><b>Oyuncu Adı:</b> " + newAusgabe["Spieler"] + "<br><b>Tür:</b> " + newAusgabe["Klasse"] + "<br><b>Son Giriş:</b> " + newAusgabe["Uhrzeit"] + "Uhr - " + newAusgabe["Datum"] + "<br><b>Sıralama:</b> " + newAusgabe["Rang"] + "<br><b>Maksimum KP:</b> " + newAusgabe["maxKP"] + "<br><b>Tamir Limitit:</b> " + newAusgabe["repZeit"] + " Saat<br><b>Üs Sayısı:</b> " + newAusgabe["Basen"] + "<br><b>Saldırı Üssü Sayısı:</b> " + newAusgabe["off_basen"] + "<br><b>Kredi Üretimi:</b> " + newAusgabe["Creditproduktion"] + "<b>/h</b><br><b>Tiberium Üretimi:</b> " + newAusgabe["Tiberiumproduktion"] + "<b>/h</b> (Bonussuz: " + parseInt(TiberiumsProduction) + "/h)<br><b>Kristal Üretimi:</b> " + newAusgabe["Kristallproduktion"] + "<b>/h</b> (Bonussuz: " + parseInt(CrystalsProduction) + "/h)<br><b>Defans Ø:</b> " + newAusgabe["def_durchschnitt"] + "<br><b>Takviyeli Üsler:</b> " + newAusgabe["support_basen"] + "<br><b>Takviye Seviyeleri Ø:</b> " + newAusgabe["support_lvl"] + "<br><b>VE Ø tüm Üslerde:</b> " + newAusgabe["ve"] + "</td></tr></table>").set({rich: true}));
									// 1. und 2. Offensive
									this.BasenwerteVBox.add(new qx.ui.basic.Label("<table cellspacing='1' cellpadding='10'><tr><td><big><b><u>1. Saldırı Üssü</u></b></big><br><b>Üs Adı:</b> " + firstBaseName + "<br><b>Seviye:</b> " + newAusgabe["1st_Base"] + "<br><b>Saldırı:</b> " + newAusgabe["1st_Off"] + "<br><b>Defans:</b> " + newAusgabe["1st_Def"] + "<br><b>Elektrik Üretimi:</b> " + newAusgabe["1st_Stromproduktion"] + "<br><b>Hava Tamir:</b> " + newAusgabe["1st_Flugzeuge"] + "<br><b>Motorlu Tamir:</b> " + newAusgabe["1st_Fahrzeuge"] + "<br><b>Piyade Tamir:</b> " + newAusgabe["1st_Fusstruppen"] + "</td><td><big><b><u>2. Saldırı Üssü</u></b></big><br><b>Üs Adı:</b> " + secondBaseName + "<br><b>Üs Seviyesi:</b> " + newAusgabe["2nd_Base"] + "<br><b>Saldırı:</b> " + newAusgabe["2nd_Off"] + "<br><b>Savunma:</b> " + newAusgabe["2nd_Def"] + "<br><b>Elektrik Üretimi:</b> " + newAusgabe["2nd_Stromproduktion"] + "<br><b>Hava Tamir:</b> " + newAusgabe["2nd_Flugzeuge"] + "<br><b>Motorlu Tamir:</b> " + newAusgabe["2nd_Fahrzeuge"] + "<br><b>Piyade Tamir:</b> " + newAusgabe["2nd_Fusstruppen"] + "</td></tr></table>").set({rich: true}));
									// Werte übertragen + Worldmap Link
									this.BasenwerteVBox.add(new qx.ui.basic.Label("<table cellspacing='1' cellpadding='10'><tr><td><a href='http://ccta.php-gfx.net/baseinfo/index.php?usersubmit=" + escape(usersubmit) + "&amp;allBases=" + escape(allBases) + "' target='_blank'><button><b>&nbsp;&nbsp;Gönder&nbsp;</b></button></a></td><td><a href='http://map.tiberium-alliances.com/map/"+worldidforWorldmap[3]+"#"+coordsforWorldmap+"|3|"+baseidforWorldmap+"|~' target='_blank'><button><b>&nbsp;&nbsp;Harita&nbsp;&nbsp;</b></button></a></td></tr></table>").set({rich: true}));
