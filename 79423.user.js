// ==UserScript==
// @name        Facebook Poke All & URL cleaner
...
function init() {
    ...
    if ($pokes.length > 0) {
        ...
        // Set up Buttons
        $pokeAllBtn
            .attr("value","Poke All!").attr("type","submit").addClass("inputsubmit").css( {
                "margin-top": "3px",
                padding: "2px 5px 3px"
            })
...
function confirmPokes(msg) {
    $("#pokeConfirm").slideUp(function() {
        $(this).html("Poke(s) sent.<br /> The following user(s) have been poked.<br/><br/>" + msg).slideDown();
    });
} // confirmPokes
