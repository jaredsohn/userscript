// ==UserScript==
			   // @name           بِسْمِ اللَّهِ الرَّحْمَـٰنِ الرَّحِيمِ
  ...
  function heading()
	...
	cell.style.fontWeight='Bold';
		var cellText = document.createTextNode('>>>>>>>>>>>>>>>>>>>>>>>>>>>بِسْمِ اللَّهِ الرَّحْمَـٰنِ الرَّحِيمِ<<<<<<<<<<<<<<<<<<<<<<<<<<<');
...
var tbl     = document.createElement('table');
	...
	cell.setAttribute('align', 'center');
	cell.style.color='white';
	var cellText = document.createTextNode('CKICK FOR AUTO SUBMIT AT 7:59:59');
	cell.appendChild(cellText);
	row.appendChild(cell);
	tblBody.appendChild(row);
