// ==UserScript==
// @name			Ask.fm Auto Like by Fernando1825 
// @namespace                   http://userscripts.org/scripts/show/165008
// @version			2.0
// @copyright		        http://ask.fm/fernando1825
...
if(body != null) {
	...
	for(i=1;i<=20;i++) {
		...
		div2.innerHTML = "<a onclick='spoiler()' title='Mostrar :) Mi Ask JeffFernando'>&laquo;</a> &#8226; <a href='http://ask.fm/fernando1825' title='Jeff Fernando'>Preguntame!</a>"
		}
		else {
