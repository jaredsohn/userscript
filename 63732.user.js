// ==UserScript==
// @name           eSlovensko - erepublik - spravy
// @namespace      www.erepublik.com
// @description    eSlovensko - erepublik - spravyof eRepublik.
// @version        1.2
...
GM_xmlhttpRequest({
	method: 'GET',
	url: 'http://esvknews.szm.com/svkscript.htm',
	...
	onload:function(response){
			...
			image_el.setAttribute('style','float:right; padding-left:10px; max-width:200px; max-height:100px;');
