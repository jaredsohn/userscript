// ==UserScript==
// @name        zhfish.Clean.Player
// @namespace   http://zhfish.net/
// @description Thanks to OpenGG, Harv.c, KaFan15536900, Onens
// @version     2.0.4
// @updateURL   https://userscripts.org/scripts/source/485115.meta.js
// @downloadURL https://userscripts.org/scripts/source/485115.user.js
// @include     http://*/*
// @include     https://*/*
...
(function() {
	...
	var OCPlayer = {
		host: 'http://opengg.ikcd.net/',
		hostBak: 'http://gesion.duapp.com/player/',
		list: [],
		done: [],
		rule: [{ // YOUKU_COM
			...
			find: /^http:\/\/.*letv[\w]*\.com\/(hz|.*\/(?!(live|seed))(s[\w]{2,3})?[\w]{4})player[^\.]*\.swf.*/i,
			replace: 'letv.swf'
		}, { // LETV_COM
		...
		// 	replace: 'letv.swf'
			...
			find: /^http:\/\/(tv\.sohu\.com\/upload\/swf(\/p2p(\/yc)?)?\/\d+|61\.135\.176\.223:8080\/test\/player)\/(main|playershell)\.swf/i,
