...
// @name	Trooptool Updater GR (gr1)
// @description	Update your troop tool with one click from the rally point. (Ready for s1.travian.gr)
...
var sLang = "gr";
var sGetParameters = "";
var sCurrentServer = "s1.travian.gr";    // Set this to the server's url to override automatic server detection
                            // (i.e. s1.travian.net)
