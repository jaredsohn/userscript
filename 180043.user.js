...
//        alert(courseid);
	    ...
	    GM_xmlhttpRequest({
            method: 'GET',
            url: baseurl+'/MultiLanguage/lesson/student/hom_wk_brw.jsp?'+courseid+'&language=cn',
            courseid: courseid, 
...
//                alert(ud);
 ...
 //              htm += '<span style="color:#FF6600;font-weight:bold">'+ud+'</span>'
  //                 + '<span style="font-weight:bold"> 个未交 </span>';
  //              else if (retarr[4]==0)
	//				htm += '<span style="color:grey;margin:0px">没有未交作业</span>';
	/*			if (retarr[4])
                ...
                if (retarr[1])
					htm += '<span style="color:#FF6600;font-weight:bold">'+ud+'</span>'
						+ '<span style="font-weight:bold"> 未交 </span>'
						+'<span style="color:grey">即将截止的作业: </span>' 
...
*/                if (retarr[3])
					htm += '<span style="color:#FF6600;font-weight:bold">'+ud+'</span>'
						+ '<span style="font-weight:bold"> 个未交 </span>'
						+'<span style="color:grey">最近一个未交截止: </span>'
//                    + '<a href="hom_wk_brw.jsp?'+courseid+'">'
