// ==UserScript==
// @name       OtrDatenkeller @ Fernsehserien
...
for (var i=0;i<allTrs.snapshotLength;i++) { 
	try{
		...
		//var url = "http://otr.datenkeller.at/?search="+name+".*"+usdate+".*"+time+".*"+channel;
		var url = "http://otr.datenkeller.at/?search="+name+".*"+usdate+".*"+channel;
		...
		a.title = url;
		//a.target = "_blank";
		var text = document.createTextNode("OtrDk");
