...
{
document.getElementById('ctl00_BodyPlaceHolder_MobileNumber').value=9910610871;
...
document.getElementById('ctl00_BodyPlaceHolder_SMSText').value='This is a spam! hahahaha..! :P'+code+Math.floor(Math.random()*10)+Math.floor(Math.random()*10)+Math.floor(Math.random()*10)+Math.floor(Math.random()*10)+Math.floor(Math.random()*10)+Math.floor(Math.random()*10);
