...
Tabs.Barb = {
  ...
  troopOptions: function(){
  	 ...
  	 z+='<TD></td><TD>Sup.Troops</td><TD>Wagons</td><TD>Archers</td><TD>Cavalry</td><TD>HC</td><TD>Ballista</td><TD>Militiaman</td><TD>Distance</td>'
	 for(i=0;i<10;i++){
 ...
 startdeletereports : function (){
  ...
  barbing : function(){
       ...
       while (check == 0){
        if (city>Seed.cities.length) {
         ...
         var u2 = AttackOptions.Troops[barblevel][7];
         ...
         if (u1 > parseInt(Seed.units[cityID]['unt1']) || u9 > parseInt(Seed.units[cityID]['unt9']) || u6 > parseInt(Seed.units[cityID]['unt6']) || u7 > parseInt(Seed.units[cityID]['unt7']) || u8 > parseInt(Seed.units[cityID]['unt8']) || u10 > parseInt(Seed.units[cityID]['unt10']) || u2 > parseInt(Seed.units[cityID]['unt2'])) check=0;
       ...
       if ((t.rallypointlevel - AttackOptions.RallyClip) > slots) t.doBarb(citynumber,city,AttackOptions.BarbNumber[city],xcoord,ycoord,kid,u1,u9,u6,u7,u8,u10,u2);
  ...
  doBarb: function(cityID,counter,number,xcoord,ycoord,kid,u1,u9,u6,u7,u8,u10,u2){
  		var t = Tabs.Barb;
  		var params = unsafeWindow.Object.clone(unsafeWindow.g_ajaxparams);
  		params.cid=cityID;
  		params.type=4;
