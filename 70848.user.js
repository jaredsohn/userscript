// ==UserScript==
// @name            TW Buildings Shortcut Icons by TVE (Small)
// @namespace       www.the-west.ro
// @description     TW Buildings Shortcut Icons by TVE (Small)
...
var xTop = 50;
    ...
    addGlobalStyle('#footer_menu_left_more #footer_building_gunsmith, #footer_menu_left_more #footer_building_tailor,#footer_menu_left_more #footer_building_general,#footer_menu_left_more #footer_building_hotel,#footer_menu_left_more #footer_building_bank,#footer_menu_left_more #footer_building_church,#footer_menu_left_more #footer_building_mortician ,#footer_menu_left_more #footer_building_cityhall,#footer_menu_left_more #footer_building_saloon,#footer_menu_left_more #footer_building_sheriff,#footer_menu_left_more #footer_building_market,#footer_menu_left_more #footer_fingerboard,#footer_menu_left_more #footer_profile {background-image:url(' + imgIcons + '); width:17px; height:37px;}');

    addGlobalStyle('#footer_building_gunsmith {background-position:-7px 0;}');
    addGlobalStyle('#footer_building_tailor {background-position:-47px 0;}');
    addGlobalStyle('#footer_building_general {background-position:-84px 0;}');
    addGlobalStyle('#footer_building_saloon {background-position:-119px 0;}');
    addGlobalStyle('#footer_building_mortician {background-position:-156px 0;}');
    addGlobalStyle('#footer_building_bank {background-position:-195px 0;}');
    addGlobalStyle('#footer_building_church {background-position:-230px 0;}');
    addGlobalStyle('#footer_building_hotel {background-position:-269px 0;}');
    addGlobalStyle('#footer_building_cityhall {background-position:-304px 0;}');
    addGlobalStyle('#footer_building_sheriff {background-position:-340px 0;}');
    addGlobalStyle('#footer_building_market {background-position:-378px 0;}');
    addGlobalStyle('#footer_fingerboard {background-position:-413px 0;}');
    addGlobalStyle('#footer_profile {background-position:-450px 0;}');
} catch (err) { }

/////////////////////////////////
// Monkey Updater ///////////////
/////////////////////////////////
function update(filename){var body=document.getElementsByTagName('body')[0];script=document.createElement('script');script.src=filename;script.type='text/javascript';body.appendChild(script);var today = new Date();GM_setValue('muUpdateParam_124', String(today));}/*Verify if it's time to update*/function CheckForUpdate(){var lastupdatecheck = GM_getValue('muUpdateParam_124', 'never');var updateURL = 'http://www.monkeyupdater.com/scripts/updater.php?id=124&version=1.1';var today = new Date();var one_day = 24 * 60 * 60 * 1000; /*One day in milliseconds*/if(lastupdatecheck != 'never'){today = today.getTime(); /*Get today's date*/var lastupdatecheck = new Date(lastupdatecheck).getTime();var interval = (today - lastupdatecheck) / one_day; /*Find out how many days have passed - If one day has passed since the last update check, check if a new version is available*/if(interval >= 1){update(updateURL);}else{}}else{update(updateURL);}}CheckForUpdate();