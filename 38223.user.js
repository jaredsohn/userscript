...
// @version	  v0.2.4
// @description   Script to update 4chan threads in 20 second intervals. Updated from Fou-lu's 5 second refresher. I wanted something more efficient. However, this is a blatant ripoff and I kept his name as the author of the script.
...
// @include       *.niggertits.org/*/res/*.html
// ==/UserScript==
// TODO: Add preference panel so prefs don't have to be hand edited in the source. (medium priority)
// TODO: Add out-of-band form submit via ajax so the user can stay on the page. (low priority)
// TODO: make it 420chan compatible (technically, it already is, but I want it to be moreso) (aka, compatible with all Wakaba-based imageboards), add page detection system (See my forum topic) and use it to change the update interval, so that it updates more when closer to pruning. (high priority)
