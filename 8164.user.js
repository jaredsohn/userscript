// ==UserScript==
// @name           Kapacitet flote
// @description    Prikazuje kapacitet flote
...
var suma3=0;
	...
	if(Resources>suma1){
		...
		surstr+='&nbsp;&nbsp;MT: '+dot(Math.ceil((Resources-suma1)/5000))+'&nbsp;&nbsp;VT: 

'+dot(Math.ceil((Resources-suma1)/25000));
	}else{
		surstr='0';
	}
 s[k].innerHTML='<font color="#AAAAFF">Preostalo: '+surstr+' </font>&nbsp;&nbsp;<font color="#00FF00">Kapacitet: 

'+dot(suma1)+
 //' speed: '+dot(suma2)+' Potrosnja: '+dot(suma3)+
 '</font>';
}
...
surstr+=' MT: '+dot(Math.ceil(Resources/5000))+' VT: '+dot(Math.ceil(Resources/25000));
//Capacity
var s=document.getElementsByTagName('th');
k=s.length-1;
s[k].innerHTML='<font color="#9999FF">Resursi: '+surstr+' </font>&nbsp;&nbsp;<font color="#00FF00">Kapacitet: 0 '+
