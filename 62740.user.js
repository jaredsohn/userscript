...
// ==/UserScript==
   ...
   var style = "body{color: yellow ; background: #303130 none repeat scroll 0 0; font color: #ffffff;}";
   style += ".bigusername { font-size: 12pt; }";
   style += ".tborder {background: pink color: #303130; border: 1px solid #ffffff;}";
   style += ".page{background: #303130 none repeat scroll 0 0}";
   style += ".alt1,.alt1Active{background: #d2d2d2 none repeat scroll 0 0}";
   style += ".alt2,.alt2Active{background: #d2d2d2 none repeat scroll 0 0}";
   style += ".panel{background: #303130 none repeat scroll 0 0; border: 2px outset; color: white; padding: 10px;}";
   style += "a:visited, body_avisited{color: #3c3c3c; text-decoration: none;}";
   style += ".tcat {background: #0b0808 repeat-x top left; color: #a11c1c style += ; font: bold 10pt verdana, geneva, lucida, 'lucida grande', arial, helvetica, sans-serif;}";
   style += ".eoctitlebar a:link, .eoctitlebar a:visited { color: #efefef; font: 13px Arial; font-weight: bold; text-decoration: none;}";
   style += ".eoctitlebar a:hover, .eoctitlebar a:active { color: #ffffff; font: 13px Arial; font-weight: bold; text-decoration: underline;}";
   ...
   style += ".tfoot {background: #0b0808; color: #ab12ab;}";
   style += "a:link, body_alink {color: #4e4e4e;}";
   style += ".thead {background: #0b0808 repeat-x top left; color: #FFFFFF; font: bold 11px tahoma, verdana,  geneva, lucida, 'lucida grande', arial, helvetica, sans-serif;}";   
   style += ".vbmenu_control {background: #0b0808; color: #FFFFFF; font: bold 11px tahoma, verdana, geneva, lucida, 'lucida grande', arial, helvetica, sans-serif; padding: 3px 6px 3px 6px; white-space: nowrap;}";
   ...
   head.appendChild(el);
// ==UserScript==
// @name            Platypus-forums.extremeoverclocki
// @namespace       Platypus
// @include 	http://forums.extremeoverclocking.com/*
// @include 	http://www.forums.extremeoverclocking.com/*
// ==/UserScript==
function do_platypus_script() {
set_style_script(window.document,document.evaluate('/HTML[1]/BODY[1]/TABLE[1]/TBODY[1]/TR[3]/TD[1]/TABLE[1]/TBODY[1]/TR[1]/TD[1]', document, null, XPathResult.FIRST_ORDERED_NODE_TYPE,null).singleNodeValue,"color: white;background-color: black;",null,null);
set_style_script(window.document,document.evaluate('/HTML[1]/BODY[1]/DIV[1]/DIV[1]/DIV[1]/TABLE[3]/TBODY[1]/TR[1]/TD[1]/TABLE[1]/TBODY[1]/TR[1]/TD[1]', document, null, XPathResult.FIRST_ORDERED_NODE_TYPE,null).singleNodeValue,"color: white;background-color: black;",null,null);
set_style_script(window.document,document.evaluate('/HTML[1]/BODY[1]/DIV[1]/DIV[1]/DIV[1]/TABLE[3]/TBODY[1]/TR[1]/TD[3]/TABLE[1]/TBODY[1]/TR[1]/TD[1]', document, null, XPathResult.FIRST_ORDERED_NODE_TYPE,null).singleNodeValue,"color: white;background-color: black;",null,null);
set_style_script(window.document,document.evaluate('/HTML[1]/BODY[1]/DIV[1]/DIV[1]/DIV[1]/TABLE[3]/TBODY[1]/TR[1]/TD[5]/TABLE[1]/TBODY[1]/TR[1]/TD[1]', document, null, XPathResult.FIRST_ORDERED_NODE_TYPE,null).singleNodeValue,"color: white;background-color: black;",null,null);
set_style_script(window.document,document.evaluate('/HTML[1]/BODY[1]/TABLE[1]/TBODY[1]/TR[3]/TD[1]/TABLE[1]/TBODY[1]/TR[1]/TD[2]', document, null, XPathResult.FIRST_ORDERED_NODE_TYPE,null).singleNodeValue,"color: white;background-color: black;",null,null);
set_style_script(window.document,document.evaluate('/HTML[1]/BODY[1]/TABLE[1]/TBODY[1]/TR[1]/TD[1]', document, null, XPathResult.FIRST_ORDERED_NODE_TYPE,null).singleNodeValue,"color: white;background-color: black;",null,null);
set_style_script(window.document,document.evaluate('/HTML[1]/BODY[1]/TABLE[1]/TBODY[1]/TR[1]/TD[2]', document, null, XPathResult.FIRST_ORDERED_NODE_TYPE,null).singleNodeValue,"color: white;background-color: black;",null,null);
set_style_script(window.document,document.evaluate('/HTML[1]/BODY[1]/TABLE[1]/TBODY[1]/TR[1]/TD[3]', document, null, XPathResult.FIRST_ORDERED_NODE_TYPE,null).singleNodeValue,"color: white;background-color: black;",null,null);
set_style_script(window.document,document.evaluate('/HTML[1]/BODY[1]/TABLE[1]/TBODY[1]/TR[1]/TD[1]/A[1]/IMG[1]', document, null, XPathResult.FIRST_ORDERED_NODE_TYPE,null).singleNodeValue,"color: white;background-color: black;",null,null);
set_style_script(window.document,document.evaluate('/HTML[1]/BODY[1]/TABLE[1]/TBODY[1]/TR[3]/TD[1]/TABLE[1]/TBODY[1]/TR[1]/TD[2]', document, null, XPathResult.FIRST_ORDERED_NODE_TYPE,null).singleNodeValue,"background-color: black;",null,null);
