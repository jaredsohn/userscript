// ==UserScript==
// @name           Wer kennt wen? Autoreload und akustische neue Nachrichten V2
// @namespace      MetaIIica
// @description    Lädt die "Wer kennt wen?"-Startseite automatisch neu, um automatisches Ausloggen zu verhindern und zeigt neue Nachrichten akustisch an
...
function checkmail() {
 tds= document.getElementsByClassName("wkwNotification wkwTr notifyMessagesActive")[0]
 if(tds) {
	 if(GM_getValue("boolsound")) {
