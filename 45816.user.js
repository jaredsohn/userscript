// ==UserScript==
// @name          BYBS Military Attack Calculator (Việt hóa)
// @version       1.0
...
function createTextDiv() {
	...
	$("#reportInboxLeft .content .centerButton").before( $(
		'<div id="ikariamMilitaryTxtDiv">' +
			'<ul>' +
				'<li class="militaryInfo"><span class="hdr">Quân lính:</span><br/>' +
					'<ul>' +
						'<li class="data"><span class="textLabel">Tấn Công: </span><div class="troopAttScore">0</div></li>' +
						'<li class="data"><span class="textLabel">Phòng Ngự: </span><div class="troopDefScore">0</div></li>' +
						'<li class="data"><span class="textLabel">Sức lực: </span><div class="troopStaScore">0</div></li>' +
						'<li class="data"><span class="textLabel">Tường thành: </span><div id="wallBonus">0</div></li>' +
					'</ul>' +
				'</li>' +
				'<li class="militaryInfo"><span class="hdr">Tàu Thuyền:</span><br/>' +
					'<ul>' +
						'<li class="data"><span class="textLabel">Tấn công: </span><div class="shipAttScore">0</div></li>' +
						'<li class="data"><span class="textLabel">Phòng Ngự: </span><div class="shipDefScore">0</div></li>' +
						'<li class="data"><span class="textLabel">Sức lực: </span><div class="shipStaScore">0</div></li>' +
					'</ul>' +
				'</li>' +
			'</ul>'
