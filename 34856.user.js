 ...
 *
 * Revision 2.20.6 2007/10/25 kcs2c
 * - 
...
// ** Global Variables
// ***************************************************************************
const scriptversion = '2.20.5';
const scriptversionID = 'Red Evo+ ' + scriptversion;
const scriptTag = 'Red Strikes Back';
const EVO_DEBUG = true;
const REDFORUM_URL = 'http://www.redalliance.info/'; 
...
EVO_debug("Begin scans",99);
	//var tick = document.evaluate("//DIV", document, null, XPathResult.ANY_TYPE, null);
    ...
    if (scan.indexOf("Sector Scan") != -1){
		...
		var strTest = intStartCoords + " " + intEndCoords + " " + strContinent + " " + unalloc + " " + alloc[0] + " " + alloc[1] + " " + alloc[2] + overallAttack.toFixed(0) + " " + overallDefenceDef.toFixed(0) + " " + strPlayer+ " " + strScore + " " + strMetalRes + " " + strMineralRes + " " + strFoodRes;
		
		EVO_debug(strTest,99);
		var postData		= "";
		//postData = "http://64.83.50.74/RedOracle1/Service1.asmx/RecordSectorScan&p_strContinent=" + "test"
