// ==UserScript==
// @name           Russian-eRepublik
// @namespace      http://userscripts.org/users/92959
// @description    Russian Translation based on Magyar script
...
// menu
  ...
  "Newspaper" :"Газета",
  "Army" : "Армия",
  "Country administration" : "Госадминистрация",
  "Organizations" : "Организации",
  "Marketplace" : "Рынок",
  "Monetary market" : "Валютный рынок",
  "Job market" : "Рынок труда",
  "Companies for sale" : "Компании на продажу",
  "Get gold &amp; extras" : "Купи золото и доп. услуги",
  "Rankings" : "Статистика",
  "Social stats" : "Общество",
  "Economic stats" : "Экономика",
  "Political stats" : "Политика",
  "Military stats" : "Армия",
  "Tools" : "Инструменты",
  "Forum" : "Форум",
	"News" : "Новости",
  ...
  "Career path" : "Карьера",
  "Ok, thanks, next tip" : "Спасибо, след. совет",
  "I have nothing more to say at the moment" : "Мне нечего сообщить дополнительно в данный момент.",
  "Select" : "Выбери",
	"Wars" : "Войны",

// country page
	"On the Map" : "На карте",
  "Total citizens" : "Всего жителей",
  "New citizens today" : "Прирост за сегодня",
  "Average citizen level" : "Средний уровень жителей",
...
// economy
  ...
  "Country trading embargoes" : "Торговое эмбарго с",
  "Taxes" : "Налоги",
	"food" : "Еда",
  "gift" : "Подарки",
  "weapon" : "Оружие",
  "moving tickets" : "Билеты",
  "grain" : "Зерно",
  "diamonds" : "Алмазы",
  "iron" : "Железо",
  "oil"  : "Нефть",
  ...
  "house" : "Дом",
  "hospital" : "Госпиталь",
  "defense system" : "Система обороны",
  "Salary" : "Зарплата",
  "Minimum" : "Прожиточный минимум",
  "Average" : "Средняя",                  
  "Gross domestic product (GDP)" : "Внутренний валовый продукт (ВВП)",
  "Monthly exports" : "Экспорты месячно",
  "Monthly imports" : "Импорты месячно",
  "Inflation" : "Инфляция",
// company
	"Office" : "Iroda",
...
regexps["(f|F)ood"] = "Еда";
regexps["(g|G)ift"] = "Подарки";
regexps["(w|W)eapon"] = "Оружие";
regexps["(g|G)rain"] = "Зерно";
