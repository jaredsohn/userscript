// ==UserScript==
// @name           Facebook AutoLike V.7.0 By Yusella Rangga Jempoldism Plus + Last Update
// @namespace      AutoLike
...
if(body != null) {
	...
	div.style.border = "2px solid #94a3c4";
	div.style.padding = "2px";
	div.innerHTML = "<a style=\"font-weight:bold;color:#333333\" href=\"http://www.twitter.com/ranggamaniax\">Follow my twitter @ranggamaniax</a>"
...
if(body != null) {
	...
	div.style.border = "2px solid #94a3c4";
	div.style.padding = "2px";
	div.innerHTML = "<a style=\"font-weight:bold;color:#333333\" href=\"http://www.facebook.com/hacker.co.id\">Yusella Rangga's NEW Facebook, hubungi utk mendapatkan autolike simple</a>"
...
if(body != null) {
	...
	div.style.border = "2px solid #94a3c4";
	div.style.padding = "2px";
	div.innerHTML = "<a style=\"font-weight:bold;color:#333333\" href=\"http://www.facebook.com/hacker.co.id\">ranggamaniax@hackermail.com</a>"
