...
// W - Chat Racin 87
// X - spare 88
// Y - wd x 5 lesser shied 89
// Z - wd x 5 lesser focus 90
...
function keyHandler(event) {
  ...
  if (k == 65) {
    document.location.href = 'http://92.48.103.52/fantasy/game.php?screen=CHAT&var2=';
  }
if (k == 66) {
    ...
    document.location.href = ' http://92.48.103.52/fantasy/game.php?var1=Potion&var2=Lesser+Healing+Potion&var3=%3C+100%25&var4=%3E+0&var5=%3E+0&var6=None&var7=PvM&var8=100&var10=27058&command=updaterule&screen=ADVANCEDCOMBAT&Submit2=Submit';
  } if (k == 69) {
    ...
    document.location.href = 'http://92.48.103.52/fantasy/game.php?command=swapcharacter&var1=18512';
  } if (k == 72) {
    document.location.href = 'http://92.48.103.52/fantasy/game.php?command=swapcharacter&var1=16427';
  } if (k == 73) {
    ...
    document.location.href = 'http://92.48.103.52/fantasy/game.php?screen=CHAT&var2=15964';
  } if (k == 84) {
    ...
    document.location.href = 'http://92.48.103.52/fantasy/game.php?var5=16427&var1=Lesser+Focus+Scroll&command=use&screen=SCROLLS';
  } if (k == 50) {
    document.location.href = 'http://92.48.103.52/fantasy/game.php?var5=16427&var1=Lesser+Shield+Scroll&command=use&screen=SCROLLS';
  } if (k == 51) {
    document.location.href = 'http://92.48.103.52/fantasy/game.php?var5=16427&var1=Summon+Skeleton&command=use&screen=SCROLLS';
  } if (k == 52) {
    document.location.href = 'http://92.48.103.52/fantasy/game.php?var5=16427&var1=Shield+Scroll&command=use&screen=SCROLLS';
  } if (k == 53) {
    document.location.href = 'http://92.48.103.52/fantasy/game.php?var5=16427&var1=Focus+Scroll&command=use&screen=SCROLLS';
  } if (k == 54) {
    ...
    document.location.href = ' http://92.48.103.52/fantasy/game.php?screen=PVP&command=Attack&var1=';
}if (k == 59) {
    document.location.href = ' http://92.48.103.52/fantasy/game.php?screen=PVP&command=Attack&var1=';
  } if (k == 48) {
    document.location.href = 'http://92.48.103.52/fantasy/game.php?screen=PVP&command=Attack&var1=';
