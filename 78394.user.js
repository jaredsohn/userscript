// ==UserScript==
// @name           formulawan_agrandissement_ecurie
// @namespace      formulawan_ag_ecurie
// @description    Ce script permet de rajouter des informations dans la partie personnel. 
// @include	   http://www.formulawan.fr/Fenetre_Staff.php?action=Gestion
// @version	   1.0
// @licence	   GPLv3
// ==/UserScript==
...
var lvl_ecurie = parseInt(document.getElementsByClassName('table largeTable')[0].getElementsByTagName('td')[3].textContent.replace(new RegExp('Niveau|,| |\t|\n|\r|', 'g'),''));
...
function trigger(){
	...
	div_txt.textContent = "(et "+nb_places+" place"+pluriel+" de différence)";
...
center_th.textContent = "Résumé des dépenses et simulation"
var tr_contenu = document.createElement("tr");
var td_gauche = document.createElement("td");
var td_droit = document.createElement("td");
td_gauche.colSpan = 2;
td_droit.colSpan = 2;
var contenu_droit = "<center>Dépenses totales: <span class=\"money\" title=\""+
...
var contenu_gauche = "Niveau " + lvl_ecurie;
...
div_txt.textContent = "(et 0 place de différence)";
