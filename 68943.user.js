// ==UserScript==
// @name           The Church of Thorn
// @namespace      And Thorn said, "Let there be dotball," and there was dotball.
...
function findName(test) {
    if (test.innerHTML.indexOf('/game/forum_thread_list.pl?forum_id=4495', 0)>=0) return 1;
  return 0;
}
