...
// ==Version History==
// 1.23a Updated on 4/4/09
// --changes by Centic to fix links in the message frame and Nav screen
//
...
var enableTransferCredits = false;

// have separate bookmarks for each universe
var enableArtemisCustomLink1 = true;
var customArtemisLink1Name = 'Manticorp';
var customArtemisLink1URL = 'http://forum.manticorp.conglomo.org';
var enableArtemisCustomLink2 = true;
var customArtemisLink2Name = 'Pardus Data Vault';
var customArtemisLink2URL = 'http://www.pardusdv.com';
var enableArtemisCustomLink3 = true;
var customArtemisLink3Name = 'Butterfat Maps';
var customArtemisLink3URL = 'http://pardus.butterfat.net/pardusmapper/maps/artemis/universe.html?universe=artemis';

var enableOrionCustomLink1 = true;
var customOrionLink1Name = 'Conglomo';
var customOrionLink1URL = 'http://forum.conglomo.org';
var enableOrionCustomLink2 = true;
var customOrionLink2Name = 'Pardus Data Vault';
var customOrionLink2URL = 'http://www.pardusdv.com';
var enableOrionCustomLink3 = true;
var customOrionLink3Name = 'Butterfat Maps';
var customOrionLink3URL = 'http://pardus.butterfat.net/pardusmapper/maps/orion/universe.html?universe=orion';

var enablePegasusCustomLink1 = true;
var customPegasusLink1Name = 'Conglomo';
var customPegasusLink1URL = 'http://www.conglomo.org/joomla/';
...
var customPegasusLink3Name = 'Butterfat Maps';
var customPegasusLink3URL = 'http://pardus.butterfat.net/pardusmapper/maps/pegasus/universe.html?universe=pegasus';
...
function getSectorName()
{
  ...
  return mainframe.getElementById('sector').innerHTML;
}
...
if(location.pathname.search(/main.php/i) != -1)
{
  ...
  for(var i = 0; i < document.links.length; i++)
  {
    ...
    if(a.getAttribute('href').search(/main.php[?]ccc=1/i) != -1 && a.innerHTML.indexOf('class="nf"') == -1 && a.innerHTML.indexOf("class='nf'") == -1)
    {
      var child = document.createElement("div");
      child.setAttribute("style", "position:relative; top:6px; margin-left: 12px; margin-top: 5px; margin-bottom: 7px;");
      if(enableShip)  child.innerHTML = child.innerHTML + "<a href='overview_ship.php'>Ship Overview</a>";
      if(enableShip) { a.parentNode.parentNode.parentNode.parentNode.parentNode.insertBefore(child,a.parentNode.parentNode.parentNode.parentNode.parentNode.firstChild); i++; }
    }
...
if(location.pathname.search(/overview_buildings.php/i) != -1)
{
  ...
  var child = document.createElement("div");
  child.setAttribute("align", "center");
//  if(enableBuildingTool)  child.innerHTML = child.innerHTML + "<a href='http://pardus.rukh.de/building_upgrade.html' target='_blank'>Pardus Building Tool</a>";
