...
ResCalc = 
{
	...
	init : function()
	{
		...
		uW.PopupFactory.addTexts({
					rcwood_lost  : "<h4>Bois</h4>Co˚t de base en bois des unitÈs perdues sans tenir compte des recherches <i>Conscription</i> et <i>MathÈmathiques</i>.",
					rcstone_lost : "<h4>Pierre</h4>Co˚t de base en pierre des unitÈs perdues sans tenir compte des recherches <i>Conscription</i> et <i>MathÈmathiques</i>.",
					rciron_lost  : "<h4>Argent</h4>Co˚t de base en argent des unitÈs perdues sans tenir compte des recherches <i>Conscription</i> et <i>MathÈmathiques</i>.",
					rcfavor_lost : "<h4>Faveur</h4>Co˚t en points de faveur des unitÈs perdues.",
					rcbh_lost    : "<h4>Population</h4>Places dans la population occupÈes par les unitÈs perdues.",
					rcatt_lost   : "Co˚t pour l'attaquant.",
					rcdef_lost   : "Co˚t pour le dÈfenseur.",
					openResBox   : "Montrer les pertes en ressources.",
					closeResBox  : "Cacher les pertes en ressources.",
					wallYourCosts: "Co˚t de vos unitÈs.",
					wallFoeCosts : "Co˚t des unitÈs adverses."
				});
		...
		if ( ResCalc.UnitData )
		{
			...
			else if ( uW.document.URL.indexOf( "action=simulator") > 0 ) 
			{
				...
				ResCalc.createResPopup('fcSim', 'Ressources perdues');
			...
			else if ( uW.document.URL.indexOf( "game/building_wall?") > 0 ) 
			{
				...
				ResCalc.createResPopup( 'fcWall', 'Total des ressources' );
				...
				if (rv)
				{
					...
					if ( attCostsTable.length | defCostsTable.length )
					{
						var sumNode = $("<div style='text-align:left;font-size:9px;'>"
								+"<center><span style='text-decoration:underline;'><b>Co˚t des pertes</b></span>"
								+"<table cellpadding='0px' cellspacing='0px'>"
								+"<tr><td>"+attCostsTable+"</td>"
								
								+ "<td><b><table cellpadding='0px' cellspacing='0px'>"
								+ "<tr><td align=center>Bois</td></tr>"
								+ "<tr><td align=center>Pierre</td></tr>"
								+ "<tr><td align=center>Argent</td></tr>"
								+ "<tr><td align=center>Faveur</td></tr>"
								+ "<tr><td align=center>&nbsp;&nbsp;Population&nbsp;&nbsp;</td></tr></table></b></td>"
