...
// @include        http://*fantasysports.yahoo.com/hockey/*
// @exclude        http://basketball.fantasysports.yahoo.com/*
// ==/UserScript==
/*
   ...
   Change log:
      ...
      2010-Feb-16  Shortformed Name, Added support for all sports except bball (4-Link) EG
      2012-Jan-22  Switched Roti category to show stats for last 14 days   EG
...
(function() {
    ...
    if (scoringType('Matchup') == 'H2H') {
	   addFilter = 'stat1=S_L7';}
	else {
	   addFilter = 'stat1=S_L14';}
