// ==UserScript==
                                // @name           Ignore Kai script; (taken from Iceman's Ignore Script)
                                // @namespace      Forum
                                // @include        http://goallineblitz.com/game/forum_thread.pl?*
                                // @include        http://goallineblitz.com/game/forum_thread_list.pl?*
                                // ==/UserScript==
                                
                                var list = ['ImTheScientist', ' Skanker irl', 'Ubasstards', 'Domer', 'jfcvsrxb', 'coreyls18', 'Polorl69', ,'Handcuffed', 'blacksunshyne', 'hokeez', 'UCLABUCSFAN', 'Vikings284', 'jallowe', 'JuniorMcSpiffy', 'uoY_redruM', 'suske127', 'supersonics', 'David Stern', 'inurbase', 'Lee06', 'Ravenwood', 'MDterpsBBall03', 'Lord Thomas Drake', 'quzur', 'Stutts11T', 'Ahrens858', 'IJesus', 'tortop', 'bid2', 'nlnwalsh', 'RevanX', 'LoperKTHNXBAI', 'Timetoshine', 'SteelCity Mafia', 'Alpha Q', 'titans15', 'icefreeze57', 'JoeFlacco05', 'Sciz', 'DAKING', 'Mr. AdamZona', 'slntkilla', 'Raindeer58', 'kostitsyn', 'Walshy.', 'allnotorious', 'gherman', 'Osmlol', '5STAR', 'GP1'];
