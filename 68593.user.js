// ==UserScript==
// @name            Crítica Digital article print
// @include         http://*criticadigital.com/index.php?secc=nota&nid=*
// @include         http://*criticadigital.com/impresa/index.php?secc=nota&nid=*
// ==/UserScript==

function do_platypus_script() {
fix_page_it(window.document,'/HTML[1]',null,null,null);
isolate(window.document,document.getElementById('textoNota'),null,null,null);
relax(window.document,document.getElementById('textoNota'),null,null,null);
