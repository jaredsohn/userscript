// ==UserScript==
// @name           Travian Map (AE) HU
// @namespace      TRAVIAN MAP
// @author         SANJoOoB Kovpeti
// @description    LARGE MAP BUTTON Hungarian version
// @version        2.6.2
...
//	loadFalseData();
	...
	function createInfoBox() {
		...
		info.innerHTML = '<table class="f8 map_infobox_grey" width="100%" cellspacing="1" cellpadding="2">' +
				 '<tr><td class="c b" colspan="2" align="center">' + 'Részletek:' + '</td></tr>' +
				 '<tr><td class="c s7" width="45%" >' + 'Játékos:' + '</td><td class="c s7">-</td></tr>' +
				 '<tr><td class="c s7">' + 'Népesség:' + '</td><td class="c s7">-</td></tr>' +
				 '<tr><td class="c s7">' + 'Klán:' + '</td><td class="c s7">-</td></tr>' +
				 '</table>';
		return info;
	}
	...
	function createMapAreas() {
		var map = dst.cn('map');
		map.name = 'map2';
		map.innerHTML = '<area dir="north" href="#" coords="762,115,30" shape="circle" title="Észak">' +
				'<area dir="east"  href="#" coords="770,430,30" shape="circle" title="Kelet">' +
				'<area dir="south" href="#" coords="210,430,30" shape="circle" title="Dél">' +
				'<area dir="west"  href="#" coords="200,115,30" shape="circle" title="Nyugat">';
		...
		return function() {
			...
			if (name) {
				var table = '<table cellspacing="1" cellpadding="2" class="tbg f8"><tr><td class="rbg f8" colspan="2"></a>' + name +
					    '</td></tr><tr><td width="45%" class="s7 f8">' + 'Játékos:' +
					    '</td><td class="s7 f8">' + owner +
					    '</td></tr><tr><td class="s7 f8">' + 'Népesség:' +
					    '</td><td class="s7 f8" id="ew">' + pop +
					    '</td></tr><tr><td class="s7 f8">' + 'Klán:' +
					    '</td><td class="s7 f8">' + ally +
					    '</td></tr></table>';
				info.innerHTML = table;
			}
			else {
				var table = '<table class="f8 map_infobox_grey" cellspacing="1" cellpadding="2"><tr><td class="c b" colspan="2" align="center"></a>' + 'Részletek:' +
					    '</td></tr><tr><td width="45%" class="c s7">' + 'Játékos:' +
					    '</td><td class="c s7">-</td></tr><tr><td class="c s7">' + 'Népesség:' +
					    '</td><td class="c s7">-</td></tr><tr><td class="c s7">' + 'Klán:' +
