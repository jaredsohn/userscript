// ==UserScript==
// @name           Reventinga!
// @namespace      Reventinga!
// @description    Script para la comunidad Reventinga!
// @include        *taringa.net/*
// @exclude        *taringa.net/comunidades/reventinga/*
// ==/UserScript==
...
byClass('menuTabs').innerHTML += "<li id=\"tabbedWTF\" class=\"tabbed\">\n <a href=\"http://www.taringa.net/comunidades/reventinga/\" onclick=\"menu(\'Reventinga! \', this.href);return false;\" title=\"Ir a la comunidad Reventinga!\">Reventinga! <img src=\n\"\" alt=\"\" /></a>\n</li>";
