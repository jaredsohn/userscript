...
for(var v=0;v<allImages.length;v++){
	...
	//7 (edit by EJII)
	if(src.match("http://s2.www.erepublik.net/images/flags_png/L/Belarus.png")){
		allImages[v].setAttribute("src",src.replace("http://s2.www.erepublik.net/images/flags_png/L/Belarus.png","http://img38.imageshack.us/img38/6130/15913888.png"));
	}

	//---XL

	//1
	if(src.match("/images/flags/X.gif")){
