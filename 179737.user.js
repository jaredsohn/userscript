// ==UserScript==
// @name           Wall Manager Sidekick (Criminal Case)
// @description    Assists Wall Manager with Criminal Case posts
// @include        http://imabigfanof.criminalcasegame.com/*
// @include        http://apps.facebook.com/criminalcase/*
// @include        http://www.facebook.com/pages/FB-Wall-Manager/*
// @license        http://creativecommons.org/licenses/by-nc-nd/3.0/us/
// @require        http://userscripts.org/scripts/source/123889.user.js
// @version        3.0.3.1
// @copyright      Robert Bucheler
// ==/UserScript==
...
(function() {
	...
	var version = "3.0.3.1"; //use something like 1.2.3.4 where 1 is the version, 2 is the major revision, 3 is the minor revision, and 4 is a bug fix
	var appID="148494581941991"; //find your appID on facebook or use google
     var scriptID="179737"; //the id of your script on userscripts.org
     var appName="Criminal Case"; //the text name of the app/game you are collecting for
	var appIcon="https://fbcdn-photos-d-a.akamaihd.net/hphotos-ak-ash3/851584_231011917023590_890333026_n.png"; //example:"http://photos-d.ak.fbcdn.net/photos-ak-snc1/v85006/71/100333333405439/app_2_100333333405439_3507.gif"
