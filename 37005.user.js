// ==UserScript==
// @name           Create Street Racing  invites.
// @namespace      Street Race friends.
// @description    Automatically invites people to your mafia that you find on the Challange page. Original Code by Andy Calderbank
// @include        http://apps.facebook.com/streetracinggame/fight.php
// @include        http://apps.facebook.com/streetracinggame/recruit.php
// @include        http://apps.new.facebook.com/streetracinggame/fight.php
// @include        http://apps.new.facebook.com/streetracinggame/recruit.php
// ==/UserScript==
...
if ((!reqID || since > 86400) && document.location.href.indexOf('fight') != -1) {
	document.location.href = 'http://apps.'+((newlayout)?'new.':'')+'facebook.com/streetracinggame/recruit.php';
	return;
}
...
if (document.location.href.indexOf('fight') == -1) {
	...
	var vars = false;
	var members = document.getElementsByXPath("//a[contains(@href,'/streetracinggame/stats.php?user=')]");
	...
	if (vars) {
		...
		GM_xmlhttpRequest({
			method: "POST",
			url: 'http://apps.'+((newlayout)?'new.':'')+'facebook.com/streetracinggame/recruit.php?action=create',
