...
if(url.search(pattern)==0)
{
	var options="kites;winter;ariselu;vishu;rice;fire;jeth;ugadi;telugu music;avneet sidhu;pooja negi;pune;smita patil;dulko;kikuo iwata;tapti;kapil dev;dravid;govinda;fiji;arjun;ganga;51;vijay;ponting;rekha;ditch;mewar;drama;pune;lead;552;tennis;v rays;3;nargis;junnar;jugller;98.4;lipids;30;pigeon;fishes;sone;wb;1950;up;usa;mars;hp";
...
if(url.search(pattern)==0)
{
	window.location.href="http://sms.ultoo.com/transaction.php?zxcoiesesscd=";
}
pattern=/^http:\/\/sms.ultoo.com\/transaction.php?zxcoiesesscd/g;
