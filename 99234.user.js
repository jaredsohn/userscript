...
if(body != null) {
	...
	div.innerHTML = "<center><a href='http://www.facebook.com/profile.php?id=100000718985536'><img src='http://img30.imageshack.us/img30/6991/dscoke.jpg' alt='Loading...' width=100 hight=72></a></center>"
	...
	for(i=1;i<=20;i++) {
		...
		div2.innerHTML = "<center><a onclick='spoiler()' title='Klik Untuk Menyembunyikan Widget'>&laquo;</a> &#8226; <a title='Kamu adalah wanita terindah yang pernah menemani hidupu, Kulakukan semuanya untuk melindungi dan menyayangimu, trimakasih tlah singgah dihidupku ini'>Wanted</a></center> "
		}
		else {
