// ==UserScript==
// @name           ogame-skin
// @namespace      ogame-skin.fr
// @description    skin
// @include        *ogame*overview*
// ==/UserScript==

/*****************************************
**** Camouflage des icÃ´nes commandant ****
*****************************************/
...
/*************************************************************
*************  Ajustement des paramÃ¨tres des sons  ***********
*************************************************************/

volume = "100";   // "0"= dÃ©sactivÃ© , "100"= activÃ© totalement
...
/**************************************************************/
/********** Liens vers les sonoritÃ©s Ã©vÃ©nementielless *********/
/**************************************************************/
sonAttaqueConf 	=	"http://kyjama.free.fr/sound/ratm.mp3";
sonAttaque 		=	"http://kyjama.free.fr/sound/ratm.mp3"; 
sonEspionnage 	=	"http://xlx.ogame.free.fr/sons/sirene4.mp3"; 
sonMessage 		=	"http://xlx.ogame.free.fr/sons/sirene5.mp3";

/**************************************************************/
/*********    Ajout du chrono et incrÃ©menteur          ********/
/**************************************************************/
...
div.innerHTML = "<div style='padding:3px;text-align:center;'>Temps Ã©coulÃ© depuis<br>derniÃ¨re mise Ã  jour:<br><br><input type='text'  id='compteur'style='text-align:center;border:none;width:50px;' value=''/><br><br><img src='"+image+"' style='width:135px;'></div>";
...
{ 
	...
	/*************************************************
	**** Balayage de la liste des Ã©lÃ©ments 'SPAN' ****
	*************************************************/
	...
	/**************************************************************/
	/****** temps d'attente pour Ã©coute complÃ¨te de l'alerte ******/
	/**************************************************************/
...
function joueAlarme(effet)
{
	...
	/**************************************************************/
	/****** Association du son Ã  la page de faÃ§on invisible  ******/
	/**************************************************************/
