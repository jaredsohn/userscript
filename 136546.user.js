// ==UserScript==
// @author         Opium
// @name           SPP Damage Report
// @namespace      SPP Damage Report
// @version	   0.1
// @uso:version    0.1
// @include	       http://*erepublik.com/*/military/battlefield/*
// @description    eRepublik SPP Damage Report
// ==/UserScript==
...
if(window.location.href.indexOf(PAGE_BATTLEFIELD) > 0) {	
	...
	/***** Badaboom *****/
	/***********************************************************************************/
	var FORM_URL = "https://docs.google.com/spreadsheet/viewform?formkey=dHdTZWkwYkktQXBJLWd2ZUNIVVhnR1E6MQ#gid=0";
	var FORM_FIELDS = {
                eZi: "entry.0.single",
                name: "entry.1.single",
	...
	function BattlePage() {
        ...
        var data = {
                ...
                dq6hit: dmgq6hit,
                battle: battleid,
                eZi: $("#header .header_info .eday strong").text(),
