...
// @version        3.2
// @author         Smizzle
// @description	   Easily add emoticons to your facebook conversations.
// ==/UserScript==
//
...
function creaBarra(event){ //prima di chiamare questo metodo controllo la presenza della barra
	...
	popolaBarra(barra);
        ...
        //<div style="clear: both;"><span style="color:blue;">Facebook Chat by </span><span style="color:red; font-size:8px;"> Smizzle.</span></div>
        ...
        cops2.innerHTML=' <a href="http://www.facebook.com/smizzle.v4" target="_blank" style="text-decoration:none;"> Smizzle</a>';
