...
///this script is collected from JoeSimmons s buxtoauto clicker java //source (scripthttp://userscripts.org/scripts/show/31320
// @name           http://www.adssourcing.com auto clicker
// @namespace      http://userscripts.org/users/23652
// @description    Auto Click Ads On http://www.adssourcing.com Auto relads after 2-4mins if no ads are present. By greate developer JoeSimmons (edited bysalman.mohammad999@gmail.com)
// @include        http://www.adssourcing.com/links.php?srt
// @include        http://www.adssourcing.com/index.php
// @include        http://www.adssourcing.com/ad.php?surl=*
// @copyright      great developer JoeSimmons (edited by salman.mohammad999@gmail.com)
// @version        1
// ==/UserScript==
...
/////////////////////////////////
// MADE BY great developer JoeSimmons (edited salman.mohammad999@gmail.com)
//
...
// XPath by salman.mohammad999@gmail.com
...
var ad_page_url = 'links.php?srt',
logout_url = 'logout.php',
index_url = 'index.php',
a = xp("//a[contains(@href, 'ad.php?surl')]",6),
v = xp("//iframe"),
s = xp("//strike"),
url = 'http://' + document.domain + '/',
logoutexist = /logout/i.test(document.body.textContent),
adpage = /ad\.php\?surl=\d+/i.test(lhr);
...
// Switch to links.php?srt if you just logged in
...
// created by JoeSimmons s (http://userscripts.org/scripts/show/31320) 