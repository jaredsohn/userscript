...
// @include        http://apps.facebook.com/ffsgame/users/*
...
*/
var _delay = 5000;
var MAXVALUE = 500000000;	//you can change this max value for personal purposes!
var FFS =
{
    ...
    work: function()
    {
        ...
        setTimeout(FFS.confirmPurchase, 4000);
	setTimeout(FFS.doReload, 4000);
    },
    checkValue: function()
    {
