...
// @description    Una barra di ricerca per Travian!!
// @version        7.12.30
...
//cookie kezelest segito fuggvenyek
//innen: http://www.quirksmode.org/js/cookies.html
...
searchform += '<option value="0"' + selected(0) + '>' + trans('Giocatori') + '</option>';
searchform += '<option value="2"' + selected(2) + '>' + trans('Villaggi') + '</option>';
searchform += '<option value="4"' + selected(4) + '>' + trans('Alleanze') + '</option>';
searchform += '<option value="31"' + selected(31) + '>' + trans('Attaccanti') + '</option>';
searchform += '<option value="32"' + selected(32) + '>' + trans('Difensori') + '</option>';
searchform += '</select>';
searchform += '<input type="submit" value="' + trans('Cerca') + '" class="std" />';
searchform += '</form>';
