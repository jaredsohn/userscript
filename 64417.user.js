// ==UserScript==
// @name            iT-lEaKeD Fasterrr by m477h3w
// @namespace       Platypus
// @include         http://www.it-leaked.com/*
// ==/UserScript==
function do_platypus_script() {
remove_it(window.document,document.evaluate('/HTML[1]/BODY[1]/CENTER[1]/TABLE[1]/TBODY[1]/TR[1]/TD[1]/IMG[1]', document, null, XPathResult.FIRST_ORDERED_NODE_TYPE,null).singleNodeValue,null,null,null);
remove_it(window.document,document.evaluate('/HTML[1]/BODY[1]/CENTER[1]/TABLE[1]/TBODY[1]/TR[2]/TD[1]', document, null, XPathResult.FIRST_ORDERED_NODE_TYPE,null).singleNodeValue,null,null,null);
center_it(window.document,document.evaluate('/HTML[1]/BODY[1]/CENTER[1]', document, null, XPathResult.FIRST_ORDERED_NODE_TYPE,null).singleNodeValue,null,null,null);
center_it(window.document,document.evaluate('/HTML[1]/BODY[1]/CENTER[1]/CENTER[1]/TABLE[1]/TBODY[1]/TR[2]/TD[2]/TABLE[2]/TBODY[1]/TR[1]/TD[1]/DIV[1]/TABLE[1]', document, null, XPathResult.FIRST_ORDERED_NODE_TYPE,null).singleNodeValue,null,null,null);
