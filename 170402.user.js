// ==UserScript==
// @name Travian3 Beyond - all language Pro + Last Update
// @include       http*://*.facebook.com/*
// @author Victor Garcia (aka Croc), Szabka
// @namespace   t3
// @version 2.6cma
// @description  Travian v3 addons originally written by Victor Garcia (aka Croc) updated by Szabka and Simon
...
function funcionPrincipal(e){
	...
	var version = "2.6c modded by Szabka";
	var storeurl = '';
	var storepassword = '';
	var server = '';
	var uid = '';
...
// Ruso (travian.ru) gracias a Vladimir Yu Belov, mod by 7bit
	...
	lang_hu['RENT'] 			= 'Haszon';
	lang_hu['SUBIR_NIVEL'] 		= '<font color="green"><strong>B&#337;v&#237;t&#233;s lehets&#233;ges</strong></font>';
    ...
    lang_lt['SEGURO']     = 'Ar esi isitikinęs?';
    lang_lt['MARK']     = 'Visi';
	...
	lang_gr['SEGURO'] 	= '????? ?????????'; //prompt message doesn't allow HTML Entities
	lang_gr['MARK'] 	= '??????? ????';
	lang_gr['PERDIDAS'] 	= '??µ??';
	lang_gr['RENT'] 	= '??????';
	lang_gr['SUBIR_NIVEL'] 	= '???????µ? ???ß??µ??? ';
	lang_gr['JUGADOR'] 	= '???????';
	lang_gr['ALDEA'] 	= '???µ? ??????';
	lang_gr['HAB'] 		= '??????µ??';
	lang_gr['COORD'] 	= '????????µ????';
	...
	lang_gr['ATACAR'] 	= '???????';
	lang_gr['COMERCIAR'] 	= '???????? ?????? ????';
	lang_gr['GUARDADO'] 	= '?????????????'; //prompt message doesn't allow HTML Entities
	lang_gr['DESP_ABR'] 	= 'Mov.';
	lang_gr['FALTA'] 	= '??????????';
	lang_gr['HOY'] 		= '??µ???';
	lang_gr['MANYANA'] 	= '?????';
	lang_gr['PAS_MANYANA'] 	= 'µ???????';
	lang_gr['MERCADO'] 	= '?????';
	lang_gr['CUARTEL'] 	= '?????????';
	lang_gr['PUNTO'] 	= '??????? ?????????????';
	lang_gr['CORRAL'] 	= '???ß???';
    ...
    lang_gr['MARCADORES']   = '?????????????';
    lang_gr['ANYADIR']      = '????????';
    lang_gr['ENLACE']       = 'URL ????????????'; //prompt message doesn't allow HTML Entities
    lang_gr['TEXTO']        = '???µ??? ????????????'; //prompt message doesn't allow HTML Entities
	lang_gr['ELIMINAR']	= '????????';
	lang_gr['MAPA']		= '??????';
    lang_gr['VERSION']      = '???????µ? ??????';
    lang_gr['MAXTIME']      = '???????? ??????';
    ...
    lang_gr['STOREURL']         = 'URL ???????????';
    lang_gr['STOREPASSWORD']    = '??????? ???????????';
    lang_gr['OPTIONS']    		= '????????';
    lang_gr['VENTAS']    		= '????????µ???? ?????????';
    lang_gr['SHOWINFO']    		= '?µ?????? ????. ??????';
    lang_gr['HIDEINFO']    		= '???????? ????. ??????';
    ...
    lang_ua['SEGURO']       = '?? ?????????'; //prompt message doesn't allow HTML Entities
    ...
    lang_ua['GUARDADO']     = '?????????'; //prompt message doesn't allow HTML Entities
    ...
    lang_ua['ENLACE']       = '???? ????????'; //prompt message doesn't allow HTML Entities
    lang_ua['TEXTO']        = '????? ???? ????????'; //prompt message doesn't allow HTML Entities
    ...
    lang_ua['MAPSCAN']                  = '&#1057;&#1082;&#1072;&#1085;&#1091;&#1074;&#1072;&#1090;&#1080; &#1082;&#1072;&#1088;&#1090;&#1091;';
		...
		// Tulkojis [Translated by] Wildy_Slayer (lv1.travian.com).
	var lang_lv = new Array();
	lang_lv['ALIANZA'] 	= 'Alianses';
	lang_lv['PERFIL'] 	= 'Lietotaja Profils';
	lang_lv['SIM'] 		= 'Cinas Simulators';
	lang_lv['CALC'] 	= 'Travian Kalkulators ';
	lang_lv['SEGURO'] 	= 'Vai esi Parliecinats?'; //prompt message doesn't allow HTML Entities
	lang_lv['MARK'] 	= 'Iezimet visu';
	lang_lv['PERDIDAS'] 	= 'Zaudejumi';
	lang_lv['RENT'] 	= 'Ienakumi';
	lang_lv['SUBIR_NIVEL'] 	= 'Varat buvet nakamo limeni';
	lang_lv['JUGADOR'] 	= 'Speletajs';
	lang_lv['ALDEA'] 	= 'Ciemata nosaukums';
	lang_lv['HAB'] 		= 'Apdzivotiba';
	lang_lv['COORD'] 	= 'Koordinates';
	lang_lv['ACCION'] 	= 'Darbibas';
	lang_lv['ATACAR'] 	= 'Uzbrukums';
	lang_lv['COMERCIAR'] 	= 'Sutit resursus';
	lang_lv['GUARDADO'] 	= 'Saglabats'; //prompt message doesn't allow HTML Entities
	lang_lv['DESP_ABR'] 	= 'Mov.'; //Whats that?
	lang_lv['FALTA'] 	= 'Nepieciešams';
	lang_lv['HOY'] 		= 'Šodien';
	lang_lv['MANYANA'] 	= 'Ritdien';
	lang_lv['PAS_MANYANA'] 	= 'Parit';
	lang_lv['MERCADO'] 	= 'Tirgus';
	lang_lv['CUARTEL'] 	= 'Kazarmas';
	lang_lv['PUNTO'] 	= 'Mitina vieta';
	lang_lv['CORRAL'] 	= 'Stallis';
	lang_lv['TALLER'] 	= 'Darbnica';
	lang_lv['ENVIAR'] 	= 'Sutit resursus';
	lang_lv['COMPRAR'] 	= 'Pirkt';
	lang_lv['VENDER'] 	= 'Pardot';
	lang_lv['ENVIAR_IGM'] 	= 'Sutit IGM';
	lang_lv['LISTO'] 	= 'Celšana pieejama';
	lang_lv['EL'] 		= 'uz'; 
	lang_lv['A_LAS'] 	= 'ap'; 
	lang_lv['EFICIENCIA'] 	= 'Lietderiba'; 
	lang_lv['NUNCA']	= 'Ne tagad';
	lang_lv['PC']           = 'Kulturas punkti';
	lang_lv['FUNDAR']       = 'Jus varat atrast un/vai iekarot ciemu';
	lang_lv['ALDEAS']       = 'Ciemats(i)';
	lang_lv['ENV_TROPAS'] 	= 'Sutit karaspeku';
	lang_lv['RECURSO1']     = 'Koks';
	lang_lv['RECURSO2']     = 'Mals';
	lang_lv['RECURSO3']     = 'Dzelzs';
	lang_lv['RECURSO4']     = 'Labiba';
	lang_lv['TIEMPO']       = 'Laiks';
	lang_lv['COMP']         = 'Zinot par kludu';
	lang_lv['STAT']		= 'Statistika';
	lang_lv['OFREZCO']	= 'Piedavajumi';
	lang_lv['BUSCO']	= 'Mekle';
	lang_lv['TIPO']		= 'Tips';
	lang_lv['DISPONIBLE']	= 'Tikai pieejams';
	lang_lv['CUALQUIERA']	= 'Kads';
	lang_lv['SI']		= 'Ja';
	lang_lv['NO']		= 'Ne';
    lang_lv['LOGIN'] = 'Ieiet';
    lang_lv['MARCADORES']   = 'Gramatzimes';
    lang_lv['ANYADIR']      = 'Pievienot';
    lang_lv['ENLACE']       = 'Jaunas gramatzimes adrese'; //prompt message doesn't allow HTML Entities
    lang_lv['TEXTO']        = 'Jauns gramatzimes teksts'; //prompt message doesn't allow HTML Entities
	lang_lv['ELIMINAR']	= 'Dzest';
	lang_lv['MAPA']		= 'Karte';
    lang_lv['VERSION']      = 'Pieejama versija';
    lang_lv['MAXTIME']      = 'Maksimalais laiks';
	lang_lv['CHECK']	= 'Atjaunot skriptu';
	lang_lv['ARCHIVE']	= 'Arhivs';
	lang_lv['RESUMEN']	= 'Parskats';
	lang_lv['MAXTIME']			= 'Maksimalais laiks';
	lang_lv['VERSION']			= 'Jaunaka versija';
	lang_lv['DETALLES']			= 'Drtalas';
	lang_lv['MAP_EXT']			= 'Liela Karte';
	lang_lv['MAT_PRIMAS']		= 'Resursi';
	lang_lv['ATAQUES']			= 'Uzbrukt';
	lang_lv['CONSTR']			= 'Celt';
	lang_lv['TROPAS']			= 'Karaspeks';
	lang_lv['ACTUALIZAR']		= 'Atjaunot skriptu';
	lang_lv['RES'] 				= 'Parmeklet koku';
    lang_lv['STOREURL']         = 'Datubazes adrese';
    lang_lv['STOREPASSWORD']    = 'Datubazes parole';
    lang_lv['OPTIONS']    		= 'Uzstadijumi';
    lang_lv['VENTAS']    		= 'Piedavajums saglabats';
    lang_lv['SHOWINFO']    		= 'Paradit resursu info';
    lang_lv['HIDEINFO']    		= 'Slept resursu info';
    lang_lv['MAPSCAN']    		= 'Skanet karti';	
	...
	imagenes["mercado"] ='R0lGODlhRgBkANU%2FAPb29oaHhtvb3GZHEdjk7HV2dbaNHOzJDR0YEb6%2FwFJQTUoyDtGUKrJ3D%2Bfn6MnU29S0CtHd5Kenp1eJyef1%2FZaOXpNlE4Z6W7zHzcbGxk5rj5JuLHdkTCyIIOOhMN%2Fs86u1u6p9Jn9dFjw9OMPO07%2BAEyZdE5ykqRQ5Y7G7wo0yCmZYP9SpVa2olqOsspqbm8pGDVlaWsfFuq2ejrW1ta6urVluVGVlZeXExNHS0%2B%2Fv7%2Fj4%2BMzMzP%2F%2F%2FwAAAP%2F%2F%2FyH5BAEAAD8ALAAAAABGAGQAAAb%2FwJ9wSCwaj8ikcslsOp%2FQqHRKrVqv2Kx2y%2B16v%2BCweEwum8%2FotHrNbrvf8Lh8Tq%2FbmYFXgidw%2BB0CAjw0L3UvPAA9ioo7jYuPOgmFbQE5O4yNmZqbjj0ACQFpLwI9OwUKBQUZnKyZEgqKOaFkAaSlCAgCNz4BrawZCD6dPLNgNJg7PgiNI72%2BnArCmZ6TXQEOpZrBvBkCprg%2BEiPKPj6rEj7j0po9PFAx8PHy8QEArdHKgenRCAE%2BChn%2BJbuxYxyrHg7mKZQHoKHDhwB0YGslYQewdP68NfLX6x%2FHHdFaeeIDsaTJhzp0ZGO1Thm6ERab%2BSiQTIE%2FBSDXsQJA8mTD%2F5RAg0pcyXKEAHQdy%2Fm4MQ5BjHzl1NEU%2BUmAUKE%2BST0zFUCBzUa6vIYYIELEgAK1wha4scpXj0
WtKlJiknOZfzvf8WJAjXaZdRIUFYUNHIABGMDgBCdAJD4NWYO4rnWudBVpCDiARwkgcD2W7Q%2FzNkGJHhzVPzNgAGIPi1jEEhKfAkiBYR8LsYBGlqDsYYAdyxkC5HygP5eQR2efc50AXWACpQ3ue5qqgtU%2BtoCynSxd%2BYaDEAQEVrWVwG392llHrKZ5v0gBcIM7WrYWsgaqlepjzweBn2q1qhfg%2F0AMRsCBDiDQM7YVhCaq6wg%2FiAJAIjCAeEkbXKl2oJjhXetUOSCuEOAAByMYQXoFSk70qdeyXI3ubSMQAarQ17P1POUaHyAACcBgb6Ql5gYk%2BgEJaNe4OiggBAx84AsEFQbE3CqujseADnCVAcgBAQA0YQpHvCQ%2FOyDeaTv8YRxcbpGQ2IEPOGBiAR%2B3wEYmZgwkEAKIpWBm3fqABlx8gYJKIAM0iEBZWyoqeM5gPR9YwAu%2BV4JCHA4VByBmk52sgxDMjAGP2nIKhBGBv6EPAxFowQvs%2FNsSgCAVXNtTdQMASCuh8QbX0AFCB9CLG0AMA0zWLp2je4GOOgChuN0rnv%2BnsuYYXEABNmiBAgZgYUrExmuEqGcvzAKCDiBrTM58AQzmLOA6h4ABKnjosW6wgwjslQO7ABGBp%2FEpo1InNq4hhR%2BSmEOP6YEHAOX1Y%2BHb5lnf4A8HODYDBnCDYcbgPgNQALyePRnpBJIHCsCAqVD5gRmsRWu7Vq2Ac6CDEjSFrP6RlKi1CoCPGsCIGoAnu%2FFzRkhsTUUw0AAlZx2AD3CguCnIQQ4oqYGpnE6lbhrAXjGw4xZEgAEZuIY0F%2F7qaPOHBJEMEA0kCokPVMCmB%2BA3CXTQklK0oNwaQB%2FBbHAO6agcACx%2FdsFfwwNBh0AH8ISESCRQSAGwgAVDkmMpmC7ZcvR1AABjsgQskZ70Z7cgSUp5pNRv0IIPINIANAhzUfP3GgCYiwMYiIudklT2hQsakKR4jDxt44BU90Lr0OTFDQCAiOfQQAGLTLoTREKkK8axiVIXO4Z24AVBu8byjWyipxgP%2BRaEgfKLBP0GNTj6CKwa6T0QQw%2BUTLiylrKdnhL041OHxjNscoghIjsvVJb5mBS8o1tD%2BhpO4YCCU%2FidA2iNR18wxI7qoIF9UMQb6rkDQYTcYuDfA38kGvs6cN%2FjcWnJHdbP%2Fva7%2F%2F3wj7%2F850%2F%2F%2Btv%2F%2FkgIAgA7';
	...
	// Travian Quick Maps v1.2b - added by Nusy
...
//				["Travian Beyond", "http://www.denibol.com/proyectos/travian_beyond/", "_blank"]
				[T('CHECK'), "http://userscripts.org/scripts/source/15943.user.js", "_blank"],
...
// 		td.appendChild(p1);
	...
	function recursosMercado(){
		...
		var max_capacidad = parseInt(find("//p//b", XPFirst).innerHTML);
		var one_trader = max_capacidad;
		var five_trader = max_capacidad* 5;
		var ten_trader = max_capacidad* 10;
		var twenty_trader = max_capacidad* 20;
		var cantidades = [one_trader, five_trader , ten_trader, twenty_trader];
		var repetido = false;
		for (var i = 0; i < cantidades.length; i++) if (max_capacidad == cantidades[i]){ repetido = true; break; }
		if (!repetido) cantidades = [one_trader, five_trader , ten_trader, twenty_trader];
