...
function doit(){
	...
	GM_addStyle('\
			   /* 让li以table方式显示，避免分列时被拆断，以及添加圆角效果等 */\
			      	.g {display: table; -moz-border-radius: 0.75em; -webkit-border-radius: 0.75em;}\
			   ...
			   /* 打开、关闭百宝箱按钮的样式 */\
					#gkk_opboxbutton {float: left; font-size:12px; color: #1111CC; cursor: pointer; display: inline-block; text-decoration: none; margin: 3px 0 2px 3px; width: 168px;}\
...
function floatInput(){
	...
	document.body.insertBefore(header, document.getElementById('cnt'));
