// ==UserScript==
                // @name           Menu Diplomatique Vany
                // @version        0.1.5
                // @namespace      Menu Diplomatique Vany
                // @description    Un petit menu pour Vany ou le diplo Lion...
                // @include        http://s3.fr.ikariam.*/index.php*
                // ==/UserScript==
                // ===========================================================================
                //
                // Un melange de plusieurs scripts adaptes pour les besoins Vany par Piwiix
                ...
                + '     <li><center><a target="_blank" href="http://s3.fr.ikariam.com/index.php?view=sendIKMessage&msgType=52&receiverId=125527" title="Contacter Lirix diplomate -R-">Lirix, diplo -R-</a></li>'
