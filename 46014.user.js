...
var x = (Math.random() * 1000)+1000; //change the page delay here; 1000 = 1 second
function delay() {
...
if(document.body.innerHTML.indexOf('HOLD') != -1){
	...
	if(t1+t2+t3+t4>=1 && g1+g2+g3+g4<=1 && f1+f2+f3+f4<=2|| t1+t2+t3+t4>=2){
