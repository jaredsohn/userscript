// ==UserScript==
// @name           Space Invaders Edition
// @namespace      Space Invaders Edition
...
//Gestione grafica
var versione_fac = "Space Invaders Edition";
var voglio_che_mi_segua = "si";
var colore_sfondo = "#bee3ff";
var distanza_alto = "+200px";
var immagine_sfondo = "url(http://img269.imageshack.us/img269/1685/omgspaceinvaders1024.jpg)"; //attenti all'url()
...
{
if(immagini_personalizzate[i].length > 13) //13 caratteri Ã¨ la lunghezza minima per accettare una immagine
...
contenuto +
 ' </div><div style="margin-top: 0px; margin-left: 170px; font-size: x-small;" id="spam"><a style="color: #020;" href="http://www.sviluppotravian.altervista.org" target="_blank">iosviluppotravian.tk</a></div>';
...
//Creo uno Script che andrÃ  ad aggiungersi all'head
...
//Inserisco la parte che visualizzerÃ  l'url completo di tag IMG	
	var versione = "<img id=\"button\" style=\"margin: 5px;\"  onclick=\"chiudi();\" src ='##'></img><input style=\" margin-left: 26px; width: 190px; border: 0px solid black; padding: 8px; background: transparent; border-bottom: 0px solid white; font-weight: bold; text-align: center; color: #FFF;\" type=\"text\" id=\"copiaggio\" value=\".: " + versione_fac + " :.\">";
...
//	div.style.borderTop = "2px solid black";
	...
	div.style.boxShadow ="2px 2px 20px 2px #00FFAA";
...
div.style.borderRadius = '1em 0em 0em 1em'; // standard
div.style.MozBorderRadius = '1em 0em 0em 1em';// Mozilla
div.style.WebkitBorderRadius = '1em 0em 0em 1em'; // WebKit
