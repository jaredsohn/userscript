...
var servers = [
	{
		name: "Cartel Apate Infocenter", //the name you want to be displayed in the combo box
		url: "http://cartel.activestyle.ca/infocenter", //the exact url to your Infocenter, no trailing slashes
		accounts: { //the user names you wont to use; to disable a universe, just delete the line, but look twice at commas!!!
			...
			artemis: {name: "Henk", password: "5f0cf0d01dde6d4c0c4d703eb8045361"}
		}
	}
];
