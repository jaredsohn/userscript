...
function CreateMenuOptions() {
  ...
  GM_registerMenuCommand('NeoBuxAVG: Threshold - MÉDIA RUIM', s_avgThreshold);
  GM_registerMenuCommand('NeoBuxAVG: Threshold - MÉDIA BOA', s_avggoodThreshold);
  GM_registerMenuCommand('NeoBuxAVG: Threshold - REFERIDO INATIVO', s_inactiveThreshold);
  GM_registerMenuCommand('NeoBuxAVG: Threshold - REFERIDO c/ ZERO CLIQUE', s_zeroThreshold);
  GM_registerMenuCommand('NeoBuxAVG: Threshold - DIAS PARA RESSALTAR UM REFERIDO', s_minDays);
  GM_registerMenuCommand('NeoBuxAVG: Feature - RESSALTAR REFERIDOS RUINS', s_automark);
  GM_registerMenuCommand('NeoBuxAVG: Feature - RESSALTAR REFERIDOS INATIVOS', s_automarkinactive);
  GM_registerMenuCommand('NeoBuxAVG: Feature - RESSALTAR REFERIDOS BONS', s_hlgood);
  GM_registerMenuCommand('NeoBuxAVG: Feature - MUDAR O ESQUEMA DE CORES', s_colorscheme);
