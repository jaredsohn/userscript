// ==UserScript==
// @name           DailyMotion No-AutoPlay Embed
// @namespace      http://userscripts.org/users/cyberdelia
// @description    No autoplay for dailymotion video.
// @include        *
...
// ==/UserScript==
var re = new RegExp("http:\/\/.*dailymotion\.com\/swf\/([^(\&|$.%)]*)");
...
for (i = 0; i < embeds.snapshotLength; i++) {
    ...
    if (result) {
      ...
      var videoID = parts[1];
      var link = 'http://www.dailymotion.com/swf/' + videoID + "&autoStart=0";
