...
var version=85;
var scriptlocation="http://userscripts.org/scripts/source/81636.user.js";
...
switch (location.host) {
	default:
		...
		chaturl='.';
		forumurl='http://k3rb3r05.foroomy.com';
		forumurlnew='.';
		break;
		
	// For Theta
	case 's8.gr.ikariam.com':
		alliancefullnm='Radical Creator';
		alliancenm='CON1';		
	...
	//for ΜΥ
	case 's12.gr.ikariam.com':
		alliancefullnm='MASKES';
		alliancenm='MAS';		
		alliance=[	['Νo alliance'	, NoAlliance],
					[ alliancenm	, Alliance	],
					['NTS'		, Allies	],
