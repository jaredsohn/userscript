// ==UserScript==
// @name          Kaskus Quick Reply For Old Kaskus version
// @icon          http://code.google.com/p/dev-kaskus-quick-reply/logo?cct=110309324
// @namespace     http://userscripts.org/scripts/show/243761
// @include       http://www.kaskus.co.id/showthread.php?*
// @version       3.2.6
// @dtversion     111030326
// @timestamp     1319917890445
// @description   provide a quick reply feature, under circumstances capcay required.
// @author        idx(302101; http://userscripts.org/users/idx); bimatampan(founder); reupload;
...
const OPTIONS_BOX = {
 ...
 ,KEY_SAVE_LAYOUT_SIGI:      ['1'] // signature layout, eg. [RIGHT]&#8212;[SIZE=1][b]QR[/b][/SIZE]&#8482;[/RIGHT]
 ...
 ,KEY_SAVE_QR_RECAPCAY_PROP: ['clean,1'] // recapcay theme, is_simple_mode
 
 ,KEY_SAVE_PRELOAD_RATE: ['0'] // whether donatur need to preload rate or not
 ,KEY_SAVE_QR_COLLAPSE:  ['1'] // initial state of qr
 ,KEY_SAVE_WIDE_THREAD:  ['0'] // initial state of thread, wider by Kaskus Fixups - chaox
...
function init(){
  ...
  gvar.isNotForum = (!location.href.match(/^http:\/\/w{3}\.kaskus\.co.id\/.*/));
  if(gvar.isNotForum) return outSideForumTreat();
  
  gvar.domainstatic= 'http://'+'static.kaskus.co.id/';
...
function appendAvatar(){
    ...
    if(isDefined(gvar.user.id)){
       ...
       _o('click',$D('#refetch'),function(){
         ...
         el=createEl('a',{href:'http:/'+'/www.kaskus.co.id/member.php?u='+gvar.user.id,'class':'cleanlink'},'<b><small>'+gvar.user.name+'</small>'+(gvar.user.isDonatur ? ' <span style="color:red;">[$]</span>':'')+'</b>');
...
var Avatar = {
  ...
  init:function(user){
    Avatar.user = user;
    Avatar.uri='http:/'+'/www.kaskus.co.id/member.php?u='+Avatar.user.id;
  },
...
var ST = {
 ...
 ,reset_setting: function(){
    var home=['http:/'+'/www.kaskus.co.id/showthread.php?t=3170414','http:/'+'/userscripts.org/topics/58227'];
    var space = '';
...
,[H+'fd_2.gif', ':cd:', 'Cape deeehh']
 ...
 ,getBOT_greet: function(min, max){
    ...
    cK.s('last_greet', String(lastgreet), '/', 'www.kaskus.co.id');
    return c[lastgreet];
  }
 ...
 ,getTPL_Settings_About: function(){
    ...
    return (''
     ...
     +'<div style="height:7px;"></div>'
     +'KASKUS brand is a registered trademark of www.kaskus.co.id<br>'
     +gvar.fullname+' (QR) is not related to or endorsed by www.kaskus.co.id in any way.<br>'
