// ==UserScript==
// @name           Rapport Espion + v.2
// @namespace      ikariam
// @description    Calcule combien de navire suffiront pour le pillage
// @include        http://*.ikariam.*/*
// @exclude        http://board.ikariam.*/*
// ==/UserScript==

// Version 1.0 (14/06/2009)
// Credits (some function is copy or modify from other srcipt): SnP Helper
...
function showTotal()
{
		...
		td1.innerHTML = 'Total ressources : ';
		...
		td1 = document.createElement("td");
		td1.setAttribute("class","job");
		td1.innerHTML = 'Niveau entrepot : ';

		td2 = document.createElement("td");
		 var wareDiv = <>
								<input type="text" style="text-align: right;" size="8"  id="warehouseLevelId" value="0"/>  Ex. 3 ou 1,2,3 si plusieurs entrepots.
							</>;
		...
		td2.innerHTML = <>
								<a
									href={backURL}
									title="Retour vers la cachette"> <img
									src="skin/buildings/y100/safehouse.gif"
									width="160" height="100" /> <span class="textLabel">&lt;&lt; Retour vers la cachette</span>
								</a>
								</>;
		...
		td2 = document.createElement("td");
		td2.innerHTML = 'Bagfender des AsA te souhaite bon courage !!';
