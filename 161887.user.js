...
var lh=location.href;
	if(location.href.indexOf("qvod")>30){
		...
		creat("F:\\cookies\\history{default}.json");
		Player.QVOD.domute();
		quiplay();
...
function cntpl(){
	var nobj=read("F:\\cookies\\history{default}.json"),lp=LI.count,ldl=LI.data,sl=/[a-z0-9]{40}/;
	for (var i=0;i<lp;i++){
...
function nyp(){
	var d=document.getElementsByTagName("a"),t=d.length,nobj=read("F:\\cookies\\history{default}.json"),vd=parseInt(VideoID)-1,vcd=VideoCID,sl=/[a-z0-9]{40}/;
	for (var i=0;i<t;i++){
