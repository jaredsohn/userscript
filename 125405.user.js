// ==UserScript==
// @name           Cambium Canopy OUI
// @namespace      http://www.latinsud.com
// @include        http://*/main.cgi*
// @version        1.0.1
// ==/UserScript==

// OUI list retrieved 2012-02-10
var ouis = {
'0A003E':'Canopy',
'1A003E':'Canopy',
'2A003E':'Canopy',
...
'0008F7':'Hitachi Ltd, Semiconductor  amp  Integrated Circuits Gr',
'0008F8':'Guardall Ltd',
...
'000B61':'Friedrich L    tze GmbH  Co.',
...
'000B91':'Aglaia Gesellschaft f  r Bildverarbeitung und Kommunikation m',
...
'000DDC':'VAC',
'000DDD':'PROF    LO TELRA ELEKTRON    K SANAY     VE T    CARET A.    .',
...
'0014AD':'Gassner Wiege- u. Me    technik GmbH',
...
'001619':'La Factor  a de Comunicaciones Aplicadas,S.L.',
'00161A':'Dametric AB',
...
'0018C1':'Almitec Inform  tica e Com  rcio Ltda.',
'0018C2':'Firetide, Inc',
...
'001F52':'UVT Unternehmensberatung f  r Verkehr und Technik GmbH',
...
'0025B2':'LFK-Lenkflugk    rpersysteme GmbH',
...
'38A851':'Quickset International Inc',
'38A95F':'Actifio Inc',
...
'3C2763':'SLE quality engineering GmbH  amp  Co. KG',
...
'3CC0C6':'d amp b audiotechnik GmbH',
...
'5808FA':'Fiber Optic  amp  telecommunication INC.',
'581626':'Avaya, Inc',
...
'6089B7':'KAEL M HENDISLIK ELEKTRONIK TICARET SANAYI Limited  irketi',
...
'848F69':'Dell Inc.',
'849000':'Arnold  amp  Richter Cine Technik',
'8497B8':'Memjet Inc.',
...
'A4E32E':'Silicon  amp  Software Systems Ltd.',
...
'A8D3C8':'Wachendorff Elektronik  GmbH  amp  Co. KG',
...
'C0CFA3':'Creative Electronics  amp  Software, Inc.',
'C0D044':'SAGEMCOM',
...
'D479C3':'Cameronet GmbH  amp  Co. KG',
...
'E05DA6':'Detlef Fink Elektronik  amp  Softwareentwicklung',
...
'EC4644':'TTK SAS',
'EC4670':'Meinberg Funkuhren GmbH  amp  Co. KG',
...
'F0E5C3':'Draegerwerk AG  amp amp  Co. KG aA',
...
'F8E7B5':'uTech Engenharia e Automa ao LTDA',
'F8E968':'Egker Kft.',
...
s=document.getElementById("BTBL");
if (s) {
  s.style.fontFamily='monospace';
  txt=s.innerHTML.replace(/Mac:([0-9A-F]{6})([0-9A-F]{6})/g, function(match,p1,p2) {
	var nombre=ouis[p1];
	if (nombre === undefined)
		return match+ " (&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;)";
	else {
		nombre=nombre.substring(0,20);
		for (var i=nombre.length; i<20; i++) {
			nombre+="&nbsp;";
		}
		return match+" ("+nombre+")";
	}
