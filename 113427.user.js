...
// @namespace	http://userscripts.org/scripts/show/87361
...
(function(code){
	...
	if (/Firefox/i.test(navigator.userAgent)) {
		var ver = [[/1.1.1/, /1.2.0/, /1.2.3/, /1.3.0/, /1.3.1/, /1.3.2/, /1.4.0/, /1.4.1/, /1.4.3/, /1.5.0/, /1.5.1/, /1.6.0/, /1.6.1/],
			  [/3.0/, /3.1.0/],
			  [/1.2.3/, /1.2.6/, /1.3.0/, /1.3.1/, /1.3.2/, /1.4.0/, /1.4.1/, /1.4.2/, /1.4.3/, /1.4.4/, /1.5.0/, /1.5.1/, /1.5.2/, /1.6.0/, /1.6.1/, /1.6.2/],
			  [/1.5.2/, /1.5.3/, /1.6/, /1.7.0/, /1.7.1/, /1.7.2/, /1.7.3/, /1.8.0/, /1.8.1/, /1.8.2/, /1.8.4/, /1.8.5/, /1.8.6/, /1.8.7/, /1.8.8/, /1.8.9/, /1.8.10/, /1.8.11/, /1.8.12/, /1.8.13/, /1.8.14/, /1.8.15/, /1.8.16/],
			  [/1.1.1/, /1.1.2/, /1.2.1/, /1.2.2/, /1.2.3/, /1.2.4/, /1.2.5/, /1.3.0/, /1.3.1/, /1.3.2/],
			  [/1.6.0.2/, /1.6.0.3/, /1.6.1.0/, /1.7.0.0/],
			  [/1.8.1/, /1.8.2/, /1.8.3/, /1.9.0/],
			  [/2.1/, /2.2/],
			  [/2.6.0/, /2.7.0/, /2.8.0r4/, /2.8.1/, /2.8.2/, /3.3.0/],
			  [/1.0.0/, /1.0.1/, /1.0.2/, /1.0.3/, /1.0.4/, /1.0.5/, /1.0.6/, /1.0.9/, /1.0.10/, /1.0.11/, /1.0.12/, /1.0.13/, /1.0.14/, /1.0.15/, /1.0.16/, /1.0.17/, /1.0.18/, /1.0.19/, /1.0.21/, /1.0.22/]];
