// ==UserScript==
// @name           MyPersonalSPiNHome
// @namespace      http://spin.jpr0g.info/
// @description    Erlaubt das anpassen und designen der SPiN.de Home-Seite
// @include        http://*.spin.de/home*
// @include        http://*.spin.de/home
// ==/UserScript==
//
...
var userbox, roomsbox, googlebox, notebox, friendbox, messagebox, linksbox, newsbox,announcementbox,eventbox, radiobox, kinobox, suggestionbox;
...
eventbox        = new Box("eventbox");
radiobox        = new Box("radiobox");
kinobox			= new Box("kinobox");
suggestionbox	= new Box("suggestionbox");

var boxes = Array(userbox,googlebox,friendbox,roomsbox,linksbox,newsbox,announcementbox,socialstreambox,notebox,eventbox,radiobox,kinobox,suggestionbox);
...
eventbox.elem = document.getElementById("eventbox");
radiobox.elem = document.getElementById("nowplayingbox");
kinobox.elem = document.getElementById("moviepromo");
...
addFieldset('Eventbox','eventbox',true,true,true,true,true,true,true);
addFieldset('Announcementbox','announcementbox',true,true,true,true,true,true,true);
addFieldset('Radiobox','radiobox',true,true,true,true,true,true,true);
addFieldset('Kinobox','kinobox',true,true,true,true,true,true,true);
