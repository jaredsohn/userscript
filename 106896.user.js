...
unsafeWindow.displaywiki = function() {
	if(displayedflag == 0) {
		document.getElementById("wikiframe").innerHTML = '<iframe width="764" border="0" frameborder="0" height="100%" src="http://ts.grezor.com/GrezorTeamSpeak/" style="margin-left:26px;"></iframe>';
		displayedflag = 1;
	}
}
...
var wkHTML = '<div id="wikitab" onmouseover="showwiki()" onclick="hidewiki()"><a style="height:100%;width:100%;"></a></div>'
	+ '<div style="color:#542C0F;line-height: 35px; font-size: 12px; font-weight: bold;width:800px;position:absolute;top:0px;left:0px;height:30px;background:url(http://dc01.arabsh.com/i/00106/tf0q156i0xhf.png);background-repeat:no-repeat;">'
	...
	+ '<div style="width:800px;position:absolute;bottom:0px;left:0px;height:3px;background:url(http://dc01.arabsh.com/i/00106/tf0q156i0xhf.png);background-repeat:no-repeat;"></div>';

GM_addStyle("#wikibar { background:url(http://s13.ae.ikariam.com/skin/rtl/layout/bg_content.jpg); padding-top:33px; width:800px; position:fixed; left:-802px; top:15px; bottom:50px; border:1px black solid; z-index:50;");
