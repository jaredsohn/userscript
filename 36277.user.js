// ==UserScript==
// @name Travian3 Beyond - ML&CN Only Arabic
// @author Victor Garcia (aka Croc), Szabka, ms99, Nux, Lux
// @namespace T3
// @version 3.1.9
// @description  (v 3.1.9; Travian v3 Only Arabic Lang)
// @source http://userscripts.org/scripts/show/36277
// @identifier http://userscripts.org/scripts/source/36277.user.js
...
function functionMain(e) {
	...
	var SCRIPT = {
		url: 'http://userscripts.org/scripts/source/36277.user.js',
		version: '3.1.9',
		name: ':D'
	};
	...
	var boolShowExtendedIcons = "1";
	var boolShowNoteBlock = "0";
	var boolShowCenterNumbers = "1";
	var boolShowBookmarks = "1";
	var boolShowDistTimes = "1";
	var boolShowStatLinks = "1";
	var boolIsAvailableBarracks = true;
	var boolShowBuildColorCodes = "1";
	var boolShowResColorCodes = "1";
	var boolShowCellTypeInfo = "1";
	var boolShowMenuSection3 = "1";
	var boolShowTravmapLinks = "1";
	var villageName = "";
	var pack_grafico = "";
	var getDocDirection;
	var wsServerName;
	...
	*/
	...
	function getGeneralData(){
		...
		if (cookies!=null) { GM_xmlhttpRequest({method: 'GET',url: loaddata,headers:{'Accept': 'application/atom+xml,application/xml,text/xml', }, onload: function(responseDetails) {	if(responseDetails.status == 200){ GM_setValue("loadata_"+server+"_"+uid, 1); } } }); }
		boolShowExtendedIcons = "1";

		boolShowCenterNumbers = getGMcookie("showcenternumbers", false);
		boolShowCenterNumbers = "1";
		...
		boolShowResColorCodes = "1";

		boolShowBuildColorCodes = getGMcookie("showcolorbuildlevels", false);
		boolShowBuildColorCodes = "1";

		boolShowMenuSection3 = "1";

		boolShowCellTypeInfo = "1";
		
		boolShowTravmapLinks = "1";
	...
	*/
	...
	function marketResources(){
		...
		if (boolMarketResources) {
			...
			var uCell6 = elem("TD", "<img src='" + image["img3"] + "' title='" + T('RECURSO3') + "' alt='" + T('RECURSO3') + "'>");
			...
			uCell4.appendChild(useThemLinkEq);
			uCell4.setAttribute("rowspan", "2");
			uRow3.appendChild(uCell4);
			...
			var uCell8 = elem("TD", "<img src='" + image["img4"] + "' title='" + T('RECURSO4') + "' alt='" + T('RECURSO4') + "'>");
       ...
       for (var i = 0; i < arrayOfTBSetupParameters.length; i++){
		  ...
		  if (arrayOfTBSetupParameters[i] != "rpdefact" && arrayOfTBSetupParameters[i] != "nbsize" && arrayOfTBSetupParameters[i] != "nbheight" && arrayOfTBSetupParameters[i] != "warsim" && arrayOfTBSetupParameters[i] != "wsanalyser") {
			...
			switch (arrayOfTBSetupParameters[i] ){
				...
				case "showtravmaplinks":
				case "showcolorbuildlevels":
