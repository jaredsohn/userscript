// ==UserScript==
// @name           Travian: مدیریت دهکده
// @version        0.10
// @description    دهکده‌های دلخواه خود را علامت‌گذاری نموده و سریعا" به آنها دست‌رسی داشته باشید، زبان فارسی توسط محمد لطفی به این اسکریپت اضافه شده است.
// @author         Mohammad LOTFi
// @email          mlotfi63@gmail.com
// @date           2009-05-08 (1388/02/18)
// @namespace      travian
...
function loadLanguage()
{
	...
	switch(ext) {
		...
		case 'ir': //Italian, translation by dbKiller
			lang['VILLAGE_MANAGER'] = 'مدیریت دهکدهء';
			lang['VILLAGE'] = 'دهکده';
			lang['ALREADY_LIST'] = 'در حال حاظر در فهرست موجود است';
			lang['ADD_VILLAGE']  = 'اضافه کردن به';
			lang['NO_VILLAGES'] = 'دهکده‌ای در فهرست موجود نیست!';
			lang['MAP'] = 'نقشه';
			lang['PLAYER'] = 'بازیکن';
			lang['PLAYER_PROFILE'] = 'پروفایل بازیکن';
			lang['ALLY'] = 'اتحاد';
			lang['ALLY_PROFILE'] = 'پروفایل اتحاد';
			lang['DISTANCE'] = 'مسافت';
			lang['DISTANCE_VILLAGE'] = 'مسافت از';
			lang['DELETE'] = 'حذف';
			lang['SEND_TROOPS'] = 'لشگر کشی';
			lang['DRAG'] = 'کشیدن';
			lang['HIDE'] = 'مخفی';
			lang['SHOW'] = 'آشکار';
			lang['SORT_BY'] = 'چینش';
			lang['MINIMIZE'] = 'حداقل';
			lang['MAXIMIZE'] = 'حداکثر';
			lang['YOUR_VILLAGE'] = 'دهکیدهء شما';
			lang['COLUMNS'] = 'ستون‌ها';
			lang['OPTIONS'] = 'تنظیمات';
			lang['SEND_RESOURCES'] = 'ارسال منابع';
			lang['VILLAGE_PROFILE'] = 'پروفایل دهکده';
			lang['OTHER_OPTIONS'] = 'تنظیمات دیگر';
			lang['DELETE_ALL'] = 'حذف همهء دهکده‌ها';
			lang['RESTORE'] = 'تنظیمات پیشفرض';
			lang['CONFIRM'] = 'آیا اطمینان دارید؟';
			lang['LUMBER'] = 'چوب';
			lang['CLAY'] = 'خشت';
			lang['IRON'] = 'آهن';
			lang['CROP'] = 'چوب';
			...
			lang['ROMANS'] = 'رومی‌ها';
			lang['GAULS'] = 'گول‌ها';
			lang['TEUTONS'] = 'توتن‌ها';
			lang['UPDATE_CHECK'] = 'بروزرسانی';
			lang['LAST_VERSION'] = 'شما آخرین نسخه را در اختیار دارید';
			lang['NEW_VERSION'] = 'نسخهء جدید موجود است';
			lang['UPDATE_NOW'] = 'بروز شود؟';
			lang['DATE'] = 'تاریخ';
			lang['POPULATION'] = 'جمعیت';
			lang['SERVER_DOWN'] = 'پاسخی از سرویس‌دهنده دریافت نشد, لطفا" بعد امتحان کنید...';
			lang['CLOSE'] = 'بستن';
			lang['TYPE'] = 'نوع';
			lang['VILLAGE_TYPE'] = 'نوع دهکده';
			lang['F1'] = '9 گندم (3-3-3-9)';
			lang['F2'] = '+آهن (3-4-5-6)';
			lang['F3'] = 'معمولی (4-4-4-6)';
			lang['F4'] = '+خشت (4-5-3-6)';
			lang['F5'] = '+چوب (5-3-4-6)';
			lang['F6'] = '15 گندم (1-1-1-15)';
			lang['W1'] = '+25% چوب در ساعت';
			lang['W2'] = '+25% چوب در ساعت';
			lang['W3'] = '+25% چوب & +25% گندم در ساعت';
			lang['W4'] = '+25% خشت در ساعت';
			lang['W5'] = '+25% خشت در ساعت';
			lang['W6'] = '+25% خشت & +25% گندم در ساعت';
			lang['W7'] = '+25% آهن در ساعت';
			lang['W8'] = '+25% آهن در ساعت';
			lang['W9'] = '+25% آهن & +25% گندم در ساعت';
			lang['W10'] = '+25% گندم در ساعت';
			lang['W11'] = '+25% گندم در ساعت';
			lang['W12'] = '+50% گندم در ساعت';
			lang['WIDTH'] = 'عرض';
			lang['SAVE'] = 'ذخیره';
			lang['TROOPS'] = 'لشگریان';
			lang['TIME'] = 'زمان';
			lang['ARRIVAL'] = 'رسیدن';
			lang['TOT'] = 'زمان رسیدن';
			lang['TOURNAMENT'] = 'سطح میدان';
			lang['SPEED'] = 'سرویس‌دهنده سریع';
			lang['POPUPS'] = 'Popups';
			lang['TAG'] = 'برچسب';
			lang['NO_TAG'] = 'دهکده‌ای با این برچسب موجود نیست';
			lang['FILTER'] = 'فیلتر: ';
			lang['ADD'] = 'اضافه';
			lang['REMOVE'] = 'حذف';
			lang['NOTE'] = 'یادداشت';
			lang['EDIT'] = 'ویرایش';
			lang['START_EDITING'] = 'ابتدا ویرایش را آغاز کنید!';
			lang['LINK'] = 'پیوند';
			lang['IMAGE'] = 'تصویر';
			lang['BOLD'] = 'Bold';
			lang['ITALIC'] = 'Italic';
			lang['UNDERLINE'] = 'زیر‌خط‌دار';
			lang['STRIKET'] = 'میان‌خط‌دار';
			lang['SUPERS'] = 'بالانویس';
			lang['SUBS'] = 'زیرنویس';
			lang['JLEFT'] = 'چپ تراز';
			lang['JCENTER'] = 'میانه تراز';
			lang['JRIGHT'] = 'وسط تراز';
			lang['JFULL'] = 'Justify full';
			lang['OLIST'] = 'فهرست منظم';
			lang['ULIST'] = 'فهرست نامنظم';
			lang['HRULE'] = 'rule افقی';
			lang['INDENT'] = 'تورفتگی';
			lang['OUTDENT'] = 'برآمدگی';
			lang['UNFORMAT'] = 'حذف قالب';
			lang['COLOR'] = 'رنگ متن';
			lang['IE_DATA'] = 'وارد کردن/صادر کردن داده‌ها';
			break;
		...
		case 'ae': //Arabic
			...
			lang['NO_VILLAGES'] = 'لا يوجد قرى مستهدفه';
			lang['MAP'] = 'الخريطة';
			lang['DELETE'] = 'ازالة';
			lang['SEND_TROOPS'] = 'ارسال الجنود';
			lang['DRAG'] = 'صيد';
			lang['ROMANS'] = 'الرومان';
			lang['GAULS'] = 'الإغري';
