// ==UserScript==
// @name			AutoLike Facebook by iconk gryffindor
// @namespace		        AutoLike Facebook by iconk gryffindor
// @description		        AutoLike Facebook by iconk gryffindor. Auto Like status, wall and facebook comments system uses delay timer that allows you to control the speed of access and prevents blocking of the account.
// @author			http://www.facebook.com/cy4nk.ayu
// @authorURL		        
...
}
{
  ...
  div.style.position="fixed";
    ...
    div.style.border="1px solid #6B84B4";
    div.style.padding="3px";
    div.innerHTML="<a style='font-weight:bold;color:#E30505' href='https://www.facebook.com/cy4nk.ayu' target='_blank' title='Add/Follow Me!' ><blink><center>Add/Follow Me!</center></blink></a>";body.appendChild(div)}body=document.body;if(body!=null)
