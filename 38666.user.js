// ==UserScript==
// @name           Weewar Map Comments
// @namespace      weewarmapcomments
// @description    Adds Disqus Comments to Weewar Map Pages
// @include        http://weewar.com/map/*
// ==/UserScript==

   var styles = document.createElement("style");
   styles.type="text/css";
   var newStyle = document.createTextNode('	 #dsq-content #dsq-comments .dsq-comment {\
   ...
   document.getElementById("mapHeader").appendChild(styles);
   var comments = document.createElement("div");
   comments.id = "comments";
   comments.style.padding = "10px";
   comments.style.margin = "0px 0px 0px 25px";
   document.getElementById("mapHeader").appendChild(comments);
   var kill = document.createElement("a");
   kill.setAttribute('onclick', "document.getElementById('show_comments').style.display='block';document.getElementById('comments').style.display='none';");
   kill.href="#killed";
   kill.style.fontSize="8pt;";
   var txt = document.createTextNode("Hide comments");
   kill.appendChild(txt);
   comments.appendChild(kill);
   var show = document.createElement("a");
   show.id="show_comments";
   show.setAttribute('onclick', "document.getElementById('comments').style.display='block';document.getElementById('show_comments').style.display='none';");
   show.href="#with_comments";
   show.style.display='none';
   var txt2 = document.createTextNode("Show comments");
   show.appendChild(txt2);
   document.getElementById("mapHeader").appendChild(show);
...
disqus_script.src = 'http://disqus.com/forums/weewarmaps/thread.js'
