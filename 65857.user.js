// ==UserScript==
// @name           TehConnection.eu :: Send torrent to (u/ru/w)Torrent WebUI
// @namespace      idkwhattoputhere
// @include        http*://*tehconnection.eu/*
// ==/UserScript==

// TehConnection.eu :: Send torrent to uTorrent WebUI by Rain724 - Modified by devkinetic for tehconnection
...
siteArray[0] = ["tehconnection", "0", "0", "action=download", "µ", "µT ", " | "];
