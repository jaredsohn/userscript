// ==UserScript==
// @name           Netvibes - Recherche Google
// @namespace      35niavlys
// @description    Redirige la recherche de Google de Netvibes directement sur le site de Google
...
function Google()
 {
    var tabSearchForm = new Element('form',{'id': 'tabSearchForm', 'class': 'autoclear atBottom', 'style': 'display: block; width: 386px;', 'method': 'get', 'action': 'http://www.google.fr/search'}).injectBefore($('NV_messageContainer')).setHTML('<fieldset><ul id="engineSelector"><li><label class="google" for="tabSearchInput">Google</label></li></ul><input id="tabSearchInput" class="text search defaultText" type="text" name="q"/></fieldset><input id="tabSearchSubmit" class="nv-button" type="submit" value="Recherche Google"/></form>');
...
//Ce script est basé sur celui de "Better Netvibes" créé par bpopoff