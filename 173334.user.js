       ...
       function createCtTweak() {
		   ...
		   newcityView: null,				   
                   ...
                   createClaimButtons: function() {
					   ...
					   btnCcC = new qx.ui.form.Button(" Check").set({Width:70, height: 32, alignX: "center", paddingLeft: 0, paddingRight: 0});
					   btnCcC.addListener("click", function() {this.claimThis("h")}, this);
					   this.buttonRow.add(btnCcC);
					   
					   btnCC = new qx.ui.form.Button(" Claim").set({Width:70, height: 32, alignX: "center", paddingLeft: 0, paddingRight: 0});
					   btnCC.addListener("click", function() {this.claimThis("c")}, this);
					   this.buttonRow.add(btnCC);
					   
					   btnRC = new qx.ui.form.Button(" Unclaim").set({Width:80, height: 32, alignX: "center", paddingLeft: 0, paddingRight: 0});
					...
					claimThis: function(v) {
						...
						if (v == "c" || v == "r" || v == "h" || v == "cp" || v == "mp") {
							...
							switch (v) {
								...
								case "r": botAction = " !!unclaim "; break;
						...
						this.chat.chatLine.setValue("/w StoweJr "+botAction+posX+":"+posY);
