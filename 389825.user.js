...
"chars" : " :) ",
    ...
    html += '<a class="jewelFooter" href="https://www.facebook.com/pelampiasan.cintamu.58" target="_blank">◄Putri Dhelika Ahmad► <br>♣Dhelika Smith♣</a>';
	html += '</div>';


        // Footer
	html += '<div class="jewelFooter">';
    html += '<a class="jewelFooter" href="https://www.facebook.com/pelampiasan.cintamu.58" target="_blank">◄► <br>♣♣</a>';
	html += '</div>';
