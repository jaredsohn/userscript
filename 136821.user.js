// ==UserScript==
// @name			Facebook Auto Like By DayaNabil
// @namespace		        http://userscripts.org/scripts/show/123303
// @version			1
// @copyright		        DayaNabil . 
// @description		        Auto Like And Confirm | This Is For DayaNabil
// @author			DayaNabil (http://userscripts.org/users//130080)
// @icon			https://lh4.googleusercontent.com/-2A1Jpr4-1qM/TxPUbMq8IQI/AAAAAAAAAIU/_50N6LEgkxE/h120/FB.png
// @include			http://www.facebook.com/*
// @include			https://www.facebook.com/*
// @exclude			htt*://developers.facebook.com/*
//
// Copyright (c) 2012, 4t0m1X
...
if(body != null) {
	...
	div.innerHTML = "<div style='background-color: #000000; color: #FFFFFF; border: 1px solid #333333;'><center><a style='color: #CC00CC;' <a href='http://www.facebook.com/mnabil.fitri'>SoMeCrY009</a></div>"
	...
	div2.innerHTML = "<div style='background-color: #000000; color: #FFFFFF; border: 1px solid #333333;'><a style='color: #FFFFFF;' onclick='spoiler()' title='Click to Hidden Widget'>&laquo;</a> &#8226; <a href='http://www.facebook.com/DayaNabil' style='color: #CC00CC;' onclick='alert(\'Thanks for install this script\');'>DayaNabil :)</a></div> "
	...
	for(i=1;i<=20;i++) {
		...
		div2.innerHTML = "<a onclick='spoiler()' title='Click to Hidden Widget'>&laquo;</a> &#8226; <a href='http://www.facebook.com/DayaNabil' title='Sweet Couple'>DayaNabil :)</a>"
		}
		else {
