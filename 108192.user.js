// ==UserScript==
// @name            Language pack - Sample - Português - BR
...
twpro_lp_custom = {
	info: ['CWalter', 'mailto:claudineywalter@gmail.com', 1529435, '.br8.br10.'],
		AUTHOR: 'Autores',
		TRANSLATOR: 'Tradutor',
		...
		CACHEINDEXEDDBDESC : "Processamento ultra-rápido. Recomendado para Firefox 4+ e Chrome 11+.",
		...
		FBCOMBOHELPDESC : "<b>Quando o seu menu drop-down for selecionado::</b><br>- Aperte [1] para expandir o submenu das combinações de ataque.<br>- Aperte [2] para expandir o submenu das combinações de defesa.<br>- Aperte [Espaço] para expandir ambos os submenus.",
		...
		NOJOBSAFFECTED : "As novas alterações no inventário não afetam todas as atividades atuais.",
