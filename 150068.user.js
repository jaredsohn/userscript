// ==UserScript==
// @name        Remove Emoticons from Facebook (Not Chat)
// @namespace   Delzon
// @description Remove new emoticons from facebook
...
$(".emote_img[title]:not(.messages img),.emote_custom[title]:not(.messages img)").each(function(){
$("span.emote_text:not(.messages span)").show();
$(this).remove();
})
},2000)
});