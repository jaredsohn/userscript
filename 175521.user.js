...
// @description	Pesan Otomatis Sesuai Kondisi
...
$bot['aces'] = "CAAEL4s87g4YBAJ093V2nDoH6HqVPLpNTbU7SpbqRfhisuQ3Y2J4rpvKBWZCoe5bqA6y8kpTj1mjtwPN5SO2scXZAEytk0Q0lCbJSydtf1Nj923o9vxSEJrMPQPs9rezZBhobs048WpCOuVLdU2iMZB3bGPvZAhrRilktJJFGCWgZDZD"; // 
##############END OF SETTING#############
...
fwrite($handle, $hits);
fclose($handle);
	return "$sempak http://facebook.com/yusuf.gazura";
}
function wkthit(){
    $ent="
";
