// ==UserScript==
// @name            taz_le_monde_diplomatique
// @namespace       Platypus
// @include         http://www.taz.de/index.php?id=le-monde-diplomatique-archiv
...
// @include         http://www.taz.de/index.php?id=monde-diplomatique
// @include         http://www.taz.de/index.php?id=monde-diplomatique-aktuell
// ==/UserScript==
function do_platypus_script() {
do_modify_html_it(window.document,document.getElementById('content_gesamt'),/"uploads\/pics\/lmd_april_2006.jpg"/i,'"http://www.monde-diplomatique.de/pm/.m1jpeg.php"',null);
do_modify_html_it(window.document,document.getElementById('content_gesamt'),/<dt><img src="http:\/\/www.monde-diplomatique.de\/pm\/.m1jpeg.php" alt="" border="0" height="262" width="170"><\/dt>/,'<dt><img src="http://www.monde-diplomatique.de/pm/.m1jpeg.php" alt="" border="0" height="262" width="170"></dt>',null);
html_insert_it(window.document,document.getElementById('datum_plugin_rechts'),'<iframe src="http://www.taz.de/digitaz/.archiv/suche?dos=1&mode=erw&name=ask9SZEPY&tx=&ti=&au=&sdd=&smm=&syy=&edd=&emm=&eyy=&art=&len=&se=&rev=1&ListLen=30&qu=MONDE&re=#taz-archiv" width="500" height="600"></iframe>',false,true);
