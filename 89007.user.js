// ==UserScript==
// @name          Facebook Resim Büyültücü
// @namespace     MsNKoPaTCocUk
// @description   Anasayfada PAylaşılan Resimlere Tıklamadan Üstüne Gelince Büyütme scitpi 
...
function inYoFace () {
  ...
  //new album images
  var newAlbumImages = document.evaluate("//a[@class='uiMediaThumb uiMediaThumbHuge']/div/i|"+
                                         "//a[@class='uiMediaThumb uiMediaThumbHuge']/i", document, null, XPathResult.UNORDERED_NODE_SNAPSHOT_TYPE, backgroundImages); 
