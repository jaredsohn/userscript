...
// @source 	somewhere
// @identifier 	nowhere
// @copyright	© blablubbb 2012  (Code snippits from Travian4 Beyond - SSE : © npocmu 2011, © Black_Cat 2012 © ms99, 2008-2012 (parts of this script © Nux, Lux, onetmt, Velonis Petros, Richard Laffers, Szabka, Victor Garcia-aka Croc-))
...
inputg.addEventListener("click", function() 
	...
	{
	try{
	if (entrees[k].getElementsByClassName("lastRaid")[0].getElementsByTagName("img")[0].getAttribute('class') == 
