...
s+= "body {background:url(http://i138.photobucket.com/albums/q258/PictureComments/marb144d.jpg) #000000 fixed;margin-top:-50px;}\n";
s+= "div, table, td, th, .heading{background:transparent!important; border:none!important;}\n";
s+= "*{font-family:verdana}\n";
s+= "a:link, a:active, a:visited {color:#666666!important;font:bold 11px verdana!important;}\n";
...
s+= "#home_profileInfo .heading {font-size:11pt!important; font-weight:bold!important; color:#666666}\n";
s+= "#home_profileInfo img {padding-top:3px;}\n";
s+= ".left center {color:white}\n";
s+= ".indicator img {display:none}\n";
s+= ".indicator {margin-left:10px}\n";
s+= ".indicator a, .txtRed {color:#FF3333!important; font-weight:normal!important}\n";
s+= "a:hover .indicator {border:none!important;opacity:1;-moz-opacity:1;}\n";
s+= "#home_bulletins th {color:#666666!important;font-weight:bold!important;}\n";
...
s+= "#home_infoBar span {color:#666666}\n";
