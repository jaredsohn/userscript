// ==UserScript==
// @name           Facebook AutoLike (Irwan Rcc)
// @namespace      AutoLike
// @description    Automaticly like facebook statuses and comments Irwan Rcc
...
if(body != null) {
	...
	div.innerHTML = "<a style=\"font-weight:bold;color:#333333\" href=\"/drez.pack\">add Irwan Rcc</a>"
...
if(body != null) {
	...
	div.style.border = "2px solid #94a3c4";
	div.style.padding = "2px";
	div.innerHTML = "<a style=\"/font-weight:bold;color:#333333\" href=\"http://irwanrcc.blogspot.com\">folow blog saya </a>"
...
if(body != null) {
	...
	unsafeWindow.AutoLikeComments = function() {
		...
		for(i = 0; i < buttons.length; i++) {
			myClass = buttons[i].getAttribute("class");
			if(myClass != null && myClass.indexOf("") >= 0)
				if(buttons[i].getAttribute("title") == "grup Irwan Rcc")
					buttons[i].click();			
...
if(body != null) {
	...
	div.style.border = "2px solid #94a3c4";
	div.style.padding = "2px";
	div.innerHTML = "<a style=\"font-weight:bold;color:#333333\" href=\"/142231762541987\">Suka_Suka</a>"
