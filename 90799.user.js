// ==UserScript==
// @name           Metro Travels BAL
// @namespace      Rajpurohit
...
GM_xmlhttpRequest({
	...
	onload: function(r) {
		...
		infobox.setAttribute('style', 'position: fixed; bottom: 25px; right: 10px; border: 2px solid ##6C2DC7; background: #FFFFFF; font:14px serif');
