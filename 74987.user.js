...
(function(){
  hideBottomStuff = false // set to false if you want to keep shown the stuff below the message area
  ...
  {
    if (j) {
      css = ".aC {display:none !important;} .aC + div.nH > div.no > div:nth-child(2) {display:none !important;} .aC + div.nH > div.no > div:nth-child(3) {width:100% !important;} .aC + div.nH > div.no {width:100% !important;}"
      text.nodeValue = text.nodeValue + css
    }
    else {
      text.nodeValue = text.nodeValue.substring(0,text.nodeValue.length-211)
    }
    j = !j
  }
