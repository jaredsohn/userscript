...
var twpro_lang = {
	...
	var twpro_langs = {};
	twpro_langs.ru = {
	info: ['NightStalker', 'mailto:pranjuvasili@yahoo.com', 20291, '.ru7.ru8.ru9.'],
		AUTHOR: 'Автор',
		TRANSLATOR: 'Преводчик',
		TWPRO_DISABLED: 'Скрипт выключен: нужно обновить скрипт для текущей версии игры The-West',
		SORTBYNAME: 'Сортировать по <b>названию</b>',
		SORTBYXP: 'Сортировать по <b>опыту</b>',
		SORTBYWAGES: 'Сортировать по <b>зароботку</b>',
		...
		FILTERJOBS: "Скрыть недоступные работы", 
		FILTERCLOTHING: 'Отображать только лучшее для данной работы',
		CHOOSEJOB: 'Выберите работу...',
		CALCJOB: 'Расчет данных, подождите...',
		...
		HPTOTAL: 'Всего очков здоровья',
		STARTCALC: 'Расчитать...',
		CONVERT: 'Конвертировать',
		MULTISEL: 'Продать несколько предметов...',
		SELL: 'Продать выбранные', 
		CONFIRMSELL: 'Продать все %1 штабеля?',
		SELLING: 'Продажа...',
		SALEDONE: 'Выбранные предметы проданы.',
		NONESELECTED: 'Нужно выбрать по крайней мере один предмет!',
		JOBRANKSETTINGS: 'Настройки рейтинга работ', 
		SEARCHINVENTORY: 'Поиск в багаже',
		NOSEARCHRESULT: 'Поиск для не дал результатов.%2Показать всё.%3',
		DISABLEBESTFORJOB: 'Не скрывать подходящие для данной работы предметы.', 
		SEARCHHELP: 'Поиск в багаже. Можно использовать групповые символы (? для одного символа, * для любого количества символов)',
		DUELSHOOTINGATT: ' \u25B7 Дуэль стрелок (атака)',
		DUELSHOOTINGDEF: ' \u25B7 Дуэль стрелок (защита)',
		DUELVIGOR: ' \u25B7 Дуэль ударник',
		FORTATTACK: ' \u25B7 Битва за форт (атака)',
		FORTDEFEND: ' \u25B7 Битва за форт (защита)',
		FORTMESSAGE: 'Сообщение участникам',
		FORTMESSAGERCP: 'Количество получателей',
		HIDEJOBS: 'Управление работами и наборами',
		CONFIRM: 'Подтвердить', 
		HIDEJOBDESC: 'Работы можно исключить из расчетов. Отметьте работы которые не нужны и нажмите Подтвердить',
		SHOWN: 'Включено',
		HIDDEN: 'Выключено',
		NOEQUIP: "Без снаряжения", 
		BESTEQUIP: "С лучшим снаряжением", 
		SETTINGSSAVED: 'Настройки для TW Pro были сохранены!', 
		SETTINGSSAVEDSESSION: 'Настройки для TW Pro были сохранены! (только для этой сессии)',
		PERSISTSETTINGS: 'Сохранить эти настройки для всех сессий.',
		CANNOTWEAR: 'Набор не может быть использован или не влияет на расчеты.',
		SETSETTINGS: 'Отключить наборы для ускорения расчетов. Неподходящие наборы по умолчанию отключены.',
		CUSTOMNAME: 'Введите название для работы', 
		CUSTOMCALCULATION: 'Введите подходящие параметры для TW Pro здесь.',
		CUSTOMENABLED: 'Поставьте галочку чтобы включить работу',  
		NEW: 'Новый',
		SPEED: ' \u25B7 Скорость',
		REGENERATION: ' \u25B7 Быстрое восстановление',
		SETSINFO: "Наборы",
		WITHSETITEMS: 'Бонус с %1 предметами',
		LABORPOINTS: 'Трудовые очки',
		USEFULITEM: 'Это число показывает сколько предметов использовалось при расчетах',
		PERCREGENERATION: 'Восстановление',
		LUCK: 'удача',
		PRAYING: 'молитва',
		NOITEMSETS: "У вас нет предметов из этого набора",
		AVERAGEDAMAGE: "Средний урон",
		PREFERENCES: "Настройки",
		DEFAULTSORTING: " \u25B7 Сортировка по умолчанию",
		FBHEALTHPRIORITY: "Приоритет очкам здоровья",
		FBHEALTHPRIORITYZERO: "0| Нет",
		FBHEALTHPRIORITYLOW: "1| Низкий",
		FBHEALTHPRIORITYMEDIUM: "2| Средний",
		FBHEALTHPRIORITYHIGH: "3| Высокий",
		FBHEALTHPRIORITYAUTO: "4| Авто",
		FBBATTLEUNIT: "Тип игрока в битве",
		FBBATTLEUNITSKIRMISHER: "1| Застрельщик (уворот) | Передовая",
		FBBATTLEUNITLINEINFANTRYMAN: "2| Пехота (многозначный) | Средняя линия",
		FBBATTLEUNITMARKSMAN: "3| Стрелок (прицеливание) | Тыл",
		FBTAGS : [["0", "1", "2", "3", "@"], ["З", "П", "С"]],
		DMGMIN: "Минимум",     
		DMGMAX: "Максимум",     
		DMGAVG: "Средний",    
		CHATWHISPER: "* Шепнуть *\n\nВведите имя игрока",
		CHATCOLOR: "* Свой цвет (000cb-999cb) *\n\nВведите цвет",
		USEFULITEMS : "Выделять все предметы подходящие для моих работ",
		USEFULITEMSPOPUP : " \u25B7 Подсветка с деталями",
		USEFULITEMSPOPUPDESC : "Бонусы по работам будут показаны на каждом подходящем предмете (процесс займет чуть больше времени).",
		SHOWALLJOBS : " \u25B7 Показать все работы на карте",
		SHOWALLJOBSDESC : "Будет включен после обновления страницы (F5)",
		COLLECTORMODE : " \u25B7 Режим барыги",
		COLLECTORMODEDESC : "Предметы у продавцов будут выделены синим если у вас еще нет этих предметов.",
		HELP : "ПОМОЩЬ",
		WEBSTORAGEQUOTAEXCEEDED : "Квота Веб хранилища превышена!\n\n- Ваши данные будут повреждены.\n- Опция кэш выключена автоматически.\n- Очистите кэш некоторых аккаунтов на этом сервере или увеличьте лимит квоты хранилища (возможно только для Firefox и Opera).",
		CACHEGENERATE : "Создать кэш...",
		CACHEUPDATE : "Обновите кэш",
		CACHEFORCEOK : "Сбросить изменения.",
		CACHEFORCEOKDESC : "Изменить статус на OK без проведения расчетов.",
		CACHEGENERATENOW : "Создать кэш сейчас?",
		CACHEUPDATENOW : "Обновить кэш сейчас?",
		CACHEINVENTORYCHANGES : "Обнаружены изменения в багаже.",
		CACHEUPDATECLICK : "Нажмите чтобы обновить кэш.",
		CACHENEWITEMS : "Новый предмет",
		CACHEDELETEDITEMS : "Удаленные предметы",
		CACHESKILLSCHANGES : "Обнаружены изменения навыков.",
		CACHEJOBSAFFECTED : "Измененные работы",
		CACHEISEMPTY : "Кэш пустой.",
		CACHEINITIALIZE : "Нажмите чтобы инициализировать.",
		CACHEOK : "Кэш OK.",
		CACHEREWRITE : "При необходимости можно перезаписать данные нажатием сюда.",
		CACHEEMPTYING : "Очистка кэш...",
		CACHENORMALMODE : "TW Pro находится в обычном режиме в процессе обработки.",
		CACHEDISABLED : "Кэш выключен.",
		CACHEOPENSETTINGS : "Открыть настройки TW Pro чтобы включить.",
		CACHENEWJOBSDETECTED : "Oбнаружены новые работы.",
		CACHENEWJOBDETECTED : "Обнаружены новые работы: %1<br>Обновите кэш.",
		CACHEENABLE : " \u25B7 Включить кэш TW Pro",
		CACHEINDEXEDDBNOT : "IndexedDB не поддерживается вашим браузером.",
		CACHEINDEXEDDBDESC : "Ультра быстрая обработка. Рекомендуется для Firefox 4+ и Chrome 11+.",
		CACHECOMPATIBILITY : "Информация о совместимости",
		CACHEQUOTAS : "Информация по квотам",
		CACHEQUOTASDESC : "<b>Нажмите на 'Информация по квотам' чтобы узнать предел хранилища вашего браузера.<br>"
				  +"<br>Как увеличить лимит хранилища?</b><br>"
				  +"<b>- Firefox:</b><br>"
				  +"Наберите 'about:config' в адресной строке и ищите опцию 'dom.storage.default_quota'.<br>"
				  +"Это значение дано в килобайтах, его можно изменить. Хранилище используется совместно <br>"
				  +"с языковым сервером, необходимо около 1500 kB на аккаунт на одном и том же сервере.<br>"
				  +"<b>- Chrome:</b><br>"
				  +"Управление квотами отсутствует<br>"
				  +"<b>- Opera:</b><br>"
				  +"По умолчанию ваш браузер сам предложит увеличить лимит хранилища при необходимости. <br>"
				  +"Также можно набрать 'opera:webstorage' в адресной строке и настроить вручную.<br>"
				  +"Это значение дано в килобайтах. Хранилище используется совместно в каждом мире, это<br>"
				  +"потребует около 3000 kB на аккаунт в одном и том же мире.<br>"
				  +"<b>- Safari:</b><br>"
				  +"Управление квотами отсутствует",
		CACHEEMPTY : "Очистить кэш TW Pro.",
		CACHEEMPTYDESC : "Утилита восстановления. Используйте только в случае несоответствия.",
		CACHEWEBSTORAGEDESC : "Быстрая обработка. Поддерживается большинством браузеров но может потребовать изменений в лимите квоты.",
		CACHEEMPTYNOW : "Очистить кэш сейчас?",
		CACHERECORDS : "записи",
		CACHEEMPTIED : "Кэш очищен!",
		CACHERECORDSDELETED : "записи удалены.",
		CACHEEMPTYSLOWDESC : "Игра возможна в процессе очистки.",
		CACHEEMPTYFASTDESC : "Быстрее, но браузер может зависнуть в процессе обработки.",
		CACHEFASTMODE : "Быстрый режим",
		NORMALMODE : "Обычный режим",
		FBCOMBOFAVORITE : "Предпочитаемый",
		FBCOMBOGENERATE : "Произвести все фортовые комбинации",
		FBCOMBODESC : "Это добавит еще 30 работ к выпадающему меню, но их также можно расположить в подмнею",
		FBCOMBONORMALDESC : "Показывает комбинации как обычные работы в списке работ.",
		FBCOMBOSUBMENUS : "Режим подменю",
		FBCOMBOSUBMENUSDESC : "Показывает комбинации как подменю в списке работ",
		FBCOMBOHELPDESC : "<b>Когда открыт список работ:</b><br>- Нажмите [1] чтобы открыть подменю комбинаций атаки.<br>- Нажмите [2] чтобы открыть подменю комбинаций защиты.<br>- Нажмите [Пробел] чтобы открыть оба подменю комбинаций.",
		FBCOMBOMOZTIP : "На браузере Firefox можно также нажать правой кнопкой на меню чтобы открыть",
		SAFEMODE : " \u25B7 Включить безопасный режим",
		SAFEMODEDESC : "Расчет идет медленнее, но предотвращает зависания и сбои браузера.",
		SAFEMODEFBEXCL : "Не запускать безопасный режим если используется ручная настройка для фортовых битв.",
		SAFEMODERUNNING : "Безопасный режим запущен...",
		SAFEMODERUNNINGDESC : ["В течение расчетов:", "- Не закрывайте и не обновляйте багаж.", "- Не продавайте и не покупайте предметы.", "- Не переодевайтесь.", "- Не меняйте навыки.", "Все в порядке, Я обязуюсь выполнить вышеперечисленное..."],
		SAFEMODECOMPLETED : "Расчет в безопасном режиме окончен,",
		ACTIVITIES : "Работы",
		ITEMS : "Предметы",
		ITEMSETSCOMBI : "Комбинации предметов",
		TESTSRUN : "Количество проведенных тестов.",
	 ...
	 if(this.colorTagTell == true && $('chatwindow_say').value.substring(0, 6) != '/tell '){
		...
		return '/tell ' + this.tellName + ': ' + texte;
		 ...
		 if (couleur) {
		   ...
		   return '/' + couleur.substring(0,3) + texte;
		 } else {
		   return texte;
		 }
	 }	 
