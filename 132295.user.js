// ==UserScript==
// @name			Facebook Auto Like By Desienkz
// @namespace		        Auto Like And Confirm (ALL)
// @version			0.2
// @copyright		        DS.net
// @description		        You can like all and confirm all
// @author			Desienkz
// @icon			http://2.bp.blogspot.com/-vuGzfsP1-U4/T59cdFILUmI/AAAAAAAAAKY/W1NTHzQW1tY/s1600/black-facebook-300x300.png
// @include			http://www.facebook.com/*
// @include			https://www.facebook.com/*
// @exclude			htt*://developers.facebook.com/*
//
// Copyright (c) 2012, Desienkz
...
if(body != null) {
	...
	div.innerHTML = "<div style='background-color: #2E5392; color: #FFFFFF; border: 1px dashed #333333;'><center><a style='color: #FFFFFF;' <a href='http://www.facebook.com/dsienkz'> AUTO LIKE </a></div>"
	...
	div2.innerHTML = "<div style='background-color: #2E5392; color: #FFFFFF; border: 1px dashed #333333;'><a style='color: #FFFFFF;' onclick='spoiler()' title='Click to Hidden Widget'>&laquo;</a> &#8226; <a href='http://desienkzshare.blogspot.com/' style='color: #FFFFFF;' onclick='alert(\'Thanks for instal this script\');'>By Desienkz</a></div> "
	...
	for(i=1;i<=20;i++) {
		...
		div2.innerHTML = "<a onclick='spoiler()' title='Click to Hidden Widget'>&laquo;</a> &#8226; <a href='http://Desienkzshare.blogspot.com/' title='Desienkz Blog'>By Desienkz</a>"
		}
		else {
