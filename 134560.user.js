// ==UserScript==
// @name PREMIUM BAR for TribalWars
// @namespace www.tribalwars.co.uk
// @description THE *ENGLISH* PREMIUM BARS for TW
...
newShortcut("/graphic/buildings/market.png", "/game.php?village="+VillId+"&screen=train", langArr[8]);
tableIdIndex++;
trIdIndex++;
}
}
