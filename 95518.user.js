// ==UserScript==
// @name	The West - ColorMe [SOM] (Beta)
...
function infoScript() {
	...
	if ((window.location.hostname.substr(0, window.location.hostname.search(/\./))).indexOf("fr") != '-1') {
		...
		somMsg ='<span style="color:#000066; text-align:center;"><b>Chat features are provided by [SOM]. Meet us <a href=\"' +url1+ '\" target="_blank">here</a>. More scripts with laguage pack <a href=\"' +url2+ '\" target="_blank">here</a>. Enjoy!.</b><br><i>Version : '+this.myVersion +' Author : ' +Author+ '</i></span>'; 
	}	
