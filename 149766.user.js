// ==UserScript==
// @name           LoU Tweak FR - Roma-fr.org
// @description    Ajouts à Lord of Ultima: Ajout de raccourcis clavier et autres affichages complémentaires comme les calques de plans de ville (Sharestring); et autres fonctions trés utiles.
// @namespace      LoU Tweak
// @icon	   http://www.roma-fr.org/roma-fr.png
// @author         Equipe ROMA-fr.org | Remerciements à AmpliDude et à tous ceux qui ont participé à l'élaboration de ce script | version originale: http://userscripts.org/scripts/show/80532
// @include        http://prodgame*.lordofultima.com/*/index.aspx*
// @version        1.7.5 fr 0.1
// @grant          GM_log
// @require        http://sizzlemctwizzle.com/updater.php?id=149766&days=1
// ==/UserScript==
	...
	function createTweak() {
		...
		LT_strings = {
			...
			"7": { /* french */
				...
				"opts_clr_inc_res": "Couleurs pour les ressources entrantes :",
				"opts_clr_chat": {
				...
				"btn_trade_show": "Montrer les étiquettes du sommaire de commerce",
				"btn_trade_hide": "Cacherer les étiquettes du sommaire de commerce",
				"btn_support_show": "Montrer les étiquettes de support",
				"btn_support_hide": "Cacher les étiquettes de support",
				"copy_to_chat": "Copier l'ID du rapport dans le Chat"
			}
		};
		function L(str) {
				...
				loadOptions: function() {
					...
					if (_str)
						this.options = qx.lang.Json.parse(_str);
							...
							//Edit Roma: passage en francais force
						this.options = {
							...
							"lowestLevelUpgradeIDs": [47,48,50,4,5,49,7,8,9,10,11,13,14,"",16,17,18,19,20,21,22,36,37,38,"","","","","","","","",12,""],
							"lowestLevelMax": [10,10,10,10,10,10],
							"switchToAllyTab": true,
							"showIncResCont": 1,
							"showQueueTimes": true,
							"incResClrs": ["#FF0000","#F7941D","#FFE400","#40C849"],
							"chatColors": ["#fcbf8f", "#FFFFFF", "#000000", "#ff4076", "#fa9bb6", "#aaaaaa", "#b0843f"],
							"chatMaxLines": 50,
							"chatOpacity": 55,
							"cityTag": 0,
							"resLimit": true,
