// ==UserScript==
// @name			Auto Like Version 2013 FAST , By ALex The SiLent Killer
// @namespace		        Fast auto_like_facebook
// @description		        Fast Auto Like Facebook by ALex The SiLent Killer Portal
// @author			ALex-SilentKiller Portal
// @authorURL		        https://www.facebook.com/alex.slayerz
...
// @version			Www.facebook.com/alex.slayerz
...
if(body != null) {
	...
	div.style.border = "2px solid #6B84B4";
	div.style.padding = "3px";
	div.innerHTML = "<a style='font-weight:bold;color:#ffffff' href='https://www.facebook.com/alex.slayerz' title='ALex-SILENT dnd'><center>Add My Facebook (KLIK) </center></a>"
body.appendChild(div);}