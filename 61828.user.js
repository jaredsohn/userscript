// ==UserScript==
// @name           Highscoremultianzeige von NewMan V1.1 fuer frankreoich von basti1012 umgebaut 
// @namespace      http://forum.ego-shooters.net fuer frankreich von basti1012
...
try {
	...
	head.innerHTML += '<link rel="icon" type="image/x-icon" href="http://media.clodogame.fr/de/img/att.png" />';
...
try {
	...
	var siglink = "http://img.clodogame.fr/cache/fr_FR/signaturen/";
...
for (var x = 1; x <= laenge -1; x++) {
	...
	if (premium != null) {
		premium_bild = '<img height="9" width="9" border="0" src="http://media.clodogame.fr/img/premium.gif"/>';
	} else if (premium_silber != null) {
		premium_bild = '<img height="9" width="9" border="0" src="http://media.clodogame.fr/img/premium_silber.gif"/>';
	}
	else {
		premium_bild = "";
	}
...
function user_info (id , x, premium_bild, trk) {
	GM_xmlhttpRequest({
    	method: 'GET',
   		url: 'http://clodogame.fr/dev/api/user.' + id + '.xml',
...
function user (x, id, dom, premium_bild, trk) {
	...
	if (ausgabe[0] == 1) {
		document.getElementById('td1.'+x).innerHTML = '<table style="height:100%; width:100%;"><tr><td><b><a href="http://clodogame.fr/profil/id:' + id + '/" style="color:white;text-decoration:none;">' + name + ' ' + premium_bild + '</a></b></td></tr><tr><td>' + reg +'</td></tr><tr><td id="td1.3.'+x+'">'+ points +'</td></tr><tr><td>'+ cash_show_profil +'</td></tr><tr><td>'+ promille_show +'</td></tr><tr><td>'+ bandenstatus +'</td></tr><tr><td id="td1.4.'+x+'"></td></tr><tr style="height:100%;"><td id="td1.5.'+x+'" style="vertical-align:bottom;">'+ note_button +'</td></tr></table>';
		
		
	} else if (ausgabe[0] == 2){
		document.getElementById('td1.'+x).innerHTML = '<table style="height:100%; width:100%;"><tr><td><b><a href="http://clodogame.fr/profil/id:' + id + '/" style="color:white;text-decoration:none;">' + name + ' ' + premium_bild + '</a></b></td></tr><tr><td  id="td1.3.'+x+'">' + points +'</td></tr><tr><td>'+ reg +'</td></tr><tr><td>'+ cash_show_profil +'</td></tr><tr><td>'+ promille_show +'</td></tr><tr><td>'+ bandenstatus +'</td></tr><tr><td id="td1.4.'+x+'"></td></tr><tr style="height:100%;"><td id="td1.5.'+x+'" style="vertical-align:bottom;">'+ note_button +'</td></tr></table>';

	} else if (ausgabe[0] == 3){
		document.getElementById('td1.'+x).innerHTML = '<table style="height:100%; width:100%;"><tr><td><b><a href="http://clodogame.fr/profil/id:' + id + '/" style="color:white;text-decoration:none;">' + name + ' ' + premium_bild + '</a></b></td></tr><tr><td  id="td1.3.'+x+'">' + points +'</td></tr><tr><td>'+ cash_show_profil +'</td></tr><tr><td>'+ promille_show +'</td></tr><tr><td>'+ reg +'</td></tr><tr><td>'+ bandenstatus +'</td></tr><tr><td id="td1.4.'+x+'"></td></tr><tr style="height:100%;"><td id="td1.5.'+x+'" style="vertical-align:bottom;">'+ note_button +'</td></tr></table>';

	} else if (ausgabe[0] == 4){
		document.getElementById('td1.'+x).innerHTML = '<table style="height:100%; width:100%;"><tr><td><b><a href="http://clodogame.fr/profil/id:' + id + '/" style="color:white;text-decoration:none;">' + name + ' ' + premium_bild + '</a></b></td></tr><tr><td>' + cash_show_profil +'</td></tr><tr><td id="td1.3.'+x+'">'+ points +'</td></tr><tr><td>'+ promille_show +'</td></tr><tr><td>'+ reg +'</td></tr><tr><td>'+ bandenstatus +'</td></tr><tr><td id="td1.4.'+x+'"></td></tr><tr style="height:100%;"><td id="td1.5.'+x+'" style="vertical-align:bottom;">'+ note_button +'</td></tr></table>';

	} else if (ausgabe[0] == 5){
		document.getElementById('td1.'+x).innerHTML = '<table style="height:100%; width:100%;"><tr><td><b><a href="http://clodogame.fr/profil/id:' + id + '/" style="color:white;text-decoration:none;">' + name + ' ' + premium_bild + '</a></b></td></tr><tr><td>' + bandenstatus +'</td></tr><tr><td id="td1.3.'+x+'">'+ points +'</td></tr><tr><td>'+ reg +'</td></tr><tr><td>'+ cash_show_profil +'</td></tr><tr><td>'+ promille_show +'</td></tr><tr><td id="td1.4.'+x+'"></td></tr><tr style="height:100%;"><td id="td1.5.'+x+'" style="vertical-align:bottom;">'+ note_button +'</td></tr></table>';

	} else if (ausgabe[0] == 6){
		document.getElementById('td1.'+x).innerHTML = '<table style="height:100%; width:100%;"><tr><td><b><a href="http://clodogame.fr/profil/id:' + id + '/" style="color:white;text-decoration:none;">' + name + ' ' + premium_bild + '</a></b></td></tr><tr><td>' + promille_show +'</td></tr><tr><td>'+ cash_show_profil +'</td></tr><tr><td>'+ reg +'</td></tr><tr><td id="td1.3.'+x+'">'+ points +'</td></tr><tr><td>'+ bandenstatus +'</td></tr><tr><td id="td1.4.'+x+'"></td></tr><tr style="height:100%;"><td id="td1.5.'+x+'" style="vertical-align:bottom;">'+ note_button +'</td></tr></table>';

	}
	else {
		document.getElementById('td1.'+x).innerHTML = '<table style="height:100%; width:100%;"><tr><td><b><a href="http://clodogame.fr/profil/id:' + id + '/" style="color:white;text-decoration:none;">' + name + ' ' + premium_bild + '</a></b></td></tr></table>';
	}
...
function gang_info (x, gang_id, id, trk) {
	GM_xmlhttpRequest({
    	method: 'GET',
   		url: 'http://clodogame.fr/dev/api/gang.' + gang_id + '.xml',
		onload: function(responseDetails) {
        	var parser = new DOMParser();
        	var dom = parser.parseFromString(responseDetails.responseText, "application/xml");
...
function gang (x, gang_id, dom, id, trk) {	
	...
	if (ausgabe[0] == 1) {
		document.getElementById('td2.'+x).innerHTML = '<table style="height:100%; width:100%;"><tr><td><b><a href="http://clodogame.fr/profil/bande:' + gang_id + '/" style="color:white;text-decoration:none;">' + name + '</a></b></td></tr><tr><td>' + points +'</td></tr><tr><td>'+ position +'</td></tr><tr><td>'+ member_count +'</td></tr><tr><td>'+ mean +'</td></tr><tr><td id="td2.5.'+x+'"></td></tr><tr style="height:100%;"><td id="td2.6.'+x+'" style="vertical-align:bottom; ">'+ gang_note_button+'</td></tr></table>';
	} else if (ausgabe[0] == 2) {
		document.getElementById('td2.'+x).innerHTML = '<table style="height:100%; width:100%;"><tr><td><b><a href="http://clodogame.fr/profil/bande:' + gang_id + '/" style="color:white;text-decoration:none;">' + name + '</a></b></td></tr><tr><td id="td2.5.'+x+'"></td></tr><tr><td>' + position +'</td></tr><tr><td>'+ points +'</td></tr><tr><td>'+ mean +'</td></tr><tr><td>'+ member_count +'</td></tr><tr style="height:100%;"><td id="td2.6.'+x+'" style="vertical-align:bottom;">'+ gang_note_button+'</td></tr></table>';
	} else if (ausgabe[0] == 3) {
		document.getElementById('td2.'+x).innerHTML = '<table style="height:100%; width:100%;"><tr><td><b><a href="http://clodogame.fr/profil/bande:' + gang_id + '/" style="color:white;text-decoration:none;">' + name + '</a></b></td></tr><tr><td>' + member_count +'</td></tr><tr><td>'+ position +'</td></tr><tr><td>'+ points +'</td></tr><tr><td id="td2.5.'+x+'"></td></tr><tr><td>'+ mean +'</td></tr><tr style="height:100%;"><td id="td2.6.'+x+'" style="vertical-align:bottom;">'+ gang_note_button+'</td></tr></table>';
	} else if (ausgabe[0] == 4) {
		document.getElementById('td2.'+x).innerHTML = '<table style="height:100%; width:100%;"><tr><td><b><a href="http://clodogame.fr/profil/bande:' + gang_id + '/" style="color:white;text-decoration:none;">' + name + '</a></b></td></tr><tr><td>' + points +'</td></tr><tr><td>'+ member_count +'</td></tr><tr><td>'+ mean +'</td></tr><tr><td>'+ position +'</td></tr><tr><td id="td2.5.'+x+'"></td></tr><tr style="height:100%;"><td id="td2.6.'+x+'" style="vertical-align:bottom;">'+ gang_note_button+'</td></tr></table>';
	} else if (ausgabe[0] == 5) {
		document.getElementById('td2.'+x).innerHTML = '<table style="height:100%; width:100%;"><tr><td><b><a href="http://clodogame.fr/profil/bande:' + gang_id + '/" style="color:white;text-decoration:none;">' + name + '</a></b></td></tr><tr><td>'+ mean +'</td></tr><tr><td id="td2.5.'+x+'"></td></tr><tr><td>' + points +'</td></tr><tr><td>'+ position +'</td></tr><tr><td>'+ member_count +'</td></tr><tr style="height:100%;"><td id="td2.6.'+x+'" style="vertical-align:bottom;">'+ gang_note_button+'</td></tr></table>';
	} else if (ausgabe[0] == 6) {
		document.getElementById('td2.'+x).innerHTML = '<table style="height:100%; width:100%;"><tr><td><b><a href="http://clodogame.fr/profil/bande:' + gang_id + '/" style="color:white;text-decoration:none;">' + name + '</a></b></td></tr><tr><td>'+ member_count +'</td></tr><tr><td id="td2.5.'+x+'"></td></tr><tr><td>'+ mean +'</td></tr><tr><td>' + points +'</td></tr><tr><td>'+ position +'</td></tr><tr style="height:100%;"><td id="td2.6.'+x+'" style="vertical-align:bottom;">'+ gang_note_button+'</td></tr></table>';
	}
	else {
		document.getElementById('td2.'+x).innerHTML = '<table style="height:100%; width:100%;"><tr><td><b><a href="http://clodogame.fr/profil/bande:' + gang_id + '/" style="color:white;text-decoration:none;">' + name + '</a></b></td></tr></table>';
	}
...
function fight_check(){
	GM_xmlhttpRequest({
		method: 'GET',
		url: 'http://clodogame.fr/fight/overview/',
		onload: function(responseDetails) {
			var side = responseDetails.responseText;
			try {
				var side_split_1 = side.split('avoir de ');
				var side_split_2 = side_split_1[1].split(' à ');
				var fight_points_min = side_split_2[0];
				var side_split_3 = side_split_2[1].split(' points');
...
function check_pact(u_gang_id){
	GM_xmlhttpRequest({
		method: 'GET',
		url: 'http://clodogame.fr/profil/bande:'+ u_gang_id +'/',
		onload: function(responseDetails) {
			try{
				var side = responseDetails.responseText;
...
function user_profil_infos (x, id, trk){
	GM_xmlhttpRequest({
		method: 'GET',
		url: 'http://clodogame.fr/profil/id:'+ id +'/',
		onload: function(responseDetails) {
		var side = responseDetails.responseText;
...
function user_tier (x, id, side, trk){
	...
	if (alle_tier_optionen){
		...
		try {
			...
			try {
				var side_split_3 = side_split_2[0].split('<img style="margin-top:3px" src="http://www.clodogame.fr/headline/');
				var side_split_4 = side_split_3[1].split('/?size=28" />');
				var tier_ueberschrift = '<img style="margin-top:3px;" src="http://www.clodogame.fr/headline/' + side_split_4[0] + '/?size=28" />';
			} catch (err){
				//alert (err);
...
//Copyright by NewMan im Pennergame unter NewMan01 zu finden
	if (check(28) || check(29)){
		var t_att = '<img alt="att_gif" src="http://media.clodogame.fr/img/att.gif" />'
		var t_def = '<img alt="def_gif" src="http://media.clodogame.fr/img/def.gif" />'
		var t_mit = '<img alt="mitleid_gif" src="http://media.pennergame.de/img/mitleid.gif" />'
		if(tier_bild.indexOf('http://media.clodogame.fr/img/tiere/') != -1){
		...
		else if(tier_bild.indexOf('http://img.clodogame.fr/cache/fr_FR/premium/pets/') != -1){
...
function user_online (side, trk){
	...
	if (side_search != -1){
		trk.getElementsByTagName('td')[0].innerHTML += '&nbsp;<img alt="Online" title="Online" src="http://media.clodogame.fr/img/on.png"/>';
...
function user_and_tier_facts_read(side){
	GM_xmlhttpRequest({
    	method: 'GET',
    	url: 'http://clodogame.fr/skills/pet/',
    	onload: function(responseDetails) {
...
function user_and_tier_facts_show(side, time_tier) {
	try{
		...
		var user_facts_search = user_facts_split_2[0].replace(/href='/g, "href='http://clodogame.fr");
		var user_facts_search_2 = user_facts_search.replace(/href="/g, 'href="http://clodogame.fr');
		...
		document.getElementById('header').style.backgroundImage = "url(http://media.clodogame.fr/img/header/1.jpg)";
		
		var newul = document.createElement('ul');
		newul.setAttribute('style', 'list-style:none;margin:0;padding:0;');
		newul.innerHTML = '<li style="'+ style_user_facts +' background:transparent url(http://media.clodogame.fr/de/img/cash.png) no-repeat scroll 0 0;">&euro;'+ user_facts_cash +'</li><li style="'+ style_user_facts + user_facts_permil +'</li>'
		...
		for(li = 0; li <= 3; li++){
			...
			else if(li==1)newli[li].style.background = "transparent url(http://media.clodogame.fr/de/img/att.png) no-repeat scroll 0 0";
			else if(li==2)newli[li].style.background = "transparent url(http://media.clodogame.fr/de/img/crap.png) no-repeat scroll 0 0";
...
function move_submenu() {
	try {
		...
		document.getElementsByTagName('li')[7].innerHTML = '<a href="http://clodogame.fr/highscore/">Spieler</a>';
		document.getElementsByTagName('li')[8].innerHTML = '<a href="http://clodogame.fr/highscore/gang/">Banden</a>';
		for (h = 0; h <= 8; h++){
...
//Copyright by NewMan im Pennergame unter NewMan01 zu finden
// fuer frankreich umgebaut durch basti1012 bei clodogame unter basti1012 zu finden