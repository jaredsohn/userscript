// ==UserScript==
// @name            1UP Main Board Link 2.0
// @namespace       The Official 1UP Message Boards
// @include         http://www.1up.com/boards/posts/list*
// ==/UserScript==
function do_platypus_script() {
html_insert_it(window.document,document.evaluate('/HTML[1]/BODY[1]/DIV[6]/DIV[1]/DIV[1]/DIV[1]/A[1]', document, null, XPathResult.FIRST_ORDERED_NODE_TYPE,null).singleNodeValue,'<a href="http://www.1up.com/boards/" class="nav">1up Message Boards</A>&nbsp;:',true,false);
do_modify_html_it(window.document,document.evaluate('/HTML[1]/BODY[1]/DIV[6]/DIV[1]/DIV[1]/DIV[1]/A[1]', document, null, XPathResult.FIRST_ORDERED_NODE_TYPE,null).singleNodeValue,/&lt; Back to /,'',null);
html_insert_it(window.document,document.evaluate('/HTML[1]/BODY[1]/DIV[6]/DIV[1]/DIV[1]/A[1]', document, null, XPathResult.FIRST_ORDERED_NODE_TYPE,null).singleNodeValue,'<a href="http://www.1up.com/boards/" class="nav">1up Message Boards</A>&nbsp;:',true,false);
do_modify_html_it(window.document,document.evaluate('/HTML[1]/BODY[1]/DIV[6]/DIV[1]/DIV[1]/A[1]', document, null, XPathResult.FIRST_ORDERED_NODE_TYPE,null).singleNodeValue,/&lt; Back to /,'',null);
