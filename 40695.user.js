...
/*
	...
	var lang_ru = new Array();
        ...
        lang_dk['MARK']         = 'VÃ¦lg alle';
        lang_dk['PERDIDAS']     = 'Tab';
        lang_dk['RENT']         = 'Profit';
        lang_dk['SUBIR_NIVEL']  = 'Udvidelse tilgÃ¦ngelig';
        ...
        lang_dk['BUSCO']        = 'SÃ¸ger';
        lang_dk['TIPO']         = 'Type';
        lang_dk['DISPONIBLE']   = 'Kun tilgÃ¦ngelig';
        lang_dk['CUALQUIERA']   = 'Alle';
        lang_dk['SI']           = 'Ja';
        lang_dk['NO']           = 'Nej';
        lang_dk['MARCADORES']   = 'BogmÃ¦rker';
        lang_dk['ANYADIR']      = 'TilfÃ¸j';
        lang_dk['ENLACE']       = 'Nyt bogmÃ¦rke URL';
        lang_dk['TEXTO']        = 'Nyt bogmÃ¦rke tekst';
...
*/
	...
	lang_hu['ALIANZA'] 			= 'KlÃ¡n';
	lang_hu['PERFIL'] 			= 'FelhasznÃ¡lÃ³ Profil';
	lang_hu['SIM'] 				= 'Harc SzimulÃ¡tor';
	lang_hu['CALC'] 			= 'Travian KalkulÃ¡tor';
	lang_hu['SEGURO'] 			= 'Biztos vagy benne?';
	lang_hu['MARK'] 			= 'KijelÃ¶li mindet';
	lang_hu['PERDIDAS'] 		= 'vesztesÃ©g';
	lang_hu['RENT'] 			= 'Haszon';
	lang_hu['SUBIR_NIVEL'] 		= '<font color="red"><strong>BÅ‘vÃ­tÃ©s lehetsÃ©ges</strong></font>';
	lang_hu['JUGADOR']	 		= 'JÃ¡tÃ©kos';
	lang_hu['ALDEA'] 			= 'Falu neve';
	lang_hu['HAB'] 				= 'NÃ©pessÃ©g';
	lang_hu['COORD'] 			= 'KoordinÃ¡tÃ¡k';
	lang_hu['ACCION'] 			= 'EsemÃ©nyek';
	lang_hu['ATACAR'] 			= 'TÃ¡madÃ¡s';
	lang_hu['COMERCIAR'] 		= 'Nyersanyag kÃ¼ldÃ©se';
	lang_hu['GUARDADO'] 		= 'Mentve';
	lang_hu['DESP_ABR'] 		= 'MozgÃ¡s:';
	lang_hu['FALTA'] 			= '<font color="black"><strong>SzÃ¼ksÃ©ged van</strong></font>';
	lang_hu['HOY'] 				= '<font color="black"><strong>ma</strong></font>';
	lang_hu['MANYANA'] 			= '<font color="black"><strong>holnap</strong></font>';
	lang_hu['PAS_MANYANA'] 		= '<font color="black"><strong>holnaputÃ¡n</strong></font>';
	lang_hu['MERCADO'] 			= 'Piac';
	lang_hu['CUARTEL'] 			= 'KaszÃ¡rnya';
	lang_hu['PUNTO'] 			= 'GyÃ¼lekezÅ‘tÃ©r';
	lang_hu['CORRAL'] 			= 'IstÃ¡llÃ³';
	lang_hu['TALLER'] 			= 'MÅ±hely';
	lang_hu['ENVIAR'] 			= 'Nyersanyag kÃ¼ldÃ©se';
	lang_hu['COMPRAR'] 			= 'VÃ¡sÃ¡rlÃ¡s';
	lang_hu['VENDER'] 			= 'EladÃ¡s';
	lang_hu['ENVIAR_IGM'] 		= 'Ãœzenet kÃ¼ldÃ©se';
	lang_hu['LISTO'] 			= '<font color="black"><strong>BÅ‘vÃ­tÃ©s lehetsÃ©ges:</strong></font> ';
	lang_hu['EL'] 				= '';
	lang_hu['A_LAS'] 			= '';
	lang_hu['EFICIENCIA'] 		= 'HatÃ©konysÃ¡g'; 
	lang_hu['NUNCA']			= 'Soha';
	lang_hu['PC']          	 	= 'kultÃºra pontok';
	lang_hu['FUNDAR']     	 	= 'AlapÃ­thatsz vagy meghÃ³dÃ­thatsz egy Ãºj falut';
	lang_hu['ALDEAS']      		= 'Falu(k)';
	lang_hu['ENV_TROPAS'] 		= 'EgysÃ©g kÃ¼ldÃ©se';
	lang_hu['RECURSO1']    		= 'Fa';
	lang_hu['RECURSO2']    		= 'Agyag';
	lang_hu['RECURSO3']    		= 'Vas';
	lang_hu['RECURSO4']    		= 'BÃºza';
	lang_hu['TIEMPO']      		= 'IdÅ‘';
	lang_hu['COMP']        		= 'Riport tÃ¶mÃ¶rÃ­tÅ‘';
	lang_hu['STAT']				= 'Statisztika';
	lang_hu['OFREZCO']			= 'AjÃ¡nlÃ¡s';
	lang_hu['BUSCO']			= 'KeresÃ©s';
	lang_hu['TIPO']				= 'ArÃ¡ny';
	lang_hu['DISPONIBLE']		= 'Csak elfogadhatÃ³ak';
	lang_hu['CUALQUIERA']		= 'BÃ¡rmelyik';
	lang_hu['SI']				= 'SzÅ±rt';
	lang_hu['NO']				= 'Mind';
	lang_hu['LOGIN']			= 'BejelentkezÃ©s';
    lang_hu['MARCADORES']		= 'KÃ¶nyvjelzÅ‘k';
    lang_hu['ANYADIR']			= 'HozzÃ¡ad';
    lang_hu['ENLACE']			= 'Ãšj URL';
    lang_hu['TEXTO']			= 'Ãšj szÃ¶veg';
	lang_hu['ELIMINAR']			= 'TÃ¶rlÃ©s';
	lang_hu['MAPA']				= 'TÃ©rkÃ©p';
	lang_hu['CHECK']			= 'Ãšj verziÃ³ keresÃ©se';
	lang_hu['ARCHIVE']			= 'ArchÃ­vum';
	lang_hu['RESUMEN']			= 'Ã–sszesen';
	lang_hu['MAXTIME']			= '<font color="blue"><strong>Maximum idÅ‘</strong></font>';
/*
