scr_meta=<><![CDATA[
// ==UserScript== 
// @name           Neobux 2+ (v3) denfel version
...
// @version        3.0.091208.1157
// @updateNote     3.0 = The first 'real' release of v3, under the WTFPL license v2; 091208.1157 = Another go at fixing the 'refsPerPage is null' error now that I have a copy of the exact error message
...
var scriptLangStrings = {
  ...
  EN : {
    ...
    'avgs': 'avgs',
    'average': 'Average',
    'raverage': '[b]R.Avg[/b]', // 'Real Average'
    'averages': 'Averages',
    'expenses': 'Expenses',
    'Recycle': '[b]Recycle[/b]',
    'autopay': 'Autopay',
  ...
  // customLogger('xpathResult.parentNode = '+xpathResult.parentNode,'x');
    ...
    infoLabel.innerHTML = (""+
      ...
      "<hr width= '155px' height='1px' color='#cccccc'/>"+
        ...
        "</div>"+
        "<div class='sidebarDetails'>"+
          "- "+localString('rentedavg')+" : "+yesterday.rentedAverage +"<br>"+
          "- "+localString('raverage')+" : "+yesterday.totalRAverage +"<br>"+
        "</div>"+
        "<div class='sidebarDetails'>"+
          "- "+localString('Recycle')+" : $"+recycleCost.yesterday.toFixed(2) +"<br>"+
