...
(function() {
    ...
    function attachBranding() {
        ...
        enhanced.innerHTML = '<a href="http://fcexts.fc.tetsunosuke.co.cc/inbound?from=fcplusplus&amp;version=' + version + '"><img src="http://fcexts.fc.tetsunosuke.co.cc/fcplusplus/enhanced.png?version=' + version + '" alt="Enhanced with FC++" style="border: 0" /></a>';
        document.getElementById('rightbar').appendChild(enhanced);
        
        GM_registerMenuCommand("About FC++...", function() {
            GM_openInTab('http://fcexts.fc.tetsunosuke.co.cc/inbound?from=fcplusplus');
        });
        
        /*var navItem = document.createElement('li');
        navItem.className = 'hov';
        navItem.innerHTML = '<a class="dir" href="#">FC++</a>' +
                            '<ul><li><a href="http://fcexts.fc.tetsunosuke.co.cc/inbound?from=fcplusplus">About FC++</a></li>' +
    ...
    function playVideo(filename) {    
        if (playingVideo) {
            ...
            with (player) {
                ...
                setAttribute('data', 'http://fcexts.fc.tetsunosuke.co.cc/fcplusplus/player.swf');
            ...
            var params = {
                movie: 'http://fcexts.fc.tetsunosuke.co.cc/fcplusplus/player.swf',
                FlashVars: 'file=http://fcexts.fc.tetsunosuke.co.cc/' + videoURL + '&id=fcplusplus-video&autostart=true&controlbar=none'
            };
        ...
        if (isLevel != null) {
            ...
            if (isLevel) {
                content.innerHTML = '<img src="/image?type=level&amp;do=thumb&amp;id=' + id + '" width="100" style="float: left; border: 2px solid #ECECF9" />' + 
                    ...
                    '<li style="width: auto">&raquo; <a href="http://fc.tetsunosuke.co.cc/level?levelId=' + id + '">View on FCR</a></li>' +
                    '<li style="width: auto">&raquo; <a href="http://fc.tetsunosuke.co.cc/level?levelId=' + id + '#statistics">View statistics</a></li>' +
                    '<li style="width: auto">&raquo; <a href="http://fc.tetsunosuke.co.cc/designs?levelId=' + id + '">Browse solutions</a></li>' +
                    '<li style="width: auto">&raquo; <a href="http://fc.tetsunosuke.co.cc/export?type=level&amp;id=' + id + '&amp;format=fcml">Export to FCML</a></li>' +
                    '</ul><br style="clear: both" />';
            } else {
                content.innerHTML = '<img src="/image?type=design&amp;do=thumb&amp;id=' + id + '" width="100" style="float: left; border: 2px solid #ECECF9" />' + 
                    '<ul style="margin-left: 110px; padding: 0">' + 
                    '<li style="width: auto">&raquo; <a href="http://fc.tetsunosuke.co.cc/design?designId=' + id + '">View on FCR</a></li>' +
                    '<li style="width: auto">&raquo; <a href="http://fc.tetsunosuke.co.cc/design?designId=' + id + '#statistics">View statistics</a></li>' +
                    '<li style="width: auto">&raquo; <a href="http://fc.tetsunosuke.co.cc/designredirect?designId=' + id + '&amp;want=level">View level on FCR</a></li>' +
                    '<li style="width: auto">&raquo; <a href="http://fc.tetsunosuke.co.cc/designredirect?designId=' + id + '&amp;want=play">Play the level</a></li>' +
                    '<li style="width: auto">&raquo; <a href="http://fc.tetsunosuke.co.cc/designredirect?designId=' + id + '&amp;want=solutions">Find other solutions</a></li>' +
                    '<li style="width: auto">&raquo; <a href="http://fc.tetsunosuke.co.cc/export?type=design&amp;id=' + id + '&amp;format=fcml">Export to FCML</a></li>' +
                    '</ul><br style="clear: both" />';
            }
        ...
        for (var i in links) {
            ...
            if (href) {
                if (href.match(/^user\?userId=/)) {
                    links[i].setAttribute('href', 'http://fc.tetsunosuke.co.cc/' + href);
