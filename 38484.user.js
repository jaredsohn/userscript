// ==UserScript==
// @name          TPB Movie Magnets for IMDB and Rotten Tomatoes
// @version		  0.42
// @author        Sharath
// @namespace     http://www.technowise.in
// @description   Shows magnets from The Pirate Bay for downloading movies within IMDB and Rotten tomatoes movie pages.
...
// ==/UserScript==
    ...
    function startAddingLinks()
    {
		...
		if( addLinksToObj && movieTitle.length > 0 )
		{
			...
			jQ(dropDownResultsDiv).css({ 'padding':'5px', 'background-color':'#fff','width':'400px', 'position':'absolute', 'display':'none', 'overflow':'auto', 'z-index':'12000', 'border':'2px solid'});
			...
			buildLink(torrentLinksSpan, "The Pirate Bay Magnets","http://thepiratebay.se/search/"+movieTitle+"/0/7/200", img);

			//Preload results.
			getBtResults("https://thepiratebay.se/search/"+movieTitle+"/0/7/200", true);
