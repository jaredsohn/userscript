// ==UserScript==
// @name           MyMangaMangaStream
// @namespace      Mangastream version of  my manga
// @description    Helps you remeber the manga your reading
// @include        http://mangastream.to/*
// @include        http://www.mangastream.to/*
//@author          Tubutas
// ==/UserScript=='
var MAIN_BREAK="retr234ehrgeA#";
var SUB_BREAK="retr353hr3g!eA#";
if(document.location.href=="http://www.mangastream.to/MyManga/"){
	document.title="Mangastream - My Manga"
	...
	for(var i=0;i<Mangas.length;i++){
		...
		alt=Math.abs(alt-1);
		text+="<tr class=bg0"+(alt+1)+"><td><a target=blank href='http://www.mangastream.to/"+Manga[0]+"/"+Manga[1]+"/"+Manga[2]+"/'>"+Manga[0]+"</td><td>"+Manga[1]+"</td><td>"+Manga[2]+"</td>";
	...
	adv_search.innerHTML="<a href='http://www.mangastream.to/MyManga/'><b>My Manga</b></a> - "+adv_search.innerHTML;
}else{
	var base="http://www.mangastream.to/";
