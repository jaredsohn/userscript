...
var BetterGSInsert = function($, window, undefined) {
					...
					'<div id="BetterGS-content">' +
						'<div id="BetterGS-interact">' +
							'<div class="BetterGS-row BetterGS-head">' +
								'<a id="BetterGS-startsearch" href="#">Buscar...</a>' +
								'<h3 id="BetterGS-head"><a target="_blank" href="http://userscripts.org/scripts/show/93354">BetterGS Lyrics - ESP</a></h3>' +
							'</div>' +
							'<div class="BetterGS-row">' +
							'<div class="BetterGS-50p" style="float: left;">' +
								'<label for="BetterGS-artist">Artista:</label>' +
								'<input id="BetterGS-artist" value="" />' +
							'</div>' +
							'<div class="BetterGS-50p" style="float: right;">' +
								'<label for="BetterGS-song">Canción:</label>' +
								'<input id="BetterGS-song" value="" />' +
							'</div>' +
							'</div>' +
							'<div class="BetterGS-row">' +
								'<strong id="BetterGS-sites-label">Sitios disponibles...</strong>' +
							'</div>' +
							'<div class="BetterGS-row">' +
								'<strong id="BetterGS-results-label">Sin resultados.</strong>' +
							'</div>' +
						'</div>' +
						'<div id="BetterGS-lyrics">' +
							'No hemos encontrados lyrics para esta canción..' +
						'</div>' +
					'</div>' +
				'</div>';
			...
			BetterGS.lyrics.fillInputs = function() {
				$('#BetterGS-song').val( Grooveshark.getCurrentSongStatus().song.songName );
				$('#BetterGS-artist').val( Grooveshark.getCurrentSongStatus().song.artistName );
			};
