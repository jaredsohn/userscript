/*
	FriendFeed http://ping.fm Tab 0.01
	Tweaked by http://friendfeed.com/baldie
	Original by Duncan Riley/ http://www.inquisitr.com
	Code modified from http://ffapps.com/tabs/
*/

// ==UserScript==
// @name           FriendFeed ping.fm
// @namespace      baldie/ http://ping.fm
// @description    Add ping.fm in a tab on FriendFeed 
...
//	});
  ...
  function pingfm_setup() {
		$('.settings').find('.l_tab:last').after('<td class="l_tab" style="padding-left: 10px;" id="tdtabtm"><div class="rounded bb" id="tabtm"><div class="t"><div class="l"><div class="r"><div class="tl"><div class="tr"><div class="body"><a id="tab-link-pingfm" href="#"><img src="http://ping.fm/favicon.ico"></a></div></div></div></div></div></div></div></td>');
                $('#tab-link-pingfm').click(function() {
		$('#subtabs').hide();
		$('#body').css("height","100%").html('<div class=iframe style="width:320px;height:100%;"><iframe id="content_iframe" marginWidth=0 marginHeight=0 src="http://i.ping.fm/" frameBorder=0 style="width:100%;height:100%;overflow:auto;"></iframe></div>');
