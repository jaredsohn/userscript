// ==UserScript==
// @name Ikariam Casustan Korunma Seviyesi Programı
// @version 4.6.0
// @author Samed Tarik Cetin
// @namespace SpyDefHelper-Türkçe
// @description Casusların şehrinizde görev başarabilme yüzdelerini gösteren, tarafımca türkçeleştirilmiş bir eklenti.
// @include http://s*.ikariam.*/index.php*
// @history 4.6.0 Türkçeleştirildi.
// @history 4.5.1 fix for skript detection (GF has dynamic skripts in send spy screen)
// @history 4.4.2 fix for detection risk below 5%
// @history 4.4.1 enhanced for malus/bonus by selected government
// @history 3.3.4 island layout had to be adapted, again
// @history 3.3.3 lint fixes / cursor above buttons
// @history 3.3.2 CR/LN code fixed
// @history 3.3.2 send spy screen: show target city name
// @history 3.3.2 send spy screen: non-send missions can not be clicked
// @history 3.3.2 send spy screen: uses send icons
// @history 3.3.1 fixed: updater
// @history 3.3.0 fix: calculation precision - looks good now :P
// @history 3.3.0 fix: adapted to silent update of island layout
// @history 3.2.2 fix: calculation for inactive player
// @history 3.2.2 fix: spy mission from occupied city
// @history 3.2.1 send spy view fix
// @history 3.2.0 layout-fix to work with thin views (http://userscripts.org/scripts/show/46868)
// @history 3.2.0 removed all language stuff 
// @history 3.1.0 math-fix
// @history 3.0.0 own defence preview
// @history 2.9.0 changes for ika update, klickable agents
// @history 2.8.0 redesign for ika 0.4.2
// @history 2.7.0 show info-box in city-view only if your action is needed
// @history 2.6.0 updater can handle downtimes of userscripts.org
// @history 2.5.0 notify events
// @history 2.4.0 update number of defending spyies on "send spy"
// @history 2.2.0 displays "<=" or ">=" instead of "="
// @history 2.1.0 fixed updatelink
...
function spyAVappendSpyInfoTo(elementId, cityId) {
	...
	addOptionToSelected('Â±0', input, targetGovFactor==0);
	addOptionToSelected('-20%', input, targetGovFactor==-20);
