// ==UserScript==
// @name OpenGG.Clean.Player(oschina)
// @author Anonymous
// @description 修改前任作者的些许代码，希望可以帮助大家
// @version 1.0
...
(function() {
    ...
    YoukuAntiAds.prototype = {
        ...
        get players() {
            if(!this._players) {
                this._players = {
                    'youku': 'http://git.oschina.net/kawaiiushio/antiad/raw/master/loader.swf',
                    'ku6': 'http://git.oschina.net/kawaiiushio/antiad/raw/master/ku6.swf',
                    'iqiyi': 'http://git.oschina.net/kawaiiushio/antiad/raw/master/iqiyi.swf',
                    'iqiyi5': 'http://git.oschina.net/kawaiiushio/antiad/raw/master/iqiyi5.swf',
                    'tudou': 'http://git.oschina.net/kawaiiushio/antiad/raw/master/tudou.swf',
                    'tudou_olc': 'http://git.oschina.net/kawaiiushio/antiad/raw/master/olc_8.swf',
                    'tudou_sp': 'http://git.oschina.net/kawaiiushio/antiad/raw/master/sp.swf',
                    'letv': 'http://git.oschina.net/kawaiiushio/antiad/raw/master/letv.swf'
                };
            }
