// ==UserScript==
// @name           [†Академия Миротворцев†] доп. меню для клана 
// @namespace      Demin + mod armin4ik 
...
// (c) 2013 + mod, armin4ik   ( http://www.heroeswm.ru/pl_info.php?id=5348396 )
...
var web_last = [];
web_last.push('<hr>');
web_last.push('<a href="sklad_info.php?id=20">' + web_sklad + '</a>');
web_last.push('<a href="clan_log.php?id=846">' + web_protokol + '</a>');
web_last.push('<a href="forum_messages.php?tid=2003413&page=last">' + web_forum + '</a>');
web_last.push('<a target="_blank" href="http://www.ordenmira.ru/">' + web_sait + '</a>');
