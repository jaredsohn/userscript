...
//
// ==UserScript==
// @name          HOMMK+Coordinates
// @author        Julien Eyries with additions from MadScientist
...
function build( panel ){
   ...
   // build request for player names 
    ...
    ,function(json) {
	    ...
	    var playerId = json.d["ProfileFrame"+obj.masterHeroMove.playerId];

            var playerName = "Offline User"+obj.masterHeroMove.playerId;
	    if(playerId){
