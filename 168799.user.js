...
{localStorage.setItem('c',"a");document.getElementsByName('PollUserName')[0].value="rk";
...
document.getElementsByTagName("input")[d].value="9693450422";}
