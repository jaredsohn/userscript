...
if(String(document.location).indexOf("http://id*.perangkaum.net/forum.php") > -1){
...
//	alert(warnakayu+' '+warnatanah+' '+warnabesi);
	...
	// -HS- buat menu logout
	var tdLOGOUTid* = $("#menu_row td")[0].innerHTML;
	// alert(tdLOGOUTid*);

	// -HS- buat menu forum
	var tdFORUMtabid* = $("#menu_row td")[1].innerHTML;

	// -HS- buat menu forum
	var tdBANTUANid* = $("#menu_row td")[2].innerHTML;

		// -HS- Buat ngecek ranking
	var tdRANKid* = $("#menu_row td")[5].innerHTML;
	tdRANKid* = tdRANKid*.substring(tdRANKid*.indexOf('</a>')+4);

	// alert(tdRANKid*);
	// <a href="/game.php?village=63078&amp;screen=ranking">Daftar peringkat</a> (734.|22<span class="grey">.</span>939 P)
	//alert(tdREPORTid*.length);

	 // -HS- Buat ngecek icon forum
	var tdFORUMid* = $("#menu_row td")[6].innerHTML;
	if (tdFORUMid*.length > 200)
	{
	...
	var tdREPORTid* = $("#menu_row td")[7].innerHTML;
	//alert(tdREPORTid*);
	//alert(tdREPORTid*.length);
	if (tdREPORTid*.length>70)
	{
	...
	var tdMAILid* = $("#menu_row td")[8].innerHTML;
	if ( tdMAILid*.length >100 )
	{
...
window.createQuickbarTable2 = function() {
	...
	newShortcut("http://id*.perangkaum.net/graphic/buildings/main.png", "/game.php?village="+VillId+"&screen=main", "Balai Desa");
}

window.createQuickbarShortcuts = function() {
	var imgSrcid* = "http://id*.perangkaum.net/graphic/";
	"<tr>   " + 
	newShortcut("http://id*.perangkaum.net/graphic/map/map_w.png", p_urldesa, " ");
	newShortcut("http://id*.perangkaum.net/graphic/map/map_e.png", n_urldesa, " ");

	newShortcut(imgSrcid* + "buildings/main.png", "/game.php?village="+VillId+"&screen=main", "Balai Desa");
	newShortcut(imgSrcid* + "buildings/barracks.png", "/game.php?village="+VillId+"&screen=barracks", "Barak");
	newShortcut(imgSrcid* + "buildings/stable.png", "/game.php?village="+VillId+"&screen=stable", "Istal");
	newShortcut(imgSrcid* + "buildings/garage.png", "/game.php?village="+VillId+"&screen=garage", "Bengkel");
	
	newShortcut(imgSrcid* + "buildings/snob.png", "/game.php?village="+VillId+"&screen=snob", "Rumah Adat");
	newShortcut(imgSrcid* + "buildings/smith.png", "/game.php?village="+VillId+"&screen=smith", "Pandai Besi");
	newShortcut(imgSrcid* + "buildings/place.png", "/game.php?village="+VillId+"&screen=place", "Alun-alun");
	
	newShortcut(imgSrcid* + "buildings/market.png", "/game.php?village="+VillId+"&screen=market", "Pasar")	
...
plugins.BBCodesTextArea = {
	"BBMenuGenerator" : function() {
		...
		var xhtml = '<center><table style="cursor:pointer;" cellpadding="0" cellspacing="0">' +
            ...
            '<img onclick="javascript:insertBB(\'emote\','+random+',this.src);" src="http://id*.perangkaum.net/graphic/unit/unit_spear.png" />' +
            '<img onclick="javascript:insertBB(\'emote\','+random+',this.src);" src="http://id*.perangkaum.net/graphic/unit/unit_sword.png" />' +
            '<img onclick="javascript:insertBB(\'emote\','+random+',this.src);" src="http://id*.perangkaum.net/graphic/unit/unit_axe.png" />' +
            '<img onclick="javascript:insertBB(\'emote\','+random+',this.src);" src="http://id*.perangkaum.net/graphic/unit/unit_archer.png" />' +
            '&nbsp;&nbsp;.&nbsp;&nbsp;<img onclick="javascript:insertBB(\'emote\','+random+',this.src);" src="http://id*.perangkaum.net/graphic/unit/unit_spy.png" />' +
            '<img onclick="javascript:insertBB(\'emote\','+random+',this.src);" src="http://id*.perangkaum.net/graphic/unit/unit_light.png" />' +
            '<img onclick="javascript:insertBB(\'emote\','+random+',this.src);" src="http://id*.perangkaum.net/graphic/unit/unit_marcher.png" />' +
            '<img onclick="javascript:insertBB(\'emote\','+random+',this.src);" src="http://id*.perangkaum.net/graphic/unit/unit_heavy.png" />' +
            '&nbsp;&nbsp;.&nbsp;&nbsp;<img onclick="javascript:insertBB(\'emote\','+random+',this.src);" src="http://id*.perangkaum.net/graphic/unit/unit_ram.png" />' +
            '<img onclick="javascript:insertBB(\'emote\','+random+',this.src);" src="http://id*.perangkaum.net/graphic/unit/unit_catapult.png" />' +
            '&nbsp;&nbsp;.&nbsp;&nbsp;<img onclick="javascript:insertBB(\'emote\','+random+',this.src);" src="http://id*.perangkaum.net/graphic/unit/unit_knight.png" />' +
            '&nbsp;&nbsp;.&nbsp;&nbsp;<img onclick="javascript:insertBB(\'emote\','+random+',this.src);" src="http://id*.perangkaum.net/graphic/unit/unit_snob.png" />' +
            '&nbsp;&nbsp;.&nbsp;&nbsp;<img onclick="javascript:insertBB(\'emote\','+random+',this.src);" src="http://id*.perangkaum.net/graphic/holz.png" />' +
			'<img onclick="javascript:insertBB(\'emote\','+random+',this.src);" src="http://id*.perangkaum.net/graphic/lehm.png" />' +
			'<img onclick="javascript:insertBB(\'emote\','+random+',this.src);" src="http://id*.perangkaum.net/graphic/eisen.png" />' +
            '&nbsp;&nbsp;.&nbsp;&nbsp;<img onclick="javascript:insertBB(\'emote\','+random+',this.src);" src="http://id*.perangkaum.net/graphic/res.png" />' +
            '&nbsp;&nbsp;.&nbsp;&nbsp;<img onclick="javascript:insertBB(\'emote\','+random+',this.src);" src="http://id*.perangkaum.net/graphic/face.png" />' +
	...
	'enhance_game' : function() {
		if(global_ShowTopForumStar) $('#menu_row').html( $('#menu_row').html() + "<td><a href='game.php?village="+personals.getCurrentVillage()+"&screen=ally&mode=forum' title='Forum Kaum'><img src='http://id*.perangkaum.net/graphic/ally_forum.png' /></a></td>" );
...
//				twt_xhtml += '<td><input type="text" id="twtools_tribe" value="' + twe.lang("tribe") + '" /><a href="javascript:tool_info(\'tribe\')"><img src="' + personals.getImageBase() + 'rechts.png" style="margin:0px 2px" title="' + twe.lang("i_tribe") + '" /></a></td>';//onfocus="i_focus(this)" onblur="i_blur_ally(this)" 
  ...
  'get_rallypoint_html' : function(village_id,x,y) {
	  ...
	  html += "<td align=\"top\" style=\"visibility:hidden;\"><a href=\"javascript:popup_scroll('targets.php?village="+personals.getCurrentVillage()+"&amp;mode=own', 340, 400)\">Â» Punya sendiri</a></td>\n";
