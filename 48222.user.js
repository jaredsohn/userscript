// ==UserScript==
// @name           Profil uzytkownika by_NewMan V1.0.1 Tlumaczenie dla menelgame by PaWmArCc
// @namespace      http://forum.ego-shooters.net
// @description    W profilu danego uzytkownika sa wyswietalne informacje ile dany uzytkownik posiada zlota i ile ma promili.
...
function user(dom){
	...
	tr[8].innerHTML = '<td><strong>&nbsp;Pieniądze</strong></td><td>'+ cash_show +'</td><td><strong>&nbsp;Promile</strong></td><td>'+ promille +'</td>';
