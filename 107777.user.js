...
switch (location.host) {
	default:
		...
		//chaturl='.';
		chaturl='.';
		forumurl='http://leclandesdragons.xoo.it/';
		//forumurl='';
		forumurlnew='.';
    ...
    if (showbubble%2) { //If Even
       ...
       addsbubble('diplomat',"Ben c'est nous, les LCn !", 72);
       ...
       addsbubble('general',"Attention !!", 110);
       addsbubble('general', "Je vais grogner !", 118);
       addsbubble('mayor', "C'est moi le chef ici !", 121);
    }
