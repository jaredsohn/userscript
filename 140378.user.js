            ...
            qx.Class.define("TASuite.main", {
                ...
                members: {
                    ...
                    initialize: function() {
                        ...
                        this.buttonSimulateCombat = new qx.ui.form.Button("Simular");
                        ...
                        this.buttonCheck.set({
                            width:80,
                            appearance:"button-text-small",
                            toolTipText:"Procurar arranjo de tropas"
                        });
                        this.buttonCheck.addListener("click", this.toggleCheck, this);

                        this.normalBoxus = new qx.ui.basic.Label("Calculador de tropas: ");
                        this.normalBoxus.setTextColor("yellow");
                    ...
                    pulseCheckUnit:function () {
                            ...
                            else
                            {
                                ...
                                else
                                {
                                    if (Math.floor(this.nOldCYPercent) < 2)
                                        this.normalBoxus.setTextColor("white");
                                    else
                                        this.normalBoxus.setTextColor("yellow");

                                    this.normalBoxus.setValue("Calculador de tropas: Pronto! Estaleiro " + this.roundNumber(this.nOldCYPercent, 2) + "%, Defense Facility " + this.roundNumber(this.lastDFPercentage, 2) + "%, Defesa " + this.roundNumber(this.nOldEUPercent, 2) + "%, Reparação " + this.formatSecondsAsTime(this.nOldRepairTime, "h:mm:ss"));
                                    this.busy = false;
                                    this.saveFormation();
                        ...
                        this.normalBoxus.setValue("Calculador de tropas: [" + (this.nCurIndex + 1).toString() + "/" + this.units.length.toString() + "] X " + this.nCurX.toString() + " Y " + this.nCurY.toString() + " Estaleiro " + this.roundNumber(this.nOldCYPercent, 2) + "%, Defense Facility " + this.roundNumber(this.lastDFPercentage, 2) + "%, Defesa " + this.roundNumber(this.nOldEUPercent, 2) + "%, Reparação " + this.formatSecondsAsTime(this.nOldRepairTime, "h:mm:ss"));
                        var oldUnit = null;
