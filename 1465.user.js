...
(function() {
  ...
  function addLinks() {
    ...
    if(document.location.href.match(/\/patterns\//)) {
      ...
      insertSection('getcomputedstyle.html', "4.14. Getting an element's style");
      insertSection('set-style.html', "4.15. Setting an element's style");
