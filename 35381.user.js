// ==UserScript==
// @name           Buggy Auto-Farmscript
// @author         Me
// @description    Travian Auto-farmscript, based on Zezuma - FDisk
// @include        http://*.travian*.*/*
// @exclude        http://forum.travian.*
// @email          autofarm@grosnichons.ch
// @version        0.1STD0
// ==/UserScript==

// Amount of soldier to send
var amountSoldier0 = 17; // Phalange
var amountSoldier1 = 0; // Combatant à l'épé
var amountSoldier2 = 0; // Eclaireur
var amountSoldier3 = 5; // Eclaire de toutatis
var amountSoldier4 = 0; // Cavalier druide
var amountSoldier5 = 0; // Hédouin
var amountSoldier6 = 0; // Bélier
var amountSoldier7 = 0; // Catapulte de guerre
var amountSoldier8 = 0; // Chef
var amountSoldier9 = 0; // Colon
...
function sendtroops() {
	...
	if(pagina.indexOf("There isn't a Village on these coordinates.") > -1)
	{
...
function voegToe() {
  ...
  var dorpnaam = code.substring(code.indexOf("<div class=\"ddb\"")+17,code.indexOf("</div>"));					

//alert("Coord "+x+" ; "+y+" Dorpnaam: "+dorpnaam);
	
	addList(x+","+y+"|"+amountSoldier0+","+amountSoldier1+","+amountSoldier2+","+amountSoldier3+","+amountSoldier4+","+amountSoldier5+","+amountSoldier6+","+amountSoldier7+","+amountSoldier8+","+amountSoldier9+"|"+dorpnaam);
...
function geefOverzicht() {
	...
	ntd1.innerHTML = "<span class='c0'><a href='http://userscripts.org/scripts/source/34367.user.js'>Update AutoFarm script</a></span>";
