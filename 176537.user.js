...
// @description    Block unwanted sites from your Google search results. v1.0 2013-08-25
...
// @require        http://www.jeffersonscher.com/gm/AnotherAutoUpdater.php?id=95205&days=1&var=GHHbD&show&v158
// @grant          GM_addStyle
// @grant          GM_getValue
// @grant          GM_setValue
...
function addManageForm(){
  ...
  mfd.innerHTML = "<form onsubmit=\"return false;\"><div id=\"ghhtsdiv\">" +
    ...
    "<p style=\"border-top:1px solid #000; padding:0.25em;margin:0.25em\">v1.5.8 &copy; 2013 Jefferson Scher. Learn more on " +
