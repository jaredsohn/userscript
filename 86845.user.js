// ==UserScript==
// @name           Mendigogame, Clodogame Paris et Marseille, Bumrise NY: Status des dons et de la tache journaliere
...
GM_xmlhttpRequest({
  	method: 'GET',
   	url: 'http://faveladogame.com.br/overview/',
...
var TASK_name = 'TÃ¢che du jour';
GM_xmlhttpRequest({
  	method: 'GET',
   	url: 'http://www.clodogame.fr/overview/',
        onload: function(responseDetails) {
        	var content = responseDetails.responseText;
			var text1 = content.split('as rÃ©ussi Ã  rÃ©colter')[1];
