          ...
          onKey : function (ev) {
            ...
            if (inputField != null) {
              ...
              if (ev.altKey && !ev.altGraphKey && !ev.ctrlKey && !ev.shiftKey && s == "Y") {
                ...
                inputField.value += "Basen in der Allianz: " + baseCount + ", davon mit Support: " + supBaseCount + " (" + (supBaseCount / baseCount * 100).toFixed(0) + "%), durchschnittliche Stufe: " + avg.toFixed(2) + ", davon 30+: " + high + " (" + (high / baseCount * 100).toFixed(0) + "%)";
                //for (var i in info)
