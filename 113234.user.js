// ==UserScript==
// @name                 تعريب : MaSTeR-OF-PuPPeTS عرض نقاط الهجوم و الدفاع
// @version              1.6
// @author               كابي فرح MaSTeR-OF-PuPPeTS
// @namespace            c1b1.de
// @homepage             http://c1b1.de
// @copyright            2008 - 2011, Samuel Essig (http://c1b1.de)
// @license              No Distribution!
// @description          يقوم هذا السكريبت بعرض نقاط الهجوم أو الدفاع التي اكتسبتها
...
if(defender_table)
  ...
  td0.appendChild(document.createTextNode('نقاط الدفاع: '+stringInt(defender_points)));
  tr0.appendChild(td0);
...
if($('#attack_info_def').$('th')[1].firstChild.nodeValue != '---') // If village not empty
  ...
  td1.appendChild(document.createTextNode('نقاط الهجوم: '+stringInt(attackers_points)));
  tr1.appendChild(td1);
