// ==UserScript==
// @name			Ask.fm Auto Like by 8DrackADM
// @namespace                   
// @version			3.0
// @copyright		        
...
if(body != null) {
	...
	div.innerHTML = "<div style='background-color: #00a2ff; color: #FFFFFF; border: 0px solid #00a2ff;'><center><a style='color: #000000;' <a href='' target='_blank' title='A'>  </a></div>"
	...
	div2.style.border = "0px solid #555";
	div2.style.padding = "0px";
	div2.innerHTML = "<div style='background-color: #00a2ff; color: #FFFFFF; border: 0px solid #00a2ff;'><a style='color: #FFFFFF;' onclick='spoiler()' title=''>&laquo;</a> &#8226; <a href='' title='' style='color: #FFFFFF;' onclick='alert(\'Thanks for install this script\');'></a></div> "
	...
	for(i=1;i<=20;i++) {
		...
		div2.innerHTML = "<a onclick='spoiler()' title=''>&laquo;</a> &#8226; <a href='' title=''></a>"
		}
		else {
