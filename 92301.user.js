// ==UserScript==
// @name           Facebook - Auto Accept KoC Gifts 87
// @version        0.1
// @namespace      KOCQuickWidgets-AutoAcceptGifts
// @homepage       http://userscripts.org/
// @description    Este script acepta automaticamente todo los regalos en el servidor Annwynn87
				...
				if(claim_gift){
					...
					if(domain_selector && (next_button1 || next_button2)){
						for(var i=0; i<domain_selector.options.length; i++){
							if(domain_selector.options[i].value == "87"){
