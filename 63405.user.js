// ==UserScript==
// @name Angrifswarner version 3 mit allen scheis  pennergame 4.0  hamburg berlin 
// @namespace http://pennerhack.foren-city.de by basti1012-pennerhack
// @description test angriff mit online und geld weg warner f?r pennergame 4,0
...
+'<p><b>Name: </b><a href="/profil/id:'+id2+'/"><font style=\"color:blue; font-size:100%;\"><b>'+name+'</b></font></a>'
+'<br><b>Bande :</b> <a href="/profil/bande:'+id21+'/"><font style=\"color:blue; font-size:100%;\"><b>'+name1+'</b></font></a>'
+'<br><b> Geld : </b><font style=\"color:black; font-size:100%;\"><b> '+cash3+'  &euro;  </b> </font>'+online+''
+'<br><b>Ende Kampf:</b><font style=\"color:red; font-size:100%;\"><b><b>'+TimeOfImpact+'</b></font></p></div></div>';
...
if(on == 1){
var wasistlos = ' Deiner gegner ist online';
}else 
if(on == 2){
		...
		if(content.match(/bereits auf/)){
			try{
				...
				var idaus = idausgang.split('<a href="/profil/id:')[1].split("/")[0];
					...
					var penner = 'Pennername : <a href="/profil/id:'+id2+'/"><font style=\"color:blue; font-size:100%;\"><b>'+name+'</b></font></a>'
					var bande = 'Bandenname : <a href="/profil/bande:'+id21+'/"><font style=\"color:blue; font-size:100%;\"><b>'+name1+'</b></font></a>'
					var cash6 = cash/100;
					var tbody = document.getElementsByClassName('zabsolute zleft')[0];
