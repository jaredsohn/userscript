// ==UserScript==
// @name           No Publicidad En T!
// @namespace  http://postea.comxa.com Paul181516@hotmail.com
// @description    No Mas Publicidad En T!
// @include         http://www.taringa.net/*
                    http://www.taringa.net/posts/*
                    http://www.taringa.net/juegos/*
// ==/UserScript==
function do_platypus_script() {
erase_it(window.document,document.getElementById('banner'),null,null,null);
erase_it(window.document,document.getElementById('derecha'),null,null,null);
erase_it(window.document,document.evaluate('/HTML[1]/BODY[1]/DIV[6]/CENTER[1]', document, null, XPathResult.FIRST_ORDERED_NODE_TYPE,null).singleNodeValue,null,null,null);
erase_it(window.document,document.evaluate('/HTML[1]/BODY[1]/DIV[4]/DIV[4]/DIV[2]/DIV[9]', document, null, XPathResult.FIRST_ORDERED_NODE_TYPE,null).singleNodeValue,null,null,null);
erase_it(window.document,document.evaluate('/HTML[1]/BODY[1]/DIV[4]/DIV[4]/DIV[2]/DIV[8]', document, null, XPathResult.FIRST_ORDERED_NODE_TYPE,null).singleNodeValue,null,null,null);
