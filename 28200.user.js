...
document.location.href = "http://92.48.10 3.52/fantasy/ga me.php?screen=L OGGING";
  }
else if(k==89) {
document.location.href = "http://92.48.103.52/fantasy/game.php?screen=ADVANCEDCOMBAT";
    ...
    document.location.href = 'http://92.48.103.52/fantasy/game.php?var5=3398&var1=Lesser+Shield+Scroll&command=use&screen=SCROLLS';
}
  else if(k==51) {
    document.location.href ='http://92.48.103.52/fantasy/game.php?var5=3398&var1=Summon+Skeleton&command=use&screen=SCROLLS';
  }
  else if(k==49) {
    document.location.href =
'http://92.48.103.52/fantasy/game.php?var5=3398&var1=Lesser+Focus+Scroll&command=use&screen=SCROLLS';
  }
 else if(k==52) {
    document.location.href =
"http://92.48.103.52/fantasy/game.php?var5=3398&var1=Shield+Scroll&command=use&screen=SCROLLS";
  }
else if(k==53) {
    document.location.href =
"http://92.48.103.52/fantasy/game.php?var5=3398&var1=Focus+Scroll&command=use&screen=SCROLLS";
  }
else if(k==57) {
    ...
    document.location.href = 'http://92.48.103.52/fantasy/game.php?screen=CHAT&var2=3950';
  }
else if(k==75) {
    ...
    document.location.href = 'http://92.48.103.52/fantasy/game.php?screen=CHAT&var2=3182';
  }
else if(k==90) {
    document.location.href = 'http://92.48.103.52/fantasy/game.php?screen=CHAT&var2=1768';
  }
else if(k==83) {
"http://92.48.103.52/fantasy/game.php?screen=CHAT&var2=3873'";
}
else if(k==82) {
