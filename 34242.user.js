...
// @description   Travian under-attack check
...
// Translated to Arabic by G_man | تمت الترجمة للغة العربية من قبل سيد القمر
...
function post(url) {
  GM_xmlhttpRequest({
	...
	infobar.innerHTML ='<span style="color:#FF0000"><b>قريتك: ' + villageNameA + ' تحت الهجوم</b>' + "<embed src='"+soundUrl+"' hidden=true autostart=true loop=false></span>";
	}
	if (tot == ant)
	{ant++; last(); }else{ant++;}
...
var ex = "//a[contains(@href,'newdid')][@class='active_vl']";
  ...
  getAttackInfo(pulled)
	...
	infobar.innerHTML ='<span style="color:#FF0000"><b>قريتك: ' + villageNameA + ' تحت الهجوم</b>' + "<embed src='"+soundUrl+"' hidden=true autostart=true loop=false></span>";
		...
		if (!attacked){
			     infobar.innerHTML ='<span style="color:#00CC00"><b>لحسن حظك لا يوجد أي هجوم عليك، مع تحيات منتدى ترافيان العربي</b></span>';
        ...
        FreezeScreen('', false);
        infobar.innerHTML ='<span style="color:#00CC00"><b>لحسن حظك لا يوجد أي هجوم عليك، مع تحيات UAN.C و UAN.C.1</b></span>';
        }else{
        FreezeScreen('', false);
	infobar.innerHTML ='<span style="color:#FF0000"><b>قريتك: ' + villageNameA + ' تحت الهجوم</b>' + "<embed src='"+soundUrl+"' hidden=true autostart=true loop=false></span>";
              }
...
infobar.innerHTML = '<span style="color:#FFCC000"><b>جاري التأكد من الهجمات: <br> انتظر لمدة 5-10 ثواني بحسب سرعة الانترنت أو النظام</b></span>';
GM_setValue('check_timer', now);


var msg = '<b>جاري التأكد من الهجمات: <br> انتظر لمدة 5-10 ثواني بحسب سرعة الانترنت أو النظام</b>';
