...
//
// ==UserScript==
// @name           balkje voor tribalwars.nl w2,3,4,6,7,8,9
// @namespace      www.tribalwars.net @description    De vertaalde versie van de Engelse. Zal enkel werken op wereld 11 op tribalwars.nl
// @include        http://nl2*.tribalwars.nl/*
// @include        http://nl3*.tribalwars.nl/*
// @include         http://nl4*.tribalwars.nl/*
// @include         http://nl6*.tribalwars.nl/*
// @include         http://nl7*.tribalwars.nl/*
// @include         http://nl8*.tribalwars.nl/*
// @include         http://nl9*.tribalwars.nl/*
// @version        2.0
// ==/UserScript==
...
newShortcut("http://ro5.triburile.ro/graphic/buildings/market.png", "/game.php?village="+VillId+"&screen=market", "Markt")	
	newShortcut("http://ro5.triburile.ro/graphic/buildings/statue.png", "/game.php?village="+VillId+"&screen=statue", "Standbeeld");
	newShortcut("http://ro5.triburile.ro/graphic/ally_rights/found.png", "/game.php?village="+VillId+"&screen=map", "Kaart");
tableIdIndex++;
	trIdIndex++;
}
