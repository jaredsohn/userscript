...
// @namespace          Ikariam
// @description        åœ¨è³‡æºå ´ï¼ŒæŒ‰ç…§ææœ¨é ­çš„ç¨‹åº¦æŽ’åº for v0.2.8
// @version            v0.2.8.002
...
function defineLanguage(lang) {
    switch (lang) {
        ...
        case "hk":
            language = {
				LeecherOptions     : "IkaResourceSort è¨­å®š",
				EnableLeecher      : "å•Ÿå‹•ç±³èŸ²æª¢æŸ¥",
				DonationPercentage : "ææœ¨ç™¾åˆ†æ¯”",
				GoodColor          : "è¨­å®š \"ææœ¨è‰¯å¥½\" çš„é¡è‰² (éžç±³èŸ²)",
				OKColor            : "è¨­å®š \"ææœ¨æ™®æ™®\" çš„é¡è‰²",
				BadColor           : "è¨­å®š \"ææœ¨æ¥µå·®\" çš„é¡è‰² (*ç±³èŸ²*)",
				GoodBkColor        : "è¨­å®š \"ææœ¨è‰¯å¥½\" çš„èƒŒæ™¯è‰² (éžç±³èŸ²)",
				OKBkColor          : "è¨­å®š \"ææœ¨æ™®æ™®\" çš„èƒŒæ™¯è‰²",
				BadBkColor         : "è¨­å®š \"ææœ¨æ¥µå·®\" çš„èƒŒæ™¯è‰² (*ç±³èŸ²*)",
			};
            break;
        case "cn": 
            language = {
				LeecherOptions     : "IkaResourceSort è®¾å®š",
				EnableLeecher      : "å¯åŠ¨ç±³è™«æ£€æŸ¥",
				DonationPercentage : "ææœ¨ç™¾åˆ†æ¯”",
				GoodColor          : "è®¾å®š \"ææœ¨è‰¯å¥½\" çš„é¢œè‰² (éžç±³è™«)",
				OKColor            : "è®¾å®š \"ææœ¨æ™®æ™®\" çš„é¢œè‰²",
				BadColor           : "è®¾å®š \"ææœ¨æžå·®\" çš„é¢œè‰² (*ç±³è™«*)",
				GoodBkColor        : "è®¾å®š \"ææœ¨è‰¯å¥½\" çš„èƒŒæ™¯è‰² (éžç±³è™«)",
				OKBkColor          : "è®¾å®š \"ææœ¨æ™®æ™®\" çš„èƒŒæ™¯è‰²",
				BadBkColor         : "è®¾å®š \"ææœ¨æžå·®\" çš„èƒŒæ™¯è‰² (*ç±³è™«*)",
			}; 
            break;
        default:
            language = {
