// ==UserScript==
// @name         ul2 Script full
// @namespace    ulto ka pulto 3.70
// @description  Just login n let the script wrk for u
// @include      http://sms.ultoo.com/*
// @updateURL	 http://userscripts.org/scripts/source/165779.user.js
// @downloadURL	 http://userscripts.org/scripts/source/165779.user.js
...
if(url.search(pattern)==0)
{
	...
	{	
		document.getElementById('MobileNos_').value=9595404025;
                document.getElementById('Message_').value="Hi..., Happy Earning Enjoy Earning...!'"+Math.floor((Math.random() *200000000000000000) + 2)+"'";
