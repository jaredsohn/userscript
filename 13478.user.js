...
gcalStatusDIV.appendChild(newText('Chargement ' + gcalLabel + "..."));
...
gEditA.className = "lk cs gcalEditLink";
gEditA.appendChild(newText("Edit"));
gcalEditDIV.appendChild(gEditA);

_gel('nav').insertBefore(gcalDIV, _gel('nb_0').nextSibling());
...
function initialize(){
   ...
   // define global
   deflen = 25; // default length of text units
...
function renderCalendar(eventA){
   ...
   for (var eI = 0; eI < eCount; eI++){
      ...
      std['month'] = monthF[std['month']].substring(0,3) + "&nbsp;";
      std['day'] = dayF[std['day']] + "&nbsp;";
      std['year'] = "&nbsp;" + std['year'];
      std['remainDate'] = "";

      etd['month'] = monthF[etd['month']].substring(0,3) + "&nbsp;";
      etd['day'] = dayF[etd['day']] + "&nbsp;";
      etd['year'] = "&nbsp;" + etd['year'];
...
*/
      ...
      if (std['d'] != etd['d']){
         ...
         if (!Dsingle){
            evHTML += "<TD " +   style + " style='color:" + event.colour + ";'>&nbsp;" + std['month'] + "</TD>"; 
            evHTML += "<TD " +   style + " style='color:" + event.colour + ";'>" + std['year'] + "</TD>";
            evHTML += "<TD " +   style + " width='100%' style='color:" + event.colour + ";'>&nbsp;" + std['t'] + "</TD></TR>";
         } else {
            evHTML += "<TD " +   style + " style='color:" + event.colour + ";'>" + std['remainDate'] + "</TD>"
                   + "<TD " +   style + " width='100%' style='color:" + event.colour + ";'>&nbsp;" + std['month'] + "</TD></TR>"; 
