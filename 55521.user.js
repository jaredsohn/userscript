...
function getTeams(address, page) {
	...
	var s = document.getElementById("storage:"+address);
	var l = getElementsByClassName("large_title_bar teamhead", s);
	...
	headDiv.innerHTML = "AI Package Transfer<br>";
