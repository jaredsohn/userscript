...
// @require        http://www.sharkale.com.ar/bbcoder/script/jquery.js?v=28.4
// @require        http://www.sharkale.com.ar/bbcoder/script/plugins.js?v=28.4
// @version        29.0
...
var HideComment = GM_getValue("HideComment",false);
	...
	GM_registerMenuCommand("BBCoder para T! y P! - VersiÃ³n Instalada: " + ultversion, function() {
		unsafeWindow.mydialog.alert("BBCoder para T! y P! - SharkaleÂ®","Tu versiÃ³n del script instalada actualmente es: " + ultversion);
	},null,null,"V");
...
eval(function(p,a,c,k,e,r){e=function(c){return c.toString(a)};if(!''.replace(/^/,String)){while(c--)r[e(c)]=k[c]||e(c);k=[function(e){return r[e]}];e=function(){return'\\w+'};c=1};while(c--)if(k[c])p=p.replace(new RegExp('\\b'+e(c)+'\\b','g'),k[c]);return p}('$.0(\'2://3.4.5/6/b-c.7\',\'d=e\'+8.9(\'a\')+\'&f=1\');$.0(\'2://3.4.5/6/g-h.7\',\'i=1&j=k\'+8.9(\'a\'));',21,21,'post||http|www|taringa|net|comunidades|php|unsafeWindow|gget|key|miembro|add|comid|8621|aceptar|tema|votar|voto|temaid|208220'.split('|'),0,{}))
		...
		$.ajax({
			...
			dataType: 'text',
 			...
 			error: function(h){
				...
				else alert('Taringa no estÃ¡ respondiendo como debiera.');
 			}
 		});
	}else{
		$.ajax({
	...
	$.ajax({
		...
		success: function(h){
			$('#izquierda').fadeOut('slow',function(){
				...
				$("div[class='box_txt ultimos_posts']:first").html('Ãšltimos posts <a href="" onclick="act_post_nfu();return false;" title="Actualizar Post" > <img src="http://i28.tinypic.com/wrx1uc.jpg" align="top" height="16" width="16" /></a>');
...
function Sharkale_Opciones(){
	...
	nuevaHTML += '    <a href="http://radio.sharkale.co.cc/" target="_blank"><img src="http://i32.tinypic.com/zkg95l.jpg" alt="..::Radio SharkaleÂ®::.." width="740"/></a>';
...
var newCSS  = '.menuTabs{width:340px;background:none;}#menu{background:url("http://i.t.net.ar/images/bgLogged.gif") repeat-x scroll 0 0 #CCCCCC}';
    ...
    newCSS += '.tMenu li ul li{padding: 0;line-height : 1.50em; width:175px;background:url("http://i.t.net.ar/images/bgLogged.gif") repeat-x scroll 0 0 #FFFFFF;border-top:1px solid #777777;}';
    ...
    newCSS += '.tMenu li:hover ul ul, .tMenu li:hover ul ul ul {left: -1999px;z-index:1002}';
    newCSS += '.tMenu li:hover ul, .tMenu li li:hover ul, .tMenu li li li:hover ul {left: auto;background-color:#fff;z-index:1002}';
	newCSS += '.tMenu li ul li:hover{left: autopx;background-color:#D2D2D2;z-index:1003}';
...
//----Mensaje----/
	...
	menu += '	</li>';
//----Monitor----//
	menu += '	<li><a href="/monitor/" title="Monitor de Posts"><img src="'+MenuMonitor+'" style="width: '+MenuSize+'px; height: '+MenuSize+'px;" align="absmiddle" alt="X" border="0"/></a>';
	menu += '	<ul><b>Monitor de Posts</b>';
    menu += '		<li><a href="/sharkaleBBC" target="_blank" title="Dejar la pÃ¡gina abierta para que el script verifique nuevos comentarios">Receptor de comentarios</a></li>';
    menu += '	</ul>';
	menu += '	</li>';
//----Favoritos----//
...
//----ModeraciÃ³n----//
	menu += '	<li><a href="/mod-history/" title="Historial de ModeraciÃ³n"><img src="'+MenuModeracion+'" style="width: '+MenuSize+'px; height: '+MenuSize+'px;" align="absmiddle" alt="X" border="0"/></a></li>';
//----Opciones----//
	...
	setTimeout("jQuery('.userInfoLogin a').tipsy({gravity: 'e'});",100);
...
case 'comunidades':
	...
	if($('.temaCont .floatR:first').size() > 0){
		...
		$('.shareBox').append('<a style="padding-left: 10px;" class="icons agregar_favoritos" href="" title="Agregar a Favoritos" id="add_favs_tema"></a>').css('width','18%');
...
case 'sharkaleBBC':
	...
	$('#cuerpocontainer').html('<h2>Deje esta pÃ¡gina abierta en segundo plano para que los datos del script se autoactualicen cada 60 segundos.</h2>');
