// ==UserScript==
// @name           alliStat-Redesign MOD
// @namespace      vulca
// @version        2.1
// @author         Vulca (98% ) & Martineli ( 2% ) & Danix (Translation options)
// @description    Progresion de los miembros de la alianza
...
var nbTrie = 6; // Comment trier les joueurs :
...
couleur[0]='#BBBBBB';           // NICKS
couleur[1]='#444444';           // FLECHAS
couleur[2]='#AAAAFF';		// PUNTOS
couleur[3]='#666666';           // TEXTO
couleur[4]='#AAAAAA';           // PORCENTAJE
couleur[5]='#00FF00';           // PORCENTAJE POSITIVO
couleur[6]='#FF0000';           // PORCENTAJE NEGATIVO
couleur[7]='#888888';           // CLASIFICACION
couleur[8]='#888888';           // CLASIFICACION EN EL JUEGO
couleur[9]='#888888';           // COORDS
couleur[10]='#FFFFFF';          // progression depuis
									
									
sizeset[0] = 80; // CLASIF. PROGRESO
sizeset[1] = 80; // POS. 1º
sizeset[2] = 80; // POS. 2º
sizeset[3] = 80; // POS. 3º
sizeset[4] = 80; // PORCENTAJE ULTIMO
sizeset[5] = 80; // CLASIF. PUNTOS		
sizeset[6] = 80; // Progression depuis									
	
								
// OPCIONES GENERALES
var centrerlescript = false;	// CENTRAR TEXTO
var baliseCenter = false;	// UTILIZAR [CENTER] EN LUGAR DE [ALIGN=CENTER]
var afficherEnQuote = false;	// RESULTADOS EN QUOTE
var gras = false;		// NEGRITA
var souligne = false;		// "HINCAPIE EN LA PROGRESION" (¿¿¿???)
	
								
// LEGENDA								
var afficherlalegende = false;	// INCLUIR LEYENDA
var spoile = false;		// LEYENDA EN SPOILER
	
								
// COORDENADAS								
var affichercoordo = false;	// INCLUIR COORDENADAS							
var italique = false;		// CORDENADAS EN MODO ITALIC
var gras_coord = false;		// COORDENADAS EN NEGRITA

									
// IMAGENES
var AfficheAudebut = false;// // RESULTADO FINAL EN NUEVA LINEA
var image1 = '[IMG]http://www.getafebikers.es/images/medals/award_star_gold_green-3.png[/IMG]'; // 1º
var image2 = '[IMG]http://www.getafebikers.es/images/medals/award_star_gold_green-2.png[/IMG]'; // 2º
var image3 = '[IMG]http://www.getafebikers.es/images/medals/award_star_gold_2.png[/IMG]'; // 3º
var image4 = '[IMG]http://img26.imageshack.us/img26/8885/skullicon.png[/IMG]'; // ULTIMO
	...
	// Google Chrome
		...
		*/
					...
					for (var i =0 ; i< infoJoueur.length ; i++)
					{
						...
						if(infoJoueur[i][5]-infoJoueur[i][3] > 0) var couleur0 = 'lime';
						else if(infoJoueur[i][5]-infoJoueur[i][3] < 0) var couleur0 = 'red';
						else var couleur0 = 'none';
						
						if(infoJoueur[i][1]- infoJoueur[i][4] > 0) var couleur2 = 'lime';
