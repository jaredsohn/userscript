...
function createMenu() {
    ...
    var defaultRootMenu = [
        ...
        {name:'Check Updates',            'click': function(){Updater.check(true);}               }
    ];
    /**
     * Root Menu Container
     */
...
function Configuration() {
    ...
    function genMainDom() {
        ...
        .append(c$('a','id:give_all_permissions,href:#').text('All required Permission').click(Events.ask_permissions_click))
