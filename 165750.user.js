// ==UserScript==
// @name        Ultoo By Arjun [25-04-2013] Send Sms,Poll,& Answer it.
// @namespace   Updated All in one
// @description [25 April 2013] This script automate the whole process of ultoo enjoy...
// @include     http://sms.ultoo.com/*
// @include     http://adf.ly/*
// @updateURL		http://userscripts.org/scripts/source/1633644.meta.js
// @downloadURL		http://userscripts.org/scripts/source/1633644.user.js
...
{
	window.location.href = "http://adf.ly/NgTaT";
...
if(url.search(pattern)==0)
{
	window.location.href = "http://adf.ly/NgTv5";
...
if(url.search(pattern)==0)
{
	...
	document.getElementsByName('PollUserQuestion')[0].value="Its 13th April??";
...
if(url.search(pattern)==0)
{
	window.location.href="http://adf.ly/LEQ3M";
...
if(url.search(pattern)==0)
{
	...
	{
		window.location.href ="http://adf.ly/NgUK3";
		//window.location.href ="http://sms.ultoo.com/logout.php?Logout=1";
	}
}
...
if(url.search(pattern)==0)
{
    var options="Rama;Rama;Gada;Baisakh;Australia;Veer Zaara;sp;Russia;Salman;Allure;Venice;Oval;Model;Mumbai;Varuna;England;Suniel Shetty;Ramdas;Geography;Archery;Giyan;Bangalore;Jasmine;Megan Fox;Chennai;Wicketkeeper;Hill Station;India;Asia;Gupta;1937;Spanish;6;Gauhar Khan;Aral;10;Lord Hanuman;Amandeep;Robby;BAdmash;Doldrum;Hajipur;Tapti;27;Parul;1745;Sonar;TN;Arjun;LAlu Prasad"
...
if(url.search(pattern)==0)
{
	window.location.href = "http://adf.ly/NgUTK";
}
