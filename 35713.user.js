...
regex1 = /vote.up.if|up.vote.if|up.if|upmod.if|downvote.if|upmod|vote.up|upvote|upvote.if|downmod|down.vote.if|mod.if|vote.down|vote.up|down.vote|vote.down.if|raise.(your|a).hand|I'?m.sure.I.?('|wi)?ll.get.downmodd?ed/i;
