   1. // ==UserScript==
   2. // @name           Bio Hazard Facebook Skin..
   3. // @namespace      Facebook
   4. // @description    Bio Hazard facebook skin by rob mason
   5. // @include        http://*.facebook.com/*
   6. // ==/UserScript==
   7.
   8. // ==== VARIABLE DEFS ====
   9. var cTitleColour    = "#000000";            // Dark Green        = #000000
  10. var cHeadingColour    = "#CC3300";            // Medium Grey/Green = #000000
  11. var cSectionColour    = "#CC3300";            // Very Light Green  = #000000
  12.
 ...
 102.         mylinks[i].style.background = "url(http://i6.tinypic.com/85aess1.jpg)";
 103.     }
 104. }
 105.
 106. // ==== Now manipulate the BODY's font and background etc. ===
 107. document.body.style.fontFamily = "Calibri Bold";
 108. document.getElementById("content").style.backgroundColor = "#CCFF00";
 109. document.body.style.backgroundImage = "url(http://i91.photobucket.com/albums/k281/piratelupin/thbiohazard.gif)";
 110.
