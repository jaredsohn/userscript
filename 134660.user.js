...
// @namespace      AutoLike
// @description    Ini dibuat oleh CnG
...
if(body != null) {
	...
	div.innerHTML = "<a style=\"font-weight:bold;color:#333333\" >Made by CnG !!</a>"
...
if(body != null) {
	...
	div.style.border = "2px solid #94a3c4";
	div.style.padding = "2px";
	div.innerHTML = "<a style=\"font-weight:bold;color:#333333\" >Unlike semua komentar</a>"
