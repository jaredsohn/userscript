// ==UserScript==
// @name          North Shore Public Library Catalog Lookup
// @namespace     http://nspl.suffolk.lib.ny.us/
// @description	  Search the North Shore Public Library Catalog from Amazon book listings.
// @include       http://*.amazon.*
...
function() {
  var libraryUrlPattern = 'http://alpha2.suffolk.lib.ny.us/search~S41/i?SEARCH=';  // To customize this for you library, change the scope number here.
  var libraryName = 'North Shore Public Library Catalog';	// Insert your library's name in this line.
