...
// @namespace      soren
// @description    English. Highlight skills based on chosen position for a player.
...
function createBuilds(){
   ...
   buildTypes[0] = new build("Goalie","Reflexes,One on one","Technique","Agility","Speed");
   buildTypes[1] = new build("Center","Playmaking,Passing","Technique,Ball control","Stamina,Speed","Jumping,Shooting");
   buildTypes[2] = new build("Pivot","Off the ball,Strength","","Agility, Speed","Shooting,Stamina,Ball control");
   buildTypes[3] = new build("Wing","Technique,Agility,Ball control","Shooting,Passing","Speed,Jumping","Stamina");
   buildTypes[4] = new build("Back","Shooting,Technique","Jumping,Passing,Off the ball","Speed","Stamina,Ball control");
   buildTypes[5] = new build("Offensiv defender","Marking,Blocking,Speed","Stamina,Agility","","");
   buildTypes[6] = new build("Defensiv defender","Blocking,Marking,Strength","Speed","","Stamina,Jumping");
   buildTypes[7] = new build("Wing defender","Marking,Blocking,Speed,Agility","","Stamina","");
   buildTypes[8] = new build("Half defender","Blocking,Marking","Agility,Stamina","Speed","");
