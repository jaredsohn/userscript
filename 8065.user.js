// ==UserScript==
// @name           Prettify
// @namespace      http://userscripts.org/users/24316/
// @description    uses http://code.google.com/p/google-code-prettify/ to syntax highlight code snippets
// @include        *
// ==/UserScript==

var tagsToPrettify = ['pre', 'code'];

GM_registerMenuCommand('Prettify', prettyPrintWrapper, 'z', 'control shift', 'p');


function prettyPrintWrapper() 
{
   for each (var tag in tagsToPrettify) {
      var elementsToPrettify = document.getElementsByTagName(tag);
      for each (var el in elementsToPrettify) {
...
/***** Google Code section *****/
// source code can be found at http://code.google.com/p/google-code-prettify/ 
