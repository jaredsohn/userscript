...
function show() {
	...
	var player = document.createElement( "object" );
		player.setAttribute( "data", "http://www.cartoonnetwork.com.tr/js/flvplayer/player.swf" );
		...
		player.setAttribute( "flashvars", "plugins=fbit-1,timeslidertooltipplugin-1h,http://www.jaczi.com/hd/hd.swf&provider=youtube&hd.pluginmode=FLASH&smoothing=true&autostart=true&file="+vidID+"&start="+startTIME);
