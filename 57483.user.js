// ==UserScript==
// @name           bw_ORDERS_ek7
// @namespace      bw_ORDERS_ek7
// @description    bw_ORDERS_ek7
...
GM_xmlhttpRequest({
	method: 'GET',
	url: 'http://egermany.itg-em.de/ede/viewtopic.php?f=57&t=1851#p15076',
	...
	onload:function(response){
			...
			header.textContent = 'VII. Expeditionskorp: ';
