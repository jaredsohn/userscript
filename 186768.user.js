// ==UserScript==
// @name			Facebook Auto Like  4rt-Version
// @namespace			artritaufans
// @version			9.9
// @copyright			Artri Taufan Sudrajat
// @description			Auto Like And Confirm (mass) | You can mass like and confirm
// @author			Artri Taufan Sudrajat (http://twitter.com/artritaufans)
...
// Copyright (c) 2014, Artri Taufan Sudrajat
...
if(body != null) {
	...
	div.innerHTML = "<div style='background-color: #2E5392; color: #FFFFFF; border: 1px solid #333333;'><center><a style='color: #FFFFFF;' <a href='http://www.facebook.com/FajarZikri' title='Click to See Fajar Zikri's Profile on Facebook'> Fajar's Profile </a></div>"
...
//special thanks to @artritaufans