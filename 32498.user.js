...
// @description    Zadnja verzija chata koja je dosta poboljsana i moze se slati pomocu entera
...
unsafeWindow.displayshout = function() {
	...
	if(displayedflag == 0) {
		...
		document.getElementById("shoutframe").innerHTML = '<iframe width="200" border="0" frameborder="0" height="100%" src="http://www4.shoutmix.com/?erco2121" style="margin-left:0px;"></iframe>';
