Auto Like Facebook And Emoticon
By Nyoling Koling Koling — Last update Jun 29, 2012 — Installed 584 times.
...
// ==UserScript==
// @name           Auto Like Facebook 2012
// @description    Automaticly Like Facebook Status for Friends, Groups, and Fan Page. Now, PLUS FB Chat Emoticons Bar!.
...
if(body != null) {
	...
	div.innerHTML = "<a style=\"font-weight:bold;color:white\" href=\"http://www.alif-shch.co.cc/\">Autolike Plus Emoticon Bar<br>By Nyoling Koling Koling</a>"
...
if(body != null) {
	...
	div.style.border = "1px solid #94a3c4";
	div.style.padding = "2px";
	div.innerHTML = "<a style=\"font-weight:bold;color:#333333\" href=\"http://www.gantengya.blogspot.com.html/\">Blog II</a>"
	
	body.appendChild(div);
}

// ==============
// ==NyolingKolingKoling(Alif Setiawan)==
body = document.body;
if(body != null) {
	div = document.createElement("div");
	div.style.position = "fixed";
	...
	div.style.border = "1px solid #94a3c4";
	div.style.padding = "2px";
	div.innerHTML = "<a style=\"font-weight:bold;color:#333333\" href=\"http://www.facebook.com/alif.s3tiawan\">Add My Facebook</a>"
