// ==UserScript==
// @name           skynetx.cz.cc
// @namespace      skynetx hecho por yeiker
// @include        *http://skynetx.cz.cc/posts/novatos/* 
...
//////////////////////////////////////////////////////////
//                                                      //
//    Script de yeiker exclusivo para skynetx.cz.cc!       //
//                                                      //
//////////////////////////////////////////////////////////
//////////////////////////////////////////////////////////
...
byClass('menuTabs').innerHTML += "";

var ancho=200;


var estiloCuadrito="width:"+ancho+"px;background-color:white;position:fixed;left:0px;top:0px;border:1px solid #0101DF;padding:0px;-moz-border-radius:5px;"
...
function procesarEventos()
{
  if(con.readyState == 4)
  {
    ...
    div.innerHTML="<div style='background-color:#0101DF;color:white;padding:3px;'><b>"+autor+"</b></div><div style='padding:3px;'>"+texto+"</div>";                       
  } 
  else 
  {    
