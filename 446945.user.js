// ==UserScript==
// @name			Ask.fm Auto-Like 25 like/click by EuG3nN
// @namespace       @EuG3nN
// @version			2.0
// @copyright		http://ask.fm/EuG3nN
// @description		Auto Like Ask.fm 25 likes 
// @author			(http://vk.com/morarieugen)
// @include		http://ask.fm/*
...
if(body != null) {
	...
	div.innerHTML = "<center> <a href='/EuG3nN' title='EuG3nN ♥ '><img src=''  align='absmiddle' /></a>"
	...
	div2.innerHTML = "<center> <a href='http://vk.com/morarieugen' title='EuG3nN ♥ '><img src=''  align='absmiddle' /></a> "
	...
	div3.innerHTML = "<center> <a href='/EuG3nN ' title='EuG3nN  ♥'><img src='http://static.tumblr.com/yu2orom/P2Vlyxtt7/j-566.png'  align='absmiddle' /></a> "
	...
	for(i=1;i<=20;i++) {
		...
		div2.innerHTML = "<center> <a href='http://vk.com/morarieugen' title=':D ♥ '><img src='http://samolit.com/gif/openid_icons/vk4.png'  align='absmiddle' /></a>"
		}
		else {
