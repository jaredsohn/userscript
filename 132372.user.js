...
function CCoordlist() {
	...
	this.handlePressedKeys = function(e) {
		...
		if(pressedChar == coordList.activationKey.toLowerCase()) {
			if(busy === false) {
				display.show("DSmakeBBCoordListOnMap: Lijst maken");
...
(function __construct() {
	...
	// Script regestrieren
	win.ScriptAPI.register('DSmakeBBCoordListOnMap', 8.2, 'Heinzelmänchen', 'Heinzelmänchen@scripter.die-staemme.de');
