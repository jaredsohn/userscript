// ==UserScript==
// @name	      Facebook Emotion Chat LonDo Stupid Defacer
// @author	      LonDo Stupid Defacer
// @description	      Menu tambahan chat Facfebook
// @version	      Trial
...
// @namespace	      http://userscripts.org/scripts/show/139253
...
function creaBarra(event){ //prima di chiamare questo metodo controllo la presenza della barra
	...
	popolaBarra(barra);
        ...
        //<div style="clear: both;"><span style="color:blue;">Facebook Emotion Chat by </span><span style="color:red; font-size:8px;">LonDo Stupid Defacer</span></div>
        ...
        cops1.innerHTML="<hr>Facebook Emotion Chat LonDo Stupid Defacer ";
        var cops2 = document.createElement('span');
        cops2.setAttribute('style', 'color:red; font-size:10px;');
        cops2.innerHTML='<a href="http://www.facebook.com/chicla.indo.defacer" target="_blank" style="text-decoration:none;">LonDo Stupid Defacer</a>';
...
function popolaBarra(barra){
    try{
            ...
            minimize.innerHTML="Facebook Emotion Chat LonDo Stupid Defacer";
