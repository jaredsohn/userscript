	...
	baseUnitValues:function (unit_name) {
		...
		case "feen":
			switch (unit_name) {
				...
				case "singing_halfgiant": 		return {id:unit_name,attack:16,defense:17,live:336,speed:2,points: 105,reviveMushrooms:  58,revivePowerStones:     0,name:'Singende Halbriesen'};
				case "stone_throwing_troll": 	return {id:unit_name,attack:34,defense:31,live:650,speed:4,points: 154,reviveMushrooms:  81,revivePowerStones:     0,name:'Steinwerfende Bergtrolle'};
				case "treegiant": 				return {id:unit_name,attack:38,defense:38,live:144,speed:4,points:  77,reviveMushrooms:  42,revivePowerStones:     0,name:'Baumriese'};
				case "elv_magican": 			return {id:unit_name,attack:47,defense:47,live:163,speed:2,points: 122,reviveMushrooms:  65,revivePowerStones:     0,name:'Elfenmagier'};
				case "fire_fay": 				return {id:unit_name,attack:19,defense:19,live: 23,speed:2,points:  30,reviveMushrooms:  19,revivePowerStones:     0,name:'Feuerfeen'};
