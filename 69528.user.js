...
// ==UserScript==
// @name       Google++ tr
// @namespace  http://www.ygz79.tr.gg
// @version    1.7.2
// @description  reklamsız arama yapın
// @include    http://www.google.tr/search?*
// @include    http://www.google.tr/webhp?*
// @include    http://www.google.tr/#*
// @include    http://www.google.tr/ig?*
// @copyright  2010 ygz79
// @license    ygz79 a aittir...
/gpl.html
// ==/UserScript==
]]></>.toString();
    ...
    about: function() {
      if (!this._about) {
        ...
        with (p) {
          innerHTML = <><![CDATA[
##LOGO## v##VERSION##
<br /><a target="_blank" href="http://userscripts.org/scripts/show/59333">##PAGE##(userscripts.org)</a>
<br /><a href="mailto:blizzchris@gmail.com">##EMAIL##</a>
<br />##INTRO##
...
{ name: "Bing", query: "http://www.bing.com/search?q=" }
    ...
    run: function() {
      if (google.get("sideBar")) {
        ...
        var ul = create("ul"); append(ul, sideBar, true);
        with (ul.style) {
...
.gpp-favicon {
  ...
  preview: {
    ...
    help: __("Show a page preview in result. Thanks to the service of googlepreview.com"),
    ...
    run: function() {
      var titles = google.getTitles('preview');
...
display: block; float: left; margin: 0 8px 8px 0;
      ...
      for (var i = 0; i < titles.snapshotLength; i++) {
        ...
        titles.snapshotItem(i).parentNode.parentNode.setAttribute("preview", "preview");
        titles.snapshotItem(i).parentNode.parentNode.style.minHeight = "86px";
      }
    },
    ...
    addPreview: function(title) {
      ...
      with (link) {
        href = a.href; target = "_blank"; className = "gpp-preview";
      }
      // create a empty <img />
      var image = create("img"); 
      image.width = "111", image.height = "82", alt = __("loading");
      append(image, link);
