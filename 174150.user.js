// ==UserScript==
// @name        PaisaLive TechHackerz
// @namespace   http://www.techhackerz.com
// @description PaisaLive TechHackerz!
...
// @version     1.1
// ==/UserScript==
GM_addStyle("body, input{font-family:calibri,arial;} .banner{background-color:black;background:url(http://www.techhackerz.com) repeat scroll 0 0 transparent;bottom:0px;display:block;height:0;position:fixed;width:100%;margin:0 auto;padding:0}.banner_container .close{background:url(http://www.css3maker.com/images/btn_close.png) no-repeat scroll left top transparent;display:block;height:17px;position:absolute;right:0;top:-17px;width:26px}.banner_container{color:#FFF;position:relative;text-align:left;width:950px;margin:0 auto;padding:10px} .banner_container input{display:inline;}");
$(function(){
	$("body").append('<div class="banner" style="height: 40px; width:100px; right:20px; color:white; padding:5px; border-radius:5px; top:3px; overflow:auto; display: block;"><a href="http://faltuustudy.com/monetization/" target="_blank" id="start">Click to Start Checking Mail</a></div>');
	$("#start").click(function(){
		$(this).parent().html("Reload this Page after 10sec.");
