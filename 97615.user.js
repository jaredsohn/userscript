// ==UserScript==
// @name          He-Man Hompage ForumReader
// @version        3.0
// @namespace      Kjoe
...
GM_xmlhttpRequest({ 
    method: 'GET',
    url: 'http://goallineblitz.com/game/forum_thread_list.pl?team_id=' + parID,
    headers: {
	...
	var count = response.responseText.split("images/game/forum/new_posts.gif").length-1;  
	    ...
	    myA.href="http://goallineblitz.com/game/forum_thread_list.pl?team_id=" +parID;
...
GM_xmlhttpRequest({ 
    method: 'GET',
    url: 'http://goallineblitz.com/game/forum_thread_list.pl?forum_id=' + parID,
    headers: {
        'User-agent': navigator.userAgent,
	'Accept': 'text/xml'
    },
	...
	var count = response.responseText.split("images/game/forum/new_posts.gif").length-1;  
	    ...
	    myA.setAttribute("class","sort_forumbutton");
	    myA.href="http://goallineblitz.com/game/forum_thread_list.pl?forum_id=" +parID;
	    myA.innerHTML = teamName + '(<b>' + count + '</b>) | ';
