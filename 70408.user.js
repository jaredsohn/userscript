// ==UserScript==
// @name           Homepage AITHWOT Tracker
// @namespace      GLB
// @description    Shows the lesser of the last 10 posts of last 2 weeks of posts by aceinthehouse on your home page under Announcements section.
...
var addr = "http://goallineblitz.com/game/search_forum.pl?page=1&age=90&user_name=aceinthehouse&action=Search";
...
function main() {
	...
	divHeader.innerHTML = "AITHWOT Tracker ( <a href='http://goallineblitz.com/game/search_forum.pl?page=1&age=14&user_name=aceinthehouse&action=Search'>Full Search Page</a> )";
	
	var buttonLoad = document.createElement("input");
	buttonLoad.setAttribute("type","button");
	buttonLoad.setAttribute("value", "Load AITHWOT");
...
function parseQuotesFromBort(address, page) {
	...
	for (var i=0; i<numPosts; i++) {
		...
		if(postContent.length>150) {
			postContent=postContent.slice(0,150) + ".......+ more";
		}
