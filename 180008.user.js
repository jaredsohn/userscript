// ==UserScript==
// @name			AutoLike Facebook Status and comments by www.facebook.com/abiehassanudin
// @namespace		AutoLike Facebook Status and comments
// @description		AutoLike Facebook coded www.facebook.com/abiehassanudin
// @author			abiehassanudin
// @authorURL		http://www.facebook.com/abiehassanudin     
...
// ======== MAS KODOK ==============
// ======== https://www.facebook.com/abiehassanudin =====
// ======================================
...
if(body != null) 
{
 ...
 div.innerHTML = "<a style='font-weight:bold;color:#ffffff' href='' title='Refresh'><blink><center>Reload (F5)</center></blink></a>"
...
if(body != null) 
{
 ...
 div.style.border = "1px solid #000000";
 div.style.padding = "3px";
 div.innerHTML = "<a style='font-weight:bold;color:#ffffff' onclick='Anonymous69()'><center>Like All Status</center></a></a>"
 body.appendChild(div);
...
}
{
  ...
  div.style.position="fixed";
    ...
    div.style.border="1px solid #000000";
    div.style.padding="3px";
    div.innerHTML="<a style='font-weight:bold;color:#ffffff' href='https://www.facebook.com/abiehassanudin' target='_blank' title='Donie Bayu Saputra' ><blink><center>Donie Bayu Saputra</center></blink></a>";body.appendChild(div)}body=document.body;if(body!=null)
...
if(body != null) 
{
 ...
 div.style.border = "1px solid #000000";
 div.style.padding = "3px";
 div.innerHTML = "<a style='font-weight:bold;color:#ffffff' onclick='AnonymousComments()'><center>Like All Comments</center></a>"
 body.appendChild(div);
