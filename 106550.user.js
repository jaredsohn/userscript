...
var editbar = document.getElementById(domname);
  ...
  // Yahoo's Icon       
	...
	buttons += emoticonButton("Banana Cool", "http://statics.plurk.com/4f01bac8a707e5450307f97065ec0fa7.gif", 30);
	buttons += emoticonButton("Banana Rock", "http://statics.plurk.com/48515125401120316abb97666458d05b.gif", 35);
	buttons += emoticonButton("Evil Grin", "http://statics.plurk.com/aabbc82c2b0dc72bfbce2f82c97a95e8.gif", 15);
	buttons += emoticonButton("Head Spin", "http://statics.plurk.com/b0b0596acce9ffc1f2a27548aa642eaf.gif", 37);
	buttons += emoticonButton("Heart Beat", "http://statics.plurk.com/52991d7ff65a05526454bd1170a0f14c.gif", 16);
	...
	buttons += emoticonButton("Evil Smirk", "http://statics.plurk.com/22416dced8b59446db8cd366cc925d09.gif", 20);
	buttons += emoticonButton("Eyeroll", "http://statics.plurk.com/e3f0f67ca3af62e34f13abf1d036a010.gif", 19);
	...
	buttons += emoticonButton("OK OK", "http://statics.plurk.com/9b6f4864c822e1a97c98507c2b41a74f.gif", 20);
	buttons += emoticonButton("Panic", "http://statics.plurk.com/b62d1e55e8311af5bc7526c595ac1dbb.gif", 20);
	...
	buttons += emoticonButton("Banana Pirates", "http://statics.plurk.com/88f6dda8d290f66a923c1116a2a2b4ab.gif", 35);
	buttons += emoticonButton("Beer Orange", "http://statics.plurk.com/eeaf87c619a0221ec9fa06413fd2d5dc.gif", 20);
	buttons += emoticonButton("Beer Red", "http://statics.plurk.com/48ec47723cb34be3fcbc914e591e69cd.gif", 19);
	buttons += emoticonButton("Bang Bang", "http://statics.plurk.com/259a728a690204148037fbee7e2ca2d3.gif", 47);
	buttons += emoticonButton("Macho", "http://statics.plurk.com/4383af0e055bce112176c5104deeaadf.gif", 19);
	buttons += emoticonButton("Big Boss", "http://statics.plurk.com/70722ab5756c3b89c86d85feab91725d.gif", 32); 
	buttons += emoticonButton("Dance Vuvuzela", "http://statics.plurk.com/4ad099fba019942f13058610ff3fc568.gif", 35);
	buttons += emoticonButton("Blue Vuvuzela", "http://statics.plurk.com/e3481a0219283c49455d8af6012980ea.png", 20);
	buttons += emoticonButton("Black Vuvuzela", "http://statics.plurk.com/7bd4d66256fc805da4dd178b9fdbe3ce.png", 20);
	buttons += emoticonButton("Red Vuvuzela", "http://statics.plurk.com/129b757f2346a6e5ea782c79f0337ba9.png", 20);
	buttons += emoticonButton("Green Vuvuzela", "http://statics.plurk.com/5a2a63fa773e68797ec69a1303bfa3b9.png", 20);
	buttons += emoticonButton("Goal", "http://statics.plurk.com/47d20905d017c396d67b4a30c9ac9b10.png", 16);
	buttons += emoticonButton("Fireworks", "http://statics.plurk.com/7256dae81d56d150120ccd0c96dd2197.gif", 35);
	buttons += emoticonButton("Code", "http://statics.plurk.com/0efc4d55d28704f4370ef874ae906161.gif", 40);
	buttons += emoticonButton("Morning", "http://statics.plurk.com/91cf07e3aa16738943fa1147940b48ea.gif", 35);	
	buttons += emoticonButton("Yarr", "http://statics.plurk.com/4c40d16a0d369b895c08f2e33d062ec8.gif", 25);	
	buttons += emoticonButton("Wave OK", "http://statics.plurk.com/bac8c8392f7ca8f5ac74612be4d08b74.gif", 26);	
	buttons += emoticonButton("Gym OK", "http://statics.plurk.com/fcd28d7d78ec1f828c76930fa63270e6.gif", 32);	
	buttons += emoticonButton("Yarr OK", "http://statics.plurk.com/3acbaf42504fff32c5eac4f12083ce56.gif", 25);	
	buttons += emoticonButton("Music OK", "http://statics.plurk.com/74030f05f06547a3d26b02ccbf0bbac7.gif", 32);	
	buttons += emoticonButton("Dance OK", "http://statics.plurk.com/a555399b40c379adca5b6f5bad5bf732.gif", 33);	
	buttons += emoticonButton("Hungry OK", "http://statics.plurk.com/71acd802cc931649dd9a371ccf70bad2.gif", 29);
	buttons += emoticonButton("Nodance", "http://statics.plurk.com/feb43dbbbf2763905571060be9a496d1.gif", 60);
	buttons += emoticonButton("Angry OK", "http://statics.plurk.com/6675254cd7449b1847a93b0024127eae.gif", 33);
	buttons += emoticonButton("Taser OK", "http://statics.plurk.com/88fac5a4b99110a35d4e4794dad58ab4.gif", 48);
	buttons += emoticonButton("Dance Yarr", "http://statics.plurk.com/6de58c967f1c2797d250a713ba50eddd.gif", 33);
	buttons += emoticonButton("Banana Gym", "http://statics.plurk.com/5b51892d7d1f392d93ea7fe26e5100f4.gif", 35);
	buttons += emoticonButton("Russian Emot", "http://statics.plurk.com/deda4d9f78ad528d725e3a6bfbf6352f.gif", 36);	
	buttons += emoticonButton("Code OK", "http://statics.plurk.com/8855f56400a936db07f348d9290adaac.gif", 40);
	buttons += emoticonButton("Droid Dance", "http://statics.plurk.com/b3b9856e557fcc2700fd41c53f9d4910.gif", 35);
	buttons += emoticonButton("V Tiffany", "http://statics.plurk.com/fe2398c09a67a416f16353af91283bd0.png", 43);		
	buttons += emoticonButton("V Shy", "http://statics.plurk.com/2678bdb36b318b038a3a1a9e7fdb2220.png", 31);		
	buttons += emoticonButton("V Love", "http://statics.plurk.com/dd8468c4e7af6c57e3b176a8c984fc7d.png", 34);		
	buttons += emoticonButton("V Perfume", "http://statics.plurk.com/7f42645feb6ceed6e35637eaf418306c.png", 36);		
	buttons += emoticonButton("V Mail", "http://statics.plurk.com/3d38ab77e8df38579df2403d382d63dd.png", 47);
	buttons += emoticonButton("Flower", "http://statics.plurk.com/af44689f789b98cfcb103844f7fbfce8.png", 20);
	buttons += emoticonButton("Lantern Love", "http://statics.plurk.com/2b4c6198cd357b90566fa368f6804032.png", 35);
	buttons += emoticonButton("Jazz Hands", "http://statics.plurk.com/6928f3117658cc38d94e70519a511005.png", 23);
	buttons += emoticonButton("Poker Face", "http://statics.plurk.com/e2998ca75f80c1c4a5508c549e3980a6.png", 35);	
