 ...
 * Email Notify: Sends a Email, if someone attacks you
 * Advanced Tower Alert: adds some additional info to the alert:
     1. Publish your HQ to Ally chat
     2. Troops in embassy(with Knight level) 
     3. Own Troops in City
     4. Total Troops
     5. Food, food usage and time left until running out of food
...
2011-02-04 (Version 0.2.0) 
   - Initial 
   - change structure to get " Falcon Advanced Tower" as Tab working with "Power Tools" and "Power Bot" 
   - add food info and fortification info to Advanced TowerAlert
2011-02-08 (Version 0.2.7) 
   - add board tab
   - change tab theme colors to ally colors
   - fix "Falcon Advanced Tower" tab to fit to tab menu 
2011-02-08 (Version 0.2.10) 
   - add adv.players tab (+online status, + login Date)   
**********************/

var Version = '0.2.11';
var Versiondate = '09.02.2011';
var Scriptname = 'Falcon Advanced Tower';
var ScriptTabName = 'Advanced Tower';
