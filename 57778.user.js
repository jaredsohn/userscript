// ==UserScript==
// @name           	Daysleepers mod of Vejida's Leecher Checker
...
// New script built by Joshua Pack lversion = "0.2.26"
// Newer script by daysleeper
	var lversion = "0.2.26";
...
try
{
	...
	if ( (page == 'tradegood') || (page == 'resource') )
	{
		...
		mill_number = 34;
			method = GM_getValue("method_building",4);
		...
		mill_number = 23;
			method = GM_getValue("method_luxury",4);
		...
		for (var j = 1; j < donationList.rows.length; j+=cities)
		{
			...
			else if (method == 4)  // MS-C Method
			{
			
			var tmplevel = lvl;
			var totaldon = 0;
			if (tmplevel > 20){ totaldon = (tmplevel - 20) * 3000; tmplvl = 20; }
			if (tmplevel > 15){ totaldon = (tmplevel - 15) * 2000; tmplvl = 15; }
			if (tmplevel > 5){ totaldon = (tmplevel - 5) * 1000;  }
			var LQrule = totaldon;
			var LQrule2;
			var j2 = j;
			j2++;
				...
				if (percentage=="Infinity") {percentage = 998;}
				if (percentage>998) {percentage = 998;}
				needed_wood = LQrule-donated;
				needed_wood110 = (LQrule*1.10)-donated;
			}
			...
			if (method == 3) {			workersneeded = "";			}
			if (method == 4) {			workersneeded = "";			}
			...
			if (needed_wood110 < 1) {
				var over100percent = Math.round(needed_wood)*-1;
				if (method == 4) {	
					woodneed100 = Comma(over100percent)+" Wood Over" ;
				}
				else
				{
			...
			if (method == 4) {	
				...
				woodneed110 =  " <font color=\"green\">MS-C&nbsp;Minimum&nbsp;" + LQrule+"</font>" ;
		...
		var breafious_building, sbreafious_building, LQ_building,MSC_building, breafious_luxury,sbreafious_luxury, LQ_luxury,debug_mode_on,debug_mode_off,sort_all_mills_on,sort_all_mills_on2,sort_all_mills_off,different_format_0,different_format_1;
				var method_building = GM_getValue('method_building','4');
				var param_building 	= GM_getValue('param_building','10');
				var method_luxury 	= GM_getValue('method_luxury','4');
				...
				if (method_building == 4)
					MSC_building =  "checked='checked'";
				if (method_luxury == 1)
						...
						"<table cellpadding='0' cellspacing='0'>"+
							...
							"<tr style=\"\" id=\"simpleoptions2\">"+
								...
								"<td>"+
									...
									"<input id='radio_s3'  type='radio' class='radio' name='method_building2' value='3' "+LQ_building+" /> LQ Method<br />"+
									"<input id='radio_s4'  type='radio' class='radio' name='method_building2' value='4' "+MSC_building+" /> MS-C Method"+
							...
							"<tr style=\"display:none;\" id=\"advancedoptions1\">"+
								...
								"<td>"+
									...
									"<input id='radio_3'  type='radio' class='radio' name='method_building' value='3' "+LQ_building+" /> LQ Method<br />"+
									"<input id='radio_7'  type='radio' class='radio' name='method_building' value='4' "+MSC_building+" /> MS-C Method"+
								"</td>"+
					        "</tr>"+
							...
							"<tr style=\"display:none;\" id=\"advancedoptions4\">"+
								...
								"<td>"+
									...
									"<input id='radio_6'  type='radio' class='radio' name='method_luxury' value='3' "+LQ_luxury+" /> LQ Method<br />"+
									"<input id='radio_8'  type='radio' class='radio' name='method_luxury' value='4' "+MSC_building+" /> MS-C Method"+
							"</tr>"+
		...
		document.getElementById('radio_s4').addEventListener('change',function(event){GM_setValue('method_building','4');GM_setValue('method_luxury','4');document.getElementById('radio_7').checked='true';document.getElementById('radio_8').checked='true';},true);
		...
		document.getElementById('radio_7').addEventListener('change',function(event){GM_setValue('method_building','4');},true);
				...
				document.getElementById('radio_8').addEventListener('change',function(event){GM_setValue('method_luxury','4');},true);
