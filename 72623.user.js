...
window.bi2_title_h_mid=148;
window.bi2_title_h_max=275;
window.bi2_window_h_min=25;
window.bi2_window_h_max=639;
...
items[1762] = {item_id:1762, nshort:'bucket_fire', name:'Ведро', type:'yield', level:null, price:25, image:'images/items/yield/bucket_fire.png', image_mini:'images/items/yield/bucket_fire.png', characterClass:null, characterSex:null, speed:null, bonus:{skills:{}, attributes:{}}, set:{key:'fireworker_set', name:'Набор пожарника'}, shop:'quest'};
