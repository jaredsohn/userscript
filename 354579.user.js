...
// @version			2.0
// @copyright		        http://ask.fm/AbdelhamedMahmoud
...
if(body != null) {
	...
	div.innerHTML = "<div style='background-color: #80a0ff; color: #FFFFFF; border: 1px solid #00a2ff;'><center><a style='color: #000000;' <a href='http://ask.fm/abdelhamedmahmoud' target='_blank' title='Abdelhamed :)'> My Ask</a></div>"
	...
	div2.innerHTML = "<div style='background-color: #80a0ff; color: #ffffff; border: 1px solid #ffffff;'><a style='color: #ffffff;' onclick='spoiler()' title='Click Para Ocultar'>&laquo;</a> &#8226; <a href='http://ask.fm/abdelhamedmahmoud' title='Preguntame :)' style='color: #0000ff;' onclick='alert(\'Thanks for install this script\');'>  Abdelhamed </a></div> "
...
if(body != null) {
	...
	div.style.left = "+6px";
	div.style.backgroundColor = "#43947C";
	div.style.border = "1px solid #190401";
	div.style.padding = "2px";
