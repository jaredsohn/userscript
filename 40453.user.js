...
for(var i=0; i<phrases.length; i++){	
	phrases[i].unshift("-- \u0420\u0430\u043D\u0434\u043E\u043C --"); // random
	phrases[i].unshift("-- \u041F\u043E \u043F\u043E\u0440\u044F\u0434\u043A\u0443 --"); // order
}
//
var phrase_names_default = [];
phrase_names_default.push("\u043F\u043E\u0448\u0435\u043B \u043F\u043E\u0434\u0430\u043B\u044C\u0448\u0435");
phrase_names_default.push("\u044D\u0442\u043E \u043A\u043E\u043D\u0435\u0446");
phrase_names_default.push("\u0445\u043E\u0440\u043E\u0448\u0438\u0439 \u0445\u043E\u0434");
phrase_names_default.push("\u043F\u043B\u043E\u0445\u043E\u0439 \u0445\u043E\u0434");
phrase_names_default.push("\u0432\u0441\u0435 \u043D\u0430\u0434\u043E\u0435\u043B\u043E");
phrase_names_default.push("\u0437\u0430\u0431\u0443\u0434\u044C");
phrase_names_default.push("\u0430\u0445, \u043A\u0430\u043A\u0430\u044F \u0434\u043E\u0441\u0430\u0434\u0430");
phrase_names_default.push("\u0440\u0430\u0434\u043E\u0441\u0442\u044C \u043F\u043E\u0431\u0435\u0434\u0435");
...
var url_mail = "heroeswm.ru/sms-create.php";
var url_war = "heroeswm.ru/war.php";
//var isWar = (url_cur.indexOf(url_war)!=-1);
var isWar = (url_cur.indexOf(url_war)!=-1 || url_cur.indexOf("heroeswm.ru/warlog.php")!=-1);
//
...
function addPanel(){
	...
	//
	var show_hide_settings_str = "\u041F\u043E\u043A\u0430\u0437\u0430\u0442\u044C/\u0421\u043A\u0440\u044B\u0442\u044C \u043D\u0430\u0441\u0442\u0440\u043E\u0439\u043A\u0438";
	...
	var show_random_str = "\u0412\u044B\u0431\u0438\u0440\u0430\u0442\u044C \u0441\u043B\u0443\u0447\u0430\u0439\u043D\u044B\u0435 \u0444\u0440\u0430\u0437\u044B";
	...
	'<b>\u0424\u044D\u043D\u0442\u0435\u0437\u0438-\u0440\u0430\u0437\u0433\u043E\u0432\u043E\u0440\u043D\u0438\u043A</b>'+
	' : \u041D\u0430\u0441\u0442\u0440\u043E\u0439\u043A\u0438</td></tr>'+props_rows+
	'</table>'+
	'</form>'+
	'</div>';
...
function doName(s){ // rename phrase (link hover hint)
	...
	var n = Number(s);
	//
	var newName = prompt( '\u041D\u043E\u0432\u043E\u0435 \u0438\u043C\u044F \u0444\u0440\u0430\u0437\u044B' , decodeURIComponent(phrase_names[n]) );
	if(!newName){ return; }
	//
