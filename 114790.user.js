...
switch(resolveBettorType(user)){
 case 'lp':
  holder.innerHTML += '<font color="fuchsia"><b>Late Payback</b></font>';
  break;
 case 'welcher':
  holder.innerHTML += '<font color="red"><b>Loan Welcher</b></font>';
  break;
case 'unknown':
...
function getNames(){
	...
	{
	    method: 'GET',
	    url: 'http://loanwelcherlist.angelfire.com/',
	    headers: 
		{
