// ==UserScript==
// @name           Polizeiwache.net AAO DarkPrince
// @namespace      http://userscripts.org/users/119663
// @description    Script fuer Alarmierung und verwaltung fuer das Spiel Polizeiwache.net
// @include        http://www.polizeiwache.net/*
// @author         DarkPrince
// @version        18.09.2012 - 23:00 Uhr - Noch auf FW, nicht ziehen
// ==/UserScript==


var MAXSPALTENVERFUEGBAR=99;
var CHECKFORUPDATES=true;
var UPDATEURL="http://userscripts.org/scripts/show/63023";
var INSTALLURL="http://userscripts.org/scripts/source/63023.user.js";
...
var Einsatzklassen = {
  ...
  'Rentner überfallen'                      :  'Stufe 2',
  'Taschendiebstahl'                        :  'Stufe 2',
  'Tourist überfallen'                      :  'Stufe 2',
  'Fensterscheibe von Auto eingeschlagen'   :  'Stufe 2',
  'Streit eskaliert'                        :  'Stufe 2',
  'Notebooks aus Hochschule entwendet'      :  'Stufe 1',
  'Fußgänger von Lieferwagen erfasst'       :  'Stufe 1',
  'Auto prallt gegen Laterne'               :  'Stufe 1',
  'Radfahrer beim Abbiegen übersehen'       :  'Stufe 1',
  'Unfall beim Parken'                      :  'Stufe 1',
  'Kleintransporter fährt auf PKW auf'      :  'Stufe 1',
  'Auffahrunfall (2 PKW)'                   :  'Stufe 1',
  'Parkendes Auto gerammt'                  :  'Stufe 1',
  'Motorroller fährt auf Auto auf'          :  'Stufe 1',
  'Busfahrer geschlagen'                    :  'Stufe 2',
  'Autoscheibe eingeschlagen'               :  'Stufe 2',
  'Raub auf Supermarkt'                     :  'Stufe 3',
  'Spielhalle überfallen'                   :  'Stufe 3',
  'Schüsse in Wohnviertel'                  :  'Stufe 3',
  'Metalldiebstahl'           		    :  'Stufe 1',
  'Drogendeal'                              :  'Stufe 2',
  'Auto erfasst Moped'                      :  'Stufe 1',
  'Gegenstand von Autobahnbrücke geworfen'  :  'Stufe 2',
  'Automatencasino überfallen'              :  'Stufe 3',
  'Tankstelle überfallen'                   :  'Stufe 2',
  'Häusliche Gewalt'                        :  'Stufe 2',
  'VU mit Wild'                             :  'Stufe 1',
  'Fahrraddiebstahl'                        :  'Stufe 1',
  'Schwarzfahrer erwischt'                  :  'Stufe 2',
};
...
var Einsatzklasse_Fahrzeugzuordnung = {
  ...
  'Stufe 1'                                 :  'FuStW',
  'Stufe 2'                                 :  'FuStW,GefKW',
  'Stufe 3'                                 :  'FuStW,FuStW,GefKWBKW,BefKW',
};
...
var Fahrzeugklassen = {
  ...
  'Hundestaffel PKW'                        :   'K-9',
  'Verkehrüberwachung'                      :   'Radar',
  'Motorrad'                                :   'Krad', 
};
...
{ var FRM = document.getElementsByTagName("form")[0];
  ...
  { if (Par.innerHTML.match("Diese Polizeiwache kann keine Fahrzeuge mehr aufnehmen"))
...
// ************************************************************************************
  ...
  if (InfotextVerfuegbar) Info += InfoVorspann + "<a target='_new' href='http://www.feuerwache.net/feuerwehrfahrzeuge'>verfügbare Fahrzeuge</a></th><td><font color='#DF7401'><font size='2'>" + InfotextVerfuegbar + "</font></font></td></tr>\n";
