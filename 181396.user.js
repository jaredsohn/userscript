// ==UserScript==
// @name 	GoogFix
// @namespace 	http://userscripts.org/users/537488
// @description Fixes layout of Google. Brings back left column (sidebar) options. 
...
// @include     https://encrypted.google.com/#*
// @include     *://*
// @require     http://userscripts.org/scripts/source/181394.user.js
// @version     25
// @grant       GM_addStyle
// @grant       GM_getValue
// @grant       GM_setValue
...
(function ()
{
	...
	GM_addStyle(" \
		...
		#gb.com-googlifix-blackbar {top:30px;} \
		#com-googlifix-blackbar {background-color:#444; padding:0px; height:30px; width:auto;} \
		#com-googlifix-blackbar span.gb_d {display:none;} \
		#com-googlifix-blackbar a.gb_b {margin:0px; padding:0px 10px; text-decoration:none;} \
		#com-googlifix-blackbar a.gb_b:hover {background-color:#666;} \
		#com-googlifix-blackbar a.gb_b > span {line-height:30px; width:auto; color:white; font-weight:bold; background-color:transparent;} \
		#gbwa {display:none;} \
		\
	...
	// black bar
	var blackbarItems = document.querySelector("#gbwa > div.gb_o > ul.gb_t");
	if (blackbarItems != null && document.location.host != "encrypted.google.com")
	{
		// search bar
		document.querySelector("#gb").className += " com-googlifix-blackbar";
		
		// basic list
		blackbarItems.id = "com-googlifix-blackbar";
		document.querySelector("#mngb").insertBefore(blackbarItems, document.querySelector("#gb"));
		
		// more link
		var moreLink = document.querySelector("#gbwa a.evenMoreLink");
		moreLink.className = "gb_b";
		
		var moreLinkSpan = document.createElement("span");
		moreLinkSpan.className = "gb_e";
		moreLinkSpan.innerHTML = moreLink.innerHTML;
		moreLink.innerHTML = "";
		moreLink.appendChild(moreLinkSpan);
		
		var moreLinkWrapper = document.createElement("li");
		moreLinkWrapper.className = "gb_a";
		moreLinkWrapper.appendChild(moreLink);
		
		document.querySelector("#com-googlifix-blackbar").appendChild(moreLinkWrapper);
	}
