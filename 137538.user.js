...
languages = { // Language tags
 ...
 "cz"    : { // Czech
  ...
  "at_none"               : "ZaÃºtoÄit znovu",
  "at_same"               : "ZaÃºtoÄit znovu stejnÃ½mi jednotkami",
  "at_all"                : "ZaÃºtoÄit znovu vÅ¡emi jednotkami",
  "mapsize"               : "Velikost mapy",
  "pop_close"             : "ZavÅ™Ã­t",
  "pop_auto"              : "Automaticky zobrazit",
  "group_toggle"          : "Zobrazit/skrÃ½t nastavenÃ­ skupiny",
  "group_edit"            : "UloÅ¾it zmÄ›ny",
  "group_moveup"          : "Tuto skupinu pÅ™esunout vÃ½Å¡e",
  ...
  "group_storeDone"       : "Aktualizace skupin! NaÄÃ­tÃ¡m stranu nÃ¡hledu...",
  "group_name"            : "NÃ¡zev skupiny",
  "group_ingroup"         : "AktuÃ¡lnÃ­ skupina",
  "overview_nogroup"      : "NeseskupenÃ© vesnice",
  "overview_village"      : "Vesnice",
  "overview_points"       : "Body",
  "overview_resources"    : "Zdroje",
  "overview_warehouse"    : "SkladiÅ¡tÄ›",
  "overview_farm"         : "Statek",
  "main_setaliasheader"   : "ZmÄ›na aliasu vesnice:",
  "main_setalias"         : "UloÅ¾it alias",
  "main_setaliasdone"     : "Alias uloÅ¾en!",
  "setting_show"          : "TW Enhancer",
  "setting_name"          : "NÃ¡zev zÃ¡suvky",
  "setting_toggle"        : "Povolit/ZakÃ¡zat",
  "setting_label_desc"    : "Popis",
  "setting_label_version" : "Verze",
  "setting_label_dev"     : "VÃ½vojÃ¡Å™",
  "setting_label_exec"    : "BÄ›hÃ¡ pro",
  "tw_scan"               : "DivokÃ©Kmeny se tÄ› prÃ¡vÄ› pokusily zkontrolovat na pouÅ¾Ã­vÃ¡nÃ­ automatizace!"
 },
 ...
 "fr" : {
  ...
  "overview_nogroup" : "SÃ©parer les villages",
  "overview_village" : "Villages",
  "overview_points" : "Points",
  "overview_resources" : "Ressources",
  "overview_warehouse" : "entrepÃ´t",
  "overview_farm" : "Ferme",
 ...
 "pl" : { // Polish
  ...
  "player"   : "Gracz",
  "tribe"    : "Wioska",
  "i_player" : "PokaÅ¼ informacje o graczu",
  "i_tribe"  : "PokaÅ¼ informacje o wiosce",
  "loading"  : "OdÅ›wieÅ¼anie...",
  "c_close"  : "Zamknij",
  "track"    : "Badaj wioskÄ™",
 ...
 "br" : { //Brazilian
  ...
  "player"   : "Jogador",
  "tribe"    : "Tribo",
  "i_player" : "Exibir informaÃ§Ã£o do jogador",
  "i_tribe"  : "Exibir informaÃ§Ã£o da tribo",
  "loading"  : "Carregando...",
  "c_close"  : "Clique para fechar",
  "track"    : "Rastrear Aldeia",
  "tracked"  : "Aldeia rastreada",
  "untrked"  : "Aldeia nÃ£o rastreada",
 ...
 "de" : { //German
  ...
  "loading"  : "Laden...",
  "c_close"  : "Klicken zum schlieÃŸen",
...
//// end timezone
  ...
  'get_rallypoint_html' : function(village_id,x,y) {
	  ...
	  html += "<td align=\"top\" style=\"visibility:hidden;\"><a href=\"javascript:popup_scroll('targets.php?village="+personals.getCurrentVillage()+"&amp;mode=own', 340, 400)\">Ã‚Â» Your own</a></td>\n";
  ...
  enhance_game_place : function() {
	  ...
	  var getTime = function(element) {
		  ...
		  part = element.firstChild.nodeValue.split(":");
			...
			// FÃƒÆ’Ã‚Â¼hrende Nullen entfernen
		  for(j=1; j<3; j++) {
 ...
 _generate_report : function() {
	 ...
	 if(/tribalwars.se/.test(location.host)) {
		 ...
		 time = new Date("20"+tmp[3], parseInt(tmp[2])-1, tmp[1], tmp[4], tmp[5]).getTime();
			...
			//example: 19.04.08 Ãƒ  17:55
		 var tmp = timeTD.innerHTML.match(/(\d+)\.(\d+)\.(\d+) Ãƒ  (\d+):(\d+)/);
		 time = new Date("20"+tmp[3], parseInt(tmp[2])-1, tmp[1], tmp[4], tmp[5]).getTime();
	 } else {
