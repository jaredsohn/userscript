...
// This plugin adds the proxy domain to outgoing links from journal sites and NCBI PubMed
// (eg, like .ezproxy.lib.unimelb.edu.au).
...
proxyname = ".ezproxy.insert.domain.for.your.institution.here"
