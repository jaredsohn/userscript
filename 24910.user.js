...
// @name		Travian: Resource++ v3 الموارد بالعربي - ترفيان 
...
case '.ae':
		langfile[lang]=['المـطلوب للإرتـقاء','سـيـفيـض بعد', 'يـستـنـفـذ','مقيــاس المــوارد','مـقيـاس المـوارد بالنـِسـب', 
		' ســاعة' ,'تكتــمال المـوارد اليــوم في ',"سـتـكتــمال المـوارد غـداً في ", "اكتـمال المـوارد في ", 
		" أيـام في " , " بـعد اقصى مـدة : " , "المخـزون : ","مـدة الإنـتـظار ","لديـك عـجـز بـمقـدار " ,"الـبـاقـي بعد الإرتـقـاء"," أقصـى مـدة ","لن يـبـقى في المخـزن شـيـئ",
		"تـقـلـص الـفائـض : ","إرتـقاء "," إنـتـاج المــوارد" ," محايد ", "تـوسـيـع مـخازن السلـع" , "تـوسـيـع مـخازن الحبـوب"];		
		break;
