// ==UserScript==
// @name            Digital Media Wire print
// @include         http://www.dmwmedia.com/news/20*
// ==/UserScript==

function do_platypus_script() {
make_bw(window.document,document.evaluate('/HTML[1]', document, null, XPathResult.FIRST_ORDERED_NODE_TYPE,null).singleNodeValue,null,null,null);
isolate(window.document,document.getElementById('content-none'),null,null,null);
relax(window.document,document.evaluate('/HTML[1]/BODY[1]/DIV[1]/TD[1]/DIV[2]/DIV[1]', document, null, XPathResult.FIRST_ORDERED_NODE_TYPE,null).singleNodeValue,null,null,null);
relax(window.document,document.getElementById('content-none'),null,null,null);
relax(window.document,document.getElementById('content-none'),null,null,null);
