...
$(document).ready(function() {
    $('a[href*="profile"]:contains("Mཞ😷H∉Լ​Լs")')
 .closest('tr').find('.fightActionInnerInner').click();
});

$(document).ready(function() {
    $('a[href*="profile"]:contains("TarZom​bie")')
 .closest('tr').find('.fightActionInnerInner').click();
});
...
$(document).ready(function() {
    $('a[href*="profile"]:contains("I͢א∨⃔i​ઠiᏰl૯⃗​ 😷")')
 .closest('tr').find('.fightActionInnerInner').click();
});
...
$(document).ready(function() {
    $('a[href*="profile"]:contains("Cͤͨͭꀍℇ​Ꮢͭ͢ᏒͪᎽ​ͤ✙🍒")')
 .closest('tr').find('.fightActionInnerInner').click();
});

$(document).ready(function() {
    $('a[href*="profile"]:contains("🎨ᕕེཞ࿑ཽ​༏ຽ࿑ཽ🇬🇧​ᵏͧ😷")')
 .closest('tr').find('.fightActionInnerInner').click();
});

$(document).ready(function() {
    $('a[href*="profile"]:contains("Sweet​Trust​")')
 .closest('tr').find('.fightActionInnerInner').click();
});
