...
// @name           omFarming Machine for Travian 3.6

// @author         OptimusS (update from pixelgeek)

// @namespace	   FM

// @description    Updated Version from the Version by pixelgeek (Adapted to the new Travian Layout) and added new timer while we waiting

// @include        http://173.45.86.130/s2/build.php?*gid=16*

// @include        http://173.45.86.130/s2/build.php?*id=39*

// @include        http://173.45.86.130/s2/a2b.php*

// @include        http://173.45.86.130/s2/karte.php*

// @include        http://173.45.86.130/s2/berichte.php*
...
var SCRIPT = {
	...
	url : 'http://userscripts.org/scripts/source/67654.user.js',
...
var messageWindowTop = 400;		//0 means top of the browser window
...
function timer(pause){
	tp = Math.floor(pause / 1000);

	document.getElementById('pause').innerHTML = tp;
	newPause = pause-1000;
	if(newPause > 0) { setTimeout( function(){ timer(newPause); }, 1000); }
}
...
try{
	...
	if (newList.length == 0) { //Village Change is not possible, Engine is pause for X sec
		...
		pause = Random(60000, 600000);

		messageStr = T('NO_VILLAGE') + " " + T('WAITING') + " <b>~<span id='pause'></span></b> " + T('SEC') + " "
		setTextMessage("", messageStr);
		timer(pause);
