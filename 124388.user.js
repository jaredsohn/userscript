    // ==UserScript==
    // @name                4chon Post Hider modification
    // @namespace   4chon Post Hider
    // @description An extention for 4chon. May be compatible with other Tinyboard based imageboards. Version .1beta. Revised:9/29/11
    // @include             *4chon.net/*
    // @exclude             *4chon.net/mod.php?/*
    // ==/UserScript==
    // ==Authors==
    //              Wriggle !!wvZ72pdJVA
    //              TheGent
    //      Barely modified by RMM
    //==License==
    ...
    function jQueryLoaded() {
            ...
            */
            ...
            preparePage = function () {
                ...
                var ConfigBox = "<div class='ConfigBox' style ='border: 0px solid; position: absolute; top: 45px; right:0px'>";
                ...
                ConfigBox += "<span class='heading'>Filter by content</span>";
                ConfigBox += "<em>Seperate values with a semi-colon.</em></center>";
                ...
                ConfigBox += "</table>";
                ConfigBox += "<center><a class='filter' href=''>Apply Filter</a><i> (Reload)</i></center>";
                ConfigBox += "</div>";
     
                // Another config tab
                ConfigBox += "<div id='tab2' class='config_section'>";
                ConfigBox += '<a class="flush" href=""><center>[Flush]</center></a> <br><i>(Unhides all hidden posts and resets all filters)</i>';
                ConfigBox += "</div>";
     
                // Another config tab
                ConfigBox += "<div id='tab3' class='config_section'>";
                ConfigBox += "<marquee>Ã¯Â½Â·Ã¯Â¾ÂÃ¢ÂÂÃ¢ÂÂ<blink>(Ã¯Â¾ÂÃ¢ÂÂÃ¯Â¾Â)</blink>Ã¢ÂÂÃ¢ÂÂ !!!!!</marquee>";
                ConfigBox += "</div>";
                ConfigBox += "</div>";
     
                // Links to the tabs themselves
                ConfigBox += "<ul class='tabs' style='float: left;list-style: none; padding: 0px; position: absolute;top: 0px; right:10px'>";
