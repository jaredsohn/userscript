...
// ==UserScript==
// @name            experienceproject-blog
// @namespace       Platypus
// @include         http://*.blogs.experienceproject.com/
// @description     Uses wide layout for experienceproject.com blogs.
// @date            18 April 2010
...
isolate(window.document,document.evaluate('/HTML[1]/BODY[1]/DIV[3]/DIV[2]/DIV[1]/DIV[1]/DIV[1]/DIV[1]/TABLE[1]/TBODY[1]/TR[1]/TD[1]/DIV[12]', document, null, XPathResult.FIRST_ORDERED_NODE_TYPE,null).singleNodeValue,null,null,null);

relax(window.document,document.evaluate('/HTML[1]/BODY[1]/DIV[1]/DIV[1]', document, null, XPathResult.FIRST_ORDERED_NODE_TYPE,null).singleNodeValue,null,null,null);

set_style_script(window.document,document.evaluate('/HTML[1]/BODY[1]/DIV[1]/DIV[1]', document, null, XPathResult.FIRST_ORDERED_NODE_TYPE,null).singleNodeValue,"height: 1200px;",null,null);
