// ==UserScript==
// @author		l2oli
// @name        	Hun Elit Unit Sebzés Jelentő
// @version		0.1.4
// @uso:version 	0.1.4
// @include		http://*erepublik.com/*
// @description    	eRepublik Sebzés Jelentő a Hun Elit Unit részére
// ==/UserScript==

var VERSION = "0.1.4";
var FORM_URL = "https://docs.google.com/spreadsheet/viewform?hl=hu_HU&formkey=dHZJcHZxSkM1eFJCWS1YMnJDaTZIUnc6MQ#gid=0";
...
var LOCALE = {
	hu: function() {
		return {
			locale: "hu_HU",
			no_damage: "Legalább 1 ellenfelet meg kell ölnöd a jelentés elküldéséhez!",
			send_report: "El szeretnéd küldeni a sebzésed?",
			report_sent: "A jelentés elküldése folyamatban. OK-ézd le ezt az ablakot és várd meg amíg az új ablak be nem töltődött teljesen!",
			round_end: "A kör véget ért. El szeretnéd küldeni a sebzésed?",
			report: "Jelentés"
		};
	},
	en: function() {
...
function BattlePage() {
	...
	var fieldsMap = {
		eday: "entry.0.single",
                name: "entry.2.single",
                oneq6hit: "entry.26.single",
                damage: "entry.4.single",
                allq6hit: "entry.27.single",
                usedq6hit: "entry.28.single",
                wellness: "entry.25.single",
                foodfight: "entry.18.single",
                next100ff: "entry.19.single",
                side2fight: "entry.21.single",
                leftcounter: "entry.15.single",
                wall: "entry.8.single",
                rightcounter: "entry.13.single",
				round: "entry.12.single",
                time: "entry.17.single",
                battle: "entry.10.single",
                battlelink: "entry.23.single",
		donate: "entry.6.single",
		version: "entry.1.single"
	};
	...
	this.createReportObject = function() {
		...
		var data = {
				...
				eday: ereptime_d + " | " + ereptime_m + " - " + ereptime_h,
...
var main = function() {
	...
	$.find("#logo").append(
		...
		'<div style="font-weight: bold">Hun Elit Unit Sebzés Jelentő<i> ' + VERSION + ' </i></div>' +
		//'<b>Szerző: </b>l2oli<br />' +
