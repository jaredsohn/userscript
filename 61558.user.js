...
var SCRIPT = {
	...
	version : '1.2.2.1' //same value as @version
...
var messageWindowTop = 200;		//0 means top of the browser window

var messageWindowLeft = 200;	//0 means left most point of the browser window

var zIndex = 100;				//make it as big as you want to put the message window over top of anything

//Waiting times

var minWait = 2000; 			//Don't make it smaller then 2000ms!
