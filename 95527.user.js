// ==UserScript==
// @name           Masowa Rekrutacja St Att Swiat 8
// @description    Advanced Massrecruitment
// @author         Michael Richter
// @namespace      http://osor.de/
// @include        http://pl*.plemiona.pl/game.php?*mode=mass*
...
// GER:  Modifikationen und Weiterverbreitung dieses Scripts benĂśtigen die
...
(function(){
	...
	var lang = {
		...
		'de': {
			'settings': 'Einstellungen fĂźr Gruppe',
			'troupsize': 'GewĂźnschte TruppenstĂ¤rke:',
			'troupsizedesc': 'Die gewĂźnschte Menge fĂźr das fertige Dorf (nicht die Menge, die pro Durchgang gebaut werden soll).',
			'openend': 'Weiter bauen:',
			'openenddesc': 'Wenn die gewĂźnschte TruppenstĂ¤rke erreicht wurde, wird weiter gebaut, bis der BH voll ist.',
			'farmfree': 'BH-PlĂ¤tze frei lassen:',
			'farmfreedesc': 'Wie viel BH-PlĂ¤tze sollen frei gelassen werden (z.B. 100 fĂźr ein AG).',
			'resfree': 'Rohstoffe Ăźbrig lassen:',
			'resfreedesc': 'Wie viel Rohstoffe sollen mindestens Ăźbrig bleiben.',
			'save': 'Speichern',
			'fill': 'AusfĂźllen',
			'recruit': 'Rekrutieren',
			'running': 'lĂ¤uft...',
			'troupneeds': '(Wunschtruppe benĂśtigt %1 Arbeiter)',
			'filled': 'AusgefĂźllt: %1 in %2 DĂśrfern',
			'settoobig': 'Die Einstellungen fĂźr die Massenrekrutierung sind zu groĂ� um in einem Cookie gespeichert zu werden. Es kann daher zu Problemen kommen. Das LĂśschen einiger Gruppen kann das Problem lĂśsen.'
		}
	};
	...
	var h3 = ce('h3');
	h3.textContent = lang[curlang]['settings'] + ' Âť'+selectedgroup+'ÂŤ';
