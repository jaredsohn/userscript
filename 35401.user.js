...
if(bilder[i].src.match(/\/zider11\/3.jpg/)) {bilder[i].src="http://i41.tinypic.com/2l8hso0.png ";bilder[i].width="220";bilder[i].height="300";}
}
//HANDGELE
for(var i=0;i<bilder.length;i++) {
if(bilder[i].src.match(/\/handgele\/3.jpg/)) {bilder[i].src="http://i41.tinypic.com/2yuluh5.jpg ";bilder[i].width="220";bilder[i].height="300";}
}
//FANNY65
for(var i=0;i<bilder.length;i++) {
...
//TORPEJINTA
for(var i=0;i<bilder.length;i++) {
if(bilder[i].src.match(/\/torpejinta\/3.jpg/)) {bilder[i].src="http://i40.tinypic.com/30xfsxi.jpg";bilder[i].width="220";bilder[i].height="300";}
}
//RINAH85
for(var i=0;i<bilder.length;i++) {
...
akt.innerHTML = akt.innerHTML +'<br><img src="http://i41.tinypic.com/qy7s4p.png">'
...
if(fonts[i].innerHTML=="Borgermester"){fonts[i].innerHTML='<img src="http://i44.tinypic.com/jfucg7.png">';
