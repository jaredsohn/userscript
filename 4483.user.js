...
s+= "body {background:url(http://i48.photobucket.com/albums/f208/___nick/hawaii/100_0596.jpg) white fixed;background-attachement:fixed;backgroud-position:center center;background-repeat:repeat-y;margin-top:-110px;}\n";
s+= "div, table,tr,td, th,table table table, .heading{background:transparent!important; border:none!important;}\n";
s+= "*{font-family:verdana;font-size:10px;color:black!important;}\n";
...
s+= ".section {border:1px solid #33ff00!important;-moz-border-radius:10px;background-color:white!important;padding:2px;}\n";
s+= ".heading, #splash_coolNewPeople h5.heading, .mar5 strong {font:bold  verdana!important;color:33ff00;border:none!important;-moz-border-radius:10px;display:inline;padding:0!important;background-color:!important;}\n";
...
s+= "#home_additionalLinks,#home_setHomePage, #home_userURLInfo,#home_schools, #home_searchAddressBook,#squareAd, iframe, #footer,a[href*="=coolnewpeople"], {display:none} a[href*='invite.history']{display:none}\n";
