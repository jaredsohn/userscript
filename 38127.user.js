...
// @description   Travian Attack Builder by m4rtini - fixed by bluelovers, modified by wojtek858, nerdrobin and skibumstevo, tester Script by fanatiCanz for Indonesian Languange fanaticanz/dot/wordprees/dot/com
...
break;
	...
	case "id"://by:fanatiCanz
		text = ["TEsss=)","Invalid attack type!","No cords!","not enough troops! (Troop #","No troop input","Starting","Probably bad cords","No scout units","Done","Wave setup:","Add new wave","Reset","Attack setup:","Attack type:","Normal","Reinforcement","Raid","Scout Res/Troops","Scout Def/Troops","Cords","Whoop some ass! =)","Arrival time","Arrive at:","Set timed arrival","Number of attacks of that specific wave","with '|' ex: 0,0|1,1","ERROR:","Unable to get active village. Assuming one village account","Timed arrival set at:","Time between waves in ms: (default 10000) "];
