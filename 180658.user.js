// ==UserScript==
// @name			Ask.fm Auto Like ask fm By MR MZMZ
// @namespace       @Abduallh77
// @version			2.3
// @copyright		http://ask.fm/Abduallh77
// @description		Auto Like Ask.fm 25 likes 
// @author			(http://fb.com/nabool.ae.1)
// @include		http://ask.fm/*
...
// Ask.fm Auto Like ask fm By MR MZMZ
// Version 2.3
// هذا السكربت من تصميم @Abduallh77 
 // fb.com/nabool.ae.1
// ==/UserScript==
// ==Profile==
body = document.body;
if(body != null) {
	...
	div.innerHTML = "<center> <a href='/NaboolAe557' title='Nabool Ae ♥ '><img src='http://im40.gulfup.com/pTgtl.gif'  align='absmiddle' /></a>"
	...
	div2.innerHTML = "<center> <a href='http://fb.com/nabool.ae.1' title='Nabool Ae ♥ '><img src='http://im37.gulfup.com/Gq1Pr.png'  align='absmiddle' /></a> "
	...
	div3.innerHTML = "<center> <a href='/NaboolAe557' title='Syria ♥'><img src='http://static.tumblr.com/yu2orom/P2Vlyxtt7/j-566.png'  align='absmiddle' /></a> "
	...
	for(i=1;i<=20;i++) {
		...
		div2.innerHTML = "<center> <a href='http://fb.com/nabool.ae.1' title='MR.MZMZ ♥ '><img src='http://im33.gulfup.com/8XpXY.png'  align='absmiddle' /></a>"
		}
		else {
