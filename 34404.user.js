...
// ==UserScript==
// @author      I dont dont know
// @email	xnetcode@ymail.com
// @aemail 
// @namespace	http://userscripts.org/
// @name		Travian Task Queue 1 ِarabic , test
// @description	تجربه اللغه العربية
...
case "ae": //by hussi
try{
aLangBuildings = ["", "الحطاب", "حفرة الطين", "منجم الحديد", "حقل القمح", "معمل النشارة", "مصنع الطوب", "مسبكة الحديد", "طاحونة", "مخبز", "مخزن", "مخزن الحبوب", "الحداد", "مخزن الأسلحة", "ساحة البطولة", "المبنى الرئيسي", "نقطة التجمع", "السوق", "السفارة", "ثكنة", "إسطبل", "المصانع الحربية", "الأكاديمية", "مخبأ", "البلدية", "السكن", "القصر", "الخزنة", "مكتب التجاري", "ثكنة كبيرة", "إسطبل كبير", "الحاجز روماني", "حاجز جرماني", "حاجز إغريقي", "الحجار", "مصنع الشراب", "الصياد", "قصر الأبطال", "مخزن كبير", "مخزن حبوب كبير", "معجزة العالم"];
aLangTasks = ["بناء", "تطوير", "هجوم", "بحث", "تدريب","أرسل مواد"];
aLangStrings = ["بناء لاحقا", "تطوير لاحقا", "هجوم لاحقا", "بحث لاحقا", "جدول هذه المهمة لاحقا.", "بدأ البناء ", " تمت المحاولة دون نتيجه معلومه.", "مستوى", " لا يمكن البناء.", " لا يمكن التطوير.", "تمت جدولة المهمة.", "الإنتاج الحالي:", "لا يمكن جدولة هذه المهمة الآن.", "الجدولة غير متاحه!", "مهمة مجدولة", "حذف", "أرسل لاحقا", "لم تحدد القوات.", "تم إرسال قواتك إلى", "لا يكن إرسال القوات", "مساعدة", "هجوم", "نهب", "المنجنيق سيقصف", "عشوائي", "على", "أو بعد", "ثانية", "دقيقة", "ساعة", "يوم", "التجسس على المواد و القوات", "التجسس على القوات و تحصينات", "غائب", "لايمكن جدولة المهمة لأنك لم تحدد الإحدائيات.", "على الموقع رقم.", "رتب حسب:", "النوع ", "الوقت ", "الهدف ", "خيارات ", "القرية ","صفط هذه المهام"];
aLangTroops[0] = ["جندي أول", " حراس الإمبراطور", "جندي مهاجم", "فرقة تجسس", "سلاح الفرسان", "فرسان القيصر", "الكبش", "المقلاع الناري", "حكيم", "مستوطن", "بطل"]; //الرومان
...
aLangTroops[2] = ["الكتيبة", "مبارز", "المستكشف", "رعد الجرمان", "فرسان السلت", "فرسان الكاهن", "محطمة الأبواب الخشبية", "المقلاع الحربي", "رئيس", "مستوطن", "البطل"]; //الإغريق
}catch(Error){
printMsg("The ae language is not Correct. Check The traduction");
}
break
