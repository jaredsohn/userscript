// ==UserScript==
// @name           CnC: Tiberium Alliances Info - Extension
// @author         TheStriker (Original), pizzaani (Extension)
            ...
            if (inputField != null || s == "M") {
              ...
              if (ev.altKey && !ev.altGraphKey && !ev.ctrlKey && !ev.shiftKey && s == "Y") {
                ...
                //  console.log("Type: " + i + " Count: " + info[i]);
                  ...
                  for (var key in apc) {
                    c = apc[key];
                    txt += c.get_LvlOffense().toFixed(2).slice(-5) + "\t";
                    txt += c.get_LvlDefense().toFixed(2).slice(-5) + "\t";
                  }
                  alert(txt);
              }
            }
