...
// @description    Türkçe Araçlar EmRe ArsLan ('AnaDoLuasLanI')
...
var MAP_DELAY = 1500;
var DISABLE_POST_KNIGHT_SKILLS = true;
var DISABLE_POST_DEFENSES = true;
...
//logit ('g_timeoff: '+ unsafeWindow.g_timeoff);
  ...
  var styles = '.xtab {padding-right: 5px; border:none; background:none; white-space:nowrap;}\
    .Düsman td { background:#FF4040; }.Dost td{background:lightblue; }.Kendin td{background:royalblue; }\
    .Normal td { background:#C8C8C8; }.unaligned td { background:gold; }\
...
//logit ( 'Options.ptWinPos: '+ inspect (Options.ptWinPos, 5, 1)); 
  ...
  AddMainTabLink('DiJiTooLs  ', eventHideShow, mouseMainTab);
}
...
var knightRoles = [
  ['Ustabasi', 'politics', 'Siy'],
  ['Maresal', 'combat', 'Çar'],
  ['Simyaci', 'intelligence', 'Zek'],
  ['Kahya', 'resourcefulness', 'Bec'],
];
...
<TABLE CLASS="MYTABLE" CELLPADDING=0 CELLSPACING=0>\
    <CAPTION CLASS="MYTABLE">Sehir ArmaLari</CAPTION>\
    \
    <THEAD >\
      <TR CLASS="MYTABLE">\
        <TH CLASS="MYTABLE">Sehir 1</TH>\
        <TH CLASS="MYTABLE">ArMa 1</TH>\
        <TH CLASS="MYTABLE">ArMa 2</TH>\
        <TH CLASS="MYTABLE">ArMa 3</TH>\
      </TR>\
    </THEAD>\
    \
    <TBODY>\
      <TR CLASS="MYTABLE">  \
        <TD CLASS="MYTABLE">Sehir 2</TD>\
        <TD CLASS="MYTABLE">Seviye 7 ('+Seed.player.title+')</TD>\
        <TD CLASS="MYTABLE">Arkadas ('+Seed.appFriends.length+')</TD>\
        <TD CLASS="MYTABLE">&nbsp;</TD>\
      </TR>\
   \
      <TR CLASS="MYTABLE">  \
        <TD CLASS="MYTABLE">Sehir 3</TD>\
        <TD CLASS="MYTABLE">4 Bor ('+bor+')</TD>\
        <TD CLASS="MYTABLE">2 Ector ('+ector+')</TD>\
        <TD CLASS="MYTABLE">1 Kay ('+kay+')</TD>\
      </TR>\
   \
      <TR CLASS="MYTABLE">  \
        <TD CLASS="MYTABLE">Sehir 4</TD>\
        <TD CLASS="MYTABLE">4 Kays ('+kay+')</TD>\
        <TD CLASS="MYTABLE">3 Bedivere ('+bedivere+')</TD>\
        <TD CLASS="MYTABLE">1 Gawain ('+gawain+')</TD>\
      </TR>\
      <TR CLASS="MYTABLE">  \
        <TD CLASS="MYTABLE">Sehir 5</TD>\
        <TD CLASS="MYTABLE">4 Percival ('+percival+')</TD>\
        <TD CLASS="MYTABLE">3 Galahad ('+galahad+')</TD>\
        <TD CLASS="MYTABLE">2 Lancelot ('+lancelot+')</TD>\
      </TR>\
      <TR CLASS="MYTABLE">  \
        <TD CLASS="MYTABLE">Sehir 6</TD>\
        <TD CLASS="MYTABLE">4 Arthur ('+arthur+')</TD>\
        <TD CLASS="MYTABLE">3 Morgana ('+morgana+')</TD>\
        <TD CLASS="MYTABLE">2 Mordred ('+mordred+')</TD>\
        </TBODY>\
  </TABLE>\
\
...
//    t.show ();
  ...
  show : function (){
    ...
    m = '<CENTER>'+ strButton20('SIFIRLA', 'id=ptwref') +'</center><TABLE cellspacing=0 cellpadding=0 class=ptTabPad align=center>';
    for (var c=0; c<Cities.numCities; c++){
      ...
      if (matTypeof(cWilds) != 'array') {
        m += '<TR style="background-color:white; font-weight:bold;" align=right><TD align=left>Bozkir Tipi</td><TD></td><TD align=left>Koord</td><TD>Tuzak</td><TD align=left>P.Askerler</td>\
         <TD width=15></td><TD colspan=3 class=entry>'+ htmlTitleLine(' DEFANS SAVUNMASI ') +'</td></tr>';
        ...
        for (i=0; i<sortem.length; i++){
          ...
          m += '<TR align=right'+ (row++%2?'':' class=ptOddrow') +'><TD align=left>'+ wildNames[wild.tileType] +'</td>\
            ...
            <TD></td><TD align=left class=ptentry><B>Tuzak Kur:</b> <INPUT onchange="ptInpWildTraps(this)" id=ptwt_'+ c +'_'+ i 
        ...
        m += '<TR><TD colspan=6></td><TD class=ptentry align=center colspan=3><TABLE><TR><TD width=40% align=left>Harcama: <SPAN id=ptwgc_'+ c +'>0</span></td>\
            <TD width=10%>'+ strButton20("BASLA", 'onclick="ptButWildSet('+ c +')"') +'<TD width=40% align=right>Altin: <SPAN id=ptwgt_'+ c +'>0</span></td></td></tr></table></td></tr>';
      } else {
...
// TODO: Seed.wildDef is null if just aquired     
    ...
    popDiv.innerHTML = '<TABLE class=ptTab width=100% height=100%><TR><TD>\
          <DIV class=ptstat>Defans Egitimi</div>\
          <DIV id=ptWildBuildDiv class=ptDiv style="padding:10px; height:225px; max-height:225px; overflow-y:auto"></div>\
          </td></tr><TR><TD align=center>'+ strButton20('IPTAL', 'id=ptWildCancel') +'</td></tr></table>';
  ...
  processQue : function (errMsg){
    ...
    if (what[0] == 'T'){
      div.innerHTML += 'Insa Ediliyor '+ what[2] +' Tuzak | Sehir '+ Cities.byID[t.buildList.cityId].name +'\ Bozkir Koord. '+ wild.xCoord +','+ wild.yCoord +' ... ';
      t.postBuyTraps (t.buildList.cityId, what[1], what[2], t.processQue);
    } else {
      div.innerHTML += 'Askerler Ayarlaniyor | '+ mercNames[what[2]] +' Sehir = '+ Cities.byID[t.buildList.cityId].name +'\ Bozkir Koord. '+ wild.xCoord +','+ wild.yCoord +' ... ';
  ...
  show : function (){
    ...
    for (var c=0; c<Cities.numCities; c++) {
      ...
      m += '<TR><TD colspan=13><DIV class=ptstat>'+ Cities.cities[c].name +'</div></td></tr>\
          <TR class=ptwpad style="font-weight:bold" align=right><TD width=70>Rol</td><TD width=160 align=center>Ad</td><TD width=26>Siy</td><TD width=26>Çar</td>\
          <TD width=26>Zek</td><TD width=26>Bec</td><TD width=90 align=center colspan=5>--- Atanmamis ---</td><TD width=40 align=right> Harcama </td><TD width=35>Seviye</td></tr>';
      totSalary = 0;
      var did = {}; 
      var row = 0;
      ...
      m += '<TR align=right><TD colspan=11><B>Toplam Harcama:</b></td><TD>'+ addCommas(totSalary) +'</td></tr>';        
    }
...
//logit (inspect (rslt, 1, 1));        
    ...
    function displayReports (ar, playerNames, allianceNames, cityNames, totalPages){
      ...
      if (matTypeof(ar) != 'array') {
        ...
        msg.push("<thead><tr><td width=105>Tarih</td><td width=40>Tür</td><td width=150>SaLdıRan</td><td>Target</td><td>G0rünTüLe</td></tr></thead><tbody>");
...
//          msg.push(rpt.marchReportId);
          ...
          msg.push(");return false;'>GoRünTüLe</a></div></td></tr>");
        }
      ...
      for(i=0; i < Cities.numCities; i++) {
        ...
        row[i] = rp[1] - usage;
          ...
          if (timeLeft<0){
                ...
                msg += ' is low on food. Remaining: '+addCommasWhole(foodleft)+' ('+timestrShort(timeLeft)+') Tuketim: '+addCommas(usage);
                sendChat ("/a " + msg);
          }
      }  
...
var TowerAlerts = {
  ...
  viewImpending_hook : function (atkinc){    
    ...
    if (!isFalse){
      ...
      d.innerHTML = '<BR><TABLE><TR><TD><a id=towerPostToChat class=button20><span>Ittifak Sohbetine Gonder.</span></a></td></tr></table>';
      div.appendChild (d);
...
Tabs.AllianceList = {
  ...
  init : function (div){
    ...
    var m = '<DIV class=ptentry><TABLE width=100% cellpadding=0>\
		...
		<TR><TD class=xtab>YADA: </td><TD class=xtab align=right> List alliances: &nbsp;</td>\
		    <TD class=xtab><INPUT align=left id=idMyAllSubmit type=submit value="Ittifakim"/>\
            <INPUT align=left id=allListSubmit type=submit value="Ittifak LisTesi" /></td></tr>\
  ...
  eventPlayerSubmit : function (){
    ...
    t.pName = name;
    if (name.length < 3){
      document.getElementById('ptplayErr').innerHTML = 'En Az 3 Karakter Girin...';
      return;
    }
  ...
  eventGotPlayerList : function (rslt){
    ...
    var m = '<DIV class=ptstat>Showing players matching <B>"'+ t.pName +'"</b></div>\
      ...
      <TABLE width=95% align=center class=ptTab cellspacing=0><TR style="font-weight:bold"><TD>İsim</td>\
      <TD align=right>KudReT</td><TD> &nbsp;Facebook &nbsp; </td><TD width=75%>BiLGiLeR </td></tr>';
    var row=0;
    var cl='';
    for (k in rslt.matchedUsers){
      ...
      m += '<TR '+ cl +'valign=top><TD>'+ u.genderAndName +'</td><TD align=right>'+ addCommasInt(u.might) +'</td>\
          ...
          <TD><SPAN onclick="PTpd(this, '+ u.userId +')"><A>DeTaYLaR</a> &nbsp; <BR></span><SPAN onclick="PTpl(this, \''+ u.userId +'\')"><A>SayI TahtasI</a></span> &nbsp; <BR></span><SPAN onclick="PCpo(this, \''+ u.userId +'\')"><A>DuRum</a></span>&nbsp; <BR></span><SPAN onclick="PCplo(this, \''+ u.userId +'\')"><A>Son Giris</a></span></td></tr>';
    }
    m += '</table></div>';
  ...
  gotPlayerLeaderboard : function (rslt, span){
    ...
    if (rslt.totalResults == 0){
      span.innerHTML = '<B>saYI TahTasI:</b> BuLunamaDI.! (misted?)';
      return;
    }
    ...
    m = '<TABLE cellspacing=0 class=ptTab><TR><TD><B>SaYI TaHTasI: </b></td><TD colspan=2> Güç: '+ p.might  +' &nbsp; ittifak: '+ an +'</td></tr>'; 
    for (var i=0; i<p.cities.length; i++){
      var c = p.cities[i];
      var created = '';
      if (c.dateCreated && c.dateCreated.substr(0,2)=='20')
        created = ' &nbsp; &nbsp; created: ' + c.dateCreated.substr(0,10);
      m += '<TR><TD align=right><B>Sehir #'+ (i+1) +':</b></td><TD> &nbsp; '+ c.cityName 
      +' (<a onclick="ptGotoMap ('+ c.xCoord +',' +c.yCoord+ ')">'+ c.xCoord +','+ c.yCoord +'</a>)</td><TD width=75%> &nbsp; Seviye: '
  ...
  gotPlayerDetail : function (rslt, span){
    ...
    var m = '<TABLE cellspacing=0 class=ptTab><TR><TD><B>Detaylar:</b> &nbsp; </td><TD>Alliance: '+ a +' &nbsp; SehirLer: '
          + u.cities +' &nbsp; Nufus: '+ u.population +'</td></tr><TR><TD></td><TD>Vilayetler: ';
  ...
  gotPlayerStatus : function (rslt, span,uid){
    ...
    var p = rslt.data;
    if (p[uid] == true) {
      m = '<span style="color:green"><b>Oyunda(AcIk)!</b></span>';
    } else {
       m = '<span style="color:red"><b>Oyunda Degil(KapalI)!</b></span>';
    }  
    span.innerHTML = m + '';
  },
  ...
  gotPlayerLastLogin : function (rslt, span){
    ...
    if (lastLogin) {
      m = '<span style="color:blue">Son Giris: '+lastLogin+'</span>';
    } else {
       m = '<span style="color:red">Giris Yok: '+lastLogin+'</span>';
    }  
    span.innerHTML = m + '';
  },
  ...
  eventSubmit : function (){
    ...
    if (t.aName.length < 3){
      document.getElementById('ptallErr').innerHTML = 'En Az 3 Karakter Girin';
      return;
    }
  ...
  eventGotAllianceList : function (rslt){
    ...
    var m = '<DIV class=ptstat>GosTeRiLiYoR <B>"'+ t.aName +'"</b></div>\
    <TABLE><TR style="font-weight:bold"><TD class=xtab>Ittifak Adi</td><TD class=xtab>Sira</td><TD class=xtab>UYeLer</td>\
        <TD align=right class=xtab>KuDReT</td><TD class=xtab>DipLomasi</td><TD class=xtab></td></tr>';
    for (k in rslt.alliancesMatched){
      ...
      m += '<TR><TD class=xtab>'+ all.allianceName +'</td><TD align=right class=xtab>'+ all.ranking +'</td><TD align=right class=xtab>'+ all.membersCount +'</td>\
       ...
       <TD class=xtab><a onclick="PTgetMembers('+ all.allianceId +')">UYeLeRi GoRünTüLe</a></td></tr>';
    }
    document.getElementById('allListOut').innerHTML = m;
  },
  ...
  eventGotOtherAlliancePage : function (rslt){
    ...
    var m = '<div style="overflow:auto; height:556px;width:564px;"><TABLE><thead><TR style="font-weight:bold"> \
        <th class=xtab>Ittifak Adi</th><th class=xtab>SıRa</th><th class=xtab>UYeLeR</th>\
        <th align=right class=xtab>Güc</th><th class=xtab>Diplomasi</th><th class=xtab></th></tr></thead><tbody>';
    document.getElementById('allListOut').innerHTML = m;
    ...
    for (var i=0; i<rslt.otherAlliances.length; i++) {
      ...
      m += '<TR class="'+ dip + '"><TD class=xtab>' + alliance.name +'</td><TD align=right class=xtab>'+ alliance.ranking +'</td><TD align=right class=xtab>'+ alliance.membersCount +'</td>\
       ...
       <TD class=xtab><a onclick="PTgetMembers('+ alliance.allianceId +')">UYeLeRi GoRünTüLe</a></td></tr>';
    }
  ...
  reDisp : function (){
    ...
    for (var i=0; i<t.dat.length; i++){
      ...
      m += '<TR style="max-height:30px"><TD class='+ tabclass +'>'+ t.dat[i][0] +'</td><TD align=right class='+ tabclass +'>'+ addCommasInt(t.dat[i][1]) +'</td><TD align=center class='+ tabclass +'>'+ t.dat[i][3] +'</td>\
			...
			<td class='+ tabclass +'><SPAN onclick="PCpo(this, \''+t.dat[i][9] +'\')"><A>DuRum</a></span></td>\
			<td class='+ tabclass +'><SPAN onclick="PCplo(this, \''+ t.dat[i][9] +'\')"><A>Son GiRis</a></span><td> </tr>';
    }
  ...
  displayMembers : function (allName, numPlayers){
    ...
    var m = '<STYLE>.clickable{background-color:#ddd; border:2px outset; border-color:#555; padding-left:5px; padding-right:5px}\
      ...
      <DIV class=ptstat><TABLE id=tabAllMembers cellpadding=0  width=100%><TR font-weight:bold"><TD class=xtab> &nbsp; '+ allName +'</td>\
        <TD class=xtab width=80% align=center>Uzaklik hesaplama <SPAN id=distFrom>'+ Cities.cities[0].name +' ('+ Cities.cities[0].x +','+ Cities.cities[0].y +')</span></td><TD class=xtab align=right>'+ numPlayers +' Oyuncu Bulundu.! &nbsp; </td></tr></table></div>\
      ...
      <TR style="font-weight:bold"><TD id=clickCol0 onclick="PTalClickSort(this)" class=clickable><A><DIV>OYunCu</div></a></td>\
        <TD id=clickCol1 onclick="PTalClickSort(this)" class=clickable align=center><A><DIV>KuDReT</a></div></td>\
        <TD id=clickCol3 onclick="PTalClickSort(this)" class=clickable><A><DIV>SeHiRLeR</a></div></td>\
        <TD id=clickCol2 onclick="PTalClickSort(this)" class=clickable align=center><A><DIV>SıRa</a></div></td>\
        ...
        <TD id=clickCol8 onclick="PTalClickSort(this)" class=clickable><A><DIV>UZaKLik</a></div></td>\
		<TD class=clickable><A><DIV>DuRum</a></div></td>\
		<TD class=clickable><A><DIV>Son GiRis</a></div></td></tr></thead>\
      ...
      <DIV style="top:670px; left:0px; position:static; width:100%;  background-color:#ffffff; border-top:1px solid; margin-top:8px; color:#700; font-weight:bold;">\
        <TABLE width=100%><TR><TD class=xtab>24 SaatDe BiR LİsTe GünCeLLeniYoR.!</td>\
    ...
    document.getElementById('altInput').innerHTML = '<HR><TABLE width=100% cellpaddding=0><TR align=center>\
        <TD class=xtab>Koordinat Gir: &nbsp; X: <INPUT size=2 type=text id=plyrX /> Y: <INPUT size=2 type=text id=plyrY /> &nbsp; Yada SeHiR Seç: <span id=dmcoords></span></td></tr></table>';
...
Tabs.Test = {
  ...
  init : function (div){
    ...
    var m = '<TABLE><TR><TD align=right>Scout: </td><TD><INPUT type=checkbox id=fakeIsScout></td></tr>\
		...
		<TR><TD align=right>Gozcu: </td><TD><INPUT type=text size=6 value=0 id=fakeScout></td></tr>\
		  <TR><TD align=right>MizRakLi: </td><TD><INPUT type=text size=6 value=0 id=fakePike></td></tr>\
		  <TR><TD align=right>SiLaHsoR: </td><TD><INPUT type=text size=6 value=0 id=fakeSword></td></tr>\
		  <TR><TD align=right>OkCu: </td><TD><INPUT type=text size=6 value=0 id=fakeArcher></td></tr>\
		  <TR><TD align=right>SuVaRı: </td><TD><INPUT type=text size=6 value=0 id=fakeCav></td></tr>\
		  <TR><TD align=right>A.SuVaRı: </td><TD><INPUT type=text size=6 value=0 id=fakeHeavy></td></tr>\
		  <TR><TD align=right>M.ARaBa: </td><TD><INPUT type=text size=6 value=0 id=fakeWagon></td></tr>\
		  <TR><TD align=right>BaLisTa: </td><TD><INPUT type=text size=6 value=0 id=fakeBallista></td></tr>\
		  <TR><TD align=right>KocBası: </td><TD><INPUT type=text size=6 value=0 id=fakeRam></td></tr>\
		  <TR><TD align=right>KaTaPuLuT: </td><TD><INPUT type=text size=6 value=0 id=fakeCat></td></tr>\
		  <TR><TD align=right>SaHTe Isim: </td><TD><INPUT type=text size=13 value=THIS_IS_A_TEST id=fakeName></td></tr>\
		  <TR><TD align=right>SeHiR Sec </td><TD>'+citySelect+'</td></tr>\
        <TR><TD colspan=2 align=center><INPUT id=testSendMarch type=submit value="SaHTe aTaK" \></td></tr></table>\
        <INPUT id=ptReloadKOC type=submit value="OYunu YeNiLe" \>\
...
Tabs.Bilgi = {
  ...
  init : function (div){
    ...
    m = '<STYLE>.xtabH {background:#ffffe8; border:none; padding-right: 5px; padding-left: 5px; margin-left:10px; }\
        ...
        <DIV style="height:650px; max-height:650px; overflow-y:auto; overflow-x:hidden"><DIV class=ptstat>BILGILER</div><TABLE align=center cellpadding=1 cellspacing=0>\
        <TR align=center><TD class=xtab></td><TD class=xtabHL colspan=5><B>GeReKeNLeR</b></td><TD class=xtabHL colspan=7><B>BiLGi</b></td><TD class=xtabHL><B>Tuk.</b></td></tr>\
        <TR valign=bottom align=right><TD class=xtab></td><TD class=xtabHL>YYcK</td><TD class=xtabH>KRsT</td><TD class=xtabH>Tas</td>\
        <TD class=xtabH>CvHR</td><TD class=xtabH>NFs</td><TD class=xtabHL>Guc</td><TD class=xtabH>Can</td><TD class=xtabH>Atk</td><TD class=xtabH>Def</td><TD class=xtabH>Hiz</td><TD class=xtabH>Tur</td><TD class=xtabH>Cep.</td>\
        <TD class=xtabHL>YiYeCeK</td></tr>\
    ...
    m += '<TR class=xtabLine><TD colspan=14 class=xtabLine></td></tr>';
    m += '</table>';
    m += '<BR><DIV class=ptstat>UZAKLIK HESAPLAYICI</div><DIV class=ptentry><TABLE align=center cellpadding=1 cellspacing=0>\
      <TR><TD class=xtab align=right><B>1. KoNum: </b></td><TD  class=xtab> X: <INPUT id=calcX type=text\> Y: <INPUT id=calcY type=text\> Yada SeHiR Seç: <SPAN id=ptloc1></span></td></tr>\
      <TR><TD class=xtab><B>2. KoNum: </b></td><TD class=xtab> X: <INPUT id=calcX2 type=text\> Y: <INPUT id=calcY2 type=text\> Or, choose city: <SPAN id=ptloc2></span></td></tr></table>\
      ...
      <BR><BR><DIV class=ptstat>VILAYET HARITASI</div><DIV id=ptProvMap><IMG width=680 height=654 SRC="'+ URL_PROVINCE_MAP +'"></div></center></div>';
    t.cont.innerHTML = m;
...
//    ce.style.top = (off.top+y+provMapCoords.topMargin-eMap.offsetHeight) +'px';      
  ...
  eventLocChanged : function (city, x, y){
    ...
    var m = 'UZaklikHesaplama '+ x1 +','+ y1 +' ile '+ x2 +','+ y2 +' Uzaklik: &nbsp;<B>'+ distance (x1, y1, x2, y2).toFixed(2) +'</b>';
    ...
    try {      
       m = '<TABLE class=ptTab>\
        ...
        <TR><TD><INPUT id=ptEnableFoodWarn type=checkbox /></td><TD>Show \'food left\' in RED if food will run out in less than \
            <INPUT id=optFoodHours type=text size=3 value="'+ Options.foodWarnHours +'"> hours.<BR> THIS ALSO CONTROLS THE FOOD ALERT. CHECK THE BOX TO TURN ON.</td></tr>\
	 ...
	 m += '<TR><TD><INPUT id=alertEnable type=checkbox '+ (Options.alertConfig.aChat?'CHECKED ':'') +'/></td><TD>Automatically post incoming attacks to alliance chat.</td></tr>\
          ...
          <TR><TD align=right>GonderiLecek Mesaj: &nbsp; </td><TD><INPUT id=alertPrefix type=text size=60 maxlength=120 value="'+ Options.alertConfig.aPrefix +'" \></td></tr>\
          <TR><TD align=right>GozCu UYaRisi: &nbsp; </td><TD><INPUT id=alertScout type=checkbox '+ (Options.alertConfig.scouting?'CHECKED ':'') +'/></td></tr>\
          <TR><TD align=right>BozKiR UYaRisi: &nbsp; </td><TD><INPUT id=alertWild type=checkbox '+ (Options.alertConfig.wilds?'CHECKED ':'') +'/></td></tr>\
          <TR><TD align=right>SaLdiRan ALLaince: &nbsp; </td><TD><INPUT id=alertAlliance type=checkbox '+ (Options.alertConfig.includealliance?'CHECKED ':'') +'/></td></tr>\
          <TR><TD align=right>SaLdiRan KuDReT: &nbsp; </td><TD><INPUT id=alertMight type=checkbox '+ (Options.alertConfig.includemight?'CHECKED ':'') +'/></td></tr>\
          <TR><TD align=right>SesLi UYaRi: &nbsp; </td><TD><INPUT id=alertSound type=checkbox '+ (Options.alertConfig.sound?'CHECKED ':'') +'/></td></tr>\
          <TR><TD align=right>Minimum AsKeR: &nbsp; </td><TD><INPUT id=alertTroops type=text size=7 value="'+ Options.alertConfig.minTroops +'" \> &nbsp; &nbsp; <span id=alerterr></span></td></tr>\
          </table></td></tr>';
		  }
...
Tabs.Arama = {
  ...
  init : function (div){
    ...
    this.cont = div;
    this.cont.innerHTML = '\
      <DIV class=ptentry><table><tr><td><TABLE><TR valign=bottom><TD class=xtab width=100 align=right>ARaNaCaK: </td><TD>\
      <SELECT id="srcType">\
        <OPTION value=0>Barbar KampLari</option>\
        <OPTION value=1>BozKiRLaR</option>\
		<OPTION value=2>SeHiRLeR</option>\
       </select></td></td> \
        <td> ViLaYeT:\
        ...
        <tr><td width=100  align=right >Kadran: </td><td><select id="idQuadSelect">\
        <option value="188,188"> KuzeyBati </option>\
        <option value="563,188"> KuzeyDogu </option>\
        <option value="188,563"> GuneyBati </option>\
        <option value="563,563"> GuneyDogu </option>\
      ...
      m = '<TABLE><TR valign=middle><TD class=xtab width=100 align=right>Koord: &nbsp; X: </td><TD class=xtab>\
        <INPUT id=srchX type=text > &nbsp; Y: <INPUT id=srchY type=text > &nbsp; <SPAN id=spInXYold></span>\
        </td></tr><TR><TD class=xtab align=right>MaK. UzakLik: </td><TD style="width: 200px;" class=xtab><INPUT id=srcDist size=3 value=10 /></td>\
        <td></td>\
        </tr>';
...
clickedPlayerDetail : function (span, uid){
  ...
  gotPlayerLeaderboard : function (rslt, span){
    ...
    if (!an || an=='' || p.officerType==4)
      ...
      an += ' ('+ officerId2String(p.officerType) +')';
    m = '<TABLE cellspacing=0 class=ptTab><TR><TD><B>SiRaLaMa: </b></td><TD colspan=2> Guc: '+ p.might  +' &nbsp; Ittifak: '+ an +'</td></tr>'; 
    for (var i=0; i<p.cities.length; i++){
      var c = p.cities[i];
      m += '<TR><TD align=right><B>SeHiR #'+ (i+1) +':</b></td><TD> &nbsp; '+ c.cityName +' '+coordLink (c.xCoord, c.yCoord)+'</td><TD width=75%> &nbsp; SeViYe: '
        + c.tileLevel +' &nbsp; &nbsp; DuRum: '+ cityStatusString (c.cityStatus) +' &nbsp; &nbsp; KuRuLum: ' + c.dateCreated.substr(0,10) +'</td></tr>';
    }  
    span.innerHTML = m + '</table>';
  },
  ...
  gotPlayerDetail : function (rslt, span){
    ...
    if (u.allianceName)
      a = u.allianceName +' ('+ getDiplomacy(u.allianceId) + ')';
    var m = '<TABLE cellspacing=0 class=ptTab><TR><TD><B>DeTaY:</b> &nbsp; </td><TD>IttiFaK: '+ a +' &nbsp; Cities: '
          + u.cities +' &nbsp; NuFus: '+ u.population +'</td></tr><TR><TD></td><TD>ViLaYeTLeR: ';
    var pids = u.provinceIds.split (',');
    var p = [];
    for (var i=0; i<pids.length; i++)
  ...
  gotPlayerStatus : function (rslt, span,uid){
    ...
    var p = rslt.data;
    if (p[uid] == true) {
      m = '<span style="color:green"><b>AciK! (OYunDa)</b></span>';
    } else {
       m = '<span style="color:red"><b>KaPaLi.! (OYunDa_DeGiL)</b></span>';
    }  
    span.innerHTML = m + '';
  },
  ...
  gotPlayerLastLogin : function (rslt, span){
    ...
    if (lastLogin) {
      m = '<span style="color:black">Son GiRis: '+lastLogin+'</span>';
    } else {
       m = '<span style="color:red">GiRis BuLunamaDı: '+lastLogin+'</span>';
    }  
    span.innerHTML = m + '';
  },
...
//End edit city search
  ...
  srchTypeHandler : function (){
    ...
    var m = '<CENTER><B>ARaNaCaK '+ typeName +'<BR>\
        Koord.: '+ t.opt.startX +','+ t.opt.startY +'  &nbsp; UzakLik: '+ t.opt.maxDistance +'<BR></center>\
        <DIV class=ptentry><TABLE cellspacing=0 width=100%><TR align=center><TD class=xtab colspan=10><B>LISTE AYARLARI:</b><BR></td></tr>';
    if (t.opt.searchType == 1 || t.opt.searchType == 0) {
     m += '<TR><TD class=xtab align=right>En KuCuK SeViYe</td><TD class=xtab> <INPUT id=filMinLvl size=2 value='+ Options.srcMinLevel +' /></td></tr>\
        <TR><TD class=xtab align=right>En BuYuk SeViYe:</td><TD class=xtab> <INPUT id=filMaxLvl size=2 value='+ Options.srcMaxLevel +' /></td></tr>';
	}
    if (t.opt.searchType == 1){
      m += '<TR><TD class=xtab align=right>Wilderness Type:</td><TD class=xtab align=right>\
            KeResTeLeR<INPUT id=woodWild type=CHECKBOX'+ (Options.woodWild?' CHECKED':'') +'></td></tr>';
      m += '<TR><TD class=xtab align=right>GöL/CaYiR<INPUT  id=foodWild type=CHECKBOX '+ (Options.foodWild?' CHECKED':'') +'></td>\
	       <TD class=xtab align=right>DaG<INPUT id=mtnWild type=CHECKBOX '+ (Options.mtnWild?' CHECKED':'') +'></td></tr>';
      m += '<TR><TD class=xtab align=right>OVa<INPUT id=plnWild type=CHECKBOX '+ (Options.plnWild?' CHECKED':'') +'></td>\
           <TD class=xtab align=right>TePeLer<INPUT id=hillWild type=CHECKBOX'+ (Options.hillWild?' CHECKED':'') +'></td></tr>';
      m += '<TR><TD class=xtab align=right>SaHiPLi:</td><TD class=xtab><INPUT id=filUnowned type=CHECKBOX '+ (Options.unownedOnly?' CHECKED':'') +'\><td></tr>';
    } 
    if (t.opt.searchType == 1 || t.opt.searchType == 0) {
        m+= '<TR><TD class=xtab align=right>SIRaLa:</td><TD class=xtab><SELECT id=filSortBy>\
          ...
          <OPTION value="dist" '+ (Options.srcSortBy=='dist'?'SELECTED':'')  +'>UzaK</option>\
			</select></td></tr>\
			<TR><TD class=xtab align=right>SaDece Koord. GonDeR:</td><TD class=xtab><INPUT type=checkbox id=coordsOnly \></td></tr>\
			</table></div><BR><SPAN id=srchSizeWarn></span>';
    } else {
        m+= '<TR><TD class=xtab align=right >GosTeR:</td><TD class=xtab align=left ><SELECT style="width: 135px" id=idSrchFilter>\
             <OPTION value=0>SaDeCe SeHiRLeR</option>\
             <OPTION value=1>SaDeCe DusManLaR</option>\
	     <OPTION value=2>SaDeCe SisDeKiLeR</option>\
	     <OPTION value=3>SaDeCe Ittifakim</option>\
	     <OPTION value=4>SaDeCe DosTLaR</option>\
	     <OPTION value=5>SaDeCe NoRmaL</option>\
	     <OPTION value=6>SaDeCe iTTiFaksiz</option>\
             </select></td></tr>';

		m+= '<TR><TD class=xtab align=right >Sort By:</td><TD class=xtab><SELECT style="width: 135px" id=filSortBy>\
          <OPTION value="might" '+ (Options.srcSortBy=='might'?'SELECTED':'')  +'>Guc</option>\
          <OPTION value="dist" '+ (Options.srcSortBy=='dist'?'SELECTED':'')  +'>UzaKLiK</option>\
        </select></td></tr>\
        <TR><TD class=xtab align=right >SaDeCe KooRd. GosTeR:</td><TD class=xtab align=left ><INPUT type=checkbox id=coordsOnly ></td></tr>\
        </table></div><BR><SPAN id=srchSizeWarn></span>';
  ...
  clickedSearch : function (){
    ...
    if (t.searchRunning){
      t.stopSearch ('ARAMA IPTAL EDILDI');
      return;
    }
    t.opt.searchType = document.getElementById ('srcType').value;
    t.opt.startX = parseInt(document.getElementById ('srchX').value);
    ...
    if (isNaN (t.opt.startX) ||t.opt.startX<0 || t.opt.startX>749)
      errMsg = "(X)0 iLe 749 aRasinDa RaKam GiRiNiz.<BR>";
    if (isNaN (t.opt.startY) ||t.opt.startY<0 || t.opt.startY>749)
      errMsg += "(Y)0 iLe 749 aRasinDa RaKam GiRiNiz.<BR>";
    if (isNaN (t.opt.maxDistance) ||t.opt.maxDistance<1 || t.opt.maxDistance>750)
      errMsg += "Mak. UzakLiGi Girin (En FazLa 75)<BR>";
    if (errMsg != ''){
    ...
    if (t.opt.searchType == 1){
      m += '<TR><TD class=xtab align=right>BozKiR TiPi:</td><TD class=xtab><SELECT id=filWildType>';
      m += htmlOptions ( {1:'GoL/CaYiR', 3:'KeResTeLeR', 4:'TePeLeR', 5:'DaG', 6:'OVa', 0:'HePsi'}, Options.wildType );
      m += '</select></td></tr><TR><TD class=xtab align=right>Sahipsiz:</td>\
	...
	if (t.opt.searchType == 1 || t.opt.searchType == 0) {
	  m += '<TR><TD class=xtab align=right>SIRaLa:</td><TD class=xtab><SELECT id=filSortBy>\
            ...
            <TR><TD class=xtab align=right>SaDeCe KoorD. GosTeR:</td><TD class=xtab><INPUT type=checkbox id=coordsOnly \></td></tr>\
            </table></div><BR><SPAN id=srchSizeWarn></span>';
	} else {
	 m += '<TR><TD class=xtab align=right>SeHiR TiPi:</td><TD class=xtab><SELECT id=filCities>';
     m += htmlOptions ( {1:'HePsi', 2:'Ittifakim', 3:'DosT', 4:'DusMan', 5:'NoRMaL', 6:'Ittifaksiz', 7:'SisDeKiLeR'}, Options.cityType );
     m += '</select></td></tr>';		
	 m += '<TR><TD class=xtab align=right>SIRaLi:</td><TD class=xtab><SELECT id=filSortBy>\
			<OPTION value="might" '+ (Options.srcSortBy=='might'?'SELECTED':'')  +'>Guc</option>\
			<OPTION value="dist" '+ (Options.srcSortBy=='dist'?'SELECTED':'')  +'>UZaKLik</option>\
           </select></td></tr>\
		   <TR><TD class=xtab align=right>GosTeriLcek Min. Guc:</td><TD class=xtab><INPUT type=text id=minMight value='+Options.MightSrc+' size=3 \></td></tr>\
           <TR><TD class=xtab align=right>SaDeCe KooRd. GosTeR:</td><TD class=xtab><INPUT type=checkbox id=coordsOnly \></td></tr>\
           </table></div><BR><SPAN id=srchSizeWarn></span>';
	}
...
if (DEBUG_TRACE) logit (" 0 clickedSearch()... setTimeout ..:" + xxx +' , '+ yyy +' , '+ t.mapCallback.name);
  ...
  dispMapTable : function (){
    var tileNames = ['Barbar Kampi', 'Cayir', 'GoL', 'Keresteler', 'Tepeler', 'Dag', 'Ova', 'Sehir' ];
    var t = Tabs.Arama;
...
if (DEBUG_TRACE) DebugTimer.start();
    ...
    for (i=0; i<t.mapDat.length; i++){
	  ...
	  if (t.opt.searchType == 2 && type == 7 ) {
			if (!(Options.cityType == 2) || t.mapDat[i][12] == 'Kendin')
			if (!(Options.cityType == 3) || t.mapDat[i][12] == 'Dost') 
			if (!(Options.cityType == 4) || t.mapDat[i][12] == 'Düsman')
			if (!(Options.cityType == 5) || t.mapDat[i][12] == 'Natural') 
			if (!(Options.cityType == 6) || t.mapDat[i][12] == 'Ittifaksiz') 
...
if (DEBUG_TRACE) DebugTimer.display('SEACHdraw: SORT');
      if (coordsOnly)
        ...
        if (t.opt.searchType == 0) // Barbs
			...
			m = '<TABLE id=srcOutTab cellpadding=2 cellspacing=2><TR style="font-weight: bold"><TD>DuRum</td><TD style="padding-left: 10px">UzaKLik</td><TD style="padding-left: 10px;">SeViYe</td><TD width=80%> &nbsp; Type</td><TD style=""></td></tr>';

		else if (t.opt.searchType == 1) // Wilds
			//m = '<TABLE id=srcOutTab cellpadding=2 cellspacing=2><TR style="font-weight: bold"><TD>DuRum</td><TD style="padding-left: 10px">UzaKLik</td><TD style="padding-left: 10px;">SeViYe</td><TD style="padding-left: 10px;> &nbsp; Type</td><TD width=80%>SaHiPLi</td><TD style=""></td></tr>';
			m = '<TABLE id=srcOutTab cellpadding=2 cellspacing=2><TR style="font-weight: bold"><TD>DuRum</td><TD style="padding-left: 10px">UzaKLik</td><TD style="padding-left: 10px;">SeViYe</td><TD width=10%> &nbsp; Type</td><TD width=70%> &nbsp; SaHipLi</td><TD style=""></td></tr>';
		else // Cities
			m = '<TABLE id=srcOutTab cellpadding=2 cellspacing=2><TR style="font-weight: bold"><TD>DuRum</td><TD >Dist</td><TD>SeHiR</td><TD>SaHipLi</td><TD>Might</td><td>Ittifak</td><TD width=80% style="font-size:9px;">DiGeR BiLGiLeR</td><TD style="padding-left: 10px;"></td></tr>';
        ...
        if (coordsOnly)
          m += '</tr>';
			...
			if (t.opt.searchType == 2) { 
				 ...
				 if (dat[i][5]) {
					m += '<DIV onclick="PTscout('+ dat[i][0] +','+ dat[i][1] +');return false;"><A style="font-size:9px;" >GozCu</a></div>';
				} else 
					m += '<DIV onclick="PTpd(this, '+ dat[i][7] +')"><A style="font-size:9px;" >DetaYLaR</a></div>\
					<DIV style="" onclick="PTpd2(this, '+ dat[i][7] +')"><A style="font-size:9px;">SiRaLaMa</a></div>\
					<DIV style="" onclick="PCpo2(this, '+ dat[i][7] +')"><A style="font-size:9px;">DuRum</a></div>\
					<DIV style="" onclick="PCplo2(this, '+ dat[i][7] +')"><A style="font-size:9px;">Son GiRis</a></div>';
...
if (DEBUG_TRACE) logit (" 3 mapCallback()");
    ...
    document.getElementById('statSearched').innerHTML = 'Aranan: '+ t.tilesSearched;
    t.dispMapTable();
...
Tabs.Egitim = {
  ...
  init : function (div){
    ...
    s = "<DIV id=trainTopSelect>\
      <DIV class=ptstat>Asker Egitimi Ve Defan Insasi </div><DIV style='height:10px'></div><DIV class=ptentry>\
      <DIV style='text-align:center; margin-bottom:10px;'>SeHiR SeC: &nbsp; <span id=ptspeedcity></span></div>\
      <TABLE class=ptTab width=100%><TR valign=top><TD width=50%>\
      <TABLE align=center><TR><TD align=right>AsKer: </td><TD colspan=2>\
      <SELECT id=ptttType>\
        <option value='1'>IKMaL AsKeRi</option>\
        <option value='2'>Milis</option>\
        <option value='3'>GozCu</option>\
        <option value='4'>MizRaKLı AsKeR</option>\
        <option value='5'>SiLaHSoR</option>\
        <option value='6'>OKCu</option>\
        <option value='7'>SuVaRi</option>\
        <option value='8'>AGiR SuVaRi</option>\
        <option value='9'>MaLzeMe ARaBaSi</option>\
        <option value='10'>Balista</option>\
        <option value='11'>KoCBaSi</option>\
        <option value='12'>KaTaPuLuT</option>\
      </select> &nbsp; (max <span id=ptttSpMax></span>)</td></tr>\
      <TR><TD align=right>ToPLam: </td><TD><INPUT id='ptttInpPS' size=5 type='text' value='0'\></td>\
        <TD><INPUT id='ptttButMaxPS' type=submit value='max'\> &nbsp; (max <span id=ptttSpMaxPS>0</span>)</td></tr>\
      <TR><TD align=right>BoL: </td><TD><INPUT id='ptttInpSlots' size=2 type='text' value='1'\></td>\
        <TD width=75%><INPUT id='ptttButMaxSlots' type=submit value='max'\> &nbsp; (max <span id=ptttSpMaxSlots>1</span>)</td></tr>\
      <TR><TD align=right valign=top>Nufus : </td><TD colspan=2><INPUT type=CHECKBOX id=chkPop"+ (Options.maxIdlePop?' CHECKED ':'') +"> \
        <SPAN style='white-space:normal;'>DoLu NuFusLa EGiTim YaP. KIsa SuReLiGine NuFus - oLuR.</span></td></tr>\
      <TR><TD colspan=3 align=center><DIV style='height:10px'></div><INPUT id='ptttButDo' type=submit value='EGiTime BasLa'\></td></tr>\
      </table></td><TD width=20></td><TD style='border-left:solid 2px;' width=50% align=center>\
      <TABLE align=center><TR><TD align=right>Defens TiPi: </td><TD colspan=2>\
      <SELECT id=pttdType>\
        <option value='53'>TaTaR YaYLaRi</option>\
        <option value='55'>MaNCıNıK</option>\
        <option value='60'>TuzaK</option>\
        <option value='61'>BıTıRaK</option>\
        <option value='62'>CiViLi BaRiYeR</option>\
      </select> &nbsp; (<span id=pttdSpMax></span>)</td></tr>\
      <TR><TD align=right>ToPLam: </td><TD><INPUT id='pttdInpPS' size=5 type='text' value='0'\></td>\
        <TD><INPUT id='pttdButMaxPS' type=submit value='max'\> &nbsp; (max <span id=pttdSpMaxPS>0</span>)</td></tr>\
      <TR><TD align=right>BoL: </td><TD><INPUT id='pttdInpSlots' size=2 type='text' value='1'\></td>\
      ...
      <TR><TD colspan=3 align=center><DIV style='height:10px'></div><INPUT id='pttdButDo' type=submit value='İnsaYa BasLa'\></td></tr></table>\
      </td></tr></table></div></div>\
      ...
      <TR><TD width=50% style='padding-left:15px; padding-right:15px'><DIV style='text-align:center'><B>Asker Egitimi &nbsp; (<SPAN id=statTTtot></span>)</b><BR><HR></div><DIV id=divSTleft style='overflow-y: auto; height:210px; max-height:210px'></div></td>\
        <TD width=50% style='padding-left:15px; padding-right:15px'><DIV style='text-align:center'><B>Defans Insaasi &nbsp; (<SPAN id=statDTtot></span>)</b><BR><HR></div><DIV id=divSTright style='overflow-y: auto; height:210px; max-height:210px'></div></td></tr>\
      </div>";
    t.cont.innerHTML = s;
...
/*******  DEF  ******/  
  ...
  doDefQueue : function (cityId, que, errMsg){
    ...
    try {
      ...
      var cmd = que.shift();
      if (!cmd){
        t.dispTrainStatus ('<B>İnSaa BaSaRaLi</b><BR>');
        t.setBusy(false);
        return;
      }
      if (cmd[0] == 'T'){
        ...
        doDefTrain ( cityId, cmd[1], cmd[2], 
          function(errMsg){
            setTimeout(function (){Tabs.Egitim.doDefQueue(cityId, que, errMsg);}, (Math.random()*3500)+1500);
          } );
      }
    } catch (err) {
...
m += '<TABLE class=ptTab width=100%><TR align=center>\
        <TD width=8%><B>Ikmal:</b></td><TD width=8%><B>Milis:</b></td><TD width=8%><B>Gozcu:</b></td>\
        <TD width=8%><B>Mizrakli:</b></td><TD width=8%><B>Silahsor:</b></td><TD width=8%><B>Archer:</b></td>\
        <TD width=8%><B>Suvari:</b></td><TD width=8%><B>A.Suvari:</b></td><TD width=8%><B>Araba:</b></td>\
        <TD width=8%><B>Balista:</b></td><TD width=8%><B>Kocbasi:</b></td><TD width=8%><B>Katapulut:</b></td><tr>';
 ...
 '<TD width=8%>'+Seed.units['city'+cityId]['unt11']+'</td><TD width=8%>'+Seed.units['city'+cityId]['unt12']+'</td><tr></table>';
    ...
    m += '<TABLE class=ptTab width=100%><TR align=center>\
        <TD width=18%><B>Yiyecek:</b></td><TD width=16%><B>Kereste:</b></td><TD width=16%><B>Tas:</b></td>\
        <TD width=16%><B>Cevher:</b></td><TD width=16%><B>Altin:</b></td><TD width=16%><B>Nufus:</b></td></tr>\
...
// troop queue .... 
    ...
    m = t.stats.barracks +' Baraka';
    if (t.stats.queued > 0)
      m += ', '+ t.stats.queued +' Sira';
    if (totTime > 0)
    ...
    try {
      ...
      if (cmd[0] == 'T'){
        ...
        doTrain (cityId, cmd[1], cmd[2], 
          function(errMsg){
           setTimeout(function (){Tabs.Egitim.doQueue(cityId, que, errMsg);}, (Math.random()*3500)+1500 );
          }
        );
      }
    } catch (err) {
...
Tabs.Kaynak = {
  ...
  hide : function (){
    clearTimeout (Tabs.Kaynak.displayTimer);
  },
...
//DebugTimer.start(); 
    try {
      ...
      str = '<DIV class=ptstat style="margin-top:5px; margin-bottom:5px;"><TABLE cellspacing=0 cellpadding=0 class=ptTab width=97% align=center>\
        <TR align=left><TD><SPAN class=ptStatLight>Giris:</span> '+ dt.toLocaleDateString() +'</td>\
        <TD><SPAN class=ptStatLight>Guc:</span> ' + addCommas(Seed.player.might) +'</td>\
      ...
      str += "<TABLE class=ptTabLined cellspacing=0><TR valign=top align=right><TD width=65></td><TD width=88 style='background: #E0EEE0'><B>TOPLAM</b></td>";
      for(i=0; i<Cities.numCities; i++) {
      ...
      if (Options.includeMarching)
        str += '<TD width=81><B>Hareket</b></td>';
      str += "</tr>";
      ...
      str += _row ('Yiyecek', rows[1]);
      str += _row ('Kereste', rows[2]);
      str += _row ('Tas', rows[3]);
      str += _row ('Cevher', rows[4]);
      str += '<TR><TD><BR></td></tr>';
...
//**********************************
      ...
      str += _row ('Ikmal', rows[1]);      
      str += _row ('Egitim', t_rows[2]);
      str += _row ('Milis', rows[2]);
      str += _row ('Egitim', t_rows[4]);
      str += _row ('Gozcu', rows[3]);
      str += _row ('Egitim', t_rows[6]);
      str += _row ('Mizrakli', rows[4]);
      str += _row ('Egitim', t_rows[8]);
      str += _row ('Silahsor', rows[5]);
      str += _row ('Egitim', t_rows[10]);
      str += _row ('Okcu', rows[6]);
      str += _row ('Egitim', t_rows[12]);
      str += _row ('Suvari', rows[7]);
      str += _row ('Egitim', t_rows[14]);
      str += _row ('Agir S.', rows[8]);
      str += _row ('Egitim', t_rows[16]);
      str += _row ('Araba', rows[9]);
      str += _row ('Egitim', t_rows[18]);
      str += _row ('Balista', rows[10]);
      str += _row ('Egitim', t_rows[20]);
      str += _row ('Kocbasi', rows[11]);
      str += _row ('Egitim', t_rows[22]);
      str += _row ('Katapulut', rows[12]);
      str += _row ('Egitim', t_rows[24]);
      ...
      str += _row ('Kalan YiYecek', row, true);
      str += '<TR><TD><BR></td></tr>';
      ...
      str += _row ('Egitim Suresi', row, true);
      ...
      str += _row ('Def.Insa', row, true);
      str += '<TR><TD class=xtab></td><TD class=xtab colspan=4><BR><INPUT type=CHECKBOX id=idCheck'+ (Options.includeMarching?' CHECKED':'') +'>Hareketleri Goster/Gosterme</td></tr>';
      str += "</table>";
      if (DEBUG_BUTTON)
        str += '<BR><BR><INPUT id=subSeed type=submit name="SEED" value="DEBUG">';
      Tabs.Kaynak.cont.innerHTML = str;
...
//DebugTimer.display ('Draw Overview');    
      ...
      Tabs.Kaynak.cont.innerHTML = '<PRE>'+ e.name +' : '+ e.message +'</pre>';
    }   
    t.displayTimer = setTimeout (t.show, 5000);
  },
};
...
Tabs.Hareket = {
  ...
  init : function (div){
    ...
    t.cont.innerHTML = '<TABLE class=ptTab align=center><TR><TD><INPUT class=pbSubtab ID=ptmrchSubA type=submit value=Ataklar></td>\
          <TD><INPUT class=pbSubtab ID=ptmrchSubM type=submit value=Hareketler></td>\
          <TD><INPUT class=pbSubtab ID=ptmrchSubR type=submit value=Takviyeler></td></tr></table><HR class=ptThin>\
  ...
  showAttacks : function (){
    var t = Tabs.Hareket;
    t.marchDiv.innerHTML = 'GELEN Saldirilari çok yakinda geliyor!';;
  },
  ...
  showMarches : function (){
    var t = Tabs.Hareket;
    t.marchDiv.innerHTML = 'GiDEN yürüyüsleri Cok yakinda geliyor!';
  },
  ...
  showReinforcements : function (){
    var rownum = 0;
    var names = ['Ikmal', 'Milis', 'Gozcu', 'Mız.', 'Sil.', 'Okcu', 'Suv.', 'A.Suv.', 'Araba', 'Balis.', 'Kocb', 'Kat'];
    var t = Tabs.Hareket;
    clearTimeout (t.displayTimer);
...
//logit (inspect (enc, 6, 1));    
    ...
    s = '<div class=ptstat>SeHirdeki Takviyeleri Gosterir..</div><BR>';
    if (numSlots == 0){
      s += '<BR><CENTER><B>Takviye Yok..</b></center>';
    } else {
      s += '<STYLE> .tot{background:#f0e0f8;} .city{background:#ffffaa;}</style>';
      s += '<TABLE cellspacing=0 width=100%><TR align=right><TD align=left width=16%><B>Oyuncu(Sovalye)</b></td>';
...
// TODO: Only allow 'send home' if troops are here now  (marchStatus = ?)              
      ...
      s += '<TR><TD colspan=13><BR><BR></td></tr><TR align=right><TD class="tot" align=left><B>TOPLAMLAR:</b></td>';
      for (i=1; i<13; i++)
        s+= '<TD class="tot">'+ tot[i] +'</td>';
      s += '</tr></table>';
    }

    s += '<BR><BR><INPUT type=CHECKBOX id=idCheck2 '+ (Options.encRemaining?'':' CHECKED ') +'> Orjinal Askerleri Goster';
    s += '<BR><BR><DIV style="font-size: 10px">NOTE: Seni Bu Takviyelerle Kim Yikar. Heyt Be Koccum Yuruuu :D.</div>';
