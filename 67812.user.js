...
function procesarEventos()
{
  if(con.readyState == 4)
  {
    ...
    var espacio="&nbsp;&nbsp;&nbsp;";
    var datos="";
    var sincoment="Este post no tiene comentarios";
    var sincoments="Si querés romper las bolas con el Soyez le premier";
    var sincomentss="Te pegamos todos";
    var datoscom="";
    var datospost="";
    var datospunt="";
    var datoss="Datos del usuario";
    var datoscoms="Comentarios: ";
    var datosposts="Posts: ";
    var datospunts="Puntos: ";
...
for(x=0;x<as.length;x++)
{
         ...
         if(spanes[x].getAttribute("class")=="title")
          rango=spanes[x].textContent;
}
for(x=0;x<divos.length;x++){
         ...
         if(divos[x].getAttribute("class")=="metadata-usuario")
          datos=divos[x].textContent;
         ...
         if(hs[x].getAttribute("class")=="titulorespuestas floatL")
{
	...
	datos=datos.split("Puntos");
	datospunt=datos[0];
	datos=datos[1].split("Posts");
	datospost=datos[0];
	datos=datos[1].split("Comentarios");
	datoscom=datos[0];
...
if(autor == "") {
    div.innerHTML="<div style='background-color: #AAFFAA; -moz-box-shadow: 2px 2px 5px #999; width: 200px;'>"+red+"</div><div><div style='background-color:#1E679A;color:white;padding:3px; width:150px; float: left;'-moz-box-shadow: 2px 2px 5px #999; height: 100%;><p style='align:left;'><div style='display:table-column;'><b>"+autors+autor+"</p><p style='align:left;'>"+rangos+rango+"</p><p style='align:left;'>"+visitass+visitas+"</p><p style='align:left;' >"+puntoss+puntos+"</p><p style='align:left;'>"+favoritoss+favoritos+"</p><p style='align:left;'>"+c+comentarios+"</p></b></div><div>"+datos+"</div></div><div style='float:right; width:150px;'><div><p style='background-color:#AAFFAA;'>"+ultimocoment+"</p>"+fecha+"</div><div>"+bueno+"</div></div></div>";   
}else {
if(comentarios =="0")
    div.innerHTML="<div style='background-color: #AAFFAA; -moz-box-shadow: 2px 2px 5px #999; text-align: center;'><b>"+autors+autor+espacio+rangos+rango+"</div><div style='background-color:#1E679A;color:white;padding:3px; width:200px; float: left;' ><div style='float: left; width:100px;'><p style='align:left;'>"+datoss+"</p><p style='align:left;'>"+datospunts+datospunt+"</p><p style='align:left;'>"+datoscoms+datoscom+"</p><p style='align:left;'>"+datosposts+datospost+"</p></div><div style='float: left; width:100px;'><p style='align:left;'>"+visitass+visitas+"</p><p style='align:left;' >"+puntoss+puntos+"</p><p style='align:left;'>"+favoritoss+favoritos+"</p><p style='align:left;'>"+c+comentarios+"</p></b></div></div><div style='height: 100px; width:200px; background-color: #FFFFFF; clear: both;'><div><p style='background-color:#AAFFAA;'>"+ultimocoment+"</p>"+sincoment+"</div><div>"+sincoments+sincomentss+"</div></div></div>"; 

else
    div.innerHTML="<div style='background-color: #AAFFAA; -moz-box-shadow: 2px 2px 5px #999; text-align: center;'><b>"+autors+autor+espacio+rangos+rango+"</div><div style='background-color:#1E679A;color:white;padding:3px; width:200px; float: left;' ><div style='float: left; width:100px;'><p style='align:left;'>"+datoss+"</p><p style='align:left;'>"+datospunts+datospunt+"</p><p style='align:left;'>"+datoscoms+datoscom+"</p><p style='align:left;'>"+datosposts+datospost+"</p></div><div style='float: left; width:100px;'><p style='align:left;'>"+visitass+visitas+"</p><p style='align:left;' >"+puntoss+puntos+"</p><p style='align:left;'>"+favoritoss+favoritos+"</p><p style='align:left;'>"+c+comentarios+"</p></b></div></div><div style='height: 100px; width:200px; background-color: #FFFFFF; clear: both;'><div><span style='background-color:#AAFFAA;'>"+ultimocoment+"</span>"+fecha+"</div><div>"+comentarior+"</div></div></div>"; 
     }        
  } 
  else 
  {
