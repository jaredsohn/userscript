...
holder.innerHTML += '<a href="http://forums.d2jsp.org/forum.php?f=104"' +
 ' title="Bar and Pub Games" target="_blank">Poker Club Status</a>: ';
switch(resolveBettorType(user)){
 case 'med':
  holder.innerHTML += '<font color="chartreuse"><b>Mediator</b></font>';
  break;
 case 'scammer':
  holder.innerHTML += '<font color="red"><b>Scammer</b></font>';
  break;
 case 'members':
  holder.innerHTML += '<font color="yellow"><b>Members</b></font>';
  break;
 ...
 case 'trusted':
  ...
  break;
 case 'admin':
  holder.innerHTML += '<font color="brown"><b>Admin</b></font>';
  break;
 case 'junior':
  holder.innerHTML += '<font color="orange"><b>Members++</b></font>';
  break;
case 'unknown':
 holder.innerHTML += '<font color="gray"><b>Not Rated</b></font>';
 break;
}
...
function getNames(){
	...
	{
	    method: 'GET',
	    url: 'http://d2jsplist.alwaysdata.net/pokerclub/pokerclub.html',
	    headers: 
		{
