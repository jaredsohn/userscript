// Western Carolina University Library Lookup
// version 0.1 BETA
// 2006-05-12
//
...
//
// ==UserScript==
// @name          Western Carolina University Library Lookup
// @namespace     
// @description   Alerts you if any editions of the current book you are browsing on Amazon.com are available at the WCU, UNCA and ASU Libaries.
// @include       http://*.amazon.*
// @include       http://amazon.*
// ==/UserScript==
...
var libraryName = 'WCU, UNCA, and ASU';
...
function libSearch(isbn, fn) {
    ...
    var libraryLookupUrl = 'http://wncln.wncln.org/search/i';

    var isbnSearchUrl = libraryLookupUrl+'?SEARCH='+isbn;
	...
	url: isbnSearchUrl,
	    ...
	    var isbnLinkPat = new RegExp('tr  class="yourEntryWouldBeHere"');
