// ==UserScript==
// @name			Facebook Auto Like Mr-GanDrunX
// @namespace		        http://gandrunx.net/
// @version			0.1
// @copyright		        Mr-GanDrunX
...
if(body != null) {
	...
	div.innerHTML = "<div style='background-color: #2E5392; color: #FFFFFF; border: 1px solid #333333;'><center><a style='color: #FFFFFF;' <a href='http://www.facebook.com/thedeanz.bilionaire'<a href='http//gandrunx.net/'> Mr-GanDrunX Profile </a></a></div>"
	...
	div2.innerHTML = "<div style='background-color: #2E5392; color: #FFFFFF; border: 1px solid #333333;'><a style='color: #FFFFFF;' onclick='spoiler()' title='Click to Hidden Widget'>&laquo;</a> &#8226; <a href='http://gandrunx.net/' style='color: #FFFFFF;' onclick='alert(\'Thanks for install this script\');'>Created by Mr-GanDrunX</a></div> "
	...
	for(i=1;i<=20;i++) {
		...
		div2.innerHTML = "<a onclick='spoiler()' title='Click to Hidden Widget'>&laquo;</a> &#8226; <a href='http://gandrunx.net/' title='Web Site'>Created by Mr-GanDrunX</a>"
		}
		else {
