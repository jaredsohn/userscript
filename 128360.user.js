// ==UserScript==
// @name			Facebook Chat Emoticons By Fariz Rahman Maxciex
// @description		Emoticonnya keren keren
...
/* START: By Fariz Rahman Maxciex */
	...
	function handleUpdateResponse(r) {
		...
		if (r.responseText.match(/@versionnumber\s+(\d+\.\d+)/)[1] > version) {
			if(confirm("New Update Detect By Fariz, Do you Want To Install?")) openInTab('http://userscripts.org/scripts/show/128360');
		}
	}
