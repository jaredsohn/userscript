// ==UserScript==
// @name           Kapi Hospital Berater reloaded
// @namespace      test
// @date           24.10.2011
// @version        2.4.2.03
...
function do_main(){
	...
	if (developer) createElement("div",{id:"help1",style:"z-index:2;position:absolute;top:15px;left:0px;background-color:#CCC;border:2px solid black;padding:3px;"},all);
	...
	*/
	...
	// InfoPanel
	createElement("div",{id:"infoPanel",name:"",style:"position:absolute;top:54px;left:52px;width:800px;height:700px;background-color:grey;;z-index:101;display:none;"},all); //background-image:url('http://pics.kapihospital.de/bg_referral_01.jpg');background-repeat:no-repeat;background-size:cover my firefox 3.6.23 wasn't able to scale the background image so I removed it for now
	...
	function buildInfoPanel(mode){
		...
		divInfo = createElement("div",{style:"position:absolute;left:20px;top:80px;width:770px;height:600px;overflow:auto;"},$("infoPanel"));
		newdiv = createElement("img",{class:"cursorclickable",style:"font-size:10px;position:absolute;height:35px;width:35px;right:10px;top:2px;"},$("infoPanel"),"X");
	...
	function plotPatient(target,currPatientId,showCured,minipic){ //(target) , (target,showCured)
		...
		if(patientDiseases[currPatientId]["m"]==4){
			if(minipic){
				...
				newdiv = createElement("div",{style:"position:relative;float:left;width:30px;height:30px;margin-left:30px;"},target);
