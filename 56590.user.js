// ==UserScript==
// @name           Neobux 2+ Provisoire
// @namespace      Fabriqué par uriburu626. Modifier par FrenchElite.
// @description    Calcule l'age des filleuls le temps sans click. Ajoute le total des clicks, moyenne des clicks et des statistiques detaillés. 
...
// Language Strings
var lang_totalClickAvg = "Moyenne total des clicks.";
var lang_lastdaysClickAvg = "Moyenne des clicks";
var lang_totalClicks = "Total des clicks";
var lang_clickedToday = "clicker aujourdui";
var lang_clickedYday = "Clicker hier";
var lang_others = "AUtres";
var lang_dailyNetIncome = "Entrer quotidienne Net";
var lang_dailyAvgIncome = "Moyenne quotidienne";
var lang_dailyAvgExpenses = "Moyenne de depense quotidienne";
var lang_dailyAvgTransfers = "Moyenne de transfere quotidienne";
var lang_statsSum = "Resumé des statistiques";
var lang_today = "Aujourd'hui";
var lang_yesterday = "Hier";
var lang_rented = "Loué";
var lang_direct = "Direct";
var lang_clicks = "Clicks";
var lang_avg = "Moyenne";
var lang_ravg = "R.Moyenne";
var lang_avgs = "Moyennes";
var lang_expenses = "Depense";
var lang_recycle = "Recyclage";
var lang_autopay = "Autopay";
var lang_renew = "Renew";
var lang_net = "Net";
var lang_last15daysSums = "Totals des 15 dernier jours";
var lang_recycled = "Recyclé";
var lang_autopaid = "Autopayé";
var lang_updateScript = "Mise à jour du script";
var lang_refferal2RenewCounts = "Filleuls à étendre (Renew)";
var lang_recycledLast15days = "Recyclé dans les 15 derniers jour";
var lang_autopaidLast15days = "Autopayé dans les 15 derniers jours";
var lang_dailyAvgEarnings = "Moyenne/jour des gains";
var lang_setAVGDays = "Entre le nombre de jours pour l'interval des moyenne";
var lang_avgDaysMsg = "SVP entre le nombre de jours pour l'interval des moyennes.";
var lang_showSTDDEV = "Voir les deviations standars";
var lang_on = "Allumé";
var lang_off = "Eteind";
var updtlinkTR = "http://userscripts.org/scripts/source/56590.user.js";
var updtlinkEN = "http://userscripts.org/scripts/source/56590.user.js";
// Language Strings End

//script provisoire
//Nombre de ref
var nbrrefprovisoire = "4"; //met ton nombre Ici !! A la place de 4!!//
//Fin du script provisoire
...
function avgdaysCommand(){
	avgdayinterval = prompt(lang_avgDaysMsg,"7");
	try{
		if(avgdayinterval>1 && avgdayinterval<16){
...
if(!stats){
	GM_registerMenuCommand(lang_setAVGDays, avgdaysCommand);
	GM_registerMenuCommand(lang_showSTDDEV+" [ "+(showstddev?lang_on:lang_off)+" ] ", stddevCommand);
	var avgIndex = 0;
	...
	if(accType==6){
		...
		for(var i = 0;i<mtx.length;i++){
			...
			if(clickData!=0){
				tmpCount = 0;
				for(var j = (15 - avgdayinterval);j<15;j++){
	...
	for(var i=1; i<rows.length; i++) {
		...
		if(rows[i].childNodes.length < 7) {
			if(rows[i].childNodes.length==1 && rows[i].childNodes[0].innerHTML=='&nbsp;'){
				...
				if(accType==6){
					tempHTML = tempHTML + "&nbsp;|&nbsp; "+lang_lastdaysClickAvg+" ("+avgdayinterval+") : "+formatDec(lastdaysAvg,3);
				}
...
function showAvgStats(embed,index){
	...
	if(docRoot.tagName == "data"){
		...
		if(index <2){
			avgLabel.innerHTML = "&nbsp;"+lang_avgs+" :&nbsp; (15) &nbsp;" + formatDec((setSum / 15),3)+"  &nbsp;(10) &nbsp;"+formatDec((setSum10days / 10),3)+"  &nbsp;(5) &nbsp;"+formatDec((setSum5days / 5),3)+"&nbsp;";
		...
		if(!self){
			...
			earnStr = " &nbsp;"+lang_dailyAvgEarnings+"  : (15) $" + formatDec(((setSum / 15)*selfClickMultiplier),3)+
