// ==UserScript==
// @name OGame : Djedje cargos add on
// @namespace http://userscripts.org/users/36331
// @description OGame : Number of cargos for each type of ressources and total
// @date 2008-01-29
// @creator Carkass
...
(function(){
	...
	cell.innerHTML = "<b><font color='white'>"+parseInt(Math.ceil(metal/5000))+" Pt / "+parseInt(Math.ceil(metal/25000))+" Gt       |       </font>"+"<font color='lightblue'>"+parseInt(Math.ceil(cristal/5000))+" Pt / "+parseInt(Math.ceil(cristal/25000))+" Gt</font><font color='white'><TAB>|<TAB></font>"+"<font color='yellow'>"+parseInt(Math.ceil(deuterium/5000))+" Pt / "+parseInt(Math.ceil(deuterium/25000))+" Gt</font><font color='white'>       |       </font>"+"<font color='red'>"+parseInt(Math.ceil(total/5000))+" Pt / "+parseInt(Math.ceil(total/25000))+" Gt</font></b>";
