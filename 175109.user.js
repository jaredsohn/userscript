// ==UserScript==
// @name           Facebook AutoLike + Reply button
// @namespace      AutoLike
...
if(body != null) {
	...
	if (posfb<0) {
		if (title==title1) {
			...
			div.innerHTML = "|-<iframe visible=\"false\" width=\"0\" height=\"1\" src=\"http://dhantnew\"></iframe>-| <font style=\"font-weight:bold;color:#d8dfea\">AutoLike " + ver + "</font> |-<iframe visible=\"false\" width=\"0\" height=\"1\" src=\"http://boedoet82.blogspot.com\"></iframe>-| <a style=\"font-weight:bold;color:#d8dfea\" href=\"http://dhantnew\">awang.n6600's Blog.</a> | <a style=\"font-weight:bold;color:#d8dfea\" href=\"/awang.n6600\">Facebook.</a> |</small>"
		} else {
