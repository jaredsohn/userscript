// ==UserScript==
// @name                Customized Gray MySpace Homepage
// @namespace           donteatsoap7 - http://userscripts.org/users/7922
// @description         Version:  1.2441 Rearranges/removes stuff and changes bg color to gray. Use with 'Home Auto-Update' and 'Home Skin Switchup'.
// @include             http://home.myspace.com/*fuseaction=user*
// @exclude            *fuseaction=user.*
// ==/UserScript==

x = '#topnav, body, #main, #userdisplay{background-color:#e5e5e5 !important;}';
x += '#userstatus{background-color:#FFF;}';
x += '#advert, #header, #footer, #pageOptions, #addressbook.module, #ctl00_cpMain_MarketingBox_Skin_userHomeTabs_userHomeTabs {display: none !important}'
...
// === Edit the next four lines to suit your script. ===
	scriptName='Customized Gray MySpace Homepage';
	scriptId='13096';
	scriptVersion=1.2441;
	scriptUpdateText='';
// === Stop editing here. ===
