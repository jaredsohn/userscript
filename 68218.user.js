// ==UserScript==
// @name           eRepublik Lana
// @namespace      http://www.erepublik.com/es
// @description    Kill Lana
...
var generals_txt = ["Zigman", "Benito_Camelas", "AbbeyRoad"]
var generals_pix = ["http://img34.imageshack.us/img34/1537/ensayo.gif", "http://img24.imageshack.us/img24/595/benitocamelas.gif", "http://img246.imageshack.us/img246/4457/ensayis.gif"];
...
//Replace Lana
GM_addStyle('.lana_holder { background-image:url(http://i45.tinypic.com/xq00ft.jpg);}');

replace_generals();

document.body.innerHTML = document.body.innerHTML.replace(/ I'm Lana and I'm going to make sure you get stronger every day you train. If you want to have a greater training effect and advance faster, book a strategy session and learn from historic military masters. /gi, 'Soy Diana, Te ayudare a crecer en tu carrera militar, junto a las Fuerzas Militares Colombianas.Como sabes todo tiene un costo, y yo no soy la excepción, no soy una chica para pobretones, mis masajes, caricias y entrenadores son caros. Pero en cambio si tienes dinero puedes entrenar con Zigman, Benito_Camelas y AbbeyRoad, ellos son los tanques eColombianos con mayor fuerza.No te olvides de hacer tu contribución a las FMC <a href="http://www.erepublik.com/es/organization/2261989">aqui</a>' );