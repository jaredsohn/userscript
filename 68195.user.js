// ==UserScript==
// @name             VCD Quality nzbsdotorg Search
// @namespace        
...
// -- Configure -------------------------------------
   var strip = true;
   var group = true;
   var g1url = 'http://www.nzbs.org/index.php?action=search&q=$1+$2&catid=2&age=';
   var g0url = 'http://www.nzbs.org/index.php?action=search&q=$1&catid=2&age=';
// --------------------------------------------------
