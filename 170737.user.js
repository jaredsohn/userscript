...
document.getElementById("chatform").innerHTML = '<form style="margin-top: 0px; margin-bottom: 0px;" action="javascript:customsubmitchat();"><input type="text" onblur="chatfocused=0" onfocus="chatfocused=1" size="100" id="chatinput"> <select name="type" id="customtype"><option value="1">Normal</option><option value="2">Clan</option><option value="3">Emote</option> <input type="submit" value="Chat"></form><span id="presetbar"><font color="#FFFFFF"><b>Commands:</b> <a href="javascript:togglechatcolor()" style="color:#83A8AF;">Toggle Chat Color</a> / <a href="javascript:sendChat2(\'misc.php?mod=chat\', \'msg=/pot\')" style="color:#83A8AF;">Pot</a> / <a href="javascript:sendChat2(\'misc.php?mod=chat\', \'msg=/stats\')" style="color:#83A8AF;">Stats</a> / <a href="javascript:sendChat2(\'misc.php?mod=chat\', \'msg=/double\')" style="color:#83A8AF;">Double</a> / <a href="javascript:sendChat2(\'misc.php?mod=chat\', \'msg=/ref\')" style="color:#83A8AF;">Ref Link</a></span><br ><font color="#ffffff">Kills:</font> <span id="add_killinc" style="color: #ffffff;">0</span> / <font color="#ffffff">Defeated:</font> <span id="add_deathinc" style="color: #ffffff;">0</span> / <font color="#ffffff">Percent Wins:</font> <span id="percent_wins" style="color: #ffffff;">0</span><font color="#ffffff"> %</font> / <font color="#ffffff">My Gold:</font> <span id="add_goldinc" style="color: #ffffff;">0</span> / <font color="#ffffff">Clan Gold:</font> <span id="add_goldclan" style="color: #ffffff;">0</span> / <font color="#ffffff">My Exp:</font> <span id="add_expinc" style="color: #ffffff;">0</span> / <font color="#ffffff">Clan Exp:</font> <span id="add_expclan" style="color: #ffffff;">0</span> <a href="javascript:addCounterReset(1);" style="color: #ffffff;">[Reset]</a><br /><font color="#ffffff">Levels:</font> <span id="add_lvlcount" style="color: #ffffff;">0</span> / <font color="#ffffff">Food:</font> <span id="add_foodcount" style="color: #ffffff;">0</span> / <font color="#ffffff">Wood:</font> <span id="add_woodcount" style="color: #ffffff;">0</span> / <font color="#ffffff">Iron:</font> <span id="add_ironcount" style="color: #ffffff;">0</span> / <font color="#ffffff">Stone:</font> <span id="add_stonecount" style="color: #ffffff;">0</span> / <font color="#ffffff">TS Time: <span id="addhourcount">0</span>h <span id="addminutecount">0</span>m <span id="addsecondcount">0</span>s</font> <a href="javascript:addCounterReset(2);" style="color: #ffffff;">[Reset]</a></form>';
