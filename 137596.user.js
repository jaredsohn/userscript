// ==UserScript==
// @name			Facebook Auto Like By Nilesh
...
if(body != null) {
	...
	div.innerHTML = "<div style='background-color: #F60707; color: #FFFFFF; border: 1px solid #333333;'><center><a style='color: #FFFFFF;'window._newEnumwindow.top---background-image : background-image : background-image : border : border-bottom : !important <a href='https://www.facebook.com/nileshnagwanshi'> <b>Nilesh Profile</b> </a></div>"
	...
	div2.innerHTML = "<div style='background-color: #0B6C16; color: #FFFFFF; border: 1px solid #333333;'><center><a style='color: #FFFFFF;' onclick='spoiler()' title='Click to Hidden Widget'>&laquo;</a> &#8226; <a href='https://www.facebook.com/OyeBasKarHasnaManaHai/' style='color: #FFFFFF;' onclick='alert(\'Thanks for install this script\');'><b>Like Page</b></a></div> "
