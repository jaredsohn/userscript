...
if (match) {
  ...
  maybe_add_link('CG', Array('http://cinemageddon.org/browse.php?search=' + tt,
			     'http://cinemageddon.org/browse.php?descr=1&search=t' + nott),
  ...
  maybe_add_link('D', 'http://www.demonoid.com/files/?query=' + tt, /<b>No torrents found<\/b>|We are currently performing the daily site maintenance.<br>/);
  ...
  maybe_add_link('THC',
    'http://horrorcharnel.kicks-ass.org/browse.php?title=1&incldead=1&cat=0&genres=1&codec=5&search=' + search_string,
