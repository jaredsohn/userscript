...
if(estenombre.innerHTML.indexOf('lastpost')==-1&&estenombre.innerHTML.indexOf('firstnew')==-1&&estenombre.innerHTML.indexOf('page=')==-1)
	{	
		...
		var http="http://board.ar.ogame.org/modcp.php?action=thread_move&x=51&y=20&threadid="+idusu+"&sid=";
		...
		enlace.innerHTML="  <img alt='Mover' border='0' src='http://servercugar.dyndns.org/sergio/moderadores/Mover.png' width='20' height='20'/>";
...
//Buscamos todos los links que contengan 'profile.php?userid'.
var nombres = xpath("//a[contains(@href,'threadview')]");
//Comenzamos a recorrerlos.
for (var i = 0; i < nombres.snapshotLength; i++ ) 
{
	if(i==0)
