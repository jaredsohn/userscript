// ==UserScript==
// @name         1kibaku_Auto_Bilder
// @namespace    http://at-n2.net/
// @description  ブラウザ一騎当千 自動建築スクリプト By NicL
// @include      http://*.1kibaku.jp/*
// ==/UserScript==

//グローバル変数
var VERSION = "0.0.1";  //バージョン情報
var INTERVAL=500;  //負荷対策 回線速度によっては正常動作しない時があります。その際は数値を増やしてください。1秒=1000
...
var OPT_MAX_LV = "2";
var OPT_FUC_NAME = ["学園","教室","体育設備","武道設備","食堂","倉庫",
...
function addOpenLinkHtml() {
	var sidebar = d.evaluate('//*[@id="supportNavi"]',
...
function addInifacHtml(vId) {
	...
	ccreateCheckBox(td1, "OPT_CHKBOX0", OPT_CHKBOX[0], "学園","中央の城・村・砦のLvを上げます。",0);
	...
	ccreateCheckBox(td2, "OPT_CHKBOX13", OPT_CHKBOX[13], "一般学生寮","自動でLv上げをする建築物にチェックをしてください。",0);
