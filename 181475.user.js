...
// @updateURL      http://userscripts.org/scripts/source/181475.user.js
// @downloadURL    http://userscripts.org/scripts/source/181475.user.js
...
window.plugin.importkeys.openDialog = function(event) {
  ...
  var handshakeUrl = window.plugin.importkeys.APPSPOT_URL + '/handshake?json='
    + encodeURIComponent(window.JSON.stringify({'nemesisSoftwareVersion': '2013-10-15T22:32:58Z 438a6fac0786 opt', 'deviceSoftwareVersion': '4.1.1'}));
