...
function dip() {
	...
	document.getElementsByTagName('TEXTAREA').item(0).value=e+"<font size=7 face='Comic Sans MS'>";
	...
	document.getElementsByTagName('TEXTAREA').item(0).value=e+"<font size=3 face='BRITANNIC BOLD'>";
	...
	document.getElementsByTagName('TEXTAREA').item(0).value=e+"<font size=3 face='ALGERIAN'>";
	...
	document.getElementsByTagName('TEXTAREA').item(0).value=e+"<font face='IMPACT'>";
	...
	document.getElementsByTagName('TEXTAREA').item(0).value=e+"<font size=5 face='LUCIDA CONSOLE'>";
	...
	document.getElementsByTagName('TEXTAREA').item(0).value=e+"<font face='ARIAL BLACK'>";
	...
	document.getElementsByTagName('TEXTAREA').item(0).value=e+"<font size=5 face='MATURA MT'>";
	...
	document.getElementsByTagName('TEXTAREA').item(0).value=e+"<font face='WIDE LATIN'>";
	...
	document.getElementsByTagName('TEXTAREA').item(0).value=e+"<font size=7 face='PLAYBILL'>";
