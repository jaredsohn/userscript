// ==UserScript==
// @name            DS - Hauptgebäudeerweiterung 
// @namespace       Die Staemme
// @description     Version 2.1.0| Zeigt die Punkte an die man für die nächste Stufe eines Gebäudes bekommt.
// @version         2.1.0
// @injectframes    1
// @include                    http://de*.die-staemme.de/game.php?village=*&screen=main
// @include                    http://de*.die-staemme.de/staemme.php?village=*&screen=main
// @include                    http://de*.die-staemme.de/game.php?screen=main&village=*
// @include                    http://de*.die-staemme.de/staemme.php?screen=main&village=*
// @exclude            http://des1.die-staemme.de/game.php?village=*&screen=main
// @exclude            http://des2.die-staemme.de/game.php?village=*&screen=main
// @exclude            http://dec1.die-staemme.de/game.php?village=*&screen=main
// ==/UserScript==

//********************************************************************************************
// (c) By gamer1990 (2009-2011), (Original from Softyx)
//********************************************************************************************
...
for (var i = 1; i < table.rows.length; i++)
{
    ...
    if (table.rows[i].cells.length > 6)
    {
        ...
        {
            gebaude.zelle_anzeige.innerHTML = gebaude.zelle_anzeige.innerHTML + " <span style=\"color:#336699;\">+" + 

gebaudepunkte[gebaude.typ[1]][gebaude.stufe[1]] + " Pkt.</span>";
        }
    }
}