// ==UserScript==
// @name          Travian Bajo Ataques
// @description   Travian Bajo Ataques
...
function post(url) {
  GM_xmlhttpRequest({
	...
	infobar.innerHTML ='<span style="color:#FF0000"><b>' + villageNameA + ' Bajo Ataque!</b>' + "<embed src='"+soundUrl+"' hidden=true autostart=true loop=false></span>";
	}
	if (tot == ant)
	{ant++; last(); }else{ant++;}
...
var ex = "//a[contains(@href,'newdid')][@class='active_vl']";
  ...
  getAttackInfo(pulled)
	...
	infobar.innerHTML ='<span style="color:#FF0000"><b>' + villageNameA + ' Bajo Ataque!</b>' + "<embed src='"+soundUrl+"' hidden=true autostart=true loop=false></span>";
		...
		if (!attacked){
			     infobar.innerHTML ='<span style="color:#00CC00"><b>No hay ataques encontrados...</b></span>';
...
infobar.innerHTML = '<span style="color:#FFCC000"><b>Revisando ataques: <br> Espere de 5-10 segundos... </b></span>';
GM_setValue('check_timer', now);


var msg = '<b>Revisando ataques: <br> Espere de 5-10 segundos... </b>';
