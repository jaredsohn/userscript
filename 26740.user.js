// ==UserScript==
// @name Travian3 Beyond "Hacked" - FULL SK/CZ + fixed
...
// @version 2.5
// @description	 opis na stronie skryptu http://userscripts.org/scripts/show/26569
// ==/UserScript==
...
var VC_showcomplete=0; //0 or 1 - hide/show completed buildings in the Village Center
var edificiosPorFila = 5; //number of columns in the Village Center
...
function funcionPrincipal(e){
	...
	var lang_us = lang_en;
        var lang_sk = lang_en;
	lang_en['ALIANZA'] 	= 'Aliancia';
	lang_en['PERFIL'] 	= 'Profil';
	lang_en['SIM'] 		= 'simulator';
	lang_en['CALC'] 	= 'Travian Calc';
	lang_en['SEGURO'] 	= 'Si si istý?';
	lang_en['MARK'] 	= 'Vybrať všetko';
	lang_en['PERDIDAS'] 	= 'Ztraty';
	lang_en['RENT'] 	= 'Zisk';
	lang_en['SUBIR_NIVEL'] 	= 'Môzeš stavať';
	lang_en['JUGADOR'] 	= 'Hráč';
	lang_en['ALDEA'] 	= 'Meno dediny';
	lang_en['HAB'] 		= 'Populácia';
	lang_en['COORD'] 	= 'Coords';
	lang_en['ACCION'] 	= 'Akcie';
	lang_en['ATACAR'] 	= 'Útok';
	lang_en['COMERCIAR'] 	= 'Poslať resources';
	lang_en['GUARDADO'] 	= 'Uložiť';
	lang_en['DESP_ABR'] 	= 'Presunúť';
	lang_en['FALTA'] 	= 'Potrebuješ';
	lang_en['HOY'] 		= 'dnes';
	lang_en['MANYANA'] 	= 'zajtra';
	lang_en['PAS_MANYANA'] 	= 'Poazajtra';
	lang_en['MERCADO'] 	= 'trhovisko';
	lang_en['ENVIAR'] 	= 'Poslať resources';
	lang_en['GETRES'] 	= 'Get resources';
	lang_en['COMPRAR'] 	= 'Kupiť';
	lang_en['VENDER'] 	= 'Predať';
	lang_en['ENVIAR_IGM'] 	= 'Poslať IGM';
	lang_en['LISTO'] 	= 'Rožšírenie povolené';
	lang_en['EL'] 		= 'na';
	lang_en['A_LAS'] 	= 'o';
	...
	lang_en['ENV_TROPAS'] 	= 'Poslať jednotky';
	lang_en['RECURSO1']			= 'drevo';
	lang_en['RECURSO2']			= 'hlina';
	lang_en['RECURSO3']			= 'zelezo';
	lang_en['RECURSO4']			= 'obilie';
	lang_en['TIEMPO']				= 'čas';
	lang_en['COMP']					= 'Report Compressor';
	lang_en['STAT']		= 'Statistics';
	lang_en['OFREZCO']	= 'Offering';
	lang_en['BUSCO']	= 'Hľadám';
	lang_en['TIPO']		= 'Typ';
	lang_en['DISPONIBLE']	= 'Only available';
	lang_en['CUALQUIERA']	= 'Any';
	lang_en['SI']		= 'ano';
	lang_en['NO']		= 'nie';
				lang_en['MARCADORES']		= 'Odkazy';
				lang_en['ANYADIR']			= 'Pridať';
				lang_en['ENLACE']				= 'New Bookmark URL';
				lang_en['TEXTO']				= 'New Bookmark Text';
	lang_en['ELIMINAR']	= 'Zmamať';
	lang_en['MAPA']		= 'Mapa';
	lang_en['CHECK']	= 'Skontrolovať novú verziu.';
	...
	var lang_hu = lang_hu;
	lang_hu['ALIANZA'] 	= 'Aliancia';
	lang_hu['PERFIL'] 	= 'Profil';
	lang_hu['SIM'] 		= 'Simulator';
	lang_hu['CALC'] 	= 'Kaukulator';
	lang_hu['SEGURO'] 	= 'Si si istý?';
	lang_hu['MARK'] 	= 'Vybrať všetko';
	lang_hu['PERDIDAS'] 	= '';
	lang_hu['RENT'] 	= 'Profit';
	...
	lang_pl['RENT'] 	= 'Zysk';
	lang_pl['SUBIR_NIVEL'] 	= '<span style="color:#44a0ff;">Rozbudowa mo&#380;liwa</span>';
...
// Natares
	...
	var unitData = [
		...
		["Legionista","Legionista","40","35","50","120","100","180","40","1","6", 'build.php?gid=19'],
		["Pretorianin","Pretorianin","30","65","35","100","130","160","70","1","5",'build.php?gid=19'],
		["Centurion","Centurion","70","40","25","150","160","210","80","1","7", 'build.php?gid=19'],
		...
		["Taran","Taran","60","30","75","900","360","500","70","3","4",'build.php?gid=21'],
		["Ognista Katapulta","Ognista katapulta","75","60","10","950","1350","600","90","6","3",'build.php?gid=21'],
		["Konsul","Konsul","50","40","30","30750","27200","45000","37500","4","4",'build.php?gid=21'],
		["Osadnik","Osadnik","0","80","80","5800","5300","7200","5500","1","5",],
		["Pałkarz","Pałkarz","40","20","5","95","75","40","40","1","7",'build.php?gid=19'],
		["Oszczepnik","Oszczepnik","10","35","60","145","70","85","40","1","7",'build.php?gid=19'],
		["Topornik","Topornik","60","30","30","130","120","170","70","1","6",'build.php?gid=19'],
		["Zwiadowca","Zwiadowca","0","10","5","160","100","50","50","1","9",'build.php?gid=19'],
		["Paladyn","Paladin","55","100","40","370","270","290","75","2","10",'build.php?gid=20'],
		["Germański Rycerz","Germański Rycerz","150","50","75","450","515","480","80","3","9",'build.php?gid=20'],
		["Taran","Taran","65","30","80","1000","300","350","70","3","4",'build.php?gid=21'],
		["Katapulta","Katapulta","50","60","10","900","1200","600","60","6","3",'build.php?gid=21'],
		["Wódz","Wódz","40","60","40","35500","26600","25000","27200","4","4",],
		["Osadnik","Osadnik","10","80","80","7200","5500","5800","6500","1","5",],
		["Falanga","Falanga","15","40","50","100","130","55","30","1","7",'build.php?gid=19'],
		["Miecznik","Miecznik","65","35","20","140","150","185","60","1","6",'build.php?gid=19'],
		["Tropiciel","Tropiciel","0","20","10","170","150","20","40","2","17",'build.php?gid=20'],
		["Grom Teutatesa","Grom Teutatesa","90","25","40","350","450","230","60","2","19",'build.php?gid=20'],
		["Jeździec Druidzki","Jeździec Druidzki","45","115","55","360","330","280","120","2","16",'build.php?gid=20'],
		["Haeduan","Haeduan","140","50","165","500","620","675","170","3","13",'build.php?gid=20'],
		["Taran","Taran","50","30","105","950","555","330","75","3","4",'build.php?gid=21'],
		["Trebusz","Trebusz","70","45","10","960","1450","630","90","6","3",'build.php?gid=21'],
		["Herszt","Herszt","40","50","50","30750","45400","31000","37500","4","5",],
		["Osadnik","Osadnik","0","80","80","5500","7000","5300","4900","1","5",],
		["Szczur","Szczur","10","25","10","/","/","/","/","1","20",],
		["Pająk","Pająk","20","35","40","/","/","/","/","1","20",],
		["Wąż","Wąż","60","40","60","/","/","/","/","1","20",],
		["Nietoperz","Nietoperz","80","66","50","/","/","/","/","1","20",],
		["Dzik","Dzik","50","70","33","/","/","/","/","2","20",],
		["Wilk","Wilk","100","80","70","/","/","/","/","2","20",],
		["Niedźwiedź","Niedźwiedź","250","140","200","/","/","/","/","3","20",],
		["Krokodyl","Krokodyl","450","380","240","/","/","/","/","3","20",],
		["Tygrys","Tygrys","200","170","250","/","/","/","/","3","20",],
		["Słoń","Słoń","600","440","520","/","/","/","/","5","20",],
	];
  ...
  imagenes["def_c"]='';
	 ...
	 */
	function img(ref, other_dir){ 
	if(!other_dir) return ("img/un/" + ref); 
	else return ("img/" + other_dir + '/' + ref);
	}
	/**
  ...
  function id2xy(id)  {
    ...
    // TMR - underline item that will take the longest
		...
		for (i = 0; i < 4; i++) {
		  if(restante[i] > 0) {
		    ...
		    texto_restante.push('<nobr><span style="cursor:default;" title="' + T('RECURSO' + (i+1)) + ' za '+formatear_tiempo(tiempo[i])+'"><img src="data:image/gif;base64,' + imagenes["res"+i] + '" width="18" height="12" border="0">');
		    if(tiempo_index==i)
		      texto_restante.push('<span id="timeout' + i + '" style="text-decoration:underline;">' + restante[i] + '</span></span></nobr> | ');
		    else
		      texto_restante.push('<span id="timeout' + i + '">' + restante[i] + '</span></span></nobr> | ');
		  }
		  else
		  {
		  	resNeeded[i] = 0;
		...
		if (tiempo_max == 'Infinity'){
			//# TMR
			a = T('FALTA') + ':<br> ' + texto_restante.join('') + ' <nobr><img src="data:image/gif;base64,' + imagenes["clock"] + '" width="18" height="12" title="' + T('TIEMPO') + '"> ' + T('NUNCA') + '</nobr>';
      ...
      //# TMR
			a = T('FALTA') + ':<br> ' + texto_restante.join('') + ' <nobr><img src="data:image/gif;base64,' + imagenes["clock"] + '" width="18" height="12" title="' + T('TIEMPO') + '"> <span id="timeout">' + tiempo2 + '</span></nobr><br/> ' + T('LISTO') + ' ' + calcularTextoTiempo(fecha);
		}
		return a;
	}
    ...
    // TMR - underline item that will take the longest
		...
		if (tiempo_max == 'Infinity'){
			...
			fecha.setTime(fecha.getTime() + (tiempo_max * 1000));
      //# TMR
			a = texto_restante.join('') + '<img style="padding-left:8px;" src="data:image/gif;base64,' + imagenes["clock"] + '" width="18" height="12" title="' + T('TIEMPO') + '"> <span id="timeout">' + tiempo2 + '</span><br/> Rozbudowa:<br/><span style="font-weight:bold; font-size:11px;">' + calcularTextoTiempo(fecha)+'</span>';
		}
		return a;
	}
	...
	if(find("//tr[@valign='top']", XPFirst).lastChild.className == 's7') overflow = true;
		...
		for (var i = 0; i < 4; i++){
			...
			var celda = elem("DIV", "<span style='font-size:9px; color:#909090; position: absolute; top:15px; height: 20px; text-align:left;'>(" + (produccionHora > 0 ? "+" : "") + parseInt(produccionHora*3600,10) + ", " + (produccionHora < 0 ? "<font color='#FF0000'>" + tiempoRestante + "</font>" : tiempoRestante) + ")</span>\n");
...
//				[T('CALC'), "http://www.denibol.com/~victor/travian_calc/", "_blank"],
	...
	function setUnitStatsTooltip(unitNum)
	{
		...
		table.appendChild(row);
		var td;
		td = elem('td', '<img style="margin-right:3px" title="attack" src="data:image/gif;base64,' + imagenes["att_all"] +'">' + getUnitAttack(unitNum));
		row.appendChild(td);
		td = elem('td', '<img style="margin-right:3px" title="defense against infantry" src="data:image/gif;base64,' + imagenes["def_i"] +'">' + getUnitInfDefense(unitNum));
		row.appendChild(td);
		td = elem('td', '<img style="margin-right:3px" title="defense against cavalry" src="data:image/gif;base64,' + imagenes["def_c"] +'">' + getUnitCavDefense(unitNum));
		row.appendChild(td);
		row = elem('tr','');
		table.appendChild(row);
		td = elem('td', 'Prędkość: ' + getUnitSpeed(unitNum));
		td.setAttribute('colspan', '3');
		row.appendChild(td);
		
		row = elem('tr','');
		table.appendChild(row);
		td = elem('td', 'Udźwig: ' + uc[unitNum][4]);
		td.setAttribute('colspan', '3');
		row.appendChild(td);
	...
	function getVillageDist(x,y)  {
	  return function(e) {
			...
			if(cities){
  			var txt1=new Array();
  			txt1.push('<tr><td colspan=2 align=center><b>'+x+'|'+y+'</b><tr><td style="border-bottom:solid 1px #00C000;"><b>Osada</b><td align=right style="border-bottom:solid 1px #00C000;"><b>Dystans</b>');
    ...
    delreport.innerHTML='<td class=rgb colspan=2>&nbsp;<input style="font-weight:bold; font-size:8pt; height:14pt" onClick="document.location.href=\''+delreporthref+'\'" type=button value="Zmamať">';
    ...
    if(find("//table[@class='tbg']//tr[@class='rbg']", XPFirst).textContent.match(/ supplies | reinforces /))  return;
  	...
  	var bookmarkRaid = '&nbsp;<input style="font-weight:bold; font-size:8pt; height:14pt" onClick="javascript:void(0);" value="Archivuj" type=button id=orange />';
    ...
    var useimage=new Array();
      ...
      sortRef=buildingsDescs[i].sortRef;
		  ...
		  // SHOWS "NAME LEVEL 1011" - SHOULD BE "NAME LEVEL 10"
          ...
          td.setAttribute("align", "left");
					...
					td2b.innerHTML = '<a style="font-size:11px;" href="' + buildingsLinks[sortRef].nodeValue + '"><tr><td><img style="padding-left:3px;height:81px" src="' + useimage[sortRef] + '" border="0"></a>'
...
*/
          ...
          var td = document.createElement("TD");
				  ...
				  table2.innerHTML = '<tr><td bgcolor=#E5E5E5><a style="font-size:11px;" href="' + buildingsLinks[sortRef].nodeValue + '">&nbsp;' + nextbuildinglevel + '<br/><img style="padding-left:3px;height:50px" src="' + useimage[sortRef] + '" border="0"><span style="position:relative;top:-15px;left:20px;">&nbsp;&nbsp;Ukończone</span></a>'
				 tablecells.push(td); 
  ...
  */
  ...
  function getResourceTypes()  {
    var funcion = function (){
      ...
      var ajax='function() { (find("//input[@name=\'getresources\']", XPFirst)).value="Gotowe!";}';
  ...
  */
	...
	*/ 
	...
	function blocNotas(){
		...
		td.setAttribute("background", img('msg/block_bg.gif', 'pl'));
		textarea.setAttribute("cols", "30");
		textarea.setAttribute("rows", "16");
		textarea.setAttribute("style", 'background-image: url(' + img('msg/underline.gif', 'pl') + '); border : 0px; overflow:auto');
	...
	function desplazarMapa(){
		...
		but.setAttribute("value",'Pokaż surowce');
	...
	function recursosMercado(){
		...
		document.body.innerHTML.search(/Każdy z twoich handlarzy może unieść <b>(\d+)/);
		...
		for(var i=0; i<rescount.snapshotLength;i++) {
  			if(rescount.snapshotItem(i)!=null)  {
    			if(rescount.snapshotItem(i).textContent.search(/Resources/)!=-1)  {
    			  ...
    			  rescount.snapshotItem(i).lastChild.innerHTML+='<span class='+rescount.snapshotItem(i).lastChild.lastChild.getAttribute("class")+' style="float:right;">'+(Math.ceil(restotal/respermerch))+' handlarzy</span>';
    			}
    		}
  		}
		var okButton = find("//input[@name='s1']", XPFirst);
		var merchEff = elem('p', 'Łącznie: <span id="merchantTotal">0</span> (handlarzy: <span id="merchantCount">0</span>, zmarnowane miejsce: <span id="capacityWasted">0</span>)');
    ...
    if(showbookmarks==true || showbookmarks == null) {
	  ...
	  bookmarks.push('<span style="color:#ff5500;font-size:11px;">Bod stretnutia</span>::build.php?gid=16');
      bookmarks.push('<span style="color:#ff5500;font-size:11px;">Kasárne</span>::build.php?gid=19');
	  bookmarks.push('<span style="color:#ff5500;font-size:11px;">Stajne</span>::build.php?gid=20');
	  bookmarks.push('<span style="color:#ff5500;font-size:11px;">Dielňa</span>::build.php?gid=21');
	  bookmarks.push('<span style="color:#ff5500;font-size:11px;">Trh</span>::build.php?gid=17');
	...
	function cityLinks(){
		...
		if (find("//img[contains(@src, 'travian1.gif')]", XPFirst)) //if Plus, then...
		{
			...
			var foo = '<TD><a href="dorf3.php"><span class="f10 c0 s7 b">Osady\n</span></a></TD><TD><a href="dorf3.php?s=2"><span class="f10 c0 s7 b">Surowce\n</span></a></TD><TD><a href="dorf3.php?s=3"><span class="f10 c0 s7 b">Magazyn\n</span></a></TD><TD><a href="dorf3.php?s=4"><span class="f10 c0 s7 b">PK\n</span></a></TD><TD><a href="dorf3.php?s=5"><span class="f10 c0 s7 b">Jednostki\n</span></a></TD>';	
		...
		for (var i = 0; i < cities.childNodes.length; i++){
			...
			city.appendChild(elem("TD", "<a href='a2b.php?z=" + id + "&dname="+cityname+"'><img src='data:image/gif;base64," + imagenes["def1"] + "' width='12' border='0' title='Wyślij jednostki'></a>"));
			...
			city.appendChild(elem("TD", "<a href='dorf1.php?newdid=" + newdid + "' title='Osada i okolice'>O</a>"));
			city.appendChild(elem("TD", "<a href='dorf2.php?newdid=" + newdid + "' title='Centrum osady'>C</a>"));
  		  ...
  		  city.appendChild(elem("TD", "<a href='karte.php?newdid=" + newdid + "' title='Mapa'>M</a>"));
  		}
 ...
 function readTroopPrefs(string)
 {
	...
	function resumenAldeas(){
		...
		for (var i = 0; i < aldeas.length; i++){
			if (aldeas[i].getAttribute("href").search(/\?newdid=(\d+)/) >= 0 && aldeas[i].getAttribute("href").search(/dorf1.php/)==-1 && aldeas[i].getAttribute("href").search(/dorf2.php/)==-1 && aldeas[i].getAttribute("href").search(/karte.php/)==-1){
				var did = RegExp.$1;
				var tr = document.createElement("TR");

				var td = document.createElement("TD");
				var enlace = elem("A", "<img src='img/un/a/b5.gif' border='0' title='" + T('ACTUALIZAR') + "' id='aldea" + did + "_boton'>");
				enlace.href = "javascript:void(0);";
