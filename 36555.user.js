...
document.getElementById(':boy:').addEventListener("click", setsmile, true);
document.getElementById(':boy:').addEventListener("click", setsmile, true);
document.getElementById(':boy:').addEventListener("click", setsmile, true);
document.getElementById(':boy:').addEventListener("click", setsmile, true);
document.getElementById(':boy:').addEventListener("click", setsmile, true);
