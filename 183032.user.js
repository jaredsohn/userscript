// ==UserScript==
// @name           Sticky Notes D
// @description    add sticky notes to websites (modified from Sticky Notes by panzi and Viper)
...
function StickyNote(x,y,width,height,text) {
	...
	stickyNote.container.addEventListener("mousedown", function(e) {
		...
		if (e.button == 0 && (stickyNote._state == STATE_DISPLAY || stickyNote._state == STATE_SELECT)) {
			...
			body.style.MozUserSelect="none";
			if (stickyNote._state == STATE_SELECT) {
			     multiMove = true;
			}
	...
	window.addEventListener("mouseup", function(e) {
		if (e.button == 0 && (stickyNote._state == STATE_MOVE || stickyNote._state == STATE_RESIZE || stickyNote._state == STATE_SELECT)) {
			if (e.ctrlKey) {
    			stickyNote.container.className = "at-ac-tuwien-student-e0427417-sticky-note-select-mode at-ac-tuwien-student-e0427417-sticky-note";
    			stickyNote._state = STATE_SELECT;
			} else {
    			stickyNote.container.className = "at-ac-tuwien-student-e0427417-sticky-note-display-mode at-ac-tuwien-student-e0427417-sticky-note";
