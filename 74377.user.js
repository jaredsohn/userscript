// ==UserScript==
// @name          Gizmonic Institute's Lab Assistant (for SB)(w/opacity)
// @description	  Calculate Research Numbers
// @include       *.spybattle.*
// @exclude       *.spybattle.*/forums/*
// ==/UserScript==
// Notes: hit ctr-F and enter "opacity" the decimal next to it is the opacity level, .8=80%, change to your likeing!
...
function apt_res_create_box() {
	...
	researchDiv.style.cssText = 'position: absolute; top: 2px; right: 10px; z-index: 10; background: url(images/spybattle_stats_bg.gif); opacity: .8; padding: 23px 3px 3px 25px; color: #FFFF66; width: 147px; height: 164px; font-size: 11px; margin: 3px;';
