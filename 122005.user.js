...
for (i = 0; i < uidList.length; i++ ) {
	...
	var formmessage = '<textarea name="message" rows="7" cols="90" tabindex="3">[size=x-small]Sent from post: http://www.hackforums.net/showthread.php?pid='+divList[i]+'#pid'+divList[i]+' [/size] \n\n</textarea><br />';
