...
*/
    attack_units['RedBloodCamp'][3][VAMPIRE_BATS] = {type:TROOP, qty:90,000};

/*
    attack_units['RedBloodCamp'][3][IMPALERS] = {type:TROOP, qty:9000};
    attack_units['RedBloodCamp'][3]["Twilight Warfare"] = {type:TECHNOLOGY, level:8};
    attack_units['RedBloodCamp'][3]["Spectral Vision"] = {type:TECHNOLOGY, level:8};
    attack_units['RedBloodCamp'][3]["Endurance"] = {type:TECHNOLOGY, level:6};
    attack_units['RedBloodCamp'][3]["Blood Transfusions"] = {type:TECHNOLOGY, level:6};
*/
...
function auto_attack_thread() {
    ...
    setTimeout(auto_attack_thread, 80000);
}
Becaus