// ==UserScript==
// @name			DSaddStandingUnits-Schweizerdeutsch
// @namespace		none
// @author			Heinzel
...
// @include		http://*.staemme.ch/game.php?*screen=report&mode=all&view=*
// ==/UserScript==
...
{
  if(tabs[x].innerHTML.match(/Azau:/) && !tabs[x].getElementsByTagName("tbody")[0])
  {
	tables.push(tabs[x]);
  }
}
