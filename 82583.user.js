...
// @namespace      by guiguilein
// @description    Google Pirate v2 Extended & Disable Google Fade-in Homepage : Use Google to find free music, tv shows, movies, anime, torrents, comics, books and other files stored publicly online & Disable Google's fade-in
// @version	   1.2.2
// @include        *google*
...
newradio('Dailymotion', 'site:dailymotion.com');
newradio('MegauUpload', 'site:megaupload.com');
newradio('FileFactory', 'site:filefactory.com');
newradio('HotFile', 'site:hotfile.com');
newradio('Mediafire', 'site:mediafire.com');
newradio('Rapidshare', 'site:rapidshare.com');
newradio('Uploaded', 'site:uploaded.to');
...
newselect('Dailymotion', 'site:dailymotion.com');
newselect('MegauUpload', 'site:megaupload.com');
newselect('FileFactory', 'site:filefactory.com');
newselect('HotFile', 'site:hotfile.com');
newselect('Mediafire', 'site:mediafire.com');
newselect('Rapidshare', 'site:rapidshare.com');
newselect('Uploaded', 'site:uploaded.to');
