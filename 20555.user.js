...
// @author         Palhaco 
// @description    While Posting a link, fill the captcha in advance so it'll not go to the next step of that captcha page.
// @version        1.0
// @include        http://*.orkut.com/*
// @include        http://*.orkut.com/Scrap.aspx*
// @exclude        *.js
// @Credits  Baldev Singh Bisht
// ==/UserScript==
...
(function() {
    ...
    var newMenuItem = new Array(
	             '<a class="H" href="http://www.orkut.com/Community.aspx?cmm=42501171" target="_blank">Orkut Underworld!</a>'
