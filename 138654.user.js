// ==UserScript==
// @name           LoU Tweak MAL
// @description    Adiciona várias funções ao LoU + Barra de Barão Integrada
// @namespace      AlucardKunMAL
// @include        http://prodgame*.lordofultima.com/*/index.aspx*
// @require        http://sizzlemctwizzle.com/updater.php?id=138654&days=1
// @version        1.7.5.3
// ==/UserScript==
...
var LT_mainFunction = function() {
	...
	function createTweak() {
		var LTversion = "1.7.5.3";
		var louTweak = {};
		var LT = {};
		var oApp, oPlayer, oTech, playerBar;
		var BaronLabel, BaronValue, availableBarons, PurifiedResourcesLabel, PurifiedResourcesValue, TitleResearch;
		var queueContSts = true;
		...
		LT_strings = {						
			"0": { /* pt_BR */
				...
				"opts_lang": {
					...
					"pt_BR": "Português (Brasil) - E Só, não reclame !"
				},
				...
				"btn_trade_show": "Mostrar Summário de Trade",
				"btn_trade_hide": "Ocultar Summário de Trade",
				"btn_support_show": "Mostrar Support labels",
				"btn_support_hide": "Ocultar Support labels",
				"copy_to_chat": "Copiar o ID do Relatório para o chat"
			}
		};
		function L(str) {
...
/* farm */				"50": {"w": [ 50, 200, 400, 1400, 3500, 6000, 10000, 16000, 25000, 38000 ], "s": [ 0, 0, 200, 600, 1500, 3000, 5000, 8000, 13000, 20000 ], "th": 3},
		...
		// try {
					...
					for (i=0; i<btns.length; i++) {
						btn = new qx.ui.form.Button(btns[i].lab).set({width: 15, appearance: "button-text-small", padding: [0,0,0,0]});
						
						switch(String(i)) {
							case "0":
							btn.setToolTipText("Cidade");
							break;
							case "1":
							btn.setToolTipText("Jogador");
							break;
							case "2":
							btn.setToolTipText("Aliança");
							break;
							case "3":
							btn.setToolTipText("Link");							
							break;
							default:
							btn.setToolTipText("Padrão");							
							break;
						}
						
						btn.addListener("click", btns[i].func, this);
						cont.add(btn, {row: i, column: 1});
					}
					this.chat.add(cont, {top: 60, left: 0});
		...
		qx.Class.define("louTweak.queueTimesLabel", {
			...
			construct: function () {
				...
				this.queueTimeCont.setWidth(290);
				this.queueTimeCont.setHeight(80);
				this.queueTimeContBgr = new qx.ui.basic.Image("data:image/png;base64,");
				this.queueTimeContBgr.setWidth(285);
				this.queueTimeContBgr.setHeight(80);
				...
				this.queueTimeCont.add(this.queueTimeGrid, {left: 8, top: 2});

				gr2 = new qx.ui.layout.Grid(3, 2);
				gr2.setColumnMaxWidth(0, 20);
				gr2.setColumnMinWidth(1, 200);
				gr2.setColumnMinWidth(2, 40);
				this.queueTimeGrid2 = new qx.ui.container.Composite(gr2);
				this.queueTimeCont.add(this.queueTimeGrid2, {left: 8, top: 39});
				...
				PurifiedResourcesValue.setToolTipText("Madeira Negra / Pedra de Runa / Veritium / Semente Vera");

				TitleResearch = new qx.ui.basic.Label(" "); 
				TitleResearch.setToolTipText("Indica se a Investigação de Título está disponível");

				BaronValue = new qx.ui.basic.Label("0/0/0/0");
				BaronValue.setToolTipText("Total / Recrutados / Recrutando / Disponíveis");

				this.queueTimeGrid2.add(new qx.ui.basic.Label("PR:").set({textColor: "text-gold", font: "bold"}), {column:0, row:0});
				this.queueTimeGrid2.add(PurifiedResourcesValue.set({textColor: "text-gold", font: "bold"}), {column:1, row:0});
				
				this.queueTimeGrid2.add(new qx.ui.basic.Label("BB:").set({textColor: "text-gold", font: "bold"}), {column:0, row:1});
				this.queueTimeGrid2.add(BaronValue.set({textColor: "text-gold", font: "bold"}), {column:1, row:1});

				this.queueTimeGrid2.add(TitleResearch.set({textColor: "#40C849", font: "bold"}), {column:2, row:1});

				this.btnx = new qx.ui.form.Button("");
				this.btnx.set({width: 3, Height: 75 , appearance: "button-text-small", toolTipText: "Mostrar/Esconder", padding: [1,1,1,1]});	
    			this.btnx.addListener("click", function() {
					queueContSts = !queueContSts;
					if ( queueContSts )
					{					
						this.queueTimeGrid.setLayoutProperties({left: 8, top: 2});	
						this.queueTimeGrid2.setLayoutProperties({left: 8, top: 39});
						this.queueTimeContBgr.setLayoutProperties({left: 0, top: 0});
						this.btnx.setLayoutProperties({left: 281, top: 0});
					} else {
						this.queueTimeGrid.setLayoutProperties({top: -75});	
						this.queueTimeGrid2.setLayoutProperties({top: -75});
						this.queueTimeContBgr.setLayoutProperties({top: -75});
						this.btnx.setLayoutProperties({left: 0});
					}
						}, this);
				this.queueTimeCont.add(this.btnx, {left: 281, top: 0});
			...
			members: {
				...
				updateQueueTimes: function() {
					...
					tech = webfrontend.data.Tech.getInstance();

					if (p != null) {
					 var pr = p.getVoidResources();
					 if (pr != null) {
					   PurifiedResourcesValue.setValue(pr[3][1] + "/" + pr[2][1] + "/" + pr[1][1] + "/" + pr[0][1]);
					 }                                        

					 var TotalBarons = p.getBarons();
					 var IdleBarons = p.getBaronsIdle();
					 var QueuedBarons = p.getBaronsQueue();
					 var Castelos = p.getNumCastles();					 

					 if (tech != null) {
					  var AvailableBarons = tech.getBonus("baronCount", webfrontend.data.Tech.research) - ((p.getNumCities() - 1) + IdleBarons + QueuedBarons);
					  BaronValue.setValue(TotalBarons + "/" + IdleBarons + "/" + QueuedBarons + "/" + AvailableBarons);
					  
					  var InvestigacaoAtual = (tech.getBonus("baronCount", webfrontend.data.Tech.research));
					  var ValorBonus = Math.floor((InvestigacaoAtual +2)/4);

					  var Purificado = tech.__fz[283][InvestigacaoAtual].r[5];

					  var BonusCasteloOk = ( (Castelos >= ValorBonus) && ((InvestigacaoAtual +2) % 4 == 0)) ? "*" : "";					  
					  
					  var RecFalta = "<table>";
					  if (pr != null)
					  {					  
					      RecFalta += (pr[3][1] < Purificado) ? "<tr><td width=100>Madeira Negra: <td width=40><font color=#40C849>" + ((pr[3][1] - Purificado) * -1) + "</font></tr>" : "";
						  RecFalta += (pr[2][1] < Purificado) ? "<tr><td width=100>Pedra de Runa: <td width=40><font color=#40C849>" + ((pr[2][1] - Purificado) * -1) + "</font></tr>" : "";
						  RecFalta += (pr[1][1] < Purificado) ? "<tr><td width=100>Veritium:      <td width=40><font color=#40C849>" + ((pr[1][1] - Purificado) * -1) + "</font></tr>" : "";
						  RecFalta += (pr[0][1] < Purificado) ? "<tr><td width=100>Semente Vera:  <td width=40><font color=#40C849>" + ((pr[0][1] - Purificado) * -1) + "</font></tr>" : "";
					  }
						  RecFalta += "</table><hr>";

					  var CstlFalta = ValorBonus - Castelos;
					  var CstlFaltaTxt = (CstlFalta > 0) ? "Ou obtenha mais <b><font color=#40C849>" + CstlFalta + "</font></b> Castelo(s)." : "";
					  var PurificadosOk = "";

					  if (pr != null)
						  PurificadosOk = ((pr[3][1] >= Purificado) && (pr[2][1] >= Purificado) && (pr[1][1] >= Purificado) && (pr[0][1] >= Purificado)) ? "*" : "";

					  var TitleResearchValue = "";

					  if ((PurificadosOk == "*") && (BonusCasteloOk == "*")) {
						  TitleResearchValue = "Título!";
						  TitleResearch.set({textColor: "#40C849" });
						  TitleResearch.setToolTipText("Investigação de Título - Purificados e Bônus de Castelo");
					  } else {
						  if (PurificadosOk == "*") {
							  TitleResearchValue = "Título!";
							  TitleResearch.set({textColor: "#40C849" });
							  TitleResearch.setToolTipText("Investigação de Título - Purificados Alcançados <hr>" + CstlFaltaTxt);
						  } else {
							  if (BonusCasteloOk == "*") {
								  TitleResearchValue = "Título!";
								  TitleResearch.set({textColor: "#40C849" });
								  TitleResearch.setToolTipText("Investigação de Título - Bônus de Castelo");
							  } else {
								  TitleResearchValue = "- - - -";
								  TitleResearch.set({textColor: "#FF0000" });
								  TitleResearch.setToolTipText("Purificados Faltantes:<br>" + RecFalta + CstlFaltaTxt);
							    }
						    }
					   }
					 
					 TitleResearch.setValue(TitleResearchValue);
					 Castelos = null
					 Purificado = null;
					 TitleResearchValue = null;
