// ==UserScript==
// @name            Cập Nhật ICON FaceBook UPDATE NEW
...
"chars" : " :) ",
	...
	// Toggler
	html += '<a class="navLink" title="1 Thông ba?o m??i">'; // var navLink
    ...
    html += '<a class="jewelFooter" href="https://www.facebook.com/HungDesigners" target="_blank">Chu?c M??ng Ba?n ?a? Ca?i ???t ICON Tha?nh Công<br>H?ng Designer</a>';
	html += '</div>';
