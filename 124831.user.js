// ==UserScript==
// @name            1337 - PM From Post
// @namespace       fl/pmfrompost
...
for (i = 0; i < uidList.length; i++ ) {
	...
	var formmessage = '<textarea name="message" rows="7" cols="90" tabindex="3">[size=x-small]Sent from post: http://www.free-leaks.com/showthread.php?pid='+divList[i]+'#pid'+divList[i]+' [/size] \n\n</textarea><br />';
