// ==UserScript==
// @name        Szkolenia_anglik
// @namespace    aaaaaaa
// @description  Aktualne szkolenie, czas jego zakończenia, szkolenie w kolejce
// @version		 1.2
...
var vor_penner_training_1 = "You're already doing a further education course.</div>";
	...
	url: ""+gamelink+"/skills/",
		onload: function(response) {
			var content = response.responseText;
				...
				var stufe1 = content.split('</span> [Level ')[1].split(']')[0];
				}catch(e){}
				try{
				var stufe2 = content.split('</span> [Level ')[2].split(']')[0];
				}catch(e){} 
