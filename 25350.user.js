// ==UserScript==
// @name            MLB.com Gameday Stuff Remover
// @description     Removes unnecessary sections of MLB Gameday pages for less scrolling and easier viewing. 
// @include         http://mlb.mlb.com/mlb/gameday/*
// @author         (c) 2007 Ryan Thibodaux <higherpie at gmail dot com> using the Platypus Firefox add-on
// ==/UserScript==
function do_platypus_script() {
remove_it(window.document,document.getElementById('logo-mlb_com'),null,null,null);
remove_it(window.document,document.getElementById('hdr'),null,null,null);
remove_it(window.document,document.getElementById('gd_tabs'),null,null,null);
remove_it(window.document,document.getElementById('footerBackground'),null,null,null);
remove_it(window.document,document.getElementById('footerText'),null,null,null);
set_style_script(window.document,document.getElementById('logo-gameday'),"height: 35px;",null,null);
