// ==UserScript==
// @name            Engadget editorial print
// @include         http://*.engadget.com/20*/*/*/editorial-*
// ==/UserScript==

function do_platypus_script() {
fix_page_it(window.document,'/HTML[1]',null,null,null);
isolate(window.document,document.evaluate('/HTML[1]/BODY[1]/DIV[9]/DIV[1]/DIV[1]/DIV[1]/DIV[1]', document, null, XPathResult.FIRST_ORDERED_NODE_TYPE,null).singleNodeValue,null,null,null);
