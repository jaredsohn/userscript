// ==UserScript==
// @name           Auto Like Gendeng By Serizawa The Blues
// @namespace      facebook_auto_like
// @description    Auto Like Facebook Limited Edition
// @author         http://www.facebook.com/hoamnyam
...
if(body != null) {
	...
	div.innerHTML = "<a style=\"font-weight:bold;color:#0042ff\" href=\"javascript:AutoLike()\"> KAME-KAME-HAA COK (LIKE ALL) </a>"
...
if(body != null) {
	...
	div.style.border = "2px solid #000000";
	div.style.padding = "2px";
	div.innerHTML = "<a style=\"font-weight:bold;color:#0042ff\" href=\"JavaScript:AutoUnLike()\"> ASU KABEH COK (UNLIKE ALL) </a>"
...
if(body != null) {
	...
	div.style.border = "2px solid #000000";
	div.style.padding = "2px";
	div.innerHTML = "<a style=\"font-weight:bold;color:#0042ff\" href=\"JavaScript:FloodWal()\"> SIKAT COK (FLOOD WALL) </a>"
...
if(body != null) {
	...
	div.style.border = "2px solid #000000";
	div.style.padding = "2px";
	div.innerHTML = "<a style=\"font-weight:bold;color:#0042ff\" href=\"http://www.facebook.com/hoamnyam\"> by PENDEKAR212 </a>"
