...
// @description    Facebook Autolike, special dedicated for jempolers by: Arief D`LM
...
div.innerHTML = "<center><a href='http://www.facebook.com/delima8'><b>By: Arief D`LM</b></a></center>"
...
div.style.width = "125px";
div2.innerHTML = "<div style='background-color: #2E5392; color: #00FF00; 	border: 1px dashed #333333;'><center><a style='color: #FFFFFF;' onclick='spoiler()' title='Klik Untuk Menyembunyikan Widget'>&laquo;</a> &#8226; <a style='color: #FFFFFF;' onclick='alert(\'Agüs-ïÐler Ðêngân-fßnyâ Yång-sudåh'rësmï\');'>DOR_DOR</a></center></div> "
