...
/*	#planet .slot {
	...
	document.getElementById("officers").appendChild(div_parent);
...
//	.fleft {    float:left;}
	...
	div1.innerHTML = format(sc, 0, '.') + " C-";// + " small cargo" + (sc>1?"s":"");
...
//	.fright {   float:right;}
	...
	div2.innerHTML = format(lc, 0, '.') + " C+";// + " large cargo" + (lc>1?"s":"");
