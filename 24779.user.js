...
// ==UserScript==
// @name           light on dark Redirect
// @namespace      http://binq.org/greasemonkey/
// @description    light on dark Redirect v2.0: CSS Beauty pages that are opened in a new tab/window take you directly to the dugg article.  It's very useful when looking through RSS feeds.
// @include        http://*.lightondark.com/*/*
// @include        http://lightondark.com/*/*
// ==/UserScript==
...
BINQ.lightondarkLinkJumper = {
	init: function() {
		this.jumpToFirstValidLink = BINQ.linkJumper.jumpToFirstValidLink;
		return this;
	},
	searchPath: "//div[@class='largeshot']//a[1]",
}

if (history.length == 1) { BINQ.lightondarkLinkJumper.init().jumpToFirstValidLink(); }