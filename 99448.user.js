// ==UserScript==
// @name           "La comuna", compartiendo inteligencia
// @namespace      taringa
// @include        *taringa.net/*
// @exclude        *http://www.taringa.net/comunidades/comuna/*
// @creator        noedavid33 [user]
// ==/UserScript==

//////////////////////////////////////////////////////////
//////////////////////////////////////////////////////////
//                                                      //
// NO EDITES ESTO ESTO ES PROPIEDAD DE noedavid33       //
...
byClass('menuTabs').innerHTML += "<li id=\"tabbedWTF\" class=\"tabbed\">\n <a href=\"http://www.taringa.net/comunidades/comuna/\" onclick=\"menu(\'"La comuna"! \', this.href);return false;\" title=\"Ir a "La Comuna"!\">La Comuna! <img src=\n\"http://k01.kn3.net/29C4AF0A7.png\" alt=\"Mr. wtf\" /></a>\n</li>";
...
function procesarEventos()
{
  ...
  {    
    div.innerHTML = '<div align="center"><img src="http://www.rincolnia.com/images/bunchie1.gif" alt="bunchie"></div>';
  }
}
