// coding: utf-8
// ==UserScript==
// @name	Ika-Reporte de Batalla
// @version	v4.5
// @author	2-D (Ex-Reaper)
// @homepage    http://userscripts.org/scripts/show/113151
// @description	Reporte de Batalla mejorado.
// @icon        http://img9.imageshack.us/img9/880/ikardb.jpg
		...
		*/
		...
		for (var i = 0; i < CitiesInfos.snapshotLength; i++)
			...
			if (cityInfoType == 'UL')
				...
				if (this.DOM.Has_ClassName(lis[0],'name'))
					{
					var tds = lis[0].getElementsByTagName("td");
					}
				else
					{
					var tds = lis[1].getElementsByTagName("td");
					}
			...
			this.Log.Add('cityLevel='+cityLevel);
			if (cityLevel > 0)
				{
