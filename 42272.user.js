// ==UserScript==
// @name           Bungie.net Quick Forum Links - Admin
// @author         Duardo
...
// @exclude        http://*bungie.net/Forums/BanDialog.aspx*
// ==/UserScript==
...
function loadWebcamWatcher()
{
    ...
    webcamWatcherDiv.innerHTML = "<div class='boxA' style='background-repeat: repeat-x; width: 99%; margin-top: 0px;'>" +
                                 "    <ul>" +
                                 "        <li>" +
                                 "            <h3>FORUM LINKS<span style='float: right; top: 2px; position: absolute; right: 5px;'></span></h3><span style='align: right; top: 2px; position: absolute; right: 5px;'><u><a href='http://admin.bungie.net/Search/default.aspx?q=Duardo&g=5'>Recent Posts</a> | <a href='http://admin.bungie.net/Forums/MyTopics.aspx'>Saved Threads</a> | <a href='http://admin.bungie.net/Account/Settings.aspx?page=avatar'>My B.net Settings</a></u></span>  " +
                                 "        <li>" +
                                 "            <a href='http://admin.bungie.net/Forums/topics.aspx?forumID=105242'>Halo 3</a> | <a href='http://admin.bungie.net/Forums/topics.aspx?forumID=5576'>Optimatch</a> | <a href='http://admin.bungie.net/Forums/topics.aspx?forumID=1'>Underground</a> | <a href='http://admin.bungie.net/Forums/topics.aspx?forumID=3'>Septagon</a> | <a href='http://admin.bungie.net/Forums/topics.aspx?forumID=10'>Flood</a> | <a href='http://admin.bungie.net/Forums/topics.aspx?forumID=4'>Gallery</a>  | <a href='http://admin.bungie.net/Forums/topics.aspx?forumID=9'>Classifieds</a> | <a href='http://admin.bungie.net/Forums/default.aspx?mode=other'>Other</a></h4>" +
                                 "        </li>" +
