...
//******************************************* Fin des option ********************************************/
	...
	//******************************************* Pour la légende ********************************************/
		...
		// on définit d'abord quelques variables de la légende 
			    ...
			    var classprog2_leg = bold+'Classement progression'+finbold; // couleur de "Classement  progression 
				...
				var classement_leg = bold +'Classement : [color='+couleur[5]+']xx ( +xx[/color] / -xx[color='+couleur[5]+'] [/color])'+ finbold; // couleur du classement ( et prog dans ce classement )
				var progression_leg = bold +'Progression :  [color='+couleur[5]+']+ xxx[/color]/- xxx'+ finbold; // couleur de "Progression", du classement positif/négatif et de points
				var pointsoit_leg = bold +'points soit'+ finbold // on garde la même variable pour la couleur des mots "points soit"
				var progprcent_leg = '[color='+couleur[4]+']+[/color]/- xx% '; // couleur de la progression, exemple +5.51%
				var classprog_leg = bold +'Classement progression : xx'+ finbold; // couleur classement progression
