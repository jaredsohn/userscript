// ==UserScript==
// @name        Delete teman In Single-Click on Facebook by Cukup Aziz Aja
// @description This script is useful if you don't want to delete each friends one by one.
// @namespace   CukupAzizAja
// @include      *.facebook.com/*
// @require       http://ajax.googleapis.com/ajax/libs/jquery/1.7/jquery.js
// @version     2.2 Beta
// ==/UserScript==
// Developed by Cukup Aziz Aja - http://www.facebook.com/punyagietya
function sleep(x) {
...
function replace_msg(x) {
	$('div.dialog_body').html('Hooray! ' + x + ' friends deleted. Like us at <a target="_blank" href="http://www.facebook.com/pulaumaduara">Blog Anak Madura</a> for more useful tips/tricks and more!');
}
set_timer();
