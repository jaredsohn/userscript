...
var SUC_script_num = 106970; // ID del Script
...
/* Boton se muestra en la esquina inferior derecha con el texto Subir */
document.getElementById('modulo_twitter').innerHTML += '<a style="filter:alpha(opacity=30); opacity: 0.3; position: fixed; right: 10px; bottom: 10px; color: #FFFFFF; font-size="16pt" width: 100px; height: 50px; font-family: Arial;" href="javascript:;scrollTo(0,0);" onmouseover="this.style.opacity=0.8;this.filters.alpha.opacity=80" onmouseout="this.style.opacity=0.5;this.filters.alpha.opacity=50"><IMG SRC="http://dimension90.webcindario.com/arriba.png"></a>'
 /* Fin del boton */
