...
// @description - Versión en Español, mejorada.
...
menuplus += '<li><a href="index.php?mod=shop" class="mplus_z">Comercio</a></li>';
menuplus += '<li><a href="index.php?mod=auction" class="mplus_m">Subasta</a></li>';
menuplus += '<li><a href="index.php?mod=market&reiter=5" class="mplus_z">Mercado</a></li>';
menuplus += '<li><a href="index.php?mod=laborshop" class="mplus_m">Laboratorio</a></il>';
menuplus += '<li><a href="index.php?mod=packages&reiter=5" class="mplus_m">Paquetes</a></li>';
menuplus += '<li><a href="index.php?mod=job" class="mplus_m">Trabajo</a></li>';
menuplus += '<li><a href="index.php?mod=training" class="mplus_m">Entrenamiento</a></li>';
...
menuplus += '<li><a href="javascript:findenemy();" class="mplus_m">Atacar enemigo</a></li>';

menuplus += '</div></ul>';

// *********** vlastni menu ***********

menuplus += '<div id="klammer-rechts"><ul><li style="position:relative"><img class="k-rechts" alt="" src="img/mk-rechts-klammer.jpg" /><a href="#">Menu propio</a></li></ul></div>';
