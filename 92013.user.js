...
// @namespace      Gerenciamento do caixa da Gangue
// @description    Auxilia no gerenciamento do caixa da gangue
// @author         James Maxwel
// @include        http://*game*/gang/memberlist/*
// @include        http://*bumrise*/gang/memberlist/*
// @require        http://yourjavascript.com/16271540154/extend_js.js
// ==/UserScript==
var user = {};
var SHOW_LAST = 7;
...
function finish() {
	...
	var heading = createElement('th',{class:'pg-list-cash'},'Pagou na Semana');
	var headrow = $('.pg-list-rank',target)[0].parentNode;
        headrow.insertBefore(heading,$('.pg-list-rank',target)[0]);
	var heading = createElement('th',{class:'pg-list-cash'},'Retirou na Semana');
        headrow.insertBefore(heading,$('.pg-list-rank',target)[0]);
	var rows = $('tr',target);
