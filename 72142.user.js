// ==UserScript==
// @name           Hacker News Keyboard Shortcuts (GMail Style)
// @namespace      hnks
// @description    Adds j/k/o navigation to the main links
...
function letsJQuery() {
    ...
    var links = $("table table td.title:gt(0)>a"); // all the links
	...
	case 107: // k -> up
	    ...
	    break;
	case 79:  // o -> open link
	    var href = $("table table td.title:gt(0)>a").eq(myctr).attr("href");
	    window.open(href);
	    break;
