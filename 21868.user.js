...
// ==UserScript==
// @name        Travian: rablott/össz rabolható zsákmány
// @description    A jelentésekben látszik az össz rablott / rabolható zsákmány -- Fordította: Simulacrum
...
// Add losses: casualties + prisoners
    if ( punitn[0].snapshotItem( 0 ).nodeValue == "Foglyok"){
