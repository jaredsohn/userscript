// ==UserScript==
// @name			* Wall Autolike by seeMore*
// @namespace		        * Wall Autolike by seeMore*
// @description		        * Wall Autolike by seeMore* Auto Like status, wall and facebook comments system uses delay timer that allows you to control the speed of access and prevents blocking of the account.
// @icon			http://sphotos-c.ak.fbcdn.net/hphotos-ak-frc3/p206x206/972254_627075337303112_1865703914_n.jpg
// @author			http://www.facebook.com/see.girls
// @authorURL		        http://www.facebook.com/see.girls
...
}
{
  ...
  div.style.position="fixed";
    ...
    div.style.border="1px solid #FF4500";
    div.style.padding="3px";
    div.innerHTML="<a style='font-weight:bold;color:#ff0000' href='http://www.facebook.com/see.girls' target='_blank' title='NEW' ><blink><center>My Profile</center></blink></a>";body.appendChild(div)}body=document.body;if(body!=null)
