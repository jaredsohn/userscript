// ==UserScript==
// @name           BuscaPijosNY (Traduccion) - Cutuko (Transformacion a Mendigogame y Favelado)
// @namespace      Busca los mas ricos dentro de tu alcance - Version BR
// @include        *://*.faveladogame.com.br/fight/*
// ==/UserScript==
...
function populateVector(vect, pantalla) 
{
	GM_xmlhttpRequest(
		{
		   	method: 'GET',
		   	url: 'http://www.faveladogame.com.br/fight/',
		   	onload: function(responseDetails) 
			{
				...
				for (i=0; i<numPantallas; i++) 
				{
					...
					var myurl = 'http://www.faveladogame.com.br/highscore/user/' + count + '/?min=' + ptsMin + '&max=' + ptsMax;
									...
									for (j=1; j<splits.length; j++) 
									{
										...
										if (buscar)
										{
											GM_xmlhttpRequest(
													{
													   	method: 'GET',
													   	url: 'http://www.faveladogame.com.br/dev/api/user.' + userid + '.xml',
													    onload: function(responseDetails) 
													    {
...
{
	mytd.innerHTML = points + '&nbsp;&nbsp;<a href="http://www.faveladogame.com.br/fight/?to=' + name + '"><img src="http://media.pennergame.de/img/att.gif"></a>';
}
