// ==UserScript==
// @name          Amazon Minuteman Public Library Linky
// @description	  v1.0 Updated from scripts for other libraries
// @include       http://*.amazon.*
// ==/UserScript==
...
// and Rockmaster http://userscripts.org/users/14120
// All I did was change the url for the library to the Minuteman Library Network

(function(){
//	GM_log('Amazon Minuteman Public Library Linky');	

	var libraryName = 'the Minuteman Public Library';
	var libraryIsbnUrlPattern = 'http://find.minlib.net/iii/encore//search/C__S'
	var libraryTitleUrlPattern = 'http://find.minlib.net/iii/encore//search/C__S'
...
//					"#2bff81" //light green
			   ...
			   foundCount++;
				...
				setLibraryHTML(
					libraryUrlPattern, isbn,
					"Not Found",
					"No record found at "+ libraryName, 
					"orange"
					);
			   foundCount++;
  			   getBookStatuses();
