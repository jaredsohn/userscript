...
// @include        http://YOUR USERNAME HERE.livejournal.com/friends*
// ==/UserScript==

// This edition only works with the Expressive layout. You need
// to modify the @include field above, replacing the username with yours.
...
for (var i = 0; i < tagDivs.snapshotLength; i++) {
  ...
  if (baleeted > 0) {
    ...
    while (walker.className != 'post-asset asset') {
