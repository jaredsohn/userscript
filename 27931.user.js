/*
	FriendFeed Scobleizer. Because you can never have enough Scoble.
	compliments from The Inquisitr http://www.inquisitr.com
	code modified from http://ffapps.com/tabs/
*/

// ==UserScript==
// @name           FriendFeed Scobleizer
// @namespace      http://www.inquisitr.com
// @description    Add Scobleizer in a tab on FriendFeed 
...
(function() {
  ...
  autoUpdateFromUserscriptsDotOrg({
    name: 'FriendFeed Scobleizer',
		url: 'http://userscripts.org/scripts/source/27931.user.js',
		version: ffrb_version,
	});

  function Scobleizer_setup() {
		$('.settings').find('.l_tab:last').after('<td class="l_tab" style="padding-left: 10px;" id="tdtabtm"><div class="rounded bb" id="tabtm"><div class="t"><div class="l"><div class="r"><div class="tl"><div class="tr"><div class="body"><a id="tab-link-Scobleizer" href="#"><img src="http://Scobleizer.com/favicon.ico"></a></div></div></div></div></div></div></div></td>');
    $('#tab-link-Scobleizer').click(function() {
			$('#subtabs').hide();
			$('#body').css("height","100%").html('<div class=iframe style="width:100%;height:100%;"><iframe id="content_iframe" marginWidth=0 marginHeight=0 src="http://www.Scobleizer.com" frameBorder=0 style="width:100%;height:100%;overflow:auto;"></iframe></div>');
