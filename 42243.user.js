...
// @name           Menu des GRIUM
// @version        0.0.1
// @namespace      Menu GRIUM
// @description    Un petit menu pour les Galerium
// @include        http://s*.ikariam.*/index.php*
// ==/UserScript==
// ===========================================================================
//
// Un mélange de plusieur script scripts adaptés pour les besoins des GRIUM.
...
+ ' <li><h2>Menu GRIUM</h2>'
+ '   <ul>'
+ '     <li><center><a target="_blank" href="http://lesgde.free.fr/forums" title=" Faut etre logge auto sur le forum">Forum GRIUM</a></li>'
