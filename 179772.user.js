// ==UserScript==
// @name       Ascend Userscript
// @namespace  Ascend Userscript
// @version    1.0
// @description  Checks the Ascend subforums to check for new posts and alerts the user if there are, + a few other treats! :tehe:
// @include      http://leakforums.org*
// @include      http://*.leakforums.org*
// @copyright  2013+, Oscar Sanchez
// @icon http://i.imgur.com/UvsfagK.png
