// ==UserScript==
// @name           Todo sobre ecologia
// @namespace      ecototal
// @description    Script para la comunidad Todo sobre ecologia
// @include        *taringa.net/*
// @exclude        *taringa.net/comunidades/ecototal/*
// ==/UserScript==
...
byClass('menuTabs').innerHTML += "<li id=\"tabbedWTF\" class=\"tabbed\">\n <a href=\"http://www.taringa.net/comunidades/ecototal/\" onclick=\"menu(\'Todo sobre ecologia \', this.href);return false;\" title=\"Ir a la comunidad Todo sobre ecologia\">Todo sobre ecologia <img src=http://o2.t26.net/images/arrowdown.png\n\"\" alt=\"\" /> </a>\n</li>";
