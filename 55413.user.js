// ==UserScript==
// @name           Facebook - Mousehunter Smarter Autohunter
// @namespace      Zatch (credit goes to Wr3cktangle)
// @description    A smarter autohunter for the Mousehunt Facebook App
...
if(timervalue > 0)
{
   ...
   setTimeout(function() { document.location = 'http://apps.facebook.com/mousehunt/soundthehorn.php'; } , 1800000);
}