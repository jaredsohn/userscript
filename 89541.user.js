...
// @description  Maiores Informações sobre os Favelados
...
// @version      1.0 Ajustado para versão SP
// ==/UserScript==

// Daten über das aktuelle Skript für den Update-Mechanismus
var THISSCRIPTVERSION = "1.0";
var THISSCRIPTNAME = "Fightinfo";
var THISSCRIPTINSTALL_URL = 'http://userscripts.org/scripts/show/89541';           // URL für Hauptseite bei userscripts.org
var THISSCRIPTSOURCE_URL = 'http://userscripts.org/scripts/source/89541.user.js';  // Skript-URL bei userscripts.org
...
// Wenn in Rio de Janeiro gespielt wird
	...
	var DFTownCode = "";
	var lang = 5;
// Wenn in São Paulo gespielt wird
...
function CheckFightValues(content) {
	...
	var fightATT = (attvalue * 1.1 + defvalue) + ", ATT: " + attvalue;
