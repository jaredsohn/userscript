...
function action()
{
	if (isKingReward)
	{
		...
		if (isKingWarningSound)
		{
			...
			kingSound.innerHTML = "<embed name=\"kingreward\" src=\"http://www.free-midi.org/midi1/k/katy_perry-firework.mid\" type=\"audio/midi\" autostart=\"true\" hidden=\"true\" loop=\"true\" mastersound enablejavascript=\"true\"><noembed><bgsound src=\"http://www.free-midi.org/midi1/k/katy_perry-firework.mid\" loop=\"infinite\"></noembed></embed>";
