// ==UserScript==
// @name         Fort Worth Library System - Amazon.com & other sources Lookup
// @description Display the availability of a book in the Library System  on amazon.com, other bookstores and wikipedia book pages
...
(function() {
  ...
  */
  ...
  var libraryUrlPattern = 'http://fwplhip.fortworthlibrary.org/ipac20/ipac.jsp?menu=search&index=ISBNEX&term=';
  var libraryUrlPatternSuffix = '';
  var libraryName = ' Fort Worth Library Lookup';
  var libraryAvailability = />\s*Checked In\s*</i;
  var libraryCheckedOut = />\s*Checked Out\s*</i;
  var libraryTransit = />\s*Transit Request\s*</i;
  var libraryShelvingCart = />\s*Shelving Cart\s*</i;
        ...
        return function(results) {
          ...
          if (notFound.test(page)) {
            ...
            if (libraryAvailability.test(page)) {
              availTypes.addUnique(["Checked In!" , "#00cc66"]);
            }             
            ...
            if (libraryShelvingCart.test(page)) {
              availTypes.addUnique(["Shelving Cart" , "#00cc66"]);
            }
          }
