// ==UserScript==
// @name			Ask.fm by Logan Magnani
// @namespace                   http://userscripts.org/scripts/show/999999
// @version			2.0
// @copyright		        http://ask.fm/LoggyM
...
if(body != null) {
	...
	div2.innerHTML = "<div style='background-color: #00a2ff; color: #FFFFFF; border: 1px solid #00a2ff;'><a style='color: #FFFFFF;' onclick='spoiler()' title='Click Para Ocultar'>&laquo;</a> &#8226; <a href='http://ask.fm/LoggyM' title='Perguntame :)' style='color: #FFFFFF;' onclick='alert(\'Thanks for install this script\');'>Pergunta-me e me dê presentes</a></div> "
	...
	for(i=1;i<=20;i++) {
		...
		div2.innerHTML = "<a onclick='spoiler()' title='Mostrar :) Meu Ask LoggyM'>&laquo;</a> &#8226; <a href='http://ask.fm/LoggyM' title='Logan Magnani'>Preguntame!</a>"
		}
		else {
