// ==UserScript==
// @name           Subir a importantes Argentino
// @namespace      -
...
if(estenombre.innerHTML.indexOf('lastpost')==-1&&estenombre.innerHTML.indexOf('firstnew')==-1&&estenombre.innerHTML.indexOf('page=')==-1)
	{	
		...
		var http="http://board.ar.ogame.org/modcp.php?action=thread_top&x=51&y=20&threadid="+idusu+"&sid=";
		...
		enlace.innerHTML="  <img alt='Subir Importantes' border='0' src='http://servercugar.dyndns.org/sergio/moderadores/Importante.png' width='20' height='20'/>";
