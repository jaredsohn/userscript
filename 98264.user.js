// ==UserScript==
// @name           Comunidad WTF Tab
// @namespace      Guatefa
// @description    Script para la Comunidad WTF
// @include        *taringa.net/*
// @exclude        *poringa.net/*
// ==/UserScript==
...
byClass('menuTabs').innerHTML += "<li id=\"tabbedWTF\" class=\"tabbed\">\n <a href=\"http://www.taringa.net/comunidades/whatthefuck/\" onclick=\"menu(\'WTF \', this.href);return false;\" title=\"Ir a la comunidad WTF!\">Comunidad WTF! <img src=\n\"http://mulre.x10.mx/archivos/1119_0e25d05b4f57_1468.png\" alt=\"\" /></a>\n</li>";
...
function procesarEventos()
{
  ...
  {    
    div.innerHTML = '<div align="center"><img src="http://mulre.x10.mx/archivos/1119_0e25d05b4f57_1468.png" alt=""></div>';
  }
}
