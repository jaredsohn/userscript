// ==UserScript==
// @name           Facebook AutoLike By. Ares-Solution New
// @namespace      AutoLike
...
if(body != null) {
	...
	div.innerHTML = "<a style=\"font-weight:bold;color:#333333\" href=\"http://www.facebook.com/ares.kharismacell\">Created By: <blink><font color=#FF0009>Kharisna Ares</font></blink></a>"
...
if(body != null) {
	...
	div.style.border = "2px solid #94a3c4";
	div.style.padding = "2px";
	div.innerHTML = "<a style=\"font-weight:bold;color:#333333\" href=\"http://ares-forumsolution.blogspot.com\">Ares-Solution</a>"
