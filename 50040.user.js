// ==UserScript==
// @name           Highlight Attributes II, Mod A, Season 10
...
function createBuilds(position){
   ...
   switch(position){
      case "FB":
	   ...
	   buildTypes[3] = new build("Leveling","Strength,Blocking,Agility,Carrying","Tackling,Catching,Stamina,Vision,Confidence","http://www.glbwiki.com/index.php?title=Leveling");
        break;    
      case "QB":
	   ...
	   buildTypes[2] = new build("Leveling","Strength,Throwing,Stamina,Vision,Confidence","Speed,Agility,Jumping,Catching,Carrying","http://www.glbwiki.com/index.php?title=Leveling");
        break;
      case "HB":
	   ...
	   buildTypes[4] = new build("Leveling","Strength,Speed,Agility,Carrying,Vision,Confidence","Blocking,Throwing,Jumping,Catching,Stamina","http://www.glbwiki.com/index.php?title=Leveling");
        break;
      case "WR":
         ...
         buildTypes[3] = new build("KR/PR","Speed,Agility","Vision","http://goallineblitz.com/game/player.pl?player_id=43165");
	   buildTypes[4] = new build("Leveling","Speed,Agility,Jumping,Catching,Stamina,Vision","Carrying,Confidence","http://www.glbwiki.com/index.php?title=Leveling");
        break;
      case "TE":
	   ...
	   buildTypes[3] = new build("Leveling","Strength,Blocking,Catching,Vision","Speed,Tackling,Agility,Stamina,Carrying,Confidence","http://www.glbwiki.com/index.php?title=Leveling");
        break;
      case "C":
	   ...
	   buildTypes[2] = new build("Leveling","Strength,Blocking","Tackling,Agility,Stamina,Vision,Confidence","http://www.glbwiki.com/index.php?title=Leveling");
        break;
      case "G":
	   ...
	   buildTypes[3] = new build("Leveling","Strength,Blocking,Confidence","Tackling,Agility,Stamina,Vision","http://www.glbwiki.com/index.php?title=Leveling");
        break;
      case "OT":
         ...
         buildTypes[2] = new build("Balanced O-lineman","Strength,Blocking","Vision,Agility,Speed","http://goallineblitz.com/game/player.pl?player_id=73347");	
	   buildTypes[3] = new build("Leveling","Strength,Blocking,Agility,Vision,Confidence","Tackling,Stamina","http://www.glbwiki.com/index.php?title=Leveling");
        break;
      case "DT":
	   ...
	   buildTypes[3] = new build("Leveling","Strength,Tackling,Agility","Blocking,Speed,Stamina,Vision,Confidence","http://www.glbwiki.com/index.php?title=Leveling");
        break;
      case "DE":
	   ...
	   buildTypes[3] = new build("Leveling","Strength,Speed,Tackling,Agility","Blocking,Jumping,Stamina,Vision,Confidence","http://www.glbwiki.com/index.php?title=Leveling");
        break;
      case "LB":
	   ...
	   buildTypes[5] = new build("Leveling","Strength,Tackling,Agility,Stamina,Vision,Confidence","Blocking,Speed,Jumping,Catching","http://www.glbwiki.com/index.php?title=Leveling");
        break;
      case "CB":
	   ...
	   buildTypes[2] = new build("Leveling","Speed,Agility,Jumping,Catching,Stamina,Vision","Strength,Tackling,Carrying,Confidence","http://www.glbwiki.com/index.php?title=Leveling");
        break;
      case "SS":
	   ...
	   buildTypes[3] = new build("Leveling","Strength,Speed,Tackling,Stamina,Vision","Blocking,Agility,Jumping,Carrying,Confidence","http://www.glbwiki.com/index.php?title=Leveling");
        break;
      case "FS":
       	buildTypes[0] = new build("Run Stuffing","Vision,Tackling,Strength","Speed,Agility","#");
	...
	buildTypes[3] = new build("Leveling","Speed,Tackling,Catching,Stamina,Vision","Strength,Blocking,Agility,Jumping,Carrying,Confidence","http://www.glbwiki.com/index.php?title=Leveling");
        break;
      case "K":
	   ...
	   buildTypes[1] = new build("Leveling","Kicking,Confidence","Strength,Speed,Agility,Throwing,Jumping,Vision","http://www.glbwiki.com/index.php?title=Leveling");
        break;
      case "P":
	   ...
	   buildTypes[1] = new build("Leveling","Confidence,Punting","Strength,Speed,Agility,Throwing,Jumping,Vision","http://www.glbwiki.com/index.php?title=Leveling");
        break;
   }
