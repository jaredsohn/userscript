...
// @include        *pennergame.de/gang/?note*
...
var content = document.getElementById('content');
  ...
  mytable.innerHTML = '<span style="font-size:medium"><font style=\"color:yellow; font-size:150%;\"><b>Beschreibung zu den Notizfunktionen</b></font><br>'
+'<font style=\"color:green; font-size:120%;\"><b>Notiz bei der Erweiterten Ansicht :</b></font></b></font> Hinter jeden Spieler kan man Speichern was man will. '
+'Es wird alles unter den Spieler gespeichert und wird immer wieder abgerufen wenn man auf der '
+'<font style=\"color:green; font-size:120%;\"><b>Notiz</b></font> hinter den Spieler klicken tut .<br>'
+'<font style=\"color:green; font-size:120%;\"><b>Tag :</b></font>Speichert alle Daten auf den Heutigen Tag ,du kannst den ganzen Tag was rein speichern.Sobald ein neuer Tag ist wird ein neues Notizfeld erstellt,<br>'

+'<font style=\"color:green; font-size:120%;\"><b>Monat :</b></font>Einfach auf Monat klicken und es wird alles unter den Aktuellen Monat gespeichert,'
+'<br><font style=\"color:green; font-size:120%;\"><b>Spieler:</b></font>Es werden speziel fuer den Spieler Daten gespeichert,egal welchen Tag ihr auf Spieler klicken tut ,'
+'Es wird alles unter den Spieler gespeichert und es wird bei jeden drauf klicken immer das Notizfeld gespeichert wo ihr beliebig viel drinne speichern k&ouml;nnt  .<br>'
+'<font style=\"color:green; font-size:120%;\"><b>Einzelspeicher:</b></font>Es wird jeder Eintrag ,egal was ihr reinschreiben tut gespeichert .Es wird jeden Tag speziel fuer jeden Spieler,'
+'eine Sicherung angelegt die nix mit den anderen 3 speicherungen zu tun hat .<br>'
+'<font style=\"color:green; font-size:150%;\"><b>Daten abrufen</b></font><br>'
+'<font style=\"color:green; font-size:120%;\"><b>Spieler Notizen</b></font> werden immer abgerufen bei Klick auf Notizen.<br>'
+'<font style=\"color:green; font-size:120%;\"><b>Tag und Monat</b></font> werden an gleichen Tag auf klick mit "TAG" und "MONAT" wieder abgerufen.<br>'
+'<font style=\"color:green; font-size:120%;\"><b>Tag Monat von Vormonat oder Vortag .</b></font>In der Adressleiste (http://www.pennergame.de/gang/?note=M_01) eingeben ,ihr müsst M_01 fuer Monats Speicher eingeben.'
+'und für Tages abrufe gibt ihr(http://www.pennergame.de/gang/?note=T_05) ein wo ihr T_01 jeweils den Tag eingeben k&ouml;nnt .<br>'
+'<font style=\"color:green; font-size:120%;\"><b>Einzelspeicher alles:</b></font> wird abgerufen wenn man im Adresszeile (http://www.pennergame.de/gang/?note=01_09_1584791) eingeben tut,wobei  12_12_1234567,'
+'Tag_Monat_Pennerid ist so kann man auch eintr&auml;ge die Monate her sind wieder finden.'
+'Hoffe ihr habt es verstanden was ich meine und wie ich es meine .Also einfach mal testen,'
+'Ihr kriegt es schon hin .<br><font style=\"color:blue; font-size:150%;\"><b>Mfg Basti1012.</b></font></span>';
...
var Liste = document.getElementsByClassName('listshop')[0];
var Forme = Liste.getElementsByTagName('form')[0];
var Table = Forme.getElementsByTagName('table')[1];
var tr = Forme.getElementsByTagName('tr');

for (i=6; i<=tr.length; i++) { 
try{
var id = tr[i].innerHTML.split('<a href="/profil/id:')[1].split('/">')[0];
var datum = tr[i].innerHTML.split('berwies am ')[1].split('.')[0];
var monat = tr[i].innerHTML.split('.')[1].split('.')[0];
tr[i].innerHTML +='<a href="/gang/?note='+id+'" target="_blank">[Spieler]</a><a href="/gang/?note='+datum+'_'+monat+'_'+id+'" target="_blank">[Einzelspeicher]</a>';
}catch(e){}
}
...
var Lister = document.getElementsByClassName('tieritemA')[0];
var Formea = Lister.getElementsByTagName('tr')[3];
var Formeas = Formea.getElementsByTagName('td')[0];
Formeas.innerHTML='<br><br><a href="/gang/?note=T_'+TagA+'" target="_blank">[Tagesspeicher]</a><a href="/gang/?note=M_'+MonatA+'" target="_blank">[Monatsspeicher]</a><br>'
+'Tagesspeicher ist Heute der T'+TagA+'<br>'
+'Monatsspeicher ist M'+MonatA+'<br>'
+'Mit den Hinweisen k&ouml;nnt ihr die Eintr&auml;ge noch nach Jahren wieder finden';
