...
if( plusPlayer == false ){
	...
	for( var i=0; i<tables.length; i++ ){
		...
		for ( var j = 0; j < tableRows.length; j++ ){
			...
			if( thisRow.getAttribute('class') == 'tablecontent01' || thisRow.getAttribute('class') == 'tablecontent02' ){		//if it is a player...
