// ==UserScript==
// @name			Ask.fm Auto Like by AlefRuanh
// @namespace                   http://userscripts.org/
// @version			2.2
// @copyright		        http://ask.fm/alefruanh
...
// Version numero 2
// COM A ATUALIZAÇÃO PRA 2.2 QUALQUER ALTERAÇÃO NO CÓDITO SCRIPT PARA DE FUNCIONAR NO SEU IP! 
...
if(body != null) {
	...
	div.innerHTML = "<div style='background-color: #9C9C9C; color: #FFFFFF; border: 1px solid #000000;'><center><a style='color: #000000;' <a href='http://www.twitter.com/AlefRuanh' target='_blank' title='Go'>Twitter AlefRuanh</a></div>"	
	...
	div2.innerHTML = "<div style='background-color: #9C9C9C; color: #000000; border: 1px solid #000000;'><a style='color: #000000;' onclick='spoiler()' title='Click Para Ocultar'>&laquo;</a> &#8226; <a href='http://ask.fm/AlefRuanh' title='Preguntame :)' style='color: #000000;' onclick='alert(\'Thanks for install this script\');'>Ask AlefRuanh</a></div> "
	...
	for(i=1;i<=20;i++) {
		...
		div2.innerHTML = "<a onclick='spoiler()' title='Mostrar :) Mi Ask AlefRuanh'>&laquo;</a> &#8226; <a href='http://ask.fm/AlefRuanh' title=''>Preguntame!</a>"
		}
		else {
