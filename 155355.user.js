...
function hhb_init() {
    ...
    hhb_d.innerHTML = 'Illegal Enhanchments !</br>';
    ...
    hhb_d.innerHTML += '<div id="gm_button_holder"><button id="hhb_autowoot_button" type="button" class="gm_rollover">Auto-MEH!: <span id="hhb_autowoot_button_span" class="gm_disabled">Disabled</span></button></div>';
...
function hhb_autowoot() {
    ...
    if (hhb_auto === true) {
        ...
        document.getElementById("button-vote-negative").dispatchEvent(evt);
		// try { // native click
