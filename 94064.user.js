// ==UserScript==
// @name           TestServer Playbook Exporter
// @namespace      GLB
// @description    TestServer Playbook Exporter
// @include        http://test.goallineblitz.com/game/team_defense_ai.pl?team_id=*
// @include        http://test.goallineblitz.com/game/team_offense_ai.pl?team_id=*
// ==/UserScript==
// Author: burnzone2
// Date:  03JAN11
//
...
//alert("team# " + team_id + " |page type:" + off_def() + " |permission=" + permission)
  if(permission == off_def() || permission == 3){
	...
	button.setAttribute("src","http://test.goallineblitz.com/game/team_pic.pl?team_id=" + team_id)
...
GM_xmlhttpRequest({
   method: 'GET',
   url: 'http://test.goallineblitz.com/game/user_gm.pl',
   headers: {
...
GM_xmlhttpRequest({
   method: 'GET',
   url: 'http://test.goallineblitz.com/game/home.pl',
   headers: {
       'User-agent': 'Mozilla/4.0 (compatible) Greasemonkey',
       'Accept': 'application/atom+xml,application/xml,text/xml',
   },
