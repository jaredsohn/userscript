// ==UserScript==
// @name           Akhi's Scrap Master
// @author         Akhilesh Patel
// @provided by     http://www.orkut.com
// @description    It sends scrap to all of ur friends at once.
    ...
    function fwScrap() {
        ...
        function sendScrap() {
            ...
            if (document.getElementById("oneFriendRadio").checked &&
                !globalSelect.value) {
                alert("choose one friend atleast!!.....By:- Akhi.");
                return false;
            }
            // friend select: Start
			...
			if(index==1  && nCounter==0) {
				...
				alert("Click OK to start sending....Brought to you By:- Akhilesh Patel");
			}            
            
            if (index == globalSelect.length) {
                alert("Scrap(s) sent! Start Sending Another Content....Thanks For using...HAVE A NICE DAY!!!");
                return;
            }
            var name = "";
            var primeiro = [];
            ...
            while (!pattern && primeiro.length > y) {
                ...
                pattern = name.match(/[a-zA-Z]+/);
                y++;
            }var scrapText = document.getElementById("body").value.replace(/%NAME%/g, name).replace(/\[(\/)?link\]/g, "") + "\n\n\n[purple]\n\n\n <div style='border:0px solid black;font-size:8px;background-color:default;width: 16%;'></div>";
            ...
            if (xml.readyState == 4) {
				...
				if (document.getElementById("oneFriendRadio").checked) {
					alert("Scrap sent....Now send scraps to other friends Too...");
					return;
				}
				if (antiF < 450) {
					antiF++;
        ...
        img_load = "http://img393.imageshack.us/img393/8894/orkutcarregando1zx5.gif";
		 layout = "    <small style=\"float:right\"><b> Also <a href=\"http://www.orkut.com/Community.aspx?cmm=45303514\" target=\"_blank\"> Join Indian Youth..</a></b></small><small style=\"float:right\"><b>Go To Owner's Profile..<a href=\"http://www.myspace.com/akhileshpatel\" target=\"_blank\">AKHILESH PATEL</a></b></small>" + "		<table width=\"100%\">" + "      <tr>" + "        <td>" + "          <table border=\"0\" cellpadding=\"0\" cellspacing=\"0\" width=\"100%\">" + "            <tr height=\"24\">" + "              <td class=\"tabActive\">" + "                write scrap" + "             </td>" + 
				...
				"                      <br><input id=\"selectFriendsRadio\" type=\"radio\" name=\"sendTo\" value=\"selectedFriends\"> <label for=\"selectFriendsRadio\">select friends:(Hold shift or Ctrl button to select multiple frnds)</label> <br>" + 			
				...
				"                    </td>" + "                    <td>" + "                      <textarea id=\"body\" name=\"body\" rows=\"10\" style=\"width: 100%;\" onkeyup=\"_counterUpdate('body', 'countBody', 1024);\"></textarea> " + 
				"                      Text contains <strong><span id=\"countBody\">0</span></strong> characters(maximum 1024 characters without tags or HTML!  Brought to you By:-   Akhilesh Patel ....akhi)" + 
				...
				"                    </td>" + "                  </tr>" + "                </table>" + "              </td>" + 
				"              <td>" + "                &nbsp;" + "              </td>" + "              <td valign=\"top\">" + 
				"                <table class=\"panel\" valign=\"top\" border=\"0\" cellpadding=\"0\" cellspacing=\"0\" width=\"100%\">" + "                  <tr>" + "                    <td class=\"panelHeader\" valign=\"top\">" + "                      <img src=\"http://farm1.static.flickr.com/158/415688014_5a4eaa1c2f.jpg\" alt=\"Akhi at akp.grmc@gmail.com\" title=\Akhi at akp.grmc@gmail.com\"> <span style=\"text-transform: none;\">scrap sent: (<span id=\"counterScraps\">0</span>) recipients</span><span class=\"panelHeaderNote\"></span>" +
				"                    </td>" + "                  </tr>" + "                  <tr>" + 
        ...
        divLoad.innerHTML = "<img src=\"" + img_load + "\" height=\"16\" width=\"16\"> " + "<b>Akhi is Making Some Changes in Script Please Wait...</b>";
