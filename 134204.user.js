...
// @description    Little Tweaks on others bots
// ==/UserScript==


var Version = '20120324a_mm';
...
unsafeWindow.CraftingItem = t.CraftingItem;
    ...
    var m = '<DIV class=pbStat>Think Rugs</div><TABLE class=pbTab><TR align=center>';
...
&nbsp;<INPUT id=pbnum3 type=text size=4 maxlength=4 value="'+ Options.celltext.num3 +'"  '+(Options.celltext.provider==0?'DISABLED':'')+'\> <span style="color:#800; font-weight:bold"><sup>*This might cost money</sup></span></td></tr><tr><td></td>\
...
Tabs.transport = {
  ...
  check:false,
    ...
    init: function(div){
      ...
      var m = '<DIV id=pbTowrtDivF class=pbStat>Think Massive Range</div><TABLE id=pbtraderfunctions width=100% height=0% class=pbTab><TR align="center">';
