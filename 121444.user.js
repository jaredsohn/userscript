...
// @description    Reporte FAA
// ==/UserScript==

var FORM_URL = "https://docs.google.com/spreadsheet/viewform?hl=en_US&formkey=dEtMMnhMazBhY0VlOW44cE1rLTdxdUE6MQ#gid=0";
...
var LOCALE = {
	...
	bg: function() {
		return {
			...
			send_report: "Estas listo para enviar el reporte a FAA?",
...
var main = function() {
	...
	<a title="Reportar a FAA" href="javascript:;" id="bs_report_pop_send">Reportar a FAA</a>                                         \
