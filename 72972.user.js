// ==UserScript==
// @author         junecaz
// @name           br-army paraquedista-4
// @namespace      http://www.erepublik.com/en/citizen/profile/439192
// @description    br-army paraquedista-4
// @version        0.2
...
var html = '<embed width="500" height="30" src="/flash/delicious.swf" quality="best" flashvars="txt=Exercito Brasileiro - Paraquedistas 4&amp;&amp;textcolor=#737373&amp;hovercolor=null&amp;linkcolor=null&amp;w=250&amp;h=28" wmode="transparent" bgcolor="transparent" sifr="true" type="application/x-shockwave-flash" class="sIFR-flash" style="width: 250px; height: 28px;"/>'
var nMembers
var count = 0
...
function Main(e) {
	GM_xmlhttpRequest({
		...
		onload:function(response) {
			var spisak_string = response.responseText.match('id="msg_42283".*?#');
