...
var settings = {
	'keys': ['findNewPoke', 'autoBattle', 'findRare', 'findLegendary'],
	'data': {},
	'save': function() {
...
function findnewPoke() {
	...
	for (var i = 0; i < newPoke.length; i++) {
		if (wildText.match(newPoke[i])) {
			unsafeWindow.console.info('Newpoke found ', wildText);
			return;
		}
	}
