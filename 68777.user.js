...
// Created by Puli and partly modified by PWG

"use strict";

var wardrobe_text={en:'Wardrobe', ro:'Garderobă', sk:'Å atnÃ­k', cz:'SkrÃ­n'};
var new_name_text={en:'New name', ro:'Nume nou', sk:'NovÃ½ nÃ¡zov', cz:'NovÃ½ nÃ¡zev'};
var cancel_button_text={en:'Cancel', ro:'Anula&#355;i', sk:'ZruÅ¡it', cz:'ZruÅ¡it'};
var delete_button_text={en:'Delete', ro:'&#350;terge', sk:'Zmazat', cz:'Smazat'};
var save_button_text={en:'Save', ro:'Salvează', sk:'UloÅ¾it', cz:'UloÅ¾it'};
var save_message_text={en:'Wardrobe is saved', ro:'Garderoba este salvată', sk:'Å atnÃ­k bol uloÅ¾enÃ½', cz:'SkrÃ­n byla uloÅ¾ena'};
var confirm_overwrite_text={
	en:'Do you realy want to overwrite wardrobe ',
        ro:'Chiar doriți să ștergeți garderoba ',
...
var save_choose_name_error_text={
	en:'You must pick "New name" or one existing wardrobe!',
        ro:'Selectați "Nume nou" sau o garderobă deja existentă!',
...
var save_invalid_name_error_text={
	en:'Wardrobe name contains invalid characters!',
        ro:'Numele garderobei conține caractere invalide!',
...
var delete_choose_name_error_text={
	en:'You must pick existing wardrobe!',
        ro:'Mai întai alegeți o garderobă care există!',
...
function createDropdown()
{
	...
	newLI.innerHTML='<a href="#"><img src="http://wiki.the-west.ro/images/d/d8/Icongarderoba.PNG" style="z-index:100"/><span style="width: 102px; color: rgb(255, 255, 255); display: block; z-index: 200; font-size: 13px; position: relative; top: -20px; text-align: center; left: 24px;">'+wardrobe_text[gLang]+'</span></a>';
