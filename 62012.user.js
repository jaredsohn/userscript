// ==UserScript==
// @name           Highscoremultianzeige von NewMan V1.1
...
// @exclude        http://highscore.pennergame.de/highscore/gang/
// ==/UserScript==
...
function user (x, id, dom, premium_bild, trk) {
	...
	if (ausgabe[0] == 1) {
		document.getElementById('td1.'+x).innerHTML = '<table style="height:100%; width:100%;"><tr><td><b><a href="http://www.pennergame.de/profil/id:' + id + '/" style="color:white;text-decoration:none;">' + name + ' ' + premium_bild + '</a></b></td></tr><tr><td>' + reg +'</td></tr><tr><td id="td1.3.'+x+'">'+ points +'</td></tr><tr><td>'+ cash_show_profil +'</td></tr><tr><td>'+ promille_show +'</td></tr><tr><td>'+ bandenstatus +'</td></tr><tr><td id="td1.4.'+x+'"></td></tr><tr style="height:100%;"><td id="td1.5.'+x+'" style="vertical-align:bottom;">'+ note_button +'</td></tr></table>';
		
		
	} else if (ausgabe[0] == 2){
		document.getElementById('td1.'+x).innerHTML = '<table style="height:100%; width:100%;"><tr><td><b><a href="http://www.pennergame.de/profil/id:' + id + '/" style="color:white;text-decoration:none;">' + name + ' ' + premium_bild + '</a></b></td></tr><tr><td  id="td1.3.'+x+'">' + points +'</td></tr><tr><td>'+ reg +'</td></tr><tr><td>'+ cash_show_profil +'</td></tr><tr><td>'+ promille_show +'</td></tr><tr><td>'+ bandenstatus +'</td></tr><tr><td id="td1.4.'+x+'"></td></tr><tr style="height:100%;"><td id="td1.5.'+x+'" style="vertical-align:bottom;">'+ note_button +'</td></tr></table>';

	} else if (ausgabe[0] == 3){
		document.getElementById('td1.'+x).innerHTML = '<table style="height:100%; width:100%;"><tr><td><b><a href="http://www.pennergame.de/profil/id:' + id + '/" style="color:white;text-decoration:none;">' + name + ' ' + premium_bild + '</a></b></td></tr><tr><td  id="td1.3.'+x+'">' + points +'</td></tr><tr><td>'+ cash_show_profil +'</td></tr><tr><td>'+ promille_show +'</td></tr><tr><td>'+ reg +'</td></tr><tr><td>'+ bandenstatus +'</td></tr><tr><td id="td1.4.'+x+'"></td></tr><tr style="height:100%;"><td id="td1.5.'+x+'" style="vertical-align:bottom;">'+ note_button +'</td></tr></table>';

	} else if (ausgabe[0] == 4){
		document.getElementById('td1.'+x).innerHTML = '<table style="height:100%; width:100%;"><tr><td><b><a href="http://www.pennergame.de/profil/id:' + id + '/" style="color:white;text-decoration:none;">' + name + ' ' + premium_bild + '</a></b></td></tr><tr><td>' + cash_show_profil +'</td></tr><tr><td id="td1.3.'+x+'">'+ points +'</td></tr><tr><td>'+ promille_show +'</td></tr><tr><td>'+ reg +'</td></tr><tr><td>'+ bandenstatus +'</td></tr><tr><td id="td1.4.'+x+'"></td></tr><tr style="height:100%;"><td id="td1.5.'+x+'" style="vertical-align:bottom;">'+ note_button +'</td></tr></table>';

	} else if (ausgabe[0] == 5){
		document.getElementById('td1.'+x).innerHTML = '<table style="height:100%; width:100%;"><tr><td><b><a href="http://www.pennergame.de/profil/id:' + id + '/" style="color:white;text-decoration:none;">' + name + ' ' + premium_bild + '</a></b></td></tr><tr><td>' + bandenstatus +'</td></tr><tr><td id="td1.3.'+x+'">'+ points +'</td></tr><tr><td>'+ reg +'</td></tr><tr><td>'+ cash_show_profil +'</td></tr><tr><td>'+ promille_show +'</td></tr><tr><td id="td1.4.'+x+'"></td></tr><tr style="height:100%;"><td id="td1.5.'+x+'" style="vertical-align:bottom;">'+ note_button +'</td></tr></table>';

	} else if (ausgabe[0] == 6){
		document.getElementById('td1.'+x).innerHTML = '<table style="height:100%; width:100%;"><tr><td><b><a href="http://www.pennergame.de/profil/id:' + id + '/" style="color:white;text-decoration:none;">' + name + ' ' + premium_bild + '</a></b></td></tr><tr><td>' + promille_show +'</td></tr><tr><td>'+ cash_show_profil +'</td></tr><tr><td>'+ reg +'</td></tr><tr><td id="td1.3.'+x+'">'+ points +'</td></tr><tr><td>'+ bandenstatus +'</td></tr><tr><td id="td1.4.'+x+'"></td></tr><tr style="height:100%;"><td id="td1.5.'+x+'" style="vertical-align:bottom;">'+ note_button +'</td></tr></table>';

	}
	else {
		document.getElementById('td1.'+x).innerHTML = '<table style="height:100%; width:100%;"><tr><td><b><a href="http://www.pennergame.de/profil/id:' + id + '/" style="color:white;text-decoration:none;">' + name + ' ' + premium_bild + '</a></b></td></tr></table>';
	}
...
function gang_info (x, gang_id, id, trk) {
	GM_xmlhttpRequest({
    	method: 'GET',
   		url: 'http://www.pennergame.de/dev/api/gang.' + gang_id + '.xml',
		onload: function(responseDetails) {
        	var parser = new DOMParser();
        	var dom = parser.parseFromString(responseDetails.responseText, "application/xml");
...
function gang (x, gang_id, dom, id, trk) {	
	...
	if (ausgabe[0] == 1) {
		document.getElementById('td2.'+x).innerHTML = '<table style="height:100%; width:100%;"><tr><td><b><a href="http://www.pennergame.de/profil/bande:' + gang_id + '/" style="color:white;text-decoration:none;">' + name + '</a></b></td></tr><tr><td>' + points +'</td></tr><tr><td>'+ position +'</td></tr><tr><td>'+ member_count +'</td></tr><tr><td>'+ mean +'</td></tr><tr><td id="td2.5.'+x+'"></td></tr><tr style="height:100%;"><td id="td2.6.'+x+'" style="vertical-align:bottom; ">'+ gang_note_button+'</td></tr></table>';
	} else if (ausgabe[0] == 2) {
		document.getElementById('td2.'+x).innerHTML = '<table style="height:100%; width:100%;"><tr><td><b><a href="http://www.pennergame.de/profil/bande:' + gang_id + '/" style="color:white;text-decoration:none;">' + name + '</a></b></td></tr><tr><td id="td2.5.'+x+'"></td></tr><tr><td>' + position +'</td></tr><tr><td>'+ points +'</td></tr><tr><td>'+ mean +'</td></tr><tr><td>'+ member_count +'</td></tr><tr style="height:100%;"><td id="td2.6.'+x+'" style="vertical-align:bottom;">'+ gang_note_button+'</td></tr></table>';
	} else if (ausgabe[0] == 3) {
		document.getElementById('td2.'+x).innerHTML = '<table style="height:100%; width:100%;"><tr><td><b><a href="http://www.pennergame.de/profil/bande:' + gang_id + '/" style="color:white;text-decoration:none;">' + name + '</a></b></td></tr><tr><td>' + member_count +'</td></tr><tr><td>'+ position +'</td></tr><tr><td>'+ points +'</td></tr><tr><td id="td2.5.'+x+'"></td></tr><tr><td>'+ mean +'</td></tr><tr style="height:100%;"><td id="td2.6.'+x+'" style="vertical-align:bottom;">'+ gang_note_button+'</td></tr></table>';
	} else if (ausgabe[0] == 4) {
		document.getElementById('td2.'+x).innerHTML = '<table style="height:100%; width:100%;"><tr><td><b><a href="http://www.pennergame.de/profil/bande:' + gang_id + '/" style="color:white;text-decoration:none;">' + name + '</a></b></td></tr><tr><td>' + points +'</td></tr><tr><td>'+ member_count +'</td></tr><tr><td>'+ mean +'</td></tr><tr><td>'+ position +'</td></tr><tr><td id="td2.5.'+x+'"></td></tr><tr style="height:100%;"><td id="td2.6.'+x+'" style="vertical-align:bottom;">'+ gang_note_button+'</td></tr></table>';
	} else if (ausgabe[0] == 5) {
		document.getElementById('td2.'+x).innerHTML = '<table style="height:100%; width:100%;"><tr><td><b><a href="http://www.pennergame.de/profil/bande:' + gang_id + '/" style="color:white;text-decoration:none;">' + name + '</a></b></td></tr><tr><td>'+ mean +'</td></tr><tr><td id="td2.5.'+x+'"></td></tr><tr><td>' + points +'</td></tr><tr><td>'+ position +'</td></tr><tr><td>'+ member_count +'</td></tr><tr style="height:100%;"><td id="td2.6.'+x+'" style="vertical-align:bottom;">'+ gang_note_button+'</td></tr></table>';
	} else if (ausgabe[0] == 6) {
		document.getElementById('td2.'+x).innerHTML = '<table style="height:100%; width:100%;"><tr><td><b><a href="http://www.pennergame.de/profil/bande:' + gang_id + '/" style="color:white;text-decoration:none;">' + name + '</a></b></td></tr><tr><td>'+ member_count +'</td></tr><tr><td id="td2.5.'+x+'"></td></tr><tr><td>'+ mean +'</td></tr><tr><td>' + points +'</td></tr><tr><td>'+ position +'</td></tr><tr style="height:100%;"><td id="td2.6.'+x+'" style="vertical-align:bottom;">'+ gang_note_button+'</td></tr></table>';
	}
	else {
		document.getElementById('td2.'+x).innerHTML = '<table style="height:100%; width:100%;"><tr><td><b><a href="http://www.pennergame.de/profil/bande:' + gang_id + '/" style="color:white;text-decoration:none;">' + name + '</a></b></td></tr></table>';
	}
...
function check_pact(u_gang_id){
	GM_xmlhttpRequest({
		method: 'GET',
		url: 'http://www.pennergame.de/profil/bande:'+ u_gang_id +'/',
		onload: function(responseDetails) {
			try{
				var side = responseDetails.responseText;
		...
		try {
			...
			if (check(18) || check(29) || check(28)){
				try {
					...
					var tier_tip = side_split_10[0].replace(/href="/g, 'href="http://www.pennergame.de');
...
//Copyright by NewMan im Pennergame unter NewMan01 zu finden
	if (check(28) || check(29)){
		...
		if(tier_bild.indexOf('http://media.pennergame.de/img/tiere/') != -1){
...
function move_submenu() {
	try {
		...
		document.getElementsByTagName('li')[7].innerHTML = '<a href="http://highscore.pennergame.de/highscore/">Spieler</a>';
		document.getElementsByTagName('li')[8].innerHTML = '<a href="http://highscore.pennergame.de/highscore/gang/">Banden</a>';
		for (h = 0; h <= 8; h++){
