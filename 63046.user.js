// ==UserScript==
// @name           تدريب القوات على مستوى الملكه
...
// @include        http://ae*.tribalwars.ae/game.php?*mode=mass*
// ==/UserScript==
...
(function(){
	...
	var lang = {
		'ae': {
			'settings': '«www.plapl.com» تابعونا على منتديات بلابل' + '«www.tw4me.com»و ايضا على مدونات بلابليه' , 
			'troupsize': 'عدد القوات المطلوبه',
			'troupsizedesc': 'قوات المرجوة للقرية (ليس فقط من أجل تشغيل هذا).',
			'openend': 'بناء المزيد من:',
			'openenddesc': 'إذا قوات المنشود هو التوصل الى تبني المزيد حتى المزرعة بالكامل.',
			'farmfree': 'ابقى مكان في المزارع',
			'farmfreedesc': 'كم يجب انا يبقى مكان في المزارع (مثال:100 لي النبيل).',
			'resfree': 'الموارد المتبقيه:',
			'resfreedesc': 'كيب يجب ان يبقى في المخازن',
			'save': 'خزن',
			'fill': 'يملأ',
			'recruit': 'جند',
			'running': 'جاري...',
			'troupneeds': '(المطلوب قوات احتياجات العمال 1 ?)',
			'filled': 'Filled: %1 in %2 villages',
			'settoobig': 'Massrecruitment إعدادات كبيرة جدا ليتم حفظ في ملف. لحل هذه المشكلة ، حذف بعض المجموعات الخاصة بك.'
		},
		'de': {
			'settings': 'Einstellungen für Gruppe',
			'troupsize': 'Gewünschte Truppenst?rke:',
			...
			'openenddesc': 'Wenn die gewünschte Truppenst?rke erreicht wurde, wird weiter gebaut, bis der BH voll ist.',
			'farmfree': 'BH-Pl?tze frei lassen:',
			'farmfreedesc': 'Wie viel BH-Pl?tze sollen frei gelassen werden (z.B. 100 für ein AG).',
			...
			'recruit': 'Rekrutieren',
			'running': 'l?uft...',
			'troupneeds': '(Wunschtruppe ben?tigt %1 Arbeiter)',
			'filled': 'Ausgefüllt: %1 in %2 D?rfern',
			'settoobig': 'Die Einstellungen für die Massenrekrutierung sind zu gro? um in einem Cookie gespeichert zu werden. Es kann daher zu Problemen kommen. Das L?schen einiger Gruppen kann das Problem l?sen.'
		}
	};
	
	var curlang = 'ae';
	if(/ae\d+\.tribalwars\.ae/.test(location.href)) {
		curlang = 'ae';
