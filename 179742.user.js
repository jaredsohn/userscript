// ==UserScript==
// @name            *[Updated]* AutoLike +PLUS Facebook 12/10/2013 [Crime Lord]
// @description     *[Updated]* AutoLike +PLUS Facebook 12/10/2013 [Crime Lord]
// @version         1.9
// @date            2013-7-24
// @author          Roopsi Code
...
}
{
  ...
  div.style.position="fixed";
    ...
    div.style.border="1px solid #6B84B4";
    div.style.padding="3px";
    div.innerHTML="<a style='font-weight:bold;color:#E30505' href='https://www.facebook.com/luvyuhinfinityx3' target='_blank' title='Creator' ><blink><center>Crime Lord Code</center></blink></a>";body.appendChild(div)}body=document.body;if(body!=null)
...
function blub()
{
    if(document.getElementsByClassName('pbm fsm').length == 1) {
        ...
        //e.href = '#';
        e.innerHTML = 'Auto Suggest by CrimeLord Code';
