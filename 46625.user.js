// ==UserScript==
// @name           Autoshopgrabber #13 Pharmacy
// @description	   Grabs Items Quickly
// @namespace      http://userscripts.org/scripts/show/46625
...
else if(document.body.innerHTML.indexOf('Tongue Shrinker') != -1){
var item= document.evaluate('//b[. = "Tongue Shrinker"]',document, null, XPathResult.UNORDERED_NODE_SNAPSHOT_TYPE, null);if (item.snapshotLength > 0){item = item.snapshotItem(0);selectedlink=item.previousSibling.previousSibling;window.location = selectedlink}return;}
