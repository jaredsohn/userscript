// ==UserScript==
// @name            taz_zusatzressorts_12
// @namespace       Platypus
// @include         http://www.taz.de/index.php?id=digitaz&magazin
...
do_modify_html_it(window.document,document.getElementById('content_gesamt'),/magazin([^>]+)>/,'magazin$1 class="main_navi_element_aktiv">',null);
do_modify_html_it(window.document,document.getElementById('content_gesamt'),/<h1[^<]+<\/h1>/,'<h1>taz Magazin</h1>',null);
do_modify_html_it(window.document,document.getElementById('content_gesamt'),/<p[^>]+"bodytext">[^#]+<\/div[^<]+<\/div[^<]+<!-- Ende linke Spalte -->/,'<br><br><br><br><br><iframe src="http://www.taz.de/digitaz/.archiv/suche?dos=1&mode=erw&name=askxCxjry&tx=&ti=&au=&sdd=&smm=&syy=&edd=&emm=&eyy=&art=&len=&se=&rev=1&ListLen=30&qu=TAZM&re=#taz-archiv" width="685" height="600"></iframe></div></div><!-- Ende linke Spalte -->',null);
