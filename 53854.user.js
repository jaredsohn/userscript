...
// @namespace	http://userscripts.org/scripts/show/53854
// @description	Vendetta All-in-one tool powered by mitm[ITA] - Original Script by: Mosaik(ITA), Al_Caponazzo(ITA), Alex(FRA), Platone (ITA), TGWo (Admin Vendetta1923.it), Trip (ITA);
// @author	mitm[ITA]
// @version	1.7.4.9
// @date	25/12/2009
...
(function(){
	...
	if (location.pathname.search('player.php') != -1 ) {		
		...
		var html = '<hr>';
		html += '&nbsp;&nbsp;<input id="reset_targets" value="Azzera Targets" type="Submit" STYLE=\'width: 120px;font-size:8pt;font-family:Verdana\'>&nbsp;&nbsp;';
		html += '&nbsp;&nbsp;<input id="unset_target" value="Deselziona Tutti" type="Submit" STYLE=\'width: 120px;font-size:8pt;font-family:Verdana\'>&nbsp;&nbsp;';
		html += '&nbsp;&nbsp;<input id="set_target" value="Seleziona Tutti" type="Submit" STYLE=\'width: 120px;font-size:8pt;font-family:Verdana\'>&nbsp;&nbsp;';
		html += '<hr>';
	...
	if (location.pathname.search('nav.php') != -1 ) {
		...
		newDiv = document.createElement("span");
		newDiv.innerHTML = '<font size=1 color=red>&nbsp;<br>&nbsp;'+release+'</font><font size=1 color=blue><br>&nbsp;powered by&nbsp;&nbsp;<b><a href="http://userscripts.org/scripts/show/53854" target="blank">mitm<b>&nbsp;</font>';
	...
	html += '<hr>&nbsp;&nbsp;Target&nbsp;:&nbsp;&nbsp;<a href="javascript:void(0);" onclick="" id=meno>-</a>&nbsp;<select id="mitm_select">' + options + '</select>&nbsp;<a href="javascript:void(0);" onclick="" id=piu>+</a>&nbsp;';
