// ==UserScript==
// @name           Menu des Pirates
// @version        0.0.1
// @namespace      Menu Pirates
// @description    Un petit menu pour les Pirates
// @include        http://s*.ikariam.*/index.php*
// ==/UserScript==
// ===========================================================================
//
// Un mélange de plusieur script scripts adaptés pour les besoins des Pirates.
...
'<div id="menu">'
+ '<ul>'
+ ' <li><h2>Menu Pirates</h2>'
+ '   <ul>'
+ '     <li><center><a target="_blank" href="http://les-pirates.forumactif.net/forum.htm" Faut etre logge auto sur le forum">Forum Pirates</a></li>'
...
+ '     <li><center><a target="_blank" href="http://board.ikariam.fr/" title="forum ikariam">Forum ikariam</a></li>'
+ '	 </ul>'
+'</DIV>';
