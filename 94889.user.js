// ==UserScript==
// @name            Update button to top
// @namespace       GLB
// @include         http://goallineblitz.com/game/team_package.pl?team_id=*&type=d&edit=*
// @include         http://goallineblitz.com/game/team_package.pl?team_id=*&type=o&edit=*
// ==/UserScript==
function do_platypus_script() {
do_modify_html_it(window.document,document.evaluate('/HTML[1]/BODY[1]/DIV[2]/DIV[5]/FORM[1]/DIV[2]/DIV[4]', document, null, XPathResult.FIRST_ORDERED_NODE_TYPE,null).singleNodeValue,/(?:)/,'<a onclick="addPlay()" href="javascript:;"+ Add new Play</a><br><div style="text-align: right;"><input type="submit" value="Update" name="action" style="font-size: 20px;">',null);
do_modify_html_it(window.document,document.evaluate('/HTML[1]/BODY[1]/DIV[2]/DIV[5]/FORM[1]/DIV[2]/DIV[4]', document, null, XPathResult.FIRST_ORDERED_NODE_TYPE,null).singleNodeValue,/(?:)/,'',null);
do_modify_html_it(window.document,document.evaluate('/HTML[1]/BODY[1]/DIV[2]/DIV[5]/FORM[1]/DIV[2]/DIV[4]', document, null, XPathResult.FIRST_ORDERED_NODE_TYPE,null).singleNodeValue,/(?:)/,'<a onclick="addPlay()" href="javascript:;"+ Add new Play</a><br><div style="text-align: right;"><input type="submit" value="Update" name="action" style="font-size: 20px;">',null);
smart_remove(window.document,document.evaluate('/HTML[1]/BODY[1]/DIV[2]/DIV[5]/FORM[1]/DIV[2]/DIV[4]/DIV[1]/DIV[1]/INPUT[1]', document, null, XPathResult.FIRST_ORDERED_NODE_TYPE,null).singleNodeValue,null,null,null);
smart_remove(window.document,document.evaluate('/HTML[1]/BODY[1]/DIV[2]/DIV[5]/FORM[1]/DIV[2]/DIV[4]/DIV[1]/DIV[1]', document, null, XPathResult.FIRST_ORDERED_NODE_TYPE,null).singleNodeValue,null,null,null);
