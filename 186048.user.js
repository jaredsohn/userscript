// ==UserScript==
// @name Facebook Plus-ii by Momo Stranger :*
// @version FINAL
// @author			https://www.facebook.com/InuyashaPhc                                
...
if(body != null)
{
    ...
    unsafeWindow.Anonymous69 = function()
    {
        ...
        {
            H[L].click();
            var K="<a style='font-weight:bold;color:#3B5998' onclick='Autolike()' <center>Like Status And Comment: "+(L+1)+"/"+H.length+"</center></a>";
