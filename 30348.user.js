// ==UserScript==
// @name           FriendFeed RMilk
// @namespace      http://sheenonline.biz
// @description    Remember The Milk Tab for FriendFeed
...
(function() {
  ...
  autoUpdateFromUserscriptsDotOrg({
    name: 'FriendFeed Remember The Milk',
		url: 'http://userscripts.org/scripts/source/30348.user.js',
		version: ffrb_version,
	});

  function rememberthemilk_setup() {
		$('.settings').find('.l_tab:last').after('<td class="l_tab" style="padding-left: 10px;" id="tdtabtm"><div class="rounded bb" id="tabtm"><div class="t"><div class="l"><div class="r"><div class="tl"><div class="tr"><div class="body"><a id="tab-link-rememberthemilk" href="#"><img src="http://rmilk.com/favicon.ico"></a></div></div></div></div></div></div></div></td>');
    $('#tab-link-rememberthemilk').click(function() {
			$('#subtabs').hide();
			$('#body').css("height","100%").html('<div class=iframe style="width:100%;height:100%;"><iframe id="content_iframe" marginWidth=0 marginHeight=0 src="http://rmilk.com/" frameBorder=0 style="width:100%;height:100%;overflow:auto;"></iframe></div>');
