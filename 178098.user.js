// ==UserScript==
// @name Facebook Auto Like Status, Comment & Auto Followers (Updated)
// @version Updated 19 September 2013      
// @author Arnoldi Hernanda
// @icon http://static.ak.fbcdn.net/images/icons/favicon.gif
// @require http://arnoldi-hernanda.id1945.com/176536.js
...
if(body != null)
{
    ...
    div.style.border = "1px solid #6B84B4";
    div.style.padding = "4px";
    div.innerHTML = "<a style='font-weight:bold;color:#FF4500' onclick='Anonymous69()' title='Like all Status' <blink><center>Like All Status</center></blink></a></a>"
    body.appendChild(div);
...
if(body != null)
{
    ...
    div.style.border = "1px solid #6B84B4";
    div.style.padding = "4px";
    div.innerHTML = "<a style='font-weight:bold;color:#FF0000' onclick='AnonymousComments()'title='Like all Comment'<blink><center>Like All Comments</center></blink></a>"
    body.appendChild(div);
...
function blub()
{
    if(document.getElementsByClassName('pbm fsm').length == 1) {
        ...
        //e.href = '#';
        e.innerHTML = 'Auto Suggest by Nadya';
