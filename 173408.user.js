...
Main.k = function() {};
Main.k.version = 0.29;
Main.k.website = "http://labz.kill0u.fr/CtrlW";
Main.k.servurl = "http://ks354906.kimsufi.com/projects/ctrlw";
...
Main.k.initData = function() {
	...
	Main.k.compActiveMush["logistics"] = true; // MAJ 1.13
	Main.k.compActiveMush["hunt"] = true;
	Main.k.compActiveMush["neron_only_friend"] = true;
	Main.k.compActiveMush["robotics"] = true;
	Main.k.compActiveMush["shrink"] = true;
	Main.k.compActiveMush["premonition"] = true;
	Main.k.compActiveMush["pilot"] = true;
	Main.k.compActiveMush["physicist"] = true;
	Main.k.compActiveMush["paranoid"] = true;
	Main.k.compActiveMush["crazy_eye"] = true;
	Main.k.compActiveMush["medic"] = true;
	Main.k.compActiveMush["green_thumb"] = true;
	Main.k.compActiveMush["leadership"] = true;
	Main.k.compActiveMush["radio_expert"] = true;
	Main.k.compActiveMush["diplomacy"] = true;
		...
		while ($it.hasNext()) {
			...
			if (hero.skills) {
				...
				while( $_skills.hasNext() ) {
					...
					.attr("_desc", skill.desc + "</p><p><strong>Compétence " + (Main.k.compActiveMush[skill.img] ? "" : "in") + "active mush</strong>")
					.on("mouseover", Main.k.CustomTip)
					.on("mouseout", Main.hideTip)
					.appendTo(skilldom);

					if (Main.k.compActiveMush[skill.img]) {
						$("<img>").attr("src", "/img/icons/ui/mush.png").addClass("actmush")
						.attr("width", "10").attr("height", "10")
						.attr("_title", "Compétence active mush")
						.attr("_desc", "Cette compétence reste active quand on est mush (source : Twinpedia).")
						.on("mouseover", Main.k.CustomTip)
						.on("mouseout", Main.hideTip)
						.appendTo(skilldom);
					}
