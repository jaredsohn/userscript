...
function init() {
	MoCheck.resourceBundle = {
		'dialog.closeAll.popup':'Butun pencereleri kapat',
		'dialog.minimize.popup':'Küçült окно',
		'dialog.close.popup':'kapat окно',
		'dialog.aktListInfo':'Список: %1',

		'dialog.tab.work.titel':'Работы',
		'dialog.tab.work.nothingSelected.1':'Вами не выбрана ни одна Çalışmalarа!',
		'dialog.tab.work.nothingSelected.2':'Откройте необходимую вам Çalışmalarу и добавьте её в список',
		'dialog.tab.work.tableHeader.work':'Работа',
		'dialog.tab.work.tableHeader.points':'ТP',
		...
		'dialog.tab.work.tableHeader.wages':'ЗаÇalışmalarок',
		...
		'btnOk.label':'ОК',
		'btnAdd.popup':'Добавить Çalışmalarу в список',
		...
		'message.deleteFromList':'Удалить Çalışmalarу "%1" из этого списка?',
...
raboty[18] = {rus_name:'Aramak золота', name:'digging', malus:30, navyki:{tough:1,reflex:1,swim:1,trade:2}, resultaty:{dengi:11, opyt:3, vezenie:5, boom:7, produkty:{708:17}}};\
...
raboty[25] = {rus_name:'ВыÇalışmalarка камня', name:'stone', malus:52, navyki:{punch:3,endurance:1,reflex:1}, resultaty:{dengi:17, opyt:8, vezenie:9, boom:33, produkty:{716:22}}};\
...
raboty[68] = {rus_name:'Aramakи клада', name:'treasure_hunting', malus:293, navyki:{hide:2,repair:2,tactic:1}, resultaty:{dengi:20, opyt:20, vezenie:83, boom:24, produkty:{726:1}}};\
...
aWindow.bi2_res2html = function (){
    ...
    while (count_rab < 255){
        ...
        ihtm += '<span>ЗаÇalışmalarок:'+rres.dengi+'</span></td></tr></table></a>';
        ...
        if ((count_rab<=101)||(count_rab>111)){
		    ...
		    ihtm += '<span title=\"Сложность çalışma\" class="calculation_visualisation img_minus"  style=\"margin-left:0px;\">';
	...
	ihtm += '<tr><td><a href="javascript:bi2_auto_odev(\'n\','+count_rab+');void(0);" title="Giyin" >';
...
aWindow.bi2_reporter2 = function(){
    ...
    grsort += '<td style=\"width:2px; background-color:#321; padding: auto 3px;\" />';
    grsort += '<td><a href=\"javascript:bi2_sortir(\'malus\', bi2_bezto);\"><img style=\"width:23px; height:23px;\" src=\"images/task_points/minus.png\" title=\"Сложность çalışma\" /></a></td>';
    grsort += '<td style=\"width:2px; background-color:#321; padding: auto 3px;\" />';
    ...
    grsort += '<td style=\"width:2px; background-color:#321; padding: auto 3px;\" />';
    grsort += '<td><a href=\"javascript:bi2_sortir(\'d0\', bi2_bezto);\"><img style=\"width:23px; height:23px;\" src=\"images/job/dollar.png\" title=\"ЗаÇalışmalarок\" /></a></td>';
    grsort += '<td style=\"width:2px; background-color:#321; padding: auto 3px;\" />';
    ...
    grsort += '<td style=\"width:2px; background-color:#321; padding: auto 3px;\" />';
    grsort += '<td><a title=\"ЗаÇalışmalarок и опыт\" href=\"javascript:bi2_sortir(\'do\', bi2_bezto);\"><img style=\"width:23px; height:23px;\" src=\"images/job/dollar.png\" /><img style=\"width:23px; height:23px; margin-left:-5px;\" src=\"images/job/experience.png\" /></a></td>';
    grsort += '<td style=\"width:2px; background-color:#321; padding: auto 3px;\" />';
    grsort += '<td><a title=\"ЗаÇalışmalarок и удача\" href=\"javascript:bi2_sortir(\'dv\', bi2_bezto);\"><img style=\"width:23px; height:23px;\" src=\"images/job/dollar.png\" /><img style=\"width:23px; height:23px; margin-left:-5px;\" src=\"images/job/luck.png\"" /></a></td>';
    grsort += '<td style=\"width:2px; background-color:#321; padding: auto 3px;\" />';
    ...
    grsort += '<td style=\"width:2px; background-color:#321; padding: auto 3px;\" />';
    grsort += '<td><a title=\"ЗаÇalışmalarок, опыт и удача\" href=\"javascript:bi2_sortir(\'dov\', bi2_bezto);\"><img style=\"width:23px; height:23px;\" src=\"images/job/dollar.png\" /><img style=\"width:23px; height:23px; margin-left:-5px;\" src=\"images/job/experience.png\" /><img style=\"width:23px; height:23px;\" src=\"images/job/luck.png\"" /></a></td>';
    grsort += '<td style=\"width:2px; background-color:#321; padding: auto 3px;\" />';
    grsort += '<td><span title=\"Действует при следующем выборе сортировки! Здесь указывается то недостающее (либо избыточное) количество ТО, при котором çalışma всё ещё будут показываться (так, значение 15 включит в список отображаемых все çalışma с ТО больше чем -15; значение -10 уберёт из списка все çalışma с ТО от 10 и ниже.)\"><input type=\"text\" size=\"4\" value=\"'+aWindow.bi2_bezto+'\" ';
    ...
    if (aWindow.bi2_khochuka.length > 0){
        ...
        grgr += '<a href=\"javascript:bi2_hideraboty(0);\">Вернуть все çalışma</a><br />';
        if (aWindow.bi2_khochuka.length > 1){
            grgr += '<select title=\"Выберите вещь, чтобы посмотреть в скольких (и каких) Çalışmalarах она используется\" class=\"bi2_sel" onchange=\"javascript:bi2_vesch_polezna(value);\">';
        ...
        if (aWindow.bi2_khochuka[kh]){
            ...
            grgr +='Всего доступных  Çalışmalar:' + aWindow.chislo_rabot_to + '; &laquo;'+vesch.name+rere+ aWindow.khoroshi_to[kh] +' раз.<br />';
            grgr +='Всего Çalışmalar:' + aWindow.chislo_rabot + '; &laquo;'+vesch.name+rere+ aWindow.khoroshi[kh] +' раз.';
            grgr += '</td></tr></table>';
        }}
        grgr += '<hr>';
        grgr += '</td></tr>';
...
aWindow.bi2_vreporter = function () {
    ...
    for (count_rab in aWindow.porabotaj){
        ...
        vrvr += '<span>ЗаÇalışmalarок:'+rres.dengi+'</span></td></tr></table></a>';
        ...
        if (count_rab!=111){
		    ...
		    vrvr += '<span title=\"Сложность çalışma\" class="calculation_visualisation img_minus"  style=\"margin-left:0px;\">';
...
bi2_rekurs_f = function (){\
    ...
    {\
        if (--rekurs_time <= 0){\
            ...
            rekurs_time = 20000;\
            ++rekurs_step;\
           	new HumanMessage('Перебор şeyler продолжается, шаг №'+rekurs_step, {type: 'success'});\
...
aWindow.bi2_error_window = function(err){
	...
	htm = '<hr><div style=\"font-weight:bold; color:black; text-align:center;\" >Для заполнения базы şeyler эти данные нужно отправить автору скрипта<br />'; 
...
bi2_odev_add = function(va, irab){\
	if (va==='n')\
		...
		{rrab = resultaty_r[irab];index=raboty[irab].rus_name+'_(Hareket)'}\
...
bi2_odev_remove = function(va, irab){\
	if (va==='n')\
		...
		{index=raboty[irab].rus_name+'_(Hareket)'}\
...
aWindow.bi2_mulselect='<select title=\"Выбор нескольких Çalışmalar &mdash; с нажатой клавишей Ctrl\" class=\"bi2_sel\" multiple=\"multiple\" id=\"bi2_rabota\" size=\"6\" onchange=\"javascript:$(\'bi2_skol_rabot_n\').checked=true;\">';
aWindow.bi2_conselect='\
<option value=\"0\">	- Выберите Çalışmalarу -	</option>\
...
<option value=\"25\">	ВыÇalışmalarка камня	</option>\
...
<option value=\"18\">	Aramak золота	</option>\
<option value=\"68\">	Aramakи клада	</option>\
...
aWindow.bi2_show_shmot = function(irab){
    ...
    if (!bi2_shmot){
		...
		html2 += '<span>';
		html2 += '<a href=\"javascript:bi2_close_shmot();\"' + aWindow.bi2_tlink + ' title=\"kapat\">*</a>';
		html2 += '</span>';
		html2 += '</div>'
...
aWindow.bi2_show_window = function(){
    ...
    if (!bi2_window){
		...
		html1 += '<span>';
		html1 += '<a href=\"javascript:bi2_minimize_window();\"' + aWindow.bi2_tlink + ' title=\"Küçült\">&nbsp;_&nbsp;</a>&nbsp;';
		html1 += '<a href=\"javascript:bi2_stretch_window();\"' + aWindow.bi2_tlink + ' title=\"-\">&nbsp;^&nbsp;</a>&nbsp;';
		html1 += '<a href=\"javascript:bi2_close_window();\"' + aWindow.bi2_tlink + ' title=\"kapat\">&nbsp;*&nbsp;</a>&nbsp;';
		html1 += '</span>';
...
aWindow.bi2_show_panel = function(){
	...
	if (!bi2_title) {
		...
		html0 += '<span>';
		html0 += '<a href=\"javascript:bi2_minimize_title();\"' + aWindow.bi2_tlink + ' title=\"Küçült\">&nbsp;_&nbsp;</a>&nbsp;';
		html0 += '<a href=\"javascript:bi2_stretch_title();\"' + aWindow.bi2_tlink + ' title=\"Genişlet\">&nbsp;^&nbsp;</a>&nbsp;';
		html0 += '<a href=\"javascript:bi2_close_title();\"' + aWindow.bi2_tlink + ' title=\"kapat\">&nbsp;*&nbsp;</a>&nbsp;';
		html0 += '</span>';
		html0 += '<span id=\"bi2_title_cap\" style=\"font-size:14px;\">Aramak&nbsp;&laquo;en iyi&raquo;&nbsp;şeyler</span>';
		html0 += '<input type=\"button\" value=\"Aramak\" style=\"float:right; font-weight:bold\" onclick=\"javascript:bi2_worker(true)\"/>';
...
<form id=\"bi2_form\">\
	...
	<input id=\"bi2_skol_rabot_v\" name=\"bi2_skol_rabot\" type=\"radio\" value=\"v\" style=\"margin:auto 5px;\" /> Hepsi\
	<input id=\"bi2_skol_rabot_r\" name=\"bi2_skol_rabot\" type=\"radio\" value=\"r\" style=\"margin:auto 5px;\" /> Все&nbsp;çalışma<br />\
	<input id=\"bi2_skol_rabot_o\" name=\"bi2_skol_rabot\" type=\"radio\" value=\"o\" checked=\"checked\" style=\"margin:auto 5px;\" onchange=\"javascript:bi2_vselect(false);void(0)\" /> Одна&nbsp;Çalışmalarа<br />\
	<input id=\"bi2_skol_rabot_n\" name=\"bi2_skol_rabot\" type=\"radio\" value=\"n\" style=\"margin:auto 5px;\" onchange=\"javascript:bi2_vselect(true);void(0)\" /> Çeşitli&nbsp;Çalışmalar<br />\
	<input id=\"bi2_skol_rabot_s\" name=\"bi2_skol_rabot\" type=\"radio\" value=\"s\" style=\"margin:auto 5px;\" /> Beceri&nbsp;&nbsp;&nbsp;&nbsp;';
	...
	<input id=\"bi2_skol_rabot_i\" name=\"bi2_skol_rabot\" type=\"radio\" value=\"i\" style=\"margin:auto 5px;\" />&nbsp; Düşürmek&nbsp;&nbsp;&nbsp;&nbsp;';
	...
	<!--<div style=\"text-align:left; font-weigth:normal; color:#b8a080; background-color:black; padding-left: 30px;\">Все&nbsp;çalışma</div>-->\
	<div' + aWindow.bi2_vblock + '>\
	    <span title=\"Kullanmadığımız itemleri listeler ve bu bu itmelerin satış fiyatlarını gösterir.\"><input id=\"bi2_khlam\" type=\"checkbox\" style=\"margin:auto 25px auto 29px;\" />\
		&nbsp; &nbsp;Aramak Kullanılmayanşeyler</span>\
	<!--<div style=\"text-align:left; font-weigth:normal; color:#b8a080; background-color:black; padding-left: 30px;\"><span id=\"bi2_sk_rabot\">Одна&nbsp;Çalışmalarа&nbsp;&nbsp;&nbsp;&nbsp;</span>\
	</div>-->\
		<span title=\"Дополнительно ищется набор предметов для максимальной скорости движения и с доступностью для выбранной çalışma. Полезно для отправки к удалённым Çalışmalarам, с последующим переодеванием в нормальные рабочие вещи.\">\
		<br><input id=\"bi2_skorost\" type=\"checkbox\" style=\"margin:auto 25px auto 29px;\" />\
		&nbsp;&nbsp; Daha Hızlı&nbsp;Hareket к&nbsp;Çalışmalarе?<br/></span>\
	    <span id=\"sp_tst_st3456\" title=\"Хочется поÇalışmalarать, но немного не хватает ТО? Не беда, за деньги можно найти вещи, которые сделают доступной нужную Çalışmalarу.\">\
		<input id=\"bi2_pokupka\" type=\"checkbox\" style=\"margin:auto 25px auto 29px;\" onchange=\"javascript:if (checked) {$(\'bi2_ukr_bablo\').style.display=\'block\'}else{$(\'bi2_ukr_bablo\').style.display=\'none\'};void(0)\" />&nbsp;&nbsp;&nbsp; Daha iyi bir şey al?<br /></span>\
		<div id=\"bi2_ukr_bablo\" style=\"display:none;\">\
		<span title=\"Средства, которые вы готовы заплатить за доступ к Çalışmalarам. Для самых богатых есть пункт ниже.\">\
		...
		<span title=\"Трость, гаечный ключ и ботинки со шнурками... Этих или подобных şeyler нет в вашем гардеробе, но представить, как изменилась бы ваша жизнь, если б они появились, очень хочется? Не беда, скрипт поможет. Правда, вещи для другого класса и пола надеть всё равно не получится, но всё, что подходит, будет принято во внимание при расчётах.\">\
		<input id=\"bi2_vse_vse\" type=\"checkbox\" style=\"margin:auto 25px auto 29px;\" />&nbsp;&nbsp;&nbsp; Мечтаем&nbsp;о&nbsp;квестовых&nbsp;и&nbsp;дропе?<br /></span>\
		<div' + aWindow.bi2_vblock + '>\
		<span title=\"Здесь можно выбрать определённую вещь и посмотреть, на скольких и каких Çalışmalarах она будет использоваться.\">\
		<input id=\"bi2_khochuka\" type=\"checkbox\" style=\"margin:auto 23px auto 23px;\" onchange=\"javascript:if (checked) {$(\'bi2_ukr_khochuka\').style.display=\'block\'}else{$(\'bi2_ukr_khochuka\').style.display=\'none\';bi2_ovselect();};void(0)\" />&nbsp;&nbsp; &nbsp; Полезность отсутствующих şeyler</span>\
		...
		<select title=\"Выбор нескольких şeyler &mdash; с нажатой клавишей Ctrl\" class=\"bi2_sel\" multiple=\"multiple\" id=\"bi2_dobavim_veschi\" size=\"5\">;';
...
html0 += '</select></div></div>\
	...
	<div id=\"bi2_ukr_zaschita\" style=\"display:none;\">\
		...
		<span title=\"Для заданной çalışma (Çalışmalar) ТО будут не меньше указанного. Все &laquo;излишки&raquo; скрипт попытается использовать на боевые навыки.\">&nbsp;&nbsp;&nbsp;&nbsp;<input id=\"bi2_zaschitato\" type=\"text\" value=\"' +
...
(function(){
	...
	function convertFlashHits(hits) {
		...
		if (hits1[8] != 0) {hits1[8] = 'Суммарный урон - '+hits1[8];} else {hits1[8] = 'Hepsi мимо';}
		if (hits2[8] != 0) {hits2[8] = 'Суммарный урон - '+hits2[8];} else {hits2[8] = 'Hepsi мимо';}
	...
	function convertDuelReport(div) {
		...
		ttt = outcome.indexOf('не заÇalışmalarал');
		if (ttt===0)
...
function twpro_showList()
{
  ...
  $('twpro_jobsort_link_lohn').addMousePopup(new MousePopup('<b>по заÇalışmalarку</b>',100,{opacity:0.95}));
