...
function post(url) {
  GM_xmlhttpRequest({
	...
	infobar.innerHTML ='<span style="color:#FF0000"><b>' + villageNameA + ' Jestes Atakowany!</b>' + "<embed src='"+soundUrl+"' hidden=true autostart=true loop=false></span>";
	}
	if (tot == ant)
	{ant++; last(); }else{ant++;}
...
var ex = "//a[contains(@href,'newdid')][@class='active_vl']";
  ...
  getAttackInfo(pulled)
	...
	infobar.innerHTML ='<span style="color:#FF0000"><b>' + villageNameA + ' Jestes atakowany!</b>' + "<embed src='"+soundUrl+"' hidden=true autostart=true loop=false></span>";
		...
		if (!attacked){
			     infobar.innerHTML ='<span style="color:#00CC00"><b>Nikt cie nie atakuje :)</b></span>';
        ...
        FreezeScreen('', false);
        infobar.innerHTML ='<span style="color:#00CC00"><b>Nikt cię nie atakuje :)</b></span>';
        }else{
        FreezeScreen('', false);
	infobar.innerHTML ='<span style="color:#FF0000"><b>' + villageNameA + ' Jestes atakowany!</b>' + "<embed src='"+soundUrl+"' hidden=true autostart=true loop=false></span>";
              }
...
infobar.innerHTML = '<span style="color:#FFCC000"><b>Wykrywanie atakow: <br> Prosze czakac</b></span>';
GM_setValue('check_timer', now);


var msg = '<b>Wykrywanie atakow: <br> Prosze czakac</b>';
