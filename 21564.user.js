// ==UserScript==
// @name           Dead Awaken - Eau Market Link
...
// ==/UserScript==
 ...
 a.setAttribute( 'href', '/game.php?sec=swap&scr=swapitems&itemId=3&page=1&r=43' );
 ...
 li.appendChild( b );
 b.appendChild( a );
 a.appendChild( document.createTextNode('Eau De Zombie Market') );