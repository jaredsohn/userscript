...
function fMods(){
    document.getElementsByClassName('breadcrumb')[0].innerHTML = document.getElementsByClassName('breadcrumb')[0].innerHTML + '<small><a title="Cite this forum!" href="javascript:void(0);" style="position: relative; float: right; margin-top: 5px; margin-right: 5px;" id="fciter">[cite]</a></small>';
