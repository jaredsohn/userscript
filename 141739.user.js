// ==UserScript==
// @name           LOU_Scrubs/Angriffsplaner
// @description    Einfacher Angriffsplaner
// @author         Ossichill
...
LouTKSMassAttack.prototype.init = function() {
   ...
   // ***** City Layout Button ***** //
   var layoutButton = new qx.ui.form.Button("Angriffsplaner");
   layoutButton.set({appearance: "button-text-small", toolTipText: "Öffne den Planer."});
   layoutButton.addListener("click", ShowMassScheduler, false);
   qx.core.Init.getApplication().cityInfoView.buildingQueue.header.add(layoutButton, {top: 32, left: 13});
...
function PrepareEmail()
{
   ...
   emailString += "[b]Angriffe Zeit[/b]: "+d+" . "+m+" . "+y+" @ "+h+" : "+n+" : "+s+" ("+attackTime+")\n";
   emailString += "[b]Hauptziel:[/b] [city]"+RealTarget.getValue()+"[/city]\n\n";
   emailString += "[b]Fakeziele:[/b]:\n";
   ...
   if(qx.core.Init.getApplication().sendMail != null && qx.core.Init.getApplication().currentOverlay==qx.core.Init.getApplication().sendMail && qx.core.Init.getApplication().sendMail.hasUnsaved()) {
      ...
      qx.core.Init.getApplication().sendMail.subject.setValue("Angriffsplanung");
   }
}
...
function ExecuteAttackPlan() {
   ...
   if (qx.core.Init.getApplication().getMailPage().__Ou.$$user_value.indexOf("Angriffsplanung") != 0) {
      err = 1;
...
function ShowMassScheduler() {
   if (!opts) {   // Don't reload the page, otherwise you lose the settings
      ...
      opts.setTitle("Scrubs Angriffsplaner - Version 5.1.1.1");
   ...
   // Save Button
      ...
      saveButton = new qx.ui.form.Button("Speichern").set({width: 120});
   ...
   // Unit Type
      var UnitLabel = new qx.ui.basic.Label("Truppen Typ").set({width:85});
   ...
   // Attack Type
      var AttackLabel = new qx.ui.basic.Label("Angriffs Typ").set({width:85});
      ...
      AttackDrop.add(new qx.ui.form.ListItem("Kundschaften",null,1));
      AttackDrop.add(new qx.ui.form.ListItem("Plündern",null,2));
      AttackDrop.add(new qx.ui.form.ListItem("Überfall",null,3));
      AttackDrop.add(new qx.ui.form.ListItem("Unterstützen",null,4));
      AttackDrop.add(new qx.ui.form.ListItem("Belagern",null,5));
   ...
   // Unit Count
      var NumOfUnitsToSendLabel = new qx.ui.basic.Label("Truppen Pro Angriff").set({ width:85 });
   ...
   // Date
      ...
      var DateLabel = new qx.ui.basic.Label("Ankunft Datum:").set({width:85});
   ...
   // Time
      ...
      var TimeLabel = new qx.ui.basic.Label("Ankunft Zeit:").set({width:85});
   ...
   // City box
      ...
      var CityLabel = new qx.ui.basic.Label("Fake Koordinaten (Max 16 )");
   ...
   // Add to page
      ...
      var decoyGroup = new qx.ui.groupbox.GroupBox("Fakeziele");
      ...
      var RealGroup = new qx.ui.groupbox.GroupBox("Hauptziel");
...
function AddTroopInfo() {
   ...
   RealAttackDrop.add(new qx.ui.form.ListItem("Kundschaften",null,1));
   RealAttackDrop.add(new qx.ui.form.ListItem("Plündern",null,2));
   RealAttackDrop.add(new qx.ui.form.ListItem("Überfall",null,3));
   RealAttackDrop.add(new qx.ui.form.ListItem("Unterstützen",null,4));
   RealAttackDrop.add(new qx.ui.form.ListItem("Belagern",null,5));
   RealAttackDrop.setSelection([RealAttackDrop.getChildren()[4]]);

   var row = new qx.ui.container.Composite(new qx.ui.layout.HBox());
   row.setAlignY("bottom");
   RealTargetLabel = new qx.ui.basic.Label("Koordinaten").set({width:85});
