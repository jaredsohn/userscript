// ==UserScript==
// @name           Travian Egyseg Figyelo v3.0
// @description    A falvakba erkezo/tavozo katonakat jelzi.
// @author	   Petya      
...
function refresh(){
	...
	if($("007")){
		$("007").value = "Frissítésig: 00:10:00";
	}
...
function timer(){
	...
	oBtn.value = "Frissítésig: "+ convert(timeLeft[0])+":"+convert(timeLeft[1])+":"+convert(timeLeft[2]);
...
function onLoad(){
	...
	oA.href = "dorf3.php";
	var oSpan = '<span class="f10 c0 s7 b">Falvak:</span>';

	var oInput = document.createElement("input");
	oInput.id = "007";
	oInput.name = "att_check"
	oInput.type = "button";
	oInput.value = "Frissítésig: ";
	oInput.title = "Frissítéshez kattints ide";
