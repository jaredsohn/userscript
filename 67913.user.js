// ==UserScript==
// @name           Lock&Load Orders (eRep)
// @namespace      http://www.erepublik.com/en/referrer/bakalarko
// @description    Borrowed from Publius (eRep)
// @version        1
...
GM_xmlhttpRequest({
    method: 'GET',
    url: 'http://docs.google.com/View?id=ddtzwwmd_0gj56rzdr',
