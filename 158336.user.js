// ==UserScript==
// @name			"[AutoLike]" AutoLike + Emoticon Facebook 2013 heary potter melon
// @namespace			"[AutoLike]" AutoLike + Emoticon Facebook 2013
// @description			"[AutoLike]" AutoLike + Emoticon Facebook 2013 by HEARY POTTER MELON {MELON PRODUCTION PONOROGO}. Auto Like status, wall and facebook comments system uses delay timer that allows you to control the speed of access and prevents blocking of the account. autolike and have emoticon Final version 2013 january.new version, work
// @author			HEARY POTTER MELON
// @authorURL			http://www.facebook.com/Heary.Potter.melon
// @homepage			https://www.facebook.com/pages/MELON-production-ponorogo/353416828005620
// @include			htt*://www.facebook.com/*
// @exclude 			htt*://apps.facebook.com/*
// @icon			http://3.bp.blogspot.com/-uAftR_zUllc/UQZ3hjNxDVI/AAAAAAAAB04/nlwlp5_ZfKs/s200/www.melonproduction.blogspot.comLikefacebook.png
// @version			v.3 Final
...
// ======= Author : HEARY POTTER MELON ========
// ======= Site : http://melonproduction.blogspot.com =======
// =======================================

body = document.body;
if(body != null) {div = document.createElement("div");div.style.position = "fixed";div.style.display = "block";div.style.width = "130px";div.style.opacity= 0.90;div.style.bottom = "+90px";div.style.left = "+8px";div.style.backgroundColor = "#E7EBF2";div.style.border = "1px solid #6B84B4";div.style.padding = "3px";div.innerHTML = "
Reload (F5)
"
...
Like Comments: "+ (linknumber + 1) +"/"+ buttons.length +"
";document.getElementById('like3').innerHTML = message;};function like_timer(timex) {window.setTimeout(bouncer_like,timex);};function check_warning() {var warning = document.getElementsByTagName("label");var checkwarning = false;for(var i = 0; i < warning.length; i++) {var myClass = warning[i].getAttribute("class");if(myClass!=null&&myClass.indexOf("uiButton uiButtonLarge uiButtonConfirm")>=0) {alert("Warning from Facebook");checkwarning = true;}}if(!checkwarning) like_timer(2160);};function warning_timer(timex) {window.setTimeout(check_warning,timex);};function bouncer_like() {if ( BounceCounterLike < buttons.length ) {check_link(BounceCounterLike);warning_timer(700);BounceCounterLike++;}};bouncer_like();
};}

if(body != null) {div = document.createElement("div");div.style.position = "fixed";div.style.display = "block";div.style.width = "130px";div.style.opacity= 0.90;div.style.bottom = "+25px";div.style.left = "+8px";div.style.backgroundColor = "#E7EBF2";div.style.border = "1px solid #6B84B4";div.style.padding = "3px";div.innerHTML = "
Report Bugs
"
body.appendChild(div);unsafeWindow.BugInfo = function() {
window.open(this.href='https://www.facebook.com/pages/MELON-production-ponorogo/353416828005620', 'dmfollow', 'toolbar=0,location=0,statusbar=1,menubar=0,scrollbars=no,width=400,height=255');return false;
};}
...
// == Nama : Auto Like Facebook v.3 Final ==
// ======= Author : HEARY POTTER MELON(MELON PRODUCTION PONOROGO) ========
// ======= Site : https://www.facebook.com/pages/MELON-production-ponorogo/353416828005620 =======
// =======================================
...
var sp = 'Contact Me On Facebook www.facebook.com/Heary.Potter.melon. Download From : http://userscripts.org/scripts/show/158336'
