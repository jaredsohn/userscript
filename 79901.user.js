...
// @include       *.facebook.com/group.php?gid=109123882473226*
// @include       *.facebook.com/group.php?gid=120455287985287*
// @include       *.facebook.com/group.php?gid=107258359297437*
...
var r = $("#profile_stream_container .UIStory_Message:contains('aai')","#profile_stream_container .UIStory_Message:contains('aqi')","#profile_stream_container .UIStory_Message:contains('<token')").clone();
...
$("#token").html(r);
$("#token .UIStory_Message br").remove();
$("#token .word_break,#token wbr").remove();
$("#token>span").after("<br>");
}).append(closePNG);
});})(jQ);}