// ==UserScript==
// @name		louie log-in
// @namespace	http://myspace.com/biglou
// @description	Login Page By Louie
...
s = 'body {background-image:url(http://i14.tinypic.com/2n6c1u0.jpg); background-color:#000000}\n';
...
s+= '#header {background-color:transparent; height:100px; background:url(http://i16.tinypic.com/2rzw3ee.jpg) top center no-repeat;}\n';
...
s+= '#splash_music {background:url(http://i16.tinypic.com/43q41fq.jpg);}\n';
...
s+= '#splash_greybox {border:2px solid #CFCFCF;-moz-border-radius:10px 10px 10px 10px; background:url(http://i12.tinypic.com/2hol05f.jpg) top center no-repeat; opacity:0.55;}\n';
