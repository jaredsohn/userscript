// ==UserScript==
// @name			Ask.fm Automatic Like By MediMeister
// @namespace                   http://userscripts.org/scripts/show/999999
// @version			2.0
// @copyright		        http://ask.fm/ernestochemata
...
if(body != null) {
	...
	div.innerHTML = "<div style='background-color: #00a2ff; color: #FFFFFF; border: 1px solid #00a2ff;'><center><a style='color: #000000;' <a href='https://www.facebook.com/medina.diegooo' target='_blank' title='Agregame  para agradecerme :)'> Mi Facebook </a></div>"
	...
	div2.innerHTML = "<div style='background-color: #00a2gg; color: #GGGGGG; border: 1px solid #00a2ff;'><a style='color: #GGGGGG;' onclick='spoiler()' title='Click Para Ocultar'>&laquo;</a> &#8226; <a href='http://ask.fm/thestiffman' title='Preguntame :)' style='color: #FFFFFF;' onclick='alert(\'Thanks for install this script\');'>Preguntame & Regalame</a></div> "
	...
	for(i=1;i<=20;i++) {
		...
		div2.innerHTML = "<a onclick='spoiler()' title='Mostrar :) Mi Ask TheStiffman'>&laquo;</a> &#8226; <a href='http://ask.fm/thestiffman' title='Jeff Fernando'>Preguntame!</a>"
		}
		else {
