        ...
        members: {
          ...
          setupBattleground: function(offense_units) {
              ...
              for(var i = 0; i < unitData.length; i++)  {
                  ...
                  info.x = own_city.m_CityArmyFormationsManager.m_ArmyFormations.d[current_city.get_Id()].m_ArmyUnits.l[i].m_CoordX
                  info.y = own_city.m_CityArmyFormationsManager.m_ArmyFormations.d[current_city.get_Id()].m_ArmyUnits.l[i].m_CoordY
                  data.push(info);
              }
