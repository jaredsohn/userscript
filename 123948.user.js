// ==UserScript==
// @name           multisiter script (FV)
// @description    enable multiple siter accounts
...
(function() { 
	...
	function sendMessage(s,hwnd){
		...
		try {
			...
			hwnd.location.href = "http://dummy.facebook.com/?#"+s;	
		}
	};
	...
	*/
	...
	var allNewItems=[
		...
		"sendheatpack",
		"sendsnowboard",
		"bushel_landinililies",
		"bushel_peony",
		"tree_giantbrokenheart",
		"tree_redrocketcrape",
		"tree_heartshape",
		"adopt_foalroseunicorn",
		"adopt_foalromance",
		"adopt_calfromance",
		"adopt_foalrosepony",
		"adopt_calfromeo",
		"adopt_calfvosges",
		"adopt_foalsingleunicorn",
		"adopt_foalvalentineunicorn",
		"adopt_foalpinkpegacorn",
		"mat_winterlivestockpen",
		"mat_winteraviary",
		"mat_romanticcarriage",
		"carriagelamp",
		"cozyblanket",
		"fancychocolate",
		"flowertrim",
		...
		"sendfirewood",
		"tree_giantsweater",
		"tree_giantsprucebirdhouse",
		"tree_giantsapphire",
		"tree_giantfrozengemfruit",
		"tree_giantbarecrystaltree",
		"adopt_foalcrystalpegacorn",
		"adopt_calfcrystal",
		"egg_crystal",
		"adopt_foalafricandonkey",
		"tree_giantheart",
		"adopt_foalvalentine",
		"adopt_foalvalentinepony",
		"egg_cupid",
		"tree_pinkplum",
		"adopt_foaldragon",
		"bushel_lovestrawberry",
		"bushel_redrose"
	];
	...
	var allNewItems2=[
		...
		"adopt_calfcocoa",
		"tree_gianthotcocoa",
		"tree_giantsugarcookie",
		"tree_giantheartflake",
		"tree_popsicle",
		"sendsoup",
		"sendmagnifyingglass",
		"sendcarrierpigeon",
		...
		"adopt_cowsmitten",
		"adopt_sheepsmitten",
		"adopt_smittenstallion",
		"adopt_calfsmitten",
		"adopt_foalsmitten",
		"adopt_foalsmittenpony",
		"tree_giantcupid"
	];
	
	var allNewItems3=[
		"sendcocoamarshmallow",
		"sendcocoamix",
		"sendmug",
		"sendperfecthotcocoa",
		"sendspice",
		...
		"mat_winterzoo",
		"mat_winterpetrun",
		"adopt_calflunarnewyear",
		"adopt_foallunarnewyear"
	];
	...
	function dock(){
		...
		var fruitTypes=["bell pepper","black berry","blueberry","fire pepper","chardonnay","cranberry","eggplant","elderberry",
				...
				"darrow blackberry","chandler blueberry","cove cranberry","red iceberry","frozen grapes","love strawberry"].fixOrder();
		...
		var flowerTypes=["bluebell","red tulip","purple popp","sunflower","lilac","daffodil","iris","morning glory","saffron",
				"lavender","clover","pink rose","white rose","daylil","lily","orange dais","electric lil","poinsettia","gladiolus",
				"pink carnation","fire & ice rose","flamingo flower","yellow rose","pink hibiscus","green hellebore","alpine rose",
				"green rose","edelweiss","lotus","golden popp","red clover","hollyhock","black rose","white poinsettia","pink aster",
				"columbine","cornflower","electric rose","star flower","chrome dais","sun popp","english rose","forget me not",
				"gardenia","spring squill","foxglove","lilac daffy","lady slipper","black tulip","snow tulip","glacial rose",
				"red rose","landini lilies","peony"].fixOrder();
		...
		var treeTypes=["alma fig","amherstia","angel red pomegranate","apple","ash","autumn ginkgo","bahri date","banana",
				...
				"moon","pink magnolia","poinsettia","lychee","durian","white apple","pink plum","spruce birdhouse",
				"heart shape","red rocket crape","popsicle"].fixOrder();

		var treeTypes2=["bell flower","black cherry","boom","bubblegum","candy apple","caramel apple","chocolate heart",
				"chrome cherry","hot cocoa","cocoa truffle","cupcake","disco ball","father","fleur de lis","french bread",
				"frozen gem fruit","golden apple","heart candy","jewel","july balloon","balloon","july confetti",
				...
				"sugar skull","halloween candle","fall ribbon flower","golden fairy","forbidden gem","purple crystal",
				...
				"amethyst gem","frosted fairy","winter spirit","whittled","sculpted","sapphire","bare crystal","gem fruit",
				"gem","broken heart","heart","sweater","spruce birdhouse","cocoa","sugar cookie","heartflake","cupid"].fixOrder();
		...
		var buildings=["maison","nursery barn","botanical garden","japanese barn","beehive","garage","pig pen","haunted house",
				...
				"cove","winter livestock pen","cow pasture","horse paddock","castle duckula","harvest hoedown","winter animal pen",
				"winter wonderland train station","snow treasure","santa's sleigh","winter water wheel","livestock pen","zoo",
				"winter pasture","winter paddock","animal feed mill","ice palace","crop mastery billboard","aviary","pet run",
				"romantic carriage"].fixOrder();
		...
		var standardMaterials=["goo ","haunted brick","knockers","creepy candle","brick","wooden board","nail","harness","horseshoe",
				...
				"horse treat","carriage lamp"].fixOrder();
				
		var fixTitles={
				mat_livestockpen:"Water Pump, Wire, Steel Beam",
				mat_winterlivestockpen:"Water Pump, Wire, Steel Beam",
				mat_wildlifehabitat:"Fence Post, Shrub, Grazing Grass",
				mat_petrun:"Painted Wood, Water Pump, Fence Post",
				mat_zoo:"Wrench, Shrub, Pipe",
				mat_aviary:"Clamp, Hinge, Screwdriver",
				mat_winteraviary:"Clamp, Hinge, Screwdriver",
				mat_cowpasture:"Hay Bundle, Stone, Tin Sheet",
				mat_winterpasture:"Hay Bundle, Stone, Tin Sheet",
				mat_horsepaddock:"Bridle, Saddle, Log",
				mat_winterpaddock:"Bridle, Saddle, Log",
				mat_winterpetrun:"Painted Wood, Water Pump, Fence Post",
				mat_winterzoo:"Wrench, Shrub, Pipe"
			};
		...
		//automatically capitalizes first letter of every word
		//fill the markAsNew array with elements you want marked green
		function createMenuFromArray(arr,prefix,sort,markAsNew,titles){
			titles=mergeJSON(fixTitles,(titles||{}));
			markAsNew=[].concat(allNewItems, allNewItems2, allNewItems3, (markAsNew||[]));
			sort=(sort==null)?true:sort;
			...
			if (arr) {
				...
				for (var i=0,len=arr2.length;i<len;i++){
					var keyName = (prefix||'')+arr2[i].noSpaces().toLowerCase();
					var fixedLabel=screwyTexts[arr2[i].toLowerCase()];
					ret[keyName]={type:'checkbox',label:(fixedLabel || arr2[i]).upperWords(),title:titles[keyName]};
					//determine array to determine color
					if (markAsNew.inArray(keyName)){
					if (allNewItems2.inArray(keyName)) ret[keyName]["newitem"]=2;
						else if (allNewItems3.inArray(keyName)) ret[keyName]["newitem"]=3;
		...
		var specialMaterials=["fruit cake","beach toys","apple","treats","tricks","bonfire supplies","holiday gifts",
				"stocking stuffer","snowman parts","token of affection"].fixOrder();
		...
		var questItems=[				
				"soup","magnifying glass","carrier pigeon","classified ad","giant toothpick","missing poster","mittens",
				"sasquatch flakes","sasquatch shoes","party whistle","sasquatch bait","snow sweeper","testimonial","sculpture plan",
				"ice brush","whittled animal","sculpt by numbers kit","chisel","block of ice","judge","podium","score card",
				"inspirational photo","wonder ice","smocks and beret","fair ribbon","skis","ski pants","slalom flag","sports drink",
				"fan poster","toboggan","penguin helmet","penguin goggles","cleaning dust","lift pass","running shoes","dumbbell",
				"yoga mat","scrub brush","skinny clothes","cookbook","resolution","string","alarm clock","snowboard outfit",
				...
				"sprinkler","grow light","work order","elbow grease","praise for henry","love potion","heat pack","snowboard","surfboard",
				"tanning lotion","cool shades","beanie","firewood","cocoa marshmallow","cocoa mix","mug","perfect hot cocoa","spice",
				"everything nice","sugar","pinch of snow","rich chocolate","fishing line","shiny doodad","shiny bobdinger","fish sweater",
				"ice saw","hug","photo with elves","yummy drink","cheer for you","piece of a ticket","goodbye gift","construction paper",
				"glue stick","glitter jar","high five","streamer","punch bowl","party popper","party whistle","social guide",
				"sasquatch cologne","whooziwutzit","heart snowball","paint brush","broom","wok","firecracker","red envelope",
				"cake decoration","snug sweater","large water bottle","large flashlight"
			].fixOrder();
		...
		var calfTypes=["autumn","belted","candy cane","chocolate","chrome","devon","dexter","disco","english","fan",
				...
				"kerry","kelly green","mohawk","neapolitan","lunar new year","panda","pink patch bull","pink patch",
				...
				"icicle","sweater","frozen","judge","baby","american","crystal","romance","romeo","vosges","cocoa",
				"smitten","new year"].fixOrder();
				
		var yakTypes=["gray baby","black baby","baby"].fixOrder();

		var foalTypes=[//multiple words
				...
				"mini party","new forest pony","lunar new year","nightmare blue unicorn","pink gypsy","pink ponytail","pink pony",
				...
				"snowflake pony","snowflake pegasus","frozen pegasus","aurora unicorn","green caroling","valentine pony",
				"crystal pegacorn","african donkey","pink pegacorn","rose pony","valentine unicorn","single unicorn",
				"rose unicorn","new year","smitten pony",
		...
		var sheepTypes=["miner","mouflon","polka dots","red","scuba","flower","clover","shamrock","spaghetti","vineyard",
				"scared","luv","thank","sunny","schooled","caroling","star bright","smitten"].fixOrder();
		...
		var cowTypes=["brown","chocolate","dexter","disco","fan","groovy","irish moiled","longhorn","pink patch",
				...
				"flannel","caroling","smitten"].fixOrder();
		...
		var eggTypes=["white","brown","black","cornish","golden","rhode island red","scots grey","rainbow","candycane",
				...
				"tourist","snowflake","crystal","cupid"].fixOrder();
		...
		var otherAnimals=["pink lamb","baby lamb","dorking chicken","persian cat","baby turkey","baby elephant",
				...
				"aurora unicorn","light blue pony","holiday st bernard","snow leopard","smitten stallion"].fixOrder();
	...
	//	var t9 = createAccTextFromArray(craftTypes,"sample_"," Sample");
		...
		var t21 = {
			...
			adopt_winterrare:"Winter Baby (Rare)",adopt_baby:"Unknown Baby",adopt_holidaystbernard:"Holiday St. Bernard",
		};
		...
		var attachment={
			...
			alterLink:{
				...
				words:["nail","wooden board","brick","honeybee","vehicle part","smoker","beeswax","blanket","bottle",
					...
					"light plywood","black light","blue roller","white paper",
			...
			tests: [
				...
				{body:["just finished building their Winter Pet Run","Holiday St. Bernard"],ret:"adopt_holidaystbernard"},
				{body:["has finished work on their Winter Zoo","Snow Leopard"],ret:"adopt_snowleopard"},
				...
				{either:["cupid bow","pair of wings","love arrow"],ret:"tokenofaffection"},
				{link:["wings","bow","love arrow"],ret:"tokenofaffection"},
				...
				{body:"Romatic Carriage",ret:"mat_romanticcarriage"},
				...
				{link:["one","some","bonus","get gift"],ret:"none",kids:[
					{body:"magic snowflake",ret:"snowmanparts"},
					{body:"holiday gift",ret:"holidaygifts"},
					{body:"stocking stuffer",ret:"stockingstuffer"},
					{body:["cupid bow","pair of wings","love arrow"],ret:"tokenofaffection"},
			...
			menu: {
				...
				equinetab:{type:'tab',label:"Horses & Foals",kids:{
					...
					horseBlock:{type:'optionblock',label:"Horses:",kids:{
						...
						adopt_smittenstallion:{type:'checkbox',label:"Smitten Stallion",newitem:true},
				...
				sheepistab:{type:'tab',label:"Goats, Sheep & Lambs",kids:{				
					sheepBlock:{type:'optionblock',label:"Sheep:",kids:{
						...
						adopt_sheepsmitten:{type:'checkbox',label:"Smitten",newitem:true},
				...
				miscanimstab:{type:'tab',label:"Other Animals",kids:{
					...
					otheranimalsBlock:{type:'optionblock',label:"Other Animals:",kids:{
						...
						adopt_holidaystbernard:{type:'checkbox',label:"Holiday St. Bernard",newitem:true},
	...
	function sendWishGift(){
		...
		if (!node) node=selectSingleNode(".//span[contains(@class,'fb_protected_wrapper')]/input[contains(@class,'request_form_submit') and not(contains(@class,'noHammer'))]");
	...
	function run(){
		...
		else if (href.startsWith(thisLoc+'/reward.php') && (text.find("Would you like a ") || text.find("Would you like an ")) && (text.find("Bushel") || text.find("Basket"))){
		...
		*/
		//*************************************************************************************
			...
			//accepted
			if (text.match(
				/(congrat(ulations|s)|yee-haw|hooray|lucky you|you (helped|claimed|collected)|agreed to join|(you )?just (sent|unlocked|collected|gave you)|(thanks|thank you) for (helping|taking part|your interest)|wants you to have|can find it in your|play farmville|can be found in your gift box)/gi
			)) sendMessage('status=1');
		}
