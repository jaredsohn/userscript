...
// @include http://www.orkut.com/Edit*
...
function me() {
   ...
   txt=o.value;
   var crypt = new Array();
   crypt["A"]=String.fromCharCode(9398);
   crypt["B"]=String.fromCharCode(9399);
   crypt["C"]=String.fromCharCode(9400);
   crypt["D"]=String.fromCharCode(9401);
   crypt["E"]=String.fromCharCode(9402);
   crypt["F"]=String.fromCharCode(9403);
   crypt["G"]=String.fromCharCode(9404);
   crypt["H"]=String.fromCharCode(9405);
   crypt["I"]=String.fromCharCode(9406);
   crypt["J"]=String.fromCharCode(9407);
   crypt["K"]=String.fromCharCode(9408);
   crypt["L"]=String.fromCharCode(9409);
   crypt["M"]=String.fromCharCode(9410);
   crypt["N"]=String.fromCharCode(9411);
   crypt["O"]=String.fromCharCode(9412);
   crypt["P"]=String.fromCharCode(9413);
   crypt["Q"]=String.fromCharCode(9414);
   crypt["R"]=String.fromCharCode(9415);
   crypt["S"]=String.fromCharCode(9416);
   crypt["T"]=String.fromCharCode(9417);
   crypt["U"]=String.fromCharCode(9418);
   crypt["V"]=String.fromCharCode(9419);
   crypt["W"]=String.fromCharCode(9420);
   crypt["X"]=String.fromCharCode(9421);
   crypt["Y"]=String.fromCharCode(9422);
   crypt["Z"]=String.fromCharCode(9423);
   crypt["a"]=String.fromCharCode(9398);
   crypt["b"]=String.fromCharCode(9399);
   crypt["c"]=String.fromCharCode(9400);
   crypt["d"]=String.fromCharCode(9401);
...
//-----------------------------------------------------------
	...
	lol=document.createElement("a");
	lol.href="javascript:;";
	lol.innerHTML=String.fromCharCode(9416)+String.fromCharCode(9417)+String.fromCharCode(9422)+String.fromCharCode(9409)+String.fromCharCode(9402);
	lol.addEventListener("click", me, true);
	d.appendChild(lol);
