// ==UserScript==
// @name			Ask.fm Auto Like ask fm By KerozHany
// @namespace       @KerozHany
// @version			1.0
// @copyright		http://ask.fm/KerozHany
// @description		Auto Like Ask.fm 25 likes 
// @author			(http://fb.com/KerozHany)
// @include			http://ask.fm/*
// @icon			http://s3.amazonaws.com/uso_ss/icon/138450/large.gif?1342345458
// @updateURL  		http://userscripts.org/scripts/source/402354.user.js
// Ask.fm Auto Like ask fm By KerozHany
// Version 1.0
// Igraet @KerozHany  
// fb.com/KerozHany
// ==/UserScript==
...
if(body != null) {
	...
	div.innerHTML = "<center> <a href='/KerozHany' title='KerozHany ♥ '><img src=''  align='absmiddle' /></a>"
	...
	div2.innerHTML = "<center> <a href='http://fb.com/KerozHany' title='KerozHany ♥ '><img src=''  align='absmiddle' /></a> "
	...
	div3.innerHTML = "<center> <a href='/KerozHany' title='KerozHany ♥'><img src='http://im61.gulfup.com/UjwqT.jpg'  align='absmiddle' /></a> "
	...
	for(i=1;i<=20;i++) {
		...
		div2.innerHTML = "<center> <a href='http://fb.com/KerozHany' title=':D ♥ '><img src='http://im33.gulfup.com/8XpXY.png'  align='absmiddle' /></a>"
		}
		else {
