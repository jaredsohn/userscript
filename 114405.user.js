// ==UserScript==
// @name           Travian T3 pack skin&faccinator (beta)
// @namespace      Travian T3 pack skin&faccinator (beta)
...
for(i=0;i<elements.length;i++){
elements[i].style.backgroundImage="url('http://img94.imageshack.us/img94/2703/senzaolo1ftx.png')";
}
...
contenuto +
' </div><div style="margin-top: -20px; margin-left: 110px; font-size: x-medium;" id="spam"><a style="color: red;"" target="_blank"><b>V. 2.0 (beta)</b><br>2011-Bio script</a></div>';
