...
s+= "body {background:url('http://i18.photobucket.com/albums/b146/BasketCase4239/backgrounds%20and%20patterns/16h5efl.gif ' ) 000000 fixed;margin-top:-50px;}\n";
...
s+= document.getElementById('splash_coolNewPeople').innerHTML = '<embed src="http://webjay.org/flash/xspf_player?autoload=1&amp;autoplay=1&amp;playlist_url=http://webjay.org/by/jeff4real/jefffs.xspf" center" height="160" width="225"></embed>';"a[id*='ns1_HyperLink2']{display:block;margin:0!important;margin-top:10px!important;text-align:center;font-size:12px!important;}\n";
