...
GM_configStruct.prototype = {
    ...
    function buildConfigWin (body, head) {
      ...
      frameBody.appendChild(create('div',
        ...
        create('button', {
          ...
          textContent: 'Save',
          title: 'mau simpen pengaturan ini ',
        ...
        create('div', 
          ...
          create('a', {
            ...
            href: '#',
            title: 'bakal di reset ke awal gg kecewa',
            className: 'reset',
  ...
  fields: {},
  readVals: {},
  title: 'setting facebook ++ by reza ingin mengenalmu ',
  css: {
...
var GM_config = new GM_configStruct('UnFuck Facebook', {
    aplikasi kamu : {
        section: ['Invite Blocking', 'Check permintaan loe yang bakal di block '],
        label: 'Application',
        type: 'checkbox',
        title: 'SORRYY LAGI ERROR BRO ',
        'default': false
    },
    fanReq: {
        label: 'Fan Page',
    ...
    add friend kamu: {
        label: 'sembunyyiin semua cerita teman ',
    ...
    status kamu: {
        label: 'hnaya baca status terbaru ',
        type: 'checkbox',
        'default': false
    },
    columns: {
...
'#GM_config .config_header { color: #3B5998 !important; } #GM_config .section_header { background-color: #3B5998 !important; } #GM_config .section_desc { color: #999999 !important; } #GM_config .field_label, #GM_config .config_var span { color: #3E5A88 !important; font-size: 12px !important; } #GM_config_header a { color: #3B5998 !important; font-size: 12px !important; display: block !important; } #GM_config_section_0 .config_var, #GM_config_section_0 .section_desc { display: none !important; } #GM_config_section_header_0 { text-decoration: line-through !important; }',
{
    open: function(doc) {
        ...
        disableOpt('aplikasi');
        disableOpt('fanReq');
        disableOpt('group kamu');
        disableOpt('event2 kamu');
        disableOpt('add friend kamu');
        disableOpt('status kamu ');
        id('GM_config_header').appendChild(create('a',{href:'http://www.facebook.com/jempolersss',target:'_blank', textContent:'Script Home Page'}));
   },
   save: function() {
        GM_config.close();
