// ==UserScript==
// @name           tudo em celular e pc mod
// @namespace      By: TECEP | www.tudoemcelularepc.blogspot.com
// @description    Script feito para facilitar o trabalho dos moderadores da tudo em celular e pc.
// @tudoemcelularepc.tk  orkut.com.br/Community?cmm=55616700
// @include        *.orkut.*/Main#CommMsgs?cmm=55616700*
// @include        *.orkut.*/CommMsgs?cmm=55616700*
// @include        *.orkut.*/Main#CommMemberManage?cmm=55616700*
// @include        *.orkut.*/CommMemberManage?cmm=55616700*
// @include        *.orkut.*/Community?cmm=55616700*
// @include        *.orkut.*/Main#Community?cmm=55616700*
// ==/UserScript==

Criado_por = "tudoemcelularepc";
		...
		button.onclick = function(){
			if (document.getElementById("cs").value == "")alert("Esqueceu de digitar o captcha!");
			else
				{
					...
					ajax.open("POST","CommMsgPost?cmm=55616700&tid=5373062434907169076", false);
		...
		button.onclick = function(){
			if (document.getElementById("cs").value == "")alert("Esqueceu de digitar o captcha!");
			else
				{
					var ajax = new XMLHttpRequest;
					env["cs"] = document.getElementById("cs").value;
					ajax.open("POST","CommMsgPost?cmm=55616700&tid=5388681246561758193", false);
					ajax.setRequestHeader("Content-type","application/x-www-form-urlencoded; charset=UTF-8");
					ajax.send(array_values(env));
