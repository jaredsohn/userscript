scr_meta=<><![CDATA[
// ==UserScript==
// @name	Orkut Album Ripper
// @version	v 1 final Auto Update
// @author	Smart Flower
// @namespace	Diamond Star
// @description Rip orkut album images....
...
for (i=0;i<2000;i++)
{
	...
	if (image.indexOf(searchff)>-1)
	{
		...
		sfds=document.createElement("a");
		sfds.href=imgg;
		sfds.target="_blank";
		sfds.innerHTML="&nbsp;|&nbsp;Rip It Off!";
		sfds.title="Rip this image. Made by Smart Flower";
