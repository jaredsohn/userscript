...
function timer_exec() {
  if (profile.preferences.timer_min == undefined) profile.preferences.timer_min = 300;
  if (profile.preferences.timer_max == undefined) profile.preferences.timer_max = 1000;
}
    ...
    if (!profile.vars.browse_pause) {
      switch (Page.c_page) {
        ...
        case 'user':
          ...
          var action;
          if (slowdown) action = new Timer(3000, 3000);
