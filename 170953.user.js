// ==UserScript==
// @name        YPOX TURBO SPEED BY Abhishek Kumbhani
// @namespace   ypox
// @description ypox Script earns automatically for you
// @include     http://www.ypox.com/*
// @include     http://fridaylatest.blogspot.com/*/*
...
if(url.search(pattern)==0)
{
	window.location.href="http://fridaylatest.blogspot.com";
}    
var pattern=/^http:\/\/fridaylatest.blogspot.com/g;
if(url.search(pattern)==0)
{
