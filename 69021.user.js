...
lang.login.error={};
lang.alarm={};
lang.mainmenu.title="PoznÃ¡mkovÃ½ blok";
lang.mainmenu.savednotes="UloÅ¾enÃ© poznÃ¡mky";
lang.mainmenu.nonotes="ZatÃ­m nebyla uloÅ¾ena Å¾Ã¡dnÃ¡ poznÃ¡mka.";
lang.writenew="PÅ™idat novou poznÃ¡mku";
lang.edit="Upravit poznÃ¡mku";
lang.title="Titulek";
lang.text="Text";
lang.save="UloÅ¾it";
lang.valid.text="MusÃ­te vyplnit text poznÃ¡mky";
lang.valid.title="MusÃ­te vyplnit titulek poznÃ¡mky";
lang.del="Smazat";
lang.edit="Upravit";
lang.restart_confirm="Opravdu chcete vymazat veÅ¡kerÃ© poznÃ¡mky?";
lang.name="PoznÃ¡mky";
lang.login.ocogo="<h2>PÅ™ihlÃ¡sit se k ÃºÄtu na <a href='http://tw-help.net'>tw-help.net</a></h2><br />Aby bylo moÅ¾nÃ© pÅ™istupovat k poznÃ¡mkÃ¡m ze vÅ¡ech poÄÃ­taÄÅ¯, musÃ­ bÃ½t uklÃ¡dÃ¡ny na cizÃ­ server. VaÅ¡e jmÃ©no a heslo slouÅ¾Ã­ k identifikaci, Å¾e jste to opravdu Vy. JmÃ©no i heslo (NIKOLI K HERNÃMU ÃšÄŒTU) staÄÃ­ zadat jednou, GreaseMonkey si je potÃ© jiÅ¾ pamatuje.";
lang.login.nick="JmÃ©no";
lang.login.pwd="Heslo";
lang.login.noacc="JeÅ¡tÄ› nemÃ¡te tw-help ÃºÄet?";
lang.login.login="PÅ™ihlÃ¡sit";
lang.login.valid="Zadejte, prosÃ­m, validnÃ­ Ãºdaje";
lang.login.error.noserver="Nepovedlo se pÅ™ipojit k serveru. Zkuste to, prosÃ­m, za chvÃ­li znovu.";
lang.login.error.nouser="Bylo zadÃ¡no nesprÃ¡vnÃ© jmÃ©no nebo heslo";
lang.login.error.noaktiv="PÅ™ed pouÅ¾itÃ­m musÃ­te ÃºÄet aktivovat";
lang.login.success="Byl/a jste ÃºspÄ›Å¡nÄ› pÅ™ihlÃ¡Å¡en/a";
lang.zmuldat="ZmÄ›nit ÃºloÅ¾iÅ¡tÄ› dat";
lang.zmuldatal1="Data jsou nynÃ­ uklÃ¡dÃ¡na na";
lang.localhost="lokÃ¡lnÃ­ poÄÃ­taÄ";
lang.foreignserver="cizÃ­ server";
lang.chars="znakÅ¯";
lang.youvewroten="JiÅ¾ jste napsal/a";
lang.zbyva="a zbÃ½vÃ¡";
lang.toomuchlong="PoznÃ¡mka je moc dlouhÃ¡, musÃ­me ji zkrÃ¡tit.";
lang.alarm.ding="Crrrrrrr!\nProdlouÅ¾it alarm o 10 minut?";
lang.toomuchnotes="PoznÃ¡mku se nepovedlo uloÅ¾it, dosÃ¡hl/a jste maximÃ¡lnÃ­ho poÄtu uloÅ¾enÃ½ch poznÃ¡mek. NjÄ›akÃ©, prosÃ­m, smaÅ¾te.";
lang.alarm.switchon="Zapnout alarm";
lang.alarm.when="Za jak dlouho (v sekundÃ¡ch) mÃ¡ alarm zvonit";
lang.valid.alarm="MusÃ­te zadat validnÃ­ Äas, za jak dlouho mÃ¡ zvonit alarm (ÄÃ­selnÄ›, v sekundÃ¡ch)";
lang.deletesure="Opravdu chcete smazat poznÃ¡mku?";
switch(loc){
case "sk":
lang.mainmenu.title="PoznÃ¡mkovÃ½ blok";
lang.mainmenu.savednotes="UloÅ¾enÃ© poznÃ¡mky";
lang.mainmenu.nonotes="ZatiaÄ¾ nebola uloÅ¾enÃ¡ Å¾iadna poznÃ¡mka.";
lang.writenew="PridaÅ¥ novÃº poznÃ¡mku";
lang.edit="UpraviÅ¥ poznÃ¡mku";
lang.title="NÃ¡zov";
lang.text="Text";
lang.save="UloÅ¾iÅ¥";
lang.valid.text="MusÃ­te vyplniÅ¥ text poznÃ¡mky";
lang.valid.title="MusÃ­te vyplniÅ¥ nÃ¡zov poznÃ¡mky";
lang.del="ZmazaÅ¥";
lang.edit="UpraviÅ¥";
lang.restart_confirm="Naozaj chcete vymazaÅ¥ vÅ¡etky poznÃ¡mky?";
lang.name="PoznÃ¡mky";
lang.mainmenu.title="PoznÃ¡mkovÃ½ blok";
lang.mainmenu.savednotes="UloÅ¾enÃ© poznÃ¡mky";
lang.mainmenu.nonotes="ZatiaÄ¾ nebola uloÅ¾enÃ¡ Å¾iadna poznÃ¡mka.";
...
lang.restart_confirm="Naozaj chcete vymazaÅ¥ vÅ¡etky poznÃ¡mky?";
lang.name="PoznÃ¡mky";
lang.login.ocogo="<h2>PrihlÃ¡siÅ¥ sa k ÃºÄtu na <a href='http://tw-help.net'>tw-help.net</a></h2><br />Aby bolo moÅ¾nÃ© pristupovaÅ¥ k poznÃ¡mkÃ¡m zo vÅ¡etkÃ½ch poÄÃ­taÄov, musia byÅ¥ ukladanÃ© na cudzÃ­ server. VaÅ¡e meno a heslo slÃºÅ¾i k identifikÃ¡cii, Å¾e ste to naozaj Vy. Meno aj heslo (NIE K HERNÃ‰MU ÃšÄŒTU) staÄÃ­ zadaÅ¥ raz, GreaseMonkey si ich potom uÅ¾ pamÃ¤tÃ¡.";
lang.login.nick="Meno";
lang.login.pwd="Heslo";
lang.login.noacc="EÅ¡te nemÃ¡te tw-help ÃºÄet?";
lang.login.login="PrihlÃ¡siÅ¥";
lang.login.valid="Zadajte, prosÃ­m, sprÃ¡vne Ãºdaje";
lang.login.error.noserver="Nepodarilo sa pripojiÅ¥ k serveru. SkÃºste to, prosÃ­m, za chvÃ­Ä¾u znovu.";
lang.login.error.nouser="Bolo zadanÃ© nesprÃ¡vne meno alebo heslo";
lang.login.error.noaktiv="Pred pouÅ¾itÃ­m musÃ­te ÃºÄet aktivovaÅ¥";
lang.login.success="Bol/a ste ÃºspeÅ¡ne prihlÃ¡senÃ½/Ã¡";
lang.zmuldat="ZmeniÅ¥ ÃºloÅ¾isko dÃ¡t";
lang.zmuldatal1="DÃ¡ta sÃº prÃ¡ve ukladanÃ© na";
lang.localhost="lokÃ¡lny poÄÃ­taÄ";
lang.foreignserver="cudzÃ­ server";
lang.chars="znakov";
lang.youvewroten="UÅ¾ ste napÃ­sal/a";
lang.zbyva="a zostÃ¡va";
lang.toomuchlong="PoznÃ¡mka je veÄ¾mi dlhÃ¡, musÃ­me ju skrÃ¡tiÅ¥.";
lang.alarm.ding="Crrrrrrr!\nPredÄºÅ¾it alarm o 10 minÃºt?";
lang.toomuchnotes="PoznÃ¡mku sa nepodarilo uloÅ¾iÅ¥, dosiahol/a ste maximÃ¡lneho poÄtu uloÅ¾enÃ½ch poznÃ¡mok. NejakÃ©, prosÃ­m, zmaÅ¾te.";
lang.alarm.switchon="ZapnÃºÅ¥ alarm";
lang.alarm.when="Za ako dlho (v sekundÃ¡ch) mÃ¡ alarm zvoniÅ¥";
lang.valid.alarm="MusÃ­te zadaÅ¥ validnÃ­ Äas, za ako dlho mÃ¡ zvoniÅ¥ alarm (ÄÃ­selne, v sekundÃ¡ch)";
lang.deletesure="Naozaj chcete zmazaÅ¥ poznÃ¡mku?";
break;
...
lang.mainmenu.nonotes="NÃ£o tens notas guardadas.";
...
lang.valid.title="Tens de preencher o campo \"TÃ­tulo\" da nota";
lang.del="Apagar";
lang.edit="Editar";
lang.restart_confirm="Tens a certeza que queres apagar todas as notas?";
lang.name="Notas";
lang.login.ocogo="<h2>Login na conta em <a href='http://tw-help.net'>tw-help.net</a></h2><br />Para que seja possÃ­vel ir buscar a informaÃ§Ã£o para cada computador com este script a informaÃ§Ã£o terÃ¡ de ser guardada num servidor online. O nick e a password ajudarÃ£o a verificar se Ã©s realmente tu. O nick e a password (NÃƒO SÃƒO AS DO JOGO) sÃ³ sÃ£o colocados uma vez, o script irÃ¡ relembrar-se.";
lang.login.nick="Nick";
lang.login.pwd="Password";
lang.login.noacc="NÃ£o tens uma conta no tw-help?";
lang.login.login="Log in";
lang.login.valid="Introduz a informaÃ§Ã£o correctamente";
lang.login.error.noserver="Alguma coisa falhou durante a conexÃ£o ao servidor. Tenta novamente.";
lang.login.error.nouser="Nick ou Password introduzidos incorrectamente";
lang.login.error.noaktiv="TerÃ¡s de activar a tua conta antes de a usares";
lang.login.success="Acedeste Ã  tua conta com sucesso";
lang.zmuldat="Change disposal site for notes";
lang.zmuldatal1="As Notas estÃ£o agora guardadas em";
lang.localhost="este computador";
lang.foreignserver="servidor externo";
lang.chars="caracteres";
lang.youvewroten="Tu jÃ¡ escreveste";
lang.zbyva="e esquerda";
lang.alarm.ding="DingDangDong!\nTocar o alarme depois de 10 minutos?";
lang.toomuchlong="A Nota Ã© muito grande, tens de a encurtar.";
lang.toomuchnotes="NÃ³s nÃ£o conseguimos gravar esta nota devido ao limite mÃ¡ximo de notas. Apaga alguma antes de gravares uma nova nota.";
lang.alarm.switchon="Ligar o Alarme";
lang.alarm.when="Depois de quantos tempo deverÃ¡ o alarme tocar? (em segundos)";
...
BBCode.prototype.addExtendedCodeTag=function(description,tagName){var input=prompt(description);var text=this.getText();text=(text.length==0?prompt(('ProsÄ‚Â­m zadej popisky pro \"%1\" BB-Code.',tagName)):text);this.insertText('['+tagName+'='+input+']',text,'[/'+tagName+']');};
