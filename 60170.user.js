// ==UserScript==
// @name          Amazon Vancouver Island Regional Library Linky
// @namespace     http://tannock.net
// @description	  v1.5 Search the Vancouver Public Library Catalog from Amazon book listings.  
// @include       http://*.amazon.*
// ==/UserScript==
...
(function(){
//	GM_log('Amazon Vancouver Public Library Linky');	
 
	var libraryIsbnUrlPattern = 'http://hip.virl.bc.ca/ipac20/ipac.jsp?index=ISBNEX&term='
	var libraryTitleUrlPattern = 'http://hip.virl.bc.ca/ipac20/ipac.jsp?index=.TW&term='
	var libraryName = 'the Vancouver Island Regional Library';
