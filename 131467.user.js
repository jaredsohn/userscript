...
// @version			2012
// @author			Ming Net
// @namespace		http://www.facebook.com/mingnet
...
// ==/UserScript==
    ...
    var fbc_desc = 'TERIMA KASIH TELAH BERKUNJUNG';
    var fbc_page = HttpsOn?'http://www.facebook.com/mingnet/':'http://www.facebook.com/mingnet/';
    var fbc_aunm = 'Mingnet';
    var fbc_aupg = HttpsOn?'http://www.facebook.com/mingnet':'http://www.facebook.com/mingnet';
    var fbc_ver = '2012';
    ...
    function fbc_About() {
	   ...
	   '<div>Chibi-Cyber:<a href="'+fbc_page+'">'+fbc_page+'</a><br/>'+
	   '<p>:<br/><a href="'+fbc_aupg+'">'+fbc_aupg+'</a></p></div>';
    }
