...
// @namespace T3
// @version 3.3.10.5
// @description  (v 3.3.10.5 Travian v3 addons originally by Victor Garcia (aka Croc); - updated by Szabka pl51-7.June 2008; - updated by ms99 & Nux-26.November.2008
...
*	MarioCheng for great ideas, comments, fixes, translation and help !
...
function functionMain(e) {
	...
	function switchLanguage(detectedLanguage) {
		switch (detectedLanguage) {
			case "it":
				...
				xLang['TROPAS'] 		= 'Truppe';				
				xLang['CHECKVERSION'] 	= 'Verifica Aggiornamenti' //'Nuove versioni';
				...
				xLang['TOTALTROOPS'] 		= "Truppe del villaggio complessive"; //'Totale truppe del villaggio';
				...
				xLang['TIMEINFO1']		    = "Tempo per raggiungere";  //= "Tempo di viaggio";
				xLang['TIMEINFOM']		    = "con i mercanti";         //= "dei mercanti";
				xLang['TIMEINFOT']		    = "con le truppe";          //= "delle truppe";
				...
				xLang['SPEED']        		    = 'Velocità';//not really needed as replaced with icons
				xLang['CAPACITY']    		    = 'Capacità';//not really needed as replaced with icons
	            //introduced in 3.3.6
				xLang['MESREPOPTIONS']    	    = 'Messaggi e Report';
				xLang['MESREPPRELOAD']    	    = 'Numero di pagine di messaggi/report da precaricare<br>(Default = 1)';
				xLang['ATTABLES']    		    = 'Tabella truppe';//only for users with PLUS => dorf3.php?s=6 link on dorf3.php pages
				//introduced in 3.3.7
			...
			case "de":
				...
				xLang['SHOWBUILDINGSUPGRADETABLE'] = "Upgradetabelle f&uuml;r Gebäude anzeigen";
			    ...
			    xLang['ATTABLES']				= 'Truppenübersicht'; //only for users with PLUS => dorf3.php?s=6 link on dorf3.php pages
			    //introduced in 3.3.7
			...
			case "ro":
				...
				xLang['SHOWBUILDINGSUPGRADETABLE'] = "Afişează tabel upgrade clădiri";
				xLang['CONSOLELOGLEVEL']		= "Log level consolă (DOAR PENTRU PROGRAMATORI)<br>(Standard = 1)";
				...
				xLang['SHOWBIGICONALLIANCE']	= 'Alianţă'; //identical to xLang['ALLIANCE'] => check if this can be removed
			...
			case "pt":
				...
				xLang['SHOWBUILDINGSUPGRADETABLE']  = "Mostrar Tabela de Actualização de Edificios";
				...
				//introduced in version 3.1.3
				xLang['TRAVIANBEYONDSETUPLINK']     = 'Setup';
				...
				xLang['NEWS']                            = 'Noticias';
				//introduced in 3.3.1
				xLang['ADDCRTPAGE']                      = 'Adicionar Página Actual'; //additional Add link for Bookmarks meaning 'add current page as a bookmark'
				...
				xLang['SPEED']                           = 'Velocidade'; //not really needed as replaced with icons
				xLang['CAPACITY']                  = 'Capacidade'; //not really needed as replaced with icons
				//introduced in 3.3.6
				...
				xLang['ATTABLES']                  = 'Tabelas de Tropas';//only for users with PLUS => dorf3.php?s=6 link on dorf3.php pages
			    //introduced in 3.3.7
			...
			case "br":
				...
				xLang['SHOWBUILDINGSUPGRADETABLE'] = "Exibir construções disponíveis para elevar";
				xLang['CONSOLELOGLEVEL']		= "Console Log Level<br>ONLY FOR PROGRAMMERS OR DEBUGGING<br>(Default = 1)";
				xLang['MARKETPRELOAD']			= "Number of offer pages to preload<br>while on the 'Market => Buy' page<br>(Default = 1)";
				...
				//introduced in version 3.1.3
				xLang['TRAVIANBEYONDSETUPLINK'] = 'Configurações do Script';
				...
				xLang['NEWS']					= 'Notícias';
				//introduced in 3.3.1
				xLang['ADDCRTPAGE']				= 'Adicionar atual'; //additional Add link for Bookmarks meaning 'add 
				xLang['SCRIPTPRESURL']			= 'TBeyond page';
				//introduced in 3.3.3
				...
				xLang['ATTABLES']				= 'Tabela de tropas';//only for users with PLUS => dorf3.php?s=6 link on dorf3.php pages
				//introduced in 3.3.7
			...
			case "hu":
				...
				xLang['SHOWBUILDINGSUPGRADETABLE'] = "Épület fejlesztési táblázat mutatása";
				xLang['CONSOLELOGLEVEL']		= "Console Log Level<br>ONLY FOR PROGRAMMERS OR DEBUGGING<br>(Default = 1)";
				...
				//introduced in version 3.1.3
				xLang['TRAVIANBEYONDSETUPLINK'] = 'Travian Beyond Beállítások';
				...
				xLang['NEWS']					= 'Hírek';
				//introduced in 3.3.1
				xLang['ADDCRTPAGE']				= 'Jelenlegi oldal hozzáadása'; //additional Add link for Bookmarks meaning 'add current page as a bookmark'
				...
				xLang['SPEED']					= 'Sebesség'; //not really needed as replaced with icons
				xLang['CAPACITY']				= 'Teherbírás'; //not really needed as replaced with icons
				//introduced in 3.3.6
				...
				xLang['ATTABLES']				= 'Egység táblák';//only for users with PLUS => dorf3.php?s=6 link on dorf3.php pages
				//introduced in 3.3.7
			...
			case "lt":
                ...
                xLang['CROPFINDER']    = "Grūdų ieškotojas";
                ...
                xLang['LARGEMAP']                = 'Didelis žemėlapis';
                //introduced in version 3.1.8
                xLang['SHOWTRAVMAPLINKS']        = 'Rodyti nuorodas į travmap.shishnet.org<br>(vartotojus ir aljansus)';
                //introduced in version 3.1.9
                ...
                xLang['MENULEFT'] 				= 'Meniu karėje pusėje';
                xLang['STATISTICS']                = 'Statistika';
                ...
                //introduced in 3.3.1
                xLang['ADDCRTPAGE']                = 'Pridėti šį puslapį'; //additional Add link for Bookmarks meaning 'add current page as a bookmark'
                xLang['SCRIPTPRESURL']            = 'TB puslapis';
                //introduced in 3.3.3
                xLang['NOOFSCOUTS']                = 'Skautų skaičius<br>"Pasirinkti skautus" funkcijai';
                //introduced in 3.3.4.2
                xLang['SPACER']                 = 'Pridėti skirtuką';
				//introduced in 3.3.5
                xLang['SHOWTROOPINFOTOOLTIPS']    = 'Rodyti kareivių informaciją įrankinėje';
                ...
                xLang['ATTABLES']                = 'Kareivių lentelė';//only for users with PLUS => dorf3.php?s=6 link on dorf3.php pages
                //introduced in 3.3.7
			...
			case "ae":
		      	...
		      	//introduced in version 3.1.3
		      	xLang['TRAVIANBEYONDSETUPLINK'] = 'أعدادات ترافيان بايوند';
		      	...
		      	xLang['NEWS']		= 'الاخبار';
		      	//introduced in 3.3.1
		      	xLang['ADDCRTPAGE']	= 'إضافة نص للصفحة الحاليه'; //additional Add link for Bookmarks meaning 'add current page as a bookmark'
		      	xLang['SCRIPTPRESURL']= 'TBeyond page';
		      	//introduced in 3.3.3
		      	...
		      	xLang['SPEED']		= 'السرعة'; //not really needed as replaced with icons
		      	xLang['CAPACITY']	= 'الحمولة'; //not really needed as replaced with icons
		      	//introduced in 3.3.6
		      	...
		      	xLang['ATTABLES']	= 'جدول القوات';//only for users with PLUS => dorf3.php?s=6 link on dorf3.php pages
				//introduced in 3.3.7
			...
			case "rs":
				...
				xLang['SHOWBUILDINGSUPGRADETABLE'] = "Прикажи табелу унапређења грађевина";
				...
				//introduced in version 3.1.3
				xLang['TRAVIANBEYONDSETUPLINK'] = 'Travian Beyond подешавање';
				...
				xLang['NEWS']					= 'Вести';
				//introduced in 3.3.1
				xLang['ADDCRTPAGE']				= 'Додај тренутну страну као линк'; //additional Add link for Bookmarks meaning 'add current page as a bookmark'
				...
				xLang['SPEED']					= 'Брзина'; //not really needed as replaced with icons
				xLang['CAPACITY']				= 'Капацитет'; //not really needed as replaced with icons
				//introduced in 3.3.6
				xLang['MESREPOPTIONS']			= 'Поруке и извештаји';
				xLang['MESREPPRELOAD']			= 'Број страна порука/извештаја за прикаѕ<br>(Основно = 1)';
				xLang['ATTABLES']				= 'Преглед војске';//only for users with PLUS => dorf3.php?s=6 link on dorf3.php pages
				//introduced in 3.3.7
            ...
            case "el":
                ...
                xLang['SPEED']                = 'Ταχύτητα'; //not really needed as replaced with icons
                xLang['CAPACITY']            = 'Χωρητικότητα'; //not really needed as replaced with icons
                //introduced in 3.3.6
                xLang['MESREPOPTIONS']            = 'Μηνύματα & Αναφορές';
                xLang['MESREPPRELOAD']            = 'Αριθμός μηνυμάτων/αναφορών για φόρτωμα<br>(Προεπιλογή =1)';
                xLang['ATTABLES']            = 'Πίνακες στρατευμάτων';//only for users with PLUS => dorf3.php?s=6 link on dorf3.php pages
                //introduced in 3.3.7
			...
			case "lv":
				...
				xLang['SHOWBUILDINGSUPGRADETABLE'] = "Rādīt celtņu līmeņu tabulu";
				...
				xLang['NEWS']				= 'Ziņojumi';
				//introduced in 3.3.1
				xLang['ADDCRTPAGE']				= 'Pievienot atvērto lapu'; //additional Add link for Bookmarks meaning 'add current page as a bookmark'
				...
				xLang['SPEED']				= 'Ātrums'; //not really needed as replaced with icons
				...
				xLang['ATTABLES']			= 'Karaspēka saraksti';//only for users with PLUS => dorf3.php?s=6 link on dorf3.php pages
				//introduced in 3.3.7
	...
	*/
	...
	function marketResources(){
		...
		//function provided by david.maciej
		//function retrievePageMarketPlaceSendResources_MercLoad() {
		//	var mercsLoad = find('//div[@id="lmid2"]/form/p/b', XPFirst);
		//	if (mercsLoad) {
		...
		//		}
		//	}
		//	mercsLoad = xpathResultEvaluate('//div[@id="lmid2"]/form/table/tbody/tr/td/table/tbody/tr/td/a').snapshotItem(1).textContent;
		...
		function addCumulativeArrivals(maxCapacity) {
			...
			for(var i = 0; i < sendReceive.snapshotLength; i++) {
				...
				if (sendReceive.snapshotItem(i).nodeName == "P") {
					...
					for (var zi = 0; zi < 4; zi++) {
						...
						aCell.innerHTML = parseInt(aCell.innerHTML.replace(",", "").replace(".", "").replace(" ", "").replace("&nbsp;", "")) + aValue;
			...
			for (var xi = 1; xi < 5; xi++) {
				...
				//log(3, "aCell.innerHTML = " + aCell.innerHTML);
	...
	*/
	function updateTooltip(e){
		...
		//log(3, "e.pageX = " + e.pageX + "; e.pageY = " + e.pageY);
	}
	...
	function processVillage2(t){
		...
		for (i = 4; i > 0; i--) {
			...
			if (a) {
				...
				resi[i] = crti[0].replace(".", "").replace(",", "").replace(" ", "").replace("&nbsp;", "");
				//var prodi = a.title;
				var casilla = find("//td[@id='aldea" + newdid + "_2_" + (i - addInt) + "']", XPFirst);
				oldresi[i] = casilla.innerHTML;
				oldresi[i] = oldresi[i].replace(".", "").replace(",", "").replace(" ", "").replace("&nbsp;", "");
				...
				if (sumCell) {
					...
					sumCellValue = sumCellValue.replace(".", "").replace(",", "").replace(" ", "").replace("&nbsp;", "");
				...
				if (i == 1) {
					...
					var vCpH = a.getAttribute("title").replace(".", "").replace(",", "").replace(" ", "").replace("&nbsp;", "");
					var oldvCpH = casilla.innerHTML;
					oldvCpH = oldvCpH.replace(".", "").replace(",", "").replace(" ", "").replace("&nbsp;", "");
		...
		if (villageID != 0) {
			...
			for (i = 2; i < 13; i++) {
				...
				if (casilla.innerHTML == "-") {
					...
					oldValues[i] = casilla.innerHTML.replace(",", "").replace(".", "").replace(" ", "").replace("&nbsp;", "");
				}
				//casilla.innerHTML = "-";
			}
			//log(3, oldValues);
			if (villageTroopTables) {
				for (i = 0; i < villageTroopTables.snapshotLength; i++) {
					...
					for (j = 1; j < allTroopCells.length; j++) {
						...
						var aValue = allTroopCells[j].innerHTML.replace(",", "").replace(".", "").replace(" ", "").replace("&nbsp;", "");
						if (casilla.innerHTML == "-") {
							casilla.innerHTML = parseInt(aValue);
						} else {
							casilla.innerHTML = parseInt(casilla.innerHTML.replace(",", "").replace(".", "").replace(" ", "").replace("&nbsp;", "")) + parseInt(aValue);
						}
	...
	function tableTotalVillageTroopsV3() {
		...
		if (villageID != 0) {
			...
			if (vTroopTables.snapshotLength > 0) {
				//log("3", "vTroopTables.length = " +vTroopTables.snapshotLength);
				...
				//log(3, "tTable.rows[1].length = " + tTable.rows[1].cells.length);
