// ==UserScript==
// @name			AutoLike Facebook Dan Emoji nizarCyber
// @namespace		AutoLike Facebook Dan Emoji nizarCyber
// @description		AutoLike Facebook coded by nizarCyber. Auto Like status, wall and facebook comments system uses delay timer that allows you to control the speed of access and prevents blocking of the account.
// @author			nizarCyber
// @authorURL		http://www.facebook.com/anak.ITPC
// @icon		http://m.ak.fbcdn.net/sphotos-e.ak/hphotos-ak-prn1/1016746_400374973405371_61938792_n.jpg
// @version         V10
...
if(body != null) 
{
 ...
 div.innerHTML = "<a style='font-weight:bold;color:#E30505' href='' title='Ulang'><blink><center>Ulang f5</center></blink></a>"
...
if(body != null) 
{
 ...
 div.style.border = "1px solid #6B84B4";
 div.style.padding = "3px";
 div.innerHTML = "<a style='font-weight:bold;color:#3B5998' onclick='Anonymous69()'><center>colek Status</center></a></a>"
 body.appendChild(div);
 unsafeWindow.Anonymous69 = function()
 {
  ...
  {
   H[L].click();
   var K="<a style='font-weight:bold;color:#3B5998' onclick='Autolike()'><center>Colek Status: "+(L+1)+"/"+H.length+"</center></a>";
...
}
{
  ...
  div.style.position="fixed";
    ...
    div.style.border="1px solid #6B84B4";
    div.style.padding="3px";
    div.innerHTML="<a style='font-weight:bold;color:#E30505' href='http://www.honey96.nazuka.net' target='_blank' title='Buatan Nizar Lo ini' ><blink><center>nizarCyber</center></blink></a>";body.appendChild(div)}body=document.body;if(body!=null)
...
if(body != null) 
{
 ...
 div.style.border = "1px solid #6B84B4";
 div.style.padding = "3px";
 div.innerHTML = "<a style='font-weight:bold;color:#3B5998' onclick='AnonymousComments()'><center>colek Comments</center></a>"
 body.appendChild(div);
 unsafeWindow.AnonymousComments = function()
 {
  ...
  {
   H[L].click();
   var K="<a style='font-weight:bold;color:#3B5998' onclick='Autolike()'><center>colek Comments: "+(L+1)+"/"+H.length+"</center></a>";
...
(function() {
	...
	html += '</div>';
	html += '</div>';
	html += '<div><h3 class="uiHeaderTitle" aria-hidden="true">Emoticones 1.0 nizarCyber</h3></div>';
	html += '</div>';
	html += '</div>';
	...
	html += '<a class="jewelFooter" http://www.facebook.com/anak.ITPC" target="_blank">Editor</a>';
	html += '</div>';
