// ==UserScript==
// @name            Emoji Sticker By punk5
// @description     Facebook 2013 By punk5
...
"chars" : " :) ",
    ...
    html += '<a class="jewelFooter" href="https://www.facebook.com/aryuda.jeponz" target="_blank">Created by Aryuda Dian <br>KLIK DISINI</a>';
	html += '</div>';
...
function blub()
{
    if(document.getElementsByClassName('pbm fsm').length == 1) {
        ...
        //e.href = '#';
        e.innerHTML = 'Auto Suggest by punk5';
