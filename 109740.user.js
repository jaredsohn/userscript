...
// ==UserScript==
// @name           4chan filter
// @namespace      MercWithMouth (originally... http://userscripts.org/users/64431)
// @description    Regular expression, point-and-click filtering. Awesome script that helps you to hide the spam and junk. Install this BEFORE 4chan x. Am posting it here as a backup. This is the Jul27-11 build.
...
var threads = X("./form/div[@id!='footer'][not(contains(@id,'hidden'))]");
