// ==UserScript==
// @name        Remove/delete all friends at once on Facebook by Andy
...
// @version     2.1.4
// ==/UserScript==
// Developed by - http://fb.com/vaL3NtiiN3.CrusH.OffiiCiiaL
...
$('.uiToolbarContent .rfloat').prepend('<div id="skidder_container" style="float:right;margin-left:5px;"><label class="_11b uiButton uiButtonConfirm" for="skidder"><input type="submit" value="Chọn tất cả" id="selec_all"></label><label for="skidder" class="_11b uiButton uiButtonConfirm"><input type="submit" id="mass_deleter" value="Xóa"></label>  <div style="display:block">By Cha</div></div>');
$('._69l.rfloat').prepend('<span id="skidder_container" style="float:right;margin-left:5px;"><label class="_11b uiButton uiButtonConfirm" for="skidder"><input type="submit" value="Chọn tất cả" id="selec_all"></label><label for="skidder" class="_11b uiButton uiButtonConfirm"><input type="submit" id="mass_deleter" value="Xóa"></label>  <span style="display:block">by Andy</span></span>');
