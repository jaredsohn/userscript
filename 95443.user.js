...
var messageWindowTop = 100;		//0 means top of the browser window

var messageWindowLeft = 100;	//0 means left most point of the browser window

var zIndex = 100;				//make it as big as you want to put the message window over top of anything

//Waiting times

var minWait = 1000; 			//Don't make it smaller then 5000ms!
