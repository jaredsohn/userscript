// ==UserScript==
// @name OpenGG.Clean.Player (Sisi)
// @author Anonymous
// @description 修改前任作者的些许代码，希望可以帮助大家
// @version 1.0
// @namespace http://userscripts.org/users/537899
// @updateURL https://userscripts.org/scripts/source/181877.meta.js
// @downloadURL https://userscripts.org/scripts/source/181877.user.js
 ...
 * === 说明 ===
 * 本脚本只是修改了原脚本的优酷播放器地址。
 * 原脚本地址：http://userscripts.org/scripts/show/177755
...
(function() {
    ...
    YoukuAntiAds.prototype = {
        ...
        get players() {
            if(!this._players) {
                this._players = {
                    'youku': 'https://lovejiani.duapp.com/opengg/player_ss.swf',
