...
function addLyric(id) {
    ...
    codebutton.setAttribute("onclick","javascript:document.getElementById('bloginput').setAttribute('value','"+blogcode+"');document.getElementById('noteinput').setAttribute('value','"+notelink+"');document.getElementById('blogcode').style.display='block';");
    codebutton.innerHTML="\u0432\u0441\u0442\u0430\u0432\u0438\u0442\u044c";
    codebutton.setAttribute("href","#");
    newdiv.innerHTML += " | ";
    newdiv.appendChild(codebutton);    
