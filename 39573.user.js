...
// @name		Travian Trooptool Updater with LV support
...
switch(sLang) {
	case "sk":
        ...
        case "ua":
                ...
                break;
        case "lv":
                aLangStrings = ["Jūsu kareivji", "Atgriežas no", "Papildspēki priekš", "'a kareivji", "Uzbrukums pret", "Iebrukums pret", "Izlūko", "Iebrukt neokupētā oāzē", "Ieslodzītie kareivji no", "Update attempted with unknown result.", "Your troops were successfully updated.", "Update failed!", "Troop Tool Updater setup", "Update Troop Tool", "Troop tool Updater:", "Enter the authentication key from your Troop tool profile"];
                break;
	case "en":
	case "com":
	case "uk":
