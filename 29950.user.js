...
// 	}
	...
	function createInfoBox() {
		...
		info.innerHTML = '<table class="f8 map_infobox_grey" width="100%" cellspacing="1" cellpadding="2">' +
				 '<tr><td class="c b" colspan="2" align="center">' + 'Info:' + '</td></tr>' +
				 '<tr><td class="c s7" width="45%" >' + 'Nome:' + '</td><td class="c s7">-</td></tr>' +
				 '<tr><td class="c s7">' + 'Pop:' + '</td><td class="c s7">-</td></tr>' +
				 '<tr><td class="c s7">' + 'Aliança:' + '</td><td class="c s7">-</td></tr>' +
				 '</table>';
		return info;
	}
	...
	function createMapAreas() {
		var map = dst.cn('map');
		map.name = 'map2';
		map.innerHTML = '<area dir="north" href="#" coords="762,115,30" shape="circle" title="Norte">' +
				'<area dir="east"  href="#" coords="770,430,30" shape="circle" title="Este">' +
				'<area dir="south" href="#" coords="210,430,30" shape="circle" title="Sul">' +
				'<area dir="west"  href="#" coords="200,115,30" shape="circle" title="Oeste">';
		...
		return function() {
			...
			if (name) {
				var table = '<table cellspacing="1" cellpadding="2" class="tbg f8"><tr><td class="rbg f8" colspan="2"></a>' + name +
					    '</td></tr><tr><td width="45%" class="s7 f8">' + 'Nome:' +
					    '</td><td class="s7 f8">' + owner +
					    '</td></tr><tr><td class="s7 f8">' + 'Pop:' +
					    '</td><td class="s7 f8" id="ew">' + pop +
					    '</td></tr><tr><td class="s7 f8">' + 'Aliança:' +
					    '</td><td class="s7 f8">' + ally +
					    '</td></tr></table>';
				info.innerHTML = table;
			}
			else {
				var table = '<table class="f8 map_infobox_grey" cellspacing="1" cellpadding="2"><tr><td class="c b" colspan="2" align="center"></a>' + 'Info:' +
					    '</td></tr><tr><td width="45%" class="c s7">' + 'Nome:' +
					    '</td><td class="c s7">-</td></tr><tr><td class="c s7">' + 'Pop:' +
					    '</td><td class="c s7">-</td></tr><tr><td class="c s7">' + 'Aliança:' +
