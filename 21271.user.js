...
// @namespace    user
// @description    Ferramentas para moderação da comunidade C/C++ Brasil. Versão 0.0.4
...
// @include   http://www.orkut.com/CommTopics.aspx?cmm=70567*
// ==/UserScript==
...
const UrlLog = "http://www.orkut.com/CommMsgs.aspx?cmm=70567&tid=2528359597612954957";
const UrlComm = "http://www.orkut.com/CommTopics.aspx?cmm=70567";
...
const ModeloExclusaoMensagem = "[b]Tópico: [/b]$0$ ([link]"+UrlTopico+"$1$[/link])\n" +
...
if (urlAtual.indexOf(UrlComm) == 0) {
	removeBotoesExcluir();
} else if (urlAtual.indexOf(UrlLog) == 0) {
	removeBotaoExcluir();
