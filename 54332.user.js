...
// @description    Version 1.1.0 | Ermöglicht im Browsergame "Die Stämme" das Sortieren der Mitgliederlisten
...
var vers_ist = "DS - Mitglieder sortieren 1.1.0";
...
if((url.match(/screen=info_member/)) || (url.match(/screen=ally&mode=members/))) {
	...
	if(dots >= 1) {
		if(spalten == 12) {
			ausgabe += "<th colspan='16' style='text-align:center; -moz-border-radius-topleft:10px; -moz-border-radius-topright:10px; cursor:default;'>Allgemeine Infos</th>";
		}
		else {
	...
	if(dots >= 1) {
		if(spalten == 12) {
			ausgabe += "<th colspan='16' style='text-align:center; -moz-border-radius-bottomleft:10px; -moz-border-radius-bottomright:10px; cursor:default;'>Allgemeine Infos</th>";
		}
		else {
