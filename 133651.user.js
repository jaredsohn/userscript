// ==UserScript==
// @author		ThomasRed (source : Angel Vladov)
// @name        Damages Report Script for Atracurium
// @namespace   eRepublikBattlesReporter_Atracurium
// @version		0.0.1
// @uso:version 0.0.1
// @include		http://*erepublik.com/*/military/battlefield/*
// @description    eRepublik Damage Reporting script for Atracurium's MU
// ==/UserScript==
...
if(window.location.href.indexOf(PAGE_BATTLEFIELD) > 0) {	
	...
	/***********************************************************************************/
	var FORM_URL = "https://docs.google.com/spreadsheet/viewform?formkey=dFZyZWZSQWhRUjhoeXFpTXdsNUNJQkE6MQ#gid=0";
	var FORM_FIELDS = {
                eday: "entry.0.single",
                name: "entry.2.single",
