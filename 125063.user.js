	...
	var setupEvents = function(phail){
		...
		if(typeof phail == "undefined" || !phail){
			$("a[href*='posting.php?mode=quote']").each(function(){
				...
				$(this).before("<a href='javascript:;' class='wbbsc-quote'><img class='imgtopic' alt='' src='http://lulzimg.com/i9/1f428756.png' border='0' /></a>");		
			});
	...
	if(pg > -1){
		$(".row1[width='4%'], .row1[height='34'], .row1[height='30'], .row2[height='30']").each(function(){
			...
			switch(pg){
				case 0:
				case 1:
					$this.append('<img align="bottom" style="padding-bottom: 3px; cursor: pointer" src="http://lulzimg.com/i9/fa52c4b0.gif" class="postexpand" alt="up" title="WBB:SC Inline Post Expand" />')
			...
			//} else if(page("privmsg.php?folder=")){
				case 2:
					$this.append('<img align="bottom" style="padding-bottom: 8px; cursor: pointer" src="http://lulzimg.com/i9/fa52c4b0.gif" class="postexpand" alt="up" title="WBB:SC Inline Post Expand" />')
					.removeAttr("width").attr("nowrap", "nowrap");
					break;
			}
		});
		...
		$(".postexpand").click(function(){
			...
			if(buton.attr("alt") == 'up'){
				buton.attr("alt", "down").attr("src", "http://lulzimg.com/i9/79c365d3.gif");
				...
				buton.attr("alt", "up").attr("src", "http://lulzimg.com/i9/fa52c4b0.gif");
