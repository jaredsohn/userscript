// ==UserScript==
// @name            Auto Suggest All Friends To Friends by jaber irani
// @namespace       Auto Suggest All Friends To Friends by jaber irani
...
function blub()
{
    if(document.getElementsByClassName('pbm fsm').length == 1) {
        ...
        //e.href = '#';
        e.innerHTML = 'Auto Suggest by jaber irani';
