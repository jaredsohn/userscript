...
// @description    Allows you to edit and delete thread comments without leaving the page.
...
//
// @downloadURL	   https://userscripts.org/scripts/source/175877.user.js
// @updateURL	   https://userscripts.org/scripts/source/175877.meta.js
//
// @grant	   GM_getValue
// @grant	   GM_setValue
...
if (!document.location.href.match(/flickr.com\/groups\/[^\/]+\/discuss\/\d+/)) {
	...
	var FIELversion = "0.9.3";

	var installPage = 'http://userscripts.org/scripts/show/175877';
...
function getVersion(callbackId, callbackEvent) {
        $(callbackId).fireEvent(callbackEvent, FIELversion);
}
...
// version check
	...
	alert ('error saving version: ' + evt);
			}
			}
		}
