...
msg_all.push(["Absence d'avatar","Bonjour,\n\nL'activation de ton personnage a été refusée pour la raison suivante :\n\n- [red][b]Absence d'avatar.[/b][/red]\n\nPour modifier ton avatar, il te suffit de cliquer sur [url=http://www.kraland.org/main.php?p=8_4]modifier le profil[/url] que tu trouveras sur la droite de ta page parmi les différents icônes. Dans [i]adresse avatar[/i], tu devras coller l'adresse url de ton image, puis cliquer sur [i]ok[/i]\n\nUne fois cette information complétée, tu pourras redemander l'activation (attention à bien vérifier tous les choix),\n\nCordialement,"]);
