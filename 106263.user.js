// ==UserScript==
// @name           Links converter for ifanscom
// @namespace      127.0.0.1
// @description    Every link that goes out of IFans.com is encrypted with base64 - this link will remove it so you don't have to click twice. :p
...
// find posts with links containing "outgoing.ifans..."
$('#posts a[href*="outgoing.ifans.com/?d"]').each(function(i) {
	hr = $(this).attr("href");
//	unsafeWindow.console.log(hr);
	// find the base64 in the url and repace ~ with =
	hr = (hr.replace(/.*outgoing\.ifans\.com\/\?d=(.*)/, "$1")).replace(/%7E/gi, "=");
//	unsafeWindow.console.log(hr);
