// ==UserScript==
// @name           Menu GTA
// @namespace      http://godteamalliance.forumdeouf.com/
// @description    Menu pour l'alliance GTA dans Ikariam
// @include        http://*ikariam.*/index.php*
// @author         IshW
// @version        20091021 2.1
// ==/UserScript==


//  21.10.2009
// version 2.1 adaptation alliance GTA
...
'<div id="menu">'
+ '<ul>'
+ ' <li><h2>Alliance GTA</h2>'
+ '   <ul>'
+ '     <li><center><a target="_blank" href="http://ikariam.teknopop.com/ik/zemapv2.swf?nomalliance=GodTeamAlliance" title="Map GTA">Map GTA</a></li>'
+ '     <li><center><a target="_blank" href="http://godteamalliance.forumdeouf.com/" title=" godteamalliance.forumdeouf.com">Forum GTA</a></li>'
+ '     <li><center><a target="_blank" href="http://tools.betawarriors.com/ikcrc/" title=" Convertisseur de combat pour la publication sur un forum">Convertisseur de combat</a></li>'
...
+ '     <li><center><a target="_blank" href="http://www.ika-world.com/suche.php?view=suche_spieler&land=fr" title=" Recherche joueur">Recherche Joueur</a></li>'
+ '     <li><center><a target="_blank" href="http://www.ika-world.com/search.php?view=suche_insel" title=" Recherche position ile">Recherche Ile</a></li>'
