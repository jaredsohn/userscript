...
var Einsatzklasse_Fahrzeugzuordnung = {
  ...
  'TH_VU'                       :  'LF',
  'Feu_Stroh'                   :  'LF/TLF',
  'Feu_Keller'                  :  'LF,LF,LF/TLF',
  'Feu_Dachstuhl'               :  'LF,LF,ELW,DL',
  'Feu_Schornstein'             :  'LF,DL',
  'Feu_Wohnung'                 :  'LF,LF,DL,ELW',
  'Feu_Pommesbude'              :  'LF,TLF',
  'Feu_Scheune'                 :  'LF,LF,LF,ELW,DL',
  'Feu_Silo'                    :  'TLF/LF,LF,DL,ELW',
  'Feu_Baumarkt'		:  'LF,LF,LF/TLF,LF/TLF,LF/TLF/TS,GW-W,GW-A,DL,DL,ELW',
  'Feu_Feld'			:  'LF,LF/TLF
  'Feu_Gewerbe'			:  'LF,LF,LF,LF/TLF,DL,ELW',
  'Feu_Supermarkt'              :  'LF,LF,LF,LF/TLF,ELW',
  'Feu_Altenheim'               :  'LF,LF,LF,ELW,DL',
  'Feu_Kino'                    :  'LF,LF/TLF,ELW,DL',
  'Feu_Sporthalle'              :  'LF,LF/TLF,ELW,DL',
  'Feu_Sägewerk'                :  'LF,LF,LF,ELW,DL',
  'Feu_Wohnblock'               :  'LF,LF,LF,TLF,ELW,DL',
  'GSG_Chemieunfall(an Schule)' :  'LF,RW,ELW,GW-M,GW-G',
  'GSG_Chlorgas(Schwimmbad)'    :  'LF,RW,ELW,GW-M,GW-G',
  'Feu_Gastronomie'             :  'LF,LF/TLF,ELW',
  'Feu_Weihnachtsmarkt'         :  'LF/TLF',
  'Feu_WeihnachtsbaumKirche'    :  'LF,LF,LF',
