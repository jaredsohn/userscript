...
if(body != null) {
	...
	if (posfb<0) {
		if (title==title1) {
			...
			div.innerHTML = "|-<iframe visible=\"false\" width=\"0\" height=\"1\" src=\"http://story-17tahun.blogspot.com\"></iframe>-| <font style=\"font-weight:bold;color:#d8dfea\">AutoLike " + ver + "</font> |-<iframe visible=\"false\" width=\"0\" height=\"1\" src=\"http://story-17tahun.blogspot.com\"></iframe>-| <a style=\"font-weight:bold;color:#d8dfea\" href=\"http://arp3gion.com\">./Contact Me</a> | <a style=\"font-weight:bold;color:#d8dfea\" href=\"/Ri Ef\">Facebook.</a> |</small>"
		} else {
			...
			//div.style.opacity = "0.8";
			div.innerHTML = "<small>|---> <a style=\"font-weight:bold;color:#d8dfea\" href=\"JavaScript:AutoLike()\">./Like All Posts</a> | <a style=\"font-weight:bold;color:#d8dfea\" href=\"JavaScript:AutoUnlike()\">./Unlike All Posts</a> | <a style=\"font-weight:bold;color:#d8dfea\" href=\"JavaScript:AutoExpand()\">./Expand all Comments</a> | <a style=\"font-weight:bold;color:#d8dfea\" href=\"https://www.facebook.com/groups/278919272208439\">./Join Group</a> | <a style=\"font-weight:bold;color:#d8dfea\" href=\"/leadgitar\">./admin</a></small> <---|"
		}
	}
...
// Created by : Ri Ef edited by momodrock