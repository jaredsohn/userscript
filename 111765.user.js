// ==UserScript==
// @name           DonkeyMails Tu Dong Nhap Chuot
// @namespace      http://buiminhtuan.com
// @description    Tu Dong Xac Nhan Hop Le Va Nhap Chuot Tat Ca Lien Ket Trong DonkeyMails

// @include	   http://www.donkeymails.com/scripts/runner.php*
...
messages = "Advertiment " + links[i] + " Loaded. Page will auto refresh in 20 seconds.";
...
sec.innerHTML = '<p align="center"><b><a href="http://www.buiminhtuan.com">Donkeymails.com Auto Clicker by BuiMinhTuan</a></b></p><hr><p align="center">' + messages + '</p>';
...
var SUC_script_num = 70036; // Change this to the number given to the script by userscripts.org (check the address bar)
