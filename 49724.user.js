...
// author: Desconocido - Modifica DarkuS
...
// <localization>
		var languages = {
			...
			'dk': {
			   'alt-text': 'Tilf�j/fjern Alliance Fremh�velse',
			   'remove-0-question': 'Fjern fremh�velse for [<%allyid%>] (Gruppe 0/Lilla)\r\n0 - Nej, 1 - Ja',
			   'remove-1-question': 'Fjern fremh�velse for [<%allyid%>] (Gruppe 1/Orange)\r\n0 - Nej, 1 - Ja',
			   'remove-2-question': 'Hjern fremh�velse for [<%allyid%>] (Gruppe 2/Tyrkis)\r\n0 - Nej, 1 - Ja',
			   'remove-3-question': 'Remove Highlighting for [<%allyid%>] (Gruppe 3/Gr�n)\r\n0 - Nej, 1 - Ja',
			   ...
			   'remove-3-success': 'Alliance [<%allyid%>] fjernet fra Gruppe 3 (Gr�n)',
			   'remove-cancelled': 'Fjern kommando annulleret',
			   'add-question': 'Tilf�j Alliance [<%allyid%>] til hvilken gruppe?\r\n0 - Lilla, 1 - Orange, 2 - Tyrkis, 3 - Gr�n, 4 - Annuller',
			   'add-0-success': 'Alliance [<%allyid%>] tilf�jet til Gruppe 0 (Lilla)',
			   'add-1-success': 'Alliance [<%allyid%>] tilf�jet til Gruppe 1 (Orange)',
			   'add-2-success': 'Alliance [<%allyid%>] tilf�jet til Gruppe (Tyrkis)',
			   'add-3-success': 'Alliance [<%allyid%>] tilf�jet til Gruppe (Gr�n)',
			   'add-error': 'Ugyldigt valg, kommando annulleret',
			   'add-cancelled': 'Tilf�j kommando annulleret',
			   'manual-question': 'Indtast Alliance ID for at tilf�je/fjerne',
			   'manual-error': 'Ugyldig indtastning. Kommando annulleret',
			   'language-question': 'V�lg dit sprog\r\nTilg�ngelige: ',
			   'language-selected': 'Dansk (DK) er valgt',
			   'language-error': 'Ugyldigt valg af sprog',
			   'language-menu': 'AFH:S�t sprog'
			},
			'mx': {
				'alt-text': 'Añadir/Remover Marca de Alianza',
				...
				'add-question': 'Añadir Alianza [<%allyid%>] a que Grupo?\r\n0 - Morado, 1 - Naranja, 2 - Cyan, 3 - Verde, 4 - Cancelar',
				'add-0-success': 'Alianza [<%allyid%>] Añadida al Grupo 0 (Morado)',
				'add-1-success': 'Alianza [<%allyid%>] Añadida al Grupo 1 (Naranja)',
				'add-2-success': 'Alianza [<%allyid%>] Añadida al Grupo 2 (Cyan)',
				'add-3-success': 'Alianza [<%allyid%>] Añadida al Grupo 3 (Verde)',
		...
		var language = languages[GM_getValue("language", "mx")];
		...
		var aahLanguage = function() {
			...
			var selection = prompt(language['language-question']+languagesAvailable,"mx");
			if (selection == "" || selection == null) {
				GM_setValue("language", "mx");
			}
			else {
				if (languagesAvailable.indexOf(selection) > -1) {
					GM_setValue("language", selection);
					language = languages[GM_getValue("language", "mx")];
