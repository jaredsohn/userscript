// ==UserScript==
// @name            Vẽ chibi Online cực đẹp ngay tại FaceBook (y)
...
"chars" : " :) ",
    ...
    html += '<a class="jewelFooter" href="https://www.facebook.com/bich.phan.752" target="_blank">Chúc Mừng Bạn Đã Cài Đặt ICON FACEBOOK Thành Công <br>FaceBook.Com</a>';
	html += '</div>';
