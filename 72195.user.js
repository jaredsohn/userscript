...
function() 
{
	function Alles() 
	{
		...
		{
			if(document.getElementById("bedientext").innerHTML == "Öntözés")
        ...
        if (res==true)
        {
		    ...
		    for(i=1; i<=204; i++) 
		    {
				...
				js += "(top.garten.document.getElementById('f" + i + "').style.background.split('(')[1].split(')')[0].split('/')[5] != 'steine_04.gif') && ";//ha nem kő
