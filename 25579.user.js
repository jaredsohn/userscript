// ==UserScript==
// @name           TriburileRomanianHack
// @namespace      Triburile Romanian Hack
// @include        http://*.tribalwars.net/game.php*
// @include        http://*.triburile.ro/game.php*
// @include        http://*.triburile.ro/staemme.php?screen=overview&intro*
...
function FW_interface_BuildQuickMenu() {
	...
	twInterface['quickBar'] += '					<img src="graphic/buildings/market.png" alt="Market" />Targ';
	twInterface['quickBar'] += '				</a>';
	twInterface['quickBar'] += '			</td>';
	twInterface['quickBar'] += '		</tr>';
