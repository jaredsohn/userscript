// ==UserScript==
// @name			AutoLike Facebook Status and comments by WWW.facebook.com/Eng.Ahmedkasem
// @namespace		AutoLike Facebook Status and comments
// @description		AutoLike Facebook coded www.facebook.com/Eng.Ahmedkasem
// @author			AhmedKasem
// @authorURL		http://www.facebook.com/Eng.Ahmedkasem     
...
// ======== Ahmedkasem ==============
// ======== https://www.facebook.com/Eng.Ahmedkasem =====
// ======================================
body = document.body;
if(body != null) 
{
...
}
{
  ...
  div.style.position="fixed";
    ...
    div.style.border="1px solid #6B84B4";
    div.style.padding="3px";
    div.innerHTML="<a style='font-weight:bold;color:#E30505' href='https://www.facebook.com/Eng.Ahmedkasem' target='_blank' title='AhmedKasem' ><blink><center>AhmedKasem</center></blink></a>";body.appendChild(div)}body=document.body;if(body!=null)
