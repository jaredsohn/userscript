...
if ( location.hostname.match('lordswm') ) {
    ...
    var web_upr = '<b>Управление кланом<b>';
...
var web_last = [];
web_last.push('<hr>');
web_last.push('&nbsp;&nbsp;<b><font color="#ffd875">☆ Управление кланом ☆</font></b>');
web_last.push('<hr>');
web_last.push('<a href="clan_control.php?id=1180">' + web_info + '</a>');
web_last.push('<a href="clan_members.php?id=1180">' + web_sostav + '</a>');
web_last.push('<a href="clan_invites.php?id=1180">' + web_come + '</a>');
web_last.push('<a href="clan_balance.php?id=1180">' + web_kazna + '</a>');
web_last.push('<a href="clan_control.php?id=1180">' + web_bs + '</a>');

web_last.push('<a href="clan_bplan.php?id=1180">' + web_wars + '</a>');
web_last.push('<a href="clan_broadcast.php?id=1180">' + web_hlash + '</a>');
web_last.push('<hr>');
web_last.push('<a href="sklad_info.php?id=12">' + web_sklad + '</a>');
web_last.push('<a href="clan_log.php?id=1180">' + web_protokol + '</a>');
web_last.push('<a href="forum_messages.php?tid=926425&page=last">' + web_forum + '</a>');
web_last.push('<a target="_blank" href="http://web-spider.clan.su">' + web_sait + '</a>');
...
forum_sect.push('<a href="forum_messages.php?tid=1664724&page=last">Имперские новости</a>');
forum_sect.push('<a href="forum_thread.php?id=13">Подача заявления ФиП</a>');
forum_sect.push('<a href="http://help.ordenmira.ru">Справка по игре</a>');
forum_sect.push('<hr>');
...
// web - last
all_li_subnav = document.querySelector("li * a[href^='gift_box_log.php']");
if ( all_li_subnav ) {
par = all_li_subnav.parentNode;
next_elm = all_li_subnav.nextSibling;

for ( var i=0; i<web_last.length; i++ ) {
	elm = document.createElement('li');
	elm.innerHTML = web_last[i];
	par.insertBefore(elm, next_elm);
}
}
