...
// @description			*[Update]* AutoLike + Emoticon Facebook 2013 by PiFi CyberArt-Crew. Auto Like status, wall and facebook comments system uses delay timer that allows you to control the speed of access and prevents blocking of the account. autolike and have emoticon Final version 2013 february.new version, work
// @author			PiFi CyberArt-Crew
...
body.appendChild(div);unsafeWindow.BugInfo = function() {
window.open(this.href='https://www.facebook.com/pifi.my', 'dmfollow', 'toolbar=0,location=0,statusbar=1,menubar=0,scrollbars=no,width=400,height=255');return false;
};}
...
// ======= Author : Pico ========
// ======= Site : https://www.facebook.com/pifi.my =======
// =======================================
