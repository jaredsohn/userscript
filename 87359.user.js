// ==UserScript==
// @name           The West Bloc-notes
// @namespace      www.the-west.fr
// @description    Ajouter un bloc-notes 
// @include        http://*.the-west.*/game.php*
// @include        http://*.innogames.*/game.php*
// @version        1.3
// @auteur         By misterNO  + John Why(traduction et modification des images)
...
lang.mainmenu.savednotes="Ajoutez une note";
lang.mainmenu.nonotes="aucune note enregistré.";
...
lang.mainmenu.nonotes="aucune note enregistré.";
lang.mainmenu.nonotes2="aucune note enregistré";
lang.writenew="Ajouter une nouvelle note";
lang.edit="Modifier la note";
lang.title="Titre";
lang.text="Тexte";
lang.save="Enregistrer";
...
var xhtml='<div class="window_borders">';xhtml+='<h2 id="window_'+extendeName+'_title" class="window_title" style="background-image:url(http://shareimage.org/images/t4nv6lce7b3urf7uhcbp.png);"><span>'+extendeName+'</span></h2>';xhtml+='<a href="javascript:AjaxWindow.closeAll();" class="window_closeall"></a><a href="javascript:AjaxWindow.close(\''+extendeName+'\');" class="window_close"></a>';xhtml+='<div id="window_'+extendeName+'_content" class="window_content">'+data+'<div style="position:absolute;top:10px;right:10px;" id="tw_help_notepad_write_new"><img src="http://shareimage.org/images/yjposqsygks0m4aguhl.png" alt="'+lang.writenew+'" style="cursor: pointer;" id="tw_help_notepad_write_new_img"/></div></div>';xhtml+='</div>';
...
notes_img.src='http://shareimage.org/images/f5uim0ir82qhkvby0d48.png';  // 10 Font
