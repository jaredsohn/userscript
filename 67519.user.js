...
//
// @history      0.06 Removed hacked ExMachina scripts.
...
ScriptUpdater.check(67519, '0.06')
...
IkariamSuperMarketOffers = function(cityId, position, resource, range, orderBy, parentNode) {
  this.buyHeader = $('<h3 class="header"><span class="textLabel">Buy</span></h3>');
  this.buyOffersDiv = $('<div class="ISM_offers_div ISM_loading content"></div>');
  this.buyFooter = $('<div class="footer"/>');
  this.sellHeader = $('<h3 class="header"><span class="textLabel">Sell</span></h3>');
...
IkariamSuperMarket.prototype.prepareScreen = function() {
  ...
  var wineSelector = $('<li id="ISM_wine_selector" class="ISM_selector selected"><a title="Wine" href="javascript:void(0);"><em><img src="/skin/resources/icon_wine.gif" width="12px" height="10px"/> Wine</em></a></div>');
  var marbleSelector = $('<li id="ISM_marble_selector" class="ISM_selector"><a title="Marble" href="javascript:void(0);"><em><img src="/skin/resources/icon_marble.gif" width="12px" height="10px"/> Marble</em></a></div>');
  var crystalSelector = $('<li id="ISM_crystal_selector" class="ISM_selector"><a title="Crystal" href="javascript:void(0);"><em><img src="/skin/resources/icon_crystal.gif" width="12px" height="10px"/> Crystal</em></a></div>');
  var sulphurSelector = $('<li id="ISM_sulphur_selector" class="ISM_selector"><a title="Sulphur" href="javascript:void(0);"><em><img src="/skin/resources/icon_sulfur.gif" width="12px" height="10px"/> Sulphur</em></a></div>');
  var woodSelector = $('<li id="ISM_wood_selector" class="ISM_selector"><a title="Wood" href="javascript:void(0);"><em><img src="/skin/resources/icon_wood.gif" width="12px" height="10px"/> Wood</em></a></div>');
