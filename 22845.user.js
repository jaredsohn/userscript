...
function funcionPrincipal(e){
	...
	lang_sk['SIM']          = 'Bojov&yacute; simul&#225;tor';
	lang_sk['CALC']         = 'Travian kalkula&#269;ka';
	lang_sk['SEGURO']       = 'Ste si isty?';
	lang_sk['MARK']         = 'Vybra&#357; v&scaron;etko';
	lang_sk['PERDIDAS'] 	  = 'Materi&aacute;lna strata';
	lang_sk['RENT']         = 'V&yacute;nos';
	lang_sk['SUBIR_NIVEL']  = 'M&ocirc;&#382;e&scaron; stava&#357;';
	lang_sk['JUGADOR']      = 'Hr&aacute;&#269;';
	lang_sk['ALDEA']        = 'Meno dediny';
	lang_sk['HAB']          = 'Popul&aacute;cia';
	lang_sk['COORD']        = 'S&uacute;radnice';
	lang_sk['ACCION']       = 'Akcia';
	lang_sk['ATACAR']       = '&Uacute;tok';
	lang_sk['COMERCIAR']    = 'Posla&#357; suroviny';
	lang_sk['GUARDADO']     = 'Ulo&#382;en&eacute;';
	lang_sk['DESP_ABR']     = 'Krok&nbsp;';
	lang_sk['FALTA']        = 'Potrebuje&scaron;';
	lang_sk['HOY']          = 'dnes';
	lang_sk['MANYANA']      = 'zajtra';
	lang_sk['PAS_MANYANA']  = 'pozajtra';
	lang_sk['MERCADO']      = 'Trh';
	lang_sk['CUARTEL']      = 'Kas&aacute;rne';
	lang_sk['PUNTO']        = 'Zhroma&#382;disko';
	lang_sk['CORRAL']       = 'Stajne';
	lang_sk['TALLER']       = 'Die&#318;na';
	lang_sk['ENVIAR']       = 'Posla&#357; suroviny';
	lang_sk['COMPRAR']      = 'K&uacute;pi&#357;';
	lang_sk['VENDER']       = 'Preda&#357;';
	lang_sk['ENVIAR_IGM']   = 'Posla&#357; spr&aacute;vu';
	lang_sk['LISTO']        = 'Bude&scaron; m&ocirc;c&#357; stava&#357;';
	lang_sk['EL']           = 'd&#328;a';
	lang_sk['A_LAS']        = 'o';
	lang_sk['EFICIENCIA']   = '&Uacute;spe&scaron;nos&#357;';
	lang_sk['NUNCA']        = 'Nikdy';
	lang_sk['PC']           = 'Kult&uacute;rne body';
	lang_sk['FUNDAR']       = 'M&ocirc;&#382;e&scaron; zalo&#382;i&#357; alebo doby&#357; nov&uacute; dedinu';
	lang_sk['ALDEAS']       = 'Dedina';
	lang_sk['ENV_TROPAS']   = 'Posla&#357; vojakov';
	lang_sk['RECURSO1']     = 'Drevo';
	lang_sk['RECURSO2']     = 'Hlina';
	lang_sk['RECURSO3']     = '&#381;elezo';
	lang_sk['RECURSO4']     = 'Obilie;';
	lang_sk['TIEMPO']       = '&#268;as';
	lang_sk['COMP']         = 'Pakova&#269; reportov';
	lang_sk['STAT']         = '&Scaron;tatistiky';
	lang_sk['OFREZCO']      = 'Pon&uacute;ka';
	lang_sk['BUSCO']        = 'H&#318;ad&aacute;';
	lang_sk['TIPO']         = 'Pomer';
	lang_sk['CUALQUIERA']   = '&#268;oko&#318;vek';
	lang_sk['DETALLES']     = 'Detaily';
	lang_sk['MAP_EXT']      = 'Roz&scaron;&iacute;ren&aacute; mapa';
	lang_sk['DISPONIBLE']   = 'Len dostupn&eacute;';
	lang_sk['SI']           = '&Aacute;no';
	lang_sk['NO']           = 'Nie';
	lang_sk['LOGIN']        = 'Login';
	lang_sk['MARCADORES']   = 'Z&aacute;lo&#382;ky';
	lang_sk['ANYADIR']      = 'Prida&#357;';
	lang_sk['ENLACE']       = 'URL adresa';
	lang_sk['TEXTO']        = 'Popisok zalozky';
	lang_sk['ELIMINAR']     = 'Smaza&#357;';
	lang_sk['MAPA']         = 'Mapa';
	lang_sk['VERSION']      = 'Dostupn&aacute; verzia';
	lang_sk['MAXTIME']      = 'Maxim&aacute;lny &#269;as';
	lang_sk['CHECK']        = 'Zisti&#357; nov&uacute; verziu';
	lang_sk['MAT_PRIMAS']   = 'Materi&aacute;l';
        lang_sk['ATAQUES']      = 'Ataques';
        lang_sk['CONSTR']       = 'Constr.';
        lang_sk['TROPAS']       = 'Tropas';
...
*/
	...
	function T(texto){
		...
		try{
			...
			eval('var language = lang_sk');
		}
		// Si una cadena concreta no esta traducida en el idioma, utiliza por defecto el castellano
		if (language[texto] == undefined) return lang_sk[texto]; else return language[texto];
	}
	...
	function F(texto, args){
		...
		catch(e){ eval('var language = lang_sk'); }
		if (language[texto] == undefined) texto = lang_sk[texto]; else texto = language[texto];
...
//				[T('LOGIN'), "login.php"],
				...
				["Travian FAQ", "http://help.travian.cz/index.php?type=faq&mod=430&s=400", "_blank"],
				["World Analyzer", "http://travian.ws/analyser.pl?s=sk4", "_blank"],
				["Travilog", "http://travilog.org.ua/sk/", "_blank"],
				["GnP Forum", "http://www.egafs.net/gnp/ally/forum/index.php", "_blank"],
//				[T('COMP'), "http://trcomp.sourceforge.net/?lang=en", "_blank"],
				[T('MAPA'), "http://travmap.shishnet.org/?lang=cz", "_blank"],
//				[T('CALC'), "http://www.denibol.com/~victor/travian_calc/", "_blank"],
				["Distance calc", "http://www.javaschubla.de/2006/travian/wegerechner/wegerechner-t3i.html?lang=en&dim=400&simple=true", "_blank"],				
...
var langfile=new Array();
		langfile=["Celkova sila utoku","Materialna strata","Obrana proti pechote",
							"Obrana proti jazde","&Scaron;tatistika","Zisk/Strata","Spotreba",
							"Exp hrdinu","Koris&#357;/Kapacita","Zisk/Strata","Nominalna spotreba obilia armadou",
							"Hrdina nebol","Hrdina","Mnozstvo odnesenych surovin","Maximalna kapacita surovin",
							"&Uacute;to&#269;n&iacute;k","Obranca", "z koristi"];
...
function elemsta(tag,class,content){
	var ret=document.createElement(tag);
	ret.innerHTML=content;
...
//			rescell.appendChild(elemsta('span','f8','<i><b> ('+atstemp[2]+')</b></i>'));
		}
...
function generatereport(){
  if(ats[3]==0)ats[2]=0;
	...
	cell.appendChild(elemsta("b","c1 b",langfile[4]));
	...
	cell2.appendChild(elemsta("font","f8","<i>"+langfile[5]+"</i>"));
	cell3=document.createElement("td");
	cell3.appendChild(elemsta("font","f8","<i>"+langfile[6]+"</i>"));
	cell4=document.createElement("td");
	cell4.appendChild(elemsta("font","f8","<i>"+langfile[7]+"</i>"));
	cell5=document.createElement("td");
	cell5.appendChild(elemsta("font","f8","<i>"+langfile[8]+"</i>"));
	...
	cell2.innerHTML=lostA+'*<img src="img/un/r/4.gif" title="'+langfile[9]+'">';
	cell3=document.createElement("td");
	...
	cell5.innerHTML=ats[2];
  if (ats[3]>0) cell5.innerHTML +=" <span style='font-size:9px; color:#909090;'>("+Math.round(ats[2]/(ats[3]/100))+'%)</span>';
  cell5.innerHTML += '*<img src="'+imgpackgo+'" title="'+langfile[13]+'"><br>'+ats[3]+'*<img src="'+imgpack+'" title="'+langfile[14]+'">';
	...
	cell2=document.createElement("td");
	cell2.setAttribute("align","right");
	cell2.innerHTML=(-lostB)+'*<img src="img/un/r/4.gif" title="'+langfile[9]+'">';
	cell3=document.createElement("td");
	cell3.setAttribute("align","right");
	...
	tab.snapshotItem(0).getElementsByTagName("td")[5].appendChild(elemsta("p","",""));
	if(warsim==0){
		...
		tab.snapshotItem(1).parentNode.parentNode.insertBefore(elemsta('p','',''),tab.snapshotItem(1).parentNode.nextSibling);
	};
};
	  ...
	  //CUSTOM	
		...
		for(var g = 0; g < t.snapshotLength; g++){
			...
			for(var j = 1; j < 11; j++){
				...
				var u = uc[tt.rows[1].cells[j].getElementsByTagName('img')[0].src.replace(/.*\/.*\/{1}/,'').replace(/\..*/,'')];
			...
			if (g == 0 && botin != null){
				...
				datos.innerHTML = rentabilidad + "% "+langfile[17];
				datos.className = "s7";
...
//				buildingCode = parseInt(buildingCode[0].substring(1, buildingCode[0].length));
	...
	*/
	...
	function crearEventoRecursosCasilla(href){
		...
		return function(){ timeout = setTimeout(function(){ ajaxRequest(href, "GET", null, procesarCasilla, dummy); }, 700); };
	}
...
TODO:
	...
	- Ańadir resumen a la vista de todas las aldeas
...
FIXME:
	...
	- Mejorar los apańos en el codigo marcados por FIXMEs
