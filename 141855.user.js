	...
	function createTweak() {
		...
		LT_strings = {
			"0": { /* english */
				...
				"opts_lowest_lvl": {
					"lab1": "Select buildings that you want to upgrade with 'L (upgrade any lowest level)' or 'Shift+Q (Fill queue)' shortcut",
					"lab2": "Define Max levels of every group type at which shortcut 'L' or 'Shift+Q' will stop upgrading",
					"towers": "Towers:",
					"military": "Military:",
					"resource": "Resource:",
					"cottage": "Cottage:",
		...
		qx.Class.define("louTweak.main", {
			...
			statics: {
				lou_building_id: {
					"woodcutter": 47, "quarry": 48, "ironmine": 49, "farm": 50, "cottage": 4, "market": 5, "sawmill": 7, "mill": 8, "hideout": 9, "stonemason": 10, "foundry": 11, "townhouse": 13, "barracks": 14, "cityguardhouse": 15, "trainingground": 16, "stable": 17, "workshop": 18, "shipyard": 19, "warehouse": 20, "castle": 21, "harbor": 22, "moonglowtower": 36, "trinsictemple": 37, "lookouttower": 38, "ballistatower": 39, "guardiantower": 40, "rangertower": 41, "templartower": 42, "pitfalltrap": 43, "barricade": 44, "arcanetrap": 45, "camouflagetrap": 46
				},
				bd: {
...
/* farm */				"50": {"w": [ 50, 200, 400, 1400, 3500, 6000, 10000, 16000, 25000, 38000 ], "s": [ 0, 0, 200, 600, 1500, 3000, 5000, 8000, 13000, 20000 ], "th": 3},
		...
		try {
					...
					if (this.app.selectorBar.isMapSelectorBarAnchorToLeft()) {
						this.app.desktop.add(this.qtLab.queueTimeCont, {left: 790, top: 100});
					} else {
						this.app.desktop.add(this.qtLab.queueTimeCont, {left: 505, top: 100});
					}
			...
			console.log(e);
				...
				upgradeLowestLevelBuilding: function(_type, _minis) {
					...
					maxLvls = {
						"R":this.options.lowestLevelMax[0],
						"U":this.options.lowestLevelMax[1],
						"C":this.options.lowestLevelMax[2],
						"T":this.options.lowestLevelMax[3],
						"B":this.options.lowestLevelMax[4],
						"M":this.options.lowestLevelMax[5]
					}
					if (_type != "F") freeS = 1;
					if (_type == "F") _type = "A";
				...
				loadOptions: function() {
					...
					if (_str)
						...
						this.options = {
							...
							"lowestLevelUpgradeIDs": [47,48,49,50,7,10,11,8,4,5,13,20,14,16,36,37,17,18,39,9,38,41,40,42,43,44,45,46,12,22,19,15,21,23],
				...
				// ----- Page 1
{
				...
				_bids = [47,48,49,50,7,10,11,8,4,5,13,20,14,16,36,37,17,18,39,9,38,41,40,42,43,44,45,46,12,22,19,15,21,23];							 
				...
				cont = new qx.ui.container.Composite(gr);
				bTypesLabels = [ L("opts_lowest_lvl").resource, L("opts_lowest_lvl").utilities, L("opts_lowest_lvl").cottage, L("opts_lowest_lvl").towers, L("opts_lowest_lvl").barracks, L("opts_lowest_lvl").military ];
				for (i=0; i<6; i++) {
