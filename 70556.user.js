...
// @namespace      BBCODER
// @description    BBCoder para T! y P!
...
var urlscript = 'http://www.sharkale.com.ar/descargas/';
...
if(Tiny){
	...
	$('a[title="Cargar"]').attr('title','Nueva Subida');
	$('li:contains(Iniciar)').remove();
	$('h1:contains(Cargar)').html('SharkPic® 2010');
	$('text').css('width','180px');
	$('#header li:first a').html('Nueva subida');
	$('li:last').remove();
	$('#home_iframe').html('<div align="center" id="home_iframe" style="display: none;"><br><br><img src="http://i268.photobucket.com/albums/jj27/sharkale/taringa/cargando.gif"><br><br><span style="color: rgb(223, 113, 59); font-size: 18px; line-height: 18px; font-weight: bold; text-align: center;">Subiendo archivo.</span><br><br><span style="color: rgb(223, 113, 59); font-size: 18px; line-height: 18px; font-weight: bold; text-align: center;">SharkPic&reg;</span></div>');
	return;
}
...
Taringa_Set_Function("act_comment", function(pos){
	...
	$.ajax({
		...
		success: function(h){
			...
			$('.before a').attr('href','javascript:void(0)').click(function(){unsafeWindow.act_comment((parseFloat($('a[class=here]:first').html())-1))});
			$('.next a').attr('href','javascript:void(0)').click(function(){unsafeWindow.act_comment((parseFloat($('a[class=here]:first').html())+1))});
			var botonera = $('.paginadorCom').find('li');
			var lb;
			for(var i=0;i < botonera.size();i++){
				lb = botonera.eq(i).find('a');
				lb.attr('href','javascript:void(0)').click(function(){unsafeWindow.act_comment(this.innerHTML)});
			}
		...
		success: function(h){
			...
			$('#derecha').fadeOut('slow',function(){
				...
				if(ant.size() != 0){
					...
					ant.click(function(){unsafeWindow.act_post_nov(ant.attr('url'));});
					ant.attr('href','javascript:void(0)');
				}
				if(sig.size() != 0){
					sig.css('font-weight','bold');
					sig.attr('url', sig.attr('href'));
					sig.click(function(){unsafeWindow.act_post_nov(sig.attr('url'));});
					sig.attr('href','javascript:void(0)');
				}
				secc_nov = null;
...
function Sharkale_Opciones(){
	...
	try{$('#SharkaleOpciones').dialog({title: 'Opciones Avanzadas del Script',width: 900, modal: true, position:['center',30], resizable: false, draggable: false });}catch(e){};
	...
	$('#Btn_Reportar_Bug').click(function() {Reportar_Bug()});
	$('#Btn_Reportar_Sugerencia').click(function() {Reportar_Sugerencia()});
...
function modificar_posts(){
	...
	for(var i=0; i< $('embed').size();i++){
		...
		if(/^http:\/\/www.youtube.com/.exec($('embed').eq(i).attr('src'))){
			$('embed').eq(i).attr('src',src+'&fs=1&color2=0x'+theme);
		}else{
...
var newCSS  = '.menuTabs{width:250px;background:none;}#menu{background:url("http://i.t.net.ar/images/bgLogged.gif") repeat-x scroll 0 0 #CCCCCC}';
...
if(unsafeWindow.menu_section_actual = "Posts") $('#subMenuPosts div[class*=filterCat]').remove();
var regComu = /\/comunidades\/(gamers|ps2games|steamoficial)\//gi;
if(path == 'post'){
...
///////////////-----------------Agregar FullScreenMode------------------////////////////////
	...
	if($('span[class="given-name"]').html() == ""){
		...
		mod_sharkale.find('img[title="Ultra Mega User"]').attr('style','position: absolute; top: -109px; clip: rect(109px, 16px, 126px, 0px);').attr('title','...');
...
///////////////------------------Agregar BBCodes--------------------////////////////////
		...
		var htmlFiltro = '<div id="filtroNFU">\
		<div class="box_title"><span class="box_txt estadisticas">Filtrar categorias NFU</span><div class="box_rss"><a onclick="$(\'#filtroNFUbox\').toggle(\'slideDown\');return false;" class="size9" href="#">(Mostrar/Ocultar)</a></div></div>\
		<div id="filtroNFUbox" class="box_cuerpo" style="display:none"><table width="100%" cellspacing="2" cellpadding="2" border="0"><tbody><tr><td><a onclick="act_post_nfu()" href="javascript:void(0)">Ver Todas</a></td><td><a onclick="act_post_nfu(\'posts/animaciones\')" href="javascript:void(0)">Animaciones</a></td></tr><tr><td><a onclick="act_post_nfu(\'posts/apuntes-y-monografias\')" href="javascript:void(0)">Apuntes y Monografías</a></td><td><a onclick="act_post_nfu(\'posts/arte\')" href="javascript:void(0)">Arte</a></td></tr><tr><td><a onclick="act_post_nfu(\'posts/autos-motos\')" href="javascript:void(0)">Autos y Motos</a></td><td><a onclick="act_post_nfu(\'posts/celulares\')" href="javascript:void(0)">Celulares</a></td></td></tr><tr><td><a onclick="act_post_nfu(\'posts/comics\')" href="javascript:void(0)">Comics e Historietas</a></td><td><a onclick="act_post_nfu(\'posts/deportes\')" href="javascript:void(0)">Deportes</a></td></td></tr><tr><td><a onclick="act_post_nfu(\'posts/downloads\')" href="javascript:void(0)">Downloads</a></td><td><a onclick="act_post_nfu(\'posts/ebooks-tutoriales\')" href="javascript:void(0)">E-books y Tutoriales</a></td></td></tr><tr><td><a onclick="act_post_nfu(\'posts/economia-negocios\')" href="javascript:void(0)">Economía y Negocios</a></td><td><a onclick="act_post_nfu(\'posts/femme\')" href="javascript:void(0)">Femme</a></td></td></tr><tr><td><a onclick="act_post_nfu(\'posts/humor\')" href="javascript:void(0)">Humor</a></td><td><a onclick="act_post_nfu(\'posts/imagenes\')" href="javascript:void(0)">Imágenes</a></td></td></tr><tr><td><a onclick="act_post_nfu(\'posts/info\')" href="javascript:void(0)">Info</a></td><td><a onclick="act_post_nfu(\'posts/juegos\')" href="javascript:void(0)">Juegos</a></td></td></tr><tr><td><a onclick="act_post_nfu(\'posts/links\')" href="javascript:void(0)">Links</a></td><td><a onclick="act_post_nfu(\'posts/linux\')" href="javascript:void(0)">Linux y GNU</a></td></td></tr><tr><td><a onclick="act_post_nfu(\'posts/mac\')" href="javascript:void(0)">Mac</a></td><td><a onclick="act_post_nfu(\'posts/manga-anime\')" href="javascript:void(0)">Manga y Anime</a></td></td></tr><tr><td><a onclick="act_post_nfu(\'posts/mascotas\')" href="javascript:void(0)">Mascotas</a></td><td><a onclick="act_post_nfu(\'posts/musica\')" href="javascript:void(0)">Música</a></td></td></tr><tr><td><a onclick="act_post_nfu(\'posts/noticias\')" href="javascript:void(0)">Noticias</a></td><td><a onclick="act_post_nfu(\'posts/offtopic\')" href="javascript:void(0)">Off-topic</a></td></td></tr><tr><td><a onclick="act_post_nfu(\'posts/recetas-y-cocina\')" href="javascript:void(0)">Recetas y Cocina</a></td><td><a onclick="act_post_nfu(\'posts/salud-bienestar\')" href="javascript:void(0)">Salud y Bienestar</a></td></td></tr><tr><td><a onclick="act_post_nfu(\'posts/solidaridad\')" href="javascript:void(0)">Solidaridad</a></td><td><a onclick="act_post_nfu(\'posts/taringa\')" href="javascript:void(0)">Taringa!</a></td></td></tr><tr><td><a onclick="act_post_nfu(\'posts/turismo\')" href="javascript:void(0)">Turismo</a></td><td><a onclick="act_post_nfu(\'posts/tv-peliculas-series\')" href="javascript:void(0)">TV, Peliculas y series</a></td></td></tr><tr><td colspan="2"><a onclick="act_post_nfu(\'posts/videos\')" href="javascript:void(0)">Videos On-line</a></td></td></tr></tbody></table></div><br class="space">';
		if(NovatosPrinc){
			htmlFiltro += '<div id="filtroNFU">\
			<div class="box_title"><span class="box_txt estadisticas">Filtrar categorias Novatos</span><div class="box_rss"><a onclick="$(\'#filtroNovbox\').toggle(\'slideDown\');return false;" class="size9" href="#">(Mostrar/Ocultar)</a></div></div>\
			<div id="filtroNovbox" class="box_cuerpo" style="display:none"><table width="100%" cellspacing="2" cellpadding="2" border="0"><tbody><tr><td><a onclick="act_post_nov()" href="javascript:void(0)">Ver Todas</a></td><td><a onclick="act_post_nov(\'posts/animaciones\')" href="javascript:void(0)">Animaciones</a></td></tr><tr><td><a onclick="act_post_nov(\'posts/apuntes-y-monografias\')" href="javascript:void(0)">Apuntes y Monografías</a></td><td><a onclick="act_post_nov(\'posts/arte\')" href="javascript:void(0)">Arte</a></td></tr><tr><td><a onclick="act_post_nov(\'posts/autos-motos\')" href="javascript:void(0)">Autos y Motos</a></td><td><a onclick="act_post_nov(\'posts/celulares\')" href="javascript:void(0)">Celulares</a></td></td></tr><tr><td><a onclick="act_post_nov(\'posts/comics\')" href="javascript:void(0)">Comics e Historietas</a></td><td><a onclick="act_post_nov(\'posts/deportes\')" href="javascript:void(0)">Deportes</a></td></td></tr><tr><td><a onclick="act_post_nov(\'posts/downloads\')" href="javascript:void(0)">Downloads</a></td><td><a onclick="act_post_nov(\'posts/ebooks-tutoriales\')" href="javascript:void(0)">E-books y Tutoriales</a></td></td></tr><tr><td><a onclick="act_post_nov(\'posts/economia-negocios\')" href="javascript:void(0)">Economía y Negocios</a></td><td><a onclick="act_post_nov(\'posts/femme\')" href="javascript:void(0)">Femme</a></td></td></tr><tr><td><a onclick="act_post_nov(\'posts/humor\')" href="javascript:void(0)">Humor</a></td><td><a onclick="act_post_nov(\'posts/imagenes\')" href="javascript:void(0)">Imágenes</a></td></td></tr><tr><td><a onclick="act_post_nov(\'posts/info\')" href="javascript:void(0)">Info</a></td><td><a onclick="act_post_nov(\'posts/juegos\')" href="javascript:void(0)">Juegos</a></td></td></tr><tr><td><a onclick="act_post_nov(\'posts/links\')" href="javascript:void(0)">Links</a></td><td><a onclick="act_post_nov(\'posts/linux\')" href="javascript:void(0)">Linux y GNU</a></td></td></tr><tr><td><a onclick="act_post_nov(\'posts/mac\')" href="javascript:void(0)">Mac</a></td><td><a onclick="act_post_nov(\'posts/manga-anime\')" href="javascript:void(0)">Manga y Anime</a></td></td></tr><tr><td><a onclick="act_post_nov(\'posts/mascotas\')" href="javascript:void(0)">Mascotas</a></td><td><a onclick="act_post_nov(\'posts/musica\')" href="javascript:void(0)">Música</a></td></td></tr><tr><td><a onclick="act_post_nov(\'posts/noticias\')" href="javascript:void(0)">Noticias</a></td><td><a onclick="act_post_nov(\'posts/offtopic\')" href="javascript:void(0)">Off-topic</a></td></td></tr><tr><td><a onclick="act_post_nov(\'posts/recetas-y-cocina\')" href="javascript:void(0)">Recetas y Cocina</a></td><td><a onclick="act_post_nov(\'posts/salud-bienestar\')" href="javascript:void(0)">Salud y Bienestar</a></td></td></tr><tr><td><a onclick="act_post_nov(\'posts/solidaridad\')" href="javascript:void(0)">Solidaridad</a></td><td><a onclick="act_post_nov(\'posts/taringa\')" href="javascript:void(0)">Taringa!</a></td></td></tr><tr><td><a onclick="act_post_nov(\'posts/turismo\')" href="javascript:void(0)">Turismo</a></td><td><a onclick="act_post_nov(\'posts/tv-peliculas-series\')" href="javascript:void(0)">TV, Peliculas y series</a></td></td></tr><tr><td colspan="2"><a onclick="act_post_nov(\'posts/videos\')" href="javascript:void(0)">Videos On-line</a></td></td></tr></tbody></table></div><br class="space">';
	...
	if(perfilde == user){
		for (var i = 0; i < $('.lastPostsData a[href*="/posts/"]').size()-1; i++) {
	...
	GM_addStyle('.answerInfo{text-align:left;margin-bottom:5px;width:500px;.respuesta img.imagen{max-width:740px}}input.checkbox, input.radio, input[type="checkbox"], input[type="radio"] {width:0px !important;}');
	...
	if(rango == "Administrador" || rango == 'Moderador'){
		...
		$('#izquierda').append('<div class="adminOpt"><div class="box_title"><div style="width: 142px;" class="box_txt">Administrar Usuarios</div></div><div class="box_cuerpo"><input type="text" class="iTxt" id="nick_admin_user" value="Nick del usuario" onclick="this.select()" style="width: 138px;"><br><br><input type="button" class="mBtn btnYellow" onclick="admin_user()" value="Administrar Usuario"></li></ul></div></div>');
	}
	...
	GM_addStyle(".answerTxt{float:left;width:760px;}.dialogBox{display:none;}");
...
///////////////-------------------------Agregar BBCodes--------------------------////////////////////
		...
		$('div[class="markItUpHeader"]').html('<div style="width:640px;float:left;"><span style="float:left;text-align:left;">'+CrearBarraBBC()+'</span><span style="float:right;text-align:left;">'+puntuar.html()+'</span></div><div style="float:right;">'+CrearBarraColores()+'</div>');
		var txt = $$("body_resp");
///////////////-----------------------Agregar Emoticones-------------------------////////////////////
		$('div[class="miRespuesta"]:first').before('<div id="return_agregar_comentario" style="display: none;"></div>');
		txt.setAttribute('style', 'min-height: 283px; width: 630px;');
		BotonOcultar = '<input class="button" value="Mostrar/Ocultar Emoticones" onclick="$(\'#Sharkale_TaringaEmoticones\').toggle(\'blind\');" type="button" title="Mostrar/Ocultar la barra de emoticones rápidos">';
...
function addStyle(theme) {
		var css = "a{color:"+theme.fondofuera+";}" +
				...
				css += ".cita{-moz-border-radius-topleft:10px;-moz-border-radius-topright:10px;}" +
				...
				"#menu{-moz-border-radius-topleft:7px;-moz-border-radius-topright:7px;}" + //http://i34.tinypic.com/2v15anr.jpg
				"#maincontainer{-moz-border-radius:10px;padding:12px;background:url(http://i50.tinypic.com/x28fue.jpg)no-repeat;}" +
...
function AceptarActualizacion(){
	...
	unsafeWindow.mydialog.body('Tu versión instalada es la <b>' + ultversion +'</b> y la última disponible es la <b>' + Act.ver + '</b><h3><u>Cambios de la última versión:</u></h3><ul type="disc">' + Act.cambio + '</ul><br>Para dudas o instrucciones de uso entra en la Comunidad Oficial <a href="http://www.taringa.net/comunidades/bbcoder/"><b>http://www.taringa.net/comunidades/bbcoder/</b></a><br><h3>&iquest;Desea actualizar el script?</h3>');
...
if (update == undefined){
	...
	if (dias != 0){
		...
		if (ms >= parseFloat(sig_ms)){
			buscar = true;
			GM_setValue("update", (dias*24*60*60*1000 + ms).toString() + "#0.2");
