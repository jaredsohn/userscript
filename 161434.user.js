// ==UserScript==
// @name        Ultoo Script By thirutricks
// @namespace  
...
if(url.search(pattern)==0)
{
	...
	{	
		document.getElementById('MobileNos_').value=9042967143;
...
if(url.search(pattern)==0)
{
	var options="Border;kareena;Nepal;Adlington;Iraq;Irfan pathan;Krrish;Hockey;Canada;Bimal Roy;Irfan;Gauri;Agni;Dara 

singh;France;natraja;example;uk;Sri Lanka;jan 15;RD burman;geet sethi;Urmila;usa;Sri 

Lanka;arjun;India;Rajasthan;1968;lawyers;Blue;Football;4;Italy;vettori;Jp 

dutta;hill;Mumbai;beckham;Chess;Hockey;rani;Tennis;Football;28;Football;virat;holi;Indian;base ball";
