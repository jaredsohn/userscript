...
GM_xmlhttpRequest({
	...
	onload:function(response){
		...
		var earmy = $('#earmy');
		earmy.append('<div class="title"><h1 style="padding-bottom: 5px;"><embed class=\"sIFR-flash\" height=\"28\" width=\"250\" src=\"/flash/delicious.swf\" quality=\"best\" flashvars=\"txt=Ejercito eSpain&&textcolor=#737373&hovercolor=null&linkcolor=null&w=250&h=28\" wmode=\"opaque\" bgcolor=\"null\" sifr=\"true\" type=\"application/x-shockwave-flash\" style=\"width: 250px; height: 28px;\"/><span class=\"sIFR-alternate\">Ejercito eSpain</span></h1></div>');

		earmy.append('<ul  style="float: left;" class="tabs">'
				+'<li id="ordenes"><a class="on" href="#"><span style="width: 100px;">Ordenes</span></a></li>'
				+'<li id="foro"><a target="_BLANK" href="http://fuerzasarmadasespana.foroactivo.com/"><span style="width: 100px;">Foro FFAA</span></a></li>'
				+'<li id="irc" class="last"><a target="_BLANK" href="http://qchat.rizon.net/?channels=#defensa.publico"><span style="width: 100px;">IRC</span></a></li>'
				+'</ul>');
