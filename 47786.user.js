// ==UserScript==
// @name           Travian: Alliance Status
// @version        0.1
// @description    (v0.1) Your ally list available on every page!
// @author         dbKiller
// @email          user9999@gmail.com
// @date           2008-07-14
// @namespace      travian
// @source         http://userscripts.org/scripts/show/30039
// @identifier     http://userscripts.org/scripts/source/30039.user.js
...
function loadLanguage()
{
	...
	//English (default)
	lang['EVENTSLOG'] = 'Alliance Status';
	lang['DRAG'] = 'Drag';
	lang['MINIMIZE'] = 'Minimize';
	lang['MAXIMIZE'] = 'Maximize';
	lang['NEW_VERSION'] = 'A new version of "Travian: Attacks List" is available';
	...
	switch(ext) {
		case 'pt': //Portugues, translation by Cuecao
			lang['EVENTSLOG'] = 'Membros Aliança';
			lang['DRAG'] = 'Arrastar';
			lang['MINIMIZE'] = 'Minimizar';
			lang['MAXIMIZE'] = 'maximizar';
			lang['NEW_VERSION'] ='Existe uma nova versão Dispónivel" ';
		...
		onload: function (responseDetails)
				{
					...
					var eventsTable = lmid2Div.getElementsByTagName('table')[1];
					if (eventsTable) eventsTable.deleteRow(0);
					//else eventsTable = lmid2Div.getElementsByTagName('td')[1];
					//append data
