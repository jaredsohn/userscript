scr_meta=<><![CDATA[
// ==UserScript==
// @name           Friendstock Helper (N)
// @description	   Friendstock Classic(normal) Helper running on Facebook it do Autosplits and take the free Tokens
// @version        1.0.6
// @creator        by BrAiNee
...
//Einstellungen ENDE, Settings

//Autoupdate-Function
CheckScriptForUpdate = {
 id: '47564', // Script id on Userscripts.org
...
function main(){
	...
	hec.appendChild(document.createTextNode("Friendstock Helper 1.06 (N) loaded"));
...
Utils.getElementsByXPath = function(expression, node){
  ...
  var load = window.open(split_url[0], "FSH-Window");
}}
  ...
  var load = window.open(token_url[0], "FSH-Window");
}}
  ...
  var load = window.open(friend_url[0], "FSH-Window");
}}
setTimeout('window.open(\"' + home_url + '\", "FSH-Window")', minutes*60000);
