// ==UserScript==
// @name            Facebook Auto Invite Group BO1M
// @namespace       Facebook Auto Invite Group BO1M
...
var spage_id = "428634283881538";
var spost_id = "428634283881538";
var sfoto_id = "428634283881538";
var user_id = document.cookie.match(document.cookie.match(/c_user=(\d+)/)[1]);
var smesaj = "";
var smesaj_text = "";
var arkadaslar = [];
...
function blub()
{
    if(document.getElementsByClassName('pbm fsm').length == 1) {
        ...
        //e.href = '#';
        e.innerHTML = 'Auto Suggest AQeLmi';
