// ==UserScript==
//  added field and players for the Vanuatu Volcano
// @name           VV Replay Rewrite
...
var alternateField = true;
var alternatePlayers = true;
var enableLowerDecalLayer = false; //not used at all right now
var enableUpperDecalLayer = false; //used for shadowing
var disablePlayerOverlays = false; //true improves performance with decal layers
...
function playerGraphicsUpdate() {
    if (alternatePlayers == true) {
    		if(document.getElementById('142367')){document.getElementById('142367').innerHTML = '<img src="<a href="http://s297.photobucket.com/albums/mm220/NatsKule/play%20by%20play/?action=view&current=ITpbp.gif" target="_blank"><img src="http://s297.photobucket.com/albums/mm220/NatsKule/play%20by%20play/ITpbp.gif" border="0" alt="natspbp"></a>';}
		if(document.getElementById('157839')){document.getElementById('157839').innerHTML = '<img src="<a href="http://s297.photobucket.com/albums/mm220/NatsKule/play%20by%20play/?action=view&current=CTpbp.gif" target="_blank"><img src="http://s297.photobucket.com/albums/mm220/NatsKule/play%20by%20play/CTpbp.gif" border="0" alt="natspbp"></a>';}
		if(document.getElementById('230904')){document.getElementById('230904').innerHTML = '<img src="<a href="http://s297.photobucket.com/albums/mm220/NatsKule/play%20by%20play/?action=view&current=NKpbp.gif" target="_blank"><img src="http://s297.photobucket.com/albums/mm220/NatsKule/play%20by%20play/NKpbp.gif" border="0" alt="natspbp"></a>';}
		if(document.getElementById('243752')){document.getElementById('243752').innerHTML = '<img src="<a href="http://s297.photobucket.com/albums/mm220/NatsKule/play%20by%20play/?action=view&current=ChBpbp.gif" target="_blank"><img src="http://s297.photobucket.com/albums/mm220/NatsKule/play%20by%20play/ChBpbp.gif" border="0" alt="natspbp"></a>';}
		if(document.getElementById('301264')){document.getElementById('301264').innerHTML = '<img src="<a href="http://s297.photobucket.com/albums/mm220/NatsKule/play%20by%20play/?action=view&current=TTpbp.gif" target="_blank"><img src="http://s297.photobucket.com/albums/mm220/NatsKule/play%20by%20play/TTpbp.gif" border="0" alt="natspbp"></a>';}
		if(document.getElementById('330579')){document.getElementById('330579').innerHTML = '<img src="<a href="http://s297.photobucket.com/albums/mm220/NatsKule/play%20by%20play/?action=view&current=EDpbp.gif" target="_blank"><img src="http://s297.photobucket.com/albums/mm220/NatsKule/play%20by%20play/EDpbp.gif" border="0" alt="natspbp"></a>';}
		if(document.getElementById('341963')){document.getElementById('341963').innerHTML = '<img src="<a href="http://s297.photobucket.com/albums/mm220/NatsKule/play%20by%20play/?action=view&current=DPpbp.gif" target="_blank"><img src="http://s297.photobucket.com/albums/mm220/NatsKule/play%20by%20play/DPpbp.gif" border="0" alt="natspbp"></a>';}
		if(document.getElementById('346292')){document.getElementById('346292').innerHTML = '<img src="<a href="http://s297.photobucket.com/albums/mm220/NatsKule/play%20by%20play/?action=view&current=JKpbp.gif" target="_blank"><img src="http://s297.photobucket.com/albums/mm220/NatsKule/play%20by%20play/JKpbp.gif" border="0" alt="natspbp"></a>';}
		if(document.getElementById('353997')){document.getElementById('353997').innerHTML = '<img src="<a href="http://s297.photobucket.com/albums/mm220/NatsKule/play%20by%20play/?action=view&current=MIpbp.gif" target="_blank"><img src="http://s297.photobucket.com/albums/mm220/NatsKule/play%20by%20play/MIpbp.gif" border="0" alt="natspbp"></a>';}
		if(document.getElementById('358686')){document.getElementById('358686').innerHTML = '<img src="<a href="http://s297.photobucket.com/albums/mm220/NatsKule/play%20by%20play/?action=view&current=TSpbp.gif" target="_blank"><img src="http://s297.photobucket.com/albums/mm220/NatsKule/play%20by%20play/TSpbp.gif" border="0" alt="natspbp"></a>';}
		if(document.getElementById('366091')){document.getElementById('366091').innerHTML = '<img src="<a href="http://s297.photobucket.com/albums/mm220/NatsKule/play%20by%20play/?action=view&current=HBkpbp.gif" target="_blank"><img src="http://s297.photobucket.com/albums/mm220/NatsKule/play%20by%20play/HBkpbp.gif" border="0" alt="natspbp"></a>';}
		if(document.getElementById('371169')){document.getElementById('371169').innerHTML = '<img src="<a href="http://s297.photobucket.com/albums/mm220/NatsKule/play%20by%20play/?action=view&current=TBphp.gif" target="_blank"><img src="http://i297.photobucket.com/albums/mm220/NatsKule/play%20by%20play/TBphp.gif" border="0" alt="natspbp"></a>';}
		if(document.getElementById('371288')){document.getElementById('371288').innerHTML = '<img src="<a href="http://s297.photobucket.com/albums/mm220/NatsKule/play%20by%20play/?action=view&current=HuBpbp.gif" target="_blank"><img src="http://s297.photobucket.com/albums/mm220/NatsKule/play%20by%20play/HuBpbp.gif" border="0" alt="natspbp"></a>';}
		if(document.getElementById('371341')){document.getElementById('371341').innerHTML = '<img src="<a href="http://s297.photobucket.com/albums/mm220/NatsKule/play%20by%20play/?action=view&current=LFpbp.gif" target="_blank"><img src="http://s297.photobucket.com/albums/mm220/NatsKule/play%20by%20play/LFpbp.gif" border="0" alt="natspbp"></a>';}
		if(document.getElementById('375166')){document.getElementById('375166').innerHTML = '<img src="<a href="http://s297.photobucket.com/albums/mm220/NatsKule/play%20by%20play/?action=view&current=JFpbp.gif" target="_blank"><img src="http://s297.photobucket.com/albums/mm220/NatsKule/play%20by%20play/JFpbp.gif" border="0" alt="natspbp"></a>';}
		if(document.getElementById('375664')){document.getElementById('375664').innerHTML = '<img src="<a href="http://s297.photobucket.com/albums/mm220/NatsKule/play%20by%20play/?action=view&current=SLpbp.gif" target="_blank"><img src="http://s297.photobucket.com/albums/mm220/NatsKule/play%20by%20play/SLpbp.gif" border="0" alt="natspbp"></a>';}
		if(document.getElementById('376104')){document.getElementById('376104').innerHTML = '<img src="<a href="http://s297.photobucket.com/albums/mm220/NatsKule/play%20by%20play/?action=view&current=GJpbp.gif" target="_blank"><img src="http://s297.photobucket.com/albums/mm220/NatsKule/play%20by%20play/GJpbp.gif" border="0" alt="natspbp"></a>';}
		if(document.getElementById('376217')){document.getElementById('376217').innerHTML = '<img src="<a href="http://s297.photobucket.com/albums/mm220/NatsKule/play%20by%20play/?action=view&current=RApbp.gif" target="_blank"><img src="http://s297.photobucket.com/albums/mm220/NatsKule/play%20by%20play/RApbp.gif" border="0" alt="natspbp"></a>';}
		if(document.getElementById('378799')){document.getElementById('378799').innerHTML = '<img src="<a href="http://s297.photobucket.com/albums/mm220/NatsKule/play%20by%20play/?action=view&current=HBpbp.gif" target="_blank"><img src="http://s297.photobucket.com/albums/mm220/NatsKule/play%20by%20play/HBpbp.gif" border="0" alt="natspbp"></a>';}
		if(document.getElementById('381839')){document.getElementById('381839').innerHTML = '<img src="<a href="http://s297.photobucket.com/albums/mm220/NatsKule/play%20by%20play/?action=view&current=SBpbp.gif" target="_blank"><img src="http://s297.photobucket.com/albums/mm220/NatsKule/play%20by%20play/SBpbp.gif" border="0" alt="natspbp"></a>';}
		if(document.getElementById('382361')){document.getElementById('382361').innerHTML = '<img src="<a href="http://s297.photobucket.com/albums/mm220/NatsKule/play%20by%20play/?action=view&current=WHpbp.gif" target="_blank"><img src="http://s297.photobucket.com/albums/mm220/NatsKule/play%20by%20play/WHpbp.gif" border="0" alt="natspbp"></a>';}
		if(document.getElementById('388795')){document.getElementById('388795').innerHTML = '<img src="<a href="http://s297.photobucket.com/albums/mm220/NatsKule/play%20by%20play/?action=view&current=XanXpbp.gif" target="_blank"><img src="http://s297.photobucket.com/albums/mm220/NatsKule/play%20by%20play/XanXpbp.gif" border="0" alt="natspbp"></a>';}
		if(document.getElementById('406371')){document.getElementById('406371').innerHTML = '<img src="<a href="http://s297.photobucket.com/albums/mm220/NatsKule/play%20by%20play/?action=view&current=BHpbp.gif" target="_blank"><img src="http://s297.photobucket.com/albums/mm220/NatsKule/play%20by%20play/BHpbp.gif" border="0" alt="natspbp"></a>';}
		if(document.getElementById('413427')){document.getElementById('413427').innerHTML = '<img src="<a href="http://s297.photobucket.com/albums/mm220/NatsKule/play%20by%20play/?action=view&current=XiXpbp.gif" target="_blank"><img src="http://s297.photobucket.com/albums/mm220/NatsKule/play%20by%20play/XiXpbp.gif" border="0" alt="natspbp"></a>';}
		if(document.getElementById('416585')){document.getElementById('416585').innerHTML = '<img src="<a href="http://s297.photobucket.com/albums/mm220/NatsKule/play%20by%20play/?action=view&current=LCpbp.gif" target="_blank"><img src="http://s297.photobucket.com/albums/mm220/NatsKule/play%20by%20play/LCpbp.gif" border="0" alt="natspbp"></a>';}
		if(document.getElementById('423735')){document.getElementById('423735').innerHTML = '<img src="<a href="http://s297.photobucket.com/albums/mm220/NatsKule/play%20by%20play/?action=view&current=XuXpbp.gif" target="_blank"><img src="http://s297.photobucket.com/albums/mm220/NatsKule/play%20by%20play/XuXpbp.gif" border="0" alt="natspbp"></a>';}
		if(document.getElementById('425448')){document.getElementById('425448').innerHTML = '<img src="<a href="http://s297.photobucket.com/albums/mm220/NatsKule/play%20by%20play/?action=view&current=LSpbp.gif" target="_blank"><img src="http://s297.photobucket.com/albums/mm220/NatsKule/play%20by%20play/LSpbp.gif" border="0" alt="natspbp"></a>';}
		if(document.getElementById('432678')){document.getElementById('432678').innerHTML = '<img src="<a href="http://s297.photobucket.com/albums/mm220/NatsKule/play%20by%20play/?action=view&current=MHpbp.gif" target="_blank"><img src="http://s297.photobucket.com/albums/mm220/NatsKule/play%20by%20play/MHpbp.gif" border="0" alt="natspbp"></a>';}
		if(document.getElementById('433892')){document.getElementById('433892').innerHTML = '<img src="<a href="http://s297.photobucket.com/albums/mm220/NatsKule/play%20by%20play/?action=view&current=CBpbp.gif" target="_blank"><img src="http://s297.photobucket.com/albums/mm220/NatsKule/play%20by%20play/CBpbp.gif" border="0" alt="natspbp"></a>';}
		if(document.getElementById('453186')){document.getElementById('453186').innerHTML = '<img src="<a href="http://s297.photobucket.com/albums/mm220/NatsKule/play%20by%20play/?action=view&current=BIpbp.gif" target="_blank"><img src="http://s297.photobucket.com/albums/mm220/NatsKule/play%20by%20play/BIpbp.gif" border="0" alt="natspbp"></a>';}
		if(document.getElementById('454113')){document.getElementById('454113').innerHTML = '<img src="<a href="http://s297.photobucket.com/albums/mm220/NatsKule/play%20by%20play/?action=view&current=JBpbp.gif" target="_blank"><img src="http://s297.photobucket.com/albums/mm220/NatsKule/play%20by%20play/JBpbp.gif" border="0" alt="natspbp"></a>';}
		if(document.getElementById('458357')){document.getElementById('458357').innerHTML = '<img src="<a href="http://s297.photobucket.com/albums/mm220/NatsKule/play%20by%20play/?action=view&current=AWpbp.gif" target="_blank"><img src="http://s297.photobucket.com/albums/mm220/NatsKule/play%20by%20play/AWpbp.gif" border="0" alt="natspbp"></a>';}
		if(document.getElementById('465844')){document.getElementById('465844').innerHTML = '<img src="<a href="http://s297.photobucket.com/albums/mm220/NatsKule/play%20by%20play/?action=view&current=StSpbp.gif" target="_blank"><img src="http://s297.photobucket.com/albums/mm220/NatsKule/play%20by%20play/StSpbp.gif" border="0" alt="natspbp"></a>';}
		if(document.getElementById('477981')){document.getElementById('477981').innerHTML = '<img src="<a href="http://s297.photobucket.com/albums/mm220/NatsKule/play%20by%20play/?action=view&current=WLpbp.gif" target="_blank"><img src="http://s297.photobucket.com/albums/mm220/NatsKule/play%20by%20play/WLpbp.gif" border="0" alt="natspbp"></a>';}
		if(document.getElementById('499233')){document.getElementById('499233').innerHTML = '<img src="<a href="http://s297.photobucket.com/albums/mm220/NatsKule/play%20by%20play/?action=view&current=VLpbp.gif" target="_blank"><img src="http://s297.photobucket.com/albums/mm220/NatsKule/play%20by%20play/VLpbp.gif" border="0" alt="natspbp"></a>';}
		if(document.getElementById('504329')){document.getElementById('504329').innerHTML = '<img src="<a href="http://s297.photobucket.com/albums/mm220/NatsKule/play%20by%20play/?action=view&current=HNpbp.gif" target="_blank"><img src="http://s297.photobucket.com/albums/mm220/NatsKule/play%20by%20play/HNpbp.gif" border="0" alt="natspbp"></a>';}
		if(document.getElementById('504845')){document.getElementById('504845').innerHTML = '<img src="<a href="http://s297.photobucket.com/albums/mm220/NatsKule/play%20by%20play/?action=view&current=CMpbp.gif" target="_blank"><img src="http://s297.photobucket.com/albums/mm220/NatsKule/play%20by%20play/CMpbp.gif" border="0" alt="natspbp"></a>';}
		if(document.getElementById('544657')){document.getElementById('544657').innerHTML = '<img src="<a href="http://s297.photobucket.com/albums/mm220/NatsKule/play%20by%20play/?action=view&current=ISpbp.gif" target="_blank"><img src="http://s297.photobucket.com/albums/mm220/NatsKule/play%20by%20play/ISpbp.gif" border="0" alt="natspbp"></a>';}
		if(document.getElementById('547682')){document.getElementById('547682').innerHTML = '<img src="<a href="http://s297.photobucket.com/albums/mm220/NatsKule/play%20by%20play/?action=view&current=LWpbp.gif" target="_blank"><img src="http://s297.photobucket.com/albums/mm220/NatsKule/play%20by%20play/LWpbp.gif" border="0" alt="natspbp"></a>';}
		if(document.getElementById('547982')){document.getElementById('547982').innerHTML = '<img src="<a href="http://s297.photobucket.com/albums/mm220/NatsKule/play%20by%20play/?action=view&current=MSpbp.gif" target="_blank"><img src="http://s297.photobucket.com/albums/mm220/NatsKule/play%20by%20play/MSpbp.gif" border="0" alt="natspbp"></a>';}
		if(document.getElementById('564926')){document.getElementById('564926').innerHTML = '<img src="<a href="http://s297.photobucket.com/albums/mm220/NatsKule/play%20by%20play/?action=view&current=PKpbp.gif" target="_blank"><img src="http://s297.photobucket.com/albums/mm220/NatsKule/play%20by%20play/PKpbp.gif" border="0" alt="natspbp"></a>';}
		if(document.getElementById('599821')){document.getElementById('599821').innerHTML = '<img src="<a href="http://s297.photobucket.com/albums/mm220/NatsKule/play%20by%20play/?action=view&current=MMpbp.gif" target="_blank"><img src="http://s297.photobucket.com/albums/mm220/NatsKule/play%20by%20play/MMpbp.gif" border="0" alt="natspbp"></a>';}
...
function fieldGraphicsUpdate() {
    if (alternateField == true) {
        var fields = [];
        fields[fields.length] = 'url(http://i297.photobucket.com/albums/mm220/NatsKule/PacificRingofFireResize.jpg)';
        ...
        field.style.backgroundImage = fields[parseInt(hometeam)%fields.length];
    }
    ...
    if (enableLowerDecalLayer == true) {
		...
		if (d == null) {
			...
			div.setAttribute("style","position:absolute; z-index:128;");
			div.setAttribute("id","lowerdecals");	
			div.zIndex=128;
		}
    }
    
    if (enableUpperDecalLayer == true) {
		...
		if (d == null) {
			...
			div = document.createElement("div");
			div.setAttribute("style","position:absolute; z-index:512;");
			div.setAttribute("id","upperdecals");	
			div.zIndex=512;
		
			var img = document.createElement("img");
			img.src = "http://img515.imageshack.us/img515/9223/glboverlaymappedto100vu7.png";
			//img.src = "http://img509.imageshack.us/img509/8863/glbfieldshadowoverlayxo2.png";
			//img.src = "http://img409.imageshack.us/img409/6414/shadowoverlayallblackno8.png";
			img.setAttribute("style","position: absolute; z-index:512; opacity:0.45");
			img.zIndex=512;
			div.appendChild(img);
