...
// @description    Removes Contact from LinkedIn Easily (updated)
// @version        1.1.2
...
var PROFILE_CONTAINER_SELECTOR = '.connect-menu';
var INVITE_SELECTOR = 'a[class="button-primary"]';
...
function renderRemoveConnectionLink() {
  ...
  var listDOM = document.createElement('dd');
