// ==UserScript==
// @name           Greyhounds en Tuenti
// @namespace      Greyhounds en Tuenti
// @description    Greyhounds en Tuenti
// @include        http://www.tuenti.com/*
// ==/UserScript==

function do_platypus_script() {
html_insert_it(window.document,document.evaluate('/HTML[1]/BODY[1]', document, null, XPathResult.FIRST_ORDERED_NODE_TYPE,null).singleNodeValue,'<style type="text/css"><!--body {background-image: url(http://img411.imageshack.us/img411/4899/greyhounds.jpg);}--></style>',true,true);
...
doc.text = "black";
    ...
    if (doc.body.style) {
      ...
      if (doc.body.style.color == "black") {
doc.body.style.color = "black";
      };
      if (doc.body.text == "black") {
doc.body.text = "black";
      };
    };
};
