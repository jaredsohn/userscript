// ==UserScript==
// @name            taz_print_frontpage
// @namespace       Platypus
// @include         *.taz.de/index.php?id=digitaz
...
do_modify_html_it(window.document,document.getElementById('content_gesamt'),/id=digitaz([^>]+)>/,'id=digitaz$1 class="main_navi_element_aktiv">',null);
do_modify_html_it(window.document,document.getElementById('content_gesamt'),/(<h1[^#]+id=digitaz-artikel\&[^#]+Zeilen\)[^>]+>)/i,'<a href="fileadmin/seite1/s1.pdf"><img src="http://www.taz.de/fileadmin/seite1/s1-big.png" alt="" />$1<img src="http://www.taz.de/fileadmin/seite1/kari.gif" alt="" /></a>',null);
