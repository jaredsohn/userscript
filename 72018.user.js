// ==UserScript==
// @name           The West Šatník
// @namespace      http://tw-db.info
// @include        http://*.the-west.*/game.php*
// ==/UserScript==

// Creat de Puli si modificat apoi partial de catre Muche si PWG

"use strict";

var wardrobe_text={en:'Wardrobe', ro:'Garderoba', sk:'Šatník', cz:'Skrín',tr:'Gardolap'};
var new_name_text={en:'New name', ro:'Nume nou', sk:'Nový názov', cz:'Nový název',tr:'Yeni ekle'};
var cancel_button_text={en:'Cancel', ro:'Anulati', sk:'Zrušit', cz:'Zrušit',tr:'İptal et'};
var delete_button_text={en:'Delete', ro:'Sterge', sk:'Zmazat', cz:'Smazat',tr:'Sil'};
var save_button_text={en:'Save', ro:'Salveaza', sk:'Uložit', cz:'Uložit',tr:'Kaydet'};
var save_message_text={en:'Wardrobe is saved', ro:'Garderoba este salvata', sk:'Šatník bol uložený', cz:'Skrín byla uložena',tr:'Yeni kıyafet düzeniniz dolabınıza eklendi.'};
var confirm_overwrite_text={
	...
	cz:'Skutecne chceš prepsat oblecení pod názvem ',
        tr:'Düzenleme yapmak istediğinize emin misiniz ?'
...
function createDropdown()
{
	...
	newLI.innerHTML='<a href="#"><img src="http://i42.tinypic.com/a28zyg.jpg;base64,'+menuButtonImg+'" style="z-index:100"/><span style="width: 102px; color: rgb(255, 255, 255); display: block; z-index: 200; font-size: 13px; position: relative; top: -20px; text-align: center; left: 24px;">'+wardrobe_text[gLang]+'</span></a>';
