...
// @version 1.0
// @namespace
// @author Rafay Hingoro (navyakool24)
...
function init() {
 ...
 form.elements[i].value = '~Team Shadow~';
 }
 }
 return true;
 } 
 ...
 createToggler(container, 'Hingoro ::: Auto-battle:', 'autoBattle');
 createToggler(container, 'Is ::: Find Rare:', 'findRare');
