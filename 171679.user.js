...
(function () {
    ...
    function adf(par) {
        var xmlhttp = new XMLHttpRequest(),
            res;
        xmlhttp.open('POST', '/shortener/go', true);
    ...
    var list = {
        ...
        lnkco: {
            host: ["lnk.co", "linkbee.com", "rdlnk.co"],
            fn: function () {
                if (L = $('#dest')) go(L.src);
                if (L = $('#urlholder')) go(L.value);
            }
        },
        awsc: {
            host: "awsclic.com",
        ...
        jack: {
            host: ["tr5.in", "adjoin.me", "adblue.us", "1ly.us", "wwy.me", "iiiii.in", "ushorten.me", "short.pk", "tey.me", "fly2url.com", "pea.bz", "bih.cc", "imi.us.tc", "weeurl.co.uk", "shortit.in", "adcrun.ch", "sk.gy", "adjoin.me", "1ly.us", "mo.vc", "4ks.net", "youlinking.com", "qurlt.com", "take-a.com", "filesko.com", "zpoz.net", "pp.nu", "mhz.me", "adsbrite.net", "gr8s.us", "link.tl", "adtwixt.com"],
            fn: function () {
                remove('iframe');
                x = /eval.*/;
        ...
        advert: {
            ...
            fn: function () {
                var frm = ["",
                        ...
                        "<input type='submit' id='skipMe' class='skip' value=' ' name='image'>",
                        "</form>"
                ].join('\n');
        ...
        cccc: {
            ...
            fn: function () {
                ...
                var L = function (data) {
                    R = JSON.parse(data);
                    if (/success/i.test(R.proc)) return go(R.go_page);
                };
                $$.get("/make_go_page_link/mglp.php?lf=" + location.href + "&rf=" + location.href + "&rd=" + Math.random(), null, L, null);
            }
        },
        zyan: {
            host: "zyan.me",
