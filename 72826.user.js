scr_meta=<><![CDATA[
// ==UserScript==
// @name    @Mayank's Twitter Script
// @namespace  http://twitter.com/mayank1509
...
GM_registerMenuCommand("Clear @mayank1509's Twitter Script Cache", function(){
...
/**
 * @author Mayank  < http://twitter.com/mayank1509 >
...
tnt_twitter = {
  ...
  bitly_api_key: '?version=2.0.1&login=mayank1509&apiKey=R_db302f29abf36ff94cb2cb6de8a3de41',
    ...
    window.setInterval(function(){
      if( tnt_twitter.ajax_queue.length > 0 )
      {
        ...
        while( ajax_obj = tnt_twitter.ajax_queue.shift())
        {
          ...
          ajax_obj['User-agent'] = 'Mozilla/4.0 (Compatible) @mayank1509 Greasemonkey Script';
  ...
  {    
    ...
    html+= '<a id="tnt-settings-link" onclick="$(\'#tnt-settings\').toggle(); return false;" href="#">@mayank1509 script settings</a> | <a target="_blank" href="http://getsatisfaction.com/mayank1509/products/mayank1509_twitter_greasemonkey_script">help</a>'
    ...
    html = '<small style="margin-top:1em">'+
        ...
        '<b>By</b> <a target="_blank" href="'+ tnt_twitter.twitter_url +'/mayank1509">@mayank1509</a><br />' +
  ...
  /**
   * @author Mayank http://twitter.com/mayank1509
   * @url httphttp://userscripts.org/scripts/show/72818
   */
