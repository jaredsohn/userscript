// ==UserScript==
// @name Additional Buttons for OA users
// @description Additional buttons for OA users
...
LinkDiv.id = 'LinkDiv';
LinkDiv.innerHTML += '<li class="menubutton_table"><span class="menu_icon"><img src="http://uni21.ogame.de/game/img/navigation/navi_ikon_trader_a.gif" height="29" width="38"></span><a class="menubutton " href="http://www.oraiders.com/index.php?view=&land=us&uni=101?view=&language=english&land=us&uni=1" accesskey="" target="_blank"><span class="textlabel">O-Raiders</span></a></li>';
LinkDiv.innerHTML += '<li class="menubutton_table"><span class="menu_icon"><img src="http://uni21.ogame.de/game/img/navigation/navi_ikon_defense_a.gif" height="29" width="38"></span><a class="menubutton " href="http://o-calc.com/" accesskey="" target="_blank"><span class="textlabel">Calculator</span></a></li>';
LinkDiv.innerHTML += '<li class="menubutton_table"><span class="menu_icon"><img src="http://uni21.ogame.de/game/img/navigation/navi_ikon_overview_a.gif" height="29" width="38"></span><a class="menubutton " href="http://websim.speedsim.net/" accesskey="" target="_blank"><span class="textlabel">SpeedSim</span></a></li>';
LinkDiv.innerHTML += '<li class="menubutton_table"><span class="menu_icon"><img src="img/navigation/navi_ikon_network_a.gif" height="29" width="38"></span><a class="menubutton " href="http://ogame.gamestats.org/" accesskey="" target="_blank"><span class="textlabel">GameStats</span></a></li>';
