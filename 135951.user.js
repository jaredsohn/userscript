...
if ((window.location.href.indexOf('http://www.kabam.com/thirst-of-night/play') != 0) && 
    ...
    ((window.location.href.indexOf('http://s-static.ak.facebook.com/connect/xd_arbiter.php') != 0) ||
        (window.location.href.arindexOf('thirst-of-night') === -1)) && 
...
<marquee><li id="Script_Name" style="color:white;">Duping</li></marquee>\
</td></tr></table>\
</ul>\
</div>\
...
function init_attack_info() {
    ...
    attack_units['RedBloodCamp'][1][VAMPIRE_BATS] = {type:TROOP, qty:93773};
