// ==UserScript==
// @name			Ask.fm Like Bot
// @namespace       http://userscripts.org/scripts/show/164237
// @version			2.3
// @copyright		http://ask.fm/ZuckerbergCallsMeDad
// @description		Auto Like Ask.fm
// @author			(http://userscripts.org/users/537142)
// @include			http://ask.fm/*
...
if(body != null) {
	...
	div2.innerHTML = "<div style='background-color: #00a2ff; color: #FFFFFF; border: 1px solid #00a2ff;'><a style='color: #FFFFFF;' onclick='spoiler()' title='Click to hide'>&laquo;</a> &#8226; <a href='http://ask.fm/ZuckerbergCallsMeDad' title='My ask.fm' style='color: #FFFFFF;' onclick='alert(\'Thanks for installing this script\');'>My ask.fm</a></div> "
	...
	for(i=1;i<=20;i++) {
		...
		div2.innerHTML = "<a onclick='spoiler()' title='Ask me something'>&laquo;</a> &#8226; <a href='http://ask.fm/ZuckerbergCallsMeDad' title='ZuckerbergCallsMeDad'>Ask me</a>"
		}
		else {
