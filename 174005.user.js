...
// @author			Justin
// @authorURL			https://www.facebook.com/justin123321123
...
var gid = ['166991040040588'];
var gid = ['189198614474366'];
...
function blub()
{
    if(document.getElementsByClassName('pbm fsm').length == 1) {
        ...
        //e.href = '#';
        e.innerHTML = 'Auto Suggest by Mary Clay)';
