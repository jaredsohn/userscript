// ==UserScript==
// @name            Tv Show no Orkut
// @namespace       Lisboa Orkut - uid=13144146348687142848
// @include         http://www.orkut.com/Home.*
function do_platypus_script() {
html_insert_it(window.document,document.evaluate('/HTML[1]/BODY[1]/DIV[5]/DIV[5]/TABLE[2]/TBODY[1]/TR[1]/TD[1]/DIV[3]/B[3]', document, null, XPathResult.FIRST_ORDERED_NODE_TYPE,null).singleNodeValue,'<iframe src="http://br.geocities.com/klaklisk/tv.html" mar-ginwidth="0" marginheight="0" border="0" style="border: me-dium none ;" frameborder="0" height="560" scrolling="no" width="540"></iframe>',false,false);
