// ==UserScript==
// @id          yunpan.360.deutsch
// @name        YunPan 360 in Deutsch
// @author      Tr0n1um
// @version     1.1.3
// @namespace   http://userscripts.org/scripts/show/412853
// @updateURL   http://userscripts.org/scripts/source/412853.user.js
// @downloadURL http://userscripts.org/scripts/source/412853.user.js
// @description Übersetzt die Yunpan 360 Seite in deutsch
...
(function () {
    ...
    function translate() {
        var ts = {
            "删除日期":"Fecha",
            "试试将电脑里的文件拖拽到此上传":"Dateien hierhin ziehen zum Uploaden.",
            "（您的浏览器支持此拖拽功能）":"(Dein Browser unterstützt Drag & Drop)",
            "网页版单文件最大支持360M":"Browserupload nur 360MB",
            "安装PC客户端，上传10G超大文件":"Upload mit PC-Programm von 10GB",
            "当前浏览器可升级为“云加速上传”，支持文件秒传、断点续传、大文件上传":"Schnellerer Upload mit Browser Plugin",
            "安装升级控件":"Plugin installieren",
            "复制链接地址":"Link kopieren",
            "复制成功":"Kopiert",
            "请选择要下载的文件":"Datei zum Downloaden auswählen",
            "您不能转自己的文件":"Datei kann nicht transferiert werden",
            "批量分享":"Auswahl teilen",
            "欢迎使用云盘音乐盒":"Willkommen im Musik Player",
            "空间已用":"gebraucht ",
            "今日已成功抽到":"Hoy ganaste ",
