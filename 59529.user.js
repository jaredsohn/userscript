...
switch(sLang) {
	case "sk":
        ...
        case "ua":
                ...
                break;
		case "ru": 
				aLangStrings = ["Собственные войска", "Возвращение из", "Подкрепление для", "Войска игрока","Нападение на","Набег на", "Разведка против","","","Обновление завершилось с неизвестным результатом", "Войска успешно обновлены","Не удалось обновить войска","Настроить обновление войск","Обновить войска", "Обновитель войск", "Введите ключ аутентификации из вашего профиля в Труптуле"]; 
				break;
				case "it":
...
break;
case "gr":
aLangStrings = ["Δικά μου στρατεύματα", "Επιστροφή από", "Ενίσχυση για", "τα στρατεύματα του", "Εισβολή", "Επίθεση", "Ανίχνευση", "Preskúmať opustené údolie", "Captured at", "Update attempted with unknown result.", "O KKRK server se akouse...", "Update failed!", "Troop Tool Updater setup", "Update Troop Tool", "Troop tool Updater:", "Enter the authentication key from your Troop tool profile"];
break;
	case "en": 
	case "com": 
	case "uk":
