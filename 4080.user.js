// ==UserScript==
// @name            Pub Comandante Removida
// @namespace       Pub Comandante Removida
// @author          GRB
// @description     Remove o quadrado grande na vista geral sobre o modo comandante
// @include         http://*/game/overview.php?session=*
// @exclude
// ==/UserScript==
function do_platypus_script() {
smart_remove(window.document,document.evaluate('/HTML[1]/BODY[1]/CENTER[1]/TABLE[1]/TBODY[1]/TR[1]/TD[1]/P[1]', document, null, XPathResult.FIRST_ORDERED_NODE_TYPE,null).singleNodeValue,null,null,null);
...
/Pub Comandante Removida.user.js