...
// Version Log:
//		v2.0.7 (september 09, 2012)
//			- Fixed : background-color Tooltip
//		v2.0.6 (july 31, 2012)
...
GM_addStyle(' \
	...
	#iuwtooltip {position:absolute;line-height:19px; text-align:right; font-size:smaller;opacity:0.85;background-color: #FDFBF4;display:none;z-index:499; font-weight:bold; border:solid #c3802d;	border-width:4px 10px 4px 11px;	-moz-border-image:url('+imgScroll+') 4 10 4 11 repeat; -webkit-border-image:url('+imgScroll+') 4 10 4 11 repeat; } \
	//#iuwtooltip {position:absolute;line-height:19px; text-align:right; font-size:smaller;z-index:499; font-weight:bold; } \
