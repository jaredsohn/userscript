// ==UserScript==
// @name          My Yahoo Subscribe
// @namespace     http://www.lysator.liu.se/~jhs/userscript
// @description   Adds links to subscribe to site feeds via My Yahoo
// ==/UserScript==

var feeds = [], links = document.getElementsByTagName( 'link' );
var types = [ 'rdf', 'atom', 'rss' ], i, j, div, g, c, node, feed, id;
var named = 'MyYahoo', urlprefix = 'http://add.my.yahoo.com/rss?url=';
var color = '#0033CC';
...
if( feeds.length )
{
  ...
  node.src = 'data:image/gif;base64,';
  node.alt = named + ' logo';
