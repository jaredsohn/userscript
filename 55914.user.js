// ==UserScript==
// @name		Flickr Anything Goes! Challenge Group (AGCG) Check Play
...
//
// @include        http://www.flickr.com/groups/anything-goes-challenge-group/discuss/
// @include        http://www.flickr.com/groups/anything-goes-challenge-group/discuss
// @include        http://flickr.com/groups/anything-goes-challenge-group/discuss/
// @include        http://flickr.com/groups/anything-goes-challenge-group/discuss
// ==/UserScript==
//
...
if (name.match("MEGA Winners!!")=="MEGA Winners!!") return true; 
...
if (name.match("chit chat")=="chit chat") return true; 
...
if (name.match("Post your MEGA")=="Post your MEGA") return true;
...
if (name.match("Showroom")=="Showroom") return true;
...
if (chlgstatus=="chit chat") return "Orange";
if (chlgstatus=="Chit Chat") return "Orange";
if (chlgstatus=="CHIT CHAT") return "Orange";
if (chlgstatus=="Post your MEGA") return "Orange";
if (chlgstatus=="Showroom") return "Orange";
...
if (chlgstatus=="chit chat") return "Monthly chit chat";
if (chlgstatus=="Chit Chat") return "Monthly chit chat";
if (chlgstatus=="CHIT CHAT") return "Monthly chit chat";
if (chlgstatus=="Post your MEGA") return "Post your MEGA challenge winning pictures here!";
if (chlgstatus=="Showroom") return "Sweeps! Showroom";
}
...
if (newchlgstatus=="chit chat") anchor.innerHTML= '[Chit_chat]';

if (newchlgstatus=="Chit Chat") anchor.innerHTML= '[Chit_chat]';

if (newchlgstatus=="CHIT CHAT") anchor.innerHTML= '[Chit_chat]';

if (newchlgstatus=="Post your MEGA") anchor.innerHTML= '[Showroom]';

if (newchlgstatus=="Showroom") anchor.innerHTML= '[Showroom]';
...
xmlhttp.onreadystatechange = function() {
      if (xmlhttp.readyState == 4) 
        { 	
		  ...
		  // alert()
           if (chlgname.match("MEGA Challenge")=="MEGA Challenge") inbrackets=true
...
/*			 challengetxt=challengetxt.split("Voting begins")[1].split("<b>")[1].split("<")[0]; 
             if (challengetxt.indexOf(playername)!=-1) 
                newchlgstatus=addchlgstatus(newchlgstatus,"CLOSED");
             }
            else
               {
 ...
 */            }
		   ...
		   if (chlgname.match("VOTE")=="VOTE")
             ...
             //if (!inbrackets)
               //{
               if (((photosposted==3)&&(chlgnum=='10'))&&(lastvote.match('5')=="5")) 
	   ...
	   if ((newchlgstatus=="none")&&(photosposted==5)&&(chlgnum=='xxx')&&(chlgname.match("OPEN")=="OPEN")) newchlgstatus="Filled";
...
for (i=1;i<trs.length;i++) {
  ...
  if (nonchallenge1(chlgname))  chlgstatus="chit chat";
  if (nonchallenge2(chlgname))  chlgstatus="Chit Chat";
  if (nonchallenge3(chlgname))  chlgstatus="CHIT CHAT";
  if (nonchallenge4(chlgname))  chlgstatus="Post your MEGA";
  if (nonchallenge5(chlgname))  chlgstatus="Showroom";
