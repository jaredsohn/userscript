...
var amount   = parseInt(GM_getValue("amount",220220));
...
Auto Sancttion player <input type=\"text\" style=\"border: 1px solid green; width: 4em; color: #00FF00; background: black; text-align: center;\" id=\"autosancNum\" value=\""+autosancNum+"\" /> times for <input type=\"text\" style=\"border: 1px solid green; width: 4em; color: #00FF00; background: black; text-align: center;\" id=\"amount\" value=\""+amount+"\" /> bounty<br>\
    \
...
if (autoheal)
{
	...
	if (healthTimer > 0)
		setTimeout("document.location = document.location", healthTimer * 20 * 1000);
...
function autobuild()
{
	if (page == "investment")
	{
		...
		if (def || inc)
		{
			...
			document.getElementById('wwfixernextbuilding').innerHTML = '<font color="#00FF00"><small><b>Next building: '+names[minIndex]+', need <img src="http://static.storm8.com/im/images/money.png?v=140">'+fixNum(need)+'</b> - '+Math.ceil(need / rate)+'h</small></font>';
