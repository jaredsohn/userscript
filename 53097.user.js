// ==UserScript==
// @name           Pennergame sonder suche
// @namespace      by basti1012  (http://pennerhack.foren-city.de).version 2
// @description    Sucht gegner nach geld punkte nach stadt oder reg datum und auch bande 
...
mytrd.innerHTML = "<span style='font-size:small'><u>Was suche zb(cash1) Zur Zeit keine Funktion:</u></span><input type='text' value='"+GM_getValue("was")+"' id='Geld' size='10'>wert zz (nur Cent f&uuml;r Geld suche)<input type='text' value='"+GM_getValue("wasa")+"' id='Gelda' size='10'>";
mytable.appendChild(mytrd);

var mytre = document.createElement('span');
mytre.innerHTML = "<span style='font-size:small'><u>Klicke zum Speichern:</u></span><input type='button' id='Geldklick' value='Speichern'>Geld Angabe ab wie viel Geld gesucht werden soll";
...
mytr4.innerHTML = "<span style='float:left; font-size:small'><span style=\"color:yellow; font-size:100%;\"><b>Geld</b></span> - - - - --:</span>";
...
+"<span style=\"color:red; font-size:100%;\"><b>--------------------------------------------------------------------------------------------------------------------------------------</b></span><br>"
...
function ausgabe(dom){
	try{
		...
		var promille = "<div style='overflow: hidden; width: 50px; height: 19px;'><img style='position: relative; top: -40px; left: -120px;' src='http://img.pennergame.de/cache/de_DE/signaturen/" + id + ".jpg'></div>";
