...
// --------------------------------------------------------------------
// ==UserScript==
// @name           TribalWars Enhancer v3 PL
// @version        3a
...
//   }, 
 ...
 lang : function(field) { // Grab the language tag
	 ...
	 if(!TW_Lang) { TW_Lang = languages.pl; }
	 if(TW_Lang[field]) {
...
languages = { // Language tags
 ...
 "pl" : { // Polish
  "villages" : "PrzeglÄ?d wiosek",
  "overview" : "SzczegĂłĹ?y wioski",
  "map"      : "Mapa",
  "main"     : "Ratusz",
  "place"    : "Plac",
  "train"    : "Rekrutuj",
  ...
  "player"   : "Gracz",
  "tribe"    : "Wioska",
  "i_player" : "PokaĹź informacje o graczu",
  "i_tribe"  : "PokaĹź informacje o wiosce",
  "loading"  : "OdĹ?wieĹźanie...",
  "c_close"  : "Zamknij",
  "track"    : "Badaj wioskÄ?",
  ...
  "at_all"   : "Ponowny atak wszystkimi jednostkami",
      "mapsize"  : "WielkoĹ?Ä? mapy",
      "pop_close": "Zamknij",
      "pop_auto" : "PokaĹź automatycznie:",
      "group_toggle" : "PokaĹź/Schowaj informacjÄ? o grupach",
      "group_edit" : "zapisz zmiany",
      "group_moveup" : "PrzesuĹ? grupÄ? do gĂłry",
      "group_remove" : "UsuĹ?",
      "group_add" : "Dodaj",
      ...
      "group_storeDone" : "Grupy zmienione! OdĹ?wieĹźanie strony przeglÄ?du..",
      "group_name" : "Nazwa grupy",
      "group_ingroup" : "BieĹźÄ?ca grupa",
      ...
      "main_setaliasheader" : "ZmieĹ? przydomek wioski:",
      "main_setalias" : "Zapisz przydomek",
      "main_setaliasdone" : "Przydomek zapisany!",
      "setting_show" : "TW Enhancer",
      "setting_name" : "Nazwa wtyczki",
      "setting_toggle" : "WĹ?Ä?cz/WyĹ?Ä?cz",
      "setting_label_desc" : "Opis",
      "setting_label_version" : "Wersja",
      "setting_label_dev" : "Autor",
      "setting_label_exec" : "DziaĹ?a przez",
      "tw_scan" : "Serwer plemion wĹ?aĹ?nie prĂłbowaĹ? sprawdziÄ? czy nie uĹźywasz skryptĂłw!"   
 },
  
 "de" : { //German
	 "villages" : "DĂśrfer",
  "overview" : "DorfĂźbersicht",
  "map"      : "Karte",
  "main"     : "HauptgebĂ¤ude",
  ...
  "loading"  : "Laden...",
  "c_close"  : "Klicken zum schlieĂ?en",
  ...
  'enhance_game_settings' : function() {
	...
	plugins.addComma = {
		...
		'enhance_game' : function() {
			...
			'info' : {
			'mandatory' : false,
			'name' : "Zmiana wyĹ?wietlania surowcĂłw",
   ...
   'enhance_game_map': function() {
      ...
      window.setTimeout(function() {
         ...
         UnitTravelTimes = new Array(18,22,18,18,9,10,10,11,30,30,10,35); // SzybkoĹ?Ä? jednostek
   ...
   'info' : {
      'mandatory' : false,
      'name' : "Czasy podrĂłĹźy jednostek",
	...
	"BBMenuGenerator" : function() {
		...
		var xhtml = '<center><table style="cursor:pointer;" cellpadding="0" cellspacing="0">' +
			...
			'<td style="cursor:default;">.</td>' +
               ...
               '   <td onmouseover="javascript:this.style.backgroundColor=\'peachpuff\';" onmouseout="javascript:this.style.background=\'none\';" onclick="javascript:insertBB(\'u\','+random+');" title="PodkreĹ?lenie" tabindex="15" style="width:15px;text-align:center;"><u>U</u></td>' +
               '   <td onmouseover="javascript:this.style.backgroundColor=\'peachpuff\';" onmouseout="javascript:this.style.background=\'none\';" onclick="javascript:insertBB(\'s\','+random+');" title="PrzekreĹ?lenie" tabindex="15" style="width:15px;text-align:center;text-decoration:line-through;"><s><del>S</del></s></td>' +
			'<td style="cursor:default;">.</td>' +
               ...
               '   <td onmouseover="javascript:this.style.backgroundColor=\'peachpuff\';" onmouseout="javascript:this.style.background=\'none\';" onclick="javascript:insertBB(\'url\','+random+');" title="Wstaw hiperĹ?Ä?cze" tabindex="17"><img src="http://runbut.com/Images/Hyperlink.jpg" alt="URL" /></td>' +
			...
			'<td style="cursor:default;">.</td>' +
               '   <td title="Wstaw kolor"><select onchange="javascript:insertBB(\'color\','+random+',this.value);this.selectedIndex=0;"><option value="DISABLED" selected disabled>Kolor czcionki</option><option value="red" style="color:red;">Czerwony</option><option value="pink" style="color:pink;">RĂłĹźowy</option><option value="purple" style="color:purple;">Purpurowy</option><option value="blue" style="color:blue;">Niebieski</option><option value="aqua" style="color:aqua;">Wodnisty</option><option value="green" style="color:green;">Zielony</option><option value="yellow" style="color:yellow;">ĹťĂłĹ?ty</option><option value="orange" style="color:orange;">PomaraĹ?czowy</option><option value="black" style="color:black;">Czarny</option><option value="gray" style="color:gray;">Szary</option><option value="silver" style="color:silver;">Srebrny</option><option value="white" style="color:white;">BiaĹ?y</option></select></td>' +
	...
	plugins.nobleCoins = { // One click to buy X coins at once
		...
		'enhance_game_snob' : function() {
			...
			if ($("table.vis:last a").length > 0 && lowest_coin > 1) {
				...
				$("table.vis:last").after("<p>MoĹźesz zrobiÄ? caĹ?kowitÄ? iloĹ?Ä? "+lowest_coin+" monet. <a href=\"javascript:makeCoins("+lowest_coin+",'"+coinlink+"');\">ZrĂłb to teraz</a></p>");
	...
	plugins.addToolbar = { // Add the premium-like toolbar
		...
		'enhance_game' : function() { // Add the premium-like toolbar
 		//make sure twe.curVillage is initalized
			...
			menu_xhtml += '<td style="border-left: dotted 1px"><a id="twtools_a" href="http://pl29.plemiona.pl/game.php?village="+personals.getCurrentVillage()+"&screen=settings&mode=vacation"><img id="twtools_img" src="' + TW_Image_Base + 'unten.png" style="margin:0px 2px" title="Ext. Tools" /></a></td>';
...
//				twt_xhtml += '<td><input type="text" id="twtools_tribe" value="' + twe.lang("tribe") + '" /><a href="javascript:tool_info(\'tribe\')"><img src="' + personals.getImageBase() + 'rechts.png" style="margin:0px 2px" title="' + twe.lang("i_tribe") + '" /></a></td>';//onfocus="i_focus(this)" onblur="i_blur_ally(this)" 
				twt_xhtml += '<td style="text-align:center"><a href="http://pl29.plemiona.pl/game.php?village="+personals.getCurrentVillage()+"&screen=settings&mode=vacation" target="_blank"><b>¤ Zastępstwa ¤</b></a></td>'
	...
	plugins.SimpleDistanceCalc = { // Calculate the time to travel to a village
		...
		'get_distance_table': function(target) {
			...
			setFunc("distancecalctoggle", function() {
				...
				if ($("#distancecalclink span").html() != 'pokaĹź') {
					$("#distancecalclink span").html('pokaĹź');
				} else {
			...
			html += '<tr><td colspan="14"><a id="distancecalclink" href="javascript:distancecalctoggle();"><span>pokaĹź</span> wszystkie wioski</a></td></tr>';
			html += "</table>";
		...
		'info' : {
			'mandatory' : false,
			'name' : "Prosty kalkulator odlegĹ?oĹ?ci",
			'desc' : "",
			'version' : "0.1",
			'dev' : "Timas"
		}
  ...
  'get_distance_table' : function(target) {
	  ...
	  setFunc("distancecalctoggle", function() {
		 $(".distancecalchide").toggle();
		 if ($("#distancecalclink span").html() != 'pokaĹź') { $("#distancecalclink span").html('pokaĹź'); } else { $("#distancecalclink span").html('ukryj'); }
  ...
  'enhance_game_report' : function() {
	  ...
	  var content = xpathGetFirst("/html/body/table[3]/tbody/tr/td/table/tbody/tr/td[2]/table/tbody/tr/td/table/tbody/tr[3]/td");
	  content.innerHTML += "<h4>OdlegĹ?oĹ?ci</h4>"+plugins.distancecalc.get_distance_table(target);

		},
		'info' : {
			'mandatory' : false,
			'name' : "Kalkulator odlegĹ?oĹ?ci",
			'desc' : "",
			'version' : "0.1",
			'dev' : "Mog"
		}
  ...
  'get_rallypoint_html' : function(village_id,x,y) {
	  ...
	  html += "<td align=\"top\" style=\"visibility:hidden;\"><a href=\"javascript:popup_scroll('targets.php?village="+personals.getCurrentVillage()+"&amp;mode=own', 340, 400)\">Ă?Âť Your own</a></td>\n";
  ...
  enhance_game_place : function() {
	  ...
	  var getTime = function(element) {
		  ...
		  part = element.firstChild.nodeValue.split(":");
			...
			// FĂ?Ć?Ă?Âźhrende Nullen entfernen
		  for(j=1; j<3; j++) {
  ...
  'get_overview' : function() {
	  ...
	  var html="<h3>PrzeglÄ?d punktĂłw podrĂłĹźy</h3>";
 ...
 _generate_report : function() {
	 ...
	 if(/tribalwars.se/.test(location.host)) {
		 ...
		 time = new Date("20"+tmp[3], parseInt(tmp[2])-1, tmp[1], tmp[4], tmp[5]).getTime();
			...
			//example: 19.04.08 Ă?  17:55
		 var tmp = timeTD.innerHTML.match(/(\d+)\.(\d+)\.(\d+) Ă?  (\d+):(\d+)/);
		 time = new Date("20"+tmp[3], parseInt(tmp[2])-1, tmp[1], tmp[4], tmp[5]).getTime();
	 } else {
