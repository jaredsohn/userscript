// ==UserScript==
// @name        AutoClickers http://trikdaninformasi.blogspot.com
// @namespace   AutoClickers http://trikdaninformasi.blogspot.com
...
wparent.location.href.indexOf('?view=ads') != -1)&& self == top){
	...
	div2.append(
		$('<h3 class="titleFunky">').text('=============| AUTO CLICKERZ EVOLUTION V2.0 |===============  |||||||||||||||||||||||||||||||||||||||||||| Edited by : dhe Tughi W |||||||||||||||||||||||||||||||||||||||||||||||||| ')		
	)	
