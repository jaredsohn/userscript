...
//FoodAlerts.init();
  ...
  AddMainTabLink('DACKALILAR', eventHideShow, mouseMainTab);
}
...
//Seed.wilderness['city'+Cities.cities[3].id] = [];      
      ...
      if (matTypeof(cWilds) != 'array') {
        m += '<TR style="background-color:white; font-weight:bold;" align=right><TD align=left>bozkir tipi</td><TD></td><TD align=left>Kordinat</td><TD>Tuzak</td><TD align=left>Parali asker</td>\
        ...
        for (i=0; i<sortem.length; i++){
          ...
          m += '<TR align=right'+ (row++%2?'':' class=ptOddrow') +'><TD align=left>'+ wildNames[wild.tileType] +'</td>\
            ...
            <TD></td><TD align=left class=ptentry><B>Tuzak Kurmak:</b> <INPUT onchange="ptInpWildTraps(this)" id=ptwt_'+ c +'_'+ i 
          ...
          m += '<TD class=ptentry> &nbsp; &nbsp; <B>Asker :</b> ' + htmlSelector(mercNames, wildDef.mercLevel, 'id=ptwm_'+ c +'_'+ i) +' &nbsp; &nbsp; </td></tr>';
        }
  ...
  show : function (){
    ...
    for (var c=0; c<Cities.numCities; c++) {
      ...
      m += '<TR><TD colspan=11><DIV class=ptstat>'+ Cities.cities[c].name +'</div></td></tr>\
          <TR class=ptwpad style="font-weight:bold" align=right><TD width=80>Görev</td><TD width=160 align=center>Adi</td><TD width=26>siya.</td><TD width=26>carpi.</td>\
          <TD width=26>zeka</td><TD width=26>beceri</td><TD width=90 align=center colspan=3>--- Atanmamis ---</td><TD width=40 align=right> Maas </td><TD width=35>Seviye</td></tr>';
      totSalary = 0;
      var did = {}; 
      var row = 0;
...
my.AllianceList = {
  ...
  show : function (){
    ...
    if (t.state == null){
      ...
      var m = '<DIV class=ptentry><TABLE width=100% cellpadding=0>\
          <TR><TD class=xtab align=right></td><TD class=xtab>Bir oyuncunun adinin tumunu veya bir kismini girin: &nbsp;</td>\
          ...
          <TR><TD class=xtab>OR: </td><TD class=xtab> veya bir ittifak adin veya bir kismini girin: &nbsp;</td>\
            <TD class=xtab><INPUT id=allAllName type=text /> &nbsp; <INPUT id=allSubmit type=submit value="Itifak bul" /></td>\
  ...
  eventGotPlayerList : function (rslt){
    ...
    var m = '<DIV class=ptstat> Eslesen oyuncular <B>"'+ t.pName +'"</b></div>\
      <DIV style="height:575px; max-height:575px; overflow-y:auto">\
      <TABLE width=95% align=center class=ptTab cellspacing=0><TR style="font-weight:bold"><TD>Adi</td>\
      <TD align=right>Kudret</td><TD> &nbsp;Facebook &nbsp; </td><TD width=75%>Lookup </td></tr>';
    var row=0;
    var cl='';
  ...
  eventGotAllianceList : function (rslt){
    ...
    <TABLE><TR style="font-weight:bold"><TD class=xtab>Ittifak Adi</td><TD class=xtab> rütbe</td><TD class=xtab> uyeler</td>\
        <TD align=right class=xtab>kudret</td><TD class=xtab>Diplomacy</td><TD class=xtab></td></tr>';
...
my.Search = {
  ...
  show : function (cont){
    ...
    if (t.state == null){
      this.cont.innerHTML = '\
        <DIV class=ptentry><table><tr><td><TABLE><TR valign=top><TD class=xtab width=100 align=right>Aranacak: </td><TD>\
        <SELECT id="srcType">\
          <OPTION value=0>Barbarlar</option>\
          <OPTION value=1>Bozkırlar</option>\
  ...
  clickedSearch : function (){
    ...
    document.getElementById ('srcStart').value = 'Aramayi bitir';
    ...
    m = '<CENTER><B>Arama için : '+ typeName +'<BR>\
        Merkez: '+ t.opt.startX +','+ t.opt.startY +'  &nbsp; Mesafe: '+ t.opt.maxDistance +'<BR></center>\
        <DIV class=ptentry><TABLE cellspacing=0 width=100%><TR align=center><TD class=xtab colspan=10><B>AYARLAR:</b><BR></td></tr>';
    if (t.opt.searchType == 1 || t.opt.searchType == 0) {
     m += '<TR><TD class=xtab align=right>Gosterilecek min. seviye:</td><TD class=xtab> <INPUT id=filMinLvl size=2 value='+ Options.srcMinLevel +' /></td></tr>\
        <TR><TD class=xtab align=right>Gosterilecek max. seviye:</td><TD class=xtab> <INPUT id=filMaxLvl size=2 value='+ Options.srcMaxLevel +' /></td></tr>';
	}
    if (t.opt.searchType == 1){
      m += '<TR><TD class=xtab align=right>Bozkır tipleri:</td><TD class=xtab align=right>\
            Ormanlar<INPUT id=woodWild type=CHECKBOX'+ (Options.woodWild?' CHECKED':'') +'></td></tr>';
      m += '<TR><TD class=xtab align=right>Cayır / Gol<INPUT  id=foodWild type=CHECKBOX '+ (Options.foodWild?' CHECKED':'') +'></td>\
      ...
      m += '<TR><TD class=xtab align=right>Ova<INPUT id=plnWild type=CHECKBOX '+ (Options.plnWild?' CHECKED':'') +'></td>\
           <TD class=xtab align=right>Tepe<INPUT id=hillWild type=CHECKBOX'+ (Options.hillWild?' CHECKED':'') +'></td></tr>';
      m += '<TR><TD class=xtab align=right>Sadece sahipsizler:</td><TD class=xtab><INPUT id=filUnowned type=CHECKBOX '+ (Options.unownedOnly?' CHECKED':'') +'\><td></tr>';
    } 
    if (t.opt.searchType == 1 || t.opt.searchType == 0) {
        m+= '<TR><TD class=xtab align=right>sıralama:</td><TD class=xtab><SELECT id=filSortBy>\
          ...
          <OPTION value="dist" '+ (Options.srcSortBy=='dist'?'SELECTED':'')  +'>Mesafe</option>\
			...
			<TR><TD class=xtab align=right>Yanlız koordinatlari goster:</td><TD class=xtab><INPUT type=checkbox id=coordsOnly \></td></tr>\
			</table></div><BR><SPAN id=srchSizeWarn></span>';
    } else {
		m+= '</select></td></tr><TR><TD class=xtab align=right>Sistekiler:</td><TD class=xtab><INPUT id=filMisted type=CHECKBOX '+ (Options.mistedOnly?' CHECKED':'') +'\><td></tr>';
                m+= '<TR><TD class=xtab align=right>Müttefikler:</td><TD class=xtab><INPUT id=filAlly type=CHECKBOX '+ (Options.allyOnly?' CHECKED':'') +'\><td></tr>';
		m+= '<TR><TD class=xtab align=right>Dostlar:</td><TD class=xtab><INPUT id=filFriendly type=CHECKBOX '+ (Options.friendlyOnly?' CHECKED':'') +'\><td></tr>';
                m+= '<TR><TD class=xtab align=right>Düsmanlar:</td><TD class=xtab><INPUT id=filHostile type=CHECKBOX '+ (Options.hostileOnly?' CHECKED':'') +'\><td></tr>';
		m+= '<TR><TD class=xtab align=right>Notur:</td><TD class=xtab><INPUT id=filNeutral type=CHECKBOX '+ (Options.neutralOnly?' CHECKED':'') +'\><td></tr>';
		m+= '<TR><TD class=xtab align=right>Ayarlanmamis:</td><TD class=xtab><INPUT id=filUnaligned type=CHECKBOX '+ (Options.unalignedOnly?' CHECKED':'') +'\><td></tr>';
		m+= '<TR><TD class=xtab align=right>Siralama:</td><TD class=xtab><SELECT id=filSortBy>\
          <OPTION value="might" '+ (Options.srcSortBy=='might'?'SELECTED':'')  +'>Kudret</option>\
          <OPTION value="dist" '+ (Options.srcSortBy=='dist'?'SELECTED':'')  +'>Mesafa</option>\
        </select></td></tr>\
        <TR><TD class=xtab align=right>Yanlız koordinatlari goster:</td><TD class=xtab><INPUT type=checkbox id=coordsOnly \></td></tr>\
        </table></div><BR><SPAN id=srchSizeWarn></span>';
    ...
    document.getElementById ('statStatus').innerHTML = 'Aranan = '+ xxx +','+ yyy;
if (DEBUG_TRACE) logit (" 0 clickedSearch()... setTimeout ..:" + xxx +' , '+ yyy +' , '+ t.mapCallback.name);
  ...
  dispMapTable : function (){
    var tileNames = ['Barbar kamp', 'Cayır', 'Gol', 'Orman', 'Tepe', 'Dag', 'Ova', 'Sehir' ];
    var t = my.Search;
...
if (DEBUG_TRACE) DebugTimer.display('SEACHdraw: FILTER');
    ...
    document.getElementById('statFound').innerHTML = 'Bulunan: '+ dat.length;
    if (dat.length == 0){
...
if (DEBUG_TRACE) DebugTimer.display('SEACHdraw: SORT');
      if (coordsOnly)
		...
		if (t.opt.searchType == 2) {
			...
			m = '<TABLE id=srcOutTab cellpadding=0 cellspacing=0><TR style="font-weight: bold"><TD>Konum</td><TD style="padding-left: 10px">Mesafe</td><TD style="padding-left: 10px;">Seviye</td><TD width=80%> &nbsp; Tur</td><TD style=""></td></tr>';
		}
	  }
...
if (DEBUG_TRACE) logit (" 3 mapCallback()");
    ...
    document.getElementById('statSearched').innerHTML = 'Toplam aranan: '+ t.tilesSearched;
    t.dispMapTable();
    ...
    document.getElementById ('statStatus').innerHTML = 'Aranan = '+ x +','+ y;
    ...
    if (t.state == null){
      s = "<DIV id=trainTopSelect>\
        ...
        <SELECT id=pttdType>\
          ...
          <option value='55'>savunma mancinigi</option>\
          <option value='60'>Tuzak</option>\
          <option value='61'>Bitiraklar</option>\
          <option value='62'>Civili Barrier</option>\
...
//DebugTimer.start(); 
    try {
      ...
      str = '<DIV class=ptstat style="margin-top:5px; margin-bottom:5px;"><TABLE cellspacing=0 cellpadding=0 class=ptTab width=97% align=center>\
        <TR align=left><TD><SPAN class=ptStatLight>Son giris:</span> '+ dt.toLocaleDateString() +'</td>\
      ...
      str += "<TABLE class=ptTabLined cellspacing=0><TR valign=top align=right><TD width=105></td><TD width=88 style='background: #ffc'><B>TOPLAM</b></td>";
      for(i=0; i<Cities.numCities; i++) {
         str += "<TD width=85><B>"+ Cities.cities[i].name.substring(0,10) +'</b><BR>(<a onclick="PTgotoMap('+Cities.cities[i].x +','+ Cities.cities[i].y+')">'+ Cities.cities[i].x +','+ Cities.cities[i].y  +"</a>)</td>";
      }
      if (Options.includeMarching)
        str += '<TD width=85><B>Yuruyusler</b></td>';
      str += "</tr>";
      ...
      rownum = 0;
      str += _row ('Ikmal askeri', rows[1]);
      str += _row ('Milis', rows[2]);
      str += _row ('Bilgi toplayici', rows[3]);
      str += _row ('Mizrakli asker', rows[4]);
      str += _row ('Silahsor', rows[5]);
      str += _row ('Okcu', rows[6]);
      str += _row ('Suvariler', rows[7]);
      str += _row ('Agir Suvariler', rows[8]);
      str += _row ('Malzeme araba', rows[9]);
      str += _row ('Ballista', rows[10]);
      str += _row ('Koc basi', rows[11]);
      ...
      str += _row ('Yiyecek sure', row, true);
      str += '<TR><TD><BR></td></tr>';
      ...
      str += _row ('Savunma ins.', row, true);
      str += '<TR><TD class=xtab></td><TD class=xtab colspan=4><BR><INPUT type=CHECKBOX id=idCheck'+ (Options.includeMarching?' CHECKED':'') +'>Yuruyusteki asker ve kaynakları goster</td></tr>';
      str += "</table>";
      if (DEBUG_BUTTON)
...
my.Encamped = {
  ...
  show : function (cont){
    var rownum = 0;
    var names = ['ik. as.', 'Milis', 'Bil. top.', 'Mızrak.', 'Silah.', 'Okcu', 'Suvari', 'Agır suv.', 'm. araba', 'Balli', 'Koç baş.', 'Cat'];
    var t = my.Encamped;
    ...
    s = '<div class=ptstat>Senin büyükelciliklerindeki tüm asker ve kampların</div><BR>';
    if (numSlots == 0){
      s += '<BR><CENTER><B>No troops encamped.</b></center>';
    } else {
      s += '<STYLE> .tot{background:#f0e0f8;} .city{background:#ffffaa;}</style>';
      s += '<TABLE cellspacing=0 width=100%><TR align=right><TD align=left width=16%><B>Oyuncu(soval.)</b></td>';
    ...
    s += '<BR><BR><INPUT type=CHECKBOX id=idCheck2 '+ (Options.encRemaining?'':' CHECKED ') +'> Askerleri göster';
    s += '<BR><BR><DIV style="font-size: 10px">NOT: Bir savaş sonrası yeni kampları veya kalan askerleri görmek için DACKALLARI yenilemeniz gerekecektir.</div>';
    t.cont.innerHTML = s;
    checkBox = document.getElementById('idCheck2');
