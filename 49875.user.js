...
GM_registerMenuCommand('Mafia Wars to Facebook Friend - Help Friends to finish Jobs', helpFriendsinit);
GM_registerMenuCommand('Mafia Wars to Facebook Friend - Set Help Delay', setHelpDelay);
...
function helpFriends() {
	...
	tmp++;
	if (tmp>=MWmafia.length) tmp=0;
	window.setTimeout(helpFriends,800);
}
