...
// ==UserScript==
// @name          Thez
// @namespace     http://www.lovehinarpg.com/theydontknowthisns
// @description   a test script
// @include       http://www.lovehinarpg.com/*
// ==/UserScript==
...
'<div id=glist>' +
'<form style="display: inline;" name=form2 method=post action="http://www.lovehinarpg.com/girl.php"><input type=hidden name="girl" value=1><input type=submit name=submit class=knap2 style="display: inline;" value=1></form>' +
'<form style="display: inline;" name=form2 method=post action="http://www.lovehinarpg.com/girl.php"><input type=hidden name="girl" value=2><input type=submit name=submit class=knap2 style="display: inline;" value=2></form>' +
'<form style="display: inline;" name=form2 method=post action="http://www.lovehinarpg.com/girl.php"><input type=hidden name="girl" value=3><input type=submit name=submit class=knap2 style="display: inline;" value=3></form>' +
'<form style="display: inline;" name=form2 method=post action="http://www.lovehinarpg.com/girl.php"><input type=hidden name="girl" value=4><input type=submit name=submit class=knap2 style="display: inline;" value=4></form>' +
'<form style="display: inline;" name=form2 method=post action="http://www.lovehinarpg.com/girl.php"><input type=hidden name="girl" value=5><input type=submit name=submit class=knap2 style="display: inline;" value=5></form>' +
'<form style="display: inline;" name=form2 method=post action="http://www.lovehinarpg.com/girl.php"><input type=hidden name="girl" value=6><input type=submit name=submit class=knap2 style="display: inline;" value=6></form>' +
'<form style="display: inline;" name=form2 method=post action="http://www.lovehinarpg.com/girl.php"><input type=hidden name="girl" value=7><input type=submit name=submit class=knap2 style="display: inline;" value=7></form>' +
'<form style="display: inline;" name=form2 method=post action="http://www.lovehinarpg.com/girl.php"><input type=hidden name="girl" value=8><input type=submit name=submit class=knap2 style="display: inline;" value=8></form>' +
'</div>' +
'<hr width=100%>' +
'</div>';
...
if(document.location == "http://www.lovehinarpg.com/move.php"){
...
'<div>You can <input class=knap2 type=button value=Buy onClick="document.location = \'http://www.lovehinarpg.com/shopbuy.php?shop=johs\';"> or <input type=button class=knap2 onClick="document.location = \'http://www.lovehinarpg.com/shopsell.php?shop=johs\';" value=Sell>things</div>' + // buy/sell things
'<div>You can <input class=knap2 type=button value=Buy onClick="document.location = \'http://www.lovehinarpg.com/shopbuy.php?shop=daray\';"> or <input type=button class=knap2 onClick="document.location = \'http://www.lovehinarpg.com/shopsell.php?shop=daray\';" value=Sell>things with Daray (extra cash)</div>' + // buy/sell things (Daray)
...
var doOneStep = function() {
	...
	var talkRight = function(passid, passkey, Billede) {
		...
		req.open(\'POST\', \'http://www.lovehinarpg.com/girl2.php\', true);
	...
	var getGirlDocument = function() {
		...
		var req = new XMLHttpRequest();
		req.open(\'POST\', \'http://www.lovehinarpg.com/girl.php\', true);
		req.setRequestHeader(\'User-agent\', \'Mozilla/4.0\');
	       	req.setRequestHeader(\'Accept\', \'text/html\');
		req.setRequestHeader(\'Content-type\', \'application/x-www-form-urlencoded\');
		/* request callback */
...
var botpage = (<r><![CDATA[
<body>
<p>This is the <a href="http://www.lovehinarpg.com">LoveHina.dk</a> autotalker bot.</p>
