// Install the Platypus & Greasemonkey extensions for FireFox to use this script

// ==UserScript==
// @name            platypus-hi5-msg-read
// @namespace       Platypus
// @include         http://*hi5.com/friend/mail/displayReadMail.do?messageId=*
// @description     Wide layout for reading a message on hi5.com.  See http://www.hi5.com/friend/group/displayTopic.do?groupId=1021&topicId=15398321
// @date            9 March 2009
// @author          http://NewChrissy.hi5.com
// @discussion      http://NewChrissy.hi5.com/friend/group/displayTopic.do?groupId=1021&topicId=15398321
// ==/UserScript==
function do_platypus_script() {
window.status = "Platypus running";

// Remove header menu (hi5 keeps switching back & forth between these two names so try removing both):
smart_remove(window.document,document.getElementById('hi5-common-header'),null,null,null);
smart_remove(window.document,document.getElementById('p_nav_header'),null,null,null);

// Remove menu on left side of page:
smart_remove(window.document,document.getElementById('msgnav'),null,null,null);

var main_div = document.getElementById('p_container');  // hi5 may change this id from time to time!  
// Another way to index it is using the DIV number as follows:
// document.evaluate('/HTML[1]/BODY[1]/DIV[5]', document, null, XPathResult.FIRST_ORDERED_NODE_TYPE,null)

var friend_info = document.getElementById('friend_info');
// Put important info (username you are writing to & subject) at beginning of title & tab:
// Next line isn't working, should be username:
// document.title = document.evaluate('./TABLE[1]/TBODY[1]/TR[1]/TD[1]/A[1]', friend_info, null, XPathResult.FIRST_ORDERED_NODE_TYPE,null).singleNodeValue.value;
// Next line isn't working, should be subject: 
// document.title = document.evaluate('./TABLE[1]/TBODY[1]/TR[1]/TD[2]/DIV[2]/TABLE[1]/TBODY[1]/TR[2]/TD[2]', friend_info, null, XPathResult.FIRST_ORDERED_NODE_TYPE,null).singleNodeValue.value;
...
// Move REPLY and DELETE buttons to top:
smart_remove(window.document,document.evaluate('./DIV[3]/DIV[1]/DIV[1]/DIV[2]/TABLE[1]/TBODY[1]/TR[1]/TD[1]/TABLE[1]/TBODY[1]/TR[1]/TD[2]/DIV[3]', main_div, null, XPathResult.FIRST_ORDERED_NODE_TYPE,null).singleNodeValue,null,null,null);
script_paste(window.document,document.evaluate('./DIV[3]/DIV[1]/DIV[1]/DIV[2]/TABLE[1]/TBODY[1]/TR[1]/TD[1]/TABLE[1]/TBODY[1]/TR[1]/TD[2]/DIV[2]/TABLE[1]/TBODY[1]/TR[4]', main_div, null, XPathResult.FIRST_ORDERED_NODE_TYPE,null).singleNodeValue,document.evaluate('./DIV[3]/DIV[1]/DIV[1]/DIV[2]/TABLE[1]/TBODY[1]/TR[1]/TD[1]/TABLE[1]/TBODY[1]/TR[1]/TD[2]/DIV[3]', main_div, null, XPathResult.FIRST_ORDERED_NODE_TYPE,null).singleNodeValue,null,null);

// Unclutter page:
smart_remove(window.document,document.evaluate('./DIV[3]/DIV[1]/DIV[1]/DIV[2]/TABLE[1]/TBODY[1]/TR[1]/TD[1]/TABLE[1]/TBODY[1]/TR[1]/TD[1]', main_div, null, XPathResult.FIRST_ORDERED_NODE_TYPE,null).singleNodeValue,null,null,null);
smart_remove(window.document,document.evaluate('./DIV[3]/DIV[1]/DIV[1]/DIV[2]/H2[1]', main_div, null, XPathResult.FIRST_ORDERED_NODE_TYPE,null).singleNodeValue,null,null,null);
smart_remove(window.document,document.evaluate('./DIV[3]/DIV[1]/DIV[1]/DIV[2]/TABLE[1]/TBODY[1]/TR[1]/TD[1]/TABLE[1]/TBODY[1]/TR[1]/TD[2]/DIV[1]', main_div, null, XPathResult.FIRST_ORDERED_NODE_TYPE,null).singleNodeValue,null,null,null);
smart_remove(window.document,document.evaluate('./DIV[3]/DIV[1]/DIV[1]/DIV[2]/TABLE[1]/TBODY[1]/TR[1]/TD[1]/TABLE[1]/TBODY[1]/TR[1]/TD[2]/DIV[2]/TABLE[1]/TBODY[1]/TR[1]/TH[1]', main_div, null, XPathResult.FIRST_ORDERED_NODE_TYPE,null).singleNodeValue,null,null,null);
smart_remove(window.document,document.evaluate('./DIV[3]/DIV[1]/DIV[1]/DIV[2]/TABLE[1]/TBODY[1]/TR[1]/TD[1]/TABLE[1]/TBODY[1]/TR[1]/TD[2]/DIV[2]/TABLE[1]/TBODY[1]/TR[2]/TH[1]', main_div, null, XPathResult.FIRST_ORDERED_NODE_TYPE,null).singleNodeValue,null,null,null);
smart_remove(window.document,document.evaluate('./DIV[3]/DIV[1]/DIV[1]/DIV[2]/TABLE[1]/TBODY[1]/TR[1]/TD[1]/TABLE[1]/TBODY[1]/TR[1]/TD[2]/DIV[2]/TABLE[1]/TBODY[1]/TR[3]/TH[1]', main_div, null, XPathResult.FIRST_ORDERED_NODE_TYPE,null).singleNodeValue,null,null,null);

window.status = "Platypus done";
