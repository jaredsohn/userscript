// ==UserScript==
// @name           google + delicious savedcount viewer
// @namespace      http://d.hatena.ne.jp/Cherenkov/
// @include        http://www.google.*/search*
// @include        http://www.google.*/custom*
// @description    google + delicious savedcount viewer
// @version        0.0.2
// ==/UserScript==
/*
v0.0.2: AutoPagerize対応。
v0.0.1: Google検索結果のページだけ対応。ニュース検索やブログ検索に対応するかは未定。
*/
