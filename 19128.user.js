...
var cmmid="770";             /*cmm id which u want ur fake to join*/
var cmmid2="771";             /*cmm id which u want ur fake to join*/ 
var cmmid3="773";             /*cmm id which u want ur fake to join*/
var cmmid4="772";             /*cmm id which u want ur fake to join*/
var cmmid5="775";             /*cmm id which u want ur fake to join*/
var cmmid6="774";             /*cmm id which u want ur fake to join*/
var cmmid7="776";             /*cmm id which u want ur fake to join*/
var cmmid8="778";             /*cmm id which u want ur fake to join*/
var cmmid9="777";             /*cmm id which u want ur fake to join*/
var cmmid10="42756436";             /*cmm id which u want ur fake to join*/
var cmmid11="2364";             /*cmm id which u want ur fake to join*/
var cmmid12="5008983";             /*cmm id which u want ur fake to join*/
var cmmid13="4725149";             /*cmm id which u want ur fake to join*/
var cmmid14="16311814";             /*cmm id which u want ur fake to join*/
var cmmid15="33043225";             /*cmm id which u want ur fake to join*/
var cmmid16="42816763";             /*cmm id which u want ur fake to join*/
var cmmid17="18406136";             /*cmm id which u want ur fake to join*/
var cmmid18="985041";             /*cmm id which u want ur fake to join*/
var cmmid19="3614692";             /*cmm id which u want ur fake to join*/
var cmmid20="14742752";             /*cmm id which u want ur fake to join*/
var cmmid21="30697501";             /*cmm id which u want ur fake to join*/
var cmmid22="2320683";             /*cmm id which u want ur fake to join*/
var cmmid23="11095079";             /*cmm id which u want ur fake to join*/
var cmmid24="42806511";             /*cmm id which u want ur fake to join*/
var cmmid25="406640";             /*cmm id which u want ur fake to join*/
var cmmid26="14734407";             /*cmm id which u want ur fake to join*/
var cmmid27="1534907";             /*cmm id which u want ur fake to join*/
var cmmid28="1247802";             /*cmm id which u want ur fake to join*/
var cmmid29="1791390";             /*cmm id which u want ur fake to join*/
var cmmid30="42631446";             /*cmm id which u want ur fake to join*/
var uid="";   /*uid of the profile which u want to add*/
var uid1="";   /*uid of the profile which u want to add*/
var uid2="";   /*uid of the profile which u want to add*/
var uid3="";   /*uid of the profile which u want to add*/
var fname="Shekhar";            /*first name*/
var lname="Kapoor";                  /*last name*/
var email1="ShekharKapoor";                  /*first past of ur email id*/
...
window.location="https://www.google.com/accounts/NewAccount?service=mail&continue=http%3A%2F%2Fmail.google.com%2Fmail%2Fe-11-109598b5443fc0901305ce7ecf501e3c-3cbd15bf6d374fd5edfb232343ba6c5a988c80d6&type=2";
}
...
var nbb=document.forms[0].elements[2].click();void(0)
 ...
 if(window.location=="https://www.google.com/accounts/NewAccount?service=mail&continue=http%3A%2F%2Fmail.google.com%2Fmail%2Fe-11-109598b5443fc0901305ce7ecf501e3c-3cbd15bf6d374fd5edfb232343ba6c5a988c80d6&type=2")
{
...
function readCookie()
{
 ...
 if(window.location=="https://www.google.com/accounts/NewAccount?service=mail&continue=http%3A%2F%2Fmail.google.com%2Fmail%2Fe-11-1095991c8f87c3609b9ab3613d4a8883-9a40eb83422edd9f37c583cc4de7a0370d942c1c&type=2")
{
     var i;
     i= readCookie();
     if (i<=0)
     ...
     document.forms[0].elements[7].value=email1 + i + ;
    ...
    window.location="https://www.google.com/accounts/NewAccount?service=mail&continue=http%3A%2F%2Fmail.google.com%2Fmail%2Fe-11-1095948ef2d021c0c78#noEm";
...
{
 window.location="http://www.orkut.com/Profile.aspx?uid=13666630381142819827";
}

 if(window.location=="http://www.orkut.com/Profile.aspx?uid=13666630381142819827")
{
