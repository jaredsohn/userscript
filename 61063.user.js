// ==UserScript==
// @name           bw_ORDERS_ek11
// @namespace      bw_ORDERS_ek11
// @description    bw_ORDERS_ek11
// @include        http://www*.erepublik.com/*
// ==/UserScript==

GM_xmlhttpRequest({
	method: 'GET',
	url: 'http://egermany.itg-em.de/ede/viewtopic.php?f=51&t=2575#p23784',
	...
	onload:function(response){
			...
			header.textContent = 'XI. Expeditionskorp: ';
