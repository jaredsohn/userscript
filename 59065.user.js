// ==UserScript==
// @name		Flickr Super Hero Challenge Check Play
// @namespace		http://www.flickr.com/groups/superchallenge/discuss/
// @description		Check Play Tool for Super Hero Challenge Group	
// @date		01/06/2008
// @creator		KVangeel (Kris Vangeel)
// @modified date	15 July 2009
// @modified by		Kristy (BearandtheMoon)
//
// @include        http://www.flickr.com/groups/showbizchallenges/discuss/
// @include        http://www.flickr.com/groups/showbizchallenges/discuss
// @include        http://flickr.com/groups/showbizchallenges/discuss/
// @include        http://flickr.com/groups/showbizchallenges/discuss
// ==/UserScript==
//
// --------------------------------------------------------------------
...
if (name.match("The Green Room")=="The Green Room") return true; 
...
if (name.match("On the Set")=="On the Set") return true; 
...
if (name.match("Hollywood Legends!")=="Hollywood Legends!") return true;
...
if (name.match("Weekly")=="Weekly") return true;
...
if ((newchlgstatus=="none")&&(value=="photoposter")) return "NOMINEE";
...
if (chlgstatus=="Voted") return "GRAY";
if (chlgstatus=="VOTE") return "BLUE";
if (chlgstatus=="ErrExclPlay") return "RED";
if (chlgstatus=="UPDATING") return "";
if (chlgstatus=="The Green Room") return "Purple";
if (chlgstatus=="On the Set") return "Purple";
if (chlgstatus=="Hollywood Legends!") return "Purple";
if (chlgstatus=="Weekly") return "Purple";
...
{
if (chlgstatus=="VOTE") return "Please Vote!";
if (chlgstatus=="OPEN") return "This challenge is open to photo submissions.";
if (chlgstatus=="Excluded") return "You are excluded from entering this challenge, see rules for more information.";
if (chlgstatus=="NOMINEE") return "You are a nominee in this challenge. Good luck!";
if (chlgstatus=="Voted") return "Thanks for voting :)";
...
if (chlgstatus=="UPDATING") return "Challenge information is being updated behind the scenes."
if (chlgstatus=="The Green Room") return "Green Room Chat";
if (chlgstatus=="On the Set") return "Come on in!";
if (chlgstatus=="Hollywood Legends!") return "Hollywood Legend Archive";
if (chlgstatus=="Weekly") return "Weekly Challenge";
}
...
if (newchlgstatus=="The Green Room") anchor.innerHTML= '[CHAT]';

if (newchlgstatus=="On the Set") anchor.innerHTML= '[ComeOnIn]';

if (newchlgstatus=="Hollywood Legends!") anchor.innerHTML= '[ARCHIVE]';

if (newchlgstatus=="WEEKLY") anchor.innerHTML= '[WEEKLY]';
...
if (newchlgstatus=="NOMINEE") anchor.innerHTML=   '[NOMINEE]';
...
xmlhttp.onreadystatechange = function() {
      if (xmlhttp.readyState == 4) 
        { 	
		  ...
		  // alert()
           if (chlgname.match("Ultra Hero Challenge")=="Ultra Hero Challenge") inbrackets=true
 ...
 */            }
		   ...
		   if (chlgname.match("VOTE")=="VOTE")
             ...
             //if (!inbrackets)
               //{
               if (((photosposted==3)&&(chlgnum=='12'))&&(lastvote.match('10')=="10")) 
                 newchlgstatus="Finished";
               if ((photosposted==3)&&((chlgnum!='12'))&&(lastvote.match('5')=="5")) 
                 newchlgstatus="Finished";
              // }
...
for (i=1;i<trs.length;i++) {
  ...
  if (nonchallenge1(chlgname))  chlgstatus="HERO CHATTER";
  if (nonchallenge2(chlgname))  chlgstatus="HERO Chatter";
  if (nonchallenge3(chlgname))  chlgstatus="Hero Chatter";
  if (nonchallenge4(chlgname))  chlgstatus="Scavenger";
  if (nonchallenge5(chlgname))  chlgstatus="Monthly";
