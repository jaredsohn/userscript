...
// @description    Mark the entries below or above the current entry as read in Google Reader.
// @include        http://*google.tld/reader/view/*
// @include        https://*google.tld/reader/view/*
// ==/UserScript==

// check latest version at http://userscripts.org/scripts/show/45893
...
// the script stops marking after encountering up to this number of read entries
const stop_cumulative_read = 20;

// the script stops marking after encountering this number of consecutive read entries
const stop_consecutive_read = 10;

// the script stops marking after encountering an entry this number of days before the starting entry
...
function mark_below()
{
	...
	if (first_entry != last_entry)
		setTimeout(mark_below, reload_wait);
	else
		simulate_dblclick(start_entry.firstChild);
}
