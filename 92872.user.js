// ==UserScript==
// @name TW Pro + mod Pedro 20101216
// @description TW Pro + mod Pedro 20101216
// @author Nexton/Lekensteyn/Sandevil/Pedro Ramirez/Zyphir Randrott
...
if (url.indexOf(".the-west.") != -1 && url.indexOf("game.php") != -1) {
	...
	var myScript = "function twpro_version(){return '"+twpro_version()+"';}";
...
var sortSchlafImg = ''
var sortSeasonImg = ''

var twpro_lang = {
	info: ['Zephyr Randrott/Pedro Ramirez'],
	WEBSITE: 'Website',
	AUTHOR: 'Author',
	...
	SLEEPYONLY: 'show <b>sleepyhead</b> items',
	SEASONONLY: 'show <b>holiday set</b> items',
	RIDEONLY: 'show <b>riding gear</b>',
	SHOOTONLY: 'show <b>ranged dueling gear</b>'
};
var twpro_langs = {};
twpro_langs.de = {
	info: ['Pedro Ramirez'],
	...
	MULTISEL: 'Mehrere Gegenst\xE4nde verkaufen',
	SELL: 'Ausgew\xE4hlte verkaufen',
	CONFIRMSELL: 'Wirklich die %1 ausgewählten Gegenst\xE4nde verkaufen?',
	SELLING: 'Verkauft...',
	...
	FORTMESSAGERCP: 'Anzahl Empfänger',
	SLEEPYONLY: 'nur <b>Morgenmuffelset</b> zeigen',
	SEASONONLY: 'nur <b>Feiertagsset</b> zeigen',
	RIDEONLY: 'nur <b>Reitausrüstung</b> zeigen',
	SHOOTONLY: 'nur <b>Schützenausrüstung</b> zeigen'
};
twpro_langs.es = {
	info: ['Sandevil'],
	WEBSITE: 'Sitio web',
...
*/
	...
	function twpro_injectScript() {
		...
		// Setitems
		{
				...
				TWPro.twpro_setBonus.set_farmer[1] = {bonus:{attributes:{},skills:{}},jobBonus:{all:0},speedBonus:0,parsedBonus:{}};
				...
				TWPro.twpro_setBonus.set_indian[1] = {bonus:{attributes:{},skills:{}},jobBonus:{all:0},speedBonus:0,parsedBonus:{}};
				...
				TWPro.twpro_setBonus.set_mexican[1] = {bonus:{attributes:{},skills:{}},jobBonus:{all:0},speedBonus:0,parsedBonus:{}};
				...
				TWPro.twpro_setBonus.set_pilgrim_male[1] = {bonus:{attributes:{},skills:{}},jobBonus:{all:0},speedBonus:0,parsedBonus:{}};
				...
				TWPro.twpro_setBonus.set_pilgrim_female[1] = {bonus:{attributes:{},skills:{}},jobBonus:{all:0},speedBonus:0,parsedBonus:{}};
				...
				TWPro.twpro_setBonus.set_quackery[1] = {bonus:{attributes:{},skills:{}},jobBonus:{all:0},speedBonus:0,parsedBonus:{}};
			   ...
			   TWPro.twpro_setBonus.set_dancer[1] = {bonus:{attributes:{},skills:{}},jobBonus:{all:0},speedBonus:0,parsedBonus:{}};
			...
			TWPro.twpro_setBonus.set_gentleman[1] = {bonus:{attributes:{},skills:{}},jobBonus:{all:0},speedBonus:0,parsedBonus:{}};
			...
			TWPro.twpro_setBonus.set_sleeper[1] = {bonus:{attributes:{},skills:{}},jobBonus:{all:0},speedBonus:0,parsedBonus:{}};
			...
			TWPro.twpro_setBonus.season_set[1] = {bonus:{attributes:{},skills:{}},jobBonus:{all:0},speedBonus:0,parsedBonus:{}};
			...
			TWPro.twpro_setBonus.gold_set[1] = {bonus:{attributes:{},skills:{}},jobBonus:{all:0},speedBonus:0,parsedBonus:{}};
			...
			TWPro.twpro_setBonus.greenhorn_set[1] = {bonus:{attributes:{},skills:{}},jobBonus:{all:0},speedBonus:0,parsedBonus:{}};
			TWPro.twpro_setBonus.greenhorn_set[2] = {bonus:{attributes:{},skills:{}},jobBonus:{all:0,sugar:10},speedBonus:0,parsedBonus:{}};
			TWPro.twpro_setBonus.greenhorn_set[3] = {bonus:{attributes:{},skills:{}},jobBonus:{all:0,sugar:10,wood:20},speedBonus:0,parsedBonus:{}};
			TWPro.twpro_setBonus.greenhorn_set[4] = {bonus:{attributes:{},skills:{}},jobBonus:{all:0,sugar:10,wood:20,tanning:20},speedBonus:0,parsedBonus:{}};
			TWPro.twpro_setBonus.greenhorn_set[5] = {bonus:{attributes:{},skills:{}},jobBonus:{all:0,sugar:10,wood:20,tanning:20,turkey:20},speedBonus:0,parsedBonus:{}};
			TWPro.twpro_setBonus.greenhorn_set[6] = {bonus:{attributes:{},skills:{}},jobBonus:{all:0,sugar:10,wood:20,tanning:20,turkey:20,cow:20},speedBonus:0,parsedBonus:{}};
			TWPro.twpro_setBonus.greenhorn_set[7] = {bonus:{attributes:{},skills:{}},jobBonus:{all:5,sugar:10,wood:20,tanning:20,turkey:20,cow:20},speedBonus:0,parsedBonus:{}};
			TWPro.twpro_setBonus.greenhorn_set[8] = {bonus:{attributes:{strength:1,charisma:1},skills:{}},jobBonus:{all:15,sugar:10,wood:20,tanning:20,turkey:20,cow:20},speedBonus:20,parsedBonus:{}};
		}
		TWPro.twpro_invHash = '';
		...
		twpro_supportLink.href = 'http://forum.the-west.de/showpost.php?p=521068';
		...
		$(twpro_supportAuthor.id).addMousePopup(new MousePopup('Nexton<br>Lekensteyn<br>Sandevil<br>Pedro Ramirez<br>Thurstan de Crusoe<br>Zyphir Randrott'));
		...
		case 'page':
			{
				if (twpro_extendeName == 'inventory') {
					...
					var hours = workSpeed[1] * 2,seconds = hours * 3600;
...
*/		
		...
		twpro_xhtml = '<div style="left:20px;position:absolute;margin-top:0px;visibility:hidden;">'+TWPro.lang.JOBRANKSETTINGS+': ';
		...
		twpro_xhtml += '<div style="position:absolute;margin-top:4px;left:210px"><label style="position:absolute;top:4px;left:21px;font-style:italic;font-size:x-small;color:#636;cursor:pointer" for="twpro_searchinventory">'+TWPro.lang.SEARCHINVENTORY+'</label><input type="text" style="width:45px;background:#F0CD8B url(data:image/png;base64,'+sortButtonImg2+') no-repeat scroll 0 0;padding:0 2px 0 19px" id="twpro_searchinventory" onfocus="previousSibling.style.display=\'none\'" onblur="if(this.value==\'\')previousSibling.style.display=\'block\'" onkeyup="TWPro.twpro_searchInventory(event.keyCode==13)" /><span id="twpro_search_help" style="font-weight:bold;color:#191970;cursor:help;background:#D4C7B0;width:20px;height:17px">?</span></div>';
		twpro_xhtml += '<input id="twpro_jobsort_filter" type="checkbox"' + (TWPro.twpro_preference('Hide_unjobs')?' checked="checked"':'') + '  onclick="TWPro.twpro_preference(\'Hide_unjobs\',this.checked);TWPro.twpro_clickfilterList()" style="visibility:hidden;position:absolute;margin-top:200px;left:692px"/>';

		twpro_xhtml += '<div style="position:absolute;top:18px;left:350px;width:140px">';
		twpro_xhtml += '<span id="twpro_aktuelleap" style="position:absolute;visibility:hidden;"><span id="twpro_aktuelleapvalue" style="border-style:solid;border-width:1px;padding:2px;"></span></span>';
		twpro_xhtml += '</div>';
		
		//animierte jobsort-buttons		
		twpro_xhtml += '<div style="position:absolute;top:3px;left:565px">';
		for(var i=0; i<TWPro.twpro_sorts.length; i++){
			var name = TWPro.twpro_sorts[i];
			twpro_xhtml += '<a href="javascript:" onmouseup="TWPro.twpro_sortList(\''+name+'\')"><img id="twpro_jobsort_link_'+name+'" alt="" src="images/transparent.png" width="20" height="17" style="background-image:url(data:image/png;base64,'+sortButtonImg+');background-position:-'+(i*20)+'px '+(TWPro.twpro_jobsort==name?0:-17)+'px" onmouseover="this.style.backgroundPosition=\'-'+(i*20)+'px 0\'" onmouseout="if(TWPro.twpro_jobsort!=\''+name+'\')this.style.backgroundPosition=\'-'+(i*20)+'px -17px\'"/></a>';
		}
		...
		//schlafmütz-button (by pedro)
		twpro_xhtml += '<div style="position:absolute;margin-top:50px;left:692px"><a href="javascript:" onclick="TWPro.twpro_showsleepy()"><img id="twpro_sleepyonly" alt="" src="images/transparent.png" width="20" height="17" style="background-image:url(data:image/png;base64,'+sortSchlafImg+');background-position: 0px -17px" onmouseover="this.style.backgroundPosition=\'-0px 0\'" onmouseout="this.style.backgroundPosition=\'-0px -17px\'"/></a></div>';
		//feiertags-button (by pedro)
		twpro_xhtml += '<div style="position:absolute;margin-top:72px;left:692px"><a href="javascript:" onclick="TWPro.twpro_showseason()"><img id="twpro_seasononly" alt="" src="images/transparent.png" width="20" height="17" style="background-image:url(data:image/png;base64,'+sortSeasonImg+');background-position: 0px -17px" onmouseover="this.style.backgroundPosition=\'-0px 0\'" onmouseout="this.style.backgroundPosition=\'-0px -17px\'"/></a></div>';

		//new bag-hover-button
		twpro_xhtml += '<div id="twpro_bag" style="position:absolute; z-index:2;left: 318px; margin-top:6px;"><img src="/images/items/yield/bagpack.png" width="25" height="25"></div>';
...
toggle_any = 0;
			...
			for(i=0; i<bag_items.length; i++){
				if (bag_items[i].firstChild.getAttribute('src') !=null){
					...
					for (j=0; j<customitems.length; j++){
						test = bag_items[i].firstChild.getAttribute('src').indexOf(customitems[j]);
						if (test != -1) {
	...
	function twpro_showseason(){
		if (toggle_any != 2){
			toggle_any = 2;
			var bag_items = document.getElementById('bag').getElementsByTagName('div'),
				i, j, anyresult, test,
				nores = document.getElementById('twpro_nosearchresult'),
				customitems = new Array("dfgrocket1a","amulett","smells_like_eggspirit","cylinder_xmas","deathsythe","thanksgiving_boots");;
	...
	function twpro_showList() {
		...
		$('twpro_sleepyonly').addMousePopup(new MousePopup(TWPro.lang.SLEEPYONLY, 100, {opacity:0.95})); //by Pedro
		$('twpro_seasononly').addMousePopup(new MousePopup(TWPro.lang.SEASONONLY, 100, {opacity:0.95})); //by Pedro
...
//		alert(TWPro.twpro_getBagPopup());
//		$('twpro_bag').addMousePopup(new MousePopup("test"));
	...
	function twpro_getBagPopup() {
		...
		twpro_xhtml += '<tr><td class="item_popup_trader_price">'+TWPro.lang.GUNS+':&nbsp;&nbsp;</td>';
		twpro_xhtml += '<td class="item_popup_trader_price">' + TWPro.twpro_bag.twpro_countType['left_arm'] + '</td></tr>';
		...
		twpro_xhtml += '<tr><td class="item_popup_trader_price">'+TWPro.lang.BELTS+':&nbsp;&nbsp;</td>';
		twpro_xhtml += '<td class="item_popup_trader_price">' + TWPro.twpro_bag.twpro_countType['belt'] + '</td></tr>';
		twpro_xhtml += '<tr><td class="item_popup_trader_price">'+TWPro.lang.PANTS+':&nbsp;&nbsp;</td>';
		twpro_xhtml += '<td class="item_popup_trader_price">' + TWPro.twpro_bag.twpro_countType['pants'] + '</td></tr>';
		...
		var twpro_all = TWPro.twpro_bag.twpro_countType['head'] + TWPro.twpro_bag.twpro_countType['neck'] + TWPro.twpro_bag.twpro_countType['right_arm'] + TWPro.twpro_bag.twpro_countType['left_arm'] + TWPro.twpro_bag.twpro_countType['body'] + TWPro.twpro_bag.twpro_countType['belt'] + TWPro.twpro_bag.twpro_countType['pants'] + TWPro.twpro_bag.twpro_countType['foot'] + TWPro.twpro_bag.twpro_countType['animal'];
	...
	function twpro_updateList() {
		...
		if (!TWPro.twpro_calculated) {
			...
			//alert("twpro_jobCount="+twpro_jobCount + " / TWPro.twpro_jobs.length="+TWPro.twpro_jobs.length);
			...
			for (var twpro_job in JobList) {
				...
				twpro_jobCount++;
				*/
				TWPro.twpro_jobs[twpro_jobCount] = JobList[twpro_job];
				TWPro.twpro_jobs[twpro_jobCount].twpro_calculation = TWPro.twpro_jobs[twpro_jobCount].formular.replace(/skills\./g, 'Character.skills.');
				twpro_jobCount++;
				/* 
				// es gibt luecken in der JobList (die man auch im Quellcode der Seite sehen kann), z.B. vor Raddampfer steuern mit Nr 82 fehlt die 81 
				// daher oben drueber den code geaendert, damit die luecken nicht uebernommen werden, 
				// der pop unten sollte damit hinfaellig sein, es macht eh keinen Sinn, da einfach Jobs zu loeschen, daher stattdessen dort einen Alert anzeigen???
				// 
				if (twpro_jobCount != TWPro.twpro_jobs.length) {
					if (TWPro.twpro_jobs.length > 80) {
						alert(JobList[twpro_job].name + " in JobList an pos " + twpro_jobCount)
						alert(JobList[twpro_job].name + " in TWPro.twpro_jobs an pos " + parseInt(twpro_job))
					}
				}
				*/
			}
	...
	function twpro_initializeItems(twpro_place, twpro_itemlist) {
		...
		if (twpro_place == 'wear') {
			for (var twpro_wear in Wear.wear) {
			//			alert(Wear.wear[twpro_wear].obj.type)
	...
	//		alert(twpro_item.type);
		if (TWPro.twpro_failure) return false;
		if ((twpro_item.characterClass != null) && (twpro_item.characterClass != Character.characterClass)) {
			return false;
		}
		if (((twpro_item.type == 'belt') || (twpro_item.type == 'pants')) && (twpro_item.level != null) && (twpro_item.level > Character.level))
		{
			return false;
		}
	...
	function twpro_compareItem(twpro_job, twpro_item) {
		...
		// do not use sythe in fort battles		
		if (twpro_item.short == "deathsythe") {
			if (twpro_job.shortName=="fortatt" || twpro_job.shortName=="fortdef") {
				//alert("deathsythe 0");
				twpro_item.bonus.attributes.charisma=0;
				twpro_item.bonus.attributes.strength=0;
				twpro_item.bonus.attributes.flexibility=0;
				twpro_item.bonus.attributes.dexterity=0;
			} else {
				//alert("deathsythe 1");
				twpro_item.bonus.attributes.charisma=1;
				twpro_item.bonus.attributes.strength=1;
				twpro_item.bonus.attributes.flexibility=1;
				twpro_item.bonus.attributes.dexterity=1;
			}
		}
		// deathsythe
		// muzzleloader_bowie
	...
	if(typeof window.TWPro == 'undefined'){try{
		...
		TWPro.twpro_showsleepy = twpro_showsleepy;
		TWPro.twpro_showseason = twpro_showseason;
