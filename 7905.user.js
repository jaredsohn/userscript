// ==UserScript==
// @name		GoogleTagCloudMaker Dark Gray Redesign
// @namespace	http://d.hatena.ne.jp/muddydixon/ | http://www.hybridprojekt.com
// @author		Muddy Dixon <muddydixon@gmail.com> | Jeff <jeffd0006@gmail.com>
// @include		http://www.google.*/search*
// @description	For those who use, http://userstyles.org/style/show/1693
// @version		0.1.1
// ==/UserScript==
...
(function(){
	...
	g.body = g.innerHTML.match(/<font size=\"-1\">(.+?)<br><span/)[1];
...
//	'['+emchar['hKana']+']+|' +
	    ...
	    this.timeout = setTimeout(
			  ...
			  try{
				  ...
				  for(var i = 0; i < parent.getElementsByTagName('div').length; i++){
					  ...
					  var child = document.getElementById(i);
					  child.style.backgroundColor = '#3e3e3e';
					  parent.removeChild(child);
	...
	cloud.style.border = 'solid 1px #606060';
	cloud.style.backgroundColor = '#202020';
	cloud.style.position = 'relative';
	cloud.style.cssFloat = 'right';
	cloud.style.marginTop = '10px';
	cloud.style.padding = '3px';
...
// 	cloud.insertBefore(document.getElementById('navbar'), null);
	...
	if(document.getElementById('nn')){
	    ...
	    nn.style.backgroundColor = '#606060';
	...
	np.style.backgroundColor = '#606060';
	...
	cl.style.backgroundColor = '#606060';
