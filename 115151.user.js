// ==UserScript==
// @name          tracker by Seed Aid aux64
// @namespace     http://lib.pirat.ca/tracker
// @description   tracker
// @include       http://pirat.ca/tracker.php*
...
function needHelp() {
$.each($('td.row3 b.seedmed'), f1);
$.each($('tr.tCenter td.row2 a.genmed'), f2);  
$(".seeaid").click(showseed);
};
...
function f1() 
{
    var numseed = $(this).text();
	if (numseed<4)
	{
		var seltor = $(this);
		var seltor2, seltor25, seltor3, seltor4, seltor5;
		seltor.css('color', 'red');
		seltor2 = seltor.closest('tr');
		seltor25 = seltor2.children('td');
		seltor25.css('background', '#FFF');
		seltor3 = seltor2.children('td.tLeft');
		seltor3.css('background', '#EEE');
		};	
};
function f2() 
{
		...
		seltor.after("<br><p><b>&clubs; Seed Aid </b> <span class='seeaid' href='"+linkaid+"'>Предпросмотр</span><span class='seeaid_link' > <a class='genmed' href='"+linkaid+"'> Переход со статистикой</a></span></p>");
