   ...
   show : function () {
    ...
    showReportBody: function (Date1,rslt,TileId,SideNum,Nom1,Coord1,Nom2,Coord2) {
    		  	...
    		  	if (rslt['fght']["s0"] != undefined) {
  					 ...
  					 if (rslt['fght']["s0"]['f'+i] != undefined) {
  					  if (rslt['fght']["s0"]['f'+i][0] > rslt['fght']["s0"]['f'+i][1]) m+='<TR><TD align="center"><div  class="pic px30 units unit_'+i+'"></td><TD align="center">'+rslt['fght']["s0"]['f'+i][0]+'</td><TD align="center"><FONT color="#CC0000">'+rslt['fght']["s0"]['f'+i][1]+'</font></td></tr>';
  				  		  	 ...
  				  		  	 m+="<tr><td><br>Keine geschützte Einheit</td></tr>";
  	  		 }
    		  	m+='<TR><TD></TD></TR></table>';
    	}
    	...
    	if (rslt['rsc'] != undefined) {
    	  ...
    	  // Renfort !
     	   m+='<TABLE style="float:left;width:45%;" class=ptTab cellpadding=3><TR style="background-color:#E5DDC9;color: #422714;font-size: 12px;font-weight: bold;"><TD align="center">Truppen</td><TD align="center">Renforc&eacute;</td></tr>';
  	   ...
  	   style=' style="background-color:#99EF99;padding:2px;"';
          ...
          m+='&nbsp;</td>\
            <td '+style+'>'+unsafeWindow.formatDateByUnixTime(rpt.reportUnixTime)+'</td>\
              ...
              <td '+style+'><a href="javascript:void(0)" onclick="cm.utils.CoordinateLinkController.onClick(event)" class="coordinateLink">('+ rpt.side1XCoord +','+ rpt.side1YCoord +')</a></td>';
              if (rpt.marchType == 3) 
  	     ...
  	     m +='<TD '+style+'><FONT color="FF0033">'+rpt.marchName+'</font></td>';
  	      ...
  	      m +='<TD '+style+'><FONT color="339933">'+rpt.marchName+'</font></td>';
              ...
              <td '+style+'><a href="javascript:void(0)" onclick="cm.utils.CoordinateLinkController.onClick(event)" class="coordinateLink">('+ rpt.side0XCoord +','+ rpt.side0YCoord +')</a></td>';
