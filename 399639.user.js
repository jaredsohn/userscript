// ==UserScript==
// @name        Casting Script Mushbuster
...
Casting.mm.group = "Mushbuster";
Casting.mm.urlgroup = "http://mush.vg/g/mushbuster";
Casting.mm.autor = "Simba";
Casting.mm.urlautor = "http://mush.vg/u/profile/7943680";
...
Casting.mm.center.INFO_RANGS['Débutant']['infotext'] = "Ce rang vous offre l'option <strong>Mush cachés</strong>.<br/>La taille maximale du casting passe à 32 chasseurs.<br/><em>Votre vie de chasseur commence enfin ! Bon pour le moment vous nettoyez votre local, mais ça y est !</em>";
...
Casting.mm.center.INFO_RANGS['Café-théâtre']['infotext'] = "Ce rang vous offre l'option <strong>Jeu Lent</strong> qui porte les cycles à 4h.<br/>La taille maximale du casting passe à 40 chasseurs.<br/><em>Premier fantôme attrapé ! bon ce n'était que des enfants déguisés pour Halloween, mais au moins vous n'avez pas eu peur</em>";
...
Casting.mm.center.INFO_RANGS['Soldat de fortune']['infotext'] = "Débloque la fonctionnalité des Scripts. Les Scripts permettent de pré-enregistrer un message pour chaque perso qui s'affichera en début de partie.<br/>La taille maximale du casting passe à 48 chasseurs.<br/><em>Les gens vous croient de plus en plus fou, mais vous savez que les fantômes sont parmis nous !</em>";
...
Casting.mm.center.INFO_RANGS['Troupe de province']['infotext'] = "La taille maximale du casting passe à 88 Chasseurs.<br/><em>Enfin, certaines personnes croient en vous, et vous appelle pour chasser les fantômes de chez eux, ou pour faire le ménage, nous ne savons pas trop.</em>";
...
Casting.mm.center.INFO_RANGS['Bar lounge']['infotext'] = "Débloque l'option Triple Mush.<br/>La taille maximale du casting passe à 104 Chasseurs.<br/><em>Votre premier vrai fantôme attrapé.</em>";
...
Casting.mm.center.INFO_RANGS['Colleur d\'affiche']['infotext'] = "Débloque l'option Jeu Beta.<br/>La taille maximale du casting passe à 112 Chasseurs.<br/><em>Le monde croit en vous à présent !</em>";
...
Casting.mm.center.INFO_RANGS['Opéra-Bouffe']['infotext'] = "Débloque l'option Jeu Rapide qui porte les cycles à 2h.<br/>La taille maximale du casting passe à 128 Chasseurs.<br/><em>Vous savez enchaîner 2 chasses sans être essoufflé</em>";;Casting.mm.center.info = {};
...
Casting.mm.center.INFO_RANGS['Nain de jardins']['infotext'] = "Débloque le départ manuel des vaisseaux.<br/>La taille maximale du casting passe à 144 Chasseurs.<br/><em>Vous êtes le roi de la chasse, un petit roi, mais un roi tout de même</em>";;Casting.mm.center.info = {};
...
Casting.mm.center.INFO_RANGS['Orchestre']['infotext'] = "La taille maximale du casting passe à 160 Chasseurs.<br/><em>On peut vous faire confiance pour animer les soirées de chasses</em>";;Casting.mm.center.info = {};
...
Casting.mm.center.INFO_RANGS['Ballet National']['infotext'] = "Débloque l'option Mush En Sommeil<br/>La taille maximale du casting passe à 176 Chasseurs.<br/><em>Il est temps de se réveiller, la chasse ne va pas se faire sans vous</em>";;Casting.mm.center.info = {};
...
Casting.mm.center.INFO_RANGS['Opéra']['infotext'] = "Débloque l'option Mush En Sommeil<br/>La taille maximale du casting passe à 176 Chasseurs.<br/><em>Il est temps de se réveiller, la chasse ne va pas se faire sans vous</em>";Casting.mm.center.info = {};
...
Casting.mm.center.recupInfo = function() {
    ...
    var fond = "http://img15.hostingpics.net/pics/796591eclair11.jpg" ;
}
...
Casting.mm.center.dispNewInfo = function() {
    ...
    var divRang = $("<div><h3><div class=\"cornerright\">Informations sur le Casting</div></h3></div>").addClass("twinstyle").appendTo(divRangBloc);
    ...
    var divRangHTML = "<div class=\"floatInfo\" style=\"text-align: center;\"><div class=\"xpcompletion\" onmouseout=\"Main.hideTip();\" onmouseover=\"Main.showTip(this, " + infobulleXPText + ")\">" +
        ...
        "</div></div>" +
        "<div class=\"floatText\">" + ((rang > 0) ? "Encore " + Math.floor((lvlup - xp)/25) + " Chasse et " + ((lvlup - xp) - Math.floor((lvlup - xp)/25)*25) + " Tickets ou alors, " + (lvlup - xp) + " Tickets." : "Encore " + (lvlup - xp) + " tickets à investir.") + "</div>" +
        ...
        "<span class=\"spanBox\">Nombre de chasseurs max. :</span> " + max + " personnes<br>" +
        "<span class=\"spanBox\">Chasseurs necessaire :</span> " + need + " personnes<br>" +
        "<span class=\"spanBox\">Nombre de chasseurs actuel :</span> " + Casting.mm.center.info.effect.length + " personnes<br>" +
        "<div class=\"floatRejPret\">" + Casting.mm.center.info.btnRejPret + "</div>" +
        "<span class=\"spanBox\">Nombre de chasses terminés :</span> " + Casting.mm.center.info.partieEnd + "<br>" +
    ...
    var divOthInfo2 = $("<div><h3><div class=\"cornerright\">Lancement des Chasses</div></h3></div>").addClass("twinstyle").appendTo(divOthInfoBloc);
    ...
    var divEffectIG = $("<div><h3><div class=\"cornerright\">Chasseurs en voyage ailleurs (" + Casting.mm.center.info.effectIG.length + ")</div></h3></div>").addClass("twinstyle").appendTo(divEffectIGBloc);
    var divEffectIGHTML = "";
    ...
    var divEffectWait = $("<div><h3><div class=\"cornerright\">Chasseurs en attente (" + Casting.mm.center.info.effectWait.length + ")</div></h3></div>").addClass("twinstyle").appendTo(divEffectWaitBloc);
    ...
    var divEffectPret = $("<div><h3><div class=\"cornerright\">Chasseurs prêts à partir (" + Casting.mm.center.info.effectPret.length + ")</div></h3></div>").addClass("twinstyle").appendTo(divEffectPretBloc);
