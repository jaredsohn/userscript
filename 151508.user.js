...
// @_include       /https?://(www\.(gay|planet)romeo.com|83\.98\.143\.20)/.*mitglieder/administration/pictures/overview\.php\?.*/
// note: 'include' with RegExp is not supported by Chrome - since Greasemonkey 0.9.8 (Aug 2011) also supports 'match' I don't use 'include'
// @match        *://*.gayromeo.com/*mitglieder/administration/pictures/overview.php*
// @match        *://*.planetromeo.com/*mitglieder/administration/pictures/overview.php*
// @match        *://83.98.143.20/*mitglieder/administration/pictures/overview.php*

// @_include       /https?://(www\.(gay|planet)romeo.com|83\.98\.143\.20)/.*mitglieder/administration/pictures/edit\.php\?id=.*/
//  ^- the '_' is to comment out include
// @match        *://*.gayromeo.com/*mitglieder/administration/pictures/edit.php*
// @match        *://*.planetromeo.com/*mitglieder/administration/pictures/edit.php*
// @match        *://83.98.143.20/*mitglieder/administration/pictures/edit.php*
...
var CACHE_NAME = 'grtimagecache',
	...
	leftWin_frame = (top.wrappedJSObject||top).document.getElementsByName('mitte')[0]
                                       .contentDocument.getElementsByName('navibar')[0],
	leftDoc = leftWin_frame.contentDocument,
