...
// ==/UserScript==
var Version = '30.04.2011';
var Versiondate = '30.04.2011';
var Scriptname = 'Reference';
var ScriptTabName = 'Reference';
...
function pcStartup (){
 ...
 var styles = '.xtab {padding-right: 5px; border:none; background:none; white-space:nowrap;}\
   ...
   .pcstat {border:1px solid; border-color:#0000FF; font-weight:bold; padding-top:2px; padding-bottom:2px; text-align:center; color:#FFFFAA; background-color:#161E8A}\
   ...
   .atk { color:red; font-weight:bold } .sco { color:orange; font-weight:bold}\
   ...
   table.pcMainTab tr td.notSel {font-weight:bold; font-size:13px; border: 1px solid; border-style: solid solid none solid; background-color:#161E8A; color:white; border-color:black;}\
   tr.pcPopTop td { background-color:#dde; border:none; height: 21px;  padding:0px; }\
...
Tabs.Info = {
  ...
  init : function (div){
    ...
    m = '<STYLE>.xtabH {background:#ffffe8; border:none; padding-right: 5px; padding-left: 5px; margin-left:10px; }\
        ...
        <DIV style="height:650px; max-height:650px; overflow-y:auto; overflow-x:hidden"><DIV class=pcstat>UNIT INFORMATION</div><TABLE align=center cellpadding=1 cellspacing=0>\
...
var crestreq = { 3:{1101:4, 1102:2, 1103:1},
 ...
 m += '<DIV class=pcstat>CREST REQUIREMENTS</div><TABLE align=center cellpadding=1 cellspacing=0>\
      <TR CLASS="xtabH">\
        <TD class=xtab></TH>\
        <TD class=xtabHL><div style="text-align: center;"><b>Requirement 1</b></div></TD>\
        <TD class=xtabHL><div style="text-align: center;"><b>Requirement 2</b></div></TD>\
        <TD class=xtabHL><div style="text-align: center;"><b>Requirement 3</b></div></TD>\
      </TR>\
	  <TR style="height:1px;"><TD style="padding:0px; spacing:0px; height:1px; border-color:black; border-width: 1px; border-style: none none solid none" colspan=14></td></tr>';
	  rownum = 0;
	  for(k in crestreq){
	  if (++rownum % 2)
		...
		for(u in crestreq[k])
			m+='<TD class=xtabL>You own '+crest[u]+' '+crestname[u]+'s of '+crestreq[k][u]+' you need</TD>';
		m += '</TR>';
	  }
 m += '</TABLE>';

    m += '<BR><DIV class=pcstat>DISTANCE CALCULATOR</div><DIV class=ptentry><TABLE align=center cellpadding=1 cellspacing=0>\
...
<div>Model ETA with: <select id="idETASelect">\
...
<BR><BR></center>';
    m += '<DIV class=pcstat>PROVINCE MAP</div><DIV id=ptProvMap style="height:'+ provMapCoords.imgHeight +'px; width:'+ provMapCoords.imgWidth +'px; background-repeat:no-repeat; background-image:url(\''+ URL_PROVINCE_MAP +'\')"></div>';
    m += '<BR><DIV class=pcstat>MISC INFO</div><br>KofC client version: '+ KOCversion +' &nbsp;&nbsp;&nbsp;Script version '+ Version +' &nbsp;';
...
//    var off = getAbsoluteOffsets (eMap);
    ...
    ce.style.border='2px solid #FFFF00';
    ce.style.color = 'gold';
...
Tabs.wikia = {
 ...
 init : function (div){    // called once, upon script startup
   var t = Tabs.wikia;
   t.myDiv = div;
   div.innerHTML = '<CENTER><iframe src="http://koc.wikia.com/wiki/Kingdoms_of_Camelot_Wiki" width="100%" height="550" name="wikia_tab" <p>Ihr Browser kann leider keine eingebetteten Frames anzeigen: Sie k&ouml;nnen die eingebettete Seite &uuml;ber den folgenden Verweis aufrufen: <a href="'+ t.forumlink +'">Knights of Phoenix Forum</a></p> </iframe> <BR></center>';
 },
