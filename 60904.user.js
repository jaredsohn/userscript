// IMDB->Torrents Linker 2.3 - EDITED BY GLaDOSDan for tehconnection.eu
...
var ImdbTorrentsLinker = {
 trackers: [new SearchEngine('TC',
                             'http://tehconnection.eu/favicon.ico',
                             'http://tehconnection.eu/torrents.php?torrentname=%title',
                             false)
            ],
