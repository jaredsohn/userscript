...
var isBadUrl = location.pathname.indexOf("ISAPI");
var slashLoc = 0;
...
if (isBadUrl == -1) {
  ...
  // When loading an item's page, sometimes this script will run for eBayISAPI.dll. Skip these.
  exit();
}
