// ==UserScript==
// @name            Remove the stupid shit from the training page
// @namespace       GLB
// @include         http://goallineblitz.com/game/training.pl?player_id=*
// ==/UserScript==
function do_platypus_script() {
smart_remove(window.document,document.evaluate('/HTML[1]/BODY[1]/DIV[2]/DIV[5]/DIV[3]', document, null, XPathResult.FIRST_ORDERED_NODE_TYPE,null).singleNodeValue,null,null,null);
smart_remove(window.document,document.getElementById('createplayer'),null,null,null);
smart_remove(window.document,document.getElementById('vidboxcreateplayer'),null,null,null);
smart_remove(window.document,document.evaluate('/HTML[1]/BODY[1]/DIV[2]/DIV[5]/DIV[2]', document, null, XPathResult.FIRST_ORDERED_NODE_TYPE,null).singleNodeValue,null,null,null);
