// ==UserScript==
// @name           Ikariam General Helper beta
// @version        0.41.3
...
// @history        0.41.3 poprawki w wykrywaniu adresu
// @history        0.41.2 próba w końcu się udała
// @history        0.41.1 próba wywalenia tego cholerstwa z jQuery
// @history        0.41.0 szykowanie sie do nowej wersji
...
- nie wykrywanie zdarzeń typu stacjonuj flotę itp. (skąd one się wzięły w tym w ogóle).
*/
...
ScriptUpdater.check(75934, '0.41.3');
  ...
  "gr": // vassilis
   {
    ...
    /* Actions */
    occupytown:   "Κατέλαβε την πόλη!",
    pillage:      "Λεηλασία",
    ontheway:     "Καθ`οδόν",
    blockharbour: "Αποκλεισμός Λιμανιού!"
   },
