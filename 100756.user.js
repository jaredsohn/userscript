...
styleEl.innerHTML = '#gbar { display: none;}#guser { display: none;}#topCtrls { display: none;}#mainlogo { display: none;}div.gbh { display: none;}#sidebar { display: none;}td.logoparent.logoparent-nondasher { display: none;}';
