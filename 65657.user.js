/**
* BUGS FIXED!
* Facebook Mafia Wars Autoplayer v10.8
* Copyright 2008-2009, MafiaWarsPlayer. All rights reserved.
* Official Site: MafiaWarsPlayer.org
*/
...
// @authors	Credits to all respective MWAP code creators.
// @version     10.8
// ==/UserScript==

var SCRIPT = {
  url: 'http://userscripts.org/scripts/source/65017.user.js',
  version: '10.8',
  build: '2009',
  name: 'inthemafia',
  appID: 'app10979261223',
  ajaxPage: 'inner2',
  presentationurl: 'http://userscripts.org/scripts/show/65017',
...
mafzPak('#mainDiv {overflow: auto !important;} .fb_email_prof_header {display: none !important;}');
...
var tabSelectedImage = '<img src="' +
			'http://mwfb.static.zynga.com/mwfb/graphics/black_bg.gif' +
			'" />';
...
var closeButtonIcon = '<img src="' +
                    'http://www.metamorphose.org/img/closebutton1.png' +
                    '" />';
...
var redBgImage =    '<img src="' +
			'http://mwfb.static.zynga.com/mwfb/graphics/bangkok_button_texture_100x144_01.gif' +
			'" />';
...
var generalTabImage =     '<img src="' +
			'http://mwfb.static.zynga.com/mwfb/graphics/mw_bangkok_background_760x418_01.jpg' +
			'" />';
...
var aboutTabImage =     '<img src="' +
			'http://mwfb.static.zynga.com/mwfb/graphics/MW_FB_Background_760.gif' +
			'" />';

var mwapLogo =     '<img src="' +
                    'http://s3.amazonaws.com/uso_ss/4842/large.jpg' +
                    '" />';
...
function createSettingsBox() {
  ...
  if (!document.getElementById('ap_settings_css')) {
    makeElement('style', document.getElementsByTagName('head')[0], {'id':'ap_settings_css', 'type':'text/css'}).appendChild(document.createTextNode(
      '#settingsBox #tabNav div{border-right:1px solid #000;float:left;margin-left:3.3px; padding:0px 7px;position:static;text-align:center}' +
      '#settingsBox #tabNav div.selected{background-image:url(' + stripURI(tabSelectedImage) + ')}' +
      '#settingsBox #tabNav div a{color:#fff;font-weight:700;text-decoration:none}' +
      ...
      '#settingsBox .tabcontent{background-repeat:no-repeat;background-position:center top;display:none;height:470px;top:114px;width:600px;}' +
  ...
  var settingsBox = makeElement('div', elt, {'style':'position: fixed; top: 10px; right: 30px; width: 600px; height: 580px; font-size: 14px; z-index: 100; color: #BCD2EA; border:5px solid #1E2713; background: #000 no-repeat scroll 0 110px', 'id':'settingsBox'});
  //End settings box
  ...
  var settingsBoxTopBG = makeElement('div', settingsBox, {'style':'background: black; position: static; height: 80px;'});
    ...
    makeElement('img', settingsBoxTopBG, {'src':stripURI(mwapLogo), 'style':'position: absolute; top: 0px; right: 1px;'});
  ...
  // Create save button
  var saveButton = makeElement('span', settingsBox, {'class':'sexy_button', 'style':'right: 10px; bottom: 10px;'});
  ...
  var updateButton = makeElement('span', settingsBox, {'class':'sexy_button', 'style':'left: 10px; bottom: 10px;'});
  makeElement('button', updateButton).appendChild(document.createTextNode('Check for Latest Release'));
...
function createGeneralTab() {
  ...
  makeElement('input', rhs, {'type':'text', 'value':GM_getValue('d1', '0'), 'id':'d1', 'size':'1', 'style':'text-align: center'});
  rhs.appendChild(document.createTextNode(' to '));
  makeElement('input', rhs, {'type':'text', 'value':GM_getValue('d2', '1'), 'id':'d2', 'size':'1', 'style':'text-align: center'});
...
function createAboutTab () {
  ...
  versionInfo.appendChild(document.createTextNode(SCRIPT.build+' Released'));

  var devs = makeElement('div', aboutTab, {'style':'top: 75px; left: 10px; font-size: 12px; font-weight: bold;'});
  devs.appendChild(document.createTextNode('About this script:'));
  devList = makeElement('span', devs, {'style':'position: relative; left: 15px;'});

  var devNames = ['Facebook Mafia Wars Autoplayer v10.8', 'Credits to all respective MWAP code creators.', 'Debugged by Supreme kaPz', '', '', 'Facebook Mafia Wars Autoplayer', 'Copyright 2008-2009, MafiaWarsPlayer. All rights reserved.', 'Official Site: http://mafiawarsplayer.org/'];
...
function customizeMasthead() {
  ...
  var mwapTitle = 'MWAP ' + SCRIPT.version + ' (' + SCRIPT.build + ' Released)';
