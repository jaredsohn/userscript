// ==UserScript==
// @name        Ultoo Script by Piyush for ULTOO.COM [25-april]
//@description Automatically works on ultoo.com for SMS,Polls,Answers
...
{
	window.location.href = "http://adf.ly/Neaug";
...
if (path=="/poll.php")
{
    ...
    setTimeout("window.location.href = \"http://ultoo.com/poll.php?zxcoiesesscd=\";",700);
}
...
var pattern=/^http:\/\/ultoo.com\/PollCompletion.php/g;
...
if(url.search(pattern)==0)
{
    var options="rama;vishnu;arrow;baisakh;england;paheli;bjp;usa;salman;fhm;bari;oval;model;mumbai;indra;england;akshaye;ramdas;energy;hockey;lev;Mumbai;tulip;megan fox;Chennai;bowler;hill station;india;asia;gupta;1937;dansih;6;gauri khan;aral;10;lord rama;ramandeep;rannji;fraud;dum;guwahati;tapti;27;parul;1745;sonar;ap;arun;ram vilas"
	...
	setTimeout("window.location.href = \"http://ultoo.com/AnswereIt.php?zxcoiesesscd=\";",2600);
}
