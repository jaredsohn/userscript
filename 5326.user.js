// ==UserScript==
// @name          Black and White Homepage by Jorge
// @namespace     www.myspace.com/jorge_suarez
// @description	  Jorge's Black and White Homepage
...
s+= "body {background:url(http://i17.photobucket.com/albums/b69/MUSTANG_COBRA/georgeeee.jpg) #800303 fixed;margin-top:-50px;}\n";
...
s+= "a[id*='friendImageLink']:hover img {border:none!important;}\n";
s+= "a[id*='friendImageLink'] img {border:none!important;}\n";
