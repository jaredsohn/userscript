...
function twpro_insertList(twpro_data)
{
  ...
  if(TWPro.Hide_unjobs==true){checkednojob="checked"}else{checkednojob=""} //666
  twpro_xhtml += '<span id="twpro_aktuelleap" style="position:absolute;right:99px;visibility:hidden;"><span id="twpro_aktuelleapvalue" style="border-style:solid;border-width:1px;padding:3px;"></span> </span></td></tr><tr><td><select id="twpro_jobList" size="1" onchange="TWPro.twpro_changeJob()" onclick="TWPro.twpro_clickList()" style="background-color: rgb(207, 195, 166); font-size: 11px; width:238px;"><option value="-1" id="twpro_wait" style="background-color: rgb(207, 195, 166);">Lista muncilor</option></select>';
 /* 
