// ==UserScript==
// @name Super_preloader_单文件规则增强版
// @author NLF & dingdong,jiayiming,青蛙傻傻,ttony,kwoktree，vokins
// @description  预读+翻页
// @create 2010-4-30
// @lastmodified 20:22 2013/02/06
// @version 2013.02.06
// @namespace  https://userscripts.org/users/wuji2004
// @include http*
...
// ==/UserScript==
	...
	{siteName:'t66y',
                        url:/http:\/\/t66y\.com\/(thread\d+|htm_data\/.*\.html)/i,
                        siteExample:'t66y',
                        nextLink:'auto;',
                        autopager:{
                                pageElement:'//div[@class="t"][@style] | //div[@class="t t2"]',
                        }
                },
           	{siteName:'c1522.amlong.info',
                        url:/http:\/\/c1522\.amlong\.info\/(thread\d+|htm_data\/.*\.html)/i,
                        siteExample:'t66y',
                        nextLink:'auto;',
                        autopager:{
                                pageElement:'//div[@class="t"][@style] | //div[@class="t t2"]',
		...
		{siteName:'百度mp3',
			...
			autopager:{
				...
				remain:1.4,
                            ...
                            siteExample:'http://tieba.baidu.com/f?kw=%BA%A3%D4%F4%CD%F5',
                            nextLink:'auto;',
                            autopager:{
                                    pageElement:'css;ul#thread_list.threadlist',
                            },
                    },
                    {siteName:'百度貼吧帖子內容',
                            url:/http:\/\/tieba\.baidu\.com\/p/i,
                            siteExample:'http://tieba.baidu.com/p/1869870010',
                            nextLink:'auto;',
                            autopager:{
                                    useiframe:true,
