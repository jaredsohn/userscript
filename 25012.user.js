// ==UserScript==
// @name           Ikariam Menu Enhanced(Eng. Version)
// @namespace      Neuromancien
// @description    Enhanced menu for Ikariam with english translation added, this is only a temporary upload, and will be taken down once the original is updated.
...
//         langfile=['Recherche','Unités','Navires','Bâtiments','Miracle', 'Forum', 'Scores', 'Options', 'Log out']
...
_sub = new Array();
_sub["href"] = "http://board.ikariam.org/";
_sub["target"] = "blank";
_sub["submenu"] = null;
_menu[title[1]] = _sub;
