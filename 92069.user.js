...
if(defender_table)
  ...
  td.appendChild(document.createTextNode('الدفاع: '+stringInt(defender_points)));
  tr.appendChild(td);
...
if($('#attack_info_def').$('th')[1].firstChild.nodeValue != '---') // If village not empty
  ...
  var td = document.createElement('td');
  td.setAttribute('colspan','2');
  td.appendChild(document.createTextNode('الهجوم: '+stringInt(attackers_points)));
  tr.appendChild(td);
