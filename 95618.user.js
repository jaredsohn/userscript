...
// @name            Ipo1
// @namespace       
// @description     Ipovedenti - Sfondo scuro, caratteri chiari
...
function elimina() 
{
    ...
    //Elimina immagine profilo personale nel 'Scrivi un commento'
    allImg = xpath("//img[@class='uiProfilePhoto actorPic UIImageBlock_Image UIImageBlock_ICON_Image uiProfilePhotoMedium img']");
    for (var i = 0; i < allImg.snapshotLength; i++) 
    {
        thisImg = allImg.snapshotItem(i);
        if (thisImg)
    ...
    allImg = xpath("//img[@class='cmt_like_icon img']"); //icone 'Pollice su' nei commenti
    for (var i = 0; i < allImg.snapshotLength; i++) 
    {
        thisImg = allImg.snapshotItem(i);
        if (thisImg)
    ...
    var allI, thisI;
    allI = document.getElementsByTagName('I'); //-1-
    ...
    var allI, thisI;
    allI = document.getElementsByTagName('I'); //-2-
    for (var i = 0; i < allI.length; i++) 
    {
        thisI = allI[i];
//        if (thisI)
...
{
    //Colora sfondo nero in tutte le pagine
    var bodies = document.getElementsByTagName("BODY");
    for (var i = 0; i < bodies.length; i++)
        bodies[i].style.backgroundColor = "black";
}

addGlobalStyle(
'h1, h2, h3, h4, h5, h6, li, ul, span {' +
...
document.addEventListener('load', coloraSfondo, true);