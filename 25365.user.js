// ==UserScript==// @name          TwitterIgnore// @namespace     http://www.70cities.net// @description   Script to let you ignore people in your recent Tweet list without removing them from your follow list. They'll still show up in any feeds and whatnot, but your main Twitter home screen will be devoid of their guff.// @include       http://twitter.com/home*// @include       http://www.twitter.com/home*
// ==/UserScript==
//
...
function killUserTwits (username) {
	...
	allContentNodes = document.evaluate(	    "//tr[@class='hentry_hover']/td[@class='content']/strong/a[@href='http://twitter.com/"+username+"']",	    document,	    null,	    XPathResult.UNORDERED_NODE_SNAPSHOT_TYPE,	    null);
