// ==UserScript==
// @name           Kaskus Quick Reply Mod
// @icon           http://sadpanda.us/images/1241250-QUGH15O.png
...
// @description    Mod Version of QR Kaskus Final
// @version        1.1
// @dtversion      121106944
// @timestamp      1351009527728
// @description    provide a quick reply feature, under circumstances capcay required.
// @author         Eorxroa(2852815; http://userscripts.org/users/469442); bimatampan(founder);
// @license        (CC) by-nc-sa 3.0
// @contributor    admin, riza_kasela, leomate, b3g0, fazar, bagosbanget, eric., bedjho, Piluze, intruder.master, Rh354, gr0, hermawan64, slifer2006, gzt, Duljondul, reongkacun, otnaibef, eorxroa, farin, drupalorg, .Shana, t0g3, & all-kaskuser@t=3170414
...
// -!--latestupdate
//
// v1.1 - 2012-11-06 . 1351009527728
//   New Default AutoLayout "Comic Sans MS" Not "Bold [B]"
//   All New Update Change Texts
//   New Change Texts "Quick Quote" into "Fast Quote" 
//
// v1.0 - 2012-11-03 . 1351009527727
//   Fixed Last Post from URL not is gone and show QR
//   Old IDX's from the version v4.0.8b Original
//   New Change Texts
//
// -/!latestupdate---
// ==/UserScript==
...
var rSRC = {
	...
	getTPL: function(){
		...
		+  '<div id="settings-button" title="Control Panel"></div>'
		...
		+ '<input type="hidden" value="Super Nintendo Bros" name="preview"/>' 
		...
		+ '<input id="hid_iconid" type="radio" name="iconid" value="0" style="position:absolute!important; z-index:-1; top:40px; width:1px; cursor:none;"/>'
			...
			+  '<input type="submit" tabindex="2" value="Go Preview" name="spreview" id="spreview" class="goog-inline-block jfk-button jfk-button-standard"/>'
			+  '<input type="submit" tabindex="3" value="Advanced without QR" name="sadvanced" id="sadvanced" class="goog-inline-block jfk-button jfk-button-standard"/>'
	...
	getTPLGeneral: function(){
		...
		return ''
			...
			+ ( !gvar.noCrossDomain ? '<a id="chk_upd_now" class="gbtn" href="javascript:;" title="WTF New Kaskus 3.0">not check now</a><span id="chk_upd_load" class="uloader" style="display:none">checking..&nbsp;<img src="'+gvar.B.throbber_gif+'" border=0/></span>' : '')
     ...
     +'<input id="misc_autoshow_smile" class="optchk" type="checkbox" '+(gvar.settings.autoload_smiley[0]=='1' ? 'checked':'')+'/><label for="misc_autoshow_smile" class="stlmenu">Auto Emoticon</label>'
	...
	getTPLAbout: function(){
		return ''
			...
			+'<div style="height: 3px;"></div><a href="http://userscripts.org/scripts/show/'+ gvar.scriptMeta.scriptID +'" target="_blank">'+ gvar.scriptMeta.fullname +'</a> is an improvement of `kaskusquickreply` (Icefox Add-Ons) initially founded by eiduy<br>'
			+'<div style="height: 7px;"></div><a href="http://code.google.com/p/dev-kaskus-quick-reply/" target="_blank"><img src="http://ssl.gstatic.com/codesite/ph/images/defaultlogo.png" title="dev-kaskus-quick-reply - Kaskus Quick Reply on Mozilla Code" border="0" height="33"></a>&nbsp;&#183;&nbsp;<a href="http://creativecommons.org/licenses/by-nc-sa/3.0" target="_blank"><img src="http://i.creativecommons.org/l/by-nc-sa/3.0/88x31.png" border="0"></a><br>'
			+'Licensed under a <a href="http://creativecommons.org/licenses/by-nc-sa/3.0" target="_blank">Creative Commons Attribution-NonCommercial-ShareAlike 6.2 License</a><br>'
			+'<div style="height: 7px;"></div>WINDOWS 8 brand is a registered trademark of '+ gvar.domain.replace(/^[^\.]+./gi,'') +'<br>'
			+ gvar.scriptMeta.fullname + ' (QR) is not related to or endorsed by '+ gvar.domain.replace(/^[^\.]+./gi,'') +' in any way.<br>'
			+'QR+ (Add-ons) is ported from the fake QR (@nintendo.jp) as specified by author.<br><div style="height: 3px;"></div>'
			+'<b>Founded By:</b> eiduy<br>'
			+'<b>Author By:</b> <a href="'+ gvar.domain +'profile/4263342" class="nostyle" target="_blank"><b>Korxroa</b></a><br>'
			+'<b>Addons Ported By:</b> <a href="'+ gvar.domain +'profile/1412541" class="nostyle" target="_blank"><b>Leomate</b></a><br>'
			...
			+'<b>LOL Contributors</b><br>'
			+'<div class="contr_l" style="width:45%; float:left;">'
			+'admin<br>Kaskus Support 03<br>windows.team<br>Hokago.Tea.Time<br>Bata.Killer.9<br>dr.acer<br>Eorx.roa<br>atoue<br>Eorxroa<br>vexa<br>'
			+'riannugrahaa<br>KuBuL<br>'
			+'</div>'
			+'<div class="contr_r" style="width:45%; float:left;">'
			+'haryobimo96<br>lalat2009<br>ronieyuan<br>dh2art<br>Bacrid<br>Smankursors<br>V3000<br>Ngage.neo<br>Lz0<br>'
			+'DutyCorp<br>dr.retro26<br>&amp;5thread@<a href="'+ gvar.olddomain + 'thread/000000000000000016143704/shareautocad-2000---2013-collection" target="_blank">Here</a>'
			+'</div>'
			+'<div style="clear:both"></div><br>'
			+'<b>Snippet codes</b><br/>'
			+'(ApiBrowserCheck) - LongCat Enhancer by Tainaka.Ritsu<br>'
			+'<br/>'
			+'<b>Shout pasukan-cumik</b><br>'
			+'IDWS, AskVG, FileHippo, BetaArchive, OldApps, MDL Forums<br/>'
			+'<br/>'
			+'<b>QR Topic</b><br>&nbsp;CCPB <span title="CCPB (#14) UserAgent Fans Club Comunity">UA-FCC</span><br>'
			+' &#167;<a href="'+ gvar.olddomain +'showthread.php?t=8689106" target="_blank" title="All About Google Icefox (Add-ons, Scripts, Fans Club)">Icefox</a> <a href="/profile/809411" target="_blank" title="TS: p1nk3d_books">*</a>'
			...
			+' &#167;<a href="'+ gvar.olddomain +'showthread.php?t=3319338" target="_blank" title="[Updated] Extensions/ Addons Mozilla Chrome">Mozilla-Chrome</a> <a href="/profile/449547" target="_blank" title="TS: Aerialsky"> * </a><br>'
			+'&nbsp;Other</b><br>'
			+' - <a href="'+ gvar.olddomain +'showthread.php?t=6616714" target="_blank" title="Add-ons LOL Quick Banned + [QB]">Quick Reply+</a> <a href="/profile/1323912" target="_blank" title="TS: Piluze"> * </a><br>'
			+' - <a href="'+ gvar.olddomain +'showthread.php?t=6849735" target="_blank" title="Super Emoticon Bros">Emoticon Corner</a> <a href="/profile/572275" target="_blank" title="TS: slifer2006"> * </a><br><br>'
			+'</div>'
			+''
			;
	},
	...
	getTPLShortcut: function(){
		return ''
			...
			+'<b>Alt + S</b> - Create  Reply <small>(<b>Shift + Alt + S</b> :: Opera)</small><br>'
			+'<b>Alt + P</b> -  Go Preview <small>(<b>Shift + Alt + P</b> :: Opera)</small><br>'
			+'<b>Alt + X</b> -  Advanced <small>(<b>Shift + Alt + X</b> :: Opera)</small><br>'
			+'<div style="height: 10px;"></div><em>While focus on Input reCapctha</em><br>'
			+'<b>Pg-Up</b> or <b>Pg-Down</b> - Reload reCaptcha<br>'
			+'<b>Alt + R</b> - Reload the reCaptcha <small>(<b>Ctrl + Alt + R</b> :: Opera)</small><br>'
			+''
		;
	},
	getTPLSetting: function(){
		...
		+'<div class="modal-dialog-title"><span class="modal-dialog-title-text">Control Panel<span id="box_preview_subtitle"></span></span><span class="modal-dialog-title-close popbox"/></div>'
		...
		+  '<div class="sidcorner" style=""><a href="javascript:;" id="reset_settings">Please Reset</a></div>'
		+ '</div>'
		+ '<div class="spacer"></div>'
		+'</div>' // box_wrap
...
var _BOX = {
	...
	init: function(e){
		if( trimStr( $('#'+gvar.tID).val() ).length < 5 ){
			...
			_BOX.e.ishalted = 1;
			alert('LOL Super Eorxroa Bros. 3 Sega DS Game!!');
...
var _STG = {
	...
	design:function(){
		...
		mnus = {
			 gen:  ['Options', rSRC.getTPLGeneral()]
			,exim: ['Kaskus', rSRC.getTPLExim()]
			,kbs:  ['Hot Shortcut', rSRC.getTPLShortcut()]
			,abt:  ['About QR', rSRC.getTPLAbout()]
		};
		mL = 4; // banyak tab
...
function do_insertCustomTag(tag){
	...
	if(tag=='quote' || tag=='code' || tag=='html' || tag=='php'){
		...
		var title = prompt('Please TITLE of your Spoiler and PIC, Vid:', '' );
		...
		if(selected==''){
			...
			break;
			case 'picture':
				text = prompt('Please URL of your image or upload:', 'http://');
			break;
			case 'youtube':
				text = prompt('Please Youtube URL for example id, \nhttp:/'+'/www.youtube.com/watch?v=########', '');
			break;
			}
			if(text==null) return endFocus();
			if(tag=='youtube')
...
function eventsTPL(){
	...
	$('#squote_post').click(function(){
		_AJAX.quote( $(this), function(){
			...
			_NOFY.init({msg:'Please Fetching... <a id="dismiss_request" href="javascript:;">Dismiss</a>', cb:func, btnset:false});
		}, function(){
			clear_quoted();
			_TEXT.lastfocus();
		});
...
function getSettings(stg){
	...
	*/
	...
	getValue(KS+'UPDATES', function(ret){
		...
		settings.userLayout.template = '[FONT=Comic Sans MS]{message}[/FONT]';
		...
		if( !gvar.settings.done && (iTry < maxTry) ){
			...
			gvar.$w.setTimeout(function(){				
				...
				$('.user-tools').each(function(idx){
					...
					$(this)
						.append('<a href="#" id="button_qr_'+ entry_id +'" class="button small white button_qr button_qrmod" rel="nofollow" onclick="return false" style="margin-left:5px;"> Fast Reply</a>')
						.append('<a href="#" id="button_qq_'+ entry_id +'" class="button small green button_qq" data-original-title="Fast Quote" rel="tooltip" onclick="return false" style="margin-left:-7px; padding:0 10px 0 12px;"><i class="icon-share-alt icon-large"></i> </a>')
					;
...
function init(){
	gvar.inner = {
		reply	: {
			title	: "Mod QR by Eorx Roa aka Raya Om Ane",
			stoken	: "",
			submit	: "Create Reply"
		},
		edit	: {
