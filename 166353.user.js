...
<input type=\"checkbox\" id=\"autoheal\" "+hchecked+" /> Auto Heal when health is below <input type=\"text\" style=\"border: 1px solid white; width: 4em; color: #FADD34; background: black; text-align: center;\" id=\"healthlimit\" value=\""+healthLimit+"\" /> and check every <input type=\"text\" style=\"border: 1px solid white; width: 4em; color: #FADD34; background: black; text-align: center;\" id=\"healthtimer\" value=\""+healthTimer+"\" /> minutes<br>\
Auto Bounty player <input type=\"text\" style=\"border: 1px solid white; width: 4em; color: #FADD34; background: black; text-align: center;\" id=\"autolistNum\" value=\""+autolistNum+"\" /> times for <input type=\"text\" style=\"border: 1px solid white; width: 4em; color: #FADD34; background: black; text-align: center;\" id=\"amount\" value=\""+amount+"\" /> bounty<br>\
    \
...
if (autoheal)
{
	...
	if (page != 'hospital')
	{
		var cp = "http://kl.storm8.com/"+page+".php";
	...
	if (parseInt(document.getElementById('healthCurrent').innerHTML) < healthLimit)
	{
		...
		if (page != "hospital")
			document.location = "http://kl.storm8.com/hospital.php";
		else
		{
