...
//
// ==UserScript==
// @name           Premium bar for Tribal Wars/hu
...
window.createQuickbarShortcuts = function() {
	"<tr>   " + 
	newShortcut("http://ro5.triburile.ro/graphic/buildings/main.png", "/game.php?village="+VillId+"&screen=main", "Főhadiszállás");
	newShortcut("http://ro5.triburile.ro/graphic/buildings/barracks.png", "/game.php?village=+VillId+&screen=barracks", "Barakk");
	newShortcut("http://ro5.triburile.ro/graphic/buildings/stable.png", "/game.php?village="+VillId+"&screen=stable", "Istálló");
	newShortcut("http://ro5.triburile.ro/graphic/buildings/garage.png", "/game.php?village="+VillId+"&screen=garage", "Műhely");
	
newShortcut("http://ro5.triburile.ro/graphic/buildings/snob.png", "/game.php?village="+VillId+"&screen=snob", "Akadémia");
	newShortcut("http://ro5.triburile.ro/graphic/buildings/smith.png", "/game.php?village="+VillId+"&screen=smith", "Kovácsműhely");
	newShortcut("http://ro5.triburile.ro/graphic/buildings/place.png", "/game.php?village="+VillId+"&screen=place", "Gyülekezőhely");
	
newShortcut("http://ro5.triburile.ro/graphic/buildings/market.png", "/game.php?village="+VillId+"&screen=market", "Piac")	
tableIdIndex++;
	trIdIndex++;
}