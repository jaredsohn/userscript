...
// @namespace 	P4
// @author		Gboz
// @description	Ika-Core para Leviatan
...
switch (location.host) {
	default:
		...
		//chaturl='.';
		chaturl='.';
		forumurl='http://leviatan.forosactivos.com/';
		//forumurl='http://cor-atle.highbb.com/';
		forumurlnew='http://leviatan.forosactivos.com/search.forum?search_id=newposts';
