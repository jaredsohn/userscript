...
// @name           A.L.
// @namespace      GLB
// @description    Add a Admin Link beneath user name in forum threads
...
for (var i = 0; i < users.length; i++) {
	...
	thisUser.innerHTML = thisUser.innerHTML + '<br><a href="http://goallineblitz.com/game/user_admin.pl?user_id=' + uid + '">User Admin</a>';
}
