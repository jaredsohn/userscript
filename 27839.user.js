/*
	FriendFeed Techmeme
	with compliments from The Inquisitr http://www.inquisitr.com
	code modified from http://ffapps.com/tabs/
*/

// ==UserScript==
// @name           FriendFeed Techmeme
// @namespace      http://www.inquisitr.com
// @description    Add Techmeme in a tab on FriendFeed 
...
(function() {
  ...
  autoUpdateFromUserscriptsDotOrg({
    name: 'FriendFeed Techmeme',
		url: 'http://userscripts.org/scripts/source/27839.user.js',
		version: ffrb_version,
	});

  function techmeme_setup() {
		$('.settings').find('.l_tab:last').after('<td class="l_tab" style="padding-left: 10px;" id="tdtabtm"><div class="rounded bb" id="tabtm"><div class="t"><div class="l"><div class="r"><div class="tl"><div class="tr"><div class="body"><a id="tab-link-techmeme" href="#"><img src="http://www.techmeme.com/favicon.ico"></a></div></div></div></div></div></div></div></td>');
