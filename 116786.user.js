...
// @run-at		document-end
// @nocompat
// @name           AntiGame Classic Mode for 2.3.x
// @namespace      antikiller
// @description    A couple of Neogame functions for Ogame Redesign - v1.29.8 fix 2.3.0 
// @version	1.29.67
...
// @grant GM_log
// @updateURL   http://userscripts.org/scripts/source/116786.meta.js
// @downloadURL	https://userscripts.org/scripts/source/116786.user.js
// @run-at		document-end
// Fix for  2.3.x from bontchev: http://board.ogame.ru/board494-ogame-ru-%D0%B8%D0%B3%D1%80%D0%B0/board248-%D0%BA%D0%BE%D0%BC%D0%BF%D1%8C%D1%8E%D1%82%D0%B5%D1%80%D0%BD%D0%BE%D0%B5-%D0%B4%D0%B5%D0%BF%D0%BE/board249-%D0%BF%D1%80%D0%BE%D0%B3%D1%80%D0%B0%D0%BC%D0%BC%D1%8B-%D0%B4%D0%BB%D1%8F-%D0%BE%D0%B3%D0%B5%D0%B9%D0%BC/p2097125-antigame-%D0%B4%D0%BB%D1%8F-%D1%80%D0%B5%D0%B4%D0%B8%D0%B7%D0%B0%D0%B9%D0%BD%D0%B0/#post2097125
// Use external lang script from bontchev http://userscripts.org/scripts/show/122450
// @include        http://*
// ==/UserScript==
...
23.12.2012 1.29.58
Show remainder fleet
Sets the target of the fleet to a planet, if no mission is selected
Fixes the planet selection dropdown menu on the 2nd fleet dispatch page
Fnx, vess

15.12.2012 1.29.55
Partially compatibility with ogame ver 5.2

09.12.2012 1.29.54
Partially compatibility with ogame ver 5.2

27.11.2012 1.29.53
closable -> hiding itself tooltips in galaxy
plain list for speed
disable show moon&debris size in mobile-view
divided show capacity&speed for ships

25.11.2012 1.29.52
Fix showBuildingNames
Add opt_msg_collapseAllSpyReport: 'Collapse all spy reports',

24.10.2012 1.29.50
Fix resources

23.10.2012 1.29.49
Fix missing energy for research and construction

23.10.2012 1.29.48
Fix 'Always minimize planet image' 

23.10.2012 1.29.47
Expanded panel of resource for ogame ver 5.x

18.09.2012 1.29.4b
Partially compatibility with ogame ver 5.x

20.07.2012 1.29.39
Cosmetic changes

03.07.2012 1.29.38
Active moon in planet list are marked with orange text and border color
Return insertRule

07.06.2012 1.29.37
Improved compatibility with ogame ver4.1, thanks bontchev

26.04.2012 1.29.36
plain list coordinates on jumpgate page fix
add autoclose allyData on alliance page, thanks bontchev
Auto-copy coordinates glitch fix 

25.04.2012 1.29.35
Improved compatibility with ogame ver4.02

10.04.2012 1.29.33
fix percent of loot for starlord

27.03.2012 1.29.32
Change refresh function for eventlist, thanks bontchev
Improved compatibility JunpGate with Opera

22.03.2012 1.29.31
Minor fixes, thanks bontchev
fix scroll time to the next event in the window title

12.03.2012 1.29.30
improve the look of the darkmatter in resources box

11.03.2012 1.29.29
add darkmatter in resources box
fix percent of loot
bontchev's fix for showPlanetConstruction 
add OSimulate www.osimulate.com

12.02.2012 1.29.28
Minor fixes, thanks bontchev
Link for hide mess of incompatible. Mess return after upload new ver ogame.

09.02.2012 1.29.27
Link for hide mess of incompatible. Mess return after restart browser.

07.02.2012 1.29.25
Improved galaxy-view, thanks bontchev
Improved calculate plunder

02.02.2012 1.29.24
Fixes in galaxy-view for 3.1.2 ver

02.02.2012 1.29.23
Minor fixes

14.01.2012 1.29.21
Standard (SI) multiples for debris 

14.01.2012 1.29.20
Minor fixes

13.01.2012 1.29.18
show only the numbers of the moon-sized
new jumpgate. thanks bontchev
CSS fix. thanks Francolino 

11.01.2012 1.29.17
showmoon fix. thanks bontchev

09.01.2012 1.29.16
Improved compatibility with Opera

05.01.2012 1.29.15
select limit expopoint
...
22.12.2011 1.29.12
fix the time of building fleet, construction, research
fix of links to statistics in galaxyview

21.12.2011 1.29.11
fix for 3.x.x

20.12.2011 1.29.10
true addresses of pictures
check versions

23.11.2011 f1.29.9
updated to work with ogame 2.3.x
locked setting the interface language
bontchev fixes
...
var AntigameFunc = function()
{
	...
	AntiGame_lang.InterfaceEN =
	{
		...
		opt_galaxy_hidingTips: 'Hiding itself tooltips',
		...
		opt_msg_collapseAllSpyReport: 'Collapse all spy reports',
		...
		opt_fleet_showCapacity: 'Show ships capacity',
		opt_fleet_showShipsSpeed: 'Show ships speed',
		opt_fleet_showShipsDelta: 'Show remainder fleet ',
		opt_fleet1_showResCalc: 'Show resource calculator',
		opt_fleet_Set_Target: 'Sets the target of the fleet to a planet, if no mission is selected',
		...
		opt_fleet2_expandLists: 'Expand drop-down boxes (Shortcuts, ACSs)',
		opt_fleet2_expandSpeed: 'Plain list for Speed drop-down box',
	...
	AntiGame_lang.InterfaceRU =
	{
		...
		opt_galaxyDebrisMul: 'Стандартные (СИ) множители для ПО',
		...
		opt_galaxy_hidingTips: '"Прячущиеся" тултипы',
		...
		opt_msg_collapseAllSpyReport: 'Свернуть все шпионские доклады',
		...
		opt_fleet_showCapacity: 'Показывать вместимость кораблей',
		opt_fleet_showShipsSpeed: 'Показывать скорость кораблей',
		opt_fleet_showShipsDelta: 'Показывать остаток флота',
		opt_fleet1_showResCalc: 'Показывать калькулятор ресурсов',
		opt_fleet_Set_Target: 'Установить тип цели флота - планета, если миссия не выбрана',
		opt_uni_maxPlayerScore: 'У самого сильного игрока очков',
		...
		opt_fleet2_expandSpeed: 'Плоский список для скорости',
	...
	var Options =
	{
		...
		fleet_showShipsSpeed: true,
		fleet_showShipsDelta: true,
		fleet_Set_Target: false,
		fleet1_showResCalc: true,
		uni_maxPlayerScore: 0, 
		...
		msg_collapseAllSpyReport: false,
		msg_showPlunder: true,
		msg_fixColors: true,
		msg_addButtons: true,
		msg_killTips: false,
		msg_addSimButton: 1, // 0 - no, 1 - WebSim, 2 - DragoSim, 3 - OsiSim
		...
		uni_options: 
		{
			...
			uni_SpeedFactor:1, uni_DFPercent:1, uni_DefenseToDF:1, uni_maxPlayerScore:1, galaxyDebrisMul: 1
		},
			...
			try {
				...
				for (var i=0; i<str.length; i++) {
					...
					switch (typeof(param))
					{
						...
						case('boolean'): Options[pair[0]] = (pair[1]=='true' || pair[1]=='checked' ? true: false); break;
						default:;
					}
				}
			}
		...
		insertCSSRules: function()
		{
			...
			Utils.insertCSSRule('#anti_options_window select { ' +
				...
				if (save) {
					...
					for (var i=0; i<inputs.length; i++) {
						...
						if (typeof(param) == 'boolean')
							Options[id] = item.prop('checked');
							// Options[id] = item.attr('checked');

						else if ( (typeof(param) == 'string' || typeof(param) == 'number') ) {
							Options.setOptionWithValidation(id, item.prop('value'))
		...
		showWindow: function()
		{
			try {
				...
				for (var i=0; i<inputs.length; i++) {
					...
					var param = Options[item.prop('id')];
					
					if (typeof(param) == 'boolean' && param)
						item.prop('checked', param);
						// item.attr('checked', param);

					else if ( (typeof(param) == 'string' || typeof(param) == 'number') )
						item.prop('value', param);
		...
		createWindow: function()
		{
			...
			div.innerHTML =
				...
				startSection(Options.Interface.lbl_sectionMessages) +
					...
					createInput('msg_collapseAllSpyReport') +
				...
				startSection(Options.Interface.lbl_sectionFleetDispatch) +
					...
					createInput('fleet_showShipsSpeed') +
					createInput('fleet_showShipsDelta') +
					createInput('fleet1_showResCalc') +
					createInput('fleet_Set_Target') +
					createSelect('uni_maxPlayerScore',[{value:0, text:'< 10k'}, {value:1, text:'< 100k'}, {value:2, text:'< 1kk'}, {value:3, text:'< 5kk'}, {value:4, text:'> 5kk'}], Options.Interface.opt_uni_maxPlayerScore) +
					...
					createInput('fleet2_expandSpeed') +
				...
				'<div id="control">' + 
					...
					createButtonHref('btnHomePage','http://userscripts.org/scripts/show/116786', 'Home page')
		...
		ver2num: function (ver)
		{
			...
			var sv = ver.split('.');
			var s = 0;
			for(var i in sv) s = s*100+parseInt(sv[i],10);
			i = 4 - i;
			if (isNaN(s)) s = -1;
			if( (s > 0) && (i > 0))	s = s * Math.pow(100, i);
			return s;
		},
		...
		showUpdateMarker: function()
		{
			...
			marker.setAttribute('href','http://userscripts.org/scripts/source/116786.user.js');
		...
		handleUpdateResponse: function(response)
		{
			try {
				if(response.readyState == 4) {
					var newversion = response.responseText.match(/@version.(\d+(\.\d+)*)/i)[1];
			...
			} catch (e) { Utils.log("handleUpdateResponse: "+e) }
		},		
		checkUpdate: function()
		{
			...
			if ( now-last < 1000*60*60*4 ) 
				...
				var url = 'http://userscripts.org/scripts/source/116786.meta.js';
	...
	var DateTime = 
	{
		...
		getTimeDelta: function()
		{
			...
			var now = new Date();
			// timezone correction
			if(Options.ver2num(versogame.content) < 500000000) {
				...
				this.InitialServerTime = Utils.unsafeWindow.serverTime.getTime();
				this.TimeZoneDelta = - (Utils.unsafeWindow.localTime.getTime() - Utils.unsafeWindow.startServerTime);
				this.TimeDelta =  Utils.unsafeWindow.timeDiff;
			}
		...
		{
			var date = new Date();
			date.setTime(this.InitialServerTime + parseInt(tick)*1000+this.TimeZoneDelta, 10);
			return date;
		},
		...
		showPageStartTime: function()
		{
			...
			if (!clock) clock = document.getElementsByClassName('OGameClock')[0];
			if (!clock) return;
			var div = document.createElement('div');
			div.id = 'StartTime';
		...
		Init: function()
		{
			...
			if (Utils.ogameVersion=='1.2.1') { // ogame 1.2.1
				...
				{
					var code = 'window.timerHandler.appendCallback(function () {\
        localTime = new Date();\
        serverTime = new Date(localTime.valueOf() + timeDiff);\
        $(".OGameClock").html(old_getFormatedDate(serverTime.getTime(), "[d].[m].[Y] <span>[H]:[i]:[s]</span>"))\
    })';
					Utils.runScript(code);
				}
					// this.changeOgameClocks2Server();
	...
	var Utils =
	{
		...
		xmlhttpRequest: ((typeof GM_xmlhttpRequest) != "undefined" ? GM_xmlhttpRequest : XMLHttpRequest),
		...
		{
			Utils.CSS=document.createElement("style");
			Utils.CSS.type="text/css";
			Utils.CSS.media="screen";
			document.documentElement.firstChild.appendChild(Utils.CSS);
			Utils.CSS=(Utils.CSS.sheet?Utils.CSS.sheet:Utils.CSS.styleSheet);
		},
		...
		getDocScript: function()
		{
			...
			if (Utils.isFrame) var scripts = parent.document.getElementsByTagName('script')
			else var scripts = document.getElementsByTagName('script'); 
		
			for (var i=0; i < scripts.length; i++) {
			
				if (! scripts[i].src) {
					var code = (Utils.isOpera) ? scripts[i].innerText : scripts[i].innerHTML;
					if (code && (code.indexOf('session') > -1)) {
		...
		initUni: function()
		{
			...
			else if (server.indexOf('CZ.OGAME') > -1)  this.server = 'CZ'; // Czech Republic
			else if (server.indexOf('OGAME.DE/') > -1)  this.server = 'DE'; // Germany
			else if (server.indexOf('DE.OGAME') > -1)  this.server = 'DE'; // Germany
			else if (server.indexOf('OGAME.DK/') > -1)  this.server = 'DK'; // Denmark
			else if (server.indexOf('DK.OGAME') > -1)  this.server = 'DK'; // Denmark
			else if (server.indexOf('OGAME.COM.ES/') > -1)  this.server = 'ES'; // Spain
			else if (server.indexOf('ES.OGAME') > -1)  this.server = 'ES'; // Spain
			else if (server.indexOf('FI.OGAME.ORG/') > -1)  this.server = 'FI'; // Finnland
			else if (server.indexOf('FI.OGAME') > -1)  this.server = 'FI'; // Finnland
			else if (server.indexOf('OGAME.FR/') > -1)  this.server = 'FR'; // France
			else if (server.indexOf('FR.OGAME') > -1)  this.server = 'FR'; // France
			else if (server.indexOf('OGAME.GR/') > -1)  this.server = 'GR'; // Greece
			else if (server.indexOf('GR.OGAME') > -1)  this.server = 'GR'; // Greece
			else if (server.indexOf('OGAME.COM.HR/') > -1)  this.server = 'HR'; // Croatia
			else if (server.indexOf('HR.OGAME') > -1)  this.server = 'HR'; // Croatia
			else if (server.indexOf('OGAME.HU/') > -1)  this.server = 'HU'; // Hungary
			else if (server.indexOf('HU.OGAME') > -1)  this.server = 'HU'; // Hungary
			else if (server.indexOf('OGAME.IT/') > -1)  this.server = 'IT'; // Italy
			else if (server.indexOf('IT.OGAME') > -1)  this.server = 'IT'; // Italy
			else if (server.indexOf('OGAME.JP/') > -1)  this.server = 'JP'; // Japan
			else if (server.indexOf('JP.OGAME') > -1)  this.server = 'JP'; // Japan
			...
			else if (server.indexOf('MX.OGAME') > -1)  this.server = 'MX'; // Mexico
			else if (server.indexOf('OGAME.NL/') > -1)  this.server = 'NL'; // Netherlands
			else if (server.indexOf('NL.OGAME') > -1)  this.server = 'NL'; // Netherlands
			else if (server.indexOf('OGAME.NO/') > -1)  this.server = 'NO'; // Norway
			else if (server.indexOf('NO.OGAME') > -1)  this.server = 'NO'; // Norway
			else if (server.indexOf('OGAME.PL/') > -1)  this.server = 'PL'; // Poland
			else if (server.indexOf('PL.OGAME') > -1)  this.server = 'PL'; // Poland
			else if (server.indexOf('OGAME.COM.PT/') > -1)  this.server = 'PT'; // Portugal
			else if (server.indexOf('PT.OGAME') > -1)  this.server = 'PT'; // Portugal
			else if (server.indexOf('OGAME.RO/') > -1)  this.server = 'RO'; // Romania
			else if (server.indexOf('RO.OGAME') > -1)  this.server = 'RO'; // Romania
			else if (server.indexOf('OGAME.RU/') > -1)  this.server = 'RU'; // Russia
			else if (server.indexOf('RU.OGAME') > -1)  this.server = 'RU'; // Russia
			else if (server.indexOf('OGAME.SE/') > -1)  this.server = 'SE'; // Sweden
			else if (server.indexOf('SE.OGAME') > -1)  this.server = 'SE'; // Sweden
			else if (server.indexOf('OGAME.SI/') > -1)  this.server = 'SI'; // Slovenia
			else if (server.indexOf('SI.OGAME') > -1)  this.server = 'SI'; // Slovenia
			else if (server.indexOf('OGAME.SK/') > -1)  this.server = 'SK'; // Slovakia
			else if (server.indexOf('SK.OGAME') > -1)  this.server = 'SK'; // Slovakia
			else if (server.indexOf('OGAME.COM.TR/') > -1)  this.server = 'TR'; // Turkey
			else if (server.indexOf('TR.OGAME') > -1)  this.server = 'TR'; // Turkey
			else if (server.indexOf('OGAME.TW/') > -1)  this.server = 'TW'; // Taiwan
			else if (server.indexOf('TW.OGAME') > -1)  this.server = 'TW'; // Taiwan
			else if (server.indexOf('OGAME.US/') > -1 ) this.server = 'US'; // USA
			else if (server.indexOf('US.OGAME') > -1 ) this.server = 'US'; // USA
			else if (server.indexOf('OGAME.ORG/') > -1) this.server = 'ORG'; // UK
			else if (server.indexOf('EN.OGAME') > -1) this.server = 'ORG'; // UK
		...
		Init: function()
		{
			...
			this.isMoon = false;
			if(this.ogame) this.isMoon = (document.getElementsByName('ogame-planet-type').item(0).content.indexOf('moon') > -1 ) ? true : false;
	...
	var Ogame =
	{
		...
		readTechs: function()
		{
			try {
				...
				Utils.$('#buttonz a.detail_button').each(
					function() {
						var tech_lev = Utils.parseInt(Utils.$(this).find('.level').get(0).lastChild.nodeValue);
						if(!tech_lev)
							tech_lev = Utils.parseInt(Utils.$(this).find('.level').get(0).innerHTML.replace(/\D/g, ''));
						Ogame.techs[this.getAttribute('ref')] = tech_lev;
					} );
		...
		{	
			try {
				...
				if (nodes.snapshotLength < 1)
					nodes = Utils.XPath ('//A[contains(@class,"planetlink")][@title]', window.parent.document.body);
				...
				if (nodes.snapshotLength == 1)
					...
					for (var i=0; i<nodes.snapshotLength; i++) 
					{
						if(Options.ver2num(versogame.content) < 500000000)
						{
							...
							if ( (nodes.snapshotItem(i).childNodes[3].className.indexOf('active') > -1) || (nodes.snapshotItem(i).className.indexOf('active') > -1) ) {
								this.active_planet = nodes.snapshotItem(i);
								break;
							}
						}
		...
		getCoordsFromPlanet: function(planet)
		{
			...
			var name = Utils.XPathSingle((Options.ver2num(versogame.content) < 500000000) ? 'SPAN[@class="planet-name"]' : 'SPAN[contains(@class,"planet-name")]', planet).innerHTML;
			var coords = Utils.XPathSingle((Options.ver2num(versogame.content) < 500000000) ? 'SPAN[@class="planet-koords"]' : 'SPAN[contains(@class,"planet-koords")]', planet).innerHTML;
...
function checkOfficer(i) {
	return officers.get (i).parentNode.className.indexOf (" on") >= 0;
		...
		Init: function()
		{
			...
			this.createShip(202, 'SCargo',		2000,	2000,	1, 5000,	5000,	20,	20);
			this.createShip(203, 'LCargo',		6000,	6000,	1, 7500,	25000,	50,	60);
			this.createShip(204, 'LFighter',	3000,	1000,	1, 12500,	50,		0,	20);
			this.createShip(205, 'HFighter',	6000,	4000,	2, 10000,	100,	0,	50);
			this.createShip(206, 'Cruiser',		20000,	7000,	2, 15000,	800,	0,	135);
			this.createShip(207, 'Battleship',	45000,	15000,	3, 10000,	1500,	0,	300);
			this.createShip(208, 'Colonizator',	10000,	20000,	2, 2500,	7500,	0,	150);
			this.createShip(209, 'Recycler',	10000,	6000,	1, 2000,	20000,	300, 80);
			this.createShip(210, 'Spy',			0,		1000,	1, 100000000, 0,	0,	5);
			this.createShip(211, 'Bomber',		50000,	25000,	2, 4000,	500,	0,	375);
			this.createShip(213, 'Destroyer',	60000,	50000,	3, 5000,	2000,	0,	550);
			this.createShip(214, 'RIP',			5000000,4000000,3, 100,		1000000,0,	45000);
			this.createShip(215, 'BCruiser',	30000,	40000,	3, 10000,	750,	0,	350);
	...
	var Colorer = 
	{
		...
		highlight: function(who, xpath, context, parser)
		{
			try {
				...
				if (color) node.setAttribute ('style', 'color:' + color + ' !important;');
			} catch(e) { Utils.log(e) }
		},
	...
	var EventList =
	{
		...
		getMissionClass: function (row)
		{
			...
			else
			{
				...
				mclass = "owntransport";
				if(mission.indexOf (Options.Labels.lbl_missAttack) != -1) mclass = "ownattack"
					else if(mission.indexOf (Options.Labels.lbl_missHold) != -1) mclass = "ownhold"
						else if(mission.indexOf (Options.Labels.lbl_missColony) != -1) mclass = "owncolony"
							else if(mission.indexOf (Options.Labels.lbl_missDeploy) != -1) mclass = "owndeploy"
								else if(mission.indexOf (Options.Labels.lbl_missHarvest) != -1) mclass = "ownharvest"
									else if(mission.indexOf (Options.Labels.lbl_missTransport) != -1) mclass = "owntransport"
										else if(mission.indexOf (Options.Labels.lbl_missFederation) != -1) mclass = "ownfederation"
											else if(mission.indexOf (Options.Labels.lbl_missDestroy) != -1) mclass = "owndestroy"
												else if(mission.indexOf (Options.Labels.lbl_missEspionage) != -1) mclass = "ownespionage"
													else if(mission.indexOf (Options.Labels.lbl_missExpedition) != -1) mclass = "ownexpedition";
			}
			return mclass;
		},
		...
		{
			if(!e || !e.target || e.target.id != 'cluetip-close') return;
		...
		showEventList: function ()
		{
			try {
				...
				var div = document.createElement('div');
				div.id = 'newEventBox';
				div.innerHTML = '<iframe id="iframeEventBox" src="index.php?page=eventList&pro=1'+	((Options.ver2num(versogame.content) < 300000000) ? '&session='+ Utils.session: '') +'"></iframe>';
	...
	var EventList2 =
	{
		...
		insertCSSRules: function()
		{
			...
			{
				Utils.insertCSSRule('.reverse td { opacity: 0.3; }');
				Utils.insertCSSRule('.reverse + .antigame_evtDetails2 td { opacity: 0.5; }');
			}
		...
		{
			var $ = Utils.$;
			if ($ ('#eventListWrap h4 .refresh_details').length)
				return;
			$ ('#eventListWrap h4')
				.prepend ('<img src="/cdn/img/icons/refresh.gif" style="vertical-align: middle;">&nbsp;&nbsp;')
				.wrapInner ('<a href="javascript:void(0);" class="refresh_details" style="text-decoration: none; color: #F1F1F1;" \>');
			$ ('#eventListWrap h4 .refresh_details').click (function ()
			{
				if(Options.ver2num(versogame.content) < 500000000) {
					Utils.runScript (
						"$.get ('/game/index.php?page=eventList&ajax=1', function (response) \
						{ \
		...
		{
			Utils.runScript('$("<div>").prop("id","initEventList_text").html($("#initEventlist", window).toString()).css("display","none").appendTo("body");');
		...
		Show: function(eventListWrap)
		{
			...
			for (var i=0; i<rows.snapshotLength; i++) {
				...
				{
					var url = Utils.getElementByClassName((Options.ver2num(versogame.content) < 500000000) ? 'tipsTitleArrowClose' : 'tooltipClose', row);
					...
					if (url) 
					{
						...
						EventList2.showFleetDetails(row, row.querySelector (".icon_movement span, .icon_movement_reserve span").title);
				}
		...
		Run: function()
		{
			...
			if (eventListWrap) EventList2.Show(eventListWrap);

			var eventboxContent = document.getElementById('eventboxContent');

			try {
				if (Utils.isOpera || eventboxContent) eventboxContent.addEventListener('DOMNodeInserted', EventList2.onDOMNodeInserted, false);
			}
			catch(e) { Utils.log(e); }	
		}
	};
	...
	var FinishTime = 
	{
		...
		ShowConstructions: function ()
		{
			...
			if (str) {
				...
				FinishTime.addConstructionTime((document.getElementById ('shipAllCountdown')) ? 'shipAllCountdown' : 'shipAllCountdown7', str[2]);
			}
		}
	};
	...
	var FleetMovement = 
	{
		...
		updateReversalClock: function()
		{
			try {
				...
				for (var i=0; i<spans.snapshotLength; i++)
				{
					...
					date.setTime( (date.getTime() - ((Options.ver2num(versogame.content) < 500000000) ? DateTime.TimeDelta : 0)) * 2 - start );
		...
		myOpenCloseFleet: function (id, change)
		{
			...
			if ( change && !opened ) {
				...
				var dif = details_height - span_height + 7;
		...
		showTargetName: function(fleet)
		{
			try {
				...
				if(parseInt(versogame.content.split('.')[0],10) < 5) name = name.title.slice(1); else name = name.title;
		...
		Run: function()
		{
			...
			if (Options.mvmt_showReversal)
				setInterval(FleetMovement.updateReversalClock, 400);
		}
	};
	...
	var Calculator =
	{
		...
		show: function(parent)
		{
			...
			function addResInput(res) {
				return '<td><input type="text" id="calc_'+res+'" value="0" style="position:static; text-align:right!important"></td>';
			}
	...
	var FleetSend = 
	{
		Capacity_insertCSSRules: function()
		{
			...
			//bontchev
			Utils.insertCSSRule('#calc_sl { visibility: visible !important; color: #848484 !important; height: 20px !important;}');
			Utils.insertCSSRule('#calc_coords input { height: 15px !important; }');
			...
			try {
				...
				for ( var i=0; i<txtFields.snapshotLength; i++ ) {
					...
					if (!isNaN(txt.value) && txt.value>0) {
						shipcount = parseInt(Utils.$('span.level', txt.parentNode)[0].childNodes[1].textContent.replace(/\D+/g, '')) - txt.value;
						if(shipcount == 0) shipcount = '';
					} else
						shipcount = '';
						
					Utils.$('div.count', txt.parentNode)[0].textContent = shipcount;
				}
		...
		showCapacity: function (node)
		{
			try {
				...
				var expLimit = [200, 2500, 6000, 9000, 12000];
				var upperLimit = expLimit[Options.uni_maxPlayerScore];
			...
			try {
				...
				if(Options.fleet1_showResCalc)
					if(allornone = document.getElementById('allornone'))
						setTimeout (function () { Calculator.show(allornone); }, 0);
						// Calculator.show(allornone);

				this.Capacity_insertCSSRules();

				if (Options.fleet_showShipsSpeed) {
					Utils.$('form li')
						.filter( function() {return !isNaN(this.id.replace('button','')) } )
						.each( function(){FleetSend.addSpeed(this)});
				}

				if (Options.fleet_showShipsDelta) {
					Utils.$('form li')
						.filter( function() {return !isNaN(this.id.replace('button','')) } )
						.each( function(){FleetSend.addCount(this)});
						unsafe.old_checkShips0 = unsafe.checkShips;
						unsafe.checkShips = function(form) { FleetSend.showCount(); unsafe.old_checkShips0(form) }
						Utils.$('input.fleetValues').bind('focus', function(){ FleetSend.showCount() } );
				}
				
				if (Options.fleet_Set_Target) {
		...
		expandSpeed: function()
		{
			...
			$("<li>")\
				...
				.html(\'' + html + '\')\
				.find("a")\
					.bind("click", function(){ $("#speed").prop("value",this.getAttribute("rel")); updateVariables(); $ ("span.speed a").prop ("data-value", $(this).prop("rel")).text ($(this).prop("rel") + "0"); })\
				.end()\
		...
		fleet2_insertCSSRules: function()
		{
			...
			if (Options.fleet2_expandLists) {
				Utils.insertCSSRule('#slPanel { \
					padding: 5px; \
					margin: 2px 0 0 5px;\
					background-image: '+'url("'+wrap_body+'"); \
					width: 642px;\
				}');
				...
				Utils.insertCSSRule('#slPanel a { color: #AAAAAA; }');
				Utils.insertCSSRule('#speed_plain a { color: #AAAAAA; font-size: 13px;}');
		...
		Fleet2_Run: function()
		{
			...
			if (Options.fleet2_expandSpeed) {
				this.expandSpeed();
			}
			Utils.$ ("#fleet2 .glow select option").removeAttr ("selected");
			Utils.$ ("#fleet2 .glow select option").eq (0).prop ("selected", "selected");
			Utils.$ ("#fleet2 .glow .currentlySelected a").text ("-");
		...
		setResources: function()
		{
			...
			Utils.runScript("setTimeout(function(){checkRessourceByType('metal');checkRessourceByType('crystal');checkRessourceByType('deuterium');updateVariables();},0)");
		},
	...
	var Galaxy =
	{
		...
		mul: function(txt)
		{
			...
			var sv = Math.pow(1000,sb).toFixed(2);
		...
		showDebris: function (row)
		{
			try {
				...
				if (Options.ver2num(versogame.content) < 500000000) {
					...
					if(debris.childNodes.length > 3) {
						link = debris.childNodes[3];
					}
				}
				if(!link || Utils.unsafeWindow.isMobile) return;
				...
				for ( var i=0; i<content.snapshotLength; i++) {
					...
					resources[i] = Options.galaxyDebrisMul ? this.mul(res) : res;
					res = res.replace(/\./g, '');
		...
		showMoon: function (row)
		{
			...
			if (Options.galaxyHideMoon && !Utils.unsafeWindow.isMobile) {
				// Utils.$ (row).find ('.moon '+((Options.ver2num(versogame.content) < 500000000) ? '.tipsGalaxy' : '.tooltipRel')+' img').hide ().parent ().append (Utils.$ ('<div>' + Options.Interface.lbl_Moon + (size.length ? ": " + Utils.$ (size).text ().split (" ") [0] : "") + '</div>'));				Utils.$ (row).find ('span#moonsize').hide ();
				Utils.$ (row).find ('td.moon a img').hide ().parent ().append (Utils.$ ('<div>' + Options.Interface.lbl_Moon + (size.length ? ": " + Utils.$ (size).text ().split (" ") [0] : "") + '</div>'));	
		...
		showRank: function (row) 
		{
			try {
				...
				rank = parseInt(rank.innerHTML.match(/\d+</),10);
				if (!rank) rank = Utils.parseInt(rank.innerHTML)
				else rank_href = Utils.$('li.rank a', player).prop('href');
				...
				if (rank)
				{
					...
					if (Options.galaxy_killTips) {
						...
						newNode.href = (Options.ver2num(versogame.content) < 300000000) ? 'index.php?page=statistics&session='+Utils.unsafeWindow.session +'&start='+rank : rank_href;
					}
					else
		...
		showAllyRank: function (row) 
		{
			...
			rank = parseInt(rank.innerHTML.match(/\d+</),10);
			if (!rank) rank = Utils.parseInt(rank.innerHTML)
			else ally_href = Utils.$('li.rank a', ally).prop('href');
			...
			if (Options.galaxy_killTips) {
				...
				if(!(Options.ver2num(versogame.content) < 500000000)) {
					var allyKillTip = Utils.getElementByClassName('tooltipRel tooltipClose tooltipRight', ally);
					var newclass = allyKillTip.className.replace('tooltipRel tooltipClose tooltipRight ', '');
					allyKillTip.className = newclass;
				}
			}
			...
			if (str)
			{
				var newNode;
					...
					if (Options.galaxy_killTips) {
						newNode = document.createElement('a');
						newNode.href = (Options.ver2num(versogame.content) < 300000000) ? 'index.php?page=statistics&session='+Utils.unsafeWindow.session +'&who=ally&start='+rank : ally_href;
					}
					else
						newNode = document.createElement('span');
		...
		killTips: function()
		{
			...
			var initCluetip = function()
				{
				if ((Options.ver2num(versogame.content) < 500000000) && selector) 
...
//bontchev
			...
			if (document.getElementById('galaxytable') && Utils.isOpera)
				Galaxy.redrawGalaxy();

			if (Options.galaxy_hidingTips) {
				var old_getTooltipOptions = Utils.unsafeWindow.getTooltipOptions;
				Utils.unsafeWindow.getTooltipOptions = function (_value) {
					var oldTO = old_getTooltipOptions(_value);
					if(Utils.$(_value).hasClass("tooltipClose")) {
						oldTO.hideAfter = 400;
						oldTO.showDelay = 400;
						oldTO.hideOn = {element: "tooltip", event: "mouseleave"};
					}
					return oldTO
				};
			}
...
var Jumpgate =
{
	...
	insertCSSRules: function ()
	{
		...
		if (Options.fleet2_expandLists)
		{
			Utils.insertCSSRule ('#jumpgateForm select[name="zm"] { color: lime; }');
			Utils.insertCSSRule ("#fleetTemplatesEdit { padding-top: 10px !important; }");
			Utils.insertCSSRule (Utils.isOpera ? "#jumpgate div.secondcol { top:282px; }" : "#jumpgate div.secondcol { top:303px; }");
			Utils.insertCSSRule ("div#jumpgate { height:555px; }");
			Utils.insertCSSRule ("#jumpgate table#anti_jumpgate { height:70px; padding-top: 7px; }");
			Utils.insertCSSRule ("#jumpgate #anti_jumpgate td.anti { white-space:nowrap; padding: 3px 15px; vertical-align:top; font-size:11px; }");
		}
		else Utils.insertCSSRule (Utils.isOpera ? "#jumpgate div.secondcol { top:287px; }" : "#jumpgate div.secondcol { top:308px; }");
	},
	Show: function ()
	{
		if (Options.fleet2_expandLists)
		{
			var flatCoords = '<table id="anti_jumpgate" align="center"><tr>';
			var numMoons = Utils.$ ('#jumpgateForm select[name="zm"] option').length - 1;
			Utils.$ ('#jumpgateForm select[name="zm"] option').each (function (i)
			{
				flatCoords += '<td class="anti"><a href="javascript:void(0);" value="' + (N (i) + 1) + '">' + this.innerHTML + "</a></td>";
				if ((i % 4) == 3)
				{
					flatCoords += '</td>';
					if (i < numMoons)
			...
			flatCoords += "</tr></table>";
			Utils.$ ("#jumpgateForm div.fright").after (flatCoords);
			Utils.$ ("#anti_jumpgate a").bind ("click", function ()
			{
				Utils.$ ('#jumpgateForm select[name="zm"]').prop ("selectedIndex", $ (this).prop ("value"));
				var Moon = Utils.$ ('#jumpgateForm select[name="zm"] option')[N ($ (this).prop ("value"))].value;
				Utils.$ ('#jumpgateForm select[name="zm"]').prop("value",Moon); //updateVariables();
			});
		}
		Utils.$ ("#fleetTemplatesEdit table.list td:not(.tdInactive) span.quantity").each (function (i)
		{
			var fvalue = Strg (this.innerHTML.replace (/[\(\)]/g, ""));
			var nvalue = fvalue.replace (/\D/g, "");
			Utils.$ (this).html ('(<a href="javascript:void(0)">' + fvalue + "</a>)").find ("a").addClass ("quantity_link").click (function ()
			{
				Utils.$ (this).parent ().parent ().next ().find ("input").prop ("value", nvalue);
			});
			Utils.$ (this).parent ().next ().find ("img").wrap ('<a href="javascript:void(0)"></a>');
			Utils.$ (this).parent ().next ().find ("a").click (function ()
			{
				Utils.$ (this).parent ().find ("input").prop ("value", nvalue);
			});
		});
		Utils.$ ('#jumpgateForm select[name="zm"]').prepend ('<option selected="selected">&nbsp;&nbsp;</option>');
		document.getElementById("jumpgateForm").reset();
	}
};
	...
	var Names = 
	{
		...
		showBuildingNames: function()
		{
			try {
				this.insertCSSRules();
				Utils.$('.ecke .textlabel').each(function () {
					var title = this.textContent.replace (/(^\s+|\s+$)/g, "");
					if (!title) return;
			...
			try {
				...
				for (var i=0; i<cons.snapshotLength; i++) {
					...
					if (previousParent == parent) {
						...
						parent.style.height = (parent.clientHeight + previousSpanHeight + span.offsetHeight + offset)+'px';
					} else {
						parent.appendChild(span);
						parent.style.height = (parent.clientHeight + span.offsetHeight + offset)+'px';
					}
					previousParent = parent;
					previousSpanHeight = span.offsetHeight;
				}
			} catch (e) { Utils.log(e) }
		},
	...
	var SpyReport = 
	{
		...
		calculatePlunder: function(report)
		{
			...
			this.plunder_metal = this.plunder_crystal = this.plunder_deuterium = this.percent = 0;

			var cells = Utils.XPath('descendant::*[contains(@class,"fragment")]/descendant::TD', report);
			if(cells.snapshotLength < 8) return;
			...
			var target_player = report.querySelector ("table.material th.area span");
			if (target_player)
			{
		...
		showPlunder: function (report)
		{
			...
			var loot_procent = this.percent;
			SimpleTable.init(Options.Interface.lbl_resources);
			SimpleTable.addCell(Options.Interface.lbl_total, total);
			
			SimpleTable.addCell(Options.Interface.lbl_loot+' ('+loot_procent+'%)', Math.floor(this.plunder_metal+this.plunder_crystal+this.plunder_deuterium));
		...
		addSimButton: function(report)
		{
			try {
				...
				if(!attack) return;
				attack.parentNode.previousElementSibling.firstElementChild.setAttribute ("colspan", "6");
				
				attack.parentNode.insertBefore(dummy, attack);
				Utils.insertAfter(dummy.cloneNode(false), attack);

				var SimName = [' - ', 'WebSim', 'DragoSim', 'OsiSim'];
				
				var sim = attack.cloneNode(false);
				sim.innerHTML = '<a class="'+((Options.ver2num(versogame.content) < 500000000) ? 'buttonSave' : 'btn_blue')+'" href="javascript:void(0)">'+ SimName[Options.msg_addSimButton]+'</a>';
		...
		createWebSimForm: function()
		{
			...
			//coords
			var coords = document.getElementsByName('ogame-planet-coordinates').item(0).content;
			if (coords)
				this.sim_form.action += '&start_pos='+coords;
		...
		createOsiSimForm: function()
		{
			...
			this.sim_form.innerHTML = addParam('lang', Utils.server_lang.toLowerCase())
				+ addParam('debris_ratio', Options.uni_DFPercent )
				...
				+ addParam('start_pos', document.getElementsByName('ogame-planet-coordinates').item(0).content)
...
Show: function()
		{
			...
			function processReport (report)
			{
				...
				if (Options.msg_PlunderThreshold && Utils.isCurrentPage('messages') ) {
					var total_pl = SpyReport.plunder_metal + SpyReport.plunder_crystal + SpyReport.plunder_deuterium;
					var total_df = SpyReport.debris_metal + SpyReport.debris_crystal;
					if (total_pl < Options.msg_PlunderThreshold*1000 && total_df < Options.msg_DebrisThreshold*1000)
					{
						var iselement = document.getElementById( (Options.ver2num(versogame.content) < 500000000) ? report.parentNode.parentNode.id.replace('spioDetails_','')+'TR' : 'TR' + report.parentNode.parentNode.id.replace('spioDetails_',''));
						if(iselement) iselement.className += ' smallplunder';
					}
				}
			...
			$ (document).ajaxSuccess (function(e, xhr, settings)
			{
				...
				{
					if ($ (this).find ("table.spy").length > 0)
					{
						processReport (this);
					}
				});
	...
	var Messages = 
	{
		addButtons: function()
		{
			function insertButton(value, mod, title) {
				...
				if (mod==412) btn.style.color = '#00CC22';
				else if (mod==-12) btn.style.color = '#229922';
				else if (mod==407) btn.style.color = '#660011';
				else if (mod==-7) btn.style.color = '#993300';
				else if (mod==409) btn.style.color = '#990000';
		...
		onButtonClick: function()
		{
			try {
				...
				if (mod>0) {
					...
					Utils.trigger(Utils.getElementByClassName(((Options.ver2num(versogame.content) < 500000000) ? 'buttonOK' : 'btn_blue')+' deleteIt'), 'click');
				}
					...
					Utils.unsafeWindow.executeAction(delIds, -(mod-400));
				}
			} catch (e) { Utils.log(e) }
		},
		...
		{
			var $ = Utils.$;
			$ ("#mailz tr.entry td.date, .infohead table tr:last td").each (function ()
			{
				var timePart = $ (this).html ().trim ();
				if (timePart && (timePart.length > 10))
				{
					var newTime = DateTime.convertStringServer2Local (timePart, "[d].[m].[Y] [H]:[i]:[s]");
					$ (this).html (newTime);
					$ (this).prop ("original", timePart);
				}
			});
			$ ("#showSpyReportsNow table.material.spy th.area, #messagebox table.material.spy th.area").each (function ()
			{
				var title = $ (this).html ().trim ();
				if (title && title.length > 20)
				{
					var delim = title.lastIndexOf (" ", title.length - 11);
					var timePart = title.substring (delim + 1);
					if (timePart && (timePart.length < 20))
					{
						var newTime = DateTime.convertStringServer2Local (timePart, "[m]-[d] [H]:[i]:[s]");
						$ (this).html (title.substring (0, delim + 1) + newTime);
					}
				}
			});
			$ ("#battlereport p.textCenter").each (function ()
			{
				var title = $ (this).html ().trim ();
				if (title && (title.length > 20))
				{
					var delim = title.lastIndexOf ("(");
					if (delim > 20)
					{
						var timePart = title.substring (delim + 1).split (")").join ("");
						if (timePart && (timePart.length < 20))
						{
							var newTime = DateTime.convertStringServer2Local (timePart, "[d].[m].[Y] [H]:[i]:[s]");
							$ (this).html (title.substring (0, delim + 1) + newTime + ")");
		...
		Show: function()
		{
			try {
				...
				if ( Utils.isCurrentPage('messages') && Options.msg_collapseAllSpyReport) setTimeout( function() {Utils.$('tr[id^="spioDetails_"]').hide()}, 0);
		...
		insertCSSRules: function()
		{
			if ( Utils.isCurrentPage('messages') ) {
				Utils.insertCSSRule('.msgButtons input { ' +
					...
					'background:transparent url(/cdn/img/layout/formular_buttons.gif) no-repeat scroll -88px -54px;' +
					'border:0 none;' +
					'color:#0D1014;' +
					'cursor:pointer;' +
					'font-size:11px;' +
				...
				Utils.insertCSSRule('.msgButtons input:hover { ' +
					'background:transparent url(/cdn/img/layout/formular_buttons.gif) no-repeat scroll -88px -80px;' +
					'}');
	...
	var Network =
	{
		...
		Show: function() {
			...
			list = document.getElementById ("link11");
			if (list && (list.rel == "allyData") && list.className == "opened")
				Utils.trigger (list, "click");
		},
	...
	var Resources = 
	{
		res_array: ['metal', 'crystal', 'deuterium', 'energy', 'darkmatter'],
		res_array_firstcap: ['Metal', 'Crystal', 'Deuterium', 'Energy', 'Dark Matter'],
		currentRes: {}, 
		costRes: {},
		res_container: null,
		...
		{
			Utils.$('<input>')
				.prop('class',(Options.ver2num(versogame.content) < 500000000) ? 'buttonOK' : 'btn_blue')
				.prop({type:'button', value:'0%', ref:'0'})
				.click(function(){Utils.$('select').val(this.getAttribute('ref')).next().children("a").prop("data-value", $(this).prop("ref")).text($(this).prop("ref") + "%")})
				.appendTo('.factorbutton')
				.clone(true)
				.prop({value:'100%', ref:'100'})
				.appendTo('.factorbutton')
			;
		},
		...
		showMissing: function()
		{
			try{
				...
				if(Options.ver2num(versogame.content) >= 501010000) {
					var currentResources;
					var newResourcesReloader = Utils.unsafeWindow.reloadResources;
					Utils.unsafeWindow.reloadResources = function(data) {currentResources = data};
					Utils.unsafeWindow.initAjaxResourcebox();
					Utils.unsafeWindow.reloadResources = newResourcesReloader;
					
					for (var i=0; i<this.res_array.length; i++) {
						var attr = this.res_array[i];
						
						if (attr != 'energy')
							this.currentRes[attr] = currentResources[attr].resources["actual"];
						else {
							var energy = currentResources[attr].tooltip;
							energy = energy.match(/([\d\.]+)\D+([\d\.]+)\D+([\d\.]+)/);
							if (energy) 
								this.currentRes[attr] = Utils.parseInt(energy[2].replace (/\D+/g, ""));
						}
						
						if(Options.ver2num(versogame.content) >= 507000000)
						{
							this.costRes[attr] = Utils.getIntByXPath(
								'//*[@id="content"]/descendant::*[@id="costs"]/LI[contains(@title,"'+Options.Labels['lbl_'+attr]+'")]',
								'title');
						} else
						{
							this.costRes[attr] = Utils.getIntByXPath(
						...
						if (def>0) {
							...
							if (attr != 'energy') 
								...
								SimpleTable.addCell(Options.Interface.lbl_shipSatelliteAlt, Math.ceil( def / Ogame.getProduction(212,0) ));
							}
						}
					}
				} else {
		...
		showProduction: function()
		{
			try {
				...
				var energy = $('#action ul li')
					...
					.find('.time')
				;
				if(Options.ver2num(versogame.content) >= 507000000) energy = $('ul.production_info li')
					.filter( function(){return $(this).html().indexOf( Options.Labels.lbl_RequiredEnergy ) >- 1 } )
					.find('.time')
				;
				...
				var f = (id != 212 && (newvalue || isNaN(newvalue) ) );
				if(Options.ver2num(versogame.content) > 400040000) f = (id != 212 && id != 12 && id != 4 && (newvalue || isNaN(newvalue) ) );
				if (f) {
		...
		Resources_Run: function()
		{
			...
			if(Options.ver2num(versogame.content) >= 501010000) {
				...
				for (var i=0; i<this.res_array.length; i++)
				{
					...
					var current, storage, prod, name;
					name = currentResources[res].tooltip.substring(0, currentResources[res].tooltip.indexOf("|"));
					var prod_sign = '';
					var html = '<b>' + name + '</b>';
					html += '<br/>';
					if (res != 'energy' && res != 'darkmatter')
					{
						current = currentResources[res].resources["actual"];
						storage = currentResources[res].resources["max"];
						prod = Math.ceil(currentResources[res].resources["production"]*60*60);
						if(prod > 0) prod_sign = '+';
						html += '<span class="'+(Utils.isMoon ? '' : current < storage ? '' : 'overmark')+'">';
						html += '<span id="'+ticker_id+'">' + Utils.unsafeWindow.gfNumberGetHumanReadable(current, Utils.unsafeWindow.isMobile) + '</span> / ';
						html += Utils.unsafeWindow.gfNumberGetHumanReadable(storage, Utils.unsafeWindow.isMobile);
						html += '</span>';
						html += '<br/>';
						html += '<span class="'+(Utils.isMoon ? '' : prod > 0 ? 'undermark' : 'overmark')+'">(' +prod_sign+ Utils.unsafeWindow.gfNumberGetHumanReadable(prod, Utils.unsafeWindow.isMobile) + ')</span>';
						node.innerHTML = html;
						this.Resources_append(node);
						var time_to_fill = currentResources[res].resources["production"] ? Math.floor((storage - current)/currentResources[res].resources["production"]) : -1;

						if (time_to_fill>0) {
							node.innerHTML += '<br/><span class="finishtime">'+DateTime.formatDate2(DateTime.getFinishTime(time_to_fill))+'</span>';
						}
					} else {
						var res_title = currentResources[res].tooltip;
						var doc = parser.parseFromString('<div>'+res_title.replace(/<br>/gi,'<br/>')+'</div>', 'text/xml');
						current = doc.getElementsByTagName('span')[0];
						storage = doc.getElementsByTagName('span')[1];
						prod = doc.getElementsByTagName('span')[2];
						if (res == 'darkmatter')
						{
							current = doc.getElementsByTagName('span')[0];
							storage = doc.getElementsByTagName('span')[2];
							prod = doc.getElementsByTagName('span')[1];
						}
						...
						html += '<br/>';
						html += (res == 'darkmatter' ? '( <font color="#FFD700"><b>' + consumed + '</b></font> + ' : '(' + consumed + '/ ') + total + ')</span>';
						node.innerHTML = html;
						this.Resources_append(node);
					}
				}
				anti_resourceTickerMetal = {
					available: currentResources.metal.resources["actual"],
					limit: currentResources.metal.resources["max"],
					production: currentResources.metal.resources["production"],
					valueElem: "antires_metal"
				};
				anti_resourceTickerCrystal = {
					available: currentResources.crystal.resources["actual"],
					limit: currentResources.crystal.resources["max"],
					production: currentResources.crystal.resources["production"],
					valueElem: "antires_crystal"
				};
				anti_resourceTickerDeuterium = {
					available: currentResources.deuterium.resources["actual"],
					limit: currentResources.deuterium.resources["max"],
					production: currentResources.deuterium.resources["production"],
					valueElem: "antires_deuterium"
				};
				if (!Utils.unsafeWindow.vacation) {
					if (typeof (metalTicker) != "undefined") {
						timerHandler.removeCallback(anti_metalTicker.intervalObj)
					}
					if (typeof (crystalTicker) != "undefined") {
						timerHandler.removeCallback(anti_crystalTicker.intervalObj)
					}
					if (typeof (deuteriumTicker) != "undefined") {
						timerHandler.removeCallback(anti_deuteriumTicker.intervalObj)
					}
					anti_metalTicker = new Utils.unsafeWindow.resourceTicker(anti_resourceTickerMetal);
					anti_crystalTicker = new Utils.unsafeWindow.resourceTicker(anti_resourceTickerCrystal);
					anti_deuteriumTicker = new Utils.unsafeWindow.resourceTicker(anti_resourceTickerDeuterium)
				}					
			}
			else {
				for (var i=0; i<this.res_array.length; i++)
				{
					...
					else // res except energy in ogame 2.2.0
					{
						...
						if (res != 'energy' && res != 'darkmatter')
						{
							html += '<span class="'+(Utils.isMoon ? '' : current.getAttribute('class'))+'">';
							html += '<span id="'+ticker_id+'">' + current.firstChild.nodeValue + '</span> / ';
							html += storage.firstChild.nodeValue;
							html += '</span>';
							html += '<br/>';
							html += '<span class="'+(Utils.isMoon ? '' : prod.getAttribute('class'))+'">(' + prod.firstChild.nodeValue + ')</span>';
						}
						else // since 2.2.6
						{
							var consumed = prod.firstChild.nodeValue.replace('-','');
	...
	var Buildings = 
	{
		...
		Show: function(e)
		{
			...
			Names.showBuildingResNames();
				...
				if(Options.ver2num(versogame.content) >= 507000000)
				{
					$('.techtree_link').css('height','32px');
					$('.techtree_link').css('width','32px');
					$('.techtree_link .label').css('display','none');
				}
		},
	...
	function Strg(s,d){return ((s)?s.toString():(d)?d.toString():'')}
	...
	try	{
		...
		if (Options.shortHeader && Utils.getElementByClassName('toggleHeader') && document.getElementById('planet').className != 'shortHeader') {	
			Utils.$("#planet").toggleClass("shortHeader");
			Utils.$(".c-left").toggleClass("shortCorner");
			Utils.$(".c-right").toggleClass("shortCorner");
			Utils.$.cookie (Utils.unsafeWindow.cookieName, 0, { expires: 365 });
		}
		...
		else if ( Utils.isCurrentPage('overview,resources,shipyard,station,station-moon,defense,research') ) {
	...
	if ((document.location.href.indexOf ("/game/index.php?") >  -1) && 
		(document.location.href.indexOf (".ogame.") >  -1)) {
		var antigamewrn = localStorage.getItem('antigame_warn');
		var compver = 506030000;
		var curver = Options.ver2num(versogame.content);
		if(!antigamewrn) antigamewrn = '0';
		antigamewrn = parseInt(antigamewrn);
		if (antigamewrn < compver) antigamewrn = compver;
		// if(curver > antigamewrn) {
			// var divA = document.createElement('div');
			// var html = '<div id="antigame_warn" style="position:relative;bottom:0;left:0;padding:0.2em 0.35em;color:#FFFFFF;background:#FF0000;font-weight:bold;font-size:small;z-index:99;">';
			// html +=  '<a href="http://userscripts.org/scripts/show/116786" style="color:#FFFFFF">This version Ogame incompatible with AntiGame Classic Mode for 2.3.x</a>';
			// html +=  ' <a href="#" style="color:yellow" ONCLICK="alert(0); return false;" id="antigame_hide">HIDE</a></div>';
			// divA.innerHTML = html;
			// document.body.appendChild(divA);
			// var wrnscript = document.createElement('script');
			// wrnscript.innerHTML = '\n'+
				// "document.getElementById('antigame_hide').onclick=function(){\n"+
						// "localStorage.setItem('antigame_warn', '"+curver.toString()+"');\n"+
						// "document.getElementById('antigame_warn').style.display = 'none';\n"+
					// "}\n";
			// document.getElementById('antigame_hide').appendChild(wrnscript);
		// }
		
		$('span.moon_active').css('color', '#FD8A1C');
	}
