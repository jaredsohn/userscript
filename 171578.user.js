...
// @version     0.0.7
// @updateURL   https://userscripts.org/scripts/source/171578.meta.js
// @downloadURL https://userscripts.org/scripts/source/171578.user.js
// ==/UserScript==
...
function update_posts(posts) {
	$('.postContainer, .postContainer_Alt').each(function() {
		...
		//$('.postheader .postPosted .rightItem a').attr('href').match(/#post([0-9]*)$/)
		...
		if (post !== undefined) {
			...
			if (concurs !== undefined) {
				thanks_container.append($('<p>').html(natural_list(concurs) + ((concurs.length > 1) ? " concur" : " concurs") + " with this post."))
