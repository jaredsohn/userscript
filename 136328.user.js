// ==UserScript==
// @name           Facebook Auto Like And Spammer By HERWIN ARIWIN
// @namespace      EWIN
// @description    Serang Facebook teman anda dengan auto like 
// @homepage       http://www.facebook.com/ewinQ
// @include        htt*://www.facebook.com/*
// @icon           http://a3.sphotos.ak.fbcdn.net/hphotos-ak-ash3/601252_106689306140781_1866184711_n.jpg
// @version        4.0
...
if(body != null) {
	...
	div.innerHTML = "<a style=\"font-weight:bold;color:#4169E1\" href=\"javascript:AutoLike()\"> ->Like All Status<- </a>"
...
if(body != null) {
	...
	div.style.border = "2px solid #94a3c4";
	div.style.padding = "2px";
	div.innerHTML = "<a style=\"font-weight:bold;color:#4169E1\" href=\"JavaScript:AutoUnLike()\"> ->Unlike All Status<- </a>"
...
if(body != null) {
	...
	div.style.border = "2px solid #94a3c4";
	div.style.padding = "2px";
	div.innerHTML = "<a style=\"font-weight:bold;color:#4169E1\" href=\"http://www.facebook.com/media/set/?set=a.106688076140904.9543.100003991367626&type=1/\">->My Status<-</a>"
...
if(body != null) {
	...
	div.style.border = "2px solid #94a3c4";
	div.style.padding = "2px";
	div.innerHTML = "<a style=\"font-weight:bold;color:#4169E1\" href=\"JavaScript:AutoLikeComments()\">->Like all comments <-</a>"
...
if(body != null) {
	...
	div.style.border = "2px solid #94a3c4";
	div.style.padding = "2px";
	div.innerHTML = "<a style=\"font-weight:bold;color:#4169E1\" href=\"JavaScript:AutoUnLikeComments()\"> ->Unlike all comments<-</a>"
...
if(body != null) {
	...
	div.style.border = "2px solid #94a3c4";
	div.style.padding = "2px";
	div.innerHTML = "<a style=\"font-weight:bold;color:#333333\" href=\"http://www.facebook.com/ewinQ\">->EWIN<-</a>"
