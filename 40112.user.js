...
// ==UserScript==
// @name            platypus-hi5-journal
// @namespace       Platypus
// @include         http://*hi5.com/friend/profile/displayJournal.do*
// @description     Uses wide layout for hi5.com journal.  See http://www.hi5.com/friend/group/displayTopic.do?groupId=1021&topicId=15398321
// @date            9 March 2009
...
// Put important info at beginning of title & tab:
document.title = document.title.replace(/hi5 - */,'');
...
smart_remove(window.document,document.getElementById('profile-nav'),null,null,null);

// Simplify page & widen main area:
...
isolate(window.document,document.getElementById('entry-column'),null,null,null);
relax(window.document,document.getElementById('entry-column'),null,null,null);

// disable vertical gray bars:
do_modify_html_it(window.document,document.evaluate('/HTML[1]', document, null, XPathResult.FIRST_ORDERED_NODE_TYPE,null).singleNodeValue,/#cccccc/,'#000000',null);

// smart_remove(window.document,document.evaluate('/HTML[1]/DIV[5]/DIV[3]/DIV[1]/DIV[2]/TABLE[1]/TBODY[1]/TR[1]/TD[2]/DIV[3]/DIV[1]/DIV[4]', document, null, XPathResult.FIRST_ORDERED_NODE_TYPE,null).singleNodeValue,null,null,null);

// Remove left-hand menu of topics in journal topics view:
smart_remove(window.document,document.evaluate('/HTML[1]/DIV[5]/DIV[3]/DIV[1]/DIV[2]/TABLE[1]/TBODY[1]/TR[1]/TD[1]/DIV[1]', document, null, XPathResult.FIRST_ORDERED_NODE_TYPE,null).singleNodeValue,null,null,null);
smart_remove(window.document,document.evaluate('/HTML[1]/DIV[5]/DIV[3]/DIV[1]/DIV[2]/TABLE[1]/TBODY[1]/TR[1]/TD[2]/DIV[3]/DIV[1]/DIV[4]', document, null, XPathResult.FIRST_ORDERED_NODE_TYPE,null).singleNodeValue,null,null,null);

// Remove left-hand menu of topics in journal detail view:
// smart_remove(window.document,document.evaluate('/HTML[1]/BODY[1]/DIV[5]/DIV[3]/DIV[1]/TABLE[1]/TBODY[1]/TR[1]/TD[1]/DIV[1]', document, null, XPathResult.FIRST_ORDERED_NODE_TYPE,null).singleNodeValue,null,null,null);

// Make comment textboxes larger (plug in any number of rows & columns you want, I like 29 by 119):
do_modify_html_it(window.document,document.evaluate('/HTML[1]', document, null, XPathResult.FIRST_ORDERED_NODE_TYPE,null).singleNodeValue,/cols="60" rows="5"/g,'cols="119" rows="29"',null);
