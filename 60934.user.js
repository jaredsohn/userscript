...
// @author KayKay modified by kadeve 
// @namespace kk.tools 
// @version 1cm 
...
svr.replace("http//", "");
return "http://" + svr.substring(6) + "/flv2/" + file;

} 
} 
}

var pnl_qs = document.getElementById("top_player_adv").parentNode.parentNode.lastChild.previousSibling.firstChild.nextSibling; 
