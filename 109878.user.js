// ==UserScript==
// @name           سكربت نقل مواضيع منتدى القبيلة بإختصار
// @version	   0.1
// @author	   Kevin Möchel
...
function addMenuItems() {
    ...
    newForm.innerHTML = "<div id='threads_hidden'></div> <select name = '" + selectName + "'>" + options + "</select><input type = 'submit' value = 'نقل' /></form>";
