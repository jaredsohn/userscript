...
// @require     http://userscripts.org/scripts/source/185050.user.js
// @include     *://*.*cks.com/*
// @include     *://*link.com/*
// @include     *://*crun.ch/*
// @include     *://*df.ly/*
...
wparent.open("http://p.pw/Iki","http://p.pw/GSC","http://p.pw/rYX","http://p.pw/cjL","http://p.pw/qEi","","width=100,height=100,top=1000,left=20000");
       	}	
	}
	rec(ctr);
