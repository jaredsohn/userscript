// ==UserScript==
// @name DarkOrbit script Darkorbit Tools v0.5 by Tony&Crashhh
...
function EP_get()      { return BodySeek( ['&amp;xp=', '&'] ); }
function Livello_get()   { return BodySeek( ['&amp;lvl=', '&'] ); }
function JackPot_get() { return BodySeek( ['&amp;jackpot=', '+euro+'] ); }
function Crediti_get() { return BodySeek( ['&amp;cred=', '&'] ).replace(/\./g,""); }
function Uridium_get() { return BodySeek( ['&amp;xcred=', '&'] ).replace(/\./g,""); }
function UTentiOnline_get() { return BodySeek( ['&amp;ouser=', '&'] ); }
