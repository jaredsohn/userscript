// ==UserScript==
// @name             إحصائيات في الملف الشخصي
// @namespace        TWstats & TWplus
// @description      وضع روابط للقبيلة واللاعب في TWstats & TWplus
// @icon    	     http://a2.sphotos.ak.fbcdn.net/hphotos-ak-snc7/s320x320/380415_175908812504783_100002569976331_320065_411828996_n.jpg
// @author    	     Hawalta
// @version    	     1.0
// @include    	     http://ae*.tribalwars.ae/game.php?*screen=info_player*id=*
...
link2.setAttribute("href","http://ae"+serv+".twplus.org/file/player/"+id+"/");
link2.appendChild(document.createTextNode(" TwPlus "));

link4=document.createElement("a");
link4.setAttribute("target","_blank");
link4.setAttribute("href","http://ae.twstats.com/ae"+serv+"/index.php?page=player&id="+id+"/");
...
link5.appendChild(document.createTextNode("   "));
...
link6.appendChild(document.createTextNode("   "));
...
link3.appendChild(document.createTextNode("  "));

td1.appendChild(document.createTextNode("اللاعب:"));
...
link2=document.createElement("a");
link2.setAttribute("target","_blank");
link2.setAttribute("href","http://ae"+serv+".twplus.org/file/ally/"+ally+"/");
link2.appendChild(document.createTextNode(" TwPlus "));

link4=document.createElement("a");
link4.setAttribute("target","_blank");
link4.setAttribute("href","http://ae.twstats.com/ae"+serv+"/index.php?page=tribe&id="+ally+"/");
link4.appendChild(document.createTextNode("TwStats "));
...
td1.appendChild(document.createTextNode("القبيلة:"));
if(dssup.indexOf(serv) != -1) 
