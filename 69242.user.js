...
// @updateNote     3.2 = Currently in the experimental development stage, added support for chrome; 100228.1431 = CHROME-BUGFIX: Finally got storage/editing values working - boolean true/false values are stored as a string, causing later boolean comparisons to fail because the string "false" !== boolean false for example;
...
function getAccountType(verbose)
{
  ...
  for (var i = 0; i < spans.length; i++) {
    if(spans[i].innerHTML.indexOf("[Standard") == 1 | spans[i].innerHTML.indexOf("[Membro") == 1) { return 0; }
  }
  ...
  if(xpathResults_FaqLogo.snapshotLength == 1)
  {
    ...
    if(toBool(manipulatePrefs('firstRun',true,'get') === true))
    {
      ...
      var arrowImg = document.createElement('img');
        ...
        arrowImg.src = "data:image/png;base64,";
...
var myAccount = new function ()
{
  ...
  this.preferences = new function (getSet)
  {
    ...
    // Flags
    this.textifyFlag = toBool(manipulatePrefs('textifyFlag',true,getSet));
...
function getDaysTilPaidOwnRecycle(indivAvg,currentProfit,expensesPerRefPerDay)
{
  ...
  if(myAccount.recycleCost > currentProfit)
  {
    ...
    if(numberOfDays > dayLimit) { numberOfDays = 'More than '+dayLimit+' days'; }
...
function localString(key,text) 
{
  ...
  else if('undefined' !== typeof scriptLangStrings['en']) 
  {
...
function neobuxString(key) 
{
  ...
  else if('undefined' !== typeof neobuxLangStrings['en']) {
    GM_log('Error getting neobux string. Defaulting to English.\nRequested key: '+key); 
    return neobuxLangStrings['en'][key];
  }
  else {
  ...
  // customLogger('xpathResult.parentNode = '+xpathResult.parentNode,'x');
    ...
    var infoLabel = document.createElement("TD");
      if('Firefox' == browserName) {
        ...
        infoLabel.setAttribute('style', 'background-image:url('+img_statSidebarBackground+');');
      }
...
// Function that runs on the Referral Listings pages
  ...
  footerRow.childNodes[0].colSpan = rows[1].childNodes.length;
