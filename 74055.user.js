...
// @namespace      2.3\
// @description    Blub\
// @include        // @include       http://*.die-staemme.de/*forum.php*answer=true*\
// @include        // @include       http://*.die-staemme.de/*forum.php*edit_post_id*\
// @include        // @include       http://*.die-staemme.de/*forum.php*mode=new_thread*\
// @include        // @include       http://*.die-staemme.de/*forum.php*mode=new_poll*\
// @include        // @include       http://*.die-staemme.de/*screen=memo*\
// @include        // @include       http://*.die-staemme.de/*screen=mail*mode=new*\
// @include        // @include       http://*.die-staemme.de/*screen=mail*mode=view*\
// @include        // @include       http://*.die-staemme.de/*screen=ally*mode=overview*\
// @include        // @include       http://*.die-staemme.de/*screen=ally*mode=properties*\
// @include        // @include       http://*.tribalwars.net/*forum.php*answer=true*\
// @include        // @include       http://*.tribalwars.net/*forum.php*edit_post_id*\
// @include        // @include       http://*.tribalwars.net/*forum.php*mode=new_thread*\
// @include        // @include       http://*.tribalwars.net/*forum.php*mode=new_poll*\
// @include        // @include       http://*.tribalwars.net/*screen=memo*\
// @include        // @include       http://*.tribalwars.net/*screen=mail*mode=new*\
// @include        // @include       http://*.tribalwars.net/*screen=mail*mode=view*\
// @include        // @include       http://*.tribalwars.net/*screen=ally*mode=overview*\
// ==UserScript==\
