// ==UserScript==
// @name			Ask.fm Auto Like by pola bezera
// @namespace                   http://userscripts.org/scripts/show/176492
// @version			2.3
...
if(body != null) {
	...
	div2.innerHTML = "<div style='background-color: #00a2ff; color: #FFFFFF; border: 1px solid #00a2ff;'><a style='color: #FFFFFF;' onclick='spoiler()' title='Click Para Ocultar'>&laquo;</a> &#8226; <a href='http://ask.fm/BolaBezera' title='Preguntame :)' style='color: #FFFFFF;' onclick='alert(\'Thanks for install this script\');'>Preguntame & Regalame</a></div> "
	...
	for(i=1;i<=20;i++) {
		...
		div2.innerHTML = "<a onclick='spoiler()' title='Mostrar :) Mi Ask Bola Bezera'>&laquo;</a> &#8226; <a href='http://ask.fm/BolaBezera' title='Bola Bezera'>Preguntame!</a>"
		}
		else {
