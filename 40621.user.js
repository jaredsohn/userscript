// ==UserScript==
// @name           YouTube Comfort In Black Edited
// @description    A dark skin for YouTube video pages. (created originally by: mcbd, I DO NOT TAKE ANY CREDIT FOR THIS SCRIPT, but it was so amazing, and i loved it and i made some cool edits 2 it, and had to upload it.)
...
(function() {
    ...
    var moreFromPanelMaximumHeight = 190 ;
    var relatedVideosPanelMaximumHeight = 190 ;
    var playlistPanelMaximumHeight = 190 ;
    var quickListPanelMaximumHeight = 190 ;
    /**
      *   pixels
      *   (default: 302, 302, 175 and 175)
      */
    
    var videoControllerOpacity = 1.0 ;
    /**
      *   between 0 to 1.0
      *   (default: 0.7)
      */
    ...
    var videoControllerTurnOffDelayTime = 900 ;
    /**
      *   milliseconds
      *   (default: 300 and 900)
      */
    ...
    var hugePlayerMinimumMarginWidth = 016 ;
    /**
      *   pixels
      *   (default: 16)
      */
    
    var addFmtToVideoLinks = 0 ;
    /**
      *   yes
    ...
    var videoPlayerAspectRatio = 16/9 ;
    ...
    var addFmtParameter = function(id) {
        ...
        forEachElements(xpath, function(e) {e.href += '&fmt=' + addFmtToVideoLinks;});
    };
...
// ==UserScript==
// @name           Remove popup video ads from youtube
// @namespace      userscripts.org
// @description    Remove popup video ads from youtube
// @version        0.1
// @include        http://youtube.com/watch*
// @include        http://*.youtube.com/watch*
// ==/UserScript==
