    ...
    GM_xmlhttpRequest(
        {
            ...
            onload:function(response)
            {
                ...
                displayEl.setAttribute('style', 'position:absolute; margin-left:200px; padding-bottom:3px;text-align:left;');
                displayEl.innerHTML = html;
                latest=document.getElementById('logo');
            ...
            onerror:function(response)
            {
                ...
                var latest=document.getElementById('logo');
                latest.parentNode.insertBefore(displayEl, latest);
            }
        }
    );
