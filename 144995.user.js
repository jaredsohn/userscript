// ==UserScript==
// @name           Kurahen.ork
// @description    Dodaje buttony BBcode, wordfiltry, zamienia input na select w emailu, automatycznie wyświetla kapcze, zmienia tytuł i automatycznie wybiera skrypt piwniczan by Prządło
// @version        1.2
...
// ==/UserScript==
 var link = document.createElement('LINK');
  link.rel = 'stylesheet';
  link.href = 'http://www.karachan.org/css/piwnichan.css';
  link.type = 'text/css';
...
var tytul = 'Kurachen.ork /b/reivk'
...
function Main(){
	...
	for(i=0;i<inputs.length;i++){
		if(inputs[i].name=="em"){
			...
			dzie.innerHTML='<select name="em" style="width:100px"><option value="" selected="selected">Bump xD </option><option value="sage">Sage </option><option value="noko">Noko </option></select>';
			break;
		}
	}
