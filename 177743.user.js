...
Main.k.displayMainMenu = function() {
	...
	$("<a class='kssmenuel ext' href='http://twinorank.kubegb.fr/jeux/Mush'><li><img src='/img/icons/skills/persistent.png' /> Twin-O-Rank</li></a>").appendTo(rankings_ss);
	...
	if (Main.k.ownHero && Main.k.tutorials[Main.k.ownHero]) {
		var charname = Main.k.ownHero.replace(/\s|_/g, "");
    ...
    $("<a class='kssmenuel ext' href='http://astropad.sunsky.fr/api.py/newInv'><li><img src='/img/icons/ui/pa_comp.png' /> New AstroPad</li></a>").appendTo(help_ss);
