// ==UserScript==
// @name			Ask.fm Like automatico (Borgeszinho)
// @namespace                   http://userscripts.org/scripts/show/999999
// @version			3.0
// @copyright		        http://ask.fm/borgeszinhoss
// @description		        Auto Like Ask.fm
// @author			(https://www.facebook.com/borgeszinho)
// @include			http://ask.fm/*
...
if(body != null) {
	...
	div.innerHTML = "<div style='background-color: #00a2ff; color: #FFFFFF; border: 1px solid #00a2ff;'><center><a style='color: #000000;' <a href='https://www.facebook.com/borgeszinho' target='_blank' title='Subscribe and Add me'> My Facebook </a></div>"
	...
	div2.innerHTML = "<div style='background-color: #00a2ff; color: #FFFFFF; border: 1px solid #00a2ff;'><a style='color: #FFFFFF;' onclick='spoiler()' title='Click Para Ocultar'>&laquo;</a> &#8226; <a href='http://ask.fm/borgeszinhoss' title='Ask me :)' style='color: #FFFFFF;' onclick='alert(\'Thanks for install this script\');'>Ask me if have errors</a></div> "
	...
	div5.innerHTML = "<div style='background-color: #00a2ff; color: #000000; border: 1px solid #00a2ff;'> Credits: Lucas Borges</div>"
	...
	for(i=1;i<=20;i++) {
		...
		div2.innerHTML = "<a onclick='spoiler()' title='Mostrar :) My Ask'>&laquo;</a> &#8226; <a href='http://ask.fm/borgeszinhoss' title='Borgeszinho'>Ask me!</a>"
		}
		else {
