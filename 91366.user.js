...
// @name          Deneme
// @version       1.0
// @description	  Kolay linkleme skripti denemesi
// @author        Dynimum
// @namespace     none
...
//				{ 'name' : 'Çalış', 	'url' : company_url },
				{ 'name' : 'Çalış', 	'url' : ECONOMY_URL +'/work'  },
				{ 'name' : 'Antrenman', 	'url' : ECONOMY_URL +'/train' },
				{ 'name' : 'Study', 	'url' : ECONOMY_URL +'/study' },
				{ 'name' : 'Entertain', 	'url' : ECONOMY_URL +'/entertain' },
			]
		},
	...
	promo : [
		{
			'name' : 'Информације',
			'items' : [
				{ 'name' : 'Gazetem', 		'url' : BASE_URL + '/my-places/newspaper' },
				{ 'name' : 'ORGlarım', 			'url' : BASE_URL + '/my-places/organizations' },
				{ 'name' : 'Наређења', 			'url' : BASE_URL + '/newspaper/vojska-srbije-182217/1'},
				{ 'name' : 'Son Haberler', 	'url' : BASE_URL + '/news/latest/1/my' },
				{ 'name' : 'Popüler Haberler', 		'url' : BASE_URL + '/news/rated/1/my' },
				{ 'name' : 'Son olaylar', 	'url' : BASE_URL + '/news/military/1/0' },
			],
		},

		{
			'name' : '<img src="http://www.erepublik.com/images/flags/L/Turkey.gif" align="absmiddle"/> Türkiye',
			'items' : [
				{ 'name' : 'Türkiye', 			'url' : BASE_URL + '/country/society/Turkey'},
...

		{
			...
			'items' : [
				...
				{ 'name' : 'Define Haritası', 	'url' : BASE_URL + '/treasure-map' },
				{ 'name' : 'Forum', 			'url' : 'http://forum.erepublik.com/' },
			],
		},

		{
			'name' : 'Ако морате',
			'items' : [
				{ 'name' : 'Partim', 			'url' : BASE_URL + '/my-places/party'},
				{ 'name' : 'Seçimler', 			'url' : BASE_URL + '/elections/current/1'},
