// ==UserScript==
// @name           Auto Accept Gifts Rhon198
// @version        0.1
// @namespace      KOCQuickWidgets-AutoAcceptGifts
// @homepage       http://userscripts.org/
// @description    This script will automatically accept all of your Kingdoms of Camelot gifts in your Facebook Game Requests. This is not my script, I just modified it for the Goswhit144 server. 
				...
				if(claim_gift){
					...
					if(domain_selector && (next_button1 || next_button2)){
						for(var i=0; i<domain_selector.options.length; i++){
							if(domain_selector.options[i].value == "144"){
