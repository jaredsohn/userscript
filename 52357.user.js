// ==UserScript==
// @name        AES Shortcut
// @author      Gianni 'guelfoweb' Amato http://www.guelfoweb.com
// @description AES 256 Text Encrypt/Decrypt
// @include     http://*
// @include     https://*
// @version     0.0.31
// @date        2013-05-23
...
// Encrypt: select plain text and press Ctrl+F1
// Decrypt: select cipher text and press Ctrl+F2

shortcut("Ctrl+F1",function() { getSelectedText('E'); }); // Encrypt
shortcut("Ctrl+F2",function() { getSelectedText('D'); }); // Decrypt

function getSelectedText(action) {
    var txt = '';
    ...
    var pass = prompt('Insert Passphrase', '');
    if(pass){
	var txtplain = String(txt);
	var passplain = String(pass);
	    if (action == "E"){
            var w = window.open('', '', 'width=400,height=400,resizeable,scrollbars');
            w.document.title = '<font size="4">Encrypted Text</font>';
            w.document.write('<b>Encrypted Text</b><br><hr>');
            w.document.write('<textarea id="myTextarea" cols="20" onfocus="this.select()" onMouseUp="return false"></textarea>');
            w.document.getElementById("myTextarea").value = AESEncryptCtr(txtplain, passplain, 256);
            w.document.write('<br><hr><font size="2"><a href="https://userscripts.org/scripts/show/52357">AES Shortcut</a></font>');
            w.document.close();
	    	return false;
	    }
	    if (action == "D"){
            var w = window.open('', '', 'width=400,height=400,resizeable,scrollbars');
            w.document.title = '<font size="4">Decrypted Text</font>';
            w.document.write('<b>Decrypted Text</b><br><hr>');
            w.document.write('<textarea id="myTextarea" cols="20" onfocus="this.select()" onMouseUp="return false"></textarea>');
            w.document.getElementById("myTextarea").value = AESDecryptCtr(txtplain, passplain, 256);
            w.document.write('<br><hr><font size="2"><a href="https://userscripts.org/scripts/show/52357">AES Shortcut</a></font>');
            w.document.close();
	    	return false;
	    }
