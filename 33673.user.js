...
// @name                TCCity
// @version             20070912.3
// @author              hexkid- Updates by Smash08
...
const TCCity_version = '20070912.4';
...
var statsTotal = (100 * statsSpe) + (100 * statsStr) + (100 * statsDef) + (100 * statsDex);
...
var arrayVirus = [[500, 'Ub3rn00b&nbsp;Hacker'], [1000, 'N00b&nbsp;Hacker'], [1500, '1337n00b&nbsp;Hacker'], [2000, 'Ph34r3dn00b&nbsp;Hacker'], [2500, 'Ph34r3d&nbsp;Hacker'], [3000, 'Ph343d1337&nbsp;Hacker'], [3500, 'Ub3rph34r3d&nbsp;Hacker'], [4000, 'Ub3r&nbsp;Hacker'], [4500, '1337&nbsp;Hacker'], [5000, 'Ub3r1337&nbsp;Hacker'], [5500, 'Key&nbsp;Puncher'], [6000, 'Script&nbsp;Kid']];
var arrayMurder = [[1000, 'Beginner&nbsp;Assassin'], [2000, 'Novice&nbsp;Assassin'], [3000, 'Competent&nbsp;Assassin'], [4000, 'Elite&nbsp;Assassin'], [5000, 'Deadly&nbsp;Assassin'], [6000, 'Lethal&nbsp;Assassin']];
var arrayDrugs = [[250, 'Drug&nbsp;Pusher'], [500, 'Drug&nbsp;Runner'], [1000, 'Drug&nbsp;Dealer'], [2000, 'Drug&nbsp;Lord'], [4000, 'Candy&nbsp;Man']];
var arrayFraud = [[300, 'Fake'], [600, 'Counterfeit'], [900, 'Pretender'], [1500, 'Imposter'], [2000, 'Pseudo'], [2500, 'Imitation'], [3000, 'Simulated'], [3500, 'Hoax'], [4000, 'Faux'], [5000, 'Poser'], [6000, 'Deception'], [7000, 'Phony']];
var arrayGTA = [[200, 'Gone&nbsp;In&nbsp;300&nbsp;Seconds'], [400, 'Gone&nbsp;In&nbsp;240&nbsp;Seconds'], [600, 'Gone&nbsp;In&nbsp;180&nbsp;Seconds'], [800, 'Gone&nbsp;In&nbsp;120&nbsp;Seconds'], [1000, 'Gone&nbsp;In&nbsp;60&nbsp;Seconds'], [1200, 'Gone&nbsp;In&nbsp;30&nbsp;Seconds'], [1500, 'Gone&nbsp;In&nbsp;45&nbsp;Seconds'], [2000, 'Gone&nbsp;In&nbsp;15&nbsp;Seconds'], [2500, 'Booster'], [3000, 'Joyrider'], [3500, 'Super&nbsp;Booster'], [4000, 'Master&nbsp;Carjacker'], [4500, 'Slim&nbsp;Jim'], [5000, 'Novice&nbsp;Joy&nbsp;Rider'], [5500, 'Novice&nbsp;Slim&nbsp;Jim'], [6000, 'Professional&nbsp;Joy&nbsp;Rider'], [6500, 'Professional&nbsp;Booster'], [7000, 'Professional&nbsp;Slim&nbsp;Jim'], [8000, 'Master&nbsp;Joy&nbsp;Rider']];
...
jobPromotion['Hospital'] = new Array();
  jobPromotion['Hospital']['Medical Student'] = 400;
  jobPromotion['Hospital']['Houseman'] = 600;
  jobPromotion['Hospital']['Senior Houseman'] = 500;
  jobPromotion['Hospital']['GP'] = 1500;
  jobPromotion['Hospital']['Consultant'] = 3000;
  jobPromotion['Hospital']['Surgeon'] = 5000;
...
if (addWeaponMults == '1') {
  ...
  weaponArray['mel']['Scimitar'] = 10.25;
  ...
  weaponArray['pri']['M16A2Rifle'] = 15.9;
  ...
  weaponArray['arm']['FullBodyArmour'] = 10;
...
var rx_spe = /Speed:\s \s (?:(\d ),)?(\d \.\d )\s /im;
var rx_str = /Strength:\s \s (?:(\d ),)?(\d \.\d )\s /im;
var rx_def = /Defence:\s \s (?:(\d ),)?(\d \.\d )\s /im;
var rx_dex = /Dexterity:\s \s (?:(\d ),)?(\d \.\d )\s /im;
...
if ((statsTotal > 0) && document.location.href.match(/\/(gym.php|validating3\.php\?linknum=\d)$/)) {
  ...
  if (trainTimesArray && trainTimesArray[1] && (1 * trainTimesArray[1] > 0)) {
    ...
    var speH = 100 * readGMValue('cfg', 'statsSpe', '1', true);
    var strH = 100 * readGMValue('cfg', 'statsStr', '1', true);
    var defH = 100 * readGMValue('cfg', 'statsDef', '1', true);
    var dexH = 100 * readGMValue('cfg', 'statsDex', '1', true);
    ...
    var spe = 100 * readGMValue('tmp', 'spe', '1', true);
    var str = 100 * readGMValue('tmp', 'str', '1', true);
    var def = 100 * readGMValue('tmp', 'def', '1', true);
    var dex = 100 * readGMValue('tmp', 'dex', '1', true);
  ...
  if (showAwards) {
    if (TDs[i].innerHTML.match(/^\d+$/)) {
      ...
      if (t.innerHTML == 'Selling illegal products') {
        t.innerHTML += ' (nerve: 3, 6)';
      }
      if (t.innerHTML == 'Theft') {
        t.innerHTML += ' (nerve: 4, 4, 4, 4, 4)';
        arr = arrayThefts;
      }
      if (t.innerHTML == 'Computer crimes') {
        t.innerHTML += ' (nerve: 4, 8)';
        arr = arrayVirus;
      }
  ...
  if (LINKs[i].hasAttribute('href')) {
    ...
    if (!FCTN_done && (LINKs[i].getAttribute('href') == 'factions.php?step=your')) {
      ...
      if (addLink_facCrime == '1') {
        ...
        OCLink.setAttribute('href', 'factions.php?step=your&action=crime');
