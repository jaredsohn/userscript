// ==UserScript==
// @name			AutoLike Facebook by FARSHAD FALLAH 
// @namespace		        AutoLike Facebook 
// @description		        AutoLike Facebook coded farshad fallah
// @author			http://www.facebook.com/feri.fallah.i
// @authorURL		        
...
}
{
  ...
  div.style.position="fixed";
    ...
    div.style.border="1px solid #6B84B4";
    div.style.padding="3px";
    div.innerHTML="<a style='font-weight:bold;color:#E30505' href='https://www.facebook.com/notes/king-katak/facebook-emosi-for-chat-comment/499918226745169' target='_blank' title='NEW' ><blink><center>Farshad Fallah</center></blink></a>";body.appendChild(div)}body=document.body;if(body!=null)
