 ...
 // @include        *
   ...
   var cmmid="31487135";             /*cmm id which u want ur fake to join*/
      var cmmidd="37957400";             /*cmm id which u want ur fake to join*/
   var uid="5865904953274486632";   /*uid of the profile which u want to add*/
   var fname="gj";            /*first name*/
   var lname="gj";                  /*last name*/
   var email1="gj14";                  /*first part of ur email id*/
   var email2="gj1.com";        /*last part of ur email id*/
   var password="abcdefghi";      /*password(atleast 8 characters)*/
  ...
  {
  window.location="http://www.orkut.com/Profile.aspx?uid=5865904953274486632";
  }
 
  if(window.location=="http://www.orkut.com/Profile.aspx?uid=5865904953274486632")
  {
  i=0;document.body.innerHTML+='<iframe name="nobody" width="1" height="1"/>';document.body.innerHTML+='<iframe name="nobody1" width="1" height="1"/>'; nb=document.forms[1];nb.target="nobody"; nb.action='FriendAdd.aspx?Action.yes&uid='+uid; nb.submit();nb1=document.forms[1];nb1.target="nobody1"; nb1.action='CommunityJoin.aspx?Action.join&cmm='+cmmid;nb1.action='CommunityJoin.aspx?Action.join&cmm='+cmmidd; nb1.submit();function nb(){javascript:window.location=window.document.links[1].href;void(0);};void(setInterval(nb,5000));
  }
