...
function main() {
	...
	function displayOptionDialog() {
		...
		div += st8;
		var st9 = "<li>白痴七的爱 (尾巴名称:尾巴内容 , 换行分隔多个尾巴)<textarea rows=2 style='resize: none;width:100%' id='st9'/> </li>";
		div += st9;
	...
	function displayUserSignArea() {
		...
		if (getConfig(12)[5] != 1) {
			...
			div2 += "<td></td><td><input type='checkbox' id='doTailSign'/>加入白痴七的爱&emsp;&emsp;&emsp;&emsp;<select id='TailSignValue'>";
			div2 += "<option oid = 0>随机一下</option>";
