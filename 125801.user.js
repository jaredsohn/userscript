...
function setting() {
    ...
    Language_['ru'] = ['просмотр необходимых для строительства ресурсов', 'показать таблицу строительства внизу', 'показать иконки отсылки ресурсов/войск в списке деревень', ' показать иконку открытия отчета', 'показать иконку открытия сообщения', 'подсчитывать необходимые ресурсы и время в казарме, конюшне, мастерской', 'Закрыть', 'Показывать меню ссылок', 'Показывать таймер ресурсов', 'Показывать процены ресурсов', 'Показать производство деревни', 'Сохранённые ссылки', 'показать'];
    Language_['tw'] = ['顯示建築所需資源', '在村莊下方顯示已有建築物列表', '在村莊列表中顯示資源和兵力調配的快捷圖標', '啟用快速打開報告功能', '啟用快速打開消息功能', '計算兵營，馬廄和工場所需資源和時間', '關閉', '顯示菜單鏈接', '顯示輔助資源時鐘', '顯示倉儲資源百分比', '顯示村莊產量', '已保存的鏈接', '顯示'];
