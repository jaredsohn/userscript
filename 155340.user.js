// coding: utf-8
// ==UserScript==
// @name          youtube cool black [edited]
...
#comments-view .video-response .video-thumb, #comments-view .comment .yt-user-photo {\
    visibility: hidden;\
}\
div.video-extras-sparkbar-dislikes {\
...
div.branded-page-v2-detached-top .branded-page-v2-primary-col {\
    border: none);\
}\
...
.epic-nav-dropdown-group:hover, body a.yt-uix-button-epic-nav-item:hover, body a.yt-uix-button-epic-nav-item.selected, button.yt-uix-button-epic-nav-item:hover, button.yt-uix-button-epic-nav-item.selected, .epic-nav-item:hover, .epic-nav-item.selected, .epic-nav-item-heading {\
...
div.feed-item-main .feed-item-actions-line {\
    color: rgb(162, 166, 166)!important;\
}\
.feed-item-actions-line .feed-item-owner {\
    color: rgb(67, 139, 197);\
}\
...
.video-extras-sparkbar-ss {\
    background: rgb(255, 0,0) !important;\
}\
.video-extras-sparkbar-likes {\
    border-right: 0px !important;\
    background: none repeat scroll 0% 0% rgb(85, 153, 0) !important;\
}\
#watch-description {\
