// ==UserScript==
// @name            asanusta YouTube Center Only Download upload
// @version         1.09.2012
// @author          Jeppe Rune Mortensen (asanusta)
// @description      Bu YouTube Merkezi'nden indirme düğmesi ekler -This adds the download button from YouTube Center.
...
(function(){
  ...
  function initUI() {
    ...
    var downloadButton = downloadButton = createYouTubeButton("Download List", "<span class=\"yt-uix-button-content\">Download</span><img class=\"yt-uix-button-arrow quimby_search_image\" src=\"//s.ytimg.com/yt/img/pixel-vfl3z5WfW.gif\" alt=\"\">", downloadMenu, null, null);
