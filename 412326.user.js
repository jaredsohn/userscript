...
function CustomOffer() {
	...
	if ($(".success_message").length <= 0 && $(".error_message").length <= 0) {
		...
		var CurrentDate = addZero(RealTime.getUTCDate()) + "." + addZero(RealTime.getUTCMonth() + 1) + "." + RealTime.getUTCFullYear() + ".";
		...
		localStorage.BuyingTime = "Time: " + CurrentDate + " " + CurrentTimeReadable + " | WRMdoc";
