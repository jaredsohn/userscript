...
// @namespace   t3
// @version 2.6cm
// @description  Travian v3 addons originally written by Victor Garcia (aka Croc) updated by Szabka pl59
...
// Ruso (travian.ru) gracias a Vladimir Yu Belov, mod by 7bit
	...
	lang_lv['PERFIL'] 	= 'Lietotāja Profils';
	lang_lv['SIM'] 		= 'Cīņas Simulators';
	lang_lv['CALC'] 	= 'Travian Kalkulators ';
	lang_lv['SEGURO'] 	= 'Vai esi Pārliecināts?'; //prompt message doesn't allow HTML Entities
	lang_lv['MARK'] 	= 'Iezīmēt visu';
	lang_lv['PERDIDAS'] 	= 'Zaudējumi';
	lang_lv['RENT'] 	= 'Ienākumi';
	lang_lv['SUBIR_NIVEL'] 	= 'Varat būvēt nākamo līmeni';
	lang_lv['JUGADOR'] 	= 'Spēlētājs';
	lang_lv['ALDEA'] 	= 'Ciemata nosaukums';
	lang_lv['HAB'] 		= 'Apdzīvotība';
	lang_lv['COORD'] 	= 'Koordinātes';
	lang_lv['ACCION'] 	= 'Darbības';
	lang_lv['ATACAR'] 	= 'Uzbrukums';
	lang_lv['COMERCIAR'] 	= 'Sūtīt resursus';
	lang_lv['GUARDADO'] 	= 'Saglabāts'; //prompt message doesn't allow HTML Entities
	lang_lv['DESP_ABR'] 	= 'Mov.'; //Whats that?
	lang_lv['FALTA'] 	= 'Nepieciešams';
	lang_lv['HOY'] 		= 'Šodien';
	lang_lv['MANYANA'] 	= 'Rītdien';
	lang_lv['PAS_MANYANA'] 	= 'Parit';
	lang_lv['MERCADO'] 	= 'Tirgus';
	lang_lv['CUARTEL'] 	= 'Kazarmas';
	lang_lv['PUNTO'] 	= 'Mitina vieta';
	lang_lv['CORRAL'] 	= 'Stallis';
	lang_lv['TALLER'] 	= 'Darbnīca';
	lang_lv['ENVIAR'] 	= 'Sūtīt resursus';
	lang_lv['COMPRAR'] 	= 'Pirkt';
	lang_lv['VENDER'] 	= 'Pārdot';
	lang_lv['ENVIAR_IGM'] 	= 'Sūtīt IGM';
	lang_lv['LISTO'] 	= 'Celšana pieejama';
	lang_lv['EL'] 		= 'uz'; 
	lang_lv['A_LAS'] 	= 'ap'; 
	lang_lv['EFICIENCIA'] 	= 'Lietderība'; 
	lang_lv['NUNCA']	= 'Ne tagad';
	lang_lv['PC']           = 'Kultūras punkti';
	lang_lv['FUNDAR']       = 'Jūs varat atrast un/vai iekarot ciemu';
	lang_lv['ALDEAS']       = 'Ciemats(i)';
	lang_lv['ENV_TROPAS'] 	= 'Sūtīt karaspēku';
	lang_lv['RECURSO1']     = 'Koks';
	lang_lv['RECURSO2']     = 'Mals';
	lang_lv['RECURSO3']     = 'Dzelzs';
	lang_lv['RECURSO4']     = 'Labība';
	lang_lv['TIEMPO']       = 'Laiks';
	lang_lv['COMP']         = 'Zinot par kļūdu';
	lang_lv['STAT']		= 'Statistika';
	lang_lv['OFREZCO']	= 'Piedāvājumi';
	lang_lv['BUSCO']	= 'Meklē';
	lang_lv['TIPO']		= 'Tips';
	lang_lv['DISPONIBLE']	= 'Tikai pieejams';
	lang_lv['CUALQUIERA']	= 'Kāds';
	lang_lv['SI']		= 'Ja';
	lang_lv['NO']		= 'Ne';
    lang_lv['LOGIN'] = 'Ieiet';
    lang_lv['MARCADORES']   = 'Grāmatzīmes';
    lang_lv['ANYADIR']      = 'Pievienot';
    lang_lv['ENLACE']       = 'Jaunās grāmatzīmes adrese'; //prompt message doesn't allow HTML Entities
    lang_lv['TEXTO']        = 'Jauns grāmatzīmes teksts'; //prompt message doesn't allow HTML Entities
	lang_lv['ELIMINAR']	= 'Dzēst';
	lang_lv['MAPA']		= 'Karte';
    lang_lv['VERSION']      = 'Pieejama versija';
    lang_lv['MAXTIME']      = 'Maksimālais laiks';
	lang_lv['CHECK']	= 'Atjaunot skriptu';
	lang_lv['ARCHIVE']	= 'Arhīvs';
	lang_lv['RESUMEN']	= 'Pārskats';
	lang_lv['MAXTIME']			= 'Maksimālais laiks';
	lang_lv['VERSION']			= 'Jaunāka versija';
	lang_lv['DETALLES']			= 'Drtalas';
	lang_lv['MAP_EXT']			= 'Liela Karte';
	lang_lv['MAT_PRIMAS']		= 'Resursi';
	lang_lv['ATAQUES']			= 'Uzbrukt';
	lang_lv['CONSTR']			= 'Celt';
	lang_lv['TROPAS']			= 'Karaspēks';
	lang_lv['ACTUALIZAR']		= 'Atjaunot skriptu';
	lang_lv['RES'] 				= 'Pārmeklēt koku';
    lang_lv['STOREURL']         = 'Datubāzes adrese';
    lang_lv['STOREPASSWORD']    = 'Datubāzes parole';
    lang_lv['OPTIONS']    		= 'Uzstādījumi';
    lang_lv['VENTAS']    		= 'Piedāvājums saglabāts';
    lang_lv['SHOWINFO']    		= 'Paradīt resursu info';
    lang_lv['HIDEINFO']    		= 'Slēpt resursu info';
    lang_lv['MAPSCAN']    		= 'Skanēt karti';	
