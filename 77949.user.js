...
liPuntosActuales.snapshotItem(0).innerHTML = "Pts investigados:" + liPuntosActuales.snapshotItem(0).innerHTML.substring(liPuntosActuales.snapshotItem(0).innerHTML.lastIndexOf(":") + 2, liPuntosActuales.snapshotItem(0).innerHTML.length);
...
{	
	...
	if (parseInt(puntosActuales,10) < parseInt(puntosNecesarios,10) ){	
		...
		//licaja.innerHTML = '<div style="border:solid 1px #73443E; width:60px; height:14px;font-size:9px;"><div style="background-color: #73443E; width:20px; height:14px font-size:9px;"></div></div>';
		...
		liPorcentajeDescubierto.innerHTML = '<div style="border:solid 1px #73443E; width:70px; height:12px;font-size:9px;"><div style="background-color: #73443E; width:' + porcentajeDescubierto.toFixed(0) + '%; height:12px;font-size:9px;;"></div></div><div style="position:relative; top:-20px; left:80px">' +  porcentajeDescubierto.toFixed(0) + "%</div>";
