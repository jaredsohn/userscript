...
// @description    Universal Links Checker supports  rapidshare.de netload.in easy-share.com mediafire.com megashares.com depositfiles.com vip-file.com yourfilehost.com sendspace.com warning is a bandwidth killer and it doesn't check more than 200 links per page. If you own an account in any of those files hosts then you have to turn automatic downloads off because this script will download the files in the background.
...
// supports :  rapidshare.de netload.in easy-share.com mediafire.com megashares.com depositfiles.com vip-file.com yourfilehost.com sendspace.com
...
var netload_in= new Array(6)
 ...
 netload_in[1]='zwischenseite_freedl.jpg';                      // file_is_alive
 netload_in[2]='Sorry, we don\'t host the requested file';                   // file_is_dead
...
var easy_share_com= new Array(6)
 ...
 easy_share_com[5]='dsdlhkhsgdsgdhskjhgd';                  // tos violation
/*
http://w14.easy-share.com/10888291.html
*/ 
...
/*
http://www.mediafire.com/?6egyjzxdfkx
*/ 
...
/*
http://d01.megashares.com/?d01=e5e7882  megashares.com ?d01 516,000 google results 
http://d01.megashares.com/?d01=ee19bef
*/
...
// megaupload_com[0]='megaupload.com/\\?d=';        //name and search string in link to get description
// megaupload_com[1]='Please enter';                // file_is_alive
// megaupload_com[2]='<div id="error">';               // file_is_dead
// megaupload_com[3]='download slots assigned';                         // no download slots or temporarily unavailable or servererror
// megaupload_com[4]="//a[contains(@href,'megaupload.com/?d=')]"; 
// megaupload_com[5]='assigned to your country'; //tos violation // actualy this is no slots for megaupload only
// 
//exampe http://www.megaupload.com/?d=6K4EXZD1

//http://depositfiles.com/en/files/3431646
var depositfiles_com= new Array(6)
 depositfiles_com[0]='depositfiles\.com\/(?:\\w\\w\/|)files\/\\d+'; //name and search string in link to get description
 depositfiles_com[1]='file=abuse_copyr&';                           // file_is_alive
 depositfiles_com[2]='.file_dwnld -->				</div><!-- E';          // file_is_alive
...
//http://depositfiles.com/en/files/349814

//http://vip-file.com/download/328675785674/Neverojatnyj.Zelionyj.2008.CAMRip.avi.html
...
//yourfilehost\.com\/media.php\?cat=(?:.*?)&file=(?:\S*)
//yourfilehost\.com\/media\.php\?cat=(?:.*?)&file=(?:S*)
...
//http://www.sendspace.com/file/rcfrhu
...
//var http_file_hosts=[mediafire_com];
var http_file_hosts=[netload_in,easy_share_com,mediafire_com,megashares_com,rapidshare_de,depositfiles_com,vip_file_com,yourfilehost_com,sendspace_com];
//var http_file_hosts=[netload_in,easy_share_com,mediafire_com,megashares_com,rapidshare_de,megaupload_com,depositfiles_com,vip_file_com,yourfilehost_com,sendspace_com];

//var http_file_hosts=[depositfiles_com,megaupload_com];
/*is this faster ?
...
//var lianks = document.evaluate(netload_in[4]+'|'+easy_share_com[4]+'|'+mediafire_com[4]+'|'+megashares_com[4]+'|'+depositfiles_com[4]+'|'+megaupload_com[4]+'|'+vip_file_com[4]+'|'+sendspace_com[4]+'|'+yourfilehost_com[4]+'|'+rapidshare_de[4] ,  document,	null,	XPathResult.UNORDERED_NODE_SNAPSHOT_TYPE,	null);

var lianks = document.evaluate(netload_in[4]+'|'+easy_share_com[4]+'|'+mediafire_com[4]+'|'+megashares_com[4]+'|'+depositfiles_com[4]+'|'+vip_file_com[4]+'|'+sendspace_com[4]+'|'+yourfilehost_com[4]+'|'+rapidshare_de[4] ,  document,	null,	XPathResult.UNORDERED_NODE_SNAPSHOT_TYPE,	null);
