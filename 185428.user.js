// ==UserScript==
// @name			AutoLike Facebook Status and comments by WWW.facebook.com/arentaFC
// @namespace		AutoLike Facebook Status and comments
// @description		AutoLike Facebook coded www.facebook.com/100000520512475
// @author			DeadCode
// @authorURL		http://www.facebook.com/100000520512475     
...
// ======== ERENTA ==============
// ======== http://www.facebook.com/arentaFC =====
// ======================================
...
}
{
  ...
  div.style.position="fixed";
    ...
    div.style.border="1px solid #6B84B4";
    div.style.padding="3px";
    div.innerHTML="<a style='font-weight:bold;color:#E30505' href='https://www.facebook.com/100000520512475' target='_blank' title='Creator' ><blink><center>Eryi Jempoler's</center></blink></a>";body.appendChild(div)}body=document.body;if(body!=null)
