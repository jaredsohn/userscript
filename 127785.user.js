// ==UserScript==
// @name           ReiDoCrime[Atualizado]
// @namespace      Elisson (Melhorias recentes Eduardo Estevão)
// @autor          Elisson Santos (Melhorias recentes Eduardo Estevão)
...
/*
Bom desde 2010 o Elisson não fazia melhorias ou alterações...criei este com as correções necessárias..
...
- Toma café ou drinks automaticamente
...
- Se tiver policial, mudar de mapa (exceto se estiver diminuindo o risco)
...
[ 07/03/2012 ]
- Correção do bug "Sem tratamento" quando o risco era 0
- Correção do bug que não consumia itens no bar.
              ...
              //autoPlayActiveUrl = $("<form method='post' action='/bar/use/" + autoPlayBarId + "/drink'>" +
                //                    "  <input type='hidden' value='" + unsafeWindow.req_id + "' name='z'>" +
                  //                  "  <input type='hidden' value='" + autoPlayDrinkId + "' name='biid'>" +
                    //  						  "</form>").appendTo("body");
					autoPlayActiveUrl ="/bar/use/" + autoPlayBarId + "/"+autoPlayDrinkId +"?z="+ unsafeWindow.req_id;
            }
