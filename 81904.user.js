...
var langText = [
...

	{
		...
		ERROR_LOAD : "Si è verificato un errore nel caricamento dei dati. Per risolvere il problema le variabili saranno resettate",

		NO_PLAYER : "Si è verificato un errore nel caricamento dei dati di un giocatore, quindi saranno resettati. Queste sono le coordinate:",

		UP_DATE : "Aggiornamento dati",

		ADD_MEMBER : "È stato aggiunto un membro: ",

		REMOVE_MEMBER : "È stato rimosso un membro: ",
		...
		SETTINGS : [
			...
			"Imposta l\'allineamento con [font] per il BBCode",
		...
		SETTINGS_TITLE : {
			...
			HEAD : "Esporta Impostazioni",

			COLOR :"Colore",

			COLORIG : "Vista Evoluzione",

			SIZE : {

				COL : "larghezza colonna",

				COL_HTML : "HTML (px)",

				COL_BBCODE : "BBCODE (carattere)",

				MAX : "Massima dimensione",
		...
		SUMMARY : {
			...
			EVOL : ["Evoluzione punti", "Evoluzione classifica", "Percentuale dell'evoluzione"],

			BEST : "Miglior progresso",

			WORST : "Peggior progresso"
