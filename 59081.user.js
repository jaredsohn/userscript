...
// @name           Truchinga?-Bar
// @namespace      Truchinga?
// @description    barra similar a la del facebook para Truchinga?
// @include        *truchinga.org*
// ==/UserScript==
...
divbuscador.innerHTML='<form method="post" action="http://www.truchinga.org/?action=search2/"><span style="position:absolute;top:2px;left:7px;height:18px;padding-right:5px;padding-top:0px;float:left;"><input type="text" name="q" style="font-size:10px;height:13px;text-color:black;padding-top:3px;border:0px;margin:0px;"></span><span style="position:absolute;top:2px;right:7px;height:18px;text-align:center;padding-right:5px;padding-top:0px;"><input type="image" src="http://www.lea87crzz.unlugar.com/barrat/lupa.PNG" style="border:0px;height:12px;"></span></form>';
...
showmenu.innerHTML='<div class="link"><div class="link_titulo"><span class="categoria Truchinga?" title="Inicio"></span> <a href="javascript:location.href=\'http://www.truchinga.org/\';" target="_self" title="Inicio" class="box_link"><b>Inicio</b></a></div></div>';
showmenu.innerHTML+='<div class="link"><div class="link_titulo"><span class="categoria Truchinga?" title="Inicio"></span> <a href="javascript:location.href=\'http://www.truchinga.org/?action=post;board=4/\';" target="_self" title="Inicio" class="box_link"><b>Agregar un post</b></a></div></div>';
...
divultimoscom.innerHTML="<b>Ultimos comentarios Truchinga? ></b>"
  ...
  onload: function(response) {
    // Inject responseXML into existing Object if not present
      ...
      h = response.responseText;
                                        ...
                                        showcomm.innerHTML="<h2><b>UIltimos comentarios de Truchinga?</b></h2>"+h;
...
if(document.body.innerHTML.indexOf("box_txt show_error")<0)
 {
   ...
   addUltimosPosts(titulo,"http://www.truchinga.org/"+id,categoria)
