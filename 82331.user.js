...
// @name           Favourites-Horizontal-Clean-Comments
...
function main() {
	$('<h3>').html('Comments').css('margin-bottom','-1.5em').css('margin-top','2em').insertAfter('#invites');
	addGlobalStyle('li.fave-block,li.group-invite-block { display:none }');
	addGlobalStyle('img.comment-buddy-icon,div.comment-icon {height:48px;width:48px}');
	addGlobalStyle('div.comment-content {margin-left:24px}');
	addGlobalStyle("#comments h3 { display:none}");
