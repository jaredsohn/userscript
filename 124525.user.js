// ==UserScript==
// @name            The West - TW Pro+ [ColorMe]
// @namespace       http://userscripts.org/scripts/show/92414
// @description     Script for The-West: TW Pro+ [SOM - Scripts-O-Maniacs] [Multilingual] (v3.1.0.8)
...
/*	  function a(){
  ...
  function appliquer_couleur(texte) {
     var couleurs = { 2: '007', 3: '700', 4: '031', 5: '775', 6: '704', 7: '409', 8: '608', 10: colorTxt.custColor };
     var couleur = '';
		 ...
		 switch (colorTxt.colorTag) {
		   ...
		   case 3:
			 ...
			 if (this.BFred == 1) {
			   ...
			   texte = '/775*' + ' /000[ /900' + texte.toUpperCase() + '/000 ]' + ' /775*';
			   couleurs[3] = '900';
			 }
		   default:
...
if (f<c) {if (texte.substring(z,k) == ' ') {szoveg=szoveg + '/' + szinkod + texte.substring(z,k);z++;k++;} else {szoveg=szoveg + '/' + szinkod + texte.substring(z,k);z++;k++;szinkod=szinkod+11; if (szinkod>=139) {f++;}}}
else {if (texte.substring(z,k) == ' ') {szoveg=szoveg + '/' + szinkod + texte.substring(z,k);z++;k++;} else {szoveg=szoveg + '/' + szinkod + texte.substring(z,k);z++;k++;szinkod=szinkod-11; if (szinkod<=106) {f--;}}
...
if (f<c) {if (texte.substring(z,k) == ' ') {szoveg=szoveg + '/' + szinkod + texte.substring(z,k);z++;k++;} else {szoveg=szoveg + '/' + szinkod + texte.substring(z,k);z++;k++;szinkod=szinkod+10; if (szinkod>=348) {f++;}}}
else {if (texte.substring(z,k) == ' ') {szoveg=szoveg + '/' + szinkod + texte.substring(z,k);z++;k++;} else {szoveg=szoveg + '/' + szinkod + texte.substring(z,k);z++;k++;szinkod=szinkod-10; if (szinkod<=308) {f--;}}
...
if (f<c) {if (texte.substring(z,k) == ' ') {szoveg=szoveg + '/' + szinkod + texte.substring(z,k);z++;k++;} else {szoveg=szoveg + '/' + szinkod + texte.substring(z,k);z++;k++;szinkod=szinkod+0; if (szinkod>=775) {f++;}}}
else {if (texte.substring(z,k) == ' ') {szoveg=szoveg + '/' + szinkod + texte.substring(z,k);z++;k++;} else {szoveg=szoveg + '/' + szinkod + texte.substring(z,k);z++;k++;szinkod=szinkod-0; if (szinkod<=775) {f--;}}
...
if (f<c) {if (texte.substring(z,k) == ' ') {szoveg=szoveg + '/' + szinkod + texte.substring(z,k);z++;k++;} else {szoveg=szoveg + '/' + szinkod + texte.substring(z,k);z++;k++;szinkod=szinkod+100; if (szinkod>=800) {f++;}}}
else {if (texte.substring(z,k) == ' ') {szoveg=szoveg + '/' + szinkod + texte.substring(z,k);z++;k++;} else {szoveg=szoveg + '/' + szinkod + texte.substring(z,k);z++;k++;szinkod=szinkod-100; if (szinkod<=400) {f--;}}
...
if (f<c) {if (texte.substring(z,k) == ' ') {szoveg=szoveg + '/' + szinkod + texte.substring(z,k);z++;k++;} else {szoveg=szoveg + '/' + szinkod + texte.substring(z,k);z++;k++;szinkod=szinkod+10; if (szinkod>=150) {f++;}}}
else {if (texte.substring(z,k) == ' ') {szoveg=szoveg + '/' + szinkod + texte.substring(z,k);z++;k++;} else {szoveg=szoveg + '/' + szinkod + texte.substring(z,k);z++;k++;szinkod=szinkod-10; if (szinkod<=120) {f--;}}
...
if (f<c) {if (texte.substring(z,k) == ' ') {szoveg=szoveg + '/' + szinkod + texte.substring(z,k);z++;k++;} else {szoveg=szoveg + '/' + szinkod + texte.substring(z,k);z++;k++;szinkod=szinkod+100; if (szinkod>=699) {f++;}}}
else {if (texte.substring(z,k) == ' ') {szoveg=szoveg + '/' + szinkod + texte.substring(z,k);z++;k++;} else {szoveg=szoveg + '/' + szinkod + texte.substring(z,k);z++;k++;szinkod=szinkod-100; if (szinkod<=199) {f--;}}
