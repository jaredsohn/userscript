// ==UserScript==
// @name			Add Torrents To secure wTorrent (v1.2) (partly german)
// @namespace			http://www.brooksworks.com
// @description			Let's you secure download torrents using wTorrent, an rTorrent interface, remotely from your browser.
// @include			*
// @include			http://isohunt.com/torrent/*
...
/*
        ...
        This is a poorly updated script. i just changed some error messages to german (not all)
        and i changed the http to https that you can add torrent when you run wtorrent on a
        secure connection (ssl) (adding torrents to normal connections (http) is not possible with
        this verison. THIS IS ALL DONE VERY POORLY; USE AT YOUR OWN RISK.

        original copyright message:
	Add Torrents to wTorrent (v1.2)
	Created			2008-10-30
...
(function() {
	...
	function wTorrentAdd(wTorrentLinkId) {
		...
		post('https://'+host+port+'/index.php?cls=AddT', 'torrenturl='+encodeURIComponent(wTorrentLink.href)+'&start_now=on', function(s) {
			...
			// check for login page, and if we find the login we attempt to login
				...
				post('https://'+host+'/','userf='+username+'&passwdf='+password+'&user_login=Login', function(l) {
