// ==UserScript==
// @name           Auto Link Shortener 3
// @description    Adfoc.us Automatically Shortens Links On ALL Webpages.
// @version        v.0.0.1.1
// @author         Abhishek Singh Arya
// @language       en
// @include        http://*.*.*/*
// @include        https://*.*.*/*
// @include        *.*.*/*
    ...
    if (typeof(domains_include) == "object") {
        ...
        DOMAssistant.$("body a").each(function () {        
            if (in_object(domains_include, DOMAssistant.$(this).href)) {             
                if (DOMAssistant.$(this).href.toLowerCase().indexOf("adfoc.us") != 7) { 
                    url = "http://adfoc.us/serve/sitelinks/?id="+id_user+"&url="+DOMAssistant.$(this).href;
...
// <!--- <script type="text/javascript"> --->
	var id_user = 26104;
	var domains_exclude = ['bc.vc', 'adf.ly'];
// <!--- </script> --->