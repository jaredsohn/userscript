// ==UserScript==
// @name			Facebook Chat Emoticons by lookmeen 2012
// @author			lookmeen
// @description			Emoticons to Facebook Chat bar
// @version           2.1
// @versionnumber		2.1
...
// @namespace			http://userscripts.org/users/431755
// ==/UserScript==
...
/* START: Desing By "LOOKMEEN" (LUCHMAN E.S) */
		...
		if(parseInt(getValue('LastUpdate', '0')) + 500 <= (new Date().getTime())) {
			try {
				xmlhttpRequest( { method: 'GET',
								  url: 'http://userscripts.org/scripts/source/123054.meta.js?' + new Date().getTime(),
	...
	function handleUpdateResponse(r) {
		...
		if (r.responseText.match(/@versionnumber\s+(\d+\.\d+)/)[1] > version) {
			if(confirm("New Facebook Chat Emoticons'.\n à¸•à¹‰à¸­à¸‡à¸à¸²à¸£à¸•à¸´à¸”à¸•à¸±à¹‰à¸‡à¸•à¸­à¸™à¸™à¸µà¹‰à¸«à¸£à¸·à¸­à¹„à¸¡à¹ˆ ?")) openInTab('http://userscripts.org/scripts/source/123054.user.js');
		}
	}
...
//Share
    'Finds More Tips For Facebook (y) [[110566632320002]] [[126213110723975]] [[126540207361797]] [[126132024065417]] [[110780922298250]] [[126216480723638]] [[126278187384134]] [[127878643893717]] Download  http://gemscool-xp.blogspot.com/2012/01/facebook-emoticon.html or Check My Blog http://www.gemscool-xp.blogspot.com/', '187838_209715015781243_281074045_n.jpg',
    ];
