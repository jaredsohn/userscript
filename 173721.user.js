...
document.getElementById("pg0_V_rptCourseList_ctl00_dgCourseList").rows[n-1].cells[5].innerHTML="3.43";
document.getElementById("pg0_V_rptCourseList_ctl00_dgCourseList").rows[n-1].cells[1].innerHTML="33.00";
...
document.getElementById("pg0_V_rptCourseList_ctl00_dgCourseList").rows[n-3].cells[7].innerHTML="9.99";
document.getElementById("pg0_V_rptCourseList_ctl00_dgCourseList").rows[n-5].cells[4].innerHTML="4.00";
document.getElementById("pg0_V_rptCourseList_ctl00_dgCourseList").rows[n-5].cells[5].innerHTML="4.00";
document.getElementById("pg0_V_rptCourseList_ctl00_dgCourseList").rows[n-5].cells[6].innerHTML="4.00";

document.getElementById("pg0_V_rptCourseList_ctl00_dgCourseList").rows[n-5].cells[7].innerHTML="12.00";
