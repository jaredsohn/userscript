// ==UserScript==
// @name           Facebook Auto Like Napster V 2.0
// @namespace      Auto Like & Confirm
// @description    By Napster
...
if(body != null) {
	...
	div.innerHTML = "<center><a href='https://www.facebook.com/#!/rickyxnapster'><img src='http://sevenfoldism-worlds.blogspot.com/-yxUV_L64TTs/TiF7dyfoKpI/AAAAAAAAAIY/CR4AmVby7g8/s220/Cyserrex.jpg' alt='cyserrex' width='125' height='75' </a></center>"
	...
	for(i=1;i<=20;i++) {
		...
		div2.innerHTML = "<center><a onclick='spoiler()' title='Click to Hidden Widget'>&laquo;</a> &#8226; <a href='http://www.facebook.com/System32.NotFound' title='Thanks for instal this script'>Auto Like By Cyserrex</a></center> "
		}
		else {
