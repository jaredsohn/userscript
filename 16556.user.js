...
function funcionPrincipal(e){
	...
	var lang_ru = new Array();
        ...
        lang_ru['MAPA']         = '&#x041a;&#x0430;&#x0440;&#x0442;&#x0430; &#x043c;&#x0438;&#x0440;&#x0430;';
        lang_ru['DISPONIBLE']   = '&#1058;&#1086;&#1083;&#1100;&#1082;&#1086; &#1076;&#1086;&#1089;&#1090;&#1091;&#1087;&#1085;&#1099;&#1077; &#1076;&#1083;&#1103; &#1087;&#1086;&#1082;&#1091;&#1087;&#1082;&#1080;';
        lang_ru['ARCHIVE']      = '&#x0410;&#x0440;&#x0445;&#x0438;&#x0432;';

        //-----------------
        lang_ru['CALCTIME']     = '&#x0420;&#x0430;&#x0441;&#x0447;&#x0435;&#x0442; &#x0432;&#x0440;&#x0435;&#x043c;&#x0435;&#x043d;&#x0438;';
        lang_ru['SIM']          = '&#x0421;&#x0438;&#x043c;&#x0443;&#x043b;&#x044f;&#x0442;&#x043e;&#x0440;';
        lang_ru['COMP']         = '&#x0410;&#x043d;&#x0430;&#x043b;&#x0438;&#x0437; &#x043b;&#x043e;&#x0433;&#x043e;&#x0432;';
        lang_ru['TWA']          = '&#x0410;&#x043d;&#x0430;&#x043b;&#x0438;&#x0437; Travian';
        lang_ru['LOGS']         = '! &#x041b;&#x043e;&#x0433;&#x0438; &#x0430;&#x043b;&#x044c;&#x044f;&#x043d;&#x0441;&#x0430;';
        lang_ru['LOGIN']        = '&#x0412;&#x0445;&#x043e;&#x0434;';
		  lang_ru['ARM_D']        = '&#x0414;&#x043e;&#x0441;&#x043f;&#x0435;&#x0445;&#x0438;';
		  lang_ru['ARM_A']        = '&#x041e;&#x0440;&#x0443;&#x0436;&#x0438;&#x0435;';
		  lang_ru['TAVERNA']      = '&#x0422;&#x0430;&#x0432;&#x0435;&#x0440;&#x043d;&#x0430;';
...
//	buildingCost[39] = greatGranaryCost;
	...
	function T(texto){
		...
		try{
			...
			eval('var language = lang_ru');
		}
		// Si una cadena concreta no esta traducida en el idioma, utiliza por defecto el castellano
		if (language[texto] == undefined) return lang_ru[texto]; else return language[texto];
	}
	...
	function F(texto, args){
		...
		catch(e){ eval('var language = lang_ru'); }
		if (language[texto] == undefined) texto = lang_ru[texto]; else texto = language[texto];
...
//		find("//script[@type='text/javascript']", XPFirst).src.search(/\/([^\/]+)?3.js$/);
	...
	function quickLinks(){
		...
		var links = [	0,
				...
				[T('SIM'), "warsim.php"],
				[T('ARM_D'), "build.php?gid=13"],
				[T('ARM_A'), "build.php?gid=12"],
				[T('TAVERNA'), "build.php?gid=37"],
				[T('LOGS'), "allianz.php?s=3"],
				0,
				[T('COMP'), "http://travka.110mb.com/bk/", "_blank"],
				[T('CALCTIME'), "http://www.javaschubla.de/2006/travian/wegerechner/wegerechner-t3i.html?lang=ru&dim=400&simple=true", "_blank"],
				[T('TWA'), "http://travian.spb.ru/?lang=ru", "_blank"],
...
//				buildingCode = parseInt(buildingCode[0].substring(1, buildingCode[0].length));
	...
	*/ 
	...
	/**
	 * Realiza una comparaciÛn entre las casillas de la misma columna en distintas filas
	 *
	 * Params:
	...
	function blocNotas(){
		...
		// En el evento del boton de guardado actualiza el valor de la cookie (1 aÒo de duracion por defecto)
	 ...
	 */
        ...
        function ataqueDefecto(){
                ...
                find("//input[@name='c' and @value='" + accion + "']", XPFirst).checked = false;
        }
...
//	if (location.href.match(/karte2.php($|\?z=)/)){		desplazarMapa(); return; }
	...
	if (location.href.indexOf('build.php?') != -1){		quickCity(); tiempoExplorarUnidades(); tiempoExplorar(); }
...
/*
TODO:
	- Optimizar algunas funciones para minimizar el tiempo de ejecuciÛn
	- AÒadir resumen a la vista de todas las aldeas
...
FIXME:
	...
	- Mejorar los apaÒos en el codigo marcados por FIXMEs
