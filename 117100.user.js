...
// @author         raimisyazwan
// @description    
// @credits        Author from various sources.
// ==/UserScript==
...
'</style><div id="wrapper">oFight; is <a id="FHELP" href="#">' + fightx_text + '</a><BR>Autohealer is <a id="AHEAL" href="#">' + aheal_text + '</a><BR>Attack Speed: <input id="killertimingi" type="text" value="444" maxlength="4" style="resize:none;width:35px;" /><BR>Autoheal at: <input id="healati" type="text" value="2500" maxlength="4" style="resize:none;width:35px;"/><br></div>';
...
document.getElementById("AHEAL").onclick = function () {
	...
	function DoAutoHeal(){
		...
		var HealthPCent = parseInt(maxHealth * .30);
