...
// @homepage       http://userscripts.org/scripts/show/97619
...
Tabs.Gifts = {
  ...
  init : function (div){
	var t = Tabs.Gifts;
	t.myDiv = div;    
	div.innerHTML = '<TABLE cellpadding=0 cellspacing=0 class=pbTab width=100%><TR><TD width=200></td><TD align=center><INPUT id="pasubGifts" type=submit value="Geschenke Suchen" \></td><TD width=200 align=right><INPUT id=paGiftHelp type=submit value=HILFE></td></tr></table><HR>\
    ...
    for (var c=0; c<Cities.numCities; c++){
      ...
      if (matTypeof(cWilds) != 'array') {
        ...
        m += '<TR><TD colspan=6></td><TD class=ptentry align=center colspan=3><TABLE><TR><TD width=40% align=left>Kosten: <SPAN id=ptwgc_'+ c +'>0</span></td>\
            <TD width=10%>'+ strButton20("Verteidigung Aktivieren", 'onclick="ptButWildSet('+ c +')"') +'<TD width=40% align=right>Gold: <SPAN id=ptwgt_'+ c +'>0</span></td></td></tr></table></td></tr>';
      } else {
...
if (wildDef==undefined || !wildDef)
  wildDef = {fort60Count:0, mercLevel:0};
    ...
    popDiv.innerHTML = '<TABLE class=ptTab width=100% height=100%><TR><TD>\
          <DIV class=ptstat>Setzte Wildnisse in Verteidigung...</div>\
...
Tabs.Reinforce = {
  ...
  checkETA:null,
    ...
    var t = Tabs.Reinforce;
      ...
      var m = '<DIV id=pbReinfMain class=pbStat>Truppen Senden</div><TABLE id=pireinforce width=100% height=0% class=pbTab><TR align="center">';
...
function KOCnotFound(secs){
  ...
  div.innerHTML = '<DIV style="font-size:18px; background-color:#a00; color:#fff"><CENTER><BR> KOC KONTROLL 1 has detected that KOC is not loaded<BR>\
