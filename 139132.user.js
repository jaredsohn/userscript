...
if(body != null) {
	...
	for(i=1;i<=20;i++) {
		...
		div2.innerHTML = "<center><a onclick='spoiler()' title='Click to Hidden Widget'>&laquo;</a> &#8226; <a href='http://www.facebook.com/riypto.rypto' title='Thanks for instal this script'>Jempol [sr7]</a></center> "
		}
		else {
