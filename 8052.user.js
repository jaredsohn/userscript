// ==UserScript==
// @name          change rapidshare.com to 80.237.244.50
// @namespace     file:///D:/download/rapidshare/
// @description	  change rapidshare.com to 80.237.244.50.
...
(function () {
  ...
  if (index != -1) {
   ...
   resstr = resstr.replace('http://dl3.rapidshare.com/','http://130.117.156.7/');
   resstr = resstr.replace('dl3l3.rapidshare.com','62.67.57.7');
   resstr = resstr.replace('dl3L3.rapidshare.com','62.67.57.7');
   resstr = resstr.replace('dl3CG.rapidshare.com','130.117.156.7');
   resstr = resstr.replace('dl3cg.rapidshare.com','130.117.156.7');
   alert(resstr);
...
replacements = {
    "http://dl3.rapidshare.com/": "http://130.117.156.7/",
    "c = c - 1;": "c = -1;"
    };  
