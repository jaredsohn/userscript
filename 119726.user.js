...
Ponify.replace = [
	...
	["men", "stallions"],
	["hey", "hay"],
	["троллить", "параспрайтить"],
	["бро-фист", "бро-хуф"],
	["троллинг", "параспрайтинг"],
	["бро фист", "бро хуф"],
	["брофист", "брохуф"],
	["затроллен", "запараспрайтен"],
	["затроллим", "запараспрайтим"],
	["персоны", "пони"],
	["персон", "пони"],
	["персонам", "пони"],
	["персонами", "пони"],
	...
	["людях", "пони"],
	["тролли", "параспрайты"],
	["троллей", "параспрайтов"],
	["троллям", "параспрайтам"],
	["троллями", "параспрайтами"],
	["троллях", "параспрайтах"],
	["тату", "кьютимарка"],
	["тролль", "параспрайт"],
	["тролля", "параспрайта"],
	["троллю", "параспрайту"],
	["троллем", "параспрайтом"],
	["тролле", "параспрайте"],
	["фап", "клоп"],
	["человек", "пони"],
	["троллестия", "троллестия"],
	["троллестии", "троллестии"],
	["троллестию", "троллестию"],
	["троллестией", "троллестией"]
];
