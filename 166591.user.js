...
//@description works on http://ultoo.in with Faster & New random poll submition method added
// @namespace  ultoo
// @include     http://ultoo.in/*
// @include     http://adf.ly/*
// @include     https://www.facebook.com/*
// @include     http://www.videoodownload.com/*
...
pattern=/^http:\/\/ultoo.in\/mywallet.php/g;
...
if (path == "/poll.php")
{
  ...
  setTimeout("window.location.href = \"http://ultoo.in/poll.php?zxcoiesesscd=\";",250);
}
...
//debugger;
	...
	if (p[12].defaultValue == "Submit")
	   ...
	   //setTimeout("window.location.href = \"http://ultoo.in/AnswereIt.php?zxcoiesesscd=\";",200);
}
...
var pattern=/^http:\/\/ultoo.in\/AICompletion.php/g;
if(url.search(pattern)==0)
{
