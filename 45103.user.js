// ==UserScript==
// @name            Fok! 13.gif/14.gif vervanger
// @namespace       TimKuik
// @include         http://forum.fok.nl/topic/*
// ==/UserScript==
function do_platypus_script() {
do_modify_html_it(window.document,document.evaluate('/HTML[1]/BODY[1]', document, null, XPathResult.FIRST_ORDERED_NODE_TYPE,null).singleNodeValue,/ 14.gif/g,' <img src=http://i.fokzine.net/templates/new/i/p/14.gif border=0>',null);

do_modify_html_it(window.document,document.evaluate('/HTML[1]/BODY[1]', document, null, XPathResult.FIRST_ORDERED_NODE_TYPE,null).singleNodeValue,/ 13.gif/g,' <img src=http://i.fokzine.net/templates/new/i/p/13.gif border=0>',null);
