...
s+= "div, table, td, th, .heading{background:!important; border:0px!important;}\n";
s+= "*{font-family:tahoma}\n";
s+= "a[id*='friendImageLink']:hover img {border:0px solid #b0bfd4!important;}\n";
s+= "a[id*='friendImageLink'] img {border:0px solid #}\n";
s+= "#header {visibility:hidden}\n";
s+= "#header .right {visibility:visible; color:#pink; position:relative; top:118px;}\n";
s+= "#header .right a {font-weight:normal!important}\n";
s+= ".section {border:1px solid green!important;background-color:!important;padding:2px;}\n";
...
s+= "#home_infoBar strong {display:block; color:; font-weight:bold; margin-top:4px}\n";
...
s+= "#home_friends .heading {font-size:11pt!important; font-weight:bold!important; color:}\n";
