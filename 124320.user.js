// ==UserScript==
// @name            HackForums TahomaBold - Green
// @namespace       JaxonHF/hftahomagreen
// @description     Makes text tahoma and green.
...
function form_submit(event) {
   ...
   for (var i = arTextareas.length - 1; i >= 0; i--) {
	   ...
	   elmTextarea.value = "[color=#00953C][font=tahoma][b]" + elmTextarea.value + "[/font][/color][/b]";
   }
