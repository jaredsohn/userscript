// ==UserScript==
// @name            Plaxo 3 Hide Premium Platypus
// @namespace       Platypus
// @description 	Removes De-Duper, eCards and Mobile tabs and the Plaxo Premium Vertical Bar.
// @include         http://preview.plaxo.com/po3/*
function do_platypus_script() {
remove_it(window.document,document.getElementById('header_deduper'),null,null,null);
remove_it(window.document,document.getElementById('header_ecard'),null,null,null);
remove_it(window.document,document.getElementById('header_mobile'),null,null,null);
remove_it(window.document,document.getElementById('plaxo_ad'),null,null,null);
