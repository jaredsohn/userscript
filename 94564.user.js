// ==UserScript==
// @name           OGame Redesign: Simple Calc (mod.)
// @namespace      Baracs
// @version        1.04
// @description    Replaces the officer icons with a simple and useful calculator. I only modified some layaout details, now it looks better under Tampermonkey in Google Chrome too. Original script: http://userscripts.org/scripts/review/74888
// @include        http://*ogame.*
// ==/UserScript==
/*
06.05.2010 v1.04
...
divContent.innerHTML = '<form name="myform" onSubmit="return false;" onKeyPress="evalOnEnter(event,this.form);"><center><input type="text" name="display" size="45" style="font-size:10px; height:12px; border:2px solid; border-color:#262a2f"> <br/> <input type="button" value="   =   " onClick="myform.display.value=eval(myform.display.value)"></center></form>';
...
calcCost.innerHTML = "Calculates the cost for the #<br/>of ships/defense.<br/>";
