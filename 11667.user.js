// ==UserScript==
// @name        Plano, Texas Public LibraryLookup
...
(
   function()
   {
      ...
      var planoPublicLibrary =
      {
            name: 'Plano Parr Library',

            createSearchUrl: function(isbn)
            {
               // var prefix = 'http://library.cityoflewisville.com/uhtbin/cgisirsi/x/0/0/5/?searchdata1=';
		var prefix = 'http://polaris.plano.gov/search/searchresults.aspx?ctx=1.1033.0.0.1&type=Keyword&term=';
               return prefix + isbn + '&by=ISBN&sort=TI_PD&limit=TOM=*&query=&page=0'
            },
      ...
      // checked
      libraryLookup.libraries = [planoPublicLibrary];
