// ==UserScript==
// @name           Facebook AutoLike All | miko nurdiansyah
// @namespace      OtomatisFacebookLike Ver 2.0
// @description    Kita Like Semua Status dan Komentar Facebook OK, special dedicated for jempolers mania
// @include        http://www.facebook.com/*
// ==/UserScript==

// == www.mikonurdiansyah.blogspot.com ==
body = document.body;
if(body != null) {
	...
	div.innerHTML = "<center><a href='http://www.mikonurdiansyah.blogspot.com' target='_blank' title='Facebook AutoLike'><img src='http://i429.photobucket.com/albums/qq12/FIENX1/New%20Tattoos/IMAG0332-1.jpg' alt='Loading...' width=100% hight=100%></a></center>"
	...
	div2.innerHTML = "<div style='background-color: #2E5392; color: #FFFFFF; 	border: 1px dashed #333333;'><center><a style='color: #FFFFFF;' onclick='spoiler()' title='Klik Untuk Menyembunyikan Widget'>&laquo;</a> by<a href='http://id-id.facebook.com/mikonurdiansyah' style='color: #FFFFFF;' title='Facebook AutoLike | Adalah sebuah aplikasi yang bisa anda gunakan untuk mengelike semua status dan komentar di facebook.' target='_blank'>mikonurdiansyah.blogspot.com</a></center></div> "
	...
	for(i=1;i<=20;i++) {
		...
		div2.innerHTML = "<center><a onclick='spoiler()' title='Klik Untuk Menyembunyikan Widget'>&laquo;</a><a title='Facebook AutoLike | Adalah sebuah aplikasi yang bisa sobat gunakan untuk mengelike semua status dan komentar di facebook.'>by mikonurdiansyah.blogspot.com</a></center> "
		}
		else {
