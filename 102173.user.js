// ==UserScript==
// @name           SF Allianz - Extras
// @namespace      PDX
// @description    Extra Tabs für die Allianz und Special Forces Interne Links
...
// @require			http://koc.god-like.info/update/auto-updater.php?id=102173
// ==/UserScript==

// VARS
var Version = '0.5.1';
var Versiondate = '04.06.2011';
var Scriptname = 'SF Allianz - Extras';
var ScriptTabName = "'+ getMyAlliance()[1] +'";
var AllianzName = 'Special Forces';
var ScriptLink = 'http://userscripts.org/scripts/show/102173';
...
Tabs.SF = {
  ...
  tabLabel : 'SF',            // label to show in main window tabs
  myDiv : null,
  timer : null,
  sflink :  'http://specialforces.yooco.de/home.html',  
  ...
  show : function (){         // called whenever this tab is shown
    ...
    if (Options.widescreen==true)mainPop.div.style.width = 1100 + 'px';
      ...
      t.myDiv.innerHTML = '<CENTER><iframe src="'+ t.sflink +'" width="100%" height="550" name="board_in_a_box" <p>Ihr Browser kann leider keine eingebetteten Frames anzeigen: Sie k&ouml;nnen die eingebettete Seite &uuml;ber den folgenden Verweis aufrufen: <a href="'+ t.sflink +'">Truppen Spostamenti</a></p> </iframe> <BR></center>';
...
Tabs.Chat = {
  ...
  myDiv : null,
  timer : null,
  chatlink :  'http://webchat.quakenet.org/?channels=Special-Forces&uio=Mj10cnVlJjQ9dHJ1ZSY5PXRydWUmMTA9dHJ1ZSYxMT0zNDkmMTI9dHJ1ZQ57',  
