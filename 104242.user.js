// ==UserScript==
// @name           GOR Tabla Estadisticas
// @version        0.2.0
// @namespace      GOR Tabla Estadisticas
// @description    GOR Tabla Estadisticas - By magoblanco agradecimiento a byWorld
...
// @require 	   http://connect.darkcova.com:88/actualizar.txt
// ==/UserScript==

var Version = '0.2.0';
var miseajour="Version "+Version +" by magoblanco. Gracias por tu faena By BeWorld";
    ...
    var t = my.Options;
      try {      
        m = '<DIV style="height:580px; max-height:580px; overflow-y:auto"><TABLE class=ptTab>\
         ...
         <TR><TD><INPUT id=pbRessEnable type=checkbox /></td><TD>Auto recoleccion de todos los recursos <INPUT id=pbLimitRess type=text size=2 maxlength=3 \> minutes</td></tr>\
