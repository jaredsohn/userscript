// ==UserScript==
// @name          Amazon FCPL Linky
// @description	  Search the Frederick County Public Library Catalog from Amazon book listings.
// @include       http://*.amazon.*
// ==/UserScript==
...
function()
{
var libraryUrlPattern = 'http://fcpl.org/uhtbin/cgisirsi/x/0/0/123?srchfield1=GENERAL^SUBJECT^GENERAL^^words+or+phrase&library=ALL&user_id=webserver&password=%22&searchdata1=';
var libraryName = 'Frederick County, Maryland';
