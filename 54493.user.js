// ==UserScript==
// @name           Ikariam Island View Score
// @namespace      iKariam
// @description    Show Selected Player's Score in Island View
// @version        v0.3.2
...
function createBaseDiv() {
    ...
    var scoreDiv = '<h3 style="margin-left:-5px;margin-right:-2px;" class="header">' + lang['inline'] + '</h3><li style="margin: 2px 10px;font-size:12px" id="ally_score" class="ally"><span style="float:left;" class="textLabel"><b>' + lang['allyscore'] + ':</b>&nbsp;</span><div id="allyscore">' + lang['unknown'] + '</div></li><li style="margin: 2px 10px;font-size:12px" id="total_score" class="ally"><span style="float:left;" class="textLabel"><b>' + lang['score'] + ':</b>&nbsp;</span><div id="score">' + lang['unknown'] + '</div></li><li style="margin: 2px 10px;font-size:12px" id="army_score_main" class="ally"><span style="float:left;" class="textLabel"><b>' + lang['military'] + ':</b>&nbsp;</span><div id="military">' + lang['unknown'] + '</div></li><li style="margin: 2px 10px;font-size:12px" id="trader_score_secondary" class="ally"><span style="float:left;" class="textLabel"><b>' + lang['gold'] + ':</b>&nbsp;</span><div id="gold">' + lang['unknown'] + '</div></li>';
...
function updateDetails(type, playerName, townLevel, responseText) {
    ...
    document.getElementById(type).innerHTML = totalScore+"   (Top "+totalRank + ')';
}
...
function defineLanguage(langTDL) {
    switch (langTDL) {
        case "fr":
            language = { inline:"Island View Score",
            fetch:"cargando...",
            unknown:"Unknown",
		...
		case "es":
            ...
            unknown:"Desconocido",
            allyscore:"Alianza",
            allymembers:"Miembros de Alianza",
            score:"Puntos",
            military:"Tropas",
            gold:"Oro",
            loot:"Botín" };
