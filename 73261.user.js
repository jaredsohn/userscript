...
// @namespace      ngbbswars@snakehole.net - aniz@anizmation.com
...
var auraWars = '';
	...
	auraWars += '<span id="ngAuraFab" style="display:block; overflow: hidden; width:0%; float:left; text-align:center; background-color:rgb(195,80,176)">&nbsp;</span>';	// Fab
	auraWars += '<span id="ngAuraLight" style="display:block; overflow: hidden; width:0%; float:left; text-align:center; background-color:rgb(41,128,187)">&nbsp;</span>'; // Light
	auraWars += '<span id="ngAuraNeutral" style="display:block; overflow: hidden; width:0%; float:left; text-align:center; background-color:rgb(45,152,2)">&nbsp;</span>'; // Neutral
	auraWars += '<span id="ngAuraEvil" style="display:block; overflow: hidden; width:0%; float:left; text-align:center; background-color:rgb(154,13,13)">&nbsp;</span>'; // Evil
	...
	auraWars += '<span id="ngAuraMod" style="display:block; overflow: hidden; width:0%; float:left; text-align:center; background-color:rgb(241,201,17);color:#000">&nbsp;</span>'; // Mod
