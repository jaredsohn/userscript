// ==UserScript==
// @name            Ubi Forums Poeh Inserter
// @namespace       Ubi Forums
// @include         http://forums*.ubi.com/*
// @description     Changes the string ":Poeh:" to the according smiley.
// ==/UserScript==
function do_platypus_script() {
do_modify_url_it(window.document,'/HTML[1]',/http:\/\/www\.sandportal\.de\//g,'http://www.princeofpersia-game.de/',true);
do_modify_html_it(window.document,document.evaluate('/HTML[1]/BODY[1]/DIV[1]/DIV[1]', document, null, XPathResult.FIRST_ORDERED_NODE_TYPE,null).singleNodeValue,/\:Poeh\:/g,'<img src="http://s1.directupload.net/images/080915/xw6ts6eg.gif">',null);
