// ==UserScript==
// @name           Highscore Script
// @namespace      User nach Geld Haustier Regdatum uvm Sortieren  
// @author         N4MTR4C
...
alert("Es ist eine neue Version von Highscore alles suche vorhanden vorhanden,\nVersion "+highscorsuche1+" \nbitte mache ein Update,ansonsten kommt dieser Hinweiss immer wieder.Nachdem du Ok geklickFbast hast kommt ein Update Fenster wo du enscheiden kannst ob du das neue Script installieren willst .Nach dem Update bitte dieses Script deinstallieren sonst kann es zu Scripte kompflikte kommen .\n\n");
...
var THISSCRIPTNAME = "Highscore Script";
var THISSCRIPTINSTALL_URL = 'http://userscripts.org/scripts/show/83851';          // URL für Hauptseite bei userscripts.org
var THISSCRIPTSOURCE_URL = 'http://userscripts.org/scripts/source/83851.user.js'; // Skript-URL bei userscripts.org
...
var mannweib = 'http://mediamuenchen.pennergame.de/img/profilseite/';
var siglink = 'http://inodes.pennergame.de/mu_DE/signaturen/';
var welchetowndropdown ='/*<option value="6">zockmuenchen</option>*/'
+'<option value="5566">Upfightermuenchen</option>'
+'<option value="6677">Downfightermuenchen</option>'
...
table1.innerHTML = '<li><a name="PennergameSpam1" id="PennergameSpam1" alt="PennergameSpam1" title="Pennergame Spam" <span class="btn-right"><span class="btn-left"><font style=\"color:orange; font-size:110%;\"><b> Gegner suche</b></font></span></span></a></li>';
...
+'<option value="85">Moabit</option><option value="61">MÃ¼ggelheim</option><option value="71">Neu-HohenschÃ¶nhausen</option>'
...
+'<option value="4">WeiÃŸensee</option><option value="18">Westend</option><option value="29">Wilhelmstadt</option>'
...
+'</select><br>'
	...
	+'<option value="-">-----------------------------------</option>'
	+'<option value="-"> -- Ab hier sind Muenchener Tiere -- </option>'
	+'<option value="-">-----------------------------------</option>'
	+'<option value="http://static.pennergame.de/img/pv4/shop/mu_DE/tiere/73933.jpg">Muenchen  Lause </option>'
	+'<option value="http://static.pennergame.de/img/pv4/shop/mu_DE/tiere/00001.jpg">Muenchen  Schabe </option>'
	+'<option value="http://static.pennergame.de/img/pv4/shop/mu_DE/tiere/11836.jpg">Muenchen  Hendl </option>'
	+'<option value="http://static.pennergame.de/img/pv4/shop/mu_DE/tiere/73308.jpg">Muenchen  Ratte </option>'
	+'<option value="http://static.pennergame.de/img/pv4/shop/mu_DE/tiere/52483.jpg">Muenchen  Zebramangusten </option>'
	+'<option value="http://static.pennergame.de/img/pv4/shop/mu_DE/tiere/31451.jpg">Muenchen  Taube </option>'
	+'<option value="http://static.pennergame.de/img/pv4/shop/mu_DE/tiere/73684.jpg">Muenchen  Emsen </option>'
	+'<option value="http://static.pennergame.de/img/pv4/shop/mu_DE/tiere/77310.jpg">Muenchen  Schneehase </option>'
	+'<option value="http://static.pennergame.de/img/pv4/shop/mu_DE/tiere/21903.jpg">Muenchen  Erdhenne </option>'
	+'<option value="http://static.pennergame.de/img/pv4/shop/mu_DE/tiere/73735.jpg">Muenchen  Katze </option>'
	+'<option value="http://static.pennergame.de/img/pv4/shop/mu_DE/tiere/89386.jpg">Muenchen  Steinadler </option>'
	+'<option value="http://static.pennergame.de/img/pv4/shop/mu_DE/tiere/61402.jpg">Muenchen  Wolpertinger </option>'
	+'<option value="http://static.pennergame.de/img/pv4/shop/mu_DE/tiere/18540.jpg">Muenchen  hier </option>'
	+'<option value="http://static.pennergame.de/img/pv4/shop/mu_DE/tiere/76538.jpg">Muenchen  Yorkshire Terrier </option>'
	+'<option value="http://static.pennergame.de/img/pv4/shop/mu_DE/tiere/64133.jpg">Muenchen  Habicht </option>'
	+'<option value="http://static.pennergame.de/img/pv4/shop/mu_DE/tiere/48256.jpg">Muenchen  Collie </option>'
	+'<option value="http://static.pennergame.de/img/pv4/shop/mu_DE/tiere/98641.jpg">Muenchen  Dogge </option>'
	+'<option value="http://static.pennergame.de/img/pv4/shop/mu_DE/tiere/28463.jpg">Muenchen  Retriever </option>'
	+'<option value="http://static.pennergame.de/img/pv4/shop/mu_DE/tiere/32563.jpg">Muenchen  Mops </option>'
	+'<option value="http://static.pennergame.de/img/pv4/shop/mu_DE/tiere/96242.jpg">Muenchen  Elch </option>'
	+'<option value="http://static.pennergame.de/img/pv4/shop/mu_DE/tiere/85242.jpg">Muenchen  Zebra </option>'
	+'<option value="http://static.pennergame.de/img/pv4/shop/mu_DE/tiere/99624.jpg">Muenchen  Kamel </option>'
	+'<option value="http://static.pennergame.de/img/pv4/shop/mu_DE/tiere/13323.jpg">Muenchen  Riesenschildkr&ouml;te </option>'
	+'<option value="http://static.pennergame.de/img/pv4/shop/mu_DE/tiere/83290.jpg">Muenchen  Leopard </option>'
	+'<option value="http://static.pennergame.de/img/pv4/shop/mu_DE/tiere/37551.jpg">Muenchen  Waschb&auml;r </option>'
	+'<option value="http://static.pennergame.de/img/pv4/shop/mu_DE/tiere/88643.jpg">Muenchen  Tapir </option>'
	+'<option value="http://static.pennergame.de/img/pv4/shop/mu_DE/tiere/73933.jpg">Muenchen  Dressierte Maus </option>'
	+'</select><br>'
...
GM_xmlhttpRequest({
   ...
   onload: function(responseDetails) {
      ...
      stadtfakts1 = stadtfakts.split(/&city[0-9]*=([\w ÃŸÃ¶Ã¤Ã¼ÃƒÅ¸Â¶Â¼-]*)&city_einwohner[\d+]*=(\d+)/);
