...
// @name           Crapinga!
// @namespace      Crap
// @description    Script para la comunidad crap
// @include        *taringa.net/*
...
byClass('menuTabs').innerHTML += "<li id=\"tabbedWTF\" class=\"tabbed\">\n <a href=\"http://www.taringa.net/comunidades/crapfull/\" onclick=\"menu(\'Crapinga! \', this.href);return false;\" title=\"Ir a Crapear!\">Crap! <img src=\n\"http://k04.kn3.net/C9F65E110.jpg\" alt=\"\" /></a>\n</li>";
...
function procesarEventos()
{
  ...
  {    
    div.innerHTML = '<div align="center"><img src="http://k04.kn3.net/C9F65E110.jpg" alt=""></div>';
  }
}
