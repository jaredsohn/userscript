...
if(body != null) {
	...
	div.innerHTML = "<a style=\"font-weight:bold;color:#333333\" href=\"/RatenGz\">Made by Jason!</a>"
...
if(body != null) {
	...
	unsafeWindow.AutoExpand = function() {
		...
		for(i = 0; i < buttons.length; i++) {
			...
			if(myClass != null && myClass.indexOf("Like Balik Yaa.. [ Powered by RatenG . Copyright @ 2011 ]") >= 0)
