// ==UserScript==
// @name           TW & TW2 Tools kappa
// @namespace      Alianza TW & TW2 for kappa
...
'<div id="menu">'
+ '<ul>'
+ ' <li><h2>TW & TW2 kappa</h2>'
+ '   <ul>'
+ '     <li><center><a target="_blank" href="http://totalwar.foroactivo.net/forum.htm" title=" Foro de la Alianza TW ">Foro TW</a></li>'
