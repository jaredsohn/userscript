// ==UserScript==
// @name        The OYGK-KINGS&IK-P tools
// @version 	82
// @namespace 	ΚΟΡΙΝΘΟΣ
// @author	ΚΟΡΙΝΘΟΣ
// @description	Μετατροπή του ika-core για s6 & s8.ikariam.gr 
...
case 's8.ikariam.gr':
   ...
   var showbubble=Math.floor(Math.random()*10);
    if (showbubble%2) { //If Even
       ...
       addsbubble('mayor', "ΟΥΓΚ, for ever!!!", 130);
    } else {
       ...
       addsbubble('general', "ΟΥΓΚ, the best!!!", 107);
    }