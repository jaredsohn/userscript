...
// @description    Interface Enhancement of Astroempires (Ver:2.06)
    ...
    ShowQueryMSG("TRUE");
 	  ...
 	  //****************************************************
		function GetTotalTradingPartners(){
    		var arrCells2 = document.getElementsByTagName('th');
    		   ...
    		   strValue = arrCells2[idx].innerHTML;
    			 ...
    			 if (strValue.match("involved in trading")){
    				  TotalPlayersTrading = strValue.split("=");
    					TotalPlayersTrading = trim(TotalPlayersTrading[2]);
             ...
             var ResponseVar = response.responseText;
    				 ...
    				 if (trimmed=='FAILED'){
    				   if (x1==x2){
						 ...
						 if (sPlanetCountDone==sTotalPlanetCount){
							 checkTradePage();				 
							 ShowQueryMSG("FALSE");
						 }
    		}
