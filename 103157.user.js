// ==UserScript==
// @name           Gifs a la orden!!!
// @namespace      Gifs
// @description    Script para la comunidad gifs a la orden!!!
// @include        *taringa.net/*
// @exclude        *taringa.net/comunidades/gifs-a-la-orden/*
// ==/UserScript==
...
byClass('menuTabs').innerHTML += "<li id=\"tabbedWTF\" class=\"tabbed\">\n <a href=\"http://www.taringa.net/comunidades/gifs-a-la-orden/\" onclick=\"menu(\'Gifs a la orden!!! \', this.href);return false;\" title=\"Ir a la comunidad Gifs a la orden!!!\">Gifs a la orden!!! <img src=http://o2.t26.net/images/arrowdown.png\n\"\" alt=\"\" /> </a>\n</li>";
