// ==UserScript==
// @name           Gestionnaire de coordonées (légal)
// @namespace      Ikariam
...
version = document.getElementById('GF_toolbar').getElementsByTagName('li')[7].getElementsByTagName('span')[0].innerHTML;
if(version=="v.0.3.1"){
    var nom=new Array();
...
{
if(!GM_getValue('version')){GM_setValue('version','bloque');alert('Suite à la nouvelle version, ce script devient non autorisé, le script ne fonctionnera donc plus ...');}
}