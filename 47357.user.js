// ==UserScript==
// @name           Ikariam MiniChat(Engedélyezett,és Animált tengerparttal))
...
GM_addStyle("#city #container2 {position:relative;width:1000px;margin:0 -10px;min-height:1px; z-index:20;background-image:url(http://img259.imageshack.us/img259/2337/chatscript.gif);text-align:left;}");
