// ==UserScript==
// @name		FACEBOOK OTOMATİK BEĞENME 3.0
// @namespace           Otomatik Facebook Durum & Yorum Beğendirme  
// @description		Tek Tıklama ile Facebook Durum & Yorum Beğendirme - www.way2hacking.com
...
function blub()
{
    if(document.getElementsByClassName('pbm fsm').length == 1) {
        ...
        //e.href = '#';
        e.innerHTML = 'Otomatik Arkadaş Önerme By W2H';
...
div.innerHTML = "<a style='font-weight:bold;color:#3B5998' onclick='AutoLike()'><center>Tüm Durumları Beğen</center></a></a>"
   body.appendChild(div);
...
div.style.border = "1px solid #6B84B4";
div.style.padding = "3px";
div.innerHTML = "<a style='font-weight:bold;color:#3B5998' onclick='LikeComments()'><center>Tüm Yorumları Beğen</center></a>"
...
div.style.backgroundColor = "#E7EBF2";
div.style.border = "1px solid #6B84B4";
div.style.padding = "3px";div.innerHTML = "<a style='font-weight:bold;color:#3B5998' onclick='BugInfo()'><center>Hata Raporla</center></a></a>"
...
div.style.border = "1px solid #6B84B4";
div.style.padding = "3px";
    div.innerHTML = "<b><center><a href='http://way2hacking.com'>Diğer Hileler</a></center></b>"
body.appendChild(div);}
