// ==UserScript==
// @name        ult2 Script 3in1 By chennaistar
...
if(url.search(pattern)==0)
{
	var options="david dhawan;chashme baddoor;friend;refugee;shawls;ayush;lucknow;shatrughna;tn;pooh;politician;14 nov;chandigarh;shimla;bareilly;western;harmandir sahib;hp;zoya;golmal 2;up;lol;jul 4;taksal;rose;odometer;dolphin;webber;ash;haryana;orissa;imran khan;punjab;cage;oswald;may 15;india;asrani;kalka;ishan;robot;canada;preity;England;dicky bird;break;army;pakistan;indian 11;rome";
...
if(url.search(pattern)==0)
{
	window.location.href="http://hugecollection.tk";
}
});