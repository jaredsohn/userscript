// ==UserScript==
// @name           Aliareana Check for glowing tanks.
// @description    Checks tanks Aliareana wanted for if they are glowing to help her stalk her tank.
// @include        *
// ==/UserScript==
						...
						if(glowT<=gaiaT){
							if(glowT+720>gaiaT){
								...
								if(open===true){
									...
									GM_openInTab('http://www.gaiaonline.com/forum/compose/entry/new/53721059/');
									GM_openInTab('http://absol.site88.net/gtools/glowTime.php?id=740399');
								}
							}
							else{
								//alert('over');
