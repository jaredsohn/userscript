...
// @include        http://websg1.pchome.net/*
// @description    v0.6.2 by zarg
// ==/UserScript==
...
function tEnd(){
	...
	location.href='http://websg1.pchome.net/stv.php'
...
function sInitialize(){
	...
	location.href='http://websg1.pchome.net/upgrade.php?'+tList[0]
...
function run(){
		...
		if (!document.getElementById('TCD1')&&((location.href.indexOf('stv') == 25)||(location.href.indexOf('sciv') == 25))){
			...
			else{location.href='http://websg1.pchome.net/upgrade.php?'+tList[sPointer]}
...
function autoUpgrade(){
	...
	if(location.href==('http://websg1.pchome.net/upgrade.php?'+tList[sPointer])){
		...
		if(b.snapshotItem(0).textContent == '建造新建筑'){
			...
			location.href = 'http://websg1.pchome.net/sciv.php' 
