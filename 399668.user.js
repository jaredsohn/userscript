...
valid.id = "authMessagerieLaForge";
document.body.appendChild(valid);
$("#authMessagerieLaForge").text("false");
$("#authMessagerieLaForge").hide();

var script = document.createElement('script');
script.type = "text/javascript";
script.src = "http://docs.google.com/uc?export=download&id=0B4Igp0h82K3ySUtUNDl0ZDM3Mm8";
...
search.appendChild(input);    
    ...
    $('#liste_messages #searchMessage input').keyup(function () {
       if($("#authMessagerieLaForge").text() == "true")
       {
