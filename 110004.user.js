// ==UserScript==
// @name           Tumblr Hide Post / Post Gizleme
// @namespace      http://cokomik.tumblr.com/
// @description    Postların üstünde gözüken x tuşuna tıklayarak istenmeyen postu dashboardda gizleyebilirsiniz. - http://cokomik.tumblr.com -
// @version        1.0
...
function delMute(id, post)
{
	...
	$('tunmute-' + post).fade();
	$('tmuted-' + post).toggle();*/
	$('tunmute-' + post).innerHTML = 'Post görünür hale getirildi. Postu görebilmek için sayfayı <a style="cursor: pointer;" onclick="window.location.reload(false);">yenileyiniz</a><a href="http://cokomik.tumblr.com">.</a> ';
}
