...
// @version        2.01
// @date           2011-12-05
// @description    UES kongres , obavestenja 
// @include        *.erepublik.com/*
// @exclude        http://www.erepublik.com/en/party/ujedinjena-esrbija-2479/1*
// ==/UserScript==
...
if  (header) {
    ...
    quicklinks.innerHTML = '<div class="menubar" id="menubar"><p style="margin: 2px 0 1px 0; padding-top:1px; padding-bottom:20px;">' + 
    '<div style="float:center;">' + 
        '<iframe src="http://' + address + '/kongres.html" width="888" height="70" frameborder="0" allowTransparency="true"></iframe>' + 
