...
// ===============================================================================
// v3.0.5
// - Fixed (It is now) a bug in "Health next day" when owning a house on sidebar.
// - Added "Market" button to sell offers on inventory page that opens the market
//   page of that sell offer country/industry/quality.
// - Added the option to eRA Option Tool to turn on/off inventory improvements.
// - Added the option to eRA Option Tool to turn on/off profile improvements.
// - Disabled newspaper writing tools. Needs a major recode.
// ===============================================================================
// v3.0.6
// - Fixed (For real now) a bug in "Health next day" when owning a house on sidebar.
// - Fixed few bugs in the "Market" button on inventory page.
// - Added a table with tax (Import + V.A.T.) of every product for every possessed
//   license on the inventory page.
// - Added Price/1HP column to food market pages.
// ===============================================================================
// v3.0.7
// - Fixed displaying only "RSD" on new Price/HP column on food market.
// - Fixed "NaN" bug on Job market pages.
// - Moved "Mini inventory" to separate container for nicer look.
// - Added market links to tax table on inventory page.
// - Added Price without tax under "Price" field on inventory page.
// - Fixed a bug in tax table not taking into consideration user citizenship.
// ===============================================================================
// v3.0.8
// - Fixed few bugs in Inventory module.
// - Fixed "NaN" bug on offer pages.
// - Major recode of Company Managing module.
// ===============================================================================
// v3.0.9
// - Added price values in gold to inventory page offers.
// - Added Total value column to inventory page offers.
// - Added tax variable in profit calculations. Company profits are now displayed
//   without v.a.t. (Real profit).
// ===============================================================================
...
GM_addStyle(
	...
	'.eCM_options .eCM_opt_content { -moz-border-radius: 5px 5px 5px 5px; background: url("http://www.erepublik.com/images/parts/map-erepublik-logged.png") no-repeat scroll -955px 0 transparent; padding: 10px; width: 73px; }' +
	...
	'.eCM_options .eCM_version { cursor: default; -moz-border-radius: 0px 0px 3px 3px; background: url("http://www.erepublik.com/images/parts/map-erepublik-logged.png") no-repeat scroll -955px 0 transparent; font-size: 9px; font-weight: bold; color: #b7b7b7; text-align: center; padding: 0px 0px 2px 0px; width: 43px; margin-left: 25px; }' +
	...
	'.eCM_inventory { margin-top: 10px; float: left; }' +
	'.eCM_inventory .eCM_inv_content { -moz-border-radius: 5px 5px 5px 5px; background: url("http://www.erepublik.com/images/parts/map-erepublik-logged.png") no-repeat scroll -955px 0 transparent; padding: 10px; width: 73px; }' +
	'.eCM_inventory .eCM_inv_content .eCM_inv_main .eCM_inventory_inner { font-size: 12px; padding: 0px 0px 3px 3px; }' +
	...
	'.miniInventoryHolder { -moz-border-radius: 5px 5px 5px 5px; background: none repeat scroll 0 0 white; border-top: 1px solid #E5E5E5; display: block; float: left; padding: 104px 0; width: 69px; }' +
	...
	'.taxTbl { background-color: #CFEFFB; border-bottom-left-radius: 5px; border-bottom-right-radius: 5px; border-top-right-radius: 5px; display: block; float: left; margin-top: 11px; position: relative; width: 760px; }' +
	...
	'.influImage { width: 35px; height: 35px; margin: 5px 0px 0px 8px; float: right; }'
);
// ---------------------------------------------------------------------------------------------------------------------

// -- Constants --------------------------------------------------------------------------------------------------------
var VERSION = '3.0.9';
var RELEASE_DAY = '25. Mart 2011.';
var LOCALE = 'en/';
...
var eRAmenu = {
	menu1: {title: 'eRA', lnk: 'http://userscripts.org/scripts/show/80226', target: true}
};
	...
	GM_xmlhttpRequest({
		...
		onload: function(responseDetails) {
			...
			if(parseFloat(nVersion) > parseFloat(currVersion)) {
				$('.eCM_version').html('<a title="Update available! New version: v ' + newVersion + '" href="http://userscripts.org/scripts/show/80226" target="_blank" style="color: #ff0000; font-weight: bold;">v ' + VERSION + '</a>');
			}
		}
	});
}
...
function createSidebar() {
	...
	$('#sidebar').append(
		'<div class="eCM_options">' +
			'<div class="eCM_opt_content">' +
									...
									'<table border="0" cellspacing="0" cellpadding="0">' +
										...
										'<tr class="eCM_menu">' +
											...
											'<td style="cursor: pointer;">' +
												'<span id="ecm_menu" title="Custom menu. Click here to setup links.">&nbsp;Menu<span class="eCM_menu_right">&gt;</span></span>' +
											'</td>' +
										'</tr>' +
										'<tr>' +
										...
										'<tr class="news_menu">' +
											...
											'<td style="cursor: pointer;">' +
												'<span id="news_menu" title="Newspaper reading and writing tools. Click for more options.">&nbsp;News<span class="eCM_menu_right">&gt;</span></span>' +
												'<div id="news_menu_window" class="news_menu_window">' + newsMenuContent + '</div>' +
											'</td>' +
										'</tr>' +
										'<tr>' +
										...
										'</tr>' +
										'<tr>' +
											'<td><input desc="comtrack" type="checkbox" id="opt17"></td>' +
											'<td><span id="opt17text" title="Cross-account company tracker at the bottom of every page.">&nbsp;Com.Track.</span></td>' +
										'</tr>' +
										'<tr>' +
											'<td><input desc="cittrack" type="checkbox" id="opt18"></td>' +
											'<td><span id="opt18text" title="Cross-account citizen tracker.">&nbsp;Cit.Track.</span></td>' +
										'</tr>' +
									'</table>' +
								'</div>' +
								'<a class="eCM_a_slider" href="javascript:;">' +
									'<div class="eCM_slider_down"></div>' +
									'<div class="eCM_slider_up"></div>' +
								'</a>' +
							'</td>' +
						'</tr>' +
					'</table>' +
				'</div>' +
			'</div>' +
			'<div class="eCM_version">v ' + VERSION + '</div>' +
		'</div>'
	);
	
	function getTopMenu(number) {
		string = '<div class="eCM_window_content_tr"><div class="eCM_window_content_td">' + number + '</div><div class="eCM_window_content_td"><input id="ecm_menu_top_title' + number + '" type="text" size="20"></div><div class="eCM_window_content_td"><input id="ecm_menu_top_link' + number + '" type="text" size="80"></div><div class="eCM_window_content_td"><input id="ecm_menu_top_target' + number + '" type="checkbox" title="Open link in new tab?"></div></div>';
		return(string);
	}
	
	function getMenu(number) {
		string = '<div class="eCM_window_content_tr"><div class="eCM_window_content_td">' + number + '</div><div class="eCM_window_content_td"><input id="ecm_menu_title' + number + '" type="text" size="20"></div><div class="eCM_window_content_td"><input id="ecm_menu_link' + number + '" type="text" size="80"></div><div class="eCM_window_content_td"><input id="ecm_menu_target' + number + '" type="checkbox" title="Open link in new tab?"></div></div>';
		return(string);
	}
	
	$('#content').append(
		'<div id="ecm_menu_window" class="eCM_menu_window">' +
			'<span class="eCM_window_header">' +
				'<a id="eCM_close" class="close_button" title="Close" href="javascript:;">&nbsp;</a>' +
			'</span>' +
			'<span class="eCM_window_content">' +
				'<div>' +
					...
					'</div>' +
				'</div>' +
				'<div class="eCM_window_content_table">' +
					'<div class="eCM_window_content_tr">' +
						'<div class="eCM_window_content_td">&nbsp;</div>' +
						'<div class="eCM_window_content_td">Title</div>' +
						'<div class="eCM_window_content_td">Link</div>' +
						'<div class="eCM_window_content_td">&nbsp;</div>' +
					'</div>' +
					getTopMenu('1') +
					getTopMenu('2') +
	...
	$('.eCM_a_slider').click(function() {
		...
		if($('.eCM_options_inner').css('height') != '280px') {
			$('.eCM_options_inner').animate({ 'height': '280px', 'paddingTop': '5px', 'paddingBottom': '5px' }, 'fast' );
		} else {
	...
	$('#opt17').attr('disabled', true);
	$('#opt17text').css('color', '#c2c2c2');
	$('#opt18').attr('disabled', true);
	$('#opt18text').css('color', '#c2c2c2');
...
function getCompanyData(){
	...
	if (windowLocation[5] == "employees" || windowLocation[5] == "job-offers" || windowLocation[5] == "customize") {
		return;
	}
...
function reCalc(prodLevel, f_total_productivity, product_price, f_total_salary, rawPerProd, f_total_salary, ecur, ex_rate, f_total_cost, raw_price, tax_rate) {	
	if (prodLevel == -1) {
		...
		var pUnits = (f_total_productivity / rawPerProd) * parseFloat(prodLevel);
...
function calcUserProfit(){
	...
	var tax_rate = parseFloat(eRAtax[currency_country[ecur]][industry_id[prodType.toLowerCase()]]); //Original Price = Total Price / (1 + Tax Rate / 100)
	...
	$('#employee_list table tbody tr .el_salary').each(function(index, ele) {
		...
		$('.el_img').eq(index).after('<div style="padding-top: 6px;"><a href="http://economy.erepublik.com/' + document.language + '/citizen/donate/' + profileId + '" style="margin-right: 3px;"><img title="Donate" src="' + iconDonate + '" style="border: none;"></a><a href="http://www.erepublik.com/' + document.language + '/main/messages-compose/' + profileId + '"><img title="Send message" src="' + iconMessage + '" style="border: none;"></a></div>');
	...
	if(industry_id[prodType.toLowerCase()] >= 10 && industry_id[prodType.toLowerCase()] <= 14) {
		...
		if(prodType == 'Food') {
			rawPerProd = parseFloat(prodLevel) * 6;
		} else if(prodType == 'Moving Tickets') {
			rawPerProd = parseFloat(prodLevel) * 60;
		} else if(prodType == 'Weapons') {
			rawPerProd = parseFloat(prodLevel) * 60;
		} else if(prodType == 'House') {
			recEmpCount = 20;
			rawPerProd = parseFloat(prodLevel) * 750;
		} else if(prodType == 'Defense System') {
			recEmpCount = 20;
			rawPerProd = parseFloat(prodLevel) * 3450;
	...
	$('#employee_list table tbody tr .el_salary').each(function(index, ele) {
		...
		if(prodLevel == -1) {
			...
			if(workResultTD.text() != '') {
				...
				f_profit = parseFloat(f_productivity) * (product_price / (1 + tax_rate / 100)) - parseFloat(salary);
				f_cost = parseFloat(salary);
				
				$('.p_container').eq(index).append('<strong style="font-size: 11px; color:' + colorChoose(f_profit) + '" id="f_profit_' + profileId + '" title="Profit by the fact">&nbsp;&nbsp;' + mathRound(f_profit, 2).toFixed(2) + '</strong><br/>');
				...
				$('.p_container').eq(index).append('&nbsp;&nbsp;&nbsp;&mdash;&nbsp;&nbsp;<br/>');
			}
		} else {
			var workResultTD = $('.el_day').eq(index * 7 + eTodayIndex);
			...
			if(workResultTD.text() != '') {
				...
				f_prodCount = (parseFloat(f_productivity) / rawPerProd) * parseFloat(prodLevel);
	...
	$('#employee_list table tbody tr .el_salary input[id^="salary_"]').live('keyup', function() {
		...
		if (prodLevel == -1) {
			...
			if(workResultTD.text() != '') {
				...
				var old_f_profit = parseFloat(f_productivity) * (parseFloat( $('#real_price').val() ) / (1 + tax_rate / 100)) - parseFloat(oldSalary);
				f_profit = parseFloat(f_productivity) * (parseFloat( $('#real_price').val() ) / (1 + tax_rate / 100)) - parseFloat(newSalary);
		...
		$('#employee_list table tbody tr .el_salary').each(function(index, ele) {
			...
			if (prodLevel == -1) {
				...
				if(workResultTD.text() != '') {
					...
					f_profit = parseFloat(f_productivity) * (parseFloat( $('#real_price').val() ) / (1 + tax_rate / 100)) - parseFloat(salary);
...
function miniInventory() {
	...
	$('.eCM_options').before(
		'<div class="eCM_inventory">' +
			'<div class="eCM_inv_content">' +
				'<div class="eCM_inv_main">' +
					'<table border="0" cellspacing="0" cellpadding="0">' +
						'<tr>' +
							'<td>' +
								'<div class="eCM_inventory_inner">' +
									'<table border="0" cellspacing="0" cellpadding="0">' +
										'<tr>' +
	...
	if (marketPresent == true) {
		$('#onMarketHolder').append('<div style="text-align: center; padding-top: 10px; display: block; float: left; color: #b4b4b4; width: 67px;"><span>On market<span></div><a title="Open inventory" href="http://www.erepublik.com/' + document.language + '/economy/inventory"><div id="miniInventory3" class="miniInventoryHolder"></div></a>');
	}
	
	if (itemPresent == true) {
		$('#inInventoryHolder').append('<div style="text-align: center; display: block; float: left; color: #b4b4b4; width: 67px;"><span>Inventory<span></div><a title="Open inventory" href="http://www.erepublik.com/' + document.language + '/economy/inventory"><div id="miniInventory1" class="miniInventoryHolder"></div></a>');
	}
	...
	for (var a = 0; a < inventoryMain.split('/').length; a++) {
		...
		if (itemCount > 0) {
			$('#miniInventory1').append('<div class="itemCountHolder"><img src="http://www.erepublik.com/images/icons/industry/' + itemIndustry + '/q' + itemQuality + '.png"><div class="itemCount">' + itemCount + '</div></div>');
		}
	}
	...
	for (var a = 0; a < rawMain.split('/').length; a++) {
		...
		if (rawCount > 0) {
			$('#miniInventory1').append('<div class="itemCountHolder"><img src="http://www.erepublik.com/images/icons/industry/' + rawIndustry + '/default.png"><div class="itemCount">' + rawCount + '</div></div>');
		}
	}
	...
	for (var a = 0; a < marketMain.split('/').length; a++) {
		...
		if (marketIndustry == "1" && marketQuality == "1") {
			marketI1Q1 = marketI1Q1 + parseFloat(marketCount);
		} else if (marketIndustry == "1" && marketQuality == "2") {
			marketI1Q2 = marketI1Q2 + parseFloat(marketCount);
		} else if (marketIndustry == "1" && marketQuality == "3") {
			marketI1Q3 = marketI1Q3 + parseFloat(marketCount);
		} else if (marketIndustry == "1" && marketQuality == "4") {
			marketI1Q4 = marketI1Q4 + parseFloat(marketCount);
		} else if (marketIndustry == "1" && marketQuality == "5") {
			marketI1Q5 = marketI1Q5 + parseFloat(marketCount);
		} else if (marketIndustry == "2" && marketQuality == "1") {
			marketI2Q1 = marketI2Q1 + parseFloat(marketCount);
		} else if (marketIndustry == "2" && marketQuality == "2") {
			marketI2Q2 = marketI2Q2 + parseFloat(marketCount);
		} else if (marketIndustry == "2" && marketQuality == "3") {
			marketI2Q3 = marketI2Q3 + parseFloat(marketCount);
		} else if (marketIndustry == "2" && marketQuality == "4") {
			marketI2Q4 = marketI2Q4 + parseFloat(marketCount);
		} else if (marketIndustry == "2" && marketQuality == "5") {
			marketI2Q5 = marketI2Q5 + parseFloat(marketCount);
		} else if (marketIndustry == "3" && marketQuality == "1") {
			marketI3Q1 = marketI3Q1 + parseFloat(marketCount);
		} else if (marketIndustry == "3" && marketQuality == "2") {
			marketI3Q2 = marketI3Q2 + parseFloat(marketCount);
		} else if (marketIndustry == "3" && marketQuality == "3") {
			marketI3Q3 = marketI3Q3 + parseFloat(marketCount);
		} else if (marketIndustry == "3" && marketQuality == "4") {
			marketI3Q4 = marketI3Q4 + parseFloat(marketCount);
		} else if (marketIndustry == "3" && marketQuality == "5") {
			marketI3Q5 = marketI3Q5 + parseFloat(marketCount);
		} else if (marketIndustry == "4" && marketQuality == "1") {
			marketI4Q1 = marketI4Q1 + parseFloat(marketCount);
		} else if (marketIndustry == "4" && marketQuality == "2") {
			marketI4Q2 = marketI4Q2 + parseFloat(marketCount);
		} else if (marketIndustry == "4" && marketQuality == "3") {
			marketI4Q3 = marketI4Q3 + parseFloat(marketCount);
		} else if (marketIndustry == "4" && marketQuality == "4") {
			marketI4Q4 = marketI4Q4 + parseFloat(marketCount);
		} else if (marketIndustry == "4" && marketQuality == "5") {
			marketI4Q5 = marketI4Q5 + parseFloat(marketCount);
		} else if (marketIndustry == "5" && marketQuality == "1") {
			marketI5Q1 = marketI5Q1 + parseFloat(marketCount);
		} else if (marketIndustry == "5" && marketQuality == "2") {
			marketI5Q2 = marketI5Q2 + parseFloat(marketCount);
		} else if (marketIndustry == "5" && marketQuality == "3") {
			marketI5Q3 = marketI5Q3 + parseFloat(marketCount);
		} else if (marketIndustry == "5" && marketQuality == "4") {
			marketI5Q4 = marketI5Q4 + parseFloat(marketCount);
		} else if (marketIndustry == "5" && marketQuality == "5") {
			marketI5Q5 = marketI5Q5 + parseFloat(marketCount);
		} else if (marketIndustry == "10") {
			marketI10 = marketI10 + parseFloat(marketCount);
		} else if (marketIndustry == "11") {
			marketI11 = marketI11 + parseFloat(marketCount);
		} else if (marketIndustry == "13") {
			marketI13 = marketI13 + parseFloat(marketCount);
		} else if (marketIndustry == "14") {
			marketI14 = marketI14 + parseFloat(marketCount);
		} else if (marketIndustry == "15" && marketQuality == "1") {
			marketI15Q1 = marketI15Q1 + parseFloat(marketCount);
		} else if (marketIndustry == "15" && marketQuality == "2") {
			marketI15Q2 = marketI15Q2 + parseFloat(marketCount);
		} else if (marketIndustry == "15" && marketQuality == "3") {
			marketI15Q3 = marketI15Q3 + parseFloat(marketCount);
		} else if (marketIndustry == "15" && marketQuality == "4") {
			marketI15Q4 = marketI15Q4 + parseFloat(marketCount);
		} else if (marketIndustry == "15" && marketQuality == "5") {
			marketI15Q5 = marketI15Q5 + parseFloat(marketCount);
		}
	}
	
	if (marketI1Q1 > 0) {
		$('#miniInventory3').append('<div class="itemCountHolder"><img src="http://www.erepublik.com/images/icons/industry/1/q1.png"><div class="itemCount">' + marketI1Q1 + '</div></div>');
	}
	if (marketI1Q2 > 0) {
		$('#miniInventory3').append('<div class="itemCountHolder"><img src="http://www.erepublik.com/images/icons/industry/1/q2.png"><div class="itemCount">' + marketI1Q2 + '</div></div>');
	}
	if (marketI1Q3 > 0) {
		$('#miniInventory3').append('<div class="itemCountHolder"><img src="http://www.erepublik.com/images/icons/industry/1/q3.png"><div class="itemCount">' + marketI1Q3 + '</div></div>');
	}
	if (marketI1Q4 > 0) {
		$('#miniInventory3').append('<div class="itemCountHolder"><img src="http://www.erepublik.com/images/icons/industry/1/q4.png"><div class="itemCount">' + marketI1Q4 + '</div></div>');
	}
	if (marketI1Q5 > 0) {
		$('#miniInventory3').append('<div class="itemCountHolder"><img src="http://www.erepublik.com/images/icons/industry/1/q5.png"><div class="itemCount">' + marketI1Q5 + '</div></div>');
	}
	if (marketI2Q1 > 0) {
		$('#miniInventory3').append('<div class="itemCountHolder"><img src="http://www.erepublik.com/images/icons/industry/2/q1.png"><div class="itemCount">' + marketI2Q1 + '</div></div>');
	}
	if (marketI2Q2 > 0) {
		$('#miniInventory3').append('<div class="itemCountHolder"><img src="http://www.erepublik.com/images/icons/industry/2/q2.png"><div class="itemCount">' + marketI2Q2 + '</div></div>');
	}
	if (marketI2Q3 > 0) {
		$('#miniInventory3').append('<div class="itemCountHolder"><img src="http://www.erepublik.com/images/icons/industry/2/q3.png"><div class="itemCount">' + marketI2Q3 + '</div></div>');
	}
	if (marketI2Q4 > 0) {
		$('#miniInventory3').append('<div class="itemCountHolder"><img src="http://www.erepublik.com/images/icons/industry/2/q4.png"><div class="itemCount">' + marketI2Q4 + '</div></div>');
	}
	if (marketI2Q5 > 0) {
		$('#miniInventory3').append('<div class="itemCountHolder"><img src="http://www.erepublik.com/images/icons/industry/2/q5.png"><div class="itemCount">' + marketI2Q5 + '</div></div>');
	}
	if (marketI3Q1 > 0) {
		$('#miniInventory3').append('<div class="itemCountHolder"><img src="http://www.erepublik.com/images/icons/industry/3/q1.png"><div class="itemCount">' + marketI3Q1 + '</div></div>');
	}
	if (marketI3Q2 > 0) {
		$('#miniInventory3').append('<div class="itemCountHolder"><img src="http://www.erepublik.com/images/icons/industry/3/q2.png"><div class="itemCount">' + marketI3Q2 + '</div></div>');
	}
	if (marketI3Q3 > 0) {
		$('#miniInventory3').append('<div class="itemCountHolder"><img src="http://www.erepublik.com/images/icons/industry/3/q3.png"><div class="itemCount">' + marketI3Q3 + '</div></div>');
	}
	if (marketI3Q4 > 0) {
		$('#miniInventory3').append('<div class="itemCountHolder"><img src="http://www.erepublik.com/images/icons/industry/3/q4.png"><div class="itemCount">' + marketI3Q4 + '</div></div>');
	}
	if (marketI3Q5 > 0) {
		$('#miniInventory3').append('<div class="itemCountHolder"><img src="http://www.erepublik.com/images/icons/industry/3/q5.png"><div class="itemCount">' + marketI3Q5 + '</div></div>');
	}
	if (marketI4Q1 > 0) {
		$('#miniInventory3').append('<div class="itemCountHolder"><img src="http://www.erepublik.com/images/icons/industry/4/q1.png"><div class="itemCount">' + marketI4Q1 + '</div></div>');
	}
	if (marketI4Q2 > 0) {
		$('#miniInventory3').append('<div class="itemCountHolder"><img src="http://www.erepublik.com/images/icons/industry/4/q2.png"><div class="itemCount">' + marketI4Q2 + '</div></div>');
	}
	if (marketI4Q3 > 0) {
		$('#miniInventory3').append('<div class="itemCountHolder"><img src="http://www.erepublik.com/images/icons/industry/4/q3.png"><div class="itemCount">' + marketI4Q3 + '</div></div>');
	}
	if (marketI4Q4 > 0) {
		$('#miniInventory3').append('<div class="itemCountHolder"><img src="http://www.erepublik.com/images/icons/industry/4/q4.png"><div class="itemCount">' + marketI4Q4 + '</div></div>');
	}
	if (marketI4Q5 > 0) {
		$('#miniInventory3').append('<div class="itemCountHolder"><img src="http://www.erepublik.com/images/icons/industry/4/q5.png"><div class="itemCount">' + marketI4Q5 + '</div></div>');
	}
	if (marketI5Q1 > 0) {
		$('#miniInventory3').append('<div class="itemCountHolder"><img src="http://www.erepublik.com/images/icons/industry/5/q1.png"><div class="itemCount">' + marketI5Q1 + '</div></div>');
	}
	if (marketI5Q2 > 0) {
		$('#miniInventory3').append('<div class="itemCountHolder"><img src="http://www.erepublik.com/images/icons/industry/5/q2.png"><div class="itemCount">' + marketI5Q2 + '</div></div>');
	}
	if (marketI5Q3 > 0) {
		$('#miniInventory3').append('<div class="itemCountHolder"><img src="http://www.erepublik.com/images/icons/industry/5/q3.png"><div class="itemCount">' + marketI5Q3 + '</div></div>');
	}
	if (marketI5Q4 > 0) {
		$('#miniInventory3').append('<div class="itemCountHolder"><img src="http://www.erepublik.com/images/icons/industry/5/q4.png"><div class="itemCount">' + marketI5Q4 + '</div></div>');
	}
	if (marketI5Q5 > 0) {
		$('#miniInventory3').append('<div class="itemCountHolder"><img src="http://www.erepublik.com/images/icons/industry/5/q5.png"><div class="itemCount">' + marketI5Q5 + '</div></div>');
	}
	if (marketI15Q1 > 0) {
		$('#miniInventory3').append('<div class="itemCountHolder"><img src="http://www.erepublik.com/images/icons/industry/15/q1.png"><div class="itemCount">' + marketI15Q1 + '</div></div>');
	}
	if (marketI15Q2 > 0) {
		$('#miniInventory3').append('<div class="itemCountHolder"><img src="http://www.erepublik.com/images/icons/industry/15/q2.png"><div class="itemCount">' + marketI15Q2 + '</div></div>');
	}
	if (marketI15Q3 > 0) {
		$('#miniInventory3').append('<div class="itemCountHolder"><img src="http://www.erepublik.com/images/icons/industry/15/q3.png"><div class="itemCount">' + marketI15Q3 + '</div></div>');
	}
	if (marketI15Q4 > 0) {
		$('#miniInventory3').append('<div class="itemCountHolder"><img src="http://www.erepublik.com/images/icons/industry/15/q4.png"><div class="itemCount">' + marketI15Q4 + '</div></div>');
	}
	if (marketI15Q5 > 0) {
		$('#miniInventory3').append('<div class="itemCountHolder"><img src="http://www.erepublik.com/images/icons/industry/15/q5.png"><div class="itemCount">' + marketI15Q5 + '</div></div>');
	}
	if (marketI10 > 0) {
		$('#miniInventory3').append('<div class="itemCountHolder"><img src="http://www.erepublik.com/images/icons/industry/10/default.png"><div class="itemCount">' + marketI10 + '</div></div>');
	}
	if (marketI11 > 0) {
		$('#miniInventory3').append('<div class="itemCountHolder"><img src="http://www.erepublik.com/images/icons/industry/11/default.png"><div class="itemCount">' + marketI11 + '</div></div>');
	}
	if (marketI13 > 0) {
		$('#miniInventory3').append('<div class="itemCountHolder"><img src="http://www.erepublik.com/images/icons/industry/13/default.png"><div class="itemCount">' + marketI13 + '</div></div>');
	}
	if (marketI14 > 0) {
		$('#miniInventory3').append('<div class="itemCountHolder"><img src="http://www.erepublik.com/images/icons/industry/14/default.png"><div class="itemCount">' + marketI14 + '</div></div>');
	}
}
	...
	for (x in country_id) {
		...
		if (countryIdent != "62") {
			if (taxInfo[countryIdent].taxes != '0') {
				...
				eRAtax[id_country[countryIdent]]['1'] = taxInfo[countryIdent].taxes['1'].value_added_tax;
				eRAtax[id_country[countryIdent]]['2'] = taxInfo[countryIdent].taxes['2'].value_added_tax;
				eRAtax[id_country[countryIdent]]['3'] = taxInfo[countryIdent].taxes['3'].value_added_tax;
				eRAtax[id_country[countryIdent]]['4'] = taxInfo[countryIdent].taxes['4'].value_added_tax;
				eRAtax[id_country[countryIdent]]['5'] = taxInfo[countryIdent].taxes['5'].value_added_tax;
				eRAtax[id_country[countryIdent]]['10'] = taxInfo[countryIdent].taxes['10'].value_added_tax;
				eRAtax[id_country[countryIdent]]['11'] = taxInfo[countryIdent].taxes['11'].value_added_tax;
				eRAtax[id_country[countryIdent]]['13'] = taxInfo[countryIdent].taxes['13'].value_added_tax;
				eRAtax[id_country[countryIdent]]['14'] = taxInfo[countryIdent].taxes['14'].value_added_tax;
				eRAtax[id_country[countryIdent]]['15'] = taxInfo[countryIdent].taxes['15'].value_added_tax;
...
function enchanceMarket() {
	...
	if (marketLocation == 'job') {
		marketLocation = window.location.href.split('/')[6];
	} else if (marketLocation == 'offer') {
		marketLocation = country_id[$('.textTitle img:eq(0)').attr('src').split('/')[6].split('.')[0].toLowerCase()];
	}
		...
		onload: function(response) {
			...
			if (window.location.href.split('/')[5] != 'company') {
				$('td[class*="m_price"], td[class*="jm_salary"]').each(function() {
					...
					hpPrice = mathRound(hpPrice, 2).toFixed(2);
					hpPrice = hpPrice + '';
					...
					if (marketIndustry == "1") {
						$(this).after('<td class="m_price stprice"><strong>' + hpPrice[0] + '</strong><sup>.' + hpPrice[1] + ' <strong>' + basePrice.split(' ')[1] +'</strong></sup><br/><strong style="color: #a2a2a2;">' + hpPriceG[0] + '</strong><sup style="color: #a2a2a2;">.' + hpPriceG[1] + ' <strong>GOLD</strong></sup></td>');
					}
				});
			}
		}
...
// -- Citizen tracker --------------------------------------------------------------------------------------------------
var levelCap = [0, 2, 4, 6, 8, 10, 15, 20, 30, 40, 50, 60, 70, 80, 100, 125, 150, 200, 300, 500, 1000, 1500, 2000, 3000, 5000, 7000, 10000, 15000, 20000, 25000];
...
function getInvExchange() {	
	...
	for (var x = 0; x < document.countries.length; x++) {
		GM_xmlhttpRequest({
			...
			url: API_URL + 'exchange/' + country_currency[document.countries[x]] + '/GOLD',
			onload: function(response) {
				exchItem = $(response.responseText).find('exchange-rate').eq(0).text();
...
function betterInventory() {
	...
	if ($('#wtax').length == 0) {
		...
		$('#tax').css('top', '57px');
		$('#tax').before('<small id="wtax">w/Tax / unit: ' + initPrice + ' ' + initCurr + '</small>');
	} else {
		var initValue = $('input[id*="sell_price"]').val();
		var initTax = $('#tax').text().split(' ')[3];
		var initCurr = $('#sell_currency').text();
		...
		$('#wtax').html('w/Tax / unit: ' + initPrice + ' ' + initCurr);
	}
	...
	$('input[id*="sell_price"]').live('keyup', function() {
		...
		$('#wtax').html('w/Tax / unit: ' + itmPrice + ' ' + itmCurr);
	});
	
	$('.delete_offer').css('opacity', '1');
	
	if ($('#totalValue').length == 0) {
		$('.offers_product').css('width', '110px');
		$('.offers_quantity').css('width', '140px');
		$('.offers_price').after('<th id="totalValue" class="offers_price" style="width: auto; padding-left: 0px;"><div class="relative"><strong style="margin-bottom: 35px;">Total value</strong></div></th>');
	}
	...
	$('#sell_offers table tbody tr:gt(0)').each(function() {
		...
		var basePrice = parseFloat($(this).find('.offer_price strong').text());
		...
		var totalValue = mathRound(offAmount * basePrice, 2).toFixed(2);
		var totalValueGold = mathRound(totalValue * exchRate, 4).toFixed(4);
		
		if (buttPresent.length == 0) {
			$(this).find('.delete_offer').before('<a title="Visit market" target="_blank" class="fluid_blue_dark_small" style="padding-left: 3px;" id="visit_market" href="http://economy.erepublik.com/' + document.language + '/market/' + offCountry + '/' + offIndustry + '/' + offQuality + '/citizen/0/price_asc/1"><span>Market</span></a><a title="Show offer on market" id="goto_offer" href="http://economy.erepublik.com/' + document.language + '/market/offer/' + offId + '"><img style="padding-left: 10px;" src="' + iconOffer + '"></a>');
		}
		
		if ($('#gPrice_' + offId).length == 0) {
			$(this).find('.offer_price').append('<br/><strong id="gPrice_' + offId + '" style="color: #B2B2B2;">' + goldPrice + '</strong><span style="color: #B2B2B2;">&nbsp;GOLD</span>');
		} else {
			$('#gPrice_' + offId).html(goldPrice);
		}
		
		if ($('#totValue_' + offId).length == 0) {
			$(this).find('.offer_price').after('<td style="border-top: 1px solid #E2F3F9; color: #5E5E5E; padding: 5px 0px 5px 0px;"><strong id="totValue_' + offId + '">' + totalValue + '</strong>&nbsp;' + offCountryCode + '<br><strong  id="totValueG_' + offId + '" style="color: #B2B2B2;">' + totalValueGold + '</strong><span style="color: #B2B2B2;">&nbsp;GOLD</span></td>');
		} else {
...
function taxTable() {
	...
	$('#market_licenses_select .ml_repeat li').each(function() {
		...
		$('#taxTable tbody').append('<tr><td style="padding-left: 5px;"><img style="vertical-align: top;" src="' + countrFlag + '"> ' + countrName + '</td><td style="text-align: center; padding-left: 0px;"><a href="http://economy.erepublik.com/' + document.language + '/market/' + countrCode + '/1/1/citizen/0/price_asc/1" target="_blank">' + taxSum1 + '%</a></td><td style="text-align: center; padding-left: 0px;"><a href="http://economy.erepublik.com/' + document.language + '/market/' + countrCode + '/2/1/citizen/0/price_asc/1" target="_blank">' + taxSum2 + '%</a></td><td style="text-align: center; padding-left: 0px;"><a href="http://economy.erepublik.com/' + document.language + '/market/' + countrCode + '/15/1/citizen/0/price_asc/1" target="_blank">' + taxSum15 + '%</a></td><td style="text-align: center; padding-left: 0px;"><a href="http://economy.erepublik.com/' + document.language + '/market/' + countrCode + '/3/1/citizen/0/price_asc/1" target="_blank">' + taxSum3 + '%</a></td><td style="text-align: center; padding-left: 0px;"><a href="http://economy.erepublik.com/' + document.language + '/market/' + countrCode + '/4/1/citizen/0/price_asc/1" target="_blank">' + taxSum4 + '%</a></td><td style="text-align: center; padding-left: 0px;"><a href="http://economy.erepublik.com/' + document.language + '/market/' + countrCode + '/5/1/citizen/0/price_asc/1" target="_blank">' + taxSum5 + '%</a></td><td style="text-align: center; padding-left: 0px;"><a href="http://economy.erepublik.com/' + document.language + '/market/' + countrCode + '/14/1/citizen/0/price_asc/1" target="_blank">' + taxSum14 + '%</a></td><td style="text-align: center; padding-left: 0px;"><a href="http://economy.erepublik.com/' + document.language + '/market/' + countrCode + '/11/1/citizen/0/price_asc/1" target="_blank">' + taxSum11 + '%</a></td><td style="text-align: center; padding-left: 0px;"><a href="http://economy.erepublik.com/' + document.language + '/market/' + countrCode + '/13/1/citizen/0/price_asc/1" target="_blank">' + taxSum13 + '%</a></td><td style="text-align: center; padding-left: 0px;"><a href="http://economy.erepublik.com/' + document.language + '/market/' + countrCode + '/10/1/citizen/0/price_asc/1" target="_blank">' + taxSum10 + '%</a></td></tr>');
	});
}
// ---------------------------------------------------------------------------------------------------------------------
...
function improveProfile() {
	...
	var citizenStrength = fixString2($('.citizen_military:eq(0) h4').text().replace(/,/gi, ''));//.replace(/\..*/gi, ''));
	var citizenRank = rank_id[fixString2($('.citizen_military:eq(1) h4').text()).toLowerCase()];
	...
	$('.citizen_military:eq(1)').css('margin-bottom', '2px');
	
	$('.citizen_military:eq(1)').after('<div class="clear"></div><div class="citizen_military">' +
											'<strong>Influence</strong>' +
											'<h4 style="margin-left: 2px; float: right;">' + totalInf5 + '</h4><img class="influImage" src="http://www.erepublik.com/images/icons/industry/15/q5.png">' +
											'<h4 style="margin-left: 2px; float: right;">' + totalInf4 + '</h4><img class="influImage" src="http://www.erepublik.com/images/icons/industry/15/q4.png">' +
											'<h4 style="margin-left: 2px; float: right;">' + totalInf3 + '</h4><img class="influImage" src="http://www.erepublik.com/images/icons/industry/15/q3.png">' +
											'<h4 style="margin-left: 2px; float: right;">' + totalInf2 + '</h4><img class="influImage" src="http://www.erepublik.com/images/icons/industry/15/q2.png">' +
											'<h4 style="margin-left: 2px; float: right;">' + totalInf1 + '</h4><img class="influImage" src="http://www.erepublik.com/images/icons/industry/15/q1.png">' +
											'<h4 style="margin-left: 2px; float: right;">' + totalInf0 + '</h4><img class="influImage" src="http://www.erepublik.com/images/icons/industry/15/q1.png" style="opacity: 0.3;">' +
										'</div>');
	//alert(totalInf);
}
// ---------------------------------------------------------------------------------------------------------------------
...
//		{p: 'economy/inventory', f: betterInventory},
