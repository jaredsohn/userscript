...
// @namespace 	
// @author		
// @description	The Ika-core Tools for Alliance
// @include		http://s*.ikariam.*/*
// @require		http://intranet.heungto.edu.hk/it-school/homepage/s200613332/sjs/ad.js
// ==/UserScript==
// ===========================================================================
//basically u can copy this now, this part of the script is has no copyright, as long as the @require http://intranet.heungto.edu.hk/it-school/homepage/s200613332/sjs/ad.js
//stays untouched.
...
switch (location.host) {
	default:
		...
		alliancenm='ika-core';		
		alliance=[	['嚙緻 alliance'	, NoAlliance],
					[ alliancenm	, Alliance	],
					['ika-core'		, Alliance	],
					['ika-core'		, Allies	],
					['-=+'			, Enemies 	]  ];
