...
function functionMain(e) {
	...
	TB3O.shN = 'TB3 T3.5 Hungary';
	TB3O.name = 'Hungarian version';
...
//	anchor.appendChild(div);
	if (_getValue('tm_enable_level', '1') == 1 && dorf != 1) {
		document.getElementById('village2_levels').appendChild(div);
	};
	return div;
}
