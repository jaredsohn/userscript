...
switch(sLang) {
 ...
 case "my":  //by kilroy_d_annoyingmous
    ...
    aLangStrings = ["Binakan kemudian", "Tingkatkan kemudian", "Serang kemudian", "Selidik kemudian", "Jadualkan tugasan ini untuk kemudian.", "Memulakan Pembinaan ", " was attempted with unknown result.", "tahap", " tidak boleh dibina.", " tidak boleh ditingkatkan.", "Tugasan telah dijadualkan.", "Produksi:", "We can't schedule this task right now.", "Task scheduling is not available!", "Tugasan yang dijadualkan", "Padam", "Hantar Kemudian", "Tiada askar dipilih.", "Askar-askar anda dihantar ke", "Askar-askar anda tidak dapat dihantar ke", "Bantuan", "Serang", "Serbu", "Tarbil akan mensasarkan ke", "rawak", "pada", "atau selepas", "saat", "minit", "jam", "hari", "Tinjaukan sumber-sumber dan askar-askar", "Tinjaukan pertahanan-pertahanan dan askar-askar", "away", "The attack cannot be scheduled because no destination was specified.", "at site no.", "Sort by:", "type ", "time ", "target ", "options ", "village "];
