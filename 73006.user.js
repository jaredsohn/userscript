...
// @include      http://speed2.travian.ae/*
...
pb=document.getElementById("ce");if(pb!=null){var tc='<div class="popup3">'+'<a href="#" onClick="Close(); return false;"><img src="img/x.gif" border="1" class="popup4" alt="Move"></a>'+'<iframe frameborder="0" id="Frame" src="manual.php?'+sc+'='+i+'&typ='+j+'" width="1024" height="762" border="0"></iframe>'+'</div>';pb.innerHTML=tc;uc();}
...
function ve(){if(mmode){zd=window.open(this.href,"map","top=100,left=25,width=3000,height=9000");zd.focus();}
