...
// @include        http://www.orkut.com/CommMsgs*108092464
// ==/UserScript==
tpcos = ["[DIC]","[DICA]","[TUT]","[TUTO]"];
...
msg += "\n-----ATEN\xc7AO!-----";
mens = "up,nao quero mais ver tanto OFF na first porra, movimento dc, não vire a dh !"; //Modifique a mensagem do up aqui
