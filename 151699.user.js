//
// ==UserScript==
// @name Conquer Club Clan War Tracker
// @namespace http://www.vennie-vollrath.com
// @description An updated version of tournament stats for improved tracking of Clan Wars Conquer Club 
...
function createBox(txt) {
  ...
  style.innerHTML += "#rankBox h1 {margin:0;font:bold 0.9em verdana,arial;background-color:#cdc;color:#000;border-bottom:1px solid #000;padding:1px 0 1px 1px;} ";
  style.innerHTML += "#rankBox p {font:0.7em verdana,arial;padding-left:20px;width:900px;} .result {font-weight:bold;color:#00f;} .totals {color:#000;} ";
  ...
  style.innerHTML += "#rankBox #closeRank {display:block;position:relative;margin:5px auto;padding:1px;border:2px solid #000;width:70px;font:0.7em verdana,arial;text-transform:uppercase;text-align:center;color:#000;background-color:#cdc;text-decoration:none;} ";
  ...
  style.innerHTML += ".display_div {width: 32px;padding: 0 1px 0 0;height: 20px;text-align: left;border: 1px solid;} ";
  style.innerHTML += ".display {background-color: #fff;color: blue;width: 32px;text-align: left;font-size: 7pt;font-family: verdana, arial, helvetica, sans-serif;font-weight: bold;cursor: text;}";
