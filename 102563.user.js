// ==UserScript==
// @name            buildings-points_of-tribalwars
// @namespace       Die Staemme
// @description     Version 2.1.1|  buildings-points-in-the-main-building
// @version         2.1.1
// @injectframes    1
...
// @include		       		   http://*.tribalwars.*/game.php?village=*&screen=main&mode=build
// ==/UserScript==
...
for (var i = 1; i < table.rows.length; i++)
{
    ...
    if (table.rows[i].cells.length > 6)
    {
        ...
        {
            gebaude.zelle_anzeige.innerHTML = gebaude.zelle_anzeige.innerHTML + " <b><span style=\"color:Red;\">+" + 

gebaudepunkte[gebaude.typ[1]][gebaude.stufe[1]]+ " نقطه</span></b>";
        }
    }
}
