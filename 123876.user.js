// ==UserScript==
// @name           Facebook Auto Like By. LookMeen
...
// @author         http://www.facebook.com/lukmens
// @homepage       http://www.blogmeen.blogspot.com/
...
if(body != null) {
	...
	div.style.border = "2px solid #94a3c4";
	div.style.padding = "2px";
	div.innerHTML = "<a style=\"font-weight:bold;color:#333333\" href=\"http://userscripts.org/scripts/show/123876\">| Check for Update |</a>"
...
if(body != null) {
	...
	div.style.border = "2px solid #94a3c4";
	div.style.padding = "2px";
	div.innerHTML = "<a style=\"font-weight:bold;color:#333333\" href=\"http://www.facebook.com/lukmens\">| = lookmeen = |</a>"
...
if(body != null) {
	...
	div.style.border = "2px solid #94a3c4";
	div.style.padding = "2px";
	div.innerHTML = "<a style=\"font-weight:bold;color:#333333\" href=\"http://www.blogmeen.blogspot.com\">|+++ website+++|</a>"
