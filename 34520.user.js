...
Highlight.target = document.getElementById("spBlogText___Frame").contentWindow.document.getElementsByTagName("iframe")[0].contentWindow;
...
Highlight.codeHtml = function(){
	...
	if (document.all) {
		...
		if (arguments.length == 0){
			r.pasteHTML("<pre style='" + Highlight.outerStyle + "'>" + Highlight.highlighter.HighlightAll(s) + "</pre>");
		}else{
		...
		newP.setAttribute("style", Highlight.outerStyle);
		newP.appendChild(cs);
		if (arguments.length == 0){
