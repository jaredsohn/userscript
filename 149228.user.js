// ==UserScript==
// @author   	 ThomasRed (source : Angel Vladov). Modifications by Hak do byung
// @name    	eRepublik's Damage Report Script eSK
// @namespace   eRepublikDamageReport_eSK
// @version   	 2.2
// @uso:version 2.2
// @include   	 http://*erepublik.com/*/military/battlefield/*
// @description	eRepublik Damage Report Script for eSK Army
// ==/UserScript==
...
if(window.location.href.indexOf(PAGE_BATTLEFIELD) > 0) {    
    ...
    /***********************************************************************************/
    var FORM_URL = "https://docs.google.com/spreadsheet/viewform?formkey=dHBJaWx3aGU2VFdxTXZxUURxUkZraXc6MQ";
    var FORM_FIELDS = {
   			 eday: "entry.0.single",
            	name: "entry.1.single",
   			 UM:  "entry.2.single",
    ...
    function BattlePage() {
    	...
    	var dmgq7=Math.floor(Math.floor((parseInt(rankl)+5)*(parseFloat(str)+400)*0.005)*3);
    	var dmgq7hit=Math.floor(dmg/dmgq7);
