// ==UserScript==
// @name           Auto-Farmscript modded
// @author         Zezuma - FDisk
// @description    Travian Auto-farmscript 10 of first armytype and 10 of the second. Thx too FDISK
...
function voegToe() {
	...
	addList(x+","+y+"|10,0,10,0,0,0,0,0,0,0|"+dorpnaam);
...
function geefOverzicht() {
	...
	if(GM_getValue("valaan"+document.domain,0) == 0)	onoffButton.innerHTML = "Klicka här thor!";	//http://s3.travian.lt/img/un/a/del.gif
