// ==UserScript==
// @name	Menu Alianza Elite
// @namespace  	Menu
// @description	Agrega link al costado de la fecha.
...
+ ' <li><h2>Elite</h2>'
+ '   <ul>'
+ '     <li><center><a target="_blank" href="http://elite2.foroactivo.net/" align="left">&nbsp;Foro de la Alianza</a></li>'
...
+ '	<li><center><a href="http://elite2.foroactivo.net/guias-tutoriales-f7/-t48.htm" target="_blank" onClick="window.open(this.href, this.target); return false;" title=" Lista de todos los Scripts Actualizada ">Lista de Scripts</a></li>'
+'</ul>'
+'</DIV>';
