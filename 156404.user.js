...
// @version     1
// @downloadURL http://userscripts.org/scripts/source/156404.user.js
// @updateURL	http://userscripts.org/scripts/source/156404.meta.js
// ==/UserScript==

scriptName='ordineMA';
scriptId='156404';
scriptVersion=1;
scriptUpdateText='News';
var VERSION = "1";
...
function GM_wait() {
	if (typeof unsafeWindow.jQuery == 'undefined') {
		...
		GM_xmlhttpRequest({
			url: 'https://docs.google.com/spreadsheet/pub?key=0AqCqerkSPk6XdDM0aGZIQWpSbE53UERDTG9wNU1zekE&single=true&gid=1&output=txt',
			method: 'GET',
			headers: {
			...
			onload: function(response) {
				$(document).ready(function() {
					var orders = '<div id="MA_orders" align="center" style="text-align: center" </div>';			
					...
					for(var i in battles) {
						...
						$('#MA_orders').append('<a href="' + url + '" style="align: center; margin: auto; display: block; margin-left:50px"><img src="'+ image + '" style="align: center;margin-top:0;"/></a><br/>');
					}
				});
			},
			onerror: function() {
				alert('Eroare - Refresh');
			}
		});
	}
}
