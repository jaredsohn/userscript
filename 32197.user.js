// ==UserScript==
// @name           YouTube Theater 2
// @namespace      tag: URI
// @description    Took "YouTube Theater Black2" and redid it to make it white. Provides the nice large video pane of "YouTube Theater" and includes all the other clutter below the video, away from sight, but still usable with a simple scroll.
...
GM_addStyle("#baseDiv { width: 850px; !important; }");
GM_addStyle("body { background-color: white; color: white; !important; }");
GM_addStyle("#search-bar { background-color: white; !important; }");
...
GM_addStyle("#watch-channel-vids-div { background-color: white !important; }");
