// ==UserScript==
// @name           TraduÃ§Ã£o portuguesa de eRepublik
// @version	   0.2 (10 de junho de 2009)
// @description    TraduÃ§Ã£o portuguesa de eRepublik
...
// company
	...
	"Find a job or own a company. Having a job will allow you to get a salary each day you go to work (don't worry, in eRepublik it is much more fun and faster to go to work than in real life).": "Procura um emprego ou possiu companhias. Ter um emprego permite a você ganhar o salário cada dia que vais trabalhar (não se preocupe, trabalhar no eRepublik é muito mais fácil do que na vida real) (Nota: não é recomendado que possuas empresas, usa organizações para isso).",
	"You do not have a job" : "Você está desempregado",
	"Find a job" : "Procurar emprego",

	"Own a company" : "Dono de empresa",
	"Having your own company may be a major source of wealth, but first you will need to make sure you have enough money to pay your future employees' salaries so that you don't go bankrupt." : "Ter empresas pode te dar muito rendimento, mas tem que fazer bem as contas, ter dinheiro para pagar salários, para não falir",
...
// region
	...
	"You can't start a resistance war in this region because it already belongs to its original owner country" : "Não pode começar uma Guerra de resistância porque a região pertence ao dono original",
	"Medium" : "Médio",
	"High": "Alto",
	"Neighbors" : "Vizinhos",
// marketplace
...
//fim de ranks
	...
	"You cannot join this fight because your country is not involved in the war" : "Não pode entrar na batalha porque o seu país não está envolvido na guerra",
...
// party
	...
	"You can join a party from it's presentation page or you can create your own party if you cannot find the right one for you. Being a member of a party could give you the chance to become a Congress Member or even the President." : "Pode entra em um partido na sua página de apresentação ou criar um novo. Ser membro de um partido permitea você ser seu presidente, membro do Congresso ou mesmo Presidente do País (Nota: pensa bem antes de cria um partido).",
...
// news
	...
	"A newspaper is an efficient way to communicate your news to the eRepublik world. Read more on the eRepublik Wiki. Create your own newspaper." : "Um jornal é uma forma eficiente de comunicar com o Mundo do eRepublik. Leia mais na wiki. Crie o seu próprio jornal",
// profiles
	"Friends" : "Amigos",
	"Fights" : "Lutas",
...
// organizations
	"In order to log in as an organization you have to log out from your citizen account and log in again with your organization username and password." : "Para efectuar login com a organização tem que sair da conta do ecidadão e usar a senha e nome da organização.",
...
//meus
	...
	"You do not own a moving ticket. You can buy moving tickets from the marketplace." : "Não tem um bilhete de avião. Podes comprar um no mercado.",
	"Name" : "Nome",
	"Country" : "País",
	" ago"	: "atrás",
//	"This country can trade with any other country in eRepublik." : "Este pais pode efetuar trocas comerciais com qualquer outro pais no eRepublik",
	...
	"You will receive 5 Gold for each citizen invited by you that reaches level 6." : "Receberá 5 Ouro quando os cidadãos que convidou chegarem ao nível 5.",
