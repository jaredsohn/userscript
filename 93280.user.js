...
c.appendChild(b)}}}}function g(){f()}var h=location.hostname.replace(/^(?:[\w\-]+\.)*(\w+\.[a-z]{2,6})$/i,"$1");window.ujs_vkontakte_ru_audio_cdl=f;window.opera.defineMagicFunction("updateBanners",function(){setTimeout(function(){ujs_vkontakte_ru_audio_cdl();window.ujs_vkontakte_ru_video_cdl&&ujs_vkontakte_ru_video_cdl()},1E3)});(typeof window.opera.version=="function"&&window.opera.version()>=9?true:false)?document.addEventListener("DOMContentLoaded",g,false):document.addEventListener("load",g,false)})();