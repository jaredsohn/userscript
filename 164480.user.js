...
// @name        urbanclix
// @namespace   urbanclix
// @include     *://*urbanclix.net/index.php?view=click*
// @include     *://*urbanclix.net/index.php?view=account&ac=click*
// @include     *://*urbanclix.net/index.php?view=account&ac=ptra*
// @include     *://*urbanclix.net/gpt.php?v=entry*
// @include     *://*urbanclix.net/gpt.php?v=read*
// @include     *://*urbanclix.net/view.php?id=*
