// ==UserScript==
// @name           livebux_com_autoclicker
// @namespace      Livebux.com
// @description    Autoclicker bot for LiveBux.com
// @include        http://*livebux.com/surf.php
// @include        http://*livebux.com/index.php
// @include        http://*livebux.com/view.php?ad=*
// ==/UserScript==
/////////////////////////////////////////////////////////////
// based on Joe Simmons bux.to script
// visit my blog at http://kuyau.blogspot.com
...
addGlobalStyle(".strike {color:#000000;text-decoration:line-through;font-weight:normal;}");
...
sec.setAttribute("style", "background:url('http://i38.tinypic.com/2dlvvc6.jpg'); color:#ddd; border:3px solid #000; padding:5em; position:absolute; top:"+window.innerHeight/3+"px; left:"+window.innerWidth/2+"px; text-align:center;"););
