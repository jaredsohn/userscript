...
Small Modifications by h2ooooooo
Same same same GPL license
...
var FunkyMusicTableMP3 = [ 'music.mp3', 'music8.mp3', 'music7.mp3', 'music6.mp3', 'music5.mp3', 'music4.mp3', 'music3.mp3', 'music2.mp3', 'music10.mp3' ]
var isoify = false
...
//EPIC MUSIC BABY FLASH BY H2OOOOOOO
unsafeWindow.toggepicmusic2 = function( e ) {
	//Begin Gay wrapper
	window.setTimeout(function() {
		if (GM_getValue("epicmusic2", false ) == true ){
			GM_setValue("epicmusic2", false );
			alert('Epic Music In Flash Disabled');
			return;
		};
		if (GM_getValue("epicmusic2", false ) == false ){
			GM_setValue("epicmusic2", true );
			alert('Epic Music In Flash Enabled');
			return;
		};
	//End Gay wrapper
	}, 0);
...
function CFG_Setup(param) {
	...
	crapmenuitem1 = document.createElement('p')
	crapmenuitem1.innerHTML = "<a href='#' onclick=\"toggepicmusic2();\">Epic Music2: <span class='highlight'>"+ GM_getValue("epicmusic2", false ) +"</span></a> - Oify Music [Flash]"
	crapmenushell.appendChild(crapmenuitem1)
...
function EMusic_Setup2(param) {
	if (GM_getValue("epicmusic2", false ) == false || !isoify ) { return; }
	var newembed, newobj, newparam, findbody;
	findbody = document.getElementsByTagName('body')[0];
	
	newobj = document.createElement('table');
	newobj.innerHTML = '<tr><td>'+
'<EMBED src=\'http://www.jalsoedesign.net/OIFYmp3/mp3player.swf\' menu=\'false\''+
' quality=\'high\' WIDTH=1 HEIGHT=1 TYPE=\'application/x-shockwave-flash\'' +
