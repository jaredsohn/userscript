// ==UserScript==
// @name            Diabolic's HackForums User Links
// @version         2.0
// @namespace       Diabolic
...
Ub3rHelper.prototype = {
  ...
  {    
	...
	adddlinks[1] = this.linkHelper ('Group CP', 'http://www.hackforums.net/managegroup.php?gid=21', 'bottom');
	...
	adddlinks[3] = this.linkHelper ('Tracking', 'http://www.hackforums.net/private.php?action=tracking', 'bottom');
        ...
        adddlinks[5] = this.linkHelper ('Help Documents', 'http://www.hackforums.net/misc.php?action=help', 'bottom');
        adddlinks[6] = this.linkHelper ('Coding Info', 'http://en.wikipedia.org/wiki/List_of_programming_languages', 'bottom');
