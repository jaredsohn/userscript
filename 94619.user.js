// ==UserScript==
// @name           GT Auto Hunt - Edited Jaryl Version
// @namespace      ZC.Khoo
...
// @version        1.07
// @history        1.07 - Update Daily Click list (2013 New Daily)
// @history        1.06 - Update Daily Click list (Unicorn Contract)
// @history        1.05 - Update Daily Click list (Coffincracker drone)
// @history        1.04 - Update Daily Click list
// @history        1.03 - Remove midnight powerhunt not running after finish all(testing)
// @history        1.02 - Added midnight powerhunt
// @history        1.01 - Remove the ghost monster link posted automatically (dead link)
// @history        1.00 - Original code from http://userscripts.org/scripts/review/82046

// ==/UserScript==
var SUC_local_ver = 1.07;
                ...
                if(SUC_local_ver!=-1)
                {
                    ...
                    if (remote_version > SUC_local_ver)
                    {
                        if ( document.getElementById("newsText")) {
                            document.getElementById("newsText").innerHTML = "<p style=\"font-family:arial;color:red;font-size:22px;\"><b><u>There is an update available for the auto-hunt script! <a href=\"http://userscripts.org/scripts/source/94619.user.js\">Download</a> now!<u></b></p>";
                        }
                        if (forced)
                        {
...
function UpdateTitle()
{
    if (TitleOver == ""){
        ...
        document.title = "| GT | Hunt: " + mins + ':' + secs + " | Potions: " + document.getElementById('profile_whisky_quantity').textContent + " |";
    }
    else
    {
