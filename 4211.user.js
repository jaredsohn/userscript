...
// ==UserScript==
// @name            Google Dark Extended
// @namespace       http://userscripts.corhol.com/google-dark/
...
// @exclude         http://*.google.tld/options/*
// @exclude         http://*.google.tld/advanced_search*
// @exclude         http://*.google.tld/preferences*
// @exclude         http://*.google.tld/language_tools*
// @version         1.1
// ==/UserScript==
...
if ( window.location.search == "" || window.location.pathname == "/webhp" || window.location.pathname == "/imghp" ) {
	...
	for ( i = 0; i < aQuery.length; i++ ) {
		...
		if ( result != -1 ) { sQuery = aQuery[i].substr(2); }
	}
...
if ( window.location.pathname == "/search" ) {
	...
	for( i = 1; i < document.getElementsByTagName('input').length; i++ ) { if ( document.getElementsByTagName('input')[i].title == 'Search' ) { vQuery = document.getElementsByTagName('input')[i].value; } }
	...
	document.getElementsByTagName('img')[1].src = 'http://userscripts.corhol.com/google-dark/logo.jpg';
