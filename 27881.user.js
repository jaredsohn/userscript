// ==UserScript==
// @name           Quote Button for douban 0.1
...
var newElement;
if (Element2Quote.childNodes.length==4){	//非本人回复的楼层
    ...
    var quotationBody = Element2Quote.childNodes[1].innerHTML;
    var textAreaValue = "    "+quotationAuthor+"于"+quotationTime+"说:“"+quotationBody+"”\n ";
											//获取引用的 时间，作者以及引用的内容
