// ==UserScript==
// @name           Search Word Toss V 1.0 for Chrome
...
if(document.getElementsByName('q'))
{
    ...
    //alert(unsafeWindow.document.getElementById('gbqfq').tagName);
    //alert(unsafeWindow.document.getElementById('gbqfq').value);
    //alert(getOffset(unsafeWindow.document.getElementById('gbqfq')).top);
    var getRealOffsetLeft = function (o) {
      return o ? o.offsetLeft + getRealOffsetLeft(o.offsetParent) : 0; 
    };
    //alert("스타트");
    //alert(getRealOffsetLeft(unsafeWindow.document.getElementById('gbqfq')));
    //alert(getRealOffsetLeft(document.getElementsByName('q')[0]));
    //alert(document.getElementsByName('q')[0].tagName);
    //alert(document.getElementsByName('q')[0].parentElement.offsetLeft);
    //alert(document.getElementsByName('q')[0].parentElement.offsetLeft.parentElement.offsetLeft);
	//alert(this.findPosX(document.getElementsByName('q')[0]));
}
// Y축 위치구하기
...
( function () {
	...
	if ( location.href.indexOf("naver") >= 0 && document.getElementById("nx_query") )
	{
        ...
        wschoe_div.style.left = (130+findPosX(document.getElementById("nx_query"))+document.getElementById("nx_query").offsetWidth) + "px";
		wschoe_div.style.top = (findPosY(document.getElementById("nx_query"))-7) + "px";
	...
	if ( document.URL.indexOf("search.daum.net") >= 0 && document.getElementById('q') ) //"ie5,ie6,ie7,ie8
	{
        ...
        wschoe_div.style.left = (findPosX(document.getElementById('q')) + 155 + document.getElementById('q').offsetWidth) + "px";
        wschoe_div.style.top = (findPosY(document.getElementById('q').offsetParent)) + "px";
		wschoe_div.style.width = 300;
		wschoe_div.innerHTML += "<input type=\"button\"	 \
		...
		*overflow:visible;\" title=\"Google 검색\" name=\"query_search\"	\
        ...
        wschoe_div2.style.left = (findPosX(document.getElementById('q1')) + 70 + document.getElementById('q1').offsetWidth) + "px";
        wschoe_div2.style.top = (findPosY(document.getElementById('q1')) - 4) + "px";        
		wschoe_div2.style.width = 300;
		wschoe_div2.innerHTML += "<input type=\"button\"	 \
		style=\"border:3px solid #48B614;	\
		height:33px; padding:3; background:transparent; cursor:pointer;	\
	...
	{
        var inputQArr = document.getElementsByName('q');
		var wschoe_div = document.createElement("div");
		document.body.appendChild(wschoe_div);
		wschoe_div.style.position = "absolute";
		wschoe_div.style.zIndex = 2147483647;
        if(findPosX(inputQArr[0])==0)
        {
            //wschoe_div.style.pixelLeft =  776;
            //wschoe_div.style.pixelTop = 49;
            wschoe_div.style.left =  "776px";
            wschoe_div.style.top = "49px";
        }
        else
        {
            //wschoe_div.style.pixelLeft =  findPosX(inputQArr[0]) + 120 + inputQArr[0].offsetWidth;
            //wschoe_div.style.pixelTop = findPosY(inputQArr[0])-6;
            wschoe_div.style.left =  (findPosX(inputQArr[0]) + 120 + inputQArr[0].offsetWidth) + "px";
            wschoe_div.style.top = (findPosY(inputQArr[0])-6) + "px";
            //alert("Left: " + wschoe_div.style.pixelLeft + ", Top: " + wschoe_div.style.pixelTop);
        }		
