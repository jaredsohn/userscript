// ==UserScript==
// @name            Netvibes maximiser
// @description	    Hides netvibes top bar (including tabs, search area, add content) and bottom and allows you to toggle them back on using an icon :)
...
//Webpage:         http://www.mattcollinge.co.uk
...
function switcher(element, visible) {
...
function toggle() {
	...
	switcher(document.getElementById('header'), toggleToVisible);
	switcher(document.getElementById('addContentLink'), toggleToVisible);
	switcher(document.getElementById('userPages'), toggleToVisible);
	switcher(document.getElementById('topbarUser'), toggleToVisible);
	switcher(document.getElementById('footer'), toggleToVisible);

}

window.setTimeout(function() {

	switcher(document.getElementById('header'), false);
	switcher(document.getElementById('addContentLink'), false);
	switcher(document.getElementById('userPages'), false);
	switcher(document.getElementById('topbarUser'), false);
	switcher(document.getElementById('footer'), false);

	switcher(document.getElementById('notification-bar'), false);
	
	el = document.getElementById("topbarContent");
