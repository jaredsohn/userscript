...
// @author		Angel Vladov
// @revised		Candymanson
// @name        CHOTOS battle stats
// @version		1.0.7
// @uso:version	1.0.7
// @include		http://*erepublik.com/*
// @description    LOS CHOTOS military unit itelligence script zaaaa
// ==/UserScript==

var FORM_URL = "https://docs.google.com/spreadsheet/viewform?formkey=dFFYbEVmdGNLTEM0VGxlSDBLM2tlWXc6MQ#gid=0";
...
var LOCALE = {
	en:function() {
		return {
			...
			send_report: "Do you want to send a report to LOS CHOTOS?",
	...
	bg: function() {
		return {
			...
			send_report: "Estas listo para enviar el reporte a LOS CHOTOS?",
...
var main = function() {
	...
	$.find("#logo").append(
		...
		'<div><b><u>CHOTOS battle stats</u></b></div>' +
		'<b>Autor: </b>candymanson :P<br />' +
