// ==UserScript==
// @name           flottengesamtkosten
// @description    Flottenkosten uebersichtlich angezeigt
...
ship[202] = "Kleiner Transporter";
ship[203] = "Gro\u00DFer Transporter";
ship[204] = "Leichter J\u00E4ger";
ship[205] = "Schwerer J\u00E4ger";
ship[206] = "Kreuzer";
ship[207] = "Schlachtschiff";
ship[208] = "Kolonieschiff";
ship[209] = "Recycler";
ship[210] = "Spionagesonde";
ship[211] = "Bomber";
ship[212] = "Solarsatellit";
ship[213] = "Zerst\u00F6rer";
ship[214] = "Todesstern";
ship[215] = "Schlachtkreuzer";
...
deu_ship[215] = 15000;
	...
	tabela = '<table><th>Schiffsname</th><th>Vorhanden</th><th>Metall</th><th>Kristall</th><th>Deuterium</th><th>Kosten</th><th>Punkte</th></tr>';
	zakonczenie = '<tr><td class="c" colspan="7">Gesamt</td></tr><tr><th colspan="6">Gesamtkosten:</th><th>'+Format(total)+'</th></tr><tr><th colspan="6">Punkte:</th><th>'+Format(total/1000)+'</th></tr></table>';
