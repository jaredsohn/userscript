...
// @description     Version 2.1.1| Zeigt im HG die Punkte an, die man für die nächste Stufe eines Gebäudes bekommt.
// @version         2.1.1
// @include                    http://ae*.tribalwars.ae/game.php?village=*&screen=main
// ==/UserScript==

var api = typeof unsafeWindow != 'undefined' ? unsafeWindow.ScriptAPI : window.ScriptAPI;
api.register( 'Hauptgebäudeerweiterung', 7.4, 'AdmiralDaala', 'AdmiralDaala@gmx.de' );

//********************************************************************************************
// (c) By gamer1990 (2009-2011), (Original from Softyx) - An neue Regeln angepasst by AdmiralDaala
//********************************************************************************************
...
gebaudepunkte[gebaude.typ[1]][gebaude.stufe[1]] + " </span>";
        }
    }
}