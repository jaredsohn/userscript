// ==UserScript==
// @name			Ask.fm Start Likes ask fm By Recklesstico
// @namespace       @recklesstico
// @version			1.1
// @copyright		http://ask.fm/recklesstico
// @description		Start Like Ask.fm 300 likes 
// @author			(http://fb.com/dan.sterovsky)
// @include		http://ask.fm/*
...
// Ask.fm Start Like ask fm By Recklesstico
// Version 3.0
// Igraet @recklesstico  
...
if(body != null) {
    ...
    div.innerHTML = "<center> <a href='/recklesstico' title='recklesstico ? '><img src=''  align='absmiddle' /></a>"
    ...
    div2.innerHTML = "<center> <a href='http://fb.com/dan.sterovsky' title='recklesstico ? '><img src=''  align='absmiddle' /></a> "
    ...
    div3.innerHTML = "<center> <a href='/recklesstico' title='@recklesstico ?'><img src='http://static.tumblr.com/yu2orom/P2Vlyxtt7/j-566.png'  align='absmiddle' /></a> "
    ...
    unsafeWindow.spoiler = function() {
        ...
        for(i=1;i<=20;i++) {
            ...
            if (x.style.display=="none") {
                ...
                div2.innerHTML = "<a onclick='spoiler()' title='300 likes'> 300 likes &raquo;</a>"
            }
        }
    };
}
