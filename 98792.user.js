// ==UserScript==
// @name           Official Power Tools Warriors Templar
// @namespace      noobs
...
//logit ( 'Options.ptWinPos: '+ inspect (Options.ptWinPos, 5, 1)); 
  ...
  AddMainTabLink('WarriorsTemplar', eventHideShow, mouseMainTab);
TestSomething.init ();  
...
Tabs.Jatonet = {
  ...
  myDiv : null,
  timer : null,
  forumlink :  'http://www.jatonet.it/camelot/index.htm',  
