...
(function () {
	...
	/* 					keyword: function () {
		...
		engineList.web[0] = {
			...
			name: 'Google',
			// 搜索引擎地址，关键字变量用%s代替
			url: 'https://www.google.de/search?q=%s&hl=zh-CN&safe=off&ie=utf-8&oe=utf-8',
			// 搜索引擎的站点图标
			favicon: 'https://www.google.com.hk/favicon.ico',
		...
		engineList.web[7] = {
			name: 'DuckGo',
			url: 'https://duckduckgo.com/?q=%s&kl=cn-zh&kp=-1&kn=1&kf=fw&kw=w&ke=-1&kk=-1&k4=-1',
			...
			engineList.video[4] = {
				name: '腾讯',
				url: 'http://v.qq.com/search.html?pagetype=3&stj2=search.hotword&stag=txt.index_hotword&ms_key=',
		...
		engineList.music[4] = {
			...
			engineList.image[0] = {
				name: 'google图片',
				url: 'http://www.google.de/search?q=%s&safe=off&hl=zh-CN&tbm=isch',
		...
		engineList.translate[8] = {
			name: '百度词典',
			url: 'http://dict.baidu.com/s?wd=%s&ie=utf-8&oe=utf-8',
			favicon: 'http://dict.baidu.com/static/img/favicon.ico',
		};
		...
		engineList.knowledge = [];
			...
			engineList.knowledge[3] = {
				...
				favicon: 'http://zh.moegirl.org/favicon.ico',
			};
			engineList.knowledge[4] = {
				name: '互动百科',
				url: 'http://so.hudong.com/s/doc/%s',
				favicon: 'http://baike.com/favicon.ico',
			};
