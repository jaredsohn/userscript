// ==UserScript==
// @name            taz_telepolis_medien1
// @namespace       Platypus
// @include         *TAZ&ressort=fl
// @include         http://www.taz.de/index.php?id=internet
// @include         http://www.taz.de/index.php?id=medien
...
html_insert_it(window.document,document.getElementById('datum_plugin_rechts'),'<iframe src="http://www.heise.de/tp/r4/inhalt/medien.html#taz" width="500" height="600"></iframe>',false,true);
