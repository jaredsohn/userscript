// ==UserScript==
// @name            Remove Premium Tabs on Redtube
// @namespace       Platypus
// @include         http://redtube.com/?avID=8&avEnter=1
// @include         http://redtube.com/*
// @include         http://www.redtube.com/*
// ==/UserScript==
function do_platypus_script() {
remove_it(window.document,document.evaluate('/HTML[1]/BODY[1]/DIV

[1]/DIV[1]/DIV[2]/UL[1]/LI[4]/A[1]', document, null, 

XPathResult.FIRST_ORDERED_NODE_TYPE,null).singleNodeValue,null,null,nul

l);
remove_it(window.document,document.evaluate('/HTML[1]/BODY[1]/DIV

[1]/DIV[1]/DIV[2]/UL[1]/LI[5]/A[1]', document, null, 
...
false);
var gplatypusBundle = Components.classes
...
var platypusthisusuallyhappens = mystrings.GetStringFromName

("platypusthisusuallyhappens");

//
//  Mon Dec 19 15:59:37 2005 -- Scott R. Turner
//  Short, uncommented file containing all the code to implement 
...
function do_modify_url_it(doc, node, match_re, replace_string, 
...
element.innerHTML = element.innerHTML.replace(match_re, 
