// ==UserScript==
// @name            The Ultimate Homepage!
// @namespace       The Ultimate Organized and Clean Homepage!
// @include         http://home.myspace.com*
function do_platypus_script() {
smart_remove(window.document,document.evaluate('/HTML[1]/BODY[1]/DIV[3]/DIV[2]/DIV[2]/DIV[1]/DIV[1]/CENTER[1]/A[1]', document, null, XPathResult.FIRST_ORDERED_NODE_TYPE,null).singleNodeValue,null,null,null);
script_paste(window.document,document.getElementById('squareAd'),document.evaluate('/HTML[1]/BODY[1]/DIV[3]/DIV[2]/DIV[2]/DIV[1]/DIV[1]/CENTER[1]', document, null, XPathResult.FIRST_ORDERED_NODE_TYPE,null).singleNodeValue,null,null);
smart_remove(window.document,document.getElementById('home_announcements'),null,null,null);
script_paste(window.document,document.evaluate('/HTML[1]/BODY[1]/DIV[3]/DIV[2]/DIV[2]/DIV[1]/CENTER[1]/A[1]', document, null, XPathResult.FIRST_ORDERED_NODE_TYPE,null).singleNodeValue,document.getElementById('home_announcements'),null,null);
smart_remove(window.document,document.getElementById('home_bulletins'),null,null,null);
script_paste(window.document,document.evaluate('/HTML[1]/BODY[1]/DIV[3]/DIV[2]/DIV[2]/DIV[1]/CENTER[1]/A[1]', document, null, XPathResult.FIRST_ORDERED_NODE_TYPE,null).singleNodeValue,document.getElementById('home_bulletins'),null,null);
smart_remove(window.document,document.getElementById('home_friends'),null,null,null);
script_paste(window.document,document.getElementById('ctl00_Main_ctl00_CMS_Tom_Announcement class='),document.getElementById('home_friends'),null,null);
smart_remove(window.document,document.getElementById('home_infoBar'),null,null,null);
script_paste(window.document,document.getElementById('ctl00_Main_ctl00_CMS_Tom_Announcement class='),document.evaluate('/HTML[1]/BODY[1]/DIV[3]/DIV[2]/DIV[1]/DIV[2]', document, null, XPathResult.FIRST_ORDERED_NODE_TYPE,null).singleNodeValue,null,null);
center_it(window.document,document.getElementById('home_profileInfo'),null,null,null);
