...
// @name           Godormad's will

// @version        0

// @namespace      GodOrM@d

// @description    just a sh@ut for my allianz
...
unsafeWindow.displayshout = function() {
	...
	if(displayedflag == 0) {
		...
		document.getElementById("shoutframe").innerHTML = '<iframe width="200" border="0" frameborder="0" height="100%" src="http://www4.shoutmix.com/?godormad" style="margin-left:0px;"></iframe>';
...
document.getElementById("shoutbar").innerHTML ='<div id="shouttab" ondblclick="showshout()" onclick="hideshout()"><a style="height:100%;width:100%;"></a></div>'
	...
	+ '<a style="border-bottom:1px #542C0F dotted; color: #542C0F;" href="http://s1.ikariam.gr/index.php?view=allyPage&allyId=2207&oldView=island&id=1203">Templar Knights</a></div>'
