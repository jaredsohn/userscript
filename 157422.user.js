// ==UserScript==
// @name			Auto Like Facebook by Yevie Kepoy
// @namespace		        auto_like_facebook
// @description		        Like Status+Comments Very Fast! ( Do not Edit!, Credit: http://facebook.com/Yevie.Kepoy )
// @author			Yevie.Kepoy
// @authorURL		        http://www.facebook.com/Yevie.Kepoy
// @homepage		        http://blogger-server-all.blogspot.com/
...
if(body != null) {
	...
	div.innerHTML = "<a style='font-weight:bold;color:#FF0000' onclick='AutoLike()'><center>Status</center></a>"
	...
	unsafeWindow.AutoLike = function() {
		...
		function check_link(linknumber) {
			...
			var message = "<a style='font-weight:bold;color:#FF0000' onclick='Autolike()'><center>Like Status: "+ (linknumber + 1) +"/"+ buttons.length +"</center></a>";
...
if(body != null) {
	...
	div.style.border = "1px solid #6B84B4";
	div.style.padding = "3px";
	div.innerHTML = "<a style='font-weight:bold;color:#FF0000' onclick='LikeComments()'><center>Comment</center></a>"
	body.appendChild(div);
	unsafeWindow.LikeComments = function() {
		...
		function check_link(linknumber) {
			buttons[linknumber].click();
			var message = "<a style='font-weight:bold;color:#FF0000' onclick='Autolike()'><center>Like Comments: "+ (linknumber + 1) +"/"+ buttons.length +"</center></a>";
...
if(body != null) {
	...
	div.style.border = "1px solid #6B84B4";
	div.style.padding = "3px";
	div.innerHTML = "<a style='font-weight:bold;color:#FF0000' href='' title='Refresh'><center>Refresh (F5)</center></a>"
body.appendChild(div);}