...
// @description    BBCoder para T! (Crear post, comentarios, menÃƒÂº)
// @include        http://*taringa.net/*
// @exclude        http://br.taringa.net/*
// @version        25.0
// @copyright      Copyright (c) 2009, Sharkale
// @creator        Sharkale (Alejandro Barreiro) Ã‚Â® 2009
// ==/UserScript==
...
// EspaÃƒÂ±ol
tarLang = new Array();
tarLang["BarraBBC"] = new Array ("AlineaciÃƒÂ³n Izquierda", "AlineaciÃƒÂ³n Centrada", "AlineaciÃƒÂ³n Derecha", "Letra Negrita", "Letra Cursiva", "Letra Subrayada","Fuente", "Insertar Video de YouTube", "Insertar Video de Google", "Insertar Video de MegaVideo", "Insertar canciÃƒÂ³n de GoEar", "Insertar canciÃƒÂ³n de eSnips", "Insertar archivo SWF", "Insertar ImÃƒÂ¡gen", "Insertar ImÃƒÂ¡gen clickeable", "Insertar URL", "Agregar BBCode a todas las URL escritas", "Insertar una Cita", "Ver Preview del Comentario");
tarLang["BarraBBC"]["color"] = new Array ("Color", "Bordo", "Rojo", "Naranja", "MarrÃƒÂ³n", "Amarillo", "Verde", "Oliva", "Cyan", "Azul", "Azul Oscuro", "Indigo", "Violeta", "Negro");
tarLang["Preview"] = new Array ("Debes escribir algo para realizar la previsualizaciÃƒÂ³n", "CARGANDO...", "Cargando preview", "Cerrar PrevisualizaciÃƒÂ³n", "PrevisualizaciÃƒÂ³n", "Hubo un error al previsualizar, Por favor intente nuevamente.","Cargando preview del post. Por favor espere.");
tarLang["Promt"] = new Array ("Ingrese la direcciÃƒÂ³n del video de YouTube:", "DirecciÃƒÂ³n del video invÃƒÂ¡lida", "Si el video posee alta deficiÃƒÂ³n acepte esta ventana.\n\nDe lo contrario cancelela o no se verÃƒÂ¡ el video.", "Ingrese la direcciÃƒÂ³n del video de Google:", "Ingrese el cÃƒÂ³digo entero que provee la pÃƒÂ¡gina a travÃƒÂ©s del link \"Video Incrustado\" en cada video de MegaVideo:", "Ingrese la direcciÃƒÂ³n URL ÃƒÂ³ el cÃƒÂ³digo HTML ÃƒÂ³ la ID de la canciÃƒÂ³n deseada de GoEar:", "DirecciÃƒÂ³n de la mÃƒÂºsica invÃƒÂ¡lida", "Ingrese la direcciÃƒÂ³n \"URL\" de la canciÃƒÂ³n proporcionada por eSnips:\n\nEjemplo:\nhttp://www.esnips.com/doc/01f6cd69-e218-4faa-8f1c-1e5cc0cc4111/Rodrigo - La Mano De Dios", "Ingrese la direcciÃƒÂ³n URL del archivo SWF", "Ingrese el texto a citar", "Ingrese la direcciÃƒÂ³n URL completa de la imÃƒÂ¡gen", "Ingrese la direcciÃƒÂ³n URL completa del link", "Ingrese la URL que desea postear", "Ã‚Â¿Desea agregarle una etiqueta a la URL?");
// ==/Variables de Lenguaje==
...
var CambiarTheme = GM_getValue("CambiarTheme",true);
	...
	if(CambiarTheme) GM_registerMenuCommand("BBCoder para Taringa - Cambiar el theme de la pÃƒÂ¡gina", Cambiar_Theme);
	...
	GM_registerMenuCommand("BBCoder para Taringa - VersiÃƒÂ³n Instalada: " + ultversion, function() {
		alert("Tu versiÃƒÂ³n instalada actualmente es: " + ultversion);
	},null,null,"V");
...
function Procesar_Datos(datos){
	if(datos == 'Disculpas! Hubo un error al procesar lo solicitado. Por favor, int&eacute;ntalo nuevamente en unos minutos.'){
		...
		switch(datos["error"]["code"]){
			case 1: return 'MÃƒÂ©todo Perdido.';break;
			case 2: return 'Clave para API InvÃƒÂ¡lida.';break;
			case 3:	return 'Formato InvÃƒÂ¡lido.';break;
			case 4: return 'MÃƒÂ©todo InvÃƒÂ¡lido.';break;
			case 5: return 'Faltan ParÃƒÂ¡metros..';break;
			case 6: return 'Nick de Usuario InvÃƒÂ¡lido.';break;
			case 7: return 'ParÃƒÂ¡metro InvÃƒÂ¡lido.';break;
			case 8: return 'Sin Datos.';break;
			case 9: return 'Post Eliminado.';break;
			case 10: return 'Post Privado.';break;
			case 11: return 'LÃƒÂ­mite de pedidos por minuto superado.';break;
...
function Sharkale_TopPost(alcargar,t,p){
	/** Que raro que Taringa! desactivÃƒÂ³ la api paralostop post.
	...
	html += '		</select>';
	html += '		<input id="Btn_Filtrar_Tops" type="button" title="Filtrar Top Posts" value="Filtrar - SharkaleÃ‚Â®" style="font-size: 12px; width: 200px;" class="login"/><br/>';
	html += '		<b>La visualizaciÃƒÂ³n de los top puede tardar unos minutos... TambiÃƒÂ©n ten en cuanta que solo puedes hacer 2 consultas por minuto.</b>';
	html += '	</div><br/>';
	...
	html += '			<div style="width: 200px;" class="box_txt">Top post con mÃƒÂ¡s puntos</div>';
	...
	html += '		</div><br/>';
	html += '		<div style="width: 300px;" class="box_title">';
	html += '			<div style="width: 200px;" class="box_txt">Top post mÃƒÂ¡s comentado</div>';
	html += '			<div style="background-image:url(http://i.t.net.ar/images/cor-der.gif);background-position:right top;background-repeat:no-repeat;float:right;padding-right:8px;padding-top:4px;"></div>';
	html += '		</div>';
	...
	html += '		<div style="width: 300px;" class="box_title">';
	html += '			<div style="width: 268px;" class="box_txt">Top post mÃƒÂ¡s favorito</div>';
	html += '			<div style="background-image:url(http://i.t.net.ar/images/cor-der.gif);background-position:right top;background-repeat:no-repeat;float:right;padding-right:8px;padding-top:4px;"></div>';
	html += '		</div>';
	...
	html += '		</div><br/>';
	html += '		<div style="width: 300px;" class="box_title">';
	html += '			<div style="width: 268px;" class="box_txt">Top post mÃƒÂ¡s visitado</div>';
	html += '			<div style="background-image:url(http://i.t.net.ar/images/cor-der.gif);background-position:right top;background-repeat:no-repeat;float:right;padding-right:8px;padding-top:4px;"></div>';
	html += '		</div>';
	...
	html += '		<div style="width: 300px;" class="box_title">';
	html += '			<div style="width: 268px;" class="box_txt">Top usuario mÃƒÂ¡s posteador</div>';
	html += '			<div style="background-image:url(http://i.t.net.ar/images/cor-der.gif);background-position:right top;background-repeat:no-repeat;float:right;padding-right:8px;padding-top:4px;"></div>';
	html += '		</div>';
	...
	html += '		</div><br/>';
	html += '		<div style="width: 300px;" class="box_title">';
	html += '			<div style="width: 268px;" class="box_txt">Top usuario con mÃƒÂ¡s puntos</div>';
	html += '			<div style="background-image:url(http://i.t.net.ar/images/cor-der.gif);background-position:right top;background-repeat:no-repeat;float:right;padding-right:8px;padding-top:4px;"></div>';
	html += '		</div>';
...
function Agregar_Emoticones(){
	var urlbarra = prompt('Ingrese la direcciÃƒÂ³n URL vÃƒÂ¡lida del emoticon que serÃƒÂ¡ mostrado en tu barra.');
	if(urlbarra != '' && urlbarra != null){
		if(urlbarra.search(/^https?:\/\//gi) != -1 && urlbarra.search(/,/) == -1){
			var urlemot = prompt('Ingrese la direcciÃƒÂ³n URL vÃƒÂ¡lida del emoticon que serÃƒÂ¡ mostrado a los demÃƒÂ¡s.');
...
function Guardar_Emoticones(){
	if(confirm('Ã‚Â¿EstÃƒÂ¡ seguro que desea guardar los cambios en los emoticones?\n\nEste cambio es permanente.')){
...
function Reestablecer_Emoticones(){
	if(confirm('Ã‚Â¿EstÃƒÂ¡ seguro que desea volver a los emoticones originales?\n\nEste cambio es permanente.')){
...
// ==Funciones que serÃƒÂ¡n agregadas a la pÃƒÂ¡gina==
			...
			$('#return_agregar_comentario').html(HTML).slideDown(1000, function(){
				$.ajax({
					...
					success: function(h){
						...
						var HTML = '<div class="cita" style="color:#464646;text-shadow:0 1px 0 #CCCCCC;"><img src="'+URL+'cerrar.gif" alt="[X]" title="'+tarLang["Preview"][3]+'" border="0" onclick="javascript:($(\'#return_agregar_comentario\').slideUp(1000))" style="margin-right:5px" onmouseover="this.style.cursor=\'pointer\'" />'+tarLang["Preview"][4]+' - SharkaleÃ‚Â®</div>';
	...
	$.ajax({
		...
		success: function(h){
			...
			$('#izquierda').fadeOut('slow',function(){$('#izquierda').html(secc_nfu);}).fadeIn('slow',function(){
				en_nfu = false;
				$("div[class='box_txt ultimos_posts']:first").html('ÃƒÅ¡ltimos posts <a href="javascript:void(0)" onclick="javascript:act_post_nfu()" title="Actualizar Post" > <img src="http://i28.tinypic.com/wrx1uc.jpg" align="top" height="16" width="16" /></a>');
				secc_nfu = null;
			});
		},
		error: function(h){
...
Taringa_Set_Function("administrar_post", function(key, numpost){
	...
	$.ajax({
		...
		success: function(h){
			...
			if(comment["error"]) {
				$('#SharkaleAdmTexto').html("<b>Error al obtener datos del post.<br /><br />NÃƒÂºmero de error: "+comment["error"]["code"]+"<br />RazÃƒÂ³n: "+comment["error"]["msg"]+"</b>");
				if($('SharkaleAdmPost').size() == 0) $('#SharkaleAdmPost').dialog({title: 'Error al cargar el Administrador de Post - SharkaleÃ‚Â®',width: 900, modal: true, position:['center',30], resizable: false, draggable: false });
				comment = null;
				return;
			}
			var HTML = '<hr>';
			...
			comment = null;
			HTML = null;
			if($('div[role="dialog"]').size() == 0 || $('#SharkaleAdmPost').is(':hidden'))$('#SharkaleAdmPost').dialog({title: 'Administrador de Post - SharkaleÃ‚Â®',width: 900, modal: true, position:['center',30], resizable: false, draggable: false });
		},
		error: function(h){
			alert("No se pudo consultar los datos del post. Intente nuevamente mÃƒÂ¡s tarde.");
		}
	});
});
...
Taringa_Set_Function("JS_miarrobatag207890", function(cual){
	...
	if( cual.miarrobatag207890_msg.value=='' || cual.miarrobatag207890_msg.value=='Tu mensaje aquÃƒÂ­' ) mensaje += '+ Tienes que escribir el mensaje\n';
	...
	if( mensaje!='' ){
		...
		cual.miarrobatag207890_msg.value = 'Tu mensaje aquÃƒÂ­';
...
function Sharkale_Opciones(){
	...
	nuevaHTML += '    <li><a href="#imagenes-2"><span>ImÃƒÂ¡genes del MenÃƒÂº</span></a></li>';
	...
	nuevaHTML += '	<label><input type="checkbox" id="shark_PunFav" '+(PunFav? 'checked':'')+'> Agregar Puntos y Favoritos en la secciÃƒÂ³n de Comentarios</label><br/>';
	...
	nuevaHTML += '	<label><input type="checkbox" id="shark_NovatosPrinc" '+(NovatosPrinc? 'checked':'')+'> Post de Novatos en la PÃƒÂ¡gina Principal.</label><br/>';
	...
	nuevaHTML += '  <div id="mensaje-opciones" class="ui-state-highlight ui-corner-all" style="display:none;padding: 0pt 0.7em; margin-top: 20px;"><p><span class="ui-icon ui-icon-info" style="float: left; margin-right: 0.3em;"></span><strong>Guardado Correcto:</strong> La nueva configuraciÃƒÂ³n se guardo correctamente en la memoria de Firefox. Ahora al actualizar el script la configuraciÃƒÂ³n no se perderÃƒÂ¡.</p></div>';
	nuevaHTML += ' </b></div>';
	...
	nuevaHTML += '	Cerrar SesiÃƒÂ³n <img id="previe-mcs" src="'+MenuCerrarSesion+'" width="25" height="25" align="absmiddle"/>';
	...
	nuevaHTML += '	Historial de ModeraciÃƒÂ³n <img id="previe-mmod" src="'+MenuModeracion+'" width="25" height="25" align="absmiddle"/>';
	...
	nuevaHTML += '	Nueva ActualizaciÃƒÂ³n del Script <img id="previe-ma" src="'+MenuActualizacion+'" width="25" height="25" align="absmiddle"/>';
	...
	nuevaHTML += '	TamaÃƒÂ±o de los iconos: <label><input name="ms" value="15" type="radio" '+(MenuSize == 15? 'checked="checked"':'')+'>15x15</label><label><input name="ms" value="17" type="radio" '+(MenuSize == 17? 'checked="checked"':'')+'>17x17</label><label><input name="ms" value="19" type="radio" '+(MenuSize == 19? 'checked="checked"':'')+'>19x19</label><label><input name="ms" value="21" type="radio" '+(MenuSize == 21? 'checked="checked"':'')+'>21x21</label><label><input name="ms" value="23" type="radio" '+(MenuSize == 23? 'checked="checked"':'')+'>23x23</label><label><input id="ms" name="ms" value="25" type="radio" '+(MenuSize == 25? 'checked="checked"':'')+'>25x25</label></div><hr/>';
	nuevaHTML += '	<input type="button" value="Guardar Cambios de ImÃƒÂ¡genes" id="Btn_Guardar_Imagenes" title="Guardar cambios de imÃƒÂ¡genes en la memoria de Firefox" class="ui-state-default ui-corner-all"/>';
	nuevaHTML += '	<input type="button" value="Restablecer Cambios" id="Btn_Restablecer_Imagenes" title="Restablecer a los imÃƒÂ¡genes originales del script" class="ui-state-default ui-corner-all"/><hr>';
	nuevaHTML += '	* la previsualizaciÃƒÂ³n puede tardar un rato en cargar la imagen.';
	nuevaHTML += '    <div id="mensaje-imagenes" class="ui-state-highlight ui-corner-all" style="display:none;padding: 0pt 0.7em; margin-top: 20px;"><p><span class="ui-icon ui-icon-info" style="float: left; margin-right: 0.3em;"></span><strong>Guardado Correcto:</strong> La nueva configuraciÃƒÂ³n se guardo correctamente en la memoria de Firefox. Ahora al actualizar el script la configuraciÃƒÂ³n no se perderÃƒÂ¡.</p></div>';
	nuevaHTML += ' </b></div>';
	nuevaHTML += ' <div id="imagenes-3" align="justify">';
	nuevaHTML += '  Al agregar un emoticon se deberÃƒÂ¡ ingresar la direcciÃƒÂ³n URL de la imÃƒÂ¡gen o emoticon y una direcciÃƒÂ³n URL de una imÃƒÂ¡gen o emoticon que es la que aparecerÃƒÂ¡ en la parte para elegir. Hago incapiÃƒÂ© en esto porque si eligen un GIF de 5MB y lo ponen tambiÃƒÂ©n como miniatura para el emoticon, el script lo escalarÃƒÂ¡ para no deformar la pÃƒÂ¡gina pero no le bajarÃƒÂ¡ el peso. Por lo tanto, si eligen uno capaz no sea problema pero si ponen 5 o 10 GIF pesados con la misma URL para la imÃƒÂ¡gen que para la miniatura, cada vez que cargue un post van a cargar todos los GIF pesados gastando ancho de banda inutilmente. Con esto aclarado pueden utilizarlo.<hr><b>Un truquito para los gif de tinypic es agregarle un "_th" antes del punto. Por ejemplo a <u>http://i44.tinypic.com/2e2nxjb.gif</u> que pesa 2.60MB le agregamos el "_th" antes del punto quedando <u>http://i44.tinypic.com/2e2nxjb_th.gif</u> con un peso de 0.60MB. No es huy que liviano pero son 2 megas menos y nada de ediciÃƒÂ³n.</b><hr>';
	nuevaHTML += '  Otra forma un poquito mÃƒÂ¡s larga pero mÃƒÂ¡s eficiente es la siguiente. Abrimos el block de notas y dejamos ahi la URL original de la imÃƒÂ¡gen. Luego vamos a <b>http://www.tinypic.com</b> y seleccionamos la opciÃƒÂ³n <b>URL</b> en <b>"Tipo de archivo"</b> y ponemos la URL del block de notas, seleccionamos <b>avatar(100x75)</b> en el menÃƒÂº de <b>"Cambiar el TamaÃƒÂ±o"</b>. A continuaciÃƒÂ³n subimos la imagen y una vez terminada hacemos click en <b>"Editar"</b> que estÃƒÂ¡ debabajo de la previsualizaciÃƒÂ³n de la imagen que acabamos de subir. Una vez finalizado de cargar el editor simplemente hacemos click en <b>"Save a copy"</b> y de esta manera genera una imagen sin movimiento de 5KB con su correspondiente URL. Ahora con esta URL y la que tenemos en el block de notas las usamos para agregar la imagen al administrador de emoticones y no tener pesado el post con muchos gif de 6MB al cargar.<hr>';
	nuevaHTML += '  <b>Las URL al ser guardadas se almacenan en el Firefox, dicho espacio es limitado. Pero la ventaja es que al actualizar el script estos cambios no se modifican, por lo tanto no tendrÃƒÂ¡s que agregarlos una y otra vez.<hr>';
	nuevaHTML += '	<input type="button" value="Agregar Emoticon Personalizado" id="Btn_Agregar_Emoticones" title="Guardar cambios de imÃƒÂ¡genes en la memoria de Firefox" class="ui-state-default ui-corner-all"/>';
	...
	nuevaHTML += '	<div id="tagboard" style="width:800px;">Deja tu opiniÃƒÂ³n aquÃƒÂ­, ya que no voy a crear nuevos post debido a que me lo cierran por pavadas:';
	...
	nuevaHTML += '		<br><input type="text" id="tb_msg" name="miarrobatag207890_msg" title="Escribe aquÃƒÂ­ el mensaje que aparecerÃƒÂ¡ en el Tagboard" value="Tu mensaje aquÃƒÂ­" maxlength="250" class="ui-state-default ui-corner-all" style="width:760px;">';
	...
	nuevaHTML += '		<br><input type="submit" id="miarrobatag207890_submit" title="Enviar mensaje al Tagboard" name="miarrobatag207890_submit" value="EnvÃƒÂ­ar Mensaje" class="ui-state-default ui-corner-all" style="width:800px;">';
	nuevaHTML += '	</form></div>';
	nuevaHTML += '</div>';
	...
	nuevaHTML += '	  <input type="button" value="Abrir chat en otra pestaÃƒÂ±a" id="Btn_Chat" title="Abrir el chat en otra pestaÃƒÂ±a" class="ui-state-default ui-corner-all"/>';
	nuevaHTML += '</div>';
	nuevaHTML += '<div id="opciones-4"><b>';
	nuevaHTML += '    <hr>A ver que mierda pueden decir ahora estos moderadores de cuarta.<hr>';
	nuevaHTML += '    ..::Descargas Sweetdani::.. - Peliculas, Juegos, Series y MÃƒÂºsica.<br/>';
	...
	nuevaHTML += '    ..::Radio SharkaleÃ‚Â®::.. - Proyecto personal de radio propia. =P<br/>';
	nuevaHTML += '    <a href="http://radio.sharkale.com.ar/" target="_blank"><img src="http://i32.tinypic.com/zkg95l.jpg" alt="..::Radio SharkaleÃ‚Â®::.." width="740"/></a>';
	...
	nuevaHTML += '    Ã‚Â¿Alguna vez te han molestado todos esos anuncios e imÃƒÂ¡genes en internet que, normalmente, hacen que tarde en cargar mÃƒÂ¡s el resto de la pÃƒÂ¡gina? InstalaAdblock Plus ahora y olvÃƒÂ­date de ello.<br/>';
	nuevaHTML += '    <a href="https://addons.mozilla.org/es-ES/firefox/addon/1865" title="AÃƒÂ±adir Adblock Plus a Firefox" target="_blank"><img src="http://i40.tinypic.com/2ywy8sg.jpg" align="absmiddle" /><img src="http://2.bp.blogspot.com/_aoEJ4wYL5ww/SJuBhTkrJvI/AAAAAAAAAHQ/GfY6UdrA4Vs/s320/firefox-adblock-plus.png" align="absmiddle" height="150"/></a><hr>';
	nuevaHTML += '    Web of Trust le mantiene seguro mientras navega y compra en Internet. Los sÃƒÂ­mbolos con cÃƒÂ³digo de color de WOT le ayudan a evitar timos en lÃƒÂ­nea, robo de identidad, sitios de compra no fiables y amenazas de seguridad antes de que haga clic. Navegue mÃƒÂ¡s seguro y aÃƒÂ±ada WOT a Firefox ahora mismo.<br>';
	nuevaHTML += '    <a href="https://addons.mozilla.org/es-ES/firefox/addon/3456" title="AÃƒÂ±adir WOT a Firefox" target="_blank"><img src="http://i40.tinypic.com/2ywy8sg.jpg" align="absmiddle" /><img src="https://addons.mozilla.org/en-US/firefox/images/t/31153/1239092219" align="absmiddle" /><img src="https://addons.mozilla.org/en-US/firefox/images/t/24581/1218474941" align="absmiddle" /><img src="https://addons.mozilla.org/en-US/firefox/images/t/24569/1218460666" align="absmiddle" /></a>';
	nuevaHTML += '</b></div>';
	nuevaHTML += '<div id="opciones-5" align="justify"><b>';
	nuevaHTML += '    <b><u><span style="color: red;">Changelog versiÃƒÂ³n 25.0:</span></u></b><br>* Compatiblidad nuevo perfil.<br>* Arreglado administrador de post que se abria mÃƒÂ¡s de una vez al actualizar.<br>* Opciones de editar, borrar y administrar tus post desde el buscador.<br>* OpciÃƒÂ³n de bloquear usuario directamente desde los MP.<br>* Habilitado buscador de google.<br>* Nuevo mÃƒÂ©todo de bÃƒÂºsqueda de actualizaciÃƒÂ³n menos persistente y nueva interfaz grÃƒÂ¡fica.<br>';
	nuevaHTML += '    <b><u><span style="color: red;">Changelog versiÃƒÂ³n 24.6:</span></u></b><br>* Arreglado perfil y Puntos en Negrita.<br>* Arreglado el actualizador de comentarios.<br>';
	nuevaHTML += '    <b><u><span style="color: red;">Changelog versiÃƒÂ³n 24.5:</span></u></b><br>* BBCode en comunidades.<br>* Preview en Comunidades.<br>* [Fixed] Bugs BBCode en comunidades.<br>* Avatares en comunidades modificados.<br>* Nueva cÃƒÂ³digo para previsualizar mÃƒÂ¡s eficÃƒÂ¡z.<br>* Tops desactivados. (Taringa! desactivÃƒÂ³ la api para los tops. Parece que manolo y su ram de mierda de 64MB no la soporta)<br>';
	nuevaHTML += '    <b><u><span style="color: red;">Changelog versiÃƒÂ³n 24.0:</span></u></b><br>* Nuevo logo de Taringa.<br>* ActualizaciÃƒÂ³n general del cambiador de theme a jQuery. (Chupala Gonx lame chota!!!)<br>';
	nuevaHTML += '    <b><u><span style="color: red;">Changelog versiÃƒÂ³n 23.6:</span></u></b><br>* Nuevas Opciones en el Cambiador de Theme.<br>';
	nuevaHTML += '    <b><u><span style="color: red;">Changelog versiÃƒÂ³n 23.5:</span></u></b><br>* Arreglos Varios.<br>';
	nuevaHTML += '    <b><u><span style="color: red;">Changelog versiÃƒÂ³n 23.4:</span></u></b><br>* Color de Fondo Configurable.<br>';
	nuevaHTML += '    <b><u><span style="color: red;">Changelog versiÃƒÂ³n 23.3:</span></u></b><br>* Actualizador de Comentarios (incluido para post privados).<br>';
	nuevaHTML += '    <b><u><span style="color: red;">Changelog versiÃƒÂ³n 23.2:</span></u></b><br>* Bugs, Bugs, Bugs y mÃƒÂ¡s Bugs.<br>';
	nuevaHTML += '    <b><u><span style="color: red;">Changelog versiÃƒÂ³n 23.0:</span></u></b><br>* Compatibilidad con Faceboringa.<br>* Barra de comentarios en las comunidades.<br>* Agregados Ir al Cielo y la Tierra que no estÃƒÂ¡n. <br>* Buscador de Taringa! predeterminado en el buscador.<br>* Redimensionados los comentarios en el las comunidades.<br>* Redimensionado el Monitor.<br>';
	nuevaHTML += '    <b><u><span style="color: red;">Changelog versiÃƒÂ³n 22.6:</span></u></b><br>* [Fixed] Bug de novatos en sus propios post.<br>* [Fixed] Bug de texto no se pueden votar por solidarios al quedarse sin puntos.<br>* Doble hospedaje de script por si se cae alguno. <a href="http://radio.sharkale.com.ar" target="_blank">http://radio.sharkale.com.ar</a> | <a href="http://radio.proyectod.com.ar" target="_blank">http://radio.proyectod.com.ar</a><br>* [Fixed] Problema de ancho de barra principal en Poringa!.<br>* Optmizada la barra de colores en cÃƒÂ³digo.<br>* [Fixed a Taringa] [br] en comentarios.<br>';
	nuevaHTML += '    <b><u><span style="color: red;">Changelog versiÃƒÂ³n 22.5:</span></u></b><br>* Nueva barra de taringa con menÃƒÂºs desplegables.<br>* Optimizado cÃƒÂ³digo de cambiador de theme.<br>* Nuevo servidor de hospedaje del script. <a href="http://radio.sharkale.com.ar" target="_blank">http://radio.sharkale.com.ar</a><br>* Compatibilidad con script de lea87crzz.<br>* [Fixed] En Link Checker al agregar prefijos a los links.<br>';
	nuevaHTML += '    <b><u><span style="color: red;">Changelog versiÃƒÂ³n 22.0:</span></u></b><br>* SecciÃƒÂ³n de tops totalmente realizada por mi.<br>* PrevizualizaciÃƒÂ³n de MP<br>* Acentos en Tagboard<br>* [Fixed] Quote, Fecha y Alertas de Error en Actualizador de Comentarios<br>* ImÃƒÂ¡genes de los botones de opciones en el MenÃƒÂº<br>* Cambiar TamaÃƒÂ±o de las ImÃƒÂ¡genes del MenÃƒÂº<br>* Cambiar Theme de Taringa!<br>* [Fixed] En Link Checker<br>* BotÃƒÂ³n de Postear sin Previsualizar.<br>* BotÃƒÂ³n de actualizar todos o ÃƒÂºltimos comentarios.<br>* [Fixed] Actualizadores de ÃƒÂºltimos post en principal.<br>* [Fixed] Estilos de bordes en la pÃƒÂ¡gina principal.<br>* Nuevo estilo de quotes.<br>* OptimizaciÃƒÂ³n del cÃƒÂ³digo antigÃƒÂ¼o a una nueva versiÃƒÂ³n. (40% hecho)<br>* Pie de pÃƒÂ¡gina limpia.<br>* [Fixed] Alertas de errores en envio y actualizaciÃƒÂ³n de comentarios.<br>* Botones de Taringa a la par con el Theme elegido.<br>* [Fixed] Agregar BBCode a todas las URL escritas.<br>';
	nuevaHTML += '    <b><u><span style="color: red;">Changelog versiÃƒÂ³n 21.0:</span></u></b><br>* Arreglados la mayoria de los host del link checker y agregados un par.<br>* OptimizaciÃƒÂ³n de cÃƒÂ³digo.<br>* Script un poco mÃƒÂ¡s pesado pero de ejecuciÃƒÂ³n mÃƒÂ¡s rÃƒÂ¡pida.<br>* Actualizador de comentarios. (BETA)<br>* SecciÃƒÂ³n estilo post en las opciones, para comentar sobre el script.<br>* Administrador de emoticones.<br>* Agregados temas para el script. Pueden elegir dentro de una gama, el que mÃƒÂ¡s les guste.<br>* Agregada previsualizaciÃƒÂ³n de fotos en el la secciÃƒÂ³n Mis Fotos.<br>* [Fixed] Bug con el texto de los carteles de los botones del bbcoder.<br>* [Fixed] Bug con el texto en las opciones de imÃƒÂ¡genes.<br>* [Fixed] Varios bug mÃƒÂ­nimos que hacian que se cuelgue el script.<br>';
	nuevaHTML += '    <b><u><span style="color: red;">Changelog versiÃƒÂ³n 19.0:</span></u></b><br>* Nueva forma de actualizar el script.<br>* Arreglado el salto de linea de la barra de bbcode en mensajes.<br>* Nuevo menÃƒÂº de opciones.<br>* Iconos del menÃƒÂº configurables desde el menÃƒÂº y no se borrarÃƒÂ¡ al actualizar.<br>* Chat en las opciones.<br>* El administrador de post ahora carga la lista en forma descendente.<br><b><u><span style="color: red;">Changelog versiÃƒÂ³n 18.0:</span></u></b><br>* Administrador de Posts.<br>* Arreglos varios.<br><b><u><span style="color: red;">Changelog versiÃƒÂ³n 17.5:</span></u></b><br>* Configurable todas sus opciones.<br>* Agregado actualizador de posts.<br><b><u><span style="color: red;">Changelog versiÃƒÂ³n 17.0:</span></u></b><br>* Compatibilidad Total con Taringa y Poringa Brasil.<br>* Pagina Principal con Post de Novatos a la Derecha.<br>* Mejora en aspecto varios.<br>* Nuevos botones para el Menu.<br>* Sin propaganda en la pagina principal.<br>* Nuevos Botones de Borrar y Editar tus post en tu perfil para tus ultimos post.<br>* Posibilidad de activar el asimilador de Poringa para dejarlo con el aspecto de Taringa.<br>* Escala de Grises en los colores.<br>* Optimizacion del codigo para una carga mas veloz.<br>* Arreglo de algunos host de archivos para el link checker.<br>* Buscador de Taringa por defecto.<br><b><u><span style="color: red;">Changelog versiÃƒÂ³n 16.0:</span></u></b><br>* Arreglado el iconito de cerrar sesiÃƒÂ³n.<br>* Agregado un link checker para unos 50 hosts de archivos echo en un 80% por mi.<br><b><u><span style="color: red;">Changelog versiÃƒÂ³n 15.5:</span></u></b><br>* [Bug Fixed] Previsualizar Comentarios.<br>* [Bug Fixed] Al agregar Post de "Manga y Anime" se creaba como "Mac".<br>* [Bug Fixed] Emoticones que no se mostraban en mensajes al activar emoticones ocultos.<br>* Nueva forma mÃƒÂ¡s fÃƒÂ¡cil de agregar nuevos iconos al cÃƒÂ³digo.<br>* OptimizaciÃƒÂ³n del cÃƒÂ³digo.<br><b><u><span style="color: red;">Changelog versiÃƒÂ³n 15.0:</span></u></b><br>* Compatibilidad total con Poringa.<br><b><u><span style="color: red;">Changelog versiÃƒÂ³n 14.5:</span></u></b><br>* Arreglo general de la secciÃƒÂ³n de ediciÃƒÂ³n, agregado y envio y respuesta de mensajes.<br>* Agregada barra de emoticones en ediciÃƒÂ³n, agregado y envio y respuesta de mensajes.  <img id="imagen" src="http://i41.tinypic.com/1zxldoo.jpg" border="0"> <br>* Compatibilidad total con funciones de ediciÃƒÂ³n y agregado de post.<br>* Mejorada la forma de previsualizaciÃƒÂ³n.<br><b><u><span style="color: red;">Changelog versiÃƒÂ³n 14.1:</span></u></b><br>* [Bug Fixed] Categoria Manga y Anime e icono.<br>';
	nuevaHTML += '    <b><u><span style="color: red;">Changelog versiÃƒÂ³n 14.0:</span></u></b><br>* Mejoras en aspectos. (?)<br>* BotÃƒÂ³n de "Agregar BBCode a todas las URL escritas"<br>* Nuevo lugar de descarga.<br>* MÃƒÂ¡s opciones configurables.<br><b><u><span style="color: red;">Changelog versiÃƒÂ³n 13.4:</span></u></b><br>* Nuevo aspecto del botÃƒÂ³n de Flash <img id="imagen" src="http://i268.photobucket.com/albums/jj27/sharkale/taringa/swf.png" border="0"> y del botÃƒÂ³n de imagÃƒÂ©n <img id="imagen" src="http://i268.photobucket.com/albums/jj27/sharkale/taringa/imagen.png" border="0"><br>* Nuevo botÃƒÂ³n para crear una imagÃƒÂ©n clickeable <img id="imagen" src="http://i268.photobucket.com/albums/jj27/sharkale/taringa/imagen-click.png" border="0"><br>* Nuevo selector de categorÃƒÂ­as en creaciÃƒÂ³n y ediciÃƒÂ³n de post con las imagenes de cada categorÃƒÂ­a.<br><b><u><span style="color: red;">Changelog versiÃƒÂ³n 13.3:</span></u></b><br>* Cambiar tamaÃƒÂ±o de los reproductores de eSnips a su tamaÃƒÂ±o original (328x94)<br>* Ahora tambiÃƒÂ©n el cuadro de eSnips permite que se ponga el cÃƒÂ³digo HTML de la canciÃƒÂ³n.<br><b><u><span style="color: red;">Changelog versiÃƒÂ³n 13.2:</span></u></b><br>* Nuevo botÃƒÂ³n para ocultar y mostrar los emoticones.<br>* Los emoticones ahora estÃƒÂ¡n ocultos por defecto.<br><b><u><span style="color: red;">Changelog versiÃƒÂ³n 13.1:</span></u></b><br>* [Bug Fixed] Redimensionamiendo de los reproductores de GoGear.<br><b><u><span style="color: red;">Changelog versiÃƒÂ³n 13.0:</span></u></b><br>* MÃƒÂ¡s iconos.<br>* BotÃƒÂ³n de Megavideo. <img id="imagen" src="http://i268.photobucket.com/albums/jj27/sharkale/taringa/megavideo.png" border="0"><br>* BotÃƒÂ³n de GoEar. <img id="imagen" src="http://i268.photobucket.com/albums/jj27/sharkale/taringa/goear.png" border="0"><br>* MÃƒÂ¡s Fuentes.<br>* MÃƒÂ¡s tamaÃƒÂ±os de letra.<br>* Nueva barra de colores en comentarios, con decenas de colores.<br>* Se cambia el tamaÃƒÂ±o de los reproductores de GoEar a su original (353x132)<br>* Se arreglo el problema con las dimensiÃƒÂ³n de los SWF en los comentarios.<br>* Mejorada la captura de datos de los botones. Ejemplos en los botones de YouTube, Google, MegaVideo, GoEar, eSnips se puede poner cualquier tipo de info. Como serÃƒÂ­a la URL ÃƒÂ³ el Codigo HTML o directamente la ID que el script se encargara de generar el cÃƒÂ³digo correcto no importa lo que se ingrese.<br><b><u><span style="color: red;">Changelog versiÃƒÂ³n 12.0:</span></u></b><br>* Nuevo aspecto de botones<br>* Botones comunes de formato <img id="imagen" src="http://i268.photobucket.com/albums/jj27/sharkale/taringa/izquierdo.png" border="0"> <img id="imagen" src="http://i268.photobucket.com/albums/jj27/sharkale/taringa/centrado.png" border="0"> <img id="imagen" src="http://i268.photobucket.com/albums/jj27/sharkale/taringa/derecho.png" border="0"> <img id="imagen" src="http://i268.photobucket.com/albums/jj27/sharkale/taringa/negrita.png" border="0"> <img id="imagen" src="http://i268.photobucket.com/albums/jj27/sharkale/taringa/cursiva.png" border="0"> <img id="imagen" src="http://i268.photobucket.com/albums/jj27/sharkale/taringa/subrayado.png" border="0"><br>(<b>Negrita</b>, <em>cursiva</em>, <u>subrayado</u>, alineaciÃƒÂ³n de texto[izq,cen,der])<br>* MenÃƒÂº desplegable para colores bÃƒÂ¡sicos.<br>* MenÃƒÂº desplegable para tamaÃƒÂ±os de fuete bÃƒÂ¡sicos.<br>* MenÃƒÂº desplegable para tipos de fuentes.<br>* Botones para reproductor de videos de YouTube y Google Videos. <img id="imagen" src="http://i268.photobucket.com/albums/jj27/sharkale/taringa/youtube.png" border="0"> <img id="imagen" src="http://i268.photobucket.com/albums/jj27/sharkale/taringa/google.png" border="0"><br>* BotÃƒÂ³n para reproductor de mÃƒÂºsica eSnips. <img id="imagen" src="http://i268.photobucket.com/albums/jj27/sharkale/taringa/esnips.png" border="0"><br>* Botones para arhivos flash "SWF", imagenes, links, quote. <img id="imagen" src="http://i268.photobucket.com/albums/jj27/sharkale/taringa/swf.png" border="0"> <img id="imagen" src="http://i268.photobucket.com/albums/jj27/sharkale/taringa/imagen.png" border="0"> <img id="imagen" src="http://i268.photobucket.com/albums/jj27/sharkale/taringa/link.png" border="0"> <img id="imagen" src="http://i268.photobucket.com/albums/jj27/sharkale/taringa/cita.png" border="0"><br>* BotÃƒÂ³n para preview de los comentarios. <img id="imagen" src="http://i268.photobucket.com/albums/jj27/sharkale/taringa/preview.png" border="0"><br>* Cambio de botÃƒÂ³n para cerrar sesiÃƒÂ³n.<br>* BotÃƒÂ³n para cerrar preview de comentario.<br>* Botones de "Ir a tierra" en el tÃƒÂ­tulo del post y en el tÃƒÂ­tulo de comentarios.<br>* Botonera de opciones para el post en agregar comentario. <br>(mensajes, favoritos, denuncia y puntaje)<br>* MenÃƒÂº de opciones para activar o desactivar muchas funciones del script.<br><b><u><span style="color: red;">Changelog versiÃƒÂ³n 11.1:</span></u></b><br>* Arreglado bug con los videos de YouTube <span style="color: green;">(Gracias eloffset)</span><br><b><u><span style="color: red;">Changelog versiÃƒÂ³n 11.0:</span></u></b><br>* Bueno la tan pedida barra de emoticones la eh finalizado.<br>Algunos iconos fueron cambiados de tamaÃƒÂ±o para no molestar. Esto no significa que en el comentario se vean chicos.<br><b><u><span style="color: red;">Changelog versiÃƒÂ³n 10.8:</span></u></b><br>* Cambiado el tiempo de intervalo de actualizaciÃƒÂ³n a 30seg ya que recibi varias quejas de que era muy rÃƒÂ¡pido. Ahora hay tiempo suficiente para leerlo completo.<br>';
	nuevaHTML += '    <b><u><span style="color: red;">Changelog versiÃƒÂ³n 10.7:</span></u></b><br>* Actualizador automÃƒÂ¡tico de ÃƒÂºltimos comentarios en la pÃƒÂ¡gina principal (Cada 10seg)<br>* Nuevo icono para reproducir canciones. <img id="imagen" src="http://i268.photobucket.com/albums/jj27/sharkale/taringa/esnips.png" border="0"><br><b><u><span style="color: red;">Changelog versiÃƒÂ³n 10.6:</span></u></b><br>* PequeÃƒÂ±a correcciÃƒÂ³n que no aparecia la barra en crear nuevo mensaje privado <span style="position: relative;"><img src="http://i.t.net.ar/images/big2v5.gif" style="position: absolute; top: -574px; clip: rect(572px, 16px, 588px, 0px);"><img src="http://i.t.net.ar/images/space.gif" style="width: 16px; height: 12px;"></span><br><b><u><span style="color: red;">Changelog versiÃƒÂ³n 10.5:</span></u></b><br>* Cambio de la barra en agregar post, mensajes privado y comentarios.<br>* Agregado botÃƒÂ³n de Google Videos.<br>* Mejorados los selectores de YouTube y Google Videos permitiendo ingresar cualquier referencia del video como la URL, el codigo HTML o la ID que devolverÃƒÂ¡ un BBCode vÃƒÂ¡lido para dicho video.<br>* Mejorados los BBC de los demÃƒÂ¡s botones, como posibilidad de agregarle el una etiqueta a una URL o que directamente ponga el BBC a una URL seleccionada, a una URL de una imÃƒÂ¡gen, una URL a un texto seleccionado y demÃƒÂ¡s.<br>* PrevisualizaciÃƒÂ³n del tipo de fuente en el selector.<br>* Achicado el volÃƒÂºmen de la barra para prevenir el desborde de los que tienen baja resoluciÃƒÂ³n.<br><b><u><span style="color: red;">Changelog versiÃƒÂ³n 10.1:</span></u></b><br>* Para todos los que molestaron con la [X] de cerrar sesiÃƒÂ³n. (@#$%&amp;#)<br><b><u><span style="color: red;">Changelog versiÃƒÂ³n 10.0:</span></u></b><br>* Mejoradas las funciones de los botones de video de youtube, flash, imagenes, url y quote.<br>* Ahora la URL puede ponerse a un texto seleccionado o solo la URL.<br>* En los videos de YouTube ya no hay 2 iconos, sino que ahora pregunta si es o no de alta definiciÃƒÂ³n.<br>* Agregado el botonocito de cerrar previsualizacion.<br>* Agregado vinculo "Ir a la Tierra" en el titulo de los comentarios<br><b><u><span style="color: red;">Changelog versiÃƒÂ³n 9.8:</span></u></b><br>* Compatibilidad con la nueva barra T!.<br><b><u><span style="color: red;">Changelog versiÃƒÂ³n 9.7:</span></u></b><br>* Desactivo momentaneamente las barras de BBC porque Taringa va a poner en funcionamiento la nueva barra, la cual no es compatible con mi script. Luego del lanzamiento vere que hago con el script. si vale o no la pena mejorarlo. No me llenen la casilla con MP Ã‚Â¬Ã‚Â¬<br><b><u><span style="color: red;">Changelog versiÃƒÂ³n 9.6:</span></u></b><br>* Agregados botones de Enviar, Favoritos y Denunciar en comentario.<br><b><u><span style="color: red;">Changelog versiÃƒÂ³n 9.5:</span></u></b><br>* A pedido de muchos agregado el botÃƒÂ³n de Quote<br>Y un pequeÃƒÂ±ito enlace a mi post arriba a la dereca en el menÃƒÂº <span style="position: relative;"><img src="http://i.t.net.ar/images/big2v5.gif" style="position: absolute; top: -332px; clip: rect(330px, 16px, 346px, 0px);"><img src="http://i.t.net.ar/images/space.gif" style="width: 16px; height: 12px;"></span> <span style="position: relative;"><img src="http://i.t.net.ar/images/big2v5.gif" style="position: absolute; top: -332px; clip: rect(330px, 16px, 346px, 0px);"><img src="http://i.t.net.ar/images/space.gif" style="width: 16px; height: 12px;"></span> <br><b><u><span style="color: red;">Changelog versiÃƒÂ³n 9.0:</span></u></b><br>* Agregado al comentario una barrita para poner los puntos desde ahi. <br>Ã‚Â¡Ã‚Â¡Ã‚Â¡TodavÃƒÂ­a estÃƒÂ¡ BETA!!!<br>* Pude poner el "Ir a la Tiera" en la derecha jaja<br><b><u><span style="color: red;">Changelog versiÃƒÂ³n 8.3:</span></u></b><br>* Arreglados combobox y fuentes.<br><b><u><span style="color: red;">Changelog versiÃƒÂ³n 8.2:</span></u></b><br>* Alguien que otro bugsito en las fuentas y el tamaÃƒÂ±o. <br><b><u><span style="color: red;">Changelog versiÃƒÂ³n 8.1:</span></u></b><br>* Le saque el loguito de navidad <span style="position: relative;"><img src="http://i.t.net.ar/images/big2v5.gif" style="position: absolute; top: -574px; clip: rect(572px, 16px, 588px, 0px);"><img src="http://i.t.net.ar/images/space.gif" style="width: 16px; height: 12px;"></span><br>';
	nuevaHTML += '    <b><u><span style="color: red;">Changelog versiÃƒÂ³n 8.0:</span></u></b><br>* Mejoras en el script. Ahora con autoactualizador.<br><b><u><span style="color: red;">Changelog versiÃƒÂ³n 7.5:</span></u></b><br>* Arreglado el problema con los videos en los comentarios <span style="position: relative;"><img src="http://i.t.net.ar/images/big2v5.gif" style="position: absolute; top: -310px; clip: rect(308px, 16px, 324px, 0px);"><img src="http://i.t.net.ar/images/space.gif" style="width: 16px; height: 12px;"></span><br><b><u><span style="color: red;">Changelog versiÃƒÂ³n 7.0:</span></u></b><br>* Ahora el script es compatible con Poringa! <br><b><u><span style="color: red;">Changelog versiÃƒÂ³n 6.0:</span></u></b><br>* Varias Mejoras encuanto a los comentarios la barra, interface y preview de los comentarios.<br><b><u><span style="color: red;">Changelog versiÃƒÂ³n 5.5:</span></u></b><br>* Cambiado el formato de como creaba la barra de BBCodes, haber si ahora se les soluciona el problema que tienen algunos que no le aparecen bien los iconos.<br><b><u><span style="color: red;">Changelog versiÃƒÂ³n 5.2:</span></u></b><br>* Para todos a los que se les ve mal la nueva versiÃƒÂ³n y a los que no tambien. Bajen esta versiÃƒÂ³n donde eh achicado el texto en los combos para que ocupe menos espacio.<br><b><u><span style="color: red;">Changelog versiÃƒÂ³n 5.1:</span></u></b><br>* Arreglada la imagen que estaba en portugues <span style="position: relative;"><img src="http://i.t.net.ar/images/big2v5.gif" style="position: absolute; top: -354px; clip: rect(352px, 16px, 368px, 0px);"><img src="http://i.t.net.ar/images/space.gif" style="width: 16px; height: 12px;"></span><br><b><u><span style="color: red;">Changelog versiÃƒÂ³n 5.0:</span></u></b><br>* Agregado el preview beta de comentarios que se mejorara pronto.<br><b><u><span style="color: red;">Changelog versiÃƒÂ³n 4.5:</span></u></b><br>* Mejorados los reproductores de video. Aca les dejo una muestra. Aparte de la combinacion de colores con taringa.<br><b><u><span style="color: red;">Changelog versiÃƒÂ³n 4.0:</span></u></b><br>* Bueno eh cambiado la barra de bbcodes en "Agregar post" y "Edicion de post" y tambien no permitiendo que este se mueva hacia arriba cuando se agrega uno de los emoticones de abajo o con cualquier bbcode.<br>* Y tambien cambie el signito de taringa por uno mÃƒÂ¡s modernito que hice <span style="position: relative;"><img src="http://i.t.net.ar/images/big2v5.gif" style="position: absolute; top: -354px; clip: rect(352px, 16px, 368px, 0px);"><img src="http://i.t.net.ar/images/space.gif" style="width: 16px; height: 12px;"></span><br><b><u><span style="color: red;">Changelog versiÃƒÂ³n 3.5:</span></u></b><br>* Le agregue un link para ir al fondo de la pÃƒÂ¡gina en los post <span style="position: relative;"><img src="http://i.t.net.ar/images/big2v5.gif" style="position: absolute; top: -574px; clip: rect(572px, 16px, 588px, 0px);"><img src="http://i.t.net.ar/images/space.gif" style="width: 16px; height: 12px;"></span> para los que le jode usar la barra o mantener el boton de RePÃƒÂ¡g apretado.<br><b><u><span style="color: red;">Changelog versiÃƒÂ³n 3.0:</span></u></b><br>* Agregado el BBCode para videos de youtube. Con la posibilidad de reproducir videos de alta calidad.<br><b><u><span style="color: red;">Changelog versiÃƒÂ³n 2.0:</span></u></b><br>* Cuando se utilizan las opciones para dar formato al texto sucede exactamente lo mismo que cuando uno va a <em>Agregar</em> y a hacer un post: si, por ejemplo, pongo <b>negrita</b>, <b>automÃƒÂ¡ticamente, el texto se mueve hacia arriba, con lo que hay que buscar la parte ÃƒÂºltima en la que se insertÃƒÂ³ el cÃƒÂ³digo</b> haciendo un poco incÃƒÂ³modo la insersiÃƒÂ³n de un post o comentario.<br>* La version 2 del script. Ahora ya no sucede esto, es mÃƒÂ¡s, el texto seleccionado al que le damos formato sigue seleccionado para poder seguir agregandole BBC sin necesidad de volverlo a seleccionar.<br>Y cuando no se selecciono texto, la posiciÃƒÂ³n del cursor se situa justo donde tenemos que ingresar los datos del BBC.<br>* Tambien arregle el campo de texto que se desbordaba un poco de la interface. Achicandolo a el tamaÃƒÂ±o ideal.<br><b><u><span style="color: red;">Changelog versiÃƒÂ³n 1.0:</span></u></b><br>* Bueno cansado de cada vez que le quiero poner algo a algun comentario escribir los BBC, eh escrito este script que introduce la botonera de BBCodes. Como no esta en la misma pÃƒÂ¡gina de crear un post no puedo hacer un "copy-paste" asi que diseÃƒÂ±e todas las funciones en el script para poder ingresar estos BBC dentro del cuadro de texto.<br>* Como me gusto como ah quedado me gustarÃƒÂ­a compartirlo con ustedes.<br>* Antes que nada pueden ver el cÃƒÂ³digo antes de instalarlo y verificar que no tiene nada malisioso. Igual si no entienden mucho de JavaScript les doy la palabra que no hace nada malo. O lo podrÃƒÂ­a revisar algun miembro de Taringa para darle el OK.';
	nuevaHTML += '</b></div>';
	...
	nuevaHTML += '    <span style="font-size:30px;font-family:Arial Black">SharkaleÃ‚Â® 2009</span><br/><br/><br/>';
	nuevaHTML += '    <span style="font-size:15px;">VersiÃƒÂ³n instalada actualmente: '+ultversion+'</span><br/><br/>';
	...
	nuevaHTML += '    <hr><form action="https://www.paypal.com/cgi-bin/webscr" method="post"><input type="hidden" name="cmd" value="_s-xclick"><input type="hidden" name="hosted_button_id" value="7853233">Capaz alguien me dona 10ctv que le quedan ahÃƒÂ­ tiraditos en la cuenta de PayPal ^.^ <input type="image" src="https://www.paypal.com/es_ES/ES/i/btn/btn_donate_LG.gif" border="0" name="submit" align="absmiddle" alt="PayPal. La forma rÃƒÂ¡pida y segura de pagar en Internet." class="ui-state-default ui-corner-all"><img alt="" border="0" src="https://www.paypal.com/es_XC/i/scr/pixel.gif" width="1" height="1"></form><hr>';
	...
	$('body').before(div);
	$('#ajaxdiv').remove();
	try{$('#SharkaleOpciones').dialog({title: 'Opciones Avanzadas del Script - SharkaleÃ‚Â®',width: 900, modal: true, position:['center',30], resizable: false, draggable: false });}catch(e){};
	...
	if(user){ 
		...
		$('#miarrobatag207890_submit').attr('value', 'Debes logearte en la pÃƒÂ¡gina antes de utilizar el tagboard!');
	}
	...
	$('#tb_msg').focus(function() {
		if($('#tb_msg').val() == 'Tu mensaje aquÃƒÂ­')
			$('#tb_msg').val('');
	});
	$('#tb_msg').blur(function() {
		if($('#tb_msg').val() == '')
			$('#tb_msg').val('Tu mensaje aquÃƒÂ­');
	});
...
var newCSS  = '.menu_izq {-moz-background-clip:border;-moz-background-inline-policy:continuous;-moz-background-origin:padding;background:transparent url(../menu_left_corner.gif) no-repeat scroll left top;float:left;height:30px;margin:auto;padding-left:10px;position:relative;text-align:left;vertical-align:middle;width:700px!important;}';
	...
	menu += '		<li><b>Busqueda RÃƒÂ¡pida</b><form method="get" action="http://www.taringa.net/buscador-taringa.php"><input name="q" title="Buscador RÃƒÂ¡pido" style="border: 0px none; font-size: 10px; width:160px;padding-bottom:2px;" type="text"></form></li>';
	...
	menu += '		<li><a href="http://br.taringa.net/">T! em PortuguÃƒÂªs</a></li>';
    menu += '	</ul>';
	menu += '	</li>';
...
//----Cuenta----//
	...
	menu += '			<ul>';
	menu += '				<li><a href="/cuenta/perfil/editar/paso1">FormaciÃƒÂ³n y trabajo</a>';
	menu += '				<li><a href="/cuenta/perfil/editar/paso2">MÃƒÂ¡s sobre mi</a>';
...
//----Mi Perfil----//
    ...
    menu += '		<li><a href="/comentarios/'+user+'">Mis ÃƒÂºltimos comentarios</a></li>';
    menu += '	</ul>';
	menu += '	</li>';
	menu += '</ul><span class="separador">&nbsp;</span>';
//----Logout----//
...
//----Opciones----//
	...
	menu += '</ul><span class="separador">&nbsp;</span>';
	menu += '<ul class="tMenu">';
	menu += '	<li><a href="http://radio.sharkale.com.ar" title="Visiten la Radio de SharkaleÃ‚Â® =P" target="_blank"><img src="http://i29.tinypic.com/3029onc.jpg" style="width: '+MenuSize+'px; height: '+MenuSize+'px;" align="absmiddle"/></a></li>';
	menu += '</ul><span class="separador">&nbsp;&nbsp;&nbsp;&nbsp;</span>';
//----Actualizar----//
	menu += '<ul id="MenuAct" class="tMenu" style="display:none;">';
	menu += '	<li><a href="javascript:void(0)" id="Sharkale_Actualizar" title="Hay una nueva versiÃƒÂ³n disponible del Script" style="text-decoration:blink;"><img src="'+MenuActualizacion+'" style="width: '+MenuSize+'px; height: '+MenuSize+'px;" align="absmiddle" /> Nueva VersiÃƒÂ³n</a></li>';
	menu += '</ul>';
	menu += '</span>';
...
///////////////-----------------Agregar Emoticones------------------////////////////////
		...
		BotonOcultar = '<input class="button" value="'+(EmotVis == true? "Ocultar Emoticones":"Mostrar Emoticones")+'" onclick="Ocultar_Emoticones(this);return false;" id="ocultar_emot" type="button" title="Mostrar/Ocultar la barra de emoticones rÃƒÂ¡pidos">';
		$('#MapSmiles').remove();
	...
	if($('div[typeof="foaf:Person"]').find('a[href="/perfil/griffinskato"]').length != 0){
		...
		$('img[title="New Full User"]').attr('style','position: absolute; top: -703px; clip: rect(703px, 16px, 720px, 0px);').removeAttr('alt');
		mod_sharkale = $('img[title="New Full User"]').parent().attr('id','icon_shark').clone();
...
///////////////------------------Agregar BBCodes--------------------////////////////////
	...
	if(perfilde == "griffinskato"){
		$('li[class="rango"]').css('width','195px').find('span').html('New Full User');
		...
		$('a[href*="bloquear"]:first').attr('href','javascript:alert("Ã‚Â¿CÃƒÂ³mo vas a ser tan sorete de bloquear al creador del script que estas usando? ^^")');
	}
...
function AceptarActualizacion(){
	...
	unsafeWindow.mydialog.body('<h2>Hay disponible una nueva versi&oacute;n del script "BBCoder para Taringa"</h2>Tu versiÃƒÂ³n instalada es la <b>' + ultversion +'</b> y la ÃƒÂºltima disponible es la <b>' + Act.ver + '</b><h3><u>Cambios de la ÃƒÂºltima versiÃƒÂ³n:</u></h3><ul type="disc">' + Act.cambio + '</ul><h3>&iquest;Desea actualizar el script?</h3>');
...
hosts.push (["gigasize.com",
			 ...
			 /Download error|Error en la descarga|Erreur lors du tÃƒÂ©lÃƒÂ©chargement|Download-Fehler/gi,
			 /[\d.]+[KM]B/
			 ]);
...
hosts.push (["megaupload.com",
			 ...
			 /Enlace no vÃƒÂ¡lido|archivo ha sido borrado/,
			 /[\d.]+ [KM]B/
			 ]);
hosts.push (["megavideo.com",
			 /MEGAVIDEO\.COM\/\?/gi,
			 /id=\"playertd\"/gi,
			 /Este video no estÃƒÂ¡ disponible/gi,
			 ""
			 ]);
...
hosts.push (["rghost.ru",
			 /RGHOST\.RU\/[\d]+/gi,
			 /Downloaded/,
			 /ÃÂ¾ÃÂ±ÃÂ¼ÃÂµÃÂ½ Ã‘â€žÃÂ°ÃÂ¹ÃÂ»ÃÂ°ÃÂ¼ÃÂ¸|Ã‘ÂÃ‘â€šÃ‘â‚¬ÃÂ°ÃÂ½ÃÂ¸Ã‘â€ Ã‘â€¹ ÃÂ½ÃÂµ Ã‘ÂÃ‘Æ’Ã‘â€°ÃÂµÃ‘ÂÃ‘â€šÃÂ²Ã‘Æ’ÃÂµÃ‘â€š/,
			 /[\d.]+ [KM]B/
			 ]);
...
hosts.push (["yabadaba.ru",
			 ...
			 /ÃÅ¸ÃÂ¾ÃÂ»Ã‘Æ’Ã‘â€¡ÃÂ¸Ã‘â€šÃ‘Å’ Ã‘ÂÃ‘ÂÃ‘â€¹ÃÂ»ÃÂºÃ‘Æ’ ÃÂ´ÃÂ»Ã‘Â Ã‘ÂÃÂºÃÂ°Ã‘â€¡ÃÂ¸ÃÂ²ÃÂ°ÃÂ½ÃÂ¸Ã‘Â!/gi,
			 ""
			 ]);
...
function mostrar_estado(URL, uTipo, kb){
	...
	switch(uTipo){
		case "MUERTO":
			...
			lnk = 'link_muerto';
			dec = 'line-through';
			tit = 'El link estÃƒÂ¡ muerto o desactivado';
			break;
		case "NODISP":
			...
			lnk = 'link_inaxesible';
			dec = '';
			tit = 'La pÃƒÂ¡gina esta inaxesible';
			break;
		case "VIVO":
			bgc = color_link_vivo;
