// ==UserScript==
// @name			Facebook Auto Like All in One By Cah-Technik
// @namespace		Auto Mass Like & Confirm
// @version			15/01/2012
// @copyright		Cah-Technik
// @description		You can mass like or mass confirm friend request
// @author			Cah-Technik (http://userscripts.org/users/javas)
// @icon			http://3.bp.blogspot.com/-RfM_XBgohGo/TaQp7nP-_zI/AAAAAAAAAI4/1tS_HmsbG_4/s320/CA8XARGT.jpg
...
if(body != null) {
	...
	div.innerHTML = "<center><a href='http://java-electronic.blogspot.com/'><img src='http://4.bp.blogspot.com/-m0pC7e1CCQI/TaQp8KYlyaI/AAAAAAAAAJI/lKhDc0T07yU/s320/Eagle_Patriotic_t-shirt.jpg' alt='Cah-Technik' width='125' height='75' </a></center>"
	...
	div.style.width = "125px";
	div2.innerHTML = "<div style='background-color: #2E5392; color: #FFFFFF; border: 1px dashed #333333;'><center><a style='color: #FFFFFF;' onclick='spoiler()' title='Click to Hidden Widget'>&laquo;</a> &#8226; <a href='http://javaelectronic.net/' style='color: #FFFFFF;' onclick='alert(\'Thanks for instal this script\');'>Auto Like By Cah-Technik</a></center></div> "
	...
	for(i=1;i<=20;i++) {
		...
		div2.innerHTML = "<center><a onclick='spoiler()' title='Click to Hidden Widget'>&laquo;</a> &#8226; <a href='http://javaelectronic.net/' title='Thanks for instal this script'>Auto Like By Cah-Technik</a></center> "
		}
		else {
