...
// let it search on KAT.org 

// Version 1.04

// Fixed search attributes in KAT link
...
if(seasonHeaders.length>0){
   // Add Episodes by Show link to find all episodes on KAT
   var offset = 11;
   ...
   table.innerHTML+="<tbody><tr class='header' align='center'><td style='border-bottom: 1px solid black;'>KAT</td></tr><tr align='center'><td><a href='http://kickass.to/usearch/" + showName + searchAttributes + "' target='_blank' class='flatbutton'>Search</a></td></tr></tbody>";
...
// Create the table cell (td) that contains the KAT link.
function getKATcell(linkURL, fadeLink){
...
function createSimpleSearchURL(searchterm){
   var url = "http://kickass.to/usearch/" +
