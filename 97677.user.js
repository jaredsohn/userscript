// ==UserScript==
// @name           Kontrola ataków w menelgame
// @namespace      s
...
// ***********************************************************************************************
// ***********************************************************************************************
var THISSCRIPTVERSION = "1.9.1";
var THISSCRIPTNAME = "Angrifswarner im NG Style PG 4.0 Berlin + Hamburg + Muenchen";
var THISSCRIPTINSTALL_URL = 'http://userscripts.org/scripts/show/97677';          // URL fuer Hauptseite bei userscripts.org
var THISSCRIPTSOURCE_URL = 'http://userscripts.org/scripts/source/97677.user.js'; // Skript-URL bei userscripts.org
		...
		if(content.match(/już trwa/)){
			try{
				...
				var TimeOfImpact2 = content.split(".2011")[1].split("<br />")[0];
					...
					var sms ='<a title="Napisz wiadomość" href="'+link+'/messages/write/?to='+id2+'"><img src="'+statics+'icons/new_msg.gif" style=\"margin-bottom:2px;\"</a>';
...
var cash3 = cash/100;
var tbody = document.getElementsByClassName('zabsolute zleft')[0];
tbody.innerHTML +='<div style="height: 83px; top: 105px; left: -1px; padding-top:3px;  background: ;" id="notifyme" class="zabsolute zleft"><div style="margin-top:-12px; margin-right:-10px; margin-left:-10px;" class="icon fight zleft" id="nicon">&nbsp;</div><div style="margin-top:6px;" class="zleft right" id="ntext">'
