...
var autoPlayUpRiskLimit = 600;
var autoPlayDownRiskLimit = 1;
...
autoPlayUpRiskOrder[1] = "punk.rob";

// Lista de URL para baixar o risco (ajudar)
var autoPlayDownRiskOrder = new Array();

autoPlayDownRiskOrder[0] = "punk.rob";
autoPlayDownRiskOrder[1] = "newcar.rob";
...
autoPlayMapOrder[0] = "south";
autoPlayMapOrder[1] = "south";
autoPlayMapOrder[2] = "south";
autoPlayMapOrder[3] = "south";
autoPlayMapOrder[4] = "south";
autoPlayMapOrder[5] = "south";
autoPlayMapOrder[6] = "south";
autoPlayMapOrder[7] = "south";
autoPlayMapOrder[8] = "south";
