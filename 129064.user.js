// ==UserScript==
// @author		Angel Vladov
// @name        eRepublik Carebears Script
// @namespace   eRepublikBattlesReporter_CareBears
// @version		1.2.7
// @uso:version 1.2.7
// @include		http://*erepublik.com/*/military/battlefield/*
// @description    eRepublik Damage Reporting script for CareBears MU
// ==/UserScript==
...
if(window.location.href.indexOf(PAGE_BATTLEFIELD) > 0) {	
	...
	/***********************************************************************************/
	var FORM_URL = "https://docs.google.com/spreadsheet/viewform?formkey=dGdBQ0dhQjBIWkljR3dzSU1ITFF6YVE6MA#gid=0";
	var FORM_FIELDS = {
		eday: "entry.0.single",
		name: "entry.2.single",
	...
	function createLogoLabel() {
		$("#logo").append('\
			...
			<div style="font-weight: bold"><u>eRepublik Carebears Script</u> ' + VERSION + '</div>   		 \
			<b>Authors: </b>wazaabg		                                                              		 \
			</div></div>'
		);
	}
