...
// @contributor   s4nji, riza_kasela, p1nky, b3g0, fazar, bagosbanget, eric., bedjho, Piluze, intruder.master, Rh354, gr0, hermawan64, slifer2006, gzt, Duljondul, reongkacun, otnaibef, ketang8keting, farin, drupalorg, .Shana, t0g3, King.Haker, Firefoxie & all-kaskuser@t=3170414
    ...
    var parse_ajax_post = function(html){
        ...
        if(html.indexOf('POSTERROR')!=-1){ // there's some error
          ...
          if(cucok = ErMsg.match(/Please\s*try\s*again\s*in\s*([^.(]+)/i)){
            ...
            r = {err:1, msg:(/did\snot\smatch/i.test(ErMsg) ? 'Capcaynya salah': cucok[1])};
          }
