// ==UserScript==
// @name            Post Bulletins from Myspace Home page
// @namespace       blablabla
// @include         http://home.myspace.com/index.cfm?fuseaction=user
// I LIKE CATS!!!!
// ==/UserScript==
function do_platypus_script() {
do_modify_html_it(window.document,document.evaluate('/HTML[1]/BODY[1]/DIV[1]/FORM[1]/DIV[2]/DIV[4]/DIV[2]/DIV[1]/DIV[3]/DIV[1]/DIV[2]', document, null, XPathResult.FIRST_ORDERED_NODE_TYPE,null).singleNodeValue,/<a class="link1" href=/,'<IFRAME WIDTH="436" HEIGHT="436" SRC=',null);
