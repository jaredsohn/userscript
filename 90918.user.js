// ==UserScript==
// @name Facebook Tweak v3 - Kristian <kimocoder>
// @description Removed all Ads, Image Highlight, Friend Remove Checker and other tweaks!
...
if (prefs['Shortcuts']) {
	window.addEventListener('keydown', function(e) {
		...
		if (e.keyCode==27) {
			...
			switch(e.keyCode) {
				case 37: clickLink('First'); break;
				case 39: clickLink('Last'); break;
	...
	showPopup('<div id="FBFConfig" class="fbfPopup">'+
		...
		'<table id="fbfConfigContainer">'+
			...
			'</td><td id="fbfConfigControls">'+
				...
				'</div>'+
				'<div id="fbfConfigControl-9">'+ makeNumberInputs('ProcessInterval,DelayPopupPicsTimeout')+
		...
		if (prefs['iCalendar'] && page.indexOf('events.php?bday=1')==0) {
			try {
				...
				if (elm!=null) {
					...
					elm.innerHTML = elm.innerHTML + ' | <a href="#" id="fbfical">' + $l('ExportICalendarFile') + '</a><span id="fbfcalwarning"> ' + $l('ExportICalendarFileWarning') + '</span>';		document.getElementById('fbfical').addEventListener('click', function(e) {
