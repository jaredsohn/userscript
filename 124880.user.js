...
for (i = 0; i < uidList.length; i++ ) {
	...
	form += '<input type="submit" class="button" value="Rate" style="border:1px solid black;" onclick="window.open(\'http://www.free-leaks.com/reputation.php\', \'myrepwindow\', \'status=1,width=400,height=350\')"/>';
	form += '</form>';
