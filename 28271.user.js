...
// @namespace   t3
// @version 2.6cm
// @description  Travian v3 addons originally written by Victor Garcia (aka Croc) updated by Szabka; last UPDATE 12. may 2008 - russian language update
...
lang_en['ALIANZA'] 	= 'تحالف';
	lang_en['PERFIL'] 	= 'الملف الشخصي';
	lang_en['SIM'] 		= 'محاكي المعركه';
	lang_en['CALC'] 	= 'حاسبة ترافيان';
	lang_en['SEGURO'] 	= 'هل انت نتأكد؟';
	lang_en['MARK'] 	= 'تحديد الكل';
	lang_en['PERDIDAS'] 	= 'خساره';
	lang_en['RENT'] 	= 'الفائده';
	lang_en['SUBIR_NIVEL'] 	= 'متاح';
	lang_en['JUGADOR'] 	= 'اللاعب';
	lang_en['ALDEA'] 	= 'اسم القريه';
	lang_en['HAB'] 		= 'السكان';
	lang_en['COORD'] 	= 'الاحداثيات';
	lang_en['ACCION'] 	= 'الامر';
	lang_en['ATACAR'] 	= 'هجوم';
	lang_en['COMERCIAR'] 	= 'ارسال مصادر';
	lang_en['GUARDADO'] 	= 'حفظ';
	lang_en['DESP_ABR'] 	= 'تحريك';
	lang_en['FALTA'] 	= 'تحـتاج   ';
	lang_en['HOY'] 		= 'اليوم  ';
	lang_en['MANYANA'] 	= 'غداً';
	lang_en['PAS_MANYANA'] 	= 'بعد غد';
	lang_en['MERCADO'] 	= 'السوق';
	lang_en['CUARTEL'] 	= 'ثكنه';
	lang_en['PUNTO'] 	= 'نقطة تجمع';
	lang_en['CORRAL'] 	= 'اسطبل';
	lang_en['TALLER'] 	= 'ورشة عمل';
	lang_en['ENVIAR'] 	= 'ارسال مصادر';
	lang_en['COMPRAR'] 	= 'شراء';
	lang_en['VENDER'] 	= 'بيع';
	lang_en['ENVIAR_IGM'] 	= 'ارسال IGM';
	lang_en['LISTO'] 	= 'يتاح';
	lang_en['EL'] 		= 'في';
	lang_en['A_LAS'] 	= 'في';
	lang_en['EFICIENCIA'] 	= 'الفعاليه'; 
	lang_en['NUNCA']	= 'ابداً';
	lang_en['PC']           = 'نقاط الثقافه';
	lang_en['FUNDAR']       = 'إيجاد  قرية يمكننفتحها';
	lang_en['ALDEAS']       = 'قرى';
	lang_en['ENV_TROPAS'] 	= 'إرسال جنود';
	lang_en['RECURSO1']     = 'خشب';
	lang_en['RECURSO2']     = 'طين';
	lang_en['RECURSO3']     = 'حديد';
	lang_en['RECURSO4']     = 'قمح';
	lang_en['TIEMPO']       = 'الوقت';
	lang_en['COMP']         = 'ضغط التقاير';
	lang_en['STAT']		= 'الاحصائيات';
	lang_en['OFREZCO']	= 'معروض للبيع';
	lang_en['BUSCO']	= 'بحث';
	lang_en['TIPO']		= 'النوع';
	lang_en['DISPONIBLE']	= 'المتوفر فقط';
	lang_en['CUALQUIERA']	= 'غير محدد';
	lang_en['SI']		= 'نعم';
	lang_en['NO']		= 'لا';
        lang_en['MARCADORES']   = 'الروابط';
        lang_en['ANYADIR']      = 'إضافه';
        lang_en['ENLACE']       = 'العنوان';
        lang_en['TEXTO']        = 'النص';
	lang_en['ELIMINAR']	= 'حذف';
	lang_en['MAPA']		= 'الخريطه';
	lang_en['CHECK']	= 'البحث عن التحديثات';
	lang_en['ARCHIVE']	= 'الارشيف';
	lang_en['RESUMEN']	= 'متابعات';
        lang_en['STOREURL']         = 'مواقع مهم';
        lang_en['STOREPASSWORD']    = 'كلمة سر قوية';
        lang_en['OPTIONS']    		= 'خيارات';
        lang_en['VENTAS']    		= 'حفظ التغييرات';
        lang_en['SHOWINFO']    	= 'عرض الدليل السريع';
        lang_en['HIDEINFO']    		= 'اخفاء الدليل السريع';
        lang_en['MAPSCAN']    		= 'مسح للخرائط';
        lang_en['LOGIN'] = 'دخول';
        lang_en['VERSION']      = 'النسخة المتوفرة';
        lang_en['MAXTIME']      = 'اقصى زمن';
	lang_en['VERSION']			= 'احدث النسخ';
	lang_en['DETALLES']			= 'اضافات';
	lang_en['MAP_EXT']			= 'Extended map';
	lang_en['MAT_PRIMAS']		= 'المصدر الرئيسي';
	lang_en['ATAQUES']			= 'هجوم';
	lang_en['CONSTR']			= 'بناء';
	lang_en['TROPAS']			= 'جيوش'
	lang_en['ACTUALIZAR']		= 'البحث عن نسخة احدث';
	lang_en['RES'] 				= 'بحث شجري';
...
//            log(1,"v3 t:"+total[i]+" n:'"+necesario[i]+"' r:"+restante+ " tn:"+tiempo_max);
		...
		if (tiempo_max == 'Infinity'){
           // Soha nem lesz eleg nyertanyag szoveg.
            a = '<table align="right">'+res_table+'<tr><td colspan="2">'+T('LISTO') + '</td><td>' + T('NUNCA')+ '</td></tr></table>';
            ...
            // tl.
            a = '<table align="right">'+res_table+'<tr><td colspan="2">'+T('LISTO') + '</td><td>' + calcularTextoTiempo(fecha)+ '</td></tr></table>';
		}
//       log(1,a);
		return a;
	}
     ...
     //       td1.setAttribute('width','25%');
			...
			for (var j = 0; j < 25; j++){
				if (grid[i][j] > 0 && buildingCost[i][j+1] != null){
					...
					var imagen = '<a href="/build.php?id='+grid[i][j]+'"><div style="width: 80%;"><img src="data:image/gif;base64,' + imagenes["r" + i] + '" border="0" title="' + T('RECURSO' + (i+1)) + '">';
					if (j > 0) {
                       imagen += '<img src="' + img('g/s/s' + j + '.gif') + '" style="position:relative; bottom:51px; left: 1px;" border="0">';
                    }
					imagen += '</div></a>';
...
//				buildingCode = parseInt(buildingCode[0].substring(1, buildingCode[0].length));
				...
				if (buildingCost[buildingCode] != null && buildingCost[buildingCode][buildingLevel+1] != null){
					...
					var table2 = document.createElement('TABLE');
					table2.setAttribute("align", "right");
