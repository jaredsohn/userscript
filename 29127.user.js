// ==UserScript==
// @name Travian3 Beyond Updated v.0.3
...
function funcionPrincipal(e){
	...
	lang_it['LOGIN'] 	= 'Login'; 
	lang_it['MAPA'] 	= 'Mappa'; 
	lang_it['VERSION'] 	= 'L&quot; ultima versione disponible è'; 
...
*/
	 ...
	 */
	function img(ref, lang_dependant){ return ("http://members.lycos.nl/trav/" + idioma + '/' + ref); }
...
/*
TODO:
	- Optimizar algunas funciones para minimizar el tiempo de ejecución
	- Añadir resumen a la vista de todas las aldeas
