...
headings["Kicking"] = ["FGM","FGA","0-19","20-29","30-39","40-49","50+","XPM","XPA","Points"];
headings["Punting"] = ["Punts","Yds","Avg"];
...
function getKicking(stats) {
	...
	if ((output["FGA"] == 0) && (output["XPA"] == 0)) return null;
