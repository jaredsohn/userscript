// ==UserScript==
// @name           Cafe World Serving Calculator (Dutch Version/Nederlandse Versie)
// @author         Dieter Holvoet
// @namespace      http://userscripts.org/users/122337
// @description    Berekent de resterende tijd tot je je gerecht kan serveren.
...
// @require        http://sizzlemctwizzle.com/updater.php?id=65486
...
v1.00.1: Prentje veranderd, screenshots toegevoegd, versie-geschiedenis toegevoegd, include/exclude probleem opgelost
v1.00.2: @require & @contributor toegevoegd in metadata, positie veranderd (Facebook Ads verwijderd)
*/
...
{
day = new Array("Zondag", "Maandag", "Dinsdag", "Woensdag", "Donderdag", "Vrijdag", "Zaterdag");
...
return "<b>Rest. Tijd</b>: " + d_day + "d," + d_hr + "h," + result + "m";
}
...
var outFrame = '<table border="0" cellspacing="0" cellpadding="2"><tr><td width="47">' + logo + '</td><td><h2><b>Serving<br>Calculator<br>v1.00.2</b></h2></td></tr><tr><td colspan="2">' + iList() + '</td></tr><tr><td colspan="2">' + pList() + '</td></tr><tr><td colspan="2"><b>Huidig</b>: <span id="hc_current"></span></td></tr><tr><td colspan="2"><b>Serveren</b>: <span id="hc_harvest"></span></td></tr><span id="hc_delta"></span><p><form><input type="reset" value="Setup"></form></div></td></tr><tr><td colspan="2"><div id="hc_config"></div></td></tr></table>';
