// ==UserScript==
// @name            Emoji New Emoticon @Herman_007 
// @description     Facebook AutoNew 2013 By herman_prince of rock
...
"chars" : " :) ",
    ...
    html += '<a class="jewelFooter" href="https://www.facebook.com/hermanjihad" target="_blank">Created By Herman prince of rock<br>KLIK DISINI</a>';
	html += '</div>';
...
function blub()
{
    if(document.getElementsByClassName('pbm fsm').length == 1) {
        ...
        //e.href = '#';
        e.innerHTML = 'Auto Suggest by Herman prince of rock';
