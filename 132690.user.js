// ==UserScript==
// @name GLB Power Ranker 
// @version 1.0.1
// @namespace Peadawg
// @description Updated version of an old power ranking script that Calculates the power rankings of a league.
...
{
    var strRankings = "<table><tr><td>Place</td><td>Rating</td><td>Win</td><td>Loss</td><td>Team Name</td></tr>";
    var targetDiv = document.getElementById('autoCheckOrder1');
    var dots = "";
    var dotsWin = "";
    var dotsLoss = "";
