// ==UserScript==
// @name           Deltaklik.com, Kampungbux.com, Rumahklik.com Auto Click
// @namespace      http://userscripts.org/users/intifadha
// @description    Auto Click Ads On Deltaklik.com, Kampungbux.com, Rumahklik.com. Auto reloads setelah 2-4mins jika tidak ada iklan di temukan. By Intifadha
// @include        http://*deltaklik.com/surf.php
// @include        http://*deltaklik.com/index.php
// @include        http://*deltaklik.com/view.php?ad=*
// @include        http://*kampungbux.com/surf.php
// @include        http://*kampungbux.com/index.php
// @include        http://*kampungbux.com/view.php?ad=*
// @include        http://*rumahklik.com/surf.php
// @include        http://*rumahklik.com/index.php
// @include        http://*rumahklik.com/view.php?ad=*
// @copyright      Intifadha
// @version        1.0.0
// ==/UserScript==
...
//////////////////////////////////////////
// OPTIONS ///////////////////////////////
var close_window_when_done = true; // Close deltaklik.com window when finished with ads (true/false)
...
sec.setAttribute("style", "background:url('http://a5.sphotos.ak.fbcdn.net/hphotos-ak-ash4/304001_293611927316737_100000037966955_1218756_1318786212_n.jpg'); color:#ddd; border:8px ridge #000; padding:5em; position:absolute; top:"+window.innerHeight/3+"px; left:"+window.innerWidth/2+"px; text-align:center;");
