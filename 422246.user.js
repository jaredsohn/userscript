...
FL_ASL.main = function () {
    ...
    html_string += '<label><input type="checkbox" name="user[sex]" value="GF" checked="checked" />Gender Fluid</label>';
    html_string += '<label><input type="checkbox" name="user[sex]" value="GQ" checked="checked" />Genderqueer</label>';
    ...
    html_string += '<label><input type="checkbox" name="user[role]" value="Dom" checked="checked" />Dominant</label>';
    html_string += '<label><input type="checkbox" name="user[role]" value="Domme" checked="checked" />Domme</label>';
    html_string += '<label><input type="checkbox" name="user[role]" value="Switch" checked="checked" />Switch</label>';
    ...
    html_string += '<label><input type="checkbox" name="user[role]" value="Mistress" checked="checked" />Mistress</label>';
    ...
    html_string += '<label><input type="checkbox" name="user[role]" value="Top" checked="checked" />Top</label>';
    html_string += '<label><input type="checkbox" name="user[role]" value="bottom" checked="checked" />Bottom</label>';
    html_string += '<label><input type="checkbox" name="user[role]" value="Sadist" checked="checked" />Sadist</label>';
    html_string += '<label><input type="checkbox" name="user[role]" value="Masochist" />Masochist</label>';
    html_string += '<label><input type="checkbox" name="user[role]" value="Sadomasochist" checked="checked" />Sadomasochist</label>';
    ...
    html_string += '<label><input type="checkbox" name="user[role]" value="Fetishist" checked="checked" />Fetishist</label>';
    html_string += '<label><input type="checkbox" name="user[role]" value="Kinkster" checked="checked" />Kinkster</label>';
    html_string += '<label><input type="checkbox" name="user[role]" value="Hedonist" checked="checked" />Hedonist</label>';
    html_string += '<label><input type="checkbox" name="user[role]" value="Vanilla" checked="checked" />Vanilla</label>';
    html_string += '<label><input type="checkbox" name="user[role]" value="Unsure" checked="checked" />Unsure</label>';
