...
// @description    Dodaje ilość handlówek potrzebnch do zrabowania surowców
// @description    translate by sihulagen
...
function showTotal()
{
		...
		td1.innerHTML = 'Surowce w magazynie:';
		...
		td1 = document.createElement("td");
		td1.setAttribute("class","job");
		td1.innerHTML = 'Poziom magazynu :';

		td2 = document.createElement("td");
		 var wareDiv = <>
								<input type="text" style="text-align: right;" size="8"  id="warehouseLevelId" value="0"/> Wpisz poziom magazynu, dla kilku magazynów wpisz po przecinku np. 1,2,3
							</>;
		...
		td1 = document.createElement("td");
		td1.setAttribute("class","job");
		td1.innerHTML = 'Potrzebna ilosc handlówek :';
		...
		td2.innerHTML = <>
								<a
									...
									width="160" height="100" /> <span class="textLabel">&lt;&lt; Powrót do kryjówki</span>
								</a>
								</>;
		...
		td2 = document.createElement("td");
		td2.innerHTML = 'Owocnego rabowania, (translate by sihulagen :)';
