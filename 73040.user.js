// ==UserScript==
// @name           Grepolis Berichtformatierer
// @namespace      http://userscripts.org/scripts/show/65163
// @description    Grepolis BB-Code Berichtformatierer v1.23 - PvP Kampfberichte als BB-Code für das Forum ausgeben - Grepolis BB-Code Report formatter - Battle reports as BB-code output for the Forum
...
//RO
if (language=='ro') {
  var txt00='Grepolis BB-Code - Formatare raport';
  var txt01='Atac catre';
  var txt02='Reformatare raport';
  var txt03='Bonus batalie';
  var txt04='Lemne';
  var txt05='Pietre';
  var txt06='Arginti';
  var txt07='';
...
if(location.href.match(/action=view/)) { 
  ...
  if (document.getElementById('ReportTextArea')) {
    ...
    BerichtMenue.innerHTML='<a title="'+txt00+' '+version+'" onclick="document.getElementById(\'ReportTextArea\').style.display=\'block\'" href="#" class="submenu_link"><span class="left">&nbsp;</span><span class="middle">'+txt02+'</span><span class="right">&nbsp;</span>&nbsp;</a>';
