// ==UserScript==
// @name           Guerre Tribla - Chat Alliance GLT
// @author         michelan - Atkins Jean-Christophe
// @include        http://fr7.guerretribale.fr/*
// ==/UserScript==
...
// chatbox_top  61889
	...
	{
	sbival = "61889";
	GM_setValue("sbival_"+server, "61889");
	}
...
function AffichageChat() {
 ...
 if (swi == "1")
 {
  ...
  if(screen.width >= 1600)
		...
		p.setAttribute('style', 'position:absolute; right:0px; top:100px; width: 305px; height: 651px; allowtransparency="true";');
		}
		...
		p.setAttribute('style', 'position:absolute; right:0px; top:100px; width: 136px; height: 651px; allowtransparency="true";');
		}
 }
 else
 {
  ...
  if(screen.width >= 1600)
		{
		chat =  '<iframe src='+sbi+' width="300" height="650" frameborder="0" allowtransparency="true"></iframe>';
		p.setAttribute('style', 'position:absolute; left:0px; top:100px; width: 305px; height: 651px; allowtransparency="true";');
		}
	else if(screen.width == 1024)
		{
		...
		p.setAttribute('style', 'position:absolute; left:0px; top:100px; width: 141px; height: 651px; allowtransparency="true";');
		} 
 }
