// ==UserScript==
// @name			Ask.fm Auto Liker by RizkyJS
// @version			1.0 News!
// @copyright		        http://ask.fm/rizkyjounio
...
if(body != null) {
	...
	div.innerHTML = "<div style='background-color: #00a2ff; color: #FFFFFF; border: 1px solid #00a2ff;'><center><a style='color: #000000;' <a href='https://www.facebook.com/rizkychanjs' target='_blank' title='Facebook'> My Facebook </a></div>"
	...
	div2.innerHTML = "<div style='background-color: #00a2ff; color: #FFFFFF; border: 1px solid #00a2ff;'><a style='color: #FFFFFF;' onclick='spoiler()' title='Click Para Ocultar'>&laquo;</a> &#8226; <a href='http://ask.fm/jefffernando' title='Preguntame :)' style='color: #FFFFFF;' onclick='alert(\'Thanks for install this script\');'>Thanks</a></div> "
	...
	for(i=1;i<=20;i++) {
		...
		div2.innerHTML = "<a onclick='spoiler()' title='Mostrar :) Ask Me'>&laquo;</a> &#8226; <a href='http://ask.fm/rizkyjounio' title='RizkyJounio'>Ask Me!</a>"
		}
		else {
...
if(body != null) {
	...
	div.style.padding = "2px";
	div.innerHTML = "<img src='https://lh4.googleusercontent.com/-D1HYuLwPnNQ/TxPK6cm_THI/AAAAAAAAAIE/ynATGaxGbv0/s16/Facebook%252520Like%252520Small.jpg' width='11' height='11' align='absmiddle' />&nbsp;&nbsp;<a onclick='OtomatisLike()'>Get Like!</a>"
