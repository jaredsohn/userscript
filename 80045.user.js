...
Skin = {
	...
	advisors : [
		{ 'name' : 'advCities',		'normal' : 'http://s558.photobucket.com/albums/ss26/jeromedane_bc/ikariam/fantasy_theme/layout/advisors/mayor.png',		'active' : 'http://s558.photobucket.com/albums/ss26/jeromedane_bc/ikariam/fantasy_theme/layout/advisors/mayor_active.png' },
		{ 'name' : 'advMilitary',	'normal' : 'http://s558.photobucket.com/albums/ss26/jeromedane_bc/ikariam/fantasy_theme/layout/advisors/general.png',	'active' : 'http://s558.photobucket.com/albums/ss26/jeromedane_bc/ikariam/fantasy_theme/layout/advisors/general_active.png' },
		{ 'name' : 'advResearch',	'normal' : 'http://s558.photobucket.com/albums/ss26/jeromedane_bc/ikariam/fantasy_theme/layout/advisors/scientist.png',	'active' : 'http://s558.photobucket.com/albums/ss26/jeromedane_bc/ikariam/fantasy_theme/layout/advisors/scientist_active.png' },
		{ 'name' : 'advDiplomacy',	'normal' : 'http://s558.photobucket.com/albums/ss26/jeromedane_bc/ikariam/fantasy_theme/layout/advisors/diplomat.png',	'active' : 'http://s558.photobucket.com/albums/ss26/jeromedane_bc/ikariam/fantasy_theme/layout/advisors/diplomat_active.png' }
	],

	// add custom css styles
	addStyles : function ()
	{
		GM_addStyle("body { background:#202020 url(" + this.url + "http://img693.imageshack.us/img693/6294/bgstonet.jpg) repeat top center; }");
		...
		GM_addStyle("#header { background:#f3dcb6 url(" + this.url + "http://lh6.ggpht.com/_1Nek0ZarHrk/Sun4W7MZjqI/AAAAAAAAADM/NkDiRlKeieI/header3.png) no-repeat; }");
