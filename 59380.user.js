...
// @resource       LyricsSitesDefinitions  http://userscripts.org/scripts/source/59382.user.js
...

{
	...
	SU=new Updater(59380,"Youtube Lyrics","updater","//div[@id='YLLyricsPanel']");

	DU=new Updater(59382,"Definitions","definitions","//div[@id='YLLyricsPanel']",installDefinitions);
