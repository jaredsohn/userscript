// ==UserScript==
// @name           LiL Report import Script
// @description    LiL Report import Script 
// @author         Chaton
// @include        http://fr35.grepolis.com/*
// @version	1.0.1
// @history	1.0.1	passage au monde Knossos
...
\
		...
		$.get('http://peret.info/lil/ajaxer.php',\
		{\
...
scriptEl.appendChild(document.createTextNode("\
	...
	cBt.innerHTML = '<span class=\"left\"><span class=\"right\"><span class=\"middle\" id=\"eveilBtn\" style=\"min-width:50px\">LiL</span></span></span>';\
	msgb.append(cBt);\
