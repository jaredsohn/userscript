...
// @description    The-west yardım envartgs
...
function inv_updateTotalSellPrice (inv)
{
	...
	inv_TotalSellPrice.innerHTML = 'Toplam: $'+total+ ' Üstündekiler: $'+equipworth+ ', Çantadakiler: $'+bagworth+'<br>'+ '(Ürünler: $'+productworth+ ', Esyalar: $'+otherworth+')';
}
