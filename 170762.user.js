// ==UserScript==
// @name			*[ AUTOLIKE ]* Rivaldo
// @namespace		        *[ AUTOLIKE ]* AutoLike Facebook 
// @description		        *[ AUTOLIKE ]* AutoLike Facebook coded by http://riv-aldo.blogspot.com/. Auto Like status, wall and facebook comments system uses delay timer that allows you to control the speed of access and prevents blocking of the account.
// @author			https://www.facebook.com/rivaldoelekkoyokbojogg
// @authorURL		        
...
}
{
  ...
  div.style.position="fixed";
    ...
    div.style.border="1px solid #6B84B4";
    div.style.padding="3px";
    div.innerHTML="<a style='font-weight:bold;color:#E30505' href='https://www.facebook.com/rivaldoelekkoyokbojogg' target='_blank' title='Like Please' ><blink><center>RIVALDO</center></blink></a>";body.appendChild(div)}body=document.body;if(body!=null)
