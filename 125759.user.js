...
imp_choice = ["I:quest","I:Run"];
girl_choice = ["GiR:quest","GiR:run"];
...
// All your GM code must be inside this function
    function letsJQuery() {
		// Solver on/off
        $(document.body).append($("<input />").attr('type','button').attr('value','NOOB on').css("position", "absolute").css("left", "50px").css("zIndex", "99").click(function() {
            ativo = !ativo;
            if (ativo)
            {
                $(this).val("NOOB on");
        ...
        $(document.body).append($("<input />").attr('type','button').attr('value',gambler_choice[gambler]).css("position", "absolute").css("left", "265px").css("zIndex", "99").click(function() {
            if (gambler==0)
            {
                gambler=1;
        ...
        $(document.body).append($("<input />").attr('type','button').attr('value',dust_choice[dust]).css("position", "absolute").css("left", "325px").css("zIndex", "99").click(function() {
            if (dust==1)
            {
                dust=0;
        ...
        $(document.body).append($("<input />").attr('type','button').attr('value',wise_choice[wiseman]).css("position", "absolute").css("left", "385px").css("zIndex", "99").click(function() {
            if (wiseman==0)
            {
                wiseman=1;
        ...
        // Girl accept/fight
        $(document.body).append($("<input />").attr('type','button').attr('value',girl_choice[girl]).css("position", "absolute").css("left", "440px").css("zIndex", "99").click(function() {
            if (girl==1)
            {
                girl=0;
        ...
        // Imp accept/fight
        $(document.body).append($("<input />").attr('type','button').attr('value',imp_choice[imp]).css("position", "absolute").css("left", "515px").css("zIndex", "99").click(function() {
            if (imp==1)
            {
                imp=0;
		...
		// Ally accept/explore
        $(document.body).append($("<input />").attr('type','button').attr('value',ally_choice[ally]).css("position", "absolute").css("left", "575px").css("zIndex", "99").click(function() {
            if (ally==1)
            {
                ally=0;
        ...
        $(document.body).append($("<input />").attr('type','button').attr('value',niceAlly_choice[niceAlly]).css("position", "absolute").css("left", "635px").css("zIndex", "99").click(function() {
            if (niceAlly==1)
            {
                niceAlly=0;
        	...
        	// Elf fight/buy
        $(document.body).append($("<input />").attr('type','button').attr('value',elf_choice[elf]).css("position", "absolute").css("left", "700px").css("zIndex", "99").click(function() {
            if (elf==1)
            {
                elf=0;
    ...
    function verificaExploracao() {
        if (!ativo || document.getElementById("transdiv"))
        {
            return;
							...
							// Bosses
				if ($("td.areasign").html() && $("td.areasign").html().trim() == "Demon Leader")
		  {
		  if ($("span.mobname").html() && $("span.mobname").html() == "Demon Leader" ||
				$("span.mobname").html() && $("span.mobname").html() == "Demon Leader" ||
				$("span.mobname2").html() && $("span.mobname2").html() == "Demon Leader" ||
				$("span.mobname3").html() && $("span.mobname3").html() == "Demon Leader")
		{
		...
		if ($("td.areasign").html() && $("td.areasign").html().trim() == "The Rat Demon")
		  {
		  if ($("span.mobname").html() && $("span.mobname").html() == "The Rat Demon" ||
				$("span.mobname").html() && $("span.mobname").html() == "The Rat Demon" ||
				$("span.mobname2").html() && $("span.mobname2").html() == "The Rat Demon" ||
				$("span.mobname3").html() && $("span.mobname3").html() == "The Rat Demon")
		{
                location.href = "javascript:(" + encodeURI( function() {
                    $("div.btn100").each(function(indice) {
                        if ($(this).html() == "Attack")
				...
				if ($("td.areasign").html() && $("td.areasign").html().trim() == "Demon Senator")
		  {
		  if ($("span.mobname").html() && $("span.mobname").html() == "Demon Senator" ||
				$("span.mobname").html() && $("span.mobname").html() == "Demon Senator" ||
				$("span.mobname2").html() && $("span.mobname2").html() == "Demon Senator" ||
				$("span.mobname3").html() && $("span.mobname3").html() == "Demon Senator")
		{
                location.href = "javascript:(" + encodeURI( function() {
                    $("div.btn100").each(function(indice) {
                        if ($(this).html() == "Attack")
		  ...
		  {
									// Lake View
			if ($("span.mobname").html() && $("span.mobname").html() == "frog" || $("span.mobname").html() && $("span.mobname").html() == "ENRAGED frog" || $("span.mobname2").html() && $("span.mobname2").html() == "frog" || $("span.mobname3").html() && $("span.mobname3").html() == "frog")
		{
                location.href = "javascript:(" + encodeURI( function() {
                    $("div.btn100").each(function(indice) {
                        if ($(this).html() == "Attack")
		...
		if ($("span.mobname").html() && $("span.mobname").html() == "giant mosquito" || $("span.mobname").html() && $("span.mobname").html() == "ENRAGED giant mosquito" || $("span.mobname2").html() && $("span.mobname2").html() == "giant mosquito" || $("span.mobname3").html() && $("span.mobname3").html() == "giant mosquito")
		{
                location.href = "javascript:(" + encodeURI( function() {
                    $("div.btn100").each(function(indice) {
                        if ($(this).html() == "Attack")
		...
		if ($("span.mobname").html() && $("span.mobname").html() == "large worm" || $("span.mobname").html() && $("span.mobname").html() == "ENRAGED large worm" || $("span.mobname2").html() && $("span.mobname2").html() == "large worm" || $("span.mobname3").html() && $("span.mobname3").html() == "large worm")
		{
                location.href = "javascript:(" + encodeURI( function() {
                    $("div.btn100").each(function(indice) {
                        if ($(this).html() == "Attack")
		...
		if ($("span.mobname").html() && $("span.mobname").html() == "flesh lotus" || $("span.mobname").html() && $("span.mobname").html() == "ENRAGED flesh lotus" || $("span.mobname2").html() && $("span.mobname2").html() == "flesh lotus" || $("span.mobname3").html() && $("span.mobname3").html() == "flesh lotus")
		{
                location.href = "javascript:(" + encodeURI( function() {
                    $("div.btn100").each(function(indice) {
                        if ($(this).html() == "Attack")
...
if ($("span.mobname").html() && $("span.mobname").html() == "wild duck" || $("span.mobname").html() && $("span.mobname").html() == "ENRAGED wild duck" || $("span.mobname2").html() && $("span.mobname2").html() == "wild duck" || $("span.mobname3").html() && $("span.mobname3").html() == "wild duck")
		{
                location.href = "javascript:(" + encodeURI( function() {
                    $("div.btn100").each(function(indice) {
                        if ($(this).html() == "Attack")
...
if ($("span.mobname").html() && $("span.mobname").html() == "giant leech" || $("span.mobname").html() && $("span.mobname").html() == "ENRAGED giant leech" || $("span.mobname2").html() && $("span.mobname2").html() == "giant leech" || $("span.mobname3").html() && $("span.mobname3").html() == "giant leech")
		{
                location.href = "javascript:(" + encodeURI( function() {
                    $("div.btn100").each(function(indice) {
                        if ($(this).html() == "Attack")
...
if ($("span.mobname").html() && $("span.mobname").html() == "swan" || $("span.mobname").html() && $("span.mobname").html() == "ENRAGED swan" || $("span.mobname2").html() && $("span.mobname2").html() == "swan" || $("span.mobname3").html() && $("span.mobname3").html() == "swan")
		{
                location.href = "javascript:(" + encodeURI( function() {
                    $("div.btn100").each(function(indice) {
                        if ($(this).html() == "Attack")
...
if ($("span.mobname").html() && $("span.mobname").html() == "pelican" || $("span.mobname").html() && $("span.mobname").html() == "ENRAGED pelican" || $("span.mobname2").html() && $("span.mobname2").html() == "pelican" || $("span.mobname3").html() && $("span.mobname3").html() == "pelican")
		{
                location.href = "javascript:(" + encodeURI( function() {
                    $("div.btn100").each(function(indice) {
                        if ($(this).html() == "Attack")
...
if ($("span.mobname").html() && $("span.mobname").html() == "small snake" || $("span.mobname").html() && $("span.mobname").html() == "ENRAGED small snake" || $("span.mobname2").html() && $("span.mobname2").html() == "small snake" || $("span.mobname3").html() && $("span.mobname3").html() == "small snake")
		{
                location.href = "javascript:(" + encodeURI( function() {
                    $("div.btn100").each(function(indice) {
                        if ($(this).html() == "Attack")
...
if ($("span.mobname").html() && $("span.mobname").html() == "water snake" || $("span.mobname").html() && $("span.mobname").html() == "ENRAGED water snake" || $("span.mobname2").html() && $("span.mobname2").html() == "wat" || $("span.mobname3").html() && $("span.mobname3").html() == "water snake")
		{
                location.href = "javascript:(" + encodeURI( function() {
                    $("div.btn100").each(function(indice) {
                        if ($(this).html() == "Attack")
...
if ($("span.mobname").html() && $("span.mobname").html() == "scavenger" || $("span.mobname").html() && $("span.mobname").html() == "ENRAGED scavenger" || $("span.mobname2").html() && $("span.mobname2").html() == "scavenger" || $("span.mobname3").html() && $("span.mobname3").html() == "scavenger")
		{
                location.href = "javascript:(" + encodeURI( function() {
                    $("div.btn100").each(function(indice) {
                        if ($(this).html() == "Attack")
...
if ($("span.mobname").html() && $("span.mobname").html() == "small crab" || $("span.mobname").html() && $("span.mobname").html() == "ENRAGED small crab" || $("span.mobname2").html() && $("span.mobname2").html() == "small crab" || $("span.mobname3").html() && $("span.mobname3").html() == "small crab")
		{
                location.href = "javascript:(" + encodeURI( function() {
                    $("div.btn100").each(function(indice) {
                        if ($(this).html() == "Attack")
...
if ($("span.mobname").html() && $("span.mobname").html() == "large frog" || $("span.mobname").html() && $("span.mobname").html() == "ENRAGED large frog" || $("span.mobname2").html() && $("span.mobname2").html() == "large frog" || $("span.mobname3").html() && $("span.mobname3").html() == "large frog")
		{
                location.href = "javascript:(" + encodeURI( function() {
                    $("div.btn100").each(function(indice) {
                        if ($(this).html() == "Attack")
...
if ($("span.mobname").html() && $("span.mobname").html() == "giant beetle" || $("span.mobname").html() && $("span.mobname").html() == "ENRAGED giant beetle" || $("span.mobname2").html() && $("span.mobname2").html() == "giant beetle" || $("span.mobname3").html() && $("span.mobname3").html() == "giant beetle")
		{
                location.href = "javascript:(" + encodeURI( function() {
                    $("div.btn100").each(function(indice) {
                        if ($(this).html() == "Attack")
...
if ($("span.mobname").html() && $("span.mobname").html() == "leech" || $("span.mobname").html() && $("span.mobname").html() == "ENRAGED leech" || $("span.mobname2").html() && $("span.mobname2").html() == "leech" || $("span.mobname3").html() && $("span.mobname3").html() == "leech")
		{
                location.href = "javascript:(" + encodeURI( function() {
                    $("div.btn100").each(function(indice) {
                        if ($(this).html() == "Attack")
...
if ($("span.mobname").html() && $("span.mobname").html() == "large toad" || $("span.mobname").html() && $("span.mobname").html() == "ENRAGED large toad" || $("span.mobname2").html() && $("span.mobname2").html() == "large toad" || $("span.mobname3").html() && $("span.mobname3").html() == "large toad")
		{
                location.href = "javascript:(" + encodeURI( function() {
                    $("div.btn100").each(function(indice) {
                        if ($(this).html() == "Attack")
					...
					else if ($(this).html() == "Explore")
                        {
                            ...
                            return false;
								...
								// JUNK TOWN
		  if ($("span.mobname").html() && $("span.mobname").html() == "giant bat" || $("span.mobname").html() && $("span.mobname").html() == "ENRAGED giant bat" || $("span.mobname2").html() && $("span.mobname2").html() == "giant bat" || $("span.mobname3").html() && $("span.mobname3").html() == "giant bat")
		{
                location.href = "javascript:(" + encodeURI( function() {
                    $("div.btn100").each(function(indice) {
                        if ($(this).html() == "Attack")
		...
		if ($("span.mobname").html() && $("span.mobname").html() == "large sewer rat"|| $("span.mobname").html() && $("span.mobname").html() == "ENRAGED large sewer rat"|| $("span.mobname2").html() && $("span.mobname2").html() == "large sewer rat" || $("span.mobname3").html() && $("span.mobname3").html() == "large sewer rat")
		{
                location.href = "javascript:(" + encodeURI( function() {
                    $("div.btn100").each(function(indice) {
                        if ($(this).html() == "Attack")
		...
		if ($("span.mobname").html() && $("span.mobname").html() == "life moss"|| $("span.mobname").html() && $("span.mobname").html() == "ENRAGED life moss"|| $("span.mobname2").html() && $("span.mobname2").html() == "life moss" || $("span.mobname3").html() && $("span.mobname3").html() == "life moss")
		{
                location.href = "javascript:(" + encodeURI( function() {
                    $("div.btn100").each(function(indice) {
                        if ($(this).html() == "Attack")
		...
		if ($("span.mobname").html() && $("span.mobname").html() == "huge cockroach"|| $("span.mobname").html() && $("span.mobname").html() == "ENRAGED huge cockroach"|| $("span.mobname2").html() && $("span.mobname2").html() == "huge cockroach" || $("span.mobname3").html() && $("span.mobname3").html() == "huge cockroach")
		{
                location.href = "javascript:(" + encodeURI( function() {
                    $("div.btn100").each(function(indice) {
                        if ($(this).html() == "Attack")
		...
		if ($("span.mobname").html() && $("span.mobname").html() == "sewer crawler" || $("span.mobname").html() && $("span.mobname").html() == "ENRAGED sewer crawler" || $("span.mobname2").html() && $("span.mobname2").html() == "sewer crawler" || $("span.mobname3").html() && $("span.mobname3").html() == "sewer crawler")
		{
                location.href = "javascript:(" + encodeURI( function() {
                    $("div.btn100").each(function(indice) {
                        if ($(this).html() == "Attack")
		...
		if ($("span.mobname").html() && $("span.mobname").html() == "giant crawler" || $("span.mobname").html() && $("span.mobname").html() == "ENRAGED giant crawler" || $("span.mobname2").html() && $("span.mobname2").html() == "giant crawler" || $("span.mobname3").html() && $("span.mobname3").html() == "giant cawler")
		{
                location.href = "javascript:(" + encodeURI( function() {
                    $("div.btn100").each(function(indice) {
                        if ($(this).html() == "Attack")
		...
		if ($("span.mobname").html() && $("span.mobname").html() == "giant sewer rat" || $("span.mobname").html() && $("span.mobname").html() == "ENRAGED giant sewer rat" || $("span.mobname2").html() && $("span.mobname2").html() == "giant sewer rat" || $("span.mobname3").html() && $("span.mobname3").html() == "giant sewer rat")
		{
                location.href = "javascript:(" + encodeURI( function() {
                    $("div.btn100").each(function(indice) {
                        if ($(this).html() == "Attack")
		...
		if ($("span.mobname").html() && $("span.mobname").html() == "large red bat" || $("span.mobname").html() && $("span.mobname").html() == "ENRAGED large red bat" || $("span.mobname2").html() && $("span.mobname2").html() == "large red bat" || $("span.mobname3").html() && $("span.mobname3").html() == "large red bat")
		{
                location.href = "javascript:(" + encodeURI( function() {
                    $("div.btn100").each(function(indice) {
                        if ($(this).html() == "Attack")
		...
		if ($("span.mobname").html() && $("span.mobname").html() == "huge sewer rat" || $("span.mobname").html() && $("span.mobname").html() == "ENRAGED huge sewer rat" || $("span.mobname2").html() && $("span.mobname2").html() == "huge sewer rat" || $("span.mobname3").html() && $("span.mobname3").html() == "huge sewer rat")
		{
                location.href = "javascript:(" + encodeURI( function() {
                    $("div.btn100").each(function(indice) {
                        if ($(this).html() == "Attack")
		...
		if ($("span.mobname").html() && $("span.mobname").html() == "huge spider" || $("span.mobname").html() && $("span.mobname").html() == "ENRAGED huge spider" || $("span.mobname2").html() && $("span.mobname2").html() == "huge spider" || $("span.mobname3").html() && $("span.mobname3").html() == "huge spider")
		{
                location.href = "javascript:(" + encodeURI( function() {
                    $("div.btn100").each(function(indice) {
                        if ($(this).html() == "Attack")
		...
		if ($("span.mobname").html() && $("span.mobname").html() == "zombie rat" || $("span.mobname").html() && $("span.mobname").html() == "ENRAGED zombie rat" || $("span.mobname2").html() && $("span.mobname2").html() == "zombie rat" || $("span.mobname3").html() && $("span.mobname3").html() == "zombie rat")
		{
                location.href = "javascript:(" + encodeURI( function() {
                    $("div.btn100").each(function(indice) {
                        if ($(this).html() == "Attack")
		...
		if ($("span.mobname").html() && $("span.mobname").html() == "sewage dweller" || $("span.mobname").html() && $("span.mobname").html() == "ENRAGED sewage dweller" || $("span.mobname2").html() && $("span.mobname2").html() == "sewage dweller" || $("span.mobname3").html() && $("span.mobname3").html() == "sewage dweller")
		{
                location.href = "javascript:(" + encodeURI( function() {
                    $("div.btn100").each(function(indice) {
                        if ($(this).html() == "Attack")
		...
		if ($("span.mobname").html() && $("span.mobname").html() == "vampire bat" || $("span.mobname").html() && $("span.mobname").html() == "ENRAGED vampire bat" || $("span.mobname2").html() && $("span.mobname2").html() == "vampire bat" || $("span.mobname3").html() && $("span.mobname3").html() == "vampire bat")
		{
                location.href = "javascript:(" + encodeURI( function() {
                    $("div.btn100").each(function(indice) {
                        if ($(this).html() == "Attack")
		...
		if ($("span.mobname").html() && $("span.mobname").html() == "rotten corpse" || $("span.mobname").html() && $("span.mobname").html() == "ENRAGED rotten corpse" || $("span.mobname2").html() && $("span.mobname2").html() == "rotten corpse" || $("span.mobname3").html() && $("span.mobname3").html() == "rotten corpse")
		{
                location.href = "javascript:(" + encodeURI( function() {
                    $("div.btn100").each(function(indice) {
                        if ($(this).html() == "Attack")
		...
		if ($("span.mobname").html() && $("span.mobname").html() == "sewer rat" || $("span.mobname").html() && $("span.mobname").html() == "ENRAGED sewer rat" || $("span.mobname2").html() && $("span.mobname2").html() == "sewer rat" || $("span.mobname3").html() && $("span.mobname3").html() == "sewer rat")
		{
                location.href = "javascript:(" + encodeURI( function() {
                    $("div.btn100").each(function(indice) {
                        if ($(this).html() == "Attack")
...
if ($("span.mobname").html() && $("span.mobname").html() == "giant spider" || $("span.mobname").html() && $("span.mobname").html() == "ENRAGED giant spider" || $("span.mobname2").html() && $("span.mobname2").html() == "giant spider" || $("span.mobname3").html() && $("span.mobname3").html() == "giant spider")
		{
                location.href = "javascript:(" + encodeURI( function() {
                    $("div.btn100").each(function(indice) {
                        if ($(this).html() == "Attack")
...
if ($("span.mobname").html() && $("span.mobname").html() == "moving ooze" || $("span.mobname").html() && $("span.mobname").html() == "ENRAGED moving ooze" || $("span.mobname2").html() && $("span.mobname2").html() == "moving ooze" || $("span.mobname3").html() && $("span.mobname3").html() == "moving ooze")
		{
                location.href = "javascript:(" + encodeURI( function() {
                    $("div.btn100").each(function(indice) {
                        if ($(this).html() == "Attack")
...
if ($("span.mobname").html() && $("span.mobname").html() == "sand giant"|| $("span.mobname").html() && $("span.mobname").html() == "ENRAGED sand giant"|| $("span.mobname2").html() && $("span.mobname2").html() == "sand giant" || $("span.mobname3").html() && $("span.mobname3").html() == "sand giant")
		{
                location.href = "javascript:(" + encodeURI( function() {
                    $("div.btn100").each(function(indice) {
                        if ($(this).html() == "Attack")
...
if ($("span.mobname").html() && $("span.mobname").html() == "giant sandworm"|| $("span.mobname").html() && $("span.mobname").html() == "ENRAGED giant sandworm"|| $("span.mobname2").html() && $("span.mobname2").html() == "giant sandworm" || $("span.mobname3").html() && $("span.mobname3").html() == "giant sandworm")
		{
                location.href = "javascript:(" + encodeURI( function() {
                    $("div.btn100").each(function(indice) {
                        if ($(this).html() == "Attack")
...
if ($("span.mobname").html() && $("span.mobname").html() == "giant cactus"|| $("span.mobname").html() && $("span.mobname").html() == "ENRAGED giant cactus"|| $("span.mobname2").html() && $("span.mobname2").html() == "giant cactus" || $("span.mobname3").html() && $("span.mobname3").html() == "giant cactus")
		{
                location.href = "javascript:(" + encodeURI( function() {
                    $("div.btn100").each(function(indice) {
                        if ($(this).html() == "Attack")
...
if ($("span.mobname").html() && $("span.mobname").html() == "large rattlesnake"|| $("span.mobname").html() && $("span.mobname").html() == "ENRAGED large rattlesnake"|| $("span.mobname2").html() && $("span.mobname2").html() == "large rattlesnake" || $("span.mobname3").html() && $("span.mobname3").html() == "large rattlesnake")
		{
                location.href = "javascript:(" + encodeURI( function() {
                    $("div.btn100").each(function(indice) {
                        if ($(this).html() == "Attack")
...
if ($("span.mobname").html() && $("span.mobname").html() == "sand ghoul"|| $("span.mobname").html() && $("span.mobname").html() == "ENRAGED sand ghoul"|| $("span.mobname2").html() && $("span.mobname2").html() == "sand ghoul" || $("span.mobname3").html() && $("span.mobname3").html() == "sand ghoul")
		{
                location.href = "javascript:(" + encodeURI( function() {
                    $("div.btn100").each(function(indice) {
                        if ($(this).html() == "Attack")
		...
		if ($("span.mobname").html() && $("span.mobname").html() == "cave troll" || $("span.mobname").html() && $("span.mobname").html() == "ENRAGED cave troll" || $("span.mobname2").html() && $("span.mobname2").html() == "cave troll" || $("span.mobname3").html() && $("span.mobname3").html() == "cave troll")
		{
                location.href = "javascript:(" + encodeURI( function() {
                    $("div.btn100").each(function(indice) {
                        if ($(this).html() == "Attack")
	...
	if ($("span.mobname").html() && $("span.mobname").html() == "small wyrm" || $("span.mobname").html() && $("span.mobname").html() == "ENRAGED small wyrm" || $("span.mobname2").html() && $("span.mobname2").html() == "small wyrm" || $("span.mobname3").html() && $("span.mobname3").html() == "small wyrm")
		{
                location.href = "javascript:(" + encodeURI( function() {
                    $("div.btn100").each(function(indice) {
                        if ($(this).html() == "Attack")
	...
	if ($("span.mobname").html() && $("span.mobname").html() == "fire giant" || $("span.mobname").html() && $("span.mobname").html() == "ENRAGED fire giant" || $("span.mobname2").html() && $("span.mobname2").html() == "fire giant" || $("span.mobname3").html() && $("span.mobname3").html() == "fire giant")
		{
                location.href = "javascript:(" + encodeURI( function() {
                    $("div.btn100").each(function(indice) {
                        if ($(this).html() == "Attack")
...
if ($("span.mobname").html() && $("span.mobname").html() == "blue dragon" || $("span.mobname").html() && $("span.mobname").html() == "ENRAGED blue dragon" || $("span.mobname2").html() && $("span.mobname2").html() == "blue dragon" || $("span.mobname3").html() && $("span.mobname3").html() == "blue dragon")
		{
                location.href = "javascript:(" + encodeURI( function() {
                    $("div.btn100").each(function(indice) {
                        if ($(this).html() == "Attack")
...
if ($("span.mobname").html() && $("span.mobname").html() == "fire elemental" || $("span.mobname").html() && $("span.mobname").html() == "ENRAGED fire elemental" || $("span.mobname2").html() && $("span.mobname2").html() == "fire elemental" || $("span.mobname3").html() && $("span.mobname3").html() == "fire elemental")
		{
                location.href = "javascript:(" + encodeURI( function() {
                    $("div.btn100").each(function(indice) {
                        if ($(this).html() == "Attack")
...
if ($("span.mobname").html() && $("span.mobname").html() == "green dragon" || $("span.mobname").html() && $("span.mobname").html() == "ENRAGED green dragon" || $("span.mobname2").html() && $("span.mobname2").html() == "green dragon" || $("span.mobname3").html() && $("span.mobname3").html() == "green dragon")
		{
                location.href = "javascript:(" + encodeURI( function() {
                    $("div.btn100").each(function(indice) {
                        if ($(this).html() == "Attack")
...
if ($("span.mobname").html() && $("span.mobname").html() == "greater fire golem" || $("span.mobname").html() && $("span.mobname").html() == "ENRAGED greater fire golem" || $("span.mobname2").html() && $("span.mobname2").html() == "greater fire golem" || $("span.mobname3").html() && $("span.mobname3").html() == "greater fire golem")
		{
                location.href = "javascript:(" + encodeURI( function() {
                    $("div.btn100").each(function(indice) {
                        if ($(this).html() == "Attack")
...
if ($("span.mobname").html() && $("span.mobname").html() == "succubus" || $("span.mobname").html() && $("span.mobname").html() == "ENRAGED succubus" || $("span.mobname2").html() && $("span.mobname2").html() == "succubus" || $("span.mobname3").html() && $("span.mobname3").html() == "succubus")
		{
                location.href = "javascript:(" + encodeURI( function() {
                    $("div.btn100").each(function(indice) {
                        if ($(this).html() == "Attack")
...
if ($("span.mobname").html() && $("span.mobname").html() == "great wrym" || $("span.mobname").html() && $("span.mobname").html() == "ENRAGED great wrym" || $("span.mobname2").html() && $("span.mobname2").html() == "great wrym" || $("span.mobname3").html() && $("span.mobname3").html() == "great wrym")
		{
                location.href = "javascript:(" + encodeURI( function() {
                    $("div.btn100").each(function(indice) {
                        if ($(this).html() == "Attack")
...
if ($("span.mobname").html() && $("span.mobname").html() == "golden dragon" || $("span.mobname").html() && $("span.mobname").html() == "ENRAGED golden dragon" || $("span.mobname2").html() && $("span.mobname2").html() == "golden dragon" || $("span.mobname3").html() && $("span.mobname3").html() == "golden dragon")
		{
                location.href = "javascript:(" + encodeURI( function() {
                    $("div.btn100").each(function(indice) {
                        if ($(this).html() == "Attack")
...
if ($("span.mobname").html() && $("span.mobname").html() == "lava serpent" || $("span.mobname").html() && $("span.mobname").html() == "ENRAGED lava serpent" || $("span.mobname2").html() && $("span.mobname2").html() == "lava serpent" || $("span.mobname3").html() && $("span.mobname3").html() == "lava serpent")
		{
                location.href = "javascript:(" + encodeURI( function() {
                    $("div.btn100").each(function(indice) {
                        if ($(this).html() == "Attack")
...
if ($("span.mobname").html() && $("span.mobname").html() == "red dragon" || $("span.mobname").html() && $("span.mobname").html() == "ENRAGED red dragon" || $("span.mobname2").html() && $("span.mobname2").html() == "red dragon" || $("span.mobname3").html() && $("span.mobname3").html() == "red dragon")
		{
                location.href = "javascript:(" + encodeURI( function() {
                    $("div.btn100").each(function(indice) {
                        if ($(this).html() == "Attack")
 ...
 // Invasion
			if ($("span.mobname").html() && $("span.mobname").html() == "Elite Alien Fighter" || $("span.mobname").html() && $("span.mobname").html() == "ENRAGED Elite Alien Fighter" || $("span.mobname2").html() && $("span.mobname2").html() == "Elite Alien Fighter" || $("span.mobname3").html() && $("span.mobname3").html() == "Elite Alien Fighter")
		{
                location.href = "javascript:(" + encodeURI( function() {
                    $("div.btn100").each(function(indice) {
                        if ($(this).html() == "Attack")
		...
		if ($("span.mobname").html() && $("span.mobname").html() == "Elite Alien Scientist" || $("span.mobname").html() && $("span.mobname").html() == "ENRAGED Elite Alien Scientist" || $("span.mobname2").html() && $("span.mobname2").html() == "Elite Alien Scientist" || $("span.mobname3").html() && $("span.mobname3").html() == "Elite Alien Scientist")
		{
                location.href = "javascript:(" + encodeURI( function() {
                    $("div.btn100").each(function(indice) {
                        if ($(this).html() == "Attack")
		...
		if ($("span.mobname").html() && $("span.mobname").html() == "Elite Alien Assassin" || $("span.mobname").html() && $("span.mobname").html() == "ENRAGED Elite Alien Assassin" || $("span.mobname2").html() && $("span.mobname2").html() == "Elite Alien Assassin" || $("span.mobname3").html() && $("span.mobname3").html() == "Elite Alien Assassin")
		{
                location.href = "javascript:(" + encodeURI( function() {
                    $("div.btn100").each(function(indice) {
                        if ($(this).html() == "Attack")
		...
		if ($("span.mobname").html() && $("span.mobname").html() == "Elite Alien Witch" || $("span.mobname").html() && $("span.mobname").html() == "ENRAGED Elite Alien Witch" || $("span.mobname2").html() && $("span.mobname2").html() == "Elite Alien Witch" || $("span.mobname3").html() && $("span.mobname3").html() == "Elite Alien Witch")
		{
                location.href = "javascript:(" + encodeURI( function() {
                    $("div.btn100").each(function(indice) {
                        if ($(this).html() == "Attack")
...
if ($("span.mobname").html() && $("span.mobname").html() == "Elite Alien Timelord" || $("span.mobname").html() && $("span.mobname").html() == "ENRAGED Elite Alien Timelord" || $("span.mobname2").html() && $("span.mobname2").html() == "Elite Alien Timelord" || $("span.mobname3").html() && $("span.mobname3").html() == "Elite Alien Timelord")
		{
                location.href = "javascript:(" + encodeURI( function() {
                    $("div.btn100").each(function(indice) {
                        if ($(this).html() == "Attack")
...
if ($("span.mobname").html() && $("span.mobname").html() == "giant crab" || $("span.mobname").html() && $("span.mobname").html() == "ENRAGED giant crab" || $("span.mobname2").html() && $("span.mobname2").html() == "giant crab" || $("span.mobname3").html() && $("span.mobname3").html() == "giant crab")
{
location.href = "javascript:(" + encodeURI( function() {
$("div.btn100").each(function(indice) {
if ($(this).html() == "Attack")
...
if ($("span.mobname").html() && $("span.mobname").html() == "sand man" || $("span.mobname").html() && $("span.mobname").html() == "ENRAGED sand man" || $("span.mobname2").html() && $("span.mobname2").html() == "sand man" || $("span.mobname3").html() && $("span.mobname3").html() == "sand man")
{
location.href = "javascript:(" + encodeURI( function() {
$("div.btn100").each(function(indice) {
if ($(this).html() == "Attack")
...
if ($("span.mobname").html() && $("span.mobname").html() == "killer whale" || $("span.mobname").html() && $("span.mobname").html() == "ENRAGED killer whale" || $("span.mobname2").html() && $("span.mobname2").html() == "killer whale" || $("span.mobname3").html() && $("span.mobname3").html() == "killer whale")
{
location.href = "javascript:(" + encodeURI( function() {
$("div.btn100").each(function(indice) {
if ($(this).html() == "Attack")
...
if ($("span.mobname").html() && $("span.mobname").html() == "jellyfish" || $("span.mobname").html() && $("span.mobname").html() == "ENRAGED jellyfish" || $("span.mobname2").html() && $("span.mobname2").html() == "jellyfish" || $("span.mobname3").html() && $("span.mobname3").html() == "jellyfish")
{
location.href = "javascript:(" + encodeURI( function() {
$("div.btn100").each(function(indice) {
if ($(this).html() == "Attack")
...
if ($("span.mobname").html() && $("span.mobname").html() == "minor water golem" || $("span.mobname").html() && $("span.mobname").html() == "ENRAGED minor water golem" || $("span.mobname2").html() && $("span.mobname2").html() == "minor water golem" || $("span.mobname3").html() && $("span.mobname3").html() == "minor water golem")
{
location.href = "javascript:(" + encodeURI( function() {
$("div.btn100").each(function(indice) {
if ($(this).html() == "Attack")
...
if ($("span.mobname").html() && $("span.mobname").html() == "young orca" || $("span.mobname").html() && $("span.mobname").html() == "ENRAGED young orca" || $("span.mobname2").html() && $("span.mobname2").html() == "young orca" || $("span.mobname3").html() && $("span.mobname3").html() == "young orca")
{
location.href = "javascript:(" + encodeURI( function() {
$("div.btn100").each(function(indice) {
if ($(this).html() == "Attack")
...
if ($("span.mobname").html() && $("span.mobname").html() == "tiger shark" || $("span.mobname").html() && $("span.mobname").html() == "ENRAGED tiger shark" || $("span.mobname2").html() && $("span.mobname2").html() == "tiger shark" || $("span.mobname3").html() && $("span.mobname3").html() == "tiger shark")
{
location.href = "javascript:(" + encodeURI( function() {
$("div.btn100").each(function(indice) {
if ($(this).html() == "Attack")
...
return false;
		...
		if ($("span.mobname").html() && $("span.mobname").html() == "water spirit" || $("span.mobname").html() && $("span.mobname").html() == "ENRAGED water spirit" || $("span.mobname2").html() && $("span.mobname2").html() == "water spirit" || $("span.mobname3").html() && $("span.mobname3").html() == "water spirit")
		{
				location.href = "javascript:(" + encodeURI( function() {
				$("div.btn100").each(function(indice) {
if ($(this).html() == "Attack")
...
if ($("span.mobname").html() && $("span.mobname").html() == "sword fish" || $("span.mobname").html() && $("span.mobname").html() == "ENRAGED sword fish" || $("span.mobname2").html() && $("span.mobname2").html() == "sword fish" || $("span.mobname3").html() && $("span.mobname3").html() == "sword fish")
		{
                location.href = "javascript:(" + encodeURI( function() {
                    $("div.btn100").each(function(indice) {
                        if ($(this).html() == "Attack")
...
if ($("span.mobname").html() && $("span.mobname").html() == "undead sailer" || $("span.mobname").html() && $("span.mobname").html() == "ENRAGED undead sailor" || $("span.mobname2").html() && $("span.mobname2").html() == "undead sailor" || $("span.mobname3").html() && $("span.mobname3").html() == "undead sailor")
		{
                location.href = "javascript:(" + encodeURI( function() {
                    $("div.btn100").each(function(indice) {
                        if ($(this).html() == "Attack")
...
if ($("span.mobname").html() && $("span.mobname").html() == "sand spirit" ||
...
if ($("span.mobname").html() && $("span.mobname").html() == "minor sand golem" ||
...
if ($("span.mobname").html() && $("span.mobname").html() == "electrofish" ||
...
if ($("span.mobname").html() && $("span.mobname").html() == "undead captain" ||
				...
				$("span.mobname3").html() && $("span.mobname3").html() == "undead captain")
		{
			...
			if ($("span.mobname").html() && $("span.mobname").html() == "hammerhead" ||
				...
				$("span.mobname3").html() && $("span.mobname3").html() == "hammerhead")
		{
				...
				if ($("span.mobname").html() && $("span.mobname").html() == "thief initiate" ||
				...
				$("span.mobname3").html() && $("span.mobname3").html() == "thief initaite")
		{
                location.href = "javascript:(" + encodeURI( function() {
					...
					if ($("span.mobname").html() && $("span.mobname").html() == "trained wolf" ||
				...
				$("span.mobname3").html() && $("span.mobname3").html() == "trained wolf")
		{
                location.href = "javascript:(" + encodeURI( function() {
					...
					if ($("span.mobname").html() && $("span.mobname").html() == "thief knifer" ||
				...
				$("span.mobname3").html() && $("span.mobname3").html() == "thief knifer")
		{
                location.href = "javascript:(" + encodeURI( function() {
					...
					if ($("span.mobname").html() && $("span.mobname").html() == "zombie dog" ||
				...
				$("span.mobname3").html() && $("span.mobname3").html() == "zombie dog")
		{
                location.href = "javascript:(" + encodeURI( function() {
					...
					if ($("span.mobname").html() && $("span.mobname").html() == "large viper" ||
				...
				$("span.mobname3").html() && $("span.mobname3").html() == "large viper")
		{
			...
			if ($("span.mobname").html() && $("span.mobname").html() == "guard dog" ||
				...
				$("span.mobname3").html() && $("span.mobname3").html() == "guard dog")
		{
			...
			if ($("span.mobname").html() && $("span.mobname").html() == "thief fighter" ||
				...
				$("span.mobname3").html() && $("span.mobname3").html() == "thief fighter")
		{
			...
			if ($("span.mobname").html() && $("span.mobname").html() == "thief guard" ||
				...
				$("span.mobname3").html() && $("span.mobname3").html() == "thief guard")
		{
			...
			if ($("span.mobname").html() && $("span.mobname").html() == "thief shaman" ||
				...
				$("span.mobname3").html() && $("span.mobname3").html() == "thief shaman")
		{
			...
			if ($("span.mobname").html() && $("span.mobname").html() == "thief warrior" ||
				...
				$("span.mobname3").html() && $("span.mobname3").html() == "thief warrior")
		{
			...
			if ($("span.mobname").html() && $("span.mobname").html() == "thief mage" ||
				...
				$("span.mobname3").html() && $("span.mobname3").html() == "thief mage")
		{
			...
			if ($("span.mobname").html() && $("span.mobname").html() == "glowing ghoul" ||
				...
				$("span.mobname3").html() && $("span.mobname3").html() == "glowing ghoul")
		{
			...
			if ($("span.mobname").html() && $("span.mobname").html() == "thief specialist" ||
				...
				$("span.mobname3").html() && $("span.mobname3").html() == "thief specialist")
		{
			...
			if ($("span.mobname").html() && $("span.mobname").html() == "trained python" ||
				...
				$("span.mobname3").html() && $("span.mobname3").html() == "trained python")
		{
			...
			if ($("span.mobname").html() && $("span.mobname").html() == "thief lieutenant" ||
...
/*			if ($("span.mobname").html() && $("span.mobname").html() == "" ||
...
*/
									...
									// Special Encounter Fights
		if ($("span.mobname2").html() && $("span.mobname2").html() == "The Gambler" ||  $("span.mobname2").html() && $("span.mobname2").html() == "Dust Merchant" || $("span.mobname2").html() && $("span.mobname2").html() == "Girl in Red" || $("span.mobname2").html() && $("span.mobname2").html() == "Dust Merchant" || $("span.mobname2").html() && $("span.mobname2").html() == "The Wiseman" || $("span.mobname3").html() && $("span.mobname3").html() == "Magic Elf" || $("span.mobname3").html() && $("span.mobname3").html() == "Guardian of Dreams")
		{
                location.href = "javascript:(" + encodeURI( function() {
                    $("div.btn100").each(function(indice) {
                        if ($(this).html() == "Attack")
				...
				idIntervals = setInterval(function() {
					if ($("#mobbox > div > table > tbody > tr:first > td").html() && $("#mobbox > div > table > tbody > tr:first > td").html().indexOf("Number indicators for each button indicate how many of button's adjacent buttons") >= 0)
					{
						...
						idIntervals = setInterval(function() {
                            ...
                            {
                                clearInterval(idIntervals);
                                idIntervals = setInterval(verificaExploracao, 25);
                            }
			...
			}
{
	...
	ativo = true;
	idIntervals = setInterval(verificaExploracao, 15);