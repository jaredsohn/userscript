// ==UserScript==
// @name           Plurk emoticons by @danychasez
// @namespace      Dany Chasez - http://www.kittynpink.com
// @description    Emoticons adicionais para Plurk.com
...
function initCSS()
{
	...
	.children('li').css(
	{
		...
		marginLeft: '0',
		marginRight: '3px',
                        border:'1px solid #FEB6DB',
		padding: '0 3px',
		cursor: 'pointer',
                        fontSize:'6.5pt',
                        fontWeight:'normal',
		backgroundColor: '#FEB6DB',
	});
