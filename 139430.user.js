// ==UserScript==
// @name			Facebook Auto Like All in One By Syabiz
// @namespace		http://userscripts.org/scripts/show/139430
// @version			01/01/2012
// @copyright		Syabiz
// @description		You can mass like or mass confirm friend request
// @author			Syabiz (http://www.syabiz.net)
...
/* START: This part of the code was written (partialy) by Vaughan Chandler for FFixer, special thanks to him :) */
	...
	function handleUpdateResponse(r) {
		...
		if (r.responseText.match(/@versionnumber\s+(\d+\.\d+)/)[1] > version) {
			if(confirm("There's an update available for 'Facebook Auto (One-Click) Mass Like All in One By Syabiz'.\nDo you wish to install it?")) openInTab('http://userscripts.org/scripts/source/120770.user.js');
		}
	}
...
if(body != null) {
	...
	div.innerHTML = "<center><a href='http://www.syabiz.net'><img src='http://fbcdn-profile-a.akamaihd.net/hprofile-ak-snc4/573199_100000111040226_877578123_n.jpg' alt='Syabiz' width='125' height='125' </a></center>"
	...
	div.style.width = "125px";
	div2.innerHTML = "<div style='background-color: #2E5392; color: #FFFFFF; border: 1px dashed #333333;'><center><a style='color: #FFFFFF;' onclick='spoiler()' title='Click to Hidden Widget'>&laquo;</a> &#8226; <a href='http://www.syabiz.net/' style='color: #FFFFFF;' onclick='alert(\'Thanks for instal this script\');'>Auto Like By Syabiz</a></center></div> "
	...
	for(i=1;i<=20;i++) {
		...
		div2.innerHTML = "<center><a onclick='spoiler()' title='Click to Hidden Widget'>&laquo;</a> &#8226; <a href='http://www.syabiz.net' title='Thanks for instal this script'>Auto Like by Syabiz</a> &#8226; </center> "
		}
		else {
