...
function maine_functione()
{
	...
	var lewak = {
'Blaskun': true, 'ghostface': true, 'Ginden': true, 'Andr3v': true, 'Ryzowy_Potwor': true, 'wolfik92': true, 'fir3fly': true, 'Destr0': true, 'mq1': true, 'Aqwart': true, 'anonim1133': true, 'Farrahan': true, 'Ryu': true, 'DuPont': true, 'Farquart': true, 'FilipChG': true, 'histeryk_13': true, 'innuendoPL': true, 'John112': true, 'Johny_Locke': true, 'John_Finn': true, 'jrs2': true, 'Kamill': true, 'mq1': true, 'MQs': true, 'NapallnTheMorning': true, 'RageKage': true, 'Ragnarokk': true, 'relik39': true, 'Shaki': true, 'Smookie': true, 'sn4tch': true, 'stekelenburg2': true, 'Supercoolljuk2': true, 'szczepqs': true, 'tmb28': true, 'Tym': true, 'Unknown__user': true, 'wielooczek': true, 'WOiOwnik': true, 'Yahoo_': true, 'Dutch': true, 'FilipChG': true, 'oxygen88': true, 'Czajna_Seczen': true, 'Derp': true, 'The_Apostate': true
	...
	$('a[title^="profil"] img').each(function (i,el) {
		if (el.alt in  lewak)
		{
			...
			el.parentNode.style['background'] = 'none repeat scroll 0 0 ' + new_color;
                        ...
                        var obrazek = <img src="http://dl.dropbox.com/u/85736209/gwiazda2.png">;
                        czas.innerHTML = '(LEWAK) ' + 'obrazek' + czas.innerHTML;
