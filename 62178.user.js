// ==UserScript==
// @name           lostfilm
// @namespace      *lostfilm.tv*
// @include lostfilm.tv/*
// ==/UserScript==
GM_addStyle('body{margin-top: 0px !important;  background-repeat: repeat}');
GM_addStyle('body{background-image: url(data:image/gif;base64,)}');
GM_addStyle('.main_logo_link{background: url(http://www.lostfilm.tv/Tmpl/LostFilm/img/logo_black.gif) no-repeat left top; width:238px; height:56px; display:block;}');
GM_addStyle('.bb_nopadding{display:none} #ta_link{display:none;}');
