...
// @namespace T3
// @version 3.3.1
// @description  (v 3.3.1; Travian v3 addons originally by Victor Garcia (aka Croc); - updated by Szabka pl51-7.June 2008; - updated by ms99 & Nux & Lux-03.November.2008
...
* All rights to additional images embedded in this script belong to their respective creators or to ms99,Nux,Lux
*
...
* Thank you vampiricdust/fr3nchlover for fixing the villages2cp function  !
...
function functionMain(e) {
	...
	function switchLanguage(detectedLanguage) {
		switch (detectedLanguage) {
			...
			case "ro":
				...
				xLang['SHOWBOOKMARKS'] 			= 'Afişează bookmarks';
				xLang['RACE'] 					= 'Rasă';
				xLang['SERVERVERSION2'] 		= "Server Travian v2.x";
			...
			case "fr":
				// by fr3nchlover . We appreciate his work and are grateful ! THANK YOU !!!)
				  ...
				  xLang['SELECTALLTROOPS']    = "S&eacute;lectionnner toutes les troupes";
				  ...
				  xLang['SHOWORIGREPORT'] = "Rapport original (&Agrave; cocher obligatoirement avant diffusion du RC)";
				  ...
				  xLang['CHECKUPDATE']  = "Recherche de mise &agrave; jour du script. Veuillez patienter...";
				  xLang['CROPFINDER']  = "Recherche de 15C";
				  ...
				  xLang['CONSOLELOGLEVEL'] = "Console Log - RESERV&Eacute; aux DEVELOPPEURS et DEBUGGEURS<br>(Defaut = 0 ou laisser Vide)"
				  ...
				  xLang['MAX']  = 'Max';
				  xLang['TOTALTROOPSTRAINING'] = 'Total troupes en cours ';
			    ...
			    xLang['SHOWBIGICONMILITARY2']    = "Hotel de ville/Manoir h&eacute;ro/Armurerie/Usine";
			    xLang['HEROSMANSION']        = "Manoir H&eacute;ro";
			    xLang['BLACKSMITH']        = "Usine armure";
			    xLang['ARMOURY']        = "Armurerie";
			...
			case "cz":
				...
				xLang['SHOWMENUSECTION3']		= "Zobrazit odkazy v levém menu<br>(Traviantoolbox, World Analyser, Travilog, Mapa)";
		      	...
		      	xLang['CAPITALOPTIONS']			= 'Hlavní vesnice';
			...
			case "si":
            	...
            	xLang['CROPFINDER']	= "Iskalec Žitnih polj";
            	...
            	xLang['TOTALTROOPSTRAINING']	= 'Skupno število enot v postopku';
      			...
      			xLang['BOOKMARKOPTIONS']= 'Zaznamki';
			...
			case "hk":
				...
				xLang['TRAVIANBEYONDSETUPLINK'] = '按此進行TB設定';
            ...
            case "el":
                ...
                xLang['CNCOLORMAXLEVEL']        = 'Χρώμα όταν είναι στο μέγιστο επίπεδο<br>(Προεπιλογή = άδειο)';
                ...
                xLang['WARSIM']                = "Link για προσομοιωτή μάχης:<br>(menu left)";
                ...
                xLang['SHOWBUILDINGSUPGRADETABLE']    = "Δείξε τον πίνακα αναβαθμίσεων για τα κτήρια";
                xLang['CONSOLELOGLEVEL']        = "Console Log Level<br><b>ΜΟΝΟ ΓΙΑ ΠΡΟΓΡΑΜΜΑΤΑΤΙΣΤΕΣ Ή ΑΠΑΣΦΑΛΜΑΤΩΣΗ</b><br>(Προεπιλογή = 0 ή άδειο)";
                xLang['MARKETPRELOAD']            = "Αριθμός των σελίδων για φόρτωση<br>μέσα στην αγορά => στην σελίδα 'Αγοράστε'<br>(Προεπιλογή = 1 ή άδειο; Μέγιστο = 5)";
                ...
                //introduced in version 3.1.3
                xLang['TRAVIANBEYONDSETUPLINK']        = 'Travian Beyond Ρυθμίσεις';
                xLang['UPDATEALLVILLAGES']        = 'Ενημέρωσε όλα τα χωριά. ΧΡΗΣΙΜΟΠΟΙΗΣΕ ΤΟ ΜΕ ΜΕΓΑΛΗ ΠΡΟΣΟΧΗ ΚΑΘΩΣ ΜΠΟΡΕΙ ΝΑ ΑΠΟΒΛΗΘΕΙΣ !!!';
                //introduced in version 3.1.4
                xLang['SHOWMENUSECTION3']        = "Δείξε επιπλέον link στο αριστερό μενού<br>(Traviantoolbox, World Analyser, Travilog, Χάρτη, κτλ.)";
                //introduced in version 3.1.7
                ...
                xLang['CAPITALOPTIONS']            = 'Πρωτεύουσα';
                xLang['BOOKMARKOPTIONS']        = 'Σελιδοδείκτες';
                xLang['NOTEBLOCKOPTIONS']        = 'Σημειωματάριο';
                xLang['MENULEFT']            = 'Μενού στην αριστερή μεριά';
			...
			case "lv":
				...
				xLang['LARGEMAP'] = 'Palielinātā karte';
			...
			case "il":
				...
				xLang['CAPITALOPTIONS'] = 'עיר הבירה';
				...
				xLang['VILLAGECENTER'] = 'מרכז העיר';
				xLang['MAPOPTIONS'] = 'אפשרויות מפה';
				xLang['COLOROPTIONS'] = 'אפשרויות צבעים';
				xLang['DEBUGOPTIONS'] = 'אפשרויות מסוף השגיאות';
	...
	image["usethempr"] = imgPrefix + '';
	//Image for the market function "Use them" equal
	image["usethemeq"] = imgPrefix + '';
	//Image for the market function "Use them" 1 hour production
	image["usethem1h"] = imgPrefix + '';
	...
	//Image for the ally (thank you, Nux)
	...
	image["alliance"] = imgPrefix + '';
	//Image for the setup
	...
	*/
	...
	function getGMcookie(aName, addNewDid) {
		...
		//log(3, "valueToReturn (aName) = a(" + aName + ")" + valueToReturn);
	...
	*/
	...
	function getGeneralData(){
		...
		//remove old "bigicons" GM cookie as not needed anymore
		deleteGMcookie("bigicons", false);
	...
	function createMapLink(strType, a) {
		...
		var smURLEnd = "&groupby=player&casen=on&format=svg&";
		if (strType == "user") {
	...
	*/
	...
	function marketResources(){
		...
		if (boolMarketResources) {
			...
			if (bigTable) {
				...
				//log(3, "firstBigRow = " + firstBigRow);
				bigTable.removeChild(bigRow.parentNode);
				//log(3, "removed bigRow");
		...
		function createEventUseThemAll1H(maxNoOfMerchants, maxCapacity) {
			log(3, "Enter createEventUseThemAll1H");
			var maxTotalTransport = maxNoOfMerchants * maxCapacity;
			var totalRes = 0;
			var intSelected = 0;
			for (var i = 0; i < 4; i++) {
				var useRes = get("res" + (i + 1) + "x");
				totalRes += parseInt(productionPerHour[i]);
				if (useRes.checked == true) {
					intSelected += 1;
				}
			}
			//log(3, "intSelected = " + intSelected + "; totalRes = " + totalRes);
			for (var i = 1; i < 5; i++) {
				var useRes = get("res" + i + "x");
				if (useRes) {
					if (useRes.checked == true) {
						if (intSelected == 4) {
							var aRes = parseInt(productionPerHour[i - 1]);
						} else {
	...
	function userBookmarks(){
		...
		if (boolShowBookmarks == "1") {
			...
			// for the additional "Add this" link next to the current Add
			var enlaceCrtPage = elem("A", T('ADDCRTPAGE'));
			enlaceCrtPage.href = "javascript:void(0);";
			enlaceCrtPage.addEventListener("click", function() {addUserBookmark(window.location.href);}, 0);
			div.appendChild(document.createTextNode(" (")); div.appendChild(enlace);div.appendChild(document.createTextNode(" | "));div.appendChild(enlaceCrtPage); div.appendChild(document.createTextNode(")"));
    ...
    function TravianBeyondSetup(){
		...
		saveCell2.setAttribute("colspan", "4");
	...
	function infoResources(){
		...
		*/
		function genMapTable(){
			...
			var columnLabels = ["PLAYER", "ALLIANCE", "ALDEA", "HAB", "COORD", "ACCION"];
			for (var i = 0; i < 6; i++){
				if (i < 4){
	...
	function marketSimpleOffer() {
		...
		if (!elemInput) {
			...
			if (aTable) {
				//log(3, "Inside marketSimpleOffer");
				if (aTable.rows[1]) {
					var aCell = aTable.rows[1].cells[4];
					if (aCell) {
						aCell.innerHTML = "<input type='checkbox' id='saveofferoption' value='1'></input>&nbsp;" + T('SAVE');
					}
				}
			}
		}
