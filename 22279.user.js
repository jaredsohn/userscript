...
else if (host.match(/yourfilehost\./i)!=null) {mediahost='YourFileHost'}
    ...
    switch (mediahost)
     {
      ...
      case 'YourFileHost':var allDivs, thisDiv;
							allDivs = document.evaluate(
							"//object[@id='VIDEO']/param[@name='URL']",
							document,
							null,
							...
							videourl = thisDiv.value;
							var troll = videourl.split("http://www.yourfilehost.com/postroll-live.php?vidlink=").join("");
							var endvalue = troll.indexOf("&");
							var linking = troll.substring(0, endvalue);
							source = linking;
							}
                          break;
