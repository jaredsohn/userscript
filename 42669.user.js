...
function poeng(e){try{e.innerHTML=e.innerHTML.replace(/Poeng han eller henne har skaffet idag/,"Poeng du har i dag").replace(/(\d*)\/20\)/,"--0--)").replace(/Poeng totalt/,"alle poengene mine tilsammen").replace(/\(\d*\/2000\)/,"(2001/2000)").replace(/Bling-O-Meter:/,"Profil-design-blingene-våre!:");
