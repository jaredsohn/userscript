...
ResCalc = 
{
    ...
    en:{
	  ...
	  popups : {
	    // Texts uses in pop-ups.
		  rcwood_lost  : "<h4>Wood</h4>Units wood of lost units.<br/><i>'Research'</i> is not considered.",
		  rcstone_lost : "<h4>Stone</h4>Units stone of lost units.<br/><i>'Research'</i> is not considered.",
		  rciron_lost  : "<h4>Silver</h4>Units silver of lost units.<br/><i>'Research'</i> is not considered.",
		  rcfavor_lost : "<h4>Favor</h4>Favor costs of lost units.",
		  rcbh_lost    : "<h4>Farm places</h4>Farm places of lost units.<i>'Militia'</i> not considered .",
