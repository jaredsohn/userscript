			...
			for (var i = 0; i < entries.length; i++) {
				...
				for ( var j = 0; j < aryClassElements.length; j++ ) {
				    if (aryClassElements[j].innerHTML==nick){
						if (party==1062) {
							aryClassElements[j].innerHTML="<img src=http://img21.imageshack.us/img21/509/frontenazionale20x20.jpg title='WARNING: Fronte Nazionale inside!'></img>  " + aryClassElements[j].innerHTML;
						} 
					}
				}
