...
// @name           hot-bux
// @namespace      
// @description    auto clicks hot-bux ads
// @include        http://www.hot-bux.info/surf.php
// ==/UserScript==

//original script by dt (bux.to), modified by flameboy


const surfTable = '//table[@width="95%"]';
const linksx = '//a[@href]';
var currentWindow;
var currentElement;
var links;
...
function getLinks(){
	...
	for(var i=0;i<links.snapshotLength;i++){
		...
		if ((item.href.substring(0,36)=='http://www.hot-bux.info/view.php?ad=') &&
			!(item.href=='http://www.hot-bux.info/view.php?ad='))
			work.push(item);
	}
