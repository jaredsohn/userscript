...
var SCRIPT = {
	url: 'http://userscripts.org/scripts/source/46734.user.js',
	version: '2.2.3',
	name: 'vampiresgame',
...
// autostat
if(GM_getValue('autoStat', '') == "checked" && stats>0 ) {
  ...
  GM_getValue('autoStatStamina', '') == "checked") {
