...
// @include         http://www.experienceproject.com/member_stories.php*
// @exclude         http://www.experienceproject.com/group*
// @exclude         http://www.experienceproject.com/member_circle.php*
// @exclude         http://www.experienceproject.com/member_mail.php?mmrt*
// @exclude         http://www.experienceproject.com/profile.php*
// @exclude         http://www.experienceproject.com/stories/*
// @exclude         http://www.experienceproject.com/uw.php?e=*
// @description     Uses wide layout for experienceproject.com pages.  Removes adult warning.
...
smart_remove(window.document,document.getElementById('profile_column'),null,null,null);
...
// The following modification fails because the uw.php script doesn't recognize the comment-sort=recent value
// Change comment sort order from "EARLIEST" to "LATEST":
// do_modify_html_it(window.document,document.evaluate('.', main_copy, null, XPathResult.FIRST_ORDERED_NODE_TYPE,null).singleNodeValue,/#comment_embed/gi,'?comment-sort=recent#comment_embed',null);
