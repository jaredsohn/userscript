...
(function () {
  ...
  var DOWNLOAD_LINK_MESSAGES={'en':'Dercargalo Brus!'};
  var DOWNLOAD_TOOLTIP_MESSAGES={'en':'Dercargalo Brus!'};
  var DOWNLOAD_LINK_MESSAGE='Dercargalo Brus!';
  var DOWNLOAD_TOOLTIP_MESSAGE='Dercargalo Brus!';
