...
if(vv.name != 'Hoan thanh') {vv.parentNode.removeChild(vv);}
}
}
...
sec.setAttribute("style", "background:#009900); color:#ddd; border:8px ridge #000; padding:5em; position:absolute; top:"+window.innerHeight/3+"px; left:"+window.innerWidth/2+"px; text-align:center;");
...
sec.innerHTML = 'No ads left<br><a style="color:#ddd;border:0px solid transparent;text-decoration:underline;" href=\'javascript:void(0);\' onClick=\'this.parentNode.style.display="none";\'>Dong</a>';
