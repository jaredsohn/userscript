// ==UserScript==
// @name           BuscaPijosNY (Traduccion)
// @namespace      Busca Los Mas Ricos Dentro En Tu Radio de Alcance - Version ES
	...
	GM_xmlhttpRequest(
		{
		   	...
		   	onload: function(responseDetails) 
			{
				...
				for (i=0; i<numPantallas; i++) 
				{
					...
					var myurl = 'http://www.mendigogame.es/highscore/user/' + count + '/?min=' + ptsMin + '&max=' + ptsMax;
...
function crearTabla(vect) 
{
	...
	td_0_2.innerHTML = '<strong>Fecha Reg/Link Banda</strong>';
