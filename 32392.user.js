...
// ==/UserScript==
   ...
   var URL= "http://www.ikariamods.com/gunmetal/canary/";
...
GM_addStyle("body                                                              {background:url("+URL+"hardcode/invisible.png); color: #c3c3c3; background-color: #e9e9e9}");
GM_addStyle("#footer                                                           {background-image:url("+URL+"bg/footer.png); position: relative; left: -5px; color: #e3e3e3; text-align: right; padding: 33px 8px 0px 34px; height: 15px; width: 962px; bottom: -18px}");
GM_addStyle("#footer a                                                         {color: #f0f0f0}");
GM_addStyle("#footer a:hover                                                   {color: #d80000}");
...
GM_addStyle("#conExtraDiv3                                                     {background-image:url("+URL+"bg/design.png); position: absolute; width: 68px; height: 77px; left: -19px; top: 20px}");
GM_addStyle("#conExtraDiv4                                                     {background-image:url("+URL+"bg/design_bg.png); position: absolute; width: 164px; height: 232px; left: -133px; top: 20px}");
/* colored banner at the top of the page */
GM_addStyle("#GF_toolbar *                                                     {color: #000000; top: 1px; left: -73px; text-decoration: none}");
GM_addStyle("#GF_toolbar *:hover, #GF_toolbar .premium a .textLabel            {color: #d80000}");
GM_addStyle("#GF_toolbar .premium a .textLabel:hover                           {color: #800606}");
...
GM_addStyle("#breadcrumbs a:hover                                              {color: #d80000}");
...
GM_addStyle("#advisors #advCities a.normalactive                               {background-image:url("+URL+"mainview/adv_city.png); background-position: 0px -216px; margin: -2px 0px 0px  0px; font-weight: bold; color: #000000}");
GM_addStyle("#advisors #advCities a.normalactive:hover                         {background-image:url("+URL+"mainview/adv_city.png); background-position: 0px -324px; margin: -2px 0px 0px  0px; font-weight: bold; color: #000000}");
...
GM_addStyle("#advisors #advCities a.premiumactive                              {background-image:url("+URL+"mainview/adv_city.png); background-position: 0px -216px; margin: -2px 0px 0px  0px; font-weight: bold; color: #000000}");
GM_addStyle("#advisors #advCities a.premiumactive:hover                        {background-image:url("+URL+"mainview/adv_city.png); background-position: 0px -324px; margin: -2px 0px 0px  0px; font-weight: bold; color: #000000}");
...
GM_addStyle("#advisors #advMilitary a.normalactive                             {background-image:url("+URL+"mainview/adv_military.png); background-position: 0px -216px; margin: -2px 0px 0px  0px; font-weight: bold; color: #000000}");
GM_addStyle("#advisors #advMilitary a.normalactive:hover                       {background-image:url("+URL+"mainview/adv_military.png); background-position: 0px -324px; margin: -2px 0px 0px  0px; font-weight: bold; color: #000000}");
GM_addStyle("#advisors #advMilitary a.normalalert                              {background-image:url("+URL+"mainview/adv_military.png); background-position: 0px -432px; margin: -2px 0px 0px  0px; font-weight: bold; color: #000000}");
GM_addStyle("#advisors #advMilitary a.normalalert:hover                        {background-image:url("+URL+"mainview/adv_military.png); background-position: 0px -540px; margin: -2px 0px 0px  0px; font-weight: bold; color: #000000}");
...
GM_addStyle("#advisors #advMilitary a.premiumactive                            {background-image:url("+URL+"mainview/adv_military.png); background-position: 0px -216px; margin: -2px 0px 0px  0px; font-weight: bold; color: #000000}");
GM_addStyle("#advisors #advMilitary a.premiumactive:hover                      {background-image:url("+URL+"mainview/adv_military.png); background-position: 0px -324px; margin: -2px 0px 0px  0px; font-weight: bold; color: #000000}");
GM_addStyle("#advisors #advMilitary a.premiumalert                             {background-image:url("+URL+"mainview/adv_military.png); background-position: 0px -432px; margin: -2px 0px 0px  0px; font-weight: bold; color: #000000}");
GM_addStyle("#advisors #advMilitary a.premiumalert:hover                       {background-image:url("+URL+"mainview/adv_military.png); background-position: 0px -540px; margin: -2px 0px 0px  0px; font-weight: bold; color: #000000}");
...
GM_addStyle("#advisors #advResearch a.normalactive                             {background-image:url("+URL+"mainview/adv_research.png); background-position: 0px -216px; margin: -2px 0px 0px  0px; padding: 0 0 0 1px; font-weight: bold; color: #000000}");
GM_addStyle("#advisors #advResearch a.normalactive:hover                       {background-image:url("+URL+"mainview/adv_research.png); background-position: 0px -324px; margin: -2px 0px 0px  0px; padding: 0 0 0 1px; font-weight: bold; color: #000000}");
...
GM_addStyle("#advisors #advResearch a.premiumactive                            {background-image:url("+URL+"mainview/adv_research.png); background-position: 0px -216px; margin: -2px 0px 0px  0px; padding: 0 0 0 1px; font-weight: bold; color: #000000}");
GM_addStyle("#advisors #advResearch a.premiumactive:hover                      {background-image:url("+URL+"mainview/adv_research.png); background-position: 0px -324px; margin: -2px 0px 0px  0px; padding: 0 0 0 1px; font-weight: bold; color: #000000}");
...
GM_addStyle("#advisors #advDiplomacy a.normalactive                            {background-image:url("+URL+"mainview/adv_diplomacy.png); background-position: 0px -216px; margin: -2px 0px 0px -1px; padding: 0 0 0 3px; width: 88px; font-weight: bold; color: #000000}");
GM_addStyle("#advisors #advDiplomacy a.normalactive:hover                      {background-image:url("+URL+"mainview/adv_diplomacy.png); background-position: 0px -324px; margin: -2px 0px 0px -1px; padding: 0 0 0 3px; width: 88px; font-weight: bold; color: #000000}");
...
GM_addStyle("#advisors #advDiplomacy a.premiumactive                           {background-image:url("+URL+"mainview/adv_diplomacy.png); background-position: 0px -216px; margin: -2px 0px 0px -1px; padding: 0 0 0 3px; width: 88px; font-weight: bold; color: #000000}");
GM_addStyle("#advisors #advDiplomacy a.premiumactive:hover                     {background-image:url("+URL+"mainview/adv_diplomacy.png); background-position: 0px -324px; margin: -2px 0px 0px -1px; padding: 0 0 0 3px; width: 88px; font-weight: bold; color: #000000}");
...
/* resource mouseover */
GM_addStyle("#container #cityResources li .tooltip                             {background-color: #1e1f20; border: 2px solid #000000; border-top-width: 2px; color: #c3c3c3; top: 25px; width: 140px}");
/* NAVIGATION
...
GM_addStyle("#container .dynamic h3.header                                     {background-image:url("+URL+"bg/sidebox_header.png); height: 24px; color: #000000; padding: 0 0 0 0; line-height: 22px}");
...
GM_addStyle("#container .dynamic .content a:hover                              {color: #d80000; text-decoration: none}");
...
GM_addStyle("#container #resUpgrade h4                                         {font-weight: bold; text-align: left; padding: 0 0 0 7px; margin: 8px 0 0 0; background-color: #1e1f20; border-left: 2px double #000000; border-right: 2px double #000000}");
GM_addStyle("#container #resUpgrade #donateForm                                {border: none; background-color: #1e1f20}");
GM_addStyle("#container #resUpgrade #donate label                              {font-weight: bold; text-align: left; padding: 0 0 0 1px; margin: -4px 0 1px 0}");
GM_addStyle("#container #resUpgrade #donate input.button:hover                 {color: #d80000}");
...
GM_addStyle("#resourceUsers tr.own td                                          {color: #d80000}");
...
GM_addStyle("#worldmap_iso #container #mapControls .visibility                 {background-color: #1e1f20; border-left: 2px double #000000}");
...
GM_addStyle("#worldmap_iso #container .dynamic table#islandInfos a:hover       {color: #d80000}");
GM_addStyle("#container #resUpgrade.upgrading .progressBar                     {width: 110px; height: 10px; border: 2px double #000000; background-color: #333536}");
...
GM_addStyle("#buildingUpgrade .actions .upgrade a:hover                        {color: #d80000}");
...
GM_addStyle("#container #buildingUpgrade .actions .downgrade a:hover           {color: #d80000}");
...
GM_addStyle("#buildingUpgrade h4                                               {background-color: #1e1f20; border-left: 2px double #000000; border-right: 2px double #000000; text-align: left; font-weight: bold; padding: 0 0 0 7px}");
...
GM_addStyle("#warehouse #container .dynamic .safeinnextlevel th                {background-color: #1e1f20; color: #c3c3c3}");
...
GM_addStyle("#embassy #container .dynamic ul.links li a:hover                  {color: #d80000}");
GM_addStyle("#civilopedia_menu a                                               {color: #c3c3c3}");
GM_addStyle("#civilopedia_menu a:hover                                         {color: #d80000; text-decoration: none}");
...
GM_addStyle("#port #container #mainview .contentBox01h .content a:hover        {color: #d80000}");
GM_addStyle("#safehouseMissions #mainview a                                    {color: #f0f0f0; text-decoration: none}");
GM_addStyle("#safehouseMissions #mainview a:hover                              {color: #d80000}");
/* upgrade information */
...
GM_addStyle("#container .progressBar                                           {width: 110px; height: 10px; border: 2px double #000000; background-color: #333536}");
GM_addStyle("#container .progressBar .bar                                      {background-color: #c3c3c3; border-right: 2px double #000000}");
/* unit and ship construction */
GM_addStyle("#unitConstructionList h4                                          {background-color: #1e1f20; border-left: 2px double #000000; border-right: 2px double #000000; text-align: left; font-weight: bold; padding: 0 0 0 7px; color: #f0f0f0; line-height: 12px}");
...
GM_addStyle("#unitConstructionList .currentUnit .progressbar                   {background-image:url("+URL+"hardcode/invisible.png); border: 2px double #000000; background-color: #333536}");
...
GM_addStyle("a:hover                                                           {color: #d80000; text-decoration: none}");
GM_addStyle("input.textfield, textarea, textarea.textfield, input.textfield:focus {border: 1px solid #000000}");
GM_addStyle("#container #mainview .unit .unitcount                             {background-image:url("+URL+"hardcode/invisible.png); background-color: #333536; border: 2px double #000000; line-height: 12px; padding: 0 6px 0 6px; height: 14px; color: #f0f0f0; width: 60px; margin-top: 4px");
...
GM_addStyle("#tradeAdvisor #mainview .content #inboxCity a:hover               {color: #d80000; text-decoration: none}");
...
GM_addStyle("#militaryAdvisorCombatReports #mainview table.operations tr td.won a       {color: #000000}");
GM_addStyle("#militaryAdvisorCombatReports #mainview table.operations tr td.won a:hover {color: #d80000; text-decoration: none}");
GM_addStyle("#militaryAdvisorCombatReports #mainview table.operations tr td.lost a      {color: #d80000}");
GM_addStyle("#militaryAdvisorCombatReports #mainview table.operations tr td.lost a:hover{color: #d80000; text-decoration: none}");
GM_addStyle("#militaryAdvisorCombatReports #mainview table.operations a                 {color: #000000}");
GM_addStyle("#militaryAdvisorCombatReports #mainview table.operations a:hover           {color: #d80000; text-decoration: none}");
...
GM_addStyle("#militaryAdvisorMilitaryMovements ul#battleReports li.enroute a:hover      {color: #d80000; text-decoration: none}");
...
GM_addStyle(".militaryAdvisorTabs #tabz td a:hover                                      {background-image:url("+URL+"content/contentbox_militaryover.png); color: #d80000; text-decoration: none}");
...
GM_addStyle("#militaryAdvisorReportView #mainview .content table#ergebnis td a:hover    {color: #d80000}");
GM_addStyle("#militaryAdvisorReportView #mainview .content table#ergebnis ul.resources li  {padding-bottom: 5px; padding-top: 3px}");
GM_addStyle("#militaryAdvisorReportView #mainview .content table#ergebnis tr.rep td.winner {background-color: #1e1f20; color: #f0f0f0}");
...
GM_addStyle("#militaryAdvisorReportView #mainview .contentBox01h h3.header a:hover      {text-decoration: none; color: #d80000; font-weight: bold}");
GM_addStyle("#militaryAdvisorReportView #mainview .content table#result td.section      {background-color: #1e1f20; color: #f0f0f0; border-left: 1px solid #1e1f20; border-right: 2px solid #1e1f20; border-bottom: 2px double #d2d2d2}");
...
GM_addStyle("#militaryAdvisorReportView #mainview .content table#result a:hover         {color: #d80000; font-weight: bold; text-decoration: none}");
...
GM_addStyle("#militaryAdvisorReportView #mainview .content table#result td.winner       {background-color: #1e1f20; color: #f0f0f0; border-left: 1px solid #1e1f20; border-right: 2px solid #1e1f20; border-bottom: 2px double #d2d2d2}");
...
GM_addStyle("#militaryAdvisorMilitaryMovements ul#battleReports a:hover                 {color: #d80000}");
...
GM_addStyle("#mainview div#currentResearch .researchName a:hover               {color: #d80000; text-decoration: none}");
GM_addStyle("#researchAdvisor #mainview div#currentResearch .progressBar       {height: 10px; border: 2px double #000000; background-color: #333536}");
...
GM_addStyle("#researchAdvisor #mainview table#inboxResearch a:hover            {color: #d80000}");
...
GM_addStyle("#diplomacyAdvisor #alliance #allyinfo a:hover                     {color: #d80000}");
GM_addStyle("#diplomacyAdvisor #container #mainview #demo a                    {color: #d80000}");
...
GM_addStyle("#diplomacyAdvisor #container #mainview .table01 a:hover           {color: #d80000; font-weight: bold; text-decoration: none}");
GM_addStyle("div.diplomacyAdvisorTabs #tabz td a                               {color: #000000}");
GM_addStyle("div.diplomacyAdvisorTabs #tabz td a:hover                         {color: #d80000; text-decoration: none}");
...
GM_addStyle("#academy #mainview #setScientists .scientists .value              {background-image:url("+URL+"hardcode/invisible.png); border: 2px double #000000; background-color: #333536; line-height: 14px; padding: 0 6px 0 6px; height: 16px; color: #f0f0f0; font-weight: bold; font-size: 12px; width: 30px; margin-left: 23px");
GM_addStyle("#academy #mainview #setScientists .citizens .value                {background-image:url("+URL+"hardcode/invisible.png); border: 2px double #000000; background-color: #333536; line-height: 14px; padding: 0 6px 0 6px; height: 16px; color: #f0f0f0; font-weight: bold; font-size: 12px; width: 35px; margin-left: 12px");
...
GM_addStyle("#academy #mainview div#currentResearch .progressBar               {height: 10px; border: 2px double #000000; background-color: #333536}");
...
GM_addStyle("#researchDetail #mainview .contentBox01h table td a:hover         {color: #d80000}");
...
GM_addStyle("#changeResearch #container #mainview ul li .progress a:hover      {color: #d80000; text-decoration: none}");
GM_addStyle("#researchDetail #mainview .contentBox01h table td a               {color: #000000; text-decoration: none; font-weight: bold}");
GM_addStyle("#changeResearch #container #mainview ul li .statusBar             {background-color: #333536; border: 2px double #000000; height: 10px}");
...
GM_addStyle("#researchOverview #container #mainview div.contentBox01h div.content ul.explored li a         {color: #d80000}");
...
GM_addStyle("#researchOverview #container #mainview div.contentBox01h div.content ul.explored li a:hover   {color: #800606}");
GM_addStyle("#researchOverview #container #mainview div.contentBox01h div.content ul.unexplored li a:hover {color: #800606}");
/* museum */
GM_addStyle("#museum #culturalGoods .content                                   {background-image:url("+URL+"hardcode/invisible.png); height: 120px; margin-left: -110px}");
GM_addStyle("#museum #culturalGoods div.goods .value                           {background-image:url("+URL+"hardcode/invisible.png); color: #d80000; vertical-align: bottom}");
...
GM_addStyle("#museum #culturalGoods .result .value                             {color: #d80000}");
GM_addStyle("#museum table th                                                  {background-color: #d2d2d2; color: #000000; text-align: left}");
GM_addStyle("#culturalPossessions_assign #moveCulturalGoods .culturalGoods     {color: #d80000}");
...
GM_addStyle("#culturalPossessions_assign #moveCulturalGoods p.error            {color: #d80000}");
...
GM_addStyle("#mainview #setWorkers .citizens .value                            {background-image:url("+URL+"hardcode/invisible.png); border: 2px double #000000; background-color: #333536; line-height: 14px; padding: 0 6px 0 6px; height: 16px; color: #f0f0f0; font-weight: bold; font-size: 12px; width: 35px; margin-left: 12px");
GM_addStyle("#mainview #setWorkers .workers .value                             {background-image:url("+URL+"hardcode/invisible.png); border: 2px double #000000; background-color: #333536; line-height: 14px; padding: 0 6px 0 6px; height: 16px; color: #f0f0f0; font-weight: bold; font-size: 12px; width: 35px; margin-left: 12px");
...
GM_addStyle("#highscore #mainview a:hover                                      {color: #d80000}");
GM_addStyle("#highscore #mainview div.content table.table01 tr.own             {background-color: #d80000; color: #f0f0f0}");
GM_addStyle("#highscore #mainview div.content table.table01 tr.ownally         {background-color: #333536; color: #f0f0f0}");
...
GM_addStyle("#options p.error, #options ul.errors li                           {color: #d80000}");
GM_addStyle("#options #mainview #emailInvalidWarning h3                        {color: #f0f0f0}");
GM_addStyle("#options #mainview #emailInvalidWarning p                         {color: #d80000}");
GM_addStyle("#options #mainview #emailInvalidWarning p.confirmation            {color: #d80000}");
/* help */
...
GM_addStyle("#container #mainview div.informations div.navigation a:hover      {color: #d80000}");
...
GM_addStyle("#tavern span.value                                                {color: #d80000}");
...
GM_addStyle("#workshop-army #container #mainview #demo .units div.progressbar          {border: 2px double #000000; height: 10px; background-color: #1e1f20}");
GM_addStyle("#workshop-fleet #container #mainview #demo .units div.progressbar         {border: 2px double #000000; height: 10px; background-color: #1e1f20}");
...
GM_addStyle(".yui-navset .yui-nav a:hover                                      {background-image:url("+URL+"content/contentbox_hideoutover.png); color: #d80000; text-decoration: none}");
...
GM_addStyle("#safehouse #container #mainview td.subject a:hover                {color: #d80000}");
...
GM_addStyle("#safehouse #container #mainview .spyinfo li.city a:hover          {color: #d80000}");
GM_addStyle("#safehouse #container #mainview .spyinfo li.status                {background-image:url("+URL+"hardcode/invisible.png)}");
GM_addStyle("#safehouse #container #mainview ul li.risk .statusBar             {border: 2px double #000000; height: 8px; background-color: #333536}");
GM_addStyle("#safehouseMissions #mainview .statusBar                           {border: 2px double #000000; height: 8px; background-color: #333536}");
...
GM_addStyle("#safehouse #container #mainview .spyinfo div.missionButton a:hover{background-color: #c3c3c3; color: #d80000}");
...
GM_addStyle("#safehouse #container #mainview .spyinfo div.missionAbort a:hover {background-color: #c3c3c3; color: #d80000}");
...
GM_addStyle("#sendSpy .risk .statusBar                                         {border: 2px double #000000; height: 8px; background-color: #333536; margin-top: 5px}");
...
GM_addStyle("#CityOverview h3 a                                                {background-image:url("+URL+"hardcode/invisible.png); color: #ffd800; margin-top: -6px; width: 40px}");
GM_addStyle("#CityOverview h3 a:hover                                          {background-image:url("+URL+"hardcode/invisible.png); color: #d80000}");
...
GM_addStyle("#SatisfactionOverview .happiness .value                           {color: #d80000; font-size: 16px}");
GM_addStyle("#renameCity .oldCityName                                          {color: #000000}");
GM_addStyle("#CityOverview .stats .incomegold_positive .value                  {color: #d80000; font-weight: bold}");
GM_addStyle("#CityOverview .stats .incomegold_negative .value                  {color: #800606; font-weight: bold}");
/* embassy */
...
GM_addStyle("#merchantNavy #mainview table td.transports                       {color: #d80000; text-align: center}");
...
/* MISCELLANEOUS
   clickable button */
GM_addStyle("*.button                                                          {background-image:url("+URL+"misc/button.png); font-size: 11px; font-weight: bold; color: #000000; border: 2px double #000000; padding: 3px 0 3px 0; line-height: 13px}");
GM_addStyle("*.button:hover                                                    {color: #d80000}");
GM_addStyle("*.button:active                                                   {font-size: 11px; font-weight: bold; color: #d80000; border: 2px double #000000; padding: 3px 0 3px 0; line-height: 13px}");
GM_addStyle("*.button_inactive                                                 {background-image:url("+URL+"misc/button.png); font-size: 11px; font-weight: bold; color: #d80000; border: 2px double #000000; padding: 3px 0 3px 0; line-height: 13px}");
GM_addStyle("*.buttonChanged                                                   {background-image:url("+URL+"misc/button.png); font-size: 11px; font-weight: bold; color: #d80000; border: 2px double #000000; padding: 3px 0 3px 0; line-height: 13px}");
GM_addStyle("*.buttonChanged:hover                                             {color: #d80000}");
GM_addStyle("*.dangerButton, *.cancelUpgrade                                   {background-image:url("+URL+"misc/button.png); font-size: 11px; font-weight: bold; color: #000000; border: 2px double #000000; padding: 3px 0 3px 0; line-height: 13px}");
GM_addStyle("*.dangerButton:hover, *.cancelUpgrade:hover                       {color: #d80000}");
GM_addStyle("*.dangerButton:active, *.cancelUpgrade:active                     {font-size: 11px; font-weight: bold; color: #d80000; border: 2px double #000000; padding: 3px 0 3px 0; line-height: 13px}");
...
GM_addStyle("#island #mainview #cities .city .textLabel                        {background-image:url("+URL+"hardcode/invisible.png); background-color: #333536; border: 2px double #000000; line-height: 14px; padding: 0 6px 0 6px; height: 16px; color: #f0f0f0; font-weight: bold");
...
GM_addStyle("#diplomacyAdvisor #container #mainview #tab1 td.reply a.button:hover {color: #d80000; text-decoration: none}");
GM_addStyle("#container #mainview #notice input                                {color: #f0f0f0}");
GM_addStyle(".modifiersList ul:hover li ul                                     {background-color: #1e1f20; border: 2px double #000000; color: #f0f0f0}");
...
GM_addStyle("#worldmap_iso #worldmap .cities                                   {background-image:url("+URL+"hardcode/invisible.png); background-color: #333536; border: 2px double #000000; bottom: 28px; left: 106px; padding-top: 1px; height: 16px}");
...
unsafeWindow.qbbuildinterior = function()
{
    ...
    if(unsafeWindow.places != "0")
    {
        ...
        for(i = 0; i < splitplaces.length-1; i++){
            ...
            if(i>0){
            qbHTML += '<a title="Move Quickmark Up" href="javascript:qbmoveup(\'' + placepiece[0] + '|' + placepiece[1] + ';\');"><img src="http://www.ikariamods.com/gunmetal/canary/content/btn_increase.png" border="0"></a>';
            }
            else {
            ...
            qbHTML += '<a title="Move Quickmark Down" href="javascript:qbmovedown(\'' + placepiece[0] + '|' + placepiece[1] + ';\');"><img src="http://www.ikariamods.com/gunmetal/canary/content/btn_decrease.png" border="0"></a>';
            }
            else {
            qbHTML += '<img src="http://www.imgboot.com/images/enigmabrand/movetrans.png" height="10" width="10" border="0">';
            }
            qbHTML += '<a title="Delete Quickmark" href="javascript:qbdeleteentry(\'' + placepiece[0] + '|' + placepiece[1] + ';\');"><img src="http://www.ikariamods.com/gunmetal/canary/content/delete.png" border="0"></a>';
            qbHTML += ' <a title="Rename Quickmark" href="javascript:qbrenameentry(\'' + placepiece[0] + '|' + placepiece[1] + ';\');"><img src="http://www.ikariamods.com/gunmetal/canary/content/rename.png" border="0"></a>-</td>';
    ...
    qbHTML += '<a href="javascript:qbexport();" title="Export list"><img src="http://www.ikariamods.com/gunmetal/canary/content/btn_increase.png" border="0"></a>';
    qbHTML += ' <a href="javascript:qbimport();" title="Import list (append)"><img src="http://www.ikariamods.com/gunmetal/canary/content/btn_decrease.png" border="0"></a>';
    qbHTML += ' <a href="javascript:qbdeleteall();" title="Delete all quickmarks"><img src="http://www.ikariamods.com/gunmetal/canary/content/delete.png" border="0"></a>';
    qbHTML += '</div>';
    qbHTML += '<div id="qfoot"></div>';
    document.getElementById("quickbar").innerHTML = qbHTML;
}

GM_addStyle("#qhead          {background:url(http://www.ikariamods.com/gunmetal/canary/bg/notebar_header.png); position: absolute; height: 21px; width: 282px; line-height: 20px; font-weight: bold; font-size: 11px; background-repeat: no-repeat; border-right: 2px double #000000}");
GM_addStyle("#quicktab       {background:url(http://www.ikariamods.com/gunmetal/canary/bg/quickbar_title.png); position: absolute; height: 85px; width: 17px; left: 284px}");
GM_addStyle("#quickbar       {width: 284px; position: absolute; left: -284px; height: 228px; top: 129px; z-index: 150; background-color: #d2d2d2; background:url(http://www.ikariamods.com/gunmetal/canary/bg/quickbar_title.png)}");
GM_addStyle("#quickbar:hover {width: 284px; left: 0px; background:url(http://www.ikariamods.com/gunmetal/canary/bg/quickbar.png); background-repeat: no-repeat}");
...
GM_addStyle("#nhead         {background:url(http://www.ikariamods.com/gunmetal/canary/bg/notebar_header.png); position: absolute; height: 21px; width: 343px; line-height: 20px; font-weight: bold; font-size: 11px; background-repeat: no-repeat}");
GM_addStyle("#notetab       {background:url(http://www.ikariamods.com/gunmetal/canary/bg/notebar_title.png); position: absolute; height: 85px; width: 17px; left: 345px}");
GM_addStyle("#notebar       {width: 345px; position: absolute; left: -345px; height: 228px; top: 36px; z-index: 150; background-color: #d2d2d2; background:url(http://www.ikariamods.com/gunmetal/canary/bg/notebar_visible.png)}");
GM_addStyle("#notebar:hover {width: 345px; left: 0px; background:url(http://www.ikariamods.com/gunmetal/canary/bg/notebar.png); background-repeat: no-repeat}");
...
scriptName='Gunmetal Ikariam (Canary Edition)';
scriptId='32392';
scriptVersion=0.86;
scriptUpdateText='For a full list of changes visit: http://userscripts.org/scripts/show/32392';
...
GM_addStyle("#gm_update_alert                      {background-image:url(http://www.ikariamods.com/gunmetal/canary/bg/sidebox_header.png); position: fixed; z-index:100000; top: "+((winH/2)-160)+"px; left: "+((winW/2)-200)+"px; width: 224px; background-repeat: no-repeat; background-position: -2px -2px; background-color: #1e1f20; padding-top: 2px; text-align: left; border: 2px double #000000}");
GM_addStyle("#gm_update_alert_buttons              {position: relative; top: -5px; margin: 7px}");
GM_addStyle("#gm_update_alert_button_close         {background-image:url(http://www.ikariamods.com/gunmetal/canary/misc/button.png); font-weight: bold; font-size: 11px; width: 35px; height: 14px; position: absolute; top: 112px; left: 84px; padding: 3px 6px 3px 6px; z-index: inherit; color: #000000; cursor:pointer}");
...
GM_addStyle("#gm_update_alert_buttons span a:hover {text-decoration:none; color: #d80000; font-weight: bold; cursor:pointer}");
                newversion = document.createElement("div");
                newversion.setAttribute('id', 'gm_update_alert');
                newversion.innerHTML = ''
                +'  <center><b><font color="#000000">Gunmetal Ikariam (Canary Edition)</font></b><br><br>'
