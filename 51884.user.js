...
// @namespace 	Cyrus
// @author		Cyrus
// @description	The Ika-core Tools for Alliance - KoC
...
switch (location.host) {
	default:
		alliancefullnm='Kingdom of Countries';
		alliancenm='KoC';		
		alliance=[	['KoC', Alliance],
					['KoH', Allies],
					['KoS', Allies],	
					['Perce', Enemies] ];

		chaturl='http://koh.leforum.eu/chat2.php';
		forumurl='http://koh.leforum.eu/index.php';
		forumurlnew='http://koh.leforum.eu/search.php?search_id=newposts';
		break;
}
