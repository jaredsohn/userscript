...
{ document.getElementById("mod_comm_list2").style.backgroundColor = 'none';}
if(document.getElementById("mod_comm_list1"))
{ document.getElementById("mod_comm_list1").style.backgroundColor = 'none';}
...
function pbStartup (){
  ...
  var styles = '.xtab {padding-right: 5px; border:none; background:none; white-space:nowrap;}\
    ...
    .ptChatWhisper {}\
    .ptChatAlliance {background-color: none}\
    .ptChatGlobal {background-color: none}\
