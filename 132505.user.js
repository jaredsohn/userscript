...
var settings = {
	'keys': ['autoBattle', 'findRare', 'findlegendary','findLegendaryRare','catchPok'],
	'data': {},
	'save': function() {
...
function autoContinue() {
	...
	if (settings.data.findLegendaryRare) {
		findLegendaryRare();
	}
}
...
function init() {
	...
	createToggler(container, 'Find Any Rare:', 'findRare');
	createToggler(container, 'Find Legendary Only:', 'findLegendary');
	createToggler(container, 'Find Legendary Rare Only:', 'findLegendaryRare');
