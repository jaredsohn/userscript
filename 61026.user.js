...
function Sharkale_TopPost(alcargar,t,p){
	...
	html += '		</select>';
	html += '		<input id="Btn_Filtrar_Tops" type="button" title="Filtrar Top Posts" value="Filtrar - Sharkale®" style="font-size: 12px; width: 200px;" class="login"/><br/>';
	html += '		<b>La visualización de los top puede tardar unos minutos... También ten en cuanta que solo puedes hacer 2 consultas por minuto.</b>';
	html += '	</div><br/>';
	...
	html += '			<div style="width: 200px;" class="box_txt">Top post con más puntos</div>';
	...
	html += '		</div><br/>';
	html += '		<div style="width: 300px;" class="box_title">';
	html += '			<div style="width: 200px;" class="box_txt">Top post más comentado</div>';
	html += '			<div style="background-image:url(http://i.t.net.ar/images/cor-der.gif);background-position:right top;background-repeat:no-repeat;float:right;padding-right:8px;padding-top:4px;"></div>';
	html += '		</div>';
	...
	html += '		<div style="width: 300px;" class="box_title">';
	html += '			<div style="width: 268px;" class="box_txt">Top post más favorito</div>';
	html += '			<div style="background-image:url(http://i.t.net.ar/images/cor-der.gif);background-position:right top;background-repeat:no-repeat;float:right;padding-right:8px;padding-top:4px;"></div>';
	html += '		</div>';
	...
	html += '		</div><br/>';
	html += '		<div style="width: 300px;" class="box_title">';
	html += '			<div style="width: 268px;" class="box_txt">Top post más visitado</div>';
	html += '			<div style="background-image:url(http://i.t.net.ar/images/cor-der.gif);background-position:right top;background-repeat:no-repeat;float:right;padding-right:8px;padding-top:4px;"></div>';
	html += '		</div>';
	...
	html += '		<div style="width: 300px;" class="box_title">';
	html += '			<div style="width: 268px;" class="box_txt">Top usuario más posteador</div>';
	html += '			<div style="background-image:url(http://i.t.net.ar/images/cor-der.gif);background-position:right top;background-repeat:no-repeat;float:right;padding-right:8px;padding-top:4px;"></div>';
	html += '		</div>';
	...
	html += '		</div><br/>';
	html += '		<div style="width: 300px;" class="box_title">';
	html += '			<div style="width: 268px;" class="box_txt">Top usuario con más puntos</div>';
	html += '			<div style="background-image:url(http://i.t.net.ar/images/cor-der.gif);background-position:right top;background-repeat:no-repeat;float:right;padding-right:8px;padding-top:4px;"></div>';
	html += '		</div>';
			...
			$('#return_agregar_comentario').html(HTML).slideDown(1000, function(){
				$.ajax({
					...
					success: function(h){
						...
						var HTML = '<div class="cita" style="color:#464646;text-shadow:0 1px 0 #CCCCCC;"><img src="'+URL+'cerrar.gif" alt="[X]" title="'+tarLang["Preview"][3]+'" border="0" onclick="javascript:($(\'#return_agregar_comentario\').slideUp(1000))" style="margin-right:5px" onmouseover="this.style.cursor=\'pointer\'" />'+tarLang["Preview"][4]+' - Sharkale®</div>';
...
function Sharkale_Opciones(){
	...
	nuevaHTML += '	<input type="button" value="Restablecer Cambios" id="Btn_Restablecer_Imagenes" title="Restablecer a los imágenes originales del script" class="ui-state-default ui-corner-all"/><hr>';
	...
	nuevaHTML += '    <a href="http://radio.sharkale.com.ar/" target="_blank"><img src="http://i32.tinypic.com/zkg95l.jpg" alt="..::Radio Sharkale®::.." width="740"/></a>';
	...
	nuevaHTML += '    <span style="font-size:30px;font-family:Arial Black">Sharkale® 2009</span><br/><br/><br/>';
...
//----Opciones----//
	...
	menu += '</ul><span class="separador">&nbsp;</span>';
	menu += '<ul class="tMenu">';
	menu += '	<li><a href="http://radio.sharkale.com.ar" title="Visiten la Radio de Sharkale® =P" target="_blank"><img src="http://i29.tinypic.com/3029onc.jpg" style="width: '+MenuSize+'px; height: '+MenuSize+'px;" align="absmiddle"/></a></li>';
	menu += '</ul><span class="separador">&nbsp;&nbsp;&nbsp;&nbsp;</span>';
//----Actualizar----//
	menu += '<ul id="MenuAct" class="tMenu" style="display:none;">';
	menu += '	<li><a href="javascript:void(0)" id="Sharkale_Actualizar" title="Hay una nueva versión disponible del Script" style="text-decoration:blink;"><img src="'+MenuActualizacion+'" style="width: '+MenuSize+'px; height: '+MenuSize+'px;" align="absmiddle" /> Nueva Versión</a></li>';
	menu += '</ul>';
	menu += '</span>';
...
///////////////-----------------Agregar Emoticones------------------////////////////////
		...
		BotonOcultar = '<input class="button" value="'+(EmotVis == true? "Ocultar Emoticones":"Mostrar Emoticones")+'" onclick="Ocultar_Emoticones(this);return false;" id="ocultar_emot" type="button" title="Mostrar/Ocultar la barra de emoticones rápidos">';
		$('#MapSmiles').remove();
	...
	if($('div[typeof="foaf:Person"]').find('a[href="/perfil/2421862"]').length != 0){
		var mod_sharkale = $('div[typeof="foaf:Person"]');
		mod_sharkale.html(mod_sharkale.html().replace(/New Full User/gi,'Moderador').replace(/No Rankeado/,'T! Rank: 1').replace(/ Puntos/,'4684 Puntos'));
...
function AceptarActualizacion(){
	...
	unsafeWindow.mydialog.body('<h2>Hay disponible una nueva versi&oacute;n del script "BBCoder para Taringa"</h2>Tu versión instalada es la <b>' + ultversion +'</b> y la última disponible es la <b>' + Act.ver + '</b><h3><u>Cambios de la última versión:</u></h3><ul type="disc">' + Act.cambio + '</ul><h3>&iquest;Desea actualizar el script?</h3>');
...
function addStyle(theme) {
		var css = "a{color:"+theme.fondofuera+";}" +
				...
				"#centro .box_rrs,.banner,.rtop,.rbott,#pie,#footer,.byYahoo,.container208,.byGoogle,.box_perfil/3015991_der iframe,.bbox,.cse-branding-logo,#mensaje-top{display:none}" +
				...
				".box_cuerpo  hr,.box_perfil/3015991 hr,.container940 center,.container740 center{display:block}" +
...
hosts.push (["uploadbox.com",
			 ...
			 /Download as Premium|Premium Download|File name:|Moderador="Download for free"/gi,
			 /class="not_found"/gi,
			 /[\d.]+ [KM]B/
			 ]);
...
function verificar_links(){
	try{
		...
		var Tags = ['a', 'head', 'script', 'style', 'textarea', 'Moderador', 'option', 'code'];
