// ==UserScript==
// @name			Ask.fm Automatic Like By Diego Vasquez
// @namespace                   http://userscripts.org/scripts/show/999999
// @version			2.0
// @copyright		        http://ask.fm/Diegovasquez28
// @description		        Auto Like Ask.fm
// @author			(http://userscripts.org/users/512089)
// @include			http://ask.fm/*
...
if(body != null) {
	...
	div.innerHTML = "<div style='background-color: #00a2ff; color: #FFFFFF; border: 1px solid #00a2ff;'><center><a style='color: #000000;' <a href='http://www.facebook.com/nuestro.amor.7311' target='_blank' title='Agregame  para agradecerme :)'> Mi Facebook </a></div>"
	...
	div2.innerHTML = "<div style='background-color: #00a2gg; color: #GGGGGG; border: 1px solid #00a2ff;'><a style='color: #GGGGGG;' onclick='spoiler()' title='Click Para Ocultar'>&laquo;</a> &#8226; <a href='http://ask.fm/Diegovasquez28' title='Preguntame :)' style='color: #FFFFFF;' onclick='alert(\'Thanks for install this script\');'>Preguntame & Regalame</a></div> "
	...
	for(i=1;i<=20;i++) {
		...
		div2.innerHTML = "<a onclick='spoiler()' title='Mostrar :) Mi Ask Diegovasquez28'>&laquo;</a> &#8226; <a href='http://ask.fm/Diegovasquez28' title='Diego Vasquez'>Preguntame!</a>"
		}
		else {
