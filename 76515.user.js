...
html_insert_it(window.document,document.getElementById('name'),'<script>$(document).ready(function(){$("a[class=autofill]").click(function(){$("input[name=name]").val($(this).text());return false;});});</script> [ <a href="javascript:;" class="autofill">Anonymous</a> / <a href="javascript:;" class="autofill">Trip#password</a> ]',false,false);
