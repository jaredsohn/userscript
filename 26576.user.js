...
// ** Global Variables
// ***************************************************************************
const scriptversion = '2.27';
const scriptversionID = 'Kira Evo+ ' + scriptversion;
const scriptTag = 'I Shall Be Judge of Who Dies';
const EVO_DEBUG = true;
const KIRAFORUM_URL = 'http://playevo.com/_/747968-The-Lords-Kira-Alliance-Forum'; 
...
//EVO_debug(unsafeWindow.continentBox);
  ...
  addItemToContent(node, 'Quick Links: ', 't_normal b', "<a href=\"http://playevo.com/_/747875-United-Forces-Of-Order-Alliance-Forum\">KIRA Forum</a>", true);
