// ==UserScript==
// @name           Facebook AutoLike 1.01 By Diardo Kashimaru.
// @namespace      AutoLike 1.01
// @description    Automaticly like facebook statuses and comments without clicking "like" button one by one. || men-Like semua status Facebook yang ada di suatu halaman tanpa perlu repot-repot meng-kliktombol "suka" satu persatu
...
//	div.innerHTML = "<a style=\"font-weight:bold;color:#333333\" href=\"JavaScript:AutoLikeComments()\">Like All Comments</a>"
	div.innerHTML = "<a style=\"font-weight:bold;color:#333333\" href=\"http://facebook.com/diardomarendikrista\" target=\"_blank\">Diardo Marendi Krista</a>"
...
if(body != null) {
	...
	div.style.border = "1px solid #067900";
    div.style.padding = "1px";
	div.innerHTML = "<a style=\"font-weight:bold;color:#333333\" href=\"http://www.diardo.co.cc\" target=\"_blank\">www.diardo.co.cc</a>"
	...
	unsafeWindow.AutoUnLikeComments = function() {
		...
		for(i = 0; i < buttons.length; i++) {
			myClass = buttons[i].getAttribute("class");
			if(myClass != null && myClass.indexOf("") >= 0)
				if(buttons[i].getAttribute("title") == "www.diardo.co.cc")
					buttons[i].click();
		}
