// ==UserScript==
// @name           Iowa League Flag Farm Players in Yahoo
// @namespace      http://glenncarr.com/greasemonkey/fantasybaseball
// @include        http://baseball.fantasysports.yahoo.com/b1/172*
// @description    Indicates Iowa Minors players that are 'owned' outside of Yahoo's active roster
...
/*
    ...
    18-Sep-2012 - Removed setTimeout experiment which started causing a bug due to FF changes in global variable scoping
*/
/*
Usage:
...
{
    FARM_ROSTERS_URL = prompt( "Enter URL of Google spreadsheet containing Iowa Minors rosters (if a URL is already in the box below, just press OK):", "https://docs.google.com/spreadsheet/pub?key=0AmkBNPY405WAdEt1TDhVc1BSYl9MUWxNVzA4c1JhTEE&output=txt" );
    if ( FARM_ROSTERS_URL != null && FARM_ROSTERS_URL != '' )
...
if ( subnav != null && subnav.getElementsByTagName( 'li' ).length > 0 )
{
    ...
    li.innerHTML = '<a target="sports" href="https://spreadsheets.google.com/pub?key=pcwHMrO9Xyn8heb2cIFT_Cw">Iowa Minors</a>';
