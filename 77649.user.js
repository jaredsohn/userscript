// ==UserScript==
// @name           Google Calendar - Weekend coloration - EN
...
// Coloration Fond
	GM_addStyle(".month-row .st-bg-table .st-bg:nth-child(1) { background:#F8F9FF !important }");
...
// Coloration titre weekend
	GM_addStyle(".month-row .st-grid .st-dtitle:nth-child(1) { background:#f2f4fa !important }");
