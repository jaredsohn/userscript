// ==UserScript==
// @name Uncoiled - Standard
// @namespace 
// @description 4:3 aspect ratio version of Uncoiled, a gallery enhancement for the CF community.
...
while (totalCount < 140) {
	...
	//check to see if totalcount is finished in order to remove "two tables" error from 4:3 version
	if (totalCount < 149){
	tr.appendChild(td3);
	imgCopy = document.getElementById('statsTable').getElementsByTagName('img')[0].parentNode;
