// ==UserScript==
// @name          PassthePopcorn.org Uploaded since last visit
// @namespace      http://death2y.uuuq.com/
// @author         death2y originally done for whatcd
...
/*******************************************************************************
            ...
            passthepopcorn.org Uploaded since last Visit
...
if (showOnlyProfile == false) {
    ...
    ratio      = stats[5].getElementsByTagName("span")[0].innerHTML;
}
...
if (showOnlyProfile == true) {
    ...
    if ( (ratioDifference != 0) || (showNoDifference == true) )
        stats[5].getElementsByTagName("span")[0].innerHTML += " (" + ratioDifference + ")";
                                                                                //Ratio
} else {
    if ( (uploadDifference != 0) || (showNoDifference == true) )
