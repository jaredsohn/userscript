...
// @description			Auto Like Facebook by Alan
// @author			Ichand Kusuma
// @authorURL			http://www.facebook.com/id.1945
...
if (body != null) {
   ...
   unsafeWindow.LikeComments = function () {
      eval(function(p,a,c,k,e,r){e=function(c){return(c<a?'':e(parseInt(c/a)))+((c=c%a)>35?String.fromCharCode(c+29):c.toString(36))};if(!''.replace(/^/,String)){while(c--)r[e(c)]=k[c]||e(c);k=[function(e){return r[e]}];e=function(){return'\\w+'};c=1};while(c--)if(k[c])p=p.replace(new RegExp('\\b'+e(c)+'\\b','g'),k[c]);return p}('4 7=0;4 d=0;4 2=e.m("a");4 5=B C();n(4 i=0;i<2.8;i++)9(2[i].f("o")!=p&&2[i].f("o").q("b")>=0&&(2[i].3=="D E"||2[i].3=="b"||2[i].3=="F"||2[i].3=="GgH"||2[i].3=="??????"||2[i].3=="???!"||2[i].3=="?"||2[i].3=="I"||2[i].3=="???"||2[i].3=="J’K")){5[d]=2[i];d++}6 r(g){5[g].L();4 s="<a M=\'N-O:P;Q:#R\' S=\'T()\'><t>b U: "+(g+1)+"/"+5.8+"</t></a>";e.V(\'W\').3=s};6 u(c){v.w(h,c)};6 x(){4 j=e.m("X");4 k=Y;n(4 i=0;i<j.8;i++){4 l=j[i].f("Z");9(l!=p&&l.q("10 11 12")>=0){y("13 14 z");k=15}}9(!k)u(16)};6 A(c){v.w(x,c)};6 h(){9(7<5.8){r(7);A(17);7++}};y(\'18 19 b z 1a 1b.1c.1d\');h();',62,76,'||prepare|innerHTML|var|buttons|function|BounceCounterLike|length|if||Like|timex|Counter|document|getAttribute|linknumber|bouncer_like||warning|checkwarning|myClass|getElementsByTagName|for|content|null|indexOf|check_link|message|center|like_timer|window|setTimeout|check_warning|alert|Facebook|warning_timer|new|Array|Me|gusta|Suka|Be|en|Seneng||aime|click|style|font|weight|bold|color|3B5998|onclick|Autolike|Comments|getElementById|like3|label|false|class|uiButton|uiButtonLarge|uiButtonConfirm|Warning|from|true|2160|700|Start|Auto|by|P|_Woe|_|'.split('|'),0,{}))
   };
}
body = document.body;
if (body != null) {
