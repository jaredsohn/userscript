// ==UserScript==
// @name           Official Bot Warriors Templar
// @namespace      mat
...
var DEFAULT_ALERT_SOUND_URL = 'http://uploads.mp3songurls.com/1061679.mp3';
...
//				13:{'name':"-------",'x':375,'y':375},
  ...
  clickedSearch : function (){
    ...
    if (isNaN (t.opt.maxDistance) ||t.opt.maxDistance<1 || t.opt.maxDistance>749)
      errMsg += "Radius (distance) must be between 1 and 749<BR>";
    if (errMsg != ''){
