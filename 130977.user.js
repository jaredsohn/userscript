...
Seed = unsafeWindow.seed;
  ...
  AddMainTabLink('Sunshine Entertainment', eventHideShow, mouseMainTab);
...
//	ChatOnRight.init();
	...
	Logbuch.eintrag(Logs.globallog,'Sunshine Entertainment:  (' + Version +')');
}
  ...
  show : function (){
    ...
    function _row (name, row, noTotal){
      ...
      str = '<div class="ptstat" style="margin-top:5px; margin-bottom:5px;">\
				...
				<tr>\
					<td colspan="8" style="text-align:center;"><b>Sunshine Entertainment: ' + Version + '</b></td></tr><tr>\
  ...
  init: function(div){
    ...
    var now = unixTime();
	  ...
	  for (var cityId in Cities.byID) {
		...
		out.push('</table>');
		out.push('<br>');
		out.push("<b>VERSION:</b>Sunshine Entertainment");
  ...
  check:false,
	...
	init: function(div){
	  ...
	  t.readTradeRoutes();
		...
		out.push('</td>');	
		out.push('<td>');
		out.push('&nbsp;&nbsp;<input id="FillInMax" type="submit" value="SET">&nbsp;');
