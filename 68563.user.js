// ==UserScript==
// @name           Elitware Link Checker
// @namespace      http://elitware.org
// @description    Teljeskoru linkellenorzo program, amely az alabbi tarhelyeknek a linkjeit hivatott ellenorizni. Barmelyik oldal hasznalhatja!
// @version        2010.02.10 23:42
...
var mediafire_com= new Array(6)                         //http://www.mediafire.com/?6egyjzxdfkx
 ...
 mediafire_com[1]='Click here to';                      // file_is_alive
 mediafire_com[2]='Invalid';                   // file_is_dead
...
var netload_in= new Array(6)
 ...
 var mediafire_com= new Array(6)                         //http://www.axifile.com/?5930695
 axifile_com[0]="axifile.com/\\?";                  //name and search string in link to get description
 axifile_com[1]='You requested';                      // file_is_alive
 axifile_com[2]='Invalid Quickkey';                   // file_is_dead
 axifile_com[3]='dsdlhkhsgdsgdhskjhgd';                  // no download slots or temporarily unavailable or servererror                  
 axifile_com[4]="//a[contains(@href,'www.mediafire.com/?')]"; 
 axifile_com[5]='tos_aup_violation';                  // tos violation
 ...
 var lianks = document.evaluate(netload_in[4]+'|'+easy_share_com[4]+'|'+mediafire_com[4]+'|'+depositfiles_com[4]+'|'+vip_file_com[4]+'|'+sendspace_com[4]+'|'+yourfilehost_com[4]+'|'+rapidshare_de[4]+'|'+filebase_to[4]+'|'+addat_hu[4]+'|'+bitroad_net[4]+'|'+filenavi_com[4]+'|'+data_hu[4]+'|'+letitbit_net[4]+'|'+zshare_net[4]+'|'+axifile_com[4] ,  document,	null,	XPathResult.UNORDERED_NODE_SNAPSHOT_TYPE,	null);
