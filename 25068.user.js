// ==UserScript==
// @author		godknight@gmail.com
// @name		Travian: Resource++ v4 HUN (Lang By GodKnightX)
// @namespace	http://userscripts.org/
// @description	Nyersanyag ++ v4 (Magyar), Magyarra fordította: GodKnightX
// @include		http://*.travian.hu/*.php*
// @include		http://www.*.travian.hu/*.php*
...
function quickLinks(vis){
	...
	var con=document.createElement('div');
		...
		con.style.height='15px';
		con.style.cssFloat='left';
		con.appendChild( document.createTextNode(  '-[Navigáció]-' ) );
	...
	var onSelect=document.createElement('select');
		...
		onSelect.appendChild(makeOption('=> Hadügy <=','#'));
		onSelect.appendChild(makeOption('Mozgó csapatok (GyT.)','build.php?id=39'));
		onSelect.appendChild(makeOption('Egységek küldése','a2b.php?s=4'));
		onSelect.appendChild(makeOption('Harc szimulátor','warsim.php'));
		...
		onSelect.style.width=w;
		onSelect.addEventListener('change',function(e){jump(e);},true);
		onSelect.appendChild(makeOption('=> Piac <=','#'));
		onSelect.appendChild(makeOption('Nyersanyag Küldés','build.php?gid=17'));
		onSelect.appendChild(makeOption('Vásálrás','build.php?gid=17&t=1'));
		onSelect.appendChild(makeOption('Eladás','build.php?gid=17&t=2'));
		onSelect.appendChild(makeOption('NPC Kereskedő','build.php?gid=17&t=3'));
		cell.appendChild(onSelect);
		row.appendChild(cell);
		mymenu.appendChild(row);
		...
		onSelect.style.width=w;
		onSelect.addEventListener('change', function(e) {jump(e);} , true);
		onSelect.appendChild( makeOption('=> Jelentések <=','#' )      );
		onSelect.appendChild( makeOption('Összes','berichte.php' ) );
		onSelect.appendChild( makeOption('Hadügyi','berichte.php?t=1' ) );
		onSelect.appendChild( makeOption('Kereskedelmi','berichte.php?t=2' ) );
		onSelect.appendChild( makeOption('Hadügyi','berichte.php?t=3' ) );
		onSelect.appendChild( makeOption('Egyéb','berichte.php?t=4' ) );
		cell.appendChild(  onSelect   );
		row.appendChild( cell );
		mymenu.appendChild(row);
		...
		onSelect.style.width=w;
		onSelect.addEventListener('change', function(e) {jump(e);} , true);
		onSelect.appendChild( makeOption('=> Üzenetek <=','#' )      );
		onSelect.appendChild( makeOption('Bejövő','nachrichten.php' ) );
		onSelect.appendChild( makeOption('Kimenő','nachrichten.php?t=1' ) );
		onSelect.appendChild( makeOption('Írás','nachrichten.php?t=2' ) );
		cell.appendChild(  onSelect   );
		row.appendChild( cell );
		mymenu.appendChild(row);
		...
		onSelect.style.width=w;
		onSelect.addEventListener('change', function(e) {jump(e);} , true);
		onSelect.appendChild( makeOption('=> Statisztikák <=','#' )      );
		onSelect.appendChild( makeOption('Játékosok','statistiken.php' ) );
		onSelect.appendChild( makeOption('Falvak','statistiken.php?id=2' ) );
		onSelect.appendChild( makeOption('Klánok','statistiken.php?id=4' ) );
		onSelect.appendChild( makeOption('Támadók','statistiken.php?id=31' ) );
		onSelect.appendChild( makeOption('Védők','statistiken.php?id=32' ) );
		onSelect.appendChild( makeOption('Általános','statistiken.php?id=0' ) );
		cell.appendChild(  onSelect   );
		row.appendChild( cell );
		mymenu.appendChild(row);
		...
		onSelect.style.width=w;
		onSelect.addEventListener('change', function(e) {jump(e);} , true);
		onSelect.appendChild( makeOption('=> Klán <=','#' )      );
		onSelect.appendChild( makeOption('Klán Főoldal','allianz.php' ) );
		onSelect.appendChild( makeOption('Fórum','allianz.php?s=2' ) );
		onSelect.appendChild( makeOption('Chat','allianz.php?s=6' ) );
		onSelect.appendChild( makeOption('Támadás','allianz.php?s=3' ) );
		onSelect.appendChild( makeOption('Hírek','allianz.php?s=4' ) );
		onSelect.appendChild( makeOption('Beállítások','allianz.php?s=5' ) );
		cell.appendChild(  onSelect   );
		row.appendChild( cell );
		mymenu.appendChild(row);
		...
		onSelect.style.width=w;
		onSelect.addEventListener('change', function(e) {jump(e);} , true);
		onSelect.appendChild( makeOption('=> Nyersanyag <=','#' )      );
		onSelect.appendChild( makeOption('Búzamező','build.php?gid=4' ) );
		onSelect.appendChild( makeOption('Favágó','build.php?gid=1' ) );
		onSelect.appendChild( makeOption('Agyagbánya','build.php?gid=2' ) );
		onSelect.appendChild( makeOption('Vasbánya','build.php?gid=3' ) );
		onSelect.appendChild( makeOption('Raktár','build.php?gid=10' ) );
		onSelect.appendChild( makeOption('Magtár','build.php?gid=11' ) );
		onSelect.appendChild( makeOption('Rejtekhely','build.php?gid=23' ) );
		onSelect.appendChild( makeOption('Piac','build.php?gid=17' ) );
		onSelect.appendChild( makeOption('Malom','build.php?gid=8' ) );
		onSelect.appendChild( makeOption('Vasöntöde','build.php?gid=7' ) );
		onSelect.appendChild( makeOption('Agyagégető','build.php?gid=6' ) );
		onSelect.appendChild( makeOption('Fafeldolgozó','build.php?gid=5' ) );
		onSelect.appendChild( makeOption('Pék','build.php?gid=9' ) );
//		onSelect.appendChild( makeOption('Brewery','build.php?gid=35' ) );	
		...
		onSelect.style.width=w;
		onSelect.addEventListener('change', function(e) {jump(e);} , true);
		onSelect.appendChild( makeOption('=> Hadsereg <=','#' )      );
		onSelect.appendChild( makeOption('Városfal (Római)','build.php?gid=31' ) );
		onSelect.appendChild( makeOption('Földfal (Germán)','build.php?gid=32' ) );
		onSelect.appendChild( makeOption('Fal (Gall)','build.php?gid=33' ) );
		onSelect.appendChild( makeOption('Barrakk','build.php?gid=19' ) );
		onSelect.appendChild( makeOption('Csapdakészítő (Gall)','build.php?gid=36' ) );
		onSelect.appendChild( makeOption('Akadémia','build.php?gid=22' ) );
		onSelect.appendChild( makeOption('Páncélkovács','build.php?gid=13' ) );
		onSelect.appendChild( makeOption('Fegyverkovács','build.php?gid=12' ) );
		onSelect.appendChild( makeOption('Istálló','build.php?gid=20' ) );
		onSelect.appendChild( makeOption('Műhely','build.php?gid=21' ) );
		onSelect.appendChild( makeOption('Nagy Barrakk','build.php?gid=29' ) );
		onSelect.appendChild( makeOption('Nagy Istálló','build.php?gid=30' ) );
		onSelect.appendChild( makeOption('Hősök Háza','build.php?gid=37' ) );
		cell.appendChild(  onSelect   );
		row.appendChild( cell );
		mymenu.appendChild(row);	
		...
		onSelect.style.width=w;
		onSelect.addEventListener('change', function(e) {jump(e);} , true);
		onSelect.appendChild( makeOption('=> Infrastruktúra <=','#' )  );
		onSelect.appendChild( makeOption('Főépület','build.php?gid=15' ) );
		onSelect.appendChild( makeOption('Gyülekezőtér','build.php?gid=16' ) );
		onSelect.appendChild( makeOption('Tanácsháza','build.php?gid=24' ) );
		onSelect.appendChild( makeOption('Rezidencia','build.php?gid=25' ) );
		onSelect.appendChild( makeOption('Palota','build.php?gid=26' ) );
		onSelect.appendChild( makeOption('Követség','build.php?gid=18' ) );
		onSelect.appendChild( makeOption('Kőfaragó','build.php?gid=34' ) );
		onSelect.appendChild( makeOption('Kereskedelmi központ','build.php?gid=28' ) );
		onSelect.appendChild( makeOption('Kincseskamra (Natar)','build.php?gid=27' ) );
		onSelect.appendChild( makeOption('Gyakorlótér','build.php?gid=14' ) );
		cell.appendChild(  onSelect );
		row.appendChild( cell );
		mymenu.appendChild(row);	
