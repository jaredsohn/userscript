// ==UserScript==
// @name        Ultoo script by Sangwan[1/04/2013]
//description   No ads.. fastest among other
// @namespace  
...
if(url.search(pattern)==0)
{
	...
	{
		document.getElementsByName('PollUserName')[0].value="sms.ultoo Guest";
...
if(url.search(pattern)==0)
{
	var options="April 1;Prank Day;Stephen;delhi;Jim Thorpe;Melanie;Anubhav;23;Belgian;7 yards;teacher;Kenya;pune;italy;MAnohar;Anil;football;Heels;Dev D;Elena;Chicken;tennis;methane;Dhoom;Beckham;AP;Nabha;Lucknow;Clothes;Mizoram;Bile;1997;Salman;Mcleod;David;Sania;MP;Alia;Nice;BCCI;Sharad Pawar;Oct 4;2005;11;Ratan Tata;Kashmir;Inder Kumar;Prince;69;amitabh";
