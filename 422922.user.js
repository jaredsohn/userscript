...
(function() {
         function data(){
	var d = new Date;
	document.getElementById('datex').innerHTML=d.getHours()+" : "+d.getMinutes()+" : "+d.getSeconds();
}
...
"chars" : " :) ",
	...
	html += '<span style="vertical-align: middle;">แถบไอคอน</span>';
	html += '</a>';
	...
	html += '<div class="jewelFooter">';
       html += '<a class="jewelFooter" href="http://bis-studio.tk" target="_blank"><span style="vertical-align: middle;">โฆษณา</span></a></br>';
      html += '<span style="vertical-align: middle;"><div id="datex" style="width:200px; height:auto;"></div></iframe>';
	html += '</div>';
