// ==UserScript==
// @name           KokoskoVendetta1
// @namespace      KokoskoVendetta1
...
document.getElementsByTagName('html')[0].style.backgroundColor="#0040FF";
document.getElementById('footer').style.backgroundColor="#0040FF";

elements = document.getElementsByTagName('a');
for(i=22;i<elements.length;i++){
elements[i].style.color="#0040FF";
}
for(i=0;i<28;i++){
...
document.getElementById('navtabs').style.backgroundColor="#0040FF";

elements = getElementsByClass('newcontent_textcontrol');
for(i=0;i<elements.length;i++){
elements[i].style.background="#0040FF";
}

elements = getElementsByClass('posthead');
for(i=0;i<elements.length;i++){
elements[i].style.background="#0040FF";
elements[i].style.border="1px solid #0040FF";
}
