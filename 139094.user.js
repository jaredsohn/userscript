// ==UserScript==
// @name			(っ◕‿◕)っ Grinbook (っ◕‿◕)っ - FB Classic Edition
// @description			Una barra de acceso rápido a los emoticones clásicos del facebook - made by @starg09
...
// :) :( :D >:( -_- :/ o.O :p :'( >:O :v 3:) :o :3 ;) :* :|] 8) <3 (Y) :putnam: 8| ^_^ (^^^) O:) <(") :42: 
	...
	var version, HttpsOn, ImagesURL, TarimgURL, ResourcesURL, storage, emotsInfo, spemotsInfo, headTag, styleTag, ArrowStyleUp, ArrowStyleDown, fEmotBarDom, fEmotsListDom, fArrow;
