// ==UserScript==
// @name			Ikariam Visual Map
// @namespace		userscripts.org
// @homepage		http://userscripts.org/scripts/show/90744
// @description		Search for players, alliances or cities using the built-in Ika Core search engine. Filter by player status, distance, luxury resource, townhall size or military score. Display the results on Ikariam world map. Export the results in CSV format to be used in spreadsheet applications.
// @version			1.1.2
...
function updatePreview(item) {
	...
	// Heading
	previewContainer.appendChild(visualMapHeading('Preview - ' + item.getPreviewHeading()));
...
function createSearchContainer(parent) {
	...
	// Heading
	result.appendChild(visualMapHeading('Search'));
	...
	playerDiv.appendChild(visualMapCaption('Player'));
	...
	cityDiv.appendChild(visualMapCaption('City'));
	...
	distanceSelect.appendChild(new Option('Any',0));
	for(i=1; i < 100; i++ ) {
	...
	townHallLevelDiv.appendChild(visualMapCaption('Townhall size'));
	...
	militaryScoreDiv.appendChild(visualMapCaption('Military score'));
	...
	*/
	...
	result.appendChild(visualMapLabel('Highlight: Inactive'));
	...
	result.appendChild(visualMapLabel('Vacation'));
...
function createMapContainer(parent) {
	...
	parent.appendChild(result);
	// Heading
	var heading = visualMapHeading('Ikariam Visual Map ' + version + ' - Powered By Ika Core');
