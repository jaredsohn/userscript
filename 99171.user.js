// ==UserScript==
// @name           Tinted Apple
// @namespace      http://userscripts.org/users/36696
// @include        *
// ==/UserScript==
...
function tinted_sheen_start($_) {
  ...
  (function($_) {
    ...
    $_.extend($_.tinted_sheen, {
      settings : {hide_bg : true, href : false, page_height : 0, search: /((\#a|A)pple|(i[pP]hone|i[pP]ad|i[pP]od|[mM]ac[bB]ook|i[tT]unes|[mM]acintosh|iOS|Apple\s[sS]tore)|[mM]ac\s[pP]ro|[sS]teve(\s|\_|\-)[jJ]obs|Safari)/mg, replace: '<span class="tinted_sheen" style="color: %C; background-color: %C;">$1$2$3</span>', starred: '****** ******', init : false, finish : false},

      pluck : function(str) {return str.replace(/(apple\sstore)/img, '****** ******').replace(/(iphone)/img, '******');},
