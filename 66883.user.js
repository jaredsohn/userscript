// ==UserScript==
// @name			MadChecker
// @namespace		http://userscripts.org/scripts/show/66882
// @include 		http://*
...
// @exclude			http://*filedropper.com/*

// ==/UserScript==
// version                     1.1 21 January 2010
...
hosts.push (["filedropper.com",
             /http:\/\/www\.filedropper\.com/gi,
             /File Details:/gi,
             ""
             ]);
...
hosts.push (["endlessapps.net",
			/ENDLESSAPPS\.NET\/DOWNLOAD/gi,
			/The file exists, proceed with your download\./gi,
			/The file doesn\'t exist\. There will be a problem\./gi
			]);
