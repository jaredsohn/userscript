...
// @require       http://sizzlemctwizzle.com/updater.php?id=98858
// ==/UserScript==

var Version = '03.3PDX';
var Versiondate = '02.04.2011';
  ...
  init : function (div){
    ...
    try {      
      m = '<DIV style="height:550px; max-height:550px; overflow-y:auto"><TABLE width=auto class=pcTabLined cellspacing=0 cellpadding=0>\
        <TR><TD colspan=2><B>Watchtower - Settings</b></td></tr>\
        <TR><TD><INPUT id=pcalertEnable type=checkbox '+ (Options.alertConfig.aChat?'CHECKED ':'') +'/></td><TD>Automatically post alerts in alliance chat.</td></tr>\
	          <TR><TD></td><TD><TABLE cellpadding=0 cellspacing=0>\
	              ...
	              <TR><TD align=right>Scout: &nbsp; </td><TD><INPUT id=pcalertScout type=checkbox '+ (Options.alertConfig.scouting?'CHECKED ':'') +'/></td></tr>\
	              <TR><TD align=right>Wild: &nbsp; </td><TD><INPUT id=pcalertWild type=checkbox '+ (Options.alertConfig.wilds?'CHECKED ':'') +'/></td></tr>\
	              <TR><TD align=right>View troop strength: &nbsp; </td><TD><INPUT id=pcalertTroops type=text size=7 value="'+ Options.alertConfig.minTroops +'" \> &nbsp; &nbsp; <span id=pcalerterr></span></td></tr>\
	              <TR><TD align=right>View troops in embassy: &nbsp; </td><TD><INPUT id=pcalertEmbassy type=checkbox '+ (Options.alertConfig.embassy?'CHECKED ':'') +'/></td></tr>\
	              <TR><TD align=right>View own troops: &nbsp; </td><TD><INPUT id=pcalertMytroops type=checkbox '+ (Options.alertConfig.mytroops?'CHECKED ':'') +'/></td></tr>\
	              <TR><TD align=right>View food consumption: &nbsp; </td><TD><INPUT id=pcalertFood type=checkbox '+ (Options.alertConfig.food?'CHECKED ':'') +' /></td></tr>\
	              <TR><TD align=right>View defenses: &nbsp; </td><TD><INPUT id=pcalertDefense type=checkbox '+ (Options.alertConfig.defense?'CHECKED ':'') +' /></td></tr>\
	              <TR><TD align=right>View city: &nbsp; </td><TD>'+ citySelect +'&nbsp; &nbsp;</td></tr>\
	              <TR><TD align=right>Post messages in alliance chat: &nbsp; </td><TD><INPUT id=pcalertSendToAlly type=checkbox '+ (Options.alertConfig.sendtoAlly?'CHECKED ':'') +' /></td></tr>\
				  <TR><TD align=right>Send as whisper; </td><TD><INPUT id=pcalertSendAsWhisper type=checkbox '+ (Options.alertConfig.sendasWhisper?'CHECKED ':'') +' /></td></tr>\
				  <TR><TD align=right>E-Mail attack to: &nbsp; </td><TD><INPUT id=pcalertSendEmail type=checkbox '+ (Options.alertConfig.sendEmail?'CHECKED ':'') +' /></td></tr>\
		          <TR><TD align=right>E-Mail Address: &nbsp; </td><TD><INPUT id=pcalertEmailAddress type=text size=36 value="'+ Options.alertConfig.emailAddress +'" \> &nbsp; &nbsp;</td></tr>\
				  <TR><TD align=right>My Token: &nbsp; </td><TD><INPUT id=pcalertToken type=text size=36 value="'+ Options.alertConfig.token +'" \> &nbsp; &nbsp;</td></tr>\
	              </table></td></tr>\
        </table><BR><BR><HR>Note: If a box is not clickable Koc has once again made ​​an update!<BR><font color=#FF0000><u>WICHTIG</u></font>: This tab of the areas you need this tool works (<a href="http://userscripts.org/scripts/show/96308" target="_blank">KOCtools: The Script</a>) Instalation and run<BR>(Do it but for as long as you are not the Users tab areas!)<HR>KoC - Allianz Extras - Update: <a href="http://userscripts.org/scripts/show/98788" target="_blank">KoC Allianz - Extras</a> - Version: '+ Version +'</div>';
      div.innerHTML = m;
...
Tabs.board = {
  ...
  myDiv : null,
  timer : null,
  forumlink :  'http://www.fatradish.com/index.php/tools/scripts/read-first',  
  
  init : function (div){    // called once, upon script startup
    var t = Tabs.board;
    t.myDiv = div;
    div.innerHTML = '<CENTER><iframe src="'+ t.forumlink +'" width="100%" height="500" name="board_in_a_box" <p>Your browser does not support frames, you can call the embedded page with this link: <a href="'+ t.forumlink +'">KoC Allianz - Extras</a></p> </iframe> <BR></center>';
  },
...
Tabs.teamspeak = {
  ...
  tabLabel : 'Skype',            // label to show in main window tabs
  myDiv : null,
  timer : null,
  forumlink :  'http://www.skype.com/intl/en-us/home',  
  
  init : function (div){    // called once, upon script startup
    var t = Tabs.teamspeak;
    t.myDiv = div;
    div.innerHTML = '<CENTER><iframe allowtransparency="true" src="'+ t.forumlink +'" width="100%" height="500" name="board_in_a_box" <p>Your browser does not support frames, you can call the embedded page with this link: <a href="'+ t.forumlink +'">god-like.org - Teamspeak Server</a></p> </iframe> <BR></center>';
  },
...
Tabs.map = {
  ...
  init : function (div){    // called once, upon script startup
    var t = Tabs.map;
    t.myDiv = div;
    div.innerHTML = '<CENTER><iframe src="'+ t.forumlink +'" width="100%" height="500" name="board_in_a_box" <p>Your browser does not support frames, you can call the embedded page with this link: <a href="'+ t.forumlink +'">KoC Server Gebiete</a></p> </iframe> <BR></center>';
  },
...
Tabs.script = {
  ...
  myDiv : null,
  timer : null,
  forumlink :  'http://userscripts.org/users/258971',  
  
  init : function (div){    // called once, upon script startup
    var t = Tabs.script;
    t.myDiv = div;
    div.innerHTML = '<CENTER><iframe src="'+ t.forumlink +'" width="100%" height="500" name="board_in_a_box" <p>Your browser does not support frames, you can call the embedded page with this link: <a href="'+ t.forumlink +'">My Userscripts.org</a></p> </iframe> <BR></center>';
  },
...
Tabs.rechner = {
  ...
  tabLabel : 'Calculator',            // label to show in main window tabs
  myDiv : null,
  timer : null,
  forumlink :  'http://greenman.webhop.org/html/troopspeed.html',  
  
  init : function (div){    // called once, upon script startup
    var t = Tabs.rechner;
    t.myDiv = div;
    div.innerHTML = '<CENTER><iframe src="'+ t.forumlink +'" width="100%" height="500" name="board_in_a_box" <p>Your browser does not support frames, you can call the embedded page with this link: <a href="'+ t.forumlink +'">Truppen Rechner</a></p> </iframe> <BR></center>';
  },
...
Tabs.wikia = {
  ...
  myDiv : null,
  timer : null,
  forumlink :  'http://www.koc.wikia.com',  
  
  init : function (div){    // called once, upon script startup
    var t = Tabs.wikia;
    t.myDiv = div;
    div.innerHTML = '<CENTER><iframe src="'+ t.forumlink +'" width="100%" height="500" name="board_in_a_box" <p>Your browser does not support frames, you can call the embedded page with this link: <a href="'+ t.forumlink +'">Kingdom of Camelot - Wiki - English</a></p> </iframe> <BR></center>';
  },
...
Tabs.extChat = {
  ...
  init : function (div){    // called once, upon script startup
    var t = Tabs.extChat;
    t.myDiv = div;
    div.innerHTML = '<CENTER><iframe src="'+ t.chatlink +'" width="100%" height="500" name="board_in_a_box" <p>Your browser does not support frames, you can call the embedded page with this link: <a href="'+ t.chatlink +'">Allianz Chat</a></p> </iframe> <BR></center>';
  },
...
var TowerAlerts = {
  ...
  e_eachSecond : function (){   // check for incoming marches
	...
	postToChat: function(m, force){
		...
		msg += 'Mein Bunker: ' + postOptions.hq + ' = ';
