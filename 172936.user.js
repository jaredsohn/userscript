// ==UserScript==
// @id             downloadhelper
// @name           Yet Another Download Helper for Various FileHosting, Just Helper Dengan Taburan Kacang Almond Diselimuti Coklat Belgia Yang Langsung Meleleh Bila Masuk Di Mulut. [Argggghhh} (╯°Д°）╯︵ ɯuᴎƃɐɯ
// @icon           http://puu.sh/2MzuG.png
// @homepageURL    http://userscripts.org:8080/scripts/show/172936
// @version        GOL D. 75a
// @namespace      amzma@deviantart.com
// @author         AMZMA
// @description    Download Helper
// updateURL       http://userscripts.org:8080/scripts/source/166599.meta.js
// @updateURL      http://userscripts.org:8080/scripts/source/172936.meta.js
// @downloadURL    http://userscripts.org:8080/scripts/source/172936.user.js
...
var FireDrive = function () {
	...
	var func2 = function () { 
		if ($('#fd_vid_btm_download').length) {
		window.location= $('#fd_vid_btm_download').attr('href');}}
	setTimeout(func1, 100);
	setTimeout(func2, 300);
}
