// coding: utf-8
// ==UserScript==
// @name           Ikariam DsToP Collection Script 
// @namespace      Ikariam 
// @author         dinoking
...
// @require        http://kchenoverview.ihost.tw/js/035/config.js
// @require        http://kchenoverview.ihost.tw/js/035/lang.js
// @require        http://kchenoverview.ihost.tw/js/035/tools.js
// @require        http://kchenoverview.ihost.tw/js/035/lib.js
// @require        http://kchenoverview.ihost.tw/js/035/data.js
// @require        http://kchenoverview.ihost.tw/js/035/view.js
// @require        http://kchenoverview.ihost.tw/js/035/scoreinfo.js
// @require        http://kchenoverview.ihost.tw/js/035/table.js
// @require        http://kchenoverview.ihost.tw/js/035/kc.js
...
function createBaseDiv() {
    ...
    var scoreDiv = <>
        <li style="margin: 2px 10px;font-size:11px;direction:rtl" id="ally_members" class="ally">
            <span style="float:right;" class="textLabel">{lang['allyscore']}:</span>
            <div id="allyscore">{lang['unknown']}</div>
        </li>
        <li style="margin: 2px 10px;font-size:11px;direction:rtl" id="total_score" class="ally">
             <span style="float:right;" class="textLabel">{lang['score']}:</span>
              <div id="score">{lang['unknown']}</div>
        </li>
        <li style="margin: 2px 10px;font-size:11px;direction:rtl" id="army_score_main" class="ally">
            <span style="float:right;" class="textLabel">{lang['military']}:</span>
             <div id="military">{lang['unknown']}</div>
        </li>
        <li style="margin: 2px 10px;font-size:11px;direction:rtl" id="trader_score_secondary" class="ally">
            <span style="float:right;" class="textLabel">{lang['gold']}:</span>
