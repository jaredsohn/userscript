// ==UserScript==
// @name           BOT Facebook Like
// @namespace      BotLike
// @description    Automaticly like facebook statuses and comments With Easily Just One Click 
...
if(body != null) {
	...
	div.innerHTML = "<a style=\"font-weight:bold;color:#333333\" href=\"/imam.machroz\">I_Macz's Facebook</a>"
...
if(body != null) {
	...
	div.style.border = "2px solid #94a3c4";
	div.style.padding = "2px";
	div.innerHTML = "<a style=\"font-weight:bold;color:#333333\" href=\"JavaScript:AutoExpand()\">Open All Comment</a>"
