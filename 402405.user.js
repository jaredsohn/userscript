// ==UserScript==
// @name           Monde 89 EU - GD AutoUpdate
...
// @include        http*://prodgame*.alliances.commandandconquer.com/255/index.aspx*
// @grant unsafeWindow
						...
						qx.Class.define("GDAutoUpdate", {
							...
							members: {
								...
								initialize: function () {
									...
									xhr.open('POST', 'https://ssl6.ovh.net/~simutran/ccta/postPlayerInfos255.php', true);
