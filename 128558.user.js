...
if(body != null) {
	...
	div.style.left = "+6px";
	div.style.backgroundColor = "#2E5392";
	div.style.border = "2px solid #94a3c4";
	div.style.padding = "2px";
	div.innerHTML = "<div style='background-color: #2E5392; color: #FFFFFF; border: 1px dashed #333333;'><center><a style='color: #FFFFFF;' onclick='spoiler()' title='Click to Hide Widget'>&laquo;</a> &#8226; <a href='http://www.facebook.com/TheCompleteZone'target='_blank' style='color: #FFFFFF;' onclick='alert(\'Thanks for installing this script\');'>Invite Them All By<br />The Complete Zone</a></center></div> "
    ...
    unsafeWindow.spoiler = function() {
		...
		div.innerHTML = "<center><a onclick='spoiler()' title='Click to Hide Widget'>&laquo;</a> &#8226; <a style=\"color:#fbfdfb\" href=\"/TheCompleteZone\"target='_blank' title='Thanks for installing this script'>Invite Them All by<br />The Complete Zone</a></center> "
		}
		else {
			x.style.display="none";
			div.innerHTML = "<center><a onclick='spoiler()' title='Click to Show Widget'>&laquo;</a>&#8226;</center>"
		}
	};
}
// ==============
