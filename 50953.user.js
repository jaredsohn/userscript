...
if (newchlgstatus=="Filled") anchor.innerHTML='<img src="http://www.flickr.com/images/Filled.png" width="52" height="26" >';
if (newchlgstatus=="Finished") anchor.innerHTML='<img src="http://www.flickr.com/images/Finished.png" width="52" height="26">';
if (newchlgstatus=="--VOTE--") anchor.innerHTML='<img src="http://www.flickr.com/images/Vote.png" width="52" height="26">';  
if (newchlgstatus=="VOTE") anchor.innerHTML='<img src="http://www.flickr.com/images/Vote.png" width="52" height="26">'; 
if (newchlgstatus=="Voted") anchor.innerHTML='<img src="http://www.flickr.com/images/OK.png" width="71" height="26">'; 
if (newchlgstatus=="OPEN") anchor.innerHTML='<img src=http://www.flickr.com/images/Open.png" width="52" height="26">'; 
...
if (newchlgstatus=="Player") anchor.innerHTML='<img src="http://www.flickr.com/images/Player.png" width="71" height="26" border=0>';
if (newchlgstatus=="CLOSED") anchor.innerHTML='<img src="http://www.flickr.com/images/Finished.png" width="52" height="26" border=0>';
 ...
 */            }
		   ...
		   if (chlgname.match("VOTE")== "VOTE" )
             ...
             //if (!Icon Group Game)
               //{
               if ((photosposted==3)&&((chlgnum!='Icon Group Game'))&&(lastvote.match('7')=="7")) 
		   ...
		   if ((newchlgstatus=="none")&&(photosposted==10)&&(chlgnum=='Icon Group Game')&&(chlgname.match("OPEN") == "OPEN" )) newchlgstatus="Filled";
