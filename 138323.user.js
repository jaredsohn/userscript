...
function findLegendary() {
        var wildText = unsafeWindow.document.querySelector('#pkmnappearsigma');
        if (!wildText) {
                moveAround();
                return;
        }
...
function autoBattle() {
        try {
                var btnContinue = unsafeWindow.document.querySelector('[type="submit"][value="Continue"]');
                if (btnContinue) {
                        btnContinue.click();
                }
               
                var btnContinue2 = unsafeWindow.document.querySelector('[type="submit"][value="Continue!"]');
                if (btnContinue2) {
                        btnContinue2.click();
                }
       
                var btnAttack = unsafeWindow.document.querySelector('[type="submit"][value="Attack!"]');
                if (btnAttack) {
                        btnAttack.click();
                }
