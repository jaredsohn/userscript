// ==UserScript==
// @name           Punkteverlauf Rangliste
// @namespace      sdgsdgserg
// @include        http://*.die-staemme.de/game.php?*screen=ranking*
// @exclude http://*.die-staemme.de/game.php?*screen=ranking*mode=*ally*
// ==/UserScript==
...
while(i<document.getElementsByClassName("vis")[1].getElementsByTagName("tr").length)
{
 ...
 if(user1 != -1)
 {
  document.getElementsByClassName("vis")[1].getElementsByTagName("tr")[i].innerHTML += '<td><input onclick="javascript:document.getElementById(\'grafik'+i+'\').src=\'http://de.twstats.com/image.php?type=playergraph&graph=points&id='+RegExp.$1+'&s=de'+link+'\';document.getElementById(\'grafik'+i+'\').style.display=\'\';" value="Zeigen" type="button"><input onclick="javascript:document.getElementById(\'grafik'+i+'\').style.display=\'none\';" value="Verstecken" type="button"><br><a href="http://de.twstats.com/de'+link+'/index.php?page=player&id='+RegExp.$1+'"><img src="" id="grafik'+i+'" style="display:none;" alt="Bild wird geladen - Bitte warten" border=0></a></td>';
 }
graphen += "document.getElementById('grafik"+i+"').src=\'http://de.twstats.com/image.php?type=playergraph&graph=points&id="+RegExp.$1+"&s=de"+link+"';document.getElementById('grafik"+i+"').style.display='';";
