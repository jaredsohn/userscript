...
// @description    Evanghelion's script
// @version        0.1
...
// ЗС 9000
	...
	try {
        ...
        if (document.location.href.indexOf('page=fleet1') > -1) 
        {
            ...
            var tit01='|'+name203+' : 100<br />'+name211+' : 100<br />'+name210+' : 100<br />'+name213+' : 0';
            ...
            expofleet.innerHTML =   '<table><tr>'+
                                    ...
                                    '<td><BUTTON TYPE="SUBMIT" ONCLICK="alert(0); return false;"  id="efbut0"  style="position: relative; left: 24px; top: 2px" class="tipsStandard" title="'+tit01+'"> 100/100/100/0</BUTTON></td>'+
            ...
            expscript.innerHTML = '\n'+
                "document.getElementById('efbut0').onclick=function(){\n"+
                    "document.getElementById('ship_210').value = 100;\n"+
                    ...
                    "document.getElementById('ship_211').value = 100;\n"+
                    "document.getElementById('ship_211').onchange();\n"+
                    "document.getElementById('ship_203').value = 100;\n"+
