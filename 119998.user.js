// ==UserScript==
// @name           Image Inliner / Imagehost Redirector [modded] 2
...
addImageHoster({
  "type": "resolver",
  "prefix": "bildr.no",
  "match": "^http://(www\\.)?bildr\\.no/view",
  "finder": "<img src=\"(.+?)\".+?class=\"bilde\"",
  "builder": "{1}"
});

addImageHoster({
  "type": "resolver",
  "prefix": "dumparump.com",
  "match": "^http://(www\\.)?dumparump\\.com/view\\.php",
  "finder": "href=\"random.php\"><img src=\"(.+?)\"",
  "builder": "{1}"
});
...
addImageHoster({
  "type": "resolver",
  "prefix": "upix.me",
  "match": "^http://(www\\.)?upix\\.me/files/.+?/$",
  "finder": "class=\"thumb\".+?href=\"(.+?)\".*?title=\"(.+?)\"",
  "builder": "{1}",
  "namer": "{2}"
});
...
addImageHoster({
  "type": "resolver",
  "prefix": "x05.org",
  "match": "^http://(www\\.)?x05\\.org/show",
  "finder": "<img src=\"(.+)?\"\\s+alt=\"(.+?)\"\\s+id=img_obj",
  "builder": "{1}",
  "namer": "{2}"
});
...
addImageHoster({
  "type": "resolver",
   "prefix": "4pics.org",
   "match": "^http://(www\\.)?4pics\\.org/view\\.php",
   "finder": "src=\"(.+?upload_image.+?)\"",
   "builder": "{1}"
});
...
addImageHoster({
	"type": "resolver",
	"prefix": "imgchili.com",
	"match": "^http://(?:[\\\\w\\\\d]+\\\\.)?imgchili\\.com/show/\\d+/",
	"static": true,
	"finder": "id=\"show_image\".*?src=\"(.+?)\"",
	"builder": "{1}",
	"gone": "Please ensure the filename is spelled correctly"
});
