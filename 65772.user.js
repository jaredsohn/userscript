// ==UserScript==
// @name        HS translator (Japanese)
// @namespace   http://hootsuite.com
// @description Adds the ability to translate tweets in HootSuite. Click on a tweet to translate it to English.
