...
// @description   Wandelt ISBNs in Links auf den Katalog der TIB/UB bzw. weiterer ausgewählter Bibliotheken um und ermittelt, ob die Bücher in der Bibliothek vorhanden sind.
// @grant    GM_getValue
// @grant    GM_setValue
...
/*
Compiled by Bernhard Tempel (bernhard.tempel@freenet.de).
...
var SUC_script_num = 105027; // Change this to the number given to the script by userscripts.org (check the address bar)
...
try
{
	...
	GM_registerMenuCommand(GM_getValue('SUC_target_script_name', 'Autolink TIB/UB') + ' - Manuelle Prüfung auf Update', function()
	{
		updateCheck(true);
	});
	updateCheck(false);
...
if (GM_getValue("libraryName") == undefined){GM_setValue("libraryName", "TIB/UB")};
