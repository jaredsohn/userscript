...
// ==/UserScript==
var VERSION      = '1.3.7d';
versions['Feuerwache.net Minheim\'s AAO'] = VERSION;
/* ******************************************************************************************
ACHTUNG
...
WENN DU DIESEN ABSCHNITT NICHT 100% VERSTANDEN UND BEFOLGT HAST, STELLE DAS GEÄNDERTE SCRIPT NICHT ONLINE!
   ******************************************************************************************/
var USERSCRIPTID = '151598'; // diese Konstante ist anzupassen
...
/*
  ...
  Syntax in der Alarmierungsliste:
    ...
    zum Beispiel 'AB1+RW/TS,ELW|GW-M,DLK' ->
        alarmiere alles nach AB1, zusätzlich einen RW oder LF16-TS, sowie einen ELW.
        markiere zusätzlich den nächsten GWM sowie die nächste DLK
*/
  'Brand in Altpapier-Lager'       : {mld: 'NMB6+TLF,GWL'             , storm: false, ab: {FW: 75}, wiki: 'Brand_in_Altpapier-Lager'},
  'Brand in Müll-Sortieranlage'    : {mld: 'NMG3+GWA,RW,GWL'          , storm: false, ab: {FW: 75}, wiki: 'Brand_in_M%C3%BCll-Sortieranlage'},
  'Kehrmaschine in Müllbunker'     : {mld: 'NMT2+DLK'                 , storm: false, ab: {FW: 75}, wiki: 'Kehrmaschine_in_M%C3%BCllbunker'},
  'Brand in Müll-Bunker'           : {mld: 'NMB5+DLK,GWG,GWM,GWL'     , storm: false, ab: {FW: 75}, wiki: 'Brand_in_M%C3%BCll-Bunker'},
  'Ölspur'                         : {mld: 'AT1+GWÖl'                 , storm: false, ab: {FW:  5}, wiki: '%C3%96lspur'},
  'Ammoniakaustritt in Eishalle'   : {mld: 'AG3+GWA'                  , storm: false, ab: {BF:  5}, wiki: 'Ammoniakaustritt_in_Eishalle'},
  'Auffahrunfall'                  : {mld: 'AT1'                      , storm: false, ab: {FW:  4}, wiki: 'Auffahrunfall'},
  'Ausgedehnter Waldbrand'         : {mld: 'AB5+GWL'                  , storm: false, ab: {FW: 20}, wiki: 'Ausgedehnter_Waldbrand'},
  'Auslaufende Betriebsstoffe'     : {mld: 'AT1+GWÖl'                 , storm: false, ab: {FW:  4}, wiki: 'Auslaufende_Betriebsstoffe'},
  'Baggerbrand'                    : {mld: 'AB1'                      , storm: false, ab: {FW: 30}, wiki: 'Baggerbrand'},
  'Baukran auf Auto'               : {mld: 'AT3+FwK'                  , storm: false, ab: {FW: 15}, wiki: 'Baukran_auf_Auto '},
  'Baum auf Auto'                  : {mld: 'AT2+GWÖl'                 , storm: true,  ab: {FW:  9}, wiki: 'Baum_auf_Auto'},
  'Baum auf Dach'                  : {mld: 'AT2+DLK'                  , storm: true,  ab: {FW:  8}, wiki: 'Baum_auf_Dach'},
  'Baum auf Schiene'               : {mld: 'NBT2'                     , storm: true,  ab: {FW: 65}, wiki: 'Baum_auf_Schiene'},
  'Baum auf Straße'                : {mld: 'AT1'                      , storm: true,  ab: {FW:  1}, wiki: 'Baum_auf_Stra%C3%9Fe'},
  'Brand am Bahndamm'              : {mld: 'NBB2'                     , storm: false, ab: {FW: 65}, wiki: 'Brand_am_Bahndamm'},
  'Brand auf Weihnachtsmarkt'      : {mld: 'AB1'                      , storm: false, ab: {FW:  3}, wiki: 'Brand_auf_Weihnachtsmarkt'},
  'Brand im Baumarkt'              : {mld: 'AB3+GWA,RW,GWG,GWM'       , storm: false, ab: {BF: 20}, wiki: 'Brand_im_Baumarkt'},
  'Brand im Casino'                : {mld: 'AB8+DLK,TLF,GWA,GWL'      , storm: false, ab: {FW: 50}, wiki: 'Brand_in_Casino'},
  'Brand im Sägewerk'              : {mld: 'AB4+GWA,GWL'              , storm: false, ab: {FW: 40}, wiki: 'Brand_im_S%C3%A4gewerk'},
  'Brand im Supermarkt'            : {mld: 'AB3+DLK,FwK'              , storm: false, ab: {FW:  4}, wiki: 'Brand_im_Supermarkt'},
  'Brand in Autohaus'              : {mld: 'AB4+DLK,GWA,GWM'          , storm: false, ab: {FW: 10}, wiki: 'Brand_in_Autohaus'},
  'Brand in Betankungsanlage'      : {mld: 'NRB5+GWA,RW,GWL,GWG,GWM'  , storm: false, ab: {FW: 64}, wiki: 'Brand_in_Betankungsanlage'},
  'Brand in Brauerei'              : {mld: 'AB3+DLK,GWA,GWL'          , storm: false, ab: {FW: 11}, wiki: 'Brand_in_Brauerei'},
  'Brand in Briefkasten'           : {mld: 'AB1'                      , storm: false, ab: {FW:  1}, wiki: 'Brand_in_Briefkasten'},
  'Brand in Druckerei'             : {mld: 'AB4+DLK,GWA,GWL,RW'       , storm: false, ab: {BF: 20}, wiki: 'Brand_in_Druckerei'},
  'Brand in Eishalle'              : {mld: 'AB3+DLK,RW,TLF,GWL'       , storm: false, ab: {FW:  5}, wiki: 'Brand_in_Eishalle'},
  'Brand in Fahrkartenautomat'     : {mld: 'NBB1|HLFS'                , storm: false, ab: {FW: 65}, wiki: 'Brand_in_Fahrkartenautomat'},
  'Brand in Gärtnerei'             : {mld: 'AB3+DLK,GWG,GWM'          , storm: false, ab: {FW:  8}, wiki: 'Brand_in_G%C3%A4rtnerei'},
  'Brand in Gemeindehaus'          : {mld: 'AB2'                      , storm: false, ab: {FW:  3}, wiki: 'Brand_in_Gemeindehaus'},
  'Brand in Großwäscherei'         : {mld: 'AB4+DLK,GWA,GWM'          , storm: false, ab: {FW: 13}, wiki: 'Brand_in_Großw%C3%A4scherei'},
  'Brand in Industriepark'         : {mld: 'VGSL'                     , storm: false, ab: {MG:  3}, wiki: 'Brand_in_Industriepark'}, //Verbandsgroßschadenslage
  'Brand in Kühlhaus'              : {mld: 'AB5+GWG,GWM,DLK,RW,GWL'   , storm: false, ab: {FW: 20}, wiki: 'Brand_in_K%C3%BChlhaus'},
  'Brand in KFZ-Werkstatt'         : {mld: 'AB2+FwK'                  , storm: false, ab: {FW: 15}, wiki: 'Brand_in_KFZ-Werkstatt'},
  'Brand in Kletterhalle'          : {mld: 'AB4+DLK,GWL'              , storm: false, ab: {BF: 45}, wiki: 'Brand_in_Kletterhalle'},
  'Brand in Lackfabrik'            : {mld: 'AB6+DLK,GWG,GWM,TLF,GWL,GWA' , storm: false, ab: {FW: 25}, wiki: 'Brand_in_Lackfabrik'},
  'Brand in Metzgerei'             : {mld: 'AB3+DLK,GWL'              , storm: false, ab: {BF:  2}, wiki: 'Brand_in_Metzgerei'},
  'Brand in Raffinerie'            : {mld: 'NRB5+DLK,FwK,TUIS,RW,GWL,GWG,GWM' , storm: false, ab: {FW: 64}, wiki: 'Brand_in_Raffinerie'},
  'Brand in Reifenlager'           : {mld: 'AB3+GWG,GWM,GWL'          , storm: false, ab: {FW: 20}, wiki: 'Brand_in_Reifenlager'},
  'Brand in Schloss'               : {mld: 'AB3+DLK'                  , storm: false, ab: {FW: 20}, wiki: 'Brand_in_Schloss'},
  'Brand in Schule'                : {mld: 'AB4+GWA,DLK'              , storm: false, ab: {FW:  5}, wiki: 'Brand_in_Schule'},
  'Brand in Spedition'             : {mld: 'AB4+TLF,DLK,GWG,GWM,GWL|TUIS' , storm: false, ab: {FW:  5}, wiki: 'Brand_in_Spedition'},
  'Brand in Sporthalle'            : {mld: 'AB4+GWA,GWL'              , storm: false, ab: {FW: 40}, wiki: 'Brand_in_Sporthalle'},
  'Brand in Steinbruch'            : {mld: 'VGSL'                     , storm: false, ab: {MG:  3}, wiki: 'Brand_in_Steinbruch'}, //Verbandsgroßschadenslage
  'Brand in Zugdepot'              : {mld: 'AB4+DLK,RW,GWL,GWS'       , storm: false, ab: {FW: 10}, wiki: 'Brand_in_Zugdepot'},
  'Brand nach Schweißarbeiten'     : {mld: 'AB3+DLK'                  , storm: false, ab: {FW: 30}, wiki: 'Brand_nach_Schweißarbeiten'},
  'Brand-Weihnachtsbaum in Kirche' : {mld: 'AB2+DLK'                  , storm: false, ab: {FW:  6}, wiki: 'Brand-Weihnachtsbaum_in_Kirche'},
  'Brennende Bäume'                : {mld: 'AB2'                      , storm: false, ab: {FW:  2}, wiki: 'Brennende_B%C3%A4ume'},
  'Brennende Lokomotive'           : {mld: 'NBB3+GWL'                 , storm: false, ab: {FW: 65}, wiki: 'Brennende_Lokomotive'},
  'Brennende S-Bahn'               : {mld: 'AB2+GWS'                  , storm: false, ab: {FW: 20}, wiki: 'Brennende_S-Bahn'},
  'Brennende Telefonzelle'         : {mld: 'AB1'                      , storm: false, ab: {FW:  1}, wiki: 'Brennende_Telefonzelle'},
  'Brennende Windmühle'            : {mld: 'AB3+DLK'                  , storm: false, ab: {FW:  4}, wiki: 'Brennende_Windm%C3%BChle'},
  'Brennender Güterzug (Bahnhof)'  : {mld: 'NBB4+GWG,GWM,TLF,TUIS'    , storm: false, ab: {FW: 65}, wiki: 'Brennender_G%C3%BCterzug_(Bahnhof)'},
  'Brennender Güterzug (Tunnel)'   : {mld: 'NTB4+GWG,GWM,GWL,TUIS'    , storm: false, ab: {FW: 65}, wiki: 'Brennender_Güterzug_(Tunnel)'},
  'Brennender Güterzug'            : {mld: 'NBB4+GWG,GWM,GWL,TUIS'    , storm: false, ab: {FW: 65}, wiki: 'Brennender_G%C3%BCterzug'      },
  'Brennender LKW'                 : {mld: 'AB2+ELW'                  , storm: false, ab: {FW:  1}, wiki: 'Brennender_LKW'},
  'Brennender Müllwagen'           : {mld: 'AB1'                      , storm: false, ab: {FW:  1}, wiki: 'Brennender_M%C3%BCllwagen'},
  'Brennender Muldenkipper'        : {mld: 'NEB2+RW,GWL'              , storm: false, ab: {FW: 70}, wiki: 'Brennender_Muldenkipper'},
  'Brennender PKW'                 : {mld: 'AB1'                      , storm: false, ab: {FW:  1}, wiki: 'Brennender_PKW'},
  'Brennender Personenbus'         : {mld: 'NEB2+RW'                  , storm: false, ab: {FW: 70}, wiki: 'Brennender_Personenbus'},
  'Brennender Sicherungskasten'    : {mld: 'AB1'                      , storm: false, ab: {FW:  1}, wiki: 'Brennender_Sicherungskasten'},
  'Brennender Wohncontainer'       : {mld: 'AB1'                      , storm: false, ab: {FW: 70}, wiki: 'Brennender_Wohncontainer'},
  'Brennendes Bus-Häuschen'        : {mld: 'AB1'                      , storm: false, ab: {FW:  3}, wiki: 'Brennendes Bus-H%C3%A4uschen'},
  'Brennendes Förderband'          : {mld: 'NEB1'                     , storm: false, ab: {FW:  5}, wiki: 'Brennendes_F%C3%B6rderband'},
  'Brennendes Flugzeug'            : {mld: 'NFB6'                     , storm: false, ab: {BF: 59}, wiki: 'Brennendes_Flugzeug'},
  'Brennendes Gebüsch'             : {mld: 'AB1'                      , storm: false, ab: {FW:  1}, wiki: 'Brennendes_Geb%C3%BCsch'},
  'Brennendes Gras'                : {mld: 'AB1'                      , storm: false, ab: {FW:  1}, wiki: 'Brennendes_Gras'},
  'Brennt Anhänger'                : {mld: 'AB1'                      , storm: false, ab: {FW:  1}, wiki: 'Brennt_Anh%C3%A4nger'},
  'Brennt Tanklager'               : {mld: 'NRB5+DLK,GWÖl,FwK,TUIS,RW,GWL,GWG,GWM', storm: false, ab: {FW: 64}, wiki: 'Brennt_Tanklager'},
  'Chemieunfall (an Schule)'       : {mld: 'AG2'                      , storm: false, ab: {BF:  2}, wiki: 'Chemieunfall_(an_Schule)'},
  'Chlorgas Alarm (Schwimmbad)'    : {mld: 'AG3'                      , storm: false, ab: {BF:  3}, wiki: 'Chlorgas_Alarm_(Schwimmbad)'},
  'Container Brand'                : {mld: 'AB1'                      , storm: false, ab: {FW:  1}, wiki: 'Containerbrand'},
  'Dachstuhlbrand'                 : {mld: 'AB3+DLK'                  , storm: false, ab: {FW:  3}, wiki: 'Dachstuhlbrand'},
  'Fahrstuhl - Türöffnung'         : {mld: 'AT2'                      , storm: false, ab: {FW: 15}, wiki: 'Fahrstuhl-T%C3%BCr%C3%B6ffnung'},
  'Feldbrand'                      : {mld: 'AB1'                      , storm: false, ab: {FW:  1}, wiki: 'Feldbrand'},
  'Fettbrand in Pommesbude'        : {mld: 'AB2+TLF'                  , storm: false, ab: {FW:  3}, wiki: 'Fettbrand_in_Pommesbude'},
  'Feuer auf Boot (Klein)'         : {mld: 'NWB1'                     , storm: false, ab: {BF: 30}, onWater: true, wiki: 'Feuer_auf_Boot_(klein)'},
  'Feuer auf Boot (Mittel)'        : {mld: 'NWB2'                     , storm: false, ab: {BF: 45}, onWater: true, wiki: 'Feuer_auf_Boot_(mittel)'},
  'Feuer im Altenheim'             : {mld: 'AB4+DLK,GWA'              , storm: false, ab: {FW:  6}, wiki: 'Feuer_im_Altenheim'},
  'Feuer im Krankenhaus'           : {mld: 'AB8+GWL,GWG,GWM,GWA,RW'   , storm: false, ab: {BF: 40}, wiki: 'Feuer_im_Krankenhaus'},
  'Feuer im Laubhaufen'            : {mld: 'AB1'                      , storm: false, ab: {FW:  1}, wiki: 'Feuer_im_Laubhaufen'},
  'Feuer im Personenzug (Bahnhof)' : {mld: 'NBB4+GWL'                 , storm: false, ab: {FW: 65}, wiki: 'Feuer_im_Personenzug_(Bahnhof)'},
  'Feuer im Personenzug (Tunnel)'  : {mld: 'NTB4+GWL'                 , storm: false, ab: {FW: 65}, wiki: 'Feuer_im_Personenzug_(Tunnel)'},
  'Feuer im Personenzug'           : {mld: 'NBB4+GWL,TLF'             , storm: false, ab: {FW: 65}, wiki: 'Feuer_im_Personenzug'},
  'Feuer in Bahnhofshalle'         : {mld: 'NBB4+DLK,GWA,GWL'         , storm: false, ab: {FW: 65}, wiki: 'Feuer_in_Bahnhofshalle'},
  'Güterzug entgleist (Bahnhof)'   : {mld: 'NBG8+FwK,TUIS'            , storm: false, ab: {FW: 65}, wiki: 'G%C3%BCterzug_entgleist_(Bahnhof)'},
  'Güterzug entgleist (Tunnel)'    : {mld: 'NTG8+GWA,TUIS'            , storm: false, ab: {FW: 65}, wiki: 'G%C3%BCterzug_entgleist_(Tunnel)'},
  'Güterzug entgleist'             : {mld: 'NBT8+DLK,GWG,GWM,FwK,TUIS', storm: false, ab: {FW: 65}, wiki: 'G%C3%BCterzug_entgleist'},
  'Gabelstapler im Hafenbecken'    : {mld: 'NHT4'                     , storm: false, ab: {FW: 40}, wiki: 'Gabelstapler_im_Hafenbecken'},
  'Garagenbrand'                   : {mld: 'AB2'                      , storm: false, ab: {FW:  4}, wiki: 'Garagenbrand'},
  'Gartenlaubenbrand'              : {mld: 'AB1'                      , storm: false, ab: {FW:  1}, wiki: 'Gartenlaubenbrand'},
  'Gas-Explosion'                  : {mld: 'AB2+DLK,ELW,GWL'          , storm: false, ab: {FW: 30}, wiki: 'Gas-Explosion'},
  'Gastronomiebrand'               : {mld: 'AB2'                      , storm: false, ab: {FW:  8}, wiki: 'Gastronomiebrand'},
  'Gasaustritt in Fabrik'          : {mld: 'AG4+DLK,GWL'              , storm: false, ab: {BF: 20}, wiki: 'Gasaustritt_in_Fabrik'},
  'Gefahrstoff-Austritt in Firma'  : {mld: 'AG4+GWA,GWL|TUIS'         , storm: false, ab: {FW: 40, BF: 2}, wiki: 'Gefahrstoff-Austritt_in_Firma' },
  'Gerüsteinsturz'                 : {mld: 'AT2+DLK'                  , storm: false, ab: {FW: 30}, wiki: 'Ger%C3%BCsteinsturz'},
  'Gewerbebrand'                   : {mld: 'AB4+DLK,GWA,RW'           , storm: false, ab: {FW: 35}, wiki: 'Gewerbebrand'},
  'Grasnarbenbrand'                : {mld: 'NFB1'                     , storm: false, ab: {FW: 59}, wiki: 'Grasnarbenbrand'},
  'Großbrand in Hafen'             : {mld: 'VGSL'                     , storm: false, ab: {MG:  3}, wiki: 'Großbrand_in_Hafen'}, //Verbandsgroßschadenslage
  'Küchenbrand'                    : {mld: 'AB1'                      , storm: false, ab: {FW:  2}, wiki: 'K%C3%BCchenbrand'},
  'Kaminbrand'                     : {mld: 'AB2+DLK'                  , storm: false, ab: {FW:  5}, wiki: 'Kaminbrand'},
  'Keller unter Wasser'            : {mld: 'AT1'                      , storm: true,  ab: {FW:  2}, wiki: 'Keller_unter_Wasser'},
  'Kellerbrand'                    : {mld: 'AB2'                      , storm: false, ab: {FW:  3}, wiki: 'Kellerbrand'},
  'Kinobrand'                      : {mld: 'AB4+TLF,GWA,DLK'          , storm: false, ab: {FW: 10}, wiki: 'Kinobrand'},
  'Kioskbrand'                     : {mld: 'AB1'                      , storm: false, ab: {FW:  2}, wiki: 'Kioskbrand'},
  'Kleiner Waldbrand'              : {mld: 'AB2+GWL'                  , storm: false, ab: {FW:  1}, wiki: 'Kleiner_Waldbrand'},
  'Kleintier in Not'               : {mld: 'AT1'                      , storm: false, ab: {FW:  2}, wiki: 'Kleintier_in_Not'},
  'LKW in Brückengeländer'         : {mld: 'AT4+DLK,FwK'              , storm: false, ab: {FW:  6}, wiki: 'LKW_in_Brückengel%C3%A4nder'},
  'Mähdrescherbrand'               : {mld: 'AB2'                      , storm: false, ab: {FW:  5}, wiki: 'M%C3%A4hdrescherbrand'},
  'Mülleimer Brand'                : {mld: 'AB1'                      , storm: false, ab: {FW:  1}, wiki: 'M%C3%BClleimerbrand'},
  'Maschinenbrand'                 : {mld: 'AB3+GWL'                  , storm: false, ab: {FW:  5}, wiki: 'Maschinenbrand'},
  'Motorrad-Brand'                 : {mld: 'AB1'                      , storm: false, ab: {FW:  1}, wiki: 'Motorradbrand'},
  'Muldenkipper abgerutscht'       : {mld: 'NET4+FwK'                 , storm: false, ab: {FW: 70}, wiki: 'Muldenkipper_abgerutscht'},
  'PKW in Fluss'                   : {mld: 'AT2+GWT,FwK'              , storm: false, ab: {FW: 15}, wiki: 'PKW_in_Fluss'},
  'Person im Fluss'                : {mld: 'AT1+GWT'                  , storm: false, ab: {BF: 25}, wiki: 'Person_im_Fluss'},
  'Person in Schacht'              : {mld: 'AT1'                      , storm: false, ab: {FW:  3}, wiki: 'Person_in_Schacht'},
  'RTZ-Einsatz'                    : {mld: 'RTZ'                      , storm: false, ab: {FW: 65}, wiki: 'RTZ-Einsatz'},
  'Radlader umgekippt'             : {mld: 'NET1+ELW,GWÖl,FwK,RW'     , storm: false, ab: {FW: 70}, wiki: 'Radlader_umgekippt'},
  'Rangierunfall'                  : {mld: 'NBT4+GWÖl'                , storm: false, ab: {FW: 65}, wiki: 'Rangierunfall'},
  'Scheunenbrand'                  : {mld: 'AB3+GWL'                  , storm: false, ab: {FW: 30}, wiki: 'Scheunenbrand'},
  'Schornsteinbrand'               : {mld: 'AB2+DLK'                  , storm: false, ab: {FW:  3}, wiki: 'Schornsteinbrand'},
  'Schuppenbrand'                  : {mld: 'AB2'                      , storm: false, ab: {FW:  4}, wiki: 'Schuppenbrand'},
  'Silobrand'                      : {mld: 'AB3'                      , storm: false, ab: {FW: 20}, wiki: 'Silobrand'},
  'Sperrmüllbrand'                 : {mld: 'AB1'                      , storm: false, ab: {FW:  1}, wiki: 'Sperrm%C3%BCllbrand'},
  'Strohballen Brand'              : {mld: 'AB2+GWL'                  , storm: false, ab: {FW:  1}, wiki: 'Strohballen_Brand'},
  'Türöffnung'                     : {mld: 'AT1'                      , storm: false, ab: {FW:  2}, wiki: 'T%C3%BCr%C3%B6ffnung'},
  'Tagebauarbeiter abgestürzt'     : {mld: 'NET2+ELW,RW,DLK'          , storm: false, ab: {FW: 70}, wiki: 'Tagebauarbeiter_abgest%C3%BCrzt'},
  'Tankbrand'                      : {mld: 'NRB5+RW,GWÖl,TUIS'        , storm: false, ab: {FW: 64}, wiki: 'Tankbrand'},
  'Traktorbrand'                   : {mld: 'AB1'                      , storm: false, ab: {FW:  1}, wiki: 'Traktorbrand'},
  'Trocknerbrand'                  : {mld: 'AB1'                      , storm: false, ab: {FW:  1}, wiki: 'Trocknerbrand'},
  'Unfall an Bahnübergang'         : {mld: 'NBT4+GWÖl'                , storm: false, ab: {FW: 65}, wiki: 'Unfall_an_Bahn%C3%BCbergang'},
  'Unfall mit Gefahrgut-Transport' : {mld: 'AG3+GWA,FwK|TUIS'         , storm: false, ab: {FW: 40, BF: 2}, wiki: 'Unfall_mit_Gefahrgut-Transport'},
  'VU mit Straßenbahn'             : {mld: 'AT4+GWS,FwK'              , storm: false, ab: {FW: 20}, wiki: 'VU_mit_Strassenbahn'},
  'Verkehrsunfall'                 : {mld: 'AT2+GWÖl'                 , storm: false, ab: {FW:  4}, wiki: 'Verkehrsunfall'},
  'Verletztentransport'            : {mld: 'RD'                       , storm: false, ab: {FW: 50}, wiki: 'Verletztentransport'},
  'Waldbrand'                      : {mld: 'AB3+DLK,GWL'              , storm: false, ab: {FW: 20}, wiki: 'Waldbrand'},
  'Wassereinbruch'                 : {mld: 'AT1'                      , storm: false, ab: {FW: 30}, wiki: 'Wassereinbruch'},
  'Wohnblockbrand'                 : {mld: 'AB5+GWA'                  , storm: false, ab: {FW: 45}, wiki: 'Wohnblockbrand'},
  'Wohnungsbrand'                  : {mld: 'AB2'                      , storm: false, ab: {FW:  2}, wiki: 'Wohnungsbrand'},
  'Wohnwagenbrand'                 : {mld: 'AB1'                      , storm: false, ab: {FW:  1}, wiki: 'Wohnwagenbrand'},
  'Beschädigtes Frachtstück'       : {mld: 'NFT1+ELW|GWG'             , storm: false, ab: {BF: 59}, wiki: ''},
  'Brand bei Flugzeugbetankung'    : {mld: 'NFB3+GWÖl|GWG'            , storm: false, ab: {BF: 59}, wiki: ''},
  'Brand im Terminal'              : {mld: 'NFB4+DLK,GWA,GWM'         , storm: false, ab: {BF: 59}, wiki: ''},
  'Brand im Tower'                 : {mld: 'NFB3+DLK'                 , storm: false, ab: {BF: 59}, wiki: ''},
  'Brand Kreuzfahrtschiff'         : {mld: 'NWB2'                     , storm: false, ab: {BF: 45}, onWater: true, wiki: ''},
  'Rauchentwicklung in Kantine'    : {mld: 'NHB3'                     , storm: false, ab: {FW: 50}, wiki: ''},
  'Feuer in Bootswerft'            : {mld: 'NHB3|GWM'                 , storm: false, ab: {FW: 60}, wiki: ''},
  'Brand in Hotel'                 : {mld: 'AB6+DLK,RW,TLF,GWA'       , storm: false, ab: {FW: 13}, wiki: 'Brand_in_Hotel'},
  'Möbelhausbrand'                 : {mld: 'AB5+DLK,GWA'              , storm: false, ab: {BF: 10}, wiki: 'M%C3%B6belhausbrand'},
  'Brand im Telefonshop'           : {mld: 'AB2'                      , storm: false, ab: {FW:  3}, wiki: ''},
  'Brand in Streichholzfabrik'     : {mld: 'AB4+DLK,GWA'              , storm: false, ab: {FW:  9}, wiki: ''},
  'Brand in Polizeistation'        : {mld: 'AB3+DLK,RW'               , storm: false, ab: {FW: 20}, wiki: ''},
  'Großbrand in Zuckerfabrik'      : {mld: 'AB8+GWL,GWA,GWM,DLK'      , storm: false, ab: {BF: 50}, wiki: ''},
  'Brand in Erholungsbad'          : {mld: 'AB6+GWL,GWA'              , storm: false, ab: {BF: 50}, wiki: ''},
};
...
/*
  ...
  Wenn an erster Stelle ein A steht, sind es ESWs für die Altstadt.
  Wenn an erster und zweiter Stelle ein NB steht, sind es ESWs für die Bahn.
  Wenn an erster und zweiter Stelle ein NT steht, sind es ESWs für die Tunnel.
  Wenn an erster und zweiter Stelle ein NH steht, sind es ESWs für den Hafen.
  Wenn an erster und zweiter Stelle ein NW steht, sind es ESWs für das Wasser.
  Wenn an erster und zweiter Stelle ein NR steht, sind es ESWs für die Raffinerie.
  Wenn an erster und zweiter Stelle ein NF steht, sind es ESWs für den Flughafen.
  Wenn an erster und zweiter Stelle ein NE steht, sind es ESWs für den Tagebau.
  Wenn an erster und zweiter Stelle ein NM steht, sind es ESWs für die MVA.
*/
  'AB1'      :  {txt: 'Brand Stufe 1',                   vhc: 'HLF'},
  'AB2'      :  {txt: 'Brand Stufe 2',                   vhc: 'HLF,HLF'},
  'AB3'      :  {txt: 'Brand Stufe 3',                   vhc: 'HLF,HLF,HLF,ELW'},
  'AB4'      :  {txt: 'Brand Stufe 4',                   vhc: 'HLF,HLF,HLF,HLF,ELW'},
  'AB5'      :  {txt: 'Brand Stufe 5',                   vhc: 'HLF,HLF,HLF,HLF,HLF,ELW'},
  'AB6'      :  {txt: 'Brand Stufe 6',                   vhc: 'HLF,HLF,HLF,HLF,HLF,HLF,ELW'},
  'AB7'      :  {txt: 'Brand Stufe 7',                   vhc: 'HLF,HLF,HLF,HLF,HLF,HLF,HLF,ELW'},
  'AB8'      :  {txt: 'Brand Stufe 8',                   vhc: 'HLF,HLF,HLF,HLF,HLF,HLF,HLF,HLF,ELW'},
  'NBB1'     :  {txt: 'Brand Stufe 1, Bahn',             vhc: 'HLFS/HLF'},
  'NBB2'     :  {txt: 'Brand Stufe 2, Bahn',             vhc: 'HLFS/HLF,HLFS/HLF'},
  'NBB3'     :  {txt: 'Brand Stufe 3, Bahn',             vhc: 'HLFS/HLF,HLFS/HLF,HLFS/HLF/TLF,ELW'},
  'NBB4'     :  {txt: 'Brand Stufe 4, Bahn',             vhc: 'HLFS/HLF,HLFS/HLF,HLFS/HLF,HLFS/HLF,ELW'},
  'NTB1'     :  {txt: 'Brand Stufe 1, Tunnel',           vhc: 'HLFS'},
  'NTB2'     :  {txt: 'Brand Stufe 2, Tunnel',           vhc: 'HLFS,HLFS'},
  'NTB3'     :  {txt: 'Brand Stufe 3, Tunnel',           vhc: 'HLFS,HLFS,HLFS,ELW'},
  'NTB4'     :  {txt: 'Brand Stufe 4, Tunnel',           vhc: 'HLFS,HLFS,HLFS,HLFS,ELW'},
  'NWB1'     :  {txt: 'Brand Stufe 1, Wasser',           vhc: 'FLB'},
  'NWB2'     :  {txt: 'Brand Stufe 2, Wasser',           vhc: 'FLB,FLB'},
  'NHB1'     :  {txt: 'Brand Stufe 1, Hafen',            vhc: 'HLF'},
  'NHB2'     :  {txt: 'Brand Stufe 2, Hafen',            vhc: 'ELW,HLF,HLF,TLF,DLK'},
  'NHB3'     :  {txt: 'Brand Stufe 3, Hafen',            vhc: 'ELW,HLF,HLF,HLF,TLF,DLK,GWA,GWL'},
  'NRB5'     :  {txt: 'Brand Stufe 5, Raffinerie',       vhc: 'ULF,ULF,ULF,ULF,ULF,ULF,HLF,HLF,TLF,ELW'},
  'NFB1'     :  {txt: 'Brand Stufe 1, Flughafen',        vhc: 'HLF/FLF'},
  'NFB2'     :  {txt: 'Brand Stufe 2, Flughafen',        vhc: 'FLF,FLF,HLF'},
  'NFB3'     :  {txt: 'Brand Stufe 3, Flughafen',        vhc: 'FLF,FLF,HLF,HLF,HLF,ELW'},
  'NFB4'     :  {txt: 'Brand Stufe 4, Flughafen',        vhc: 'FLF,FLF,HLF,HLF,HLF,HLF,ELW'},
  'NFB5'     :  {txt: 'Brand Stufe 5, Flughafen',        vhc: 'FLF,FLF,HLF,HLF,HLF,HLF,HLF,ELW'},
  'NFB6'     :  {txt: 'Brand Stufe 6, Flughafen',        vhc: 'FLF,FLF,FLF,FLF,FLF,FLF,RTr,HLF,HLF,HLF,TLF,ELW,RW,GWL,GWG,GWM,GWÖl'},
  'NEB1'     :  {txt: 'Brand Stufe 1, Tagbebau',         vhc: 'HLF'},
  'NEB2'     :  {txt: 'Brand Stufe 2, Tagbebau',         vhc: 'HLF,HLF'},
  'NMB5'     :  {txt: 'Brand Stufe 5, MVA',              vhc: 'HLF,HLF,HLF,HLF,HLF,ELW'},
  'NMB6'     :  {txt: 'Brand Stufe 6, MVA',              vhc: 'HLF,HLF,HLF,HLF,HLF,HLF,ELW'},
  'AT1'      :  {txt: 'Technik Stufe 1',                 vhc: 'HLF'},
  'AT2'      :  {txt: 'Technik Stufe 2',                 vhc: 'HLF,RW'},
  'AT3'      :  {txt: 'Technik Stufe 3',                 vhc: 'HLF,HLF,RW'},
  'AT4'      :  {txt: 'Technik Stufe 4',                 vhc: 'HLF,HLF,HLF,RW,ELW'},
  'NHT4'     :  {txt: 'Technik Stufe 3, Hafen',          vhc: 'HLF,HLF,RW,ELW,GWT,FwK'},
  'NBT1'     :  {txt: 'Technik Stufe 1, Bahn',           vhc: 'HLFS/HLF'},
  'NBT2'     :  {txt: 'Technik Stufe 2, Bahn',           vhc: 'HLFS,HLFS/HLF,HLFS/HLF'},
  'NBT3'     :  {txt: 'Technik Stufe 3, Bahn',           vhc: 'HLFS,HLFS/HLF,HLFS/HLF,ELW,RW,GWS'},
  'NBT4'     :  {txt: 'Technik Stufe 4, Bahn',           vhc: 'HLFS,HLFS/HLF,HLFS/HLF,HLFS/HLF,ELW,RW,GWS'},
  'NBT8'     :  {txt: 'Technik Stufe 8, Bahn',           vhc: 'HLFS,HLFS,HLFS/HLF,HLFS/HLF,HLFS/HLF,HLFS/HLF,HLFS/HLF,HLFS/HLF,ELW,RW,GWS'},
  'NTT1'     :  {txt: 'Technik Stufe 1, Tunnel',         vhc: 'HLFS'},
  'NTT2'     :  {txt: 'Technik Stufe 2, Tunnel',         vhc: 'HLFS,HLFS'},
  'NTT3'     :  {txt: 'Technik Stufe 3, Tunnel',         vhc: 'HLFS,HLFS,HLFS,ELW,RW,GWS'},
  'NTT4'     :  {txt: 'Technik Stufe 4, Tunnel',         vhc: 'HLFS,HLFS,HLFS,HLFS,ELW,RW,GWS'},
  'NFT1'     :  {txt: 'Technik Stufe 1, Flughafen',      vhc: 'HLF'},
  'NET1'     :  {txt: 'Technik Stufe 1, Tagebau',        vhc: 'HLF,HLF'},
  'NET2'     :  {txt: 'Technik Stufe 2, Tagebau',        vhc: 'HLF,GWH'},
  'NET3'     :  {txt: 'Technik Stufe 3, Tagebau',        vhc: 'HLF,HLF,GWH'},
  'NET4'     :  {txt: 'Technik Stufe 4, Tagebau',        vhc: 'HLF,HLF,HLF,GWH,ELW'},
  'NMT2'     :  {txt: 'Technik Stufe 2, MVA',            vhc: 'HLF,GWH'},
  'AG2'      :  {txt: 'Gefahrgut Stufe 2',               vhc: 'HLF,HLF,ELW,GWG,GWM'},
  'AG3'      :  {txt: 'Gefahrgut Stufe 3',               vhc: 'HLF,HLF,HLF,ELW,RW,GWG,GWM'},
  'AG4'      :  {txt: 'Gefahrgut Stufe 4',               vhc: 'HLF,HLF,HLF,HLF,ELW,RW,GWG,GWM'},
  'NBG2'     :  {txt: 'Gefahrgut Stufe 2, Bahn',         vhc: 'HLFS/HLF,HLFS/HLF,GWG,GWM'},
  'NBG3'     :  {txt: 'Gefahrgut Stufe 3, Bahn',         vhc: 'HLFS/HLF,HLFS/HLF,HLFS/HLF,ELW,RW,GWS,GWG,GWM'},
  'NBG4'     :  {txt: 'Gefahrgut Stufe 4, Bahn',         vhc: 'HLFS/HLF,HLFS/HLF,HLFS/HLF,HLFS/HLF,ELW,RW,GWS,GWG,GWM'},
  'NBG8'     :  {txt: 'Gefahrgut Stufe 8, Bahn',         vhc: 'HLFS,HLFS,HLFS,HLFS,HLFS/HLF,HLFS/HLF,HLFS/HLF,HLFS/HLF,ELW,RW,GWS,GWG,GWM'},
  'NTG1'     :  {txt: 'Gefahrgut Stufe 1, Tunnel',       vhc: 'HLFS,GWG,GWM'},
  'NTG2'     :  {txt: 'Gefahrgut Stufe 2, Tunnel',       vhc: 'HLFS,HLFS,GWG,GWM'},
  'NTG3'     :  {txt: 'Gefahrgut Stufe 3, Tunnel',       vhc: 'HLFS,HLFS,HLFS,ELW,RW,GWS,GWG,GWM'},
  'NTG4'     :  {txt: 'Gefahrgut Stufe 4, Tunnel',       vhc: 'HLFS,HLFS,HLFS,HLFS,ELW,RW,GWS,GWG,GWM'},
  'NTG8'     :  {txt: 'Gefahrgut Stufe 8, Tunnel',       vhc: 'HLFS,HLFS,HLFS,HLFS,HLFS,HLFS,HLFS,HLFS,ELW,RW,GWS,GWG,GWM'},
  'NMG3'     :  {txt: 'Gefahrgut Stufe 3, MVA',          vhc: 'HLF,HLF,HLF,ELW,GWG,GWM'},
  'VGSL'     :  {txt: 'Verbandseinsatz',                 vhc: 'HLF,HLF,HLF,HLF,HLF,HLF/HLFS,HLF/HLFS,HLF/HLFS,HLF/HLFS,HLF/HLFS'},
  'RTZ'      :  {txt: 'Rettungszug',                     vhc: 'HLFS,HLFS,HLFS'},
  'RD'       :  {txt: 'Medizinscher Notfall',            vhc: ''},
};
...
*/
  ...
  'LF 20'              : {id: 30, grp: 'HLF',   speed: 60, groupVeh: true, regex: /LF 20[^/]/, wiki: 'LF_20'},
  'LF 20/16'           : {id:  6, grp: 'HLF',   speed: 60, groupVeh: true, regex: /LF 20\/16/, wiki: 'LF_20/16'},
  'HLF 10/6'           : {id: 24, grp: 'HLF',   speed: 58, groupVeh: true, regex: /HLF 10\/6/, wiki: 'HLF_10/6'},
  'HLF 20/16'          : {id: 23, grp: 'HLF',   speed: 60, groupVeh: true, regex: /HLF 20\/16/, wiki: 'HLF_20/16'},
  ...
  'TLF 16/25'          : {id: 27, grp: 'LF',    speed: 55, regex: /TLF 16\/25/, wiki: 'TLF_16/25'},
  'TLF 20/40 - SL'     : {id:  7, grp: 'TLF',   speed: 49, regex: /TLF 20\/40 - SL/, wiki: 'TLF_20/40_SL'},
...
var FhzGruppeLst = {
  'ELW' : {text: 'Einsatzleitwagen',        seq:  1, ab: {FW:  5}},
  'LF'  : {text: 'Tanklöschfahrzeug',       seq:  2, type: 'TLF', ab: {FW:  1}},
  'TLF' : {text: 'Großtanklöschfahrzeug',   seq:  3, ab: {FW:  7}},
  'ULF' : {text: 'Universallöschfahrzeug',  seq:  4, ab: {FW: 64}},
  'FLF' : {text: 'Flugfeldlöschfahrzeug',   seq:  5, ab: {BF: 59}},
  'DLK' : {text: 'Drehleiter (Korb)',       seq:  6, ab: {FW:  3}},
  'RTr' : {text: 'Rettungstreppe',          seq:  7, ab: {BF: 59}},
  'KLF' : {text: 'Kleinlöschfahrzeug',      seq:  8},
  'LF'  : {text: 'Löschgruppenfahrzeug',    seq:  9, type: 'LF'},
  'TS'  : {text: 'LF mit Tragkraftspritze', seq:  10},
  'HLF' : {text: 'Hilfeleistungslöschgruppenfahrzeug', seq:  11},
  'HLFS': {text: 'Hilfeleistungslöschgruppenfahrzeug mit Schienenfahreinrichtung', seq:  12, ab: {FW: 65}},
  'RW'  : {text: 'Rüstwagen',               seq: 13, ab: {FW:  4}},
  'GWÖl': {text: 'Gerätewagen Öl',          seq: 14, ab: {FW:  4}},
  'GWG' : {text: 'Gerätewagen Gefahrgut',   seq: 15, ab: {BF:  2}},
  'GWA' : {text: 'Gerätewagen Atemschutz',  seq: 16, ab: {FW:  6}},
  'GWT' : {text: 'Gerätewagen Taucher',     seq: 17, ab: {BF: 25}},
  'GWM' : {text: 'Gerätewagen Messtechnik', seq: 18, ab: {BF:  2}},
  'TUIS': {text: 'Gerätewagen Transport-Unfall-Informationssystem', seq: 19, ab: {FW: 64}},
  'GWL' : {text: 'Schlauchwagen',           seq: 20, ab: {FW:  5}},
  'WLF' : {text: 'Wechselladerfahrzeug',    seq: 21, type: 'WLF'},
  'GWS' : {text: 'Gerätewagen Schiene',     seq: 22, ab: {FW: 10}},
  'FwK' : {text: 'Feuerwehrkran',           seq: 23, ab: {FW: 25}},
  'RTB' : {text: 'Rettungsboot',            seq: 24, ab: {FW: 50}, type: 'RTM', onWater: true},
  'FLB' : {text: 'Feuerlöschboot',          seq: 25, ab: {BF: 30}, onWater: true},
  'NEF' : {text: 'Notarzteinsatzfahrzeug',  seq: 26, ab: {BF: 20}, type: 'NEF'},
  'RTW' : {text: 'Rettungswagen',           seq: 27, ab: {BF: 10}, type: 'RTM'},
  'GWH' : {text: 'Gerätewagen Höhenrettung', seq: 28, ab: {BF: 70}},
  'ABE' : {text: 'AB-Einsatzleitung',       seq: 29, visible: false, type: 'AB'},
};
...
'global': {
  ...
  assignLF16TSToGrpLF       : {valDef: true, text: 'LF 16-TS in Gruppe LF führen'},
  assignTLF16ToGrpLF        : {valDef: true, text: 'TLF16/25 in Gruppe LF führen'},
  disableSelectionDueToStorm: {valDef: false, text: 'Unwettermodus'},
  reducedSelectionVehicles  : {valDef: 'LF/HLF', type: OptType.string,  length: 50, valChkFunc: chkFunc.redSelVhc, text: 'Fahrzeug(e) für Unwettermodus'},
...
'eList': {
  ...
  showInfoVehiclesInListe: {valDef: false,  text: 'gemäß Alarmierungsstichwort zu alarmierende Fahrzeuge anzeigen'},
...
'eInfo': {
  ...
  callSurplusRTW            : {valDef: true, text: 'einen RTW mehr alarmieren, als von Verletztenzahl notwendig (mögliche Nachalarmierung)'},
  callNEFWithInjured        : {valDef: 4,     type: OptType.integer, length: 3, valChkFunc: chkFunc.limTime, text: 'NEF ab x Verletzte automatisch mit alarmieren (0 = nie)'},
  limitRTWcall              : {valDef: true, text: 'RTW Alarmierung zeitlich begrenzen'},
  limitRTWcallMin           : {valDef: 30,    type: OptType.integer, length: 3, valChkFunc: chkFunc.limTime, text: 'RTW bis maximal x Min. vorschlagen'},
...
'fList': {
  ...
  showStatusLangtext      : {valDef: false,  text: 'Text zum Status anzeigen'},
  ...
  limitDamageTo           : {valDef: 74,   type: OptType.integer,  length:  3, valChkFunc: chkFunc.limDmg, text: 'Nur beschädigte Fahrzeuge mit weniger als x% anzeigen:'},
...
'wList': {
  ...
  imgStationList           : {valDef: 'none', type: OptType.radio,  text: 'Graphiken in Liste',
...
'gList': {
   text: 'Gebäudeliste',
   opt: {
  imgBuildingList: {valDef: 'none', type: OptType.radio,  text: 'Graphiken in Liste',
                    list: {'normal':'normale Graphik', 'small':'kleine Graphik', 'none':'Graphik nicht anzeigen'}},
}},
'lList': {
   text: 'Log',
