// ==UserScript==
// @name           Better FriendFeed
// @namespace      http://sheenonline.biz/*
// @description    Make FriendFeed A Little Better
...
(function() {
  ...
  autoUpdateFromUserscriptsDotOrg({
			url: 'http://userscripts.org/scripts/source/30996.user.js',
			version: betterff_version,
		});
  ...
  function showOptions() {	
	...
	if (div2==null)
	{
		...
		var text1="";
		text1+="<center><font size=\"+1\">Better FriendFeed</a> Options</font><br>By:&nbsp;<a href=\"http://sheenonline.biz\" target=\"_blank\">Rahsheen Porter</a></center>";
  ...
  function tab_setup(name, url, favicon) {
	...
	$('#header').find('.search.container').after('<td><a id="tab-link-' + tabLink + '" href="#"><img width=16 height=16 src="' + favicon  + '"></a></td>');
  ...
  function lets_jquery() {
	GM_registerMenuCommand('Better FriendFeed', showOptions);
	
		if (cleanerFF) {
			//Based on the Cleaner FriendFeed Script
			// author        AJ Batac
			// homepage   http://www.allanjosephbatac.com/blog/
			var css = "@namespace url(http://www.w3.org/1999/xhtml); *::-moz-selection{ background:#ECF2FA !important; color:#ffffff !important; } *{ font-family: \"Trebuchet MS\", \"Arial\", \"Serif\" !important; color: #000000; } a,a:link,a:visited{ text-decoration:none !important; color:#276DCD !important; } a:hover{ color:#333333 !important; border-bottom:1px dotted #333333 !important; } a:active{ text-decoration:none !important; color:#f4a460 !important; } .feed .entry .comments .comment.friend{ background-color:#ffffe0 !important; /*Highlight your friends comments*/ } .feed .entry .comments .comment.owner.friend{ background-color:#e1f0ff !important; /*Highlight your own comments*/ } .tabs{ left:2.2em !important; } .rounded.bb .tl,.rounded.bb .tr{ background:none !important; } .rounded.bb.white .tl,.rounded.bb.white .tr{ background:none !important; } #infobox .body .tl{ background:none !important; } #infobox{ padding-top:2em !important; } .login{ font-size:.8em !important; padding-top:3.2em !important; } #rightsearch{ font-size:.8em !important; padding-top:2.3em !important; } .cluster{ border-bottom:1px dotted #708090 !important; padding-bottom:1em !important; }";
