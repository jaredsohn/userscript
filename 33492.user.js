...
/*
 * @author SKD
 * @profile http://www.orkut.co.in/Profile.aspx?uid=9960356076961747673
 */
...
var htmlQuoteB = "<div style='background: #FFF2E6; border: 2px #000000 solid; color: black; font-size: 90%; margin-left: 20px; margin-right: 20px; padding: 2px 3px 2px 3px'>";
var htmlQuoteE = "</div>";
...
var signature = "";
var htmlSignature = newLineFixer + "<sub style='font-size:15px'>᠌</sub><br /><br /><sub><a><b><center><h2>╒═» şκÐ™«═╕</h2><center></b></a></sub>";
/* /VARS:: Signature */

/* VARS:: QuickReply */
QReplyAccept("22674184", "Linkin Park");
QReplyAccept("34769312", "Style Is In My Blood");
QReplyAccept("40352228" , "Teenage Love & Affection");
QReplyAccept("35640847" , "I Hate Cheating & Cheaters");
QReplyAccept("38148933" , "Skd Fans Till Death");
QReplyAccept("34868406", "I Love To Walk In The Rain");
QReplyAccept("51875294", "MTV Roadies 7.0");
QReplyAccept("38471977", "FRIENDSHIP");
QReplyAccept("34874158", "Brazil VS Argentina");
/* /VARS:: QuickReply */
