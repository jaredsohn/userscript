// ==UserScript==
// @name FB MafiaWars Addon ♆ Ł☠Ҝ ♆
// @namespace http://userscripts.org/scripts/show/110492
// @version 0.5.2.5 ♆ Ł☠Ҝ ♆
// @description http://userscripts.org/topics/93230
...
var AppInfo = {
    ...
    name     : 'FB MafiaWars Addon ♆ Ł☠Ҝ ♆',
    tag      : 'FBMWAddon ♆ Ł☠Ҝ ♆',
    prefix   : 'FBMafiaWarsAddon_♆ Ł☠Ҝ ♆',
    url      : 'http://userscripts.org/scripts/show/110492',
    meta     : 'http://userscripts.org/scripts/source/110492.meta.js'
};
        ...
        'es_ES': {
            ...
            content: {
                ...
                'freegiftscenter_popup': {
                    ...
                    'fgopt_scantime': 'Scanning.<br>Pon aquÃ­ el tiempo que tendrÃ¡ como mÃ¡ximo un posts para escanearlo.',
                    'massive_input': 'Parsing.<br>AquÃ­ puedes pegar todos los enlaces que encuentres de tus amigos para de una pÃ¡gina.',
                    'fgopt_usefilter': 'Parsing.<br>MÃ¡rcalo para activar el filtro de regalos.',
                    'fgopt_filter': 'Parsing.<br>AÃ±ade aquÃ­ los regalos que deseas mostrar.<br>Separa cada regalo por el caracter "|".',
                    'fgopt_remonsuccess': 'Remove facebook requests.<br>MÃ¡rcalo para quitar una peticiÃ³n de facebook tras aceptarla.',
                    'fgopt_remonignore': 'Remove facebook requests.<br>MÃ¡rcalo para quitar una peticiÃ³n de facebook tras ignorarla.',
                    'fgopt_sendthanksrequest': 'Send back.<br>MÃ¡rcalo para devolver regalos de facebook tras aceptar un regalo.',
                    'fgopt_sendbacktype': 'Send back.<br>Selecciona por medio de que deseas devolver los regalos.',
                    'fgopt_usebackgiftfilter': 'Send back.<br>MÃ¡rcalo para activar el filtro de regalos usado para devolverlos.',
                    'fgopt_thanksbackfilter': 'Send back.<br>Pon aquÃ­ los nombres de los regalos que deseas filtrar.<br>Usa "|" para separarlos.',
                    'fgopt_ignorelimits': 'Collector.<br>MÃ¡rcalo para ignorar los regalos que llegan a su lÃ­mite diario y seguir abriendolos.',
                    'fgopt_skipsameuser': 'Collector.<br>MÃ¡rcalo para no recoger regalos del mismo usuario cuando ya le abriste.',
                    'fgopt_masssendback': 'Collector.<br>MÃ¡rcalo para devolver regalos a travÃ©s de facebook despuÃ©s de abrirlos.',
                    'fgopt_collectnomafia': 'Collector.<br>MÃ¡rcalo para abrir relgalos de gente que no estÃ¡ en tu mafia.',
                    'fgopt_csselect': 'Crime Spree.<br>Selecciona aquÃ­ el Paso 1 cuando abres un Crime Spree.',
                    'fgopt_csreward': 'Crime Spree.<br>Selecciona aquÃ­ el Paso 2 cuando abres un Crime Spree.',
                    'fgopt_useexcludedgifts': 'Skipping.<br>MÃ¡rcalo para activar la lista de excluidos.',
                    'fgopt_excludedpattern': 'Skipping.<br>Pon aquÃ­ el texto que aparecerÃ¡ tras abrir un regalo que harÃ¡ que este sea aÃ±adido a la lista de excluidos.<br>Usa "|" para aÃ±adir varios textos diferentes.'
                },
                ...
                // MULTI GIFTER
                'multigifter_popup': {
                    'mgopt_giftpages': 'Pagination.<br>MÃ¡rcalo para paginar la lista de objetos.',
                    'mgopt_userpages': 'Pagination.<br>MÃ¡rcalo para paginar la lista de amigos.',
                    'mgopt_hidezeroamount': 'Item quantity.<br>MÃ¡rcalo para esconder los objetos que tengan una cantidad de cero.',
                    'mgopt_delay': 'Delay.<br>Pon aquÃ­ el retraso para enviar regalos.',
                ...
                // HOME FEED CENTER
                'homefeedcenter_popup': {
                    'hfopt_filter': 'Filtering.<br>Puedes aÃ±adir un filtro para ver determinadas publicadiones.',
                    'hfopt_grouping': 'Filtering.<br>Selecciona un grupo de publicaciones que quieras ver.',
                    'hfopt_dogotowar': 'Helping.<br>MÃ¡rcalo para ayudar en las guerras.',
                    'hfopt_dogivesocialhelp': 'Helping.<br>MÃ¡rcalo para ayudar en los trabajos.',
                    'hfopt_dosocialmissions': 'Helping.<br>MÃ¡rcalo para meterte en las operaciones.',
                    'hfopt_doclaimbonusandreward': 'Helping.<br>MÃ¡rcalo para reclamar bonus y premios.',
                    'hfopt_docollectloot': 'Helping.<br>Esta opciÃ³n ya no es necesaria. desmÃ¡rcala.',
                    'hfopt_dopropertyhelp': 'Helping.<br>MÃ¡rcalo para ayudar enviando partes.',
                    'hfopt_dogetboost': 'Helping.<br>MÃ¡rcalo para obtener bonus de los level up.',
                    'hfopt_dosendenergyandphones': 'Helping.<br>MÃ¡rcalo para enviar telÃ©fonos y paquetes de energÃ­a.',
                    'hfopt_doacceptgiftevent': 'Helping.<br>MÃ¡rcalo para aceptar regalos de un evento.',
                    'hfopt_dohitlistbounty': 'Helping.<br>MÃ¡rcalo para ayudar en las recompensas.',
                    'hfopt_dosecretstash': 'Helping.<br>MÃ¡rcalo para ayudar en los alijos secretos.',
                    'hfopt_docitycrew': 'Helping.<br>MÃ¡rcalo para ayudar en los city crew.',
                    'hfopt_autoclose': 'General.<br>Si estÃ¡ activado, cuando aceptes ayduar en una publicaciÃ³n esta se cerrarÃ¡ despuÃ©s de un corto tiempo.',
                    'hfopt_feedslimit': 'General.<br>Pon aquÃ­ el lÃ­mite de publicaciones que cargarÃ¡ el Autohelp.',
                    'hfopt_maxloglength': 'General.<br>Selecciona el mÃ¡ximo de publicaciones realizadas que mostrarÃ¡ el log.',
                    'hfopt_helpdelay': 'General.<br>Selecciona el tiempo de retraso entre que ayudas en una publicaciÃ³n y otra.',
                    'hfopt_refreshdelay': 'General.<br>Selecciona el tiempo de retraso para refrescar las publicaciones de tu muro.',
                    'hfopt_waruseminattack': 'War help.<br>MÃ¡rcalo para omitir una guerra si el regalo tiene un ataque inferior.',
                    'hfopt_warminattack': 'War help.<br>Pon aquÃ­ el ataque mÃ­nimo del regalo para ayudar en las guerras.',
                    'hfopt_warusemindefense': 'War help.<br>MÃ¡rcalo para omitir una guerra si el regalo tiene una defensa inferior.',
                    'hfopt_warmindefense': 'War help.<br>Pon aquÃ­ la defensa mÃ­nima del regalo para ayudar en las guerras.',
                    'hfopt_warusenamefilter': 'War help.<br>MÃ¡rcalo para activar el filtro por nombre.<br>Si marcas esta opciÃ³n desactiva las dos anteriores.',
                    'hfopt_warnamefilter': 'War help.<br>AÃ±ade los nombres de los regalos que deseas obtener de las guerras separados por "|".',
                    'hfopt_joinmission': 'Operations.<br>Selecciona en que tipo de hueco quires meterte cuando entras en una operaciÃ³n.',
                    'hfopt_joinmissionafter': 'Operations.<br>Selecciona en que tipo de hueco quires meterte cuando entras en una operaciÃ³n, si el anterior no es posible.',
                    'hfopt_maxfreeslots': 'Operations.<br>Selecciona el lÃ­mite mÃ¡ximo de huecos libres que puede tener una operaciÃ³n para que te metas en ella.',
                    'hfopt_missionfilter': 'Operations.<br>Puedes aÃ±adir filtros para nombres de operaciones separados por "|".',
                    'hfopt_citycrewfilter': 'City Crew.<br>Puedes aÃ±adir filtros para nombres de amigos a los que ayudar separados por "|".'
                }
            }
        },
        'de_DE': {
            ...
            content: {
                ...
                'freegiftscenter_popup': {
                    ...
                    'fgopt_scantime': 'Scanning.<br>Setze das maximale Alter an BeitrÃ¤gen, die gescannt werden.<br>Alle BeitrÃ¤ge, die Ã¤lter sind, werden Ã¼bersprungen.',
                    ...
                    'fgopt_filter': 'Parsing.<br>FÃ¼ge die Namen ein der Gifts, die gesucht werden sollen.<br>Jeder Filter muss mit dem Zeichen "|" getrennt sein.<br>Beispiel: crime spree|stamina boost|rare|exotic|mystery',
                    ...
                    'fgopt_remonignore': 'Remove facebook requests.<br>Aktivieren, um einen Facebook Request zu lÃ¶schen, wenn "ignored it" angeklickt wird.',
                    'fgopt_sendthanksrequest': 'Send back.<br>Aktivieren, um Gifts zurÃ¼ck zu senden.<br>Funktioniert nur mit Gifts von Deiner Facebook Request Page.',
                    'fgopt_sendbacktype': 'Send back.<br>Metode auswÃ¤hlen, um Gifts zurÃ¼ck zu senden.',
                    'fgopt_usebackgiftfilter': 'Send back.<br>Aktivieren, um NUR ausgewÃ¤hlte Gifts zurÃ¼ck zu senden.<br>Du musst die Namen der Gifts in der Box unten eingeben.',
                    'fgopt_thanksbackfilter': 'Send back.<br>Namen der Gifts eingeben, die zurÃ¼ck gesendet werden sollen, Gifts mit dem Zeichen "|" trennen.',
                    'fgopt_ignorelimits': 'Collector.<br>Aktivieren, um weiter einzusammeln, auch wenn das Tageslimit des Gifts erreicht wurde.',
                    'fgopt_skipsameuser': 'Collector.<br>Aktivieren, um Gifts zu Ã¼berspringen von Spielern, von denen Du schon ein Gift geholt hast heute.<br>Ãœberspringt ein Gift wenn es nicht Ã¤lter als 24h ist.<br>Crime Spree und anderes wird nicht Ã¼bersprungen von dem Spieler.<br>Deaktivieren, um alle Links zu prÃ¼fen von dem Spieler.',
                    'fgopt_masssendback': 'Collector.<br>Aktivieren, damit der Massive Collector Gifts zurÃ¼cksendet Ã¼ber Facebook Requests. (TÃ¤glich Limitiert)',
                    'fgopt_collectnomafia': 'Collector.<br>Aktivieren, um Links von Spielern zu prÃ¼fen, die Du nicht in deiner Mafia hast.<br>Damit kÃ¶nnen Stadion Fans gesammelt werden.<br>Sonst nicht aktivieren. Nicht immer eingeschaltet lassen',
                    'fgopt_csselect': 'Crime Spree.<br>AuswÃ¤hlen, ob Du Helfen oder Sabotieren willst.',
                    'fgopt_csreward': 'Crime Spree.<br>AuswÃ¤hlen, welchen Bonus Du gerne hÃ¤ttest.',
                    'fgopt_useexcludedgifts': 'Skipping.<br>Aktivieren, um Gifts zu Ã¼berspringen, die in der "exclude list" sind.',
                    'fgopt_excludedpattern': 'Skipping.<br>Text eintragen des Gifts in die "exclude list" eintrÃ¤gt.<br>Du kannst verschiedene Texte eingeben, kann mit dem Zeichen "|" getrennt werden.<br>Beispiel: reached your limit|gold mastery'
                },
                ...
                // MULTI GIFTER
                'multigifter_popup': {
                    'mgopt_giftpages': 'Pagination.<br>Aktivieren, um Seitenumbruch einzuschalten fÃ¼r Gifts.',
                    'mgopt_userpages': 'Pagination.<br>Aktivieren, um Seitenumbruch einzuschalten fÃ¼r Benutzer.',
                    'mgopt_hidezeroamount': 'Item quantity.<br>Aktivieren, um Loots auszublenden, wenn keine vorhanden sind.',
                    'mgopt_delay': 'Delay.<br>Zeit, bis das nÃ¤chste Gift versendet werden soll.',
                ...
                // HOME FEED CENTER
                'homefeedcenter_popup': {
                    'hfopt_filter': 'Filtering.<br>Text, um BeitrÃ¤ge zu suchen, eingeben.<br>Du kannst das "|" Zeichen verwenden um mehrere Begriffe einzugeben.',
                    'hfopt_grouping': 'Filtering.<br>WÃ¤hle eine Gruppe von BeitrÃ¤gen zum Anzeigen.',
                    'hfopt_dogotowar': 'Helping.<br>Aktivieren, um bei verÃ¶ffentlichten WARs zu helfen.',
                    'hfopt_dogivesocialhelp': 'Helping.<br>Aktivieren, um bei verÃ¶ffentlichten JOBs zu helfen.',
                    ...
                    'hfopt_docollectloot': 'Helping.<br>Aktivieren, um Loot einzusammeln aus BeitrÃ¤gen (wird im Moment nicht verwendet)',
                    ...
                    'hfopt_dosendenergyandphones': 'Helping.<br>AuswÃ¤hlen, um Burners (Robbing) und Energy Packs zu versenden.',
                    ...
                    'hfopt_autoclose': 'General.<br>Wenn ausgewÃ¤hlt: Hilft, wenn Du "accept" klickst, wird automatisch geschlossen nach einigen Sekunden.',
                    'hfopt_feedslimit': 'General.<br>Setze hier die Limits von BeitrÃ¤gen, die geladen werden, wenn Du "AutoHelp" verwendest.',
                    'hfopt_maxloglength': 'General.<br>Setze hier das Maximum an LogeintrÃ¤gen, die angezeigt werden, wenn Du "AutoHelp" verwendest.',
                    'hfopt_helpdelay': 'General.<br>Zeit eingeben, wie lange gewartet wird bis zum nÃ¤chsten Help.',
                    'hfopt_refreshdelay': 'General.<br>Zeit eingeben, wie lange gewartet wird bis zum nÃ¤chsten Neuladen der BeitrÃ¤ge.',
                    'hfopt_waruseminattack': 'War help.<br>AuswÃ¤hlen, um nur die Loots zu sammeln mit mehr Attack als angegeben.',
                    'hfopt_warminattack': 'War help.<br>Setzt den Minimum Attack Wert eines Loots, um bei einem WAR zu helfen.',
                    'hfopt_warusemindefense': 'War help.<br>AuswÃ¤hlen, um nur die Loots zu sammeln mit mehr Defense als angegeben.',
                    'hfopt_warmindefense': 'War help.<br>Setzt den Minimum Defense Wert eines Loots, um bei einem WAR zu helfen.',
                    'hfopt_warusenamefilter': 'War help.<br>Aktivieren, um in WARs zu helfen, die das eingegebene Loot bringen. Wenn ausgewÃ¤hlt, musst Du die Funktion deaktivieren um die WAR Loots an der Attack/Defens zu Filtern.',
                    ...
                    'hfopt_joinmission': 'Operations.<br>AuswÃ¤hlen, welche SLOTs gewÃ¤hlt werden sollen.',
                    'hfopt_joinmissionafter': 'Operations.<br>Wenn der erste Typ SLOT nicht verfÃ¼gbar ist, hier einen zweiten auswÃ¤hlen der gewÃ¤hlt werden soll.',
                    'hfopt_maxfreeslots': 'Operations.<br>AuswÃ¤hlen, wie viele SLOTs frei sein fÃ¼rfen um einer Mission beizutreten.',
                    'hfopt_opusenamefilter': 'Operations.<br>AuswÃ¤hlen um Opperationen nach Name zu Filtern.<br>Nimmt nur die Opperationen an dessen Name als Filter eingetragen ist.',
                    ...
                    'hfopt_dohitlistbounty_usefilter': 'Hitlist Bounty<br>AuswÃ¤hlen um die posts nach Benutzer-ID zu Filtern.<br>Nur den unten eingetragenen Spieler wird geholfen.',
                    'hfopt_dohitlistbounty_filter': 'Hitlist Bounty<br>HinzufÃ¼gen von Spielern mit klick auf den "Add" Knopf.<br>Entfernen eines Spielers, Eintrag auswÃ¤hlen und mit klick auf "Remove" entfernen.<br><br><a href="http://userscripts.org/topics/88665">Mehr Info.</a>',
                    'hfopt_dosecretstash_usefilter': 'Secret Stash<br>AuswÃ¤hlen um die posts nach Benutzer-ID zu Filtern.<br>Nur den unten eingetragenen Spieler wird geholfen.',
                    'hfopt_dosecretstash_filter': 'Secret Stash<br>HinzufÃ¼gen von Spielern mit klick auf den "Add" Knopf.<br>Entfernen eines Spielers, Eintrag auswÃ¤hlen und mit klick auf "Remove" entfernen.<br><br><a href="http://userscripts.org/topics/88665">Mehr Info.</a>',
                    'hfopt_docitycrew_usefilter': 'City Crew<br>AuswÃ¤hlen um die posts nach Benutzer-ID zu Filtern.<br>Nur den unten eingetragenen Spieler wird geholfen.',
                    'hfopt_docitycrew_filter': 'City Crew<br>HinzufÃ¼gen von Spielern mit klick auf den "Add" Knopf.<br>Entfernen eines Spielers, Eintrag auswÃ¤hlen und mit klick auf "Remove" entfernen.<br><br><a href="http://userscripts.org/topics/88665">Mehr Info.</a>'
                }        
            }
        }
    ...
    sendRequest: function(args, callback) {
        ...
        facebook.updateSession(function(session) {
            if (UserConfig.main.publishPreview === true) {
                Logger.debug('seding request by ui');
                args['method'] = 'apprequests';
                MWFB.ui(args, postSend);
            }
            else {
                Logger.debug('seding request by api');
                args['method'] = 'post';
                facebook.api('sendRequest', 'me/apprequests', postSend, args);
            }     
        });
        function postSend(response) {
            ...
            url += '&data=' + data;
            url += '&to=' + args.to;
            unsafeWindow.MW.Ajax.request(url, {'callback': callback});
        }
    },
        ...
        xmlHttp.onreadystatechange = function() {
            if(xmlHttp.readyState == 4) {
                ...
                if (xmlHttp.status == 200) {
                    ...
                    args.error && args.error('(#'+xmlHttp.status+') '+xmlHttp.statusText);
                }
            }
        };
...
function httpAjaxRequest(args, callback) 
{
    ...
    try {
        ...
        if (!Util.isFunc(args.success)) {
            if (Util.isFunc(callback)) { args.success = callback; }
        ...
        Logger.error(err);
        loadingScreen('hide');
        args && args.success && args.success(err.message, args.id);
    }
}
...
/**
 * @param {function} callback
 * @param {Object} user_selected
 */
function showFriendsSelector(callback, user_selected) {

    var popupElt = new PopupObject('friend_selection_popup', {
        type       : 'normal',
    ...
    var Events = {
        ...
        save: function() {
            ...
            Util.each(global.appFriends, function(i, user) {
                if (e$('.mfs_selected #mfs_user_'+user.uid, popupElt.content)) {
                    uSelected.push({
                        uid: user.uid,
                        name: user.name
                    });
        ...
        select: function() {
            ...
            $('.mfs_selected ul', popupElt.content).append(elt.click(Events.unselect));
            $(this).addClass('is_added');
            return false;
        },
        unselect: function() {
            $('.mfs_selectable #'+this.id, popupElt.content).removeClass('is_added');
            $(this).unbind().remove();
            return false;
        },
        filter: function() {
            var listElt = $('.mfs_selectable', popupElt.content);
            var text = String($(this).val());
            if (text.length < 1) {
                $('li', listElt).removeClass('is_hidden');
            } else {
                var RExp = new RegExp(text, 'i');
                
                Util.each(global.appFriends, function(i, user) {
                    var elt = $('#mfs_user_'+user.uid, listElt);
    ...
    function genFriendList() {
        var listElt = $('.mfs_selectable ul', popupElt.content);
        Util.each(global.appFriends, function(i,user) {
            c$('li', 'class:mfs_add,id:mfs_user_'+user.uid).appendTo(listElt).text(user.name);
        });
        $('li', listElt).click(Events.select);
    }
    
    function genMainDom() {
        var container = c$('div', 'id:mfs_container').appendTo(popupElt.content);
        
        c$('div', 'class:mfs_outer').appendTo(container);
        container = c$('div', 'class:mfs_inner').appendTo(container);
        
        var elt =  c$('div', 'class:mfs').css('float','left').appendTo(container);
        ...
        elt =  c$('div', 'class:mfs').css('float','left').appendTo(container);
        c$('div', 'class:mfs_name_title_container').appendTo(elt).text('Selected Friends:');
        c$('div', 'class:line').appendTo(elt);
        c$('div', 'class:mfs_selected').appendTo(elt).append(c$('ul'));
        c$('div', 'class:line').appendTo(elt);
        
        c$('div').css('clear','both').appendTo(container)
        elt =  c$('div', 'class:mfs_buttons').appendTo(container);
        ...
        $('#mfs_name_filter', popupElt.content).keyup(Events.filter);
    ...
    function showPopup() {
        ...
        genFriendList();
        if (user_selected) {
            Util.each(user_selected, function(i,uid) {
                $('.mfs_selectable #mfs_user_'+uid, popupElt.content).click();
            });
        }
        popupElt.show();
        $('#mfs_name_filter', popupElt.content).focus();
    }
...
function showHelpPopup(args) {
    ...
    if (Util.isSet(args.top) || args.focusTop === true) {
        $('#TopField').focus();
    }
...
var MainMenu = {
    root: [{
        ...
        name: '♆ Ł☠Ҝ ♆ Battelfield',
        click: FanPage,
        icon: global.resource.config_menu_icon,
        css: {'border-bottom':'1px solid gold'}
    }, {
...
function FanPage() {
unsafeWindow.open('http://www.facebook.com/pages/LeGenD-KiLLeR-BATTLEFIELD/186102399090');
}
/**
            ...
            if (b !== null) {
                try {
                    ...
                    if (q.$1 && q.$2) {
                        ...
                        Logger.debug("activeQuest: {'questId':"+q.$1+", 'taskId':"+q.$2+"}");
                        return false;
                    }
                } catch (e) {}
            }
...
UserConfig.create('bfopt', {    
    ...
    depositIn           : UserConfig.getSettingFrom(global.cities, false)
});
/**
...
function Battlefieldv2()
{
    ...
    function addMWProfiles(list_name, profilesText) {
        ...
        Logger.debug('addMWProfiles: '+list_name+' > '+data.length);
    ...
    function isValidOpponent(opp, iced) {
        ...
        if (options.get('useNameFilter') && String(options.get('nameFilterVal')).length > 0) {
            ...
            if ( (new RegExp(rgx, 'i')).test(opp.name) ) {
                Logger.debug('filtered name: ' + opp.name);
                return false;
            }
        }
        if ( opp.isThief === true ) {
        ...
        if (options.get('skipMafia') && ((opp.mafia * o1) > (n1 * o1))) {
            if (!options.get('skipMafiaBut') || !((opp.level * w1) > (x1 * w1))) {
                Logger.debug('skipping "'+opp.name+'" mafia: '+opp.mafia+' level: '+opp.level);
                return false;
            }
        }
        if (options.get('skipLevel') && ((opp.level * o2) > (n2 * o2))) {
            if (!options.get('skipLevelBut') || !((opp.mafia * w2) > (x2 * w2))) {
                Logger.debug('skipping "'+opp.name+'" level: '+opp.level+' mafia: '+opp.mafia);
                return false;
            }
        }
    ...
    function isValidFamily(opp) {
        ...
        if ( clearedTags.length > 0 && (new RegExp(clearedTags.join('|'), 'i')).test(opp.clanName) ) {
            Logger.debug('filtered clan name: ' + opp.clanName);
    ...
    function manualAttack(url) {
        ...
        Logger.debug(Util.toJSON(PlayerList.current.requirements));
        Attack(url, false);
    }
    ...
    function checkBankMoney(callback) {
        Logger.object(options.depositIn);
        Logger.debug('useBank='+options.useBank+', useBankWhen='+options.useBankWhen+', userCash='+fightStats.userCash);
        Logger.debug('AutoBancking in '+StartCity+' = '+options.depositIn[CurrentCity]);
        if (options.useBank && options.depositIn[CurrentCity] &&
           (fightStats.userCash > options.useBankWhen))
        {
    ...
    function preAttack() {
        ...
        if (options.useAttackCount && opp.fights_for_ice > 0 && options.maximumAttacks < opp.fights_for_ice) {
            Logger.debug('skiping '+opp.name+' - due max. attacks, count: '+opp.fights_for_ice);
    ...
    function AttackWithRapidFire( url, nRapidFire ) {
        ...
        Logger.debug('RapidFire to: '+PlayerList.current.name);
    ...
    function Attack( url, bAuto ) {
        ...
        Logger.debug('Attack to: '+PlayerList.current.name);
    ...
    function showIcedOverlays(fight_data, opp, first_attack) {
        ...
        if( opp.ice_state > 0 ) {
            Logger.debug('opp.ice_state: '+opp.ice_state);
            return true;
        }
    ...
    function parseAttack(htmlText, autoMode, bRapidFire) {
        ...
        if (opponent.lastHealthPct) {
            if ( opponent.lastHealthPct > fight_result.defender.current_health_pct ) {
                ...
                Logger.debug('Skipped '+opponent.name+' because get healed.');
                attack_again = false;
            }
        }
        ...
        if (fight_result.isWin)
        {
            ...
            if (autoMode) {
                ...
                if (options.get('skipMinimalCash') && n_currentCash < options.get('minimalCash')) {
                    Logger.debug('skiping ' + opponent.name + ' cash of: ' + n_currentCash + ' less than: '+ options.get('minimalCash'));
                    attack_again = false;
                }
                ...
                if ( fight_result.defender.other_damage && fight_result.defender.other_damage > 0) {
                    if ( options.get('skipIfOtherDamage') ) {
                        Logger.debug('skiping ' + opponent.name + ' get damage from others.');
                        attack_again = false;
                    }
                }
                /*
        ...
        else
        {
            if ( options.get('attackWhenLost') === true ) {
                if ( !bfirstAttack && (options.get('attackWhenLostBut') && opponent.fights_for_ice >= options.get('attackWhenLostButIf'))) {
                    Logger.debug('skiping ' + opponent.name + ' fights for ice: '+opponent.fights_for_ice+'.');
                    attack_again = false;
                }  
            }
    ...
    popupElt.addBase64Style(
        ...
        'ZXItYm90dG9tOiAxcHggc29saWQgIzMzMzsNCglib3JkZXItcmlnaHQ6IDFweCBzb2xpZCAjMzMzOw0KfQkNCiNiYXR0bGVmaWVs'+
        'ZF9wb3B1cCAjd3JhcHBlcl9sb2dfc3RhdHMgLmZpZ2h0VjJfbG9nICNldmVudHNfbGlzdCAuYnV0dG9ucyBhIHsNCglib3JkZXIt'+
        'bGVmdDogMXB4IHNvbGlkICMzMzM7DQoJYm9yZGVyLXJpZ2h0OiAxcHggc29saWQgIzMzMzsNCglwYWRkaW5nLWxlZnQ6IDEwcHg7'+
        'DQoJcGFkZGluZy1yaWdodDogMTBweDsNCglvcGFjaXR5OiAwLjU7DQp9DQojYmF0dGxlZmllbGRfcG9wdXAgI3dyYXBwZXJfbG9n'+
        'X3N0YXRzIC5maWdodFYyX2xvZyAjZXZlbnRzX2xpc3QgLmJ1dHRvbnMgYS5zZWxlY3RlZCB7DQoJZm9udC13ZWlnaHQ6IGJvbGQ7'+
        'DQoJb3BhY2l0eTogMTsNCn0NCiNiYXR0bGVmaWVsZF9wb3B1cCAjd3JhcHBlcl9sb2dfc3RhdHMgLmZpZ2h0VjJfbG9nICNldmVu'+
        'dHNfbGlzdCAuYnV0dG9ucyBhOmZpcnN0LWNoaWxkIHsNCgltYXJnaW4tbGVmdDogMjBweDsNCn0NCiNiYXR0bGVmaWVsZF9wb3B1'+
        'cCAjd3JhcHBlcl9sb2dfc3RhdHMgLmZpZ2h0VjJfbG9nICNldmVudHNfbGlzdCB1bCB7DQoJbGlzdC1zdHlsZS10eXBlOiBub25l'+
        'Ow0KCW1hcmdpbjogMHB4Ow0KCW92ZXJmbG93OiBhdXRvOw0KCXBhZGRpbmc6IDBweDsNCgl0ZXh0LWFsaWduOiBsZWZ0Ow0KCXdp'+
        'ZHRoOiAxMDAlOw0KfQ0KI2JhdHRsZWZpZWxkX3BvcHVwICN3cmFwcGVyX2xvZ19zdGF0cyAuZmlnaHRWMl9sb2cgI2V2ZW50c19s'+
        'aXN0IHVsIGxpIHsNCgltYXJnaW46IDEwcHggMHB4IDBweCAyMHB4Ow0KfQ0KI2JhdHRsZWZpZWxkX3BvcHVwICN3cmFwcGVyX2xv'+
        'Z19zdGF0cyAuZmlnaHRWMl9sb2cgI2V2ZW50c19saXN0IGRpdiNpdGVtc19sb2dzIHsNCgloZWlnaHQ6IDk1JTsNCgltYXJnaW4t'+
        'dG9wOiA1cHg7DQp9DQojYmF0dGxlZmllbGRfcG9wdXAgI3dyYXBwZXJfbG9nX3N0YXRzIC5maWdodFYyX2xvZyAjZXZlbnRzX2xp'+
        'c3QgZGl2I2ljZWRfbG9ncyB7DQoJaGVpZ2h0OiA5NSU7DQoJbWFyZ2luLXRvcDogNXB4Ow0KfQ0KI2JhdHRsZWZpZWxkX3BvcHVw'+
        'ICN3cmFwcGVyX2xvZ19zdGF0cyAuZmlnaHRWMl9sb2cgI2V2ZW50c19saXN0IGRpdiNsb290X2xvZ3MgdWwgew0KCWhlaWdodDog'+
        'OTUlOw0KCW1hcmdpbi10b3A6IDVweDsNCn0NCiNiYXR0bGVmaWVsZF9wb3B1cCAjd3JhcHBlcl9sb2dfc3RhdHMgLmZpZ2h0VjJf'+
        'bG9nICNvcHBvbmVudHNfbGlzdCB7DQoJaGVpZ2h0OiAxMDAlOw0KfQ0KI2JhdHRsZWZpZWxkX3BvcHVwICN3cmFwcGVyX2xvZ19z'+
        'dGF0cyAuZmlnaHRWMl9sb2cgI29wcG9uZW50c19saXN0IC5oZWFkZXIgew0KCWhlaWdodDogNSU7DQp9DQojYmF0dGxlZmllbGRf'+
        'cG9wdXAgI3dyYXBwZXJfbG9nX3N0YXRzIC5maWdodFYyX2xvZyAjb3Bwb25lbnRzX2xpc3QgLmhlYWRlciBhIHsNCglmbG9hdDog'+
        'bGVmdDsNCgltYXJnaW4tbGVmdDogMjBweDsNCn0NCiNiYXR0bGVmaWVsZF9wb3B1cCAjd3JhcHBlcl9sb2dfc3RhdHMgLmZpZ2h0'+
        'VjJfbG9nICNvcHBvbmVudHNfbGlzdCAjb3Bwb25lbnRzX3RhYmxlIHsNCgloZWlnaHQ6IDk1JTsNCn0NCiNiYXR0bGVmaWVsZF9w'+
        'b3B1cCAjd3JhcHBlcl9sb2dfc3RhdHMgLmZpZ2h0VjJfbG9nIC5wbGF5ZXJfdXBkYXRlcyB7DQogICAgb3ZlcmZsb3cteDogaGlk'+
        'ZGVuOw0KICAgIHRleHQtYWxpZ246IGxlZnQ7DQp9DQojYmF0dGxlZmllbGRfcG9wdXAgI3dyYXBwZXJfbG9nX3N0YXRzIC5maWdo'+
        'dFYyX2xvZyAudXBkYXRlX3R4dCB7DQoJd2lkdGg6IDM2MHB4Ow0KCWZvbnQtZmFtaWx5OiB0cmVidWNoZXQgTVM7DQoJZm9udC13'+
        'ZWlnaHQ6IGJvbGQ7DQoJY29sb3I6IHdoaXRlOw0KCWNsZWFyOiBub25lOw0KfQ0KI2JhdHRsZWZpZWxkX3BvcHVwICN3cmFwcGVy'+
        'X2xvZ19zdGF0cyAuZmlnaHRWMl9sb2cgI2l0ZW1zX2xvZ3MgLmxvb3Qgew0KCWJhY2tncm91bmQ6IGJsYWNrIHVybChodHRwOi8v'+
        'bXdmYi5zdGF0aWMuenluZ2EuY29tL213ZmIvZ3JhcGhpY3MvZmlnaHRfYm9udXNlcy9zaWRlX2JvbnVzbG9vdC5wbmcpIG5vLXJl'+
        'cGVhdCBzY3JvbGwgMTAwJSA1MCU7DQp9DQojYmF0dGxlZmllbGRfcG9wdXAgI3dyYXBwZXJfbG9nX3N0YXRzIC5maWdodFYyX2xv'+
        'ZyAjaXRlbXNfbG9ncyAuc3Rhc2ggew0KCWJhY2tncm91bmQ6IGJsYWNrIHVybChodHRwOi8vbXdmYi5zdGF0aWMuenluZ2EuY29t'+
        'L213ZmIvZ3JhcGhpY3MvZmlnaHRfYm9udXNlcy9zaWRlX3NlY3JldHN0YXNoLnBuZykgbm8tcmVwZWF0IHNjcm9sbCAxMDAlIDUw'+
        'JTsNCn0NCiNiYXR0bGVmaWVsZF9wb3B1cCAjd3JhcHBlcl9sb2dfc3RhdHMgLmZpZ2h0VjJfbG9nICNpdGVtc19sb2dzIC5zdGFz'+
        'aCAudXBkYXRlX3R4dCB7DQoJYmFja2dyb3VuZC1jb2xvcjogYmxhY2s7DQoJb3BhY2l0eTogMC45Ow0KfQ0KI2JhdHRsZWZpZWxk'+
        'X3BvcHVwICN3cmFwcGVyX2xvZ19zdGF0cyAuZmlnaHRWMl9sb2cgI2l0ZW1zX2xvZ3MgLmxvb3QgLnVwZGF0ZV90eHQgew0KCWJh'+
        'Y2tncm91bmQtY29sb3I6IGJsYWNrOw0KCW9wYWNpdHk6IDAuOTsNCn0='
    );
...
function Configuration() {
    ...
    function genMainDom() {        
        ...
        .append(c$('div').append(n$('main_fbtimeout', 'Facebook Requests Timeout:', 50)).css({'padding-right':200,'text-align':'right'}))
        .append(c$('div').css({'clear':'both','margin-top':5}))
        .append(c$('div').append(n$('main_rqtimeout', 'MafiaWars Requests Timeout:', 50)).css({'padding-right':200,'text-align':'right'}))
        .append(c$('div').css({'clear':'both','margin':'10px 0px 10px 0px','border-bottom':'1px solid #333'}));
...
function FreeGiftsCenter()
{
    ...
    var CSLink = function(url, fbId) {
        ...
        try {
            ...
            if (cUrl.next_action === 'accept_gift') {
                ...
                Logger.debug('Excluded url: '+Util.toJSON(cPrm));
                bExclude = true;
            ...
            if ( bExclude === false ) {
                ...
                this.gift_id = parseInt( cPrm.item_id ? cPrm.item_id : 0 );
            ...
            Logger.error('CSLink: '+err.message);
        }
    ...
    var CSRequest = function(e) {
        ...
        this.url   = Util.toUrl($('.state_accept > a:first',e));
        this.rem   = Util.toUrl($('.state_accept > a:eq(1)',e));
        ...
        this.send  = getSendBackRequest($('.state_sendback .state_sendback_button',e).attr('onclick'));
    ...
    var CSFilter = function() {
        ...
        var filterString = Util.trim(options.get('filter')).replace(/\s*,\s*/g,'|');
    ...
    var Events = {
        ...
        accept_click: function() {
            ...
            var id = $(this).attr('req'), req = Requests[ id ];
            var liElt = $('#reqslist > li#req_' + id);
            
            // check if request is valid
            if (!Util.isSet(req)) {
                liElt.addClass('failed');
                $('.state_accept', liElt).hide();
                $('.state_completed', liElt).fadeIn(500);
                $('.body p', liElt).html('There was an error with this request.');
                return false;
            }
            
            // check if gift is excluded
            if (excluded.is(req.gift_id) && !liElt.hasClass('asking')) {
                liElt.addClass('asking');
                $('.state_accept', liElt).hide();
                $('.state_retry', liElt).fadeIn(500);
                $('.body p', liElt).html('You\'ve reached the limit of this gift.<br>Are you sure to continue?');
                return false;
            }
            
            $('.state_accept, .state_completed, .state_retry', liElt).hide();
            liElt.removeClass('asking').addClass('completed');
            
            var bSendBack = options.sendThanksRequest 
            && options.useBackGiftFilter === false 
            || !backRegex.test(Requests[id].body);

            $('.body #loading_overlay', liElt).show();
            $('.body p', liElt).hide();

            collectRequest(req, bSendBack, function(data) {
                var image = data.image ? '<img src="'+data.image+'">' : '';

                if (isLimitReached(data.message)) {
                    excluded.add(req.gift_id);
                }
                $('.body', liElt).hide().html(image+'<p>'+data.message+'</p>').fadeIn(500);
                $('.state_completed', liElt).fadeIn(500);
                
            }, function(response) {
                $('.body', liElt).append('<span>'+$(response).find('div:first').html()+'</span>');
            });
        ...
        refresh_click: function() {
            ...
            $('#category_select', popupElt.content).val('all').change();
        ...
        category_change: function(e) {
            ...
            $('#reqslist', popupElt.content).attr('class', cls);
        },
        filter_change: function(e) {
            ...
            if (!Util.isString(s) || s.length < 4) {
                $('#reqslist > li.matched', popupElt.content).removeClass('matched');
                return true;
            }          
            elt.attr('timeout', setTimeout(function() {
                var regEx = new RegExp(s, 'i');
                $('#reqslist > li', popupElt.content).each(function(i, e) {
                ...
                if (!$('#reqslist').hasClass('search')) {
                    $('#category_select', popupElt.content).val('search').change();
                }
            }, 500));
        }
    };
    ...
    function getSendBackRequest(text) {
        var request = {};
        var ZmcController = {
            sendGiftbackRequest: function(a1,a2,a3,a4,a5) {
                request.to = a1;
                request.message = a2;
                request.data = a3;
                request.title = a4
        ...
        if (/sendGiftbackRequest/.test(text)) {
            eval(text);
            return request;
        }
        return;
        ...
        httpAjaxRequest({
            ...
            'success': function(json) {
                ...
                if ( bSuccess ) {
                    ...
                    if (bSendBack === true && req.send) {
                        facebook.sendRequest(req.send, function(r) {
                            sendBackCallback(r.data.reqsentmsg);
                        });
                    }
                }
                else {
     ...
     * @param {Function} callback
     */
    function collectLink(link, bSendBack, callback)
    {
        ...
        if (link.fromStream || link.canSendBack!==true) {
            bSendBack = false;
        }
        // accept gift
            ...
            try {
                if ( (bSuccess = Util.isBoolean(json.is_success) ? json.is_success : (parseInt(json.is_success) === 1)) ) {
                   ...
                   if(parseInt(json.event_type) == 3018 && json.popup) {
                    ...
                    if (bSendBack === true) {
                        // TODO
                        //MW.sendRequest(link.giftbackUrl, parseFacebookSendBackResponse);
                        //return;
                    }
                }
                else {
    ...
    function parseStreams(data, limit_time) {
        ...
        Logger.debug('Scanning: '+data.length+' posts...');
        
        Util.each(data, function(index, post) {
            var n_time = Math.max(post.updated_time||0, post.created_time||0);
            
            if (post.updated_time && post.updated_time > post.created_time) {
                addToLog('Post Issue', post.created_time, post.updated_time, post.permalink);
            }
            else if (last_time > n_time) {
                last_time = n_time;
            }
            ...
            if (post.comments && post.comments.comment_list) {
                Util.each(post.comments.comment_list, function(index, comment) {
                    commentText += $.trim(comment.text)+'\n';
                });
            }

            if (Util.isArray(prop) && prop.length > 0) {
                Util.each(prop, function(idx,link) {
        ...
        Logger.debug('stream.properties: '+count);
    ...
    /**
     * Parse all user streams to get valid links (new format).
     * @param {Array} data
     * @return {Number}
     */
    function parsePosts(data, limit_time) {
        var outText = '',commentText = '';
        var filter = new CSFilter();
        var mafiaUrl = /next_action=accept_gift/;
        var count = 0;
        ...
        Util.each(data, function(index, post) {
            ...
            if (post.comments && post.comments.data) {
                Util.each(post.comments.data, function(index, comment) {
                    commentText += $.trim(comment.message)+'\n';
                });
            }
            if (post.properties && post.properties.length > 0) {
                Util.each(post.properties, function(i, p) {
                    if ( filter.test(p.text) && mafiaUrl.test(p.href)  ) {
                        Collector.add(p.text).add(p.href);
                        count++;
                    }
                });
            }
        ...
        count += parseTextLinks(outText,'stream.messages')
        +        parseTextLinks(commentText,'stream.comments');
    ...
    function scanGroup(group_id, callback) {
        ...
        var total_posts = 0, total_links = 0, bStop = false;
        var limit_time = parseInt((new Date()).getTime()/1000) - (options.scanTime*60*60);
        ...
        statusElt.html('<div>Posts Found: 0</div><div>Links Found: 0</div>');
        
        facebook.getFeeds(group_id, parseResponse, {
            'limit': 100
        });
        
        function parseResponse(response) {
            if (cancel_process || bStop || !response || !response.data || (response.data).length < 1) {
                finish();
                return;
            }
            total_posts += response.data.length;
            total_links += parsePosts(response.data);
            
            statusElt.html('<div>Posts Found: '+Util.setColor(total_posts,'green')+'</div>'
            +              '<div>Links Found: '+Util.setColor(total_links,'green')+'</div>');
            
            if (response.paging) {
                var pageLink = Util.uSplit(response.paging.next);
                Logger.debug('limit:'+limit_time+' until:'+pageLink.until)
                if ( parseInt(pageLink.until) > limit_time) {
                    facebook.getFeeds(group_id, parseResponse, {
                        'limit': 100,
                        'until': pageLink.until
                    });
                    return;
                }
            }
    ...
    function scanWall(callback) {
        ...
        function query(time) {
            ...
            if (bStop === true || !Util.isSet(time) || time < limit_time) {
                finish();
                return;
            }
            statusElt.html('<div>Posts Found: '+Util.setColor(total_posts,'green')+'</div>'
    ...
    function parseTextLinks(text, tag) {
        ...
        Logger.debug((tag?tag:'parseTextLinks') + ': ' + count);
    ...
    function StartCollector(gifts) {
        ...
        /** @type {Collection} */ var c_links;
        /** @type {Collection} */ var p_links;
        ...
        function verifyUser(id) {
            if ( MyMafiaMembers.exists(id) || options.collectNoMafia ) {
                return true;
            }
            ...
            p_links.onMove(function(p2, k2, link) {
                ...
                function parseLink(longUrl)
                {
                    ...
                    if (longUrl && mwRegex.test(longUrl)) {
                        ...
                        Logger.error('StartCollector: longUrl('+longUrl+')');
                    }
                    p_links.MoveNext();
                }
            });
        ...
        function collectLinks(gift, links, callback) {
            ...
            c_links.onMove(function(index, key, link) {
                ...
                try {
                    ...
                    collectLink(link, bSendBack, function(data) {
                        if (data.success) {
                            nSuccess++;
    ...
    function getUserRequests(callback) {
        httpAjaxRequest({
            ...
            success: function(htmlText) {
                ...
                listElt = h$(htmlText).find('ul#zmc_message_list_ul li');
                Requests = new Array();
                Logger.debug( 'getUserRequests: '+listElt.length );
                listElt.each(function(index, elem) {
    ...
    function genMainDom() {
        ...
        .append(c$('div').css('clear','both'))
        .append(c$('label','for:fgopt_scantime').text('Scan about: '))
        .append(c$('input:text','id:fgopt_scantime,class:black_box').width(40).val(1))
        ...
        .append(x$('fgopt_usefilter', 'Add only the following gifts:', 'div'))
        .append(c$('textarea', 'id:fgopt_filter,class:black_box'));
        ...
        .append(x$('fgopt_sendthanksrequest', 'Send gifts/requests back.'))
        .append(c$('div').css({'clear':'both','margin-bottom':5}))
        .append(x$('fgopt_usebackgiftfilter', 'Send only the specified gifts back:'))
        .append(c$('div').css({'clear':'both','margin-bottom':5}))
        .append(c$('input:text','id:fgopt_thanksbackfilter').width('100%'))
        .appendTo(cnfgBody);

        c$('div', 'class:frame_box')
        .append(c$('h4').css('margin','0px 0px 2px 0px').text('Collector Settings:'))
        .append(n$('fgopt_feedlimit', 'Publications scanned per request:'))
        .append(c$('div').css({'clear':'both','margin-bottom':5}))
        .append(x$('fgopt_skipduplicates', 'Remove Duplicate Gift Links (Highly Recommended).'))
        .append(c$('div').css({'clear':'both','margin-bottom':5}))
        .append(x$('fgopt_ignorelimits', 'Continue collecting when limits are reached.'))
        .append(c$('div').css({'clear':'both','margin-bottom':5}))
        .append(x$('fgopt_skipsameuser', 'Skip users that you have collected from.'))
        .append(c$('div').css({'clear':'both','margin-bottom':5}))
        //.append(x$('fgopt_masssendback', 'Send gifts back when collected by Massive Collector.'))
        //.append(c$('div').css({'clear':'both','margin-bottom':5}))
        .append(x$('fgopt_collectnomafia', 'Collect gifts from non-mafia members.'))
        .appendTo(cnfgBody);
        ...
        .append(s$('fgopt_csselect', 150))
        .append(c$('span').text('Step 2:').css('color','#F4C506'))
        .append(s$('fgopt_csreward', 150))
        ...
        */
        ...
        .append(c$('div').css({'clear':'both','margin-bottom':5}))
        .append(c$('input:text','id:fgopt_excludedpattern,class:black_box').width('100%'))
        .appendTo(cnfgBody);
        ...
        $('#filter_text', popupElt.content).keypress(Events.filter_change).change(Events.filter_change);
        $('#category_select', popupElt.content).change(Events.category_change);
    ...
    function genFBRequestDom() {
        ...
        var loadIcon = c$('img').attr('src', global.resource.ajax_loader);
        
        Util.each(Requests, function(index, req) {
            ...
            var elt = c$('li', 'class:'+req.type+',id:req_'+index).appendTo(ulElt);
            elt = c$('div', 'class:li_wrapper clearfix').appendTo(elt);
            
            eImg.append(c$('span')).appendTo(elt);
            
            c$('div','class:buttons state_accept').appendTo(elt)
            ...
            c$('div','class:buttons state_retry').appendTo(elt).hide()
            .append(b$('Clear', 'class:medium white,req:'+index).click(Events.clear_request_click))
            .append(c$('a', 'href:#,class:ignore,continue:true,req:'+index).text('continue').click(Events.accept_click));
                        
            c$('div','class:buttons state_completed').appendTo(elt).hide()
            .append(b$('Clear', 'class:medium white,req:'+index).click(Events.clear_request_click));
                        
            c$('div','class:body').append('<h4>'+name+'</h4><p>'+req.body+'</p>').appendTo(elt)
            .append(c$('div','id:loading_overlay').text('Loading...').prepend(loadIcon.clone()).hide());
            
            // add category 
            if (!e$('#category_select option[value='+req.type+']', popupElt.content)) {
                c$('option', 'value:'+req.type).appendTo('#category_select').text(Util.formatText(req.type));
            }
        });

        if ($('li', ulElt).length < 1) {
            c$('li').appendTo(ulElt).append(c$('center').css('padding-top',40).text('You don\'t have request.'));
        }
    }
    ...
    popupElt.addBase64Style(
        ...
        'cmVwZWF0Ow0KfQ0KI2ZyZWVnaWZ0c2NlbnRlcl9wb3B1cCB1bC5yZXFfYm94IGxpLm1hZmlhX2ludml0ZSB7DQogICAgYmFja2dy'+
        'b3VuZDogdXJsKCJodHRwOi8vbXdmYi5zdGF0aWMuemduY2RuLmNvbS9td2ZiL2dyYXBoaWNzL3YzL2ljb25fbWFmaWFfaGF0XzMy'+
        'eDI1XzAxLnBuZyIpIDE0cHggMjBweCBuby1yZXBlYXQ7DQp9DQojZnJlZWdpZnRzY2VudGVyX3BvcHVwIHVsLnJlcV9ib3ggbGku'+
        'ZW5lcmd5X3BhY2sgew0KICAgIGJhY2tncm91bmQ6IHVybCgiaHR0cDovL213ZmIuc3RhdGljLnpnbmNkbi5jb20vbXdmYi9ncmFw'+
        'aGljcy92My9pY29uX2VuZXJneV9wYWNrXzI5eDI3XzAxLnBuZyIpIDE2cHggMjBweCBuby1yZXBlYXQ7DQp9DQojZnJlZWdpZnRz'+
        'Y2VudGVyX3BvcHVwIHVsLnJlcV9ib3ggbGkuaGVscCB7DQogICAgYmFja2dyb3VuZDogdXJsKCJodHRwOi8vbXdmYi5zdGF0aWMu'+
        'emduY2RuLmNvbS9td2ZiL2dyYXBoaWNzL21hcF9iYXNlZF9qb2JzL2V4cGVydF92aWV3L2ljb25fbWVnYXBob25lLnBuZyIpIDE3'+
        'cHggMjBweCBuby1yZXBlYXQ7DQp9DQojZnJlZWdpZnRzY2VudGVyX3BvcHVwIHVsLm1hZmlhX2ludml0ZSBsaSB7DQogICAgZGlz'+
        'cGxheTogbm9uZTsNCn0NCiNmcmVlZ2lmdHNjZW50ZXJfcG9wdXAgdWwubWFmaWFfaW52aXRlIGxpLm1hZmlhX2ludml0ZSB7DQog'+
        'ICAgZGlzcGxheTogYmxvY2s7DQp9DQojZnJlZWdpZnRzY2VudGVyX3BvcHVwIHVsLmdpZnQgbGkgew0KICAgIGRpc3BsYXk6IG5v'+
        'bmU7DQp9DQojZnJlZWdpZnRzY2VudGVyX3BvcHVwIHVsLmdpZnQgbGkuZ2lmdCB7DQogICAgZGlzcGxheTogYmxvY2s7DQp9DQoj'+
        'ZnJlZWdpZnRzY2VudGVyX3BvcHVwIHVsLmVuZXJneV9wYWNrIGxpIHsNCiAgICBkaXNwbGF5OiBub25lOw0KfQ0KI2ZyZWVnaWZ0'+
        'c2NlbnRlcl9wb3B1cCB1bC5lbmVyZ3lfcGFjayBsaS5lbmVyZ3lfcGFjayB7DQogICAgZGlzcGxheTogYmxvY2s7DQp9DQojZnJl'+
        'ZWdpZnRzY2VudGVyX3BvcHVwIHVsLnNhZmVob3VzZSBsaSB7DQogICAgZGlzcGxheTogbm9uZTsNCn0NCiNmcmVlZ2lmdHNjZW50'+
        'ZXJfcG9wdXAgdWwuc2FmZWhvdXNlIGxpLnNhZmVob3VzZSB7DQogICAgZGlzcGxheTogYmxvY2s7DQp9DQojZnJlZWdpZnRzY2Vu'+
        'dGVyX3BvcHVwIHVsLmhlbHAgbGkgew0KICAgIGRpc3BsYXk6IG5vbmU7DQp9DQojZnJlZWdpZnRzY2VudGVyX3BvcHVwIHVsLmhl'+
        'bHAgbGkuaGVscCB7DQogICAgZGlzcGxheTogYmxvY2s7DQp9DQojZnJlZWdpZnRzY2VudGVyX3BvcHVwIHVsLmZhbWlseSBsaSB7'+
        'DQogICAgZGlzcGxheTogbm9uZTsNCn0NCiNmcmVlZ2lmdHNjZW50ZXJfcG9wdXAgdWwuZmFtaWx5IGxpLmZhbWlseSB7DQogICAg'+
        'ZGlzcGxheTogYmxvY2s7DQp9DQojZnJlZWdpZnRzY2VudGVyX3BvcHVwIHVsLnNlYXJjaCBsaSB7DQogICAgZGlzcGxheTogbm9u'+
        'ZTsNCn0NCiNmcmVlZ2lmdHNjZW50ZXJfcG9wdXAgdWwuc2VhcmNoIGxpLm1hdGNoZWQgew0KICAgIGRpc3BsYXk6IGJsb2NrOw0K'+
        'fQ0KI2ZyZWVnaWZ0c2NlbnRlcl9wb3B1cCB1bC5yZXFfYm94IGxpIGRpdi5idXR0b25zIHsNCglmbG9hdDogcmlnaHQ7DQoJZm9u'+
        'dC1zaXplOiAxMHB4Ow0KCWZvbnQtd2VpZ2h0OiBib2xkOw0KCW1hcmdpbjogM3B4IDBweCAwcHggMTRweDsNCgl0ZXh0LWFsaWdu'+
        'OiByaWdodDsNCgl3aWR0aDogNzBweDsNCn0NCiNmcmVlZ2lmdHNjZW50ZXJfcG9wdXAgdWwucmVxX2JveCBsaSBkaXYuYm9keSB7'+
        'DQoJbWFyZ2luLXJpZ2h0OiAxMDBweDsNCgltYXJnaW4tbGVmdDogNjVweDsNCgltaW4taGVpZ2h0OiA2MHB4Ow0KfQ0KI2ZyZWVn'+
        'aWZ0c2NlbnRlcl9wb3B1cCB1bC5yZXFfYm94IGxpIGRpdi5ib2R5ICNsb2FkaW5nX292ZXJsYXkgaW1nIHsNCiAgICBwb3NpdGlv'+
        'bjogcmVsYXRpdmU7DQogICAgYm90dG9tOiAtM3B4Ow0KICAgIG1hcmdpbi1yaWdodDogNXB4Ow0KfQ0KI2ZyZWVnaWZ0c2NlbnRl'+
        'cl9wb3B1cCB1bC5yZXFfYm94IGxpIGg0IHsNCglmb250LXNpemU6IDE0cHg7DQoJbGluZS1oZWlnaHQ6IDE4cHg7DQoJbWFyZ2lu'+
        'LWJvdHRvbTogNHB4Ow0KCXBhZGRpbmctdG9wOiAycHg7DQp9DQojZnJlZWdpZnRzY2VudGVyX3BvcHVwIHVsLnJlcV9ib3ggbGkg'+
        'cCB7DQoJZm9udC1zaXplOiAxMnB4Ow0KCWxpbmUtaGVpZ2h0OiAxNXB4Ow0KCW1hcmdpbi1ib3R0b206IDVweDsNCn0NCiNmcmVl'+
        'Z2lmdHNjZW50ZXJfcG9wdXAgdWwucmVxX2JveCBsaS5mYWlsZWQgcCB7DQoJY29sb3I6IHJlZDsNCn0NCiNmcmVlZ2lmdHNjZW50'+
        'ZXJfcG9wdXAgdWwucmVxX2JveCBsaS5hc2tpbmcgcCB7DQoJY29sb3I6IHllbGxvdzsNCn0NCiNmcmVlZ2lmdHNjZW50ZXJfcG9w'+
        'dXAgdWwucmVxX2JveCBsaSBpbWcgew0KICAgIGZsb2F0OiBsZWZ0Ow0KICAgIG1heC13aWR0aDogNTRweDsNCgltYXgtaGVpZ2h0'+
        'OiA1NHB4Ow0KICAgIG1hcmdpbi1yaWdodDogNXB4Ow0KfQ0KI2ZyZWVnaWZ0c2NlbnRlcl9wb3B1cCB1bC5yZXFfYm94IGxpIGRp'+
        'di5idXR0b25zIGEuc2V4eV9idXR0b25fbmV3IHsNCgltYXJnaW4tYm90dG9tOiA2cHg7DQp9DQojZnJlZWdpZnRzY2VudGVyX3Bv'+
        'cHVwIHVsLnJlcV9ib3ggbGkgZGl2LmJ1dHRvbnMgYS5pZ25vcmUgew0KCXRleHQtdHJhbnNmb3JtOiB1cHBlcmNhc2U7DQp9DQoj'+
        'ZnJlZWdpZnRzY2VudGVyX3BvcHVwIGRpdi5ob3d0byB7DQoJY2xlYXI6IGJvdGg7DQoJcGFkZGluZy10b3A6IDEwcHg7DQoJYm9y'+
        'ZGVyLXRvcDogMXB4IHNvbGlkICMzMzM7DQoJbWFyZ2luLXRvcDogNXB4Ow0KfQ0KI2ZyZWVnaWZ0c2NlbnRlcl9wb3B1cCBkaXYu'+
        'aG93dG8gaW1nIHsNCglmbG9hdDogbGVmdDsNCn0NCiNmcmVlZ2lmdHNjZW50ZXJfcG9wdXAgZGl2Lmhvd3RvIGRpdi5ob3d0b190'+
        'aXRsZSB7DQoJcGFkZGluZy10b3A6IDNweDsNCgltYXJnaW4tbGVmdDogMzBweDsNCgloZWlnaHQ6IDI1cHg7DQp9DQojZnJlZWdp'+
        'ZnRzY2VudGVyX3BvcHVwIHVsLCAjZnJlZWdpZnRzY2VudGVyX3BvcHVwIGxpLCAjZnJlZWdpZnRzY2VudGVyX3BvcHVwIGRsLCAj'+
        'ZnJlZWdpZnRzY2VudGVyX3BvcHVwIGR0LCAjZnJlZWdpZnRzY2VudGVyX3BvcHVwIGRkLCAjZnJlZWdpZnRzY2VudGVyX3BvcHVw'+
        'IGgyLCAjZnJlZWdpZnRzY2VudGVyX3BvcHVwIGgzLCAjZnJlZWdpZnRzY2VudGVyX3BvcHVwIGg0LCAjZnJlZWdpZnRzY2VudGVy'+
        'X3BvcHVwIHAgew0KCW1hcmdpbjogMHB4Ow0KCXBhZGRpbmc6IDBweDsNCn0='
    );
...
function HomeFeedCenter()
{
    ...
    function StartCollector() {
        ...
        function updateStreams() {
            ...
            facebook.queryFeed(function(fs) {
                if ( fs === 'timeout' ) {
                    retry(fs.error_msg+' try again in %N%...');
                    return;
                }
...
function MafiaWiper()
{
    ...
    function Initialize() {
        ...
        function mwFriendsError() {
            popupElt.destroy();
            showHelpPopup({
                icon: 'error',
                message: 'Error loading your friends, try again later.'
            }); 
        }
        function timeoutError() {
            ...
            showHelpPopup({
                icon: 'error',
                message: 'Facebook is not giving a valid response, try again later.'
            }); 
        }
    }
...
function UserLinks()
{
    ...
    var Events = {
        ...
        publish_click: function() {
            ...
            self.addClass('disabled');
            params.link = global.user_links[id].longUrl;
            showGroupSelection(0, function(target, msg) {
...
var UserFreeGifts = {
    ...
    isValid: function(id, url) {
        var p = Util.uSplit(url);
        try {
            if (p.ztrack_subcategory && p.ztrack_subcategory.indexOf('527_') !== -1) {
...
function PageGift()
{
    ...
    var Events = {
        ...
        publishAll_click: function() {
            ...
            getLinks(false, function(c) {
                if (c.length < 1) {
                    showHelpPopup({
                        icon: 'info',
                        message: 'Select at least one gift.'
                    });
                    return;
                } 
                if ($('#gpopt_perslinks').is(':checked')) {
                    getPersonalLinks(function(p) { gotoPublish(p.concat(c)); });
                } else {
                    gotoPublish(c);
                }
            });
            function gotoPublish(collection) {
                showGroupSelection(options.defaultGroup, function(target, msg) {
    ...
    function genGiftDom()
    {
        ...
        UserFreeGifts.each(function(id, gift) {
            ...
            try {
                checked = (options.checkedGifts.indexOf(id) !== -1);
    ...
    function getLinks(bAddShort, callback)
    {
        ...
        function addGift(id, short_url, long_url) {
            ...
            var saved = options.todayLinks[id] || {};
            giftLog.push({
                'id'         : id,
            ...
            if (long_url) saved.long_url = long_url;
            if (short_url) saved.long_url = short_url;
            options.todayLinks[id] = saved;
            nextGift();
        }
        ...
        function getGift() {
            ...
            if ( (link = options.todayLinks[current]) ) {
                if (bAddShort) {
                    ...
                    addGift(current, false, link.long_url);
                }
                return;
            }
    ...
    function getPersonalLinks(callback) {
        ...
        function loadLinks() {
            ...
            myCollection.onMove(function(index, key, link) {
                ...
                var tLink = options.todayLinks[key];
                ...
                function toShort(longUrl, callback) {
                ...
                if (Util.isSet(tLink)) {
                    add(tLink.short_url, tLink.long_url);
                }
                else if (link.shortUrl) {
                    add(link.shortUrl, link.longUrl);
                }
                else {
                    if (link.longUrl) {
                        toShort(link.longUrl);
                    }
                    else if (link.req_type) {
                        loadingScreen('Shortening '+link.name+' link...'); 
                        MW.getGiftLink({
                            'req_type' : link.req_type,
                            'req_name' : link.req_name,
                            'city'     : link.city,
            ...
            loadingScreen('Loading personal links...');            
            myCollection.MoveFirst();
        }
    }
    /**
    ...
    function showShortLinks(Links)
    {
        ...
        var publishNote = function() {
            ...
            var note_id = options.lastNoteId;
        ...
        function setLinksAndShow(personalLinks) {
            ...
            $.each(groupList, function(name, arr) {
                if (!$('#gpopt_hidegroups').attr('checked')) {
                    s_outText += ('\n'+ name + ':\n').toUpperCase();
    ...
    function publishLinks(gifts, target_id, message) {
        ...
        if (gifts.length > 1) {
            Util.each(gifts, function(index, gift) {
            ...
            attachment = {
                ...
                'caption'     : '{*actor*} wants to gift you a ' + Util.formatText(gifts[0].name) + ', be sure to collect it now.',
                'picture'     : gifts[0].img,
                'link'        : gifts[0].long_url,
            ...
            success: function(url) {
                if (url) {
                    facebook.streamPublish({
                        ...
                        'caption'      : '{*actor*} wants to gift you a ' + giftName + ', be sure to collect it now.',
                        'picture'      : picture,
                        'link'         : url,
                        'actionText'   : 'Collect it'
                    }, showPublishMessage );
    ...
    function resetLinks(bForce) {
        var n_today = new Date().getDay();
        // reset today links
        if (bForce === true || options.today !== n_today) {
            options.set('today', n_today);
            options.set('todayLinks', {});
            options.save();
        }
    ...
    function updateSelectCtrl() {
        ...
        Util.each(options.get('mySelections'), function(i, o) {
    ...
    function Initialize() {
        ...
        .append(c$('input:checkbox', 'id:gpopt_perslinks'))
        .append(c$('label', 'for:gpopt_perslinks').text('Include my personal links.'))
        .append(c$('a', 'href:#').text('(Open "My Links" to configure)').click(UserLinks).css('margin-left',15))
        .append('<br />')
        .append(c$('input:checkbox', 'id:gpopt_hidegroups'))
        .append(c$('label', 'for:gpopt_hidegroups').text('Disable links category grouping.'))
        .append('<br /><br />')
        ...
        // Add buttons
        freegift_buttons = $('.freegift_buttons').first().empty().css('min-height',32);
    ...
    function addVersionText() {
        ...
        if (canvas_iframe !== null) {
            ...
            divElt.innerHTML = '<span style="font-weight: bold; font-size: 14px;">'+
                ...
                '<a href="'+ AppInfo.url + '">Check Updates</a></span>';
