 ...
 ********************************************************************************/
// Script information
var Version = '20110821a_BETA'; // Year, Month, Day, Revision, Maturity (e.g. YYYMMDDa_BETA)
...
var OptionsDefaults = {
  ...
  objAttack     : {enabled:false, repeatTime:3660, delayMin:10, delayMax:60, levelEnable:[], levelDist:[null,10,10,10,10,10,10,10,10,10,10], deleteObjAttacks:false, stopAttackOnLoss:false, logAttacks:true, maxMarches:10, troops:[], clearAllTargets:false},
  currentTab    : false,
  attackTab     : 0,
  mapTab        : 0,
  jobsTab       : 0,
  ...
  waves         : {enabled:false, iterationMin:10, iterationMax:45, stopOnLoss:true, deleteReports:false, targets:[], runTime:0},
  objStats      : null,
  objMarches    : {},
  version       : {lastChecked:0, checkVersion:Version, lastVersion:Version},
  maps          : {enabled:false, repeatTime:3660, delayMin:10, delayMax:60, levelEnable:[], levelDist:[null,10,10,10,10,10,10,10,10,10,10], deleteObjAttacks:false, stopAttackOnLoss:false, logAttacks:true, maxMarches:10},
  mapChoice     : kAntCamp,
  mapMarches    : {},
  autoColInt    : 8,
  isDefending   : false,
