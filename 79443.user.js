// ==UserScript==
// @name           YouTube Video Download V2.3.4
...
var pageFunction = function(checkUpdates, updateNeeded) {
	...
	window.ytd = {formats: {
			...
			38: { fmt: 38, quality: { level: 10, recdl: true, description: "Original Definition"               }, format: "MP4"                                                                                                  , acodec: "AAC?"  , vcodec: "H.264"  },
