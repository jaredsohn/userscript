...
function JVCMaster(){
    ...
    // Parce que console.log c'est casse burnes.
    ...
    _.onMp = function(){
        return window.location.href.match(/^http:\/\/www\.jeuxvideo\.com\/messages-prives\/message.php\?idd=[0-9]*/);
    }
    ...
    _.init = function(){
        ...
        var BTN_CONFIGURATION = $("<a/>", {
            title : "Panneau de configuration des outils"
          , text  : "Outils"
          , click : function(e){
                ...
                var html = '<div class="JVCMaster_colorboxHTML forums hp_forums"><div class="bloc_forum"><h3 class="titre_bloc"><span>Fonctionnalités</span></h3><div class="bloc_inner"><ul class="liste_liens">';
    ...
    _.scripts = {
        ...
        citation : {
          ...
          ,  init : function(){
                ...
                _.insertCSS(".JVCMaster_POST_CITATION .postContainer{background:#e4f5ff;border:1px solid #9ddbff;border-radius:6px 6px 0 0;box-shadow:0 0 10px rgba(0,0,0,0.2);margin:20px 0 5px;padding:5px;position:relative} \
                             .JVCMaster_POST_CITATION .postContainer:first-child{margin-top:-5px}.postContainer>.postContainer{margin-top:4px} \
                ...
                $(".msg").find(".post:first, .msg_body:first").each(function(){
                    ...
                    html = html.replace(/(?:<br(?: \/)?>)+(?:\| )*((?:Ecrit par « |Citation de )([a-zA-Z0-9_\-\|\]]*)(?: »)?(?:[^<]*))/g, 
            ...
            init : function(){
                ...
                function showFarbtastic(color, pseudo, friends, callback){
                    $.colorbox({
                        ...
                        width  : "330px", 
                        onComplete : function(){
                            $("#JVCMaster_BTN_ValidateColor").live("click", function(){
        ...
        visionoelshack : {
            ...
            init : function(){
                setTimeout(function(){
                    $("a[href^=http\\:\\/\\/www\\.noelshack\\.com], a[href^=http\\:\\/\\/image\\.noelshack\\.com]").live("click", function(e){
                        ...
                        if(resUrl.match(/\.swf$/)){
                            ...
                            $.colorbox({
                                photo       : true
                                , href      : resUrl
                                , title     : "<a href='" + resUrl + "' style='overflow: hidden;text-overflow: ellipsis;white-space: nowrap'>" + resUrl + "</a>"
                                , maxHeight : "95%"
                                , maxWidth  : "95%"
                            });
                        }
        ...
        quicknavigation : {
            ...
            init : function(){
                if(window.location.href.match("^http:\/\/www\.jeuxvideo\.com\/forums")){
                    _.insertCSS("#JVCMaster_loadPost{font-size : 20px;height : 40px;line-height : 1.4em;text-align  : center}");
        ...
        quickresponse : {
            id          : "quickresponse",
            name        : "Quick Response",
            description : "Répondez à un topic!",
            init : function(){
