...
var SUC_script_num = 67333;
var script_version = "0.11.9"
...
function Iventory_update() {
    ...
    function doStep1() {
        ...
        // build search string;
        myUrl  	 = 'http://facebook.mafiawars.com/mwfb/remote/html_server.php?xw_controller=gift&xw_action=view&xw_city=1';
    ...
    function doStep2() {
        ...
        // build search string;
        myUrl  	 = 'http://facebook.mafiawars.com/mwfb/remote/html_server.php?xw_controller=inventory&xw_action=view&xw_city=1';
        myUrl	+= '&xw_person='+gvar.FB_user_id.slice(2);
    ...
    function doStep3(_iStep) {
        ...
        if (_iStep <8) {
            ...
            myUrl  	 = 'http://facebook.mafiawars.com/mwfb/remote/html_server.php?xw_controller=collection&xw_action=view&xw_city=4';
            myUrl	+= '&xw_person='+gvar.FB_user_id.slice(2);
                            ...
                            do {
                                ...
                                if (iStart !=-1 ) {
	                                ...
	                                do {
	                                    ...
	                                    i1			= strTemp.indexOf('src="http:',i1)+5;
	                                    i2      	= strTemp.indexOf('"',i1);
	            ...
	            oTbody.setAttribute('style', 'margin-left: 6px; margin-top: 2px; border: 0px; height: 60px; width: 732px; float: left;');
	                oTr = document.createElement('tr');
	                    ...
	                    oTd.setAttribute('rowspan', '2');
	                        ...
	                        oButton.setAttribute('href','http://userscripts.org/scripts/show/67333');
...
function GiftDisplay() {
    ...
    if (oSnapShot.snapshotLength > 0) {
       ...
       var oTab_Tbody	=	[];
		...
		for (var loot_type=0; loot_type<5; loot_type++) {
			...
			for (var ID in gvar.item_names[1]) {
				switch(loot_type) {
					...
					case 3:
						...
						break
					case 4:
						if ((gvar.item_type[1][ID]==3)||(gvar.item_type[1][ID]==1)||(gvar.item_type[1][ID]==2)||(gvar.item_type[1][ID]==8)) continue;
						break
				}
...
function Initialize(){
	...
	if (gvar.strFrameId = 'MafiaWars') {
		...
		gvar.Gift_Tabs = {
			...
			5:{name:'Other',				id:'table_loot_other',			key:1},
			6:{name:'Boosts',				id:'table_expendables',			key:2},
			7:{name:'Collection Groups',	id:'table_collection_groups',	key:3},
			8:{name:'Special',				id:'table_special',				key:4}
		}
