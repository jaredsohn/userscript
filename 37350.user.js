...
var Urls = {
  standard:  "http://s141.photobucket.com/albums/r47/Jonoleth/LUEsers2/th_*.jpg",
  std_big:   "http://s141.photobucket.com/albums/r47/Jonoleth/LUEsers2/*.jpg",
...
if (/\/boards\/.*\/[0-9]+/.test(window.location.href)) {
  ...
  for (var i = 0; i < allLinks.snapshotLength; i++) {
    ...
    var userID = parseInt(/user=([0-9]+)/.exec(userLink.href)[1]);
