	...
	if (map1Element){
		...
		for (var i = 0; i < 22; i++) {
			...
			if (BuildingLevel){
				...
				// *********************************************************************************************************
				// **** EDIT THIS IF YOU NEED ANOTHER LANGUAGE								****
				// **** IN DIFFRENT LANGUAGES, CHANGE BUILDING NAMES AS THEY SHOULD BE 					****
				// **** THIS WORKS IN FINNISH AND IN THE COMMMENTS YOU CAN FIND BUILDING NAMES IN ENGLISH 		****
				// *********************************************************************************************************

				Buildings = new Array(35);
				Buildings[0] = "Marketti"; 		// Marketplace
				Buildings[1] = "Kasarmi"; 		// Barracks
				Buildings[2] = "Kokoontumispiste"; 	//Rally Point
				Buildings[3] = "Leipomo"; 		//Bakery
				Buildings[4] = "Tiilitehdas"; 		//Brickyard
				Buildings[5] = "Viljamylly"; 		//Grain Mill
				Buildings[6] = "Viljasiilo"; 		//Granary
				Buildings[28] = "Suuri viljasiilo"; 	//Great Granary
				Buildings[7] = "Suuri varasto"; 	//Great Warehouse
				Buildings[8] = "Rautavalimo"; 		//Iron Foundry
				Buildings[9] = "Sahaamo"; 		//Sawmill
				Buildings[10] = "Varasto"; 		//Warehouse
				Buildings[11] = "Akatemia"; 		//Academy
				Buildings[12] = "Aseseppä"; 		//Blacksmith
				Buildings[13] = "Haarniskapaja"; 	//Armoury
				Buildings[14] = "Kaupungin muuri"; 	//City Wall
				Buildings[29] = "Suuri Kasarmi"; 	//Great Barracks
				Buildings[30] = "Suuri Hevostalli"; 	// Great Stable
				Buildings[15] = "Sankarin kartano"; 	//Hero's Mansion
				Buildings[16] = "Hevostalli"; 		//Stable
				Buildings[17] = "Turnaus areena"; 	//Tournament Square
				Buildings[18] = "Ansoittaja"; 		//Trapper
				Buildings[19] = "Työpaja"; 		//Workshop
				Buildings[20] = "Kätkö"; 		//Cranny
				Buildings[21] = "Lähetystö"; 		//Embassy
				Buildings[22] = "Päärakennus"; 		//Main Building
				Buildings[23] = "Palatsi"; 		//Palace
				Buildings[24] = "Virka-asunto"; 	//Residence
				Buildings[25] = "Kivenhakkaaja"; 	//Stonemason
				Buildings[26] = "Kaupungintalo"; 	//Townhall
				Buildings[27] = "Kauppamaja"; 		//Trade Office
				Buildings[31] = "Treasury"; 		//Treasury
				Buildings[32] = "Wonder Of The World"; 	//Wonder Of The World
				Buildings[33] = "Maamuuri"; 		//Earth Wall
				Buildings[34] = "Keihäsmuuri"; 		//Palisade
				
				// *********************************************************************************************************
				// **** EDIT THIS											****
				// **** EDIT VALUES FROM HERE, DECIDE HOW FAR YOU WANT TO UPGRADE EACH BUILDING 			****
