// ==UserScript==
// @name          Amazon University of the Fraser Valley Library Linky
// @namespace     http://tannock.net
// @description	  v1.5 Search the University of the Fraser Valley Library Catalog from Amazon book listings.  
// @include       http://*.amazon.*
// ==/UserScript==
...
(function(){
//	GM_log('Amazon University of the Fraser Valley Library Linky');	
 
	var libraryTitleUrlPattern = 'http://198.162.102.2/uhtbin/cgisirsi/x/0/0/5?searchdata1='
	var libraryName = 'University of the Fraser Valley Library';
