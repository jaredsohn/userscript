// ==UserScript==
// @name           Yahoo Fantasy NBA Bench 'Em All CustomHUGERotiRoster
// @namespace      http://userscripts.org/users/Trecetratops/benchemall
// @description    Provides a couple of buttons next to "Submit Changes" ones to bench every player with night off FOR CUSTOM ROTI HUGE ROSTER
// @include        http://basketball.fantasysports.yahoo.com/nba/105612/*
...
var doBench = function(event) {
  ...
  var allElements;
  var thisElement;
  var myLineup = { "PG":2, "SG":2, "G":1, "SF":2, "PF":2, "F":1, "C":2, "Util":2 };
