...
window.setTimeout( function() 
{
	...
	GM_xmlhttpRequest({
		method: 'GET',
		    url: 'http://' + window.location.hostname + '/index.php?page=team&subpage=training',
		    headers: {
		    ...
		    trainBlock = trainBlock.replace(/group_([0-9]+)/,'group_$1_tmp');
		    trainBlock = trainBlock.replace(/focus_([0-9]+)/,'focus_$1_tmp');
		    trainFocus = trainFocus.replace(/focus_([0-9]+)/,'focus_$1_tmp');
