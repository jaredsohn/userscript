...
// @contributor   s4nji, riza_kasela, p1nky, b3g0, fazar, bagosbanget, eric., bedjho, Piluze, intruder.master, Rh354, gr0, hermawan64, slifer2006, gzt, Duljondul, reongkacun, otnaibef, ketang8keting, farin, drupalorg, .Shana, t0g3, KasKus1999, KasKus1999, & all-kaskuser@t=3170414
...
//
// v3.1.8 - 2011-05-21
//   Fix resolve behaviour with kaskus capcay. Thanks=[p1nky,ketang6,ceroberoz,reinhard.tambz,KasKus1999]
...
var rSRC = {
 ...
 ,getSetOf: function(type){
  ...
  switch(type){
    ...
    break;
    case "font":
     return ["Arial","Arial Black","Arial Narrow","Book Antiqua","Calibri","Century Gothic","Comic Sans MS","Courier New","Elephant","Famous fromage","Fixedsys","Franklin Gothic Medium","Garamond","Georgia","Impact","Lucida Console","Lucida Sans Unicode","Microsoft Sans Serif","Mixed Up","Palatino Linotype","Papyrus","Script MT Bold","System","Tahoma","Times New Roman","Trebuchet MS","Verdana"];
    break;
    case "size":
