...
// @description    Basically yet another dotd script
// @author         SReject, chairmansteve, JHunz, wpatter6, MoW, true_heathen, HG, PDrifting, mutikt
// @version        1.0.14
// @date           05.26.2013
// @grant          none
...
// if any1 needs a simple way to calculate damage: atk*4+def+legionpower*5
	...
	window.SRDotDX = {
		version: {major: "1.0.14", minor: "FortheGoodofAll"},
		...
		getRaidDetailsBase: function(url) {
			...
			if (typeof r != 'undefined' && typeof r.diff != 'undefined' && typeof r.hash != 'undefined' && typeof r.boss != 'undefined' && typeof r.id != 'undefined') { 
			    if (r.id == "3772268") {r.diffLongText = "WR";r.diffShortText ="WR"}
				else if (r.id != "3772268") {r.diffLongText = ['Normal','Hard','Legendary','Nightmare','Insane','Hell'][r.diff-1];
				...
				if (typeof stats == 'object') {
					...
					if (!isNaN(stats.health[r.diff-1])) {
						...
						if (typeof stats.loottiers == 'object' && typeof stats.loottiers[r.diff-1] == 'object') {
							...
							if (r.shortname =='Countess'){r.fairShare=r.fairShare*1.5}
		...
		gui: {
			...
			standardMessage: function (){//message to show 
				return 'FortheGoodofAll - <span class="room_name_container h6_alt mbs">' +document.getElementById("raid_list").childNodes.length + ' raids stored</span>';
			},
			...
			load: function () {
				if (typeof holodeck == 'object' && typeof holodeck._tabs == 'object' && typeof holodeck._tabs.addTab == 'function') {
					...
					SRDotDX.gui.cHTML('style').set({type: "text/css"}).text(" \
						...
						#kong_game_ui div#lots_tab_pane ul li.tab div.tab_head  { font-family: Verdana, Arial, sans-serif;font-size: 10px;padding: 3px 5px 4px 5px; background-color: #a0a0a0; color:white; cursor: pointer; text-decoration: none; margin-right: 1px; } \
						#kong_game_ui div#lots_tab_pane ul li.tab div.tab_pane  { padding: 2px 5px; background-color: #ffffff; display: none;} \
						#kong_game_ui div#lots_tab_pane ul li.tab.active div.tab_head { background-color: #ffffff; color: #000000; cursor: default; text-decoration: none; }\
						...
						#kong_game_ui div#lots_tab_pane ul li.tab.active div.tab_pane #raid_list .raid_list_item .raid_list_item_head .FPXlink {display:block;width:10px;height:10px; padding-right: 5px;float: left;} \
					...
					var link = SRDotDX.gui.cHTML('a').set({href: '#lots_tab_pane',class: ''}).html("<span class='SRDotDX_new'>RAIDS</span>").attach("to",SRDotDX.gui.cHTML('li').set({class: 'tab', id: 'lots_tab', onclick:'SRDotDX.gui.raidsTabClicked()'}).attach("after","game_tab").ele()).ele();
					...
					var pane = SRDotDX.gui.cHTML('div').set({id: 'lots_tab_pane'}).html(' \
						...
						<ul id="SRDotDX_tabpane_tabs"> \
							...
							<li class="tab"> \
								<div class="tab_head">Extra</div> \
								<div class="tab_pane"> \
									<ul id="SRDotDX_tabpane_tabs2"> \
									<li class="tab2"> \
										<div class="tab_head2">Commands</div> \
										<div class="tab_pane2"> \
										<table border="1" cellpadding="3" cellspacing="0"> \
										<tr><td><font color="#990000">/clear</font></td><td>Clears the chat on screen</td></tr> \
										<tr><td><font color="#990000">/loadraid A</br>/lr A</font></br><i>Where A is a raid url</i></td><td>Loads the raid entered in A</td></tr> \
										<tr><td><font color="#990000">/mute A</font></br><i>Where A is a username(case sensitive)</i></td><td>Mutes the user entered as A</td></tr> \
										<tr><td><font color="#990000">/mutelist</font></td><td>Lists all users you have muted using this script</td></tr> \
										<tr><td><font color="#990000">/perc</font></td><td>Provides you with perception tiers.</td></tr> \
										<tr><td><font color="#990000">/raid A B</font></br><i>Where A is a raid name or part of a name and B is difficulty 1-4</i></td><td>Provides details on the raid(s) that fall under A and B. If B is not entered details on all levels for the raid(s) is/are given</td></tr> \
										<tr><td><font color="#990000">/relaod</br>/reload</br>/rl</font></td><td>Reloads the game only, not chat or the page</td></tr> \
										<tr><td><font color="#990000">/script</font></td><td>Provides the link to this script in chat</td></tr> \
										<tr><td><font color="#990000">/stop</font></td><td>Stops any automated posting you initiated with this script. IE trains</td></tr> \
										<tr><td><font color="#990000">/update</font></td><td>Provides current version number installed as well as update link.</td></tr> \
										<tr><td><font color="#990000">/unmute A</font></br><i>Where A is a username(case sensitive) or all</i></td><td>Unmutes the user entered as A or all users you muted with this script</td></tr> \
										<tr><td><font color="#990000">/wikil</font></td><td>Provides wiki link to chat</td></tr> \
										<tr><td><font color="#990000">/wiki A </font></br><i>Where A is any set of search words </i></td><td>Opens the wiki in a new tab with those words searched for</td></tr> \
										</div> \
									</li> \
									</ul> \
								</div> \
					...
					for (var i in SRDotDX.raids) {
						if (SRDotDX.raids.hasOwnProperty(i)) {
							...
							} else if (raid.size == 25 || raid.id == 'krugnug') {
								parentTable.attach('to','FPXRaidFilterWhatSmall');
					...
					SRDotDX.gui.cHTML('li').set({
						class: 'spritegame'
					}).html("<a href=\"http://www.kongregate.com/games/5thPlanetGames/dawn-of-the-dragons\" onclick=\"SRDotDX.reload(); return false;\">Reload Game</a>").attach("after","quicklinks_favorite_block");
		...
		fails: 0, 
		load: function () {
			if (typeof holodeck == 'object' && holodeck.ready && typeof ChatDialogue == 'function' && typeof activateGame == 'function' && typeof document.getElementById('kong_game_ui') != 'null') {
				...
				holodeck.addChatCommand("lr",function(deck,text){
					...
					else {SRDotDX.echo('<b>/lr</b>: Invalid raid specified.');}
					return false;
				});
				holodeck.addChatCommand("loadraid",function(deck,text){
					var u;
					if (u = /^\/loadraid (\S+)$/i.exec(text)) {SRDotDX.loadRaid(u[1]);}
					else {SRDotDX.echo('<b>/loadraid</b>: Invalid raid specified.');}
					return false;
				});
				...
				holodeck.addChatCommand("reload",function(deck,text){
					if (/^\/reload$/i.test(text)) {
						...
						SRDotDX.echo('<b>/reload</b>: You can not type anything after this command.');
					}
					return false
				});
				holodeck.addChatCommand("relaod",function(deck,text){
					if (/^\/relaod$/i.test(text)) {
						SRDotDX.reload();
					}
					else {
						SRDotDX.echo('<b>/relaod</b>: You can not type anything after this command.');
					}
					return false
				});
				holodeck.addChatCommand("rl",function(deck,text){
					if (/^\/rl$/i.test(text)) {
						SRDotDX.reload();
					}
					else {
						SRDotDX.echo('<b>/rl</b>: You can not type anything after this command.');
					}
					return false
				});
				//specifically required to reduce vinnie induced script stress
				holodeck.addChatCommand("reloaf",function(deck,text){
					if (/^\/reloaf$/i.test(text)) {
						SRDotDX.reload();
					}
					else {
						SRDotDX.echo('<b>/rl</b>: You can not type anything after this command.');
				...
				holodeck.addChatCommand("script", function(deck,text) {
					SRDotDX.gui.FPXdoWork('http://userscripts.org/scripts/show/156214');
					return false;
				});
				holodeck.addChatCommand("update", function(deck,text) {
					...
					d += 'You can check <a href="http://userscripts.org/scripts/show/156214" target="_blank">here</a> to see if your version is most current and update. <br><b>PLEASE REMEMBER TO REFRESH THIS PAGE IF YOU UPDATE</b>';
					SRDotDX.echo(d)
					return false;
				});
				holodeck.addChatCommand("wr", function(deck,text) {
					SRDotDX.echo('/wr error. Either there is no WR or I have not added this functionality yet. Most likely the latter is true regardless or I would have erased this part.')
					return false;
				});
				holodeck.addChatCommand("loot", function(deck,text) {
					SRDotDX.echo('/loot error. Either there is no WR or I have not added this functionality yet. Most likely the latter is true regardless or I would have erased this part.')
					return false;
				});
				...
				holodeck.addChatCommand("wiki", function(deck,text) {
					var p; 
					if (p = /^\/wiki (.*?)$/i.exec(text)) {
						window.open("http://dotd.wikia.com/wiki/index.php?search="+p[1]+"&fulltext=Search");
						SRDotDX.echo("Wiki search opened.");}
					else {
						SRDotDX.echo('<b>/wiki</b>: Invalid parameters specified');}
					return false;
				});
				holodeck.addChatCommand("perc", function(deck,text) {
					var brndotd='<font color="#A52A2A">Brown</font>'
					var grydotd='<font color="#404040">Grey</font>'
					var grnsdotd='<font color="#0DB819">Green</font>'
					var blusdotd='<font color="#0D3E9F">Blue</font>'
					var pursdotd='<font color="#6C08EF">Purple</font>'
					var orosdotd='<font color="#EF7408">Orange</font>'
					var redsdotd='<font color="#DD0000">Red</font>'
					SRDotDX.echo('<b>Buffs and Books of Knowledge tiers:</b><br><b>1-3,999:</b> '+brndotd+' and '+grydotd+'<br><b>4,000-5,999:</b> '+brndotd+', '+grydotd+', and '+grnsdotd+' <br><b>6,000-9,999:</b> '+grydotd+' and '+grnsdotd+' <br><b>10,000-13,999:</b> '+grydotd+', '+grnsdotd+', and '+blusdotd+' <br><b>14,000-15,999:</b> '+grnsdotd+' and '+blusdotd+' <br><b>16,000-17,999:</b> '+grnsdotd+', '+blusdotd+', and '+pursdotd+' <br><b>18,000-21,9999:</b> '+blusdotd+', and '+pursdotd+' <br><b>22,000-23,999:</b> '+blusdotd+', '+pursdotd+', and '+orosdotd+' <br><b>24,000-29,999:</b> '+pursdotd+' and '+orosdotd+' <br><b>30,000-32,999:</b> '+orosdotd+' <br><b>33,000-35,999: '+orosdotd+'</b>,'+redsdotd+'<br><b>36,000+:</b> '+orosdotd+',<b>'+redsdotd+'</b> <br><font color="#BBCF0B"><b>Golden Garden Armor</b></font> drops at all tiers.<br><font color="#656753"><b>Perfected Clockwork Parts</b></font> drop at the rate of 10-235 based on tiers')
					return false;
				});
				holodeck.addChatCommand("raid", function(deck,text){
					...
					if (p = /^\/raid (.*?)(?: ([1-6]))?$/i.exec(text)) {
									...
									//else {
										...
										for (var n = start;n<end;n++) {
											...
											if (typeof raid.loottiers == 'object') {
												...
												var fs = h / raid.size;
												if(raid.name=='Countess Serpina'){var fs = fs*1.5}
												var os = fs*{"1": 1, "10": 1.25, "15": 1.25, "50":2.2, "100": 2.3, "250": 1, "500": 1.5}[raid.size + ""]; 
												var maxsp = fs*{"1": 1, "10": 1.25, "13": 1.25, "50":1, "100": .75, "250": .67, "500": .67}[raid.size + ""];
												msg += "Fair Share: "+SRDotDX.getShortNum(fs)+"<br>";
												msg += "Optimal Share: "+SRDotDX.getShortNum(os)+"<br>";
												msg += "Maximized SP at Damage: "+SRDotDX.getShortNum(maxsp)+"<br>";
											}
									//	}
									}
								}
						...
						SRDotDX.echo('<b>/raid</b>: Invalid parameters specified');
					}
					return false;
				});
				...
				setTimeout(function() { SRDotDX.load(); }, 500);
			}
			else {
		...
		searchKeywords: {
			...
			'z9.5': { reg: /^(z9\.5)|(pumpkins?)$/i, sub: 'jack|revenge' },
			z10: { reg: /^(z10)|(crypt)|(emblems?)|(scrolls?)$/i, sub: 'caracalla|riddler|krugnug|leonine|marius' },
			farm: { reg: /^farm$/i, sub: 'maraak|erakka|wexxa|guilbert|bellarius|erebus|grune|mazalu|baron' },
			...
			banhammer: { reg: /^(banhammer(brother\s))$/i, sub: 'felendis' },
			smalls: { reg: /^small?$/i, sub: 'ataxes|bloodmane|butcher|horgrak|serpina|lair|gunnar|hargamesh|ironclad|krugnug|maraak'},
			mediums: {reg: /^medium?$/i, sub: 'alice|baroness|erakka|grimsly|kerberos|mazalu|nidhogg|riddler|scylla|tisiphone|zombie'},
			larges: {reg: /^large?$/i, sub: 'grune|gravlok|hydra|kang|leonine|lurking|rift|stein|wexxa'},
			epics: {reg: /^epic?$/i, sub: 'bogstench|marius|erebus|guilbert|jack|mesyra|nimrod|phaedra|cai|sisters|ulfrik|frog-men'},
			colossals: {reg: /^colossal?$/i, sub: 'bellarius|caracalla|kalaxia|tyranthius|mardachus|nalagarst|tenebra|valanazes'}
		...
		raids: {
			...
			baroness:{name: 'The Baroness', shortname: 'Baroness',  id: 'baroness', stat: 'S', size:50, duration:60, health: [68000000,85000000,108000000,136000000,,]},
			...
			burbata:{name: 'Burbata',shortname: 'Burbata',id: 'burbata',stat: 'S', size:250, duration:96, health: [1000000000,,,5000000000,,], loottiers: [['100M','200M','300M','400M','500M','600M'],['100M','200M','300M','400M','500M','600M'],['100M','200M','300M','400M','500M','600M'],['100M','200M','300M','400M','500M','600M'],,]},
			caracalla:{name: 'Caracalla', shortname: 'Caracalla',  id: 'caracalla', stat: 'S', size:500, duration:128, health: [50000000000,75000000000,,200000000000,,], loottiers: [['400M','500M','600M','700M','800M','900M','1B','2B','3B'],['400M','500M','600M','700M','800M','900M','1B','2B','3B'],['400M','500M','600M','700M','800M','900M','1B','2B','3B'],['400M','500M','600M','700M','800M','900M','1B','2B','3B'],,]},
			harpy:{name: 'Celeano', shortname: 'Cel',  id: 'harpy', stat: 'H', size:10, duration:120, health: [3000000,3750000,4800000,6000000,,]},
			centurion_marius:{name: 'Centurion Marius', shortname: 'Marius',  id: 'centurion_marius', stat: 'S', size:250, duration:96, health: [10000000000,12000000000,16000000000,40000000000,,], loottiers: [['100m','200m','300m','400m','500m','600m','700m','800m','900m','1b'],['100m','200m','300m','400m','500m','600m','700m','800m','900m','1b'],['100m','200m','300m','400m','500m','600m','700m','800m','900m','1b'],['100m','200m','300m','400m','500m','600m','700m','800m','900m','1b'],,]},
			...
			dragons_lair:{name: 'Dragons Lair', shortname: 'Lair',  id: 'dragons_lair', stat: 'S', size:13, duration:5, health: [100000000,500000000,1000000000,1500000000,,], loottiers: [['8M','9M','10M','16M','20M','26M','30M','36M','40M','46M'],['40M','45M','50M','80M','100M','130M','150M','180M','200M','230M'],['80M','90M','100M','160M','200M','260M','300M','360M','400M','460M'],['100M','135M','150M','225M','300M','375M','450M','525M','600M','690M'],,]},
			echidna:{name: 'Echidna', shortname: 'Echidna', id: 'echidna', stat: 'ESH', size:90000, duration:96, health: ['Unlimited','Unlimited','Unlimited','Unlimited','Unlimited','Unlimited'], loottiers: [['1M','15M','45M','75M','275M','500M','750M','1B','2.5B','5.5B','9B','50B'],[],[],[],[],[]]},
			...
			felendis:{name: 'Banhammer Brothers - Felendis and Shaoquin', shortname: 'Felendis',  id: 'felendis', stat: 'H', size:100, duration:168, health: [441823718,549238221,707842125,888007007,,]},
			frogmen_assassins:{name: 'Frog-Men (Frogmen) Assassins', shortname: 'Froggy',  id: 'frogmen_assassins', stat: 'S', size:250, duration:96, health: [16000000000,32000000000,48000000000,64000000000,,],loottiers: [['400M','500M','600M','700M','800M','900M','1B','2B','3B'],['400M','500M','600M','700M','800M','900M','1B','2B','3B'],['400M','500M','600M','700M','800M','900M','1B','2B','3B'],['400M','500M','600M','700M','800M','900M','1B','2B','3B'],,]},
			...
			pumpkin:{name: 'Jack', shortname: 'Jack', id: 'pumpkin', stat: 'S', size: 250, duration:48 , health: [1000000000,1500000000,2000000000,3000000000,,],loottiers: [['12M','24M','36M','48M','60M','72M','145M','216M','288M','360M','432M','504M','576M'],['12M','24M','36M','48M','60M','72M','145M','216M','288M','360M','432M','504M','576M'],['12M','24M','36M','48M','60M','72M','145M','216M','288M','360M','432M','504M','576M'],['12M','24M','36M','48M','60M','72M','145M','216M','288M','360M','432M','504M','576M'],,]},
			jacksrevenge1:{name: "Jack's Revenge", shortname: 'Revenge', id: 'jacksrevenge1', stat: 'S', size: 250, duration:48 , health: [5000000000,7500000000,10000000000,15000000000,,],loottiers: [['60M','120M','180M','240M','300M','360M','720M','1.5B','3B'],['60M','120M','180M','240M','300M','360M','720M','1.5B','3B'],['60M','120M','180M','240M','300M','360M','720M','1.5B','3B'],['60M','120M','180M','240M','300M','360M','720M','1.5B','3B'],,]},
			...
			krugnug:{name: 'Krugnug', shortname: 'Krugnug',  id: 'krugnug', stat: 'S', size:25, duration:48, health: [1000000000,1500000000,2000000000,4000000000,,], loottiers: [['100m','200m','300m','400m','500m','600m','700m','800m','900m','1b'],['100m','200m','300m','400m','500m','600m','700m','800m','900m','1b'],['100m','200m','300m','400m','500m','600m','700m','800m','900m','1b'],['100m','200m','300m','400m','500m','600m','700m','800m','900m','1b'],,]},
			...
			leonine_watcher:{name: 'Leonine', shortname: 'Leonine',  id: 'leonine_watcher', stat: 'S', size:100, duration:48, health: [4000000000,6000000000,8000000000,16000000000,,], loottiers: [['100m','200m','300m','400m','500m','600m','700m','800m','900m','1b'],['100m','200m','300m','400m','500m','600m','700m','800m','900m','1b'],['100m','200m','300m','400m','500m','600m','700m','800m','900m','1b'],['100m','200m','300m','400m','500m','600m','700m','800m','900m','1b'],,]},
			...
			tomb_gargoyle:{name: 'Riddler Gargoyle', shortname: 'Riddler',  id: 'tomb_gargoyle', stat: 'S', size:50, duration:48, health: [2000000000,3000000000,4000000000,8000000000,,], loottiers: [['100m','200m','300m','400m','500m','600m','700m','800m','900m','1b'],['100m','200m','300m','400m','500m','600m','700m','800m','900m','1b'],['100m','200m','300m','400m','500m','600m','700m','800m','900m','1b'],['100m','200m','300m','400m','500m','600m','700m','800m','900m','1b'],[],[]]},
			...
			siculus:{name: 'Count Siculus\' Phantom',shortname: 'Siculus',id: 'siculus',stat: 'S', size:500, duration:128, health: [850000000,,,4250000000,,], loottiers: [['400M','500M','600M','700M','800M','900M','1B'],['400M','500M','600M','700M','800M','900M','1B'],['400M','500M','600M','700M','800M','900M','1B'],['400M','500M','600M','700M','800M','900M','1B'],,]},
			...
			teremarthu:{name: 'Teremarthu', shortname: 'Teremarthu',  id: 'teremarthu', stat: 'S', size:100, duration:48, health: [6000000000,9000000000,12000000000,24000000000,,], loottiers: [['100m','200m','300m','400m','500m','600m','700m','800m','900m','1b'],['100m','200m','300m','400m','500m','600m','700m','800m','900m','1b'],['100m','200m','300m','400m','500m','600m','700m','800m','900m','1b'],['100m','200m','300m','400m','500m','600m','700m','800m','900m','1b'],,]},
			tisiphone:{name: 'Tisiphone The Vengeful', shortname: 'Tisiphone',  id: 'tisiphone', stat: 'E', size:50, duration:12, health: [500000000,2500000000,5000000000,7500000000,,]},
			...
			xessus:{name: 'Xessus of the Grim Wood', shortname: 'Xessus', id: 'xessus', stat: 'H', size:100, duration:48, health: [500000000,625000000,800000000,1000000000,,], loottiers: [[],[],[],['10m','14m','18m','20m','35m','45m','50m','70m','80m','90m'],[],[]]},
                        malchar:{name: 'Malchar the Tri-Eyed', shortname: 'Malchar', id: 'malchar', stat: 'H', size:100, duration:48, health: [500000000,625000000,800000000,1000000000,,], loottiers: [[],[],[],['10m','14m','18m','20m','35m','45m','50m','70m','80m','90m'],[],[]]},
                        krasgore:{name: 'Krasgore', shortname: 'Krasgore', id: 'krasgore', stat: 'H', size:100, duration:48, health: [500000000,625000000,800000000,1000000000,,], loottiers: [[],[],[],['10m','14m','18m','20m','35m','45m','50m','70m','80m','90m'],[],[]]},
                        nrlux:{name: 'N\'rlux the Devourer', shortname: 'N\'rlux', id: 'nrlux', stat: 'H', size:100, duration:48, health: [10000000000,12500000000,16000000000,20000000000,,], loottiers: [['8M','17M','26M','35M','45M','56M','67M','78M','90M','103M','116M','129M','143M','157M','173M','188M','202M','220M','238M','255M','270M','293M','311M','330M','350M'],['8M','17M','26M','35M','45M','56M','67M','78M','90M','103M','116M','129M','143M','157M','173M','188M','202M','220M','238M','255M','270M','293M','311M','330M','350M'],['8M','17M','26M','35M','45M','56M','67M','78M','90M','103M','116M','129M','143M','157M','173M','188M','202M','220M','238M','255M','270M','293M','311M','330M','350M'],['8M','17M','26M','35M','45M','56M','67M','78M','90M','103M','116M','129M','143M','157M','173M','188M','202M','220M','238M','255M','270M','293M','311M','330M','350M'],,]},
			...
			zralkthalat:{name: 'Z\'ralk\'thalat',shortname: 'Zral',id: 'zralkthalat',stat: 'S', size:100, duration:72, health: [,,,35000000000,,], loottiers: [['100M','200M','300M','400M','500M','600M','700M','800M','900M','1B'],['100M','200M','300M','400M','500M','600M','700M','800M','900M','1B'],['100M','200M','300M','400M','500M','600M','700M','800M','900M','1B'],['100M','200M','300M','400M','500M','600M','700M','800M','900M','1B','APis175M'],,]}
		},
		...
		raidSizes: {
			...
			25: { name: 'Small', visible: 'Yes', pruneTimers: [3600000,10800000,32400000]}, // 1h, 2h, 3h
		...
		raidArray: [ "agony","djinn","animated_armor","spider","rhino","gladiators","bellarius","werewolfpack",
               			"alice","bogstench","4ogre","bmane","harpy","kobold","krugnug","corrupterebus","serpina","serpina.jpg","dahrizons_general",
                        "basilisk","dirthax","dragons_lair","erakka_sak","frogmen_assassins","giantgolem","echthros","drag","felendis","ogre",
