// ==UserScript==
// @name           LoU Suite (Philokei Edition,edit by Damien69) vers. fr par patjgll
		...
		function createSuite()
		{
			...
			qx.Class.define("louSuite.main", {
				...
				members:{
					...
					startScript     :function ()
					{
						...
						btn.set({width:30, appearance:"button-text-small", toolTipText:"LoU Suite console"});
			...
			qx.Class.define("lou_suite.gui.DungeonRaider", {
				...
				construct:function ()
				{
					...
					this.setLabel("Donjons");
					this.setLayout(new qx.ui.layout.VBox(10));
					this.add(this._createToolBar());
					this._tableModel = new qx.ui.table.model.Simple();
					var columnNames = [ "Id", "Row Info", "Type", "Level", "Progress", "Pos", "Nom", "Distance", "Unites", "Actions"];
			...
			var units = {
				...
				Foret:       {
					...
					_createToolBar                 :function ()
					{
						...
						this.sbLevel.setToolTipText("Filtre par: <b>niveau mini</b>");
						...
						for (var i = 1; i < 10; i++)
						{
							var item = new qx.ui.form.ListItem("Niv " + i, null, i);
						...
						var btnViewRegion = new qx.ui.form.Button("Voir Region");
						...
						var btnRecount = new qx.ui.form.Button("Recompter troupes");
						...
						this.sbField.setToolTipText("distance max (champ) <b>de la ville</b>");

						for (var i = 1; i <= 20; i++)
						{
							var itemField = new qx.ui.form.ListItem("Ch. " + i, null, i);
			...
			qx.Class.define("lou_suite.gui.BossRaider", {
				...
				construct:function ()
				{
					...
					this.add(this._createToolBar());
					this._tableModel = new qx.ui.table.model.Simple();
					var columnNames = [ "Id", "Row Info", "Type", "Level", "Pos", "Nom", "Distance", "Unites", "Actions"];
					...
					getUnitsPerBoss                :function ()
					{
						var units = {
							Dragon :{
								...
								7 :[40, 240, 1500, 3100, 8000, 12000, 15500, 23000, 34000, 45000], // Magier
							...
							Moloch :{
								...
								7 :[30, 160, 1050, 2000, 5000, 8000, 10500, 15500, 23000, 31000], // Magier
