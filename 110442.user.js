// ==UserScript==
// @name            The West - Motivation - PT-BR
// @namespace       http://userscripts.org/scripts/show/110442
...
// @website         http://userscripts.org/scripts/show/110442
// @include         http://*.the-west.*/game.php*
// @include         http://userscripts.org/scripts/source/110442.meta.js
// @require         http://userscripts.org/scripts/source/74144.user.js
// @exclude         http://forum.the-west.br/*
// @exclude         http://wiki.the-west.br/*
// @version         1.30.06
//
// @history         1.30.06 Added Portuguese Translations
...
function openMotivationWindow() {
	...
	xhtml += '    							<ul style="margin-top:10px;text-align:left;">' +
			 '									<li>Capacidade de criar listas de atividades para você;</li>' +
			 '									<li>Referem-se ao trabalho do personagem em um clique, sem uma longa procura;</li>' +
			 '									<li>Classificação pela Experiência, Motivação, Salário e Sorte;</li>' +
			 '								</ul>';
	xhtml += '    						</div>';
	xhtml += '    						<div style="float:left;">';
	xhtml += '    							Para mais informações fazer o download do script aqui:<br />';
	xhtml += '    							<a href="http://userscripts.org/scripts/show/110442" target="_blank">The West_-_Motivation</a>';
	xhtml += '    							<br>Para mais informações, vá para a Wiki: <br />';
	xhtml += '    							<a href="http://wiki.the-west.fr" target="_blank">The-West Wiki </a>';
	xhtml += '    						</div>';
	xhtml += '    						<div style="float:right;">';
	xhtml += '    							<a href="http://userscripts.org/users/344882" target="_blank">';
	xhtml += '    								Para mais Infomações entre em contato comigo no Userscript.org: CWalter';
	xhtml += '    							</a>';	
	xhtml += '    						</div>';	
	xhtml += '    					</div>';
	xhtml += '    				</div>';
	...
	xhtml += '    		</tr>';
	xhtml += '    	</table>';
	xhtml += '      <span style="position:absolute; right:22px; top:19px;">' + MoCheck.getString('author') + '&nbsp;&nbsp;' + MoCheck.getAuthor() + '&nbsp;&nbsp;v.<a href=\'http://userscripts.org/scripts/show/110442\' target=\'_blank\'>1.30.06</a></span>';
...
function getLanguage(lang) {
	...
	res['br'] = { //CWalter
		'dialog.closeAll.popup':'Fechar todas as janelas',
		'dialog.minimize.popup':'Minimizar janela',
		'dialog.close.popup':'Fechar',
		'dialog.tab.work.titel':'Trabalho',
		'dialog.tab.about.titel':'Sobre',
		'dialog.tab.work.nothingSelected.1':'Não há nenhum trabalho selecionado!',
		'dialog.tab.work.nothingSelected.2':'Você precisa abrir um trabalho e adicioná-lo!',
		'dialog.tab.work.tableHeader.work':'Trabalho',
		'dialog.tab.work.tableHeader.points':'Pontos de trabalho',
		'dialog.tab.work.tableHeader.money':'Salário',
		'dialog.tab.work.tableHeader.experience':'Experiência',
		'dialog.tab.work.tableHeader.luck':'Sorte',
		'dialog.tab.work.tableHeader.motivation':'Motivação',
		'dialog.tab.configuration.actual':'Atual',
		'dialog.tab.configuration.btnDelete.popup':'Apagar Lista',
		'dialog.tab.configuration.btnRename.popup':'Renomear Lista',
		'dialog.tab.configuration.btnNew.popup':'Criar Nova Lista',
		'select.option.minutes':'m',
		'select.option.hours':'H',
		'btnOk.label':'OK',
		'btnAdd.popup':'Adicionar Trabalho',
		'btnCenter.popup':'<b>Tempo de duração:</b> %1h',
		'btnDelete.popup':'Excluir trabalho da lista',
		'sortIcon.popup.money':'Classificar por <b>Salários</b>',
		'sortIcon.popup.luck':'Classificar por <b>Sorte</b>',
		'sortIcon.popup.experience':'Classificar por <b>Experiência</b>',
		'sortIcon.popup.motivation':'Classificar por <b>Motivação</b>',
		'visibleIcon.popup.money':'Mostrar / Ocultar <b>Salários</b>',
		'visibleIcon.popup.luck':'Mostrar / Ocultar <b>Sorte</b>',
		'visibleIcon.popup.experience':'Mostrar / Ocultar <b>Experiência</b>',
		'visibleIcon.popup.motivation':'Mostrar / Ocultar <b>Motivação</b>',
		'jobImage.popup':'Job: <b>%1</b><br />Pontos de Trabalho: <b>%2</b>',
		'message.error.unableToDeleteCurrentList':'Não é possível excluir lista atual.',
		'message.deleteList':'Excluir Lista %1?',
		'message.newName':'Novo Nome:',
		'message.addedWork':'Trabalho Adicionado!',
		'message.deleteFromList':'Excluir %1 da Lista?',
		'message.listLoaded':'Carregado %1.',
		'message.listDeleted':'Excluido %1.',
		'message.listRenamed':'Renomear Lista.',
		'message.listCreated':'Criar Lista.',
		'message.error.nameAlreadyDefined': 'Nome de 1% já está em uso.',
	        // 'motivation.text':'Motivação'
		'author':'Autor: <b>JoeSmith</b>. Release:'
...
function getAuthor() {
	...
	switch(window.location.hostname.substr(0,window.location.hostname.search(/\./))) {
		...
		break;
		default:
			hrefStr = 'http://userscripts.org/users/344882';
			win_op = 'target=\'_blank\'';
	}
	return '<a href=\"' + hrefStr + '\" style=\"color:492b19\"' + win_op + '>CWalter</a>';
}
...
try {
	ScriptUpdater.check(110442, ''+getVersion()+'');
} catch(e) {};

//ScriptUpdater.forceNotice(110442, getVersion);
//ScriptUpdater.forceCheck(110442, getVersion);
ScriptUpdater.check(110442, getVersion);
// FIN DE LE MAJ AUTO