// ==UserScript==
// @name			HF Scripts - Easy Report to Mr Kewl
// @namespace 		Mr Kewl/Reports/Mentor
// @description 	Easy reporting script to report threads directly to Mr Kewl.
...
if(navBit.innerHTML.indexOf('<a href="forumdisplay.php?fid=25">The Lounge</a>') != -1) {
	...
	for(var i = 0; i < authBut.length; i++) {
		...
		var formto = '<input type="hidden" name="to" id="to" value="Mr Kewl" />';
		...
		var formsend = '<input type="submit" class="bitButton" name="submit" value="Lounge Report" tabindex="9" accesskey="s" onclick="return confirm(\'Are you sure that you want to report this post to Mr Kewl?\');"/>';
	...
	for(var i = 0; i < authBut.length; i++) {
		...
		var formchecks = '<input type="hidden" name="options[signature]" value="1" /><input type="hidden" name="options[savecopy]" value="1" /><input type="hidden" name="options[readreceipt]" value="1" />';
		var formsend = '<input type="submit" class="bitButton" name="submit" value="Beginner Hacking Report" tabindex="9" accesskey="s" onclick="return confirm(\'Are you sure that you want to report this post to Mr Kewl?\');"/>';
		var formmessage = '<input type="hidden" name="message" value="Post: http://www.hackforums.net/showthread.php?pid='+pid+'#pid'+pid+'" />';
		var finalform = formaction+formpmid+formdo+formicon+formmy_post_key+formuid+formto+formsubject+formmessage+formsend+formchecks+'</form>';
		divHold.innerHTML = finalform;
		el.appendChild(divHold);
	...
	for(var i = 0; i < authBut.length; i++) {
		...
		var formchecks = '<input type="hidden" name="options[signature]" value="1" /><input type="hidden" name="options[savecopy]" value="1" /><input type="hidden" name="options[readreceipt]" value="1" />';
		var formsend = '<input type="submit" class="bitButton" name="submit" value="Member Contests Report" tabindex="9" accesskey="s" onclick="return confirm(\'Are you sure that you want to report this post to Mr Kewl?\');"/>';
		var formmessage = '<input type="hidden" name="message" value="Post: http://www.hackforums.net/showthread.php?pid='+pid+'#pid'+pid+'" />';
		var finalform = formaction+formpmid+formdo+formicon+formmy_post_key+formuid+formto+formsubject+formmessage+formsend+formchecks+'</form>';
		divHold.innerHTML = finalform;
		el.appendChild(divHold);
	...
	for(var i = 0; i < authBut.length; i++) {
		...
		var formchecks = '<input type="hidden" name="options[signature]" value="1" /><input type="hidden" name="options[savecopy]" value="1" /><input type="hidden" name="options[readreceipt]" value="1" />';
		var formsend = '<input type="submit" class="bitButton" name="submit" value="Science, Religion, Philosophy, and Politics Report" tabindex="9" accesskey="s" onclick="return confirm(\'Are you sure that you want to report this post to Mr Kewl?\');"/>';
		var formmessage = '<input type="hidden" name="message" value="Post: http://www.hackforums.net/showthread.php?pid='+pid+'#pid'+pid+'" />';
		var finalform = formaction+formpmid+formdo+formicon+formmy_post_key+formuid+formto+formsubject+formmessage+formsend+formchecks+'</form>';
		divHold.innerHTML = finalform;
		el.appendChild(divHold);
	...
	for(var i = 0; i < authBut.length; i++) {
		...
		var formchecks = '<input type="hidden" name="options[signature]" value="1" /><input type="hidden" name="options[savecopy]" value="1" /><input type="hidden" name="options[readreceipt]" value="1" />';
		var formsend = '<input type="submit" class="bitButton" name="submit" value="Free Services and Giveaways Report" tabindex="9" accesskey="s" onclick="return confirm(\'Are you sure that you want to report this post to Mr Kewl?\');"/>';
		var formmessage = '<input type="hidden" name="message" value="Post: http://www.hackforums.net/showthread.php?pid='+pid+'#pid'+pid+'" />';
		var finalform = formaction+formpmid+formdo+formicon+formmy_post_key+formuid+formto+formsubject+formmessage+formsend+formchecks+'</form>';
		divHold.innerHTML = finalform;
		el.appendChild(divHold);
	...
	for(var i = 0; i < authBut.length; i++) {
		...
		var formchecks = '<input type="hidden" name="options[signature]" value="1" /><input type="hidden" name="options[savecopy]" value="1" /><input type="hidden" name="options[readreceipt]" value="1" />';
		var formsend = '<input type="submit" class="bitButton" name="submit" value="Hacking Tutorials Report" tabindex="9" accesskey="s" onclick="return confirm(\'Are you sure that you want to report this post to Mr Kewl?\');"/>';
		var formmessage = '<input type="hidden" name="message" value="Post: http://www.hackforums.net/showthread.php?pid='+pid+'#pid'+pid+'" />';
		var finalform = formaction+formpmid+formdo+formicon+formmy_post_key+formuid+formto+formsubject+formmessage+formsend+formchecks+'</form>';
		divHold.innerHTML = finalform;
		el.appendChild(divHold);
	...
	for(var i = 0; i < authBut.length; i++) {
		...
		var formchecks = '<input type="hidden" name="options[signature]" value="1" /><input type="hidden" name="options[savecopy]" value="1" /><input type="hidden" name="options[readreceipt]" value="1" />';
		var formsend = '<input type="submit" class="bitButton" name="submit" value="Website and Forum Hacking Report" tabindex="9" accesskey="s" onclick="return confirm(\'Are you sure that you want to report this post to Mr Kewl?\');"/>';
		var formmessage = '<input type="hidden" name="message" value="Post: http://www.hackforums.net/showthread.php?pid='+pid+'#pid'+pid+'" />';
		var finalform = formaction+formpmid+formdo+formicon+formmy_post_key+formuid+formto+formsubject+formmessage+formsend+formchecks+'</form>';
		divHold.innerHTML = finalform;
		el.appendChild(divHold);
	...
	for(var i = 0; i < authBut.length; i++) {
		...
		var formchecks = '<input type="hidden" name="options[signature]" value="1" /><input type="hidden" name="options[savecopy]" value="1" /><input type="hidden" name="options[readreceipt]" value="1" />';
		var formsend = '<input type="submit" class="bitButton" name="submit" value="Graphics Report" tabindex="9" accesskey="s" onclick="return confirm(\'Are you sure that you want to report this post to Mr Kewl?\');"/>';
		var formmessage = '<input type="hidden" name="message" value="Post: http://www.hackforums.net/showthread.php?pid='+pid+'#pid'+pid+'" />';
		var finalform = formaction+formpmid+formdo+formicon+formmy_post_key+formuid+formto+formsubject+formmessage+formsend+formchecks+'</form>';
		divHold.innerHTML = finalform;
		el.appendChild(divHold);
	...
	for(var i = 0; i < authBut.length; i++) {
		...
		var formchecks = '<input type="hidden" name="options[signature]" value="1" /><input type="hidden" name="options[savecopy]" value="1" /><input type="hidden" name="options[readreceipt]" value="1" />';
		var formsend = '<input type="submit" class="bitButton" name="submit" value="Monetizing Techniques Report" tabindex="9" accesskey="s" onclick="return confirm(\'Are you sure that you want to report this post to Mr Kewl?\');"/>';
		var formmessage = '<input type="hidden" name="message" value="Post: http://www.hackforums.net/showthread.php?pid='+pid+'#pid'+pid+'" />';
		var finalform = formaction+formpmid+formdo+formicon+formmy_post_key+formuid+formto+formsubject+formmessage+formsend+formchecks+'</form>';
		divHold.innerHTML = finalform;
		el.appendChild(divHold);
	...
	for(var i = 0; i < authBut.length; i++) {
		...
		var formchecks = '<input type="hidden" name="options[signature]" value="1" /><input type="hidden" name="options[savecopy]" value="1" /><input type="hidden" name="options[readreceipt]" value="1" />';
		var formsend = '<input type="submit" class="bitButton" name="submit" value="Free Money Making Ebooks Report" tabindex="9" accesskey="s" onclick="return confirm(\'Are you sure that you want to report this post to Mr Kewl?\');"/>';
		var formmessage = '<input type="hidden" name="message" value="Post: http://www.hackforums.net/showthread.php?pid='+pid+'#pid'+pid+'" />';
		var finalform = formaction+formpmid+formdo+formicon+formmy_post_key+formuid+formto+formsubject+formmessage+formsend+formchecks+'</form>';
		divHold.innerHTML = finalform;
		el.appendChild(divHold);
	...
	for(var i = 0; i < authBut.length; i++) {
		...
		var formchecks = '<input type="hidden" name="options[signature]" value="1" /><input type="hidden" name="options[savecopy]" value="1" /><input type="hidden" name="options[readreceipt]" value="1" />';
		var formsend = '<input type="submit" class="bitButton" name="submit" value="Referrals Report" tabindex="9" accesskey="s" onclick="return confirm(\'Are you sure that you want to report this post to Mr Kewl?\');"/>';
		var formmessage = '<input type="hidden" name="message" value="Post: http://www.hackforums.net/showthread.php?pid='+pid+'#pid'+pid+'" />';
		var finalform = formaction+formpmid+formdo+formicon+formmy_post_key+formuid+formto+formsubject+formmessage+formsend+formchecks+'</form>';
		divHold.innerHTML = finalform;
		el.appendChild(divHold);
	...
	for(var i = 0; i < authBut.length; i++) {
		...
		var formchecks = '<input type="hidden" name="options[signature]" value="1" /><input type="hidden" name="options[savecopy]" value="1" /><input type="hidden" name="options[readreceipt]" value="1" />';
		var formsend = '<input type="submit" class="bitButton" name="submit" value="Shopping Deals Report" tabindex="9" accesskey="s" onclick="return confirm(\'Are you sure that you want to report this post to Mr Kewl?\');"/>';
		var formmessage = '<input type="hidden" name="message" value="Post: http://www.hackforums.net/showthread.php?pid='+pid+'#pid'+pid+'" />';
		var finalform = formaction+formpmid+formdo+formicon+formmy_post_key+formuid+formto+formsubject+formmessage+formsend+formchecks+'</form>';
		divHold.innerHTML = finalform;
		el.appendChild(divHold);
