// --------------------------------------------------------------------
//   Türkçe Çeviri : sYs     e-mail:bboysystr@gmail.com   Çeviri Sorunlarını bildirmek için bu e-mail'i kullanabilirsiniz.
// Bu Bir GreaseMonkey Eklentisidir.
//
// Yüklemek için GreaseMonkey Gerekmektedir: http://greasemonkey.mozdev.org/
// 
// 
// 
//
...
// @version        0.1f
// @namespace      i.am.timas@gmail.com
// @description    Reklamsız oyun. 15x15 Harita. Kısayol Menüsü. Köyler Arası hızlı geçiş ve daha fazlası!!!  Türkçe Çeviri: sYs
...
// @include	   http://en*.ds.ignames.net/*
// @copyright      Copyright (c) 2007 - 2008, Gelu Kelu - Türkçe Çeviri: sYs
// @maintainer     Timas
// ==/UserScript==
...
"en" : {
	...
	"player"   : "ID",
	"tribe"    : "Klan",
	"i_player" : "Kullanıcı Bilgisini Göster",
	"i_tribe"  : "Klan Bilgisini Göster",
	"loading"  : "Yükleniyor...",
	"c_close"  : "Kapatmak için tıkla",
	"track"    : "Köyü Takip Et",
	"tracked"  : "Köy Takip Ediliyor",
	"untrked"  : "Takip Durduruldu",
	"untrack"  : "Takip etmeyi bırak",
	"cltrack"  : "Hepsini Temizle",
	"notrack"  : "Takip Edilen Köy Yok",
	"oktrack"  : "Takip Edilen Köyler",
	"at_none"  : "Tekrar Saldır",
	"at_same"  : "Aynı Askerlerle Tekrar Saldır",
	"at_all"   : "Tüm Askerlerle Tekrar Saldır",
...
function init_game_info(){
	...
	if(TW_Use_Cache === false){
		var info = '';
		info += 'Kullanıcı Adı: ' + TW_Player_Id + '<br />Köyler:<br /><ul style="margin-top:3px">';
	...
	TW_Mpt = get_mpt();
		...
		tw_alert("Bilgi Güncellendi!" , info+pointtrackinfo);
	}
...
function build_shortcuts_menu(){
	...
	menu_xhtml += '<td style="border-left: dotted 1px"><a id="twtools_a" href="javascript:twtools_show()"><img id="twtools_img" src="' + TW_Image_Base + 'unten.png" style="margin:0px 2px" title="TW-Tools" /></a></td>';
	menu_xhtml += '</tr></table>';
	...
	twt_xhtml += '<td><a href="http://' + TWT_World + '.tw-tools.com/index.php?object=main&method=worldindex&lng=en&type=html" target="_blank">TW-Tools</a>:</td>';
...
function enhance_map_screen(){
	...
	var iHtml = '<table><tr><td colspan="2">&nbsp;</td></tr><tr><td align="right">Büyüklük: </td><td><select id="map_size_select" onchange="resize_map()">';
	for(kk=0; kk<sizes.length; kk++) iHtml += '<option ' + (sizes[kk]==new_size ? 'selected="selected" ' : '') + 'value="' + sizes[kk] +'">' + sizes[kk] + 'x' + sizes[kk] + '</option>';

	iHtml += '</select></td></tr>';
	iHtml += '<tr><td align="right">Oyuncu İşaretle: </td><td><input type="text" id="mark_player" size="8" /><input type="text" id="mark_tribe" size="8" /><a href="javascript:search_map();"><img src="'+TW_Image_Base+'/map/map_e.png" /></a></td></tr>';
...
function enhance_mail_screen() {
	...
	var xhtml = "<table class='bbcodearea'> " +
		    ...
		    '	<td><a tabindex="58" href="javascript:insertBB(\'unit catapult\','+random+');"><img src="http://www.tribalwars.net/graphic/unit/unit_catapult.png" /></a></td>' +
      		    ...
      		    "</tr>   " +
		    '	<td><a tabindex="76" href="javascript:insertBB(\'player\','+random+');"><img src="'+ TW_Image_Base +'/face.png" alt="Insert player BB code" /></a></td>' +
		    '	<td><a tabindex="75" href="javascript:insertBB(\'village\','+random+');"><img src="'+ TW_Image_Base +'/buildings/main.png" alt="Insert village BB code" /></a></td>' +
		    '	<td><a tabindex="74" href="javascript:insertBB(\'tribe\','+random+');"><img src="'+ TW_Image_Base +'/command/support.png" alt="Insert tribe BB code" /></a></td>' +
		    '	<td><a tabindex="73" href="javascript:insertBB(\'red\','+random+');"><img src="http://members.lycos.co.uk/bboysys/red.png" alt="Insert tribe BB code" /></a></td>' +
		    '	<td><a tabindex="72" href="javascript:insertBB(\'blue\','+random+');"><img src="http://members.lycos.co.uk/bboysys/blue.png" alt="Insert tribe BB code" /></a></td>' +
		    '	<td><a tabindex="71" href="javascript:insertBB(\'yellow\','+random+');"><img src="http://members.lycos.co.uk/bboysys/yellow.png" alt="Insert tribe BB code" /></a></td>' +
		    '	<td><a tabindex="70" href="javascript:insertBB(\'orange\','+random+');"><img src="http://members.lycos.co.uk/bboysys/orange.png" alt="Insert tribe BB code" /></a></td>' +
		    '	<td><a tabindex="69" href="javascript:insertBB(\'white\','+random+');"><img src="http://members.lycos.co.uk/bboysys/white.png" alt="Insert tribe BB code" /></a></td>' +
		    '	<td><a tabindex="68" href="javascript:insertBB(\'black\','+random+');"><img src="http://members.lycos.co.uk/bboysys/black.png" alt="Insert tribe BB code" /></a></td>' +
		    '	<td><a tabindex="67" href="javascript:insertBB(\'kalin\','+random+');"><img src="http://members.lycos.co.uk/bboysys/kalin.png" alt="Insert tribe BB code" /></a></td>' +
		    '	<td><a tabindex="66" href="javascript:insertBB(\'italic\','+random+');"><img src="http://members.lycos.co.uk/bboysys/italic.png" alt="Insert tribe BB code" /></a></td>' +
		    '	<td><a tabindex="65" href="javascript:insertBB(\'underline\','+random+');"><img src="http://members.lycos.co.uk/bboysys/underline.png" alt="Insert tribe BB code" /></a></td>' +
		    '	<td><a tabindex="60" href="javascript:insertBB(\'addlink\','+random+');"><img src="http://members.lycos.co.uk/bboysys/addlink.png" alt="Insert tribe BB code" /></a></td>' +
		    '	<td><a tabindex="59" href="javascript:insertBB(\'image\','+random+');"><img src="http://members.lycos.co.uk/bboysys/image.png" alt="Insert tribe BB code" /></a></td>' +    		   
      			    "</tr>   " +
        ...
        '	<td><a tabindex="41" href="javascript:insertBB(\'smily confused\','+random+');"><img src="http://forum.tribalwars.net/images/smilies/phpbb_smilies/icon_confused.gif" /></a></td>' +
		    ...
		    '	<td><a tabindex="64" href="javascript:insertBB(\'smile\','+random+');"><img src="http://members.lycos.co.uk/bboysys/smile.png" alt="Insert tribe BB code" /></a></td>' +
		    '	<td><a tabindex="63" href="javascript:insertBB(\'biggrin\','+random+');"><img src="http://members.lycos.co.uk/bboysys/biggrin.png" alt="Insert tribe BB code" /></a></td>' +
		    '	<td><a tabindex="62" href="javascript:insertBB(\'mad\','+random+');"><img src="http://members.lycos.co.uk/bboysys/mad.png" alt="Insert tribe BB code" /></a></td>' +
		    '	<td><a tabindex="61" href="javascript:insertBB(\'eek\','+random+');"><img src="http://members.lycos.co.uk/bboysys/eek.png" alt="Insert tribe BB code" /></a></td>' +
	...
	document.body.innerHTML = document.body.innerHTML.replace( /<textarea\s/gi, xhtml+"<textarea id=\"txt_"+random+"\" ");
			    ...
			    var xhtml = "<table class='bbcodearea'> " +
		    "<tr>    " +
   '	<td><a tabindex="90" href="javascript:insertBB(\'osmim\','+random+');"><img src="http://members.lycos.co.uk/bboysys/osm-im.png" alt="Insert tribe BB code" /></a></td>' +
        		    '	<td><a tabindex="91" href="javascript:insertBB(\'osmby\','+random+');"><img src="http://members.lycos.co.uk/bboysys/Osm-by.png" alt="Insert tribe BB code" /></a></td>' +
        		    '	<td><a tabindex="92" href="javascript:insertBB(\'osm1\','+random+');"><img src="http://members.lycos.co.uk/bboysys/osm1.png" alt="Insert tribe BB code" /></a></td>' +
        		    '	<td><a tabindex="93" href="javascript:insertBB(\'osm2\','+random+');"><img src="http://members.lycos.co.uk/bboysys/osm2.png" alt="Insert tribe BB code" /></a></td>' +
		     "</tr>    " +
		      "</table>";
		      document.body.innerHTML = document.body.innerHTML.replace( /<textarea\s/gi, xhtml+"<textarea id=\"txt_"+random+"\" ");
	...
	TW_Set_Function("insertBB", function(insertType, ident){
			...
			switch (insertType) {
				...
				case 'underline':
					...
					break;
				case 'smile':
					txtinsertBefore = "[img]http://members.lycos.co.uk/bboysys/smile[/img]";
					insertButton = 'R';
					break;
				case 'biggrin':
					txtinsertBefore = "[img]http://members.lycos.co.uk/bboysys/biggrin[/img]";
					insertButton = 'R';
					break;
				case 'mad':
					txtinsertBefore = "[img]http://members.lycos.co.uk/bboysys/mad[/img]";
					insertButton = 'R';
					break;
				case 'eek':
					txtinsertBefore = "[img]http://members.lycos.co.uk/bboysys/eek[/img]";
					insertButton = 'R';
					break;
					case 'osmim':
					txtinsertBefore = "[img]http://members.lycos.co.uk/bboysys/Osm.biz.jpg[/img]";
					insertButton = 'R';
					break;
					case 'osmby':
					txtinsertBefore = "[img]http://members.lycos.co.uk/bboysys/osm.by.jpg[/img]";
					insertButton = 'R';
					break;
					case 'osm1':
					txtinsertBefore = "[img]http://members.lycos.co.uk/bboysys/osm1.jpg[/img]";
					insertButton = 'R';
					break;
					case 'osm2':
					txtinsertBefore = "[img]http://members.lycos.co.uk/bboysys/osm2.jpg[/img]";
					insertButton = 'R';
					break;
				case 'addlink':
					txtinsertBefore = "[url]";
