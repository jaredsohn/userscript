// ==UserScript==
// @name          Tycho Blasphemy Blaster
// @namespace     http://www.someurlthingherethatsprettyunique.com/blah/Tycho Blasphemy Blaster
...
(function() {
	...
	var ReplacementText = "gosh darn";
	
	//edit the words here
	//sorted alpha backwords to catch bad word groupings
	var badwords=['Goddamn', 'Goddamned'];
