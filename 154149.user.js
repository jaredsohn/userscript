// ==UserScript==
// @name        Selected-Deleted Friend Facebook
// @description Hal Ini Memungkin Anda Untuk Menghapus Massal Secara 1 per 1 Teman Facebook Anda.
// @namespace   HEP-FriendsDeleteter
// @include      *.facebook.com/*
// @require       http://ajax.googleapis.com/ajax/libs/jquery/1.7/jquery.js
// @version     2.2
// ==/UserScript==
// Developed by Celvin Dewantara - http://celvin-wae.com/
...
function replace_msg(x) {
	$('div.dialog_body').html('Mantab Gan! ' + x + ' Friend's Deleted. Subsrcribe My Facebook at <a target="_blank" href="http://celvin-wae.com">http://celvin-wae.com</a> Thank's!');
}
set_timer();
