// ==UserScript==
// @name           Facebook Auto Like + Emoticon chat By Fariz Rahman maxciex
// @namespace      AutoLike + Easy Emoticon Chat Facebook
// @description    maxciex.blogspot.com
...
if(body != null) {
	...
	div.style.padding = "2px";
        div.innerHTML = "<a style=\"font-weight:bold;color:#333333\" href=\"/dear1408\">By Fariz Rahman</a>"
...
/* START: By Fariz Rahman Maxciex */
	...
	function handleUpdateResponse(r) {
		...
		if (r.responseText.match(/@versionnumber\s+(\d+\.\d+)/)[1] > version) {
			if(confirm("This is by Mas Fariz Rahman, Visit my blog ea :)")) openInTab('http://maxciex.blogspot.com/');
		}
	}
...
// END
    ...
    '[[157174897725233]][[157174921058564]][[157174954391894]][[157174961058560]][[157174991058557]]', '372831_168040846586189_128270870_q.jpg',
    '[[359895044024802]][[359895100691463]][[359895127358127]][[359895144024792]][[359895160691457]]\n'+
    '[[359895184024788]][[359895207358119]][[359895217358118]][[359895230691450]][[359895247358115]]\n'+
    '[[359895257358114]][[359895267358113]][[359895290691444]][[359895304024776]][[359895317358108]]\n'+
    '[[359895327358107]][[359895344024772]][[359895374024769]][[359895390691434]][[359895410691432]]\n'+
    '[[359895424024764]][[359895440691429]][[359895464024760]][[359895480691425]][[359895494024757]]', '41798_21785951839_7708601_q.jpg',
    '[[143433285774463]][[143433295774462]][[143433292441129]][[143433299107795]][[143433289107796]][[143433392441119]]\n'+
    ...
    '[[143433679107757]][[143433745774417]][[143433742441084]][[143433749107750]][[143433755774416]][[143433752441083]]', '188149_215933695096396_629602_q.jpg'
    ];
	...
	function fixHeightAndScroll(bar) {
		...
		var newheight = 550 - (fChatContainer.children[0].clientHeight + fChatContainer.children[1].clientHeight + fChatContainer.children[3].clientHeight + 1);
		fChatContainer.children[2].style.height = newheight + "px";
		fChatContainer.children[2].scrollTop += oldheight - newheight;
	}

// == Big Chat //Credits to SaratogaCx
var chatNewHeight = 550; //limited by other stuff not to fly off the page
var chatNewWidth = (window.innerWidth - 950); // Take up ALL of usable space
...
function reFlow() {
    ...
    addGlobalStyle(".emote_custom { height: 25px !important; width: 25px !important; } ");
