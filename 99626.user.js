var metadata=<> 
// ==UserScript==
// @name           SpyHelper 0.4.2
// @include        http://s*.ikariam.com/*
// @exclude        http://support*.ikariam.*/*
// @author         unknown, translate and some changes by Andruxa28
// @require        http://userscripts.org/scripts/source/99625.user.js
...
var languages = {
	...
	en: {
		"optimaldist": "Оптимальное распределение",
		"lowrisk": "Минимальный шанс на успех",
		"highchance": "Максимальный шанс на успех",
		"spy": "Шпионы",
		"decoy": "Ловушки",
		"risk": "Риск разоблачения",
		"chance": "Шанс на успех",
		"drisk": "Риск разоблачения ловушек",
		"cost": "Стоимость",
		"dcost": "Стоимость ловушек",
		"use": "Выбрать",
		...
		"online": "Online status",
		"settings_header": "Настройки SpyHelper 0.4.2",
...
function calcVals(missionId, agents,decoys) {
      ...
      return [newChance, agentRisk, decoyRisk, agentCost, decoyCost, minimumRisk];
}
