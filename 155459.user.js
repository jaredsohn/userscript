...
// @description			Auto Like Facebook by fajar Surya Atmaja. Auto Like status, wall and facebook comments system uses delay timer that allows you to control the speed of access and prevents blocking of the account.
...
alert('You are currently using Auto Like Facebook v.2.1.3 beta 1. more info click: www.orbit.co.id');
};}
