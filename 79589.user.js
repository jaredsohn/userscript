// JavaScript Document
// ==UserScript==
// @name           Ikariam Favori Şehirler v.1
// @autor          Ikariam World Beta: DLR Alliance
// @license        GNU GPL v3 (http://www.gnu.org/copyleft/gpl.html)
// @homepage       http://userscripts.org/scripts/show/49151
// @description    (www.ikariam.forumm.biz)Biz daha iyisini yapana kadar en iyisi bu :D
	...
	$("div#"+page).each(function() {
		$(this).before(
			'<div style="cursor: default" class="dynamic">' +
				'<h3 class="header">Favori Şehirler</h3>' +
...
function updateTargetsScratchpad()
{
  ...
  for (var t = 0; t < IK_TARGETS.length; t++)
  {
    ...
    plunderColumn.innerHTML = '<a href="?view=plunder&destinationCityId=' + cityID + '"><img src="' + IMAGES.plunder + '" width="18" title="Yagma" /></a>';

    var blockadeColumn = document.createElement('td');
    blockadeColumn.setAttribute('width', '20');
    blockadeColumn.innerHTML = '<a href="?view=blockade&destinationCityId=' + cityID + '"><img src="' + IMAGES.blockade + '" width="18" title="Abluka" /></a>';

    var espionageColumn = document.createElement('td');
    espionageColumn.setAttribute('width', '20');
    espionageColumn.innerHTML = '<a href="?view=sendSpy&destinationCityId=' + cityID + '"><img src="' + IMAGES.espionage + '" width="18" title="Casus Gönder" /></a>';
...
function addFavoriteButton(id, name) 
{
	$("div#actions ul").append(
		'<li class="favaction">' +
			'<a id="'+id+'" name="'+name+'" href="#" title="www.ikariam.forumm.biz">' +
				'<span class="textLabel">Favorilere Ekle</span>' +
			'</a>' +
		'</li>'
	);
...
function addUnfavoriteButton(id)
{
	$("div#actions ul").append(
		'<li class="unfavaction">' +
			'<a id="'+id+'" href="#" title="www.ikariam.forumm.biz">' +
				'<span class="textLabel">Favorilerden Çıkar</span>' +
			'</a>' +
		'</li>'
	);
