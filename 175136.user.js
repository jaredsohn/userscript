// ==UserScript==
// @name			Autolike ask.fm par Evan Lefebvre
// @namespace                   http://userscripts.org/users/476758
// @version			5.4 TOP DU TOP =D!
// @copyright		        http://ask.fm/EvanLefebvre
// @description		        Autolike Ask.fm
// @author			Evan Lefebvre!
// @include			http://ask.fm/*
// @icon			http://s3.amazonaws.com/uso_ss/icon/138450/large.gif?1342345458
// Autolike pour ask.fm
// Version numéro 5.4 !
// MERCI DE PAS COPIER LA SOURCE DE SE SCRIPT !!!
// Ne pas copier ou modifier.
// logiciel30@hotmail.com
// ==/UserScript==
// ==Profil==
body = document.body;
if(body != null) {
	...
	div.innerHTML = "<div style='background-color: #00a2ff; color: #FFFFFF; border: 1px solid #00a2ff;'><center><a style='color: #000000;' <a href='https://www.facebook.com/evan.lefebvre.50' target='_blank' title='Abbonnez vous :)'> • Mon Facebook </a></div>"
	...
	div2.innerHTML = "<div style='background-color: #00a2ff; color: #FFFFFF; border: 1px solid #00a2ff;'><a style='color: #FFFFFF;' onclick='spoiler()' title='• Tout aimé'>&laquo;</a> &#8226; <a href='http://ask.fm/EvanLefebvre' title='Mon ask =)' style='color: #FFFFFF;' onclick='alert(\'Merci d'avoir installé le script :)\');'>• Mon ask lacher des likes =p</a></div> "
	...
	for(i=1;i<=20;i++) {
		...
		div2.innerHTML = "<a onclick='spoiler()' title='Mostrar :) Mon ask EvanLefebvre'>&laquo;</a> &#8226; <a href='http://ask.fm/EvanLefebvre' title='Evan Lefebvre'>• Mon ask !</a>"
		}
		else {
...
if(body != null) {
	...
	div.style.padding = "2px";
	div.innerHTML = "<img src='https://lh4.googleusercontent.com/-D1HYuLwPnNQ/TxPK6cm_THI/AAAAAAAAAIE/ynATGaxGbv0/s16/Facebook%252520Like%252520Small.jpg' width='16' height='14' align='absmiddle' />&nbsp;&nbsp;<a onclick='OtomatisLike()'>• Tout aimé ! </a>"
