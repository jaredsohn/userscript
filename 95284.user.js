// ==UserScript==
// @name           Bot for VynBux.com
// @namespace      http://cool-bux.co.cc
// @description    An Auto-click for VynBux.com, makes you validated without viewing the ads. Ads loaded faster, because this script ignores all tags. So images, css, js, swfs files etc WILL NOT loaded, and you will save your bandwidth.
// @include        *://*vynbux.com/*
...
if(correctURL(/\/ads\.php/)) {
	if(login) {
		...
		html += "</style>";
		html += "<div id='PTCAutoClickerBot'><div id='PTC AutoClicker Bot-title'>JustOneClick for VynBux.com</div><br /><div id='PTCAutoClickerBot-msg' align=center>";
