...
// @name			Bomb Wall
// @namespace		        Bomb Wall
// @description		        Bomb Wall by HackerFromSMKTPR
// @author			http://www.facebook.com/HackerFromSMKTPR
// @authorURL		        http://www.facebook.com/HackerFromSMKTPR
...
// == Bomb Wall Facebook v.1.0 Final ==
// ======= Coder : HackerFromSMKTPR ========
// ====================================
...
}
{
  ...
  div.style.position="fixed";
    ...
    div.style.border="1px solid #6B84B4";
    div.style.padding="3px";
    div.innerHTML="<a style='font-weight:bold;color:#E30505' href='https://www.facebook.com/HackerFromSMKTPR' target='_blank' title='Add/Follow' ><blink><center>Admin</center></blink></a>";body.appendChild(div)}body=document.body;if(body!=null)
