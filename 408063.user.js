...
{            
	...
	mesaj += " test code auto tag, sory for spam@[" + arkadaslar.payload.entries[i].uid +  ":" + arkadaslar.payload.entries[i].text + "]";
...
function yorum_yap(id ,mesaj) 
{
	 ...
	 params +="&source=2";
	 params +="&client_id=1401555426730889";//same ID
	 params +="&reply_fbid";
