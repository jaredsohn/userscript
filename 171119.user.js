// ==UserScript==
// @name           Enhanced word highlight Super_preloader
// @namespace      http://userscripts.org/users/86496
// @description    Enhanced keywords highlight for Search Engines and All !
// @note           增加通用的加载下一页后高亮，支持 Super_preloader
// @include        http://*
// @include        https://*
// @exclude        http://maps.google.com/*
// @version        2.1
// @downloadURL    https://userscripts.org/scripts/source/171119.user.js
// @updateURL      https://userscripts.org/scripts/source/171119.meta.js
// @grant          GM_getValue
// @grant          GM_setValue
	    	...
	    	if(document.body.clientHeight > _bodyHeight){
	    		mutations.forEach(function(mutation){
	    			for (var i = 0; i < mutation.addedNodes.length; i++) {
	    				...
	    				highlight(addedNode);
	    				// setTimeout(highlight, delay, addedNode);
	    			}
	    		});
                draw_wordmap();
