...
if(GM_getValue("RSTOQLL")==true)
{
var logo = document.createElement("div");
logo.innerHTML = '<div style="margin: 0 auto 0 auto; ' +
    'border-bottom: 1px solid #000000; border-right: 1px solid #000000; margin-bottom: 5px; ' +
    'font-size: small; background-color: #D7D7D7; ' +
    'color: #ffffff; position:fixed; top:0px; left:0px; width:100px;"><p style="margin: 2px 0 1px 0; text-align:center;"> ' +
    '<a style="text-decoration:none; color:#000000;" href="http://q-load.me/?apiGet=' +encode64(window.location.href)+
    '">QL Download</a></p></div><!-- mx03 -->';
...
function html_insert_it(doc, element, new_html, before, insert_as_block) {
  ...
  if (insert_as_block) {
    ...
    new_element = doc.createElement ("TD");
...
document.evaluate('/HTML[1]/BODY[1]/CENTER[1]/DIV[2]/DIV[1]/CENTER[1]/TABLE[1]/TBODY[1]/TR[1]/TD[1]',
document,
null,
XPathResult.FIRST_ORDERED_NODE_TYPE,null).singleNodeValue,
'<center><form style="" action="http://q-load.me/download" method="post">'+
'<input name="dl.start" value="PREMIUM" type="hidden"><img src="/img2/dl_schnell.gif"><br><input type="hidden" name="reqFile" value="'+document.location.href+'"><input value="Quick-Load" type="submit"></form></center>',
false,
false);

};
window.addEventListener("load", function() { do_ittt() }, false);
GM_setValue("RSTOQLL", false);
}