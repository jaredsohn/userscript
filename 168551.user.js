// ==UserScript==
// @name          Better Westcoast
// @namespace     absolut-fair.com
// @description   Machs dir wie du's willst
// @include       http://gtawc.net/*
// @require       http://ajax.googleapis.com/ajax/libs/jquery/1.6.4/jquery.min.js
// @version       1.2.2
// @updateURL     https://userscripts.org/scripts/source/168551.meta.js
// @downloadURL   https://userscripts.org/scripts/source/168551.user.js
// ==/UserScript==
var popupStatus=0;
...
$(document).ready(function () {
	...
	if(allow("spitzname"))
	{
		$(".messageSidebar").each(function() {
			var uid = $("a",$(".userName",this)).attr("href").replace("http://gtawc.net/index.php?page=User&userID=","");
