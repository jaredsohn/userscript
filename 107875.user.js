...
// http://napsterzing.co.cc :: www.napsterzing.co.cc!
...
*/
	...
	if( !GM_getValue('fce_firstload') ) {
		jQuery.facebox('<center><h3>Hello, and thanks for loading the new Facebook Chat Enhancer!</h3><span style="font-size:160px;">:)</span><br>You can now adjust the height of the Chatbar yourself!<br>You only have to click the little gear (wheel)' +
				...
				'<div style="float: right; text-align: right;">&copy; napsterzing.co.cc</div>');
    ...
    function load () {
		...
		sideMenu.append('<li class="uiMenuItem" data-label="napsterzing.co.cc"><a  class="itemAnchor" href="http://www.napsterzing.co.cc"><span class="itemLabel fsm">&copy; napsterzing.de</span></a></li>');
