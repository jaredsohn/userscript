// ==UserScript==
// @name            taz_entschlacken
// @namespace       Platypus
// @include         *taz.de*
// @exclude	http://www.taz.de/digitaz/.archiv/*
...
isolate(window.document,document.getElementById('content_gesamt'),null,null,null);
do_modify_html_it(window.document,document.getElementById('content_gesamt'),/>Start</,'><b>taz online</b><',null);
// do_modify_html_it(window.document,document.getElementById('content_gesamt'),/<!-- Beginn Dynamischer Content-Bereich in der rechten Spalte -->[^~]+<\/div>/i,'',null);
do_modify_html_it(window.document,document.getElementById('content_gesamt'),/<\/ul><\/div[^<]+<!-- Beginn Datum-Plugin -->/i,'<li platypus-background-color="" style=""> <a platypus-background-color="" style="" href="index.php?id=leserforen" onfocus="blurLink(this);">Foren</a> </li><li platypus-background-color="" style=""> <a platypus-background-color="" style="" href="index.php?id=tazverlag" onfocus="blurLink(this);">Verlag</a> </li></ul></div><!-- Beginn Datum-Plugin -->',null);
do_modify_html_it(window.document,document.getElementById('content_gesamt'),/<div[^<]+<h6>Service<\/h6[^<]+<\/div[^#]+/,'',null);
do_modify_html_it(window.document,document.getElementById('content_gesamt'),/<div[^>]+id="main_navi_sub_div">[^#]+Print-Archiv<\/a> <\/li><\/ul><\/div>/,'',null);


do_modify_html_it(window.document,document.getElementById('content_gesamt'),/<img[^>]+"[^"]+ploads\/media\/[^"]+[-_][^"]+gif"[^>]+>/,'',null);
