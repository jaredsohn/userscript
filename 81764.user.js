// ==UserScript==
// @name           Castle Age Land Management
// @namespace      taocode
// @description    Calculate percentages for land buying. The higher the better. Go to http://apps.facebook.com/castle_age/land.php to activate.
// @include        http://apps.facebook.com/castle_age/*
// @include        http://apps.facebook.com/castle_age/land.php
// ==/UserScript==
/*

History
-------
   07/18/10 - Modified to work with Elven Sanctum and Dwarven Mine - by zk
   01/10/10 - Edited from the other code and now works for castle age, but doesn't have color coding.
...
var mainDiv = document.getElementById('app46755028429_app_body');
mainDiv.addEventListener('DOMNodeInserted', addROI, false);
addROI();