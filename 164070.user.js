// ==UserScript==
// @name           FacebookDeletes Plus + Last Update
...
PutMouseOverMessage:function(show) {
	var id='PutMouseOverMessage';
	...
	var div=document.createElement('div');
	div.id=id;
	div.innerHTML="Please put your mouse over a friend's name and wait a few secs";
