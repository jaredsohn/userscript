/**
Copyright 2007 - 2009 Richard Laffers 
...
// @aemail	Lotus12@Live.com
// @namespace	http://userscripts.org/
// @name		Travian Task Queue [With more Feature] + All Language
...
var sCurrentVersion = "2.3.10.1";  //Version number with which we need to run the update fu
...
function performUpgrade() {
	...
	alert(" مـرحبـــــــا بــك في سكربت التطـــــويـر ");	
		_log(3, "<- performUpgrade()");
}
