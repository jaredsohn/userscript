...
// @name           testetet
// @namespace      testetet
// @description    e-Sim in persian language
// @version        2.0
...
menuLinkReplacements = {
	"work.html"				:["Work","کار"],
	"train.html"			:["Train","تمرین نظامی"],
	"equipment.html"		:["Equipment","لوازم جنگی"],
	"companies.html"		:["Companies","کمپانی"],
	"newspaper.html"		:["Newspaper","روزنامه"],
	"myParty.html"			:["Party","حزب"],
	"contracts.html"		:["Contracts","قرارداد"],
	"myShares.html"		    :["Shares","سهام"],
	"myAuctions.html"		:["Auctions","مزایده"],
...
"news.html\?newsType=TOP_ARTICLES"		:["Top articles","مقالات برتر"],
	"news.html\?newsType=LATEST_ARTICLES"	:["Latest articles","آخرین مقالات"],
	"news.html\?newsType=MILITARY_EVENTS"	:["Military events","اتفاقات نظامی"],
	"news.html\?newsType=POLITICAL_EVENTS"	:["Political events","اتفاقات سیاسی"],
...
hpTabsReplacements = {
	"#topArticles":["Global","جهانی"],
	"#latestArticles":["Latest","آخرین"],
	"#localArticles":["Local","داخلی"],
...
function doSide() {
	...
	var sideLink2Replacements = {
		...
		"http://wiki.e-sim.org/index.php/Health"	:["Health tutorial","آموزش سلامتی"],
	};
...
function doTrain() {
	var train1Replacements = {
		"."					:[/(Military training)/,"تمرین نظامی",
							...
							/(Damage)/,"تخریب",
							/(Critical Hit)/,"دمیج خرکی",
							/(Critical Hit chance)/,"شانس دمیج خرکی داشتن.",
							/(Miss chance)/,"شانس از دست دادن",
...
function doPremium() {
	...
	tmp.innerHTML="<h2 style='text-align: center'>اسکریپت فارسی ساز</h2>"
		+ "<i>اسکریپت فارسی سازای-سیم</i> بعد از یک ماه تلاش آپدیت شد. همونطور که میدونید ورژن اول این اسکریپت سال قبل نوشته شد که دو ماه زمان کل کار کدنویسی و ترجمه بود. با آپدیت شدن بازی قسمتهای جدید زیادی اضافه شد که ترجمه نشده باقی مونده بود بنابرین نوشتن یک کد جدید الزامی بود. با آمدن سرور سکورا قسمتهای زیادی از اسکریپت قبلی از کار افتاد و بازنویسی شد. آپدیتهای متفاوت بازی باعث شد طی یک ماه تمامی سایت مجددا ترجمه شود. آپدیتهای بازی و تغییرات گرافیکی بازی ممکن است باعث از کار افتادن قسمتهای مختلف اسکریپ شود. در صورت مشاهده هر گونه مشکل با سازنده اسکریپت تماس بگیرید  <br/><br/>"
	...
	tmp.innerHTML = tmp.innerHTML.replace(/FAQ/,"سوالات پرتکرار")
