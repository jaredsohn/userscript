...
var numero_uni = location.href.split('/uni')[1].split('.ogame.')[0];
...
function parseResponse(txt) {
	var elm = document.createElement('div');
		...
		if(elm.getElementsByClassName("allianceAttack")){
			...
			for(i=0; i< allianceAttack.length ; i++){
				{/** on met a 10px chaque ligne **/
					...
					if(allianceAttack[i].getElementsByClassName("friendly textBeefy")[0]){
		...
		if(elm.getElementsByClassName("partnerInfo")){
			var partnerInfo = elm.getElementsByClassName("partnerInfo");	
			
			for(i=0 ; i< partnerInfo.length ; i++){
				var elem22 = partnerInfo[i];
				{/** on met a 10px chaque ligne **/
					//elem22.getElementsByClassName("arrivalTime")[0].style.fontSize = '10px';
					elem22.getElementsByClassName("missionFleet")[0].style.fontSize = '10px';
					elem22.getElementsByClassName("originFleet")[0].style.fontSize = '10px';
					elem22.getElementsByClassName("coordsOrigin")[0].style.fontSize = '10px';
					elem22.getElementsByClassName("detailsFleet")[0].style.fontSize = '10px';
					elem22.getElementsByClassName("descFleet")[0].style.fontSize = '10px';
					elem22.getElementsByClassName("destCoords")[0].style.fontSize = '10px';
					elem22.getElementsByClassName("countDown")[0].style.fontSize = '10px';
				}
				elem22.setAttribute('style',"color:#A59CAF;font-weight:bold;");

				if(elem22.getElementsByClassName('descFleet')[0].title && elem22.getElementsByClassName('descFleet')[0].title != 'undefined'){
					var pseudo = elem22.getElementsByClassName('descFleet')[0].title.split('|')[1];
					var pseudo_rajouter ='<br/> <a href="http://www.war-riders.de/fr/'+numero_uni +'i/details/player/'+ pseudo+'" target="_blank" class="a_war_rider">'+pseudo +'</a>';
					var span_pseudo = document.createElement('span');
						span_pseudo.innerHTML = pseudo_rajouter;
						elem22.getElementsByClassName("descFleet")[0].appendChild(span_pseudo);
				}
