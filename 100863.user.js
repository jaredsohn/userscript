// ==UserScript==
// @name           Binnews Improvment
// @namespace      Mantalo
// @description    Add a link to newsgroups search websites and several other website
...
linksArray.forEach(function(link) {
	...
	*/
	generateLink(td, str, 'NI', 'NZBIndex', 'http://www.nzbindex.nl/search/?q=$$STR$$&age=&max=250&sort=agedesc&minsize=&maxsize=&dq=&poster=&nfo=&hidespam=0&hidespam=1&more=0', {backgroundColor:'blue', color:'white'}, {width:'18px', height:'16px'});
