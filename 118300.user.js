// ==UserScript==
// @name			DoA Power Tools DIABOLIK VERSION
// @namespace		Fixed
// @description		VERSIONE FIXATA. 
 ...
 ********************************************************************************/
// Script information
var Version = '1.0.1_VERSIONE_BETA'; // Year, Month, Day, Revision, Maturity (e.g. YYYMMDDa_BETA)
...
var kDragonAltar = 'SpectralDragonKeep';
var kReapingStones = 'EnergyCollector';
...
var kSpctDragon = 'SpectralDragon';
...
var translateFrArray = {
	...
	'Stop if any troops lost: ':'ArrР“Р„ter si perte de troupes: ',
	'Delay Between attacks: ':'DР“В©lai Entre les Attaques: ',
	' to ':' Р“В ',
	' seconds ':' secondes ',
	...
	'StorageVault':'EntrepР“Т‘t SР“В©curisР“В©',
	...
	'Lumbermill':'Scierie',
	'Quarry':'CarriР“РЃre',
	'TrainingCamp':'Camp d\'EntraР“В®nement',
	'Silo':'Silo',
	'Agriculture':'Agriculture',
	'Woodcraft':'Science du Bois',
	'Masonry':'MaР“В§onnerie',
	'Alloys':'Alliages',
	'Clairvoyance':'Clairvoyance',
	'Rapid Deployment':'DР“В©ploiment Rapide',
	'Weapons Calibration':'Calibration d\'Armes',
	'Metallurgy':'MР“В©tallurgie',
	'Medicine':'MР“В©decine',
	'Dragonry':'Etude Dragons',
	'Levitation':'LР“В©vitation',
	'Mercantilism':'Mercantilisme',
	'Aerial combat':'Combat AР“В©rien',
	'level':'niveau',
	'Units':'Troupes',
	'Wave':'Vague',
	...
	'Research':'Recherche',
	'Training':'EntraР“В®nement',
	'NONE':'AUCUN',
	'BUSY':'OCCUPE',
	'refresh':'rafraР“В®chir',
	...
	'DEFENDING':'DР“РЃFENSE',
	'Dark Portal':'Portale Oscuro',
	'Mausoleum':'Mausoleo',
	'DragonAltar':'Drg Altar',
	'ReapingStones':'Ptr Racc',
...
var translateNlArray = {
	...
	'Target Coords: ':'Doelwit CoР“В¶rdinaten: ',
...
function translate( wordToTranslate ) {
	...
	if ( navigator.language == 'fr' ) {
		if ( translateFrArray[wordToTranslate] != undefined ) {
			...
			logit( wordToTranslate+' Р“В  traduire' );
		}
	}
...
console.log(rslt);
	...
	updateCity : function (city) {
		...
		if (city.outpost_type&&city.outpost_type=='SpectralDragonOutpost') Seed.cities[5] = city;
...
//*** Attacks Tab - Stats Sub-tab ***
 ...
 // Data.options.campAttack {enabled:false, maxDist:7, repeatTime:3660, delayMin:15, delayMax:25, levelEnable:[], levelDist:[]}
  ...
  troopTypes : [kPorter, kConscript, kSpy, kHalberdsman, kMinotaur, kLongbowman, kSwiftStrikeDragon, kBattleDragon, kArmoredTransport, kGiant, kFireMirror, kAquaTroop, kStoneTroop, kFireTroop, kWindTroop, kGreatDragon, kWaterDragon, kStoneDragon, kFireDragon, kWindDragon, kSpctDragon],
  ...
  hide : function (){
    ...
    showStuff : function (){
        ...
        for (var i=0; i<Names.troops.names.length; i++){
            ...
            if (name==kGreatDragon || name==kWaterDragon || name==kStoneDragon || name==kFireDragon || name==kWindDragon|| name==kSpctDragon) continue;
...
var Names = {
  troops : {
	...
	[16, kSpctDragon, kSpcDrg],
    [17, kAquaTroop, kFang],
    [18, kStoneTroop, kOgre],
    [19, kFireTroop, kLavaJaw],
	[20, kWindTroop, kBanshee],
    ],
  }, 
...
//    researchTimer   : null,
    ...
    trainJobs       : [],
    capitolResearch : {Agriculture:'Agriculture', Woodcraft:'Woodcraft', Masonry:'Masonry', Mining:'Alloys', Clairvoyance:'Clairvoyance', RapidDeployment:'Rapid Deployment', Ballistics:'Weapons Calibration', Metallurgy:'Metallurgy', Medicine:'Medicine', Dragonry:'Dragonry', Levitation:'Levitation', Mercantilism:'Mercantilism', AerialCombat:'Aerial Combat', EnergyCollection:'Energy Collection',WarriorRevival:'Warrior Revival',GuardianRevival:'Guardian Revival'},
    researchIdx     : {Agriculture:0, Woodcraft:1, Masonry:2, Mining:3, Clairvoyance:4, RapidDeployment:5, Ballistics:6, Metallurgy:7, Medicine:8, Dragonry:9, Levitation:10, Mercantilism:11, AerialCombat:12,EnergyCollection:13,WarriorRevival:14,GuardianRevival:15},
    ...
    outpost2City     : [kDarkPortal, kMausoleum, kDragonAltar],
    outpost2Field    : [kReapingStones],
    capitalResearch : ['Agriculture', 'Woodcraft', 'Masonry', 'Alloys', 'Clairvoyance', 'Rapid Deployment', 'Weapons Calibration', 'Metallurgy', 'Medicine', 'Dragonry', 'Levitation', 'Mercantilism', 'Aerial Combat','Energy Collection','Warrior Revival','Guardian Revival'],
	...
	tabJobBuild : function (){
		...
		if (i<5){
                	...
                	listC = t.outpost2City;
                	listF = t.outpost2Field;
		}
            }
        ...
        for (var i=0; i<Seed.cities.length; i++) {
            var len = (i==0) ? (t.capitolCity.length + t.capitolField.length) : (i<5)?(t.outpostCity.length + t.outpostField.length):(t.outpost2City.length + t.outpost2Field.length);
            for (var ii=0;ii<len; ii++) {
                ...
                try {
                    if (!Data.options.autoBuild.buildCap[i][ii]) {
                        ...
                        var outpostB2 = t.outpost2City.concat(t.outpost2Field);                    
                        var lowestBuildingLevel = t.getCurrentLowestBuildingLevel(i, (i==0)? capitolB[ii] : (i<5)?outpostB[ii]:outpostB2[ii]);
                        selectMenu.selectedIndex = lowestBuildingLevel;
                        Data.options.autoBuild.buildCap[i][ii] = lowestBuildingLevel;
		console.log(lowestBuildingLevel);
                    }
                    else {
    ...
    getBuildingCap : function (cityIdx, buildingType){
        var t = Tabs.Jobs;
        var cap = 0;
        var cityType =  (cityIdx == 0) ? t.capitolCity : (cityIdx<5)?t.outpostCity:t.outpost2City;
        cityType =  (cityIdx == 0) ? cityType.concat(t.capitolField) : (cityIdx<5) ? cityType.concat(t.outpostField):cityType.concat(t.outpost2Field);
    ...
    checkBuildReqs : function(cityIdx, buildingType){
        ...
        switch (buildingType) {
            ...
            case kDarkPortal:       return t.checkStandardReqs(cityIdx, buildingType, 300, 2000, 1300, 1750);
            case kMausoleum:        return t.checkStandardReqs(cityIdx, buildingType, 150, 1000, 500, 200);
            case kDragonAltar:      return t.checkStandardReqs(cityIdx, buildingType, 400, 1500, 2500, 1500);
            case kReapingStones:    return t.checkStandardReqs(cityIdx, buildingType, 250, 1200, 500, 1500);
        }  
    },
    ...
    checkEnergyCollectionReqs : function() {
        // dragonry, dragons keep, gold, food, dragon armor (items)
        var t = Tabs.Jobs;
        var researchType = 'EnergyCollection';
        var researchLevel = t.getCurrentResearchLevel(researchType);
        var gold = 10000 * Math.pow(2,researchLevel +1);
        var food = 200 * Math.pow(2,researchLevel +1);
        var wood = 400 * Math.pow(2,researchLevel +1);
        var stone = 200 * Math.pow(2,researchLevel +1);
        var metals = 400 * Math.pow(2,researchLevel +1);
        var m = '';
        var n = '<TABLE><TR><TD>Need: </td>';
        var city    = Seed.cities[0];
        ...
        try {
            ...
            gold = seedReqs.level[researchLevel + 1].resources['gold'];
            food = seedReqs.level[researchLevel + 1].resources['food'];
            ore = seedReqs.level[researchLevel + 1].resources['ore'];
            wood = seedReqs.level[researchLevel + 1].resources['wood'];
            stone = seedReqs.level[researchLevel + 1].resources['stone'];
        }
        catch(e){
            actionLog('Building: ' + e.msg + ' Manifest not available, using defaults');
        ...
        if (city.resources.gold < gold) m += '<TD>&nbsp;gold '+ (gold - city.resources.gold) +'</td>';
        if (city.resources.food < food) m += '<TD>&nbsp;food '+ (food - city.resources.food) +'</td>';
        if (city.resources.wood < wood) m += '<TD>&nbsp;wood '+ (wood - city.resources.wood) +'</td>';
        if (city.resources.ore < ore) m += '<TD>&nbsp;ore '+ (ore - city.resources.ore) +'</td>';
        if (city.resources.stone < stone) m += '<TD>&nbsp;stone '+ (stone - city.resources.stone) +'</td>';
        if (m.length == 0) {
            ret.researchable = true;
            ret.msg = 'Researching:' + kLevel1 + ' ' + (researchLevel + 1) + ' ' + researchType;
    ...
    checkWarriorReqs : function() {
        // dragonry, dragons keep, gold, food, dragon armor (items)
        var t = Tabs.Jobs;
        var researchType = 'WarriorRevival';
        var researchLevel = t.getCurrentResearchLevel(researchType);
        var gold = 10000 * Math.pow(2,researchLevel +1);
        var food = 200 * Math.pow(2,researchLevel +1);
        var wood = 400 * Math.pow(2,researchLevel +1);
    ...
    checkGuardianReqs : function() {
        // dragonry, dragons keep, gold, food, dragon armor (items)
        var t = Tabs.Jobs;
        var researchType = 'GuardianRevival';
        var researchLevel = t.getCurrentResearchLevel(researchType);
        var gold = 10000 * Math.pow(2,researchLevel +1);
        var food = 200 * Math.pow(2,researchLevel +1);
        var wood = 400 * Math.pow(2,researchLevel +1);
    ...
    checkResearchReqs : function (researchType){
        ...
        switch(researchType) {
            ...
            case 'EnergyCollection':    return t.checkAerialCombatReqs();
            case 'WarriorRevival':    return t.checkAerialCombatReqs();
            case 'GuardianRevival':    return t.checkAerialCombatReqs();
        }
    },
