...
// @namespace           http://userscripts.org/users/124322
// @description         schlaegt Fahrzeuge zu Einsatzstichworten vor
// @include             http://www.feuerwache.net/*
// @special thanks to   sawos and chrisantonia
// @AAO by              1894 
// @version             2010-06-14 19:36
// ==/UserScript==
...
var INSTALLURL="http://userscripts.org/scripts/source/65201.user.js";

// ******************************************************************************************
// AAO KOPIEREN AB HIER //function df() { debugging=false; }// AAO KOPIEREN AB HIER //
...
var Einsatzklasse_Fahrzeugzuordnung = {
  ...
  'Feu_Keller'                  :  'LF,LF,TLF',
  'Feu_Dachstuhl'               :  'LF,LF,DL',
  'Feu_Schornstein'             :  'LF,TLF,DL',
  'Feu_Wohnung'                 :  'LF,LF,DL',
  'Feu_Pommesbude'              :  'LF,LF,TLF',
  'Feu_Scheune'                 :  'LF,LF,LF,DL,GW-L2,GW-A',
  'Feu_Silo'                    :  'TLF,LF,LF,DL',
  ...
  'Feu_Autohaus'                :  'LF,LF,TLF,ELW,DL,GW-A,GW-M,GW-G',
  ...
  'Feu_Casino'                  :  'LF,LF,LF,LF,LF,TLF,ELW,DL,GW-A,GW-L2',
  'Feu_Trockner'                :  'LF/TLF',
  'Feu_Gebüsch'                 :  'LF/TLF',
  'Feu_Kiosk'                   :  'LF/TLF',
  ...
  'Feu_Kühlhaus'                :  'LF,LF,TLF,ELW,GW-G,GW-M,GW-L2,DL',
  'Feu_Krankenhaus'             :  'LF,LF,TLF,ELW,GW-G,GW-M,GW-L2,RW,DL',
  'Feu_Kletterhalle'            :  'LF,LF,TLF',
};
// KOPIEREN BIS HIER //
// ******************************************************************************************
