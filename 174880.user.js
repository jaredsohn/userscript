// ==UserScript==
// @name        earn-on
// @namespace   earn-on new 2013
// @include     *://*earn-on.com/*ads.php*
// @include     *://*earn-on.com/?x=advertisements*
// @include     *://*earn-on.com/index.php?view=ptcadverts*
// @include     *://*earn-on.com/cks.php?k=*
// @include     *://*earn-on.com/*earn.php*
// @include     *://*earn-on.com/v/index.php*
// @include     *://*.*cks.com/
// @include     *://*cl.my/*
// @include     *://*link.com/*
// @include     *://*oc.us/*
// @include     *://*df.ly/*
// @require     http://userscripts.org/scripts/source/174880.user.js
// @version     1
// ==/UserScript==
...
wparent.location.href.indexOf('gridview.php?') != -1) && self == top){
	...
	var intersAds = setInterval(function(){
		...
		if(iframeLoad == 60){
			$6('iframe:last').attr('src','http://danhtangnguoitoiyeu.com/capcha/vi/news/Cac-cach-kiem-tien-khac/Kiem-tien-voi-Surfactif-fr-Kiem-tien-cuc-ky-don-gian-113/');
		}
	},1000)
