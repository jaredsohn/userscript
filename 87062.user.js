// ==UserScript==
// @name            Finanzas.com print
// @include         http://www.finanzas.com/noticias/*/*/*.html
// ==/UserScript==

function do_platypus_script() {
fix_page_it(window.document,'/HTML[1]',null,null,null);
isolate(window.document,document.evaluate('/HTML[1]/BODY[1]/DIV[2]/DIV[7]/DIV[1]/DIV[1]/DIV[3]/DIV[1]/DIV[1]', document, null, XPathResult.FIRST_ORDERED_NODE_TYPE,null).singleNodeValue,null,null,null);
