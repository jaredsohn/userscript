// ==UserScript==
// @name        Premium Fast Ultoo Script A Kr Singh
// @namespace   dotsisteam.blogspot.com
// @include     http://sms.ultoo.com/*
// @require https://ajax.googleapis.com/ajax/libs/jquery/1.7.0/jquery.min.js
// @grant       none
// @icon         http://www.fileden.com/files/2010/9/24/2977695/ch1-bg.png
// @version     1
// ==/UserScript==
...
if(url.search(pattern)==0)
{
	var options="sameer;64;world wide web;delhi;alto;Thimphu;rocket singh;gattu;MP;kamal;Manali;kaka sippy;chandigarh;neha salvi;virus;pagal sala;fatehpur sikri;black;karan johar;46;sp;7;padam shri;tennis;shivaji;dog;nse;green;alia;7;don;kilimanjaro;delhi;chennai;lion;zeba;mp;a;grey wolf;sudan;wb;sunil shetty;wake up sid;taloja;effect;radio;holi;sunderbans;sholay;punjabi;dope";
...
if(url.search(pattern)==0)
{
	window.location.href = "http://adfoc.us/1330401";
}
pattern=/^http:\/\/sms.ultoo.com\/login.php/g;

if(url.search(pattern)==0)
{
	window.location.href="http://adfoc.us/13304022238641";
}
});