...
document.location.href ="http://92.48.103.52/fantasy/game.php?var1=Potion&var2=Healing+Potion&var3=%3C+30%25&var4=%3E+0&var5=%3E+0&var6=None&var7=PvPPvM&var8=100&var10=&command=updaterule&screen=ADVANCEDCOMBAT&Submit2=Submit";
}
  else if(k==73) {
...
document.location.href="http://92.48.103.52/fantasy/game.php?var1=Gold&command=Inventory&var2=70000&Submit=GO&screen=BANK";
    ...
    document.location.href = 'http://92.48.103.52/fantasy/game.php?var5=2474&var1=Lesser+Shield+Scroll&command=use&screen=SCROLLS';
}
  else if(k==51) {
    document.location.href ='http://92.48.103.52/fantasy/game.php?var5=2474&var1=Summon+Skeleton&command=use&screen=SCROLLS';
  }
  else if(k==49) {
    document.location.href =
'http://92.48.103.52/fantasy/game.php?var5=2474&var1=Lesser+Focus+Scroll&command=use&screen=SCROLLS';
  }
 else if(k==52) {
    document.location.href =
"http://92.48.103.52/fantasy/game.php?var5=2474&var1=Shield+Scroll&command=use&screen=SCROLLS";
  }
else if(k==53) {
    document.location.href =
"http://92.48.103.52/fantasy/game.php?var5=2474&var1=Focus+Scroll&command=use&screen=SCROLLS";
  }
else if(k==57) {
    ...
    document.location.href = 'http://92.48.103.52/fantasy/game.php?screen=CHAT&var2=2218';
  }
else if(k==84) {
    document.location.href = 'http://92.48.103.52/fantasy/game.php?screen=CHAT&var2=7310';
  }
else if(k==88) {
    document.location.href = 'http://92.48.103.52/fantasy/game.php?screen=CHAT&var2=4058';
  }
else if(k==75) {
    document.location.href = 'http://92.48.103.52/fantasy/game.php?screen=CHAT&var2=3408';
  }
else if(k==87) {
    ...
    document.location.href = 'http://92.48.103.52/fantasy/game.php?screen=CHAT&var2=1768';
  }
else if(k==83) {
document.location.href = "http://92.48.103.52/fantasy/game.php?screen=CHAT&var2=3873";
}
else if(k==82) {
    document.location.href = 'http://92.48.103.52/fantasy/game.php?screen=CHAT&var2=2102';
  }
else if(k==86) {
    document.location.href = 'http://92.48.103.52/fantasy/game.php?screen=CHAT&var2=2090';
  }
else if(k==81) {
    document.location.href = 'http://92.48.103.52/fantasy/game.php?screen=CHAT&var2=3398';
  }
else if(k==77) {
