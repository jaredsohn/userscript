...
"data:image/png;base64,";
	...
	$("#wildwest-menu").append(setButton('Нефтопровод','/neft/')+"&nbsp;");
	$("#wildwest-menu").append(setButton('Банка','/bank/')+"&nbsp;");
	$("#wildwest-menu").append(setButton('Пирамида','/pyramid/')+"&nbsp;"+"<br>"+"&nbsp;");
	$("#wildwest-menu").append(setButton('Ловна среща','/huntclub/')+"&nbsp;");
	...
	$("#wildwest-menu").append(setButton('Автомобили','/automobile/ride/')+"&nbsp;");
	$("#wildwest-menu").append(setButton('Клуб','/nightclub/jobs/')+"&nbsp;");
	$("#wildwest-menu").append(setButton('Военна статистика','/clan/profile/warstats/')+"&nbsp;");
