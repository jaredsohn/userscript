// ==UserScript==
// @name           Ikariam Reloaded 2
// @namespace      Ikariam Reloaded 2
...
// @license        Creative Commons Reconocimiento-No comercial-Sin obras derivadas 3.0 EspaÃ±a License
// @author         Buzzy
// @version        2.40
// @date           27/09/09
 ...
 * @param str texto con el nombre de la ciudad y las coordenadas. ParÃ¡metro opcional.
 ...
 * TambiÃ©n la actualiza si se ha creado una nueva ciudad.
 * @return true si la ciudad actual es mÃ­a, sinÃ³, false.
 */
function compruebaVariableCiudades (){
	...
	//Calculo el nÃºmero de ciudades sin contar las que no son mÃ­as
	var num = 0;
	var mia = false;
...
/**
 * Transforma un nÃºmero en una cadena con separaciÃ³n de grupos de 3 cifras con comas.
 * @param num nÃºmero sin comas.
...
function actualizaNombreCiudad (){
	/**
	 * Actualiza el nombre del objeto que guarda informaciÃ³n de la ciudad y la variable ordenCiudades.
	...
	function actualizaNombre (div){
		...
		//Comprobamos si el nuevo nombre no estÃ¡ repetido.
	...
	//AÃ±ado un listener en el botÃ³n para renombrar una ciudad para actualizar la variable
...
/**
 * Modifica algunos elementos grÃ¡ficos y aÃ±ade mejoras varias (las que no se pueden activar/desactivar).
 */
function cambiaUI (){
	/**
	...
	/**
	 * Muestra la cantidad de vino necesÃ¡ria hasta que la poblaciÃ³n estÃ© al mÃ¡ximo de capacidad.
	 */
...
/**
 * Crea un botÃ³n para cambiar entre iconos normales y Premium.
 */
...
/**
 * Permite ordenar las ciudades y aÃ±ade un icono del bien de lujo de la ciudad.
 */
function ordenImagenCiudades (){
	 ...
	 * @param b true si se intercambia con el de arriba, sinÃ³, false.
	...
	/**
	 * AÃ±ade una fila con la imagen del bien de lujo y las flechas.
	 * @param num nÃºmero de fila.
	 * @param nombre nombre de la ciudad de la fila.
	 * @param b true si es una fila de mi ciudad, sinÃ³, false.
	 */
...
/**
 * Crea un panel para saber la puntuaciÃ³n del jugador.
 */
...
function creaPanelTransporte (){
	 ...
	 * @return contenido para aÃ±adir al panel.
	 */
	...
	/**
	 * Calcula la direcciÃ³n donde redirigir la pÃ¡gina para enviar unidades.
	...
	//AÃ±ado listeners a todos los iconos
 ...
 * TambiÃ©n crea botones de reset.
 */
function creaBotonesRecursos (){
	/**
	 * Suma puntos en los recursos para ser transportados.
	 * @param num nÃºmero de recursos a sumar.
	 * @param boton botÃ³n que se ha apretado.
	 * @param i nÃºmero de hijo del nodo padre.
	 */
	...
	/**
	 * Pone el mÃ¡ximo de los recursos.
	 * @param boton botÃ³n que se ha apretado.
	 * @param i nÃºmero de hijo del nodo padre.
	 */
	...
	/**
	 * Crea y aÃ±ade los botones de +500 y Reset.
	 * @param barras elemento donde se aÃ±aden los botones.
	 * @param i nÃºmero de hijo de barras donde aÃ±adir los botones.
	 */
...
/**
 * Informa si hay ganancia o pÃ©rdida de oro cuando los trabajadores se aumentan o disminuyen en el aserradero, mina o academia.
 * TambiÃ©n aÃ±ade el oro total ganado entre todas las ciudades.
 */
function informaOroMinas (){
	/**
	 * Al aumentar o disminuir los trabajadores/investigadores comprueba si hay ganancia o pÃ©rdida de oro.
	 * TambiÃ©n aÃ±ade el oro total de las ciudades.
...
/**
 * AÃ±ade informaciÃ³n Ãºtil en las minas.
 */
function creaInfoMinas (){
	/**
	 * Consulta el nÃºmero de trabajadores mÃ¡ximo de un nivel.
	 * @param lvl nivel del aserradero/mina.
	 * @param b1 true si es aserradero, sinÃ³, false.
	 * @param b2 true si hay investigaciÃ³n, sinÃ³, false.
	 * @return nÃºmero mÃ¡ximo de trabajadores.
	 */
...
/**
 * AÃ±ade links directos al aserradero y mina en la barra de recursos
...
/**
 * Cambia el diseÃ±o del cuartel.
 */
function cuartelVistaAvanzada (){
	/**
	 * Cambia el tag h4 por un span y saca el tag p.
	 * @param i nÃºmero del nodo de la lista de unidades.
	 */
	...
	/**
	 * Mueve la capa con la descripciÃ³n de la unidad.
	 * @param e Event.
	 * @param div capa con la descripciÃ³n.
	 */
	...
	/**
	 * Esconde la capa con la descripciÃ³n de la unidad.
	 * @param div capa con la descripciÃ³n.
	 */
	...
	/**
	 * Crea el span de la descripciÃ³n.
	 * @param i nÃºmero del nodo de la lista de unidades.
	 * @return span creado.
	 */
	 ...
	 * @param e Event.
	 * @param eti etiqueta con la descripciÃ³n.
	 */
	...
	/**
	 * Crea la informaciÃ³n de la unidad.
	 * @param basico true si la vista es bÃ¡sica, false si es avanzada.
	 */
	function creaInfo (basico){
		...
		//Creo la flecha para cambiar entre modo bÃ¡sico y modo avanzado
		creaModos (unidad, basico);
	}
	
	/**
	 * Crea la flecha para cambiar entre modo bÃ¡sico y modo avanzado.
	...
	/**
	 * Cambia entre el modo bÃ¡sico y el avanzado.
	...
	/**
	 * SegÃºn el input actualiza los recursos necesarios para formar la unidad.
	 */
	...
	/**
	 * Coloca un botÃ³n para cambiar el vista de todas las unidades.
	 */
...
function ordenaMiembrosAlianza (){
	...
	/**
	 * Crea un botÃ³n para resetear la ordenaciÃ³n de las columnas.
	 */
	...
	if (pagina == "embassy" || pagina == "diplomacyAdvisorAlly"){
		...
		if (tabla){
			...
			//Creo la lista y aÃ±ado los elementos
			try{
				var lista = new Lista ();
				var j = 1;
				for (var i=1; i<=miembros.childNodes.length - 2; i+=2){
...
/**
 * Crea un panel donde se informa del riesgo que corren otros jugadores al enviar espÃ­as.
 */
function creaPanelEspias (){
	 ...
	 * @param valorNumero nÃºmero de espÃ­as.
	...
	/**
	 * Calcula los valores segÃºn los parÃ¡metros.
	 */
	function calcula (){
		var ok = true;
...
/**
 * AÃ±ade una calculadora de distancias.
 */
...
/**
 * Crea un menÃº de configuraciÃ³n de las funciones.
 */
function menuConfig (){
	function guardar (){
...
/**
 * Calcula el tiempo de ejecuciÃ³n del script.
 */
