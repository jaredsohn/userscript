...
// @description    Version 1.7.3 - Replaces forum names with clickable links, adds a tally of held forums, adds Klan shortforms. Cleaned up the previous version for troll class
...
window.addEventListener ("load", function (e) {
 ...
 /*
  ...
  else if (myClass == "Troll")
  {
    ...
    altText = "<b>you have <u>" + myCount + "</u> ";
    if (myCount == 1)
      altText += "forums";
    else
      altText +=  "forums";
