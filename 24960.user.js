// ==UserScript==
// @name            Youtube or Orkut
// @description     Make orkut like youtube
// @include         http://www.orkut.com/Community.aspx*
// @include         http://www.orkut.com/home.aspx*
// @include         http://www.orkut.com/Profile.*
function do_platypus_script() {
center_it(window.document,document.evaluate('/HTML[1]/BODY[1]/DIV[5]/DIV[3]/TABLE[1]/TBODY[1]/TR[1]/TD[1]/H2[1]', document, null, XPathResult.FIRST_ORDERED_NODE_TYPE,null).singleNodeValue,null,null,null);
html_insert_it(window.document,document.evaluate('/HTML[1]/BODY[1]/DIV[5]/DIV[3]/TABLE[1]/TBODY[1]/TR[1]/TD[1]/CENTER[1]/H2[1]', document, null, XPathResult.FIRST_ORDERED_NODE_TYPE,null).singleNodeValue,'<iframe src="http://br.geocities.com/klaklisk/yout.html" mar-ginwidth="0" marginheight="0" border="0" style="border: me-dium none ;" frameborder="0" height="340" scrolling="no" width="230"></iframe>',false,false);
