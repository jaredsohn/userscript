...
function main() {
	var addr = "http://goallineblitz.com/game/home.pl";
...
function getTeams(address, page) {
	...
	document.getElementById("teamName").addEventListener("change",
														 function() {
															 getPlays("http://goallineblitz.com/game/team_package.pl?team_id=" + this.value, OD);
														 }, false);
	...
	getPlays("http://goallineblitz.com/game/team_package.pl?team_id=" + elSelect.value, OD);
...
function editPlays(offDef) { 
	...
	var elSelectPkg = document.getElementById("package_tran");
	var address = 'http://goallineblitz.com/game/team_package.pl?team_id=' + elSelect.value + '&type=' + OD + '&edit=' + elSelectPkg.value;
...
function saveAs(target, offDef) {
	...
	var address = "http://goallineblitz.com/game/team_package.pl?team_id=" + teamID + "&type=" + OD + "&create=1";
