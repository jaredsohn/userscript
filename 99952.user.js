// ==UserScript==
// @name           Botón Comunidad GNU/Linux!
// @namespace      taringa
// @include        *taringa.net/*
// @exclude        *taringa.net/comunidades/ubuntuparataringeros*
// @creator        emosordodehabbo [user]
// ==/UserScript==

//////////////////////////////////////////////////////////
//////////////////////////////////////////////////////////
//                                                      //
// NO EDITES ESTO ESTO ES PROPIEDAD DE EMOSORDODEHABBO  //
...
byClass('menuTabs').innerHTML += "<li id=\"tabbedWTF\" class=\"tabbed registrate\">\n <a href=\"http://www.taringa.net/comunidades/ubuntuparataringeros\" onclick=\"menu(\'GNU/Linux! \', registro_load_form(); return false;\" title=\"Ir a la Comunidad GNU/Linux!!\">GNU/Linux! <img src=\n\"http://k01.kn3.net/29C4AF0A7.png\" alt=\"EmoSordodeHabbo\" /></a>\n</li>";
