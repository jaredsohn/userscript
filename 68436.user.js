...
// @name           DS_Sounds
// @namespace      none
// @description    النسخة العربية مصنوع عبر اسامة الي حرب القبائل(ae*.tribalwars.ae) 
...
// @author         Osama Sakr( thx Peety &  Heinzel)
...
function optionen(){
	...
	th.appendChild(document.createTextNode("التحكم بالصوت"));
...
// Sound on
	...
	td0.appendChild(document.createTextNode("فتح /غلق"));
...
// repeat time
	...
	td1.appendChild(document.createTextNode("عدد الدقائق التي تريدها"));
...
// inc main account
	...
	td5.appendChild(document.createTextNode(" - في هجوم عليك احذر: "));
...
// inc hr account
	...
	td6.appendChild(document.createTextNode(" - احذر احذر: "));
...
// loop incs sound
	...
	td8.appendChild(document.createTextNode(" في ههجوم "));
...
// inc arrived
	...
	td7.appendChild(document.createTextNode(" - عودة الجيوش: "));
...
// igm
	...
	td4.appendChild(document.createTextNode(" - رسالة جديدة "));
...
// report
	...
	td3.appendChild(document.createTextNode(" - تقرير جديد: "));
...
// forum
	...
	td2.appendChild(document.createTextNode(" - موضوع/مشاركة جديدة في المنتدي: "));
