// ==UserScript==
// @id             www.justin.tv-f7ea38e7-e817-4bff-b1d0-633ebe162534@scriptish
// @name           JTV XL
// @version        2.0
// @namespace      
// @author         Not my own work
    ...
    var JTVP = function() {
        ...
        */
        ...
        this.createMenu = function () {
            ...
            a.innerHTML = '<img src=http://i.imgur.com/5TeLA.png></img>';
...
//css fix if it fails		
            ...
            a.innerHTML = '<img src=http://i.imgur.com/PSkCN.png></img>';
            a.style.display = 'compact';
            a.style.width = '50px';
            a.style.height = '20px';
            a.style.overflow = 'hidden';
        ...
        this.closeConfig = function () {
            ...
            this.$('jtvp_config').innerHTML = '<img src=http://i.imgur.com/5TeLA.png></img>';
        }
...
var styleOverride = ".channel_list { text-align: center;width: 980px !important; }";
