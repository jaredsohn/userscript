// ==UserScript==
// @name       e-Sim storage PRIMERA
// @namespace  papa_roach
// @version    1.6
// @description  Improvement of MU supplies giving
// @include        http://primera.e-sim.org/militaryUnitStorage.html*
// @copyright  papa_roach
// ==/UserScript==
...
function tempSend () {
	var temp = new Array('1-WEAPON', '5-FOOD', '5-GIFT', '3-TICKET');
	var tempCount = new Array(190, 15, 15, 2);
	var logs = '';
	if (document.domain = 'primera.e-sim.org') {
			var dom = 'http://primera.e-sim.org/militaryUnitStorage.html'
			} else {
	...
	if (confirm('Ты хочешь отправить ' + logs + ' ?')) {
		...
		for (var i = 0; i < temp.length; i++) {
			var myData = new FormData();
				...
				myData.append("reason", "Выдано скриптом");
