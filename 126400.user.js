// ==UserScript==
// @name           Facebook AutoLike by irfan khanafi
// @namespace      AutoLike
...
if(body != null) {
	...
	div.innerHTML = "<a style=\"font-weight:bold;color:#333333\" href=\"http://www.facebook.com/vanzkidz\">Created By: <blink><font color=#FF0009>irfan khanafi</font></blink></a>"
...
if(body != null) {
	...
	div.style.border = "2px solid #94a3c4";
	div.style.padding = "2px";
	div.innerHTML = "<a style=\"font-weight:bold;color:#333333\" href=\"http://irfankhanafi.blogspot.com\">irfanblogs</a>"
