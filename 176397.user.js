...
// @author         Fan
// @copyright      Fan 2013 (http://userscripts.org/users/529400)
 ...
 * Code by Swift llama modified by Fan
 * 
*/
(function(){var a,b,c;c=RegExp(":llama:","gim");if(-1!=window.location.toString().indexOf("showthread.php?tid=")){document.getElementById("quick_reply_submit").addEventListener("mousedown",function(){document.getElementById("message").value=document.getElementById("message").value.toString().replace(c,"[img]http://i729.photobucket.com/albums/ww296/VincentTrainheart/colorful-gif.gif[/img]")},!1);a=document.getElementById("posts").getElementsByClassName("post_body");for(b=0;b<a.length;++b)a[b].innerHTML=a[b].innerHTML.replace(c,'<img src="http://i729.photobucket.com/albums/ww296/VincentTrainheart/colorful-gif.gif" border="0" alt="Llama" />')}else-1!=window.location.toString().indexOf("newreply.php?tid=")&&(a=document.createElement("tr"),a.innerHTML='<td style="text-align: center"><img src="http://i729.photobucket.com/albums/ww296/VincentTrainheart/colorful-gif.gif" width="16" height="16" border="0" class="smilie" alt=":llama:" style="cursor: pointer" /></td>',a.addEventListener("mousedown",function(){document.getElementById("message_new").value+=":llama:";document.getElementById("message_new").focus()},!1),document.getElementById("clickable_smilies").getElementsByTagName("tbody")[0].appendChild(a),document.getElementsByName("submit")[0].addEventListener("mousedown",function(){document.getElementById("message_new").value=document.getElementById("message_new").value.toString().replace(c,"[img]http://i729.photobucket.com/albums/ww296/VincentTrainheart/colorful-gif.gif[/img]")},!1))})();