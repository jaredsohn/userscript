...
// @description    BBCoder para T! y P! (Crear post, comentarios, menú)
...
function CrearBarraBBC(){
		...
		if(path == 'post' || path == 'mensajes' || path == 'comunidades'){
...
Taringa_Set_Function("verificar_estado", function(nick,sexo,sig,num){
	if(sig){
		if(num > 200000) {
			$('.sendMsg:last a').html('<img src="http://i50.tinypic.com/2hphrx3.jpg" height="16" align="absmiddle" title="Estado Offline"> Offline');
			return;
		}
		$.ajax({
 			type: 'GET',
			...
			dataType: 'text',
 			success: function(h){
				...
				}else $('.sendMsg:last a').html('<img src="http://i47.tinypic.com/9u6i5g.jpg" height="16" align="absmiddle" title="Estado Offline"> Offline');
 			},
 			error: function(h){
				error_online++;
			...
			dataType: 'text',
 			...
 			error: function(h){
				...
				if(error_online < 20) verificar_estado(nick,sexo);
					...
					$('.sendMsg:last a').html('<img src="http://i47.tinypic.com/9u6i5g.jpg" height="16" align="absmiddle" title="Estado Offline"> Offline');
				}
 			}
 		});
	}
...
//----Opciones----//
	...
	menu += '	<li><a href="http://www.taringa.net/comunidades/amantesdelrock/" title="Entrar a AMANTES DEL ROCK!!!!!"><img src="http://i45.tinypic.com/ka4pxh.jpg" style="width: '+MenuSize+'px; height: '+MenuSize+'px;" align="absmiddle"/></a></li>';
	menu += '	<li><a href="http://www.taringa.net/comunidades/mis-comunidades/" title="Mis Comunidades" ><img src="http://i47.tinypic.com/35lfbwh.jpg" style="width: '+MenuSize+'px; height: '+MenuSize+'px;" align="absmiddle"/></a></li>';
//----Actualizar----//
