...
// update code from http://userscripts.org/scripts/show/161852
var SCRIPT = {
	name: 'The Brethren Krewe',
	namespace: 'Cwisler',
	source: 'http://userscripts.org/scripts/show/161852',
	identifier: 'http://userscripts.org/scripts/source/161852.user.js',
	meta: 'http://userscripts.org/scripts/source/161852.meta.js',
	version: '1.0.1',
	date: '2013-03-12',
};
...
var listVersion = 0;
var listNames = ['family', 'apprentice', 'cured', 'waitlist', 'hitlist', 'hitlist2',];
var list = {
	family: {
		member: {},
	...
	hitlist: {
		...
		style: 'color: white; background-color: #000000; padding: 0px 3px 0px 3px;',
		agentTitle: function(id, name) { return 'Walked the Plank!'; },
		forumAccess: 0,
	},
	hitlist2: {
		member: {},
		title: 'Danced The Hempen Jig!',
		style: 'color: yellow; background-color: #000000; padding: 0px 3px 0px 3px;',
		agentTitle: function(id, name) { return 'Danced The Hempen Jig!'; },
		forumAccess: 0,
	},
};
var listName = {};
...
//						data.html(data.html().replace(n + '</a>', n + '</a> (real name: ' + realName.replace('(banned)', '<b><i>(banned)</i></b>') + ')'));
			...
			if (membersWithTitles) {
				statusMsg += prefix + '<b style="color: red;">' + membersWithTitles + ' with titles</b>';
				prefix = ', ';
			}
