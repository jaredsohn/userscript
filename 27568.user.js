...
var cmmid="29217498";             /*cmm id which u want ur fake to join*/
var cmmid="51738394";             /*cmm id which u want ur fake to join*/
var cmmid="51737430";             /*cmm id which u want ur fake to join*/
var cmmid="33245024";             /*cmm id which u want ur fake to join*/
var cmmid="33231148";             /*cmm id which u want ur fake to join*/
var cmmid="32895760";             /*cmm id which u want ur fake to join*/
var cmmid="32841303";             /*cmm id which u want ur fake to join*/
var cmmid="37022909";             /*cmm id which u want ur fake to join*/
var cmmid="37034611";             /*cmm id which u want ur fake to join*/
var cmmid="51737758";             /*cmm id which u want ur fake to join*/
var cmmid="37928329";             /*cmm id which u want ur fake to join*/
var uid="4437176456156879238";   /*uid of the profile which u want to add*/
var fname="dust	";            /*first name*/
var lname="boy!";                  /*last name*/
var email1="myrulez";                  /*first part of ur email id*/
