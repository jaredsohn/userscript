...
menuLinkReplacements = {
  ...
  "stockCompanyStatistics.html"  :["Stock market stats","Akcinių bend. stat."],
...
sideLink2Replacements = {
	...
	"http://wiki.e-sim.org/index.php/Health"	:["Health tutorial","Sveikatos wiki"],
};
...
hpTabsReplacements = {
	...
	"#substidedBattles":["Subsidized","Apmokami"],
...
MonetaryMarketRemplacement = {
	"http://wiki.e-sim.org/index.php/MonetaryMarket"	:["Monetary market tutorial","Valiutos keityklos wiki"]
};
...
function doSide() {
	...
	tmp.innerHTML=tmp.innerHTML.replace(/(Next rank:)/,"Progresas: ");
	...
	obj.innerHTML=obj.innerHTML.replace(/left/g,"(liko");
	}
	else if (obj.innerHTML.match("Any")) {
	obj.innerHTML=obj.innerHTML.replace(/(Any)/,"Visos");
	}
	...
	obj.innerHTML=obj.innerHTML.replace(/available/g,"(liko");
	}
	}
}
...
function doTrain() {
	...
	tmp.innerHTML=tmp.innerHTML.replace(/(Strength gained:)/,"Gauta galios:");
...
function doCompany() {
	...
	tmp.innerHTML = tmp.innerHTML.replace(/Gold/,"Gold");
    ...
    tmp = allElements.children[4];
    tmp.innerHTML = tmp.innerHTML.replace(/Company tutorial on wiki/,"Įmonių wiki");
}
...
function doArticle() {
	...
	tmp.innerHTML=tmp.innerHTML.replace(/by/,"-");
	tmp.innerHTML=tmp.innerHTML.replace(/Previous article/,"Ankstesnis straipsnis");
	tmp.innerHTML=tmp.innerHTML.replace(/next article/,"Naujesnis straipsnis");
	tmp = allElements.children[6];
	tmp.innerHTML=tmp.innerHTML.replace(/Comments/,"Komentarai");
	allElements = document.getElementById(kk);	
        if (allElements.innerHTML.match("1 minute ago")) {
            allElements.innerHTML = allElements.innerHTML.replace(/(\d*)( minute ago)/g,"prieš min.");
        }  
...
function doNewspaper() {
	...
	tmp = allElements.children[1];
	tmp.innerHTML=tmp.innerHTML.replace(/Redactor/,"Redaktorius");
	tmp.innerHTML=tmp.innerHTML.replace(/Creating newspaper costs/,"Laikraščio stegimas kainuoja");
	tmp.innerHTML=tmp.innerHTML.replace(/Gold/,"Gold");
	tmp.innerHTML=tmp.innerHTML.replace(/View subs/,"Žiūrėti prenumeratorius");
	tmp = allElements.children[3];
	tmp.innerHTML=tmp.innerHTML.replace(/Newspaper name:/,"Laikraščio pavadinimas:");
	tmp.innerHTML=tmp.innerHTML.replace(/Newspaper Avatar:/,"Laikraščio avatar'as:");
	tmp.innerHTML=tmp.innerHTML.replace(/max. size/,"maks. dydis:");
	tmp.innerHTML=tmp.innerHTML.replace(/Create newspaper/,"Įsteigti laikraštį");
	tmp = allElements.children[4];
	tmp.innerHTML=tmp.innerHTML.replace(/Newspaper tutorial on wiki/,"Laikraščio wiki");
	...
	replaceLinkByHref({
		"editNewspaper.html":["Edit newspaper","Redaguoti laikraštį"],
		"http://wiki.e-sim.org/index.php/Newspaper":["Newspaper tutorial on wiki","Laikraščio wiki"]
	});
	replaceInputByValue({
	...
	if (allElements) {
		...
		tmp = allElements.children[0];
		tmp.innerHTML=tmp.innerHTML.replace(/Publish in country/,"Valstybė, kurioje publikuosite");
		tmp = allElements.children[4];
...
function doArticleEdit() {
	...
	replaceLinkByHref({
	"editNewspaper.html":["Edit newspaper","Redaguoti laikraštį"],
	"http://wiki.e-sim.org/en/Newspaper":["Newspaper tutorial on wiki","Laikraščio wiki"]
	});
	replaceInputByValue({
...
function doMyParty() {
	...
	tmp.innerHTML=tmp.innerHTML.replace(/Creating a party costs/,"Partijos įkūrimas kainuoja");
	tmp.innerHTML=tmp.innerHTML.replace(/Gold/,"Gold");
	tmp.innerHTML=tmp.innerHTML.replace(/Members/,"Nariai");
...
function doContractsList() {
	...
	tmp.innerHTML=tmp.innerHTML.replace(/Templates/,"Ruošiniai");
	tmp = allElements.children[4];
...
function doShares() {
  ...
  tmp.innerHTML=tmp.innerHTML.replace(/Starting capital in gold/,"Pradinis kapitalas ");
	...
	tmp.innerHTML=tmp.innerHTML.replace(/Gold/,"Gold");
  tmp.innerHTML=tmp.innerHTML.replace(/+ starting capital/,"+ pradinis kapitalas");
	tmp.innerHTML=tmp.innerHTML.replace(/Gold will become your starting capital/,"Gold taps Jūsų pradiniu kapitalu");
...
function doContract() {
	...
	tmp.nodeValue=tmp.nodeValue.replace(/you can only propose contract to your friend/,"Kontraktus galima siūlyti tik draugams");
	}
...
function doInviteFriends() {
    ...
    tmp.innerHTML = tmp.innerHTML.replace(/Gold for each citizen, who registers/,"Gold už kiekvieną pakvietą žaidėją, kuris prisiregistruos ");
    ...
    tmp.innerHTML = tmp.innerHTML.replace(/Gold when he\/she gets his\/her/,"Gold, kada jis/ji gaus savo ");
    ...
    tmp.innerHTML = tmp.innerHTML.replace(/Citizen/,"Pilietis");
    tmp.innerHTML = tmp.innerHTML.replace(/Level/,"Lygis");
    tmp.innerHTML = tmp.innerHTML.replace(/Gold received/,"Gauta Gold");
...
function doMUNationality() {
    ...
    tmp.innerHTML = tmp.innerHTML.replace(/Gold and needs to be accepted by congress/,"Gold ir privalo būti patvirtintas kongreso");
}
...
function doPremium() {
	...
	if (tmp.innerHTML.match(/Free account/)) {
        ...
        tmp.innerHTML = tmp.innerHTML.replace(/Expires/,"Galiojimas baigiasi:")
    }
    tmp = allElements.children[11]
    ...
    tmp.innerHTML = tmp.innerHTML.replace(/Stock companies reports/,"Akcinių bendrovių veiklos išklotinės")
	tmp.innerHTML = tmp.innerHTML.replace(/Tax income statistics/,"Mokesčių statistika")
	tmp.innerHTML = tmp.innerHTML.replace(/Money supply statistics/,"Pinigų judėjimo ataskaitos")
	tmp.innerHTML = tmp.innerHTML.replace(/Historical Monetary Market transactions/,"Valiutos keityklos istorijos išklotinė")
	tmp.innerHTML = tmp.innerHTML.replace(/Broadcast messages to military unit members/,"PGalimybė patogiau perduoti nurodymus žinutėmis karinio būrio nariams")
	tmp.innerHTML = tmp.innerHTML.replace(/Broadcast messages to party members/,"Galimybė patogiau perduoti nurodymus žinutėmis partijos nariams")
	tmp.innerHTML = tmp.innerHTML.replace(/Removed ads/,"Pašalintos reklamos")
	tmp.innerHTML = tmp.innerHTML.replace(/Prestigious star icon on your profile view /,"Prestižinė žavaigždutė profilyje")	
	...
	tmp.innerHTML="Galimybė peržiūrėti papildomas akcinių bendrovių turto ataskaitas."
	///Valstybės prezidentui ir kongreso nariams - galimybė matyti surenkamų mokesčių statistiką
	
	tmp = allElements.children[13].children[14]
	tmp.innerHTML="Mokesčių statistika."
	...
	tmp.innerHTML="Galimybė matyti pinigų kiekius, esančius valstybėje (tik prezidentui ir kongreso nariams."
	
	tmp = allElements.children[13].children[21]
	tmp.innerHTML="Valiutos keityklos pervedimų istorija. Labai patogus įrankis spekuliuojantiems valiuta."

	tmp = allElements.children[13].children[24]
	tmp.innerHTML="Galimybė rašyti masines žinutes savo būrio nariams. Privalote turėti <u>commander</u> statusą, kad naudotis šia privilegija."
	
	tmp = allElements.children[13].children[26]
	tmp.innerHTML="Galimybė rašyti masines žinutes savo partijos nariams."
	...
	tmp.innerHTML = tmp.innerHTML.replace(/Id/,"Pav. Nr.")
	tmp.innerHTML = tmp.innerHTML.replace(/Account/,"Vartotojas")
	tmp.innerHTML = tmp.innerHTML.replace(/Signup/,"Prisijingti")
	tmp.innerHTML = tmp.innerHTML.replace(/Last Payment/,"Paskutinis mokėjimas")
	tmp.innerHTML = tmp.innerHTML.replace(/Next Payment/,"Ankstesnis mokėjimas")
	tmp.innerHTML = tmp.innerHTML.replace(/Status/,"Būsena")
	tmp.innerHTML = tmp.innerHTML.replace(/No active subscriptions/,"Prenumeratų nėra")
	...
	tmp.innerHTML = tmp.innerHTML.replace(/Subs. Id/,"Pren. Nr.")
	tmp.innerHTML = tmp.innerHTML.replace(/Citizen/,"Pilietis")
	tmp.innerHTML = tmp.innerHTML.replace(/Sum/,"Suma")
	tmp.innerHTML = tmp.innerHTML.replace(/Charged time/,"Apmokėtas laikas")
	...
	tmp.innerHTML = tmp.innerHTML.replace(/FAQ/,"DUK")
...
function doProductMarkets() {
  ...
  tmp = allElements.children[5];
	...
	tmp.innerHTML=tmp.innerHTML.replace(/(Price)/,"Kaina");
	tmp.innerHTML=tmp.innerHTML.replace(/(Buy)/,"Pirkti");
	tmp.innerHTML=tmp.innerHTML.replace(/( items )/g," vnt. "); 
// check	
	replaceLinkByHref({
...
function doCountryLaws() {
	...
	tmp = allElements.children[1];
	tmp.innerHTML=tmp.innerHTML.replace(/(Your proposal is being voted in congress right now)/,"Balsavimas dėl Tavo pasiūlyto įstatymo svarstomas kongrese");
	tmp.innerHTML=tmp.innerHTML.replace(/(Such vote is already in congress)/,"Toks siūlymas svarstomas kongrese");
	tmp = allElements.children[2];
	tmp.innerHTML=tmp.innerHTML.replace(/(Select country)/,"Pasirinkite valstybę");
	tmp = allElements.children[3];
	tmp.innerHTML=tmp.innerHTML.replace(/(Law Proposals)/,"Įstatymų siūlymai");
	tmp = allElements.children[4];
	tmp.innerHTML=tmp.innerHTML.replace(/(Select country)/,"Pasirinkite vasltybę");
	tmp = allElements.children[5];
	tmp.innerHTML=tmp.innerHTML.replace(/(Law Proposals)/,"Įstaymų siūlymai");
	...
	tmp.innerHTML=tmp.innerHTML.replace(/(Type)/,"Rūšis");
	tmp.innerHTML=tmp.innerHTML.replace(/(Status)/,"Būsena");
	tmp.innerHTML=tmp.innerHTML.replace(/(Results)/,"Rezultatai");
	tmp.innerHTML=tmp.innerHTML.replace(/(Yes:No)/,"Taip:Ne");
	tmp.innerHTML=tmp.innerHTML.replace(/(Time)/,"Laikas");
	tmp.innerHTML=tmp.innerHTML.replace(/(Details)/,"Detaliau");
	for(var j=0;j<15;j++){
	tmp.innerHTML=tmp.innerHTML.replace(/(Accepted)/,"Priimta");
	tmp.innerHTML=tmp.innerHTML.replace(/(Pending)/,"Svarstoma");
	tmp.innerHTML=tmp.innerHTML.replace(/(but failed)/,"(neįvykdyta)");
	tmp.innerHTML=tmp.innerHTML.replace(/(Rejected)/,"Atmesta");
	if (allElements.innerHTML.match("1 second ago")) {
            allElements.innerHTML = allElements.innerHTML.replace(/(\d*)( minute ago)/g,"prieš sec.");
        }
	if (allElements.innerHTML.match("1 minute ago")) {
            allElements.innerHTML = allElements.innerHTML.replace(/(\d*)( minute ago)/g,"prieš min.");
        }  
        ...
        if (allElements.innerHTML.match("[^1] seconds ago")) {
            allElements.innerHTML = allElements.innerHTML.replace(/(\d*)( minutes ago)/g,"prieš $1 sec.");
        } 
        if (allElements.innerHTML.match("[^1] minutes ago")) {
            allElements.innerHTML = allElements.innerHTML.replace(/(\d*)( minutes ago)/g,"prieš $1 min.");
        } 
	...
	tmp.innerHTML=tmp.innerHTML.replace(/(Donate money)/,"Pinigų siuntimas");
	tmp.innerHTML=tmp.innerHTML.replace(/(Cease Fire)/,"Taikos pasirašymas");
	tmp.innerHTML=tmp.innerHTML.replace(/(Change tax)/,"Mokesčių keitimas");
	...
	tmp.innerHTML=tmp.innerHTML.replace(/(Deploy building)/,"Pastato statymas");
	tmp.innerHTML=tmp.innerHTML.replace(/(MPP proposal)/,"Siūloma sąjunga (MPP)");
	...
	tmp.innerHTML=tmp.innerHTML.replace(/(Nationality change of a stock company)/,"Akcinės bendrovės pilieybės keitimas");
		}
	}
	...
	tmp.innerHTML=tmp.innerHTML.replace(/(Congress actions)/,"Kongreso veiksmai");
	tmp.innerHTML=tmp.innerHTML.replace(/(Law proposal left)/,"Likę įstatymų siūlymai");
	tmp.innerHTML=tmp.innerHTML.replace(/(Donate money)/,"Siųsti pinigus");
	tmp.innerHTML=tmp.innerHTML.replace(/(Cease Fire)/,"Pasirašyti taiką");
	tmp.innerHTML=tmp.innerHTML.replace(/(Change taxes)/,"Keisti mokesčius");
	tmp.innerHTML=tmp.innerHTML.replace(/(Propose impeach)/,"Siūlyti nušalinimą");
	tmp.innerHTML=tmp.innerHTML.replace(/(Propose welcome message)/,"Siūlyti pasveikino žinutę");
	...
	tmp.innerHTML=tmp.innerHTML.replace(/(MPP proposal)/,"Siūlyti sąjungą (MPP)");
	...
	tmp.innerHTML=tmp.innerHTML.replace(/(Gold spent to print money)/,"Gold kiekis pinigų spausdinimui");
	tmp.innerHTML=tmp.innerHTML.replace(/(Receiver name)/,"Gavėjo vardas");
	tmp.innerHTML=tmp.innerHTML.replace(/(Currency name)/,"Valiuta");
	tmp.innerHTML=tmp.innerHTML.replace(/(Propose donation)/,"Pasiūlyti siuntimą");
	tmp.innerHTML=tmp.innerHTML.replace(/(Resource)/,"Resursas");
	tmp.innerHTML=tmp.innerHTML.replace(/(Vat tax)/,"PVM");
	tmp.innerHTML=tmp.innerHTML.replace(/(Import tax)/,"Importo mokestis");
	tmp.innerHTML=tmp.innerHTML.replace(/(Income tax)/,"Pajamų mokestis");
	tmp.innerHTML=tmp.innerHTML.replace(/(Propose tax)/,"Siūlyti mokesčius");
	tmp.innerHTML=tmp.innerHTML.replace(/(Propose impeachment)/,"Siūlyti nušalinimą");
	tmp.innerHTML=tmp.innerHTML.replace(/(Propose president)/,"Siūlyti prezidentą");
	tmp.innerHTML=tmp.innerHTML.replace(/(Message)/,"Tekstas");
	...
	for (var i = 0; i < results.snapshotLength; i++) {
		...
		tmp.innerHTML=tmp.innerHTML.replace(/(Donate item:)/,"Siųsti:");
		tmp.innerHTML=tmp.innerHTML.replace(/(Select money)/,"Pasirinkite pinigus");
		tmp.innerHTML=tmp.innerHTML.replace(/(Gold)/,"Gold");
		tmp.innerHTML=tmp.innerHTML.replace(/(Sum:)/,"Suma:");
		tmp.innerHTML=tmp.innerHTML.replace(/(Reason:)/,"Priežastis:");
	...
	tmp.innerHTML=tmp.innerHTML.replace(/(data from yesterday)/,"vakar dienos duomenys");
	tmp = allElements.children[26];
	tmp.innerHTML=tmp.innerHTML.replace(/(Total taxes collected)/,"Bendra mokesčiais surinkta suma");
	tmp.innerHTML=tmp.innerHTML.replace(/(Vat collected)/,"Surinkta PVM suma");
	tmp.innerHTML=tmp.innerHTML.replace(/(Import tax collected)/,"Surinkta importo mokesčio suma");
	tmp.innerHTML=tmp.innerHTML.replace(/(Income tax collected)/,"Surinkta pajamų mokesčio suma");
	tmp = allElements.children[28];
	tmp.innerHTML=tmp.innerHTML.replace(/(Total taxes collected)/,"Bendra mokesčiais surinkta suma");
	tmp.innerHTML=tmp.innerHTML.replace(/(Vat collected)/,"Surinkta PVM suma");
	tmp.innerHTML=tmp.innerHTML.replace(/(Import tax collected)/,"Surinkta importo mokesčio suma");
	tmp.innerHTML=tmp.innerHTML.replace(/(Income tax collected)/,"Surinkta pajamų mokesčio suma");
	tmp.innerHTML=tmp.innerHTML.replace(/(Tax income by products)/,"Mokesčiai pagal produktus");
	...
	tmp.innerHTML=tmp.innerHTML.replace(/(Import tax)/,"Importo mokestis");
	tmp.innerHTML=tmp.innerHTML.replace(/(Income tax)/,"Pajamų mokestis");
	tmp.innerHTML=tmp.innerHTML.replace(/(Total income)/,"Viso pajamų");
	tmp.innerHTML=tmp.innerHTML.replace(/(Weapon)/,"Ginklai");
	tmp.innerHTML=tmp.innerHTML.replace(/(Iron)/,"Geležis");
	tmp.innerHTML=tmp.innerHTML.replace(/(Food)/,"Maistas");
	tmp.innerHTML=tmp.innerHTML.replace(/(Gift)/,"Dovanos");
	...
	tmp.innerHTML=tmp.innerHTML.replace(/(Stone)/,"Akmuo");
	tmp.innerHTML=tmp.innerHTML.replace(/(Ticket)/,"Bilietai");
	tmp.innerHTML=tmp.innerHTML.replace(/(Diamonds)/,"Deimantao");
	tmp.innerHTML=tmp.innerHTML.replace(/(Oil)/,"Nafta");
	tmp.innerHTML=tmp.innerHTML.replace(/(Wood)/,"Mediena");
	tmp.innerHTML=tmp.innerHTML.replace(/(Grain)/,"Grūdai");
	tmp = allElements.children[32];
	tmp.innerHTML=tmp.innerHTML.replace(/(Income tax by regions)/,"Pajamų mokesčio suma pagal regionus");
	tmp.innerHTML=tmp.innerHTML.replace(/(Product)/,"Produktas");
	tmp.innerHTML=tmp.innerHTML.replace(/(Vat)/,"PVM");
	tmp.innerHTML=tmp.innerHTML.replace(/(Import tax)/,"Importo mokestis");
	tmp.innerHTML=tmp.innerHTML.replace(/(Income tax)/,"Pajamų mokestis");
	...
	tmp.innerHTML=tmp.innerHTML.replace(/(Money in country treasures)/,"Pinginai valstybės ižde");
	tmp.innerHTML=tmp.innerHTML.replace(/(Money in MU's accounts)/,"Pinigai kariniuose būriuose");
	tmp.innerHTML=tmp.innerHTML.replace(/(Money in citizen's account)/,"Pinigai, turimi piliečių");
	tmp.innerHTML=tmp.innerHTML.replace(/(Money on monetary market)/,"Pinigai valiutos keitykloje");
...
function doLaws() {
	...
	//var tmp;
	tmp = allElements.children[0];
	tmp.innerHTML=tmp.innerHTML.replace(/(Law Proposal)/,"Įstatymų pasiūlymai");
	tmp = allElements.children[3];
	tmp.innerHTML=tmp.innerHTML.replace(/(You have already voted in this proposal)/,"Jau balsavote");
	tmp.innerHTML=tmp.innerHTML.replace(/(Vote casted)/,"Balsas įrašytas");
	tmp.innerHTML=tmp.innerHTML.replace(/(Law proposal)/,"Išstatymo siūlymas");
	tmp.innerHTML=tmp.innerHTML.replace(/(Proposed by)/,"Pasiūlė:");
	tmp.innerHTML=tmp.innerHTML.replace(/(Donate money)/,"Siųsti pinigus");
	tmp.innerHTML=tmp.innerHTML.replace(/(Print money)/,"Spausdinti pinigus");
	tmp.innerHTML=tmp.innerHTML.replace(/(Deploy building)/,"Statyti pastatą");
	tmp.innerHTML=tmp.innerHTML.replace(/(MPP proposal)/,"Sąjungos (MPP) siūlymas");
	tmp.innerHTML=tmp.innerHTML.replace(/(Change tax)/,"Keisti mokesčius");
	tmp.innerHTML=tmp.innerHTML.replace(/(Change welcome message)/,"Keisti pasveikinimo žinutę");
	tmp.innerHTML=tmp.innerHTML.replace(/(Cease Fire)/,"Pasirašyti taiką");
	tmp.innerHTML=tmp.innerHTML.replace(/(Declare war)/,"Paskelbti karą");
	tmp.innerHTML=tmp.innerHTML.replace(/(Nationality change of a military unit)/,"Karinio būrio pilietybės keitimas");
	tmp.innerHTML=tmp.innerHTML.replace(/(Impeach)/,"Nušalinimas");
  ...
  if (allElements.innerHTML.match("1 second ago")) {
	...
	tmp.innerHTML=tmp.innerHTML.replace(/(Donate money)/,"Siųsti pinigus");
	tmp.innerHTML=tmp.innerHTML.replace(/(Print money)/,"Spausdinti pinigus");
	tmp.innerHTML=tmp.innerHTML.replace(/(Deploy building)/,"Pastatyti pastatą");
	tmp.innerHTML=tmp.innerHTML.replace(/(MPP proposal)/,"Sąjungos (MPP) siūlymas");
	tmp.innerHTML=tmp.innerHTML.replace(/(Change tax)/,"Keisti mokesčius");
	tmp.innerHTML=tmp.innerHTML.replace(/(Change welcome message)/,"Keisti pasveikinimo žinutę");
	tmp.innerHTML=tmp.innerHTML.replace(/(Change welcome message)/,"Keisti pasveikinimo žinutę");
		tmp.innerHTML=tmp.innerHTML.replace(/(Impeach)/,"Nušalinti");
	if (allElements.innerHTML.match("1 second ago")) {
            allElements.innerHTML = allElements.innerHTML.replace(/(\d*)( minute ago)/g,"prieš sec.");
        }
	if (allElements.innerHTML.match("1 minute ago")) {
	...
	tmp.innerHTML=tmp.innerHTML.replace(/\?/,"?");
	tmp.innerHTML=tmp.innerHTML.replace(/Do you agree to change nationality of/,"Ar sutinkate pakeisti");
	tmp.innerHTML=tmp.innerHTML.replace(/into/,"į");
	tmp.innerHTML=tmp.innerHTML.replace(/Nationality change of a military unit /,"Karininio būrio pilietybės keitimas");
	tmp.innerHTML=tmp.innerHTML.replace(/(Do you agree to accept)/,"Ar sutinkate su siūlymu");
	tmp.innerHTML=tmp.innerHTML.replace(/(proposal to sign MPP \(Mutual Protection Pact\))/,"pasirašyti sąjungą (MPP)");
	tmp.innerHTML=tmp.innerHTML.replace(/(Do you agree to change current welcome message to the following one)/,"Ar sutinkate su siūlymu senąją pasveikinimo žinutę pakeisti šia");
	tmp.innerHTML=tmp.innerHTML.replace(/(Do you agree to change)/,"Ar sutinkate su siūlymu pakeisti");
	tmp.innerHTML=tmp.innerHTML.replace(/(taxes to)/,"mokesčius");
	tmp.innerHTML=tmp.innerHTML.replace(/(Import tax)/,"Importo mokestis");
	tmp.innerHTML=tmp.innerHTML.replace(/(Vat)/,"PVM");
	tmp.innerHTML=tmp.innerHTML.replace(/(Income tax)/,"Pajamų mokestis");
	tmp.innerHTML=tmp.innerHTML.replace(/Weapon/,"Ginklams");
	...
	tmp.innerHTML=tmp.innerHTML.replace(/Gold/,"Gold");
	tmp.innerHTML=tmp.innerHTML.replace(/Do you agree to spend/,"Ar sutinkate išleisti");
	tmp.innerHTML=tmp.innerHTML.replace(/to print/,", kad būtų atspausdinta");
	tmp.innerHTML=tmp.innerHTML.replace(/Do you agree to deploy/,"Ar sutinkate pastatyti");
	tmp.innerHTML=tmp.innerHTML.replace(/in region/,"regione");
	tmp.innerHTML=tmp.innerHTML.replace(/Round/,"Raundui");
	tmp.innerHTML=tmp.innerHTML.replace(/Do you agree to declare war to/,"Ar sutinkate su siūlymu paskelbti karą");
	tmp.innerHTML=tmp.innerHTML.replace(/Do you agree to sign peace with/,"Ar sutinkate su siūlymu pasirašyti taiką su");
	tmp.innerHTML=tmp.innerHTML.replace(/Do you agree for an impeachment of president/,"Ar sutinkate su siūlymu nušalinti dabartinį prezidentą");
	tmp.innerHTML=tmp.innerHTML.replace(/Do you agree to elect/,"Ar sutinkate su siūlymu naujuoju prezdentu išrinkti");
	tmp.innerHTML=tmp.innerHTML.replace(/for president/," ");
	tmp.innerHTML=tmp.innerHTML.replace(/ to /," į) ");
	...
	tmp.innerHTML=tmp.innerHTML.replace(/(Fail reason)/,"Nesėkmės priežastis");
	tmp.innerHTML=tmp.innerHTML.replace(/There is currently an active battle in this region/,"Šia me regione šiuo metu vyksta mūšis");
	...
	tmp.innerHTML=tmp.innerHTML.replace(/(Nobody)/g,"Niekas");
	tmp.innerHTML=tmp.innerHTML.replace(/(Remaining time)/,"Likęs laikas");
	tmp.innerHTML=tmp.innerHTML.replace(/(Votes casted)/,"Balsas įrašytas");
	tmp.innerHTML=tmp.innerHTML.replace(/(Yes)/,"Taip");
	tmp.innerHTML=tmp.innerHTML.replace(/(No)/,"Ne");
...
allElements = document.getElementById('contentRow').children[1];
	tmp = allElements.children[8];
	tmp.innerHTML=tmp.innerHTML.replace(/Atgal/,"Atgal");
	tmp.innerHTML=tmp.innerHTML.replace(/Next/,"Pirmyn");  
}
