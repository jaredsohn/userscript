// ==UserScript==
// @version        1.0.0
// @name           İnci Sözlük LinkThumb
// @namespace      İnci Sözlük LinkThumb
...
var thumbsize = 80;
	if(el.timg && parseInt(el.timg.width)>0) {
		...
		tt.innerHTML='<img src='+el.timg.src+' style=\'width:'+el.timg.width2*tscale+'%;height:'+el.timg.height*tscale+'%;\'>';
	}
