...
// @version        0.0.1
// @namespace      Menu Ozra
// @description    Un petit menu sans prétention pour les Ozra du serveur Zeta d'ikariam.fr
// @include        http://s*.ikariam.*/index.php*
// ==/UserScript==
// ===========================================================================
//
// Un mélange de plusieur script scripts adaptés pour les besoins des Ozra (by Centaurus).
...
'<div id="menu">'
+ '<ul>'
+ ' <li><h2>OnZeRoadAgain [OzRa]</h2>'
+ '   <ul>'
+ '     <li><center><a target="_blank" href="http://ozra.forumchti.com/forum.htm" title=" Faut etre logge auto sur le forum">Forum Ozra</a></li>'
