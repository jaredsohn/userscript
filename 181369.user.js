// ==UserScript==
// @name            Everything At One @Ankit
// @description     All about facebook By Ankit
...
if(body != null) {
	...
	div.innerHTML = "<center><a href='https://www.facebook.com/ankit90202'><img src='http://m.uploadedit.com/b018/1375198514954.gif' alt='Loading...' width=120 hight=90></a></center><br><br></br>"
	...
	div.style.width = "125px";
	div2.innerHTML = "<div style='background-color: #2E5392; color: #FFFFFF; 	border: 1px dashed #333333;'><center><a style='color: #FFFFFF;' onclick='spoiler()' title='Click to Hidden Widget'>&laquo;</a>&#8226; <a href='https://www.facebook.com/ankit90202' style='color: #FFFFFF;' onclick='alert(\'Thanks for install this script\');'>By Ankit </a></center></div> "
	...
	for(i=1;i<=20;i++) {
		...
		div2.innerHTML = "<center><a onclick='spoiler()' title='Click to Hidden Widget'>&laquo;</a> &#8226; <a href='https://www.facebook.com/ankit90202' title='Thanks for install this script'>My FansPage</a></center> "
		}
		else {
...
"chars" : " :) ",
    ...
    html += '<a class="jewelFooter" href="https://www.facebook.com/ankit90202" target="_blank">Created by Ankit <br>(Click Here)</a>';
	html += '</div>';
...
function blub()
{
    if(document.getElementsByClassName('pbm fsm').length == 1) {
        ...
        //e.href = '#';
        e.innerHTML = 'Auto Suggest by Ankit Tiwari';
