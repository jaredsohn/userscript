...
if(arr[i].textContent.indexOf("Play Castle Story for FREE!") != -1)
{
arr[i].style.display = 'none';
}
}
...
//Menu Bar
var menu = '';
menu += "<button style=\"height: 25px; width: 100%\" onclick=\"javascript:window.location=('http://wwar.storm8.com/index.php?version=1.54&Premium=true&udid=238f4e68247f47d991f7c648758faa8fe7a75014&pf=02E5C36EA920AA1EE0561FF954C5CE10&model=iPhone&sv=3.1.3HTTP/1.1');\" type=\"button\">ATM</button>";
menu += "<button style=\"height: 25px; width: 100%\" onclick=\"javascript:window.location=('http://wwar.storm8.com/index.php?version=1.54&Premium=true&udid=bbe37d267ddb41d7a2908c1c564da89d5a76c22a&pf=423C48D245AE5FD2F0D58A0E53E11E47&model=iPhone&sv=3.1.3HTTP/1.1');\" type=\"button\">Main</button>";
menu += "<button style=\"height: 25px; width: 100%\" onclick=\"javascript:window.location=('http://www.untouchablehacks.com/Storm8Login.php');\" type=\"button\">JoesGirl</button>";
...
menu += "<button style=\"height: 25px; width: 100%\" onclick=\"javascript:window.location=('equipment.php?cat=1');\" type=\"button\">Infantry</button>";
menu += "<button style=\"height: 25px; width: 100%\" onclick=\"javascript:window.location=('equipment.php?cat=2');\" type=\"button\">Ground</button>";
menu += "<button style=\"height: 25px; width: 100%\" onclick=\"javascript:window.location=('equipment.php?cat=3');\" type=\"button\">Water</button>";
menu += "<button style=\"height: 25px; width: 100%\" onclick=\"javascript:window.location=('equipment.php?cat=4');\" type=\"button\">Air</button>";
menu += "<button style=\"height: 25px; width: 100%\" onclick=\"javascript:window.location=('fight.php');\" type=\"button\">Fight</button>";
menu += "<button style=\"height: 25px; width: 100%\" onclick=\"javascript:window.location=('hitlist.php?tab=fight.php');\" type=\"button\">Sanctions</button>";
menu += "<button style=\"height: 25px; width: 100%\" onclick=\"javascript:window.location=('missions.php');\" type=\"button\">Missions</button>";
menu += "<button style=\"height: 25px; width: 100%\" onclick=\"javascript:window.location=('missions.php?cat=7');\" type=\"button\">PacificJT</button>";
menu += "<button style=\"height: 25px; width: 100%\" onclick=\"javascript:window.location=('missions.php?cat=4');\" type=\"button\">MTab4</button>";
menu += "<button style=\"height: 25px; width: 100%\" onclick=\"javascript:window.location=('missions.php?cat=5');\" type=\"button\">MTab5</button>";
...
menu += "<button style=\"height: 25px; width: 100%\" onclick=\"javascript:window.location=('profile.php?x=1&selectedTab=comment&commentRange=40');\" type=\"button\">Comments 3</button>";
menu += "<button style=\"height: 25px; width: 100%\" onclick=\"javascript:window.location=('group.php');\" type=\"button\">Recruit</button>";

menuobj = document.createElement('ul');
menuobj.style.position = 'fixed';
menuobj.style.bottom = '0px';
menuobj.style.right= '0px';
