// ==UserScript==
// @name           Youtube - Reproductor Alternativo con calidad MP4
// @namespace      userscripts.org
// @description    Remplaza el reproductor de Youtube por uno con calida MP4 y sin la molesta barra al poner en pantalla completa.
// @version        1.0
...
var srcWithT = 'http://'+document.domain+'/get_video?fmt=18&video_id='+vidID+'&t='+fv.split("&t=")[1].split("&")[0];
...
pD.innerHTML = '<embed width="960" height="520" type="application/x-shockwave-flash" '+
	...
	'playList: [ { url: \'http://img.youtube.com/vi/'+vidID+'/default.jpg\', overlayId: \'play\' }, { url: \''+encodeURIComponent(srcWithT)+'\' '+
