...
// @include        http://openstudy.com/groups/cs1332 

// @include        http://openstudy.com/groups/finance
// @include        http://openstudy.com/groups/history
 // @include        http://openstudy.com/groups/writing
// @include        http://openstudy.com/groups/social%20sciences
// @include        http://openstudy.com/groups/language%20and%20culture
// @include        http://openstudy.com/groups/language+and+culture

// @include        http://openstudy.com/groups/health+sciences

// @include        http://openstudy.com/groups/mit+6.0+intro+computer+science+(ocw) 
...
.ready(
		...
		function() {
			...
			var BOSH_SERVICE = 'http://50.57.110.107/http-bind';
			...
			function getPutRecos() {
				...
				$('.update-body').live("getReco", function(e)
					...
					GM_xmlhttpRequest( { 
						...
						url : "http://50.57.110.107:8080/coboted/xmlMessageReceiver",
