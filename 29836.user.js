...
// @author         DigasMC
// @version        1.1
// @description    Large Map button like PLUS
...
// 	}
	...
	function createMapAreas() {
		var map = dst.cn('map');
		map.name = 'map2';
		map.innerHTML = '<area dir="north" href="#" coords="762,115,30" shape="circle" title="الشمال">' +
				'<area dir="east"  href="#" coords="770,430,30" shape="circle" title="الشرق">' +
				'<area dir="south" href="#" coords="210,430,30" shape="circle" title="الجنوب">' +
				'<area dir="west"  href="#" coords="200,115,30" shape="circle" title="الغرب">';
