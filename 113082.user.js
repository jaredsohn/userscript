// ==UserScript==
// @name           xrel.to Search Engine Integration (with p2p)
// @namespace      http://example.net/xreltocollectr/
// @description    Integrates various german underground search engines into xrel.to
// @include        http://www.xrel.to/*
// @include        http://xrel.to/*
// @version		   1.5.3c
// ==/UserScript==
// 
// autor: thwax (thx) mod: blAde
// email: thwax33@gmail.com 
//
...
// 
// changelog:
//  - 1.5.3c- added google (dont like scroogle :))
//  - 1.5.3b- added p2p section
...
// woom.ws [inactive: sometimes not works as expected!]
newEngine = new Object();
newEngine["id"] = "woomws";
newEngine["title"] = "woom.ws";
newEngine["baseUrl"] = "http://woom.ws/search.php?v=%s";
newEngine["icon"] = "data:image/png;base64,";
...
// Scroogle [google anonymous]
newEngine = new Object();
newEngine["id"] = "scroogleorg";
newEngine["title"] = "scroogle.org";
newEngine["baseUrl"] = "http://www.scroogle.org/cgi-bin/nbbw.cgi?Gw=%s";
...
newEngine["active"] = false;
newEngine["modifyReleaseName"] = function(relName) { result = relName; /*.replace(/\./g, "%20");*/ result += "%20rapidshare"; return result; };
searchEngines.push(newEngine);

// filmatorium.info
newEngine = new Object();
newEngine["id"] = "filmatoriuminfo";
newEngine["title"] = "filmatorium.info";
newEngine["baseUrl"] = "http://www.filmatorium.info/search?criteria=%s";
//black: newEngine["icon"] = "data:image/png;base64,";
newEngine["icon"] = "data:image/png;base64,";
newEngine["active"] = true;
searchEngines.push(newEngine);
...
newEngine["baseUrl"] = "http://nzbindex.nl/search/?q=%s";
newEngine["icon"] = "data:image/png;base64,";
newEngine["active"] = true;
searchEngines.push(newEngine);
...
//iload.to 
newEngine = new Object();
newEngine["id"] = "iloadto";
newEngine["title"] = "iload.to";
newEngine["baseUrl"] = "http://iload.to/category/-1-Alles/search/%s"
newEngine["icon"] = "data:image/png;base64,";
newEngine["active"] = true;
