...
// @name    	eRepublik's Damage Report Script VEN
// @namespace   eRepublikDamageReport_VEN
// @version   	 2.2
// @uso:version 2.2
// @include   	 http://*erepublik.com/*/military/battlefield/*
// @description	eRepublik Damage Report Script for eVenezuela's Army
// ==/UserScript==
...
var UMs_full = ['Academia FAN', 'Fuerza Civil eVenezolana - FCV', 'P.M.C. El Condor Guardian'];
var UMs_abrev = ['aFAN', 'FCV', 'CONDOR'];

if(window.location.href.indexOf(PAGE_BATTLEFIELD) > 0) {    
    /***********************************************************************************/
    /***** Coonstants. If someone wants to reuse this script - change values here *****/
    /***********************************************************************************/
    var FORM_URL = "https://docs.google.com/spreadsheet/viewform?formkey=0AgxmmnzvNVTpdHNadW5kdzh3NHpacmw5UEZhaTUtSmc#gid=0";
    var FORM_FIELDS = {
   			 eday: "entry.0.single",
            	name: "entry.2.single",
   			 UM:  "entry.18.single",
    ...
    function BattlePage() {
    	...
    	var rankar={"Recruit":1, "Private":2, "Private *":3, "Private **":4, "Private ***":5,
                            	...
                            	"Legendary Force ***":61, "God of War":62, "God of War *":63, "God of War **":64, "God of War ***": 65, "Titan": 66, "Titan*": 67, "Titan**": 68, "Titan***": 69, };
    	var str,
