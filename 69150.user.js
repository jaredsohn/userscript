// ==UserScript==
// @name           wunsch von Pennerwutz Immer seine externe Shoutbox da mit mouseover
...
unsafeWindow.displaywiki = function() {
	if(displayedflag == 0) {
		document.getElementById("wikiframe").innerHTML = '<iframe width="600"   height="100%" src="http://www.freeshoutbox.net/PRDchat" style="margin-left:2px;"></iframe>';
		displayedflag = 1;
	}
}
