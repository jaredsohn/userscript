...
//
// ==UserScript==
// @name           FEAR The West Toolbar
// @namespace      www.the-west.com.br
// @description    FEAR The West Toolbar
...
window.createQuickbarShortcuts = function() {
	"<tr>   " + 
	newShortcut("http://downzwarez.googlepages.com/cidade.png", "javascript:AjaxWindow.show('building_cityhall',{town_id:26},'26');", "Edifício Municipal");
newShortcut("http://downzwarez.googlepages.com/banco.png", "javascript:AjaxWindow.show('building_bank',{town_id:26},'26');", "Banco");
newShortcut("http://downzwarez.googlepages.com/hotel.png", "javascript:AjaxWindow.show('building_hotel',{town_id:26},'26');", "Hotel");
newShortcut("http://downzwarez.googlepages.com/loja_de_armas.png", "javascript:AjaxWindow.show('building_gunsmith',{town_id:26},'26');", "Loja de Armas");
newShortcut("http://downzwarez.googlepages.com/alfaiate.png", "javascript:AjaxWindow.show('building_tailor',{town_id:26},'26');", "Alfaiate");
newShortcut("http://downzwarez.googlepages.com/loja.png", "javascript:AjaxWindow.show('building_general',{town_id:26},'26');", "Loja");
newShortcut("http://downzwarez.googlepages.com/coveiro.png", "javascript:AjaxWindow.show('building_mortician',{town_id:26},'26');", "Coveiro");
