// ==UserScript==
// @name			Ask.fm Auto Likes by xMrRyooon
// @namespace                   http://userscripts.org/scripts/show/9099999
// @version			1.0
// @copyright		        http://ask.fm/xMrRyooon
// @description		        Auto Like On Ask.fm
...
if(body != null) {
    ...
    div.innerHTML = "<div style='background-color: #80a0ff; color: #FFFFFF; border: 1px solid #00a2ff;'><center><a style='color: #000000;' <a href='https://twitter.com/MrRyooon' target='_blank' title='Follow Me For more :)'> My twitter</a></div>"
    ...
    div2.innerHTML = "<div style='background-color: #56A5EC; color: #F9B7FF; border: 1px solid #ffffff;'><a style='color: #ffffff;' onclick='spoiler()' title='Click Para Ocultar'>&laquo;</a> &#8226; <a href='http://ask.fm/xMrRyooon' title=' My Site :)' style='color: #0000ff;' onclick='alert(\'Thanks for install this script\');'>  Rayan </a></div> "
    ...
    unsafeWindow.spoiler = function() {
        ...
        for(i=1;i<=20;i++) {
            ...
            if (x.style.display=="none") {
                ...
                div2.innerHTML = "<a onclick='spoiler()' title='Mostrar :) My Ask Rayan'>&laquo;</a> &#8226; <a href='http://ask.fm/xMrRyooon' title='Rayan-'>!</a>"
            }
            else {
