// ==UserScript==
// @name           eRepublik Donate Logger/es
// @namespace      erepDonateLogger
// @author         Really dont know...
// @include        http://www.erepublik.com/es/economy/donate-money/*
// @include        http://www.erepublik.com/es/economy/donate-items/*
// @include        http://www.erepublik.com/es/citizen/profile/*
            ...
            if (selfID == userID)
            {
                ...
                for (var i=0; i<list.length; i++)
                {
                    ...
                    $("div#DonateLog").append('<div>' + "["  +  list[i]  +  "] To&nbsp;"
                                               + '<a class="nameholder" title="' + data.split('|')[0] + '" href="/es/citizen/profile/' + data.split('|')[1] + '">' + data.split('|')[0] + '</a>:'
                                               + '<br/>' + data.split('|')[2]
                                               + '</div>');
                }
            }
