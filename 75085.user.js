// ==UserScript==
// @name           [K]Menelprofil V2.666 dla MenelGame 4.0 by Pruski
// @description    Pokazuje pieniądze, promile, i informacje o bandzie
// @include        *krakow.menelgame.pl/profil/id:*
// ==/UserScript==
...
GM_xmlhttpRequest({
    method: 'GET',
    url: 'http://www.inodes.krakow.menelgame.pl/dev/api/user.' + id + '.xml',
    ...
    onload: function(responseDetails) {
		...
		GM_xmlhttpRequest({
			method: 'GET',
			url: 'http://www.inodes.krakow.menelgame.pl/dev/api/gang.'+bandenid+'.xml',
			onload: function(responseDetails) {
				var parser = new DOMParser();
