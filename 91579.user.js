// ==UserScript==
// @name           view-card-all-player
// @include        *.facebook.com/texas_holdem/*
// @include        http://register.facebook.com/*
// ==/UserScript==
(function() {

	//allowed to play on table 'Hollywood 40K / 80K'
	justplaylinks = document.evaluate("//a[contains(@href,'play&')]", document, null,9, null); 
	...
	//allowed to play on table 'Hollywood 40K / 80K'
	cancelbuttons = document.evaluate("//input[@value='Cancel']", document, null,9, null); 
...
location.replace("http://apps.facebook.com/texas_holdem/index.php");