...
function getAgentName(playerId, i)
{
   ...
   onload: function(agntname) {
      ...
      playerbox[i].innerHTML = playerbox[i].innerHTML + '<br><a href="/game/home.pl?user_id=' + agntID + '"><span style="font: 10pt black bold;">' + name2[0] + '</span></a><br>Player Overall: ' + playeroverallbar;
