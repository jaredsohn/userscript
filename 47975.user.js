// ==UserScript==
// @name          Whirlpool Plus (Erwin Version - 2.036)
// @namespace     http://www.onlinelife.com2.036
...
erB.textContent='List All User Notes';
...
erB.addEventListener('mouseup', function() {
var gmVals = GM_listValues();
	for(var gmKey in gmVals){
		if(gmVals[gmKey].charAt(0)=='u' && Number(gmVals[gmKey].charAt(1))){
			erTa.value+='$UserNote$ : '+(gmVals[gmKey].replace("u","#"))+' : '+GM_getValue(gmVals[gmKey])+'\r\n';
		}
	}
}, false);


var scriptVersion = '2.036';
...
if(installedVersion < scriptVersion && scriptVersion == currentVersion){
	if(installedVersion < 2.036){
	   	newFeatures += 'Added WP Black theme to list of themes - thanks to â•CPmasterâ•, ';
	}
...
if(typeof GM_xmlhttpRequest != "undefined") {
	...
	addListSetting(['','@import url(http://members.optusnet.com.au/whirlpoolian/classic/css/core.css);','@import url(http://members.optusnet.com.au/foonly/wpblue/1/css/core.css);','@import url(http://members.optusnet.com.au/whirlpoolian/greyscale/css/core.css);','@import url(http://members.optusnet.com.au/whirlpoolian/steelyellow/css/core.css);','@import url(http://www.members.optusnet.com.au/kev.nat/Whirlpool%20Noir/1/WP%20BLACK.css);'] , ['Default','WP Classic','WP Blue','WP Grey','WP Steel Yellow','WP Black'],'customtheme', 'Custom WP Theme', 'Choose a WP Theme to Use. <a href="http://whirlpool.net.au/wiki/?tag=whirlpool_plus">Click here to see new Custom WP Theme in action.</a>');
...
$('.foot_subs').append('Â· <a href="'+nthreadLink+'">Thread Archive</a>  ');
}
if (pView ==1){
...
$('.foot_subs').append('Â· <a href="'+threadLink+'">Print View</a>  ');
}
if (mView ==1){
var threadLink = window.location.href;
...
$('.foot_subs').append('Â· <a href="'+threadLink+'">View moderator posts</a>  ');
}
if (rView ==1){
var threadLink = window.location.href;
...
$('.foot_subs').append('Â· <a href="'+threadLink+'">View representative posts</a>  ');
}

$('.foot_subs').append(' <a href="#top" onclick="self.scrollTo(0, 0); return false;">Â· Go to Top of Page</a> Â· ');
...
if(floatQuote>0){
	...
	for (var loop=0; loop < replyNumAr.snapshotLength; loop++){
		...
		GM_log('asd');
		unsafeWindow.console.log(usernote);
		unsafeWindow.console.log((typeof usernote));		
	if (usernote ==1){
