...
// @name           Topic Poster
// @author         Kute -
// @description    This script will Post same topic in all joined communities easily, You just need to enter capatcha and press enter and it will post topic smoothly. Created by someone else and fixed by Kute.
// @namespace      Orkuted.com
// @include        http://www.orkut.com/*
// ==/UserScript==

var subject = "Gift Beautiful Pictures To Your Friend";
var msg = "[b][green]Gift Beautiful Pictures To Your Friend Visit This Community now: http://www.orkut.com/Community.aspx?cmm=56003649 \n \n";
...
if(document.location.href.indexOf("CommMsgs.aspx")>=0)
{
	...
	{
		alert("All the communities have been posted with the message. Visit freemoviesgalaxy.com for Free Online Movies");
	}
}
}, false);