...
// @exclude    http://*.ikariam.*/gold.php
// @exclude    http://ikariam.ogame-world.com/*
// @exclude    http://www.__kauboj__-world.com/*
// ==/UserScript==
				...
				<div id="cityNav">
					<form id="changeCityForm" action="index.php" method="POST">
						<fieldset style="display:none;">
							...
							<input type="hidden" name="actionRequest" value="d29ac7ab97e7a38394808577ab1be2ff" />
...
<!-- TODO Goldbalance... -->
				<div id="globalResources">
					...
					<ul>
						...
						<li class="gold" title="809,182 Zlato"><a href="?view=finances"><span class="textLabel">Zlato: </span><span id="value_gold">809,182</span></a></li>
				...
				<div id="cityResources">
					...
					<ul class="resources">
						<li class="population" title="Populacija">
							...
							<span id="value_inhabitants" style="display:block;width:80px;">841 (1,314)</span>
						</li>
...
<!-- Top-toolbar with extragame options. -->
		<div id="GF_toolbar">
			...
			<ul>
				...
				<li class="serverTime"><a><span class="textLabel" id="servertime">26.02.2009 18:25:32</span></a></li>
			</ul>
		</div>
<!-- END Top-toolbar -->
...
function updateServerTime() {
    ...
    currTime.setTime((1235669132000-startServerTime)+ currTime.getTime()) ;
