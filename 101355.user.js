scr_meta=<><![CDATA[
// ==UserScript==
// @name          QuangDo Crop Finder T4
// @namespace      http://userscripts.org/
// @description    Find 15 and 9 Crop fields
// @version        0.3
// @include        http://ts8.travian.com.vn/*
...
function getMap(x, y) {
	$.getJSON('http://ts8.travian.com.vn/ajax.php', "cmd=mapPositionData&data[x]=" + x + "&data[y]=" + y + "&data[zoomLevel]=2&", function(data) {
...
var AnotherAutoUpdater = { // update script ECHOP THANKS! http://userscripts.org/scripts/show/38017
