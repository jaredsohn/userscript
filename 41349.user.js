...
if (k == 66) {
    ...
    document.location.href = 'http://92.48.103.52/fantasy/game.php?command=swapcharacter&var1=2122';
  } if (k == 72) {
    document.location.href = 'http://92.48.103.52/fantasy/game.php?command=swapcharacter&var1=2850';
  } if (k == 73) {
    ...
    document.location.href = 'http://92.48.103.52/fantasy/game.php?screen=CHAT&var2=5148';
  } if (k == 84) {
    ...
    document.location.href = 'http://92.48.103.52/fantasy/game.php?var5=2850&var1=Lesser+Shield+Scroll&command=use&screen=SCROLLS';
  } if (k == 50) {
    document.location.href = 'http://92.48.103.52/fantasy/game.php?var5=2850&var1=Lesser+Focus+Scroll&command=use&screen=SCROLLS';
  } if (k == 51) {
    document.location.href = 'http://92.48.103.52/fantasy/game.php?var5=2850&var1=Summon+Skeleton&command=use&screen=SCROLLS';
  } if (k == 52) {
    document.location.href = 'http://92.48.103.52/fantasy/game.php?var5=2850&var1=Shield+Scroll&command=use&screen=SCROLLS';
  } if (k == 53) {
    document.location.href = 'http://92.48.103.52/fantasy/game.php?var5=2850&var1=Focus+Scroll&command=use&screen=SCROLLS';
  } if (k == 32) {
