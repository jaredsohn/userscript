...
//
// ==UserScript==
// @name          Akismet Auntie Spam v2 for WordPress 2.3 or lower
...
// 		last_num = 3; // DEBUG
  ...
  function checkUpdates(now) {
    autoUpdateFromUserscriptsDotOrg({
	  ...
	  url: 'http://userscripts.org/scripts/source/24594.user.js',
