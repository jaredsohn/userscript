...
var UMs_full = ['Inter Military Services'];
var UMs_abrev = ['IMS'];

var FORM_URL_MU = ["https://spreadsheets.google.com/spreadsheet/formResponse?hl=en_US&formkey=dHNWOW5UMGRtR2E1bHBLVmlWbGludVE6MA&ifq"];
...
if(window.location.href.indexOf(PAGE_BATTLEFIELD) > 0) {	
	...
	/***********************************************************************************/
	var FORM_URL = "https://docs.google.com/spreadsheet/viewform?formkey=dHNWOW5UMGRtR2E1bHBLVmlWbGludVE6MA#gid=0";
	var FORM_FIELDS = {
				eday: "entry.0.single",
                name: "entry.2.single",
				UM:  "entry.18.single",
	...
	function createReportDialog() {
		var $reportDialog = $('<div id="bs_popup_report" class="pop enemy_defeated bs_window" style="top: 303px; left: 603.5px; display: block;"> \
			<div class="heading">																										   \
