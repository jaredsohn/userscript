// ==UserScript==
// @name        Youtube URL replacer (4CHAN)
// @namespace   Youtube URL replacer (4CHAN)
// @description Youtube URL replacer for 4chan
	...
	if (posts[i].innerHTML.indexOf("http://www.youtube.com/watch?v=") != -1)
		{
			...
			realEnd = oldText.indexOf(videoCode, oldText.indexOf("http://www.youtube.com/watch?v="))+11;
