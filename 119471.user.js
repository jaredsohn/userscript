...
//floatingDivToTop.innerHTML        = "<a id='to_top_div' style='-moz-transform: scale(2);padding: 0px 0px 10px 0px;margin: 0px 20px 0px -30px;background:none;color:#336699; text-decoration:none;font-size:large;font-family:verdana' href='#'                   onClick='javascript:window.scrollTo(0,0);window.blur();return false'>" + to_top_char + '</a>';
//floatingDivToTop.innerHTML        = "<a id='to_top_div' style='-moz-transform: scale(2);padding: 0px 0px 10px 0px;margin: 0px 0px 20px -30px; background:none;color:#336699;text-decoration:none;font-size:large;font-family:verdana' href='javascript:void(0);' onClick='javascript:window.scrollTo(0,0);window.blur();return false'>" + to_top_char + '</a>';
  floatingDivToTop.innerHTML        = "<a id='to_top_div' style='-moz-transform: scale(2);padding: 0px 0px 10px 0px;margin: 0px 0px 20px -30px; background:none;color:#336699;text-decoration:none;font-size:large;font-family:verdana'                            onClick='javascript:window.scrollTo(0,0);              return false'>" + to_top_char + '</a>';
//floatingDivToTop.innerHTML        = "<a id='to_top_div' style='-moz-transform: scale(2);padding: 0px 0px 10px 0px;margin: 0px 0px -30px 0px;background:none;color:none;text-decoration:none;font-size:large;font-family:verdana'                            onClick='javascript:window.scrollTo(0,0);              return false'>" + to_top_char + '</a>';
...
//floatingDivToBottom                  =        document.createElement('div');
  //window.blur() fails when there is more than one window open
//floatingDivToBottom.innerHTML        = "<a id='to_bottom_div' style='-moz-transform: scale(2);padding: 0px 0px 0px 0px;margin: 0px 0px 0px -30px;background:transparent;color:#336699;text-decoration:none;font-size:large;font-family:verdana' href='#'                   onClick='javascript:window.scrollTo(0,window.innerHeight+window.scrollMaxY);window.blur();return false'>" + to_bottom_char + '</a>';
//floatingDivToBottom.innerHTML        = "<a id='to_bottom_div' style='-moz-transform: scale(2);padding: 0px 0px 0px 0px;margin: 0px 0px -30px 0px;background:transparent;color:#336699;text-decoration:none;font-size:large;font-family:verdana' href='javascript:void(0);' onClick='javascript:window.scrollTo(0,window.innerHeight+window.scrollMaxY);window.blur();return false'>" + to_bottom_char + '</a>';
  floatingDivToBottom.innerHTML        = "<a id='to_bottom_div' style='-moz-transform: scale(2);padding: 0px 0px 0px 0px;margin: 0px 0px 0px -30px;background:transparent;color:#336699;text-decoration:none;font-size:large;font-family:verdana'                            onClick='javascript:window.scrollTo(0,window.innerHeight+window.scrollMaxY);              return false'>" + to_bottom_char + '</a>';
//floatingDivToBottom.innerHTML        = "<a id='to_bottom_div' style='-moz-transform: scale(2);padding: 0px 0px 0px 0px;margin: 0px 0px 0px -30px;background:transparent;color:none;text-decoration:none;font-size:large;font-family:verdana'                            onClick='javascript:window.scrollTo(0,window.innerHeight+window.scrollMaxY);              return false'>" + to_bottom_char + '</a>';
