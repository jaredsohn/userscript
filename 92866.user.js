...
USP.init({theName:'member', theText:'Tipo de Membro?', 
          theValues:['Pioneer','Standard','Golden','Ultimate'], theDefault:'Standard'},
          {theName:'lang', theText:'Lingua?', 
          theValues:['EN','TH'], theDefault:'EN'},
          {theName:'reciclagem', theText:'Calculate profit with recycling costs?', theDefault:false},
          {theName:'renovar', theText:'Calculate profit with renew?', theDefault:false},
          {theName:'trenovar', theText:'Renovação:', theDefault:30}
...
// -> O script corre nas duas linguas Portugues e Inglês(vou tentar adicionar mais em breve)
  ...
  TH : {
    ...
    'Golden': '[Golden',
    'Ultimate': '[Ultimate',
    'clickedtoday': 'คลิกวันนี้:',
    'clickedyesterday': 'คลิกเมื่อวาน:',
    'neverclicked': 'ไม่เคยคลิก:',
    'tclicks': 'รวมคลิก:',
    'average': 'คลิกเฉลี่ย',
    'profit': 'กำไร',
    'timeago': 'วันที่ผ่านมา'
  }
};
