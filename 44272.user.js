// ==UserScript==
// @name           Lincr Shortening for Twitter
// @namespace      aalaap.com
// @description    Shortens URLs using Lincr within the Twitter web interface. By Aalaap Ghag. Based on Twitter-URL-Shortener by Jimmy222.
            ...
            if(v) {
                ...
                if(urlLength===0) {
                    ...
                    for(var i=urlLength-1;i>-1;i--) {
                        GM_xmlhttpRequest({
                            method: 'GET',
                            url: 'http://lin.cr/?mode=api&full=1&l=' + encodeURIComponent(urls[i][0]),
