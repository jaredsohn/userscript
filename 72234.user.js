...
// @exclude		   	*change*
// @version			0.3.2 leon6: modifs des smileys
// @version			0.3.2 leon5: modifs mineures
...
function add_funcs() {
	...
	*/
	...
	editor.addSmilie('http://media.pennergame.de/de/img/cash.png');
	editor.addSmilie('http://static.pennergame.de/img/pv4/icons/att.gif');
	editor.addSmilie('http://static.pennergame.de/img/pv4/icons/def.gif');
