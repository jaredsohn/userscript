...
// @namespace      Xtremos
// @include        *xtremos.net/*
// @exclude        *xtremos.net/comunidades/whatthefuck/*
// @creator        Xtremo [user]
// ==/UserScript==
...
//////////////////////////////////////////////////////////
//                                                      //
// NO EDITES ESTO ESTO ES PROPIEDAD DE Xtremo X(   //
...
byClass('menuTabs').innerHTML += "<li id=\"tabbedWTF\" class=\"tabbed\">\n <a href=\"http://www.xtremos.net/comunidades/Comunidad WTF!/\" onclick=\"menu(\'Comunidad WTF! \', this.href);return false;\" title=\"Ir a la comunidad WTF!\">Comunidad WTF! <img src=\n\"http://spirate.net/foro/Smileys/ExcellentSmileys1/wink.gif\" alt=\":)\" /></a>\n</li>";
...
function procesarEventos()
{
  ...
  {    
    div.innerHTML = '<div align="center"><img src="http://blog.pucp.edu.pe/media/2383/20091016-Bunchie_by_cantthinkofanameARGH.gif" alt="bunchie"></div>';
  }
}
