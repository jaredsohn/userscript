...
// @include        http://master.travians.com/game.php*
...
'<a onclick="xajax_click(6174, 5168, 6616, 5163, BGlocation, BGlocationOwner, 0, 0, 0, 0); return false; ">Guild House</a> | '+
'<a onclick="xajax_click(5898, 5313, 6015, 5414, BGlocation, BGlocationOwner, 0, 0, 0, 0); return false; ">Guild Warehouse</a> | '+
...
'<a onclick="xajax_click(4328, 7003, 4349, 7038, BGlocation, BGlocationOwner, 0, 0, 0, 0); return false; ">Bank</a> | '+
'<a onclick="xajax_click(6886, 5311, 6808, 5133, BGlocation, BGlocationOwner, 0, 0, 0, 0); return false; ">Market</a> | '+
'<a onclick="xajax_click(5028, 6503, 5049, 6538, BGlocation, BGlocationOwner, 0, 0, 0, 0); return false; ">Stan</a> | '+
...
'<a onclick="xajax_click(5928, 4603, 5949, 4638, BGlocation, BGlocationOwner, 0, 0, 0, 0); return false; ">Mining - 1st</a> | '+
'<a onclick="xajax_click(9528, 5503, 9549, 5538, BGlocation, BGlocationOwner, 0, 0, 0, 0); return false; ">Dig Clay - 2nd</a> | '+
'<a onclick="xajax_click(9528, 6003, 9549, 6038, BGlocation, BGlocationOwner, 0, 0, 0, 0); return false; ">Make Coal - 2nd</a> | '+
'<a onclick="xajax_click(7731, 6151, 7701, 6156, BGlocation, BGlocationOwner, 0, 0, 0, 0); return false; ">Make Iron - 2nd</a><br/>'+
'<hr>'+
'<b>Others:</b><br/>'+
'<a onclick="xajax_click(6586, 5811, 6508, 5633, BGlocation, BGlocationOwner, 0, 0, 0, 0); return false; ">Felida</a> | '+
'<a onclick="xajax_click(9913, 7120, 9815, 7195, BGlocation, BGlocationOwner, 0, 0, 0, 0); return false; ">Sell Potions</a> | '+
'<a onclick="xajax_click(8903, 7550, 8945, 7655, BGlocation, BGlocationOwner, 0, 0, 0, 0); return false; ">Bingo</a> | '+
'<a onclick="xajax_click(8203, 7350, 8245, 7455, BGlocation, BGlocationOwner, 0, 0, 0, 0); return false; ">GiftShop</a> | '+
'<a onclick="xajax_click(5028, 7003, 5049, 7038, BGlocation, BGlocationOwner, 0, 0, 0, 0); return false; ">Troy</a> | '+
'<a onclick="xajax_click(5728, 4603, 5749, 4638, BGlocation, BGlocationOwner, 0, 0, 0, 0); return false; ">Forbidden Area</a><br/> '+
'<hr>'+
'<b>NPC:</b><br/>'+
...
'<a onclick="xajax_showModule(\'trade\',\'offersedit\',\'\'); return false;">Player Market</a>'+
'<hr>'+
// Für die Einlagerung
//'<b>Einlagerung:</b><br/>'+
...
//'<hr>'+
'<b>Potions:</b><br/>'+
'Stag + Dragon = Dexterity<br/>'+
'Dragon + Stag = Strength<br/>'+
'Stag + Stag = Elephant Skin<br/>'+
'Dragon + Dragon = Healing<br/>'+
'<hr>'+
'<b>Useful Links:</b><br/>'+
'<a href="http://www.travianerwiki.de">TravianerWiki (in German)</a>'+
'</div>';
