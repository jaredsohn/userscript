// ==UserScript==
// @name            S.A.L - (simple ass login) 05-29 update/
// @namespace       AirWalk
// @include         http://www.myspace.com/
// @include         http://www.myspace.com/index.cfm?fuseaction=splash
// ==/UserScript==
function do_platypus_script() {
isolate(window.document,document.getElementById('col1'),null,null,null);
erase_it(window.document,document.evaluate('/HTML[1]/BODY[1]/DIV[1]/DIV[1]/DIV[3]/DIV[1]', document, null, XPathResult.FIRST_ORDERED_NODE_TYPE,null).singleNodeValue,null,null,null);
erase_it(window.document,document.evaluate('/HTML[1]/BODY[1]/DIV[1]/DIV[1]/DIV[2]/DIV[1]/DIV[1]', document, null, XPathResult.FIRST_ORDERED_NODE_TYPE,null).singleNodeValue,null,null,null);
erase_it(window.document,document.evaluate('/HTML[1]/BODY[1]/DIV[1]/DIV[1]/DIV[2]/DIV[2]', document, null, XPathResult.FIRST_ORDERED_NODE_TYPE,null).singleNodeValue,null,null,null);
erase_it(window.document,document.evaluate('/HTML[1]/BODY[1]/DIV[1]/DIV[1]/DIV[2]/DIV[4]/DIV[1]', document, null, XPathResult.FIRST_ORDERED_NODE_TYPE,null).singleNodeValue,null,null,null);
do_modify_html_it(window.document,document.getElementById('logIn'),/Forgot your password\?/,'Created by AirWalk',null);
do_modify_html_it(window.document,document.getElementById('account'),/Sign Up\!/,'Userscripts.org',null);
do_modify_html_it(window.document,document.getElementById('account'),/http:\/\/signups.myspace.com\/index.cfm\?fuseaction\=signup/,'http://userscripts.org/',null);
do_modify_html_it(window.document,document.getElementById('account'),/Sign Up/,'User Scripts',null);
do_modify_html_it(window.document,document.getElementById('account'),/http:\/\/secure.myspace.com\/index.cfm\?fuseaction\=user.retrievepassword/,'http://userscripts.org/scripts/show/11823',null);
