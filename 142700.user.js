// ==UserScript==
// @name           Ikariam Geliştirme Takipçisi
// @version        2.0.6
// @namespace      Ceres_Dm
// @description    Geliştirilebilir binalara yeşil renk verilir,geliştirilemeyen binalara kırmızı renk verilir. ne kadar eksik&fazla kaynağın olduğunu gösterir.
// @author         Ceres_Dm
//
...
GM_addStyle(' \
	...
	#iuwtooltip {position:absolute;line-height:19px; text-align:right; font-size:smaller;opacity:0.85;color:#333;display:none;z-index:499; font-weight:bold; border:solid #c3802d;	border-width:4px 10px 4px 11px;	-moz-border-image:url('+imgScroll+') 4 10 4 11 repeat; -webkit-border-image:url('+imgScroll+') 4 10 4 11 repeat; } \
...
var IUW = new function() {
	...
	this.updateIcons = function() {
		...
		for (var i = 0; i < this.spot.length; i++) {
			...
			busy = this.spot[i].isBusy && (buildingType != 'port');
			busy = busy || cityBusy;
