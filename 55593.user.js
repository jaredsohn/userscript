// ==UserScript==
// @name           eSweden Battle Orders (eRep)
// @namespace      www.erepublik.com
// @description    eSweden Battle Orders (eRep)
// @version        0.1
...
GM_xmlhttpRequest({
	method: 'GET',
	url: 'http://www.erepublik.se/viewtopic.php?f=10&t=6042',
	...
	onload:function(response){
			...
			updated_el.textContent ='Uppdaterat: ' + date_issued;
