...
//
// @include        http://www.flickr.com/groups/pickyourpoison/discuss/
// @include        http://www.flickr.com/groups/pickyourpoison/discuss
// @include        http://flickr.com/groups/pickyourpoison/discuss/
// @include        http://flickr.com/groups/pickyourpoison/discuss
// ==/UserScript==
//
// --------------------------------------------------------------------
...
if (name.match("(CLOSED) PYP Chat")=="(CLOSED) PYP Chat") return true; 
...
if (name.match("PYP Chat")=="PYP Chat") return true; 
...
if (newchlgstatus=="PYP Chat") anchor.innerHTML='<img src="http://www.purpletwinkie.com/tcf/pypchat2.png" width="80" height="17">';
 ...
 */            }
		   ...
		   if (chlgname.match("VOTE")=="VOTE")
             ...
             //if (!inbrackets)
               //{
               //if (((photosposted==5)&&(chlgnum=='11'))&&(lastvote.match('20')=="20")) 
               // newchlgstatus="Finished";
               if ((photosposted==5)&&((chlgnum!='12'))&&(lastvote.match('5')=="5")) 
                 newchlgstatus="Finished";
              // }
             } // end of if match vote
             
           //overwrite some base statusses if challenge is in voting.
           if ((newchlgstatus=="none")&&(photosposted==5)&&(chlgname.match("ENTER")=="ENTER")) newchlgstatus="Filled";
...
for (i=1;i<trs.length;i++) {
  ...
  if (nonchallenge(chlgname))  chlgstatus="PYP Chat";
