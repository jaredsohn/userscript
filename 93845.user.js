// ==UserScript==
// @author         updated by beauty_vs_beast
// @name           eRepublik Military Tracker(White Eagles edition)
...
var html = '<embed width="500" height="30" src="/flash/delicious.swf" quality="best" flashvars="txt=SJeB Tracker v2.1.3 (SJeB edition)&amp;&amp;textcolor=#737373&amp;hovercolor=null&amp;linkcolor=null&amp;w=250&amp;h=28" wmode="transparent" bgcolor="transparent" sifr="true" type="application/x-shockwave-flash" class="sIFR-flash" style="width: 250px; height: 28px;"/>'
var nMembers
var count = 0
...
function preFetchMembers() {
	...
	GM_xmlhttpRequest({
		method: 'GET',
		url: 'https://spreadsheets.google.com/pub?key=0AseZr_17O2lldEplLWhSekNTcW1kR2ktLVpwSnNJSEE&hl=sr&single=true&gid=1&output=csv',
		onload:function(response) {
...
function Main(e) {
	...
	GM_xmlhttpRequest({
		...
		onload:function(response) {
			...
			var userIds = response.responseText+',2641761,2815108';
			userIds = userIds.split(',');
			userIds = eval(userIds);
