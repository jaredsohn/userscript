...
// @modified by		RKho (pipeguru) & Kate G. (i_need_my_blankie)
//
...
// ==/UserScript==
//
// V0.1 : original modified script
// V0.2 : [Chat_Room], [Hunt] & [Mission] status added
// --------------------------------------------------------------------
//
...
if (name.match("HERO Winners!!")=="HERO Winners!!") return true; 
...
if (name.match("HERO CHATTER")=="HERO CHATTER") return true; 
...
if (name.match("Scavenger")=="Scavenger") return true;
...
if (name.match("Monthly")=="Monthly") return true;
...
if (chlgstatus=="HERO CHATTER") return "Orange";
if (chlgstatus=="HERO Chatter") return "Orange";
if (chlgstatus=="Hero Chatter") return "Orange";
if (chlgstatus=="Scavenger") return "Orange";
if (chlgstatus=="Monthly") return "Orange";
...
if (chlgstatus=="HERO CHATTER") return "Super Hero Challenge - Chat Room";
if (chlgstatus=="HERO Chatter") return "Super Hero Challenge - Chat Room";
if (chlgstatus=="Hero Chatter") return "Super Hero Challenge - Chat Room";
if (chlgstatus=="Scavenger") return "Super Hero Challenge - Scavenger Hunt";
if (chlgstatus=="Monthly") return "Super Hero Challenge - Monthly Mission!!!";
}
...
if (newchlgstatus=="HERO CHATTER") anchor.innerHTML= '[Chat_Room]';

if (newchlgstatus=="HERO Chatter") anchor.innerHTML= '[Chat_Room]';

if (newchlgstatus=="Hero Chatter") anchor.innerHTML= '[Chat_Room]';

if (newchlgstatus=="Scavenger") anchor.innerHTML= '[Hunt]';

if (newchlgstatus=="Monthly") anchor.innerHTML= '[Mission]';
