// ==UserScript==
// @name           liveKusoKote
// @namespace      http://zako.if.land.to/
...
(function (){
	...
	function kusoChanger(){
		...
		kusoButton.addEventListener(
			...
			function(){
				...
				GM_setValue('kusoData',kusoData.toSource());main();
			},false
		);
	...
	function kusoGet(kuso){
		return eval( GM_getValue( kuso , "({})" ) )||{};
	};
