// ==UserScript==
// @name           AloysiusWeasley Check for glowing tanks.4
// @description    Checks tanks AloysiusWeasley wanted for if they are glowing to help her stalk her tank.
// @include        *
// ==/UserScript==
						...
						if(glowT<=gaiaT){
							if(glowT+720>gaiaT){
								...
								if(open===true){
									...
									GM_openInTab('http://www.gaiaonline.com/forum/compose/entry/new/57641519/');
								}
							}
							else{
								//alert('over');
...
function checkTanks(){
	...
	if(time>=GM_getValue('date',time-20)+20){
		...
		checkTank(2550589,false);//Havenne Shadow
	}
}
checkTanks();
