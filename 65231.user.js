// ==UserScript==
// @name           polskie tlumaczenie eRepublik by COLT
// @description    polskie tlumaczenie eRepublik by COLT (cedits - dowlander)
...
//Strona główna
"Day ": "Dzień ",
"Hey, I am busy right now. I will be back in a few moments": "Cześć, jestem zajęty teraz. Wrócę za chwilę",
"New feature": "Nowe funkcje",
"Advertising Department": "Urząd Reklamy",
"Country stats": "Statystyki krajów",
"Tutorials": "Poradniki",
"World Map": "Mapa świata",
"new events": "nowe imprezy",
"Congress election day. Vote for your favorite!": "Dzień wyborów do Kongresu. Zagłosuj na swojego ulubionego!",
"The salary cannot be lower than the amount agreed until three days pass." : "Stawka nie może być mniejsza niż ustalona przy przyjęciu nim miną 3 dni.",
"Amount" : "Ilość",
"Price" : "Cena",
...
"Jobs available in this company" : "Dostępna praca w tej firmie",
"You do not have any active job offers" : "Nie masz aktwnych ofert pracy",
"Employees details" : "Szczegóły Zatrudnionych",
//

//Profil
"Edit Wiki file": "Edytuj notatkę Wiki",
"edit profile": "edytuj profil",
"No shouts posted by this citizen yet": "Brak okrzyków tego mieszkańca",
"Location": "Lokalizacja",
"Citizenship": "Obywatelstwo",


  "* new messages": "$1 nowych wiadomośći",
  "Apply": "Podejmij",
  "Buy": "Kup",
  ...
  "Get gold &amp; extras" : "Kup gold &amp; extra",
	"Rankings" : "Ranking",
...
// country page
	"On the Map" : "Na mapie",
	"Total citizens" : "Liczba obywateli",
	"New citizens today" : "Obywatele zarejestrowani dzisiaj",
...
// economy
	...
	"Country trading embargoes" : "Embarga handlowe",
	"Taxes" : "Podatki",
	"food" : "żywność",
	"gift" : "prezent",
	"weapon" : "broń",
...
// company
	"Office" : "Biuro",
	"You have already worked today." : "Dzisiaj już pracowałeś.",
	"Come back tomorrow." : "Wróć tutaj jutro.",
	"Resign" : "Rezygnuj",
	"Employees" : "Pracownicy",
	"Raw materials" : "Surowce",
	"Show all employees" : "Zobacz pracowników",
	...
	"Sell products here" : "Sprzedaj Towary",
	...
	"The company offers no products in this market" : "Firma nie oferuje żadnego produktu na tym rynku",
	"Enter a price between 1 - 5000 Gold" : "Wpisz cenę pomiędzy 1 a 5000 Gold",
	"Products" : "Produkty",
	"Market offers" : "Oferty na rynku",
	"Grain" : "Zboże",
	"Food" : "Żywność",
	...
	"Minimum country wage" : "Minimalna płaca krajowa",
...
// army
	...
	"Military achievements" : "Odznaczenia wojskowe",
	...
	"General" : "Generał",
	"Fights" : "Liczba Walk",
	"Field Marshall" : "Marszałek Polowy",
...
// party
	...
	"Show proposed members of congress" : "Zobacz proponowanych posłów",
...
// profiles
	...
	"Reach the highest total damage in one battle" : "Zdobądź największe obrażenia podczas jednej bitwy",
	"Resistance Hero" : "Bohater Powstania",
...
// fight
	...
	"Conquer" : "Podbity",
	"Secure" : "Obroniony",
	"Basic damage" : "Podstawowe obrażenia",
...
// messages
  "Inbox" : "Skrzynka",
	...
	"From" : "Od",
// flash menu
	"My places > Training grounds" : "Moje Miejsca > Koszary",
	"My places > Newspaper" : "Gazeta",
	"My places > Organizations" : "Organizacje",
	"My places > Party" : "Partie",
...
addGlobalStyle('#menu ul li#menu1 a, #menu ul li#menu2 a, #menu ul li#menu3 a, #menu ul li#menu4 a, #menu ul  li#menu5 a, #menu ul  li#menu6 a, #logo a { background-image: url(http://img193.imageshack.us/img193/5638/maperepubliklogged.png); }');
