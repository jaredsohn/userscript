...
// @namespace http://userscripts.org/scripts/show/110549
// @version 0.2.0.0 WarMachine Mod
// @description http://userscripts.org/topics/110549
...
var MWAddonInfo = {
    version         : '0.2.0.0',
    name            : 'FB MafiaWars Addon WarMachine Mod',
    tag             : 'FBMafiaWarsAddon_',
    url             : 'http://userscripts.org/scripts/show/110549',
    meta_url        : 'http://userscripts.org/scripts/source/110549.meta.js',
...
var helpToolTips = {
    ...
    locale_info: {
        'en_US': {
            ...
            description: 'English Tooltip v1.1<br><br>Created by: <a href="http://userscripts.org/users/250944" target="_black">dakam</a>.<br>Revision by: <a href="http://www.facebook.com/prince.loa" target="_black">Prince Loa</a>.'
        },    
        'id_ID': {
            name: 'Indonesia (Indo)',
            description: 'Indonesia Tooltip v1.0<br><br>Created by: <a href="http://www.facebook.com/prince.loa" target="_black">Prince Loa</a>.<br>Fans Page: <a href="http://www.facebook.com/pages/tgmw-The-Great-Mafia-Wars-Fan-Page/155005297902807" target="_black">≋tgmw≋ Fan Page</a>.<br>â•‘EMIâ•‘ Fans Page: <a href="http://www.facebook.com/groups/167743759914150/?id=197849696903556" target="_black">Beranda ║EMI║</a>.'
        },
        'es_ES': {
            name: 'Spanish (Spain)',
        ...
        'de_DE': {
            name: 'Deutsch (German)',
            description: 'German Tooltip v1.0<br><br>Created by <a href="http://www.facebook.com/prince.loa" target="_black">Prince Loa</a>.'
        }    
    },
    ...
    'id_ID': {
        ...
        'homefeedcenter_popup': {
            ...
            'feedstream_dogotowar': 'Helping.<br>Kasih tanda hanya untuk menolong â€œwarâ€.',
...
function createMenu() {
     ...
     */
    var defaultRootMenu = [
        {name:'<img src="http://userscripts.org/images/script_icon.png" height=16 /> CONFIGURATION',            									'click': Configuration                                  }, 
        {name:'-',                        																											'line' : true                                           },
        {name:'<img src="http://userscripts.org/images/script_icon.png" height=16 /> Free Gifts Center',        									'click': FreeGiftsCenter                                },
        {name:'<img src="http://userscripts.org/images/script_icon.png" height=16 /> Home Feed Center',         									'click': HomeFeedCenter                                 },
        {name:'<img src="http://userscripts.org/images/script_icon.png" height=16 /> Collect All Cities',       									'click': CollectAllCities                               },
        {name:'<img src="http://userscripts.org/images/script_icon.png" height=16 /> BattleField v2!',          									'click': Battlefieldv2                                  },
        {name:'<img src="http://userscripts.org/images/script_icon.png" height=16 /> Gifts Page (Short Links)', 									'click': tofreegiftsPage                                },
        {name:'<img src="http://userscripts.org/images/script_icon.png" height=16 /> Craft Manager',            									'click': CraftManager                                   },
        {name:'<img src="http://userscripts.org/images/script_icon.png" height=16 /> Operations Center',        									'click': OperationsCenter                               },
        {name:'<img src="http://userscripts.org/images/script_icon.png" height=16 /> Multi Gifter',             									'click': MultiGifter                                    },
        {name:'<img src="http://userscripts.org/images/script_icon.png" height=16 /> Plug-In Manager',          									'click': PluginManager,     'submenu': 'plugins'        },
        //{name:'Reminder Editor',          								  																		  'click': ReminderEditor,    'submenu': 'reminder'       },
        {name:'<img src="http://userscripts.org/images/script_icon.png" height=16 /> Inventory Analizer',       									'click': InventoryAnalizer                              },
        {name:'<img src="http://userscripts.org/images/script_icon.png" height=16 /> Mafia Wiper',              									'click': MafiaWiper                                     },
        {name:'<img src="http://userscripts.org/images/script_icon.png" height=16 /> My Links',                 									'click': UserLinks                                      },
        {name:'<img src="http://userscripts.org/images/script_icon.png" height=16 /> Check Updates',    											'click': Updater.check                             		},
        {name:'-',                                                          																		'line' : true             								},
        {name:'<img src="http://userscripts.org/images/script_icon.png" height=16 /> WarMachine FanPage',         									'click': FanPage,        	'main': true                },
        {name:'<img src="http://userscripts.org/images/script_icon.png" height=16 /> Links For All',        										'click': LinksForAll,       'main': true                },
        {name:'-',                        																											'line' : true                                      		},
        {name:'<img src="http://userscripts.org/images/script_icon.png" height=16 /> unframe MafiaWwars',          									'click': unframe                             			},
        ...
        {name:'<img src="http://userscripts.org/images/script_icon.png" height=16 /> Link-A-Nator',          										'click': LinkANator                                     },
        {name:'<img src="http://userscripts.org/images/script_icon.png" height=16 /> Loose Slots',          										'click': LooseSlots                                     }
    ];
    /**
     * Root Menu Container
     */
...
function FanPage() {
unsafeWindow.open('http://www.facebook.com/pages/The-War-Machine-FanWar-Page/169253039799304');
}
function LinksForAll() {
unsafeWindow.open('http://www.facebook.com/groups/201614053183930');
}
function unframe() {
unsafeWindow.open('http://facebook.mafiawars.zynga.com/mwfb/index.php?skip_req_frame=1&mwcom=1');
}
...
location.href="javascript:%28function%28%29%7Bvar%20a%3Ddocument.createElement%28%22script%22%29%3Ba.type%3D%22text%2Fjavascript%22%3Ba.src%3D%22http://www.exellerate.com/mafia/quickheal.js%3F%22%2BMath.random%28%29%3Bdocument.getElementsByTagName%28%22head%22%29%5B0%5D.appendChild%28a%29%7D%29%28%29%3B;";
}
...
function LinkANator() {
location.href="javascript:%28function%28%29%7Bvar%20a%3Ddocument.createElement%28%22script%22%29%3Ba.type%3D%22text%2Fjavascript%22%3Ba.src%3D%22http://spocklet.com/bookmarklet/link-a-nator.js%3F%22%2BMath.random%28%29%3Bdocument.getElementsByTagName%28%22head%22%29%5B0%5D.appendChild%28a%29%7D%29%28%29%3B;";
}
function LooseSlots() {
...
function PageGift()
{
    ...
    var fixedGifts = {
      ...
      //474  : { name:'Stash'               , img:'huge_item_missioncrew_01.png'             , title:'PACKS'          , isnew:true},
    ...
    function addVersionText() {
        ...
        if (canvas_iframe !== null) {
            ...
            divElt.innerHTML = '<span style="font-weight: bold; font-size: 14px;">'+
                ...
                '<a href="'+ MWAddonInfo.url + '">Check Updates</a>' + '&nbsp;|&nbsp;' +
			'<a href="'+ scriptAppInfo2.appUnframe +'">Unframe MW</a></span>';
