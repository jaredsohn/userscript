        ...
        qx.Class.define("MaelstromTools.Language", {
          ...
          members: {
            ...
            loadData: function(language) {
              ...
              this.Data["Overall production"] = ["Глобальное производство"][l];
              this.Data["Army overview"] = ["Обзор армии"][l];
              this.Data["Base resources"] = ["Ресурсы базы"][l];
              this.Data["Main menu"] = ["Основное меню"][l];
              this.Data["Repair all units"] = ["Починить все юниты"][l];
              this.Data["Repair all buildings"] = ["Починить все здания"][l];
              this.Data["Base status overview"] = ["Обзор статистики базы"][l];
              this.Data["Upgrade priority overview"] = ["Обзор приороитетов улучшений"][l];
              this.Data["MaelstromTools Preferences"] = ["Настройки MaelstromTools"][l];
              this.Data["Options"] = ["Опции"][l];
              this.Data["Target out of range, no resource calculation possible"] = ["База вне досягаемости, нет возможности провести полдсчёт ресурсов."][l];
              this.Data["Lootable resources"] = ["Добыча"][l];
              this.Data["per CP"] = ["за ОД"][l];
              this.Data["2nd run"] = ["2-я атака"][l];
              this.Data["3rd run"] = ["3-я атака"][l];
              this.Data["Calculating resources..."] = ["Подсчитываем ресурсы..."][l];
              this.Data["Time to next MCV"] = ["Время до МСЦ"][l];
              this.Data["Show time to next MCV"] = ["Показать время до следующей МСЦ"][l];
              this.Data["Show lootable resources (restart required)"] = ["Показать ресурсы с добычи (требутеся рестарт)"][l];
              this.Data["Use dedicated Main Menu (restart required)"] = ["Показать выделенное главное меню (требуется рестарт)"][l];
              this.Data["Autocollect packages"] = ["Автосбор пакетов"][l];
              this.Data["Autorepair units"] = ["Автопочинка юнитов"][l];
              this.Data["Autorepair buildings"] = ["Автопочинка зданий"][l];
              this.Data["Automatic interval in minutes"] = ["Автоматический интервал в минутах"][l];
              this.Data["Apply changes"] = ["Применить"][l];
              this.Data["Discard changes"] = ["Отмена"][l];
              this.Data["Reset to default"] = ["Сбросить настройки"][l];
              this.Data["Continuous"] = ["Продолжительно"][l];
              this.Data["Bonus"] = ["Бонус"][l];
              this.Data["POI"] = ["POI"][l];
              this.Data["Total / h"] = ["Всего / ч"][l];
              this.Data["Repaircharges"] = ["Затраты на ремонт"][l];
              this.Data["Repairtime"] = ["Время на ремонт"][l];
              this.Data["Attacks"] = ["Нападения"][l];
              ...
              this.Data[MaelstromTools.Statics.Research] = ["Очки исследований"][l];
              ...
              this.Data["Units"] = ["Юниты"][l];
              this.Data["Hide Mission Tracker"] = ["Убрать трекер миссий"][l];
              this.Data["none"] = ["ничего"][l];
              this.Data["Cooldown"] = ["Перезарядка"][l];
              this.Data["Protection"] = ["Защита"][l];
              this.Data["Available weapon"] = ["Доступное оружие"][l];
              this.Data["Calibrated on"] = ["Наведено на"][l];
              this.Data["Total resources"] = ["Всего ресурсов"][l];
              this.Data["Max. storage"] = ["Макс, места на складе"][l];
              this.Data["Storage full!"] = ["Склад полон"][l];
              this.Data["Storage"] = ["Склад"][l];
              this.Data["display only top buildings"] = ["Показывать только лучшие здания"][l];
              this.Data["display only affordable buildings"] = [ "Показывать только доступные здания"][l];
              this.Data["City"] = ["Город"][l];
              this.Data["Type (coord)"] = ["Тип (коорд.)"][l];
              this.Data["to Level"] = ["до уровня"][l];
              this.Data["Gain/h"] = ["Прирост / ч"][l];
              this.Data["Factor"] = ["Фактор"][l];
              this.Data["Tib/gain"] = ["Тиб. / прирост"][l];
              this.Data["Pow/gain"] = ["Пит / прирост"][l];
              this.Data["ETA"] = ["Осталось времени"][l];
              this.Data["Upgrade"] = ["Улучшение"][l];
              this.Data["Powerplant"] = ["Электростарнция"][l];
              this.Data["Refinery"] = ["Обогатитель"][l];
              this.Data["Harvester"] = ["Харвестер"][l];
              this.Data["Silo"] = ["Хранилище"][l];
              this.Data["Accumulator"] = ["Аккумулятор"][l];
              this.Data["Calibrate support"] = ["Помощь наводки"][l];
              this.Data["Access"] = ["Доступ"][l];
              this.Data["Focus on"] = ["Сфокусироваться на"][l];
              this.Data["Possible attacks from this base (available CP)"] = ["Возможные атаки с этой базы (доступно ОД)"][l];
            //this.Data[""] = [""][l];
            },
