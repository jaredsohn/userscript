...
// 1 - Lesser Shield
// 2 - Lesser Armor
// 2 - Lesser Armor on Carve
// 5 - Lesser Shield on Carve
// 3 - Summon Skeleton
// 8 - Pray
// 9 - Healing Potion
...
document.location.href = "http://92.48.103.52/fantasy/game.php?screen=ADVANCEDCOMBAT";
    ...
    document.location.href = 'http://92.48.103.52/fantasy/game.php?var5=3873&var1=Lesser+Shield+Scroll&command=use&screen=SCROLLS';
}
  else if(k==53) {
    document.location.href = 'http://92.48.103.52/fantasy/game.php?var5=3398&var1=Lesser+Shield+Scroll&command=use&screen=SCROLLS';
  }
  else if(k==51) {
    document.location.href ='http://92.48.103.52/fantasy/game.php?var5=3873&var1=Summon+Skeleton&command=use&screen=SCROLLS';
  }
  else if(k==49) {
    document.location.href =
'http://92.48.103.52/fantasy/game.php?var5=3873&var1=Lesser+Focus+Scroll&command=use&screen=SCROLLS';
  }
 else if(k==54) {
    document.location.href =
