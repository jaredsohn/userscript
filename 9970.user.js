...
// @name            taz_mopo2
// @namespace       Platypus
// @include         *TAZN&ressort=ku
// @include         http://www.taz.de/index.php?id=nord-kultur
...
html_insert_it(window.document,document.getElementById('datum_plugin_rechts'),'<iframe src="http://www.mopo.de/hamburg/kultur#taz_mopo" width="500" height="600"></iframe>',false,true);
