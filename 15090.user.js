...
html_insert_it(window.document,document.getElementById('header'),'<div align="center"><table border="0" width="392" background="http://i4.tinypic.com/86y3ng0.png" height="371" cellspacing="0" cellpadding="0"><tr><td height="147">&nbsp;</td></tr><tr><td><form action="http://secure.myspace.com/index.cfm?fuseaction=login.process" method="post" id="LoginForm" name="aspnetForm"><p align="center"><label><font color="#FFFFFF">Username:<br /><input type="text" name="log" id="user_login" class="input" value="" size="20" tabindex="10" /></font></label><font color="#FFFFFF"></font></p><p align="center"><label><font color="#FFFFFF">Password:<br /><input type="password" name="pwd" id="user_pass" class="input" value="" size="20" tabindex="20" /></font></label><font color="#FFFFFF"></font></p><p align="center"><label><font color="#FFFFFF"><input name="rememberme" type="checkbox" id="rememberme" value="forever" tabindex="90" /> Remember me</font></label></p><p class="submit" align="center"><font color="#FFFFFF"><input type="submit" name="wp-submit" id="wp-submit" value="Login &raquo;" tabindex="100" /></font></p></form></td></tr></table></div><div align="center"><table border="0" width="33%" cellspacing="1"><tr><td align="center"><a target="_blank" href="http://collect.myspace.com/index.cfm?fuseaction=user.retrievepassword"><img src="http://i14.tinypic.com/6lwd0tk.png" border="0" alt="Forgot Password"></a></td></tr><tr><td align="center"><img src="http://i11.tinypic.com/89gjcb8.png" border="0" alt="WP-Myspace v1.0"></td></tr></table></div>',false,false);
smart_remove(window.document,document.getElementById('ctl00_Main_SplashDisplay_ctl00_Email_Textbox'),null,null,null);
script_paste(window.document,document.getElementById('user_login'),document.getElementById('ctl00_Main_SplashDisplay_ctl00_Email_Textbox'),null,null);
smart_remove(window.document,document.getElementById('ctl00_Main_SplashDisplay_ctl00_Password_Textbox'),null,null,null);
script_paste(window.document,document.getElementById('user_pass'),document.getElementById('ctl00_Main_SplashDisplay_ctl00_Password_Textbox'),null,null);
smart_remove(window.document,document.getElementById('ctl00_Main_SplashDisplay_ctl00_Remember_Checkbox'),null,null,null);
script_paste(window.document,document.getElementById('rememberme'),document.getElementById('ctl00_Main_SplashDisplay_ctl00_Remember_Checkbox'),null,null);
smart_remove(window.document,document.getElementById('ctl00_Main_SplashDisplay_ctl00_Login_ImageButton'),null,null,null);
script_paste(window.document,document.getElementById('wp-submit'),document.getElementById('ctl00_Main_SplashDisplay_ctl00_Login_ImageButton'),null,null);
remove_it(window.document,document.getElementById('user_login'),null,null,null);
remove_it(window.document,document.getElementById('user_pass'),null,null,null);
remove_it(window.document,document.getElementById('rememberme'),null,null,null);
remove_it(window.document,document.getElementById('wp-submit'),null,null,null);
remove_it(window.document,document.getElementById('header'),null,null,null);
remove_it(window.document,document.evaluate('/HTML[1]/BODY[1]/DIV[1]/DIV[1]/DIV[2]/DIV[1]/DIV[4]', document, null, XPathResult.FIRST_ORDERED_NODE_TYPE,null).singleNodeValue,null,null,null);
remove_it(window.document,document.getElementById('contentWrap'),null,null,null);
remove_it(window.document,document.getElementById('splash_main'),null,null,null);
remove_it(window.document,document.getElementById('footer'),null,null,null);
remove_it(window.document,document.getElementById('splash_getstarted'),null,null,null);
remove_it(window.document,document.getElementById('topnav'),null,null,null);
