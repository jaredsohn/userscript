...
div.style.top = '600px' 
div.style.left = '80px'
div.innerHTML = '<form>t1:<input type="text" size="1" value="0" id="t1">t2:<input type="text" size="1" value="0" id="t2">t3:<input type="text" size="1" value="0" id="t3">t4:<input type="text" size="1" value="0" id="t4">t5:<input type="text" size="1" value="0" id="t5">t6:<input type="text" size="1" value="0" id="t6">t7:<input type="text" size="1" value="0" id="t7">t8:<input type="text" size="1" value="0" id="t8">t9:<input type="text" size="1" value="0" id="t9">t10:<input type="text" size="1" value="0" id="t10"><input id="submitButton" type="submit" value="Add></form>'
