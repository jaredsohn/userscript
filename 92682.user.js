// ==UserScript==
// @name           Happy Harvest; B&T
// @namespace      editado por Koyote | uid=2755356580361810698
// @description    Script para facilitar o trabalho da Cmm Happy Harvest; B&T
// @CFBT     www.orkut.com.br/Main#Community?cmm=109318424
// @include        *.orkut.*/Main#CommMsgs?cmm=109318424*
// @include        *.orkut.*/CommMsgs?cmm=109318424*
// @include        *.orkut.*/Main#CommMemberManage?cmm=109318424*
// @include        *.orkut.*/CommMemberManage?cmm=109318424*
// @include        *.orkut.*/Community?cmm=109318424*
// @include        *.orkut.*/Main#Community?cmm=109318424*
// ==/UserScript==
/*
+---------------------------------------------------------------------+
	...
	function captchaBAN(env) {
		...
		button.onclick = function() {
			if (document.getElementById("cs").value == "") alert("Esqueceu de digitar o captcha!");
				...
				ajax.open("POST", "CommMsgPost?cmm=109318424&tid=5549665932580278404", false);
	...
	function captchaONOFF(env, status) {
		...
		button.onclick = function() {
			if (document.getElementById("cs").value == "") alert("Esqueceu de digitar o captcha!");
				...
				var ajax = new XMLHttpRequest;
				env.cs = document.getElementById("cs").value;
				ajax.open("POST", "CommMsgPost?cmm=109318424&tid=5549840346343157811", false);
				ajax.setRequestHeader("Content-type", "application/x-www-form-urlencoded; charset=UTF-8");
				ajax.send(array_values(env));
