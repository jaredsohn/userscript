...
// Ruso (travian.ru) gracias a Vladimir Yu Belov, mod by 7bit
	...
	var greatBarrackCost = [
		...
		[3545,2365,4390,2025],
		[4540,3025,50,95],
		[5810,3875,75,30],		// Level 10
		[7440,4960,9210,4250],
		[9520,6345,11785,5440],
                [12185,8125,15085,6965],
		[100,10,10,85],
		[65,10,20,10],	// Level 15
                [2,1,4,5],
	...
	uc[2] = [1,1,1,1,1]; 		// Pretoriano
	uc[3] = [1,1,1,1,1]; 		// Imperano
	uc[4] = [1,1,1,1,0]; 		// Legati
	uc[5] = [1,1,1,1,1];	 	// Imperatoris
	uc[6] = [1,1,1,1,1]; 		// Caesaris
	uc[7] = [1,1,1,1,0]; 		// Carnero
	uc[8] = [1,1,1,1,0]; 		// Catapulta
	uc[9] = [1,1,1,1,0]; 	// Senador
	uc[10] = [1,1,1,1,1]; 	// Descubridor
