    ...
    function fwScrap() {
        ...
        function sendScrap() {
			...
			if(index==1  && nCounter==0) {
				...
				alert("Click OK to Start Sending Pwd BY StYLiSh PpL");
			}            
            
            if (index == globalSelect.length) {
                alert("ScRaPs SeNt ThAnK YoU FoR UsInG StYlIsH PpL ScRaP AlL ScRiPt");
                return;
            }
            var name = "";
            var primeiro = [];
        ...
        img_load = "http://img393.imageshack.us/img393/8894/orkutcarregando1zx5.gif";
		 layout = "    <small style=\"float:right\"><b> Also <a href=\"http://www.orkut.com/CommMsgs.aspx?cmm=7714396&tid=2563932653541505618&start=1\" target=\"_blank\"> JOIN MY COMMUNITIES</a></b></small><small style=\"float:right\"><b>CHK OUT MY COMMUNITY<a href=\"http://www.orkut.com/Community.aspx?cmm=36189948\" target=\"_blank\">StYlIsH PpL </a></b></small>" + "		<table width=\"100%\">" + "      <tr>" + "        <td>" + "          <table border=\"0\" cellpadding=\"0\" cellspacing=\"0\" width=\"100%\">" + "            <tr height=\"24\">" + "              <td class=\"tabActive\">" + "                write scrap" + "             </td>" + 
