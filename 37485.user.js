...
// @name           Borrar hilos
// @namespace      -
// @include        http://board.ogame.com.es/thread.php?threadid=*
// ==/UserScript==
...
if(estenombre.innerHTML.indexOf('lastpost')==-1&&estenombre.innerHTML.indexOf('firstnew')==-1&&estenombre.innerHTML.indexOf('page=')==-1)
	{	
		...
		enlace.innerHTML="<img alt='Reportar firma ilegal' border='0' src='http://img84.imageshack.us/img84/5005/nocb9.png'/>";
