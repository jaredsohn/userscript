...
// @description   Automatically log into the Ohio State RESNET Internet. You must save your username and password with firefox.
// @include       https://norcas*.resnet.ohio-state.edu/auth/*
// @exclude       http://*
// ==/UserScript==
...
{
	if (div[i].innerHTML == "\n      Please provide your OSU name.# and password to access ResNet.\n    ")
	{
...
if (font[0] && font[0].innerHTML == "Logon Successful!")
{
