...
// @namespace     ***NOT MINE CHANGED TO INCLUDE NEW FRIEND UPDATE ONLY NOT MINE***Seifer - original: http://userscripts.org/users/33118
// @description   ***NOT MINE CHANGED TO INCLUDE NEW FRIEND UPDATE ONLY NOT MINE*** Customize your homepage to exactly the way you want it. WORKS WITH InsaneNinja's Home Skin Switchup! Author: Seifer.
...
if ($('col3')) // Check that we're using the new skin
	...
	piece['Q'] = $('addressbook');
	piece['R'] = $('ctl00_cpMain_MarketingBox_Skin_userHomeTabs_userHomeTabs');
	piece['X'] = $('aSignUpOrOut');
	piece['Z'] = $('header');
	//	========================
...
// Old variables for the old update notification script.
	script_version=1.23;
	script_updatetext='Now works with "MySpace - Home Skin Switchup" You will loose some functionality with this update but if you install the "Home Skin Switchup" by InsaneNinja and use it at the same time you will get it all back!';
...
// === Edit the next four lines to suit your script. ===
	...
	scriptId='14950';
	scriptVersion=1.2;
	scriptUpdateText='Now works with "MySpace - Home Skin Switchup" You will loose some functionality with this update but if you install the "Home Skin Switchup" by InsaneNinja and use it at the same time you will get it all back! ***If the last update broke your homepage or if you keep getting this update alert. Go to the script homepage to find how to fix it.';
// === Stop editing here. ===
