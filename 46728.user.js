// ==UserScript==
// @name    Facebook Zoo Builder Auto Visit
// @namespace   Zoobuilder
// @description   This script will pick a random zoo from the Visit Zoos (request) screen and send them visitors. It will continually repeat itself.
...
(function()
{
	...
	else if (location.href.indexOf("players.php")>0)
	{
		...
		try
		{		
			unsafeWindow.a36533109268_giveYoung(id);
		}
		catch (e)
		{
