// ==UserScript==
// @name          Fumbbl Spectate Links
// @namespace     das_fumbblhelper
// @description   Adds spectate links to players and teams throughout the fumbbl site. (v1.21)
// @include       http://fumbbl.com/*
// ==/UserScript==

/*
 * Fumbbl Spectate Links v1.21
 * Copyright (c) David Ashley-Smith, 2008.
 *
...
//					GM_log('score: '+current_matchdata.score.toSource());
					...
					//else GM_log('nodata. assuming group header');
