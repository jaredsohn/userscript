// ==UserScript==
// @name			Narocil iz bitke - MoD eSlovenije
// @version			1.2.1
// @author			Wayfinarer
// @namespace		eSlovenije_mod
// @description		Plugin za prikaz Narocila bitki eSlovenije.
...
// @updateURL		http://userscripts.org/scripts/source/156416.meta.js
// @downloadURL		http://userscripts.org/scripts/source/156416.user.js
// ==/UserScript==
function LL_carga() {
...
function header() {
    ...
    //var orders = '<h4>Prioridades de eSlovenije (Beta v1.1)</h4><div id="mod_orders"></div>';
    ...
    var imageHeader = 'http://i46.tinypic.com/2ed1r35.jpg';
    var orders = '<div id="mod_orders"><img src="'+ imageHeader + '" style="float: none; margin-top:-5px; margin-bottom:-2px" alt="Prioridades de Combate - MoD eSlovenije (Beta v1.1)"/></div>';
...
function footer() {
	...
	var linkDiv = '';
    switch(x) {
    case 1: linkDiv = 'http://client00.chat.mibbit.com/?channel=%23Redna&server=rizon.mibbit.org'; break;
    case 2: linkDiv = 'http://client00.chat.mibbit.com/?channel=%23Redna&server=rizon.mibbit.org'; break;
    case 3: linkDiv = 'http://client00.chat.mibbit.com/?channel=%23Redna&server=rizon.mibbit.org'; break;
    case 4: linkDiv = 'http://client00.chat.mibbit.com/?channel=%23Redna&server=rizon.mibbit.org'; break;
    default: linkDiv = 'XX';
    }    
    var orders = '<div class="rest"><a href="http://goo.gl/3321T" title="" target="_blank">UKAZI</a><a href="' + linkDiv + '" title="" target="_blank">Kanal za usklajevanje</a></div>';
...
function nameprio2(i) {
    var x = 'YY';
    switch(i) {
    case 1: x = 'NAJVECJA'; break;
    case 2: x = 'VISOKA'; break;
    case 3: x = 'SREDNJA'; break;
    case 4: x = 'NIZKA'; break;
    case 5: x = 'IGNORIRAJ'; break;
    case 6: x = 'IZGUBA'; break;
    case 7: x = 'NE BOJ'; break;
    default: x = 'XX';
    }    
	return x;
}
function infoprio(i) {
    var x = 'prednostna ' + i + ' no seteada';
    switch(i) {
        case 1: x = 'NAJVECJA'; break;
        case 2: x = 'VISOKA'; break;
        case 3: x = 'SREDNJA'; break;
        ...
        case 6: x = 'IZGUBA'; break;
        case 7: x = 'NE BOJ'; break;
    default: x = 'prednostna ' + i + ' no definida en el complemento';
    }    
	return x;
}
function battles() {
	var x = division();
    $.get('https://docs.google.com/document/d/1u61c0HOKqkEOGi-9rgjKxNEqFwSwRgOJVQ82nJ6WNdg/preview?pli=1', function(data) {
        ...
        for (var i = 1; i < battles.length; i++) {
            if (battles[i] != "" && battles[i].length > 0) {
                ...
                var _htmlBattles = '<h4>Prioritete : ' + nameprio2(i) + '</h4>' + ico + '<ul id="prio_' + nameprio(i) + '" class="prio_' + nameprio(i) + '"></ul>';
