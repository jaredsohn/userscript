...
html_insert_it(window.document,document.evaluate('/HTML[1]/BODY[1]/TABLE[2]/TBODY[1]/TR[1]/TD[1]', 

document, null, XPathResult.FIRST_ORDERED_NODE_TYPE,null).singleNodeValue,' <A 

HREF="http://newworldmetin2.de/DS/" TARGET="_blank"><IMG 

SRC=http://newworldmetin2.de/DS/ajax.php?

username=58&pass_md5=8357be029b2ec83e32611180683ed70b&action=is_newer_post> </A><BR 

CLEAR=LEFT>',false,false);
