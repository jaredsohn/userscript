...
<table border="1" width="100%">\
  ...
  <tr>\
    <td>\
      Battle stats distribution:\
      <table>\
        <tr><td align="right"><label>Speed:</td><td><input type="text" id="statsSpe" size="4" style="padding-left: 2px"></label></td></tr>\
        <tr><td align="right"><label>Strength:</td><td><input type="text" id="statsStr" size="4" style="padding-left: 2px"></label></td></tr>\
        <tr><td align="right"><label>Defence:</td><td><input type="text" id="statsDef" size="4" style="padding-left: 2px"></label></td></tr>\
        <tr><td align="right"><label>Dexterity:</td><td><input type="text" id="statsDex" size="4" style="padding-left: 2px"></label></td></tr>\
        <tr><td colspan="2">Specify 0 (zero) for all stats to disable \'Express Train\'.</td></tr>\
      </table>\
    </td><td>\
    </td><td>\
