// ==UserScript==
// @name          Calcul du temps de déplacement
// @namespace     http://
// @description	  Calcul du temps de déplacement pour les attaques les Blocus le transport des marchandises et des troupes 
