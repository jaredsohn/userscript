// ==UserScript==
// @name           	דוקטור צחוק מציג : איקרים בודק עלוקות
// @namespace      	http://ikariamlibrary.com/
// @description    	בודק עלוקות. עלוקות הם אלה שחוצבים ולא תורמים.
// @version		0.1
// @author		דוקטור צחוק
...
function getLeecherInfo(page)
{
	...
	var info =  + "%</b> <br/>" + percentage*100 + "ערים באי .זה אומר שעל כל אחד לתרום<b>" + cities + "ישנם "
	...
	{		
		...
		div.innerHTML = 
			"<div id='leecher_checker' class='contentBox'>"+
				"<h3 class='header'><span class='textLabel'>דוקטור צחוק אומר: אתה עלוקה!!!! (או אולי לא, אז בוא נראה)</span></h3>"+
				"<div class='content'>"+
					"<table>"+
						"<tr>"+
							"<td colspan='3'>"+
						...
						"</tr>"+
						"<tr>"+
							"<td style='color: green;'><center>אתה תורם לעילא, ירבו כמותך באי</center></td>"+
							"<td style='color: orange;'><center>אתה ככה ככה - אולי קמצנצ'יק?</center></td>"+
							"<td style='color: red;'><center> אתה חצי פרסי חצי תימני. </center></td>"+
						"</tr>"+
					"</table>"+
				"</div>"+
			"</div>";
