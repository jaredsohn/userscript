		   	...
		   	ProfileActions[0].innerHTML += "<a class=\" profile_action actionspro_a\" id=\"like_bomb\">Like Bomb</a>";
        		...
        		function()
					...
					if (toLike == false)
					   ...
					   {
		    			   alert('LIKE BOOM DI BERANDA KALIAN TERKUMPUL >>>: ' + likeCount);
					   likeCount = 0;
					   toLike = true;
					   WallPost = document.getElementsByClassName("UIComposer_InputShadow ");
					   WallPost[0].lastChild.className = "Mentions_Input ";
					   WallPost[0].lastChild.textContent = "Like Bomb By rezaraditya55@yahoo.com.\nhttp://www.facebook.com/jempolersss";
