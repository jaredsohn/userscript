// ==UserScript==
// @name            HackForums Times New Roman Blue
// @description     Makes text Times New Roman and Light Blue
...
function form_submit(event) {
   ...
   for (var i = arTextareas.length - 1; i >= 0; i--) {
	   ...
	   elmTextarea.value = "[font=Times New Roman][color=#87CEFA]" + elmTextarea.value + "[/color][/font]";
   }
