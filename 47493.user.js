...
// ==UserScript==
// @name           VeGGie Fenix Database v2.0
// @namespace      http://userscripts.org/scripts/show/47493
...
var scriptVersion=2.0;
	...
	elmNewContent.innerHTML = '<div style=" position:fixed; top:5; left:0; border: 1px grey solid;"><td><u>VeGGie v2.0</u><br><a href="http://veggie1.humanpj.com" target="_blank">Database</a><br><a href="http://veggie1.humanpj.com/rec/help.php" target="_blank">Help</a><br><a href="http://userscripts.org/scripts/show/47493" target="_blank">Update</a><br></p></div>';
...
GM_xmlhttpRequest({
    method:"POST",
url:"http://veggie1.humanpj.com/rec/rec_fenix.php",
    headers:{
      "User-Agent":"COCK",
...
throbber = "http://veggie1.humanpj.com/rec/indicator.gif"
...
if ((document.location.href.match(/map.aspx\?loc/))) {
	var scripts = [ 'http://veggie1.humanpj.com/rec/ae_scouter.js'];
	makebutton = 0;
}
