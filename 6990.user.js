...
(function() 
{
	...
	function makeBlockbusterLink(movieName)
	{
		if (movieName != null && movieName.length > 0)
		{
			...
			newLink.setAttribute("href", "http://www.blockbuster.com/online/search/PerformKeyWordSearchAction?channel=Movies&subChannel=sub&keyword=" + movieName);
