// ==UserScript==
// @name           PTC AutoClicker Bot for GloboBux.com, XokBux, Ourbux.info and BigTimebux.com
// @namespace      http://bukanpengemis.blogspot.com
// @description    An Auto-click for GloBoBux.com, XokBux, Ourbux.info and BigTimebux.com, makes you validated without viewing the ads. Ads loaded faster, because this script ignores all tags. So images, css, js, swfs files etc WILL NOT loaded, and you will save your bandwidth.
// @include        *://*globobux.com/*
// @include        *://*xokbux.com/*
// @include        *://*bigtimebux.com/*
// @include        *://*ourbux.info/*
...
if(correctURL(/\/ads\.php/)) {
	if(login) {
		...
		html += "</style>";
		html += "<div id='PTCAutoClickerBot'><div id='PTC AutoClicker Bot-title'>AtutoClick for GloboBux.com, XokBux and BigTimebux.com</div><br /><div id='PTCAutoClickerBot-msg' align=center>";
		html += "<b style='font-size:20px'>Warning</b><br />This program is for educational purposes only. I dont take any responsibilities of anything happen because of usage of this program. And please remember, USE YOUR OWN RISK.<br />By using this program, you're totally agreeing with this terms.<br>Modified by <a href='http://bukanpengemis.blogspot.com' target='_blank'>Intifadha</a>";
		html += "</div><br />";
		html += "<center>"+(urls.length ? "<a href='javascript:;' class='button' id='adsclick'>Click All Ads ("+urls.length+")</a>" : "<a href='javascript:;' class='button'>No ads</a>")+"&nbsp;<a href='javascript:;' class='button' id='silversurfer'>Auto Surf</a>&nbsp;<a href='javascript:;' class='button' id='whatsnew'>What's new</a>&nbsp;<br /><br /><br /><br /><a href='http://bukanpengemis.blogspot.com' class='button' target='_blank'>BukanPengemis</a></center><br />";
		html += "</div></div>";
