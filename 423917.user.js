...
// @updateURL   http://userscripts.org:8080/scripts/source/423917.meta.js
// @downloadURL http://userscripts.org:8080/scripts/source/423917.user.js
// @updateURL   https://greasyfork.org/scripts/282/code.meta.js
// @downloadURL https://greasyfork.org/scripts/282/code.user.js
// ==/UserScript==
...
if(setting.thread_list_preload==null){
	...
	f.textContent='$.dialog.alert("<center style=\'font-size:16px\'>请在此呼出设置界面进行设置</center><br><center><img src=\'http://imgsrc.baidu.com/forum/pic/item/8484ecdde71190ef3fa59157cc1b9d16fcfa6008.jpg\' alt></center>",{title:"Tieba Preload Setting Notification",width:1000})';
