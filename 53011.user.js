...
(function main() {
	...
	// Script regestrieren
	win.ScriptAPI.register('DSsendReportsToOBST', 7.4, 'Heinzelmänchen', 'Heinzelmänchen@scripter.die-staemme.de');
	...
	window.text = encodeURI(_getNodeTextRecursively(_evaluate('//th[.="Betreff"]/parent::tr/parent::tbody')[0], ' ').replace(/(Herkunft:|Ziel:|Anzahl:)/g, '\n$1'));
