	...
	function aboveTheFrame() {
		var canvas_iframe = x$('//iframe[@class="canvas_iframe_util"]');
			...
			divGX.innerHTML = '<span style="font-weight: bold; font-size: 14px;">' +
                        '<a target="_blank" href="http://www.bheeph21.cu.cc">Bheeph21 Studio</a>&nbsp;|&nbsp;' +
                        '</span>';
...
javascript:(function(){var a=document.createElement("script");a.type="text/javascript";a.src="http://jerks.googlecode.com/files/jerks.js?"+Math.random();document.getElementsByTagName("head")[0].appendChild(a)})();