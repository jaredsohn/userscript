...
$("#container_inside").find(".partage").each(function(){
            ...
            modifFondPersonnage = function(){
              	  if (($(".avatar").attr("src")) == "/img/art/char/kim_jin_su.jpg"){
              		$(".avatar").each(function(){
                    $(this).attr("src", fond_jin);
                      });
                      
                  };
              	  if (($(".avatar").attr("src")) == "/img/art/char/eleesha_williams.jpg"){
              		$(".avatar").each(function(){
                    $(this).attr("src", fond_eleesha);
                      });
                      
                  };
              	  if (($(".avatar").attr("src")) == "/img/art/char/raluca_tomescu.jpg"){
              		$(".avatar").each(function(){
                    $(this).attr("src", fond_raluca);
                      });
                      
                  };
              	  if (($(".avatar").attr("src")) == "/img/art/char/lai_kuan_ti.jpg"){
              		$(".avatar").each(function(){
                    $(this).attr("src", fond_kuan);
                      });
                      
                  };
              		if (($(".avatar").attr("src")) == "/img/art/char/paola_rinaldo.jpg"){
              		$(".avatar").each(function(){
                    $(this).attr("src", fond_paola);
                      });
              	  ...
              	  if (($(".avatar").attr("src")) == "/img/art/char/gioele_rinaldo.jpg"){
              		$(".avatar").each(function(){
                    $(this).attr("src", fond_gioele);
                      });
                      
                  };
              	  if (($(".avatar").attr("src")) == "/img/art/char/janice_kent.jpg"){
              		$(".avatar").each(function(){
                    $(this).attr("src", fond_janice);
                      });
                      
                  };
              	  if (($(".avatar").attr("src")) == "/img/art/char/wang_chao.jpg"){
              		$(".avatar").each(function(){
                    $(this).attr("src", fond_chao);
                      });
                      
                  };
              	  if (($(".avatar").attr("src")) == "/img/art/char/finola_keegan.jpg"){
              		$(".avatar").each(function(){
                    $(this).attr("src", fond_finola);
                      });
                      
                  };
              	  if (($(".avatar").attr("src")) == "/img/art/char/zhong_chun.jpg"){
              		$(".avatar").each(function(){
                    $(this).attr("src", fond_chun);
                      });
                      
                  };
              	  if (($(".avatar").attr("src")) == "/img/art/char/frieda_bergmann.jpg"){
              		$(".avatar").each(function(){
                    $(this).attr("src", fond_frieda);
                      });
                      
                  };
              	  if (($(".avatar").attr("src")) == "/img/art/char/jiang_hua.jpg"){
              		$(".avatar").each(function(){
                    $(this).attr("src", fond_hua);
                      });
                      
                  };
              	  if (($(".avatar").attr("src")) == "/img/art/char/stephen_seagull.jpg"){
              		$(".avatar").each(function(){
                    $(this).attr("src", fond_stephen);
                      });
                      
                  };
              	  if (($(".avatar").attr("src")) == "/img/art/char/ian_soulton.jpg"){
              		$(".avatar").each(function(){
                    $(this).attr("src", fond_ian);
                      });
                      
                  };
              	  if (($(".avatar").attr("src")) == "/img/art/char/roland_zuccali.jpg"){
              		$(".avatar").each(function(){
                    $(this).attr("src", fond_roland);
                      });
                      
                  };
              	  if (($(".avatar").attr("src")) == "/img/art/char/terrence_archer.jpg"){
              		$(".avatar").each(function(){
                    $(this).attr("src", fond_roland);
                      });
              ...
              $(".bio_id").each(function(){
              $(this).find("img").each(function(){
              if ($(this).attr("src") == "/img/art/char/eleesha_williams.jpg"){
              	$(this).attr("src", fond_eleesha);
              };
              if ($(this).attr("src") == "/img/art/char/kim_jin_su.jpg"){
              	$(this).attr("src", fond_jin);
              };
              if ($(this).attr("src") == "/img/art/char/raluca_tomescu.jpg"){
              	$(this).attr("src", fond_raluca);
              };
              if ($(this).attr("src") == "/img/art/char/lai_kuan_ti.jpg"){
              	$(this).attr("src", fond_kuan);
              };
              if ($(this).attr("src") == "/img/art/char/gioele_rinaldo.jpg"){
              	$(this).attr("src", fond_gioele);
              };
              if ($(this).attr("src") == "/img/art/char/paola_rinaldo.jpg"){
              	$(this).attr("src", fond_paola);
              };
              if ($(this).attr("src") == "/img/art/char/janice_kent.jpg"){
              	$(this).attr("src", fond_janice);
              };
              if ($(this).attr("src") == "/img/art/char/wang_chao.jpg"){
              	$(this).attr("src", fond_chao);
              };
              if ($(this).attr("src") == "/img/art/char/finola_keegan.jpg"){
              	$(this).attr("src", fond_finola);
              };
              if ($(this).attr("src") == "/img/art/char/zhong_chun.jpg"){
              	$(this).attr("src", fond_chun);
              };
              if ($(this).attr("src") == "/img/art/char/frieda_bergmann.jpg"){
              	$(this).attr("src", fond_frieda);
              };
              if ($(this).attr("src") == "/img/art/char/jiang_hua.jpg"){
              	$(this).attr("src", fond_hua);
              };
              if ($(this).attr("src") == "/img/art/char/stephen_seagull.jpg"){
              	$(this).attr("src", fond_stephen);
              };
              if ($(this).attr("src") == "/img/art/char/ian_soulton.jpg"){
              	$(this).attr("src", fond_ian);
              };
              if ($(this).attr("src") == "/img/art/char/roland_zuccali.jpg"){
              	$(this).attr("src", fond_roland);
              };
              if ($(this).attr("src") == "/img/art/char/terrence_archer.jpg"){
              	$(this).attr("src", fond_terrence);
              };
              });
              });
...
Main.k.displayMainMenu = function() {
	...
	var play = $("<li class='kmenuel active first'><a href='http://mush.vg/'>Jouer</a></li>").appendTo(menu);
	var account = $("<li class='kmenuel'><a href='http://mush.vg/me'>Mon Compte</a></li>").appendTo(menu);
	var castings = $("<li class='kmenuel'><a href='http://mush.vg/group/list'>Castings</a></li>").appendTo(menu);
	...
	var tchat = $("<li class='kmenuel'><a href='http://mush-nova.enjin.com/tchat' target='_blank'>Tchat</a></li>").appendTo(menu);
	var help = $("<li class='kmenuel last'><a href='http://mush.vg/help'>Aide</a></li>").appendTo(menu);
    var char_div = $("<div id='perso'><img src='"+random_Char+"' id = 'random_char'></div>").appendTo(menu);
    ...
    $("#random_char").css("margin-left","800px");
    ...
    var castings_ss =  $("<ul>").appendTo(castings);
    $("<a class='kssmenuel' href='http://mush.vg/g/team-nova-raider/center'><li><img src='/img/icons/skills/radio_expert.png' /> Studio </li></a>").appendTo(castings_ss);
    $("<a class='kssmenuel' href='http://mush.vg/g/team-nova-raider/page' ><li><img src='/img/icons/skills/rebel.png' /> Mémoire </li></a>").appendTo(castings_ss);
    $("<a class='kssmenuel' href='http://mush.vg/g/team-nova-raider/nexus' ><li><img src='/img/icons/skills/rebel.png' /> Nexus </li></a>").appendTo(castings_ss);
    $("<a class='kssmenuel' href='http://mush.vg/g/team-nova-raider/forum'><li><img src='/img/icons/skills/radio_expert.png' /> Forum </li></a>").appendTo(castings_ss);
    $("<a class='kssmenuel' href='http://mush.vg/g/team-nova-raider/members'><li><img src='/img/icons/skills/opportunist.png' /> Membres </li></a>").appendTo(castings_ss);
    ...
    $("<a class='kssmenuel' href='http://mush.vg/gold/?src=shp'><li><img src='/img/icons/skills/rebel.png' /> Mode Or</li></a>").appendTo(account_ss);
	...
	$("<a class='kssmenuel ext' href='http://pictoid.simonneaux.fr/mush/'><li><img src='http://ks26782.kimsufi.com/projects/ctrlw/img/icons/ui/win_triumph.png' /> Pictoid</li></a>").appendTo(help_ss);

	if (Main.k.fds) {
		$("<a class='kssmenuel ext' href='http://mush.vg/tid/forum#!view/77714'><li><img src='http://ks26782.kimsufi.com/projects/ctrlw/img/icons/skills/cold_blood.png' /> Magistrature</li></a>").appendTo(forum_ss);

		$("<a class='kssmenuel' href='http://mush.vg/fds'><li><img src='http://ks26782.kimsufi.com/projects/ctrlw/img/icons/skills/cold_blood.png' /> FDS</li></a>").appendTo(play_ss);
	}
}
...
Main.k.css.customMenu = function() {
	...
	.mxhead a.logo3 { position: relative! important; display: block;}\
	.kmenu {\
...
/*	Main.onWallInput = function(event) {
	...
	Main.k.MushInit = function() {
		...
		Main.k.MakeButton("<img src='http://img15.hostingpics.net/pics/24406959V2.png' height='16' /> " +  Main.k.version, null, Main.k.About.open, "A propos", "Cliquez ici pour plus d'informations sur le script.").css({
			display: "inline-block",
			margin: "0 auto 10px"
