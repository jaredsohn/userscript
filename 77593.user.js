// ==UserScript==
// @name	  NPCC Library Lookup
// @namespace	  http://youseemore.com/npcc/
// @description	  Search the NPCC Library Catalog from Amazon book listings.
// @include	  http://*.amazon.*

// Modified by Brenda Van Dusen, May 25, 2010
// ==UserScript==
...
function() {
  var libraryUrlPattern = 'http://libpac.npcc.edu/?config=ysm#section=search&term=isbn:';  // The mimium search string for the Library
  var libraryName = 'NPCC Library';	// what to Call the Library?
