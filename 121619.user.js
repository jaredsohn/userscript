// ==UserScript==
// @name			Facebook Chat Emoticons Bar (+Memes)
// @description	    Adds an emoticon + memes bar to Facebook chat
...
// @namespace		http://userscripts.org/scripts/show/121619
// ==/UserScript==
//
...
/* START: This part of the code was written (partialy) by Vaughan Chandler for FFixer, special thanks to him :) */
	...
	function handleUpdateResponse(r) {
		...
		if (r.responseText.match(/@versionnumber\s+(\d+\.\d+)/)[1] > version) {
			if(confirm("There's an update available for 'Facebook Chat Emoticons + Memes Bar'.\nDo you wish to install it?")) openInTab('http://userscripts.org/scripts/source/121619.user.js');
		}
	}
