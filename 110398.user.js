// ==UserScript==
// @name           GLB Player Builder v4/updated for Accelerated Building by chefsjg71
// @namespace      monsterkill
// @description    simulate a player's build for the accelerated building/modified version of 
//                 monsterkill's GLB Player Builder v3
    ...
    GM_xmlhttpRequest({
        ...
        onload: function(responseDetails) {
			...
			if (result2!=null && result2.length>1) {
				log('boost count = '+result2[1]);
				setBoostCount(result2[1]);
			} else {
