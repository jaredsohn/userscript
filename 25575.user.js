...
if (mainmatch){
        ...
        if (boldsans.snapshotLength) {
               if (isbn)  {
                       ...
                       GM_xmlhttpRequest( { 
                               method:"POST", 
        url: 'http://proteus.pct.edu/uhtbin/cgisirsi/X/0/0/123?searchdata1=' + isbn + '&srchfield1=GENERAL^SUBJECT^GENERAL^^words or phrase',
                               data:'',
                               onload:function(responseDetails) {
                                      ...
                                      table_content = table_content + "<TR style='background-color:#ddddff; padding:4px; font-weight:bold;'><TD colspan=2><a style='color:#000000;' href=' 'http://proteus.pct.edu/uhtbin/cgisirsi/X/0/0/123?searchdata1=" + isbn + " &srchfield1=GENERAL^SUBJECT^GENERAL^^words or phrase'>Click here to visit Madigan Library Catalog</a></td></tr.";
