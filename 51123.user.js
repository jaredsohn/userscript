// mod by Michael Kuzmin http://kuzmin.ca
// http://userscripts.org/scripts/show/51123
// Auto-login v0.7.1
...
// --------------------------------------------------------------------
// ==UserScript==
// @name          YorkU AutoLogin
// @namespace     http://labs.beffa.org/greasemonkey/
// @description   Auto-login for a variety of York University websites
// @include     *yorku.ca/login.pl*
// @include     *yorku.ca/moodle/login/*
// @include     *yorku.ca/login.html*
// @include     *yorku.ca/QuickPlace/*Login*
// @include     *passportyork.yorku.ca/ppylogin*
// ==/UserScript==
