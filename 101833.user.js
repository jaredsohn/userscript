...
const VERSIONfunctionFile = "1.0.12";
...
function produktPic(product,append){
	var prodNum = isNaN(parseInt(product,10))?prodId[product]:parseInt(product,10);
	var newdiv = createElement("div",{"prod":prodNum,"style":"display:inline-block;margin-right:3px;border:none;vertical-align:bottom;"});
	if (prodNum>0) newdiv.setAttribute("class","kp"+prodNum);
	else createElement("img",{"src":GFX+"menu/coins.gif","style":"height:15px;width:15px;border:none;top:0px;vertical-align:bottom;"},newdiv);
...
function coinsFormat(number,append){
	...
	var newdiv1 = produktPic(0,newdiv);
...
const GAMEPAGES = {"au":"au.myfreefarm.com","bu":"veselaferma.com","de":"myfreefarm.de","dk":"myfreefarm.dk","es":"migranjalinda.es","fr":"mabelleferme.fr","ro":"fermavesela.ro","gr":"myfreefarm.gr","hu":"enkicsitanyam.hu","it":"myfreefarm.it","nl":"myfreefarm.nl","nz":"myfreefarm.co.nz","pl":"wolnifarmerzy.pl","ru":"mojaderewnja.ru","se":"myfreefarm.se","tr":"tr.myfreefarm.com","uk":"myfreefarm.co.uk","us":"myfreefarm.com"};
