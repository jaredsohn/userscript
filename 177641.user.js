...
function letsJQuery()
{
    $(document).ready(function () {
        ...
        var transferBaiduData = function(id,lng,lat,status){
            ...
            if(n_lng == '123' || n_lat == '41' || n_lat == '42'|| n_lat == '0' || n_lat == '0'){
        ...
        function getLocalData(){
            $.getJSON("http://10.207.0.240/jsapi.php?type=getshop&city=shenyang&callback=?",function(data){
                    var data = eval(data);
