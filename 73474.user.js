...
// @description    Adds the Waze map control 
// @include        http://foursquare.com/venue/*
// @version        1.0
// ==/UserScript==


var text = document.getElementsByTagName('body')[0].innerHTML;
var regex = /point\ =\ new\ GLatLng\((\-?\d+\.\d+),\ (\-?\d+\.\d+)\)/ig;
var match = regex.exec(text);
var lat = match[1];
var lon = match[2];

var data = 'var lat = ' + lat + '; var lon = ' + lon + '; ';
...
newDiv.id = "map";
newDiv.style.width = "495px";
newDiv.style.height = "201px";
newDiv.style.marginBottom = "24px";
document.getElementById('mapContainer').insertBefore(newDiv, document.getElementById('vmap'));
