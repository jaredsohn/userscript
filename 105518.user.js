...
// @description     Script for The-West: Duel Page [SOM - Scripts-O-Maniacs]- Adds infos in the Duel Search Window & Saloons. 
// @author          Dun [SOM - Scripts-O-Maniacs]
// @release         Zyphir Randrott
// @website         http://scripts-o-maniacs.leforum.eu
// @include         http://*.the-west.*/game.php*
// @include         http://userscripts.org/scripts/source/105518.meta.js*
// @include         http://userscripts.org/scripts/review/105518*
// @version         1.0.7
//
...
var dp_lang = {
	XP: 'XP',
	YOURDUELLVL: 'Your duelling level',
	REFRESHDUELLVL: 'Refresh the duelling level',
};
var dp_langs = {};
dp_langs.fr = {
	XP: 'XP',
