// ==UserScript==
// @name           Power Tools - By Taz
// @namespace      noobs
// @include        http://*.kingdomsofcamelot.com/*main_src.php*
// @include        http://*.kingdomsofcamelot.com/*main_src.php*
// @include	   http://static1.grsites.com/archive/sounds/bells/bells004.wav
// @description    Enhancements and bug fixes for Kingdoms of Camelot
// @require        http://sizzlemctwizzle.com/updater.php?id=98075
// ==/UserScript==

var Version = '20110221a';
var Title = 'Taz Power Tools Modified by Taz';
...
var URL_CASTLE_BUT = 'http://img10.imageshack.us/i/mplzr.png/';
var URL_CASTLE_BUT_SEL = 'http://img62.imageshack.us/img62/2706/xwr4b.png';
var URL_PROVINCE_MAP = 'http://img838.imageshack.us/img838/1417/ve48b.png';
...
//logit ('g_timeoff: '+ unsafeWindow.g_timeoff);
  ...
  var styles = '.xtab {padding-right: 5px; border:none; background:none; white-space:nowrap;}\
    ...
    .castleButNon {background-image:url("http://img10.imageshack.us/img10/5031/mplzr.png")}\
    .castleButSel {background-image:url("http://img62.imageshack.us/img62/2706/xwr4b.png")}\
...
//logit ( 'Options.ptWinPos: '+ inspect (Options.ptWinPos, 5, 1)); 
  ...
  mainPop = new CPopup ('ptmain', Options.ptWinPos.x, Options.ptWinPos.y, 880,700, Options.ptWinDrag, 
      function (){
        tabManager.hideTab();
  ...
  AddMainTabLink('The Force', eventHideShow, mouseMainTab);
}
...
//**********************************
      ...
      str += _row ('Tr ST', t_rows[2]);
      str += _row ('Militia', rows[2]);
      str += _row ('Tr MM', t_rows[4]);
      str += _row ('Scout', rows[3]);
      str += _row ('Tr SC', t_rows[6]);
      str += _row ('Pike', rows[4]);
      str += _row ('Tr PK', t_rows[8]);
      str += _row ('Sword', rows[5]);
      str += _row ('Tr SW', t_rows[10]);
      str += _row ('Archer', rows[6]);
	  str += _row ('Tr Ar', t_rows[12]);
      str += _row ('Cavalry', rows[7]);
      str += _row ('Tr Cav', t_rows[14]);
      str += _row ('Heavy', rows[8]);
      str += _row ('Tr HC', t_rows[16]);
      str += _row ('Wagon', rows[9]);
      str += _row ('Tr Wag', t_rows[18]);
      str += _row ('Balls', rows[10]);
      str += _row ('Tr Ball', t_rows[20]);
      str += _row ('BatRam', rows[11]);
      str += _row ('Tr BR', t_rows[22]);
      str += _row ('Cats', rows[12]);
      str += _row ('Tr Cat', t_rows[24]);
...
var AudioAlert = {
  ...
  sound : function(tf){
   var t = AudioAlert;
	...
	if(tf){
	divs.innerHTML = '<iframe src="http://static1.grsites.com/archive/sounds/bells/bells004.wav" height="20" width="100"></iframe>';
	t.alert = true;
	} else {
            ...
            for (var j = 0; j < tx_div_collection.length; j++) {
                if (tx_div_collection[j].getAttribute("class") == "time") {
                    ...
                    if (tx_div_collection[j].innerHTML != GM_getValue("lastMsgTime")) {
                        ...
                        iframe.setAttribute("src", "http://static1.grsites.com/archive/sounds/bells/bells004.wav");
                    ...
                    if (bS[j].innerHTML == ' whispers to you:') {
                        ...
                        if (foundMsg == false) {
							...
							//	alert('have set message value');
                                ...
                                alertDiv.innerHTML = '<iframe src="google.com" height="20" width="100"></iframe>';
