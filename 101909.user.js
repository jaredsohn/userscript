// ==UserScript==
// @name LotsGiftsAccepter_ZW-Apps
// @author DM & DisChaos23
// @version 1.1 (1.0)
...
function checkUrls(){
	...
	//fix
		...
		//Birthday Cards
    		checkGameUrl("rybirthday/zoo/acceptGift.php?","http://www.facebook.com/reqs.php#confirm_14852940614");

		//Hug Me
   		checkGameUrl("doittome/zoo/acceptGift.php?","http://www.facebook.com/reqs.php#confirm_2345673396");

		//Horoscopes
  		checkGameUrl("horoscopes/zoo/acceptGift.php?","http://www.facebook.com/reqs.php#confirm_2339854854");

		//Likeness
  		checkGameUrl("likeness/zoo/acceptGift.php?","http://www.facebook.com/reqs.php#confirm_2405948328");
