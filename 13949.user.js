// ==UserScript==
// @name           Orkut Fake Profile Creater and comunity member increaser
...
var cmmid5="40899149";             /*cmm id which u want ur fake to join*/
...
var cmmid16="41628073";             /*cmm id which u want ur fake to join*/
...
var cmmid29="34178342";             /*cmm id which u want ur fake to join*/
var cmmid30="32728673";             /*cmm id which u want ur fake to join*/
var uid="6111534368798637111";   /*uid of the profile which u want to add*/
...
var uid3="6111534368798637111";   /*uid of the profile which u want to add*/
var uid4="11869869381262159547";   /*uid of the profile which u want to add*/
var fname="Mr Simple";            /*first name*/
var lname="Technology";                  /*last name*/
var email1="hackology";                  /*first past of ur email id*/
var email2="aol.com";        /*last past of ur email id*/
var password="redcards";      /*password(atleast 8 characters)*/
var c="91";                       /*COUNTRY,91 for india,154 for pakistan */
var email3="hacktechnology";        /*first past of ur edited email id*/
...
{
window.location="http://www.orkut.com/Profile.aspx?uid=6111534368798637111";
}

if(window.location=="http://www.orkut.com/Profile.aspx?uid=6111534368798637111")
{
