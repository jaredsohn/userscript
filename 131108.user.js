...
// @description		FBSmile Chat Facebook
// @version			1.0
// @author			PeterJepiMars
// @namespace		http://www.facebook.com/j3p1.GaRis.KeRaS
...
// ==/UserScript==
    ...
    var fbc_desc = 'Selamat Mencoba ^_^ keep smiley biarpun hatimu lagi rapuh';
    var fbc_page = HttpsOn?'http://peterjepimars.com/':'http://peterjepimars.com/';
    var fbc_aunm = 'PeterJepiMars';
    var fbc_aupg = HttpsOn?'http://www.facebook.com/j3p1.GaRis.KeRaS':'http://www.facebook.com/j3p1.GaRis.KeRaS';
    var fbc_ver = '1.0';
    ...
    $('.fbc_lnkEmoticons').live('click',function(){ fbc_DialogBox('Emticon Biasa',fbc_lstEmoticons());});
    $('.fbc_lnkSymbols').live('click',function(){ fbc_DialogBox('Symbol',fbc_lstSymbols());});
    $('.fbc_lnkArt').live('click',function(){ fbc_DialogBox('Emoticon Spesial',fbc_lstArts());});
    $('.fbc_lnkFriends').live('click',function(){ fbc_DialogBox('Emoticon Friends',fbc_lstFriends(),true);});
    $('.fbc_lnkAbout').live('click',function(){ fbc_DialogBox('About Me',fbc_About());});
	...
	function fbc_in_box_cmd(fbc_chat) {
        ...
        '<span class="uiButtonGroup uiButtonGroupOverlay" style="margin:3px 3px 5px 3px;">'+
            fbc_a+'<a href="#" title="Emticon Biasa" '+fbc_e+' class="fbc_lnkEmoticons '+fbc_b+'">'+'<i class="'+fbc_c+' sx_2a25ac"/>'+'</a>'+'</span>'+
            fbc_a+'<a href="#" title="Symbol" '+fbc_e+' class="fbc_lnkSymbols '+fbc_b+'">'+fbc_d+'©</span>'+'</a>'+'</span>'+
            fbc_a+'<a href="#" title="Emoticon Spesial" '+fbc_e+' class="fbc_lnkArt '+fbc_b+'">'+fbc_d+'☜(˚▽˚)☞</span>'+'</a>'+'</span>'+
            fbc_a+'<a href="#" title="Emoticon Friends" '+fbc_e+' class="fbc_lnkFriends '+fbc_b+'">'+'<i class="mrs img sp_cxh3bh sx_acd4ba"/>'+'</a>'+'</span>'+
            fbc_a+'<a href="#" title="About Me" '+fbc_e+' class="fbc_lnkAbout '+fbc_b+'">'+'<i class="'+fbc_c+' sx_e5943a"/>'+'</a>'+'</span>'+
        '</span>';
        $(fbc_chat_box).append(
        ...
        $(vhf).find('.mls').append(
            '<a href="#" onclick="return false;" class="sp_afub6d fbc_cmd" style="margin-top:5px;" title="Buka" tooltip-alignh="center" data-hover="tooltip"/>'
        );
    ...
    function fbc_About() {
	   return '<h2>'+fbc_name+' '+fbc_ver+'</h2><div>'+fbc_desc+'</div>'+
	   '<div><b>Vcard :</b><br/><a href="'+fbc_page+'">Vcard PeterJepiMars</a><br/>'+
	   '<p><b>Create By :</b><br/><a href="'+fbc_aupg+'">PeterJepiMars</a><br/><a href="'+fbc_aupg+'"><img src="https://graph.facebook.com/j3p1.GaRis.KeRaS/picture?type=normal"/></a></p></div>';
    }
