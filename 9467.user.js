...
// @include                http://*
// @include                https://*
// @include                https://torrentproject.com/userscripts*
// @include                file://*
...
// @exclude        http://www.megashares.com/*
// @exclude        http://netload.in/*
// @exclude        http://www.netload.in/*
// @exclude        http://crocko.com/*
// @exclude        http://www.crocko.com/*
// @exclude        http://vip-file.com/*
// @exclude        http://www.vip-file.com/*
// @exclude        http://yourfilehost.com*
// @exclude        http://www.yourfilehost.com*
// @exclude        http://www.sendspace.com*
// @exclude        http://sendspace.com*
// @exclude        http://www.letitbit.net*
// @exclude        http://letitbit.net*
// @exclude        http://zshare.net*
// @exclude        http://www.zshare.net*
// @exclude        http://uploadbox.com*
// @exclude        http://www.uploadbox.com*
// @exclude        http://vip-file.com*
// @exclude        http://www.vip-file.com*
// @exclude        http://bitroad.net*
// @exclude        http://www.bitroad.net*
// @exclude        http://link-protector.com*
// @exclude        http://www.link-protector.com*
// @exclude        http://duckload.com*
// @exclude        http://www.duckload.com*
// @exclude        http://filepost.com*
// @exclude        http://www.filepost.com*
// @exclude        http://x7.to*
// @exclude        http://www.x7.to*
// @exclude        http://turbobit.net/*
// @exclude        http://hitfile.net/*
// @exclude        http://www.turbobit.net/*
// @exclude        *xml_dump.php*
// @exclude        *phpMyAdmin*
// @exclude        *deleterecord.php*
// @exclude        http://www.extabit.com*
// @exclude        http://extabit.com*
// @exclude        http://www.anysend.com*
// @exclude        http://anysend.com*
// @exclude        http://shareflare.net*
// @exclude        http://www.shareflare.net*
// @exclude        http://solidfile.com*
// @exclude        http://www.solidfile.com*
// @exclude        http://gigapeta.com*
// @exclude        http://www.gigapeta.com*
// @exclude        http://*rayfile.com*
// @exclude        http://www.rayfile.com*
// @exclude        http://turboshare.com*
// @exclude        http://freakshare.net*
// @exclude        http://www.freakshare.net*
// @exclude        http://freakshare.com*
// @exclude        http://www.freakshare.com*
...
// @exclude        http://dizzcloud.com*
// @exclude        http://www.dizzcloud.com*
// @exclude        http://oteupload.com*
// @exclude        https://oteupload.com*
// @exclude        http://www.oteupload.com*
// @exclude        https://www.oteupload.com*
// @exclude        http://keep2share.cc*
// @exclude        http://www.keep2share.cc*
// @exclude        https://keep2share.cc*
// @exclude        https://www.keep2share.cc*
// @exclude        http://keep2s.cc*
// @exclude        http://www.keep2s.cc*
// @exclude        https://keep2s.cc*
// @exclude        https://www.keep2s.cc*
...
// @exclude        http://www.ziddu.com/*
// @exclude        http://uploadc.com/*
// @exclude        http://www.uploadc.com/*
// @exclude        http://movshare.net/*
// @exclude        http://www.movshare.net/*
// @exclude        http://www.zippyshare.com*
// @exclude        http://zippyshare.com*
// @exclude        http://filegag.com*
// @exclude        http://www.filegag.com*
// @exclude        http://egofiles.com*
// @exclude        http://www.egofiles.com*
// @exclude        http://filecloud.io*
// @exclude        http://www.filecloud.io*
// @exclude        http://putlocker.com*
// @exclude        http://www.putlocker.io*
// @exclude        http://putlocker.com*
// @exclude        http://www.putlocker.com*
// @exclude        https://mega.co.nz/*
// @exclude        http://mega.co.nz/*
// @exclude        http://dfiles.eu/*
// @exclude        http://www.dfiles.eu/*
// @exclude        http://bayfiles.net/*
// @exclude        http://luckyshare.net/*
// @exclude        http://www.luckyshare.net/*
// @exclude        http://nowvideo.ch/*
// @exclude        http://www.nowvideo.ch/*
// @exclude        http://ryushare.com/*
// @exclude        http://www.ryushare.com/*
// @exclude        http://clz.to/*
// @exclude        http://www.clz.to/*
// @exclude        http://cloudzer.net/*
// @exclude        http://www.cloudzer.net/*
// @exclude        http://nowdownload.ch/*
// @exclude        http://www.nowdownload.ch/*
// @exclude        http://nowdownload.eu/*
// @exclude        http://www.nowdownload.eu/*
// @exclude        http://unibytes.com/*
// @exclude        http://www.unibytes.com/*
// @exclude        http://4shared.com/*
// @exclude        http://www.4shared.com/*
// @exclude        http://180upload.com/*
// @exclude        http://www.180upload.com/*
// @exclude        http://fireget.com/*
// @exclude        http://www.fireget.com/*
// @exclude        http://fileom.com/*
// @exclude        http://www.fileom.com/*
// @exclude        http://vidbull.com/*
// @exclude        http://www.vidbull.com/*
// @exclude        http://movreel.com/*
// @exclude        http://www.movreel.com/*
// @exclude        http://salefiles.com/*
// @exclude        http://www.salefiles.com/*
// @exclude        http://secureload.eu/*
// @exclude        http://www.secureload.eu/*
// @exclude        http://dizzcloud.com/*
// @exclude        http://www.dizzcloud.com/*
// @exclude        http://lumfile.com/*
// @exclude        http://www.lumfile.com/*
// @exclude        http://banashare.com/*
// @exclude        http://www.banashare.com/*
// @exclude        http://ultramegabit.com/*
// @exclude        http://www.ultramegabit.com/*
// @exclude        http://filesmonster.com/*
// @exclude        http://www.filesmonster.com/*
// @exclude        http://rapidgator.net/*
// @exclude        http://www.rapidgator.net/*
// @exclude        http://share-online.biz/*
// @exclude        http://www.share-online.biz/*
// @exclude        http://www.kingfiles.net/*
// @exclude        http://lumfile.com/*
// @exclude        https://fileparadox.in/*
// @exclude        http://videopremium.me/*
// @exclude        http://epicshare.net/*
// @exclude        http://hugefiles.net/*
// @exclude        http://dspeedhost.com/*
// @exclude        http://junocloud.me/*
// @exclude        http://mightyupload.com/*
// @exclude        http://usefile.com/*
// @exclude        http://www.arabloads.com/*
// @exclude        http://inafile.com/*
// @exclude        http://sinhro.net/*
// @exclude        http://uploadboy.com/*
// @exclude        http://4upfiles.com/*
// @exclude        http://terafile.co/*
// @exclude        http://unlimitzone.com/*
// @exclude        http://uploadjet.net/*
// @exclude        http://rockdizfile.com/*
// @exclude        http://fastsonic.net/*
// @exclude        http://www.fastsonic.net/*
// @exclude        http://rocketfile.net/*
// @exclude        http://www.rocketfile.net/*
// @exclude        http://www.anafile.com/*
// @exclude        http://www.filetug.com/*
// @exclude        http://www.rapidfileshare.net/*
// @exclude        http://www.sendmyway.com/*
// @exclude        http://www.tusfiles.net/*
// @exclude        http://dropbox.com/*
// @exclude        http://www.dropbox.com/*
// @exclude        http://hulkfile.eu/*
// @exclude        http://www.hulkfile.eu/*
// @exclude        http://nirafile.com/*
// @exclude        http://www.nirafile.com/*
// @exclude        http://project-free-upload.com/*
// @exclude        http://www.project-free-upload.com/*
// @exclude        http://akafile.com/*
// @exclude        http://www.akafile.com/*
// @exclude        http://uploadscenter.com/*
// @exclude        http://www.uploadscenter.com/*
// @exclude        http://upafile.com/*
// @exclude        http://www.upafile.com/*
// @exclude        http://filesend.net/*
// @exclude        http://www.filesend.net/*
// @exclude        http://file-upload.net/*
// @exclude        http://www.file-upload.net/*
// @exclude        http://file-upload.net/*
// @exclude        http://www.file-upload.net/*
// @exclude        http://gigabase.com/*
// @exclude        http://www.gigabase.com/*
// @exclude        http://asfile.com/*
// @exclude        http://www.asfile.com/*
// @usoscript      9467
// ==/UserScript==
 
fileMETA["update"] = 'new addition rocketfile';

// todo 
// to check this type of links
// example here linksfu.com/2013/03/vikings-s01e01-repack-hdtv-x264-2hd/
// www.seriesenblog.com/2013/11/the-walking-dead-s04e04.html
// www.scnsrc.me/films/battle-year-2013-bdrip-x264-geckos/
// buggy hulkfile.eu ??? recheck
 ...
 return;
	...
	function create_window(event){
		...
		var tt_div = document.createElement("div");
			...
			tt_div.setAttribute("style", "background:" + bg_color + "; text-align: justify; box-shadow: 0 1px 5px rgba(0, 0, 0, 0.5);padding: 6px 6px 6px 6px; -moz-border-radius:4px; border-radius:4px; opacity:0.9; border:1px solid " + border_color + "; color:" + font_color + ";font-family:" + font_face + ";font-size:" + font_size + ";position:absolute;z-index:1000; max-width: 400px;");
		var tt_url = document.createElement("div");
			tt_url.innerHTML = event.currentTarget.getAttribute('dll_info');
			tt_div.appendChild(tt_url);
		GM_addStyle(".ho-buy-on-amazon {display:none;}");	
	...
	function add_RSLC_style(){
		if (!(document.getElementsByTagName('RSLC')[0])){
			...
			GM_addStyle(".loading_rlc {background:transparent url(" + loading_img + ") no-repeat scroll 100% 50% !important;padding-right:15px;}");
		}
	}
 
	
	if ( location.href.match(/https:\/\/torrentproject.com\/userscripts\/rapidshare_links_checker_new\/search\//))
	{
		...
		function openRapidshare(){
			...
			if ( (whatsite == 'rapidshare2') || (whatsite == 'all2') || (whatsite == 'singlelink2')){
				...
				googlesearchurl =	"http://www.google.com/search?q=intitle:\""+search_term+"\" +\""+search_term+"\"+\"watch+online\"+-trailer+-jamespot+-weebly+-lovefilm+-removed&num=100&hl=en&lr=&btnG=Search";
			}else{
		...
		function GetAndShowMeTheRapidshare(googlesearchurl,where,rightpositionprs,TheQueryIsCommingFrom)
		{
			...
			GM_xmlhttpRequest(
			{
				...
				onload:function(responseDetails)
				{
					...
					googleresponse = googleresponse.replace(/\/url\?q=http/g, "http");
					googleresponse = googleresponse.replace(/&amp;sa=.*?"/g, "\"");
					googleresponse = googleresponse.replace(/%3F/g, "?");
					googleresponse = googleresponse.replace(/%3D/g, "=");					
					//linko = unescape(linko);		
					...
					else
					{
					 if (TheQueryIsCommingFrom == "openOtherhosts"){
							newgooglesearchurl =	"http://www.google.com/search?hl=en&q=%22"+moviename+"%22+%22interchangeable+links%22+OR+%22mediafire.com%2F%5C%5C%3F%22+OR+%22uploaded+net+id%22+OR+%22megashares.com%22+OR+%22rapidshare.de%5C%2Ffiles%22+OR+%22dfiles%5C.eu%22+OR+%22netload%5C%5C.in%22+OR+%22filefactory.com/file/%22&num=100&btnG=Search";
						}
		...
		function analyseResults(toanalyse,where)
		{
			...
			for (var i = 0; i < toanalyse_array.length; i++)
			{
				...
				if (match != null) {
					...
					linko = linko.replace(/\/url\?q=http/g, "http");
					linko = linko.replace(/&amp;sa=.*/g, "");
					linko = unescape(linko);									
					linktitle = match[2];	
					if (x < 25){
		...
		function wheretosearch()
		{
			...
			"all" 						 : '"rapidshare.com/files"||"letitbit.net"||"badongo.com/file/"||"dfiles.eu/"||"vip-file.com/download"||"filefactory.com/file"||"storage.to/get"||"hotfile.com/dl"||"netload.in/date"',
			"all2" 						 : '"rapidshare.com/files"||"letitbit.net"||"badongo.com/file/"||"dfiles.eu/"||"vip-file.com/download"||"filefactory.com/file"||"storage.to/get"||"hotfile.com/dl"||"netload.in/date"',
			"singlelink" 				 : '"single link" OR "one link download" "fileserve.com/file/"||"turbobit.net/"||"mega.co.nz/"||"letitbit.net"||"quickupload.net/"||"dfiles.eu/"||"vip-file.com/download"||"gettyfile.ru"||"filestab.com"||"cramit.in"||"netload.in/date"||"gigasize.com"||"sharejunky.com"||"2shared.com"',
			"singlelink2" 				 : '"single link" OR "one link download" "fileserve.com/file/"||"turbobit.net/"||"mega.co.nz/"||"letitbit.net"||"quickupload.net/"||"dfiles.eu/"||"vip-file.com/download"||"gettyfile.ru"||"filestab.com"||"cramit.in"||"netload.in/date"||"gigasize.com"||"sharejunky.com"||"2shared.com"',
			"rapidshare" : "%22rapidshare.com/files/%22",
			"rapidshare2" : "%22rapidshare.com/files/%22",
			"mega.co.nz" : "%22mega.co.nz%22",
			"mega.co.nz" : "%22mega.co.nz%22",
			...
			"uploaded.net" : "%22uploaded.net/.id=%22",
			"watch_online" : "watch_online",
			"badongo.com" : "%22badongo.com/file/%22",
			"depositfiles" : "%22dfiles.eu/files/%22",
	...
	var Send_performance_statistics_no_personal_information_is_transmited, Show_black_background_in_dead_links, Show_line_through_in_dead_links;
	var Remove_html_from_rapidshare_urls, Add_html_to_urls, No_live_links, Keyboard_functions, Convert_links_to_full_address_links, Show_info_in_tooltip, Display_page_stats, Destyling_google_cache, Autocheck_links_on_page_load, Check_rapidshare_dot_com_links, Check_filejungle_dot_com_links,Check_freakshare_dot_com_links, Check_mega_dot_co_dot_nz_links, Check_ryushare_dot_com_links, Check_turbobit_dot_net_links, Check_secureupload_dot_eu_links, Check_kingfiles_dot_net_links, Check_videopremium_dot_me_links, Check_fileparadox_dot_in_links, Check_epicshare_dot_net_links, Check_hugefiles_dot_net_links, Check_lumfile_dot_com_links, Check_dspeedhost_dot_com_links, Check_junocloud_dot_me_links, Check_mightyupload_dot_com_links, Check_terafile_dot_co_links, Check_filecloud_dot_io_links, Check_unlimitzonedot_com_links, Check_uploadjet_dot_net_links, Check_rockdizfile_dot_com_links, Check_fastsonic_dot_net_links, Check_rocketfile_dot_net_links, Check_filetug_dot_com_links, Check_anafile_dot_com_links, Check_rapidfileshare_dot_net_links, Check_sendmyway_dot_com_links, Check_oteupload_dot_com_links, Check_tusfiles_dot_net_links, Check_banashare_dot_com_links, Check_megafiles_dot_se_links, Check_fileom_dot_com_links, Check_vidbull_dot_com_links, Check_movreel_dot_com_links, Check_salefiles_dot_com_links, Check_nirafile_dot_com_links, Check_akafile_dot_com_links, Check_uploadscenter_dot_com_links,  Check_project_dash_free_dash_upload_dot_com_links, Check_fireget_dot_com_links, Check_bayfiles_dot_net_links, Check_bitshare_dot_com_links, Check_netload_dot_in_links, Check_egofiles_dot_com_links, Check_filegag_dot_com_links, Check_fileserve_dot_com_links, Check_hotfile_dot_com_links, Check_share_dash_online_dot_biz_links, Check_uploading_dot_com_links;
	function set_variables()
	{
		Send_performance_statistics_no_personal_information_is_transmited = GM_getValue("Send_performance_statistics_no_personal_information_is_transmited", true);
		...
		Check_180upload_dot_com_links = GM_getValue("Check_180upload_dot_com_links", false);
		Check_4shared_dot_com_links = GM_getValue("Check_4shared_dot_com_links", true);
		...
		Check_freakshare_dot_com_links = GM_getValue("Check_freakshare_dot_com_links", true);
		Check_mega_dot_co_dot_nz_links = GM_getValue("Check_mega_dot_co_dot_nz_links", true);
		Check_ryushare_dot_com_links = GM_getValue("Check_ryushare_dot_com_links", true);
		Check_bayfiles_dot_net_links = GM_getValue("Check_bayfiles_dot_net_links", true);
		Check_fireget_dot_com_links = GM_getValue("Check_fireget_dot_com_links", true);
		Check_fileom_dot_com_links = GM_getValue("Check_fileom_dot_com_links", true);
		Check_vidbull_dot_com_links = GM_getValue("Check_vidbull_dot_com_links", true);
		Check_movreel_dot_com_links = GM_getValue("Check_movreel_dot_com_links", true);
		Check_salefiles_dot_com_links = GM_getValue("Check_salefiles_dot_com_links", true);
		Check_nirafile_dot_com_links = GM_getValue("Check_nirafile_dot_com_links", true);
		Check_project_dash_free_dash_upload_dot_com_links = GM_getValue("Check_project_dash_free_dash_upload_dot_com_links", true);
		Check_akafile_dot_com_links = GM_getValue("Check_akafile_dot_com_links", true);
		Check_uploadscenter_dot_com_links = GM_getValue("Check_uploadscenter_dot_com_links", true);
		Check_kingfiles_dot_net_links = GM_getValue("Check_kingfiles_dot_net_links", true);
		Check_videopremium_dot_me_links = GM_getValue("Check_videopremium_dot_me_links", true);
		Check_fileparadox_dot_in_links = GM_getValue("Check_fileparadox_dot_in_links", true);
		Check_epicshare_dot_net_links = GM_getValue("Check_epicshare_dot_net_links", true);
		Check_hugefiles_dot_net_links = GM_getValue("Check_hugefiles_dot_net_links", true);	
		Check_lumfile_dot_com_links = GM_getValue("Check_hugefiles_dot_net_links", true);	
		Check_dspeedhost_dot_com_links = GM_getValue("Check_dspeedhost_dot_com_links", true);
		Check_junocloud_dot_me_links = GM_getValue("Check_junocloud_dot_me_links", true);			
		Check_mightyupload_dot_com_links = GM_getValue("Check_mightyupload_dot_com_links", true);		
		Check_terafile_dot_co_links = GM_getValue("Check_terafile_dot_co_links", true);		
		Check_unlimitzonedot_com_links = GM_getValue("Check_unlimitzonedot_com_links", true);		
		Check_uploadjet_dot_net_links = GM_getValue("Check_uploadjet_dot_net_links", true);		
		Check_rockdizfile_dot_com_links = GM_getValue("Check_rockdizfile_dot_com_links", true);		
		Check_fastsonic_dot_net_links = GM_getValue("Check_fastsonic_dot_net_links", true);		
		Check_rocketfile_dot_net_links = GM_getValue("Check_rocketfile_dot_net_links", true);		
		Check_filetug_dot_com_links = GM_getValue("Check_filetug_dot_com_links", true);	
		Check_anafile_dot_com_links	= GM_getValue("Check_anafile_dot_com_links", true);	
		Check_rapidfileshare_dot_net_links = GM_getValue("Check_rapidfileshare_dot_net_links", true);		
		Check_sendmyway_dot_com_links = GM_getValue("Check_sendmyway_dot_com_links", true);		
		Check_oteupload_dot_com_links = GM_getValue("Check_oteupload_dot_com_links", true);		
		Check_tusfiles_dot_net_links = GM_getValue("Check_tusfiles_dot_net_links", true);				
		Check_banashare_dot_com_links = GM_getValue("Check_banashare_dot_com_links", true);		
		Check_megafiles_dot_se_links  = GM_getValue("Check_megafiles_dot_se_links", true);			
		Check_junocloud_dot_me_links = GM_getValue("Check_junocloud_dot_me_links", true);
		Check_secureupload_dot_eu_links = GM_getValue("Check_secureupload_dot_eu_links", true);
		...
		Check_egofiles_dot_com_links = GM_getValue("Check_egofiles_dot_com_links", true);		
		Check_filegag_dot_com_links = GM_getValue("Check_filegag_dot_com_links", true);	
		...
		Check_share_dash_online_dot_biz_links = GM_getValue("Check_share_dash_online_dot_biz_links", true);
		...
		Check_rd_dash_fs_dot_com_links = GM_getValue("Check_rd_dash_fs_dot_com_links", true);		
		...
		Check_movshare_dot_net_links = GM_getValue("Check_movshare_dot_net_links", false);
		Check_d_dash_h_dot_st_links = GM_getValue("Check_d_dash_h_dot_st_links", false);
		...
		Check_bitshare_dot_com_links = GM_getValue("Check_bitshare_dot_com_links", true);
		...
		Check_dropbox_dot_com_links = GM_getValue("Check_dropbox_dot_com_links", false);
		Check_hulkfile_dot_eu_links = GM_getValue("Check_hulkfile_dot_eu_links", false);
		Check_nowdownload_dot_ch_links = GM_getValue("Check_nowdownload_dot_ch_links", false);
		...
		Check_uploadc_dot_com_links = GM_getValue("Check_uploadc_dot_com_links", true);
		Check_zippyshare_dot_com_links = GM_getValue("Check_zippyshare_dot_com_links", true);
		Check_rapidshare_dot_de_links = GM_getValue("Check_rapidshare_dot_de_links", false);
		Check_rapidgator_dot_net_links = GM_getValue("Check_rapidgator_dot_net_links", true);
		Check_filesmonster_dot_com_links = GM_getValue("Check_filesmonster_dot_com_links", true);
		...
		Check_anysend_dot_com_links = GM_getValue("Check_anysend_dot_com_links", true);	
		Check_ultramegabit_dot_com_links = GM_getValue("Check_ultramegabit_dot_com_links", true);	
		Check_megashares_dot_com_links = GM_getValue("Check_megashares_dot_com_links", false);
		Check_nowvideo_dot_ch_links = GM_getValue("Check_nowvideo_dot_ch_links", false);	
		Check_clz_dot_to_links = GM_getValue("Check_clz_dot_to_links", false);	
		Check_luckyshare_dot_net_links = GM_getValue("Check_luckyshare_dot_net_links", false);	
		Check_oteupload_dot_com_links = GM_getValue("Check_oteupload_dot_com_links", false);
		Check_keep2share_dot_cc_links = GM_getValue("Check_keep2share_dot_cc_links", true);
		...
		Check_topvideo_dot_tv_links = GM_getValue("Check_topvideo_dot_tv_links", false);
		Check_uploaded_dot_net_links = GM_getValue("Check_uploaded_dot_net_links", true);
		Check_usaupload_dot_net_links = GM_getValue("Check_usaupload_dot_net_links", false);
		//Check_uptobox_dot_com_links = GM_getValue("Check_uptobox_dot_com_links", true);
		Check_unibytes_dot_com_links = GM_getValue("Check_unibytes_dot_com_links", true);
		Check_dizzcloud_dot_com_links = GM_getValue("Check_dizzcloud_dot_com_links", false);
		Check_filesend_dot_net_links = GM_getValue("Check_filesend_dot_net_links", false);	
		Check_gigabase_dot_com_links = GM_getValue("Check_gigabase_dot_com_links", false);	
		Check_asfile_dot_com_links = GM_getValue("Check_asfile_dot_com_links", false);	
		Check_file_dash_upload_dot_net_links = GM_getValue("Check_file_dash_upload_dot_net_links", false);	
		...
		Check_filecloud_dot_io_links = GM_getValue("Check_filecloud_dot_io_links", false);
		Check_putlocker_dot_com_links = GM_getValue("Check_putlocker_dot_com_links", false);		
	...
	function check(Send_performance_statistics_no_personal_information_is_transmited,
	 ...
	 firsttime)
	{
		if (Destyling_google_cache && (location.href.search(/q=cache.*?(rapidshare|mega.co.nz|filefactory|netload|fileserve)/) != -1)) {
			var mybody = document.getElementsByTagName('body');
			if (mybody[0].innerHTML.search(/rapidshare|mega.co.nz|filefactory|netload|fileserve/) != -1) {
		...
		var googleregex = new RegExp("(^http://blogsearch.*|^http://.*google.*)(.*rapidshare.*|.*mega.co.nz.*|.*filefactory.*|.*netload.*|.*fileserve.*)"); 
		if (googleregex.test(location.href)) {
			...
			if (links.snapshotItem(0)) {
				...
				var regexmu = new RegExp("mega.co.nz");
		...
		var commonregexpart = '.*?[^"\\s\\<\\>]*[^.,;\'">\\:\\s\\<\\>\\)\\]\\!])';
		if (Check_filejungle_dot_com_links) detectLinksRegEx += '(?:\\:\/\/(?:|www\.)filejungle\\.com\/f\/..*?[^"\\s\\<\\>]*[^.,;\'">\\:\\s\\<\\>\\)\\]\\!])|';
		if (Check_freakshare_dot_com_links) detectLinksRegEx += '(?:\\:\/\/(?:|www\.)freakshare\\.com\/files\/.*?[^"\\s\\<\\>]*[^.,;\'">\\:\\s\\<\\>\\)\\]\\!])|';
		...
		if (Check_share_dash_online_dot_biz_links) detectLinksRegEx += "(?:\\:\/\/(?:|www\\.)share-online\\.biz\/dl\/"+commonregexpart+"|";
		...
		if (Check_egofiles_dot_com_links) detectLinksRegEx += '(?:\\:\/\/(?:|www\.)egofiles\\.com\/[0-9a-zA-Z]{16}(?:\/|)\\S*)|';
		if (Check_filegag_dot_com_links) detectLinksRegEx += "(?:\\:\/\/(?:|www\\.)filegag\\.com\/.*?\\S*\\.html)|";
		if (Check_fileserve_dot_com_links) detectLinksRegEx += '(?:\\:\/\/(?:|www\\.)fileserve\\.com\/file\/\\w*(?:|/\\w*)(?:\/|))[^"\\s\\<\\>]*[^.,;\'">\\:\\s\\<\\>\\)\\]\\!]|';
		if (Check_mega_dot_co_dot_nz_links) detectLinksRegEx += "(?:\\:\/\/mega\\.co\\.nz\/..[a-zA-Z0-9_!-]{20,65})|";
		if (Check_ryushare_dot_com_links) detectLinksRegEx += '(?:\\:\/\/(?:|www\\.)ryushare\\.com\/\\w*..*?[^"\\s\\<\\>]*[^.,;\'">\\:\\s\\<\\>\\)\\]\\!])|';
		if (Check_bayfiles_dot_net_links) detectLinksRegEx += "(?:\\:\/\/(?:|www\\.)bayfiles\\.net\/file\/.{2,8}\/.{3,9}\/"+commonregexpart+"|";
		if (Check_bitshare_dot_com_links) detectLinksRegEx += "(?:\\:\/\/(?:|www\\.)bitshare\\.com\/(?:files\/|.f=)[a-zA-Z0-9]{7,9}"+commonregexpart+"|";
		if (Check_fireget_dot_com_links) detectLinksRegEx += "(?:\\:\/\/(?:|www\\.)(?:fireget|upafile|uptobox|vidhog|billionuploads|filenuke)\\.com\/.{10,14}"+commonregexpart+"|";
		if (Check_fileom_dot_com_links) detectLinksRegEx += "(?:\\:\/\/(?:|www\\.)fileom\\.com\/[a-z0-9]{11}"+commonregexpart+"|";
		if (Check_vidbull_dot_com_links) detectLinksRegEx += "(?:\\:\/\/(?:|www\\.)vidbull\\.com\/[a-z0-9]{11}"+commonregexpart+"|";
		if (Check_movreel_dot_com_links) detectLinksRegEx += "(?:\\:\/\/(?:|www\\.)movreel\\.com\/[a-z0-9]{11}"+commonregexpart+"|";
		if (Check_salefiles_dot_com_links) detectLinksRegEx += "(?:\\:\/\/(?:|www\\.)salefiles\\.com\/[a-z0-9]{11}"+commonregexpart+"|";
		if (Check_nirafile_dot_com_links) detectLinksRegEx += "(?:\\:\/\/(?:|www\\.)nirafile\\.com\/[a-z0-9]{11}"+commonregexpart+"|";
		if (Check_akafile_dot_com_links) detectLinksRegEx += "(?:\\:\/\/(?:|www\\.)akafile\\.com\/[a-z0-9]{11}"+commonregexpart+"|";
		if (Check_uploadscenter_dot_com_links) detectLinksRegEx += "(?:\\:\/\/(?:|www\\.)uploadscenter\\.com\/[a-z0-9]{11}"+commonregexpart+"|";
		if (Check_project_dash_free_dash_upload_dot_com_links) detectLinksRegEx += "(?:\\:\/\/(?:|www\\.)project-free-upload\\.com\/[a-z0-9]{11}"+commonregexpart+"|";
		if (Check_banashare_dot_com_links) detectLinksRegEx += "(?:\\:\/\/(?:|www\\.)banashare\\.com\/[a-z0-9]{11}"+commonregexpart+"|";
		if (Check_megafiles_dot_se_links) detectLinksRegEx += "(?:\\:\/\/(?:|www\\.)megafiles\\.se\/[a-z0-9]{11}"+commonregexpart+"|";
		if (Check_junocloud_dot_me_links) detectLinksRegEx += "(?:\\:\/\/(?:|www\\.)junocloud\\.me\/[a-z0-9]{9,}"+commonregexpart+"|";
		if (Check_secureupload_dot_eu_links) detectLinksRegEx += "(?:\\:\/\/(?:|www\\.)secureupload\\.eu\/[a-z0-9]{11}"+commonregexpart+"|";
		if (Check_turbobit_dot_net_links) detectLinksRegEx += "(?:\\:\/\/(?:|www\\.)(?:turbobit|hitfile)\\.net\/[a-z0-9]{2,}"+commonregexpart+"|";
		if (Check_kingfiles_dot_net_links) detectLinksRegEx += "(?:\\:\/\/(?:|www\\.)kingfiles\\.net\/[a-z0-9]{11}"+commonregexpart+"|";
		if (Check_videopremium_dot_me_links) detectLinksRegEx += "(?:\\:\/\/(?:|www\\.)videopremium\\.(?:me|tv)\/[a-z0-9]{11}"+commonregexpart+"|";
		if (Check_lumfile_dot_com_links) detectLinksRegEx += "(?:\\:\/\/(?:|www\\.)lumfile\\.com\/[a-z0-9]{11}"+commonregexpart+"|";
		if (Check_dspeedhost_dot_com_links) detectLinksRegEx += "(?:\\:\/\/(?:|www\\.)dspeedhost\\.com\/[a-z0-9]{11}"+commonregexpart+"|";
		if (Check_junocloud_dot_me_links) detectLinksRegEx += "(?:\\:\/\/(?:|www\\.)junocloud\\.me\/[a-z0-9]{11}"+commonregexpart+"|";
		if (Check_mightyupload_dot_com_links) detectLinksRegEx += "(?:\\:\/\/(?:|www\\.)(?:mightyupload.com|uploadboy.com|4upfiles.com|sinhro.net|inafile.com|arabloads.com|usefile.com)\/[a-z0-9]{11}"+commonregexpart+"|";
		if (Check_terafile_dot_co_links) detectLinksRegEx += "(?:\\:\/\/(?:|www\\.)terafile\\.co\/[a-z0-9]{11}"+commonregexpart+"|";
		if (Check_filecloud_dot_io_links) detectLinksRegEx += "(?:\\:\/\/(?:|www\\.)filecloud\\.io\/[a-z0-9]{8})|";
		if (Check_unlimitzonedot_com_links) detectLinksRegEx += "(?:\\:\/\/(?:|www\\.)unlimitzone\\.com\/[a-z0-9]{11}"+commonregexpart+"|";
		if (Check_uploadjet_dot_net_links) detectLinksRegEx += "(?:\\:\/\/(?:|www\\.)uploadjet\\.net\/[a-z0-9]{11}"+commonregexpart+"|";
		if (Check_rockdizfile_dot_com_links) detectLinksRegEx += "(?:\\:\/\/(?:|www\\.)rockdizfile\\.com\/[a-z0-9]{11}"+commonregexpart+"|";
		if (Check_fastsonic_dot_net_links) detectLinksRegEx += "(?:\\:\/\/(?:|www\\.)fastsonic\\.net\/[a-z0-9]{11}"+commonregexpart+"|";
		if (Check_rocketfile_dot_net_links) detectLinksRegEx += "(?:\\:\/\/(?:|www\\.)rocketfile\\.net\/[a-z0-9]{11}"+commonregexpart+"|";
		if (Check_filetug_dot_com_links) detectLinksRegEx += "(?:\\:\/\/(?:|www\\.)filetug\\.com\/[a-z0-9]{11}"+commonregexpart+"|";
		if (Check_anafile_dot_com_links) detectLinksRegEx += "(?:\\:\/\/(?:|www\\.)anafile\\.com\/[a-z0-9]{11}"+commonregexpart+"|";
		if (Check_rapidfileshare_dot_net_links) detectLinksRegEx += "(?:\\:\/\/(?:|www\\.)rapidfileshare\\.net\/[a-z0-9]{11}"+commonregexpart+"|";
		if (Check_sendmyway_dot_com_links) detectLinksRegEx += "(?:\\:\/\/(?:|www\\.)sendmyway\\.com\/[a-z0-9]{11}"+commonregexpart+"|";
		if (Check_oteupload_dot_com_links) detectLinksRegEx += "(?:\\:\/\/(?:|www\\.)oteupload\\.com\/[a-z0-9]{11}"+commonregexpart+"|";
		if (Check_tusfiles_dot_net_links) detectLinksRegEx += "(?:\\:\/\/(?:|www\\.)tusfiles\\.net\/[a-z0-9]{11}"+commonregexpart+"|";
		if (Check_fileparadox_dot_in_links) detectLinksRegEx += "(?:\\:\/\/(?:|www\\.)fileparadox\\.in\/[a-zA-Z0-9]{9}"+commonregexpart+"|";
		if (Check_epicshare_dot_net_links) detectLinksRegEx += "(?:\\:\/\/(?:|www\\.)epicshare\\.net\/[a-z0-9]{11}"+commonregexpart+"|";
		if (Check_hugefiles_dot_net_links) detectLinksRegEx += "(?:\\:\/\/(?:|www\\.)hugefiles\\.net\/[a-z0-9]{11}"+commonregexpart+"|";
		detectLinksRegEx = detectLinksRegEx.replace(/\|$/,'');
		if (Check_kingfiles_dot_net_links || Check_videopremium_dot_me_links || Check_lumfile_dot_com_links ||Check_dspeedhost_dot_com_links || Check_junocloud_dot_me_links || Check_filecloud_dot_io_links || Check_mightyupload_dot_com_links ||Check_terafile_dot_co_links ||Check_unlimitzonedot_com_links ||Check_uploadjet_dot_net_links ||Check_rockdizfile_dot_com_links ||Check_fastsonic_dot_net_links || Check_rocketfile_dot_net_links ||Check_filetug_dot_com_links || Check_anafile_dot_com_links || Check_rapidfileshare_dot_net_links ||Check_sendmyway_dot_com_links ||Check_oteupload_dot_com_links ||Check_tusfiles_dot_net_links || Check_fileparadox_dot_in_links || Check_epicshare_dot_net_links || Check_hugefiles_dot_net_links || Check_rapidshare_dot_com_links || Check_filejungle_dot_com_links || Check_freakshare_dot_com_links || Check_mega_dot_co_dot_nz_links || Check_ryushare_dot_com_links || Check_secureupload_dot_eu_links || Check_turbobit_dot_net_links || Check_junocloud_dot_me_links ||Check_banashare_dot_com_links || Check_megafiles_dot_se_links || Check_fileom_dot_com_links || Check_vidbull_dot_com_links || Check_salefiles_dot_com_links ||  Check_nirafile_dot_com_links || Check_akafile_dot_com_links || Check_uploadscenter_dot_com_links || Check_project_dash_free_dash_upload_dot_com_links || Check_fireget_dot_com_links || Check_bayfiles_dot_net_links || Check_bitshare_dot_com_links || Check_netload_dot_in_links || Check_egofiles_dot_com_links || Check_filegag_dot_com_links || Check_fileserve_dot_com_links || Check_hotfile_dot_com_links || Check_share_dash_online_dot_biz_links || Check_uploading_dot_com_links){
		...
		var numberoffreakslinks = 0;
		var numberofmulinks = 0;
		var numberofnllinks = 0;
		var numberoffglinks = 0;
		var numberofkflinks = 0;
		var numberofbslinks = 0;
		var numberofmflinks = 0;
		var numberofjclinks = 0;
		var numberofbitslinks = 0;
		var numberoftblinks = 0;
		var numberofhitflinks = 0;
		var numberoffclinks = 0;
		var numberofsulinks = 0; 
		var numberofeflinks = 0;
		var numberoffslinks = 0;
		var numberoffgaglinks = 0;
		var numberofrylinks = 0;
		var numberofbflinks = 0;
		var numberofsolinks = 0;	
		var numberofhflinks = 0;		
		var numberofuplinks = 0;
		var nonexistant____ = /nonexistant____/;
		if (Check_rapidshare_dot_com_links){
			...
			var myrapidshareRegExp0, myrapidshareRegExp1, myrapidshareRegExp2
			myrapidshareRegExp0 = myrapidshareRegExp1 = myrapidshareRegExp2 = nonexistant____ ;
			}
			
		
		if (Check_freakshare_dot_com_links){
			var myfreakshareRegExp = /http\:\/\/(?:|www\.)freakshare\.com\/files\/\w*/;
		}else{
			var myfreakshareRegExp = nonexistant____;
			} 	
			
		if (Check_filejungle_dot_com_links){
			var myfilejungleRegExp = /http\:\/\/(?:|www\.)filejungle\.com\/f\/\w*/;
		}else{
			var myfilejungleRegExp = nonexistant____;
			} 	
			
		if (Check_ryushare_dot_com_links){
			var myryushareRegExp = /http\:\/\/(?:|www\.)ryushare\.com\/\w*/;	
		}else{
			var myryushareRegExp = nonexistant____;
			}			
		if (Check_mega_dot_co_dot_nz_links){
			var mymegauploadRegExp0 = /http(?:s|)\:\/\/mega\.co\.nz\/..[a-zA-Z0-9_!\-]{20,65}/;				
		}else{
			var mymegauploadRegExp0 = nonexistant____;
			}
		if (Check_secureupload_dot_eu_links){	
			var mysecureuploadRegExp = /http\:\/\/(?:|www\.)secureupload\.eu\/[a-zA-Z0-9]{9,15}/;		
		}else{
			var mysecureuploadRegExp = nonexistant____;
			} 
		if (Check_fileom_dot_com_links){	
			var myfileomRegExp = /http\:\/\/(?:|www\.)fileom\.com\/[a-zA-Z0-9]{9,15}/;		
		}else{
			var myfileomRegExp = nonexistant____;
			} 
		if (Check_vidbull_dot_com_links){	
			var myvidbullRegExp = /http\:\/\/(?:|www\.)vidbull\.com\/[a-zA-Z0-9]{9,15}/;		
		}else{
			var myvidbullRegExp = nonexistant____;
			} 
		if (Check_movreel_dot_com_links){	
			var mymovreelRegExp = /http\:\/\/(?:|www\.)movreel\.com\/[a-zA-Z0-9]{9,15}/;		
		}else{
			var mymovreelRegExp = nonexistant____;
			} 
		if (Check_salefiles_dot_com_links){	
			var mysalefilesRegExp = /http\:\/\/(?:|www\.)salefiles\.com\/[a-zA-Z0-9]{9,15}/;		
		}else{
			var mysalefilesRegExp = nonexistant____;
			} 
		if (Check_nirafile_dot_com_links){	
			var mynirafileRegExp = /http\:\/\/(?:|www\.)nirafile\.com\/[a-zA-Z0-9]{9,15}/;		
		}else{
			var mynirafileRegExp = nonexistant____;
			} 
		if (Check_akafile_dot_com_links){	
			var myakafileRegExp = /http\:\/\/(?:|www\.)akafile\.com\/[a-zA-Z0-9]{9,15}/;		
		}else{
			var myakafileRegExp = nonexistant____;
			} 
		if (Check_uploadscenter_dot_com_links){	
			var myuploadscenterRegExp = /http\:\/\/(?:|www\.)uploadscenter\.com\/[a-zA-Z0-9]{9,15}/;		
		}else{
			var myuploadscenterRegExp = nonexistant____;
			}			
		if (Check_project_dash_free_dash_upload_dot_com_links){	
			var myprojectfreeuploadRegExp = /http\:\/\/(?:|www\.)project-free-upload\.com\/[a-zA-Z0-9]{9,15}/;		
		}else{
			var myprojectfreeuploadRegExp = nonexistant____;
			} 
		if (Check_banashare_dot_com_links){	
			var mybanashareRegExp = /http\:\/\/(?:|www\.)banashare\.com\/[a-zA-Z0-9]{0,15}/;		
		}else{
			var mybanashareRegExp = nonexistant____;
			} 	
		if (Check_megafiles_dot_se_links){	
			var mymegafilesRegExp = /http\:\/\/(?:|www\.)megafiles\.se\/[a-zA-Z0-9]{5,15}/;		
		}else{
			var mymegafilesRegExp = nonexistant____;
			} 		
		if (Check_kingfiles_dot_net_links){	
			var mykingfilesRegExp = /http\:\/\/(?:|www\.)kingfiles\.net\/[a-zA-Z0-9]{9,15}/;		
		}else{
			var mykingfilesRegExp = nonexistant____;
			} 
		if (Check_videopremium_dot_me_links){	
			var myvideopremiumRegExp = /http\:\/\/(?:|www\.)videopremium\.(?:tv|me)\/[a-zA-z0-9]{9,15}/;		
		}else{
			var myvideopremiumRegExp = nonexistant____;
			}
//----------------------------------------------------------------------			 
			
		if (Check_turbobit_dot_net_links){	
			var myturbobitRegExp = /http\:\/\/(?:|www\.)turbobit\.net\/[a-zA-Z0-9]{9,15}/;		
		}else{
			var myturbobitRegExp = nonexistant____;
			} 
		if (Check_turbobit_dot_net_links){	
			var myhitfileRegExp = /http\:\/\/(?:|www\.)hitfile\.net\/[a-zA-Z0-9]{2,15}/;		
		}else{
			var myhitfileRegExp = nonexistant____;
			} 
		if (Check_lumfile_dot_com_links){	
			var mylumfileRegExp = /http\:\/\/(?:|www\.)lumfile\.com\/[a-zA-Z0-9]{9,15}/;		
		}else{
			var mylumfileRegExp = nonexistant____;
			} 
		if (Check_dspeedhost_dot_com_links){	
			var mydspeedhostRegExp = /http\:\/\/(?:|www\.)dspeedhost\.com\/[a-zA-Z0-9]{9,15}/;		
		}else{
			var mydspeedhostRegExp = nonexistant____;
			} 
		//if (Check_junocloud_dot_me_links){	
			//var myjunocloudRegExp = /http\:\/\/(?:|www\.)junocloud\.me\/[a-zA-Z0-9]{9,15}/;		
		//}else{
			//var myjunocloudRegExp = nonexistant____;
			//} 
		if (Check_junocloud_dot_me_links){	
			var myjunocloudRegExp = /http\:\/\/(?:|www\.)junocloud\.me\/[a-z0-9]{9,}/;		
		}else{
			var myjunocloudRegExp = nonexistant____;
			} 
		if (Check_mightyupload_dot_com_links){	
			var mymightyuploadRegExp = /http\:\/\/(?:|www\.)(?:mightyupload.com|uploadboy.com|4upfiles.com|sinhro.net|inafile.com|arabloads.com|usefile.com)\/[a-zA-Z0-9]{9,15}/;		
		}else{
			var mymightyuploadRegExp = nonexistant____;
			} 
		if (Check_terafile_dot_co_links){	
			var myterafileRegExp = /http\:\/\/(?:|www\.)terafile\.co\/[a-zA-Z0-9]{9,15}/;		
		}else{
			var myterafileRegExp = nonexistant____;
			} 
		if (Check_filecloud_dot_io_links){	
			var myfilecloudRegExp = /http\:\/\/(?:|www\.)filecloud\.io\/[a-zA-Z0-9]{8}/;		
		}else{
			var myfilecloudRegExp = nonexistant____;
			} 
		if (Check_unlimitzonedot_com_links){	
			var myunlimitzoneRegExp = /http\:\/\/(?:|www\.)unlimitzone\.com\/[a-zA-Z0-9]{9,15}/;		
		}else{
			var myunlimitzoneRegExp = nonexistant____;
			} 
		if (Check_uploadjet_dot_net_links){	
			var myuploadjetRegExp = /http\:\/\/(?:|www\.)uploadjet\.net\/[a-zA-Z0-9]{9,15}/;		
		}else{
			var myuploadjetRegExp = nonexistant____;
			} 
		if (Check_rockdizfile_dot_com_links){	
			var myrockdizfileRegExp = /http\:\/\/(?:|www\.)rockdizfile\.com\/[a-zA-Z0-9]{9,15}/;		
		}else{
			var myrockdizfileRegExp = nonexistant____;
			} 
		if (Check_fastsonic_dot_net_links){	
			var myfastsonicRegExp = /http\:\/\/(?:|www\.)fastsonic\.net\/[a-zA-Z0-9]{9,15}/;		
		}else{
			var myfastsonicRegExp = nonexistant____;
			} 
		if (Check_rocketfile_dot_net_links){	
			var myrocketfileRegExp = /http\:\/\/(?:|www\.)rocketfile\.net\/[a-zA-Z0-9]{9,15}/;		
		}else{
			var myrocketfileRegExp = nonexistant____;
			} 
		if (Check_filetug_dot_com_links){	
			var myfiletugRegExp = /http\:\/\/(?:|www\.)filetug\.com\/[a-zA-Z0-9]{9,15}/;		
		}else{
			var myfiletugRegExp = nonexistant____;
			} 
		if (Check_anafile_dot_com_links){
			var myanafileRegExp = /http\:\/\/(?:|www\.)anafile\.com\/[a-zA-Z0-9]{9,15}/;		
		}else{
			var myanafileRegExp = nonexistant____;
			}				
		if (Check_rapidfileshare_dot_net_links){	
			var myrapidfileshareRegExp = /http\:\/\/(?:|www\.)rapidfileshare\.net\/[a-zA-Z0-9]{9,15}/;		
		}else{
			var myrapidfileshareRegExp = nonexistant____;
			} 
		if (Check_sendmyway_dot_com_links){	
			var mysendmywayRegExp = /http\:\/\/(?:|www\.)sendmyway\.com\/[a-zA-Z0-9]{9,15}/;		
		}else{
			var mysendmywayRegExp = nonexistant____;
			} 
		if (Check_oteupload_dot_com_links){	
			var myoteuploadRegExp = /http(?:s|)\:\/\/(?:|www\.)oteupload\.com\/[a-zA-Z0-9]{9,15}/;		
		}else{
			var myoteuploadRegExp = nonexistant____;
			} 
		if (Check_tusfiles_dot_net_links){	
			var mytusfilesRegExp = /http\:\/\/(?:|www\.)tusfiles\.net\/[a-zA-Z0-9]{9,15}/;		
		}else{
			var mytusfilesRegExp = nonexistant____;
			} 
//-------------------------------------------------------------			
		if (Check_fileparadox_dot_in_links){	
			var myfileparadoxRegExp = /http(?:s|)\:\/\/(?:|www\.)fileparadox\.in\/[a-zA-Z0-9]{9,15}/;		
		}else{
			var myfileparadoxRegExp = nonexistant____;
			} 
		if (Check_epicshare_dot_net_links){	
			var myepicshareRegExp = /http\:\/\/(?:|www\.)epicshare\.net\/[a-zA-Z0-9]{9,15}/;		
		}else{
			var myepicshareRegExp = nonexistant____;
			} 
		if (Check_hugefiles_dot_net_links){	
			var myhugefilesRegExp = /http\:\/\/(?:|www\.)hugefiles\.net\/[a-zA-Z0-9]{9,15}/;		
		}else{
			var myhugefilesRegExp = nonexistant____;
			} 
		if (Check_fireget_dot_com_links){	
			var myfiregetRegExp = /http\:\/\/(?:|www\.)(?:fireget|upafile|uptobox|vidhog|billionuploads|filenuke)\.com\/.{3,9}/;		
		}else{
			var myfiregetRegExp = nonexistant____;
			} 
		if (Check_bayfiles_dot_net_links){		
			var mybayfilesRegExp = /http\:\/\/(?:|www\.)bayfiles\.net\/file\/.{2,8}\/.{3,9}/;		
		}else{
			var mybayfilesRegExp = nonexistant____;
			}	
		if (Check_bitshare_dot_com_links){		
			var mybitshareRegExp = /http\:\/\/(?:|www\.)bitshare\.com\/(?:files\/|.f=)[a-zA-Z0-9]{7,9}/;		
		}else{
			var mybitshareRegExp = nonexistant____;
			}
//------------------------------------------
		if (Check_netload_dot_in_links){
			var mynetloadinRegExp0 = /htt[ps]{1,2}(?:\:|%3A)(?:\/|%2F)(?:\/|%2F)(?:|www\.)netload\.in(?:\/|%2F)datei\w*(?:\/|%2F|).*?/;	
		} 
		if (Check_egofiles_dot_com_links){
			var myegofilesRegExp0 = /http(?:\:|%3A)(?:\/|%2F)(?:\/|%2F)(?:|www\.)egofiles\.com\/[0-9a-zA-Z]{16}/;	
		} 
		if (Check_filegag_dot_com_links){
			var myfilegagcomRegExp0 = /http(?:\:|%3A)(?:\/|%2F)(?:\/|%2F)(?:|www\.)filegag\.com\/.*?\S*\.html/;	
		} 
		if (Check_fileserve_dot_com_links){
			var myfileservecomRegExp0 = /http(?:\:|%3A)(?:\/|%2F)(?:\/|%2F)(?:|www\.)fileserve\.com\/file\/.*/;	
		} 
		if (Check_share_dash_online_dot_biz_links){
			var myshareonlineRegExp0 = /http(?:s|)(?:\:|%3A)(?:\/|%2F)(?:\/|%2F)(?:|www\.)share-online\.biz(?:\/|%2F)dl(?:\/|%2F)\w*/;	
		}			
		if (Check_hotfile_dot_com_links){
			var myhotfilecomRegExp0 = /http(?:s|)(?:\:|%3A)(?:\/|%2F)(?:\/|%2F)(?:|www\.)hotfile\.com\/dl\/\w*/;	
		}	
		...
		{	
			...
			if ((links[i].href.search(myfreakshareRegExp) != -1) && (!(links[i].id.match(checkedlinksRegExpid)))) {
				var urll = links[i].href;
				numberoffreakslinks++;
				urll = fixurl(urll,'freakshare');
				var myString = '' + numberoffreakslinks + '';
				if (myString.search(/\d00/) != -1) {
					allfreaks.push('xxxczxczxcsasdasdasdx4234');
				}
				allfreaks.push(urll);
			}			
			...
			if ((links[i].href.search(myshareonlineRegExp0) != -1) && (!(links[i].id.match(checkedlinksRegExpid)))) { 
				var urll = links[i].href;
				numberofsolinks++;
				urll = fixurl(urll,'share-online');
				var myString = '' + numberofsolinks + '';
				if (myString.search(/\d00/) != -1) {
					allso.push('xxxczxczxcsasdasdasdx4234');
				}
				allso.push(urll);
			}							
			...
			if ((links[i].href.search(myegofilesRegExp0) != -1) && (!(links[i].id.match(checkedlinksRegExpid)))) {
				var urll = links[i].href;
				numberofeflinks++;
				urll = fixurl(urll,'egofiles');
				var myString = '' + numberofeflinks + '';
				if (myString.search(/\d00/) != -1) {
					allef.push('xxxczxczxcsasdasdasdx4234');
				}
				allef.push(urll);
			}									
			if ((links[i].href.search(myfilegagcomRegExp0) != -1) && (!(links[i].id.match(checkedlinksRegExpid)))) {
				var urll = links[i].href;
				numberoffgaglinks++;
				urll = fixurl(urll,'filegag');
				var myString = '' + numberoffgaglinks + '';
				if (myString.search(/\d00/) != -1) {
					allfgag.push('xxxczxczxcsasdasdasdx4234');
				}
				allfgag.push(urll);
			}			
			...
			if ((links[i].href.search(mybanashareRegExp) != -1) && (!(links[i].id.match(checkedlinksRegExpid)))) {
				var urll = links[i].href;
				numberofbslinks++;
				urll = fixurl(urll,'banashare');
				var myString = '' + numberofbslinks + '';
				if (myString.search(/\d00/) != -1) {
					allbs.push('xxxczxczxcsasdasdasdx4234');
				}
				allbs.push(urll);
			}			
			if ((links[i].href.search(mymegafilesRegExp) != -1) && (!(links[i].id.match(checkedlinksRegExpid)))) {
				var urll = links[i].href;
				numberofmflinks++;
				urll = fixurl(urll,'banashare');
				var myString = '' + numberofmflinks + '';
				if (myString.search(/\d00/) != -1) {
					allmf.push('xxxczxczxcsasdasdasdx4234');
				}
				allmf.push(urll);
			}
			if ((links[i].href.search(myjunocloudRegExp) != -1) && (!(links[i].id.match(checkedlinksRegExpid)))) {
				var urll = links[i].href;
				urll = urll.replace(/(.*?(?:www.|)junocloud\.me\/)([a-z0-9]{12}\/).*$/g, "$1$2");
				numberofjclinks++;
				urll = fixurl(urll,'banashare');
				var myString = '' + numberofjclinks + '';
				if (myString.search(/\d00/) != -1) {
					alljc.push('xxxczxczxcsasdasdasdx4234');
				}
				alljc.push(urll);
			}
			if ((links[i].href.search(myturbobitRegExp) != -1) && (!(links[i].id.match(checkedlinksRegExpid)))) {
				var urll = links[i].href;
				numberoftblinks++;
				//urll = fixurl(urll,'banashare');
				var myString = '' + numberoftblinks + '';
				if ( (myString.search(/\d00/) != -1) ||  (myString.search(/50$/) != -1)){
					alltb.push('xxxczxczxcsasdasdasdx4234');
				}
				alltb.push(urll);
			}
			if ((links[i].href.search(myhitfileRegExp) != -1) && (!(links[i].id.match(checkedlinksRegExpid)))) {
				var urll = links[i].href;
				numberofhitflinks++;
				//urll = fixurl(urll,'banashare');
				var myString = '' + numberofhitflinks + '';
				if ( (myString.search(/\d00/) != -1) ||  (myString.search(/50$/) != -1)){
					allhitf.push('xxxczxczxcsasdasdasdx4234');
				}
				allhitf.push(urll);
			}
			if ((links[i].href.search(myfilecloudRegExp) != -1) && (!(links[i].id.match(checkedlinksRegExpid)))) {
				var urll = links[i].href;
				numberoffclinks++;
				var myString = '' + numberoffclinks + '';
				if ( (myString.search(/\d00/) != -1) ||  (myString.search(/50$/) != -1)){
					allfc.push('xxxczxczxcsasdasdasdx4234');
				}
				allfc.push(urll);
			}
					
			if ( ( (links[i].href.search(mykingfilesRegExp) != -1) 
					|| (links[i].href.search(myvideopremiumRegExp) != -1)  
					|| (links[i].href.search(mylumfileRegExp) != -1) 
					|| (links[i].href.search(mydspeedhostRegExp) != -1) 
					|| (links[i].href.search(myjunocloudRegExp) != -1) 
					|| (links[i].href.search(mymightyuploadRegExp) != -1) 
					|| (links[i].href.search(myterafileRegExp) != -1) 
					|| (links[i].href.search(myunlimitzoneRegExp) != -1) 
					|| (links[i].href.search(myuploadjetRegExp) != -1) 
					|| (links[i].href.search(myrockdizfileRegExp) != -1) 
					|| (links[i].href.search(myfastsonicRegExp) != -1) 
					|| (links[i].href.search(myrocketfileRegExp) != -1) 
					|| (links[i].href.search(myfiletugRegExp) != -1) 
					|| (links[i].href.search(myanafileRegExp) != -1) 
					|| (links[i].href.search(myrapidfileshareRegExp) != -1) 
					|| (links[i].href.search(mysendmywayRegExp) != -1) 
					|| (links[i].href.search(myoteuploadRegExp) != -1) 
					|| (links[i].href.search(mytusfilesRegExp) != -1) 					
					|| (links[i].href.search(myfileparadoxRegExp) != -1) 
					|| (links[i].href.search(myepicshareRegExp) != -1)
					|| (links[i].href.search(myhugefilesRegExp) != -1)
					|| (links[i].href.search(mysecureuploadRegExp) != -1)
					|| (links[i].href.search(myfileomRegExp) != -1)
					|| (links[i].href.search(myvidbullRegExp) != -1)
					|| (links[i].href.search(mymovreelRegExp) != -1)
					|| (links[i].href.search(mysalefilesRegExp) != -1)
					|| (links[i].href.search(mynirafileRegExp) != -1)
					|| (links[i].href.search(myakafileRegExp) != -1)
					|| (links[i].href.search(myuploadscenterRegExp) != -1)
					|| (links[i].href.search(myprojectfreeuploadRegExp) != -1)
					) 
				&& (!(links[i].id.match(checkedlinksRegExpid)))) {
				var urll = links[i].href;
				numberofkflinks++;
				var myString = '' + numberofkflinks + '';
				if (myString.search(/\d00/) != -1) {
					allkf.push('xxxczxczxcsasdasdasdx4234');
				}
				allkf.push(urll);
			}			
			if ((links[i].href.search(myfiregetRegExp) != -1) && (!(links[i].id.match(checkedlinksRegExpid)))) {
				var urll = links[i].href;				
				numberoffglinks++;
				var myString = '' + numberoffglinks + '';
				if (myString.search(/\d00/) != -1) {
					allfg.push('xxxczxczxcsasdasdasdx4234');
				}
				allfg.push(urll);
			}
			if ((links[i].href.search(mybitshareRegExp) != -1) && (!(links[i].id.match(checkedlinksRegExpid)))) {
				var urll = links[i].href;		
				numberofbitslinks++;
				var myString = '' + numberofbitslinks + '';
				if (myString.search(/\d00/) != -1) {
					allbits.push('xxxczxczxcsasdasdasdx4234');
				}
				allbits.push(urll);
			}
			if ((links[i].href.search(mybayfilesRegExp) != -1) && (!(links[i].id.match(checkedlinksRegExpid)))) {
				var urll = links[i].href;		
				urll = urll.replace(/(^.*(www.|)bayfiles\.net\/file)(\/.*\/.*)(\/.*)/g, "$3");		
				numberofbflinks++;
				var myString = '' + numberofbflinks + '';
				if (myString.search(/\d00/) != -1) {
					allbf.push('xxxczxczxcsasdasdasdx4234');
				}
				allbf.push(urll);	
			}
											
			if ((links[i].href.search(myryushareRegExp) != -1) && (!(links[i].id.match(checkedlinksRegExpid)))) {
				var urll = links[i].href;		
				numberofrylinks++;
				urll = fixurl(urll,'ryushare');
				var myString = '' + numberofrylinks + '';
				if (myString.search(/\d00/) != -1) {
					allry.push('xxxczxczxcsasdasdasdx4234');
				}
				allry.push(urll);
			}
				
			if ((links[i].href.search(mymegauploadRegExp0) != -1) && (!(links[i].id.match(checkedlinksRegExpid)))) { 
				var urll = links[i].href;
				numberofmulinks++;	
				urll = urll.match(/mega\.co\.nz\/\#\!(\w+)(?:!\w+)?/)[1];
				urll = '{"a":"g","p":"' + urll + '"}';
				urll = urll.replace(/%2F/gi, '/');
				urll = urll.replace(/%3A/gi, ':');
		...
		allfreaks = allfreaks.join();
		allfreaks = allfreaks.replace(/,/gi, '\r\n');
		var allfreaks = allfreaks.split("xxxczxczxcsasdasdasdx4234");
		...
		allef = allef.join();
		allef = allef.replace(/,/gi, '\n');
		var allef = allef.split("xxxczxczxcsasdasdasdx4234");	
		
		allfgag = allfgag.join();
		allfgag = allfgag.replace(/,/gi, '\n');
		var allfgag = allfgag.split("xxxczxczxcsasdasdasdx4234");	
		
		allfg = allfg.join();
		allfg = allfg.replace(/,/gi, '\n');
		var allfg = allfg.split("xxxczxczxcsasdasdasdx4234");	
		
		allsu = allsu.join();
		allsu = allsu.replace(/,/gi, '\n');
		var allsu = allsu.split("xxxczxczxcsasdasdasdx4234");	
		
		allbs = allbs.join();
		allbs = allbs.replace(/,/gi, '\n');
		var allbs = allbs.split("xxxczxczxcsasdasdasdx4234");
			
		allmf = allmf.join();
		allmf = allmf.replace(/,/gi, '\n');
		var allmf = allmf.split("xxxczxczxcsasdasdasdx4234");
		
		allbits = allbits.join();
		allbits = allbits.replace(/,/gi, '\n');
		var allbits = allbits.split("xxxczxczxcsasdasdasdx4234");	
		
		allkf = allkf.join();
		allkf = allkf.replace(/,/gi, '\n');
		var allkf = allkf.split("xxxczxczxcsasdasdasdx4234");	
		...
		alljc = alljc.join();
		alljc = alljc.replace(/,/gi, '\n');
		var alljc = alljc.split("xxxczxczxcsasdasdasdx4234");	
							
		alltb  = alltb.join();
		alltb  = alltb.replace(/,/gi, '\n');
		var alltb  = alltb.split("xxxczxczxcsasdasdasdx4234");
		
		allhitf  = allhitf.join();
		allhitf  = allhitf.replace(/,/gi, '\n');
		var allhitf  = allhitf.split("xxxczxczxcsasdasdasdx4234");
				
		//allfc  = allfc.join();
		//allfc  = allfc .replace(/,/gi, '\n');
		//allfc  = allfc.split(",");
		
		allry = allry.join();
		allry = allry.replace(/,/gi, '\n');
		var allry = allry.split("xxxczxczxcsasdasdasdx4234");						
		...
		allso = allso.join();
		allso = allso.replace(/,/gi, '\n');
		var allso = allso.split("xxxczxczxcsasdasdasdx4234");	
		...
		allbf = allbf.join();
		allbf = allbf.replace(/,/gi, '');
		var allbf = allbf.split("xxxczxczxcsasdasdasdx4234");
		
		if (((numberofrslinks > 0) || (numberofbflinks > 0) || (numberofhflinks > 0) || (numberofsolinks > 0) || (numberoffclinks > 0) || (numberofuplinks > 0) || (numberoffjlinks > 0)  || (numberoffreakslinks > 0) || (numberoffgaglinks > 0) || (numberoffglinks > 0) || (numberofbslinks > 0) ||  (numberofmflinks > 0 ) || (numberofjclinks > 0) || (numberofbitslinks > 0) || (numberoftblinks > 0) || (numberofhitflinks > 0) || (numberofkflinks > 0) ||  (numberofnllinks > 0) || (numberoffslinks > 0) || (numberofsulinks>0) || (numberofrylinks >0) || (numberofmulinks > 0)) && !(document.getElementsByTagName('RSLC')[0])) {
			add_RSLC_style();
		}
		if (numberofrslinks > 0) { 
			getlinkschecked(all); 
		}
		if (numberoffreakslinks > 0) {
			getfreakslinkschecked(allfreaks);
		}
		if (numberofnllinks > 0) {
			getnllinkschecked(allnl);
		}
		if (numberofeflinks > 0) {
			geteflinkschecked(allef);
		}
		if (numberoffglinks > 0) {
			getfglinkschecked(allfg);
		}
		if (numberoffslinks > 0) {
			getfslinkschecked(allfs);
		}
		if (numberofsulinks > 0) {
			getsulinkschecked(allsu);
		}
		if (numberoftblinks > 0) {
			gettblinkschecked(alltb);
		}
		if (numberofhitflinks>0){
			gettblinkschecked(allhitf);
			}
		if (numberoffclinks >0){
			for (var i = allfc.length - 1; i >= 0; i--)
			{
			getfilecloudlinkschecked(allfc[i]);
			}
		}
		if (numberofbslinks > 0) {
			getfglinkschecked(allbs);
		}
		if (numberofmflinks > 0) {
			getkflinkschecked(allmf);
		}
		if (numberofbitslinks > 0){
			getbitslinkschecked(allbits);
			}		
		
		if (numberofjclinks > 0) {
			getjclinkschecked(alljc);
		}
		if (numberofkflinks > 0) {
			getkflinkschecked(allkf);
		}
		if (numberoffgaglinks > 0) {
			getfgaglinkschecked(allfgag);
		}
		if (numberofrylinks >0 ){
			getrylinkschecked(allry);
			//getkflinkschecked(allry);
		}			
		if (numberofuplinks > 0) {
			getuplinkschecked(allup);
		}	
		if (numberofsolinks	> 0) {
			getsolinkschecked(allso);
		}								
		...
		if (numberofbflinks > 0) {
			getbflinkschecked(allbf);
		}
		...
		function getfreakslinkschecked(all)
		{
			for (var i = all.length - 1; i >= 0; i--) {
				GM_xmlhttpRequest(
				{
					method: "POST",
					url: 'http://freakshare.com/linkcheck.html',
					headers: {
						'User-agent': 'Mozilla/4.0 (compatible) Greasemonkey',
						'Content-type': 'application/x-www-form-urlencoded',
						'Referer': "http://freakshare.com/linkcheck.html" 
					},
					data: 'links=' + encodeURIComponent(all[i])+'&submit=V%C3%A9rifier',
					onload: function(result)
					{
						...
						res = res.replace(/\n/g, ''); 
						res = res.replace(/ {2,}/g, " ");
						livelink = res.match(/ru_2\.gif" \/><\/div><span style="font-size:14px;font-weight:bold;">(filename|.*?)<\/span><\/p><p><a href="http.*?files\/(id|.*?)\/.*?" target="_blank">/g);
						notfound = res.match(/ru_3\.gif" \/><\/div><span style="font-size:14px;font-weight:bold;">(?:filename|.*?)<\/span><\/p><p><a href="http.*?files\/(id|.*?)\/.*?" target="_blank">/g);
	
						if (notfound) {
							var fotfoundlinks = new Array();
							for (var i = notfound.length - 1; i >= 0; i--) {
								var string = notfound[i];
								var regex = /ru_3\.gif" \/><\/div><span style="font-size:14px;font-weight:bold;">(?:filename|.*?)<\/span><\/p><p><a href="http.*?files\/(id|.*?)\/.*?" target="_blank">/;
						...
						if (livelink) {
							...
							for (var i = livelink.length - 1; i >= 0; i--) {
								var string = livelink[i];
								var regex2 = /ru_2\.gif" \/><\/div><span style="font-size:14px;font-weight:bold;">(filename|.*?)<\/span><\/p><p><a href="http.*?files\/(id|.*?)\/.*?" target="_blank">/;
								matchArraylive = string.match(regex2);
								livelinklinks.push(matchArraylive[1]);
								livelinklinksplus.push('+%%+id=' + matchArraylive[2] + '+%%+size=' + matchArraylive[3] + '+%%+name=' + matchArraylive[1] + '+%%+##');
							}
							if (livelinklinksplus) {
								DiplayTheMULiveLinks(livelinklinksplus);
							}
		...
		function getjclinkschecked(all)
        {
			for (var i = all.length - 1; i >= 0; i--)
			{
				var dataposted = 'op=checkfiles&list='+ encodeURI(all[i]) +'&process=Check+URLs';
				var urlposted = 'http://junocloud.me/?op=checkfiles';
				//var liveres = "\"_blank\">http://junocloud.me/([a-zA-Z0-9]{12})(?:/(.*?)\.html|)</a> .*?Found</span> (\\d.*?)</div>";
				var liveres = "\"_blank\">http://junocloud.me/([a-zA-Z0-9]{12})\/</a> .*?Found</span> (\\d.*?)</div>";
				//var notfoundres = ">http://junocloud.me/([a-zA-Z0-9]{12})(?:/.*?\.html|)</a> .*?Not found";
				var notfoundres = ">http://junocloud.me/([a-zA-Z0-9]{12})/</a> .*?Not found";
				GM_xmlhttpRequest(
				{
					method: "post",
					url: urlposted,
					...
					{
						res = result.responseText;
						notfound = res.match(notfoundres,"g"); 
						
				//var liveres = "\"_blank\">http://junocloud.me/([a-zA-Z0-9]{12})(?:/(.*?)\.html|)</a> .*?Found</span> (\\d.*?)</div>";
						//var liveres = "http://junocloud.me/([a-zA-Z0-9]{12})(?:/(.*?)\.html|)</a> .*?Found</span> (\d.*?)</div>";
						//livelink = res.match(/http:\/\/junocloud.me\/([a-zA-Z0-9]{12})(?:\/(.*?)\.html|)<\/a> .*?Found<\/span> (\d.*?)<\/div>/g); 
						//var liveres = new RegExp(liveres, "g");
						//livelink = res.match(liveres,"g"); 
						//var livelink = res.match(livelinkregexxx);	
						livelink = res.match(liveres,"g");				
						if (notfound) {
								var fotfoundlinks = new Array();
								for (var i = notfound.length - 1; i >= 0; i--) {
									var string = notfound[i];
								//	var regex = /\.net\/([0-9a-zA-Z]{9,14}).*?, 0/;
									matchArrayff = string.match(notfoundres);
									matchArrayfflink = matchArrayff[1];
									fotfoundlinks.push(matchArrayfflink);
								}
								if (fotfoundlinks) {
						...
						if (livelink) {
							...
							for (var i = livelink.length - 1; i >= 0; i--) {
								var string = livelink[i];
								//var regex2 = /\.net\/([0-9a-zA-Z]{9,14}).*?, 1/;
								//var liveres = "\"_blank\">http://junocloud.me/([a-zA-Z0-9]{12})/.?</a> .*?Found</span> (\\d.*?)</div>";
								matchArraylive = string.match(liveres);
								livelinklinks.push(matchArraylive[1]);	
								livelinklinksplus.push('+%%+id=' + matchArraylive[1] + '+%%+size=' + matchArraylive[3] + '+%%+name=' + matchArraylive[2] + '+%%+##');
							}
							if (livelinklinksplus) {
		...
		function getfilecloudlinkschecked(all){
				var id =all.match(/filecloud\.io\/([a-z0-9]{8})/)[1];
				var data =  "ukey="+id;
				GM_xmlhttpRequest(
				{
					method: "post",
					...
					{
						res = result.responseText;
						notfound = res.match(/{"status":"error","message":"no such file"}/g); 
						livelink = res.match(/{"message":"fetched","ukey":"([0-9a-zA-Z]{8})","name":"(.*?)","size":"(.*?)","status":"ok"}/g); 				
						if (notfound) {
								var fotfoundlinks = new Array();
								//for (var i = notfound.length - 1; i >= 0; i--) {
									//var string = notfound[i];
									//var regex = /{"status":"error","message":"no such file"}/;
									//matchArrayff = string.match(regex);
									//matchArrayfflink = matchArrayff[1];
									//fotfoundlinks.push(matchArrayfflink);
									fotfoundlinks.push(id);
								//}
								if (fotfoundlinks) {
									DiplayTheDeletedLinks(fotfoundlinks);
								}
						...
						if (livelink) {
							...
							for (var i = livelink.length - 1; i >= 0; i--) {
								var string = livelink[i];
								var regex2 = /{"message":"fetched","ukey":"([0-9a-zA-Z]{8})","name":"(.*?)","size":"(.*?)","status":"ok"}/;
								matchArraylive = string.match(regex2);
								livelinklinks.push(matchArraylive[1]);
								livelinklinksplus.push('+%%+id=' + matchArraylive[1] + '+%%+size=' + matchArraylive[3] + '+%%+name=' + matchArraylive[2] + '+%%+##');
							}
        ...
        function gettblinkschecked(all)
        {
			for (var i = all.length - 1; i >= 0; i--)
			{
				data="links_to_check="+encodeURI(all[i]);
				
				if (all[i].match(/turbobit\.net\//)){
					var domainchecklinkurl = "turbobit.net";
					}else{
					var domainchecklinkurl = "hitfile.net";	
						}
						
				GM_xmlhttpRequest(
				{
					method: "post",
					url: 'http://'+domainchecklinkurl+'/linkchecker/csv',
					headers: {
						"Content-type": "application/x-www-form-urlencoded"
					},
					data: data,
					...
					{
						res = result.responseText;
						notfound = res.match(/\.net\/([0-9a-zA-Z]{3,14}).*?, 0/g); 
						livelink = res.match(/\.net\/([0-9a-zA-Z]{3,14}).*?, 1/g); 				
						if (notfound) {
								var fotfoundlinks = new Array();
								for (var i = notfound.length - 1; i >= 0; i--) {
									var string = notfound[i];
									var regex = /\.net\/([0-9a-zA-Z]{3,14}).*?, 0/;
									matchArrayff = string.match(regex);
									matchArrayfflink = matchArrayff[1];
									fotfoundlinks.push(matchArrayfflink);
								}
						...
						if (livelink) {
							...
							for (var i = livelink.length - 1; i >= 0; i--) {
								var string = livelink[i];
								var regex2 = /\.net\/([0-9a-zA-Z]{3,14}).*?, 1/;
								matchArraylive = string.match(regex2);
								livelinklinks.push(matchArraylive[1]);
								livelinklinksplus.push('+%%+id=' + matchArraylive[1] + '+%%+size=' + matchArraylive[3] + '+%%+name=' + matchArraylive[2] + '+%%+##');
							}
        ...
        function getsolinkschecked(all)
        {
			for (var i = all.length - 1; i >= 0; i--)
			{
				data="links="+encodeURIComponent(all[i].toUpperCase());
				GM_xmlhttpRequest(
				{
					method: "post",
					...
					{
						res = result.responseText;
						notfound = res.match(/([0-9a-zA-Z]{9,14});NOTFOUND;/g); 
						livelink = res.match(/([0-9a-zA-Z]{9,14});OK;(.*?);(\d*)/g); 			
						if (notfound) {
								var fotfoundlinks = new Array();
								for (var i = notfound.length - 1; i >= 0; i--) {
									var string = notfound[i];
									var regex = /([0-9a-zA-Z]{9,14});NOTFOUND;/;
									matchArrayff = string.match(regex);
									matchArrayfflink = matchArrayff[1];
									fotfoundlinks.push(matchArrayfflink);
								}
						...
						if (livelink) {
							...
							for (var i = livelink.length - 1; i >= 0; i--) {
								var string = livelink[i];
								var regex2 = /([0-9a-zA-Z]{9,14});OK;(.*?);(\d*)/;
								matchArraylive = string.match(regex2);
								livelinklinks.push(matchArraylive[1]);
								livelinklinksplus.push('+%%+id=' + matchArraylive[1] + '+%%+size=' + matchArraylive[3] + '+%%+name=' + matchArraylive[2] + '+%%+##');
							}
	...
	function geteflinkschecked(all)
		{			
			for (var i = all.length - 1; i >= 0; i--) {
				...
				{
					method: "GET",
					url: "http://egofiles.com/ajax/checker.php?string=" + encodeURIComponent(all[i]),
					headers: {
						'User-agent': 'Mozilla/4.0 (compatible) Greasemonkey',
						'Content-type': 'application/x-www-form-urlencoded',
						'Referer': 'http://egofiles.com/checker'
					},
					onload: function(result)
					{						
						res = result.responseText;
						res = res.replace(/\\\//g, '/'); 
						var liveregex=new RegExp("egofiles\\.com\/([0-9a-zA-Z]{16})([^\"]*?)\",\"status\":\"OK","g");
						var liveregex0 = /egofiles\.com\/([0-9a-zA-Z]{16})([^"]*?)","status":"OK/;
						livelink = res.match(liveregex);
						notfound = res.match(/egofiles\.com\/([0-9a-zA-Z]{16})([^"]*?)","status":"ERROR/g);
						
						if (notfound) {
							var fotfoundlinks = new Array();
							for (var i = notfound.length - 1; i >= 0; i--) {
								var string = notfound[i];
								var regex = /egofiles\.com\/([0-9a-zA-Z]{16})([^"]*?)","status":"ERROR/;
								matchArrayff = string.match(regex);
								fotfoundlinks.push(matchArrayff[1]);
							}
							if (fotfoundlinks) {
						...
						if (livelink) {
							...
							for (var i = livelink.length - 1; i >= 0; i--) {
								var string = livelink[i];
								var regex2 = /egofiles\.com\/([0-9a-zA-Z]{16})([^"]*?)","status":"OK/g;
								matchArraylive = liveregex0.exec(string);
								livelinklinks.push(matchArraylive[1]);
								livelinklinksplus.push('+%%+id=' + matchArraylive[1] + '+%%+size=' + matchArraylive[3] + '+%%+name=' + matchArraylive[2] + '+%%+##');
							}
							if (livelinklinksplus) {
	 ...
	 function getfgaglinkschecked(all)
		{
			...
			for (var i = all.length - 1; i >= 0; i--) {
				...
				{
					method: "POST",
					url: 'http://filegag.com/?op=checkfiles',
					headers: {
						'User-agent': 'Mozilla/4.0 (compatible) Greasemonkey',
						'Content-type': 'application/x-www-form-urlencoded'
					},
					data: 'list=' + encodeURIComponent(all[i]) + "&op=checkfiles&process=Check+URLs",
					onload: function(result)
					{
						...
						res = res.replace(/\r\n/g, ''); 
						res = res.replace(/\n/g, ''); 
						livelink = res.match(/class="greenCheck"><\/div><div class="innerText"><h1 class="name">(.*?) \((.*?)\)<\/h1><p>http:\/\/www.filefactory.com\/file\/(.*?)\/n\/(?:.*?)<\/p><p class="hidden size">/g);
						notfound = res.match(/redThumb"><\/div><div class="innerText"><h1>http:\/\/www.filefactory.com\/file\/(.*?)\/<\/h1>/g);
						
						if (notfound) {
							var fotfoundlinks = new Array();
							for (var i = notfound.length - 1; i >= 0; i--) {
								var string = notfound[i];
								var regex = /redThumb"><\/div><div class="innerText"><h1>http:\/\/www.filefactory.com\/file\/(.*?)<\/h1>/;
								matchArrayff = string.match(regex);
						...
						if (livelink) {
							...
							for (var i = livelink.length - 1; i >= 0; i--) {
								var string = livelink[i];
								var regex2 = /class="greenCheck"><\/div><div class="innerText"><h1 class="name">(.*?) \((.*?)\)<\/h1><p>http:\/\/www.filefactory.com\/file\/(.*?)\/n\/(?:.*?)<\/p><p class="hidden size">/;
								matchArraylive = string.match(regex2);
								livelinklinks.push(matchArraylive[1]);
								livelinklinksplus.push('+%%+id=' + matchArraylive[3] + '+%%+size=' + matchArraylive[2] + '+%%+name=' + matchArraylive[1] + '+%%+##');
							}
							if (livelinklinksplus) {
								DiplayTheMULiveLinks(livelinklinksplus);
							}
					...
					onload: function(result)
					{
						...
						if (notfound) {
							...
							for (var i = notfound.length - 1; i >= 0; i--) {
								...
								matchArrayfflink = "datei" + matchArrayff[1];
								fotfoundlinks.push(matchArrayfflink);
							}
							if (fotfoundlinks) {								
								DiplayTheDeletedLinks(fotfoundlinks);
	 ...
	 function getrylinkschecked(all)
		{
			for (var i = all.length - 1; i >= 0; i--)
			{
				GM_xmlhttpRequest(
				{
					method: "POST",
					url: "http://ryushare.com/checkfiles.python",
					data: "op=checkfiles&list="+ encodeURIComponent(all[i])+'&process=Check+URLs',
					headers: {
					"Content-Type": "application/x-www-form-urlencoded"
					},
					onload: function(result)
					{						
						res = result.responseText;
						//console.log(res);
						//livelink = res.match(/<font color='green'>htt.{1,2}:\/\/(?:|www\.)ryushare.com\/(\w*)(?:\/|)(.*?) found/g);
						livelink = res.match(/<font color='green'>htt.{1,2}:\/\/(?:|www\.).*?\/(\w*)(?:\/|)(.*?|) found/g);
						//notfound = res.match(/<font color='red'>htt.{1,2}:\/\/(?:|www\.)ryushare.com\/(\w*).*? not found/g); 
						notfound = res.match(/<font color='red'>htt.{1,2}:\/\/(?:|www\.).*?\/(\w*)(?:\/|)(.*?|) (?:not found)/g); 
						if (notfound) {
							var fotfoundlinks = new Array();
							for (var i = notfound.length - 1; i >= 0; i--) {
								var string = notfound[i];
								//var regex = /<font color='red'>htt.{1,2}:\/\/(?:|www\.)ryushare.com\/(\w*).*? not found/; 
								var regex = /<font color='red'>htt.{1,2}:\/\/(?:|www\.).*?\/(\w*)(?:\/|)(.*?|) (?:not found)/; 
								matchArrayff = string.match(regex);
								matchArrayfflink = matchArrayff[1];
								fotfoundlinks.push(matchArrayfflink);
							}
						...
						if (livelink) {
							...
							for (var i = livelink.length - 1; i >= 0; i--) {
								var string = livelink[i];								
								//var regex2 = /<font color='green'>htt.{1,2}:\/\/(?:|www\.)ryushare.com\/(\w*)(?:\/|)(.*?) found/;
								var regex2 = /<font color='green'>htt.{1,2}:\/\/(?:|www\.).*?\/(\w*)(?:\/|)(.*?|) found/;
								matchArraylive = string.match(regex2);
								livelinklinks.push(matchArraylive[1]);
								livelinklinksplus.push('+%%+id=' + matchArraylive[1] + '+%%+size=' + matchArraylive[3] + '+%%+name=' + matchArraylive[2] + '+%%+##');
							}
	...
	function isset ()
	{
	 ...
	 function fnGetDomain(url) {
			return (url.match(/:\/\/(.[^/]+)\/[a-zA-Z0-9]{8,}/)[1]).replace('www.','');
		}		
	 function getkflinkschecked(all)
		{			
			var alldomains = new Array();
			for (var i = all.length - 1; i >= 0; i--){
				var allsplit = all[i].split("\n"); 
				var domain,thislink;
				
				for (var ii = allsplit.length - 1; ii >= 0; ii--) {
					if (allsplit[ii]!=""){
						domain = fnGetDomain(allsplit[ii]);
						ragexd = domain+"\/[a-zA-Z0-9]{10,15}";
						ragexdt=new RegExp(ragexd);
						thislink = allsplit[ii].match(ragexdt);
						if (thislink) {
							if(isset(alldomains[domain])){
							//dalldomains[domain] +="\n"+allsplit[ii];
							alldomains[domain] +="\nhttp://"+thislink[0];
							}else{
							//alldomains[domain] =allsplit[ii];
							alldomains[domain] ="http://"+thislink[0];		
							}
						}
					}
				}
				...
				for (key in alldomains) {				
					if ((key ==	"kingfiles.net"	) || (key == "epicshare.net") || (key == "fastsonic.net") || (key == "rocketfile.net") || (key == "filetug.com") || (key == "anafile.com") || (key == "rapidfileshare.net") || (key == "sendmyway.com") || (key == "tusfiles.net") || (key == "secureupload.eu") || (key == "nirafile.com" ) || (key == "arabloads.com" ) ){
						url =  "http://www."+key+"/?op=checkfiles";
						getopcheckfilescomplex(alldomains[key],url);
					}else if ( (key == "lumfile.com") || (key == "videopremium.tv") || (key == "hugefiles.net" ) || (key == "mightyupload.com" ) || (key == "usefile.com" )  || (key == "inafile.com" ) || (key == "sinhro.net" )  || (key == "4upfiles.com" ) || (key == "uploadboy.com" ) || (key == "terafile.co" ) || (key == "unlimitzone.com" ) || (key == "uploadjet.net" ) || (key == "rockdizfile.com" ) || (key == "dspeedhost.com" )  || (key == "junocloud.me" ) || (key == "fileom.com" ) || (key == "vidbull.com" ) || (key == "movreel.com" ) || (key == "salefiles.com" ) || (key == "megafiles.se" ) || (key == "project-free-upload.com" ) || (key == "akafile.com" )  || (key == "uploadscenter.com" ) ){
						keyv = key.replace(/videopremium.(tv|net)/,'videopremium.me');
						url =  "http://"+keyv+"/?op=checkfiles";
						regexlive = '" target="_blank">htt.*?\/([a-zA-Z0-9]{10,15})</a> <span style="color: green; padding: 0 18px;">Found</span> (\d*.*?)</div>';
						getopcheckfilescomplex(alldomains[key],url);
					}else if ( ( key == "fileparadox.in") || (key == "oteupload.com")  ){
						url =  "https://"+key+"/?op=checkfiles";
						getopcheckfilescomplex(alldomains[key],url);
					}
					//else if ( key == "ryushare.com") {
						////url =  "https://"+key+"/?op=checkfiles";
						
					//url= "http://ryushare.com/checkfiles.python";
						////var regexlive = '<tr><td>htt.*?\/([a-zA-Z0-9]{10,15})<\/td><td style="color:green;">Found<\/td><td>(\d*.*?)<\/td><\/tr>';
						//regexlive = "<font color='green'>htt.{1,2}:\/\/(?:|www\.).*?\/(\w*)(?:\/|)(.*?|) found";						
						////regexnotfound = '<tr><td>htt.*?\/([a-zA-Z0-9]{10,15})<\/td><td style="color:red;';
						//regexnotfound = '<font color=\'red\'>htt.{1,2}:\/\/(?:|www\.).*?\/(\w*)(?:\/|)(.*?|) (?:not found)';
						//getopcheckfilescomplex(alldomains[key],url,regexlive,regexnotfound);
						//}
				}				
			}
	 function getopcheckfilescomplex(all,url)
		{
                var allsplited = all.split("\n"); 
				var regexlive = '<tr><td>htt.*?\/([a-zA-Z0-9]{10,15})<\/td><td style="color:green;">Found<\/td><td>(\d*.*?)<\/td><\/tr>';
				var regexnotfound = '<tr><td>htt.*?\/([a-zA-Z0-9]{10,15})<\/td><td style="color:red;';
				GM_xmlhttpRequest(
				{
					method: "POST",
					url: url,
					data: 'op=checkfiles&list='+ encodeURIComponent(all) +'&process=Check+URLs',
					headers: {
					"Content-Type": "application/x-www-form-urlencoded"
					},
					onload: function(result)
					{						
						res = result.responseText;
						livelink = res.match(regexlive,"g");
						//notfound = res.match(/<tr><td>htt.*?\/([a-zA-Z0-9]{10,15})<\/td><td style="color:red;/g);
						notfound = res.match(regexnotfound,"g");
						if (notfound) {
							var fotfoundlinks = new Array();
							for (var i = notfound.length - 1; i >= 0; i--) {
								var string = notfound[i];
						        //var regex = /<tr><td>htt.*?\/([a-zA-Z0-9]{10,15})<\/td><td style="color:red;/; 
								//matchArrayff = string.match(regex);
								matchArrayff = string.match(regexnotfound);
								matchArrayfflink = matchArrayff[1];
								fotfoundlinks.push(matchArrayfflink);
							}
							if (fotfoundlinks) {
						...
						if (livelink) {
							...
							for (var i = livelink.length - 1; i >= 0; i--) {
								var string = livelink[i];	
								matchArraylive = string.match(regexlive);
								livelinklinks.push(matchArraylive[1]);
								livelinklinksplus.push('+%%+id=' + matchArraylive[1] + '+%%+size=' + matchArraylive[2] + '+%%+name=' + matchArraylive[3] + '+%%+##');
							}
							if (livelinklinksplus) {
								DiplayTheMULiveLinks(livelinklinksplus);
							} 
	 ...
	 function getbitslinkschecked(all)
		{
			for (var i = all.length - 1; i >= 0; i--)
			{
				GM_xmlhttpRequest(
				{
					method: "POST",
					url: "http://bitshare.com/api/openapi/general.php",
					data: 'action=getFileStatus&files='+ encodeURIComponent(all[i]),
					headers: {
					"Content-Type": "application/x-www-form-urlencoded"
					},
					onload: function(result)
					{						
						res = result.responseText;
						livelink = res.match(/\.com\/(?:files\/|.f=)(?:[a-zA-Z0-9]{8})\/.*?#online#([a-zA-Z0-9]{8})#(.*?)#(\d{1,})/g);
						notfound = res.match(/\.com\/(?:files\/|.f=)([a-zA-Z0-9]{8})\/.*?#offline/g); 
						if (notfound) {
							var fotfoundlinks = new Array();
							for (var i = notfound.length - 1; i >= 0; i--) {
								var string = notfound[i];
								var regex = /\.com\/(?:files\/|.f=)([a-zA-Z0-9]{8})\/.*?#offline/; 
								matchArrayff = string.match(regex);
								matchArrayfflink = matchArrayff[1];
								fotfoundlinks.push(matchArrayfflink);
							}
						...
						if (livelink) {
							...
							for (var i = livelink.length - 1; i >= 0; i--) {
								var string = livelink[i];								
								var regex2 = /\.com\/(?:files\/|.f=)(?:[a-zA-Z0-9]{8})\/.*?#online#([a-zA-Z0-9]{8})#(.*?)#(\d{1,})/;
								matchArraylive = string.match(regex2);
								livelinklinks.push(matchArraylive[1]);
								livelinklinksplus.push('+%%+id=' + matchArraylive[1] + '+%%+size=' + matchArraylive[3] + '+%%+name=' + matchArraylive[2] + '+%%+##');
							}
	 ...
	 function getfglinkschecked(all)
		{
			for (var i = all.length - 1; i >= 0; i--)
			{
				if (all[i].match(/fireget\.com/)){
					url = "http://www.fireget.com/?op=checkfiles";
				}else if (all[i].match(/banashare\.com/i)){
					url = "http://www.banashare.com/?op=checkfiles";						
					}	else if (all[i].match(/upafile\.com/i)){
					url = "http://upafile.com/?op=checkfiles";						
					}		else if (all[i].match(/uptobox\.com/i)){
					url = "http://uptobox.com/?op=checkfiles";						
					}		else if (all[i].match(/vidhog\.com/i)){
					url = "http://www.vidhog.com/?op=checkfiles";									
					}		else if (all[i].match(/billionuploads\.com/i)){
					url = "http://billionuploads.com/?op=checkfiles";			
					}		else if (all[i].match(/filenuke\.com/i)){
					url = "http://filenuke.com/?op=checkfiles";						
					}
				...
				GM_xmlhttpRequest(
				{
					...
					{						
						res = result.responseText;
						livelink = res.match(/<font color='green'>(htt.*?) /gi);
						notfound = res.match(/<font color='red'>(htt.*?) /gi); 
						if (notfound) {
							var fotfoundlinks = new Array();
							for (var i = notfound.length - 1; i >= 0; i--) {
								var string = notfound[i];
							//	var regex = /<font color='red'>(htt.*?) /; 
								var regex = /<font color='red'>http(?:|s):\/\/(?:www\.|).*?\/(.*?) /;
								matchArrayff = string.match(regex,'i');
								matchArrayfflink = matchArrayff[1];
								fotfoundlinks.push(matchArrayfflink);
							}
							if (fotfoundlinks) {
						...
						if (livelink) {
							...
							for (var i = livelink.length - 1; i >= 0; i--) {
								var string = livelink[i];								
							//	var regex2 = /<font color='green'>(htt.*?) /;		
								var regex2 = /<font color='green'>http(?:|s):\/\/(?:www\.|).*?\/(.*?) /;
								matchArraylive = string.match(regex2,'i');
								livelinklinks.push(matchArraylive[1]);
								livelinklinksplus.push('+%%+id=' + matchArraylive[1] + '+%%+size=' + matchArraylive[3] + '+%%+name=' + matchArraylive[2] + '+%%+##');
							}
							if (livelinklinksplus) {
	 ...
	 function getnllinkschecked2(all)
		...
		function getbflinkschecked(allbf)
		{
			for (var i = allbf.length - 1; i >= 0; i--) {
				...
				{
					method: "get",
					url: 'http://api.bayfiles.net/v1/file/info'+datas,
					headers: {
						'User-agent': 'Mozilla/4.0 (compatible) Greasemonkey',
					...
					onload: function(result){
						res = result.responseText;
						res = res.replace(/\{"error":"",/g,"");
						res = res.replace(/\}$/g,"");
						res = res.replace(/,"sha1":"[a-z0-9]{40}","/g," ");
						res = res.replace(/"/g,"");
						res = res.replace(/\n/g,"");					
						var recieved = new Array();
						recieved = res.split(',');						
						var pagelinks = new Array();						
						datas = datas.replace(/(\/.{4}\/.{6})/g,"$1,");						
						pagelinks = datas.split(',');
						pagelinks.pop();
						var livelinklinksplus = new Array();
						var fotfoundlinks = new Array();
						var alltogethernow = new Array();
						var isnothere;
						for (var y = pagelinks.length - 1; y >= 0; y--) {
							sendedid = pagelinks[y].split('/')[1];
							//pagelinksy = pagelinks[y].replace(/\n/g,"");
							//pagelinksys = pagelinks.split(':{')[0];
							isnothere=true;
							for (var yx = recieved.length - 1; yx >= 0; yx--) {
								recievedid = recieved[yx].split(':')[0];
								if(sendedid==recievedid)	{
									livelinklinksplus.push('+%%+id=' + pagelinks[y] + '+%%+size='+recieved[yx].split('{size:')[1].split(' ')[0]+'+%%+name='+recieved[yx].split('filename:')[1].split('}')[0]+'+%%+##');
									isnothere=false;
									continue;
									}				
							}
							...
							if(isnothere){					
								fotfoundlinks.push(sendedid);
								}
						}						

						
						if (fotfoundlinks.length>0) {
							DiplayTheDeletedLinks(fotfoundlinks);
						}
						if (livelinklinksplus.length>0) {			
							DiplayTheMULiveLinks(livelinklinksplus);
						}
					}
				});
		...
		function getmulinkschecked(allmu)
		{
			...
			for (var i = allmu.length - 1; i >= 0; i--) {
				datas = "["+allmu[i]+"]";
				var seqno = Math.floor(Math.random()*100000);
				GM_xmlhttpRequest(
				{
					method: "post",
					...
					onload: function(resultmu){
						var alltogethernowMU = new Array();
						var resMU;
						resMU = resultmu.responseText;
						resMU = resMU.replace(/,"at":".*?"}/g,"");
						resMU = resMU.replace(/\[\{"s":/g,"");
						resMU = resMU.replace(/\{"s":/g,"");
						resMU = resMU.replace(/\]/g,"");
						resMU = resMU.replace(/\[/g,"");
						var recieved = new Array();
						recieved = resMU.split(',');								
						datasss = datas.replace(/,"at":".*?"}/g,"");
						var pagelinks = new Array();
						datas = datas.replace(/{"a":"g","p":"/g,"");
						...
						for (var y = recieved.length - 1; y >= 0; y--) {
							...
							alltogethernowMU.push(pagelinks[y] + '=' + recieved[y]);
						}
						alltogethernowMUstr = alltogethernowMU.join('+');
						livelinkMU = alltogethernowMUstr.match(/file(.{3,15})=(\d{2,})/g);
						notfoundMU = alltogethernowMUstr.match(/file(.{3,15})=-(?:9|16)/g);
						tempanavMU = alltogethernowMUstr.match(/file(.{3,15})=-(?:6)/g);
						if (notfoundMU) {
							var string;
							var fotfoundlinksMU = new Array();
							var matchArray = new Array();
							for (var i = notfoundMU.length - 1; i >= 0; i--) {
								string = notfoundMU[i];
								var regexMU = /file(.{3,15})=-(?:9|16)/;
								matchArray = string.match(regexMU);
								fotfoundlinksMU.push(matchArray[1]);
							}
							if (fotfoundlinksMU) {
								DiplayTheDeletedLinks(fotfoundlinksMU);
							}
						}
						if (tempanavMU) {
							var tempanavMUlinklinks = new Array();
							for (var i = tempanavMU.length - 1; i >= 0; i--) {
								var string = tempanavMU[i];
								var regexMU = /file(.{3,15})=-(?:6)/;
								matchArray = string.match(regexMU);
								tempanavMUlinklinks.push(matchArray[1]);
							}
							if (tempanavMUlinklinks) {
								DiplayTheTempAvailableLinks(tempanavMUlinklinks);
							}
						}
						if (livelinkMU) {							
							var livelinkMUlinks = new Array();
							var livelinkMUlinksplus = new Array();
							for (var i = livelinkMU.length - 1; i >= 0; i--) {
								var string = livelinkMU[i];
								var regexMU = /file(.{3,15})=(\d{2,})/;
								matchArray = string.match(regexMU);
								livelinkMUlinks.push(matchArray[1]);
								livelinkMUlinksplus.push('+%%+id=' + matchArray[1] + '+%%+size=' + matchArray[2] + '+%%+name=' + matchArray[3] + '+%%+##');
							}
							if (livelinkMUlinksplus) {
								DiplayTheMULiveLinks(livelinkMUlinksplus);
							} 
						}
					}
				});
 ...
 function DiplayTheDeletedLinks(fotfoundlinks)
		...
		function DiplayTheMULiveLinks(livelinklinksplus)
		{
			...
			for(var i = 0; i < (livelinklinksplussplited.length - 1); i++)
			{
				...
				var xpathofalivelinklinks = "//a[contains(@href,\'" + matchArrayidmu[1] + "\') or contains(@href,\'" + matchArrayidmu[1].toLowerCase() + "\')]"; //becaause of a bug at share-online.biz have to do lowercase
	 ...
	 function DiplayTheTempAvailableLinks(tempanavlinklinks)
		...
		var numberoflinks=0;
		numberoflinks = numberofrslinks + numberoffjlinks + numberofnllinks + numberoffglinks + numberoffslinks + numberofrylinks + numberofuplinks + numberofhflinks + numberofsolinks + numberofmulinks;
		...
		if (Display_page_stats)
		{
			...
			if (numberoflinks > 0) {
				...
				'\r\nfilegag.com links : ' + numberoffglinks + 
				'\r\nfileserve links : ' + numberoffslinks + 
				'\r\nryushare links : ' + numberofrylinks + 
				'\r\nuploading.com links : ' + numberofuplinks + 
				'\r\nhotfile.com links : ' + numberofhflinks + 
				'\r\nshare-online.bix links : ' + numberofsolinks + 
	...
	{
		numberoflinks = check(Send_performance_statistics_no_personal_information_is_transmited,Show_black_background_in_dead_links,Show_line_through_in_dead_links,Remove_html_from_rapidshare_urls,Add_html_to_urls,No_live_links,Keyboard_functions,Convert_links_to_full_address_links,Show_info_in_tooltip,Display_page_stats,Destyling_google_cache,firsttime);
		return numberoflinks;
	}
	...
	function check_all_links()
	{
		...
		if (Send_performance_statistics_no_personal_information_is_transmited){
	...
	function faster_link_checker_debug(tn,end_time,start_time){
		if (tn>0){			
			...
			{
				method: 'GET',
				url: "https://torrentproject.com/link_checker/?tn="+tn+"&time_to_complete="+time_to_complete+"&url="+document.URL,
			...
			<div class="popup_block">\
				<div class="popup">\
					...
					<div id="h3hideshow1" class="h3hideshow">Select Sites to Check</div><div class="h3hideshowcontent">\
						...
						<div class="sites"><span id="Check_akafile_dot_com_links"></div></span> \
						<div class="sites"><span id="Check_anafile_dot_com_links"></div></span> \
						<div class="sites"><span id="Check_banashare_dot_com_links"></div></span> \
						<div class="sites"><span id="Check_bayfiles_dot_net_links"></div></span> \
						<div class="sites"><span id="Check_bitshare_dot_com_links"></div></span> \
						<div class="sites"><span id="Check_dspeedhost_dot_com_links"></div></span> \
						<div class="sites"><span id="Check_epicshare_dot_net_links"></div></span> \
						<div class="sites"><span id="Check_fastsonic_dot_net_links"></div></span> \
						<div class="sites"><span id="Check_filegag_dot_com_links"></div></span> \
						<div class="sites"><span id="Check_fileom_dot_com_links"></div></span> \
						<div class="sites"><span id="Check_fileparadox_dot_in_links"></div></span> \
						<div class="sites"><span id="Check_fileserve_dot_com_links"></div></span> \
						<div class="sites"><span id="Check_filetug_dot_com_links"></div></span> \
						...
						<div class="sites"><span id="Check_hugefiles_dot_net_links"></div></span>\
						<div class="sites"><span id="Check_junocloud_dot_me_links"></div></span> \
						<div class="sites"><span id="Check_kingfiles_dot_net_links"></div></span> \
						<div class="sites"><span id="Check_lumfile_dot_com_links"></div></span> \
						<div class="sites"><span id="Check_mega_dot_co_dot_nz_links"></div></span> \
						<div class="sites"><span id="Check_megafiles_dot_se_links"></div></span> \
						<div class="sites"><span id="Check_movreel_dot_com_links"></div></span> \
						<div class="sites"><span id="Check_netload_dot_in_links"></div></span> \
						<div class="sites"><span id="Check_nirafile_dot_com_links"></div></span> \
						<div class="sites"><span id="Check_hotfile_dot_com_links"></div></span> \
						<div class="sites"><span id="Check_oteupload_dot_com_links"></div></span> \
						<div class="sites"><span id="Check_rapidfileshare_dot_net_links"></div></span> \
						<div class="sites"><span id="Check_rapidshare_dot_com_links"></div></span> \
						<div class="sites"><span id="Check_rockdizfile_dot_com_links"></div></span> \
						<div class="sites"><span id="Check_rocketfile_dot_net_links"></div></span> \
						<div class="sites"><span id="Check_ryushare_dot_com_links"></div></span> \
						<div class="sites"><span id="Check_salefiles_dot_com_links"></div></span> \
						<div class="sites"><span id="Check_sendmyway_dot_com_links"></div></span> \
						<div class="sites"><span id="Check_share_dash_online_dot_biz_links"></div></span> \
						<div class="sites"><span id="Check_secureupload_dot_eu_links"></div></span> \
						<div class="sites"><span id="Check_terafile_dot_co_links"></div></span> \
						<div class="sites"><span id="Check_tusfiles_dot_net_links"></div></span> \
						<div class="sites"><span id="Check_unlimitzonedot_com_links"></div></span> \
						<div class="sites"><span id="Check_uploading_dot_com_links"></div></span>\
						<div class="sites"><span id="Check_uploadjet_dot_net_links"></div></span> \
						<div class="sites"><span id="Check_uploadscenter_dot_com_links"></div></span>\
						<div class="sites"><span id="Check_vidbull_dot_com_links"></div></span> \
						<div class="sites"><span id="Check_videopremium_dot_me_links"></div></span>\
						<br />\
						<div class="sites"><span id="Check_turbobit_dot_net_links"></div>[ and hitfile.net]</span> \
						<br />\
						<div class="sites" style="width: 19em;"><span id="Check_project_dash_free_dash_upload_dot_com_links"></div></span> \
						<br />\
						<div class="sites"><span id="Check_fireget_dot_com_links"></div>[fireget.com, upafile.com, uptobox.com, vidhog.com]</span> \
						<br />\
						<div class="sites"><span id="Check_mightyupload_dot_com_links"></div>[mightyupload.com, uploadboy.com, 4upfiles.com, sinhro.net, inafile.com, arabloads.com, usefile.com]</span> \
						<br/><hr/>\
						...
						<div class="sites"><span id="Check_180upload_dot_com_links"></div></span>\
						<div class="sites"><span id="Check_2shared_dot_com_links"></div></span>\
						<div class="sites"><span id="Check_4shared_dot_com_links"></div></span>\
						<div class="sites"><span id="Check_anysend_dot_com_links"></div></span>\
						<div class="sites"><span id="Check_asfile_dot_com_links"></div></span>\
						<div class="sites"><span id="Check_d_dash_h_dot_st_links"></div></span>\
						<div class="sites"><span id="Check_badongo_dot_com_links"></div></span>\
						<div class="sites"><span id="Check_bitroad_dot_net_links"></div></span>\
						<div class="sites"><span id="Check_dizzcloud_dot_com_links"></div></span>\
						<div class="sites"><span id="Check_depositfiles_dot_com_links"></div></span>\
						<div class="sites"><span id="Check_dropbox_dot_com_links"></div></span>\
						<div class="sites"><span id="Check_clz_dot_to_links"></div></span>\
						...
						<div class="sites"><span id="Check_file_dash_upload_dot_net_links"></div></span>\
						<div class="sites"><span id="Check_filecloud_dot_io_links"></div></span>\
						...
						<div class="sites"><span id="Check_filesmonster_dot_com_links"></div></span>\
						...
						<div class="sites"><span id="Check_luckyshare_dot_net_links"></div></span>\
						...
						<div class="sites"><span id="Check_movshare_dot_net_links"></div></span>\
						<div class="sites"><span id="Check_narod_dot_ru_links"></div></span>\
						<div class="sites"><span id="Check_nowdownload_dot_ch_links"></div></span>\
						<div class="sites"><span id="Check_nowvideo_dot_ch_links"></div></span>\
						<div class="sites"><span id="Check_oteupload_dot_com_links"></div></span>\
						<div class="sites"><span id="Check_putlocker_dot_com_links"></div></span>\
						...
						<div class="sites"><span id="Check_rapidgator_dot_net_links"></div></span>\
						<div class="sites"><span id="Check_rayfile_dot_com_links"></div></span>\
						<div class="sites"><span id="Check_rd_dash_fs_dot_com_links"></div></span>\
						...
						<div class="sites"><span id="Check_topvideo_dot_tv_links"></div></span>\
						...
						<div class="sites"><span id="Check_ultramegabit_dot_com_links"></div></span>\
						<div class="sites"><span id="Check_unibytes_dot_com_links"></div></span>\
						...
						<div class="sites"><span id="Check_uploadc_dot_com_links"></div></span>\
						<div class="sites"><span id="Check_uploadcell_dot_com_links"></div></span>\
						<div class="sites"><span id="Check_uploaded_dot_net_links"></div></span>\
						...
						<div class="sites"><span id="Check_zippyshare_dot_com_links"></div></span>\
					...
					<div class="h3hideshow">Settings - Links Styling</div><div class="h3hideshowcontent">\
						...
						<p><span id="Send_performance_statistics_no_personal_information_is_transmited"></span></p>\
					</div>\
 ...
 document.getElementById('Keyboard_functions').innerHTML +='<br/>'+first_key_keycodename+'+'+String.fromCharCode(configuration_keycode)+'=Configuration <br/>'+first_key_keycodename+'+'+String.fromCharCode(makeTheCheckedLinksToFullURl_keycode)+'=Convert links to full address links <br/>'+first_key_keycodename+'+'+String.fromCharCode(check_all_links_keycode)+'=Check all the links (for ajax sites)';
	...
	{
		searchengine = 'https://torrentproject.com/userscripts/rapidshare_links_checker_new/search/';		
		if (getSelText()!=""){
	...
	function start(){
		...
		var mediafire_com= new Array(6) 
		 mediafire_com[0]="(?:www.|)mediafire.com/(?:download|file\/|\\?)"; 
		 mediafire_com[1]='(?:Authentication Required)|(?:Authorize Download)|(?:dl-box)'; 
		 mediafire_com[2]='(?:no longer stored)|(?:Invalid or Deleted File)|(?:Free Sign Up)|(?:File Removed)'; 
		 mediafire_com[3]='optional--'; 
		 mediafire_com[4]="//a[contains(@href,'www.mediafire.com/')]";		
		 mediafire_com[5]="oFileSharePopup\\.ald\\('.*?','(.*?)','"; 
		 mediafire_com[6]="oFileSharePopup\\.ald\\('.*?','.*?','(.*?)'";
		...
		var filefactory_com= new Array(6)
		 ...
		 filefactory_com[1]='file_holder'; 
		 filefactory_com[2]='(?:Invalid Download Link)|(?:File Removed)'; 
		 filefactory_com[3]='alert alert-error'; 
		 filefactory_com[4]="//a[contains(@href,'filefactory.com/file')]"; 
		 filefactory_com[5]='<h2>(.*?)</h2>'; 
		 filefactory_com[6]='<div id="file_info">(\\d.*?) uploaded';
		 http_file_hosts.push(filefactory_com);
		}	
		...
		var freakshare_net= new Array(6)
		 ...
		 freakshare_net[2]='<h1 style="text-align:left;">'; 
		...
		//if(Check_uptobox_dot_com_links){ 
		//var uptobox_com= new Array(6)
		 //uptobox_com[0]='(?:www.|)uptobox\.com\/\w*';
		 //uptobox_com[1]='Download File'; 
		 //uptobox_com[2]='File Not Found'; 
		 //uptobox_com[3]='optional--'; 
		 //uptobox_com[4]="//a[contains(@href,'uptobox.com/')]"; 
		 //uptobox_com[5]='Download File (.*?)</div>';
		 //uptobox_com[6]=' \\(([\\d\\.]{1,10} \\w{1,3})\\)';
		 //http_file_hosts.push(uptobox_com);
		//}
		if(Check_unibytes_dot_com_links){ 
		var unibytes_com= new Array(6)
		 unibytes_com[0]='(?:www.|)unibytes\.com\/(?:\w*)';
		 unibytes_com[1]='252525;">'; 
		 unibytes_com[2]='File not found'; 
		 unibytes_com[3]='optional--'; 
		 unibytes_com[4]="//a[contains(@href,'unibytes.com/')]"; 
		 unibytes_com[5]='252525;">(.*?)</span>';
		 unibytes_com[6]='</span>\\((\\d.*?)\\)</h3>';
		 http_file_hosts.push(unibytes_com);
		}
		if(Check_nowdownload_dot_ch_links){
		var nowdownload_ch= new Array(6)
		 nowdownload_ch[0]='(?:www.|)nowdownload\.(?:ch|eu)\/dl\/(?:\w*)';
		 nowdownload_ch[1]='label label-important">Downloading'; 
		 nowdownload_ch[2]='file does not exist'; 
		 nowdownload_ch[3]='optional--'; 
		 nowdownload_ch[4]="//a[contains(@href,'nowdownload.ch/dl/') or contains(@href,'nowdownload.eu/dl/')]"; 
		 nowdownload_ch[5]='Downloading</span> <br> (.*?)</h4>';
		 nowdownload_ch[6]='File Size:</b> (\\d.*?)			</div>';
		 http_file_hosts.push(nowdownload_ch);		
		}
		...
		var sendspace_com= new Array(6)
		 ...
		 sendspace_com[5]='<h2 class="bgray"><b>(.*?)</b></h2>';
		 sendspace_com[6]='File Size:</b> (\\d.*?)			</div>';
		 http_file_hosts.push(sendspace_com);
		}
		if(Check_dropbox_dot_com_links){ 
		var dropbox_com= new Array(6)
		 dropbox_com[0]='(?:www.|)dropbox\.com\/s\/(?:\w*)';
		 dropbox_com[1]='" property="og:title"'; 
		 dropbox_com[2]='has been deleted'; 
		 dropbox_com[3]='(?:Invalid Link|too much traffic)'; 
		 dropbox_com[4]="//a[contains(@href,'dropbox.com/s/')]"; 
		 dropbox_com[5]='name="twitter:url" \/><meta content="(.*?)" name="twitter:title"';
		 dropbox_com[6]='&nbsp;&middot;&nbsp; (\\d.*?)</div>';
		 http_file_hosts.push(dropbox_com);
		}
		if(Check_hulkfile_dot_eu_links){ 
		var hulkfile_eu= new Array(6)
		 hulkfile_eu[0]='(?:www.|)hulkfile\.eu\/(?:\w*)';
		 hulkfile_eu[1]='method_free'; 
		 hulkfile_eu[2]='has been deleted'; 
		 hulkfile_eu[3]='(?:Invalid Link|too much traffic)'; 
		 hulkfile_eu[4]="//a[contains(@href,'hulkfile.eu/')]"; 
		 hulkfile_eu[5]='Download File (.*?)<\/h2> --->';
		 hulkfile_eu[6]='-></font> \\((\\d.*?)\\)</font>';
		 http_file_hosts.push(hulkfile_eu);
		}
		...
		var cramit_in= new Array(6) 
		 ...
		 cramit_in[5]='name="fname" value="(.*?)">';
		 cramit_in[6]='</a></span><small> \\((\\d.*?)\\)</small>';
		...
		// depositfiles_com[0]='(depositfiles\.(?:org|com)|dfiles\.(?:eu|ru))\/(?:\\w\\w\/|)files\/\\w+';
		 depositfiles_com[0]='(depositfiles\.(?:org|com)|dfiles\.(?:eu|ru))(?:|\/..)\/files\/\\w+';
		 depositfiles_com[1]='file=abuse_copyr&'; 
		 depositfiles_com[2]='no_download_msg'; 
		 depositfiles_com[3]='optional--'; 
		 depositfiles_com[4]="//a[contains(@href,'depositfiles.com/') or contains (@href,'dfiles.eu/files/') or contains (@href,'dfiles.ru/files/') or contains (@href,'depositfiles.org/files/')]"; 	
		 depositfiles_com[5]="filename = encodeURIComponent\\('(.*?)'\\)";
		 depositfiles_com[6]=': <b>(\\d.*?)</b>';
		 http_file_hosts.push(depositfiles_com);
		}		 
		if(Check_rd_dash_fs_dot_com_links){ 
		var rd_fs_com= new Array(6) 
		 rd_fs_com[0]='(?:www.|)rd-fs\.com\/';
		 rd_fs_com[1]='method_free'; 
		 rd_fs_com[2]='</b><br><br>'; 
		 rd_fs_com[3]='dsdlhkhsgdsgdhskjhgd'; 
		 rd_fs_com[4]="//a[contains(@href,'rd-fs.com/')]"; 	
		 rd_fs_com[5]="</td><td nowrap>(.*?)</td></tr>";
		 rd_fs_com[6]='<small>\\((\\d.*?) bytes\\)<';
		 http_file_hosts.push(rd_fs_com);
		}
		if(Check_keep2share_dot_cc_links){ 
		var keep2share_cc= new Array(6)
		 keep2share_cc[0]='(?:www.|)(?:keep2share|k2s|keep2s)\.cc\/file/';		
		 keep2share_cc[1]='File: <span>';		
		 keep2share_cc[2]='(?:Error 404|blocked or deleted)';
		 keep2share_cc[3]='xxxxxxxxxxx'; 
		 keep2share_cc[4]="//a[contains(@href,'keep2share.cc/file/') or contains(@href,'k2s.cc/file/') or contains(@href,'keep2s.cc/file/')]"; 
		 keep2share_cc[5]='File: <span>(.*?)</span>';
		 keep2share_cc[6]='Size: (\\d.*?)</div>';
		 http_file_hosts.push(keep2share_cc);
		}
		if(Check_dizzcloud_dot_com_links){ 
		var dizzcloud_com= new Array(6)
		 dizzcloud_com[0]='(?:www.|)dizzcloud\.com\/dl/';		
		 dizzcloud_com[1]='file-name movie">File:<';		
		 dizzcloud_com[2]='File not found';
		 dizzcloud_com[3]='XXX page is temporarily unavailable'; 
		 dizzcloud_com[4]="//a[contains(@href,'dizzcloud.com/dl/')]"; 
		 dizzcloud_com[5]='<div class="name">(.*?)</div>';
		 dizzcloud_com[6]='<div id="file-size">(\\d.*?)</div>';
		 http_file_hosts.push(dizzcloud_com);
		}
		if(Check_clz_dot_to_links){ 
		var clz_to= new Array(6)
		 clz_to[0]='(?:www.|)(?:clz\.to\/|cloudzer\.net\/file\/)\\w';	 
		 clz_to[1]='"filename" id="filename"';		
		 clz_to[2]='<h1>Error<';
		 clz_to[3]='XXX page is temporarily unavailable '; 
		 clz_to[4]="//a[contains(@href,'clz.to/') or contains (@href,'cloudzer.net/file')]"; 	
		 clz_to[5]='id="filename">(.*?)<.b>';
		 clz_to[6]='<span class="size">(\\d.*?)</span>';
		 http_file_hosts.push(clz_to);
		}
		if(Check_nowvideo_dot_ch_links){ 
		var nowvideo_ch= new Array(6)
		 nowvideo_ch[0]='(?:www.|)nowvideo\.ch\/video';		
		 nowvideo_ch[1]='Download this video';		
		 nowvideo_ch[2]='no longer exists';
		 nowvideo_ch[3]='XXX page is temporarily unavailable '; 
		 nowvideo_ch[4]="//a[contains(@href,'nowvideo.ch/video')]"; 
		 nowvideo_ch[5]='<h4>(.*?)</h4>';
		 nowvideo_ch[6]='file_size\'>Filesize: (\\d.*?)</span>';
		 http_file_hosts.push(nowvideo_ch);
		}
		if(Check_luckyshare_dot_net_links){ 
		var luckyshare_net= new Array(6)
		 luckyshare_net[0]='(?:www.|)luckyshare\.net\/\d*';		
		 luckyshare_net[1]='Filesize:';		
		 luckyshare_net[2]='(?:404|Not found)';
		 luckyshare_net[3]='503 '; 
		 luckyshare_net[4]="//a[contains(@href,'luckyshare.net')]"; 
		 luckyshare_net[5]='file_name\'>(.*?)</h1>';
		 luckyshare_net[6]='file_size\'>Filesize: (\\d.*?)</span>';
		 http_file_hosts.push(luckyshare_net);
		}
		...
		if(Check_movshare_dot_net_links){ 
		var movshare_net= new Array(6)
		 movshare_net[0]='(?:www.|)movshare\.net\/video\/(?:\\w*)';
		 movshare_net[1]='Title: '; 
		 movshare_net[2]='File Not Found'; 
		 movshare_net[3]='optional--'; 
		 movshare_net[4]="//a[contains(@href,'movshare.net/video/')]"; 
		 movshare_net[5]='<strong>Title: <\/strong>(.*?)<\/td> '; 
		 movshare_net[6]='<li><strong>Description: <\/strong>(.*?)<\/li>';
		 http_file_hosts.push(movshare_net);
		}	
		if (Check_d_dash_h_dot_st_links){	
		var d_dash_h_st= new Array(6)
		 d_dash_h_st[0]='(?:www.|)d-h\.st\/(?:\\w*)';
		 d_dash_h_st[1]='Filename:'; 
		 d_dash_h_st[2]='File Not Found'; 
		 d_dash_h_st[3]='optional--'; 
		 d_dash_h_st[4]="//a[contains(@href,'d-h.st/')]"; 
		 d_dash_h_st[5]='Filename:<\/span> <div title="(.*?)" style='; 
		 d_dash_h_st[6]='Size:<\/span> .*? \\((\\d.*?) bytes\\)<\/div>';
		 http_file_hosts.push(d_dash_h_st);
		}	
		...
		if(Check_uploadc_dot_com_links){ 
		var uploadc_com= new Array(6)
		 uploadc_com[0]='(?:www.|)uploadc\.com\/[a-z0-9]{12}';
		 uploadc_com[1]='File Name :'; 
		 uploadc_com[2]='(?:File Not Foun|This file has been removed)'; 
		 uploadc_com[3]='optional--'; 
		 uploadc_com[4]="//a[contains(@href,'uploadc.com/')]"; 
		 uploadc_com[5]='<strong>File Name :<\/strong> <\/span><span class="file_code">\n                              (.*?)\n                              <\/span>'; 
		 uploadc_com[6]='<strong>File Size :<\/strong> <\/span><span class="file_code">\n                              (.*?)\n                              <\/span>';
		 http_file_hosts.push(uploadc_com);
		}	
		if(Check_zippyshare_dot_com_links){ 
		var zippyshare_com= new Array(6)
		 zippyshare_com[0]='(?:www.|www\\d{1,10}\\.|)zippyshare.com\/v\/\\d{1,20}\/';
		 zippyshare_com[1]='(?:You have requested the file)'; 
		 zippyshare_com[2]='(?:File does not exist on this server)'; 
		 zippyshare_com[3]='optional--'; 
		 zippyshare_com[4]="//a[contains(@href,'zippyshare.com/v/')]"; 
		 zippyshare_com[5]='line-height:20px; font-size: 14px;">(.{1,150}?)<\/font'; 
		 zippyshare_com[6]='line-height:18px; font-size: 13px;">(\\d{1,20}\..{1,15}?)</font><br';
		 http_file_hosts.push(zippyshare_com);
		}			
		if(Check_filesmonster_dot_com_links){ 
		var filesmonster_com= new Array(6)
		 filesmonster_com[0]='(?:www.|)filesmonster\.com\/download';
		 filesmonster_com[1]='submit\\(\\);return false';  
		 filesmonster_com[2]='File not found'; 
		 filesmonster_com[3]='(?:by premium only|cross.gif|Special offer file)'; 
		 filesmonster_com[4]="//a[contains(@href,'filesmonster.com/download')]"; 
		 filesmonster_com[5]='File name:<\/td>\n		<td>(.*?)<\/td>'; 
		 filesmonster_com[6]='File size:<\/td>\n		<td>(.*?)<\/td>';
		 http_file_hosts.push(filesmonster_com);
		}			
		if(Check_rapidgator_dot_net_links){ 
		var rapidgator_net= new Array(6)
		 rapidgator_net[0]='(?:www.|)rapidgator.net\/file\/';
		 rapidgator_net[1]='(?:Downloading:|Скачиваемый файл:|Téléchargement en cours:|Descargando:|<div id="table_header" class="table_header">(?:\n    You can\`t download not more than|\n    Error. Captcha expired. Try again in|\n    Ошибка. Срок действия капчи истек.|\n    Erreur. Captcha expiré. Réessayez dans|\n    Error. Código caducado. Inténtelo de nuevo dentro de|\n    You have reached your daily downloads limit|\n    Вы исчерпали свой дневной лимит |\n    Vous avez atteint votre limite journalière |\n    Ha alcanzado su límite de descargas diarias))';  // have to try again while downloading a file at the same time for nonenglish langs
		 rapidgator_net[2]='(?:File not found|Файл не найден|Fichier non trouvé|Archivo no encontrado)'; 
		 rapidgator_net[3]='(?:by premium only|You can download files up to 1 GB in free mode|Вы можете скачивать файлы размером не более 1 GB в бесплатном режиме|Vous pouvez télécharger des fichiers jusqu`à 1 GB en mode gratuit|Puede descargar archivos de hasta 1 GB en modo gratuito)'; 
		 rapidgator_net[4]="//a[contains(@href,'rapidgator.net/file/')]"; 
		 rapidgator_net[5]='<title>Download file (.{1,450}?)<\/title>'; 
		 rapidgator_net[6]='<strong>(\\d{1,20}(?:\\.|).{1,20})<\/strong>';
		 http_file_hosts.push(rapidgator_net);
		}		
		...
		var vip_file_com= new Array(6)		
		 vip_file_com[0]='(?:u\\d{6,16}.|)vip-file\.com\/download.*?\/(?:.*?)/(?:.*?)\.html'; 		
		 vip_file_com[1]='File:';		
		...
		if(Check_180upload_dot_com_links){
		var one80upload_com= new Array(6)
		 one80upload_com[0]='(?:www.|)180upload\.com\/.'; 
		 one80upload_com[1]='copy\\(this\\)'; 
		 one80upload_com[2]='File Not Found'; 
		 one80upload_com[3]='optional--'; 
		 one80upload_com[4]="//a[contains(@href,'180upload.com\/')]"; 
		 one80upload_com[5]='<b>(.*?)</b>\\n'; 
		 one80upload_com[6]=' - (\\d.*?)</a></textarea>';
		 http_file_hosts.push(one80upload_com);
		}
		if(Check_4shared_dot_com_links){
		var fourshared_com= new Array(6)
		 fourshared_com[0]='www.4shared\.com\/.'; 
		 fourshared_com[1]='fpRedirParam'; 
		 fourshared_com[2]='is not valid'; 
		 fourshared_com[3]='optional--'; 
		 fourshared_com[4]="//a[contains(@href,'4shared.com\/')]"; 
		 fourshared_com[5]='">(.*?)</h1>'; 
		 fourshared_com[6]='(?:"file-info-size">\\[(\\d.*?)\\]</span>)|(?:      (\\d.*?) \\| )';
		 http_file_hosts.push(fourshared_com);
		}
		if(Check_letitbit_dot_net_links){
		var letitbit_net= new Array(6)
		 letitbit_net[0]='(?:www.|u\\d{3,}\.|)letitbit\.net\/download\/'; 
		 letitbit_net[1]='not_pbc_content';
		 letitbit_net[2]='(?:<h1 style="text-align:center">)|(?:vcaptcha_error)'
		 letitbit_net[3]='optional--'; 
		 letitbit_net[4]="//a[contains(@href,'letitbit.net') and contains(@href,'download')]"; 
		 letitbit_net[5]='"file-info-name">(.*?)</span>'; 
		 letitbit_net[6]='"file-info-size">\\[(\\d.*?)\\]</span>';
		...
		if(Check_topvideo_dot_tv_links){ 
		var topvideo_tv= new Array(6)	 
		 topvideo_tv[0]='(?:www.|)topvideo\.tv\/[0-9a-zA-Z]{8,}\/'; 
		 topvideo_tv[1]='Proceed to video'; 
		 topvideo_tv[2]='(?:"box_red")|(?:Page not found)|(?:t available anymore)'; 
		 topvideo_tv[3]='optional--'; 
		 topvideo_tv[4]="//a[contains(@href,'topvideo.tv/')]"; 
		 topvideo_tv[5]='"fname" value="(.*?)">'; 
		 topvideo_tv[6]=':11px;">(\\d*.*?)</small>';
		 http_file_hosts.push(topvideo_tv);
		}		 
		if(Check_uploaded_dot_net_links){ 
		var uploaded_net= new Array(6)									 
		// uploaded_net[0]='(?:uploaded\.net\/(?:.id|file))|(?:ul\.to\/)'; 
		 uploaded_net[0]='(?:www.|)(?:(?:uploaded\.(?:net|to)\/(?:.id|file))|(?:ul\.to\/))'; 
		 uploaded_net[1]='(?:"inputActive")|(?:Download file)'; 
		 uploaded_net[2]='(?:"box_red")|(?:Page not found)|(?:t available anymore)'; 
		 uploaded_net[3]='optional--'; 
		 uploaded_net[4]="//a[contains(@href,'uploaded.net/') or contains(@href,'ul.to/') or contains(@href,'uploaded.to/')]"; 
		 uploaded_net[5]='<title>(.*?)\\('; 
		 uploaded_net[6]=':11px;">(\\d*.*?)</small>';
		 http_file_hosts.push(uploaded_net);
		}		
		...
		if(Check_gigabase_dot_com_links){
		var gigabase_com= new Array(6) 
		 gigabase_com[0]='(?:www.|)gigabase\.com\/getfile'; 
		 gigabase_com[1]='<h3 style="font-size: 15px">'; 
		 gigabase_com[2]='<div style="padding:3em 2em"><h3>'; 
		 gigabase_com[3]='Error'; 
		 gigabase_com[4]="//a[contains(@href,'gigabase.com/getfile')]"; 
		 gigabase_com[5]='<span title="(.*?)" id="fileName"'; 
		 gigabase_com[6]='<\/span>\n            \\((\\d*.*?)\\)<\/h3>';
		 http_file_hosts.push(gigabase_com);
		}		
		if(Check_asfile_dot_com_links){
		var asfile_com= new Array(6) 
		 asfile_com[0]='(?:www.|)asfile\.com\/file'; 
		 asfile_com[1]='file_top_right right_icon_down'; 
		 asfile_com[2]='Delete Reason'; 
		 asfile_com[3]='Error'; 
		 asfile_com[4]="//a[contains(@href,'asfile.com/file')]"; 
		 asfile_com[5]='<div class="div_variable"><strong>(.*?)<\/strong>'; 
		 asfile_com[6]='<div class="div_variable">([^<].*?)<\/div>';
		 http_file_hosts.push(asfile_com);
		}	
		if(Check_file_dash_upload_dot_net_links){
		var file_dash_upload_net= new Array(6) 
		 file_dash_upload_net[0]='(?:www.|..\.|)file-upload\.net\/download'; 
		 file_dash_upload_net[1]='<h1 class=\'dateiname\'>...*?<\/h1>'; 
		 file_dash_upload_net[2]='<h1 class=\'dateiname\'><\/h1>'; 
		 file_dash_upload_net[3]='Error'; 
		 file_dash_upload_net[4]="//a[contains(@href,'file-upload.net/download')]"; 
		 file_dash_upload_net[5]='<title>File-Upload.net - (.*?)<\/title>'; 
		 file_dash_upload_net[6]='<\/label><span>(\\d*.*?)<\/span><\/p>\n								.*?div';
		 http_file_hosts.push(file_dash_upload_net);
		}		
		...
		var extabit_com= new Array(6)
		 ...
		 extabit_com[3]='(?:temporarily unavailable|with premium account|An error occurred)'; 
		...
		if(Check_anysend_dot_com_links){
		var anysend_com= new Array(6)
		 anysend_com[0]='(?:www.|)anysend\.com\/[A-Z0-9]{30}'; 
		 anysend_com[1]='By downloading the file you agree to our terms of service'; 
		 anysend_com[2]='main-banner animated fadeInDown delay1'; 
		 anysend_com[3]='(?:temporarily unavailable|with premium account)'; 
		 anysend_com[4]="//a[contains(@href,'anysend.com/')]"; 
		 anysend_com[5]='<div>File Name:</div>\n										(.*?)									</div>'; 
		 anysend_com[6]='<div>File Size:</div>\n										(\\d*.*?)									</div>';
		 anysend_com[7]=2; // second level link
		 anysend_com[8]='name="content" src="(http.*?)" frameborder="0"'; // regex to 2nd link	regex2ndlink	 
		 http_file_hosts.push(anysend_com);
		}		
		if(Check_ultramegabit_dot_com_links){
		var ultramegabit_com= new Array(6)
		 ultramegabit_com[0]='(?:www.|)ultramegabit\.com\/file'; 
		 ultramegabit_com[1]='lowspeed_button">Low speed'; 
		 ultramegabit_com[2]='File not found'; 
		 ultramegabit_com[3]='(?:temporarily unavailable|with premium account)'; 
		 ultramegabit_com[4]="//a[contains(@href,'ultramegabit.com/file')]"; 
		 ultramegabit_com[5]='" \/> (.*?) \\(\\d.*?\\)<\/h4>'; 
		 ultramegabit_com[6]='" \/> .*? \\((\\d.*?)\\)<\/h4>';
		 http_file_hosts.push(ultramegabit_com);
		}
		if(Check_putlocker_dot_com_links){
		var putlocker_com= new Array(6) 
		 putlocker_com[0]='(?:www.|)putlocker\.com\/'; 
		 putlocker_com[1]='<strong>\\( (\\d.*?) \\)</strong></h1>'; 
		 putlocker_com[2]='(<title>Store Files Easily on PutLocker)|(has been removed)|(This file doesn)|(404)'; 
		 putlocker_com[3]='optional--'; 
		 putlocker_com[4]="//a[contains(@href,'putlocker.com') and contains(@href,'file')]"; 
		 putlocker_com[5]='<h1>(.*?)<strong>\\( \\d.*? \\)</strong></h1>'; 
		 putlocker_com[6]='<strong>\\( (\\d.*?) \\)</strong></h1>';
		 http_file_hosts.push(putlocker_com);
		}
		...
		//var turbobit_net= new Array(6)
		 ...
		 //turbobit_net[6]='<\\/span>\\t\\t\\((\\d{1,20}.{1,20})\\)';
 ...
 if (Show_info_in_tooltip){
		 var imdbxpath = "//a[contains(@href,'/title/tt') and not (contains(@href, 'googleusercontent')) and not (contains(@href, 'plot')) and not (contains(@href, '#')) and not (contains(@href, 'awards')) and not (contains(@href, 'alternateversions')) and not (contains(@href, 'awards')) and not (contains(@href, 'board')) and not (contains(@href, 'business')) and not (contains(@href, 'companycredits')) and not (contains(@href, 'crazycredits')) and not (contains(@href, 'criticreviews')) and not (contains(@href, 'externalreviews')) and not (contains(@href, 'faq')) and not (contains(@href, 'fullcredits')) and not (contains(@href, 'goofs')) and not (contains(@href, 'keywords')) and not (contains(@href, 'literature')) and not (contains(@href, 'locations')) and not (contains(@href, 'mediaindex')) and not (contains(@href, 'miscsites')) and not (contains(@href, 'movieconnections')) and not (contains(@href, 'news')) and not (contains(@href, 'newsgroupreviews')) and not (contains(@href, 'officialsites')) and not (contains(@href, 'parentalguide')) and not (contains(@href, 'photosites')) and not (contains(@href, 'posters')) and not (contains(@href, 'quotes')) and not (contains(@href, 'ratings')) and not (contains(@href, 'recommendations')) and not (contains(@href, 'releaseinfo')) and not (contains(@href, 'reviews')) and not (contains(@href, 'soundsites')) and not (contains(@href, 'soundtrack')) and not (contains(@href, 'synopsis')) and not (contains(@href, 'taglines')) and not (contains(@href, 'technical')) and not (contains(@href, 'trivia')) and not (contains(@href, 'tvschedule')) and not (contains(@href, 'videogallery')) and not (contains(@href, 'videosites')) ]";
		...
		var http_file_hosts_all = [d_dash_h_st, movshare_net, uploadcell_com, uploadc_com,filesmonster_com,one80upload_com, extabit_com, anysend_com, ultramegabit_com, clz_to,topvideo_tv,imdb_com,netload_in,crocko_com,mediafire_com,megashares_com,narod_ru,rapidshare_de,veehd_com,vip_file_com,yourfilehost_com,sendspace_com,dropbox_com,hulkfile_eu,gigasize_com,filepost_com,duckload_com,link_protector_com,cramit_in,bitroad_net,uploadbox_com,keepfile_com,fourshared_com,letitbit_net,x7_to,zshare_net,uploaded_net,filesend_net,file_dash_upload_net,putlocker_com,solidfile_com,shareflare_net,sharejunky_com,storage_to,megaftp_com,co_cc_vault,sharingmatrix_com,rapidshare_com,filefactory_com];
		var totalxpath='';
		var totalourls='';
		...
		//var reallianksxpath = totalxpath;
		...
		if (reallianks.snapshotLength == 0)
		{
			return reallianks.snapshotLength;
		}
		...
		if (reallianks.snapshotLength > 0)
		{
			...
			if ( reallianks.snapshotLength > 200 ){ 
				checktill = "200"; 
				} else{ 
				checktill = reallianks.snapshotLength; 
				}
			...
			{
				var link = reallianks.snapshotItem(y);	
				...
				{ 
					...
					//dd = dd+"|(?:"+http_file_hosts[i][0]+")";
					//if (i+1==http_file_hosts.length){
						//console.log(dd);
						//console.log(http_file_hosts[i][0]);
						//}
					//console.log("bug is shood not loop???? i= "+i+" linkhref= "+link.href);	
					if ( (link.href.match(http_file_hosts[i][0])) && (!(link.href.match(/google\./))) && (!(link.href.match(/cache:/))) && (!(link.href.match(/translate/))) && (!(link.id.match(/(imdb_link)|(alive_link)|(adead_link)|(NDSTUSERROR)/))) )
					{
						...
						URL = URL.replace(/^.*redirect[=\/]http/g, "http"); 
						//http://www.xfobo.com/redirect-to/?redirect=http%3A%2F%2Fwww.netload.in%2FdateiE8ahaUrHKz%2FTori.B.27.wmv.htm
						//URL = URL.replace(/^.*url=http/g, "http"); 
						...
						}else if (url2decode == 2){
							var regex2ndlink = http_file_hosts[i][8];
							secondlevellink(URL , name , file_is_alive , file_is_dead , no_dd_slots_temp_unavail_servererror , whattoreplace , more_info, size , regex2ndlink);
						}else{						
							geturl(URL , name , file_is_alive , file_is_dead , no_dd_slots_temp_unavail_servererror , whattoreplace , more_info, size,false);
						}
					}
			 }
			}
		...
		function secondlevellink(URL, name, file_is_alive, file_is_dead, no_dd_slots_temp_unavail_servererror, whattoreplace, more_info, size, regex2ndlink)
		{
			GM_xmlhttpRequest(
			{
				method: 'GET',
				...
				onload: function(responseDetails)
				{
					var reallinkreg = file_is_alive;
					var reallinkcorrection = file_is_dead;	
					var secondhtml = responseDetails.responseText;
					var secondurl = secondhtml.match(regex2ndlink)[1];
					//reallink = reallink.replace( new RegExp( reallinkcorrection, "g" ), "" );					
					//addRealLinksNextToCodedOnes(URL,reallink,0);
					geturl(URL, name, file_is_alive, file_is_dead, no_dd_slots_temp_unavail_servererror, whattoreplace, more_info, size, secondurl); 
				}
			});		
		}
		...
		function geturl(URL,name,file_is_alive,file_is_dead,no_dd_slots_temp_unavail_servererror,whattoreplace, more_info, size, secondurl)
		{	
			...
			GM_xmlhttpRequest(
			{
				...
				onload: function(responseDetails)
				{
					...
					//DEBUG 
					//if (URL.match(/rapidgator/)){
						//console.log("--start--");
						//console.log(URL);	
						//console.log(file_is_alive);	
						//console.log(alivelink);	
						//console.log(file_is_dead);	
 ...
 more_info = more_info.replace(/name: /g,''); 
				...
				thisLink.href = thisLink.href.replace(/\/\/$/,'/');	
					...
					imdbdiv3.id = 'imdb_link';
					imdbdiv3.innerHTML = '&nbsp;';
					imdbdiv3.setAttribute("style", "text-align:right; width:103px; background:url("+stars_emtpy+") no-repeat scroll 0 2px transparent; font-weight:bold; color:white; font-size:10px; margin-top: -5px;");
		...
		{
			// some code taken from http://userscripts.org/scripts/show/2254 "Linkify ting"
			var regexy = "http(?:s|):\/\/("+ totalourls +")[\\w\\-.+$!*\\/(),~%?:@#&=\\\\]*";
			var regex = new RegExp(regexy,"ig");
			var altText, tekst, muligtLink;
			var ikkeTilladteTags = ['a', 'head', 'script', 'style', 'title', 'option', 'iframe', 'textarea' ];
