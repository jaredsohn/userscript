// Copyright (c) 2005-2008 VistaArc. All rights reserved.
...
// @description   This script allows Prothom Alo, Bhorer Kagoj and other Bangla News papers to load in unicode.
// @include       http://bhorerkagoj.net/*
// @include       http://jaijaidin.com/*
// @include       http://shamokal.com/*
// @include       http://manabzamin.net/*
// @include       http://amadershomoy.com/*
// @include       http://ittefaq.com/*
// @include       http://prothom-alo.tld/*
// @include       http://www.bhorerkagoj.net/*
// @include       http://www.jaijaidin.com/*
// @include       http://www.shamokal.com/*
// @include       http://www.manabzamin.net/*
// @include       http://www.amadershomoy.com/*
// @include       http://www.ittefaq.com/*
// @include       http://www.prothom-alo.tld/*
// ==/UserScript==
...
function j(){
     ...
     if(document.domain.indexOf("prothom-alo.net")!=-1){
          c="alpona";
          b="Alpona"}
     else{if(document.domain.indexOf("amadershomoy.com")!=-1||document.domain.indexOf("ittefaq.com")!=-1||document.domain.indexOf("bhorerkagoj.net")!=-1||document.domain.indexOf("manabzamin.net")!=-1||document.domain.indexOf("jaijaidin.com")!=-1){
               c="bijoy";
               b="MJ"}
     else{if(document.domain.indexOf("shamokal.com")!=-1){
               c="bijoy";
               b="Samakal"}
      else{if(document.domain.indexOf("banglapedia.org")!=-1){
                         c="bijoy";
                         b="Banglapedia"}
              else {e=true       }
          }
