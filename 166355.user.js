...
var amount   = parseInt(GM_getValue("amount",120));
...
Auto list player <input type=\"text\" style=\"border: 1px solid white; width: 4em; color: #FADD34; background: black; text-align: center;\" id=\"autolistNum\" value=\""+autolistNum+"\" /> times for <input type=\"text\" style=\"border: 1px solid white; width: 4em; color: #FADD34; background: black; text-align: center;\" id=\"amount\" value=\""+amount+"\" /> bounty<br>\
    \
