...
whichRegex : /(bonus|collectable|find|hatch|adopt|bouquet|perfect bunch|present|fuel|help)/,
ampRegex : /&amp;/g,
...
accText : {
			bonus : "Bonus Alindi!",
			collectable : "Koleksiyon Alindi!",
			Find : Koleksiyon Bulundu!"
...
case "Get a collectable": w="collectable"; break;
case "Find a collectable": w="find"; break;
}
return w;
},
...
return (new Function("return "+GM_getValue("fvwm_accepted", "({bonus:[],find:[],get:[],collectable:[],hatch:[],adopt:[],bouquet:[],present:[],box:[],fuel:[],none:[]})")+";"))();
},
...
stat.textContent = "[FVWM] "+main.currReqs+" s3rkan12.";
},
...
GM_config.init("Serkan12 FarmDuvar "+version+" Ayarlari", {
	collectable : {
		...
		label : "Bonus ve Kolesiyonlar Alinsin mi?",
		type: "checkbox",
		"default" : true
	},
	hatch : {
