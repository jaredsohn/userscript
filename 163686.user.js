// ==UserScript==
// @name 		Schnullas German - Tiberium Alliances Combat Simulator
// @description 	Schlacht Simulator
...
/**This is a translate version of Eladas Combat Simulator
		...
		function createClasses()
		{
			...
			qx.Class.define("Simulator.StatWindow", 
			{
				...
				construct: function()
				{
					...
					var enemyHealthTitle = new qx.ui.basic.Label("Gegner Basis Zustand").set({ alignX: "center", alignY: "top", font: "font_size_14_bold"});
					...
					var eHLabelOverall = new qx.ui.basic.Label("Insgesamt:");
					var eHLabelBase = new qx.ui.basic.Label("Basis:");
					var eHLabelDefense = new qx.ui.basic.Label("Vert.Einh.:");
					var eHLabelCY = new qx.ui.basic.Label("Bauhof:");
					var eHLabelDF = new qx.ui.basic.Label("Vert.Einr.:");
					...
					var playerRepairTitle = new qx.ui.basic.Label("Reperatur Zeit").set({ alignX: "center", alignY: "top", font: "font_size_14_bold"});
					...
					var miscTitle = new qx.ui.basic.Label("Resultat").set({ alignX: "center", alignY: "top", font: "font_size_14_bold"});
