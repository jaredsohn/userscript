...
document.getElementById('[size=7][/size]').src = "http://img.ihere.org/uploads/2c1b59af07.gif";
...
document.getElementById('[url=*URL*]*Text*[/url]').src = "http://img.ihere.org/uploads/160f2c3e2d.gif";
...
document.getElementById('[img]http://img.ihere.org/uploads3/67401977db.png[/img]').addEventListener("click", setsmile, true);
document.getElementById('[img]http://img.ihere.org/uploads3/db33a060f5.png[/img]').addEventListener("click", setsmile, true);
document.getElementById('[img]http://img.ihere.org/uploads3/45a4404faf.png[/img]').addEventListener("click", setsmile, true);
document.getElementById('[img]http://img.ihere.org/uploads3/5538ea4caa.png[/img]').addEventListener("click", setsmile, true);
document.getElementById('[img]http://img.ihere.org/uploads3/1cef86cd2b.png[/img]').addEventListener("click", setsmile, true);
document.getElementById('[img]http://img.ihere.org/uploads3/67401977db.png[/img]').addEventListener("click", setsmile, true);
document.getElementById('[img]http://img.ihere.org/uploads3/f2e827a923.png[/img]').addEventListener("click", setsmile, true);
document.getElementById('[img]http://img.ihere.org/uploads3/83363d124c.png[/img]').addEventListener("click", setsmile, true);
document.getElementById('[img]http://img.ihere.org/uploads3/5ec8bf4582.png[/img]').addEventListener("click", setsmile, true);
document.getElementById('[img]http://img.ihere.org/uploads3/cf01d3e58e.png[/img]').addEventListener("click", setsmile, true);
...
document.getElementById('[img]http://www.up-th.com/images/3qfgq3tl7denxmc68ax.gif[/img]').addEventListener("click", setsmile, true);
document.getElementById('[img]http://www.up-th.com/images/8g1vupvy6xy6dpx978q1.gif[/img]').addEventListener("click", setsmile, true);
