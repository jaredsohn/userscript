// ==UserScript==
// @name           Ikariam Aide-Memoire (Offensive Points)
// @namespace      http://userscripts.org/scripts/show/51119
// @author         Martynius (http://userscripts.org/users/68307)
// @license        GNU GPL v3 (http://www.gnu.org/copyleft/gpl.html)
// @homepage       http://userscripts.org/scripts/show/51119
// @description    Shows the Offensive points of a player in the island view afer you have looked it up in the highscores.
...
if ( PAGE_ID !== undefined ) {
	new IkariamAideMemoire( {
		...
		SCRIPT_NAME: "Ikariam Aide-Memoire (Offensive Points)"
	});
}