...
// @description    A couple of Neogame functions for Ogame Redesign - v1.29.8
// @version	1.29.8
...
var AntigameFunc = function()
{
	...
	{
		lbl_missAttack: 'Saldırmak',
		lbl_missColony: 'Sömürgeleştirmek',
		lbl_missDeploy: 'Konuşlandırmak',
		lbl_missDestroy: 'Ay Yok Etmek',
		lbl_missEspionage: 'Casusluk',
		lbl_missExpedition: 'Keşif',
		lbl_missFederation: 'İttifak Saldırısı',
		lbl_missHarvest: 'Harabe Alanını Sök',
		lbl_missHold: 'İttifak Savunması',
		lbl_missTransport: 'Nakliye',
		
		lbl_shipSCargo: 'Küçük Nakliye',
		lbl_shipLCargo: 'Büyük Nakliye',
		...
		lbl_shipBomber: 'Bombardıman',
		lbl_shipDestroyer: 'Muhrip',
		lbl_shipRIP: 'Ölüm Yıldızı',
		lbl_shipBCruiser: 'Firkateyn',
		...
		lbl_RequiredEnergy: 'Gereken Enerji',
	...
	AntiGame_lang.InterfaceTR =
	{
		...
		opt_title: 'AntiGame Seçenekleri - Çeviri: RivaL',
		opt_btnOk: 'Tamam',
		opt_btnCancel: 'İptal Et',
		opt_btnDefault: 'Varsayılan',

		opt_language: 'Dil',
		opt_update_check: 'Güncellemeleri otomatik kontrol et',
		opt_thousandSeparator: 'Binlik basamak ayırıcı',
		opt_blockAutoComplete: 'Block Auto-Complete in Firefox',
		
		opt_showDeficient: 'Eksik Madenleri Göster',
		opt_showResources: 'Gelişmiş Maden Bilgisini Göster',
		opt_showNames: 'Gemi/Bina/Araştırma Resimlerinin Üstünde İsmini Göster',
		opt_nameColorOn: 'Yazı Rengi: Uygun',
		opt_nameColorOff: 'Yazı Rengi: Uygun değil',
		opt_nameColorDisabled: 'Yazı Rengi: Yeterli maden yok',
		opt_showConstructionTitle: 'İnşaat yapımını gezegen listesinde göster',
		...
		opt_uni_SpeedFactor: 'Evrenin Hız Faktörü',
		opt_uni_DFPercent: 'Filodan çıkan harabe oranı',
		opt_uni_DefenseToDF: 'Savunmadan çıkan harabe oranı',
		
		opt_timeSetting: 'Zaman değerlerini değiştir (sadece saat)',
		opt_showServerOgameClock: 'Sağ üstte ogame sunucu saatini tut',
		opt_showServerPhalanx: 'Keep server time for Phalanx view',
		opt_showPageStartTime: 'Sayfanın son yenilenme süresini göster',
		opt_timeAMPM: '24 yerine 12 saat formatını kullan (AM/PM)',
		
		opt_timeDontChange: 'Saati Değiştirme',
		opt_timeLocal: 'Her zaman yerel saati kullan',
		opt_timeServer: 'Her zaman sunucu saatini kullan',
		...
		opt_galaxyShowRank: 'Galaksi görünümünde Oyuncu/İttifak sırasını göster',
		opt_galaxyRankColor: 'Oyuncu/İttifak Seviyesini Renklendir',
		opt_galaxyDebrisMin: 'Enkaz alanını renkli göstermek için gerekli en az sayı (kapatmak için 0 yazın)',
		opt_galaxyDebrisColor: 'Enkaz alanını renkli göster',
		opt_galaxyHideMoon: 'Hide Moon picture (display moon size instead)',
		opt_galaxy_Players: 'Highlight the following players',
		opt_galaxy_PlayerColors: 'Oyuncuları vurgulamak için renkler',
		opt_galaxy_Allys: 'Highlight the following alliances',
		opt_galaxy_AllyColors: 'Colors for alliance highlighting',
		opt_galaxy_keepTipsPlanets: 'Keep tooltips for planets and moons',
		opt_galaxy_keepTipsDebris: 'Keep tooltips for debris fields',
		...
		opt_msg_DebrisThreshold: 'Low limit for theoretical debris (x1000)',
		opt_msg_foldSmallPlunder: 'Fold reports with plunder and debris less than the limit',
		opt_msg_showPlunder: 'Yağma miktarını casusluk raporlarında göster',
		opt_msg_addButtons: 'Mesajlarda Ek Butonlar',
		opt_msg_fixColors: 'Fix colors of combat reports',
		
		opt_fleet_showCapacity: 'Gemi kapesitesini ve hızını göster',
		opt_fleet1_showResCalc: 'Maden hesaplayıcısını göster',
		opt_uni_maxPlayerScore: 'En güçlü oyuncu 5m dan fazla puana sahip',
		opt_autocopyCoords: 'Koordinatları Otomatik Kopyala',
		opt_autocopyGlobal: 'Memorize coordinates from any page (not only current Ogame universe tabs)',
		opt_fleet2_setTargetDF: 'Filoda geri dönüşümcü varsa hedefi harabe seç',
		opt_fleet2_fixLayout: 'Fix flight information layout (page 2)',
		opt_fleet2_ShortLinks: 'Target shortlinks (page 2)',
		opt_fleet2_MoonColor: 'Color for moons in the shortlink list',
		opt_fleet2_MoonsToEnd: 'Move moons to the end of the shortlinks list',
		...
		opt_mvmt_expandFleets: 'Filo gemilerini ve nakliyeyi göster',
		opt_mvmt_showReversal: 'Show reversal time for fleets',
		
		opt_missAttack: 'Görev Rengi: Saldırmak',
		opt_missColony: 'Görev Rengi: Sömürgeleştirmek',
		opt_missDeploy: 'Görev Rengi: Konuşlandırmak',
		opt_missDestroy: 'Görev Rengi: Ay Yok Etmek',
		...
		opt_missHarvest: 'Görev Rengi: Harabe Alanını',
		opt_missHold: 'Görev Rengi: İttifak Savunması',
		opt_missTransport: 'Görev Rengi: Nakliye',
		opt_msg_addSimButton: 'Casusluk raporlarına simülatör butonu ekle',
		...
		lbl_sectionTime: 'Saat Ayarları',
		lbl_sectionEventList: 'Event list & Phalanx',
		lbl_sectionGalaxy: 'Galaksi',
		lbl_sectionMessages: 'Mesajlar',
		lbl_sectionFleetDispatch: 'Filo Görevleri',
		lbl_sectionFleetMovement: 'Filo Haraketleri',
		
		lbl_optionsNote1: 'Bu seçenek sadece bu gezegen için kaydedildi',
		
		lbl_resetCoords: 'Sıfırla - ',
		
		lbl_TotalCapacity: 'Toplam Kapesite',
		lbl_MinSpeed: 'Hız',
		lbl_ExPoints: 'Karşılık Gelen Puan',
		lbl_mvmt_Return: 'R',
		
		lbl_resources: 'Madenler',
		lbl_debris: 'Enkaz Alanı',
		lbl_total: 'Toplam',
		lbl_loot: 'Yağma',
		lbl_metal: 'Metal',
		lbl_crystal: 'Kristal',
		
		lbl_shipSCargoAlt: 'KN',
		lbl_shipLCargoAlt: 'BN',
		lbl_shipRecyclerAlt: 'Madenler',
		lbl_shipSatelliteAlt: 'Sat.',
		
		lbl_deficientRes: 'Eksik Madenler',
		lbl_Production: 'Üretim',
		lbl_ArrivalACS: 'Varış (İSS)',
		
		lbl_btnMarkReadAll: 'Görüntülenen tüm mesajları okundu say',
		lbl_btnDeleteSmallPlunder: 'Delete spy reports with plunder < $plunder and debris < $debris',
		...
		lbl_installNewVersion: 'Yeni versiyonu kurmak için tıklayın',
		lbl_Save: 'Kaydet',
		lbl_Clear: 'Temizle',
		lbl_Quantity: 'Miktar',
		lbl_Duration: 'Durma Süresi',
		lbl_Consumption: 'Tüketim',
		
		lbl_tmTime: 'Süre',
		lbl_tmCountdown: 'Geri sayım'
	};
	...
	var EventList =
	{
		...
		getMissionClass: function (row)
		{
			...
			mission = mission.src.match (/\/([\da-f]{30})\.gif/) [1];
			var mclass = "";
			...
			if (fleetType == -1) mclass = 'hostile';
				...
				switch(mission) {
					...
					case ('cd360bccfc35b10966323c56ca8aac'): mclass = "ownattack"; break;
					case ('b20ddc3fdb2486567ce20d24d3889d'): mclass = "ownhold"; break;
					case ('0bbcbc3a6d6b102c979413d82bac47'): mclass = "owncolony"; break;
					case ('4dab966bded2d26f89992b2c6feb4c'): mclass = "owndeploy"; break;
					case ('26dd1bcab4f77fe67aa47846b3b375'): mclass = "ownharvest"; break;
					case ('2af2939219d8227a11a50ff4df7b51'): mclass = "owntransport"; break;
					case ('87d615c4fb395b75ec902b66b7757e'): mclass = "ownfederation"; break;
					case ('575dfbbe877f58d6c09120ffbcaabe'): mclass = "owndestroy"; break;
					case ('60a018ae3104b4c7e5af8b2bde5aee'): mclass = "ownespionage"; break;
					case ('892b08269e0e0bbde60b090099f547'): mclass = "ownexpedition"; break;
		...
		fleet2_insertCSSRules: function()
		{
			...
			if (Options.fleet2_expandLists) {
				Utils.insertCSSRule('#slPanel { \
					padding: 5px; \
					margin: 2px 0 0 5px;\
					background-image: url("'+wrap_body_gif+'"); \
					width: 642px;\
				}');
