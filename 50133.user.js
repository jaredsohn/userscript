...
// проверка обновления Scripts_by_Ahmadi
...
function ShowNewVersionDialog(version,changelog) {
	...
	var text = '<h1><font color="#444444"><b>Доступна новая версия Scripts_by_Ahmadi '+version+'</b></font></h1><br><br>Изменения в новой версии:<ul>';
	...
	showDialog("Обновление Scripts_by_Ahmadi",text,"Обновить","Отмена",hideFunc()+"location.href='http://userscripts.org/scripts/source/xxxxx.user.js'",hideFunc());	
}
...
if (location.pathname == '/settings.php') {
	...
	if (GET['act'] != 'Scripts_by_Ahmadi') {
		...
		menuElements.innerHTML += '<li>'+settInActiveLink('Scripts_by_Ahmadi','?act=Scripts_by_Ahmadi','4.8em')+'</li>';
		...
		"<h4>Scripts_by_Ahmadi Настройки <small><font color='#98A7B5'>версия "+vkpathVersion+"</font></small></h4><div align='right'><small><a href='?checkVKUpdateNow=1&act=Scripts_by_Ahmadi'>Проверить обновление</a></small></div>"+
		"<form method=\"GET\" id=\"Scripts_Scripts_by_AhmadiSettings\" name=\"Scripts_by_AhmadiSettings\" action=\"\"><input type=\"hidden\" name=\"act\" value='Scripts_by_Ahmadi'><input type=\"hidden\" name=\"Scripts_by_Ahmadi\">"+
		...
		"<tbody>"+
			...
			settLine('Обновление')+
			settCheckbox('checkUpdates',		'Обновление',			'Проверять наличие новых версий Scripts_by_Ahmadi.')+		
