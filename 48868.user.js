...
var petname = '<em>-</em>';
							}			//get Haustier	[petname]
					
			
			if (online2 == 'Offline') {
					onlinehtml = '<div align="middle"><img src="http://kuestenpenner.ku.ohost.de/of.png></img></div>';						
					} else { 					
					onlinehtml = '<div align ="middle"><img src="http://mediaberlin.pennergame.de/img/on.png></img></div>';
					}
		
			online.innerHTML = onlinehtml;		
			
			tr[x].insertBefore(online, tr[x].getElementsByTagName('td')[7]);		//Fill in Online [onlinehtml-->online]]td[6]]
