...
function dataHandler(data) {
	...
	for(var i=0;i<trackList.length;i++) {
		...
		innerString += artist + "-" + mp3Title + "&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;<a href=\""+jiemiUrl+"\">" + "MP3" + "</a>";
		if(lyrics != "")
			innerString += "&nbsp;&nbsp;&nbsp;&nbsp;<a href=\""+lyrics+"\">"  + "Lyrics" + "</a>";		
	...
	document.getElementById('xiami_player').appendChild(downloadArea);
	document.getElementById('xiami_player').style.overflow = 'scroll';
}

var currentURL = window.location.href;

//in the play mode
if(currentURL.indexOf("http://www.xiami.com/song/play?ids") == 0){
