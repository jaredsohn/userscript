...
"en" :
{
      popups : {
        // Texts uses in pop-ups.
        show_games  : "Arată jocuri olimpice (on/off).",
        show_theater: "Arată piese de teatru (on/off).",
        show_party  : "Arată festivalele orașului (on/off).",
        show_triumph: "Arată parade triumfale (on/off).",
        next_party  : "Apăsați pentru <b>pornirea</b> unui festival al orașului.",
        auto_party  : "Interzis.",
        no_party    : "Nici un festival al orașului nu e disponibil momentan.",
        next_triumph: "Apăsați pentru <b>pornirea</b> unei parade de triumf.",
        auto_triumph: "Interzis.",
        no_triumph  : "Nici o paradă de triumf nu e disponibilă momentan."
...
function init ()
{
    ...
    if ( uW.document.URL.indexOf("=culture_overview")>0 )
