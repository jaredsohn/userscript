// ==UserScript==
// @name           Yahoo Fantasy NBA Bench 'Em All Custom20Inch6Pos
// @namespace      http://userscripts.org/users/Trecetratops/benchemall
// @description    Provides a couple of buttons next to "Submit Changes" ones to bench every player with night off FOR CUSTOM 20 INCH 6 POSITION
// @include        http://basketball.fantasysports.yahoo.com/nba/89423/*
...
var doBench = function(event) {
  ...
  var allElements;
  var thisElement;
  var myLineup = { "PG":1, "SG":1, "SF":1, "PF":1, "C":1, "Util":1 };
