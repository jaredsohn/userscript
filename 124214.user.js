...
var attack_unit_IonCannon     = "modal_attack_unit_ipt_20";  // "AttackIon"
...
(object) player = [object Object]
    ...
    (string) avatarId = 12
    (number) might = 3502842
    (number) title = 43
    (string) datejoinUnixTime = 1318718345
...
Tabs.tower = {
  ...
  init: function(div){
    ...
    var m = '<DIV class=pbStat>Empty Pockets Only</div><TABLE class=pbTab><TR align=center>';
...
Tabs.Hookers = {
    ...
    init: function(div){
        ...
        m += '</tr></table><SPAN class=boldRed id=Hookers></span>';
        t.myDiv.innerHTML = m;
		UpdateMainTabLink();
...
Tabs.PodTools = {
    ...
    init : function (div){
        ...
        try {
            ...
            <TR><TD><BR> </td></tr>';
            m += '</table><BR><BR><HR>After entering the number of troops in the boxes above, Click A place on the map and it will auto hit.';
            t.cont.innerHTML = m;
