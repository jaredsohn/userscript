...
// @description    Adds a button on Twitter profile pages to follow users' conversations with Quotably.com
// @include        *twitter.com/*
// ==/UserScript==
window.addEventListener('load', function()
	...
	for(i=0;i<h2s.length;i++)
		...
		an.href="http://quotably.com/"+uName;
		an.appendChild(img);
		an.innerHTML+="Follow me with quotably!";
