// ==UserScript==
// @name           Add New anywhere
// @namespace      Envelope150
// @description    Add new works from anywhere on redbubble
// @include        http://www.redbubble.com/*
// ==/UserScript==
function do_envelope150_script() {
html_insert_it(window.document,document.getElementById('new-header'),'<div style="text-align: center;"> Add New <a href="http://www.redbubble.com/mybubble/art/new">Art &amp; Photography </a>&nbsp; <a href="http://www.redbubble.com/mybubble/clothing/new" title="T-Shirt">T-Shirt</a>&nbsp; <a href="http://www.redbubble.com/mybubble/journal/new">Journal</a>&nbsp; <a href="http://www.redbubble.com/mybubble/writing/new">Writing</a><br></div><br>',true,false);
}; // Ends do_envelope150_script
window.addEventListener("load", function() { do_envelope150_script() }, false);
var genvelope150Bundle = Components.classes["@mozilla.org/intl/stringbundle;1"].getService(Components.interfaces.nsIStringBundleService);
var mystrings = genvelope150Bundle.createBundle("chrome://envelope150/locale/envelope150Core.properties");
var envelope150envelope150couldntfi1 = mystrings.GetStringFromName("envelope150envelope150couldntfi1");
var envelope150thisusuallyhappens = mystrings.GetStringFromName("envelope150thisusuallyhappens");

//
//  Mon Dec 19 15:59:37 2005 -- Scott R. Turner
//  Short, uncommented file containing all the code to implement envelope150
//  actions.  Can be "included" into the envelope150 script.
//
// 
// 
...
function envelope150_do(win, func_name, o, other, other2, other3) {
    var func = eval(func_name);
    var doc = null;
    if (func == null) return;
    if (!o) {
Warning(envelope150envelope150couldntfi1+
func_name+envelope150thisusuallyhappens);
    };
    doc = win.document;
