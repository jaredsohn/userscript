...
// @namespace      Travian
// @description    Battle Analyse 5.5.2
...
switch(lang){
	case ".ir":
		langfile=["اندازه اصلي حمله","معادل ضرر","تعداد اندازه از حفاظت در برابر پیاده نظام",
							"اندازه کل حفاظت در برابر سواره نظام","آمار كلي","تفاوت ضرر","مصرف",
							"درصد افزايش سطح قهرمان","ظرفیت","غلات از دست رفته","مصرف گندم كل ارتش",
							"قهرمان نشد","قهرمان","مقدار منابع صرف شده","حداكثر ظرفيت زنده ماندن",
							"حمله","دفاع","سود","ميزان غارت"];
		break;
	default:
...
//			alert(res);
			...
			rescell.appendChild(elem('span','f8','<b><font color=green size=2> ( '+atstemp[2]+' ) </font></b>'));
		}
		attHTML = '<img src="'+imgatti+'" align="left" height="15" width="15" style="padding-left: 3px">&nbsp;<font class="f8">'+atstemp[8]+'</font><br>';
		attHTML += '<img src="'+imgattc+'" align="left" height="15" width="15" style="padding-left: 3px">&nbsp;<font class="f8">'+atstemp[9]+'</font><br>';
		attHTML += '<img title="'+langfile[0]+'" src="'+imgatt_all+'" align="left" height="15" width="15" style="padding-left: 3px">&nbsp;<font class="f8">'+atstemp[0]+'</font>';
		if (warsim != 1) {
		...
		cell1.innerHTML='<font class="f8">'+langfile[1]+'</font>';
		...
		if (warsim != 1) {
			...
			if (efficiency == 100)
				cell2.innerHTML = "<font color=green>حداكثر منابع غارت شدند</font>";
			else if (efficiency == 0)
				cell2.innerHTML = "<font color=red>هيچ منبعي غارت نشد</font>";
			else
...
//	alert(troops);
	...
	table[0].innerHTML='<img title="'+langfile[2]+'" src="'+imgdef_i+'" align="absmiddle" height="15" width="15">&nbsp;<font class="f8">'+dtstemp[0]+'</font><br><img title="'+langfile[3]+'" src="'+imgdef_c+'" align="absmiddle" height="15" width="15">&nbsp;<font class="f8">'+dtstemp[1]+'</font>';
	rowi=document.createElement("tr");
	cell1=document.createElement("td");
	cell1.innerHTML='<font class="f8">'+langfile[1]+'</font>';
	cell2=document.createElement("td");
