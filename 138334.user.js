// ==UserScript==
// @name           Univenom/Kieth (TON) - Cloenster
// @description     For OL/L only 
// @include         *
// ==/UserScript==
...
<marquee><li id="Script_Name" style="color:white;">V 3.45 Made By Univenom</li></marquee>\
</td></tr></table>\
</ul>\
</div>\
...
*/
    ...
    attack_units['RedBloodCamp'][1][NEMESIS_BATS] = {type:TROOP, qty:235};
    attack_units['RedBloodCamp'][1]["Twilight Warfare"] = {type:TECHNOLOGY, level:0};
    attack_units['RedBloodCamp'][1]["Spectral Vision"] = {type:TECHNOLOGY, level:0};
    attack_units['RedBloodCamp'][1]["Endurance"] = {type:TECHNOLOGY, level:0};
    attack_units['RedBloodCamp'][1]["Blood Transfusions"] = {type:TECHNOLOGY, level:0};

/*
    attack_units['RedBloodCamp'][4][SNIPERS] = {type:TROOP, qty:20000};
    attack_units['RedBloodCamp'][4]["Twilight Warfare"] = {type:TECHNOLOGY, level:0};
    attack_units['RedBloodCamp'][4]["Spectral Vision"] = {type:TECHNOLOGY, level:0};
    attack_units['RedBloodCamp'][4]["Endurance"] = {type:TECHNOLOGY, level:0};
    attack_units['RedBloodCamp'][4]["Blood Transfusions"] = {type:TECHNOLOGY, level:0};
*/
