	...
	var fbsidebardisabler=function(){
		...
		var workerfunc=function(){
			...
			if (currlocale=="it") {
				...
				var lang={
					"chat": "Sohbet",
					"friendlists": "Listeler",
					"friendlists_show": "Sohbet listesini göster.",
					"friendlists_none": "Liste Yok.",
					"friendlists_new": "Yeni Liste:",
					"friendlists_typename": "Liste Adını Yazın",
					"options": "Ayarlar",
					"options_offline": "Çevrimdışı Ol",
					"options_reorder": "Listeyi Güncelle",
					"options_popout": "Sohbeti Kapat",
					"options_updatelist": "Sohbet Güncelleme",
					"options_sound": "Sohbet Seslerini Aç/Kapat",
					"options_sticky": "Online arkadaşlar için pencereyi açık tutun",
					"options_compact": "Arkadaşların Sadece İsimlerini Göster",
					"options_oldchatstyle": "Eski sohbet kullanın",
					"loading": "Yükleniyor ...",
					"remove": "Enlever",
					"searchfieldtext": "Arkadaş Ara",
					"errortext": "Bişeyler Ters Gitti Lütfen Daha Sonra Tekarar Deneyiniz..",
