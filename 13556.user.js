   1. // ==UserScript==
   2. // @name mr.exceptional ka flood script
   3. // @namespace http://userscripts.org/people/17268
   4. // @description mr.exceptional's flooding script
  ...
  16.     s+= 'a[href*="http://www.orkut.com/Profile.aspx?uid=5028461720169600702"] {color:black;}\n';
  17.
  18. //----------------------------------------------------------------
  19. // All topics page
  20. //----------------------------------------------------------------
