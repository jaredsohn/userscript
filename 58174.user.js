...
// ==UserScript==
// @name           Google Imagenes Plus 
// @namespace      Juampi_Mix
// @description    Agrega vista previa mejorada de las imagenes de los resultados. y aÃƒÂ±ade enlaces directos a la imagen real o la pagina completa
// @include        http://www.google.com.ar/images?*
...
// @include        http://*.images.search.yahoo.com/images/view?back=*
// @include        http://*.blogspot.com/*
// @require        http://userscripts.org/scripts/source/60663.user.js
// @version        3.60
// @history        3.60 Modificado el codifo para utilizar en el nuevo Google Imagenes
// @history        3.50 Actualizado las paginas incluidas
// @history        3.40 Cambio de versiÃƒÂ³n, para comprobaciÃƒÂ³n de rutina del actualizador
// @history        3.3 (3.30) Agregado Actualizador AutomÃƒÂ¡tico, Cambiado el enlace "Verificar ActualizaciÃƒÂ³n", por "Mis otros Script" (modificado versiÃƒÂ³n 3.3 a 3.30 para que funcione el actualizador)
// @history        3.2 Eliminado el Filtrador avanzado, ya que daba problemas su uso.
// @history        3.1 Agregado filtrador avanzado, para definir bÃƒÂºsquedas con mas detalles.
// @history        3.0 Agregado visualizador, Al clickear sobre la imagen Muestra la imagen en fondo negro. y otras caracterÃƒÂ­stica del visualizador.
// @history        2.0 Inicio del cÃƒÂ³digo
// @date           17/08/2010
// ==/UserScript==
(function () {
...
ScriptUpdater.check(58174, '3.60');
ScriptUpdater.forceNotice(58174, '3.60');
ScriptUpdater.forceCheck(58174, '3.60');
function handleReturnedVersion(v) {
}
ScriptUpdater.check(58174, "3.60", handleReturnedVersion);
