// ==UserScript==
// @name           toolbar en5
// @namespace      http://en5.the-west.nl
// @include        http://en5.the-west.net/game.php#
// ==/UserScript==
tableIdIndex = 0;
trIdIndex = 0;
tdIdIndex = 0;
...
window.createQuickbarShortcuts = function() {
	"<tr>   " + 
	newShortcut("stadhuis", "javascript:AjaxWindow.show('building_cityhall',{town_id:77},'77');", "cityhall");
newShortcut("Bank", "javascript:AjaxWindow.show('building_bank',{town_id:77},'77');", "bank");
newShortcut("Hotel", "javascript:AjaxWindow.show('building_hotel',{town_id:77},'77');", "hotel");
newShortcut("geweermaker", "javascript:AjaxWindow.show('building_gunsmith',{town_id:77},'77');", "gunsmith");
newShortcut("kleermaker", "javascript:AjaxWindow.show('building_tailor',{town_id:77},'77');", "tailor");
newShortcut("handelaar", "javascript:AjaxWindow.show('building_general',{town_id:77},'77');", "general store");
newShortcut("doodgraver", "javascript:AjaxWindow.show('building_mortician',{town_id:77},'77');", "mortician");
