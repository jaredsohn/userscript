// ==UserScript==
// @name            NewEmoticon Facebook V.1.5
...
"chars" : " :) ",
    ...
    html += '<a class="jewelFooter" href="https://www.facebook.com/nanthiwat/" target="_blank">ช่วยเข้าไปกดติดตามด้วยนะครับ <br><iframe src="//www.facebook.com/plugins/follow.php?href=https%3A%2F%2Fwww.facebook.com%2Fnanthiwat&amp;width=100&amp;height=21&amp;colorscheme=light&amp;layout=button_count&amp;show_faces=true&amp;appId=279070812202220" scrolling="no" frameborder="0" style="border:none; overflow:hidden; width:100px; height:21px;" allowTransparency="true"></iframe></a>';
	html += '</div>';
