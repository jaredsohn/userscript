// ==UserScript==
// @name              MEKY Sigma Trainer
// @namespace      http://www.facebook.com/145Barisdemirci145 Edited by: meky
...
function init() {
  ...
  unsafeWindow.disableSubmitButton = function(form) {
    for (i = 0; i < form.elements.length; i++) {
      if (form.elements[i].type == 'submit') {
        form.elements[i].value = 'For my fans <3 Baris~';
      }
    }
    return true;
  } 
  ...
  createToggler(container, 'Baris ::: Auto-battle:', 'autoBattle');
