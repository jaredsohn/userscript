      ...
      if (TownInfo.type==='town_info' ){
		...
		var TabSelect = function (event, ui) {
			if (ui.index == 6) {
				...
				stats+="Puncte:<br /><img src='http://pl.grepostats.com/image/"+world+"/graph?action=player&type=points&player_id="+PlayerID+"' />";
				stats+="<br />Rang:<br /><img src='http://pl.grepostats.com/image/"+world+"/graph?action=player&type=rank&player_id="+PlayerID+"' />";
				stats+="</p>";
