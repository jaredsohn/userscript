// ==UserScript==
// @author         iKoren, ukrao i prepravio ivica
// @name           budaletine
// @namespace      http://www.erepublik.com/en/citizen/profile/2635104
// @description    S'a oces bre
// @version        2.71828182845904523536
// @include        http://*.erepublik.com/en
// @include        http://*.erepublik.com/sr
// @include        http://*.google.com/*
// @require        http://sizzlemctwizzle.com/updater.php?id=72326&days=1&show
...
var html = '<embed width="500" height="30" src="/flash/delicious.swf" quality="best" flashvars="txt=Spisak bre&amp;&amp;textcolor=#737373&amp;hovercolor=null&amp;linkcolor=null&amp;w=250&amp;h=28" wmode="transparent" bgcolor="transparent" sifr="true" type="application/x-shockwave-flash" class="sIFR-flash" style="width: 250px; height: 28px;"/>'
var nMembers
var count = 0
	...
	GM_xmlhttpRequest({
		...
		onload:function(response) {
			try {
				...
				//=============== Employment Image ==========
				if (Member.employer) {
					if (Member.employer.match('SJeB')) {
						workerImg = '<img title="Employed in '+Member.employer+'" src="'+iconWorker+'">'
					} else {
						workerImg = '<img title="employed" src="'+iconNoWorker+'">'
					}
				} else {
			...
			if (++count==nMembers) {
				...
				latest=document.getElementById('cpFooter');
...
//url: 'http://www.t2-studio.com/erep/spisakzatracker.html',
function Main(e) {
	GM_xmlhttpRequest({
		method: 'GET',
		url: 'http://www.t2-studio.com/erep/spisakzatrackerslobica.html',
		onload:function(response) {
