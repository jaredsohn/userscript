...
var townView=document.evaluate("//a[@title='בחן את העיר שנבחרה']", document.body, null, 9, null).singleNodeValue;   
if ( townView ){ delay = getRandomInt (1000, 2000); townView.click(); }
} //eof

function click_pirateFort(){
var pirateFort=document.evaluate("//a[contains(@title,'מבצר הפיראטים')]", document.body, null, 9, null).singleNodeValue;   
