// ==UserScript==
// @name Travian Attack Builder FOR T3.5 SERVER P1
// @author      Update by Hill Thank you Hill  (( Support T3.5))
// @email       XKX@W.CN
// @version     2.2.3p5
// @source      http://userscripts.org/scripts/show/49249
// @include     http://*.travian*.*/a2b.php*
// @include     http://*.travian.co.*/*.php*
...
// @enclude     http://*.travian*.*/payment.php*
...
// revised at 31/05/2009 19:10:05
// a few of code changed, it excpected to work correctly with
// scheduled arrival time, but schedule is limited by 24 hours.

var SCRIPT = {
    url : 'http://userscripts.org/scripts/source/49865.user.js',
    version : '2.2.3p5' //same value as @version
};
...
switch ( sLang ) {
    ...
    case "cn":// by congxz6688
        text = ["正在派遣军队...","无效的部队类型","没有设定攻击目标","没有足够的部队! (部队 #","没有输入部队","开始于：","目标有误","没有侦察兵","已发出：","发兵波次设定:","增加新的部队组合","重置","攻击设定:","攻击类型:","普通","增援","掠夺","侦察 资源/军队","侦察防御/军队","目标","马上出兵!","到达时间","预期到达时间: ","设定到达时间","同一行内相同部队的发出波数","用'|'隔开X坐标、Y坐标 例如: 0|1","错误: ","帐号问题","已确定目标时间:","每波时间间隔:(默认为500毫秒)","Wrong timed arrival set:","","Unable set delayed arrival time","All timers reset to initial state","Sending at:","Too late send troops to arrive at selected time:"];
    ...
    case "tw":// by bluelovers
        text = ["兵力調動中","無效的攻擊類型!","未指定攻擊目標!","沒有足夠的軍隊! (軍隊#","沒有設定攻擊軍隊","正在派遣軍隊","錯誤的攻擊目標","沒有偵察軍種","完成派兵","攻擊設定","新增攻擊","還原設定","攻擊設定:","攻擊類型:","正常攻擊","增援","搶奪攻擊","偵察資源/軍隊","偵察防禦/軍隊","攻擊目標","立即派遣軍隊","軍隊到達時間","到達目標於:","設定攻擊到達時間","攻擊的波數","用targetSplit","分隔多村、","cordsSplit ","分隔坐標，如 ","cordsSplit","targetSplit","cordsSplit+","錯誤:","無法取得目標村莊的資訊","軍隊到達時間:","波次延遲(毫秒)","Wrong timed arrival set:","","Unable set delayed arrival time","All timers reset to initial state","Sending at:","Too late send troops to arrive at selected time:"];
    ...
    case "et"://by jeje
        text = ["Ataca!!! =)","Tipo de ataque invalido!","No hay coordenadas!","No hay suficientes Tropas! (Tropas #","No tropas introducidas","Empezando","Problamente malas coordenadas","No hay exploradores","Correcto-Hecho","Configurar Ataque:","Añadir nuevo ataque","Resetear","Configurar ataque:","Tipo de ataque:","Normal","Refuerzos","Atraco","Acechar Produccion/Tropas","Achechar Defensas/Tropas","Coordenadas","Ataca camarada! =)","Tiempo de Llegada","Llegara a las :","Establecer tiempo de llegada","Numero de ataques de esta estrategia","con '|' ex: 0|0,1|1","ERROR:","Incapaz de encontrar la aldea activa. Assuming one village account","Tiempo de llegada establecido a las:","Time between waves in ms: (default 500)","Wrong timed arrival set:","","Unable set delayed arrival time","All timers reset to initial state","Sending at:","Too late send troops to arrive at selected time:"];
    ...
    case "tr"://by kustah
        text = ["vur tekmeyi =)","yanlış atak tipi!","cordinat yok!","yeterli asker yok! (askerler #","asker seçilmedi","başlıyor","yanlış kordinat","gözcü yok","Bitti","Dalga ayarı:","Yeni dalga ekle","Reset","Atak ayarı:","Atak tipi:","Normal","Destek","Yağmalama","Hammade gözle","Defans gözle","Kordinat","Vur tekmeyi! =)","Ulaşım zamanı","Varış saati:","Ulaşım zamanı ayarı","Dalgadaki saldırı sayısı","with '|' ex: 0|0,1|1","Hata:","Hesap kapalı","Ulaşım zamanı :","Time between waves in ms: (default 500)","Wrong timed arrival set:","","Unable set delayed arrival time","All timers reset to initial state","Sending at:","Too late send troops to arrive at selected time:"];
    ...
    case "cz": //CeP
        text = ["Odesílám","Chybný typ útoku!","Chybí souřadnice!","Nedostatek jednotek! (Jednotka #","Neurčil jsi útočné jednotky :)","Start","Asi špatné souřadnice","Nemáš špehy","Hotovo","Nastavení vlny:","Přidat další vlnu","Reset","Nastavení útoku:","Typ útoku:","Útok","Podpora","Loupež","Špehovat suroviny/jednotky","Špehovat obranu/jednotky","Souřadnice","Odeslat útok","Zjistit čas příchodu","Přijít v:","Načasovat příchod","Počet útoků ve vlně","oddělovač souřadnic - ';' - středník - např.: -5|10,51|-110","CHYBA:","Nelze odeslat ..","Příchod nastaven na:","Time between waves in ms: (default 500)","Wrong timed arrival set:","","Unable set delayed arrival time","All timers reset to initial state","Sending at:","Too late send troops to arrive at selected time:"];
    ...
    case "co.il": //By Optimusik
        text = ["Надерти сідниці! =)","Невірний тип атаки!","Вкажіть координати!","більше немає військ! (Військо #","Не вказані війська","Початок","Ймовірно невірні координати","Немає розвідників","Готово","Налаштування хвилі:","Додати хвилю","Скинути","Налаштування атаки:","Тип атаки:","Звичайна","Підкріплення","Набіг","Розвідати ресурси та військо","Розвідати оборонні споруди та військо","Координати","Надерти сідниці! =)","Час прибуття","Прибуття в:","Встановлення часу прибуття","Кількість атак для вказаної хвилі","роздільник '|' наприклад: 0|0,1|1","Помилка:","Неможливо визначити активне поселення. Вкажіть одне з поселень","Час прибуття встановлений в:","Time between waves in ms: (default 500) ","Wrong timed arrival set:","","Unable set delayed arrival time","All timers reset to initial state","Sending at:","Too late send troops to arrive at selected time:"];
    ...
    case "ru": //by KrasivayaSvo
        text = ["Погнали...","Неправильный тип атаки!","Укажите правильные координаты!","больше нет войск! (Войско #","Не указаны войска","Начали","Верояно неправильные координаты","Нет разведчиков","Готово","Настройки волны:","Добавить волну","Сброс","Настройки атаки:","Тип атаки:","Нападение","Подкрепление","Набег","Разведка ресурсов и войск","Разведка обороны и войск","Координаты","Надрать задницу!","Время прибытия","Прибытие в:","Установка времени прибытия","Число атак для указанной волны","разделитель '|' например: 0|0,1|1","Ошибка:","Невозможно определить активную деревню. Укажите одну из деревень","Время прибытия установлено в:","Интервал между волнами в мс.: (по умолчанию 500) ","Не верно задано время прибытия:","","Не возможно установить указанное время прибытия!","Все таймеры сброшены в начальное значение.","Отправка в:","Слишком поздно для отправки к указанному времени:"];
        cataText = ["Выберите цель =)","Случайно","Лесопилка","Глиняный карьер","Железный рудник","Ферма","Деревообрабатывающий завод","Кирпичный завод","Чугунолитейный завод","Мукомольная мельница","Пекарня","Склад","Амбар","Кузница оружия","Кузница доспехов","Арена","Главное здание","Пункт сбора","Рынок","Посольство","Казарма","Конюшня","Мастерская","Академия","Ратуша","Резиденция","Дворец","Торговая палата","Большая казарма","Большая конюшня","Таверна","Большой склад","Большой амбар","Чудо света","Treasury"];
        break;

    case "it": //by psea
        text = ["Inviare ! =)","Tipo si attacco errato!","Coordinate assenti!","Truppe insufficienti! (Truppe #","Truppe non immesse","Partenza","Errate coordinate ?","Nessuna spia","Fatto","Ondata :","Altra ondata","Reset","Attacco :","Tipo di attacco:","Normale","Rinforzo","Raid","Spia. Ris/Truppe","Spia. Dif/Truppe","Coord.","Inviare ! =)","Time Arrivo ","Arrivo alle :","Imposta orario di arrivo","Numero di attacchi di questa Ondata","con '|' es: 0|0,1|1","ERRORE:","Impossibile ottenere il villaggio.attivo. Si assume un solo villaggio","Ora di arrivo fissata alle :","Tempo tra le ondate in ms: (default 500)","Wrong timed arrival set:","","Unable set delayed arrival time","All timers reset to initial state","Sending at:","Too late send troops to arrive at selected time:"];
    ...
    default:
        text = ["Whooping some ass =)","Invalid attack type!","No valid cords!","not enough troops! (Troop #","No troop input","Starting","Probably bad cords","No scout units","Done","Wave setup:","Add new wave","Reset","Attack setup:","Attack type:","Normal","Reinforcement","Raid","Scout Res/Troops","Scout Def/Troops","Cords","Whoop some ass! =)","Arrival time","Arrive at:","Set timed arrival","Number of attacks of that specific wave","with ',' ex: 0|0,1|1","ERROR:","Unable to get active village. Assuming one village account","Timed arrival set at:","Time between waves in ms: (default 500) ","Wrong timed arrival set:","","Unable set delayed arrival time!","All timers reset to initial state","Sending at:","Too late send troops to arrive at selected time:"];
        cataText = ["Select a target =)","Random","Woodcutter","Clay Pit","Iron Mine","Wheat Field","Sawmill","Brickworks","Iron Foundry","Flour Mill","Bakery","Warehouse","Granary","Blacksmith","Armory","Tournament Square","Main Building","Rally Point","Marketplace","Embassy","Barracks","Stable","Siege Workshop","Academy","Town Hall","Residence","Palace","Trade Office","Great Barracks","Great Stable","Hero\'s Mansion","Great Warehouse","Great Granary","Wonder of the World","Treasury"];
        break;
}
...
var timedAttacktimer = null;
var timedAttackDate = null;
var troops = new Array();
var totTroops = new Array();
var cord = null;
var Race = getRace();
var referenceTime = 0;
var have_troops = false;
var have_valid_cors = false;
var getArrivalTimeDone = false;
var switchActiveVillageDone = false;
...
var numberattacks = 0;
var totalattacks = 0;
var myimbabuttonClicked = false;

function attack()
{
    myimbabuttonClicked = true;
    if (firstRun)
    {
        cordN = 1;
        wavesSent = 0;
        myimbabutton.innerHTML = text[0];
        numberOfWaves = nthWave - 1; // nthWave is n+1 inputs
        ...
        var sCords = document.getElementById('cords').value;
        if (!sCords)
        {
            errorMsg(text[2]);
            abort();
        ...
        for (var num = 0; num <= 11; num++)
        {
            if (num <= 10)
            {
                ...
                for (var x = 0; x < troop.length; x++)
                {
                    ...
                    if (!num) {
                        totalattacks = totalattacks + parseInt(troop[x].value);
                    }
        ...
        for (var x = 1; x <= 10; x++) //Sjekker om man har nok tropper
        {
            ...
            if ((totTroops[x] * cord.length) > getTotalUnit('t'+tempX)) {
                errorMsg(text[3] + x + ")");
                abort();
                return;
            }
        ...
        addCount("<b><span style=\"color:red;\">" + text[5] +"</span></b>:&nbsp;&nbsp;(" +
                 sTime.snapshotItem(0).textContent + ")", 1);
...
//      post(url, postvar, xcord, ycord, troops[11][wavesSent], troops[12][wavesSent], spy);
        ...
        ++nThisWave;
        if (nThisWave >= troops[0][wavesSent]) {
            wavesSent++;
            nThisWave = 0;
        }
        ...
        if ( nThisWave == 0 )
        {
            ...
            var timewait = document.getElementById('timebetween').value;
            if ( timewait != null )
            {
                timebetweenwaves = parseInt(timewait, 10);
                if ( timebetweenwaves == NaN )
                {
                    timebetweenwaves = 500;
                }
            }
    ...
    GM_xmlhttpRequest({
        ...
        onload: function(responseDetails) {
            ...
            var sTime = document.evaluate(
                ...
                null);
            addCount("&nbsp;&nbsp;&nbsp;&nbsp;<a href='build.php?"+(DID != "" ? DID+'&' : "")+"id=39'>"+
                     text[0]+" ("+sTime.snapshotItem(0).textContent+")</a>", 1);
            if (numberattacks >= totalattacks)
            {
                addCount("<a href='build.php?"+(DID != "" ? DID+'&' : "")+"id=39'>"+text[8]+" ("+
                         sTime.snapshotItem(0).textContent+") x "+numberattacks+"("+
                         totalattacks+")</a>", 1);  //legg inn delay her
                if ( timedAttacktimer == null )
                {
                    reset();
                }
            }
...
//              errorMsg("(" + xcord +',' + ycord + ")" +text[6] +"."  );
            ...
            if (kat != 0) {
                postData = postData + '&kata=' + kat;
            }
            if (kat2 != 0) {
                postData = postData + '&kata2=' + kat2;
            }
...
attackInterface.innerHTML = '<fieldset><legend>' + text[12] + '</legend><div id=start><table width="100%"><tr><td colspan="2">' + text[13] + '</td></tr><tr><td colspan="2"><select name=\"typeAttack\" id=\"typeAttack\" class=\"fm\"><option value=\"3\">' + text[14] + '</option><option value=\"2\">' + text[15] + '</option><option value=\"4\">' + text[16] + '</option><option value=\"5\">' + text[17] + '</option><option value=\"6\">' + text[18] + '</option></select></td></tr><tr><td colspan="2">' + text[19] + '&nbsp;&nbsp;<span style="font: 11px/1.5em Tahoma,Verdana,Arial !important; color:grey;">(&nbsp;' + text[25] + '&nbsp;)</span></td></tr><tr><td colspan=\"2\"><input type=\"text\" value=\"' + getCords() + '\" name=\"cords\" id=\"cords\" class=\"fm\" style=\"width:98%;\" /></td></tr><tr><td colspan=\"2\" style=\"padding-top:0.5em;padding-bottom:0.8em;\">' + text[29] + '&nbsp;&nbsp;<input class=\"fm\" style=\"color:#777;width:18%;\" id=\"timebetween\" type=\"text\" value=\"500\" /></td></tr><tr><td><button id=\"arrivalTime\" style=\"font-size:smaller;\">' + text[21] + '&nbsp;??</button></td><td style=\"width:68%;\"><div id=\"arrivalTimeDiv\">' + text[21] + ': ??:??:??</div></td></tr><tr><td colspan="2" style=\"padding-top:0.8em;padding-bottom:0.3em;\">' + text[22] + '</td></tr><tr><td colspan="2"><input id=\"timedArrivalInput\" value=\"hh:mm:ss\" class=\"fm\"> <button id=\"timedArrivalButton\" style=\"font-size:smaller;margin-left:2em;\">' + text[23] + '</button></td></tr></table>';
...
table += "<td><img src=\"img/x.gif\" class=\"unit uhero\"></td></tr></table>";
//table += "<td>" + targetLogo + "</td><td>" + targetLogo + "</td>";
table += '<div style=\"margin-top:0.8em;\"><button id="newWaveButton" style=\"font-size:small;margin-left:1em;\">' + text[10] + '</button> <button id=\"myimbabutton\" style=\"font-size:small;margin-left:1em;\">' + text[20] + '</button> <button id="resetButton" style=\"font-size:small;margin-left:1em;\">' + text[11] + '</button><br><span style="padding-left:1em; font: 11px/1.5em Tahoma,Verdana,Arial !important; color:grey;">( * - ' + text[24] + ' )</span><span style="font: 11px/1.5em Tahoma,Verdana,Arial !important; color:#ff0000;">' + text[31] + '</span></div>';
...
function popup(id)
{
    ...
    function test(id) {
        ...
        field.innerHTML = "<option value=\"" + element.options[element.selectedIndex].value+"\">" +
                            element.options[element.selectedIndex].value+"</option>";
...
function reset()
{
    ...
    var timebetween = document.getElementById('timebetween');
    timebetween.value = "500";
}
...
function errorMsg (msg)
{
    ...
    errDiv.innerHTML = errDiv.innerHTML +  "<br><span style=\"color:red;\"><b>"+text[26]+"</b></span>&nbsp;" + msg;
}
...
function getActiveDid()
{
    ...
    if(!tag.snapshotLength) {
        ...
        ex = "id('vlist')/table/tbody/tr[@class='sel']/td/a[contains(@href,'newdid')]";
        tag = document.evaluate(ex, document, null, XPathResult.UNORDERED_NODE_SNAPSHOT_TYPE, null);
    }
    //End Hill edition
    if (tag.snapshotLength)
...
function addInfoDiv()
{
    ...
    infoDiv.innerHTML = "<div><div style=\"margin-left:20px;\" id=\"err\"></div><br><br><div style=\"margin-left:20px;\" id=\"count\"></div></div>";
...
function abort()
{
    setTimeout(function(){realAbort();},250);
}
...
function realAbort ()
{
    ...
    numberattacks = 0;
    totalattacks = 0;
    myimbabuttonClicked = false;
    timedAttacktimer = null;
    timedAttackDate = null;
    clearInterval(timerIntervalId);
    timerIntervalId = null;
    getArrivalTimeDone = false;
    have_troops = false;
    have_valid_cors = false;
    switchActiveVillageDone = false;
    myimbabutton.innerHTML = text[20];
    document.getElementById('arrivalTimeDiv').innerHTML = text[21] +':&nbsp;' + "??:??:??";
    addCount('*&nbsp;' + text[33], 1);
}
...
function getCheckTroops()
{
    ...
    for(var x = 1; x <= 10; x++) //Sjekker om man har nok tropper
    {
        ...
        if (totTroops[x] > getTotalUnit('t'+tempX)) {
            errorMsg(text[3] + x+ ")");
            abort();
            return;
        }
...
{
    var tempWaveNumber = 0;
    getCheckTroops();
    if ( !have_troops ) {
        getArrivalTimeDone = true;
        return;
    }
    ...
    var xy = sCords.split(targetSplit)[0].split(cordsSplit);
    if ( xy[0].match(/^[+-]?\d+$/) && xy[1].match(/^[+-]?\d+$/) ) {
        have_valid_cors = true;
    } else {
        have_valid_cors = false;
        getArrivalTimeDone = true;
        errorMsg(text[2]);
    ...
    var tempTargetCord = splitN(sCords.split(targetSplit)[0], cordsSplit);
    var Xcord = tempTargetCord[0];
    var Ycord = tempTargetCord[1];

    var tempUrl = document.location.href.split('?')[0] + '?' + DID;
    var tempPostvar = 'b=1&t1=' + troops[1][tempWaveNumber] + '&t4=' + troops[4][tempWaveNumber] +
                      '&t7=' + troops[7][tempWaveNumber] + '&t9=' + troops[9][tempWaveNumber] + '&t2=' +
                      troops[2][tempWaveNumber] + '&t5=' + troops[5][tempWaveNumber] + '&t8=' +
                      troops[8][tempWaveNumber] + '&t10=' + troops[11][tempWaveNumber] + '&t3=' +
                      troops[3][tempWaveNumber] + '&t6=' + troops[6][tempWaveNumber] + '&c='+ 3 +
                      '&dname=&x=' + Xcord + '&y=' + Ycord + '&s1=ok';
...
//      seconds = parseInt(seconds,10) + parseInt(diffTime,10);
    ...
    if (!have_troops || !have_valid_cors)
    {
        clearInterval(timerIntervalId);
        getArrivalTimeDone = false;
        reset();
    ...
    var sTime = document.evaluate("id('tp1')", document, null, XPathResult.UNORDERED_NODE_SNAPSHOT_TYPE, null);
    var aMatch = sTime.snapshotItem(0).textContent.match(/^([0-9]{1,2}):([0-9]{2}):([0-9]{2})$/i);
    ...
    sDate.setMilliseconds(550);

    // aDate is arrival time from now
    var aDate = new Date(sDate.getTime() + referenceSeconds*1000);

    if (timedAttacktimer)
    {
        var tTimer = timedAttacktimer.split(':');
        var sTimer = sDate.toTimeString().split(/\s+/)[0].split(':');
        if (tTimer.length == 3 && sTimer.length == 3 )
        {
            tHours =   parseInt(tTimer[0], 10);
            tMinutes = parseInt(tTimer[1], 10);
            tSeconds = parseInt(tTimer[2], 10);

            sHours =   parseInt(sTimer[0], 10);
            sMinutes = parseInt(sTimer[1], 10);
            sSeconds = parseInt(sTimer[2], 10);

            if ( !myimbabuttonClicked && tHours == sHours && tMinutes == sMinutes && tSeconds == sSeconds )
            {
                myimbabuttonClicked = true;
                attack();
            } else if ( !switchActiveVillageDone && tHours == sHours && (tMinutes-5) == sMinutes && tSeconds == sSeconds )
            {
                switchActiveVillage();
            } else if ( sDate.getDay() == timedAttackDate.getDay() &&
                        (sDate.getTime() - timedAttackDate.getTime()) > referenceSeconds*1000 ) {
                clearInterval(timerIntervalId);
                switchToRallyPoint();
                return;
            }
            ...
            var _tm = new Date();
            if ( timedAttackDate.getTime() >= sDate.getTime() )
            {
                if ( timedAttackDate.getMonth() > sDate.getMonth() ||
                     timedAttackDate.getDate() > sDate.getDate() ) {
                    _tm.setHours(0);
                    _tm.setMinutes(0);
                    _tm.setSeconds((timedAttackDate.getTime() - sDate.getTime())/1000);
                }
                else
                {
                    var timesec = sDate.getHours()*3600 + sDate.getMinutes()*60 + sDate.getSeconds();
                    _tm.setTime(timedAttackDate.getTime() - timesec*1000);
                }
            }
            else
            {
                var timesec = timedAttackDate.getHours()*3600 + timedAttackDate.getMinutes()*60 + timedAttackDate.getSeconds();
                _tm.setTime(sDate.getTime() - timesec*1000);
            }
            document.getElementById('arrivalTimeDiv').innerHTML = text[34] + '&nbsp;' +
                    timedAttackDate.toTimeString() +
                    "<div style=\"text-align:center;\">[ " +
                    _tm.toTimeString().split(/\s+/)[0] + " ]</div>";
        }
    }
    else
    {
        document.getElementById('arrivalTimeDiv').innerHTML = text[21]+':&nbsp;'+aDate.toTimeString();
    }
}

function switchActiveVillage() {
    switchActiveVillageDone = true;
    GM_xmlhttpRequest({
        method: "GET",
        url: "http://" + document.domain + "/dorf1.php" + (DID != "" ? "?"+DID : ""),
        headers:{'Content-type':'application/x-www-form-urlencoded'}
    });
    return;
}

function switchToRallyPoint()
{
    abort();
    location.replace("http://" + document.domain + "/build.php?" + (DID != "" ? DID+"&" : "") + "id=39");
}

function waitArrivalTime()
{
    if ( !getArrivalTimeDone ) {
        setTimeout(function(){waitArrivalTime();}, 1000);
    } else {
        setArrivalTimer();
    }
    return getArrivalTimeDone;
}
...
{
    var timedInput = document.getElementById('timedArrivalInput').value;
    var aMatch = timedInput.match(/^([0-9]{1,2}):([0-9]{1,2})(?::([0-9]{1,2}))?$/i);
    if ( aMatch ) {
        if ( !getArrivalTimeDone ) {
            getArrivalTime();
            if ( waitArrivalTime() == false ) {
                return;
            }
        }
        ...
        sDate.setHours(parseInt(aMatch[1], 10));
        sDate.setMinutes(parseInt(aMatch[2], 10));
        sDate.setSeconds(aMatch[3] ? parseInt(aMatch[3], 10) : 0);

        if (referenceSeconds) {
            // sending time
            timedAttackDate = new Date(sDate.getTime() - referenceSeconds*1000);
            timedAttacktimer = timedAttackDate.toTimeString().split(/\s+/)[0];
        } else {
            timedAttackDate = new Date(sDate.getTime());
            timedAttacktimer = aMatch[1].replace(/\b(\d)\b/g, '0$1')+":"+aMatch[2].replace(/\b(\d)\b/g, '0$1')+":"+
                (aMatch[3] ? aMatch[3].replace(/\b(\d)\b/g, '0$1') : "00");
        }

        // reset
        getArrivalTimeDone = false;

        // TODO: test if time correct
        // server's time
        var srvTime = document.evaluate("id('tp1')", document, null, XPathResult.UNORDERED_NODE_SNAPSHOT_TYPE, null);
        aMatch = srvTime.snapshotItem(0).textContent.match(/^([0-9]{1,2}):([0-9]{2}):([0-9]{2})$/i);
        sDate = new Date();
        sDate.setHours(parseInt(aMatch[1]));
        sDate.setMinutes(parseInt(aMatch[2]));
        sDate.setSeconds(parseInt(aMatch[3]));
        // 24 time span
        if ( sDate.getTime() >= timedAttackDate.getTime() ) {
            timedAttackDate.setDate(timedAttackDate.getDate() + 1);
        }

        if ( have_troops && have_valid_cors ) {
            addCount(text[34] + " " + timedAttackDate.toTimeString(), 1);
            clearInterval(timerIntervalId);
