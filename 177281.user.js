...
javascript:
 ...
 script name = smart_vills_renamer
 auther = Bassem
 version = 0.1
 
 -- The script have the following methods
 1)- Normal Villages Renamer 
 2)- Villages Renamer  Name with index
 3)- Villages Renamer in the form of distance from a certain coords
 4)- Villages Renamer in the form of Random coordinates
 5)- Villages list as HTML code with points from the player profile page
 6)- Import/Export Old Village Names
 var type = prompt("اختر الطريقة التي تريد تسمية القرى بها :\n\n\n 1 : عادي\n\n 2 : ع ترقيم\n\n 3 : المسافة من احداثية معينة\n\n 4 : على شكل احداثيات عشوائية\n\n 5 : تحويل القرى  الى اكواد مع نقاط من ملف الاعب\n\n 6 : استيراد او تصدير اسماء القرى القديمة")

//Villages Renamer+# for vill < 1000

javascript:
var text = prompt("Naming My Villages", 'dOOmsDay.');
var doc = document;
