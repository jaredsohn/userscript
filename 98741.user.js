...
2011-02-08 (Version 3.9.11) Hiro
   - add adv.players tab (+oninestatus, +loginDate)   
**********************/

var Version = '3.9.11';
var Versiondate = '3.9.11';
var Scriptname = 'Officer Tools';
var ScriptTabName = 'Officer';
...
Tabs.board = {
  ...
  myDiv : null,
  timer : null,
  forumlink :  'http://community.kabam.com/forums/forumdisplay.php?4-Kingdoms-of-Camelot',  
...
Tabs.script = {
  ...
  tabLabel : 'KocTls',            // label to show in main window tabs
  myDiv : null,
  timer : null,
...
Tabs.wikia = {
  tabOrder : 35,                    // order to place tab in top bar
  tabLabel : 'Wikia',            // label to show in main window tabs
  myDiv : null,
  timer : null,
...
/****************************  External Chat Tab   ******************************/
Tabs.extChat = {
  tabOrder : 22,                    // order to place tab in top bar
  tabLabel : 'TrpTme',            // label to show in main window tabs
  myDiv : null,
  timer : null,
  chatlink :  'http://free.7host06.com/carlmc29670/troopspeed.html',  
  
  init : function (div){    // called once, upon script startup
    var t = Tabs.extChat;
    t.myDiv = div;
    div.innerHTML = '<CENTER><iframe src="'+ t.chatlink +'" width="100%" height="700" name="board_in_a_box" <p>Ihr Browser kann leider keine eingebetteten Frames anzeigen: Sie k&ouml;nnen die eingebettete Seite &uuml;ber den folgenden Verweis aufrufen: <a href="'+ t.chatlink +'">Knights of Phoenix Forum</a></p> </iframe> <BR></center>';
  },
