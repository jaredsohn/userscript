// ==UserScript==
// @name        Add All Your Friends To Group in 1 click by : Ilysoft
// @author      Ilysoft
...
var locales = {
	"ar": {
		"addbstr": "إضافة كل الأصدقاء",
		"dlgtstr": "إضافة أصدقاء إلى المجموعة",
		"dlgwstr": "Ilysoft",
...
function Main() {
	...
	var settingsbuttoncheck = setInterval(function() {
		if (!document.getElementById('fbga') && settingsbutton) {
			...
			addbutton.id = "fbga";
			var addbuttoninht = "<i class='mrs img sp_6b0izw 
...
function AddToGroup() {
	...
	var bodytxt = "<div class='_1yv' role='dialog' style='width: 445px; margin-top: 

97.5px;'><div class='_1yu'><div class='_t'><div class='pvs phm _1yw'>" + dlgtstr + 

"</div><div class='pam _13'><p id='fbgadlglin1' style='font-weight:bold;font-size:20px;'>" + 

dlgwstr + "</p><p id='fbgadlglin2' style='font-weight:bold;'>" + dlgastr + "</p><p 

id='fbgadlglin3'>" + dlgfstr + " : <font color='blue' style='font-weight: bold;' 

id='fbgafn'>" + Allids.length + "</font></p><p id='fbgadlglin4'>" + dlgpstr + " : <font 

color='Brown' style='font-weight: bold;' id='fbgapro'>0</font> | " + dlgrstr + " : <font 

style='font-weight: bold;' id='fbgaram'>" + Allids.length + "</font> | " + dlgsstr + " : 

<font color='green' style='font-weight: bold;' id='fbgasuc'>0</font> | " + dlgistr + " : 

<font color='red' style='font-weight: bold;' id='fbgafal'>0</font></p></div><div 

class='_14'><div class='pam uiOverlayFooter uiBoxGray topborder' 

id='fbgadivclose'></div></div></div></div></div>";
...
("fbgasuc").textContent = scss;
		...
		document.getElementById("fbgadlglin2").innerHTML = "<font id='fbgafn' 

color='gree' style='font-weight: bold;'>" + scss + "</font> " + dlgffstr;
		document.getElementById("fbgadlglin3").setAttribute("style", "font-

weight:bold;");
		document.getElementById("fbgadlglin3").innerHTML = "<font id='fbgafn' 

color='red' style='font-weight: bold;'>" + fail + "</font> " + dlgfsstr;
		document.getElementById("fbgadlglin4").parentNode.removeChild

(document.getElementById("fbgadlglin4"));
		document.getElementById("fbgabut").parentNode.removeChild

(document.getElementById("fbgabut"));
...
function CloseButton() {
	document.getElementById("fbgadialog").parentNode.removeChild

(document.getElementById("fbgadialog"));
}
