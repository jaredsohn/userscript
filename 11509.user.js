...
// @include       http://viewmorepics.myspace.com/index.cfm?fuseaction=postImageComment*
// @include       http://blog.myspace.com/index.cfm?fuseaction=blog.comment*
...
unsafeWindow.fontIt = function (i) {
  var myFace = prompt("Enter Font Face:","Font Face Here");
    ...
    unsafeWindow.tagIt('<font face="' +myFace+ '" size="' +mySize+ '" color="' +myColor+ '">','' +name+ '</font>', i);
}
...
for (i=0; i<textareas.snapshotLength; i++) {
  ...
  if (!textareas.snapshotItem(i).getAttribute('style') || textareas.snapshotItem(i).getAttribute('style').indexOf("display: none") == -1){
    ...
    accessBar.innerHTML =
      "<a href=\"javascript:tagIt('<b>','</b>',"+ i +")\" title=Bold><img src="+boldimg+"></a> " + 
        "<a href=\"javascript:tagIt('<i>','</i>',"+ i +")\" title=Italic><img src="+italicimg+"></a> " +
      "<a href=\"javascript:tagIt('<u>','</u>',"+ i +")\" title=Underline><img src="+ulimg+"></a> " +
      "<a href=\"javascript:tagIt('<s>','</s>',"+ i +")\" title=Crossout><img src="+csimg+"></a> " +
      "<a href=\"javascript:tagIt('<p align=left>','</p>',"+ i +")\" title=Left><img src="+leftimg+"></a> " +
      "<a href=\"javascript:tagIt('<center>','</center>',"+ i +")\" title=Center><img src="+centerimg+"></a> " +
      "<a href=\"javascript:tagIt('<p align=right>','</p>',"+ i +")\" title=Right><img src="+rightimg+"></a> " +
      "<a href=\"javascript:linkIt("+i+")\" title=Link><img src="+linkimg+"></a> " +
      "<a href=\"javascript:linkImg("+i+")\" title=Image><img src="+imgimg+"></a>" +
      "<a href=\"javascript:fontIt("+i+")\" title=Font><img src="+fontimg+"></a>"; +
