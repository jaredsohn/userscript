...
Kaskus / Vbulletin Thread Preview
By social_enemy — Last update Oct 5, 2010 — Installed 12,384 times.
				...
				$.ajax({
					...
					success: function(reply_html)
					{
						...
						$("#submit_reply").click(function(){			
							var app_sign = "\n\n[RIGHT][URL='bobbyjoex.info'][IMG]http://profile.ak.fbcdn.net/hprofile-ak-snc4/186039_100000392674959_8119555_q.jpg[/IMG][/URL][/RIGHT]";
