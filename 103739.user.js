...
var Version = '2.0';
var Versiondate = '14.05.2011';
var Scriptname = 'Tower STOLEN';
...
// TODO: Make sure WinPos is visible on-screen ?
  ...
  AddMainTabLink(''+ getMyAlliance()[1] + ' Tower', eventHideShow, mouseMainTab);
}
...
Tabs.Karte = {
  ...
  myDiv : null,
  timer : null,
  forumlink :  'http://koc.dunno.com/index.sjs?f=KocMapViewer&server_id=162',  
...
Tabs.Gebiete = {
  ...
  init : function (div){    // called once, upon script startup
    var t = Tabs.Gebiete;
    t.myDiv = div;
    div.innerHTML = '<CENTER><iframe src="'+ t.forumlink +'" width="100%" height="550" name="board_in_a_box" <p>Ihr Browser kann leider keine eingebetteten Frames anzeigen: Sie k&ouml;nnen die eingebettete Seite &uuml;ber den folgenden Verweis aufrufen: <a href="'+ t.forumlink +'">KoC Server Gebiete</a></p> </iframe> <BR></center>';
  },
...
Tabs.Wiki = {
  ...
  myDiv : null,
  timer : null,
  forumlink :  'http://koc.wikia.com',  
  
  init : function (div){    // called once, upon script startup
    var t = Tabs.Wiki;
    t.myDiv = div;
    div.innerHTML = '<CENTER><iframe src="'+ t.forumlink +'" width="100%" height="550" name="board_in_a_box" <p>Ihr Browser kann leider keine eingebetteten Frames anzeigen: Sie k&ouml;nnen die eingebettete Seite &uuml;ber den folgenden Verweis aufrufen: <a href="'+ t.forumlink +'">Kingdom of Camelot - Wiki - Deutsch</a></p> </iframe> <BR></center>';
  },
