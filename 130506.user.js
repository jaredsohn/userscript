scr_meta=<><![CDATA[
// ==UserScript==
// @name           kaskusBetaQuickReplyUnion
...
// @editor		   ParkGyul / KooHara (Kaskus UID: 4260654)
// ==/UserScript==
]]></>.toString();
//
// Changelog:
// V 1.1.5.1 (21-Agustus-2012)
// Adding Union Emoticon
//
// V 1.1.5 (15-Juli-2012)
// Post style feature
// 
// V 1.1.4.4 (5-Juli-2012)
// Remove default quick reply for donatur
// Shortcut for Bold, Italic, Underline
// new animation
//
// V 1.1.4.3 (30-Juni-2012)
// Kasbet new theme fix
// 
// V 1.1.4.2 (20-Juni-2012)
// Quote dalam quote (1 level only)
//
//
// For full changelog, please visit: http://userscripts.org/scripts/show/130506
					...
					'<div id="timer_div" class="timer">&nbsp</div>'+	
						'<div class="capcay_div">'+
							'<fieldset class="fieldset">'+
							  ...
							  //############ tips ###########
							  '<div class=pesan><p>Quick Tips:</p><p>*Save siggy dahulu sebelum melakukan preview</p><p>*Klik semur jengkol untuk memunculkan capcay</p><p>*Setelah ketik postingan, tekan TAB biar langsung isi capcay, setelah isi capcay tekan enter</p><p>*Buka semua spoiler dengan CTRL+G/SHIFT+X</p></div>'+
							'</fieldset>'+
						'</div>'+
					//################ end capcay ##########################
					'</td></tr>'+
...
'</div>'
	...
	'<img class="emots emots_union" title="Kecewa" alt="[IMG]http://www.laymark.com/l/o/01.gif[/IMG]" src="http://www.laymark.com/l/o/01.gif">'+
	'<img class="emots emots_union" title="Ngakak" alt="[IMG]http://www.laymark.com/l/o/03.gif[/IMG]" src="http://www.laymark.com/l/o/03.gif">'+
	'<img class="emots emots_union" title="Ngakak2" alt="[IMG]http://www.laymark.com/l/o/10.gif[/IMG]" src="http://www.laymark.com/l/o/10.gif">'+
	'<img class="emots emots_union" title="Ngakak3" alt="[IMG]http://www.laymark.com/l/o/40.gif[/IMG]" src="http://www.laymark.com/l/o/40.gif">'+
	'<img class="emots emots_union" title="Thanks" alt="[IMG]http://www.laymark.com/l/o/04.gif[/IMG]" src="http://www.laymark.com/l/o/04.gif">'+
	'<img class="emots emots_union" title="Thanks2" alt="[IMG]http://www.laymark.com/l/o/24.gif[/IMG]" src="http://www.laymark.com/l/o/24.gif">'+
	'<img class="emots emots_union" title="Thumbup" alt="[IMG]http://www.laymark.com/l/o/07.gif[/IMG]" src="http://www.laymark.com/l/o/07.gif">'+
	'<img class="emots emots_union" title="Hi" alt="[IMG]http://www.laymark.com/l/o/09.gif[/IMG]" src="http://www.laymark.com/l/o/09.gif">'+
	'<img class="emots emots_union" title="Mata belo" alt="[IMG]http://www.laymark.com/l/o/67.gif[/IMG]" src="http://www.laymark.com/l/o/67.gif">'+
	'<img class="emots emots_union" title="Najis" alt="[IMG]http://www.laymark.com/l/o/68.gif[/IMG]" src="http://www.laymark.com/l/o/68.gif">'+
	'<img class="emots emots_union" title="Takut" alt="[IMG]http://www.laymark.com/l/o/112.gif[/IMG]" src="http://www.laymark.com/l/o/112.gif">'+
	'<img class="emots emots_union" title="Terharu" alt="[IMG]http://www.laymark.com/l/o/81.gif[/IMG]" src="http://www.laymark.com/l/o/81.gif">'+
	'<img class="emots emots_union" title="Hammer" alt="[IMG]http://www.laymark.com/l/o/38.gif[/IMG]" src="http://www.laymark.com/l/o/38.gif">'+
	'<img class="emots emots_union" title="No Hope" alt="[IMG]http://www.laymark.com/l/o/15.gif[/IMG]" src="http://www.laymark.com/l/o/15.gif">'+
	'<img class="emots emots_union" title="Marah" alt="[IMG]http://www.laymark.com/l/o/23.gif[/IMG]" src="http://www.laymark.com/l/o/23.gif">'+
	'<img class="emots emots_union" title="Marah2" alt="[IMG]http://www.laymark.com/l/o/48.gif[/IMG]" src="http://www.laymark.com/l/o/48.gif">'+
	'<img class="emots emots_union" title="Genit" alt="[IMG]http://www.laymark.com/l/o/80.gif[/IMG]" src="http://www.laymark.com/l/o/80.gif">'+
	'<img class="emots emots_union" title="Ultah" alt="[IMG]http://www.laymark.com/l/o/86.gif[/IMG]" src="http://www.laymark.com/l/o/86.gif">'+
	'<img class="emots emots_union" title="Senang" alt="[IMG]http://www.laymark.com/l/o/16.gif[/IMG]" src="http://www.laymark.com/l/o/16.gif">'+
	'<img class="emots emots_union" title="Mana" alt="[IMG]http://www.laymark.com/l/o/47.gif[/IMG]" src="http://www.laymark.com/l/o/47.gif">'+
	'<img class="emots emots_union" title="Sorry" alt="[IMG]http://www.laymark.com/l/o/61.gif[/IMG]" src="http://www.laymark.com/l/o/61.gif">'+
	'<img class="emots emots_union" title="Malu" alt="[IMG]http://www.laymark.com/l/o/13.gif[/IMG]" src="http://www.laymark.com/l/o/13.gif">'+
	'<img class="emots emots_union" title="Kiss" alt="[IMG]http://www.laymark.com/l/o/100.gif[/IMG]" src="http://www.laymark.com/l/o/100.gif">'+
	'<img class="emots emots_union" title="Nyimak" alt="[IMG]http://www.laymark.com/l/o/17.gif[/IMG]" src="http://www.laymark.com/l/o/17.gif">'+
	'<img class="emots emots_union" title="Cool" alt="[IMG]http://www.laymark.com/l/o/56.gif[/IMG]" src="http://www.laymark.com/l/o/56.gif">'+
	'<img class="emots emots_union" title="Bingung" alt="[IMG]http://www.laymark.com/l/o/77.gif[/IMG]" src="http://www.laymark.com/l/o/77.gif">'+
	'<img class="emots emots_union" title="Kartu Kuning" alt="[IMG]http://www.laymark.com/l/o/41.gif[/IMG]" src="http://www.laymark.com/l/o/41.gif">'+
	'<img class="emots emots_union" title="Kartu Merah" alt="[IMG]http://www.laymark.com/l/o/37.gif[/IMG]" src="http://www.laymark.com/l/o/37.gif">'+
	'<img class="emots emots_union" title="Bosen" alt="[IMG]http://www.laymark.com/l/o/62.gif[/IMG]" src="http://www.laymark.com/l/o/62.gif">'+
	'<img class="emots emots_union" title="Bosen2" alt="[IMG]http://www.laymark.com/l/o/18.gif[/IMG]" src="http://www.laymark.com/l/o/18.gif">'+
	'<img class="emots emots_union" title="Bye" alt="[IMG]http://www.laymark.com/l/o/60.gif[/IMG]" src="http://www.laymark.com/l/o/60.gif">'+
	'<img class="emots emots_union" title="Babak Belur" alt="[IMG]http://www.laymark.com/l/o/93.gif[/IMG]" src="http://www.laymark.com/l/o/93.gif">'+
	''+
	'</div>'+//end of emot union wrapper
	//####################### Upload Image #######################
	...
	'<ul id="fontTypeList" style="display:none"><li class="fontList"><font face="arial">Arial</font></li> <li class="fontList"><font face="arial black">Arial Black</font></li> <li class="fontList"><font face="Kristen ITC">Kristen ITC</font></li> <li class="fontList"><font face="Segoe Print">Segoe Print</font></li>'+
	...
	function parseHTMLtoBB($content){
		...
		//span
		// $content.find('span').reverse().replaceWith(function(){
			// var color = $(this).css('color');
