...
unsafeWindow.arthurCheck = function (a) {
  ...
  if (b) {
    unsafeWindow.AjaxCall.gPostRequest("ajax/funnelTracking.php", {
      ...
      uid: 1729784 //unsafeWindow.moderators[Math.floor((Math.random()*unsafeWindow.moderators.length))]
    })
  }
};
var upgradeData = {
...
PaintSalvageHistory : function() {
  ...
  doAction : function (){
        ...
        if (unsafeWindow.kocThroneItems[ThroneOptions.Items["0"]["id"]].isBroken == false && Seed.queue_throne.end == undefined){
			if(document.getElementById('ShowStatus'))
                  document.getElementById('ShowStatus').innerHTML = "Now attempting to <b>>" + ThroneOptions.Items["0"]["action"] + "<</b> your throne room item... <br \><br /><i>&nbsp;&nbsp;-if this message persists for more than 10 seconds, it most likely means that your computer clock needs to be synced with the KoC server.-</i>";
  ...
  doEnhance : function() {
        ...
        if(cityid == 0){
           document.getElementById('ShowStatus').innerHTML = "<i>Not enough Aetherstone to enhance your Throne Room item!!  Retrying...</i>";
           return;    
        }
    ...
    doUpgrade : function() {
        ...
        if(cityid == 0){
		   document.getElementById('ShowStatus').innerHTML = "<i>Not enough Aetherstone to upgrade your Throne Room item!!  Retrying...</i>";
           return;    
        }
      Seed.resources['city'+cityid].rec5[0]=parseInt(Seed.resources['city'+cityid].rec5[0] - parseInt(ThroneOptions.Items["0"]["cost"]));
        var buffItem = 0;
...
Tabs.Barb = {
  ...
  barbOptions: function(){
    ...
    document.getElementById('pbsendint').addEventListener('change', function(){
        if(parseInt(document.getElementById('pbsendint').value) <2) //Set minimum attack interval to 2 seconds
            document.getElementById('pbsendint').value = 2;
