...
Following code belongs to In your circles xiaolaba_mod.
Copyright (C) 2012 xiaolaba G
...
// ==UserScript==
// @id             InYourCirclesXiaolabaMod
// @name           In Your Circles xiaolaba_mod
// @version        0.1.3
// @namespace      gplus.inYourCircles
// @author         xiaolaba G
// @description    Restore In your circles section (49 people version)
    ...
    GM_xmlhttpRequest({
        ...
        onload: function (response) {
            ...
            var container = document.querySelector('div[class="GPInYc KBMoYc c-wa-Da Yf96sb"]');
                ...
                for (var i = 0; i < Math.min(userptr.length, 50) ; i++) {
