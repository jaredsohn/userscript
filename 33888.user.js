...
//SONIQSA
for(var i=0;i<bilder.length;i++) {
if(bilder[i].src.match(/\/soniqsa\/3.jpg/)) {bilder[i].src="http://i36.tinypic.com/6f4h2v.jpg";bilder[i].width="220";bilder[i].height="300";}
}
//SMONG
for(var i=0;i<bilder.length;i++) {
...
//MYOKEEN
for(var i=0;i<bilder.length;i++) {
if(bilder[i].src.match(/\/myokeen\/3.jpg/)) {bilder[i].src="http://i34.tinypic.com/syawwn.jpg";bilder[i].width="220";bilder[i].height="300";}
}
//NITEDALS
for(var i=0;i<bilder.length;i++) {
...
//NOTBLOND
for(var i=0;i<bilder.length;i++) {
if(bilder[i].src.match(/\/notblond\/3.jpg/)) {bilder[i].src="http://i38.tinypic.com/t5j7zb.gif ";bilder[i].width="220";bilder[i].height="300";}
}
//MALMO95
for(var i=0;i<bilder.length;i++) {
...
//M4RT1NM
for(var i=0;i<bilder.length;i++) {
if(bilder[i].src.match(/\/m4rt1nm\/3.jpg/)) {bilder[i].src="http://i37.tinypic.com/2psizjq.jpg ";bilder[i].width="220";bilder[i].height="300";}
}
//RBH
for(var i=0;i<bilder.length;i++) {
...
//SHANNARA
for(var i=0;i<bilder.length;i++) {
if(bilder[i].src.match(/\/shannara\/3.jpg/)) {bilder[i].src="http://i38.tinypic.com/1zbz2xf.gif";bilder[i].width="220";bilder[i].height="300";}
}
//JACOBANDRE
for(var i=0;i<bilder.length;i++) {
...
//MEG
for(var i=0;i<bilder.length;i++) {
if(bilder[i].src.match(/\/caladorion\/3.jpg/)) {bilder[i].src="http://i35.tinypic.com/18iwdw.jpg";bilder[i].width="220";bilder[i].height="300";}
}
//NETTENUTT
for(var i=0;i<bilder.length;i++) {
...
akt=akt.nextSibling;
>
akt.innerHTML = akt.innerHTML +'<br><img src="http://i37.photobucket.com/albums/e52/casicrime/offsec.jpg">'
...
akt.innerHTML = akt.innerHTML + '<img src="http://i37.photobucket.com/albums/e52/casicrime/CasiHacks-1.gif">';
...
for(i=0;i<links.length;i++) {
 if(links[i].innerHTML=="Casi & JokerRoX") {
  links[i].innerHTML="Agentlederºº²";
  links[i].style.color="#00FF00"; {
   if(links[i].href='http://www.nettby.no/user/index.php?user_id=495114');
   break;
  }
 }
}
...
for(q=0;q<fakta.length;q++){
	if(fakta[q].innerHTML=="Fakta")
		{fakta[q].innerHTML="Info om meg,som ingen bryr seg om...:";
		break;
	}
}
...
for(q=0;q<imON.length;q++){
	if(imON[q].innerHTML=="Pålogget")
		//{imON[q].innerHTML="<center><blink>Jeg er ONLINE @ Nettby ! =D </blink></center>";
