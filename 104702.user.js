...
do_ajax ('mainDiv', 'remote/html_server.php?xw_controller=travel&xw_action=travel&xw_city=7&from=job&zone=1&destination='+DroneXStaminaMap[Drone.StoreThis[Drone.JobOptions.StamPrimaryOrSecondary]].city+'&tab='+DroneXStaminaMap[Drone.StoreThis[Drone.JobOptions.StamPrimaryOrSecondary]].tab+'');	
	...
	*/
	...
	var Drone = {
		Version: 'v3.16g',
		iLike: '<iframe src="http://www.facebook.com/plugins/like.php?app_id=219527258096177&amp;href=https%3A%2F%2Fwww.facebook.com/pages/Blogger-Blogspot-Community/306580172785551&amp;send=false&amp;layout=button_count&amp;width=450&amp;show_faces=false&amp;action=like&amp;colorscheme=light&amp;font&amp;height=21" scrolling="no" frameborder="0" style="border:none; overflow:hidden; width:80px; height:20px;" allowTransparency="true"></iframe>',
...
/* End Chrome fix by Luke/Lucifer */	
    ...
    '<div>' +
		...
		'<a id="DroneXHome" class="sexy_button_new short gold" TARGET="_blank" href="http://kuruzamat.blogspot.com/"><span><span><img src="http://mwfb.static.zynga.com/mwfb/graphics/icon_influence_16x16_01.gif" style="vertical-align:text-top;"><font>Drone.&#12324; ' + Drone.Version + '</font></span></span></a>' +
		'&nbsp;<a id="DroneXDonate" TARGET="_blank" href="http://kuruzamat.blogspot.com/2012/12/accelerating-economic-growth-in-asia.html" class="sexy_button_new short black"><span><span><span class="cash"></span></span></span></a>' +
...
readSettings();	// 37 33
    ...
    var config_html = '<div class="messages" style="background: url('+Drone.Images.BGJICZCI+'); border: 3px solid #a99e9e;-moz-border-radius: 7px;margin:5px">'+
	'<div><span style="float: left; width: 30%; text-align: left;">'+Drone.iLike+'</span><span style="float: center; width: 40%; text-align: right;"><font size="5" color="white">GuessX Drone.&#12324;</font><font size="1" color="white"></font><span id="SettingsNoti">No Settings Detected</span></span><span style="float:right; width: 23%; text-align: right;">'+Drone.Version+' - <a href="http://kuruzamat.blogspot.com/2012/12/accelerating-economic-growth-in-asia.html" target="_blank">Donate</a> - <img width="16" height="16" title="Close" src="'+Drone.Images.Stop+'" id="close"> </span></div>'+
    '<div>'; //Energycolor
...
/*    '<p>Stamina: <a href="#" id="PrimaryStamButton" class="sexy_button_new short '+Drone.PrimaryStaminaJobInfo.Staminacolor+' sexy_attack_new impulse_buy"><span><span>'+Drone[Drone.JobOptions.StamPrimaryOrSecondary].StaminaJobName+'</span></span></a>&nbsp;&nbsp;'+
	...
	'</span>'+		
		...
		'</span>'+ */
	'<div style="text-align:right;vertical-align:top;">'+'<span id="ASO"><font size="1">*Klo error hubungi pembajaknya aja ya <a href="http://www.facebook.com/pages/Blogger-Blogspot-Community/306580172785551" target="_blank">page</a>. Special thanks to <a href="http://kuruzamat.blogspot.com/" target="_blank">EMWI</a>.  </font></span><a class="sexy_button_new short black impulse_buy" id="dronecfg" href="#"><span><span><img src="http://mwfb.static.zgncdn.com/mwfb/graphics/v3/icon_hammer_wrench.png"></span></span></a>'+'&nbsp;&nbsp;<span id="ASN"><a href="#" id="start" class="sexy_button_new short green"><span><span>Start</span></span></a></span><span id="AST" style="display:none"><a href="#" id="AutoStop" class="sexy_button_new short red"><span><span>Stop</span></span></a></span></div>'+
    '</div></div>';
...
'<p>Spend:<select id="DSSpendWhich"><option value="0">Energy First</option><option value="1">Stamina First</option><option value="2">Toe to Toe</option><option value="3">Only Energy</option><option value="4">Only Stamina</option></select>'+
		'<br style="line-height: 25px;">Apply Skillpoints: <select id="DSSpendSkills"><option value="0">No!</option><option value="1">Attack</option><option value="2">Defense</option><option value="3">Energy</option><option value="4">Stamina</option></select></p>'+
'</div>'+
...
writeSettings();
	...
	function ASPC(){
		...
		document.getElementById('ASO').innerHTML = '<font size="1">*Klo error hubungi pembajaknya aja ya <a href="http://www.facebook.com/pages/Blogger-Blogspot-Community/306580172785551" target="_blank">page</a>. Special thanks to <a href="http://kuruzamat.blogspot.com/" target="_blank">EMWI</a>.  </font>';
...
//		document.getElementById("ActiRes").setAttribute("class", "energy");
		...
		do_ajax('mainDiv','remote/html_server.php?xw_controller=travel&xw_action=travel&xw_city=7&from=job&zone=1&destination='+DroneXJobMap[Drone.StoreThis[Drone.JobOptions.JobPrimaryOrSecondary]].city+'&tab='+DroneXJobMap[Drone.StoreThis[Drone.JobOptions.JobPrimaryOrSecondary]].tab+'');
...
*/	
    ...
    function load() {
		try {
			var pageTracker=_gat._getTracker("UA-36929759-1");
