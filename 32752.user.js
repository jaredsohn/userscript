...
// 27/08/2008
// ==UserScript==
// @name Vendetta Inattivi
// @author mitm[ITA]
// @descrizione: Tool Inattivi per Vendetta powered by mitm
...
(function(){
		...
		if(celleth[9].innerHTML.search("value=\"s\" selected") != -1) {
			...
			tmp2 = serverID.indexOf("/vendetta/", tmp1);
...
function pl_det(pl_id, pl_name, conta, serverID){
	...
	html = '<html><head><title>Dettaglio Player ' + pl_name + '</title></head><body bgcolor=black><font color=#dfdbc9><H1>Dettaglio punti player ' + pl_name + '</H1></font><table border=1 bordercolor=black cellpadding=3 cellspacing=0><tr><td height="7" bgcolor=#dfdbc9>Classifica</td><td height="7" bgcolor=#dfdbc9>Posizione</td><td height="7" bgcolor=#dfdbc9>Nome</td><td height="7" bgcolor=#dfdbc9>Pt.Allenamento</td><td height="7" bgcolor=#dfdbc9>Pt.Edific</td><td height="7" bgcolor=#dfdbc9>Pt.Unita\'</td><td height="7" bgcolor=#dfdbc9>Pt.Totale</td><td height="7" bgcolor=#dfdbc9>Num.Edifici</td></tr>';
