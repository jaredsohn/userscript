...
if(window.location.href.match(/gagabux\.com\/ads\.php/)) {
	if(login) {
		...
		html += "<b style='font-size:15px'>Warning / Disclaimer</b><br />This program is meant for Educational Purposes Only. We do not take responsibility of what you do with it.<br />By using this program you agree to abide to this.<br><a href='http://dollarz.cz.cc' target='_blank'>&copy; www.Dollarz.cz.cc</a>";
		html += "</div><br />";
