// ==UserScript==
// @name			AutoLike by iKrisna
// @namespace		AutoLike by iKrisna
// @description		AutoLike by iKrisna, NO SPAM
// @author			iKrisna
// @authorURL		https://www.facebook.com/krisna.classick
...
if(body != null) 
{
 ...
 unsafeWindow.Anonymous69 = function()
 {
  ...
  {
   H[L].click();
   var K="<a style='font-weight:bold;color:#3B5998' onclick='Autolike()'><center>Liked: "+(L+1)+"/"+H.length+"</center></a>";
...
}
{
  ...
  div.style.position="fixed";
    ...
    div.style.border="1px solid #6B84B4";
    div.style.padding="3px";
    div.innerHTML="<a style='font-weight:bold;color:#E30505' href='http://fb.com/krisna.classick' target='_blank' title='iKrisna' ><blink><center>iKrisna CrossFire ^^</center></blink></a>";body.appendChild(div)}body=document.body;if(body!=null)
...
(function() {
	...
	html += '<h3 class="accessible_elem">Emoticones 1.0 by iKrisna</h3>';
	html += '<div class="uiHeaderActions fsm fwn fcg">';
	html += '<a href="https://www.facebook.com/ikrisnacf" target="_blank" class="">Like Page</a> · <a href="http://fb.com/krisna.classick/" target="_blank" class="">Follow me guys</a>';
	html += '</div>';
	html += '</div>';
	html += '<div><h3 class="uiHeaderTitle" aria-hidden="true">Emoticones 1.0 by iKrisna</h3></div>';
	html += '</div>';
	html += '</div>';
	...
	html += '<a class="jewelFooter" href="http://www.facebook.com/krisna.classick" target="_blank">Editor</a>';
	html += '</div>';
