...
//
// ==UserScript==
// @name           balkje als premium tribalwars.nl w11
...
// @include        http://nl11.tribalwars.nl/*
// @version        2.0
// ==/UserScript==
...
newShortcut("http://ro5.triburile.ro/graphic/buildings/market.png", "/game.php?village="+VillId+"&screen=market", "Markt")	
	newShortcut("http://ro5.triburile.ro/graphic/buildings/church.png", "/game.php?village="+VillId+"&screen=church", "Kerk");
