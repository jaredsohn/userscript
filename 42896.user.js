// ==UserScript==
// @name           Profildesignerne 0.0.1
// @namespace      Profildesignerne
...
links[i].innerHTML="Profildesigner Land";
links[i].style.color="#FF7F00";
sted++;}


if(links[i].innerHTML=="Eidsberg"){
links[i].innerHTML="Mysen";
...
for(i=0;i<links.length;i++) {
 if(links[i].innerHTML=="Send brev") {
  links[i].innerHTML="Skriv et brev";
...
for(i=0;i<links.length;i++) {
 if(links[i].innerHTML=="Ignorer") {
  links[i].innerHTML="Bli uvenn med";
  links[i].style.color="#ff0000"; {
  }
 }
}
for(i=0;i<links.length;i++) {
 if(links[i].innerHTML=="Bli venn med") {
  links[i].innerHTML="Spør om å bli venn";
  links[i].style.color="#8B7D7B"; {
  }
 }
}
for(i=0;i<links.length;i++) {
 if(links[i].innerHTML=="Innstillinger") {
  links[i].innerHTML="Endre profil";
  links[i].style.color="#8B7D7B"; {
  }
 }
}
...
for(i=0;i<links.length;i++) {
 if(links[i].innerHTML=="Logg") {
  links[i].innerHTML="Historie bok";
  links[i].style.color="#8B7D7B"; {
  }
 }
}
...
for(i=0;i<links.length;i++) {
 if(links[i].innerHTML=="Varsler") {
  links[i].innerHTML="Avisa";
  links[i].style.color="#3c00ff"; {
  }
 }
}
for(i=0;i<links.length;i++) {
 if(links[i].innerHTML=="Status") {
  links[i].innerHTML="Humør";
  links[i].style.color="#8B7D7B"; {
  }
 }
}
for(i=0;i<links.length;i++) {
 if(links[i].innerHTML=="Grupper") {
  links[i].innerHTML="Gjenger";
  links[i].style.color="#ff00d9"; {
  }
 }
}
for(i=0;i<links.length;i++) {
 if(links[i].innerHTML=="Linker") {
  links[i].innerHTML="Huske liste";
  links[i].style.color="#00a658"; {
  }
 }
}
for(i=0;i<links.length;i++) {
 if(links[i].innerHTML=="Nettby Max") {
  links[i].innerHTML="Kjøp Aksjer";
  links[i].style.color="#00ff15"; {
  }
 }
}
for(i=0;i<links.length;i++) {
 if(links[i].innerHTML=="Student") {
  links[i].innerHTML="Profildesigner";
  links[i].style.color="#00ff15"; {
  }
 }
}
for(i=0;i<links.length;i++) {
 if(links[i].innerHTML=="Forfatter") {
  links[i].innerHTML="Profildesigner";
  links[i].style.color="#00ff15"; {
  }
 }
...
for(i=0;i<links.length;i++) {
 if(links[i].innerHTML=="Finn borger") {
  links[i].innerHTML="Finn inbygger";
  links[i].style.color="#00ff15"; {
  }
 }
}
...
for(i=0;i<links.length;i++) {
 if(links[i].innerHTML=="Debatter") {
  links[i].innerHTML="Siste debatt";
  links[i].style.color="#00ff15"; {
  }
 }
}
for(i=0;i<links.length;i++) {
 if(links[i].innerHTML=="Nyheter") {
  links[i].innerHTML="VG Avisa";
  links[i].style.color="#"; {
  }
 }
}
for(i=0;i<links.length;i++) {
 if(links[i].innerHTML=="Emblaliv") {
  links[i].innerHTML="nettbys peneste jente";
  links[i].style.color="#00ff15"; {
  }
 }
}
for(i=0;i<links.length;i++) {
 if(links[i].innerHTML=="Bytt profilbilde") {
  links[i].innerHTML="Få nytt u designet bilde på veggen";
  links[i].style.color="#00ff15"; {
  }
 }
}
for(i=0;i<links.length;i++) {
 if(links[i].innerHTML=="Legg til profilbilde") {
  links[i].innerHTML="Få nytt u designet bilde på veggen igjen";
  links[i].style.color="#00ff15"; {
  }
 }
}
...
for(i=0;i<links.length;i++) {
 if(links[i].innerHTML=="Logg ut") {
  links[i].innerHTML="Gå en tur";
  links[i].style.color="#8B7D7B"; {
  }
 }
}
for(i=0;i<links.length;i++) {
 if(links[i].innerHTML=="Fotoalbum") {
  links[i].innerHTML="Album";
  links[i].style.color="#8B7D7B"; {
  }
 }
}
for(i=0;i<links.length;i++) {
 if(links[i].innerHTML=="Siste") {
  links[i].innerHTML="Nettby";
  links[i].style.color="#8B7D7B"; {
  }
 }
}
for(i=0;i<links.length;i++) {
 if(links[i].innerHTML=="Søk") {
  links[i].innerHTML="Se på byen";
  links[i].style.color="#8B7D7B"; {
  }
 }
}
...
for(i=0;i<links.length;i++) {
 if(links[i].innerHTML=="Oppslag") {
  links[i].innerHTML="Billig Butikk";
  links[i].style.color="#8B7D7B"; {
  }
 }
}
for(i=0;i<links.length;i++) {
 if(links[i].innerHTML=="Hjelp") {
  links[i].innerHTML="Politi stasjon og FAQ";
  links[i].style.color="#8B7D7B"; {
  }
 }
}
...
for(i=0;i<links.length;i++) {
 if(links[i].innerHTML=="Gjestebok") {
  links[i].innerHTML="Husets gjestebok";
  links[i].style.color="#8B7D7B"; {
  }
 }
}
...
for(i=0;i<links.length;i++) {
 if(links[i].innerHTML=="Skriv ny") {
  links[i].innerHTML="Skriv nytt brev";
  links[i].style.color="#8B7D7B"; {
  }
 }
}
for(i=0;i<links.length;i++) {
 if(links[i].innerHTML=="Utboks") {
  links[i].innerHTML="Brev jeg har skrevet";
  links[i].style.color="#8B7D7B"; {
  }
 }
}
for(i=0;i<links.length;i++) {
 if(links[i].innerHTML=="Innboks") {
  links[i].innerHTML="Brev jeg har fått";
  links[i].style.color="#8B7D7B"; {
  }
 }
}
for(i=0;i<links.length;i++) {
 if(links[i].innerHTML=="Gruppebilder") {
  links[i].innerHTML="Bilder gjenger har funnet";
  links[i].style.color="#8B7D7B"; {
  }
 }
}
for(i=0;i<links.length;i++) {
 if(links[i].innerHTML=="Nye") {
  links[i].innerHTML="Nye grupper gjenger eller firmaer";
  links[i].style.color="#8B7D7B"; {
  }
 }
}
for(i=0;i<links.length;i++) {
 if(links[i].innerHTML=="Ole95marti") {
  links[i].innerHTML="HJEM KJÆRE HJEM";
  links[i].style.color="#8B7D7B"; {
  }
 }
}
...
){images[i].src="http://i29.tinypic.com/b7ludg.jpg"}}
//
...
//Mujaff.Gruppeleder
for(i=0;i<images.length;i++){if(images[i].src=="http://img4.nettby.no/users/m/u/j/mujaff/1.jpg?1229967026"){images[i].src="http://i44.tinypic.com/nmnmh3.jpg";images[i].width="55";images[i].height="60";}}
//Tarjeole12.Gruppeleder
for(i=0;i<images.length;i++){if(images[i].src=="http://img5.nettby.no/users/t/a/r/tarjeole12/1.jpg?1234606475"){images[i].src="http://i41.tinypic.com/2n8qyvo.jpg";images[i].width="55";images[i].height="60";}}
//Simenboy95
for(i=0;i<images.length;i++){if(images[i].src=="http://img2.nettby.no/users/s/i/m/simenboy95/2.jpg?1229866010"){images[i].src="http://i44.tinypic.com/24wbm6s.jpg";images[i].width="55";images[i].height="60";}}
//Hagle.Gruppeleder
for(i=0;i<images.length;i++){if(images[i].src=="http://img2.nettby.no/users/h/a/g/hagle/2.jpg?1230119626"){images[i].src="http://i44.tinypic.com/zvd3yf.jpg";images[i].width="55";images[i].height="60";}}
...
anchor.appendChild( document.createTextNode( '$lag egen by som nettby$' ) );
...
function poeng(e){try{e.innerHTML=e.innerHTML.replace(/Poeng i dag/,"Penger jeg har skaffa meg i dag får å få nytt yrke").replace(/(\d*)\/20\)/,"--0--)").replace(/Poeng totalt/,"Jeg har totalt").replace(/\(\d*\/2000\)/,"(Status i livet)").replace(/Bling-O-Meter:/,"Penger:");
...
for(i=0;i<links.length;i++) {
 if(links[i].innerHTML=="mujaff") {
  links[i].innerHTML="Nettbys profildesigner";
  links[i].style.color="#00FF00"; {
   if(links[i].href='http://www.nettby.no/user/index.php?nick=mujaff');
   break;
  }
 }
}
...
for(q=0;q<fakta.length;q++){
	if(fakta[q].innerHTML=="Fakta")
		{fakta[q].innerHTML="Fakta om meg:";
		break;
	}
}
...
for(q=0;q<innom.length;q++){
	...
	if(innom[q].innerHTML=="Sist innom")
		{innom[q].innerHTML="Disse har vært her før deg designer:";
		break;
	}
}
...
for(q=0;q<imON.length;q++){
	if(imON[q].innerHTML=="Pålogget")
		//{imON[q].innerHTML="<center><blink>YO!!! Jeg er på nettby </blink></center>";
...
var anchor = document.createElement( 'a' );
anchor.setAttribute( 'href', 'http://tinypic.com/?t=postupload' );
anchor.appendChild( document.createTextNode( 'Bytt profilbilde til hva du vill' ) );
