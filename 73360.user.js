...
function findName(test) {
    if (test.innerHTML.indexOf('/game/home.pl?user_id=74437', 0)>=0) return 1;
  return 0;
}

var els = getElementsByClassName('silenthatred', document);
for(var i=0,j=els.length; i<j; i++) {
	if (findName(els[i])){
<a id='user_name_34782365" href="/game/home.pl?user_id=74437">silenthatred</a>}
