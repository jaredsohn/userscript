...
// @namespace      n\a
// @include        http://ts5.travian.ir/dorf1.php
// ==/UserScript==
...
url = "http://ts5.travian.ir/build.php?id=33" + getActiveVillage();
  GM_xmlhttpRequest({
    method: "GET",
    url: url,
...
url = "http://" + document.domain + "/build.php?id=33" + getActiveVillage();
  GM_xmlhttpRequest({
    method: "GET",
    url: url,
    onload: function(responseDetails) 
