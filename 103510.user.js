// ==UserScript==
// @name           Cameo Tools with Angl's Colors
// @namespace      Cameo/Angl
// @include        http://*.kingdomsofcamelot.com/*main_src.php*
// @include	       http://corpr8.co.uk/*
// @description    Cameo's KoC Powertools with a color scheme for girls
// ==/UserScript==

var Version = '23.06.20011';

var Title = 'CameoAnglTools';
...
//logit ('g_timeoff: '+ unsafeWindow.g_timeoff);
  ...
  var styles = '.xtab {padding-right: 5px; border:none; background:none; white-space:nowrap;}\
    ...
    .ptChatWhisper {}\
    .ptChatBold {background-color: #BBDAF1;  text-shadow: 1px 1px 1px #99F;}\
    .ptChatAlliance {background-color: #BBDAF1;}\
    .ptChatGlobal {background-color: #FBC0E8; text-shadow: 1px 1px 1px #F88;}\
    .ptChatGlobalBold {text-shadow: 1px 1px 1px #FBC0E8;}\
    .ptChatGlobalAll {text-shadow: 1px 1px 1px #FBC0E8;;background-color: #FFC}\
    ...
    .ptChatIcon {border: 2px inset white}\
      ...
      for (i=0; i<numRows; i++){
        ...
        if (coordsOnly)
          ...
          m += '<TD align=right  valign="top">'+ dat[i][2].toFixed(2) +' &nbsp; </td><TD align=right>'+ dat[i][4] +'</td><TD> &nbsp; '+ tileNames[dat[i][3]]
            +'</td><TD valign="top">'+ (dat[i][5]?' <SPAN class=boldRed>OWNED</SPAN>':'') +'</td></tr>';
			}
		}
       }
      m += '</table>';
...
//DebugTimer.start(); 
    try {
      ...
      str += "<DIV id=overMainDiv style='font-size:"+ Options.overviewFontSize +"px'><TABLE class=ptTabOverview cellpadding=0 cellspacing=0><TR valign=top align=center><TD width=65></td><TD width=88 style='background: #ffc; font-size:150%' align=center><SPAN class=oohfancy>TOTAL</SPAN></td>";
      for(i=0; i<Cities.numCities; i++) {
	  ...
	  str += '<TR valign=top align=right><TD></td><TD style=\'background: #ffc\'></td>';
		...
		if(Gate == 0)
		 str += '<TD align=center><div style=color:green;font-style:italic;font-variant:small-caps;>Sanctuary</div></td>';
		else
		  str += '<TD align=center><div style=color:red;font-weight:bold;font-variant:small-caps;>Defending</div></td>';
		}
...
if(document.getElementById("mod_comm_list1"))
  { document.getElementById("mod_comm_list1").style.backgroundColor = '#FF42E0';}

if(document.getElementById("mod_comm_list2"))
  { document.getElementById("mod_comm_list2").style.backgroundColor = '#288EFB';}