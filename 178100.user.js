...
ShitList['Ben Franklin'] = true;
ShitList['Lexx Core'] = true;
ShitList['Walter Bishop'] = true;
ShitList['Nimey'] = true;
ShitList['HollyHopDrive'] = true;
ShitList['Trane'] = true;
ShitList['Angelfish'] = true;
ShitList['Edmund Blackadder'] = true;
ShitList['mirko'] = true;
ShitList['Rusty'] = true;
ShitList['R1ddick'] = true;
ShitList['Th0mas Hard'] = true;
ShitList['pr0cast1'] = true;
ShitList['l1ldebb1e'] = true;
	...
	for (var j = 0; j < links.length; j++)
	{
		...
		if (match = link.href.match(diary_re))
		{
			...
			if (outer.nodeType == 1 && outer.tagName == 'FONT')
			{
				...
				// without this code, the whole sidebar disappears when a shitlister's diary is first
				for (var i = 0; i < 7; i++)	
