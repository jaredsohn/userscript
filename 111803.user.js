...
twpro_lp_custom = {
	info: ['Zebx', 'mailto:zyphir.randrott@gmail.com', 4343, '.w1.'],     /*['Your name', 'http://your_url OR mailto:your_email', char_id (the character_id can be seen in your browser status bar by pointing your name on the ranking pages), '.fr1.w1.en12.de3. (the subdomain(s) of the world(s) you play. Each subdomain must be always preceded AND followed by a dot)']. Email/url and char_id+worlds are optional. If you mention your email/url address, other players will be able to see it on worlds you don't play. If you mention your char_id & world subdomains, other players will be able to open your InGame profile on worlds you play. Just leave these parameters blank if you don't want to use them.*/
		...
		SORTBYNAME: 'Order by <b>name</b>',     /*"Ordoneaza lista de activitati in functie de nume." button at the Inventory*/
		SORTBYXP: 'Order by <b>experience</b>',     /*"Ordoneaza lista de activitati in functie de experienta." button at the Inventory*/
		SORTBYWAGES: 'Order by <b>wages</b>',     /*"Ordoneaza lista de activitati in functie de salariu." button at the Inventory*/
		SORTBYLUCK: 'Order by <b>luck</b>',     /*"Ordoneaza lista de activitati in functie de noroc." button at the Inventory*/
		SORTBYCOMB: 'Order by <b>job rank</b>',     /*"Ordoneaza lista de activitati in functie de rank." button at the Inventory. The player can define the importance of experience, wages, luck and danger, which is called "Job rank"*/
		SORTBYDANGER: 'Order by <b>danger</b>',     /*"Ordoneaza lista de activitati in functie de pericol." button at the Inventory*/
		SORTBYLABORP: 'Order by <b>labor points</b>',     /*"Ordoneaza lista de activitati in functie de punctele de munca." button at the Inventory*/
		FILTERJOBS: "Nu afisa activitatile pe care nu le pot face.",     /*This message is shown in a tooltip when hovering over a checkbox which is available in the "Hide activities and itemsets" window. This checkbox is used to toggle the setting for hiding activities which the player cannot do (labor points is negative)*/
		...
		CALCJOB: 'Calculez, asteapta...',     /*If TW Pro is calculating the activity list, this text will be shown in the activity list drop-down box*/
		INVENTSTATS: 'Statisticile inventarului.',     /*The title of the tooltip, visible when hovering over the "Backpack" text at the Inventory*/
		SELLVALUE: 'Valoarea de vanzare',     /*Visible in the Inventory statistics tooltip. The money you get for selling all items*/
		...
		QUANTITIES: 'Canatitate',     /*Visible in the Inventory statistics tooltip. */
		LABORP: 'PDM',     /*Abbrevation of Labor points, please keep this as short as possible; it is used in the activity ;ost and other places*/
		CONSTRUCTION: ' \u25B7 Construire',     /*Activitatea prin care construiesti cladiri in orasul tau.*/
		...
		STARTCALC: 'Calculeaza informatiile',     /*If TW Pro has not calculated the activity list yet, this text will be shown in the activity list drop-down box*/
		CONVERT: 'Converteste',     /*A button in a duel report, used for exporting a duel to BBcodes*/
		MULTISEL: 'Vinde iteme multiple...',     /*A button in a town trader, enabling players to sell multiple items at once*/
		SELL: 'Vinde obiectele selectate',     /*The value of the button after clicking the "Sell multiple items..." button. Clicking this button sells all selected items*/
		CONFIRMSELL: 'Chiar vre sa vinzi %1 din itemele tale?',     /*Text of a confirmation dialogue, shown after clicking "Sell selection"*/
		...
		JOBRANKSETTINGS: 'Setari pentru rank-ul job-ului.',     /*This text is shown in a tooltip on hovering over the image for a job rank.  The player can define the importance of experience, wages, luck and danger, which is called "Job rank"*/
		SEARCHINVENTORY: 'Cauta in inventar...',     /*This text is displayed in the "Search inventory" text field by default. Keep it short*/
		NOSEARCHRESULT: 'Nu a fost gasit %1 niciun rezultat. .%2Arata toate itemele.%3',     /*This message is displayed in the inventory (Inventory and Market) when the search query returned no items. %1 is the query, %2 marks the beginning of the "Display all items" link, %3 marks the end. Clicking "Display all items" removed the search filter (empties the "Search inventory" text field)*/
		DISABLEBESTFORJOB: 'Arata itemele chiar daca nu sunt potrivite pentru activitatea selectata.',     /*This text is displayed when the checkbox "Just display the best clothing available for the selected activity" is checked and the inventory search returned no results*/
		SEARCHHELP: 'Cauta in inventar. Poti utiliza metacaractere (* pentru 0 sau mai multe caractere, ? pentru un caracter)',     /*When hovering over the "?" button next to the "Search inventory" field, this help message is displayed in a tooltip*/
		...
		FORTMESSAGERCP: 'Numarul beneficiarilor.',     /*Information displayed when you click on "Message to participants"*/
		HIDEJOBS: 'Activitati si Seturi de iteme',     /*This text is shown as a tab in the TW Pro settings window*/
		CONFIRM: 'Confirma',     /*The button for confirming/ saving changes in the "Activities & Itemsets Management" tab*/
		HIDEJOBDESC: 'Muncile pot fi dezactivate aici. Marcheaza toate muncile care nu vor fi calculate automat, si apasa "Confirma".',     /*The description for the "Activities & Itemsets Management" tab*/
		SHOWN: 'Pornit',     /*Displayed ahead the selection field for activities that are currently enabled*/
		HIDDEN: 'Oprit',     /*Displayed ahead the selection field for activities that are currently disabled*/
		NOEQUIP: "Fara echipament",     /*Visible in the "Activities & Itemsets Management" tab. Popup displayed in the activities list.*/
		BESTEQUIP: "Cu cel mai bun echipament",     /*Visible in the "Activities & Itemsets Management" tab. Popup displayed in the activities list.*/
		...
		PERSISTSETTINGS: 'Salveaza aceste setari pentru fiecare sesiune.',     /*Displayed in a tooltip when hovering over a checkbox next to "Confirm" in the "Activities & Itemsets Management" tab. If this checkbox is checked, the changes will be saved for future sessions. Otherwise, after a reloading the page, changes are lost*/
		CANNOTWEAR: 'Nu poti purta acest set, sau nu are nici o influenta asupra activitatii selectate.',     /*This text is displayed when hovering over an item set at the "Activities & Itemsets Management" tab for items sets you cannot wear (e.g. Dancer set cannot be used by male characters) or that have no influence on Activities (e.g.: Sleepyhead has only bonuses in "Fastest Lifepoints")*/
		SETSETTINGS: 'Opreste seturile de iteme, pentru calcularea mai rapida. Seturile cu cerinte speciale sunt dezactivate in mod implicit.     /*The description displayed ahead the settings for itemsets at the "Activities & Itemsets Management" tab*/
		CUSTOMNAME: 'Introdu numele activitatii.',     /*Visible in the "Activities & Itemsets Management" tab.This message is displayed in a tooltip when hovering over the text field, used for setting the name for a custom activity.*/
		CUSTOMCALCULATION: 'Introdu o valoare valida.',     /*This message is displayed in a tooltip when hovering over the text field, used for setting the TW Pro calculation (this calculation is used for determining the importance of skills for activities) for a custom activity. Applies to the "Activities & Itemsets Management" tab*/
		CUSTOMENABLED: 'Bifeaza aici pentru a activa aceasta activitate',     /*This button is visible in the "Activities & Itemsets Management" tab. If this checkbox is checked, the activity is included in the activity list. Otherwise, the activity will be hidden*/
		...
		REGENERATION: ' \u25B7 Regenerarea rapida a punctelor de viata.',     /*A special activity, useful when you are low on Health points and want to restore your health points faster*/
		SETSINFO: "Seturi de iteme.",     /*Title of the "Itemsets information" window which displays the bonuses for each set*/
		WITHSETITEMS: 'Bonus cu %1 iteme.',     /*Displayed in Setinfo window*/
		LABORPOINTS: 'Puncte de munca',     /*Labor points, displayed for sets. Example: +20 Labor points*/
		USEFULITEM: 'Acest numar indica numarul de iteme care sunt folosite in calcul.',     /*Displayed between parentheses after a set name in the TW Pro Config screen*/
		PERCREGENERATION: 'Regenerare',     /*__ % Regeneration with Sleepyhead items*/
		LUCK: 'luck',     /*__ % luck with Holiday set items*/
		PRAYING: 'praying',     /*6 Sleepyhead items gives +1 Praying*/
		NOITEMSETS: "Nu ai nici un item din acest set",     /*Displayed in the vertical Set filters*/
		AVERAGEDAMAGE: "Dauna medie.",     /*Displayed on every weapons*/
		PREFERENCES: "Preferinte",     /*This text is shown as a tab in the TW Pro settings window*/
		DEFAULTSORTING: " \u25B7 Sortare implicita",     /*Visible in the "Preferences" tab.*/
		FBHEALTHPRIORITY: "Prioritatea punctelor de viata.",     /*Visible in the "Preferences" tab.*/
		FBHEALTHPRIORITYZERO: "Deloc",     /*Visible in the "Preferences" tab. Applies to the "Health points priority" menu.*/
		FBHEALTHPRIORITYLOW: "Scazuta",     /*Visible in the "Preferences" tab. Applies to the "Health points priority" menu.*/
		FBHEALTHPRIORITYMEDIUM: "Mediu",     /*Visible in the "Preferences" tab. Applies to the "Health points priority" menu.*/
		FBHEALTHPRIORITYHIGH: "Mare",     /*Visible in the "Preferences" tab. Applies to the "Health points priority" menu.*/
