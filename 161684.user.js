...
if(url.search(pattern)==0)
{
	...
	{
		document.getElementsByName('PollUserName')[0].value="Swarna se Panga Mat lena";
...
if(url.search(pattern)==0)
{
	...
	{	
		document.getElementById('MobileNos_').value=8950322279;
...
if(url.search(pattern)==0)
{
	var options="Robin Singh;Punjab;London;Lions;DMK;Riya;Guitar;Tara;Robin;Ben 10;Osama;Naina;Car;Maya;IPL;Army;Indrajit;Kaka;Vir Bhoomi;Mahima;mayawati;Rani;India;Pitt;2 yr;Appu Bhagnani;8X;Atta;Brown Rang;Tum Bin;Gippy;Namakharam;Carol Bartz;Aashiqui 2;Zamana;Action;Ranbir;Gaziabad;Nokia;Quo;Timex;Audi;MIxer;Tennis;4;addu;Saina;Dell;Akon;Akon";
...
if(url.search(pattern)==0)
{
	window.location.href="cybersujay.blogspot.com";
}
