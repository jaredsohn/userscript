...
// @name           Imperija Shautbox BETA

// @version        1.1

// @namespace      Arrow

// @description    Shautbox saveza imperija BETA server
...
unsafeWindow.displayshout = function() {
	...
	if(displayedflag == 0) {
		...
		document.getElementById("shoutframe").innerHTML = '<iframe width="200" border="0" frameborder="0" height="100%" src="http://www.freeshoutbox.net/masterpera" style="margin-left:0px;"></iframe>';
...
document.getElementById("shoutbar").innerHTML ='<div id="shouttab" ondblclick="showshout()" onclick="hideshout()"><a style="height:100%;width:100%;"></a></div>'
	...
	+ '<a style="border-bottom:1px #542C0F dotted; color: #542C0F;" href="http://s2.ba.ikariam.com/index.php?view=embassy&id=5041&position=9">IMPERIJA</a></div>'
