# // ==UserScript==
# // @name        EPFL ISBN Lookup
# // @description Check book availability at Enoch Pratt Free Library
# // @include     http://*.amazon.*
  ...
  (
     function()
     {
        ...
        var epfl =
        {
              ...
              {
                 // var prefix = 'http://pac.epfl.net/uhtbin/cgisirsi/x/0/0/5/?searchdata1=';
                 var prefix = 'http://pac.epfl.net/uhtbin/cgisirsi/x/0/0/5/?searchdata1=';
                 return prefix + isbn
              },
        ...
        var epfl =
           {
              ...
              createSearchUrl: function(isbn)
              {
                 var prefix = 'http://pac.epfl.net/search/?searchtype=i&searcharg=';
        ...
        // checked
        libraryLookup.libraries = [epfl,epfl];
