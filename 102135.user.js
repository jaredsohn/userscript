// ==UserScript==
// @name           Fixed Icon Mod Display on BBS
// @namespace      Gccc98
// @description    Makes Icon Mod names purple! (original idea by K-Guare) but fixed
// @include        http://*newgrounds.com/bbs/*
// @include        http://*newgrounds.com/bbs/forum/*
// ==/UserScript==

var modArray = new Array("Jolly", "14hourlunchbreak", "Afro-Ninja", "Alaska", "altr", "Archawn",
...
function dotest() {
	...
	for(i=0; i<thelinks.length; i++) {
		...
		if(isIconMod(thelink) && thelinks[i].className != "moderator") thelinks[i].style.color = "#cc77cc";
	}
}
...
function addLabel(labelDiv) {
	...
	e.innerHTML = "<img src='http://i54.tinypic.com/qox8cy.jpg' alt='Icon Mod Pill' /> Icon Mod";
