// ==UserScript==
// @name           Travian: Battle Analyse Pro + Last Update
// @include       http*://*.facebook.com/*
// @version        5.5.3
// @author         MeXaon
// @email          svgmail@mail.ru
// @namespace      Travian
// @description    Battle Analyse 5.5.3
...
GM_registerMenuCommand(ScriptName + ' > ' + (GM_getValue('tba_tooltips', '1') == '1' ? 'show tooltips' : 'not show tooltips'), function(){if(GM_getValue('tba_tooltips', '1') == '1') {GM_setValue('tba_tooltips', '0')} else {GM_setValue('tba_tooltips', '1')};window.location.reload()});
