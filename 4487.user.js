...
s = "body {background:url(http://img218.imageshack.us/img218/5457/background8bl.jpg) #FFFFFF;background-attachment:fixed;background-position:center;background-repeat:repeat-y;}\n";
s+= "div, table, td, th, .heading{background:transparent!important; border:none!important;}\n";
s+= "*{font-family:comic sans ms}\n";
s+= "#topnav {margin-left:auto;margin-right:auto;width:600px;background-color:white!important;font-size:0;border:1px solid black!important;height:18px;padding:0!important;}\n";
s+= "#topnav a {font:normal 11px comic sans ms;margin-left:3px;margin-right:3px;color:lightblue!important;}\n";
s+= "#topnav a:hover {font:normal 11px comic sans ms;margin-left:3px;margin-right:3px;color:orange!important;}\n";
s+= ".section {border:1px solid black!important;background-color:FFFFFF!important;padding:2px;}\n";
s+= ".heading, #splash_coolNewPeople h5.heading, .mar5 strong {font:normal 11px comic sans ms!important;color:black;border:1px solid black!important;display:inline;padding:0!important;background-color:FFFFFF!important;}\n";
