// ==UserScript==
// @author          blackca
// @name            eRepublik Health Limit Tooltips (24-hour clock)
...
var HLTooptipInsert = function($, window, undefined) {
	$(document).ready(function () {
		...
		if (foodNow!=foodMax&&0==$('p#foodLimitInfo').length) {
			...
			$('#eatFoodTooltip p[style="margin:0"]').append('<p id="foodLimitInfo">Reach health limit at: <big>'+nextHour+':'+nextMin+':'+nextSec+'</big> (+'+nextFood+')</p>')
		}
	})
}
// Script Insert
