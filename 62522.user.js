...
// @require        http://swfobject.googlecode.com/svn/tags/swfobject_2_1/src/swfobject.js
// @version        1.2.4
...
function BuildReport() {
	...
	if (formatter != null) 
	{
		...
		/* Fill Textarea */
		//$("div#ikfcrcPlayPen textarea").append(formatter.ReplaceColors(report));
		/* Fill Flash */
...
function BuildStandardReport(formatter)
{
	...
	report += '\n';
	if (GAME_VERSION == "v.0.3.2") report += '───────────────────────────────────────────────────────────────\n';
...
function BuildDeluxeReport(formatter)
{
	...
	if (GAME_VERSION == "v.0.3.1" || GAME_VERSION == "v.0.3.2")
	{
		/* Add Place & Time of Attack */
