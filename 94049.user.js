// ==UserScript==
// @name           Colheita Feliz- Bugs & Truques (Mod-Felipe)
...
|	
|     este script foi criado por Kaique, e editado por Koyote/Kaique	      |
|						                      |
+---------------------------------------------------------------------+
*/
...
var colocaNaPagina = function() {
	...
	function postaTopicoDeletado(titulo, uid, motivo) {
		...
		var texto = "[fuchsia][b]Titulo:[/b][/fuchsia] ".concat(titulo, breakLine, "[b]Criador:[/b] ", "[green]", uid, breakLine, "[/green]", breakLine, "[/green][fuchsia][b]Motivo:[/b][/fuchsia] ", motivo, breakLine, "[b]Horario:[/b] ", pegaData(), breakLine, breakLine, "[/gray]");
		var envia = {
