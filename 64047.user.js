...
// @version        1.4.06d
// @description    Tuning fora losux.pl
// @author         Nitrol
// @include        http://losux.pl/*
// @include        http://www.losux.pl/*

// ==/UserScript==

//skrypt logo
var logo=document.getElementsByTagName("img") [0];
logo.src="http://img686.imageshack.us/img686/1178/logophpbbe.gif";
...
unsafeWindow.displayshout = function() {
	if(displayedflag == 0) {
		document.getElementById("shoutframe").innerHTML = '<iframe src="http://www.freeshoutbox.net/losux" width="200" height="100%" frameborder="0" allowtransparency="true" ></iframe>';
		displayedflag = 1;
	}
}
...
document.getElementById("shoutbar").innerHTML ='<div id="shouttab" onclick="showshout()" ondblclick="hideshout()"><a style="height:100%;width:100%;"></a></div>'
	...
	+ '</div>'
	+ '<div id="shoutframe" style="position:absolute;top:3px;bottom:3px;righ:3px;" onmouseover="displayshout()"><center>Najedz kursorem by pokazac Shoutbox Losux.pl</center></div>'
...
GM_addStyle("#shouttab { background:url(http://img697.imageshack.us/img697/508/91835775h.png); width:39px; height:134px; position:absolute; right:-41px; top:0px; } ");
