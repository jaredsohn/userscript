...
ScriptUpdater.check(66604, '0.38.1');
...
const LANGS =
{
  ...
  "co.il": // Dannidin
   {
    ...
    testmode:              "� יסוי צופרים",
    testedalarmtype:       "� יסוי ההתראות השו� ות (1-5)",
    sound:                 "צליל",
    on:                    "פעיל",
    off:                   "לא פעיל",
    top:                   "עליון", //top: "עליון", 
    bottom:                "תחתון",
    change:                "שי� וי ערך",
    enterinterval:         "הכ� ס קצב רע� ון (בש� יות)",
    enteralarmtype:        "סוג התראה מבוקש (1-5)",
    badvalue1:             "ערך שגוי!",
    badvalue2:             "ערך שגוי (1-5)!",

    /* Attacks messages */
    title:                 "ג� רל! פתח את הלשו� ית!",
    nochanges:             "אין שי� וי.",
    warning:               "אזהרה!",
    newattack:             "התקפה חדשה!",
    changes1:              "שי� וי בהתקפה!",
    changes2:              "התקפה שו� תה!",
    abortattack:           "התקפה הופסקה!",
    endofbattle:           "הקרב � גמר!",
  ...
  "gr": // vassilis
   {
    ...
    warning:      "� ΡΟΕΙΔΟ� ΟΙΗΣΗ!!!",
    newattack:    "ΝΕΑ Ε� ΙΘΕΣΗ!",
    changes1:     "Η Ε� ΙΘΕΣΗ ΑΛΛΑΞΕ!",
    changes2:     "Η Ε� ΙΘΕΣΗ ΑΛΛΑΞΕ!",
    abortattack:  "Η Ε� ΙΘΕΣΗ ΑΚΥΡΩΘΗΚΕ!",
  ...
  "lt": // edita
   {
    ...
    nomembersattacked: "� iuo metu puolamų aljanso narių nėra.",
  ...
  "nl": // Thanx TO Darkgrumly and Traceahot
   {
    /* Options */
    options:               "opties",
