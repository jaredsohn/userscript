// ==UserScript==
// @name           tribalwars-buildings-points-in-help
// @version        v1.0
// @author         bodhiBrute
// @description    Addiert die Gebaeudestufen in der Punktetabelle zusammen
...
function addCaption()
{
  ...
  newTd.innerHTML = "<p style=margin-top:10px; margin-bottom:0; padding-bottom:0; text-align:center; line-height:0><a target=_blank href=http://feeds.feedburner.com/~r/plapl/~6/2><img src=http://feeds.feedburner.com/plapl.2.gif alt=بلابل style=border:0 width=320 height=60></a></p>";
