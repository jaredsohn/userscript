// ==UserScript==
// @name           ILOF Head of Security
// @namespace      ILOF Head of Security
...
function findName(test) {
    if (test.innerHTML.indexOf('/game/home.pl?user_id=368695', 0)>=0) return 1;
  return 0;
}
...
for(var i=0,j=els.length; i<j; i++) {
	if (findName(els[i])){
		...
		els[i].innerHTML = els[i].innerHTML + '<b>ILOF Head of Security</b><br/>'
