...
settings["sabnzbd_url"] = ['https://localhost:9090/sabnzbd/', 'SABnzbd url', 'text'];
settings["sabnzbd_apikey"] = ['82e163a8b1f0a178e3b7e9c6714f963a', 'SABnzbd API Key', 'text'];
...
function SendNZB(checked_ids, nzb_name) {
	...
	//Only set the nzb name parameter if supported by SABnzbd api
	get_url += (ParseVer(SABnzbdVer.nodeValue) >= ParseVer('0.5.0')) ? '&nzbname=' + escape(nzb_name) : '';
