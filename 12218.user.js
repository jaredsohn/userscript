...
// @name            taz_zeit_sport
// @namespace       Platypus
// @include         *TAZ&ressort=le
// @include         *.taz.de/index.php?id=sport
...
html_insert_it(window.document,document.getElementById('datum_plugin_rechts'),'<iframe src="http://newsfeed.zeit.de/sport/index#feed-greasemonkey" width="500" height="600"></iframe>',false,true);
