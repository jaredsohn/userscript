// ==UserScript==
// @name FBMW Addon 3 In 1 Pro + Last Update
// @include       http*://*.facebook.com/*
// @namespace http://userscripts.org/scripts/show/105612
// @version 0.6.7.2 ≋TGMW≋
// @description http://userscripts.org/topics/88705
// @copyright 2011 - The Great Mafia Wars
...
// @icon http://i46.tinypic.com/2z6wlf4.jpg
// ==/UserScript==
...
var scriptAppInfo3 = {
	appContribute: 'https://www.paypal.com/cgi-bin/webscr?cmd=_s-xclick&hosted_button_id=VYFBVKMDTK7F2'
};
// ------------------------------------------------------
// Global variables
// ------------------------------------------------------
...
var helpToolTips = {
    ...
    locale_info: {
        'en_US': {
            ...
            description: 'DAILY BONUS MAFIA WARS:<br><br>Daily Bonus Point (every midnight Zynga time): <a href="http://the-great-mafia-wars.blogspot.com/p/free-daily-bonus-mafia-wars.html" target="_black">CLICK HERE</a>.<br>Daily E-mail Bonus (every 24 hours): <a href="http://the-great-mafia-wars.blogspot.com/p/email-bonus-mafia-wars.html" target="_black">CLICK HERE</a>.<br>Toolbar Bonus (every 8 hours): <a href="http://the-great-mafia-wars.blogspot.com/p/toolbar-bonus.html" target="_black">CLICK HERE</a>.<br><br><div style="color: green;">*Showed your LOVE with send Donation, thank you in advance!!!'
        },    
        'id_ID': {
            name: 'Indonesia (Indo)',
            description: 'DAILY BONUS MAFIA WARS:<br><br>Daily Bonus Point (every midnight Zynga time): <a href="http://the-great-mafia-wars.blogspot.com/p/free-daily-bonus-mafia-wars.html" target="_black">CLICK HERE</a>.<br>Daily E-mail Bonus (every 24 hours): <a href="http://the-great-mafia-wars.blogspot.com/p/email-bonus-mafia-wars.html" target="_black">CLICK HERE</a>.<br>Toolbar Bonus (every 8 hours): <a href="http://the-great-mafia-wars.blogspot.com/p/toolbar-bonus.html" target="_black">CLICK HERE</a>.<br><br><div style="color: green;">*Showed your LOVE with send Donation, thank you in advance!!!'
    ...
    'en_US': {
        ...
        'config_popup': {
            ...
            'main_shortserviceid': 'Shortening.<br>Select the shortener service to use.<br>The services that require cross domain support only work in Firefox and Chrome with MWAddon plugin installed.',
        ...
        'battlefield_popup': {
            ...
            'bfopt_attackwhenlost': 'Red ices.<br>Check to keep attacking a player when you lose. Attack the "BEAST".<br>The Red Ice term means that you can get an ice while losing the fights.<br>You will lose experience points, health and loot when attacking in this way.',
            ...
            'bfopt_skiplevel': 'Filtering by level.<br>Check to enable filtering by level.<br>Skip user levels "greater" or "lower" than the "selected amount".<br>And attack all players with a level "lower" or "greater" than your "selected amount".',
            ...
            'bfopt_skiplevelbut': 'Filtering by level.<br>Check to use a new condition to attack the players that were skipped by a level.<br>It only works if "Skip users level" is checked.<br><br>When a player is skipped by level you can create a new condition to attack them depending on their mafia.',
            ...
            'bfopt_skipmafia': 'Filtering by mafia.<br>Check to enable filtering by mafia.<br>Skip user mafias "greater" or "lower than the "selected amount".<br>And attack all players with a mafia "lower" or "greater" than your "selected amount".',
            ...
            'bfopt_skipmafiabut': 'Filtering by mafia.<br>Check to use a new condition to attack the players that were skipped by mafia.<br>It only works if "Skip users mafia" is checked.<br><br>When a player is skipped by mafia you can create a new condition to attack them depending on their level.',
        ...
        'homefeedcenter_popup': {
            ...
            'feedstream_dohitlistbounty_filter': 'Hitlist Bounty<br>Add users by clicking the "Add" button.<br>Remove users by selecting them and clicking "Remove".',
            ...
            'feedstream_dosecretstash_filter': 'Secret Stash<br>Add users by clicking the "Add" button.<br>Remove users by selecting them and clicking "Remove".',
            ...
            'feedstream_docitycrew_filter': 'City Crew<br>Add users by clicking the "Add" button.<br>Remove users by selecting them and clicking "Remove".'
        }
    },    
    ...
    'id_ID': {
        ...
        // CONFIGURATION
        'config_popup': {
            'main_autoheal': 'Autoheal.<br>Beri tanda untuk menggunakan auto-heal.<br>Ini berfungsi kalau bermain secara manual.',
            'main_autohealwhen': 'Autoheal.<br>Setting auto-heal dengan angka yang di inginkan.',
            'main_autohealin': 'Autoheal.<br>Pilih kota untuk auto-heal.',
            'main_usebitly': 'Shortening.<br>Kasih tanda jika kamu ingin menggunakan bit.ly account untuk memperpendek links kamu.',
            'main_api_bit_ly_login': 'Shortening.<br>Isi dengan bit_ly username kamu.',
            'main_api_bit_ly_key': 'Shortening.<br>Isi dengan Key bit_ly kamu.',
            'privacy': 'Privacy.<br>Pilih konfigurasi pribadi ketika akan di publish.',
            'privacy_fl': 'Privacy.<br>Hanya teman di friend list yang dapat melihat ini.',
            'main_publishpreview': 'Publish method.<br>Kasih tanda jika ingin menggunakan tampilan facebook.<br>Mengizinkan kamu untuk publish di wall kamu.'
        },
        
        // BATTLEFIELD
        'battlefield_popup': {
            'bfopt_forcestartingcity': 'Starting city.<br>Kasih tanda dari kota mana kamu akan mulai.<br>Jangan kasih tanda jika kamu main MW di tab lain.',
            'bfopt_startingcity': 'Starting city.<br>Jika kamu kasih tanda di "Start City", Kamu akan fight di kota yang kamu inginkan.',
            'bfopt_fightcitytime': 'Travel to cities.<br>Kasih tanda jika kamu ingin fight di kota lain dgn waktu yg telah ditentukan.<br>Kota yang dipilih telah di tentukan di "Select Cities" control.',
            'bfopt_fightcitytimeout': 'Travel to cities.<br>Beri waktu untuk tetap fight sebelum pindah ke kota lain.',
            'bfopt_travelwhennotargets': 'Travel to cities.<br>Kasih tanda untuk pergi ke kota lain jika tidak menemukan musuh.<br> Kota yang dipilih telah di tentukan di "Select Cities" control.',
            'bfopt_useheal': 'Autoheal.<br>Kasih tanda untuk menggunakan auto-heal.',
            'bfopt_healin': 'Autoheal.<br>Kasih tanda dari kota mana untuk auto-heal.',
            'bfopt_healwhen': 'Autoheal.<br>Auto-heal dengan sendirinya akan nge-heal health km jika dibawah jumlah yang kamu cantumkan.',
            'bfopt_nohealiflowsta': 'Autoheal.<br>Kasih tanda untuk tidak auto-heal jika stamina kamu kurang dari jumlah yg ditentukan.',
            'bfopt_minstaforheal': 'Autoheal.<br>Auto-heal tidak akan bekerja jika stamna kamu dibawah jumlah yg sudah ditentukan.',
            'bfopt_nohealifattacking': 'Autoheal.<br>Kasih tanda untuk menolak auto-heal jika ingin fight dengan musuh yg sama.<br>Ini akan membantu untuk mendapatkan ice, tetapi bias juga juga untuk ice/kill diri km sendiri.',
            'bfopt_userapidfire': 'Rapid Fire.<br>Kasih tanda untuk menggunakan rapidfire.<br>Gunakan ini dengan mengikuti maksimum attack.<br>Power Attack harus dikasih tanda agar Rapidfire berfungsi.',
            'bfopt_rapidfirewhen': 'Rapid Fire.<br> Kasih tanda untuk menggunakan rapidfire.<br>Setting ke maksimal memungkinkan untuk memperoleh ice, tp menghabiskan banyak stamina.<br>Jika tidak dikasih tanda pada "Maximum Attack", Kamu akan menghabiskan stamina dgn jumlah yg banyak.',
            'bfopt_rapidfireprofile': 'Rapid Fire.<br>Pilih Rapid Fire Aggressiveness.<br>Semakin tinggi yg km pilih akan memungkinkan untuk mendapatkan ice, tp akan menghabiskan banyak stamina juga.',
            'bfopt_useattackcount': 'Maximum Attacks.<br>Kasih tanda untuk Maximum Attacks.<br>Ini berfungsi jika Rapid Fire km kasih tanda.',
            'bfopt_maximumattacks': 'Maximum Attacks.<br>Setting maximum attacks yg km inginkan terhadap musuh yg sama.<br>Semakin dikit km setting akan semakin dikit stamina yg dikeluarkan per opponent.',
            'bfopt_usepowerattack': 'Power Attack.<br>Kasih tanda untuk menggunakan Power Attack.<br>Gunakan ini jk ingin menggunakan Rapid Fire.',
            'bfopt_attackplayernpc': 'NPC Attack.<br>Kasih tanda jika km ingin fight dng non-player yg di add oleh Mafia Wars ketika ada misi.',
            'bfopt_healtimer': 'Autoheal.<br>Seting waktu health yg di inginkan setelah health pertama kali.<br>Ini akan nge-heal kamu setelah heal pertama berjalan.<br>Normalnya adalah 60 detik untuk semua pemain.',
            'bfopt_useattackdelay': 'Attack delay.<br>Kasih tanda untuk mengulang fight terhadap pemain yg sama.<br>Jangan kasih tanda jika kamu ingin memperoleh ice.',
            'bfopt_attackdelay': 'Attack delay.<br> Kasih tanda untuk mengulang fight terhadap pemain yg sama.',
            'bfopt_usenewplayerdelay': 'Attack delay.<br>Kasih tanda ketika kamu sudah siap bertarung dengan pemain baru.<br>Ini memberi effect rendah untuk di ices, saran saya sih kasih tanda.',
            'bfopt_newplayerdelay': 'Attack delay.<br>Setting untuk mengulang attack.<br>Saran digunakan adalah 1 detik.',
            'bfopt_usebank': 'Autobanking.<br>Kasih tanda untuk menyimpan uang kamu.<br>Kamu harus kasih tanda untuk menyimpan otomatis uang kamu di "Select Cities" kontrol.',
            'bfopt_usebankwhen': 'Autobanking.<br>Setting jumlah yg kamu inginkan untuk disimpan secara otomatis.',
            'bfopt_attackwhenlost': 'Red ices.<br>Kasih tanda untuk tetap nge-tack walaupun kamu kalah (bodoh banget sih, udah kalah tetap ngetack :P).<br>The Red Ice artinya kamu tetap memperoleh ice walaupun kalah fight.<br>walaupun km kalah tp masih dapet xp (1 xp = 1 stamina tetapi km gak mungkin dapet loots.',
            'bfopt_attackwhenlostbut': 'Red ices.<br>Setting ke disable red ice untuk ngetack lebih spesifik lagi.<br>Ini berfungsi jika kamu kasih tanda di "Attack when lost".',
            'bfopt_attackwhenlostbutif': 'Red ices.<br>Setting jumlah attack yg di inginkan dalam red ice.<br> Ini berfungsi jika kamu kasih tanda di "Attack when lost".',
            'bfopt_keepattackafterwon': 'Red ices.<br>Kadangkala kamu kalah dalam fight setelah menang, itu karena mush kamu menggunakan Boost atau dia naik level.<br>Kasih tanda untuk mengikuti Red Ice mode setelah menang di attack pertama.',
            'bfopt_takerevenge': 'Revenges.<br>Kasih tanda untuk enable revenge.<br>Fungsi ini untuk menghajar pencuri ice kamu (itupun kalau menang :P ).',
            'bfopt_revengelevel': 'Revenges.<br>Kasih tanda untuk level berapa di fungsi Revenge.',
            'bfopt_revengelevelway': 'Revenges.<br>Kasih tanda biar lebih spesifik lagi untuk level tinggi atau level rendah.',
            'bfopt_revengelevelof': 'Revenges.<br>Jika "lower" yg dipilih, set disini untuk level tinggi dalam fight.<br>Jika "greater" yang dipilih, pilih level rendah.',
            'bfopt_norevengeblacklist': 'Revenges.<br>Kasih tanda disini untuk menghiraukan Revenge pemain yg kuat dan yg sudah ada di Black List .',
            'bfopt_autopublish': 'Autopublish.<br>Kasih tanda untuk publish otomatis.<br>Ini berfungsi jika berada dalam silent mode, kamu harus nonaktifkan "Use Facebook user interface." di Configuration menu, Publish tab.',
            'bfopt_autopublishafter': 'Autopublish.<br>Pilih jumlah yg di inginkan untuk di publish.',
            'bfopt_autopublishin': 'Autopublish.<br>Pilih dimana kamu ingin publish iced km, atau biarkan kosong untuk di publish di wall kamu.<br>kalau ingin di publish di group, perhatikan id group yg di inginkan (group_id=XXX), copas nomor id (XXX) kedalam kotak',
            'bfopt_maxloglength': 'Log events.<br>Pilih jumlah log yg di inginkan untuk di tampilkan.',
            'bfopt_showsocialevents': 'Log events.<br>Kasih tanda enable showing social events di general log.<br>Jangan kasih tanda untuk menyimpan memori yg telah di gunakan untuk waktu yg lama.',
            'bfopt_showlootevents': 'Log events.<br>Kasih tanda untuk menampilkan loots even di log.<br> Jangan kasih tanda untuk menyimpan memori yg di telah gunakan untuk waktu yg lama.',
            'bfopt_usenamefilter': 'Filtering.<br>Kasih tanda untuk menyaring nama.<br>Jangan menggunakan tag clan disini.',
            'bfopt_namefilterval': 'Filtering.<br>Berfungsi jika "Name filter" dikasih tanda.<br>NORMAL: Semua character melalui proses penyaringan.<br>REGEX: Pergunakan tanda yg diketahui. Contoh: hanya mengikuti kata/spasi/titik<br>[^\\w\\s\\.]',
            'bfopt_usefilterregex': 'Filtering.<br>Pergunakan "Name Filter" untuk enable Regex.<br>Jika gak tau apa itu regex lebih baik jangan kasih tanda.',
            'bfopt_usebadgefilter': 'Filtering.<br>Kasih tanda untuk menyaring melalui badges yg dipergunakan.',
            'bfopt_badgefilterval': 'Filtering.<br>Set disini untuk menyaring Badge yg km inginkan.<br>Contoh untuk menyaring diamond tiers 2 sampai 5 bagdes: diamond [2-5]<br>Contoh untuk menyaring ruby dan diamond: ruby|diamond',
            'bfopt_useskipifhealth': 'Skipping.<br>Kasih tanda untuk menyaring health pemain yg melebihi perkiraan dari persentasi.',
            'bfopt_skipifhealth': 'Skipping.<br>Pilih maksimum persentasi untuk tetap ngetack musuh.',
            'bfopt_skipifotherdamage': 'Skipping.<br>Kasih tanda untuk menyaring musuh yang sudah di attack pemain lain.',
            'bfopt_skipminimalcash': 'Skipping.<br>Kasih tanda untuk menghiraukan musuh yg uang nya gak ada :P.',
            'bfopt_minimalcash': 'Skipping.<br>Jika dikasih tanda, tentukan jumlah uang yg di inginkan.<br>Maksimum uang yg didapat tanpa bonus untuk sekali fight adalah $65,000 (New York, Moscow, Vegas, Italy).<br>Simpan pemikiran jika penghasilan di kota lain lebih rendah.',
            'bfopt_skipdiffcitycash': 'Skipping.<br>Beri tanda jika uang yang didapat berasal dari lain kota.<br>Ini bekerja dengan baik untuk mendapatkan 5x loots di Brazil.',
            'bfopt_skiplevel': 'Filtering by level.<br>beri tanda untuk menyaring musuh melalui level nya.<br>Contoh:<br>Hiraukan musuh yg level nya "greater" dari: "5000", Tetapi Attack yg mafia nya "lower" dari: "490".<br>Ini berarti menyaring pemain yg diatas level â€œ5000â€ tetapi tetap ngetack jika mafianya lebih rendah dari â€œ490â€.',
            'bfopt_skiplevelway': 'Filtering by level.<br>Pilih level yg di inginkan greater atau lower biar lebih spesifik lagi.',
            'bfopt_skiplevelof': 'Filtering by level.<br>Pilih level berapa untuk menyaring level yg mau di attack.',
            'bfopt_skiplevelbut': 'Filtering by level.<br>Beri tanda untuk musuh baru dan sudah disaring levelnya.<br>Ini berfungsi jika "Skip users level" di kasih tanda.',
            'bfopt_skiplevelbutway': 'Filtering by level.<br> Pilih level yg di inginkan greater atau lower biar lebih spesifik lagi.',
            'bfopt_skiplevelbutmafia': 'Filtering by level.<br> Pilih level berapa untuk menyaring level yg mau di attack.',
            'bfopt_skipmafia': 'Filtering by mafia.<br>Beri tanda enable untuk menyaring musuh melalui mafia yg dimiliki.<br>Contoh:<br>Hiraukan mafia yg "greater" dari: "500", tetapi attack jika levelnya "lower" dari: "700".<br>Ini artinya hiraukan musuh yg mafianya lebih dari â€œ500â€ dan tetap ngetack jika levelnya lebih rendah dari â€œ700â€.',
            'bfopt_skipmafiaway': 'Filtering by mafia.<br>Beri tanda untuk menyaring mafia yg lebih tinggi atau rendah biar lebih spesifik lagi.',
            'bfopt_skipmafiaof': 'Filtering by mafia.<br>setting jumlah mafia musuh yg di inginkan.',
            'bfopt_skipmafiabut': 'Filtering by mafia.<br>Kasih tanda untuk level baru yg jumlah mafianya sudah disaring.<br>Ini berfungsi jika "Skip users mafia" dikasih tanda.',
            'bfopt_skipmafiabutway': 'Filtering by mafia.<br> Beri tanda untuk menyaring level yg lebih tinggi atau rendah biar lebih spesifik lagi.',
            'bfopt_skipmafiabutlevel': 'Filtering by mafia.<br>Pilih level yg di inginkan untuk pengecekan berikutnya untuk ngetack musuh yg tlh disaring jumlah mafianya.',
            'bfopt_skipiced': 'Filtering.<br>Kasih tanda untuk menghiraukan musuh yg sudah mati.',
            'bfopt_skipicedplayers': 'Filtering.<br>Kasih tanda untuk menghiraukan pemain yg sudah di iced oleh kamu.',
            'bfopt_skipifhealed': 'Skipping.<br>Kasih tanda jika ingin menhiraukan healing.<br>Ini gak berfungsi jika kamu menggunakan Rapid Fire.',
            'bfopt_usestopwheniced': 'Autostop.<br>Kasih tanda untuk berhenti ketika iced kamu sdh mencapai target.',
            'bfopt_stopwheniced': 'Autostop.<br>tentukan jumlah iced yg di inginkan waktu berhenti.',
            'bfopt_stopwhenstamina': 'Autostop.<br>Kasih tanda jika stamina kamu dibawah jumlah yg sudah ditentukan.',
            'bfopt_staminatokeep': 'Autostop.<br>tentukan jumlah stamina yg di inginkan untuk disimpan.',
            'bfopt_stopbeforelvlup': 'Autostop.<br>Kasih tanda untuk berhenti jika kamu mau naik level.',
            'bfopt_explefttostop': 'Autostop.<br>Tentukan jumlah XP yg di inginkan sebelum naik level.',
            'bfopt_stopafterlevelup': 'Autostop.<br>Kasih tanda untuk berhenti setelah naik level.<br>Ini akan berhenti dan pop-up naik level akan muncul.',
            'bfopt_keepfigthing': 'Autoresume.<br>Kasih tanda untuk mengikuti resume Battlefield dihentikan karena suatu alasan.',
            'bfopt_resumedelay': 'Autoresume.<br>Tentukan jumlah menit untuk menunggu sebelum Battlefielddihentikan.',
            'bfopt_fighttime': 'Autopause.<br>Kasih tanda untuk menunda fight dgn waktu yg ditentukan.',
            'bfopt_fighttimeout': 'Autopause.<br>Tentukan jumlah menit yg di inginkan untuk otomatis pause dalam fight.',
            'bfopt_fighttimeoutresume': 'Autopause.<br>Tentukan jumlsh menit yg di inginkan sebelum fight di hentikan oleh fungsi autopasue.',
            'bfopt_useblacklist': 'Blacklist.<br>Kasih tanda untuk memasukkna musuh kedalam blacklist.',
            'bfopt_blacklist': 'Blacklist.<br>Blacklist digunakan untuk menyaring musuh yg kuat.',
            'bfopt_addusertowlist': 'Whitelist.<br>Kasih tanda untuk memasukkan musuh kedalam whitelist jika mereka menghasilkan uang ketika di attack dengan kekuatan penuh.',
            'bfopt_cashneedtogain': 'Whitelist.<br>Tentukan jumlah uang yg di inginkan, setelah itu musuh dimasukkan kedalam whitelist.<br>Buang pemikiran karena factor kota (Cuba, Bangkok, Brazil) will jika uang yg dihasilkan lebih rendah.',
            'bfopt_whitelist': 'Whitelist.<br>Kamu dapat menggunakan tombol "Attack witelist" untu k ngetack musuh yg ada di whitelist. ',
            'bfopt_clantagfilterval': 'Family.<br>Tentukan untuk menyaring Tag famili.<br>Km harus tentukan character atau kata baris per baris.',
            'bfopt_addtoclanlist': 'Family.<br>Working with Family Tag Filter.<br>Check to add the filtered families to your clan list.',
            'bfopt_skipfilteredclans': 'Family.<br>Berfungsi mengikuti penyaringan tag famili.<br>Kasih tanda untuk menyaring famili.',
            'bfopt_clanlistusage': 'Family.<br>Select how the Families listed in the clan list box below are used.<br>Normally it should be "Skipped" to avoid attack your friendly families.',
            'bfopt_clanlist': 'Family.<br>The Clan list is used to manage families.<br>If you just want to skip freindly allies, add their families using the buttons in right side.<br>Just add their profile link (located in the family profile page) in the clan list and make sure the listed families box says "SKIPPED".'
        },
        
        // FREE GIFTS CENTER
        'freegiftscenter_popup': {
            'filter_text': 'Searching.<br>Tentukan gift yg km cari.<br>kamu dapat mencari beberapa di ikuti dgn tanda "|".<br>Contoh: join|crew',
            'select_fbgroups': 'Scanning.<br>Pilih group facebook untuk di scan.<br>Jika ingin di "My wall", cukup dengan meng-klik "Refresh".<br>Untuk melakukan ini km harus permisi dulu sama mafiawars.',
            'freegifts_scantime': 'Scanning.<br>Tentukan waktu untuk melakukan scanning.<br>Semua akan dihiraukan jika melebihi waktu yg telah km tentukan.',
            'massive_input': 'Parsing.<br>Copas semua link yg kamu temukan untuk dianalisa dan kemudian di kolek giftnya.',
            'freegifts_usefilter': 'Parsing.<br>Kasih tanda jk km ingin mencari link yg hanya di inginkan.<br>Kamu harus memasukan nama gift di kotak di bawah ini.',
            'freegifts_filter': 'Parsing.<br>Masukkan nama2 gift yg kamu cari.<br>Kamu harus memisahkan nama gift dgn tanda "|".<br>Contoh: crime spree|stamina boost',
            'freegifts_remonsuccess': 'Remove facebook requests.<br>Kasih tanda jika ingin menghapus Facebook request ketika gift sudah di kolek.',
            'freegifts_remonignore': 'Remove facebook requests.<br>Kasih tanda untuk menghapus Facebook request ketika km ignored.',
            'freegifts_sendthanksrequest': 'Send back.<br>Kasih tanda kalau ingin kirim gift kembali.<br>Ini berfungsi untuk gifts yang ada di halaman facebook requests.',
            'freegifts_sendbacktype': 'Send back.<br>Pilih cara untuk mengirim gift kembali.',
            'freegifts_usebackgiftfilter': 'Send back.<br>Kasih tanda untuk mengirim kembali gift yg sudah ditentukan.<br>Kamu harus memasukan nama gift di kotak di bawah ini.',
            'freegifts_thanksbackfilter': 'Send back.<br>Tentukan disini nama gift yg akan dikirim kembali dipisahkan dengan tanda "|".',
            'freegifts_ignorelimits': 'Collector.<br>Kasih tanda untuk tetap ngolek gift setelah batas ngolek tercapai.',
            'freegifts_skipsameuser': 'Collector.<br>Kasih tanda untuk menghiraukan user yg telah km kolek gift sebelumnya.<br>akan menghiraukan gift yang sudah lewat 24 jam.<br>Crime Spree dan yg lainnya masih bias dikolek dari pemain.<br>Jangan kasih tanda untuk ngolek semua gift.',
            'freegifts_masssendback': 'Collector.<br>Kasih tanda enable Massive Collector untuk mengirim gift melalui facebook requests.',
            'freegifts_collectnomafia': 'Collector.<br>Kasih tanda untuk tetap ngolek gift yg bukan teman mafia.<br>Ini berfungsi untuk ngolek link seperti Footbal fans.<br>Untuk yg lainnya jgn kasih tanda.',
            'freegifts_csselect': 'Crime Spree.<br>Pilih cara pertama.',
            'freegifts_csreward': 'Crime Spree.<br>Pilih cara kedua.',
            'freegifts_useexcludedgifts': 'Skipping.<br>Kasih tanda untuk menhiraukan gift yg sudah ada di list.',
            'freegifts_excludedpattern': 'Skipping.<br>Tentukan text yg digunakan untuk nama yg ada di luar list.<br>km dapat memasukan teks yg berbeda dengan di kasih tanda "|".<br>Contooh: reached your limit|gold mastery'
        },
        ...
        'remindereditor_popup': {
            ...
            'setting_gotocityid': 'Reminder Editor.<br>Select the city to travel.',
            'setting_gotopage': 'Reminder Editor.<br>Check if you want to go to a specified page.',
            'setting_gotopageurl': 'Reminder Editor.<br>Set the page url to go.<br>You can paste here the full url link copied from a link in Mafia Wars that point to the wanted page.',
            'setting_runplugin': 'Reminder Editor.<br>Check to execute a pre-installed plugin.',
            'setting_runpluginid': 'Reminder Editor.<br>Select the plugin to execute.',
            'setting_resetonload': 'Reminder Editor.<br>Check if this reminder will be reset after a page load.',
            'setting_resetonloadurl': 'Reminder Editor.<br>Set the page that will reset this reminder.<br>Same as "Go To Page", you can paste here a full url link of a Mafia Wars page.'
        ...
        // PLUGIN MANAGER
        'pluginmanager_popup': {
            'app_name': 'Plugin Manager.<br>Tentukan nama spp script yg dipilih.',
            'app_code': 'Plugin Manager.<br>Paste kode script yang akan dieksekusi di sini.'
        },
        
        // MULTI GIFTER
        'multigifter_popup': {
            'multigift_giftpages': 'Pagination.<br>Kasih tanda enable pagination untuk items.',
            'multigift_userpages': 'Pagination.<br>Kasih tanda enable pagination untuk teman.',
            'multigift_hidezeroamount': 'Item quantity.<br>Kasih tanda untuk menghilangkan item yng jumlahnya 0.',
            'multigift_delay': 'Delay.<br>Tentukan detik untuk menungu di dalam mengirim gift.',
            'gift_page': 'Pagination.<br>Pilih halaman yg km inginkan.',
            'user_page': 'Pagination.<br> Pilih halaman yg km inginkan.',
            'gift_category': 'Gift category.<br>Pilih items dengan melihat dari kategori group.',
            'user_category': 'User category.<br> Pilih teman dengan melihat dari kategori group.',
            'collection_filter_type': 'Filtering.<br>Pilih tipe koleksi untuk menyaring.',
            'collection_filter': 'Filtering.<br>Pilih nama koleksi untuk menyaring.',
            'search_gift': 'Searching.<br>Pilih search untuk mencari gift.<br>Kamu bisa tentukan disini nama2 yg akan dicari, nama dipisahkan dgn tanda "|".',
            'saved_search': 'Searching.<br>Gunakan pencarian yg telah disimpan sebelumnya.',
            'search_user': 'Searching.<br>Gunakan pencarian untuk menemukan teman.<br> Kamu bisa tentukan disini nama2 yg akan dicari, nama dipisahkan dgn tanda "|".'
        },
        
        // HOME FEED CENTER
        'homefeedcenter_popup': {
            'feedstream_filter': 'Filtering.<br>Tentukan teks pencarian untuk mencari posting.<br>Kamu dapat menggunakan tanda "|" untuk pencarian yg lain.',
            'feedstream_grouping': 'Filtering.<br>Pilih group post untuk ditampilkan.',
            'feedstream_dogotowar': 'Helping.<br>Kasih tanda hanya untuk menolong.',
            'feedstream_dogivesocialhelp': 'Helping.<br>Kasih tanda untuk menolong job yg di publish.',
            'feedstream_dosocialmissions': 'Helping.<br>Kasih tanda untuk join operations.',
            'feedstream_doclaimbonusandreward': 'Helping.<br>Kasih tanda untk ngolek bonus atau reward yg di publish.',
            'feedstream_docollectloot': 'Helping.<br>Kasih tanda untuk ngolek loot yg di publish',
            'feedstream_dopropertyhelp': 'Helping.<br>Kasih tanda untuk menolong mengirim parts properties.',
            'feedstream_dogetboost': 'Helping.<br>Kasih tanda untuk ngolek bonus dari naik level.',
            'feedstream_dosendenergyandphones': 'Helping.<br>Kasih tanda untuk mengirim/mengkolek rob phones dan energy packs.',
            'feedstream_doacceptgiftevent': 'Helping.<br>Kasih tanda untuk menolong dan mengkolek gift event.',
            'feedstream_dohitlistbounty': 'Helping.<br>Kasih tanda untuk mengkolek bounty.',
            'feedstream_dosecretstash': 'Helping.<br>Kasih tanda untuk ngolek/nolong secret stash.',
            'feedstream_docitycrew': 'Helping.<br>Kasih tanda untuk menolong atau join di city crew.',
            'feedstream_autoclose': 'General.<br>Jika di tandai, semua post yg telah kamu tolong akan ditutup secara otomatis.',
            'feedstream_feedslimit': 'General.<br>Tentukan jumlah post yg di inginkan ketika menggunakan "AutoHelp".',
            'feedstream_maxloglength': 'General.<br>Tentukan jumlah log yg di inginkan ketika menggunakan "AutoHelp".',
            'feedstream_helpdelay': 'General.<br>Tentukan waktu yg di inginkan menunggu dalam menolong.',
            'feedstream_refreshdelay': 'General.<br>Tentukan waktu yg di inginkan menunggu dalam refresh postingan.',
            'feedstream_waruseminattack': 'War help.<br>Kasih tanda untuk mengolek reward dari war dengan spesifikasi attack.',
            'feedstream_warminattack': 'War help.<br>Kasih tanda untuk mengolek reward dari war dengan spesifikasi minimum attack dalam menolong war.',
            'feedstream_warusemindefense': 'War help.<br>Kasih tanda untuk mengolek reward dari war dengan spesifikasi minimum defense dalam menolong war.',
            'feedstream_warmindefense': 'War help.<br>Tentukan minimum reward items defense dari menolong war.',
            'feedstream_warusenamefilter': 'War help.<br>Kasih tanda untuk menyaring reward war dari namanya. Jika di kassih tanda kamu harus menghilangkan tanda minimal attack/defense options.',
            'feedstream_warnamefilter': 'War help.<br>Masukan nama2 reward war dengan dipisah menggunakan tanda "|".',
            'feedstream_joinmission': 'Operations.<br>Pilih slot yg di inginkan ketika join dalam operation.',
            'feedstream_joinmissionafter': 'Operations.<br>Jika slot pertama tidak berhasil pilih slot kedua.',
            'feedstream_maxfreeslots': 'Operations.<br>Tentukan jumlah maksimum slot yg kosong ketika join dalam operation.',
            'feedstream_missionfilter': 'Operations.<br>Tentukan untuk menyaring operation dengan menggunakan nama.<br>Masukan nama2 operation dengan menggunakan tanda pemisah "|".',
            'feedstream_citycrewfilter': 'City Crew.<br>Kasih tanda untuk menyaring dalam meberikan pertolongan city crew.'
        }
    },    
    ...
    'es_ES': {
        ...
        // CONFIGURATION
        'config_popup': {
            'main_checkforupdates': 'Updates.<br>Selecciona esta opciÃ³n si deseas que se te avise cuando se encuentren nuevas actualizaciones.',
            'main_autoheal': 'Autoheal.<br>Marca esta opciÃ³n para activar "Autoheal", el cual te curarÃ¡ cuando tu vida baje de un determinado nivel.',
            'main_autohealwhen': 'Autoheal.<br>Pon aquÃ­ cuanta vida deseas tener para que Autoheal te cure.',
            'main_autohealin': 'Autoheal.<br>Selecciona donde deseas que Autoheal te cure.',
            'main_usebitly': 'Shortening.<br>Marca esta opciÃ³n si deseas usar el servicio bit.ly para acortar tus enlaces.',
            'main_api_bit_ly_login': 'Shortening.<br>Pon aquÃ­ el nombre de tu cuenta bit.ly.',
            'main_api_bit_ly_key': 'Shortening.<br>Pon aquÃ­ la llave (key) de tu cuenta bit.ly.',
            'privacy': 'Privacy.<br>Selecciona el tipo de privacidad que deseas usar para publicar en tu muro.',
            'privacy_fl': 'Privacy.<br>Selecciona la lista de amigos que verÃ¡n tus publicaciones.',
            'main_publishpreview': 'Publish method.<br>Marca esta opciÃ³n solo si tienes problemas, la mayorÃ­a de las funciones de MWAddon requiere que estÃ© desactivada.'
        },
        
        // BATTLEFIELD
        'battlefield_popup': {
            'bfopt_forcestartingcity': 'Starting city.<br>Marca esta opciÃ³n si deseas comenzar a luchar en la ciudad especificada.',
            'bfopt_startingcity': 'Starting city.<br>Selecciona en que ciudad deseas empezar a luchar.',
            'bfopt_fightcitytime': 'Travel to cities.<br>Marca esta opciÃ³n si quieres viajar a otras ciudades despuÃ©s de un determinado tiempo.<br>Las ciudades las puedes seleccionar en el control "Select Cities".',
            'bfopt_fightcitytimeout': 'Travel to cities.<br>Pon aquÃ­ el tiempo que te mantendrÃ¡s luchando en la misma ciudad antes de viajar.',
            'bfopt_travelwhennotargets': 'Travel to cities.<br>Marca esta opciÃ³n si quieres viajar a una ciudad diferente cuando no se encuentran enemigos.<br>Las ciudades las puedes seleccionar en el control "Select Cities".',
            'bfopt_useheal': 'Autoheal.<br>Marca esta opciÃ³n para activar Autoheal.',
            'bfopt_healin': 'Autoheal.<br>Selecciona donde quieres que Autoheal te cure.',
            'bfopt_healwhen': 'Autoheal.<br>Pon aquÃ­ como de baja debes tener la vida para que Autoheal te cure.',
            'bfopt_nohealiflowsta': 'Autoheal.<br>Marca esta opciÃ³n si no quieres que Autoheal te cure cuando tu stamina baja a una determinada cantidad.',
            'bfopt_minstaforheal': 'Autoheal.<br>Pon aquÃ­ como de baja debe ser tu stamina para desactivar Autoheal.',
            'bfopt_nohealifattacking': 'Autoheal.<br>Marca esta opciÃ³n para desactivar Autoheal cuando atacas a un mismo jugador.<br>Esto te ayudarÃ¡ a obtener el ice pero por contra puedes hacerte ice/kill tu mismo.',
            'bfopt_userapidfire': 'Rapid Fire.<br>Marca esta opciÃ³n si quieres activar Rapid Fire.',
            'bfopt_rapidfirewhen': 'Rapid Fire.<br>Selecciona como de baja debe tener la vida tu oponente en porcentaje para usar Rapid Fire.<br>A mÃ¡s alto pongas esto, mÃ¡s posibilidades de obtener un ice, pero por contra puedes gastar una cantidad muy elevada de stamina con el mismo jugador, sobretodo si no tienes configurado "Maximunm Attacks".',
            'bfopt_rapidfireprofile': 'Rapid Fire.<br>Selecciona como de agresivo serÃ¡ Rapid Fire.<br>A mÃ¡s alto pongas esto, mÃ¡s posibilidades de obtener un ice pero por contra, puedes gastar un poco mÃ¡s de stamina.',
            'bfopt_useattackcount': 'Maximum Attacks.<br>Marca esta opciÃ³n para activar "Maximum Attacks".',
            'bfopt_maximumattacks': 'Maximum Attacks.<br>Pon aquÃ­ la cantidad mÃ¡xima de ataques que permitirÃ¡s que haga Battlefield a un mismo jugador.<br>A menos cantidad, menos gasto de stamina por jugador.',
            'bfopt_usepowerattack': 'Power Attack.<br>Marca esta opciÃ³n para activar "Power Attack".<br>Esta opciÃ³n es requerida para poder usar "Rapid Fire".',
            'bfopt_attackplayernpc': 'NPC Attack.<br>Marca esta opciÃ³n para atacar a jugadores controlados por la mÃ¡quina que aparecen en tu lista de enemigos cuando estÃ¡s haciendo una misiÃ³n.',
            'bfopt_healtimer': 'Autoheal.<br>Pon aquÃ­ la cantidad de segundos que debes esperar antes de curarte despuÃ©s de haberte curado.<br>Normalmente para todos los jugadores es 60 segundos, asÃ­ que mantÃ©n esta opciÃ³n en 60 si no sabes que poner.',
            'bfopt_useattackdelay': 'Attack delay.<br>Marca esta opciÃ³n para activar el retraso para ataques a un mismo jugador.<br>Si estÃ¡s intentando obtener ices, desmÃ¡rcala.',
            'bfopt_attackdelay': 'Attack delay.<br>Selecciona los segundos de retraso entre ataques a un mismo jugador.',
            'bfopt_usenewplayerdelay': 'Attack delay.<br>Marca esta opciÃ³n para activar el retraso de ataque a un nuevo jugador.',
            'bfopt_newplayerdelay': 'Attack delay.<br>Selecciona los segundos de retraso cuando vas a atacar a un jugador diferente.',
            'bfopt_usebank': 'Autobanking.<br>Marca esta opciÃ³n para activar Autobanking (esto depositarÃ¡ tu dinero en el banco).',
            'bfopt_usebankwhen': 'Autobanking.<br>Pon aquÃ­ la cantidad de dinero acumulada para que Autobanking la meta en el banco.',
            'bfopt_disableplayercache': 'Player cache<br>MÃ¡rcalo para desactivar la cachÃ© de jugadores.<br>Cuando atacas a un jugador la primera vez, obtienes una lista de jugadores nuevos, al desactivar esta opciÃ³n forzarÃ¡s que se ataquen solo a esos jugadores.<br><br>DesmÃ¡rcalo para usar la cachÃ©.<br>Si usas la cachÃ©, Bttlefield mantendrÃ¡ hasta a 20 jugadores como mucho en reserva para atacarlos mientras busca nuevos jugadores.',
            'bfopt_attackwhenlost': 'Red ices.<br>Marca esta opciÃ³n para activar "Red ice".<br>Esto atacarÃ¡ jugadores con los que pierdas.',
            'bfopt_attackwhenlostbut': 'Red ices.<br>Marca esta opciÃ³n para atacar a un jugador con el que pierdes solo si necesitas una cantidad determinada de ataques para obtener tu ice.',
            'bfopt_attackwhenlostbutif': 'Red ices.<br>Pon aquÃ­ la cantidad de ataques necesarios para obtener tu ice cuando atacas perdiendo.',
            'bfopt_keepattackafterwon': 'Red ices.<br>Marca esta opciÃ³n para continuar atacando a un jugador con el que pierdes pero al que ganaste al menos el primer combate.',
            'bfopt_takerevenge': 'Revenges.<br>Marca esta opciÃ³n para activar "Revenge".<br>Esto atacarÃ¡ a los jugadores que te roben algÃºn ice.',
            'bfopt_revengelevel': 'Revenges.<br>Marca esta opciÃ³n si quieres filtrar por nivel a que jugadores atacar por medio de "Revenge".',
            'bfopt_revengelevelway': 'Revenges.<br>Selecciona si el nivel deberÃ¡ ser superior o inferior al indicado.',
            'bfopt_revengelevelof': 'Revenges.<br>Pon aquÃ­ el nivel que se usarÃ¡ para filtrar los jugadores que te robaron un ice.',
            'bfopt_norevengeblacklist': 'Revenges.<br>Marca esta opciÃ³n para no atacar a los jugadores que te robaron un ice y se encuentran en tu lista negra (blacklist).',
            'bfopt_autopublish': 'Autopublish.<br>Marca esta opciÃ³n para activar Autopublish.<br>Esto publicarÃ¡ un determinado nÃºmero de ices en tu muro o un grupo/pÃ¡gina que especifiques.',
            'bfopt_autopublishafter': 'Autopublish.<br>Selecciona el nÃºmero de ices que deseas publicar.',
            'bfopt_autopublishin': 'Autopublish.<br>Pon aquÃ­ el ID del grupo o pÃ¡gina en el que deseas publicar.<br>Debe se un nÃºmero. Para publicar en tu muro dÃ©jalo en blanco.',
            'bfopt_maxloglength': 'Log events.<br>Selecciona el nÃºmero de eventos que se montrarÃ¡n en el log general.',
            'bfopt_showsocialevents': 'Log events.<br>MÃ¡rcalo para mostrar eventos sociales en el log general.',
            'bfopt_showlootevents': 'Log events.<br>MÃ¡rcalo para mostrar eventos de loot (objetos que obtienes) en el log general.',
            'bfopt_usenamefilter': 'Filtering.<br>MÃ¡rcalo para activar el filtro por nombres.',
            'bfopt_namefilterval': 'Filtering.<br>Pon aquÃ­ el filtro para los nombres.<br>NORMAL: cada caracter que ponges se considerarÃ¡ un filtro.<br>REGEX: Debes poner un regex vÃ¡lido.',
            'bfopt_usefilterregex': 'Filtering.<br>MÃ¡rcalo para utilizar regex ewn el filtro por nombres.<br>Si no sabes como aÃ±adir un regex, desmÃ¡rcalo.',
            'bfopt_usebadgefilter': 'Filtering.<br>MÃ¡rcalo para user filtro por insignias.',
            'bfopt_badgefilterval': 'Filtering.<br>Pon aquÃ­ el filtro que usarÃ¡s para filtrar tus oponentes por insignias.<br>Por ejemplo, "diamond [2-5]" omitirÃ¡ cualquier jugador que tenga el tier diamond en nivel de 2 a 5.',
            'bfopt_useskipifhealth': 'Skipping.<br>MÃ¡rcalo para activar el filtro por nivel de vida.',
            'bfopt_skipifhealth': 'Skipping.<br>Selecciona el nivel de vida mÃ¡ximo que tendrÃ¡ tu oponente en porcentaje para atacarlo.',
            'bfopt_skipifotherdamage': 'Skipping.<br>MÃ¡rcalo para omitir jugadores que han sido daÃ±ados por otros jugadores.',
            'bfopt_skipminimalcash': 'Skipping.<br>MÃ¡rcalo para activar el filtro por dinero.',
            'bfopt_minimalcash': 'Skipping.<br>Pon aquÃ­ cuanto dinero debe soltar tu enemigo para continuar atacÃ¡ndolo.',
            'bfopt_skipdiffcitycash': 'Skipping.<br>MÃ¡rcalo para dejar de atacar a un jugador que suelta dinero de una ciudad diferente en la que luchas.<br>Esta opciÃ³n e smuy util para obtener objetos en Brazil x 5.',
            'bfopt_skiplevel': 'Filtering by level.<br>MÃ¡rcalo para activar el filtro por nivel.',
            'bfopt_skiplevelway': 'Filtering by level.<br>Selecciona si el nivel debe ser mayor o menor que el indicado.',
            'bfopt_skiplevelof': 'Filtering by level.<br>Pon aquÃ­ el nivel que se comprobarÃ¡ en el filtro.',
            'bfopt_skiplevelbut': 'Filtering by level.<br>MÃ¡rcalo para activar el chequeo de mafia para jugadores filtrados por su nivel.',
            'bfopt_skiplevelbutway': 'Filtering by level.<br>Selecciona si la mafia debe ser mayor o menor que el indicado.',
            'bfopt_skiplevelbutmafia': 'Filtering by level.<br>Pon aquÃ­ el nÃºmero de mafia que se comprobarÃ¡ cuando un jugador ha sido filtrado por nivel.',
            'bfopt_skipmafia': 'Filtering by mafia.<br>MÃ¡rcalo para activar el filtro por mafia.',
            'bfopt_skipmafiaway': 'Filtering by mafia.<br>Selecciona si la mafia debe ser mayor o menor que el indicado.',
            'bfopt_skipmafiaof': 'Filtering by mafia.<br>Pon aquÃ­ el nÃºmero de mafia que se comprobarÃ¡ en el filtro.',
            'bfopt_skipmafiabut': 'Filtering by mafia.<br>MÃ¡rcalo para activar el chequeo de nivel para jugadores filtrados por su mafia.',
            'bfopt_skipmafiabutway': 'Filtering by mafia.<br>Selecciona si el nivel debe ser mayor o menor que el indicado.',
            'bfopt_skipmafiabutlevel': 'Filtering by mafia.<br>Pon aquÃ­ el nivel que se comprobarÃ¡ para jugadores filtrados por su mafia. ',
            'bfopt_skipiced': 'Filtering.<br>MÃ¡rcalo para omitir jugadores que ya estÃ¡n iced.',
            'bfopt_skipicedplayers': 'Filtering.<br>MÃ¡rcalo para omitir jugadores a los que ya les hiciste un ice.',
            'bfopt_skipifhealed': 'Skipping.<br>MÃ¡rcalo para omitir jugadores que se han curado.<br>Esta opciÃ³n no funciona si tienes activado Rapid Fire.',
            'bfopt_usestopwheniced': 'Autostop.<br>MÃ¡rcalo para activar el paro por acumulaciÃ³n de ices.',
            'bfopt_stopwheniced': 'Autostop.<br>Pon aquÃ­ cuantos ices quieres obtener antes de parar de atacar.',
            'bfopt_stopwhenstamina': 'Autostop.<br>MÃ¡rcalo para activar el paro por stamina.',
            'bfopt_staminatokeep': 'Autostop.<br>Pon aquÃ­ cuanta stamina deseas conservar.',
            'bfopt_stopbeforelvlup': 'Autostop.<br>MÃ¡rcalo para parar Battlefield antes de subir de nivel.',
            'bfopt_explefttostop': 'Autostop.<br>Pon aquÃ­ cuanta experiencia deseas conservar.',
            'bfopt_stopafterlevelup': 'Autostop.<br>MÃ¡rcalo para parar Battlefield despuÃ©s de subir de nivel.',
            'bfopt_keepfigthing': 'Autoresume.<br>MÃ¡rcalo para continuar luchando despuÃ©s de que se haya parado.',
            'bfopt_resumedelay': 'Autoresume.<br>Pon aquÃ­ el tiempo en minutos que debe esperar antes de resumir la lucha.',
            'bfopt_fighttime': 'Autopause.<br>MÃ¡rcalo para activar el modo de pausa.',
            'bfopt_fighttimeout': 'Autopause.<br>Pon aquÃ­ cuantos minutos debes mantenerte luchando antes de pausar.',
            'bfopt_fighttimeoutresume': 'Autopause.<br>Pon aquÃ­ los minutos que esperarÃ¡s antes de resumir la lucha.',
            'bfopt_useblacklist': 'Blacklist.<br>MÃ¡rcalo para aÃ±adir los luchadoes que te ganen a tu lista negra.',
            'bfopt_blacklist': 'Blacklist.<br>La lista negra se usa para aÃ±adir los jugadores a los que no quieres atacar.',
            'bfopt_addusertowlist': 'Whitelist.<br>MÃ¡rcalo para aÃ±adir jugadores a la lista blanca.',
            'bfopt_cashneedtogain': 'Whitelist.<br>DespuÃ©s de haber terminado de atacar a un jugador, pon aquÃ­ la cantidad de dinero que debe soltar para aÃ±adirlo a la lista blanca automaticamente.',
            'bfopt_usewlistattackcount': 'Whitelist.<br>MÃ¡rcalo para atacar la lista blanca solo el nÃºmero de veces especificado.<br>DespuÃ©s de atacar la lista blanca las veces especificadas, se continuarÃ¡ atacando de forma normal a otros jugadores.',
            'bfopt_wlistattackcount': 'Whitelist.<br>Si has marcado "Attack whitelist only", pon aquÃ­ las veces que quieres atacar la lista blanca.',
            'bfopt_randomizewhitelist': 'Whitelist.<br>MÃ¡rcalo para atacar la lista blanca de forma aleatoria.',
            'bfopt_whitelist': 'Whitelist.<br>La lista blanca se usa para aÃ±adir jugadores a los que quieres atacar mÃ¡s adelante.',
            ...
            'bfopt_addtoclanlist': 'Family.<br>MÃ¡rcalo para aÃ±adir las familias que filtras a tu lista de clanes.',
            'bfopt_skipfilteredclans': 'Family.<br>MÃ¡rcalo para omitir la lucha a los jugadores que pertenezcan a una familia filtrada.',
            'bfopt_clanlistusage': 'Family.<br>Selecciona como se usarÃ¡ tu lista de clanes.<br>Normalmente se usa para no atacar a jugadores que pertenezcan a las familias que aÃ±ades en la lista, por ello se selecciona "Skipped".',
            'bfopt_clanlist': 'Family.<br>La lista de clanes se usa para aÃ±adir familias a las que no quieres atacar o deseas atacar.'
        },
        
        // FREE GIFTS CENTER
        'freegiftscenter_popup': {
            'filter_text': 'Filtering.<br>Usa este filtro para mostrar solo algunos regalos.',
            'select_fbgroups': 'Scanning.<br>Selecciona aquÃ­ el grupo que deseas escanear.<br>Si solo ves "My wall", pulsa en "Refresh".',
            'freegifts_scantime': 'Scanning.<br>Pon aquÃ­ el tiempo que tendrÃ¡ como mÃ¡ximo un posts para escanearlo.',
            'massive_input': 'Parsing.<br>AquÃ­ puedes pegar todos los enlaces que encuentres de tus amigos para de una pÃ¡gina.',
            'freegifts_usefilter': 'Parsing.<br>MÃ¡rcalo para activar el filtro de regalos.',
            'freegifts_filter': 'Parsing.<br>AÃ±ade aquÃ­ los regalos que deseas mostrar.<br>Separa cada regalo por el caracter "|".',
            'freegifts_remonsuccess': 'Remove facebook requests.<br>MÃ¡rcalo para quitar una peticiÃ³n de facebook tras aceptarla.',
            'freegifts_remonignore': 'Remove facebook requests.<br>MÃ¡rcalo para quitar una peticiÃ³n de facebook tras ignorarla.',
            'freegifts_sendthanksrequest': 'Send back.<br>MÃ¡rcalo para devolver regalos de facebook tras aceptar un regalo.',
            'freegifts_sendbacktype': 'Send back.<br>Selecciona por medio de que deseas devolver los regalos.',
            'freegifts_usebackgiftfilter': 'Send back.<br>MÃ¡rcalo para activar el filtro de regalos usado para devolverlos.',
            'freegifts_thanksbackfilter': 'Send back.<br>Pon aquÃ­ los nombres de los regalos que deseas filtrar.<br>Usa "|" para separarlos.',
            'freegifts_ignorelimits': 'Collector.<br>MÃ¡rcalo para ignorar los regalos que llegan a su lÃ­mite diario y seguir abriendolos.',
            'freegifts_skipsameuser': 'Collector.<br>MÃ¡rcalo para no recoger regalos del mismo usuario cuando ya le abriste.',
            'freegifts_masssendback': 'Collector.<br>MÃ¡rcalo para devolver regalos a travÃ©s de facebook despuÃ©s de abrirlos.',
            'freegifts_collectnomafia': 'Collector.<br>MÃ¡rcalo para abrir relgalos de gente que no estÃ¡ en tu mafia.',
            'freegifts_csselect': 'Crime Spree.<br>Selecciona aquÃ­ el Paso 1 cuando abres un Crime Spree.',
            'freegifts_csreward': 'Crime Spree.<br>Selecciona aquÃ­ el Paso 2 cuando abres un Crime Spree.',
            'freegifts_useexcludedgifts': 'Skipping.<br>MÃ¡rcalo para activar la lista de excluidos.',
            'freegifts_excludedpattern': 'Skipping.<br>Pon aquÃ­ el texto que aparecerÃ¡ tras abrir un regalo que harÃ¡ que este sea aÃ±adido a la lista de excluidos.<br>Usa "|" para aÃ±adir varios textos diferentes.'
        },
        
        // REMINDER EDITOR
        'remindereditor_popup': {
            'setting_name': 'Reminder Editor.<br>Pon aquÃ­ el nombre del recordatorio.',
            'setting_description': 'Reminder Editor.<br>Pon aquÃ­ una descripciÃ³n del recordatorio.',
            ...
            'setting_every': 'Reminder Editor.<br>Pon aquÃ­ las horas, o la hora del dÃ­a que se te recordara.',
            'setting_gotocity': 'Reminder Editor.<br>MÃ¡rcalo para viajar a una ciudad.',
            'setting_gotocityid': 'Reminder Editor.<br>Selecciona la ciudad a la que viajarÃ¡s.',
            'setting_gotopage': 'Reminder Editor.<br>MÃ¡rcalo para ir a una pÃ¡gina de Mafia Wars.',
            'setting_gotopageurl': 'Reminder Editor.<br>Pon aquÃ­ la pÃ¡gina a la que irÃ¡s.<br>Puedes copiar y pegar cualquier direcciÃ³n que apunte a una pÃ¡gina de Mafia Wars.',
            'setting_runplugin': 'Reminder Editor.<br>MÃ¡rcalo para usar un plugin previamente aÃ±adido.',
            'setting_runpluginid': 'Reminder Editor.<br>Selecciona el plugin que deseas ejecutar.',
            'setting_resetonload': 'Reminder Editor.<br>MÃ¡rcalo si quieres resetear este recordatorio cuando cargues una pÃ¡gina en Mafia Wars.',
            'setting_resetonloadurl': 'Reminder Editor.<br>Pon aquÃ­ la pÃ¡gina que resetearÃ¡ el recordatorio.<br>Puedes copiar y pegar cualquier direcciÃ³n que apunte a una pÃ¡gina de Mafia Wars.'
        },
        
        // PLUGIN MANAGER
        'pluginmanager_popup': {
            'app_name': 'Plugin Manager.<br>Pon aquÃ­ el nombre del plugin.',
            'app_code': 'Plugin Manager.<br>AÃ±ade aquÃ­ el cÃ³digo del script que deseas ejecutar.'
        },
        
        // MULTI GIFTER
        'multigifter_popup': {
            'multigift_giftpages': 'Pagination.<br>MÃ¡rcalo para paginar la lista de objetos.',
            'multigift_userpages': 'Pagination.<br>MÃ¡rcalo para paginar la lista de amigos.',
            'multigift_hidezeroamount': 'Item quantity.<br>MÃ¡rcalo para esconder los objetos que tengan una cantidad de cero.',
            'multigift_delay': 'Delay.<br>Pon aquÃ­ el retraso para enviar regalos.',
            'gift_page': 'Pagination.<br>Selecciona la pÃ¡gina que deseas ver.',
            'user_page': 'Pagination.<br>Selecciona la pÃ¡gina que deseas ver.',
            'gift_category': 'Gift category.<br>Selecciona que categorÃ­a deseas ver.',
            'user_category': 'User category.<br>Selecciona que categorÃ­a deseas ver.',
            'collection_filter_type': 'Filtering.<br>Selecciona el tipo de filtro para las colecciones.',
            'collection_filter': 'Filtering.<br>Selecciona el nombre de la colecciÃ³n que deseas ver.',
            'search_gift': 'Searching.<br>Usa una bÃºsqueda para encontrar objetos.',
            'saved_search': 'Searching.<br>Selecciona una bÃºsqueda previamente guardada.',
            'search_user': 'Searching.<br>Usa una bÃºsqueda de amigos.'
        },
        
        // HOME FEED CENTER
        'homefeedcenter_popup': {
            'feedstream_filter': 'Filtering.<br>Puedes aÃ±adir un filtro para ver determinadas publicadiones.',
            'feedstream_grouping': 'Filtering.<br>Selecciona un grupo de publicaciones que quieras ver.',
            'feedstream_dogotowar': 'Helping.<br>MÃ¡rcalo para ayudar en las guerras.',
            'feedstream_dogivesocialhelp': 'Helping.<br>MÃ¡rcalo para ayudar en los trabajos.',
            'feedstream_dosocialmissions': 'Helping.<br>MÃ¡rcalo para meterte en las operaciones.',
            'feedstream_doclaimbonusandreward': 'Helping.<br>MÃ¡rcalo para reclamar bonus y premios.',
            'feedstream_docollectloot': 'Helping.<br>Esta opciÃ³n ya no es necesaria. desmÃ¡rcala.',
            'feedstream_dopropertyhelp': 'Helping.<br>MÃ¡rcalo para ayudar enviando partes.',
            'feedstream_dogetboost': 'Helping.<br>MÃ¡rcalo para obtener bonus de los level up.',
            'feedstream_dosendenergyandphones': 'Helping.<br>MÃ¡rcalo para enviar telÃ©fonos y paquetes de energÃ­a.',
            'feedstream_doacceptgiftevent': 'Helping.<br>MÃ¡rcalo para aceptar regalos de un evento.',
            'feedstream_dohitlistbounty': 'Helping.<br>MÃ¡rcalo para ayudar en las recompensas.',
            'feedstream_dosecretstash': 'Helping.<br>MÃ¡rcalo para ayudar en los alijos secretos.',
            'feedstream_docitycrew': 'Helping.<br>MÃ¡rcalo para ayudar en los city crew.',
            'feedstream_autoclose': 'General.<br>Si estÃ¡ activado, cuando aceptes ayduar en una publicaciÃ³n esta se cerrarÃ¡ despuÃ©s de un corto tiempo.',
            'feedstream_feedslimit': 'General.<br>Pon aquÃ­ el lÃ­mite de publicaciones que cargarÃ¡ el Autohelp.',
            'feedstream_maxloglength': 'General.<br>Selecciona el mÃ¡ximo de publicaciones realizadas que mostrarÃ¡ el log.',
            'feedstream_helpdelay': 'General.<br>Selecciona el tiempo de retraso entre que ayudas en una publicaciÃ³n y otra.',
            'feedstream_refreshdelay': 'General.<br>Selecciona el tiempo de retraso para refrescar las publicaciones de tu muro.',
            'feedstream_waruseminattack': 'War help.<br>MÃ¡rcalo para omitir una guerra si el regalo tiene un ataque inferior.',
            'feedstream_warminattack': 'War help.<br>Pon aquÃ­ el ataque mÃ­nimo del regalo para ayudar en las guerras.',
            'feedstream_warusemindefense': 'War help.<br>MÃ¡rcalo para omitir una guerra si el regalo tiene una defensa inferior.',
            'feedstream_warmindefense': 'War help.<br>Pon aquÃ­ la defensa mÃ­nima del regalo para ayudar en las guerras.',
            'feedstream_warusenamefilter': 'War help.<br>MÃ¡rcalo para activar el filtro por nombre.<br>Si marcas esta opciÃ³n desactiva las dos anteriores.',
            'feedstream_warnamefilter': 'War help.<br>AÃ±ade los nombres de los regalos que deseas obtener de las guerras separados por "|".',
            'feedstream_joinmission': 'Operations.<br>Selecciona en que tipo de hueco quires meterte cuando entras en una operaciÃ³n.',
            'feedstream_joinmissionafter': 'Operations.<br>Selecciona en que tipo de hueco quires meterte cuando entras en una operaciÃ³n, si el anterior no es posible.',
            'feedstream_maxfreeslots': 'Operations.<br>Selecciona el lÃ­mite mÃ¡ximo de huecos libres que puede tener una operaciÃ³n para que te metas en ella.',
            'feedstream_missionfilter': 'Operations.<br>Puedes aÃ±adir filtros para nombres de operaciones separados por "|".',
            'feedstream_citycrewfilter': 'City Crew.<br>Puedes aÃ±adir filtros para nombres de amigos a los que ayudar separados por "|".'
        }
    },
    ...
    'de_DE': {
        ...
        // CONFIGURATION
        'config_popup': {
            'main_checkforupdates': 'Updates.<br>Aktivieren, um auf die VerfÃ¼gbarkeit neuer Updates zu prÃ¼fen.',
            'main_autoheal': 'Autoheal.<br>AuswÃ¤hlen, um die AutoHeal-Funktion zu aktivieren.<br>Funktioniert nur bei manuellem spielen.',
            'main_autohealwhen': 'Autoheal.<br>Health Wert, der unterschritten werden muss fÃ¼r AutoHeal.',
            'main_autohealin': 'Autoheal.<br>AuswÃ¤hlen, wo Du Dich heilen willst.',
            'main_shortserviceid': 'Shortening.<br>WÃ¤hle den Dienst zum Links kÃ¼rzen.<br>Die Dienste die Cross-Domains verwenden funktionieren nur in Firefox und Chrome mit dem MWAddon plugin.',
            'privacy': 'Privacy.<br>Standard fÃ¼r das Posten der BeitrÃ¤ge auswÃ¤hlen.',
            'privacy_fl': 'Privacy.<br>Nur Freunde in Deiner ausgewÃ¤hlten Freundesliste kÃ¶nnen deine BeitrÃ¤ge sehen.',
            'main_publishpreview': 'Publish method.<br>AuswÃ¤hlen, um das Facebook-Vorschaufenster anzuzeigen.<br>ErmÃ¶glicht das Posten auf Deiner Wall.'
        },
        
        // BATTLEFIELD
        'battlefield_popup': {
            'bfopt_forcestartingcity': 'Starting city.<br>Aktivieren, wenn Du eine Stadt zu Beginn setzen willst.<br>Nicht auswÃ¤hlen, wenn Du in einem anderen Fenster Mafia Wars spielen willst.',
            'bfopt_startingcity': 'Starting city.<br>Wenn Du "Start City" aktiviert hast, erfolgt ein Wechsel zu der ausgewÃ¤hlten Stadt.',
            'bfopt_fightcitytime': 'Travel to cities.<br>Aktivieren, um nach der eingestellten Zeit zu einer anderen Stadt zu wechseln.<br>Es werden die StÃ¤dte verwendet, die vorher bei "Select Cities" ausgewÃ¤hlt wurden.',
            ...
            'bfopt_travelwhennotargets': 'Travel to cities.<br>Aktivieren, um die Stadt zu wechseln wenn in der aktuellen keine Gegner mehr gefunden werden.<br>Es werden die StÃ¤dte verwendet, die vorher bei "Select Cities" ausgewÃ¤hlt wurden.',
            'bfopt_useheal': 'Autoheal.<br>Aktivieren, um Dich automatisch zu heilen.',
            'bfopt_healin': 'Autoheal.<br>Stadt auswÃ¤hlen, in der Du dich heilen willst.',
            ...
            'bfopt_rapidfirewhen': 'Rapid Fire.<br>AuswÃ¤hlen, wann Rapid Fire gestartet wird.<br>Je hÃ¶her das gesetzt ist, desto eher gibts ein ICE, aber es kostet Dich mehr Stamina.<br>Wenn "Maximum Attack" nicht aktiviert ist, wird Deine Stamina verschwendet bei einem Spieler den Du nicht alleine ICEN kannst.',
            'bfopt_rapidfireprofile': 'Rapid Fire.<br>AuswÃ¤hlen der Rapid Fire AggressivitÃ¤t.<br>Je hÃ¶her das gesetzt ist desto eher gibts ein ICE aber es kostet Dich mehr Stamina.',
            'bfopt_useattackcount': 'Maximum Attacks.<br>Aktivieren, um Maximum Attacks einzuschrÃ¤nken.<br>Aktivieren wenn Du Rapid Fire aktiviert hast.',
            ...
            'bfopt_attackplayernpc': 'NPC Attack.<br>Aktivieren, um Gegner von Missionen anzugreifen. Das sind keine normalen Spieler. (ohne MafiagrÃ¶ÃŸenangabe)',
            'bfopt_healtimer': 'Autoheal.<br>Zeit eingeben, nach der wieder geheilt werden darf nach dem letzten Heilen<br>Heilt Dich, wenn es wieder mÃ¶glich ist. Speichere die Zeit, nach der Du Dich frÃ¼hestens wieder Heilen kannst.<br>Normalerweise sind es 60 Sekunden fÃ¼r alle Spieler. Die Zeit kann durch Bonus verkÃ¼rzt werden.(Brazil Mastery)',
            'bfopt_useattackdelay': 'Attack delay.<br>Aktivieren, um eine Zeit zu setzen bis zum nÃ¤chsten Angriff auf den gleichen Spieler.<br>Nicht aktivieren, um ein ICE zu bekommen.',
            'bfopt_attackdelay': 'Attack delay.<br>Pause zwischen zwei Angriffen auf den gleichen Gegner.',
            'bfopt_usenewplayerdelay': 'Attack delay.<br>Aktivieren, um eine Pause zu machen, bis der nÃ¤chste Gegner angegriffen wird.<br>Hat keinen Einfluss, viele ICE zu erhalten .',
            'bfopt_newplayerdelay': 'Attack delay.<br>Zeit fÃ¼r die Pause eingeben.<br>Empfohlen wird mindestens 1 Sekunde.',
            'bfopt_usebank': 'Autobanking.<br>Aktiviert das automatische Einzahlen.<br>WÃ¤hle die StÃ¤dte aus bei "Select Cities", in der das automatische Einzahlen aktiviert werden soll.',
            'bfopt_usebankwhen': 'Autobanking.<br>Mindestbetrag der erreicht werden muss, bevor automatisch einbezahlt wird.',
            'bfopt_attackwhenlost': 'Red ices.<br>Aktivieren, um weiter anzugreifen, auch wenn Du verlierst.<br>Red Ice: Um ein ICE zu bekommen auch wenn Du die KÃ¤mpfe verlierst.<br>Bringt wenig XP und keine Loots.',
            'bfopt_attackwhenlostbut': 'Red ices.<br>Aktivieren, damit nur angegriffen wird, wenn Du verlierst, aber weniger als x Angriffe brauchst fÃ¼r ein ICE.<br>Funktioniert nur, wenn die Funktion "Attack when lost" aktiviert ist.',
            'bfopt_attackwhenlostbutif': 'Red ices.<br>Maximale Anzahl Angriffe fÃ¼r ein red ICE.<br>Funktioniert nur, wenn die Funktion "Attack when lost" aktiviert ist.',
            ...
            'bfopt_takerevenge': 'Revenges.<br>Aktiviert die Revange Funktion.<br>Diese Funktion ermÃ¶glicht das automatische Angreifen der Spieler, die Dir das ICED geklaut haben.',
            'bfopt_revengelevel': 'Revenges.<br>Aktivieren, um Revange Level abhÃ¤ngig zu machen.',
            'bfopt_revengelevelway': 'Revenges.<br>AuswÃ¤hlen, ob der Gegner ein kleineres oder grÃ¶sseres Level hat als angegeben.',
            'bfopt_revengelevelof': 'Revenges.<br>Wenn "lower" (kleiner) ausgewÃ¤hlt ist, hier das hÃ¶chste Level eingeben das angegriffen werden soll.<br>Wenn "greater" (grÃ¶ÃŸer) ausgewÃ¤hlt ist, hier das kleinste Level eingeben das angegriffen werden soll.',
            'bfopt_norevengeblacklist': 'Revenges.<br>Aktivieren, um Spieler zu Ã¼berspringen bei Revange, die in der BlackList sind.',
            ...
            'bfopt_maxloglength': 'Log events.<br>Maximale Anzahl der EintrÃ¤ge, die im Log-Fenster zu sehen sind.',
            'bfopt_showsocialevents': 'Log events.<br>Aktivieren, um "Sozial" EventeintrÃ¤ge im Log anzuzeigen.<br>Deaktivieren bei langer Laufzeit, um den Arbeitsspeicher zu schonen.',
            'bfopt_showlootevents': 'Log events.<br>Aktivieren, um Loot EventeintrÃ¤ge im Log anzuzeigen.<br>Deaktivieren bei langer Laufzeit, um den Arbeitsspeicher zu schonen.',
            'bfopt_usenamefilter': 'Filtering.<br>Aktivieren, um Gegner wegen speziellem Namen zu Ã¼berspringen.<br>Keine clan tags hier eingeben.',
            'bfopt_namefilterval': 'Filtering.<br>Verwendet, wenn "Name filter" aktiviert ist.<br>NORMAL: Jedes Zeichen zÃ¤hlt als Filter.<br>REGEX: Verwende einen gÃ¼ltigen regex syntax. Example: Erlaubt ist nur word/space/point<br>[^\\w\\s\\.]',
            'bfopt_usefilterregex': 'Filtering.<br>Verwendet von "Name filter" aktiviert Regex.<br>Wenn Du nicht weiÃŸt, wie regex funktioniert - DEAKTIVIEREN!.',
            'bfopt_usebadgefilter': 'Filtering.<br>Aktivieren, um Spieler wegen Badges zu Ã¼berspringen.',
            'bfopt_badgefilterval': 'Filtering.<br>AuswÃ¤hlen, welche Badges Ã¼bersprungen werden sollen.<br>Beispiel zum Ãœberspringen von Diamond Tiers 2 is 5 badges: diamond [2-5]<br>Beispiel zum Ãœberspringen von Rruby und Diamond: ruby|diamond',
            'bfopt_useskipifhealth': 'Skipping.<br>Aktivieren, um Gegner aufgrund mehr prozentualer Health zu Ã¼berspringen als eingestellt.',
            'bfopt_skipifhealth': 'Skipping.<br>Setze die maximale Health in Prozent, um weiter anzugreifen.',
            'bfopt_skipifotherdamage': 'Skipping.<br>AuswÃ¤hlen um Gegner zu Ã¼berspringen die von einem anderen angegriffen werden.',
            'bfopt_skipminimalcash': 'Skipping.<br>Aktivieren, um Gegner zu Ã¼berspringen, wenn kein Geld gewonnen wird bei dem Angriff.',
            'bfopt_minimalcash': 'Skipping.<br>Wenn aktiviert, setze das Limit an Geld, was bei jedem Angriff gewonnen werden muss, um weiter anzugreifen.<br>Mit einem Angriff kÃ¶nnen maximal $ 65000 gewonnen werden ohne Bonus (New York, Moscow, Vegas, Italy).<br>In anderen StÃ¤dten ist das Maximum geringer.',
            'bfopt_skipdiffcitycash': 'Skipping.<br>Aktivieren, um Gegner zu Ã¼berspringen, wenn das gewonnene Geld nicht aus der aktuellen Stadt stammt.<br>Funktioniert sehr gut, um 5x Loot-Pakete in Brazil zu sammeln.',
            'bfopt_skiplevel': 'Filtering by level.<br>Aktiviert den Filter nach Level.<br>Beispiel:<br>Skip users level "greater" than: "5000", but attack if mafia is "lower" than: "490".<br>Es werden alle Gegner Ã¼bersprungen, die Ã¼ber Level 5000 sind, auÃŸer die MafiagrÃ¶ÃŸe ist kleiner als 490.',
            'bfopt_skiplevelway': 'Filtering by level.<br>AuswÃ¤hlen, ob das Level grÃ¶ÃŸer oder kleiner sein soll als angegeben.',
            'bfopt_skiplevelof': 'Filtering by level.<br>Setze die Levelnummer fÃ¼r den Levelfilter.',
            'bfopt_skiplevelbut': 'Filtering by level.<br>Aktivieren, um den Gegner auf MafiagrÃ¶ÃŸe zu prÃ¼fen, wenn er wegen dem Level Ã¼bersprungen wurde.<br>Funktioniert nur wenn "Skip users level" aktiviert ist.',
            'bfopt_skiplevelbutway': 'Filtering by level.<br>AuswÃ¤hlen, ob die MafiagrÃ¶ÃŸe grÃ¶ÃŸser oder kleiner sein soll als angegeben.',
            'bfopt_skiplevelbutmafia': 'Filtering by level.<br>Setze die MafiagrÃ¶ÃŸe, um einen Gegner anzugreifen, der wegen dem Level Ã¼bersprungen wurde.',
            'bfopt_skipmafia': 'Filtering by mafia.<br>Aktiviert den Filter nach MafiagrÃ¶ÃŸe.<br>Beispiel:<br>Skip users mafia "greater" than: "500", But attack if level is "lower" than: "700".<br>Es werden alle Gegner Ã¼bersprungen, deren MafiagrÃ¶ÃŸe Ã¼ber 500 ist, auÃŸer das Level ist kleiner als 700.',
            'bfopt_skipmafiaway': 'Filtering by mafia.<br>AuswÃ¤hlen, ob die MafiagrÃ¶ÃŸe grÃ¶ÃŸer oder kleiner sein soll als angegeben.',
            'bfopt_skipmafiaof': 'Filtering by mafia.<br>Setze die MafiagrÃ¶ÃŸe fÃ¼r den Mafiafilter.',
            'bfopt_skipmafiabut': 'Filtering by mafia.<br>Aktivieren, um das Level des Gegners zu prÃ¼fen, wenn er wegen der MafiagrÃ¶ÃŸe Ã¼bersprungen wurde.<br>Funktioniert nur wenn "Skip users mafia" aktiviert ist.',
            'bfopt_skipmafiabutway': 'Filtering by mafia.<br>AuswÃ¤hlen, ob das Level grÃ¶ÃŸer oder kleiner sein soll als angegeben.',
            'bfopt_skipmafiabutlevel': 'Filtering by mafia.<br>Aktivieren, um das Level des Gegners zu prÃ¼fen, wenn er wegen der MafiagrÃ¶ÃŸe Ã¼bersprungen wurde.',
            'bfopt_skipiced': 'Filtering.<br>AuswÃ¤hlen, um nicht auf Leichen einzuschlagen. Ãœberspringt Gegner die schon ICED sind.',
            'bfopt_skipicedplayers': 'Filtering.<br>Aktivieren, um Spieler zu Ã¼berspringen, die Du ICED hast.',
            'bfopt_skipifhealed': 'Skipping.<br>Aktivieren, um Gegner zu Ã¼berspringen, die sich geheilt haben.<br>Funktioniert nicht, wenn "Rapid Fire" aktiviert ist.',
            ...
            'bfopt_explefttostop': 'Autostop.<br>Anzahl an XP, die zum Leveln gebraucht wird fÃ¼r das Stoppen.',
            'bfopt_stopafterlevelup': 'Autostop.<br>Aktivieren, um zu Stoppen nach dem Level-UP.<br>Stoppt und Ã¶ffnet das Fenster vom Level-UP.',
            ...
            'bfopt_fighttime': 'Autopause.<br>AuswÃ¤hlen, um das Battlefield zu pausieren nach der eingestellten Zeit.',
            'bfopt_fighttimeout': 'Autopause.<br>Anzahl Minuten, bis das Battlefield pausiert wird.',
            'bfopt_fighttimeoutresume': 'Autopause.<br>Anzahl Minuten, bis das Battlefield weiter lÃ¤uft nach der eingestellten Pause.',
            'bfopt_useblacklist': 'Blacklist.<br>Aktivieren, um zu starke Spieler in die BlackList einzutragen.',
            'bfopt_blacklist': 'Blacklist.<br>Die BalckList wird gebraucht, um Spieler zu Filtern/Ãœberspringen.',
            ...
            'bfopt_whitelist': 'Whitelist.<br>Du kannst den "Attack whitelist" Knopf verwenden, um die Spieler anzugreifen. Funktioniert wie die Rivals List, ermÃ¶glicht aber eine grÃ¶ÃŸere Anzahl an Spielern.',
            'bfopt_clantagfilterval': 'Family.<br>Setze die Filter fÃ¼r Family tags.<br>WÃ¶rter oder einzelne Zeichen eingeben pro Zeile.',
            ...
            'bfopt_skipfilteredclans': 'Family.<br>Verwendet "Family Tag Filter".<br>Aktivieren, um die Familien zu filtern/Ã¼berspringen.',
            'bfopt_clanlistusage': 'Family.<br>WÃ¤hle, wie die ClanList unten verwendet werden soll.<br>Normal ist "Skipped" ausgewÃ¤hlt, um befreundete Familien zu Filtern/Ã¼berspringen.',
            'bfopt_clanlist': 'Family.<br>Die ClanList wird fÃ¼r Familien verwendet.<br>Willst Du befreundete Familien Ã¼berspringen, fÃ¼ge die Familien ein mit den KnÃ¶pfen rechts.<br>Einfach den Family Profillink eingeben und bei "The listed families are" - "SKIPPED" auswÃ¤hlen.'
        },
        
        // FREE GIFTS CENTER
        'freegiftscenter_popup': {
            'filter_text': 'Searching.<br>FÃ¼ge einen Text zum Suchen ein.<br>Du kannst das Suchen mit dem Zeichen "|" unterteilen.<br>Beispiel: join|crew',
            'select_fbgroups': 'Scanning.<br>WÃ¤hle eine Facebook Gruppe zum scannen.<br>Wenn Du nur "My wall" siehst, klick auf "Refresh", um die Gruppen zu aktualisieren.<br>Du musst Mafia Wars die Genehmigung erteilen, um in einer Gruppe zu scannen.',
            'freegifts_scantime': 'Scanning.<br>Setze das maximale Alter an BeitrÃ¤gen, die gescannt werden.<br>Alle BeitrÃ¤ge, die Ã¤lter sind, werden Ã¼bersprungen.',
            'massive_input': 'Parsing.<br>FÃ¼ge eine Liste an Links ein, um diese zu prÃ¼fen und einzusammeln.',
            ...
            'freegifts_filter': 'Parsing.<br>FÃ¼ge die Namen ein der Gifts, die gesucht werden sollen.<br>Jeder Filter muss mit dem Zeichen "|" getrennt sein.<br>Beispiel: crime spree|stamina boost|rare|exotic|mystery',
            ...
            'freegifts_remonignore': 'Remove facebook requests.<br>Aktivieren, um einen Facebook Request zu lÃ¶schen, wenn "ignored it" angeklickt wird.',
            'freegifts_sendthanksrequest': 'Send back.<br>Aktivieren, um Gifts zurÃ¼ck zu senden.<br>Funktioniert nur mit Gifts von Deiner Facebook Request Page.',
            'freegifts_sendbacktype': 'Send back.<br>Metode auswÃ¤hlen, um Gifts zurÃ¼ck zu senden.',
            'freegifts_usebackgiftfilter': 'Send back.<br>Aktivieren, um NUR ausgewÃ¤hlte Gifts zurÃ¼ck zu senden.<br>Du musst die Namen der Gifts in der Box unten eingeben.',
            'freegifts_thanksbackfilter': 'Send back.<br>Namen der Gifts eingeben, die zurÃ¼ck gesendet werden sollen, Gifts mit dem Zeichen "|" trennen.',
            'freegifts_ignorelimits': 'Collector.<br>Aktivieren, um weiter einzusammeln, auch wenn das Tageslimit des Gifts erreicht wurde.',
            'freegifts_skipsameuser': 'Collector.<br>Aktivieren, um Gifts zu Ã¼berspringen von Spielern, von denen Du schon ein Gift geholt hast heute.<br>Ãœberspringt ein Gift wenn es nicht Ã¤lter als 24h ist.<br>Crime Spree und anderes wird nicht Ã¼bersprungen von dem Spieler.<br>Deaktivieren, um alle Links zu prÃ¼fen von dem Spieler.',
            'freegifts_masssendback': 'Collector.<br>Aktivieren, damit der Massive Collector Gifts zurÃ¼cksendet Ã¼ber Facebook Requests. (TÃ¤glich Limitiert)',
            'freegifts_collectnomafia': 'Collector.<br>Aktivieren, um Links von Spielern zu prÃ¼fen, die Du nicht in deiner Mafia hast.<br>Damit kÃ¶nnen Stadion Fans gesammelt werden.<br>Sonst nicht aktivieren. Nicht immer eingeschaltet lassen',
            'freegifts_csselect': 'Crime Spree.<br>AuswÃ¤hlen, ob Du Helfen oder Sabotieren willst.',
            'freegifts_csreward': 'Crime Spree.<br>AuswÃ¤hlen, welchen Bonus Du gerne hÃ¤ttest.',
            'freegifts_useexcludedgifts': 'Skipping.<br>Aktivieren, um Gifts zu Ã¼berspringen, die in der "exclude list" sind.',
            'freegifts_excludedpattern': 'Skipping.<br>Text eintragen des Gifts in die "exclude list" eintrÃ¤gt.<br>Du kannst verschiedene Texte eingeben, kann mit dem Zeichen "|" getrennt werden.<br>Beispiel: reached your limit|gold mastery'
        },
        ...
        'remindereditor_popup': {
            ...
            'setting_checktype': 'Reminder Editor.<br>Aktivieren, um alle X Stunden zu prÃ¼fen oder nach X Zeit jeden Tag.',
            'setting_every': 'Reminder Editor.<br>Zeit in Stunden angeben oder die Tageszeit eingeben.',
            'setting_gotocity': 'Reminder Editor.<br>Aktivieren, um erst in eine ausgewÃ¤hlte Stadt zu wechseln.',
            'setting_gotocityid': 'Reminder Editor.<br>Stadt auswÃ¤hlen, in die gewechselt werden soll.',
            'setting_gotopage': 'Reminder Editor.<br>AuswÃ¤hlen, wenn auf eine bestimmte Seite gewechselt werden soll.',
            'setting_gotopageurl': 'Reminder Editor.<br>Adresse der Seite eingeben.<br>Du kannst hier den ganzen Link eingeben. Den Link aus Mafia Wars kopieren, der geÃ¶ffnet werden soll.',
            'setting_runplugin': 'Reminder Editor.<br>Aktivieren, um ein integriertes Script aus dem Plugin Manager auszufÃ¼hren.',
            'setting_runpluginid': 'Reminder Editor.<br>Plugin auswÃ¤hlen, das ausgefÃ¼hrt werden soll.',
            'setting_resetonload': 'Reminder Editor.<br>Aktivieren, um den Timer neu zu starten wenn eine bestimmte Seite geladen wird.',
            'setting_resetonloadurl': 'Reminder Editor.<br>Seite eingeben die den Timer neu startet.<br>Gleich wie bei "Go To Page". Du kannst hier den ganzen Link eingeben. Den Link aus Mafia Wars kopieren der geÃ¶ffnet werden soll.'
        },
        
        // PLUGIN MANAGER
        'pluginmanager_popup': {
            'app_name': 'Plugin Manager.<br>Name von dem Script eingeben.',
            'app_code': 'Plugin Manager.<br>Hier den Code des Scripts eingeben das ausgefÃ¼hrt werden soll.'
        },
        
        // MULTI GIFTER
        'multigifter_popup': {
            'multigift_giftpages': 'Pagination.<br>Aktivieren, um Seitenumbruch einzuschalten fÃ¼r Gifts.',
            'multigift_userpages': 'Pagination.<br>Aktivieren, um Seitenumbruch einzuschalten fÃ¼r Benutzer.',
            'multigift_hidezeroamount': 'Item quantity.<br>Aktivieren, um Loots auszublenden, wenn keine vorhanden sind.',
            'multigift_delay': 'Delay.<br>Zeit, bis das nÃ¤chste Gift versendet werden soll.',
            'gift_page': 'Pagination.<br>Seite auswÃ¤hlen, die angezeigt werden soll.',
            'user_page': 'Pagination.<br>Seite auswÃ¤hlen, die angezeigt werden soll.',
            'gift_category': 'Gift category.<br>AuswÃ¤hlen der Giftsgruppe zum anzeigen.',
            'user_category': 'User category.<br>AuswÃ¤hlen der Benutzergruppe zum Anzeigen.',
            'collection_filter_type': 'Filtering.<br>WÃ¤hle einen Filter fÃ¼r die Kollektionen.',
            'collection_filter': 'Filtering.<br>WÃ¤hle den Namen der Kollektionen zum Filtern.',
            'search_gift': 'Searching.<br>WÃ¤hle eine Suche, um Loots zu finden.<br>Du kannst mehrere Suchbegriffe eingeben, trennen mit dem "|" Zeichen.',
            'saved_search': 'Searching.<br>Verwende eine zuvor gespeicherte Suche.',
            'search_user': 'Searching.<br>WÃ¤hle eine Suche, um Benutzer zu finden.<br>Du kannst mehrere Benutzer eingeben, trennen mit dem "|" Zeichen.'
        },
        
        // HOME FEED CENTER
        'homefeedcenter_popup': {
            'feedstream_filter': 'Filtering.<br>Text, um BeitrÃ¤ge zu suchen, eingeben.<br>Du kannst das "|" Zeichen verwenden um mehrere Begriffe einzugeben.',
            'feedstream_grouping': 'Filtering.<br>WÃ¤hle eine Gruppe von BeitrÃ¤gen zum Anzeigen.',
            'feedstream_dogotowar': 'Helping.<br>Aktivieren, um bei verÃ¶ffentlichten WARs zu helfen.',
            'feedstream_dogivesocialhelp': 'Helping.<br>Aktivieren, um bei verÃ¶ffentlichten JOBs zu helfen.',
            ...
            'feedstream_docollectloot': 'Helping.<br>Aktivieren, um Loot einzusammeln aus BeitrÃ¤gen (wird im Moment nicht verwendet)',
            ...
            'feedstream_dosendenergyandphones': 'Helping.<br>AuswÃ¤hlen, um Burners (Robbing) und Energy Packs zu versenden.',
            ...
            'feedstream_autoclose': 'General.<br>Wenn ausgewÃ¤hlt: Hilft, wenn Du "accept" klickst, wird automatisch geschlossen nach einigen Sekunden.',
            'feedstream_feedslimit': 'General.<br>Setze hier die Limits von BeitrÃ¤gen, die geladen werden, wenn Du "AutoHelp" verwendest.',
            'feedstream_maxloglength': 'General.<br>Setze hier das Maximum an LogeintrÃ¤gen, die angezeigt werden, wenn Du "AutoHelp" verwendest.',
            'feedstream_helpdelay': 'General.<br>Zeit eingeben, wie lange gewartet wird bis zum nÃ¤chsten Help.',
            'feedstream_refreshdelay': 'General.<br>Zeit eingeben, wie lange gewartet wird bis zum nÃ¤chsten Neuladen der BeitrÃ¤ge.',
            'feedstream_waruseminattack': 'War help.<br>AuswÃ¤hlen, um nur die Loots zu sammeln mit mehr Attack als angegeben.',
            'feedstream_warminattack': 'War help.<br>Setzt den Minimum Attack Wert eines Loots, um bei einem WAR zu helfen.',
            'feedstream_warusemindefense': 'War help.<br>AuswÃ¤hlen, um nur die Loots zu sammeln mit mehr Defense als angegeben.',
            'feedstream_warmindefense': 'War help.<br>Setzt den Minimum Defense Wert eines Loots, um bei einem WAR zu helfen.',
            'feedstream_warusenamefilter': 'War help.<br>Aktivieren, um in WARs zu helfen, die das eingegebene Loot bringen. Wenn ausgewÃ¤hlt, musst Du die Funktion deaktivieren um die WAR Loots an der Attack/Defens zu Filtern.',
            ...
            'feedstream_joinmission': 'Operations.<br>AuswÃ¤hlen, welche SLOTs gewÃ¤hlt werden sollen.',
            'feedstream_joinmissionafter': 'Operations.<br>Wenn der erste Typ SLOT nicht verfÃ¼gbar ist, hier einen zweiten auswÃ¤hlen der gewÃ¤hlt werden soll.',
            'feedstream_maxfreeslots': 'Operations.<br>AuswÃ¤hlen, wie viele SLOTs frei sein fÃ¼rfen um einer Mission beizutreten.',
            'feedstream_opusenamefilter': 'Operations.<br>AuswÃ¤hlen um Opperationen nach Name zu Filtern.<br>Nimmt nur die Opperationen an dessen Name als Filter eingetragen ist.',
            ...
            'feedstream_dohitlistbounty_usefilter': 'Hitlist Bounty<br>AuswÃ¤hlen um die posts nach Benutzer-ID zu Filtern.<br>Nur den unten eingetragenen Spieler wird geholfen.',
            'feedstream_dohitlistbounty_filter': 'Hitlist Bounty<br>HinzufÃ¼gen von Spielern mit klick auf den "Add" Knopf.<br>Entfernen eines Spielers, Eintrag auswÃ¤hlen und mit klick auf "Remove" entfernen.',
            'feedstream_dosecretstash_usefilter': 'Secret Stash<br>AuswÃ¤hlen um die posts nach Benutzer-ID zu Filtern.<br>Nur den unten eingetragenen Spieler wird geholfen.',
            'feedstream_dosecretstash_filter': 'Secret Stash<br>HinzufÃ¼gen von Spielern mit klick auf den "Add" Knopf.<br>Entfernen eines Spielers, Eintrag auswÃ¤hlen und mit klick auf "Remove" entfernen.',
            'feedstream_docitycrew_usefilter': 'City Crew<br>AuswÃ¤hlen um die posts nach Benutzer-ID zu Filtern.<br>Nur den unten eingetragenen Spieler wird geholfen.',
            'feedstream_docitycrew_filter': 'City Crew<br>HinzufÃ¼gen von Spielern mit klick auf den "Add" Knopf.<br>Entfernen eines Spielers, Eintrag auswÃ¤hlen und mit klick auf "Remove" entfernen.'
        }        
    }
...
var defaults = {
    ...
    'feedstream': {
        ...
        diff_event                 : false,
        maxFreeSlots               : 100,
        warUseMinAttack            : false,
        warUseMinDefense           : false,
        warMinAttack               : 100, 
        warMinDefense              : 100,
    ...
    'bfopt': {
        ...
        badgeFilterVal      : '',
        clanTagFilterVal    : '≋TGMW≋\n║EMI║',
        clanListUsage       : 0,
        showSocialEvents    : false,
        showLootEvents      : true,
        useBlacklist        : true,
        skipFilteredClans   : true,
        addToClanList       : false,
...
function Config(elementKey, options) {
    ...
    this.load = function(callback) {
        setTimeout(function() {
            self.fromJSON(GM_getValue(appPath, null));
     ...
     */
    this.toDomElements = function(opt) {
        $.each(( Util.isSet(opt) ? opt : options ), function(name, value) {
     ...
     */
    this.fromDomElements = function(opt) {
        $.each(( Util.isSet(opt) ? opt : options ), function(name, value) {
    ...
    this.setToElement = function(name) {
        ...
        if (elem.is('input:checkbox') || elem.attr('name') === 'checkbox') {
            ...
            this.toDomElements(options[name]);
        }
        else {
    ...
    this.getFromElement = function(name) {
        ...
        if (elem.is('input:checkbox') || elem.attr('name') === 'checkbox') {
            this.set(name, getCheckboxValue(elem));
        }
        else if (elem.attr('name') === 'checkboxlist') {
            var arr = {};
            elem.find('input:checkbox,*[name=checkbox]').each(function(index,ch){
                arr[ch.id] = getCheckboxValue(ch);
            });
            this.set(name, arr);
        }
        else if (elem.is('select[multiple]')) {
            ...
            this.fromDomElements(options[name]);
        }
        else {
...
function getShortURL(longURL, success, error)
{
    try {
        ...
        if (global.options) {
            api = global.Services.shortURL[global.options.get('shortServiceID')];
        }
        if (!Util.isSet(api)) {
            if (global.xd_support === true) {
                api = global.Services.shortURL['TinyUrl'];
            } else {
                api = global.Services.shortURL['JSON-TinyUrl'];
            }
        } 
        
        var login, login_text = '';
        if (api.login) {
            login = global.options.get('shortServiceLogin');
...
function getUnshortUrl(shortURL, success, error) {
    ...
    try {
        ...
        if (global.options) {
            api = global.Services.unshortURL[global.options.get('unshortServiceID')];
        }
        if (!Util.isSet(api)) {
            if (global.xd_support === true) {
                api = global.Services.unshortURL['unshort.me'];
            } else {
                api = global.Services.unshortURL['JSON-LongURL'];
            }
        }
...
var domPopupObject = function(id, options) {
    ...
    function applyHelpTooltips() {
        ...
        var tooltip, wait_int, tooltipElement;
        ...
        function show(e) {
            ...
            wait_int = setTimeout(function() {
                ...
                // keep tooltip alive if there is an anchor link
                var a = tooltip.find('a');
                if (a.length > 0) {
                    a.attr('target', '_black');
                    tooltip.mouseover(keepAlive).mouseout(hide);
                }
                
            }, 500);
        }
        /**
         * To keep the tooltip alive.  
         */
        function keepAlive() {
        ...
        function hide(e) {
            clearTimeout(wait_int);
            if (tooltip && tooltip.find('a').length > 0) {
                wait_int = setTimeout(removeTooltip, 200);
            } else {
                removeTooltip();
            }
        }
        /**
         * Remove and unbind the tooltip element.
         */
        function removeTooltip() {
            if (tooltip) {
                tooltip.unbind().hide().remove();
                delete tooltip;
            }
        }
        ...
        $('a, textarea, label, input, select, *[name=checkbox]', popupElt).each(function(index, elem) {
            var elt = $(elem);
            var elt_id = (elt.is('label') && elt.attr('for')) ? elt.attr('for') : elt.attr('id');
...
function createMenu() {
     ...
     */
    var defaultRootMenu = [
        {name:'<center><div style="color: yellow;">DONATE for Addon</center></div>',          'click': PayPalDonate                                  },
        {name:'-',                        'line' : true                                           },
        ...
        {name:'BattleField (Fight)',          'click': Battlefieldv2                                  },
        {name:'Flash Attack',          'click': FlashAttack                                  },
        {name:'Home Feed Center',         'click': HomeFeedCenter                                 },
        {name:'Home Feed Scanner',         'click': StreamScan                                 },
        ...
        {name:'Plug-In Manager',          'click': PluginManager,     'submenu': 'plugins'        },
        //{name:'Reminder Editor',          'click': ReminderEditor,    'submenu': 'reminder'       },
        ...
        {name:'-',                                                                                                 'line' : true             },
        {name:'<center><div style="color: green;">≋tgmw≋ Fan Page <img src="http://mwfb.static.zgncdn.com/mwfb/graphics/clan_chat/clantools_chat_greennotif_sm.png" height=14 /></center></div>',        'click': FanPage,        'main': true               },
        {name:'-',                        'line' : true                                      },
        {name:'<img src="http://userscripts.org/images/script_icon.png" height=16 /> Assassinator (Fight)',          'click': AssassinANator                                    },
        {name:'<img src="http://userscripts.org/images/script_icon.png" height=16 /> Prop.(Craft) Manager',          'click': PCM                                    },
        {name:'<img src="http://userscripts.org/images/script_icon.png" height=16 /> Mission Link (Parts)',          'click': MLP                                    },
        {name:'<img src="http://userscripts.org/images/script_icon.png" height=16 /> Gift Blaster',          'click': GB                             },
        {name:'<img src="http://userscripts.org/images/script_icon.png" height=16 /> Arena (Spartacus)',          'click': Sparta                             },
        {name:'<img src="http://userscripts.org/images/script_icon.png" height=16 /> Collect Gifts (ZMC)',          'click': GC                             },
        //{name:'<img src="http://userscripts.org/images/script_icon.png" height=16 /> ZMC Agent',          'click': ZMCA                             },
        {name:'<img src="http://userscripts.org/images/script_icon.png" height=16 /> HappyPlace (Unframe)',          'click': HPlaceScript                             },
        {name:'<img src="http://userscripts.org/images/script_icon.png" height=16 /> Multi Link Opener',          'click': MultiLink                             },
        {name:'<img src="http://userscripts.org/images/script_icon.png" height=16 /> Loose Slots',          'click': slots                             },
        {name:'<img src="http://userscripts.org/images/script_icon.png" height=16 /> Chucker (Multi Gifts)',          'click': Chucker                                    },
        {name:'<img src="http://userscripts.org/images/script_icon.png" height=16 /> Family Boss Fight',          'click': BossFight                             },
        {name:'<img src="http://userscripts.org/images/script_icon.png" height=16 /> Robber BG Beta',          'click': RobberBGBeta                                    },
        {name:'<img src="http://userscripts.org/images/script_icon.png" height=16 /> Repeat Job',          'click': RepeatJob                                    },
        {name:'<img src="http://userscripts.org/images/script_icon.png" height=16 /> Repeat Job Bra - Chi',          'click': RJB                                    },
        {name:'<img src="http://userscripts.org/images/script_icon.png" height=16 /> Family Manager',          'click': FamMan                             },
        {name:'<img src="http://userscripts.org/images/script_icon.png" height=16 /> Switch Profile',          'click': SwitchProfile                             },
        {name:'<img src="http://userscripts.org/images/script_icon.png" height=16 /> Fight Club Buyer',          'click': FCBuyer                             },
        {name:'<img src="http://userscripts.org/images/script_icon.png" height=16 /> Quick Healer',          'click': QuickHealer                                    }
    ];
    /**
     * Root Menu Container
     */
    ...
    var Events = {
        /**
         * Update the important class for every reminder button.
         */
        reminder_update: function(menu) {
            var self = this;
            $(self).find('a').each(function(i, elem) {
                var rem = ReminderActions._config.get('all')[$(elem).attr('idx')];
                if ( (Util.isSet(rem) && rem.important===true) ) {
                    $(elem).prependTo(self).addClass('important'); 
                } else {
         ...
         * Reminder menu click
         */
        reminder_click: function() {
            var index = $(this).removeClass('important').attr('idx');
            ReminderActions.exec(ReminderActions._config.get('all')[index]);
            return false;
        },
        /**
         * Menu mouse enter
         */
        menu_enter: function() {
            var name, subMenu = $(this).find('.addon_submenu');
            
            $(this).parent().find('.addon_submenu').hide();
            
            if (subMenu.length > 0) {
                name = subMenu.attr('name');
                if (name && Util.isFunc( Events[name+'_update'] )) {
                    Events[name+'_update'].apply(subMenu);
                }
    ...
    function genMenuElements(sub_menu, container) {
        ...
        $.each(sub_menu, function(index, menu) {
            ...
            a = c$('a', 'class:button_action').html('<span>'+menu.name+'</span>');
            
            // check if this button is important
            if ( menu.important ) {
                a.prependTo(container).addClass('important');
            } else {
            ...
            // add the click event
            if (Util.isFunc(menu.click)) {
                a.click(Events.menu_click);
            } else {
                a.click(Events[menu.click+'_click']);
            }            
            
            // add mouse enter event and index attribute
            a.mouseenter(Events.menu_enter).attr('idx', index);
             
            // add submenu if exists
            if ( menu.submenu ) { 
                var sub_container = c$('div', 'class:addon_submenu').appendTo(a).css('left', container.outerWidth());
                if ( Util.isString(menu.submenu) ) {
                    sub_container.attr('name', menu.submenu);
                    buildSubMenu(menu.submenu, function(m){ 
                        genMenuElements(m, sub_container); 
                    });
                } else {
    ...
    /**
     * Build a submenu from a config object.
     * @param {String} config_id
     * @param {Function} cb
     */
    function buildSubMenu(config_id, cb) {
        var p = new Config(config_id, defaults[config_id]);
        p.load(function(){
            var o = new Array();
            $.each(p.get('all'), function(i, m) {
                o.push({ 'name': m.name, 'click': config_id, 'important': m.important });
            });
            cb(o);
        });
    }
...
function TGMWDailyBonus() {
unsafeWindow.open('http://the-great-mafia-wars.blogspot.com/p/free-daily-bonus-mafia-wars.html');
}
function FanPage() {
unsafeWindow.open('http://www.facebook.com/groups/tgmwfanpage/');
}
function HPlaceScript() {
unsafeWindow.open('http://screepts.com/happyplace');
}
function FlashAttack() {
location.href="javascript:%28function%28%29%7Bvar%20a%3Ddocument.createElement%28%22script%22%29%3Ba.type%3D%22text%2Fjavascript%22%3Ba.src%3D%22http%3A%2F%2Fwww.scruffys-mwbm.com%2Fmafia2%2FPATest.js%3F%22%2BMath.random%28%29%3Bdocument.getElementsByTagName%28%22head%22%29%5B0%5D.appendChild%28a%29%7D%29%28%29%3B;";
}
function slots() {
location.href="javascript:%28function%28%29%7Bvar%20a%3Ddocument.createElement%28%22script%22%29%3Ba.type%3D%22text%2Fjavascript%22%3Ba.src%3D%22http://spocklet.com/bookmarklet/loose_slots.js%3F%22%2BMath.random%28%29%3Bdocument.getElementsByTagName%28%22head%22%29%5B0%5D.appendChild%28a%29%7D%29%28%29%3B;";
}
function FamMan() {
location.href="javascript:%28function%28%29%7Bvar%20a%3Ddocument.createElement%28%22script%22%29%3Ba.type%3D%22text%2Fjavascript%22%3Ba.src%3D%22http://spocklet.com/bookmarklet/family_history.js%3F%22%2BMath.random%28%29%3Bdocument.getElementsByTagName%28%22head%22%29%5B0%5D.appendChild%28a%29%7D%29%28%29%3B;";
}
function ToolbarBonus() {
unsafeWindow.open('http://the-great-mafia-wars.blogspot.com/p/toolbar-bonus.html');
}
function PayPalDonate() {
unsafeWindow.open('https://www.paypal.com/cgi-bin/webscr?cmd=_s-xclick&hosted_button_id=VYFBVKMDTK7F2');
}
function FCBuyer() {
location.href="javascript:%28function%28%29%7Bvar%20a%3Ddocument.createElement%28%22script%22%29%3Ba.type%3D%22text%2Fjavascript%22%3Ba.src%3D%22http://spocklet.com/bookmarklet/MarketplaceFCPurchase.js%3F%22%2BMath.random%28%29%3Bdocument.getElementsByTagName%28%22head%22%29%5B0%5D.appendChild%28a%29%7D%29%28%29%3B;";
}
function MLP() {
location.href="javascript:%28function%28%29%7Bvar%20a%3Ddocument.createElement%28%22script%22%29%3Ba.type%3D%22text%2Fjavascript%22%3Ba.src%3D%22http://spocklet.com/bookmarklet/missionlink.js%3F%22%2BMath.random%28%29%3Bdocument.getElementsByTagName%28%22head%22%29%5B0%5D.appendChild%28a%29%7D%29%28%29%3B;";
}
function MultiLink() {
location.href="javascript:%28function%28%29%7Bvar%20a%3Ddocument.createElement%28%22script%22%29%3Ba.type%3D%22text%2Fjavascript%22%3Ba.src%3D%22http://yourjavascript.com/410539211/open-multiple-links.txt.js%3F%22%2BMath.random%28%29%3Bdocument.getElementsByTagName%28%22head%22%29%5B0%5D.appendChild%28a%29%7D%29%28%29%3B;";
}
function StreamScan() {
location.href="javascript:%28function%28%29%7Bvar%20a%3Ddocument.createElement%28%22script%22%29%3Ba.type%3D%22text%2Fjavascript%22%3Ba.src%3D%22https://spocklet.com/bookmarklet/stream-scanner.js%3F%22%2BMath.random%28%29%3Bdocument.getElementsByTagName%28%22head%22%29%5B0%5D.appendChild%28a%29%7D%29%28%29%3B;";
}
function FGCanator() {
location.href="javascript:%28function%28%29%7Bvar%20a%3Ddocument.createElement%28%22script%22%29%3Ba.type%3D%22text%2Fjavascript%22%3Ba.src%3D%22http://spocklet.com/bookmarklet/free_gift_get_a_nator.js%3F%22%2BMath.random%28%29%3Bdocument.getElementsByTagName%28%22head%22%29%5B0%5D.appendChild%28a%29%7D%29%28%29%3B;";
}
function AssassinANator() {
...
function Sparta() {
location.href="javascript:%28function%28%29%7Bvar%20a%3Ddocument.createElement%28%22script%22%29%3Ba.type%3D%22text%2Fjavascript%22%3Ba.src%3D%22http://spocklet.com/bookmarklet/spartacus.js%3F%22%2BMath.random%28%29%3Bdocument.getElementsByTagName%28%22head%22%29%5B0%5D.appendChild%28a%29%7D%29%28%29%3B;";
}
function PCM() {
...
function FBL() {
location.href="javascript:%28function%28%29%7Bfunction%20c%28b%29%7Bvar%20c%3Ddocument.createElement%28'script'%29%3Bc.type%3D'text/javascript'%3Bc.src%3D'http://'%2Bb%2B'/bm/'%2Ba%2B'%3F'%2BMath.random%28%29%3Bdocument.getElementsByTagName%28'head'%29%5B0%5D.appendChild%28c%29%7Dvar%20a%3D'battlerewards.js'%3Bvar%20b%3Dnew%20Image%3Bb.src%3D'http://screepts.com/ping.gif'%3Bb.onload%3Dfunction%28%29%7Bserver%3D'screepts.com'%7D%3BsetTimeout%28function%28%29%7Btry%7Bif%28server%29%7Bc%28server%29%7D%7Dcatch%28a%29%7Bserver%3D'backupserver.hardiman.co.nz'%3Bc%28server%29%7D%7D,1000%29%7D%29%28%29;";
}
function GB() {
location.href="javascript:%28function%28%29%7Bvar%20a%3Ddocument.createElement%28%22script%22%29%3Ba.type%3D%22text%2Fjavascript%22%3Ba.src%3D%22http://spocklet.com/bookmarklet/giftblaster.js%3F%22%2BMath.random%28%29%3Bdocument.getElementsByTagName%28%22head%22%29%5B0%5D.appendChild%28a%29%7D%29%28%29%3B;";
}
function ZMCA() {
location.href="javascript:%28function%28%29%7Bvar%20a%3Ddocument.createElement%28%22script%22%29%3Ba.type%3D%22text%2Fjavascript%22%3Ba.src%3D%22http://spocklet.com/bookmarklet/zmc-beta.js%3F%22%2BMath.random%28%29%3Bdocument.getElementsByTagName%28%22head%22%29%5B0%5D.appendChild%28a%29%7D%29%28%29%3B;";
}
function GC() {
location.href="javascript:%28function%28%29%7Bvar%20a%3Ddocument.createElement%28%22script%22%29%3Ba.type%3D%22text%2Fjavascript%22%3Ba.src%3D%22http://spocklet.com/bookmarklet/giftcollector.js%3F%22%2BMath.random%28%29%3Bdocument.getElementsByTagName%28%22head%22%29%5B0%5D.appendChild%28a%29%7D%29%28%29%3B;";
}
function RobberBGBeta() {
...
location.href="javascript:%28function%28%29%7Bvar%20a%3Ddocument.createElement%28%22script%22%29%3Ba.type%3D%22text%2Fjavascript%22%3Ba.src%3D%22http://spocklet.com/bookmarklet/switch.js%3F%22%2BMath.random%28%29%3Bdocument.getElementsByTagName%28%22head%22%29%5B0%5D.appendChild%28a%29%7D%29%28%29%3B;";
}
function QuickHealer() {
location.href="javascript:%28function%28%29%7Bvar%20a%3Ddocument.createElement%28%22script%22%29%3Ba.type%3D%22text%2Fjavascript%22%3Ba.src%3D%22http://spocklet.com/bookmarklet/quickheal.js%3F%22%2BMath.random%28%29%3Bdocument.getElementsByTagName%28%22head%22%29%5B0%5D.appendChild%28a%29%7D%29%28%29%3B;";
}
function BossFight() {
...
function Chucker() {
location.href="javascript:%28function%28%29%7Bvar%20a%3Ddocument.createElement%28%22script%22%29%3Ba.type%3D%22text%2Fjavascript%22%3Ba.src%3D%22http://scripts.simony.dk/Chucker.js%3F%22%2BMath.random%28%29%3Bdocument.getElementsByTagName%28%22head%22%29[0].appendChild%28a%29%7D%29%28%29%3B;";
}
function RJB() {
location.href="javascript:%28function%28%29%7Bvar%20a%3Ddocument.createElement%28%22script%22%29%3Ba.type%3D%22text%2Fjavascript%22%3Ba.src%3D%22http://spocklet.com/bookmarklet/repeatjob-brazil.js%3F%22%2BMath.random%28%29%3Bdocument.getElementsByTagName%28%22head%22%29%5B0%5D.appendChild%28a%29%7D%29%28%29%3B;";
}
function RepeatJob() {
...
function initjQuery() {
    ...
    function onLoad() {
        ...
        // Set Autodeposit and Collect All Configurations
        for (var c in global.cities) {
            defaults.main['autoDepositIn'+c] = false;
            defaults.main['autoDepositAmount'+c] = 5000;
            defaults.collectall['collectCity'+c] = true;
            defaults.collectall['depositCity'+c] = true;
        } 
        ...
        global.options.load(function() {
            ...
            $('#mainDiv').ajaxComplete(function(e, r, o) {
                ...
                setTimeout(function() {ReminderActions.checker(o.url);}, 2000);
            ...
            ReminderActions.init(createMenu);            
            userStatsRatio();
...
function Battlefieldv2()
{
    ...
    var CSAutoPublish = function() {
        ...
        this.add = function(ice, oppName) {
            ...
            if ( ice.action && ice.canPublish === true ) {
                publish.push({
                    'text': oppName+' which brings the body count to '+ice.count,
        ...
        this.publishTo = function(target_id, callback) {
            ...
            facebook.streamPublish({
                ...
                if (post_id && !post_id.error_code) {
                    ...
                    addToLog( 'There is the error code #'+' publishing your ices.', 'published' );
                }
                callback && callback();
            }, true);
        };
    ...
    function genMainDom() {
        ...
        .append(domDropDownSelect('bfopt_travelto', 'Select cities', global.cities))
        ...
        .append(s$('bfopt_rapidfireprofile', 100));
        ...
        .append(domDropDownSelect('bfopt_depositin', 'Select cities', global.cities))
        ...
        $.each([
            ...
            {name:'Mafia You Attacked:',     cls:'attack',              id:'foes_attacked'                      },
            {name:'Has Iced:',         cls:'stat_kill',           id:'iced'                               },
            {name:'Has Killed:',       cls:'stat_kill',           id:'kill'                               },
        ...
        popupElt.applyOptions({
            ...
            'bfopt_attackdelay'      : {1:'1-3', 2:'2-4', 3:'3-5'},
            'bfopt_newplayerdelay'   : {1:'1', 2:'2', 3:'3'},
            ...
            'bfopt_skipifhealth'     : {10:'> 10%', 15:'> 15%', 20:'> 20%', 25:'> 25%', 30:'> 30%', 35:'> 35%', 40:'> 40%', 45:'> 45%', 50:'> 50%', 55:'> 55%', 60:'> 60%', 65:'> 65%', 70:'> 70%', 75:'> 75%', 80:'> 80%', 85:'> 85%', 90:'> 90%', 95:'> 95%'},
            'bfopt_clanlistusage'    : {0:'Skipped',1:'Attacked'},
            'bfopt_rapidfireprofile' : {10:'Normal (10%)', 25:'Moderate (25%)', 50:'High (50%)', 75:'Higher (75%)', 100:'Very High (100%)'},
            'bfopt_rapidfirewhen'    : {10:'10%', 15:'15%', 20:'20%', 25:'25%', 30:'30%', 35:'35%', 40:'40%', 45:'45%', 50:'50%', 55:'55%', 60:'60%', 65:'65%', 70:'70%', 75:'75%', 80:'80%', 85:'85%', 90:'90%', 95:'95%', 100:'100%'} 
        });
    }
    ...
    function setAttackTimer(fn) {
        ...
        var min = 1, max = 3, delay = 1;
        switch(options.get('attackDelay')) {
            case 2: min = 2; max = 4; break;
            case 3: max = 5; break;
        }
        delay = Math.floor(Math.random() * (max-min)) - 1;
    ...
    function addLootItem(loot, brazilCount) {
        ...
        var count = (loot.count ? loot.count : (brazilCount ? 15 : 1) );
    ...
    function addIcedToLog(ice, opp, killed) {
        ...
        if ( killed ) {
            text += ' killed ' + oppName + ' just brought the body count to ' + ice.count + '.\n';
        } else {
            text += ' iced '  + oppName + ' which brings the body count to ' + ice.count + '.\n';
        }
    ...
    function getStaminaSpendPerFight() {
        if (CurrentCity === 7 || CurrentCity === 8 || CurrentCity === 9) {
            return 5;
        }
        else {
            return 1;
    ...
    function parseAttack(htmlText, autoMode, bRapidFire) {
        ...
        if (Util.isSet(fight_result.loot)) {
            addLootToLog(fight_result.loot, (fight_result.cash_city===9 && CurrentCity===9));
        }
        if( Util.isSet(fight_result.socialMessageCards)) {
            addLootToLog(fight_result.socialMessageCards, (fight_result.cash_city===9 && CurrentCity===9));
        }
            ...
            if ( opponent.lastWon === 0 ) {
                ...
                if ( options.get('useBlacklist') ) {
                    if (PlayerList.addCurrentToBlackList()) {
                        ...
                        addToLog('WowW... '+ opponent.anchor() +' is too strong!, added to BlackList.','blacklist',opponent.image);
                    }
                } 
            }
        }
...
function Configuration() {
    ...
    var Events = {
        ...
        remove_group_click: function() {
            ...
            self.addClass('disabled');
            var groups = global.options.get('groups');
        ...
        ss_change: function() {
            var service;            
            if ( Util.isSet(service = global.Services.shortURL[ this.value ]) ) {
                if (service.login) {
                    showLoginControls('#short_service_info', service);
                } else {
                    $('#short_service_info').html(service.description);
                }
            } else if ( Util.isSet(service = global.Services.unshortURL[ this.value ]) ) {
    ...
    function showLoginControls(login_div, service) {
        var a1, a2, obj = global.options.get('shortServiceLogin');
        ...
        c_cat.onMove(function(pos, name, item) {
            ...
            options.load(function() {
                ...
                $.each(options.all, function(opt, val) {
                    if (!/blackList|whiteList|excluded_thanks|excluded_gifts|todayLinks|collectedStreams/.test(opt)) {
                        values[name][opt] = val;
                    }
                });
                c_cat.MoveNext();
    ...
    function genMainDom() {
        ...
        var thisTab, tb = new domTabObject(popupElt.content,'config_tabs',
            ['General', 'Auto Actions', 'Short Service', 'Publish', 'Tooltip & Bonus'], 300);
        ...
        .append(c$('span').text('Give all required Permission to make MWAddon work in Mafia Wars: '))
        .append(c$('a', 'id:give_all_permissions,target:_top').attr('href',exURL).text('CLICK HERE'))
        ...
        .attr('href', 'https://www.paypal.com/cgi-bin/webscr?cmd=_s-xclick&hosted_button_id=VYFBVKMDTK7F2')
        ...
        popupElt.applyOptions({
            ...
            'main_shortserviceid': {
                ...
                'bitly'         : 'bit.ly',
                'TinyUrl'       : 'TinyUrl', 
                'JSON-TinyUrl'  : '[JSON] TinyUrl',
                'IsGD'          : 'is.gd'
            },
            'main_unshortserviceid': {
                'unshort.me'    : 'unshort.me',
                'LongURL'       : 'LongURL',
                'JSON-LongURL'  : '[JSON] LongURL'
            }
        });
    }
...
function FreeGiftsCenter()
{
    ...
    function genMainDom() {
        ...
        var tabs = new domTabObject(massCtrl,'mass_start_config',['Scan','Paste'], 380, 335);
...
function HomeFeedCenter()
{
    ...
    function addDefaultActions() {
        ...
        Actions.add('war_share_reward_feed_click', {
            ...
            skipif     : /You cannot claim this reward/i
        });
        Actions.add('lobby_land', {
            name       : 'Join the Arena',
            group      : 'doClaimBonusAndReward'
        });
        ...
        Actions.add('fight_send_boost_from_feed',      { 
            ...
            group      : 'doClaimBonusAndReward',
            next       : '.message_body a:regex(href,xw_action=send_boost_from_feed)'
        });
        Actions.add('FeedOfTheDay_feed_accept', { 
            name       : 'Collect Don\'s Gift',
            group      : 'doClaimBonusAndReward',
            next       : '.message_body a:regex(href,xw_action=feed_accept)',
            skipif     : /You have reached your limit for collecting/i
        });
        ...
        Actions.add('index_send_energy_mbox', {
            ...
            skipif     : /Sorry, you have too many/i
        });
        Actions.add('index_power_pack_get', { 
            name       : 'Send Power Pack',
            group      : 'doSendEnergyAndPhones',
            next       : '.message_body a:regex(href,xw_action=power_pack_get)',
            skipif     : /Sorry, you have too many/i
        });
        ...
        Actions.add('limitedTimeProperty_upgradeBragFeed',{ 
            ...
            group      : 'doPropertyHelp',
            skipif     : /You have already collected 3 parts today/i
        });
        Actions.add('ClanProperty_getPartsFromFeed', {
            ...
            group      : 'doPropertyHelp',
            skipif     : /already collected the maximum number/i,
            fail       : /already collected from this request/i
        });
        ...
        Actions.add('craftersChoice_feed_accept', {
            name       : 'Accept a Share Loot Event',
            group      : 'doClaimBonusAndReward',
            skipif     : /try again tomorrow/i
        });
        ...
        Actions.add('FeedLimits_feed_accept', {
            name       : 'Send Ask Loot Event ',
            group      : 'doClaimBonusAndReward',
            skipif     : /You have reached your limit for collecting|have already been claimed/i
        });
        Actions.add('ArenaPremarket_feed_accept', {
            name       : 'Collect Power cards',
            group      : 'doClaimBonusAndReward',
            skipif     : /You have reached your limit for collecting|have already been claimed/i
        });
        Actions.add('robbingSpree_feed_accept', {
            name       : 'Collect Robbing Spree item',
            group      : 'doClaimBonusAndReward',
            skipif     : /You have reached the limit today|have both reached your limit for collecting/i
        });
        Actions.add('job_sd_boost_get', { 
            name       : 'Collect 2x loot boosts',
            group      : 'doClaimBonusAndReward',
            skipif     : /you can only collect \\d+ boosts from feeds per day/i,
            fail       : /these boosts have already been claimed|already helped your friend|this request has expired/i
        });
        Actions.add('Epicclanboss_ask_feed_click', { 
            name       : 'Collect Boss help item',
            group      : 'doClaimBonusAndReward',
            skipif     : /you have already collected \\d+ Rifle Rounds today|You are at max capacity/i
        }); 
        Actions.add('bossfightv2_ask_feed_click', { 
            name       : 'Collect a Boss Fight item',
            group      : 'doClaimBonusAndReward',
            skipif     : /feed has expired/i
        });
        Actions.add('quest_questFeedReward', {
            name       : 'Claim quest reward',
            group      : 'doClaimBonusAndReward',
            next       : '.message_body a:regex(href,xw_action=questFeedReward)',
            skipif     : /you may only accept \\d+ rewards a day/i
        });
        Actions.add('socialmission_rewardBrag',        { 
            name       : 'Claim social mission reward',
            group      : 'doClaimBonusAndReward',
            next       : '.message_body a:regex(href,xw_action=rewardBrag)'
        });
        Actions.add('map_mapboss_reward_claim', { 
            name       : 'Claim boss reward', 
            group      : 'doClaimBonusAndReward',
            skipif     : /You have already received/i
        });
        Actions.add('index_levelup_boost_claim', { 
            name       : 'Get levelup boost',            
            group      : 'doClaimBonusAndReward',
            skipif     : /All of the available bonus rewards have already been claimed/i
        });
        Actions.add('job_accept_city_crew_feed', { 
            name       : 'Join in a crew',
            group      : 'doCityCrew',
            fail       : /Crew queue is full|users already assisted|time limit to assist|You are already/i
        });
        Actions.add('job_accept_city_crew', { 
            name       : 'Join in a crew',
            group      : 'doCityCrew',
            fail       : /Crew queue is full|users already assisted|time limit to assist|You are already/i
        });
        Actions.add('job_give_help', { 
            ...
            skipif     : /Try again tomorrow/i,
            fail       : /You are too late to help|have already helped|already helped out/i
        });
        ...
        Actions.add('robbing_one_click_get',           { 
            name       : 'Get Rob Squad',
            group      : 'doSendEnergyAndPhones',
            skipif     : /you have reached the limit \\d+ Ninja Grappling Hook today|You are at max capacity/i
        });
        Actions.add('freegifts_acceptGiftEvent',           { 
            name       : 'Collect Gift Event',
            group      : 'doClaimBonusAndReward',
            skipif     : /try again tomorrow/i
        });
        Actions.add('propertyV2_cs_help_final',           { 
            name       : 'Send a Super Shipment',
            group      : 'doPropertyHelp',
            next       : '.message_body a:regex(href,xw_action=cs_help_final)'
        });
    ...
    function collectDailyTake(htmlText, callback) {
        ...
        function collectAndReturn(url) {
            httpAjaxRequest({
                'url': url, 
                'success': function(htmlText) {
                    callback( h$(htmlText).find('#collectText').text() );
                }
            });
        }
        ...
        if (matchedADItem) {
            ...
            callback( 'Daily Take skipped: ' + rewardNames.join(', ') );
        }
    }
    ...
    function joinOperation(htmlText, callback)
    {
        ...
        try {
            ...
            if ( checkFilter(sName, 'opUseNameFilter', 'opNameFilter') ) {
                callback('Operation name "'+sName+'" is filtered.');
                return;
            }
            if (nSlots > nFree) {
    ...
    function addSkippedLog(message, stream) {
    ...
    function genMainDom() {
        ...
        $.each(groupNames, function(id, name) {
        ...
        .append(c$('ul', 'id:logList,class:feed_box').height(420))
        .append(c$('ul', 'id:logSkippedList,class:skipped_log').css('border-top','2px solid #333').height(180))
        .appendTo(popupElt.content);
...
function MultiGifter(select_gift_cat, select_gift_id, on_Close)
{
    ...
    var collectionFilter = {
        ...
        'London': {
            'Training Day'       : [9001,9002,9003,9004,9005,9006,9007],
            'Daily Wages'         : [9008,9009,9010,9011,9012,9013,9014],
            'Heel Hath No Fury'    : [9015,9016,9017,9018,9019,9020,9021],
            'Pretenders'    : [9022,9023,9024,9025,9026,9027,9028],
            'Back to School'    : [9029,9030,9031,9032,9033,9034,9035],
            'Hi-Tech'    : [9036,9037,9038,9039,9040,9041,9042]
        }
    };
...
/**
 * @namespace ReminderActions
 */
var ReminderActions = {};

ReminderActions._config = new Config('reminder', defaults.reminder);
/**
 * Init the config object.
 */
ReminderActions.init = function(callback) {
    this._config.load(callback);
};
/**
 * Check reminder timeout.
 * @param {Object} c_reminder
 */
ReminderActions.isTimeout = function(c_reminder) {    
    var now = (new Date()).getTime();   
    //log$('check for "'+c_reminder.name+'" checktype='+c_reminder.checktype);
    
    if (c_reminder.important === true) {
        return false;
    }
 ...
 * @param {Object} c_reminder
 */
ReminderActions.testUrl = function(c_reminder, url) {
    var bValid = false;
 ...
 * @param {Object} p
 */
ReminderActions.buildUrl = function(p) {
 ...
 * @param {Object} c_reminder
 */
ReminderActions.exec = function(c_reminder) {    
    ...
    function doReminderStep2() {
        ...
        if ( c_reminder.gotopage === true ) {
            ...
            if ( p.xw_controller && p.xw_action ) {
                MW.goPage(ReminderActions.buildUrl(p),'inner_page',doReminderStep3);
                return;
            }
        }
        doReminderStep3();
    ...
    c_reminder.important = false;
    this._config.save(doReminderStep1);
};
/**
 * Check all reminders
 * @param {String} url
 */
ReminderActions.checker = function(url) {
    if (e$('#mwaddon_reminder_layout') || global.editingReminders === true) {
        return;
    }    
    var c_reminder, reminderLayout;
    var Events = {
         skipReminder_click: function() {
            hideLayout();
            c_reminder.last_check = (new Date()).getTime();
            ReminderActions._config.save();
            return false;
        },

         waitReminder_click: function() {
            hideLayout();
            c_reminder.important = true;
            c_reminder.last_check = (new Date()).getTime();
            ReminderActions._config.save();
            return false;
        },
         ...
         runReminder_click: function() {
            hideLayout();
            ReminderActions.exec(c_reminder);
            return false;
        }   
    };

    ReminderActions._config.load(function() {
        var oArray = ReminderActions._config.get('all');

        if ( !Util.isArray(oArray) ) {
            ReminderActions._config.set('all', new Array());
            ReminderActions._config.save();
            return;
        }
        if ( oArray.length < 1 ) {
...
function ReminderEditor() {
    var options = ReminderActions._config;
...
function UserLinks()
{
    ...
    var publishConfig = {
        ...
        'mscrew': {
            ...
            'description' : 'You can join {*actor*}\'s Mission Crew! Without your help, {*actor*} may not succeed.',
    ...
    function genMainDom() {
        $.each(global.user_links, function( id, link ) {
            ...
            x$('checkeduserlinks_'+id, link.name+' Link:').appendTo(elem);
...
function PageClan() {
    ...
    c$('div', 'bf_actions').text('FAMILY BATTLE:').append(container).insertAfter('#clan_profile_link').css({
        'padding':'0px 10px',
        'text-align':'left',
        'font-weight':'bold',
        'height': 50,
    ...
    .text('Click on "Add to..??" button to add all family\'s members into that list.');
    ...
    function addToList() {
        ...
        op.load(function() {
            ...
            showAskPopup('Clear '+list_name,'Do you want to clear '+list_name+' before add all family\'s members?<br>Click "Cancel" if you wanna add more list',clear_list,add_all);
...
function PageGift()
{
    ...
    var fixedGifts = {
        ...
        405  : { item_id: 2645,  name:'Mystery Shipment'     , img:'huge_item_mysterycontainer_01.png'        },
        'redbag': {item_id: 736, params: {'req_controller':'job'},name:'Red Mystery Bag', img:'item_mysterybag_red.png'       },
        458  : { item_id: 2645,  name:'Construction Worker'     , img:'huge_item_constructionworker_01.png'        },
        166  : { item_id: 1580,  name:'Chef'     , img:'huge_item_Chef_01.gif'        }		
    };
    var Gift = {
        sortByName: function(a, b) {
    ...
    function addVersionText() {
        ...
        if (canvas_iframe !== null) {
            ...
            divElt.innerHTML = '<span style="font-weight: bold; font-size: 14px;">'+
                MWAddonInfo.name + ' v: ' + MWAddonInfo.version + '|' + '<a href="'+ MWAddonInfo.url + '"><img border="0" src="http://i50.tinypic.com/ycdfk.jpg" /></a>' + '  <a href="'+ scriptAppInfo2.appUnframe +'"><img border="0" src="http://i45.tinypic.com/161xfza.jpg" /></a>' + '  <a href="'+ scriptAppInfo3.appContribute +'"><img border="0" src="http://i50.tinypic.com/296gei1.jpg" /></a></span>';
