...
// @require 	   http://sizzlemctwizzle.com/updater.php?id=85623&uso
// @version 	   1.3
// @include        *.geocaching.com/seek/cache_details.aspx?guid=*
// @include	   *.geocaching.com/seek/cache_details.aspx?wp=*
...
for(var i=0;i<allStyles.snapshotLength; i++){
	...
	if(CS == 'white' || CS == '#ffffff' || CS == 'rgb(255, 255, 255)'){
		found = true;
