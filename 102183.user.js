...
// @description     Script for The-West: TW Pro+ [SOM - Scripts-O-Maniacs] [Multilingual] (v2.0.1.4)
...
var twpro_version = "2.0.1.4";

var url = window.location.href;
if (url.indexOf(".thewest.") != -1) {
...
var url = window.location.href;
if (url.indexOf(".thewest.") != -1 && url.indexOf("game.php") != -1) {
...
//if ((window.location.href.indexOf('.thewest.') != -1 || window.location.href.indexOf('tw.innogames.net') != -1) && window.location.href.indexOf('game') != -1) {
	/*
