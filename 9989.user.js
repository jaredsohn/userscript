// ==UserScript==
// @name            taz_archiv_content
// @namespace       Platypus
// @include         *#taz-archiv
// @description     Teil eines Gesamtprojektes zum Veraendern von taz.de. Durch die zugehoerigen Scripte wird taz.de entschlackt und zugleich umfangreich erweitert. Beschreibungen aller Scripte und Screenshots sind unter http://schmiertatze.blogspot.com verfuegbar.
// ==/UserScript==
do_modify_html_it(window.document,document.evaluate('/HTML[1]/BODY[1]/FORM[1]/DIV[4]/DIV[2]', document, null, XPathResult.FIRST_ORDERED_NODE_TYPE,null).singleNodeValue,/<span class="mark">/gi,'',null);
function do_platypus_script() {
do_modify_html_it(window.document,document.evaluate('/HTML[1]/BODY[1]/FORM[1]/DIV[4]/DIV[2]', document, null, XPathResult.FIRST_ORDERED_NODE_TYPE,null).singleNodeValue,/href="([^"]+)"/gi,'href="$1#taz-archiv"',null);
isolate(window.document,document.evaluate('/HTML[1]/BODY[1]/FORM[1]/DIV[4]/DIV[2]', document, null, XPathResult.FIRST_ORDERED_NODE_TYPE,null).singleNodeValue,null,null,null);
erase_it(window.document,document.evaluate('/HTML[1]/BODY[1]/DIV[1]/DIV[1]/P[2]', document, null, XPathResult.FIRST_ORDERED_NODE_TYPE,null).singleNodeValue,null,null,null);
erase_it(window.document,document.evaluate('/HTML[1]/BODY[1]/DIV[1]/DIV[1]/P[3]', document, null, XPathResult.FIRST_ORDERED_NODE_TYPE,null).singleNodeValue,null,null,null);
erase_it(window.document,document.evaluate('/HTML[1]/BODY[1]/DIV[1]/DIV[1]/DIV[1]/TABLE[1]', document, null, XPathResult.FIRST_ORDERED_NODE_TYPE,null).singleNodeValue,null,null,null);
erase_it(window.document,document.evaluate('/HTML[1]/BODY[1]/DIV[1]/DIV[1]/DIV[1]', document, null, XPathResult.FIRST_ORDERED_NODE_TYPE,null).singleNodeValue,null,null,null);
set_style_script(window.document,document.evaluate('/HTML[1]/BODY[1]/DIV[1]/DIV[1]', document, null, XPathResult.FIRST_ORDERED_NODE_TYPE,null).singleNodeValue,"width: 445px;",null,null);
