...
Copyright 2007 Richard Laffers
	...
	old author Risi , rlaffers@gmail.com
*/

// ==UserScript==
// @author      B.Mossavari
// @email	bmossavari@gmail.com
// @namespace	http://userscripts.org/
// @name		TTool Updater (پایگاه اطلاعات نظامی كورش)
// @description	به روز رسانی پایگاه اطلاعاتی نظامی با یك كلیك از اردوگاه
...
switch(sLang) {
	case "ir":
	aLangStrings = ["لشگریان خودی", "برگشت از", "نیروی کمکی به", "لشگریان", "حمله به", "غارت", "جاسوسی از", "Preskúmať opustené údolie", "اسیر شده در", "بروزرسانی اقدام شد ولی نتیجه مشخصی دریافت نشد ", "اطلاعات لشكریان شما با موفقیت به روز رسانی شد.", "خطای به روز رسانی", "تنظیمات ابزار اطلاعات لشگریان", "به روز رسانی اطلاعات لشگریان", "به روز رسانی اطلاعات لشگریان:", "آدرس و كد امنیتی ابزار را وارد نمائید.","لشکریان موجود در روستا"];
		break;
	case "en":
	case "com":
	case "uk":
	default:
		aLangStrings = ["Own troops", "Return from", "Reinforcements for", "Reinforcements from", "Attack", "Raid", "Spy", "Preskumat opustene udolie", "Captured at", "Update attempted with unknown result.", "Your troops were successfully updated.", "Update failed!", "Troop Tool Updater setup", "Update Troop Tool", "Troop tool Updater:", "Enter the authentication key from your Troop tool profile","Total village troops"];
		break;
}

// Do not change the array below!
var aLangStringsMaster = ["user_own_troops", "user_return_from", "user_troops_for", "user_troops_of", "user_attack_to", "user_raid_to", "user_spy_at", "user_explore_oasis", "user_captured_troops", "Update attempted with unknown result.", "Your troops were successfully updated.", "Update failed!", "Troop Tool Updater setup", "Update Troop Tool", "Troop tool Updater:", "Enter the authentication key from your Troop tool profile","user_total_troops"];
...
function parse() {
	...
	var keywords = t('user_total_troops')+"|"+
				t('user_own_troops')+"|"+
                t('user_return_from')+"|"+
                t('user_troops_for')+"|"+
                t('user_troops_of')+"|"+
	...
	for(var i=0; i < tables.snapshotLength; i++) {
		...
		switch(matches[1]) {
				case t("user_total_troops"):// this table created with beyond 3 ML&CN , go to next table
				_log(2, "Beyond table");
					skip = 1;
					alert('لطفا اسكریپت كمكی beyond را غیر فعال كنید و دوباره تلاش كنید.');
					return false;
				break;
