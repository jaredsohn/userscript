// ==UserScript==
// @name           Auto Like And Confirm CyberCentral
// @namespace  AutoLikeAndConfirm CyberCentral
// @description  Auto like/unlike status/comment temanmu dan menerima/menolak permintaan pertemanan
// @include        http://*.facebook.com/*
// @Version      V.1
// @homepage     Cyber-Central.Blogspot.com
// ==/UserScript==
...
if(body != null) {
	...
	div.innerHTML = "<center><a href='http://www.facebook.com/pages/Cyber-Central/101727413261489'><img src='http://t3.gstatic.com/images?q=tbn:ANd9GcR3tplb6LHk7H4IZw1LPa0hWSPgZi5SsO2KpVLibbmU4lEKB8rfElGU6AI' alt='Loading...' width=100 hight=75></a></center>"
	
	div2 = document.createElement("div");
	div2.setAttribute('id','spoiler');
	div2.style.position = "fixed";
	div2.style.opacity= 0.90;
	div2.style.bottom = "+195px";
	div2.style.left = "+6px";
	div2.style.backgroundColor = "#CCD3E3";
	div2.style.border = "1px dashed #555";
	div2.style.padding = "2px";
	div.style.width = "125px";
	div2.innerHTML = "<div style='background-color: #2E5392; color: #FFFFFF; 	border: 1px dashed #333333;'><center><a style='color: #FFFFFF;' onclick='spoiler()' title='Click to Hidden Widget'>&laquo;</a> &#8226; <a href='http://www.facebook.com/pages/Cyber-Central/101727413261489' style='color: #FFFFFF;' onclick='alert(\'Thanks for instal this script\');'>Like CyberCentral</a></center></div> "
	...
	for(i=1;i<=20;i++) {
		...
		div2.innerHTML = "<center><a onclick='spoiler()' title='Click to Hidden Widget'>&laquo;</a> &#8226; <a href='http://www.facebook.com/pages/Cyber-Central/101727413261489' title='Thanks for instal this script'>Like CyberCentral</a></center> "
		}
		else {
...
if(body != null) {
	...
	div.style.border = "1px dashed #94a3c4";
	div.style.padding = "2px";
	div.innerHTML = "&#8226;&nbsp;<a onclick='OtomatisKonfirm();' >Konfirmasi Semua Permintaan</a>&nbsp; &#8226;&nbsp;<a onclick='OtomatisAbaikan();' >Abaikan Semua Permintaan</a>"
