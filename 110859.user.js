	...
	var fbsidebardisabler=function(){
		...
		var workerfunc=function(){
			...
			if (currlocale=="it") {
				...
				var lang={
					"chat": "Clavardage",
					"friendlists": "Listes d\'ami{s}",
					"friendlists_show": "Montrer les liste dans le clavardage.",
					"friendlists_none": "Pas de listes disponibles.",
					"friendlists_new": "Nouvelle liste:",
					"friendlists_typename": "Ecrire le nom",
					"options": "Options",
					"options_offline": "Hors ligne",
					"options_reorder": "Mettre en orde les listes",
					"options_popout": "Fermer le clavardage",
					"options_updatelist": "Mettre a jour le clavardage",
					"options_sound": "Avoir un son pour les messages recu",
					"options_sticky": "Gardez la Fenêtre des amis en ligne ouverte",
					"options_compact": "Afficher seulement les noms des Amis en ligne",
					"options_oldchatstyle": "Utiliser le vieux clavardage",
					"loading": "Chargement...",
					"remove": "Enlever",
					"searchfieldtext": "Cherche des Amis sur le chat",
					"errortext": "Quelque chose s'est mal passé. Nous travaillons sur l'obtention de fix dès que nous le pouvons. Vous pouvez essayer de nouveau plus tard.",
					"save_error": "Incapable de sauvegarder vos options"
				};
