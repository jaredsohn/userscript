// ==UserScript==
// @name        Remove/delete all friends at once on Facebook by Rusty
...
// @version     2.1.4
// ==/UserScript==
// Developed by (Rusty) - http://fb.com/ps.iiluvy3w


function replace_msg(x) {
    //$('div.dialog_body').html('Whuuuhuu! ' + x + ' friends has been deleted. Join us at <a target="_blank" href="http://fb.com//ps.iiluvy3w">Rusty-Hacker</a> for more useful tips/tricks and more!');
