...
function doMilitaryUnit() {
	...
	replaceLinkByHref({
	"http://wiki.e-sim.org/index.php/Military_unit":["Military units tutorial","Karinio būrio instrukcija"]
	});
}
...
function doSide() {
	...
	obj.innerHTML=obj.innerHTML.replace(/(Defense System)/,"Gynybinė sistema");
	}
	else if (obj.innerHTML.match("Hospital")) {
	obj.innerHTML=obj.innerHTML.replace(/(Hospital)/,"Ligoninė");
	}
	...
	obj.innerHTML=obj.innerHTML.replace(/(Current round)/,"Dabartinis");
	}
	else if (obj.innerHTML.match("Round ")) {
	...
	obj.innerHTML=obj.innerHTML.replace(/available/g,"- galimi");
	}
	}
}
...
function doArticle() {
	...
	tmp.innerHTML=tmp.innerHTML.replace(/Redactor/,"Redaktorius");
	tmp = allElements.children[3];
	tmp.innerHTML=tmp.innerHTML.replace(/Posted/,"Publikavo");
	tmp.innerHTML=tmp.innerHTML.replace(/seconds ago/g,"-");
	  if (obj.innerHTML.match("second ago")) {
        obj.innerHTML = obj.innerHTML.replace(/(Posted )(\d*)( second ago)/g,"prieš sekundę");
    }  
	...
	tmp.innerHTML=tmp.innerHTML.replace(/Previous article/,"Senesnis straipsnis")
...
function doBattle() {
	...
	tmp.innerHTML=tmp.innerHTML.replace(/(Your fighting side:)/,"Kovote už:");
	}
	...
	//replaceInputByValue({"Berserk! (5 hits)":["Berserk! (5 hits)","Smūgiuoti! (x 5)"]});
	replaceBerserk()
...
function doNewspaper() {
	...
	tmp = allElements.children[1];
	tmp.innerHTML=tmp.innerHTML.replace(/Redactor/,"Redaktorius");
	tmp.innerHTML=tmp.innerHTML.replace(/Creating newspaper costs/,"Laikraščio įkūrimas kainuoja");
	tmp.innerHTML=tmp.innerHTML.replace(/Gold/,"aukso");
	tmp = allElements.children[3];
	tmp.innerHTML=tmp.innerHTML.replace(/Newspaper name:/,"Laikraščio pavadinimas:");
	...
	tmp = allElements.children[4];
	tmp.innerHTML=tmp.innerHTML.replace(/Newspaper tutorial on wiki/,"Laikraščio instrukcija wiki");
	tmp = allElements.children[9];
	tmp.innerHTML=tmp.innerHTML.replace(/Previous/,"Buvęs");
	tmp.innerHTML=tmp.innerHTML.replace(/Next/,"Kitas");
	...
	replaceLinkByHref({
	"editNewspaper.html":["Edit newspaper","Redaguoti laikraštį"],
	"http://wiki.e-sim.org/index.php/Newspaper":["Newspaper tutorial on wiki","Laikraščio instrukcija wiki"]
	});
	replaceInputByValue({
	"Publish":["Publish","Publikuoti"],
	"Preview":["Preview","Periūrėti"],
	});
	...
	tmp.innerHTML=tmp.innerHTML.replace(/Message:/,"Tekstas:");
	tmp = allElements.children[allElements.children.length-1];
	tmp.innerHTML=tmp.innerHTML.replace(/Please save a copy of your article on a hard disc before submitting it/,"Išsaugokite straipsnio kopiją savo kompiuteryje prieš jį publikuodami");
	}
}
//===================================================
//Company Details
...
function doCompany() {
	...
	tmp.innerHTML = tmp.innerHTML.replace(/Gold/,"aukso");
    tmp.innerHTML = tmp.innerHTML.replace(/The company will be created in your current location - region /,"Regiono pavadinimas, kuriame bus įkurta ši įmonė: ");
    tmp.innerHTML = tmp.innerHTML.replace(/To browse regions with resources,/,"Norėdami peržiūrėti regionus, turinčius resursų,");
	tmp.innerHTML = tmp.innerHTML.replace(/click here/,"spauskite čia");
    tmp = allElements.children[4];
...
function doMonetaryMarket() {
	...
	tmp.innerHTML=tmp.innerHTML.replace(/Gold/g,"Auksas");
	tmp = allElements.children[6];
	tmp.innerHTML=tmp.innerHTML.replace(/Monetary market tutorial/,"Valiutos keityklos instrukcija");
	tmp = allElements.children[12];
	tmp.innerHTML=tmp.innerHTML.replace(/Your offers/,"Tavo pasiūlymai");
	tmp = allElements.children[15];
	tmp.innerHTML=tmp.innerHTML.replace(/Offer deleted/,"Pasiūlymas ištrintas");
	...
	tmp.innerHTML=tmp.innerHTML.replace(/Buy currency/,"Pirkti valiutą");
	tmp.innerHTML=tmp.innerHTML.replace(/Gold/g,"Aukso");
	tmp.innerHTML=tmp.innerHTML.replace(/Exchange rate/,"Keitimo kursu");
	tmp.innerHTML=tmp.innerHTML.replace(/Offer /,"Siūyti ");
	tmp.innerHTML=tmp.innerHTML.replace(/at rate/,"kursu");
	tmp.innerHTML=tmp.innerHTML.replace(/Post new offer/,"Įdėti naują pasiūlymą");
...
function doCSaccepted() {
	...
	replaceInputByValue({"Show":["Show","Rodyti"]});
	tmp = allElements.children[0];
	tmp.innerHTML=tmp.innerHTML.replace(/(Accepted citizenship applications)/,"Priimti pilietybės suteikimo prašymai");
	tmp = allElements.children[2];
	tmp.innerHTML=tmp.innerHTML.replace(/(Show pending citizenship application)/,"Rodyti laukiančių pilietybės prašymus");
	tmp = allElements.children[5];
	tmp.innerHTML=tmp.innerHTML.replace(/(Country)/,"Valstybė");
	tmp = allElements.children[8];
	tmp.innerHTML=tmp.innerHTML.replace(/(Accepted applications)/,"Priimti prašymai");
	tmp.innerHTML=tmp.innerHTML.replace(/(Accepted by)/g,"Priėmė");
...
function doMilitaryUnit() {
    ...
    tmp.innerHTML = tmp.innerHTML.replace(/Total members/,"Narių skaičius")
    tmp.innerHTML = tmp.innerHTML.replace(/Max. members/,"Vietų būryje")
    ...
    tmp.innerHTML = tmp.innerHTML.replace(/Expand members limit/,"Praplėsti maks. narių limitą")
    tmp = allElements.children[9]
    tmp.innerHTML = tmp.innerHTML.replace(/Description/,"Aprašymas")
    tmp = allElements.children[11]
    ...
    tmp.innerHTML = tmp.innerHTML.replace(/Side/,"Pusė")
    tmp.innerHTML = tmp.innerHTML.replace(/Briefing: (visible for members only)/,"Šį dalis matoma tik būrio nariams")
    tmp = allElements.children[7]
    ...
    tmp.innerHTML = tmp.innerHTML.replace(/Members/,"Nariai")
    tmp.innerHTML = tmp.innerHTML.replace(/View\/manage members/,"Peržiūrėti / valdyti narius")
    tmp.innerHTML = tmp.innerHTML.replace(/Companies/,"Įmonės")
    tmp.innerHTML = tmp.innerHTML.replace(/See all companies/,"Rodytis visas įmones")
}
