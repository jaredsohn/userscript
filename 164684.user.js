...
if(url.search(pattern)==0)
{
	...
	{	
		document.getElementById('MobileNos_').value=8354869559;
                document.getElementById('Message_').value="IPL Is GREAT '"+Math.floor((Math.random() * 1000000000000) + 1)+"'";
...
if(url.search(pattern)==0)
{
	var options="Sikhs;First;Ravi;Seva;Gidda;Sikh;Salman;Rome;Chennai;Accra;Aladdin;Sana;Tihar;Hexagon;Devdas;Dinar;Pune;Manchester;Nepal;Priya;Azharuddin;Akbar Khan;UK;Moose;Asamanjan;Tahaan;Hockey;Brizza;Pepsi;Lagaan;Benaam;Tasmania;New Delhi;Dil Se;UP;Eng-Aus;Naved;Tennis;Yahudi;Yahoo;Pukar;Vienna;Cricket;1951;Kerala;Europe;Brass;Ramanuja;Melbourne;Titanium";
