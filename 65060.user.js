...
// @description		Automatisch anmeldet, um das Spiel menelgame/pennergame/mendigogame/clodogame/serserionline 
// @version		3.3
// @author		mikskape
...
GM_registerMenuCommand("Setzen Sie Ihr Login und Passwort", function(){
GM_deleteValue("memail");
GM_deleteValue("mpass");
alert("Ihr Benutzername und Passwort wurden entfernt!");
});
...
if(email == "" || pass == "") {
GM_setValue("memail", prompt("Geben Sie Ihren Benutzernamen:"));
GM_setValue("mpass",  prompt("Geben Sie Ihr Kennwort:"));
...
if(email == "" || pass == "") {
GM_setValue("mesemail", prompt("Geben Sie Ihren Benutzernamen:"));
GM_setValue("mespass",  prompt("Geben Sie Ihr Kennwort:"));
...
GM_setValue("pemail", prompt("Geben Sie Ihren Benutzernamen:"));
GM_setValue("ppass",  prompt("Geben Sie Ihr Kennwort:"));
confirmation();
}
...
if(email == "" || pass == "") {
GM_setValue("cemail", prompt("Geben Sie Ihren Benutzernamen:"));
GM_setValue("cpass",  prompt("Geben Sie Ihr Kennwort:"));
...
if(email == "" || pass == "") {
GM_setValue("semail", prompt("Geben Sie Ihren Benutzernamen:"));
GM_setValue("spass",  prompt("Geben Sie Ihr Kennwort:"));
