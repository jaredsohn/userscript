// ==UserScript==
// @name            Space-Explore IP Warning Remove
// @namespace       crysis992
// @include         http://uni1.space-explore.de/*
// ==/UserScript==
function do_platypus_script() {
remove_it(window.document,document.evaluate('/HTML[1]/BODY[1]/CENTER[2]/CENTER[1]/TABLE[1]/TBODY[1]/TR[1]/TD[2]/BLINK[1]/FONT[1]', document, null, XPathResult.FIRST_ORDERED_NODE_TYPE,null).singleNodeValue,null,null,null);
remove_it(window.document,document.evaluate('/HTML[1]/BODY[1]/CENTER[2]/CENTER[1]/TABLE[1]/TBODY[1]/TR[1]/TD[1]/BLINK[1]/FONT[1]', document, null, XPathResult.FIRST_ORDERED_NODE_TYPE,null).singleNodeValue,null,null,null);
