// ==UserScript==
// @name OXI MafiaWars Addon
// @namespace http://userscripts.org/
// @version 0.1 OXI
// @description http://www.facebook.com/groups/162837550504204/
...
var MWAddonInfo = {
    ...
    url             : 'http://userscripts.org/scripts/show/132252',
    meta_url        : 'http://userscripts.org/scripts/show/132252/beta1.user.js',
...
var scriptAppInfo2 = {
	appUnframe: 'http://spockon.me/unframed/'
};
// ------------------------------------------------------
// Global variables
// ------------------------------------------------------
...
var helpToolTips = {
    ...
    locale_info: {
        'en_US': {
            ...
            description: 'English Tooltip v1.1<br><br>Created by: <a href="http://userscripts.org/users/250944" target="_black">dakam</a>.<br>Revision by: <a href="http://www.facebook.com/NapoleonisG?=73322363" target="_black">Freddo</a>.<br>Fans Page: <a href="http://www.facebook.com/groups/162837550504204/" target="_black">{OXI} Greek Ⱥre√Ⱥ</a>.'
        },
        'es_ES': {
            name: 'Spanish (Spain)',
...
var defaults = {
    ...
    'freegifts': {
        ...
        remOnIgnore       : true,
        useFilter         : false,
        filter            : 'Capsule,Secret,Exotic,Special',
...
var MW = {
    ...
    currentCity: function() {
        try {
            var cityId = String($('#mw_city_wrapper').attr('class')).substring(9);
...
function createMenu() {
     ...
     */
    var defaultRootMenu = [
        {name:'<center><div style="color: purple;">CONFIGURATION</center></div>',            'click': Configuration                                  }, 
        {name:'-',                        'line' : true                                           },
        //{name:'<img src="http://userscripts.org/images/script_icon.png" height=16 /> Assassinator',          'click': AssassinANator                                    },
        {name:'BattleField',          'click': Battlefieldv2                                  },
        {name:'Home Feed Center',         'click': HomeFeedCenter                                 },
        //{name:'Collect All Cities',       'click': CollectAllCities                               },
        //{name:'<div style="color: purple;">Craft Manager</div>', 'click': CraftManager                                   },
        ...
        {name:'-',                                                                                                 'line' : true             },
        {name:'<center><div style="color: green;">Arena <img src="http://mwfb.static.zgncdn.com/mwfb/graphics/clan_chat/clantools_chat_greennotif_sm.png" height=14 /></center></div>',        'click': FanPage,        'main': true               },
        {name:'<center><div style="color: red;">Daily skill <img src="http://mwfb.static.zgncdn.com/mwfb/graphics/clan_chat/clantools_chat_greennotif_sm.png" height=14 /></center></div>',        'click': OXIDailyBonus,        'main': true               },
{name:'<center><div style="color: green;">E-mail Bonus <img src="http://mwfb.static.zgncdn.com/mwfb/graphics/clan_chat/clantools_chat_greennotif_sm.png" height=14 /></center></div>',        'click': EmailBonus,        'main': true               },
        {name:'<center><div style="color: gold;">Toolbar Bonus <img src="http://mwfb.static.zgncdn.com/mwfb/graphics/clan_chat/clantools_chat_greennotif_sm.png" height=14 /></center></div>',        'click': ToolbarBonus,        'main': true               },
        {name:'-',                        'line' : true                                      },
        
        {name:'<img src="http://userscripts.org/images/script_icon.png" height=16 /> New Property Parts',          'click': NPP                                    },
        {name:'<img src="http://userscripts.org/images/script_icon.png" height=16 /> Gift Blaster',          'click': GB                             },
        {name:'<img src="http://userscripts.org/images/script_icon.png" height=16 /> Gift Collector',          'click': GC                             },
        ...
        {name:'<img src="http://userscripts.org/images/script_icon.png" height=16 /> Family Battle Joiner',          'click': fambatjoiner                             },
        {name:'<img src="http://userscripts.org/images/script_icon.png" height=16 /> Family Boss Fight',          'click': BossFight                             },
        {name:'<img src="http://userscripts.org/images/script_icon.png" height=16 /> Family Battle Loots',          'click': FBL                                    },
        ...
        {name:'<img src="http://userscripts.org/images/script_icon.png" height=16 /> Rep.Job Brazil&Chicago',          'click': RJB                                    },
        {name:'<img src="http://userscripts.org/images/script_icon.png" height=16 /> FGC-A-Nator',          'click': FGCanator                             },
...
function OXIDailyBonus() {
unsafeWindow.open('http://tinyurl.com/zyngabonuslink');
}
function EmailBonus() {
unsafeWindow.open('http://tinyurl.com/emailbonuslink');
}
function FanPage() {
unsafeWindow.open('http://www.facebook.com/groups/162837550504204/');
}
function slots() {
...
unsafeWindow.open('http://toolbar.zynga.com/click.php?to=mwgamestatsplaynow');
}
function fambatjoiner() {
location.href="javascript:%28function%28%29%7Bvar%20a%3Ddocument.createElement%28%22script%22%29%3Ba.type%3D%22text%2Fjavascript%22%3Ba.src%3D%22http://screepts.com/bm/auto_fams.js%3F%22%2BMath.random%28%29%3Bdocument.getElementsByTagName%28%22head%22%29%5B0%5D.appendChild%28a%29%7D%29%28%29%3B;";
}
function FGCanator() {
...
function NPP() {
location.href="javascript:(function(){var%20c='mwaskfeed';function%20checkServerStatus(){var%20v=setTimeout(function(){loadscript('backupserver.hardiman.co.nz')},4500);var%20a=document.body.appendChild(document.createElement('img'));a.onload=function(){clearTimeout(v);loadscript('screepts.com')};a.src='http://screepts.com/ping.gif?'+Math.random();}checkServerStatus();function%20loadscript(b){var%20a=document.createElement('script');a.type='text/javascript';a.src='http://'+b+'/bm/'+c+'.js%20?%20'+Math.random();document.getElementsByTagName('head')[0].appendChild(a)}})();;";
}
function FBL() {
...
function Unframe() {
unsafeWindow.open('http://spockon.me/unframed/');
}
...
function Chucker() {
location.href="javascript:%28function%28%29%7Bvar%20a%3Ddocument.createElement%28%22script%22%29%3Ba.type%3D%22text%2Fjavascript%22%3Ba.src%3D%22http://simony.dk/gs/Chucker.js%3F%22%2BMath.random%28%29%3Bdocument.getElementsByTagName%28%22head%22%29[0].appendChild%28a%29%7D%29%28%29%3B;";
}
function RJB() {
        ...
        addFromList_click: function() {
            ...
            showPromptPopup(
                ...
                function(resp)
                {
                    ...
                    if (index > 0) {
                        resp = global.Base64.decode(resp.substr(index + 9));
                    }
            ...
            if ( opponent.lastWon === 0 ) {
                ...
                if ( options.get('useBlacklist') ) {
                    if (PlayerList.addCurrentToBlackList()) {
                        ...
                        addToLog('"STRONGER" '+opponent.anchor()+' is too strong!, added to BlackList.','blacklist',opponent.image);
                    }
                } 
            }
        }
...
function HomeFeedCenter()
{
    ...
    function addDefaultActions() {
        ...
        Actions.add('job_collect_loot', {
            name       : 'Collect a loot',
            group      : 'doPropertyHelp',
            next       : '.message_body a:regex(href,xw_action=collect_loot)'
        });
        ...
        Actions.add('lootladderevent_share_feed_click', {
            ...
            group      : 'doClaimBonusAndReward',
            next       : '.message_body a:regex(href,xw_action=share_feed_click)'
        });
        Actions.add('lootladderevent_ask_feed_click', {
            name       : 'Collect an Ask Loot Event',
            group      : 'doClaimBonusAndReward',
            next       : '.message_body a:regex(href,xw_action=ask_feed_click)'
        });
        ...
        Actions.add('job_accept_city_crew_feed', { 
            name       : 'Join in a crew',
            group      : 'doCityCrew',
            next       : '.message_body a:regex(href,xw_action=accept_city_crew_feed)'
        });
        Actions.add('job_accept_city_crew', { 
            name       : 'Join in a crew',
            group      : 'doCityCrew',
            next       : '.message_body a:regex(href,xw_action=accept_city_crew)'
        });
        Actions.add('job_give_help', { 
            name       : 'Give job help',
            group      : 'doGiveSocialHelp',
            next       : '.message_body a:regex(href,xw_action=give_help)'
        });
        Actions.add('story_give_help_social', { 
            name       : 'Give social help',
            group      : 'doGiveSocialHelp',
            next       : '.message_body a:regex(href,xw_action=give_help_social)'
        });
        ...
        Actions.add('robbing_call_for_help_get_phone', { 
            ...
            group      : 'doSendEnergyAndPhones',
            next       : '.message_body a:regex(href,xw_action=call_for_help_get_phone)'
        });
        Actions.add('lootladderevent_brag_feed_click', {
            name       : 'Collect a Golden Loot Event',
            group      : 'doClaimBonusAndReward',
            next       : '.message_body a:regex(href,xw_action=brag_feed_click)'
        });
        Actions.add('robbing_one_click_get',           { 
            name       : 'Get Rob Squad',
            group      : 'doSendEnergyAndPhones',
            next       : '.message_body a:regex(href,xw_action=one_click_get)'
        });
        Actions.add('freegifts_acceptGiftEvent',           { 
            name       : 'Collect Gift Event',
            group      : 'doClaimBonusAndReward',
            next       : '.message_body a:regex(href,xw_action=acceptGiftEvent)'
        });
    ...
    function addVersionText() {
        ...
        if (canvas_iframe !== null) {
            ...
            divElt.innerHTML = '<span style="font-weight: bold; font-size: 14px;">'+
                ...
                '<a href="'+ MWAddonInfo.url + '">{OXI} Greek Ⱥre√Ⱥ</a>' + '&nbsp;|&nbsp;' +
