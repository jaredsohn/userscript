// ==UserScript==
// @name			Facebook Bom Like v3.2 2014 final
// @namespace		Facebook Bom Like v3.2 2014 final
// @description		AutoLike Facebook re-coded by wira. Auto Like status, wall and facebook comments system uses delay timer that allows you to control the speed of access and prevents blocking of the account.
// @author			Nahman Khayet re-coded by wira
// @authorURL		http://www.facebook.com/wira95
...
}
{
  ...
  div.style.position="fixed";
    ...
    div.style.border="1px solid #6B84B4";
    div.style.padding="3px";
    div.innerHTML="<a style='font-weight:bold;color:#E30505' href='http://www.wira-7.com' target='_blank' title='Buka Situs di Tab Baru' ><blink><center>Wira-7 Site</center></blink></a>";body.appendChild(div)}body=document.body;if(body!=null)
