// ==UserScript==
// @name            Language pack - Sample - Romanian
...
twpro_lp_custom = {
	info: ['TDR', 'mailto:denis.tdr@gmail.com', 4343, '.w1.'],     /*['Your name', 'http://your_url OR mailto:your_email', char_id (the character_id can be seen in your browser status bar by pointing your name on the ranking pages), '.fr1.w1.en12.de3. (the subdomain(s) of the world(s) you play. Each subdomain must be always preceded AND followed by a dot)']. Email/url and char_id+worlds are optional. If you mention your email/url address, other players will be able to see it on worlds you don't play. If you mention your char_id & world subdomains, other players will be able to open your InGame profile on worlds you play. Just leave these parameters blank if you don't want to use them.*/
		...
		SORTBYNAME: 'Ordonati dupa <b>nume</b>',     /*"Order activity list by name" button at the Inventory*/
		SORTBYXP: 'Ordonati dupa <b>experienta</b>',     /*"Order activity list by experience" button at the Inventory*/
		SORTBYWAGES: 'Ordonati dupa <b>salariu</b>',     /*"Order activity list by wages" button at the Inventory*/
		SORTBYLUCK: 'Ordonati dupa <b>noroc</b>',     /*"Order activity list by luck" button at the Inventory*/
		...
		SORTBYDANGER: 'Ordonati dupa <b>pericol</b>',     /*"Order activity list by danger" button at the Inventory*/
		SORTBYLABORP: 'Ordonati dupa <b>punctele de munca</b>',     /*"Order activity list by labor points" button at the Inventory*/
		...
		REGENERATION: ' \u25B7 Regenerare Puncte de viata',     /*A special activity, useful when you are low on Health points and want to restore your health points faster*/
		...
		USEFULITEM: 'Acest numar indica cate iteme sunt luate in calcul',     /*Displayed between parentheses after a set name in the TW Pro Config screen*/
		PERCREGENERATION: 'Regenerare',     /*__ % Regeneration with Sleepyhead items*/
		LUCK: 'noroc',     /*__ % luck with Holiday set items*/
		PRAYING: 'praying',     /*6 Sleepyhead items gives +1 Praying*/
		NOITEMSETS: "Nu ai niciun item din acest set",     /*Displayed in the vertical Set filters*/
		AVERAGEDAMAGE: "Daune medii",     /*Displayed on every weapons*/
		PREFERENCES: "Preferinte",     /*This text is shown as a tab in the TW Pro settings window*/
		DEFAULTSORTING: " \u25B7 Ordonare normala",     /*Visible in the "Preferences" tab.*/
		FBHEALTHPRIORITY: "Prioritate puncte de viata",     /*Visible in the "Preferences" tab.*/
		FBHEALTHPRIORITYZERO: "Deloc",     /*Visible in the "Preferences" tab. Applies to the "Health points priority" menu.*/
		FBHEALTHPRIORITYLOW: "Putin",     /*Visible in the "Preferences" tab. Applies to the "Health points priority" menu.*/
		FBHEALTHPRIORITYMEDIUM: "Mediu",     /*Visible in the "Preferences" tab. Applies to the "Health points priority" menu.*/
		FBHEALTHPRIORITYHIGH: "Ridicat",     /*Visible in the "Preferences" tab. Applies to the "Health points priority" menu.*/
		FBHEALTHPRIORITYAUTO: "Automat",     /*Visible in the "Preferences" tab. Applies to the "Health points priority" menu.*/
		...
		DMGAVG: "Medie",     /*Abbreviation for Average. Refers to the average damage of a weapon. Visible on weapon popups.*/
		CHATWHISPER: "* Soapta *\n\nIntrordu numele unui jucator",     /*Visible when clicking the corresponding button in the Chat box.*/
		CHATCOLOR: "* Culoare personalizata (000-999) *\n\nIntrodu codul unei culori",     /*Visible when clicking the corresponding button in the Chat box.*/
		USEFULITEMS : "Arata fiecare item care este folositor pentru munca activa",     /*Visible near the backpack. Displayed when calculations has been run and none activity is selected.*/
		USEFULITEMSPOPUP : " \u25B7 Inventar | Arata obiectele cu detalii",     /*Visible in the "Preferences" tab. Applies to the special box that highlights useful items.*/
		USEFULITEMSPOPUPDESC : "Bonusurile pentru munca vor fi afisate pe fiecare item folositor (acest proces dureaza putin mai mult).",     /*Popup visible in the "Preferences" tab. Applies to the special box that highlights useful items.*/
		SHOWALLJOBS : " \u25B7 Arata toate muncile pe harta",     /*Visible in the "Preferences" tab.*/
		SHOWALLJOBSDESC : "Va fi activat dupa refresh (F5)",     /*Popup visible in the "Preferences" tab.*/
		COLLECTORMODE : " \u25B7 Modul Colector",     /*Visible in the "Preferences" tab.*/
		COLLECTORMODEDESC : "Obiectele de la negustor vor fi marcate cu albastru daca nu le ai deja..",     /*Popup visible in the "Preferences" tab.*/
		HELP : "Ajutor",     /*Visible in the "Preferences" tab.*/
