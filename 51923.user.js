// ==UserScript==
// @name           Jokerbux Auto Click
// @namespace      http://userscripts.org/users/95765
// @description    Auto Click Ads On Bux.to. Auto relads after 2-4mins if no ads are present. By Fenixto
// @include        http://*jokerbux.com/index.php?option=surf
// @include        http://*jokerbux.com/index.php
// @include        http://*jokerbux.com/view.php?ad=*
// @copyright      Fenixto
// @version        2.6.0
// ==/UserScript==
...
// Switch to index.php?option=surf if you just logged in
...
function main() {
ad_wait_time = 25 + Math.ceil(Math.random()*5);
foundAd = false;
