...
// @namespace      http://trukz.com
		// @description    Adds 5 MPH to the default speed set by Trukz when en route. This also adds blinking text next to the fuel price if it is below $2. 
...
/*
     ...
     Miles To Go support added by Jeoh. 
*/		
...
var fuelCost;
var fatiguePoints;
// look for the speed limits, miles to go and fuel numbers
...
if(ENABLE_ADD_SPEED)
{
  ...
  if (topWeatherSpeed <= speedLimit && topWeatherSpeed <= topTruckSpeed) newSpeed = (topWeatherSpeed + ADD_SPEED);
