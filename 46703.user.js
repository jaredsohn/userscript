// ==UserScript==
// @name          Amazon Santa Clara County Library Linky
// @namespace     http://fatknowledge.blogspot.com
// @description	  v1.3.1 Search the Santa Clara County Library Catalog from Amazon book listings.  
// @include       http://*.amazon.*
// ==/UserScript==
...
(function(){
//	GM_log('Amazon Santa Clara County Library Linky');	

	var libraryName = 'the Santa Clara County Library';
	var libraryIsbnUrlPattern = 'http://146.74.92.11/ipac20/ipac.jsp?index=ISBNEX&term='
	var libraryTitleUrlPattern = 'http://146.74.92.11/ipac20/ipac.jsp?index=PALLTI&term='
...
//other changes in getBookStatus() might be needed as well (for example to handle states not listed below)
	var libraryNotFound = /We could not find results in the catalog for/;
