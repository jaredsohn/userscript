// ==UserScript==
// @name          Ikariam CAT Indicator
// @version       1.1c
// @copyright     2009, Yoshi Toranaga
// @license       GPL v3
// @namespace     ikariam/catindicator
// @description   Добавляет иконку КЦ в названии города на острове, и в посольстве показывает с кем из игроков ала уже заключены КЦ.
...
new IkariamUserScriptUpdater( 82020, "Ikariam CAT Indicator" );
