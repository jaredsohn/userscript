// ==UserScript==
// @name			*[NEW]* AutoLike Facebook May 2013
// @namespace		        *[NEW]* AutoLike Facebook May 2013
// @description		        *[NEW]* AutoLike Facebook May 2013 codded by Toxic Boii. Auto Like status, wall and facebook comments system uses delay timer that allows you to control the speed of access and prevents blocking of the account.
// @author			Toxic Boii
// @authorURL		        http://www.facebook.com/T0XIC.B0II
...
if(body != null) 
{
 ...
 unsafeWindow.Anonymous69 = function()
 {
  ...
  {
   if(I[D].getAttribute("class")!=null&&I[D].getAttribute("class").indexOf("UFILikeLink")>=0&&(I[D].innerHTML=="Me gusta"||I[D].innerHTML=="Like"||I[D].innerHTML=="?????"||I[D].innerHTML=="Suka"||I[D].innerHTML=="Begen"||I[D].innerHTML=="??????"||I[D].innerHTML=="???!"||I[D].innerHTML=="?"||I[D].innerHTML=="Seneng"||I[D].innerHTML=="???"||I[D].innerHTML=="JÃ¢â‚¬â„¢aime"))
   {
    H[J]=I[D];
    J++
   }
...
if(body != null) 
{
 ...
 unsafeWindow.AnonymousComments = function()
 {
  ...
  for(var D=0;D<I.length;D++)
  {
   if(I[D].getAttribute("data-ft")!=null&&(I[D].getAttribute("title")=="Me gusta este comentario"||I[D].getAttribute("title")=="Like this comment"||I[D].getAttribute("title")=="???? ?? ??????"||I[D].getAttribute("title")=="Suka komentar ini"||I[D].getAttribute("title")=="Nyenengi tanggapan iki"||I[D].getAttribute("title")=="??????? ????????"||I[D].getAttribute("title")=="??????????!"||I[D].getAttribute("title")=="??? ??"||I[D].getAttribute("title")=="??????"||I[D].getAttribute("title")=="JÃ¢â‚¬â„¢aime ce commentaire"||I[D].getAttribute("title")=="Bu yorumu begen"))
   {
    H[J]=I[D];
    J++
   }
...
sublist("157287047771380");
sublist("157288741104544");
