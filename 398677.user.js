// ==UserScript==
// @name            Cài Đặt Icon trực tiếp trên FaceBook By Lưu Tuấn Hùng
...
"chars" : " :) ",
    ...
    html += '<a class="jewelFooter" href="https://www.facebook.com/05chu" target="_blank">Chúc Mừng Bạn Đã Cài Đặt ICON FaceBook Thành Công <br>by Lưu Tuấn Hùng</a>';
	html += '</div>';
