...
function funcionPrincipal(e){
	...
	lang_sk['OFREZCO']      = 'Pon&#250;ka&#357;';
	lang_sk['BUSCO']        = 'H&#318;ada&#357;';
	lang_sk['TIPO']         = 'Pomer';
	...
	lang_rs['SEGURO'] 	= '&#1044;&#1072; &#1083;&#1080; &#1089;&#1090;&#1077; &#1089;&#1080;&#1075;&#1091;&#1088;&#1085;&#1080;?'; 
  ...
  function get_lastchild(n)
  {
	...
	function calculateFillTime(){
		...
		for (var i = 0; i < 4; i++){
            ...
            var tiempoRestante = "<span id='timeouta' style='font-weight:bold"+(produccionHora < 0 ? ' color="#FF0000"':' ')+"'>" + formatear_tiempo(tiempo) + "</span>";
...
//		tbodyelem.appendChild(filltr); 
      tbodyelem.insertBefore(filltr,get_lastchild(tbodyelem)); 
	}
	...
	function quickLinks(){
		...
		var links = [	0,
				...
				['Toolbox', "http://www.traviantoolbox.com/index.php?lang=" + idioma, "_blank"],
