...
try  {
	...
	$jq(document).ready(function () {
		...
		try {
			...
			if (meta.view.contains("profile/comments/id/")){
				userid = meta.view.replace("/profile/comments/id/","").split("/")[ 0 ];
				$jq("ul.tabs").prepend("<li > <a id='previous' href='/profile/comments/id/"+(parseInt(userid, 10)-1)+"' > "+loca.getLocaString("label/previous")+"</a > </li > ");
				$jq("ul.tabs").append("<li > <a id='next' href='/profile/comments/id/"+(parseInt(userid, 10)+1)+"' > "+loca.getLocaString("label/next")+"</a > </li > ");
