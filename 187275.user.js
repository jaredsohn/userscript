// troll Blocking script
// −−−−−−−−−−−−−−−−−−−−−−−−−−−−−−−−−−−−−−−−−−−−−−−−−−−−−−−−−−−−−−−−−−−−
// ==UserScript==
// @name blog.hu troll blocker
// @namespace bloghuTB
// @description Block trolls from  blog.hu
...
//
//--CONFIG-------------------------------------
//bUserName  = GM_setValue('bUserName', 'H:Jn 16.33|S:Hátrányos helyzetű kaviár');
...
function redisplayquote() {
  var chd = this.getElementsByTagName('span');
  for (var i=0; i<chd.length; i++) {
...
function hideCommentsOf(UserName) {
  ...
  elements2 = document.getElementsByTagName('span');
  for (var i = 0; i < elements2.length; i++) {
     if (elements2[i].className.search('commentAuthor') != -1) {
       if (elements2[i].innerHTML.search(UserName) != -1 ) {
          ppp  = elements2[i].parentNode.parentNode;
	  ...
	  paci.style.color="#bbbbbb";
	  paci.style.background="#ffffff";
	  paci.style.fontSize='8px';
      paci.style.padding='5px';
...
function generateButtons() {
  ...
  for (var i = 0; i < elements2.length; i++) {
     if (elements2[i].className.search('commentAuthor') != -1) {
       ...
       blockingButtonsPanel = '<div style="cursor:pointer; float:right; font-size:6px;">'+' '+nameOfAuthor+
                                '<span class="HB'+nameOfAuthor+'" id="HB'+i+'" style="background:#ff6060; padding:2px;">HB</span> '+
                                '<span class="SB'+nameOfAuthor+'" id="SB'+i+'" style="background:#ffff30; padding:2px">SB</span> '+
                                '<span class="UB'+nameOfAuthor+'" id="UB'+i+'" style="background:#60ff60; padding:2px;">UB</span> '+
                              '</div>'
