...
// @namespace https://ultra.trophymanager.com
...
// @userscripts                 http://userscripts.org/scripts/show/184484        
// @grant                        none
// ==/UserScript==
...
function get_player_info_history(player_id,show_non_pro_graphs){
        $.ajaxSetup({async: false});
        $.post("https://ultra.trophymanager.com/ajax/players_get_info.ajax.php",{"player_id":player_id, "type":"history","show_non_pro_graphs":show_non_pro_graphs},function(data){
                if(data != null){        
...
function get_player_info_hidden_skills(player_id){
        $.ajaxSetup({async: false});
        $.get(
    "https://ultra.trophymanager.com/players/"+player_id+"/",
...
function get_player_info_scout(player_id, player_fp,show_non_pro_graphs){
                                ...
                                $.ajaxSetup({async: false});
                        $.post("https://ultra.trophymanager.com/ajax/players_get_info.ajax.php",{"player_id":player_id, "type":"scout","show_non_pro_graphs":show_non_pro_graphs},function(data){
...
function get_player_info_graphs(player_id,show_non_pro_graphs){
                                ...
                                $.ajaxSetup({async: false});
                        $.post("https://ultra.trophymanager.com/ajax/players_get_info.ajax.php",{"player_id":player_id, "type":"graphs","show_non_pro_graphs":show_non_pro_graphs},function(data){
                                if(data != null)
                                {
        ...
        document.calculateSkillDefPlay = function(positionX, skills) {
                ...
                if(positionIndex != 13){ // is not goalkeeper is defender
                        ...
                        //calculo de potencial para estilo de finalizacao
                        ...
                        //para diferentes posicoes diferentes pesos
                        }
