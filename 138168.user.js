// ==UserScript==
// @name            Paramilitary
// @namespace       http://userscripts.org/scripts/show/137168
// @author          MAREV!!! (customized by NO CARRIER)
// @version         3.1a
// @uso:version     3.1a
...
if(location.href.match(/http:\/\/www.erepublik.com\/.+\/military\/battlefield/)) {
	...
	var FORM_URL = "https://docs.google.com/spreadsheet/viewform?formkey=dEZFZG10R1dDUU5sdnRfUUhsczlvbmc6MQ";
	...
	function BattlePage() {
		...
		var fieldsMap = {
			...
			time: "entry.7.single",
			strength: "entry.8.single",
			rank: "entry.9.single",
			division: "entry.10.single",
