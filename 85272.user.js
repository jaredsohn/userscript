...
div.innerHTML += '<br/><b><a href="http://forums.d2jsp.org/forum.php?f=104"' + 
	...
	switch(resolveBettorType(user)){
		...
		case 'welcherpaidback':
			div.innerHTML += '<font color="fuchsia"><b>Late Payback</b></font>';
			break;
		case 'trusted':
		...
		case 'blacklist':
			...
			break;
		case 'regular':
			div.innerHTML += '<font color="orange"><b>Regular</b></font>';
			break;
		case 'unknown':
			div.innerHTML += '<font color="gray"><b>?</b></font>';
			break;
		case 'unknown':
			div.innerHTML += '<font color="fuchsia"><b>Late-Pay</b></font>';
			break;
	}
	div.innerHTML += '</b>';
};
...
function getNames(){
	...
	{
	    method: 'GET',
	    url: 'http://pokahustla2.angelfire.com/',
	    headers: 
		{
