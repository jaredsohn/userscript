...
(function () {
   ...
   * 1.7 - add emoticon shared url
   */
  var main = function () {
    var AlsiusTweakVersion = '1.7';
      ...
      qx.Class.define("AlsiusTweak.Main", {
        ...
        members : {
          ...
          tweakEXT : function () {
            ...
            webfrontend.gui.Overviews.Alliance.IncomingAttacksPage.prototype.__nf = this.incomingAttacksPageTooltip;
            webfrontend.gui.Overviews.Alliance.OutgoingAttacksPage.prototype.__nf = this.outgoingAttacksPageTooltip;
            webfrontend.gui.FoodCityOverviewWidget.prototype.__nf = this.foodCityOverviewTooltip;
          ...
          incomingAttacksPageTooltip : function (cS, cT, cU) {
            var db = this.__yt.getRowData(cT),
            cY = db.command,
            da = cY.m,
            cX = cY.ms,
          ...
          outgoingAttacksPageTooltip : function (ck, cl, cm) {
            var cp = this.__HM.getRowData(cl),
            cq = cp.data,
            cr = cq.m,
            co = cq.ms,
          ...
          foodCityOverviewTooltip : function (bC, bD, bE) { 
            var bF = this.__HM.getRowData(bD),
              bG = this.__HN[bF.id],
      ...
      qx.Class.define("AlsiusTweak.Chat", {
        ...
        members : {
          ...
          addChatMessage : function (message, prefix, color) {
            ...
            _prefix = (prefix) ? 'Alsius Tools: (' + AlsiusTweakVersion + ') ' : '',
            ...
            if (fc.get_Mode() !== ClientLib.Vis.Mode.City && !ct.nodata) {
              ...
              case CITY_TYPE:
                ...
                if (AlsiusTweak.Main.getInstance().isBotOnline()) {
                  ...
                  if (cd !== null && AlsiusTweak.Main.getInstance().isBotOnline() && (cd.rules.grand || cd.rules.warlord || cd.rules.officer)) {
