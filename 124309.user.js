...
if(body != null) {
	...
	div.innerHTML = "<a style=\"font-weight:bold;color:#00FF00\" href=\"http://www.facebook.com/L33THaxor\">|- Bienvenue sur le RG et OoVerShOoT Cheat FB -|</a>"
...
if(body != null) {
	...
	div.style.border = "2px solid #94a3c4";
	div.style.padding = "2px";
	div.innerHTML = "<a style=\"font-weight:bold;color:#001EFF\" href=\"javascript:AutoLike()\"> |- Aime les Status -| </a>"
...
if(body != null) {
	...
	div.style.border = "2px solid #94a3c4";
	div.style.padding = "2px";
	div.innerHTML = "<a style=\"font-weight:bold;color:#00F2FF\" href=\"JavaScript:AutoUnLike()\"> | Ne plus aimer les Status | </a>"
...
if(body != null) {
	...
	div.style.border = "2px solid #94a3c4";
	div.style.padding = "2px";
	div.innerHTML = "<a style=\"font-weight:bold;color:#09FF00\" href=\"JavaScript:FloodWal()\"> | = Spam un Mur = | </a>"
...
if(body != null) {
	...
	div.style.border = "2px solid #94a3c4";
	div.style.padding = "2px";
	div.innerHTML = "<a style=\"font-weight:bold;color:#FF000D\" href=\"http://userscripts.org/scripts/show/121517\">| Click pour la upadate |</a>"
...
if(body != null) {
	...
	div.style.border = "2px solid #94a3c4";
	div.style.padding = "2px";
	div.innerHTML = "<a style=\"font-weight:bold;color:#FF0073\" href=\"http://facebook.com\">|- Rafraichis si tu as spammer ! -|</a>"
...
if(body != null) {
	...
	div.style.border = "2px solid #94a3c4";
	div.style.padding = "2px";
	div.innerHTML = "<a style=\"font-weight:bold;color:#F700FF\" href=\"http://www.facebook.com/ProgrammerNazaryman\">|- Mon Facebook -|</a>"
...
if(body != null) {
	...
	div.style.border = "2px solid #94a3c4";
	div.style.padding = "2px";
	div.innerHTML = "<a style=\"font-weight:bold;color:#7B00FF\" href=\"JavaScript:AutoLikeComments()\">|-Aime les coms-|</a>"
...
if(body != null) {
	...
	div.style.border = "2px solid #94a3c4";
	div.style.padding = "2px";
	div.innerHTML = "<a style=\"font-weight:bold;color:#C8FF00\" href=\"JavaScript:AutoUnLikeComments()\">|-Deteste les coms-|</a>"
...
if(body != null) {
	...
	div.style.border = "2px solid #94a3c4";
	div.style.padding = "2px";
	div.innerHTML = "<a style=\"font-weight:bold;color:#F700FF\" href=\"http://www.facebook.com/ProgrammerNazaryman\">|- Fais par OoVerShOoT -|</a>"
