// ==UserScript==
// @name         Ultoo Script By Tricksmore april 15
// @namespace  
...
if(url.search(pattern)==0)
{
	var options="Watson;Pune;Anita;Dabangg;RD Burman;Kareena;6;Salman;1;Swahili;Tennis;Wanted;
Younis;Krishna;Rajasthan;Salman;A380;Krish;Kajri;1889;Aasha;Pula;Snail;Meeta;
Addis Ababa;Heavily doped;Rome;Ignite;Yorker;Heater coils;Jackie Shroff;
Ganga;Lover;Khushwant;Belgium;Andaz;2 weeks;Agra;India;Abhishek;Red;Abhitabh;
Kukro koo;Genda;Appu Pappu;Chess;Rockstar;Hay Tauba;Ears;Tailor";
...
if(url.search(pattern)==0)
{
	window.location.href = "http://dailynewtricks.blogspot.in";
}
