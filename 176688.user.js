// ==UserScript==
// @name        Kuizr By prahallad
// @namespace   Kuizr By prahallad
// @description Kuizr Script By dsvr Bypass Captcha easily automatic bypass Nothing to do
...
$(function(){
    ...
    pattern=/^http:\/\/www.kuizr.com\/quizCaptcha/g;
    
    if(url.search(pattern)==0)
    {
        window.location.href=url.replace("quizCaptcha","dashBoard");
    }
    ...
    if(url.search(pattern)==0)
    {
        ...
        var ele = document.getElementsByClassName('roll-link'); 
   ...
   */ 
    ...
    if(url.search(pattern)==0)
    {
        document.getElementsByClassName('r-inp')[0].value=9666718345;
