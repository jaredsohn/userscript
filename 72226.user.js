	...
	init : function()
	{
		...
		if ( ResCalc.UnitData )
		{
			...
			else if ( uW.document.URL.indexOf( "action=simulator") > 0 ) 
			{
				...
				ResCalc.createResPopup('fcSim', '    Resources Table   ');
				...
				if (rv)
				{
					...
					if ( attCostsTable.length | defCostsTable.length )
					{
						var sumNode = $("<div style='text-align:left;font-size:9px;'>"
								+"<center><span style='text-decoration:underline;'><b>Costs of Losses</b></span>"
								...
								+ "<tr><td align=center>&nbsp;&nbsp;Pop Lost&nbsp;&nbsp;</td></tr></table></b></td>"
