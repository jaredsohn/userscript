// ==UserScript==
// @name           SUPER DUPER SLIM GOOGLE
// @namespace      Mr. Buh
// @description    Because it's actually possiable to slim Google, more than it is now
// @include        http://www.google.com/
// ==/UserScript==
function do_platypus_script() {
smart_remove(window.document,document.evaluate('/HTML[1]/BODY[1]/SPAN[1]/SPAN[2]/CENTER[1]/IMG[1]', document, null, XPathResult.FIRST_ORDERED_NODE_TYPE,null).singleNodeValue,null,null,null);
smart_remove(window.document,document.evaluate('/HTML[1]/BODY[1]/SPAN[1]/SPAN[1]/DIV[3]', document, null, XPathResult.FIRST_ORDERED_NODE_TYPE,null).singleNodeValue,null,null,null);
smart_remove(window.document,document.getElementById('gbar'),null,null,null);
smart_remove(window.document,document.evaluate('/HTML[1]/BODY[1]/SPAN[1]/SPAN[1]/DIV[4]/NOBR[1]', document, null, XPathResult.FIRST_ORDERED_NODE_TYPE,null).singleNodeValue,null,null,null);
smart_remove(window.document,document.evaluate('/HTML[1]/BODY[1]/SPAN[1]/SPAN[2]/CENTER[1]/FORM[1]/TABLE[1]/TBODY[1]/TR[1]/TD[3]', document, null, XPathResult.FIRST_ORDERED_NODE_TYPE,null).singleNodeValue,null,null,null);
smart_remove(window.document,document.evaluate('/HTML[1]/BODY[1]/SPAN[1]/SPAN[2]/CENTER[1]/FORM[1]/TABLE[1]/TBODY[1]/TR[1]/TD[2]/INPUT[4]', document, null, XPathResult.FIRST_ORDERED_NODE_TYPE,null).singleNodeValue,null,null,null);
smart_remove(window.document,document.evaluate('/HTML[1]/BODY[1]/SPAN[1]/SPAN[3]/CENTER[1]', document, null, XPathResult.FIRST_ORDERED_NODE_TYPE,null).singleNodeValue,null,null,null);
