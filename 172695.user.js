...
Main.k.servurl_badconker = 'http://files.badconker.tk/mush/ctrlw';
Main.k.topicurl = "http://twd.io/e/8IZu0g";
...
Main.k.displayMainMenu = function() {
	...
	var play = $("<li class='kmenuel active first'><a href='http://mush.vg/chooseHero'>Jouer</a></li>").appendTo(menu);
	var account = $("<li class='kmenuel'><a href='http://mush.vg/me'>Mon Compte</a></li>").appendTo(menu);
	var casting = $("<li class='kmenuel'><a href='http://mush.vg/group/list'>Castings</a></li>").appendTo(menu);
	var rankings = $("<li class='kmenuel'><a href='http://mush.vg/ranking'>Classement</a></li>").appendTo(menu);
	var forum = $("<li class='kmenuel'><a href='http://mush.vg/tid/forum'>Forum</a></li>").appendTo(menu);
	var help = $("<li class='kmenuel last'><a href='http://mush.vg/help'>Aide</a></li>").appendTo(menu);

	var play_ss = $("<ul>").appendTo(play);
	$("<a class='kssmenuel' href='http://mush.vg/vending'><li><img src='/img/icons/skills/rebel.png' /> Distributeur</li></a>")
	.css("display", "none").attr("id", "vendingmenu").appendTo(play_ss);

	var account_ss = $("<ul>").attr("id", "accountmenu").appendTo(account);
	$("<a class='kssmenuel' href='http://mush.vg/me'><li><img src='/img/icons/skills/persistent.png' /> Expérience</li></a>").appendTo(account_ss);
	$("<a class='kssmenuel' href='http://mush.vg/me?profile'><li><img src='/img/icons/skills/opportunist.png' /> Ma fiche</li></a>").appendTo(account_ss);
	$("<a class='kssmenuel' href='http://mush.vg/me?config'><li><img src='/img/icons/skills/engineer.png' /> Réglages</li></a>").appendTo(account_ss);
	$("<a class='kssmenuel' href='http://mush.vg/me?news'><li><img src='/img/icons/skills/radio_expert.png' /> News</li></a>").appendTo(account_ss);

	var rankings_ss = $("<ul>").appendTo(rankings);
	$("<a class='kssmenuel' href='http://mush.vg/ranking'><li><img src='/img/icons/skills/persistent.png' /> Classements</li></a>").appendTo(rankings_ss);
	$("<a class='kssmenuel ext' href='http://twinorank.kubegb.fr/jeux/mush.php'><li><img src='/img/icons/skills/persistent.png' /> Twin-O-Rank</li></a>").appendTo(rankings_ss);

	var forum_ss = $("<ul>").appendTo(forum);
	$("<a class='kssmenuel ext' href='http://mush.vg/tid/forum#!view/67061'><li><img src='" + Main.k.servurl + "/img/radioh.png' /> Discussion</li></a>").appendTo(forum_ss);
	$("<a class='kssmenuel ext' href='http://mush.vg/tid/forum#!view/67561'><li><img src='" + Main.k.servurl + "/img/radioh.png' /> Entraide</li></a>").appendTo(forum_ss);
	$("<a class='kssmenuel ext' href='http://mush.vg/tid/forum#!view/74323'><li><img src='" + Main.k.servurl + "/img/radioh.png' /> Détente</li></a>").appendTo(forum_ss);
	if (Main.k.silver) $("<a class='kssmenuel ext' href='http://mush.vg/tid/forum#!view/78267'><li><img src='/img/icons/skills/rebel.png' /> Officiers</li></a>").appendTo(forum_ss);

	var help_ss = $("<ul>").appendTo(help);
	$("<a class='kssmenuel' href='http://mush.vg/help'><li><img src='/img/icons/skills/genius.png' /> Aide Mush</li></a>").appendTo(help_ss);
	$("<a class='kssmenuel' href='http://mush.vg/patchlog'><li><img src='/img/icons/skills/persistent.png' /> Patchlog</li></a>").appendTo(help_ss);
	if (Main.k.ownHero && Main.k.tutorials[Main.k.ownHero]) {
		var charname = Main.k.ownHero.replace("_", "");
		$("<a class='kssmenuel ext' href='http://mush.vg/tid/forum#!view/67561|thread/" + Main.k.tutorials[Main.k.ownHero] + "'><li><img src='/img/icons/ui/" + charname + ".png' /> Tuto " + Main.k.ownHero.capitalize() + "</li></a>").appendTo(help_ss);
	}
	...
	$("<a class='kssmenuel ext' href='http://pictoid.simonneaux.fr/mush/'><li><img src='/img/icons/ui/win_triumph.png' /> Pictoid</li></a>").appendTo(help_ss);
...
Main.k.css.customMenu = function() {
	...
	.mxhead a.logo, .mxhead a.logo2 { position: relative! important; display: block; }\
	.kmenu {\
...
Main.k.tabs.playing = function() {
	...
	Main.onWallFocus = function(jq) { 
		if (jq.val() == "Mon message ici !") jq.val("");
	...
	Main.onWallInput = function(event) {
		...
		if(event.keyCode == 13) {
			if(!event.ctrlKey && val.length > 1) {
				var k = tgt.closest(".unit").data("k")
				var scr = $(".cdWallChannel").scrollTop();
				var after = function() {
					var jq = $(".cdWallChannel");
					jq.scrollTop(scr + 100);
					tgt.prop("disabled", false);
				};

				Main.k.postMessage(k, val, after);
				event.preventDefault();
				tgt.prop("disabled", true);
			} else if (event.ctrlKey) {
				// Insert new line at carret
				tgt.insertAtCaret("\n");
			}
		}
	}
	...
	Main.k.UpdateDialog = function() {
		...
		var okHref = Main.k.servurl + "/js/CTRLW.user.js";
		var okHref2 = Main.k.servurl + "/js/CTRLW-chrome.user.js";
		...
		for (var i=0; i<Main.k.UpdateData.changelog.length; i++) {
			...
			if (log[0] > Main.k.version) {
				var updates = log[1].split("|");
				for (var j=0; j<updates.length; j++) {
					maj_content += "<li>[" + log[0] + "] " + updates[j] + "</li>";
				}
			}
		}
		maj_content += "</ul> <br/> <a href='" + okHref + "'>Lien direct vers le script</a>";
		maj_content += " - <a href='" + okHref2 + "'>Version Chrome</a>";

		// Fill popup content
		var content = "<div class='updatescontent'>" + maj_content + "</div>";
		var okAc = "'Main.k.ClosePopup(); js.Lib.window.location.assign(\"" + okHref + "\");'";
		var ok = "<div class='updatesactions'><div id=\"ok\" class=\"but updatesbtn\" onclick=" + okAc + "><div class=\"butright\"><div class=\"butbg\"><a href=\"#\">Mettre à jour</a></div></div></div>";
		...
		$("<div>").html(content + ok + cancel).appendTo(popup.content);
	...
	Main.k.About.open = function() {
		...
		if (!Main.k.About.initialized) {
			...
			$("<p>").css({
				...
				color: "#CCC",
				"text-align": "center"
			}).html("Script développé par <a href='http://twinoid.com/user/8297'>kill0u</a>. <br/>\
	...
	Main.k.Manager.loadWholeWall = function(k) {
		...
		var w = $(".cdWallChannel .cdLast");
		var wp = w.closest(".wall");

		if (w.length > 0) {
			var datak = k ? k : w.parent().attr("data-k");
