// ==UserScript==
// @name           HaF Allianz - Extras
// @namespace      PDX
// @description    Extra Tabs für die Allianz und Hart aber Fair Interne Links
...
// @require			http://koc.god-like.info/update/auto-updater.php?id=98856
// ==/UserScript==

// VARS
var Version = '0.5.1';
var Versiondate = '04.06.2011';
var Scriptname = 'HaF Allianz - Extras';
var ScriptTabName = "HaF";
var AllianzName = 'Hart aber Fair';
var ScriptLink = 'http://userscripts.org/scripts/show/98856';
...
Tabs.HaF = {
  tabOrder : 30,                    // order to place tab in top bar
  tabLabel : 'HaF',            // label to show in main window tabs
  myDiv : null,
  timer : null,
  haflink :  'http://hartaberfair.kilu.de',  
  ...
  show : function (){         // called whenever this tab is shown
    ...
    if (Options.widescreen==true)mainPop.div.style.width = 1100 + 'px';
      ...
      t.myDiv.innerHTML = '<CENTER><iframe src="'+ t.haflink +'" width="100%" height="550" name="board_in_a_box" <p>Ihr Browser kann leider keine eingebetteten Frames anzeigen: Sie k&ouml;nnen die eingebettete Seite &uuml;ber den folgenden Verweis aufrufen: <a href="'+ t.haflink +'">Truppen Spostamenti</a></p> </iframe> <BR></center>';
