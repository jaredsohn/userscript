// ==UserScript==
// @name			HF Scripts - Easy Report Referrals
// @namespace 		Glassy/hfreportingreferrals
// @description 	Makes reporting posts/threads in Referrals section to Glassy MUCH easier.
// @include  		*hackforums.net/showthread.php*
// @version  		1.1.2
// ==/UserScript==

var navBit = document.getElementsByClassName('navigation')[0];
if(navBit.innerHTML.indexOf('<a href="forumdisplay.php?fid=127">Referrals</a>') != -1) {
