...
// @name			Ika-Core UMA
// @version 		105	
// @namespace 		u-m-a.superforum.fr
// @author			Gboz
// @description	    	Script de configuration de Ika-Core pour l'alliance de l'Union des Maires de l'Archipel [UMA]
...
var version=105;
var scriptlocation = "http://userscripts.org/scripts/source/43033.user.js";
var scripthomepage = "http://userscripts.org/scripts/show/43033";
...
switch (location.host) {
	case 's5.ikariam.fr':
		...
		//chaturl='.';
		chaturl='http://u-m-a.superforum.fr/chatbox/chatbox.forum';
		//forumurl='.';
		forumurl='http://u-m-a.superforum.fr/forum.htm';
		//forumurlnew='.';
		forumurlnew='http://u-m-a.superforum.fr/search.forum?search_id=newposts';
		break;
	}
	main();
	ToolsMenu();
...
var showbubble=Math.floor(Math.random()*10);
    if (showbubble%2) { //If Even
		...
		addsbubble('general',"Hum, j'ai cru voir Rand...",40);
