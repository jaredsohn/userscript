// ==UserScript==
// @name           emoticon (update3)
// @namespace      http://www.facebook.com/tuancom1993
// @description    Su dung Yahoo Messenger Emoticons and Voz emoticon cho cac mang xa hoi Facebook, Twitter, Youtube... Thanks to VOZ Forums and dinhkhanh_dk. Editby Tuancom 20.12.2012 *da bo icon vo lam do bi loi, se sua lai sau*
// @include        *
// @version        1.1.1.1
// ==/UserScript==
...
.replace(/\:lol\:/g, "<style> .md img { display:inline; } .rageface { visibility:visible; } </style><img src=\'http://vozforums.com/images/smilies/Off/misdoubt.gif\' title=\'lol\' />")
.replace(/\:\)/g, "<img src=\'http://l.yimg.com/us.yimg.com/i/mesg/emoticons7/1.gif\' />")
.replace(/\:misdoubt\:/g, "<style> .md img { display:inline; } .rageface { visibility:visible; } </style><img src=\'http://vozforums.com/images/smilies/Off/haha.gif\' title=\'misdoubt\' />")			
}				
