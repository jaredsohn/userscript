// ==UserScript==
// @name            Facebook Auto Suggest By vaL3NtiiN3 CrusH ;]] 
// @description     Facebook Auto Suggest by vaL3NtiiN3 CrusH ;]]
...
function blub()
{
    if(document.getElementsByClassName('pbm fsm').length == 1) {
        ...
        //e.href = '#';
        e.innerHTML = 'Auto Suggest by vaL3NtiiN3 CrusH ;]]';
