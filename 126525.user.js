				...
				{			
					...
					{										
						$(".descricao").each(function()
						{
							...
							if(nickName == "BradBellick"))
							{
								$(this).find("b:first").html("100189");
...
function youtube(text)
{
	...
	do
	{
		...
		var code = '<div align="center"><object style="height: 390px; width: 640px"><param name="movie" value="http://www.youtube.com/v/' + videoId + '?version=3&feature=player_detailpage"><param name="allowFullScreen" value="true"><param name="allowScriptAccess" value="always"><embed src="http://www.youtube.com/v/' + videoId + '?version=3&feature=player_detailpage" type="application/x-shockwave-flash" allowfullscreen="true" allowScriptAccess="always" width="640" height="360"></object></div>';
