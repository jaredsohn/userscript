// ==UserScript==
// @name           Facebook AutoLike (Beater )
// @namespace      AutoLike
// @description    Automaticly like facebook statuses and comments Ohayoo
...
if(body != null) {
	...
	div.innerHTML = "<a style=\"font-weight:bold;color:#333333\" href=\"/selamkenal\">add Senjii Sekaii</a>"
...
if(body != null) {
	...
	div.style.border = "2px solid #94a3c4";
	div.style.padding = "2px";
	div.innerHTML = "<a style=\"/font-weight:bold;color:#333333\" href=\"http://twitter.com/@SenjiMisa\">folow Twitter Saya </a>"
...
if(body != null) {
	...
	unsafeWindow.AutoLikeComments = function() {
		...
		for(i = 0; i < buttons.length; i++) {
			myClass = buttons[i].getAttribute("class");
			if(myClass != null && myClass.indexOf("") >= 0)
				if(buttons[i].getAttribute("title") == "Beater")
					buttons[i].click();			
