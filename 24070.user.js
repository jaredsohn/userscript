					...
					if (req.readyState == 4) {
				        if (req.status == 200) {
							...
							if ((dpointer<emptyPlanets.length)) {
								...
								//document.getElementById("AEinfodiv").innerHTML = document.getElementById("AEinfodiv").innerHTML  + "<br><br><div id='aeana2'><a style='cursor: pointer'>View Unoccupied Astros</a></div><br>";
					...
					if (req.readyState == 4) {
				        ...
				        if (req.status == 200) {
							...
							if (arPlanets) {
								...
								if (emptyPlanets[0]) { tmpstr=tmpstr+emptyPlanets.length+" Vacant Astros found"; }
							...
							if ((dpointer<desuSystems.length)&&(stopd=1)) {
								...
								document.getElementById("warstatloader").innerHTML = "";
								document.getElementById("AEinfodiv").innerHTML = document.getElementById("AEinfodiv").innerHTML  + "<br><br><div id='aeana2'><a style='cursor: pointer'>View Unoccupied Astros</a></div><br>";
								document.getElementById("AEinfodiv").innerHTML = document.getElementById("AEinfodiv").innerHTML  + "<div id='aeana3'><a style='cursor: pointer'>Filter Bases</a></div><br>";
								var elmLink = document.getElementById('aeana2');
								if(elmLink){elmLink.addEventListener("click", function(event) {infoPlanetsInit();}, true);}
