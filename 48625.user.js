// ==UserScript==
// @name            Platypus-wordpress.com/
// @namespace       Platypus
// @include         http://wordpress.com/
// ==/UserScript==
function do_platypus_script() {
erase_it(window.document,document.evaluate('/HTML[1]/BODY[1]/DIV[1]/DIV[3]/P[1]', document, null, XPathResult.FIRST_ORDERED_NODE_TYPE,null).singleNodeValue,null,null,null);
center_it(window.document,document.evaluate('/HTML[1]/BODY[1]/DIV[1]/DIV[1]/H1[1]/A[1]', document, null, XPathResult.FIRST_ORDERED_NODE_TYPE,null).singleNodeValue,null,null,null);
fix_page_it(window.document,'/HTML[1]',null,null,null);
center_it(window.document,document.evaluate('/HTML[1]/BODY[1]/DIV[1]/DIV[1]/H1[1]/CENTER[1]/A[1]', document, null, XPathResult.FIRST_ORDERED_NODE_TYPE,null).singleNodeValue,null,null,null);
center_it(window.document,document.getElementById('wrapper'),null,null,null);
center_it(window.document,document.getElementById('wrapper'),null,null,null);
center_it(window.document,document.evaluate('/HTML[1]/BODY[1]/CENTER[1]/CENTER[1]/DIV[1]/DIV[2]/DIV[4]/DIV[1]/DIV[1]/H6[1]', document, null, XPathResult.FIRST_ORDERED_NODE_TYPE,null).singleNodeValue,null,null,null);
center_it(window.document,document.evaluate('/HTML[1]/BODY[1]/CENTER[1]/CENTER[1]/DIV[1]/DIV[2]/DIV[4]/DIV[1]/DIV[1]/CENTER[1]/H6[1]', document, null, XPathResult.FIRST_ORDERED_NODE_TYPE,null).singleNodeValue,null,null,null);
center_it(window.document,document.evaluate('/HTML[1]/BODY[1]/CENTER[1]/CENTER[1]/DIV[1]/DIV[2]/DIV[4]/DIV[1]/DIV[1]/CENTER[1]/CENTER[1]/H6[1]', document, null, XPathResult.FIRST_ORDERED_NODE_TYPE,null).singleNodeValue,null,null,null);
center_it(window.document,document.evaluate('/HTML[1]/BODY[1]/CENTER[1]/CENTER[1]/DIV[1]/DIV[2]/DIV[4]/DIV[1]/DIV[1]/CENTER[1]/CENTER[1]/CENTER[1]/H6[1]', document, null, XPathResult.FIRST_ORDERED_NODE_TYPE,null).singleNodeValue,null,null,null);
center_it(window.document,document.evaluate('/HTML[1]/BODY[1]/CENTER[1]/CENTER[1]/DIV[1]/DIV[2]/DIV[4]/DIV[1]/DIV[1]', document, null, XPathResult.FIRST_ORDERED_NODE_TYPE,null).singleNodeValue,null,null,null);
erase_it(window.document,document.evaluate('/HTML[1]/BODY[1]/CENTER[1]/CENTER[1]/DIV[1]/DIV[2]/DIV[4]/DIV[1]/CENTER[1]/DIV[1]', document, null, XPathResult.FIRST_ORDERED_NODE_TYPE,null).singleNodeValue,null,null,null);
erase_it(window.document,document.getElementById('lang-guess'),null,null,null);
erase_it(window.document,document.evaluate('/HTML[1]/BODY[1]/CENTER[1]/CENTER[1]/DIV[1]/DIV[1]/UL[1]/LI[2]/A[1]', document, null, XPathResult.FIRST_ORDERED_NODE_TYPE,null).singleNodeValue,null,null,null);
erase_it(window.document,document.evaluate('/HTML[1]/BODY[1]/CENTER[1]/CENTER[1]/DIV[1]/DIV[1]/UL[1]/LI[4]/A[1]', document, null, XPathResult.FIRST_ORDERED_NODE_TYPE,null).singleNodeValue,null,null,null);
center_it(window.document,document.getElementById('head-search'),null,null,null);
center_it(window.document,document.getElementById('head-search'),null,null,null);
erase_it(window.document,document.evaluate('/HTML[1]/BODY[1]/CENTER[1]/CENTER[1]/DIV[1]/DIV[1]/UL[1]/LI[5]/A[1]', document, null, XPathResult.FIRST_ORDERED_NODE_TYPE,null).singleNodeValue,null,null,null);
erase_it(window.document,document.evaluate('/HTML[1]/BODY[1]/CENTER[1]/CENTER[1]/DIV[1]/DIV[2]/DIV[3]/DIV[1]/DIV[1]', document, null, XPathResult.FIRST_ORDERED_NODE_TYPE,null).singleNodeValue,null,null,null);
erase_it(window.document,document.getElementById('promoblock'),null,null,null);
erase_it(window.document,document.evaluate('/HTML[1]/BODY[1]/CENTER[1]/CENTER[1]/DIV[1]/DIV[3]/UL[1]/LI[7]/STRONG[1]', document, null, XPathResult.FIRST_ORDERED_NODE_TYPE,null).singleNodeValue,null,null,null);
erase_it(window.document,document.evaluate('/HTML[1]/BODY[1]/CENTER[1]/CENTER[1]/DIV[1]/DIV[2]/DIV[1]/DIV[1]/H4[1]', document, null, XPathResult.FIRST_ORDERED_NODE_TYPE,null).singleNodeValue,null,null,null);
