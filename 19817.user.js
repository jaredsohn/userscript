// ==UserScript==
// @name           KG - Artist Search
// @namespace      http://karagarga.net
// @description    searches artist names on KG tracker. (v 0.2)
...
(function() 
{
	...
	function makeEssexLink(movieName)
	{
		if (movieName != null && movieName.length > 0)
		{
			...
			newLink.setAttribute("href", "http://karagarga.net/browse.php?incldead=&search_type=torrent&search=" + '"' + movieName + '"');
			newLink.setAttribute("style", "-moz-opacity: 0.4;");
			
			var newImg = document.createElement("img");
				newImg.setAttribute("src", 'data:image/png;base64,iVBORw0KGgoAAAANSUhEUgAAAAkAAAAJCAMAAAGgSMa0AAAAB3RJTUUH1gEcDxsZ6R2wYgAAAAlwSFlzAAAewQAAHsEBw2lUUwAAAARnQU1BAACxjwv8YQUAAAAGUExURf///5SUKfhHFCAAAAABdFJOUwBA5thmAAAAKklEQVR42mNgYARCIABSjGAKRoD4jBAWnEbIMyKEIAoZwSJgwxiRTAERAAaBACHDT2PUAAAAAElFTkSuQmCC');
				newImg.setAttribute("border", "0");
				newImg.setAttribute("width", "9");
				newImg.setAttribute("height", "9");
				newImg.setAttribute("alt", "KG Artist Search");
				newImg.setAttribute("title", "KG Artist Search");
