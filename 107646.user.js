...
// @include       http://lose4.piraten-battle.de/index.php?num=*
// @exclude       
// ==/UserScript==
var ah=9; 
...
while (e = Suche.exec(responseDetails.responseText)) {su='sid='+e[1]+'"><font color="#003366">archivieren</font></a></font>';er=su+e[2];innertext=innertext.replace(su,er);}
