// ==UserScript==
// @name           KoC Power - Italia
// @version        Paolcudazzo[ITA]
// @namespace      Paolcudazzo[ITA]
...
var Version = 'By Paolcudazzo[ITA]';
// JSON
...
if (document.body.id == 'mainbody') {
	...
	div.appendChild(Builder.BlueButton("Messaggio all' Alleanza", "getMessageWindow(1445,'Membri Alleanza','allianceall');return false;"));
	div.appendChild(Builder.BlueButton("Report", "modal_alliance();track_chrome_btn('alliance_btn');allianceReports();modal_alliance_changetab(4);return false;"));
...
+ div.appendChild(Builder.Html("<span class=boldRed><b> KoC Power - Italy \ Version: <font color=#600000>"+ Version +"</font></b>")); 
...
//		else //this should isolate the stuff in alliance chat. seltab2 = alliance.
		...
		for (var i = 0; i < div.childNodes.length; i++) {
			...
			for (var j = 0; j < msgdiv.childNodes.length; j++) {
				...
				var tDly = tReq.replace('* Richiesta risorse *:', "consegnato:");
				...
				actiondiv.appendChild(Builder.BlueButton("consegnato", cD));
...
if (TEST_WIDE){
  ...
  window.name = 'PT';
  logit ("KoC Power - Version: "+ Version);
  readOptions();
  readCrestOptions();
  readTrainingOptions();
  setCities();
...
if (Options.enableBarbSummary)
		RecordBarbs.init ();
  actionLog ("KoC Power - Italy - Version: <span class=boldRed>"+ Version);
...
//DebugTimer.start();
  ...
  Tabs.Marches.getMarchCount(0);
      ...
      str = '<DIV class=pdxStat style="margin-top:5px; margin-bottom:5px;"><TABLE cellspacing=0 cellpadding=0 class=pdxTab width=97% align=center>\
        ...
        <TD><SPAN class=pdxStatLight>Alleanza:</span> ' + getMyAlliance()[1] +'</td>\<TD align=right><SPAN class=pdxStatLight>Dominio:</span> ' + unsafeWindow.domainName  +' - By Paolcudazzo[ITA] -  ' +'</td></tr></table></div>';
  ...
  var currentCityId = unsafeWindow.currentcityid;
    ...
    str += '<tr align=right><TD style=\'background: #99ccff\' width=88 ><span class=pdxCapShadowRW><center>Difesa</span></center> &nbsp;</td><TD style=\'background: #99ccff\' ></td>';
        for(i=0; i<Cities.numCities; i++) {
          ...
          str+='<TD style=\'background: #99ccff\'><center><INPUT id="pdxTabut_'+i+ '" type=submit value='+((mode==1)?'ON':'OFF')+' /></INPUT></center></td>';
      }
...
str += '<TR><TD class=pdxStat>In Addestramento</td></tr>';
    ...
    str += '<TR><TD class=pdxStat>Costruzioni</td></tr>';
        ...
        str += _row ('<span class=pdxCapShadowSG>Popolazione inattiva Max</span>', rowsnm[3]);
...
//        13:{'name':"-------",'x':375,'y':375},
  ...
  helpPop : function (){
       ...
       pop.getTopDiv().innerHTML = '<CENTER><B>KoC Power - Italy: Raid Angriffe</b></center>';
       pop.show (true);
     },
...
var m = '<DIV class=pdxStat2>AUTO SPÄHEN - EINSTELLUNG</div>';
    ...
    m += '<DIV style="max-height:220px; overflow-y:auto;"><TABLE align=center cellpadding=0 cellspacing=0 class=pdxTabPadNW><TR style="font-weight:bold; "><TD width=15><input type=checkbox id=pbsrcScout_All /></td><TD>Coordinate Obiettivo</td></tr>';
  ...
  popScout.getTopDiv().innerHTML = '<CENTER><B>KoC Power - Italy: Späher Liste</b></center>';
  popScout.show(true);
...
//logit (inspect (t.gifts, 8, 1));     
      ...
      m += '<TABLE class=pdxTab align=center><TR><TD align=right>Server: </td><TD>'
        ...
        <TR style="font-weight:bold"><TD>Geschenk</td><TD>Data</td><TD>von (server)</td><TD width=20></td></tr>';
...
<table width="624" border="0" cellspacing="0" cellpadding="0"><tr>\
    <td colspan="2"><a href="http://userscripts.org/scripts/show/104137" target="_blank">KoC Power - Italy</a> -   Version: <SPAN class=boldRed> '+ Version +' </span> by <a href="http://userscripts.org/users/297645/scripts" target="_blank">PDX</a></span></td>\
...
<TR><TD></td><TD>Wer darf die Anfrage sehen? '+ htmlSelector({0:'----', 80:'Alle', 50:'Freunde von Freunden', 40:'Nur Freunde', 10:'Nur ich'},GlobalOptions.autoPublishPrivacySetting,'id=selectprivacymode') +' </td></tr>\
		   ...
		   <TR><TD><INPUT id=deletetoggle type=checkbox /></td><TD> Automatisches Löschen der Barbaren/Transport Berichte <span class=boldRed>(von dir)</span></td></tr>\
			...
			<TR><TD></td><TD> '+ strButton20('ALLES ZURÜCKSETZEN', 'id=ResetALL') +'</td></tr>\
        </table><BR><BR><HR><u>Hinweis</u>: Wenn eine Box nicht klickbar ist hat KoC mal wieder eine änderung vorgenommen!<HR>\
<table width="624" border="0" cellspacing="0" cellpadding="0"><tr>\
    <td colspan="2"><a href="http://userscripts.org/scripts/show/104137" target="_blank">KoC Power - Italy</a> -   Version: <SPAN class=boldRed> '+ Version +' </span> by <a href="http://userscripts.org/users/297645/scripts" target="_blank">PDX</a></span></td>\
    <td><b>Bewertungen</b></td>\
...
<TR><TD colspan=2><BR><B><u>Kingdom of Camelot - Einstellung</u></b></td></tr>\
    ...
    <TR><TD><INPUT id=togAllRpts type=checkbox /></td><TD>Erweiterte Allianz Berichte.</td></tr>\
        ...
        <TR><TD><INPUT id=togEnhanceMsging type=checkbox /></td><TD>Erweiterte Nachrichten. <SPAN class=boldRed>("Weiterleiten" und "Agli Ufficiali" Buttons)</span></td></tr>\
        <TR><TD><INPUT id=togWarnZero type=checkbox /></td><TD>Warnen falls du nach 0,0 Maschieren möchtest.</td></tr>\
        <TR><TD><INPUT id=togChatStuff type=checkbox /></td><TD>Chat Erweitern <SPAN class=boldRed>(Hintergrund Farben etc.)</span></td></tr>\
  ...
  unsafeWindow.getReport = t.getReportBody;
    ...
    document.getElementById('StartSearch').addEventListener ('click', function(){
           if (document.getElementById('searchSelect').value == "Reports") {
               t.totalPages = 0;
               t.content = '<center><table><thead><th>Öffnen</th><th>Seite</th><th>Data</th><th>Aggressore</th><th>Aggressore<br>coordinate</th><th>Alleanza</th><th>Marcia</th><th>Obiettivo</th><th>Tipo</th><th>Obiettivo<br>Coordinate</th></thead><tbody>';
               t.searchReports("",1);
           }
           else {
             t.totalPages = 0;
             t.content = '<center><table><thead><th>Öffnen</th><th>Seite</th><th>Data</th><th>von</th><th>Betreff</th></thead><tbody>';
             t.searchMail("",1);
           }
        }, false);
 ...
 Tabs.Crest = {
  ...
  init : function (div){
    ...
    m += '<TD>Y:<INPUT id=pbcresty type=text size=3 maxlength=3 value="'+CrestOptions.Y+'"</td></tr></table>';
	  m += '<TABLE class=ptTab><TR><TD>Welle <b>1</b>: </td><TD><img src=http://cdn1.kingdomsofcamelot.com/fb/e2/src/img/units/unit_2_30.png></td><TD><INPUT id=R1MM type=text size=5 maxlength=5 value="'+CrestOptions.R1MM+'" (Wenn keine Truppen mehr in der Stadt sind wird es aufhören die erste Welle zu schicken)</td>';
  ...
  init : function (div){
	...
	var m = '<DIV class=pdxStat>RAID - EINSTELLUNG</div><TABLE width=100% height=0% class=pdxTab><TR align="center">';
	    m += '<TD><INPUT id=pbRaidStart type=submit value="Auto Reset = '+ (Options.RaidRunning?'AN':'AUS') +'" ></td>';
		 m += '<TD><INPUT id=pbsendreport type=checkbox '+ (Options.foodreport?' CHECKED':'') +'\> Raid Berichte alle ';
...
cityID = 'city' + Seed.cities[c][0];    
  					 ...
  					 onSuccess: function(transport){
  						var rslt = eval("(" + transport.responseText + ")");
  		                  if (rslt.ok) {
  		                  		...
  		                  		actionLog('<b>Ferma Raids </b> '+ Seed.cities[i][1]);
  						  		...
  						  		if (rslt.msg == "The system is busy, please try again later") setTimeout (t.DoAllStop, (2000),i);
  					 	  			...
  					 	  			t.stopprogress = t.stopprogress + (100/Seed.cities.length);
  					 	  			actionLog('<b>Ferma Raids</b> '+ Seed.cities[i][1] + ' - ' + rslt.msg);
  					 	  			updatebotbutton('Ferma Raids: '+ t.stopprogress.toFixed(0) + '%', 'pbraidtab')
  					 	  			if (t.stopprogress.toFixed(0) == 100) {
  					 	  				 t.stopprogress = 0;
  					 	  				 setTimeout(function(){updatebotbutton('Ferma Raids ('+ t.activecount + ')', 'pbraidtab');t.stopping = false;}, (5000));
  		 ...
  		 new AjaxRequest2(unsafeWindow.g_ajaxpath + "ajax/_dispatch.php" + unsafeWindow.g_ajaxsuffix, {
  					 ...
  					 onSuccess: function(transport){
  						var rslt = eval("(" + transport.responseText + ")");
  		                  if (rslt.ok) {
  		                  		t.stopprogress = t.stopprogress + (100/Seed.cities.length);
  		                  		actionLog('<b>Riprendi Raids</b> '+ Seed.cities[i][1]);
  ...
  DoAllDelete : function (Id,city,count){
      ...
      new AjaxRequest2(unsafeWindow.g_ajaxpath + "ajax/_dispatch.php" + unsafeWindow.g_ajaxsuffix, {
  		  	 ...
  		  	 actionLog('<b>Cancella Raids</b> '+ Seed.cities[city][1]);
...
&nbsp;<INPUT id=pbnum3 type=text size=5 maxlength=5 value="'+ Options.celltext.num3 +'" '+(Options.celltext.provider==0?'DISABLED':'')+'\></td>\
 ...
 m += '</select></td></tr>\
    ...
    <TR><TD><BR></td></tr>\
    <TR><TD><INPUT id=pbSoundEnable type=checkbox '+ (Options.alertSound.enabled?'CHECKED ':'') +'/></td><TD colspan="2">Suona l\' allarme in caso di attacco o esplorazione</td></tr>\
    <TR><TD></td><td colspan="2">\
        <DIV id=pbLoadingSwf><span class=boldRed> Version: By Falco</div><DIV style="display:none" id=pbSoundOpts><TABLE cellpadding=0 cellspacing=0>\
...
document.getElementById('pbcellenable').addEventListener ('change', function (e){Options.celltext.atext = e.target.checked;}, false);
 ...
 mailHelpPop : function (){
  var helpmailText = '<BR>1. Mettere la spunta su Invia sms di attacco...<BR> \
    ...
    <BR>Per maggiori informazioni clicca<a href="http://koc.god-like.org/?p=544" target="_new">qui</a>'; 
  var pop = new CPopup ('giftHelp', 0, 0, 500, 400, true);
  pop.centerMe (mainPop.getMainDiv());  
  pop.getMainDiv().innerHTML = helpmailText;
  pop.getTopDiv().innerHTML = '<CENTER><B>KoC Power Bot -Italy</b></center>';
  pop.show (true);
  },
        ...
        onSuccess: function (transport) {
          ...
          if (rslt.ok) {
            ...
            if (rslt.error_code == 213)
              ...
              actionLog('Il trasporto a ' + cityname + ' è fallito -> Spazio insufficente nel Punto di raduno - ' + rslt.feedback);
            else
...
var t = Tabs.Reinforce;
    ...
    m += '<td colspan="2"><center><u>oder</u> <b>coordinate Obiettivo</b></center></td>';
 ...
 m += '</TABLE>';
  ...
  //End Link info
    m += '<DIV class=pdxStat>ENTFERNUNGS RECHNER</div><DIV class=pdxEntry><TABLE align=center cellpadding=1 cellspacing=0>\
      ...
      <TR><TD class=xtab><B>Obiettivo: </b></td><TD class=xtab> X: <INPUT id=calcX2 type=text\> Y: <INPUT id=calcY2 type=text\> <SPAN id=ptloc2></span></td></tr></table>\
  ...
  <div><br><b>Marschzeit für</b><br><select id="idETASelect">\
        ...
        <option value="1,120" > Rammbock </option>\
        <option value="1,80" > Steinschleuder </option>\
</select><BR><BR><SPAN class=boldRed>(Startpunkt, Obiettivo und Truppen Auswählen!)</span></div>\
...
Tabs.F = {
  ...
  var citySelect = '  <SELECT id=fakeCity>';
    ...
    <TR><TD align=right>Späher: </td><TD><INPUT type=text size=6 value=0 id=fakeScout></td></tr>\
      ...
      <TR><TD align=right>Obiettivo: </td><TD>'+citySelect+'</td></tr>\
...
var CollectGold = {
  ...
  e_ajaxDone : function (rslt){
    var t = CollectGold;
    if (rslt.ok)
      actionLog ('<b>Auto Gold</b> '+ rslt.goldGained +' Gold für '+ t.colCityName +' (glück war auf '+ t.colHappy +'%)');
    else
      actionLog ('<b>Auto Gold</b> Fehler beim eintreiben von Gold '+ t.colCityName +': <SPAN class=boldRed>'+ rslt.errorMsg +'</span>');
  },
...
var RefreshEvery  = {
  ...
  doit : function (){
    actionLog ('<b>Auto Refresh</b> ('+ Options.pbEveryMins +' Minuten sind abgelaufen!)');
    reloadKOC();
  }
}
...
actionLog(Seed.cities[TrainCity][1]  + '<b>Auto Ausbildung</b> Arbeiter: ' + idle + ' - Truppen:  ' + troops[unitId] );
  } else {actionLog(Seed.cities[TrainCity][1] + '<b>Auto Ausbildung</b> Fehlgeschlagen ' + idle + ' ' +  troops[unitId] + ' - '+ rslt.msg);}
},
onFailure: function() {}
});
}
