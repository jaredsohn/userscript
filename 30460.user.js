// ==UserScript==
// @name		OGame Auto Login
// @version	1.0
// @description	Automatic login for any OGame server. Saving you time and effort.
// @author		Skyboat
// @e-mail		skyboat at blueyonder dot co dot uk
// @include	http://*ogame.org/home.php
...
if (location.pathname =='/home.php'){
	try{
		if(uni!=0 && nombre!='' && clave !=''){
			...
			var url = "http://uni" + uni + ".ogame.org/game/reg/login2.php";
