	...
	function createTweak() {
		...
		LT_strings = {
			...
			"de": {
				...
				"layout_btn_tt": "FÃ¼r die aktuelle Stadt einen LoU City Planner Sharestring erzeugen",
				"chat_btn_city": "Stadt",
				"chat_btn_player": "Spieler",
				"chat_btn_alliance": "Allianz",
				"chat_btn_url": "Link",
				"copy_coords_btn": "Kopiere Koordinaten in den Chat",
				"up_count_tt": "Zum Aufwerten verfÃ¼gbare GebÃ¤ude:",
				...
				"opts_show_queue_win": "Info-Fenster fÃ¼r AuftrÃ¤ge anzeigen",
				"opts_limit_req_res": "Begrenze bestellte Rohstoffe auf die freie LagerkapazitÃ¤t der Stadt",
				"opts_inc_res": {
					"lab": "Label fÃ¼r ankommende Waren:",
					"disabled": "deaktiviert",
					"always": "Immer an",
					"context": "KontextabhÃ¤ngig"
				},
				"opts_separator": {
				...
				"opts_lowest_lvl": {
					"lab1": "WÃ¤hle die GebÃ¤ude zur Aufwertung durch den 'L (niedrigste Stufe aufwerten)' TastenkÃ¼rzel aus",
					"lab2": "Die maximale Stufe fÃ¼r jede Gruppe festlegen, bei der das TastenkÃ¼rzel 'L' das Aufwerten beendet",
					"towers": "TÃ¼rme:",
					"military": "MilitÃ¤r:",
					"resource": "Waren:",
					"cottage": "Wohnhaus:",
				...
				"opts_set_hotkeys": "Zum Festlegen eines TastenkÃ¼rzels zuerst den Button anklicken und dann eine Taste drÃ¼cken",
				"opts_hotkey_labels": {
					"lab1": "Aufbau-Hotkeys:",
					"lab2": "Aufwertungs-Hotkeys:",
					"lab3": "Mondsteinerzeugungs-Hotkeys:",
					"lab4": "Allgemeine Hotkeys:",
					"upgrade": "GebÃ¤ude aufwerten",
					"downgrade": "Abwerten / Abriss (Umschalt+)",
					"minister": "Dem Minister zuweisen",
					"prev_city": "Vorherige Stadt",
					"next_city": "NÃ¤chste Stadt"
				},
				"opts_clr_inc_res": "Font Farbe fÃ¼r Ankommende Waren Label:",
				"opts_clr_chat": {
					"lab": "Font Farben fÃ¼r Chat:",
					"all": "Alle:",
					"alliance": "Allianz:",
					"whisper": "FlÃ¼stern ",
				...
				"opts": {
					...
					"export": "Exportieren",
					"import": "Importieren",
					"export_lab": "Diese Zeichenkette in einer Textdatei speichern und spÃ¤ter bei Bedarf importieren.",
					"import_lab": "Gespeicherte LoU Tweak Optionen in das Textfeld einfÃ¼gen und OK drÃ¼cken.",
					"import_invalid": "Die eingefÃ¼gte Zeichenkette ist ungÃ¼ltig"
				},
				"layout": {
					"city": "Stadtplan",
					"overlay": "Ãœbersichtsplan einblenden",
					"apply": "Ãœbersichtsplan anwenden",
					"remove": "Ãœbersichtsplan entfernen"
				},
				"opts_lang": {
			...
			"es": {
				...
				"layout_btn_tt": "Pincha para generar un texto con el diseÃ±o de tu ciudad actual",
				...
				"opts_max_chatlines": "LÃ­neas mÃ¡ximas de chat:",
				"opts_chat_opacity": "Transparencia de la ventana de Chat:",
				"opts_switch_to_ally_tab": "Cambiar a la pestaÃ±a Alianza al comenzar",
				"opts_show_queue_win": "Mostrar ventana de informaciÃ³n de colas",
				...
				"opts_city_tag": {
					...
					"info": "InformaciÃ³n de la ciudad",
					"region": "Vista de la regiÃ³n"
				},
				"opts_lowest_lvl": {
					"lab1": "Selecciona los edificios que quieres ampliar con el acceso directo 'L (amplia cualquiera del nivel mÃ¡s bajo)'",
					"lab2": "Define el nivel mÃ¡ximo de todos los tipos de grupo con el que el acceso directo 'L' se detendrÃ¡ la actualizaciÃ³n",
					"towers": "Torres:",
					"military": "Militares:",
					"resource": "Recursos:",
					"cottage": "Cottage:",
				...
				"opts_hotkey_labels": {
					...
					"lab3": "Teclas de acceso directo para la creaciÃ³n de Moonstone:",
				...
				"opts": {
					...
					"export": "Exportar",
					"import": "Importar",
					"export_lab": "Puedes salvar esta cadena de texto como un fichero de texto e importarlo mÃ¡s adelante.",
					"import_lab": "Inserta las opciones salvadas del LoU Tweak en el campo de texto y presiona ok.",
					"import_invalid": "La cadena de texto introducida no es vÃ¡lida"
				},
				"layout": {
					"city": "DiseÃ±o de la ciudad",
					"overlay": "Superponer diseÃ±o",
					"apply": "Aplicar diseÃ±o",
					"remove": "Eliminar diseÃ±o"
				},
				"opts_lang": {
					"lab": "Idoma:",
					"en": "InglÃ©s (English)",
				...
				"purify_btn_tt": "Pincha aquÃ­ para abrir la ventana 'PurificaciÃ³n de recursos'",
				"opts_minimap": {
			...
			"pl": {
				"options_btn_tt": "Kliknij aby otworzyÄ‡ okno opcji LoU Tweak",
				"layout_btn_tt": "Kliknij aby wygenerowaÄ‡ plan (ShareString) tego miasta",
				"chat_btn_city": "Miasto",
				"chat_btn_player": "Gracz",
				"chat_btn_alliance": "Sojusz",
				"chat_btn_url": "Link",
				"copy_coords_btn": "Kopiuj wspÃ³Å‚rzÄ™dne do czatu",
				"up_count_tt": "IloÅ›Ä‡ budynkÃ³w moÅ¼liwych do rozbudowy:",
				"opts_max_chatlines": "Maksymalna liczba linii czatu:",
				"opts_chat_opacity": "PrzezroczystoÅ›Ä‡ tÅ‚a czatu:",
				"opts_switch_to_ally_tab": "PrzeÅ‚Ä…cz na kartÄ™ Sojuszu podczas startu",
				"opts_show_queue_win": "PokaÅ¼ okno z czasami kolejek",
				"opts_limit_req_res": "Ogranicz zamawiane surowce do wolnego miejsca",
				"opts_inc_res": {
					"lab": "Okno przybywajÄ…cych surowcÃ³w:",
					"disabled": "WyÅ‚Ä…czone",
					"always": "Zawsze wÅ‚Ä…czone",
					"context": "Kontekstowo"
				},
				"opts_separator": {
					"lab": "Separator tysiÄ™czny:",
					"period": "'.' (kropka)",
					"comma": "',' (przecinek)",
					"space": "' ' (spacja)",
					"none": "brak"
				...
				"opts_city_tag": {
					...
					"info": "Informacje o mieÅ›cie",
					"region": "Widok regionu"
				},
				"opts_lowest_lvl": {
					"lab1": "Wybierz budynki, ktÃ³re chcesz rozbudowaÄ‡ przy pomocy skrÃ³tu 'L (rozbuduj najniÅ¼szy poziom)'",
					"lab2": "Zdefinuj poziomy dla kaÅ¼dej grupy, przy ktÃ³rych skrÃ³t 'L' przestanie ulepszaÄ‡",
					"towers": "WieÅ¼e:",
					"military": "Wojskowe:",
					"resource": "Surowce:",
					"cottage": "Chatki:",
					"barracks": "Baraki:",
					"utilities": "UÅ¼ytecznoÅ›ci:"
				},
				"opts_set_hotkeys": "Aby przypisaÄ‡ skrÃ³t, kliknij na przycisku, a nastÄ™pnie wciÅ›nij klawisz na klawiaturze",
				"opts_hotkey_labels": {
					"lab1": "SkrÃ³ty konstrukcyjne:",
					"lab2": "SkrÃ³ty ulepszeÅ„:",
					"lab3": "",
					"lab4": "SkrÃ³ty globalne:",
				...
				"opts_clr_inc_res": "Kolory okna przybywajÄ…cych surowcÃ³w:",
				"opts_clr_chat": {
					"lab": "Kolory czatu:",
					"all": "Wszyscy:",
					"alliance": "Sojusz:",
				...
				"opts": {
					...
					"export": "Eksport",
					"import": "Import",
					"export_lab": "MoÅ¼esz zapisaÄ‡ ten tekst w pliku tekstowym i w razie potrzeby przywrÃ³ciÄ‡ opcje.",
					"import_lab": "Wklej zapisane opcje LoU Tweak i wciÅ›nij OK.",
					"import_invalid": "Wklejony ciÄ…g jest niepoprawny"
				},
				"layout": {
					"city": "Plan miasta",
				...
				"opts_lang": {
					"lab": "JÄ™zyk LoU Tweak",
					"en": "Angielski (English)",
					"de": "Niemiecki (German)",
					"es": "HiszpaÅ„ski (Spanish)",
					"pl": "Polski (Polish)",
					"pt": "Portugalski (PortuguÃªs)",
					"ru": "Rosyjski (Ð ÑƒÑÑÐºÐ¸Ð¹)",
					"it": "WÅ‚oski (Italiano)",
					"fr": "Francuski (French)"
				},
				"purify_btn_tt": "Kliknij aby otworzyÄ‡ okno oczyszczania surowcÃ³w",
				"opts_minimap": {
					"enable_lab": "WÅ‚Ä…cz MiniMapÄ™",
					"clrs_lab": "Kolory MiniMapy:",
					"show_cities": "PokaÅ¼ miasta",
					"show_none": "Å»adne",
			...
			"pt": {
				"options_btn_tt": "Clique para mostrar as opÃ§Ãµes do LoU Tweak",
				"layout_btn_tt": "Clique para gerar a Sharestring da cidade atual",
				"chat_btn_city": "Cidade",
				"chat_btn_player": "Jogador",
				"chat_btn_alliance": "AlianÃ§a",
				"chat_btn_url": "Link",
				"copy_coords_btn": "Copiar as coordenadas para o bate-papo",
				"up_count_tt": "ConstruÃ§Ãµes disponÃ­veis para melhora:",
				"opts_max_chatlines": "MÃ¡ximo de linhas no bate-papo:",
				"opts_chat_opacity": "TransparÃªncia do fundo do bate-papo:",
				"opts_switch_to_ally_tab": "Mostrar a guia AlianÃ§a ao iniciar",
				"opts_show_queue_win": "Mostrar janela de informaÃ§Ãµes da fila",
				"opts_limit_req_res": "Limitar os recursos pedidos ao espaÃ§o livre da cidade",
				"opts_inc_res": {
					"lab": "RÃ³tulo dos recursos a chegar:",
				...
				"opts_city_tag": {
					...
					"info": "InformaÃ§Ãµes da cidade",
					"region": "Vista da regiÃ£o"
				},
				"opts_lowest_lvl": {
					"lab1": "Selecione as construÃ§Ãµes que vocÃª quer melhor com o atalho 'L (melhorar o de menor nÃ­vel)'",
					"lab2": "Defina o nÃ­vel mÃ¡ximo ao qual o atalho 'L' irÃ¡ parar de melhorar",
					"towers": "Torres:",
					"military": "Militar:",
					"resource": "Recursos:",
				...
				"opts_set_hotkeys": "Clique em um dos seguintes botÃµes e aperte uma tecla para definir o atalho",
				"opts_hotkey_labels": {
					"lab1": "Atalhos para construÃ§Ã£o:",
					"lab2": "Atalhos para melhora:",
					"lab3": "Artalhos para criaÃ§Ã£o de Pedra do Luar:",
					"lab4": "Atalhos globais:",
					"upgrade": "Melhorar construÃ§Ã£o",
					"downgrade": "Reduzir nÃ­vel / Demolir (Shift+)",
					"minister": "Atribuir ao ministro",
					"prev_city": "Cidade anterior",
					"next_city": "PrÃ³xima cidade"
				},
				"opts_clr_inc_res": "Cores dos rÃ³tulos dos recursos a chegar:",
				"opts_clr_chat": {
				...
				"opts": {
					...
					"export": "Exportar",
					"import": "Importar",
					"export_lab": "VocÃª pode salvar isto em um arquivo de texto e importar mais tarde quando necessÃ¡rio.",
					"import_lab": "Insira as opÃ§Ãµes salvas do LoU Tweak no campo de texto e aperte OK.",
					"import_invalid": "O texto inserido Ã© invÃ¡lido"
				},
				"layout": {
				...
				"opts_minimap": {
					...
					"show_shrine": "PalÃ¡cios",
					"clr_self": "PrÃ³prias:",
					"clr_alliance": "AlianÃ§a:",
					"clr_allied": "Aliados:",
					"clr_enemy": "Inimigos:",
					"clr_nap": "PNA:",
					"clr_other": "Outras:",
					...
					"clr_shrine": "PalÃ¡cios:"
				},
				"trade_limit": "Limite",
				"no": "NÃ£o",
				"yes": "Sim",
				"req_restart": "(requer reinÃ­cio)",
				"opts_save_ss_cn": "Salvar a Sharestring do projeto sobreposto nas Notas da Cidade",
				"opts_trade_lab_max_amount": "Quantide de rÃ³tulos a mostrar no Resumo do ComÃ©rcio:",
                "show_get_use_btn_tt": "Mostrar botÃµes 'Obter e usar'",
                "opts_hide_get_use": "Ocultar botÃµes 'Obter e usar'",
				"btn_trade_show": "Show Trade Summary labels",
				"btn_trade_hide": "Hide Trade Summary labels",
				"btn_support_show": "Show Support labels",
				"btn_support_hide": "Hide Support labels"
			...
			"ru": {
				"options_btn_tt": "ÐÐ°Ð¶Ð¼Ð¸Ñ‚Ðµ Ð´Ð»Ñ Ð¿Ð¾ÐºÐ°Ð·Ð° Ð½Ð°ÑÑ‚Ñ€Ð¾ÐµÐº LoU Tweak",
				"layout_btn_tt": "ÐÐ°Ð¶Ð¼Ð¸Ñ‚Ðµ Ð´Ð»Ñ ÑÐ¾Ð·Ð´Ð°Ð½Ð¸Ñ Ð¼Ð°ÐºÐµÑ‚Ð° Sharestring Ð´Ð»Ñ ÑÑ‚Ð¾Ð³Ð¾ Ð³Ð¾Ñ€Ð¾Ð´Ð°",
				"chat_btn_city": "Ð“Ð¾Ñ€Ð¾Ð´",
				"chat_btn_player": "Ð˜Ð³Ñ€Ð¾Ðº",
				"chat_btn_alliance": "ÐÐ»ÑŒÑÐ½Ñ",
				"chat_btn_url": "Ð¡ÑÑ‹Ð»ÐºÐ°",
				"copy_coords_btn": "ÐšÐ¾Ð¾Ñ€Ð´Ð¸Ð½Ð°Ñ‚Ñ‹ Ð² Ñ‡Ð°Ñ‚",
				"up_count_tt": "Ð—Ð´Ð°Ð½Ð¸Ñ, Ð´Ð¾ÑÑ‚ÑƒÐ¿Ð½Ñ‹Ðµ Ð´Ð»Ñ Ð¿Ð¾Ð²Ñ‹ÑˆÐµÐ½Ð¸Ñ ÑƒÑ€Ð¾Ð²Ð½Ñ:",
				"opts_max_chatlines": "ÐœÐ°ÐºÑÐ¸Ð¼ÑƒÐ¼ ÑÑ‚Ñ€Ð¾Ðº Ð² Ñ‡Ð°Ñ‚Ðµ:",
				"opts_chat_opacity": "ÐŸÑ€Ð¾Ð·Ñ€Ð°Ñ‡Ð½Ð¾ÑÑ‚ÑŒ Ñ„Ð¾Ð½Ð° Ñ‡Ð°Ñ‚Ð°:",
				"opts_switch_to_ally_tab": "ÐŸÐµÑ€ÐµÐ¹Ñ‚Ð¸ Ð²Ð¾ Ð²ÐºÐ»Ð°Ð´ÐºÑƒ Ð°Ð»ÑŒÑÐ½ÑÐ° Ð¿Ñ€Ð¸ Ð·Ð°Ð¿ÑƒÑÐºÐµ",
				"opts_show_queue_win": "ÐŸÐ¾ÐºÐ°Ð·Ñ‹Ð²Ð°Ñ‚ÑŒ Ð¾Ñ‡ÐµÑ€ÐµÐ´ÑŒ Ð² Ð¾ÐºÐ½Ðµ Ð¸Ð½Ñ„Ð¾Ñ€Ð¼Ð°Ñ†Ð¸Ð¸",
				"opts_limit_req_res": "Ð£ÑÑ‚Ð°Ð½Ð¾Ð²Ð¸Ñ‚ÑŒ Ð»Ð¸Ð¼Ð¸Ñ‚ Ð·Ð°Ð¿Ñ€Ð°ÑˆÐ¸Ð²Ð°ÐµÐ¼Ñ‹Ñ… Ñ€ÐµÑÑƒÑ€ÑÐ¾Ð² Ð¸ÑÑ…Ð¾Ð´Ñ Ð¸Ð· ÑÐ²Ð¾Ð±Ð¾Ð´Ð½Ð¾Ð³Ð¾ Ð¼ÐµÑÑ‚Ð° Ð² Ð³Ð¾Ñ€Ð¾Ð´Ðµ",
				"opts_inc_res": {
					"lab": "ÐŸÐ¾ÐºÐ°Ð· Ð¸Ð½Ñ„Ð¾Ñ€Ð¼Ð°Ñ†Ð¸Ð¸ Ð¾ Ð¿Ð¾ÑÑ‚ÑƒÐ¿Ð°ÑŽÑ‰Ð¸Ñ… Ñ€ÐµÑÑƒÑ€ÑÐ°Ñ…:",
					"disabled": "ÐžÑ‚ÐºÐ»ÑŽÑ‡Ð¸Ñ‚ÑŒ",
					"always": "Ð’ÑÐµÐ³Ð´Ð°",
					"context": "Ð•ÑÐ»Ð¸ Ð¿Ð¾ÑÑ‚ÑƒÐ¿Ð°ÑŽÑ‚"
				},
				"opts_separator": {
					"lab": "Ð Ð°Ð·Ð´ÐµÐ»ÑÑ‚ÑŒ Ñ‚Ñ‹ÑÑÑ‡Ð¸:",
					"period": "'.' (Ñ‚Ð¾Ñ‡ÐºÐ¾Ð¹)",
					"comma": "',' (Ð·Ð°Ð¿ÑÑ‚Ð¾Ð¹)",
					"space": "' ' (Ð¿Ñ€Ð¾Ð±ÐµÐ»Ð¾Ð¼)",
					"none": "Ð½Ðµ Ñ€Ð°Ð·Ð´ÐµÐ»ÑÑ‚ÑŒ"
				},
				"opts_city_tag": {
					"lab": "Ñ‚ÑÐ³ [city] Ð¿Ð¾ÐºÐ°Ð·Ñ‹Ð²Ð°ÐµÑ‚:",
					"info": "Ð˜Ð½Ñ„Ð¾Ñ€Ð¼Ð°Ñ†Ð¸ÑŽ Ð¾ Ð³Ð¾Ñ€Ð¾Ð´Ðµ",
					"region": "ÐœÐµÑÑ‚Ð¾ Ð² Ñ€ÐµÐ³Ð¸Ð¾Ð½Ðµ"
				},
				"opts_lowest_lvl": {
					"lab1": "Ð’Ñ‹Ð±ÐµÑ€Ð¸Ñ‚Ðµ Ð·Ð´Ð°Ð½Ð¸Ñ, ÐºÐ¾Ñ‚Ð¾Ñ€Ñ‹Ð¼ Ð²Ñ‹ Ñ…Ð¾Ñ‚Ð¸Ñ‚Ðµ Ð¿Ð¾Ð²Ñ‹ÑÐ¸Ñ‚ÑŒ ÑƒÑ€Ð¾Ð²ÐµÐ½ÑŒ Ñ Ð³Ð¾Ñ€ÑÑ‡ÐµÐ¹ ÐºÐ»Ð°Ð²Ð¸ÑˆÐµÐ¹ 'L (ÐŸÐ¾Ð²Ñ‹ÑˆÐµÐ½Ð¸Ðµ ÑƒÑ€Ð¾Ð²Ð½Ñ Ð»ÑŽÐ±Ð¾Ð³Ð¾ Ð½Ð¸Ð·ÐºÐ¾Ð³Ð¾ ÑƒÑ€Ð¾Ð²Ð½Ñ)'",
					"lab2": "ÐžÐ¿Ñ€ÐµÐ´ÐµÐ»Ð¸Ñ‚ÑŒ Ð¼Ð°ÐºÑÐ¸Ð¼Ð°Ð»ÑŒÐ½Ñ‹Ð¹ ÑƒÑ€Ð¾Ð²ÐµÐ½ÑŒ Ð¿Ð¾Ð²Ñ‹ÑˆÐµÐ½Ð¸Ñ ÐºÐ°Ð¶Ð´Ð¾Ð¹ Ð³Ñ€ÑƒÐ¿Ð¿Ñ‹ Ð´Ð»Ñ Ð³Ð¾Ñ€ÑÑ‡ÐµÐ¹ ÐºÐ»Ð°Ð²Ð¸ÑˆÐ¸ 'L'",
					"towers": "Ð‘Ð°ÑˆÐ½Ð¸:",
					"military": "Ð’Ð¾ÐµÐ½Ð½Ñ‹Ðµ:",
					"resource": "Ð ÐµÑÑƒÑ€ÑÐ½Ñ‹Ðµ:",
					"cottage": "ÐšÐ¾Ñ‚Ñ‚ÐµÐ´Ð¶Ð¸:",
					"barracks": "ÐšÐ°Ð·Ð°Ñ€Ð¼Ñ‹:",
					"utilities": "ÐžÐ±ÑÐ»ÑƒÐ¶Ð¸Ð²Ð°ÑŽÑ‰Ð¸Ðµ:"
				},
				"opts_set_hotkeys": "ÐÐ°Ð¶Ð¼Ð¸Ñ‚Ðµ Ð½Ð° Ð¾Ð´Ð½Ñƒ Ð¸Ð· ÑÐ»ÐµÐ´ÑƒÑŽÑ‰Ð¸Ñ… ÐºÐ½Ð¾Ð¿Ð¾Ðº Ð¸ Ð·Ð°Ñ‚ÐµÐ¼ Ð½Ð°Ð¶Ð¼Ð¸Ñ‚Ðµ Ð½Ð° ÐºÐ»Ð°Ð²Ð¸ÑˆÑƒ, Ð´Ð»Ñ Ð¾Ð¿Ñ€ÐµÐ´ÐµÐ»ÐµÐ½Ð¸Ñ Ð³Ð¾Ñ€ÑÑ‡ÐµÐ¹ ÐºÐ»Ð°Ð²Ð¸ÑˆÐ¸",
				"opts_hotkey_labels": {
					"lab1": "Ð“Ð¾Ñ€ÑÑ‡Ð¸Ðµ ÐºÐ»Ð°Ð²Ð¸ÑˆÐ¸Ñ‚ Ð·Ð´Ð°Ð½Ð¸Ð¹:",
					"lab2": "Ð“Ð¾Ñ€ÑÑ‡Ð¸Ðµ ÐºÐ»Ð°Ð²Ð¸ÑˆÐ¸ Ð¿Ð¾Ð²Ñ‹ÑˆÐµÐ½Ð¸Ñ ÑƒÑ€Ð¾Ð²Ð½Ñ:",
					"lab3": "Ð“Ð¾Ñ€ÑÑ‡Ð¸Ðµ ÐºÐ»Ð°Ð²Ð¸ÑˆÐ¸ Ð¾Ð±Ð¾Ð³Ð°Ñ‰ÐµÐ½Ð¸Ñ Ñ€ÐµÑÑƒÑ€ÑÐ¾Ð²:",
					"lab4": "Ð“Ð»Ð¾Ð±Ð°Ð»ÑŒÐ½Ñ‹Ðµ Ð³Ð¾Ñ€ÑÑ‡Ð¸Ðµ ÐºÐ»Ð°Ð²Ð¸ÑˆÐ¸:",
					"upgrade": "ÐŸÐ¾Ð²Ñ‹ÑˆÐµÐ½Ð¸Ðµ ÑƒÑ€Ð¾Ð²Ð½Ñ Ð·Ð´Ð°Ð½Ð¸Ñ",
					"downgrade": "ÐŸÐ¾Ð½Ð¸Ð¶ÐµÐ½Ð¸Ðµ ÑƒÑ€Ð¾Ð²Ð½Ñ / Ð¡Ð½Ð¾Ñ (Shift+)",
					"minister": "ÐÐ°Ð·Ð½Ð°Ñ‡Ð¸Ñ‚ÑŒ Ð¼Ð¸Ð½Ð¸ÑÑ‚Ñ€Ð°",
					"prev_city": "ÐŸÑ€ÐµÐ´Ñ‹Ð´ÑƒÑ‰Ð¸Ð¹ Ð³Ð¾Ñ€Ð¾Ð´",
					"next_city": "Ð¡Ð»ÐµÐ´ÑƒÑŽÑ‰Ð¸Ð¹ Ð³Ð¾Ñ€Ð¾Ð´"
				},
				"opts_clr_inc_res": "Ð¦Ð²ÐµÑ‚ ÑˆÑ€Ð¸Ñ„Ñ‚Ð° Ð¾ÐºÐ½Ð° Ð¿Ð¾ÑÑ‚ÑƒÐ¿Ð°ÑŽÑ‰Ð¸Ñ… Ñ€ÐµÑÑƒÑ€ÑÐ¾Ð²:",
				"opts_clr_chat": {
					"lab": "Ð¦Ð²ÐµÑ‚ ÑˆÑ€Ð¸Ñ„Ñ‚Ð° Ñ‡Ð°Ñ‚Ð°:",
					"all": "Ð’ÑÐµ:",
					"alliance": "ÐÐ»ÑŒÑÐ½Ñ:",
					"whisper": "Ð›Ð¸Ñ‡Ð½Ñ‹Ðµ ÑÐ¾Ð¾Ð±Ñ‰ÐµÐ½Ð¸Ñ ",
					"background": "Ð¤Ð¾Ð½:",
					"social": "Social:",
					"louwin": "LoU:"
				},
				"opts": {
					...
					"import": "Ð˜Ð¼Ð¿Ð¾Ñ€Ñ‚",
					"export_lab": "Ð’Ñ‹ Ð¼Ð¾Ð¶ÐµÑ‚Ðµ ÑÐ¾Ñ…Ñ€Ð°Ð½Ð¸Ñ‚ÑŒ ÑÑ‚Ð¸ ÑÑ‚Ñ€Ð¾ÐºÐ¸ Ð² Ñ‚ÐµÐºÑÑ‚Ð¾Ð²Ñ‹Ð¹ Ñ„Ð°Ð¹Ð» Ð¸ Ð¸Ð¼Ð¿Ð¾Ñ€Ñ‚Ð¸Ñ€Ð¾Ð²Ð°Ñ‚ÑŒ ÐºÐ¾Ð³Ð´Ð° Ð¿Ð¾Ð½Ð°Ð´Ð¾Ð±Ð¸Ñ‚ÑÑ.",
					"import_lab": "Ð’ÑÑ‚Ð°Ð²ÑŒÑ‚Ðµ ÑÐ¾Ñ…Ñ€Ð°Ð½ÐµÐ½Ð½Ñ‹Ðµ Ð½Ð°ÑÑ‚Ñ€Ð¾Ð¹ÐºÐ¸ LoU Tweak Ð² Ñ‚ÐµÐºÑÑ‚Ð¾Ð²Ð¾Ðµ Ð¿Ð¾Ð»Ðµ Ð¸ Ð½Ð°Ð¶Ð¼Ð¸Ñ‚Ðµ OK.",
					"import_invalid": "Ð’ÑÑ‚Ð°Ð²Ð»ÐµÐ½Ð½Ð°Ñ ÑÑ‚Ñ€Ð¾ÐºÐ° Ð½Ðµ Ð¿Ð¾Ð´Ñ…Ð¾Ð´Ð¸Ñ‚"
				},
				"layout": {
					"city": "ÐŸÐ»Ð°Ð½ Ð³Ð¾Ñ€Ð¾Ð´Ð°",
					"overlay": "ÐÐ°Ð»Ð¾Ð¶ÐµÐ½Ð¸Ðµ Ð¿Ð»Ð°Ð½Ð°",
					"apply": "ÐŸÑ€Ð¸Ð¼ÐµÐ½Ð¸Ñ‚ÑŒ Ð¿Ð»Ð°Ð½",
					"remove": "Ð£Ð´Ð°Ð»Ð¸Ñ‚ÑŒ Ð¿Ð»Ð°Ð½"
				},
				"opts_lang": {
					"lab": "LoU Tweak language",
					"en": "English (Englisch)",
				...
				"purify_btn_tt": "ÐÐ°Ð¶Ð¼Ð¸Ñ‚Ðµ, Ñ‡Ñ‚Ð¾ Ð±Ñ‹ Ð¾Ñ‚ÐºÑ€Ñ‹Ñ‚ÑŒ Ð¾ÐºÐ½Ð¾ 'ÐŸÐ¾ÑÐ»Ð°Ñ‚ÑŒ Ñ€ÐµÑÑƒÑ€ÑÑ‹'",
				"opts_minimap": {
					"enable_lab": "Ð’ÐºÐ»ÑŽÑ‡Ð¸Ñ‚ÑŒ Ð¼Ð¸Ð½Ð¸ÐºÐ°Ñ€Ñ‚Ñƒ",
					"clrs_lab": "Ð¦Ð²ÐµÑ‚Ð° Ð½Ð° Ð¼Ð¸Ð½Ð¸ÐºÐ°Ñ€Ñ‚Ðµ:",
					"show_cities": "ÐŸÐ¾ÐºÐ°Ð·Ð°Ñ‚ÑŒÑ‚ Ð³Ð¾Ñ€Ð¾Ð´Ð°",
					"show_none": "ÐÐ¸Ñ‡ÐµÐ³Ð¾",
					"show_noncastle": "Ð‘ÐµÐ· Ð·Ð°Ð¼ÐºÐ°",
					"show_castle": "Ð—Ð°Ð¼Ð¾Ðº",
					"show_all": "Ð’ÑÐµ",
					"show_self": "ÐœÐ¾Ð¹",
					"show_alliance": "ÐÐ»ÑŒÑÐ½Ñ",
					"show_allied": "Ð¡Ð¾ÑŽÐ·Ð½Ð¸Ðº",
					"show_enemy": "Ð’Ñ€Ð°Ð³",
					"show_nap": "NAP",
					"show_other": "Ð”Ñ€ÑƒÐ³Ð¾Ðµ",
					"show_lawless": "Ð’Ð½Ðµ Ð·Ð°ÐºÐ¾Ð½Ð°",
					"show_moongate": "Ð›ÑƒÐ½Ð½Ñ‹Ðµ Ð²Ð¾Ñ€Ð¾Ñ‚Ð°",
					"show_shrine": "Ð¡Ð²ÑÑ‚Ð¸Ð»Ð¸Ñ‰Ðµ",
					"clr_self": "Ð¡Ð°Ð¼:",
					"clr_alliance": "ÐÐ»ÑŒÑÐ½Ñ:",
					"clr_allied": "Ð¡Ð¾ÑŽÐ·Ð½Ð¸Ðº:",
					"clr_enemy": "Ð’Ñ€Ð°Ð³:",
					"clr_nap": "NAP:",
					"clr_other": "Ð”Ñ€ÑƒÐ³Ð¾Ðµ:",
					"clr_lawless": "ÐÐ°Ñ€ÑƒÑˆÐ°ÑŽÑ‰Ð¸Ð¹:",
					"clr_moongate": "Ð›ÑƒÐ½Ð½Ñ‹Ðµ Ð²Ñ€Ð°Ñ‚Ð°:",
					"clr_shrine": "Ð¡Ð²ÑÑ‚Ð¸Ð»Ð¸Ñ‰Ðµ:"
				},
				"trade_limit": "Ð›Ð¸Ð¼Ð¸Ñ‚",
				"no": "ÐÐµÑ‚",
				"yes": "Ð”Ð°",
				"req_restart": "(Ñ‚Ñ€ÐµÐ±ÑƒÐµÑ‚ÑÑ Ð¿ÐµÑ€ÐµÐ·Ð°Ð³Ñ€ÑƒÐ·ÐºÐ°)",
				"opts_save_ss_cn": "Ð¡Ð¾Ñ…Ñ€Ð°Ð½Ð¸Ñ‚ÑŒ Ð¼Ð°ÐºÐµÑ‚ Sharestring Ð² Ð·Ð°Ð¼ÐµÑ‚ÐºÐ°Ñ… Ð³Ð¾Ñ€Ð¾Ð´Ð°",
				"opts_trade_lab_max_amount": "Amount of Trade Summary labels to be displayed:",
				"show_get_use_btn_tt": "Show 'Get & Use' buttons",
				"opts_hide_get_use": "Hide 'Get & Use' buttons",
				"btn_trade_show": "Show Trade Summary labels",
			...
			"it": {
				...
				"opts_limit_req_res": "Impostare un limite di risorse richieste in base allo spazio disponibile in cittÃ ",
				"opts_inc_res": {
				...
				"opts_city_tag": {
					...
					"info": "Informazioni citÃ '",
					"region": "Vista Regione"
				},
				"opts_lowest_lvl": {
					"lab1": "Seleziona gli edifici che vuoi potenziare con il tasto 'L' (potenzia tutte gli edifici piÃ¹ bassi)",
			...
			"fr": {
				"options_btn_tt": "Cliquez pour accÃ©der aux Options de LoU Tweak",
				"layout_btn_tt": "Cliquez pour gÃ©nÃ©rer un 'Sharestring' pour la ville actuelle",
				"chat_btn_city": "Ville",
				"chat_btn_player": "Joueur",
				"chat_btn_alliance": "Alliance",
				"chat_btn_url": "Lien",
				"copy_coords_btn": "Copier les coordonnÃ©es dans le chat",
				"up_count_tt": "BÃ¢timents disponibles pour mise Ã  niveau :",
				"opts_max_chatlines": "Lignes maximum dans le chat :",
				"opts_chat_opacity": "Transparence de l'arriÃ¨re-plan du chat :",
				"opts_switch_to_ally_tab": "Aller Ã  l'onglet Alliance au dÃ©marrage",
				"opts_show_queue_win": "Montrer la fenÃªtre de file d'attente",
				"opts_limit_req_res": "Limiter les ressources demandÃ©es Ã  l'espace libre dans la ville",
				"opts_inc_res": {
				...
				"opts_city_tag": {
					...
					"region": "Vue de la rÃ©gion "
				},
				"opts_lowest_lvl": {
					"lab1": "SÃ©lectionnez les bÃ¢timents que vous souhaitez mettre Ã  niveau avec 'L' (mise Ã  niveau des plus bas niveau) ",
					"lab2": "DÃ©finissez les niveaux maximum de chaque type de groupe auquel 'L' doit arrÃªter la mise Ã  niveau",
					"towers": "Tours :",
					"military": "Militaire :",
					"resource": "Ressources :",
					"cottage": "Cottages :",
				...
				"opts_set_hotkeys": "Cliquez sur un des boutons suivants, puis appuyez sur une touche pour dÃ©finir des raccourcis",
				"opts_hotkey_labels": {
					"lab1": "Raccourci Construire :",
					"lab2": "Raccourci Monter de niveau :",
					"lab3": "Raccourci CrÃ©ation de pierre lunaire :",
					"lab4": "Raccourci Globaux :",
					"upgrade": "Monter niveau bÃ¢timent",
					"downgrade": "Baisser niveau / DDÃ©molir (Shift+)",
					"minister": "Assigner au Ministre",
					"prev_city": "Ville prÃ©cÃ©dente",
				...
				"opts": {
					...
					"export": "Exporter",
					"import": "Importer",
					"export_lab": "Vous pouvez enregistrer cette chaÃ®ne dans un fichier texte et l'importer plus tard, lorsque cela est nÃ©cessaire.",
					"import_lab": "InsÃ©rez les donnÃ©es sauvÃ©es de LoU Tweak Options dans le champ texte et appuyez sur OK.",
					"import_invalid": "La chaÃ®ne insÃ©rÃ©e est invalide"
				},
				"layout": {
				...
				"purify_btn_tt": "Cliquez ici pour ouvrir la fenÃªtre 'Purifier des ressources'",
				"opts_minimap": {
					"enable_lab": "Activer la MiniMap",
					"clrs_lab": "Couleurs de la MiniMap :",
					"show_cities": "Montrer les villes",
					"show_none": "Rien",
					"show_noncastle": "Sans chÃ¢teau",
					"show_castle": "Avec chÃ¢teau",
					"show_all": "Tout",
					"show_self": "Moi",
					"show_alliance": "Alliance",
					"show_allied": "AlliÃ©s",
				...
				"no": "Non",
				"yes": "Oui",
				"req_restart": "(RedÃ©marrage nÃ©cessaire)",
				"opts_save_ss_cn": "Enregistrer la superposition des masques Sharestring dans les notes de la ville",
				"opts_trade_lab_max_amount": "Nombre d'opÃ©rations de commerce Ã  afficher :",
