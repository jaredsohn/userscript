// ==UserScript==
// @name           Koc Automatico Accetta tutti i regali di Kingdoms of Camelot,By UtherP
// @version        0.2
// @namespace      KOCQuickWidgets-AutoAcceptGifts
// @homepage       http://userscripts.org/
// @description    Questo script accetta tutti i regali di Kingdoms of Camelot sulle tue richieste di Facebook. Funziona per tutti i domini ma è più indicato per Glessic 125!
				...
				if(claim_gift){
					...
					if(domain_selector && (next_button1 || next_button2)){
						for(var i=0; i<domain_selector.options.length; i++){
							if(domain_selector.options[i].value == "125"){
