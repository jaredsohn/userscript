// ==UserScript==
// @name			HF Scripts - Easy Report Science, Religion, Philosophy, and Politics
// @namespace 		Glassy/hfreportingsciencereligionphilosophyandpolitics
// @description 	Makes reporting posts/threads in Science, Religion, Philosophy, and Politics section to Glassy MUCH easier.
// @include  		*hackforums.net/showthread.php*
// @version  		1.1.2
// ==/UserScript==

var navBit = document.getElementsByClassName('navigation')[0];
if(navBit.innerHTML.indexOf('<a href="forumdisplay.php?fid=128">Science, Religion, Philosophy, and Politics</a>') != -1) {
