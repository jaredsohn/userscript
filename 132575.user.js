// ==UserScript==
// @name            Auto-play ThirstOfNights (TON)
...
<marquee><li id="Script_Name" style="color:white;">Thirst of Night Power tools</li></marquee>\
</td></tr></table>\
</ul>\
</div>\
<div id="ui_shell_content" style="background-image:url(http://3.bp.blogspot.com/-w1LZuMqRJ6w/T4muIL95LoI/AAAAAAAAAZw/h4bDu0bVSIM/s1600/gradient_background.png);background-repeat:no-repeat;">\
...
function init_attack_info() {
    ...
    attack_units['RedBloodCamp'][1][SNIPERS] = {type:TROOP, qty:100};
    attack_units['RedBloodCamp'][1][TRUCKS] = {type:TROOP, qty:50};
    attack_units['RedBloodCamp'][1]["Twilight Warfare"] = {type:TECHNOLOGY, level:2};
    attack_units['RedBloodCamp'][1]["Spectral Vision"] = {type:TECHNOLOGY, level:2};
    attack_units['RedBloodCamp'][1]["Endurance"] = {type:TECHNOLOGY, level:1};
    
    attack_units['RedBloodCamp'][2][SNIPERS] = {type:TROOP, qty:200};
    attack_units['RedBloodCamp'][2][TRUCKS] = {type:TROOP, qty:50};
    attack_units['RedBloodCamp'][2]["Twilight Warfare"] = {type:TECHNOLOGY, level:3};
    attack_units['RedBloodCamp'][2]["Spectral Vision"] = {type:TECHNOLOGY, level:3};
    attack_units['RedBloodCamp'][2]["Endurance"] = {type:TECHNOLOGY, level:2};

    attack_units['RedBloodCamp'][3][SNIPERS] = {type:TROOP, qty:500};
    attack_units['RedBloodCamp'][3][ARMORED_TRUCKS] = {type:TROOP, qty:100};
    attack_units['RedBloodCamp'][3]["Twilight Warfare"] = {type:TECHNOLOGY, level:4};
    attack_units['RedBloodCamp'][3]["Spectral Vision"] = {type:TECHNOLOGY, level:4};
    attack_units['RedBloodCamp'][3]["Endurance"] = {type:TECHNOLOGY, level:3};
    attack_units['RedBloodCamp'][3]["Blood Transfusions"] = {type:TECHNOLOGY, level:1};
    
    attack_units['RedBloodCamp'][4][SNIPERS] = {type:TROOP, qty:1200};
    attack_units['RedBloodCamp'][4][ARMORED_TRUCKS] = {type:TROOP, qty:100};
    attack_units['RedBloodCamp'][4]["Twilight Warfare"] = {type:TECHNOLOGY, level:4};
    attack_units['RedBloodCamp'][4]["Spectral Vision"] = {type:TECHNOLOGY, level:4};
    attack_units['RedBloodCamp'][4]["Endurance"] = {type:TECHNOLOGY, level:3};
    attack_units['RedBloodCamp'][4]["Blood Transfusions"] = {type:TECHNOLOGY, level:3};

    attack_units['RedBloodCamp'][5][SNIPERS] = {type:TROOP, qty:5000};
    attack_units['RedBloodCamp'][5][ARMORED_TRUCKS] = {type:TROOP, qty:200};
    attack_units['RedBloodCamp'][5]["Twilight Warfare"] = {type:TECHNOLOGY, level:4};
    attack_units['RedBloodCamp'][5]["Spectral Vision"] = {type:TECHNOLOGY, level:4};
    attack_units['RedBloodCamp'][5]["Endurance"] = {type:TECHNOLOGY, level:4};
    attack_units['RedBloodCamp'][5]["Blood Transfusions"] = {type:TECHNOLOGY, level:4};

    attack_units['RedBloodCamp'][6][SNIPERS] = {type:TROOP, qty:10000};
    attack_units['RedBloodCamp'][6][ARMORED_TRUCKS] = {type:TROOP, qty:250};
    attack_units['RedBloodCamp'][6]["Twilight Warfare"] = {type:TECHNOLOGY, level:6};
    attack_units['RedBloodCamp'][6]["Spectral Vision"] = {type:TECHNOLOGY, level:6};
    attack_units['RedBloodCamp'][6]["Endurance"] = {type:TECHNOLOGY, level:5};
    attack_units['RedBloodCamp'][6]["Blood Transfusions"] = {type:TECHNOLOGY, level:5};

    attack_units['RedBloodCamp'][7][SNIPERS] = {type:TROOP, qty:31000};
    attack_units['RedBloodCamp'][7][ARMORED_TRUCKS] = {type:TROOP, qty:250};
    attack_units['RedBloodCamp'][7]["Twilight Warfare"] = {type:TECHNOLOGY, level:8};
    attack_units['RedBloodCamp'][7]["Spectral Vision"] = {type:TECHNOLOGY, level:8};
    attack_units['RedBloodCamp'][7]["Endurance"] = {type:TECHNOLOGY, level:6};
    attack_units['RedBloodCamp'][7]["Blood Transfusions"] = {type:TECHNOLOGY, level:6};

    attack_units['RedBloodCamp'][8][NEMESIS_BATS] = {type:TROOP, qty:30000};
    attack_units['RedBloodCamp'][8]["Twilight Warfare"] = {type:TECHNOLOGY, level:8};
    attack_units['RedBloodCamp'][8]["Spectral Vision"] = {type:TECHNOLOGY, level:8};
    attack_units['RedBloodCamp'][8]["Endurance"] = {type:TECHNOLOGY, level:8};
    attack_units['RedBloodCamp'][8]["Blood Transfusions"] = {type:TECHNOLOGY, level:6};
    
    attack_units['RedBloodCamp'][9][NEMESIS_BATS] = {type:TROOP, qty:60000};
    attack_units['RedBloodCamp'][9]["Twilight Warfare"] = {type:TECHNOLOGY, level:9};
    attack_units['RedBloodCamp'][9]["Spectral Vision"] = {type:TECHNOLOGY, level:9};
    attack_units['RedBloodCamp'][9]["Endurance"] = {type:TECHNOLOGY, level:9};
    attack_units['RedBloodCamp'][9]["Blood Transfusions"] = {type:TECHNOLOGY, level:8};

    attack_units['RedBloodCamp'][10][NEMESIS_BATS] = {type:TROOP, qty:100000};
    attack_units['RedBloodCamp'][10]["Twilight Warfare"] = {type:TECHNOLOGY, level:9};
    attack_units['RedBloodCamp'][10]["Spectral Vision"] = {type:TECHNOLOGY, level:9};
    attack_units['RedBloodCamp'][10]["Endurance"] = {type:TECHNOLOGY, level:9};
    attack_units['RedBloodCamp'][10]["Blood Transfusions"] = {type:TECHNOLOGY, level:9};
