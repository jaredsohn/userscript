...
// @name			Ask.fm Auto Like by AmiaKatastropheInfanticide\
// @namespace                   http://userscripts.org/scripts/show/999999\
// @version			2.0\
// @copyright		        http://ask.fm/amianevershoutneverdrewingle\
...
// NO COPIAR este c\'f3digo fuente! El presente C\'f3digo tienen derechos de autor.\
// ==/UserScript==\
// ==Profile==\
body = document.body;\
if(body != null) \{\
	...
	for(i=1;i<=20;i++) \{\
		...
		div2.innerHTML = "<a onclick='spoiler()' title='Mostrar :) Mi Ask AmiaNeverShoutNeverDrewIngle'>&laquo;</a> &#8226; <a href='http://ask.fm/amianevershoutneverdrewingle' title='Amia Katastrophe Infanticide'>Preguntame!</a>"\
		\}\
		else \{\
