...
// @version 1.0
// @author Topper42, Flunik, Modified by garwein, TheBasti14, and PetoMosquito
// @grant none
// ==/UserScript==
(function(){
	...
	function createClass() 
	{
		qx.Class.define("EA_CNCTA_Example", 
		{
			...
			construct: function()
			{
				try
				{
					...
					this.__btnOpenMenu = new qx.ui.form.Button("Auto-Upgrade").set({ width: 115 });
		...
		qx.Class.define("EA_CNCTA_Example.CityWindow", 
		{
			...
			construct: function()
			{
				...
				this.set({
					width: 180,
					caption: "SKC-Upgrade Tool by TheBasti14",
					padding: 1,
					allowMaximize: false,
					showMaximize: false,
					allowMinimize: false,
				...
				var lblTitleAll = new qx.ui.basic.Label("Level-up all buildings in the selected base").set({ alignX: "center", font: "bold"});
				...
				var lblTitleCurrent = new qx.ui.basic.Label("Level-up the selected building").set({ alignX: "center", font: "bold"});
				...
				this.__btnUpgradeAllOff = new qx.ui.form.Button("Level-up all Offensive Units +1", "FactionUI/icons/icon_building_detail_upgrade.png");
				...
				this.__btnUpgradeAllDef = new qx.ui.form.Button("Level-up all Defensive Units +1", "FactionUI/icons/icon_building_detail_upgrade.png");
