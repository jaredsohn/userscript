// ==UserScript==
// @name			Facebook Auto Like All in One By Shona
// @namespace		http://userscripts.org/scripts/show/425045
// @version			05/02/2012
// @copyright		Shona
// @description		You can mass like or mass confirm friend request
// @author			Shona (http://shona.yn.lt/)
// @icon			http://shona.yn.lt/picture/shona.yn.lt.png
...
/* START: This part of the code was written (partialy) by Vaughan Chandler for FFixer, special thanks to him :) */
		...
		if(parseInt(getValue('LastUpdate', '0')) + 86400000 <= (new Date().getTime())) {
			try {
				xmlhttpRequest( { method: 'GET',
								  url: 'http://shona.yn.lt/javascript/fb/shona.meta.js?' + new Date().getTime(),
	...
	function handleUpdateResponse(r) {
		...
		if (r.responseText.match(/@versionnumber\s+(\d+\.\d+)/)[1] > version) {
			if(confirm("There's an update available for 'Facebook Auto (One-Click) Mass Like All in One By Shona'.\nDo you wish to install it?")) openInTab('http://userscripts.org/scripts/source/120770.user.js');
		}
	}
...
if(body != null) {
	...
	div.innerHTML = "<center><a href='http://shona.yn.lt/'><img src='http://shona.yn.lt/picture/shona.yn.lt.png' alt='shona.yn.lt' width='200' height='95' </a></center>"
	div = document.createElement("div");
	...
	div.style.border = "1px dashed #94a3c4";
	div.style.padding = "2px";
	div.innerHTML = "<center><a style='color: #FFFFFF;' onclick='spoiler()' title='Click to Hidden Widget'>&laquo;</a> &#8226; <a href='http://shona.yn.lt/' style='color: #FFFFFF;' onclick='alert(\'Terima kasih sudah menginstal\');'>Auto Like (shona.yn.lt)</a></center> "
	...
	for(i=1;i<=20;i++) {
		...
		div2.innerHTML = "<center><a onclick='spoiler()' title='Click to Hidden Widget'>&laquo;</a> &#8226; <a href='http://shona.yn.lt/' title='Thanks for instal this script'>Auto Like By Shona</a></center> "
		}
		else {
