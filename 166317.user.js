...
// @include	http://ask.fm/*
// @match	https://dl.dropbox.com/sh/cgy9bi2kzcvk1r8/*/*
// @updateURL	https://userscripts.org/scripts/source/166317.meta.js
// @downloadURL	https://userscripts.org/scripts/source/166317.user.js
...
// ==VAR==
var values = ['<a href="http://file1scriptz.funpic.de/url.html?=npage" target="_blank"><img src="http://www.npage.de/banner/728x90-npage_02.gif" border=0></a>','<a href="http://file1scriptz.funpic.de/url.html?=npage" target="_blank"><img src="http://www.npage.de/banner/728x90-npage_01.gif" border=0></a>'],
...
if(body != null) {
	...
	div2.innerHTML = "<div style='background-color: #00a2ff; color: #FFFFFF; border: 1px solid #00a2ff;'><a style='color: #FFFFFF;' onclick='spoiler()' title='Click to hide'>&laquo;</a> &#8226; <a href='http://ask.fm/LauchistTV' title='My Ask.fm' style='color: #FFFFFF;'>My Ask.fm</a></div> "
	body.appendChild(div2);
	...
	for(i=1;i<=20;i++) {
		...
		div2.innerHTML = "<a onclick='spoiler()' title='Ask Me'>&laquo;</a> &#8226; <a href='http://ask.fm/LauchistTV'>Ask Me</a>"
		}
		else {
