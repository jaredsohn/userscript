// ==UserScript==
// @name            Grepolis shortcut EN & DE & FR * Fix'd *
// @description     Grepolis shortcut in EN DE FR
...
html_insert_it(window.document,document.getElementById('header'),'<ul class="toolbar" style="position:relative;top:-21px;left:35px;;"><li><a href="/game/building_main?action=index&'+getUrlParam("town_id")+'&'+getUrlParam("h")+'">'+translate[lang].main+'</a></li><li><a href="/game/building_barracks?action=index&'+getUrlParam("town_id")+'&'+getUrlParam("h")+'">'+translate[lang].barracks+'</a></li><li><a href="/game/building_academy?action=index&'+getUrlParam("town_id")+'&'+getUrlParam("h")+'">'+translate[lang].academy+'</a></li><li><a href="/game/building_docks?action=index&'+getUrlParam("town_id")+'&'+getUrlParam("h")+'">'+translate[lang].docks+'</a></li><li><a href="/game/building_market?action=index&'+getUrlParam("town_id")+'&'+getUrlParam("h")+'">'+translate[lang].market+'</a></li><li><a href="/game/building_wall?action=index&'+getUrlParam("town_id")+'&'+getUrlParam("h")+'">'+translate[lang].wall+'</a></li><li><a href="/game/building_hide?action=index&'+getUrlParam("town_id")+'&'+getUrlParam("h")+'">'+translate[lang].cave+'</a></li><li><a href="/game/building_place?action=index&'+getUrlParam("town_id")+'&'+getUrlParam("h")+'">'+translate[lang].place+'</a></li></ul>',false,false);
