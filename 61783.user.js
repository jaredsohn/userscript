// Copyright (c) 2009-2012 Foppe Hemminga
...
// Should work in Greasemonkey and in Chrome
...
//	console.log("crimeG: " + crimeG)
	crimeTotal = parseInt( parseInt( crimeG ) + parseInt( crimeB ) + parseInt( crimeR ) );
//	console.log("Total number of crimes: " + crimeTotal);
	return crimeTotal;
}	
...
jQuery(document).ready(function() {
    ...
    if (crime && !crimeText) {
        ...
        numberOfCrimes = parseInt( numberOfCrimes ) + 1;
        ...
        hasRed = $("div[align=left] center table tbody tr td")
                 .find("font[color=#AA0000]").attr("color");

        if (hasGreen == '#006600') {
            // Number of successes or green
            var numberOfCrimesGreen = GM_getValue(crimeSuccess, 0);
            numberOfCrimesGreen = parseInt( numberOfCrimesGreen ) + 1;
        ...
        if (hasBrown == '#663300') {
            ...
            numberOfCrimesBrown = parseInt( numberOfCrimesBrown ) + 1;
        ...
        if (hasRed == '#AA0000') {
            ...
            numberOfCrimesRed = parseInt( numberOfCrimesRed ) + 1;
