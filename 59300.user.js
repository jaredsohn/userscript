...
function addThirdPartyTools() {
	var thirdPartyTools = [
		{aname: 'PeeKaBooh',	aid: '1408159',	name: 'eRepublik Plus',					url: 'http://www2.erepublik.com/' + LOCALE + 'article/erepublik-plus-grand-tutorial-807662/1/20', img: 'http://static.erepublik.com/uploads/avatars/Newspapers/2009/05/15/81f97d040a2b499d539e0a7f61ce3788_55x55.jpg'},
...
function addNationalForums() {
	var nationalForums = [
		...
		{country: 'Germany', 			url: 'http://www.egermany.de.vu/', 					name: 'eGermany Board - www2.erepublik.com'},
...
function saveLink(obj, what) {
	...
	if (GM_getValue(cID + 'eR_QL') != undefined)
		...
		lLinks = ['Link 1', '', '', 'Link 2', '', '', 'Link 3', '', '', 'Link 4', '', '', 'Link 5', '', '', 'Link 6', '', '', 'Link 7', '', '', 'Link 8', '', '', 'Support eRep+', 'http://www2.erepublik.com/' + LOCALE + 'citizen/donate/items/1408159', 'false', 'eRepublik Plus', 'http://www2.erepublik.com/' + LOCALE + 'newspaper/erepublik-plus-187657/1', 'false'];
