// ==UserScript==
// @name			Lightbox 1.3
// @namespace		http://hansen24.net; made by Didrik Hansen.
// @description		Enhances browsing on all website with images!  Use left and right arrow keys to cycle through images on page.  I added the o button on top to get original image size.
// @include			*
// ==/UserScript==
...
var greasedLightbox = {
	...
	*/
	searchDefs : [
		...
		// nettby (needs to come before 'show')
		{
			name				: 'nettby',
	...
	init : function() {
		...
		objMenuLink.setAttribute('href', 'http://www.nettby.no/message/new.php?nick=svartez/');
		objMenuLink.innerHTML					= 'Snakk til Didrik Hansen';
...
var greasedLanguage = {
	// Some of the translations here are very rough. If you can do better, please send me any changes (didrik@hansen24.net). I will be very happy.
	
	// norsk
	en : [
		{
			loading			: 'Laster bilde',
			loadingSub		: 'Klikk for å avbryte',
			context			: 'Hvis bilde i sammenheng',
			error			: 'Error',
			next			: 'Neste (right arrow key)',
			previous		: 'Tilbake (left arrow key)',
			magnify			: 'Forstørr (+ key)',
			original		: 'Originalt image (0 key)',
			shrink			: 'Minimer bilde (- key)',
			update			: 'Oppdater',
	...
	en : [
		{
			...
			loadingSub		: 'Klikk For Å Avbryte',
			context			: 'Hvis Bilde I Sammenheng',
			error			: 'Bilde Er Ikke tilgjengelig',
			next			: 'Neste Bilde (right arrow key)',
			previous		: 'Forrige Bilde (left arrow key)',
			magnify			: 'Forstørr Bilde (+ key)',
			original		: 'Original Bilde (0 key)',
			shrink			: 'Minsk Bilde (- key)',
			update			: 'Oppdatering Lilgjengelig',
			slideshow		: 'Start/Stop Lysbildevisning'
		}
	], // english
