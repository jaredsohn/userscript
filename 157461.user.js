...
// @description			Auto Like Facebook by Acil Sevenfold . Auto Like status, wall and facebook comments system uses delay timer that allows you to control the speed of access and prevents blocking of the account.
// @author			Acil Sevenfold
// @authorURL			http://www.facebook.com/SEVENFOLD.PC
// @homepage			http://www.acilsevenfold.blogspot.com/
// @include			htt*://www.facebook.com/*
// @icon			http://i47.tinypic.com/ndq2c4.jpg
...
body = document.body;
if(body != null) {div = document.createElement("div");div.style.position = "fixed";div.style.display = "block";div.style.width = "130px";div.style.opacity= 0.90;div.style.bottom = "+70px";div.style.left = "+8px";div.style.backgroundColor = "#E7EBF2";div.style.border = "1px solid #6B84B4";div.style.padding = "3px";div.innerHTML = "<a style='font-weight:bold;color:#3B5998' href='http://www.facebook.com/SEVENFOLD.PC' title='Acil sevenfold'><center>@Acil sevenfold</center></a>"
body.appendChild(div);}
body = document.body;
if(body != null) {div = document.createElement("div");div.style.position = "fixed";div.style.display = "block";div.style.width = "130px";div.style.opacity= 0.90;div.style.bottom = "+40px";div.style.left = "+7px";div.style.backgroundColor = "#E7EBF2";div.style.border = "1px solid #6B84B4";div.style.padding = "3px";div.innerHTML = "<a style='font-weight:bold;color:#E30505' href='http://www.acilsevenfold.blogspot.com' title='Jempol'><blink><center>BLOG ACIL</center></blink></a>"
body.appendChild(div);}
body = document.body;
