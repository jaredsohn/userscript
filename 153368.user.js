...
// @license        Creative CommonsAttribution-ShareAlike 3.0 Unported License - http://creativecommons.org/licenses/by-sa/3.0
...
(function ()
{
	...
	var LS_mainFunction = function ()
	{
		...
		function createSuite()
		{
			...
			var units = {
				Berghöhle:    {
							    6: [25, 125, 450, 1100, 4500, 10000, 20000, 30000, 45000, 65000], // Berserker
                                3: [23, 147, 687, 2324, 4500, 9750, 21000, 30000, 54000, 90000], // Jäger
                                //4: [7, 32, 146, 375, 1250, 2834, 6250, 10417, 16667, 25000], // Guardian
		                        7: [35, 250, 1000, 4500, 7500, 15000, 35000, 50000, 80000, 125000], // Magier
		                        11: [11, 53, 245, 630, 2100, 4760, 10500, 17500, 28000, 42000], // Ritter
		                        5: [100, 600, 1500, 6000, 10000, 20000, 35000, 50000, 80000, 125000], // Templer
				...
				Hügelgrab:     {
                                ...
                                7: [35, 250, 1000, 4500, 7500, 15000, 35000, 50000, 80000, 125000], // Magier
                                11: [11, 46, 175, 595, 1750,3500 , 8400, 14000, 24500, 35000], // Ritter
                                12: [15, 65, 250, 850, 2500, 5000, 12000, 20000, 35000, 50000], // Hexenmeister
				},
				Waldhöhle:       {
								 6: [25, 125, 450, 1100, 4500, 10000, 20000, 30000, 45000, 65000], // Berserker
                                  3: [23, 147, 687, 2324, 4500, 9750, 21000, 30000, 54000, 90000], // Jäger
                                  //4: [5, 20, 75, 255, 750, 1500, 3600, 6000, 10500, 15000], // Guardian
                                  9: [25, 150, 500, 2000, 4500, 10000, 20000, 30000, 50000, 80000], // Armbrüste
		                    	   7: [35, 250, 1000, 4500, 7500, 15000, 35000, 50000, 80000, 125000], // Magier
                                  11: [10, 44, 167, 567, 1667, 3334, 8000, 13334, 23334, 33334], // Ritter
                                  10: [13, 75, 250, 700, 2250, 5000, 10000, 17500, 22500, 32500], // Paladine
							},
					Sea :      {
								16: [2, 9, 57, 110, 277, 417, 567, 834, 1250, 1667], // Schaluppen
                                15: [1, 4, 23, 44, 111, 167, 227, 334, 500, 667], // Fregatten
                                 17: [1, 1, 6, 11, 28, 42, 57, 84, 125, 167], // Gallionen
							}
						};
					...
					_createToolBar                 :function ()
					{
						...
						var btnViewRegion = new qx.ui.form.Button("Gehe Region");
						...
						this.btnUpdateView = new qx.ui.form.Button("Suchen");
						...
						var btnRecount = new qx.ui.form.Button("Truppen Zählen");
						...
						this.chkViewAll = new qx.ui.form.CheckBox("Alle");
			...
			qx.Class.define("lou_suite.gui.BossRaider", {
				...
				members  :{
					...
					getUnitsPerBoss                :function ()
					{
						var units = {
							Dragon :{
								6 :[75, 450, 3000, 5000, 15000, 20000, 25000, 35000, 50000, 65000], // Berserker
								3 :[84, 500, 3334, 6667, 20000, 30000, 40000, 55000, 80000, 110000], // Jäger
								5 :[100, 600, 4000, 8000, 20000, 30000, 40000, 60000, 90000, 120000], // Templer
								9 :[100, 450, 3000, 7500, 15500, 20000, 30000, 40000, 60000, 80000], // Armbrüste
								11:[25, 250, 1000, 1850, 5000, 7500, 10000, 15000, 18500, 25000], // Ritter
								7 :[36, 215, 1429, 2858, 7143, 10715, 14286, 21429, 32143, 42858], // Magier
								12:[21, 125, 834, 1667, 4167, 6250, 8334, 12500, 18750, 250000], // Hexenmeister
								10:[55, 350, 2000, 4000, 10000, 15000, 18500, 30000, 40000, 55000], // Paladine
							},
							Moloch :{
								6 :[75, 450, 3000, 5000, 15000, 20000, 25000, 35000, 50000, 65000], // Berserker
								3 :[84, 500, 3334, 6667, 20000, 30000, 40000, 55000, 80000, 110000], // Jäger
								5 :[100, 600, 4000, 8000, 20000, 30000, 40000, 60000, 90000, 120000], // Templer
								9 :[100, 450, 3000, 7500, 15500, 20000, 30000, 40000, 60000, 80000], // Armbrüste
								11:[28, 167, 1112, 2223, 5556, 8334, 11112, 16667, 25000, 33334], // Ritter
								7 :[24, 143, 972, 1886, 4743, 7143, 9715, 14286, 21429, 28572], // Magier
								12:[40, 225, 1034, 2067, 5167, 8250, 10034, 15500, 20750, 275000], // Hexenmeister
								10:[55, 350, 2000, 4000, 10000, 15000, 18500, 30000, 40000, 55000], // Paladine
							},
							Hydra  :{
								6 :[75, 450, 3000, 5000, 15000, 20000, 25000, 35000, 50000, 65000], // Berserker
								3 :[84, 500, 3334, 6667, 20000, 30000, 40000, 55000, 80000, 110000], // Jäger
								5 :[68, 400, 2720, 5280, 13280, 20000, 27200, 40000, 60000, 80000], // Templer
								9 :[100, 450, 3000, 7500, 15500, 20000, 30000, 40000, 60000, 80000], // Armbrüste
								11:[28, 167, 1112, 2223, 5556, 8334, 11112, 16667, 25000, 33334], // Ritter
								7 :[36, 215, 1429, 2858, 7143, 10715, 14286, 21429, 32143, 42858], // Magier
								12:[40, 225, 1034, 2067, 5167, 8250, 10034, 15500, 20750, 275000], // Hexenmeister
