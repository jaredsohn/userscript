// ==UserScript==
// @name           The-West Wardrobe 1.30 Slovak version
...
var wardrobe_text={en:'Wardrobe', sk:'Šatník', cz:'Skříň'};
var new_name_text={en:'New name', sk:'Nový názov', cz:'Nový název'};
var cancel_button_text={en:'Cancel', sk:'Zrušiť', cz:'Zrušit'};
var delete_button_text={en:'Delete', sk:'Zmazať', cz:'Smazat'};
var save_button_text={en:'Save', sk:'Uložiť', cz:'Uložit'};
var save_message_text={en:'Wardrobe is saved', sk:'Šatník bol uložený', cz:'Skříň byla uložena'};
...
function createDropdown()
{
	...
	newLI.innerHTML= "<a href=\"#\"><div style=\"z-index:100; background-image:url(http://thi.uloz.to/7/b/5/7b587fd29dc7d05b0deab0fd732b559e.800x600.png); background-repeat:no-repeat; background-position:left top; width:128px; height:25px;\" onMouseMove=\"this.style.backgroundPosition = 'left bottom'\" onMouseOut=\"this.style.backgroundPosition = 'left top'\"></div></a>";
