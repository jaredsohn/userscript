// ==UserScript==
// @name           Links converter for iPod Touch Fans.com
// @namespace      127.0.0.1
// @description    Every link that goes out of ITF.com is encrypted with base64 - this link will remove it so you don't have to click twice. :p
// @include        http://www.ipodtouchfans.com/*
// @include        http://ipodtouchfans.com/*
// ==/UserScript==

//unsafeWindow.console.log("Start");
$ = unsafeWindow.jQuery;
// Base64 en/decoder for jQuery
...
// find posts with links containing "outgoing.ipo..."
$('#posts a[href*="outgoing.ipodtouchfans.com/?d"]').each(function(i) {
	hr = $(this).attr("href");
//	unsafeWindow.console.log(hr);
	// find the base64 in the url and repace ~ with =
	hr = (hr.replace(/.*outgoing\.ipodtouchfans\.com\/\?d=(.*)/, "$1")).replace(/%7E/gi, "=");
//	unsafeWindow.console.log(hr);
	$(this).attr("href", $.base64Decode(hr));
});

//unsafeWindow.console.log("End");