// ==UserScript==
// @name           CSS GPXPlus Bleu
// @namespace      http://www.gpxplus.net/
// @version        0.1
// @description    Changement des styles CSS de GPXPlus avec des styles personnalises : Bleu
...
addGlobalStyle('@import "http://s2.e-monsite.com/2010/03/20/02/css-blue.css"');
...
modifyImage.bySource("http://gpxplus.net/files/layout/dex.png", "http://s2.e-monsite.com/2010/03/20/12/dex-blue.png", 1);
modifyImage.bySource("http://gpxplus.net/files/layout/logo.png", "http://s2.e-monsite.com/2010/03/20/12/logo-blue.png", 1);
modifyImage.bySource("http://gpxplus.net/files/layout/online.gif", "http://s2.e-monsite.com/2010/03/20/02/online-blue.gif", 1);
