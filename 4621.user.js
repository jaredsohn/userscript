// ==UserScript==
// @name          gordies homebage
// @namespace     www.myspace.com/gordiie
// @description	  DIV SPACE BITCH!
...
s+= ".no{padding:0px; border:0px; margin:0px;}\n";
s+= "body {background:#CCCCCC fixed;margin-top:-110px;}\n";
s+= "div, table, td, th, .heading{background:transparent!important; border:0px!important;}\n";
s+= "*{font-family:verdana}\n";
s+= "a:link, a:active, a:visited {color:#000000!important;font:11px verdana!important;}\n";
s+= "a:hover {text-decoration:underline;color:63B8FF!important;}\n";
...
s+= "#topnav {background-color:#FFFFFF; border:2px solid #333333; padding:0!important; margin-bottom:10px;}\n";
s+= "#topnav a {font:normal 11px verdana!important; color:333333!important;  background-color:#FFFFFF; border:2px solid #333333;}\n";
...
s+= document.getElementById('splash_coolNewPeople').innerHTML = '<center><br>GORDIE IS SOO FRICKING COOOOLLL!!!!<br>HE OWNS BOOBAGE SPLOOGE!<br>MUHAHAHA</center>';"a[id*='ns1_HyperLink2']{display:inline; float:left!important; margin-left:-10px!important; margin-top:10px!important;text-align:center;font-size:12px!important;}\n";
...
s+= "a[id*='ar1_HyperLink2']{display:none!important;}\n";
s+= "a[id*='ar1_HyperLink3']{display:none!important;}\n";
s+= "a[id*='ar1_HyperLink4']{display:none!important;}\n";
s+= "a[id*='Bar1_EditCommentsHyperLink']{display:none!important;}\n";
