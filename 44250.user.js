...
if (location.pathname == '/settings.php') {
	...
	if (GET['act'] != 'Удафф Вконтакте') {
		...
		menuElements.innerHTML += '<li>'+settInActiveLink('vkPatch','?act=vkPatch','4.8em')+'</li>';
		...
		// Добавляем нашу вкладку
		menuElements.innerHTML += '<li class="activeLink">'+settActiveLink('vkPatch','?act=vkPatch','4.8em')+'</li>';
