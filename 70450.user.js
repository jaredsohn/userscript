// ==UserScript==
// @name           eRepublik Bicie dla TankÃ³w
// @version        0.138 dev
// @author         eCitizen Scyld
// @namespace      eCitizenScyld
// @description    Usprawnienia battlefielda dla TankÃ³w
// @include        http://www.erepublik.com/*/citizen/profile/*
// @include        http://www.erepublik.com/*/military/battlefield/*
// ==/UserScript==

// ===============================================================================
// Licencja i zrzeczenie siÄ™ odpowiedzialnoÅ›ci
// ===============================================================================
// Ten program udostÄ™pniam na zasadzie : podoba Ci siÄ™ - podeÅ›lij gold autorowi :D
// IloÅ›Ä‡ golda jest TwojÄ… prywatnÄ… sprawÄ….
// Konto autora: http://www.erepublik.com/pl/citizen/profile/1283469
// Program dostarczam bez Å¼adnych gwarancji oraz odpowiedzialnoÅ›ci za negatywne
// dziaÅ‚anie - korzystasz na wÅ‚asnÄ… odpowiedzialnoÅ›Ä‡.
...
var styles      =
  'div.BHTable { width: 200px; height: 72px; border: 1px solid #777; border-radius: 5px; padding: 3px; background-color: #333; } ' +
...
function bhStats(att, def, satt, sdef) {
  ...
  $j('div#myStatBox').html(
  	...
  	'<div class="BHTable" style="float:right"><table class="BHTable" style="float:right"><tr><td>Citizen</td><td>Kills</td><td>Influence</td></tr>' + def + '</table></div>' +
  	'</div>'
  );
...
// Upewniamy siÄ™ czy wymagana eRepowa jQuery jest zaÅ‚adowana
function GM_wait() {
