// ==UserScript==
// @name				TW-MoveReports-searching-نقل  و بحث في التقرير
// @author				Heinzel, pinjam, to arabic by araby
// @namespace			http://userscripts.org
// @description			  سكربات يقوم بي اعدت تصفية التقرير و نقل التقرير الىالمجموعات 
...
function createPreferencesMenu() {
	...
	span1.innerHTML += "<br /><br /><a href=http://www.plapl.com/>بلابل</a><br /><br />التصنيف حسب :<br />";
