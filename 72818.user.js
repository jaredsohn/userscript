...
// select "Twitter Page Follower by Mayank", and click Uninstall.
//
// --------------------------------------------------------------------
//
// ==UserScript==
// @name          Twitter Page Follower by Mayank
...
if(butts.length > 0) {
	...
	txt = "<div style=\"width:760px;margin:6px auto 0 auto;color:#ffffff;text-align:left\">";
		...
		txt += "</p>";
		txt += "<p>";
			txt += "<strong>Twitter Page Follower</strong> brought to you by <a href=\"http://twitter.com/mayank1509\" style=\"color:#2FC2EF\">@mayank1509</a>";
		txt += "</p>";
	txt += "</div>";
