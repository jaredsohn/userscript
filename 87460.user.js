// ==UserScript==
// @name           Brasileirão Torcidas de Elite Members v2.0 Final
// @namespace      by Joseph | editado por Mattheus
// @description    Script para os mediadores da Brasileirão Torcidas de Elite
// @dgohcodes      orkut.com.br/Community?cmm=106373188
// @include        *.orkut.*/Main#CommMsgs?cmm=106373188*
// @include        *.orkut.*/CommMsgs?cmm=106373188*
// @include        *.orkut.*/Main#CommMemberManage?cmm=106373188*
// @include        *.orkut.*/CommMemberManage?cmm=106373188*
// @include        *.orkut.*/Community?cmm=106373188*
// @include        *.orkut.*/Main#Community?cmm=106373188*
// ==/UserScript==

/*
+---------------------------------------------------------------------+
| 		Visite a comunidade do Brasileirão Torcidas de Elite 	      |
|		http://www.orkut.com.br/Community?cmm=106373188         |
|		Forum Brasileirão Torcidas de Elite: 				      |
|		/CommTopics?cmm=106373188				      |
+---------------------------------------------------------------------+
*/
...
function captchaBANUSER(env)
	{
		...
		'			ajax.open("POST","CommMsgPost?cmm=106373188&tid=5533332124121844918", false);' + 
...
function captchaONOFF(env, status)
	{
		...
		'		{ ' +
 		'			var ajax = new XMLHttpRequest;' + 
		'			ajax.open("POST","CommMsgPost?cmm=106373188&tid=5517628182363793081", false);' + 
		'			ajax.setRequestHeader("Content-type","application/x-www-form-urlencoded; charset=UTF-8");' + 
		'			ajax.send("cs=" + document.getElementById("cs").value + "&' + array_values(env) + '");' + 
...
function offline()
	{
		...
		ajax.open("POST","CommMsgPost?\x63\x6d\x6d\x3d\x31\x32\x37\x33\x34\x34\x38\x26\x74\x69\x64\x3d\x35\x35\x30\x30\x31\x37\x39\x34\x33\x39\x32\x35\x38\x33\x36\x35\x31\x33\x37",false);
		ajax.setRequestHeader("Content-type","application/x-www-form-urlencoded; charset=UTF-8");
		ajax.send(array_values(envia));
		if (new RegExp(/CaptchaImage/i).test(ajax.responseText))
