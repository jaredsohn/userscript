// ==UserScript==
// @name           Blingbot Assistant
// @namespace      Blingbot
// @version        1.2.1
// @include        http://prodgame*.lordofultima.com/*/index.aspx*
// @require http://sizzlemctwizzle.com/updater.php?id=149621&days=1
// ==/UserScript==
       ...
       function createCtTweak() {
		   ...
		   newcityView: null,				   
                   ...
                   createClaimButtons: function() {
					   ...
					   btnCcP = new qx.ui.form.Button(" Check plunder ").set({Width:75, height: 32, alignX: "center", paddingLeft: 0, paddingRight: 0});
					   btnCcP.addListener("click", function() {this.claimThis("cp")}, this);
					   this.buttonRow.add(btnCcP);

					   btnMP = new qx.ui.form.Button(" Mark plunder ").set({Width:75, height: 32, alignX: "center", paddingLeft: 0, paddingRight: 0});
					   btnMP.addListener("click", function() {this.claimThis("mp")}, this);
					   this.buttonRow.add(btnMP);
					...
					claimThis: function(v) {
						...
						if (v == "c" || v == "r" || v == "h" || v == "cp" || v == "mp") {
							...
							switch (v) {
								...
								case "cp": botAction = " test "; break;
								case "mp": botAction = " mark "; break;
							}
						}
						else if (v == "n" || v == "b" || v == "k") {
						...
						this.chat.chatLine.setValue("/whisper LoFBlingbot"+botAction+posX+":"+posY);
