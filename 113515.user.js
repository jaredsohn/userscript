// ==UserScript==
// @name           Neopets: Money Tree [ Grabs ]
// @namespace      http://userscripts.org/users/113515
// @description    Tries to pick when appear on Money Tree
...
function checkmoney() {
var i,highest=0,am=new Array(),amounts = $x("//b[contains(text(), 'plu')]",7);
