...
// @namespace
// @description    Replaces all YouTube comments with fortunes from the BSD 'fortune' program
...
var i, p;
for (i = 0; div = comments.snapshotItem(i); i++) {
	div.textContent = fortunes[Math.floor(Math.random() * fortunes.length)];
}
