...
// @author TWS DX Map - ÐŸÐ¾Ñ€Ð¾ÑÑÑ‡Ð¸Ð¹ÐšÐ¾Ñ‚
// @version 0.6.1
...
// ==/UserScript==
    ...
    /* what todo
	 Ð’ÑˆÐ¸Ñ‚ÑŒ Ð¿ÐµÑ€ÐµÐ¾Ð´ÐµÐ²Ð°Ð»ÐºÑƒ Ð¾Ñ‚ ÑÑ‚Ð¾Ñ€Ð°Ð½Ð° (Ð¼Ð°Ð»Ð¾Ð²ÐµÑ€Ð¾ÑÑ‚Ð½Ð¾, Ð¸Ð±Ð¾ ÐºÐ¾Ð´ Ñƒ Ð¿ÐµÑ€ÐµÐ¾Ð´ÐµÐ²Ð°Ð»ÐºÐ¸ Ð¿Ñ€Ð¾ÑÑ‚Ð¾ "Ð±Ð¾Ð¶ÐµÑÑ‚Ð²ÐµÐ½Ð½ÐµÐ½")
	 Ð’Ð¾Ð·Ð¼Ð¾Ð¶Ð½Ð¾ÑÑ‚ÑŒ Ð¿Ð¾Ð¸ÑÐºÐ° ÑÐµÑ€ÐµÐ±Ñ€ÑÐ½Ñ‹Ñ… Ð¸ Ð·Ð¾Ð»Ð¾Ñ‚Ñ‹Ñ… Ñ€Ð°Ð±Ð¾Ñ‚ Ð½Ð° ÐºÐ°Ñ€Ñ‚Ðµ. (ÐšÐ°Ñ€Ñ‚Ð¸Ð½ÐºÐ° ÐºÐ°Ñ€Ñ‚Ñ‹ - ÐŸÐ¾Ñ€Ð¾ÑÑÑ‡Ð¸Ð¹ÐšÐ¾Ñ‚)
	*/
	...
	(function(fn) {
	  ...
	  TWS.langs.ru_RU = {
		...
		auto_update : "ÐŸÑ€Ð¾Ð²ÐµÑ€ÐºÐ° Ð¾Ð±Ð½Ð¾Ð²Ð»ÐµÐ½Ð¸Ð¹",
		auto_update_title : "Ð Ð°Ð·Ñ€ÐµÑˆÐ¸Ñ‚ÑŒ Ð°Ð²Ñ‚Ð¾Ð¼Ð°Ñ‚Ð¸Ñ‡ÐµÑÐºÑƒÑŽ Ð¿Ñ€Ð¾Ð²ÐµÑ€ÐºÑƒ Ð¾Ð±Ð½Ð¾Ð²Ð»ÐµÐ½Ð¸Ð¹?",
		bank : "Ð‘Ð°Ð½Ðº",
		beeper_sound : "Ð—Ð²ÑƒÐº ÑƒÐ²ÐµÐ´Ð¾Ð¼Ð»ÐµÐ½Ð¸Ñ:",
		beeper_set_sound : "Ð£ÑÑ‚Ð°Ð½Ð¾Ð²Ð¸Ñ‚ÑŒ",
		changed : "Ð˜Ð·Ð¼ÐµÐ½ÐµÐ½Ð¾ ÑƒÑÐ¿ÐµÑˆÐ½Ð¾!",
		chat_title : "Ð§Ð°Ñ‚",
		church : "Ð¦ÐµÑ€ÐºÐ¾Ð²ÑŒ",
		default : "Ð¡Ñ‚Ð°Ð½Ð´Ð°Ñ€Ñ‚Ð½Ñ‹Ð¹",
		dont_have_hotel: "Ð£ Ñ‚ÐµÐ±Ñ Ð½Ðµ Ð¿Ð¾ÑÑ‚Ñ€Ð¾ÐµÐ½ Ð¾Ñ‚ÐµÐ»ÑŒ!",
		DuelSafer_ally : "ÐÐ°Ð¿Ð°Ð´ÐµÐ½Ð¸Ðµ Ð½Ð° ÑÐ¾ÑŽÐ·Ð½Ð¸ÐºÐ°",
		DuelSafer_ally_text : "Ðž Ð½ÐµÑ‚! Ð­Ñ‚Ð¾ ÑÐ¾ÑŽÐ·Ð½Ð¸Ðº! Ð’Ñ‹ Ð´ÐµÐ¹ÑÑ‚Ð²Ð¸Ñ‚ÐµÐ»ÑŒÐ½Ð¾ Ñ…Ð¾Ñ‚Ð¸Ñ‚Ðµ Ð½Ð°Ð¿Ð°ÑÑ‚ÑŒ?",
		DuelSafer_already_have : "Ð£Ð¶Ðµ ÐµÑÑ‚ÑŒ Ð² ÑÐ¿Ð¸ÑÐºÐµ Ð³Ð¾Ñ€Ð¾Ð´Ð¾Ð²/Ð°Ð»ÑŒÑÐ½ÑÐ¾Ð²",
		DuelSafer_found : "DuelSafer.",
		DuelSafer_from_alliance : "ÐÐ»ÑŒÑÐ½Ñ: ",
		DuelSafer_from_town : "Ð“Ð¾Ñ€Ð¾Ð´: ",
		DuelSafer_input_alliance : "Ð’Ð²ÐµÐ´Ð¸Ñ‚Ðµ Ð½Ð°Ð·Ð²Ð°Ð½Ð¸Ðµ Ð°Ð»ÑŒÑÐ½ÑÐ°:",
		DuelSafer_input_town : "Ð’Ð²ÐµÐ´Ð¸Ñ‚Ðµ Ð½Ð°Ð·Ð²Ð°Ð½Ð¸Ðµ Ð³Ð¾Ñ€Ð¾Ð´Ð°:",
		DuelSafer_not_found : "ÐÐµ Ð½Ð°Ð¹Ð´ÐµÐ½ Ñ‚Ð°ÐºÐ¾Ð¹ Ð³Ð¾Ñ€Ð¾Ð´/Ð°Ð»ÑŒÑÐ½Ñ",
		DuelSafer_own_alliance_text : "Ðž Ð½ÐµÑ‚! Ð¢Ñ‹ ÑÐ¾Ð±Ð¸Ñ€Ð°ÐµÑˆÑŒÑÑ Ð½Ð°Ð¿Ð°ÑÑ‚ÑŒ Ð½Ð° ÑÐ²Ð¾Ð¹ Ð°Ð»ÑŒÑÐ½Ñ! Ð¡ÐµÑ€ÑŒÐµÐ·Ð½Ð¾?",
		DuelSafer_own_town_text : "Ðž Ð½ÐµÑ‚! Ð¢Ñ‹ Ð°Ñ‚Ð°ÐºÑƒÐµÑˆÑŒ Ð¶Ð¸Ñ‚ÐµÐ»Ñ ÑÐ²Ð¾ÐµÐ³Ð¾ Ð³Ð¾Ñ€Ð¾Ð´Ð°!! ÐšÐ°Ðº Ñ‚Ð°ÐºÐ¾Ðµ Ð¼Ð¾Ð³Ð»Ð¾ Ð¿Ñ€Ð¾Ð¸Ð·Ð¾Ð¹Ñ‚Ð¸?!",
		dx_not_found: "Ðš ÑÐ¾Ð¶Ð°Ð»ÐµÐ½Ð¸ÑŽ, Ð½Ð¸Ñ‡ÐµÐ³Ð¾ Ð½Ðµ Ð½Ð°Ð¹Ð´ÐµÐ½Ð¾.",
		dx_show_on_map : "ÐŸÐ¾ÐºÐ°Ð·Ð°Ñ‚ÑŒ Ð½Ð° ÐºÐ°Ñ€Ñ‚Ðµ",
		dx_transit_time : "Ð Ð°ÑÑÑ‚Ð¾ÑÐ½Ð¸Ðµ",
		dx_warning : "Ð˜ÑÐ¿Ð¾Ð»ÑŒÐ·Ð¾Ð²Ð°Ð½Ð¸Ðµ Ð´Ð°Ð½Ð½Ð¾Ð³Ð¾ ÑÐºÑ€Ð¸Ð¿Ñ‚Ð° Ð¼Ð¾Ð¶ÐµÑ‚ Ð¿Ñ€Ð¸Ð²ÐµÑÑ‚Ð¸ Ðº <b>Ð±Ð»Ð¾ÐºÐ¸Ñ€Ð¾Ð²Ð°Ð½Ð¸ÑŽ</b> Ð²Ð°ÑˆÐµÐ³Ð¾ Ð°ÐºÐºÐ°ÑƒÐ½Ñ‚Ð° ÑÐ¾ ÑÑ‚Ð¾Ñ€Ð¾Ð½Ñ‹ Ð°Ð´Ð¼Ð¸Ð½Ð¸ÑÑ‚Ñ€Ð°Ñ†Ð¸Ð¸. Ð”Ð¾Ð¿ÑƒÑÐºÐ°ÐµÑ‚ÑÑ Ð¸ÑÐ¿Ð¾Ð»ÑŒÐ·Ð¾Ð²Ð°Ð½Ð¸Ðµ <b>Ñ‚Ð¾Ð»ÑŒÐºÐ¾</b> Ð½Ð° Ñ€ÑƒÑÑÐºÐ¸Ñ… ÑÐµÑ€Ð²ÐµÑ€Ð°Ñ… Ð¸Ð³Ñ€Ñ‹.<br /> Ð˜ÑÐ¿Ð¾Ð»ÑŒÐ·ÑƒÐ¹Ñ‚Ðµ Ð½Ð° ÑÐ²Ð¾Ð¹ ÑÑ‚Ñ€Ð°Ñ… Ð¸ Ñ€Ð¸ÑÐº.<br />ÐŸÑ€Ð¾Ð´Ð¾Ð»Ð¶Ð¸Ñ‚ÑŒ?",
		dx_what_needed : "Ð§Ñ‚Ð¾ Ð¸Ñ‰ÐµÐ¼?",
		enable_beeper : "Ð’ÐºÐ»ÑŽÑ‡Ð¸Ñ‚ÑŒ Ð±Ð¸Ð¿ÐµÑ€",
		enable_beeper_title : "<b>Ð‘Ð¸Ð¿ÐµÑ€</b> - Ð·Ð²ÑƒÐºÐ¾Ð²Ð¾Ðµ ÑƒÐ²ÐµÐ´Ð¾Ð¼Ð»ÐµÐ½Ð¸Ðµ Ð¾ Ð»Ð¸Ñ‡Ð½Ð¾Ð¼ ÑÐ¾Ð¾Ð±Ñ‰ÐµÐ½Ð¸Ð¸ Ð² Ñ‡Ð°Ñ‚Ðµ",
		enable_select : "Ð’Ñ‹Ð´ÐµÐ»ÐµÐ½Ð¸Ðµ Ñ‚ÐµÐºÑÑ‚Ð° Ð² 2.0",
		enable_select_title : "Ð’ÐºÐ»ÑŽÑ‡Ð¸Ñ‚ÑŒ Ð²Ð¾Ð·Ð¼Ð¾Ð¶Ð½Ð¾ÑÑ‚ÑŒ Ð²Ñ‹Ð´ÐµÐ»ÑÑ‚ÑŒ Ð¼Ñ‹ÑˆÑŒÑŽ Ñ‚ÐµÐºÑÑ‚ Ð² 2.0",
		enable_town_button : "Ð’ÐºÐ»ÑŽÑ‡Ð¸Ñ‚ÑŒ ÐºÐ½Ð¾Ð¿ÐºÑƒ \"Ð“Ð¾Ñ€Ð¾Ð´\"",
		enable_town_title : "Ð”Ð¾Ð±Ð°Ð²Ð»ÑÐµÑ‚ ÑÐ¿Ñ€Ð°Ð²Ð° ÐºÐ½Ð¾Ð¿ÐºÑƒ <b>\"Ð³Ð¾Ñ€Ð¾Ð´\"</b>, ÐºÐ¾Ñ‚Ð¾Ñ€Ð°Ñ ÑÐ¾Ð´ÐµÑ€Ð¶Ð¸Ñ‚ Ñ„ÑƒÐ½ÐºÑ†Ð¸Ð¸ Ð´Ð»Ñ Ð±Ñ‹ÑÑ‚Ñ€Ð¾Ð³Ð¾ ÑƒÐ¿Ñ€Ð°Ð²Ð»ÐµÐ½Ð¸Ñ \"Ð³Ð¾Ñ€Ð¾Ð´ÑÐºÐ¸Ð¼Ð¸\" Ð·Ð°Ð´Ð°Ñ‡Ð°Ð¼Ð¸. (ÐžÑ‚ÐºÑ€Ñ‹Ñ‚ÑŒ ÑÐ¿Ð»ÐµÑ‚Ð½Ð¸, Ð»ÐµÑ‡ÑŒ ÑÐ¿Ð°Ñ‚ÑŒ Ð² Ð±Ð»Ð¸Ð¶. Ñ„Ð¾Ñ€Ñ‚, Ñ€Ñ‹Ð½Ð¾Ðº, Ñ†ÐµÑ€ÐºÐ¾Ð²ÑŒ Ð¸ Ñ‚.Ð¿)",
		forum : "Ð¡Ð¿Ð»ÐµÑ‚Ð½Ð¸",
		general : "ÐžÑÐ½Ð¾Ð²Ð½Ñ‹Ðµ",
		HealthTL_to : "Ð”Ð¾ Ð¿Ð¾Ð»Ð½Ð¾Ð³Ð¾ Ð²Ð¾ÑÑÑ‚Ð°Ð½Ð¾Ð²Ð»ÐµÐ½Ð¸Ñ Ð·Ð´Ð¾Ñ€Ð¾Ð²ÑŒÑ: ",
		have_not_forts : "Ð£ Ñ‚ÐµÐ±Ñ Ð½ÐµÑ‚ Ñ„Ð¾Ñ€Ñ‚Ð¾Ð²!",
		listen : "ÐŸÑ€Ð¾ÑÐ»ÑƒÑˆÐ°Ñ‚ÑŒ",
		main : "Ð“Ð»Ð°Ð²Ð½Ñ‹Ðµ Ð½Ð°ÑÑ‚Ñ€Ð¾Ð¹ÐºÐ¸",
		market : "Ð Ñ‹Ð½Ð¾Ðº",
		need_reload : "Ð¢Ñ€ÐµÐ±ÑƒÐµÑ‚ÑÑ Ð¿ÐµÑ€ÐµÐ·Ð°Ð³Ñ€ÑƒÐ·ÐºÐ° ÑÑ‚Ñ€Ð°Ð½Ð¸Ñ†Ñ‹. Ð’Ñ‹Ð¿Ð¾Ð»Ð½Ð¸Ñ‚ÑŒ?",
		own_saloon : "CÐ°Ð»ÑƒÐ½",
		play_current_sound : "Ð’Ð¾ÑÐ¿Ñ€Ð¾Ð¸Ð·Ð²ÐµÑÑ‚Ð¸ Ñ‚ÐµÐºÑƒÑ‰Ð¸Ð¹ Ð·Ð²ÑƒÐº ÑƒÐ²ÐµÐ´Ð¾Ð¼Ð»ÐµÐ½Ð¸Ñ",
		patches_title : "ÐŸÐ°Ñ‚Ñ‡Ð¸ (ÐœÐ¾Ð´Ð¸Ñ„Ð¸ÐºÐ°Ñ†Ð¸Ð¸)",
		revision_current : "Ð¢ÐµÐºÑƒÑ‰Ð°Ñ Ñ€ÐµÐ²Ð¸Ð·Ð¸Ñ",
		revision_new : "ÐÐ¾Ð²Ð°Ñ Ñ€ÐµÐ²Ð¸Ð·Ð¸Ñ",
		settings : "ÐÐ°ÑÑ‚Ñ€Ð¾Ð¹ÐºÐ¸",
		settings_reload : "Ð‘Ð¾Ð»ÑŒÑˆÐ¸Ð½ÑÑ‚Ð²Ð¾ Ð½Ð°ÑÑ‚Ñ€Ð¾ÐµÐº Ñ‚Ñ€ÐµÐ±ÑƒÐµÑ‚ Ð¿ÐµÑ€ÐµÐ·Ð°Ð³Ñ€ÑƒÐ·ÐºÐ¸ ÑÑ‚Ñ€Ð°Ð½Ð¸Ñ†Ñ‹",
		sheriff : "Ð¨ÐµÑ€Ð¸Ñ„",
		sleep_in_fort : "Ð¡Ð¿Ð°Ñ‚ÑŒ Ð² Ð±Ð»Ð¸Ð¶. Ñ„Ð¾Ñ€Ñ‚Ðµ",
		sleep_in_hotel : "Ð¡Ð¿Ð°Ñ‚ÑŒ Ð² ÑÐ²Ð¾ÐµÐ¼ Ð¾Ñ‚ÐµÐ»Ðµ",
		switch_on : "Ð’ÐºÐ»ÑŽÑ‡Ð¸Ñ‚ÑŒ",
		to_last_page : "Ðš Ð¿Ð¾ÑÐ»ÐµÐ´Ð½ÐµÐ¹ ÑÑ‚Ñ€Ð°Ð½Ð¸Ñ†Ðµ",
		town : "Ð“Ð¾Ñ€Ð¾Ð´",
		update_found : "ÐÐ¾Ð²Ð°Ñ Ð²ÐµÑ€ÑÐ¸Ñ TWSweets.",
		update_found_html : "TWSweets Ð¾Ð±Ð½Ð°Ñ€ÑƒÐ¶Ð¸Ð» Ð½Ð¾Ð²ÑƒÑŽ Ð²ÐµÑ€ÑÐ¸ÑŽ ÑÐºÑ€Ð¸Ð¿Ñ‚Ð°. Ð£ÑÑ‚Ð°Ð½Ð¾Ð²Ð¸Ñ‚ÑŒ?",
		version_current : "Ð¢ÐµÐºÑƒÑ‰Ð°Ñ Ð²ÐµÑ€ÑÐ¸Ñ",
		version_new : "ÐÐ¾Ð²Ð°Ñ Ð²ÐµÑ€ÑÐ¸Ñ",
		wir_enabler : "Ð£Ð¼ÐµÐ½ÑŒÑˆÐ¸Ñ‚ÐµÐ»ÑŒ Ð¸Ð½Ð²ÐµÐ½Ñ‚Ð°Ñ€Ñ.",
		wir_on_line : "Ð½Ð° ÑÑ‚Ñ€Ð¾ÐºÑƒ",
		wir_on_one_line : "ÐšÐ¾Ð»-Ð²Ð¾ ÑÐ»ÐµÐ¼ÐµÐ½Ñ‚Ð¾Ð² Ð½Ð° ÑÑ‚Ñ€Ð¾ÐºÑƒ Ð² Ð¸Ð½Ð²ÐµÐ½Ñ‚Ð°Ñ€Ðµ:",
		without_city : "ÐÐ¾ Ñƒ Ñ‚ÐµÐ±Ñ Ð¶Ðµ Ð½ÐµÑ‚ Ð³Ð¾Ñ€Ð¾Ð´Ð°!",
		your_character: "Ð¢Ñ‹"
	  };
	  TWS.langs.en_US = {
		add : "Add",
		...
		bank : "Bank",
		beeper_sound : "Sound file:",
		beeper_set_sound : "Change",
		chat_title : "Chat",
		...
		dx_not_found: "Unfortunately nothing was found.",
		dx_show_on_map : "Show on map",
		dx_transit_time : "Trans. time",
		...
		dx_what_needed : "What are looking for?",
		enable_beeper : "Enable beeper",
		enable_beeper_title : "<b>Beeper</b> - sound alert if you get private message",
		...
		play_current_sound : "Play the current sound",
	...
	TWSweets.langs.pt_PT = {
		add : "Adicionar",
		alliance : "Aliança",
		auto_update : "Procura actualizações",
		auto_update_title : "Procura automatica de actualizacoes",
		bank : "Banco",
		beeper_sound : "Som:",
		beeper_set_sound : "Alterar som",
		chat_title : "Chat",
		changed : "Alterado com sucesso!!!",
		church : "Igreja",
		default : "Predefinido",
		dont_have_hotel: "Tu nao tens um hotel!!!",
		DuelSafer_ally : "Ataque a um aliado",
		DuelSafer_ally_text : "Este jogador é um aliado. Tens a certeza que queres ataca-lo???",
		DuelSafer_already_have : "Já está inserido na lista da aliança/cidade",
		DuelSafer_found : "Duelo seguro.",
		DuelSafer_from_alliance : "Aliança: ",
		DuelSafer_from_town : "Cidade: ",
		DuelSafer_input_alliance : "Insere o nome da Aliança:",
		DuelSafer_input_town : "Insere o nome da cidade:",
		DuelSafer_not_found : "Cidade/Aliança nao encontrada",
		DuelSafer_own_alliance_text : "Tu queres atacar alguem da aliança? De certeza???",
		DuelSafer_own_town_text : "É a tua cidade!!! Não podes atacar ninguém da tua cidade!!!",
		dx_not_found: "Infelizmente nada foi encontrado.",
		dx_show_on_map : "Visualiza o teu mapa",
		dx_transit_time : "Distância",
		dx_warning : "A administração nao apoiou ainda este script. Se pretender utilizar é da sua conta e risco. Continuar?",
		dx_what_needed : "Estas à procura de?",
		enable_beeper : "Activa sinal",
		enable_beeper_title : "Alerta de som caso receba uma mensagem privada",
		enable_select : "Texto selecionavel para 2.0",
		enable_select_title : "Activa texto selecionavel para 2.0",
		enable_town_button : "Activa botao  \"Cidade\"",
		enable_town_title : "Com este script podes fazer a maior parte das tarefas da tua cidade, no qual é adicionado um botão do lado direito (ex. ir dormir no forte mais perto, mercado, igreja, etc.)",
		forum : "Fórum",
		general : "Geral",
		listen : "Ouvir",
		have_not_forts : "Tu não tens nenhum forte",
		HealthTL_to : "Tempo para a recuperação total de saude: ",
		main : "Configurações principais",
		market : "Mercado",
		need_reload : "A página precisa de ser reiniciada. Reiniciar agora?",
		own_saloon : "Taberna",
		patches_title : "Modificações",
		play_current_sound : "Tocar o som actual",
		revision_current : "Versão actual",
		revision_new : "Nova versão",
		settings : "Definições",
		settings_reload : "A maior parte das configurações necessitam de actualizar a página",
		sheriff : "Xerife",
		sleep_in_fort : "Dormir no forte",
		sleep_in_hotel : "Dormir no hotel",
		switch_on : "Activar",
		to_last_page : "Ir para a última pagina",
		town : "Cidade",
		update_found : "Nova versão do TWSweets!",
		update_found_html : "TWSweets encontrou uma nova versão do script. instalar agora?",
		version_current : "Versão actual",
		version_new : "Nova versão",
		wir_enabler : "Redução do inventário.",
		wir_on_line : "numa linha",
		wir_on_one_line : "Número de items por linha:",
		without_city : "Tu não tens uma cidade!!!",
		your_character : "A tua personagem"
	};
	  ...
	  TWS.Config.openConfig = function(tab) {
		...
		var openTab = function(win, id) {
			...
			break;
			case 'tws_ds':
				self.win.setTitle('Duelo Seguro');
				mainTab.hide();
			...
			break;
			case 'tws_dx': 
				self.win.setTitle('Trabalhos de luxo');
				mainTab.hide();
				DuelSafer.hide();
		...
		this.win = wman.open("twsweets", "TWSweets " + TWS.lang.settings, " bigwman nominimize noreload")
				...
				.addTab("Duelos seguros", "tws_ds", openTab)
				.addTab("Trabalhos de luxo", "tws_dx", openTab)
	  ...
	  TWS.Config.mainTab = function() {
		var tws_main = $('<div id="tws_main" style="display: block;"></div>');	
			...
			.append("<b>Redutor de Inventário</b><hr>")
			...
			.append(new tw2gui.combobox("tws_changelang").addItem("ru_RU", "Russian").addItem("en_US", "English").addItem("pt_PT", "Portugues").select(TWS.Settings.language).addListener(function(v) { TWS.Core.switchSetting("language", v); TWS.lang = TWS.langs[v]; var need = confirm(TWS.lang.need_reload); need && location.reload(true);}).getMainDiv())
			.appendTo(tws_main);
	  ...
	  TWS.DuelSafer.getId = function(name, type, callback) {
		  if (typeof name != "string" || typeof type != "string" || typeof callback != "function") return console.error("ÐŸÐµÑ€Ð²Ñ‹Ð¹ Ð¸ Ð²Ñ‚Ð¾Ñ€Ñ‹Ðµ Ð°Ñ€Ð³ÑƒÐ¼ÐµÐ½Ñ‚Ñ‹ Ð´Ð¾Ð»Ð¶Ð½Ñ‹ Ð±Ñ‹Ñ‚ÑŒ Ñ‚ÐµÐºÑÑ‚Ð¾Ð¼. 3Ð¸Ð¹ ÐºÐ¾Ð»Ð±ÑÐº Ñ„ÑƒÐ½ÐºÑ†Ð¸Ñ (Ð¿ÐµÑ€Ð²Ñ‹Ð¹ Ð°Ñ€ÑƒÐ¼ÐµÐ½Ñ‚ ÑÐ²Ð»ÑÐµÑ‚ÑÑ ID)");    
		  ...
		  function onresult(data) {
			  ...
			  callback(id); // ÐšÐ°Ðº Ð°Ð½Ð°Ð»Ð¾Ð³ return;
		  }
	  }
	  ...
	  TWS.DuelSafer.addFriend = function(name, type, callback) {
		if (!isDefined(type) || typeof type != "string") return console.error("Ð’Ñ‚Ð¾Ñ€Ð¾Ð¹ Ð°Ñ€Ð³ÑƒÐ¼ÐµÐ½Ñ‚ Ð½Ðµ ÑƒÐºÐ°Ð·Ð°Ð½ Ð¸Ð»Ð¸ Ð½Ðµ Ð¿Ñ€Ð°Ð²Ð¸Ð»ÑŒÐ½Ð¾Ð³Ð¾ Ñ‚Ð¸Ð¿Ð°.");
	  ...
	  TWS.DuelSafer.removeFriend = function(name, type) { // "-Ð Ð¾Ð½Ð¸Ð½Ñ‹-" "alliances"
		  if (typeof name != "string" || typeof type != "string") return "ÐŸÐµÑ€Ð²Ñ‹Ð¹ Ð¸ Ð²Ñ‚Ð¾Ñ€Ñ‹Ðµ Ð°Ñ€Ð³ÑƒÐ¼ÐµÐ½Ñ‚Ñ‹ Ð´Ð¾Ð»Ð¶Ð½Ñ‹ Ð±Ñ‹Ñ‚ÑŒ Ñ‚ÐµÐºÑÑ‚Ð¾Ð¼.";   
	  ...
	  TWS.DuelSafer.start_duel = function (player_id, allianceId, force, view) {
			...
			if (isDefined(friends.alliances[allianceId])) {
				alert(player_id, allianceId, false); // ÐÐ»ÑŒÑÐ½Ñ Ð½Ðµ Ð½Ð°Ñˆ, Ð½Ð¾ ÑÐ¾ÑŽÐ·Ð½Ñ‹Ð¹
			} else if (myAlliance == allianceId) {
				alert(player_id, allianceId, true) // ÐÐ»ÑŒÑÐ½Ñ Ð½Ð°Ñˆ
	  ...
	  TWS.Menu.mainSelectBox = function() {
		var self = TWS;
	  	this.mainSelect = $(new tw2gui.selectbox(true).setPosition(-168,12).setWidth(150).addListener(this.mainOptions)
			...
			.addItem("tws_ds","Duelos seguros")
			.addItem("tws_dx", "Trabalhos de luxo")
			.getMainDiv());
	  }
	  ...
	  TWS.HealthTL = {
		...
		intervalFn: function() {
			...
			Ajax.remoteCall("inventory", "carry", {}, function(result) { // Ð¯ Ð½Ðµ Ð½Ð°ÑˆÐµÐ» Ð´Ñ€ÑƒÐ³Ð¾Ð³Ð¾ ÑÐ¿Ð¾ÑÐ¾Ð±Ð° ÑƒÐ·Ð½Ð°Ñ‚ÑŒ Ñ‚ÐµÐºÑƒÑ‰ÐµÐµ Ð·Ð´Ð¾Ñ€Ð¾Ð²ÑŒÐµ Ð² Ð´Ñ€Ð¾Ð±Ð½Ñ‹Ñ… Ð·Ð½Ð°Ñ‡ÐµÐ½Ð¸ÑÑ….
