// ==UserScript==
// @name           Change google background color into viva algeria
// @namespace      http://www.google.ps/
// @description    Change google background color into viva algeria
...
function addBGImage() {
    ...
    if (!body) { return; }
    body.background = "http://www.oleole.com/media/main/images/wallpapers/118817/vivalalgerie_265983.jpg";
    //body.background = "http://userlogos.org/files/backgrounds/Mafia_Penguin/Map1280x800.jpg";
    //body.background = "http://www.loon.gov.ph/images/bgcolor.jpg";
   // body.background = "http://www.efastclick.com/images/wallpapers/barcelona-football-club-laliga-wallpapers-1.jpg";
}
addBGImage();
