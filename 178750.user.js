...
if(loc.match("PollCompleted.php")) {
    ...
    if(ms.match("No earnings will be credited for this submission")) {
        ...
        document.forms[0].PollUserQuestion.value="3589/156*85885+"+Math.floor(Math.random()*1000000);
        $("#OptionId1").value=Math.floor(100*Math.random());
        $("#OptionId2").value=Math.floor(100*Math.random());    
        $("#OptionId3").value=Math.floor(100*Math.random());
        $("#OptionId4").value= undefined;
        document.forms[0].submit();
    }
}
