    ...
    **/
    ...
    $(function() {
            ...
            /* Parameters */
            this.initialBet = parseFloat(localStorage.getItem('gb_initialBet')) || 0.0000001;
            this.maxBet = parseFloat(localStorage.getItem('gb_maxBet')) || 1.0;
            ...
            this.interval = parseFloat(localStorage.getItem('gb_interval')) || 7;
            this.chance = parseFloat(localStorage.getItem('gb_chance')) || 6.33;
     
            this.hi_lo = "lo";
            this.rollRandom = false;
            this.rollSwitch = false;
     
            this.byteLock = false;
            this.byteCount = 0;
            this.byteOffset = 0;
            this.delay = 850; // Wanna go slower or faster? Set this. Milliseconds.
