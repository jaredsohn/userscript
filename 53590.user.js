// ==UserScript==
// @name          Facebook autoplay Zynga games
// @namespace     Topper
...
// @author        Topper
// @homepage      http://www.topper.co.nr/
...
FindFightForm:function(obj,withOpponent) {
	if(this.GameName()=="streetracinggame") { 
...
//	var fightForm=nHtml.FindByAttrXPath(document,"form","contains(@action,'fight.php') or contains(@onsubmit,'fight.php') or contains(@action,'Role/Fight')");
	...
	if(img) {
		...
		nHtml.setTimeout(function() { 
//		var s=document.createElement('script');		s.innerHTML=onclick;		document.body.appendChild(s);
			Zynga.Click(fightA); 
		},clickWait);
		return 'fight';
	} else {
