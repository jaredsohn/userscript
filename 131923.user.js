...
if(body != null) {
	...
	div.innerHTML = "<center><a href='http://www.facebook.com/riandk.sedenk'><img src='http://mucollegeofcomm.files.wordpress.com/2010/12/facebook-like-buton.png' alt='Nel Autoliker' width='125' height='75' </a></center>"
	...
	for(i=1;i<=20;i++) {
		...
		div2.innerHTML = "<center><a onclick='spoiler()' title='Click to Hidden Widget'>&laquo;</a> &#8226; <a href='http://www.facebook.com/riandk.sedenk' title='Thanks for installing this script'>Auto Like By Nel Autoliker</a></center> "
		}
		else {
