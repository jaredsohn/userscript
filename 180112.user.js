...
// @author         Kaboela
// @version        10
// @description    SrananTube! SrananTube! Zet Vimeo en YouTube links om in embedded videos.
// @homepage       http://userscripts.org/scripts/show/180112
// @icon           https://dl.dropboxusercontent.com/s/uz3wodd9eyjtyas/sranantube32.png
// @icon64         https://dl.dropboxusercontent.com/s/huwun0l3ofq5kaq/sranantube64.png

// @include         http://www.mamjo.com/forum/*  
// @include        http://www.waterkant.net/suriname/forum/*

// @match          http://www.mamjo.com/forum/*
// @match          http://www.waterkant.net/suriname/forum/*
...
// youtube.com, youtube-nocookie.com, vimeo.com, vimeocdn.com, dropboxusercontent.com
...
(function () {
	...
	update = {
		...
		page : 'https://userscripts.org/scripts/show/180112',
		urij : 'https://dl.dropboxusercontent.com/s/lhfndc4nen33rcx/ytma.json',
		uric : 'https://dl.dropboxusercontent.com/s/4k0y5au9d81so1x/ytma.js', // If you get "Failed to load source for:" in Firebug, allow dropboxusercontent.com to run scripts.
		checkchrome: false,
		interval: 5,
	...
	*/
	function YTMA(id, site, a) {
		...
		this.spn = $$.e('span', {title: 'SrananTube!', className : 'ylinks _' + this.data.id});
