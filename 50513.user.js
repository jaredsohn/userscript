// ==UserScript==
// @name           Ikariam Mapa Alianza LGESP
// @namespace      Ikariam Mapa Alianza LGESP
// @author         Dantrigger (http://userscripts.org/users/92873)
// @license        GPL v3 (http://www.gnu.org/copyleft/gpl.html)
// @homepage       http://userscripts.org/scripts/show/50513
// @description    SISI
...
// Version 1.1.5b -	Feature: Added Polish & Hebrew Translations.
// Version 1.1.6 -	Feature: Added Romanian & Italian Translations.
// Version 1.1.6b -	Feature: Added Greek & Vietnamese Translations.
// Version 1.1.7 -	Bugfix: Updated Turkish language translation.
//			Bugfix: Changed to parse island drop-down menu to get own town locations so players with no alliance can see own town locations.
// Version 1.1.8 -	Feature: Updated French language translation.
//			Feature: Added Hungarian language translation.
//			Bugfix: Recoded map generation for speed up.
//			Bugfix: Changed parsing of own islands.
//			Bugfix: Fixed height of tabs in configuration menu.
// Version 1.1.9 -	Feature: Updated Hebrew language translation.
//			Bugfix: Fixed co-ordinate parsing for [0X:XX] or [XX:0X] islands.
// Version 1.1.9b -	Feature: Added Chinese language translation.
// Version 1.1.10 -	Bugfix: Reworked display of own islands.
// Version 1.1.11 -	Feature: Added Czech language translation.
//			Feature: Added option to reset mini-map location in the Greasemonkey menu
//			Feature: Added option to turn of mini-map.
// Version 1.1.11b -	Feature: Added link to approval page on .org.
//
// -- Resources --
...
const language = {
	...
	"hungarian":	{	ltr: true,	open: "Világtérképet mutat",	worldMap: "Világtérkép",	miniMap: "Mini világtérkép",	config: "Beállítások",	scheme: "Színek",	skin: "Téma",	island: "Sziget",	sea: "Tenger",	border: "Keret",	grid: "Rácsozat",	own: "Saját sziget",	selected: "Kiválasztott sziget",	marble: "Márványos sziget",	wine: "Boros sziget",	crystal: "Kristályos sziget",	sulphur: "Kénes sziget",	variable: "Változó méret",	ownAlliance: "Szín",	ownAllianceFade: "Árnékolás",	alliance: "Saját szövetség",	details: "Script adatai",	author: "Szerző",	webpage: "Weboldal",	approved: "Engedélyezve",	close: "Bezár",	move: "Mozgatás",	language: "Nyelv", reset: 'Reset Mini Map Helyszín', displayMap: 'Mini térkép-megjelenítés' },
	"italian":	{	ltr: true,	open: "Apri Mappamondo",	worldMap: "Mappamondo",		miniMap: "Mini Mappamondo",	config: "Configurazione",	scheme: "Schema Colori",	skin: "Tema",	island: "Isola",	sea: "Mare",	border: "Bordo",	grid: "Griglia",	own: "Tua Isola",	selected: "Isola Selezionata",	marble: "Isola di Marmo",	wine: "Isola di Vino",	crystal: "Isola di Cristallo",	sulphur: "Isola di zolfo",	variable: "Varia Misura",	ownAlliance: "Colour",	ownAllianceFade: "Dissolvenza",	alliance: "Tua Alleanza",	details: "Dettagli Script",	author: "Autore",	webpage: "Pagina Web",	approved: "Approvato",	close: "Chiudi",	move: "Sposta",	language: "Lingua", reset: 'Reset Mini-Mappa Ubicazione', displayMap: 'Visualizza Mini-Map' },
	...
	"latvian":	{	ltr: true,	open: 'Open World Map',		worldMap: 'World Map',		miniMap: 'Pasaule Mini-Karte',	config: 'Konfigurācija', scheme: 'Krāsu shēma', skin: 'Āda', island: 'Island', sea: 'Jūra', border: 'Border', grid: 'Režģis', own: 'Pašu Island', selected: 'Atlasīti Island', marble: 'Marble Island', wine: 'Vīns Island', crystal: 'Crystal Island', sulphur: 'Sēra Island', variable: 'Vari Size', ownAlliance: 'Krāsa', ownAllianceFade: 'Izbalināt', alliance: 'Pašu Alliance', details: 'Script detaļas', author: 'Autors', webpage: 'Webpage', approved: 'Apstiprināts ar', close: 'Aizvērt', move: 'Kustība', language: 'Valoda', reset: 'Atjaunot Mini-Karte Location', displayMap: 'Display Mini-Karte' },
	...
	"portuguese":	{	ltr: true,	open: 'Open World Map',		worldMap: 'World Map',		miniMap: 'Mundo Mini-Mapa',	config: 'Configuração', scheme: 'Esquema de cores', skin: 'Pele', island: 'Ilha', sea: 'Mar', border: 'Border', grid: 'Grelha', own: 'Própria ilha', selected: 'Selecionado Island', marble: 'Mármore Island', wine: 'Vinho Island', crystal: 'Crystal Island', sulphur: 'Enxofre Island', variable: 'Tamanho Vary', ownAlliance: 'Cor', ownAllianceFade: 'Fade', alliance: 'Própria Aliança', details: 'Script Detalhes', author: 'Autor', webpage: 'Webpage', approved: 'Aprovado em', close: 'Fechar', move: 'Mover', language: 'Linguagem', reset: 'Reset Mini-Mapa Localização', displayMap: 'Display Mini-Mapa' },
	"romanian":	{	ltr: true,	open: "Deschide Harta Lumii",	worldMap: "Harta Lumii",	miniMap: "Mini-Harta Lumii",	config: "Configurare",	scheme: "Schema de Culori",	skin: "Aspect",	island: "Insula",	sea: "Mare",	border: "Margini",	grid: "Caroiaj",	own: "Insula Mea",	selected: "Insula Selectată",	marble: "Insula de Marmura",	wine: "Insula de Vin",	crystal: "Insula de Cristal",	sulphur: "Insula de Sulf",	variable: "Redimensioneaza",	ownAlliance: "Culoare",	ownAllianceFade: "Nuanţă",	alliance: "Alianţa Mea",	details: "Detaliile Script-ului",	author: "Autor",	webpage: "Pagina Web",	approved: "Aprobat",	close: "Închide",	move: "Mută",	language: "Limbă", reset: 'Resetare Mini-Harta Locatie', displayMap: 'Afişează mini-hartă' },
	...
	"spanish":	{	ltr: true,	open: "Abrir Mapa del Mundo",	worldMap: "Mapa del Mundo",	miniMap: "Mini-Mapa del Mundo",	config: "Configuración ",	scheme: "Esquema de Color", skin: "Tema",	island: "Color Islas", sea: "Color Mar", border: "Color Borde de Isla",	grid: "Color Cuadrícula", own: "Color Islas Propias", selected: "Color Selección de Isla en mini-mapa",	marble: "Color Islas de Mármol", wine: "Color Islas de Vino", crystal: "Color Islas de Cristal",	sulphur: "Color Islas de Azufre",	variable: "Variar Tamaño Isla (# ciudades LGESP en isla)",	ownAlliance: "Color Islas LGESP",	ownAllianceFade: "Variar color islas # de espartanos en isla", alliance: "Propia Alianza", details: "Detalles de Script",	author: "Autor", webpage: "Webpage", approved: "Aprobado por", close: "Cerrar", move: "Mover", language: "Lenguaje", reset: 'Restablecer Mini-Mapa de Ubicación', displayMap: 'Mini-pantalla de Mapa' },
 ...
 */
const SKINS	= {
	Map:		{ island: 'Green',		sea: 'Blue',		grid: 'White',		border:	'Black',		own: 'White',		centered: 'White',	marble: false,	wine: false,	crystal: false,	sulphur: false,	ownAlliance: 'Yellow',		ownAllianceFade: 'Red' },
...
if ( PAGE_ID == "world" ) {
	...
	function createConfig() {
		...
		$('body').prepend(
				...
				'<tbody>' +
				'<tr><th valign="middle">' + language.author + ':</th><td><a href="http://userscripts.org/users/92873" target="_blank">Dantrigger</a></td></tr>' +
				'<tr><th valign="middle">' + language.webpage + ':</th><td><a href="http://userscripts.org/scripts/show/50513">http://userscripts.org/scripts/show/50513</a></td></tr>' +
				'<tr><th valign="middle">' + language.approved.replace( ' ', '&nbsp;' ) + ':</th><td><a href="http://board.ikariam.org/index.php?page=Thread&threadID=61032" target="_blank"><img src="http://nwlng.gameforge.de/flags/gb.gif" width="16px" height="11px">&nbsp;(.org)</a></td></tr>' +
...
if ( GM_getValue( cache_variables.DISPLAYMAP, true ) ) {
	...
	GM_registerMenuCommand( language.reset || "Reset Island Mini-Map Location" , function() {
		GM_setValue( cache_variables.LOCATION + islandID, "({x:242,y:177})" );
	});
