// ==UserScript==
// @name           Bottled Faerie Grabber
// @namespace      http://userscripts.org/users/268829
// @description    Tries to pick up bottled faeries when they appear on the Money Tree
...
function checkmoney() {
var i,highest=0,am=new Array(),amounts = $x("//b[contains(text(), 'faerie')]",7);
