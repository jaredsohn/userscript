// ==UserScript==
// @author Methew
// @name Darkpirates MenuPlus Türkçe
// @description - Türkçe Darkpirates keyfi.
// @include       http://s*.darkpirates.es/*
// @include       http://s*.darkpirates.cz/*
// @include       http://s*.ba.darkpirates.org/*
// @include       http://s*.darkpirates.net/*
// ==/UserScript==
//
// --------------------------------------------------------------------
//
...
menuplus = '<div id="klammer-links"><ul><li style="position:relative"><img class="k-links" alt="" src="img/mk-links-klammer.jpg" /><a href="#">Menüler</a></li></ul></div>';
menuplus += '<div id="heimatwelten"><ul>';
menuplus += '<li><a href="index.php?mod=shop" class="mplus_z">Eşya Ticareti</a></li>';
menuplus += '<li><a href="index.php?mod=auction" class="mplus_m">Müzayede Salonu</a></li>';
menuplus += '<li><a href="index.php?mod=market&reiter=5" class="mplus_z">Kara Borsa</a></li>';
menuplus += '<li><a href="index.php?mod=laborshop" class="mplus_m">Laboratuar</a></il>';
menuplus += '<li><a href="index.php?mod=packages&reiter=5" class="mplus_m">Depo</a></li>';
menuplus += '<li><a href="index.php?mod=job" class="mplus_m">İş</a></li>';
menuplus += '<li><a href="index.php?mod=training" class="mplus_m">Eğitim</a></li>';
...
menuplus += '<li><a href="javascript:findenemy();" class="mplus_m">Rakip Bul</a></li>';

menuplus += '</div></ul>';

// *********** vlastni menu ***********

menuplus += '<div id="klammer-rechts"><ul><li style="position:relative"><img class="k-rechts" alt="" src="img/mk-rechts-klammer.jpg" /><a href="#">Förmül Menüsü</a></li></ul></div>';
