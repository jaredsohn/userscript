// ==UserScript==
// @name   	Add hidden boards to board list
// @namespace  	4chon.net
// @description	Adds hidden boards to the 4chon board list
