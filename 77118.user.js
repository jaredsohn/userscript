// ==UserScript==
// @name           Sistema Tutores
// @namespace      http://userscripts.org/scripts/show/
// @description    Para uso de Tutores eMexico
// @date           2010-05-19
// @include        http://www.erepublik.com/*
// @include        http://www.erepublik.com/*/citizen/profile/*
// @include        http://www.erepublik.com/*/search/?q=*
// @include        http://www.erepublik.com/*/messages/*
// Thanks to mkey for the initial release
// By Isidro L. Spencer
// Under LGPL License
...
// ==/UserScript==
	...
	var url_script= "http://userscripts.org/scripts/source/77118.user.js";
	...
	//var url_empty= "http://i1018.photobucket.com/albums/af304/mkey82/empty-1.png";
        var url_empty= 'data:image/png;base64,' +
'iVBORw0KGgoAAAANSUhEUgAAAAEAAAABCAYAAA' +
'AfFcSJAAAAAXNSR0IArs4c6QAAAAZiS0dEAP8A' +
'/wD/oL2nkwAAAAlwSFlzAAALEwAACxMBAJqcGA' +
'AAAAd0SU1FB9oDAQ0QBbId/dEAAAAZdEVYdENv' +
'bW1lbnQAQ3JlYXRlZCB3aXRoIEdJTVBXgQ4XAA' +
'AADUlEQVQI12P4//8/AwAI/AL+XJ/P2gAAAABJ' +
'RU5ErkJggg%3D%3D';
	
	var style= (<r><![CDATA[
		.battle {background-color:#eafaff;border:1px solid #d0faff;float:right;margin-top:2px;}
		.battle:hover {border-color:#edfaff;}
		.battle img {width:20px;height:15px;background:url("http://i797.photobucket.com/albums/yy257/marshal82/eRep%20Tutor%20System/list1-2.png") 0 -135px no-repeat;}
		...
		.notify.yel {background:url("http://i797.photobucket.com/albums/yy257/marshal82/eRep%20Tutor%20System/list1-2.png") 0 -105px no-repeat;}
		.notify.red {background:url("http://i797.photobucket.com/albums/yy257/marshal82/eRep%20Tutor%20System/list1-2.png") 0 -120px no-repeat;}
		...
		.small.pm {background:url("http://i797.photobucket.com/albums/yy257/marshal82/eRep%20Tutor%20System/list2-3.png") 0 0 no-repeat;}
		.small.del {background:url("http://i797.photobucket.com/albums/yy257/marshal82/eRep%20Tutor%20System/list2-3.png") 0 -10px no-repeat;}
		...
		.trend.down {background:url("http://i797.photobucket.com/albums/yy257/marshal82/eRep%20Tutor%20System/list1-2.png") 0 -90px no-repeat;}
		.trend.up {background:url("http://i797.photobucket.com/albums/yy257/marshal82/eRep%20Tutor%20System/list1-2.png") 0 -75px no-repeat;}
	...
	strings0= new Array("SAC - Tutorado", "Mandar PM", "PM", "Actualizar", "Remover Tutorado",
		"Muestra niveles de vitalidad por los pasados 5 dias", "Muestra los cambios en experiencia por los pasados 5 dias", "Remover Tutorado", "Agregar Tutorado", "WS",
		"Day:Well diff ", "Day:Exp diff ", "Day:Str diff ", "Day:Skill diff ", "STR",
		"H", "actualizar script", "Click para obtener actualizacion", " ha perdido ", " de vitalidad en los pasados dias",
		"W", " no se esta desarrollando", "E", "Batalla disponible", "B",
		" - Perfil", "Almacen de Mensajes", "No escriba aqui", "Limpiar", "Grabar",
		"Cargar", "en", "es", "Cambiar Idioma", "Actualizando...");
