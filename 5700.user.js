...
// @description   Make JavaScripted links in Helgon.net guestbooks into regular links, to enable opening in new tabs and such.
...
with_each("//a[starts-with(@href, 'javascript:')]", function(a) {
	...
	function de_jsify(entire_href, funk, arg1, arg2, arg3) {
		switch (funk) {
			case "S":
				return 'quickmessage.aspx?UserID=' + arg1 + '&UserName=' + arg2 + '&GuestBookID=' + arg3;
			case "H":
