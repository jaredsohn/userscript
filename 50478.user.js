...
function createBaseDiv() 
{
    ...
    var scoreDiv = <>
        ...
        <li style="margin: 2px 10px;font-size:11px" id="logo" class="ally">
            <span style="float:left;" class="textLabel">{lang['logo']}</span>
            <div id="free">= </div>
            <div id="free">. </div>
        </li>
        </>;
...
function defineLanguage(langTDL) {
    switch (langTDL) {
        ...
        case "it":
            ...
            score:"Punti Totali",
            military:"Punti Militari",
            gold:"Oro",
            logo:" ==========================  Edited By Edotor"};
            break;
        case "vn":
            language = { 
            fetch:"Đang tải...",
