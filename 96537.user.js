// ==UserScript==
// @name  سكربت ناشر التقارير  By:KOPc
// @description سكربت يقوم بنشر التقارير 
// @author Hypix
...
function createBBForm(cell,size,createBBCode,report)
{
  ...
  tab.insertRow(tab.rows.length).appendChild(document.createElement("th")).innerHTML = "خيارات نشر التقارير";
  tab.style.width = "100%";
