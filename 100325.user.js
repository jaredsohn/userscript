...
var KOCAversion = 'Niknah 20110110, Fred-201102179a';
...
ShowOptionsDialog:function() {
	...
	div.innerHTML="<form><table>"+
		...
		"<TABLE width=100%><TR><TD><a id='KOCAttackOptionsSave' class='button20'><span>Save</span></a> <a id='KOCAttackOptionsCancel' class='button20'><span>Cancel</span></a> <a id='KOCAttackOptionsReset' class='button20'><span>Reset options</span></a> <a id='KOCAttackOptionsResetAll' class='button20'><span>Reset all!</span></a> </td><TD align=right>"+ KOCAversion +"</td></tr></table></form>";
	var t=this;
...
AddOptionsLink:function() {
	...
	a=this.AddTabLink('<div style="background-color:#FC6;border:#000 solid thin; display: inline-block;text-decoration: none;height: 15px;padding-top: 1px;padding-right: 2px;padding-bottom: 0pt;padding-left: 2px; color:#000;">Options</div>');
	if(!a) {
		window.setTimeout(function() {
			t.AddOptionsLink();
		},t.GetRandTime(250));
...
//	if(autoAttack && autoAttack.cities && autoAttack.cities[t.GetCurrentCityId()]) {
	if(autoAttack) {
		toggle.innerHTML='<div style="background-color:#F00;border:#000 solid thin; display: inline-block;text-decoration: none;height: 15px;padding-top: 1px;padding-right: 4px;padding-bottom: 0pt;padding-left: 4px; margin-left:3px; color:#000;">Auto attack</div>';
	} else {
		toggle.innerHTML='<div style="background-color:#FC6;border:#000 solid thin; display: inline-block;text-decoration: none;height: 15px;padding-top: 1px;padding-right: 2px;padding-bottom: 0pt;padding-left: 2px; color:#000;">No auto attack</div>';
	}
},
...
HideAttackEfforts:function() {
  ...
  txt.innerHTML = 'Hide Boosts';   
  inp.type='checkbox';
  span.appendChild (inp);
  span.appendChild (txt);
  if (KOCAttack.hideAttackEffortsState){
    inp.checked = true;
    hideshow ('none');
  }   
     
	inp.addEventListener('change', function(evt) {
  	  KOCAttack.hideAttackEffortsState = evt.target.checked;
  	  hideshow();
  	},false);
	for (var i=1; i<5; i++)
...
// not needed anymore since KofC will select a knight	??		
...
//{"time":1273315720.514,"troops":"test","type":0,"messages":[["Attack (326,97)  - Barbarian Camp Lv. 2 (NewCity4216)","modal_messages_viewreports_view(\"529747\",1,51,2,0,\"Enemy\",\"0\",\"niknah\",\"M\",4,326,97,1273312617,1,333,110);return false;"],["Attack (326,97)  - Barbarian Camp Lv. 2 (NewCity4216)","modal_messages_viewreports_view(\"529747\",1,51,2,0,\"Enemy\",\"0\",\"niknah\",\"M\",4,326,97,1273312617,0,333,110);return false;"]]}
  ...
  document.getElementById ('modal_attack').appendChild(divContainer);
	...
	if(autoAttack && autoAttack.x==xy[0] && autoAttack.y==xy[1] && !ignore.checked) {
		...
		if(totalTroops>0 && knightSelect.options.length>1	&& !notFullTroops	&& !notFullResources	&& btnMarch.className.indexOf('grey')<0	) {
