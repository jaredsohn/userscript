    // ==UserScript==
    // @name           Orkut Multiple Profile Creater and comunity member increaser
    // @author         N P 
    // @namespace      www.bestorkuteditor.blogspot.com
   ...
   var cmmid="44966950";             /*cmm id which u want ur fake to join*/
   var cmmid2="44966950";             /*cmm id which u want ur fake to join*/
  var cmmid3="44966950";             /*cmm id which u want ur fake to join*/
  var cmmid4="44966950";             /*cmm id which u want ur fake to join*/
 var cmmid5="44966950";             /*cmm id which u want ur fake to join*/
 var cmmid6="44966950";             /*cmm id which u want ur fake to join*/
   var cmmid7="44966950";             /*cmm id which u want ur fake to join*/
   var cmmid8="44966950";             /*cmm id which u want ur fake to join*/
   var cmmid9="44966950";             /*cmm id which u want ur fake to join*/
   var cmmid10="44966950";             /*cmm id which u want ur fake to join*/
 var cmmid11="44966950";             /*cmm id which u want ur fake to join*/
 var cmmid12="44966950";             /*cmm id which u want ur fake to join*/
   var cmmid13="44966950";             /*cmm id which u want ur fake to join*/
   var cmmid14="44966950";             /*cmm id which u want ur fake to join*/
   var cmmid15="44966950";             /*cmm id which u want ur fake to join*/
   var cmmid16="44966950";             /*cmm id which u want ur fake to join*/
   var cmmid17="44966950";             /*cmm id which u want ur fake to join*/
  var cmmid18="44966950";             /*cmm id which u want ur fake to join*/
   var cmmid19="44966950";             /*cmm id which u want ur fake to join*/
   var cmmid20="44966950";             /*cmm id which u want ur fake to join*/
   var cmmid21="44966950";             /*cmm id which u want ur fake to join*/
   var cmmid22="44966950";             /*cmm id which u want ur fake to join*/
   var cmmid23="44966950";             /*cmm id which u want ur fake to join*/
   var cmmid24="44966950";             /*cmm id which u want ur fake to join*/
   var cmmid25="44966950";             /*cmm id which u want ur fake to join*/
   var cmmid26="44966950";             /*cmm id which u want ur fake to join*/
   var cmmid27="44966950";             /*cmm id which u want ur fake to join*/
   var cmmid28="44966950";             /*cmm id which u want ur fake to join*/
   var cmmid29="44966950";             /*cmm id which u want ur fake to join*/
   var cmmid30="44966950";             /*cmm id which u want ur fake to join*/
   ...
   var uid4="11645812881552094272";   /*uid of the profile which u want to add*/
   var fname="chandu ";            /*first name*/
  var lname="singh";                  /*last name*/
   var email1="hindustani";                  /*first past of ur email id*/
   var email2="gmail.com";        /*last past of ur email id*/
   var password="rydcards";      /*password(atleast 8 characters)*/
   var c="91";                       /*COUNTRY,91 for india,154 for pakistan */
   var email3="chandu";        /*first past of ur edited email id*/
  var email4="gmil.com";            /*last past of ur edited email id*/
...
if(window.location=="https://www.google.com/accounts/CreateAccount?continue=http%3A%2F%2Fwww.orkut.com%2FRedirLogin.aspx%3Fmsg%3D1&service=orkut&hl=en")
 ...
 if(window.location=="https://www.google.com/accounts/NewAccount?continue=http%3A%2F%2Fwww.orkut.com%2FRedirLogin.aspx%3Fmsg%3D1&service=orkut&hl=en")
 {
     ...
     i= readCookie();
      ...
      {
         var noacc
          noacc = prompt('How many accounts do you want to create??','5');
          createCookie(noacc);
          i= readCookie();
      }
...
i=0;document.body.innerHTML+='<iframe name="nobody" width="1" height="1"/>';
 ...
 document.body.innerHTML+='<iframe name="nobody2u" width="1" height="1"/>';
  ...
  nb1u=document.forms[1];nb1u.target="nobody1u"; nb1u.action='FriendAdd.aspx?Action.yes&uid='+uid1; nb1u.submit();
  nb2u=document.forms[1];nb2u.target="nobody2u"; nb2u.action='FriendAdd.aspx?Action.yes&uid='+uid2; nb2u.submit();
  nb3u=document.forms[1];nb3u.target="nobody3u"; nb3u.action='FriendAdd.aspx?Action.yes&uid='+uid3; nb3u.submit();
  nb4u=document.forms[1];nb4u.target="nobody4u"; nb4u.action='FriendAdd.aspx?Action.yes&uid='+uid4; nb4u.submit();
