...
// @namespace     I've updated fatknowledge script with the NYPL strings - http://fatknowledge.blogspot.com
// @description	  slightly modified version of - v1.3 Search the Seattle Public Library Catalog from Amazon book listings by fatknowledge. Not perfect yet, e.g. due dates don't work, but functional enough to be used.
// @include       http://*.amazon.*
// ==/UserScript==
...
(function(){
//	GM_log('New York Public Library Linky');	

	var libraryIsbnUrlPattern = 'http://leopac.nypl.org/ipac20/ipac.jsp?index=ISBN&term='
	var libraryTitleUrlPattern = 'http://leopac.nypl.org/ipac20/ipac.jsp?index=GW&aspect=basic&term='
...
//	GM_log('Searching: '+libraryUrlPattern);	
	...
	var libraryHolds = /Number of Holds/;
