		...
		qx.Class.define('ccta_pa',
		{
			...
			construct: function()
			{
				try
				{
					...
					var img = new qx.ui.basic.Image('http://imageshack.us/scaled/thumb/69/pgi2.jpg');
					...
					var info = new qx.ui.groupbox.GroupBox("");
					...
					var createTable = function(){
						...
						var columns = [["Nível POI", "Pontuação"], ["Quantidade", "Pontuação Precisa", "Bonus", "Percentagem"], ["Classificação", "Multiplicação"]];
					...
					[['Pontuações', 'score'], ['Muliplicação', 'multiplier'], ['Quantidade', 'bonus']].map(function(key){
			...
			members:
			{
				...
				__getData: function(n,r)
				{
					try
					{
						...
						var	poisConstructor = function()
						{
							...
							this.pwr = {"scr": ranks[2].s, "color": "#8cc1c7", "range": range(ranks[2].s), "type": 1, "rank": ranks[2].r, "name": "Reactores"};
							this.tun = {"scr": ranks[3].s, "color": "#d7d49c", "range": range(ranks[3].s), "type": 2, "rank": ranks[3].r, "name": "Tungenio"};
							this.urn = {"scr": ranks[4].s, "color": "#dbb476", "range": range(ranks[4].s), "type": 2, "rank": ranks[4].r, "name": "Uranio"};
				...
				__graph: function()
				{
					...
					addRow('Quantidade', tier, table, 0);
					addRow('Classificação Aliança', poiRank, table, 0);		
					addRow('Pontuação', score, table);
					addRow('Proxima Pontuaçºao', nextTier, table, 0);
					addRow('Bonus', bns, table, 1);
					addRow('Proximo Bonus', nextBns, table, 0);
