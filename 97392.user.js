...
"ae" : {// عربي
		...
		"player"   : "لاعب",
		"tribe"    : "القبيلة",
		"i_player" : "إظهار معلومات لاعب",
		"i_tribe"  : "إظهار معلومات قبيلة",
		"loading"  : "تحميل...",
		"c_close"  : "انقر فوق لإغلاق",
		"track"    : "مسار القرية",
		"tracked"  : "تتبع قرية",
		"untrked"  : "قرية غير متعقب",
		"untrack"  : "untrack village",
		"cltrack"  : "مسح الكل",
		"notrack"  : "لا تتبع القرى",
		"oktrack"  : "تتبع القرى",
		"at_none"  : "هجوم مرة أخرى",
		"at_same"  : "هجوم مرة اخرى مع القوات نفسه",
		"at_all"   : "هجوم مرة اخرى مع جميع القوات",
		"mapsize"  : "حجم الخريطة",
		"pop_close": "إغلاق",
		"pop_auto" : "اظهار تلقائيا :",
		"group_toggle" : "إظهار / إخفاء تكوين المجموعات",
		"group_edit" : "حفظ التغييرات",
		"group_moveup" : "نقل هذه المجموعة للأعلى",
		"group_remove" : "حذف",
		"group_add" : "إضافة",
		"group_village" : "قرى",
		"group_nogroup" : "تفريق",
		"group_action" : "اعمل",
		"group_store" : "تحديث مجموعات",
		"group_storeDone" : "تم تحديث المجموعات! عادة تحميل الصفحة نظرة عامة..",
		"group_name" : "اسم المجموعة",
		"group_ingroup" : "المجموعة الحالية",
		"overview_nogroup" : "اخفاء القرى",
		"overview_village" : "قرى",
		"overview_points" : "النقاط",
		"overview_resources" : "الموارد",
		"overview_warehouse" : "مخزن",
		"overview_farm" : "المزرعة",
		"main_setaliasheader" : "تغيير الاسم القرية :",
		"main_setalias" : "حفظ الاسم",
		"main_setaliasdone" : "تم حفظ الاسم!",
		"setting_show" : "TW Enhancer",
		"setting_name" : "اسم البرنامج المساعد",
		"setting_toggle" : "تمكين / تعطيل",
		"setting_label_desc" : "الوصف",
		"setting_label_version" : "الإصدار",
		"setting_label_dev" : "المطور",
		"setting_label_exec" : "لتشغيل",
  		"tw_scan" : "TribalWars just tried to scan you for using scripts!"
 },
