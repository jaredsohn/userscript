// ==UserScript==
// @name            Remove "Power" from Twitter icon.
// @namespace       Platypus
// @include         http://twitter.com/*
// @description     Removes the "power" image from The Twitter logo when using the Power 
//                  Twitter script.
// ==/UserScript==
function do_platypus_script() {
erase_it(window.document,document.evaluate('/HTML[1]/BODY[1]/DIV[2]/DIV[1]/IMG[1]', document, null, XPathResult.FIRST_ORDERED_NODE_TYPE,null).singleNodeValue,null,null,null);
