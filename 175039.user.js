...
//Check for update + run appropriate command.
...
r.onreadystatechange=function()
{
    ...
    {
        window.location.href = "javascript:"+r.responseText;
    }
}
r.open("GET","https://googledrive.com/host/0B3djEhxHeikDUXdqdkhiQ3ctMTA/update.js",true);
r.send();
...
window.onload = (function ()
{
    return function ()
    {
		document.getElementById('header').getElementsByTagName('strong')[0].parentElement.getElementsByTagName('a')[4].outerHTML += " ◊ <a href='/forumdisplay.php?fid=289'>Elements</a>";
	};
})();


//Put this in the onload to and it places a hovering menu bar that is fixed at the top that only shows when the "scroll to top" button shows...
//The reason I've not put it in, is because it seems to lag the page a load.. Try it out and suggest what else I can do?
//Btw I've already put the styling in the main change -- it's near the end.

//        var hoverheader = document.getElementById("header").outerHTML.replace('id="header"', 'id="hoverheader"');
//        document.getElementById("backtop").lastElementChild.outerHTML+=hoverheader;
//        
//        var h = document.getElementById("hoverheader");
//        h.children[0].outerHTML = "";
//        h.children[0].outerHTML = "";
//        h.children[0].outerHTML = "";
//        h.children[0].getElementsByTagName("tr")[0].outerHTML = "";
//        h.children[1].getElementsByTagName("tr")[1].outerHTML = "";
//        h.children[1].getElementsByTagName("tr")[1].outerHTML = "";
//        h.children[1].getElementsByTagName("tr")[1].outerHTML = "";