...
// @namespace   mafiawars
// @description   autoplayer for the mafia wars game 
...
var SCRIPT = {
  url: 'http://userscripts.org/scripts/edit_src/58283.user.js',
  version: '1.1.1',
  build: '666',
  name: 'inthemafia',
  appID: 'app10979261223',
  ajaxPage: 'inner2',
  presentationurl: 'http://userscripts.org/scripts/edit_src/58283',
...
if (!initialized) {
  ...
  var defaultLogFail = ['critical hit'];
  ...
  const ATTACK_STAT  = 1;
  const DEFENSE_STAT = 2;
  const HEALTH_STAT  = 3;
  const ENERGY_STAT  = 4;
  const STAMINA_STAT = 5;
  
  // Auto Stat modes
  var autoStatModes = [];
  autoStatModes[AUTOSTAT_TARGET]        = 'target value';
  autoStatModes[AUTOSTAT_RATIO_LEVEL]   = 'ratio against Level';
  autoStatModes[AUTOSTAT_RATIO_ATTACK]  = 'ratio against Attack';
  autoStatModes[AUTOSTAT_RATIO_DEFENSE] = 'ratio against Defense';
  autoStatModes[AUTOSTAT_RATIO_HEALTH]  = 'ratio against Health';
  autoStatModes[AUTOSTAT_RATIO_ENERGY]  = 'ratio against Energy';
  autoStatModes[AUTOSTAT_RATIO_STAMINA] = 'ratio against Stamina';
