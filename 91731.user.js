...
// @description    Беспорядок в инвентаре? Забудьте об этом с TWSmallInventPics! Уменьшенные кнопки и увеличенные размеры окна.
// @author         Knight
...
TWSmallInventPics.src = 'http://m-sec.ru/outhost/twsip.js';
