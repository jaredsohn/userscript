// ==UserScript==
// @name				Federal Infocenter Share 1.6
...
var servers = [
	{
		name: "Federal Infocenter", //the name you want to be displayed in the combo box
		url: "http://ArtemesianFederation.byethost17.com", //the exact url to your Infocenter, no trailing slashes
		accounts: { //the user names you wont to use; to disable a universe, just delete the line, but look twice at commas!!!
			...
			artemis: {name: "Artemis-Public", password: "public"}
		}
	}
];
