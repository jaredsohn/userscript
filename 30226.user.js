// ==UserScript==
// @name           ByBeR SHOUTBOX
// @description    Shoutbox para la alianza SmYoS
...
unsafeWindow.displayshout = function() {
	if(displayedflag == 0) {
		document.getElementById("shoutframe").innerHTML = '<iframe width="200" border="0" frameborder="0" height="100%" src="http://www4.shoutmix.com/?byber" style="margin-left:0px;"></iframe>';
		displayedflag = 1;
	}
}
...
document.getElementById("shoutbar").innerHTML ='<div id="shouttab" onclick="showshout()" ondblclick="hideshout()"><a style="height:100%;width:100%;"></a></div>'
	...
	+ '<a style="border-bottom:1px #542C0F dotted; color: #542C0F;" href="http://ikariam.forosonline.es" target="_blank">SmYoS</a></div>'
	+ '<div id="shoutframe" style="position:absolute;top:30px;bottom:3px;righ:0px;" onmouseover="displayshout()">Mouse over this area to load the shoutbox</div>'
