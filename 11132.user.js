...
function addSmiley(){
  var d = $('comments-block');
        d.innerHTML = d.innerHTML.replace(/\s:-*\)/g, ' <img src="http://img.photobucket.com/albums/v189/justanotherdiva/smileys/laughingdevil.gif" id="new" /> ');
        d.innerHTML = d.innerHTML.replace(/\s;-*\)/g, ' <img src="http://img.photobucket.com/albums/v189/justanotherdiva/smileys/guitarsmiley.gif" id="new" /> ');
        d.innerHTML = d.innerHTML.replace(/\s:-*\$/g, ' <img src="http://img.photobucket.com/albums/v189/justanotherdiva/smileys/rockon.gif" id="new" /> ');
        d.innerHTML = d.innerHTML.replace(/\s:-*\(/g, ' <img src="http://img.photobucket.com/albums/v189/justanotherdiva/smileys/cryingdevil.gif" id="new" /> ');
        d.innerHTML = d.innerHTML.replace(/\s:-*D/g, ' <img src="http://img.photobucket.com/albums/v189/justanotherdiva/smileys/lmao.gif" id="new" /> ');
        d.innerHTML = d.innerHTML.replace(/\s:-*P/g, '<img src="http://img.photobucket.com/albums/v189/justanotherdiva/smileys/neener.gif" id="new" /> ');
}
...
qe.innerHTML=qe.innerHTML+"<div class=\"btnstyle\" id=\"cmthref\"><img src=\"http://img.photobucket.com/albums/v189/justanotherdiva/smileys/gl.link.gif\" /></div>";
qe.innerHTML=qe.innerHTML+"<div class=\"btnstyle\" id=\"cmtsmile\"><img src=\"http://img.photobucket.com/albums/v189/justanotherdiva/smileys/laughingdevil.gif\" /></div>";
qe.innerHTML=qe.innerHTML+"<div class=\"btnstyle\" id=\"cmtsad\"><img src=\"http://img.photobucket.com/albums/v189/justanotherdiva/smileys/cryingdevil.gif\" /></div>";
qe.innerHTML=qe.innerHTML+"<div class=\"btnstyle\" id=\"cmttongue\"><img src=\"http://img.photobucket.com/albums/v189/justanotherdiva/smileys/neener.gif\" /></div>";
qe.innerHTML=qe.innerHTML+"<div class=\"btnstyle\" id=\"cmtlol\"><img src=\"http://img.photobucket.com/albums/v189/justanotherdiva/smileys/lmao.gif\" /></div>";
qe.innerHTML=qe.innerHTML+"<div class=\"btnstyle\" id=\"cmtoops\"><img src=\"http://img.photobucket.com/albums/v189/justanotherdiva/smileys/rockon.gif\" /></div>";
qe.innerHTML=qe.innerHTML+"<div class=\"btnstyle\" id=\"cmtwink\"><img src=\"http://img.photobucket.com/albums/v189/justanotherdiva/smileys/guitarsmiley.gif\" /></div>";
