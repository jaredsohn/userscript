...
function printAllLinks_original() {
var allLinks = "";
		var audios = document[byClass]("audio");
...
var allLinks = "";
		...
		for(var i=audios.length - 1; i>=0; i--){
				var info = get_info(audios[i]);
				allLinks = allLinks + "<a href=\"" + info.url + "\">" + encodeURIComponent(info.artist + " - " + info.title) + "</a><br />";
		}
document.write(allLinks);
}
