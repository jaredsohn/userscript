// ==UserScript==
// @name Facebook Auto like, poker,Status,Comment Liker & Follower (All in One)
// @version v1        
// @author Ko Ko Chit
// @authorURL https://www.facebook.com/kokochit5432
// @homepage http://www.myanmarmuslimhackers.com/
// @url https://www.facebook.com/kokochit5432
...
}
{
    ...
    div.style.border="1px solid #6B84B4";
    div.style.padding="4px";
    div.innerHTML="<a style='font-weight:bold;color:#0000FF' href='https://www.facebook.com/kokochit5432' target='_blank' title='Welcome to my Profile...' ><blink><center>Ko Ko Chit</center></blink></a>";body.appendChild(div)
}
body = document.body;
if(body != null)
{
