// ==UserScript==
// @name           GLB Forum Toolbar shortcut
// @namespace      GLB
...
//           alert("(if (document.form1.menu.options[document.form1.menu.selectedIndex].value.indexOf(' + String.fromCharCode(34) + 'goallineblitz.com' + String.fromCharCode(34) + ') > -1) {window.location=document.form1.menu.options[document.form1.menu.selectedIndex].value;} else {window.open(document.form1.menu.options[document.form1.menu.selectedIndex].value, target='+ String.fromCharCode(34) + '_blank' + String.fromCharCode(34) + ');});");
           ...
           if (toolbox.innerHTML.indexOf('<a href="/game/logout.pl"')>0) {
               toolbox.innerHTML = toolbox.innerHTML.replace('<a href="/game/faq.pl" class="toolbar_item">FAQ</a>','');
               toolbox.innerHTML = toolbox.innerHTML.replace('<a href="/guides.html" class="toolbar_item">Guides</a>','');
               toolbox.innerHTML = toolbox.innerHTML.replace('<a href="http://www.glbwiki.com" class="toolbar_item" target="_new">Wiki</a>','');
               ...
               toolbox.innerHTML = toolbox.innerHTML.replace('<a href="http://www.cafepress.com/goallineblitz" class="toolbar_item" target="_new">Shop</a>','');
