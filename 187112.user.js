...
// @description  show SI and exact REC in FMU Player page
...
case "Defender/Defensive Midfielder Center":
                            ...
                            break;
case "Defender/Midfielder Center":
                            recSkills += skill * weightR2[0][i];
                            recSkills2 += skill * weightR2[4][i];
                            break;
case "Defender/Offensive Midfielder Center":
                            recSkills += skill * weightR2[0][i];
...
case "Defender/Midfielder Right":
                            ...
                            break;
case "Defender/Offensive Midfielder Left":
case "Defender/Offensive Midfielder Right":
                            recSkills += skill * weightR2[1][i];
                            recSkills2 += skill * weightR2[7][i];
                            break;
case "Defender Left, Forward":
case "Defender Right, Forward":
                            recSkills += skill * weightR2[1][i];
                            recSkills2 += skill * weightR2[8][i];
                            break;
...
case "Defensive Midfielder/Midfielder Center":
                            ...
                            recSkills2 += skill * weightR2[4][i];
                            break;
case "Defensive Midfielder/Offensive Midfielder Center":
                            recSkills += skill * weightR2[2][i];
                            recSkills2 += skill * weightR2[6][i];
                            break;
case "Defensive Midfielder Center, Forward":
                            recSkills += skill * weightR2[2][i];
                            recSkills2 += skill * weightR2[8][i];
                            break;
...
case "Defensive Midfielder/Midfielder Right":
                            ...
                            recSkills2 += skill * weightR2[5][i];
                            break;
case "Defensive Midfielder/Offensive Midfielder Left":
case "Defensive Midfielder/Offensive Midfielder Right":
                            recSkills += skill * weightR2[3][i];
                            recSkills2 += skill * weightR2[7][i];
                            break;
case "Defensive Midfielder Left, Forward":
case "Defensive Midfielder Right, Forward":
                            recSkills += skill * weightR2[3][i];
                            recSkills2 += skill * weightR2[8][i];
                            break;
...
case "Midfielder Center/Right":
                            ...
                            recSkills2 += skill * weightR2[5][i];
                            break;
case "Midfielder/Defender Center":
                            recSkills += skill * weightR2[4][i];
                            recSkills2 += skill * weightR2[0][i];
                            break;
...
case "Midfielder Left/Center":
                            ...
                            recSkills2 += skill * weightR2[4][i];
                            break;
case "Midfielder/Defender Right":
case "Midfielder/Defender Left":
                            recSkills += skill * weightR2[5][i];
                            recSkills2 += skill * weightR2[1][i];
                            break;
...
case "Offensive Midfielder Center/Right":
                            ...
                            recSkills2 += skill * weightR2[7][i];
                            break;
case "Offensive Midfielder/Defender Center":
                            recSkills += skill * weightR2[6][i];
                            recSkills2 += skill * weightR2[0][i];
                            break;
case "Offensive Midfielder/Defensive Midfielder Center":
                            recSkills += skill * weightR2[6][i];
                            recSkills2 += skill * weightR2[2][i];
                            break;
...
case "Offensive Midfielder Left/Center":
                            ...
                            recSkills2 += skill * weightR2[6][i];
                            break;
case "Offensive Midfielder/Defender Right":
case "Offensive Midfielder/Defender Left":
                            recSkills += skill * weightR2[7][i];
                            recSkills2 += skill * weightR2[1][i];
                            break;
case "Offensive Midfielder/Defensive Midfielder Right":
case "Offensive Midfielder/Defensive Midfielder Left":
                            recSkills += skill * weightR2[7][i];
                            recSkills2 += skill * weightR2[3][i];
                            break;
...
case "Goalkeeper":
                            recSkills = recSkills / 11 * 14;
                            recSkills = (recSkills - weightR3[14]) / weightR3[15];
                            break;
case "Defender Center": 
...
case "Defensive Midfielder/Midfielder Right":
                            ...
                            recSkills2 = (recSkills2 - weightR2[5][14]) / weightR2[5][15];
                            break;
case "Defensive Midfielder/Offensive Midfileder Left":
case "Defensive Midfielder/Offensive Midfielder Right":
                            recSkills = (recSkills - weightR2[3][14]) / weightR2[3][15];
                            recSkills2 = (recSkills2 - weightR2[7][14]) / weightR2[7][15];
                            break;
...
case "Midfielder/Defender Left":
                            ...
                            recSkills2 = (recSkills2 - weightR2[1][14]) / weightR2[1][15];
                            break;
case "Midfileder/Defensive Midfielder Right":
case "Midfielder/Defensive Midfielder Left":
                            recSkills = (recSkills - weightR2[5][14]) / weightR2[5][15];
                            recSkills2 = (recSkills2 - weightR2[3][14]) / weightR2[3][15];
                            break;
