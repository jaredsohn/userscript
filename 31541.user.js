// ==UserScript==
// @name           Chatbox des pirates
// @description    Chatboxprivee pour l'alliance l'olonnais - serveur epsilon
// @version        0.2
// @include        http://s5.ikariam.fr/*
// @include        http://lolonnais.forumactif.net/*
// @author         hokage
// ==/UserScript==
...
unsafeWindow.displayshout = function() {
	if(displayedflag == 0) {
		document.getElementById("shoutframe").innerHTML = '<iframe src="http://www.i-tchat.com/shoutbox/shoutbox.php?idShoutbox=60996" width="200" height="97%" frameborder="0" allowtransparency="true" ></iframe>';
		displayedflag = 1;
	}
}
