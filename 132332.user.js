// ==UserScript==
                                // @name           Fucktard Ignore Script
                                // @namespace      Forum
                                // @include        http://goallineblitz.com/game/forum_thread.pl?*
                                // @include        http://goallineblitz.com/game/forum_thread_list.pl?*
                                // ==/UserScript==
                                
                                var list = ['jdbolick', 'bhall43', 'Dpride59', 'Gart888', 'Tw1nty', 'joemalaka', 'Bushido Zin', 'captobvious', 'Canaan Cracker', 'djinnt', 'wormser1971', 'PatrickStump', 'Darkus Black'];
