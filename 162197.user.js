// ==UserScript==
// @name        Ultoo SUper Fast ALL in 1 by TERMINAL  
...
if(url.search(pattern)==0)
{
	...
	{
		document.getElementsByName('PollUserName')[0].value="Ultoo Girl";
		document.getElementsByName('PollUserQuestion')[0].value="Ultoo give me???'"+Math.floor((Math.random() * 10000000000000000) + 1)+"'";
...
if(url.search(pattern)==0)
{
	...
	{	
		document.getElementById('MobileNos_').value=8559897543;
                document.getElementById('Message_').value="Are you Virgin???....no! its ok '"+Math.floor((Math.random() * 200000000000000000) + 2);
