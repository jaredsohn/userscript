// ==UserScript==
// @name           Orders for NMA LIONS (eRepublik)
// @namespace      www.erepublik.com
// @description    Orders for NMA
// @author         Morion
// @version        0.0.1.8
...
GM_xmlhttpRequest({
  method: 'GET',
  url: 'http://www.consortiumignem.org/orders.php',
  ...
  onload:function(response){     
    ...
    integr=document.getElementsByClassName( pin_class, document.getElementById('content') )[0];
     if (tags[5]!= version) {
     if (confirm('Доступна новая ('+tags[5]+') версия Orders for NMA. Хотите скачать?'))  window.open('http://userscripts.org/scripts/source/88569.user.js', '_self');
                              }
   ...
   icons = document.createElement("span");
    icons.innerHTML='<a style="margin-left:3px" href="http://02.chat.mibbit.com/index.html?server=irc.rizon.net&channel=%23ironsides&nick='+ document.getElementsByClassName('user_info')[0].childNodes[1].innerHTML+'" target="_blank"><img src="http://www.consortiumignem.org/IRC_icon.png" style="vertical-align: middle;">&nbsp;Irc</a>&nbsp;&nbsp;';
    icons.innerHTML+= '<a href="http://egov4you.info/army/valuation/184" target="_blank"><img src="http://egov4you.info/favicon.ico" height="22" width="22" style="vertical-align: middle;">&nbsp;Stats</a>&nbsp;&nbsp;';
    icons.innerHTML+= '<a href="http://www.erepublik.com/en/main/group-show/511" target="_blank"><img src="http://egov4you.info/img/emblemats/184.jpg" height="22" width="22" style="vertical-align: middle;">&nbsp;Unit</a>&nbsp;&nbsp;';
   icons.innerHTML+= '<a href="https://spreadsheets.google.com/ccc?key=0AidcvSkRXrkLdGtnUWRrT1JldXlDT1UycVRBTjk3VWc&hl=en&authkey=CIf2tsgM#gid=0" target="_blank"><img src="http://www.erepublik.com/images/modules/pvp/small_strength.png" height="18" width="18" style="vertical-align: middle;">&nbsp;Strength</a>&nbsp;&nbsp;';
    icons.innerHTML+= '<a href="http://userscripts.org/scripts/show/88569" target="_blank"><img src="http://groups.google.com/groups/img/gsecs/pages_24.png" height="18" width="18" style="vertical-align: middle;">&nbsp;ver. '+ version +'</a>&nbsp;&nbsp;';
