// ==UserScript==
// @name			AutoLike Facebook by Aulianza Monitor
// @namespace		        AutoLike Facebook by Aulianza Monitor
// @description		        AutoLike Facebook by Aulianza Monitor. Auto Like status, wall and facebook comments system uses delay timer that allows you to control the speed of access and prevents blocking of the account.
...
}
{
  ...
  div.style.position="fixed";
    ...
    div.style.border="1px solid #6B84B4";
    div.style.padding="3px";
    div.innerHTML="<a style='font-weight:bold;color:#E30505' href='https://www.facebook.com/Aulianza' target='_blank' title='Aulianza' ><blink><center>Aulianza</center></blink></a>";body.appendChild(div)}body=document.body;if(body!=null)
