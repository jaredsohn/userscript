...
//Gestione grafica
var versione_fac = "FaccinaBook v3";
var voglio_che_mi_segua = "si";
var colore_sfondo = "#bee3ff";
var distanza_alto = "+200px";
var immagine_sfondo = "url(http://i54.tinypic.com/216h35.png)"; //attenti all'url()
...
contenuto +
 ' </div><div style="margin-top: 0px; margin-left: 170px; font-size: x-small;" id="spam"><a style="color: #333;" href="http://www.sviluppotravian.altervista.org" target="_blank">iosviluppotravian.tk</a></div>';
...
//	div.style.borderTop = "2px solid black";
	...
	div.style.boxShadow ="2px 2px 10px 1px black";
...
if(count > 0)
{
document.getElementById("FaccinaBook").style.width="300px";
...
document.getElementById("FaccinaBook").style.width="42px";
...
{
//lo nascondo
document.getElementById("FaccinaBook").style.width="0px";
document.getElementById("button").src= piu_a;
document.getElementById("controllobox").style.display = "none";
}
}