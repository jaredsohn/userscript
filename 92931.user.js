...
// Linkadressen fuer reloaded hamburg
if (url.indexOf("http://reloaded.pennergame.de")>=0) {
var link = "http://reloaded.pennergame.de"
var spendenlink = 'http://reloaded.pennergame.de/change_please/';//3877811/
}
// Linkadressen fuer Muenchen
if (url.indexOf("http://muenchen")>=0) {
var link = "http://muenchen.pennergame.de"
var spendenlink = 'http://change.muenchen.pennergame.de/change_please/';
}
// Linkadressen fuer Koeln
if (url.indexOf("http://koeln")>=0) {
var link = "http://koeln.pennergame.de"
var spendenlink = 'http://koeln.pennergame.de/change_please/';//8230318/
}
...
var spendenlink = 'http://reloaded.clodogame.fr/change_please/';//7187198/
}
// Linkadressen fuer Marseille Frankreich
if (url.indexOf("marseille")>=0) {
var link = "http://marseille.clodogame.fr"
var spendenlink = 'http://marseille.clodogame.fr/change_please/';//4320216/
}
...
// Linkadresse Krakow Menelgame
if (url.indexOf("krakow")>=0) {
var link = "http://krakow.menelgame.pl"
var spendenlink = 'http://krakow.menelgame.pl/change_please/';//7753406/
}
// Linkadresse reloaded.menelgame
if (url.indexOf("reloaded.menelgame.pl")>=0) {
var link = "http://reloaded.menelgame.pl"
var spendenlink = 'http://reloaded.menelgame.pl/change_please/';//2718299/
}
