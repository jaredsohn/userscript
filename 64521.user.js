// ==UserScript==
// @name           funkysouls.com paginator
// @description    Dirty/Leprosorium like paginator for funkysouls.com
...
Paginator.prototype.initEvents = function() {
	...
	this.html.scrollThumb.addEventListener('mousedown', function(e) {
		if (!e) var e = window.event;
		e.cancelBubble = true;
		if (e.stopPropagation) e.stopPropagation();

		var dx = getMousePosition(e).x - _this.html.scrollThumb.xPos;
		onmove = function(e) {
			if (!e) var e = window.event;
	...
	this.html.scrollBar.addEventListener('mousedown', function(e) {
		if (!e) var e = window.event;
	...
	for (var i = 0; i < this.html.tdsPages.length; i++) {
		...
		if (cellCurrentValue == this.inputData.pageCurrent) {
			...
			if (cellCurrentValue === 1) {
				...
				html = "<span>" + "<a href='" + this.inputData.baseUrl + cellCurrentValue + "index.html'>" + cellCurrentValue + "</a>" + "</span>";
			}
		}
...
var td77 = document.querySelector(".td77");
var lnks = td77.getElementsByTagName("a");
var pages = Number(lnks[lnks.length - 1].innerText);
var current = 1;

if (isNaN(pages)) {
	pages = Number(lnks[lnks.length - 1].innerHTML);
}

if (window.location.pathname !== "/") {
	current = Number(/.(\d*)index.html/.exec(window.location.pathname)[1]);
}

paginator_div.className = "paginator";
paginator_div.id = "paginator_div";
td77.parentNode.replaceChild(paginator_div, td77);
var paginator = new Paginator("paginator_div", pages, 30, current, "http://funkysouls.com/");
