// ==UserScript==
// @name           [BFSU] BlackFantome Script Utilities
...
var BFSU = function ()
{
	...
	if (mywindow.BFSU_started) return;
	mywindow.BFSU_started = 1;
	...
	var Tools =
	{
		...
		getValue: function (cookieName, cookieValue)
		{
			...
			return GM_getValue ('Ikariam_' + cookieName + '_monde_' + Options.monde, cookieValue);
		},
		init: function ()
		{
		...
		setValue: function (cookieName, cookieValue)
		{
			...
			GM_setValue ('Ikariam_' + cookieName + '_monde_' + Options.monde, cookieValue);
		},
...
if (window.navigator.userAgent.indexOf('Chrome') > -1 && window.google)
	document.location.href = 'javascript:('+BFSU+')();void(0);';
else
	BFSU();