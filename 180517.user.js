...
(function()
{
	...
	var _defs={
		"libble.me":					function(){return _extend(_protos["gazelle"],
									{
										siteName:	"libble.me",
										svPrefix:	"lib"
									});},
		"indietorrents.com":		function(){return _extend(_protos["gazelle"],
									{
										siteName:	"indietorrents",
										svPrefix:	"it"
									});}
	};
	var version="0.9.8";
	...
	if(validLinks.length)
	{
		...
		for(var i=0;i<validLinks.length;i++)
		{
			...
			if(res)
			{
				...
				{
					validLinks[i].innerHTML+=" <span style=\"color:white;font-weight:bold;background:black\">S</span>"; //  "+res+"
		...
		if(snatchMode)
		{
			...
			if(ibn)
			{
				...
				var text=
					...
					"Snitch! "+version+" <sup>by xbtc ft. totallywired</sup> knows of <b>"+known+"</b> snatches.";
