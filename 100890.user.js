...
"<div class='dlgContainer'>" +
	...
	"<div class='activeDialogView' id='cfgFunctionalModules'>" +
		...
		"</div>" +
		// MessagingEnhancements
		"<div class='cfgLine'>" +
			"<div class='cfgLineToggleDiv'>" +
				"<input type='checkbox' id='cfgMessagingEnhancements' />" +
			"</div>" +
			"<div class='cfgLineDescription'>" +
				"<div class='cfgModuleName'>" +
				...
				"</div>" +
				"<div class='cfgSubLine'>" +
					"Adds the option of saving a message as a draft and editing it later.<br/>"+
					"Also adds a dropdown list of members to the compose message page. " +
				"</div>" +
			"</div>" +
			"<div style='clear: both;'><!-- --></div>" +
		"</div>" +
...
var EnableModule_messagingEnhancements = GM_getValue("module_messagingEnhancements", true);
...
if(EnableModule_messagingEnhancements)
  $("#cfgMessagingEnhancements").attr("checked", "checked");
...
var checkBoxIdToPersistentKeyMap = {
	...
	"#cfgHideArcadePosts": "module_hideArcadePosts",
	"#cfgMessagingEnhancements": "module_messagingEnhancements"
...
// ==================================================================== //
// Module: MessagingEnhancements
// Description: Add the ability to save drafts and create a dropdown list
// of members to send to.
// ==================================================================== //

if(EnableModule_messagingEnhancements)
{
	if(uri.match("inbox|compose|outbox")) {  // add the drafts menu option
	}
}
