// ==UserScript==
// @name			IRC Mibbit Ogame
// @namespace		Origin
// @description		add link, IRC Sojuszu
// @version			1.0.5
// @include			http://*.ogame.pl/game/index.php?page=*
...
var server = GM_getValue("server","irc.mibbit.net");	
var charset = GM_getValue("charset","utf-8");			
var nick = GM_getValue("nick",pseudo);					
var channel = GM_getValue("channel","d23 inka");			
...
LinkDiv.innerHTML +='<li class="menubutton_table"><span class="menu_icon" id="idopt" style="color:grey"><img src="data:image/png;base64," height="29" width="38" /></span>'
              +'<a class="menubutton " href="'+linkirc+'" accesskey="" target="_blank" id="hrefirc"><span class="textlabel">IRC Sojuszu</span></a></li>';
...
function(event){
   ...
   inputtext.innerHTML += '<li class="menubutton_table"><a class="menubutton " href="#" ><span class="textlabel">kanał :</span></a></li>';
