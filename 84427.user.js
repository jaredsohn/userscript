...
twpro_lang = {
	info: ['NEXTON', 'mailto:nexton@tw-pro.de', 38340, '.10.'],
	WEBSITE: 'Yararlı Scriptler',
	AUTHOR: 'Çeviren',
	TRANSLATOR: 'Yazar',
	TWPRO_DISABLED: 'script kapatıldı',
...
*/
	...
	function twpro_injectScript() {
		...
		// Setitems
		{
			...
			TWPro.twpro_setBonus.set_dancer[5].bonus.skills.endurance = 16;
		...
		twpro_supportLink.href = 'http://forum.the-west.org/showthread.php?t=12525';
		...
		if (TWPro.twpro_getAuthor()) {
			twpro_supportAuthor.href = 'javascript:AjaxWindow.show(\'profile\',{char_id:38340},\'38340\');';
		}
		else {
			twpro_supportAuthor.href = 'http://userscripts.org/users/202825';
			twpro_supportAuthor.target = '_blank';
		}
		twpro_supportAuthor.appendChild(document.createTextNode("JohnCooper"));
		twpro_support.appendChild(document.createTextNode("Forum: "));
							...
							onComplete: function(resp){
								if(resp){
									...
									if(d){
											...
											td.colSpan = '2';
											td.appendChild(document.createTextNode('Win: '+d[1]+'; lose: '+d[2]+'; Diff: '+d[3]));
											tr.appendChild(td);
		...
		if(sortby == 'comb'){
			for(var i=0, twpro_job, twpro_jobv; i<TWPro.twpro_jobs.length; i++){
				...
				jobRank[twpro_job.shortName] = TWPro.multipliers.xp * twpro_jobv.erfahrung +
												...
												TWPro.multipliers.luck * twpro_jobv.glueck +
...
addGlobalStyle('#item_trader_button { position:absolute; width:36px; height:35px; margin-left:70px; top:-9px; background: transparent url(data:image/png;base64,) no-repeat; }');