...
var v = "7.3.20120714";
var scriptNum = "66656";
var scriptName = "Universal Links Checker v7";
...
var uploaded_to= new Array(6)
 ...
 uploaded_to[4]="//a[contains(@href,'uploaded.to/')]";
...
var dataport_cz= new Array(6)
 ...
 dataport_cz[2]='Soubor nebyl nalezen|Tento soubor neexistuje';
...
var shareflare_net= new Array(6)
 ...
 shareflare_net[2]='File not found,deleted for abuse or something like this';
...
var oron_com= new Array(6)
 oron_com[0]='oron\.com\/[a-z0-9A-Z]';
 oron_com[1]='File size:';
 oron_com[2]='File Not Found';
 oron_com[3]='dsdlhkhsgdsgdhskjhgd';
 oron_com[4]="//a[contains(@href,'oron.com')]";
 oron_com[5]='dsdlhkhsgdsgdhskjhgd';
...
var euroshare_eu= new Array(6)
 ...
 euroshare_eu[2]='Súbor sa nenašiel';
...
var cobrashare_sk= new Array(6)
 cobrashare_sk[0]='cobrashare\.sk';
 cobrashare_sk[1]='class\=\"popis\"';
 cobrashare_sk[2]='nenach.dza';
 cobrashare_sk[3]='dsdlhkhsgdsgdhskjhgd';
 cobrashare_sk[4]="//a[contains(@href,'cobrashare')]";
 cobrashare_sk[5]='dsdlhkhsgdsgdhskjhgd';
...
var fastshare_cz= new Array(6)
 ...
 fastshare_cz[1]='Velikost|Veľkosť';
 fastshare_cz[2]='zmazaný|smazán';
...
hotfile_com,uploading_com,multishare_cz,dataport_cz,fileserve_com,extabit_com,shareflare_net,freakshare_com,oron_com,bitshare_com,cramit_in,euroshare_eu,turbobit_net,usershare_net,uploadstation_com,
filekeen_com,bezvadata_cz,upnito_sk,cobrashare_sk,filefactory_com,filejungle_com,filepost_com,fastshare_cz,webshare_cz,rapidgator_net];
/*is this faster ?
...
+sharerapid_cz[4]+'|'+extabit_com[4]+'|'+shareflare_net[4]+'|'+freakshare_com[4]+'|'+oron_com[4]+'|'+bitshare_com[4]+'|'+cramit_in[4]+'|'+euroshare_eu[4]+'|'+turbobit_net[4]+'|'
+usershare_net[4]+'|'+uploadstation_com[4]+'|'+filekeen_com[4]+'|'+bezvadata_cz[4]+'|'+upnito_sk[4]+'|'+cobrashare_sk[4]+'|'+filefactory_com[4]+'|'+filejungle_com[4]+'|'+filepost_com[4]+'|'+fastshare_cz[4]+'|'
+webshare_cz[4]+'|'+rapidgator_net[4], document, null, XPathResult.UNORDERED_NODE_SNAPSHOT_TYPE, null);
...
var regex = /\b(http:\/\/|shttp:\/\/)(\w(\w|-)+\.)+(dk|com|net|org|se|no|nl|us|uk|de|it|nu|edu|info|cz|sk|pl|in|to|eu)[\w\-.+$!*\/(),~%?:@#&=\\—ěščřžýáíéúů]*/gi;
