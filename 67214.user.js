...
window.createQuickbarShortcuts = function() {
	"<tr>   " + 
	newShortcut("/graphic/buildings/main.png", "/game.php?village="+VillId+"&screen=main", "Rotušė   ");
	newShortcut("/graphic/buildings/barracks.png", "/game.php?village="+VillId+"&screen=barracks", "Kareivinės   ");
	newShortcut("/graphic/buildings/stable.png", "/game.php?village="+VillId+"&screen=stable", "Arklidės");
	newShortcut("/graphic/buildings/garage.png", "/game.php?village="+VillId+"&screen=garage", "Dirbtuvės   ");
    newShortcut("/graphic/buildings/snob.png", "/game.php?village="+VillId+"&screen=snob", "Akademija   ");
	newShortcut("/graphic/buildings/smith.png", "/game.php?village="+VillId+"&screen=smith", "Kalvė   ");
	+ "<tr>   " + 
	newShortcut("/graphic/buildings/place.png", "/game.php?village="+VillId+"&screen=place", "Aikštė   ");
    newShortcut("/graphic/buildings/market.png", "/game.php?village="+VillId+"&screen=market", "Turgus");
tableIdIndex++;
	trIdIndex++;
}