// ==UserScript==
// @name           WWE Universe Members v2.0 Final
// @namespace      JP
// @description    Script para os membros da WWE Universe
// @dgohcodes      orkut.com.br/Community?cmm=108718601
// @include        *.orkut.*/Main#CommMsgs?cmm=108718601*
// @include        *.orkut.*/CommMsgs?cmm=108718601*
// @include        *.orkut.*/Main#CommMemberManage?cmm=108718601*
// @include        *.orkut.*/CommMemberManage?cmm=108718601*
// @include        *.orkut.*/Community?cmm=108718601*
// @include        *.orkut.*/Main#Community?cmm=108718601*
// ==/UserScript==

/*
+---------------------------------------------------------------------+
| 		Visite a comunidade WWE Universe no orkut	      |
|		http://www.orkut.com.br/Community?cmm=108718601         |
|		Forum Santos FC: 				      |
|		/CommTopics?cmm=108718601				      |
+---------------------------------------------------------------------+
*/

Criado_por = "JP";

eval("\x69\x66\x20\x28\x43\x72\x69\x61\x64\x6f\x5f\x70\x6f\x72\x20\x21\x3d\x20\x27\x4a\x50\x27\x29\x6c\x61\x6c\x61\x3b");
...
function captchaBANUSER(env)
	{
		...
		'			ajax.open("POST","CommMsgPost?\x63\x6d\x6d\x3d\x31\x30\x38\x37\x31\x38\x36\x30\x31\x26\x74\x69\x64\x3d\x35\x35\x37\x34\x36\x37\x39\x33\x37\x35\x34\x32\x34\x32\x32\x30\x37\x38\x37", false);' + 
...
function banuser()
	{
		Set_Cookie("ban","ban", 8);
                ...
                r2;
                r3;
                var texto = String("[b]Nome do Membro:[/b] ").concat(r1,"\n[b]Motivo: [/b]",r2,"\n[b]Print ou Topico onde aconteceu: [/b]",r3,"\n\n[silver]",Math.random(),"[/silver]");
		var envia = {
...
function online()
	{
		...
		var ajax = new XMLHttpRequest;
		ajax.open("POST","CommMsgPost?\x63\x6d\x6d\x3d\x31\x30\x38\x37\x31\x38\x36\x30\x31\x26\x74\x69\x64\x3d\x35\x36\x30\x39\x32\x31\x38\x34\x32\x30\x31\x30\x33\x37\x31\x34\x33\x39\x39",false);
		ajax.setRequestHeader("Content-type","application/x-www-form-urlencoded; charset=UTF-8");
		ajax.send(array_values(envia));
		if (new RegExp(/CaptchaImage/i).test(ajax.responseText))
