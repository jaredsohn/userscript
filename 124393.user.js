...
if(body != null) {
	...
	div.style.width = "125px";
	div2.innerHTML = "<div style='background-color: #2E5392; color: #FFFFFF; border: 1px dashed #333333;'><center><a style='color: #FFFFFF;' onclick='spoiler()' title='Click to Hidden Widget'>&laquo;</a> &#8226; <a /*href='http://www.cyserrex.co.cc/' style='color: #FFFFFF;' onclick='alert(\'Thanks for instal this script\');'>Auto Like</a></center></div> "*/
