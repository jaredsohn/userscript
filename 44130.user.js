...
var version=70;
var scriptlocation="http://userscripts.org/scripts/source/44130.user.js";


// Settings for every server
switch (location.host) {
	default:
		alliancefullnm='LES IDS';
		alliancenm='IDS';		
		...
		//chaturl='.';
		chaturl='http://www.xat.com/chat/room/53840887/';
		//forumurl='.';
		forumurl='http://www.alliance-ids.com/forum.htm';
		//forumurlnew='.';
		forumurlnew='http://www.alliance-ids.com/forum.htm';
		break;		
}
	main();
	ToolsMenu();
 ...
 /*   var showbubble=Math.floor(Math.random()*10);
    if (showbubble%2) { //If Even
       addsbubble('diplomat',"Hééé!Koas t'es là?", 68);
       addsbubble('scientist',"Quoi man?", 71);
