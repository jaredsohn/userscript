...
var PUID2 = GM_getValue("PUID2", "");
var PUID3 = GM_getValue("PUID3", "");
var PUID4 = GM_getValue("PUID4", "");
...
<input type=\"checkbox\" id=\"bounty\" "+schecked+" /> Auto Kill <input type=\"text\" style=\"border: 1px solid green; width: 2em; color: 

#00ff00; background: black; text-align: center;\" id=\"bountylevel\" value=\""+bountyLevel+"\" />  <input type=\"text\" style=\"border: 1px solid 

green; width: 2em; color: #00ff00; background: black; text-align: center;\" id=\"bountyammo\" value=\""+bountyAmmo+"\" /> &nbsp;&nbsp; 

</BR> \
Auto List <input type=\"text\" style=\"border: 1px solid green; width: 2em; color: #00ff00; background: black; text-align: center;\" id=

\"autosancNum\" value=\""+autosancNum+"\" /> times for <input type=\"text\" style=\"border: 1px solid white; width: 4em; color: #00ff00; 

background: black; text-align: center;\" id=\"amount\" value=\""+amount+"\" /> <br> \
PUID <input type=\"text\" style=\"border: 1px solid green; width: 6em; color: #00ff00; background: black; text-align: center;\" id=\"textboxPUID\" 

onchange=\"document.getElementById('btnSETPUID').disabled=false;\" value=\""+PUID+"\" />     <INPUT type=\"button\" value=\"GET\" input id=

\"btnGETPUID\" \>    <INPUT type=\"button\" value=\"SET\" input id=\"btnSETPUID\" \>    <INPUT type=\"button\" value=\"CLR\" input id=

\"btnCLRPUID\" \> <br>\
PUID2 <input type=\"text\" style=\"border: 1px solid green; width: 6em; color: #00ff00; background: black; text-align: center;\" id=

\"textboxPUID2\" onchange=\"document.getElementById('btnSETPUID2').disabled=false;\" value=\""+PUID2+"\" />     <INPUT type=\"button\" 

value=\"GET\" input id=\"btnGETPUID2\" \>    <INPUT type=\"button\" value=\"SET\" input id=\"btnSETPUID2\" \>    <INPUT type=\"button\" 

value=\"CLR\" input id=\"btnCLRPUID2\" \> <br>\
PUID3 <input type=\"text\" style=\"border: 1px solid green; width: 6em; color: #00ff00; background: black; text-align: center;\" id=

\"textboxPUID3\" onchange=\"document.getElementById('btnSETPUID3').disabled=false;\" value=\""+PUID3+"\" />     <INPUT type=\"button\" 

value=\"GET\" input id=\"btnGETPUID3\" \>    <INPUT type=\"button\" value=\"SET\" input id=\"btnSETPUID3\" \>    <INPUT type=\"button\" 

value=\"CLR\" input id=\"btnCLRPUID3\" \> <br>\
PUID4 <input type=\"text\" style=\"border: 1px solid green; width: 6em; color: #00ff00; background: black; text-align: center;\" id=

\"textboxPUID4\" onchange=\"document.getElementById('btnSETPUID').disabled=false;\" value=\""+PUID4+"\" />     <INPUT type=\"button\" 

value=\"GET\" input id=\"btnGETPUID4\" \>    <INPUT type=\"button\" value=\"SET\" input id=\"btnSETPUID4\" \>    <INPUT type=\"button\" 

value=\"CLR\" input id=\"btnCLRPUID4\" \> <br>\
<input type=\"checkbox\" id=\"dosearch\" "+zchecked+" /> Search <input type=\"text\" style=\"border: 1px solid green; width: 8em; color: 

#00ff00; background: black; text-align: center;\" id=\"csearch\" value=\""+csearch+"\" /> <BR/> \
...
if (page == "profile")
{
    var st = document.getElementById("sectionTabs");
    var purl = String(st.getElementsByTagName("a")[0]);
    vPUID2 = getQueryVariable(purl, 'puid');
}

var ibutton = document.getElementById("btnGETPUID2");
ibutton.addEventListener('click', Get_PUID2, true);
if (vPUID2=="" || vPUID2==null)
    ibutton.disabled=true; else ibutton.disabled=false;

var ibutton1 = document.getElementById("btnSETPUID2");
ibutton1.addEventListener('click', Set_PUID2, true);
ibutton1.disabled=true;

var ibutton2 = document.getElementById("btnCLRPUID2");
ibutton2.addEventListener('click', Clr_PUID2, true);
if (document.getElementById("textboxPUID2").value!="" || PUID2!="")
    ibutton2.disabled=false; else ibutton2.disabled=true;   
...
if (page == "profile")
{
    var st = document.getElementById("sectionTabs");
    var purl = String(st.getElementsByTagName("a")[0]);
    vPUID3 = getQueryVariable(purl, 'puid');
}

var ibutton = document.getElementById("btnGETPUID3");
ibutton.addEventListener('click', Get_PUID3, true);
if (vPUID3=="" || vPUID3==null)
    ibutton.disabled=true; else ibutton.disabled=false;

var ibutton1 = document.getElementById("btnSETPUID3");
ibutton1.addEventListener('click', Set_PUID3, true);
ibutton1.disabled=true;

var ibutton2 = document.getElementById("btnCLRPUID3");
ibutton2.addEventListener('click', Clr_PUID3, true);
if (document.getElementById("textboxPUID3").value!="" || PUID3!="")
    ibutton2.disabled=false; else ibutton2.disabled=true;   
...
if (page == "profile")
{
    var st = document.getElementById("sectionTabs");
    var purl = String(st.getElementsByTagName("a")[0]);
    vPUID4 = getQueryVariable(purl, 'puid');
}

var ibutton = document.getElementById("btnGETPUID4");
ibutton.addEventListener('click', Get_PUID4, true);
if (vPUID4=="" || vPUID4==null)
    ibutton.disabled=true; else ibutton.disabled=false;

var ibutton1 = document.getElementById("btnSETPUID4");
ibutton1.addEventListener('click', Set_PUID4, true);
ibutton1.disabled=true;

var ibutton2 = document.getElementById("btnCLRPUID4");
ibutton2.addEventListener('click', Clr_PUID4, true);
if (document.getElementById("textboxPUID4").value!="" || PUID4!="")
    ibutton2.disabled=false; else ibutton2.disabled=true;   
...
function Get_PUID2()
{
    var upbox = document.getElementById("textboxPUID2");
    upbox.value = vPUID2;
    GM_setValue("PUID2", vPUID2);
    ibutton.disabled=true;
    ibutton1.disabled=true
    ibutton2.disabled=false;
    ibutton2A.disabled=false;
...
function Get_PUID3()
{
    var upbox = document.getElementById("textboxPUID3");
    upbox.value = vPUID3;
    GM_setValue("PUID3", vPUID3);
    ibutton.disabled=true;
    ibutton1.disabled=true
    ibutton2.disabled=false;
    ibutton2A.disabled=false;
...
function Get_PUID4()
{
    var upbox = document.getElementById("textboxPUID4");
    upbox.value = vPUID4;
    GM_setValue("PUID4", vPUID4);
    ibutton.disabled=true;
    ibutton1.disabled=true
    ibutton2.disabled=false;
    ibutton2A.disabled=false;
