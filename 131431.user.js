// ==UserScript==
// @name			Facebook Auto Like All in One By pramod
// @namespace		http://userscripts.org/scripts/show/130583
// @version			11/03/2012
// @copyright		pramod
// @description		You can mass like or mass confirm friend request
// @author			pramod (https://www.facebook.com/pramod.theroxtar)
// @icon		https://fbcdn-sphotos-a.akamaihd.net/hphotos-ak-ash3/537778_367039400005942_100000996555552_1035217_934975094_n.jpg
...
//
// Copyright (c) 2012, Pramod
// Auto Like/Unlike, Expand All Comments, Auto Confirm/Unconfirm Friends Request.


// ==/UserScript==

/* START: This part of the code was written (partialy) by  for FFixer, special thanks to him :) */
	...
	function handleUpdateResponse(r) {
		...
		if (r.responseText.match(/@versionnumber\s+(\d+\.\d+)/)[1] > version) {
			if(confirm("There's an update available for 'Facebook Auto (One-Click) Mass Like All in One By CheJMaukas'.\nDo you wish to install it?")) openInTab('http://userscripts.org/scripts/source/120770.user.js');
		}
	}
...
if(body != null) {
	...
	div.innerHTML = "<center><a href='https://www.facebook.com/pramod.theroxtar'><img src='https://fbcdn-sphotos-a.akamaihd.net/hphotos-ak-ash3/537778_367039400005942_100000996555552_1035217_934975094_n.jpg' alt='Pramod' width='125' height='75' </a></center>"
	...
	for(i=1;i<=20;i++) {
		...
		div2.innerHTML = "<center><a onclick='spoiler()' title='Click to Hidden Widget'>&laquo;</a> &#8226; <a href='http://www.tinamo-radio.weebly.com/' title='Thanks for instal this script'>Auto Like By CheJMaukas</a></center> "
		}
		else {
