// ==UserScript==
// @name           The West Zayif Paket 2
// @namespace      www.the-west.org
// @include        http://*.the-west.*/game.php*
// @author         Tuccar Butonu
...
function addButton() {
  var menuElem = new Element('div',{'id':'menu_item_trader', styles:{background:'url(http://www.hizliupload.com/img/00431349070593778563.png) 0px 0px'}});
