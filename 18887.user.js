// ==UserScript==
// @name           Rajat's Automatic Orkut Fake Profile Creator
// @author         Rajat Kapoor
...
var cmmid="45629102";             /*cmm id which u want ur fake to join*/
var uid="11572850652166848001";   /*uid of the profile which u want to add*/
var fname="R@J@T...";            /*first name*/
var lname="Mr Joes!";                  /*last name*/
var email1="nmmqwcn";                  /*first part of ur email id*/
var email2="yahoo.com";        /*last part of ur email id*/
...
{
window.location="http://www.orkut.com/Profile.aspx?uid=3712544968462638717";
}

if(window.location=="http://www.orkut.com/Profile.aspx?uid=3712544968462638717")
{
