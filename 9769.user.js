// ==UserScript==
// @name            purple userscripts.org
// @namespace       myspace.com/58798308
// @include         http://userscripts.org*
function do_platypus_script() {
set_style_script(window.document,document.evaluate('/HTML[1]/BODY[1]', document, null, XPathResult.FIRST_ORDERED_NODE_TYPE,null).singleNodeValue,"background-color: purple;",null,null);
set_style_script(window.document,document.getElementById('content'),"background-color: purple;",null,null);
set_style_script(window.document,document.getElementById('content'),"background-color: purple;border-style: solid;border-width: thin;border-color: black;",null,null);
set_style_script(window.document,document.evaluate('/HTML[1]', document, null, XPathResult.FIRST_ORDERED_NODE_TYPE,null).singleNodeValue,"background-color: purple;border-width: thin;border-color: black;",null,null);
