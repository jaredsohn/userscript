...
var language = {
	...
	en: {
		...
		quote:'Quote by',
		chose_color:'Kolor Czcionki:',
		preview_window:'Wiadomosc zapisana',
		send:'Wyślij',
		preview:'Zapisz wiadomosc',
		help: {
	...
	({
		...
		onload: function(response) {
			...
			if(vers!=obj.version) {
				...
				updateIt = '<span class="on" style="text-decoration:none !important;">Niema Aktualizacij!</span>';
			}
