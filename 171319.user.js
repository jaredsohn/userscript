// ==UserScript==
// @name          SubScene Forum Emoticons
// @namespace     erosman
// @description   Adds Yahoo Messenger Emoticons to SubScene Forum
// @updateURL     https://userscripts.org/scripts/source/171319.meta.js
// @downloadURL   https://userscripts.org/scripts/source/171319.user.js
// @include       http://v2.subscene.com/forums/t/*
// @include       http://v2.subscene.com/forums/p/*
...
/* --------- Note ---------
  ...
  1.4 Code re-write with reduced instructions + Added 2 missing emoticons
  1.3 Code Improvements + Added Subtitle pages
  1.2 More RegEx pattern improvement and fixing issues where one string is sub-string of another
  1.1 RegEx patterns improvement
  1.0 Initial release
...
switch (true) {
  case  path.indexOf('/forums/') !== -1:
  pat = './/div [@class="content"]';
  break;

  case path.indexOf('/subtitles/') !== -1:
  pat = './/div [@class="post-body"]';
  break;
}
