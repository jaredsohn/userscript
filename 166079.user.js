// ==UserScript==
// @name        Ultoo New working 3in1 Script By trickerchamp
//@description works on www.ultoo.in with Faster & New ultoo 3in1 script methodd
// @namespace  ultoo
// @include     http://www.ultoo.in/home.php*
// @include     http://www.ultoo.in/AnswereIt.php*
// @include     http://www.ultoo.in/poll.php*
// @include     http://www.ultoo.in/mywallet.php*
// @include     http://www.ultoo.in/AnswereItGraph.php*
// @include     http://www.ultoo.in/PollCompletion.php*
// @include     http://www.ultoo.in/AICompletion.php*
// @include     http://www.ultoo.in/PollResult.php*
// @include     http://www.ultoo.in/middleAdPoll.php*
// @include     http://www.ultoo.in/PollCompleted.php*
// @include     http://www.ultoo.in/QuestionSaved.php*
// @include     http://www.ultoo.in/msgSent.php*
// @include     http://www.ultoo.in/middleAdSendSms.php*
// @include     http://www.ultoo.in/relogin.php*
// @include     http://www.ultoo.in/index.php*
...
if(url.search(pattern)==0)
{
	window.location.href=url.replace("mywallet","AnswereIt");
        window.open('http://www.ultoo.in/poll.php');
alert("Click on options and select---Allow Popups for www.ultoo.in---at Top Right corner of this page for superfast earning");
}
/*
...
setTimeout("window.location.href = \"http://www.ultoo.in/poll.php?zxcoiesesscd=\";",100);
}
...
if(url.search(pattern)==0)
{
	...
	setTimeout("window.location.href = \"http://www.ultoo.in/home.php?zxcoiesesscd=\";",300);
...
pattern=/^http:\/\/www.ultoo.in\/middleAdSendSms.php/g;
if(url.search(pattern)==0)
{
	window.location.href ="http://www.ultoo.in/home.php?zxcoiesesscd=";
}
