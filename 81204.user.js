...
// Conversion des donnÃ©es de l'ancien script (v1.04 / v1.05)
if(GM_getValue('savedUnis') && GM_getValue('savedUnis').indexOf('#') != -1) {
	...
	alert('mise Ã  jour du script effectuÃ©e');
}

// RÃ©cupÃ©ration des donnÃ©es & traitement
var HTMLData = {};
...
function showLogin() {
	...
	if (savedUnis.length > 0) {
		var mesComptes = document.createElement('div');
			...
			mesComptes.appendChild(document.createTextNode('Accountübersicht'));
	...
	for(var i = 0; i < savedUnis.length; i++) {
		var compte = document.createElement('div');
			...
			compte.setAttribute('Nick', savedUnis[i].pseudo);
			compte.setAttribute('PW', savedUnis[i].pass);
	...
	var gestion = document.createElement('div');
		...
		gestion.appendChild(document.createTextNode('Einstellungen'));
	...
	var ajouterUni = document.createElement('div');
		...
		ajouterUni.appendChild(document.createTextNode('Acc hinzufügen'));
	...
	var modifierUni = document.createElement('div');
		...
		modifierUni.appendChild(document.createTextNode('Acc bearbeiten'));
	...
	var changerOrdreUni = document.createElement('div');
		...
		changerOrdreUni.appendChild(document.createTextNode('Uni Reihenfolge ändern'));
...
function ajouterCompte() {
	document.getElementById('loginBtn').innerHTML = 'Hinzufügen';
	...
	var univers = document.createElement('div');
		...
		univers.appendChild(document.createTextNode('Uni'));
	...
	var pseudo = document.createElement('div');
		...
		pseudo.appendChild(document.createTextNode('Nick'));
	...
	var pass = document.createElement('div');
		...
		pass.appendChild(document.createTextNode('PW'));
	...
	var buttonAjouter = document.createElement('div');
		...
		buttonAjouter.appendChild(document.createTextNode('Acc hinzufügen'));
	...
	var retourLogin = document.createElement('div');
		...
		retourLogin.appendChild(document.createTextNode('Zurück'));
	document.getElementById('login').appendChild(retourLogin);
}


function modifierCompte() {
	document.getElementById('loginBtn').innerHTML = 'bearbeiten';
	...
	if (savedUnis.length > 0) {
		var mesComptes = document.createElement('div');
			...
			mesComptes.style.marginBottom = '3px';
			mesComptes.style.fontWeight = 'bold';
			mesComptes.appendChild(document.createTextNode('Acc wählen'));
		document.getElementById('login').appendChild(mesComptes);
	}
	for(var i = 0; i < savedUnis.length; i++) {
		var compte = document.createElement('div');
...
function optionsCompte(elm) {
	...
	var buttonValiderModifs = document.createElement('div');
		...
		buttonValiderModifs.appendChild(document.createTextNode('Änderung übernehmen'));
	...
	var supprimerCompte = document.createElement('div');
		...
		supprimerCompte.appendChild(document.createTextNode('diesen Acc löschen'));
...
function changerOrdre() {
	document.getElementById('loginBtn').innerHTML = 'Ordnen';
	...
	if (savedUnis.length > 0) {
		var mesComptes = document.createElement('div');
			...
			mesComptes.style.marginBottom = '3px';
			mesComptes.style.fontWeight = 'bold';
			mesComptes.appendChild(document.createTextNode('Acc in richtiger Reihenfolge wählen'));
		document.getElementById('login').appendChild(mesComptes);
	}
	for(var i = 0; i < savedUnis.length; i++) {
		var compte = document.createElement('div');
