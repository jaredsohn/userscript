...
(function(){
		    ...
		    var b_collection_name='琳吧专属';
    var b_collection=[
	
'http://hiphotos.baidu.com/%BB%A4%D8%A9%D6%AE%C7%BD_%C1%D6/pic/item/84078d29f8dcd10029afad85728b4710b8122fb3.jpg',		
'http://hiphotos.baidu.com/%BB%A4%D8%A9%D6%AE%C7%BD_%C1%D6/pic/item/657458f92e738bd4671cea8da18b87d6267ff9a6.jpg',
		];
		
		    var g_collection_name='洋葱头大2';
    var g_collection=[
...
'http://hiphotos.baidu.com/%C7%A7%C4%EA%B5%C4%B3%D9%B5%BD/pic/item/d2ea832eea463c209922ede5.jpg',
    ...
    var zhaifang_collection_name='洋葱头';
    var zhaifang_collection=[
...
'http://hiphotos.baidu.com/%C7%A7%C4%EA%B5%C4%B3%D9%B5%BD/pic/item/3c55581bcb420323f2de32e3.jpg'
    ...
    var luckystar_collection_name='幸运星';
    var luckystar_collection=[
...
'http://hiphotos.baidu.com/sostuanyuan/pic/item/229f1d8bc9177f3edeff9ead70cf3bc79e3d5628.jpg'
    ...
    setTimeout(function(){
        ...
        fun_UserDefinedSmiley(zhaifang_collection_name, zhaifang_collection, 'tab24', 'tab_24');        
        fun_UserDefinedSmiley(konata_collection_name, konata_collection, 'tab25', 'tab_25');
        fun_UserDefinedSmiley(lucky_star_collection_name, lucky_star_collection, 'tab26', 'tab_26');
        fun_UserDefinedSmiley(yutumei_collection_name, yutumei_collection, 'tab27', 'tab_27');
        fun_UserDefinedSmiley(g_collection_name, g_collection, 'tab28', 'tab_28');
        fun_UserDefinedSmiley(b_collection_name, b_collection, 'tab29', 'tab_29');
