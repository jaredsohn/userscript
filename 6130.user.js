// ==UserScript==
// @name           Ogame fleet capacity
// @namespace      li-on@wp.pl
// @description    Ogame - show capacity of fleet PL
...
var suma3=0;
 ...
 s[k].innerHTML='<font color="#AAAAFF">Sobra: '+surstr+' </font>&nbsp;&nbsp;<font color="#00FF00">Capacidade: '+kropka(suma1)+
...
k=s.length-1;
s[k].innerHTML='<font color="#9999FF">recursos: '+surstr+' </font>&nbsp;&nbsp;<font color="#00FF00">Capacidade: 0 '+
