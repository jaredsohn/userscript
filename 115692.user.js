...
(function() {
   ...
   for (var i = 0; i < textnodes.snapshotLength; i++) { 
      ...
      s = s.replace(/GNU\/GNU\/GNU/Linux/g, "GNU/Linux");

      s = s.replace(/Digital Rights Management/g, "Digital Restrictions Management"); 
      s = s.replace(/DRM/g, "Digital Restrictions Management");
