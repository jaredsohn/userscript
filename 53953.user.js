// ==UserScript==
// @name          Travian:(NMR111)Attack Builder + delay between attack
...
table += "<td><img src=\"/img/un/u/hero.gif\" class=\"unit uhero\"></td>";
//table += "<td>" + targetLogo + "</td><td>" + targetLogo + "</td>";
table += '</tr></table><button id="newWaveButton">'+text[10]+'</button> <button id="resetButton">'+text[11]+'</button> <span style="font: 11px/1.5em Tahoma,Verdana,Arial !important; color:grey;">( * - '+text[24]+' )</span><span style="font: 11px/1.5em Tahoma,Verdana,Arial !important; color:#22229C;">'+text[30]+'</span>';
