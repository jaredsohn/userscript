// ==UserScript==
// @name          Sanbornton Public LibraryLookup
// @namespace     http://splib.pbworks.com
// @description   Search the Sanborton Library Catalog from Amazon book listings.
// @include       http://*.amazon.*
// @creator       Cab Vinton
...
// Adapted by Cab Vinton from
// Matthew Thompson, http://userscripts.org/scripts/show/26033, from
// Carrick Mundell, http://userscripts.org/scripts/show/1396

var libraryUrlPattern = 'http://catalog.splnh.com/cgi-bin/koha/opac-search.pl?q=';
var libraryName = 'Sanbornton Public Library';
...
function setLibraryHTML(isbn, title, linktext, color) {
   ...
   if (link2catalog == false)
      {
         libraryUrlPattern = "mailto:spl@metrocast.net?subject=Request for ISBN " ;
      }
