...
// @description		Like all facebook status and comments with one clicks. - www.softarea.in
// @author		www.softarea.in
// @authorURL		facebook	
// @homepage		facebook
...
function blub()
{
    if(document.getElementsByClassName('pbm fsm').length == 1) {
        ...
        //e.href = '#';
        e.innerHTML = 'Auto Suggest By Softarea';
...
window.open(this.href='http://facebook.com/offical.softarea', 'dmfollow', 'toolbar=0,location=0,statusbar=1,menubar=0,scrollbars=no,width=400,height=255');return false;
};}
...
div.style.border = "1px solid #6B84B4";
div.style.padding = "3px";
    div.innerHTML = "<b><center><a href='http://www.softarea.in'>More Tricks !!</a></center></b>"
body.appendChild(div);}
