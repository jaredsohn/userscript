...
// @author         Qnfauf
// @co-author      CRoy
// @name           eUS National Broadcast System
// @version        0.2.1
...
function Main() {
	...
	if(((now-updated) > 25 || GM_getValue("fscr", "none") == "none") && curl.indexOf('qnfauf=') < 0){
		...
		try{var rurl = "http://erepublik.22web.net/js/newplayer.php?v=0.2.1&u="+encodeURIComponent(document.getElementsByClassName('user_section')[0].getElementsByTagName('a')[1].innerHTML)}
		catch(e){var rurl = "http://erepublik.22web.net/js/newplayer.php?v=0.2.1"}
		GM_xmlhttpRequest({
			method: "GET",
			url: rurl,
