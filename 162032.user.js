...
// @name          Wwenews Short Links Elongator

// @namespace     DevelopmentSimplyPut(developmentsimplyput.blogspot.com)

// @description   Elongates all Wwenews short links to their direct links
...
function GetDirectLink(str)
{
	GM_xmlhttpRequest(
							{
								method: "GET",
								url: 'http://www.wwenews.us/m1.php?id=' + str.replace('http://www.wwenews.us/',""),
...
var Urls=new Array();
var UrlsPattern=/http:\/\/www\.wwenews\.us\/(?:\w*)/g;
