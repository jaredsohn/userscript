// ==UserScript==
// @id             Gift acceptor Badon348
// @name           Auto Gift acceptor For Badon348
// @version        1.0
// @namespace      Auto Gift acceptor For Badon348
// @homepage       http://userscripts.org/
// @author         Tiestoale
// @description    Auto Gift Acceptor For Badon348
				...
				if(claim_gift){
					...
					if(domain_selector && (next_button1 || next_button2)){
						for(var i=0; i<domain_selector.options.length; i++){
							if(domain_selector.options[i].value == "348"){
