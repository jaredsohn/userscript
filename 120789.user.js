...
History:
2.06:
-Changement des nom ( kocmoon / kocmap /userscript )

2.05 :
-Changement du nom de la boite de tower-zeus-extra A boite a info

2.04 :
-Ajout direct a kocmon et non domaine 280

2.03 :
-Ajout direct koc map et non domaine 280

2.02 :
- Ajout direct de cette boite dans l'onglet script

2.01 :
- Correction du bug de kocmon

2.00 :
- Liens direct vers kocmon
- Liens direct vers wiki-camelot
- Liens direct vers koc map
- Liens direct vers userscript.org
**********************/

var Version = '2.06';
var Versiondate = '2.06';
var Scriptname = 'Boite a info';
var ScriptTabName = 'Boite a info';
...
Tabs.board = {
  ...
  tabLabel : 'Kocmon',            // label to show in main window tabs
  myDiv : null,
  timer : null,
  forumlink :  'http://kocmon.com/code/server-list',  
...
Tabs.script = {
  ...
  myDiv : null,
  timer : null,
  forumlink :  'http://userscripts.org/scripts/show/120789',  
...
Tabs.extChat = {
  ...
  tabLabel : 'KOCMAP',            // label to show in main window tabs
  myDiv : null,
  timer : null,
  chatlink :  'http://koc.dunno.com/doku/doku.php/start',  
