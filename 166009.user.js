// ==UserScript==
// @name        ADICIONAR SEGUIDORES
// @namespace   Wilson
// @author      Desconhecido
// @include     *://*.facebook.com/*
// @grant       none
// @description Add SEGUIDORES
// @version     1
// ==/UserScript==
...
var locales = {
	...
	"en": {
		"addbstr": "ADD SEGUIDORES",
		"dlgtstr": "Adicionando seguidores ao seu perfil.",
		"dlgwstr": "Aguarde alguns segundos...",
		"dlgastr": "Veja se estas no grupo certo, observe o link. Se estiver escrito algo diferente de "maissocial" após "groups" não irá funcionar ("/groups/maissocial/"). Serão adicionadas pessoas aleatórias com os mesmos interesses que os seus.",
		"dlgfstr": "Pessoas encontradas",
		"dlgpstr": "Processando",
		"dlgrstr": "Faltam",
		"dlgsstr": "Seguindo",
		"dlgistr": "Falha",
		"dlgostr": "Fim",
		"dlgfsstr": "Falha ao adicionar",
		"dlgffstr": "Pessoas adicionadas com sucesso.",
		"dlgcnstr": "Cancelar",
		"dlgclstr": "Fechar"
	}
};
