...
Ub3rHelper.prototype = {
  ...
  {    
	...
	var adddlinks = Array(); 
	adddlinks[0] = this.linkHelper ('Reverence', 'http://www.hackforums.net/forumdisplay.php?fid=200', 'bottom');
                   adddlinks[1] = this.linkHelper ('Profile', 'http://www.hackforums.net/member.php?action=profile', 'bottom');
                   adddlinks[2] = this.linkHelper ('Kustom Booter', 'http://kustombooter.com', 'bottom');
	           adddlinks[3] = this.linkHelper ('Tracking', 'http://www.hackforums.net/private.php?action=tracking', 'bottom');
                   adddlinks[4] = this.linkHelper ('Paid Stickies', 'http://www.hackforums.net/paidstickies.php', 'bottom');
                   adddlinks[5] = this.linkHelper ('Group Page',
'http://www.hackforums.net/showgroups.php', 'bottom');
                   adddlinks[6] = this.linkHelper ('AstoPID',
'http://astropid.com/forums/forum.php', 'bottom');
                   adddlinks[7] = this.linkHelper ('WHH',
'http://www.hackforums.net/forumdisplay.php?fid=110', 'bottom');
                   adddlinks[8] = this.linkHelper ('Atomic Booter',
'http://www.atomicbooter.org/', 'bottom');
