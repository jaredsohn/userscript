...
//@contributer Ian Scott (ian@norcimo.com)
// @include http://*flickr.com/photos/*/*
// 

//norcimo:
//2008-09-21
//Fixed none-working version (adjested Xpaths and changed call to unsafewindow.DOMParser() to be window.DOMParser()
// Version number set to 0.9.1
...
(function () {
	...
	var SCRIPT = {
		...
		date: (new Date("2008-09-21"))		// update date
		.valueOf()
	};
	...
	flickrphotocompass.prototype = {
		...
		coordDone: function() {
			...
			var uploadedBy = document.evaluate( "/html/body/div[@id='Main']/table[@id='Photo']/tbody/tr/td[2]/div[@class='Widget']/a[1]/img[1]",                              
		...
		getCoord: function() {
			...
			var moreLot = document.evaluate(									"//span[@id='div_taken_in_links']//a",
