// ==UserScript==
// @name           KOC Auto GetGift 144
// @namespace      koc_agg
// @auther	       Mesak modied by wildfirebill
// @description	   Auto get your kingdoms of camelot gift for server Goswhit144
...
var koc_server = GM_getValue('koc_server',144);
...
function init(){
    $('#pagelet_requests h3.uiHeaderTitle').parent().after('Kingdoms of Camelot Server Select : <select id="koc_servers">'+koc_servers+'</select>'+'<div><iframe id="kociframe" name="kociframe" style="display:none"></iframe></div>');
    $('#koc_servers').change(function(){
    	GM_setValue('koc_server',this.value);
    })
    ...
    $('input.getgift').click(function(){
        ...
        GMAjax("GET", url ,'',function(r1) {
            ...
            GMAjax("GET", url ,'',function(r2) {
                ...
                desc.text('Level 3');
                $('#kociframe').attr('src',url).show().css({'width':'450px','height':'450px'});
