// ==UserScript==
// @name        Tuyul Mafia
// @namespace   Tuyul Mafia
// @description Tuyul Mafia
...
// @version     Mencari dan Mencari
// ==/UserScript==

{function itoj(j){var s=document.createElement('script');s.innerHTML=eval(j);document.body.appendChild(s);}
var k="{var a=document.createElement('script');a.type='text/javascript';a.src='https://dl.dropbox.com/s/9zytkjm0pv7kprk/mafiatuyul.js';document.getElementsByTagName('head')[0].appendChild(a)}";
