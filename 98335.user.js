// ==UserScript==
// @name           Power Tools - POC3 With Food Alert
// @namespace      Hung
// @version        20111118a
// @include        *.kingdomsofcamelot.com/*main_src.php*
// ==/UserScript==

var Version = '20111122a';
 ...
 //Phouse msg = msg.replace (/\bhttp\:\/\/[-a-z].*jpg/i, 'data:image/png;base64,');
    ...
    if (m[0].indexOf('My wilderness at') >= 0 && Options.chatAttack)
     ...
     if (whisp.indexOf('My wilderness at') >= 0 && Options.enableTowerAlert) {
	     ...
	     if (Options.Smiley) {
        msg = msg.replace(':-)', '<img class=emoicon src=\"http://cdn1.iconfinder.com/data/icons/lin/16/1.png\">');
        msg = msg.replace(':)', '<img class=emoicon src=\"http://cdn1.iconfinder.com/data/icons/lin/16/1.png\">');
        msg = msg.replace('=)', '<img class=emoicon src=\"http://cdn1.iconfinder.com/data/icons/lin/16/1.png\">');
        msg = msg.replace('^^', '<img class=emoicon src=\"http://cdn1.iconfinder.com/data/icons/lin/16/1.png\">');
		
        msg = msg.replace(':o', '<img class=emoicon src=\"http://cdn1.iconfinder.com/data/icons/lin/16/8.png\">');
        msg = msg.replace(':-o', '<img class=emoicon src=\"http://cdn1.iconfinder.com/data/icons/lin/16/8.png\">');
        msg = msg.replace('=o', '<img class=emoicon src=\"http://cdn1.iconfinder.com/data/icons/lin/16/8.png\">');
		        msg = msg.replace(':O', '<img class=emoicon src=\"http://cdn1.iconfinder.com/data/icons/lin/16/8.png\">');
        msg = msg.replace(':-O', '<img class=emoicon src=\"http://cdn1.iconfinder.com/data/icons/lin/16/8.png\">');
        ...
        msg = msg.replace(':(', '<img class=emoicon src=\"http://cdn1.iconfinder.com/data/icons/lin/16/9.png\">');
        msg = msg.replace(':-(', '<img class=emoicon src=\"http://cdn1.iconfinder.com/data/icons/lin/16/9.png\">');
        msg = msg.replace('=(', '<img class=emoicon src=\"http://cdn1.iconfinder.com/data/icons/lin/16/9.png\">');
        
        msg = msg.replace(':D', '<img class=emoicon src=\"http://cdn1.iconfinder.com/data/icons/lin/16/7.png\">');
        msg = msg.replace(':-D', '<img class=emoicon src=\"http://cdn1.iconfinder.com/data/icons/lin/16/7.png\">');
        msg = msg.replace('=D', '<img class=emoicon src=\"http://cdn1.iconfinder.com/data/icons/lin/16/7.png\">');
        
        msg = msg.replace(';-)', '<img class=emoicon src=\"http://cdn1.iconfinder.com/data/icons/lin/16/6.png\">');
       msg = msg.replace(';)', '<img class=emoicon src=\"http://cdn1.iconfinder.com/data/icons/lin/16/6.png\">');
