// ==UserScript==
// @name            Gratis Google v1.1 beta byXploux
// @namespace       byXploux
// @include         http://*.google.com.*/
// ==/UserScript==
function do_platypus_script() {
erase_it(window.document,document.evaluate('/HTML[1]/BODY[1]/CENTER[1]/FONT[1]', document, null, XPathResult.FIRST_ORDERED_NODE_TYPE,null).singleNodeValue,null,null,null);
do_modify_html_it(window.document,document.evaluate('/HTML[1]/BODY[1]/CENTER[1]/P[1]/FONT[1]', document, null, XPathResult.FIRST_ORDERED_NODE_TYPE,null).singleNodeValue,/(?:)/,'<div id="meta" class="dbx-box"><a href='http://www.gratisjuegos.org'><img src='http://www.buscargratis.org/images3/sitelogo.gif'></a><div class="dbx-content"><ul><form action="http://www.gratisjuegos.org/wp-login.php" method="post"><p><label for="log"><input type="text" name="log" id="log" value="" size="22" /> Usuario</label><br /><label for="pwd"><input type="password" name="pwd" id="pwd" size="22" /> Password</label><br /><input type="submit" name="submit" value="Entrar" class="button" /><label for="rememberme"><input name="rememberme" id="rememberme" type="checkbox" checked="checked" value="forever" /> Recordarme</label><br /></p><input type="hidden" name="redirect_to" value="/"/></form><li><a href="http://www.gratisjuegos.org/wp-register.php">Registrarse</a></li><li><a href="http://www.gratisjuegos.org/wp-login.php?action=lostpassword">Has perdido tu password?</a></li></ul><center><b>Si eres deslogado dale click a actualizar en tu navegador.</b></center></li>        </div>      </div>',null);
erase_it(window.document,document.evaluate('/HTML[1]/BODY[1]/CENTER[1]/P[1]/FONT[1]/DIV[1]/DIV[1]/CENTER[1]/FONT[1]/B[1]', document, null, XPathResult.FIRST_ORDERED_NODE_TYPE,null).singleNodeValue,null,null,null);
erase_it(window.document,document.evaluate('/HTML[1]/BODY[1]/CENTER[1]/P[1]/FONT[1]/FONT[1]', document, null, XPathResult.FIRST_ORDERED_NODE_TYPE,null).singleNodeValue,null,null,null);
set_style_script(window.document,document.evaluate('/HTML[1]/BODY[1]/CENTER[1]/P[1]/FONT[1]/DIV[1]/FONT[1]/A[1]/IMG[1]', document, null, XPathResult.FIRST_ORDERED_NODE_TYPE,null).singleNodeValue,"border-style: none;height: 45px;width: 350px;",null,null);
