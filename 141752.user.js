...
(function(){
 var main = function () {
      ...
      var createTweak = function () {
          ...
          const EXTbotname     = "Scrubs"
          const EXTgreeting    = "Scrubs Reloaded";
          ...
          qx.Class.define("AlsiusTweak.Main", {
            ...
            members: {
              ...
              tweakEXT: function () {
                ...
                this.panel = new AlsiusTweak.ui.ExtraTools("Scrubs 2012 v" + EXTversion + ' °~~°' + EXTgreeting + '°~~° ');
              ...
              logOn: function () {
                this.chat.addMsg('/whisper ' + EXTbotname + ' !Scrubs.lou.Login ' + EXTversion + ' ' + webfrontend.net.CommandManager.getInstance().getInstanceGuid());
              },
          ...
          qx.Class.define("AlsiusTweak.Tooltip", {
            ...
            statics: {
              ...
              _buildNoDataOrAccess: function(br) {
                 br.add(bl3 + 'Scrubs Tools:' + m + nb + nb + nb + nb + nb + nb + nb + nb + nb + nb + webfrontend.gui.Util.convertBBCode(i18n('ext:no_data_or_credentials')) + l);
              },
              _buildProcessHeadline: function(br) {
                 br.add(bl2 + 'Scrubs Tools: v' + EXTversion + l2 + kl + hl + l);
              },
          ...
          qx.Class.define("AlsiusTweak.Chat", {
            ...
            members: {
              ...
              addChatMessage: function (message, prefix) {
                var prefix = (prefix) ? 'Scrubs Tools: (' + AlsiusTweakVersion + ') ' : '';
          ...
          qx.Class.define("AlsiusTweak.ui.LeftPanel", {
            ...
            construct: function (label) {
              this.base(arguments);
              this.stateIcon = new qx.ui.basic.Image('webfrontend/ui/icons/icon_alliance_blue_17.png').set({
            ...
            members: {
              ...
              setState: function (state) {
                if (state) {
                  this.stateIcon.setSource('webfrontend/ui/icons/icon_alliance__17.png');
          ...
          qx.Class.define("AlsiusTweak.ui.ExtraTools", {
            ...
            members: {
              ...
              buildUI: function () {
                ...
                // infoButton
                var infoButton = new qx.ui.form.Button("Info").set({
                  width: 80,
                  appearance: "button-text-small",
                ...
                row.add(new qx.ui.core.Widget().set({
                 ...
                 // scheduleButton
                this.scheduleButton = new qx.ui.form.Button('Raids timen').set({
                  width: 80,
                  appearance: "button-text-small",
                ...
                this.addContent(row, {top: 25, left: 0});
              },
