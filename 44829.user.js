...
var version=2;
var scriptlocation="http://userscripts.org/scripts/source/44829.user.js";
...
// s*.ikariam.it
	...
	default:
		alliancefullnm='TERRONI SENZA PADRONI';
		alliancenm='TSP';		
...
// Use the DOT (.) to not include the chat, forum, forumnew in the menu.
	...
	chaturl='http://terronisenzapadroni.forumfree.net/?f=6686235';
	forumurl='http://terronisenzapadroni.forumfree.net';
	forumurlnew='http://terronisenzapadroni.forumfree.net/?act=Search&CODE=getactive' ;
...
unsafeWindow.displaychat = function() {
	if(displayedflag == 0) {
		document.getElementById("chatframe").innerHTML = '<iframe width="764" border="0" frameborder="0" height="100%" src="http://terronisenzapadroni.forumfree.net/?f=6686235" style="margin-left:26px;"></iframe>';
		displayedflag = 1;
	}
}
...
var wkHTML = '<div id="chattab" onmouseover="showchat()" onclick="hidechat()"><a style="height:100%;width:100%;"></a></div>'
	...
	+ '<a style="border-bottom:1px #542C0F dotted; color: #542C0F;">TSP Chat</a></div>'
...
// default colours
var DEFAULT_TROOPS_BG_COLOUR = '#F0E0B0';
var DEFAULT_SHIPS_BG_COLOUR = '#E0D0A0';
var DEFAULT_TEXT_COLOUR = '#542C0F';
