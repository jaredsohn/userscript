...
// @name            taz_mopo1
// @namespace       Platypus
// @include         *TAZN&ressort=ha
// @include         http://www.taz.de/index.php?id=hamburg
...
html_insert_it(window.document,document.getElementById('datum_plugin_rechts'),'<iframe src="http://www.mopo.de/hamburg/politik/#taz_mopo" width="500" height="600"></iframe><iframe src="http://www.mopo.de/hamburg/panorama/#taz_mopo" width="500" height="600"></iframe>',false,true);
