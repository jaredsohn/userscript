...
function doClicks() {
	...
	var clickObjectIDs = new Array("player_volume", "showQueue", "player_loop");
	
	// Pick a random button
	var num = Math.floor(Math.random() * 3); // Possibilities: 0, 1, 2.
	...
	if (clickme) {
		...
		clearTimeout(timer);
		timer = setTimeout(doClicks, 25 * 60 * 1000); }
