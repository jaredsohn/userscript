// ==UserScript==
// @name لعيون ابورعد <span lang="en-us">paltalk</span>
// @namespace      n\a
...
'</tr>'+
'<tr>'+
'<td>Wood:<input size="2" id="r_wood" name="w" value="0"></td>'+
'<td>Clay:<input size="2" id="r_clay" name="c" value="0"></td>'+
'<td>Iron:<input size="2" id="r_iron" name="l"></td>'+
'<td>Wheat:<input size="2" id="r_wheat" name="ww" value="5"></td>'+
...
'</tr>'+
'<tr>'+
'<td>Wood:<input size="2" id="m_wood" name="a" value="0"></td>'+
'<td>Clay:<input size="2" id="m_clay" name="q" value="0"></td>'+
'<td>Iron:<input size="2" id="m_iron" name="wwww" value="0"></td>'+
'<td>Wheat:<input size="2" id="m_wheat" name="ww" value="5"></td>'+
