...
// @name        PlugDJ++
// @namespace   PlugDJ++
// @description Añade nuevas funcionalidades a plug.dj
...
function init() {
    ...
    butovideo.innerHTML = "Ocultar v&iacute;deo";
    ...
    butovideo2.innerHTML = "Mostrar v&iacute;deo";
...
function actlista(obj) {
	...
	for (i=0;i<API.getUsers().length;i++) {
		...
		if (API.getDJs()[0].username == user.username) {
			document.getElementById("listavotosin").innerHTML += "<font color='orange'><b>"+user.username+"</b> es el DJ</font></br>";
		} else {
			if (user.vote == 1) {
				document.getElementById("listavotosin").innerHTML += "<font color='green'><b>"+user.username+"</b> ha votado <i>Woot!</i></font></br>";
			} else if (user.vote == 0) {
				document.getElementById("listavotosin").innerHTML += "<font color='white'><b>"+user.username+"</b> aún no ha votado</font></br>";
			} else if (user.vote == -1) {
				document.getElementById("listavotosin").innerHTML += "<font color='red'><b>"+user.username+"</b> ha votado <i>Meh</i></font></br>";
			} else {
				return 0;
			}
		}
