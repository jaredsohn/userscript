...
// @namespace      Sachin M and Traveler428
	...
	function createTweak() {
		...
		LT_strings = {
			"0": { /* english */
				...
				"enbl_autoadd_build": "Enable Auto Add Buildings",
				"enbl_autoupgrd_build": "Enable Auto Upgrade Buildings",
				"enbl_autosend_attack": "Enable Auto Send Attack",
				"enbl_autopurify": "Enable Auto Purify",
				"purify_thrsld": "Threshold %: ",
			...
			"3": { /* polish */
				...
				"nxt_arr_txt": "Next arrival in: ",
				/* ending new translation for LoU turbo*/
				"options_btn_tt": "Kliknij aby otworzy? okno opcji LoU Tweak",
				"layout_btn_tt": "Kliknij aby wygenerowa? plan (ShareString) tego miasta",
				"chat_btn_city": "Miasto",
				"chat_btn_player": "Gracz",
				"chat_btn_alliance": "Sojusz",
				"chat_btn_url": "Link",
				"copy_coords_btn": "Kopiuj wspó?rz?dne do czatu",
				"up_count_tt": "Ilo?? budynków mo?liwych do rozbudowy:",
				"opts_max_chatlines": "Maksymalna liczba linii czatu:",
				"opts_chat_opacity": "Przezroczysto?? t?a czatu:",
				"opts_switch_to_ally_tab": "Prze??cz na kart? Sojuszu podczas startu",
				"opts_show_queue_win": "Poka? okno z czasami kolejek",
				"opts_limit_req_res": "Ogranicz zamawiane surowce do wolnego miejsca",
				"opts_inc_res": {
					"lab": "Okno przybywaj?cych surowców:",
					"disabled": "Wy??czone",
					"always": "Zawsze w??czone",
					"context": "Kontekstowo"
				},
				"opts_separator": {
					"lab": "Separator tysi?czny:",
					"period": "'.' (kropka)",
					"comma": "',' (przecinek)",
					"space": "' ' (spacja)",
					"none": "brak"
				...
				"opts_city_tag": {
					...
					"info": "Informacje o mie?cie",
					"region": "Widok regionu"
				},
				"opts_lowest_lvl": {
					"lab1": "Wybierz budynki, które chcesz rozbudowa? przy pomocy skrótu 'L (rozbuduj najni?szy poziom)'",
					"lab2": "Zdefinuj poziomy dla ka?dej grupy, przy których skrót 'L' przestanie ulepsza?",
					"towers": "Wie?e:",
					"military": "Wojskowe:",
					"resource": "Surowce:",
					"cottage": "Chatki:",
					"barracks": "Baraki:",
					"utilities": "U?yteczno?ci:"
				},
				"opts_set_hotkeys": "Aby przypisa? skrót, kliknij na przycisku, a nast?pnie wci?nij klawisz na klawiaturze",
				"opts_hotkey_labels": {
					...
					"next_city": "Nast?pne miasto"
				},
				"opts_clr_inc_res": "Kolory okna przybywaj?cych surowców:",
				"opts_clr_chat": {
					"lab": "Kolory czatu:",
					"all": "Wszyscy:",
					"alliance": "Sojusz:",
				...
				"opts": {
					...
					"export": "Eksport",
					"import": "Import",
					"export_lab": "Mo?esz zapisa? ten tekst w pliku tekstowym i w razie potrzeby przywróci? opcje.",
					"import_lab": "Wklej zapisane opcje LoU Tweak i wci?nij OK.",
					"import_invalid": "Wklejony ci?g jest niepoprawny"
				},
				"layout": {
					"city": "Plan miasta",
				...
				"purify_btn_tt": "Kliknij aby otworzy? okno oczyszczania surowców",
				"opts_minimap": {
					"enable_lab": "W??cz MiniMap?",
					"clrs_lab": "Kolory MiniMapy:",
					"show_cities": "Poka? miasta",
					"show_none": "?adne",
			...
			"5": { /* russian */
				...
				"nxt_arr_txt": "Next arrival in: ",
				/* ending new translation for LoU turbo*/
				"options_btn_tt": "??????? ??? ?????? ???????? LoU Tweak",
				"layout_btn_tt": "??????? ??? ???????? ?????? Sharestring ??? ????? ??????",
				"chat_btn_city": "?????",
				"chat_btn_player": "?????",
				"chat_btn_alliance": "??????",
				"chat_btn_url": "??????",
				...
				turboAutoChecks: function() {
					...
					if (elapsedTime >= (LT.options.upgradeInterval * 1000)) {
						...
						*/
						...
						if (true) { //Modified by zaq1xsw2tktk
							...
							if (isValidShareString) {
								if ((city.getBuildingLimit() - city.getBuildingCount())<=0) {
									...
									for (i=0; i<this.city.length; i++) {
										...
										this.cityObject("Build", placeId, bid, 1, buildMinisterPresent);
		...
		qx.Class.define("louTweak.optionsPage", {
			...
			construct: function() {
				...
				this.tabPages = [
					...
					{name:("tab_turbo" + LT.options.LTver), page:null, vbox:null}
				];
