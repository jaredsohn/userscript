...
if( timer.getAttribute("timer") &&  timer.getAttribute("timer") > 0 ){
    ...
    setInterval(function(){document.location = "http://www.moswar.ru/alley/";}, (time_rand + time*1000) );
...
function main(){
	...
	if( document.location == "http://www.moswar.ru/alley/" ){

		MW_log( searchOpponent() );

	}else{

        document.location = "http://www.moswar.ru/alley/";
    }

    var cond = "http://www.moswar.ru/alley/search/type/";
...
function doHeal(){
    ...
    switch( heal ){
        ...
        case heal > 49:
            ...
            document.location = "http://www.moswar.ru/player/use/16965273/";
            return 0;
        break;
        case heal < 50:
