...
// @name	Tribalwars Easy Mensage
// @description	Send a mail to a list of arbitrary users.
// @include     http://*.tribalwars.*/game.php?village=*&screen=mail&mode=new
// @version     1.0.1
// ==/UserScript==
...
tr["vn"] = {
	...
	msg_no_recipients: "Không có tên người n� y",
	msg_topic_and_content: "Hãy viết chủ đề v�  nội dung",
	msg_invalid_recipient: "Người nhận không hợp lệ",
	msg_finished_auto_sending: "Tự động gửi thư đã ho� n tất",
