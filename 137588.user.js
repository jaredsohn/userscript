...
PanelOptions.prototype = {
	init: function() {
		...
		this.disco.add(new Option('0.5 secondes', '500'), null)
		this.disco.add(new Option('1 seconde', '1000'), null)
		this.disco.add(new Option('2 secondes', '2000', true), null)
		this.disco.add(new Option('3 secondes', '4000'), null)
		this.disco.add(new Option('5 secondes', '5000'), null)
...
Main.prototype = {
	init: function() {
		...
		$('#login_pass').after('<div id="jvnick"><label for="pseudochoix">* JVNick:               </label></div><br />')
	...
	setPseudos: function() {
		if(document.getElementById('bool_log')) {
			...
			var _this = this
			this.select.add(new Option('-', ''), null)
