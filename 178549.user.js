...
// @include        http*://tracker.deepbassnine.com/upload.php*
// @include        http*://tracker.deepbassnine.com/requests.php*
// @include        http*://tracker.deepbassnine.com/torrents.php*
// ==/UserScript==
...
var factory = {
    locations : new Array(
        ...
        {
	        name : 'db9_upload',
	        regex : /http(s)?\:\/\/tracker\.deepbassnine\.com\/upload\.php.*/i
        },
        {
            name : 'db9_edit',
            regex : /http(s)?\:\/\/tracker\.deepbassnine\.com\/torrents\.php\?action=editgroup&groupid=.*/i
        },
        {
            name : 'db9_request',
            regex : /http(s)?\:\/\/tracker\.deepbassnine\.com\/requests\.php\?action=new/i
        }
    ),
    ...
    getInputElements : function() {
        var buttonHTML = '<input type="submit" value="Fetch" id="yadg_submit"/>',
            ...
            optionsHTML = '<div id="yadg_options"><label for="yadg_format" id="yadg_format_label">Format:</label><select name="yadg_format" id="yadg_format"><option value="bbcode-generic">BBCode</option><option value="plain">plain</option><option value="wafflesfm">waffles.fm</option><option value="wafflesfm-tracks-only">waffles.fm (tracks only)</option><option value="whatcd" selected="selected">what.cd</option><option value="whatcd-tracks-only">what.cd (tracks only)</option></select></div>',
