...
// @version 1.0
// @author Topper42, Flunik, Modified by garwein and TheBasti14
// @grant none
// ==/UserScript==
(function(){
	...
	function createClass() 
	{
		qx.Class.define("EA_CNCTA_Example", 
		{
			...
			construct: function()
			{
				try
				{
					...
					this.__btnOpenMenu = new qx.ui.form.Button("SKC Up-Tool").set({ width: 115 });
		...
		qx.Class.define("EA_CNCTA_Example.CityWindow", 
		{
			...
			construct: function()
			{
				...
				this.set({
					width: 180,
					caption: "SKC-Upgrade Fenster by TheBasti14",
					padding: 1,
					allowMaximize: false,
					showMaximize: false,
					allowMinimize: false,
				...
				var lblTitleAll = new qx.ui.basic.Label("Werte alle Gebauede in der markierten Basis auf").set({ alignX: "center", font: "bold"});
				cntUpgradeAll.add(lblTitleAll);
				
				var cntUpgradeAllHBox = new qx.ui.container.Composite(new qx.ui.layout.HBox(5));
				var lblPreLevelAll = new qx.ui.basic.Label("Neue Stufe:").set({ alignY: "middle"});
				this.__txtNewLevelAll = new qx.ui.form.TextField().set({ width: 100});
				this.__btnUpgradeAll = new qx.ui.form.Button("Aufwerten", "FactionUI/icons/icon_building_detail_upgrade.png");
				...
				var lblTitleCurrent = new qx.ui.basic.Label("Werte das markierte Gebauede auf").set({ alignX: "center", font: "bold"});
				cntUpgradeCurrent.add(lblTitleCurrent);
				
				this.__lblCurrentSelected = new qx.ui.basic.Label("Markiertes Gebauede: -");
				...
				var lblPreLevelCurrent = new qx.ui.basic.Label("Neue Stufe:").set({ alignY: "middle"});
				this.__txtNewLevelCurrent = new qx.ui.form.TextField().set({ width: 100});
				this.__btnUpgradeBuilding = new qx.ui.form.Button("Aufwerten", "FactionUI/icons/icon_building_detail_upgrade.png");
				...
				var lblTitleAllOff = new qx.ui.basic.Label("Offensive").set({ alignX: "center",  font: "bold"});
				cntUpgradeAllOff.add(lblTitleAllOff);
				
				var cntUpgradeAllOffHBox = new qx.ui.container.Composite(new qx.ui.layout.HBox(5));
				//var lblPreLevelOff = new qx.ui.basic.Label("Neue Stufe:").set({ alignY: "middle"});
				//this.__txtNewLevelOff = new qx.ui.form.TextField().set({ width: 100});
				this.__btnUpgradeAllOff = new qx.ui.form.Button("Werte alle Einheiten auf +1", "FactionUI/icons/icon_building_detail_upgrade.png");
				...
				var lblTitleAllDef = new qx.ui.basic.Label("Defensive").set({ alignX: "center", font: "bold"});
				...
				this.__btnUpgradeAllDef = new qx.ui.form.Button("Werte die Verteidigung auf +1", "FactionUI/icons/icon_building_detail_upgrade.png");
