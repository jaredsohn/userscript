// ==UserScript==
// @name           Stop Getting Fooled on Youtube
...
function button(index,id){
	return '<div class="getReview" id="'+index+'"><button id="getVideoLikes" class="yt-uix-tooltip-reverse yt-uix-button yt-uix-button-default" type="button" title="Get Review" data-tooltip-text="Get Review"><span class="yt-uix-button-content"><span class="addto-label">Get Reviews</span></span></button></div><div class="showReview"></div>';
}