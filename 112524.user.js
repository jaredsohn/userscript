...
var Styles = '\
    ...
    table.' + rndStyle['classPrefix'] + 'TabPad tr td {border:none; background:green; white-space:nowrap; padding: 1px 1px}\
    ...
    table.' + rndStyle['classPrefix'] + 'TabLined tr td {border-bottom:1px solid #ccc; background:green; padding: 1px 4px 1px 4px;}\
    table tr.' + rndStyle['classPrefix'] + 'TabHdr1 td {background-color:green; font-weight:bold}\
    ...
    tr.' + rndStyle['classPrefix'] + 'retry_ptpoptp td { background-color:green; color:#fff; border:none; height: 21px; padding:0px; }\
    tr.' + rndStyle['classPrefix'] + 'Owned {background-color: green; color:white}\
