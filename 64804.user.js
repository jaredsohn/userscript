...
// ==UserScript==
// @name            experienceproject-grp
// @namespace       Platypus
// @include         http://www.experienceproject.com/group*
// @description     Uses wide layout for experienceproject.com groups.
// @date            27 April 2009
...
isolate(window.document,document.evaluate('./DIV[1]/DIV[1]/DIV[1]', main_copy, null, XPathResult.FIRST_ORDERED_NODE_TYPE,null).singleNodeValue,null,null,null);
smart_remove(window.document,document.getElementById('gprofile_column'),null,null,null);

// Widen the page:
relax(window.document,document.getElementById('gprofile_pane'),null,null,null);
