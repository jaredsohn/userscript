...
/*
    Modified by papaspae@gmail.com
    Links directly to the entire page, not only the image;
    removed googFont, seems that no is longer avaiable
*/



// ==UserScript==
// @name          Google Image direct links II
// @namespace     http://juhani.naskali.net/files/gm/
// @description   Rewrites Google Image Search links to point straight to the corresponding websites without google frames.
// @version	  0.1
// @date	  2009-12-17
...
(function()
{
    ...
    for (var x=0; x<googLinks.length; x++)
    {
        ...
        if (gmatch)
        {
            ...
            googLinks[x].href = decodeURIComponent(urlmatch[1]);
