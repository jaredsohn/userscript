...
// @name          twepl
// @namespace     http://none
// @description   twepl r0nin
// @include 	  http://pl*.plemiona.*/game.php*
// @exclude       http://w*.tribalwars.*/game.php*
...
var twImgsPath = "http://www.tribalwars.es/graphic/"; 										//  Ruta para las imĂˇgenes originales de tw

var twUnitsNamesArray = new Array("spear", "sword", "axe", "archer", "spy", "light", "marcher", "heavy", "ram", "catapult", "knight", "snob");
var twCostsByUnit = new Array( new Array(50,30,10), new Array(30,30,70), new Array(60,30,40), new Array(100,30,60), new Array(50,50,20), new Array(125,100,250), new Array(250,100,150), new Array(200,150,600), new Array(300,200,200), new Array(320,400,100), new Array(20,20,40), new Array(30000,50000,50000) );
...
function twShowInfoResources()
{
	...
	newDiv += "				<td title='Ĺ»elazo'><img src='"+twLinks["twOtherImg"][2]+"' /></td><td>"+twGlobalInfo["resources"][2]+"</td>";
...
function twGlobalResumeArmy()
{
		...
		//document.createTextNode("<tr><th>NÂş</th><th>Pueblo</th><th colspan='9'>Unidades</th");
