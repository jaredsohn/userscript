// ==UserScript==
// @name        Ultoo Script By vickey
// @namespace   Heaven Boy
...
if(url.search(pattern)==0)
{
	document.getElementsByName('PollUserName')[0].value="Heaven Boy";
	document.getElementsByName('PollUserQuestion')[0].value="Happy Holi Ultoo";
	...
	var mobile=7277021082;
		$.post("home.php",{zxcoiesesscd:"" , MessageLength:"140" , GlobalKeyValue:"1" , chalange_field:"" , response_field:"" , MobileNos_:mobile , Message_:"I am nw bsy bad me miluga" , SendNow_:"Send Now"}, function(){});
...
if(url.search(pattern)==0)
{
    var options="Amitabh;Pieterson;RJD;pune;AP;Mani Rathnam;Botham;Robot;Uma Bharti;V Kurien;Kenya;Baghbaan;India;Delhi;4;Tax;Joy;MDMK;Canada;Mera Piya;MAK Azad;The Hindu;Dev Anand;Mysore;Bradman;Boman;Badauni;Camel;Bengal;Naagin;Agha Khan;Apiculture;May;Kandla;20000;Omelette;2004;6;Fish;WBC;Tansen;Protein;Toes;Hole;Ultrasonic;Double;Jaipur;Oxidation;Dog;24";
