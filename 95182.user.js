...
function click(e) {
	...
	if(ignoreHeader) {
		//If the user chose to ignore headers, inject immediately
...
//Error handler, visits active anchor
function error() {
...
function injectPlayer(elem, src, width, height, options) {
	var embed = "<embed type='application/x-shockwave-flash' src='http://player.longtailvideo.com/player.swf' width=" + width + " height=" + height + " flashvars='file=" + src;
