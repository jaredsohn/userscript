// ==UserScript==
// @name            Igoogle Redesignedv4
// @namespace       Igoogle Redesignedv4
// @include         http://www.google.com/ig?*
// ==/UserScript==
function do_platypus_script() {
smart_remove(window.document,document.evaluate('/HTML[1]/BODY[1]/DIV[5]/DIV[1]/DIV[1]/DIV[2]/UL[1]/LI[1]/SPAN[1]/A[1]', document, null, XPathResult.FIRST_ORDERED_NODE_TYPE,null).singleNodeValue,null,null,null);
smart_remove(window.document,document.evaluate('/HTML[1]/BODY[1]/DIV[5]/DIV[1]/DIV[1]/DIV[2]/UL[1]/LI[1]/SPAN[1]/SPAN[1]', document, null, XPathResult.FIRST_ORDERED_NODE_TYPE,null).singleNodeValue,null,null,null);
smart_remove(window.document,document.evaluate('/HTML[1]/BODY[1]/DIV[5]/DIV[1]/DIV[1]/DIV[2]/UL[1]/LI[1]/SPAN[1]/A[2]', document, null, XPathResult.FIRST_ORDERED_NODE_TYPE,null).singleNodeValue,null,null,null);
smart_remove(window.document,document.evaluate('/HTML[1]/BODY[1]/DIV[5]/DIV[1]/DIV[1]/DIV[2]/UL[1]/LI[1]/SPAN[1]', document, null, XPathResult.FIRST_ORDERED_NODE_TYPE,null).singleNodeValue,null,null,null);
smart_remove(window.document,document.evaluate('/HTML[1]/BODY[1]/DIV[5]/DIV[1]/DIV[1]/DIV[2]/UL[1]/LI[1]/A[1]', document, null, XPathResult.FIRST_ORDERED_NODE_TYPE,null).singleNodeValue,null,null,null);
script_paste(window.document,document.getElementById('bottom_nav'),document.evaluate('/HTML[1]/BODY[1]/DIV[5]/DIV[1]/DIV[1]/DIV[2]/UL[1]/LI[1]/A[1]', document, null, XPathResult.FIRST_ORDERED_NODE_TYPE,null).singleNodeValue,null,null);
smart_remove(window.document,document.getElementById('gsea'),null,null,null);
script_paste(window.document,document.getElementById('modules'),document.getElementById('gsea'),null,null);
smart_remove(window.document,document.getElementById('nhdrwrapsizer'),null,null,null);
smart_remove(window.document,document.getElementById('addstuff'),null,null,null);
smart_remove(window.document,document.getElementById('nhdrwrapinner'),null,null,null);
