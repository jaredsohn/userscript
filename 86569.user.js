// ==UserScript== 
// @name           Ikariam MiniChat modificado
// @description    scripts un poco modificado para DHB
...
var lang={
 ...
 es: { 'send': '>>>',			'sh': 'Mostrar/ocultar',    'msg': 'Escriba aquí',            'swap': 'modificarse',
       'cpub': 'Servidor', 'cally': 'DAR AL-HARB',    'new': 'Noticia de la versión',         'get': 'instalar',
       'pass': 'Contraseña de la ALY','set': 'poner contraseña aqui',    'noch': 'No hay modificación',
       'errr': 'Acceso prohibido, poner la contraseña en su Embajada',           'mesg': 'Message...',
       'newp': 'Elegir una nueva contraseña para la alianza',
       'oldp': 'Antigua contraseña',
       'setp': 'Nueva contraseña',
       'gopt': '<u>System</u>---Definición Imposible, Por favor, abren la página de <a href="index.php?view=options">opciones</a>---end:0:0:1',
       'chok': 'Todos los miembros de la alianza tienen esta nueva contraseña para la Alianza',
       'errp': 'Error - presione "Mostrar ciudad" para recargar el a Chat',
       'wrng': 'La antigua contraseña no es correcta. Si no puede recordarla, contactar'+m1+m2+m3,
       'putm': 'Escribir un mensaje',
       'repo': '¿Quiere moderar este mensaje?\nSerá indicado a los Moderadores con su nombre. ',
       'reok': 'Hecho. Gracias'
 },
