// ==UserScript==
// @author         Nimesin
// @name           eHR profile view
// @namespace      erepublik@nimesin.com
// @description    eHR profile view- sending various profile info to google spread of your unit
// @version        0.9.0
...
var frameDisplay=1;
var sendToSpread=1;
var formKey="dC1HcmhwXy16Sy1EZmlfYjlPRS1uTmc6MA";
var URLGoogleForm="https://spreadsheets.google.com/formResponse?formkey="+formKey;
//$(".expanded").show();
//$(".expanded").css("top",$(".citizen_military").css("top"));
var rank_id = 
{
...
//	$('.citizen_info a:eq(2)').after(' <a href="'+regFeed+'">feed</a>');
	...
	if (debug==1) alert("citWell: "+citWell);
	var citWellLeft = $('.tooltip_health_limit').html();
	if (debug==1) alert("citWellLeft: "+citWellLeft);
	var foodResetHours = $('#foodResetHours').html();
	if (debug==1) alert("foodResetHours: "+foodResetHours); 
	...
	var citLevel = $('.citizen_level').text();
	if(citName!=citName2)
	{
		//citName=citName2;
		citWellLeft="N/A";
