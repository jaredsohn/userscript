// ==UserScript==
// @name           Moh3n TS Resource bar , Edited
...
var langs = ['auto','English (en)','Ø¹Ø±Ø¨ÙŠ (ar)','Ð‘ÑŠÐ»Ð³Ð°Ñ€ÑÐºÐ¸ (bg)','Bosanski (bs)','Deutsch (de)','EspaÃ±ol (es)','ÙØ§Ø±Ø³ÛŒ (fa)','FranÃ§ais (fr)','Hrvatski (hr)','Magyar (hu)','Italiano (it)','Polski (pl)','PortuguÃªs (pt)','RomÃ¢nÄƒ (ro)','Ð ÑƒÑÑÐºÐ¸Ð¹ (ru)','Ð¡Ñ€Ð¿ÑÐºÐ¸ (sr)','Svenska (sv)','TÃ¼rkÃ§e (tr)','Ð£ÐºÑ€Ð°Ñ—Ð½ÑÑŒÐºÐ° (ua)','Tiáº¿ng Viá»‡t (vi)','ä¸­æ–‡ (zh)'];
...
if( /x2|y2|z2|t1/i.test(crtPath) ) { sM = 2; sK = 2; }
...
DICT = {
	...
	ru: {
		// ÑÑÐ¾Ð±Ñ‰ÐµÐ½Ð¸Ñ Ð² Ð¸Ð³Ñ€Ðµ
		cancel : "ÐžÑ‚Ð¼ÐµÐ½Ð°",
		close : "Ð—Ð°ÐºÑ€Ñ‹Ñ‚ÑŒ",
		overview : "Ð¾Ð±Ð·Ð¾Ñ€ Ð´ÐµÑ€ÐµÐ²ÐµÐ½ÑŒ",
		svers : "Ð²ÐµÑ€ÑÐ¸Ñ ÑÐºÑ€Ð¸Ð¿Ñ‚Ð°",
		settings : "Ð½Ð°ÑÑ‚Ñ€Ð¾Ð¹ÐºÐ¸",
		notes : "Ð·Ð°Ð¼ÐµÑ‚ÐºÐ¸",
		res90 : "Ðº % Ð·Ð°Ð¿Ð¾Ð»Ð½ÐµÐ½Ð¸Ñ ÑÐºÐ»Ð°Ð´Ð°",
		refresh : "Ð¾Ð±Ð½Ð¾Ð²Ð¸Ñ‚ÑŒ",
		warehouse : "Ð¡ÐºÐ»Ð°Ð´Ñ‹",
		resources : "Ð—Ð°Ð¿Ð°ÑÑ‹",
		troops : "Ð’Ð¾Ð¹ÑÐºÐ°",
		links : "Ð¡ÑÑ‹Ð»ÐºÐ¸",
		linkname : "Ð½Ð°Ð·Ð²Ð°Ð½Ð¸Ðµ ÑÑÑ‹Ð»ÐºÐ¸",
		linkdel : "ÑƒÐ´Ð°Ð»Ð¸Ñ‚ÑŒ ÑÑÑ‹Ð»ÐºÑƒ",
		name2 : "Ð²Ñ‚Ð¾Ñ€Ð¾Ðµ Ð¸Ð¼Ñ",
		archive : "ÐÑ€Ñ…Ð¸Ð²",
		arena : "ÐÑ€ÐµÐ½Ð°",
		addcur : "Ð´Ð¾Ð±Ð°Ð²Ð¸Ñ‚ÑŒ ÑÑ‚Ñƒ Ð´ÐµÑ€ÐµÐ²Ð½ÑŽ",
		del : "ÑƒÐ´Ð°Ð»Ð¸Ñ‚ÑŒ",
		edit : "Ð¸Ð·Ð¼ÐµÐ½Ð¸Ñ‚ÑŒ",
		unfix : "Ð¾Ñ‚ÐºÑ€ÐµÐ¿Ð¸Ñ‚ÑŒ",
		fix : "Ð·Ð°ÐºÑ€ÐµÐ¿Ð¸Ñ‚ÑŒ",
		total : "Ð’ÑÐµÐ³Ð¾",
		noplace : "ÐÐµÑ‚ Ð¼ÐµÑÑ‚Ð°!",
		hunger : "Ð½Ð°ÑÑ‚ÑƒÐ¿Ð»ÐµÐ½Ð¸Ðµ Ð³Ð¾Ð»Ð¾Ð´Ð°",
		duration : "Ð¿Ñ€Ð¾Ð´Ð¾Ð»Ð¶Ð¸Ñ‚ÐµÐ»ÑŒÐ½Ð¾ÑÑ‚ÑŒ",
		deficit : "Ð´ÐµÑ„Ð¸Ñ†Ð¸Ñ‚",
		consnegat : "ÐŸÐ¾Ñ‚Ñ€ÐµÐ±Ð»ÐµÐ½Ð¸Ðµ Ð² ÑÑ‚Ð¾Ð¹ Ð´ÐµÑ€ÐµÐ²Ð½Ðµ Ð¾Ñ‚Ñ€Ð¸Ñ†Ð°Ñ‚ÐµÐ»ÑŒÐ½Ð¾Ðµ. ÐÐ° ÑÐºÐ¾Ð»ÑŒÐºÐ¾ Ð¼Ð¸Ð½ÑƒÑ‚ Ð½ÑƒÐ¶ÐµÐ½ Ð·Ð°Ð¿Ð°Ñ?",
		searchlast : "ÐÐ°Ð¹Ñ‚Ð¸ Ð¿Ð¾ÑÐ»ÐµÐ´Ð½ÐµÐµ Ð¸Ð·",
		bmove : "ÐŸÐµÑ€ÐµÐ¼ÐµÑ‰ÐµÐ½Ð¸Ðµ Ð·Ð´Ð°Ð½Ð¸Ð¹",
		neighbors : "ÑÐ¾ÑÐµÐ´Ð¸",
		// Ð½Ð°ÑÑ‚Ñ€Ð¾Ð¹ÐºÐ¸
		none : 'Ð½ÐµÑ‚',
		auto : "Ð°Ð²Ñ‚Ð¾.",
		info : "ÐžÐ±Ñ‰Ð°Ñ Ð¸Ð½Ñ„Ð¾Ñ€Ð¼Ð°Ñ†Ð¸Ñ",
		yourrace : "Ð’Ð°Ñˆ Ð½Ð°Ñ€Ð¾Ð´",
		speedart : "ÐÑ€Ñ‚ÐµÑ„Ð°ÐºÑ‚ ÑÐºÐ¾Ñ€Ð¾ÑÑ‚Ð¸",
		racelist : ['Ð Ð¸Ð¼Ð»ÑÐ½Ðµ','Ð“ÐµÑ€Ð¼Ð°Ð½Ñ†Ñ‹','Ð“Ð°Ð»Ð»Ñ‹'],
		cranny : "Ð¶ÐµÐ»Ñ‚Ñ‹Ð¹ ÑƒÑ€Ð¾Ð²ÐµÐ½ÑŒ Ð·Ð°Ð½ÑÑ‚Ð¾ÑÑ‚Ð¸ Ñ‚Ð°Ð¹Ð½Ð¸ÐºÐ° (Ð¿Ñ€Ð¾Ñ†ÐµÐ½Ñ‚Ñ‹)",
		crannyh : 'Ð½Ð¾Ñ€Ð¼Ð° - 80, 70 Ð´Ð»Ñ ÐºÐ»Ð°ÑÑÐ¸Ñ‡ÐµÑÐºÐ¾Ð³Ð¾ ÑÐµÑ€Ð²ÐµÑ€Ð° Ð¸Ð»Ð¸ Ð´Ð»Ñ Ð°Ñ€Ñ‚ÐµÑ„Ð°ÐºÑ‚Ð° Ð³Ñ€Ð°Ð±Ð¸Ñ‚ÐµÐ»Ñ',
		builtin : "Ð’ÑÑ‚Ñ€Ð¾ÐµÐ½Ð½Ñ‹Ðµ Ð¸Ð½ÑÑ‚Ñ€ÑƒÐ¼ÐµÐ½Ñ‚Ñ‹",
		builtinh : 'Ð´Ð»Ñ Ð½Ð¾Ñ€Ð¼Ð°Ð»ÑŒÐ½Ð¾Ð³Ð¾ Ð¿Ñ€Ð¾Ð¸Ð·Ð²Ð¾Ð´ÑÑ‚Ð²Ð°: ÐºÑ€Ð°ÑÐ½Ñ‹Ð¹ Ñ†Ð²ÐµÑ‚ - ÑÐ°Ð¼Ñ‹Ð¹ Ð½ÐµÐ¾Ð±Ñ…Ð¾Ð´Ð¸Ð¼Ñ‹Ð¹ Ñ€ÐµÑÑƒÑ€Ñ, Ð·ÐµÐ»Ñ‘Ð½Ñ‹Ð¹ - Ð»Ð¸ÑˆÐ½ÐµÐµ Ð¿Ñ€Ð¾Ð¸Ð·Ð²Ð¾Ð´ÑÑ‚Ð²Ð¾',
		normalize : 'ÐÐ¾Ñ€Ð¼Ð°Ð»ÑŒÐ½Ð¾Ðµ Ð¿Ñ€Ð¾Ð¸Ð·Ð²Ð¾Ð´ÑÑ‚Ð²Ð¾',
		normal : "Ñ€ÐµÑÑƒÑ€ÑÑ‹",
		banalyze : "Ð’ÑÑ‚Ñ€Ð¾ÐµÐ½Ð½Ñ‹Ð¹ Ð°Ð½Ð°Ð»Ð¸Ð·Ð°Ñ‚Ð¾Ñ€ Ð±Ð¾Ñ",
		cropfind : "Ð’ÑÑ‚Ñ€Ð¾ÐµÐ½Ð½Ñ‹Ð¹ Ð¿Ð¾Ð¸ÑÐº ÑÐ²Ð¾Ð±Ð¾Ð´Ð½Ñ‹Ñ… Ñ…Ð»ÐµÐ±Ð½Ñ‹Ñ… ÐºÐ»ÐµÑ‚Ð¾Ðº",
		adetect : "ÐžÐ±Ð½Ð°Ñ€ÑƒÐ¶ÐµÐ½Ð¸Ðµ Ð½Ð°Ð¿Ð°Ð´ÐµÐ½Ð¸Ñ",
		adetecto : ['Ð²Ñ‹ÐºÐ».','Ð±ÐµÐ· Ð·Ð°Ð¼Ð¾Ñ€Ð¾Ð·ÐºÐ¸','Ð²ÐºÐ»ÑŽÑ‡ÐµÐ½Ð¾'],
		adetecth : "Ð´ÐµÐ»Ð°ÐµÑ‚ ÑÐºÑ€Ñ‹Ñ‚Ñ‹Ðµ Ð¾Ð±Ñ€Ð°Ñ‰ÐµÐ½Ð¸Ñ Ðº ÑÐµÑ€Ð²ÐµÑ€Ñƒ, Ð½Ð°Ñ€ÑƒÑˆÐ°Ñ Ð¿Ñ€Ð°Ð²Ð¸Ð»Ð°. Ð¼Ð¾Ð¶ÐµÑ‚ Ð¿Ð¾Ð²Ð»ÐµÑ‡ÑŒ Ð½Ð°ÐºÐ°Ð·Ð°Ð½Ð¸Ðµ.",
		adetectt : "Ð¿ÐµÑ€Ð¸Ð¾Ð´ Ð¾Ð±Ð½Ð°Ñ€ÑƒÐ¶ÐµÐ½Ð¸Ñ",
		buildhint : "ÐŸÐ¾Ð´ÑÐºÐ°Ð·ÐºÐ¸ Ð²Ð¾Ð·Ð¼Ð¾Ð¶Ð½Ð¾ÑÑ‚Ð¸ ÑÑ‚Ñ€Ð¾Ð¸Ñ‚ÐµÐ»ÑŒÑÐ²Ð°",
		onallp : "ÐÐ° Ð²ÑÐµÑ… ÑÑ‚Ñ€Ð°Ð½Ð¸Ñ‡ÐºÐ°Ñ…",
		dontwrap : "ÐÐµ Ð´Ð°Ð²Ð°Ñ‚ÑŒ ÑÐ²Ð¾Ñ€Ð°Ñ‡Ð¸Ð²Ð°Ñ‚ÑŒ ÑÑ‚Ñ€Ð°Ð½Ð¸Ñ‡ÐºÑƒ",
		dontwraph : 'ÐµÑÐ»Ð¸ ÑÐ¿Ð¸ÑÐ¾Ðº Ð´ÐµÑ€ÐµÐ²ÐµÐ½ÑŒ Ð¿Ñ€Ñ‹Ð³Ð°ÐµÑ‚ Ð²Ð½Ð¸Ð· Ð¸Ð»Ð¸ Ð¿ÐµÑ€ÐµÐºÐ°ÑˆÐ¸Ð²Ð°ÐµÑ‚ÑÑ',
		buildand : "ÐŸÐ¾ÐºÐ°Ð·Ñ‹Ð²Ð°Ñ‚ÑŒ Ñ‚Ð°Ð¹Ð¼ÐµÑ€ Ð¿Ð¾ÑÑ‚Ñ€Ð¾ÐµÐº Ð¸ Ð°Ñ‚Ð°ÐºÐ¸",
		buildandh : 'Ð¾Ñ‚Ð¾Ð±Ñ€Ð°Ð¶Ð°ÐµÑ‚ÑÑ ÐºÐ°Ðº Ñ‡Ð°ÑÐ¸ÐºÐ¸ Ð² ÑÐ¿Ð¸ÑÐºÐµ Ð´ÐµÑ€ÐµÐ²ÐµÐ½ÑŒ',
		sendres : "ÐŸÐ¾ÐºÐ°Ð·Ñ‹Ð²Ð°Ñ‚ÑŒ Ð¸ÐºÐ¾Ð½ÐºÐ¸ &laquo;Ð¾Ñ‚Ð¾ÑÐ»Ð°Ñ‚ÑŒ Ñ€ÐµÑÑƒÑ€ÑÑ‹/Ð²Ð¾Ð¹ÑÐºÐ°&raquo;",
		sendmess : "ÐŸÐ¾ÐºÐ°Ð·Ñ‹Ð²Ð°Ñ‚ÑŒ Ð¸ÐºÐ¾Ð½ÐºÐ¸ &laquo;Ð¾Ñ‚Ð¾ÑÐ»Ð°Ñ‚ÑŒ ÑÐ¾Ð¾Ð±Ñ‰ÐµÐ½Ð¸Ðµ&raquo;",
		analyzer : "ÐÐ½Ð°Ð»Ð¸Ð·Ð°Ñ‚Ð¾Ñ€ Ð¼Ð¸Ñ€Ð°",
		bigicon : "ÐŸÐ¾ÐºÐ°Ð·Ñ‹Ð²Ð°Ñ‚ÑŒ Ð‘ÐžÐ›Ð¬Ð¨Ð˜Ð• Ð¸ÐºÐ¾Ð½ÐºÐ¸",
		addvtable : "ÐŸÐ¾ÐºÐ°Ð·Ñ‹Ð²Ð°Ñ‚ÑŒ Ð´Ð¾Ð¿Ð¾Ð»Ð½Ð¸Ñ‚ÐµÐ»ÑŒÐ½ÑƒÑŽ Ñ‚Ð°Ð±Ð»Ð¸Ñ†Ñƒ Ð´ÐµÑ€ÐµÐ²ÐµÐ½ÑŒ",
		addvtableo : ['Ð½ÐµÑ‚','Ð´Ð°','Ð¿Ñ€Ð¸ÐºÐ»ÐµÐ¸Ñ‚ÑŒ'],
		addvtableh : 'Ð´Ð»Ñ Ñ‚Ñ€Ð°Ð²Ð¸Ð°Ð½ Ð²ÐµÑ€ÑÐ¸Ð¸ 4',
		opennote : "ÐÐ²Ñ‚Ð¾Ð¼Ð°Ñ‚Ð¸Ñ‡ÐµÑÐºÐ¸ Ð¾Ñ‚ÐºÑ€Ñ‹Ð²Ð°Ñ‚ÑŒ Ð·Ð°Ð¼ÐµÑ‚ÐºÐ¸",
		notesize : "Ð Ð°Ð·Ð¼ÐµÑ€ Ð¾ÐºÐ½Ð° Ð·Ð°Ð¼ÐµÑ‚Ð¾Ðº",
		openoview : "ÐÐ²Ñ‚Ð¾Ð¼Ð°Ñ‚Ð¸Ñ‡ÐµÑÐºÐ¸ Ð¾Ñ‚ÐºÑ€Ñ‹Ð²Ð°Ñ‚ÑŒ Ð¾Ð±Ð·Ð¾Ñ€ Ð´ÐµÑ€ÐµÐ²ÐµÐ½ÑŒ",
		resbar : "Ð¢Ð°Ð±Ð»Ð¸Ñ†Ð° Ñ€ÐµÑÑƒÑ€ÑÐ¾Ð²",
		showres : "ÐŸÐ¾ÐºÐ°Ð·Ñ‹Ð²Ð°Ñ‚ÑŒ Ñ‚Ð°Ð±Ð»Ð¸Ñ†Ñƒ Ñ€ÐµÑÑƒÑ€ÑÐ¾Ð² Ð² Ð¾ÐºÐ½Ðµ",
		redbl : "ÐºÑ€Ð°ÑÐ½Ñ‹Ð¹ (Ð² Ñ‡Ð°ÑÐ°Ñ…)",
		yellowbl: "Ð¶ÐµÐ»Ñ‚Ñ‹Ð¹ (Ð² Ñ‡Ð°ÑÐ°Ñ…)",
		marketpl : "Ð Ñ‹Ð½Ð¾Ðº",
		mfilter : "Ñ„Ð¸Ð»ÑŒÑ‚Ñ€ Ð¿Ñ€ÐµÐ´Ð»Ð¾Ð¶ÐµÐ½Ð¸Ð¹",
		mfiltero : ['Ð½ÐµÑ‚','Ñ‚Ð¾Ð»ÑŒÐºÐ¾ Ñ€ÐµÐ¹Ñ‚Ð¸Ð½Ð³','Ñ‚Ð¾Ð»ÑŒÐºÐ¾ Ñ„Ð¸Ð»ÑŒÑ‚Ñ€','Ð¿Ð¾Ð»Ð½Ñ‹Ð¹'],
		npcsum : "ÑÑƒÐ¼Ð¼Ð° Ñ€ÐµÑÑƒÑ€ÑÐ¾Ð² Ð´Ð»Ñ NPC",
		npcsumh : 'Ð½Ð° Ñ€Ñ‹Ð½ÐºÐµ Ð¸ ÑÑ‚Ñ€Ð¾Ð¹ÐºÐ°Ñ…',
		bidinc : "ÑˆÐ°Ð³ ÑÑ‚Ð°Ð²ÐºÐ¸",
		bidinch : 'Ð´Ð»Ñ Ð°ÑƒÐºÑ†Ð¸Ð¾Ð½Ð¾Ð² Ñ‚Ñ€Ð°Ð²Ð¸Ð°Ð½ Ð²ÐµÑ€ÑÐ¸Ð¸ 4',
		show3x : "Ð¿Ð¾ÐºÐ°Ð·Ñ‹Ð²Ð°Ñ‚ÑŒ Ð²Ð¾Ð·Ð¼Ð¾Ð¶Ð½Ð¾ Ð½ÐµÐ²ÐµÑ€Ð½Ñ‹Ðµ Ð´Ð°Ð½Ð½Ñ‹Ðµ",
		show3xh : 'Ð¿Ð¾Ð¿Ñ‹Ñ‚ÐºÐ° Ð¿Ñ€ÐµÐ´ÑÐºÐ°Ð·Ð°Ñ‚ÑŒ Ð¿Ð¾ÑÑ‚ÑƒÐ¿Ð»ÐµÐ½Ð¸Ðµ Ñ€ÐµÑÑƒÑ€ÑÐ¾Ð² Ð¿Ñ€Ð¸ 3x Ð¸ 2x Ð¾Ñ‚Ð¿Ñ€Ð°Ð²ÐºÐµ',
		rpandmp : "ÐŸÑƒÐ½ÐºÑ‚ ÑÐ±Ð¾Ñ€Ð° Ð¸ Ñ€Ñ‹Ð½Ð¾Ðº",
		incomres : "Ð¸Ð½Ñ„Ð¾Ñ€Ð¼Ð°Ñ†Ð¸Ñ Ð¾ Ð¿Ð¾ÑÑ‚ÑƒÐ¿Ð°ÑŽÑ‰Ð¸Ñ… Ñ€ÐµÑÑƒÑ€ÑÐ°Ñ…",
		incomreso : ['Ð½ÐµÑ‚','ÐµÑÑ‚ÑŒ','Ñ Ð¸Ñ‚Ð¾Ð³Ð°Ð¼Ð¸','Ð§ÑƒÐ´Ð¾ Ñ€ÐµÐ¶Ð¸Ð¼'],
		troopsI : "Ð˜Ð½Ñ„Ð¾Ñ€Ð¼Ð°Ñ†Ð¸Ñ Ð¾ Ð²Ð¾Ð¹ÑÐºÐ°Ñ…",
		troopsIo : ['Ð½ÐµÑ‚','Ð´Ð°','Ð¿ÐµÑ€ÐµÑ‡Ð¸Ñ‚Ð°Ñ‚ÑŒ ÑÐ¿Ñ€Ð°Ð²ÐºÑƒ'],
		defRP : "Ð´ÐµÐ¹ÑÑ‚Ð²Ð¸Ðµ Ð¿Ð¾ ÑƒÐ¼Ð¾Ð»Ñ‡Ð°Ð½Ð¸ÑŽ Ð´Ð»Ñ Ð¿ÑƒÐ½ÐºÑ‚Ð° ÑÐ±Ð¾Ñ€Ð°",
		showls : "ÐŸÐ¾ÐºÐ°Ð·Ñ‹Ð²Ð°Ñ‚ÑŒ ÑÑÑ‹Ð»ÐºÐ¸",
		showAsSN : "Ð˜ÑÐ¿Ð¾Ð»ÑŒÐ·Ð¾Ð²Ð°Ñ‚ÑŒ ÑÑÑ‹Ð»ÐºÐ¸ ÐºÐ°Ðº Ð²Ñ‚Ð¾Ñ€Ð¾Ðµ Ð¸Ð¼Ñ",
		showlso : ['Ð½ÐµÑ‚','Ð´Ð°','Ð² Ð¾ÐºÐ½Ðµ'],
		savedls : "ÑÐ¾Ñ…Ñ€Ð°Ð½Ñ‘Ð½Ð½Ñ‹Ðµ ÑÑÑ‹Ð»ÐºÐ¸",
		savedd : "ÑÐ¾Ñ…Ñ€Ð°Ð½Ñ‘Ð½Ð½Ñ‹Ðµ Ð´Ð°Ð½Ð½Ñ‹Ðµ",
		saveddh : 'Ð²ÐºÐ»ÑŽÑ‡Ð°Ñ Ð¡ÑÑ‹Ð»ÐºÐ¸ Ð¸ Ð’Ñ‚Ð¾Ñ€Ð¾Ðµ Ð¸Ð¼Ñ Ð´ÐµÑ€ÐµÐ²ÐµÐ½ÑŒ. Ð•ÑÐ»Ð¸ ÑƒÑ‡ÐµÑ‚Ð½Ð°Ñ Ð·Ð°Ð¿Ð¸ÑÑŒ ÑƒÐ´Ð°Ð»ÑÐµÑ‚ÑÑ Ð¸Ð»Ð¸ ÑÑ‚Ð¾ Ð½Ðµ Ð²Ð°Ñˆ ÐºÐ¾Ð¼Ð¿ÑŒÑŽÑ‚ÐµÑ€.',
		savedelall : "ÑƒÐ´Ð°Ð»Ð¸Ñ‚ÑŒ Ð²ÑÐµ Ð´Ð°Ð½Ð½Ñ‹Ðµ",
		savedelallh : 'Ð’Ñ‹ ÑƒÐ²ÐµÑ€ÐµÐ½Ñ‹, Ñ‡Ñ‚Ð¾ Ñ…Ð¾Ñ‚Ð¸Ñ‚Ðµ ÑƒÐ´Ð°Ð»Ð¸Ñ‚ÑŒ Ð²ÑÐµ Ð´Ð°Ð½Ð½Ñ‹Ðµ, Ð²ÐºÐ»ÑŽÑ‡Ð°Ñ Ð¡ÑÑ‹Ð»ÐºÐ¸ Ð¸ Ð’Ñ‚Ð¾Ñ€Ð¾Ðµ Ð¸Ð¼Ñ Ð´ÐµÑ€ÐµÐ²ÐµÐ½ÑŒ?',
		scrlang : "Ð¯Ð·Ñ‹Ðº ÑÐºÑ€Ð¸Ð¿Ñ‚Ð°",
		youlang : "Ð’Ð°Ñˆ ÑÐ·Ñ‹Ðº",
		notifi : "Ð½Ð°Ð¿Ð¾Ð¼Ð¸Ð½Ð°Ð½Ð¸Ñ",
		notification : "Ð¾Ð¿Ð¾Ð²Ð¸Ñ‰ÐµÐ½Ð¸Ðµ Ð¿Ð¾ÑÐ»Ðµ ÑÑ‚Ñ€Ð¾Ð¸Ñ‚ÐµÐ»ÑŒÑÑ‚Ð²Ð°",
		method : "Ð¼ÐµÑ‚Ð¾Ð´",
		audiourl : "URL Ð·Ð²ÑƒÐºÐ¾Ð²Ð¾Ð³Ð¾ Ñ„Ð°Ð¹Ð»Ð°",
		audiotest : "Ð¿Ñ€Ð¾Ð²ÐµÑ€Ð¸Ñ‚ÑŒ Ð·Ð²ÑƒÐº"
	},
	ua: { fb : "ru",
		archive : "ÐÑ€Ñ…Ñ–Ð²",
		racelist : ['Ð Ð¸Ð¼Ð»ÑÐ½Ð¸','Ð¢ÐµÐ²Ñ‚Ð¾Ð½Ñ†Ñ–','Ð“Ð°Ð»Ð»Ð¸']
	},
	hu: { // Hungarian language. thx mrzed :)
		...
		notes : "jegyzetek",
		res90 : "nyersanyagokat %-ig feltÃ¶lteni",
		refresh : "frissÃ­t",
		...
		info : "InformÃ¡ciÃ³k",
		yourrace : "NÃ©p",
		speedart : "SebessÃ©g ereklye",
		racelist : ['RÃ³mai','GermÃ¡n','Gall'],
		onallp : "Minden oldal",
		dontwrap : "Ne tÃ¶mÃ¶rÃ­tse az oldalakat",
		dontwraph : 'Ha a faluk listÃ¡ja leugrik',
		buildand : "VisszaszÃ¡mlÃ¡lÃ³k megjelenÃ­tÃ©se",
		buildandh : 'A faluk listÃ¡jÃ¡ban (Ã©pÃ­tkezÃ©sek, csapatmozgÃ¡sok)',
		sendres : "Nyersanyag-/csapatkÃ¼ldÃ©s ikonok megjelenÃ­tÃ©se",
		sendmess : "ÃœzenetkÃ¼ldÃ©s ikonok megjelenÃ­tÃ©se",
		bigicon : "Nagy ikonok megjelenÃ­tÃ©se",
		opennote : "Jegyzetek automatikus megnyitÃ¡sa",
		resbar : "NyersanyagkijelzÅ‘",
		showres : "NyersanyagkijelzÅ‘ kÃ¼lÃ¶n ablakban",
		redbl : "piros (Ã³rÃ¡ban)",
		yellowbl: "sÃ¡rga (Ã³rÃ¡ban)",
		marketpl : "PiactÃ©r",
		mfilter : "szÅ±rÅ‘",
		mfiltero : ['nincs','csak arÃ¡ny','csak szÅ±rÅ‘','teljes'],
		rpandmp : "GyÃ¼lekezÅ‘tÃ©r Ã©s piactÃ©r",
		incomres : "InformÃ¡ciÃ³ az Ã©rkezÅ‘ nyersanyagokrÃ³l",
		incomreso : ['ki','be','Ã¶sszefoglalÃ³','WW mode'],
		troopsI : "CsapatinformÃ¡ciÃ³k",
		showls : "Linkek megjelenÃ­tÃ©se",
		showlso : ['ki','be','ablakban'],
		savedls : "Mentett linkek",
		scrlang : "Szkript nyelve",
		youlang : "Az Ã–n nyelve"
		//version = verziÃ³
		//Rally point = GyÃ¼lekezÅ‘tÃ©r
	},
	fa: { // Persian, thx Reza Moghadam
		...
		svers : "ÙˆØ±Ú˜Ù† Ø§Ø³Ú©Ø±ÛŒÙ¾Øª",
		settings : "ØªÙ†Ø¸ÛŒÙ…Ø§Øª",
		notes : "Ù…ØªÙ†",
		res90 : "% Ù…Ù†Ø§Ø¨Ø¹ Ù¾Ø± Ø§Ø³Øª",
		warehouse : "Ø§Ù†Ø¨Ø§Ø±",
		resources : "Ù…Ù†Ø§Ø¨Ø¹",
		troops : "Ù„Ø´Ú©Ø±ÛŒØ§Ù†",
		links : "Ù„ÛŒÙ†Ú© Ù‡Ø§",
		archive : "Ø¢Ø±Ø´ÛŒÙˆ",
		arena : "Ù…ÛŒØ¯Ø§Ù† ØªÙ…Ø±ÛŒÙ†",
		// settings
		info : "Ø§Ø·Ù„Ø§Ø¹Ø§Øª",
		yourrace : "Ø¯Ø³ØªÙ‡ ÛŒ Ø´Ù…Ø§",
		speedart : "Ø³Ø±Ø¹Øª Ù…ØµÙ†ÙˆØ¹ÛŒ",
		racelist : ['Ø±ÙˆÙ…ÛŒ Ù‡Ø§','ØªÙˆØªÙ† Ù‡Ø§','Ú¯Ù„ Ù‡Ø§'],
		onallp : "Ù‡Ù…Ù‡ ÛŒ ØµÙØ­Ø§Øª",
		dontwrap : 'Ú©Ø´ÛŒØ¯Ù‡ Ù†Ø´Ø¯Ù† ØµÙØ­Ù‡',
		dontwraph : "Ø§Ú¯Ø± Ù„ÛŒØ³Øª Ø±ÙˆØ³ØªØ§Ù‡ Ù¾Ø§ÛŒÛŒÙ† Ø±ÙØª",
		buildand : "Ù†Ù…Ø§ÛŒØ´ Ø´Ù…Ø§Ø±Ø´ Ù…Ø¹Ú©ÙˆØ³ Ø³Ø§Ø®ØªÙ…Ø§Ù† Ùˆ Ø­Ù…Ù„Ù‡",
		buildandh : 'Ø¯Ø± Ù„ÛŒØ³Øª Ø±ÙˆØ³ØªØ§ Ù‡Ø§',
		sendres : "Ù†Ù…Ø§ÛŒØ´ Ø¢ÛŒÚ©ÙˆÙ† Ù‡Ø§ÛŒ Ø§Ø±Ø³Ø§Ù„ Ù…Ù†Ø§Ø¨Ø¹/Ø³Ø±Ø¨Ø§Ø²Ø§Ù†",
		sendmess : "Ù†Ù…Ø§ÛŒØ´ Ø¢ÛŒÚ©ÙˆÙ† Ù‡Ø§ÛŒ Ø§Ø±Ø³Ø§Ù„ Ù¾ÛŒØ§Ù…",
		bigicon : "Ù†Ù…Ø§ÛŒØ´ Ø¢ÛŒÚ©ÙˆÙ† Ù‡Ø§ÛŒ Ø¨Ø²Ø±Ú¯",
		opennote : "Ø¨Ø§Ø²Ø´Ø¯Ù† Ø®ÙˆØ¯Ú©Ø§Ø± Ù…ØªÙ† Ù‡Ø§",
		resbar : "Ù†ÙˆØ§Ø± Ù…Ù†Ø§Ø¨Ø¹",
		showres : "Ù†Ù…Ø§ÛŒØ´ Ù†ÙˆØ§Ø± Ù…Ù†Ø§Ø¨Ø¹ Ø¯Ø± Ù¾Ù†Ø¬Ø±Ù‡",
		redbl : "Ù‚Ø±Ù…Ø² (Ø¯Ø± Ø³Ø§Ø¹Øª)",
		yellowbl: "Ø²Ø±Ø¯ (Ø¯Ø± Ø³Ø§Ø¹Øª)",
		marketpl : "Ø¨Ø§Ø²Ø§Ø±",
		mfilter : "ÙÛŒÙ„ØªØ±",
		mfiltero : ['Ø®Ø§Ù…ÙˆØ´','ØªÙ†Ù‡Ø§ Ø§Ø±Ø²ÛŒØ§Ø¨ÛŒ','ÙÙ‚Ø· Ø®Ø§Ù…ÙˆØ´','Ú©Ø§Ù…Ù„'],
		rpandmp : "Ø§Ø±Ø¯ÙˆÚ¯Ø§Ù‡ Ùˆ Ø¨Ø§Ø²Ø§Ø±",
		incomres : "Ø¯Ø±ÛŒØ§ÙØª Ø§Ø·Ù„Ø§Ø¹Ø§Øª Ù…Ù†Ø§Ø¨Ø¹",
		incomreso : ['Ø®Ø§Ù…ÙˆØ´','Ø±ÙˆØ´Ù†','Ø®Ù„Ø§ØµÙ‡','WW mode'],
		showls : "Ù†Ù…Ø§ÛŒØ´ Ù„ÛŒÙ†Ù†Ú© Ù‡Ø§",
		showlso : ['Ø®Ø§Ù…ÙˆØ´','Ø±ÙˆØ´Ù†','Ø¯Ø± Ù¾Ù†Ø¬Ø±Ù‡'],
		savedls : "Ø°Ø®ÛŒØ±Ù‡ Ø³Ø§Ø²ÛŒ Ù„ÛŒÙ†Ú© Ù‡Ø§"
	},
 ar: { // Arabic, thx ww_start_t
		...
		close : "Ø¥ØºÙ„Ø§Ù‚",
		overview : "Ù†Ø¸Ø±Ø© Ø¹Ø§Ù…Ø© Ø¹Ù„Ù‰ Ø¬Ù…ÙŠØ¹ Ø§Ù„Ù‚Ø±Ù‰",
		svers : "Ø£ØµØ¯Ø§Ø± Ø§Ù„Ø³ÙƒØ±Ø¨Øª",
		settings : "Ø§Ù„Ø£Ø¹Ø¯Ø§Ø¯Ø§Øª",
		notes : "Ø¯ÙØªØ± Ø§Ù„Ù…Ù„Ø§Ø­Ø¸Ø§Øª",
		res90 : "Ø§Ù„Ù…ÙˆØ§Ø±Ø¯ Ø­ØªÙ‰ % Ù„Ù„Ø­Ø¯ Ø§Ù„Ø£Ù‚ØµÙ‰",
		refresh : "ØªØ­Ø¯ÙŠØ«",
		warehouse : "Ø§Ù„Ù…Ø®Ø²Ù†",
		resources : "Ø§Ù„Ù…ÙˆØ§Ø±Ø¯",
		troops : "Ø§Ù„Ù‚ÙˆØ§Øª",
		links : "Ø§Ù„Ø±ÙˆØ§Ø¨Ø·",
		linkname : "Ø£Ø³Ù… Ø§Ù„Ø±Ø§Ø¨Ø·",
		linkdel : "Ø­Ø°Ù Ø§Ù„Ø±Ø§Ø¨Ø·",
		name2 : "Ø§Ù„Ø£Ø³Ù… Ø§Ù„ØªØ§Ù„ÙŠ",
		archive : "Ø§Ù„Ø£Ø±Ø´ÙŠÙ",
		arena : "Ø³Ø§Ø­Ø© Ø§Ù„Ø¨Ø·ÙˆÙ„Ø©",
		addcur : "Ø£Ø¶Ø§ÙØ©",
		del : "Ø£Ù…Ø³Ø­",
		edit : "ØªØ¹Ø¯ÙŠÙ„",
		unfix : "Ù„Ù… ÙŠØªÙ… Ø£ØµÙ„Ø§Ø­Ø©",
		fix : "ØªÙ… Ø£ØµÙ„Ø§Ø­Ø©",
		total : "Ø§Ù„Ù…Ø¬Ù…ÙˆØ¹",
		noplace : "Ù„Ø§ÙŠÙˆØ¬Ø¯ Ø³ÙƒÙ†!",
		hunger : "Ø¬ÙˆØ¹",
		duration : "Ø§Ù„Ù…Ø¯Ø©",
		deficit : "Ù„Ø§ÙŠÙ…ÙƒÙ†",
		aclock : "Ø§Ù„Ù…Ù†Ø¨Ø©\nhh:mm:ss , hh:mm , mm (Ù…Ù† Ø§Ù„ÙˆÙ‚Øª Ø§Ù„Ø­Ø§Ù„ÙŠ)",
		consnegat : "Ø§Ø³ØªÙ‡Ù„Ø§Ùƒ Ø§Ù„Ù‚Ù…Ø­ Ù„Ù‡Ø°Ù‡ Ø§Ù„Ù‚Ø±ÙŠØ© Ø³Ø§Ù„Ø¨. ÙƒÙ… Ø¯Ù‚ÙŠÙ‚Ø© Ø§Ø­ØªÙŠØ§Ø·ÙŠØ© ØªØ­ØªØ§Ø¬ØŸ",
		searchlast : "Ø¨Ø­Ø« Ø¹Ù† Ø£Ø®Ø±",
		bmove : "ØªØ­Ø±ÙŠÙƒ Ø§Ù„Ù…Ø¨Ø§Ù†ÙŠ",
		// settings
		none : "Ù„Ø§Ø´ÙŠØ¡",
		auto : "Ø¢Ù„ÙŠ",
		info : "Ø§Ù„Ù…Ø¹Ù„ÙˆÙ…Ø§Øª",
		yourrace : "Ù‚Ø¨ÙŠÙ„ØªÙƒ",
		speedart : "Ø§Ù„Ø³Ø±Ø¹Ø©",
		racelist : ['Ø§Ù„Ø±ÙˆÙ…Ø§Ù†','Ø§Ù„Ø¬Ø±Ù…Ø§Ù†','Ø§Ù„Ø£ØºØ±ÙŠÙ‚'],
		cranny : "Ø§Ù„Ù†Ø³Ø¨Ø© Ù„Ù„ÙˆÙ† Ø§Ù„Ø£ØµÙØ± Ù„Ù„Ù…Ø®Ø¨Ø£ (Ø§Ù„Ù†Ø³Ø¨Ø©)",
		crannyh : 'Ø§Ù„Ø£ÙØªØ±Ø§Ø¶ÙŠ 80, 70 Ù„Ù„ÙƒÙ„Ø§Ø³ÙŠÙƒ',
		builtin : "Ø§Ù„Ø£Ø¯ÙˆØ§Øª-Ø§Ù„Ù…Ø¨Ù†ÙŠØ©",
		builtinh : 'Ø£Ù„ÙˆØ§Ù† Ø§Ù†ØªØ§Ø¬ Ø§Ù„Ù…ÙˆØ§Ø±Ø¯: Ø§Ù„Ù„ÙˆÙ† Ø§Ù„Ø£Ø­Ù…Ø± - Ù„Ù„Ø£Ù‚Ù„ Ø§Ù†ØªØ§Ø¬, Ø§Ù„Ù„ÙˆÙ† Ø§Ù„Ø£Ø®Ø¶Ø± - Ù„Ù„Ø£ÙƒØ«Ø± Ø§Ù†ØªØ§Ø¬',
		normalize : 'Ø§Ù†ØªØ§Ø¬ Ø§Ù„Ù…ÙˆØ§Ø±Ø¯',
		normal : "Ø§Ù„Ø£ÙØªØ±Ø§Ø¶ÙŠ",
		banalyze : "Ù…Ø¨Ù†ÙŠ Ø¹Ù„Ù‰ - Ù…Ø­Ø§ÙƒÙŠ Ø§Ù„Ù…Ø¹Ø§Ø±Ùƒ",
		cropfind : "Ù…Ø¨Ù†ÙŠ Ø¹Ù„Ù‰ - Ø¨Ø§Ø­Ø« Ø¹Ù† Ø§Ù„Ù‚Ø±Ù‰ Ø§Ù„Ù‚Ù…Ø­ÙŠØ©",
		adetect : "ÙƒØ§Ø´Ù Ø§Ù„Ù‡Ø¬Ù…Ø§Øª(ØºÙŠØ± Ù…Ø³ØªØ­Ø³Ù†)",
		adetecto : ['Ù…Ø¹Ø·Ù„','ØªØ¹Ù„ÙŠÙ‚ Ø¹Ù†Ø¯ Ù…Ø¹Ø¬Ø²Ø© Ø§Ù„Ø¹Ø§Ù„Ù…','ØªÙØ¹ÙŠÙ„'],
		adetecth : "ÙŠØ±Ø³Ù„ Ø·Ù„Ø¨Ø§Øª Ù…Ø®ÙÙŠØ© Ø§Ù„Ù‰ Ø§Ù„Ø³ÙŠØ±ÙØ±, ÙŠØªÙ… Ø§Ø®ØªØ±Ø§Ù‚ Ù‚ÙˆØ§Ù†ÙŠÙ† Ø§Ù„Ù„Ø¹Ø¨Ø©. ÙˆÙ‚Ø¯ ÙŠØªÙ… Ø§ÙŠÙ‚Ø§Ù Ø­Ø³Ø§Ø¨Ùƒ.",
		adetectt : "ÙØªØ±Ø© ÙƒØ§Ø´Ù Ø§Ù„Ù‡Ø¬ÙˆÙ…",
		buildhint : "Ù†ØµØ§Ø¦Ø­ Ø§Ù„Ø¨Ù†Ø§Ø¡",
		onallp : "Ø§Ù„Ø£Ø¯ÙˆØ§Øª Ø§Ù„ØªÙŠ ØªØ¹Ù…Ù„ Ø¹Ù„Ù‰ Ø¬Ù…ÙŠØ¹ Ø§Ù„ØµÙØ­Ø§Øª",
		dontwrap : "Ù„Ø§ØªÙ„Ù Ø§Ù„ØµÙØ­Ø©(Ù…Ø³ØªØ­Ø³Ù†)",
		dontwraph : 'Ø¥Ø°Ø§ ÙƒØ§Ù†Øª Ù‚Ø§Ø¦Ù…Ø© Ø§Ù„Ù‚Ø±Ù‰ Ø¨Ø§Ù„Ø£Ø³ÙÙ„',
		buildand : "Ø§Ø¸Ù‡Ø§Ø± ÙˆÙ‚Øª Ø§Ù„Ù…Ø¨Ø§Ù†ÙŠ ÙˆØ§Ù„Ù‡Ø¬Ù…Ø§Øª Ø¨Ø¬Ø§Ù†Ø¨ Ù‚Ø§Ø¦Ù…Ø© Ø§Ù„Ù‚Ø±Ù‰ ",
		buildandh : 'ÙÙŠ Ù‚Ø§Ø¦Ù…Ø© Ø§Ù„Ù‚Ø±Ù‰',
		sendres : "Ø£Ø¸Ù‡Ø§Ø± Ø§ÙŠÙ‚ÙˆÙ†Ø§Øª Ø§Ø±Ø³Ø§Ù„ Ù…ÙˆØ§Ø±Ø¯ ÙˆÙ‚ÙˆØ§Øª",
		sendmess : "Ø¹Ø±Ø¶ Ø§ÙŠÙ‚ÙˆÙ†Ø© Ø§Ø±Ø³Ø§Ù„ Ø±Ø³Ø§Ù„Ø© Ø¨Ø¬Ø§Ù†Ø¨ ÙƒÙ„ Ù„Ø§Ø¹Ø¨",
		analyzer : "Ù…Ø­Ù„Ù„ Ø§Ù„Ø³ÙŠØ±ÙØ±",
		bigicon : "Ø£Ø¸Ù‡Ø§Ø± Ù‚Ø§Ø¦Ù…Ø© Ø§Ù„Ù…Ø¨Ø§Ù†ÙŠ",
		addvtable : "Ø¹Ø±Ø¶ Ø¬Ø¯ÙˆÙ„ Ø§Ù„Ù‚Ø±Ù‰",
		addvtableo : ['Ù…Ø¹Ø·Ù„','ØªØ´ØºÙŠÙ„','ØªØ¹Ù„ÙŠÙ‚'],
		addvtableh : 'Ù„ØªØ±Ø§ÙÙŠØ§Ù† Ø§Ù„Ù†Ø³Ø®Ø©4 Ø§Ù„Ø¬Ø¯ÙŠØ¯Ù‡',
		opennote : "ÙØªØ­ Ø¯ÙØªØ± Ø§Ù„Ù…Ù„Ø§Ø­Ø¸Ø§Øª Ø¢Ù„ÙŠØ§Ù‹",
		notesize : "Ø­Ø¬Ù… Ø¯ÙØªØ± Ø§Ù„Ù…Ù„Ø§Ø­Ø¸Ø§Øª",
		openoview : "ÙØªØ­ Ù†Ø§ÙØ°Ù‡ Ù†Ø¸Ø±Ù‡ Ø¹Ø§Ù…Ù‡ Ø¥Ù„ÙŠØ§Ù‹",
		resbar : "Ø´Ø±ÙŠØ· Ø§Ù„Ù…ÙˆØ§Ø±Ø¯",
		showres : "Ø¹Ø±Ø¶ Ø´Ø±ÙŠØ· Ø§Ù„Ù…ÙˆØ§Ø±Ø¯ ÙÙŠ Ù†Ø§ÙØ°Ø© Ù…ØªØ­Ø±ÙƒØ©",
		redbl : "Ø§Ù„Ù„ÙˆÙ† Ø§Ù„Ø£Ø­Ù…Ø± (Ù„ÙƒÙ„ Ø³Ø§Ø¹Ø©)",
		yellowbl: "Ø§Ù„Ù„ÙˆÙ† Ø§Ù„Ø£ØµÙØ± (Ù„ÙƒÙ„ Ø³Ø§Ø¹Ø©)",
		marketpl : "Ø§Ù„Ø³ÙˆÙ‚",
		mfilter : "Ø§Ù„ÙÙ„ØªØ±",
		mfiltero : ['ØªØ´ØºÙŠÙ„','Ø¹Ø±Ø¶ Ø§Ù„Ù†Ø³Ø¨Ø©','Ø¹Ø±Ø¶ Ø§Ù„ÙÙ„ØªØ±','Ø¹Ø±Ø¶ Ø§Ù„ÙƒÙ„'],
		npcsum : "Ù…Ù„Ø®Øµ ØªØ§Ø¬Ø± Ø§Ù„Ù…Ø¨Ø§Ø¯Ù„Ø©",
		npcsumh : 'ÙÙŠ Ø§Ù„Ø³ÙˆÙ‚ ÙˆØ§Ù„Ù…Ø¨Ø§Ù†ÙŠ',
		bidinc : "Ø§Ù„Ù…Ø²Ø§ÙŠØ¯Ø© Ø§Ù„Ø­Ø§Ù„ÙŠØ©",
		bidinch : 'Ù„ØªØ±Ø§ÙÙŠØ§Ù† Ø§Ù„Ù†Ø³Ø®Ø©4',
		show3x : "Ù‚Ø¯ Ù„Ø§ÙŠØªÙ… Ø¹Ø±Ø¶ Ø§Ù„Ø¨ÙŠØ§Ù†Ø§Øª Ø¨Ø´ÙƒÙ„ ØµØ­ÙŠØ­",
		show3xh : 'Ù…Ø­Ø§ÙˆÙ„ Ø§Ù„ØªÙ†Ø¨Ø¤ Ø¹Ù†Ø¯ ÙˆØ¬ÙˆØ¯ ÙƒÙ…ÙŠØ© Ù…Ù† Ø§Ù„Ù…ÙˆØ§Ø±Ø¯ Ø¹Ù†Ø¯ Ø§Ø±Ø³Ø§Ù„ Ù…ÙˆØ§Ø±Ø¯ 3 Ù…Ø±Ø§Øª Ø£Ùˆ Ù…Ø±ØªÙŠÙ†',
		rpandmp : "Ù†Ù‚Ø·Ø© Ø§Ù„ØªØ¬Ù…Ø¹ Ùˆ Ø§Ù„Ø³ÙˆÙ‚",
		incomres : "Ø¹Ø±Ø¶ Ù…Ø¹Ù„ÙˆÙ…Ø§Øª Ø¹Ù† Ø§Ù„Ù…ÙˆØ§Ø±Ø¯ Ø§Ù„Ù‚Ø§Ø¯Ù…Ø©",
		incomreso : ['Ù…Ø¹Ø·Ù„','ØªØ´ØºÙŠÙ„','Ù…Ø¹ Ø§Ù„Ù…Ø­Ù„Ù„','Ù†Ù…Ø· Ù…Ø¹Ø¬Ø²Ø© Ø§Ù„Ø¹Ø§Ù„Ù…'],
		troopsI : "Ø§Ù„Ù…Ø¹Ù„ÙˆÙ…Ø§Øª Ø­ÙˆÙ„ Ø§Ù„Ù‚ÙˆØ§Øª",
		troopsIo : ['Ù…Ø¹Ø·Ù„','ØªØ´ØºÙŠÙ„','Ù…Ø³Ø§Ø¹Ø¯Ø© ÙÙŠ Ø§Ù„Ø¨Ø­Ø«'],
		defRP : "Ø§Ù„Ø£Ø¬Ø±Ø§Ø¡ Ø§Ù„Ø£ÙØªØ±Ø§Ø¶ÙŠ Ù„Ù†Ù‚Ø·Ø© Ø§Ù„ØªØ¬Ù…Ø¹",
		showls : "Ø¹Ø±Ø¶ Ø§Ù„Ø±ÙˆØ§Ø¨Ø·",
		showAsSN : "Ø£Ø³ØªØ¹Ù…Ù„ Ø§Ù„Ø£Ø³Ù… Ø§Ù„ØªØ§Ù„ÙŠ ÙƒÙ€ Ø§Ù„Ø£Ø³Ù… Ø§Ù„Ø§ÙØªØ±Ø§Ø¶ÙŠ",
		showlso : ['Ù…Ø¹Ø·Ù„','ØªØ´ØºÙŠÙ„','ØªØ´ØºÙŠÙ„ ÙÙŠ Ù†Ø§ÙØ°Ø©'],
		savedls : "Ø§Ù„Ø±ÙˆØ§Ø¨Ø· Ø§Ù„Ù…Ø­ÙÙˆØ¸Ø©",
		savedd : "Ø§Ù„Ø¨ÙŠØ§Ù†Ø§Øª Ø§Ù„Ù…Ø­ÙÙˆØ¸Ø©",
		saveddh : 'Ø¨Ù…Ø§ ÙÙŠ Ø°Ù„Ùƒ Ø§Ù„Ø±ÙˆØ§Ø¨Ø· ÙˆØ§Ù„Ø£Ø³Ù… Ø§Ù„ØªØ§Ù„ÙŠ. Ø¥Ø°Ø§ Ø­ÙØ°Ù Ø§Ù„Ø­Ø³Ø§Ø¨, Ø£Ùˆ Ù„ÙŠØ³ Ø§Ù„ÙƒÙ…Ø¨ÙŠÙˆØªØ± Ø§Ù„Ø®Ø§Øµ Ø¨Ùƒ.',
		savedelall : "Ù…Ø³Ø­ Ø¬Ù…ÙŠØ¹ Ø§Ù„Ø¨ÙŠØ§Ù†Ø§Øª Ø§Ù„Ù…Ø­ÙÙˆØ¸Ø©",
		savedelallh : 'Ù‡Ù„ Ø£Ù†Øª Ù…ØªØ£ÙƒØ¯ Ù…Ù† Ø­Ø°Ù Ø¬Ù…ÙŠØ¹ Ø§Ù„Ø¨ÙŠØ§Ù†Ø§Øª Ø§Ù„Ù…Ø­ÙÙˆØ¸Ø©, Ø¨Ù…Ø§ ÙÙŠ Ø°Ù„Ùƒ Ø§Ù„Ø±ÙˆØ§Ø¨Ø· ÙˆØ§Ù„Ø£Ø³Ù… Ø§Ù„ØªØ§Ù„ÙŠØŸ',
		scrlang : "Ù„ØºØ© Ø§Ù„Ø³ÙƒØ±Ø¨Øª",
		youlang : "Ù„ØºØªÙƒ",
		notifi : "Ø§Ù„Ø¥Ø¨Ù„Ø§Øº",
		notification : "Ø¥Ø¨Ù„Ø§ØºÙŠ Ø¹Ù†Ø¯ Ø£Ù†ØªÙ‡Ø§Ø¡ Ø§Ù„Ù…Ø¨Ù†Ù‰ Ù…Ù† Ø§Ù„Ø¨Ù†Ø§Ø¡",
		method : "Ø§Ù„Ø£Ø³Ù„ÙˆØ¨",
		audiourl : "Ø§Ù„Ø±Ø§Ø¨Ø· Ø§Ù„Ø®Ø§Øµ Ø¨Ø§Ù„ØµÙˆØª",
	...
	fr: { // French translation , thx azukae09
		...
		notes : "notes",
		res90 : "Ressources Ã  % de la capacitÃ©",
		refresh : "rafraichir",
		warehouse : "EntrepÃ´t",
		...
		buildand : "Montrer le compte Ã  rebours pour les constructions et les attaques",
		buildandh : 'Dans la liste des villages',
		sendres : "Afficher les icÃ´nes &laquo;envoyer ressources/troupes&raquo;",
		sendmess : "Afficher les icÃ´nes &laquo;envoyer message&raquo;",
		analyzer : "Outils et statistiques",
		bigicon : "Afficher de GRANDES icÃ´nes",
		opennote : "Ouvrir automatiquement les notes",
		resbar : "Barre des ressources",
		showres : "Montrer la barre des ressources dans une fenÃªtre",
		redbl : "Rouge (en heures)",
		yellowbl: "Jaune (en heures)",
		marketpl : "Place du marchÃ©",
		mfilter : "Filtre",
		mfiltero : ['aucun','que le taux','que les filtres','tout'],
		rpandmp : "Place du rassemblement et place du marchÃ©",
		incomres : "Info sur les ressources arrivant",
		incomreso : ['Non','Oui','Avec rÃ©sumÃ©','WW mode'],
		showls : "Afficher les liens",
		showlso : ['Non','Oui','Dans une fenÃªtre'],
		...
		builtin : "Outils integrÃ©s",
		builtinh : 'Pour normaliser la production; rouge ressource la plus demandÃ©e, vert, ressource la moins necessaire',
		normalize : 'Normalisation de la production',
		normal : "Normal",
		banalyze : "Analiseur intÃ©grÃ© de bataille",
		cropfind : "Recherche intÃ©grÃ©e de champs",
		adetect : "Detection des attaques",
		adetecto : ['off','sans freeze','on'],
		adetecth : "Fait des requetes masquÃ©es au serveur, ce qui viole les rÃ¨gles et peut ocasionner une sanction",
		adetectt : "PÃ©riode de dÃ©tection des attaques",
		addvtable : "afficher le tableau additionnel des villages",
		addvtableh : 'pour travian4',
		npcsum : "RÃ©sumÃ© pour le marchand pnj",
		npcsumh : 'Dans les marchÃ©s et batiments',
		bidinc : "IncrÃ©ment d'enchÃ¨re",
		bidinch : 'Pour les enchÃ¨res dans travian4',
		savedelallh : 'Etes vous sur d\'effacer les donnÃ©es sauvegardÃ©es (y compris les liens et le second nom)',
		notification : "Notification aprÃ¨s construction",
		method : "MÃ©thode",
	...
	hr: { // Croatian translation, thx semiRocket
		...
		cranny : "Å½uta razina Å¾itnice (postotak)",
		crannyh : 'Normalno 80, 70 za klasiÄne pljaÄke ili artefakt',
		builtin : "UgraÄ‘eni alati",
		builtinh : 'Normalizacija produkcije: crveno najviÅ¡e potrebni, a zeleno manje potrebni resursi',
		normalize : 'Normalizacija produkcije',
		normal : "Normalno",
		banalyze : "UgraÄ‘eni analizator bitke",
		cropfind : "UgraÄ‘ena traÅ¾ilica Å¾itnih (crop) polja",
		adetect : "Detektiranje napada",
		adetecto : ['IskljuÄeno','Bez zamrzavanja','UkljuÄeno'],
		adetecth : "Radi skrivene zahtjeve prema posluÅ¾itelju krÅ¡eÄ‡i pravila. MoÅ¾e dovesti do kazni.",
		adetectt : "Razdoblje detektiranja napada",
		onallp : "Sve stranice",
		dontwrap : "OnemoguÄ‡i prijelom stranica",
		dontwraph : 'Korisno ako se lista naselja razlomi u dva reda',
		buildand : "PrikaÅ¾i odbrojavanje izgradnje i napada",
		buildandh : 'Prikaz u listi naselja',
		sendres : "PrikaÅ¾i ikonice Â«Å¡alji resurse/vojskaÂ»",
		sendmess : "PrikaÅ¾i ikonicu Â«Å¡alji porukuÂ»",
		analyzer : "Analizator svijeta",
		bigicon : "PrikaÅ¾i VELIKE ikone",
		addvtable : "PrikaÅ¾i dodatnu tablicu naselja",
		addvtableh : '(Travian 4)',
		opennote : "Automatski otvori zabiljeÅ¡ke",
		resbar : "Grafikon resursa",
		showres : "PrikaÅ¾i grafikon u zasebnom prozoru",
		redbl : "Crveno (u satima)",
		yellowbl: "Å½uto (u satima)",
		marketpl : "TrÅ¾nica",
		mfilter : "Filter",
		mfiltero : ['IskljuÄeno','Samo omjer','Samo filter','Potpuno'],
		npcsum : "SaÅ¾etak za NPC",
		npcsumh : 'Prikaz u trÅ¾nici i zgradama',
		bidinc : "PoveÄ‡anje ponude",
		bidinch : 'Koristi se za aukcije (Travian 4)',
		rpandmp : "OkupljaliÅ¡te i TrÅ¾nica",
		incomres : "Informacije o dolazeÄ‡im resursima",
		incomreso : ['IskljuÄeno','UkljuÄeno','S kratkim pregledom','WW mod'],
		troopsI : "Informacije o trupama",
		troopsIo : ['IskljuÄeno','UkljuÄeno','Skeniraj upute'],
		defRP : "Predpostavljena akcija za okupljaliÅ¡te",
		showls : "PrikaÅ¾i poveznice",
		showlso : ['IskljuÄeno','UkljuÄeno','U zasebnom prozoru'],
		savedls : "Spremljene poveznice",
		savedd : "Pohranjeni podaci",
		saveddh : 'UkljuÄuje linkove i druge nazive naselja. Korisno ako se raÄun briÅ¡e ili ne koristi na VaÅ¡em raÄunalu.',
		savedelall : "IzbriÅ¡i sve pohranjene podatke",
		savedelallh : 'Jeste li sigurni da Å¾elite izbrisati sve pohranjene podatke, ukljuÄujuÄ‡i linkove i druge nazive naselja?',
	...
	//traduzido por Yabadabaduca - server ptx5
		...
		racelist : ['Romanos','TeutÃµes','Gauleses'],
		onallp : "Todas as pÃ¡ginas",
		dontwrap : "NÃ£o rolar pÃ¡ginas (lento)",
		dontwraph : 'Se a lista das aldeias pular para baixo',
		buildand : "Mostrar construÃ§Ã£o em contagem regressiva e atacar",
		buildandh : 'Na lista das aldeias',
		sendres : "Mostrar &laquo;Enviar reforÃ§os/tropas&raquo; icons",
		sendmess : "Mostrar &laquo;Enviar mensagem&raquo; icons",
		analyzer : "World analyzer",
		bigicon : "Mostrar Ã­cones grandes",
		...
		marketpl : "Mercado",
		mfilter : "filtro",
		mfiltero : ['desligado','taxa Ãºnica','somente filtro','cheio'],
		rpandmp : "Ponto de encontro e Mercado",
		incomres : "informaÃ§Ãµes de recursos recebidos",
		incomreso : ['desligado','ligado','com sumÃ¡rio','WW mode'],
	...
	bg: { // Bulgarian language, thx Mitko
		...
		svers : "Ð’ÐµÑ€ÑÐ¸Ñ Ð½Ð° Ð¡ÐºÑ€Ð¸Ð¿Ð°",
		settings : "ÐžÐ¿Ñ†Ð¸Ð¸",
		notes : "Ð‘ÐµÐ»ÐµÐ¶ÐºÐ¸",
		res90 : "Ñ€ÐµÑÑƒÑ€ÑÐ¸ Ð½Ð° % Ð¿ÑŠÐ»Ð½Ð¸",
		refresh : "Ð ÐµÑ„Ñ€ÐµÑˆ",
		warehouse : "Ð¡ÐºÐ»Ð°Ð´",
		resources : "Ð ÐµÑÑƒÑ€ÑÐ¸",
		troops : "Ð’Ð¾Ð¹Ð½Ð¸Ñ†Ð¸",
		links : "Ð’Ñ€ÑŠÐ·ÐºÐ¸",
		linkname : "Ð˜Ð¼Ðµ Ð½Ð° Ð²Ñ€ÑŠÐ·ÐºÐ°Ñ‚Ð°",
		linkdel : "Ð˜Ð·Ñ‚Ñ€Ð¸Ð¹ Ð²Ñ€ÑŠÐ·ÐºÐ°Ñ‚Ð°",
		name2 : "Ð²Ñ‚Ð¾Ñ€Ð¾ Ð¸Ð¼Ðµ",
		archive : "ÐÑ€Ñ…Ð¸Ð²",
		arena : "ÐÑ€ÐµÐ½Ð°",
		addcur : "Ð”Ð¾Ð±Ð°Ð²Ð¸ ÐºÐ¾Ñ€Ð´Ð¸Ð½Ð°Ñ‚Ð¸",
		del : "Ð˜Ð·Ñ‚Ñ€Ð¸Ð¹",
		edit : "Ñ€ÐµÐ´Ð°ÐºÑ‚Ð¸Ñ€Ð°Ð¹",
		total : "ÐžÐ±Ñ‰Ð¾",
		noplace : "ÐÑÐ¼Ð° Ð¼ÑÑÑ‚Ð¾!",
		hunger : "Ð“Ð»Ð°Ð´",
		duration : "Ð¿Ñ€Ð¾Ð´ÑŠÐ»Ð¶Ð¸Ñ‚ÐµÐ»Ð½Ð¾ÑÑ‚",
		deficit : "Ð´ÐµÑ„Ð¸Ñ†Ð¸Ñ‚",
		// settings
		none : 'ÐÐ¸ÐºÐ¾Ð¹',
		info : "Ð˜Ð½Ñ„Ð¾Ñ€Ð¼Ð°Ñ†Ð¸Ñ",
		yourrace : "Ð¢Ð²Ð¾ÑÑ‚Ð° Ñ€Ð°ÑÐ°",
		speedart : "Ð¡ÐºÐ¾Ñ€Ð¾ÑÑ‚ Ð½Ð° Ð°Ñ€Ñ‚ÐµÑ„Ð°ÐºÑ‚Ð°",
		racelist : ['Ð Ð¸Ð¼Ð»ÑÐ½Ð¸','Ð¢ÐµÐ²Ñ‚Ð¾Ð½Ñ†Ð¸','Ð“Ð°Ð»Ð¸'],
		onallp : "Ð’ÑÐ¸Ñ‡ÐºÐ¸ ÑÑ‚Ñ€Ð°Ð½Ð¸Ñ†Ð¸",
		dontwrap : "ÐÐµ ÑÐ¼ÐµÐ½ÑÐ¹ ÑÑ‚Ñ€Ð°Ð½Ð¸Ñ†Ð¸",
		dontwraph : 'Ð¡Ð¿Ð¸ÑÑŠÐºÐ° Ð½Ð° ÑÐµÐ»Ð°Ñ‚Ð° ÑÐºÐ°Ñ‡Ð° Ð´Ð¾Ð»Ñƒ',
		buildand : "ÐŸÐ¾ÐºÐ°Ð¶Ð¸ Ð¾Ñ‚Ð±Ñ€Ð¾ÑÐ²Ð°Ð½Ðµ Ð·Ð° ÑÐ³Ñ€Ð°Ð´Ð¸ Ð¸ Ð°Ñ‚Ð°ÐºÐ¸",
		buildandh : 'Ð’ÑŠÐ² ÑÐ¿Ð¸ÑÑŠÐºÐ° Ð½Ð° ÑÐµÐ»Ð°Ñ‚Ð° ',
		sendres : "Ð’Ð¸Ð¶ &laquo;Ð¸Ð·Ð¿Ñ€Ð°Ñ‚Ð¸ Ñ€ÐµÑÑƒÑ€Ñ / Ð²Ð¾Ð¹ÑÐºÐ°&raquo;",
		sendmess : "Ð’Ð¸Ð¶ &laquo;Ð¸Ð·Ð¿Ñ€Ð°Ñ‚Ð¸ ÑÑŠÐ¾Ð±Ñ‰ÐµÐ½Ð¸Ðµ&raquo;",
		analyzer : "Ð¡Ð²ÐµÑ‚Ð¾Ð²Ð½Ð°Ñ‚Ð° Ð°Ð½Ð°Ð»Ð¸Ð·Ð°Ñ‚Ð¾Ñ€",
		bigicon : "ÐŸÐ¾ÐºÐ°Ð¶Ð¸ Ð³Ð¾Ð»ÐµÐ¼Ð¸ Ð¸ÐºÐ¾Ð½Ð¸",
		opennote : "ÐÐ²Ñ‚Ð¾Ð¼Ð°Ñ‚Ð¸Ñ‡Ð½Ð¾ Ð¾Ñ‚Ð²Ð°Ñ€ÑÐ½Ðµ Ð½Ð° Ð±ÐµÐ»ÐµÐ¶ÐºÐ¸",
		resbar : "Ð ÐµÑÑƒÑ€ÑÐµÐ½ Ð±Ð°Ñ€",
		showres : "ÐŸÐ¾ÐºÐ°Ð¶Ð¸ Ñ€ÐµÑÑƒÑ€ÑÐ½Ð¸Ñ Ð±Ð°Ñ€ Ð² Ð¿Ñ€Ð¾Ð·Ð¾Ñ€ÐµÑ†",
		redbl : "Ñ‡ÐµÑ€Ð²ÐµÐ½Ð¾ (Ð²ÑŠÐ² Ñ‡Ð°ÑÐ¾Ð²Ðµ)",
		yellowbl: "Ð¶ÑŠÐ»Ñ‚ (Ð²ÑŠÐ² Ñ‡Ð°ÑÐ¾Ð²Ðµ)",
		marketpl : "ÐŸÐ°Ð·Ð°Ñ€",
		mfilter : "Ð¤Ð¸Ð»Ñ‚ÐµÑ€Ð¸",
		mfiltero : ["Ð¸Ð·ÐºÐ»ÑŽÑ‡ÐµÐ½Ð¾", "ÑÐ°Ð¼Ð¾ ÐºÑƒÑ€Ñ", "ÑÐ°Ð¼Ð¾ Ñ„Ð¸Ð»Ñ‚ÑŠÑ€", "Ð¿ÑŠÐ»Ð½Ð¾"],
		rpandmp : "Ð¡Ð±Ð¾Ñ€ÐµÐ½ Ð¿ÑƒÐ½Ðº Ð¸ ÐŸÐ°Ð·Ð°Ñ€",
		incomres : "Ð²Ñ…Ð¾Ð´ÑÑ‰Ð¸ Ñ€ÐµÑÑƒÑ€ÑÐ¸ Ð¸Ð½Ñ„Ð¾Ñ€Ð¼Ð°Ñ†Ð¸Ñ",
		incomreso : ["Ð¸Ð·ÐºÐ»ÑŽÑ‡ÐµÐ½Ð¾", "Ð²ÐºÐ»ÑŽÑ‡ÐµÐ½Ð¾ ","Ð¾Ð±Ð¾Ð±Ñ‰ÐµÐ½Ð°", "WW Ñ€ÐµÐ¶Ð¸Ð¼"],
		troopsI : "Ð˜Ð½Ñ„Ð¾Ñ€Ð¼Ð°Ñ†Ð¸Ñ Ð·Ð° Ð²Ð¾Ð¹Ð½Ð¸Ñ†Ð¸",
		troopsIo : ["Ð¸Ð·ÐºÐ»ÑŽÑ‡ÐµÐ½Ð¾", "Ð²ÐºÐ»ÑŽÑ‡ÐµÐ½Ð¾ ","ÑÐºÐ°Ð½Ð¸Ñ€Ð°Ð½Ðµ Ð¿Ð¾Ð¼Ð¾Ñ‰"],
		showls : "ÐŸÐ¾ÐºÐ°Ð¶Ð¸ Ð²Ñ€ÑŠÐ·ÐºÐ¸",
		showlso : ["Ð¸Ð·ÐºÐ»ÑŽÑ‡ÐµÐ½Ð¾", "Ð²ÐºÐ»ÑŽÑ‡ÐµÐ½Ð¾ ","Ð² Ð¿Ñ€Ð¾Ð·Ð¾Ñ€ÐµÑ†Ð°"],
		savedls : "Ð·Ð°Ð¿Ð°Ð·ÐµÐ½Ð¸ Ð²Ñ€ÑŠÐ·ÐºÐ¸",
		scrlang : "Ð•Ð·Ð¸Ðº Ð½Ð° ÑÐºÑ€Ð¸Ð¿Ñ‚Ð°",
		youlang : "Ð¢Ð²Ð¾ÑÑ‚ ÐµÐ·Ð¸Ðº",
		notification : "ÑƒÐ²ÐµÐ´Ð¾Ð¼Ð»ÐµÐ½Ð¸Ðµ ÑÐ»ÐµÐ´ ÑÑ‚Ñ€Ð¾Ð¸Ñ‚ÐµÐ»ÑÑ‚Ð²Ð¾",
		method : "Ð¼ÐµÑ‚Ð¾Ð´",
		audiourl : "URL Ð½Ð° Ð°ÑƒÐ´Ð¸Ð¾ Ñ„Ð°Ð¹Ð»",
		audiotest : "Ð¢ÐµÑÑ‚"
	},
	...
	sr: { // Serbian language, thx jokusaet
		...
		close : "Ð—Ð°Ñ‚Ð²Ð¾Ñ€Ð¸",
		overview : "ÐŸÑ€ÐµÐ³Ð»ÐµÐ´",
		svers : "Ð’ÐµÑ€Ð·Ð¸Ñ˜Ð° ÑÐºÑ€Ð¸Ð¿Ñ‚Ðµ",
		settings : "ÐŸÐ¾Ð´ÐµÑˆÐ°Ð²Ð°ÑšÐ°",
		notes : "Ð‘ÐµÐ»ÐµÑˆÐºÐµ",
		res90 : "Ð ÐµÑÑƒÑ€ÑÐ¸ Ð´Ð¾ % Ð¿Ð¾Ð¿ÑƒÑšÐµÐ½Ð¾ÑÑ‚Ð¸",
		refresh : "ÐžÑÐ²ÐµÐ¶Ð¸",
		warehouse : "Ð¡ÐºÐ»Ð°Ð´Ð¸ÑˆÑ‚Ðµ",
		resources : "Ð ÐµÑÑƒÑ€ÑÐ¸",
		troops : "ÐˆÐµÐ´Ð¸Ð½Ð¸Ñ†Ðµ",
		links : "Ð›Ð¸Ð½ÐºÐ¾Ð²Ð¸",
		linkname : "Ð˜Ð¼Ðµ Ð»Ð¸Ð½ÐºÐ°",
		linkdel : "ÐžÐ±Ñ€Ð¸ÑˆÐ¸ Ð»Ð¸Ð½Ðº",
		name2 : "Ð”Ñ€ÑƒÐ³Ð¾ Ð¸Ð¼Ðµ",
		archive : "ÐÑ€Ñ…Ð¸Ð²Ð°",
		arena : "Ð’Ð¸Ñ‚ÐµÑˆÐºÐ° Ð°Ñ€ÐµÐ½Ð°",
		addcur : "Ð”Ð¾Ð´Ð°Ñ˜ Ñ‚Ñ€ÐµÐ½ÑƒÑ‚Ð½Ñƒ ÑÑ‚Ñ€Ð°Ð½Ñƒ",
		del : "ÐžÐ±Ñ€Ð¸ÑˆÐ¸",
		edit : "Ð˜Ð·Ð¼ÐµÐ½Ð¸",
		total : "Ð£ÐºÑƒÐ¿Ð½Ð¾",
		noplace : "ÐÐµÐ¼Ð° Ð´Ð¾Ð²Ð¾Ñ™Ð½Ð¾ Ð¼ÐµÑÑ‚Ð°!",
		hunger : "Ð“Ð»Ð°Ð´",
		duration : "Ð¢Ñ€Ð°Ñ˜Ð°ÑšÐµ",
		deficit : "Ð”ÐµÑ„Ð¸Ñ†Ð¸Ñ‚",
		// settings
		none : "ÐÐ¸ÑˆÑ‚Ð°",
		auto : "ÐÑƒÑ‚Ð¾",
		info : "Ð˜Ð½Ñ„Ð¾",
		yourrace : "Ð¢Ð²Ð¾Ñ˜Ð° Ñ€Ð°ÑÐ°",
		speedart : "ÐÑ€Ñ‚ÐµÑ„Ð°ÐºÑ‚ Ð±Ñ€Ð·Ð¸Ñ…",
		racelist : ['Ð Ð¸Ð¼Ñ™Ð°Ð½Ð¸','Ð¢ÐµÐ²Ñ‚Ð¾Ð½Ñ†Ð¸','Ð“Ð°Ð»Ð¸'],
		cranny : "Ð–ÑƒÑ‚Ð¸ Ð½Ð¸Ð²Ð¾ ÑÐ¸Ð»Ð¾ÑÐ° (Ð¿Ñ€Ð¾Ñ†ÐµÐ½Ð°Ñ‚)",
		crannyh : 'Ð½Ð¾Ñ€Ð¼Ð°Ð»Ð½Ð¾ 80, 70 Ñ•Ð° ÐºÐ»Ð°ÑÐ¸Ñ‡Ð½Ð¾ Ð¸ Ð°Ñ€Ñ‚ÐµÑ„Ð°ÐºÑ‚',
		builtin : "Ð£Ð³Ñ€Ð°Ñ’ÐµÐ½Ð¸ Ð°Ð»Ð°Ñ‚Ð¸",
		builtinh : 'Ð·Ð° Ð½Ð¾Ñ€Ð¼Ð°Ð»Ð¸Ð·Ð°Ñ†Ð¸Ñ˜Ñƒ Ð¿Ñ€Ð¾Ð¸Ð·Ð²Ð¾Ð´ÑšÐµ: Ñ†Ñ€Ð²ÐµÐ½Ð° Ð±Ð¾Ñ˜Ð° - Ð½Ð°Ñ˜Ð¿Ð¾Ñ‚Ñ€ÐµÐ±Ð½Ð¸Ñ˜Ð¸ Ñ€ÐµÑÑƒÑ€ÑÐ¸, Ð·ÐµÐ»ÐµÐ½Ð° - Ð¼Ð°ÑšÐµ Ð¿Ð¾Ñ‚Ñ€ÐµÐ±Ð½Ð¸ Ñ€ÐµÑÑƒÑ€ÑÐ¸',
		normalize : 'Ð½Ð¾Ñ€Ð¼Ð°Ð»Ð¸Ð·Ð°Ñ†Ð¸Ñ˜Ð° Ð¿Ñ€Ð¾Ð¸Ð·Ð²Ð¾Ð´ÑšÐµ',
		normal : "Ð½Ð¾Ñ€Ð¼Ð°Ð»Ð½Ð¾",
		banalyze : "ÑƒÐ³Ñ€Ð°Ñ’ÐµÐ½ Ð°Ð½Ð°Ð»Ð¸Ð·Ð°Ñ‚Ð¾Ñ€ Ð±Ð¸Ñ‚ÐºÐµ",
		cropfind : "ÑƒÐ³Ñ€Ð°Ñ’ÐµÐ½Ð¸ Ð¿Ñ€ÐµÑ‚Ñ€Ð°Ð¶Ð¸Ð²Ð°Ñ‡ Ð¶Ð¸Ñ‚Ð½Ð¸Ñ†Ð°",
		onallp : "ÑÐ²Ðµ ÑÑ‚Ñ€Ð°Ð½Ðµ",
		dontwrap : "Ð½Ðµ ÑƒÐ¼Ð¾Ñ‚Ð°Ð²Ð°Ñ˜ ÑÑ‚Ñ€Ð°Ð½Ðµ",
		dontwraph : 'Ð°ÐºÐ¾ Ñ˜Ðµ Ð»Ð¸ÑÑ‚Ð° ÑÐµÐ»Ð°, ÑÐºÐ¾Ñ‡Ð¸ Ð´Ð¾Ð»Ðµ',
		buildand : "Ð¿Ð¾ÐºÐ°Ð¶Ð¸ Ð¾Ð´Ð±Ñ€Ð¾Ñ˜Ð°Ð²Ð°ÑšÐµ Ð³Ñ€Ð°Ñ’ÐµÐ²Ð¸Ð½Ð° Ð¸ Ð½Ð°Ð¿Ð°Ð´",
		buildandh : 'Ð£ Ð»Ð¸ÑÑ‚Ð¸ ÑÐµÐ»Ð°',
		sendres : "ÐŸÑ€Ð¸ÐºÐ°Ð¶Ð¸ &laquo;Ð¿Ð¾ÑˆÐ°Ñ™Ð¸ Ñ€ÐµÑÑƒÑ€ÑÐµ/Ñ˜ÐµÐ´Ð¸Ð½Ð¸Ñ†Ðµ&raquo; Ð¸ÐºÐ¾Ð½Ðµ",
		sendmess : "ÐŸÑ€Ð¸ÐºÐ°Ð¶Ð¸ &laquo;Ð¿Ð¾ÑˆÐ°Ñ™Ð¸ Ð¿Ð¾Ñ€ÑƒÐºÑƒ&raquo; Ð¸ÐºÐ¾Ð½Ðµ",
		analyzer : "World analyzer",
		bigicon : "ÐŸÑ€Ð¸ÐºÐ°Ð¶Ð¸ Ð’Ð•Ð›Ð˜ÐšÐ• Ð¸ÐºÐ¾Ð½Ðµ",
		addvtable : "ÐŸÑ€Ð¸ÐºÐ°Ð¶Ð¸ Ð´Ð¾Ð´Ð°Ñ‚Ð½Ñƒ Ñ‚Ð°Ð±ÐµÐ»Ñƒ ÑÐ° Ð»Ð¸ÑÑ‚Ð¾Ð¼ ÑÐµÐ»Ð°",
		addvtableh : 'Ð·Ð° Ð¢4',
		opennote : "ÐÑƒÑ‚Ð¾Ð¼Ð°Ñ‚ÑÐºÐ¸ Ð¾Ñ‚Ð²Ð¾Ñ€Ð¸ Ð±ÐµÐ»ÐµÑˆÐºÐµ",
		resbar : "Ð¢Ð°Ð±ÐµÐ»Ð° ÑÐ° Ñ€ÐµÑÑƒÑ€ÑÐ¸Ð¼Ð°",
		showres : "ÐŸÑ€Ð¸ÐºÐ°Ð¶Ð¸ Ñ‚Ð°Ð±ÐµÐ»Ñƒ ÑÐ° Ñ€ÐµÑÑƒÑ€ÑÐ¸Ð¼Ð° Ñƒ Ð¿Ñ€Ð¾Ð·Ð¾Ñ€Ñƒ",
		redbl : "Ñ†Ñ€Ð²ÐµÐ½Ð¾ (Ñƒ ÑÐ°Ñ‚Ð¸Ð¼Ð°)",
		yellowbl: "Ð¶ÑƒÑ‚Ð¾ (Ñƒ ÑÐ°Ñ‚Ð¸Ð¼Ð°)",
		marketpl : "ÐŸÐ¸Ñ˜Ð°Ñ†Ð°",
		mfilter : "Ñ„Ð¸Ð»Ñ‚ÐµÑ€",
		mfiltero : ['Ð¸ÑÐºÑ™ÑƒÑ‡ÐµÐ½','ÑÐ°Ð¼Ð¾ Ð¾Ð´Ð½Ð¾Ñ','ÑÐ°Ð¼Ð¾ Ñ„Ð¸Ð»Ñ‚ÐµÑ€','Ð¿ÑƒÐ½Ð¾'],
		npcsum : "ÑÑƒÐ¼Ð° Ð·Ð° ÐÐŸÐ¦",
		npcsumh : 'Ñƒ Ð¿Ð¸Ñ˜Ð°Ñ†Ð¸ Ð¸ Ð·Ð³Ñ€Ð°Ð´Ð°Ð¼Ð°',
		bidinc : "Ð¿Ð¾Ð²ÐµÑ›Ð°ÑšÐµ Ð¿Ð¾Ð½ÑƒÐ´Ðµ Ð½Ð° Ð±ÐµÑ€Ð·Ð¸",
		bidinch : 'Ð·Ð° Ð°ÑƒÐºÑ†Ð¸Ñ˜Ðµ Ð½Ð° Ð¢4',
		rpandmp : "ÐœÐµÑÑ‚Ð¾ Ð¾ÐºÑƒÐ¿Ñ™Ð°ÑšÐ° Ð¸ ÐŸÐ¸Ñ˜Ð°Ñ†Ð°",
		incomres : "Ð¸Ð½Ñ„Ð¾ Ð¾ Ð´Ð¾Ð»Ð°Ð·ÐµÑ›Ð¸Ð¼ Ñ€ÐµÑÑƒÑ€ÑÐ¸Ð¼Ð°",
		incomreso : ['Ð¸ÑÐºÑ™ÑƒÑ‡ÐµÐ½','ÑƒÐºÑ™ÑƒÑ‡ÐµÐ½','ÑÐ° ÑÑƒÐ¼Ð¾Ð¼','WW Ð¼Ð¾Ð´'],
		troopsI : "Ð˜Ð½Ñ„Ð¾Ñ€Ð¼Ð°Ñ†Ð¸Ñ˜Ðµ Ð¾ Ñ˜ÐµÐ´Ð¸Ð½Ð¸Ñ†Ð°Ð¼Ð°",
		troopsIo : ['Ð¸ÑÐºÑ™ÑƒÑ‡ÐµÐ½Ð¾','ÑƒÐºÑ™ÑƒÑ‡ÐµÐ½Ð¾','Ð¿Ð¾Ð¼Ð¾Ñ› Ð¿Ñ€Ð¸ ÑÐºÐµÐ½Ð¸Ñ€Ð°ÑšÑƒ'],
		defRP : "Ð¿Ð¾Ð´Ñ€Ð°Ð·ÑƒÐ¼ÐµÐ²Ð°Ð½Ð° Ð°ÐºÑ†Ð¸Ñ˜Ð° Ñƒ Ð¼ÐµÑÑ‚Ñƒ Ð¾ÐºÑƒÐ¿Ñ™Ð°ÑšÐ°",
		showls : "ÐŸÑ€Ð¸ÐºÐ°Ð¶Ð¸ Ð»Ð¸Ð½ÐºÐ¾Ð²Ðµ",
		showlso : ['Ð¸ÑÐºÑ™ÑƒÑ‡ÐµÐ½Ð¾','ÑƒÐºÑ™ÑƒÑ‡ÐµÐ½Ð¾','Ñƒ Ð¿Ñ€Ð¾Ð·Ð¾Ñ€Ñƒ'],
		savedls : "ÑÐ°Ñ‡ÑƒÐ²Ð°Ð½Ð¸ Ð»Ð¸Ð½ÐºÐ¾Ð²Ð¸",
		savedd : "ÑÐ°Ñ‡ÑƒÐ²Ð°Ð½Ð¸ Ð¿Ð¾Ð´Ð°Ñ†Ð¸",
		saveddh : 'ÑƒÐºÑ™ÑƒÑ‡ÑƒÑ˜ÑƒÑ›Ð¸ Ð»Ð¸Ð½ÐºÐ¾Ð²Ðµ Ð¸ Ð´Ñ€ÑƒÐ³Ð¾ Ð¸Ð¼Ðµ. Ð£ÐºÐ¾Ð»Ð¸ÐºÐ¾ Ñ˜Ðµ Ð½Ð°Ð»Ð¾Ð³ Ð¾Ð±Ñ€Ð¸ÑÐ°Ð½, Ð¸Ð»Ð¸ Ð½Ð¸Ñ˜Ðµ Ñ‚Ð²Ð¾Ñ˜ ÐºÐ¾Ð¼Ð¿Ñ˜ÑƒÑ‚ÐµÑ€.',
		savedelall : "Ð¾Ð±Ñ€Ð¸ÑˆÐ¸ ÑÐ²Ðµ ÑÐ°Ñ‡ÑƒÐ²Ð°Ð½Ðµ Ð¿Ð¾Ð´Ð°Ñ‚ÐºÐµ",
		savedelallh : 'Ð”Ð° Ð»Ð¸ ÑÐ¸ ÑÐ¸Ð³ÑƒÑ€Ð°Ð½ Ð´Ð° Ð¶ÐµÐ»Ð¸Ñˆ Ð´Ð° Ð¾Ð±Ñ€Ð¸ÑˆÐµÑˆ ÑÐ²Ðµ ÑÐ°Ñ‡ÑƒÐ²Ð°Ð½Ðµ Ð¿Ð¾Ð´Ð°Ñ‚ÐºÐµ, ÑƒÐºÑ™ÑƒÑ‡ÑƒÑ˜ÑƒÑ›Ð¸ Ð¸ Ð»Ð¸Ð½ÐºÐ¾Ð²Ðµ Ð¸ Ð´Ñ€ÑƒÐ³Ð¾ Ð¸Ð¼Ðµ?',
		scrlang : "ÐˆÐµÐ·Ð¸Ðº ÑÐºÑ€Ð¸Ñ‚Ðµ",
		youlang : "Ñ‚Ð²Ð¾Ñ˜ Ñ˜ÐµÐ·Ð¸Ðº",
		notifi : "Ð½Ð¾Ñ‚Ð¸Ñ„Ð¸ÐºÐ°Ñ†Ð¸Ñ˜Ð°",
		notification : "Ð½Ð¾Ñ‚Ð¸Ñ„Ð¸ÐºÐ°Ñ†Ð¸Ñ˜Ð° Ð·Ð° Ð¸Ð·Ð³Ñ€Ð°Ð´ÑšÑƒ",
		method : "Ð¼ÐµÑ‚Ð¾Ð´Ð°",
		audiourl : "Ð£Ð Ð› Ð°ÑƒÐ´Ð¸Ð¾ Ñ„Ð°Ñ˜Ð»Ð°",
		audiotest : "Ñ‚ÐµÑÑ‚Ð¸Ñ€Ð°Ñ˜ Ð°ÑƒÐ´Ð¸Ð¾"
	},
	pl: { // Polish translation, thx aren
		...
		settings : "ustawienia",
		notes : "notatki",
		res90 : "Å›rodkÃ³w na % napeÅ‚niania",
		refresh : "odÅ›wieÅ¼",
		warehouse : "Magazyn",
		resources : "Surowce",
		troops : "Jednostki",
		...
		info : "Informacja",
		yourrace : "Twoja rasa",
		speedart : "PrÄ™dkoÅ›Ä‡ artefaktu",
		racelist : ['Rzymianie','Germanie','Galowie'],
		cranny : "Å¼Ã³Å‚ty poziom kryjÃ³wki (procent)",
		crannyh : 'normalny 80, 70 do grabieÅ¼y na klasycznym lub artefakcie',
		builtin : "Wbudowane narzÄ™dzia",
		builtinh : 'dla normalizacji produkcji: kolor czerwony - najwiÄ™cej Å›rodkÃ³w potrzeba, zielony - potrzeba mniej zasobÃ³w',
		normalize : 'normalizacja produkcji',
		normal : "normalny",
		banalyze : "Wbudowany analizator bitwy",
		cropfind : "Wbudowany poszukiwacz cropÃ³w",
		onallp : "Wszystkie strony",
		dontwrap : "Nie zawijaj stron",
		dontwraph : 'JeÅ¼eli lista osad przeskocz w dÃ³l',
		buildand : "Pokaz odliczanie budynku i ataku",
		buildandh : 'Na liÅ›cie osad',
		sendres : "Pokaz &laquo;wyÅ›lij surowce/jednostki&raquo; ikony",
		sendmess : "Pokaz &laquo;wyÅ›lij wiadomoÅ›Ä‡&raquo; ikony",
		analyzer : "World analyzer",
		bigicon : "Pokaz DUÅ»E ikony",
		addvtable : "Pokaz dodatkowa tablice osad",
		addvtableh : 'dla travian4',
		opennote : "Automatycznie otwÃ³rz notatnik",
		resbar : "Tabela surowcÃ³w",
		showres : "Pokaz tabele surowcÃ³w w oknie",
		redbl : "czerwony (w godzinach)",
		yellowbl: "Å¼Ã³Å‚ty (w godzinach)",
		marketpl : "Rynek",
		mfilter : "filter",
		...
		rpandmp : "Miejsce zbiÃ³rki i Rynek",
		incomres : "informacja o przychodzÄ…cych surowcach",
		incomreso : ['off','on','z podsumowaniem','WW mode'],
		troopsI : "Informacja o jednostkach",
		troopsIo : ['off','on','scan help'],
		defRP : "domyÅ›lna akcja dla Miejsca zbiÃ³rki",
		showls : "Pokaz linki",
		showlso : ['off','on','w oknie'],
		savedls : "zapisane linki",
		savedd : "zapisane dane",
		saveddh : 'w tym Linki i Druga nazwa. JeÅ›li konto usuniÄ™te, albo nie twÃ³j komputer.',
		savedelall : "usunÄ…Ä‡ wszystkie zapisane dane",
		savedelallh : 'Czy na pewno chcesz usunÄ…Ä‡ wszystkie dane, w tym linki i druga nazwe?',
		scrlang : "JÄ™zyk skryptu",
		youlang : "twÃ³j jÄ™zyk",
		notifi : "powiadomienie",
		notification : "powiadomienia po zakoÅ„czeniu budowy",
		method : "metoda",
	...
	sv:{ // Swedish translation, thx Dragon from the future
		...
		Overview : "Ã¶verblick",
		svers : "script version",
		setting : "instÃ¤llningar",
		notes : "Anteckningar",
		res90 : "Resurser Ã¶ver 90 %",
		refresh : "Uppdatera",
		warehouse : "Magasin",
		resources : "RÃ¥varor",
		troops : "Soldater",
		links : "LÃ¤nkar",
		linkname : "LÃ¤nknamn",
		linkdel : "Radera lÃ¤nk",
		name2 : "Andra namn",
		archive : "Arkiv",
		arena : "Torneplats",
		addcur : "LÃ¤gg till nuvarande",
		del : "radera",
		edit : "Ã¤ndra",
		total : "Totalt",
		...
		cranny : "Gul nivÃ¥ pÃ¥ grotta (procent)",
		crannyh : "Normal 80, 70 fÃ¶r klssisk eller artefakt-plundrare",
		builtin : "Inbyggda hjÃ¤lpmedel",
		builtinh : "FÃ¶r att Ã¥terstÃ¤lla produktionen: rÃ¶d fÃ¤rg - BehÃ¶vs mest resurser, green - behÃ¶vs mindre resurser",
		normalize : "Ã…terstÃ¤ll produktionen",
		normal : "normal",
		banalyze : "inbyggd analysator fÃ¶r slag",
		cropfins : "inbyggd veteby-finnare",
		onallp : "Alla sidor",
		dontwrap : "Byt inte sidor",
		dontwraph : "Om bylistan hoppar ner",
		buildand : "Visa byggnings och attack nedrÃ¤kning",
		buildandh : "I bylistan",
		sendres : "Visa &laquo;sÃ¤nd rÃ¥varor/trupper&raquo; ikoner",
		sendmess : "Visa Skicka meddelande ikoner",
		analyzer : "VÃ¤rldsanalysator",
		bigicon : "Visa STORA ikoner",
		addvtable : "Visa extra bylista",
		addvtableh : "FÃ¶r travian 4",
		opennote : "Ã–ppnar automatisk anteckningar",
		resbar : "RÃ¥varor-fÃ¤lt",
		showres : "Visa rÃ¥varor-fÃ¤ltet i ett eget fÃ¶nster",
		redbl : "rÃ¶d (i timmar)",
		yellowbl : "yellow (i timmar)",
		marketpl : "Marknadsplats",
		mfilter : "Filter",
		mfiltero : ['av','Endast vÃ¤rde','Endast filter','full'],
		npcsum : "summering fÃ¶r NPC",
		npcsumh : "I marknadsplats och och byggnader",
		incomres : "ikommande rÃ¥varo-info",
		incomreso : ['av','pÃ¥','med sammanfattning','VÃ¤rldsunder'],
		troppsl : "Information om soldaterna",
		troopslo : ['av','pÃ¥','i fÃ¶nster'],
		defRP : "FÃ¶rvald attacktyp pÃ¥ samlingsplats",
		showls : "Visa lÃ¤nkar",
		showlso : ['av','pÃ¥','i fÃ¶nster'],
		savedls : "sparade lÃ¤nkar",
		savedd : "sparad data",
		saveddh : 'Inkluderar lÃ¤nkar och andra-namn. Ã„r ett konto raderat, eller inte din dator.',
		savedelall : "Radera all sparad data",
		savedelallh : 'Ã„r du sÃ¤ker pÃ¥ att du vill radera all data, lÃ¤nkar och andra namnpÃ¥ byar?',
		scrlang : "Script sprÃ¥k",
		youlang : "ditt sprÃ¥k",
		notifi : "notifikation",
		notification : "Notifikation efter byggande",
		method : "metod",
		audiourl : "URL fÃ¶r ljudfil",
		audiotest : "ljudtest"
	},
	it: { // Italian translation , Dragonflame
		...
		notes : "Blocco note",
		res90 : "Risorse a % della capacitÃ ",
		refresh : "Aggiorna",
		warehouse : "Magazzino",
		resources : "Risorse",
		troops : "Truppe",
		...
		auto : "auto",
		info : "Informazioni",
		yourrace : "La tua TribÃ¹:",
		speedart : "Artefatto velocitÃ ",
		racelist : ['Romani','Teutoni','Galli'],
		cranny : "Livello giallo della capacitÃ  del deposito segreto (%)",
		crannyh : 'Normalmente 80; Per il server classico o per artefatto del Ladro 70;',
		builtin : "Strumenti Integrati",
		builtinh : 'Per la produzione ottimizzata: Rosso = Servono piÃ¹ risorse; Verde = servono meno risorse;',
		...
		sendres : "Mostra le icone Â«invia risorse / truppeÂ»",
		sendmess : "Mostra icone Â«invia messaggioÂ»",
		analyzer : "World analyzer",
		...
		incomreso : ['No','Si','Con risultati','ModalitÃ  Meraviglia'],
		troopsI : "Informazioni sulle truppe",
		troopsIo : ['Spento','Acceso','Scansione di aiuto'],
		defRP : "Azione predefinita per Â«Invia truppeÂ»",
		showls : "Mostra link",
		showlso : ['No','Si','In una finestra'],
		savedls : "Salva link",
		savedd : "Salva Dati",
		saveddh : 'Incluso Links e Secondo nome. Se un Account viene cancellato, o non Ã¨ il tuo computer.',
	...
	es: {// Spanish translation. n4ch021
		// ingame messages
		ok : "Ok",
		cancel : "Cancelar",
		close : "cerrar",
		...
		crannyh : 'normal 80, 70 para el saqueo clÃ¡sico o un artefacto',
		builtin : "Herramientas integradas",
		builtinh : 'Para normalizar la producciÃ³n: Color rojo â€“ la mayorÃ­a de los recursos necesarios, verde- os recursos necesitan menos',
		normalize : 'Normalizar la producciÃ³n',
		normal : "normal",
		...
		buildand : "Mostrar cuenta regresiva de un ataque y la construcciÃ³n",
		buildandh : 'Lista de los pueblos',
		sendres : " Mostrar iconos Â«Enviar recursos / las tropasÂ»",
		sendmess : "Mostrar iconos Â«Enviar mensajesÂ»",
		analyzer : "Explorar Mapa",
		bigicon : "Mostrar iconos Grandes",
		opennote : "Notas se aplican automÃ¡ticamente",
		resbar : "Barra de Recursos",
		...
		mfilter : "Filtro",
		mfiltero : ['off','calificaciÃ³n','filtrar','completo'],
		...
		incomres : "InformaciÃ³n de los recursos entrantes",
		incomreso : ['off','on','con el resumen','WW modo'],
		troopsI : "InformaciÃ³n sobre las tropas",
		troopsIo : ['off','on','Analice de ayuda'],
		defRP : "Defecto de la acciÃ³n de puntode reuniÃ³n",
		showls : "Mostrar links",
	...
	zh: {// Chinese (Taiwan) (tw and cn and hk) translation. atg008782
		...
		duration : "æ™‚é–“",
		deficit : "ç´…å­—",
		aclock : "è­¦å ±æ™‚é–“\nhh:mm:ss , hh:mm , mm (å¾žç¾åœ¨èµ·)",
		consnegat : "åœ¨é€™å€‹æ‘èŽŠçš„å„²å­˜é‡æ˜¯è² çš„. å‰©ä¸‹å„²å­˜é‡å¤šå°‘åˆ†é˜?",
		searchlast : "æœç´¢æœ€å¾Œä¸€å€‹",
		bmove : "ç§»å‹•å»ºç¯‰",
		// è¨­å®š(settings)
		none : "ç„¡",
		auto : "è‡ªå‹•",
		info : "è¨Šæ¯",
		yourrace : "ä½ çš„ç¨®æ—",
		speedart : "ä¼ºæœå™¨å€é€Ÿ",
		racelist : ['ç¾…é¦¬','æ¢é “','é«˜ç›§'],
		cranny : "é»ƒè‰²è­¦æˆ’ç·š (ç™¾åˆ†æ¯”)",
		crannyh : 'ä¸€èˆ¬ 80, 70 ç¶“å…¸æˆ–è—è¡“å“åŠ æˆ',
		builtin : "ç½®å…¥å·¥å…·",
		builtinh : 'ç”¢é‡æ¬„é¡¯ç¤ºï¼šç´…è‰²-ç‚ºç¼ºä¹çš„è³‡æºï¼Œç¶ è‰²-ç‚ºä¸ç¼ºä¹çš„è³‡æº',
		normalize : 'æ¨™æº–ç”Ÿç”¢',
		normal : "ä¸€èˆ¬",
		banalyze : "ç½®å…¥æˆ°é¬¥åˆ†æžå™¨",
		cropfind : "ç½®å…¥æœç”°å™¨",
		adetect : "æ”»æ“Šæª¢æ¸¬",
		adetecto : ['é—œé–‰','w/oåœæ­¢','é–‹å•Ÿ'],
		adetecth : "ä½¿ç”¨éš±è—åŠŸèƒ½é•åéŠæˆ²è¦å‰‡å¯èƒ½æœƒå°Žè‡´æ‡²ç½°.",
		adetectt : "æª¢æ¸¬æ”»æ“Šæ™‚é–“",
		buildhint : "å»ºè¨­æç¤º",
		onallp : "å…¨éƒ¨é é¢",
		dontwrap : "ä¸æ›é ",
		dontwraph : 'ä¸‹æ‹‰å¼æ‘èŽŠåˆ—è¡¨',
		buildand : "é¡¯ç¤ºå»ºè¨­å’Œæ”»æ“Šå€’æ•¸è¨ˆæ™‚",
		buildandh : 'æ‘å…§åˆ—è¡¨',
		sendres : "é¡¯ç¤º è³‡æº/éƒ¨éšŠ å‚³è¼¸åœ–ç¤º",
		sendmess : "é¡¯ç¤ºå‚³é€è¨Šæ¯åœ–ç¤º ",
		analyzer : "ä¸–ç•Œåˆ†æž",
		bigicon : "é¡¯ç¤ºå¤§åœ–ç¤º",
		addvtable : "é¡å¤–é¡¯ç¤ºæ‘èŽŠåˆ—è¡¨",
		addvtableo : ['é—œé–‰','é–‹å•Ÿ','å›ºå®š'],
		addvtableh : 'æ”¯æ´ travian 4',
		opennote : "è‡ªå‹•é–‹å•Ÿç­†è¨˜",
		notesize : "ç­†è¨˜è¦–çª—å°ºå¯¸",
		openoview : "è‡ªå‹•é–‹å•Ÿæ‘èŽŠé è¦½",
		resbar : "è³‡æºæ¬„",
		showres : "é¡¯ç¤ºè³‡æºæ¬„è¦–çª—",
		redbl : "ç´…(æ¯å°æ™‚)",
		yellowbl: "é»ƒ(æ¯å°æ™‚)",
		marketpl : "å¸‚å ´",
		mfilter : "éŽæ¿¾",
		mfiltero : ['é—œé–‰','åªæœ‰æ¯”çŽ‡','åªæœ‰éŽæ¿¾','å…¨éƒ¨'],
		npcsum : "é›»è…¦å•†äººäº¤æ˜“(NPC)",
		npcsumh : 'åœ¨å¸‚å ´èˆ‡å»ºç¯‰',
		bidinc : "æ‹è³£åŠ åƒ¹",
		bidinch : ' travian 4 æ‹è³£',
		show3x : "å¯èƒ½é¡¯ç¤ºä¸æ­£ç¢ºçš„æ•¸æ“š",
		show3xh : 'å˜—è©¦é æ¸¬åœ¨ 3å€ å’Œ 2å€ çš„è³‡æºå‚³è¼¸',
		rpandmp : "é›†çµé»ž èˆ‡ å¸‚å ´",
		incomres : "è³‡æºå‚³è¼¸ä¿¡æ¯",
		incomreso : ['é—œé–‰','é–‹å•Ÿ','é›»è…¦äº¤æ˜“','å¥‡è§€æ¨¡å¼'],
		troopsI : "éƒ¨éšŠè¨Šæ¯",
		troopsIo : ['é—œé–‰','é–‹å•Ÿ','æŽƒæå¹«åŠ©'],
		defRP : "é»˜èªé›†çµé»ž",
		showls : "é¡¯ç¤ºéˆæŽ¥",
		showAsSN : "ä½¿ç”¨ç¬¬äºŒåç¨±",
		showlso : ['é—œé–‰','é–‹å•Ÿ','è¦–çª—é¡¯ç¤º'],
		savedls : "å„²å­˜éˆæŽ¥",
		savedd : "å„²å­˜æ•¸æ“š",
		saveddh : 'é›»è…¦ä¸æ˜¯ä½ çš„å¦‚æžœè¦åˆªé™¤,åˆªé™¤é …ç›®æœƒåŒ…å«éˆæŽ¥å’Œç¬¬äºŒåç¨±',
		savedelall : "å…¨éƒ¨å„²å­˜æ•¸æ“šåˆªé™¤",
		savedelallh : 'ä½ ç¢ºå®šè¦åˆªé™¤æ‰€æœ‰æ•¸æ“šï¼ŒåŒ…æ‹¬éˆæŽ¥å’Œç¬¬äºŒåç¨±å—Žï¼Ÿ',
		scrlang : "è…³æœ¬èªžè¨€",
		youlang : "ä½ çš„èªžè¨€",
		notifi : "é€šå ±",
		notification : "å»ºè¨­å®Œæˆé€šå ±",
		method : "æ–¹å¼",
		audiourl : "éŸ³æ¨‚ç¶²å€",
		audiotest : "æ’­æ”¾éŸ³æ¨‚"
	},
	tr: { // Turkish language. xpugur
		...
		cancel : "iptal",
		close : "Kapat",
		overview : "KÃ¶ylerin genel gÃ¶rÃ¼nÃ¼mÃ¼",
		svers : "kod versiyonu",
		settings : "ayarlar",
		notes : "notlar",
		...
		troops : "Askerler",
		links : "BaÄŸlantÄ±lar",
		linkname : "baÄŸlantÄ± adÄ±",
		linkdel : "baÄŸlantÄ±yÄ± sil",
		name2 : "ikinci ad",
		archive : "ArÅŸiv",
		arena : "Turnuva alanÄ±",
		addcur : "mevcutu ekle",
		...
		duration : "sÃ¼re",
		deficit : "eksiklik",
		aclock : "Alarm saati\nhh:mm:ss , hh:mm , mm (ÅŸuandan itibaren)",
		consnegat : "Bu kÃ¶yde tÃ¼ketim eksilerde. KaÃ§ dakika gerekiyor rezervlerin dolmasÄ± iÃ§in?",
		searchlast : "Sonuncuyu arayÄ±n",
		bmove : "BinalarÄ± taÅŸÄ±",
		// settings
		none : "Yok",
		auto : "otomatik",
		info : "Bilgi",
		yourrace : "IrkÄ±n",
		speedart : "HÄ±z eseri",
		racelist : ['RomanlÄ±lar','Cermenler','GalyalÄ±lar'],
		cranny : "sÄ±ÄŸÄ±nak sarÄ± seviyesi (yÃ¼zde)",
		crannyh : 'normal 80, klasik veya eser yaÄŸmasÄ± iÃ§in 70 ',
		builtin : "Entegre araÃ§lar",
		builtinh : 'Ãœretimi normalleÅŸtirmek iÃ§in: kÄ±rmÄ±zÄ± renk - en gerekli kaynak, yeÅŸil - en az gerekli kaynak',
		normalize : 'Ãœretimi normalleÅŸtirmek iÃ§in',
		normal : "normal",
		banalyze : "Dahili savaÅŸ analizcisi",
		cropfind : "Dahili tarla bulucu",
		adetect : "SaldÄ±rÄ±larÄ± algÄ±la",
		adetecto : ['kapa','w/o dondur','aÃ§'],
		adetecth : "Server a gizli istekler gÃ¶nderir, kural ihlalidir. Ceza gelebilir.",
		adetectt : "saldÄ±rÄ± algÄ±lama zaman aralÄ±klarÄ±",
		buildhint : "inÅŸaat ipuÃ§larÄ±",
		onallp : "TÃ¼m sayfalar",
		dontwrap : "SayfalarÄ± birleÅŸtirme",
		dontwraph : 'kÃ¶y listeleri sayfa atlarsa',
		buildand : "inÅŸaat gerisayÄ±mÄ±nÄ± ve saldÄ±rÄ±larÄ± gÃ¶ster",
		buildandh : 'KÃ¶y listelerinde',
		sendres : "iÅŸaretleri gÃ¶ster: ?send resource/troops? ",
		sendmess : "iÅŸaretleri gÃ¶ster: ?send message? ",
		analyzer : "DÃ¼nya analizcisi",
		bigicon : "BÃ¼yÃ¼k simgeler gÃ¶ster",
		addvtable : "Ek kÃ¶y tablosunu gÃ¶ster",
		addvtableo : ['kapa','aÃ§','sabitle'],
		addvtableh : 'travian4 iÃ§in',
		opennote : "Otomatik olarak notlarÄ± aÃ§",
		notesize : "Notlar iÃ§in pencere boyutu",
		openoview : "Otomatik olarak kÃ¶ylerin genel gÃ¶rÃ¼ÅŸÃ¼nÃ¼ aÃ§",
		resbar : "Kaynaklar Ã§ubuÄŸu",
		showres : "Kaynaklar Ã§ubuÄŸunu pencerede gÃ¶ster",
		redbl : "kÄ±rmÄ±zÄ± (saat olarak)",
		yellowbl: "sarÄ± (saat olarak)",
		marketpl : "Market",
		mfilter : "filtre",
		mfiltero : ['kapa','sadece oran','sadece filtre','dolu'],
		npcsum : "NPC iÃ§in Ã¶zet",
		npcsumh : 'binalarda ve markette',
		bidinc : "teklif arttÄ±r",
		bidinch : 'travian4 aÃ§Ä±k-arttÄ±rmalarÄ± iÃ§in',
		show3x : "yanlÄ±ÅŸ veri gÃ¶sterebilir",
		show3xh : '3x ve 2x ile gÃ¶nderilen kaynak akÄ±ÅŸÄ±nÄ± tahmin etmeye Ã§alÄ±ÅŸ',
		rpandmp : "Marketteki git-gel noktasÄ±",
		incomres : "gelen kaynak bilgisi",
		incomreso : ['kapa','aÃ§','Ã¶zetle','WW modu'],
		troopsI : "Askerler hakkÄ±nda bilgi",
		troopsIo : ['kapa','aÃ§','yardÄ±m ara'],
		defRP : "git-gel noktasÄ± iÃ§in standart hareket",
		showls : "BaÄŸlantÄ±alrÄ± gÃ¶ster",
		showAsSN : "BaÄŸlantÄ±larÄ± ikinci isim olarak kullan",
		showlso : ['kapa','aÃ§','pencerede'],
		savedls : "kaydedilmiÅŸ baÄŸlantÄ±lar",
		savedd : "kaydedilmiÅŸ veriler",
		saveddh : 'baÄŸlantÄ±lar ve ikinci ismi iÃ§eren. Hesap silindiyse, yada kendi bilgisayarÄ±nÄ±z deÄŸilse.',
		savedelall : "kaydedilmiÅŸ tÃ¼m verileri sil",
		savedelallh : 'ikinci isim ve baÄŸlantÄ±larÄ± iÃ§eren, tÃ¼m verileri silmekte emin misiniz?',
		scrlang : "Kod dili",
		youlang : "Kendi diliniz",
		notifi : "bilgilendirmeler",
		notification : "inÅŸaattan sonra bilgilendirmeler",
		method : "method",
		audiourl : "ses dosyasÄ±nÄ±n URL si",
		audiotest : "test sesi"
	},
	vi: { // VietNamese translation by Nguyá»…n Duy Thanh
		// ingame messages
		ok : "Äá»“ng Ã½",
		cancel : "Huá»· bá»",
		close : "ÄÃ³ng",
		overview : "tá»•ng quan lÃ ng",
		svers : "PhiÃªn báº£n scripts(translator thanhgola):",
		settings : "CÃ i Ä‘áº·t",
		notes : "ghi chÃº",
		res90 : "TÃ i nguyÃªn cáº§n Ä‘á»ƒ Ä‘áº§y %",
		refresh : "lÃ m tÆ°Æ¡i",
		warehouse : "nhÃ  kho",
		resources : "TÃ i nguyÃªn",
		troops : "LÃ­nh",
		links : "LiÃªn káº¿t",
		linkname : "tÃªn liÃªn káº¿t",
		linkdel : "xoÃ¡ liÃªn káº¿t",
		name2 : "tÃªn phá»¥",
		archive : "LÆ°u trá»¯",
		arena : "Binh trÆ°á»ng",
		addcur : "thÃªm liÃªn káº¿t hiá»‡n táº¡i",
		del : "xoÃ¡",
		edit : "sá»­a",
		unfix : "gá»¡",
		fix : "sá»­a",
		total : "Tá»•ng",
		noplace : "KhÃ´ng cÃ³ chá»—!",
		hunger : "Ä‘Ã³i",
		duration : "Thá»i gian",
		deficit : "thÃ¢m há»¥t",
		aclock : "Äá»“ng há»“ bÃ¡o\nhh:mm:ss , hh:mm , mm ( tÃ­nh tá»« bÃ¢y giá»)",
		consnegat : "Má»©c tiÃªu thá»¥ Ã¢m. Cáº§n bao nhiÃªu phÃºt Ä‘á»ƒ dá»¯ trá»¯?",
		searchlast : "TÃ¬m kiáº¿m láº§n cuá»‘i",
		bmove : "Dá»i cÃ´ng trÃ¬nh",
		// settings
		none : "KhÃ´ng",
		auto : "tá»± Ä‘á»™ng",
		info : "ThÃ´ng tin",
		yourrace : "Chá»§ng tá»™c cá»§a báº¡n",
		speedart : "Cá»— xe cá»§a Helios",
		racelist : ['Romans','Teutons','Gauls'],
		cranny : "BÃ¡o mÃ u vÃ ng khi á»‘ng tÃ i nguyÃªn Ä‘áº¡t (%)",
		crannyh : 'thÃ´ng thÆ°á»ng lÃ  80, 70 cho lÃ ng bÃ¬nh thÆ°á»ng hoáº·c lÃ ng cÃ³ BÃ¬nh rÆ°á»£u cá»§a Dionysus',
		builtin : "CÃ´ng cá»¥ cÃ´ng trÃ¬nh",
		builtinh : 'Chuáº©n hoÃ¡ sáº£n lÆ°á»£ng tÃ i nguyÃªn: mÃ u Ä‘á» -loáº¡i tÃ i nguyÃªn cáº§n nháº¥t, mÃ u xanh - loáº¡i tÃ i nguyÃªn Ã­t cáº§n',
		normalize : 'Chuáº©n hoÃ¡ sáº£n lÆ°á»£ng tÃ i nguyÃªn',
		normal : "chuáº©n",
		banalyze : "Chá»©c nÄƒng - phÃ¢n tÃ­ch tráº­n chiáº¿n",
		cropfind : "Chá»©c nÄƒng - tÃ¬m lÃ ng nhiá»u ruá»™ng lÃºa",
		adetect : "PhÃ¡t hiá»‡n táº¥n cÃ´ng",
		adetecto : ['táº¯t','w/o máº·c Ä‘á»‹nh','má»Ÿ'],
		adetecth : "áº©n cÃ¡c hÃ nh vi cÃ³ thá»ƒ dáº«n Ä‘áº¿n hÃ¬nh phÃ¡t",
		adetectt : "Thá»i gian phÃ¡t hiá»‡n táº¥n cÃ´ng",
		buildhint : "Máº¹o xÃ¢y dá»±ng",
		onallp : "Táº¥t cáº£ trang",
		dontwrap : "Äá»«ng ngáº¯t trang",
		dontwraph : 'náº¿u danh sÃ¡ch trang quÃ¡ dÃ i',
		buildand : "Hiá»ƒn thá»‹ thá»i gian xÃ¢y dá»±ng vÃ  táº¥n cÃ´ng",
		buildandh : 'Trong danh sÃ¡ch lÃ ng',
		sendres : "Hiá»‡n biá»ƒu tÆ°á»£ng <<gá»­i />>",
		sendmess : "Hiá»‡n biá»ƒu tÆ°á»£ng <<gá»­i>>",
		analyzer : "PhÃ¢n tÃ­ch tháº¿ giá»›i",
		bigicon : "Hiá»‡n biá»ƒu tÆ°á»£ng BIG",
		addvtable : "Hiá»ƒn thá»‹ danh sÃ¡ch lÃ ng bá»• sung",
		addvtableo : ['táº¯t','má»Ÿ','dÃ­nh'],
		addvtableh : 'Cho travian 4',
		opennote : "Tá»± Ä‘á»™ng má»Ÿ ghi chÃº",
		notesize : "KÃ­ch thÆ°á»›c cá»§a sá»• ghi chÃº",
		openoview : "Tá»± Ä‘á»™ng má»Ÿ tá»•ng quÃ¡t lÃ ng",
		resbar : "Thanh tÃ i nguyÃªn",
		showres : "Hiá»‡n thanh tÃ i nguyÃªn trÃªn cá»­a sá»•",
		redbl : "Äá» (giá»)",
		yellowbl: "VÃ ng (giá»)",
		marketpl : "Khu chá»£",
		mfilter : "Bá»™ lá»c",
		mfiltero : ['táº¯t','chá»‰ tá»‰ lá»‡','chá»‰ bá»™ lá»c','Ä‘áº§y Ä‘á»§'],
		npcsum : "TÃ³m táº¯t cho NPC",
		npcsumh : 'chá»£ vÃ  cÃ´ng trÃ¬nh',
		bidinc : "TÄƒng Ä‘áº¥u giÃ¡",
		bidinch : 'Ä‘áº¥u giÃ¡ cá»§a travian4',
		show3x : "CÃ³ thá»ƒ hiá»‡n thá»‹ dá»¯ lá»‡u khÃ´ng chÃ­nh xÃ¡c",
		show3xh : 'cá»‘ gáº¯n dá»± Ä‘oÃ¡n cÃ¡c luá»“n tÃ i nguyÃªn sever 2x vÃ  3x Ä‘ang gá»­i',
		rpandmp : "Binh trÆ°á»ng vÃ  chá»£",
		incomres : "ThÃ´ng tin tÃ i nguyÃªn Ä‘ang Ä‘áº¿n",
		incomreso : ['táº¯t','má»Ÿ','vá»›i tÃ³m táº¯t','cháº¿ Ä‘á»™ WW'],
		troopsI : "ThÃ´ng tin vá» quÃ¢n Ä‘á»™i",
		troopsIo : ['táº¯t','má»Ÿ','tÃ¬m trá»£ giÃºp'],
		defRP : "HÃ nh Ä‘á»™ng máº·t Ä‘á»‹nh khi gá»­i lÃ­nh",
		showls : "Hiá»‡n liÃªn káº¿t",
		showAsSN : "Sá»­ dá»¥ng liÃªn káº¿t nhÆ° tÃªn phá»¥",
		showlso : ['táº¯t','má»Ÿ','trong cá»­a sá»•'],
		savedls : "LÆ°u liÃªn káº¿t",
		savedd : "LiÃªn káº¿t Ä‘Ã£ lÆ°u",
		saveddh : 'gá»“m liÃªn káº¿t vÃ  liÃªn káº¿t phá»¥. Náº¿u tÃ i khoáº£ng xoÃ¡ hoáº·c Ä‘Ã¢y khÃ´ng pháº£i mÃ¡y tÃ­nh cá»§a báº¡n.',
		savedelall : "xoÃ¡ táº¥t cáº£ dá»¯ liá»‡u Ä‘Ã£ lÆ°u",
		savedelallh : 'báº¡n cÃ³ cháº¯c muá»‘n xoÃ¡ háº¿t dá»¯ liá»‡u, bao gá»“m cáº£ liÃªn káº¿t vÃ  tÃªn phá»¥ cáº£u nÃ³?',
		scrlang : "NgÃ´n ngá»¯ Script",
		youlang : "NgÃ´n ngá»¯ cá»§a báº¡n",
		notifi : "ThÃ´ng bÃ¡o",
		notification : "thÃ´ng bÃ¡o sau khi xÃ¢y dá»±ng xong",
		method : "PhÆ°Æ¡ng phÃ¡p",
		audiourl : "URL cá»§a tá»‡p nháº¡c",
		audiotest : "Thá»­ nháº¡c"
	}
};
...
function getResources () {
	if( initRes ) {
		if( ver4FL ) {
			try { eval($xf('//script[contains(text(),"resources.production")]').innerHTML); }
...
acss =	"table#"+allIDs[0]+" {width:100%; border-collapse:collapse; font-size:8pt; text-align:center; background-color:white; padding:2px; margin:1px;}" +
	...
	"."+allIDs[33]+" { height:12px;width:18px;background: url("+img_car+") no-repeat 0px 0px; }" +
	"."+allIDs[34]+" { height:12px;width:18px;background: url("+img_def+") no-repeat 0px 0px; }" +
	"."+allIDs[35]+" { height:12px;width:18px;background: url("+img_att+") no-repeat 0px 0px; }" +
...
if( ver4FL ) acss += "table#vlist td{padding:0;line-height:16px;text-align:"+docDir[0]+";white-space:nowrap;}table#vlist thead td{background-color:#FFF;height:22px;text-align:center;padding:0px 3px;}" +
	...
	"span."+allIDs[48]+" {position:relative;float:"+docDir[1]+";margin-top:-17px;padding-top:3px;height:15px;background-color:#F7EBBE;} span."+allIDs[48]+" a {display:inline !important;margin:0px !important;}";
...
function neededResAdd () {
    ...
    var __Troop = $g('troops')[0];
    var __T1 = $gn('t1',__Troop)[0];
    var __T5 = $gn('t5',__Troop)[0];
    var __T6 = $gn('t6',__Troop)[0];

    if(getParameterByName('go') !== null) __T1.value = getParameterByName('go');
    if(getParameterByName('de') !== null) __T5.value = getParameterByName('de');
    if(getParameterByName('sh') !== null) __T6.value = getParameterByName('sh');
...
function marketSend () {
	...
	function rEL () {
		...
		if( mcFL ) {
			$g('merchantsAvailable').addEventListener('DOMNodeInserted',reloadMerchants,false);
			mcFL = false;
		}
	...
	function checkMerchants () {
		...
		if (moC) {
			var moCC = moC.innerHTML.onlyText().match(/(\S+)\s+(\d+)\s*?\/\s*?(\d+)/);
			mName = moCC[1];
	...
	moC.appendChild($em('SPAN',[maxRM,' Î£=',maxRC],[['style','margin:0px 5px;font-size:12px;']]));
		...
		for (i = 0; i < aT.length; i++) {
			...
			if( multFL.length > 0 ) {
				...
				for( var nc=cnt-1; nc>0; nc-- ) {
					...
					var newT = htR * (cnt-nc)*2 + htR*2 - timeToGo;
...
if( ver4FL && RB.bodyH[0] == 1 ) {
	if( timerN.length < 4 ){
		...
		timerN[j].divme1 = $ee('P',
			$em('span',['( ',$ee('span',resource,[['style','color:'+resoColor+';']]),' ',timerN[j].resotime,' ',timerN[j].perreso,')'],
				[['style',"font-size:8pt !important;background-color:white;white-space:nowrap;position:absolute;"+docDir[1]+":0px;"]]),
			[['style','position:relative;top:8px;'+docDir[1]+':0px;']]);
...
function rbSetup () {
	...
	var aRBS = [
		...
		['I', 0, gtext("onallp")],
			...
			['SEL',35, gtext("notesize"), ['40x15','55x20','70x30','60x45','40x8']],
...
function parseSpieler () {
	...
	var curTR = $xf('.//tr[.//a[contains(@href,"d='+village_aid+'")]]','f',$g('villages'));
	if( curTR ) {
		var sit = parseInt(curTR.cells[(ver4FL?2:1)].innerHTML.onlyText());
		var prod = parseInt((ver4FL?$g('l5'):$gt('TABLE',$g("resWrap"))[0].rows[0].cells[9]).innerHTML.split('/')[1]);
		$at(curTR.cells[(ver4FL?2:1)],[['title',(prod-sit)]]);
	}
}
...
function culturePoints(){
	function villages2cp( noVil, classic ) {
		...
		if( classic )
			...
			else if( /x2|y2|z2|t1/i.test(crtPath) )
	...
	var newTR = $ee('TR',$c('#'));
	var cpTransl = $xf('.//a[contains(@href,"s=2")]','f',cont).innerHTML.onlyText();
			...
			for( var i = 0; i < descr.length; i++ ) {
				...
				if( ver4FL ) {
					if( td.length < 3 ) {
						...
						newCookie[t++] = td[2].innerHTML.onlyText().replace(/.+?\d\d\s\S+\s/,'');
					}
				} else {
					if( td.length < 4 ) {
						newCookie[t++] = 0;
...
function rbNotes () {
	...
	var nSize = [[40,15],[55,20],[70,30],[60,45],[40,8]];
...
function demolishSave () {
	...
	if( ! dem ) {
		...
		for( var i = 0; i < descr.length; i++ ) {
			newCookie[0]++;
			var td = descr[i].cells;
			newCookie[t++] = td[1].innerHTML.trim();
			if( td.length < 4 ) {
				newCookie[t++] = 0;
				newCookie[t++] = '';
			} else {
...
function troopsOasis ( vfS ) {
	...
	if(i) addToolTip(newITT,(ver4FL? i[1]: i.rows[0].cells[0]));
}
...
function normalProductionCalc ( ires ) {
	...
	var vNormal = [[10,12,8,6],  // Ð½Ð¾Ñ€Ð¼Ð°Ð»ÑŒÐ½Ð¾Ðµ Ñ€Ð°Ð·Ð²Ð¸Ñ‚Ð¸Ðµ (Ð¿Ñ€Ð¾Ð¸Ð·Ð²Ð¾Ð´ÑÑ‚Ð²Ð¾ Ñ€ÐµÑÐ¾Ð²)/normal development (production resources)
// Ð Ð˜ÐœÐ›Ð¯ÐÐ• / ROMANS //
	[6,5,8,2],// Ð»ÐµÐ³Ð¸Ð¾Ð½ÐµÑ€Ñ‹ / Legionnaire
	[10,13,16,7],// Ð¿Ñ€ÐµÑ‚Ð¾Ñ€Ð¸Ð°Ð½Ñ†Ñ‹ / Praetorian
	[15,16,21,8],// Ð¸Ð¼Ð¿ÐµÑ€Ð¸Ð°Ð½Ñ†Ñ‹ / Imperian
	[7,8,1,2],// ÐºÐ¾Ð½Ð½Ñ‹e Ñ€Ð°Ð·Ð²ÐµÐ´Ñ‡Ð¸ÐºÐ¸ / Equites Legati
	[55,44,32,10],// ÐºÐ¾Ð½Ð½Ð¸Ñ†Ð° Ð¸Ð¼Ð¿ÐµÑ€Ð°Ñ‚Ð¾Ñ€Ð° / Equites Imperatoris
	[55,64,80,18],// ÐºÐ¾Ð½Ð½Ð¸Ñ†Ð° Ð¦ÐµÐ·Ð°Ñ€Ñ / Equites Caesaris
	[90,36,50,7],// Ñ‚Ð°Ñ€Ð°Ð½Ñ‹ / Battering Ram
	[95,135,60,9],// Ð¾Ð³Ð½ÐµÐ½Ð½Ñ‹Ðµ ÐºÐ°Ñ‚Ð°Ð¿ÑƒÐ»ÑŒÑ‚Ñ‹ / Fire Catapult
// Ð“Ð•Ð ÐœÐÐÐ¦Ð« / TEUTONS //
	[19,15,8,8],// Ð´ÑƒÐ±Ð¸Ð½Ñ‰Ð¸ÐºÐ¸ / Clubswinger
	[29,14,17,8],// ÐºÐ¾Ð¿ÐµÐ¹Ñ‰Ð¸ÐºÐ¸ / Spearman
	[13,12,17,7],// Ñ‚Ð¾Ð¿Ð¾Ñ€Ñ‰Ð¸ÐºÐ¸ / Axeman
	[16,10,5,5],// ÑÐºÐ°ÑƒÑ‚Ñ‹ / Scout
	[74,54,58,15],// Ð¿Ð°Ð»Ð°Ð´Ð¸Ð½Ñ‹ / Paladin
	[90,103,96,16],// Ñ‚ÐµÐ²Ñ‚Ð¾Ð½Ñ‹ / Teutonic Knight
	[100,30,35,7],// ÑÑ‚ÐµÐ½Ð¾Ð±Ð¸Ñ‚Ð½Ñ‹Ðµ Ð¾Ñ€ÑƒÐ´Ð¸Ñ / Battering Ram
	[45,60,30,3],// ÐºÐ°Ñ‚Ð°Ð¿ÑƒÐ»ÑŒÑ‚Ñ‹ / Catapult
// Ð“ÐÐ›Ð›Ð« / GAULS //
	[20,26,11,6],// Ñ„Ð°Ð»Ð°Ð½Ð³Ð¸ / Phalanx
	[28,30,37,12],// Ð¼ÐµÑ‡Ð½Ð¸ÐºÐ¸ / Swordsman
	[17,15,2,4],// ÑÐ»ÐµÐ´Ð¾Ð¿Ñ‹Ñ‚Ñ‹ / Pathfinder
	[35,45,23,6],// Ð³Ñ€Ð¾Ð¼Ñ‹ / Theutates Thunder
	[36,33,28,12],// Ð´Ñ€ÑƒÐ¸Ð´Ñ‹ / Druidrider
	[100,124,135,34],// ÑÐ´ÑƒÐ¸ / Haeduan
	[190,111,66,15],// Ñ‚Ð°Ñ€Ð°Ð½Ñ‹ / Battering Ram
	[96,145,63,9]];// Ñ‚Ñ€ÐµÐ±ÑƒÑˆÐµÑ‚Ñ‹ / Trebuchet
...
function get2Gorzi(res) {
 			var __Res = parseInt(res / 3);
			var __2Gorzi = (__Res * 2) / 60;
			return parseInt(__2Gorzi);
}

function get1Shovaliye(res) {
 			var __Res = parseInt(res / 3);
            var __1Shovaliye = __Res / 80;
			return parseInt(__1Shovaliye);
}
...
function analyzerBattle () {
	...
	if( ver4FL && goods.length > 1) {
		...
		if( ! isNaN(crC) ) {
			...
			goods[1].appendChild($ee('SPAN',' ( &#931;= '+pbonus+' ) '));
			
//mohsen

            var __gorziImage = '<img class="unit u11" alt="??????" src="img/x.gif" style="margin-left:4px">';
            var __delavarImage = '<img class="unit u15" alt="??????" src="img/x.gif" style="margin-left:4px">';
            var __shovaliyeImage = '<img class="unit u16" alt="??????" src="img/x.gif" style="margin-left:4px">';
    
			
			var __units1 = $gc('units')[4];			// Ù…Ø¯Ø§ÙØ¹
			var __units2 = $gc('units')[7];			// Ù†Ø¨Ø±ÙˆÛŒ Ú©Ù…Ú©ÛŒ
			
			
			var __reportId = $g('report_surround')[0];

            var __reportContent = $gc('report_content',__reportId)[0];
                        
            if(crtPath.substring(23,31) == 'berichte') __reportContent.removeChild($gt('img',__reportContent)[0]);



			var __def = false;
			for(var i = 0; i < 11; i++) {
                if($gc('unit',__units1)[i] !== undefined) {
				var un1 = $gc('unit',__units1)[i].innerHTML;
				if(parseInt(un1) > 0) {
				    __def = true;
				    break;
				}
			...
			for(var i = 0; i < 11; i++) {
				if($gc('unit',__units1)[i] !== undefined) {
                var un1 = $gc('unit',__units2)[i].innerHTML;
				if(parseInt(un1) > 0 || __def == true) {
                    goods[1].appendChild($ee('SPAN','Ù†ÛŒØ±ÙˆÛŒ Ø¯ÙØ§Ø¹ÛŒ Ø¯Ø§Ø±Ù‡',[['style','color:red;margin-right: 20px; font-weight: bold;']]));
					break;
				}
				}
			}			
			...
			//goods[1].appendChild($ee('div','<br/> '+parseInt(pbonus / 60)+''));
//			var __TypeTarget = $gc('none2')[0].innerHTML;
				var __UserID = $gc('troopHeadline')[1].firstChild.childNodes[2].href;
				__UserID = __UserID.substring(__UserID.lastIndexOf('?d=') + 3,__UserID.length);
			
			
					
 
 			// Ø¨Ø±Ø§ Ø·Ø¨ÛŒØ¹Øª
 			var __Gorzi = parseInt(pbonus / 60);
			var __Delavar = parseInt(pbonus / 110);
			var __Shovaliye = parseInt(pbonus / 80);

			
			
			if($gc('troopHeadline')[1].childNodes[0].childNodes[0].innerHTML == 'Ø·Ø¨ÛŒØ¹Øª') {
				goods[1].appendChild($e('BR'));
				goods[1].appendChild($e('BR'));
                goods[1].appendChild($ee('div','<a target="_blank" href="build.php?id=39&tt=2&z='+ __UserID + '&go=' + (__Gorzi - 1) + '">' + __gorziImage + (__Gorzi - 1) +  '</a>',[['style','width:80px;float:right;']]));
				goods[1].appendChild($ee('div','<a target="_blank" href="build.php?id=39&tt=2&z='+ __UserID + '&de=' + (__Delavar - 1) + '">' + __delavarImage + (__Delavar - 1)  + '</a>',[['style','width:80px;float:right;']]));
				goods[1].appendChild($ee('div','<a target="_blank" href="build.php?id=39&tt=2&z='+ __UserID + '&sh=' + (__Shovaliye - 1) + '">' + __shovaliyeImage + (__Shovaliye - 1)  + '</a>',[['style','width:80px;float:right;']]));
				
				goods[1].appendChild($ee('div','<a target="_blank" href="build.php?id=39&tt=2&z='+ __UserID + '&go=' + get2Gorzi(pbonus) + '&sh=' + get1Shovaliye(pbonus) + '">' + __gorziImage+__gorziImage+__shovaliyeImage +  '</a>',[['style','width:80px;float:right;']]));				

			} else {
				goods[1].appendChild($e('BR'));
				goods[1].appendChild($e('BR'));
                goods[1].appendChild($ee('div','<a target="_blank" href="build.php?id=39&tt=2&z='+ __UserID + '&go=' + __Gorzi + '">' + __gorziImage + __Gorzi +  '</a>',[['style','width:80px;float:right;']]));
				goods[1].appendChild($ee('div','<a target="_blank" href="build.php?id=39&tt=2&z='+ __UserID + '&de=' + __Delavar + '">' + __delavarImage + __Delavar  + '</a>',[['style','width:80px;float:right;']]));
				goods[1].appendChild($ee('div','<a target="_blank" href="build.php?id=39&tt=2&z='+ __UserID + '&sh=' + __Shovaliye + '">' + __shovaliyeImage + __Shovaliye  + '</a>',[['style','width:80px;float:right;']]));
...
function addReport () {
	...
	reportV = reportV.replace(/<script[\s\S]+?script>/g,' ').replace(/\s{2,}/g,' ').replace(/<\/td>/g,"\t").replace(/<\/div>|<\/tr>/g,"\n").onlyText();
...
function TM_ShowMainBuildingNumbers(){
	...
	if (dorf == 2) {
		...
		if( ver4FL ) {
			// tables for T4 from Qusai Abu Hilal Ù‚ØµÙŠ Ø£Ø¨Ùˆ Ù‡Ù„Ø§Ù„
...
//			alert( gid +' /// '+ BuildingLevel +' /// '+ getMaxLevel(gid));
		...
		if (parseInt(BuildingLevel[0]) == getMaxLevel(gid)) {
			smallDIV.style.backgroundColor = '#A0F0A0'; //green
		}else if( resneed[0] > fullRes[0] || resneed[1] > fullRes[0] || resneed[2] > fullRes[0] || resneed[3] > fullRes[3] ) {
			smallDIV.style.backgroundColor = '#F0B8FF'; //magenta
			...
			if(resNow[0] >= resneed[0] && resNow[1] >= resneed[1] && resNow[2] >= resneed[2] && resNow[3] >= resneed[3]){
				smallDIV.style.backgroundColor = '#F8FFD8'; //white
			}else{
				smallDIV.style.backgroundColor = '#FFD86B'; //orange #FFC85B
			}
		}else if (parseInt(resneed[0]) > resNow[0] ||
			parseInt(resneed[1]) > resNow[1] ||
			parseInt(resneed[2]) > resNow[2] ||
			parseInt(resneed[3]) > resNow[3] ){
			smallDIV.style.backgroundColor = '#FF8888'; //red
		}
	}
}
...
function goldClubInfo () {
	...
	function scanGoldRep () {
		...
		for( var i=0; i < fList.length; i++ ) {
			...
			$gt('INPUT',fList[i])[0].addEventListener('click',checkAll);
			...
			if( flID != RB.village_Var[2] ) {
				...
				if( RB.dictFL[22] == 0 ) {
					try {
						var tm = $gc('tabItem',$gc('active',$gc('tabNavi',cont)[0])[0])[0].innerHTML;
					} catch(err) {
						var tm = false;
					}
					if( tm ) {
...
function reportsDelOrSearch () {
	...
	if( ver4FL ) {
		...
		newDel.setAttribute('title',$gc('button-contents',newDel)[0].innerHTML);
		$gc('button-contents',newDel)[0].innerHTML = ltr ? " [X] &gt;&gt; ": " [X] &lt;&lt; ";
	} else {
...
// start script
	...
	if( /spieler.php\?.*uid=/.test(crtPath) ) { distanceToTargetVillages(); parseSpieler(); userActivityInfo(); spielerSort(); if( ! ver4FL ) resourceBalance(); }
	...
	if( /adventure.php/.test(crtPath) ) addSpeedAndRTSend();
