// ==UserScript==
// @name           TrExMa on National Shortlist
// @namespace      ---
// @description    Show the TrExMa ratings for Favorite Positions on the National Shortlist page
// @include        http://trophymanager.com/national_shortlist.php*
// ==/UserScript==

// 2010-09-04 - Adapted by Eric Savage (Savage United) from shortlist script for use on NT shortlist
...
document.getSkills = function(tableData) {
  var skillArray = [];
  for (var l = 9; l < tableData.length - 1; l++) {
...
document.showPlayerSkills = function(playerRow) {
  ...
  if (tableData.length > 1) {
    ...
    var playersPositions = tableData[3].innerHTML.split("x");
	var pomocny=tableData[3].innerHTML;
