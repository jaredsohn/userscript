// ==UserScript==
// @name        	Chat Ikariam v1.1
// @namespace   	Platypus
// @include     	http://s*.ikariam.vn/index.php?view=embassy&id=*&position=*
// @exclude		  http://board.ikariam.vn/*
// ==/UserScript==
function do_platypus_script() {
html_insert_it(window.document,document.getElementById('container2'),'<embed src="http://www.xatech.com/web_gear/chat/chat.swf" quality="high" width="700" height="500" name="chat" FlashVars="id=48728854" align="middle" allowScriptAccess="sameDomain" type="application/x-shockwave-flash" pluginspage="http://xat.com/update_flash.shtml" />',false,false);
}; // Ends do_platypus_script
window.addEventListener("load", function() { do_platypus_script() }, false);
var gplatypusBundle = Components.classes["@mozilla.vn/intl/stringbundle;1"].getService(Components.interfaces.nsIStringBundleService);
