// ==UserScript==
// @name           GLB Modify IHasUsername Posts
// @namespace      GLB
// @include        http://goallineblitz.com/game/forum_thread.pl?*
// ==/UserScript==

var list = ['IHasUsername'];
      ...
      if (els[i].className == 'post_user') {
         ...
         for (var m=0, n=els2.length; m<n; m++) 
              if (els2[m].className=='user_name' && findName(els2[m])) {
				 ...
				 elm[0].innerHTML = elm[0].innerHTML + '<br><br><b>Bengals</b> - LOLast Place!';
             }
       }
}
      ...
      if (els[i].className == 'post_content_container') {
         ...
         for (var m=0, n=els2.length; m<n; m++) 
              if (els2[m].className=='post_content' && findNameInQuote(els2[m])) {
                 ...
                 els2[m].innerHTML=els2[m].innerHTML.substring(0, p2) + '<br><br><b>Bengals</b> - LOLast Place!' + els2[m].innerHTML.substring(p2, len);
                 return 0;
             }
       }
}
