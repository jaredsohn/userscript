 ...
 * >>> Please submit all translations to mawgli@gmail.com <<<
 * -------------------------------------------------------------------------
 */
...
switch(sLang) {
	...
	case "co.il":  //by mawgli
        aLangBuildings = [,"חוטב עצים"
מכרה ברזל","בור טיט","אדמת יבול","מנסרה", "מפעל לבנים", "בית ציקה","טחנת דגנים", "מאפייה" , "מחסן","מחסן תבואה","נפח","נשקייה","רחבת טורניר"
, "נקודת מפגש", "מגורי חיילים", "אורווה", "בית-מלאכה", "אקדמיה", "מגורי-חיילים גדולים",
"אורווה גדולה", "מלכודת", "אחוזת הגיבור", "בניין מרכזי", "שוק", "שגרירות", "נקיק",
"בנין עירייה", "מגורים", "ארמון", "קופה", "משרד סחר", "סתת", "מחסן גדול"
, "מחסן תבואה גדול",""];
