// ==UserScript==
// @name           	BBCode-Edit Pennergame *NEW edit by Just4Me*
// @namespace      	11235813 *edit by Bengy - edit by Just4Me
// @description    	Erweiterter BB-Code Editor mit Vorschaufunktion + ULTRAviele Smileys 
...
update()
    ...
    //==========================================================//
    //
    // @version        1.2 erneut einige Wunschsmilies hinzugefügt
    // @version        1.1 neue SkriptID = 129598 - Smilies bearbeitet + ergänzt by Just4Me, 
    // @version        1.0 Grundversion von ScriptID = 111553 edit by bengy 
    // @version        1.0 Script mit Hilfe von We1hnachtsmann für reloaded gefixt + neue Smileys eingebaut
...
function add_funcs() {
	...
	editor.addSmilie('http://www.greensmilies.com/smile/smiley_emoticons_teuflisches-ja.gif');
	editor.addSmilie('http://www.greensmilies.com/smile/smiley_emoticons_no.gif');
	editor.addSmilie('http://www.greensmilies.com/smile/smiley_emoticons_wink_gruen.gif');
	editor.addSmilie('http://www.greensmilies.com/smile/smiley_emoticons_wink2.gif');;
	...
	editor.addSmilie('http://www.greensmilies.com/smile/smiley_emoticons_mague_nacht.gif');
	...
	editor.addSmilie('http://www.greensmilies.com/smile/smiley_emoticons_coool.gif');
	...
	editor.addSmilie('http://www.greensmilies.com/smile/smiley_emoticons_explode.gif');
    editor.addSmilie('http://www.smilies.4-user.de/include/Wut/smilie_wut_061.gif');
	...
	editor.addSmilie('http://www.greensmilies.com/smile/smiley_emoticons_luege.gif');
	editor.addSmilie('http://www.greensmilies.com/smile/smiley_emoticons_look.gif');
	editor.addSmilie('http://www.greensmilies.com/smile/smiley_emoticons_richter.gif');
	editor.addSmilie('http://www.greensmilies.com/smile/smiley_emoticons_altes_eisen.gif');
	editor.lineBreak();
    // gruener Block
    ...
    editor.addSmilie('http://www.smilies.4-user.de/include/Krank/smilie_krank_002.gif');
    ...
    editor.addSmilie('http://www.smilies.4-user.de/include/Frech/smilie_frech_118.gif');
    editor.addSmilie('http://www.smilies.4-user.de/include/Denken/smilie_denk_33.gif');
    editor.addSmilie('http://www.smilies.4-user.de/include/Denken/smilie_denk_22.gif');
    ...
    editor.addSmilie('http://www.smilie.ws/smileys/party/0005.gif');
    ...
    editor.addSmilie('http://www.smilies.4-user.de/include/Musik/schlagzeug_smilie_136.gif');
    editor.addSmilie('http://www.smilies.4-user.de/include/Geburtstag/smilie_geb_039.gif');
    ...
    editor.addSmilie('http://www.smilies.4-user.de/include/Essen/smilie_essen_035.gif');
    editor.lineBreak();
    ...
    editor.addSmilie('http://www.greensmilies.com/smile/smiley_emoticons_stock2.gif');
    editor.addSmilie('http://www.greensmilies.com/smile/smiley_emoticons_selbstmord.gif');
    editor.addSmilie('http://www.greensmilies.com/smile/smiley_emoticons_waffe13.gif');
    editor.addSmilie('http://www.greensmilies.com/smile/smiley_emoticons_waffe14.gif');
    editor.addSmilie('http://www.greensmilies.com/smile/smiley_emoticons_engel2.gif');
    editor.addSmilie('http://www.greensmilies.com/smile/smiley_emoticons_ironieteufel.gif');
    editor.addSmilie('http://www.greensmilies.com/smile/smiley_emoticons_eckbanner00.gif');
    ...
    editor.addSmilie('http://www.greensmilies.com/smile/smiley_emoticons_redface.gif');
    editor.addSmilie('http://www.greensmilies.com/smile/smiley_emoticons_fluch3.gif');
    editor.addSmilie('http://www.greensmilies.com/smile/smiley_emoticons_shout.gif');
    editor.addSmilie('http://www.greensmilies.com/smile/smiley_emoticons_hangman.gif');
    editor.addSmilie('http://www.greensmilies.com/smile/smiley_emoticons_kinggrin_anbeten2.gif');
    editor.addSmilie('http://www.greensmilies.com/smile/smiley_emoticons_anbeten01.gif');
    editor.addSmilie('http://www.greensmilies.com/smile/smiley_emoticons_gott.gif');
    editor.addSmilie('http://www.greensmilies.com/smile/smiley_emoticons_queengrin1.gif');
    editor.addSmilie('http://www.greensmilies.com/smile/smiley_emoticons_musketiere_schwoerend.gif');
    editor.addSmilie('http://www.greensmilies.com/smile/smiley_emoticons_mttao_star_wars.gif');
    editor.addSmilie('http://www.greensmilies.com/smile/smiley_emoticons_kings_shocked.gif');
    editor.addSmilie('http://www.greensmilies.com/smile/smiley_emoticons_star-wars-yoda3-blau.gif');
    editor.addSmilie('http://www.greensmilies.com/smile/smiley_emoticons_zugekniffen.gif');
    editor.addSmilie('http://www.greensmilies.com/smile/smiley_emoticons_mazzn_wtf.gif');
    editor.addSmilie('http://www.greensmilies.com/smile/smiley_emoticons_borg.gif');
    editor.addSmilie('http://www.greensmilies.com/smile/smiley_emoticons_doh.gif');
    editor.addSmilie('http://www.greensmilies.com/smile/smiley_emoticons_schriftsteller_b.gif');
    editor.addSmilie('http://www.greensmilies.com/smile/smiley_emoticons_helpnew.gif');
    editor.addSmilie('http://www.greensmilies.com/smile/smiley_emoticons_mttao_shopping.gif');
    ...
    editor.addSmilie('http://www.greensmilies.com/smile/smiley_emoticons_krank.gif');
    editor.addSmilie('http://www.greensmilies.com/smile/smiley_emoticons_spritze.gif');
    editor.addSmilie('http://www.greensmilies.com/smile/smiley_emoticons_eazy_stinker.gif');
    editor.addSmilie('http://www.greensmilies.com/smile/smiley_emoticons_internetzensur.gif');
    editor.addSmilie('http://www.greensmilies.com/smile/smiley_emoticons_computer.gif');
    editor.addSmilie('http://www.greensmilies.com/smile/smiley_emoticons_stapel2.gif');
    editor.addSmilie('http://www.greensmilies.com/smile/smiley_emoticons_haufen.gif');
    editor.addSmilie('http://www.greensmilies.com/smile/smiley_emoticons_karte_rot.gif');
    editor.addSmilie('http://www.greensmilies.com/smile/smiley_emoticons_koepfler.gif');
    editor.addSmilie('http://www.greensmilies.com/smile/smiley_emoticons_hexe-frosch.gif');
	...
	editor.addSmilie('http://www.greensmilies.com/smile/smiley_emoticons_panik2.gif');
	editor.addSmilie('http://www.greensmilies.com/smile/smiley_emoticons_panik3.gif');
	editor.addSmilie('http://www.greensmilies.com/smile/smiley_emoticons_panik5.gif');
	editor.addSmilie('http://www.greensmilies.com/smile/smiley_emoticons_dinosaurier07.gif');
	editor.addSmilie('http://www.greensmilies.com/smile/smiley_emoticons_flucht3.gif');
	...
	editor.addSmilie('http://www.smilies.4-user.de/include/Wut/smilie_wut_050.gif');
	...
	editor.lineBreak();
	//zweiter gelber Block
    
	editor.addSmilie('http://www.greensmilies.com/smile/smiley_emoticons_verlegen.gif');
	editor.addSmilie('http://www.greensmilies.com/smile/smiley_emoticons_hot.gif');
	editor.addSmilie('http://www.greensmilies.com/smile/smiley_emoticons_ventilator.gif');
	editor.addSmilie('http://www.greensmilies.com/smile/smiley_emoticons_sun.gif');
	...
	editor.addSmilie('http://www.greensmilies.com/smile/smiley_emoticons_pfeif.gif');
	editor.addSmilie('http://www.greensmilies.com/smile/smiley_emoticons_respekt.gif');
	...
	editor.addSmilie('http://www.greensmilies.com/smile/smiley_emoticons_papiertuete-kopf.gif');
	editor.addSmilie('http://www.greensmilies.com/smile/smiley_emoticons_stevieh_seufz.gif');
	editor.addSmilie('http://www.greensmilies.com/smile/smiley_emoticons_confusednew.gif');
	editor.addSmilie('http://www.greensmilies.com/smile/smiley_emoticons_unknownauthor_lehrer.gif');
	editor.addSmilie('http://www.greensmilies.com/smile/smiley_emoticons_nixweiss.gif');
	editor.addSmilie('http://www.greensmilies.com/smile/smiley_emoticons_ins-auge-stechen.gif');
	editor.addSmilie('http://www.greensmilies.com/smile/smiley_emoticons_axt.gif');
	editor.addSmilie('http://www.greensmilies.com/smile/smiley_emoticons_blaues-auge.gif');
	editor.addSmilie('http://www.greensmilies.com/smile/smiley_emoticons_cash2.gif');	
	editor.addSmilie('http://www.smilies.4-user.de/include/Trinken/smilie_trink_061.gif');
	editor.addSmilie('http://www.greensmilies.com/smile/smiley_emoticons_bier.gif');
	editor.addSmilie('http://www.greensmilies.com/smile/smiley_emoticons_mttao_kochen.gif');
	editor.lineBreak();
	...
	editor.addSmilie('http://www.greensmilies.com/smile/d2_saya_necro2.gif');
	editor.addSmilie('http://www.greensmilies.com/smile/smiley_emoticons_applaus.gif');
	editor.lineBreak();
    
	editor.addSmilie('http://www.greensmilies.com/smile/smiley_emoticons_charly_abinsbett.gif');
	...
	editor.addSmilie('http://www.greensmilies.com/smile/smiley_emoticons_dafuer.gif');
	editor.addSmilie('http://www.greensmilies.com/smile/smiley_emoticons_abstimmen.gif');
	editor.addSmilie('http://www.greensmilies.com/smile/smiley_emoticons_dagegen.gif');
	...
	editor.addSmilie('http://www.greensmilies.com/smile/smiley_emoticons_saufen.gif');
	editor.addSmilie('http://www.greensmilies.com/smile/smiley_emoticons_party.gif');
	editor.addSmilie('http://www.greensmilies.com/smile/smiley_emoticons_eazy_ruelps.gif');
	...
	editor.addSmilie('http://www.greensmilies.com/smile/smiley_emoticons_handy2.gif');
	editor.lineBreak();
    
	editor.addSmilie('http://www.greensmilies.com/smile/smiley_emoticons_frosch02.gif');
	editor.addSmilie('http://www.greensmilies.com/smile/smiley_emoticons_labor_explosion.gif');
	editor.addSmilie('http://www.greensmilies.com/smile/smiley_emoticons_charly_nachti.gif');
	editor.addSmilie('http://www.greensmilies.com/smile/smiley_emoticons_unknownauthor_wink.gif');
	editor.addSmilie('http://www.greensmilies.com/smile/smiley_emoticons_keks2.gif');
	editor.addSmilie('http://www.greensmilies.com/smile/smiley_emoticons_ben_doener.gif');
	editor.addSmilie('http://www.greensmilies.com/smile/smiley_emoticons_mcdonalds.gif');
	...
	editor.addSmilie('http://www.greensmilies.com/smile/smiley_emoticons_steinwerfen.gif');
	editor.addSmilie('http://www.greensmilies.com/smile/smiley_emoticons_ins-auge-stechen.gif');
	editor.addSmilie('http://www.greensmilies.com/smile/smiley_emoticons_nude.gif');
	editor.addSmilie('http://www.greensmilies.com/smile/smiley_emoticons_invert.gif');
	editor.addSmilie('http://www.greensmilies.com/smile/smiley_emoticons_color.gif');
	editor.addSmilie('http://www.greensmilies.com/smile/smiley_emoticons_zunge-ellenbogen.gif');
	editor.addSmilie('http://www.greensmilies.com/smile/smiley_emoticons_glaskugel4.gif');
	editor.addSmilie('http://www.greensmilies.com/smile/smiley_emoticons_paradoxon6.gif');
	editor.addSmilie('http://www.greensmilies.com/smile/smiley_emoticons_weckruf.gif');
	editor.lineBreak();
	/*paar skype smilies

editor.addSmilie('http://factoryjoe.s3.amazonaws.com/emoticons/emoticon-0100-smile.gif');
editor.addSmilie('http://factoryjoe.s3.amazonaws.com/emoticons/emoticon-0101-sadsmile.gif')
editor.addSmilie('http://factoryjoe.s3.amazonaws.com/emoticons/emoticon-0102-bigsmile.gif');
editor.addSmilie('http://factoryjoe.s3.amazonaws.com/emoticons/emoticon-0103-cool.gif');
editor.addSmilie('http://factoryjoe.s3.amazonaws.com/emoticons/emoticon-0105-wink.gif');
editor.addSmilie('http://factoryjoe.s3.amazonaws.com/emoticons/emoticon-0106-crying.gif');
editor.addSmilie('http://factoryjoe.s3.amazonaws.com/emoticons/emoticon-0107-sweating.gif');
editor.addSmilie('http://factoryjoe.s3.amazonaws.com/emoticons/emoticon-0108-speechless.gif');
editor.addSmilie('http://factoryjoe.s3.amazonaws.com/emoticons/emoticon-0109-kiss.gif');
editor.addSmilie('http://factoryjoe.s3.amazonaws.com/emoticons/emoticon-0110-tongueout.gif');
editor.addSmilie('http://factoryjoe.s3.amazonaws.com/emoticons/emoticon-0111-blush.gif');
editor.addSmilie('http://factoryjoe.s3.amazonaws.com/emoticons/emoticon-0112-wondering.gif');
editor.addSmilie('http://factoryjoe.s3.amazonaws.com/emoticons/emoticon-0113-sleepy.gif');
editor.addSmilie('http://factoryjoe.s3.amazonaws.com/emoticons/emoticon-0114-dull.gif');
editor.addSmilie('http://factoryjoe.s3.amazonaws.com/emoticons/emoticon-0115-inlove.gif');
editor.addSmilie('http://factoryjoe.s3.amazonaws.com/emoticons/emoticon-0116-evilgrin.gif');
editor.addSmilie('http://factoryjoe.s3.amazonaws.com/emoticons/emoticon-0117-talking.gif');
editor.addSmilie('http://factoryjoe.s3.amazonaws.com/emoticons/emoticon-0118-yawn.gif');	
editor.addSmilie('http://factoryjoe.s3.amazonaws.com/emoticons/emoticon-0119-puke.gif');
editor.addSmilie('http://factoryjoe.s3.amazonaws.com/emoticons/emoticon-0120-doh.gif');
editor.addSmilie('http://factoryjoe.s3.amazonaws.com/emoticons/emoticon-0121-angry.gif');
editor.addSmilie('http://factoryjoe.s3.amazonaws.com/emoticons/emoticon-0122-itwasntme.gif');
editor.addSmilie('http://factoryjoe.s3.amazonaws.com/emoticons/emoticon-0123-party.gif');
editor.addSmilie('http://factoryjoe.s3.amazonaws.com/emoticons/emoticon-0124-worried.gif');
editor.addSmilie('http://factoryjoe.s3.amazonaws.com/emoticons/emoticon-0125-mmm.gif');
editor.lineBreak();
*/	
    ...
    editor.addSmilie('http://www.smilies.4-user.de/include/Haushalt/smilie_haus_005.gif');
    editor.addSmilie('http://www.smilies.4-user.de/include/Essen/smilie_essen_134.gif');
    editor.addSmilie('http://www.smilies.4-user.de/include/Einkaufen/smilie_shop_022.gif');
    editor.addSmilie('http://www.smilies.4-user.de/include/Frech/smilie_frech_101.gif');
    editor.addSmilie('http://www.smilies.4-user.de/include/Geburtstag/smilie_geb_049.gif');
    // große Smilies 
	editor.lineBreak();
