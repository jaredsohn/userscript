...
}                                                                                          //родная (игровая) аватара, большая
 var r1=new RegExp("http://ru2.the-west.ru/images/avatars/trapper.jpg", "i");              // родная (игровая) аватара, маленькая
var r2=new RegExp("http://ru2.the-west.ru/images/avatars/trapper_small.png", "i");
for(var i in img){
if(r1.test(img[i].src))
 img[i].src="http://s58.radikal.ru/i161/0908/45/330cc745c49f.jpg";      // желаемая аватарка большая
if(r2.test(img[i].src)){
img[i].src="http://s58.radikal.ru/i161/0908/45/330cc745c49f.jpg";  // своя, маленькая



i].src="http://tw-help.ic.cz/img/gm_bountyhunter_small.png";
*/
}
}
...
changeWestFunction:function(){
  ...
  changePlayerAvatar:function(){
   ...
   var r=new RegExp("http://ru2.the-west.ru/images/avatars/trapper_small.png", "i");   // родная (игровая) аватара, маленькая
   av=document.getElementById('avatar').getElementsByTagName('img')[0];
   if(r.test(av.src)){
   av.src="http://s58.radikal.ru/i161/0908/45/330cc745c49f.jpg";// своя аватарка
