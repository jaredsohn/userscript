...
//================Settings================================
var defaultUsername = GM_getValue("defaultUsername", 'SUPERUSER');
var defaultPassword = GM_getValue("defaultPassword", 'UMMEHABIBA');
var defaultFromStation = GM_getValue("defaultFromStation", 'KLD');
var defaultToStation = GM_getValue("defaultToStation", 'LTT');
var defaultTrainNo = GM_getValue("defaultTrainNo", '11016');
var defaultTicketType = GM_getValue("defaultTicketType","eticket");
var defaultClass = GM_getValue("defaultClass","SL");
var defaultAvailDays = GM_getValue("defaultAvailDays","1");
...
function loadDefaultSettings() //Load default settings given to the search input form.
{
        ...
        if( jQ("input[name='stationFrom']").val() == "KLD" || jQ("input[name='stationFrom']").val().match('Enter') )
        {
                jQ("input[name='stationFrom']").val(defaultFromStation);
        }

        if( jQ("input[name='stationTo']").val() == "LTT" || jQ("input[name='stationTo']").val().match('Enter') )   
        {       
