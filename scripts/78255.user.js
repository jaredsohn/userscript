// ==UserScript==
// @name           Grepolis Show Farm Info On Map
// @namespace      
// @description    Makes it easy to find the farms with good mood quickly by showing all moods/strengths on the map rather than having to mouse over all of them.
