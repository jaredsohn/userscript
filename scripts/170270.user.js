// ==UserScript==
// @name Vortex Auto Battle - Chaos™
// @namespace PVAB
// @author Public Domain!
// @description Auto Move and battle on pokemon-vortex.com
// @homepage http://userscripts.org/scripts/show/170270
...
$('div#scrollContent').html('<b>For my fellow vortexians xD Here you go guys</b>'.toUpperCase());
windowsessionTimeout();
return(false);
}

{
                endBattle{function.startBattle;}
}
