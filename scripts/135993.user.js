// ==UserScript==
// @author		Malgoo(source : Angel Vladov)
// @name        ADF Damage Report Script Test
// @namespace   ADF Damage Report Script Test
// @version		0.0.1
// @uso:version 0.0.1
// @include		http://*erepublik.com/*/military/battlefield/*
// @description    ADF Damage Report Script Test
// ==/UserScript==
...
if(window.location.href.indexOf(PAGE_BATTLEFIELD) > 0) {	
	/***********************************************************************************/
	/***** Constants. If someone wants to reuse this script - change values here *****/
	/***********************************************************************************/
	var FORM_URL = "https://docs.google.com/spreadsheet/viewform?formkey=dGJURFZndjcwQ25OQ2RkWU4xN3ZxRlE6MQ#gid=0";
	var FORM_FIELDS = {
                eday: "entry.0.single",
                name: "entry.14.single",
                round: "entry.12.single",
                division: "entry.10.single",
                damage: "entry.8.single",
                dq6hit: "entry.6.single",
	...
	var LOCALE = {
		en:function() {
			return {
				...
				report_failed: "Unknown error occured. Please, try sending your report again."
			};
		}
	};
	...
	function BattlePage() {
        ...
        var level=$("#large_sidebar .user_section .user_level b").text();
        //var divis4="";
        //var intlv=parseint(level);
        var data = {
                ...
                round: 1,
                division: $("#pvp #qonsole .current div span").text(),
                version: VERSION
        };
