// ==UserScript==
// @name           script graphic pack travian indo
// @version        3.0.0
// @namespace      Diellllll
// @autor          Diel sang scriptmaster
// @email          Diel.only@gmail.com
// @description    Script gp indo
...
if (URL != '')
{
    addCssFile(URL + 'gp_check.css');
    addCssFile(URL + 'unx.css');
...
{    
    ...
    var HTMLtext = '<div class="contentBox01h">' +
                    ...
                    '<p>With a graphic pack you can change the design of travian and shorten the loading time for each site. Many graphic packs can be tested online before you install them on your computer.</p>' +
                    '<div class="content">' +
                        '<table cellpadding="0" cellspacing="0"><tbody>' +
                            ...
                            '<tr>' +
                                '<th>Example</th>' +
                                '<td><pre>file:///c:/travian gp/</pre></td>' +
                            '</tr>' +
                            '<tr>' +
