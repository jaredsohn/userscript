...
// @name           eRepublik WE II Battalion Military Tracker by Denis Cicic
// @namespace      http://www.erepublik.com/en/citizen/profile/1709354
// @description    eRepublik WE II Battalion Military Tracker.
// @version        1.0.2
// @include        http://www.erepublik.com/en
// @include        http://www.erepublik.com/sr
// @require        http://sizzlemctwizzle.com/updater.php?id=80187&days=1&show
...
function preFetchMembers() {
	GM_xmlhttpRequest({
		method: 'GET',
		url: 'http://whiteeagles.freehostia.com/members/IImember',
		onload:function(response) {
...
function Main(e) {
	GM_xmlhttpRequest({
		method: 'GET',
		url: 'http://whiteeagles.freehostia.com/members/IIusers',
		onload:function(response) {
			var statusData = "off";
