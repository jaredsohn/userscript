...
// @source	  http://userscripts.org/scripts/show/154378
// @identifier	  http://userscripts.org/scripts/source/154378.user.js
...
//alert('entro');
	...
	BFather = (document.getElementById('yt-masthead-content'))?document.getElementById('yt-masthead-content'):document.getElementById('masthead-utility');//postxanadus old
	...
	button.innerHTML = '<img id="us_icon_small" style="margin: 10px 5px -3px 0px;" src="'+us_icon()+'" alt="audioscrobbler.com" /><a class="start">Scrobble</a>';//postxanadus
...
//
//Thanx to Crosbow and Xanadus for original Code
////////////////////////////////////