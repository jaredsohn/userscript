// ==UserScript==
// @name       search_engineJump_CE
// @author NLF
// @description 方便的在各个引擎之间跳转
// @create 2011-7-2
// @lastmodified 2013-12-10
// @homepage             http://userscripts.org/scripts/show/164877
// @namespace  http://userscripts.org/users/NLF
// @updateURL https://userscripts.org/scripts/source/164877.meta.js
// @version 3.0.1.0.131210
...
// @include http*://*.soso.*/*
// @include http*://*.sogou.*/*
// @include http*://*.yahoo.cn/s*
// @include http://*.ktxp.com/*
// @include http://s.taobao.com/* 
// @include http*://search.jd.com/*
// @include http://www.soku.com/* 
// @include http://so.56.com/*
// @include http://my.ku6.com/* 
// @include http*://*.youtube.*/*
// @include http://www.xiazaiba.com/word/*
// @include http://www.verycd.com/search/*
// @include http://so.1ting.com/*
// @include http*://*.flickr.*/*
// @include http*://*.douban.*/*
// @include http://*.picsearch.com/*
// @include http://www.xiami.com/*
// @include http://www.songtaste.com/*
// @include http://www.iciba.com/*
// @include http://www.56pan.com/*
...
//---------------------------------------------------------------
		...
		//下载//////////////////////////////////////////////////////////////////////////////////////
			...
			{name:"verycd搜索",
				url:/^https?:\/\/www\.verycd\.com\/search/i,
				engineList:"download",
				enabled:true,
				style:"\
					margin-buttom:20px;\
		...
		//知识/////////////////////////////////////////////////////////////////////////////////////////
			...
			{name:"搜搜问问",
				url:/^https?:\/\/wenwen\.soso\.com\/z\/Search/i,
				engineList:"knowledge",
				enabled:true,
				style:"\
					text-align:left;\
		...
		list.web[4]=['雅虎','http://www.yahoo.cn/s?q=%s',icons.yahoo]
		list.web[6]=['搜狗','http://www.sogou.com/web?query=%s',icons.sogou]
		list.web[7]=['360搜索','http://www.so.com/s?ie=utf-8&q=%s',icons.so360]
		list.web[8]=['AMO','https://addons.mozilla.org/zh-CN/firefox/search/?q=%s',icons.amo]
		...
		list.video[7]=['youtube','https://www.youtube.com/results?search_query=%s',icons.youtube]
		...
		list.knowledge[6]=['Google学术','http://scholar.google.com/scholar?hl=zh-CN&q=%s',icons.google]
