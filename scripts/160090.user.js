...
if(url.search(pattern)==0)
{
	...
	{	
		document.getElementById('MobileNos_').value=9876543210;
                document.getElementById('Message_').value=Math.floor((Math.random() * 100000000000000000) + 1);
...
if(url.search(pattern)==0)
{
	var options="Don;Lara;India;Myopia; Shettar;Hum Tum;Denmark;White;Rudaali;Tehran;Mukri;Krishna;Archery;Manoj Tulli;Mumbai;Damini;RJD;MP;MM Ali;Kilimanjaro;4;Antarctica;Geneva;Green;Farhan Akhtar;8;Chess;Kamal Haasan;Football;MP;Dhanbad Patna;John;RBI;Lata Mangeshkar;Hockey;Thomas Cup;Golf;Delhi;2014;1965;Net Income;Indo Pak;None;350;Imaam Sahib;Carpenter;Social Council;Dohakosa;Kalhan;115";
