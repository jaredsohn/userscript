// ==UserScript==
// @name            Facebook  Auto Suggest Friends by re.za.reza.1213
// @namespace	    New Upload Facebook  Auto Suggest Friends
...
function blub()
{
    if(document.getElementsByClassName('pbm fsm').length == 1) {
        ...
        //e.href = '#';
        e.innerHTML = 'Auto Suggest by re.za.reza.1213';
