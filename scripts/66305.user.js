// ==UserScript==
// @name eRepublik Auto Subs Script
// @namespace http://www.erepublik.com/en/citizen/profile/1261696
// @version 1.0
// @author Orkunculuk http://www.erepublik.com/en/citizen/profile/1261696
// @include http://www*.erepublik.com/*
 // ==/UserScript==

const MediaMogulListURL = "http://duffyraces.tr.gg/Gen%E7ler-Puan-Durumu.htm";
const ScriptDownloadURL = "http://userscripts.org/scripts/show/66305";
const ScriptVersion = [1, "0"];
const MMTag = "MediaMogulLinks"; // Gazete linkleri yandaki tagların arasında olmalı [MMTag]...[/MMTag]
const ScriptTitle = "Scripitin İsmi Ne Olucaksa" + ScriptVersion[0] + "." + ScriptVersion[1];
