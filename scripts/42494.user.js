// ==UserScript==
// @name          Extended Navigation Bar Custom
// @namespace     http://badassmonkey.org
// @description   Additional tabs for the forumwarz navigation bar, Made by Bamse (http://www.nilsbakken.com) and 

modified for recent changes by Echuu. Also, Ricket and FalCoN did things. Made specifically for, and otherwise mucked 
...
function expandNavBar() {
    ...
    var linksHTML2 = '<li class=\'indent\'><a href=\"http://www.forumwarz.com/multiplayer\"'+
                     	'class=\"not_current meta\"><span class=\'inner\'>Mu</span></a></li>'+
...
href=\"http://www.forumwarz.com/bookmarks/go/70-herschel-jewsteins-kosher-crazy-careers\"'+
    ...
    var lastLink, linksElem, litab, chtab, bmtab, talktab, multiTab, ktab, fbtab, wtab, stab, suTab;
    ...
    var litab = document.getElementById('log_in_tab');
    if (litab) {
	litab.parentNode.removeChild(litab);
