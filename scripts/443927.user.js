// ==UserScript==
// @name           iBOOD Autosubmit to sofortÜberweisung (DE)(no longer PayPal)
// @namespace      Allows you to Fast Forward required forms in iBOOD
// @description    When Ibood organises a "hunt", it can be very hard to obtain some objects due to the limited quantity. This script will auto-submit the forms directly up to the sofortÜberweisung page.
...
// @downloadURL    http://userscripts.org/scripts/source/443927.user.js
// @updateURL      http://userscripts.org/scripts/source/443927.meta.js
...
var quantity = 1;
var paymentprovider = 32; //sofortÜberweisung
...
$(document).ready(function() {
    $("input[pmmethod=sofortÜberweisung]").click();
