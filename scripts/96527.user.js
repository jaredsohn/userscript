// JavaScript Document
// ==UserScript==
// @name           Ikariam Solarium 2.4
// @autor          boskimaras
// @e-mail         bossmaras@wp.pl
...
Noche('#city #container .phase16, #city #container .phase17 {    background-image:url(http://boskimaras.republika.pl/city_level24.jpg);}');
Noche('#city #container .phase18, #city #container .phase19 {    background-image:url(http://solarium.pezmc.com/Night/city_phase7.jpg);}');
Noche('#city #container .phase20 {    background-image:url(http://boskimaras.republika.pl/city_level24.jpg);}');
Noche('#city #container .phase24 {    background-image:url(http://boskimaras.republika.pl/city_level24.jpg);}');

//-----------------------------------edificios--------------------------------

Noche('#city #container #mainview #locations .shipyard .buildingimg {	left:-22px; top:-20px; width:129px; height:100px; background-image:url(http://boskimaras.republika.pl/building_shipyard.gif);	}'       );
Noche('#city #container #mainview #locations .museum .buildingimg {	left:-8px; top:-38px; width:105px; height:85px;  background-image:url(http://boskimaras.republika.pl/building_museum.gif);	}');
Noche('#city #container #mainview #locations .warehouse .buildingimg {	left:0px; top:-33px; width:126px; height:86px;  background-image:url(http://boskimaras.republika.pl/building_warehouse.gif);	}');
Noche('#city #container #mainview #locations .wall .buildingimg {	left:-500px; top:-15px; width:720px; height:137px;   background-image:url(http://boskimaras.republika.pl/building_wall.gif);	}');
Noche('#city #container #mainview #locations .tavern .buildingimg {	left:-10px; top:-15px; width:111px; height:65px;  background-image:url(http://boskimaras.republika.pl/building_tavern.gif);	}');
Noche('#city #container #mainview #locations .palace .buildingimg {	left:-10px; top:-42px; width:106px; height:97px;  background-image:url(http://boskimaras.republika.pl/building_palace.gif);	}');
Noche('#city #container #mainview #locations .academy .buildingimg {	left:-19px; top:-31px; width:123px; height:90px; background-image:url(http://boskimaras.republika.pl/building_academy.gif);	}');
Noche('#city #container #mainview #locations .workshop-army .buildingimg {    left:-19px; top:-31px; width:106px; height:85px; background-image:url(http://boskimaras.republika.pl/building_workshop.gif);}');
Noche('#city #container #mainview #locations .safehouse .buildingimg {	left:5px; top:-15px; width:84px; height:58px; background-image:url(http://boskimaras.republika.pl/building_safehouse.gif);	}');
Noche('#city #container #mainview #locations .branchOffice .buildingimg {	left:-19px; top:-31px; width:109px; height:84px; background-image:url(http://boskimaras.republika.pl/building_branchOffice.gif);}');
Noche('#city #container #mainview #locations .embassy .buildingimg {	left:-5px; top:-31px; width:93px; height:85px; background-image:url(http://boskimaras.republika.pl/building_embassy.gif);	}');
Noche('#city #container #mainview #locations .palaceColony .buildingimg {    left:-10px; top:-42px; width:109px; height:95px;  background-image:url(http://boskimaras.republika.pl/building_palaceColony.gif);	}');
Noche('#city #container #mainview #locations .townHall .buildingimg {	left:-5px; top:-60px; width:104px; height:106px; background-image:url(http://boskimaras.republika.pl/building_townhall.gif);	}');
Noche('#city #container #mainview #locations .barracks .buildingimg {	left:0px; top:-33px; width:100px; height:76px; background-image:url(http://boskimaras.republika.pl/building_barracks.gif); }');
Noche('#city #container #mainview #locations .port .buildingimg {	left:-65px; top:-35px; width:163px; height:131px; background-image:url(http://boskimaras.republika.pl/building_port.gif); }');
Noche('#city #container #mainview #locations li .constructionSite { left:-20px; top:-30px; width:114px; height:81px; background-image:url(http://boskimaras.republika.pl/constructionSite.gif);	}');
Noche('#city #container #mainview #locations .temple .buildingimg { left: 5px; top: -23px; width: 67px; height: 67px; background-image: url("img/city/building_temple.gif"); }');
Noche('#city #container #mainview #locations .forester .buildingimg { left: -5px; top: -31px; width: 126px; height: 85px; background-image: url("img/city/building_forester.gif"); }');
Noche('#city #container #mainview #locations .stonemason .buildingimg { left: -20px; top: -40px; width: 126px; height: 85px; background-image: url("img/citybuilding_stonemason.gif"); }');
Noche('#city #container #mainview #locations .glassblowing .buildingimg { left: -5px; top: -31px; width: 126px; height: 85px; background-image: url("img/city/building_glassblowing.gif"); }');
Noche('#city #container #mainview #locations .alchemist .buildingimg { left: -5px; top: -31px; width: 126px; height: 85px; background-image: url("img/city/building_alchemist.gif"); }');
Noche('#city #container #mainview #locations .carpentering .buildingimg { left: -5px; top: -31px; width: 126px; height: 85px; background-image: url("img/city/building_carpentering.gif"); }');
Noche('#city #container #mainview #locations .architect .buildingimg { left: -5px; top: -31px; width: 126px; height: 85px; background-image: url("img/city/building_architect.gif"); }');
Noche('#city #container #mainview #locations .optician .buildingimg { left: -17px; top: -42px; width: 126px; height: 85px; background-image: url("img/city/building_optician.gif");  }');
Noche('#city #container #mainview #locations .vineyard .buildingimg { left: -5px; top: -31px; width: 126px; height: 85px; background-image: url("img/city/building_vineyard.gif"); }');
Noche('#city #container #mainview #locations .fireworker .buildingimg { left: -5px; top: -31px; width: 126px; height: 85px; background-image: url("img/city/building_fireworker.gif"); }');
Noche('#city #container #mainview #locations .dump .buildingimg { left: -5px; top: -31px; width: 96px; height: 74px; background-image: url("http://boskimaras.republika.pl/building_dump.gif"); }');
Noche('#city #container #mainview #locations .transporter { left: 45px; position: absolute; top: 380px; width: 64px; height: 60px; background-image: url("img/city/transporter.gif"); }');
Noche('#city #container #mainview #locations .protester { height: 44px; left: 325px; position: absolute; top: 188px; width: 46px; z-index: 360; background-image: url("img/city/demonstranten.gif"); }');
