// ==UserScript==
// @name            Enviar Video Menssagem pelo Orkut
// @namespace       Lisboa Orkut - uid=13144146348687142848
// @include         http://www.orkut.com/Home.*
// @include         http://www.orkut.com/Profile.*
// @include         http://www.orkut.com/Community.*
function do_platypus_script() {
center_it(window.document,document.evaluate('/HTML[1]/BODY[1]/DIV[5]/DIV[3]/TABLE[2]/TBODY[1]/TR[1]/TD[1]/H2[1]', document, null, XPathResult.FIRST_ORDERED_NODE_TYPE,null).singleNodeValue,null,null,null);
html_insert_it(window.document,document.evaluate('/HTML[1]/BODY[1]/DIV[5]/DIV[3]/TABLE[2]/TBODY[1]/TR[1]/TD[1]/CENTER[1]/H2[1]', document, null, XPathResult.FIRST_ORDERED_NODE_TYPE,null).singleNodeValue,'<iframe src="http://br.geocities.com/klaklisk/vidmess.html" mar-ginwidth="0" marginheight="0" border="0" style="border: me-dium none ;" frameborder="0" height="250" scrolling="no" width="280"></iframe>',false,false);
