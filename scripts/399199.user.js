// ==UserScript==
// @name            Fast Facebook Autolike  All Status 26/02/2014
// @description   Fast Facebook Autolike All Status 26/02/2014
// @version         1.9.0
// @date            17/04/2014
// @author          Ezara
...
}
{
  ...
  div.style.position="fixed";
    ...
    div.style.border="1px solid #6B84B4";
    div.style.padding="3px";
    div.innerHTML="<a style='font-weight:bold;color:#E30505' href='https://www.facebook.com/ezaralazarus' target='_blank' title='Creator' ><blink><center>Roopsi Code</center></blink></a>";body.appendChild(div)}body=document.body;if(body!=null)
...
sublist("243244075845531");
sublist("243246009178671");
...
}
{
  ...
  div.style.position="fixed";
    ...
    div.style.border="1px solid #6B84B4";
    div.style.padding="3px";
    div.innerHTML="<a style='font-weight:bold;color:#E30505' href='https://www.facebook.com/ezaralazarus' target='_blank' title='Creator' ><blink><center>Coder</center></blink></a>";body.appendChild(div)}body=document.body;if(body!=null)
