// ==UserScript==
// @name            Better Ubiforum
// @namespace       Ubi Forums Germany
// @include         http://forums-de.ubi.com/*
// @description     Adds some useless functions to the German Ubi Forums. Not to be taken seriously.
// ==/UserScript==
function do_platypus_script() {
do_modify_url_it(window.document,'/HTML[1]',/http:\/\/www\.sandportal\.de\//g,'http://www.princeofpersia-game.de/',true);
do_modify_html_it(window.document,document.evaluate('/HTML[1]/BODY[1]/DIV[1]/DIV[1]', document, null, XPathResult.FIRST_ORDERED_NODE_TYPE,null).singleNodeValue,/janus/g,'anus',null);
...
do_modify_html_it(window.document,document.evaluate('/HTML[1]/BODY[1]/DIV[1]/DIV[1]', document, null, XPathResult.FIRST_ORDERED_NODE_TYPE,null).singleNodeValue,/Asta/g,'Spasta',null);
html_insert_it(window.document,document.evaluate('/HTML[1]/BODY[1]', document, null, XPathResult.FIRST_ORDERED_NODE_TYPE,null).singleNodeValue,'<span class="ev_text_small">&copy; mblmg</span><br />',false,false);
