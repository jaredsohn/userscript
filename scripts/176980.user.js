...
function buildPresetWidget()
{
    ...
    var C = $("<ul/>", {
        id: "t_throneStatList",
        addClass: "presetList",
        style: "padding: 0; width: 190px; margin: 0px; list-style: none; overflow: hidden; float: left; border: none;"
    });
    $.each(E, function (K, L) {
        C.append(L)
    })
...
Tabs.organizer = {
        ...
        init : function (div){
        	...
        	m += '<div id="preset_tt"> <b>: </b> </div></a>';
                ...
                if (presetData.num_presets > 0)
                {
                   m += "Switch to slot <INPUT id=trPresetNumber type=text size=1 maxlength=1 value='" + parseInt(presetData.usePreset) + "' </input> when loading";
                }
                m +=  "</span></td></tr>" ;
            }
            ...
            $("#trLocalPresetList option").hover(
        	    function (e) {
        		var target = $(e.target); 
        		var id = target.val();
        		if (id >= 0 ) {
