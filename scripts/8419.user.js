...
// @include       http://*myspace.com/*=143963219
// @include       http://*myspace.com/*=143963219&*
// @exclude       http://comments.myspace.com/*
// ==/143963219Script==

// redirect away from the collect server
if(location.href.match(/collect.*=143963219.*[^(commentForm)]*/)) location.href = 'http://myspace.com/index.cfm?fuseaction=143963219';
...
s+= "#home_additionalLinks,#home_setHomePage, #home_143963219URLInfo,#home_schools, #home_searchAddressBook,#squareAd, iframe, #footer, a[href*='invite.history']{display:none}\n";
