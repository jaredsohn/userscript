// ==UserScript==
// @name            7chan - Noko Sage
// @namespace   x
// @include         https://7chan.org/*
// ==/UserScript==

function do_platypus_script() {
html_insert_it(window.document,document.getElementById('email'),'<script>$(document).ready(function(){$("a[class=autofill]").click(function(){$("input[name=em]").val($(this).text());return false;});});</script> [ <a href="javascript:;" class="autofill">noko</a> / <a href="javascript:;" class="autofill">sage</a> ]',false,false);
