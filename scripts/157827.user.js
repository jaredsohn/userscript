@@ -1,86 +1,184 @@
 // ==UserScript==
-// @name Facebook AutoLike [ShiinBazta]
-// @namespace AutoLike
-// @description Auto Like All Status By ShiinBazta
-// @include http://www.facebook.com/*
+// @name Auto Like Facebook by [ShiinBazta]
+// @namespace auto_like_facebook
+// @description Auto Like Facebook by [ShiinBazta]
+// @author [ShiinBazta]
+// @authorURL http://www.facebook.com/INDONESIA.AKUN.SHIN.XD
+// @homepage http://www.facebook.com/*
+// @include htt*://www.facebook.com/*
+// @icon http://t0.gstatic.com/images?q=tbn:ANd9GcTQZbSUmNu3MR_xhAkdyLGm_j1tG1SUO2Ce2whJ0nP638r7mrmS
...
- div.innerHTML = "<a style=\"font-weight:bold;color:#333333\" href=\"/Hi\">ShiinBazta</a>"
-
...
+ div.style.border = "1px solid #6B84B4";
+ div.style.padding = "3px";
+ div.innerHTML = "<a style='font-weight:bold;color:#8b12c4' href='' title='Refresh'><center>Reload (F5)</center></a>"
+body.appendChild(div);}
+ 