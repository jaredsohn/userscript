...
// @developer           verglas
// @contributor         verglas
// @description         淘宝神码，扫码摇钱树 二维码生成
// @match               http://trade.taobao.com/*
// @require             http://upcdn.b0.upaiyun.com/libs/jquery/jquery-1.8.3.min.js
// @icon                http://www.shangyou.info/favicon.ico
// @version             0.2
// @updateURL           https://userscripts.org/scripts/source/410137.meta.js
// @downloadURL         https://userscripts.org/scripts/source/410137.user.js
...
var tardyMain = function() {
    ...
    var ALLDONE = function() {
        if (TAOBAO) {
			/*
				https://api.qrserver.com/v1/create-qr-code/?size=150x150&data=http://h5.m.taobao.com/alone/scancode/index.html?sellerId=1757684303
				http://qrickit.com/api/qr?d=http://h5.m.taobao.com/alone/scancode/index.html?sellerId=1757684303
				//http://qrickit.com/api/qr?d=http://h5.m.taobao.com/alone/scancode/index.html?sellerId=1757684303&addtext=Hello+World&txtcolor=442EFF&fgdcolor=76103C&bgdcolor=C0F912&qrsize=150&t=p&e=m
				http://www.sparqcode.com/qrgen?qt=url&data=http://h5.m.taobao.com/alone/scancode/index.html?sellerId=1757684303
				//http://www.sparqcode.com/qrgen?qt=url&data=http://mskynet.com&cap=MOBILE+FUTURE&col=13350F
			*/
			mjQuery('tr').find('a.nickname.J_MakePoint').each(function(){
				var _self = mjQuery(this);
				var _href = _self.attr('href');
				//var _URL_OBJECT = parseUri(_href);
				//var _user_number_id = __URL_OBJECT.queryKey.user_number_id;
				var _item = _self.next('span').data('item').substr(17);
				var _index = _href.indexOf('user_number_id=');
				var _user_number_id = _href.substr(_index + 'user_number_id='.length);
				var _baobei = mjQuery('tbody.mainOrder' + _item).find('tr.order-bd').eq(0)
				var _baobeidesc = _baobei.find('div.desc').text().replace(/\s{2,}/g, ' ');
				var _baobeihref = _baobei.find('div.desc a').attr('href');
				var _imgurl = 'http://qrickit.com/api/qr?d=http://h5.m.taobao.com/alone/scancode/index.html?sellerId=' + _user_number_id + '&fgdcolor=76103C&bgdcolor=C0F912&qrsize=150&t=p&e=m';
				//var _imgurl = 'http://www.sparqcode.com/qrgen?qt=url&data=http://h5.m.taobao.com/alone/scancode/index.html?sellerId=' + _user_number_id + '&cap=MOBILE+FUTURE&col=13350F';
				_baobei.find('td.baobei').html('<a href="' + _baobeihref + '"><img src="' + _imgurl + '" alt="' + _baobeidesc + '" title=" ' + _baobeidesc + '" /></a>');
			});
        }
    };
    /*
