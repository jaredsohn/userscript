// ==UserScript==
// @name		Attacks-Renamer-tribalwars-plapl.com
// @version    1.3
// @description  tribalwars: اعدت تسمية الهجمات  اخكوم عربي اصيل
...
function labelAttack(){
   ...
   return unescape(strReturn)
	...
	mySetInner(myInsCell(1),arrValues[3]+' حقول www.plapl.com').colSpan=2;
	newRow=myInsRow();
