...
// @author Anonymous
// @description 通过替换swf播放器的方式来解决优酷的黑屏广告+Bilibili黑科技 In God，We Trust.
// @version 1.367.4
// @icon http://extensiondl.maxthon.cn/skinpack/17276781/1366787326/icons/icon_48.png
// @include http://*.youku.com/*
// @include http://player.ku6cdn.com/*
// @include http://player.ku6.com/*
// @include http://*.iqiyi.com/*
// @include http://*.*letv*.com/*
// @include http://js.tudouui.com/*
...
(function() {
    ...
    YoukuAntiAds.prototype = {
        ...
        get players() {
            if(!this._players) {
                this._players = {
                    'youku': 'http://git.oschina.net/qiufeng/antiad/raw/master/loader.swf',
                    'ku6': 'http://git.oschina.net/qiufeng/antiad/raw/master/ku6.swf',
                    'iqiyi': 'http://git.oschina.net/qiufeng/antiad/raw/master/iqiyi.swf',
                    'iqiyi5': 'http://git.oschina.net/qiufeng/antiad/raw/master/iqiyi5.swf',
                    'tudou': 'http://git.oschina.net/qiufeng/antiad/raw/master/tudou.swf',
                    'tudou_olc': 'http://git.oschina.net/qiufeng/antiad/raw/master/olc_8.swf',
                    'tudou_sp': 'http://git.oschina.net/qiufeng/antiad/raw/master/sp.swf',
                    'letv': 'http://git.oschina.net/qiufeng/antiad/raw/master/letv.swf'
                };
            }
