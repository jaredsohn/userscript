...
// ==/UserScript==
	...
	var prefs={
		floatWindow:true																	,//显示悬浮窗
				FW_position:4																	,//1:出现在左上角;2:出现在右上角;3：出现在右下角;4：出现在左下角;
	...
	var SITEINFO_D={
		enable:true							,//启用
		useiframe:true				,//(预读)是否使用iframe..
		viewcontent:true			,//查看预读的内容,显示在页面的最下方.
		autopager:{
			enable:true						,//启用自动翻页...
			manualA:false				,//手动翻页.
			...
			maxpage:99						,//最多翻多少页..
			ipages:[true,7]			,//立即翻页,第一项是控制是否在js加载的时候立即翻第二项(必须小于maxpage)的页数,比如[true,3].就是说JS加载后.立即翻3页.
