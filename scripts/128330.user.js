  ...
  init : function (div){
    ...
    try {      
      m = '<DIV style="height:500px; max-height:500px; overflow-y:auto"><TABLE width=100% class=pbOptions cellspacing=0 cellpadding=0>\
        ...
        <TR><TD><INPUT id=deletethrone type=checkbox '+ (Options.ThroneDeleteItems?'CHECKED ':'') +'/></td><TD> Auto delete throne items equal to/below '+ htmlSelector({0:'----', 1:'Simple', 2:'Common', 3:'Uncommon', 4:'Rare', 5:'Epic', 6:'Wonderous'},Options.ThroneDeleteLevel,'id=selecttil') +'</td></tr>\
