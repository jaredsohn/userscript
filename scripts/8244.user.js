...
// Personal - Edit Profile - Personal
    ...
    var newMenuItem = new Array(
        ...
        '<a class="H" href="http://www.orkut.com/TestimonialView.aspx">Testi-Wrote |</a>',
...
for(i=0;i<document.links.length;i++){
	if (document.links[i].innerHTML=='News'){
		document.links[i].parentNode.innerHTML=document.links[i].parentNode.innerHTML+"| <a class=H href='http://www.orkutplus.blogspot.com>Orkut Plus!</a>"
	}
}
;void(0)