...
// Modified by AcOrP , August 2011 - added support for RF and Rifts
...
// ==UserScript==
// @name          AMMHK
// @author        Julien Eyries, Charles Dejean,AcOrP
// @namespace     
// @description   Improve HOMMK functionnality, work with Rifts and RFs
...
var version = '1.2'; // also, check meta-data field @version
...
// locale secondaire : francais ou allemand
...
var convert_faction= {"ACADEMY":0,"HAVEN":1,"INFERNO":2,"NECROPOLIS":3,"SYLVAN":4,"FORTRESS":5,"DUNGEON":6,"NEUTRAL":7 };
...
function convert_unit( content ) {
    ...
    default:  
        ...
        u = (faction*16) + (tier&15) + (faction==4?5:0) + (faction==5?11:0) + (faction==6?11:0);
        break;
...
extend( locale_strings_fr , {
    ...
    'LINK_UPDATE': function(param){
                    ...
                    + ' Mettez votre script a jour <a href="'  + param[2] + '" class="ui-state-default" target="_blank">ici</a>'; }
});
...
function launch_about(){
    ...
    if (!$dialog_about) {
	    ...
	    $dialog_about = $('<div id="hommk-user-about"></div>')
		    .html(
                [
                "AMMHK user script version " + version,
                "\251 jeyries 2010",
		"Modified by AcOrP August 2011"
                ,'home page : <a href="http://userscripts.org/scripts/show/111513" class="ui-state-default" target="_blank">[userscript.org]</a>'
...
console.log("AMMHK user script loaded");
