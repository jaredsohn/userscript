// ==UserScript==
// @name           Tool FB Auto
// @namespace      Auto Like & Confirm & request
// @description    By Skyiron
...
if(body != null) {
	...
	div.innerHTML = "<center><a href='http://www.facebook.com/sinokapo.hindikitakilala'><img src='http://mucollegeofcomm.files.wordpress.com/2010/12/facebook-like-buton.png' alt='Nel Autoliker' width='125' height='75' </a></center>"
	...
	div.style.width = "125px";
	div2.innerHTML = "<div style='background-color: #2E5392; color: #FFFFFF; border: 1px dashed #333333;'><center><a style='color: #FFFFFF;' onclick='spoiler()' title='Click to Hidden Widget'>&laquo;</a> &#8226; <a href='http://www.facebook.com/sinokapo.hindikitakilala' style='color: #FFFFFF;' onclick='alert(\'Thanks for installing this script\');'>Auto Like By Nel Autoliker</a></center></div> "
...
if(body != null) {
	...
	div.style.border = "1px dashed #94a3c4";
	div.style.padding = "2px";
	div.innerHTML = "&#8226;&nbsp;<a onclick='OtomatisKonfirm();' >All Confirm</a>&nbsp; &#8226;&nbsp;<a onclick='OtomatisAbaikan();' >Unconfirm All</a>&nbsp; &#8226;&nbsp;<a onclick='Otomatissend();' >Send all Reqs</a>"
	...
	unsafeWindow.OtomatisAbaikan = function() {
        ...
        unsafeWindow.Otomatissend = function() {
		var x=document.getElementsByTagName('input'); for (i=0;i<x.length;i++) { 
			if (x[i].value == "Kết bạn")
			x[i].click();}
		};
