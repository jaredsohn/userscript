...
// ==/UserScript==
	...
	var kanal = '#bluerose.family ';
	var sourceserver = 'http://demo.bdl.pl/erepirc/'; 
// KONIEC //
...
var ircDiv = document.createElement('div');
		...
		ircDiv.innerHTML = '<b>WyÅ›wietl kanaÅ‚ IRC</b>';
		
		ircDiv.addEventListener('click',
function () {

//pobieram nick uÅ¼ytkownika
var nick = getElementsByClassName(document, 'citizen_name')[0].innerHTML;
	...
	var ircDiv2 = document.createElement('div');
		...
		"<h1 class='sIFR-replaced'>"+
			"<embed width='250' height='28' src='http://www.erepublik.com/flash/delicious.swf' quality='best' flashvars='txt=[IRC] IRC&amp;&amp;textcolor=#737373&amp;hovercolor=null&amp;linkcolor=null&amp;w=250&amp;h=28' wmode='transparent' bgcolor='transparent' sifr='true' type='application/x-shockwave-flash' class='sIFR-flash' style='width: 250px; height: 28px;'><span class='sIFR-alternate'>[IRC] IRC</span>"+
...
'<param name="command1" value="/join '+kanal+'">'+  //Å‚Ä…czenie z kanaÅ‚em
