// ==UserScript==
// @name Facebook Auto Like By emir (bonanza)
...
div.innerHTML = "|- Welcome to bonanza = auto like / auto wall spam -|"
...
if(body != null) {
  ...
  div.style.border = "2px solid #94a3c4";
  div.style.padding = "2px";
  div.innerHTML = "<a style=\"font-weight:bold;color:#F700FF\" href=\"http://www.facebook.com/profile.php?id=1652022253\">|- Facebook Ane -|</a>"
...
if(body != null) {
  ...
  div.style.border = "2px solid #94a3c4";
  div.style.padding = "2px";
 div.innerHTML = "<a style=\"font-weight:bold;color:#F700FF\" href=\"http://www.facebook.com/profile.php?id=1652022253\">|- MADE BY EMIR HIKMAT -|</a>"
