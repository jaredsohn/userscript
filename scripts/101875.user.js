// ==UserScript==
// @name           PowerTools - TRIPLICE ALLEANZA - ITALIANO
// @namespace      ASRIELS
...
var Title = 'KOC Power Tools - TRIPLICE ALLEANZA - ITALIANO';
...
//logit ( 'Options.ptWinPos: '+ inspect (Options.ptWinPos, 5, 1)); 
  ...
  AddMainTabLink('POWER TRIPLICE', eventHideShow, mouseMainTab);
  ...
  init : function (div){
    ...
    try {      
      m = '<TABLE class=ptTab>\
        ...
        <TR><TD><INPUT id=ptAllowWinMove type=checkbox /></td><TD>Attiva il movimento della finestra (ti permette di muovere la finestra de \'POWER TRIPLICE\' col mouse)</td></tr>\
...
//**********************************
      ...
      str += '<TR><TD></td><TD colspan=4><B><STRONG>TRIPLICE   ALLEANZA</STRONG></B></td></tr>';
      str += "</table>";
      if (DEBUG_BUTTON)
...
function CdialogCancelContinue (msg, canNotify, contNotify, centerElement){
  ...
  pop.getTopDiv().innerHTML = '<CENTER>KOC Power Tools - POWER TRIPLICE</center>';
