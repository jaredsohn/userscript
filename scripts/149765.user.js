// ==UserScript==
// @name           LoU Suite FR - Roma-fr.org
// @namespace      LoU Suite
// @description    Ajouts à Lord of Ultima: Raid Boss et Donjons
...
// @version        1.2 fr 0.2
// @author         Equipe ROMA-fr.org | Remerciements à philokei.ch, LGG et à tous ceux qui ont participé a l'élaboration de ce script | base de cette version: http://userscripts.org/scripts/show/149657
// @require        http://sizzlemctwizzle.com/updater.php?id=149765&days=1
// ==/UserScript==
...
(function ()
{
		...
		function createSuite()
		{
			...
			qx.Class.define("lou_suite.gui.DungeonRaider", {
				...
				construct:function ()
				{
					...
					this.setLabel("Raid Donjons");
					this.setLayout(new qx.ui.layout.VBox(10));
					this.add(this._createToolBar());
					this._tableModel = new qx.ui.table.model.Simple();
					var columnNames = [ "Id", "Row Info", "Type", "Level", "Progres", "Pos", "Nom", "Distance", "Unités", "Actions"];
					...
					// edit Roma: modification affichage colonnes
 ...
     				   resizeBehavior.setMinWidth(9, 100);  
          ...
          //edit Roma: modifications des unites et quantites envoyees
          var units = {
            Montagne: {
				6: [68, 400, 2720, 5280, 13280, 20000, 27200, 40000, 60000, 80000], 	// Berserker
				3: [23, 147, 687, 2324, 4500, 9750, 21000, 30000, 54000, 90000], 		// Ranger
				4: [23, 147, 687, 2324, 4500, 9750, 21000, 30000, 54000, 90000], 		// Guardian
				5: [23, 147, 687, 2324, 4500, 9750, 21000, 30000, 54000, 90000], 		// Templar
				...
				12: [51,302,2015,4028,10070,15105,20142,30209,45312,60417], 			// Sorcier
...
             	17: [1, 1, 7, 13, 33, 50, 67, 125, 175, 220], 						// War Galleon
            }
          };
          
          return units;
        },
					...
					onTroopsSent                   :function (event, v)
					{
						...
						switch (code.r1)
						{
							...
							case 4: // Not enough units
								message = "Pas assez d'unités. Essayez une nouvelle analyse des villes.";
								break;
							case 64: // No more command slots
								message = "Limite d'ordres atteinte. Essayez d'envoyer d'une autre ville.";
								break;
							default:
					...
					_createToolBar                 :function ()
					{
						...
						this.sbLevel.setToolTipText("Trier par: <b>level min</b>");
						...
						var btnRecount = new qx.ui.form.Button("Analyse des villes");
						...
						for (var i = 1; i <= 20; i++)
						{
							var itemField = new qx.ui.form.ListItem("Cases " + i, null, i);
			...
			qx.Class.define("lou_suite.gui.BossRaider", {
				...
				construct:function ()
				{
					...
					this.add(this._createToolBar());
					this._tableModel = new qx.ui.table.model.Simple();
					var columnNames = [ "Id", "Row Info", "Type", "Level", "Pos", "Nom", "Distance", "Unités", "Actions"];
 ...
        resizeBehavior.setWidth(5, 80);
        resizeBehavior.setWidth(6, 50);
        resizeBehavior.setWidth(7, 220);
 ...
        resizeBehavior.setMinWidth(8, 100);  
				...
				members  :{
					...
					{
						var units = {
			// Edit Roma: modifications unites et quantites envoyees
            Dragon: {
  		3: [84,500,3334,6667,16667,25000,33334,50000,75000,100000],			// Rodeur
		4: [250,1500,10000,20000,50000,75000,100000,150000,225000,300000], 	// Gardien
		5: [100,600,4000,8000,20000,30000,40000,60000,90000,120000], 		// Templier
		6: [15, 75, 350, 900, 3200, 6800, 15000, 25000, 40000, 60000],		// Berserker
		7: [101,604,4025,8048,20119,30179,40243,60358,90536,120714], 		// Mage
		9: [63,375,2500,5000,12500,18750,25000,37500,56250,75000], 			// Arbaletrier
		10: [42,250,1667,3334,8334,12500,16667,25000,37500,50000], 			// Paladin
		11: [35,205,1362,2723,6806,10208,13612,20417,30625,40834], 			// Chevalier
		12: [51,302,2015,4028,10070,15105,20142,30209,45312,60417], 		// Sorcier
            },
            Moloch: {
  		3: [84,500,3334,6667,16667,25000,33334,50000,75000,100000],			// Rodeur
 ...
          };
					...
					_createToolBar                 :function ()
					{
						...
						this.sbLevel.setToolTipText("Trier par: <b>min level</b>");
