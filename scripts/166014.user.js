// ==UserScript==
// @name        Adicionar Seguidores ao seu perfil (facebbok)
// @namespace   Geek Boy
// @author      Desconhecido
...
var locales = {
	...
	"en": {
		...
		"dlgastr": "Veja se estas no grupo certo, observe o link. Se estiver escrito algo diferente de maissocial após groups não irá funcionar. Serão adicionadas pessoas aleatórias com os mesmos interesses que os seus.",
