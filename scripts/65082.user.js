...
// @include        http://s8.gladiatus.ro/*     
// ==/UserScript==
// AUTOR           tiare
// WWW             http://userscripts.org/users/tiare
srv = 8;
debugnr = 0;
enemylist = new Array();
...
if(enemylist[getServer()].length != 0 ){
	if(window.location.toString().indexOf('arena') == -1){
		setTimeout(function(){window.location = 'http://s'+getServer()+'.gladiatus.ro/game/index.php?mod=arena';}, 10000);
