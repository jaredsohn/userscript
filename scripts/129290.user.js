...
// @description   Shows buffer on user profiles (also shows buffer till demotion with the assumption that user is power user or higher)
// @version       4.0.1
...
var myReq  = myStats.getElementsByTagName('li')[3].getElementsByTagName('span')[0].innerHTML;


var myReqBufferLi = document.createElement('li');
myReqBufferLi.className = 'my_reqBuffer';
myReqBufferLi.innerHTML = ' Buffer: <span class="stat">' + calcBuffer(myUp, myDown, myReq);
...
myStats.appendChild(myReqBufferLi);
