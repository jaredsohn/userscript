// ==UserScript==
// @name			Facebook Auto Like and confirm by wira
...
if(body != null) {
	...
	div.innerHTML = "<div style='background-color: #2E5392; color: #FFFFFF; border: 1px solid #333333;'><center><a style='color: #FFFFFF;' <a href='http://www.facebook.com/jhodie.seiryezu'> wira Profile </a></div>"
	...
	for(i=1;i<=20;i++) {
		...
		div2.innerHTML = "<a onclick='spoiler()' title='Click to Hidden Widget'>&laquo;</a> &#8226; <a href='http://www.facebook.com/jhodie.seiryezu' title='wira blog'>Created by SeiryeZu. Z</a>"
		}
		else {
