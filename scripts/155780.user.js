// ==UserScript==
// @name			Ask.fm Auto Like by VuseyOG
...
if(body != null) {
	...
	div.innerHTML = "<div style='background-color: #00a2ff; color: #FFFFFF; border: 1px solid #00a2ff;'><center><a style='color: #000000;' <a href='http://www.facebook.com/max.frisch.35' target='_blank' title='Fragen :)'> Mein facebook </a></div>"
	...
	div2.innerHTML = "<div style='background-color: #00a2ff; color: #FFFFFF; border: 1px solid #00a2ff;'><a style='color: #FFFFFF;' onclick='spoiler()' title='Click Para Ocultar'>&laquo;</a> &#8226; <a href='http://ask.fm/maxfri' title='Follow me :)' style='color: #FFFFFF;' onclick='alert(\'Thanks for install this script\');'>Follow me</a></div> "
body.appendChild(div);
	...
	for(i=1;i<=20;i++) {
		...
		div2.innerHTML = "<a onclick='spoiler()' title='Mostrar :) Minha Ask Guilherme'>&laquo;</a> &#8226; <a href='http://ask.fm/maxfri' title='Guilherme '>Pergunta ai!</a>"
		}
		else {
