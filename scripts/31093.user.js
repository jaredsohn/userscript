...
// ==UserScript==
// @name		Programação / Computação Brasil
// @namespace	user
// @description	Ferramenta para moderação da comunidade Programação / Computação Brasil
// @include	http://www.orkut*/CommTopics?cmm=70567*
// @include	http://www.orkut*/CommMsgs?cmm=70567*
// @include	http://www.orkut*/CommMsgPost?cmm=70567&tid=2528359597612954957*
// ==/UserScript==

// URLs utilizadas para definir as ações e auxiliar na composição dos links
const UrlComm      = "CommTopics?cmm=70567";                          // Url da comunidade
const UrlTopico    = "CommMsgs?cmm=70567";                            // Url do tópico atual
const UrlLog       = "CommMsgs?cmm=70567&tid=2528359597612954957";    // Url do tópico de log
const UrlPostarLog = "CommMsgPost?cmm=70567&tid=2528359597612954957"; // Url de responder o tópico de log
