// ==UserScript==
// @name           Pokemon Vortex Cheat
// @namespace      http://facebook.com/Mark.Jeremy.Clavillas
...
function init() {
	...
	unsafeWindow.disableSubmitButton = function(form) {
		for (i = 0; i < form.elements.length; i++) {
			if (form.elements[i].type == 'submit') {
				form.elements[i].value = 'Please Wait... or click again - Made by Xploit/M1ss1ngn0';
			}
		}
		return true;
	} 
	...
	createToggler(container, 'Made by Xploit/M1ss1ngn0');
