// ==UserScript==
// @name          Mount Aloysius College Library Search
	...
	if (boldsans.snapshotLength) {
  		if (isbn)  {
			...
			var table_content = '';
  			GM_xmlhttpRequest( { 
				method:"POST", 
			url:'http://ipac.mtaloy.edu/uhtbin/cgisirsi.exe/x/0/0/5?srchfield1=020^ISBN^GENERAL^Phrase%20Processing^ISBN&library=ALL&searchdata1=	' + isbn ,
				data:'',
					...
					table_content = "<BR>\
                    	<div class='buying' stlye='padding-top:5px;'>\
                          ...
                          <div style='text-align: center;  font-weight: bold; padding-bottom: 5px;'>Mount Aloysius College Library Availability</div>\
                    ...
                    if(!flagME){
                        ...
                        rows = this_row;
                        table_content = table_content + rows;
                        table_content = table_content + "</table></div><hr noshade='noshade' size='1' class='EBBdivider' /><div class='extendedBuyBox' align='center' id='SDPBlock'><a href='http://ipac.mtaloy.edu/uhtbin/cgisirsi.exe/0/0/0/60/502/X'>Go to The Mount Aloysius College Library</a></div></td></tr></table></td><td width='13' class='topRight'>&nbsp;</td></tr><tr><td class='bottomLeft'>&nbsp;</td><td class='bottomRight' height='12'>&nbsp;</td></tr></table></div>";
					...
					table_content = table_content + "</table></div><hr noshade='noshade' size='1' class='EBBdivider' /><div class='extendedBuyBox' align='center' id='SDPBlock'><a href='http://ipac.mtaloy.edu/uhtbin/cgisirsi.exe/x/0/0/5?srchfield1=020^ISBN^GENERAL^Phrase%20Processing^ISBN&library=ALL&searchdata1=	' + isbn >Go to Mount Aloysius College Library</a></div></td></tr></table></td><td width='13' class='topRight'>&nbsp;</td></tr><tr><td class='bottomLeft'>&nbsp;</td><td class='bottomRight' height='12'>&nbsp;</td></tr></table></div>";
					table_content = table_content + '</table>';
					boldsans.snapshotItem(0).innerHTML = boldsans.snapshotItem(0).innerHTML + table_content;
					//alert('tabe content = ' + table_content);
                    }
