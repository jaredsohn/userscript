...
// @version       0.1.0
// @include       http://www.teamhb.org/index.php?page=team&subpage=makeorders*
// @include       http://teamhb.org/index.php?page=team&subpage=makeorders*
...
window.setTimeout( function() 
{
	...
	// For each found tag test whether it should be highlighted (i.e. given a lightgreen background)
	for (var i = 0; i < allPlayers.snapshotLength; i++) {
		var thisPlayer = allPlayers.snapshotItem(i);
		if (playerids[thisPlayer.value] === true) {
		    thisPlayer.style.backgroundColor = 'lightgreen';
		}
	}
