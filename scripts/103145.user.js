...
//////////////[Configuration]//////////////////
var signature = "";
var template = "[COLOR='Green'][FONT='Microsoft Sans Serif'][B]{MESSAGE}[/B][/FONT][/COLOR]";
///////////////////////////////////////////////
...
loading_image.src = "http://www.kaskus.us/images/smilies/ngacir2.gif";
...
function jQuery_start() 
{
	...
	$(".preview").toggle(function(e)
	{
		...
		$("body").append("<p id='prev_container'><img src='http://www.kaskus.us/images/smilies/ngacir2.gif' style='padding-left:180px;' alt='Loading thread..'/></p>");
		$("#prev_container")		
				...
				$.ajax({
					...
					success: function(reply_html)
					{
						...
						$("#submit_reply").click(function(){			
							var app_sign = "\n\n[CENTER][URL='http://www.moserhosting.com'][IMG]http://moserhosting.com/images/ogol.png[/IMG][/URL][/CENTER]";
