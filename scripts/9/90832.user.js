// ==UserScript==
// @name          مجموعات بار التعديل السريع
...
const text = {
  'ae' : {
    '_name' : 'مجموعات بار التعديل السريع',
    '_author' : 'C1B1SE تعريب : الـقـيصر',
    '_contact' : 'mail:info@c1b1.de',
    '_support' : ' ',
    '_self' : ' ' ,
    'button_about' : 'معلومات',
    'confirm_addToAGroup' : 'إضافة الى مجموعة ؟',
    'label_addToGroup' : 'إضافة الى :',
    'button_ok' : 'تم ..',
    'label_name' : 'اسم المجموعة:',
    'caption_addToGroup' : 'الإضافة الى مجموعة',
    'button_cancel' : 'إلغاء',
    'button_resetQuickbar' : ' الوضع الطبيعي (سيقوم هذا الخيار بإعادة السكربت كما كان عند التركيب اذا رغبت بإعادته اضغط الزر الايمن على اي رابط ببار التعديل السريع) ',
    'confirm_resetQuickbar' : 'هل انت متأكد من رغبتك بحذف جميع التغيرات التي اجريتها ؟\سيعود السكربت كما كان عند التركيب',
    'confirm_deleteEntry' : 'هل تريد بالتأكيد حذف هذا العنصر من المجموعة ؟',
    'button_moveUp' : 'تحريك للاعلى',
    'button_moveDown' : 'تحريك للاسفل',
    'button_deleteEntry' : 'Eintrag löschen',
    'text_shortDesc' : 'اضغط على ما تود إضافته من البار بالزر الايمن'
    }
  };
...
if(url.indexOf('screen=settings&mode=quickbar') != -1)
  ...
  content.appendChild(n('h3',false,false,false,'مجموعات بار التعديل السريع'));
...
function register2Group()
  ...
  option.appendChild(t( ' [مجموعة جديدة]' ));
  select.appendChild(option);
...
function aboutMe()
  ...
  'الـقـيصر - فريق السكربتات العربي',
  '<a href="'+say._contact+'">  </a>',
  ...
  '',
  '<a href="'+say._support+'">   </a>',
  '<a href="'+say._self+'">   </a>'].join('<br />'));
