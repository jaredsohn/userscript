// ==UserScript==
// @id             Whirlpool.net.au user page sort
// @name           Whirlpool.net.au user page sort
// @namespace      whirlpool
// @description    sort thread links by last post date
// @version			0.1
...
function GM_orderSearch(firstOrLast,upOrDown){
    ...
    var getTrs = $('#userprofile #threads tbody tr');
    var titleTxt=true;
    var plainArr = [];
