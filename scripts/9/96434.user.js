// ==UserScript==
// @name        Facebook : Hapus Aktifitas Terkini
// @namespace   www.wakrizki.net | MasTer Q ™
...
function createButton()
{
    if (!button)
    {
        ...
        <span style='margin-bottom: 10px;padding:3px 8px' class='uiButton uiButtonDefault uiButtonMedium'>Hapus Aktifitas Terkini</span></div></center>";
