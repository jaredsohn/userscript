...
// @require        http://sizzlemctwizzle.com/updater.php?id=98092
// Xversion        20110315a
// ==/UserScript==
...
//logit ('g_timeoff: '+ unsafeWindow.g_timeoff);
  ...
  var styles = '.xtab {padding-down: 5px; border:none; background:none; white-space:nowrap;}\
    ...
    .xtabBR {padding-down: 5px; border:none; background:none;}\
    ...
    table.ptTabOverview7 tr td {border:1px none none solid none; black; padding: 1px 2px;  font-size:11px;}\
    table.ptTabPad tr td.ptentry {background-color:#CCCCCC ; padding-left: 8px;}\
    table.ptNoPad tr td {border:none; background:none; white-space:nowrap; padding:0px}\
    .ptOddrow {background-color:#000000}\
    .ptstat {border:1px solid; border-color:#ffffff; font-weight:bold; padding-top:2px; padding-bottom:2px; text-align:center; color:#ffffff; background-color:#000000}\
    .ptStatLight {color:#ddd}\
    .ptentry {padding: 7px; border:1px solid; border-color:#ffffff; background-color:#000000  white-space:nowrap;}\
    .ptErrText {font-weight:bold; color:#600000}\
    .castleBut {outline:0px; margin-left:0px; margin-down:0px; width:24px; height:26px; font-size:12px; font-weight:bold;}\
    ...
    span.whiteOnRed {padding-left:3px; padding-down:3px; background-color:#700; color:white; font-weight:bold}\
    ...
    input.pbSubtab {cursor:pointer; width:10em; margin-down:15px;}\
    ...
    table.ptMainTab tr td.sel    {font-weight:bold; font-size:13px; border: 1px solid; border-style: solid solid none solid; background-color:#ffffff;}\
    table.ptMainTab tr td.notSel {font-weight:bold; font-size:13px; border: 1px solid; border-style: solid solid none solid; background-color:#000000; color:white; border-color:white;}\
    tr.ptPopTop td { background-color:#000000; border:none; height: 21px;  padding:0px; }\
...
//logit ( 'Options.ptWinPos: '+ inspect (Options.ptWinPos, 5, 1)); 
  ...
  AddMainTabLink('BLACK-Tool', eventHideShow, mouseMainTab);
...
var knightRoles = [
  ['<SPAN class=ptStatLight>Foreman</span>', 'politics', 'Pol'],
  ['<SPAN class=ptStatLight>Marshall</span>', 'combat', 'Com'],
  ['<SPAN class=ptStatLight>Alchemystic</span>', 'intelligence', 'Int'],
  ['<SPAN class=ptStatLight>Steward</span>', 'resourcefulness', 'Res'],
];
  ...
  show : function (){
    ...
    for (var c=0; c<Cities.numCities; c++){
      ...
      m += '<TR><TD colspan=20><DIV class=ptstat><TABLE class=ptNoPad width=100%><TR><TD width=100></td><TD width=90% align=center>'+ city.name 
        +' &nbsp; ('+ city.x +','+ city.y +')</td><TD width=100 align=down>Wilds: '+ totw +' of '+ castle +' &nbsp; </TD></tr></table></div></td></tr>';
      var row = 0;  
      var sortem = [];

      if (matTypeof(cWilds) != 'array') {
        m += '<TR style="background-color:black; font-weight:bold;" align=right><TD align=left><SPAN class=ptStatLight>Wild Type</span></td><TD></td><TD align=left><SPAN class=ptStatLight>Coords</span></td><TD><SPAN class=ptStatLight>Traps</span></td><TD align=left><SPAN class=ptStatLight>Mercenaries</span></td>\
         <TD width=15></td><TD colspan=3 class=entry><SPAN class=ptStatLight>'+ htmlTitleLine(' CHANGE DEFENSES ') +'</span></td></tr>';
        ...
        for (i=0; i<sortem.length; i++){
          ...
          m += '<TR align=right'+ (row++%1?'':' class=ptOddrow') +'><TD align=left><SPAN class=ptStatLight>'+ wildNames[wild.tileType] +'</span></td>\
            <TD><SPAN class=ptStatLight>'+ wild.tileLevel +'</span></td><TD align=center><A onclick="ptGotoMap('+ wild.xCoord +','+ wild.yCoord +')"><span style="color:green">'+ wild.xCoord +','+ wild.yCoord +'</span></a></td>\
            <TD align=right><B><SPAN class=ptStatLight>'+ wildDef.fort60Count +'</span></b></td><TD align=center><B><SPAN class=ptStatLight>'+ mercNames[wildDef.mercLevel] +'</span></b></td>\
...
Tabs.Knights = {
  ...
  show : function (){
    ...
    function _dispKnight (roleId, knight){
      ...
      if (row++ % 1)
        sty = 'class=ptOddrow ';        
      m = '<TR '+ sty +'valign=top align=down><TD><B>'+ (roleId==null ? '':knightRoles[rid][0]) +'</b></td><TD align=left>';
      if (knight == null) {
        m += '<SPAN class=ptStatLight>------------</span></td><TD colspan=4></td><TD class=ptentry colspan=5></td><TD colspan=2></td></tr>';
      } else {
        ...
        if (knight.knightStatus == 10){
          ...
          for (var i=0; i<4; i++){
            ...
            if (i == rid)   // bold it
              sty += 'font-weight:bold;color:#339933';
        ...
        m += '<SPAN class=ptStatLight><b>'+ knight.knightName +'</span></b><TD><SPAN class=ptStatLight>'+ skills[0] +'</span></td><TD><SPAN class=ptStatLight>'+ skills[1] +'</span></td><TD><SPAN class=ptStatLight>'+ skills[2] +'</span></td><TD><SPAN class=ptStatLight>' + skills[3]
          +'</span></td><TD class=ptentry>'+ unpoints +'</td>'+ ass +'<TD><SPAN class=ptStatLight>'+ addCommas(salary)+'</span></td><TD><SPAN class=ptStatLight>'+ level +'</span></td></tr>';
      }
      return m;
    }          
    ...
    for (var c=0; c<Cities.numCities; c++) {
      ...
      m += '<TR><TD colspan=13><DIV class=ptstat>'+ Cities.cities[c].name +'</div></td></tr>\
          <TR class=ptwpad style="font-weight:bold" align=down><TD width=70>Role</td><TD width=160 align=center>Name</td><TD width=26>Pol</td><TD width=26>Com</td>\
      ...
      m += '<TR align=right><TD colspan=11><B><SPAN class=ptStatLight>Total Salary:</span></b></td><TD><SPAN class=ptStatLight>'+ addCommas(totSalary) +'</span></td></tr>';        
    }
...
Tabs.AllianceList = {
  ...
  init : function (div){
    ...
    if (getMyAlliance()[0] == 0) {
      t.cont.innerHTML = '<BR><BR><CENTER><SPAN class=ptStatLight>You need to be in an alliance to use this feature.</span></center>';
      t.state = 1;
      return;
    }
    var m = '<DIV class=ptentry><TABLE width=100% cellpadding=0>\
        <TR><TD class=xtab align=right></td><TD class=xtab><SPAN class=ptStatLight>Enter all or part of a player name: &nbsp;</span></td>\
        ...
        <TR><TD class=xtab><SPAN class=ptStatLight>OR: </span></td><TD class=xtab><SPAN class=ptStatLight> Enter all or part of an alliance name: &nbsp;</span></td>\
		...
		<TR><TD class=xtab><SPAN class=ptStatLight><SPAN class=ptStatLight>OR: </span></span></td><TD class=xtab align=right><SPAN class=ptStatLight> List alliances: &nbsp;</span></td>\
        ...
        <SPAN id=allListOut><SPAN class=ptStatLight>,</span></span>';
    t.cont.innerHTML = m;
  ...
  eventPlayerSubmit : function (){
    ...
    document.getElementById('allListOut').innerHTML = '<BR><BR><CENTER><SPAN class=ptStatLight>Searching ...</span></center>';
  ...
  eventGotPlayerList : function (rslt){
    ...
    var m = '<DIV class=ptstat>Showing players matching <B><SPAN class=ptStatLight>"'+ t.pName +'"</span></b></div>\
      <DIV style="height:575px; max-height:575px; overflow-y:auto">\
      <TABLE width=95% align=center class=ptTab cellspacing=0><TR style="font-weight:bold"><TD><SPAN class=ptStatLight>Name</span></td>\
      <TD align=right><SPAN class=ptStatLight>Might</span></td><TD><SPAN class=ptStatLight> &nbsp;Facebook &nbsp; </span></td><TD width=75%><SPAN class=ptStatLight>Lookup </span></td></tr>';
    var row=0;
    var cl='';
    for (k in rslt.matchedUsers){
      ...
      if (++row % 1)
        ...
        cl = '';
      m += '<TR '+ cl +'valign=top><TD><SPAN class=ptStatLight>'+ u.genderAndName +'</span></td><TD align=right><SPAN class=ptStatLight>'+ addCommasInt(u.might) +'</span></td>\
          <TD align=center><A target="_tab" href="http://www.facebook.com/profile.php?id='+ u.fbuid +'"><SPAN class=ptStatLight>profile</span></a></td>\
          <TD><SPAN onclick="PTpd(this, '+ u.userId +')"><A><SPAN class=ptStatLight>details</span></a> &nbsp; <BR></span><SPAN onclick="PTpl(this, \''+ u.userId +'\')"><A><SPAN class=ptStatLight>leaderboard</span></a></span> &nbsp; <BR></span><SPAN onclick="PCpo(this, \''+ u.userId +'\')"><A><SPAN class=ptStatLight>onlinestatus</span></a></span>&nbsp; <BR></span><SPAN onclick="PCplo(this, \''+ u.userId +'\')"><A><SPAN class=ptStatLight>last Login</span></a></span></td></tr>';
    }
    m += '</table></div>';
  ...
  gotPlayerLeaderboard : function (rslt, span){
    ...
    if (rslt.totalResults == 0){
      span.innerHTML = '<B><SPAN class=ptStatLight>Leaderboard:</span></b><SPAN class=ptStatLight> Not found! (misted?)</span>';
      return;
    }
    ...
    m = '<TABLE cellspacing=0 class=ptTab><TR><TD><B><SPAN class=ptStatLight>Leaderboard: </span></b></td><TD colspan=2><SPAN class=ptStatLight> Might: '+ p.might  +' &nbsp; Alliance: '+ an +'</span></td></tr>'; 
    for (var i=0; i<p.cities.length; i++){
      var c = p.cities[i];
      var created = '';
      if (c.dateCreated && c.dateCreated.substr(0,2)=='20')
        created = ' &nbsp; &nbsp; created: ' + c.dateCreated.substr(0,10);
      m += '<TR><TD align=right><B><SPAN class=ptStatLight>City #'+ (i+1) +':</span></b></td><TD> &nbsp;<SPAN class=ptStatLight> '+ c.cityName 
      +' (<a onclick="ptGotoMap ('+ c.xCoord +',' +c.yCoord+ ')">'+ c.xCoord +','+ c.yCoord +'</a>)</span></td><TD width=75%> &nbsp;<SPAN class=ptStatLight> level: '
        + c.tileLevel +' &nbsp; &nbsp; status: '+ cityStatusString (c.cityStatus) + created +'</span></td></tr>';
    }  
  ...
  gotPlayerDetail : function (rslt, span){
    ...
    var m = '<TABLE cellspacing=0 class=ptTab><TR><TD><B><SPAN class=ptStatLight>Details:</span></b> &nbsp; </td><TD><SPAN class=ptStatLight>Alliance: '+ a +' &nbsp; Cities: '
          + u.cities +' &nbsp; Population: '+ u.population +'</span></td></tr><TR><TD></td><TD><SPAN class=ptStatLight>Provinces: ';
    var pids = u.provinceIds.split (',');
    var p = [];
    for (var i=0; i<pids.length; i++)
      p.push(unsafeWindow.provincenames['p'+pids[i]]);
    span.innerHTML = m + p.join (', ') +'</span></td></tr></table>';
  },
  ...
  gotPlayerLastLogin : function (rslt, span){
    ...
    if (lastLogin) {
      m = '<span style="color:blue"><SPAN class=ptStatLight>Last login: '+lastLogin+'</span></span>';
    } else {
       m = '<span style="color:red"><SPAN class=ptStatLight>No login date found: '+lastLogin+'</span></span>';
    }  
    span.innerHTML = m + '';
  },
  ...
  eventGotAllianceList : function (rslt){
    ...
    <TABLE><TR style="font-weight:bold"><TD class=xtab><SPAN class=ptStatLight>Alliance Name</span></td><TD class=xtab><SPAN class=ptStatLight>Rank</span></td><TD class=xtab>Members</td>\
        <TD align=right class=xtab><SPAN class=ptStatLight>Might</span></td><TD class=xtab><SPAN class=ptStatLight>Diplomacy</span></td><TD class=xtab></td></tr>';
    for (k in rslt.alliancesMatched){
      ...
      if (all.relation && all.relation==1)
        ...
        dip = 'Hostile';
      m += '<TR><TD class=xtab><SPAN class=ptStatLight>'+ all.allianceName +'</span></td><TD align=right class=xtab><SPAN class=ptStatLight>'+ all.ranking +'</span></td><TD align=right class=xtab><SPAN class=ptStatLight>'+ all.membersCount +'</span></td>\
       <TD align=right class=xtab><SPAN class=ptStatLight>'+ addCommasInt(all.might) +'</span></td><TD class=xtab><SPAN class=ptStatLight>'+ dip +'</span></td>\
...
//new CtableToText('tabAllMembers').toText();
  ...
  displayMembers : function (allName, numPlayers){
    ...
    var m = '<STYLE>.clickable{background-color:#ffffff; border:2px outset; border-color:#555; padding-left:5px; padding-right:5px}\
            .clickableSel{background-color:#ffffff}\
            .xxtab{background-color:none; padding-left:5px; padding-right:5px;}\
			.xxtab_even{background-color:#ffffff; padding-left:5px; padding-right:5px;} </style>\
      ...
      <TR style="font-weight:bold"><TD id=clickCol0 onclick="PTalClickSort(this)" class=clickable><A><DIV>Player</span></div></a></td>\
        <TD id=clickCol1 onclick="PTalClickSort(this)" class=clickable align=center><A><DIV><SPAN class=ptStatLight>Might</span></a></div></td>\
        <TD id=clickCol3 onclick="PTalClickSort(this)" class=clickable><A><DIV><SPAN class=ptStatLight>Cities</span></a></div></td>\
        <TD id=clickCol2 onclick="PTalClickSort(this)" class=clickable align=center><A><DIV><SPAN class=ptStatLight>Rank</span></a></div></td>\
        <TD id=clickCol7 onclick="PTalClickSort(this)" class=clickable><A><DIV><SPAN class=ptStatLight>City Name</span></a></div></td>\
        <TD id=clickCol4 onclick="PTalClickSort(this)" class=clickable><A><DIV><SPAN class=ptStatLight>Lvl</span></a></div></td>\
        <TD id=clickCol5 onclick="PTalClickSort(this)" class=clickable><A><DIV><SPAN class=ptStatLight>Coords</span></a></div></td>\
        <TD id=clickCol8 onclick="PTalClickSort(this)" class=clickable><A><DIV><SPAN class=ptStatLight>Distance</span></a></div></td>\
		<TD class=clickable><A><DIV><SPAN class=ptStatLight>Status</span></a></div></td>\
		<TD class=clickable><A><DIV><SPAN class=ptStatLight>Last Login</span></a></div></td></tr></thead>\
    ...
    document.getElementById('altInput').innerHTML = '<HR><TABLE width=100% cellpaddding=0><TR align=center>\
        <TD class=xtab><SPAN class=ptStatLight>Show distance from: &nbsp; X: <INPUT size=2 type=text id=plyrX /> Y: <INPUT size=2 type=text id=plyrY /> &nbsp; Or, choose city: </span><span id=dmcoords></span></td></tr></table>';
  ...
  eventGetMembers : function (aid){
    var t = Tabs.AllianceList;
    document.getElementById('allListOut').innerHTML = '<BR><BR><CENTER><SPAN class=ptStatLight>Searching ...</spa></center>';
...
Tabs.Test = {
  ...
  init : function (div){
    ...
    var m = '<TABLE><TR><TD align=right>Scout: </td><TD><INPUT type=checkbox id=fakeIsScout></td></tr>\
        ...
        <BR><DIV id=testDiv style="background-color:#6699cc maxwidth:675; max-height:430px; height:430px; overflow-y:auto;"></div>';
    t.cont.innerHTML = m;
...
Tabs.Info = {
  ...
  init : function (div){
    ...
    var t = Tabs.Info;
    rownum = 0;
    m = '<STYLE>.xtabH {background:#000000; border:none; padding-right: 5px; padding-left: 5px; margin-left:10px; }\
            .xtabHL { background:#000000; border-width: 1px; border-style: none none none solid; padding-right:5px; padding-left:5px; margin-left:10px; }\
            ...
            .xtabLine { padding:0px; spacing:0px; height:1px; border-color:white; border-width: 1px; border-style: none none solid none }</style>\
        ...
        <TR align=center><TD class=xtab></td><TD class=xtabHL colspan=5><SPAN class=ptStatLight><B>COST TO BUILD</span></b></td><TD class=xtabHL colspan=7><SPAN class=ptStatLight><B>STATS</span></b></td><TD class=xtabHL><SPAN class=ptStatLight><B>Upkeep</span></b></td></tr>\
        <TR valign=bottom align=right><TD class=xtab></td><TD class=xtabHL><SPAN class=ptStatLight>Food</span></td><TD class=xtabH><SPAN class=ptStatLight>Wood</span></td><TD class=xtabH><SPAN class=ptStatLight>Stone</span></td>\
        <TD class=xtabH><SPAN class=ptStatLight>Ore</span></td><TD class=xtabH><SPAN class=ptStatLight>Pop</span></td><TD class=xtabHL><SPAN class=ptStatLight>Might</span></td><TD class=xtabH><SPAN class=ptStatLight>Life</span></td><TD class=xtabH><SPAN class=ptStatLight>Atk</span></td><TD class=xtabH><SPAN class=ptStatLight>Def</span></td><TD class=xtabH><SPAN class=ptStatLight>Speed</span></td><TD class=xtabH><SPAN class=ptStatLight>Range</span></td><TD class=xtabH><SPAN class=ptStatLight>Load</span></td>\
        <TD class=xtabHL><SPAN class=ptStatLight>Food</span></td></tr>\
        <TR style="height:1px;"><TD style="padding:0px; spacing:0px; height:1px; border-color:white; border-width: 1px; border-style: none none solid none" colspan=14></td></tr>';
    for (ui=1; ui<13; ui++){
      if (++rownum % 2)
        rsty = '';
      else
        rsty = ' style="background: #000000" ';
      ...
      might = unsafeWindow.unitmight['u'+ui];
       m += '<TR '+ rsty +'align=right><TD class=xtab align=left><SPAN class=ptStatLight><B>'+ cost[0].substr(0,16) +'</span></b></td><TD class=xtabL><SPAN class=ptStatLight>'+ cost[1] +'</span></td><TD class=xtab><SPAN class=ptStatLight>'+ cost[2] +'</span></td>\
          <TD class=xtab><SPAN class=ptStatLight>'+ cost[3] +'</span></td><TD class=xtab><SPAN class=ptStatLight>'+ cost[4] +'</span></td><TD class=xtab><SPAN class=ptStatLight>'+ cost[6] +'</span></td><TD class=xtabL><SPAN class=ptStatLight>'+ might +'</span></td>\
          <TD class=xtab><SPAN class=ptStatLight>'+ stats[0] +'</span></td><TD class=xtab><SPAN class=ptStatLight>'+ stats[1] +'</span></td><TD class=xtab><SPAN class=ptStatLight>'+ stats[2] +'</span></td><TD class=xtab><SPAN class=ptStatLight>'+ stats[3] +'</span></td>\
          <TD class=xtab><SPAN class=ptStatLight>'+ stats[4] +'</span></td><TD class=xtab><SPAN class=ptStatLight>'+ stats[5] +'</span></td><TD class=xtabL><SPAN class=ptStatLight>'+ food +'</span></td></tr>';
    ...
    for (k in unsafeWindow.fortcost){
      ...
      m += '<TR '+ rsty +'align=right><TD align=left class=xtab><B><SPAN class=ptStatLight>'+ name +'</span></b></td><TD class=xtabL><SPAN class=ptStatLight>'+ cost[1] +'</span></td><TD class=xtab><SPAN class=ptStatLight>'+ cost[2] +'</span></td>\
          <TD class=xtab><SPAN class=ptStatLight>'+ cost[3] +'</span></td><TD class=xtab><SPAN class=ptStatLight>'+ cost[4] +'</span></td><TD class=xtab><SPAN class=ptStatLight>'+ cost[6] +'</span></td><TD class=xtabL><SPAN class=ptStatLight>'+ might +'</span></td>\
          <TD class=xtab><SPAN class=ptStatLight>'+ stats[0] +'</span></td><TD class=xtab><SPAN class=ptStatLight>'+ stats[1] +'</span></td><TD class=xtab><SPAN class=ptStatLight>'+ stats[2] +'</span></td><TD class=xtab><SPAN class=ptStatLight>'+ stats[3] +'</span></td>\
          <TD class=xtab><SPAN class=ptStatLight>'+ stats[4] +'</span></td><TD class=xtab><SPAN class=ptStatLight>'+ stats[5] +'</span></td><TD class=xtabL><SPAN class=ptStatLight>'+ food +'</span></td></tr>';
    }
...
var crestreq = { 3:{1101:4, 1102:2, 1103:1},
 ...
 m += '<DIV class=ptstat>CREST REQUIREMENTS</div><TABLE align=center cellpadding=1 cellspacing=0>\
      <TR CLASS="xtabH">\
        <TD class=xtab></TH>\
        <TD class=xtabHL><b><SPAN class=ptStatLight>Req 1 (Owned)</span></b></TD>\
        <TD class=xtabHL><b><SPAN class=ptStatLight>Req 2 (Owned)</span></b></TD>\
        <TD class=xtabHL><b><SPAN class=ptStatLight>Req 3 (Owned)</span></b></TD>\
      </TR>\
	  <TR style="height:1px;"><TD style="padding:0px; spacing:0px; height:1px; border-color:white; border-width: 1px; border-style: none none solid none" colspan=14></td></tr>';
	  rownum = 0;
	  for(k in crestreq){
	  if (++rownum % 2)
        ...
        rsty = ' style="background: #000000" ';
		m += '<TR '+rsty+'>  \
			<TD class=xtab><SPAN class=ptStatLight><B>City '+k+'</span></B></TD>';
		for(u in crestreq[k])
			m+='<TD class=xtabL><SPAN class=ptStatLight>'+crestreq[k][u]+' '+crestname[u]+ ' ('+crest[u]+') </span></TD>';
		m += '</TR>';
	  }
 m += '</TABLE>';
	//End crest info
    m += '<BR><DIV class=ptstat>DISTANCE CALCULATOR</div><DIV class=ptentry><TABLE align=center cellpadding=1 cellspacing=0>\
      <TR><TD class=xtab align=right><B><SPAN class=ptStatLight>First Location: </span></b></td><TD  class=xtab><SPAN class=ptStatLight> X: <INPUT id=calcX type=text\> Y: <INPUT id=calcY type=text\> Or, choose city: <SPAN id=ptloc1></span></span></td></tr>\
      <TR><TD class=xtab><SPAN class=ptStatLight><B>Second Location: </span></b></td><TD class=xtab><SPAN class=ptStatLight> X: <INPUT id=calcX2 type=text\> Y: <INPUT id=calcY2 type=text\> Or, choose city: <SPAN id=ptloc2></span></span></td></tr></table>\
...
Tabs.Options = {
  ...
  init : function (div){
    ...
    try {      
      m = '<TABLE class=ptTab>\
        <TR><TD colspan=2><B><SPAN class=ptStatLight>Config:</span></b></td></tr>\
        <TR><TD><INPUT id=ptAllowWinMove type=checkbox /></td><TD><SPAN class=ptStatLight>Enable window drag (move window by dragging top bar with mouse)</span></td></tr>\
        <TR><TD><INPUT id=ptHideOnGoto type=checkbox /></td><TD><SPAN class=ptStatLight>Hide window when clicking on map coordinates. <SPAN class=boldRed>&nbsp;(NEW)</span></td></tr>\
        <TR><TD><INPUT id=ptEnableFoodWarn type=checkbox /></td><TD><SPAN class=ptStatLight>Show \'food left\' in RED if food will run out in less than \
            <INPUT id=optFoodHours type=text size=3 value="'+ Options.foodWarnHours +'"> hours. THIS ALSO CONTROLS THE FOOD ALERT. CHECK THE BOX TO TURN ON.</span></span></td></tr>\
        <TR><TD colspan=2><P><B><SPAN class=ptStatLight>KofC Features:</span></b></td></tr>\
        <TR><TD><INPUT id=togMsgCountFix type=checkbox /></td><TD><SPAN class=ptStatLight>Show number of new messages separately from number of reports on Messages icon.</span></td></tr>';
      m += '<TR><TD><INPUT id=togAllRpts type=checkbox /></td><TD><SPAN class=ptStatLight>Enable enhanced Alliance Reports.</span></td></tr>\
        <TR><TD><INPUT id=togAllowAlter type=checkbox /></td><TD><SPAN class=ptStatLight>Allow other scripts to change format of Alliance Reports.</span></td></tr>\
        <TR><TD><INPUT id=togEnhanceMsging type=checkbox /></td><TD><SPAN class=ptStatLight>Enable enhanced messaging ("forward" and "all officers" buttons).</span></td></tr>\
        <TR><TD><INPUT id=togPageNav type=checkbox /></td><TD><SPAN class=ptStatLight>Enhanced page navigation for messages and reports.</span></td></tr>\
        <TR><TD><INPUT id=togWarnZero type=checkbox /></td><TD><SPAN class=ptStatLight>Warn if attempting to march to location 0,0.</span></td></tr>\
        <TR><TD><INPUT id=togGmtClock type=checkbox /></td><TD><SPAN class=ptStatLight>Enable GMT clock next to "Camelot Time" <SPAN class=boldRed>&nbsp;(NEW)</span></span></td></tr>\
        <TR><TD><INPUT id=togChatStuff type=checkbox /></td><TD><SPAN class=ptStatLight>Enable Chat enhancements (clickable coords, pink global messages, click on icon to whisper) <SPAN class=boldRed>&nbsp;(New)</span></span></td></tr>\
        <TR><TD><INPUT id=togAttackPicker type=checkbox /></td><TD><SPAN class=ptStatLight>Enable target city picker in attack dialog (reinforce, reassign and transport) <SPAN class=boldRed>&nbsp;(NEW option)</span></span></td></tr>\
        <TR><TD><INPUT id=togBatRounds type=checkbox /></td><TD><SPAN class=ptStatLight>Display # of rounds in battle reports <SPAN class=boldRed>&nbsp;(NEW)</span></span></td></tr>\
        <TR><TD><INPUT id=togAtkDelete type=checkbox /></td><TD><SPAN class=ptStatLight>Enable delete button when displaying battle report <SPAN class=boldRed>&nbsp;(NEW)</span></span></td></tr>\
        <TR><TD colspan=2><BR><BR><B><SPAN class=ptStatLight>KofC Bug Fixes:</span></b></td></tr>\
        <TR><TD><INPUT id=togTowerFix type=checkbox /></td><TD><SPAN class=ptStatLight>Fix tower report to show exact target (city, wild or invalid)</span></td></tr>\
        <TR><TD><INPUT id=togMapDistFix type=checkbox /></td><TD><SPAN class=ptStatLight>Fix map to show distances from currently selected city, instead of always the first city.</span></td></tr>\
        <TR><TD><INPUT id=togTowerFix2 type=checkbox /></td><TD><SPAN class=ptStatLight>Fix false attack alerts created from scouting missions.</span></td></tr>\
        <TR><TD><INPUT id=togKnightSelect type=checkbox /></td><TD><SPAN class=ptStatLight>Do not automatically select a knight when changing march type to scout, transport or reassign <SPAN class=boldRed>(NEW)</span></span></td></tr>\
        <TR><TD><INPUT id=togCoordBox type=checkbox /></td><TD><SPAN class=ptStatLight>Keep map coordinate box/bookmarks on top of troop activity <SPAN class=boldRed>(NEW)</span></span></td></tr>\
        </table><BR><BR><HR><SPAN class=ptStatLight>Note that if a checkbox is greyed out there has probably been a change of KofC\'s code, rendering the option inoperable.</span>';
      t.cont.innerHTML = m;
  ...
  init : function (div){
    ...
    this.cont.innerHTML = '\
      ...
      <SELECT id="srcType">\
        ...
        <DIV id="srcOpts" style="height:100px"></div></td><td><DIV id=divOutOpts style="background:#000000; padding:10px"></div></td></tr></table></div>\
...
//End edit city search
  ...
  srchTypeHandler : function (){
    ...
    var m = '<CENTER><B><SPAN class=ptStatLight>Search for '+ typeName +'</span><BR>\
        <SPAN class=ptStatLight>Center: '+ t.opt.startX +','+ t.opt.startY +'  &nbsp; Distance: '+ t.opt.maxDistance +'</span><BR></center>\
    ...
    if (t.opt.searchType == 1 || t.opt.searchType == 0) {
     m += '<TR><TD class=xtab align=right><SPAN class=ptStatLight>Min. level to show:</span></td><TD class=xtab> <INPUT id=filMinLvl size=2 value='+ Options.srcMinLevel +' /></td></tr>\
        <TR><TD class=xtab align=right><SPAN class=ptStatLight>Max. level to show:</span></td><TD class=xtab> <INPUT id=filMaxLvl size=2 value='+ Options.srcMaxLevel +' /></td></tr>';
	}
    if (t.opt.searchType == 1){
      m += '<TR><TD class=xtab align=right><SPAN class=ptStatLight>Wilderness Type:</span></td><TD class=xtab align=right>\
            <SPAN class=ptStatLight>Woodlands<INPUT id=woodWild type=CHECKBOX'+ (Options.woodWild?' CHECKED':'') +'></span></td></tr>';
      m += '<TR><TD class=xtab align=right><SPAN class=ptStatLight>Grassland/Lake</span><INPUT  id=foodWild type=CHECKBOX '+ (Options.foodWild?' CHECKED':'') +'></td>\
	       <TD class=xtab align=right><SPAN class=ptStatLight>Mountain</span><INPUT id=mtnWild type=CHECKBOX '+ (Options.mtnWild?' CHECKED':'') +'></td></tr>';
      m += '<TR><TD class=xtab align=right><SPAN class=ptStatLight>Plain</span><INPUT id=plnWild type=CHECKBOX '+ (Options.plnWild?' CHECKED':'') +'></td>\
           <TD class=xtab align=right><SPAN class=ptStatLight>Hills</span><INPUT id=hillWild type=CHECKBOX'+ (Options.hillWild?' CHECKED':'') +'></td></tr>';
      m += '<TR><TD class=xtab align=right><SPAN class=ptStatLight>Unowned Only:</span></td><TD class=xtab><INPUT id=filUnowned type=CHECKBOX '+ (Options.unownedOnly?' CHECKED':'') +'\><td></tr>';
    } 
    if (t.opt.searchType == 1 || t.opt.searchType == 0) {
        m+= '<TR><TD class=xtab align=right><SPAN class=ptStatLight>Sort By:</span></td><TD class=xtab><SELECT id=filSortBy>\
          ...
          <OPTION value="dist" '+ (Options.srcSortBy=='dist'?'SELECTED':'')  +'>Distance</option>\
			...
			<TR><TD class=xtab align=right><SPAN class=ptStatLight>Show coordinates only:</span></td><TD class=xtab><INPUT type=checkbox id=coordsOnly \></td></tr>\
			</table></div><BR><SPAN id=srchSizeWarn></span>';
    } else {
        m+= '<TR><TD class=xtab align=right ><SPAN class=ptStatLight>Show:</span></td><TD class=xtab align=left ><SELECT style="width: 135px" id=idSrchFilter>\
		...
		m+= '<TR><TD class=xtab align=right ><SPAN class=ptStatLight>Sort By:</span></td><TD class=xtab><SELECT style="width: 135px" id=filSortBy>\
          <OPTION value="might" '+ (Options.srcSortBy=='might'?'SELECTED':'')  +'>Might</option>\
          <OPTION value="dist" '+ (Options.srcSortBy=='dist'?'SELECTED':'')  +'>Distance</option>\
        </select></td></tr>\
        <TR><TD class=xtab align=right ><SPAN class=ptStatLight>Show coords only:</span></td><TD class=xtab align=left ><INPUT type=checkbox id=coordsOnly ></td></tr>\
        </table></div><BR><SPAN id=srchSizeWarn></span>';
  ...
  clickedSearch : function (){
    ...
    m = '<CENTER><B><SPAN class=ptStatLight>Search for '+ typeName +'</span><SPAN class=ptStatLight><BR>\
        Center: '+ t.opt.startX +','+ t.opt.startY +'  &nbsp; Distance: '+ t.opt.maxDistance +'<span><BR></center>\
        <DIV class=ptentry><TABLE cellspacing=0 width=100%><TR align=center><TD class=xtab colspan=10><B><SPAN class=ptStatLight>LIST OPTIONS:</span></b><BR></td></tr>';
	if (t.opt.searchType == 1 || t.opt.searchType == 0) {
      m += '<TR><TD class=xtab align=right><SPAN class=ptStatLight>Min. level to show:</span></td><TD class=xtab> <INPUT id=filMinLvl size=2 value='+ Options.srcMinLevel +' /></td></tr>\
        <TR><TD class=xtab align=right><SPAN class=ptStatLight>Max. level to show:</span></td><TD class=xtab> <INPUT id=filMaxLvl size=2 value='+ Options.srcMaxLevel +' /></td></tr>';
    ...
    if (t.opt.searchType == 1){
      m += '<TR><TD class=xtab align=right><SPAN class=ptStatLight>Wilderness Type:</span></td><TD class=xtab><SELECT id=filWildType>';
      m += htmlOptions ( {1:'Glassland/Lake', 3:'Woodlands', 4:'Hills', 5:'Mountain', 6:'Plain', 0:'ALL'}, Options.wildType );
      m += '</select></td></tr><TR><TD class=xtab align=right><SPAN class=ptStatLight>Unowned Only:</span></td>\
	...
	if (t.opt.searchType == 1 || t.opt.searchType == 0) {
	 ...
	 m += '<TR><TD class=xtab align=right><SPAN class=ptStatLight>City Type:</span></td><TD class=xtab><SELECT id=filCities>';
	 ...
	 m += '<TR><TD class=xtab align=right><SPAN class=ptStatLight>Sort By:</span></td><TD class=xtab><SELECT id=filSortBy>\
		   ...
		   <TR><TD class=xtab align=right><SPAN class=ptStatLight>Min might to show:</span></td><TD class=xtab><INPUT type=text id=minMight value='+Options.MightSrc+' size=3 \></td></tr>\
           <TR><TD class=xtab align=right><SPAN class=ptStatLight>Show coordinates only:</span></td><TD class=xtab><INPUT type=checkbox id=coordsOnly \></td></tr>\
           </table></div><BR><SPAN id=srchSizeWarn></span>';
	}
...
Tabs.Train = {
  ...
  init : function (div){
    ...
    s = "<DIV id=trainTopSelect>\
      ...
      <DIV style='text-align:center; margin-bottom:10px;'><SPAN class=ptStatLight>Select City: &nbsp; <span id=ptspeedcity></span></span></div>\
      <TABLE class=ptTab width=100%><TR valign=top><TD width=50%>\
      <TABLE align=center><TR><TD align=right><SPAN class=ptStatLight>Troop Type: </span></td><TD colspan=2>\
      <SELECT id=ptttType>\
      ...
      </select> &nbsp; <SPAN class=ptStatLight>(max <span id=ptttSpMax></span>)</span></td></tr>\
      <TR><TD align=right><SPAN class=ptStatLight># per slot: </span></td><TD><INPUT id='ptttInpPS' size=5 type='text' value='0'\></td>\
        <TD><INPUT id='ptttButMaxPS' type=submit value='max'\> &nbsp; <SPAN class=ptStatLight>(max <span id=ptttSpMaxPS>0</span>)</span></td></tr>\
      <TR><TD align=right><SPAN class=ptStatLight># of slots: </span></td><TD><INPUT id='ptttInpSlots' size=2 type='text' value='1'\></td>\
        <TD width=75%><INPUT id='ptttButMaxSlots' type=submit value='max'\> &nbsp; <SPAN class=ptStatLight>(max <span id=ptttSpMaxSlots>1</span>)</span></td></tr>\
      <TR><TD align=right valign=top><SPAN class=ptStatLight>Set Workers idle: </span></td><TD colspan=2><INPUT type=CHECKBOX id=chkPop"+ (Options.maxIdlePop?' CHECKED ':'') +"> \
        <SPAN style='white-space:normal;'><SPAN class=ptStatLight>Allows you to train more troops. May temporarily set idle population negative.</span></span></td></tr>\
      ...
      <TABLE align=center><TR><TD align=right><SPAN class=ptStatLight>Defense Type: </span></td><TD colspan=2>\
      <SELECT id=pttdType>\
      ...
      </select> &nbsp; <SPAN class=ptStatLight>(<span id=pttdSpMax></span>)</span></td></tr>\
      <TR><TD align=right><SPAN class=ptStatLight># per slot: </span></td><TD><INPUT id='pttdInpPS' size=5 type='text' value='0'\></td>\
        <TD><INPUT id='pttdButMaxPS' type=submit value='max'\> &nbsp; <SPAN class=ptStatLight>(max <span id=pttdSpMaxPS>0</span>)</span></td></tr>\
      <TR><TD align=right><SPAN class=ptStatLight># of slots: </span></td><TD><INPUT id='pttdInpSlots' size=2 type='text' value='1'\></td>\
        <TD width=75%><INPUT id='pttdButMaxSlots' type=submit value='max'\> &nbsp; <SPAN class=ptStatLight>(max <span id=pttdSpMaxSlots>1</span>)</span></td></tr>\
      <TR align=center><TD colspan=3><SPAN class=ptStatLight><SPAN id=pttdSpace></span></span></td></tr>\
      ...
      <div style='height: 325px; background: #000000'>\
      <TABLE width=100% class=ptTab><TR><TD colspan=3><DIV id=divSTtop></div></td></tr>\
      <TR><TD width=50% style='padding-left:15px; padding-right:15px'><DIV style='text-align:center'><SPAN class=ptStatLight><B>Troop Queue &nbsp; (<SPAN id=statTTtot></span>)</span></b><BR><HR></div><DIV id=divSTleft style='overflow-y: auto; height:210px; max-height:210px'></div></td>\
        <TD width=50% style='padding-left:15px; padding-right:15px'><DIV style='text-align:center'><SPAN class=ptStatLight><B>Defense Queue &nbsp; (<SPAN id=statDTtot></span>)</span></b><BR><HR></div><DIV id=divSTright style='overflow-y: auto; height:210px; max-height:210px'></div></td></tr>\
      </div>";
    t.cont.innerHTML = s;
...
/*******  TROOPS  ******/  
  ...
  clickTroopDo : function (){
    ...
    t.displayCityStats ();
    if (perSlot<1){
      t.divTrainStatus.innerHTML = '<FONT COLOR=#ffffff>Number of troops per slot must be greater than 0.</font>';
      return;
    }
    if (perSlot*numSlots > t.stats.MaxTrain){
      t.divTrainStatus.innerHTML = '<FONT COLOR=#ffffff>Can\'t train that many troops (max is '+ t.stats.MaxTrain +' total)</font>';
      return;
    }
    if (numSlots<1 || numSlots>t.stats.barracks - t.stats.queued){
      t.divTrainStatus.innerHTML = '<FONT COLOR=#ffffff>Invalid number of slots.</font>';
      return;
    }
    t.setBusy(true);
    var que = [];
...
/*******  DEF  ******/  
  ...
  clickDefDo : function (){
    ...
    t.displayCityStats ();
    if (perSlot<1){
      t.divTrainStatus.innerHTML = '<FONT COLOR=#ffffff>Number of units per slot must be greater than 0.</font>';
      return;
    }
    if (perSlot*numSlots > t.stats.MaxDefTrain){
      t.divTrainStatus.innerHTML = '<FONT COLOR=#ffffff>Can\'t train that many unit (max is '+ t.stats.MaxDefTrain +' total)</font>';
      return;
    }
  ...
  doDefQueue : function (cityId, que, errMsg){
    ...
    try {
      t.displayCityStats();
      if (errMsg){
        t.dispTrainStatus ('<font color=#ffffff><B>ERROR: '+ errMsg +'</b></font><SPAN class=ptStatLight><BR>');
        t.setBusy(false);
        return;
      }
      var cmd = que.shift();
      if (!cmd){
        t.dispTrainStatus ('<B><SPAN class=ptStatLight>Done queueing defenses.</span></span></b><SPAN class=ptStatLight><BR>');
        t.setBusy(false);
        return;
      }
      if (cmd[0] == 'T'){
        t.dispTrainStatus ('Training '+ cmd[2] +' '+  fortNamesShort[cmd[1]] +'</span><BR>');
  ...
  displayCityStats : function (){
    ...
    var m = '<CENTER><SPAN class=ptStatLight><B>'+ Cities.byID[cityId].name +' &nbsp; ('+ Cities.byID[cityId].x +','+ Cities.byID[cityId].y +')</span></b></center><HR>';
	
m += '<TABLE class=ptTab width=100%><TR align=center>\
        <TD width=8%><SPAN class=ptStatLight><B>Supply:</span></b></td><TD width=8%><SPAN class=ptStatLight><B>Militia:</b></span></td><TD width=8%><SPAN class=ptStatLight><B>Scout:</span></b></td>\
        <TD width=8%><SPAN class=ptStatLight><B>Pike:</span></b></td><TD width=8%><B><SPAN class=ptStatLight>Sword:</span></b></td><TD width=8%><B><SPAN class=ptStatLight>Archer:</span></b></td>\
        <TD width=8%><SPAN class=ptStatLight><B>Cav:</span></b></td><TD width=8%><SPAN class=ptStatLight><B>Heavy Cav:<.span></b></td><TD width=8%><SPAN class=ptStatLight><B>Wagon:</span></b></td>\
        <TD width=8%><SPAN class=ptStatLight><B>Ballista:</span></b></td><TD width=8%><B><SPAN class=ptStatLight>Ram:</span></b></td><TD width=8%><SPAN class=ptStatLight><B>Catapult:</span></b></td><tr>';
		
 m += '<TR align=center><TD width=8%><SPAN class=ptStatLight>'+Seed.units['city'+cityId]['unt1']+'</span></td><TD width=8%><SPAN class=ptStatLight>'+Seed.units['city'+cityId]['unt2']+
 '<TD width=8%><SPAN class=ptStatLight>'+Seed.units['city'+cityId]['unt3']+'</td><TD width=8%><SPAN class=ptStatLight>'+Seed.units['city'+cityId]['unt4']+
 '<TD width=8%><SPAN class=ptStatLight>'+Seed.units['city'+cityId]['unt5']+'</td><TD width=8%><SPAN class=ptStatLight>'+Seed.units['city'+cityId]['unt6']+
 '<TD width=8%><SPAN class=ptStatLight>'+Seed.units['city'+cityId]['unt7']+'</td><TD width=8%><SPAN class=ptStatLight>'+Seed.units['city'+cityId]['unt8']+
 '<TD width=8%><SPAN class=ptStatLight>'+Seed.units['city'+cityId]['unt9']+'</td><TD width=8%><SPAN class=ptStatLight>'+Seed.units['city'+cityId]['unt10']+
 '<TD width=8%><SPAN class=ptStatLight>'+Seed.units['city'+cityId]['unt11']+'</td><TD width=8%><SPAN class=ptStatLight>'+Seed.units['city'+cityId]['unt12']+'</span></td><tr></table>';
	
    m += '<TABLE class=ptTab width=100%><TR align=center>\
        <TD width=18%><SPAN class=ptStatLight><B>Food:</span></b></td><TD width=16%><SPAN class=ptStatLight><B>Wood:</span></b></td><TD width=16%><SPAN class=ptStatLight><B>Stone:</span></b></td>\
        <TD width=16%><SPAN class=ptStatLight><B>Ore:</span></b></td><TD width=16%><SPAN class=ptStatLight><B>Gold:</span></b></td><TD width=16%><SPAN class=ptStatLight><B>Idle Pop:</span></b></td></tr>\
      <TR align=center><TD><SPAN class=ptStatLight>'+ addCommasInt(t.stats.food) +'</span></td><TD><SPAN class=ptStatLight>'+ addCommasInt(t.stats.wood) +'</span></td><TD><SPAN class=ptStatLight>'+ addCommasInt(t.stats.stone) +'</span></td>\
        <TD><SPAN class=ptStatLight>'+ addCommasInt(t.stats.ore) +'</span></td><TD><SPAN class=ptStatLight>'+ addCommasInt(t.stats.gold) +'</span></td>\
        <TD><SPAN class=ptStatLight>'+ addCommasInt(t.stats.idlePop) +'</span></td></tr></table><BR>';
    ...
    if ( qs == t.lastQueString){
      ...
      if (q!=null && q.length>0 ){
        ...
        for (var i=0; i<q.length; i++){
          ...
          if (actual < 0)
            actual = 0;
          m += '<TR align=right><TD><SPAN class=ptStatLight>'+ q[i][1] +' </span></td><TD align=left><SPAN class=ptStatLight> '+ unsafeWindow.unitcost['unt'+q[i][0]][0];
          if (first)
            m += '</span></td><TD> &nbsp; <SPAN class=ptStatLight>'+  timestr(end-start, true) +'</span></td><TD><SPAN class=ptStatLight> (<SPAN id=ptttfq><SPAN class=ptStatLight>'+ timestr(actual, true) +'</span>)</span>';
          else
            m += '</td><TD> &nbsp;<SPAN class=ptStatLight> '+  timestr(actual, true) +'</span></td></tr>'; 
          lastEnd = end;
          first = false;
        }
      }
...
// defense queue ....
    ...
    if ( qs == t.lastDQueString){
      ...
      if (q!=null && q.length > 0 ){
        ...
        for (i=0; i<q.length; i++){
          ...
          if (actual < 0)
            actual = 0;
          m += '<TR align=right><TD><SPAN class=ptStatLight>'+ q[i][1] +' </span></td><TD align=left><SPAN class=ptStatLight> '+ fortNamesShort[q[i][0]];
          if (first)
            m += '</span></td><TD> &nbsp;<SPAN class=ptStatLight> '+  timestr(end-start, true) +'</span></td><TD><SPAN class=ptStatLight> (<SPAN id=pttdfq>'+ timestr(actual, true) +'</span>)</span>';
          else
            m += '</td><TD> &nbsp;<SPAN class=ptStatLight> '+  timestr(actual, true) +'</span></td></tr>'; 
          lastEnd = end;
          first = false;
  ...
  doQueue : function (cityId, que, errMsg){
    ...
    try {
      t.displayCityStats();
      if (errMsg){
        t.dispTrainStatus ('<font color=#ffffff><B>ERROR: '+ errMsg +'</b></font><BR>');
        t.setBusy(false);
        return;
      }
      var cmd = que.shift();
      if (!cmd){
        t.dispTrainStatus ('<B><SPAN class=ptStatLight>Done queueing troops.</span></b><SPAN class=ptStatLight><BR>');
        t.setBusy(false);
        return;
      }
      if (cmd[0] == 'T'){
        t.dispTrainStatus ('Training '+ cmd[2] +' '+  unsafeWindow.unitcost['unt'+cmd[1]][0] +'</span><BR>');
      ...
      logit (inspect (err, 8, 1));
      t.dispTrainStatus ('<font color=#ffffff>PROGRAM ERROR: '+ err.message +'</font><BR>');
      t.setBusy(false);
    }
  },
}
...
//DebugTimer.start(); 
    try {
      ...
      str += "<TABLE class="+ tabClass +" cellpadding=1 cellspacing=1><TR valign=top align=right><TD width=65></td><TD width=88 style='background: 		#6699FF'><SPAN class=ptStatLight><b>TOTAL</b></span></td>";
      for(i=0; i<Cities.numCities; i++) {
        str += "<TD width=81 style='background: #6699FF'><SPAN class=ptStatLight><B>"+ Cities.cities[i].name.substring(0,11) +'</span></b><SPAN class=ptStatLight><BR>'+ coordLink (Cities.cities[i].x, Cities.cities[i].y) +"<BR>"+ unsafeWindow.provincenames['p'+ Cities.cities[i].provId] +"</span></td>";
      }
      if (Options.includeMarching)
        str += '<TD width=81><B>Marching</b></td>';
      str += "</tr>";
	  
	  str += '<TR valign=top align=right align=left><TD></td><TD style=\'background: #ffffff\'></td>';
	  for(i=0; i<Cities.numCities; i++){
...
//**********************************
      ...
      str += _row ('<i><span style="color:green">Training</span></i>', t_rows[2]);
      str += _row ('Militia', rows[2]);
      str += _row ('<i><span style="color:green">Training</span></i>', t_rows[4]);
      str += _row ('Scout', rows[3]);
      str += _row ('<i><span style="color:green">Training</span></i>', t_rows[6]);
      str += _row ('Pike', rows[4]);
      str += _row ('<i><span style="color:green">Training</span></i>', t_rows[8]);
      str += _row ('Sword', rows[5]);
      str += _row ('<i><span style="color:green">Training</span></i>', t_rows[10]);
      str += _row ('Archer', rows[6]);
      str += _row ('<i><span style="color:green">Training</span></i>', t_rows[12]);
      str += _row ('Cavalry', rows[7]);
      str += _row ('<i><span style="color:green">Training</span></i>', t_rows[14]);
      str += _row ('Heavy', rows[8]);
      str += _row ('<i><span style="color:green">Training</span></i>', t_rows[16]);
      str += _row ('Wagon', rows[9]);
      str += _row ('<i><span style="color:green">Training</span></i>', t_rows[18]);
      str += _row ('Ballista', rows[10]);
      str += _row ('<i><span style="color:green">Training</span></i>', t_rows[20]);
      str += _row ('Ram', rows[11]);
      str += _row ('<i><span style="color:green">Training</span></i>', t_rows[22]);
      str += _row ('Catapult', rows[12]);
      str += _row ('<i><span style="color:green">Training</span></i>', t_rows[24]);
      ...
      str += '<TR><TD class=xtab></td><TD class=xtab colspan=4><BR><INPUT type=CHECKBOX id=idCheck'+ (Options.includeMarching?' CHECKED':'') +'><SPAN class=ptStatLight>Include Marching Troops/Resources</span></td></tr>';
