...
// @description    un gradino piu in alto
// ==/UserScript==

var Version = 'Anakyn 1';
var Title = 'KOC Power Blood Tools';
...
//logit ( 'Options.ptWinPos: '+ inspect (Options.ptWinPos, 5, 1)); 
  ...
  AddMainTabLink('BLOODS', eventHideShow, mouseMainTab);
}
...
var TowerAlerts = {
  ...
  postToChat : function (m, force){
	...
	if (t.postToChatOptions.includealliance){
	  var a = t.fetchPlayerInfo(m.pid, function (r) {t.getAllianceName(r);})
	  var alliance = 'of '+a;
	  }
	 else
		alliance = '';
