...
// @namespace      axel_12BBCODER
// @description    BBCoderReloaded para T! y P! (By axel_12 para T!)
...
// @version        1.0
// @copyright      Copyright (c) 2010, axel_12
// @creator        axel_12  Â® 2011 - Modificado y arreglado de bugs (comentarios, links a medios embebidos, preview de posts) a partir del 20/11/2010 por axel_12
// ==/UserScript==

// **COPYRIGHT NOTICE**
//
//    "BBCoder en Comentarios para T! y P!" Copyright (C) 2011 - axel_12
//
...
var CategoriasT = new Array(-1,"","Ver Todas",7,"animaciones","Animaciones",18,"apuntes-y-monografias","Apuntes y Monografias",4,"arte","Arte",
	...
	16,"deportes","Deportes",9,"downloads","Downloads",23,"ebooks-tutoriales","E-books y Tutoriales",34,"ecologia","Ecologi­a",
	29,"economia-negocios","Economia y Negocios",24,"femme","Femme",35,"hazlo-tu-mismo","Hazlo tu mismo",26,"humor","Humor",
	...
	31,"turismo","Turismo",13,"tv-peliculas-series","TV, Peli­culas y Series",3,"videos","Videos On-line");
var CategoriasP = new Array(-1,"","Ver Todas",7,"animaciones","Animaciones",9,"downloads","Downloads",8,"gay","Gay",1,"imagenes","Imágenes",
	...
	0,"relatos","Relatos",13,"tv-peliculas-series","TV, Peli­culas y Series",3,"videos","Videos On-line");
// ==/Variables==
...
if(Tiny){
	...
	if(/login.php/.exec(location.href)){
		...
		$('label[for=remember-me]').html('Â¿Recordar en esta PC?');
		$('p a[href^=/plugin/join.php]').parent().remove();
		$(':button').addClass('red').html('Â¡Iniciar sesiÃ³n ahora!');
		$('h2:contains(Not yet a member?)').remove();
	}else{
		$(':button').addClass('red').html('Â¡Subir archivo ahora!');
		$('h1:contains(Cargar)').html('SharkPicÂ® 2010');
...
$('head').append('<link type="text/css" href="http://jquery-ui.googlecode.com/svn/tags/latest/themes/base/jquery.ui.all.css" rel="stylesheet"/><link href="'+GM_getValue('sharkale-theme','http://ajax.googleapis.com/ajax/libs/jqueryui/1.7.2/themes/dark-hive/jquery-ui.css')+'" type="text/css" rel="Stylesheet" class="ui-theme">');
var Tynt=Tynt||[];
function WAU_tab(key,position){
	...
	var e=$('<div id="wau_tab_container" title="Cantidad de gente usando el BBCoder" onclick="window.location=\'http://whos.amung.us/stats/'+key+'/\'" style="position:fixed;zIndex:5000000;'+position[0]+'=-50px;display:none"></div>');
	if(position[1]=="upper"){
		e.css('top','25%');
	}else{
...
var mostarMiEstado = GM_getValue("mostarMiEstado",false);
	...
	GM_registerMenuCommand("BBCoder para T! y P! - Reinicializar Valores", function() {
	...
	GM_registerMenuCommand("BBCoder para T! y P! - Reportar BUG", function() {
		GM_openInTab("http://www.taringa.net/comunidades/bbcoder/125800/");
	},null,null,"B");
	
	GM_registerMenuCommand("BBCoder para T! y P! - Aportar Sugerencia", function() {
		GM_openInTab("http://www.taringa.net/comunidades/bbcoder/125814/");
	},null,null,"B");

	GM_registerMenuCommand("BBCoder para T! y P! - Entrar al post del Script", function() {
		GM_openInTab(postscript);
	},null,null,"P");

	GM_registerMenuCommand("BBCoder para T! y P! - VersiÃ³n Instalada: " + 1.0, function() {
		unsafeWindow.mydialog.alert("BBCoder para T! y P! - axel_12®","Tu versiÃ³n del script instalada actualmente es: " + 1.0);
	},null,null,"V");
...
function CrearBarraColores(){
		...
		var nuevaHTML = '<div id="axel_TaringaColores" style="position: absolute!important;margin-left:-85px"><table border="0" cellpadding="0" cellspacing="1" align="center" bgcolor="#000000" onmouseover="this.style.cursor=\'pointer\'"><tbody><tr>'; 
					...
					data: 'titulo=Preview&cuerpo='+encodeURIComponent(txt.value),
 					success: function(h){
						...
						if(path == 'mensajes'){
							...
							HTML += '<div class="answerTxt"><div class="answerContainer"><div class="Container" style="padding:0; width:640px !important;"><div class="answerOptions"><div class="floatL metaDataA"><img src="'+URL+'cerrar.gif" alt="[X]" title="Cerrar PrevisualizaciÃ³n" border="0" onclick="($(\'#return_agregar_comentario\').slideUp(1000))" align="absmiddle" style="margin-right:5px" onmouseover="this.style.cursor=\'pointer\'" />PrevisualizaciÃ³n - SharkaleÂ®</div></div><div style="margin: 10px !important; width:640px !important;" class="cuerpo_comm">'+respuesta+'</div></div></div></div></div>';
						}
 						$('#return_agregar_comentario').slideUp(1000, function(){
...
if (GM_getValue("mostarMiEstado"))
	var MenuOnlineOffline = GM_getValue("MOO", 'http://k02.kn3.net/9C96DEAC2.png');
else
	var MenuOnlineOffline = GM_getValue("MOO", 'http://k01.kn3.net/0C689B175.png');
...
function Sharkale_Opciones(){
	...
	var nuevaHTML = '<div class="ui-dialog-titlebar ui-widget-header ui-corner-all ui-helper-clearfix" style="-moz-user-select: none;margin-bottom:3px;">';
	nuevaHTML += '	<span class="ui-dialog-title" id="ui-dialog-title-SharkaleOpciones" unselectable="on" style="-moz-user-select: none;">Opciones Avanzadas del Script - axel_12&reg;</span>';
	nuevaHTML += '	<a href="" onclick="$(\'#widget\').remove();$(\'#cuerpocontainer\').show();return false;" onmouseover="$(this).addClass(\'ui-state-hover\');" onmouseout="$(this).removeClass(\'ui-state-hover\');" class="ui-dialog-titlebar-close ui-corner-all" unselectable="on" style="-moz-user-select: none;">';
	nuevaHTML += '		<span class="ui-icon ui-icon-closethick" unselectable="on" style="-moz-user-select: none;">close</span>';
	nuevaHTML += '	</a>';
	nuevaHTML += '</div>';
	...
	nuevaHTML += '    <li><a href="#imagenes-2"><span>Imagenes del Menu</span></a></li>';
	nuevaHTML += '    <li><a href="#imagenes-3"><span>Emoticones personalizados</span></a></li>';
	nuevaHTML += '  </ul>';
	nuevaHTML += '  <div id="imagenes-1"><b>';
	nuevaHTML += '    <div class="ui-state-error ui-corner-all" style="padding: 0pt 0.7em;"><p><span class="ui-icon ui-icon-alert" style="float: left; margin: 0.3em 0.3em;"></span></a></span></p></div>';
	...
	nuevaHTML += '	<label><input type="checkbox" id="shark_LinkCheck" '+(LinkCheck? 'checked':'')+'> Ejecutar LinkChecker automÃ¡ticamebte. De lo contrario un botÃ³n aparecerÃ¡ junto al tÃ­tulo para la ejecuciÃ³n manual.</label><br/>';
	...
	nuevaHTML += '	<div id="tagboard">Deja tu opiniones y sugerencias del Script, y ayudalo a crecer! :';
	...
	nuevaHTML += '    <div class="ui-state-error ui-corner-all" style="padding: 0pt 0.7em;"><p><span class="ui-icon ui-icon-alert" style="float: left; margin: 0.3em 0.3em;"></span><span style="font-size: 14px;">Si queres donar por medio de PayPal mandame MP y te digo a que cuenta transferir <a href="http://www.taringa.net/mensajes/a/axel_12"><img src="https://www.paypal.com/es_ES/ES/i/btn/btn_donate_LG.gif" align="absmiddle" alt="PayPal. La forma rÃ¡pida y segura de pagar en Internet."></a></span></p></div>';
	nuevaHTML += '    <div style="float:left;"><img src="'+urlimg+'" alt=""/></div>';
	nuevaHTML += '    <div style="float:right;"><img src="'+urlimg+'" alt=""/></div>';
	nuevaHTML += '    <div align="center"><br><span style="font-size:15px">BBCoder para Taringa! y Poringa! por:</span><br/><br/><br/>';
	nuevaHTML += '    <span style="font-size:30px;font-family:Arial Black">axel_12® 2011</span><br/><br/><br/>';
	nuevaHTML += '    <span style="font-size:15px;">VersiÃ³n instalada actualmente: '+1.0 +'</span><br/><br/>';
	nuevaHTML += '    <img src="http://a02.t.net.ar/avatares/2/9/3/3/120_2933323.jpg" alt=""/><br><br>';
	nuevaHTML += '    <div class="ui-state-error ui-corner-all" style="padding: 0pt 0.7em;"><p><span class="ui-icon ui-icon-alert" style="float: left; margin-right: 0.3em;"></span><strong>Atencion:</strong> Agradezco a toda T! que hizo posible este Script, y bueno...Espero que lo disfruten</p></div><br/>';
	nuevaHTML += '    <hr>Agradecimientos a:<br><input type="button" class="ui-state-default ui-corner-all" title="Mis agradecimientos a Todos Ustedes que hicieron posible esto" value="Ustedes">';
	nuevaHTML += '    <input type="button" class="ui-state-default ui-corner-all" title="Mis agradecimientos a Taringa!" value="Taringa!">';
	nuevaHTML += '    <input type="button" class="ui-state-default ui-corner-all" title="Mis agradecimientos al Staff de Taringa!" value="Staff de Taringa!">';
...
//----Actualizar----//
	menu += '	';
//----Online/Offline----//
	menu += '	<li id="MenuOnlineOffline" "><a href="#" id="Menu_Online_Offline" title="Mostrar mi estado cuando navego el sitio (Cambiar estado [Off] o [On])"><img id="imgonlineoffline" src="'+MenuOnlineOffline+'" style="width: '+MenuSize+'px; height: '+MenuSize+'px;" align="absmiddle" /></a></li>';
//----Inicio----//
	...
	menu += '		<li><b>Busqueda Rápida en T! o P!</b><form method="get" action="http://'+Dom+'/posts/buscador/taringa/"><input name="q" title="Buscador RÃ¡pido" style="border: 0px none; font-size: 10px; width:171px;padding-bottom:2px;" type="text"></form></li>';
	menu += '		<li><b>Busqueda Rápida en Google</b><form method="get" action="http://www.taringa.net/posts/buscador/google/" onsubmit="$(\':input[name=q3]\').attr(\'name\',\'q2\').val($(\':input[name=q][title*=Google]:last\').val())"><input name="q" title="Buscador RÃ¡pido en Google" style="border: 0px none; font-size: 10px; width:171px;padding-bottom:2px;" type="text"><input type="hidden" name="q3" value=""><input type="hidden" name="cof" value="FORID:10"><input type="hidden" name="cx" value="partner-pub-5717128494977839:h5hvec-zeyh"></form></li>';
...
//----Mi Perfil----//
    ...
    menu += '		<li><a href="/perfil/'+user+'/comentarios">Mis Ãºltimos comentarios</a></li>';
    menu += '	</ul>';
	menu += '	</li>';
//----Logout----//
	menu += '	<li><a href="/logout.php?key='+datospag.user_key+'" title="Salir de la cuenta"><img src="'+MenuCerrarSesion+'" style="width: '+MenuSize+'px; height: '+MenuSize+'px;" align="absmiddle" alt="X" border="0"/></a></li>';
//----Opciones----//
	menu += '	<li style="-moz-border-radius-topright: 7px;"><a href="" id="Sharkale_Opciones" title="Opciones del Script"><img src="'+MenuOpciones+'" style="width: '+MenuSize+'px; height: '+MenuSize+'px;" align="absmiddle" alt="OPCIONES" /></a></li>';
	...
	submenu += '	<li><a title="Proximamente Comunidad Oficial del Script y muchas mas opciones!" href="http://www.taringa.net/">Comunidad Oficial</a></li>';
	submenu += '	<li></li>';
	submenu += '	<li></li>';
	submenu += '	<li></li>';
	submenu += '	<li></li>';
		...
		$.ajax({
				...
				success: function(h){
					...
					$('#imgonlineoffline').attr("src",function() {
							var hrefvivo   = 'http://k02.kn3.net/9C96DEAC2.png';
							var hrefmuerto = 'http://k01.kn3.net/0C689B175.png';
...
case 'post':
	...
	var n_com_ini = 100 * parseInt($('a[class=here]:first').html()) - 100 || 0;
	var n_com = $('.comment-info .nick');for(var i=0;i < n_com.size();i++){n_com.eq(i).before('#'+(i+n_com_ini+1)+' - ');}
	if($('span[class="given-name"]').html() == "axel_12"){
		...
		mod_sharkale.find('img[title="Ultra Mega User"]').attr('style','position: absolute; top: -109px; clip: rect(109px, 16px, 126px, 0px);').attr('title','axel_12  Unido a toda Taringa! :D');
...
case 'perfil':
	...
	if(perfilde == "Sharkale"){
		...
		$('.perfil-info a[href*="bloquear"]').attr('href','javascript:alert("Como vas a ser tan sorete de bloquear al creador del script que estas usando? ^^")');
	}
	if(perfilde == "axel_12"){
		$('.w-stats li:has(span:contains(Rango))').css('width','170px').css('background-repeat','no-repeat').css('background-image','url(\'http://img25.imageshack.us/img25/9739/vipkz.jpg\')').html('Ultra Mega VIP User<span>Rango</span>');
		...
		$('.w-stats li:has(span:contains(Posts))').css('width','60px');
		$('.perfil-info a[href*="bloquear"]').attr('href','javascript:alert("Â¿CÃ³mo vas a ser tan mala gente de bloquear al que continuo y arreglo el script que estas usando?")');
	}
		...
		GM_xmlhttpRequest({
			...
			onload: function(r) {
				...
				if (parseFloat(ultvers.ver) <= parseFloat(SCRIPT.version)){
					if(SCRIPT.forzado){
						unsafeWindow.mydialog.procesando_fin();
						unsafeWindow.mydialog.alert("Actualizador del BBCoderReloadedÂ®","No hay actualizaciones disponibles en este momento.");
					}
					return;
...
function mostrar_estado(URL, uTipo, kb){
	...
	switch(uTipo){
		...
		case "NODISP":
			...
			dec = '';
			tit = 'La pÃ¡gina esta inaccesible';
			break;
		case "VIVO":
			bgc = color_link_vivo;
