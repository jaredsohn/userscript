// ==UserScript==
// @name           StatScript
// @description    adds a new menu to the game containing an overview of your space empire. Updated to work with uni2 extreme and crystal total fixed.
// @version        1.21
...
incometotal = Comma(eval(parseInt(GM_getValue("ore0", 0))+parseInt(GM_getValue("ore46", 0))+parseInt(GM_getValue("ore51", 0))+parseInt(GM_getValue("ore6", 0))+parseInt(GM_getValue("ore11", 0))+parseInt(GM_getValue("ore16", 0))+parseInt(GM_getValue("ore21", 0))+parseInt(GM_getValue("ore26", 0))+parseInt(GM_getValue("ore31", 0))+parseInt(GM_getValue("ore36", 0))+parseInt(GM_getValue("ore41", 0))+parseInt(GM_getValue("crystal0", 0))+parseInt(GM_getValue("crystal46", 0))+parseInt(GM_getValue("crystal51", 0))+parseInt(GM_getValue("crystal6", 0))+parseInt(GM_getValue("crystal11", 0))+parseInt(GM_getValue("crystal16", 0))+parseInt(GM_getValue("crystal21", 0))+parseInt(GM_getValue("crystal26", 0))+parseInt(GM_getValue("crystal31", 0))+parseInt(GM_getValue("crystal36", 0))+parseInt(GM_getValue("crystal41", 0))+parseInt(GM_getValue("hydrogen0", 0))+parseInt(GM_getValue("hydrogen46", 0))+parseInt(GM_getValue("hydrogen51", 0))+parseInt(GM_getValue("hydrogen6", 0))+parseInt(GM_getValue("hydrogen11", 0))+parseInt(GM_getValue("hydrogen16", 0))+parseInt(GM_getValue("hydrogen21", 0))+parseInt(GM_getValue("hydrogen26", 0))+parseInt(GM_getValue("hydrogen31", 0))+parseInt(GM_getValue("hydrogen36", 0))+parseInt(GM_getValue("hydrogen41", 0)))*24);
convertedtotal = Comma(eval(parseInt(GM_getValue("ore0", 0))+parseInt(GM_getValue("ore46", 0))+parseInt(GM_getValue("ore51", 0))+parseInt(GM_getValue("ore6", 0))+parseInt(GM_getValue("ore11", 0))+parseInt(GM_getValue("ore16", 0))+parseInt(GM_getValue("ore21", 0))+parseInt(GM_getValue("ore26", 0))+parseInt(GM_getValue("ore31", 0))+parseInt(GM_getValue("ore36", 0))+parseInt(GM_getValue("ore41", 0))+parseInt(GM_getValue("crystal0", 0)*5/3)+parseInt(GM_getValue("crystal46", 0)*5/3)+parseInt(GM_getValue("crystal51", 0)*5/3)+parseInt(GM_getValue("crystal6", 0)*5/3)+parseInt(GM_getValue("crystal11", 0)*5/3)+parseInt(GM_getValue("crystal16", 0)*5/3)+parseInt(GM_getValue("crystal21", 0)*5/3)+parseInt(GM_getValue("crystal26", 0)*5/3)+parseInt(GM_getValue("crystal31", 0)*5/3)+parseInt(GM_getValue("crystal36", 0)*5/3)+parseInt(GM_getValue("crystal41", 0)*5/3)+parseInt(GM_getValue("hydrogen0", 0)*2.5)+parseInt(GM_getValue("hydrogen46", 0)*2.5)+parseInt(GM_getValue("hydrogen51", 0)*2.5)+parseInt(GM_getValue("hydrogen6", 0)*2.5)+parseInt(GM_getValue("hydrogen11", 0)*2.5)+parseInt(GM_getValue("hydrogen16", 0)*2.5)+parseInt(GM_getValue("hydrogen21", 0)*2.5)+parseInt(GM_getValue("hydrogen26", 0)*2.5)+parseInt(GM_getValue("hydrogen31", 0)*2.5)+parseInt(GM_getValue("hydrogen36", 0)*2.5)+parseInt(GM_getValue("hydrogen41", 0)*2.5)));
...
+'<BR>Points: <span id="pointsget">'+GM_getValue("points", 0)+'</span><BR>Hourly Ore: '+oretotal+'<BR>Hourly Crystal: '+crystaltotal+'<BR>Hourly Hydro: '+hydrogentotal+'<BR>Daily Ore: '+Comma(oretotal.replace(/\,/g,"")*24)+'<BR>Daily Crystal: '+Comma(crystaltotal.replace(/\,/g,"")*24)+'<BR>Daily Hydro: '+Comma(hydrogentotal.replace(/\,/g,"")*24)+'<BR>Daily Converted: '+Comma(convertedtotal.replace(/\,/g,"")*24)+'<BR><BR><BR><BR><h4>How to use:</h4>1. Go to buildings menu.<br>2. Click through all your planets slowly.<br>3. Click leaderboard.<br>4. Click stats. All values should now be filled.</div>'
...
var css_link_html = document.createElement('link'); css_link_html.rel = 'Stylesheet'; css_link_html.href = 'http://uni2.playstarfleetextreme.com/stylesheets/starfleet.css'; css_link_html.type = 'text/css'; try { document.getElementsByTagName('head')[0].appendChild( css_link_html ); } catch(e) { }
}
// part 2
