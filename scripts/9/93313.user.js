// ==UserScript==
// @name            The West - TW Pro+ [SOM] (beta)
// @namespace       http://userscripts.org/scripts/show/93313
// @description     Script for The-West: TW Pro+ [SOM - Scripts-O-Maniacs] [Multilingual] (v3.1.0.0k beta)
...
// @include         http://userscripts.org/scripts/review/93313*
// @version         3.1.0.0k
//
// @history         3.1.0.0k|21/08/2011 Bug fix when detecting a new Set item with no direct bonuses (Tequila, Elixir, etc).
// @history         3.1.0.0j|18/08/2011 Code cleaned.
// @history         3.1.0.0i|14/08/2011 Bug fix on Fortbattle combinations.
// @history         3.1.0.0h|13/08/2011 Storage space required when caching Fortbattle combinations has been reduced. Please regen your cache for these activities.
// @history         3.1.0.0g|12/08/2011 Bug fix when overwriting or updating IndexedDB cache in Chrome (was a Chrome bug actually).
// @history         3.1.0.0f|09/08/2011 Incoming Set items analysis improved.
// @history         3.1.0.0f|04/08/2011 Bug fix when the market is empty.
// @history         3.1.0.0f|04/08/2011 Bug fix when a new job and item changes are detected at the same time (Thx to Bluep for reporting).
// @history         3.1.0.0f|03/08/2011 Bug fix regarding the cache button that was disappearing in special cases (Thx to Mariache320, Ren33 & Bluep for the numerous tests that helped me find this repeated bug).
// @history         3.1.0.0e|03/08/2011 Dancer's Set updated.
// @history         3.1.0.0d|31/07/2011 Health points for each job are now displayed in red when they are lower than your current HP (thx to Bluep for the idea).
// @history         3.1.0.0d|31/07/2011 Cache use "update" word instead of "generate" when needed.
// @history         3.1.0.0d|31/07/2011 Improved error handling when a new job is added in the game (jobs will be added in the red cache button).
// @history         3.1.0.0c|28/07/2011 Dancer & Indian's Sets updated for Beta worlds.
// @history         3.1.0.0c|28/07/2011 Dancer's Set unlocked in the Itemsets manager since male characters can wear 2 items from this Set (don't forget to disable/enable this Set manually from now!)
// @history         3.1.0.0c|28/07/2011 Incoming items analysis improved.
// @history         3.1.0.0c|28/07/2011 Bug fix in job "Fastest Lifepoints".
// @history         3.1.0.0c|28/07/2011 Bug fix #2 in Cache generation.
// @history         3.1.0.0b|27/07/2011 Bug fix in Cache generation.
// @history         3.1.0.0a|26/07/2011 Final step regarding calculation process improvements. From now, updating the cache or changing settings (in Live mode & Cache mode) will only request to compute the affected activities.<br><b>Note:</b> It could be safer to regenerate your cache once after upgrading to this version.<br><b>Warning:</b> Be careful with this beta, it is a first draft and we begin to track bugs only from now on. Since the core code has been modified once again, bugs may be very annoying and/or could give you strange results.
// @history         3.1.0.0a|20/07/2011 Bug fix on Fortbattle combinations in Live mode.
// @history         3.1.0.0a|20/07/2011 Bug fix in Custom Jobs.
// @history         3.0.0.4a|20/07/2011 Improved error handling when a new job is added in the game.
// @history         3.0.0.3b|19/07/2011 Added new job "Palisade bauen" for Amchitka server (beta2) (thx to Bluep & Darius II for the data).
// @history         3.0.0.3b|19/07/2011 Error handling when a new job is added in the game.
// @history         3.0.0.3a|17/07/2011 Cookies storage improved for users with a large number of accounts on the same server.
// @history         3.0.0.2e|17/07/2011 Bug fix on Recipe highlighting in Collector mode.
// @history         3.0.0.2d|14/07/2011 Bug fix on crafting reports.
// @history         3.0.0.2c|13/07/2011 Advanced item popup and item highlighting are working now in reports too.
// @history         3.0.0.2c|13/07/2011 Browser tab will now blink when Safe mode process is completed.
// @history         3.0.0.2c|13/07/2011 Activities which are not unlocked by the item are now shown in red in the merchant popups.
// @history         3.0.0.2b|12/07/2011 Safe mode improved. Process will still run even if another browser tab is focused (it should even run faster??).<br>Performance tests in progress, waiting for feedbacks...
// @history         3.0.0.2b|12/07/2011 Live mode in/out inventory analysis improved (By "Live mode", I mean cache disabled).
// @history         3.0.0.2a|10/07/2011 Minor fix on Fortbattle combinations (tags were not displayed correctly in the inventory popups on job selection).
// @history         3.0.0.2a|10/07/2011 Some fixes for Firefox 3.6 users (Cache & Chat links). However I really encourage you to upgrade to FF5 because FF3.6 is very very slow.
// @history         3.0.0.1r|09/07/2011 New Set Items added for Beta worlds (thx to Bluep for the data) + test on error handling with these new Set combinations.
// @history         3.0.0.1q|09/07/2011 Bug fix on skills changes (was causing unwanted generation of a new cache in a special case).
// @history         3.0.0.1p|09/07/2011 Chat colors and whisper compatibility improved (thanks to Danosaure for his work on the code).
// @history         3.0.0.1o|08/07/2011 Cache status button improved (Inventory items you can wear after a level up will be now considered as new items. Therefore, these items will also switch the cache button to red).
// @history         3.0.0.1o|06/07/2011 Small fix on item highlighting at merchants.
// @history         3.0.0.1n|06/07/2011 Small fix when locking inventory window during Safe mode.
// @history         3.0.0.1m|06/07/2011 Bug fix on cache generation when a new Set item is found (or enabled).
// @history         3.0.0.1m|06/07/2011 Bug fix on cache status in Safe mode.
// @history         3.0.0.1l|06/07/2011 Pilgrims Sets unlocked in the Itemsets manager since we can wear 3 items from the Set of the opposite sex (don't forget to disable these Sets manually from now!)
// @history         3.0.0.1k|05/07/2011 Some fixes on item highlighting at merchants.
// @history         3.0.0.1j|04/07/2011 Added "Attributes" in custom job settings.
// @history         3.0.0.1i|03/07/2011 Chat fix when using custom color and whisper at the same time.
// @history         3.0.0.1h|03/07/2011 Bug fix on skillsHash test.
// @history         3.0.0.1h|03/07/2011 Code cleaned.
// @history         3.0.0.1g|03/07/2011 Added option to discard changes & force cache status to OK.
// @history         3.0.0.1f|03/07/2011 Calculation stats displayed in normal mode too.
// @history         3.0.0.1f|03/07/2011 Added calculation time in the calculation stats.
// @history         3.0.0.1f|03/07/2011 Test#2 on speed value accuracy for duelists.
// @history         3.0.0.1f|03/07/2011 Improved tag system in Fortbattle combinations.
// @history         3.0.0.1f|02/07/2011 Bug fix on item popups at merchants when using cache (attributes on items were ignored in the bonus calculation).
// @history         3.0.0.1e|30/06/2011 Job values updated on ajax window refresh when skills changes are detected.
// @history         3.0.0.1d|30/06/2011 Test on speed value accuracy for duelists.
// @history         3.0.0.1c|30/06/2011 Inventory window is locked during Safe mode calculations.
// @history         3.0.0.1c|30/06/2011 Added option to exclude Fortbattle settings from Safe mode.
// @history         3.0.0.1b|29/06/2011 First beta tests on a new "Safe mode" feature.
// @history         3.0.0.1b|29/06/2011 Minor bug fix on cache status button #2 (color not refreshing in a special case).
// @history         3.0.0.1a|26/06/2011 Minor bug fix on cache status button (color not refreshing in a special case).
// @history         2.0.1.6q|26/06/2011 Updater improved when userscript.org is down.
// @history         2.0.1.6q|26/06/2011 Added health points information for every activities in the dropdown menu.
// @history         2.0.1.6q|26/06/2011 Added highlighting and popup info in the activities management menus.<br>When calculations are done, the "Enabled" list is now sorted as your dropdown menu.
// @history         2.0.1.6q|26/06/2011 Added "Collector mode".
// @history         2.0.1.6q|26/06/2011 Added "Show all jobs on map" feature.
// @history         2.0.1.6q|26/06/2011 Added cell coordinates in the minimap.
// @history         2.0.1.6q|26/06/2011 Improved error handling when WebStorage is full.
// @history         2.0.1.6q|26/06/2011 Updated layout for the TW Pro settings windows.
// @history         2.0.1.6q|26/06/2011 Added quotas limits infos.
// @history         2.0.1.6p Forum smileys fixed for the new updater
// @history         2.0.1.6p Fixed Sets filters for Opera
// @history         2.0.1.6o Updater updated :D
// @history         2.0.1.6o Handling errors when user rejects the API request for offline IndexedDB storage
// @history         2.0.1.6n Improved analysis of in/out inventory (regen your cache once manually to avoid a bug)
// @history         2.0.1.6m Translation variables added
// @history         2.0.1.6m Handling errors when browser doesn't support IndexedDB
// @history         2.0.1.6m Fix for Safari rejecting the IndexedDB delete command in source code
// @history         2.0.1.6l Reactivation of the automatic updater on beta version (major bugs seems to be fixed now ^^)
// @history         2.0.1.6l Fix on Fortbattle (defender) values in the dropdown menu
// @history         2.0.1.6k Bug gix when detecting cache changes in WebStorage mode
// @history         2.0.1.6j Minor layout fix in settings
// @history         2.0.1.6i Improved cache system using IndexedDB (Firefox 4+ & Chrome 11+ only).<br>Faster than ever! ;)
// @history         2.0.1.6i New "split fortbattle combinations" feature!
// @history         2.0.1.6i Items in the inventory are not higlighted anymore if you already wear them
// @history         2.0.1.6i Fix on fortbattle settings with zero-priority on health
// @history         2.0.1.6h Fix when detecting new items in inventory
// @history         2.0.1.6h Fix on Storage function
// @history         2.0.1.6h Fix on inventory hash
// @history         2.0.1.6g Fix when using Fortbattle settings after detecting inventory or skills changes
// @history         2.0.1.6f Fix when using Fortbattle settings after F5 refresh
// @history         2.0.1.6e Fix when using TW Pro settings
// @history         2.0.1.6d Weapons fix @ merchants popups
// @history         2.0.1.6c Fix emptying cache
// @history         2.0.1.6b Beta tests on new cache system (first throw, work still in progress)
// @history         2.0.1.6b Tequila boom boom fix on regen HP ;)
// @history         2.0.1.6b Second issue fixed when opening crafting page, using equipment manager & eating usable items.
// @history         2.0.1.6b Bug fix on bag statistics popup
// @history         2.0.1.6a Fix test regarding bad links in Chat (-> links works properly with FF 3.5 & 4.0 but fails with 3.6)
// @history         2.0.1.5d SOM Manager display fix
// @history         2.0.1.5c Added SOM Manager (beta test only)
