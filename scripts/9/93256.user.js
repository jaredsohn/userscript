		  ...
		  new Ajax.Request(g_ajaxpath + "ajax/construct.php" + g_ajaxsuffix,{
			 ...
			 onSuccess : function(transport){
				...
				if(rslt.ok){
				   ...
				   seed.resources["city" + cityid].rec5[0] -= parseInt(buildingcost["bdg" + bdgid][5]) * mult * 3600;
				   seed.resources["city" + cityid].rec6[0] -= parseInt(buildingcost["bdg" + bdgid][6]) * mult * 3600;
				   seed.citystats["city" + cityid].gold[0] -= parseInt(buildingcost["bdg" + bdgid][7]) * mult;
