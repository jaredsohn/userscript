// ==UserScript==
// @name            taz_zeit_feuilleton
// @namespace       Platypus
// @include         *TAZ&ressort=ku
// @include         http://www.taz.de/index.php?id=leben
...
html_insert_it(window.document,document.getElementById('datum_plugin_rechts'),'<iframe src="http://newsfeed.zeit.de/feuilleton/index#feed-greasemonkey" width="500" height="600"></iframe>',false,true);
