...
// select "TribalWars Enhancer mod by dr.love", and click Uninstall.
//
// --------------------------------------------------------------------
// ==UserScript==
// @name           حرب القبائل بـ آستآيل جديد 
// @version        3.6.3.EN.Z
// @namespace      i.am.تعريب adel
...
// @exclude    http://ae2.tribalwars.ae/staemme.php?screen=overview&intro&t=*
// @exclude    http://ae2.tribalwars.ae/game.php?village=[replace with users village]*
// @copyright      Copyright (c) 2007,2008,2009,2010, dr.love
// ==/UserScript==
...
//If you want to see expandable menu (!!!عربي وبس!!!)
var emenu= 0;
// Make remote calls
  ...
  'enhance_game_settings' : function() {
   ...
   'info' : {
	...
	plugins.SnobBuildingSmithyResources = {
		...
		'info' : {
			'mandatory' : false,
			'name' : "Enhanced Resource Counter",
...
plugins.BBCodesTextArea = {
	"BBMenuGenerator" : function() {
		...
		var xhtml = '<center><table style="cursor:pointer;" cellpadding="0" cellspacing="0">' +
			'<tr>' +
               '   <td onmouseover="javascript:this.style.backgroundColor=\'peachpuff\';" onmouseout="javascript:this.style.background=\'none\';" onclick="javascript:insertBB(\'player\','+random+');" title="Player" tabindex="10"><img src="graphic/face.png" alt="Player" /></td>' +
               '   <td onmouseover="javascript:this.style.backgroundColor=\'peachpuff\';" onmouseout="javascript:this.style.background=\'none\';" onclick="javascript:insertBB(\'village\','+random+');" title="Village" tabindex="11"><img src="graphic/buildings/main.png" alt="Village" /></td>' +
               '   <td onmouseover="javascript:this.style.backgroundColor=\'peachpuff\';" onmouseout="javascript:this.style.background=\'none\';" onclick="javascript:insertBB(\'tribe\','+random+');" title="Tribe" tabindex="12"><img src="graphic/command/support.png" alt="Tribe" /></td>' +
			'<td style="cursor:default;">.</td>' +
               '   <td onmouseover="javascript:this.style.backgroundColor=\'peachpuff\';" onmouseout="javascript:this.style.background=\'none\';" onclick="javascript:insertBB(\'b\','+random+');" title="Bold" tabindex="13" style="width:15px;text-align:center;"><b>B</b></td>' +
               '   <td onmouseover="javascript:this.style.backgroundColor=\'peachpuff\';" onmouseout="javascript:this.style.background=\'none\';" onclick="javascript:insertBB(\'i\','+random+');" title="Italic" tabindex="14" style="width:15px;text-align:center;"><i>I</i></td>' +
               '   <td onmouseover="javascript:this.style.backgroundColor=\'peachpuff\';" onmouseout="javascript:this.style.background=\'none\';" onclick="javascript:insertBB(\'u\','+random+');" title="Under scored" tabindex="15" style="width:15px;text-align:center;"><u>U</u></td>' +
               '   <td onmouseover="javascript:this.style.backgroundColor=\'peachpuff\';" onmouseout="javascript:this.style.background=\'none\';" onclick="javascript:insertBB(\'s\','+random+');" title="Crossed out" tabindex="15" style="width:15px;text-align:center;text-decoration:line-through;"><s><del>S</del></s></td>' +
			'<td style="cursor:default;">.</td>' +
               '   <td onmouseover="javascript:this.style.backgroundColor=\'peachpuff\';" onmouseout="javascript:this.style.background=\'none\';" onclick="javascript:insertBB(\'quote\','+random+');" title="Quote" tabindex="16"><img src="http://www.offthemap.com/images/site/blockquote.jpg" alt="Quote" /></td>' +
               '   <td onmouseover="javascript:this.style.backgroundColor=\'peachpuff\';" onmouseout="javascript:this.style.background=\'none\';" onclick="javascript:insertBB(\'url\','+random+');" title="URL Link" tabindex="17"><img src="http://runbut.com/Images/Hyperlink.jpg" alt="URL" /></td>' +
               '   <td onmouseover="javascript:this.style.backgroundColor=\'peachpuff\';" onmouseout="javascript:this.style.background=\'none\';" onclick="javascript:insertBB(\'img\','+random+');" title="Image Link" tabindex="18"><img src="http://www.zaburi.com/images/icons/image_add.png" alt="Image" /></td>' +
			'<td style="cursor:default;">.</td>' +
               '   <td title="Wstaw kolor"><select onchange="javascript:insertBB(\'color\','+random+',this.value);this.selectedIndex=0;"><option value="DISABLED" selected disabled>Font Color</option><option value="red" style="color:red;">Red</option><option value="pink" style="color:pink;">Pink</option><option value="purple" style="color:purple;">Purple</option><option value="blue" style="color:blue;">Blue</option><option value="aqua" style="color:aqua;">Aqua</option><option value="green" style="color:green;">Green</option><option value="yellow" style="color:yellow;">Yellow</option><option value="orange" style="color:orange;">Orange</option><option value="black" style="color:black;">Black</option><option value="gray" style="color:gray;">Gray</option><option value="silver" style="color:silver;">Silver</option><option value="white" style="color:white;">White</option></select></td>' +
               '   <td title="Wstaw rozmiar"><select onchange="javascript:insertBB(\'size\','+random+',this.value);this.selectedIndex=0;" style="height:17px;"><option value="DISABLED" selected disabled>Font Size</option><option value="2" style="font-size:2pt;">2</option><option value="4" style="font-size:4pt;">4</option><option value="6" style="font-size:6pt;">6</option><option value="8" style="font-size:8pt;">8</option><option value="10" style="font-size:10pt;">10</option><option value="12" style="font-size:12pt;">12</option><option value="14" style="font-size:14pt;">14</option><option value="16" style="font-size:16pt;">16</option><option value="18" style="font-size:18pt;">18</option><option value="20" style="font-size:20pt;">20</option></select></td>' +
			'<td style="cursor:default;">.</td>' +
		...
		'enhance_game' : function() { // Add the premium-like toolbar
 		//make sure twe.curVillage is initalized
			...
			if(multivillage && twe.myVillages().length > 0) {
				...
				menu_xhtml += '<td style="border-left:dotted 1px"><select onchange="switch_village(this)">';/*<option value="">villages</option>';*/
...
//				twt_xhtml += '<td><input type="text" id="twtools_player" value="' + twe.lang("player") + '" /><a href="javascript:tool_info(\'player\')"><img src="' + personals.getImageBase() + 'rechts.png" style="margin:0px 2px" title="' + twe.lang("i_player") + '" /></a></td>';//onfocus="i_focus(this)" onblur="i_blur_tribe(this)"
	...
	plugins.SimpleDistanceCalc = { // Calculate the time to travel to a village
		...
		'info' : {
			'mandatory' : false,
			'name' : "Calculator",
			'desc' : "Just a simple calculator device.",
			'version' : "0.1",
			'dev' : "Timas"
		}
	};	
  ...
  'get_distance_table' : function(target) {
	  ...
	  setFunc("distancecalctoggle", function() {
		 $(".distancecalchide").toggle();
		 if ($("#distancecalclink span").html() != 'show') { $("#distancecalclink span").html('show'); } else { $("#distancecalclink span").html('ukryj'); }
...
*/
			...
			// end of top menu edit by  dr.love thematrix370