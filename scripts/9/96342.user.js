...
//  Updated for SPCC by Zaranthan
//
// Updated points values and current maintenance handled by Zaranthan
//
// ==UserScript==
// @name          SPCC - hobopolis manager
// @namespace     http://userscripts.org/scripts/source/96342.user.js
// @version       2.51c
// @description   Version 2.51c - modifed from magnet0 version of slyz's Raid Log Manager 
...
// ==/UserScript==
// --------------------------------------------------------------------------------------
// Modified magnet0's Raid Log Manager
// --------------------------------------------------------------------------------------
// 03/14/2011 version 2.51c - Changed boss values for March Madness, altered version checker AGAIN. :(
// 03/01/2011 version 2.51b - Bypassed version check, I'm going to need to develop on my own schedule
// 02/07/2011 version 2.51a - Changed point values to donkeybutt200's system
...
var twn_Richard_2 = 0 ;
var twn_Richard_3 = 0 ;
var twn_Hodg = -40 ; //-80 after March

// BURNBARREL:

var brn_Hobo = .25 ;
var brn_Scratch = -60 ; //-120 after March
var brn_Defeats = -2 ;
var brn_Fire = 2 ;
var brn_Tirevalance = 1 ;
var brn_Steam = -3  ;
var brn_Opened_Door = 5 ;
var brn_Burned_Door = -1 ;

// EXPOSURE ESPLANADE:

var exp_Hobo = .25 ;
var exp_Frosty = -60 ; //-120 after March
var exp_Defeats = -2 ;
var exp_Freezer = 3 ;
var exp_Fridge = 2 ;
var exp_Broke = 2 ;
var exp_Water_Out = 3 ;
var exp_Water_Burnbarrel = 2 ;
...
var heap_Hobo = .25 ;
var heap_Oscus = -60 ; //-120 after March
var heap_Defeats = -2 ;
var heap_Trashcano = 2 ;
var heap_Treasure = -1 ;
var heap_compost = -3 ;
...
var burial_Hobo = .25 ;
var burial_Zombo = -60 ; //-120 after March
var burial_Defeats = -2 ;
var burial_Flowers = -3 ;
var burial_Raided = 5 ;
var burial_Dance = 1  ;
...
var purple_Hobo = .25 ;
var purple_Chester = -60 ; //-120 after March
...
var currentVersion = "2.51c";
var scriptURL = "http://userscripts.org/scripts/source/96342.user.js";
var scriptName = "SPCC - hobopolis manager";
...
{
/* Really? Every time the script runs? Yeesh, dude.
...
//		}
    ...
    document.body.innerHTML = "<div style='font-size: 10px;' align='center'>"+
                              "    <a href='/showplayer.php?who=1995860'>Zaranthan's</a> SPCC Dungeon Log Viewer" + currentVersion + "<br><br>"+
                              "</div>" + 
                              "<div align='center'>"+
