...
for(var x=0;x<imgs.length;x++){
	...
	if(imgs[x].src.indexOf("left_top.gif")>0){
		...
		imgs[x].src = "http://shareimage.org/images/j85apaxls572h2l6im5.png";
	}else if(imgs[x].src.indexOf("eps.png")>0){
		imgs[x].src = "http://shareimage.org/images/c57pnzws0gb2wxokp8jg.png";
	}else if(imgs[x].src.indexOf("appz.png")>0){
		imgs[x].src = "http://shareimage.org/images/dglkwtg75ozpljvzkm6e.png";
		...
		imgs[x].src = "http://shareimage.org/images/h84jtk4fe9m5hq9kh9p6.png";
	}else if(imgs[x].src.indexOf("dvd-r.png")>0){
		imgs[x].src = "http://shareimage.org/images/vzwwasjhl42u2xhtwfjy.png";
	}else if(imgs[x].src.indexOf("console.png")>0){
		imgs[x].src = "http://shareimage.org/images/2rsvgm48fdbyfb8wluz2.png";
        }else if(imgs[x].src.indexOf("hdtv.png")>0){
		imgs[x].src = "http://shareimage.org/images/dv9udel6uuecekujmi.png";
        }else if(imgs[x].src.indexOf("hd-ro.png")>0){
		imgs[x].src = "http://shareimage.org/images/xtta601e36idkt530gz.png";
        }else if(imgs[x].src.indexOf("hd.png")>0){
		imgs[x].src = "http://shareimage.org/images/3k02pc7t3k4ghn7qs6.png";
		...
		imgs[x].src = "http://shareimage.org/images/5izk1uakneuqkmwk3kg.png";
	}else if(imgs[x].src.indexOf("sport.png")>0){
		imgs[x].src = "http://shareimage.org/images/crq61yx6xslq803u9z27.png";
		...
		imgs[x].src = "http://shareimage.org/images/yevljsc5o9i1pn1pbii.png";
		...
		imgs[x].src = "http://shareimage.org/images/obcl41j6rttailneic2a.png";
	}else if(imgs[x].src.indexOf("unlockednew.png")>0){
		imgs[x].src = "http://shareimage.org/images/p0dw2gq7rs0he9d7hb0v.png";
	}else if(imgs[x].src.indexOf("lockednew.png")>0){
		imgs[x].src = "http://shareimage.org/images/iexvmzjeblndgxqcsm6.png";
        }else if(imgs[x].src.indexOf("locked.png")>0){
		imgs[x].src = "http://shareimage.org/images/btvkjotg6xacnsjo5jz9.png";
        }else if(imgs[x].src.indexOf("blu.png")>0){
		imgs[x].src = "http://shareimage.org/images/5n0t3bkbez8izwbfbhqv.png";
	}else if(imgs[x].src.indexOf("vcd.png")>0){
		imgs[x].src = "http://shareimage.org/images/m8e65kd19n4icxd1b5bk.png";
	}else if(imgs[x].src.indexOf("logo.png")>0){
		imgs[x].src = "http://img211.imageshack.us/img211/1353/uploadprevmy8.jpg";
	}else if(imgs[x].src.indexOf("arrowup.gif")>0){
		imgs[x].src = "http://shareimage.org/images/fpz5qvrvb44zao673lz.png";
	}else if(imgs[x].src.indexOf("arrowdown.gif")>0){
		imgs[x].src = "http://shareimage.org/images/wkrjmm2w8gcy77dj2r3g.png";
		...
		imgs[x].src = "http://shareimage.ro/images/55rpcidpznjgdu8ugey.png";		
	}else if(imgs[x].src.indexOf("starbig.gif")>0){
		imgs[x].src = "http://shareimage.ro/images/g7k5mvuak7245zklm98.png";
