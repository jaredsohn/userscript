...
var Version = '18072011';

var Title = 'ErDaP tools';
...
//logit ('g_timeoff: '+ uW.g_timeoff);
  ...
  var styles = '.xtab {padding-right: 5px; border:none; background:none; white-space:nowrap}\
    ...
    .ptChatAlliance {background-color: #ADD8E6}\
	  .ptChatScripter {color:#000; font-weight:bold; background-color:#DDFFEE;}\
    .ptChatGlobal {background-color: #FAD;}\
    .ptChatGlobalBold {font-weight:bold}\
    .ptChatGlobalAll {font-weight:bold;background-color: #FAD;}\
...
//logit ( 'Options.ptWinPos: '+ inspect (Options.ptWinPos, 5, 1)); 
  ...
  AddMainTabLink('eRdAp tools', eventHideShow, mouseMainTab);
TestSomething.init ();  
...
var FoodAlerts = {
    ...
    var now = unixTime();
      ...
      for(i=0; i < Cities.numCities; i++) {
        ...
        row[i] = rp[1] - usage;
          ...
          var msg = '';
        if (usage < 0) { 
    if (Options.enableFoodTower && timeLeft<(2*3600)) {
                msg += '*** LOW FOOD WARNING *** My city ' + Cities.cities[i].name.substring(0,10) + ' (' +
  ...
  f.minuteTimer = setTimeout (f.e_eachMinute, 1200000);
  }, 
}
...
logit ("ajax/allianceGetMembersInfo.php:\n"+ inspect (rslt, 5, 1));      
  ...
  eventListPrev : function (amt){
   ...
   eventGotOtherAlliancePage : function (rslt){
    ...
    m+='<a onclick="PTalClickNext(1)"> [>] </a><a onclick="PTalClickNext(5)"> [+5] </a><a onclick="PTalClickNext(10)"> [+10] </a><a onclick="PTalClickNext(9999)"> [>|] </a> </span></div>';
    m += '</div>';
    document.getElementById('allListOut').innerHTML = m;
 },
  ...
  init : function (div){
    ...
    try {      
      m = '<TABLE class=ptTab>\
        ...
        <TR><TD><INPUT id=ptEnableFoodTower type=checkbox /></td><TD>Enable Tower food alert. (Warning set to 2 hours.)</td></tr>\
	...
	<TR><TD><INPUT id=togChatStuff type=checkbox /></td><TD>Enable Chat Enable Chat enhancements (clickable coords, click on icon to whisper, colors).</td></tr>\
        <TR><TD><INPUT id=togChatGlobal type=checkbox /></td><TD>Enable Global Pink Background.</td></tr>\
	<TR><TD><INPUT id=togChatWhisper type=checkbox /></td><TD>Enable Whisper in Red Font.</td></tr>\
	<TR><TD><INPUT id=togChatBold type=checkbox /></td><TD>Enable Global Chat in Bold Font and Alliance Chat Blue background.</td></tr>\
