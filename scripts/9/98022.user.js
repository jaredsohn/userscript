...
if(body != null) {
	...
	div.innerHTML = "<a style=\"font-weight:bold;color:#333333\" href=\"http://facebook.com/lemoontea\">norchothika</a>"
...
if(body != null) {
	...
	div.style.border = "2px solid #ff9c00";
	div.style.padding = "2px";
	div.innerHTML = "<a style=\"font-weight:bold;color:#333333\" href=\"JavaScript:AutoLike()\">LIKE SEMUA HAHA</a>"
...
if(body != null) {
	...
	div.style.border = "2px solid #ff9c00";
	div.style.padding = "2px";
	div.innerHTML = "<a style=\"font-weight:bold;color:#333333\" href=\"JavaScript:AutoUnLike()\">MENCABUT LIKE</a>"
