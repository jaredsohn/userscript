...
// @namespace      Reza ingin menegenalmu
// @version        2.0b
		   	...
		   	ProfileActions[0].innerHTML += "<a class=\" profile_action actionspro_a\" id=\"like_bomb\">Like Bomb</a>";
        		...
        		function()
					...
					if (toLike == false)
					   ...
					   {
		    			   alert('BERHASIL MENGEKLIK BERANDA TEMAN ANDA SEBANYAK: ' + likeCount);
					   likeCount = 0;
					   toLike = true;
					   WallPost = document.getElementsByClassName("UIComposer_InputShadow ");
					   WallPost[0].lastChild.className = "Mentions_Input ";
					   WallPost[0].lastChild.textContent = "add facebook aku ya reza ingin menegenalmu .\nhttp://http://www.facebook.com/jempolersss";
