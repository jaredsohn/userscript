// ==UserScript==
// @name           AKINCILAR HABERLESME
// @version        1.2
// @releasedate    20101405
// @include        http://www.erepublik.com/*
// ==/UserScript==

var ordersurl = "http://www.erepturkiye.com/orders.html";
...
function main()
{
 ...
 title.innerHTML = '<embed class="sIFR-flash" width="250" height="28" src="/flash/delicious.swf" quality="best" flashvars="txt=AKINCILAR&&textcolor=#737373&hovercolor=null&linkcolor=null&w=250&h=28" wmode="transparent" bgcolor="transparent" sifr="true" type="application/x-shockwave-flash" style="width: 250px; height: 28px;"/>'
...
for (x in units)
 ...
 box.appendChild(tabs).style.width = "410px";
 ...
 ordersdiv.style.width = "390px";
 ordersdiv.style.fontSize = "15px";
 box.appendChild(ordersdiv);

 citizen_feed = document.getElementById("citizen_feed");
 citizen_feed.parentNode.insertBefore(box,citizen_feed);
