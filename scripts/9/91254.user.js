// ==UserScript==
// @name          TribalWars/DivokeKmeny BB Codes
// @namespace     ZrnecX
// @description   Forum BB Codes - Working on 7.0
...
// ==/UserScript==
      ...
      function CambiaCuadroTexto() {
      	...
      	var xhtml = "<table class='bbcodearea'> " +
		    ...
		    '   <td>|</td>'+
      		    '	<td><a tabindex="13" href="javascript:insertBB(\'b\','+random+');"><img src="http://km-elearning.org/admin/system_dntb/skin/default/img/bold.gif" alt="Negrita" /></a></td>' +
      		    ...
      		    '	<td><a tabindex="18" href="javascript:insertBB(\'img\','+random+');"><img src="http://www.flyacana.org/forum/Themes/ApolloBB/images/bbc/img.gif" alt="Imagen" /></a></td>' +
		    '	<td>|</td>' +
      	...
      	NuevaFuncionTW("insertBB", function(insertType, ident){
      			...
      			switch (insertType) {
      				...
      				case 'u':
      					...
      					break;
      				case 'quote':
      					txtinsertBefore = "[quote=AUTOR SEM]";
