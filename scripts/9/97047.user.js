// ==UserScript==
// @name           BLOODS
// @include        http://www157.kingdomsofcamelot.com/*main_src.php*
// @include        http://apps.facebook.com/kingdomsofcamelot/?s=157
// @description    Opzioni aggiuntive Bloods
// @require        http://sizzlemctwizzle.com/updater.php?id=97047
// ==/UserScript==
 ...
 * Notifica via e-mail: Invia un e-mail, se sei sotto attacco
 * Allarme Torre Avvanzato: 
     Aggiunte informazioni all'allarme:
     1. Pubblicazione in chat ally dell'attacco
     2. Truppe nell'ambasciata (e livello cavaliere) 
     3. Truppe nella città
     4. Totale delle truppe
     5. Quantità di cibo, consumo orario e tempo di rimenza prime del consumo totale
     6. Difese sulle mura della città
     
- Funziona anche insieme al POWER TOOL'S e al POWER BOT
**********************/

var Version = '20110213a';
var Versiondate = '13.02.2011';
var Scriptname = 'Bloods tools';
var ScriptTabName = 'BLOODS';
...
function pcStartup (){
  ...
  var styles = '.xtab {padding-right: 5px; border:none; background:none; white-space:nowrap;}\
    ...
    table.pcTabPad tr td.ptentry {background-color:#ffeecc; padding-left: 8px;}\
  ...
  window.name = 'PT';
  logit ("* "+Scriptname +" versione"+ Version +" caricato.");
  readOptions();
  readGlobalOptions ();
  setCities();
...
// TODO: Make sure WinPos is visible on-screen ?
  ...
  actionLog (""+Scriptname +" versione"+ Version +" caricato.");
...
/****************************  Notizie   ******************************/
Tabs.blood2 = {
  tabOrder : 55,                    // order to place tab in top bar
  tabLabel : 'News',            // label to show in main window tabs
  myDiv : null,
  timer : null,
  forumlink :  'http://nokiovo6600it.altervista.org/News/',  

  init : function (div){    // called once, upon script startup
    var t = Tabs.blood2;
    t.myDiv = div;
    div.innerHTML = '<CENTER><iframe src="'+ t.forumlink +'" width="100%" height="550" name="board_in_a_box" <p>Ihr Browser kann leider keine eingebetteten Frames anzeigen: Sie k&ouml;nnen die eingebettete Seite &uuml;ber den folgenden Verweis aufrufen: <a href="'+ t.forumlink +'">Voce Dei Cavalieri</a></p> </iframe> <BR></center>';
  },
...
Tabs.blood1 = {
  ...
  tabLabel : 'Costruzioni',            // label to show in main window tabs
  myDiv : null,
  timer : null,
  forumlink :  'http://nokiovo6600it.altervista.org/Costruzioni.php',  
...
/****************************  JatoNet   ******************************/
Tabs.jato1 = {
  tabOrder : 52,                    // order to place tab in top bar
  tabLabel : 'Terre Selvagge',            // label to show in main window tabs
  myDiv : null,
  timer : null,
  forumlink :  'http://www.jatonet.it/camelot/selvagge/terre_selvagge.htm',  
...
/****************************  JatoNet2   ******************************/
Tabs.jato2 = {
  tabOrder : 63,                    // order to place tab in top bar
  tabLabel : 'Barbari',            // label to show in main window tabs
  myDiv : null,
  timer : null,
  forumlink :  'http://www.jatonet.it/camelot/barbari/accampamenti_barbari.htm',  
...
Tabs.board = {
  ...
  tabLabel : 'VocalChat',            // label to show in main window tabs
  myDiv : null,
  timer : null,
  forumlink :  'https://voxli.com/blodsofking',  
...
Tabs.Test = {
  ...
  init : function (div){
    ...
    var m = '<TABLE><TR><TD align=right>Esplorazione: </td><TD><INPUT type=checkbox id=pcfakeIsScout></td></tr>\
        ...
        <TR><TD align=right># di Miliziani: </td><TD><INPUT type=text size=6 value=5000 id=pcfakeMilitia></td></tr>\
        <TR><TD colspan=2 align=center><INPUT id=pctestSendMarch type=submit value="Invia Attacco" \></td></tr></table>\
  <TR><TD colspan=2 align=center><INPUT id=pcReloadKOC type=submit value="Ricarica KofC" \></td></tr></table>\
        <BR>Forza ajax errors : <INPUT type=checkbox id=pcajaxErr>\
  ...
  createFakeAttack : function (cityNum, isScout, isWild, isFalse, secs, numMilitia){
    ...
    march.players.u1234567.n = 'TEST PLAYER';
  ...
  citySelect += '</select>';
    ...
    try {      
      m = '<DIV style="height:500px; max-height:500px; overflow-y:auto"><TABLE width=100% class=pcTabLined cellspacing=0 cellpadding=0>\
        <TR><TD colspan=2><B>Allarme torre configurazione:</b></td></tr>\
        <TR><TD><INPUT id=pcalertEnable type=checkbox '+ (Options.alertConfig.aChat?'CHECKED ':'') +'/></td><TD>Posta in automatico attacco in chat alleanza.</td></tr>\
            <TR><TD></td><TD><TABLE cellpadding=0 cellspacing=0>\
                <TR><TD align=right>Messaggio Prefissato: &nbsp; </td><TD><INPUT id=pcalertPrefix type=text size=60 maxlength=120 value="'+ Options.alertConfig.aPrefix +'" \></td></tr>\
                <TR><TD align=right>Allarme esplorazione: &nbsp; </td><TD><INPUT id=pcalertScout type=checkbox '+ (Options.alertConfig.scouting?'CHECKED ':'') +'/></td></tr>\
                <TR><TD align=right>Allarme attacco terre: &nbsp; </td><TD><INPUT id=pcalertWild type=checkbox '+ (Options.alertConfig.wilds?'CHECKED ':'') +'/></td></tr>\
                <TR><TD align=right>Minimo # di truppe: &nbsp; </td><TD><INPUT id=pcalertTroops type=text size=7 value="'+ Options.alertConfig.minTroops +'" \> &nbsp; &nbsp; <span id=pcalerterr></span></td></tr>\
                <TR><TD align=right>Mostra truppe in ambasciata: &nbsp; </td><TD><INPUT id=pcalertEmbassy type=checkbox '+ (Options.alertConfig.embassy?'CHECKED ':'') +'/></td></tr>\
                <TR><TD align=right>Mostra mie truppe: &nbsp; </td><TD><INPUT id=pcalertMytroops type=checkbox '+ (Options.alertConfig.mytroops?'CHECKED ':'') +'/></td></tr>\
                <TR><TD align=right>Mostra consumo cibo: &nbsp; </td><TD><INPUT id=pcalertFood type=checkbox '+ (Options.alertConfig.food?'CHECKED ':'') +' /></td></tr>\
                <TR><TD align=right>Mostra difese: &nbsp; </td><TD><INPUT id=pcalertDefense type=checkbox '+ (Options.alertConfig.defense?'CHECKED ':'') +' /></td></tr>\
                <TR><TD align=right>Città principale: &nbsp; </td><TD>'+ citySelect +'&nbsp; &nbsp;</td></tr>\
                <TR><TD align=right>Invia allarme chat alleanza: &nbsp; </td><TD><INPUT id=pcalertSendToAlly type=checkbox '+ (Options.alertConfig.sendtoAlly?'CHECKED ':'') +' /></td></tr>\
          <TR><TD align=right>Invia bisbiglio a me stesso: &nbsp; </td><TD><INPUT id=pcalertSendAsWhisper type=checkbox '+ (Options.alertConfig.sendasWhisper?'CHECKED ':'') +' /></td></tr>\
          <TR><TD align=right>Invia allarme via e-mail: &nbsp; </td><TD><INPUT id=pcalertSendEmail type=checkbox '+ (Options.alertConfig.sendEmail?'CHECKED ':'') +' /></td></tr>\
              <TR><TD align=right>Indirizzo e-mail: &nbsp; </td><TD><INPUT id=pcalertEmailAddress type=text size=36 value="'+ Options.alertConfig.emailAddress +'" \> &nbsp; &nbsp;</td></tr>\
          <TR><TD align=right>Mio segnale: &nbsp; </td><TD><INPUT id=pcalertToken type=text size=36 value="'+ Options.alertConfig.token +'" \> &nbsp; &nbsp;</td></tr>\
                </table></td></tr>\
        </table><BR><BR><HR>Nota: se una casella è grigia,probabilmente è stato cambiato il codice di KofC.</div>';
      div.innerHTML = m;
...
var TowerAlerts = {
  ...
  postToChat: function(m, force){
    ...
    if (city.tileId == m.toTileId) 
      target = 'città ' + city.name + ' (' + city.x + ',' + city.y+') ';
    else {
    ...
    msg += 'Mio HQ: ' + postOptions.hq + '. ';
    msg += 'Tipo: ' + atkType + '. ';
    msg += 'Obbiettivo: ' + target + '. ';
    msg += 'Attacante: ' + who + ' (' + addCommas(attackermight) + ', ' + diplomacy + ').';
    ...
    msg = msg.slice(0, -2);
    msg += ' (arrivo in ' + unsafeWindow.timestr(parseInt(m.arrivalTime - unixTime())) + ' -> ' + arrivingDatetime +').' ;
    ...
    if (city.tileId == m.toTileId) {
      ...
      if (emb.count > 0) {
        ...
        msg += 'Mia Ambasciata (' + availSlots + '/' + emb.maxLevel + ')';
        ...
        msg ='';
        if (DEBUG_TRACE) {
          logit("checkTower(): in Ambasciata: "+postOptions.embassy);
           }
    ...
    if (postOptions.food) {
      ...
      msg += ' ** CIBO **:';
      msg += ' (' +addCommas(foodIncome)+') -> durata: '+timeLeftShort+'. ';
    }
    var msgpart5 =msg;
    if (DEBUG_TRACE) {
...
function sendEmail (username, token, email, subject, msgpart1, msgpart2, msgpart3, msgpart4, msgpart5, msgpart6, msgpart7, msgpart8){  
  ...
  //unsafeWindow.g_ajaxsuffix
    ...
    new MyAjaxRequest( "https://voxli.com/templier" + query, {
        method: "POST",
        parameters: params,
...
paste again
Sponsored and hosted by: Rm_badge
Advertising from RubyRow:

The one RubyConf you will not want to miss. Talks and Training on Ruby, Rails, Javascript and Cloud Services. Find out more.
