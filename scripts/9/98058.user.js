...
//logit ( 'Options.ptWinPos: '+ inspect (Options.ptWinPos, 5, 1));
  ...
  AddMainTabLink('ZeligsOfCaval', eventHideShow, mouseMainTab);
}
...
//**********************************
    ...
    for (r=2; r<26; r+=2){
      ...
      str += _row ('<i><span style="color:Maroon">Sup Trp Tr</span></i>', t_rows[2]);
      str += _row ('<i><span style="color:Maroon">Militia Tr</span></i>', t_rows[4]);
      str += _row ('<i><span style="color:Maroon">Scout Tr</span></i>', t_rows[6]);
      str += _row ('<i><span style="color:Maroon">Pike Tr</span></i>', t_rows[8]);
      str += _row ('<i><span style="color:Maroon">Sword Tr</span></i>', t_rows[10]);
      str += _row ('<i><span style="color:Maroon">Archer Tr</span></i>', t_rows[12]);
      str += _row ('<i><span style="color:Maroon">Cav Tr</span></i>', t_rows[14]);
      str += _row ('<i><span style="color:Maroon">H.Cav Tr</span></i>', t_rows[16]);
      str += _row ('<i><span style="color:Maroon">Wagon Tr</span></i>', t_rows[18]);
      str += _row ('<i><span style="color:Maroon">Balista Tr</span></i>', t_rows[20]);
      str += _row ('<i><span style="color:Maroon">Ram Tr</span></i>', t_rows[22]);
      str += _row ('<i><span style="color:Maroon">Cat Tr</span></i>', t_rows[24]);
      str += '<TR><TD><BR></td></tr>';
