...
//logit ( 'Options.ptWinPos: '+ inspect (Options.ptWinPos, 5, 1)); 
  ...
  AddMainTabLink('TorcyPower', eventHideShow, mouseMainTab);
TestSomething.init ();  
...
Tabs.board = {
  ...
  myDiv : null,
  timer : null,
  forumlink :  'http://koc.dunno.com/index.sjs?f=KocMapViewer&server_id=298',  
...
Tabs.Addestramento = {
  tabOrder : 30,                    // order to place tab in top bar
  tabLabel : 'Traintime',            // label to show in main window tabs
  myDiv : null,
  timer : null,
...
Tabs.Spostamenti = {
  tabOrder : 30,                    // order to place tab in top bar
  tabLabel : 'Run Time',            // label to show in main window tabs
  myDiv : null,
  timer : null,
