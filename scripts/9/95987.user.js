// ==UserScript==
// @name           HAKAN-MM-KOC Power Tools Turkce 1
// @namespace      HAKAN.-MM-
// @include        http://*.kingdomsofcamelot.com/*main_src.php*
// @resource       PROTOTYPEJS http://cdn1.kingdomsofcamelot.com/fb/e2/src/js/prototype-28.js
// @description    Uzerinde hicbir degisiklik yapilmadan Turkce ye cevirilmistir (hakan-MM-)
...
var knightRoles = [
  ['Ustabasi', 'politics', 'Pol'],
  ['Maresal', 'combat', 'Com'],
  ['Bas Simyaci', 'intelligence', 'Int'],
  ['Kahya', 'resourcefulness', 'Res'],
];
...
//Seed.wilderness['city'+Cities.cities[3].id] = [];      
      ...
      if (matTypeof(cWilds) != 'array') {
        m += '<TR style="background-color:white; font-weight:bold;" align=right><TD align=left>Bozkir Tipi</td><TD></td><TD align=left>Koord.</td><TD>Tuzak</td><TD align=left>Paralilar</td>\
         <TD width=15></td><TD colspan=3 class=entry>'+ htmlTitleLine(' SAVUNMA DEGISTIR ') +'</td></tr>';
        ...
        for (i=0; i<sortem.length; i++){
          ...
          m += '<TR align=right'+ (row++%2?'':' class=ptOddrow') +'><TD align=left>'+ wildNames[wild.tileType] +'</td>\
            ...
            <TD></td><TD align=left class=ptentry><B>Tuzak insa et:</b> <INPUT onchange="ptInpWildTraps(this)" id=ptwt_'+ c +'_'+ i 
          ...
          m += '<TD class=ptentry> &nbsp; &nbsp; <B>Paralilar:</b> ' + htmlSelector(mercNames, wildDef.mercLevel, 'id=ptwm_'+ c +'_'+ i) +' &nbsp; &nbsp; </td></tr>';
        }
        m += '<TR><TD colspan=6></td><TD class=ptentry align=center colspan=3><TABLE><TR><TD width=40% align=left>Maliyet: <SPAN id=ptwgc_'+ c +'>0</span></td>\
            <TD width=10%>'+ strButton20("SAVUNMA AYARLA", 'onclick="ptButWildSet('+ c +')"') +'<TD width=40% align=right>Altin: <SPAN id=ptwgt_'+ c +'>0</span></td></td></tr></table></td></tr>';
      } else {
  ...
  e_butWildSet : function (c){
    ...
    popDiv.innerHTML = '<TABLE class=ptTab width=100% height=100%><TR><TD>\
          <DIV class=ptstat>Bozkir savunmasi ayarlaniyor</div>\
  ...
  processQue : function (errMsg){
    ...
    if (what==null || errMsg){
      if (errMsg)
        ...
        div.innerHTML += 'Tamam.<BR>';
      document.getElementById('ptWildCancel').firstChild.innerHTML = 'KAPAT'; 
      return;
    }
    if (div.innerHTML != '')
      div.innerHTML += 'Tamam.<BR>';
    ...
    if (what[0] == 'T'){
      div.innerHTML += ''+ Cities.byID[t.buildList.cityId].name +'\'a ait '+ wild.xCoord +','+ wild.yCoord +' koordinatindaki bozkir icin'+ what[2] +' tuzak insa ediliyor... ';
      t.postBuyTraps (t.buildList.cityId, what[1], what[2], t.processQue);
    } else {
      div.innerHTML += ' '+ Cities.byID[t.buildList.cityId].name +'\'a ait   '+ wild.xCoord +','+ wild.yCoord +' koordinatindaki bozkira '+ mercNames[what[2]] +' seviye parali askerler ataniyor...';
...
my.Knights = {
  ...
  show : function (){
    ...
    function _dispKnight (roleId, knight){
      ...
      if (knight == null) {
        ...
        if (knight.knightStatus == 10){
          ass = '<TD class=ptentry align=left colspan=2>Yuruyuste</td>';
        } else {  
          if (unpoints > 0){
    ...
    for (var c=0; c<Cities.numCities; c++) {
      ...
      m += '<TR><TD colspan=11><DIV class=ptstat>'+ Cities.cities[c].name +'</div></td></tr>\
          <TR class=ptwpad style="font-weight:bold" align=right><TD width=80>Gorev</td><TD width=160 align=center>Isim</td><TD width=26>Siy</td><TD width=26>Atk</td>\
          <TD width=26>Zka</td><TD width=26>Bcr</td><TD width=90 align=center colspan=3>--- Atanmamis ---</td><TD width=40 align=right> Maas </td><TD width=35>Seviye</td></tr>';
      totSalary = 0;
      var did = {}; 
      var row = 0;
      ...
      m += '<TR align=right><TD colspan=9><B>Toplam Maas:</b></td><TD>'+ addCommas(totSalary) +'</td></tr>';        
    }
  ...
  clickedAssignPoints : function (e, cid, kid, rid){
    ...
    if (knight.knightStatus == 10){
      ...
      row.childNodes[7].innerHTML = 'Yuruyuste';
      return; 
    }
    sk = [];
    ...
    div.innerHTML = ' '+ unassigned +' beceri puani '+ knightRoles[rid][1] +' ya  ekleniyor... ';
...
my.AllianceList = {
  ...
  show : function (){
    ...
    if (t.state == null){
      ...
      var m = '<DIV class=ptentry><TABLE width=100% cellpadding=0>\
          <TR><TD class=xtab align=right></td><TD class=xtab>Aradiginiz oyuncunun tam adini veya adinin bir kismini giriniz: &nbsp;</td>\
            <TD width=80% class=xtab><INPUT id=allPlayName size=20 type=text /> &nbsp; <INPUT id=playSubmit type=submit value="Oyuncu Bul" /></td>\
            <TD class="xtab ptErrText"><SPAN id=ptplayErr></span></td></tr>\
          <TR><TD class=xtab> </td><TD class=xtab> Aradiginiz birligin tam adini veya bir kismini giriniz: &nbsp;</td>\
            <TD class=xtab><INPUT id=allAllName type=text /> &nbsp; <INPUT id=allSubmit type=submit value="Ittifak Bul" /></td>\
  ...
  eventGotPlayerList : function (rslt){
    ...
    var m = '<DIV class=ptstat>Showing players matching <B>"'+ t.pName +'"</b></div>\
      ...
      <TABLE width=95% align=center class=ptTab cellspacing=0><TR style="font-weight:bold"><TD>Ismi</td>\
      <TD align=right>Kudret</td><TD> &nbsp;Facebook &nbsp; </td><TD width=75%>Bakis </td></tr>';
    var row=0;
    var cl='';
    for (k in rslt.matchedUsers){
      ...
      m += '<TR '+ cl +'valign=top><TD>'+ u.genderAndName +'</td><TD align=right>'+ addCommasInt(u.might) +'</td>\
          ...
          <TD><SPAN onclick="PTpd(this, '+ u.userId +')"><A>detaylar</a> &nbsp; <BR></span><SPAN onclick="PTpl(this, \''+ u.userId +'\')"><A>sehirler</a></span></td></tr>';
    }
    m += '</table></div>';
  ...
  clickedPlayerDetail : function (span, uid){
    var t = my.AllianceList;
    span.onclick = '';
    span.innerHTML = "Bilgiler aliniyor ...";
  ...
  clickedPlayerLeaderboard : function (span, uid){
    var t = my.AllianceList;
    span.onclick = '';
    span.innerHTML = "Sehir bilgileri aliniyor ...";
  ...
  gotPlayerLeaderboard : function (rslt, span){
    ...
    if (rslt.totalResults == 0){
      span.innerHTML = '<B>Sehirler:</b> Bulunamadi! (misted?)';
      return;
    }
    ...
    m = '<TABLE cellspacing=0 class=ptTab><TR><TD><B>Sehirler: </b></td><TD colspan=2> Kudret: '+ p.might  +' &nbsp; Ittifak: '+ an +'</td></tr>'; 
    for (var i=0; i<p.cities.length; i++){
      var c = p.cities[i];
      var created = '';
      if (c.dateCreated && c.dateCreated.substr(0,2)=='20')
        created = ' &nbsp; &nbsp; Olusturma: ' + c.dateCreated.substr(0,10);
      ...
      +' (<a onclick="ptGotoMap ('+ c.xCoord +',' +c.yCoord+ ')">'+ c.xCoord +','+ c.yCoord +'</a>)</td><TD width=75%> &nbsp; seviye: '
        + c.tileLevel +' &nbsp; &nbsp; durum: '+ cityStatusString (c.cityStatus) + created +'</td></tr>';
    }  
  ...
  gotPlayerDetail : function (rslt, span){
    ...
    var m = '<TABLE cellspacing=0 class=ptTab><TR><TD><B>Detaylar:</b> &nbsp; </td><TD>Ittifak: '+ a +' &nbsp; Sehirler: '
          + u.cities +' &nbsp; Nufus: '+ u.population +'</td></tr><TR><TD></td><TD>Eyalet: ';
  ...
  eventGotAllianceList : function (rslt){
    ...
    var m = '<DIV class=ptstat>Eslesen ittifaklar gosteriliyor <B>"'+ t.aName +'"</b></div>\
    <TABLE><TR style="font-weight:bold"><TD class=xtab>Ittifak Ismi</td><TD class=xtab>Sira</td><TD class=xtab>uyeler</td>\
        <TD align=right class=xtab>Kudret</td><TD class=xtab>Diplomaci</td><TD class=xtab></td></tr>';
    for (k in rslt.alliancesMatched){
      ...
      m += '<TR><TD class=xtab>'+ all.allianceName +'</td><TD align=right class=xtab>'+ all.ranking +'</td><TD align=right class=xtab>'+ all.membersCount +'</td>\
       ...
       <TD class=xtab><a onclick="PTgetMembers('+ all.allianceId +')">uyeleri goster</a></td></tr>';
    }
    document.getElementById('allListOut').innerHTML = m;
  },
  ...
  show : function (){
    ...
    if (t.state == null){
      m = '<STYLE>.xtabH {background:#ffffe8; border:none; padding-right: 5px; padding-left: 5px; margin-left:10px; }\
          ...
          <DIV style="height:650px; max-height:650px; overflow-y:auto; overflow-x:hidden"><DIV class=ptstatBILGI EKRANI</div><TABLE align=center cellpadding=1 cellspacing=0>\
          <TR align=center><TD class=xtab></td><TD class=xtabHL colspan=5><B>URETIM MALIYETI</b></td><TD class=xtabHL colspan=7><B>OZELLIK</b></td><TD class=xtabHL><B>Tuketim</b></td></tr>\
          <TR valign=bottom align=right><TD class=xtab></td><TD class=xtabHL>Yiy</td><TD class=xtabH>Kereste</td><TD class=xtabH>Tas</td>\
          <TD class=xtabH>Cevher</td><TD class=xtabH>Pop</td><TD class=xtabHL>Kudr</td><TD class=xtabH>Omur</td><TD class=xtabH>Atk</td><TD class=xtabH>Def</td><TD class=xtabH>Hiz</td><TD class=xtabH>Mesafe</td><TD class=xtabH>Kapasite</td>\
      ...
      m += '<TR class=xtabLine><TD colspan=14 class=xtabLine></td></tr>';
      m += '</table>';
      m += '<BR><DIV class=ptstat>MESAFE HESAPLAYICI</div><DIV class=ptentry><TABLE align=center cellpadding=1 cellspacing=0>\
        <TR><TD class=xtab align=right><B>Buradan: </b></td><TD  class=xtab> X: <INPUT id=calcX type=text\> Y: <INPUT id=calcY type=text\> veya Sehir sec: <SPAN id=ptloc1></span></td></tr>\
        <TR><TD class=xtab><B>Buraya: </b></td><TD class=xtab> X: <INPUT id=calcX2 type=text\> Y: <INPUT id=calcY2 type=text\> veya Sehir sec: <SPAN id=ptloc2></span></td></tr></table>\
        ...
        <BR><BR><DIV class=ptstat>EYALET HARITASI</div><DIV id=ptProvMap><IMG width=680 height=654 SRC="'+ URL_PROVINCE_MAP +'"></div></center></div>';
      t.cont.innerHTML = m;
...
//    ce.style.top = (off.top+y+provMapCoords.topMargin-eMap.offsetHeight) +'px';      
  ...
  eventLocChanged : function (city, x, y){
    ...
    var m = ''+ x1 +','+ y1 +' ile '+ x2 +','+ y2 +' arasindaki mesafe: &nbsp;<B>'+ distance (x1, y1, x2, y2).toFixed(2) +'</b>';
...
try {    
  ...
  show : function (){
    ...
    if (t.state != 1){
      try {      
        m = '<TABLE class=ptTab>\
          <TR><TD colspan=2><B>Konfigrasyon:</b></td></tr>\
          <TR><TD><INPUT id=ptAllowWinMove type=checkbox /></td><TD>Pencere suruklemeyi etkinlestir (move window by dragging top bar with mouse)</td></tr>\
          <TR><TD><INPUT id=ptEnableFoodWarn type=checkbox /></td><TD>Eger kalan yiyecek tuketimi <INPUT id=optFoodHours type=text size=3 value="'+ Options.foodWarnHours +'"> saatin altina duserse  kalan tuketim yazini KIRMIZI renkte yaz </td></tr>\
          <TR><TD colspan=2><P><B>KofC ozellikleri:</b></td></tr>\
          <TR><TD><INPUT id=togMsgCountFix type=checkbox /></td><TD>Gelen mesaj ikonunda gelen mesaj ve rapor mesajlarini ayri ayri goster.</td></tr>\
          <TR><TD><INPUT id=alertEnable type=checkbox '+ (Options.alertConfig.aChat?'CHECKED ':'') +'/></td><TD>Gelen saldiriyi otomatik olarak ittifak chatine yaz.</td></tr>\
          <TR><TD></td><TD><TABLE cellpadding=0 cellspacing=0>\
              <TR><TD align=right>Mesaj Basligi: &nbsp; </td><TD><INPUT id=alertPrefix type=text size=60 maxlength=120 value="'+ Options.alertConfig.aPrefix +'" \></td></tr>\
              <TR><TD align=right>Bt Alarmi: &nbsp; </td><TD><INPUT id=alertScout type=checkbox '+ (Options.alertConfig.scouting?'CHECKED ':'') +'/></td></tr>\
              <TR><TD align=right>Bozkir Alarmi: &nbsp; </td><TD><INPUT id=alertWild type=checkbox '+ (Options.alertConfig.wilds?'CHECKED ':'') +'/></td></tr>\
              <TR><TD align=right>Minimum asker sayisi: &nbsp; </td><TD><INPUT id=alertTroops type=text size=7 value="'+ Options.alertConfig.minTroops +'" \> &nbsp; &nbsp; <span id=alerterr></span></td></tr>\
              </table></td></tr>\
          <TR><TD><INPUT id=togAllRpts type=checkbox /></td><TD>Gelismis Ittifak raporlarini etkinlestir.</td></tr>\
          <TR><TD><INPUT id=togAllowAlter type=checkbox /></td><TD>Diger scriptlerin ittifak raporlarinin bicimini degistirebilmelerine izin ver.</td></tr>\
          <TR><TD><INPUT id=togEnhanceMsging type=checkbox /></td><TD>Gelismis mesajlasmayi etkinlestir ("ilet" ve "tum yoneticiler" dugmesi).</td></tr>\
          <TR><TD colspan=2><BR><BR><B>KofC Oyun hatalarini duzeltme:</b></td></tr>\
          <TR><TD><INPUT id=togTowerFix type=checkbox /></td><TD>Kule raporunda tam hedef gostermeyi duzelt(sehir, bozkir veya gecersiz)</td></tr>\
          <TR><TD><INPUT id=togMapDistFix type=checkbox /></td><TD>Haritada, her zaman ilk sehir yerine secili sehirin mesafesini goster.</td></tr>\
          <TR><TD><INPUT id=togTowerFix2 type=checkbox /></td><TD>Senin yaptigin Bt saldirilarindan dolayi olusan saldiri alarmi hatasini duzelt.</td></tr>\
          </table><BR><BR><HR>Not: Eger isaret kutucuklarindan birisi gri ise bu secenek ile ilgili KOFC kodu degistiginden duzeltme yapilamaz demektir.<br> <br> Lord vayacondios tarafindan Turkcelestirilmistir.';
        t.cont.innerHTML = m;
...
my.Search = {
  ...
  show : function (cont){
    ...
    if (t.state == null){
      this.cont.innerHTML = '\
        <DIV class=ptentry><TABLE><TR valign=bottom><TD class=xtab width=100 align=right>Aranacak: </td><TD>\
        <SELECT id="srcType">\
          <OPTION value=0>Barbar Kampi</option>\
      ...
      m = '<TABLE><TR valign=middle><TD class=xtab width=100 align=right>Konum: &nbsp; X: </td><TD class=xtab>\
        <INPUT id=srchX type=text\> &nbsp; Y: <INPUT id=srchY type=text\> &nbsp; <SPAN id=spInXY></span>\
        </td></tr><TR><TD class=xtab align=right>Max. Mesafe: </td><TD class=xtab><INPUT id=srcDist size=4 value=10 /></td></tr>';
      m += '<TR><TD class=xtab></td><TD class=xtab><INPUT id=srcStart type=submit value="Aramayi Baslat"/></td></tr>';
      m += '</table>';
  ...
  clickedSearch : function (){
    ...
    document.getElementById ('srcStart').value = 'Aramayi Durdut';
    m = '<DIV class=ptstat><TABLE width=100% cellspacing=0><TR><TD class=xtab width=125><DIV id=statSearched></div></td>\
      ...
      <TABLE width=100%><TR><TD><DIV id=divOutTab style="width:380px; height:470px; max-height:470px; overflow-y:auto;"></div></td>\
    ...
    if (t.opt.searchType == 0)
      typeName = 'Barbar kamplari';
    else
      typeName = 'Bozkirlar';

    m = '<CENTER><B>Aranan '+ typeName +'<BR>\
        Konum: '+ t.opt.startX +','+ t.opt.startY +'  &nbsp; Mesafe: '+ t.opt.maxDistance +'<BR></center>\
        <DIV class=ptentry><TABLE cellspacing=0 width=100%><TR align=center><TD class=xtab colspan=10><B>LISTELEME SECENEKLERI:</b><BR></td></tr>\
        <TR><TD class=xtab align=right>Min. seviye:</td><TD class=xtab> <INPUT id=filMinLvl size=2 value='+ Options.srcMinLevel +' /></td></tr>\
        <TR><TD class=xtab align=right>Max. seviye:</td><TD class=xtab> <INPUT id=filMaxLvl size=2 value='+ Options.srcMaxLevel +' /></td></tr>';
    if (t.opt.searchType == 1){
      m += '<TR><TD class=xtab align=right>Bozkir Tipi:</td><TD class=xtab><SELECT id=filWildType>';
      m += htmlOptions ( {1:'Cayir/Gol', 3:'Orman', 4:'Tepe', 5:'Dag', 6:'Ova', 0:'Hepsi'}, Options.wildType );
      m += '</select></td></tr><TR><TD class=xtab align=right>Sadece sahipsizler:</td><TD class=xtab><INPUT id=filUnowned type=CHECKBOX '+ (Options.unownedOnly?' CHECKED':'') +'\><td></tr>';
    }
    m+= '<TR><TD class=xtab align=right>Siralama:</td><TD class=xtab><SELECT id=filSortBy>\
        ...
        <TR><TD class=xtab align=right>Sadece koordinatlari goster:</td><TD class=xtab><INPUT type=checkbox id=coordsOnly \></td></tr>\
    ...
    document.getElementById ('statStatus').innerHTML = ' at '+ xxx +','+ yyy;
if (DEBUG_TRACE) logit (" 0 clickedSearch()... setTimeout ..:" + xxx +' , '+ yyy +' , '+ t.mapCallback.name);
  ...
  dispMapTable : function (){
    var tileNames = ['Barbar Kampi', 'Cayir', 'Gol', 'Orman', 'Tepe', 'Dag', 'Ova' ];
    var t = my.Search;
...
if (DEBUG_TRACE) DebugTimer.display('SEACHdraw: FILTER');
    ...
    if (dat.length == 0){
      m = '<BR><CENTER>Bulunamadi</center>';
    } else {
      dat.sort(mySort);
if (DEBUG_TRACE) DebugTimer.display('SEACHdraw: SORT');
      if (coordsOnly)
        m = '<TABLE align=center id=srcOutTab cellpadding=0 cellspacing=0><TR style="font-weight: bold"><TD>Yer</td></tr>';
      else
        m = '<TABLE id=srcOutTab cellpadding=0 cellspacing=0><TR style="font-weight: bold"><TD>Yer</td><TD style="padding-left: 10px">Mesafe</td><TD style="padding-left: 10px;">Seviye</td><TD width=80%> &nbsp; Tip</td><TD style="padding-left: 10px;"></td></tr>';
...
if (DEBUG_TRACE) logit (" 3 mapCallback()");
    ...
    document.getElementById ('statStatus').innerHTML = ' at '+ x +','+ y;
  ...
  show : function (){
    ...
    if (t.state == null){
      s = "<DIV id=trainTopSelect>\
        <DIV class=ptstat>Asker egit ve Sur savunmasi insa et</div><DIV style='height:10px'></div><DIV class=ptentry>\
        ...
        <TR><TD align=right># baraka basi: </td><TD><INPUT id='ptttInpPS' size=5 type='text' value='0'\></td>\
          <TD><INPUT id='ptttButMaxPS' type=submit value='max'\> &nbsp; (max <span id=ptttSpMaxPS>0</span>)</td></tr>\
        <TR><TD align=right># baraka: </td><TD><INPUT id='ptttInpSlots' size=2 type='text' value='1'\></td>\
          <TD width=75%><INPUT id='ptttButMaxSlots' type=submit value='max'\> &nbsp; (max <span id=ptttSpMaxSlots>1</span>)</td></tr>\
        <TR><TD align=right valign=top>Iscileri bosa cikar: </td><TD colspan=2><INPUT type=CHECKBOX id=chkPop"+ (Options.maxIdlePop?' CHECKED ':'') +"> \
          <SPAN style='white-space:normal;'>Daha fazla asker uretmenizi saglar.Gecici olarak nufusu eksiye dusurur</span></td></tr>\
        <TR><TD colspan=3 align=center><DIV style='height:10px'></div><INPUT id='ptttButDo' type=submit value='Asker Egit'\></td></tr>\
        </table></td><TD width=20></td><TD style='border-left:solid 2px;' width=50% align=center>\
        <TABLE align=center><TR><TD align=right>Savunma Tipi: </td><TD colspan=2>\
        <SELECT id=pttdType>\
          <option value='53'>Tatar Yayi</option>\
          <option value='55'>Mancinik</option>\
          <option value='60'>Tuzak</option>\
          <option value='61'>Bitirak</option>\
          <option value='62'>Civili Bariyer</option>\
        </select> &nbsp; (<span id=pttdSpMax></span>)</td></tr>\
        <TR><TD align=right># slot basina: </td><TD><INPUT id='pttdInpPS' size=5 type='text' value='0'\></td>\
          <TD><INPUT id='pttdButMaxPS' type=submit value='max'\> &nbsp; (max <span id=pttdSpMaxPS>0</span>)</td></tr>\
        <TR><TD align=right># slot: </td><TD><INPUT id='pttdInpSlots' size=2 type='text' value='1'\></td>\
        ...
        <TR><TD colspan=3 align=center><DIV style='height:10px'></div><INPUT id='pttdButDo' type=submit value='Savunma insa et'\></td></tr></table>\
        </td></tr></table></div></div>\
        ...
        <TR><TD width=50% style='padding-left:15px; padding-right:15px'><DIV style='text-align:center'><B>Asker uretim&nbsp; (<SPAN id=statTTtot></span>)</b><BR><HR></div><DIV id=divSTleft style='overflow-y: auto; height:210px; max-height:210px'></div></td>\
          <TD width=50% style='padding-left:15px; padding-right:15px'><DIV style='text-align:center'><B>Savunma Uretim &nbsp; (<SPAN id=statDTtot></span>)</b><BR><HR></div><DIV id=divSTright style='overflow-y: auto; height:210px; max-height:210px'></div></td></tr>\
        </div>";
      t.cont.innerHTML = s;
...
/*******  TROOPS  ******/  
  ...
  clickTroopDo : function (){
    ...
    t.displayCityStats ();
    if (perSlot<1){
      t.divTrainStatus.innerHTML = '<FONT COLOR=#550000>Her slottaki asker sayisi 0 dan buyuk olmali.</font>';
      return;
    }
    if (perSlot*numSlots > t.stats.MaxTrain){
      t.divTrainStatus.innerHTML = '<FONT COLOR=#550000>Bu kadar uretim yapilamaz (en fazla'+ t.stats.MaxTrain +' uretebilirsin)</font>';
      return;
    }
    if (numSlots<1 || numSlots>t.stats.barracks - t.stats.queued){
      t.divTrainStatus.innerHTML = '<FONT COLOR=#550000>Hatali baraka sayisi.</font>';
      return;
    }
    t.setBusy(true);
    var que = [];
...
/*******  DEF  ******/  
  ...
  updateTopDef : function (){
    ...
    if (isNaN(slots) || slots<0)
      slots = 0;
    t.TDspMax.innerHTML = 'max:'+ t.stats.MaxDefTrain +'&nbsp; mevcut:'+ t.stats.defOwned;   
    ...
    t.TDspSpace.innerHTML = 'Sur Seviyesi: <B>'+ t.stats.wallLevel +'</b><BR>Sur Kapasite: '+ (t.stats.wallSpaceUsed+t.stats.wallSpaceQueued)  +'/<B>'+ t.stats.wallSpace +'</b><BR>\
        Alan kapasite: '+ (t.stats.fieldSpaceUsed+t.stats.fieldSpaceQueued) +'/<B>'+ t.stats.fieldSpace +'</b>';
  },
  ...
  clickDefDo : function (){
    ...
    t.displayCityStats ();
    if (perSlot<1){
      t.divTrainStatus.innerHTML = '<FONT COLOR=#550000>Her slottaki unite sayisi 0 dan buyuk olmali.</font>';
      return;
    }
    if (perSlot*numSlots > t.stats.MaxDefTrain){
      t.divTrainStatus.innerHTML = '<FONT COLOR=#550000>Bu kadar uretim yapilamaz (en fazla '+ t.stats.MaxDefTrain +' uretebilirsin)</font>';
      return;
    }
  ...
  doDefQueue : function (cityId, que, errMsg){
    ...
    try {
      ...
      var cmd = que.shift();
      if (!cmd){
        t.dispTrainStatus ('<B>Siraya alinan savunma birimleri.</b><BR>');
        t.setBusy(false);
        return;
      }
      if (cmd[0] == 'T'){
        t.dispTrainStatus (cmd[2] +' '+  fortNamesShort[cmd[1]] +'Egitimi'+'<BR>');
        doDefTrain (cityId, cmd[1], cmd[2], function(errMsg){my.Train.doDefQueue(cityId, que, errMsg);} );
      }
    } catch (err) {
      logit (inspect (err, 8, 1));
      t.dispTrainStatus ('<font color=#550000>PROGRAM HATASI: '+ err.message +'</font><BR>');
      t.setBusy(false);
    }
  },
  ...
  displayCityStats : function (){
    ...
    m += '<TABLE class=ptTab width=100%><TR align=center>\
        ...
        <TD width=16%><B>Cevher:</b></td><TD width=16%><B>Altin:</b></td><TD width=16%><B>Kullanilabilir Nufus:</b></td></tr>\
...
// defense queue ....
  ...
  doQueue : function (cityId, que, errMsg){
    ...
    try {
      ...
      var cmd = que.shift();
      if (!cmd){
        t.dispTrainStatus ('<B>Siraya alinan asker birimleri.</b><BR>');
        t.setBusy(false);
        return;
      }
      if (cmd[0] == 'T'){
        t.dispTrainStatus (cmd[2] +' '+  unsafeWindow.unitcost['unt'+cmd[1]][0] +' Egitimi'+'<BR>');
...
//DebugTimer.start(); 
    try {
      ...
      str = '<DIV class=ptstat style="margin-top:5px; margin-bottom:5px;"><TABLE cellspacing=0 cellpadding=0 class=ptTab width=97% align=center>\
        <TR align=left><TD><SPAN class=ptStatLight>Oyuna Baslama:</span> '+ dt.toLocaleDateString() +'</td>\
        <TD><SPAN class=ptStatLight>Kudret:</span> ' + addCommas(Seed.player.might) +'</td>\
        <TD><SPAN class=ptStatLight>Ittifak:</span> ' + getMyAlliance()[1] +'</td>\
        <TD align=right><SPAN class=ptStatLight>Server:</span> ' + unsafeWindow.domainName +'</td></tr></table></div>';
      ...
      for(i=0; i<Cities.numCities; i++) {
        str += "<TD width=81><B>"+ Cities.cities[i].name.substring(0,10) +'</b><BR>('+
            Cities.cities[i].x +','+ Cities.cities[i].y  +")</td>";
      }
      if (Options.includeMarching)
        str += '<TD width=81><B>Yuruyuste</b></td>';
      str += "</tr>";
      ...
      str += _row ('Agir', rows[8]);
      str += _row ('Malz Arb.', rows[9]);
      str += _row ('Balista', rows[10]);
      str += _row ('Kocbasi', rows[11]);
      str += _row ('Katapult', rows[12]);
      str += '<TR><TD><BR></td></tr>';
      ...
      str += _row ('Uretimdeki Asker', row, true);
      ...
      str += _row ('Sur savunmasi', row, true);
      str += '<TR><TD class=xtab></td><TD class=xtab colspan=4><BR><INPUT type=CHECKBOX id=idCheck'+ (Options.includeMarching?' CHECKED':'') +'>Yuruyusteki askerleri/Destegi goster</td></tr>';
      str += "</table>";
      if (DEBUG_BUTTON)
...
my.Encamped = {
  ...
  show : function (cont){
    var rownum = 0;
    var names = ['Ikmal', 'Milis', 'Bt', 'Mizr', 'Silhsr', 'Okcu', 'Suvari', 'Agir', 'M.Arb', 'Bal', 'Koc B.', 'Kat'];
    var t = my.Encamped;
    ...
    s = '<div class=ptstat>Buyukelciliklerinde kamp kurmus tum destek askerleri</div><BR>';
    if (numSlots == 0){
      s += '<BR><CENTER><B>Destek askeri yok.</b></center>';
    } else {
    ...
    s += '<BR><BR><DIV style="font-size: 10px">NOT: Yeni Destek askerlerini veya bir saldiridan sonra kalan destek askerlerini gorebilmek icin oyunu yenilemelisin.</div>';
    t.cont.innerHTML = s;
    checkBox = document.getElementById('idCheck2');
...
function DialogRetry (errMsg, seconds, onRetry, onCancel){
  ...
  if (!rdiv){
    ...
    rdiv.innerHTML = '<DIV style="background: #cccccc"><CENTER>KOC Power Tools</div>\
      <CENTER><BR><FONT COLOR=#550000><B>Bir Hata ile karsilasti:</b></font><BR><BR><DIV id=retryErrMsg></div>\
      <BR><BR><B> <SPAN id=retrySeconds></b></span> saniye icinde tekrarlanacak ...<BR><BR><INPUT id=retryCancel type=submit value="CANCEL Retry" \>';
