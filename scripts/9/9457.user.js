// ==UserScript==
// @name            Direkter Link auf den Katalog von Buecherhallen.de
// @description     Durch diese Erweiterung wird auf Buecherhallen.de der Link auf den Katalog geaendert, so dass mit einem Klick eine Suchmaske fuer differenzierte Suchabfragen erreichbar ist.
// @namespace       Platypus
// @include         http://www.buecherhallen.de/
// ==/UserScript==
function do_platypus_script() {
do_modify_url_it(window.document,document.evaluate('/HTML[1]/BODY[1]/DIV[1]/DIV[1]/DIV[2]/DIV[1]/DIV[3]/UL[1]/LI[1]/P[1]/A[1]', document, null, XPathResult.FIRST_ORDERED_NODE_TYPE,null).singleNodeValue,/http:\/\/www\.buecherhallen\.de\/katalog_konto/gi,'https://www.buecherhallen.de/alswww2.dll/APS_ADVANCED_SEARCH?Style=Portal2&SubStyle=&Theme=&Lang=GER&ResponseEncoding=utf-8&Parent=Obj_122051180598851?Style=Portal2&SubStyle=&Theme=&Lang=GER&ResponseEncoding=utf-8&BrowseAsHloc=-2&SubStyle=Advanced',false);
