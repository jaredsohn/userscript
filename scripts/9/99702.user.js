// ==UserScript==
// @name             KOC Power Il Padrino
// @version          0.0.04
// @namespace        KOC Power Il Padrino
// @homepage         http://userscripts.org/scripts/show/99702
...
var Version = '17/04/2011 v.0.0.4';
...
*) Modificati i colori chat
*) Aggiunte Addestramento e Spostamento e tolto Crests

TODO: New Marches tab ; Alliance Map ; Ostile Map
...
//logit ( 'Options.ptWinPos: '+ inspect (Options.ptWinPos, 5, 1)); 
  ...
  AddMainTabLink('Il Padrino 4Ever', eventHideShow, mouseMainTab);
TestSomething.init ();  
...
Tabs.Mappa = {
  ...
  myDiv : null,
  timer : null,
  forumlink :  'http://koc.dunno.com/index.sjs?f=KocMapViewer&server_id=93',  
...
//DebugTimer.start(); 
    try {
	  ...
	  for(i=0; i<Cities.numCities; i++){
		...
		if(Gate == 0)
			str += '<TD style=\'background: #000000\'><SPAN class=boldRed>Hidden</span></td>';
		else
			str += '<TD style=\'background: #000000\' ><SPAN class=boldRed><blink>Defense</blink></span></td>';
	  }
      ...
      rownum = 0;
	  str += '<TR><TD class=ptstat>Troop</td></tr><BR>';
      ...
      str += _row ('Catapult', rows[12]);
      	  if (Options.includeTraining) {
		str += '<TR><TD class=ptstat>Training</td></tr><BR>';
        str += _row ('<i><span style="color:green">SupTrp</span></i>', t_rows[2]);
        str += _row ('<i><span style="color:green">Militia</span></i>', t_rows[4]);
        str += _row ('<i><span style="color:green">Scout</span></i>', t_rows[6]);
        str += _row ('<i><span style="color:green">Pike</span></i>', t_rows[8]);
        str += _row ('<i><span style="color:green">Sword</span></i>', t_rows[10]);
        str += _row ('<i><span style="color:green">Archer</span></i>', t_rows[12]);
        str += _row ('<i><span style="color:green">Cav</span></i>', t_rows[14]);
        str += _row ('<i><span style="color:green">H-Cav</span></i>', t_rows[16]);
        str += _row ('<i><span style="color:green">Wagon</span></i>', t_rows[18]);
        str += _row ('<i><span style="color:green">Ballista</span></i>', t_rows[20]);
        str += _row ('<i><span style="color:green">Ram</span></i>', t_rows[22]);
        str += _row ('<i><span style="color:green">Catapult</span></i>', t_rows[24]);
      }
      ...
      str += '<TR><TD class=ptstat>Info</td></tr><BR>';
      ...
      str += '<TR><TD class=xtab></td><TD class=xtab colspan=4><BR><INPUT type=CHECKBOX id=idCheck'+ (Options.includeMarching?' CHECKED':'') +'>Marching troops / resources ads</td></tr>';
      str += '<TR><TD class=xtab></td><TD class=xtab colspan=4><INPUT type=CHECKBOX id=ptoverIncTraining'+ (Options.includeTraining?' CHECKED':'') +'>Trainees troops show / aggregation</td></tr>';
      str += '<TR><TD class=xtab></td><TD class=xtab colspan=4><INPUT type=CHECKBOX id=ptOverOver'+ (Options.overviewAllowOverflow?' CHECKED':'') +'>Overflow allow \
         &nbsp; &nbsp; | Fontsize: '+ htmlSelector ({9:9, 10:10, 11:11, 12:12 , 14:14}, Options.overviewFontSize, 'id=ptoverfont') +'</td></tr>';
      str += "</table></div>";
...
var Version = '06/04/2011 v.0.0.3';
