// ==UserScript==
// @name           BBCodes para Taringa by yasserock (beta)
...
// @version        31.0
// @copyright      Copyright (c) 2011, yasserock
...
// ==Variables==
var ultversion = '31.0';
var postscript = 'http://www.taringa.net/posts/taringa/8085358/Script-BBCoder-para-Taringa_.html';
...
var CategoriasT = new Array(-1,"","Ver Todas",7,"animaciones","Animaciones",18,"apuntes-y-monografias","Apuntes y Monografías",4,"arte","Arte",
	...
	31,"turismo","Turismo",13,"tv-peliculas-series","TV, Películas y Series",3,"videos","Videos On-line")
        38,"juegos-online","Juegos on-line",36,"paranormal","Paranormal",37,"Reviews","Reviews");
					...
					data: 'titulo=Preview&cuerpo='+encodeURIComponent(txt.value),
 					success: function(h){
						...
						if(path == 'mensajes'){
							...
							HTML += '<div class="answerTxt"><div class="answerContainer"><div class="Container" style="padding:0; width:640px !important;"><div class="answerOptions"><div class="floatL metaDataA"><img src="'+URL+'cerrar.gif" alt="[X]" title="Cerrar Previsualización" border="0" onclick="($(\'#return_agregar_comentario\').slideUp(1000))" align="absmiddle" style="margin-right:5px" onmouseover="this.style.cursor=\'pointer\'" />Previsualización - Sharkale®</div></div><div style="margin: 10px !important; width:640px !important;" class="cuerpo_comm">'+respuesta+'</div></div></div></div></div>';
						}
 						$('#return_agregar_comentario').slideUp(1000, function(){
...
function Sharkale_Opciones(){
	...
	nuevaHTML += '    <div class="ui-state-error ui-corner-all" style="padding: 0pt 0.7em;"><p><span class="ui-icon ui-icon-alert" style="float: left; margin-right: 0.3em;"></span><strong>Alerta:</strong> Si sos moderador te agradesco uses el script, es un orgullo te sea útil. Y si estas buscando como contactarme para criticar algo del script te podes ir bien a la casilla de mensajes y escribirme. =D</p></div><br/>';
	...
	$('#Btn_Reportar_Bug').click(function() {GM_openInTab('http://www.taringa.net/comunidades/scriptsbbcoders/')});
	$('#Btn_Reportar_Sugerencia').click(function() {GM_openInTab('http://www.taringa.net/comunidades/scriptsbbcoders/')});
...
//----Opciones----//
	...
	menu += '	<a href="http://www.taringa.net/comunidades/scriptsbbcoders/" title="Entrar a La Comu del Script®" style="">Script <img alt="Drop Down" src="http://i.t.net.ar/images/arrowdown.png"></a>';
	menu += '</li>';
