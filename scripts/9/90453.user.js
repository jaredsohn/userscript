...
ar: { units: "Unidades", slinger: "Hondero", swordsman: "Espadachín", phalanx: "Hoplita", archer: "Arquero", marksman: "Fusilero", gyrocopter: "Girocóptero", "steam giant": "Gigante a vapor", bombardier: "Bombardero", ram: "Ariete", catapult: "Catapulta", mortar: "Mortero", doctor: "Médico", cook: "Cocinero", spearmen: "Lancero", barbarian: "Barbaro" },
...
co: { units: "Unidades", slinger: "Hondero", swordsman: "Espadachín", phalanx: "Hoplita", archer: "Arquero", marksman: "Fusilero", gyrocopter: "Girocóptero", "steam giant": "Gigante a vapor", bombardier: "Bombardero", ram: "Ariete", catapult: "Catapulta", mortar: "Mortero", doctor: "Médico", cook: "Cocinero", spearmen: "Lancero", barbarian: "Barbaro" },
...
es: { units: "Unidades", slinger: "Hondero", swordsman: "Espadachín", phalanx: "Hoplita", archer: "Arquero", marksman: "Fusilero", gyrocopter: "Girocóptero", "steam giant": "Gigante a vapor", bombardier: "Bombardero", ram: "Ariete", catapult: "Catapulta", mortar: "Mortero", doctor: "Médico", cook: "Cocinero", spearmen: "Lancero", barbarian: "Agitador de Hacha de los Bárbaros" },
...
pe: { units: "Unidades", slinger: "Hondero", swordsman: "Espadachín", phalanx: "Hoplita", archer: "Arquero", marksman: "Fusilero", gyrocopter: "Girocóptero", "steam giant": "Gigante a vapor", bombardier: "Bombardero", ram: "Ariete", catapult: "Catapulta", mortar: "Mortero", doctor: "Médico", cook: "Cocinero", spearmen: "Lancero", barbarian: "Bárbaro" },
...
ve: { units: "Unidades", slinger: "Hondero", swordsman: "Espadachín", phalanx: "Hoplita", archer: "Arquero", marksman: "Fusilero", gyrocopter: "Girocóptero", "steam giant": "Gigante a vapor", bombardier: "Bombardero", ram: "Ariete", catapult: "Catapulta", mortar: "Mortero", doctor: "Médico", cook: "Cocinero", spearmen: "Lancero", barbarian: "Agitador de Hacha de los Bárbaros" },
...
const U_MAP = {
        name: { phalanx: "army s303", slinger: "army s301", swordsman: "army s302", archer: "army s313", marksman: "army s304", gyrocopter: "army s312", "steam giant": "army s308", bombardier: "army s309", ram: "army s307", catapult: "army s306", mortar: "army s305", doctor: "army s311", cook: "army s310", spearmen:"army s315", barbarian: "army s316"},
        clas: { "army s303": "phalanx","army s301": "slinger", "army s302": "swordsman",  "army s313": "archer", "army s304": "marksman", "army s312": "gyrocopter", "army s308": "steam giant", "army s309": "bombardier", "army s307": "ram", "army s306": "catapult", "army s305": "mortar", "army s311": "doctor", "army s310": "cook", "army s315": "spearmen", "army s316": "barbarian" }
};
const S_MAP = {
...
var adress = new Array('0','107','108','109','110','111','112','113','121','134','152','195','216','234','260');
var adress2 = adress[world];
window.open('http://board.ikariam.es/index.php?form=ThreadAdd&boardID='+ adress2);
...
if(bf_size4==25) { var bf_size=3; }
if(bf_size4==18) { var bf_size=2; }
if(bf_size4==11) { var bf_size=1; }
...
if(deffenders.length>1) {results += 'es'; }
        ...
        report += '<br/>[b][i]Compactado con: [url=http://board.ikariam.es/index.php?page=Thread&threadID=129508]Combat Report Auto-Converter[/url] v2.2.6 © by [url=http://board.ikariam.es/index.php?page=User&userID=47984]WTF[/url][/i][/b]';
...
if(GM_getValue('forumclass')=='plain') {
        ...
        final_text = final_text.replace('[img]http://'+server+'/skin/resources/icon_sulfur.gif[/img]','Azufre:');
        final_text = final_text.replace('[img]http://'+server+'/skin/resources/icon_citizen.gif[/img]','Burgueses:');
        final_text = final_text.replace('[b][i]Compactado con: [url=http://board.ikariam.es/index.php?page=Thread&threadID=129508]Combat Report Auto-Converter[/url] v1.1 © by [url=http://board.ikariam.es/index.php?page=User&userID=47984]WTF[/url][/i][/b]','Compactado con: Combat Report Auto-Converter v1.1 © by WTF');
...
var new_mainview =  '<div class="footer"></div></div><div class="contentBox01h"><h3 class="header"><a href="http://board.ikariam.es/index.php?page=Thread&threadID=129508" target="_blank">Combat Report Auto-Converter</a> v2.2.6 © by <a href="http://board.ikariam.es/index.php?page=User&userID=47984" target="_blank">WTF</a></b></h3><div class="content"><table style="border:none;"><tr><td style="border:none; height:8px;"></td></tr><tr><td style="vertical-align:middle; text-align:center; border:none;">Doble click sobre la parte que quieras y ya estará copiada en tu portapapeles! (luego pegala con CTRL+V)';
...
new_mainview += '</td></tr><tr style="border:none;"><td style="border:none;"><table style="border:none;"><tr style="border:none;"><td style="width:20px; border:none;"></td><td style="vertical-align:middle; border:none;"><object classid="clsid:D27CDB6E-AE6D-11cf-96B8-444553540000" width="121" height="27" id="copysubject">  <param name="movie" value="http://www.worldofhouse.es/images/copy/copysubject.swf?textocopy=' + final_subject + '"><param name="quality" value="high"><param name="wmode" value="transparent"><param name="swfversion" value="6.0.65.0"><!-- La siguiente etiqueta object es para navegadores distintos de IE. Ocúltela a IE mediante IECC. --><!--[if !IE]>--><object type="application/x-shockwave-flash" data="http://www.worldofhouse.es/images/copy/copysubject.swf?textocopy=' + final_subject + '" width="121" height="27"><!--<![endif]--><param name="quality" value="high"><param name="wmode" value="transparent"><!--[if !IE]>--></object><!--<![endif]--></object></td><td style="width:20px; border:none;"></td><td style="vertical-align:middle; border:none;" id="copytext_td"><object classid="clsid:D27CDB6E-AE6D-11cf-96B8-444553540000" width="205" height="27" id="copytext">  <param name="movie" value="http://www.worldofhouse.es/images/copy/copytext.swf?textocopy=' + final_text + '"><param name="quality" value="high"><param name="wmode" value="transparent"><param name="swfversion" value="6.0.65.0"><!-- La siguiente etiqueta object es para navegadores distintos de IE. Ocúltela a IE mediante IECC. --><!--[if !IE]>--><object type="application/x-shockwave-flash" data="http://www.worldofhouse.es/images/copy/copytext.swf?textocopy=' + final_text + '" width="205" height="27"><!--<![endif]--><param name="quality" value="high"><param name="wmode" value="transparent"><!--[if !IE]>--></object><!--<![endif]--></object></td><td style="width:20px; border:none;"></td><td style="vertical-align:middle; border:none;">';
