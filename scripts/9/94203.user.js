...
document.body.appendChild(create("span", {textContent:(35+Math.round(Math.random()*5)),id:"sec",style:("background:url(\"http://i015.radikal.ru/1101/5b/0dc3866677e2.jpg\"); color:#ddd; border:8px ridge #000; padding:5em; position:absolute; top:"+window.innerHeight/3+"px; left:"+window.innerWidth/2+"px; text-align:center;")}));
