// ==UserScript==
// @name           reggaetoneros en t comunidad official
// @namespace      reggaetoneros
// @description    Script para la comunidad reggaetoneros en t comunidad official
// @include        *taringa.net/*
// @exclude        *http://www.taringa.net/comunidades/me-gusta-el-reggaeton/*
// ==/UserScript==
...
byClass('menuTabs').innerHTML += "<li id=\"tabbedWTF\" class=\"tabbed\">\n <a href=\"http://www.taringa.net/comunidades/me-gusta-el-reggaeton/\" onclick=\"menu(\'reggaetonero taringa! \', this.href);return false;\" title=\"Ir a la comunidad Reggaetonero en T!\">Reggaetoneros! <img src=\n\"\" alt=\"\" /></a>\n</li>";
