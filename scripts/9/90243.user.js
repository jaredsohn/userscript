...
function check(xhr) {
	...
	var ini2=xhr.indexOf('"',ini1);
	var status=xhr.substring(ini1,ini2);
	if(GM_getValue(host+".advMilitary") && GM_getValue(host+".military")!=1 && status == "normalalert"){
		//Acciones
