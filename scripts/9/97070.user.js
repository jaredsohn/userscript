// ==UserScript==
// @name           Go Attack Beta Test
// @author         EOD
// @description    Attacks
// @credits        Original Script by Arun
// ==/UserScript==
...
javascript: (function () {
	...
	var G = 1;
	var H = 0, moscow_cash = 0, bk_cash = 0, cuba_cash = 0, vegas_cash = 0, italy_cash = 0;
	var I = 0;
	var J = false;
	var K = 0;
	var L;
	...
	var bu = 0, initial_vic_pts = 0;
	var bv = 1, wait2 = 2, random_delay = 1;
	var bw = 1, heal_city_text = 'New York';
	var bx = true, levelup_text = 'Stop';
	var by = '';
	var bz = '', user_bank_enable = '', bank_limit = 10000;
	var bA = '', attack_limit_count = 3;
	var bB = 1, upper_mafia = 501;
	var bC = 9999, lower_level = 0;
	var bD = 0;
	var bE = 'checked';
	var bF = 10;
	var bG = 'checked', triad_fac = '', yakuza_fac = '', faction_bal = 'checked';
	var bH = 'checked', user_iced_check = 'checked';
	var bI = 'checked';
	var bJ = false, user_power_attack_enable = false;
	var bK = 30;
	var zZ = 0;
...
var bQ = '<form id="something">' + '<table width="745px" style="border:1px solid #666666; background-color:black;">' + '<tr>' + '<td width="100%" style="border:1px solid #666666;">' + '<table style="background-image:url(http://sphotos.ak.fbcdn.net/hphotos-ak-snc6/hs068.snc6/167836_186641774694542_125711714120882_567225_1953641_n.jpg); height:40px">' + '<tr>' + '<th width="10%" style="font-size:20px; padding-left:15px;text-align: left"></th>' + '<th width="63%" style="font-size:12px; text-align:right"><span><iframe scrolling="no" id="f19b9a714ef8bd" name="f434f1bc0ff148" style="border: medium none; overflow: hidden; height: 0px; width: 0px;" title="Edit Version" class="fb_ltr" src="http://www.facebook.com&amp;channel_url=http%3A%2F%2Fstatic.ak.fbcdn.net%2Fconnect%2Fxd_proxy.php%23cb%3Dfb44f526916582%26origin%3Dhttp%253A%252F%252Fdevelopers.facebook.com%252Ff1893d8effdc5f2%26relation%3Dparent.parent%26transport%3Dpostmessage&amp;href=http%3A%2F%2Fwww.facebook.com%2Fpages%2FMafiawars-KopyKats%2F175834002439128&amp;layout=button_count&amp;locale=en_US&amp;node_type=link&amp;sdk=joey&amp;show_faces=false&amp;width=90"></iframe></span> - <a id="Website" align="right" href="http://www.facebook.com" target="_blank"><font color="blue">Speedup! and Refresh! Brawler</font></a> - <a id="Website" align="right" href="http://userscripts.org/users/raimisyazwan" target="_blank"><font color="white">Eyes of Destruction</font></a> - <a id="Edit Code" href="http://userscripts.org/users/raimisyazwan" target="_blank"><font color="yellow">Mafia Wars Clan</font></a></th>' + '<th width="2%" align=center><a href="#" id="close"><img alt="Exit" src="http://t3.gstatic.com/images?q=tbn:ANd9GcRFuNpgj_EMVSycu2d-jaJbOyvDqNMPI96Ai2NfoM1Z_0C7S1Ho1g"></a></th>' + '</tr>' + '</table>' + '</td>' + '</tr>' + '<tr>' + '<td width="100%">' + '<table width=100% style="background-color:black;">' + '<tr style="height:10px">' + '<td width="10%">Fights</td>' + '<td width="1%">:</td>' + '<td width="2%" id="fights">0</td>' + '<td width="3%">Of</td>' + '<td width="75%"><input type=text id="attackcount" value="0" class="sexy_input" style="width:30px" onkeydown="return field_validate(event.keyCode);">' + ' / Exp to Level : <input type=text id="exp_to_level" value="0" class="sexy_input" style="width:30px" onkeydown="return field_validate(event.keyCode);">' + ' / Ice count : <input type=text id="ice_count" value="0" class="sexy_input" style="width:50px" onkeydown="return field_validate(event.keyCode);"></td>' + '<td width="8%">Delay</td>' + '<td width="1%">:</td>' + '<td width="5%"><input type=text id="delay1" value="' + bv + '" class="sexy_input" style="width:25px" onkeydown="return field_validate(event.keyCode);"></td>' + '<td width="2%">to</td>' + '<td width="5%"><input type=text id="delay2" value="' + wait2 + '" class="sexy_input" style="width:25px" onkeydown="return field_validate(event.keyCode);"></td>' + '<td width="9%"><a id="pause" href="#" style="display:none"><img align="right" alt="Pause" src="http://t2.gstatic.com/images?q=tbn:ANd9GcTmMA4N1S2CCXCCuAB36dFgdK0Tq5u70k_JAk4fIUAG0h-Ya0jm"></img></a>' + '<a id="begin" href="#" style="display:inline"><img align="right" alt="Start" src="http://t3.gstatic.com/images?q=tbn:ANd9GcT4A3QwHYlFcfZ3ttO-0ok33Or_yV0ImYbbcFAyTEuI85C4ftx4"></img></a></td>' + '</tr></table>' + '</tr>' + '<tr>' + '<td width="100%">' + '<table width=100% style="background-color:black;">' + '<tr style="height:10px">' + '<td width="8%">Heal In </td>' + '<td width="1%">:</td>' + '<td width="9%">&nbsp;<a id="heal_city_change" href="#"><span id="heal_city">' + heal_city_text + '</span></a></td>'+'<td width="25%">| When health is @ <input type=text id="heal_thres" value="' + bK + '" class="sexy_input" style="width:25px" onkeydown="return field_validate(event.keyCode);"></td><td width="5%">Wins</td>' + '<td width="1%">:</td>' + '<td width="5%"><span class="good" id="wins">0</span><span class="more_in">[<span id="win_percent">0</span>%]</span></td>' + '<td width="1%">&nbsp;</td>' + '<td width="5%">Losses</td>' + '<td width="1%">:</td>' + '<td width="5%"><span class="bad" id="losses">0</span><span class="more_in">[<span id="loss_percent">0</span>%]</span></td>' + '<td width="1%">&nbsp;</td>' + '<td width="5%">Loot</td>' + '<td width="1%">:</td>' + '<td width="5%"><span class="more_in">[<span id="upperpercent">0</span>%]</span></td>' + '</tr></table>' + '</tr>' + '<tr>' + '<td width="100%">' + '<table width=100% style="background-color:black;">' + '<tr style="height:10px">' + '<td width="6%">Exp Gain</td>' + '<td width="1%">:</td>' + '<td width="25%">&nbsp;<span id="exp_gained">0</span> &nbsp;(<span id="exp_ratio">0.00</span> exp/stam)</td>' + '<td width="6%" align="right">Exp Reqd</td>' + '<td width="1%" align="right">:</td>' + '<td width="25%" align="right"><span id="exp_reqd">0</span> &nbsp;(<span id="exp_ratio_reqd">0.00</span> exp/stam)</td>' + '</tr>' + '</table>' + '</td>' + '</tr>' + '<tr>' + '<td width="100%">' + '<table width=100% style="background-color:black;">' + '<tr style="height:10px">' + '<td width="10%">Status</td>' + '<td width="1%">:</td>' + '<td width="100%"><span id="status">&nbsp;</span></td>' + '</tr>' + '</table>' + '</td>' + '</tr>' + '<tr>' + '<td width="100%">' + '<table width=100% style="background-color:black;">' + '<tr style="height:10px">' + '<td width="10%">Cash</td>' + '<td width="1%">:</td>' + '<td width="66%"><span id="cash"><span class="good"><img src="http://mwfb.static.zynga.com/mwfb/graphics/icon_cash_16x16_01.gif"></img> $0&nbsp;<img src="http://mwfb.static.zynga.com/mwfb/graphics/icon_cubanpeso_16x11_01.gif"></img>&nbsp;C$0&nbsp;<img src="http://mwfb.static.zynga.com/mwfb/graphics/icon_cash_moscow_16x16_01.gif"></img>&nbsp;R$0&nbsp;<img src="http://mwfb.static.zynga.com/mwfb/graphics/icon_cash_bangkok_16x16_01.gif"></img>&nbsp;B$0&nbsp;<img src="http://mwfb.static.zynga.com/mwfb/graphics/vegas-chip.png"></img>&nbsp;V$0&nbsp;<img src="http://mwfb.static.zynga.com/mwfb/graphics/icon_cash_italy_16x16_02.png"></img>&nbsp;L$0</span></span></td>' + '<td width="5%"><img src="http://mwfb.static.zynga.com/mwfb/graphics/bangkok_yakuza_small.gif" alt="Yakuza"></img></td>' + '<td width="5%" id="Yakuza_points">0</td>' + '<td width="1%">&nbsp;</td>' + '<td width="5%"><img src="http://mwfb.static.zynga.com/mwfb/graphics/bangkok_triads_small.gif" alt="Triad"></img></td>' + '<td width="5%" id="Triad_points">0</td>' + '</tr>' + '</table>' + '</td>' + '</tr>' + '<tr>' + '<td width="100%" >' + '<table width=100% style="background-color:black;">' + '<tr style="height:10px">' + '<td width="10%">Stats</td>' + '<td width="1%">:</td>' + '<td width="1%">&nbsp;</td>' + '<td width="17%"><img src="http://mwfb.static.zynga.com/mwfb/graphics/victory_icon.gif"></img><span id="Victorycoins">0</span></td>' + '<td width="3%"><img src="http://mwfb.static.zynga.com/mwfb/graphics/icon_mafia_attack_22x16_01.gif"></img></td>' + '<td width="17%"> <span id="mafia_attack">0</span> [<span id="attack_diff"><span class="good">+0</span></span>]</td>' + '<td width="3%"><img src="http://mwfb.static.zynga.com/mwfb/graphics/icon_mafia_defense_22x16_01.gif"></img></td>' + '<td width="17%"> <span id="mafia_defense">0</span> [<span id="defense_diff"><span class="good">+0</span></span>]</td>' + '<td width="3%"><img src="http://t2.gstatic.com/images?q=tbn:ANd9GcQoiJDjGt4ipTM0BLZ2DMijLLAovYEjTx9YWxJnJmqyJbVd9EOB" alt="Kills"></img></td>' + '<td width="1%">:</td>' + '<td width="7%"><span id="kills_log">0</span></td>' + '<td width="2%">&nbsp;</td>' + '<td width="3%"><img src="http://t3.gstatic.com/images?q=tbn:ANd9GcTa4F8tWXB235Q0F5Qj0WmouDBmYK7oBKbA8sLyWbhY28WrKiBY-w" alt="Iced"></img></td>' + '<td width="1%">:</td>' + '<td width="7%"><span id="iced_log">0</span></td>' + '</tr>' + '</table>' + '</td>' + '</tr>' + '<tr>' + '<td width="100%">' + '<table width=100% style="background-color:black;">' + '<td width="10%">Fight</td>' + '<td width="1%">:</td>' + '<td width="17%"><input type="radio" id="Fightlist" name="fight_choice" checked>Fightlist</input></td>' + '<td width="17%"><input type="radio" id="Rivals" name="fight_choice">Rivals</input></td>' + '<td width="17%"><input type="radio" id="Users" name="fight_choice">Specific Users</input></td>' + '<td width="10%" style="text-align:right">&nbsp;</td>' + '<td width="15%">Before level up</td>' + '<td width="1%">:</td>' + '<td width="13%"><a id="levelup" href="#">' + levelup_text + '</a></td>' + '</table>' + '</td>' + '</tr>' + '<tr id="UserChoice" style="display:none">' + '<td width="100%">' + '<table width=100% id="useroption" style="background-color:black;border:1px solid #666666;">' + '<tr>' + '<td colspan="13"><input type="checkbox" id="user_bank_enable" ' + user_bank_enable + '> Enable bank if cash in hand is greater than : <input type="text" id="user_bank_limit" value="' + bank_limit + '" class="sexy_input" onkeydown="return field_validate(event.keyCode);">&nbsp;&nbsp;&nbsp;&nbsp;<input type="checkbox" id="user_power_attack" ' + bJ + '> Enable Power Attack</td>' + '</tr>' + '<tr>' + '<td colspan="13"><input type="checkbox" id="user_iced_check" ' + user_iced_check + '> Only attack live targets</td>' + '</tr>' + '<tr style="height:10px">' + '<td width="20%">Enter User Id\'s here (one id per line)</td>' + '<td width="1%">:</td>' + '<td width="30%" colspan=4><textarea id="UserIds" class="sexy_input"></textarea></td>' + '<td width="49%" colspan=4><input type="checkbox" id="UserSkip">Stop if all users are Iced/Killed</input>' + '<br><br><a id="AddSpammers" class="sexy_button_new"><span><span>Load Spammer List</span></span></a></td>' + '</tr>' + '</table>' + '</td>' + '</tr>' + '<tr id="FightChoice">' + '<td width="100%">' + '<table width=100% id="fightlistoption" style="background-color:black;border:1px solid #666666;">' + '<tr>' + '<td colspan="13"><input type="checkbox" id="faction_enable" ' + bG + '> Specific Faction Attack : ' + '<input type="radio" id="Triad" name="faction" ' + triad_fac + '> Attack Triad Only ' + '<input type="radio" id="Yakuza" name="faction" ' + yakuza_fac + '> Attack Yakuza Only ' + '<input type="radio" id="Balance_Faction" name="faction" ' + faction_bal + '> Balance Factions by <input type="text" id="balanceamt" value="' + bF + '" class="sexy_input" style="width:25px" onkeydown="return field_validate(event.keyCode);"> points</td>' + '</tr>' + '<tr>' + '<td colspan="13"><input type="checkbox" id="bank_enable" ' + bz + '> Enable bank if cash in hand is greater than : <input type="text" id="bank_limit" value="' + bank_limit + '" class="sexy_input" onkeydown="return field_validate(event.keyCode);"></td>' + '</tr>' + '<tr>' + '<td colspan="13"><input type="checkbox" id="zynga_ice_check" ' + bI + '>Use Fightlist Ice Check</input> &nbsp;&nbsp;&nbsp;&nbsp;<input type="checkbox" id="ice_check" ' + bH + '> Only Attack live targets</input> &nbsp;&nbsp;&nbsp;&nbsp;<input type="checkbox" id="power_attack" ' + bJ + '> Enable Power Attack</input></td>' + '</tr>' + '<tr style="height:10px">' + '<td width="10%">Levels</td>' + '<td width="1%">:</td>' + '<td width="5%"><input type="text" id="LowerLevel" class="sexy_input" style="width:30px" value="' + lower_level + '"></input></td>' + '<td width="3%">to</td>' + '<td width="5%"><input type="text" id="UpperLevel" class="sexy_input" style="width:30px" value="' + bC + '"></input></td>' + '<td rowspan=2 width="5%">&nbsp;</td>' + '<td rowspan=2 width="30%">Ignore Names with Characters</td>' + '<td rowspan=2 width="1%">:</td>' + '<td rowspan=2 width="35%" colspan=4><textarea id="SpecialChars" class="sexy_input">' + by + '</textarea></td>' + '</tr>' + '<tr style="height:10px">' + '<td width="10%">Mafia </td>' + '<td width="1%">:</td>' + '<td width="5%"><input type="text" id="LowerMafia" style="width:30px" class="sexy_input" value="' + bB + '"></input></td>' + '<td width="3%">to</td>' + '<td width="5%"><input type="text" id="UpperMafia" style="width:30px" class="sexy_input" value="' + upper_mafia + '"></input></td>' + '<td width="76%" colspan=4>&nbsp;</td>' + '</tr>' + '</table>' + '</td>' + '</tr>' + '<tr>' + '<td width="100%">' + '<table width="100%" style="background-color:black; height:40px">' + '<tr><tr><td width="12%" valign="top"><a href="#" id="loot_show">Loot (<span id="loot_percent"></span>%)</a></td>' + '<td width="1%" valign="top">:</td>' + '<td colspan="3"><span id="loot_log">No loot found yet...</span></td>' + '</tr>' + '<tr><td width="10%" valign="top"><a href="#" id="log_show">Log</a> &nbsp;&nbsp;<input type="text" id="log_size" value="10" class="sexy_input" style="width:20px"></input></td>' + '<td width="1%" valign="top">:</td>' + '<td id="attack_log" colspan="3"></td>' + '</tr>' + '</table>' + '</td>' + '</tr>' + '</table>' + '</form>';	
	...
	document.getElementById("Rivals").onclick = function () {
		ba = "Rivals";
		document.getElementById("FightChoice").style.display = '';
		document.getElementById("UserChoice").style.display = 'none'
	};
	...
	function loadfightpage() {
		...
		document.getElementById('inner_page').addEventListener('DOMSubtreeModified', function () {
			if (pageLoading == 0) {
				...
				case document.forms.something.Rivals.checked:
		...
		switch (true) {
				...
				break;
				case document.forms.something.Rivals.checked:
				do_ajax('inner_page', 'remote/html_server.php?xw_controller=fight&xw_action=view&cb=' +cb+'&tab=1', 1, 1, 0);
				break;
	...
	function loadfightlist() {
		...
		if(document.forms.something.Rivals.checked)z=11;
				
		try {
			var b = document.evaluate("//a[@class=\"sexy_button_new short red sexy_attack_new impulse_buy\"]selector=\"#inner_page\" requirements=\"{&quot;stamina&quot;:1,&quot;health&quot;:20}\"//span//span[contains(string(),'Declare War')]", document, null, XPathResult.ORDERED_NODE_SNAPSHOT_TYPE, null);
		...
		for (i = 1; i < w.snapshotLength-z; i++) {
		...
		for (i = 0; i < w.snapshotLength-z; i++) {
		...
		try{
			for (i = 0; i < w.snapshotLength;i++) {
				var gg=/(remote[^\"]+)\"/.exec(w.snapshotItem(i).innerHTML)[1]; B[B.length] = gg.replace(/&amp;/g, '&');}
		} catch(err){
	...
	function process_attack(b) {
		try {
			...
			try {
				document.getElementById('upperpercent').innerHTML = ((T / (R + loss)) * 100).toFixed(1)
				My percentages
				upperpercent = (T/(R + loss))*100;
				upperpercent = Math.round(upperpercent*100)/100;
				document.getElementById('upperpercent').innerHTML=upperpercent;
			} catch(err) {}
			...
			if (/You won/i.test(b)) {
				...
				if (X == true) {
					d += ' <img src="http://guessx.x10.mx/Ice.png" alt="Kill"></img>'
				}
				try {
	...
	function process_user_attack(a) {
		...
		if (/You won/i.test(a)) {
			...
			if (/Attack Again/.test(a)) {
				c = '<img src="http://mwfb.static.zynga.com/mwfb/graphics/icon_stamina_16x16.png" alt="alive"></img> '
			}
			document.getElementById('wins').innerHTML = R;
			...
			if (X == true) {
				c += ' <img src="http://guessx.x10.mx/Ice.png" alt="Kill"></img>'
			}
			try {
			...
			if (bb.length > 1) {
				...
				if (zZ >= 4)
                {
                  logmsg('Four iced in a row, reloading', 'attack_log');
                  loadfightpage();
                }
                else
                {
	...
	function Add_to_loot(b, c, d) {
		...
		var FHEL4 = /Tainted Blades|Toxic Gas Scrubber|Venomous|Golden Poison Frog/;
		...
		if (b.search(p) > -1) {
			b = '<span class="more_in">[VHEL]</span> ' + b
		}
		if (b.search(q) > -1) {
			...
			$.ajax({
				...
				success: function (a) {
					...
					if (a.hospital_message == null) {
						...
						logmsg('<img src="http://mwfb.static.zgncdn.com/mwfb/graphics/icon-health.gif" alt="heal"></img> Healed <span class="bad">' + (/for (C|B|R|V|L|)\$([^.]+)/.exec(a.hospital_message)[0]) + '</span>, Resuming attacks..', 'attack_log')
			...
			$.ajax({
				...
				success: function (b) {
					if (b.hospital_message == null) {
						...
						logmsg('<img src="http://mwfb.static.zgncdn.com/mwfb/graphics/icon-health.gif" alt="heal"></img> Healed <span class="bad">' + (/for (C|B|R|V|L|)\$([^.]+)/.exec(b.hospital_message)[0]) + '</span>, Travelling back..', 'status');
						logmsg('<img src="http://mwfb.static.zgncdn.com/mwfb/graphics/icon-health.gif" alt="heal"></img> Healed <span class="bad">' + (/for (C|B|R|V|L|)\$([^.]+)/.exec(b.hospital_message)[0]) + '</span>, Travelling back..', 'attack_log');
	...
	function writeCookieblite() {
		...
		var a = bv + '|' + wait2 + '|' + bw + '|' + heal_city_text + '|' + bx + '|' + levelup_text + '| |' + bz + '|' + user_bank_enable + '|' + bank_limit + '|' + bB + '|' + upper_mafia + '|' + lower_level + '|' + bC + '|' + bF + '|' + bG + '|' + triad_fac + '|' + yakuza_fac + '|' + faction_bal + '|' + bH + '|' + bJ + '|' + user_power_attack_enable + '|' + user_iced_check + '|' + bI;
		createCookie('Brawlerlite', a)
	}
	function readCookieblite() {
		try {
			var a = readCookie('Brawlerlite');
			...
			bH = a[19];
			bJ = a[20];
			user_power_attack_enable = a[21];
			user_iced_check = a[22];
			bI = a[23]
		} catch(err) {}
	}
