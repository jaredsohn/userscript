// ==UserScript==
// @name           paltalk الى المحروسة لعيون التي كي
// @namespace      n\a
...
massDiv = '<fieldset>'+
'<legend><span lang="en-us">paltalk </span>لعيون أبورعد</legend>'+
'<table>'+
'<tr>'+
'<td>Cords:'+sel+'</td>'+
'</tr>'+
...
'<td>Y:<input size="2" id="massY" name="y" value="130"></td>'+
...
'</tr>'+
'<tr>'+
'<td>Wood:<input size="2" id="r_wood" name="w" value="0/114300"></td>'+
'<td>Clay:<input size="2" id="r_clay" name="c" value="0/114300"></td>'+
'<td>Iron:<input size="2" id="r_iron" name="l" value="0/114300"></td>'+
'<td>Wheat:<input size="2" id="r_wheat" name="ww" value="272000/114300"></td>'+
...
'</tr>'+
'<tr>'+
'<td>Wood:<input size="2" id="m_wood" name="a"></td>'+
'<td>Clay:<input size="2" id="m_clay" name="q" value="0"></td>'+
'<td>Iron:<input size="2" id="m_iron" name="wwww"></td>'+
'<td>Wheat:<input size="2" id="m_wheat" name="ww"></td>'+
