// ==UserScript==
// @name           h3o.de - youtube.com
// @namespace      http://h3o.de/sites
// @description    Automatically posts track message of movies watched on youtube.com
...
window.setTimeout(
	...
	function runH3O(msg) {
		...
		if(language="de") {
			msg="Am ansehen von Filmchen bei YouTube: "; 
			} else {
			msg="Watching on YouTube: ";
			}
		
		msg=msg+"["+document.title.substr("YouTube - ")+"|"+window.location+"]";
