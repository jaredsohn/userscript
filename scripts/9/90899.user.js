// ==UserScript==
// @name         ترتيب القرى من الشكل العام
// @namespace     فله ما منها مله
// @include       http://ae*.tribalwars.ae/*screen=overview_villages*
...
dom.addEvent(img,'click',function() {
  ...
  div.appendChild(dom.text('الترتيب حسب:'));
  ...
  a.appendChild(dom.text('الترتيب حسب القاره'));
  div.appendChild(a);
  div.appendChild(dom.n('br'));
  ...
  a.appendChild(dom.text('الترتيب حسب الاحداثيات'));
  div.appendChild(a);
  div.appendChild(dom.n('br'));
  ...
  a.appendChild(dom.text( 'الترتيب بالابجديه'));
  div.appendChild(a);
  div.appendChild(dom.n('br'));
  ...
  dom.addEvent(a,'click',function()
    ...
    sortE(elist,0,false,'search:'+prompt('أدخل سلسلة لتصفية',''));
    });
  a.appendChild(dom.text('مرشح'));
  div.appendChild(a);
...
dom.addEvent(img,'click',function() {
  ...
  a.appendChild(dom.text('المجموع'));
  div.appendChild(a);
