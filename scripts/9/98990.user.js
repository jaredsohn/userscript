  ...
  //addGlobalStyle('#screensizer {padding:0; margin:0; width:100%; height:100%;}');
    ...
    addGlobalStyle('#main_sizer { margin:0; }'); //padding:0; 
      addGlobalStyle('#head_container { background:transparent; }'); //padding-top:0; 
        ...
        addGlobalStyle('#head_background { margin:0; }'); //background:transparent;
          addGlobalStyle('#character_info { margin: 0 16px 0 60px; top:-1px; z-index:3; }');
    ...
    //addGlobalStyle('#main_container_position { top:40px; height:100%; }');
      ...
      addGlobalStyle('#main_container { margin:0; background:none; }'); //padding:0; 
        ...
        addGlobalStyle('.bottomleftcurve {background:url(/images/main/brown_bg_repeat.jpg);}');
        ...
        addGlobalStyle('.bottomrightcurve {background:url(/images/main/brown_bg_repeat.jpg);}');
...
addFooterIcon('javascript:AjaxWindow.show(\'item_trader\', {action: \'index\', h: h});','footer_building_trader','Коммивояжер');
addGlobalStyle('#footer_menu_left #footer_building_trader {background-image:url(data:image/png;base64,%3D%3D);}');
addGlobalStyle('#footer_building_trader {background-position:0px 0;}');
// ~~~~~~~~~~~~~~~~~~~~
...
// === меню "Блокнот" ===
  var notes_img = document.createElement("div");
  notes_img.id="notes_img";
  notes_img.innerHTML = '<a id=\"TWF_notes_img\" title=\"Открыть Блокнот\"></a>';
  notes_img.addEventListener("click", openNotepadMainMenu, false);
  addGlobalStyle('#notes_img { background:url(data:image/png;base64,%3D%3D); }');
  // добавляем меню "Лево" под "Дуэль"
  var menu_duel = document.getElementById('menu_duel');
  if (menu_duel) {
    menu_duel.parentNode.insertBefore(notes_img, menu_duel.nextSibling);
  }
// === меню "Блокнот" ===
...
\
items[55] = {item_id:55, nshort:'bouquet', name:'Букет', type:'right_arm', level:1, price:22, image:'images/items/right_arm/bouquet.png?1', image_mini:'images/items/right_arm/mini/bouquet.png?1', characterClass:null, characterSex:null, speed:null, bonus:{skills:{}, attributes:{}}, set:{key:null, name:null}, shop:'quest'};\
\
...
items[10117] = {item_id:10117, nshort:'cavalry_fine', name:'Солдатские штаны Джорджа Крука', type:'pants', level:85, price:16100, image:'images/items/pants/cavalry_fine.png?1', image_mini:'images/items/pants/mini/cavalry_fine.png?1', characterClass:null, characterSex:null, speed:null, bonus:{skills:{tactic:23, reflex:15, health:15}, attributes:{charisma:3, strength:3}}, set:{key:null, name:null}, shop:'drop'};\
\
