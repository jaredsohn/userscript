...
addGlobalStyle(' body { margin-top: 32px; }  #p-cactions { top: 4em;} #p-logo { top: 32px;} .body { margin-top: 40px; } #navbar, #navbar ul {  padding: 0;  margin: 0;  list-style: none; font-size: 9pt; font-family: "Arial",sans-serif; line-height: 14px;} #navbar a:link { text-decoration: none; color: #3B2C16; } #navbar a:hover { text-decoration: none; color: #3B2C16; background-color: #F2E1BF; } #navbar a:visited { text-decoration: none; color: #3B2C16; } #navbar a:active { text-decoration: none; color: #3B2C16; }  #navbar li:hover ul {  display: block; }  #navbar {  top: 0px;  left: 0px;  width: 100%;  height: 30px;  position: fixed;  background-color: #D2B48C;  z-index: 50; }  #navbar a {  display: block;  padding: 2px 0px; }  #navbar li {  width:200px;  margin: 4px 0px 0px 6px;  border: 2px solid #F2E1BF;  float: left;  text-align: center;  font-weight: bold; }  #navbar li ul {  display: none;  position: absolute;  width:200px;  background-color: #D2B48C;  margin-top: 2px;  margin-left: -2px;  border-left: 2px solid #F2E1BF;  border-bottom: 2px solid #F2E1BF;  border-right: 2px solid #F2E1BF;  z-index: 50; }  #navbar li ul li {  width:200px;  position: relative;  margin: 0px;  border: none;  text-align: left; } #navbar li ul li a {  padding: 2px 4px; }  #navbar li .divider {  border-bottom: 2px solid #F2E1BF; }  div.userbar {  top: 28px;  left: 0px;  width: 100%;  padding: 2px 0px;  position: fixed; z-index: 0; } #centernav { width:1300px; margin:0 auto; }');
