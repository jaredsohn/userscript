// ==UserScript==
// @name        Teclado Virtual Plus!
// @namespace   Juampi_Mix
// @version     1.45
// @description Agrega un teclado virtual en campos de textos. Haga doble click sobre un campo de texto para activar el teclado virtual.
// @Original    http://userscripts.org/scripts/show/10974
// @Note        Este Script es solo una modificacion y/o personalizacion del Script Original "Virtual Keyboard Interface".
// ==/UserScript==
...
(function() {
  ...
  /* ***** i18n text strings ************************************* */
  this.VKI_i18n = {
    '00': "Mostrar Teclado Num\u00e9rico",
    '01': "Mostrar Teclado Virtual Plus!",
    '02': "Seleccione la distribuci\u00f3n del teclado",
    '03': "Teclas Muertas",
    '04': "On",
    '05': "Off",
    '06': "Cerrar el teclado",
    '07': "Limpiar",
    '08': "Limpiar esta entrada",
    '09': "Versi\u00f3n",
    '10': "Reducir Tama\u00f1o del Teclado",
    '11': "Ampliar Tama\u00f1o del Teclado"
  };
  ...
  this.VKI_layout['S\u00edmbolos'] = {
   ...
   this.VKI_layout['US Internacional'] = {
    'name': "US Internacional", 'keys': [
   ...
   *
   */
  this.VKI_attachKeyboard = function(elem) {
  ...
  function VKI_buildKeyboardInputs() {
    ...
    document.documentElement.addEventListener('dblclick', (function(self) { return function(e) {
      e = e || event;
      if ((e.target.nodeName == "TEXTAREA" || e.target.type == "text" || e.target.type == "password") && !e.target.getAttribute("VKI_attached")) {
        self.VKI_attachKeyboard(e.target);
