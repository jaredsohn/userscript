// ==UserScript==
// @name           DS - AutoBuild v.1.7
// @namespace      Celesteria - credits to Zaff
...
/*
 * namen f�r die geb�ude:
 *
 * main       -> Hauptgeb?ude       - max.20
 * barracks   -> Kaserne            - max.25
 * stable     -> Stall              - max.20
 * garage     -> Werkstatt          - max.15
 * snob       -> Adelshof           - max.3
...
/* buildings */
		...
		lang['wall']			= 'Wall';
/* units */
		lang['spear']    	= 'Speertr�ger';
		lang['sword']    	= 'Schwertk�mpfer';
		lang['axe']      	= 'Axtk�mpfer';
		lang['spy']			 	= 'Sp�her';
...
ausbau[0]['evenly'] = true;               // gleichm�ssige ausbauverteilung
