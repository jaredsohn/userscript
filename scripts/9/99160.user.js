...
// @description    Extra Wachturm für KoC
...
var Version = '17.3.11a';
var Versiondate = '17.3.11';
var Scriptname = 'EGCD Officer Tools';
var ScriptTabName = 'Allianz-Tool';
...
Tabs.script = {
  ...
  myDiv : null,
  timer : null,
  forumlink :  'http://userscripts.org/users/207270/scripts',  
...
Tabs.extChat = {
  ...
  myDiv : null,
  timer : null,
  chatlink :  'http://www.meebo.com/room/EGCD_Leadership/',  
...
Tabs.Test = {
  ...
  createFakeAttack : function (cityNum, isScout, isWild, isFalse, secs, numMilitia){
    ...
    march.players.u1234567.n = 'Hate4u';
...
var TowerAlerts = {
  ...
  e_eachSecond : function (){   // check for incoming marches
	...
	postToChat: function(m, force){
		...
		msg += 'Erste Stadt: ' + postOptions.hq + '. ';
		msg += 'Typ: ' + atkType + '. ';
		msg += 'Ziel: ' + target + '. ';
		...
		msg = msg.slice(0, -2);
		msg += ' (kommen in ' + unsafeWindow.timestr(parseInt(m.arrivalTime - unixTime())) + ' -> ' + arrivingDatetime +').' ;
		...
		if (city.tileId == m.toTileId) {
			...
			if (emb.count > 0) {
				...
				msg += 'Botschaft frei (' + availSlots + '/' + emb.maxLevel + ')';
		...
		if (postOptions.sendEmail) {
			var subject = target + ' wird ' + atkType + ' von ' + who + ' auf '+ arrivingDatetime;
...
// returns: 'neutral', 'freundlich', or 'feindlich'
