var icppre = ''
...
////== Opciones ==////
$(".menuTabs .clearBoth").before('<li id="option" class="tabbed"><a href="http://www.taringa.net/opciones/" title="Configuración del Script">Opciones <img src="http://i.t.net.ar/images/arrowdown.png" alt="Drop Down"></a></li>');
if(loc == 'opciones') {
...
$(".menuTabs .clearBoth").before('<li id="colour" class="tabbed" style="cursor:pointer"><a title="Cambia los colores de taringa"><img src="'+img+'lapiz.png"></a></li>');
...
$("#opu").html(spa+'<b>Funciones</b>'+spa+'<ul>\
<li><input type="checkbox" id="fdc" '+(fdc? 'checked':'')+'> <strong>Filtro de categorías</strong> || \
Categoría 1: <select id="categ1"><option value="-1">Todas</option><option value="novatos">Novatos</option><option value="animaciones">Animaciones</option><option value="apuntes-y-monografias">Apuntes y Monografias</option><option value="arte">Arte</option><option value="autos-motos">Autos y Motos</option><option value="celulares">Celulares</option><option value="comics">Comics</option><option value="deportes">Deportes</option><option value="downloads">Downloads</option><option value="ebooks-tutoriales">E-books y Tutoriales</option><option value="economia-negocios">Economia y Negocios</option><option value="femme">Femme</option><option value="humor">Humor</option><option value="imagenes">Imagenes</option><option value="info">Info</option><option value="juegos">Juegos</option><option value="links">Links</option><option value="linux">Linux y GNU</option><option value="mac">Mac</option><option value="manga-anime">Manga y Anime</option><option value="mascotas">Mascotas</option><option value="musica">Musica</option><option value="noticias">Noticias</option><option value="offtopic">Off-topic</option><option value="recetas-y-cocina">Recetas y Cocina</option><option value="salud-bienestar">Salud y Bienestar</option><option value="solidaridad">Solidaridad</option><option value="taringa">Taringa!</option><option value="turismo">Turismo</option><option value="tv-peliculas-series">TV, Peliculas y series</option><option value="videos">Videos On-line</option></select>\
Categoría 2: <select id="categ2"><option value="-1">Todas</option><option value="novatos">Novatos</option><option value="animaciones">Animaciones</option><option value="apuntes-y-monografias">Apuntes y Monografias</option><option value="arte">Arte</option><option value="autos-motos">Autos y Motos</option><option value="celulares">Celulares</option><option value="comics">Comics</option><option value="deportes">Deportes</option><option value="downloads">Downloads</option><option value="ebooks-tutoriales">E-books y Tutoriales</option><option value="economia-negocios">Economia y Negocios</option><option value="femme">Femme</option><option value="humor">Humor</option><option value="imagenes">Imagenes</option><option value="info">Info</option><option value="juegos">Juegos</option><option value="links">Links</option><option value="linux">Linux y GNU</option><option value="mac">Mac</option><option value="manga-anime">Manga y Anime</option><option value="mascotas">Mascotas</option><option value="musica">Musica</option><option value="noticias">Noticias</option><option value="offtopic">Off-topic</option><option value="recetas-y-cocina">Recetas y Cocina</option><option value="salud-bienestar">Salud y Bienestar</option><option value="solidaridad">Solidaridad</option><option value="taringa">Taringa!</option><option value="turismo">Turismo</option><option value="tv-peliculas-series">TV, Peliculas y series</option><option value="videos">Videos On-line</option></select></li>\
<li><input type="checkbox" id="lic" '+(lic? 'checked':'')+'> <strong>Link Checker</strong>\
<li><input type="checkbox" id="bfl" '+(bfl? 'checked':'')+'> <strong>Agrandar swf</strong></li>\
<li><input type="checkbox" id="mos" '+(mos? 'checked':'')+'> <strong>Ocultar swf [Botón]</strong> || \
Aparecerán: <select id="mosm"><option value="Cerrados">Cerrados</option><option value="Abiertos">Abiertos</option></select></li>\
\
<li><input type="checkbox" id="mdp" '+(mdp? 'checked':'')+'> <strong>Agregar Moderador de post</strong>\
<li><input type="checkbox" id="icon" '+(icon? 'checked':'')+'> <strong>Agregar Íconos</strong> || \
Aparecerá: <select id="iconm"><option value="Cerrado">Cerrado</option><option value="Abierto">Abierto</option></select></li>\
\
<li><input type="checkbox" id="barco" '+(barco? 'checked':'')+'> <strong>Agregar Barra de colores</strong> || \
Aparecerá: <select id="barcom"><option value="cerrado">Cerrado</option><option value="abierto">Abierto</option></select></li>\
\
<li><input type="checkbox" id="color" '+(color? 'checked':'')+'> <strong>Agregar Coloringa</strong> || \
Aparecerá: <select id="colorm"><option value="cerrado">Cerrado</option><option value="abierto">Abierto</option></select></li>\
\
<li><input type="checkbox" id="leter" '+(leter? 'checked':'')+'> <strong>Agregar Letringa</strong> || \
Aparecerá: <select id="leterm"><option value="cerrado">Cerrado</option><option value="abierto">Abierto</option></select></li>\
\
<li><input type="checkbox" id="bott" '+(bott? 'checked':'')+'> <strong>Agregar botones</strong> || \
Aparecerá: <select id="bottm"><option value="cerrado">Cerrado</option><option value="abierto">Abierto</option></select></li>\
\
<li><input type="checkbox" id="chct" '+(chct? 'checked':'')+'> <strong>Cambiar color de Taringa!</strong></li>\
\
...
$('#gou').click(function(){
  ...
  $("#bo").before('<div id="saop" style="display:none;font-size:11px;padding:8px;text-align:center"><b style="color:#0fe60f !important;"> ·Opciones guardadas· </b></div>')
$("#saop").slideDown("slow");
...
function setColours() {
  ...
  <td><div id="tcolor" class="cose"><center>Color de taringa</center><input type="text" class="color" value="'+tcolor+'"></div></td>\
...
\
<input class="let" type="radio" name="estilo" value="1" checked> Taringa \
...
<hr class="divider"><div class="pcb"><table width="100%" border="0" cellspacing="0" cellpadding="0"><tr>\
	...
	<li><a name="taringa">Taringa!</a></li>\
...
$.ajax({
  url: "http://www.taringa.net/rss/comentarios.php?id="+locc[3],
...
//$("#comentarios").load("http://www.taringa.net/rss/comentarios.php?id=4384974")
...
$.ajax({
  type: "GET",
  url: "http://www.taringa.net/perfil/gonx_666",
  success: function(html){
	...
	if(ee = ultver){
	 $.ajax({
      type: "POST",
	  url: "http://www.taringa.net/perfil/gonza_06",
	  success: function(html){
	    var ee = $(html).find('.categoriaPost:eq(0) a').html().split('-')[1]
		if(ee > ultver){
		  $('.userInfoLogin ul').prepend('<li><a href="http://userscripts.org/scripts/source/63704.user.js" style="height:20px" title="Hay una nueva version" alt="Hay una nueva version"><img src="'+img+'refresh.png"></a></li>')
...
////== Chat ==////
$(".tabsMenu div").before('<li class="heres"><a href="http://www.taringa.net/posts/2/" title="Chat!">Chat</a></li>');
if(loc == 'chat') {
$(".tabsMenu .here").replaceWith('<li><a href="/" title="Inicio">Inicio</a></li>');
$(".heres").replaceWith('<li class="here"><a href="http://www.taringa.net/posts/2/" title="Chat!">Chat</a></li>');
$(".post-deleted").before('<div id="ban-users" style="display:none"></div>')
if(user != null){
$('#ban-users').load('http://www.taringa.net/comunidades/t-scripts/116220/ .temaCont b div',function(){
...
GM_registerMenuCommand("1 - Reportar Bug ", function() { GM_openInTab('http://www.taringa.net/mensajes/a/briiann79'); },null,null,"1");
GM_registerMenuCommand("2 - Cambiar color de Taringa! ", function() { setColours() },null,null,"3");
