...
//                if(user.size()) {
		    if(user != undefined) {
                    dmg = $j.trim($j("div.statsT2 table table table tr td:has(a[href=http://apps.facebook.com/castle_age/keep.php?casuser="+user+"]) + td").text());
	...
	if (/player_monster_list.php/.test(this.clickUrl)){
		clickUrl = $j("#app46755028429_current_pg_url").val();
        ...
        if(time.length == 3) {
	     ...
	     var monster_id2 = $j("input[name=mid]");
	      if (monster_id2.size()){
			var monster_ext = gettext.FESTIVAL;
		}else{
			var monster_ext = "";
		}
		if ($j("img[src*="+boss.def_img+"]").size()){
            ...
            var hp   = Math.ceil($j("img[src*="+boss.hp_img+"]").parent().css("width").replace(/%/,''))
              ...
              , outer = false
              , info = name + "'s " + monster_ext + boss[user_locale] + "\n[links]\n" +
	     ...
	     var monster_id = $j("input[name=mid]");
	      if (monster_id.size()){
			monster_url = "http://apps.facebook.com/castle_age/festival_battle_monster.php?casuser=" + summoner + "&mpool=" + mpool + "&mid=" + monster_id.val() + (boss.siege ? "&action=doObjective" : "");
		}else{
...
/*
	     var monster_id = $j("input[name=mid]");
	      if (monster_id.size()){
		     ca_info.text(info.replace('[links]', "http://apps.facebook.com/castle_age/festival_battle_monster.php?casuser=" + summoner + "&mpool=" + mpool + "&mid=" + monster_id.val() + (boss.siege ? "&action=doObjective" : "")+"\n" ));
		}else{
	            ca_info.text(info.replace('[links]', "http://apps.facebook.com/castle_age/battle_monster.php?casuser=" + summoner + "&mpool=" + mpool + (boss.siege ? "&action=doObjective" : "")+"\n" ));
		}
*/
    ...
    bosses          : {
        '/graphics/orc_boss_large.jpg' : {
            ...
            def: true, def_img   : '/graphics/nm_green.jpg', hp_img : '/graphics/nm_red.jpg',
            zh_tw : '奧里略.獅子叛軍', en_us : 'Aurelius, Lion\'s Rebellion'
            ...
            def: true, def_img   : '/graphics/nm_green.jpg', hp_img : '/graphics/nm_red.jpg',
            zh_tw : '火元素', en_us : 'Gehenna, The Fire Elemental'
            ...
            def: true, def_img   : '/graphics/nm_green.jpg', hp_img : '/graphics/nm_red.jpg',
            zh_tw : '大氣元素', en_us : 'Valhalla, The Air Elemental'
            ...
            def: true, def_img   : '/graphics/nm_green.jpg', hp_img : '/graphics/nm_red.jpg',
            zh_tw : '賈漢娜 極光祭司', en_us : 'Jahanna, Priestess of Aurora'
            ...
            def: true, def_img   : '/graphics/nm_green.jpg', hp_img : '/graphics/nm_red.jpg',
            zh_tw : '阿加曼農 監督者', en_us : 'Agamemnon the Overseer'
		...
		mpool : 3, army : false, levels : {
            ...
            def: true, def_img   : '/graphics/nm_green.jpg', hp_img : '/graphics/nm_red.jpg',
	     zh_tw : 'Shardros,山巨人', en_us : 'Shardros,the Mountain Giant'
		...
		mpool : 3, army : false, levels : {
            ...
            def: true, def_img   : '/graphics/nm_green.jpg', hp_img : '/graphics/nm_red.jpg',
	     zh_tw : 'Glacius,霜巨人', en_us : 'Glacius,the Frost Giant'
		...
		mpool : 3, army : false, levels : {
            ...
            def: true, def_img   : '/graphics/nm_green.jpg', hp_img : '/graphics/nm_red.jpg',
	     zh_tw : 'Kromash,風暴巨人', en_us : 'Kromash,the Storm Giant'
		...
		mpool : 3, army : false, levels : {
            ...
            def: true, def_img   : '/graphics/nm_green.jpg', hp_img : '/graphics/nm_red.jpg',
	     zh_tw : 'Magmos,熔岩巨人', en_us : 'Magmos,the Lava Giant'
