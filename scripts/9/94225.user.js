...
var lag = GM_getValue("FSLW_Lag",50);
...
var dir= new Array(7);
   dir[0]="//a[img[contains(@src,'/L_on.gif') or contains(@src,'/L.gif')]]";
   dir[1]="//a[img[contains(@src,'/R_on.gif') or contains(@src,'/R.gif')]]";
   dir[2]="//a[img[contains(@src,'/T_on.gif') or contains(@src,'/T.gif')]]";
   dir[3]="//a[img[contains(@src,'/B_on.gif') or contains(@src,'/B.gif')]]";
   dir[4]="//a[img[contains(@src,'/TL_on.gif') or contains(@src,'/TL.gif')]]";
   dir[5]="//a[img[contains(@src,'/TR_on.gif') or contains(@src,'/TR.gif')]]";
   dir[6]="//a[img[contains(@src,'/BL_on.gif') or contains(@src,'/BL.gif')]]";
   dir[7]="//a[img[contains(@src,'/BR_on.gif') or contains(@src,'/BR.gif')]]";
...
function lagTimer(i)
{
	if(i>0)
	{
		...
		globalTimer=setTimeout(function(){lagTimer(0);},timerClick);
	}
	else
	{
		if(counter>0)
		{
			globalTimer=setTimeout(function(){lagTimer(0);},timerClick);
			counter--;
			b = document.getElementById('FSLW_Panel');
			b.innerHTML="<span style='color:red;font-weight:bold;'>Wait</span> [ <span style='color:red;font-weight:bold;'>"+counter+"</span> ]";
		}
		else
		{
			b = document.getElementById('FSLW_Panel');
			b.innerHTML="<span style='color:#1B8BCB;font-weight:bold;'>Fs. LightWalk</span> [ <span style='color:green;font-weight:bold;'>Data Sent</span> ]";
		}
	}
}
...
if(getVal("cmd",window.location.href)=="world" ||
	getVal("cmd",window.location.href)=="combat" ||
	getVal("cmd",window.location.href)=="blacksmith")
{
	...
	else
	{
			...
			b = getNode("//table/tbody[tr/td/font/b[.='Quick Links']]/tr[4]/td");
