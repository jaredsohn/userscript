		...
		if(this.hasShips) {
			...
			for(var i in this.fleets) {
				...
				if (this.fleets[i].hermes != 0)
					s += "* Hermes Class Probe: " + addCommas(this.fleets[i].hermes) + "<br>";
				if (this.fleets[i].helios != 0)
					s += "* Helios Class Solar Satellite: " + addCommas(this.fleets[i].helios) +   "<br>";
				if (this.fleets[i].artemis != 0)
					s += "* Artemis Class Fighter: " + addCommas(this.fleets[i].artemis) + "<br>";
				if (this.fleets[i].atlas != 0)
					s += "* Atlas Class Cargo: " + addCommas(this.fleets[i].atlas) + "<br>";
				if (this.fleets[i].apollo != 0)
					s += "* Apollo Class Fighter: " + addCommas(this.fleets[i].apollo) + "<br>";
				if (this.fleets[i].charon != 0)
					s += "* Charon Class Transport: " + addCommas(this.fleets[i].charon) + "<br>";
				if (this.fleets[i].hercules != 0)
					s += "* Hercules Class Cargo: " + addCommas(this.fleets[i].hercules) + "<br>";
				if (this.fleets[i].dionysus != 0)
					s += "* Dionysus Class Recycler: " + addCommas(this.fleets[i].dionysus) + "<br>";
				if (this.fleets[i].gaia != 0)
					s += "* Gaia Colony Ship: " + addCommas(this.fleets[i].gaia) + "<br>";
				if (this.fleets[i].poseidon != 0)
					s += "* Poseidon Class Cruiser: " + addCommas(this.fleets[i].poseidon) + "<br>";
				if (this.fleets[i].athena != 0)
					s += "* Athena Class Battleship: " + addCommas(this.fleets[i].athena) + "<br>";
				if (this.fleets[i].ares != 0)
					s += "* Ares Class Bomber: " + addCommas(this.fleets[i].ares) + "<br>";
				if (this.fleets[i].hades != 0)
					s += "* Hades Class Battleship: " + addCommas(this.fleets[i].hades) + "<br>";
				if (this.fleets[i].prometheus != 0)
					s += "* Prometheus Class Destroyer: " + addCommas(this.fleets[i].prometheus) + "<br>";
				if (this.fleets[i].zeus != 0)
					s += "* Zeus Class: " + addCommas(this.fleets[i].zeus) + "<br>";
				if (this.fleets[i].hephaestus != 0)
					s += "* Hephaestus Class Attack Platform: " + addCommas(this.fleets[i].hephaestus) + "<br>";
				s += "<br>";
			}
		}
		if(this.hasDefenses) {
			s += "DEFENSES:<br>";
			if (this.defense.missileBatt > 0)
				s += "* Missile Battery: " + addCommas(this.defense.missileBatt) + "<br>";
			if (this.defense.laserCannon > 0)
				s += "* Laser Cannon: " + addCommas(this.defense.laserCannon) + "<br>";
			if (this.defense.pulseCannon > 0)
				s += "* Pulse Cannon: " + addCommas(this.defense.pulseCannon) + "<br>";
			if (this.defense.particleCannon > 0)
				s += "* Particle Cannon: " + addCommas(this.defense.particleCannon) + "<br>";
			if (this.defense.decoy > 0)
				s += "* Decoy: " + this.defense.decoy + "<br>";
			if (this.defense.gaussCannon > 0)
				s += "* Gauss Cannon: " + addCommas(this.defense.gaussCannon) + "<br>";
			if (this.defense.largeDecoy > 0)
				s += "* Large Decoy: " + this.defense.largeDecoy + "<br>";
			if (this.defense.plasmaCannon > 0)
				s += "* Plasma Cannon: " + addCommas(this.defense.plasmaCannon) + "<br>";
			if (this.defense.abm != 0 || this.defense.ibm != 0)
				s += "<br>";
			if (this.defense.abm > 0)
				s += "* Anti-Ballistic Missile: " + addCommas(this.defense.abm) + "<br>";
			if (this.defense.ibm > 0)
				s += "* Interplanetary Ballistic Missile: " + addCommas(this.defense.ibm) + "<br>";
			s += "<br>";
		}
