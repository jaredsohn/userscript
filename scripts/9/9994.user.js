// ==UserScript==
// @name            taz_zusatzressorts_09
// @namespace       Platypus
// @include         http://www.taz.de/index.php?id=digitaz&w+b
...
do_modify_html_it(window.document,document.getElementById('content_gesamt'),/w\+b([^>]+)>/,'w+b$1 class="main_navi_element_aktiv">',null);
do_modify_html_it(window.document,document.getElementById('content_gesamt'),/<h1[^<]+<\/h1>/,'<h1>Wissen</h1>',null);
do_modify_html_it(window.document,document.getElementById('content_gesamt'),/<p[^>]+"bodytext">[^#]+<\/div[^<]+<\/div[^<]+<!-- Ende linke Spalte -->/,'<br><br><br><br><br><iframe src="http://www.taz.de/digitaz/.archiv/suche?dos=1&mode=erw&tx=~fgtrz&ti=&au=&sdd=09&smm=01&syy=2006&edd=&emm=&eyy=&art=&len=&se=&rev=1&ListLen=10&qu=&re=bi#taz-archiv" width="685" height="600"></iframe><iframe src="http://www.taz.de/digitaz/.archiv/suche?dos=1&mode=erw&name=askhRWvAU&tx=~fgtrz&ti=&au=&sdd=09&smm=01&syy=2006&edd=&emm=&eyy=&art=&len=&se=&rev=1&ListLen=10&qu=&re=wi#taz-archiv" width="685" height="600"></iframe><iframe src="http://newsfeed.zeit.de/wissen/bildung/index#feed-greasemonkey" width="685" height="600"></iframe></div></div><!-- Ende linke Spalte -->',null);
