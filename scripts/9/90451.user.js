...
// ==UserScript==
// @name           OnBux Manager (Golden member)
...
// -> O script corre nas duas linguas Portugues e Inglês(vou tentar adicionar mais em breve)
  ...
  PT : {
    ...
    'clickedyesterday': 'Clicaram Ontem:',
    'neverclicked': 'Nunca clicaram:',
    'tclicks': 'Total cliques:',
    'average': 'M&eacute;dia de Cliques',
    'profit': 'Ganhos',
