// ==UserScript==
// @name           PTC AutoClicker Bot for 123bux.net
// @namespace      http://cool-bux.co.cc
// @description    An Auto-click for 123bux.net, makes you validated without viewing the ads. Ads loaded faster, because this script ignores all tags. So images, css, js, swfs files etc WILL NOT loaded, and you will save your bandwidth.
// @include        *://*123bux.net/*
...
if(correctURL(/\/ads\.php/)) {
	if(login) {
		...
		html += "</style>";
		html += "<div id='PTCAutoClickerBot'><div id='PTC AutoClicker Bot-title'>JustOneClick for 123bux.net</div><br /><div id='PTCAutoClickerBot-msg' align=center>";
