...
Travian: Attack Builder updated
By arl0ng — Last update Oct 7, 2009 — Installed 19,512 times.
...
switch(sLang)
{
	...
	case "pt":
		text = ["Descendo o dedo =)","Tipo inv?lido de ataque!","Sem coordenadas!","Tropas insuficientes! (Tropas #","Tropas n?o informadas","Iniciando","Coordenadas inv?lidas","Sem unidades de reconhecimento","Conclu?do","Configuraç?o da Onda:","Adicionar Onda","Reiniciar","Configuraç?o de Ataque:","Tipo de Ataque:","Normal","Reforço","Assalto","Espiar recursos e tropas","Espiar defesas e tropas","Coordenadas","Senta o dedo! =)","Hora de Chegada","Chegada às:","Definir hora de chegada","N?mero de ataques desta onda","com '|' ex: 0,0|1,1","ERRO:","Imposs?vel pegar a aldeia ativa. Considerando que a conta s? possui uma aldeia","Chegada programada para:","Time between waves in ms: (default 500) "];

		cataText = ["Escolha um alvo =)","Aleat?rio","Bosque","Poço de Barro","Mina de Ferro","Campo de Cereais","Serraria","Alvenaria","Fundiç?o","Moinho","Padaria","Armazém","Celeiro","Ferreiro","F?brica de Armaduras","Praça de Torneios","Edif?cio Principal","Ponto de Reuni?o Militar","Mercado","Embaixada","Quartel","Cavalaria","Oficina","Academia","Casa do Povo","Residência","Pal?cio","Companhia do Comércio","Grande Quartel","Grande Cavalaria","Mans?o do Her?i","Grande Armazém","Grande Celeiro","Maravilha do Mundo","Tesouraria"];
		break;

	case "et"://by jeje

		text = ["Ataca!!! =)","Tipo de ataque invalido!","No hay coordenadas!","No hay suficientes Tropas! (Tropas #","No tropas introducidas","Empezando","Problamente malas coordenadas","No hay exploradores","Correcto-Hecho","Configurar Ataque:","A?adir nuevo ataque","Resetear","Configurar ataque:","Tipo de ataque:","Normal","Refuerzos","Atraco","Acechar Produccion/Tropas","Achechar Defensas/Tropas","Coordenadas","Ataca camarada! =)","Tiempo de Llegada","Llegara a las :","Establecer tiempo de llegada","Numero de ataques de esta estrategia","con '|' ex: 0,0|1,1","ERROR:","Incapaz de encontrar la aldea activa. Assuming one village account","Tiempo de llegada establecido a las:","Time between waves in ms: (default 500) "];
		cataText = ["Selecciona un objectivo =)","Aleatorio","Le?ador","Barrena","Mina Hierro","Campo de Cereales","Serreria","Ladrillar","Fundicion","Molino","Panaderia","Almacen","Granero","Herreria","Armeria","Plaza de Torneos","Edificio Principal","Plaza de Reuniones","Mercado","Embajada","Cuartel","Establo","Oficina","Academia","Ayuntamiento","Residencia","Palacio","Oficina de comercio","Cuartel Grande","Establo Grande","Casa del Heroe","Almacen Grande","Granero Grande","Maravilla","Tesoro"];

		break;

	case "lt":
		text = ["Ataka vykdoma","Klaidingas atakos tipas","Nepasirinktos koordinat?s","Nepakanka kari? (Kari? skai?ius","Nepasirinkti kariai","Pradedama","Klaidingos koordinat?s","Tr?ksta ?valgybini? kari?","?vykdyta","Bang? nustatymai:","Prid?ti nauj? bang?","Pradiniai nustatymai","Atak? nustatymai:","Atakos tipas:","Ataka","Pastiprinimas","Reidas","Resurs? bei paj?g? ?valgyba","Gynybini? fortifikacij? bei paj?g? ?valgyba","Koordinat?s","Ataka","Atvykimas","Atakos laikas:","Nustatyti atakos laik?","atak? skai?ius","atskirti su \'|\' pvz.: 0,0|1,1","KLAIDA:","Ne?manoma gauti gyvenvie?i? koordina?i?. Tikriausiai yra tik viena gyvenviet?.","Kari? atvykimo laikas nustatytas:","Vykdoma","Time between waves in ms: (default 500) "];

		cataText = ["Nustatyti taikin?","Atsitiktinai","Med?i? kirtaviet?","Molio karjeras","Gele?ies kasykla","Gr?d? ferma","Lentpj?v?","Plytin?","Liejykla","Mal?nas","Kepykla","Sand?lis","Kl?tis","Ginkl? kalv?","?arv? kalv?","Arena","Gyvenamasis pastatas","Susib?rimo vieta","Turgaviet?","Ambasada","Kareivin?s","Arklid?","Dirbtuv?s","Akademija","Rotu??","Rezidencija","Valdovo r?mai","I?din?","Prekybos r?mai","Did?iosios kareivin?s","Did?ioji arklid?","Kar?ygio namai","Didysis sand?lis","Did?ioji kl?tis","Pasaulio stebuklas","Treasury"];
		break;

	case "tr"://by kustah
		text = ["vur tekmeyi =)","yanl?? atak tipi!","cordinat yok!","yeterli asker yok! (askerler #","asker seçilmedi","ba?l?yor","yanl?? kordinat","g?zcü yok","Bitti","Dalga ayar?:","Yeni dalga ekle","Reset","Atak ayar?:","Atak tipi:","Normal","Destek","Ya?malama","Hammade g?zle","Defans g?zle","Kordinat","Vur tekmeyi! =)","Ula??m zaman?","Var?? saati:","Ula??m zaman? ayar?","Dalgadaki sald?r? say?s?","with '|' ex: 0,0|1,1","Hata:","Hesap kapal?","Ula??m zaman? :","Time between waves in ms: (default 500) "];

		cataText = ["Select a target =)","Random","Orman","Tugla ocag?","Demir madeni","Tarla","Marangozhane","Tu?la F?r?n?","Demir d?kümhanesi","De?irmen","Ekmek f?r?n?","Hammadde deposu","Tah?l ambar?","Silah d?kümhanesi","Z?rh d?kümhanesi","Turnuva alan?","Merkez binas?","Askeri üs","Pazar yeri","Elçilik","K??la","Ah?r","Tamirhane","Akademi","Belediye","K??k","Saray","Ticaret merkezi","Büyük k??la","Büyük ah?r","Kahraman k??las?","Büyük hammadde deposu","Büyük Tah?l ambar?","Dünya harikas?","Treasury"];
		break;

	case "de":
		text = ["Whooping some ass =)","Falscher Angriffs Typ!","Keine Koordinaten!","nicht genug Truppen! (Truppen #","Keine Truppen Eingabe","Startet","Falsche Koordinaten","Keine Sp?her!","Fertig","Wellen Einstellung:","Neue Welle hinzufügen","Abbrechen","Angriffs Einstellungen:","Angriffs Typ:","Angriff: Normal","Unterstützung","Angriff: Raubzug","Res/Truppen aussp?hen","Def/Truppen aussp?hen","Koordinaten","Whoop some ass! =)","Ankunftszeit","Ankunft in:","Ankunftszeit festlegen","Anzahl der Angriffe der spezifischen Welle","mit '|' ex: 0,0|1,1","ERROR:","Unable to get active village. Assuming one village account","Ankunftszeit gesetzt für:","Time between waves in ms: (default 500) "];

		cataText = ["Select a target =)","Random","Holzf?ller","Lehmgrube","Eisenmiene","Getreidefeld","S?gewerk","Lehmbrennerei","Eisengie?erei","Getreidemühle","B?ckerei","Rohstofflager","Kornspeicher","Rüstungsschmiede","Waffenschmiede","Tunierplatz","Hauptgeb?ude","Versammlungsplatz","Marktplatz","Botschaft","Kaserne","Stall","Siege Workshop","Akademie","Rathaus","Residenz","Palast","Marktplatz","Gro?e Kaserne","Gro?er Stall","Heldenhof","Go?es Rohstofflager","Gro?er Kornspeicher","Weltwunder","Treasury"];
		break;
	...
	case "cz": //CeP
		text = ["Odes?l?m","Chybn? typ ?toku!","Chyb? sou?adnice!","Nedostatek jednotek! (Jednotka #","Neur?il jsi ?to?né jednotky :)","Start","Asi ?patné sou?adnice","Nem?? ?pehy","Hotovo","Nastaven? vlny:","P?idat dal?? vlnu","Reset","Nastaven? ?toku:","Typ ?toku:","?tok","Podpora","Loupe?","?pehovat suroviny/jednotky","?pehovat obranu/jednotky","Sou?adnice","Odeslat ?tok","Zjistit ?as p??chodu","P?ij?t v:","Na?asovat p??chod","Po?et ?tok? ve vln?","odd?lova? sou?adnic - ';' - st?edn?k - nap?.: -5|10;51|-110","CHYBA:","Nelze odeslat ..","P??chod nastaven na:","Time between waves in ms: (default 500) "];

		cataText = ["Vyber c?l =)","N?hodn?","D?evorubec","Hlin?n? d?l","?elezn? d?l","Obilné pole","Pila","Cihelna","Slév?rna","Ml?n","Pek?rna","Sklad","S?pka","Kov?rna","Zbrojnice","Turnajové h?i?t?","Hlavn? budova","Shroma?di?t?","Tr?i?t?","Ambas?da","Kas?rny","St?je","D?lna","Akademie","Radnice","Rezidence","Pal?c","Obchodn? kancel??","Velké kas?rny","Velké st?je","Hrdinsk? dv?r","Velk? sklad","Velk? s?pka","Div sv?ta","Treasury"];
		break;

	case "pt"://by MauDaFaca
		text = ["Vai-te a eles =)","Tipo de ataque invalido!","Sem coordenadas!","Sem tropas suficientes! (Tropas #","Sem especificaç?o de tropas","Começando","Provavelmente m?s coordenadas","Sem batedores","Feito","Configuraç?o da onda:","Adicionar nova onda","Zerar","Configurar ataque:","Tipo de ataque:","Normal","Reforço","Assalto","Espiar Rec/Tropas","Scout Def/Tropas","Coordenadas","Vai-te a eles! =)","tempo de chegada","Chegada às:","Devem chegar às","Numero de ataques desta onda","Com '|' ex: 0,0|1,1","ERRO:","Incapaz de encontrar uma aldeia activa. Assumindo uma conta de aldeia","Tempo de chegada às:","Time between waves in ms: (default 500) "];

		cataText = ["Escolha um alvo =)","A sorte","Floresta","Pço de barro","Mina de ferro","Campo de cereais","Serraç?o","Oleiro","Fundiç?o","Moinho","Padaria","Armazem","Celeiro","Ferreiro","F?brica de Armaduras","Praça de troneios","Edificio principal","Ponto de reuni?o","Mercado","Embaixada","Quartel","Est?bulo","Oficina","Academia","Casa do povo","Residencia","Palacio","Companhia do comércio","Grande quartel","Grande est?bulo","Residência do heroi","Grande armazem","Grande celeiro","Maravilha do mundo","Treasury"];
		break;

	case "sk": //by eth4rendil
		text = ["Rozbi t? lamu =)","Chybn? typ ?toku!","?iadne s?radnice!","Nedostatok vojakov! (Vojak #","?iadny vojaci na uto?enie :)","Za??nam","Pravdepodobne zlé s?radnice","?iadny ?peh","Hotovo","Nastavenie vlny:","Prida? nov? vlnu","Reset","Nastavenie ?toku:","Typ ?toku:","?tok","Podpora","L?pe?","?pehova? suroviny a vojakov","?pehovat obranne budovy a vojakov","S?radnice","Rozbi t? lamu! =)","?as pr?chodu","Pr?s? o:","Nastavi? ?asovan? pr?chod","Po?et ?tokov v danej vlne","with '|' ex: 0,0|1,1","Error:","Nemozno odoslat ..","?as pr?chodu nastaveny na:","Time between waves in ms: (default 500) "];

		cataText = ["Vyberte si cie? =)","N?hodne","Drevoruba?","Hlinen? ba?a","?elezn? ba?a","Obilné pole","P?la","Tehe??a","Zlievare?","Mlyn","Pek?re?","Sklad","S?pka","Kov??ska diel?a","Zbrojnica","Aréna","Hlavn? budova","Bod stretunutia","Trhovisko","Ambas?da","Kas?rne","Stajne","Diel?a","Akadémia","Radnica","Rezidencia","Pal?c","Obchodn? kancel?ria","Velké kas?rne","Velké stajne","Hrdinsk? dvoj","Velk? sklad","Velk? s?pka","Div sveta","Treasury"];
		break;

	case "pl": //by robertnik
		text = ["Licz? co? tam :P","Z?y typ ataku!","Brak wsp??rz?dnych!","?le wybra?e? jednostki! (Atak #","Nie wybrano jednostek!","Zaplanowany ATAK","Z?e wsp??rz?dne","Nie wybra?e? szpieg?w","Atakuj ","Wybierz jednostki:","Dodaj nowy atak","Wyczy??","Szczeg??y ataku:","Typ ataku:","Atak: Normalny","Posi?ki","Atak: Grabie?","Obserwuj surowce","Obserwuj fortyfikacje","Wsp??rz?dne","Zaplanuj, p??niej od?wie? ;)","Poka? aktualny czas ataku","Przybycie o:","Zaplanuj atak o czasie doj?cia","Ilo?? atak?w","inny cel po ',' przyk?ad: 0|0,1|1","B??D: ","Niezdolny dosta? aktywn? wie?.","Zaplanowany atak dojdzie o: ","Czas pomi?dzy falami w ms: (domy?lnie 500) "];

		cataText = ["Wybierz cel =)","Losowy cel","Las","Kopalnia gliny","Kopalnia ?elaza","Pole","Tartak","Cegielnia","Huta ?elaza","M?yn","Piekarnia","Magazyn","Spichlerz","Ku?nia","Zbrojownia","Plac turniejowy","G??wny budynek","Miejsce zbi?rki","Rynek","Ambasada","Koszary","Stajnia","Warsztat","Akademia","Ratusz","Rezydencja","Pa?ac","Targ","Du?e koszary","Du?a stajnia","Dw?r bohater?w","Du?y magazyn","Du?y spichlerz","Cud :P","Treasury"];
		break;
	...
	case "ae": ///by Dream1
text = ["Êã ÇáåÌæã =)","äæÚ ÇáåÌæã ÎÇØÆ!","áÇÊæÌÏ ÅÍÏÇËíÇÊ!","ÚÏÏ ÇáÞæÇÊ ÇáãæÌæÏå ÛíÑ ßÇÝí! ÇáÞæÇÊ ÑÞã  #","áã íÊã ÅÎÊíÇÑ ÇáÞæÇÊ","ÇáÈÏÇíÉ","ÑÈãÇ ÇáÅÍÏÇËíÇÊ ÎÇØÆÉ","áã ÊÎÊÇÑ æÍÏÇÊ ßÔÇÝå","Êã ÇáåÌæã","ÃÚÏÇÏÇÊ ÇáÞæÇÊ:","ÃÖÇÝÉ ÞæÇÊ åÌæã ÌÏíÏÉ","ãÓÍ ÇáÞæÇÊ","ÃÚÏÇÏÇÊ ÇáåÌæã:","äæÚ ÇáåÌæã:","åÌæã: ßÇãá","ãÓÇäÏÉ","åÌæã: ááäåÈ","ÇáÊÌÓÓ Úáì ÇáãæÇÑÏ æÇáÞæÇÊ","ÇáÊÌÓÓ Úáì ÇáÊÍÕíäÇÊ æÇáÞæÇÊ","ÇáÅÍÏÇËíÇÊ","åÌæã ÇáÂä! =)","æÞÊ ÇáæÕæá","ÇáæÕæá Ýí:","ÅÎÊÇÑ æÞÊ ÇáæÕæá","ÚÏÏ ÇáåÌãÇÊ","ááåÌæã Úáì ÃßËÑ ãä ÞÑíå ÖÚ åÐå Èíä ÇáÅÍÏÇËíÇÊ',' ãËÇá: 00|1,1|0","ÎØÃ:","ÊÚÐÑ ÇáæÕæá Çáì ÇáÞÑíå ÇáäÔØå. ãä ÇáãÝÊÑÖ Çä íßæä ãä ÍÓÇÈ æÇÍÏ æÞÑíå æÇÍÏå","æÞÊ ÇáæÕæá ÍÏÏ Úáì:","ÇáæÞÊ Èíä ÇáåÌãÇÊ: (ÇáÅÝÊÑÇÖí 500) "," ÊÚÑíÈ:ãäÕæÑ ÇáÚÊíÈí (Dream1)"];

cataText = ["ÃÎÊÇÑ ÇáåÏÝ =)","ÚÔæÇÆí","ÇáÍØÇÈ","ÍÝÑÉ ÇáØíä","ãäÌã ÍÏíÏ","ÍÞá ÇáÞãÍ","ãÚãá ÇáäÔÇÑÉ","ãÕäÚ ÇáØæÈ","ÍÏíÏ ãÓÈß","ÇáãØÇÍä","ãÎÈÒ","ãÎÒä","ãÎÒä ÇáÍÈæÈ","ÇáÍÏÇÏ","ãÓÊæÏÚ ÇáÇÓáÍÉ","ÓÇÍÉ ÇáÈØæáÉ","ÇáãÈäì ÇáÑÆíÓí","äÞØÉ ÇáÊÌãÚ","ÇáÓæÞ","ÇáÓÝÇÑÉ","Ëßäå","ÅÓØÈá","ÇáãÕÇäÚ ÇáÍÑÈíÉ","ÇáÃßÇÏíãíÉ","ÇáÈáÏíÉ","ÇáÓßä","ÞÕÑ","ÇáãßÊÈ ÇáÊÌÇÑí","ËßäÉ ßÈíÑÉ","ÅÓØÈá ßÈíÑ","ÞÕÑ ÇáÃÈØÇá","ãÎÒä ßÈíÑ","ãÎÒä ÍÈæÈ ßÈíÑ","ãÚÌÒÉ ÇáÚÇáã","ÇáÎÒäÉ"];
break;

	case "dk": //Credit to Kennetha for the translation.
		text = ["Klarg?r angreb...","Ugyldig angrebstype!","Ingen koordinater!","Ikke nok tropper! (Enhed #","Ingen tropper valgt","Starter","Sandsynligvis ugyldige koordinater","Ingen spionenheder","F?rdig","Angrebsindstillinger:","Tilf?j ny angrebsb?lge","Nulstil","Angrebsindstillinger:","Angrebstype:","Normalt","Opbakning","Plyndringstogt","Spionage Res/Tropper","Spionage Forsvar/Tropper","Koordinater","Angrib! =)","Ankomst tid","Ankomst:","S?t timet ankomst","Antal angreb af den specifikke angrebsb?lge","Adskil med '|' f.eks.: 0,0|1,1 for at sende angreb p? flere byer af gangen","Fejl:","Kunne ikke finde aktiv landsby. Antager kontoen har én by.","Timet ankomst sat til:","Time between waves in ms: (default 500) "];

		cataText = ["V?lg et m?l =)","Tilf?lde","Skovhugger","Lergrav","Jernmine","Kornavler","Savv?rk","Lerbr?nderi","Jernst?beri","Kornm?lle","Bageri","R?stoflager","Kornkammer","V?bensmedje","Rustningssmedje","Turneringsplads","Hovedbygning","Forsamlingsplads","Markedsplads","Ambassade","Kaserne","Stald","V?rksted","Akademi","R?dhus","Residens","Palads","Handelskontor","Stor kaserne","Stor stald","Heltebygning","Stort r?stoflager","Stort kornkammer","Verdens Vidunder","Treasury"];
		break;

	case "hu": // by Mijo
		text = ["Z?z?s folyamatban =)","Ervénytelen t?mad?si t?pus!","Mik a koordin?t?k?!","nincs elég sereg! (Sereg #","Nincs sereg megadva!","Ind?t?s","Val?sz?n?leg hib?s cél!","Nincs kémed!","Kész!","Hull?mok be?ll?t?sa:","?j hull?m","Lenull?z","T?mad?s be?ll?t?sa:","T?mad?si forma:","Norm?l","T?mogat?s","Fosztogat?s","Kémkedés Nyersanyagok/Seregek","Kémkedés Védelmi Berendezések/Seregek","Koordin?t?k","Z?zzunk oda! =)","Erkezési id?","Erkezés ekkor:","Id?z?tett érkezés","Az adott hull?m t?mad?sainak sz?ma","T?bb cél elv?laszt?sa '|'-val pl: 0,0|1,1","HIBA: ","Nem lehet meghat?rozni az aktu?lis falut! Feltételezhet?en egy falus j?tékos.","Id?z?tett érkezés be?ll?tva:","Time between waves in ms: (default 500) "];

		cataText = ["V?lassz célpontot! =)","Véletlen","Fav?g?","Agyagb?nya","Vasércb?nya","B?zafarm","F?rész üzem","Agyagéget?","Vas?nt?de","Malom","Pékség","Rakt?r","Magt?r","Fegyverkov?cs","P?ncélkov?cs","Gyakorl?tér","F?épület","Gyülekez?tér","Piac","K?vetség","Kasz?rnya","Ist?ll?","M?hely","Akadémia","Tan?csh?za","Rezidencia","Palota","Kereskedelmi k?zpont","Nagy kasz?rnya","Nagy ist?ll?","H?s?k h?za","Nagy rakt?r","Nagy magt?r","Vil?gcsoda","Treasury"];
		break;

	case "no":
		text = ["Whooping some ass =)","Ugyldig angreps type!","Ingen koordinater!","Ikke nok tropper! (Enhet #","Ingen tropper valgt","Starter","Sannsynligvis ugyldige koordinater","Ingen spion enheter","Ferdig","Angrepsb?lge oppsett:","Ny angrepsb?lge","Nullstill","Angreps oppsett:","Angreps type:","Normal","Forsterkninger","Plyndringstokt","Spioner Res/Tropper","Spioner Forsvar/Tropper","Koordinater","Whoop some ass! =)","Ankomst tid","Ankommer:","Sett beregned ankomst tid","Antall repetisjoner av den angrepsb?lgen","Skill med '|' f.eks: 0,0|1,1","Feil:","Klarte ikke ? finne aktiv landsby. Antar konto med en landsby","Beregnet ankomst satt til:","Time between waves in ms: (default 500) "];

		cataText = ["Velg et m?l =) ","Tilfeldig","T?mrer","Leirgrop","Jernmine","Korn?ker","Sagbruk","Mursteinsopplag","Smelteverk","M?lle","Bakeri","Varehus","Silo","V?pensmed","Rustningssmed","Turneringsomr?de","Hovedbygning","M?teplass","Markedsplass","Ambassade","Kaserne","Stall","Verksted","Akademi","R?dhus","Residens","Palass","Handelskontor","Stor kaserne","Stor stall","Heltens villa","Stort varehus","Stor silo","Verdens underverk","Skattekammer"];
