...
twpro_langs.fr = {
	...
	HATS: 'Couvre-chefs:',
	NECKLACES: 'Colliers',
	WEAPONS: 'Armes de duel',
	GUNS: 'Fusils',
	BELTS: 'Ceintures',
	PANTS: 'Pantalons',
	CLOTHING: 'Habillements',
	SHOES: 'Chaussures',
	ANIMAL: 'Montures',
	NONYIELDS: 'Total Equipements',
	YIELDS: 'Produits',
	//LOADING: 'Chargement...',
	LABORP: 'PT',
	...
	SLEEPYONLY: 'Afficher le set <b>Grincheux</b>'
};
twpro_langs.hu = {
	...
	HATS: 'Fejfedők',
	NECKLACES: 'Nyakbavalók',
	WEAPONS: 'Párbajegyverek',
	GUNS: 'Erődharcos fegyverek',
	BELTS: 'Övek',
	PANTS: 'Nadrágok',
	CLOTHING: 'Ruházat',
	SHOES: 'Cipők',
	ANIMAL: 'Hátasállat',
	NONYIELDS: 'Nem-termékek',
	YIELDS: 'Termékek',
	//LOADING: 'Töltés...',
	LABORP: 'MP',
	CONSTRUCTION: 'Építés',
	...
	SLEEPYONLY: '<b>Alvós</b> szett mutatása'
};
...
*/
	...
	function twpro_injectScript() {
		...
		twpro_support.appendChild(document.createTextNode("TW Pro FR: "));
...
toggle_sleepy = 0;
	function twpro_showsleepy(){
	  if (toggle_sleepy == 0){
		...
		if(!anyresult){
			...
			nores.innerHTML = TWPro.lang.NOSEARCHRESULT.replace('%2', '<br /><a href="javascript:" onclick="document.getElementById(\'twpro_searchinventory\').value=\'\';TWPro.twpro_searchInventory(true)">').replace('%3', '</a>').replace('%1', '<em>'+TWPro.lang.SLEEPYONLY+'</em>');
		}
		else if(nores){
	...
	function twpro_getBagPopup() {
		...
		twpro_xhtml += '<tr><td class="item_popup_trader_price">'+TWPro.lang.BAG+':&nbsp;&nbsp;<hr></td>';
		twpro_xhtml += '<td class="item_popup_trader_price">' + TWPro.twpro_bag.twpro_priceBag + ' $<hr></td></tr>';
		...
		twpro_xhtml += '<td class="item_popup_trader_price">' + TWPro.twpro_bag.twpro_priceYields + ' $<hr></td></tr>';
		...
		twpro_xhtml += '</table>';
		twpro_xhtml += '<DIV class="popup_yield_divider"></DIV><span class="item_popup_requirement_text"><hr>'+TWPro.lang.QUANTITIES+'<hr></span>';
		twpro_xhtml += '<table>';
		...
		twpro_xhtml += '<td class="item_popup_trader_price">' + TWPro.twpro_bag.twpro_countType['animal'] + '<hr></td></tr>';
		twpro_xhtml += '<tr><td class="item_popup_trader_price">'+TWPro.lang.NONYIELDS+':&nbsp;&nbsp;<hr></td>';
		...
		twpro_xhtml += '<td class="item_popup_trader_price">' + twpro_all + '<hr></td></tr>';
		twpro_xhtml += '<tr><td class="item_popup_trader_price">'+TWPro.lang.YIELDS+':&nbsp;&nbsp;<hr></td>';
		twpro_xhtml += '<td class="item_popup_trader_price">' + TWPro.twpro_bag.twpro_countType['yield'] + '<hr></td></tr>';
		twpro_xhtml += '<tr><td class="item_popup_trader_price">'+TWPro.lang.TOTAL+':&nbsp;&nbsp;</td>';
