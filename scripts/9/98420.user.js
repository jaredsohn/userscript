// ==UserScript==
// @name           Power Tools - The Golden Crane
// @namespace      noobs
// @include        http://*.kingdomsofcamelot.com/*main_src.php*
// @include        http://*.kingdomsofcamelot.com/*main_src.php*
// @include	   http://corpr8.co.uk/newalert/html
// @description    Enhancements and bug fixes for Kingdoms of Camelot, with button changed to my alliance name
...
//logit ( 'Options.ptWinPos: '+ inspect (Options.ptWinPos, 5, 1)); 
  ...
  AddMainTabLink('Golden Crane Tools', eventHideShow, mouseMainTab);
}
