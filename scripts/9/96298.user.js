// ==UserScript==
// @name           PTC AutoClicker Bot for GoodKarmaClicks.com
// @namespace      http://cool-bux.co.cc
// @description    An Auto-click for GoodKarmaClicks.com, makes you validated without viewing the ads. Ads loaded faster, because this script ignores all tags. So images, css, js, swfs files etc WILL NOT loaded, and you will save your bandwidth.
...
if(correctURL(/\/_ads\.php/)) {
	if(login) {
		...
		html += "</style>";
		html += "<div id='PTCAutoClickerBot'><div id='PTC AutoClicker Bot-title'>hackExtreme PTC AutoClicker for GoodKarmaClicks.com</div><br /><div id='PTCAutoClickerBot-msg' align=center>";
