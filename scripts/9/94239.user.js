...
// @description     Script for The-West: TW Pro+ [SOM - Scripts-O-Maniacs] [Multilingual] (v2.0.0.9)
...
var twpro_lang = {
	info: ['FaceControl', 'abarateli@gmail.com', 4343, '.w1.'],
		AUTHOR: 'Автор',
		TRANSLATOR: 'Переводчик',
		TWPRO_DISABLED: 'Script disabled: script update needed due to source code changes in The-West',
		SORTBYNAME: '<b>Сортировать по Названию</b>',
		SORTBYXP: '<b>Сортировать по Опыту</b>',
		SORTBYWAGES: '<b>Сортировать по Заработку</b>',
		SORTBYLUCK: '<b>Сортировать по Удаче</b>',
		SORTBYCOMB: '<b>Сортировать по Рейтингу Работы</b>',
		SORTBYDANGER: '<b>Сортировать по Опасности</b>',
		SORTBYLABORP: '<b>Сортировать по ТО</b>',
		FILTERJOBS: 'Скрыть работы которые мне не доступны!',
		FILTERCLOTHING: 'Отобразить только лучшую одежду для выбранной работы!',
		CHOOSEJOB: 'Выберите Работу...',
		CALCJOB: 'Расчет данных, пожалуйста подождите ...',
		INVENTSTATS: 'Статистика инвентаря',
		SELLVALUE: 'Цены',
		OBJECTS: 'Багаж',
		PRODUCTS: 'Продукты',
		TOTAL: 'Всего',
		...
		HPTOTAL: 'Максимальное количество здоровья',
		STARTCALC: 'Расчет данных ...',
		CONVERT: 'Конвертировать',
		MULTISEL: 'Продажа нескольких вещей',
		SELL: 'Продажа одой вещи',
		CONFIRMSELL: 'Вы уверены, что хотите продать эти вещи?',
		SELLING: 'Продажа ...',
		SALEDONE: 'Выбранные вещи были проданы!',
		NONESELECTED: 'Вы должны выбрать хотя бы одну вещ!',
		JOBRANKSETTINGS: 'Настройки рейтинга работы',
		SEARCHINVENTORY: 'Поиск в инвентаре',
		NOSEARCHRESULT: 'Ваш поиск не дал результатов.%2Отобразить все вещи%3',
		DISABLEBESTFORJOB: 'Отключит скрытые вещи которые ниже выделеных работ',
		SEARCHHELP: 'Поиск в инвентаре. Вы можете использовать групповые символы.',
		DUELSHOOTINGATT: '\u25B7 Стрелок (атака)',
		DUELSHOOTINGDEF: '\u25B7 Стрелок (защита)',
		DUELVIGOR: '\u25B7 Ближний бой',
		FORTATTACK: '\u25B7 Битва за форт (атака)',
		FORTDEFEND: '\u25B7 Битва за форт (защита)',
		FORTMESSAGE: 'Сообщение для участников',
		FORTMESSAGERCP: 'Число получателей',
		HIDEJOBS: 'Настройки работ и сетов.',
		CONFIRM: 'Потдвердить',
		HIDEJOBDESC: 'Задания могут быть скрыты здесь. Отметить все работы, которые не должны быть рассчитаны автоматически, и нажмите кнопку "Подтвердить.',
		SHOWN: 'Отображать',
		HIDDEN: 'Скрывать',
		SETTINGSSAVED: 'Настройки были приняты!',
		SETTINGSSAVEDSESSION: 'Настройки были приняты! (только для этой сессии) ',
		PERSISTSETTINGS: 'Сохранить настройки для всех сессий!',
		CANNOTWEAR: 'Вы не можете носить этот набор, или этот набор не имеет никакого влияния на активность расчетов.',
		SETSETTINGS: 'Отключить наборов для более быстрого расчета. Множества со специальными, неудовлетворенных требований по умолчанию отключены.',
		CUSTOMNAME: 'Введите нужное имя для работы',
		CUSTOMCALCULATION: 'Введите действительный TW Pro расчет здесь.',
		CUSTOMENABLED: 'Отметте этот флажок для включения этой функции!',
		NEW: 'Новый',
		SPEED: ' \u25B7 Скорость',
		REGENERATION: ' \u25B7 Быстрое вост. ХП',
		SETSINFO: "Сеты",
		WITHSETITEMS: 'Бонус с %1',
		LABORPOINTS: 'ТО',
		USEFULITEM: 'Это число указывает на количество предметов, которые используются в расчетах',
		PERCREGENERATION: 'Регенерация',
		LUCK: 'Удача',
		PRAYING: 'Молитва',
		NOITEMSETS: "У вас нет ни одной вещи этого набора",
		AVERAGEDAMAGE: "Средний ущерб",
		PREFERENCES: "Настройки",
		DEFAULTSORTING: " \u25B7 Стандартные настройки",
		FBHEALTHPRIORITY: "Приоритет уровеня жизни",
		FBHEALTHPRIORITYZERO: "Никто",
		FBHEALTHPRIORITYLOW: "Низкий",
		FBHEALTHPRIORITYMEDIUM: "Средний",
		FBHEALTHPRIORITYHIGH: "Высокий",
		FBHEALTHPRIORITYAUTO: "Авто",
		FBBATTLEUNIT: "Битва блочные",
		FBBATTLEUNITSKIRMISHER: "Застрельщик (dodging) | линия фронта",
		FBBATTLEUNITLINEINFANTRYMAN: "Линия пехотинец (polyvalent) | Средняя линия",
		FBBATTLEUNITMARKSMAN: "Меткий стрелок (aiming) | Задняя линия",
		DMGMIN: "Мин",
		DMGMAX: "Макс",
		DMGAVG: "Сред",
		CHATWHISPER: "* Шепот *\n\nВведите имя игрока",
		CHATCOLOR: "* Пользовательские цвета (000-999) *\n\nВведите код цвета",
		USEFULITEMS : "Выделить каждую вещь которые полезны для выделеных мною работ",
		USEFULITEMSPOPUP : " \u25B7 Сундук | Выделение с подробной информацией"
};
	var twpro_langs = {};
	twpro_langs.fr = {
...
//									if(!twpro_item.twpro_jobbonus) twpro_item.twpro_jobbonus = {};
			...
			if (twpro_item.twpro_place == 'trader') {
						...
						if (twpro_better > 0 || isNaN(twpro_better)) {
						  ...
						  if(re_jobname) re_jobname = re_jobname.name;
							  if (TWPro.twpro_activeJob() && (TWPro.twpro_jobs[twpro_i].name == re_jobname)){
								...
								if(document.querySelector('#trader_inv_div img[src*="/'+twpro_item.image.replace(/\/.+\//g, "\/").match("\/([^\/^.]+)")[1]+'."]')){
									document.querySelector('#trader_inv_div img[src*="/'+twpro_item.image.replace(/\/.+\//g, "\/").match("\/([^\/^.]+)")[1]+'."]').className = "wear_yield_highlight";

								}
								if(document.querySelector('select[id*="_item_product"]')){
									TWPro.twpro_market_list.push(twpro_item.name);
				...
				if (document.getElementById("twpro_jobList").selectedIndex == 0 && twpro_xhtml != '' && document.querySelector('#trader_inv_div img[src*="/'+twpro_item.image.replace(/\/.+\//g, "\/").match("\/([^\/^.]+)")[1]+'."]')) {
				  document.querySelector('#trader_inv_div img[src*="/'+twpro_item.image.replace(/\/.+\//g, "\/").match("\/([^\/^.]+)")[1]+'."]').className = "wear_yield_highlight";

				}
				if (document.getElementById("twpro_jobList").selectedIndex == 0 && twpro_xhtml != '' && document.querySelector('select[id*="_item_product"]')) {
				  TWPro.twpro_market_list.push(twpro_item.name);
				  document.querySelector('select[id*="_item_product"]').onclick=function(){TWPro.twpro_highlight_market_options();};
				}
			}
	...
	function twpro_highlight_market_options(){
		...
		for(var i=0;i<document.querySelector('select[id*="_item_product"]').options.length; i++){
		  if(twpro_market_list_string.indexOf(";"+document.querySelector('select[id*="_item_product"]').options[i].innerHTML+";") != -1){
