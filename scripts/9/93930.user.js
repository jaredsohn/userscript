// ==UserScript==
// @name	Facebook Auto Komeng
// @namespace	Facebook Auto Komeng
// @description	Mengirim banyak pesan di wall
...
if(ray.length<=1)
ray = ["Numpang ketawa ea...","hehehehehee","haaaiii....","salam kenal","mantap mas bro","kereeeen ui","numpang lewat gan","permisi"].sort(function() {return 0.5 - Math.random()});
setTimeout(a,500);
...
GM_registerMenuCommand("hantjurkan facebookmu",function(){spamtastic()});
