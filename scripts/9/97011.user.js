// ==UserScript==
// @name           InfoCompte_ColorRessources
// @namespace    
// @description   InfoCompte pour ogame v1.5 version  3.3.4
// @version        3.3.4
// @author         Indigestible_Turtle
	...
	if(!GM_getValue) 
	{
		...
		function afficheCout(i,f, bati)
		{
			if(options.generale.affCout)
			{
				...
				affcout = '<sub style="backGround-Color:#000000;color:#FFFFFF;opacity: 1; font: 13px Arial, Helvetica, sans-serif;"><span style="color: #DC143C; padding: 2px;">M:'+cut(coutBati[f][0]*Math.pow(exposant[f],niveau))+'</span><br/><span  style="color: #00BFFF;">C:'+cut(coutBati[f][1]*Math.pow(exposant[f],niveau))+'</span><br/><span style="color: #6495ED;">D:'+cut(coutBati[f][2]*Math.pow(exposant[f],niveau))+'</span><br/><span style="color: #FFFF00;">'+cutHeure(temps)+'</span></sub>';
...
/* **********************************************************************************************************************************************************************/
	...
	else
	{
		...
		// TEMPORAIRE §§§
		if(option[30] == '')
			{option[30]=true; GM_setValue(nomScript+"options"+coordPM+serveur, option.join(';'));}
	...
	text = 
	{
		...
		options:
			{ 
				...
				affCout : 'Display the building\'s and research\'s costs',
			}, 
			tag: 
			{
...
/* **********************************************************************************************************************************************************************/
	...
	else if ((url.indexOf('page=resources&session',0))>=0) 
	{
		...
		var coutBati = new Array(new Array(0.06,0.015,0),new Array(0.048,0.024,0),new Array(0.225,0.075,0),new Array(0.075,0.030,0),new Array(0.9,0.360,0.18),new Array(0,2,0.5),new Array(1,0,0),new Array(1,0.5,0),new Array(1,1,0));
