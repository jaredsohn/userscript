...
Add option to immediode related to stretching, lefately go to the popup search result if there is only one
...
Where possible, let css changes to the home page be fluid so resizing the browser doesn't screw things up
	Also, just double check all the ct aligning etc
