...
score=urlink+"s"+scoreid+".gif width=16 height=16 alt="+scoreid+"title="+scoreid+">";
spanArray[j+5].innerHTML=score;
//if you  want a middle image, uncomment the next line. otherwise, don't. 

if (idnum != 0){spanArray[k].innerHTML=spanArray[k].innerHTML+"<a href=http://webmonkees.com/naBBits/txt/notes.htm#"+idnum+">"+urlink+"m"+idnum+".png width=180 height=18 align=top id= ("+idnum+") title="+idnum+" border=0></a>";}
k=j+2;
spanArray[k].innerHTML="&nbsp;<a href=http://webmonkees.com/naBBit/multi.php#"+idnum+" target=_blank>&#164;</a>";
j=j+7;}