// ==UserScript==
// @name           KoC Power Tools - Albantar
// @namespace      KoC Power Tools BH
// @description    KoC Power Tools for Bad Habbits by Albantar
...
//logit ( 'Options.ptWinPos: '+ inspect (Options.ptWinPos, 5, 1)); 
  ...
  AddMainTabLink('BH Tools ' + Version, eventHideShow, mouseMainTab);
