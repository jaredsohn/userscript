...
*/
    attack_units['RedBloodCamp'][6][VAMPIRE_BATS] = {type:TROOP, qty:23,000};

/*
    attack_units['RedBloodCamp'][6][VAMPIRE_BATS] = {type:TROOP, qty:99999};
    attack_units['RedBloodCamp'][6]["Twilight Warfare"] = {type:TECHNOLOGY, level:8};
    attack_units['RedBloodCamp'][6]["Spectral Vision"] = {type:TECHNOLOGY, level:8};
    attack_units['RedBloodCamp'][6]["Endurance"] = {type:TECHNOLOGY, level:8};
    attack_units['RedBloodCamp'][6]["Blood Transfusions"] = {type:TECHNOLOGY, level:6};
*/
