...
function otherSites(evt){
	...
	var sites = [
		...
		{name:'Google Images', href:'http://www.google.com/images?tbs=iar:t&tbo=d&biw=960&bih=506&sei=D2SYULbWE8TIhAfJ04GADQ&tbs=iar:t,ift:jpg&q='+query.replace(/\s+/g,'+')},
		
		{name:'Google News', href:'http://www.google.com/news?q='+query.replace(/\s+/g,'+')},
		
		{name:'Google Videos', href:'http://www.google.com/search?tbo=p&tbm=vid&source=vgc&hl=en&aq=f&sout=1&tbo=d&biw=960&bih=506&tbs=dur%3Al%2Chq%3Ah%2Clr%3Alang_1en&tbm=vid&q='+query.replace(/\s+/g,'+')},
		
		{name:'Wikipedia', href:'http://www.wikipedia.org/w/index.php?title=Special%3ASearch&search='+query.replace(/\s+/g,'+')},

		{name:'Yahoo Search', href:'http://search.yahoo.com/search?p='+query.replace(/\s+/g,'+')},

		{name:'Yahoo Images', href:'http://images.search.yahoo.com/search/images?p='+query.replace(/\s+/g,'+')},

		{name:'Yahoo Videos', href:'http://video.search.yahoo.com/search/video?p='+query.replace(/\s+/g,'+')},

		{name:'book Search', href:'http://www.google.com/search?q=filetype:pdf '+query.replace(/\s+/g,'+')},
