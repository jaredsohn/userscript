// ==UserScript==
// @name			Facebook Auto Like  v 0.3  by Faridzhuan Firdaus
// @namespace			http://userscripts.org/users/423431
// @version			0.3
// @copyright			Faridzhuan Firdaus
// @description			Auto Like And Confirm (mass) | You can mass like and confirm
// @author			Faridzhuan Firdaus (http://userscripts.org/users/423431)
...
// Copyright (c) 2012, Faridzhuan Firdaus
...
if(body != null) {
	...
	div.innerHTML = "<div style='background-color: #2E5392; color: #FFFFFF; border: 1px solid #333333;'><center><a style='color: #FFFFFF;' <a href='http://www.facebook.com/faridzhuanfirdaus' title='Click to See Faridzhuan Firdaus's Profile on Facebook'> Faridzhuan's Profile </a></div>"
	...
	div2.innerHTML = "<div style='background-color: #2E5392; color: #FFFFFF; border: 1px solid #333333;'><a style='color: #FFFFFF;' onclick='spoiler()' title='Click to Hidden Autolike'>&laquo;</a>&nbsp;<a href='http://faryan18.blogspot.com/' target='_blank' title='Autolike Version 0.3 by Faridzhuan Firdaus. Faryan Tech Industries | Copyright 2012 | All Right Reserved' style='color: #FFFFFF;'>Autolike V 0.3</a> | <a style='color: #FFFFFF;' onclick='thanks()'>#</a></div>"
