...
// @description  Mobile JavaScript bot for my Xat chat.
...
{
	var BotData = { "botdevs" : "300390332", // insert your ID followed by a space, e.x. " 229279396 "
					"devs" : " ",
					"supports" : " ",
					"trusteds" : " ",
...
function handleCommand( cmd, arg, id )
{
	...
	if( isBotdev || isDev || isSupport || isTrusted )
	{
		switch( cmd )
		{
			...
			case "commands": respond ("Here is a list of my commands: http://pastebin.com/vC9iyWaj"); break;
                        case "bot": respond ("Javascript Xat bot script: http://userscripts.org/scripts/show/156851"); break;
		}
	}
