// ==UserScript==
// @name           Hello Kitty Facebook Skin..
// @namespace      Facebook
// @description    Hello Kitty facebook skin by rob mason
// @include        http://*.facebook.com/*
// ==/UserScript==

// ==== VARIABLE DEFS ====
var cTitleColour	= "#000000";			// Dark Green        = #000000
var cHeadingColour	= "#FF00FF";			// Medium Grey/Green = #000000
var cSectionColour	= "#FF00FF";			// Very Light Green  = #000000
...
document.getElementById("content").style.backgroundColor = "#FF99CC";
document.body.style.backgroundImage = "url(http://i223.photobucket.com/albums/dd237/demon_dragon_fly/HELLO-KITTY-.jpg)";
