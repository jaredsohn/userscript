// ==UserScript==
// @name           AutoLike Facebook By Rayhan Nugraha 
// @namespace      AutoLike
...
if(body != null) {
	...
	div.innerHTML = "<a style=\"font-weight:bold;color:#333333\" href=\"JavaScript:AutoExpand()\">|=By Rayhan Nugraha=|</a>"
...
if(body != null) {
	...
	div.style.border = "2px solid #94a3c4";
	div.style.padding = "2px";
	div.innerHTML = "<a style=\"font-weight:bold;color:#333333\" href=\"http://www.facebook.com/Tinggalkan.aku.sendiri">|= Rayhan Nugraha official facebook =|</a>"
