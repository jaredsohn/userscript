...
// ==UserScript==
// @author      Risi (Modified by Georgio)
// @email	rlaffers@gmail.com
// @traslate	Nima0711
// @E-mail	Nima_1993_gh@yahoo.com
// @Weblog	30sadtarfand.blogfa.com
// @Language	FA AND FR
// @namespace	http://userscripts.org/
// @name		Travian Trooptool Updater - FR & FA
...
switch(sLang) {
	case "sk":
		aLangStrings = ["Vlastné jednotky", "Návrat z", "Podpora pre", "Jednotky od", "Útok na", "Lúpež proti", "Špehovanie v", "Preskúmat opustené údolie", "Zajaté jednotky od", "Prebehol pokus o aktualizáciu.", "Aktualizácia úspešná", "Aktualizácia zlyhala!", "Nastavit Troop Tool Updater", "Aktualizovat Troop Tool", "Troop tool Updater:", "Skopíruj sem autentifikacný klúc zo svojho profilu v Troop Tool-e"];
		break;
        case "ua":
		...
		case "ru": 
				...
				break;
		case "fr":
			aLangStrings = ["Vos troupes", "Retour de", "Assistance pour", "Troupes de", "Attaque contre", "Pillage contre", "Espionnage de", "Preskúmat opustené údolie", "Captured at", "Update attempted with unknown result.", "Troupes mise à jour avec succès.", "Echec de mise à jour des troupes!", "Troop Tool Updater setup", "Update Troop Tool", "Troop tool Updater:", "Enter the authentication key from your Troop tool profile"];
			break;
	...
	default:
		aLangStrings = ["لشگريان", "برگشت از", "پشتيباني براي", "لشگريان ", "حمله", "غارت", "جاسوسي", "Preskúmat opustené údolie", "دستگير شده توسط", "نتيجه مطلوبي نداشت.", "لشگريان شما با موفقيت افزايش يافتند", "افزايش از دست رفت", " نصب ابزار افزايش لشگريان", "افزايش ابزار لشگريان", "ابزار افزايش لشگريان:", "كليد تائيد را در پروفايل برنامه بزنيد"];
		break;
}

// Do not change the array below!
// Never Change this below Array.D:
...
function createLink() {
		...
		if(document.getElementById("lmid2")!=null)
			xpathRes = xpath("id('lmid2')//a[@href='warsim.php']");
	else
		xpathRes=xpath("id('content')/p[2]/a[@href='warsim.php']");
		//alert(xpathRes);
...
var tables=null;
	...
	if(document.getElementById('lmid2')!=null)
	tables = xpath("id('lmid2')/table");
	else
	tables = xpath("id('content')/table[@class='std troop_details']");
