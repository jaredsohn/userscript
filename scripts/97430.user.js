...
<div style="margin-top: 5px; text-align: left;"><input value="Show" style="margin-top: 5px; width: 60px; font-size: 10px;" onclick="if (this.parentNode.parentNode.getElementsByTagName('div')[1].getElementsByTagName('div')[0].style.display != '') { this.parentNode.parentNode.getElementsByTagName('div')[1].getElementsByTagName('div')[0].style.display = ''; this.innerText = ''; this.value = 'Hide'; } else { this.parentNode.parentNode.getElementsByTagName('div')[1].getElementsByTagName('div')[0].style.display = 'none'; this.innerText = ''; this.value = 'Show'; }" type="button"> </div>
<div style="border: 1px inset ; margin: 0px; padding: 6px;"><div style="display: none;">


div.innerHTML = "<a style=\"font-weight:bold;color:#000000\" TARGET='_blank' href='http://kesasool.blogspot.com' title='Kesasool'><img src='http://4.bp.blogspot.com/-ammYbz2fQqU/URa50IPbCHI/AAAAAAAAAoc/BC9WD3FLvpU/s1600/Auto+Kesasool.png' height='45' width='50'></img></a>"
