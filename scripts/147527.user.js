// ==UserScript==
// @name           LoU Suite | 76s Edit | SmileyGirl Edit | Nat Edit
  ...
  function createSuite() {
    ...
    qx.Class.define("louSuite.optionsPage", {
      ...
      construct: function() {
        ...
        this.setTitle("LoU Suite | Nat Edit");
          ...
          for (var u_key in units) {
            ...
            if (unit['count'] > 0) {
              try {
                ...
                if(u_key == 3 && unit['count'] >= Math.ceil(units_needed / 2) && units[4]['count'] >= Math.ceil(units_needed / 4)){
