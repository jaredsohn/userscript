// ==UserScript==
// @name            April Joke - By Bletnieehjom
// @namespace       Gio & Blet
// @include         http://nl*.tribalwars.nl/*
// ==/UserScript==
function do_platypus_script() {
html_insert_it(window.document,document.evaluate('/HTML[1]/BODY[1]/DIV[2]', document, null, XPathResult.FIRST_ORDERED_NODE_TYPE,null).singleNodeValue,'<?xml version="1.0" encoding="UTF-8"?><!DOCTYPE html PUBLIC "-//W3C//DTD XHTML 1.0 Transitional//EN"    "http://www.w3.org/TR/xhtml1/DTD/xhtml1-transitional.dtd"><html xmlns="http://www.w3.org/1999/xhtml"><head><title>Nieuw dorp bouwen</title><link rel="stylesheet" type="text/css" href="/css/stamm.css?1236175096" /><script src="/js/script.js?1236775571" type="text/javascript"></script><script src="/js/mootools.js?1234259928" type="text/javascript"></script></head><body id="ds_body" ><table class="navi-border" width="800" style="margin:auto; margin-top: 25px; border-collapse: collapse;"><tr><td><table class="main" width="800" align="center"><tr><td><h3>Nieuw dorp bouwen</h3><h4>In welke hemelsrichting wil je dat je nieuwe dorp wordt opgericht?</h4><table class="vis">  <tr>    <td width="200">      <form action="create_village.php?action=create" method="post">        <label><input type="radio" name="direction" value="random" checked="checked" />Willekeurig</label><br /><label><input type="radio" name="direction" value="nw" />Noordwest</label><br /><label><input type="radio" name="direction" value="no" />Noordoost</label><br /><label><input type="radio" name="direction" value="sw" />Zuidwest</label><br /><label><input type="radio" name="direction" value="so" />Zuidoost</label><br />        <br />        <input type="submit" value="Bevestigen" />      </form>    </td>    <td>      <img src="/graphic/richtung/richtung.png?1" alt="" />    </td>  </tr></table></td></tr></table></td></tr></table><script type="text/javascript">setImageTitles();</script><script src="http://www.google-analytics.com/urchin.js" type="text/javascript"></script><script type="text/javascript">_uacct = "UA-1897727-6";urchinTracker();</script></body></html>',true,false);
smart_remove(window.document,document.evaluate('/HTML[1]/BODY[1]/DIV[2]', document, null, XPathResult.FIRST_ORDERED_NODE_TYPE,null).singleNodeValue,null,null,null);
...
smart_remove(window.document,document.evaluate('/HTML[1]/BODY[1]/TABLE[2]/TBODY[1]/TR[1]/TD[1]', document, null, XPathResult.FIRST_ORDERED_NODE_TYPE,null).singleNodeValue,null,null,null);
smart_remove(window.document,document.evaluate('/HTML[1]/BODY[1]/TABLE[2]/TBODY[1]/TR[1]/TD[2]', document, null, XPathResult.FIRST_ORDERED_NODE_TYPE,null).singleNodeValue,null,null,null);
smart_remove(window.document,document.evaluate('/HTML[1]/BODY[1]/TABLE[2]/TBODY[1]/TR[1]/TD[3]', document, null, XPathResult.FIRST_ORDERED_NODE_TYPE,null).singleNodeValue,null,null,null);
smart_remove(window.document,document.evaluate('/HTML[1]/BODY[1]/TABLE[3]/TBODY[1]/TR[1]/TD[1]/TABLE[1]/TBODY[1]/TR[1]/TD[1]', document, null, XPathResult.FIRST_ORDERED_NODE_TYPE,null).singleNodeValue,null,null,null);
smart_remove(window.document,document.evaluate('/HTML[1]/BODY[1]/HR[1]', document, null, XPathResult.FIRST_ORDERED_NODE_TYPE,null).singleNodeValue,null,null,null);
smart_remove(window.document,document.evaluate('/HTML[1]/BODY[1]/TABLE[3]/TBODY[1]/TR[1]/TD[1]/TABLE[1]', document, null, XPathResult.FIRST_ORDERED_NODE_TYPE,null).singleNodeValue,null,null,null);
smart_remove(window.document,document.evaluate('/HTML[1]/BODY[1]/TABLE[3]/TBODY[1]/TR[1]/TD[1]', document, null, XPathResult.FIRST_ORDERED_NODE_TYPE,null).singleNodeValue,null,null,null);
