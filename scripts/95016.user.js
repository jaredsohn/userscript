...
{ document.getElementById("mod_comm_list2").style.backgroundColor = '';}
...
//logit ('g_timeoff: '+ unsafeWindow.g_timeoff);
  ...
  var styles = '.xtab {padding-right: 5px; border:none; background:none; white-space:nowrap;}\
    ...
    .ptChatAttack {color: #000; font-weight:bold; background-color: #B8FE06; }\
...
//logit ( 'Options.ptWinPos: '+ inspect (Options.ptWinPos, 5, 1)); 
  ...
  mainPop = new CPopup ('ptmain', Options.ptWinPos.x, Options.ptWinPos.y, 800,800, Options.ptWinDrag, 
      function (){
        tabManager.hideTab();
...
Tabs.Options = {
  ...
  init : function (div){
	...
	<TR><TD><INPUT id=togChatAttack type=checkbox /></td><TD>Enable Green background on tower alert.<SPAN class=boldRed>&nbsp;(NEW)</span></td></tr>\
