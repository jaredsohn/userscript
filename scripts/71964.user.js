// ==UserScript==
// @name         Bandenprofil Deluxe  PG 4.0 alle versionen
// @namespace    by basti1012 & Updated by niceguy0815 (visit http://pennerhack.forren-city.de) fuer alle by Boggler
// @description  Zeigt alles an was man wissen muss wenn man bei einer Bande auf das Profil geht. Zeigt Premiumtiere, Premiumplayer und gel�schte Penner an. 
// @version	 2.8
...
try{
if (url.indexOf("clodogame")>=0) {
     var location1 = content.split('Arrondissement</strong><')[1];
