// ==UserScript==
// @name MWaddon
// @namespace http://userscripts.org/scripts/show/115547
// @version 0.0.0.3 A$$
// @description http://userscripts.org/topics/new?script_id=115547
// @copyright 2011 - ISEEU
...
var MWAddonInfo = {
    ...
    url             : 'http://userscripts.org/scripts/show/115547',
    meta_url        : 'http://userscripts.org/scripts/source/115547.meta.js',
...
var helpToolTips = {
    ...
    'de_DE': {
        ...
        'homefeedcenter_popup': {
            ...
            'feedstream_dohitlistbounty_filter': 'Hitlist Bounty<br>Hinzufügen von Spielern mit klick auf den "Add" Knopf.<br>Entfernen eines Spielers, Eintrag auswählen und mit klick auf "Remove" entfernen.',
            ...
            'feedstream_dosecretstash_filter': 'Secret Stash<br>Hinzufügen von Spielern mit klick auf den "Add" Knopf.<br>Entfernen eines Spielers, Eintrag auswählen und mit klick auf "Remove" entfernen.',
            ...
            'feedstream_docitycrew_filter': 'City Crew<br>Hinzufügen von Spielern mit klick auf den "Add" Knopf.<br>Entfernen eines Spielers, Eintrag auswählen und mit klick auf "Remove" entfernen.'
        }        
    }
...
function createMenu() {
    ...
    var defaultRootMenu = [
        ...
        {name:'-',                                                                                                 'line' : true             },
        {name:'<center><div style="color: green;">D&C Chat <img src="http://mwfb.static.zgncdn.com/mwfb/graphics/clan_chat/clantools_chat_greennotif_sm.png" height=14 /></center></div>',        'click': FanPage,        'main': true               },
        {name:'<center><div style="color: green;">D&C Ice Wall <img src="http://mwfb.static.zgncdn.com/mwfb/graphics/clan_chat/clantools_chat_greennotif_sm.png" height=14 /></center></div>',        'click': EMI,        'main': true               },
        {name:'-',                        'line' : true                                      },
        {name:'<img src="http://userscripts.org/images/script_icon.png" height=16 /> Daily/E-mail Bonus',        'click': DailyBonus,        'main': true               },
        ...
        {name:'<img src="http://userscripts.org/images/script_icon.png" height=16 /> Chucker V5.1',          'click': Chucker                                    }
    ];
    /**
     * Root Menu Container
     */
...
function FanPage() {
unsafeWindow.open('http://www.facebook.com/groups/127940560594565/');
}
function unframe() {
    unsafeWindow.open('http://facebook.mafiawars.zynga.com/mwfb/index.php?skip_req_frame=1&mwcom=1');
}
function EMI() {
unsafeWindow.open('http://www.facebook.com/pages/Destroy-Conquer-Icing-Area-/138575946168339');
}
