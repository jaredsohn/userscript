// ==UserScript==
// @name        The West - Kolekcjoner setow by 0ndra
...
(function(func) {
    ...
    var TW_Sets = [{
           ...
           // name: "TW-Times set",
            ...
            name: "zestaw Opery Mydlanej",
            items: [41019, 42007, 11181, 481, 40048, 10192]
        }, {
            name: "zestaw Paradny Christophera",
            items: [41020, 42008, 11182, 482, 40049, 10193]
        }, {
            name: "zestaw Lesnego Maga",
            items: [185151, 185152, 185148, 185150, 185149, 185147]
        }, {
            name: "zestaw / bronie Willa Munnyego",
            items: [41028, 42016, 11190, 490, 40057, 10201, 895, 87, 183]
        }, {
            name: "zestaw / bronie Jeremiaha Johnsona",
            items: [41029, 42017, 11191, 491, 40058, 10202, 896, 88, 184]
        }, {
            name: "zestaw / bronie Elfego Baca",
            items: [41030, 42018, 11192, 492, 40059, 10203, 897, 89, 185]
        }, {
            name: "zestaw Niepodleglosci",
            items: [41032, 42020, 11193, 494, 40061, 10205, 661, 2301]
        }, {
            name: "zestaw / bronie Franka Eatona",
            items: [41033, 42021, 11195, 495, 40063, 10206, 899, 91, 187]
        }, {
            name: "zestaw / bronie Georgea McJunkina",
            items: [41034, 42022, 11196, 496, 40064, 10207, 900, 92, 188]
        }, {
            name: "zestaw / bronie Kinga Fishera",
            items: [41035, 42023, 11197, 497, 40065, 10208, 901, 93, 189]
        }, {
            name: "Tradycyjny Stoj Bawarski",
            items: [41036, 42024, 11198, 498, 40066, 10209, 663, 2363]
        }, {
            name: "zestaw Preriowy",
            items: [42025, 41037, 40067, 499, 11199, 10210]
        }, {
            name: "zestaw Koszmaru",
            items: [41044, 42032, 40074, 10217, 11206, 43006]
        }, {
            name: "Ogien i Lod",
            items: [90, 186]
        }, {
            name: "Grzmot i Piorun",
            items: [902, 190]
        }, {
            name: "zestaw Poszukiwacza Przygod",
            items: [41040, 42028, 40070, 11202, 10213, 43002]
        }, {
            name: "zestaw Zawadiaki",
            items: [41041, 42029, 40071, 11203, 10214, 43003]
        }, {
            name: "zestaw Robotnika",
            items: [41042, 42030, 40072, 11204, 10215, 43004]
        }, {
            name: "zestaw Zolnierza",
            items: [41043, 42031, 40073, 11205, 10216, 43005]
        }, {
            name: "zestaw Konfederatow",
            items: [41038, 42026, 40068, 11200, 10211, 43000]
        }, {
            name: "Nienazwany zestaw",
            items: [41039, 42027, 40069, 11201, 10212, 43001]
        }, {
            name: "Zimowe ubrania / wyposarzenie",
            items: [41200, 42201, 40202, 10261, 11273, 43200, 905, 191, 667, 2539, 97]
        }, {
            name: "Uroczy zestaw",
            items: [11277, 42205, 40206, 43204, 10303, 41205]
        }
    ];

    var TW_QuickSearch = new Object();
    TW_QuickSearch.name = "Kolekcjoner setow by 0ndra";
    TW_QuickSearch.gui = {};
    ...
    TW_QuickSearch.popup = function(button, e) {
        if (!TW_QuickSearch.gui.popupMenu) {
            TW_QuickSearch.gui.popupMenu = new west.gui.Selectbox().setWidth(275);
