// ==UserScript==
// @name          Gizmonic Institute's Lab Assistant (for SB)
...
function apt_res_create_box() {
	...
	researchDiv.style.cssText = 'position: absolute; top: 2px; right: 10px; z-index: 10; background: transparent url(images/spybattle_stats_bg.gif); padding: 23px 3px 3px 25px; color: #FFFF66; width: 147px; height: 164px; font-size: 11px; margin: 3px;';
