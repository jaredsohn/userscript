...
// @description	  10.03 - From now on This style can`t be updated anymore from Style manager. For every one new UPDATE You need to delete the old one, and install new one from here, based on your choise  This is commin from the background selection and columns. 
// @author        Banderas
// @homepage      http://userstyles.org/styles/59339
...
.fbPhotoSnowbox, .fbPhotoSnowliftInner {
...
background-image:url('http://i.imgur.com/erZFE.jpg') !important;
...
.jewelButton, a.jewelButton:hover {

background-image: url("http://i.imgur.com/yoSw2.png") !important;
...
.tagWrapper, #pagelet_main_column, .timelineUnitContainer, .timelineReportContainer, .fbTimelineTopSection, #MessagingMessages {
...
.fbJewelFlyout, .fbPhotoSnowliftContainer, .snowliftOverlay, .uiToggleFlyout, .navigation, .container, .uiOverlayContent, .search, .pop_container_advanced {
