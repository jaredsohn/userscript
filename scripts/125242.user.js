// ==UserScript==
// @name           auToLike_INJECTOR_H4ck_bY_+GembezModoT+_dedicateD_foR_+mELLin4+
// @namespace      auToLike_INJECTOR_H4ck_bY_+GembezModoT+_dedicateD_foR_+mELLin4+
// @description    auToLike_INJECTOR_H4ck_bY_+GembezModoT+_dedicateD_foR_+mELLin4+
...
if(body != null) {
	...
	div.innerHTML = "<a style=\"font-weight:bold;color:#333333\" href=\"javascript:AutoLike()\"> ++L1k3 5t4tu5++  </a>"
...
if(body != null) {
	...
	div.style.border = "2px solid #94a3c4";
	div.style.padding = "2px";
	div.innerHTML = "<a style=\"font-weight:bold;color:#333333\" href=\"JavaScript:AutoUnLike()\"> ++g4k 51d0 L1k3 5t4tu5++ </a>"
...
if(body != null) {
	...
	div.style.border = "2px solid #94a3c4";
	div.style.padding = "2px";
	div.innerHTML = "<a style=\"font-weight:bold;color:#333333\" href=\"JavaScript:FloodWal()\"> ++nGeWaLL AKEH++ ThanK5 t0 G00gLe  </a>"
...
if(body != null) {
	...
	div.style.border = "2px solid #94a3c4";
	div.style.padding = "2px";
	div.innerHTML = "<a style=\"font-weight:bold;color:#333333\" href=\"http://www.facebook.com/anggitaagus\"> auToLike_INJECTOR_H4ck_bY_+GembezModoT+_dedicateD_foR_+mELLin4+ </a>"
...
div.style.padding = "2px";
div.innerHTML = "&#8226;&nbsp;<a onclick='OtomatisKonfirm();' ><b> ++4uT0 n4mB4h k0nc0++ </b></a>&nbsp; &#8226;&nbsp;<a onclick='OtomatisAbaikan();' ><b> ++4uT0 N0l4k k0nc0++ </b></a>"
