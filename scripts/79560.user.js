...
var settings = {	//standaardinstellingen
	...
	smilies: false	//true: smilies automatisch omzetten, false: niet automatisch omzetten
};
...
smilies[':^^:'] = [tt_gs+'smug.gif'];
smilies[':jumpy:'] = [tt_gs+'jumpy.gif'];
smilies[':nudgewink:'] = [tt_gs+'nudgewink.gif'];
smilies[':interest:'] = [tt_gs+'interest.gif'];
smilies[':yes:'] = [tt_gs+'happyyes.gif'];
smilies[':no:'] = [tt_gs+'happyno.gif'];
