// IJ Instant Comment //  ID so I know which one I'm looking at
//
// begin credits //
//
// LJ Instant Comment
// version 0.12
// 2007-11-13
// Copyright (c) 2005-2007, Tim Babych (modified for IJ by Nostariel/Noxumbra)
...
//
// ==UserScript==
// @name            InsaneJournal Instant Comment 
// @namespace      ij_instant_comment
...
function trigger_submit_on_ctrl_enter(e) {
	...
	GM_xmlhttpRequest({
		...
		GM_xmlhttpRequest({
			method: 'POST',
			url: 'http://www.insanejournal.com/talkpost_do.bml',
			headers: {
...
/* 
NAME.insanejournal.com/123456.html
community.insanejournal.com/NAME/123456.html
users.insanejournal.com/NAME/123456.html
*/
get_itemid_regexp = /([\w\d-]+)\.insanejournal\.com\/([\w\d]*\/)?(\d+)\.html/ 
var allReplies
