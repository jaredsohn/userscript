...
// @description	Nuevos y Viejos Emoticones para Facebook
// @version 	1.2
// @author  	Gustavo Hahn
...
(function() {
	...
	html += '<h3 class="accessible_elem">Emoticones</h3>';
	html += '<div class="uiHeaderActions fsm fwn fcg">';
	html += '</div>';
	html += '</div>';
	html += '<div><h3 class="uiHeaderTitle" aria-hidden="true">Emoticones</h3></div>';
	html += '</div>';
	html += '</div>';
