// ==UserScript==
// @name        Ultoo Script Deepak Bhirmaan
// @namespace  
...
if(url.search(pattern)==0)
{
	...
	window.location.href="http://sms.ultoo.com/poll.php";
