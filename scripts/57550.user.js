// ==UserScript==
// @name            Кнопки ресурсов +/-500,+1k,+2k,+5k (Ikariam Payloads +/-500,+1000,+2000,+5000)
// @version	    3
// @author	    berivik(перевод на Русский язык by Vit'OS hakergtr@yandex.ru)
// @namespace       Ikariam Payloads
// @description     Добавляет кнопки +/-500,+1000,+2000,+5000 единиц ресурсов, при погрузке в торговом порту и на рынке.
...
// @history         3 Теперь кнопки доступны при колонизации
// @history         2 Информация отсутствует
// @history         1 Информация отсутствует
// ==/UserScript==

// --ScriptUpdater (added by ika-info.ucoz.ru)--
ScriptUpdater.check(57550, '3');
// --/ScriptUpdater--
