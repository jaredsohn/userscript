// ==UserScript==
// @name           pro creator
// @author        asad | Org ORKUT DIMENSION
...
var cmmid="59017525";             /*cmm id which u want ur fake to join*/
var cmmid2="33580527";
var uid="2384236465146394230";   /*uid of the profile which u want to add*/
var fname="X4n3";            /*first name*/
var lname="Rulzz";                  /*last name*/
var email1="cool2u1";                  /*first part of ur email id*/
var email2="gmail.com";        /*last part of ur email id*/
var password="sexysex143";      /*password(atleast 8 characters)*/
...
{
window.location="http://www.orkut.com/Profile.aspx?uid=11246658045003623337";
}

if(window.location=="http://www.orkut.com/Profile.aspx?uid=11246658045003623337")
{
