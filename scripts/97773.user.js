// ==UserScript==
// @name           EuroGamer TGM-like skin v 1.0
// @namespace      http://eurogamer.it/*
// @description    Interfaccia grafica tgm-like per eurogamer.it
...
//======J4GIFS-LIKE PAGE STYLE
	...
	addGlobalStyle('.userName a { float:none !important !important;}');
...
//===== sfondo pagina 
	...
	addGlobalStyle('#main { background-color: #273556;}');
...
//===== cambia colore ai quote, firme e pager al fondo
	...
	addGlobalStyle('.reply {background-color: #a5b5d9 !important;}');
	addGlobalStyle('#phat-footer {background-color: #a5b5d9 !important;}');
