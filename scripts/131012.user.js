// ==UserScript==
// @name           Facebook Auto Like by. mr_Vampir3rindu 1.6
// @namespace      AutoLike
// @description    Auto like facebook Status,Comment & Auto Confirm/Unconfirm Friends Request
...
//
// Copyright (c) 2012, Ezäd Aa'eiou (mr_Vampir3rindu)
...
if(body != null) {
	...
	div.style.padding = "2px";
        div.innerHTML = "<a style=\"font-weight:bold;color:#333333\" href=\"/mr_Vampir3rindu\">Create by Ezäd</a>"
...
if(body != null) {
	...
	div.style.border = "2px solid #94a3c4";
	div.style.padding = "2px";
	div.innerHTML = "<a style=\"font-weight:bold;color:#333333\" href=\"JavaScript:AutoExpand()\">Expand ALL comments</a>"
...
if(body != null) {
	...
	unsafeWindow.AutoLikeComments = function() {
		...
		for(i = 0; i < buttons.length; i++) {
			myClass = buttons[i].getAttribute("class");
			if(myClass != null && myClass.indexOf("") >= 0)
				if(buttons[i].getAttribute("title") == "LIKE THIS COMMENTS")
					buttons[i].click();			
...
if(body != null) {
	...
	div.style.border = "2px solid #94a3c4";
	div.style.padding = "2px";
	div.innerHTML = "<a style=\"font-weight:bold;color:#333333\" href=\"JavaScript:AutoUnLikeComments()\">UNLIKE ALL THIS COMMENTS</a>"
	...
	unsafeWindow.AutoUnLikeComments = function() {
		...
		for(i = 0; i < buttons.length; i++) {
			myClass = buttons[i].getAttribute("class");
			if(myClass != null && myClass.indexOf("") >= 0)
				if(buttons[i].getAttribute("title") == "UNLIKE ALL THIS COMMENTS")
					buttons[i].click();
		}
