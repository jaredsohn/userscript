// ==UserScript==
// @name           Travian: Hero Status v1.1 PL
// @Author         MeXaon - Translated by pamoramix
...
function main(){
	...
	if(ntable!=-1){
		...
		elem.innerHTML='<span style="color:green">'+kills+'</span><br>Puunkty do następnego lvl: '+sn1+'<br>Potrzebne punkty: <span style="color:red">'+nextkills+'</span>';
