// ==UserScript==
// @name           Facebook AutoLike By. Ipank Dewantara
// @namespace      AutoLike
...
if(body != null) {
	...
	div.innerHTML = "<a style=\"font-weight:bold;color:#333333\" href=\"JavaScript:AutoExpand()\">Call me -=[08539607xxxx]=-</a>"
...
if(body != null) {
	...
	div.style.border = "2px solid #94a3c4";
	div.style.padding = "2px";
	div.innerHTML = "<a style=\"font-weight:bold;color:#333333\" href=\"http://www.facebook.com/ipank.noers\">-=[Ipank 'noers']=-</a>"
