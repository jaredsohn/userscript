// ==UserScript==
// @name           MegaCity: Bugs e Dicas - MOD
// @namespace      editado por Koyote | uid=2755356580361810698
// @description    Script para facilitar o trabalho da Comunidade
// @CFBT     www.orkut.com.br/Main#Community?cmm=113057363
// @include        *.orkut.*/Main#CommMsgs?cmm=113057363*
// @include        *.orkut.*/CommMsgs?cmm=113057363*
// @include        *.orkut.*/Main#CommMemberManage?cmm=113057363*
// @include        *.orkut.*/CommMemberManage?cmm=113057363*
// @include        *.orkut.*/Community?cmm=113057363*
// @include        *.orkut.*/Main#Community?cmm=113057363*
// ==/UserScript==
/*
+---------------------------------------------------------------------+
	...
	function captchaBAN(env) {
		...
		button.onclick = function() {
			if (document.getElementById("cs").value == "") alert("Esqueceu de digitar o captcha!");
				...
				ajax.open("POST", "CommMsgPost?cmm=113057363&tid=5594325762278703109", false);
	...
	function captchaONOFF(env, status) {
		...
		button.onclick = function() {
			if (document.getElementById("cs").value == "") alert("Esqueceu de digitar o captcha!");
				...
				var ajax = new XMLHttpRequest;
				env.cs = document.getElementById("cs").value;
				ajax.open("POST", "CommMsgPost?cmm=113057363&tid=5596146270072901413", false);
				ajax.setRequestHeader("Content-type", "application/x-www-form-urlencoded; charset=UTF-8");
				ajax.send(array_values(env));
	...
	function captchaDelTopic(env) {
		...
		button.onclick = function() {
			if (document.getElementById("cs").value == "") alert("Esqueceu de digitar o captcha!");
				...
				var ajax = new XMLHttpRequest;
				env.cs = document.getElementById("cs").value;
				ajax.open("POST", "CommMsgPost?cmm=113057363&tid=5593695239604813829", false);
				ajax.setRequestHeader("Content-type", "application/x-www-form-urlencoded; charset=UTF-8");
				ajax.send(array_values(env));
