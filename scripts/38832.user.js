// ==UserScript==
// @name            Platypus-lifehacker.com/
// @namespace       Platypus
// @include         http://lifehacker.com/
// ==/UserScript==
function do_platypus_script() {
do_modify_html_it(window.document,document.evaluate('/HTML[1]/BODY[1]', document, null, XPathResult.FIRST_ORDERED_NODE_TYPE,null).singleNodeValue,/\n.*\<img.*metaIcon\"\>\n/gi,'',null);
do_modify_html_it(window.document,document.evaluate('/HTML[1]/BODY[1]', document, null, XPathResult.FIRST_ORDERED_NODE_TYPE,null).singleNodeValue,/\n.*\<a rel=\"nofollow\" id=\"tag_.*\" class=\"topTag\".*\<\/a\>\n/,'',null);
do_modify_html_it(window.document,document.evaluate('/HTML[1]/BODY[1]', document, null, XPathResult.FIRST_ORDERED_NODE_TYPE,null).singleNodeValue,/\n.*\<a rel=\"nofollow\".*\<\/a\>\n/gi,'',null);
do_modify_html_it(window.document,document.evaluate('/HTML[1]/BODY[1]', document, null, XPathResult.FIRST_ORDERED_NODE_TYPE,null).singleNodeValue,/\n.*\<div class=\"time\"\>\n.*\n.*\n.*\n.*\<\/div\>\n/gi,'',null);
do_modify_html_it(window.document,document.evaluate('/HTML[1]/BODY[1]', document, null, XPathResult.FIRST_ORDERED_NODE_TYPE,null).singleNodeValue,/\n.*\<div class=\"views\".*\n.*\n.*\<\/div\>\n/gi,'',null);
...
do_modify_html_it(window.document,document.evaluate('/HTML[1]/BODY[1]', document, null, XPathResult.FIRST_ORDERED_NODE_TYPE,null).singleNodeValue,/\n.*\<cite\>.*\<br\>\n/gi,'',null);
do_modify_html_it(window.document,document.evaluate('/HTML[1]/BODY[1]', document, null, XPathResult.FIRST_ORDERED_NODE_TYPE,null).singleNodeValue,/\n.*\<div.*class=\"views\".*\n.*\n.*\<\/div\>.*\n/gi,'',null);
do_modify_html_it(window.document,document.getElementById('wrapper'),/\n.*\<br\>\n.*\n.*\<p.*class=\"short_comment\"\>\n.*\<cite\>.*\<\/p\>\n/gi,'',null);
do_modify_html_it(window.document,document.evaluate('/HTML[1]/BODY[1]', document, null, XPathResult.FIRST_ORDERED_NODE_TYPE,null).singleNodeValue,/\n.*\<br\>.*\n.*\n.*short_comment.*\<\/p\>/gi,'',null);
do_modify_html_it(window.document,document.evaluate('/HTML[1]/BODY[1]', document, null, XPathResult.FIRST_ORDERED_NODE_TYPE,null).singleNodeValue,/\n.*\<br\>.*\n.*\n.*short_comment\"\>\n.*\n.*\<\/p\>.*\n/gi,'',null);
do_modify_html_it(window.document,document.evaluate('/HTML[1]/BODY[1]', document, null, XPathResult.FIRST_ORDERED_NODE_TYPE,null).singleNodeValue,/\n\<li.*class=\"post postBigPic bordered\" id=\"id_.*\"\>.*\n/gi,'',null);
remove_it(window.document,document.getElementById('header'),null,null,null);
remove_it(window.document,document.getElementById('header_container'),null,null,null);
remove_it(window.document,document.getElementById('sidebar'),null,null,null);
do_modify_html_it(window.document,document.evaluate('/HTML[1]/BODY[1]', document, null, XPathResult.FIRST_ORDERED_NODE_TYPE,null).singleNodeValue,/\n.*\<a href=\".*class=\"super-permalink spimage\" title=\".*\"\>\<img platypus-background-color=\"\" style=\"\" src=\".*\" class=\"bigpic\".*\<\/a\>.*\n/gi,'',null);
relax(window.document,document.getElementById('content'),null,null,null);
do_modify_html_it(window.document,document.evaluate('/HTML[1]/BODY[1]', document, null, XPathResult.FIRST_ORDERED_NODE_TYPE,null).singleNodeValue,/.*<a.*class=\"super-permalink spimage\" title=\".*\"\>\<img.*\<\/a\>.*\n/gi,'',null);
do_modify_html_it(window.document,document.evaluate('/HTML[1]/BODY[1]', document, null, XPathResult.FIRST_ORDERED_NODE_TYPE,null).singleNodeValue,/.*\<a.*class=\"topTag\".*\<\/a\>/gi,'',null);
do_modify_html_it(window.document,document.getElementById('wrapper'),/.*<a.*class=\"topTag condensedTag\".*\<\/a\>.*\n/gi,'',null);
do_modify_html_it(window.document,document.getElementById('wrapper'),/\n.*class=\"featured\"\>.*\n.*\n.*\n/gi,'',null);
do_modify_html_it(window.document,document.evaluate('/HTML[1]/BODY[1]', document, null, XPathResult.FIRST_ORDERED_NODE_TYPE,null).singleNodeValue,/\<iframe.*src.*digg\.com.*\>\<\/iframe\>.*\n/gi,'',null);
do_modify_html_it(window.document,document.evaluate('/HTML[1]/BODY[1]', document, null, XPathResult.FIRST_ORDERED_NODE_TYPE,null).singleNodeValue,/.*\<div.*script.*ad\.doubleclick\.net.*\<\/script\>\<\/div\>/gi,'',null);
do_modify_html_it(window.document,document.evaluate('/HTML[1]/BODY[1]', document, null, XPathResult.FIRST_ORDERED_NODE_TYPE,null).singleNodeValue,/.*\<li.*id=\"interruptor\"\>\n.*\<div.*\n.*\n.*\n.*\n.*\n.*\n.*\n.*\n.*<\/div>\n.*<\/div>\n.*<\/li>.*\n/gi,'',null);
relax(window.document,document.getElementById('content_container'),null,null,null);
set_style_script(window.document,document.getElementById('content'),"background-color: white;text-align: left;",null,null);
relax(window.document,document.getElementById('content_container'),null,null,null);
remove_it(window.document,document.getElementById('siteinfo'),null,null,null);
remove_it(window.document,document.getElementById('sitemeter'),null,null,null);
