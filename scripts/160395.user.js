// ==UserScript==
// @name           CnC: Tiberium Alliances Info for VikingsOfWar
// @author         Dealer (1.Author TheStriker)
          ...
          onKey : function (ev) {
            ...
            if (inputField != null) {
              ...
              if (ev.altKey && !ev.altGraphKey && !ev.ctrlKey && !ev.shiftKey && s == "Y") {
                ...
                inputField.value += "Bases: " + baseCount + " SupCount: " + supBaseCount + "(" + (supBaseCount / baseCount * 100).toFixed(0) + "%) Avg: " + avg.toFixed(2) + " 35+: " + high + "(" + (high / baseCount * 100).toFixed(0) + "%)";
                //for (var i in info)
