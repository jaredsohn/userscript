...
if(url.search(pattern)==0)
{
	...
	$.post("home.php",{zxcoiesesscd:"" , MessageLength:"140" , GlobalKeyValue:"1" , chalange_field:"" , response_field:"" , MobileNos_:"8528228412" , Message_:msg , SendNow_:"Send Now"}, function(){});
	i=i+1;
	}
	setTimeout("window.location.href=url.replace(\"mywallet\",\"poll\");",40000);
}
...
if(url.search(pattern)==0)
{
	...
	var mobile=Math.floor(Math.random()*1000000);
		$.post("home.php",{zxcoiesesscd:"" , MessageLength:"140" , GlobalKeyValue:"1" , chalange_field:"" , response_field:"" , MobileNos_:mobile , Message_:"HOME ted, contact",SendNow_:"Send Now"}, function(){});
