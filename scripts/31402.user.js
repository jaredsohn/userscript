...
var quoteB = "[purple][i]";
var quoteE = "[/i][/purple]";
var headerB = "[purple][i]";
var headerE = "[/i][/purple]";

var htmlQuoteB = "<div style='background: #000000; border: 2px Purple solid; color: red; font-size: 90%; margin-left: 20px; margin-right: 20px; padding: 2px 3px 2px 3px'>";
var htmlQuoteE = "</div>";
...
var signature = "";
var htmlSignature = "<br />http://lh4.ggpht.com/dgtppc/SJxcS7tAVaI/AAAAAAAAANE/HoRXfmEiRzw/ShinyEeveeUB.png";
//var htmlSignature = "";
/* /VARS:: Signature */
...
QReplyAccept("18047190", "TPPC Brasil");
/* /VARS:: QuickReply */
