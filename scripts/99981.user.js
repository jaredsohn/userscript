// ==UserScript==
// @name           Infinite Scroll for StumbleUpon
// @namespace      onyxstone@stumbleupon.com
// @description    An adaptation of http://www.infinite-scroll.com/ jquery plugin for StumbleUpon blogs
    ...
    function kickOffAjax(){
        ...
        props.loadingMsg.appendTo( opts.loadMsgSelector ).show(opts.loadingMsgRevealSpeed, function(){
	        ...
	        if ($.isFunction(opts.pathParse)){
		        ...
		        desturl = path + ( (opts.currPage-1)*10);
...
if( $( 'div.listUsersModule' )[0] ) {
// infinitescroll() is called on the element that surrounds 
// the items you will be loading more of
  $('ul.listStumble').infinitescroll({
 
    navSelector  : "ul.modulePagination",            
                   // selector for the paged navigation (it will be hidden)
    nextSelector : "ul.modulePagination li:first a",    
                   // selector for the NEXT link (to page 2)
    itemSelector : "ul.listStumble li.listLi"          
