// ==UserScript==
// @name        Farmers Branch and Lewisville, Texas LibraryLookup
...
(
   function()
   {
      ...
      } // end lewisvillePublicLibrary
	  
	        var fbpl =
      {
            name: 'Farmers Branch Public Library',

            createSearchUrl: function(isbn)
            {
               // var prefix = 'http://library.farmersbranch.info/uhtbin/cgisirsi.exe/x/0/0/5/?searchdata1=';
               var prefix = 'http://library.farmersbranch.info/uhtbin/cgisirsi.exe/x/0/0/5/?searchdata1=';
               return prefix + isbn
            },
      ...
      // checked
      libraryLookup.libraries = [fbpl, lewisvillePublicLibrary];
