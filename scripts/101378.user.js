// ==UserScript==
// @name           Ikariam - Sound alert (Φασουλάδα)
// @namespace      Φασουλάδα
// @description    Φασουλάδα development team :)
// @include        http://m*.ikariam.*/*
// @exclude	   http://m*.ikariam.*/index.php?view=sendIKMessage*
// @exclude	   http://m*.ikariam.*/index.php?view=sendSpy*
// @exclude	   http://m*.ikariam.*/index.php?view=deployment*
// @exclude	   http://m*.ikariam.*/index.php?view=defend*
// @exclude	   http://m*.ikariam.*/index.php?view=transport*
// @exclude        http://m*.ikariam.*/index.php?view=embassyGeneralAttacksToAlly*
...
var sa_SoundNotify 	= 'http://www.wav-sounds.com/various/electric.wav';
var sa_SoundWarning = 'http://www.wav-sounds.com/various/cashtill.wav';
var sa_SoundAlert 	= 'http://www.wav-sounds.com/various/beep.wav';
var sa_RandStart = 3; // random value start from X minutes
var sa_RandEnd = 8; // random value end at Y minutes
