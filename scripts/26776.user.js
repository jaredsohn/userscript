// ==UserScript==
// @name           Travian: Battle Analyse upraveno Cakenem
// @version        4.4.2
// @author         MeXaon, upraveno Cakenem
// @email          svgmail@mail.ru
// @namespace      Travian
// @description    Battle Analyse 4.4.2, upraveno Cakenem
...
var ScriptAutor='MeXaon, upraveno Cakenem';
var ScriptVersion='4.4.2';
...
function generatereport(){
	...
	if (warsim != 1 && worksave == 1) {
		...
		button1.setAttribute("value", "Ulož hlášení");
		...
		travilogForm.appendChild(elem("span", "", "Anonymní"));
		...
		divLoading.innerHTML = "<b>--= Načítám =--</b>";
