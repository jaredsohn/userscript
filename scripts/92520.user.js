// ==UserScript==
// @name           Auto Accep Gift KOC 100 & 102 by Skey
// @namespace      http://userscripts.org/scripts/
// @description    Auto Accep Gift KOC 100 & 102 by Skey
...
// EDIT THE LINE BELOW THIS ONE - Change XXX to the number for your domain
							if(domain_selector.options[i].value == "100"){
		...
		domTick();
                                                         ...
                                                         if(domain_selector.options[i].value == "102"){
								domain_selector.selectedIndex = i;
								if(next_button1){
									nHtml.Click(next_button1);
								}else{
