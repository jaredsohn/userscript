// ==UserScript==
// @name           Utilitários para The West (Petee) em Português
// @namespace      http://west-helps.blogspot.com
// @description    Cálculo das faturas bancárias e agrupamento de vendas no mercado, é isso que proporciona o script The West Petee's Utilities, traduzido por Marcos Bercke e codificado e desenvolvido por Petee
...
/**************************/
		...
		TWPU.lang_pack_default = {
			...
			'error_atypical_function':	"Script não poderia modificar uma função, porque é atípico",
			'error_not_that_many':		"Não há muitos itens!",
			'error_code_load_failed':	"O script não foi capaz de carregar o código :-(... Por favor, reporte o seu mundo e servidor para Petee nos fóruns .net ou em userscripts.com.",
			'made_by':			"Produzido por",
			'translator_text':		"Tradutor",
			'repeat_sale':			"Repita esta venda",
			'repeat_sale_extra':		"Repita este mesmo leilão no número especificado de vezes.",
			...
			'count':			"Contagem",
			'lang':				"Português/BR",
			'translator_name':		"Marcos Bercke" // yes, put your own nick here
		};
