// ==UserScript==
// @name        eRepublik test recovery 
// @namespace   eRepublikARE
...
var refreshTime = 40; //check timer, in seconds
// ------------------Configurable Variables------------------
...
function checkHealth() {
	...
	if (intCurrentHealth < intMaxHealth) {
		if (strButtonText=='Obnova energije') {
