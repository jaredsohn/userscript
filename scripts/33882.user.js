...
// @description   Makes orkut better
// @include       http://*.orkut.*/*
// @exclude       http://*.orkut.*/Main#*
// @exclude       http://*.orkut.gmodules.*
// ==/UserScript==
script_version = '0.5.4a';
userscripts_id = 33882;
/* 
 Change History
 v 0.5.4a
  - Fixed QuickScrap Captcha bug (Thanx to Jinu Varghese) 
 v 0.5.4
  - Fixed all broken features
  - Removed Profile Feeds application
 v 0.5.3
  - Minor Changes to Quick Scrap
  - Fixed forum topics display
 v 0.5.2
  - Added New Quick Scrap Box feature
  - Added Ad block feature
  - Added [time] tag to quote template
 v 0.5.1
