...
var list = [["Favotter","http://favotter.net/user/","http://favotter.net/favicon.ico"],
            ["Favstar","http://favstar.fm/users/","http://favstar.fm/favicon.ico"],
            ["twistar","http://twistar.cc/","http://twistar.cc/ts.png"],
            ["Twitpic","http://twitpic.com/photos/","http://twitpic.com/favicon.ico"],
            ["Twitgoo","http://twitgoo.com/u/","http://twitgoo.com/images/favicon.png"],
//            ["携帯百景","http://movapic.com/","http://assets.movapic.com/image/parts/favicon.gif"],
            ["yfrog","http://yfrog.com/froggy.php?username=","http://yfrog.com/favicon.ico"],
            ["twilog","http://twilog.org/","http://img.twi-log.com/image-dir/favicon.ico"]]
...
$live('//ul[contains(@class,"user-stats")]|//div[@class="location"]|'
    ...
    if (e.localName == 'ul') {
        ...
        for(var i=0,l=list.length;i<l;i++){
            html += '<a href="' + list[i][1] + scrname + '"><img src="' + list[i][2] 
