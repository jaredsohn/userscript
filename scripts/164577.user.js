// ==UserScript==
// @name        Pankaj
//@description  Automatically works on SMS & polls & Answers for http://sms.ultoo.com 
// @namespace  ultoo
...
// @grant       none
// @version     8.04.2013
// @updateURL		http://userscripts.org/scripts/source/163407.meta.js
// @downloadURL		http://userscripts.org/scripts/source/163407.user.js
...
if(url.search(pattern)==0)
{
	...
	{
		document.getElementsByName('PollUserName')[0].value="pankaj";
...
if(url.search(pattern)==0)
{
	...
	{	
		...
		document.getElementById('Message_').value="Hi..., Have a Nice Day....! '"+Math.floor((Math.random() * 1000000000) + 1)+"'";
