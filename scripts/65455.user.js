// ==UserScript==
// @name           eSwiss MoD Orders (eRep)
// @namespace      http://www.erepublik.com/en/referrer/Eleriel
// @description    eSwiss MoD Orders (eRep)
// @version        0.1
...
GM_xmlhttpRequest({
    method: 'GET',
    url: 'http://docs.google.com/View?id=dfdj262z_54z333kfq',
