/*
	FriendFeed Identi.ca
	Duncan Riley/ http://www.inquisitr.com
	code modified from http://ffapps.com/tabs/
*/

// ==UserScript==
// @name           FriendFeed Identi.ca
// @namespace      Duncan Riley/ http://www.inquisitr.com
// @description    Add Identi.ca in a tab on FriendFeed 
...
(function() {
  ...
  function Identica_setup() {
		$('.settings').find('.l_tab:last').after('<td class="l_tab" style="padding-left: 10px;" id="tdtabtm"><div class="rounded bb" id="tabtm"><div class="t"><div class="l"><div class="r"><div class="tl"><div class="tr"><div class="body"><a id="tab-link-Identica" href="#"><img src="http://Identi.ca/favicon.ico"></a></div></div></div></div></div></div></div></td>');
    $('#tab-link-Identica').click(function() {
			$('#subtabs').hide();
			$('#body').css("height","100%").html('<div class=iframe style="width:100%;height:100%;"><iframe id="content_iframe" marginWidth=0 marginHeight=0 src="http://Identi.ca/" frameBorder=0 style="width:100%;height:100%;overflow:auto;"></iframe></div>');
