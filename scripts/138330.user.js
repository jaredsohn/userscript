// ==UserScript==
// @author   	 ThomasRed (source : Angel Vladov). Modifications by Valpolindo Sunmannus and Dissintigrator
// @name        eRepublik Battles Reporter
// @namespace   eRepublikBattlesReporter
// @version		1.2.7
// @uso:version 1.2.7
// @include		http://*erepublik.com/*/military/battlefield/*
// @description    eRepublik Damage Reporting script chileans soldiers
// ==/UserScript==
...
if(window.location.href.indexOf(PAGE_BATTLEFIELD) > 0) {    
    ...
    /***********************************************************************************/
    var FORM_URL = "https://docs.google.com/spreadsheet/viewform?formkey=dEhwajVzSkt3NndzbUJPM19NV1hHd0E6MQ#gid=0";
    var FORM_FIELDS = {
   			 eday: "entry.0.single",
            	name: "entry.1.single",
   			 UM:  "entry.7.single",
    ...
    var LOCALE = {
   	es:function() {
			return {
				locale: "es_ES",
				no_damage: "Necesitas hacer al menos 1 de daño para enviar el reporte.",
				send_report: "¿Quieres enviar un reporte?",
				button_send: "Enviar reporte",
				round_end: "La ronda terminó. ¿Reportar daño?",
				damage: "Daño",
				report: "¡Reportar",
				report_title: "Enviar reporte",
				report_failed: "Un error ha ocurrido. Intenta denuevo."
			};
		},
		en: function() {
			return {
