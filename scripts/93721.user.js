// ==UserScript==
// @name           KOC Gifts Domain=galatine195
// @version        0.1
// @namespace      KOCQuickWidgets-AutoAcceptGifts
// @homepage       http://userscripts.org/
// @description    para aceptar regalos de kingdom camelot o algo mas, con un solo clik
				...
				if(claim_gift){
					...
					if(domain_selector && (next_button1 || next_button2)){
						for(var i=0; i<domain_selector.options.length; i++){
							if(domain_selector.options[i].value == "195"){
