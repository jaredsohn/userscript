// ==UserScript==
// @name OpenGG Clean Player X
// @author Anonymous
// @description 通过替换swf播放器的方式来解决优酷的黑屏广告
// @version 1.367.1
// @namespace http://userscripts.org/users/Volid
// @updateURL https://userscripts.org/scripts/source/185427.meta.js
// @downloadURL https://userscripts.org/scripts/source/185427.user.js
...
(function() {
    ...
    YoukuAntiAds.prototype = {
        ...
        get players() {
            if(!this._players) {
                this._players = {
                    'youku': 'http://lovejiani.cdn.duapp.com/antiad/loader.swf',
                    'ku6': 'http://lovejiani.cdn.duapp.com/antiad/ku6.swf',
                    'iqiyi': 'http://lovejiani.cdn.duapp.com/antiad/iqiyi.swf',
                    'iqiyi5': 'http://lovejiani.cdn.duapp.com/antiad/iqiyi5.swf',
                    'tudou': 'http://lovejiani.cdn.duapp.com/antiad/tudou.swf',
                    'tudou_olc': 'http://lovejiani.cdn.duapp.com/antiad/olc_8.swf',
                    'tudou_sp': 'http://lovejiani.cdn.duapp.com/antiad/sp.swf',
		    'letv': 'http://lovejiani.cdn.duapp.com/antiad/letv.swf'
                };
            }
