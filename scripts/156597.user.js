﻿// ==UserScript==
// @name           Octobermails Auto Clicker
// @description    Valida automaticamente e clicar em todos os links paid2click octobermails.com
// @include        *octobermails.com/pages/ptc.php*
...
messages = "No clickable ads currently available. Atualize a página para procurar mais anúncios.";
...
messages = "Advertiment " + links[i] + " Carregado. Página irá atualizar automaticamente em 20 segundos.";
...
sec.innerHTML = '<p align="center"><b>Octobermails Auto Clicker</a></b></p><hr><p align="center">' + messages + '</p>';
...
var SUC_script_num = 156595; // Change this to the number given to the script by userscripts.org (check the address bar)
