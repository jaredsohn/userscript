// ==UserScript==
// @name          Bausteinnachrichter
// @description   Ermöglicht die Nutzung vordefinierter Antwortnachrichten.
// @include       http://de*.die-staemme.de/game.php?*&screen=mail&mode=view*
// ==/UserScript==
...
function neuBaustein() {
 ...
 stein    += "</textarea><br><button type='button' id='neubausteinanlegen'>Neuer Baustein!</button></form></div>";
