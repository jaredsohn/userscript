...
function Sharkale_Opciones(){
	...
	nuevaHTML += '		<br><input type="text" id="tb_msg" name="miarrobatag207890_msg" title="Escribe aquÃ­ el mensaje que aparecerÃ¡ en el Tagboard" value="Tu mensaje aquÃ­" maxlength="250" class="ui-state-default ui-corner-all" style="width:760px;">';
	...
	nuevaHTML += '		<br><input type="submit" id="miarrobatag207890_submit" title="Enviar mensaje al Tagboard" name="miarrobatag207890_submit" value="EnvÃ­ar Mensaje" class="ui-state-default ui-corner-all" style="width:800px;">';
	nuevaHTML += '	</form></div>';
	nuevaHTML += '</div>';
	...
	nuevaHTML += '    <hr><form action="https://www.paypal.com/cgi-bin/webscr" method="post"><input type="hidden" name="cmd" value="_s-xclick"><input type="hidden" name="hosted_button_id" value="7853233">Capaz alguien me dona 10ctv que le quedan ahÃ­ tiraditos en la cuenta de PayPal ^.^ <input type="image" src="https://www.paypal.com/es_ES/ES/i/btn/btn_donate_LG.gif" border="0" name="submit" align="absmiddle" alt="PayPal. La forma rÃ¡pida y segura de pagar en Internet." class="ui-state-default ui-corner-all"><img alt="" border="0" src="https://www.paypal.com/es_XC/i/scr/pixel.gif" width="1" height="1"></form><hr>';
...
///////////////-----------------Agregar Emoticones------------------////////////////////
	...
	if($('div[typeof="foaf:Person"]').find('a[href="/perfil/2192568"]').length != 0){
