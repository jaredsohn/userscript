// ==UserScript==
// @name           The-West Notite
// @namespace      www.tw-help.org
// @description    Un notepad pt. ati nota tot ce ai de facut pentru ziua de maine.
// @translator     PWG
// @include        http://*.the-west.ro/game.php*
...
switch(loc){
case "ro":
lang.mainmenu.title="Jegyzettömb";
lang.mainmenu.savednotes="Elmentett jegyzetek";
lang.mainmenu.nonotes="Nincs jegyzet.";
lang.writenew="Új jegyzet";
lang.edit="Szerkesztés";
lang.title="Cím";
lang.text="Szöveg";
lang.save="Mentés";
lang.valid.text="Trebuie sa adaugati un text";
lang.valid.title="Trebuie sa adaugati un titlu";
lang.del="Törlés";
lang.edit="Szerkesztés";
lang.restart_confirm="Sunteti sigur ca doriti sa stergeti toate notele?";
lang.name="Cím";
lang.zmuldat="Schimba locul de eliminare pt. note";
lang.zmuldatal1="Notele suna cum salvate";
lang.localhost="computerul tau";
lang.foreignserver="server strain";
lang.chars="caractere";
lang.youvewroten="Ai scris deja";
lang.zbyva="si stanga";
lang.alarm.ding="DingDangDong!\nAlarm din nou dupa 10 minute?";
lang.toomuchlong="Nota este prea lunga.";
lang.toomuchnotes="Nu am putut salva aceasta nota deoarece ati ajuns la maximum de note. Va rugam sa stergeti o nota.";
...
lang.deletesure="Biztos törölni akarod?";
...
var xhtml='<div class="window_borders">';xhtml+='<h2 id="window_'+extendeName+'_title" class="window_title" style="background-image:url(http://wiki.the-west.ro/images/8/8c/Notepad1.png);"><span>'+extendeName+'</span></h2>';xhtml+='<a href="javascript:AjaxWindow.closeAll();" class="window_closeall"></a><a href="javascript:AjaxWindow.toggleSize(\'' + extendeName + '\');" class="window_minimize"></a><a href="javascript:AjaxWindow.close(\''+extendeName+'\');" class="window_close"></a>';xhtml+='<div id="window_'+extendeName+'_content" class="window_content">'+data+'<div style="position:absolute;top:10px;right:13px;" id="tw_help_notepad_write_new"><img src="http://wiki.the-west.ro/images/4/46/Newnote.png" alt="'+lang.writenew+'" style="cursor: pointer;" id="tw_help_notepad_write_new_img" /></div></div>';xhtml+='</div>';
...
notes_img.src='http://wiki.the-west.ro/images/2/2a/Notepad.png';
