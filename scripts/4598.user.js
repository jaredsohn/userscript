// ==UserScript==
// @name          mixed script
// @namespace     www.myspace.com/tiba31
...
s+= "body {background:url() #ffffff fixed;margin-top:-110px;}\n";
...
document.getElementById('splash_coolNewPeople').innerHTML = '<embed src= "http://www.filecabin.com/members_vb/files/58768/xspf_white.swf?playlist_url=http://www.filecabin.com/members_vb/files/58768/yayiehopepage.xml&autoplay=true&info_button_text=Lyrics" quality="high" bgcolor="black" name="xspf_player" allowScriptAccess="never" type="application/x-shockwave-flash" pluginspage="http://www.macromedia.com/go/getflashplayer" align="center" height="160" width="380">';
