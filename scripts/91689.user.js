...
// @homepage         http://userscripts.org/scripts/show/91689
...
var KOCAttack={
	...
	ShowOptionsDialog:function() {
		...
		div.innerHTML="<form><table>"+
			...
			"Attacking camp:<input id='KOCAttackHoursSinceLastCamp' value='"+(this.options.attackSecsSinceLastCamp/(60))+"' size='3' />hrs<br />"+
		...
		ById('KOCAttackOptionsSave').addEventListener('click',function() {
			...
			t.options.attackSecsSinceLastCamp=parseFloat(ById('KOCAttackHoursSinceLastCamp').value)*60;
