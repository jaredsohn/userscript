var fileMETA = <><![CDATA[
// ==UserScript==
// @name         Clodogame - Fightinfo
// @namespace    http://userscripts.org/scripts/show/102207
// @author       Memphis007
// @description  Informations détaillées sur les bastons, script de We1hnachtsmann, adapté pour clodogame reloaded et traduit en fr.
// @maj			 adaptation de la version originale 1.6.2 de fighinfo
// @version      1.6
...
// URLs für Icons
var imgPrefix = 'http://i653.photobucket.com/albums/uu259/we1hnachtsmann/';
var ICON_ATTACK = 'attack.png';                     // Icon für Angriff
var ICON_INFO = 'info.gif';                         // Icon für Pennerzone-Link
var ICON_LASTFIGHT_NOCOMMENT = 'buchgrn.gif';       // Icon für letzte Kämpfe (noch kein Kampf) ohne Kommentar
var ICON_LASTFIGHT_COMMENT = 'buchorange.gif';      // Icon für letzte Kämpfe (noch kein Kampf) mit Kommentar
var ICON_LASTFIGHT_WARNING = 'buchrot.gif';         // Icon für letzte Kämpfe (noch kein Kampf) mit Warnung
var ICON_LASTFIGHT_NOCOMMENT_FIGHTED = 'grn.png';   // Icon für letzte Kämpfe (schon mindestens ein Kampf) ohne Kommentar
var ICON_LASTFIGHT_COMMENT_FIGHTED = 'gelb.gif';    // Icon für letzte Kämpfe (schon mindestens ein Kampf) mit Kommentar
var ICON_LASTFIGHT_WARNING_FIGHTED = 'rot.gif';     // Icon für letzte Kämpfe (schon mindestens ein Kampf) mit Warnung
var ICON_LASTFIGHT_NONE = 'buchschw.gif';           // Icon für letzte Kämpfe selbst

var ICON_PENNERZONE_MONEY = 'dollar.gif';           // Icon für Pennerzone-Suche ohne Punktebeschränkung
var ICON_PENNERZONE_UP = 'pennerzoneup.gif';        // Icon für Pennerzone-Suche am oberen Punktespektrum
var ICON_PENNERZONE_DOWN = 'pennerzonedown.gif';    // Icon für Pennerzone-Suche am unteren Punktespektrum
var ICON_PENNERZONE_DATE = 'pennerzone_date.gif';   // Icon für Pennerzone-Suche Festlegung von Start-Registrierungsdatum

var ICON_FIGHTCOMMENT = 'notizgelb.gif';
var ICON_NOFIGHTCOMMENT = 'notizgrau.gif';
var ICON_SENDTOSB = 'envelope.gif';
var ICON_ADDTOFT = 'grnadd.gif';                    // Icon für Hinzufügen zur Kampftabelle
var ICON_DELFROMFT = 'userdel.png';           	    // Icon für Entfernen aus Kampftabelle
var ICON_CHEATERDIA_NORMAL = 'diagramm.png';
var ICON_CHEATERDIA_DOUBLE = 'diagramm.gif';
var ICON_DIRECTATTACK = 'direktangriff.gif';        // Icon für Direktangriffslink
var ICON_NEW = 'new.png';                           // Icon für "NEU"
...
var ICON_0_0 = '0_0kopie.gif';
var ICON_0_1 = '0_1kopie.gif';
var ICON_1_0 = '1_0kopie.gif';
var ICON_1_1 = '1_1kopie.gif';
var ICON_2_0 = '2_0kopie.gif';
var ICON_2_1 = '2_1kopie.gif';
var ICON_EVADE = 'evadekopie.gif';

// Landesflaggen
var flags = new Array();
    flags[0] = 'germany.png';
    flags[1] = 'United_States.png';
    flags[2] = 'poland.png';
    flags[3] = 'france.png';
    flags[4] = 'spain.png';
    flags[5] = 'brazil.png';
    flags[6] = 'russia.png';
    flags[7] = 'united_kingdom.png';
...
// Wenn in Warschau gespielt wird
	...
	var DFTownCode = "";
	if (location.toString().indexOf("reloaded") != -1) {
		TOWNBASE_URL = 'http://reloaded.menelgame.pl/';
		TOWNEXTENSION = 'WR';
		fightPause = 24;		// Pause zwischen zwei Angriffen
	}
	var lang = 2;
...
// Wenn in Paris gespielt wird
	...
	var DFTownCode = "";
	if (location.toString().indexOf("reloaded") != -1) {
		TOWNBASE_URL = 'http://reloaded.clodogame.fr/';
		TOWNEXTENSION = 'PR';
		fightPause = 24;		// Pause zwischen zwei Angriffen
	}
	var lang = 3;
...
// Wenn in Madrid gespielt wird
	...
	var DFTownCode = "";
	if (location.toString().indexOf("reloaded") != -1) {
		TOWNBASE_URL = 'http://reloaded.mendigogame.es/';
		TOWNEXTENSION = 'MR';
		fightPause = 24;		// Pause zwischen zwei Angriffen
	}
	var lang = 4;
// Wenn in Sao Paolo gespielt wird
} else if (location.toString().indexOf("sampa.faveladogame.com") != -1) {
	var TOWNBASE_URL = 'http://www.sampa.faveladogame.com/';
	var ZONEBASE_URL = ''; 
	var TOWNEXTENSION = 'SP';
	var DFTownCode = "";
	var lang = 5;
// Wenn in Rio de Janeiro gespielt wird
} else if (location.toString().indexOf("faveladogame.com") != -1) {
	var TOWNBASE_URL = 'http://www.faveladogame.com/';
	var ZONEBASE_URL = ''; 
...
var Txt1IncFight = new Array();
    ...
    Txt1IncFight[3] = "1 baston inattendue";
...
var TxtFightCom = new Array();
    ...
    TxtFightCom[3] = "S'il vous plaît entrez un commentaire pour ce post:";
...
var TxtAttack = new Array();
    ...
    TxtAttack[3] = 'Attaque en cours sur';
...
var TxtMyFav = new Array();
    ...
    TxtMyFav[3] = 'Mes adversaires préférés';
...
var TxtDelFromFT = new Array();
    ...
    TxtDelFromFT[3] = 'Supprimer de la liste des combats';
...
var TxtNoAddedToFT = new Array();
    ...
    TxtNoAddedToFT[3] = 'Aucune entrée ajoutée à la liste des combats';
...
var TxtCheckBums = new Array();
    ...
    TxtCheckBums[3] = "S'il vous plaît cochez les combats pour ajouter à la liste des combats!";
...
var TxtNewIDs = new Array();
    ...
    TxtNewIDs[3] = 'Entrez nouveau joueur svp: ';
...
// **********************************************************************************
// **********************************************************************************
// Funktion ermiitelt die Bildadresse
// **********************************************************************************
// **********************************************************************************
...
function ChangeFightIcon(currenttr) {
	...
	switch (imagename) {
		case '0_0.gif': {
			fightimage.src = getIconAddr(ICON_0_0);
			fightimage.alt = "AUS";
			break;
		}
		case '0_1.gif': {
			fightimage.src = getIconAddr(ICON_0_1);
			fightimage.alt = "EIN";
			break;
		}
		case '1_0.gif': {
			fightimage.src = getIconAddr(ICON_1_0);
			fightimage.alt = "AUS";
			break;
		}
		case '1_1.gif': {
			fightimage.src = getIconAddr(ICON_1_1);
			fightimage.alt = "EIN";
			break;
		}
		case '2_0.gif': {
			fightimage.src = getIconAddr(ICON_2_0);
			fightimage.alt = "AUS";
			break;
		}
		case '2_1.gif': {
			fightimage.src = getIconAddr(ICON_2_1);
			fightimage.alt = "EIN";
			break;
		}
		case 'evade.gif': {
			fightimage.src = getIconAddr(ICON_EVADE);
			fightimage.alt = "AGW";
			break;
		}
	}
...
function FightCommentHandler(currentimg) {
	...
	currentimg.addEventListener("click", function(event) { 
		...
		var fightcomment = prompt("Merci de saisir votre commentaire sur ce combat:", fightcomment);
			...
			if (trs[x].getElementsByTagName("td").length >= 7) {
				...
				GM_xmlhttpRequest({method: 'GET', url: API_URL + userid + ".xml", onload: function(responseDetails) {
					...
					if (responseDetails.status == 200) {
						...
						userpoints=(userpoints<=ownattmax&&userpoints>=ownattmin&&bl("fi", userid))?Math.ceil(ownattmin*0.95):userpoints;
...
function GetNumberOfFights(content) {
	try {
		...
		GM_log("Impossible de déterminer le nombre de combats entrants: " + err);
	}
}
...
function ReplaceFightSearchIDs(userid, nrofpastfights, stats) {
	...
	function GetFightstring(nrofpastfights) {
		...
		switch (nrofpastfights) {
			case 0: {
				return fightstring = ' aucun combat';
			}
			case 1: {
				return fightstring = ' 1 combat';
			}
			default: {
				return fightstring = nrofpastfights + ' combats';
			}
		}
	}
...
function GetIconInsertHTML(userid, username, fighttime) {
	...
	if (NrOfFightComments > 0) {
		...
		if (NrOfFightComments > 1) {
			var lastfightadditionalinfo = '. Il y a ' + NrOfFightComments + ' commentaires sur cet adversaire';
		// sonst: Es gibt einen Kommentar
		} else {
			var lastfightadditionalinfo = '. Il y a un commentaire sur cet adversaire';
	}
	...
	if (ExistsWarning(username)) {
		...
		var lastfightadditionalinfo = lastfightadditionalinfo + ". Attention, l\'avertissement a été activé!";
	}

	// Icon für letzte Kämpfe einfügen
	if (userid != m_ownuserid)
		IconInsertHTML = IconInsertHTML + '<a href="' + FIGHTSEARCH_URL + username + '" target="_blank"><img border="0" id="fightsearchid:' + userid + "_" + (GetNrOfIDs(document, 'fightsearchid:' + userid) + 1) + '" src="' + lastfighticon + '" title="Combats contre ' + username + lastfightadditionalinfo + '" height="14" width="14" alt="O" style="padding-left: 3px; padding-right: 4px;"></a>'
	else if (fighttime != "x")
	...
	if (fighttime != "" && fighttime != "x" && fighttime != "nofight") {
		...
		IconInsertHTML = IconInsertHTML + '<img id="' + username + "*" + fighttime + '" border="0" src="' + fightcommenticon + '" title="Laisser un commentaire à propos de ce combat" height="14" width="14" alt="O" style="cursor: pointer">'
	}
	...
	if (userid == m_ownuserid && fighttime != "x")
		...
		IconInsertHTML = IconInsertHTML + '<a href="' + FIGHTTO_URL + username + '" target = "_blank"><img id="' + username + '*attack" border="0" src="' + getIconAddr(ICON_ATTACK) + '" title="Attaquer ' + username + '" height="14" width="14" alt="O" style="cursor: pointer"></a>';
...
function InsertSubmitButton(content, table, inGang) {
	...
	{ 
		...
		newtd = document.createElement("td");
		newtd.setAttribute("colspan", "2");
		newtd.innerHTML = 'Les pages sont extraites du journal de combat, merci de patienter...';
		newtr.appendChild(newtd);
...
function HandleProfile() {
	...
	if (datatable >= 0) {
		...
		for (var i = 0; i < trs.length; i++)
			if (trs[i].innerHTML.indexOf(TxtPunkte[lang]+"</strong") != -1) {
				var userpoints = trs[i].getElementsByTagName("td")[1].innerHTML;
				trs[i].getElementsByTagName("td")[1].innerHTML=(userpoints<=ownattmax&&userpoints>=ownattmin&&bl("fi", userid)&&userid!=m_ownuserid)?userpoints=Math.ceil(ownattmin*0.95):userpoints;
				break;
			}
	}
	...
	if (ZONEBASE_URL != "" || userid != m_ownuserid) {
		...
		if (ZONEBASE_URL != "")
			...
			var Txt = "Statistiques";
		newtr.getElementsByTagName("td")[2].innerHTML = '<strong>' + Txt + ' sur ' + username + '</strong>';
...
function PrepareFightTable(table) {
	...
	newtd.innerHTML = "1";
	newtd.innerHTML = '<input name="FTCheckbox" id="FTCheckbox" type="checkbox"><span style="vertical-align: bottom">&nbsp;Afficher la liste des combats</span>';
	newtr.appendChild(newtd);
...
function InsertFightTable(fightIDList) {
	...
	function InsertHead(table, nrofcolumns) {
		...
		newtr.getElementsByTagName("th")[2].innerHTML = "Nom";   // Username
		...
		newtr.getElementsByTagName("th")[4].innerHTML = "Points";    // aktuelle Punktzahl
		newtr.getElementsByTagName("th")[4].setAttribute('style', 'width: 75px; text-align: right; padding-right: 10px');
		
		newtr.getElementsByTagName("th")[5].innerHTML = "Inscription"; // Registrierungsdatum
		newtr.getElementsByTagName("th")[5].setAttribute('style', 'width: 65px');

		newtr.getElementsByTagName("th")[6].innerHTML = "Tunes";   // Geld
	...
	GM_xmlhttpRequest({method: 'GET', url: DFurl[id], onload: function(responseDetails) {
		...
		if (responseDetails.status == 200) {
			...
			function GetDirectAttack(username) {
				return '<a href="' + FIGHTTO_URL + username + '" title="Direktangriff auf ' + username + '" target="_blank"><img src="' + getIconAddr(ICON_DIRECTATTACK) + '" style="padding-right: 3px"></a>';
			}
	...
	function GetActPoints(userid, x) {
		...
		GM_xmlhttpRequest({method: 'GET', url: API_URL + userid + ".xml", onload: function(responseDetails) {
			...
			if (responseDetails.status == 200) {
				...
				// Punktezahl und UserID auslesen
				var userpoints = Number(dom.getElementsByTagName('points')[0].textContent);
				userpoints=(userpoints<=ownattmax&&userpoints>=ownattmin&&bl("fi", userid)&&userid!=m_ownuserid)?Math.ceil(ownattmin*0.95):userpoints;
			...
			GM_xmlhttpRequest({method: 'GET', url: API_URL + m_ownuserid + ".xml", onload: function(responseDetails) {
				...
				if (responseDetails.status == 200) {
					...
					if (content.indexOf(TxtZiel[lang]) != -1 ) {
						...
						if (attackspan) {
							attackspan.innerHTML = '<img id="LangSelect" border="0" src="' + getIconAddr(flags[myLang]) + '" title="' + TxtLang[myLang] + '" height="12" width="18" style="cursor:pointer">&nbsp;&nbsp;' + attackspan.innerHTML;
							// ***********************************************************************************************
...
CheckScriptForUpdate = {
 ...
 name: 'Clodogame - Fightinfo', // Script Name
 version: '1.6', // Version
 id: '102207', // Script id on Userscripts.org
