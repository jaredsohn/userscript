// ==UserScript==
// @name      Photo pop-up + OC colors + gets rid of ads
// @version	1.2
// @author	adam booth
// @namespace   
// @description  Makes Facebook OC colors and photos pop up + and removes ads
...
toplogo = "http://i20.photobucket.com/albums/b205/MWBC/OClogo3.jpg";
tophover = toplogo;

/*Turn this line on if you want to have a rollover image for the logo*/
tophover = "http://i20.photobucket.com/albums/b205/MWBC/OClogohome.jpg";
...
addGlobalStyle('.tip {font:10px/12px Arial,Helvetica,sans-serif;border:0;padding:3px 3px 1px 3px;visibility:hidden;position:fixed;z-index:100;color:#8B0000;top:20px;left:90px;background-color:#8B0000;}');
