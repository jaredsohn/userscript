...
var HideComment = GM_getValue("HideComment",true);
	...
	GM_registerMenuCommand("BBCoder para T! y P! - Buscar Actualizaciones", function() {
...
function Sharkale_Opciones(){
	...
	var nuevaHTML = '<div class="ui-dialog-titlebar ui-widget-header ui-corner-all ui-helper-clearfix" style="-moz-user-select: none;margin-bottom:3px;">';
	nuevaHTML += '	<span class="ui-dialog-title" id="ui-dialog-title-SharkaleOpciones" unselectable="on" style="-moz-user-select: none;">Opciones Avanzadas del Script - Sharkale&reg;   /  mod. Juampi_Mix</span>';
	nuevaHTML += '	<a href="" onclick="$(\'#widget\').remove();$(\'#cuerpocontainer\').show();return false;" onmouseover="$(this).addClass(\'ui-state-hover\');" onmouseout="$(this).removeClass(\'ui-state-hover\');" class="ui-dialog-titlebar-close ui-corner-all" unselectable="on" style="-moz-user-select: none;">';
	nuevaHTML += '		<span class="ui-icon ui-icon-closethick" unselectable="on" style="-moz-user-select: none;">close</span>';
	nuevaHTML += '	</a>';
	nuevaHTML += '</div>';
	...
	nuevaHTML += '	<label><input type="checkbox" id="shark_PunFav" '+(PunFav? 'checked':'')+'> Agregar Puntos y Favoritos en la seccion de Comentarios</label><br/>';
	nuevaHTML += '	<label><input type="checkbox" id="shark_aSWF" '+(aSWF? 'checked':'')+' onchange="if ($(this).is(\':checked\'))"> Agrandar archivos Flash.</label><br/>';
	nuevaHTML += '	<label><input type="checkbox" id="shark_EmotVis" '+(EmotVis? 'checked':'')+'> Mostrar Emoticones por defecto.</label><br/>';
	nuevaHTML += '	<label><input type="checkbox" id="shark_NovatosPrinc" '+(NovatosPrinc? 'checked':'')+'> Post de Novatos en la Pagina Principal.</label><br/>';
	...
	nuevaHTML += '    <b><u><span style="color: red;">Changelog versiÃ³n 31.0:</span></u></b><br><b><span style="color: yellow;">Inicio de la Modificacion por Juampi_Mix:</span></b><br>* [Fixed] Enlace a Mis Posts.<br>* [Fixed] Enlace a Mis Temas.<br>* [Add] Listado de Juegos y Salas en el menu Taringa.<br>* [Mod] Cambiado de la pestaña "Chat", al Chat Oficial de Radio_Sharkale.<br>* [Delete] Eliminado Ocultar Archivos Flash<br>* [Delete] Eliminado El LinkChequer.<br>';
	nuevaHTML += '    <b><u><span style="color: red;">Changelog versiÃ³n 30.1:</span></u></b><br>* [Fixed] ImÃ¡genes de IMGur.<br>* [Fixed] Host de imÃ¡genes para crear post.<br>* [Fixed] Pack de emoticones.<br>* [Fixed] ImÃ¡genes hosteadas en server propio.<br>* [Fixed] Algunos host en el linkchecker.<br>';
      nuevaHTML += '    <b><u><span style="color: red;">Changelog versiÃ³n 30.0:</span></u></b><br>* [Fixed] Varios errores.<br>* [Fixed] ImÃ¡genes del menÃº.<br>* [Add] Borradores en el MenÃº.<br>* [Add] Nuevo servidor para subir imagenes en crear post.<br>* [Fixed] Creador de reproductor de MixPod.<br>';
	...
	nuevaHTML += '    <div align="center"><br><span style="font-size:15px">BBCoder para Taringa! y Poringa! Version Original por:</span><br/><br/>';
	nuevaHTML += '    <span style="font-size:30px;font-family:Arial Black">SharkaleÂ® 2010</span><br/><br/><br/>';
	nuevaHTML += '    <div align="center"><br><span style="font-size:15px">Version Modificada por:</span><br/><br/>';
	nuevaHTML += '    <span style="font-size:30px;font-family:Arial Black">Juampi_Mix</span><br/><br/><br/>';
...
//----Inicio----//
	...
	menu += '		<li><b>Busqueda RÃ¡pida en T! o P!</b><form method="get" action="http://'+Dom+'/posts/buscador/taringa/"><input name="q" title="Buscador RÃ¡pido" style="border: 0px none; font-size: 10px; width:171px;padding-bottom:2px;" type="text"></form></li>';
	menu += '		<li><a href="http://br.taringa.net/">T! em PortuguÃªs</a></li>';
    menu += '	</ul>';
	menu += '	</li>';
//----Mensaje----/
...
function AceptarActualizacion(){
	...
	unsafeWindow.mydialog.body('Tu versiÃ³n instalada es la <b>' + ultversion +'</b> y la Ãºltima disponible es la <b>' + Act.ver + '</b><h3><u>Cambios de la Ãºltima versiÃ³n:</u></h3><div align="left" style="padding:0px 50px"><ul type="disc">' + Act.cambio + '</ul></div><br>Para dudas o instrucciones de uso entra en la:<br>Comunidad Oficial <a href="http://www.taringa.net/comunidades/bbcoder/"><b>http://www.taringa.net/comunidades/bbcoder/</b></a><br>PÃ¡gina Oficial <a href="http://www.sharkale.com.ar/bbcoder/"><b>http://www.taringa.net/comunidades/bbcoder/</b></a><br><br><a href="https://addons.mozilla.org/es-ES/firefox/addon/53880" target="_blanc"><h3 style="text-decoration:blink">Â¿Luego de usar unas horas el script, Firefox se te vuelve lento? Instala este Add-on</h3></a><h2>&iquest;Desea actualizar el script?</h2>');
	...
	unsafeWindow.mydialog.center();
	$('#mydialog #buttons .mBtn.btnOk').click(function(){GM_openInTab('http://www.sharkale.com.ar/bbcoder/')});
}
...
function ActualizarScript(SCRIPT) {
	try {
		GM_xmlhttpRequest({
			...
			url: SCRIPT.url,
			onload: function(r) {
				var ultvers = new Function("return "+r.responseText)();
				Act = {ver: ultvers.ver, url: ultvers.url, cambio: ultvers.changelog};
				if (parseFloat(ultvers.ver) <= parseFloat(SCRIPT.version)){
					if(SCRIPT.forzado){
						unsafeWindow.mydialog.procesando_fin();
						unsafeWindow.mydialog.alert("Actualizador del BBCoderÂ®","No hay actualizaciones disponibles en este momento.");
					}
					return;
