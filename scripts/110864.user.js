...
// @version 0.4.5.2a for HMMW

// @description Facebook MafiaWars Tools.
// @include http://userscripts.org/scripts/source/110864.meta.js*
...
var scriptAppInfo = 
{
    ...
    appVer: '0.4.5.2a',
	appVera: '0.4.5.2a for HMMW',
	appUrla: 'http://facebook.mafiawars.zynga.com/mwfb/index.php?skip_req_frame=1&mwcom=1',
    appUrl: 'http://userscripts.org/scripts/show/110864',
...
var Util = {
    ...
    formatText: function(string) {
        ...
        for (var i = 0; i < words.length; i++) {
            outText+= words[i].charAt(0).toUpperCase() + words[i].substr(1).toLowerCase()+' ';
        }
 ...
 * @return {jQuery}
 */
function createDropDownSelectList(id, options) {
...
function checkForUpdates() {
    var now = new Date().getTime();
    var uInt = scriptAppInfo.appUpdateInterval * 60 * 60 * 1000;
...
function modMenu()
{
    ...
    var menu_container = c$('div', 'fbmw_menu_container').prependTo(global.final_wrapper); 
        ...
        var menuOptions = [
        {name:'FBMWAddon Options <img src=http://mwfb.static.zgncdn.com/mwfb/graphics/v3/icon_hammer_wrench.png height=14 />',      'click': Configuration,        'main': true               },
	{name:'Email Bonus',         'click': EmailBonus, 'timer':'EmailBonus' 			},
	{name:'Lucky Stash Bonus',         'click': LuckyStashBonus, 'timer':'LuckyStashBonus' 			},
	{name:'Toolbar Bonus',         'click': ToolbarBonus, 'timer':'ToolbarBonus' 			},
	//{name:'Atlantic City Bonus',         'click': AtlanticCityBonus, 'timer':'AtlanticCityBonus' 			},
        ...
        {name:'Battlefield v2! <img src=http://mwfb.static.zgncdn.com/mwfb/graphics/icon_stamina_16x16.png height=12 />',            'click': Battlefieldv2                        },
	{name:'Assassin-a-Nator <img src="http://mwfb.static.zgncdn.com/mwfb/graphics/icon_stamina_16x16.png" height=14 />',          'click': AssassinANator  },
        {name:'Robbit <img src="http://mwfb.static.zgncdn.com/mwfb/graphics/icon_stamina_16x16.png" height=14 />',              'click': Robbit                                           },
		...
		{name:'Mafia Wars Bonus <img src="http://mwfb.static.zgncdn.com/mwfb/graphics/clan/group_xp.png" height=14 />',          'click': Dailybonus  }
    ];
...
//unsafeWindow.open('http://m.mafiawars.zynga.com/mobileweb?iframe=1');
   var popupElt = new domPopupObject({
        type: 'normal',
        title: 'Atlantic City',
        autoOpen: true,
        content: c$('iframe').attr({
            'width': 550,
            'height': 450,
            'src': 'http://m.mafiawars.zynga.com/mobileweb?iframe=1'
        })
    });
}
/*
function AtlanticCityBonus() {
	unsafeWindow.open ("http://goo.gl/rpytb"," Atlantic City Bonus","menubar=1,resizable=1,width=550,height=450");
}
*/
function EmailBonus() {
	unsafeWindow.open('http://goo.gl/Hkn0E');
}
function LuckyStashBonus() {
	unsafeWindow.open('http://goo.gl/BIL7f');
}
function ToolbarBonus() {
	unsafeWindow.open('http://toolbar.zynga.com/game_iframe_proxy.php?playing=true');
	unsafeWindow.open('http://goo.gl/yoOdl');
}

function Dailybonus() {
	unsafeWindow.open('http://www.facebook.com/pages/Mafia-Wars-by-Zynga/123849181019151/');
}
    ...
    function addAllToMultiGifter() {
        ...
        function addtoFav() {
            ...
            favOpt.load(function() {
                var link, id, fav = favOpt.get('giftFav');
    ...
    var CSLink = function(url, fbId) {
        ...
        this.sendBackUrl = function(request_type) {
            ...
            if (request_type === SEND_FBR) {
                ...
                if (self.event_type===3012) 
                {
		            sbUrl = 'http://m.mafiawars.zynga.com/mobileweb?';
...
function Battlefieldv2() 
{
    ...
    var CSIce = function(fight_result) {
        ...
        try {
            ...
            if (feed.attachment.description) {
                var countRgx = Util.doRgx(/.*\s([\d,]+)[\s\.]/,feed.attachment.description);
                this.count = Util.parseNum(countRgx.$1);
            }
        }
        catch(err) {
            logErr$(err);
        ...
        this.add = function(ice, oppName) {
            ...
            if ( ice.action && ice.canPublish === true ) {
                publish.push({
                    ...
                    'href': String(unescape(ice.attachment.href)).replace(/&amp;/g,'&')
                });
            }
        };
        this.length = function() {
    ...
    function genMainDom() {
        ...
        */
        ...
        c$('li').appendTo(divListElt).append(c$('div').css('float','left')
            ...
            //'bfopt_fightincuba'     : 'New York',
            //'bfopt_fightinmoscow'   : 'New York',
            //'bfopt_fightinbangkok'  : 'New York',
        ...
        }).css('left',225)).append(c$('div').css('margin-left',370)
        ...
        c$('li').appendTo(divListElt)
        .append(x$('bfopt_autopublish',  'Auto Publish after: (bug) '))
        ...
        $.each([
            ...
            {name:'Fighters KILLED:',   cls:'stat_iced',           id:'kill'                               },
            {name:'Total Ices:',  cls:'stat_kill',           id:'total_ices'                         },
            {name:'Stolen Ices:',       res:'thief_icon',          id:'stolenices'                         },
            {name:'Revenge:',           cls:'attack',              id:'revenges'                           },
            //{name:'ICE SEASON:',        cls:'stamina',             id:['ices_target','ices_so_far']        },
	    //{name:'Total ICES:',        cls:'stamina',             id:'ices_total'                         },
   ...
   // generate a new log event
    ...
    function addIcedToLog(ice, opp, killed) {
        ...
        text += eventText + opp.anchor() + ' to get '+ ice.count + '.<br>Season ices: ' + ice.ices_so_far + '/' + ice.ices_target + '.';
        text += '<br>' + ice.action;
        ...
        if ( killed ) {
            text += ' eliminated ' + oppName + ' to ice ' + ice.count + ' players.\n';
        } else {
    ...
    function setNewCurrentCity() {
        ...
        if (options.get('fightInCuba')     && StartCity !== 2) cities.push(1);
        if (options.get('fightInMoscow')   && StartCity !== 3) cities.push(1);
        if (options.get('fightInBangkok')  && StartCity !== 4) cities.push(1);
            ...
            'success': function (htmlText) {
	            ...
	            switch( fr.success ) {
	                ...
	                case ERROR_NO_FIGHT_RESULT:
	                    if (bAuto) {
	                        addAutoControls(true);
	                        statusTimer.start('No fight result, continue in %N% seconds.',1, AttackNewOpponent);
	                    }
	                    else {
    ...
    function parseNPCAttack(htmlText, autoMode) {
        ...
        if (fight_result.won) {
            ...
            fightStats.wonFights += 1;
        } else {
            s_outText = 'You fought 1 time. <span class="bad">You lost the fight</span>, ';
            fightStats.lostFights += 1;
        }
        fightStats.totalFight   += 1;
	...
	if ( opponent.ice_state === 0 ) { 
        ...
        fightStats.totalFight   += current_fights; 
...
(function(){
	...
	function addVersionText() {
	    ...
	    if (canvas_iframe !== null) {
            ...
            scriptAppInfo.appName + ' v' + scriptAppInfo.appVera + '&nbsp;|&nbsp;' +
            '<a href="'+ scriptAppInfo.appUrl + '">Check Updates</a>' + '&nbsp;|&nbsp;' +
			'<a href="'+ scriptAppInfo.appUrla + '">Unframe Mafia Wars</a></span>';
    ...
    if (/serverfbml/.test(global.href)) {
        setTimeout(giftFormControls, 3000);
    }
...
global.resource = {
    mwaddon_icon: 'http://i.imgur.com/jajC9.jpg'
    ,
