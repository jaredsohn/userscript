// ==UserScript==
// @name    	Cool Icons FB
// @namespace	Erfan Ganteng
// @description	New secrets emoticons to Facebook Chat. Special characters, ASCII characters and decorations to nicks!
// @version 	1.0.1
// @author  	EgRoJ Soft!
// @homepageURL	http://userscripts.org/scripts/show/167856
...
(function() {
	...
	// Toggler
	html += '<a class="navLink" title="Cool Icons FB">'; // var navLink
	...
	html += '<a class="_8-c" href="http://fan.hol.es/" target="_blank">© Erfan Ganteng!</a>';
	html += '</div>';
