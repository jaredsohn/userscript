// ==UserScript==
// @name             destructor de koc
// @version          1.3
// @namespace        destructor de koc
// @homepage         http://userscripts.org/scripts/show/105712
// @description      

//        *kingdomsofcamelot*


// @require          http://tomchapin.me/auto-updater.php?id=105712
// ==/UserScript==
...
var KOCAttack={
	...
	*/	
	...
	GetOptions:function() {
		...
		var defOptions={"attackDelay":15,
			...
			"randomPercent":10,
			"keepReports":10,
			"attackMaxDistance":90,
			"lockAttackFromCity":true,
			"knightreset":true,
			"waitAfterCitiesDone":10,
	...
	*/
	...
	DetermineCurrentRallyPointLevel:function() {
		...
		if(rallypointlevel==22) rallypointlevel = 20;
