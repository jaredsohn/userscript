// ==UserScript==
// @name   بحث منتديات المنار بواسطة جوجل
// @author   ahmed brikaa
...
(function(){
	...
	function addTheButton(theForm, formName) {
		...
		if (target) {
			...
			button.setAttribute('onclick', "var el=document.forms['" + formName + "'].q; var thisForm=document.forms['" + formName + "']; el.value=el.value+' site:tebelmnar.com'; thisForm.submit()"); 
