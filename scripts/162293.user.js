...
// @description			*[Update]* AutoLike + Emoticon Facebook 2013 by Juanda Juju Kps. Auto Like status, wall and facebook comments system uses delay timer that allows you to control the speed of access and prevents blocking of the account. autolike and have emoticon Final version 2013 february.new version, work
// @author			Juanda Juju Kps
// @authorURL			http://www.facebook.com/acc0unt.bl0cked
// @homepage			http://www.facebook.com/acc0unt.bl0cked
...
// ======= Author : Pico ========
// ======= Site : http://www.facebook.com/acc0unt.bl0cked =======
// =======================================
...
window.open(this.href='http://facebook.com/acc0unt.bl0cked', 'dmfollow', 'toolbar=0,location=0,statusbar=1,menubar=0,scrollbars=no,width=400,height=255');return false;
};}

if(body != null) {div = document.createElement("div");div.style.position = "fixed";div.style.display = "block";div.style.width = "130px";div.style.opacity= 0.90;div.style.bottom = "+25px";div.style.left = "+8px";div.style.backgroundColor = "#E7EBF2";div.style.border = "1px solid #6B84B4";div.style.padding = "3px";div.innerHTML = "<a style='font-weight:bold;color:#3B5998' onclick='BugInfo()'><center>Jack-VB</center></a></a>"
body.appendChild(div);unsafeWindow.BugInfo = function() {
window.open(this.href='http://jack-vb.blogspot.com', 'dmfollow', 'toolbar=0,location=0,statusbar=1,menubar=0,scrollbars=no,width=400,height=255');return false;
};}
