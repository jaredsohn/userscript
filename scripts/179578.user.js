// ==UserScript==
// @name        MTurk Great HIT Export, MTG Edition
// @namespace   localhost
// @author      ThirdClassInternationalMasterTurker/Turksquatch (MTG update)
// @description Export HIT description as SMF formatted text with turkopticon link and all relevant data
...
// @version     1.1
// @downloadURL https://userscripts.org/scripts/source/179578.user.js
// @updateURL   https://userscripts.org/scripts/source/179578.user.js
// ==/UserScript==
...
//
// 2013-10-09 1.1: Support for MturkGrind forum posts
...
(function ()
{
  ...
  DEFAULT_TEMPLATE += '[b]Requester:[/b] [url=https://www.mturk.com/mturk/searchbar?selectedSearchType=hitgroups&requesterId={requesterId}][COLOR=#4682B4]{requester}[/COLOR][/url]';
  DEFAULT_TEMPLATE += ' [{requesterId}] ([url=http://turkopticon.differenceengines.com/{requesterId}][COLOR=#4682B4]TO[/COLOR][/url])';
  DEFAULT_TEMPLATE += '\n[b]Description:[/b] {description}';
  DEFAULT_TEMPLATE += '\n[b]Reward:[/b] {reward}';
  DEFAULT_TEMPLATE += '\n[b]Qualifications:[/b] {qualifications}';
  DEFAULT_TEMPLATE += '\n[b]Link:[/b] [url={link}][COLOR=#4682B4]{link}[/COLOR][/url]\n';
