...
// ==UserScript==
// @name           The Horizontal Way Redirect
// @namespace      http://binq.org/greasemonkey/
// @description    The Horizontal Way Redirect v2.0: CSS Beauty pages that are opened in a new tab/window take you directly to the dugg article.  It's very useful when looking through RSS feeds.
// @include        http://*.thehorizontalway.com/*/*
// @include        http://thehorizontalway.com/*/*
// ==/UserScript==
...
BINQ.thehorizontalwayLinkJumper = {
	init: function() {
		this.jumpToFirstValidLink = BINQ.linkJumper.jumpToFirstValidLink;
		return this;
	},
	searchPath: "//div[@class='storycontent']//a[1]",
}

if (history.length == 1) { BINQ.thehorizontalwayLinkJumper.init().jumpToFirstValidLink(); }