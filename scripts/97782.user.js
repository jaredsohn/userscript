...
var config = {
  auto_hunt: true,			    // Vadászat automatikus folytatása
  autohunt_wait: 5,			  // Vadászat folytatása előtti max várakozás (másodperc)
  auto_hunt_count: 20,      // ennyi vadászat megy le egyszerre maximum
  auto_submit: true,			  // Kész gombra kattintás
  auto_random: true,			  // hianyzó válasznal tippelés
  autorandom_idle_time: 6	// várakozás (másodperc) a tippelés előtt autorandom eseten
};
...
settings = {
	version: "4.41",
	server_url: "http://vukviz.tarhely.biz/",
	talalat: false
};
