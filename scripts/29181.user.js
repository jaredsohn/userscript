...
// @frequency   12 hours
// @releaseURL  http://userscripts.org/scripts/source/29181.meta.js
// @scriptURL   http://userscripts.org/scripts/source/29181.user.js
// @releaseURL  http://userscripts.org/scripts/review/29181?format=txt
// @scriptURL   http://userscripts.org/scripts/source/29181.user.js
// @releaseURL  http://userscripts.org/scripts/source/29181.user.js?
// @scriptURL   http://userscripts.org/scripts/source/29181.user.js
...
//(EDIT THESE LINES to change your configuration)
//-=- basic settings
var O_LL='';
 //(edit this to always show the price map page starting from a specific
 // state; to change this, go to the map page, set it how you want it,
 // click "Link to map", copy everything after the "?" in the box that
 // appears, and paste that text between the quotes above)
var O_TL=false;
 //(change this to "true" to force a line break between dates and times
 // on the topic list pages)
var O_RV=false;
 //(change this to "true" to always start with "oldest first" ordering
 // for forum message pages)
//-=- advanced settings
//(do not change unless you know what you're doing)
var O_TT=false;//(this setting is only pertinent to Firefox)
var O_MS=false;
 //(change this to "true" to allow editing of site and state on MSL
 // editing pages)
   ...
   {nct=nct.innerHTML;
    ...
    {el2=document.getElementById('MemProfile1_InviteBuddy');
     ...
     {nch=document.createElement('br');
      ...
      roe.href='/pm_send.aspx?to='+encodeURIComponent(nct);
...
{return new Array
 ...
 );};//Opera wants the final "}" on this line; I have no idea why
