// ==UserScript==
// @name        Costumizable Express
// @namespace   Express For Costumize Facebook 
// @description Enhancements for Facebook look and function
...
// Last edited 2011-3-9

/*

This copyright section and all credits in the script must be included in modifications or redistributions of this script.

Genocide Script is Copyright (c) 2011, Rui Fujiwara
Genocide Script is licensed under a Creative Commons Attribution-Share Alike 3.0 Unported License
License information is available here: http://ruifujiwara.co.cc

Facebook is a registered trademark of Facebook, Inc.
Genocide Script is not related to or endorsed by Facebook, Inc. in any way.
...
* Fixed a bug where Genocide Script's bookmarks would appear underneath other items on the page.
...
* Added Vietnamese localization, thanks to Zhack.
* Updated Norwegian localization, thanks to Uverta .
* Updated Greek localization, thanks to Dimitris Farah Athena Sarlis.
* Added Macedonian and Korean to the drop down menu for Genocide Script languages (I had forgotten to add them before).
...
* Added Korean localization - thanks to Kim Jeu Hee
* Updated localizations:
* 	Czech - thanks to Ufta Zarmarov
* 	Greek - thanks to Dimitris Farah Athena Sarlis
* 	Serbian - thanks to Gorštak
* 	Turkish - thanks to Walid Hadim
...
var lang = {
	...
	en : {
		...
		'Close' : 'Close',
		'ConfigureFacebookFixer' : 'Facebook Express',
		'ConfigureInstructions' : 'Facebook Express is software to modify configuration system of Facebook page and you can look review of this program at http://ruifujiwara.co.cc',
		...
		'ConfFacebookFixerLanguage' : 'Language for Genocide Script',
		'ConfFacebookTimestamps' : 'Show Facebook timestamps (eg. "3 hours ago").',
		'ConfFBFTimestamps' : 'Add Genocide Script timestamps after Facebook timestamps (eg. "11:45").',
		'ConfFBFTimestamps24' : 'Show Genocide Script timestamps in 24-hour format.',
		...
		'ConfSectionAbout' : 'About Genocide Script',
		...
		'ConfUpdates' : 'Check Userscripts.org daily for updates to Genocide Script. Or <a href="#" id="fbfUpdateLink" onclick="return false;">check now</a>.',
		...
		'UpdateAvailable1' : 'An update is available for Genocide Script',
	...
	// Spanish - Contributed by Joan Pedro and Genocide (20110626)
	es : {
		'_language' : 'Spanish',
		...
		'Close' : 'Cerrar',
		'ConfigureFacebookFixer' : 'Configuración de Genocide Script',
		...
		'ConfFacebookFixerLanguage' : 'Lenguaje del Genocide Script',
		'ConfFacebookTimestamps' : 'Mostrar cuanto hace que fue creado (Ejemplo: "Hace 3 horas").',
		'ConfFBFTimestamps24' : 'Mostrar las marcas de tiempo de Genocide Script en formato 24 horas.',
		'ConfFBFTimestamps' : 'Añadir las marcas de tiempo de Genocide Script después de las marcas de tiempo de Facebook (Por ejemplo "11:45").',
		...
		'ConfSectionAbout' : 'Acerca de Genocide Script',
		...
		'ConfShortcutList' : '<b>Atajos de Teclado</b> (sensible a la diferencia entre minúsculas y mayúsculas):<br /><br /><i>Desde cualquier página:</i><br />&nbsp;<b>A</b> - Álbumes/Fotos<br />&nbsp;<b>B</b> - Activar/Desactivar lista de amigos (Amigos conectados)<br />&nbsp;<b>C</b> - Configuración de Genocide Script<br />&nbsp;<b>D</b> - Cumpleaños<br />&nbsp;<b>E</b> - Eventos<br />&nbsp;<b>F</b> - Amigos<br />&nbsp;<b>H</b> - Página de Inicio<br />&nbsp;<b>I</b> - Bandeja de Entrada<br />&nbsp;<b>K</b> - Añadir Marcador<br />&nbsp;<b>L</b> - Seleccionar vínculo para terminar la sesión (presione Enter después para terminar la sesión)<br />&nbsp;<b>N</b> - Notificaciones<br />&nbsp;<b>P</b> - Perfil<br />&nbsp;<b>R</b> - Peticiones<br />&nbsp;<b>S</b> - Saltar a el campo de búsqueda<br />&nbsp;<b>T</b> - Traducir el texto seleccionado<br />&nbsp;<b>?</b> - Mostrar la información de depuración de Genocide Script<br />&nbsp;<b><escape></b> - Cerrar la ventana emergente creada por Genocide Script<br /><br /><i>Desde la página de inicio (filtros)</i>:<br />&nbsp;<b>a</b> - Páginas<br />&nbsp;<b>f</b> - Live feed<br />&nbsp;<b>g</b> - Grupos<br />&nbsp;<b>l</b> - Vínculos<br />&nbsp;<b>n</b> - Noticias<br />&nbsp;<b>p</b> - fotos<br />&nbsp;<b>s</b> or <b>u</b> - Estatus de las Actualizaciones<br />&nbsp;<b>t</b> - Notas<br />&nbsp;<b>v</b> - Vídeos<br /><br /><i>Desde los perfiles</i>:<br />&nbsp;<b>i</b> - Información<br />&nbsp;<b>p</b> - Fotos<br />&nbsp;<b>w</b> - Muro<br />&nbsp;<b>x</b> - Cajas<br /><br /><i>Desde las páginas con paginación (previo, siguiente, etc)</i><br />&nbsp;<b><left arrow></b> - Previo<br />&nbsp;<b><right arrow></b> - Siguiente<br />&nbsp;<b><shift> + <left arrow></b> - Primera (cuando este disponible)<br />&nbsp;<b><shift> + <right arrow></b> - Ultimo (cuando este disponible)<br /><br /><i>Al ver albumes/fotos:</i><br />&nbsp;<b>a</b> - Ver todas la miniaturas (cuando este disponible)<br />&nbsp;<b>b</b> - Ver fotos grandes<br />&nbsp;<b>c</b> - Ver comentarios<br />&nbsp;<b>k</b> - De vuelta al álbum<br />&nbsp;<b>m</b> - Fotos de (personas) y yo<br /><br /><i>Al ver albumes recientes y fotos subidas/marcadas:</i><br />&nbsp;<b>a</b> or &nbsp;<b>r</b> - Albumes Recientes<br />&nbsp;<b>m</b> or &nbsp;<b>u</b> - Fotos de Móviles<br />&nbsp;<b>o</b> - Fotos de mi<br />&nbsp;<b>p</b> - Mis Fotos<br />&nbsp;<b>t</b> or &nbsp;<b>f</b> - Amigos Marcados', 'ConfTopBarHoverOpacity' : 'Al pasar el ratón por encima', 'FacebookFixerConflict' : 'Facebook Fixer ahora se llama Genocide Script.<br /><br />Por el cambio de nombre es necesario desinstalar Facebook Fixer manualmente de su navegador o los dos programas entraran en conflicto.<br /><br />Si no sabe como desinstalar un userscript, <a %s>haga clic aquí para ver instrucciones</a>.',
		...
		'ConfUpdates' : 'Revisar Userscripts.org diarimente por si hay actualizaciones en Genocide Script. O <a href="#" id="fbfUpdateLink" onclick="return false;">revisar Ahora</a>.',
		...
		'FacebookFixerConflict' : 'Facebook Fixer ahora se llama Genocide Script.<br /><br />Por el cambio de nombre es necesario desinstalar Facebook Fixer manualmente de su navegador o los dos programas entraran en conflicto.<br /><br />Si no sabe como desinstalar un userscript, <a %s>haga clic aquí para ver instrucciones</a>.',
		...
		'UpdateAvailable1' : 'Hay una actualización disponible para Genocide Script',
	...
	// French - Contributed by Ryan Endika Chandra (20110329)
	fr : {
		'_language' : 'French',
		...
		'Close' : 'Fermer',
		'ConfigureFacebookFixer' : 'Configurer Genocide Script',
		...
		'ConfFacebookFixerLanguage' : 'Langue de Genocide Script',
		'ConfFacebookTimestamps' : 'Affichage de la datation Facebook (ex. "Il y a 3 heures").',
		'ConfFBFTimestamps' : 'Ajout de la datation Genocide Script apr&egrave;s la datation Facebook (ex. "11:45").',
		'ConfFBFTimestamps24' : 'Affichage de la datation Genocide Script au format 24 heures.',
		...
		'ConfSectionAbout' : 'A propos de Genocide Script',
		...
		'ConfUpdates' : 'V&eacute;rifie quotidiennement si une mise &agrave; jour de Genocide Script est disponible sur Userscripts.org. Ou <a href="#" id="fbfUpdateLink" onclick="return false;">v&eacute;rifier maintenant</a>.',
		...
		'FacebookFixerConflict' : 'Genocide Script est maintenant devenu Genocide Script. A cause du changement de nom, vous aurez besoin de d&eacute;sinstaller manuellement Genocide Script de votre explorateur, ou les deux scripts rentreront en conflit. Si vous n\'&ecirc;tes pas s&ucirc;r de comment faire pour d&eacute;sinstaller un userscript, <a %s>cliquez ici pour la marche &agrave; suivre</a>.',
		...
		'Left' : 'Gauche',
		'ListeningRestarted' : 'Genocide Script s\'est remit \340 l\'\351coute des changements \351ventuels.',
		'ListeningStopped' : 'Genocide Script a arret\351 d\'\352tre \340 l\'\351coute des changements \351ventuels.\nAppuyez sur L (SHIFT + l) pour r\351-activer l\'\351coute',
		...
		'UpdateAvailable1' : 'Une mise &agrave; jour de Genocide Script est disponible',
	...
	// Italian - Contributed by Dario Archetti (20110328)
	it : {
		'_language' : 'Italian',
		...
		'Close' : 'Chiudi',
		'ConfigureFacebookFixer' : 'Impostazioni di Genocide Script',
		...
		'ConfFacebookFixerLanguage' : 'Lingua di Genocide Script',
		...
		'ConfSectionAbout' : 'Riguardo di Genocide Script',
		...
		'FacebookFixerConflict' : 'Genocide Script ha cambiato nome in Genocide Script. A causa del cambiamento dovrai disinstallare manualmente Genocide Script dal tuo browser, o i due script andranno in conflitto. Se non sei sicuro di come disinstallare un userscript <a %s>clicca qui per le istruzioni</a>.',
		...
		'Left' : 'Sinistra',
		'ListeningRestarted' : 'Registrazione dei cambiamenti da parte di Genocide Script attivata.',
		'ListeningStopped' : 'Registrazione dei cambiamenti da parte di Genocide Script disattivata.\nPremi L (SHIFT + l) per riabilitare la registrazione.',
		...
		'UpdateAvailable1' : 'È disponibile un update per Genocide Script.',
	...
	de : {
		...
		'Close' : 'Schließen',
		'ConfigureFacebookFixer' : 'Genocide Script konfigurieren',
		...
		'ConfFacebookFixerLanguage' : 'Sprache für Genocide Script',
		...
		'ConfUpdates' : 'UÜberprüfen Sie Userscripts.org täglich auf Updates für Genocide Script. <a href="#" id="fbfUpdateLink" onclick="return false;">Jetzt überprüfen</a>.',
		...
		'Left' : 'Links',
		'ListeningRestarted' : 'Genocide Script reagiert wieder auf Änderungen.',
		'ListeningStopped' : 'Genocide Script reagiert nicht auf Änderungen.\nL (SHIFT + l) drücken, um die Reaktion wieder zu aktvieren.',
		...
		'today' : 'heute',
		'UpdateAvailable1' : 'Es gibt ein Update für Genocide Script',
	...
	bg : {
		...
		'Close' : 'Затваряне',
		'ConfigureFacebookFixer' : 'Конфигуриране на Genocide Script',
		...
		'ConfFacebookFixerLanguage' : 'Език за Genocide Script',
		...
		'ConfUpdates' : 'Проверяване на Userscripts.org ежедневно за ъпдейти на Genocide Script. Или <a href="#" id="fbfUpdateLink" onclick="return false;">проверка сега</a>.',
		...
		'Left' : 'Отляво',
		'ListeningRestarted' : 'Genocide Script възстанови проверките за промени.',
		'ListeningStopped' : 'Genocide Script спря проверките за промени.\nНатиснете L (Shift + l) за повторно пускане',
		...
		'today' : 'днес',
		'UpdateAvailable1' : 'Излязло е обновление на Genocide Script',
	...
	// Greek - Contributed by Dimitris Farah Athena Sarlis (20111024)
	el : {
		'_language' : 'Greek',
		...
		'Close' : 'Κλείσιμο',
		'ConfigureFacebookFixer' : 'Διαμόρφωση Genocide Script',
		...
		'ConfFacebookFixerLanguage' : 'Γλώσσα για το Genocide Script',
		'ConfFacebookTimestamps' : 'Εμφάνιση της ώρας του Facebook (πχ. "Πριν 3 ώρες").',
		'ConfFBFTimestamps' : 'Προσθήκη της ώρας του Genocide Script μετά από την ώρα του Facebook (πχ. "11:45").',
		'ConfFBFTimestamps24' : 'Εμφάνιση της ώρας του Genocide Script σε 24-ωρη μορφή.',
		...
		'ConfSectionAbout' : 'Σχετικά με το Genocide Script',
		...
		'ConfUpdates' : 'Έλεγχος Userscripts.org καθημερινά για καινούργιες ενημερώσεις του Genocide Script ή <a href="#" id="fbfUpdateLink" onclick="return false;">έλεγχος τώρα</a>.',
		...
		'UpdateAvailable1' : 'Υπάρχει καινούργια διαθέσιμη έκδοση του Genocide Script',
	...
	// Slovak - Contributed by Rutheford (20110817)
	sk : {
		'_language' : 'Slovak',
		...
		'Close' : 'Zavrieť',
		'ConfigureFacebookFixer' : 'Konfigurovať Genocide Script',
		...
		'FacebookFixerConflict' : 'Facebook Fixer sa odteraz nazýva Genocide Script.<br /><br />Pretože sa zmenil názov, je potrebné ručne odinštalovať Facebook Fixer z prehliadača, inak budú v konflikte dva skripty medzi sebou navzájom.<br /><br />Ak neviete, ako skript odinštalovať, <a %s>kliknutím sem otvorte pokyny</a>.',
	...
	// Dutch - Contributed by Asy van Collev (20091107)
	nl : {
		'_language' : 'Dutch',
		...
		'Close' : 'Sluit',
		'ConfigureFacebookFixer' : 'Configureer Genocide Script',
		...
		'ConfFacebookFixerLanguage' : 'Taal voor Genocide Script',
		'ConfFacebookTimestamps' : 'Laat Facebook timestamps zien (bijv. "3 uur geleden").',
		'ConfFBFTimestamps' : 'Genocide Script timestamps toevoegen na Facebook timestamps (bijv. "11:45").',
		'ConfFBFTimestamps24' : 'Laat Genocide Script timestamps zien in 24-uurs formaat.',
		...
		'ConfUpdates' : 'Check Userscripts.org dagelijks voor updates naar Genocide Script. Of <a href="#" id="fbfUpdateLink" onclick="return false;">check nu</a>.',
		'DownloadVideo' : 'Download Video',
		...
		'today' : 'vandaag',
		'UpdateAvailable1' : 'Een update is beschikbaar voor Genocide Script',
	...
	// Chinese (Taiwan) - Contributed by By Ren Tao (20110422)
	zh_tw : {
		...
		'CreatingFile' : '創建文件',
		'Close' : '關閉',
		'ConfigureFacebookFixer' : '設定 Genocide Script',
		...
		'ConfFacebookFixerLanguage' : 'Genocide Script的語言選項',
		'ConfFacebookTimestamps' : '顯示Facebook原來的時間戳記 (eg. "3 hours ago").',
		'ConfFBFTimestamps' : '新增Genocide Script的顯示時間戳記 (eg. "11:45").',
		'ConfFBFTimestamps24' : 'Genocide Script的時間戳記採用24小時制。',
		...
		'ConfSectionAbout' : '關於 Genocide Script',
		...
		'ConfShortcutList' : '<b>鍵盤快捷鍵</b> (大小寫區分):<br /><br /><i>從任何頁面:</i><br />&nbsp;<b>A</b> - 相本/相片<br />&nbsp;<b>B</b> - 切換好友列表 (在線好友)<br />&nbsp;<b>C</b> - Genocide Script 設置<br />&nbsp;<b>D</b> - 生日<br />&nbsp;<b>E</b> - 活動<br />&nbsp;<b>F</b> - 朋友<br />&nbsp;<b>H</b> - 首頁<br />&nbsp;<b>I</b> - 信箱<br />&nbsp;<b>L</b> - 選擇登出連結 (按下確定後登出)<br />&nbsp;<b>N</b> - 通知<br />&nbsp;<b>P</b> - 你的個人資料<br />&nbsp;<b>R</b> - 請求<br />&nbsp;<b>S</b> - 跳到搜索欄位<br />&nbsp;<b>T</b> - 翻譯選擇的內容<br />&nbsp;<b>?</b> - 顯示Genocide Script除錯訊息<br />&nbsp;<b>&lt;escape&gt;</b> - 使用Genocide Script關閉彈出視窗<br /><br /><i>從首頁 (過濾)</i>:<br />&nbsp;<b>a</b> - 頁面<br />&nbsp;<b>f</b> - 即時動態<br />&nbsp;<b>g</b> - 團體<br />&nbsp;<b>l</b> - 連結<br />&nbsp;<b>n</b> - 新的動態<br />&nbsp;<b>p</b> - 相片<br />&nbsp;<b>s</b> or <b>u</b> - 更新狀態<br />&nbsp;<b>t</b> - 筆記<br />&nbsp;<b>v</b> - 影片<br /><br /><i>從個人資料</i>:<br />&nbsp;<b>i</b> - 信息<br />&nbsp;<b>p</b> - 相片<br />&nbsp;<b>w</b> - 牆<br />&nbsp;<b>x</b> - 盒子<br /><br /><i>從網頁的頁碼 (previous, next, etc)</i><br />&nbsp;<b>&lt;left arrow&gt;</b> - Previous<br />&nbsp;<b>&lt;right arrow&gt;</b> - 下一個<br />&nbsp;<b>&lt;shift&gt; + &lt;left arrow&gt;</b> - 首先 (當可以使用)<br />&nbsp;<b>&lt;shift&gt; + &lt;right arrow&gt;</b> - 最後 (當可以使用)<br /><br /><i>當瀏覽相本/相片:</i><br />&nbsp;<b>a</b> - 讀取所有縮圖 (當可以使用)<br />&nbsp;<b>b</b> - 顯示大張的圖片<br />&nbsp;<b>c</b> - 查看留言<br />&nbsp;<b>k</b> - 返回相本<br />&nbsp;<b>m</b> - 照片 (個人) 和我<br /><br /><i>查看最近上傳/標記的相片:</i><br />&nbsp;<b>a</b> or &nbsp;<b>r</b> - 最新的相本<br />&nbsp;<b>m</b> or &nbsp;<b>u</b> - 手機上傳<br />&nbsp;<b>o</b> - 我的相片<br />&nbsp;<b>p</b> - 我的相片<br />&nbsp;<b>t</b> or &nbsp;<b>f</b> - 標記的朋友',
		...
		'ConfUpdates' : '檢查 Userscripts.org For Genocide Script 的更新。 或是 <a href="#" id="fbfUpdateLink" onclick="return false;">立即確認</a>.',
		'DownloadVideo' : '下載影片',
		'ExportICalendarFile' : '輸出 iCalendar 檔案',
		'ExportICalendarFileWarning' : '(如果你有很多的朋友的話，將要一段時間)',
		'FacebookFixerConflict' : 'Facebook Fixer現在更名為Genocide Script。<br /><br />由於更改名稱，你需要手動從瀏覽器中卸載舊的Facebook Fixer腳本，因為兩個腳本會相互衝突。<br /><br />如果你不確定如何去移除腳本， <a %s>點擊說明部份</a>.',
		...
		'today' : 'today',
		'UpdateAvailable1' : 'Genocide Script 有可用的更新。',
	...
	// Turkish - Contributed by Walid Hadim (20110817)
	tr : {
		'_language' : 'Turkish',
		...
		'Close' : 'Kapat',
		'ConfigureFacebookFixer' : 'Genocide Script\'ı Yapılandır',
		...
		'ConfFacebookFixerLanguage' : 'Genocide Script\'ın Dili',
		'ConfFacebookTimestamps' : 'Facebook\'un zaman etiketlerini göster (örn. "3 saat önce").',
		'ConfFBFTimestamps' : 'Facebook\'un zaman etiketlerinin ardından Genocide Script zaman etiketlerini ekle (örn. "11:45").',
		'ConfFBFTimestamps24' : 'Genocide Script zaman etiketlerini 24-saat biçiminde göster',
		...
		'ConfSectionAbout' : 'Genocide Script Hakkında',
		...
		'ConfUpdates' : 'Genocide Script güncellemeleri için her gün Userscripts.org\'u ziyaret et. Ya da <a href="#" id="fbfUpdateLink" onclick="return false;">şimdi kontrol et</a>.',
		...
		'FacebookFixerConflict' : 'Genocide Script\'ın yeni adı artık Genocide Script. İsim değişikliğinden dolayı Genocide Script\'ı tarayıcınızdan kaldırmanız gerekiyor, yoksa bu iki script birbiriyle uyuşmazlık sorunları çıkaracaktır. Eğer bir userscript\'i nasıl kaldıracağınızdan emin değilseniz <a %s>buraya tıklayarak öğrenebilirsiniz</a>.',
		...
		'UpdateAvailable1' : 'Genocide Script için bir güncelleme mevcut',
	...
	// Serbian (Cyrillic) - Contributed by Горштак (20110817)
	sr_rs : {
		...
		'Close' : 'Затвори',
		'ConfigureFacebookFixer' : 'Подеси Genocide Script',
		...
		'ConfFacebookFixerLanguage' : 'Језик Genocide Script-а',
		'ConfFacebookTimestamps' : 'Прикажи Фејсбук време (нпр. "пре 3 сата").',
		'ConfFBFTimestamps' : 'Додај Genocide Script време после Фејсбук времена (нпр. "11:45").',
		'ConfFBFTimestamps24' : 'Прикажи Genocide Script времена у 24-часовном облику.',
		...
		'ConfSectionAbout' : 'О додатку Genocide Script',
		...
		'ConfUpdates' : 'Свакодневно проверавај Userscripts.org за надоградње Genocide Script-а. Или <a href="#" id="fbfUpdateLink" onclick="return false;">провери сада</a>.',
		...
		'FacebookFixerConflict' : 'Genocide Script се сада зове Genocide Script. Због промене имена мораћете ручно да уклоните Genocide Script из свог прегледача да не би дошло до ометања између ове две скрипте. Ако нисте сигурни како да уклоните скрипту, <a %s>кликните овде за упутство</a>.',
		...
		'UpdateAvailable1' : 'Доступне су надоградње за Genocide Script',
	...
	// Serbian (Latin) - Contributed by Armar Saniv(20110817)
	sr : {
		...
		'Close' : 'Zatvori',
		'ConfigureFacebookFixer' : 'Podesi Genocide Script',
		...
		'ConfFacebookFixerLanguage' : 'Jezik Genocide Script-a',
		'ConfFacebookTimestamps' : 'Prikaži Fejsbuk vreme (npr. "pre 3 sata").',
		'ConfFBFTimestamps' : 'Dodaj Genocide Script vreme posle Fejsbuk vremena (npr. "11:45").',
		'ConfFBFTimestamps24' : 'Prikaži Genocide Script vremena u 24-časovnom obliku.',
		...
		'ConfSectionAbout' : 'O dodatku Genocide Script',
		...
		'ConfUpdates' : 'Svakodnevno proveravaj Userscripts.org za nadogradnje Genocide Script-a. Ili <a href="#" id="fbfUpdateLink" onclick="return false;">proveri sada</a>.',
		...
		'FacebookFixerConflict' : 'Genocide Script se sada zove Genocide Script. Zbog promene imena moraćete ručno da uklonite Genocide Script iz svog pregledača da ne bi došlo do ometanja između ove dve skripte. Ako niste sigurni kako da uklonite skriptu, <a %s>kliknite ovde za uputstvo</a>.',
		...
		'UpdateAvailable1' : 'Dostupne su nadogradnje za Genocide Script',
	...
	// Danish - Contributed by Ruzita (20110210)
	da : {
		'_language' : 'Danish',
		...
		'Close' : 'Luk',
		'ConfigureFacebookFixer' : 'Konfigurér Genocide Script',
		...
		'ConfFacebookFixerLanguage' : 'Sprog i Genocide Script',
		'ConfFacebookTimestamps' : 'Vis Facebook tidsstempler (f.eks. "3 timer sider").',
		'ConfFBFTimestamps' : 'Tilføj Genocide Script tidsstempler efter Facebook tidsstempler (f.eks. "11:45").',
		'ConfFBFTimestamps24' : 'Vis Genocide Script tidsstempler i 24 timers format.',
		...
		'ConfSectionAbout' : 'Omkring Genocide Script',
		...
		'ConfUpdates' : 'Undersøg Userscripts.org dagligt for opdateringer til Genocide Script. Eller <a href="#" id="fbfUpdateLink" onclick="return false;">undersøg nu</a>.',
		...
		'FacebookFixerConflict' : 'Genocide Script vil fremover hedde Genocide Script. På grund af navneskiftet, skal du manuelt afinstallere Genocide Script fra dine browsere, da de to scripts ellers vil komme i konflikt med hinanden. Hvis du er usikker på hvordan man afinstallerer et Userscript, så <a %s>tryk her for instruktioner</a>.',
		'fullAlbumLoaded' : 'Hele albummet hentet',
		'Left' : 'Venstre',
		'ListeningRestarted' : 'Genocide Script lytter efter ændringer igen.',
		'ListeningStopped' : 'Genocide Script er stoppet med at lytte efter ændringer.\nTryk L (SHIFT + l) for at starte igen',
		...
		'today' : 'i dag',
		'UpdateAvailable1' : 'En opdatering er tilgængelig til Genocide Script',
	...
	// Czech - Contributed by Ufta Zarmarov (20110823)
	cs : {
		'_language' : 'Czech',
		...
		'Close' : 'Zavřít',
		'ConfigureFacebookFixer' : 'Nastavení - Genocide Script',
		...
		'ConfFacebookFixerLanguage' : 'Jazyk pro Genocide Script',
		'ConfFacebookTimestamps' : 'Zobrazit časové značky Facebooku (t. j. "před 3 hodinami")',
		'ConfFBFTimestamps' : 'Přidat časové značky skriptu Genocide Script za časové značky Facebooku (t. j. "11:45")',
		'ConfFBFTimestamps24' : 'Zobrazit časové značny skriptu Genocide Script v 24-hodinovém formátě',
		...
		'ConfSectionAbout' : 'O Genocide Scriptu',
		...
		'ConfShortcutList' : '<b>Klávesové zkratky</b> (rozlišují se malá/velká písmena):<br /><br /><i>Z libovolné stránky:</i><br />&nbsp;<b>A</b> - Alba/fotky<br />&nbsp;<b>B</b> - Přepnout seznam přátel (online přátel)<br />&nbsp;<b>C</b> - Konfigurace skriptu Genocide Script<br />&nbsp;<b>D</b> - Narozeniny<br />&nbsp;<b>E</b> - Události<br />&nbsp;<b>F</b> - Přátelé<br />&nbsp;<b>H</b> - Domů<br />&nbsp;<b>I</b> - Přijaté zprávy<br />&nbsp;<b>K</b> - Přidej záložku<br />&nbsp;<b>L</b> - Odhlášení (po odhlášení stiskněte Enter)<br />&nbsp;<b>N</b> - Upozornění<br />&nbsp;<b>P</b> - Váš profil<br />&nbsp;<b>R</b> - Žádosti<br />&nbsp;<b>S</b> - Přeskočit na pole Hledat<br />&nbsp;<b>T</b> - Přeložit vybraný text<br />&nbsp;<b>?</b> - Zobrazit informace o ladění skriptu Genocide Script<br />&nbsp;<b>&lt;escape&gt;</b> - Zavřít kontextová okna vytvořené skriptem Genocide Script<br /><br /><i>Ze stránky Domů (filtry)</i>:<br />&nbsp;<b>a</b> - Stránky<br />&nbsp;<b>f</b> - Aktuality<br />&nbsp;<b>g</b> - Skupiny<br />&nbsp;<b>l</b> - Odkazy<br />&nbsp;<b>n</b> - Novinky<br />&nbsp;<b>p</b> - Fotky<br />&nbsp;<b>s</b> nebo <b>u</b> - Co dělají ostatní<br />&nbsp;<b>t</b> - Poznámky<br />&nbsp;<b>v</b> - Videa<br /><br /><i>Z profilů</i>:<br />&nbsp;<b>i</b> - Informace<br />&nbsp;<b>p</b> - Fotky<br />&nbsp;<b>w</b> - Zeď<br />&nbsp;<b>x</b> - Kontejner<br /><br /><i>Ze stránek s navigací (dozadu, dopredu atd.)</i><br />&nbsp;<b>&lt;levá šipka&gt;</b> - Předchozí<br />&nbsp;<b>&lt;pravá šipka&gt;</b> - Následující<br />&nbsp;<b>&lt;shift&gt; + &lt;levá šipka&gt;</b> - První (pokud je dispozici)<br />&nbsp;<b>&lt;shift&gt; + &lt;pravá šipka&gt;</b> - Poslední (pokud je k dispozici)<br /><br /><i>Při prohlížení alb/fotek:</i><br />&nbsp;<b>a</b> - Načítat všechny miniatury (pokud je k dispozici)<br />&nbsp;<b>b</b> - Zobrazit velké obrázky<br />&nbsp;<b>c</b> - Zobrazit komentáře<br />&nbsp;<b>k</b> - Zpět do alba<br />&nbsp;<b>m</b> - Fotky (osoby) a moje<br /><br /><i>Při prohlížení nejnovějších alb a nahraných/označených fotek:</i><br />&nbsp;<b>a</b> nebo &nbsp;<b>r</b> - Nejnovější alba<br />&nbsp;<b>m</b> nebo &nbsp;<b>u</b> - Nahrané z mobilu<br />&nbsp;<b>o</b> - Fotky mé osoby<br />&nbsp;<b>p</b> - Mé fotky<br />&nbsp;<b>t</b> nebo &nbsp;<b>f</b> - Označení přátelé',
		...
		'ConfUpdates' : 'Denně na Userscripts.org ověřovat aktualizace pro Genocide Script, případně <a href="#" id="fbfUpdateLink" onclick="return false;">zkontrolovat nyní</a>.',
		...
		'FacebookFixerConflict' : 'Facebook Fifex je nyní znám jako Genocide Script.<br /><br />Protože se změnilo jméno, musíte manuálně odinstalovat Facebook Fixer z vašeho prohlížeče.<br /><br />Pokud si nevíte jak na to <a %s>pokračujte zde</a>.',
		...
		'UpdateAvailable1' : 'K dispozici je aktualizace skriptu Genocide Script.',
	...
	// Macedonian - Contributed by Ivan Hernan (20110628)
	mk : {
		...
		'Close' : 'Затвори',
		'ConfigureFacebookFixer' : 'Конфигурирај го Genocide Script',
		...
		'ConfFacebookFixerLanguage' : 'Јазик за Genocide Script',
		'ConfFacebookTimestamps' : 'Прикажи Facebook маркер за времето (eg. "3 часа старо").',
		'ConfFBFTimestamps' : 'Додади Genocide Script маркер за времето по Facebook маркерот за време (eg. "11:45").',
		'ConfFBFTimestamps24' : 'Прикажи Genocide Script маркер за време во 24-часовен формат.',
		...
		'ConfSectionAbout' : 'За Genocide Script',
		...
		'ConfShortcutList' : '<b>Кратенки за тастатура</b> (case sensitive):<br /><br /><i>Од секоја страница:</i><br />&nbsp;<b>A</b> - Albums/photos<br />&nbsp;<b>B</b> - Вклучи корисници (вклучени пријатели)<br />&nbsp;<b>C</b> - Genocide Script Конфигурација<br />&nbsp;<b>D</b> - Родендени<br />&nbsp;<b>E</b> - Настани<br />&nbsp;<b>F</b> - Пријатели<br />&nbsp;<b>H</b> - Почетна страница<br />&nbsp;<b>I</b> - Сандаче<br />&nbsp;<b>K</b> - Add Bookmark<br />&nbsp;<b>L</b> - Select the logout link (press Enter afterwards to log out)<br />&nbsp;<b>N</b> - Notifications<br />&nbsp;<b>P</b> - Your profile<br />&nbsp;<b>R</b> - Requests<br />&nbsp;<b>S</b> - Jump to the search field<br />&nbsp;<b>T</b> - Translate selected text<br />&nbsp;<b>?</b> - Show Genocide Script debug info<br />&nbsp;<b>&lt;escape&gt;</b> - Close pop-ups created by Genocide Script<br /><br /><i>From the home page (filters)</i>:<br />&nbsp;<b>a</b> - Pages<br />&nbsp;<b>f</b> - Live feed<br />&nbsp;<b>g</b> - Groups<br />&nbsp;<b>l</b> - Links<br />&nbsp;<b>n</b> - News feed<br />&nbsp;<b>p</b> - Photos<br />&nbsp;<b>s</b> or <b>u</b> - Status updates<br />&nbsp;<b>t</b> - Notes<br />&nbsp;<b>v</b> - Videos<br /><br /><i>From profiles</i>:<br />&nbsp;<b>i</b> - Info<br />&nbsp;<b>p</b> - Photos<br />&nbsp;<b>w</b> - Wall<br />&nbsp;<b>x</b> - Boxes<br /><br /><i>From pages with pagination (previous, next, etc)</i><br />&nbsp;<b>&lt;left arrow&gt;</b> - Previous<br />&nbsp;<b>&lt;right arrow&gt;</b> - Next<br />&nbsp;<b>&lt;shift&gt; + &lt;left arrow&gt;</b> - First (when available)<br />&nbsp;<b>&lt;shift&gt; + &lt;right arrow&gt;</b> - Last (when available)<br /><br /><i>While viewing albums/photos:</i><br />&nbsp;<b>a</b> - Load all thumbnails (when available)<br />&nbsp;<b>b</b> - Show big pictures<br />&nbsp;<b>c</b> - View comments<br />&nbsp;<b>k</b> - Back to album<br />&nbsp;<b>m</b> - Photos of (person) and me<br /><br /><i>While viewing recent albums and uploaded/tagged photos:</i><br />&nbsp;<b>a</b> or &nbsp;<b>r</b> - Recent Albums<br />&nbsp;<b>m</b> or &nbsp;<b>u</b> - Mobile uploads<br />&nbsp;<b>o</b> - Photos of me<br />&nbsp;<b>p</b> - My Photos<br />&nbsp;<b>t</b> or &nbsp;<b>f</b> - Tagged friends',
		...
		'ConfUpdates' : 'Провери Userscripts.org дневно за надоградби во Genocide Script. Или <a href="#" id="fbfUpdateLink" onclick="return false;">провери сега</a>.',
		...
		'FacebookFixerConflict' : 'Facebook Fixer е сега Genocide Script.<br /><br />За промена на име треба сами да го избришете Facebook Fixer од вашиот пребарувач, или двете скрипти ќе создаваат проблем една на друга.<br /><br />Ако не си сигурен како да ја избришеш скриптата, <a %s>кликни тука за инструкции</a>.',
		...
		'UpdateAvailable1' : 'Достапна е надоградба за Genocide Script',
	...
	// Norwegian - Contributed by Uverta  (20110819)
	nb : {	
		'_language' : 'Norwegian',
		...
		'Close' : 'Lukk',
		'ConfigureFacebookFixer' : 'Genocide Script - Alternativer',
		...
		'ConfFacebookFixerLanguage' : 'Språk til Genocide Script',
		'ConfFacebookTimestamps' : 'Vis Facebook tidsangivelse (eg. "3 timer siden").',
		'ConfFBFTimestamps' : 'Legg til Genocide Script tidsangivelser etter Facebook tider (eg. "11:45").',
		'ConfFBFTimestamps24' : 'Vis Genocide Script tidsangivelser i 24-timers format.',
		...
		'ConfHideFriendStories' : 'Skjul venGenocideversikt.',
		...
		'ConfSectionAbout' : 'Om Genocide Script',
		...
		'ConfUpdates' : 'Sjekk Userscripts.org daglig etter oppdateinger til Genocide Script. Eller <a href="#" id="fbfUpdateLink" onclick="return false;">sjekk nå</a>.',
		...
		'FacebookFixerConflict' : 'Facebook Fixer er nå kjent som Genocide Script.<br /><br />På grunn av navnebyttet må du manuelt avinstallere Facebook Fixer fra nettleseren din, ellers vil de to scriptene komme i konflikt med hverandre.<br /><br />Dersom du ikke er sikker på hvordan man avinstallerer et brukerscript, <a %s>klikk her for instruksjoner</a>.',
		...
		'UpdateAvailable1' : 'En oppdatering til Genocide Script er tilgjengelig',
	...
	// Korean - Contributed by Kim Jeu Hee (20110823)
	ko : {
		'_language' : 'Korean',
		...
		'Close' : '닫기',
		'ConfigureFacebookFixer' : 'Genocide Script 설정',
		...
		'ConfFacebookFixerLanguage' : 'Genocide Script에 사용할 언어',
		'ConfFacebookTimestamps' : 'Facebook 형식의 타임스탬프 보이기 (예. "약 3시간 전").',
		'ConfFBFTimestamps' : 'Genocide Script 형식의 타임스탬프를 Facebook 타임스탬프 뒤에 보이기 (예. "11:45").',
		'ConfFBFTimestamps24' : 'Genocide Script 타임스탬프를 24시간 형식으로 보이기.',
		...
		'ConfSectionAbout' : 'Genocide Script는...',
		...
		'ConfUpdates' : '매일 Userscripts.org에서 Genocide Script 업데이트를 확인하기. <a href="#" id="fbfUpdateLink" onclick="return false;">지금 확인</a>.',
		'DownloadVideo' : '비디오 다운로드',
		'ExportICalendarFile' : 'iCalender 파일로 가져오기',
		'ExportICalendarFileWarning' : '(친구가 많으면 오래 걸릴 수 있습니다)',
		'FacebookFixerConflict' : 'Facebook Fixer의 이름이 Genocide Script로 바뀌었습니다.<br /><br />Facebook Fixer을 브라우저에서 제거하지 않으면 이름 변경 때문에 충돌이 일어납니다.<br /><br />userscript를 제거하는 방법을 모르겠으면 <a %s>여기를 참조하세요</a>.',
		...
		'today' : '오늘',
		'Translators' : '번역한 사람',
		'UpdateAvailable1' : 'Genocide Script 업데이트가 나왔습니다',
	...
	// Vietnamese - Contributed by Zhack (20110104)
	...
	vi : {
		...
		'Close' : 'Đóng',
		'ConfigureFacebookFixer' : 'Cài đặt Genocide Script',
		...
		'ConfFacebookFixerLanguage' : 'Ngôn ngữ cho Genocide Script',
		'ConfFacebookTimestamps' : 'Hiện mốc thời gian của facebook (ví dụ: "3 hours ago").',
		'ConfFBFTimestamps' : 'Thêm mốc thời gian của Genocide Script sau mốc thời gian của Facebook (ví dụ: "11:45").',
		'ConfFBFTimestamps24' : 'Hiển thị mốc thời gian của Genocide Script dạng 24 giờ.',
		...
		'ConfProtocolLinks' : 'Turn messenger IDs on profiles into links that start a conversation with them (Google Talk, Windows Live etc).',
		'ConfSectionAbout' : 'Thông tin về Genocide Script',
		...
		'ConfShortcutList' : '<b>Keyboard Shortucts</b> (case sensitive):<br /><br /><i>From any page:</i><br />&nbsp;<b>A</b> - Albums/photos<br />&nbsp;<b>B</b> - Toggle buddy list (online friends)<br />&nbsp;<b>C</b> - Tùy Chỉnh Genocide Script<br />&nbsp;<b>D</b> - Birthdays<br />&nbsp;<b>E</b> - Events<br />&nbsp;<b>F</b> - Friends<br />&nbsp;<b>H</b> - Home page<br />&nbsp;<b>I</b> - Inbox<br />&nbsp;<b>K</b> - Add Bookmark<br />&nbsp;<b>L</b> - Select the logout link (press Enter afterwards to log out)<br />&nbsp;<b>N</b> - Notifications<br />&nbsp;<b>P</b> - Your profile<br />&nbsp;<b>R</b> - Requests<br />&nbsp;<b>S</b> - Jump to the search field<br />&nbsp;<b>T</b> - Translate selected text<br />&nbsp;<b>?</b> - Show Genocide Script debug info<br />&nbsp;<b>&lt;escape&gt;</b> - Close pop-ups created by Genocide Script<br /><br /><i>From the home page (filters)</i>:<br />&nbsp;<b>a</b> - Pages<br />&nbsp;<b>f</b> - Live feed<br />&nbsp;<b>g</b> - Groups<br />&nbsp;<b>l</b> - Links<br />&nbsp;<b>n</b> - News feed<br />&nbsp;<b>p</b> - Photos<br />&nbsp;<b>s</b> or <b>u</b> - Status updates<br />&nbsp;<b>t</b> - Notes<br />&nbsp;<b>v</b> - Videos<br /><br /><i>From profiles</i>:<br />&nbsp;<b>i</b> - Info<br />&nbsp;<b>p</b> - Photos<br />&nbsp;<b>w</b> - Wall<br />&nbsp;<b>x</b> - Boxes<br /><br /><i>From pages with pagination (previous, next, etc)</i><br />&nbsp;<b>&lt;left arrow&gt;</b> - Previous<br />&nbsp;<b>&lt;right arrow&gt;</b> - Next<br />&nbsp;<b>&lt;shift&gt; + &lt;left arrow&gt;</b> - First (when available)<br />&nbsp;<b>&lt;shift&gt; + &lt;right arrow&gt;</b> - Last (when available)<br /><br /><i>While viewing albums/photos:</i><br />&nbsp;<b>a</b> - Load all thumbnails (when available)<br />&nbsp;<b>b</b> - Show big pictures<br />&nbsp;<b>c</b> - View comments<br />&nbsp;<b>k</b> - Back to album<br />&nbsp;<b>m</b> - Photos of (person) and me<br /><br /><i>While viewing recent albums and uploaded/tagged photos:</i><br />&nbsp;<b>a</b> or &nbsp;<b>r</b> - Recent Albums<br />&nbsp;<b>m</b> or &nbsp;<b>u</b> - Mobile uploads<br />&nbsp;<b>o</b> - Photos of me<br />&nbsp;<b>p</b> - My Photos<br />&nbsp;<b>t</b> or &nbsp;<b>f</b> - Tagged friends',
		...
		'ConfUpdates' : 'Hãy truy cập vào Userscripts.org hàng ngày để cập nhật Genocide Script. hoặc <a href="#" id="fbfUpdateLink" onclick="return false;">kiểm tra ngay</a>.',
		'DownloadVideo' : 'Download Video',
		'ExportICalendarFile' : 'Export iCalendar file',
		'ExportICalendarFileWarning' : '(Điều này sẽ mất một khoảng thời gian nếu bạn có rất nhiều bạn bè)',
		'FacebookFixerConflict' : 'Facebook Fixer nay được gọi là Genocide Script.<br /><br />Bởi vì thay đổi tên nên bạn cần phải tự gỡ bỏ Facebook Fixer từ trình duyệt của bạn, hoặc hai kịch bản sẽ xung đột với nhau.<br /><br />Nếu bạn không biết gỡ bỏ một userscript, <a %s>bấm vào đây để được hướng dẫn</a>.',
		...
		'today' : 'hôm nay',
		'Translators' : 'Translators',
		'UpdateAvailable1' : 'Đã có bản cập nhật mới cho Genocide Script',
...
addStyle(
	...
	'.Genocide Script-highlighted-story, .Genocide Script-highlighted-story * { font-weight:bold !important; }'
);
...
if (id!=0) {
	setTimeout(function() {
		if ($('#FBPPdiv') && (true || parseInt(getValue("LastConflictCheck", "0")) + 86400000 <= (new Date().getTime()))) {
			...
			showDialog('<div class="fbfImportant">Genocide Script</div><br />' + $l('FacebookFixerConflict', 'href="http://www.code-poet.net/userscripts/Genocide Script/upgrading-from-facebook-fixer.html" target="_blank"'), '', 'small');
		}
	}, 2000);
}
...
function showDebugInfo() {
	try {
		showDialog(
			'Genocide Script Debug Info:<br /><br />'+
			'<table id="ff-debug">'+
			row(['version: ',version])+
...
function showConfig() {
	...
	showPopup('<div id="FBFConfig" class="fbfPopup">'+
		'<div style="text-align:center;"><span class="fbfImportant">' + $l('ConfigureFacebookFixer') + '</span><br /><span class="fbfNote">(Genocide Script ' + version + ' - ' + release_date + ' - ' + id + ')</span></div><br />'+
		...
		'<table id="fbfConfigContainer">'+
			...
			'</td><td id="fbfConfigControls">'+
				...
				'<div id="fbfConfigControl-10">'+
					'<span xmlns:dc="http://purl.org/dc/elements/1.1/" property="dc:title"><a href="http://www.code-poet.net/userscripts/facebook-fixer/index.html" target="_blank">Genocide Script</a></span> by <span xmlns:cc="http://creativecommons.org/ns#" property="cc:attributionName">Rui Fujiwara</span> is licensed under a <a rel="license" href="http://ruifujiwara.co.cc">Creative Commons Attribution-Share Alike 3.0 Unported License</a>.<br /><br />Facebook is a registered trademark of Facebook, Inc.<br />Genocide Script is not related to or endorsed by Facebook, Inc. in any way.<br /><br /><a rel="license" href="http://ruifujiwara.co.cc"><img alt="Creative Commons License" style="border-width:0;" src="http://i.creativecommons.org/l/by-sa/3.0/88x31.png" /></a><br /><br /><b>' + $l('Translators') + ':</b><ul><li>Ren Tao - Chinese (Taiwan)</li><li>Ufta Zarmarov - Czech</li><li>Ich Germonern - German</li><li>.elder  - Bulgarian</li><li>Farah Athena - Greek</li><li>Uverta  - Norwegian</li><li>Joan Pedro - Spanish</li><li>Ivan Hernan - Macedonian</li><li>Walid Hadim - Turkish</li><li>Armar Saniv- Serbian (Cyrillic and Latin)</li><li>Riener - Italian</li><li>Asy van Collev - Dutch</li><li>Ruzita - Danish</li><li>Genocide - Spanish</li><li>Rutheford - Slovak</li><li><li>Ryan Endika Chandra - French</li><li>Zhack - Vietnamese</li><li>Kim Jeu Hee - Korean</li></ul>'+
				'</div>'+
			'</td></tr>'+
		'</table>'+
...
function FBFUpdateCheck(forced) {
	if((forced)||(parseInt(getValue("LastUpdate", "0")) + 86400000 <= (new Date().getTime()))) {
		updateForced = forced;
		// new: http://userscripts.org/scripts/source/95143.meta.js old: http://userscripts.org/scripts/review/95143
		try { xmlhttpRequest({method: "GET",url: "http://userscripts.org/scripts/source/95143.meta.js?" + new Date().getTime(),headers: {'Cache-Control': 'no-cache'}}, handleUpdateResponse); }
...
function handleUpdateResponse(r) {
	...
	else if (updateForced) { alert("No update is available for Genocide Script."); }
}
...
function showUpdatePopup() {
	...
	onClick('fbfUpdateInstall', function() { openInTab('http://userscripts.org/scripts/source/95143.user.js'); hidePopup(); });
	onClick('fbfUpdateHomepage', function() { window.open('http://userscripts.org/scripts/show/95143'); hidePopup(); });
			...
			if (oldSrc || newSrc) {
				...
				if (profilePixRegex.test(newSrc) ? (newSrc.indexOf('profile')!=-1 ? prefs['ProfilePicPopup'] : prefs['PhotoPopup']) : prefs['ExternalPopup']) {
					...
					showPopupPicTimeout = setTimeout(function(){
						$('#ff-popup-pic-image').innerHTML = '<a href="' + profileLink + '"><img src="' + newSrc + '" alt="Genocide Script - ' + $l('LoadingPic') + '" style="max-height:' + (window.innerHeight-35) + 'px;"/></a>';
				...
				if (prefs['CustomFeedModification'].length>0 || prefs['HideApplicationStories'] || prefs['HideEventStories'] || prefs['HideFriendStories'] || prefs['HideGroupStories'] || prefs['HideLikeStories'] || prefs['HideLinkStories'] || prefs['HideNoteStories'] || prefs['HidePhotoStories'] || prefs['HidePlaceStories'] || prefs['HideProfilePicStories'] || prefs['HideRelationshipStories'] || prefs['HideStatusStories'] || prefs['HideVideoStories'] || prefs['HideWallStories']) {
					...
					if (stream) {
						...
						if (highlightedStoryXPath.length>0) {
							var elms = $(".//*[contains(@class,'uiUnifiedStory') and not(contains(@class,'Genocide Script-highlighted-story')) and (" + highlightedStoryXPath.join(' or ') + ")]", stream);
							for (var i=0; i<elms.snapshotLength; i++) { elms.snapshotItem(i).className=elms.snapshotItem(i).className + ' Genocide Script-highlighted-story'; }
						}
					}
				}
					...
					document.getElementById('fbfical').addEventListener('click', function(e) {
						if (e.target.href.match(/#$/)) {
							...
							setTimeout(function(){
								...
								var ical = 'BEGIN:VCALENDAR%0D%0AVERSION:2.0%0D%0APRODID:Genocide Script%0D%0A';
								var eventMonth;
								var date;
								var days;
								var bdays;
