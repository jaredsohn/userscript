...
for(i=0;i<links.length;i++) {
 if(links[i].innerHTML=="Ignorer") {
  links[i].innerHTML="pul personen t den dævve";
...
for(i=0;i<links.length;i++) {
 if(links[i].innerHTML=="Bilder") {
  links[i].innerHTML="jævla dritkak";
  links[i].style.color="#CC0000"; {
  }
 }
}
for(i=0;i<links.length;i++) {
 if(links[i].innerHTML=="logg") {
  links[i].innerHTML="the log lizzm";
  links[i].style.color="#f40aeb"; {
  }
 }
}
for(i=0;i<links.length;i++) {
 if(links[i].innerHTML=="varsler") {
  links[i].innerHTML="comments i helvette";
  links[i].style.color="#f40aeb"; {
  }
 }
}
...
for(i=0;i<links.length;i++) {
 if(links[i].innerHTML=="Dagbok") {
  links[i].innerHTML="støgg homsebok";
  links[i].style.color="#CC0000"; {
  }
 }
}
for(i=0;i<links.length;i++) {
 if(links[i].innerHTML=="Venner") {
  links[i].innerHTML="folka mine, er så glad i dere (L)(L)";
  links[i].style.color="#f40aeb"; {
  }
 }
}
for(i=0;i<links.length;i++) {
 if(links[i].innerHTML=="Sist innom") {
  links[i].innerHTML=Nuubs, hey ikek si sånn...:";
  links[i].style.color="#f40aeb"; {
  }
 }
}
...
for(i=0;i<links.length;i++) {
 if(links[i].innerHTML=="xxbartinxx") {
...
for(q=0;q<fakta.length;q++){
	if(fakta[q].innerHTML=="Fakta")
		{fakta[q].innerHTML="shitting om mæ:";
		break;
	}
}
...
for(q=0;q<innom.length;q++){
	if(innom[q].innerHTML=="sist innom")
		{innom[q].innerHTML="drittfolka som var innom:";
		break;
	}
}
