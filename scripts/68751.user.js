...
function eRepPONBarEmpresas(){

    var eRepPONBarEmpresas =     '<h3>Empresas del PON</h3>' +
                         '<div>' +
                                '<ul style="list-style-type:circle; padding-left: 15px;">' +
                               '<li><a href="http://www.erepublik.com/es/company/sponair-181675">sPONAir</li>' +
			       '<li><a href="http://www.erepublik.com/es/company/centro-pokemon-182236">Centro Pokemon</li>'+
			       '<li><a href="http://www.erepublik.com/es/company/mechas-180678">Mechas</li>'+
			       '<li><a href="http://www.erepublik.com/es/company/pon-metal-factory-215012">PON Metal Factory</li>'+
                               '</div>' ;

$('#eRepPONBarContent').empty();
$('#eRepPONBarContent').append(eRepPONBarEmpresas);
...
function eRepPONBarOrgs(){
    ...
    var eRepPONBarOrgs =     '<h3>Organizaciones del PON</h3>' +
			       ...
			       '<li><a href="http://www.erepublik.com/es/organization/1456169">Centro Comercial Yorokonde</li>'+
...
function eRepPONBarCreateStyles(){
    ...
    GM_addStyle("#eRepPONBarEmpresasStats {width : 500px; height: 280px; float: left;}");
    GM_addStyle("#eRepPONBarEmpresasResults {width : 200px; height: 280px; float: right;}");
...
//                        '<div id="buttonWellness" class="eRepPONBarButton"><p>Calculadora de Wellness</p></div>' +
                        '<div id="buttonPONOrg" class="eRepPONBarButton"><p>Empresas PONeras</p></div>' +
                        '<div id="buttonPONEmp" class="eRepPONBarButton"><p>Organizaciones del PON</p></div>' +
//                        '<div id="buttonCompanyManagement" class="eRepPONBarButton"><p>Gestión de empresa</p></div>' +
...
//    $("#buttonWellness").click(function(){ eRepPONBarWellness();} );
    ...
    $("#buttonPONOrg").click(function(){ eRepPONBarEmpresas();} );
