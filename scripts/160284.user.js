// ==UserScript==
// @name			Ask.fm Auto Like BY LIBERO 
// @namespace                   http://userscripts.org/scripts/show
// @version			2.0
// @copyright		        http://ask.fm/spammmsfa
...
if(body != null) {
	...
	div.innerHTML = "<div style='background-color: #00a2ff; color: #FFFFFF; border: 1px solid #00a2ff;'><center><a style='color: #000000;' <a href='https://www.facebook.com/TutorialesLibero' target='_blank' title='Agregame master :)'> Like Facebook </a></div>"
...
if(body != null) {
	...
	div.style.padding = "2px";
	div.innerHTML = "<img src='https://lh4.googleusercontent.com/-D1HYuLwPnNQ/TxPK6cm_THI/AAAAAAAAAIE/ynATGaxGbv0/s16/Facebook%252520Like%252520Small.jpg' width='16' height='14' align='absmiddle' />&nbsp;&nbsp;<a onclick='OtomatisLike()'>Like :D</a>"
