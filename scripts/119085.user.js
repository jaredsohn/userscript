...
function insertfind(title)
{
    ...
    var htmlStr = "<h2>在镇江市图书馆借这本书...</h2>";
    htmlStr += '<div class="indent"><a href='+openLink+' target="_blank" title="点击前往图书馆搜索">到图书馆搜索《'+ title +'》</a></div>';
    ...
    $("#info .pl").each(function(i){
        if ($(this).text() == 'ISBN:'){
            ...
            setTimeout(function(){GM_xmlhttpRequest({
                method: 'GET',
                url: 'http://code.lwjef.net/ujslib/getbook.php?isbn='+isbn,
                headers: {
                ...
                onload: function(res) {
                            ...
                            if (json.ok > 0 ){
                                ...
                                htmlStr += '<div class="indent"><h4 style="margin-bottom: 0px;"><a href="'+openLink+'" target="_blank" title="点击前往图书馆网页查看信息">前往镇江市图书馆</a></h4>';
