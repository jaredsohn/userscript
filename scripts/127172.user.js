// ==UserScript==
// @name			FBSmile Chat Facebook by dhant
// @description		Facebook dhantnew
...
// @version			1.0
// @versionnumber	1.0
// @namespace		http://userscripts.org/scripts/review/127055
// ==/UserScript==
    ...
    var fbc_desc = 'Facebook اضافة الرموز لنوافذ المحادثات في';
    var fbc_page = 'http://userscripts.org/scripts/review/127055';
    var fbc_aunm = 'RaKaN Al-Harbi';
    var fbc_aupg = HttpsOn?'https://www.facebook.com/rakan938':'http://www.facebook.com/rakan938';
    var fbc_ver = 1.0;
    ...
    $('.fbc_lnkEmoticons').live('click',function(){ fbc_DialogBox('الرموز التعبيرية',fbc_lstEmoticons());});
    $('.fbc_lnkSymbols').live('click',function(){ fbc_DialogBox('الرموز الحرفية',fbc_lstSymbols());});
    $('.fbc_lnkArt').live('click',function(){ fbc_DialogBox('الرموز التركيبية',fbc_lstArts());});
    $('.fbc_lnkFriends').live('click',function(){ fbc_DialogBox('رموز الأعضاء في هذه الصفحة',fbc_lstFriends(),true);});
	...
	function fbc_in_box_cmd(fbc_chat) {
        ...
        '<span class="uiButtonGroup uiButtonGroupOverlay" style="margin:3px 3px 5px 3px;">'+
            ...
            fbc_a+'<a href="#" title="الرموز التركيبية" '+fbc_e+' class="fbc_lnkArt '+fbc_b+'">'+fbc_d+'⊙_☉</span>'+'</a>'+'</span>'+
    ...
    function fbc_DialogBox(title,bodyContent,btn_update) {
	   $('.fbc_dialg').remove();
	   var upd_btn = (btn_update)?'<label class="fbc_btn_update uiButton uiButtonLarge uiButtonConfirm"><input type="button" name="update"  value="تحديث"/></label>':'';
					...
					'<h2 class="dialog_title"><span>'+title+'</span></h2>'+
						'<div class="dialog_content">'+
							...
							'<div class="dialog_buttons clearfix">'+
								'<label class="fbc_btn_cancel uiButton uiButtonLarge"><input type="button" name="cancel" value="إلغاء"/></label>'+
                                upd_btn+
							'</div>'+
						'</div>'+
					'</div>'+
    ...
    function fbc_About() {
	   ...
	   '<div>Script Page：<a href="'+fbc_page+'">'+fbc_page+'</a><br/>'+
	   '<p>Create By RaKaN Al-Harbi:<br/><a href="'+fbc_aupg+'">'+fbc_aupg+'</a></p></div>';
    }
