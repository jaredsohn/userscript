// ==UserScript==
// @name            HF Script - HF Post Helper for Yellows
...
function form_submit(event) {
   ...
   for (var i = arTextareas.length - 1; i >= 0; i--) {
	   var elmTextarea = arTextareas[i];
		...
		re = /\[Astonish\]/gi;
		elmTextarea.value = elmTextarea.value.replace(re,"[url=http://hackforums.net/member.php?action=profile&uid=657392][color=#AAAAFF][b]Astonish is NJ[/b][/color][/url]");
