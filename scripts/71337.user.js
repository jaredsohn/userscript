// ==UserScript==
// @name           DHR Stats Since Last Visit (by time interval)
// Original Author death2y, captZEEbo
// @author         동해랑
// @namespace      http://donghaerang.com
// @description    지정한 일정 시간이 지난 후의 업로드양, 다운로드양, Ratio의 변화를 ( )안에 표시해줍니다.
// @require        http://sizzlemctwizzle.com/updater.php?id=71337&show&uso&days=7
// Forum           http://userscripts.org/scripts/show/71337
// @version        1.0.2010.05.19.18.11
// @include        http://www.naver.com/
// ==/UserScript==

/*************************************************************
※ 소스 수정시 이부분은 건드리지 마세요.
원 제작자            death2y, captZEEbo
수정 제작자          동해랑
수정 제작자 홈페이지 http://donghaerang.com
수정 소스 소개처     http://userscripts.org/scripts/show/71337
**************************************************************/
