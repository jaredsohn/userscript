...
// --------------------------------------------------------------------
// ==UserScript==
// @name           Created By NerVeux
// @version        55
// @namespace      iXXXx
// @description    Bize Özel
...
languages = { // Language tags
 ...
 "pl" : { // Polish
  ...
  "player"   : "Oyuncu",
  "tribe"    : "Köy",
  "i_player" : "Pokaż informacje o Oyuncuu",
  "i_tribe"  : "Pokaż informacje o wiosce",
  "loading"  : "Odświeżanie...",
  "c_close"  : "Zamknij",
  "track"    : "Badaj wioskę",
  "tracked"  : "Köy badana",
  "untrked"  : "Köy bez badania",
  ...
  "at_all"   : "Ponowny atak wszystkimi jednostkami",
      ...
      "group_toggle" : "Grupları Göster/Gizle",
      ...
      "overview_nogroup" : "Köyleri Gizle/Göster",
      "overview_village" : "Köy",
      "overview_points" : "Puan",
      "overview_resources" : "Madenler",
      "overview_warehouse" : "Depo",
      "overview_farm" : "Çiftlik",
      "main_setaliasheader" : "İsim (Sadece Siz Görebilirsibiz):",
      "main_setalias" : "Tamam",
...
plugins.BBCodesTextArea = {
	"BBMenuGenerator" : function() {
		...
		var xhtml = '<center><table style="cursor:pointer;" cellpadding="0" cellspacing="0">' +
			'<tr>' +
               '   <td onmouseover="javascript:this.style.backgroundColor=\'peachpuff\';" onmouseout="javascript:this.style.background=\'none\';" onclick="javascript:insertBB(\'player\','+random+');" title="[player][/player]" tabindex="10"><img src="graphic/face.png" alt="Player" /></td>' +
               '   <td onmouseover="javascript:this.style.backgroundColor=\'peachpuff\';" onmouseout="javascript:this.style.background=\'none\';" onclick="javascript:insertBB(\'village\','+random+');" title="[village][/village]" tabindex="11"><img src="graphic/buildings/main.png" alt="Village" /></td>' +
               '   <td onmouseover="javascript:this.style.backgroundColor=\'peachpuff\';" onmouseout="javascript:this.style.background=\'none\';" onclick="javascript:insertBB(\'tribe\','+random+');" title="[ally][/ally]" tabindex="12"><img src="graphic/command/support.png" alt="Tribe" /></td>' +
	...
	'enhance_game' : function() {
		if(global_ShowTopForumStar) $('#menu_row').html( $('#menu_row').html() + "<td><a href='game.php?village="+personals.getCurrentVillage()+"&screen=ally&mode=forum' title='Forum'><img src='http://en15.tribalwars.net/graphic/ally_forum.png' /></a></td>" );
		if(location.href.match( /screen=settings/) || location.href.match( /screen=mail/ )) plugins.BBCodesTextArea.BBMenuGenerator();
	},
	'info' : {
		'mandatory' : false,
		'name' : "Toolbar on top of TextAreas",
	...
	plugins.nobleCoins = { // One click to buy X coins at once
		...
		'enhance_game_snob' : function() {
			...
			if ($("table.vis:last a").length > 0 && lowest_coin > 1) {
				...
				$("table.vis:last").after("<p>"+lowest_coin+". Altın Para Basabilirsin <a href=\"javascript:makeCoins("+lowest_coin+",'"+coinlink+"');\">Şimdi Yap</a></p>");
		...
		'enhance_game' : function() { // Add the premium-like toolbar
 		//make sure twe.curVillage is initalized
			...
			setFunc("tool_info", function(type){
				...
				if (type == 'player') {
					window.open("http://" + twe.World + ".klanstats.com/stats.php?name=" + escape(tribeID) + "&search_at=tribe&object=stat&method=tribe_file&lng=en");
				} else {
					window.open("http://" + twe.World + ".klanstats.com/stats.php?name=" + escape(ally_name) + "&search_at=ally&object=stat&method=ally_file&lng=en");                                        
				}
			});
  ...
  'get_distance_table' : function(target) {
	  html = "<table>";
	  html += "<tr><th>Köyler</th><th>Dystans</th>";
	  ...
	  html += '<tr><td colspan="14"><a id="distancecalclink" href="javascript:distancecalctoggle();"><span>pokaż</span> wszystkie Köy</a></td></tr>';
	  html += "</table>";
	  return html;
  },
  ...
  'get_rallypoint_html' : function(village_id,x,y) {
	  ...
	  var html = "<h4>Ordu Gönder</h4><form name=\"units\" action=\"game.php?village="+personals.getCurrentVillage()+"&amp;screen=place&amp;try=confirm\" method=\"post\">\n";
	  ...
	  html += "<td rowspan=\"2\"><input class=\"attack\" name=\"attack\" value=\"SALDIR\" style=\"font-size: 10pt;\" type=\"submit\"></td>\n";
	  html += "<td rowspan=\"2\"><input class=\"support\" name=\"support\" value=\"Destek Ol\" style=\"font-size: 10pt;\" type=\"submit\"></td>\n";
	  html += "</tr></tbody></table>";
	  html += "</form>";
	  return html;
  },
  ...
  'get_overview' : function() {
	  ...
	  var html="<h3>Diğer Birliklerin</h3>";
	  html += "<table><tr><th>Köyler</th>\n";
	  ...
	  for(var i in TW_Villages) {
		...
		//  log(1,uneval(rallypoint));
		  ...
		  if(!rallypoint) {
			  html+="<td colspan=\"14\">Güncel Değil</td></tr>";
			//  continue;
		  } else {
  ...
  'get_overview_row' : function(vid) {
	  ...
	  if(!rallypoint) return "<td colspan=\"0\" align=\"center\">Bilgi Yok</td></tr>";
...
*/
 ...
 _get_buildings : function(buildingsTD) {
  ...
  'enhance_game_map': function(){
	  ...
	  var iHtml = '<table><tr><td colspan="2">&nbsp;</td></tr><tr><td align="right">Harita Genişliği: </td><td><select id="map_size_select" onchange="resize_map()">';
