...
function getTPL_Preview(){
 ...
 +    '<input tabindex="102" id="preview_presubmit" type="button" class="button" value=" '+(gvar.user.iskaskuser ? '':'pre-')+'Post " />&nbsp;&nbsp;'
...
/* Mod By Idx and RedFeX. */====== /END Global Var ===
