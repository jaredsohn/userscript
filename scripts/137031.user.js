// ==UserScript==
// @name            John. HF Script - HF Post Helper
// @namespace       catbodi/hfposthelper
...
function form_submit(event) {
   ...
   for (var i = arTextareas.length - 1; i >= 0; i--) {
	   var elmTextarea = arTextareas[i];
		...
		elmTextarea.value = elmTextarea.value.replace(":P",":tongue:"); 
		elmTextarea.value = elmTextarea.value.replace(":D",":biggrin:");

		var re = /\[UKFDubstep\]/gi;
		elmTextarea.value = elmTextarea.value.replace(re,"[url=http://youtube.com/ukfdubstep][color=#1E90FF][b]UKFDubstep[/b][/color][/url]");
		...
		var mentors = '[list]\n';
		mentors = mentors + '[*][url=http://www.hackforums.net/member.php?action=profile&uid=657392][color=#AAAAFF][b]Astonish is NJ[/b][/color][/url]\n';
		...
		mentors = mentors + '[*][url=http://www.hackforums.net/member.php?action=profile&uid=47970][color=#AAAAFF][b]Paradoxum[/b][/color][/url]\n';
        mentors = mentors + '[*][url=http://www.hackforums.net/member.php?action=profile&uid=70881][color=#AAAAFF][b]Skill[/b][/color][/url]\n';
		...
		re = /\[Chris\]/gi;
		elmTextarea.value = elmTextarea.value.replace(re,"[url=http://www.hackforums.net/member.php?action=profile&uid=656453][color=lime][b]Xch4ng3[/b][/color][/url]");
