// ==UserScript==
// @name           Perangkaum SDA Info by R4mli
// @version        1.0
// @namespace      Script ini berfungsi menampilkan SDA kita yg tersisa secara Grafis.
// @description    Perangkaum.net Sda info buat dunia 3!
// @include        http://id3.perangkaum.net/*
// @copyright      Copyright (c) 2010
// @maintainer     Hundera, Hipio, R4mli
// ==/UserScript==
...
var TWR_dicts = {
  "en" : {"storage" : "Tinjauan SDA", "hari ini" : "Penuh Pkl", "Besok" : "Gudang Penuh Pkl"},
...
function resourceTable(){
 ...
 //resTable.id='ResTable';
  ...
  for each (var cr in TWR_resources) {
	   ...
	   cell.innerHTML = TWR_res[cr] + " / Produksi Per Jam: " + TWR_resIncome[cr];
	   row.appendChild( cell );
