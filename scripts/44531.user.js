...
if ( document.URL.indexOf("world.php") != -1 ) {
	...
	var room = document.getElementsByTagName('table')[12].getElementsByTagName('tr')[1].getElementsByTagName('td')[64];
...
masterdiv.insertBefore(searchForm,masterdiv.childNodes[53]);
