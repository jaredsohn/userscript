...
function isWide() {
  ...
  if(playerEmbed) {
    ...
    if(flashvars) {
      ...
      if(getIntValue('DETECT_YT_CROP_STRETCH')>0 && keywords) {
...
function googleWatch_CSS_remake() {
    ...
    +'.comment .metadata .author { position:absolute; top:4px; white-space:nowrap;margin-left:-2px;margin-right:100%;overflow:visible;padding-bottom:0;font-weight:bold;}'
    ...
    +'#watch-sidebar .video-actions { bottom:3px; right:-40px; }'
