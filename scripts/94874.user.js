...
//Modif shootbox
	//var twpro_selectChatRoomInnerHTML = new String();
    var twpro_shootBoxInnerHTML = new String();
	//twpro_selectChatRoomInnerHTML = document.getElementById('abdorment_right').innerHTML;
    //twpro_selectChatRoomInnerHTML = twpro_selectChatRoomInnerHTML.concat('<div id="chat_room"> </div>');     
    //document.getElementById('abdorment_right').innerHTML = twpro_shootBoxInnerHTML;
    twpro_shootBoxInnerHTML = document.getElementById('abdorment_right').innerHTML;
    twpro_shootBoxInnerHTML = twpro_shootBoxInnerHTML.concat('<object width="190" height="300" id="obj_1295388095550"><param name="movie" value="http://laconfederation.chatango.com/group"/><param name="AllowScriptAccess" VALUE="always"/><param name="AllowNetworking" VALUE="all"/><param name="AllowFullScreen" VALUE="true"/><param name="flashvars" value="cid=1295388095550&a=230400&b=100&c=CCCCCC&d=CCCCCC&e=C7B47C&f=91&h=C7B47C&j=230400&k=230400&l=000000&m=C7B47C&n=230400&q=494136&r=100&s=1&v=0&w=0"/><embed id="emb_1295388095550" src="http://laconfederation.chatango.com/group" width="190" height="300" allowScriptAccess="always" allowNetworking="all" type="application/x-shockwave-flash" allowFullScreen="true" flashvars="cid=1295388095550&a=230400&b=100&c=CCCCCC&d=CCCCCC&e=C7B47C&f=91&h=C7B47C&j=230400&k=230400&l=000000&m=C7B47C&n=230400&q=494136&r=100&s=1&v=0&w=0"></embed></object>');
	//twpro_selectChatRoomInnerHTML = twpro_selectChatRoomInnerHTML.concat('<select id="selectChatRoom" size="1" onchange="if((document.getElementById('selectChatRoom').value!='1')){document.getElementById('chat_room').innerHTML = twpro_shootBoxInnerHTML;} else {}" style="background-color: rgb(207, 195, 166); font-size: 10px; width:120px;"><option value="-1">- Chat Room -</option><option value="1" >La confédération</option><option value="2">miaou</option></select><div id="chat_room"> </div>');     
    document.getElementById('abdorment_right').innerHTML = twpro_shootBoxInnerHTML;
