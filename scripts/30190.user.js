   ...
   'info' : {
	...
	plugins.BBCodesTextArea = {
		BBMenuGenerator : function() {
            ...
            var xhtml = '<table style="cursor:pointer;">' +
               '<tr>' +
            ...
            setFunc("insertBB", function(insertType, ident, thirdVar){
				...
				switch (insertType) {
					...
					case 'img':
						...
						break;
					case 'color':
						if(thirdVar=="DISABLED") return false;
						txtinsertBefore = "[color="+thirdVar+"]";
						txtinsertAfter = "[/color]";
						insertButton = 'CO';
					break
					case 'size':
						if(thirdVar=="DISABLED") return false;
						txtinsertBefore = "[size="+thirdVar+"]";
						txtinsertAfter = "[/size]";
						insertButton = 'SI';
					break
				}
		...
		'enhance_game' : function() {
			document.getElementById('menu_row').innerHTML += "<td><a href='game.php?village="+personals.getCurrentVillage()+"&screen=ally&mode=forum' title='Tribe Forum'><img src='http://en15.tribalwars.net/graphic/ally_forum.png' /></a></td>";
		...
		'info' : {
			...
			'desc' : "Adds a BB toolbar on top of TextAreas in Mail, Profile and Forum",
			'version' : "Beta v0.9g",
			'dev' : "JelianSD"
		}
	} 
