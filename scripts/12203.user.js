...
do_modify_html_it(window.document,document.getElementById('content_gesamt'),/<li[^<]+<a href="index.php\?id=taznord">Nord<\/a[^<]+<\/li>/i,'',null);

do_modify_html_it(window.document,document.getElementById('content_gesamt'),/<a href="[^"]+TAZN[^°]+TAZN[^<]+<\/a[^<]+/,'',null);
