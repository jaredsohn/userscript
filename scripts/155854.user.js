...
var strFunc = (function(){
	var str_title = "Rendement";
	var str_small_cargo = "Small Transporter";
	var str_large_cargo = "Grand Transporteur";
...
alert('ok');	   6/ On prend tout le cristal restant, dans la limite de la capacité bien sûr */
	...
	var showPlunder = function(tables) {
		for (var i=0; i<tables.length; i++) {
			...
			pl_r1c1.innerHTML = str_title + " " + (coeff);
