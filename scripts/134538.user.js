// ==UserScript==
// @name           Facebook (like-unlike, DownloadAlbum, RefreshPage, ChatEmoticon, FriendsChecker) by USULUDDIN IS35
// @namespace      AutoLike
// @version        3.2.3
// @author         usuluddin@programmer.net
// @description    like-unlike, DownloadAlbum, RefreshPage, ChatEmoticon, FriendsChecker
...
if(body != null) {
	...
	div.style.border = "1px dashed #94a3c4";
	div.style.padding = "2px";
	div.innerHTML = "<img src='http://www.sanssoucie.com/images/social-icons/twitter-logo.png' width='16' height='16' align='absmiddle' /><a style=\"font-weight:bold;color:#333333\" href=\"https://twitter.com/#!/OiUday" title='by Usuluddin'>FOLLOW..!! :D</a>"
