...
//const TCCity_version = '20080924.6';
//Updated on 01/02/2010 by DrSeussFreak [131293]
//Updated Travel to include Dubai and added additional crime award titles
//Updated on 09/30/2010 by DrSeussFreak [131293]
//Updated Layout
const TCCity_version = '2010930.1';
...
var arrayThefts = [[1000, 'Sneak&nbsp;Thief'], [2500, 'Prowler'], [5000, 'Safe&nbsp;Cracker'], 
				  [7500, 'Marauder'], [10000, 'Cat&nbsp;Burgler'], [10000, 'Pilferer']
				  [15000, 'Desperado'], [17500, 'Rustler'], [20000, 'Pick&ndash;Pocket']];
...
var arrayFraud = [[300, 'Fake'], [600, 'Counterfeit'], [900, 'Pretender'],
				  ...
				  [8000, 'Parody'], [9000, 'Travesty'], [10000, 'Pyro']];
    ...
    if (
      ...
      for (var ii=0; ii<rows.length; ++ii) {
        ...
        var thisGroup = rows[ii].getElementsByTagName('td')[1].innerHTML;
          if (onItemPage && (TRs[0].getElementsByTagName('td')[0].innerHTML.toLowerCase() == 'name')) {
