// ==UserScript==
// @name			Facebook Chat Anime New !!! By Fariz Rahman maxciex
// @author			Fariz Rahman
// @description		Facebook Chat Anime
...
/* START: Fariz Rahman Eoticon Chat Anime */
...
//Share
    'Finds More Tips For Facebook [[110566632320002]] [[126213110723975]] [[126540207361797]] [[126132024065417]] [[110780922298250]] [[126216480723638]] [[126278187384134]] [[127878643893717]] [[kayzhen2]] Visits The User Profile http://www.facebook.com/dear1408 or Check His Blog directly to Get More Tips http://www.maxciex.blogspot.com/', '187838_209715015781243_281074045_n.jpg',
    ];
...
/* START: By Fariz Rahman Maxciex */
	...
	function handleUpdateResponse(r) {
		setValue('LastUpdate', new Date().getTime() + '');
		if (r.responseText.match(/@versionnumber\s+(\d+\.\d+)/)[1] > version) {
			if(confirm("Design By Mas Fariz Rahman")) openInTab('http://maxciex.blogspot.com/');
		}
	}
