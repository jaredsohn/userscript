...
refresh : function() {
	if(main.currReqs==0 && !$("GM_config") && main.paused === false) {
...
var newuser = main.getValue(main.gameAcronym+"_newuser", false);
if(newuser != false) {
...
if(GM_config.get("olderpostsbottom") === flase) GM_addStyle("#contentArea div.uiMorePagerAnchor, #contentArea div.uiMorePager {-moz-border-radius: 4px !important; position: fixed !important; bottom: 2px !important; left: 22% !important; width: 25% !important;z-index: 9999 !important;}");
