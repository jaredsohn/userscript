...
// @exclude			http://*hack*
// @exclude			http://*my*
// @version			1.1.3 Seitenanpassungen
// @version			1.1.2 Boggler ist eine geile Sau xD
...
var THISSCRIPTNAME = "Spenden via www.PennerTools.com";
var THISSCRIPTINSTALL_URL = 'http://userscripts.org/scripts/show/88743';
// URL fГјr Hauptseite bei userscripts.org
var THISSCRIPTSOURCE_URL = 'http://userscripts.org/scripts/source/88743.user.js';
...
GM_xmlhttpRequest({
    ...
    onload: function(responseDetails) {
        var content = responseDetails.responseText;
        var links = content.split('</big><br>')[1].split('<br><b>')[0];
        var info = content.split('<br><b>')[1].split('</b><br>')[0];

        var tieritem = document.getElementsByClassName('clearcontext');
        var bereich = tieritem[tieritem.length - 4];

        bereich.getElementsByTagName('ul')[0].getElementsByTagName('li')[4].innerHTML += '<br> <br> <br><h3><a target="_blank" href="http://www.pennertools.com">PennerTools.com</a> Spendenscript <a href="http://www.ipcount.net/online/tw6prkid12hf.html" target="_blank"><img src="http://www.ipcount.net/count/tw6prkid12hf/7.gif" alt="ipcount.net Kostenloser Besucherzähler" border="0" /></a></h3><input style="color:#990000" type="button" id="eintragen" value="SpendenLink auf PennerTools eintragen!"><br><b><div id="eintragtext" ></div></b><br><input style="color:#003300" type="button" id="anzeigen" value="Spendenlinks anzeigen"><div id="linkbereich"></div>' + info;
