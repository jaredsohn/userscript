...
div.innerHTML += '<br/><b><a href="http://forums.d2jsp.org/forum.php?f=104"' + 
		' title="Bar and Pub Games" target="_blank">Loan Status</a>: ';
	switch(resolveLoanType(user)){
		case 'helper':
			div.innerHTML += '<font color="blue"><b>Helper</b></font>';
			break;
		case 'welcher':
		...
		case 'welcherpaidback':
			...
			break;
		case 'trusted':
			div.innerHTML += '<font color="darkgreen"><b>Trusted</b></font>';
			break;
		case 'blacklist':
			div.innerHTML += '<font color="black"><b>Blacklist</b></font>';
			break;
		case 'unknown':
...
function getNames(){
	...
	{
	    method: 'GET',
	    url: 'http://jsploan.angelfire.com/',
	    headers: 
		{
	    ...
	    onload: function(response)
		{
			...
			var names = str.substring(str.indexOf('StArToFmYLOANlIsT') + 19,str.indexOf('EnDoFmYLOANlIsT'));
			eval(names);
			doThePage();
		}
	});
