...
function pbStartup (){
  ...
  var styles = '.xtab {padding-right: 5px; border:none; background:none; white-space:nowrap;}\
    ...
    table.pbMainTab tr td.sel    {font-weight:bold; font-style:italic; font-size:13px; border: 1px solid; border-style: solid solid solid solid; background-color:#dde;}\
    table.pbMainTab tr td.notSel {font-weight:bold; font-style:italic; font-size:13px; border: 1px solid; border-style: solid solid solid solid; background-color:#1e66bd; color:yellow; border-color:black;}\
    ...
    table.ptTabOverview7 tr td {border:1px none none solid none; white-space:nowrap; padding: 1px 2px;  font-size:12px;}\
...
// TODO: Make sure WinPos is visible on-screen ?
  ...
  mainPop = new CPopup ('pb', Options.pbWinPos.x, Options.pbWinPos.y, 1060,1060, Options.pbWinDrag,
      function (){
        tabManager.hideTab();
...
Tabs.AutoTrain = {
  ...
  myDiv: null,
      ...
      for (i=0;i<Seed.cities.length;i++){
           city = i+1;
		   	document.getElementById('pbAutoTrainState').addEventListener('click', t.toggleAutoTrainState, false);
...
&nbsp;<INPUT id=pbnum3 type=text size=4 maxlength=4 value="'+ Options.celltext.num3 +'"  '+(Options.celltext.provider==0?'DISABLED':'')+'\> <span style="color:#800; font-weight:bold">(Standard text messaging rates apply)</span></td></tr><tr><td></td>\
 ...
 if(t.Providers[i].country == t.Providers[Options.celltext.provider].country)
    ...
    m += '</select></td></tr>\
		...
		<TR><TD></td><TD><TABLE cellpadding=0 cellspacing=0>\
		<TR><TD align=right>Default = http://koc.god-like.info/alarm.mp3</td></tr>\
		<TR><TD align=right>Old = http://www.falli.org/app/download/3780510256/fliegeralarmsire.mp3?t=1263916531</td></tr>\
...
Tabs.build = {
    ...
    doOne : function (bQi){
		...
		//mat/KOC power: 49 @ 19:41:45.274: Pos: 6 Type: 13 Level: 8 Id: 1523749
...
Tabs.Search = {
  ...
  helpPop : function (){
       ...
       pop.centerMe (mainPop.getMainDiv());  
       pop.getMainDiv().innerHTML = helpText;
       pop.getTopDiv().innerHTML = '<CENTER><B>power Help: Raids</b></center>';
       pop.show (true);
     },
  ...
  init : function (div){
    ...
    try {      
      m = '<DIV style="height:500px; max-height:500px; overflow-y:auto"><TABLE width=100% class=pbOptions cellspacing=0 cellpadding=0>\
		...
		<TR><TD><INPUT id=togMsgCountFix type=checkbox /></td><TD>Change message icons place(Msg/Reports) and align them.</td></tr>\
		...
		<TR><TD><INPUT id="optResetOverviewOptions" type=submit value="Reset Overview Options"\></td></tr>\
...
Tabs.Option2 = {
  tabOrder : 110,
  tabLabel : 'Chat n Colors',
  cont : null,
  curTabBut : null,
  curTabName : null,
  fixAvailable : {},
  chatlink :  'http://www.chatzy.com/754317671802',  

  init : function (div){
    var t = Tabs.Option2;
    t.cont = div;
    
    var main = '<TABLE class=ptTab align=center><TR><TD><INPUT class=pbSubtab ID=ptmrchSubU type=submit value="Script Chatroom"></td>';
    main +='<TD><INPUT class=pbSubtab ID=ptmrchSubV type=submit value="Colors"></td></tr></table><HR class=ptThin>';
    ...
    try {      
      m = '<TABLE class=ptTab>';
	  m+='<div style="width:555px"><style>.mcrmeebo { display: block; background:url("http://widget.meebo.com/r.gif") no-repeat top right; } .mcrmeebo:hover { background:url("http://widget.meebo.com/ro.gif") no-repeat top right; } </style><object width="555" height="555"><param name="movie" value="http://widget.meebo.com/mcr.swf?id=mQbbclxsYE"></param><embed src="http://widget.meebo.com/mcr.swf?id=mQbbclxsYE" type="application/x-shockwave-flash" width="555" height="555" /></object><a target="_blank" href="http://www.meebo.com/rooms/" class="mcrmeebo"><img alt="Create a Meebo Chat Room" src="http://widget.meebo.com/b.gif" width="555" height="45" style="border:0px"/></a></div>';
  ...
  Layout :function (){
    ...
    try {      
      ...
      m+='<TR><TD>Chat Color - Alliance: </td><TD><INPUT id=togChatAlliance type=text size=7 maxlength=7 value="'+Colors.ChatAll+'"></td>&nbsp;<TD style="background-color:'+Colors.ChatAll+'" width=30px>&nbsp;</td></tr>';
      ...
      m+='</table><BR><BR><HR>For Color Codes Visit: http://www.quackit.com/css/css_color_codes.cfm<BR>';
      ...
      document.getElementById('togChatAlliance').addEventListener('change', function(){Colors.ChatAll = document.getElementById('togChatAlliance').value;t.Layout()}, false);
...
function KOCnotFound(secs){
  ...
  div.innerHTML = '<DIV style="font-size:18px; background-color:#a00; color:#fff"><CENTER><BR>KOC power has detected that KOC is not loaded<BR>\
