// ==UserScript==
// @name        UoP Tweaks
// @description Helpful tweaks to the University of Phoenix's Class Forums
// @namespace   uop.8bitmage.com
// @include     https://classroom.phoenix.edu/*
// @version     2
// @grant       none
//
...
$("#message_box").ready(function (){
    ...
    var showNext = function() {
        var e = $('a.expandarrow-icon.righticon');
        var url = e.attr('href');
        if (url) {
            e.css('border', '2px solid blue');
    	    window.location.href = url;
    ...
    var showPrev = function() {
        var e = $('a.hidearrow-icon.lefticon')
        var url = e.attr('href');
        if (url) {
            e.css('border', '2px solid blue');
    	    window.location.href = url;
