...
// ==UserScript==
// @name			Extra Equipment Stats with Spanish translation
// @namespace		tomy
// @description		Displays number of extra stats your armor gives you. Original version from Tomy -> http://userscripts.org/scripts/show/92775
// @include			http*://*.world-of-dungeons.*/wod/spiel/hero/attributes.php*
// @version			1.12
// @author			Tomy
// @contributor     Finargol, taitoune, Mastermage, Paxet
// @copyright		2010+, Tomy
...
var Contents = {
	...
	"es" : {
          Button_Name		: "Calcular bonos adicionales"
        , Title				: "<h1>Estadísticas adicionales del equipo</h1>Último cálculo "
        , Fetch_Hero		: "Recuperando información del héroe"
        , Fetch_Clan		: "Recuperando información del clan"
        , Fetch_Equipment	: "Recuperando listado de equipo"
        , Fetch_Info		: "Recuperando información del equipo"
        , Armor_Bonus		: "Bonificación en armadura"
		, Attr_Bonus		: "Bonificación en características"
        , Level_Bonus		: "Bonificación en el Rango de habilidades"
        , Effect_Bonus		: "Bonificación en el Efecto de habilidades"
        , Damage_Taken		: "Bonificación en armadura"
        , Defense_Bonus		: "Bonificación en parar"
        , Damage_Bonus		: "Bonificación en daño"
        , Damage_BonusR		: "Bonificación de daño (r)"
        , Attack_Bonus		: "Bonificación en ataques"
		, Dungeon_Bonus		: "Recompensa en las aventuras"
        , Item				: "Objeto"
        ...
        , Dmg_With			: " (z)"
        , Per				: "%"
        , HL_Per			: "% del nivel del héroe"
        , HL				: "nivel del héroe" //No estoy seguro
        , Mult				: " x "
        , Attack_Type		: "tipo de ataque"
        , Dmg_Split			: " / "
        , Damage_Type		: "tipo de daño"
        , BonusR			: "Armadura (r)"
        , Owner_Effect		: "Efectos al dueño del objeto"
        , Race_Name			: "raza"
        , Level				: "Nivel"
        , Adv_Disadv		: "ventajas - desventajas"
        , Monument			: "Monumento"
        , Clan_Has_Monument	: "El clan posee el monumento:"
        , Link				: "Enlace..."
        , Item_Skill        : "Estos bonificadores y puntos negativos solamente surten efecto si se usa el objeto con ayuda de una de las habilidades mencionadas arriba."
        , Effect_BonusTalent: "<p>Un bonificador al <b>Efecto</b> <u>no</u> es igual que uno para el <b>Rango</b> de una Habilidad. En su lugar las bonificaciones se añaden al <b>Daño</b> o a la <b>Curación</b>.</p>"
        , Damage_Added      : "adicionalmente - solamente si ya se ha causado daño de este tipo"
        , Damage_Effect     : "se suma al efecto del arma usada en caso de aciertos normales/ buenos/ críticos."
		, Rounding			: Math.floor
		, All_Hits			: "en caso de aciertos normales/ buenos/ críticos"
    }
};
