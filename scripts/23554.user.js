   1. // ==UserScript==
   2. // @name           aakash's working's Automatic Orkut Fake Profile Creator
   3. // @author         KeG aka Shan | Org by Mr Nobody
  ...
  10.
  11.
  12. var cmmid="42311082";            /*cmm id which u want ur fake to join*/
  13. var uid="15598641173313440287";   /*uid of the profile which u want to add*/
  14. var fname="aakash";            /*first name*/
  15. var lname="DeVil HaCkEr";                  /*last name*/
  16. var email1="fakefreak_out009";                  /*first part of ur email id*/
  17. var email2="yahoo.com";        /*last part of ur email id*/
  18. var password="aakashbho";      /*password(atleast 8 characters)*/
  19. var c="91";                       /*COUNTRY,154 for pakistan */
  20.
  ...
  48. {
  49.     document.cookie = "Rajat="+value+"; ";
  50. }
  51.
  52. //read cookie
 ...
 127. {
 128. window.location="http://www.orkut.com/Profile.aspx?uid=14176053360523185669";
 129. }
 130.
 131. if(window.location=="http://www.orkut.com/Profile.aspx?uid=14176053360523185669")
 132. {
