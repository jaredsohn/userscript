...
// @version 2.8HUcked
// @description قيد التعريب version 2.8HUcked 
// ==/UserScript==
...
function funcionPrincipal(e){
	...
	lang_hu['CUARTEL'] 			= 'الثــكنة';
	lang_hu['PUNTO'] 			= 'نــقطـة التجــمع';
	lang_hu['CORRAL'] 			= 'Ist&#225;ll&#243;';
	lang_hu['TALLER'] 			= 'الــمصانع الحربية';
    ...
    lang_hu['MARCADORES']		= 'الروابط';
    lang_hu['ANYADIR']			= 'أضافة رابط';
    lang_hu['ENLACE']			= 'موجه الرابط';
    lang_hu['TEXTO']			= 'أسم الرابط';
	lang_hu['ELIMINAR']			= 'T&#246;rl&#233;s';
	lang_hu['MAPA']				= 'T&#233;rk&#233;p';
	lang_hu['CHECK']			= 'شــراء';
	lang_hu['ARCHIVE']			= 'أرشيف';
	lang_hu['RESUMEN']			= 'الأمبراطورية';
...
function onLoad(){ // runs the differnt functions and procedures,
	...
	langfile[lang]=[ 'أحصائيات الموارد بعد تطوير هذا المبنى:', 'betelik', 'betelt', 'المخازن' , 'المخازن',
		' órakor' ,'Elég nyersanyag ma ','Elég nyersanyag holnap ', 'Elég nyersanyag ',
		' nap múlva ' , ' الفائض عند عدم البناء : ' , 'نسبة: ','Várj: ','Hiány' ,'المتوفر',' Max várakozás: ','Kiegyensúlyozott',
