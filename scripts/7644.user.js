// ==UserScript==
// @name            Ogame Pro Remove Commander and Officer's
// @namespace       Ogame Remove Commander and Officer's
// @author          GRB (updated to remove officer's by: klandestino)
// @description     Remove Commander and Officer's Left Menu Links
// @include         http://*/game/leftmenu.php?session=*
// @exclude
// ==/UserScript==
function do_platypus_script() {
smart_remove(window.document,document.evaluate('/HTML[1]/BODY[1]/CENTER[1]/TABLE[1]/TBODY[1]/TR[14]/TD[1]/CENTER[1]', document, null, XPathResult.FIRST_ORDERED_NODE_TYPE,null).singleNodeValue,null,null,null);

// Remove Default Officer's Casino Menu Link
element = document.evaluate('/HTML[1]/BODY[1]/CENTER[1]/TABLE[1]/TBODY[1]/TR[16]/TD[1]/DIV[1]/FONT[1]', document, null, XPathResult.FIRST_ORDERED_NODE_TYPE,null).singleNodeValue;
element.innerHTML ='';
...
//Removedor do Comandante.user.js
