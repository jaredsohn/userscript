// ==UserScript==
// @name           Version Français de la barre Premium de Guerre Tribale
// @namespace      www.guerretribale.fr
// @description    Barre Premium de Guerre Tribale (Quartier général, Caserne, Écurie, Atelier, Académie, Forge, Point de ralliement, Marché)  
// @include        http://*.guerretribale.*
// @include        https://*.guerretribale.*  
// @version        1.1
// ==/UserScript==

var lang = "fr";   // Language option
...
function functionMain(e) {
	...
	if (b==null) {
		...
		langArr[0] = " Quartier général ";
		langArr[1] = " Caserne ";
		langArr[2] = " Écurie ";
		langArr[3] = " Atelier ";
		langArr[4] = " Académie ";
		langArr[5] = " Forge ";
		langArr[6] = " Point de ralliement ";
		langArr[7] = " Marché ";
		langArr[8] = ""
		tableIdIndex = 0;
		trIdIndex = 0;
