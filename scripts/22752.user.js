...
// @author       	Hackdeluxe With Platypus
// @include         *ogame*overview*
// ==/UserScript==

function do_platypus_script() {
set_style_script(window.document,document.evaluate('/HTML[1]/BODY[1]/DIV[4]/CENTER[1]/TABLE[1]/TBODY[1]/TR[1]/TD[1]', document, null, XPathResult.FIRST_ORDERED_NODE_TYPE,null).singleNodeValue,"width:800px;",null,null);
set_style_script(window.document,document.evaluate('/HTML[1]/BODY[1]/DIV[4]/CENTER[1]/TABLE[1]', document, null, XPathResult.FIRST_ORDERED_NODE_TYPE,null).singleNodeValue,"width: 800px;",null,null);
set_style_script(window.document,document.evaluate('/HTML[1]/BODY[1]/DIV[4]/CENTER[1]/TABLE[1]/TBODY[1]/TR[9]/TH[2]/IMG[1]', document, null, XPathResult.FIRST_ORDERED_NODE_TYPE,null).singleNodeValue,"height: 85px;width: 85px;",null,null);
set_style_script(window.document,document.evaluate('/HTML[1]/BODY[1]/DIV[4]/CENTER[1]/TABLE[1]/TBODY[1]/TR[9]/TH[1]/A[1]/IMG[1]', document, null, XPathResult.FIRST_ORDERED_NODE_TYPE,null).singleNodeValue,"height: 15px;width: 15px;",null,null);
set_style_script(window.document,document.evaluate('/HTML[1]/BODY[1]/DIV[4]/CENTER[1]/TABLE[1]/TBODY[1]/TR[9]/TH[3]/TABLE[1]/TBODY[1]/TR[1]/TH[1]/A[1]/IMG[1]', document, null, XPathResult.FIRST_ORDERED_NODE_TYPE,null).singleNodeValue,"height: 20px;width: 20px;",null,null);
set_style_script(window.document,document.evaluate('/HTML[1]/BODY[1]/DIV[4]/CENTER[1]/TABLE[1]/TBODY[1]/TR[9]/TH[3]/TABLE[1]/TBODY[1]/TR[1]/TH[2]/A[1]/IMG[1]', document, null, XPathResult.FIRST_ORDERED_NODE_TYPE,null).singleNodeValue,"height: 20px;width: 20px;",null,null);
set_style_script(window.document,document.evaluate('/HTML[1]/BODY[1]/DIV[4]/CENTER[1]/TABLE[1]/TBODY[1]/TR[9]/TH[3]/TABLE[1]/TBODY[1]/TR[2]/TH[1]/A[1]/IMG[1]', document, null, XPathResult.FIRST_ORDERED_NODE_TYPE,null).singleNodeValue,"height: 20px;width: 20px;",null,null);
set_style_script(window.document,document.evaluate('/HTML[1]/BODY[1]/DIV[4]/CENTER[1]/TABLE[1]/TBODY[1]/TR[9]/TH[3]/TABLE[1]/TBODY[1]/TR[2]/TH[2]/A[1]/IMG[1]', document, null, XPathResult.FIRST_ORDERED_NODE_TYPE,null).singleNodeValue,"height: 20px;width: 20px;",null,null);
set_style_script(window.document,document.evaluate('/HTML[1]/BODY[1]/DIV[4]/CENTER[1]/TABLE[1]/TBODY[1]/TR[9]/TH[3]/TABLE[1]/TBODY[1]/TR[3]/TH[1]/A[1]/IMG[1]', document, null, XPathResult.FIRST_ORDERED_NODE_TYPE,null).singleNodeValue,"height: 20px;width: 20px;",null,null);
set_style_script(window.document,document.evaluate('/HTML[1]/BODY[1]/DIV[4]/CENTER[1]/TABLE[1]/TBODY[1]/TR[9]/TH[3]/TABLE[1]/TBODY[1]/TR[3]/TH[2]/A[1]/IMG[1]', document, null, XPathResult.FIRST_ORDERED_NODE_TYPE,null).singleNodeValue,"height: 20px;width: 20px;",null,null);
set_style_script(window.document,document.evaluate('/HTML[1]/BODY[1]/DIV[4]/CENTER[1]/TABLE[1]/TBODY[1]/TR[9]/TH[3]/TABLE[1]/TBODY[1]/TR[4]/TH[1]/A[1]/IMG[1]', document, null, XPathResult.FIRST_ORDERED_NODE_TYPE,null).singleNodeValue,"height: 20px;width: 20px;",null,null);
set_style_script(window.document,document.evaluate('/HTML[1]/BODY[1]/DIV[4]/CENTER[1]/TABLE[1]/TBODY[1]/TR[9]/TH[3]/TABLE[1]/TBODY[1]/TR[4]/TH[2]/A[1]/IMG[1]', document, null, XPathResult.FIRST_ORDERED_NODE_TYPE,null).singleNodeValue,"height: 20px;width: 20px;",null,null);
