...
// @name           OdS_Tools_Bar
// @namespace      OdStips
// @description    Herraminetas para la alianza OdS
// @include        http://s8ikariam.*/index.php*
// @author         Original por Verx - Modificado por Taz2781 para OdS
// @version        20080615 102433
// ==/UserScript==

var OdSToolsIds  = new Array("opclos","FontForm","buscaBox","worldBox");
...
'<div id="menu">'
+ '<ul>'
+ ' <li><h2>OdDiN SeNaTuS</h2>'
+ '   <ul>'
+ '     <li><center><a target="" href="http://s8.ikariam.es/index.php?view=sendAllyMessage&oldView=diplomacyAdvisor&watch=4&id=38467&position=13&type=50" title="Envia mensaje Circular">Mensaje Circular</a></li>'
+ '     <li><center><a target="_blank" href="http://senatuspqr.mundoforo.com" title=" Foro de laAliansa OdS ">Foro OdDiN SeNaTuS</a></li>'
+ '     <li><center><a target="_blank" href="http://www.compactador.com.ar/IK/index.php" target="_blank" onClick="window.open(this.href, this.target, \'width=670,height=635\'); return false;" title=" Compactador de batallas para publicarlas en el foro ">Compactador de batallas</a></li>'
...
//+ '     <li><a href="#" title="Cambia il font" onclick="showTools(1)">Font <input style="margin-left:10px; visibility:hidden;" id="c'+OdSToolsIds[0]+'" type=CheckBox CHECKED DISABLED /></a></li>'
+ '     <li><center><a target="_blank" href="http://ikariam.ogame-world.com/es/suche.php?view=suche_stadt" title="Busca todas las ciudades, de un jugador o de una alianza">Buscar Jugadores</a></li>'
...
//+ '     <li><a href="#" title="Cerca un bersaglio" onclick="showTools(3)">Scansione <input style="margin-left:10px; visibility:hidden;" id="c'+OdSToolsIds[3]+'" type=CheckBox CHECKED DISABLED/></a></li>'
+ '     <li><center><a target="_blank" href="http://board.ikariam.es/board.php?boardid=115&sid=de2cd42a7d0eee017dfa009715d20e44" title="Foro Oficial, Mundo Theta">Foro Oficial</a></li>'
...
elemToShow = document.getElementById(OdSToolsIds[toolID[i]]);

if (elemToShow) {
 if ((toolID[i] == 0) || (toolID[i] == 1)) {if (document.getElementById(OdSToolsIds[0]).style.visibility == 'hidden') {
 document.getElementById(OdSToolsIds[0]).style.visibility = 'visible';
 document.getElementById(OdSToolsIds[1]).style.visibility = 'visible';
 if (document.getElementById('c'+OdSToolsIds[0])) document.getElementById('c'+OdSToolsIds[0]).style.visibility='visible';
 } else {
 document.getElementById(OdSToolsIds[0]).style.visibility = 'hidden';
 document.getElementById(OdSToolsIds[1]).style.visibility = 'hidden';
 if (document.getElementById('c'+OdSToolsIds[0])) document.getElementById('c'+OdSToolsIds[0]).style.visibility='hidden';
 }  } else {
 if (elemToShow.style.visibility == 'hidden') {elemToShow.style.visibility = 'visible'; if (document.getElementById('c'+OdSToolsIds[toolID[i]])) document.getElementById('c'+OdSToolsIds[toolID[i]]).style.visibility='visible';}
 else {elemToShow.style.visibility = 'hidden'; if (document.getElementById('c'+OdSToolsIds[toolID[i]])) document.getElementById('c'+OdSToolsIds[toolID[i]]).style.visibility='hidden';}
 }
}
}
}
...
var elemTrigger = document.getElementById(OdSToolsIds[0]);
...
'  <input type="hidden" name="welt" value="8"></font></p>'+
