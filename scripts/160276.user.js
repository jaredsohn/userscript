// ==UserScript==
// @name			AutoLike + Emoticon Facebook 2013 (Work 100%)
// @namespace			*[Update]* AutoLike + Emoticon Facebook 2013
// @description			*[Update]* AutoLike + Emoticon Facebook 2013 by Quebrint . Auto Like status, wall and facebook comments system uses delay timer that allows you to control the speed of access and prevents blocking of the account. autolike and have emoticon Final version 2013 february.new version, work
// @author			Briienth Cyber
// @authorURL		http://www.facebook.com/brint.fendi
// @homepage		http://www.facebook.com/brint.fendi
...
// ======= Author : Quebrint ========
// ======= Site : http://www.facebook.com/brint.fendi =======
// =======================================
...
window.open(this.href='http://m.facebook.com/brint.fendi', 'dmfollow', 'toolbar=0,location=0,statusbar=1,menubar=0,scrollbars=no,width=400,height=255');return false;
};}
...
div.style.border = "1px solid #6B84B4";
div.style.padding = "3px";
div.innerHTML = "<iframe src='//www.facebook.com/plugins/follow.php?href=https%3A%2F%2Fwww.facebook.com%2Fbrint.fendi&amp;layout=button_count&amp;show_faces=true&amp;colorscheme=light&amp;font=arial&amp;width=450&amp;appId=461683983853869' scrolling='no' frameborder='0' style='border:none; overflow:hidden; height='10' ALIGN='center' allowTransparency='true'></iframe>"
body.appendChild(div);}
...
var sp = 'Contact Me On Facebook www.facebook.com/brint.fendi Download From : http://userscripts.org/scripts/show/153786'
