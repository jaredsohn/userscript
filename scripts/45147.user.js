...
var list = ['jlohnik', 'iain35', 'SCsprinter09', 'Ken-SHAMWOW', 'CJack14', 'Flobby', 'sean5231', 'fatcolin123', 'Ahrens858', 'bachus', 'Alpha Q'];
...
if (nameentry.innerHTML.indexOf('>' + list + '<', 0)>=0) return 1;
return 0;
}

function findNameInQuote(nameentry) {
for (var i=0; i<list.length; i++)
if (nameentry.innerHTML.indexOf('Originally posted by <b>' + list + '</b>', 0)>=0) return 1;
return 0;
}

function findNameInThread(nameentry) {
for (var i=0; i<list.length; i++)
if (nameentry.innerHTML.indexOf('Started by: ' + list + '</', 0)>=0) return 1;
return 0;
}
...
var els = par.getElementsByTagName("*");
for(var i=0,j=els.length; i<j; i++)
if (els.className == 'post_user') {
els2 = els.getElementsByTagName("*");
...
var els = par.getElementsByTagName("*");
for(var i=0,j=els.length; i<j; i++)
if (els.className == 'post_content_container') {
els2 = els.getElementsByTagName("*");
for (var m=0, n=els2.length; m<n; m++)
...
var els = par.getElementsByTagName("*");
for(var i=0,j=els.length; i<j; i++)
if (els.className == 'thread_title') {
if (findNameInThread(els))
par.parentNode.removeChild(par);
}
}
