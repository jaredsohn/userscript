 ...
 * Changelog:
 *   31 Aug 2009, qspace:
 *     - Updated to a new maintainer version.
 *   18 Aug 2009, deFox:
...
//      TS_debug("getEnemyAttackArrivalTime: row "+i+" has "+tbcells.length+" cells");
  ...
  function prepSave(a2b_doc) 
  {
    ...
    reqUrl = "http://" + document.domain + "/a2b.php?" + getActiveVillageStr(document);
    reqData = "b="+1+"&t1="+trVal[1]+"&t4="+trVal[4]+"&t7="+trVal[7]+"&t9="+trVal[9]+"&t2="+trVal[2]+"&t5="+trVal[5]+"&t8="+trVal[8]+"&t10="+trVal[10]+"&t11="+trVal[11]+"&t3="+trVal[3]+"&t6="+trVal[6]+"&c="+cVal+"&dname=&x="+savePos[0]+"&y="+savePos[1]+"&s1=ok";
...
function finishSave(a2b_doc)
{
    ...
    reqUrl = "http://" + document.domain + "/a2b.php?" + getActiveVillageStr(document);
    reqData = 'id='+idVal+'&a='+aVal+'&c='+cVal+'&kid='+kidVal+'&t1='+trVal[1]+'&t2='+trVal[2]+'&t3='+trVal[3]+'&t4='+trVal[4]+'&t5='+trVal[5]+'&t6='+trVal[6]+'&t7='+trVal[7]+'&t8='+trVal[8]+'&t9='+trVal[9]+'&t10='+trVal[10]+'&t11='+trVal[11]+'&s1=ok&attacks=&cords=';
