...
var lang = {
	...
	it : {
		...
		'ConfSectionAbout' : '<a href="http://www.facebook.com/pages/Temi-Personalizzati/234855009909602?sk=wall" target="_blank">Riguardo di FFixer</a>',
	...
	el : {
		...
		'CreatingFile' : '??µ??????a ???e???',
		'Close' : '??e?s?µ?',
		'ConfigureFacebookFixer' : '??aµ??f?s? FFixer',
		...
		'ConfFacebookFixerLanguage' : 'G??ssa ??a t? FFixer',
		'ConfFacebookTimestamps' : '?µf???s? t?? ??a? t?? Facebook (p?. "???? 3 ??e?").',
		'ConfFBFTimestamps' : '???s???? t?? ??a? t?? FFixer µet? ap? t?? ??a t?? Facebook (p?. "11:45").',
		'ConfFBFTimestamps24' : '?µf???s? t?? ??a? t?? FFixer se 24-??? µ??f?.',
		...
		'ConfSectionAbout' : 'S?et??? µe t? FFixer',
		...
		'ConfShortcutList' : '<b>S??t?µe?se?? ????t????????</b> (e?a?s??s?a ?a?a?t????):<br /><br /><i>?p? ?p??ad?p?te se??da:</i><br /> <b>A</b> - ??µp??µ/F?t???af?e?<br /> <b>B</b> - ?µf???s?/?p?????? ??sta f???? (d?a??s?µ?? f????)<br /> <b>C</b> - ?p?????? FFixer<br /> <b>F</b> - F????<br /> <b>H</b> - ?????? Se??da<br /> <b>I</b> - ??se???µe?a<br /> <b>K</b> - ???s???? ??ap?µ????<br /> <b>L</b> - ?p????? t?? s??d?sµ?? ap?s??des?? (pat?ste t? Enter aµ?s?? µet? ??a ?a ap?s??de?e?te)<br /> <b>N</b> - ??d?p???se??<br /> <b>P</b> - ?? p??f?? sa?<br /> <b>T</b> - ?et?f?as? ep??e?µ???? ?e?µ????<br /> <b><escape></b> - ??e?s?µ? a?ad??µe??? d?µ??????µ??a ap? t? FFixer<br /><br /><i>?p? t?? a????? se??da</i>:<br /> <b>f</b> ? <b>l</b> - ???ta??? t??f?d?t?se??<br /> <b>i</b> - ??µ?s?e?µ??a st???e?a<br /> <b>n</b> - ???f?d?t?s? ????<br /> <b>p</b> - F?t???af?e?<br /> <b>s</b> ? <b>u</b> - ??a?e?se?? ?at?stas??<br /><br /><i>?p? p??f??</i>:<br /> <b>i</b> - ?????f???e?<br /> <b>p</b> - F?t???af?e?<br /> <b>w</b> - ??????<br /> <b>x</b> - ??a?s?a<br /><br /><i>?p? se??de? µe p?????s? (p??????µe??, ep?µe??, ?.?.)</i><br /> <b><a??ste?? ße????></b> - ???????µe??<br /> <b><de?? ße????></b> - ?p?µe??<br /> <b><shift> + <a??ste?? ße????></b> - ?????? (?ta? e??a? d?a??s?µ?)<br /> <b><shift> + <de?? ße????></b> - ?e?e?ta?a (?ta? e??a? d?a??s?µ?)<br /><br /><i>?at? t?? p??ß??? ??µp??µ/f?t???af?e?:</i><br /> <b>a</b> - F??t?s? ???? t?? µ??????af??? (?ta? e??a? d?a??s?µ?)<br /> <b>b</b> - ?µf???s? µe?a??te??? f?t???af???<br /> <b>c</b> - ?µf???s? pa?at???se??<br /> <b>k</b> - ?p?st??f? st? ??µp??µ<br /> <b>m</b> - F?t???af?e? ap? (?t?µ?) ?a? eµ??a<br /><br /><i>?at? t?? d????e?a p??sfat?? ??µp??µ ?a? a?eßasµ????/s?µe??µ???? f?t???af???:</i><br /> <b>a</b> ?  <b>r</b> - ???sfata ??µp??µ<br /> <b>m</b> ?  <b>u</b> - ??eßasµ??a ap? ????t?<br /> <b>o</b> - F?t???af?e? µe µ??a<br /> <b>p</b> - ?? f?t???af?e? µ??<br /> <b>t</b> ?  <b>f</b> - S?µe??µ???? f????',
		...
		'ConfUpdates' : '??e???? Userscripts.org ?a??µe???? ??a ?a???????e? e??µe??se?? t?? FFixer ? <a href="#" id="fbfUpdateLink" onclick="return false;">??e???? t??a</a>.',
		'DownloadVideo' : '???? ???te?',
		'ExportICalendarFile' : '??a???? a??e??? iCalendar',
		'ExportICalendarFileWarning' : '(??t? ?a p??e? a??et? ??a a? ??ete p?????? f?????)',
		'FacebookFixerConflict' : '?? FacebookFixer e??a? p???? ???st? sa? FFixer. ???? t?? a??a??? t?? ???µat?? ?a p??pe? ?a ape??atast?sete ?e???????ta t? FFixer ap? t?? pe?????t? sa?, d?af??et??? ta d?? p?????µµata ?a s????????ta? µeta?? t???. ??? de? e?saste s??????? ??a t? p?? ?a ape??atast?sete ??a p????aµµa userscript, <a %s>pat?ste ed? ??a ?d???e?</a>.',
		...
		'UpdateAvailable1' : '?p???e? ?a???????a d?a??s?µ? ??d?s? t?? FFixer',
	...
	sk : {
		...
		'Close' : 'Zavriet',
		'ConfigureFacebookFixer' : 'Konfigurovat FFixer',
		...
		'ConfFBFTimestamps' : 'Pridat casové znacky skriptu Facebook Fixer za casové znacky Facebooku (t. j. "11:45")',
		'ConfFBFTimestamps24' : 'Zobrazit casové znacky skriptu Facebook Fixer v 24-hodinovom formáte',
		...
		'ConfSectionAbout' : 'Co je Facebook Fixer',
		...
		'ConfShortcutList' : '<b>Klávesové skratky</b> (rozlišujú sa malé/velké písmená):<br /><br /><i>Z lubovolnej stránky:</i><br /> <b>A</b> – Albumy/fotky<br /> <b>B</b> – Prepnút zoznam priatelov (online priatelia)<br /> <b>C</b> – Konfigurácia skriptu Facebook Fixer<br /> <b>D</b> – Narodeniny<br /> <b>E</b> – Udalosti<br /> <b>F</b> – Priatelia<br /> <b>H</b> – Domov<br /> <b>I</b> – Prijaté správy<br /> <b>L</b> – Vybrat odkaz Odhlásit sa (po odhlásení stlacte Enter)<br /> <b>N</b> – Upozornenia<br /> <b>P</b> – Váš profil<br /> <b>R</b> – Žiadosti<br /> <b>S</b> – Preskocit na pole Hladat<br /> <b>T</b> – Preložit vybraný text<br /> <b>?</b> – Zobrazit informácie o ladení skriptu Facebook Fixer<br /> <b><Esc></b> – Zavriet kontextové okná vytvorené skriptom Facebook Fixer<br /><br /><i>Zo stránky Domov (filtre)</i>:<br /> <b>a</b> – Stránky<br /> <b>f</b> – Aktuality<br /> <b>g</b> – Skupiny<br /> <b>l</b> – Odkazy<br /> <b>n</b> – Novinky<br /> <b>p</b> – Fotky<br /> <b>s</b> alebo <b>u</b> – Co robia ostatní<br /> <b>t</b> – Poznámky<br /> <b>v</b> – Videá<br /><br /><i>Z profilov</i>:<br /> <b>i</b> – Informácie<br /> <b>p</b> – Fotky<br /> <b>w</b> – Nástenka<br /> <b>x</b> – Priecinky<br /><br /><i>Zo stránok s navigáciou (dozadu, dopredu atd.)</i><br /> <b><šípka dolava></b> – Dozadu<br /> <b><šípka doprava></b> – Dopredu<br /> <b><shift> + <šípka dolava></b> – Prvá (ak je k dispozícii)<br /> <b><shift> + <šípka doprava></b> – Posledná (ak je k dispozícii)<br /><br /><i>Pocas prezerania albumov/fotiek:</i><br /> <b>a</b> – Nacítat všetky miniatúry (ak je k dispozícii)<br /> <b>b</b> – Zobrazit velké obrázky<br /> <b>c</b> – Zobrazit komentáre<br /> <b>k</b> – Spät na album<br /> <b>m</b> – Fotky osoby a mna<br /><br /><i>Pocas prezerania najnovších albumov a nahratých fotiek/fotiek s menovkou:</i><br /> <b>a</b> or  <b>r</b> – Najnovšie albumy<br /> <b>m</b> alebo  <b>u</b> – Nahraté z mobilu<br /> <b>o</b> – Fotky, na ktorých som ja<br /> <b>p</b> – Moje fotky<br /> <b>t</b> alebo  <b>f</b> Menovky priatelov',
		...
		'ConfUpdates' : 'Denne na Userscripts.org overovat aktualizácie pre Facebook Fixer, prípadne <a href="#" id="fbfUpdateLink" onclick="return false;">skontrolovat teraz</a>.',
		...
		'FacebookFixerConflict' : 'Facebook Fixer sa odteraz nazýva FFixer.<br /><br />Pretože sa zmenil názov, je potrebné rucne odinštalovat Facebook Fixer z prehliadaca, inak budú v konflikte dva skripty medzi sebou navzájom.<br /><br />Ak neviete, ako skript odinštalovat, <a %s>kliknutím sem otvorte pokyny</a>.',
	...
	tr : {
		...
		'Close' : 'Kapat',
		'ConfigureFacebookFixer' : 'FFixer\'i Yapilandir',
		...
		'ConfFacebookFixerLanguage' : 'FFixer\'in Dili',
		'ConfFacebookTimestamps' : 'Facebook\'un zaman etiketlerini göster (örn. "3 saat önce").',
		'ConfFBFTimestamps' : 'Facebook\'un zaman etiketlerinin ardindan FFixer zaman etiketlerini ekle (örn. "11:45").',
		...
		'ConfSectionAbout' : 'FFixer Hakkinda',
		...
		'ConfUpdates' : 'FFixer güncellemeleri için her gün Userscripts.org\'u ziyaret et. Ya da <a href="#" id="fbfUpdateLink" onclick="return false;">simdi kontrol et</a>.',
		...
		'FacebookFixerConflict' : 'FFixer\'in yeni adi artik FFixer. Isim degisikliginden dolayi FFixer\'i tarayicinizdan kaldirmaniz gerekiyor, yoksa bu iki script birbiriyle uyusmazlik sorunlari çikaracaktir. Eger bir userscript\'i nasil kaldiracaginizdan emin degilseniz <a %s>buraya tiklayarak ögrenebilirsiniz</a>.',
	...
	sr : {
		...
		'ConfFBFTimestamps24' : 'Prikaži FFixer vremena u 24-casovnom obliku.',
		...
		'FacebookFixerConflict' : 'FFixer se sada zove FFixer. Zbog promene imena moracete rucno da uklonite FFixer iz svog pregledaca da ne bi došlo do ometanja izmedu ove dve skripte. Ako niste sigurni kako da uklonite skriptu, <a %s>kliknite ovde za uputstvo</a>.',
	...
	cs : {
		...
		'ConfFacebookTimestamps' : 'Zobrazit casové znacky Facebooku (t. j. "pred 3 hodinami")',
		'ConfFBFTimestamps' : 'Pridat casové znacky skriptu FFixer za casové znacky Facebooku (t. j. "11:45")',
		'ConfFBFTimestamps24' : 'Zobrazit casové znacny skriptu FFixer v 24-hodinovém formáte',
		...
		'ConfUpdates' : 'Denne na Userscripts.org overovat aktualizace pro FFixer, prípadne <a href="#" id="fbfUpdateLink" onclick="return false;">zkontrolovat nyní</a>.',
		...
		'FacebookFixerConflict' : 'Facebook Fifex je nyní znám jako FFixer.<br /><br />Protože se zmenilo jméno, musíte manuálne odinstalovat Facebook Fixer z vašeho prohlížece.<br /><br />Pokud si nevíte jak na to <a %s>pokracujte zde</a>.',
	...
	vi : {
		...
		'Close' : 'Ðóng',
		'ConfigureFacebookFixer' : 'Cài d?t FFixer',
		...
		'ConfFacebookFixerLanguage' : 'Ngôn ng? cho FFixer',
		'ConfFacebookTimestamps' : 'Hi?n m?c th?i gian c?a facebook (ví d?: "3 hours ago").',
		'ConfFBFTimestamps' : 'Thêm m?c th?i gian c?a FFixer sau m?c th?i gian c?a Facebook (ví d?: "11:45").',
		...
		'ConfProtocolLinks' : 'Turn messenger IDs on profiles into links that start a conversation with them (Google Talk, Windows Live etc).',
		'ConfSectionAbout' : 'Thông tin v? FFixer',
		...
		'ConfUpdates' : 'Hãy truy c?p vào Userscripts.org hàng ngày d? c?p nh?t FFixer. ho?c <a href="#" id="fbfUpdateLink" onclick="return false;">ki?m tra ngay</a>.',
		'DownloadVideo' : 'Download Video',
		'ExportICalendarFile' : 'Export iCalendar file',
		'ExportICalendarFileWarning' : '(Ði?u này s? m?t m?t kho?ng th?i gian n?u b?n có r?t nhi?u b?n bè)',
		'FacebookFixerConflict' : 'Facebook Fixer nay du?c g?i là FFixer.<br /><br />B?i vì thay d?i tên nên b?n c?n ph?i t? g? b? Facebook Fixer t? trình duy?t c?a b?n, ho?c hai k?ch b?n s? xung d?t v?i nhau.<br /><br />N?u b?n không bi?t g? b? m?t userscript, <a %s>b?m vào dây d? du?c hu?ng d?n</a>.',
		...
		'today' : 'hôm nay',
		'Translators' : 'Translators',
		'UpdateAvailable1' : 'Ðã có b?n c?p nh?t m?i cho FFixer',
