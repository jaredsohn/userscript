﻿// coding: utf-8
// ==UserScript==
// @name           ikariam alarme et Tableau
// @namespace      psmith
// @description    Greek Version 
//                 
//                 
//                 
// @include        http://s6.ikariam.fr/index.php*
// ==/UserScript==
/**************************************************************************************************
Version history:
- 2008.07.22:
  * Internazionalization of changes made only for .cn (by Kupy123)
...
"LETTERCHANNEL" :"LETTERCHANNEL",
"TABLE_PLAYERS" :"Show players and cities table (under development)",
...
"LETTERCHANNEL" :"信件通道已研究",
"TABLE_PLAYERS" :"显示玩家和城市信息 (开发中)",
...
"Reset_all_data" :"重置数据",
    ...
    texts = {
      ...
      "hide_settings": "Hide settings", "show_settings": "Show settings",
"scienceReport" : "Reporte de ciencia",
"constructionLevel" : "Nivel de construcción",
"scientists" : "Cientificos/as",
"production" : "Producción",
"costs" : "Coste",
"goTo" : "Ir a",
"armyReport" : "Reporte de armada",
"resourcesReport" : "Reporte de recursos",
"buildingsReport" : "Reporte de construcciones",
"h" : "h",
"day" : "dia",
"hoursToFull" : "h -> lleno",
"hoursToEmpty" : "h -> vacío",
"available" : "disponible",
"fullness" : "lleno",

"lastUpdate" : "última actualización", 
"appendDestination" : "Añadir a destinos habituales",
"removeDestination" : "Eliminar destino habitual",
"appendDestinationNameLabel" : "Escribe un nombre para el destino habitual",
"appendDestinationNameErrorLabel" : "El nombre escogido no es válido",
"removeDestinationConfirmLabel" : "¿Estás seguro/a de querer eliminar el destino habitual?",

"SETTINGS_RESET_DATA_CONFIRM" : "¿Estás seguro/a de querer eliminar TODA la información almacenada?",
"ALERT_SOUNDS" :"Sonidos de alerta",
"ALERT_VOLUME" :"Volumen de alerta",
"WARNING_VOLUME" :"Volumen de aviso",
"AUTO_REFRESH" :"Auto refresco",
"AUTO_REFRESH_MIN_SECS" :"Auto refresco (segundos mínimos)",
"AUTO_REFRESH_MAX_SECS" :"Auto refresco (segundos máximos)",
"TABLE_RESOURCES" :"Mostrar tabla de recursos",
"TABLE_BUILDINGS" :"Mostrar tabla de edificios",
"TABLE_ARMYFLEET" :"Mostrar tabla de armada",
"TABLE_RESEARCH" :"Mostrar tabla de investigación",
"LETTERCHANNEL" :"LETTERCHANNEL",
"TABLE_PLAYERS" :"Mostrar tabla de ciudades y jugadores (en desarrollo)",
"PROGRESS_BAR_MODE" :"Modo de la barra de recursos",
"off" :"sin barra",
"time" :"basada en el tiempo restante",
"percent" :"basada en el porcentaje de almacenaje lleno",
"LANGUAGE" :"Lenguaje",
"LANGUAGE_AUTO" :"Automático",
"ownAlly" :"Alianza propia (nombre corto)",
"friendlyAllies" :"Alianzas amigas (nombres cortos, separados con comas)",
"hostileAllies" :"Alianzas hostiles (nombres cortos, separados con comas)",
"DEBUG_LOG" :"Almacear mensajes de depuración",

"Refresh_table" :"Refrescar tabla",
...
"scienceReport" : "Αναφορά Επιστήμης",
"constructionLevel" : "Επίπεδο Οικοδόμησης",
"scientists" : "Επιστήμονες",
"production" : "Παραγωγή",
"costs" : "Έξοδα",
"goTo" : "Πήγαινε στο",
"armyReport" : "Αναφορά Στρατού",
"resourcesReport" : "Αναφορά Αποθεμάτων",
"buildingsReport" : "Αναφορά Κτιριων",
"h" : "ώρα",
"day" : "ημέρα",
"hoursToFull" : "ώρες μέχρι να γεμίσει",
"hoursToEmpty" : "ώρες μέχρι να αδειάσει",
"available" : "Διαθέσιμο",
"fullness" : "Πληρότητα",

"lastUpdate" : "Τελευταία αναβάθμιση", 
"appendDestination" : "Προσθήκη στους αγαπημένους προορισμούς",
"removeDestination" : "Αφαίρεση απο τους αγαπημένους προορισμούς",
"appendDestinationNameLabel" : "Προσθέστε ονομασία για τον συγκεκριμένο προορισμό",
"appendDestinationNameErrorLabel" : "Η ονομασία που δώσατε είναι λανθασμένη, παρακαλώ προσπαθήστε ξανά",
"removeDestinationConfirmLabel" : "Είστε σίγουρος οτι θέλετε να αφαιρέσετε τον συγκεκριμένο προορισμό απο την λίστα;",

"SETTINGS_RESET_DATA_CONFIRM" : "Είστε σίγουρος οτι θέλετε να αφαιρέσετε όλα τα αποθηκευμένα δεδομένα;",
"ALERT_SOUNDS" :"Ηχητικές ειδοποιήσεις",
"ALERT_VOLUME" :"Ένταση ήχου ειδοποίησης",
"WARNING_VOLUME" :"Ένταση ήχου προειδοποίησης",
"AUTO_REFRESH" :"Αυτόματη ανανέωση",
"AUTO_REFRESH_MIN_SECS" :"Αυτόματη ανανέωση - ελάχιστος χρόνος εκκίνησης (δευτερόλεπτα)",
"AUTO_REFRESH_MAX_SECS" :"Αυτόματη ανανέωση - μέγιστος χρόνος εκκίνησης (δευτερόλεπτα)",
"TABLE_RESOURCES" :"Εμφάνιση πίνακα Αποθεμάτων",
"TABLE_BUILDINGS" :"Εμφάνιση πίνακα Κτιρίων",
"TABLE_ARMYFLEET" :"Εμφάνιση πίνακα Στράτου και Στόλου",
"TABLE_RESEARCH" :"Εμφάνιση πίνακα Έρευνας",
"LETTERCHANNEL" :"LETTERCHANNEL",
"TABLE_PLAYERS" :"Εμφάνιση πίνακα παικτών και πόλεων (υπό προγραματισμό)",
"PROGRESS_BAR_MODE" :"Μπάρα ελέγχου πρόοδου αποθεμάτων",
"off" :"Εκτώς Λειτουργείας",
"time" :"Με βάση τον υπολείποντα χρόνο",
"percent" :"Με βάση ποσοστό πληρότητας",
"LANGUAGE" :"Γλώσσα",
"LANGUAGE_AUTO" :"Αυτόματος καθορισμός γλώσσας ",
"ownAlly" :"Η Συμμαχία σας(συντομογραφία)",
"friendlyAllies" :"Φιλικές Συμμαχίες (συντομογραφίες διαχωρισμένες με κόμα)",
"hostileAllies" :"Εχθρικές Συμμαχίες (Συντομογραφίες χωρισμένες με κόμα)",
"DEBUG_LOG" :"Καταγραφή μυνημάτων επαναπρογραμματισμού",

"Refresh_table" :"Ανανέωση πίνακα",
"Reset_all_data" :"Επαναφόρα αρχικών ρυθμίσεων",
    };
...
"Reset_all_data" :"Reset all data",
    ...
    texts = {
      ...
      "hide_settings": "Masquer les paramètres", "show_settings": "Montrer les paramètres", 
"scienceReport" : "Tableau des Rapports Scientifiques",
"constructionLevel" : "Niveau de Construction",
"scientists" : "Scientifique",
"production" : "Production",
"costs" : "Dépenses",
"goTo" : "Direction l'",
"armyReport" : "Tableau des Troupes dans la ville",
"resourcesReport" : "Tableau des Ressources",
"buildingsReport" : "Tableau des Constructions et Bâtiment",
"h" : "h",
"day" : "jour",
"hoursToFull" : "heures avant stock plein",
"hoursToEmpty" : "heures avant stock vide",
"available" : "disponible",
"fullness" : "plein",

"lastUpdate" :"dernière mise à jour", 
"appendDestination" :"Ajouter aux destinations",
"removeDestination" :"Retirer des destinations",
"appendDestinationNameLabel" :"Tapez un nom pour cette destination",
"appendDestinationNameErrorLabel" :"Le nom spécifié n'est pas valide, réessayez",
"removeDestinationConfirmLabel" :"Êtes-vous sûr de vouloir supprimer cette destination de la liste?",


"SETTINGS_RESET_DATA_CONFIRM" :"Êtes-vous sûr de vouloir supprimer toutes les données stockées?",
"ALERT_SOUNDS" :"Activer les Alertes son",
"ALERT_VOLUME" :"Volume",
"WARNING_VOLUME" :"Volume du Warning",
"AUTO_REFRESH" :"Rafraîchissement Auto",
"AUTO_REFRESH_MIN_SECS" :"Rafraîchissement Auto min secondes",
"AUTO_REFRESH_MAX_SECS" :"Rafraîchissement Auto max secondes",
"TABLE_RESOURCES" :"Afficher le tableau des Ressources",
"TABLE_BUILDINGS" :"Afficher le tableau des Batiments",
"TABLE_ARMYFLEET" :"Afficher le tableau des Armées et Flottes",
"TABLE_RESEARCH" :"Afficher le tableau des Académie",
"LETTERCHANNEL" :"LETTERCHANNEL",
"TABLE_PLAYERS" :"Afficher le tableau des joueurs et des villes",
"PROGRESS_BAR_MODE" :"Mode de la barre de Progression des ressources",
"off" :"off",
"time" :"Afficher le temps restant",
"percent" :"fondée sur le pourcentage de remplissage",
"LANGUAGE" :"Langue",
"LANGUAGE_AUTO" :"Auto selon le nom de serveur",
"ownAlly" :"Mon Alliance (noms court)",
"friendlyAllies" :"Alliances Amies (noms court, séparer par une virgule)",
"hostileAllies" :"Alliances Hostiles (noms court, séparer par une virgule)",
"DEBUG_LOG" :"Log debug messages",

"Refresh_table" :"Rafraichir les Tableaux",
"Reset_all_data" :"Supprimer toutes les données",
    };
...
function createCounter(startTime, startAmount, factPerHour, showTooltip, maxCapacity, plusText) {
  ...
  if ((PROGRESS_BAR_MODE != "off") && (maxCapacity > 0)) {
    ...
    if (factPerHour > 0) {
      ...
      remaining = "<br>"+floatFormat(remhour, 1) + " " + texts["hoursToFull"];
    } else if (factPerHour < 0) {
      remaining = "<br>"+floatFormat(curres / -factPerHour, 1) + " " + texts["hoursToEmpty"];
    }
...
function createLastUpdateAsTooltip(content, time) {
  return createTooltip(content, texts["lastUpdate"]+" "+smartDateFormat(time, true));
}
...
function renderTables() {
  ...
  if (TABLE_RESOURCES) {
    ...
    s += "<caption>"+texts["resourcesReport"]+"</caption>";
...
//        growthRemainingHours = floatFormat((parseInt(spacetotal) + parseInt(bonusspace) - parseInt(population)) / (0.02 * happiness), 1) + " h";
  ...
  if (TABLE_BUILDINGS) {
    s += "<table border=1 class='table01'>";
    s += "<caption>"+texts["buildingsReport"]+"</caption>";
  ...
  if(TABLE_RESEARCH) {
    ...
    s += "<tr class='table_header'><th>"+texts["cityName"]+"</th>"+
    		 "<th class='lf'>"+texts["constructionLevel"]+"</th>"+
    		 "<th>"+texts["scientists"]+"</th>"+
    		 "<th>"+texts["production"]+"</th>"+
    		 "<th>"+texts["costs"]+"</th>"+
    		 "<th></th>";
    s += "</tr>";
  ...
  if (TABLE_ARMYFLEET) {
    if (config["unitnames"] != undefined) {
      ...
      if (usedIndexesCount > 0) {
        s += "<table border=1 class='table01'>";
        s += "<caption>"+texts["armyReport"]+"</caption>";
        s += "<tr class='table_header'><th class='table_header'>"+texts["cityName"]+"</th>";
        for(key in names) {
          var name = names[key];
  ...
  if (true) {
    ...
    t.appendChild(createRowChk(texts["LETTERCHANNEL"]+":", "LETTERCHANNEL", "LETTERCHANNEL"));
    ...
    t.appendChild(createRowSlct(texts["LANGUAGE"]+":", "LANGUAGE", language, {"": texts["LANGUAGE_AUTO"], cn: "简体中文" ,tw: "TChinese",en: "English", hu: "Magyar", de: "German", cz: "Czech", tr: "Turkish", es: "Spanish", ba: "Bosnian", it: "Italian", pt: "Portuguese", fr: "French"}));
