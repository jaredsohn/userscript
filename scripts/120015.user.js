...
var lang = {
	...
	es : {
		...
		'Close' : 'Cerrar',
		'ConfigureFacebook-foREVer-' : 'Configuración de -foREVer- Script',
		...
		'ConfFBFTimestamps' : 'Añadir las marcas de tiempo de -foREVer- Script después de las marcas de tiempo de Facebook (Por ejemplo "11:45").',
		...
		'ConfShortcutList' : '<b>Atajos de Teclado</b> (sensible a la diferencia entre minúsculas y mayúsculas):<br /><br /><i>Desde cualquier página:</i><br />&nbsp;<b>A</b> - Álbumes/Fotos<br />&nbsp;<b>B</b> - Activar/Desactivar lista de amigos (Amigos conectados)<br />&nbsp;<b>C</b> - Configuración de -foREVer- Script<br />&nbsp;<b>D</b> - Cumpleaños<br />&nbsp;<b>E</b> - Eventos<br />&nbsp;<b>F</b> - Amigos<br />&nbsp;<b>H</b> - Página de Inicio<br />&nbsp;<b>I</b> - Bandeja de Entrada<br />&nbsp;<b>K</b> - Añadir Marcador<br />&nbsp;<b>L</b> - Seleccionar vínculo para terminar la sesión (presione Enter después para terminar la sesión)<br />&nbsp;<b>N</b> - Notificaciones<br />&nbsp;<b>P</b> - Perfil<br />&nbsp;<b>R</b> - Peticiones<br />&nbsp;<b>S</b> - Saltar a el campo de búsqueda<br />&nbsp;<b>T</b> - Traducir el texto seleccionado<br />&nbsp;<b>?</b> - Mostrar la información de depuración de -foREVer- Script<br />&nbsp;<b><escape></b> - Cerrar la ventana emergente creada por -foREVer- Script<br /><br /><i>Desde la página de inicio (filtros)</i>:<br />&nbsp;<b>a</b> - Páginas<br />&nbsp;<b>f</b> - Live feed<br />&nbsp;<b>g</b> - Grupos<br />&nbsp;<b>l</b> - Vínculos<br />&nbsp;<b>n</b> - Noticias<br />&nbsp;<b>p</b> - fotos<br />&nbsp;<b>s</b> or <b>u</b> - Estatus de las Actualizaciones<br />&nbsp;<b>t</b> - Notas<br />&nbsp;<b>v</b> - Vídeos<br /><br /><i>Desde los perfiles</i>:<br />&nbsp;<b>i</b> - Información<br />&nbsp;<b>p</b> - Fotos<br />&nbsp;<b>w</b> - Muro<br />&nbsp;<b>x</b> - Cajas<br /><br /><i>Desde las páginas con paginación (previo, siguiente, etc)</i><br />&nbsp;<b><left arrow></b> - Previo<br />&nbsp;<b><right arrow></b> - Siguiente<br />&nbsp;<b><shift> + <left arrow></b> - Primera (cuando este disponible)<br />&nbsp;<b><shift> + <right arrow></b> - Ultimo (cuando este disponible)<br /><br /><i>Al ver albumes/fotos:</i><br />&nbsp;<b>a</b> - Ver todas la miniaturas (cuando este disponible)<br />&nbsp;<b>b</b> - Ver fotos grandes<br />&nbsp;<b>c</b> - Ver comentarios<br />&nbsp;<b>k</b> - De vuelta al álbum<br />&nbsp;<b>m</b> - Fotos de (personas) y yo<br /><br /><i>Al ver albumes recientes y fotos subidas/marcadas:</i><br />&nbsp;<b>a</b> or &nbsp;<b>r</b> - Albumes Recientes<br />&nbsp;<b>m</b> or &nbsp;<b>u</b> - Fotos de Móviles<br />&nbsp;<b>o</b> - Fotos de mi<br />&nbsp;<b>p</b> - Mis Fotos<br />&nbsp;<b>t</b> or &nbsp;<b>f</b> - Amigos Marcados', 'ConfTopBarHoverOpacity' : 'Al pasar el ratón por encima', 'Facebook-foREVer-Conflict' : 'Facebook -foREVer- ahora se llama -foREVer- Script.<br /><br />Por el cambio de nombre es necesario desinstalar Facebook -foREVer- manualmente de su navegador o los dos programas entraran en conflicto.<br /><br />Si no sabe como desinstalar un userscript, <a %s>haga clic aquí para ver instrucciones</a>.',
		...
		'UpdateAvailable1' : 'Hay una actualización disponible para -foREVer- Script',
	...
	it : {
		...
		'UpdateAvailable1' : 'È disponibile un update per -foREVer- Script.',
	...
	de : {
		...
		'ConfFacebook-foREVer-Language' : 'Sprache für -foREVer- Script',
		...
		'ConfUpdates' : 'UÜberprüfen Sie Userscripts.org täglich auf Updates für -foREVer- Script. <a href="#" id="fbfUpdateLink" onclick="return false;">Jetzt überprüfen</a>.',
		...
		'Left' : 'Links',
		'ListeningRestarted' : '-foREVer- Script reagiert wieder auf Änderungen.',
		'ListeningStopped' : '-foREVer- Script reagiert nicht auf Änderungen.\nL (SHIFT + l) drücken, um die Reaktion wieder zu aktvieren.',
		...
		'today' : 'heute',
		'UpdateAvailable1' : 'Es gibt ein Update für -foREVer- Script',
	...
	bg : {
		...
		'Close' : 'Затваряне',
		'ConfigureFacebook-foREVer-' : 'Конфигуриране на -foREVer- Script',
		...
		'ConfFacebook-foREVer-Language' : 'Език за -foREVer- Script',
		...
		'ConfUpdates' : 'Проверяване на Userscripts.org ежедневно за ъпдейти на -foREVer- Script. Или <a href="#" id="fbfUpdateLink" onclick="return false;">проверка сега</a>.',
		...
		'Left' : 'Отляво',
		'ListeningRestarted' : '-foREVer- Script възстанови проверките за промени.',
		'ListeningStopped' : '-foREVer- Script спря проверките за промени.\nНатиснете L (Shift + l) за повторно пускане',
		...
		'today' : 'днес',
		'UpdateAvailable1' : 'Излязло е обновление на -foREVer- Script',
	...
	el : {
		...
		'Close' : 'Κλείσιμο',
		'ConfigureFacebook-foREVer-' : 'Διαμόρφωση -foREVer- Script',
		...
		'ConfFacebook-foREVer-Language' : 'Γλώσσα για το -foREVer- Script',
		'ConfFacebookTimestamps' : 'Εμφάνιση της ώρας του Facebook (πχ. "Πριν 3 ώρες").',
		'ConfFBFTimestamps' : 'Προσθήκη της ώρας του -foREVer- Script μετά από την ώρα του Facebook (πχ. "11:45").',
		'ConfFBFTimestamps24' : 'Εμφάνιση της ώρας του -foREVer- Script σε 24-ωρη μορφή.',
		...
		'ConfSectionAbout' : 'Σχετικά με το -foREVer- Script',
		...
		'ConfUpdates' : 'Έλεγχος Userscripts.org καθημερινά για καινούργιες ενημερώσεις του -foREVer- Script ή <a href="#" id="fbfUpdateLink" onclick="return false;">έλεγχος τώρα</a>.',
		...
		'Facebook-foREVer-Conflict' : 'Το Facebook-foREVer- είναι πλέον γνωστό σαν -foREVer- Script. Λόγω της αλλαγής του ονόματος θα πρέπει να απεγκαταστήσετε χειροκίνητα το -foREVer- Script από τον περιηγητή σας, διαφορετικά τα δύο προγράμματα θα συγκρούονται μεταξύ τους. Εάν δεν είσαστε σίγουροι για το πως να απεγκαταστήσετε ένα πρόγραμμα userscript, <a %s>πατήστε εδώ για οδηγίες</a>.',
		...
		'UpdateAvailable1' : 'Υπάρχει καινούργια διαθέσιμη έκδοση του -foREVer- Script',
	...
	sk : {
		...
		'Close' : 'Zavrieť',
		'ConfigureFacebook-foREVer-' : 'Konfigurovať -foREVer- Script',
		...
		'ConfFBFTimestamps' : 'Pridať časové značky skriptu Facebook -foREVer- za časové značky Facebooku (t. j. "11:45")',
		'ConfFBFTimestamps24' : 'Zobraziť časové značky skriptu Facebook -foREVer- v 24-hodinovom formáte',
		...
		'ConfSectionAbout' : 'Čo je Facebook -foREVer-',
		...
		'ConfUpdates' : 'Denne na Userscripts.org overovať aktualizácie pre Facebook -foREVer-, prípadne <a href="#" id="fbfUpdateLink" onclick="return false;">skontrolovať teraz</a>.',
		...
		'Facebook-foREVer-Conflict' : 'Facebook -foREVer- sa odteraz nazýva -foREVer- Script.<br /><br />Pretože sa zmenil názov, je potrebné ručne odinštalovať Facebook -foREVer- z prehliadača, inak budú v konflikte dva skripty medzi sebou navzájom.<br /><br />Ak neviete, ako skript odinštalovať, <a %s>kliknutím sem otvorte pokyny</a>.',
		...
		'UpdateAvailable1' : 'K dispozícii je aktualizácia skriptu Facebook -foREVer-.',
	...
	zh_tw : {
		...
		'CreatingFile' : '創建文件',
		'Close' : '關閉',
		'ConfigureFacebook-foREVer-' : '設定 -foREVer- Script',
		...
		'ConfFacebook-foREVer-Language' : '-foREVer- Script的語言選項',
		'ConfFacebookTimestamps' : '顯示Facebook原來的時間戳記 (eg. "3 hours ago").',
		'ConfFBFTimestamps' : '新增-foREVer- Script的顯示時間戳記 (eg. "11:45").',
		'ConfFBFTimestamps24' : '-foREVer- Script的時間戳記採用24小時制。',
		...
		'ConfSectionAbout' : '關於 -foREVer- Script',
		...
		'ConfShortcutList' : '<b>鍵盤快捷鍵</b> (大小寫區分):<br /><br /><i>從任何頁面:</i><br />&nbsp;<b>A</b> - 相本/相片<br />&nbsp;<b>B</b> - 切換好友列表 (在線好友)<br />&nbsp;<b>C</b> - -foREVer- Script 設置<br />&nbsp;<b>D</b> - 生日<br />&nbsp;<b>E</b> - 活動<br />&nbsp;<b>F</b> - 朋友<br />&nbsp;<b>H</b> - 首頁<br />&nbsp;<b>I</b> - 信箱<br />&nbsp;<b>L</b> - 選擇登出連結 (按下確定後登出)<br />&nbsp;<b>N</b> - 通知<br />&nbsp;<b>P</b> - 你的個人資料<br />&nbsp;<b>R</b> - 請求<br />&nbsp;<b>S</b> - 跳到搜索欄位<br />&nbsp;<b>T</b> - 翻譯選擇的內容<br />&nbsp;<b>?</b> - 顯示-foREVer- Script除錯訊息<br />&nbsp;<b>&lt;escape&gt;</b> - 使用-foREVer- Script關閉彈出視窗<br /><br /><i>從首頁 (過濾)</i>:<br />&nbsp;<b>a</b> - 頁面<br />&nbsp;<b>f</b> - 即時動態<br />&nbsp;<b>g</b> - 團體<br />&nbsp;<b>l</b> - 連結<br />&nbsp;<b>n</b> - 新的動態<br />&nbsp;<b>p</b> - 相片<br />&nbsp;<b>s</b> or <b>u</b> - 更新狀態<br />&nbsp;<b>t</b> - 筆記<br />&nbsp;<b>v</b> - 影片<br /><br /><i>從個人資料</i>:<br />&nbsp;<b>i</b> - 信息<br />&nbsp;<b>p</b> - 相片<br />&nbsp;<b>w</b> - 牆<br />&nbsp;<b>x</b> - 盒子<br /><br /><i>從網頁的頁碼 (previous, next, etc)</i><br />&nbsp;<b>&lt;left arrow&gt;</b> - Previous<br />&nbsp;<b>&lt;right arrow&gt;</b> - 下一個<br />&nbsp;<b>&lt;shift&gt; + &lt;left arrow&gt;</b> - 首先 (當可以使用)<br />&nbsp;<b>&lt;shift&gt; + &lt;right arrow&gt;</b> - 最後 (當可以使用)<br /><br /><i>當瀏覽相本/相片:</i><br />&nbsp;<b>a</b> - 讀取所有縮圖 (當可以使用)<br />&nbsp;<b>b</b> - 顯示大張的圖片<br />&nbsp;<b>c</b> - 查看留言<br />&nbsp;<b>k</b> - 返回相本<br />&nbsp;<b>m</b> - 照片 (個人) 和我<br /><br /><i>查看最近上傳/標記的相片:</i><br />&nbsp;<b>a</b> or &nbsp;<b>r</b> - 最新的相本<br />&nbsp;<b>m</b> or &nbsp;<b>u</b> - 手機上傳<br />&nbsp;<b>o</b> - 我的相片<br />&nbsp;<b>p</b> - 我的相片<br />&nbsp;<b>t</b> or &nbsp;<b>f</b> - 標記的朋友',
		...
		'ConfUpdates' : '檢查 Userscripts.org For -foREVer- Script 的更新。 或是 <a href="#" id="fbfUpdateLink" onclick="return false;">立即確認</a>.',
		'DownloadVideo' : '下載影片',
		'ExportICalendarFile' : '輸出 iCalendar 檔案',
		'ExportICalendarFileWarning' : '(如果你有很多的朋友的話，將要一段時間)',
		'Facebook-foREVer-Conflict' : 'Facebook -foREVer-現在更名為-foREVer- Script。<br /><br />由於更改名稱，你需要手動從瀏覽器中卸載舊的Facebook -foREVer-腳本，因為兩個腳本會相互衝突。<br /><br />如果你不確定如何去移除腳本， <a %s>點擊說明部份</a>.',
		...
		'today' : 'today',
		'UpdateAvailable1' : '-foREVer- Script 有可用的更新。',
	...
	tr : {
		...
		'Close' : 'Kapat',
		'ConfigureFacebook-foREVer-' : '-foREVer- Script\'ı Yapılandır',
		...
		'ConfFacebook-foREVer-Language' : '-foREVer- Script\'ın Dili',
		'ConfFacebookTimestamps' : 'Facebook\'un zaman etiketlerini göster (örn. "3 saat önce").',
		'ConfFBFTimestamps' : 'Facebook\'un zaman etiketlerinin ardından -foREVer- Script zaman etiketlerini ekle (örn. "11:45").',
		'ConfFBFTimestamps24' : '-foREVer- Script zaman etiketlerini 24-saat biçiminde göster',
		...
		'ConfSectionAbout' : '-foREVer- Script Hakkında',
		...
		'ConfUpdates' : '-foREVer- Script güncellemeleri için her gün Userscripts.org\'u ziyaret et. Ya da <a href="#" id="fbfUpdateLink" onclick="return false;">şimdi kontrol et</a>.',
		...
		'Facebook-foREVer-Conflict' : '-foREVer- Script\'ın yeni adı artık -foREVer- Script. İsim değişikliğinden dolayı -foREVer- Script\'ı tarayıcınızdan kaldırmanız gerekiyor, yoksa bu iki script birbiriyle uyuşmazlık sorunları çıkaracaktır. Eğer bir userscript\'i nasıl kaldıracağınızdan emin değilseniz <a %s>buraya tıklayarak öğrenebilirsiniz</a>.',
		...
		'UpdateAvailable1' : '-foREVer- Script için bir güncelleme mevcut',
	...
	sr_rs : {
		...
		'Close' : 'Затвори',
		'ConfigureFacebook-foREVer-' : 'Подеси -foREVer- Script',
		...
		'ConfFacebook-foREVer-Language' : 'Језик -foREVer- Script-а',
		'ConfFacebookTimestamps' : 'Прикажи Фејсбук време (нпр. "пре 3 сата").',
		'ConfFBFTimestamps' : 'Додај -foREVer- Script време после Фејсбук времена (нпр. "11:45").',
		'ConfFBFTimestamps24' : 'Прикажи -foREVer- Script времена у 24-часовном облику.',
		...
		'ConfSectionAbout' : 'О додатку -foREVer- Script',
		...
		'ConfUpdates' : 'Свакодневно проверавај Userscripts.org за надоградње -foREVer- Script-а. Или <a href="#" id="fbfUpdateLink" onclick="return false;">провери сада</a>.',
		...
		'Facebook-foREVer-Conflict' : '-foREVer- Script се сада зове -foREVer- Script. Због промене имена мораћете ручно да уклоните -foREVer- Script из свог прегледача да не би дошло до ометања између ове две скрипте. Ако нисте сигурни како да уклоните скрипту, <a %s>кликните овде за упутство</a>.',
		...
		'UpdateAvailable1' : 'Доступне су надоградње за -foREVer- Script',
	...
	sr : {
		...
		'ConfFBFTimestamps24' : 'Prikaži -foREVer- Script vremena u 24-časovnom obliku.',
		...
		'ConfShortcutList' : '<b>Prečice sa tastature</b> (razlikuju se mala i velika slova):<br /><br /><i>Sa bilo koje stranice:</i><br /> <b>A</b> - Albumi/fotografije<br /> <b>B</b> - Spisak dostupnih prijatelja<br /> <b>C</b> - -foREVer- Script podešavanja<br /> <b>D</b> - Rođendani<br /> <b>E</b> - Događaji<br /> <b>F</b> - Prijatelji<br /> <b>H</b> - Početna stranica<br /> <b>I</b> - Primljene poruke<br /> <b>K</b> - dodaj zabelešku<br /> <b>L</b> - Označi vezu za odjavu (pritisnite Enter nakon toga za odjavljivanje)<br /> <b>N</b> - Obaveštenja<br /> <b>P</b> - Profil<br /> <b>R</b> - Zahtevi<br /> <b>S</b> - Prelazak na polje za pretragu<br /> <b>T</b> - Prevedi odabrani tekst<br /> <b>?</b> - Prikaži izveštaj o grešci -foREVer- Script-a<br /> <b><escape></b> - Zatvori iskačuće prozore koje je napravio -foREVer- Script<br /><br /><i>Sa početne stranice (filteri)</i>:<br /> <b>a</b> - Stranice<br /> <b>f</b> - Najnovije<br /> <b>g</b> - Grupe<br /> <b>l</b> - Veze<br /> <b>n</b> - Novosti<br /> <b>p</b> - Fotografije<br /> <b>s</b> ili <b>u</b> - Promene statusa<br /> <b>t</b> - Beleške<br /> <b>v</b> - Video<br /><br /><i>Sa profila</i>:<br /> <b>i</b> - Informacije<br /> <b>p</b> - Fotografije<br /> <b>w</b> - Zid<br /> <b>x</b> - Okviri<br /><br /><i>Sa stranica sa nabrajanjem (prethodna, sledća, itd.)</i><br /> <b><strelica levo></b> - Prethodna<br /> <b><strelica desno></b> - Sledeća<br /> <b><šift> + <strelica levo></b> - Prva (ako je dostupno)<br /> <b><šift> + <strelica desno></b> - Poslednja (ako je dostupno)<br /><br /><i>Prilikom pregledavanja albuma/fotografija:</i><br /> <b>a</b> - Učitaj sve sličice (ako je dostupno)<br /> <b>b</b> - Prikaži velike slike<br /> <b>c</b> - Prikaži komentare<br /> <b>k</b> - Nazad na album<br /> <b>m</b> - Fotografije sa (korisnikom) i sa mnom<br /><br /><i>Pri pregledavanju skorašnjih albuma i postavljenih/označenih fotografija:</i><br /> <b>a</b> ili  <b>r</b> - Skorašnji albumi<br /> <b>m</b> ili  <b>u</b> - Postavljeno preko mobilnog telefona<br /> <b>o</b> - Fotografije na kojima sam ja<br /> <b>p</b> - Moje fotografije<br /> <b>t</b> ili  <b>f</b> - Označeni prijatelji',
		...
		'Facebook-foREVer-Conflict' : '-foREVer- Script se sada zove -foREVer- Script. Zbog promene imena moraćete ručno da uklonite -foREVer- Script iz svog pregledača da ne bi došlo do ometanja između ove dve skripte. Ako niste sigurni kako da uklonite skriptu, <a %s>kliknite ovde za uputstvo</a>.',
	...
	da : {
		...
		'Close' : 'Luk',
		'ConfigureFacebook-foREVer-' : 'Konfigurér -foREVer- Script',
		...
		'ConfFBFTimestamps' : 'Tilføj -foREVer- Script tidsstempler efter Facebook tidsstempler (f.eks. "11:45").',
		...
		'ConfUpdates' : 'Undersøg Userscripts.org dagligt for opdateringer til -foREVer- Script. Eller <a href="#" id="fbfUpdateLink" onclick="return false;">undersøg nu</a>.',
		...
		'Facebook-foREVer-Conflict' : '-foREVer- Script vil fremover hedde -foREVer- Script. På grund af navneskiftet, skal du manuelt afinstallere -foREVer- Script fra dine browsere, da de to scripts ellers vil komme i konflikt med hinanden. Hvis du er usikker på hvordan man afinstallerer et Userscript, så <a %s>tryk her for instruktioner</a>.',
		'fullAlbumLoaded' : 'Hele albummet hentet',
		'Left' : 'Venstre',
		'ListeningRestarted' : '-foREVer- Script lytter efter ændringer igen.',
		'ListeningStopped' : '-foREVer- Script er stoppet med at lytte efter ændringer.\nTryk L (SHIFT + l) for at starte igen',
		...
		'today' : 'i dag',
		'UpdateAvailable1' : 'En opdatering er tilgængelig til -foREVer- Script',
	...
	cs : {
		...
		'Close' : 'Zavřít',
		'ConfigureFacebook-foREVer-' : 'Nastavení - -foREVer- Script',
		...
		'ConfFBFTimestamps' : 'Přidat časové značky skriptu -foREVer- Script za časové značky Facebooku (t. j. "11:45")',
		'ConfFBFTimestamps24' : 'Zobrazit časové značny skriptu -foREVer- Script v 24-hodinovém formátě',
		...
		'ConfShortcutList' : '<b>Klávesové zkratky</b> (rozlišují se malá/velká písmena):<br /><br /><i>Z libovolné stránky:</i><br />&nbsp;<b>A</b> - Alba/fotky<br />&nbsp;<b>B</b> - Přepnout seznam přátel (online přátel)<br />&nbsp;<b>C</b> - Konfigurace skriptu -foREVer- Script<br />&nbsp;<b>D</b> - Narozeniny<br />&nbsp;<b>E</b> - Události<br />&nbsp;<b>F</b> - Přátelé<br />&nbsp;<b>H</b> - Domů<br />&nbsp;<b>I</b> - Přijaté zprávy<br />&nbsp;<b>K</b> - Přidej záložku<br />&nbsp;<b>L</b> - Odhlášení (po odhlášení stiskněte Enter)<br />&nbsp;<b>N</b> - Upozornění<br />&nbsp;<b>P</b> - Váš profil<br />&nbsp;<b>R</b> - Žádosti<br />&nbsp;<b>S</b> - Přeskočit na pole Hledat<br />&nbsp;<b>T</b> - Přeložit vybraný text<br />&nbsp;<b>?</b> - Zobrazit informace o ladění skriptu -foREVer- Script<br />&nbsp;<b>&lt;escape&gt;</b> - Zavřít kontextová okna vytvořené skriptem -foREVer- Script<br /><br /><i>Ze stránky Domů (filtry)</i>:<br />&nbsp;<b>a</b> - Stránky<br />&nbsp;<b>f</b> - Aktuality<br />&nbsp;<b>g</b> - Skupiny<br />&nbsp;<b>l</b> - Odkazy<br />&nbsp;<b>n</b> - Novinky<br />&nbsp;<b>p</b> - Fotky<br />&nbsp;<b>s</b> nebo <b>u</b> - Co dělají ostatní<br />&nbsp;<b>t</b> - Poznámky<br />&nbsp;<b>v</b> - Videa<br /><br /><i>Z profilů</i>:<br />&nbsp;<b>i</b> - Informace<br />&nbsp;<b>p</b> - Fotky<br />&nbsp;<b>w</b> - Zeď<br />&nbsp;<b>x</b> - Kontejner<br /><br /><i>Ze stránek s navigací (dozadu, dopredu atd.)</i><br />&nbsp;<b>&lt;levá šipka&gt;</b> - Předchozí<br />&nbsp;<b>&lt;pravá šipka&gt;</b> - Následující<br />&nbsp;<b>&lt;shift&gt; + &lt;levá šipka&gt;</b> - První (pokud je dispozici)<br />&nbsp;<b>&lt;shift&gt; + &lt;pravá šipka&gt;</b> - Poslední (pokud je k dispozici)<br /><br /><i>Při prohlížení alb/fotek:</i><br />&nbsp;<b>a</b> - Načítat všechny miniatury (pokud je k dispozici)<br />&nbsp;<b>b</b> - Zobrazit velké obrázky<br />&nbsp;<b>c</b> - Zobrazit komentáře<br />&nbsp;<b>k</b> - Zpět do alba<br />&nbsp;<b>m</b> - Fotky (osoby) a moje<br /><br /><i>Při prohlížení nejnovějších alb a nahraných/označených fotek:</i><br />&nbsp;<b>a</b> nebo &nbsp;<b>r</b> - Nejnovější alba<br />&nbsp;<b>m</b> nebo &nbsp;<b>u</b> - Nahrané z mobilu<br />&nbsp;<b>o</b> - Fotky mé osoby<br />&nbsp;<b>p</b> - Mé fotky<br />&nbsp;<b>t</b> nebo &nbsp;<b>f</b> - Označení přátelé',
		...
		'ConfUpdates' : 'Denně na Userscripts.org ověřovat aktualizace pro -foREVer- Script, případně <a href="#" id="fbfUpdateLink" onclick="return false;">zkontrolovat nyní</a>.',
		...
		'Facebook-foREVer-Conflict' : 'Facebook Fifex je nyní znám jako -foREVer- Script.<br /><br />Protože se změnilo jméno, musíte manuálně odinstalovat Facebook -foREVer- z vašeho prohlížeče.<br /><br />Pokud si nevíte jak na to <a %s>pokračujte zde</a>.',
	...
	mk : {
		...
		'Close' : 'Затвори',
		'ConfigureFacebook-foREVer-' : 'Конфигурирај го -foREVer- Script',
		...
		'ConfFacebook-foREVer-Language' : 'Јазик за -foREVer- Script',
		'ConfFacebookTimestamps' : 'Прикажи Facebook маркер за времето (eg. "3 часа старо").',
		'ConfFBFTimestamps' : 'Додади -foREVer- Script маркер за времето по Facebook маркерот за време (eg. "11:45").',
		'ConfFBFTimestamps24' : 'Прикажи -foREVer- Script маркер за време во 24-часовен формат.',
		...
		'ConfSectionAbout' : 'За -foREVer- Script',
		...
		'ConfShortcutList' : '<b>Кратенки за тастатура</b> (case sensitive):<br /><br /><i>Од секоја страница:</i><br />&nbsp;<b>A</b> - Albums/photos<br />&nbsp;<b>B</b> - Вклучи корисници (вклучени пријатели)<br />&nbsp;<b>C</b> - -foREVer- Script Конфигурација<br />&nbsp;<b>D</b> - Родендени<br />&nbsp;<b>E</b> - Настани<br />&nbsp;<b>F</b> - Пријатели<br />&nbsp;<b>H</b> - Почетна страница<br />&nbsp;<b>I</b> - Сандаче<br />&nbsp;<b>K</b> - Add Bookmark<br />&nbsp;<b>L</b> - Select the logout link (press Enter afterwards to log out)<br />&nbsp;<b>N</b> - Notifications<br />&nbsp;<b>P</b> - Your profile<br />&nbsp;<b>R</b> - Requests<br />&nbsp;<b>S</b> - Jump to the search field<br />&nbsp;<b>T</b> - Translate selected text<br />&nbsp;<b>?</b> - Show -foREVer- Script debug info<br />&nbsp;<b>&lt;escape&gt;</b> - Close pop-ups created by -foREVer- Script<br /><br /><i>From the home page (filters)</i>:<br />&nbsp;<b>a</b> - Pages<br />&nbsp;<b>f</b> - Live feed<br />&nbsp;<b>g</b> - Groups<br />&nbsp;<b>l</b> - Links<br />&nbsp;<b>n</b> - News feed<br />&nbsp;<b>p</b> - Photos<br />&nbsp;<b>s</b> or <b>u</b> - Status updates<br />&nbsp;<b>t</b> - Notes<br />&nbsp;<b>v</b> - Videos<br /><br /><i>From profiles</i>:<br />&nbsp;<b>i</b> - Info<br />&nbsp;<b>p</b> - Photos<br />&nbsp;<b>w</b> - Wall<br />&nbsp;<b>x</b> - Boxes<br /><br /><i>From pages with pagination (previous, next, etc)</i><br />&nbsp;<b>&lt;left arrow&gt;</b> - Previous<br />&nbsp;<b>&lt;right arrow&gt;</b> - Next<br />&nbsp;<b>&lt;shift&gt; + &lt;left arrow&gt;</b> - First (when available)<br />&nbsp;<b>&lt;shift&gt; + &lt;right arrow&gt;</b> - Last (when available)<br /><br /><i>While viewing albums/photos:</i><br />&nbsp;<b>a</b> - Load all thumbnails (when available)<br />&nbsp;<b>b</b> - Show big pictures<br />&nbsp;<b>c</b> - View comments<br />&nbsp;<b>k</b> - Back to album<br />&nbsp;<b>m</b> - Photos of (person) and me<br /><br /><i>While viewing recent albums and uploaded/tagged photos:</i><br />&nbsp;<b>a</b> or &nbsp;<b>r</b> - Recent Albums<br />&nbsp;<b>m</b> or &nbsp;<b>u</b> - Mobile uploads<br />&nbsp;<b>o</b> - Photos of me<br />&nbsp;<b>p</b> - My Photos<br />&nbsp;<b>t</b> or &nbsp;<b>f</b> - Tagged friends',
		...
		'ConfUpdates' : 'Провери Userscripts.org дневно за надоградби во -foREVer- Script. Или <a href="#" id="fbfUpdateLink" onclick="return false;">провери сега</a>.',
		...
		'Facebook-foREVer-Conflict' : 'Facebook -foREVer- е сега -foREVer- Script.<br /><br />За промена на име треба сами да го избришете Facebook -foREVer- од вашиот пребарувач, или двете скрипти ќе создаваат проблем една на друга.<br /><br />Ако не си сигурен како да ја избришеш скриптата, <a %s>кликни тука за инструкции</a>.',
		...
		'UpdateAvailable1' : 'Достапна е надоградба за -foREVer- Script',
	...
	nb : {	
		...
		'ConfFacebook-foREVer-Language' : 'Språk til -foREVer- Script',
		...
		'ConfUpdates' : 'Sjekk Userscripts.org daglig etter oppdateinger til -foREVer- Script. Eller <a href="#" id="fbfUpdateLink" onclick="return false;">sjekk nå</a>.',
		...
		'Facebook-foREVer-Conflict' : 'Facebook -foREVer- er nå kjent som -foREVer- Script.<br /><br />På grunn av navnebyttet må du manuelt avinstallere Facebook -foREVer- fra nettleseren din, ellers vil de to scriptene komme i konflikt med hverandre.<br /><br />Dersom du ikke er sikker på hvordan man avinstallerer et brukerscript, <a %s>klikk her for instruksjoner</a>.',
	...
	ko : {
		...
		'Close' : '닫기',
		'ConfigureFacebook-foREVer-' : '-foREVer- Script 설정',
		...
		'ConfFacebook-foREVer-Language' : '-foREVer- Script에 사용할 언어',
		'ConfFacebookTimestamps' : 'Facebook 형식의 타임스탬프 보이기 (예. "약 3시간 전").',
		'ConfFBFTimestamps' : '-foREVer- Script 형식의 타임스탬프를 Facebook 타임스탬프 뒤에 보이기 (예. "11:45").',
		'ConfFBFTimestamps24' : '-foREVer- Script 타임스탬프를 24시간 형식으로 보이기.',
		...
		'ConfSectionAbout' : '-foREVer- Script는...',
		...
		'ConfShortcutList' : '<b>키보드 단축키</b> (대소문자 구분):<br /><br /><i>모든 페이지에서 작동</i>:<br />&nbsp;<b>A</b> - 사진첩/사진<br />&nbsp;<b>B</b> - 접속된 친구 보이기/숨기기<br />&nbsp;<b>C</b> - -foREVer- Script 설정<br />&nbsp;<b>D</b> - 생일<br />&nbsp;<b>E</b> - 이벤트<br />&nbsp;<b>F</b> - 친구<br />&nbsp;<b>H</b> - 첫 페이지<br />&nbsp;<b>I</b> - 쪽지<br />&nbsp;<b>K</b> - 즐겨찾기 더하기<br />&nbsp;<b>L</b> - 로그아웃 링크를 선택 (그다음 엔터키를 누르면 로그아웃)<br />&nbsp;<b>N</b> - 알림<br />&nbsp;<b>P</b> - 내 프로필<br />&nbsp;<b>R</b> - Requests<br />&nbsp;<b>S</b> - 검색 필드로 커서 이동<br />&nbsp;<b>T</b> - 선택한 텍스트를 번역<br />&nbsp;<b>?</b> - -foREVer- Script 디버그 정보 보기<br />&nbsp;<b>&lt;ESC&gt;</b> - -foREVer- Script 팝업 사진 닫기<br /><br /><i>홈페이지에서 작동(필터)</i>:<br />&nbsp;<b>a</b> - 페이지<br />&nbsp;<b>f</b> - 최신글<br />&nbsp;<b>g</b> - 그룹<br />&nbsp;<b>l</b> -링크<br />&nbsp;<b>n</b> - 뉴스 피드<br />&nbsp;<b>p</b> - 사진<br />&nbsp;<b>s</b> 또는 <b>u</b> - 상태 업데이트<br />&nbsp;<b>t</b> - 노트<br />&nbsp;<b>v</b> - 비디오<br /><br /><i>프로필 페이지에서 작동</i>:<br />&nbsp;<b>i</b> - 정보<br />&nbsp;<b>p</b> - 사진<br />&nbsp;<b>w</b> - 담벼락<br />&nbsp;<b>x</b> - Boxes<br /><br /><i>이동이 가능한 페이지에서 작동(이전, 다음, 등)</i>:<br />&nbsp;<b>&lt;←&gt;</b> - 이전<br />&nbsp;<b>&lt;→&gt;</b> - 다음<br />&nbsp;<b>&lt;Shift&gt; + &lt;←&gt;</b> - 처음 (가능할때만)<br />&nbsp;<b>&lt;Shift&gt; + &lt;→&gt;</b> - 마지막 (가능할때만)<br /><br /><i>사진첩/사진을 볼때 작동</i>:<br />&nbsp;<b>a</b> - 모든 썸네일 보기 (가능할때만)<br />&nbsp;<b>b</b> - 큰 사진 보이기<br />&nbsp;<b>c</b> - 댓글 보기<br />&nbsp;<b>k</b> - 사진첩으로 돌아가기<br />&nbsp;<b>m</b> - 내가(또는 친구가) 나온 사진<br /><br /><i>최근 사진첩이나 업로드/태그된 사진을 볼때 작동:</i><br />&nbsp;<b>a</b> 또는 &nbsp;<b>r</b> - 최근 사진첩<br />&nbsp;<b>m</b> 또는 <b>u</b> - 모바일 업로드<br />&nbsp;<b>o</b> - 내가 나온 사진<br />&nbsp;<b>p</b> -내 사진<br />&nbsp;<b>t</b> 또는 <b>f</b> - 태그 된 친구들',
		...
		'ConfUpdates' : '매일 Userscripts.org에서 -foREVer- Script 업데이트를 확인하기. <a href="#" id="fbfUpdateLink" onclick="return false;">지금 확인</a>.',
		'DownloadVideo' : '비디오 다운로드',
		'ExportICalendarFile' : 'iCalender 파일로 가져오기',
		'ExportICalendarFileWarning' : '(친구가 많으면 오래 걸릴 수 있습니다)',
		'Facebook-foREVer-Conflict' : 'Facebook -foREVer-의 이름이 -foREVer- Script로 바뀌었습니다.<br /><br />Facebook -foREVer-을 브라우저에서 제거하지 않으면 이름 변경 때문에 충돌이 일어납니다.<br /><br />userscript를 제거하는 방법을 모르겠으면 <a %s>여기를 참조하세요</a>.',
		...
		'today' : '오늘',
		'Translators' : '번역한 사람',
		'UpdateAvailable1' : '-foREVer- Script 업데이트가 나왔습니다',
	...
	vi : {
		...
		'Close' : 'Đóng',
		'ConfigureFacebook-foREVer-' : 'Cài đặt -foREVer- Script',
		...
		'ConfFacebook-foREVer-Language' : 'Ngôn ngữ cho -foREVer- Script',
		'ConfFacebookTimestamps' : 'Hiện mốc thời gian của facebook (ví dụ: "3 hours ago").',
		'ConfFBFTimestamps' : 'Thêm mốc thời gian của -foREVer- Script sau mốc thời gian của Facebook (ví dụ: "11:45").',
		'ConfFBFTimestamps24' : 'Hiển thị mốc thời gian của -foREVer- Script dạng 24 giờ.',
		...
		'ConfProtocolLinks' : 'Turn messenger IDs on profiles into links that start a conversation with them (Google Talk, Windows Live etc).',
		'ConfSectionAbout' : 'Thông tin về -foREVer- Script',
		...
		'ConfShortcutList' : '<b>Keyboard Shortucts</b> (case sensitive):<br /><br /><i>From any page:</i><br />&nbsp;<b>A</b> - Albums/photos<br />&nbsp;<b>B</b> - Toggle buddy list (online friends)<br />&nbsp;<b>C</b> - Tùy Chỉnh -foREVer- Script<br />&nbsp;<b>D</b> - Birthdays<br />&nbsp;<b>E</b> - Events<br />&nbsp;<b>F</b> - Friends<br />&nbsp;<b>H</b> - Home page<br />&nbsp;<b>I</b> - Inbox<br />&nbsp;<b>K</b> - Add Bookmark<br />&nbsp;<b>L</b> - Select the logout link (press Enter afterwards to log out)<br />&nbsp;<b>N</b> - Notifications<br />&nbsp;<b>P</b> - Your profile<br />&nbsp;<b>R</b> - Requests<br />&nbsp;<b>S</b> - Jump to the search field<br />&nbsp;<b>T</b> - Translate selected text<br />&nbsp;<b>?</b> - Show -foREVer- Script debug info<br />&nbsp;<b>&lt;escape&gt;</b> - Close pop-ups created by -foREVer- Script<br /><br /><i>From the home page (filters)</i>:<br />&nbsp;<b>a</b> - Pages<br />&nbsp;<b>f</b> - Live feed<br />&nbsp;<b>g</b> - Groups<br />&nbsp;<b>l</b> - Links<br />&nbsp;<b>n</b> - News feed<br />&nbsp;<b>p</b> - Photos<br />&nbsp;<b>s</b> or <b>u</b> - Status updates<br />&nbsp;<b>t</b> - Notes<br />&nbsp;<b>v</b> - Videos<br /><br /><i>From profiles</i>:<br />&nbsp;<b>i</b> - Info<br />&nbsp;<b>p</b> - Photos<br />&nbsp;<b>w</b> - Wall<br />&nbsp;<b>x</b> - Boxes<br /><br /><i>From pages with pagination (previous, next, etc)</i><br />&nbsp;<b>&lt;left arrow&gt;</b> - Previous<br />&nbsp;<b>&lt;right arrow&gt;</b> - Next<br />&nbsp;<b>&lt;shift&gt; + &lt;left arrow&gt;</b> - First (when available)<br />&nbsp;<b>&lt;shift&gt; + &lt;right arrow&gt;</b> - Last (when available)<br /><br /><i>While viewing albums/photos:</i><br />&nbsp;<b>a</b> - Load all thumbnails (when available)<br />&nbsp;<b>b</b> - Show big pictures<br />&nbsp;<b>c</b> - View comments<br />&nbsp;<b>k</b> - Back to album<br />&nbsp;<b>m</b> - Photos of (person) and me<br /><br /><i>While viewing recent albums and uploaded/tagged photos:</i><br />&nbsp;<b>a</b> or &nbsp;<b>r</b> - Recent Albums<br />&nbsp;<b>m</b> or &nbsp;<b>u</b> - Mobile uploads<br />&nbsp;<b>o</b> - Photos of me<br />&nbsp;<b>p</b> - My Photos<br />&nbsp;<b>t</b> or &nbsp;<b>f</b> - Tagged friends',
		...
		'ConfUpdates' : 'Hãy truy cập vào Userscripts.org hàng ngày để cập nhật -foREVer- Script. hoặc <a href="#" id="fbfUpdateLink" onclick="return false;">kiểm tra ngay</a>.',
		'DownloadVideo' : 'Download Video',
		'ExportICalendarFile' : 'Export iCalendar file',
		'ExportICalendarFileWarning' : '(Điều này sẽ mất một khoảng thời gian nếu bạn có rất nhiều bạn bè)',
		'Facebook-foREVer-Conflict' : 'Facebook -foREVer- nay được gọi là -foREVer- Script.<br /><br />Bởi vì thay đổi tên nên bạn cần phải tự gỡ bỏ Facebook -foREVer- từ trình duyệt của bạn, hoặc hai kịch bản sẽ xung đột với nhau.<br /><br />Nếu bạn không biết gỡ bỏ một userscript, <a %s>bấm vào đây để được hướng dẫn</a>.',
		...
		'today' : 'hôm nay',
		'Translators' : 'Translators',
		'UpdateAvailable1' : 'Đã có bản cập nhật mới cho -foREVer- Script',
	...
	ja : {
		...
		'Close' : '閉じる',
		'ConfigureFacebook-foREVer-' : '-foREVer- Script設定',
		...
		'ConfSectionAbout' : '-foREVer- Scriptについて',
		...
		'ConfShortcutList' : '<b>キーボード ショートカット</b>（大文字と小文字で異なります）:<br /><br /><i>どのページでも可能:</i><br />&nbsp;<b>A</b> - アルバム/写真<br />&nbsp;<b>B</b> - 連絡先リスト（オンラインの友達）の切替え<br />&nbsp;<b>C</b> - -foREVer- Script設定<br />&nbsp;<b>D</b> - 誕生日<br />&nbsp;<b>E</b> - イベント<br />&nbsp;<b>F</b> - 友達<br />&nbsp;<b>H</b> - ホーム<br />&nbsp;<b>I</b> - 受信箱<br />&nbsp;<b>K</b> - ブックマークに追加<br />&nbsp;<b>L</b> - ログアウトへのリンクを選択 （その後でEnterを押すとログアウトします）<br />&nbsp;<b>N</b> - お知らせ<br />&nbsp;<b>P</b> - プロフィール<br />&nbsp;<b>R</b> - リクエスト<br />&nbsp;<b>S</b> - 検索ボックスにジャンプ<br />&nbsp;<b>T</b> - 選択されたテキストを翻訳<br />&nbsp;<b>?</b> - -foREVer- Scriptのデバッグ情報を表示<br />&nbsp;<b>&lt;escape&gt;</b> - -foREVer- Scriptが作成したポップアップを閉じる<br /><br /><i>ホームで可能（フィルタ）</i>:<br />&nbsp;<b>a</b> - ページ<br />&nbsp;<b>f</b> - 最新情報<br />&nbsp;<b>g</b> - グループ<br />&nbsp;<b>l</b> - リンク<br />&nbsp;<b>n</b> - ニュースフィード<br />&nbsp;<b>p</b> - 写真<br />&nbsp;<b>s</b> / <b>u</b> - 近況アップデート<br />&nbsp;<b>t</b> - ノート<br />&nbsp;<b>v</b> - 動画<br /><br /><i>プロフィールで可能</i>:<br />&nbsp;<b>i</b> - 基本データ<br />&nbsp;<b>p</b> - 写真<br />&nbsp;<b>w</b> - ウォール<br />&nbsp;<b>x</b> - ボックス<br /><br /><i>ページ付け（前へ，次へ等）があるページで可能</i><br />&nbsp;<b>←</b> - 前へ<br />&nbsp;<b>→</b> - 次へ<br />&nbsp;<b>&lt;shift&gt; + ←</b> - 最初へ（可能な時のみ）<br />&nbsp;<b>&lt;shift&gt; + →</b> - 最後へ（可能な時のみ）<br /><br /><i>アルバム/写真の閲覧時:</i><br />&nbsp;<b>a</b> - 全てのサムネイルを読み込む（可能な時のみ）<br />&nbsp;<b>b</b> - 大きい画像を表示<br />&nbsp;<b>c</b> - コメントを表示<br />&nbsp;<b>k</b> - アルバムに戻る<br />&nbsp;<b>m</b> - （誰かと）あなたの写真<br /><br /><i>友達の写真やアップロード/タグ付けされた写真の閲覧時:</i><br />&nbsp;<b>a</b> / &nbsp;<b>r</b> - 友達のアルバム<br />&nbsp;<b>m</b> / &nbsp;<b>u</b> - 携帯アップロード<br />&nbsp;<b>o</b> - 私が写っている写真<br />&nbsp;<b>p</b> - マイアルバム<br />&nbsp;<b>t</b> / &nbsp;<b>f</b> - タグ付けされている友達',
		...
		'ConfUpdates' : '-foREVer- Scriptのアップデートを Userscripts.org で毎日確認する．または<a href="#" id="fbfUpdateLink" onclick="return false;">今すぐ確認</a>する．',
		'DownloadVideo' : '動画をダウンロード',
		'ExportICalendarFile' : 'iCalendarファイルをエクスポートする',
		'ExportICalendarFileWarning' : '（友達がたくさんいる場合は多少時間がかかります）',
		'Facebook-foREVer-Conflict' : 'Facebook -foREVer-は-foREVer- Scriptに名前が変更されました．<br /><br />名前が変わったために，ブラウザからFacebook -foREVer-を手動でアンインストールしないと2つのスクリプトが互いにコンフリクトしてしまいます．<br /><br />userscriptをアンインストールするやり方が分からない場合は，<a %s>ここをクリックしてください．（注: 英語）</a>',
		...
		'today' : '今日',
		'Translators' : '翻訳',
		'UpdateAvailable1' : '-foREVer- Scriptをアップデートできます．',
...
if(body != null) {
	...
	div.innerHTML = "<a style=\"font-weight:bold;color:#333333\" href=\"http://www.facebook.com/Xaverius.Adhe.Franksischo\">By Adhe Frankcescho</a>"
