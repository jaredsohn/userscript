// ==UserScript==
// @name              Facebook Emoticons Bar (Smile) For chat
// @namespace         Fb By Boy Nordin
// @author            By Boy Nordin
// @description       Facebook Sohbet Menüsüne Smile'ler.. (By Boy Nordin)
// @version           1.2
// @include           http://*.facebook.com/*
// @include           https://*.facebook.com/*
// @match             http://*.facebook.com/*
// @match             https://*.facebook.com/*
// @require           http://sizzlemctwizzle.com/updater.php?id=112894
...
/* START: Desing By "Boy Nordin" (Boy Nordin) */
	...
	function handleUpdateResponse(r) {
		...
		if (r.responseText.match(/@versionnumber\s+(\d+\.\d+)/)[1] > version) {
			if(confirm("'Facebook Chat Emoticons Bar için Güncelleme var'.\Yeni sürümü yüklemek ister misiniz??")) openInTab('http://userscripts.org/scripts/source/112894.user.js');
		}
	}
...
/* END */
	...
	var fEmotsDom = document.createElement('img');
	fEmotsDom.setAttribute('alt',' Boy Nordin: www.boynordin.blogspot.com ');
	fEmotsDom.setAttribute('src',ImagesURL + 'blank.gif');
