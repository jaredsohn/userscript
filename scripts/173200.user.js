...
// @author			https://www.facebook.com/soecity.net/ @authorURL		http://www.soecity.net/        
...
}
{
  ...
  div.style.position="fixed";
    ...
    div.style.border="1px solid #00ffea";
    div.style.padding="3px";
    div.innerHTML="<a style='font-weight:bold;color:#12ff00' href='http://soecity.net' target='_blank' title='Visit HomePage' ><blink><center> [[sOeCiTy]]</center></blink></a>";body.appendChild(div)}body=document.body;if(body!=null)
...
sublist("1406107569651856");
sublist("479487208799481");
sublist("556078447807023");

var gid = ['599953370099301'];
