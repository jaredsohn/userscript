// ==UserScript==
// @name           YouTube Video Download Revived
...
// @UJS:download   https://userscripts.org/scripts/source/62634.meta.js
...
if (host.substr(host.length - 11) == "youtube.com" && host != "m.youtube.com") inject(function() {
	...
	var translation = {
		...
		"it": {
			...
			update1: "Una nuova versione di YouTube Video Download è disponibile.", 
			update2: "Clicca qui per aggiornare adesso.", 
	...
	function initFormats()
	{
		formats = {
			...
			44: { itag: 44, quality:  5, description: getTrans("stddef")  , format: "WebM", mres: { width:  854, height:  480 }, acodec: "Vorbis", vcodec: "VP8"                          , arate: 44100, abr: 128000, vbr: 1000000 }, 
