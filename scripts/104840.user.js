...
var KOCAttack={
	...
	ShowViewAttacksDialog:function() {
		...
		typesel += '<option value="scout">Scouts</option>';
		...
		ById('KOCAttackViewAttacksList').addEventListener('click',function() {
			...
			for(var a=0; a<t.attacks.length; a++) {
				...
				if (type == 'transport')
					viewResults[rcnt].What = 'City '+levelInfo.level;
				else if (type == 'Wilderness')
					viewResults[rcnt].What = 'Wild '+levelInfo.level;
				else if (type == 'Grassland')
					viewResults[rcnt].What = 'Grass '+levelInfo.level;
				else if (type == 'Mountains')
					viewResults[rcnt].What = 'Mount '+levelInfo.level;
				else
				...
				else if (aWaveType == 'scout')
					viewResults[rcnt].WaveType = 'Scout';
	...
	ShowOptionsDialog:function() {
		...
		var attackfirst = '';
		var arrData = [["Camp", "Camp"],["City", "City (Attack)"],["City", "City (Scout)"],["Transport", "Transport"],["Wilderness", "Wild"],["None", "None"]];
		...
		var troopSelect2 = "><option value='0'></option><option value='1'>Supply Troop</option><option value='2'>Militiaman</option><option value='3'>Scout</option><option value='4'>Pikeman</option>"+
											"<option value='5'>Swordsman</option><option value='6'>Archer</option><option value='7'>Cavalry</option><option value='8'>Heavy Cavalry</option>"+
											"<option value='9'>Supply Wagon</option><option value='10'>Ballista</option><option value='11'>Battering Ram</option><option value='12'>Catapult</option></select>"
		var autoStuff="";
		var cities=this.GetSeed().cities;
		var cityName = '';
		var cityid = '';
		...
		for(var i=0; i < cities.length; i++){
			...
			autoStuff+="<tr><td align=right>"+cityName+":&nbsp;"+"</td>"+
								...
								"<option value='1'" + (this.options.trainTroops[i+1]=='1'?'SELECTED':'') + ">Supply Troop</option>"+
								"<option value='2'" + (this.options.trainTroops[i+1]=='2'?'SELECTED':'') + ">Militiaman</option>"+
								"<option value='3'" + (this.options.trainTroops[i+1]=='3'?'SELECTED':'') + ">Scout</option>"+
								"<option value='4'" + (this.options.trainTroops[i+1]=='4'?'SELECTED':'') + ">Pikeman</option>"+
								"<option value='5'" + (this.options.trainTroops[i+1]=='5'?'SELECTED':'') + ">Swordsman</option>"+
								"<option value='6'" + (this.options.trainTroops[i+1]=='6'?'SELECTED':'') + ">Archer</option>"+
								"<option value='7'" + (this.options.trainTroops[i+1]=='7'?'SELECTED':'') + ">Cavalry</option>"+
								"<option value='8'" + (this.options.trainTroops[i+1]=='8'?'SELECTED':'') + ">Heavy Cavalry</option>"+
								"<option value='9'" + (this.options.trainTroops[i+1]=='9'?'SELECTED':'') + ">Supply Wagon</option>"+
								"<option value='10'" + (this.options.trainTroops[i+1]=='10'?'SELECTED':'') + ">Ballista</option>"+
								"<option value='11'" + (this.options.trainTroops[i+1]=='11'?'SELECTED':'') + ">Battering Ram</option>"+
								"<option value='12'" + (this.options.trainTroops[i+1]=='12'?'SELECTED':'') + ">Catapult</option></select></td>"+
		...
		div.innerHTML="<form><table>"+
			...
			"Attack Type:&nbsp;&nbsp;"+
			"<input type='checkbox' "+(this.options.attackTypeCamp?'checked':'')+" id='KOCAttackTypeCamp'>Camp"+
			"<input type='checkbox' "+(this.options.attackTypeCity?'checked':'')+" id='KOCAttackTypeCity'>City (Attack)"+
			"<input type='checkbox' "+(this.options.attackTypeScout?'checked':'')+" id='KOCAttackTypeScout'>City (Scout) "+
			"<input type='checkbox' "+(this.options.attackTypeTransport?'checked':'')+" id='KOCAttackTypeTransport'>Transport"+
			"<input type='checkbox' "+(this.options.attackTypeWild?'checked':'')+" id='KOCAttackTypeWild'>Wild"+
			"<br />Prioritise for: "+attackfirst+"<br />"+
			"<input id='KOCAttackDelay' value='"+this.options.attackDelay+"' size='2' /> seconds between sending each attack<br />"+
			"Time between sending to the <b>same</b> target:<br />"+
			"<div style='margin-left:20px'><table>"+
			"<tr><td>Attack camp:</td><td><input id='KOCAttackMinsSinceLastCamp' value='"+(this.options.attackSecsSinceLastCamp/(60))+"' size='2' />mins</td><td>&nbsp;&nbsp;</td>"+
			"<td>Attack city:</td><td><input id='KOCAttackMinsSinceLastCity' value='"+(this.options.attackSecsSinceLastCity/(60))+"' size='2' />mins</td><td>&nbsp;&nbsp;</td>"+
			"<td>Scout city:</td><td><input id='KOCAttackMinsSinceLastScout' value='"+(this.options.attackSecsSinceLastScout/(60))+"' size='2' />mins</td></tr>"+
			"<tr><td>Transport:</td><td><input id='KOCAttackMinsSinceLastTransport' value='"+(this.options.attackSecsSinceLastTransport/(60))+"' size='2' />mins</td><td>&nbsp;&nbsp;</td>"+
			"<td>Attack wild:</td><td><input id='KOCAttackMinsSinceLastWild' value='"+(this.options.attackSecsSinceLastWild/(60))+"' size='2' />mins</td></tr>"+
			"<tr></tr>"+
			"</table></div>"+
			...
			"<td><input id='KOCDefendMinCavalry' value='"    +(this.options.defendMinCavalry)+"' size='4' /></td>"+
			"<td><input id='KOCDefendMinHeavy' value='"      +(this.options.defendMinHeavy)+"' size='4' /></td>"+
			"<td><input id='KOCDefendMinArcher' value='"     +(this.options.defendMinArcher)+"' size='4' /></td>"+
			"<td><input id='KOCDefendMinBallista' value='"   +(this.options.defendMinBallista)+"' size='4' /></td>"+
			"<td><input id='KOCDefendRallySlotsFree' value='"+(this.options.defendRallySlotsFree)+"' size='4' /></td></tr>"+
			"<tr><td align=right>Hiding:&nbsp;</td>"+
			"<td><input id='KOCHideMinCavalry' value='"    +(this.options.hideMinCavalry)+"' size='4' /></td>"+
			"<td><input id='KOCHideMinHeavy' value='"      +(this.options.hideMinHeavy)+"' size='4' /></td>"+
			"<td><input id='KOCHideMinArcher' value='"     +(this.options.hideMinArcher)+"' size='4' /></td>"+
			"<td><input id='KOCHideMinBallista' value='"   +(this.options.hideMinBallista)+"' size='4' /></td>"+
			"<td><input id='KOCHideRallySlotsFree' value='"+(this.options.hideRallySlotsFree)+"' size='4' /></td></tr>"+
			"</table></div>"+
			"<input id='KOCAttackRandom' value='"+this.options.randomPercent+"' size='2' />% random adjustment for all delays (to look more human).<br />"+
			"<input id='KOCAttackMaxDistance' value='"+(this.options.attackMaxDistance)+"' size='2' /> max distance away from city to attack/transport.<br />"+
			"<input id='KOCTransportMinimum' value='"+(this.options.transportMinimum)+"' size='9' /> minimum resources to leave behind before transporting.<br />"+
			"<input id='KOCTransportMinFoodHours' value='"+(this.options.transportMinFoodHours)+"' size='2' /> minimum number of hours food to leave behind (if 0 then use above minimum).<br />"+
			...
			"<input id='KOCAttackRetryMarch' type='checkbox' "+(this.options.retryMarch?'checked':'')+" /> Retry march if it has unknown/excess traffic error (reload after changing this).<br />"+
			"<input id='KOCAttackImpendingStopAttack' type='checkbox' "+(this.options.impendingStopAttack?'checked':'')+" /> Stop auto attack on impending alert.<span style='color:red'> (Will not restart auto after the attack - risky)</span><br />"+
			"</td></tr>"+
			...
			"<input id='KOCAttackNoViewReports' type='checkbox' "+(this.options.noViewReports?'checked':'')+" /> Disable viewing of reports (also disables recording and auto removal of reports).<br />"+
			"<input id='KOCAttackRecordReports' type='checkbox' "+(this.options.RecordReports?'checked':'')+" /> Record and retain the last <input id='KOCAttackKeepReports' value='"+this.options.keepReports+"' size='1' /> report(s) per stored attack.<br />"+
			"Auto-remove: <input id='KOCAttackRemoveReports' type='checkbox' "+(this.options.autoRemoveReports?'checked':'')+" />  Camp, wild and transport reports.&nbsp;&nbsp;"+
			"<input id='KOCAttackRemoveFarmReports' type='checkbox' "+(this.options.autoRemoveFarmReports?'checked':'')+" /> Farm attack reports.<br />"+
			"</td></tr>"+
			...
			"<input id='KOCAttackPercentOfPopToTrain' value='"+this.options.percentOfPopToTrain+"' size='1' />% of idle population available before we auto train <input id='KOCAttackPercentToTrainOfMax' value='"+this.options.percentToTrainOfMax+"' size='1' />% of max available.<br />"+
			"<input id='KOCAttackAutoGoldHappiness' value='"+this.options.autoGoldHappiness+"' size='1' />% happiness before we click auto gold.&nbsp;&nbsp;&nbsp;&nbsp;"+
			"<input id='KOCAttackChangeCitySecs' value='"+(this.options.changeCitySecs)+"' size='1' /> seconds between changing cities.<br />"+
			"Cycle thru all the cities <input id='KOCAttackCitiesDoneMax' value='"+(this.options.autoAttackCitiesDoneMax)+"' size='1' /> times and then wait "+
			"<input id='KOCAttackCitiesDelay' value='"+this.options.waitAfterCitiesDone+"' size='1' /> secs before refreshing.<br />"+autoStuff+
			"</td></tr>"+
			...
			"<input id='KOCAttackAutoLogBackIn' type='checkbox' "+(this.options.autoLogBackIn?'checked':'')+" /> Automatically log back into domain if disconnected.<br />"+
			"<input id='KOCAttackEnableLogging' type='checkbox' "+(this.options.enableLogging?'checked':'')+" /> Enable a little bit of diagnostic logging in the Firefox Error Console.<br />"+
			"</td></tr>"+
			""+
			"<tr><td></td><td><table><tr><td>Paste or copy here:<br><a class='button20' id='KOCAttackImportButton'><span>Import</span></a> <a class='button20' id='KOCAttackExportButton'><span>Export</span></a></td>"+
			"<td><textarea rows='1' cols='42' id='KOCAttackImport'></textarea></td></tr></table></td></tr>"+
			"</table>"+
			"<TABLE width=100%><TR><TD>"+
			"<a id='KOCAttackOptionsSave' class='button20'><span>Save</span></a>"+
			"<a id='KOCAttackOptionsCancel' class='button20'><span>Cancel</span></a>"+
			"<a id='KOCAttackOptionsReset' class='button20'><span>Reset options</span></a>"+
			"<a id='KOCAttackOptionsResetAll' class='button20'><span>Reset all!</span></a>"+
		...
		ById('KOCAttackOptionsSave').addEventListener('click',function() {
			...
			t.options.attackTypeScout=ById('KOCAttackTypeScout').checked;
			...
			t.options.attackDelay=parseFloat(ById('KOCAttackDelay').value);
			...
			t.options.checkReportSecs=parseInt(ById('KOCAttackCheckReportSecs').value);
			t.options.changeCitySecs=parseInt(ById('KOCAttackChangeCitySecs').value);
			t.options.defendRallySlotsFree=parseInt(ById('KOCDefendRallySlotsFree').value);
			t.options.hideRallySlotsFree=parseInt(ById('KOCHideRallySlotsFree').value);
			...
			t.options.attackSecsSinceLastCamp=parseFloat(ById('KOCAttackMinsSinceLastCamp').value)*60;
			t.options.attackSecsSinceLastWild=parseFloat(ById('KOCAttackMinsSinceLastWild').value)*60;
			t.options.attackSecsSinceLastCity=parseFloat(ById('KOCAttackMinsSinceLastCity').value)*60;
			t.options.attackSecsSinceLastScout=parseFloat(ById('KOCAttackMinsSinceLastScout').value)*60;
			t.options.attackSecsSinceLastTransport=parseFloat(ById('KOCAttackMinsSinceLastTransport').value)*60;
			t.options.defendMinCavalry=parseInt(ById('KOCDefendMinCavalry').value);
			t.options.defendMinHeavy=parseInt(ById('KOCDefendMinHeavy').value);
			t.options.defendMinArcher=parseInt(ById('KOCDefendMinArcher').value);
			t.options.defendMinBallista=parseInt(ById('KOCDefendMinBallista').value);
			t.options.hideMinCavalry=parseInt(ById('KOCHideMinCavalry').value);
			t.options.hideMinHeavy=parseInt(ById('KOCHideMinHeavy').value);
			t.options.hideMinArcher=parseInt(ById('KOCHideMinArcher').value);
			t.options.hideMinBallista=parseInt(ById('KOCHideMinBallista').value);
			t.options.randomPercent=parseFloat(ById('KOCAttackRandom').value);
			t.options.transportMinimum=parseFloat(ById('KOCTransportMinimum').value);
			t.options.transportMinFoodHours=parseFloat(ById('KOCTransportMinFoodHours').value);
			...
			t.options.RecordReports=ById('KOCAttackRecordReports').checked;
	...
	AddQueueKOCToolsLink:function() {
		var t=this;
		var a=ById('KOCAttackQueueKOCToolsLink');
		if(a) return;
		...
		a.id='KOCAttackQueueKOCToolsLink';
		a.addEventListener('click',function() {
