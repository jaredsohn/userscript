  ...
  if( location.href.match('travian.+[build|dorf1]') ) {
   ...
   window.setInterval(keepalive, 1000*60*20); //20 min
    ...
    var autobuild = location.href.match('build.php') 
      ? "<input id='autobuild' type='checkbox'> ÐšÐ¾Ð³Ð°Ñ‚Ð¾ Ñ€ÐµÑÑƒÑ€ÑÑŠÑ‚ Ð´Ð¾ÑÑ‚Ð¸Ð³Ð½Ðµ Ð·Ð°Ð´Ð°Ð´ÐµÐ½Ð°Ñ‚Ð° ÑÑ‚Ð¾Ð¹Ð½Ð¾ÑÑ‚ - Ð¿Ñ€ÐµÐ·Ð°Ñ€ÐµÐ´Ð¸ ÑÑ‚Ñ€Ð°Ð½Ð¸Ñ†Ð°Ñ‚Ð° Ð¸ Ð¿Ð¾ÑÑ‚Ñ€Ð¾Ð¹ Ð¾Ð±ÐµÐºÑ‚Ð°! <span id='remntime' style='color:red'></span>" 
      : "";
    ...
    cntnr.innerHTML = 
      ...
      "<table width='400px'><tr><td><img class='res' src='img/un/r/1.gif' title='Ð”ÑŠÑ€Ð²ÐµÑÐ¸Ð½Ð°'> <span style='width:200px;'>Ð”ÑŠÑ€Ð²ÐµÑÐ¸Ð½Ð°</span> </td><td><input id='ed4' type='edit' class='small' /> "+
      "<span id='est4'></span>"+
      "</td></tr>"+
      
      "<tr><td><img class='res' src='img/un/r/2.gif' title='Ð“Ð»Ð¸Ð½Ð°'> <span style='width:200px;'>Ð“Ð»Ð¸Ð½Ð°</span> </td><td><input id='ed3' type='edit' class='small' /> <span id='est3'></span>  </td></tr>"+
      "<tr><td><img class='res' src='img/un/r/3.gif' title='Ð–ÐµÐ»ÑÐ·Ð¾'> <span style='width:200px;'>Ð–ÐµÐ»ÑÐ·Ð¾</span> </td><td><input id='ed2' type='edit' class='small' /> <span id='est2'></span> </td></tr>"+
      "<tr><td><img class='res' src='img/un/r/4.gif' title='Ð–Ð¸Ñ‚Ð¾'> <span style='width:200px;'>Ð–Ð¸Ñ‚Ð¾</span> </td><td><input id='ed1' type='edit' class='small' /> <span id='est1'></span> </td></tr>"+
