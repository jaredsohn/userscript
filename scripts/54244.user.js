 ...
 *********************/
if (init) {
    var sCurrentVersion = "1.6.0";  //Version number with which we need to run the update fu
...
function displayTimerForm(iTask, target, options, timestamp) {
	...
	+ '" onfocus="document.getElementById(\'after\').value = \'\'; this.value=\'' +sTime+ '\'" title="' +sTimeType+ '" /> ' + aLangStrings[26] 
