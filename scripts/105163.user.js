...
// @require   http://userscripts.org/scripts/source/87680.user.js
...
ScriptUpdater.check(102851, "0.134");
...
Config.settings = {
  ...
  "Events":{
  	...
  	fields:{
  		...
  		eventsEmailHtml:{
  			type:'html',
  			value:'<p style="border-top:1px solid #ccc; padding-top:1em !important;"><strong>Email Settings</strong> - see "Email Settings" on <a href="http://userscripts.org/scripts/show/94377" target="_blank">this page</a> for more information.</p>',
  		},
  		emailNoticeUrl:{
  			type:'text',
  ...
  "About":{
    label:IkaTools.getText('optionsLabels', 'about', "About"),
  	html:'	<p><a href="http://userscripts.org/scripts/show/' + ScriptUpdater.scriptId + '" target="_blank" style="font-weight:bold !important;">Ikariam ExMachina v' + ScriptUpdater.scriptCurrentVersion +
  			...
  			'<p>This is a collection of Ikariam hacks by PhasmaExMachina - Updates by Isgard</p>',
  	fields:{
  		debugMode:{
  			type:'checkbox',
