...
// @namespace      http://u.n.s.c.board.ag

// @description Ajoute quelques fonctionnalités pour l'Alliance U.N.S.c
// @include        http://barym.ogame.fr/*

// ==/UserScript==

var joueur=110515; //Entre ici le numéro de ton joueur (il est possible de le trouver en faisant une recherche de "fr_102_" dans le code source de la page http://ogame.gamestats.org/?lang=fr&uni=102 en recherchant ton joueur
...
LinkDiv.innerHTML += '<li class="menubutton_table"><span class="menu_icon"><img src="img/navigation/navi_ikon_fleet1_a.gif" height="29" width="38"></span><a class="menubutton " href="http://drago-sim.com/index.php?lang=french" accesskey="" target="_blank"><span class="textlabel">Simulateur</span></a></li>';
