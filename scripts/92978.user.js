...
if(linkParent != 'btn' && linkParent != 'btn bbs_search' && linkParent != 'btn col' && linkParent != 'btn kill' && linkParent != 'fin' && linkParent 

!= 'link' && linkParent !='game' && linkParent != 'movie' && link.className != 'moderator' && link.className != 'administrator')
{
link.style.color = itemColor;
}
if(linkParent == 'movie')
{
link.style.color = greenColor;
link.style.backgroundImage = greenBackground;
link.style.backgroundRepeat = 'repeat-y';
}
if(linkParent == 'game')
{
link.style.color = redColor;
