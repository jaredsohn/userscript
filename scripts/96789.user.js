// ==UserScript==
// @name           سكربت الاحصائيات الشاملة للنيوبكس By:KOPc
// @description    يقوم باعطائك احصائيات للريفيرال + حسابك By:KOpc).
...
// @version        3.4.110201.2155
// ==/UserScript==

(function () {
    var version = "3.4.110201.2155";
...
// To allow the script to run in English and other languages
        AE: {
            "noClicks": "لا يوجد ضغطات حتى الان",
            "today": "اليوم",
            "yesterday": "يوم امس"
        },
        PT: {
...
// REFERRAL STATISTICS PAGE
            "totalClickAvg": "معدل مجموع الضغطات.",
            "lastdaysClickAvg": "معدل الضغطات.",
            "totalClicks": "مجموع الضغطات",
            "clickedToday": "ضغط اليوم",
            "clickedYday": "ضغط يوم امس",
            "others": "اخر",
            "dailyNetIncome": "صافي الدخل اليومي",
            "avgIncome": "التقييم. الدخل",
            "avgExpenses": "التقييم. المصروفات",
            "avgARecycling": "التقييم. التبديلات",
            "avgTransfersRB": "التقييم. تحويلات الميزانية العادية",
            "avgTransfersGPB": "التقييم.تحويلات ",
// STATISTICS SUMMARY (SIDEBAR)
            "statsSum": "ملخص الاحصائات",
            "today": "اليوم",
            "yesterday": "يوم امس",
            "rented": "مؤجر",
            "direct": "مباشر",
            "clicks": "الضغطات",
            "avg": "التقييم او المعدل",
            "avgs": "المعدلات",
            "average": "المعدل",
            "raverage": "معدل الاحالات", // Real Average
            "averages": "المتوسط",
            "Recycle": "التبديلات",
            "autopay": "الدفع الاوتوماتيكي",
            "renew": "تجديد",
            "net": "صافي",
            ...
            "Days": "ايام",
            "recycled": "التبديلات",
            "autopaid": "الدفع الاوتوماتيكي",
            "updateScript": "تحديث السكربت",
            "refferalsToBeRenewed": "تجديد الاحالات",
            "recycledLast": "التدوير السابق",
            "autopaidLast": "الدفع الاوتوماتيكي السابق",
            "totalReferrals": "مجموع الاحالات:",
            "income": "الدخل",
            "stats": "الاحصائيات",
            "summary": "الملخص",
            "projectedIncome": "الايرادات المتوقعة",
            "zeroClickers": "صفر ضغطات",
            "automaticRecycling": "التبديلات الاوتوماتيكية", // Automatic Recycling
// FLAGS
            "W": "W", // White Flag
            "R": "R", // Red Flag
            "O": "O", // Orange Flag
...
// REFERRAL PROFIT POPUP
            "referral": "الاحالات",
            "expenses": "المصروفات",
            "goldenFee": "العضوية الذهبية",
            "goldenPackFee": "حزمة العضوية الذهبية",
            "totalExpenses": "مجموع المصروفات",
            "perRefPerDay": "في المرجع يوميا",
            "minimumAverage": "الحد الادنى",
            "toBreakEven": "to break even",
            "grossIn": "الاجمالي في",
            "grossOut": "الاجمالي خارج",
            "currentProfit": "الارباح الحالية",
            "incl": "incl", // Including
            "recycle": "الاستبدال",
            "netProfit": "الربح الصاف",
            "daysToPayForOwnRecycle": "ايام لدفع الاستبدالات",
            "day": "اليوم",
// UPDATES
            "newUpdateFoundFor": "يوجد عملية تحديث لـ:",
            "updateDesc": "ملاحظات التحديث",
            "updateNow": "التحديث الان",
            "remindMeLater": "ذكرني لاحقا",
            "dismiss": "رفض",
            "forUpdates": "للحصول على تحديثات",
            "for": "لأجل",
            "enableUpdates": "%s:السماح بالتحديث",
            "disableUpdates": "تعطيل",
            "updates": "تحديثات",
            "noUpdatesAvailableFor ": "لا يوجد تحديثات متاحة لـ %s",
            "autoUpdates": "التحديث التلقائي",
            "newVersionAvailable": "A new version of the %s user script is available.",
            "currentVersion": "النسخة الحالية: %s",
            "availableVersion": "النسخة المتاحة: %s",
            "notesAboutTheAvailableVersion": "ملاحظات للنسخة المتاحة:\n%s",
            "doYouWishToUpdateTo": "هل تريد الرفع للنسخة %s?",
            "doYouWishToTurnOffAutoUpdates": "هل تريد ايقاف التحديثات ?",
            "autoUpdatesCanBeReenabled": "التحديثات التلقائي يمكن اعادة تشغيلها .",
// MENUS
            "setAVGDays": "مجموع ايام القيم للمعدل",
            "avgDaysMsg": "الرجاء ادخال مجموع الايام للمعدل.",
            "showSTD": "Show Standard Deviation",
            "on": "تشغيل",
            "off": "تعطيل",
            "error": "خلل",
            "days": "ايام",
            "editUpdateFrequency": "تحرير التحديثات المستمرة",
            "checkForUpdates": "%s: التحقق من وجود تحديثات"
        }
    };
...
// Add the arrow pointing to the settings editor.
    ...
    function firstRun() {
// Code to run when the user first installs the script.
        alert("ProFinal:\nشكرا لأستخدامك سكربت النيوبكس للاحصائيات الشامل.");
        alert("ProFinal:\n سيتم طرح عليك 3 اسئلة لتساعدك في عمل هذا السكربت.\n\n");
        var renewalLength = prompt("ProFinal:\n كم يوم لديك لعمل تمديد للأحالات خاصتك ?\nملاحظة: ادخل ارقام only.\n1 (AutoPay) or 15 or 30 or 60 or 90 or 150 or 240.");
        if (renewalLength) {
            ...
            if (renewalLength === 1 ||
                ...
                alert("ProFinal فشل:\nلقد قمت بأدخال قيمة خاطئة.");
            }
        }
        var rentedRefs = prompt("ProFinal:\n ما هو عدد **الأحالات** المؤجرة التي تملكها ؟?\nاذا ضغطت الغاء , سيتم تحديد القيمة التي لديك.");
        if (rentedRefs && !isNaN(rentedRefs)) {
            manipulatePrefs("numberOfRentedRefs", rentedRefs, "set");
        }
        var directRefs = prompt("ProFinal:\nما هو عدد **الاحالات ** المباشرة التي تملكها ?\nاذا ضغطت الغاء , سيتم تحديد القيمة التي لديك.");
...
// Enlarge the width of the page to accomodate the extra column and add a little padding to make it look nicer
        ...
        var nodesSnapshot = selectNodes("//body/div");
        for (var i = 0; i < nodesSnapshot.length; i += 1) {
...
// SUMMARY ROW @ bottom of the referral listing table
        ...
        nodesSnapshot[2].childNodes[0].style.width = null;
