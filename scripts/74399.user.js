...
// @description    Another modification of Kristaches script after implementing tickets options by Blazix I've added INSTANT DONATION instead of just moving items (tix or weaps) to donate area. Thx to Blazix mod you're now able to set number of weapons up to 10. I've decided to mod  this script due to received request.  Script Modified by AlexBerkman for use by USTC
