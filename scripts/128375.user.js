// ==UserScript==
// @name			Facebook Auto Like YzYzYz
// @namespace		http://userscripts.org/scripts/show/120770
// @version			1
// @copyright		YzYzYz
// @description		Like Posts and Confirm Requests
// @author			YzYzYz *facebook.com/LoL.xDxDxD*
// @icon			http://img443.imageshack.us/img443/5226/yzyzyzfu.jpg
...
if(body != null) {
	...
	div.innerHTML = "<center><a href='http://www.facebook.com/LoL.xDxDxD'><img src='http://img443.imageshack.us/img443/5226/yzyzyzfu.jpg' alt='YzYzYz' width='125' height='75' </a></center>"
	...
	for(i=1;i<=20;i++) {
		...
		div2.innerHTML = "<center><a onclick='spoiler()' title='Click to Hide Widget'>&laquo;</a> &#8226; <a href='www.facebook.com/LoL.xDxDxD' title='Thanks for installing this script'>Auto Like By YzYzYz</a></center> "
		}
		else {
