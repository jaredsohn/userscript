...
// @description    Highlights Kiva.org loan entries (on the Lend page) based upon the associated lender partner, and a white/black list to match them against.
// @version        1.01
// @grant          GM_getValue
// @grant          GM_setValue
...
//                 1.00 Released to main stream.  20120915.
//                 1.01 Adjustment for change in Lend page layout for Lendee entry. 20121003.
//
// --------------------------------------------------------------------

// Update Checking...don't change this...
var SUC_script_num = 86187; 
...
var config = 
{
	...
	flag: function(element) { element.parent().parent().parent().css('background-color', 'black'); }
};
...
{
	window.open('http://userscripts.org/scripts/show/86187', '_blank');
