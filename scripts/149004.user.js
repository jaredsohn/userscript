...
// @history         5.0   pantalla fija de tiempo para las fuerzas de tierra y mar, y los mapas de la ciudad en la que nadar.
...
// @description     Añade un botón para viajar entre ciudades.
...
//        }
    ...
    scriptOptionsConfig : function(){
        ...
        this.CFG.init({
            'General':{
                html:'<p>Personalice el script '+ this.scriptName +' con estas opciones. <br/> Presione ESCAPE para cerrar sin guardar.<br></p>',
                fields:{
                    'position' : {
                        type : 'select',
                        value : 'top',
                        label : 'Bloquear la posición de InterCity',
                        options : {
                            'Arriba / Primero' : 'top',
                            'Abajo / Ultimo' : 'bottom'
                        }
			    ...
			    'Русский' : 'ru',
                    ...
                    'simpleView' : {
                        ...
                        value : true,
                        label : 'Vistas simple',
                        text : 'Vistas simple envío + los tiempos de carga'
                    }
                }
            },
            "Acerca de":{
                html:'<p><a href="http://userscripts.org/scripts/show/' +this.usoNum + '" target="_blank" style="font-weight:bold !important;">' +
                    ...
                    '</a> Por <a href="http://userscripts.org/users/emptysoul12" target="_blank">Empty_Soul</a> Traducido y corregido <a href="http://userscripts.org/users/177603" target="_blank">Любовь </a> </p>' +
                    '<p>Este script hace que sea fácil de transportar <br> mercancías, tropas y barcos entre sus ciudades</p>'
            }
        });
    },
