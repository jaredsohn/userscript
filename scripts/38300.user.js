...
// V - Battle Rules
// W - Chat Racin
// X - Cast Lesser Focus on Star
// Y - Use Lesser Health Potion
// Z - Cast Lesser Shield on Star

// 1 - Lesser Shield on ryna
// 2 - Lesser Armor on ryna
// 3 - Summon Skeleton on ryna
// 4 - Shield on ryna
// 5 - Focus on ryna
// 6 - WD 2000 lhp from Bank
// 8 - tf 400 lhp to Star
// 9 - Gorin Temple
// 0 - Pray at Temple after being Killed.
...
if (k == 66) {
    ...
    document.location.href = 'http://92.48.103.52/fantasy/game.php?var5=15964&var1=Lesser+Focus+Scroll&command=use&screen=SCROLLS';
  } if (k == 89) {
    document.location.href = 'http://92.48.103.52/fantasy/game.php?screen=INVENTORY&command=equip&var1=Lesser%20Healing%20Potion';
  } if (k == 90) {
    document.location.href = 'http://92.48.103.52/fantasy/game.php?var5=15964&var1=Lesser+Shield+Scroll&command=use&screen=SCROLLS';
  } if (k == 49) {
    ...
    document.location.href = 'http://92.48.103.52/fantasy/game.php?var1=Lesser+Healing+Potion&command=Inventory&var2=2000&Submit=GO&screen=BANK';
  } if (k == 55) {
    document.location.href = 'http://92.48.103.52/fantasy/game.php?command=Removealerts';
  } if (k == 56) {
    document.location.href = 'http://92.48.103.52/fantasy/game.php?var1=Lesser+Healing+Potion&var2=300&var3=15964&Submit=GO&command=Transfer&screen=TRANSFER';
  } if (k == 57) {
