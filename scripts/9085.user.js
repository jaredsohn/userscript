...
// @description      Say goodbye to Demonoid's most annoying ads ever.
// @author           Matthew Price (http://mattprice.me/)
// @website          https://github.com/mattprice/Demonoid-Ad-Remover
// @version          1.5

// @updateURL        https://github.com/mattprice/Demonoid-Ad-Remover/raw/master/Demonoid.user.js

// @include          http://*demonoid.me/*
// @exclude          http://*demonoid.me/private_message.php*
// @exclude          http://fora.demonoid.me/*
// @exclude          http://beta.demonoid.me/*
// ==/UserScript==

(function() {
   // Remove "Sponsored Links" from the torrent listings
   var allTds, thisTd;
   ...
   // Remove "Sponsored Links" from torrent pages
   ...
   // Remove "Try our toolbar" image
   var allImg, thisImg;
   allImg = document.evaluate(
      "//img[@src='http://www.demonoid.me/images/trytoolbar.gif']", document, null,
      XPathResult.UNORDERED_NODE_SNAPSHOT_TYPE, null);
...
// Disable the Kontera textual ads as soon as they're inserted
// Code thanks to Grant Goodale <http://userscripts.org/scripts/show/3637>
...
// CSS to remove ads and disclaimer
...
// CSS to change the menu and footer backgrounds
...
var otherTweaks = '.user_menu {padding-bottom:1.4em; !important} img[src="/images/download.gif"] {vertical-align:middle; !important} img[src="http://www.demonoid.me/images/db.png"], img[src="http://beta.demonoid.me/images/staff/tmp_sdb.jpg"] {display:none; !important}';
...
(function() {
   ...
   style.type = 'text/css';
   style.innerHTML = killAds + imageMods + otherTweaks;
