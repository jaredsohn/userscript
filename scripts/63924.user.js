...
// @include       http://hockey.fantasysports.yahoo.com/h*
// ==/UserScript==
//
...
//v. 1.2 - Hopefully adding Support for Hockey - Efrem Gomes
//
...
function runLinkBuild(ball) {
	...
	if (ball=="baseball") {
		...
		var Label8 = "";
		var Label9 = "";
		var Label1_loc = "/players?status=A&pos=C&cut_type=33&stat1=S_S_"+hockeyYear+"&sort=AR";
		var Label2_loc = "/players?status=A&pos=LW&cut_type=33&stat1=S_S_"+hockeyYear+"&sort=AR";
		var Label3_loc = "/players?status=A&pos=RW&cut_type=33&stat1=S_S_"+hockeyYear+"&sort=AR";
		var Label4_loc = "/players?status=A&pos=D&cut_type=33&stat1=S_S_"+hockeyYear+"&sort=AR";
		var Label5_loc = "/players?status=A&pos=G&cut_type=33&stat1=S_S_"+hockeyYear+"&sort=AR";
		var Label6_loc = "/players?status=A&pos=Util&cut_type=33&stat1=S_S_"+hockeyYear+"&sort=AR";
		var Label7_loc = "";
		var Label8_loc = "";
		var Label9_loc = "";
		var allO_label = "All Offense";
		var allO_loc = "/players?status=A&pos=P&cut_type=33&stat1=S_S_"+hockeyYear+"&sort=AR";
