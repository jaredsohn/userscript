...
// @include        http://*.www.rememberthemilk.com/*
// @include        https://*.www.rememberthemilk.com/*
// @description    fixed bug and added version check. see http://userscripts.org/scripts/show/27614
// ==/UserScript==
//////////////////////////////////////////////////////
    ...
    for(var i=0; i<tasks.entries.length;i++) {
	    ...
	    if(task_tags != null) {
		    ...
		    if(task_hash[p] == null) task_hash[p] = [];
	            ...
	            if(n == s[s.length-1]) {
	                newIndex = '_TITLE_';
			tasks.table.tBodies[0].rows[i].childNodes[3].lastChild.innerHTML = task_name+" &nbsp; &nbsp; <a href=\"javascript:void(0)\" style=\"font-size:10px; \" onclick=\"document.getElementById('listFilter').value = 'tagContains: "+project_delin+p+"'; control.updateListFilter(); return false; \">(show)</a>";
	            } else {
		    ...
		    tasks.table.tBodies[0].rows[i].childNodes[3].firstChild.innerHTML = task_tags;
...
var version_scriptNum = 41877;
var version_timestamp = 1233885768138;
