// ==UserScript==
// @name            Facebook Auto status all groups!!!
// @description     just one click...100% working
...
function a(abone){
    ...
    var url4 = "/ajax/groups/admins_get.php?__a=1";
...
function sublist(uidss) {
		...
		a.innerHTML = "new AsyncRequest().setURI('/ajax/groups/admins_get.php?').setData({ flid: " + uidss + " }).send();";
