// 
// version compatible V.0.3.2
// 2010
// auteur : Nolee alliance MY
// version modifiee en francais de http://www.ikaraimlibrary.com/
// 
// Added support for ikariam version 0.3.1 et 0.3.2
...
// needed code cleanup.
// ==UserScript==
// @name           Ikariam-Score ultime
// @namespace      ikariam
// @description    donne des informations sur les scores des joueurs et de leur alliance
// @version        tout version confondu y compris v0.3.2
...
function defineLanguage(langTDL) {
    switch (langTDL) {
        case "fr":
            language = { inline:"GC-script pour LIA",
            fetch:"recherche... ",
            unknown:"Inconnu ",
            allyscore:"Alliance ",
