// ==UserScript==
// @name           zbux.ueuo.com Auto Clicker
// @namespace      zbux.ueuo.com
// @include        http://zbux.ueuo.com/index.php?option=surf
// ==/UserScript==
...
function main() 
{
	...
	if (document.URL.indexOf("http://zbux.ueuo.com/index.php?option=surf") != -1)
	{	
                ...
                for (var i=0;i<obj.length;i++)
		{
			...
			if(pot=="http://zbux.ueuo.com/view.php?ad=")
			{
