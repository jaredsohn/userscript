// ==UserScript==
// @id             Die Schwarze Legion
// @name           Die Schwarze Legion
// @namespace      Die Schwarze Legion
// @author         Sporty255
...
// ==UserScripte - Zeilenangaben: ==
// MultiLogin MOD              23
// BasisINFO MOD		       669
// Extra Menü MOD		       793
// PVP/PVE/POI Info MOD	       944
// Ressourcen MOD		       1147
// Nachrichten MOD		       1287
// CHAT MOD		               1358
// Kampfsimulator MOD	       1807
// Zoom MOD		               4779
// CCTAWrapper		           4859
// BaseScanner		           4984
// MaelstromTools		       4988
// CnCopt			           8455
// Weltkarte		           9142
// Allianz Verwaltungstool	   10781
// Loot 2			           11242
// Upgrade MOD		           13040
// Koordis Copy MOD 	       13797
// Info Sticker                13913
          ...
          qx.Class.define("MHTools.OptionsPage", {
            ...
            members: {
              ...
              addPageAbout: function() {
                ...
                page.add(new qx.ui.basic.Label("<b>Die Schwarze Legion</b>").set({rich: true}));//, textColor: red
                page.add(new qx.ui.basic.Label("").set({rich: true,marginLeft:10}));
                page.add(new qx.ui.basic.Label("").set({rich: true,marginLeft:10}));
                ...
                page.add(new qx.ui.basic.Label("").set({rich: true,marginLeft:10}));
                page.add(new qx.ui.basic.Label("").set({rich: true,marginLeft:10}));
                page.add(new qx.ui.basic.Label("Autor: <span style='color:blue'><b>Sporty255</b></span>").set({rich: true,marginLeft:10}));
	...
	var AMMinnerHTML = function () {
		function AMM() {
			...
			var addonmenu  = Addons.AddonMainMenu.getInstance();
   			addonmenu.AddMainMenu("Grundlagen",function(){window.open("http://www.united-forum.de/strategien-f1036/basenvermehrung-pvp-defensive-stromproduktion-tunnelaktivierung-skripte-111040/", "_blank")});
  			addonmenu.AddMainMenu("GDI Statistiken",function(){window.open("http://forum.alliances.commandandconquer.com/showthread.php?tid=7704", "_blank")});
            //--UNTERMENÜ I--
	...
	var PlayerInfoMod_main = function () {
		...
		function createPlayerInfoMod() {
			try {
				...
				var pvpLabel = new qx.ui.basic.Label("- gegnerische Basen zerstört(PvP):");
				...
				var pveLabel = new qx.ui.basic.Label("- vergessene Basen zerstört(PvE):");
		...
		function createClasses()
		{
				...
				construct: function()
				{
					...
					{						
						...
						({
							...
							width: 120,
							height: 28,
							toolTipText: "Startet den Kampfsimulator.",
						...
						optionBtn = new qx.ui.form.Button("Einstellungen");
						optionBtn.set
						({
							alignY: "middle", 
							width: 120,
							height: 28,
							toolTipText: "Öffnet die Einstellungen",
							appearance: "button-text-small"
						});
						...
						statBtn = new qx.ui.form.Button("Anzeige");
						statBtn.set
						({
							alignY: "middle", 
							width: 120,
							height: 28,
							toolTipText: "öffnet das Statistikfenster",
							appearance: "button-text-small"
						});
						...
						layoutBtn = new qx.ui.form.Button("Speichern");
						layoutBtn.set
						({
							alignY: "middle", 
							width: 120,
							height: 28,
							toolTipText: "Läd und speichert Aufstellungen",
							appearance: "button-text-small"
						});
						...
						unlockCmtBtn = new qx.ui.form.Button("sicher?");
						unlockCmtBtn.set
						({
							alignY: "middle",
							width: 50,
							height: 50,
							toolTipText: "Endsichert den Button",
							appearance: "button-text-small"
						});
						...
						unlockRTBtn = new qx.ui.form.Button("sicher?");
						unlockRTBtn.set
						({
							alignY: "middle",
							width: 50,
						...
						({
							...
							width: 30,
							height: 20,
							toolTipText: "Verstellt die Aufstellung",
							appearance: "button-text-small"
						});
						...
						mirrorBtn = new qx.ui.form.Button("Spiegeln");
						mirrorBtn.set
						({
							alignY: "middle",
							width: 70,
							height: 35,
							toolTipText: "Spiegelt die Aufstellung",
							appearance: "button-text-small"
						});
						...
						disableAllUnitsBtn = new qx.ui.form.Button("Alles aus");
						...
						({
							...
							width: 70,
							height: 35,
							toolTipText: "schaltet alle Einheiten ein und aus",
							appearance: "button-text-small"
						});
						...
						armyUndoBtn = new qx.ui.form.Button("zurück");
						armyUndoBtn.set
						({
						...
						quickSaveBtn = new qx.ui.form.Button("Speichern");
						quickSaveBtn.set
						({
							alignY: "middle",
							width: 70,
							height: 35,
							toolTipText: "Speichert die aktuelle Aufstellung der Einheiten",
							appearance: "button-text-small"
						});
						...
						var replayStatBtn = new qx.ui.form.Button("Menü");
						replayStatBtn.set
						({
							width: 50,
							height: 24,
							appearance: "button-text-small",
							toolTipText: "Menü anzeigen"
						});
			...
			qx.Class.define("Simulator.StatWindow", 
			{
				...
				construct: function()
				{
					...
					var enemyHealthTitle = new qx.ui.basic.Label("Basisstatus").set({ alignX: "center", alignY: "top", font: "font_size_14_bold"});
					...
					var enemyHealthBox = new qx.ui.container.Composite(new qx.ui.layout.VBox(5)).set({ width: 60, padding: 5, decorator: "pane-light-opaque"});
					var eHLabelOverall = new qx.ui.basic.Label("Gesamt:");
					var eHLabelBase = new qx.ui.basic.Label("Basis:");
					var eHLabelDefense = new qx.ui.basic.Label("DEF.:");
					var eHLabelCY = new qx.ui.basic.Label("B.H.:");
					var eHLabelDF = new qx.ui.basic.Label("V.E.:");
					...
					var enemyHealthValues = new qx.ui.container.Composite(new qx.ui.layout.VBox(5)).set({ alignX: "center", width: 50, padding: 5, decorator: "pane-light-opaque"});
					...
					var playerRepairTitle = new qx.ui.basic.Label("Reparaturzeiten").set({ alignX: "center", alignY: "top", font: "font_size_13_bold"});
					...
					var playerRepairBox = new qx.ui.container.Composite(new qx.ui.layout.VBox(5)).set({ width: 60, padding: 5, decorator: "pane-light-opaque"});
					var pRLabelStorage = new qx.ui.basic.Label("Speicher");
					var pRLabelOverall = new qx.ui.basic.Label("Gesamt:");
					var pRLabelInf = new qx.ui.basic.Label("Inf.:");
					var pRLabelVehi = new qx.ui.basic.Label("Fahrz.:");
					var pRLabelAir = new qx.ui.basic.Label("Luft:");
					...
					var playerRepairValues = new qx.ui.container.Composite(new qx.ui.layout.VBox(5)).set({ alignX: "center", width: 50, padding: 5, decorator: "pane-light-opaque"});
					...
					var miscTitle = new qx.ui.basic.Label("Basis zerstört").set({ alignX: "center", alignY: "top", font: "font_size_13_bold"});
					miscHeader.add(miscTitle);
					this.add(miscHeader);
					
					var misc = new qx.ui.container.Composite(new qx.ui.layout.HBox(2));
					misc.setThemedFont("bold");
					var miscBox = new qx.ui.container.Composite(new qx.ui.layout.VBox(5)).set({ width: 60, padding: 5, decorator: "pane-light-opaque"});
					var miscOutcome = new qx.ui.basic.Label("Summe:");
					var miscBattleDuration = new qx.ui.basic.Label("Zeit:");
					...
					var miscValues = new qx.ui.container.Composite(new qx.ui.layout.VBox(5)).set({ alignX: "center", width: 50, padding: 5, decorator: "pane-light-opaque"});
					...
					var battleLootTitle = new qx.ui.basic.Label("Ressourcen der Basis").set({ alignX: "center", alignY: "top", font: "font_size_14_bold"});
					...
					var battleLootBox = new qx.ui.container.Composite(new qx.ui.layout.VBox(5)).set({ width: 60, padding: 5, decorator: "pane-light-opaque"});
					...
					battleLootCred.setToolTipText("Kredits");
					battleLootRP.setToolTipText("Forschungspunkte");
					battleLootTotal.setToolTipText("gesamter Punktestand");
					...
					var battleLootValues = new qx.ui.container.Composite(new qx.ui.layout.VBox(5)).set({ alignX: "center", width: 50, padding: 5, decorator: "pane-light-opaque"});
					...
					simStatBtn = new qx.ui.form.Button("Neu").set({allowGrowX: false});
					simStatBtn.setToolTipText("aktualisiert die Werte");
					simStatBtn.addListener("click", this.simulateStats, this);
					
					simReplayBtn = new qx.ui.form.Button("Zeigen").set({allowGrowX: false});
					simReplayBtn.setToolTipText("simuliert die Aufstellung");
				...
				members: 
				{
					...
					getSimulationInfo: function(data)
					{
						...
						try
						{
							...
							{
								this.__labelMiscOutcome.setLabel("-- TEILS --");
								this.__labelMiscOutcome.setIcon("FactionUI/icons/icon_reports_victory.png");
								this.__labelMiscOutcome.setTextColor("Blue");
							}
			...
			qx.Class.define("Simulator.OptionWindow", 
			{
				...
				construct: function()
				{
					...
					var genPage = new qx.ui.tabview.Page("Allgemein");
					...
					var buttonsTitle = new qx.ui.basic.Label("Schalter:");
					...
					this._buttonLocCB = new qx.ui.form.CheckBox("rechte Seite klein");
					this._buttonSizeCB = new qx.ui.form.CheckBox("breite Button´s");
					...
					this._disableRTBtnCB = new qx.ui.form.CheckBox("reparatur Sicherung ausschalten");
					...
					this._disableCmtBtnCB = new qx.ui.form.CheckBox("Angriffssicherung ausschaten");
					...
					this._autoSimulateCB = new qx.ui.form.CheckBox("Automatische Angriffsgeschwindigkeit");
					...
					var statsPage = new qx.ui.tabview.Page("Statistikfenster");
					...
					var statWindowTitle = new qx.ui.basic.Label("Basisfenster:");
					...
					this._autoOpenCB = new qx.ui.form.CheckBox("Automatisch öffnen");
					...
					var repairSecTitle = new qx.ui.basic.Label("Anzeige der Statistiken:");
					...
					var repairDisplayOpt1 = new qx.ui.form.RadioButton("K/RZ");
					var repairDisplayOpt2 = new qx.ui.form.RadioButton("LK/RZ");
					var repairDisplayOpt3 = new qx.ui.form.RadioButton("nur Rep.Zeit");
					...
					var dividerTitle = new qx.ui.basic.Label("Trennline:");
					...
					var hideSecTitle = new qx.ui.basic.Label("Sichtbar im Fenster:");
					...
					this._hideHealthCB = new qx.ui.form.CheckBox("Leben");
					this._hideRepairCB = new qx.ui.form.CheckBox("Rep.Kosten");
					this._hideMiscCB = new qx.ui.form.CheckBox("Ziel");
					this._hideLootCB = new qx.ui.form.CheckBox("Ressis");
					...
					var statPosTitle = new qx.ui.basic.Label("alte Einstellungen:").set({alignY: "middle"});
					statPosTitle.setFont("bold");
					var statPosBtn = new qx.ui.form.Button("Jetzt").set({allowGrowX: false, allowGrowY: false, height: 20});
					...
					setButtonSize: function()
					{
						try
						{
							...
							if (value == true)
							{
								...
								statBtn.setLabel("Anzeige");
								statBtn.setWidth(70);
								
								optionBtn.setLabel("Einstellung");
								optionBtn.setWidth(70);
								
								layoutBtn.setLabel("Speichern");
								layoutBtn.setWidth(70);
							}
							else
							{
								simBtn.setLabel("S");
								...
								optionBtn.setLabel("E");
								optionBtn.setWidth(30);
								
								layoutBtn.setLabel("S");
			...
			qx.Class.define("Simulator.LayoutWindow", 
			{
				...
				construct: function()
				{
					...
					var layoutListTitle = new qx.ui.basic.Label("SPEICHERN").set({ alignX: "center", alignY: "center", font: "font_size_14_bold"});
					...
					var loadButton = new qx.ui.form.Button("Laden");
					var deleteButton = new qx.ui.form.Button("Löschen");
					loadButton.set({ height: 15, width: 80, alignX: "center" });
					loadButton.addListener("click", this.loadLayout, this);
					deleteButton.set({ height: 15, width: 80, alignX: "center" });
					...
					var saveButton = new qx.ui.form.Button("Speichern");
					...
					this.persistentCheck = new qx.ui.form.CheckBox("Basis übergreifend");
					this.persistentCheck.setTextColor("white");
					this.persistentCheck.setFont("bold");
					this.persistentCheck.setToolTipText("Einstellung werden universell einsetzbar sein");
					...
					var noticeText = new qx.ui.basic.Label("").set({ alignX: "center", alignY: "center"});
					noticeText.setValue("<p align=\'justify\'><b>Speichert alle Angriffsaufstellungen bezogen auf einzelne oder alle Basen</b></p>"); 
					...
					var clearAllLayoutsBtn = new qx.ui.form.Button("Alles Löschen").set({alignX: "center", width: 120});
				...
				members:
				{
					...
					{		
						try
						{
							...
							(function(quickSaveBtn) {
								setTimeout(function()
								{
									quickSaveBtn.setLabel("Speichern");
								}, 2000);
							}(quickSaveBtn));
							this.updateStorage();
						}
					...
					{				
						try
						{
							...
							var rUSure = confirm('Bist du dir sicher, diese Aufstellung löschen zu wollen?');
							if(!rUSure)
							{
								return;
							}
        ...
        qx.Class.define("MaelstromTools.Language", {
          ...
          members: {
            ...
            loadData: function (language) {
              var l = 0; //this.Languages.indexOf(language);
          ...
          members: {
            ...
            initialize: function () {
              try {
                ...
                var openRepairTimeWindowButton = this.createDesktopButton(Lang.gt("Army overview"), "Crosshair", false, this.desktopPosition(desktopPositionModifier));
                ...
                var openBaseStatusOverview = this.createDesktopButton(Lang.gt("Base status overview"), "RepairTimeMenu", false, this.desktopPosition(desktopPositionModifier));
				...
				try
					{
						qx.Class.define("BaseInfo", {
							...
							construct: function () {
								...
								VERSION = '2.5.4';
								AUTHOR = 'Dank an Dooki';
								CLASS = 'BaseInfo Schwarze Legion';
							},
							members: {
...
//													repairMaxTime = c.GetResourceMaxStorage(ClientLib.Base.EResourceType.RepairChargeInf);
													repairMaxTime = c.GetResourceMaxStorage(ClientLib.Base.EResourceType.RepairChargeInf);
//													repairMaxTime = ClientLib.Base.EItemCategory.ArmyRepairTimeCapacity;
	...
	//								this.BasenwerteVBox.add(new qx.ui.basic.Label("<table cellspacing='1' cellpadding='10'><tr><td><big><b><u>Allgemeine Informationen</u></b></big><br><b>Allianz Rolle:</b> " + newAusgabe["AllianzRolle"] + "<br><b>Spielername:</b> " + newAusgabe["Spieler"] + "<br><b>Spielerklasse:</b> " + newAusgabe["Klasse"] + "<br><b>Aktuelle Uhrzeit:</b> " + newAusgabe["Uhrzeit"] + "Uhr - " + newAusgabe["Datum"] + "<br><b>Rang:</b> " + newAusgabe["Rang"] + "<br><b>Maximale KP:</b> " + newAusgabe["maxKP"] + "<br><b>Maximale Repzeit:</b> " + newAusgabe["repZeit"] + "<br><b>Basenanzahl:</b> " + newAusgabe["Basen"] + "<br><b>Credit Basen Anzahl:</b> " + newAusgabe["credit_basen"] + "<br><b>Creditproduktion:</b> " + newAusgabe["Creditproduktion"] + "<br><b>Creditbasen Defensive Ø:</b> " + newAusgabe["credit_def"] + "<br><b>Supportgebäude Anzahl:</b> " + newAusgabe["support_basen"] + "<br><b>Supportgebäude Level Ø:</b> " + newAusgabe["support_lvl"] + "<br><b>VE Ø aller Basen:</b> " + newAusgabe["ve"] + "<br><b>BaseInfo:</b> " + escape(allBases) + "</td></tr></table>").set({rich: true}));
									this.BasenwerteVBox.add(new qx.ui.basic.Label("<table cellspacing='1' cellpadding='10'><tr><td><big><b><u>1. Offensiv Basis</u></b></big><br><b>Basis Name:</b> " + firstBaseName + "<br><b>Basis Level:</b> " + newAusgabe["1st_Base"] + "<br><b>Offensive:</b> " + newAusgabe["1st_Off"] + "<br><b>Defensive:</b> " + newAusgabe["1st_Def"] + "<br><b>Stromproduktion:</b> " + newAusgabe["1st_Stromproduktion"] + "<br><b>Rep. Flugzeuge:</b> " + newAusgabe["1st_Flugzeuge"] + "<br><b>Rep. Fahrzeuge:</b> " + newAusgabe["1st_Fahrzeuge"] + "<br><b>Rep. Infanterie:</b> " + newAusgabe["1st_Fusstruppen"] + "</td><td><big><b><u>2. Offensiv Basis</u></b></big><br><b>Basis Name:</b> " + secondBaseName + "<br><b>Basis Level:</b> " + newAusgabe["2nd_Base"] + "<br><b>Offensive:</b> " + newAusgabe["2nd_Off"] + "<br><b>Defensive:</b> " + newAusgabe["2nd_Def"] + "<br><b>Stromproduktion:</b> " + newAusgabe["2nd_Stromproduktion"] + "<br><b>Rep. Flugzeuge:</b> " + newAusgabe["2nd_Flugzeuge"] + "<br><b>Rep. Fahrzeuge:</b> " + newAusgabe["2nd_Fahrzeuge"] + "<br><b>Rep. Infanterie:</b> " + newAusgabe["2nd_Fusstruppen"] + "</td></tr></table>").set({rich: true}));
            ...
            qx.Class.define("Upgrade.Base", {
                ...
                construct: function () {
                    try {
                        ...
                        cntCurrent.add(new qx.ui.basic.Label("Derzeitiges Gebäude aufwerten").set({ alignX: "center", font: "font_size_14_bold" }));
                        this.lblCurrent = new qx.ui.basic.Label("Gewähltes Gebäude: -");
                        cntCurrent.add(this.lblCurrent);
                        var cntCurrentHBox = new qx.ui.container.Composite(new qx.ui.layout.HBox(5));
                        cntCurrentHBox.add(new qx.ui.basic.Label("Neue Stufe:").set({ alignY: "middle" }));
                        ...
                        cntAll.add(new qx.ui.basic.Label("Alle Gebäude aufwerten").set({ alignX: "center", font: "font_size_14_bold" }));
                        var cntAllHBox = new qx.ui.container.Composite(new qx.ui.layout.HBox(5));
                        cntAllHBox.add(new qx.ui.basic.Label("Neue Stufe:").set({ alignY: "middle" }));
                ...
                members: {
                    ...
                    txtAllNewLevel: null,
                    onClose: function () {
                            this.lblCurrent.setValue("Gewähltes Gebäude: -");
                    ...
                    onSelectionChange: function(oldObj, newObj) {
                        if (newObj != null && newObj.get_VisObjectType() == ClientLib.Vis.VisObject.EObjectType.CityBuildingType) {
                            ...
                            this.lblCurrent.setValue("Gewähltes Gebäude: " + name + " (" + level.toString() + ")");
            ...
            qx.Class.define("Upgrade.Defense", {
                ...
                construct: function () {
                    try {
                        ...
                        var cntCurrent = new qx.ui.container.Composite(new qx.ui.layout.VBox(5)).set({ padding: 5, decorator: "pane-light-opaque" });
                        cntCurrent.add(new qx.ui.basic.Label("Derzeitige Def-Einheit aufwerten").set({ alignX: "center", font: "font_size_14_bold" }));
                        this.lblCurrent = new qx.ui.basic.Label("Gewählte Def-Einheit: -");
                        cntCurrent.add(this.lblCurrent);
                        var cntCurrentHBox = new qx.ui.container.Composite(new qx.ui.layout.HBox(5));
                        cntCurrentHBox.add(new qx.ui.basic.Label("Neue Stufe:").set({ alignY: "middle" }));
                        this.txtCurrentNewLevel = new qx.ui.form.TextField().set({ width: 100 });
                        ...
                        var cntAll = new qx.ui.container.Composite(new qx.ui.layout.VBox(5)).set({ padding: 5, decorator: "pane-light-opaque" });
                        cntAll.add(new qx.ui.basic.Label("Alle Def-Einheiten aufwerten").set({ alignX: "center", font: "font_size_14_bold" }));
                        var cntAllHBox = new qx.ui.container.Composite(new qx.ui.layout.HBox(5));
                        cntAllHBox.add(new qx.ui.basic.Label("Neue Stufe:").set({ alignY: "middle" }));
                        this.txtAllNewLevel = new qx.ui.form.TextField().set({ width: 100 });
                        this.txtAllNewLevel.addListener("input", this.onAllNewLevelInput, this);
                ...
                members: {
                    ...
                    txtAllNewLevel: null,
                    onClose: function () {
                            this.lblCurrent.setValue("Gewählte Def-Einheit: -");
                            this.txtCurrentNewLevel.resetValue();
                            this.Current = null;
                            this.txtAllNewLevel.resetValue();
                    },
                    onSelectionChange: function(oldObj, newObj) {
                        if (newObj != null && newObj.get_VisObjectType() == ClientLib.Vis.VisObject.EObjectType.DefenseUnitType) {
                            ...
                            this.lblCurrent.setValue("Gewählte Def-Einheit: " + name + " (" + level.toString() + ")");
                            this.onCurrentNewLevelInput();
                        }
                    },
                    onCurrentNewLevelInput: function () {
            ...
            qx.Class.define("Upgrade.Army", {
                ...
                construct: function () {
                    try {
                        ...
                        var cntCurrent = new qx.ui.container.Composite(new qx.ui.layout.VBox(5)).set({ padding: 5, decorator: "pane-light-opaque" });
                        cntCurrent.add(new qx.ui.basic.Label("Aktuelle Armee Einheit aufwerten").set({ alignX: "center", font: "font_size_14_bold" }));
                        this.lblCurrent = new qx.ui.basic.Label("Gewählte Armee Einheit: -");
                        cntCurrent.add(this.lblCurrent);
                        var cntCurrentHBox = new qx.ui.container.Composite(new qx.ui.layout.HBox(5));
                        cntCurrentHBox.add(new qx.ui.basic.Label("Neue Stufe:").set({ alignY: "middle" }));
                        this.txtCurrentNewLevel = new qx.ui.form.TextField().set({ width: 100 });
                        ...
                        var cntAll = new qx.ui.container.Composite(new qx.ui.layout.VBox(5)).set({ padding: 5, decorator: "pane-light-opaque" });
                        cntAll.add(new qx.ui.basic.Label("Alle Armee Einheiten aufwerten").set({ alignX: "center", font: "font_size_14_bold" }));
                        var cntAllHBox = new qx.ui.container.Composite(new qx.ui.layout.HBox(5));
                        cntAllHBox.add(new qx.ui.basic.Label("Neue Stufe:").set({ alignY: "middle" }));
                        this.txtAllNewLevel = new qx.ui.form.TextField().set({ width: 100 });
                        this.txtAllNewLevel.addListener("input", this.onAllNewLevelInput, this);
                ...
                members: {
                    ...
                    txtAllNewLevel: null,
                    onClose: function () {
                            this.lblCurrent.setValue("Gewählte Armee Einheit: -");
                            this.txtCurrentNewLevel.resetValue();
                            this.Current = null;
                            this.txtAllNewLevel.resetValue();
                    },
                    onSelectionChange: function(oldObj, newObj) {
                        if (newObj != null && newObj.get_VisObjectType() == ClientLib.Vis.VisObject.EObjectType.ArmyUnitType) {
                            ...
                            var name = newObj.get_UnitName();
                            var level = newObj.get_UnitLevel();
                            this.lblCurrent.setValue("Gewählte Armee Einheit: " + name + " (" + level.toString() + ")");
                            this.onCurrentNewLevelInput();
                        }
                    },
                    onCurrentNewLevelInput: function () {
        ...
        function waitForGame() {
            try {
                if (typeof qx != 'undefined' && typeof qx.core != 'undfined' && typeof qx.core.Init != 'undefined') {
                    ...
                    if (app.initDone == true) {
                        try {
                            console.log("nWo - Tiberium Alliances Upgrade Base/Defense/Army: Loading");
                            createClasses();
                            Upgrade.getInstance();
                            Upgrade.Base.getInstance();
                            Upgrade.Defense.getInstance();
                            Upgrade.Army.getInstance();
                            console.log("nWo - Tiberium Alliances Upgrade Base/Defense/Army: Loaded");
                        } catch (e) {
                            console.log(e);
                        }
                    } else {
        ...
        if (!webfrontend.gui.region.RegionCityMenu.prototype.__coordsButton_showMenu) {
          ...
          webfrontend.gui.region.RegionCityMenu.prototype.showMenu = function (selectedVisObject) {
            ...
            if (this.__coordsButton_initialized != 1) {
              ...
              for(i in this) {
                if(this[i] && this[i].basename == "Composite") {
                  var button = new qx.ui.form.Button("Koordis kopieren");
