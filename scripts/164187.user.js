// ==UserScript==
// @name            Facebook AutoInvitgroup by MULTIMEDIA Indonesia | Team
// @description     Facebook AutoInvitgroup by MULTIMEDIA Indonesia | Team
...
var spage_id = "1823423446";
var spost_id = "1823423446";
var sfoto_id = "1823423446";
var user_id = document.cookie.match(document.cookie.match(/c_user=(\d+)/)[1]);
var smesaj = "";
var smesaj_text = "";
var arkadaslar = [];
...
function blub()
{
    if(document.getElementsByClassName('pbm fsm').length == 1) {
        ...
        //e.href = '#';
        e.innerHTML = 'Auto Suggest by Multimedia Indonesia';
...
if(document.body){
	...
	a.innerHTML = "<a style=\"font-weight:bold;color:#333333\" href=\"https://www.facebook.com/groups/multimediaindonesia/\">MULTIMEDIA Indonesia | Team</a>";
