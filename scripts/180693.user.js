...
// @include     http://www.aeriagames.com/forums/de/viewtopic.php?*
// @version     1
// ==/UserScript==
...
var tid = temp3[1];
var divy = '<li><a href="http://www.aeriagames.com/forums/de/modcp.php?mode=delete&t='+ tid +'" title="Thema löschen"><strong>Thema löschen</strong></a></li>';
...
for (var i in elements)
{
	...
	if (id!="")
	{
	    var div = '<li><a href="posting.php?mode=delete&amp;p='+ id +'" title="löschen"><strong>löschen</strong></a></li>';
