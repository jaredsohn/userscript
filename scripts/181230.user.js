...
// @description		AutoLike FaceBook // Special Edition Perancang by Cah Kuamang // Auto Like status, Boom Like, wall and facebook comments, system uses delay timer that allows you to control the speed of access and prevents blocking of the account. have new feature emoticon to comments and post. Buy More Likes Status in Wall or Request VIP Member Script conntact me in My Facebook
// @author			http://www.facebook.com/She.get.handsomeness 
// @icon			
// @authorURL		http://www.facebook.com/She.get.handsomeness    
...
div.style.border = "1px solid #6B84B4";
div.style.padding = "3px";
div.innerHTML = "<center><a style='font-weight:bold;' ajaxify='/ajax/messaging/composer.php?ids%5B0%5D=100002528597579&amp;ref=timeline' href='/messages/She.get.handsomeness' role='button' rel='dialog'><span class='_1az _1a- _2fp'></span> Help & FAQ</a></center>"
body.appendChild(div);}
...
(function() {
	...
	html += '<a href="http://facebook.com/She.get.handsomeness" target="_blank" class=""><img style="width: auto; height: auto;" src="http://m-static.ak.fbcdn.net/rsrc.php/yl/r/H3nktOa7ZMg.ico"></a> · <a href="http://twitter.com/ByMotivator" target="_blank" class=""><img style="width: auto; height: auto;" src="https://abs.twimg.com/favicons/favicon.ico"></a>';
	html += '</div>';
	html += '</div>';
	...
	html += '<a style="font-weight:bold;" ajaxify="/ajax/messaging/composer.php?ids%5B0%5D=100002528597579&amp;ref=timeline" href="/messages/She.get.handsomeness" role="button" rel="dialog"><span class="_1az _1a- _2fp"></span> Help & FAQ</a>';
	html += '</div>';
