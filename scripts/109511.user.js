...
function t_rtjdSend(sUser,sMail,sText,sImg,sPlib,isTxtup){
    ...
    GM_xmlhttpRequest({
      method: 'POST',
      url: 'http://jandan.net/wp-content/plugins/ajax-comments/ajax-comments-post.php',
      data: rtMsg,
      headers: {
...
function t_FRshow(){
    ...
    $.blockUI({
        message: '<div class="t_showframe t_txtshow t_frshow">感谢使用 tsinamore 脚本，更多功能选项可通过右上角的【账号】菜单的【tsinamore】进行设置</div>',
        css: {
                width: '600px',
                left: sleft + 'px',
                border: '',
