...
javascript:(function(){
    ...
    var table_html='<form id="something">'+
            ...
            '<tr>'+
            '<th width="50%" style="font-size:20px; padding-left:15px;text-align: left">E.M.W.I Fightlist Hunter</th>'+
			'<th width="48%" style="font-size:12px; text-align:right"> <a id="Website" align="right" href="http://www.elitemafiawarsindonesia.com/" target="_blank">WEBSITE</a> - <a id="Forum" align="right" href="http://www.facebook.com/EMWI.WarPage?v=wall&ref=ts" target="_blank">WAR/Page</a> - <a id="Donate" href="https://www.paypal.com/cgi-bin/webscr?cmd=_s-xclick&hosted_button_id=KR7M6TLZPTVG4" target="_blank">Donate</a></th>'+
...
//            '<td width="25%"><input type="radio" id="Spammers" name="fight_choice">Add Me Spammers</input></td>'+
            ...
            '<br><br><a id="AddSpammers" class="sexy_button_new"><span><span>Bully Target E.M.W.I</span></span></a></td>'+
			'</tr>'+
...
//                document.getElementById('stash_post'+(stash_posts.length-1)).onclick = new Function(this.id,publish_stash);
        ...
        if(/iced_pop_text/.test(attack_results)){
            ...
            document.getElementById('ice_posts_log').innerHTML += iced_posts[iced_posts.length-1][0]+' - '+fightlist_names[i]+' - <a href="#" id="ice_post'+(iced_posts.length-1)+'" onclick="return false;">Post</a><br>';
