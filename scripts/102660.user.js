...
my.RapportAlliance = {
 ...
 init : function (){
  ...
  show : function () {  
     var t = my.RapportAlliance;
     var pageNum=1;
     t.cont.innerHTML = "Recherche en cours...";
     clearTimeout (t.displayTimer);
     var params = unsafeWindow.Object.clone(unsafeWindow.g_ajaxparams);
       ...
       onSuccess: function (rslt) {
       		...
       		var totalPages=rslt.totalPages;
                   ...
                   .msgviewtable tbody .myWarn div {font-weight:600; color:#442200}\
                      ...
                      msg.push("<div class=modalalliancewrap><div id='allianceContent' class='allianceboxwrap'><div class='modal_msg_reports'><a href='javascript:void(0);' id=clickclick onclick='allianceReports();'><img src='http://cdn1.iconfinder.com/data/icons/momenticons-gloss-basic/momenticons-gloss-basic/16/arrow-refresh.png'> Actualiser</a>")
              ...
              msg.push(rpt.reportId);
       		...
       		msg.push("</div><div id='modal_report_list_pagination'></div></div></div>");
             	this.cont.innerHTML = msg.join("");
          		...
          		this.cont.innerHTML += "<br><hr><INPUT type=CHECKBOX id=BOidCheck2 "+ (Options.EnableRefrechRapport?' CHECKED':'') +">Rafraichir automatiquement toute les 15s<br>NOTE : Ceci est une version pas stable<br>Si vous rencontrez des pb, merci de revenir sur un autre onglet de Boite a Outils ou de faire F5 pour reactualiser.";
          ...
          if (Options.EnableRefrechRapport)
                     {
	               t.displayTimer = setTimeout(t.show, 15000);
           }   
    ...
    function _row (name, row, noTotal){
       ...
       if (t.state == null) {  
         ...
         m += "<TABLE width=400 class=ptTab border=0 align=center><TR><TD colspan=3><DIV id=divSTRtop></div></td></tr>\
           <tr align=center valign=top><td colspan=1 width=33%><b><u>Source</b></u><br><span id=RAAsrcRptspeedcity></span></td>\
           <td colspan=1 width=33%><b>&nbsp;</u></b></td>\
           <td colspan=1 width=33%><b><u>Destination</b></u><br><span id=RAAdesRptspeedcity></span></tr>\
           <tr align=center valign=top><td><div id=RAAstatsource></div></td>\
           <td><table cellspacing=0 cellpadding=0 width=80%>";
            for (r=1; r<13; r++){
   	     m += '<tr><td align=right><img height=20 title="'+unsafeWindow.unitcost['unt'+r][0]+'" src=http://cdn1.kingdomsofcamelot.com/fb/e2/src/img/units/unit_'+r+'_30.jpg></td><td align=left><input style="border:1px solid black;height:16px;font-size:11px;" id="RAAnbunit'+r+'" type=text size=7 value="0"></td></tr>';
      	}
        m += "</table></td><td>X:<input type=text id=RAAtypetrpx size=3>&nbsp;Y:<input type=text id=RAAtypetrpy size=3><br><a href='javascript:void(0);' id='chargelistelieux'>Membres</a> : <select id='listeFavori'></select><br><br><input type=button id=RAAaction value='Attaquer'><br><input type=button id=RENaction value='Renforcer'></td></tr>\
              <tr><td colspan=3><div id=ptRAAStatus style='overflow-y:auto; max-height:78px; height: 78px;'></div></td></tr></table>";
        t.cont.innerHTML = m; 
...
var GMTclock = {
  ...
  everySecond : function (){
    var now = new Date();  
    now.setTime(now.getTime() + (now.getTimezoneOffset()*100));
...
my.Marches = {
  ...
  show : function (){  
    ...
    t.cont.innerHTML = '<TABLE class=ptTab align=center><TR><TD><INPUT class=pbSubtab ID=ptmrchSubM type=submit value="Marches en cours"></td>\
      ...
      <DIV id=ptMarchOutput style="margin-top:5px; background-color:white; height:620px;max-height:620px;overflow-y:auto"></div>';
...
var MessageCounts = {
  ...
  init : function (){ 
    ...
    unsafeWindow.BOMessageCounts = t.show;
    
    e = document.getElementById('chrome_messages_notify');
    e.style.float='right';
    e.style.margin = '10px 5px 6pt 10px;';
    
          span = document.createElement('span');
          span.className='notificationCount';
          span.style.display='none';
          span.id = 'chrome_messages_notifyL';
          span.style.margin = '10px -5px 6pt 10px;';
          span.style.cssFloat ='left';
    e.parentNode.insertBefore (span, e);
              span = document.createElement('span');
              span.className='notificationCount';
              span.style.display='none';
              span.id = 'chrome_messages_notifyR';
              span.style.margin = '10px 5px 6pt 10px;';
  ...
  show: function() {
      ...
      var r = document.getElementById('chrome_messages_notifyR');
      if (parseInt(Seed.newMailCount) > 0) {
        l.innerHTML = parseInt(Seed.newMailCount);
        l.style.display = 'block';
        l.style.margin = '10px -5px 6pt 10px';
      ...
      if (reports < 1) {
        ...
        r.style.margin = '10px 5px 6pt 10px';
   ...
   setTimeout (unsafeWindow.BOMessageCounts, 1000);
  },
