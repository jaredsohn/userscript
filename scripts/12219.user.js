// ==UserScript==
// @name            taz_zeit_wirtschaft
// @namespace       Platypus
// @include         *TAZ&ressort=wu
// @include         *.taz.de/index.php?id=wirtschaft
...
html_insert_it(window.document,document.getElementById('datum_plugin_rechts'),'<iframe src="http://newsfeed.zeit.de/wirtschaft/index#feed-greasemonkey" width="500" height="600"></iframe>',false,true);
