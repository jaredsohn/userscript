// ==UserScript==
// @name           eTÃ¼rkiye Emirleri
// @version        1.01
// @releasedate   20101004
// @include        http://www.erepublik.com/*
// ==/UserScript==

var ordersurl = "http://bit.ly/eturkiyeemirleri";

var selectedunit = GM_getValue("defaultunit");
if (selectedunit==undefined) selectedunit = 1;
var units = ["MSB", "BaÅ�kan", "GÃ¼ndem", "KÄ±brÄ±s", "?"];
...
function main()
{
 ...
 title.innerHTML = '<embed class="sIFR-flash" width="250" height="28" src="/flash/delicious.swf" quality="best" flashvars="txt=GÃ¼nlÃ¼k_Emirler&&textcolor=#737373&hovercolor=null&linkcolor=null&w=250&h=28" wmode="transparent" bgcolor="transparent" sifr="true" type="application/x-shockwave-flash" style="width: 250px; height: 28px;"/>'
