// ==UserScript==
// @name            Platypus-www.clipfish.de/meinprof
// @namespace       Platypus
// @include         http://www.clipfish.de/meinprofil/
// ==/UserScript==
function do_platypus_script() {
html_insert_it(window.document,document.evaluate('/HTML[1]/BODY[1]/DIV[1]/DIV[3]/DIV[2]/DIV[1]/DIV[2]/DIV[3]/A[1]/IMG[1]', document, null, XPathResult.FIRST_ORDERED_NODE_TYPE,null).singleNodeValue,'<a href="http://clipfish.kotzt-mich-an.eu/" target="_blank"><img src="http://www2.pic-upload.de/29.11.09/qs1def22ty.gif" border="0" alt="Bilder hochladen"></a>',false,false);
html_insert_it(window.document,document.evaluate('/HTML[1]/BODY[1]/DIV[1]/DIV[3]/DIV[2]/DIV[1]/DIV[2]/DIV[3]/A[1]/IMG[1]', document, null, XPathResult.FIRST_ORDERED_NODE_TYPE,null).singleNodeValue,'<a href="http://clipfish.kotzt-mich-an.eu/" target="_blank"><img src="http://www2.pic-upload.de/29.11.09/qs1def22ty.gif" border="0" alt="Bilder hochladen"></a>',true,false);
