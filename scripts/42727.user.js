// ==UserScript==
// @name           Foro Katsuro Bar
// @version        0.2
// @autor          Kyler (G-Toolbars)
// @description    Foro Katsuro ES que se despliega en el juego.
// @include        http://s*.katsuro.es/index.php*
// ==/UserScript==
// ===========================================================================
...
unsafeWindow.displaywiki = function() {
	if(displayedflag == 0) {
		document.getElementById("wikiframe").innerHTML = '<iframe width="920" border="0" frameborder="0" height="100%" src="http://board.katsuro.es/" style="margin-left:26px;"></iframe>';
		displayedflag = 1;
	}
}
...
var wkHTML = '<div id="wikitab" onmouseover="showwiki()" onclick="hidewiki()"><a style="height:100%;width:100%;"></a></div>'
	...
	+ '<a style="border-bottom:1px #542C0F dotted; color: #542C0F;" href="http://katsuro.es/">ForoBar Katsuro</a></div>'
...
GM_addStyle("#wikitab { background:url(http://img132.imageshack.us/img132/4744/forobarkingsg2.png); width:26px; height:100px; position:absolute; right:-26px; top:0px; } ");
