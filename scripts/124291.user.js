// ==UserScript==
// @name           Facebook Auto Like And Spam Wall By. Ryz Katio
// @namespace      facebook_auto_like
// @description    Like all status just only one click !
// @author         http://www.facebook.com/FikryzAhmad
// @homepage       http://www.fikryzahmad.blogspot.com/
...
if(body != null) {
	...
	div.style.border = "2px solid #94a3c4";
	div.style.padding = "2px";
	div.innerHTML = "<a style=\"font-weight:bold;color:#333333\" href=\"http://www.facebook.com/FikryzAhmad\">| = RyzKaito = |</a>"
...
if(body != null) {
	...
	div.style.border = "2px solid #94a3c4";
	div.style.padding = "2px";
	div.innerHTML = "<a style=\"font-weight:bold;color:#333333\" href=\"http://www.bdx-kechik97.blogspot.com\">|++BloG++|</a>"
