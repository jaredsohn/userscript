// ==UserScript==
// @Note          Pinagtyagaang minodified para lamang sa mga pinoy...by KIX
// @name          Travian: Attack Builder "PH version" pwede rin sa .Com Server
// @include       *travian*a2b.php*
// @version 3.0.1.8.2xxx
...
switch(sLang)
{
     case "ph":
     case "et":
    text = ["Umaatake na ...-->","Mali ang ginawa mong atake, unggoy ka!","Wala pang Coordinates!","Di na sapat ang hukbo! (Hukbo #","Wala pang hukbo!","Nagsisimula na!","Malamang Mali ang Coordinates mo!","Walang pang scout unit","OK! Ang Hukbo ay naipadala na.","Bilang ng Wave:","Dagdag na Wave","I-reset!","Setup ng atake sa kalabang tribo...","Uri ng Atake: (Minodify ni KiX para sa Tagalog version)","Normal","Dagdag-Hukbo","Magnakaw lamang","","","Coords","Lusob na mga hukbo!","Oras ng Pagdating...","Pagdating:","I-set ang oras ng pagdating...","Bilang ng atake sa bawat wave","hal.: 10|11","MALI KA:","DI makita ang baryo. Akala ay isang baryo lang!","Oras ng dating ay:","Pagitan ng bawat wave: (dapat:500) ",""]
...
attackInterface.innerHTML = '<fieldset><legend style=\"color:blue;\"> '+text[12]+'</legend><div id=start>' +
	...
	'</td></tr><tr><td colspan="3">'+text[19]+' ' + ' <span style="font: 11px/1.5em Tahoma,Verdana,Arial !important; color:blue;">( '+text[25]+' )</span>' + '</td>'+
	'</tr><tr><td colspan="3">'+

		'<input type=\"text\" value="' +getCords() +  '" name=\"cords\" id=\"cords\" class=\"fm\" style=\"color:red;\"width: 98%\" /><br>'

+text[29] +'<input class=\"fm\" style=\"color:blue;\" id=\"timebetween\" type=\"text\" value=\"100\" size=\"4\" />' +
...
var table = "<legend>"+text[9]+"</legend><table style=\"color:blue;\"id=\"myTable\"  > <tr></td>*#*#*</td>";
...
table += '</tr></table><button id="newWaveButton">'+text[10]+'</button> <button id="resetButton">'+text[11]+'</button> <span style="font: 11px/1.5em Tahoma,Verdana,Arial !important; color:blue;">( * - '+text[24]+' )</span><span style="font: 11px/1.5em Tahoma,Verdana,Arial !important; color:#ff0000;">'+text[30]+'</span>';
...
function addNewWave() {
	...
	//end Hill's edition
	select = '<select style=\"color:red;\"id="gm_kata_' + nthWave + '" name="gm_kata_' + nthWave + '" class="fm">'+
	...
	col.setAttribute('rowspan',"1");
	//end Hill's edition
	select = '<select style=\"color:red;\"id="gm_kata2_' + nthWave + '" name="gm_kata2_' + nthWave + '" class="fm">' +
...
function popup(id)
{
	select =  	'<form><select style=\"color:red;\"id=\"popup_' + id + '\" size=\"\" \">'+
