// ==UserScript==
// @name           Dave LoU Raid Rus
// @description    Рейдовый помощник
...
var p= r.getTab();
if (v== "visible" && p== 3) {
alert("Окно обзора конанд должно быть закрыто");
...
if (i.c==0) {
w.h();
alert("Нет бездействующих войск.  Попробуйте позже.");
...
this.hide();
w.k2.setLabel("С")
w.k2.setToolTipText("Изменить на режим списка")
...
this.hide();
w.k2.setLabel("П")
w.k2.setToolTipText("Изменить на режим панели инструментов")
...
this.a= new qx.ui.form.Button("Г").set({
appearance: "button-text-small",
toolTipText: "Перейти в следующий город",
...
this.add(this.a);
this.d= new qx.ui.form.Button("О").set({
appearance: "button-text-small",
toolTipText: "Обновить список",
...
this.add(this.d);
this.b= new qx.ui.form.Button("И").set({
appearance: "button-text-small",
toolTipText: "Добавить текущий город в список игнорирования",
...
this.add(this.b);
this.e= new qx.ui.form.Button("К").set({
appearance: "button-text-small",
toolTipText: "Добавить весь континент в список игнорирования",
...
this.add(this.e);
this.c= new qx.ui.form.Button("Ч").set({
appearance: "button-text-small",
toolTipText: "Очистить список игнорирования",
...
this.add(this.c);
this.k2= new qx.ui.form.Button("С");
this.k2.set({
appearance: "button-text-small",
blockToolTip: false,
toolTipText : "Изменить на режим списка",
...
var m= new qx.ui.form.MenuButton("М",null,j).set({
appearance: "button-text-small",
toolTipText: "Меню для изменений рейдов в подземелья и утилиты",

padding:3,
})
this.add(m);
var k= new qx.ui.menu.Button("Изменить на одиночные");
k.set({
blockToolTip: false,
toolTipText : "Изменить все рейды на одиночные",
...
k= new qx.ui.menu.Button("Изменить на полное");
k.set({
blockToolTip: false,
toolTipText : "Изменить все рейды на полное прохождение",
...
k= new qx.ui.menu.Button("Вернуться к раннему приказу");

k.set({
blockToolTip: false,
toolTipText : "Вернуть все рейды до самого раннего приказа",
...
this.z= new qx.ui.menu.Button("Вернуться до сегодня 23:00");
this.z.set({
blockToolTip: false,
toolTipText : "Вернуть все рейды в указанное время",
...
k= new qx.ui.menu.Button("Изменить время возврата");

k.set({
blockToolTip: false,
toolTipText : "Изменить время возврата рейдов",
...
k= new qx.ui.menu.Button("Переключить панель в мире");

k.set({
blockToolTip: false,
toolTipText : "Спрятать/показать левую панель в обзоре мира",
...
k= new qx.ui.menu.Button("Перейти в предыдущий город");

k.set({
blockToolTip: false,
toolTipText : "Перейти в предыдущий город в режиме списка",
...
this.add(o);
var n=new qx.ui.form.CheckBox("Боссы").set({
height: 20,
allowGrowX: false,
})
n.setValue(true);
...
o.add(n);
n=new qx.ui.form.CheckBox("Подземелья").set({
height: 20,
allowGrowX: false,
})
n.setValue(true);
...
o.add(new qx.ui.core.Spacer(2,2))
this.add(o);
var n=new qx.ui.form.CheckBox("Г").set({
height: 20,
allowGrowX: false,
})
n.setValue(true);
...
o.add(n);
var n=new qx.ui.form.CheckBox("Х").set({
height: 20,
allowGrowX: false,
})
n.setValue(true);
...
o.add(n);
var n=new qx.ui.form.CheckBox("Л").set({
height: 20,
allowGrowX: false,
})
n.setValue(true);
n.addListener("changeValue", function (e) {
this.forest = e.getData();
this.r();
}, this)
o.add(n);
var n=new qx.ui.form.CheckBox("М").set({
height: 20,
allowGrowX: false,
})
n.setValue(true);
...
n:e,
d:Math.round(t),
u:s.toLocaleTimeString().substr(0, 4),
v:u,
};
this.o.push(o);
}
...
var j=this.o[i];
if (j.n=="Б"&&!this.b) continue;
if (j.n!="Б"&&!this.d) continue;

if (j.n=="Х" && !this.hill) continue;
else if (j.n=="Г" && !this.mnt) continue;
else if (j.n=="Л" && !this.forest) continue;
else if (j.n=="М" && !this.sea) continue;
...
construct: function()
{
this.base(arguments,"Время возврата");
this.buildGUI();
this.set({
allowMaximize : false,
allowMinimize : false,
...
buildGUI: function() {
g=this;
var li=new qx.ui.form.ListItem("Сегодня", null, 0);
this.d.add(li);
this.d.add(new qx.ui.form.ListItem("Завтра", null, 1));
this.d.add(new qx.ui.form.ListItem("2 дня", null, 2));
this.d.add(new qx.ui.form.ListItem("3 дня", null, 3));
this.d.add(new qx.ui.form.ListItem("4 дня", null, 4));
this.d.add(new qx.ui.form.ListItem("5 дней", null, 5));
...
w.z.setLabel("Вернуться до "+this.l);
},
j: null,
k: null,
l: null,
...
c=new d.C();
this.buildGUI();
var i=new qx.ui.tabview.Page("Рейд");
...
buildGUI: function(){
this.setLayout(new qx.ui.layout.VBox())
var t= "<b>DaveLoU Помощник Рейдов</b> <br><br>  "
+"<b>Бездействующие войска</b> <br>"
+"Включать войска:"
...
this.add(h)
var n=new qx.ui.form.CheckBox("АТАКУЮШИЕ").set({
width: 100,
})
n.setValue(c.o.o)
n.addListener("changeValue",function(e){
...
this.add(h)
n= new qx.ui.form.CheckBox("ЗАЩИТНЫЕ").set({
width: 100,
})
n.setValue(c.o.d)
n.addListener("changeValue",function(e){
...
this.add(h)
n= new qx.ui.form.CheckBox("МОРСКИЕ").set({
width: 100,
})
n.setValue(c.o.n)
n.addListener("changeValue",function(e){
...
this.add(l)
n= new qx.ui.basic.Label("Минимум секунд до показа всплывающего окна войск").set({
...
this.add(l)
n= new qx.ui.basic.Label("Игнорировать города со свободными войсками(в тысячах) меньше чем").set({
...
this.add(l)
n= new qx.ui.basic.Label("Авто-обновление списка (спрятать кнопку О) ").set({
...
this.add(l)
n= new qx.ui.basic.Label("Вычесть назначенные приказы для подсчета").set({
...
this.add(l)
n= new qx.ui.basic.Label("Ограничить список текущей выбранной групой").set({
...
this.add(l)
n= new qx.ui.basic.Label("Изменение времени рейдов в минутах до раннего назначенного приказа").set({
...
this.add(l)
n= new qx.ui.basic.Label("Панель вертикально (или горизонтально)").set({
...
this.add(l)
n= new qx.ui.basic.Label("Радиус поиск Боссов/Подземелий для списка(4-20)").set({
...
this.add(l)
n= new qx.ui.basic.Label("Показывать информацию в регионе/мире в всплывающем окне").set({
...
this.add(l)
n= new qx.ui.basic.Label("Время окончания 1-2 дневных рейдов (0-23) ").set({
width:450,
});
l.add(n)
...
this.add(l)
n= new qx.ui.basic.Label("Задержка смещения времени рейдов (минуты)").set({
...
this.add(l)
n= new qx.ui.basic.Label("Игнорировать медленные войска для рейдов на боссов").set({
...
r= "Информация рейда: Одиночный: "+Math.round(this.q/this.p.i*100)
+"%, 1Д: "+ Math.round(this.q/this.n.i*100)
+"%, 2Д: "+ Math.round(this.q/this.r.i*100)
+"%, Полный: "+Math.round(this.q/this.o.i*100)+"%<br>"+n;
l+=r+"<br>Время в пути "+ s.toLocaleTimeString()
this.h.setLabel(l);
},
k2: function(i,j,k) {
...
s=new Date();
s.setHours(0, 0, this.u, 0);
l=l+"Информация рейда: Достаточно для "+this.q0+" боссов<br>"+n

+"<br>Время в пути "+ s.toLocaleTimeString();
this.h.setLabel(l);
},
s: function() {
...
this.m1= new qx.ui.menu.Button("Рейд 1 день");
this.m.add(this.m1);
this.m1.addListener("click",function(e){
this.k2(e);
this.n(1)
},this);
this.m2= new qx.ui.menu.Button("Рейд 2 дня");
this.m.add(this.m2);
...
k=this;
this.m3= new qx.ui.menu.Button("Рейд Полный");
this.m.add(this.m3);
this.m3.addListener("click",function(e){
this.k2(e);
this.n(3)
},this);
this.m5= new qx.ui.menu.Button("Рейд одиночный");
this.m.add(this.m5);
this.m5.addListener("click",function(e){
this.k2(e)
this.n(0)
},this);
this.m4= new qx.ui.menu.Button("Рейд на Босса");
this.m.add(this.m4);
