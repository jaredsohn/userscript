// ==UserScript==
// @name            1UP Main Board Link (Consistency add-on)
// @namespace       The Official 1UP Message Boards
// @include         http://www.1up.com/boards/forums/show*
// ==/UserScript==
function do_platypus_script() {
do_modify_html_it(window.document,document.evaluate('/HTML[1]/BODY[1]/DIV[6]/DIV[1]/DIV[1]', document, null, XPathResult.FIRST_ORDERED_NODE_TYPE,null).singleNodeValue,/Main Boards List/g,'1up Message Boards',null);
