...
// @description    	單鍵轉噗、日曆、翻譯、點ID開新頁、進階文字編輯器、噗浪時光機、封鎖計時器（Build 20091010）
// modified log:    
// author: Plurk Translate（Peteris Krumins）、Plurker 2 _blank（kris7topher）、Plurk Productivity（Katharine Berry ）、Plurk Time Jumper（Wisely Song）、Plurk Rich Edit（maxchu）、PLURK小月曆（rein）、RE（???）  
// Changed : Dravex
...
// ==Plurk Productivity== 封鎖計時器 by Katharine Berry//
