// ==UserScript==
// @name DicingDangers V3 Shortcuts for chrome
// @namespace http://diveintogreasemonkey.org/download/
// @description DicingDangers V3 Shortcuts for Chrome
// @match http://ec2-50-17-79-49.compute-1.amazonaws.com/*
// ==/UserScript==
// 1 =
// 2 =
// 3 =
...
function keyHandler(event) {
  ...
  if(k==49)      {
    ...
    document.location.href = 'http://ec2-50-17-79-49.compute-1.amazonaws.com//game.php?s=changechar&var1=4877';
  }//0
  else if(k==48) {
    document.location.href = 'http://ec2-50-17-79-49.compute-1.amazonaws.com//game.php?s=changechar&var1=4876';
  }//A
  else if(k==65) {
    document.location.href = '';
  }//B
    ...
    document.location.href = 'http://ec2-50-17-79-49.compute-1.amazonaws.com//game.php?s=combat&a=flee';
  }//X
 else if(k==88) {
    document.location.href = '';
  }//Y
