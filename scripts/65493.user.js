...
// @description    Returns to the original thread on 4chan after posting or deleting a post even if an email address is given. UPDATORTED BY KEBLES.
...
var img2post = {"boards":"sys"};

var post2img = {"sys":"boards"};
