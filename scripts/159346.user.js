// ==UserScript==
// @name        DGR - Visibilité des Forums (Sauf forum2 RR)
// @namespace   http://dev.webnaute.net
// @description 
// @include     http://forum.lesroyaumes.com
// @include     http://forum.nativekingdoms.com
// @include     http://forum.shogunkingdoms.com
// @include     http://forum.lesroyaumes.com/index.php*
// @include     http://forum.nativekingdoms.com/index.php*
// @include     http://forum.shogunkingdoms.com/index.php*
// @exclude     http://forum.lesroyaumes.com/index.php?c=*
// @exclude     http://forum.nativekingdoms.com/index.php?c=*
// @exclude     http://forum.shogunkingdoms.com/index.php?c=*
// @version     1
// ==/UserScript==
//
...
for (i = 0 ; i < cats.length ; ++i) {
    ...
    if (tr.nb_f < 2) {
        ...
        if (i == 0) cats[i].innerHTML += " (Ma Gargote)";
        if (pos == 1) {
            var trloop = tr;
