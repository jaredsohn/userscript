// ==UserScript==
// @version 1
// @name Signature Button by Supriya for Jobin..
...
// @include http://www.orkut.com/Scrapbook.aspx?undefined*
// ==/UserScript==

// edit The value of Signa Below for ur Own Signature... 

var signa="\n\n"+"[teal]"+"_________________"+" "+"\n"+"[b][i][purple]Clothes are useless to girls[:x] [red]unless they inspire men to take them off[;)]";
