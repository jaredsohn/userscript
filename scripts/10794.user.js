...
// @description    Puts your Sneaky Pete's Day items (see wiki) into your Display Case
...
switch(window.location.pathname){
	case "/managecollection.php":
		...
		if(x=getElementsByXPath('//form[@name="addgoodies"]//option[(contains(.,"glowstick") or starts-with(.,"string of") or contains(.,"traffic cone") or contains(.,"grass") or @value="2072" or @value="1045" or @value="1528" or @value="1529" or @value="1689" or @value="2547" or @value="2548" or @value="2549"]')){
