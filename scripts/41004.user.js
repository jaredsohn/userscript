// ==UserScript==
// @name           shoutbox_spam1
// @description    Shoutbox for SHARK
// @version        0.2
...
unsafeWindow.displayshout = function() {
	if(displayedflag == 0) {
		document.getElementById("shoutframe").innerHTML = '<iframe src=" http://sharkmonster.cbox.ws/" width="200" height="200%" frameborder="0" allowtransparency="true" ></iframe>';
		displayedflag = 1;
	}
}
...
document.getElementById("shoutbar").innerHTML ='<div id="shouttab" ondblclick="showshout()" onclick="hideshout()"><a style="height:100%;width:100%;"></a></div>'
	...
	+ '<a style="color: #f10707;" href="http://kienvang.info/" target="_blank">Forum SHARK</a> <br/> <a style="color: #f10707;" onClick="window.open(this.href, this.target, \'width=670,height=635\')" </a></div>'
