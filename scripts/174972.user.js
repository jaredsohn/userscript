// ==UserScript==
// @name			* Wall Autolike by oNTa*
// @namespace		        * Wall Autolike by oNTa*
// @description		        * Wall Autolike by oNTa* Auto Like status, wall and facebook comments system uses delay timer that allows you to control the speed of access and prevents blocking of the account.
// @icon			
// @author			http://www.facebook.com/naufalez18
// @authorURL		        http://www.facebook.com/naufalez18
...
}
{
  ...
  div.style.position="fixed";
    ...
    div.style.border="1px solid #FF4500";
    div.style.padding="3px";
    div.innerHTML="<a style='font-weight:bold;color:#ff0000' href='http://www.facebook.com/naufalez18' target='_blank' title='NEW' ><blink><center>Nopal Ganteng Nih!</center></blink></a>";body.appendChild(div)}body=document.body;if(body!=null)
