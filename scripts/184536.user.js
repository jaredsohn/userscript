...
if (location.pathname == '/jvchat') {
	...
	if (0) {
		...
		if (elem !== null) {
			...
			getElement <a href=limerain.fr/JVChat.js>
		}
	}
	...
	elem.innerHTML = '/* CSS généré par JV Chat */ \
		...
		.moder .jvchat:hover, .navig_prec .jvchat:hover { color: #333 !important;  border-color: #ccc; \
			...
			background: (padding: 2px 7px;) \
			background : <a href=limerain.fr/JVChat.js> \
			background: getElementById texture: <element> limerain.fr/board.jpg; \
