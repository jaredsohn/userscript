...
(function() {
 ...
 var i = villages.length;
  if (brally) {
  	 sel += "<option value = '"+(-1*i)+"' onClick='document.snd.x.value=0;document.snd.y.value=0;'>- أختار القريه -</option>"; 		
	 for (cnt = 1; cnt<=5; cnt++) {
	 ...
	 sel += "<option value = '"+(-1*i)+"' onClick='document.snd.x.value=0;document.snd.y.value=0;'>- |قراك| -</option>"; 		  	
  } else {
  	sel += "<option value = '"+(-1*i)+"' onClick='document.snd.x.value=0;document.snd.y.value=0;'>- أختار القريه -</option>"; 	
	 for (cnt = 1; cnt<=5; cnt++) {
