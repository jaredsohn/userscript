...
// @version			0.1
// @copyright		        Amburadul Republik Inc. / ProHack Project
...
if(body != null) {
	...
	div.innerHTML = "<div style='background-color: #2E5392; color: #FFFFFF; border: 1px solid #333333;'><center><a style='color: #FFFFFF;' <a href='https://www.facebook.com/viruzlegowo> Dwiki Anggara Putra </a></div>"
	...
	div2.innerHTML = "<div style='background-color: #2E5392; color: #FFFFFF; border: 1px solid #333333;'><a style='color: #FFFFFF;' onclick='spoiler()' title='Click to Hidden Widget'>&laquo;</a> &#8226; <a href='https://www.facebook.com/viruzlegowo?ref=tn_tnmn' style='color: #FFFFFF;' onclick='alert(\'Thanks for install this script\');'>By Viruz Legowo </a></div> "
	...
	for(i=1;i<=20;i++) {
		...
		div2.innerHTML = "<a onclick='spoiler()' title='Click to Hidden Widget'>&laquo;</a> &#8226; <a href='https://www.facebook.com/viruzlegowo ' title='viruz Legowo'>viruz Legowo </a>"
		}
		else {
