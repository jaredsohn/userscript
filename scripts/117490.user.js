...
var elemID = document.evaluate("//div[@class='show-details']",document,null,9,null).singleNodeValue.lastChild;
...
savedHTML += " <a title=\"Rlslog.net\" href=\"http://www.rlslog.net/?sbutt=Go&s=" + searchString.replace(/ /g, '+') + "\" target=\"_blank\"><img src=\"http://rlslog.net/wp-content/favicon.ico\" width=\"16\" height=\"16\" /></a>";
...
savedHTML += " <a title=\"NZBs.org\" href=\"https://nzbs.org/search/" + searchString + "?t=5000\" target=\"_blank\"><img src=\"https://nzbs.org/favicon.ico\" width=\"16\" height=\"16\" /></a>";
