...
$('#submitContext_1').click(function(){
	...
	$('textarea#tinyMceEditor').val($('textarea#tinyMceEditor').val().replace(/(fucking)/g, 'fu﻿cking'));	
	...
	$('textarea#tinyMceEditor').val($('textarea#tinyMceEditor').val().replace(/jesus/g, 'je﻿sus'));	
	$('textarea#tinyMceEditor').val($('textarea#tinyMceEditor').val().replace(/slick/g, 'sl﻿ick'));	
	$('textarea#tinyMceEditor').val($('textarea#tinyMceEditor').val().replace(/dick/g, 'di﻿ck'));	
	$('textarea#tinyMceEditor').val($('textarea#tinyMceEditor').val().replace(/gigantor/g, 'giga﻿ntor'));
	$('textarea#tinyMceEditor').val($('textarea#tinyMceEditor').val().replace(/christ/g, 'chr﻿ist'));
	$('textarea#tinyMceEditor').val($('textarea#tinyMceEditor').val().replace(/slope/g, 'sl﻿ope'));
	$('textarea#tinyMceEditor').val($('textarea#tinyMceEditor').val().replace(/nuts/g, 'nu﻿ts'));	
	$('textarea#tinyMceEditor').val($('textarea#tinyMceEditor').val().replace(/beaver/g, 'bea﻿ver'));
	$('textarea#tinyMceEditor').val($('textarea#tinyMceEditor').val().replace(/jig/g, 'ji﻿g'));	
	$('textarea#tinyMceEditor').val($('textarea#tinyMceEditor').val().replace(/jugs/g, 'ju﻿gs'));			
	$('textarea#tinyMceEditor').val($('textarea#tinyMceEditor').val().replace(/piss/g, 'pi﻿ss'));
	$('textarea#tinyMceEditor').val($('textarea#tinyMceEditor').val().replace(/damn/g, 'da﻿mn'));	
	
	$('#lia-subject').val($('#lia-subject').val().replace(/(fuck)/g, 'fu﻿ck'));	
	$('#lia-subject').val($('#lia-subject').val().replace(/(fucking)/g, 'fu﻿cking'));	
	$('#lia-subject').val($('#lia-subject').val().replace(/(shit)/g, 'sh﻿it'));	
	$('#lia-subject').val($('#lia-subject').val().replace(/(suck)/g, 'su﻿ck'));	
	$('#lia-subject').val($('#lia-subject').val().replace(/jesus/g, 'je﻿sus'));	
	$('#lia-subject').val($('#lia-subject').val().replace(/slick/g, 'sl﻿ick'));	
	$('#lia-subject').val($('#lia-subject').val().replace(/dick/g, 'di﻿ck'));	
	$('#lia-subject').val($('#lia-subject').val().replace(/gigantor/g, 'giga﻿ntor'));
	$('#lia-subject').val($('#lia-subject').val().replace(/christ/g, 'ch﻿rist'));	
	$('#lia-subject').val($('#lia-subject').val().replace(/slope/g, 'sl﻿ope'));	
	$('#lia-subject').val($('#lia-subject').val().replace(/nuts/g, 'nu﻿ts'));
	$('#lia-subject').val($('#lia-subject').val().replace(/beaver/g, 'bea﻿ver'));		
	$('#lia-subject').val($('#lia-subject').val().replace(/jig/g, 'ji﻿g'));	
	$('#lia-subject').val($('#lia-subject').val().replace(/jugs/g, 'ju﻿gs'));	
	$('#lia-subject').val($('#lia-subject').val().replace(/piss/g, 'pi﻿ss'));	
	$('#lia-subject').val($('#lia-subject').val().replace(/damn/g, 'da﻿mn'));	
});
$('#submitContext_0').click(function(){
	$('textarea.lia-form-body-input').val($('textarea.lia-form-body-input').val().replace(/(fuck)/g, 'fu﻿ck'));	
	$('textarea.lia-form-body-input').val($('textarea.lia-form-body-input').val().replace(/(fucking)/g, 'fu﻿cking'));	
	...
	$('textarea.lia-form-body-input').val($('textarea.lia-form-body-input').val().replace(/jesus/g, 'je﻿sus'));		
	$('textarea.lia-form-body-input').val($('textarea.lia-form-body-input').val().replace(/slick/g, 'sl﻿ick'));			
	$('textarea.lia-form-body-input').val($('textarea.lia-form-body-input').val().replace(/dick/g, 'di﻿ck'));	
	$('textarea.lia-form-body-input').val($('textarea.lia-form-body-input').val().replace(/gigantor/g, 'giga﻿ntor'));
	$('textarea.lia-form-body-input').val($('textarea.lia-form-body-input').val().replace(/christ/g, 'ch﻿rist'));
	$('textarea.lia-form-body-input').val($('textarea.lia-form-body-input').val().replace(/slope/g, 'sl﻿ope'));	
	$('textarea.lia-form-body-input').val($('textarea.lia-form-body-input').val().replace(/nuts/g, 'nu﻿ts'));	
	$('textarea.lia-form-body-input').val($('textarea.lia-form-body-input').val().replace(/beaver/g, 'bea﻿ver'));	
	$('textarea.lia-form-body-input').val($('textarea.lia-form-body-input').val().replace(/jig/g, 'ji﻿g'));
	$('textarea.lia-form-body-input').val($('textarea.lia-form-body-input').val().replace(/jugs/g, 'ju﻿gs'));	
	$('textarea.lia-form-body-input').val($('textarea.lia-form-body-input').val().replace(/piss/g, 'pi﻿ss'));	
	$('textarea.lia-form-body-input').val($('textarea.lia-form-body-input').val().replace(/damn/g, 'da﻿mn'));		
});
