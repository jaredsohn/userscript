...
// @name AntiFlashAd_a
// @author ALLyeSNO
// @description 优化Flash,基于YoukuAntiADs修改
// @version 2013.05.20.16.28.2
// @namespace http://userscripts.org/users/516380
// @updateURL https://userscripts.org/scripts/source/166769.meta.js
// @downloadURL https://userscripts.org/scripts/source/166769.user.js
// @include http://*/*
// @include https://*/*
...
(function() {
    ...
    YoukuAntiAds.prototype = {
        ...
        get players() {
            if(!this._players) {
                this._players = {
                    'youku': 'http://catcat:520/AntiFlashAd/loader.swf',
                    'ku6': 'http://catcat:520/AntiFlashAd/ku6.swf',
                    'iqiyi': 'http://catcat:520/AntiFlashAd/iqiyi.swf',
                    'iqiyi5': 'http://catcat:520/AntiFlashAd/iqiyi5.swf',
                    'tudou': 'http://catcat:520/AntiFlashAd/tudou.swf',
                    'tudou_olc': 'http://catcat:520/AntiFlashAd/olc_8.swf',
                    'tudou_sp': 'http://catcat:520/AntiFlashAd/sp.swf'
                };
            }
        ...
        initPreHandlers: function() {
            ...
            this.rules['tudou_out']['preHandle'] = function(elem, find, replace, player) {
                ...
                GM_xmlhttpRequest({
                    ...
                    url: isFx ? player : 'https://query.yahooapis.com/v1/public/yql?format=json&q=' + encodeURIComponent('use"http://catcat:520/AntiFlashAd/tudou_redirect.yql.xml" as tudou; select * from tudou where url="' + player + '" and referer="' + window.location.href + '"'),
