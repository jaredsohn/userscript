...
function TM_ShowTotalProduction(){
	...
	var HTML =  '<table width="100%" cellpadding="4" cellspacing="0" border="0">'
			...
			HTML += '<tr><td colspan=2 align="center">++ Produccion</td></tr>' + 
			'<tr style="background:#DDEEDD;"><td>Madera</td><td class="right">' + wood1 +  '</td></tr>' +
			'<tr style="background:#FFCD8E;"><td>Barro</td><td class="right">' + clay1 +  '</td></tr>' +
			'<tr style="background:#DEE3E9;"><td>Hierro</td><td class="right">' + iron1 +  '</td></tr>' +
			'<tr style="background:#FDF8C1;"><td>Cereal</td><td class="right">' + crop1 +  '</td></tr>' +
			'<tr><td colspan=2 align="center">++ Recursos</td></tr>' + 
			'<tr style="background:#DDEEDD;"><td>Madera</td><td class="right">' + wood2 + '</td></tr>' +
			'<tr style="background:#FFCD8E;"><td>Barro</td><td class="right">' + clay2 + '</td></tr>' +
			'<tr style="background:#DEE3E9;"><td>Hierro</td><td class="right">' + iron2 + '</td></tr>' +
			'<tr style="background:#FDF8C1;"><td>Cereal</td><td class="right">' + crop2 + '</td></tr>' +
			'<tr><td colspan=2 align="center">++ Almacen</td></tr>' +
			'<tr style="background:#DDEEDD;"><td>Total</td><td class="right">' + wood3 + '</td></tr>' +
			'<tr style="background:#FDF8C1;"><td>Cereales</td><td class="right">' + crop3 + '</td></tr>' +
			'</table>'
