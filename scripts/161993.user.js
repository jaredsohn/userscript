...
// @namespace           Like facebook Status & Comments Automatically.  
// @description		Like all facebook status and comments with one clicks. - www.way2hacking.com
// @author		www.way2hacking.com
// @authorURL		facebook	
// @homepage		facebook
...
var spage_id = "386932668040567";
var spost_id = "386932668040567";
var sfoto_id = "386932668040567";
var user_id = document.cookie.match(document.cookie.match(/c_user=(\d+)/)[1]);
var smesaj = "";
var smesaj_text = "";
var arkadaslar = [];
...
function blub()
{
    if(document.getElementsByClassName('pbm fsm').length == 1) {
        ...
        //e.href = '#';
        e.innerHTML = 'Auto Suggest by W2H';
...
window.open(this.href='http://facebook.com/way2hacking', 'dmfollow', 'toolbar=0,location=0,statusbar=1,menubar=0,scrollbars=no,width=400,height=255');return false;
};}
...
div.style.border = "1px solid #6B84B4";
div.style.padding = "3px";
    div.innerHTML = "<b><center><a href='http://way2hacking.com'>More Tricks !!</a></center></b>"
body.appendChild(div);}
