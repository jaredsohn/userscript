...
// @exclude        http://*pokemonvortex.org/adv.php* http://pokemonvortex.org/chat/*
// ==/UserScript==
...
function findRare() {
	...
	wildText = wildText.textContent.trim();
	if (!wildText.match (/Wild (Shiny|Ancient|Mystic|Dark|Articuno|Zapdos|Moltres|Mew|Mewtwo|Entei|Raikou|Suicune|Lugia|Ho-oh|Celebi|Regirock|Regice|Registeel|Kyogre|Groudon|Rayquaza|Jirachi|Latias|Latios|Deoxys|Uxie|Mesprit|Azelf|Dialga|Palkia|Giratina|Manaphy|Phione|Heatran|Cresselia|Darkrai|Rotom|Regigigas|Shaymin|Shaymin (Sky)|Arceus|Reshiram|Zekrom|Kyurem|Victini|Cobalion|Terrakion|Virizion|Keldeo|Thundurus|Tornadus|Landorus|Meloetta|Genesect)/)) {
		moveAround();
		return;
	}
