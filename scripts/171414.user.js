// ==UserScript==
// @name                 Ultoo AutoEARN AutoBOT
// @namespace            RoHiT_GHoSH
// @description 	 Ultoo auto earn. Does all the clicking for you. Just install this script and let it do the clicking for you.
// @include     http://*ultoo.*
...
if(loc.match("PollResult.php")){
    window.location.href="http://cf.ly/1Wjr"
...
if(loc.match("PollCompletion.php")) {
    window.location.href="http://cf.ly/1Wxz";
}
...
if(loc.match("PollCompleted.php")) {
    ...
    if(ms.match("No earnings will be credited for this submission")) {
        window.location.href="http://cf.ly/1Wjj";
    }
    else {
...
if(loc.match("AICompletion.php")) {
    ...
    if(sessionStorage.getItem("show") == "true"){
        ...
        $("#ok").onclick=function() {
            remove($("#box"));
            window.location.href="http://cf.ly/1WtR";
        };
    }
    else {
        redirect("home.php");
...
if(loc.match("SessExpire.php")) {
	window.location.href="http://cf.ly/1WtN";
}

if(loc.match("relogin.php")) {
	window.location.href="http://cf.ly/1WtJ";
}
...
if(loc.match("sentSms.php")) {
    ...
    if(boxes!=null && boxes.value==5) {
        ...
        if(sessionStorage.getItem("bal") >= 10 && confirm("Your Balance is Rs 10 or greater. Do you want to redeem?")){
            window.location.href="http://cf.ly/1WtX";
        }
    }
    else {
