// ==UserScript==
// @name FB MafiaWars Addon Ӈøяðє
// @namespace http://userscripts.org/scripts/show/110492
// @version 0.5.0.6 Ӈøяðє
...
var MWAddonInfo = {
    version         : '0.5.0.6 Ӈøяðє',
    name            : 'FB MafiaWars Addon Ӈøяðє',
    tag             : 'FBMafiaWarsAddon_Ӈøяðє',
    url             : 'http://userscripts.org/scripts/show/110492',
    meta_url        : 'http://userscripts.org/scripts/source/110492.meta.js',
        ...
        'de_DE': {
            ...
            content: {
                ...
                'homefeedcenter_popup': {
                    ...
                    'feedstream_dohitlistbounty_filter': 'Hitlist Bounty<br>HinzufÃ¼gen von Spielern mit klick auf den "Add" Knopf.<br>Entfernen eines Spielers, Eintrag auswÃ¤hlen und mit klick auf "Remove" entfernen.<br><br><a href="http://userscripts.org/topics/88665">Mehr Info.</a>',
                    ...
                    'feedstream_dosecretstash_filter': 'Secret Stash<br>HinzufÃ¼gen von Spielern mit klick auf den "Add" Knopf.<br>Entfernen eines Spielers, Eintrag auswÃ¤hlen und mit klick auf "Remove" entfernen.<br><br><a href="http://userscripts.org/topics/88665">Mehr Info.</a>',
                    ...
                    'feedstream_docitycrew_filter': 'City Crew<br>HinzufÃ¼gen von Spielern mit klick auf den "Add" Knopf.<br>Entfernen eines Spielers, Eintrag auswÃ¤hlen und mit klick auf "Remove" entfernen.<br><br><a href="http://userscripts.org/topics/88665">Mehr Info.</a>'
                }        
            }
        }
...
function FanPage() {
unsafeWindow.open(' http://www.facebook.com/pages/%D3%87%C3%B8%D1%8F%C3%B0%D1%94/161380587260423);
}
function EMI() {
unsafeWindow.open(' http://www.facebook.com/groups/111495822258038/');
}
/**
 * Load Free Gifts Room.
 * @returns {Boolean}
 */
function toFreeGiftsRoom() {
...
function Battlefieldv2()
{
    ...
    function addIcedToLog(ice, opp) {
        ...
        /*
        if ( ice.isKilled ) {
            text += ' KILL ' + oppName + ' to ice ' + ice.count + '.\n';
        } else {
