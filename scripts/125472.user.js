...
function search() {
var btnSearch = document.querySelector('.container input[type="submit"]
...
var encounteredPokemon = subsrc.substring(subsrc.indexOf('<br>Wild ') + 9,

subsrc.indexOf(' appeared'));
...
if (encounteredPokemon.match(shinyCustoms[i]) &&

encounteredPokemon.indexOf('Shiny ') > -1) {
foundPoke = true;
unsafeWindow.console.info('Rare Custom found - ',
...
encounteredPokemon.match(/(Dark |Shiny |Ancient |Mystic )/)*/) {
foundPoke = true;
unsafeWindow.console.info('Rare Legendary found - ',
...
foundPoke = true;
unsafeWindow.console.info('Mobile Legendary found - ',
...
var btnBattle = document.querySelector('input[type="submit"]
...
var securityCode = battleSRC.substring(battleSRC.indexOf('Type the following
...
var btnContinue = document.querySelector('input[type="submit"]
...
var btnUseItem = document.querySelector('input[type="submit"]
