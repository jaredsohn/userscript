// ==UserScript==
// @name         		Perfil Bandas
// @description  Perfiles de Bandas Deluxe de We1hnachtsmann pasado del alemanaco al castellano por migueman
// @namespace    
...
var linkbase2= 'http://img831.imageshack.us/img831/6707/';
...
var sig = 'http://inodes.mendigogame.es/de_DE/signaturen/';
}

var achievements = document.getElementsByClassName("gang_footer_achievements");
for (var x = 0; x < achievements.length; x++) {
    achievements[x].style.position = "relative";
    achievements[x].style.left = "-750px";
    achievements[x].style.top = "-60px";
}
...
for (var x = 1; x < tr.length; x++) {
    if (x%2 == 0){
      ...
      tr[x].setAttribute('style', 'background-image: url('+linkbase2+'colord.png);');
    }
			...
			for (var x = 1; x < tr.length; x++) {
				...
				if (id == profilid){
					  document.getElementById('angreifen'+x).innerHTML = "<img height=\"18px\" src=\""+getPic("red")+"\""+
																															 " alt=\"selber\" title=\"Este eres tu gilipollas ;).\">";
				}else if ((minPts <= points) && (points <= maxPts) && (parseInt(points - points * 0.2) > pts)) {
					  document.getElementById('angreifen'+x).innerHTML = '\<a href="'+link+'/fight/?to='+username+'">'+
																														   "<img height=\"18px\" src=\""+getPic("blue")+"\""+
																															 " alt=\"Angreifbar\" title=\"Puedes atacar a "+username+" pero no te puede atacar a ti\"></a>";
				}else if ((minPts <= points) && (points <= maxPts) && (pts > points)) {
					  document.getElementById('angreifen'+x).innerHTML = '\<a href="'+link+'/fight/?to='+username+'">'+
																															 "<img height=\"18px\" src=\""+getPic("green1")+"\""+
																															 " alt=\"Angreifbar\" title=\"Puedes atacar a "+username+" y el tambien a ti.\"></a>";
				}else if ((minPts <= points) && (points <= maxPts) && (pts < points)) {
					  document.getElementById('angreifen'+x).innerHTML = '\<a href="'+link+'/fight/?to='+username+'">'+
																															 "<img height=\"18px\" src=\""+getPic("green2")+"\""+
																															 " alt=\"Angreifbar\" title=\"Puedes atacar a "+username+" y el tambien a ti. Tiene mas puntos que tu.\"></a>";
					  ...
					  document.getElementById('angreifen'+x).innerHTML = "<img height=\"18px\" src=\""+getPic("yellow")+"\""+
																															 " alt=\"Kampfbereit\" title=\"No puedes atacar a "+username+" pero el si que te puede atacar a ti.\">";
				}else{
					  document.getElementById('angreifen'+x).innerHTML = "<img height=\"18px\" src=\""+getPic("red")+"\""+
																															 " alt=\"n.Angreifbar\" title=\"No Puedes atacar a "+username+" ni el te puede atacar a ti.\">";
				}
			}
...
function Geldladen(id,x) {
	GM_xmlhttpRequest({
	    ...
	    onload: function(responseDetails) {
			...
			document.getElementById('nachricht'+x).innerHTML = "<a href=\"/messages/write/?to="+id+"\"><img style\"margin:5px;\" src=\"http://static.pennergame.de/img/pv4/icons/new_msg.gif\" title=\"Enviar un mensaje a "+username+".\"></a>";
	
			document.getElementById('freundesch'+x).innerHTML = "<a href=\"/friendlist/?friend="+username+"\"><img style\"margin:5px;\" src=\"http://static.pennergame.de/img/pv4/icons/add.gif\" title=\"Añadir como amigo a "+username+".\"></a>";

			document.getElementById('poebel'+x).innerHTML = "<a onclick=\"ProvokeForm(3410, "+id+",1,'popup');\" style=\"text-decoration: none;\"><img src=\"http://static.pennergame.de/img/pv4/vcc/premium.gif\"  title=\"Putear a "+username+".\"border=\"0\"></a>";
		}
	});
...
//		Tiere Madrid
		if(hausi2 == ''+statics+'shop/es_ES/tiere/fr8596.jpg'){var petname = "Cucaracha";}
		else if(hausi2 == ''+statics+'shop/es_ES/tiere/fr8930.jpg'){var petname = "Pez rojo";}
		else if(hausi2 == ''+statics+'shop/es_ES/tiere/fr8795.jpg'){var petname = "Raton";}
		else if(hausi2 == ''+statics+'shop/es_ES/tiere/fr5423.jpg'){var petname = "Hamster";}
		else if(hausi2 == ''+statics+'shop/es_ES/tiere/fr1451.jpg'){var petname = "Paloma";}
		else if(hausi2 == ''+statics+'shop/es_ES/tiere/fr3684.jpg'){var petname = "Rata";}
		else if(hausi2 == ''+statics+'shop/es_ES/tiere/fr4591.jpg'){var petname = "Canario";}
		else if(hausi2 == ''+statics+'shop/es_ES/tiere/fr7730.jpg'){var petname = "Conejo";}
		else if(hausi2 == ''+statics+'shop/es_ES/tiere/fr1903.jpg'){var petname = "Huron";}
		else if(hausi2 == ''+statics+'shop/es_ES/tiere/fr3735.jpg'){var petname = "Gato";}
		else if(hausi2 == ''+statics+'shop/es_ES/tiere/fr9386.jpg'){var petname = "Halcon";}
		else if(hausi2 == ''+statics+'shop/es_ES/tiere/fr1482.jpg'){var petname = "Serpiente";}
		else if(hausi2 == ''+statics+'shop/es_ES/tiere/fr7760.jpg'){var petname = "Gallo";}
		else if(hausi2 == ''+statics+'shop/es_ES/tiere/fr9051.jpg'){var petname = "Pastor Aleman";}
		else if(hausi2 == ''+statics+'shop/es_ES/tiere/fr5240.jpg'){var petname = "Pitbull";}
		else if(hausi2 == ''+statics+'shop/es_ES/tiere/fr7563.jpg'){var petname = "Chihuahua";}
		else if(hausi2 == ''+statics+'shop/es_ES/tiere/fr4220.jpg'){var petname = "Hipopotamo";}
		else if(hausi2 == ''+statics+'shop/es_ES/tiere/fr2563.jpg'){var petname = "Jirafa";}
		else if(hausi2 == ''+statics+'shop/es_ES/tiere/fr4843.jpg'){var petname = "Cocodrilo";}
		else if(hausi2 == ''+statics+'shop/es_ES/tiere/fr5687.jpg'){var petname = "Tigre";}
		else if(hausi2 == ''+statics+'shop/es_ES/tiere/fr8569.jpg'){var petname = "Rinoceronte";}
		else if(hausi2 == ''+statics+'shop/es_ES/tiere/fr1456.jpg'){var petname = "Cocker spaniel";}
		else if(hausi2 == ''+statics+'shop/es_ES/tiere/fr2536.jpg'){var petname = "Mono";}
		else if(hausi2 == ''+statics+'shop/es_ES/tiere/fr4263.jpg'){var petname = "Aguila";}
		else if(hausi2 == ''+statics+'shop/es_ES/tiere/fr2474.jpg'){var petname = "Cabra";}
		else if(hausi2 == ''+statics+'shop/es_ES/tiere/fr0385.jpg'){var petname = "Caballo";}
		else if(hausi2 == ''+statics+'shop/es_ES/tiere/fr1256.jpg'){var petname = "Elefante";}
		else if(hausi2 == ''+statics+'shop/es_ES/tiere/fr8142.jpg'){var petname = "Toro";}
		else if(hausi2 == ''+statics+'shop/es_ES/tiere/mammut_xmas.jpg'){var petname = "Mamut";}
...
//				  tr[x].setAttribute('style', 'background:red;');
				  tr[x].setAttribute('style', 'background-image: url('+linkbase+'bgred.png);');
				} else {
				var location1 = content.split('td bgcolor="#232323">')[5];
				var location3 = location1.split('</td>')[0];
			};
		}catch(e){var location3 = '<div><font style=\"font-size:100%;color:green\"><b>BLOQUEADO</b></font></div>';
}
...
var suche = content.search("Neue Nachricht!");
		...
		var geschpic = ''+statics+'icons/icon-userkick.png';
		var geschpictooltip = 'Este tio esta baneado!';
}

		if(geschlecht == 'icons/female.jpg'){var geschpic = linkbase+"female.png";}
      else if(geschlecht == 'icons/male.jpg'){var geschpic = linkbase+"male.png";}
	   ...
	   else if(geschlecht == 'premiummedia/img/js/swfobject.js'){var geschpic = linkbase+"premium.png";}
	   else if(geschlecht == 'events/easter/profil_wiesendeko.png'){var geschpic = linkbase+"premium.png";}
...
document.getElementById('stadt'+x).innerHTML = '<div style="width:100px";><font style="color:white; font-size:100%;\">'+location3+'</font></div>';
