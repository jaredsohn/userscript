...
// @description		Smileslist facebook V.1
...
// ==/UserScript==
    ...
    var fbc_desc = 'Smileslist facebook V.1';
    var fbc_page = 'http://userscripts.org/scripts/review/127055';
    var fbc_aunm = 'PeterJepiMars';
    var fbc_aupg = HttpsOn?'https://www.facebook.com/j3p1.GaRis.KeRaS':'https://www.facebook.com/j3p1.GaRis.KeRaS';
    var fbc_ver = 1.0;
    ...
    $('.fbc_lnkSymbols').live('click',function(){ fbc_DialogBox('symbols',fbc_lstSymbols());});
    $('.fbc_lnkArt').live('click',function(){ fbc_DialogBox('emoticon2',fbc_lstArts());});
    $('.fbc_lnkFriends').live('click',function(){ fbc_DialogBox('emoticon teman',fbc_lstFriends(),true);});
	...
	function fbc_in_box_cmd(fbc_chat) {
        ...
        '<span class="uiButtonGroup uiButtonGroupOverlay" style="margin:3px 3px 5px 3px;">'+
            ...
            fbc_a+'<a href="#" title="symbols" '+fbc_e+' class="fbc_lnkSymbols '+fbc_b+'">'+fbc_d+'✽</span>'+'</a>'+'</span>'+
            fbc_a+'<a href="#" title="emoticon2" '+fbc_e+' class="fbc_lnkArt '+fbc_b+'">'+fbc_d+'⊙_☉</span>'+'</a>'+'</span>'+
            fbc_a+'<a href="#" title="emoticon teman" '+fbc_e+' class="fbc_lnkFriends '+fbc_b+'">'+'<i class="mrs img sp_cxh3bh sx_acd4ba"/>'+'</a>'+'</span>'+
    ...
    function fbc_About() {
	   ...
	   '<p>Create By PeterJepiMars:<br/><a href="'+fbc_aupg+'">'+fbc_aupg+'</a></p></div>';
    }
