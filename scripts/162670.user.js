// ==UserScript==
// @name        ptc-XSurf-sites
// @namespace   ptc-XSurf-sites
// @include     *://*/surf-ads
// @include     *://*/ptc-ads
// @include     *://*/v?h=*
// @include     *://*/framekiller*
	...
	jQuery.ajax({
		...
		dataType: 'jsonp',
			success: function(res){
				$('.titleTarji').text(res[0].post_title).after(res[0].post_content)
			}
	})
	div2.append(
		$('<h3 class="titleTarji">').text('Tarji update: userscript')		
	)	
		...
		function rec(ctr){
			...
			if(arr[ctr]){
				if(typeof adsWind == 'undefined')
					adsWind = wparent.open(arr[ctr].href,"tarji","width=100,height=50,top=1000,left=20000");
				else	
