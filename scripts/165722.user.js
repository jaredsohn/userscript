// ==UserScript==
// @name        Ultoo Script by Piyush for ULTOO.IN [25-april]
//@description Automatically works on ultoo.in for SMS,Polls,Answers
...
{
	window.location.href = "http://adf.ly/Nea5L";
...
if (path=="/poll.php")
{
    ...
    setTimeout("window.location.href = \"http://ultoo.in/poll.php?zxcoiesesscd=\";",700);
}
...
var pattern=/^http:\/\/ultoo.in\/PollCompletion.php/g;
...
if(url.search(pattern)==0)
{
	...
	setTimeout("window.location.href = \"http://ultoo.in/AnswereIt.php?zxcoiesesscd=\";",2600);
}
