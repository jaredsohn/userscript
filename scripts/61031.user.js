...
// @creator        xXREDFOXx (Andres Ramirez) ® 2009
// ==/UserScript==

// **COPYRIGHT NOTICE**
//
//    "BBCoder en Comentarios para T! y P!" Copyright (C) 2008-2009 Andres Ramires
//
...
var CambiarTheme = GM_getValue("CambiarTheme",true);
	...
	GM_registerMenuCommand("BBCoder para Taringa  xXREDFOXx- Reinicializar Valores", function() {
	...
	GM_registerMenuCommand("BBCoder para Taringa - Reportar BUG o Sugerencia", function() {
		GM_openInTab("http://www.taringa.net/mensajes/a/ xXREDFOXx");
	},null,null,"B");
...
function CrearBarraBBC(){
		...
		var nuevaHTML = "<div id=' xXREDFOXx_TaringaBBC' style='display:block;'>";
...
function  xXREDFOXx_TopPost(alcargar,t,p){
	/** Que raro que Taringa! desactivó  =) **/
	/*var tiempo = -1;
	var posts = -1;
	var maspunt;
	var mascoment;
	...
	html += '		</select>';
	html += '		<input id="Btn_Filtrar_Tops" type="button" title="Filtrar Top Posts" value="Filtrar -  xXREDFOXx®" style="font-size: 12px; width: 200px;" class="login"/><br/>';
...
function CrearBarraEmoticones(){
	GM_addStyle(". xXREDFOXxEmoticones img {max-width:40px;max-height:40px;}");
	var URLtaringa = 'http://i.t.net.ar/images/smiles/';
	var nuevaHTML = '<div id="Sharkale_TaringaEmoticones" align="center" class=" xXREDFOXxEmoticones" style="display:'+(EmotVis == true || path == "mensajes"? 'block':'none')+'">';
...
function  xXREDFOXx_Opciones(){
	if($('# xXREDFOXxOpciones').length != 0){
		$('# xXREDFOXxOpciones').remove();
	}
	var div = document.createElement('div');
	div.setAttribute('id', ' xXREDFOXxOpciones');
	...
	$('body').before(div);
	$('#ajaxdiv').remove();
	try{$('#SharkaleOpciones').dialog({title: 'Opciones Avanzadas del Script -  xXREDFOXx®',width: 900, modal: true, position:['center',30], resizable: false, draggable: false });}catch(e){};
