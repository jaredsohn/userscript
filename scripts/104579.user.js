...
// ==UserScript==
// @name           Caylak++
// @description    Turlu cinliklerle Caylaklar Sozluk'u guzellestirme aparati. Donuz dusmani!
// @namespace      http://userscripts.org/users/ntpl
// @version        0.5.1.1
// @author         ocanal
// @license        GPL v3 or later; http://www.gnu.org/licenses/gpl.html
// @include        http://www.caylaklarsozluk.com/*
// @include        http://caylaklarsozluk.com/*
// ==/UserScript==
...
//--// FONKSIYONLAR, ISLEMLER, EMEKCILER //-//
    ...
    function ayarMenusunuGoster() {
        ...
        "<h1 class='title' style='text-align:center;'><a><b>Caylak++ Ayar Paneli</b></a></h1>"+
        ...
        "<fieldset style='padding-left:1em;'>"+
            ...
            "Yasakli kelimelere <b>ekle</b> <input id='epp_yasakBaslikEkleVal' type='text' style='min-width: 20em;'> <button class='but' id='epp_yasakBaslikEkleBut'>Ekle</button> (<a href='sozluk.php?process=word&q=regular+expression'>regular expression</a>'dir aslen, kullaniniz)<br/><br/>"+
        ...
        "<fieldset style='padding-left:1em;'>"+
            ...
            "<br/>"+
            "<input id='epp_solFrameMenusuCB' type='checkbox'> <b>Sol frame menusunu (o_0)</b> goster (neler donmus serhat, gunun onemi ve otomatik yenileme menusu) "+"<b style='color:red'></b>"+"<br/><br/>"+
			...
			"<input id='epp_donBebegimCB' type='hidden'>"+
            ...
            "<input id='epp_cokHeyecanliCB' type='checkbox'> <b>Cok heyecanli</b> sistemini kullan (basliga girilen yeni entry'leri takip kolayligi saglar) "+"<b style='color:red'></b>"+"<br/><br/>"+
            "<input id='epp_iframeGosterCB' type='checkbox'> <b>iFrame tusu</b>nu goster (duz basliklara sol ve ust frame'leri ekler) "+"<b style='color:red'></b>"+"<br/><br/>"+
            "<input id='epp_tezgetirGosterCB' type='checkbox'> <b>Tez getir</b> sistemini kullan (baslik sayfasindan baslik aramaya izin verir) "+"<b style='color:red'></b>"+"<br/><br/>"+
            "<input id='epp_konuluEntryIsaretleCB' type='checkbox'> Konulu entry'leri <b>isaretle</b> (kit veya tumunu goster ile gelinen sayfalarda, asil entry'yi isaretler) "+"<b style='color:red'></b>"+"<br/><br/>"+
            "<input id='epp_konuluEntryHizalaCB' type='checkbox'> Konulu entry'leri <b>basa hizala</b> (kit veya tumunu goster ile gelinen sayfalarda, ekrani asil entry'ye kadar kaydirir) "+"<b style='color:red'></b>"+"<br/><br/>"+
            "<input id='epp_turkiyeSaatiniKullanCB' type='checkbox'> Tarih/saat islemleri icin <b>Turkiye saatini kullan</b> (Serhat ve gunun onemi fonksiyonlari icin anlamli) "+"<b style='color:red'></b>"+"<br/><br/>"+
        "</fieldset><br/><br/>"+
        ...
        var cokHeyecanliCB = idGet("epp_cokHeyecanliCB");
        ...
        cokHeyecanliCB.checked = Ayarlar.cokHeyecanli;
        ...
        donuzSyncBut.addEventListener("click", function(){
            if (Ayarlar.eppDonuzSyncID) {
                ...
                if (confirm("Ilk defa senkronizasyon kullaniyorsunuz; verilerinizin, yalnizca senkronizasyon amaciyla, Caylak++ serverlarinda saklanmasina izin veriyor musunuz?")) {
        ...
        cokHeyecanliCB.addEventListener("change", function(){ 
            tumAyarlariYukle();
            Ayarlar.cokHeyecanli = this.checked;
            tumAyarlariKaydet();
            ayarMenusuDerki("'Cok heyacanli' sistemi <b>"+(this.checked?"aktif":"devre disi")+"</b>!", 4);
        }, true);
        ...
        if (!reklamCss) {
            ...
            if (bugun != enSon) {
                ...
                if (donBebegimTusu) { 
                    ...
                    donBebegimTusu.parentNode.innerHTML = "<b>Caylak++:</b><br/> Bugun daha once 'don bebegim' yapanlara ikinci 'don bebegim' bizden!<br/> Iyi seyirler!<br/><br/>";
                }
    ...
    function yeniEksiLinki(tip, nereye, yazi, title, acma, kapama, wrapper) {
        ...
        yazi = (typeof(yazi) != "undefined") ? yazi : "Caylak++";
    ...
    function entryGetir(entryUrl) {
        ...
        if (entryler.length) {
            ...
            var yazarID = xpath("./font/div/a/font",entryler[0]).snapshotItem(0).innerHTML;
            ...
            var eksiTuslari =  '<table style="float: right; margin-top: 0.5em;"><tbody><tr><td style="white-space: nowrap;" id="vst__ENTRY-ID__" class="ei">&nbsp;</td>\
                                    <td><span id="suk__ENTRY-ID__" class=but onclick="voting_caylak(__ENTRY-ID__,\'arti\',\'suk__ENTRY-ID__\')"  title=iyi onmouseout=bn(this) onmouseover=ov(this) onmouseup=bn(this) onmousedown=md(this)> &nbsp;:)&nbsp;</span></td>\
                                    <td><span id="kot__ENTRY-ID__" class=but onclick="voting_caylak(__ENTRY-ID__,\'eksi\',\'kot__ENTRY-ID__\')" title=k&ouml;t&uuml; onmouseout=bn(this) onmouseover=ov(this) onmouseup=bn(this) onmousedown=md(this)> &nbsp;:(&nbsp;</span></td>\
                                    <td>&nbsp;</td>\
                                    <td><span class=but onclick="od(\'sozluk.php?process=privmsg&islem=yenimsj&gkime=__YAZAR-ID__&txt=__ENTRY-ID__\',400,300)" title=msg onmouseout=bn(this) onmouseover=ov(this) onmouseup=bn(this) onmousedown=md(this) > &nbsp;msg&nbsp;</span></td>\
                                    <td><span class=but onclick="od(\'sozluk.php?process=ben&kim=__YAZAR-ID__\',400,400)" title="nasil bir &ccedil;aylak" onmouseout=bn(this) onmouseover=ov(this) onmouseup=bn(this) onmousedown=md(this)> &nbsp;?&nbsp;</span></td>\
                                </tr></tbody></table>';
            ...
            result = "<h2 class='title'>" + baslik.innerHTML + 
                         "<sup><a href='sozluk.php?process=word&q="+escape(baslik.textContent).replace(/[']/g,"%27").replace("%u015F","%FE").replace("%011F","%F0").replace("%u0131","%FD")+"' title='basliga git' target='_blank' style='text-decoration:underline;'>git</a></sup>"+
                         "<sup><a href='sozluk.php?process=word&q="+escape(baslik.textContent).replace(/[']/g,"%27").replace("%u015F","%FE").replace("%011F","%F0").replace("%u0131","%FD")+"&i="+entryID+"' title='konulu git' target='_blank' style='text-decoration:underline; margin-left:.5em;'>kit</a></sup>"+
                     "</h2>";
            ...
            result = "<b>Caylak++</b> Sozluk cok acayip bir seyler dondu, bilemedim!";
        }
        return result;
    }
    ...
    function entryGomucu(entryLinki) {
        if (!entryLinki.getAttribute("entryGomulu")) {
            ...
            //entryUrl = entryUrl.replace("caylaklarsozluk.com","www.caylaklarsozluk.com"); //Domain degisikligi onlemi
            ...
            entryBox.innerHTML = "<b>Caylak++</b> Bir seyler geliyor... ";
            ...
            if (entryHTML) {
                ...
                entryBox.innerHTML = "<b>Caylak++</b> Yokmus ki boyle bir entry!";
    ...
    function gomulebilirEntryleriDuzenle() {
        ...
        for (var i=0; i<length; i++) {
            ...
            } else if (link.href.match(/^http:\/\/(caylaklarsozluk\.com|www\.caylaklarsozluk\.com)\/sozluk\.php\?process=eid&eid=\d+/)) {
                link.style.textDecoration = "underline";
                link.addEventListener("click", (function(pLink) { return function(e){ 
                    if (!e.ctrlKey) { 
                        entryGomucu(pLink); 
 ...
 /*
    ...
    function AyarMerkeziEngine() {
        ...
        function mesajlariDuzenle() {
            ...
            if (!idGet("panel"))
                return; // Mesaj kutusunda degiliz sanki?
        ...
        function malSevkiyatiSistemiKur() {
            ...
            ozAyarMenusuBaslik.innerHTML = "<b>Caylak++ Donuz Listesi Islemleri</b>";
...
*/
    ...
    function UstFrameEngine() {
        ...
        function guncellemePaneli(yeniSurum) {                           
            ...
            '<a style="padding:2px 1em; margin:0 2em 0 1em;" class="but" href="http://userscripts.org/scripts/source/'+meta.id+'.user.js" target="_blank" title="Hanim kos guncelleme olmus!" onmouseout="bn(this)" onmouseover="ov(this)" onmouseup="bn(this)" onmousedown="md(this)" id="">Ersin Ozbukey ile Guncelli-yorum!</a>'+
            "";
    ...
    */
    ...
    function SolFrameEngine() {        
        ...
        function baslikFiltresi(baslik) {
			...
			//var spanref = baslik.parentNode.getElementsByTagName("span")[0];
			//var bid = spanref.id.toString().replace("m","");
			var bid = baslik.id;
            var baslikRef = baslik;
            this.basla = function () {
                var adres = "http://www.caylaklarsozluk.com/sozluk.php?process=caylakartiarti&id="+bid;
                ...
                req.onreadystatechange = function () {
                    if (this.readyState == 4) {
                        ...
                        var girdiler = xpath("./span", baslikDoc);
                        if (girdiler.snapshotLength > 0) {
                            ...
                            if (isDonuz(ilkSuser)) {
                                ...
                                alalimArkadasi(baslikRef.parentNode.parentNode);
                                baslikRef.parentNode.parentNode.setAttribute("epp_donuz", ilkSuser);
                            } else {
                ...
                if (proxyResp) {
                    for (var proxyBaslik in proxyResp) {
                        if (baslik.innerHTML == proxyBaslik) {
                            ...
                            if(0 == 1){ //if (proxyResp[proxyBaslik]) {       
            ...
            for (var i=0; i<basliklar.snapshotLength; i++) {
                ...
                for (var j in Ayarlar.yasakliRegexListesi) {
                    ...
                    if (re.test(baslikStr)) {
                        alalimArkadasi(baslik.parentNode.parentNode);
                        baslik.parentNode.parentNode.setAttribute("epp_yasakli", "true");
        ...
        function basliklariDuzenle() {
            ...
            baslikListesi = xpath("//table[@id='basliklar']/tbody/tr", document);
            if (!baslikListesi.snapshotItem(0))  return;
            basliklar = xpath("//table[@id='basliklar']/tbody/tr/td/a",document);
        ...
        function arayuzElemanlariniEkle() {
            if (Ayarlar.solFrameMenusu) {
                ...
                gundemTusu.addEventListener("click",function(){
                    ...
                    window.location.href = 'sozluk.php?process=gundem';
                },false);
                ...
                gununOnemiTusu.addEventListener("click",function(){
                    ...
                    var day = turkeyTime.getDate();
                    var year = turkeyTime.getFullYear();
                    window.location.href ="sozluk.php?process=new_search&kw="+day+"+"+month+"+"+year+"&n=ss&sr=a&d=&m=&y=";
                },false);
    ...
    function SagFrameEngine() {
        ...
        function spoilerHazirla(nodes, spBas, spSon) {
            ...
            spoilerWrapper.innerHTML = "(( <a class='gb' href='sozluk.php?process=word&q=spoiler'>spoiler</a>! )) &nbsp;";
        ...
        function donuzTusuEkle(pGirdi, pYazar) {
            var gizliKutu = xpath("./div/font/div/table/tbody/tr", pGirdi).snapshotItem(0);
            /*
        ...
        function girdileriDuzenle() {
            ...
            for (var i = 0; i < girdiler.snapshotLength; i++) {
                ...
                var yazar = xpath("./div/a/font", girdi).snapshotItem(0).innerHTML; 
                ...
                if (!donuzGirdisiFiltrele(girdi, yazar)) {
                    ...
                    if(girdi.innerHTML.match(/spoiler.*spoiler/)) {
                        ...
                        spoilerFiltrele(xpath("./font",girdi).snapshotItem(0));
					}
        ...
        function onerileriBul() {
            ...
            var adresSablon = "sozluk.php?process=new_search&kw=__KW__&n=&sr=a&d=&m=&y=";
            ...
            req.onreadystatechange = (function (pArama) { return function() {
                if (this.readyState == 4) {
                    if (this.status == 200) {
						...
						var tempbasliks = xpath(".//table", tempDiv);
						var tempbaslik = tempbasliks.snapshotItem(tempbasliks.snapshotLength-1);
                        var basliklar = xpath(".//tbody/tr", tempbaslik);
                        for (var i = 0; i < basliklar.snapshotLength; i++) {
                            var basliks = basliklar.snapshotItem(i);
							var baslik = xpath(".//td",basliks).snapshotItem(1);
        ...
        function sonEntrylereYenile() {
            ...
            if (nextPageBut && nextPageBut.title.match(/sonraki/)) { //Sonraki sayfa varsa...
                ...
                var sonEntryId = sonEntry.id.replace(/\D/g,'');
                window.location.href = window.location.href.replace(/(&i=\d+|$)/,"&i="+sonEntryId+"&epp_ch=1");
            }
        }
        ...
        function frameSirinle() {
            ...
            rightFrame.id = "main";
            rightFrame.name = "main";
            rightFrame.style.position = "absolute";
            rightFrame.style.left = "250px";
            rightFrame.style.top = "100px";
            rightFrame.style.height = (window.innerHeight-100)+"px";
        ...
        function arayuzElemanlariniEkle() {
            ...
            ayarTusu.value = "Caylak++ Ayarlari";
            ...
            var tumunuGoster = 0; 
            var buttons = xpath("/html/body/div/button");
            ...
            //Canli goster tusu
            if (Ayarlar.cokHeyecanli && !window.location.href.match(/show\.asp\?.*&?id=(\d+)&?/)) {
                ...
                if (tumunuGoster) {
                    ...
                    var entryli = xpath("//ol/li",document);
					var entryOL = entryli.snapshotItem(entryli.snapshotLength-1);
        ...
        function konuluEntry() {
            if (window.location.href.match(/sozluk\.php\?process=(word|word_today).*&?i=(\d+)&?/)) {
                // Cok heyecanli ile mu gelinmis?
                var cokHeyecanli = window.location.href.match(/sozluk\.php\?process=(word|word_today).*&?epp_ch=1&?/);
                // Konulu entry nedir?
                var entryId = window.location.href.match(/sozluk\.php\?process=(word|word_today).*&?i=(\d+)&?/)[2];
                var entry = idGet(entryId);
                if (entry) {
    ...
    this.basla = function () {
       ...
       // EppAPI_runOnce(migrateToV05, "migrateToV05");
        ...
        if (window.location.href.match(/\/sozluk\.php\?process=top/)) {
            //aktifEngine = new UstFrameEngine();
        } else if (window.location.href.match(/\/sozluk\.php\?process=(today|gundem|ju|yesterday)/)) {
            aktifEngine = new SolFrameEngine();
        } else if (window.location.href.match(/\/sozluk\.php\?process=(word|word_today)/)) {
		...
		if (window.location.href.match(/\/sozluk\.php\?process=(word|word_today|eid)/)) {
