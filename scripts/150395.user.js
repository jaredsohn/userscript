// ==UserScript==
// @name           Xunlei.Fuck.Player
// @namespace      Xunlei.Fuck.Player
// @description    Xunlei.Fuck.Player, should be working on xlpan.com and can play any url as you wish.
...
// @updateURL      http://userscripts.org/scripts/source/150395.meta.js
// @downloadURL    http://userscripts.org/scripts/source/150395.user.js
// @version        0.45
// ==/UserScript==
...
(function(){
	'use strict';
	var CONSTANTS = {
		tips: '<div class="tips_container"><div class="tips_close">X</div>Xunlei.Fuck.Player \u5DF2\u542F\u7528&emsp;<a href="http://opengg.me/821/xunlei-any-player/" style="color:blue" target="_blank">\u53CD\u9988</a></div>',
				...
				UTILS.proxy(function(){
					function hack(){
						...
						if(XL_CLOUD_FX_INSTANCE){
							var queryBack = XL_CLOUD_FX_INSTANCE.queryBack;
							var queryOtherBack = XL_CLOUD_FX_INSTANCE.queryOtherBack;
							if(queryBack&&(queryBack.toString().indexOf('arguments')===-1)){
								XL_CLOUD_FX_INSTANCE.queryBack=function(){
									try{
										XL_CLOUD_FX_INSTANCE.userType=1;
									}catch(e){}
									queryBack.apply(XL_CLOUD_FX_INSTANCE,arguments);
								}
							}
							if(queryOtherBack&&(queryOtherBack.toString().indexOf('arguments')===-1)){
								XL_CLOUD_FX_INSTANCE.queryOtherBack=function(){
									try{
										XL_CLOUD_FX_INSTANCE.userType=1;
									}catch(e){}
									queryOtherBack.apply(XL_CLOUD_FX_INSTANCE,arguments);
								}
							}
						}
					}
