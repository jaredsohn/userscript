// ==UserScript==
// @name           Sparpa Templar Military Prospect
// @namespace      http://cvtm.forumfree.it/?f=6558936
// @icon           http://i44.tinypic.com/v4rok8.png
// @description    Voi venite in chat e il tool dello Sparpa vi dice quanti generali sono :) e quanto vi costa
// @include        http://cvtm.forumfree.it/?f=6558936
// ==/UserScript==
...
var nome='Sparpa Templarucci Military Project ';
var versione='0.5';
...
function sparpaMilitary(){if (!(document.getElementsByName('submit')[0]) ) {
		...
		titre.appendChild(document.createTextNode(nome+versione));
		var corps=document.createElement('div');
		corps.setAttribute('class','content');
		panel.appendChild(titre);
		panel.appendChild(corps);
		titre.setAttribute('style','text-align:center;margin: 0 auto 0 auto;');
