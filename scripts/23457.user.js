...
//
//
// StudiVZ - Bilder speichern VV2.0
// original script "SVZ Image Download" by Waldheinz
// modified by Varian Vega
//
// ==UserScript==
// @name           StudiVZ - Bilder speichern VV2.0
// @namespace      http://userscripts.org
// @version        VV2.0
// @date           2008-03-01
// @description    Erzeugt "Bild speichern"-Link unter den Fotos in der Einzelbildansicht
// @author         Varian Vega
// @include        http://*studivz.net/PhotoAlbums/Photo/*
// ==/UserScript==
//
// Changelog:
// VV2.0:    - initial release of modificated script version
//           - now working with the new StudiVZ layout
//           - download link repositioned and labeled
//
