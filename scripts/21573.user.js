// ==UserScript==
// @name            marcvz.net/blog/
// @namespace       Marc
// @include         http://marcvz.net/blog/*
function do_platypus_script() {
html_insert_it(window.document,document.evaluate('/HTML[1]/BODY[1]/DIV[1]/DIV[3]/UL[1]/LI[1]/DIV[1]/P[2]/IMG[1]', document, null, XPathResult.FIRST_ORDERED_NODE_TYPE,null).singleNodeValue,'<img src="http://www.sindhu-s.com/wp-content/uploads/2008/01/marc.jpg">',true,false);
html_insert_it(window.document,document.evaluate('/HTML[1]/BODY[1]/DIV[1]/DIV[3]/UL[1]/LI[1]/DIV[1]/P[2]/IMG[1]', document, null, XPathResult.FIRST_ORDERED_NODE_TYPE,null).singleNodeValue,'<center><img src="http://www.sindhu-s.com/wp-content/uploads/2008/01/marc.jpg"></center>',true,false);
smart_remove(window.document,document.evaluate('/HTML[1]/BODY[1]/DIV[1]/DIV[3]/UL[1]/LI[1]/DIV[1]/P[2]/SPAN[1]/IMG[1]', document, null, XPathResult.FIRST_ORDERED_NODE_TYPE,null).singleNodeValue,null,null,null);
smart_remove(window.document,document.evaluate('/HTML[1]/BODY[1]/DIV[1]/DIV[3]/UL[1]/LI[1]/DIV[1]/P[2]/IMG[1]', document, null, XPathResult.FIRST_ORDERED_NODE_TYPE,null).singleNodeValue,null,null,null);
}; // Ends do_platypus_script
window.addEventListener("load", function() { do_platypus_script() }, false);
//
//  Mon Dec 19 15:59:37 2005 -- Scott R. Turner
//  Modifies marc's blog's sidebar for a more pleasing visual experience.
//   
// 
