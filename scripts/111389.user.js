	...
	for (var i=0,l=div.length;i<l;i++){
		if (div[i].previousSibling.previousSibling.tagName=='B'){
			...
			while (it){
				if (items!="")
					items+='<br>';
				items+='&bull;&nbsp;<a href=http://www.ganjawars.ru/item.php?item_id='+it[1]+' style="font-size:3px;text-decoration:none;">'+it[2]+'</a>';
...
function showHint(obj,it){
	...
	div.innerHTML='<a href="http://www.ganjawars.ru/info.php?id='+it.id+'" style="font-size:3px;font-weight:bold;">'+it.nick+'</a>['+it.lvl+']<br>';
...
(function() {
	...
	addCss('.hint {position:absolute;float:left;background-color:#fff;border:1px #009900 dashed;font-size:3px;padding:3px;}');		
