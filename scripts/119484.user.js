...
// @name           Tumblr Savior
// @namespace      bjornstar
// @description    from ever having to see another post about certain things ever again
...
function needstobesaved(theStr){
  var blackList = new Array('TVD', 'The x-files', 'Fox Mulder', 'Dana Scully' 'personal', 'The Walking Dead', 'genevieve padalecki', 'American Horror Story', 'Lady Gaga', 'Rape', 'Destiel', 'Castiel', 'Sassy','Danneel Ackles');
