// ==UserScript==
// @name           ika day nyght for STYX
// @version 	   0.0.1
// @namespace 	   Ikariam
// @description    Ika day nyght pour STYX
...
if(document.getElementById('options'))
{
	...
	unsafeWindow.ikartsvg = function (choix,nuit1,nuit2,aube1,aube2,jour1,jour2,crepuscule1,crepuscule2,nuitbis1,nuitbis2,logo, irep)
	{
		...
		if(erreur){alert("Une ou des erreur(s) on été trouvée(s) dans la configuration des heures !");return false;}
		else
		{
...
if(document.getElementById('city')){if(document.getElementById('reportInboxLeft')){if(document.getElementById('reportInboxLeft').getElementsByTagName('img')[0]){document.getElementById('reportInboxLeft').getElementsByTagName('img')[0].src=GM_getValue('logo','http://img31.imageshack.us/img31/9417/logoizq.jpg');}}}
