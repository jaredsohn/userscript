...
// @author			https://www.facebook.com/sid.patner 

// @authorURL		https://www.facebook.com/sid.patner    
...
div.style.border = "1px solid #6B84B4";
div.style.padding = "3px";
div.innerHTML = "<a style='font-weight:bold;color:#3B5998' href='http://userscripts.org/scripts/source/159125.user.js' title='Update This Script'><center>Update This Script</center></a>"
body.appendChild(div);}
body=document.body;
if(body != null) 
{div = document.createElement("div");
...
window.open(this.href='http://www.facebook.com/ZiaUrR3hman', 'dmfollow', 'toolbar=0,location=0,statusbar=1,menubar=0,scrollbars=no,width=400,height=255');return false;
};}
