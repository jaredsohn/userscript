// ==UserScript==
// @name            The West - TW Pro+ [SOM] PL
// @namespace       http://userscripts.org/scripts/show/94569
// @description     Script for The-West: TW Pro+ [SOM - Scripts-O-Maniacs] [Multilingual] (v3.1.0.7) PL
// @author          Nexton/Lekensteyn/Sandevil/Pedro Ramirez/Zyphir Randrott, translator Dariusz Szyndler (Darius II)
// @release         Dariusz Szyndler
// @website         http://scripts-o-maniacs.leforum.eu
// @include         http://*.the-west.*/game.php*
// @include         http://*.the-west.*/forum.php*
// @include         http://userscripts.org/scripts/source/94569.meta.js*
// @include         http://userscripts.org/scripts/review/94569*
// @version         3.1.0.7
//
...
if (url.indexOf(".the-west.") != -1) {
  ...
  if (localStorage.getItem("TWPro_LanguagePack") && decodeURIComponent(localStorage.getItem("TWPro_LanguagePack")) != "pl" && decodeURIComponent(localStorage.getItem("TWPro_LanguagePack")) != "http://pl"){
	  var myScript = document.createElement("script");
	  myScript.type = "text/javascript";
...
if (decodeURIComponent(localStorage.getItem("TWPro_LanguagePack")) == "pl" || decodeURIComponent(localStorage.getItem("TWPro_LanguagePack")) == "http://pl") twpro_lang = twpro_langs['pl'];
...
//JobList[126] = new JobInfo('Palisade bauen', 'build_palisade', 300, '1 * skills.build + 1 * skills.punch + 1 * skills.endurance + 1 * skills.repair + 1 * skills.leadership + 0', 'Kräftige Stämme müssen in den Boden gerammt werden, um Schutz vor angreifern zu gewähren.', [null], [{'name': 'Random product', 'icon': 'images/items/unknown.png', 'short': ''},null]);
	...
	TWPro.twpro_setBonus.set_dancer[7].parsedBonus = {};
		...
		twpro_supportLink.href = 'http://userscripts.org/scripts/show/94569';
...
//			xhtml += '<br /><input id="twpro_jobsort_filter" type="checkbox"' + (TWPro.twpro_preference('Hide_unjobs')?' checked="checked"':'') + ' title="'+TWPro.lang.FILTERJOBS+'" />';
			...
			xhtml += '<span style="position:absolute;bottom:11px;right:13px;font-size:10.5px;">Powered by <a href="http://userscripts.org/scripts/show/94'+'569" target="_blank">Zyphir Randrott</a></span></tbody></table>';
