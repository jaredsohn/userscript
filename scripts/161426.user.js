...
var rSRC = {
	...
	getTPL: function(){
		...
		+ '<input id="hid_iconid" type="radio" name="iconid" value="0" style="position:absolute!important; z-index:-1; top:40px; width:1px; cursor:none;"/>'
			...
			+  '<input type="submit" accesskey="v" tabindex="1" value="'+gvar.inner.reply.submit+'" name="sbutton" id="sbutton" class="goog-inline-block jfk-button '+ (gvar.user.isDonatur ? 'jfk-button-action' : 'g-button-red') +'"/>'
	...
	getCSSWideFix: function(){
		...
		+"#site-search .search-opt span {display:block;}"
