// ==UserScript==
// @name         StarsQuest : commonScript
// @namespace    StarsQuest : commonScript
// @description	 Script librairies neccessaire a l'execution des autres scripts [StarsQuest's scripts string]
// @author       Benoit485
// @version      0.3
...
var version = '0.3';
var url = 'http://userscripts.org/scripts/source/165896.user.js';
var debug = true;
var clickO = false;
...
var ansaerys = 
{
	...
	url : 
	{
		get : document.location.href.replace(/http:\/\/s[0-9]+\.ansaerys\.net\/game\.php\?/, '')
	}
};
