...
var wpLink = document.createElement("a");
wpLink.href = 'https://www.feedthe.net/browse.php?search=' + title;
wpLink.style.marginRight = "70px";
wpLink.title = "FTN";
wpLink.innerHTML = '<img src="https://feedthe.net/favicon.ico" align="absmiddle" border="0" vspace="3"> <b>FTN</b>';
div.appendChild(wpLink);
