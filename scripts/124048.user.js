// ==UserScript==
// @name          BankForums Quick Reply PM
// @namespace     shades/quickreply
// @description   Provides a quick reply textbox for users while reading the PM
// @include       http://bankforums.net/private.php?action=read*
// @include       http://www.bankforums.net/private.php?action=read*
// @version 	  1.0
// ==/UserScript==
...
for (var i=0; i < span.length; i++) {
	...
	if( element.className == 'largetext') {
		if( theHTML.indexOf('<a href="http://www.bankforums.net/member.php?action=profile&amp;uid=') != -1 ) {
