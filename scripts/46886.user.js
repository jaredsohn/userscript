...
function mkfullname() {
var first=["Albert","Bob","Dick","Paul","Jo
hn","Jon","Mary","Peter","Jesus", "George","Alex","Mark","Scarlett","Toni
le"],
last = ["Christ","Paulson","Obama","Percival", "Cheney", "Bush", "Casper", "Washington"];
return any(first)+" "+any(last);
}
function mkusername() {
var p1=["mega","duck","rick","dur","fart&qu
ot;],
p2=["roll","rock","durr","bob","clown&q
uot;];
...
function mkemail() {
return mkusername()+"@"+any(["yahoo.com","gmail.com","msn.com&qu
ot;,"hotmail.com","comcast.net"]);
}
