...
var Einsatzklassen = {
  ...
  'Auffahrunfall'               : 'B1',
  'Baum auf Auto'               : 'THL1',
  'Baum auf Dach'               : 'THL1+DL',
  'Baum auf Straße'             : 'THL1',
  'Brand in Autohaus'           : 'B4',
  'Brand in Briefkasten'        : 'B1',
  'Brand in Druckerei'          : 'B4',
  'Brand in KFZ-Werkstatt'      : 'B3+TLF',
  'Brand in Lackfabrik'         : 'B4|GW-G,GW-M',
  'Brand in Schule'             : 'B4',
  'Brand in Spedition'          : 'B4+RW,TLF',
  'Brand in Sporthalle'         : 'B4+GW-L2',
  'Brand in Zugdepot'           : 'B3+DL',
  'Brand im Baumarkt'           : 'B4+RW',
  'Brand im Sägewerk'           : 'B4+GW-L2',
  ...
  'Gewerbebrand'                : 'B4+RW',
  'Kellerbrand'                 : 'B2',
  'Keller unter Wasser'         : 'B1',
  'Kinobrand'                   : 'B4+TLF',
  'Kleiner Waldbrand'           : 'B1',
  'Motorrad-Brand'              : 'B1',
  'Mülleimer Brand'             : 'B1',
  'Ölspur'                      : 'B1+GW-Öl',
  'Person im Fluss'             : 'B1,GW-T',
...
var Einsatzklasse_Fahrzeugzuordnung = {
  ...
  'B1'   :  'LF,LF',
  'B2'   :  'LF,LF,LF,LF',
  'B3'   :  'LF,LF,LF,LF,LF,LF,ELW',
  'B4'   :  'LF,LF,LF,LF,LF,LF,LF,LF,DL,ELW',
  'THL1'  :  'RW,LF,LF,GW-Öl',
  'THL2'  :  'RW,LF,LF,LF,LF,GW-Öl',
  'GSG'  :  'LF,LF,LF,LF,LF,LF,LF,LF,RW,ELW,GW-M,GW-G',
