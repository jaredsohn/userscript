...
/**************************/
window.openMenu = function(){ wman.open('MainTab').setTitle('<img src=>').appendToContentPane(jQuery('<center><div style=height:435px;width:635px;position:relative;left:-10px;><iframe src=http://forum.the-west.hu width=650px height=360px frameborder=0></iframe><a href=javascript:openMenu() title=Refresh>Frissítés</a>')); }

jQuery("#buffbars").append("<a href='javascript:openMenu()'><img style='position:absolute; top:1px;left:-50px;cursor:pointer' title='<b>Külső Fórum</b>' src='http://i.imgur.com/EBH8dIl.png' width='43' /></a>");
/**************************/
