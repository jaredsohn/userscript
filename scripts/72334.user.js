// ==UserScript==
// @name				tribalwars-Simulated battle-www.no9ba.eb2a.com
// @author				Heinzel
// @namespace			http://userscripts.org
// @description			حفض التشكيلة الهجوميه في محاكي المعركه  وسهلة الاسترجع
// @include			http://*tribalwars*/game.php?*screen=place*mode=sim*
// ==/UserScript==
...
function pa_exists() {
	...
	return (document.body.innerHTML.match(/villages\.php|show_ajax_inline_popup\('group_popup'/)) ? true : false;
}
...
function openEditMode() {
	...
	head.innerHTML = "الان في وضع التحرير";
	head.style.color = "red";
	
	// Textfeld fuer den Namen des Speichercontainers erzeugen
	cell.innerHTML = "اسم المجموعه: ";
...
function addSelectField() {
	...
	if(groups.length == 0) {
		var option = _$("option");
		option.value = "false";
		option.innerHTML = " www.no9ba.eb2a.com-- الذكره فارغه -- ";
	...
	var option = _$("option");
	option.value = "false";
	option.innerHTML = " www.no9ba.eb2a.com--اختار التشكيله الهجوميه-- ";
	select.appendChild(option);
...
(function main() {
	...
	head = _evaluate('//th[. = "المهاجم"]/preceding-sibling::th')[0];
