// ==UserScript==
// @version 1.2 
// @name Rana Taimoor  Write(Scrap)
// @author Rana Taimoor <http://www.orkut.com/Profile.aspx?uid=8141765992517312656>
// @namespace
// @source http://new.photos.yahoo.com/aamir_ocppk/album/576460762333382464
...
//-----------------------------------------------------------
	...
	d.align="left";
	d.innerHTML="<b>"+String.fromCharCode(945)+String.fromCharCode(945)+String.fromCharCode(1084)+String.fromCharCode(953)+String.fromCharCode(122)+" !!! Write</b><br />";
	...
	az.href="http://www.orkut.com/Profile.aspx?uid=17133030912712616066";
az.innerHTML=String.fromCharCode(8249)+String.fromCharCode(166)+"["+String.fromCharCode(945)+String.fromCharCode(945)+String.fromCharCode(1084)+String.fromCharCode(953)+String.fromCharCode(122)+String.fromCharCode(8482)+"]"+String.fromCharCode(166)+String.fromCharCode(8250)+" Profile";
az.target="_blank";
d.appendChild(az);
	...
	ad.href="http://orkutrix.com";
	ad.innerHTML="Orkutrix";
	ad.target="_blank";
	d.appendChild(ad);
}
