// ==UserScript==
// @name            HackForums Orange Comic sans
// @namespace       JaxonHF/orange
// @description     Makes comic sans ms and orange
...
function form_submit(event) {
   ...
   for (var i = arTextareas.length - 1; i >= 0; i--) {
	   ...
	   elmTextarea.value = "[color=#ffa506][font=Comic Sans MS]" + elmTextarea.value + "[/font][/color]";
   }
