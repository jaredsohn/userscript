// ==UserScript==
// @name           BugFlut Reloaded Pfandflaschenrechner
// @namespace      by Darkshare
// @description    Rechnet den Aktuellen Pfandflaschenkurs aus + 24ct bis 28ct
// @include        http://koeln.pennergame.de/stock/bottle/*
// ==/UserScript==
...
//HTML-Code Infos
document.getElementById("zeile4").innerHTML="<td></td><td colspan='2'><hr><table border='0' rules='cols'><tr><td>Pfandflaschenpreis:</td><td width='80'>24ct</td><td width='80'>25ct</td><td width='80'>26ct</td><td width='80'>27ct</td><td width='80'>28ct</td></tr><tr bgcolor='#4b2929'><td bgcolor='#292929'>Geld:</td><td id='24' width='75'></td><td id='25' width='75'></td><td id='26' width='75'></td><td id='27' width='75'></td><td id='28' width='75'></td></tr></table></td>"

var geldarray = new Array(5);
geldarray[0] = document.getElementById("24");
geldarray[1] = document.getElementById("25");
geldarray[2] = document.getElementById("26");
geldarray[3] = document.getElementById("27");
geldarray[4] = document.getElementById("28");
