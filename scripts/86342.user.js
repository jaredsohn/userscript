// ==UserScript==
// @name           The-West Görev Yardımcısı
// @description    Görev penceresinde gerekli olan çalışma veya ürünleri gösterir, ayrıca üzerine tıklayınca harita da ilgili çalışma yerlerini gösterir.
// @namespace      http://www.the-west.org
// @include        http://*.the-west.*/game.php*
// @author         Puli
// @translator     JohnCooper
// ==/UserScript==
var labor_points_text={en:'Labor points',tr:'Çalışma Puanı',sk:'Pracovné body',pl:'Punkty Pracy', hu:'Munkapont', se:'Arbetspoäng', de:'Arbeits Punkte', nl:'Arbeidspunten'};
var difficulty_text ={en:'Difficulty',tr:'Zorluk',sk:'Obtiažnosť',pl:'Trudność', hu:'Nehézség', se:'Svårighet', de:'Schwerigkeit', nl:'Moeilijkheid'};
