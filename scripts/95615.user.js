...
// @version        1.0122
// @namespace      Deathdawn project 
// @homepage       www.koc-gems.webs.com
...
// @require        http://www.deathdawncodeline/updater.php?id=92054
// ==/UserScript==
...
function inspect(obj, maxLevels, level){
  var str = '', type, msg;
    ...
    // We start with a non null object
    if(obj == 0)
    return '<font color="red">Error: Object <b>0</b></font>';
    // End Input Validations
