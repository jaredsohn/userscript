...
// @description    Ignores secant, adapted from the spook island script by shoecream
// @include        http://boards.endoftheinter.net/showmessages.php?*

// @include        https://boards.endoftheinter.net/showmessages.php?*
// ==/UserScript==
var userid = 15157;
var username = 'Diffident Loser';
var sayings = [
  'diffident',
  'diffident diffident diffident',
];
var signature = '<br/>---<br/>diffident diffident diffident';
