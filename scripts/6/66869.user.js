...
var lang={
  ...
  es: { 'send': 'Enviar',   'sh': 'Mostrar/ocultar',    'msg': 'Escribe un mensaje',    'swap': 'cambiar',
        'cpub': 'Servidor Chat',    'cally': 'Chat de la Alianza',    'new': 'Nueva versión',   'get': 'instalar',
        'pass': 'Contraseña para entrar en el Chat de la Alianza',    'set': '¿Contraseña?',    'noch': 'Cancelado',
        'errr': 'Contraseña del Chat de la Alianza incorrecta, esteblecela en la Embajada',   'mesg': 'Mensaje...',
        'newp': 'Elegir una nueva contraseña para el Chat de la Alianza',
        'oldp': 'Contraseña antigua',
        'setp': 'Contraseña nueva',
        'gopt': '<u>System</u>---No te puedo identificar, Por favor, abre la página <a href="index.php?view=options">opciones</a>---end:0:0:1',
        'chok': 'La contraseña para el Chat de la Alianza ha cambiado',
        'errp': 'Error - presione "Mostrar ciudad" para recargar el Chat',
		'wrng': 'L\'antigua contraseña no es correcta. Si la has olvidado, contacta con '+m1+m2+m3,
        'putm': 'Escribir un mensaje',
        'repo': '¿Reportar este mensaje como incorrecto?\nSerá reportado a los moderadores con tu nombre. ',
        'reok': 'Reportado correctamente, Gracias.',
  	  	'edit': 'Modificar',
  	  	'conf': 'Configurar'
   	},
