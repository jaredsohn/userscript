// ==UserScript==
// @name Ogame FR : Standard suche.php (Search)
// @author Izcelion
// @description Ogame FR : Standard suche.php (Search)
// @language FR
...
if (isFinite(GetUniverse())){
		...
		if (i==4){
			...
			while (j<trnode.length){
				...
				if (thnode.length==6){
					...
					//===============================================
					// Add icon Evolution for the players in top 1500
					//===============================================
					if((thnode[5].innerHTML).indexOf("<a href",0)>=0){
						PlayerName = thnode[0].innerHTML;
						...
						//alert(PlayerName);
						thnode[1].innerHTML += '<a href="http://infranova.free.fr/detail.php?pseudo='+escape(PlayerName)+'&uni='+GetUniverse()+'" target="Hauptframe"><img src="http://img144.imageshack.us/img144/5875/icongrowthog3.gif" alt="See evolution" border="0" width="13" Height="11"></a>';
	...
	//alert("Standard suche.php (Search)");
}
