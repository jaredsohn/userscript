...
try {
	...
	var siglink = "http://imgclodogame.fr/cache/bl_DE/signaturen/";
		...
		try {
			...
			if (check(18) || check(29) || check(28)){
				try {
					...
					var tier_tip = side_split_10[0].replace(/href="/g, 'href="http://clodogame.fr');
...
//Copyright by dzeros im Pennergame unter NewMan01 zu finden
	if (check(28) || check(29)){
		...
		if(tier_bild.indexOf('http://mediaclodogame.fr/img/tiere/') != -1){
...
//Copyright by dzeros im clodogame unter NewMan01 zu finden