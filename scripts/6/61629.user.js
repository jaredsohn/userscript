// ==UserScript==
// @name          Bloodlines iBranch Crew Attack Fix
// @namespace     HappyBunnyMan55
// @description   Modifies Bloodlines Crew Page to help you run Semi-Auto Attacking Macro
// @include       http://bloodlinesrpg.info/crews.php?id=59
// ==/UserScript==
...
oaf = function () {
    ...
    function loadEvents(links, fn){
        for (var i = 0; i < links.length; i++) {
            if (links[i].href.indexOf("profile.php?") > 0) {
