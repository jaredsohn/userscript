// ==UserScript==
// @name           Test Change Portal
// @namespace      http://www.ritaj.ps/
// @description    Change Ritaj background color
// @include        https://ritaj.birzeit.edu/*
// ==/UserScript==
...
function addBGImage() {
    ...
    if (!body) { return; }
    body.background = "http://www.zastavki.com/pictures/1024x768/2008/Music_Avril_Lavigne_004714_.jpg";
