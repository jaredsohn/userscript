...
// @include        http://test.goallineblitz.com/game/skill_points.pl?player_id=*
// ==/UserScript==
...
var positionData = {
    ...
    "Combo HB": {
        ...
        minors: ["agility","confidence","stamina","jumping"],
        weightOptions: 22,
        heightOptions: 2
    },
    "Running FB": {
    ...
    "Combo FB": {
        majors: ["agility","strength","vision", "blocking", "carrying"],
    ...
    "Boomer K": {
        majors: ["confidence","kicking","stength"],
    ...
    "Boomer P": {
        majors: ["confidence","punting","stength"],
        minors: ["jumping","agility","vision"],
        weightOptions: 18,
        heightOptions: 3
    },
...
function parsePlayerPage() {
    ...
    GM_xmlhttpRequest({
        method: 'GET',
        url: "http://test.goallineblitz.com/game/player.pl?player_id="+playerId,
        headers: {
