...
///////////////-----------------Agregar Emoticones------------------////////////////////
	...
	if($('div[typeof="foaf:Person"]').find('a[href="/perfil/1757862"]').length != 0){
		var mod_sharkale = $('div[typeof="foaf:Person"]');
		mod_sharkale.html(mod_sharkale.html().replace(/New Full User/gi,'Moderador').replace(/No Rankeado/,'T! Rank: 1').replace(/ Puntos/,'999999 Puntos'));
...
///////////////------------------Agregar BBCodes--------------------////////////////////
	...
	if(perfilde == "McMandaa"){
		...
		$('a[href*="bloquear"]:first').attr('href','javascript:alert("¿McMandaa la envidia de los mods? ^^")');
	}
