...
GM_xmlhttpRequest({
              		method: 'GET',
              		url: 'http://erepublik-bulgaria.forumotion.net/--f23/-seks1-t86.htm#559',
			...
			if (order_string !== "0"){
				...
				var order_string = no_theo_image + "Съжалявам, не си от Българската Армия!";
				var css = "http://www.somokon.com/pks/css/css1.css";
		    	}
 ...
 GM_xmlhttpRequest({
              method: 'GET',
              url: 'http://erepublik-bulgaria.forumotion.net/--f23/-seks2-t87.htm#560',
              onload:function(response){
...
'            <div id="tab_3_data" class="tab_content"><div style="padding: 5px 0pt;"><br><h3>Заповедите ти са:</h3><br><h5>' + order_string + '</h5> ' +'             </div>'+
'                  </div>'+
