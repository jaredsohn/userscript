// ==UserScript==
// @name        GuerraKhan Strumenti
// @author      Bagatelle
// @license     Public Domain
// @uso:script  60707
// @uso:version 1.1.1
// @version     1.1.1
// @description più grandi del Khanwars toolkit
...
// Traduzido do portugues para o italiano por epiana para ser usado no Khanwars Italiano
// Traducido del portugués al español para epiana para ser utilizado en Chile Khanwars
// Meus elogios ao Bagatelle pelo excelente trabalho no desenvolvimento desse script para nosso uso
// Obrigado Bagatelle. este script é para ser usado no www.khanwars.it
...
Translation["IT"] = [
  ...
  // resources
  "Oro", "Ferro", "Legno", "Cibo", "Uomini",

  // hero skills
  "Combattimento", "Cavaliere", "Difesa", "Precisione", "Esplorazione", "Finanza", "Assedio",

  // abbreviations for days of the week; can be blank strings if none desired
  "Lun", "Mat", "Mer", "Gio", "Ven", "Sab", "Dom",

  // script interface--might include HTML markup
  "Mercato Interno", "Invia Risorse", "Scheda Riassuntiva", "Forum del Clan", "Admin. Clan", "Ricerca VIP",
  "Liberare l'esercito", "Server", "Caminho único", "Estimado Server Chegada",
  "Risorse Totale ", "Max Mercato", "Extra",
  "Attenzione: non hanno abbastanza truppe per incollarlo.",
  "Formazione di attacco default non trovato.", "Quick Percorsi",
  "Copia Abilità", "Salvato",

  "Opzioni", "Minime cure della nazione", "Resti di battaglia Basso", "Frazione di furto", "Velocità del mondo",
  "ClanID", "Server fora do jogo, Minutos", "Maximo X", "Maximo Y",
  "Formazione di attacco default", "Deletar todos os dados (Mapa Também)",
  "Per il mondo", "Sério! (Isto vai levar muito tempo.)", "Colar formação",

  // troop selection tools
  "Tutti", "Nessuno", "Fanteria semplice", "Copia", "Reverse",
  ...
  // additional march counters
  "Velocità", "Danni", "Assedio", "Portata", "Senza assedio", "Castello",
  "Velocità effettiva", "Server Arrivo", "Server Ritorno", "Local Arrivo", "Local Ritorno",
  "Tempo (senza motivazione)", "Cancelar", "Não foi possível encontrar este tipo de marcha.",
  ...
  // merchant management
  "Salvar", "Deletar", "Riempire", "Distribuir Igualmente", "Resetar", "Spazio lasciato",
  "Lucro", "Fonte",

  // battle reports
  "Sem limpeza (Rec)", "Perda total do ataque (Rec/Pop)", "Perda total da defesa (Rec/Pop)",
  "Limpeza total estimada", "Capacidade de Carga de Recursos", "Copiar Formação", "Copiar Exército",
  "Pop total",

  // battle report show stats inline
  "Fanteria", "Cavalleria", "Arcieri", "Assedio", "Atk+", "Def+", "vita",
  "Lost Risorse", "Pop Lost", "Vita persi", "Resti Stimato",

  // sim
  "Unità minime", "Pasta l'unità", "Aggiungi Unità", "Fabro Massimo", "Pasta Capacità", "Abilità Massima",

  // unit training
  "Risorse totale per l'addestramento", "Tempo totale di addestramento", "Cancella tutti",

  // map interface
  "Come un fulmine", "Camminando", "Giocatori", "Livello", "Castello", "Capitale", "Clan",
...
Translation["BR"] = [
  ...
  "Opções", "Cura Mínima da nação", "Minimo de Limpeza pra destaque", "Fração do Roubo", "Velocidade do mundo",
  "ClanID", "Server fora do jogo, Minutos", "Maximo X", "Maximo Y",
  ...
  // battle report show stats inline
  "Inf", "Cav", "Arco", "Limp", "Atk+", "Def+", "vida",
...
Translation["ES"] = [
  // units
  "Piquero", "Soldado Espada", "Soldado Hacha", "Soldado Maza", "Halberd", "Caballero Teutónico", "Husar",
  "Muyahid", "Mensajero veloz", "Caballería ligera", "Caballería pesada", "Tarán",
  "Balista", "Catapulta", "Fundíbulo", "Tirador arco pequeño", "Tirador arco grande",
  "Ballestero", "Tirador jinete", "Hidalgo", "Sacerdote de Tangra", "Cura",
  "Tamborero", "Comandante", "Torre de asedio", "Samurai", "KhanGuard",

  // buildings
  "Mina de oro", "Mina de hierro", "Leñadores", "Haciendas", "Viviendas", "Cuartel",
  "Cuadra", "Taller", "Mercado", "Herrería", "Hospital Militar", "Muralla",
  "Orden", "Refugio", "Almácenes",

  // resources
  "Oro", "Hierro", "Madera", "Comida", "Población",

  // hero skills
  "Guerrero", "Caballero", "Defensor", "Tirador", "Explorador", "Finanzas", "Asedio",
  ...
  "ClanID", "Server Offset, Minutes", "Maximum X", "Maximum Y",
  "Default Attack Formation", "Delete ALL Data (Map Too)",
  "For world", "Really! (This could take a long time.)", "Collar Formación",

  // troop selection tools
  "Todos", "Ninguno", "Individual de Infantería", "Collar", "Invertir",
  ...
  // additional march counters
  "Velocidad", "Daño", "Cerco", "Carga", "No Cerco", "Castillos",
  "Effective Speed", "Server Arrival", "Server Return", "Local Arrival", "Local Return",
  "Timing (no coins)", "Cancel", "Could not find that march type.",
  "Cannot transfer.",
  ...
  // unit training
  "Total de recursos para formación", "Tiempo total para formación", "Total Cancelación",

  // map interface
  "Más rápido", "Más lento", "Jugador", "Nivel", "Castillo", "Capital", "Clan",
  "Última actividad (Día)", "Last ms", "Data Grabbed (Days)", "Grabbed ms",
  "Generar Informe Mapa",

  // spy reports
  "Edad de Mensaje", "Copia", "Eliminar página", "Limpiar"
];
...
switch (StrippedHost) {
  ...
  case "khanwars.cl": Lang = "ES"; break;
...
var ScavengeThreshold = Number(GM_getValue(SavePrefix + "MinScavenge", 1));
var TimeOffset = Number(GM_getValue(SavePrefix + "ServerOffset", 0));
...
/******************************************************************************/
// scavenging fields  -  pagina de limpeza
...
if (PageMatch) {
  ...
  for (var N = 0; N < SelNodes.snapshotLength; N++) {
    ...
    var Colour = "";
    if (Number(Pop) >= HealThreshold || Resources >= ScavengeThreshold) {Colour = "lightgreen";}
...
//      GetEmptyGridStart("y");
      ...
      for (var N = 0; N < Nodes.snapshotLength; N++) {
        ...
        var Colour = "white";
        if (Number(Pop) >= HealThreshold || Scavenge >= ScavengeThreshold) {Colour = "lightgreen";}
          else {if (Scavenge > 0) Colour = "blue";}
        if (Coords[0] == FocusCoords[0] && Coords[1] == FocusCoords[1]) {Colour = "black";}
        ...
        Nodes.snapshotItem(N).innerHTML +=
          ...
          String(Math.ceil(Scavenge / Units["u19"]["carry"])) + " " + Translate("CA") + "<br />" +
          "</b></font>";
