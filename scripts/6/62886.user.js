...
// @description     Spielt eine Vorschau des Videos nachdem man die Maus darÃ¼ber bewegt.
...
i18n_data["de"] = {
  ...
  "display video information after the mouse was %t over the element": 
      "Videoinformationen anzeigen wenn die Maus %t Ã¼ber dem Element war.",
  "additional play delay":
      "ZusÃ¤tzliche AbspielverzÃ¶gerung",
  ...
  "start position: %d%":
      "Startposition, relativ zur VideolÃ¤nge: %d%",
  ...
  "Language code (selected by Youtube): %s":
      "Sprachcode (von Youtube Ã¼bernommen): %s.",
...
<dialogheader title="' + getText('About') + '" description="Youtube Prewatch 1.0"/>
  <vbox style="padding:0 1em 1em">
    ...
    <description>
      ' + getText('Current Version: %s', '1.0b4') + '
    </description>
    <description>
