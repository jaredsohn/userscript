...
// @description    Premium balk voor Tribalwars (Hoofdgebouw, Kazerne , Stal , Werkplaats , Edelhoeve , Smederij , Verzamelplaats , Markt)  
...
window.createQuickbarShortcuts = function() {
	"<tr>   " + 
	newShortcut("/graphic/buildings/main.png", "/game.php?village="+VillId+"&screen=main", "Hoofdgebouw   ");
	newShortcut("/graphic/buildings/barracks.png", "/game.php?village="+VillId+"&screen=barracks", "Kazerne   ");
	newShortcut("/graphic/buildings/stable.png", "/game.php?village="+VillId+"&screen=stable", "Stal");
	newShortcut("/graphic/buildings/garage.png", "/game.php?village="+VillId+"&screen=garage", "Werkplaats   ");
    newShortcut("/graphic/buildings/snob.png", "/game.php?village="+VillId+"&screen=snob", "Edelhoeve   ");
	newShortcut("/graphic/buildings/smith.png", "/game.php?village="+VillId+"&screen=smith", "Smederij   ");
	+ "<tr>   " + 
	newShortcut("/graphic/buildings/place.png", "/game.php?village="+VillId+"&screen=place", "Verzamelplaats   ");
    newShortcut("/graphic/buildings/market.png", "/game.php?village="+VillId+"&screen=market", "Marktplaats");
tableIdIndex++;
	trIdIndex++;
}
