// ==UserScript==
// @name            Guardian.co.uk print
// @include         http://www.guardian.co.uk/*/print
// ==/UserScript==

function do_platypus_script() {
fix_page_it(window.document,'/HTML[1]',null,null,null);
isolate(window.document,document.getElementById('article-wrapper'),null,null,null);
relax(window.document,document.evaluate('/HTML[1]', document, null, XPathResult.FIRST_ORDERED_NODE_TYPE,null).singleNodeValue,null,null,null);
