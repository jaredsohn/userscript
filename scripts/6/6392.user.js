// ==UserScript==
// @name Ogame FR : Standard notizen.php (Notes)
// @author Izcelion
// @description Ogame FR : Standard notizen.php (Notes)
// @language FR
...
if (isFinite(GetUniverse())){
	...
	textareanode[0].setAttribute("cols","80");
	textareanode[0].setAttribute("rows","35");
	
	//alert("Standard notizen.php (Notes)");
