...
// @name           Freash
// @namespace      local
// @include        http://www.fotka.pl/profil/Parlez/
// ==/UserScript==
...
function dodajNoweMenu(){
	...
	poz1 = newElem("li")
	poz1.innerHTML = "<a href = '#'>Pokaż zawartość</a>"
	poz1.addEventListener("click", pokazPopup, false)
	pozLista.appendChild(poz1)
	
	poz2 = newElem("li")
	poz2.innerHTML = "<a href = '#'>Opróżnij koszyk</a>"
...
function dodajPrzycisk(){
	...
	if (l != null){
		...
		var p = newElem("IMG")
		p.src = "http://s.fotka.pl/img/users/fp.png"	
		p.id = "przycisk_dodaj"
		p.title = "Fotka Przyjaciel"
		p.style.cursor = "pointer"
		p.style.position = "top", p.style.marginBottom = "5px"
