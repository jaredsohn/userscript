...
if (InsertionPoint) {
  ...
  LinkNode.innerHTML =
    ...
    "<a href='http://www.redekid.com/'>" + Translate("Chat") + "</a> | " +
    "<a href='http://www.redekid.com/khan/'>" + Translate("KhanFull") + "</a> | " +
...
function TrapMapUpdate(Event) {
  ...
  if (ID == "now_map" || ID == "new_map" || ID == "old_map") {
    ...
    var BaseX = unsafeWindow.x, BaseY = unsafeWindow.y, CurrX, CurrY, NewNode;
