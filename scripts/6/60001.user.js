// Neopets - Links rápidos
// by yoshi42 (yoshi@renan.com)
//
// ==UserScript==
...
//  ['',''],                                                                     // another example of a separator
  ...
  ['Águas Curativas','http://www.neopets.com/faerieland/springs.phtml'], 
  ['Altador Plot Daily','http://www.neopets.com/altador/council.phtml'],
  ['Alavanca do destino','http://www.neopets.com/space/strangelever.phtml'],   
  ['Calendário de Adventos','http://neopets.com/winter/adventcalendar.phtml'], 
  ...
  ['Laboratório','http://www.neopets.com/lab2.phtml'],
  ['Laboratório de PetPets','http://www.neopets.com/petpetlab.phtml'],   
  ['Máquina de Frutas','http://www.neopets.com/desert/fruitmachine.phtml'],
  ['Meteor Crash Site 725-XZ','http://www.neopets.com/moon/meteor.phtml'],
  ['Misteriosa Toca de Symol','http://www.neopets.com/medieval/symolhole.phtml'],
  ['Omelete Gigante','http://www.neopets.com/prehistoric/omelette.phtml'],],
  ['Pesca Submarina','http://www.neopets.com/water/fishing.phtml'], 
  ['Roda da Emoção','http://www.neopets.com/faerieland/wheel.phtml'],
  ['Roda da Sabedoria','http://www.neopets.com/medieval/knowledge.phtml'],
  ['Roda da Mediocridade','http://www.neopets.com/prehistoric/mediocrity.phtml'],
  ['Roda do Azar','http://www.neopets.com/halloween/wheel/index.phtml'],
  ['Roda da Monotonia','http://www.neopets.com/prehistoric/monotony/monotony.phtml'],
  ['Roda da Meleca ','http://www.neopets.com/games/play.phtml?game_id=807'],
  ['Santuário de Coltzan','http://www.neopets.com/desert/shrine.phtml'],
  ...
  ['Teste Sua Força','http://www.neopets.com/halloween/strtest/index.phtml'
  ['Templo Lunar','http://www.neopets.com/shenkuu/lunar/?show=puzzle'],  
  ['Tombola','http://www.neopets.com/island/tombola.phtml'],
  ['Tumba Perdida','http://www.neopets.com/worlds/geraptiku/tomb.phtml'],
