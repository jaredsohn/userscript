// ==UserScript==
// @name           eRepublik ПРОФИТ!!1!
// @version        0.0.1
// @namespace      http://userscripts.org/users/daneke
// @author         Csupi and mod by FLATROY
// @description    eRepublik канкулятор профита;)
...
function output() {
	...
	<div class="holder" id="statsholder">\
		<h2 class="section">Ваш профит (нажмите)</h2>\
		<div class="indent">\
	...
	html["product_price"] = '\
		<div class="left">\
			<p class="goleft regular">Цена товара</p>\
	...
	html["raw_price"] = '\
		<div class="left">\
			<p class="goleft regular">Цена материалов</p>\
	...
	html["salary_cost"] = '\
		<div class="left">\
			<p class="goleft regular">Затраты на зарплаты</p>\
	...
	html["total_productivity"] = '\
		<div class="left">\
			<p class="goleft regular">Общая продутивность</p>\
			<p class="goleft special"><span id="total_productivity">0</span></p>\
			<p class="goleft currency"><span id="products">0</span><span> единиц товаров</span></p>\
		</div>\
	';
	html["raw_cost"] = '\
		<div class="left">\
			<p class="goleft regular">Стоимость материалов</p>\
			<p class="goleft special"><span id="raw_cost">0</span></p>\
			<p class="goleft currency"><span id="raw_needed">0</span><span> требуется</span></p>\
		</div>\
	';
	html["profit"] = '\
		<div class="left">\
			<p class="goleft regular">Текущий PROFit</p>\
			<p class="goleft special"><span id="profit">0</span></p>\
			<p class="goleft currency"><span id="per_product">0</span> с единицы товара</p>\
		</div>\
	';
	html_output = "";
...
function EmployeeProductivity() {
	...
	$("h2.biggersection").append(" ("+employees_nr+')<br />Цена товара: <span id="product_price">'+product_price+'</span>');
	if(COMPANY["domain"] != "land") $("h2.biggersection").append(' Цена материалов: <span id="raw_price">'+raw_price+'</span>');
...
function CompanyStats() {
	...
	for(q=1;q<=5;q++) {
		GM_xmlhttpRequest({ //----------------------------- Цена материалов ---------------------------------
			method: 'GET',
		...
		<div class="indent">\
			<div class="infoholder" id="stats" style="width:540px;display:none;">\
				<div class="left" id="productivity">\
					<p class="goleft regular">Общая продуктивность</p>\
...
//епервая русская версия скрипта-канкулятора для манагера;) DONATE to http://www.erepublik.com/en/citizen/profile/1862655
//