// ==UserScript==
// @name Ogame FR : Standard stat.php (Statistics)
// @author Izcelion
// @description Ogame FR : Standard stat.php (Statistics)
// @language FR
...
if (isFinite(GetUniverse())){
		...
		if (i==4){
			...
			while (j<trnode.length){
				...
				if (thnode.length==5){
					...
					//alert(PlayerName);
					thnode[2].innerHTML += '<a href="http://infranova.free.fr/detail.php?pseudo='+escape(PlayerName)+'&uni='+GetUniverse()+'" target="Hauptframe"><img src="http://img144.imageshack.us/img144/5875/icongrowthog3.gif" alt="See evolution" border="0" width="13" Height="11"></a>';
	...
	//alert("Standard stat.php (Statistics)");
}
