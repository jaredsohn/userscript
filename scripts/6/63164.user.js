// ==UserScript==
// @name           Ikariam VENENEZUELA	
// @version        0.3.2
// @autor          f3n1x
// @description    Se desplega foro de ikariam
// @include         http://s*.ikariam.com.ve/index.php*
// ==/UserScript==
// ===========================================================================
...
unsafeWindow.displaywiki = function() {
	if(displayedflag == 0) {
		document.getElementById("wikiframe").innerHTML = '<iframe width="920" border="0" frameborder="0" height="100%" src="http://board.ikariam.com.ve/" style="margin-left:26px;"></iframe>';
		displayedflag = 1;
	}
}
...
var wkHTML = '<div id="wikitab" onmouseover="showwiki()" onclick="hidewiki()"><a style="height:100%;width:100%;"></a></div>'
	...
	+ '<a style="border-bottom:1px #542C0F dotted; color: #542C0F;" href="http://ikariam.com.ve/">FoRo Ikariam.ve</a></div>'
