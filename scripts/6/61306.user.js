// ==UserScript==
// @name           Gladiatus - Auction Exporter
// @namespace      http://www.puli.sk
// @include        http://s*.gladiatus.org/game/index.php?mod=auction*
// ==/UserScript==
...
for (var i=0; i<alltds.length; i++) {
	if (alltds[i].id == "submenufooter") {
		...
		var button = document.createElement("a");
			...
			button.innerHTML = "Exportuj aukciu";
...
//   if(tooltipContent == null || tooltipContent.indexOf("alt='Rubíny'") >= 0)continue;
   ...
   while(startPos >= 0) {
      ...
      if(tooltipContent.indexOf('Cena') == 0)break;
      descStart = false;
      startPos = tooltipContent.indexOf("nowrap='nowrap'>");
      }
