...
{
	// add all css
	addGlobalStyle('a.tooltip8 span {display:none; padding:2px 3px; margin-left:1px; width:150px;}');
	...
	addGlobalStyle('a.tooltip8:hover span{display:inline; position:absolute; background:#ffffff; border:1px solid #cccccc; color:#6c6c6c;}');
	...
	if ( (page == 'tradegood') || (page == 'resource') )
	{
		...
		mill_number = 34;
			...
			workplace[40] = new Array(1076, 13635591, 70175293);
		}
		else
		{
		...
		if (method == 2 || method == 3) {	milllevel = document.getElementById('resUpgrade').childNodes[3].childNodes[3+offset].innerHTML.split('</span>')[1];}
		if (sort_all_mills==1) {
		...
		for (var jj = 1; jj < donationList.rows.length; jj++)
		{
			...
			//GM_log("name : "+name+" / donated_int : "+donated_int); //Xav
			// sorting array
			new_var_towns++;
		...
		for (var j = 1; j < donationList.rows.length; j+=cities)
		{
			...
			var LQrule =  (lvl)*(lvl)*workplace[milllevel][0];
			//var LQrule =  6*lvl*workplace[milllevel][0];
			//GM_log(milllevel);
			var LQrule2;
			var j2 = j;
			j2++;
				while ( (j2 < donationList.rows.length) && ("&nbsp;" == donationList.rows[j2].cells[0].innerHTML) )
				{
					...
					LQrule2 = (lvl2)*(lvl2)*workplace[milllevel][0];
...
//			 donationList.rows[j].cells[4].innerHTML="<a class=\"tooltip\" href=\"javascript:void(0)\">"+ordered_towns[j][4]+"<span>"+Comma(Math.round(ordered_towns[j][6]))+" wood has been donated per town.</span></a>";
			donationList.rows[j].cells[4].innerHTML="<a class=\"tooltip8\" href=\"javascript:void(0)\">"+ordered_towns[j][4]+"<span>"+Comma(Math.round(ordered_towns[j][6]))+" wood has been donated per town.</span></a>";
			...
			donationList.rows[j].cells[4].innerHTML="<a class=\"tooltip8\" href=\"javascript:void(0)\">"+ordered_towns[j][4]+"<span>"+Comma(Math.round(ordered_towns[j][7]))+" wood has been donated per town.</span></a>";
			}
			...
			donationList.rows[j].cells[4].innerHTML += "<a class=\"tooltip8\" href=\"javascript:void(0)\">"+tothree(newpercent)+"%<span>"+woodneed100+""+woodneed110+"</span></a>";
		...
		var breafious_building, sbreafious_building, LQ_building, breafious_luxury,sbreafious_luxury, LQ_luxury,debug_mode_on,debug_mode_off,sort_all_mills_on,sort_all_mills_on2,sort_all_mills_off,different_format_0,different_format_1;
				...
				document.getElementById("alloptions").innerHTML = 
				    ...
				    "</div>";
	            document.getElementById('radio_s1').addEventListener('change',function(event){GM_setValue('method_building','3');GM_setValue('param_building','15');GM_setValue('method_luxury','1');GM_setValue('param_luxury','15');document.getElementById('text_1').value='15';document.getElementById('text_2').value='15';document.getElementById('radio_1').checked='true';document.getElementById('radio_4').checked='true';},true);
	            document.getElementById('radio_s2').addEventListener('change',function(event){GM_setValue('method_building','3');GM_setValue('param_building','10');GM_setValue('method_luxury','2');GM_setValue('param_luxury','10');document.getElementById('text_1').value='10';document.getElementById('text_2').value='10';document.getElementById('radio_2').checked='true';document.getElementById('radio_5').checked='true';},true);
	            ...
	            document.getElementById('radio_1').addEventListener('change',function(event){GM_setValue('method_building','3');document.getElementById('text_1').value='15';GM_setValue('param_building','15')},true);
	            document.getElementById('radio_2').addEventListener('change',function(event){GM_setValue('method_building','3');document.getElementById('text_1').value='10';GM_setValue('param_building','10')},true);
				document.getElementById('radio_3').addEventListener('change',function(event){GM_setValue('method_building','3');},true);
	            document.getElementById('radio_4').addEventListener('change',function(event){GM_setValue('method_luxury','3');document.getElementById('text_2').value='15';GM_setValue('param_luxury','15')},true);
	            document.getElementById('radio_5').addEventListener('change',function(event){GM_setValue('method_luxury','3');document.getElementById('text_2').value='10';GM_setValue('param_luxury','10')},true);
