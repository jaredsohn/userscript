...
var icppre = ',http://i26.tinypic.com/ayvn8m.gif,http://i27.tinypic.com/2uy3k0o.jpg'
...
////== Opciones ==////
$(".menuTabs .clearBoth").before('<li id="option" class="tabbed"><a href="http://www.taringa.net/opciones/" title="Opciones del script">Opciones <img src="http://i.t.net.ar/images/arrowdown.png" alt="Drop Down"></a></li>');
if(loc == 'opciones') {
...
\
<li><input type="checkbox" id="chct" '+(chct? 'checked':'')+'> Cambiarle el color a taringa</li>\
\
...
GM_registerMenuCommand("1 - Reportar Bug ", function() { GM_openInTab('http://www.taringa.net/mensajes/a/gonx_666'); },null,null,"1");
GM_registerMenuCommand("2 - Comunidad del Script ", function() { GM_openInTab('http://www.taringa.net/comunidades/t-scripts/'); },null,null,"2");
GM_registerMenuCommand("3 - Cambiarle el color a taringa ", function() { setColours() },null,null,"3");
