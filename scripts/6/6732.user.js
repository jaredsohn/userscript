// ==UserScript==
// @name           OGame Calcolatore di risorse
// @namespace      
// @description    
// @include        http://*/game/*
// @include        
...
var PMetal = T_Recursos[33].innerHTML.replace(/\./g,'');
var PCristal = T_Recursos[34].innerHTML.replace(/\./g,'');
var PDeut = T_Recursos[35].innerHTML.replace(/\./g,'');

var AlmM = T_Recursos[28].innerHTML.replace(/\./g,'');
var AlmC = T_Recursos[29].innerHTML.replace(/\./g,'');
var AlmD = T_Recursos[30].innerHTML.replace(/\./g,'');
...
for (var i = 0; i < ResFormC.length; i++) {
	...
	T_Form = ResFormC[i];
	if (T_Form.getAttribute('width') == '500') {
		ResForm = T_Form;
	}
}
