// ==UserScript==
// @name          zelené impérium - multi sklizeň
// @autor          tomas sousedik
// @namespace      Zelené impérium
// @landscape      http://zeleneimperium.wgz.cz/
// @include        http://s*.zeleneimperium.cz/main.php?page=garden
// ==/UserScript==
...
(function() {
   ...
   function startScript() {
      var gz = document.createElement("span");
		...
		gz_style.nodeValue = "position:absolute;z-index:1;width:45px;height:45px;top:815px;right:250px;background:url('http://d3o68bgrbhx8hn.cloudfront.net/pics/verkauf/kannenzwerg.gif') top left no-repeat;";
