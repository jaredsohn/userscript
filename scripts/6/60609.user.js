// ==UserScript==
// @name            Agregar icono de Chat
// @namespace       Chat
// @include         http://*.taringa.net/*
// ==/UserScript==
function do_platypus_script() {
html_insert_it(window.document,document.evaluate('/HTML[1]/BODY[1]/DIV[4]/DIV[2]/DIV[1]/DIV[1]/UL[1]/LI[2]', document, null, XPathResult.FIRST_ORDERED_NODE_TYPE,null).singleNodeValue,'    <li>      <a name="Chat" href="/chat" title="Chat">        <span class="systemicons respuestas"></span>      </a>     </li>',false,false);
