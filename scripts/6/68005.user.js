...
var positionData = {
    "DE": {
        ...
        minors: ["stamina","vision","confidence"],
        weightOptions: 18,
        heightOptions: 3
    },
    "DT": {
        majors: ["strength","tackling","agility"],
        minors: ["vision", "stamina", "confidence"],
        weightOptions: 33,
        heightOptions: 3
    },
    "C": {
        majors: ["strength","blocking","confidence"],
        minors: ["agility","stamina","vision"],
        weightOptions: 22,
        heightOptions: 2
    },
    "G": {
    ...
    "HB": {
        majors: ["strength","speed","agility","carrying"],
        minors: ["vision","stamina","confidence","catching"],
        weightOptions: 20,
        heightOptions: 2
    },
    "WR": {
        majors: ["agility","strength","blocking","catching"],
        minors: ["confidence","vision","speed","stamina"],
        weightOptions: 11,
        heightOptions: 2
    },
    "QB": {
        majors: ["throwing","vision","confidence"],
        minors: ["agility","stamina","strength"],
        weightOptions: 9,
        heightOptions: 3
    },
    "TE": {
        majors: ["strength","blocking","catching","agility"],
        minors: ["speed","stamina","vision","confidence"],
        weightOptions: 22,
        heightOptions: 3
    },
    "FB": {
        majors: ["strength","blocking","vision","speed"],
        minors: ["confidence","agility","stamina","carrying"],
        weightOptions: 15,
        heightOptions: 3
    },
    "LB": {
        majors: ["strength","tackling","agility","vision"],
        minors: ["confidence","speed","jumping","stamina"],
        weightOptions: 9,
        heightOptions: 3
    },
    "CB": {
        majors: ["speed","agility","jumping","vision"],
        minors: ["catching","stamina","tackling","confidence"],
        weightOptions: 11,
        heightOptions: 3
    },
    "SS": {
    ...
    "K": {
        majors: ["kicking","strength","confidence"],
        minors: ["agility","jumping","vision"],
        weightOptions: 22,
        heightOptions: 2
    },
    "P": {
        majors: ["punting","strength","confidence"],
        minors: ["agility","jumping","vision"],
        weightOptions: 22,
        heightOptions: 2
    }
