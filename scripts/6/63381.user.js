...
// @description    FÃ¼gt auf der Karte Farbmarkierungen fÃ¼r bestimmte Gruppen zu DÃ¶rfern hinzu
...
(function(){
	...
	// Ecke wÃ¤hlen (1 = links oben, 2 = rechts oben, 3 = rechts unten, 4 = links unten)
	var position = 1;
	
	// Rechung wÃ¤hlen (1 = waagerecht, 2 = senkrecht)
	var orientation = 1;
	
	// GrÃ¶ÃŸe der einzelnn Markierungen in Pixel
	var size = 8;
	
	// --------- Ende ---------
	// Folgender Code sollte nicht verÃ¤ndert werden.
