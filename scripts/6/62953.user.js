...
var Einsatzklassen = {
  ...
  'Baum auf Auto'                    : 'ETH',
  'Baum auf Straße'                  : 'ETH',
  'Fahrstuhl - Türöffnung'           : 'ETH',
  'Baum auf Dach'                    : 'ETH+DL',
  'Keller unter Wasser'              : 'ETH-Kellerwasser',
  ...
  'Strohballen Brand'                : 'B2',
  'Schuppenbrand'                    : 'B2',
  'Traktorbrand'                     : 'B2+GW-Öl',
  'Brand in KFZ-Werkstatt'           : 'B2+TLF',
  'Kellerbrand'                      : 'B2+GW-A',
  'Schornsteinbrand'                 : 'B2+DL',
  'Brennende S-Bahn'                 : 'B2+GW-S',


  'Brand auf Weihnachtsmarkt'	     : 'B3+TLF',
  'Fettbrand in Pommesbude'          : 'B3+TLF',
  'Dachstuhlbrand'                   : 'B3+DL',
  'Scheunenbrand'                    : 'B3+GW-L2',
  'Silobrand'                        : 'B3+DL+GW-L2',
  'Brand-Weihnachtsbaum in Kirche'   : 'B3+TLF+DL',
  ...
  'Gewerbebrand'                     : 'B4',
  'Kinobrand'                        : 'B4+TLF',
  'Brand in Spedition'               : 'B4+RW',
  'Brand im Baumarkt'                : 'B4+RW+GW-M+GW-G',
...
// ************************************************************************************
  ...
  if (InfotextVerfuegbar) Info += InfoVorspann + "<a target='_new' href='http://www.feuerwache.net/feuerwehrfahrzeuge'>verfügbar</a></th><td><font color='green'>" + 

InfotextVerfuegbar + "</font></td></tr>\n";
