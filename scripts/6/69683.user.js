// ==UserScript==
// @name [PG] Freundesliste V2.3 by Boggler und syme
// @namespace syme [ICQ:442287724] und Boggler @ pennerhack.foren-city.de
...
var seite = document.location.href;
if (seite.indexOf("http://halloween.pennergame") >= 0) {
...
function infos(i) {
    ...
    GM_xmlhttpRequest({
        ...
        onload: function(responseDetails) {
            ...
            var fight = '<a href="/messages/write/?to=' + id + '"><img src="http://media.pennergame.de/img/overview/new_msg.gif"</a>';
            var pn = '<a href="/fight/?to=' + name + '"><img src="http://media.pennergame.de/de/img/att.png" width="16" height="16"</a>';
            ...
            td_4.innerHTML = '&nbsp;&nbsp;<a href="/profil/bande:' + idbande + '/"><b>' + namebande + '</b></a>';
