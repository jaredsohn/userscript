...
var addr = "http://test.goallineblitz.com/game/search_forum.pl?page=1&age=90&user_name=Bort&action=Search";
...
function main() {
	...
	divHeader.innerHTML = "Bort Tracker ( <a href='http://test.goallineblitz.com/game/search_forum.pl?page=1&age=14&user_name=Bort&action=Search'>Full Search Page</a> )";
