// ==UserScript==
// @name           Feuerwache.net AAO und Tool Script
...
// Feuer
  ...
  'Schuppenbrand'				   : 'F1',  
  'Fettbrand in Pommesbude'        : 'F1+Pumper', 
  ...
  'Kinobrand'                      : 'F2',
  'Dachstuhlbrand'                 : 'F2+Ladder',
  'Schornsteinbrand'               : 'F2+Ladder',
  'Brennende S-Bahn'			   : 'F2+Ladder', 

  'Gewerbebrand'                   : 'F3+RescueC2',
  'Brand in Spedition'             : 'F3',
  'Brand in Sporthalle'            : 'F3', 
  'Brand in Schule'                : 'F3',
  'Feuer im Altenheim'             : 'F3+RescueC2', 
  
  'Wohnblockbrand'                 : 'F4',  
  'Brand im Sägewerk'              : 'F4+RescueC5',
  'Brand im Baumarkt'              : 'F4+RescueC5', 
...
var Einsatzklasse_Fahrzeugzuordnung = {
  ...
  'undef'    :  'EngineC1/EngineC2',
// zu undef = unbekannten Einsatzen wird per Default jetzt ein LF 10/6 geschickt
  'F1'       :  'EngineC1/EngineC2',
  'F2'       :  'EngineC2,EngineC1/EngineC2',
  'F3'		 :  'EngineC2,EngineC1 EngineC1,Ladder',
  'F4'       :  'EngineC2,EngineC1,EngineC1,CCV,Ladder,RescueC2',
  
  'H1'       :  'EngineC1/EngineC2',
  'H2'       :  'EngineC2,EngineC1,CCV,RescueC5,RescueC2',
  'NotTV'    :  'RescueC5',
...
var Fahrzeugklassen = {
  ...
  'GW-Messtechnik'     :   'HazMatC1'       ,
  'GW-Gefahrgut'       :   'HazMatC2'       ,
  'GW-Schiene'         :   'RescueC1'       ,
  'GW-A'               :   'RescueC2'       ,
  'GW-L2 - Wasser'     :   'RescueC3'       ,
  'GW-Öl'              :   'RescueC4'      ,
  'RW'                 :   'RescueC5'        ,
...
var Nachforderungen = {
  "Die Einsatzstelle wird unübersichtlich. Wir benötigen einen ELW 1." : "CCV",
  "Hier wird es zu unübersichtlich! Wir benötigen einen ELW 1" : "CCV",
  "Die Lage wird zu unübersichtlich! Wir brauchen einen ELW 1." :"CCV",
  "Zur besseren Koordination benötigen wir einen ELW 1." : "CCV",
  "Aufgrund der Ausbreitung wird ein ELW 1 benötigt." : "CCV",
  "Vorort herrscht Chaos! Wir benötigen einen ELW 1." : "CCV",
  
  "Die Wasserversorgung ist unzureichend! Ein TLF 20/40 - SL wird benötigt." : "Pumper",
  "Wir benötigen mehr Schaummittel. Es wird ein TLF 20/40 - SL benötigt." : "Pumper",
  "Ein TLF 20/40 - SL wird benötigt, da größere Mengen Schaummittel und der Wasserwerfer eingesetzt werden sollen." : "Pumper",
    
  "Uns gehen die Atemschutzgeräte aus! Wir benötigen einen GW-A." : "RescueC2",

  "Wir benötigen Material vom Rüstwagen (RW)!" : "RescueC5",
  "Für erweiterte Technische Hilfe wird ein RW (Rüstwagen) benötigt." : "RescueC5",
  "Um das Auto zu befreien, benötigen wir einen RW!" : "RescueC5",
  "Um das Haus vom Baum zu befreien, benötigen wir einen Rüstwagen (RW)" : "RescueC5",
  
  "Wir benötigen für weitere Löscharbeiten dringend eine Drehleiter (DLA (K) 23/12)." : "Ladder",
  "Um das Feuer besser erreichen zu können, brauchen wir eine Drehleiter (DLA (K) 23/12)." : "Ladder",
  "Um die oberen Stockwerke zu erreichen, brauchen wir eine Drehleiter (DLA (K) 23/12)." : "Ladder",
  "Um die Löscharbeiten weiter ausführen zu können, wird eine Drehleiter (DLA (K) 23 / 12) benötigt." : "Ladder",
  "Wir erreichen den Baum nicht richtig! Wir benötigen eine DLA (K) 23/12." : "Ladder",
  "Für Dachlöscharbeiten wird eine DLA (K) 23/12 benötigt." : "Ladder",

  "Unbekannte Stoffe sind ausgetreten. Wir benötigen einen GW-Gefahrgut." : "HazMatC2",
  "Unbekannte Fässer wurden gefunden! Wir benötigen einen GW-Gefahrgut." : "HazMatC2",
  "Wir benötigen die Ausrüstung vom GW-Gefahrgut." : "HazMatC2",
  "Gefahrstoffe könnten aufgetreten sein! Wir benötigen einen GW-Gefahrgut" : "HazMatC2",
  "Hier wurden Gefäße mit unbekannten Flüssigkeiten gefunden. Wir benötigen zur Abklärung einen GW-Gefahrgut." : "HazMatC2",
  "Unbekannte Stoffe sind ausgetreten. Wir benötigen zum Messen einen GW-Messtechnik" : "HazMatC1",
  "Hier treten seltsame Gase auf. Wir benötigen zur Feststellung einen GW-Messtechnik" : "HazMatC1",
  "Zum messen des Gefahrstoffes benötigen wir einen GW-Messtechnik." : "HazMatC1",
  "Es treten unbekannte Gase aus. Wir brauchen zur Abklärung einen GW-Messtechnik." : "HazMatC1",

  "Beim Verkehrsunfall sind große Mengen Öl ausgelaufen! Wir brauchen den GW-Öl!" : "RescueC4",
  "Hier laufen größere Mengen Öl aus! Wir benötigen einen GW-Öl." : "RescueC4",
  
  "Hier muss Wasser über weite Wegstrecken transportiert werden. Wir benötigen einen GW-L2 Wasser." : "RescueC2",
  "Das Feuer ist weiter ausserhalb und alle Wasserreserven sind aufgebraucht. Wir brauchen einen GW-L2 -Wasser um weitere Schläuche verlegen zu können." : "RescueC2",
  "Wir benötigen einen GW-L2 - Wasser" : "RescueC2",
  
  "Um weiter arbeiten zu können, benötigen wir einen GW-Schiene." : "RescueC1",
};
    ...
    { var TDs = TR.getElementsByTagName("td");
      ...
      { TDs[0].style.backgroundColor="transparent";
        ...
        { if (GG && Ausb.match("Gefahrgut")==null) TDs[0].style.backgroundColor="#226622";
          ...
          if (TA && Ausb.match("Taucher")==null) TDs[0].style.backgroundColor="#222266";
        }
      }
    }
  }
...
{ var DC=document.getElementById("content");
  ...
  T += "<th rowspan='2'>Fahrzeugtyp</th>" + 
       ...
       "<th rowspan='2'>&Sigma; km</th><th rowspan='2'>&Oslash;-km</th>" +
       "</tr>\n<tr>\n";
...
// ************************************************************************************
  ...
  Info += "> Fahrzeuge sofort abhaken</td></tr></table>\n";
  ...
  // Info +="></td>";
  // Info += "<th>&nbsp;oder&nbsp;</th><td align='center'> GSG/RD zuerst <input type='checkbox' id='zweiterAbmarschAusb' ";
  ...
  if (InfotextKlasse) 
  { Info += InfoVorspann + "Einsatzklasse</th><td><font color='#d6d6d6'>" + InfotextKlasse + "</font>";
...
{ 
  ...
  H += "<a href='javascript:toggledisplay();';>AAO und Tool Script Konfiguration anzeigen</a>";
  if (ScriptUpdateAvailable != "") 
  { H += "<br><br><div align='center'><font color='red'>Hinweis: es ist ein Script-Update verfügbar!</font><br>";
    H += "<a href='" + UPDATEURL + "' target='_new'>Informationen</a> dazu";
    H += " oder gleich <a id='installURL' href='" + INSTALLURL + "' target='_new'>installieren</a>.</div>";
  }
  H += "<br><br>\n";
  NewDiv.innerHTML = H;
