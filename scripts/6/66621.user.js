// ==UserScript==
// @name وقت وصول القوات -plapl.com-tribalwars
...
if( /screen=info_village&id=(\d+)/.test(location.href) )
{
  ...
  cell.innerHTML = "معلومات وقت السفر--www.plapl.com--";
...
function updateTimes()
{
  ...
  if( v >= 4 && v < 6 && !bbvillage )
    arrivalTimeCell.innerHTML += '<br/><span class="warn">(مكافئة الليل فعال)!</span>';
