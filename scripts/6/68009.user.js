// ==UserScript==
// @name           Archetype Player Builder
// @namespace      Originally modified off of monsterkill GLB Player Builder script
// @description    For use by testers to simulate a player's build under the proposed archetypes.
...
var positionData = {
    "DE": {
        majors: ["speed","vision","agility"],
        minors: ["stamina","tackling","confidence"],
        weightOptions: 18,
        heightOptions: 3
    },
    "DT": {
        majors: ["speed","vision","agility"],
        minors: ["tackling", "stamina", "confidence"],
        weightOptions: 33,
        heightOptions: 3
    },
    "C": {
        majors: ["strength","blocking","agility"],
        minors: ["speed","stamina","vision"],
        weightOptions: 22,
        heightOptions: 2
    },
    "G": {
    ...
    "HB": {
        majors: ["vision","speed","agility","carrying"],
        minors: ["jumping","stamina","confidence","catching"],
        weightOptions: 20,
        heightOptions: 2
    },
    "WR": {
        majors: ["agility","speed","vision","catching"],
        minors: ["confidence","jumping","carrying","stamina"],
        weightOptions: 11,
        heightOptions: 2
    },
    "QB": {
        majors: ["speed","agility","carrying"],
        minors: ["strength","stamina","vision"],
        weightOptions: 9,
        heightOptions: 3
    },
    "TE": {
        majors: ["speed","agility","catching","vision"],
        minors: ["strength","stamina","jumping","confidence"],
        weightOptions: 22,
        heightOptions: 3
    },
    "FB": {
        majors: ["strength","blocking","agility","speed"],
        minors: ["confidence","vision","stamina","carrying"],
        weightOptions: 15,
        heightOptions: 3
    },
    "LB": {
        majors: ["speed","vision","agility","jumping"],
        minors: ["strength","tackling","confidence","stamina"],
        weightOptions: 9,
        heightOptions: 3
    },
    "CB": {
        majors: ["speed","agility","tackling","vision"],
        minors: ["catching","jumping","stamina","confidence"],
        weightOptions: 11,
        heightOptions: 3
    },
    "SS": {
    ...
    "K": {
        majors: ["kicking","vision","confidence"],
        minors: ["agility","jumping","strength"],
        weightOptions: 22,
        heightOptions: 2
    },
    "P": {
        majors: ["punting","vision","confidence"],
        minors: ["agility","jumping","strength"],
        weightOptions: 22,
        heightOptions: 2
    }
