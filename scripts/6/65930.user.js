// ==UserScript==
// @name          	One Manga - Manga listing thumnail
// @namespace		http://www.vietcms.com
// @description    	
// @include       	http://www.onemanga.com/directory/*
// ==/UserScript==
					...
					link.addEventListener("mouseover", function() {
						...
						GM_xmlhttpRequest({
										  ...
										  onload:function(details) {
											...
											var index = doc.indexOf('<div class="title-logo">');
											var index2 = doc.indexOf('</a>',index);
											var img = doc.substr(index, index2 - index);
											index = img.indexOf('http');
											index2 = img.indexOf('"',index);
											var src = img.substr(index, index2 - index);
											img = '<img src="'+src+'"/>';
											var contentSide = document.getElementById('content-side');
											if(contentSide.innerHTML.indexOf('myimg')==-1)
											{
												contentSide.innerHTML = '<div id="myimg" style="position:fixed; top:50; right:50;">' + img + '</div>'+contentSide.innerHTML;
											}
											else
											{
