...
// @include        http://de*.die-staemme.de/guest.php?*screen=ranking*
// ==/UserScript==
...
function gotofirst() {
	...
	a.appendChild(document.createTextNode("<-<-<- nach ganz oben"));
	a2.appendChild(document.createTextNode("Weltenstatistik"));
	a2.setAttribute('href',document.URL.substr(0,document.URL.indexOf('de/g')+3)+'stat.php?');
