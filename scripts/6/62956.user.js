...
callback.src = 'http://twitter.com/statuses/user_timeline/bungietweets.json?callback=twitterCallback2&count=5';
callback.type = 'text/javascript'; 
tweettweet.id = 'twitter_div';
tweettweet.innerHTML = '<h2>Latest Tweets <a href="http://www.twitter.com/bungietweets"><img src="/images/base_struct_images/arrow_2.gif"></a></h2><ul id="twitter_update_list"></ul>';
