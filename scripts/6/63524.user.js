...
nbHTML += '<div id="nhead"><center><a style="border-bottom:1px #000080 dotted; color: #000080;" href="http://userscripts.org/scripts/show/63524">Barra de Notas Intrepidos[M3 Kingsage.es] v'+version+'</a></center></div>';
...
// Add the style to the notebar and put the code into it
GM_addStyle("#notebar { width:400px; position:fixed; left:-400px; height:421px; top:0px; z-index: 50; background:url(http://img45.xooimage.com/files/c/7/1/p--1616a45.png); border:0px black solid;}");

GM_addStyle("#nhead { height:70px; width:400px; position:absolute; left:0px; top:0px; background:url(http://img45.xooimage.com/files/c/7/1/p--1616a45.png); line-height:38px; font-weight:bold; font-size:13px;} ");
...
GM_addStyle("#notetab { background:url(http://img25.xooimage.com/files/1/e/a/p--1616ae3.png); width:30px; height:130px; position:absolute; right:-30px; top:0px; z-index:495; } ");
