// ==UserScript==
// @name           WhatCD :: Add torrent to Deluge WebUI
// @namespace      SavageCore
// @include        http*://*what.cd/*
// @include        http://brokenstones.me*
// ==/UserScript==

//Add torrents from gazelle trackers to Deluge 1.2 WebUI
//Include other gazelle sites for them to function
...
if (host == "") { alert('You need to configure the user script with your Deluge parameters before using it.'); }
...
function match(url) {
   ...
   //Gazelle : (what.cd etc..)
   if (url.match(/htt.*:\/\/.*\/torrents\.php\?action\=download/i)) {
       return true;
   }
   // Brokenstones
