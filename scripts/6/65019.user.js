scr_meta=<><![CDATA[ 
// ==UserScript==
// @name 	Travian AutoTask | Correct IT
// @namespace   Travian
// @author 	congxz6688,deFox,Tuga,KOCCY(IT)
// @version 	1.2.4.7.K
...
case "hu": //Harrerp
		...
		aLangTaskOfText = ["Ieplānot uzlabojumus", "Ieplānot jaunas ēkas celtniecību", "Uzlabot resursus", "Izslēgt", "Uzsākt", "Ieslēgts", "Stop", "Resursu lauku izvietojums šajā ciemā", "Automātiska nosūtīšana", "Automātiska nosutīšana atslēgta", "Ieslēgts", "Veiksmīgi nosūtīts", "* Uzdevumi *", "Nepietiek tirgotāju", "Vienādi", "Izmainīt", "Koks/Māls/Dzelzis", "Labība", "Ieplānot nojaukšanu",
			...
			"Ieplānot apmācību","Train site","Kareivju apmācība pabeigta","optimizēt transportēšanu","Ievadīt laiku pēc kura atkārtot iekraušanu","Šis ir intervāls esošajai iekraušanai ,\n pēc noklusējuma - 20 min., Lūdzu ievadiet jaunu laiku:\n\n","Nepietiek tirgotāju","Ieplānot svinības","mazās svinības","lielās svinības","Uzstādīt laika intervālu resursu koncentrācijai",
			"minūtes", "apturēts", "viss notiek", "uzsākt", "apturēt","Sakārtot uzdevumus","Sakārtot uzbrukumus","Sakārtot aizsardzību"];
	...
	case "it": // thanks Koccy
		...
		aLangAddTaskText = ["Aggiungi Compito", "Stilo", "Villaggio Attivo", "Obiettivo", "Al Livello", "Modalità", "Supporto di Costruzione", "Concentrazione risorse", "Aumenta Priorità", "Diminuisci priorità", "Rimuovi", "   Attività", "Priorità", "Annulla tutte le attività"]; 
		aLangTaskKind = ["Amplia", "Nuovo Edificio", "Attacco", "Ricerca", "Addestra", "Trasporto", "NPC", "Demolire", "Festa"]; 
		maxlevel = ["10", "10", "10", "10", "0", "5", "5", "5", "5", "5", "20", "20", "20", "20", "20", "20", "20", "20", "20", "20", "20", "20", "20", "10", "20", "20", "20", "20", "20", "20", "20", "20", "20", "20", "20", "10", "20", "20", "20", "20", "100", "20"]; 
		aLangGameText = ["", "Mercanti", "ID", "Capitale", "Ora Inizio", "Impostazione non utilizzata", "al livello", "Villaggio", "trasporto", "dalla", "Trasporto alla", "Trasporto dalla", "Ritorno dalla", "risorse", "edifici", "Costruisci nuovo edificio", "vuoto", ""]; 
		aLangRaceName = ["Romani", "Teutoni", "Galli"]; 
		aLangTaskOfText = ["Programma Ampliamento", "Programma Nuovo Efificio", "Autoampliamento RES", "▮▮", "▷", "▶", "▯▯", "La distribuzione dei campi di risorse di questo villaggio è ", "Autotrasporto", "Autotrasporto chiuso", "Aperto", "Trasportato successo", "Lista Attività", "", "", "", "Legno/Argilla/Ferro", "Grano", "Distruggi",
			"Programma Attacco", "Tipo Attacco", "Tempo Percorso", "Ripeti", "volte | Intervalo di tempo","00:00:00","Obiettivo Catapulta", "Random", "Scunosciuto", "Volte", "Mese", "Giorno", "Truppe Inviate", "Programma Addestramento", "Addestra site", "Addestramento Completato","Trasporto Diverso","Imposta intervallo aggiornamento","Questo è l'intervallo di aggiornamento della pagina,\n Default: 20 minuti, Inserire nuovo valore per continuare:\n\n","","Programma Festa","festa piccola","festa grande","Imposta l'intervalo di Concentrazione di Risorse",
			"minuti","In Pausa ▮▮","In Esecuzione ▶","▷ Esegui","▯▯ Ferma","Aumenta Programmazione","Aumenta attacco","Aumenta difesa"]; 
		aLangErrorText = ["Risorse non sufficienti", "I Lavoratori Sono Pronti per Lavorare", "Edificio Completato", "Inizia Edificio", "Nella Ricerca", "Il tuo Magazzino è troppo piccolo. Amplia il Magazzino per continuare", "Il tuo Granaio è troppo piccolo. Amplia il Granaio per continuare", "Risorse sufficientemente","Mancanza di Cibo: produzione di grano insufficiente!","Pronta la Festa"]; 
		aLangOtherText = ["Nota Importante ", "Solo i Campi della Capitale possono essere ampliate al livelo 20. La tua capitale non è determinata. Visita il tuo Profilo per impostarla.", "Collegamento qui ^_^", "Avviato", "Annullato", "Inizia le attività", "Ampliamento completato con successo", "Iniziato con successo", "La tua razza non è impostata e pertanto neanche i tipi di truppe. Visita il tuo Profilo per determinare la razza.", "Visitare il Circolo degli eroi per determinare la velocità e il tipo di eroe."];
