// ==UserScript==
// @name           Grepolis Forum BB code voor aanvallen
// @namespace      http://userscripts.org/scripts/show/65163
// @description    Grepolis Berichtmaker v 1.1 - Gevechtsrapporten naar BB code zetten voor forum
// @description    Vertaald door Animalnl
// @description    thanks to http://userscripts.org/users/86073 Norm
// @include        http://*.grepolis.de/*
// @include        http://nl*.grepolis.com/*
// ==/UserScript==
...
if(location.href.match(/action=view/)) { 
  ...
  var BerichtTitel = "[b]Stad [town]"+townName[0]+"[/town] valt [town]"+townName[1]+"[/town] aan[/b]";
  for(var c = 0; c < document.getElementsByTagName('div').length; c++) {
  ...
  if (document.getElementById('ReportTextArea')) {
    ...
    BerichtMenue.innerHTML='<a onclick="document.getElementById(\'ReportTextArea\').style.display=\'block\'" href="#" class="submenu_link"><span class="left">&nbsp;</span><span class="middle">Forum BB code</span><span class="right">&nbsp;</span>&nbsp;</a>';
  ...
  if (document.getElementById('resources')) {
    ...
    if (wood) resourcesOutput+="[b]Hout:[/b] "+wood+" ";
    if (stone) resourcesOutput+="[b]Steen:[/b] "+stone+" ";
    if (iron) resourcesOutput+="[b]IJzer:[/b] "+iron+" ";
  }
  ...
  for(var c = 0; c < document.getElementsByTagName('script').length; c++) {
    if (document.getElementsByTagName('script')[c].innerHTML.match(/ReportViewer.initialize/)) {
      ...
      } else var dulOutput = 'Geen '; 
      if (document.getElementById('ReportTextArea')) {
        document.getElementById('ReportTextArea').innerHTML = "[quote]"+BerichtTitel+"\n\n"+fight_bonus+resourcesOutput+"\n\n[b]Aanvaller:[/b] [player]"+townOwner[0]+"[/player]\n"+auhOutput+"\n[b]Verlies:[/b]\n"+aulOutput+"\n\n[b]Verdediger:[/b] [player]"+townOwner[1]+"[/player]\n"+duhOutput+"\n[b]Verlies:[/b]\n"+dulOutput+"[/quote]";
      }
      break;
    }
  }  
