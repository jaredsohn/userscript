// ==UserScript==
// @name        *_____*
// @namespace   http://userscripts.org/scripts/show/111722
// @version     0.5d
// @author      !
...
// @description Reloads (aka refreshs) a webpage after a certian time. Config menu with "Shift + T". Autodetects language: English, German, Spanish
// ==/UserScript==
...
Array(English, German, Spanish, Dutch) */
reload = ['How often would you like your page to reload?  This number is in seconds.', 'In welchem Intervall -in Sekunden- soll die Seite neugeladen werden?', 'Cada cuantos segundos quiere actualizar la página?','Hoe vaak wilt u de pagina verversen?, Interval is in seconden'];
statusbar_before_time = ['', 'Die Seite wird in ', 'La página será cargada de nuevo en ','De pagina wordt in '];
statusbar_behind_seconds = [' seconds remaining...', ' Sekunden neugeladen...', ' segundos...',' seconden over...'];
statusbar_behind_minutes = [' minutes remaining...', ' Minuten neugeladen...', ' minutos...',' minuten over...'];
statusbar_behind_hours = [' hours remaining...', ' Stunden neugeladen...', ' horas...',' uren over...'];
statusbar_stop_refresh = ['The countdown has been cancelled...', 'Die Aktualisierung wurde abgebrochen...', 'La cuenta atrás ha sido cancelada...', 'Het aftellen is geannuleerd...'];
offline_box_message = ['Lost connection to site. Page will be reloaded, when the connection is restored...','Verbindung fehlgeschlagen. Die Seite wird neugeladen, sobald wieder eine Verbindung besteht... ','Pérdida de conexion. La página será recargada cuando se recupere la conexion...','Verbinding met site verbroken. Als de verbinding is hersteld, zal de pagina opnieuw worden geladen...'];
options_title = ['\"Auto F5 reload window\" options', 'Optionen für \"Auto F5 reload window\"', 'Opciones de \"Auto F5 reload window\"','\"Auto F5 reload window optie\'s\"'];
options_default_timeout = ['Default timeout', 'Standardtimeout', 'Tiempo de recarga estándar','Standaard timeout'];
options_timeout = ['Timeout for this page', 'Timeout der aktuellen Seite', 'Tiempo de recarga de esta página','Timeout voor deze pagina'];
options_random = ['Add random value to timeout between 0 and', 'Zufallswert zu Timeout hinzufügen. Zwischen 0 und', 'Añadir número aleatorio entre 0 y','Voeg een willekeurige waarde aan timeout toe, tussen 0 en'];
options_hotKeys = ['Show and hide menu ', 'Menü ein- und ausblenden ', 'Mostrar y esconder menu ','Toon en verberg menu '];
options_separators = ['Ignore everything after these symbols in URL(separate with spaces)', 'Ignoriere URLs nach folgenden Symbolen(mit Leerzeichen trennen)', 'Ignorar todo despues de estos símbolos en URLs (separar con espacios)','Negeer alles na deze symbolen in URL(gescheiden door spatie\'s)'];
options_separators_incl = ['Include the separators in the URL saved', 'Speichere URLs einschließlich Trennsymbole', 'Incluir separadores en la URL','Scheidingstekens insluiten in de opgeslagen URL'];
options_autoclose = ['Hide menu when clicking outside the menu', 'Bei Click außerhalb des Menüs, Menü ausblenden', 'Ocultar menú al clickear fuera del menú','Verberg menu als er buiten het menu wordt geklikt'];
options_click_extend = ['Prolong timeout on mouseclicks or keyboard input', 'Bei Mausklicks oder Tastatureingaben Timeout hinauszögern', 'Prolongar cuenta atras cliqueando o tecleando','Verleng timeouts muis klik of toetsenbord invoer'];
options_refresh_all = ['Reload all pages with default timeout, which has no timeout set', 'Aktualisiere alle Seiten mit Standardtimeout, für die kein Timeout gesetzt wurde', 'Actualiza todas las páginas con tiempo de recarga estándar, sin propio tiempo de recarga','Herlaad alle pagina\'s met standaard time-out, welke niet ingesteld zijn op standaard'];
options_btn_ok = ['OK', 'OK', 'OK', 'OK'];
options_btn_cancel = ['Cancel', 'Abbrechen', 'Cancelar','Annuleren'];
options_btn_abort = ['Abort reload', 'Neuladen verhindern', 'Abortar recarga','Herladen afbreken'];
options_number_format = ['Format examples: hh:mm:ss, h:m:ss, m:sss, s etc. like 1:20:30 oder 500 oder 3:100', 'Formatbeispiele: hh:mm:ss, h:m:ss, m:sss, s, also 1:20:30 oder 500 oder 3:100','Ejemplos de formato: hh:mm:ss, h:m:ss, m:sss, s etc. como 1:20:30 oder 500 oder 3:100','Formaat voorbeelden: hh:mm:ss, h:m:ss, m:sss, s etc. zoals 1:20:30 of 500 of 3:100'];
num_err_default = ['Please enter a positiv numeric value for default timeout.', 'Bitte eine positive ganze Zahl für Standardtimeout eingeben.', 'Introducir número entero y postivo de tiempo de recarga estándar por favor', 'A.u.b. voer een positief getal in voor standaard time-out'];
num_err_timeout = ['Please enter a positiv numeric value for timeout.', 'Bitte eine positive ganze Zahl für Timeout eingeben.', 'Introducir número entero y postivo de tiempo de recarga por favor','A.u.b. voer een positief getal in voor time-out'];
num_err_random = ['Please enter a positiv numeric value for random value.', 'Bitte eine positive ganze Zahl für Zufallszahl eingeben.', 'Introducir número entero y postivo de número aleatorio por favor','A.u.b. voer een positief getal in voor een willekeurige waarde'];
time_format_err = ['Please do not enter more than three \':\'', 'Bitte nicht mehr als drei \':\' eingeben', 'No poner mas de tres \':\' por favor','A.u.b. voer niet meer dan drie \':\''];
hotkey_err = ['Please enter a hotkey.', 'Bitte geben Sie ein Hotkey ein.', 'Por favor introduzca un hotkey.','A.u.b. voer een sneltoets in']; 
...
if (timeoutset || refresh_all) {
	...
	var rand = Math.round(Math.random()*random);
