// ==UserScript==
// @name           Feyntube Comment Snob
// @description    Replaces any poor comments with Richard Feynman quotes. Combines the FeynTube and YouTube Comment Snob scripts.
...
var tests = [
    ...
    [/\b(retard)/i, 'Used a naughty word'],
];
...
function hide(element, reason) {
    ...
    d.innerHTML = 'Show comment (REASON)'.replace('REASON', reason) + '<br />' + quotes[Math.floor(Math.random() * quotes.length)];
    d.style.color = 'grey';
