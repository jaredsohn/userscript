	...
	function startDemonow(vi, demotask){//"7_" + theID +"_" + crtlevel + "_" + currentID() + "_" + theBuild;
		...
		GM_xmlhttpRequest({
			...
			onload: function(response){
				...
				calldoing1()
				printMSG(aLangTaskKind[7].fontcolor("red")+" "+demotask[4]+" "+ aLangOtherText[7]+"!");
				window.location.href=myhost + "/dorf1.php"
			},
		})
	}
	...
	function createTaskListTable(){
		...
		if (taskss != "false") {
			...
			for (i in tasks) {
				...
				switch (thisTask[0]) {
					case "0": // 0_id_level_time_name
						if (thisTask[1] < 19) {
							taskStr = aLangTaskKind[0].fontcolor("green") +"&#160;"+ thisTask[4] + "&#160;&#160;" + aLangGameText[2] + ": " + thisTask[1] + "&#160;&#160;" + aLangAddTaskText[4] + ":" + aLangGameText[0] + thisTask[2];
						}
						else 
					...
					case "1": // 1_id_level_gid_time_name
						taskStr = aLangTaskKind[1].fontcolor("green") +"&#160;" +aLangAllBuildWithId[parseInt(thisTask[3])] + "&#160;&#160;" + aLangGameText[2] + ":" + thisTask[1] + "&#160;&#160;" + aLangAddTaskText[4] + ": " + aLangGameText[0] + thisTask[2];
						break;
					case "2": // 2_targetPosition_kind_repeat_startTime_interval_troops_kata1_kata2    
						...
						if (Xlang == "com") {
							...
							taskStr = aLangAttackType[thisTask[2] - 2].bold(1).fontcolor("black") + ": " + targetcoord + "&#160;&#160;" + month + "." + aLangTaskOfText[29] + "&#160;" + days + "." + aLangTaskOfText[30] + "&#160;" + aLangTaskOfText[51] + "&#160;" + starttime.toLocaleTimeString() + "&#160;&#160;" + (Number(thisTask[3]) + 1) + " " + aLangTaskOfText[28];
						}
					...
					case "6": // 6_1_1000_1245413194000
						...
						break;
					case "7": // "7_" + theID +"_" + crtlevel + "_" + currentID() + "_" +theBuild
						taskStr=aLangTaskKind[7].fontcolor("red") +" "+thisTask[4]+"&#160;"+aLangGameText[17]+thisTask[2]+"&#160;"+aLangAddTaskText[4]+ ": " +aLangGameText[17]+"0"
						break;
					case "8": // 8_241654_500,500,500,500_0_1245413194000_interval
			...
			aTd5.setAttribute("colspan", "4");
				...
				aTd7.align="right"
				aTd7.innerHTML="&#160;&#160;"+"<a href='http://userscripts.org/scripts/show/62787' id='verdisp'  target='_blank'>"+crtVersion+"</a>"
