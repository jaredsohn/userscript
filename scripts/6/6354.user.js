...
// @namespace      http://www.myspace.com/iforgotmyemoquote
...
messages = true;
messageIcon = 'http://x.myspace.com/images/icon_envelope.gif';
friendrequests = true;
friendrequestIcon = 'http://x.myspace.com/images/icon_envelope.gif';
comments = true;
commentIcon = 'http://x.myspace.com/images/icon_envelope.gif';
imgcomments = true;
imgcommentIcon = 'http://x.myspace.com/images/icon_envelope.gif';
blogComments = true;
blogCommentIcon = 'http://x.myspace.com/images/icon_envelope.gif';
blogSubscriptions = true;
blogSubscriptionIcon = 'http://x.myspace.com/images/icon_envelope.gif';
events = true;
eventIcon = 'http://x.myspace.com/images/icon_envelope.gif';
birthdays = true;
