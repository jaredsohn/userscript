...
// @version           1.8.9 PG Hamburg reloaded eingebaut 
// @version           1.8.8 Anzeige wieder gefixt
// @version           1.8.7 Koeln Bugfix
// @version           1.8.6 Koeln Update
// @version           1.8.5 Fix Hintergund habe jetzt den original Link gefunden
// @version           1.8.4 2011 FIX Danke an Nixen für den Tip
// @version           1.8.3 Hhalloween Update
// @version           1.8.2 Malle Update
	...
	onload: function(responseDetails) {
		...
		if(content.match(/bereits auf/)){
			try{
				...
				var TimeOfImpact2 = content.split(".2011")[1].split("<br />")[0];
...
// male http://i45.tinypic.com/17zojs.png   -  http://i47.tinypic.com/2zz3n86.png
					...
					tbody.innerHTML += '<div style="height: 108px; top: 98px; left: -1px; padding-top:3px;  background: url(http://static.pennergame.de/img/pv4/bg_notifyme.png);" id="notifyme" class="zabsolute zleft"><div style="margin-top:-2px; margin-right:-12px; margin-left:-4px;" class="icon ok zleft" id="nicon">&nbsp;</div><div style="margin-top:16px;" class="zleft right" id="ntext"><font style=\"color:#000000; font-size:106%;\"><u><b>Dein laufender Kampf:</b></u></font><p><div style=\"color:#000000; font-size:12px; margin-right:-55px;\">'+penner+' <div style=\"margin-left:175px; margin-top:-32px; margin-bottom:17px;\">'+onlinex+'&nbsp;'+sms+'&nbsp;'+geschlecht_imagex+'</div></div><div style=\"color:#000000; font-size:12px; margin-top:-8px; margin-right:-55px;\">'+bande+'</div><div style=\"color:#000000; font-size:12px; margin-right:-35px;\">Geld:<font style=\"color:#006400; font-size:12px;\"> <b>'+cash6+'&euro; </b><font style=\"color:#000000; font-size:12px;\"> &nbsp; Ende:</font><b><font style=\"color:#006400; font-size:12px;\">'+TimeOfImpact2+'</b></font></font>Uhr</div></font></div></div>';
...
var cash3 = cash/100;
var tbody = document.getElementsByClassName('zabsolute zleft')[0];
tbody.innerHTML += '<div style="height: 108px; top: 98px; left: -1px; padding-top:3px;  background: url(http://static.pennergame.de/img/pv4/bg_notifyme.png);" id="notifyme" class="zabsolute zleft"><div style="margin-top:-2px; margin-right:-10px; margin-left:-4px;" class="icon ok zleft" id="nicon">&nbsp;</div><div style="margin-top:16px;" class="zleft right" id="ntext"><font style=\"color:#000000; font-size:12px;\"><u><b>Achtung:</b></u></font><p>Dein Ziel hat soeben Geld ausgegeben oder dazuverdient bitte checke ob der angriff sich noch lohnt. Aktuelles Geld des Gegners<font style=\"color:'+color+'; font-size:11px;\"><b> '+cash3+'</b></font>.</div></div>';
}
}
...
//http://static.pennergame.de/img/pv4/events/easter/profil_wiesendeko.png
		...
		else if(geschlechty == 'events/easter/profil_wiesendeko.png'){var geschpic2 = "http://i47.tinypic.com/2zz3n86.png";}
...
var cash3 = cash/100;
var tbody = document.getElementsByClassName('zabsolute zleft')[0];
tbody.innerHTML +='<div style="height: 108px; top: 98px; left: -1px; padding-top:3px;  background: url(http://static.pennergame.de/img/pv4/bg_notifyme.png);" id="notifyme" class="zabsolute zleft"><div style="margin-top:-2px; margin-right:-10px; margin-left:-4px;" class="icon fight zleft" id="nicon">&nbsp;</div><div style="margin-top:16px;" class="zleft right" id="ntext">'
+'<font style=\"color:#000000; font-size:106%;\"><u><b>Eingehende K&auml;mpfe  '+anzahl+'</b></u></font><p>'
+'<div style=\"color:#000000; font-size:12px; margin-right:-55px;\">Name: <a href="/profil/id:'+id2+'/"><font style=\"color:#006400; font-size:12px;\"><b>'+name+'</b></font></a><div style=\"margin-left:175px; margin-top:-32px; margin-bottom:17px;\">'+online+'&nbsp;'+sms2+'&nbsp;'+geschlecht_imagex2+'</div></div>'
+'<div style=\"color:#000000; font-size:12px; margin-top:-8px; margin-right:-55px;\">Bande: <a href="/profil/bande:'+id21+'/"><font style=\"color:#006400; font-size:12px;\"><b>'+name1+'</b></font></a></div>'
...
var tbody = document.getElementsByClassName('zabsolute zleft')[0];
tbody.innerHTML += '<div style="height: 108px; top: 98px; left: -1px; padding-top:3px;  background: url(http://static.pennergame.de/img/pv4/bg_notifyme.png);" id="notifyme" class="zabsolute zleft"><div style="margin-top:-2px; margin-right:-10px; margin-left:-4px;" class="icon ok zleft" id="nicon">&nbsp;</div><div style="margin-top:16px;" class="zleft right" id="ntext"><font style=\"color:#000000; font-size:12px;\"><u><b>Achtung</b></u></font><p>Dein Ziel hat sich gerade ein oder ausgelogt aktueller Status deines Gegners  '+wasistlos+'.</div></div>';
}
}});
}});
}
