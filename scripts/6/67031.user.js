...
// get the div id
  whiskyLoc = document.body.innerHTML.match(/app[0-9]{1,}_profile_whisky_quantity/);
  // get the quantity
  whiskyCount = document.getElementById(whiskyLoc).innerHTML;
  
  // do something :))
  if(whiskyCount == 0 ) {
    alert("Whisky abis gan!");
    document.location = 'http://apps.facebook.com/ghost-trappers/setup.php?type=whisky'; // buy whisky
  }