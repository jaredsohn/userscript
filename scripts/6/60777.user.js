...
function LalaFaviconAlerts() {
	...
	this.construct = function() {
		...
		this.title = 'Lala Favicon Alerts';
		this.eventName = 'currentTrack';
		this.wasPlaying = false;
		// Register Growl Commands
		GrowlMonkey.register(this.title, "http://peterwooley.com/projects/greasemonkey/lalafaviconalerts/1.0/logo.png", [{name:this.eventName, displayName:'The current track playing in Lala.', enabled:true}]);
	...
	this.sendNotification = function() {
		...
		GrowlMonkey.notify(self.title, self.eventName, 'Currently Playing...', document.getElementById('headerTrackTitle').textContent + ' by ' + document.getElementById('headerTrackArtist'));
	}
