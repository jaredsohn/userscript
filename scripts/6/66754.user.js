...
(function() {
	function selectall () {
		alert('here');
		cont = document.getElementsByTagName('ul').getElementById('friends').getElementsByTagName('li');
		for ( i=0; i<cont.length; i++) {
			temp = cont[i].getElementsByTagName('a');
			temp[0].click();
		}
	}
	inter = 0;
