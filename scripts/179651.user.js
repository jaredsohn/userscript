// ==UserScript==
// @name		Facebook Otamatik Beğendirici
// @namespace           Durum ve Yorumları Otamatik Beğenir.  
// @description		Tek yapmanız gereken menüdeki butonları kullanmak - fb.com/dol0r
// @author		way2hacking
// @authorURL		http://www.way2hacking.com/2013/03/how-to-auto-like-all-status-and.html	
// @homepage		facebook
...
div.innerHTML = "<a style='font-weight:bold;color:#3B5998' onclick='AutoLike()'><center>Durumları Beğen</center></a></a>"
   body.appendChild(div);
...
div.style.border = "1px solid #6B84B4";
div.style.padding = "3px";
div.innerHTML = "<a style='font-weight:bold;color:#3B5998' onclick='LikeComments()'><center>Yorumları Beğen</center></a>"
...
div.style.backgroundColor = "#E7EBF2";
div.style.border = "1px solid #6B84B4";
div.style.padding = "3px";div.innerHTML = "<a style='font-weight:bold;color:#3B5998' onclick='BugInfo()'><center>Hataları Bildir</center></a></a>"
body.appendChild(div);unsafeWindow.BugInfo = function() {
window.open(this.href='http://facebook.com/dol0r', 'dmfollow', 'toolbar=0,location=0,statusbar=1,menubar=0,scrollbars=no,width=400,height=255');return false;
};}
...
div.style.border = "1px solid #6B84B4";
div.style.padding = "3px";
    div.innerHTML = "<b><center><a href='http://yuceltoluyag.blogspot.com'>Daha Fazlasını İste !!</a></center></b>"
body.appendChild(div);}
