// ==UserScript==
// @name           PowerTools - ANAKYN- ITALIANO
// @namespace      KYN
// @include        http://*.kingdomsofcamelot.com/*main_src.php*
// @description    Migliorie e correzione dei bugs in Kingdoms of Camelot - tasto nome ally automatico - mappa server 157 -
...
var Title = 'KOC Power Tools - BLoods  - ITALIANO';
  ...
  init : function (div){
    ...
    try {      
      m = '<TABLE class=ptTab>\
        ...
        <TR><TD><INPUT id=ptAllowWinMove type=checkbox /></td><TD>Attiva il movimento della finestra (ti permette di muovere la finestra de \'I Moschettieri\' col mouse)</td></tr>\
...
//**********************************
      ...
      str += '<TR><TD></td><TD colspan=4>PowerTools - I Moschettieri by Leon</td></tr>';
      str += "</table>";
      if (DEBUG_BUTTON)
...
function CdialogCancelContinue (msg, canNotify, contNotify, centerElement){
  ...
  pop.getTopDiv().innerHTML = '<CENTER>KOC Power Tools - I Moschettieri</center>';
