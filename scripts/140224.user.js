// ==UserScript==
// @name           Tiberium Alliances Combat Simulator in Italiano
...
// @author Translate          Hellcco, luke11luke
// @Language       Italian
      ...
      qx.Class.define("TASuite.main", {
        ...
        members: {
          ...
          initialize: function () {
            ...
            this.buttons.attack.simulate = new qx.ui.form.Button("Simula");
            this.buttons.attack.simulate.set({
              width: 58,
              appearance: "button-text-small",
              toolTipText: "Avvia simulazione"
            });
            ...
            this.buttons.attack.unlock = new qx.ui.form.Button("Sblocca");
            this.buttons.attack.unlock.set({
              width: 55,
              height: 46,
              appearance: "button-text-small",
              toolTipText: "Sblocca Pulsante d'attacco"
            });
      ...
      qx.Class.define("TASuite.main", {
        ...
        members: {
          ...
          initializeStats: function (tabView) {
            // ////////////////Stats ////////////////////
            this.statsPage = new qx.ui.tabview.Page("Statistiche");
            ...
            eHBox1.add(new qx.ui.basic.Label("Base Nemica: "));
            ...
            eHBox4.add(new qx.ui.basic.Label("Difesa: "));
            ...
            eHBox5.add(new qx.ui.basic.Label("Strutture: "));
            ...
            eHBox2.add(new qx.ui.basic.Label("Cantiere: "));
            ...
            eHBox3.add(new qx.ui.basic.Label("Stazione di Difesa: "));
            ...
            eHBox6.add(new qx.ui.basic.Label("Centro di Comando: "));
            ...
            this.labels.supportlevel = new qx.ui.basic.Label("Supporto lvl ");
            ...
            tHBox1.add(new qx.ui.basic.Label("Tempo di Riparazione: "));
            ...
            tHBox5.add(new qx.ui.basic.Label("Complessivo: "));
            ...
            tHBox2.add(new qx.ui.basic.Label("Fanteria: "));
            ...
            tHBox3.add(new qx.ui.basic.Label("Veicoli: "));
            ...
            tHBox4.add(new qx.ui.basic.Label("Velivoli: "));
            ...
            hBox2.add(new qx.ui.basic.Label("Risultato: "));
            this.labels.damage.outcome = new qx.ui.basic.Label("Sconosciuto");
            ...
            hBox1.add(new qx.ui.basic.Label("Tempo di Battaglia: "));
          ...
          initializeLayout: function (tabView) {
            // ////////////////Layouts ////////////////////
            var layoutPage = new qx.ui.tabview.Page("Formazioni");
            ...
            // Load button
            this.buttons.attack.layout.load = new qx.ui.form.Button("Carica");
            this.buttons.attack.layout.load.set({
              width: 80,
              appearance: "button-text-small",
              toolTipText: "Carica Formazione salvata."
            });
            this.buttons.attack.layout.load.addListener("click", this.loadCityLayout, this);
            layHBox.add(this.buttons.attack.layout.load);
            // Delete button
            this.buttonLayoutDelete = new qx.ui.form.Button("Cancella");
            this.buttonLayoutDelete.set({
              width: 80,
              appearance: "button-text-small",
              toolTipText: "Cancella Formaizione salvata."
            });
          ...
          initializeInfo: function (tabView) {
            ...
            var proHelpBar = new qx.ui.basic.Label().set({
              value: "<a target='_blank' href='http://userscripts.org/scripts/discuss/138212'>Forum</a>",
			  rich: true
            });
            ...
            infoPage.add(psVBox);
            psVBox.add(new qx.ui.basic.Label("Bottino"));
            // Tiberium
          ...
          initialize: function () {
            ...
            this.buttons.simulate.back.set({
              width: 80,
              appearance: "button-text-small",
              toolTipText: "Cambia Formazione d'attacco"
            });
            ...
            this.buttons.attack.unlock.set({
              ...
              height: 46,
              appearance: "button-text-small",
              toolTipText: "Sblocca Pulsate D'attacco"
            });
            this.buttons.attack.unlock.addListener("click", this.unlockAttacks, this);
            this.buttons.attack.unlock.setOpacity(0.5);
            armyBar.add(this.buttons.attack.unlock, {
            ...
            this.buttons.attack.unlockReset = new qx.ui.form.Button("Sblocca");
            this.buttons.attack.unlockReset.set({
              width: 55,
              height: 42,
              appearance: "button-text-small",
              toolTipText: "Sblocca Pulsante Reset Formazione"
            });
            ...
            this.buttons.attack.tools = new qx.ui.form.Button("Strumenti");
            this.buttons.attack.tools.set({
              width: 64,
              appearance: "button-text-small",
              toolTipText: "Apri Strumenti"
            });
            ...
            this.battleResultsBox = new qx.ui.window.Window("Simulatore d'Attacco");
          ...
          updateStatsWindow: function () {
            ...
            this.labels.supportlevel.setValue('Supporto lvl ' + SLabel + ': ');
