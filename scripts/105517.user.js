// ==UserScript==
// @name           The West - Notepad [SOM]
// @namespace      http://scripts-o-maniacs.leforum.eu
// @description    A Notepad for The-West [SOM - Scripts-O-Maniacs] [Multilingual] - 1.1.1
...
// @include        http://userscripts.org/scripts/review/105517*
// @version        1.1.1
//
// @history        1.1.1|31/08/2011 Added Spanish translations, thanks to William Manney.
// @history        1.1.0|25/08/2011 Added Polish translations, thanks to Darius II.
// @history        1.0.9|20/08/2011 Bug fix when deleting a note.
// @history        1.0.9|20/08/2011 Automatic updater updated.
// @history        1.0.9|20/08/2011 Added Brazilian/Portuguese translations, thanks to CWalter.
// @history        1.0.8 Script moved to another account since Dun has stopped to play The-West. Thanks again for all his work !
    ...
    (function(f) {
        ...
        switch(loc) {
			...
			case "pt":
				loc = "br";
			case "br": // Cwalter
				lang.mainmenu.title="Notas";  
				lang.mainmenu.savednotes="Salvar Nota";  
				lang.mainmenu.nonotes="Sem Nota.";  
				lang.mainmenu.nonotes2="Sem Nota";  
				lang.mainmenu.object="Objeto";  
				lang.mainmenu.content="Conteúdo";  
				...
				lang.text="Texto";  
				lang.save="Salvar";  
				lang.valid.text="Digite a nota!";  
				lang.del="Excluir";  
				lang.deltext="Excluir esta nota";  
				lang.name="Nota";  
				lang.delconfirm="Excluir nota ?";  
				lang.restart_confirm="Excluir todas as notas ?"  
				break; 
			case "pl": // Darius II
				lang.mainmenu.title="Notatnik";
				lang.mainmenu.savednotes="Notatka zostałą zapisana.";
				lang.mainmenu.nonotes=" —— Brak notatek. ——";
				lang.mainmenu.nonotes2="Notatka nie została zapisana";
				lang.mainmenu.object="Nazwa";
				lang.mainmenu.content="Szczegóły";
				lang.writenew="Dodaj nową totatkę";
				...
				lang.text="Treść";
				lang.save="Zapisz";
				lang.valid.text="Musisz wypełnić wszystkie pola!!!";
				lang.del="Usuń";
				lang.deltext="Usuń notatkę";
				lang.name="Notatka";
				lang.delconfirm="Usunąć tą notatnkę?";
				lang.restart_confirm="Usunąć wszystkie notatki?";
				break;
			case "es": // William Manney
				lang.mainmenu.title="Notas";
				lang.mainmenu.savednotes="Salvar Nota";
				lang.mainmenu.nonotes="Sin Notas Registradas";
				lang.mainmenu.nonotes2="Sin Registro";
				lang.mainmenu.object="Tema";
				lang.mainmenu.content="Resumen";
				lang.writenew="Añadir Nota";
				lang.new="Nueva Nota";
				lang.edit="Editar Nota";
				lang.prev="Previsualizar";
				lang.title="Título";
				lang.text="Texto";
				lang.save="Guardar";
				lang.valid.text="Introduce una nota!";
				lang.del="Borrar";
				lang.deltext="Borrar esta nota";
				lang.name="Nota";
				lang.delconfirm="Borrar nota?";
				lang.restart_confirm="Borrar todas las notas?"
				break;
            default:
