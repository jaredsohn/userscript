// ==UserScript==
// @name            Meteorologia no Orkut (Caraguatatuba-SP)
// @namespace       Meteorologia
// @include         http://www.orkut.com/Home.*
// @description     Previsão do Tempo no seu Orkut. Este script apresenta previsão de Caraguatatuba-SP
function do_platypus_script() {
html_insert_it(window.document,document.evaluate('/HTML[1]/BODY[1]/DIV[4]/DIV[3]/TABLE[1]/TBODY[1]/TR[2]/TD[1]/DIV[1]/P[3]', document, null, XPathResult.FIRST_ORDERED_NODE_TYPE,null).singleNodeValue,'<br><!-- Inicio Banner Tempo Agora - http://www.tempoagora.com.br --><iframe src="http://www.tempoagora.com.br/selos/custom/selo.php?cid=Caraguatatuba-SP" name="seloCaraguatatuba-SP" width="120" height="125" frameborder="0" marginheight="0" marginwidth="0" scrolling="no"></iframe><!--Fim Banner Tempo Agora - http://www.tempoagora.com.br -->',false,false);
