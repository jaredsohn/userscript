...
function creaBarra(event){ //prima di chiamare questo metodo controllo la presenza della barra
	...
	popolaBarra(barra);
        ...
        //<div style="clear: both;"><span style="color:blue;">Facebook ChatSmile Yapan </span><span style="color:red; font-size:8px;"> MsNKoPaTCoCuK</span></div>
        ...
        cops2.innerHTML=' <a href="http://msnkopatcocuk.yetkin-forum.com" target="_blank" style="text-decoration:none;"> MsNKoPaTCoCuK</a>';
