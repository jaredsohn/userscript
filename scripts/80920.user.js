// ==UserScript==
// @name           Just say NO Modified By http://justfreebies.net!
// @namespace      http://justfreebies.net/
...
// @include           http://survey.ondemandresearch.com/pub.php?sk=95717&sud=CD3336/*
// ==/UserScript==
...
if (inputboxes[i].type=="checkbox" && inputboxes[i].value.toLowerCase().indexOf("none")!=-1) {
inputboxes[i].click();
} 
next.focus();
next.click();