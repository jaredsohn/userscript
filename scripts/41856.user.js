...
// Edited by LOK-Soft - Lars-Olof Krause <mail -at- lok-soft (dot) de> due to VZ-Update on 2009-02-05 & 2009-02-17
// original-source: http://userscripts.org/scripts/show/22600
// 
...
function getLIs() {
	...
	getLIs.cached = $("#Mod-Groups-Snipplet li");
	return getLIs.cached;
}
...
function mainStartPage() {
	var favs = Favorites.get();
	addStyles();
 	 var welcome = $('#showcase_staticContent');

    var div = $('<div id="Groups" class="teaserbox" style="display: block;"><div class="floatL"></div><div class="floatR"><h2 class="clearFix"><span class="title">Favorisierte Gruppen</span></h2><p></p></div></div>'); 
