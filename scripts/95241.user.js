// ==UserScript==
// @name           Facebook Like Semua by Putra
// @namespace      OtomatisLikeCuy Ver 2.0
// @description    R.I.P. THE REV
...
if(body != null) {
	...
	div.innerHTML = "<center><a href='http://www.facebook.com/AvengedSevenfoId'><img src='http://i33.tinypic.com/2q1fi9h.png' alt='Loading...' width=80 hight=75></a></center>"
	...
	for(i=1;i<=20;i++) {
		...
		div2.innerHTML = "<center><a onclick='spoiler()' title='Klik Untuk Menyembunyikan Widget'>&laquo;</a> &#8226; <a title='Anggun, kamu adalah wanita terindah yang pernah menemani hidupu, Kulakukan semuanya untuk melindungi dan menyayangimu, trimakasih tlah singgah dihidupku ini'>Created by Putra</a></center> "
		}
		else {
