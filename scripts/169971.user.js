// ==UserScript==
// @name        Show Twitter Created Date & Tweets Per Day
// @version     0.1
...
// ==/UserScript==
	...
	var newspan = target.appendChild(document.createElement('span'));
		...
		newspan.setAttribute('style', 'font-size: 13px !important;');
		...
		onload: function(response) {
		  ...
		  //GM_log(response.responseText);
			...
			newspan.innerHTML = ' ' + raverage + ' Tweets / Day'+'<br />' + "Created at: " + pdate ;
