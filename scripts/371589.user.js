...
form.elements.namedItem('stationFrom').value='PANVEL (PNVL)';
form.elements.namedItem('stationTo').value='TRIVANDRUM CNTL (TVC)';
form.elements.namedItem('boardPoint').value=form.elements.namedItem('stationFrom').value;
form.elements.namedItem('day').value='13';
form.elements.namedItem('month').value='12';
form.elements.namedItem('classCode').value='AC 3 Tier(3A)';
form.elements.namedItem('trainNo').value='6345';
...
form.elements.namedItem('passengers[0].passengerName').value='prapul kumar';
form.elements.namedItem('passengers[0].passengerAge').value='24';
