// ==UserScript==
// @name           Feuerwache.net Fahrzeugvorschlaege by CarstenR
// @description    schlaegt Fahrzeuge zu Einsatzstichworten vor incl. Stadterweiterung
// @include        http://www.feuerwache.net/*
// @author         CarstenR  Grundbau: sawos, tfm94 und andere
// @version        2011-02-01 12:00
// ==/UserScript==
...
var UPDATEURL="http://userscripts.org/scripts/show/63127";
// unter welchem URL finde ich das Script als Installation?
var INSTALLURL="http://userscripts.org/scripts/source/63127.user.js";
...
var Einsatzklassen = {
  ...
  //
  //   Flughafeneinsätze:
  //   Bei den Flughafeneinsätzen muss hinter das Stichwort " sp" gesetzt werden, dann dafür eine Klasse angegeben werden.
  //   Es kann auch z.B. so der Gewerbebrand zweimal angegeben werden, einmal ür Flughafen, und einmal ohne.
  //   Alle Flughafeneinsätze die hier nicht extra konfiguriert werden, wird die Einsatzklasse "FL" zugewiesen.
  
  
  'Auffahrunfall'               : {FZ: 'F1+GW-Öl',      wiki: 'Auffahrunfall',                   RD: 'RTW'},
  'Baum auf Auto'               : {FZ: 'TH2',           wiki: 'Baum_auf_Auto',                   RD: 'RTW'},
  'Baum auf Dach'               : {FZ: 'TH1+DL',        wiki: 'Baum_auf_Dach',                   RD: 'RTW'},
  'Baum auf Straße'             : {FZ: 'TH1',           wiki: 'Baum_auf_Stra%C3%9Fe',            RD: 'RTW'},
  'Brand in KFZ-Werkstatt'      : {FZ: 'F2+TLF,KW' ,    wiki: 'Brand_in_KFZ-Werkstatt',          RD: 'RTW'},
  'Brand in Schule'             : {FZ: 'F4+GW-A|TLF',   wiki: 'Brand_in_Schule',                 RD: 'RTW'},
  'Brand in Spedition'          : {FZ: 'F4+RW,TLF,GW-L2|GW-M,GW-G',     wiki: 'Brand_in_Spedition',              RD: 'RTW'},
  'Brand in Sporthalle'         : {FZ: 'F5',            wiki: 'Brand_in_Sporthalle',             RD: 'RTW'},
  'Brand im Sägewerk'           : {FZ: 'F5',            wiki: 'Brand_im_S%C3%A4gewerk',          RD: 'RTW'},
  'Brand im Supermarkt'         : {FZ: 'F3|KW',         wiki: 'Brand_im_Supermarkt',             RD: 'RTW'},
  'Brennende Bäume'             : {FZ: 'F1',            wiki: 'Brennende_B%C3%A4ume',            RD: 'RTW'},
  'Brennende Telefonzelle'      : {FZ: 'F0',            wiki: 'Brennende_Telefonzelle',          RD: 'RTW'},
  'Brennender LKW'              : {FZ: 'F2',            wiki: 'Brennender_LKW',                  RD: 'RTW'},
  'Brennender PKW'              : {FZ: 'F1',            wiki: 'Brennender_PKW',                  RD: 'RTW'},
  'Brennendes Gras'             : {FZ: 'F1',            wiki: 'Brennendes_Gras',                 RD: 'RTW'},
  'Chemieunfall (an Schule)'    : {FZ: 'GSG',           wiki: 'Chemieunfall_%28an_Schule%29',    RD: 'RTW'},
  'Chlorgas Alarm (Schwimmbad)' : {FZ: 'GSG',           wiki: 'Chlorgas_Alarm_%28Schwimmbad%29', RD: 'RTW'},
  'Container Brand'             : {FZ: 'F1',            wiki: 'Containerbrand',                  RD: 'RTW'},
  'Dachstuhlbrand'              : {FZ: 'F3',            wiki: 'Dachstuhlbrand',                  RD: 'RTW'},
  'Fahrstuhl - Türöffnung'      : {FZ: 'TH1',           wiki: 'Fahrstuhl-T%C3%BCr%C3%B6ffnung',  RD: 'RTW'},
  'Fettbrand in Pommesbude'     : {FZ: 'F2+TLF',        wiki: 'Fettbrand_in_Pommesbude',         RD: 'RTW'},
  'Feuer im Altenheim'          : {FZ: 'F4+GW-A',       wiki: 'Feuer_im_Altenheim',              RD: 'RTW'},
  'Feuer im Laubhaufen'         : {FZ: 'F1',            wiki: 'Feuer_im_Laubhaufen',             RD: 'RTW'},
  'Gartenlaubenbrand'           : {FZ: 'F1',            wiki: 'Gartenlaubenbrand',               RD: 'RTW'},
  'Gastronomiebrand'            : {FZ: 'F3+LF',         wiki: 'Gastronomiebrand',                RD: 'RTW'},
  'Kellerbrand'                 : {FZ: 'F2',            wiki: 'Kellerbrand',                     RD: 'RTW'},
  'Keller unter Wasser'         : {FZ: 'LF/RW',         wiki: 'Keller_unter_Wasser',             RD: 'RTW'},
  'Kinobrand'                   : {FZ: 'F4+GW-A|TLF',   wiki: 'Kinobrand',                       RD: 'RTW'},
  'Motorrad-Brand'              : {FZ: 'F1',            wiki: 'Motorradbrand',                   RD: 'RTW'},
  'Mülleimer Brand'             : {FZ: 'F0',            wiki: 'M%C3%BClleimerbrand',             RD: 'RTW'},
  'Scheunenbrand'               : {FZ: 'F3+GW-L2,LF',   wiki: 'Scheunenbrand',                   RD: 'RTW'},
  'Schornsteinbrand'            : {FZ: 'F3',            wiki: 'Schornsteinbrand',                RD: 'RTW'},
  'Silobrand'                   : {FZ: 'F3',            wiki: 'Silobrand',                       RD: 'RTW'},
  'Sperrmüllbrand'              : {FZ: 'F0',            wiki: 'Sperrm%C3%BCllbrand',             RD: 'RTW'},
  'Strohballen Brand'           : {FZ: 'F2+GW-L2',      wiki: 'Strohballen_Brand',               RD: 'RTW'},
  'Traktorbrand'                : {FZ: 'F1',            wiki: 'Traktorbrand',                    RD: 'RTW'},
  'Verkehrsunfall'              : {FZ: 'TH2',           wiki: 'Verkehrsunfall',                  RD: 'RTW'},
  'Wohnblockbrand'              : {FZ: 'F4+GW-A',       wiki: 'Wohnblockbrand',                  RD: 'RTW'},
  'Wohnungsbrand'               : {FZ: 'F2',            wiki: 'Wohnungsbrand',                   RD: 'RTW'},
  'Brand-Weihnachtsbaum in Kirche': {FZ: 'F4',          wiki: 'Brand-Weihnachtsbaum_in_Kirche',  RD: 'RTW'},
  'Brand auf Weihnachtsmarkt'   : {FZ: 'F2+TLF',        wiki: 'Brand_auf_Weihnachtsmarkt',       RD: 'RTW'},
  'Feldbrand'                   : {FZ: 'F2+GW-L2',      wiki: 'Feldbrand',                       RD: 'RTW'},
  'Gewerbebrand'                : {FZ: 'F4+RW,GW-A,TLF',     wiki: 'Gewerbebrand',                    RD: 'RTW'},
  'Brand im Baumarkt'           : {FZ: 'F5+RW,TLF|GW-M,GW-G',        wiki: 'Brand_im_Baumarkt',               RD: 'RTW'},
  'Brennende S-Bahn'            : {FZ: 'F2+GW-S,RW,ELW',   wiki: 'Brennende_S-Bahn',                RD: 'RTW'},
  'Schuppenbrand'               : {FZ: 'F2|GW-G,GW-M',  wiki: 'Schuppenbrand',                   RD: 'RTW'},
  'Brennender Sicherungskasten' : {FZ: 'F1',            wiki: 'Brennender_Sicherungskasten',     RD: 'RTW'},
  'Wohnwagenbrand'              : {FZ: 'F1',            wiki: 'Wohnwagenbrand',                  RD: 'RTW'},
  'Brand in Briefkasten'        : {FZ: 'F0',            wiki: 'Brand_in_Briefkasten',            RD: 'RTW'},
  'Kleiner Waldbrand'           : {FZ: 'F2+LF,GW-L2',        wiki: 'Kleiner_Waldbrand',               RD: 'RTW'},
  'Brennender Müllwagen'        : {FZ: 'F2',            wiki: 'Brennender_M%C3%BCllwagen',       RD: 'RTW'},
  'Ölspur'                      : {FZ: 'F1+GW-Öl',         wiki: '%C3%96lspur',                     RD: 'RTW'},
  'Brand in Zugdepot'           : {FZ: 'F5+GW-S|RW',    wiki: 'Brand_im_Zugdepot',               RD: 'RTW'},
  'Brand in Autohaus'           : {FZ: 'F4+GW-A',       wiki: 'Brand_in_Autohaus',               RD: 'RTW'},
  'Brand in Druckerei'          : {FZ: 'F5+RW,TLF',     wiki: 'Brand_in_Druckerei',              RD: 'RTW'},
  'Brand in Lackfabrik'         : {FZ: 'F5+RW,TLF|GW-M,GW-G',        wiki: 'Brand_in_Lackfabrik',             RD: 'RTW'},
  'Person im Fluss'             : {FZ: 'TH3',           wiki: 'Person_im_Fluss',                 RD: 'RTW'},
  'Trocknerbrand'               : {FZ: 'F1',            wiki: 'Trocknerbrand',                   RD: 'RTW'},
  'Brand in Reifenlager'        : {FZ: 'F5+TLF|GW-M,GW-G',     wiki: 'Brand_in_Reifenlager',            RD: 'RTW'},
  'Brand im Casino'             : {FZ: 'F5+LF,LF,TLF,RW',  wiki: 'Brand_im_Casino',                 RD: 'RTW'},
  'Brennendes Gebüsch'          : {FZ: 'F1',            wiki: 'Brennendes_Gebüsch',              RD: 'RTW'},
  'Kioskbrand'                  : {FZ: 'F1',            wiki: 'Kioskbrand',                      RD: 'RTW'},
  'Garagenbrand'                : {FZ: 'F2',            wiki: 'Garagenbrand',                    RD: 'RTW'},
  'Mähdrescherbrand'            : {FZ: 'F2+TLF',        wiki: 'Mähdrescherbrand',                RD: 'RTW'},
  'Kaminbrand'                  : {FZ: 'F3',            wiki: 'Kaminbrand',                      RD: 'RTW'},
  'PKW in Fluss'                : {FZ: 'TH4',           wiki: 'PKW_in_Fluss',                    RD: 'RTW'},
  'Brand in Schloss'            : {FZ: 'F5',            wiki: 'Brand_in_Schloss',                RD: 'RTW'},
  'Brand in Kühlhaus'           : {FZ: 'F5+TLF|GW-M,GW-G',        wiki: 'Brand_in_Kühlhaus',               RD: 'RTW'},
  'Feuer im Krankenhaus'        : {FZ: 'F5',            wiki: 'Feuer_im_Krankenhaus',            RD: 'RTW'},
  'Brand in Kletterhalle'       : {FZ: 'F4',            wiki: 'Brand_in_Kletterhalle',           RD: 'RTW'},
  'Grasnarbenbrand'             : {FZ: 'FL',            wiki: 'Grasnarbenbrand',                 RD: 'RTW'},
  'Brennendes Flugzeug'         : {FZ: 'FLG',           wiki: 'Brennendes_Flugzeug',             RD: 'RTW'},
  'Brand in Industriepark'      : {FZ: 'GSL',           wiki: 'Brand_in_Industriepark',          RD: 'RTW'},
  'Brand in Eishalle'           : {FZ: 'F5+TLF',        wiki: 'Brand_in_Eishalle',               RD: 'RTW'},
  'Brand in Metzgerei'          : {FZ: 'F4|GW-L2',      wiki: 'Brand_in_Metzgerei',              RD: 'RTW'},
  'Brand in Gärtnerei'          : {FZ: 'F5|GW-M,GW-G',  wiki: 'Brand_in_Gärtnerei',              RD: 'RTW'},
  'Gewerbebrand sp'             : {FZ: 'FL+RW',         wiki: 'Gewerbebrand',                    RD: 'RTW'},
  'Brennendes Flugzeug sp'      : {FZ: 'FLG',           wiki: 'Brennendes_Flugzeug',             RD: 'RTW'},
  'Grasnarbenbrand sp'          : {FZ: 'FL',            wiki: 'Grasnarbenbrand',                 RD: 'RTW'},
  'Feuer auf Boot (Klein)'      : {FZ: 'FlB',           wiki: 'Feuer_auf_Boot_(klein)',          RD: 'RtB'},
  'Feuer auf Boot (Mittel)'     : {FZ: 'HaF1',          wiki: 'Feuer_auf_Boot_(mittel)',         RD: 'RtB'},  
  'Gabelstapler im Hafenbecken' : {FZ: 'HaF2',          wiki: 'Gabelstapler_im_Hafenbecken',     RD: 'RTW'},  
  'Verletztentransport'         : {FZ: '',              wiki: '',                                RD: 'RTW'},
  'Brand in Gemeindehaus'       : {FZ: 'F3',            wiki: 'Brand_in_Gemeindehaus',           RD: 'RTW'},
  'Brand in Steinbruch'         : {FZ: 'GSL',           wiki: 'Brand in Steinbruch',             RD: 'RTW'},
  'Maschinenbrand'              : {FZ: 'F2+ELW,GW-L2',  wiki: 'Maschinenbrand',                  RD: 'RTW'},
};
...
var sonderpositionen = {
'Andere Stadt -                         83 - 180'  : 'Flughafen',
'Flughafen'                                        : 'Flughafen' ,
'Andere Stadt -                         84 - 179'  : 'Flughafen' ,
'Andere Stadt -                         84 - 180'  : 'Flughafen' ,
'Andere Stadt -                         83 - 179'  : 'Flughafen' ,
'Andere Stadt -                         98 - 198'  : 'Hafen' ,
'Andere Stadt -                         99 - 198'  : 'Hafen' ,
'Andere Stadt -                         100 - 198' : 'Hafen' ,
'Andere Stadt -                         98 - 199'  : 'Hafen' ,
'Andere Stadt -                         99 - 199'  : 'Hafen' ,
'Andere Stadt -                         100 - 199' : 'Hafen' ,
'Andere Stadt -                         98 - 200'  : 'Hafen' ,
'Andere Stadt -                         99 - 200'  : 'Hafen' ,
'Andere Stadt -                         100 - 200' : 'Hafen' ,
'Hafen'                                            : 'Hafen' ,
};

var sonderpositionenEK =
{
'Flughafen'       : 'FL',
}
...
{ 
  ...
  { bearbeiteLogFile(); }
  else if (adr.match("http://www.feuerwache.net/toplist*"))
  { bearbeiteToplist(); }
...
function bearbeiteToplist()
 {
// Username = document.getElementsByTagName("a")[3];
// Username = Username.substring(33);
  ...
  var TRs = document.getElementById("content").getElementsByTagName("tbody")[0].getElementsByTagName("tr"); {
		...
		{ 
			...
			var Platz = TD[0].innerHTML;
			var User = TD[1].innerHTML;
			var Credits = TD[2].innerHTML;
			if (User.match(Username) != null ) { 
			  var	H = "<td bgcolor='green'>" + Platz + "</td> <td bgcolor='green'>" + User + "</td><td bgcolor='green'>" + Credits + "</td>";
		      TR.innerHTML = H;	
		     } 
		}
	}		  
...
function bearbeiteLogFile() { 
	var TRs = document.getElementById("content").getElementsByTagName("tbody")[0].getElementsByTagName("tr"); {
		var AnzNotruf  = 0, AnzFehl     = 0, AnzErledigt = 0, AnzAusgetreten = 0, AnzNeuLeute = 0;
		for (i=0;i<TRs.length;i++) { 
					var TR = TRs[i];
	  ...
	  ret += "<tr><th>Feuerwehrleute ausgetreten:</th><td><font color='red'><b>" + AnzAusgetreten + "</b></font></td></tr>\n";
	  ret += "<tr><th>Feuerwehrleute eingetreten:</th><td><font color='green'><b>" + AnzNeuLeute + "</b></font></td></tr>\n";
	  ret += "</table><br>\n";
	  var main, newElement;
...
{ var GG = document.getElementById("education_type_1").checked;
  ...
  var FL = document.getElementById("education_type_4").checked;  
    ...
    { var TDs = TR.getElementsByTagName("td");
      ...
      { TDs[0].style.backgroundColor="transparent";
        ...
        { var bgc="";
          ...
          if (RA && Ausb.match("Rettungsassistent")==null) bgc="white";
          if (TA && Ausb.match("Taucher")==null) bgc="#222266";
          if (FL && Ausb.match("Flughafen")==null) bgc="#FAF707";
		  if (LB && Ausb.match("Löschboot")==null) bgc="blue";
		  if (RB && Ausb.match("Rettungsboot")==null) bgc="blue";
          if (bgc) 
...
{ 
  ...
  // Position auslesen
  PosDiv = document.getElementById("mission_content");
  Pos = document.getElementsByTagName("td")[0];
  Position = getStichwort(Pos.innerHTML);

 if (sonderpositionen[Position])
 {
  PosBem = sonderpositionen[Position];
  if (sonderpositionenEK[PosBem])
  {
var  Einsatzstichwortsonder = Einsatzstichwort + " sp";
  Einsatzklasse = getEinsatzKlasse(Einsatzstichwortsonder);
  if (Einsatzklasse == "undef") Einsatzklasse = sonderpositionenEK[PosBem];
  }
  }
  ...
  //RD Fahrzeug ermitteln
  var RDFZ = Einsatzklassen[Einsatzstichwort].RD
...
// ************************************************************************************
 ...
 // Infos in Tabelle strukturieren
  ...
  if (showInfoBemerkung) 
  { if (PosBem) Info +=InfoVorspann + "Bemerkung</th><td>" + PosBem + "</td></tr>\n";
  }
  ...
  if (InfotextVerfuegbar) Info += InfoVorspann + "<a target='_new' href='http://www.feuerwache.net/feuerwehrfahrzeuge'>verfügbar</a></th><td><font color='green' size=1>" + InfotextVerfuegbar + "</font></td></tr>\n";
...
/*
  for (var i=Rows1.length-1; i>=0; i--)
      ...
      if (FZName2.substr(0,1).toUpperCase()=="X") FZKlasse2 = "2";
  ...
  { for each (TD in document.getElementsByTagName("td"))
    { for each (A in TD.getElementsByTagName("a"))
      { if ( A.href.indexOf("http://www.feuerwache.net/feuerwehr-einsaetze/") == 0)
        { 
		TD.innerHTML += "<span style='float:right'><font color='red'>(" + getEinsatzKlasse(A.innerHTML) + ")</font>";
        }
      }
    }
  }
...
{ MachSortierbar(myTB);
  ...
  var AnzFL=0, AnzFLDienst=0, AnzFLBereit=0;
  ...
  { if (TR.getElementsByTagName("td").length>5)
    { var TDs = TR.getElementsByTagName("td");
      ...
      { AnzFL++;
        if (Stat == "Beim Einsatz" || Stat == "Einsatzbereit") AnzFLDienst++;
        if (Stat == "Einsatzbereit") AnzFLBereit++;
      }
  ...
  if (AnzFL)
  { ret += "Flughafen: " + AnzFL + " insgesamt, " + AnzFLDienst + " im Dienst";
    if (AnzFLDienst != AnzFLBereit)
    { ret += ", davon " + AnzFLBereit + " einsatzbereit.<br>\n"; }
    else
    { ret += " (alle einsatzbereit).<br>\n"; }
  }
  if (AnzLB)
...
{ 
  ...
  H += "<input type='checkbox' id='machVorschlag' ";
  if (machVorschlag) H +="checked";
  H += "> vorgeschlagene Fahrzeuge sofort abhaken<br>\n";
  
  H += "Abmarschreihenfolge beachten: <input type='checkbox' id='zweiterAbmarschTr' ";
  if (zweiterAbmarsch==1) H +="checked";
  H +=">  (zuerst Trupp-FZ)";
  H += "&nbsp;&nbsp;<input type='checkbox' id='zweiterAbmarschAusb' ";
  if (zweiterAbmarsch==2) H +="checked";
  H +=">  (zuerst Sonderausbildungs-FZ)<br>\n";
  
  
  H += "<input type='checkbox' name='KonfigBox' id='KonfBemerkung'";
  if (showInfoBemerkung) H += " checked";
  H += "> Bemerkung anzeigen<br>\n";
...
function getEinsatzKlasse(Einsatzstichwort)
{ if (AlleGleich) return "-gleich-";
 mylog("getEinsatzKlasse(" + Einsatzstichwort + ")");
  var EK;
  var ekn = Einsatzklassen[Einsatzstichwort];
  if (ekn ==  undefined)
  {
  EK = "undef";
  }
  ...
  {
  EK = Einsatzklassen[Einsatzstichwort].FZ;
  }
 /* if (EK == undefined)
  {
   EK = "FL";
...
{ 
  ...
  var WL = Einsatzklassen[Stichwort].wiki;
  if (WL == undefined) 
  { WL = ""; }
  else
  ...
  { var FZ = Optional[opt];
    ...
    { var ThisZeile = Zeilen[i];
      ...
      { var C = ThisSpalten[0].getElementsByTagName("input")[0];
        ...
        if (C.alt != "x" && RN.substr(0,1).toUpperCase() != "X")
...
{ // Array aufbauen, Reihenfolge wie in Fahrzeugklassen
  ...
  { var FZ;
    ...
    { FZ=TDs[2].innerHTML;
      ...
      if (FN.substr(0,1).toUpperCase()=="X")
      { AnzFZKX[FZK]++; }
      else
      { AnzFZK[FZK]++; }
    }
  ...
  { if (c==MAXSPALTENVERFUEGBAR) c=0, ret+="</tr><tr>";
    ...
    if (AnzFZKX[FZ]) ret +="<font color='green'>+"+AnzFZKX[FZ]+"</font>";
    ret += "<br>"+FZ+"&nbsp;</td>";
    c++;
  }
  ret +="</tr></table>";
...
{ mylog("GetVariables");
  ...
  showInfoBemerkung = GM_getValue("showInfoBemerkung",true);
...
{ mylog("SetVariables");
  ...
  GM_setValue("showInfoBemerkung",showInfoBemerkung);
}
