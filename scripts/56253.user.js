// ==UserScript==
// @name            Remove thepiratebay T-shirt corner ad/
// @namespace       Platypus
// @include         http://thepiratebay.org/
// ==/UserScript==
function do_platypus_script() {
remove_it(window.document,document.evaluate('/HTML[1]/BODY[1]/DIV[1]/A[1]/IMG[1]', document, null, XPathResult.FIRST_ORDERED_NODE_TYPE,null).singleNodeValue,null,null,null);
