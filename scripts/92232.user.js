...
$('#app_content_130402594779 .canvas_iframe_util').css('width','13000px');
...
//$('#kocmain div.mod_comm div.comm_body').css('margin-top','68px');
//$('#kocmain_bottom').css('height','60px');
...
$('#mod_cityinfo_cityname').css('padding-top','15');
$('#mod_cityinfo_cityname').css('text-align','left');
$('#mod_cityinfo_cityname').css('padding-left','10px');

//Bring overview over
//$('#mod_cityinfo div.cityinfo_head div.hd a.button14').css('left','-404px');
$('#mod_cityinfo div.cityinfo_head div.hd a.button14').css('left','135px');
...
$('#directory_tabs_2_allianceInfo').css('bottom','500px');
...
$('#kocmain_bottom div.mod_directory div.directory_head a').css('left','-83px');
$('#kocmain_bottom div.mod_directory div.directory_head a').css('top','28px');
$('#kocmain_bottom div.mod_directory div.directory_head a').css('font-size','8px');
$('#kocmain_bottom div.mod_directory div.directory_head a').css('font-weight','normal');
$('#kocmain_bottom div.mod_directory div.directory_head a').css('text-vertical-align','middle');
