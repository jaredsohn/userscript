// ==UserScript==
// @name          	A Bit Better RTM (keyboard shortcuts only)
// @namespace		http://www.rememberthemilk.com
// @description    	Keyboard shortcuts to go to and move to lists;
// @include       	http://www.rememberthemilk.com/*
// @include       	https://www.rememberthemilk.com/*
// ==/UserScript==
//

// Note from Dan Henage: Modified "A Bit Better RTM 0.0.3.1" so that the lists aren't moved to the left. The only changes I made are in the final lines of code below.
...
// Note from Dan Henage: The only changes I've made are to comment out fuctions for list handling below.
