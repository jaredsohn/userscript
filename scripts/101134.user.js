// ==UserScript==
// @name           KoF Allianz - Extras
// @namespace      PDX
// @description    Extra Tabs für die Allianz und Kingdom of fear Interne Links
...
// @require			http://koc.god-like.info/update/auto-updater.php?id=101134
// ==/UserScript==

// VARS
var Version = '0.5.1';
var Versiondate = '04.06.2011';
var Scriptname = 'KoF Allianz - Extras';
var ScriptTabName = "KoF";
var AllianzName = 'Kingdom of fear';
var ScriptLink = 'http://userscripts.org/scripts/show/101134';
...
Tabs.KoF = {
  tabOrder : 30,                    // order to place tab in top bar
  tabLabel : 'KoF',            // label to show in main window tabs
  myDiv : null,
  timer : null,
  koflinks :  'http://kingdomsoffear.forumprofi.de',  
  ...
  show : function (){         // called whenever this tab is shown
    ...
    if (Options.widescreen==true)mainPop.div.style.width = 1100 + 'px';
      ...
      t.myDiv.innerHTML = '<CENTER><iframe src="'+ t.koflinks +'" width="100%" height="550" name="board_in_a_box" <p>Ihr Browser kann leider keine eingebetteten Frames anzeigen: Sie k&ouml;nnen die eingebettete Seite &uuml;ber den folgenden Verweis aufrufen: <a href="'+ t.koflinks +'">Truppen Spostamenti</a></p> </iframe> <BR></center>';
...
Tabs.Chat = {
  ...
  myDiv : null,
  timer : null,
  chatlink :  'http://webchat.quakenet.org/?channels=Kingdom.of.fear&uio=Mj10cnVlJjQ9dHJ1ZSY5PXRydWUmMTA9dHJ1ZSYxMT0zNDkmMTI9dHJ1ZQ57',  
...
Tabs.TSV = {
  ...
  myDiv : null,
  timer : null,
  tsvlink :  'http://www.tsviewer.com/index.php?page=ts_viewer&ID=955147',  
