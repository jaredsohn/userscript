...
// select "Dorkly - EZ Download", and click Uninstall.
//
// --------------------------------------------------------------------
//
// ==UserScript==
// @name          Dorkly - EZ Download
...
// @version		  0.2.0
// @notes		  Added initial support for Chrome.<br/>Added Configuration icon and overlay.<br/>Fixed menu being blocked by bottom social bar.<br/>Fixed typo in XHR header.<br/>Fixed updateCheck not returning update if HTTPS Everywhere was installed.<br/>^Changed USO update link from HTTP to HTTPS.<br/>Changed Flattr donation link.<br/>Upgraded jQuery from 1.6.1 to 1.7.0.<br/>^Changed .live() calls to .on()
// @include       http*://www.dorkly.com/video/*
// ==/UserScript==
...
var scriptName = 'Dorkly - EZ Download';
var scriptId = '104123';
var scriptVersion = '0.2.0';
var scriptUpdateText = 'Added initial support for Chrome.<br/>Added Configuration icon and overlay.<br/>Fixed menu being blocked by bottom social bar.<br/>Fixed typo in XHR header.<br/>Fixed updateCheck not returning update if HTTPS Everywhere was installed.<br/>^Changed USO update link from HTTP to HTTPS.<br/>Changed Flattr donation link.<br/>Upgraded jQuery from 1.6.1 to 1.7.0.<br/>^Changed .live() calls to .on()';
// === Stop editing here. ===
...
var donationLink_flattr = 'https://flattr.com/thing/412446/Dorkly-EZ-Download';
...
$ljq("#gmmnu").html(""
		+"\n<div id='gmmnu_title' data-title='Dorkly Download'>Dorkly Download</div>\n"
		+"<div id='gmmnu_menu'>\n"
...
$ljq(document).ready(function(){
	...
	$ljq("#continuous_player").bind('DOMSubtreeModified',function(){
		...
		var zzPageid = $ljq("div[data-json*='node_id']").attr("data-json");
		if ($ljq("div[data-json*='node_id']").attr("data-json")) {
			GMlog("zz:"+zzPageid);
...
function getFile() {
GMlog('http://www.dorkly.com/moogaloop/video/'+Pageid);
//alert('http://www.dorkly.com/moogaloop/video/'+Pageid);
$ljq("#gmmnu_links_sd .status").html("Loading...");
	GM_xmlhttpRequest({
		method: "GET",
    	url: 'http://www.dorkly.com/moogaloop/video/'+Pageid+'',
    	headers: {'User-agent': 'Mozilla/4.0 (compatible) Greasemonkey','Accept': 'text/plain'},
    	onload: function(res) {
