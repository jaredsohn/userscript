// ==UserScript==
// @name          Lexington Public Library DVD Lookup
// @description  Search the Lexington Public Library Catalog from Amazon DVD listings.
// @include       http://*.amazon.*
...
function() {
  ...
  str = mainmatch.substring(17,200);
  ...
  if (mainmatch){
	  ...
	  var link = document.createElement('a');
   	  ...
   	  link.innerHTML 	= '</br>Lookup this DVD at the ' + libraryName;
