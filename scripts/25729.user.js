// ==UserScript==
// @name          Travian script snippets
// @namespace     Travian_snippets
// @author        FDisk
// @description   Functions collection, which will help you to start programming anny travian script. v0.0.1 BETA
