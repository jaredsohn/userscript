...
// @version        1.0.1c
// @updateURL      https://userscripts.org/scripts/source/162533.meta.js
// @downloadURL    https://userscripts.org/scripts/source/162533.user.js
// ==/UserScript==
...
(function (){
  var tazoom_main = function() {
    function initialize() {
      ...
      var zoomMax = 0.18;	// Smaller number means able to zoom out further.
      var zoomInc = 0.09;	// Larger number for faster zooming, Smaller number for slower zooming.
