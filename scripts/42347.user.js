// ==UserScript==
// @name           Custom Emote Fix Link
// @namespace      Coasterfreak3000
// @description    Fixes the add Emote link in the channel for Zikes emote
// @include        http://chat.deviantart.com/chat/*
// ==/UserScript==
function do_platypus_script() {
html_insert_it(window.document,document.evaluate('/HTML[1]/BODY[1]/DIV[2]/DIV[2]/DIV[1]/DIV[1]/DIV[1]/DIV[1]/DIV[1]/DIV[1]/DIV[3]/DIV[2]/DIV[1]/A[2]', document, null, XPathResult.FIRST_ORDERED_NODE_TYPE,null).singleNodeValue,'<a href="http://www.thezikes.com/emotes.asp?Page=AddEmote">Add Emotes</a> |',true,false);
