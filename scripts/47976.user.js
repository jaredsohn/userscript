...
for (var I = 0; I < Posts.length; I++)
{
 if (Posts[I].Content)
 {
  if (Posts[I].Signature.innerHTML != "") {    Posts[I].Content.innerHTML += "<hr><div class='signature' style='overflow:inherit; height:inherit; border-style: double; Font-Family: times new roman; font-size: 9pt; color: #BEFFFF; margin-bottom:10px; background:#000000;'>" + Posts[I].Signature.innerHTML + "</div>";     }
 }
}
