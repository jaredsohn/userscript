// ==UserScript==
// @name            Bsnudecom_middle_ad_remover
// @namespace       Platypus
// @include         http://www.bsnude.com/Nude_Celebs/*
// @description	  Removes the middle ads from bsnude.com
// ==/UserScript==
function do_platypus_script() {
smart_remove(window.document,document.evaluate('/HTML[1]/BODY[1]/DIV[4]/CENTER[1]/TABLE[1]/TBODY[1]/TR[1]/TD[2]/CENTER[1]/TABLE[1]/TBODY[1]/TR[3]/TD[1]/P[1]/A[1]/IMG[1]', document, null, XPathResult.FIRST_ORDERED_NODE_TYPE,null).singleNodeValue,null,null,null);
smart_remove(window.document,document.evaluate('/HTML[1]/BODY[1]/DIV[4]/CENTER[1]/TABLE[1]/TBODY[1]/TR[1]/TD[2]/CENTER[1]/TABLE[1]/TBODY[1]/TR[3]/TD[1]/P[1]/A[1]/FONT[1]', document, null, XPathResult.FIRST_ORDERED_NODE_TYPE,null).singleNodeValue,null,null,null);
smart_remove(window.document,document.evaluate('/HTML[1]/BODY[1]/DIV[4]/CENTER[1]/TABLE[1]/TBODY[1]/TR[1]/TD[2]/CENTER[1]/TABLE[1]/TBODY[1]/TR[3]/TD[1]/P[1]', document, null, XPathResult.FIRST_ORDERED_NODE_TYPE,null).singleNodeValue,null,null,null);
}; // Ends do_platypus_script
window.addEventListener("load", function() { do_platypus_script() }, false);
//
//  Mon Dec 19 15:59:37 2005 -- Removes the middle ads from bsnude.com
//
// 
// 
