...
// @namespace       Platypus
// @include         *&ressort=me
// @include         http://www.taz.de/index.php?id=kommentar
...
html_insert_it(window.document,document.getElementById('datum_plugin_rechts'),'<iframe src="http://www.dradio.de/presseschau/#taz" width="500" height="600"></iframe>',false,true);
