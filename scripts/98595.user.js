// ==UserScript==
// @name            GLB homepage cleanup
// @namespace       GLB
// @include         http://goallineblitz.com/game/home.pl
// ==/UserScript==
function do_platypus_script() {
smart_remove(window.document,document.evaluate('/HTML[1]/BODY[1]/DIV[2]/DIV[5]/DIV[4]/DIV[5]/TABLE[1]/TBODY[1]/TR[1]/TD[1]', document, null, XPathResult.FIRST_ORDERED_NODE_TYPE,null).singleNodeValue,null,null,null);
smart_remove(window.document,document.getElementById('user_note'),null,null,null);
smart_remove(window.document,document.getElementById('calendar'),null,null,null);
smart_remove(window.document,document.getElementById('rings'),null,null,null);
smart_remove(window.document,document.getElementById('top_trophies'),null,null,null);
