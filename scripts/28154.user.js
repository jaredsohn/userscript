...
document.location.href = "http://92.48.103.52/fantasy/game.php?screen=ADVANCEDCOMBAT";
    ...
    document.location.href = 'http://92.48.103.52/fantasy/game.php?var5=6642&var1=Lesser+Shield+Scroll&command=use&screen=SCROLLS';
}
  else if(k==53) {
...
'http://92.48.103.52/fantasy/game.php?var5=4462&var1=Lesser+Focus+Scroll&command=use&screen=SCROLLS';
  }
 else if(k==54) {
    document.location.href =
