...
var stationFromCode = "ndls";		//Enter the origin station code between the double quotes
var stationToCode = "bct";		//Enter the destination station code between the double quotes
var date = "01062012"; 			//ddmmyyyy - Enter the journey date in the given format only
...
var trainNo = 19020;			//Enter the Train No to book in
...
var psgrName = "Test";
var dob = "01011980";			//ddmmyyyy - Enter passenger's date of birth in the given format only
