// ==UserScript==
// @name Travian3 Beyond - Hebrew
// @author 
// @namespace   t3
// @version 2.6cm-he
// @description  Travian Beyond Translated to Hebrew (By Ben Figlin)
...
function funcionPrincipal(e){
	...
	// Hebrew (By Ben Figlin)
	var lang_il = new Array();
		var lang_he = lang_il;
	lang_il['ALIANZA'] 	= 'ברית';
	lang_il['PERFIL'] 	= 'פרופיל משתמש';
	lang_il['SIM'] 		= 'סימולטור קרב';
	lang_il['CALC'] 	= 'מחשבון טרוויאן';
	lang_il['SEGURO'] 	= '?האם אתה בטוח'; //prompt message doesn't allow HTML Entities
	lang_il['MARK'] 	= 'סמן הכל';
	lang_il['PERDIDAS'] 	= 'הפסד';
	lang_il['RENT'] 	= 'רווח';
	lang_il['SUBIR_NIVEL'] 	= 'שדרוג זמין';
	lang_il['JUGADOR'] 	= 'שחקן';
	lang_il['ALDEA'] 	= 'שם הכפר';
	lang_il['HAB'] 		= 'אוכלוסיה';
	lang_il['COORD'] 	= 'מיקום';
	lang_il['ACCION'] 	= 'פעולות';
	lang_il['ATACAR'] 	= 'התקפה';
	lang_il['COMERCIAR'] 	= 'שלח משאבים';
	lang_il['GUARDADO'] 	= 'נשמר'; //prompt message doesn't allow HTML Entities
	lang_il['DESP_ABR'] 	= 'הזז';
	lang_il['FALTA'] 	= 'צריך ';
	lang_il['HOY'] 		= 'היום';
	lang_il['MANYANA'] 	= 'מחר';
	lang_il['PAS_MANYANA'] 	= 'מחרותיים';
	lang_il['MERCADO'] 	= 'שוק';
	lang_il['CUARTEL'] 	= 'מגורי חיילים';
	lang_il['PUNTO'] 	= 'נקודת מפגש';
	lang_il['CORRAL'] 	= 'ארווה';
	lang_il['TALLER'] 	= 'בית מלאכה';
	lang_il['ENVIAR'] 	= 'שלח משאבים';
	lang_il['COMPRAR'] 	= 'קנה';
	lang_il['VENDER'] 	= 'מכור';
	lang_il['ENVIAR_IGM'] 	= 'Send IGM';
	lang_il['LISTO'] 	= 'מוכן';
	lang_il['EL'] 		= 'בתאריך';
	lang_il['A_LAS'] 	= 'ב';
	lang_il['EFICIENCIA'] 	= 'יעילות'; 
	lang_il['NUNCA']	= 'לעולם לא';
	lang_il['PC']           = 'נקודות תרבות';
	lang_il['FUNDAR']       = 'אתה יכול לייסד או לכבוש כפר חדש';
	lang_il['ALDEAS']       = 'כפרים';
	lang_il['ENV_TROPAS'] 	= 'שלח כוחות';
	lang_il['RECURSO1']     = 'עץ';
	lang_il['RECURSO2']     = 'טיט';
	lang_il['RECURSO3']     = 'ברזל';
	lang_il['RECURSO4']     = 'יבול';
	lang_il['TIEMPO']       = 'זמן';
	lang_il['COMP']         = 'מקבץ דוחות';
	lang_il['STAT']		= 'סטטיסטיקה';
	lang_il['OFREZCO']	= 'מציע';
	lang_il['BUSCO']	= 'מחפש';
	lang_il['TIPO']		= 'סוג';
	lang_il['DISPONIBLE']	= 'רק זמין';
	lang_il['CUALQUIERA']	= 'הכל';
	lang_il['SI']		= 'כן';
	lang_il['NO']		= 'לא';
    lang_il['LOGIN'] = 'התחבר';
    lang_il['MARCADORES']   = 'מועדפים';
    lang_il['ANYADIR']      = 'הוסף';
    lang_il['ENLACE']       = 'קישור למועדף חדש'; //prompt message doesn't allow HTML Entities
    lang_il['TEXTO']        = 'טקסט למועדף חדש'; //prompt message doesn't allow HTML Entities
	lang_il['ELIMINAR']	= 'מחק';
	lang_il['MAPA']		= 'מפה';
    lang_il['VERSION']      = 'גרסה זמינה';
    lang_il['MAXTIME']      = 'זמן מירבי';
	lang_il['CHECK']	= 'בדוק גרסה חדשה';
	lang_il['ARCHIVE']	= 'ארכיון';
	lang_il['RESUMEN']	= 'תקציר';
	lang_il['MAXTIME']			= 'זמן מירבי';
	lang_il['VERSION']			= 'הגרסה החדשה ביותר';
	lang_il['DETALLES']			= 'פרטים';
	lang_il['MAP_EXT']			= 'מפה מורחבת';
	lang_il['MAT_PRIMAS']		= 'משאבים';
	lang_il['ATAQUES']			= 'תקוף';
	lang_il['CONSTR']			= 'בנה';
	lang_il['TROPAS']			= 'כוחות';
	lang_il['ACTUALIZAR']		= 'בדוק גרסה חדשה';
	lang_il['RES'] 				= 'שידרוגים';
    lang_il['STOREURL']         = 'קישור האיכסון';
    lang_il['STOREPASSWORD']    = 'סיסמת האיכסון';
    lang_il['OPTIONS']    		= 'אפשרויות';
    lang_il['VENTAS']    		= 'הצעות שמורות';
    lang_il['SHOWINFO']    		= 'הצג פרטים';
    lang_il['HIDEINFO']    		= 'הסתר פרטים';
    lang_il['MAPSCAN']    		= 'סרוק את המפה';
...
//				["Travian Beyond", "http://www.denibol.com/proyectos/travian_beyond/", "_blank"]
				[T('CHECK'), "http://userscripts.org/scripts/source/27686.user.js", "_blank"],
				[T('RES'), "http://www.nmprog.hu/travian/buildingsandunitsv39ek.jpg", "tr3_buildingtree"],
//				[T('UPGRADET'), "http://userscripts.org/scripts/source/27686.user.js", "_blank"],
		];
