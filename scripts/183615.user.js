...
// @version      1.4.3
// @description  77 Beautiful Emoticons and Smiley Icon Packs.
...
newStyle.innerHTML = '#bv_main *{box-sizing:border-box!important;-moz-box-sizing:border-box!important}#bv_main{background:none repeat scroll 0 0 #FFF;border:1px solid #DDD;border-width:1px 1px 0 0;bottom:-100%;float:left;left:-100%;position:fixed;transition:all .2s;-webkit-transition:all .2s;z-index:999;padding:10px!important}#bv_main > div:not(#tooltip){border-top:1px solid #0084FF;text-align:center;max-width:336px;padding:5px 0!important}#bv_main > a.close{position:absolute;right:10px;top:10px;height:24px;width:24px;text-indent:-9999px;background:url(data:image/gif;base64,) no-repeat 0 0 transparent}#tab_emo{height:30px;width:100%}#tab_emo li{display:inline;list-style:none outside none}#tab_emo a{color:#0084FF!important;display:inline-block;height:30px;line-height:30px;text-decoration:none;padding:0 10px!important}#tab_emo a.active{background:#0084FF;color:#FFF!important}#bv_emo,#bv_about{display:none}.bv_content{overflow:auto;border-bottom:1px dashed #ECECEC;font-size:12px;height:184px;margin-bottom:10px!important;padding:5px 0!important}.bv_pag{display:inline-block;font-size:80%;height:26px;line-height:14px}.bv_pag a{color:#15B;background:#F8F0B3;text-decoration:none}.bv_pag a,.bv_pag span{display:block;float:left;margin-bottom:5px!important;margin-right:5px!important;padding:.3em .5em!important}.bv_emoticon{text-indent:-9999px}.bv_pag .current,.bv_pag a:hover{background:#26B;color:#FFF}.bv_pag .current.prev,.bv_pag .current.next{background:#B6B6B6}#tooltip{text-align:center;background-color:#FFF;border:2px solid #333;color:#131313;max-width:550px;padding:10px}#bv_main .item{width:42px;height:42px;display:block;text-align:center;border:1px solid transparent;float:left;position:relative;padding:2px}#bv_main .item img{max-width:100%;max-height:100%;position:absolute;left:0;top:0;right:0;bottom:0;margin:auto}#bv_main .item:hover{cursor:pointer;border-color:#333}#divsmilies{display:block;position:relative}#divsmilies .tip{font-size:11px;position:absolute;top:-30px;left:0;width:auto;white-space:nowrap;background:#333;color:#FFF;height:24px;line-height:24px;padding:0 10px}#divsmilies .tip:after{content:" ";background:#333;width:8px;height:8px;position:absolute;bottom:-4px;left:7px;-webkit-transform:rotate(45deg)}';
...
var data = {
	imgur: {
		...
		nCat: {
			t: "NCat",
			n: "GOW0mJR hvOvwM1 LpQiQBu p7hIHt1 07gIuCF jatQht6 SpIpER0 dHtOequ S8doqGj UeLS1UQ b6r1ssX F1Qvruw GmAQNN8 QjCqk9c noxypKV UjONMI3 yB7yY6U nMVjM93 NgYsYdm 27MtyO5 791vXDi oMItkOu 6jvqrM8 1crnOKG 50zHxc9 L1fI2ox KkjWjgh 0mOltaJ Zt3ngnm 46c52zK pxfxehY gkHKWvh cYmosqx fioeTWY rnxF6Mz LaUYkob oKfJuRY gSws4pj uKUL0uP 1qq5JDh peNYpHh aUAn9JZ TDIdQFQ GIgIYy4 pjwIkFz B3DefYo OHUZrhx ldh0hIl KSEvDV3 dI9F4RA qKhd9RU VGX73kB vbJMG79".split(" "),
			f: ".jpg"
		}
	},
    emoer: {
	...
	umh: {
		...
		get_item: function (a, b) {
			...
			if (bvE.FF) return b ? window.opener.document.getElementById(a) : document.getElementById(a);
		...
		show_tooltip: function (a, b, d) {
			...
			c || (c = document.createElement("div"), c.setAttribute("id", "tooltip"), document.getElementById("bv_main").appendChild(c));
			c.style.zIndex = 99999;
			c.style.position = "fixed";
			d && (document.getElementById("_emo").innerHTML = d);
			c.innerHTML = "<p>" + b + "</p>";
			c.style.visibility = "visible";
			a.onmousemove = bvE.move_tooltip;
			a.onmouseout = function () {
				c.style.visibility = "hidden";
				document.getElementById("_emo").innerHTML = bvE.last_emo
			}
		},
		move_tooltip: function (a) {
			bvE.real_body = document.compatMode &&
				"BackCompat" != document.compatMode ? document.documentElement : document.body;
			...
			var b = bvE.IE ? event.clientX + bvE.real_body.scrollLeft : a.pageX,
				...
				c = bvE.IE && !window.opera ? bvE.real_body.clientWidth - event.clientX - bvE.offsetxpoint : window.innerWidth - a.clientX - bvE.offsetxpoint - 20,
				e = bvE.IE && !window.opera ? bvE.real_body.clientHeight - event.clientY - bvE.offsetypoint : window.innerHeight - a.clientY -
					bvE.offsetypoint - 20,
				f = 0 > bvE.offsetxpoint ? -1 * bvE.offsetxpoint : -1E3;
			bvE.current_tooltip = bvE.get_item("tooltip");
			bvE.current_tooltip.style.left = c < bvE.current_tooltip.offsetWidth ? bvE.IE ? bvE.real_body.scrollLeft + event.clientX - bvE.current_tooltip.offsetWidth + "px" : window.pageXOffset + a.clientX - bvE.current_tooltip.offsetWidth + "px" : b < f ? "5px" : b + bvE.offsetxpoint + "px";
			bvE.current_tooltip.style.top = e < bvE.current_tooltip.offsetHeight ? bvE.IE ? bvE.real_body.scrollTop + event.clientY - bvE.current_tooltip.offsetHeight -
				bvE.offsetypoint + "px" : window.pageYOffset + a.clientY - bvE.current_tooltip.offsetHeight - bvE.offsetypoint + "px" : d + bvE.offsetypoint + "px"
		},
		create_emo: function (a, b) {
            ...
            "imgur" == a ? bv_path = "" : (bv_path = d.u, void 0 == bv_path && (bv_path = b + "/"));
			var c = d.n;
			void 0 == c && (c = []);
			var e = d.b;
			void 0 == e && (e = 1);
		...
		create_list: function (a) {           
			$.each(a, function (a, d) {   
				$.each(this, function (c, e) {
					if ("r" != c) {
						var f = "";
                        "imgur" != a && (f = e.u, void 0 == f && (f = c + "/"));
						var h = e.e;
						void 0 == h && (h = e.n[0]);
						var g = e.f;
						void 0 == g && (g = ".gif");
						f = encodeURI(d.r + f + h + g);
						$("#bv_list .bv_content").append('<div id="' + c + '" data-emo="' + a + '" class="item click_emo"><img alt="' + e.t + '" src="' + f + '" /></div>')
					}
				})
			})
		},
		bv_emo: function (a) {
			...
			for (var b = bv_i * a; b < bv_i * a + bv_i; b++)
				if (void 0 != bv_current[b]) {
					var d =
						encodeURI(bv_url + bv_path + bv_current[b] + bv_type);
		...
		start: function () {
			...
			$("#tab_emo a").click(function () {
				...
				$("#bv_main > div:not(#tooltip)").hide();
				$("#bv" + this.id).show()
			});
            var z = my_getcookie("bv_emo_last");
			if (z != null) {
				var b = z.split("|");
			...
			$(".click_emo").click(function () {
				my_setcookie("bv_emo_last", $(this).data("emo") + "|" + this.id, !0);
				bvE.create_emo($(this).data("emo"), this.id)
			});
			$(window).on("keydown keyup",
				function (d) {
					a = d.ctrlKey
				});
			$("#bv_main").on("mouseover", "#bv_main .item", function () {
				...
				$("#message").val($("#message").val() + "[img]" + $("img", $(this))[0].src + "[/img]").focus();
				a || (submitmsg(params), bvE.close())
			});
			$("#bv_list .bv_pag").pagination($("#bv_list img").length, {
				callback: bvE.bv_list
			});
			$("#divsmilies").removeAttr("onclick").click(function () {
				my_setcookie("Zznotip", 1, !0);
				$("#bv_main").css({
					left: 0,
					bottom: 0
				})
			});
			$("#bv_main .close").click(function () {
				bvE.close()
			});
			$("body").click(function (a) {
				$(a.target).closest("#bv_main, #divsmilies").length || bvE.close()
			});
			null == my_getcookie("Zznotip") && $("#divsmilies").append('<div class="tip">Click để sử dụng <strong>bv_Emo</strong></div>')
		}
	};
$(function () {
	$("#message").length && ($("body").append('<div id="bv_main"><a class="close" href="#close">X</a><ul id="tab_emo"><li><a id="_list"href="#categories">Danh sách</a></li><li><a id="_emo"href="#emoticons">Meep</a></li><li><a id="_about"href="#about">?</a></li></ul><div id="bv_list"><div class="bv_content"></div><div class="bv_pag"></div></div><div id="bv_emo"><div class="bv_content"></div><div class="bv_pag"></div></div><div id="bv_about"><div class="bv_content" style="text-align: left;"><span style="font-size: 24px; line-height: normal"><strong><font color="#ff3333">bv_Emo</font></strong></span> <small>(version 1.4.3)</small><br><br><em>Ứng dụng được phát triển cho chatbox forumotion, tổng hợp 77 bộ biểu tượng vui từ nhiều nguồn khác nhau, lợi dụng BBcode image để chèn vào tin nhắn.<br>Để sử dụng, bạn chỉ cần CLICK vào biểu tượng.<br>Giữ CTRL để chọn nhiều biểu tượng cùng lúc.<br><br>Chi tiết xem tại: <a class="copyright" href="http://devs.forumvi.com/t12-userscript-bv_emo-them-77-bo-bieu-tuong-vui-vao-chatbox#40" target="_blank" alt="DEVs">http://devs.forumvi.com</a></em></div><div class="bv_pag">Copyright © 2013 <strong>Zzbaivong</strong>. All rights reserved.</div></div></div>'), bvE.start())
});