...
// ==/UserScript==
var labor_points_text={en:'Labor points',cz:'Pracovní body',sk:'Pracovné body',pl:'Punkty Pracy', hu:'Munkapont', se:'Arbetspoäng', de:'Arbeits Punkte', nl:'Arbeidspunten'};
var difficulty_text ={en:'Difficulty',cz:'Obtížnost',sk:'Obtiažnosť',pl:'Trudność', hu:'Nehézség', se:'Svårighet', de:'Schwerigkeit', nl:'Moeilijkheid'};
