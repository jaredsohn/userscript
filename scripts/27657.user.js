...
function funcionPrincipal(e){
	...
	lang_hk['ALIANZA'] 	= '\聯\盟';
	lang_hk['PERFIL'] 	= '\個\人\資\料';
	lang_hk['SIM'] 		= '\戰\鬥\模\擬\器';
	lang_hk['CALC'] 	= 'Travian\計\算\機';
	lang_hk['SEGURO'] 	= '\你\真\的\確\定?';
	lang_hk['MARK'] 	= '\全\選';
	lang_hk['PERDIDAS'] 	= '\損\失';
	lang_hk['RENT'] 	= '\得\益';
	lang_hk['SUBIR_NIVEL'] 	= '\已\可\升\級\！';
	lang_hk['JUGADOR'] 	= '\玩\家';
	lang_hk['ALDEA'] 	= '\村\莊';
	lang_hk['HAB'] 		= '\人\口';
	lang_hk['COORD'] 	= '\座\標';
	lang_hk['ACCION'] 	= '\行\動';
	lang_hk['ATACAR'] 	= '\攻\擊';
	lang_hk['COMERCIAR'] 	= '\運\送\資\源';
	lang_hk['GUARDADO'] 	= '\儲\存';
	lang_hk['DESP_ABR'] 	= '\移\動\格\數';
	lang_hk['FALTA'] 	= '\尚\缺';
	lang_hk['HOY'] 		= '\今\天';
	lang_hk['MANYANA'] 	= '\明\天';
	lang_hk['PAS_MANYANA'] 	= '\後\天';
	lang_hk['MERCADO'] 	= '\市\場';
	lang_hk['CUARTEL'] 	= '\兵\營';
	lang_hk['PUNTO'] 	= '\集\結\點';
	lang_hk['CORRAL'] 	= '\馬\廄';
	lang_hk['TALLER'] 	= '\工\場';
	lang_hk['ENVIAR'] 	= '\運\送\資\源';
	lang_hk['COMPRAR'] 	= '\買';
	lang_hk['VENDER'] 	= '\賣';
	lang_hk['ENVIAR_IGM'] 	= '\發\送IGM';
	lang_hk['LISTO'] 	= '\升\級\可\於';
	lang_hk['EL'] 		= '\-';
	lang_hk['A_LAS'] 	= '\-';
	lang_hk['EFICIENCIA'] 	= '\效\率'; 
	lang_hk['NUNCA']	= '\永\不';
	lang_hk['PC']           = '\文\明\點';
	lang_hk['FUNDAR']       = '\您\可\以\興\建\或\者\佔\領\一\座\村\莊';
	lang_hk['ALDEAS']       = '\村\莊';
	lang_hk['ENV_TROPAS']	= '派遣軍隊';
	lang_hk['RECURSO1']     = '\木\材';
	lang_hk['RECURSO2']     = '\磚\塊';
	lang_hk['RECURSO3']     = '\鋼\鐵';
	lang_hk['RECURSO4']     = '\穀\物';
	lang_hk['TIEMPO']       = '\時\間';
	lang_hk['COMP']         = '\報\告\壓\縮\器';
	lang_hk['STAT']		= '\統\計';
	lang_hk['OFREZCO']	= '\提\供';
	lang_hk['BUSCO']	= '\搜\尋';
	lang_hk['TIPO']		= '\比\例';
	lang_hk['DISPONIBLE']	= 'Only available';
	lang_hk['CUALQUIERA']	= '\任\何';
	lang_hk['SI']		= '\是';
	lang_hk['NO']		= '\否';
	lang_hk['LOGIN']	= '\登\入';
    lang_hk['MARCADORES']   = '\書\籤';
    lang_hk['ANYADIR']      = '\加\入';
    lang_hk['ENLACE']       = '\新\書\籤\網\址';
    lang_hk['TEXTO']        = '新書籤標題';
	lang_hk['MAXTIME']	= '最大運輸時間';
	lang_hk['ELIMINAR']	= '\刪\除';
	lang_hk['MAPA']		= '\地\圖 \(TravMap\)';
	lang_hk['CHECK']	= '\檢\查\新\版\本';
	lang_hk['ARCHIVE']	= '\封\存';
	lang_hk['RESUMEN']	= '\概\要';
	
	
	//for new
	lang_hk['ALDEA_EXTRA1'] 	= '\兵';	
	lang_hk['ALDEA_EXTRA2'] 	= '\運';	
	lang_hk['ALDEA_EXTRA3'] 	= '\地';	
	lang_hk['UPLV'] 	= '升級到等級';
	lang_hk['ALIANZA_FORUM'] 	= '聯盟論壇';	
	lang_hk['ALIANZA_CHAT'] 	= '聯盟 Chat';	
	lang_hk['ALIANZA_ATTACK'] 	= '聯盟攻擊';	
	lang_hk['ALIANZA_NEWS'] 	= '聯盟新聞';	
	lang_hk['ALIANZA_OPTION'] 	= '聯盟選項';

	//導出短消息用
	lang_hk['IGMTITLE'] = '主題'; 
	lang_hk['IGMSENTER'] = '寄件人'; 
	lang_hk['IGMDATE'] = '日期'; 
	lang_hk['IGMTIME'] = '時間'; 
	lang_hk['IGMOUTPUT'] = '顯示全部信件內容'; 
	
	//
	lang_hk['OPENLINK']='開啟連結';
	lang_hk['OPENRESINFO']='查詢資源田資訊';
	lang_hk['MAP']='地圖';
	lang_hk['ADD_ALL']='全部增加';
	lang_hk['SAVEMAPURL1']='請輸入名稱';
	lang_hk['SAVEMAPURL2']='&raquo; 將此地點存入書籤';	
	lang_hk['QUERYMODE']='查詢資源';		
	lang_hk['REFRESH_INFORMARION'] = '查看全部';
...
//	buildingCost[39] = greatGranaryCost;
	...
	function F(texto, args){
		...
		if (language[texto] == undefined) texto = lang_hk[texto]; else texto = language[texto];
...
//				[T('CALC'), "http://www.denibol.com/~victor/travian_calc/", "_blank"],
				...
				["PTT Ver 1.21", "https://opensvn.csie.org/traccgi/Travian_Beyond_Ptt_Version/wiki", "_blank"]				
		];
	...
	*/ 
	...
	function puntosCultura(){
		...
		for (var i = 0; i < 3; i++){
			...
			// 下一級需要的文明
			var pc_necesarios = (check3X() )? aldeas2pc3X(aldeas_actuales + i) : aldeas2pc(aldeas_actuales + i) ;
