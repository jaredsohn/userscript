...
// @description    Cosillas para facilitarme la vida en el foro mafia
// @include        *quegrande.org/mafia/*
// ==/UserScript==
...
(function(){
	...
	else if (new RegExp("mafia/(index\.php)?$").test(doc.location)) {
