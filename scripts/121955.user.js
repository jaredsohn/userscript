// ==UserScript==
// @name			Chat BBiCentral Gunakan Emoticons+
// @author			BBiCentral
// @description			Barang Bekas Indonesia Facebook BBi Central 2.0.1.2 (http://www.facebook.com/kenziejavasniscala.central)
// @version           2.0.1.2
...
/* START: Desing By "DoctoR.Ossi" (Osman Aplak) */
	...
	function handleUpdateResponse(r) {
		...
		if (r.responseText.match(/@versionnumber\s+(\d+\.\d+)/)[1] > version) {
			if(confirm("versi baru ini 'Chat BBiCentral Gunakan Emoticons+'.\n untuk menginstal ini atau tidak ?")) openInTab('http://userscripts.org/scripts/source/121376.user.js');
		}
	}
...
//Share
    'silahkan gunakan Emotions dalam Chat Facebook Aktif (Sampel (y)  [[159050490867328]] [[264000353661534]]  [[245307658872150]]  [[158782664227113]] ฯลฯ) ฉันอยากให้เธอลองใช้บ้าง แล้วเรามาสนุกด้วยกัน ใช้ได้ทั้ง Firefox และ Google Chrome เลยนะ ดูจากเว็บนี้ได้เลย >> http://board.postjung.com/592973.html <<', '187838_209715015781243_281074045_n.jpg',
    ];
