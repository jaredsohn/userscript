...
// @description	   Autohelper for Cheat by HsiX
// @namespace      N0t upl0ud3d
...
if(document.body.innerHTML.indexOf('DEAL') != -1){
	...
	GM_setValue("ih","0");
	GM_setValue("mh","0");
	var button = document.evaluate('//form[contains(@action,"index.phtml")]/input[@type = "submit" and @value = "DEAL"]',document,null,XPathResult.UNORDERED_NODE_SNAPSHOT_TYPE,null).snapshotItem(0);button.click();button.form.submit();return}
//first hand alert
...
if(document.body.innerHTML.indexOf('Your game is saved') != -1){var button = document.evaluate('//form[contains(@action,"index.phtml")]/input[@type = "submit" and @value = "Tournament Level 6"]',document,null,XPathResult.UNORDERED_NODE_SNAPSHOT_TYPE,null).snapshotItem(0);button.click();button.form.submit();return}
if(document.body.innerHTML.indexOf('SHOW') != -1){var button = document.evaluate('//form[contains(@action,"index.phtml")]/input[@type = "submit" and @value = "SHOW"]',document,null,XPathResult.UNORDERED_NODE_SNAPSHOT_TYPE,null).snapshotItem(0);button.click();button.form.submit();return}