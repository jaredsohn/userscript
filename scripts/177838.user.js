...
// @name        buxxxx
// @namespace   buxxxx
// @include     *://*buxxxx.com/index.php?view=click*
// @include     *://*buxxxx.com/index.php?view=account&ac=click*
// @include     *://*buxxxx.com/index.php?view=account&ac=ptra*
// @include     *://*buxxxx.com/gpt.php?v=entry*
// @include     *://*buxxxx.com/gpt.php?v=read*
// @include     *://*buxxxx.com/view.php?id=*
...
self == top){
	...
	if($('frame:last').attr('src').indexOf('cheat') >= 0 ){
		...
		if(wparent.location.host.indexOf('buxxxx')!=-1)cheatCheck=[1,6,9,18,28,29,15];
