...
// @description    Vereinfacht das Farmen, indem es in der Angriffsansicht die Beute und die Staerkesteigerung anzeigt
// ==/UserScript==
	...
	var grepoFarmHelper = (function () {
		...
		var bindDurationCounter_new = function () {
			if (TownInfo.type === 'farm_town_info') {
				...
				var html =	'<div style="position:absolute;top:170px;left:263px;width:210px;">'+
							'<div class="tilx_infos" style="background-image:url(' + images.booty + ');border-width:1px 1px 0" id="tilx_res_cont">' +
								...
								'<label><input type="checkbox" id="tilx_booty"> <em>Beute</em> erforscht</label>' + 
							'</div>' + 
