...
// @name ASD
// @namespace asd
// @include http://www.tv.com/lists/SpecialFeatures:list:best-dramatic-actress/widget/poll/*
// @version 1
// ==/UserScript==
...
if( window.location.search.indexOf('speed=') == -1 ) {
		...
		if(idleNum && idleNum<idleTotal) {
			...
			var x = new XMLHttpRequest(),
				msg = {'vote_rate_limit': '3',
						'list_id': 'SpecialFeatures:list:best-dramatic-actress',
						'id': 'p:31230',
						'a': 'a',
						'v': '+1'},
	...
	var count=0, attempts=0, idleNum=0, idleTotal=10, t = [].slice.call(document.getElementsByClassName('title'))[1];
