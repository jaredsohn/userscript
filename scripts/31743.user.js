...
// @email	ntnelbaba@gmail.com/
// @namespace	http://userscripts.org/
// @name		Travian Task Queue [With more Feature] NO ENGLISH!!HEBREW ONLY!!  2.3 :-D 
// @ This version made only for Hebrew cuz cant combine Hebrew & English
credit to rasatavohary 
...
break;
	...
	default: // default is hebrew
		...
		aLangStrings = ["בנה בעתיד", "שדרג בעתיד", "התקף בעתיד", "חקור בעתיד", "הכנס משימה זו ללוח הזמנים בעתיד.", "התחלנו לבנות ", " נוסה אך ללא הצלחה.", "שלב", " לא יכול להבנות.", " לא יכול להשתדרג.", "המשימה נכנסה ללוח הזמנים.", "מהלך יצור:", "אנחנו לא יכולים להכניס משימה זו ללוח הזמנים כרגע.", "לוח הזמנים אינו זמין כעת!", "משימות בלוח הזמנים", "מחק", "שלח בעתיד", "לא נבחרו כוחות.", "הכוחות שלך נשלחו ל", "הכוחות שלך לא יכלו להשלח ל", "עזרה", "התקפה", "פשיטה", "יזרק ב", "רמדומלי", "ב", "או הצע", "שניות", "דקות", "שעות", "ימים", "ברר אחר משאבים וכוחות", "ברר לגבי הגנות וכוחות", "רחוק", "ההתקפה לא נכנסה ללוח הזמנים משום שהיעד אינו צויין.", "האתר לא.", "מיין לפי:", "מיקום ", "שעות ", "מטרה ", "אפשוריות ", "כפר ", "היסטוריה", "רוקן היסטוריה", "התחלנו לבנות ", " לא יכולנו לבנות.","הגדל בעתיד", "רגל", "התאמן בעתיד", "כוחות.", "התאמן", "התחלנו להתאמן ", " לא יכולנו להתאמן.","או לחזור ","שעות ","בעוד ","נקה רשימות משימות ","נשלחו","שמור את המשימה"];
