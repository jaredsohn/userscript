...
var lang={
  ...
  hu: { 'send': 'Küld',			'sh': 'Megmutat/Elrejt',	'msg': 'Írj egy üzenetet',	'swap': 'Csere',
	...
	// greek translation by Gousgounis - actually incomplete, please can you help?
  gr: {	'send': 'Στείλε',				'sh': 'Εμφάνιση/Απόκρυψη',			'msg': 'Γράψτε το μήνυμα',	'swap': 'Αλλαγή',
        ...
        'wrng': 'Ο παλαιός κωδικός είναι λάθος',
  ...
  dk: {	'send': 'Send',			'sh': 'Vis/Gem',		'msg': 'Skriv en besked',	'swap': 'Skift',
    ...
    // russian translation by UnderGut - actually incomplete, please can you help?
  ru: { 'send': 'Отпр.',			'sh': 'Показать/Убрать',	'msg': 'Введите сообщение',	'swap': 'swap',
	...
	// looking for (at least) german, spanish, portugues, finnish, swedish translations, can you help me? :) Thanks!
}
...
var local='en';
if (domain=='fr' || domain=='it' || domain=='hu' || domain=='gr' || domain=='dk' || domain=='ru') local=domain;
...
function cbf(e) {
	...
	alert( ""
		  +"1.01: adden translations: dk, ru, hu, gr\n"
