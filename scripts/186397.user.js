...
var DriverJS = "2.0"; //ТЕКУЩАЯ ВЕРСИЯ -- lite+DiZ-Mod-Cleaner
...
if (settings.fullScreenTime) {
  ...
  //$('#navi').append(bTime);
  $('#main_logo_link').html("<div style='font-family:Verdana;font-size:24px;text-align:center;color:#444444;text-shadow:1px 1px 1px #DDDDDD;'><b>" + hours + ':' + minutes + ':' + seconds + "</b></div>");
