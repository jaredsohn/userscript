...
// --------------------------------------------------------------------
// ==UserScript==
// @name          SAB Tab for Newzbin V3 v1.4
...
// Location of your SABnzbd server, 
// Default: http://127.0.0.1:8080
var SABLocation = "http://127.0.0.1:8080";

// If you have setup a SABnzbd server username/pwd it is recommended to enable useSABData to ensure you are logged in
...
// Refresh interval for SAB Tab stats. 
// Default = 30, 0 = off
...
// Put SAB Tab as the left most menu item. 
// Default: false
var putSABTabFirst = false;

// Use pop out SAB Queue in the "Queue" menu item. 
// Default: false
...
// Changes Complete icon (green checkmark) to 1-click link for adding post to SAB. 
// Default: true
var use1ClickSABAdd = true;

// Use confirmation dialog when clicking 1-click link.
// if false dialog is skipped and post is added without prompt. 
// Default: true
var confirmAdd = true;
...
function GetSABData(SABPage){
	  ...
	  if (typeof SABPage == 'string') {SABPAGE=SABPage;}
		...
		if(useSABData){
			...
			document.getElementById('SABStatus_out').innerHTML='SAB Tab';		
		}
}
...
function GetSABQueue(){
	  ...
	  document.getElementById("mnSABQueue").innerHTML = "Fecthing Queue...";
		...
		onreadystatechange: function(responseDetails) { 
			if(responseDetails.readyState == 2 && SABRunning == false){			
				var SABStatus_out = document.getElementById('mnSABQueue');
			//TEST	SABStatus_out.innerHTML = "SAB unavailable";
			}
			SABRunning = false;
		}
	});
