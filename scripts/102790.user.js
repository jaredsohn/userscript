// ==UserScript==
// @name             KOCAttack - Extra Features italiano!
// @version          0.9.6.6_ita
// @namespace        KOCAttack-Extra IT
// @homepage         http://userscripts.org/scripts/show/102790
// @description      Versione italiana di KOC Attack extra features. In fase di sviluppo
...
var KOCAttack={
	...
	ShowViewAttacksDialog:function() {
		...
		typesel += '<option value="bulkadded">Bulk Add</option>';
		typesel += '</select>';
	...
	ShowOptionsDialog:function() {
		...
		div.innerHTML="<form><table>"+
			...
			"Attacco barbari:<input id='KOCAttackHoursSinceLastCamp' value='"+(this.options.attackSecsSinceLastCamp/(60*60))+"' size='3' />ore<br />"+
			"Attacco terre:<input id='KOCAttackHoursSinceLastWild' value='"+(this.options.attackSecsSinceLastWild/(60*60))+"' size='3' />ore<br />"+
			" Attacco città:<input id='KOCAttackHoursSinceLastCity' value='"+(this.options.attackSecsSinceLastCity/(60*60))+"' size='3' />ore<br />"+
			" Trasporto:<input id='KOCAttackMinsSinceLastTransport' value='"+(this.options.attackSecsSinceLastTransport/(60))+"' size='3' />min<br />"+
			" Nel trasporto, lascia almeno <input id='KOCAttackTransportReserveAmount' value='"+this.options.transportResourcesReserveAmount+"' size='10' /> di ogni risorsa in ciascuna città <font color=#FF0000>(NEW)</font>"+
			"</div>"+
			"<input id='KOCAttackRandom' value='"+this.options.randomPercent+"' size='3' />% di regolazione dei ritardi (per sembrare più umano).<br />"+
			"<br />"+
			...
			"<input id='KOCAttackRemoveFarmReports' type='checkbox' "+(this.options.autoRemoveFarmReports?'checked':'')+" /> Rimozione automatica resoconti attacchi alle farm.<br />"+
			...
			"<span style=\"font-size:10px; color:#555; line-height:18px; \">Per abilitare l'addestramento automatico, cliccare il pulsante auto train sotto il tipo di truppa nella caserma.</span><br />"+
			"<span style=\"font-size:10px; color:#555; line-height:18px; \">Nota: Se addestri il 100% della popol. massima, potresti incorrere in errori di cache a causa delle risorse.</span><br />"+
			"</td></tr>"+
			
			"<tr><td valign='top' align='center'><img src='img/gold_30.png' /></td><td valign='top'>"+
			"<input id='KOCAttackAutoGoldHappiness' value='"+this.options.autoGoldHappiness+"' size='3' />% felicità prima di attivare l'oro automatico.<br />"+
			"<span style=\"font-size:10px; color:#555; line-height:18px; \">Per attivare l'oro automatico, cliccare sul pulsante auto gold nel castello.</span><br />"+
			"</td></tr>"+
			...
			"Import/Export: copia o incolla le impostazioni qui...<br /><textarea id='KOCAttackImport'></textarea>"+
			...
			"<a id='KOCAttackOptionsSave' class='button20'><span>Salva</span></a> <a id='KOCAttackOptionsCancel' class='button20'><span>Cancella</span></a> <a id='KOCAttackOptionsReset' class='button20'><span>Reset opzioni</span></a> <a id='KOCAttackOptionsResetAll' class='button20'><span>Reset tutto!</span></a>"+
	...
	*/	
	...
	BulkAddAttackLink:function(box) {
		...
		AddHtml(bulkAddDiv,"<hr />");
		AddHtml(bulkAddDiv,"Tipo di bersaglio:<br />");
		...
		//AddHtml(bulkAddDiv,"<input id='KOCAttackBulkAddSuicideWave' type='checkbox' /> Questo è un attacco suicida per spazzare le trappole nelle terre selvagge.<br />");
		...
		AddHtml(bulkAddSuicideSpan,'<label for="KOCAttackBulkAddSuicideWave">Questo è un attacco suicida per spazzare le trappole delle terre selvagge.</label>');
	...
	HideAttackEfforts: function () {
		...
		a.innerHTML = 'Nascondi Attacco/Acceleratori';
		//inp.type='checkbox';
		span.appendChild(a);
