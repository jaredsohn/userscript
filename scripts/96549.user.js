...
function selection(pos, players) {
  ...
  for (var x=0; x<players.length; x++) {
    ...
    if (players[x][0][2] == pos) {
      ...
      if (pos=="QB") {
        score=parseFloat(players[x][0][8])/18.0 + parseFloat(players[x][0][9])*4.1 - parseFloat(players[x][0][10])*3.0 - 
              parseFloat(players[x][0][16])*2.5 + parseFloat(players[x][0][14]) * 1.2 + (parseFloat(players[x][0][5]) < 80 ? -10000 : 0);
        players[x][0][3]=parseFloat(score)*parseFloat(players[x][0][7]);
      }
      else if (pos=="RB")
        players[x][0][3]=parseFloat(players[x][0][19])/12.5 + parseFloat(players[x][0][21])*3.0 + parseFloat(players[x][0][28])*0.25 - 
                      parseFloat(players[x][0][30])*0.5 + parseFloat(players[x][0][33])* 4.0 + parseFloat(players[x][0][32]) / 13 -
                      parseFloat(players[x][0][26]);
      else if (pos=="FB")
        players[x][0][3]=parseFloat(players[x][0][19])/12.5 + parseFloat(players[x][0][21])*3.0 + parseFloat(players[x][0][28])*0.25 - 
                      parseFloat(players[x][0][30])*0.5 + parseFloat(players[x][0][33])* 4.0 + parseFloat(players[x][0][32]) / 13 -
                      parseFloat(players[x][0][26]);
      else if (pos=="WR")
        players[x][0][3]=parseFloat(players[x][0][32])/10.0 + parseFloat(players[x][0][33]) * 5.0 + parseFloat(players[x][0][28]) * 0.2 - 
                      parseFloat(players[x][0][30]) * 0.8 - parseFloat(players[x][0][38]) * 1.2;
      else if (pos=="TE")
        players[x][0][3]=parseFloat(players[x][0][32])/10.0 + parseFloat(players[x][0][33]) * 4.0 + parseFloat(players[x][0][28]) * 0.2 - 
                      parseFloat(players[x][0][30]) *0.8 - parseFloat(players[x][0][38]) * 1.2 + 
                      parseFloat(players[x][2][15]) * parseFloat(players[x][2][20]) / 100.0 + parseFloat(players[x][2][10])/8.0;
      else if (pos=="C")
        players[x][0][3]= parseFloat(players[x][2][15])* (parseFloat(players[x][2][20])-7.5) / 10.0 + 
                          (1.0 - parseFloat(players[x][2][18]) * 10.0 / 100.0) * (parseFloat(players[x][2][16])-300.0) / 9.0 +
                          parseFloat(players[x][2][15])/8.0 + (players[x][2][15] < 150 ? -10000 : 0) + (players[x][2][16] < 150 ? -10000 : 0);
      else if (pos=="G")
        players[x][0][3]= parseFloat(players[x][2][15])* (parseFloat(players[x][2][20])-7.5) / 10.0 + 
                          (1.0 - parseFloat(players[x][2][18]) * 20.0 / 100.0) * (parseFloat(players[x][2][16])-300.0) / 9.0 +
                          parseFloat(players[x][2][15])/8.0 + (players[x][2][15] < 150 ? -10000 : 0) + (players[x][2][16] < 150 ? -10000 : 0);
      else if (pos=="T")
        players[x][0][3]= (parseFloat(players[x][2][15])-200.0) * (parseFloat(players[x][2][20])-6.7) / 10.0 + 
                          (1.0 - parseFloat(players[x][2][18]) * 35.0 / 100.0) * (parseFloat(players[x][2][16])-300.0) / 5.0 +
                          parseFloat(players[x][2][15])/8.0 + (players[x][2][15] < 150 ? -10000 : 0) + (players[x][2][16] < 150 ? -10000 : 0);
      else if (pos=="DE")
        players[x][0][3]= parseFloat(players[x][1][7]) * 0.8 + parseFloat(players[x][1][8]) * 7.5 + parseFloat(players[x][1][10])* 3.0 + 
                          parseFloat(players[x][1][11])* 6.0 + parseFloat(players[x][1][13]) * 12.0 + parseFloat(players[x][1][14]) * 3.0 +
                          parseFloat(players[x][1][15]) * 1.8 + parseFloat(players[x][1][17]) * 12.0;
      else if (pos=="DT")
        players[x][0][3]= parseFloat(players[x][1][7]) * 0.8 + parseFloat(players[x][1][8]) * 7.5 + parseFloat(players[x][1][10])* 3.5 + 
                          parseFloat(players[x][1][11])* 6.0 + parseFloat(players[x][1][13]) * 14.0 + parseFloat(players[x][1][14]) * 3.0 +
                          parseFloat(players[x][1][15]) * 1.8 + parseFloat(players[x][1][17]) * 14.0;
      else if (pos=="LB")
        players[x][0][3]= parseFloat(players[x][1][7]) * 0.7 + parseFloat(players[x][1][8]) * 9.0 + parseFloat(players[x][1][10])* 6.0 + 
                          parseFloat(players[x][1][11])* 9.0 + parseFloat(players[x][1][13]) * 12.0 + parseFloat(players[x][1][14]) * 5.0 +
                          parseFloat(players[x][1][15]) * 1.2 + parseFloat(players[x][1][17]) * 12.0;
      else if (pos=="CB")
        players[x][0][3]= parseFloat(players[x][1][7]) * 0.15 + parseFloat(players[x][1][8]) * 3.8 + parseFloat(players[x][1][10])* 4.5 + 
                          parseFloat(players[x][1][11])* 7.5 + parseFloat(players[x][1][13]) * 9.0 + parseFloat(players[x][1][14]) * 3.5 +
                          parseFloat(players[x][1][15]) * 1.2 + parseFloat(players[x][1][17]) * 9.0;
      else if (pos=="S")
        players[x][0][3]= parseFloat(players[x][1][7]) * 0.8 + parseFloat(players[x][1][8]) * 5.5 + parseFloat(players[x][1][10])* 4.0 + 
                          parseFloat(players[x][1][11])* 6.7 + parseFloat(players[x][1][13]) * 9.0 + parseFloat(players[x][1][14]) * 3.5 +
                          parseFloat(players[x][1][15]) * 1.2 + parseFloat(players[x][1][17]) * 9.0;
      else if (pos=="K")
      ...
      players[x][0][3]= parseFloat(players[x][2][6]) * 4.0 + parseFloat(players[x][2][5]) / 2.0 - (parseInt(players[x][2][5]) <= 15)* 1000.0
                        + parseFloat(players[x][2][7]) * 3.5;
      list[list.length]=players[x];
    }
    else if (pos=="PRET") {
      players[x][0][3]= parseFloat(players[x][2][10]) * 17.0 + parseFloat(players[x][2][9]) / 2.0 - (parseInt(players[x][2][9]) <= 15)* 1000.0
                        + parseFloat(players[x][2][11]) * 3.5;
      list[list.length]=players[x];
    }
  ...
  if (list.length>0) {
    ...
    if (pos=="QB")
      for (var x=0; x<3; x++) {
        newdiv=creatediv("<b>"+list[x][0][0] + " - " + list[x][0][1] + "</b> ATT: <b>" + list[x][0][5] + "</b>, CMP: <b>" + list[x][0][6] +
                         "</b>, PCT: <b>" + list[x][0][7] + "</b>, YRD: <b>" + list[x][0][8] + "</b>, TD: <b>" + list[x][0][9] + 
                         "</b>, INT: <b>" + list[x][0][10] +"</b>, RATE: <b>" + list[x][0][14] + "</b>, SACK: <b>" + list[x][0][12] + 
                         "</b>, FMBL: <b>" + list[x][0][16] +"</b>", "QB"+x);
        target.parentNode.insertBefore(newdiv, target);
      }
    else if (pos=="RB")
      for (var x=0; x<3; x++) {
        newdiv=creatediv("<b>"+list[x][0][0] + " - " + list[x][0][1] + "</b> Rush: <b>" + list[x][0][18] + 
                         "</b>, YRD: <b>" + list[x][0][19] + "</b>, YPC: <b>" + list[x][0][20] + "</b>, Rush TD: <b>" + list[x][0][21] + 
                         "</b>, FMBL: <b>" + list[x][0][26] + "</b>, REC: <b>" + list[x][0][28] + "</b>, DRP: <b>" + list[x][0][30] + 
                         "</b>, YRD: <b>" + list[x][0][32] + "</b>, REC TD: <b>" + list[x][0][33] + "</b>","RB"+x);
        target.parentNode.insertBefore(newdiv, target);
      }
    else if (pos=="FB")
      for (var x=0; x<1; x++) {
        newdiv=creatediv("<b>"+list[x][0][0] + " - " + list[x][0][1] + "</b> Rush: <b>" + list[x][0][18] + 
                         "</b>, YRD: <b>" + list[x][0][19] + "</b>, YPC: <b>" + list[x][0][20] + "</b>, Rush TD: <b>" + list[x][0][21] + 
                         "</b>, FMBL: <b>" + list[x][0][26] +"</b>, REC: <b>" + list[x][0][28] + "</b>, DRP: <b>" + list[x][0][30] + 
                         "</b>, YRD: <b>" + list[x][0][32] + "</b>, REC TD: <b>" + list[x][0][33] + "</b>","FB"+x);
        target.parentNode.insertBefore(newdiv, target);
      }
    else if (pos=="WR")
      for (var x=0; x<4; x++) {
        newdiv=creatediv("<b>"+list[x][0][0] + " - " + list[x][0][1] + "</b> REC: <b>" + list[x][0][28] + 
                         "</b>, TGT: <b>" + list[x][0][29] + "</b>, DRP: <b>" + list[x][0][30] + "</b>, YPC: <b>" + list[x][0][31] + 
                         "</b>, YRD: <b>" + list[x][0][32] + "</b>, TD: <b>" + list[x][0][33] + 
                         "</b>, YAC: <b>" + list[x][0][35] + "</b>, FMBL: " + list[x][0][38] + "</b>","WR"+x);
        target.parentNode.insertBefore(newdiv, target);
      }
    else if (pos=="TE")
      for (var x=0; x<2; x++) {
        newdiv=creatediv("<b>"+list[x][0][0] + " - " + list[x][0][1] + "</b> REC: <b>" + list[x][0][28] + 
                         "</b>, TGT: <b>" + list[x][0][29] + "</b>, DRP: <b>" + list[x][0][30] + "</b>, YPC: <b>" + list[x][0][31] + 
                         "</b>, YRD: <b>" + list[x][0][32] + "</b>, TD: <b>" + list[x][0][33] + "</b>, YAC: <b>" + list[x][0][35] + 
                         "</b>, FMBL: <b>" + list[x][0][38] + "</b>, ORP: <b>" + list[x][2][15] + "</b>, RBLK: <b>" + list[x][2][19] +
                         "</b>, GRADE: <b>" + list[x][2][20] + "</b>", "TE"+x);
        target.parentNode.insertBefore(newdiv, target);
      }
    else if (pos=="C")
      for (var x=0; x<2; x++) {
        newdiv=creatediv("<b>"+list[x][0][0] + " - " + list[x][0][1] + "</b> OPP: <b>" + list[x][2][16] + 
                         "</b>, SkAl: <b>" + list[x][2][17] + "</b>, PCT: <b>" + list[x][2][18] + "</b>, ORP: <b>" + list[x][2][15] +
                         "</b>, RBLK: <b>" + list[x][2][19] + "</b>, GRADE: <b>" + list[x][2][20] + "</b>", "C"+x);
        target.parentNode.insertBefore(newdiv, target);
      }
    else if (pos=="G")
      for (var x=0; x<3; x++) {
        newdiv=creatediv("<b>"+list[x][0][0] + " - " + list[x][0][1] + "</b> OPP: <b>" + list[x][2][16] + 
                         "</b>, SkAl: <b>" + list[x][2][17] + "</b>, PCT: <b>" + list[x][2][18] + "</b>, ORP: <b>" + list[x][2][15] +
                         "</b>, RBLK: <b>" + list[x][2][19] + "</b>, GRADE: <b>" + list[x][2][20] + "</b>", "G"+x);
        target.parentNode.insertBefore(newdiv, target);
      }
    else if (pos=="T")
      for (var x=0; x<3; x++) {
        newdiv=creatediv("<b>"+list[x][0][0] + " - " + list[x][0][1] + "</b> OPP: <b>" + list[x][2][16] + 
                         "</b>, SkAl: <b>" + list[x][2][17] + "</b>, PCT: <b>" + list[x][2][18] + "</b>, ORP: <b>" + list[x][2][15] +
                         "</b>, RBLK: <b>" + list[x][2][19] + "</b>, GRADE: <b>" + list[x][2][20] + "</b>", "T"+x);
        target.parentNode.insertBefore(newdiv, target);
      }
    else if (pos=="DE")
      for (var x=0; x<3; x++) {
        newdiv=creatediv("<b>"+list[x][0][0] + " - " + list[x][0][1] + "</b> TCK: <b>" + list[x][1][7] +
                         "</b>, SACK: <b>" + list[x][1][8] + "</b>, PDEF: <b>" + list[x][1][10] + "</b>, INT: <b>" + list[x][1][11] +
                         "</b>, ITD: <b>" + list[x][1][13] + "</b>, FFUM: <b>" + list[x][1][14] + "</b>, FREC: <b>" + list[x][1][15] +
                         "</b>, FTD: <b>" + list[x][1][17] + "</b>", "DE"+x);
        target.parentNode.insertBefore(newdiv, target);
      }
    else if (pos=="DT")
      for (var x=0; x<3; x++) {
      ...
      for (var x=0; x<1; x++) {
        newdiv=creatediv("<b>"+list[x][0][0] + " - " + list[x][0][1] + "</b> KRET: <b>" + list[x][2][5] + "</b>, KAVG: <b>" + list[x][2][6] +
                         "</b>, KOTD: <b>" + list[x][2][7] + "</b>", "KRET"+x);
        target.parentNode.insertBefore(newdiv, target);
      }
    else if (pos=="PRET")
      for (var x=0; x<1; x++) {
        newdiv=creatediv("<b>"+list[x][0][0] + " - " + list[x][0][1] + "</b> PRET: <b>" + list[x][2][9] + "</b>, PAVG: <b>" + list[x][2][10] +
                         "</b>, PTD: <b>" + list[x][2][11] + "</b>", "KRET"+x);
        target.parentNode.insertBefore(newdiv, target);
      }
