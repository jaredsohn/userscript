...
// @include         http://nl*.tribalwars.nl/*screen=report*	
// @include         http://nl*.tribalwars.nl/game.php*screen=place*
// @include         http://nl*.tribalwars.nl/game.php?*screen=map*
// @include         http://nl*.tribalwars.nl/game.php*screen=info_command&id*
// @exclude        http://nl*.tribalwars.nl/game.php?*screen=train*
// @include        http://nl*.tribalwars.nl/game.php?*mode=prod*
// @icon             http://www.tribalwars.nl/graphic/klee.png
// ==/UserScript==
// @run-at window-load
...
//      ovlMoral: "Moral",
      ...
      forumWiki: "http://forum.tribalwars.nl/showthread.php?154445-8-8-GM-TW-assistent3",
      forumDonate: "https://www.paypal.com", 
