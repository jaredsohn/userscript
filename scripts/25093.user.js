...
// @description    Displays further information for movies. Version 0.2.1.
...
function getPureRating(dom) {
    var xpath = "div[@id='wrapper']/div[@id='root']/div[@id='tn15']/div[@id='tn15main']/div[@id='tn15content']/div[@id='tn15rating']/div[2]/b[2]";
...
function IMDbVotes(dom) {
    var xpath = "div[@id='wrapper']/div[@id='root']/div[@id='tn15']/div[@id='tn15main']/div[@id='tn15content']/div[@id='tn15rating']/div[2]/small";
...
function IMDbGenres(dom) {
    ...
    var xpath = "div[@id='wrapper']/div[@id='root']/div[@id='tn15']/div[@id='tn15main']/div[@id='tn15content']/div[6]/a";
...
function IMDbPoster(dom) {
    ...
    var images = evalXPath(dom,
        "div[@id='wrapper']/div[@id='root']/div[@id='tn15']/div[@id='tn15lhs']/div/a/img/@src");
...
function IMDbImages(dom) {
    ...
    var xpath = "div[@id='wrapper']/div[@id='root']/div[@id='tn15']/div[@id='tn15main']/div[@id='tn15content']/table[1]/tbody/tr[2]/td/div/a/img/@src";
...
function IMDbRelease(dom) {
    var content = document.createElement("td");
    var xpath = "div[@id='wrapper']/div[@id='root']/div[@id='tn15']/div[@id='tn15main']/div[@id='tn15content']/div[5]/text()[2]";
...
function IMDbOutline(dom) {
    ...
    var re = /<h5>Plot (?:Summary|Outline):<\/h5>\s*([^<]*)/i;
    
    var outline = text.match(re);
    
    if(outline) {
        content.innerHTML = outline[1];
    }
    else {
