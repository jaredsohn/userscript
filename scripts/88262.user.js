// ==UserScript==
// @name DS MapAllyList
// @description Version 1.1.1 Zeigt StÃ¤mme- und Spielerlisten auf der Karte
// @author Hypix
...
// Versionhistory:
// 1.1.1 DS-Ã„nderungen hinterher geflickt
// 1.1.0 Anpassung an DS-Version 6.0
...
function parseMap()
{
  ...
  if( container )
  {
    ...
    for( var i = 0; i < tds.length; i++ )
    {
      ...
      {
        a = a[0];
        var parts = a.getAttribute("onmouseover").match( /map_popup\(event, '([^']*)', '([^']*)', '([^'])*', (\d+), ('([^']*)'|null), ('([^']*)'|null),/);
