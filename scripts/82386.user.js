...
// @name           eRepublik WE Bebe I Battalion Military Tracker by Denis Cicic. Rgds to Roktaal
// @namespace      http://www.erepublik.com/en/citizen/profile/1709354
// @description    eRepublik WE Bebe I Battalion Military Tracker.
// @version        1.0.2
// @include        http://www.erepublik.com/en
// @include        http://www.erepublik.com/sr
// @require        http://sizzlemctwizzle.com/updater.php?id=82386&days=1&show
...
function preFetchMembers() {
	GM_xmlhttpRequest({
		method: 'GET',
		url: 'http://whiteeagles.freehostia.com/members/WebebeImem',
		onload:function(response) {
...
function Main(e) {
	GM_xmlhttpRequest({
		method: 'GET',
		url: 'http://whiteeagles.freehostia.com/members/webebeIusers',
		onload:function(response) {
			var statusData = "off";
