...
var addPlatoonButton = function () {
	...
	<div id="comcenter-platoons" class="comcenter-preview-area " style="display: none;">\
		...
		<div class="comcenter-notification-content">\
			<div class="comcenter-notification-list" style="max-height: 500px; overflow-y: scroll;">\
		...
		$('#base-dropdown-menu-your-platoons').children().slice(1).each(function () {
			...
			$.ajax({
				...
				success: function (data) {
					...
					$('#platoon-'+id).find('img').first().attr('src', 'http://static.cdn.ea.com/battlelog/prod/emblems/60/'+data.context.platoon.badgePath).attr('style', '');
