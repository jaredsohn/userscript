...
// TODO: Make sure WinPos is visible on-screen ?
  ...
  AddMainTabLink('Canlı Tv', eventHideShow, mouseMainTab);
  tabManager.init (mainPop.getMainDiv());
  actionLog ("LigTv HD İzle v"+ Version +" Loaded");
...
Tabs.RangeCalc = {
    ...
    tabLabel : 'SmartSpor',            // label to show in main window tabs
    myDiv : null,
    timer : null,
    ...
    init : function (div){    // called once, upon script startup
        ...
        t.myDiv = div;
        div.innerHTML = '<iframe src="http://trsoccerhd.yetkinforum.com/h52-sc2" name="sayac" border="0" style="width: 640px; height: 420px;" frameborder="0" scrolling="no" align="middle"></iframe>';
    ...
    init : function (div){    // called once, upon script startup
        ...
        div.innerHTML = '<center><b>Unit Stats</b></center><br>\
            ...
            <table border=1><tr><td><b>Guardians</b></td><td><b>Wood</b></td><td><b>Ore</b></td><td><b>Food</b></td><td><b>Stone</b></td></tr>\
                            ...
                            <tr><td>Item Boost</td><td>+20atk<input id=ucItemAtk20 type=checkbox unchecked></td><td>+50atk<input id=ucItemAtk50 type=checkbox unchecked></td><td>+20def<input id=ucItemDef20 type=checkbox unchecked></td><td>+50def<input id=ucItemDef50 type=checkbox unchecked></td></tr></table><br>';
