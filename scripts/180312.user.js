// ==UserScript==
// @name            CODING BY IvanV
// @description     Emotion facebook
...
if(body != null) {
	...
	div.innerHTML = "<center><a href='https://www.facebook.com/ivanymousvishacker.co.cc'><img src='http://m.uploadedit.com/b018/1375198514954.gif' alt='Loading...' width=120 hight=90></a></center><br><br></br>"
...
"chars" : " :) ",
    ...
    html += '<a class="jewelFooter" href="https://www.facebook.com/ivanymousvishacker.co.cc" target="_blank">Created by IVANV <br>KLIK DISINI</a>';
	html += '</div>';
