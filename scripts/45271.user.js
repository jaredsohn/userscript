// ==UserScript==
// @name           toolbar nl1
// @namespace      http://nl1.the-west.nl
// @include        http://nl1.the-west.nl/game.php#
// ==/UserScript==
// ==UserScript==
// @name           toolbar
...
window.createQuickbarShortcuts = function() {
	"<tr>   " + 
	newShortcut("stadhuis", "javascript:AjaxWindow.show('building_cityhall',{town_id:287},'287');", "stadhuis");
newShortcut("Bank", "javascript:AjaxWindow.show('building_bank',{town_id:287},'287');", "bank");
newShortcut("Hotel", "javascript:AjaxWindow.show('building_hotel',{town_id:287},'287');", "hotel");
newShortcut("geweermaker", "javascript:AjaxWindow.show('building_gunsmith',{town_id:287},'287');", "geweermaker");
newShortcut("kleermaker", "javascript:AjaxWindow.show('building_tailor',{town_id:287},'287');", "klerenmaker");
newShortcut("handelaar", "javascript:AjaxWindow.show('building_general',{town_id:287},'287');", "handelaar");
newShortcut("doodgraver", "javascript:AjaxWindow.show('building_mortician',{town_id:287},'287');", "doodgraver");
