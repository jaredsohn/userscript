...
// ==/UserScript==
	...
	function taobao(cart_url,url_save)
	{
		...
		this.htmlOnLoad=function ()
		{
			...
			//html vung luu lai
			var save_text='<div style="float:right;margin-right:50px;margin-top:6px">[<a id="id_nhaphang_save_item" href="'+href+'">Lưu lại đặt hàng sau</a>]</div>';
	...
	function alibaba(cart_url,url_save)
	{
		...
		this.htmlOnLoad=function ()
		{
			...
			var price_result =getVNDPrice(price_taobao);
			var quantity=getQuantity();
			var price_text='<div style="font-weight:bold;color: blue; font-size: 24px;margin-bottom:10px;margin-left:41px" id="hangnhap-price">'+(price_result)+' VNĐ</div>';
			...
			var com_text='<div><span style="width:50px;">Mô tả：</span><input id="min_quantity" type="hidden" value="'+quantity+'" /><textarea cols="64" id="txtBz" name="txtBz"></textarea></div>';
	...
	var url="http://localhost/Cart/add?";
