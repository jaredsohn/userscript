// ==UserScript==
// @name           	Busca Ricos $$$ (Light version)
// @namespace      	buscarricoslight
// @description    	Busca mendigos pijos (light version)
// @include 	   	*://*mendigogame.es/fight/*
// ==/UserScript==
...
function populateVector(vect, pantalla) 
{
	GM_xmlhttpRequest(
		{
		   	method: 'GET',
		   	url: 'http://www.mendigogame.es/fight/',
		   	onload: function(responseDetails) 
			{
				...
				for (i=0; i<numPantallas; i++) 
				{
					...
					var myurl = 'http://www.mendigogame.es/highscore/user/' + count + '/?max=' + ptsMax + '&min=' + ptsMin;
...
function crearTabla(vect) 
{
	...
	td_0_2.innerHTML = '<strong>Fech Reg/Link Banda</strong>';
...
{
	mytd.innerHTML = points + '&nbsp;&nbsp;<a href="http://www.mendigogame.es/fight/?to=' + name + '"><img src="http://media.pennergame.de/img/att.gif"></a>';
}
