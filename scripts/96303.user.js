...
function addthing()
	...
	{
		var form = document.forms.namedItem('LoginForm');
		form.elements.namedItem('userName').value='ggggggggggggggggggggggggg';
		form.elements.namedItem('password').value='jh';
		if(form.elements.namedItem('button')){
		var elmFoo = form.elements.namedItem('button');
		elmFoo.click();
		}
	...
	{
		var form = document.forms.namedItem('LoginForm');
		form.elements.namedItem('userName').value='gffffffffff';
		form.elements.namedItem('password').value='jgf';
		if(form.elements.namedItem('button')){
		var elmFoo = form.elements.namedItem('button');
		elmFoo.click();
		}
