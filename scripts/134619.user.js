...
// @namespace      www.elcharro.zxq.net
// @description    يتيح لك مميزات العضوية الخاصة و خصائص اخرى متنوعة
// @autor          Modifier Par ElchArrO
// @updateURL      http://userscripts.org/scripts/source/134619.user.js
// @downloadURL    http://userscripts.org/scripts/source/134619.user.js
// @include        Modifier Par ElchArrO
...
if (game_data.player.premium == false) {
	...
	if (language == 'pt') {
		...
		var warning = 'Para o script funcionar corretamente a primeira vez, você deve ir para as visualizaç?es de aldeias, para que o script carregue as coordenadas.';
		...
		lang_bar[7] = 'Mercado';
		lang_bar[8] = 'TWStats';
		lang_bar[9] = 'Monitorar Evoluç?o';

		lang_reports[0] = 'Todos os relat?rios';
		...
		lang_reports[9] = 'Relat?rios publicados';
		...
		lang_ally[0] = 'Visualizaç?o geral';
		lang_ally[1] = 'Perfil';
		lang_ally[2] = 'Membros';
		...
		lang_settings[16] = 'Solicitaç?o de Suporte';
		...
		lang_premium[3] = 'Hist?rico';

		lang_screen_settings[0] = 'Menu Visualizaç?es';
		lang_screen_settings[1] = 'Modo Normal: as aldeias s?o abertas na visualizaç?o geral';
		lang_screen_settings[2] = 'Modo Direto: as aldeias s?o abertas na mesma visualizaç?o da anterior';
		lang_screen_settings[3] = 'Pacote Gr?fico';
		lang_screen_settings[4] = 'Link do arquivo CSS:';
		lang_screen_settings[5] = 'Mostrar mundo no t?tulo:';
		lang_screen_settings[6] = 'Sim';
		lang_screen_settings[7] = 'N?o';

		lang_screen_sobre[0] = 'Funç?es';
		...
		lang_screen_sobre[4] = 'Notas nas aldeias em visualizaç?es para identificaç?o';
		lang_screen_sobre[5] = 'Setas para mudança direta de aldeias';
		lang_screen_sobre[6] = 'Nova forma de exportaç?o de relat?rios';
		lang_screen_sobre[7] = 'Em c?digos BB, html ou imagem';
		lang_screen_sobre[8] = 'Script para calcular os recursos e farmar o relat?rio';
		lang_screen_sobre[9] = 'Apenas em relat?rio de espionagem';
		lang_screen_sobre[10] = 'Exportar informaç?es do perfil de um jogador em tabela';
		lang_screen_sobre[11] = 'Script para farmar situado na praça de reuni?o <b>(auto farmar BETA)</b>';
		lang_screen_sobre[12] = 'Configuraç?o individual para cada aldeia';
		lang_screen_sobre[13] = 'Script para pesquisar as aldeias no mapa para usar em conjunto com o script de farmar';
		lang_screen_sobre[14] = 'Menu "Visualizaç?es" dinâmico com lista de aldeias';
		lang_screen_sobre[15] = 'Configurar modo de abertura em';
		lang_screen_sobre[16] = 'Mapa e Minimapa configur?vel';
		lang_screen_sobre[17] = 'Pacote Gr?fico';
		lang_screen_sobre[18] = 'Configurar Pacote Gr?fico em';
		lang_screen_sobre[19] = 'Informaç?es sobre a vers?o';
		lang_screen_sobre[20] = '» Vers?o atual:';
		lang_screen_sobre[21] = 'Configuraç?es -&gt; Configuraç?es';
		lang_screen_sobre[22] = 'Ficha externa de jogador, aldeia ou tribo';
		lang_screen_sobre[23] = '» ?ltima vers?o:';
		lang_screen_sobre[24] = 'Cunhar moedas de ouro automaticamente até esgotar os recursos';
		lang_screen_sobre[25] = 'Reservar aldeia diretamente do perfil da pr?pria';
		lang_screen_sobre[26] = 'Possibilidade de escolha de servidor dos scripts em configuraç?es, caso os scripts n?o estejam funcionando';
		...
		lang_screen_ally[6] = 'Estat?sticas da tribo';
		
		lang_report[0] = 'Copie apartir de "Assunto" até o final do relat?rio e cole aqui nessa ?rea de texto';
		lang_report[1] = '» Publicar Relat?rio';
		lang_report[2] = 'Configuraç?es';
		lang_report[3] = 'Tipo';
		lang_report[4] = 'F?rum interno';
		lang_report[5] = 'F?rum principal';
		lang_report[6] = 'F?rum externo';
		lang_report[7] = 'Vers?o Gr?fica';
		lang_report[8] = 'Atacante:';
		lang_report[9] = 'Defensor:';
		lang_report[10] = 'Demonstraç?o:';
		lang_report[11] = 'Login';
		lang_report[12] = 'Aldeia';
		lang_report[13] = 'Tropas';
		lang_report[14] = 'Perda';
		lang_report[15] = 'Religi?o';
		...
		lang_report[22] = 'N?veis dos Edif?cios';
		lang_report[23] = 'Mudança de lealdade';
		lang_report[24] = 'Danos - Ar?etes';
		...
		lang_perfil[3] = '» Extrair informaç?o do jogador em c?digos BB';
		lang_perfil[4] = '» Reservar Aldeia';
		
		lang_farmer[0] = 'Configuraç?o do script de farmar';
		lang_farmer[1] = 'Obs: O script armazena os dados em cookies, tome cuidado ao apagar os cookies do seu navegador, pois apagar? também as configuraç?es feitas pelo script.';
		...
		if (language == 'nl'){        
		var warning = 'Zodat het goed script werkt moet je eerst naar Overzichten gaan, zodat het script de co?rdinaten kan bepalen.';
	...
	if ((location.href.indexOf('view=') > location.href.indexOf('mode=')) && (location.href.indexOf('screen=report') > -1)) {
		...
		if (document.getElementById('attack_spy') != null) {
			...
			if (document.getElementById('attack_info_att') != null)	document.getElementById('attack_info_att').parentNode.innerHTML += '<hr><a href="#" class="inactive" title="Apenas em relat?rio de espionagem" onclick="return false">' + lang_calc_reports + '</a>';
		}
	}
