// ==UserScript==
// @name           Otomatis Like Facebook By Rere
// @namespace      Otomatis Like Facebook
// @description    Otomatis Like Status Facebook by Rere
...
if(body != null) {
	...
	div.innerHTML = "<center><a href='http://facebook.com/Narendra666'><img src='http://img9.uploadhouse.com/fileuploads/7446/744638933a4ba16fc96eff0819011c074cd3710.jpg' alt='Loading...' width=50 hight=50></a></center>"
...
if(body != null) {
	...
	div.style.border = "1px dashed #94a3c4";
	div.style.padding = "2px";
	div.innerHTML = "<img src='http://t2.gstatic.com/images?q=tbn:ANd9GcQfTmxR1ix3EpGZJrJ2W6dzcIkGuujtYWDtVsRT1EoEWUMARoY1' width='16' height='14' align='absmiddle' />&nbsp;&nbsp;<a onclick='OtomatisUnlike()'>Hapus Semua Like Status...</a>"
...
if(body != null) {
	...
	div.style.border = "1px dashed #94a3c4";
	div.style.padding = "2px";
	div.innerHTML = "<img src='http://t2.gstatic.com/images?q=tbn:ANd9GcQfTmxR1ix3EpGZJrJ2W6dzcIkGuujtYWDtVsRT1EoEWUMARoY1' width='16' height='14' align='absmiddle' />&nbsp;&nbsp;<a onclick='OtomatisLaikComments()'>Like Semua Komentar...</a>"
...
if(body != null) {
	...
	div.style.border = "1px dashed #94a3c4";
	div.style.padding = "2px";
	div.innerHTML = "<img src='http://t2.gstatic.com/images?q=tbn:ANd9GcQfTmxR1ix3EpGZJrJ2W6dzcIkGuujtYWDtVsRT1EoEWUMARoY1' width='16' height='14' align='absmiddle' />&nbsp;&nbsp;<a onclick='OtomatisUnlikeComments();'>Hapus Semua Like Komentar...</a>"
...
if(body != null) {
	...
	div.style.border = "1px dashed #94a3c4";
	div.style.padding = "2px";
	div.innerHTML = "&#8226;&nbsp;<a onclick='OtomatisKonfirm();' >Konfirmasi Semua Permintaan Pertemanan...</a>&nbsp; &#8226;&nbsp;<a onclick='OtomatisAbaikan();' >Abaikan Semua Permintaan Pertemanan...</a>"
...
if(body != null) {
	...
	div.style.padding = "2px";
	div.innerHTML = "<a style=\"font-weight:bold;color:#333333\" href=\"/Narendra666\">My Facebook Profile...*</a>"
