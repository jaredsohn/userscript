...
// @description    Исправленый скрипт от JOESIMMONS'a.
...
/////////////////////////////////
// MADE BY JOESIMMONS исправлено Ruki-Salat
//
...
var a = $g("//a[contains(@href, 'view.php?ad') or contains(@href, 'cks.php?k') or contains(@href, 'cashads.php?') or contains(@href, 'click.php?ad') or contains(@href, 'surfing.php?') or contains(@id, 'cks') or contains(@href, 'javascript:void')]",{type:7}),
s = $g("//strike"),
...
case "07bux.net":case "mifriend.com":surf_page_url="ads.php";break;
...
document.body.appendChild(create("span", {textContent:(35+Math.round(Math.random()*5)),id:"sec",style:("background:url(\"http://i015.radikal.ru/1101/5b/0dc3866677e2.jpg\"); color:#ddd; border:4px ridge #000; padding:3em; position:absolute; top:"+window.innerHeight/3+"px; left:"+window.innerWidth/2+"px; text-align:center;")}));
