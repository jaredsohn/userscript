...
// @name	Trooptool Updater GR (grx)
// @description	Update your troop tool with one click from the rally point. (Ready for speed.travian.gr)
...
var sLang = "gr";
var sGetParameters = "";
var sCurrentServer = "speed.travian.gr";    // Set this to the server's url to override automatic server detection
                            // (i.e. s1.travian.net)
                            // Dont set it if you're playing on multiple servers simultaneously!
							//Allready set for speed.travian.gr
...
switch(sLang) {
	case "sk":
        ...
        case "ua":
                ...
                break;
	case "gr":
                aLangStrings = ["Δικά μου στρατεύματα", "Επιστροφή από", "Ενίσχυση για", "τα στρατεύματα του",  "Επίθεση εναντίον", "Εισβολή αρπαγής εναντίον", "Ανίχνευση του", "Εισβολή εγκαταλειμμένης όασης", "Φυλακισμένα στρατεύματα από", "Η ανανέωση πέτυχε με αβέβαιο αποτέλεσμα!", "Τα στρατεύματα σας έχουν ανανεωθεί.", "Η ανανέωση απέτυχε!", "Εγκατάσταση του Troop Tool Updater", "Ανανέωσε το Troop Tool", "Troop tool Updater:", "Εισάγετε το κλειδί αυθεντικοποιήσης απο το 'My profile' του Troop tool σας"];
		break;
	case "en":
	case "com":
	case "uk":
	default:
		aLangStrings = ["Own troops", "Return from", "Reinforcements for", "Reinforcements from", "Attack", "Raid", "Spy", "Preskúmať opustené údolie", "Captured at", "Update attempted with unknown result.", "Your troops were successfully updated.", "Update failed!", "Troop Tool Updater setup", "Update Troop Tool", "Troop tool Updater:", "Enter the authentication key from your Troop tool profile"];
		break;
}
