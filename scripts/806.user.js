...
// @description     Transform textareas using JS Textile
// @include         http://*
// @include         https://*
// ==/UserScript==
...
(function() {
    ...
    function init() {
        ...
        for (i = 0; i < textareas.length; i++) {
            ...
            button = document.createElementNS("http://www.w3.org/1999/xhtml", "input");
            button.setAttribute("type", "button");
            button.setAttribute("value", "Textile it!");
            button.setAttribute("id", '__button_' + id);
            button.onclick = doTextile;

            textareas[i].parentNode.insertBefore(button, textareas[i].nextSibling);
        }
    }
    ...
    function doTextile() {
        ...
        textarea.value = textile(textarea.value);
    }
