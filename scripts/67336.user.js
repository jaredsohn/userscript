// ==UserScript==
// @name           Doomlord Highscores
// @namespace      titan
// @include        http://*.doomlord.net/index.php?m=toplistak*
// ==/UserScript==
...
GM_JQ3.src = 'http://jqueryjs.googlecode.com/svn-history/r6185/trunk/plugins/selectboxes/jquery.selectboxes.js';
...
function letsJQuery() {
    ...
    $(document).ready(function(){
    	...
    	$('#negativlediff_select').addOption('nincs','No Filtering');
    	$('#negativlediff_select').addOption('eltuntet','Hide');
    	$('#negativlediff_select').addOption('kiemel','HighLight');
