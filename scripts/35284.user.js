// ==UserScript==
// @name           imp space
// @description    conjunto de Scripts reunidos y Adaptados por r0a9f0a2
...
unsafeWindow.displayshout = function() {
	...
	if(displayedflag == 0) {
		...
		document.getElementById("shoutframe").innerHTML = '<iframe width="208" border="0" frameborder="0" height="100%" src="http://ikariams11.esforos.com" style="margin-left:0px;"></iframe>';
...
+ ' <li><h2>Menú Space</h2>'
+ '   <ul>'
+ '     <li><center><a target="" href="http://s11.ikariam.es/index.php?view=embassy&id=9624&position=8" title="Imperio">Embajada</a></li>'
+ '     <li><center><a target="" href="http://s11.ikariam.es/index.php?view=sendAllyMessage&oldView=embassy&id=9624&position=8&type=50" title="Enviar un mensaje a todos los miembros de la alianza">Mensaje Circular</a></li>'
+ '     <li><center><a target="_blank" href="http://ikariams11.esforos.com" title=" Foro de Los Veteranos X ">Foro imperio space</a></li>'
