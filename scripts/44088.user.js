...
var northEndZoneImage = "http://img213.imageshack.us/img213/7779/northr.jpg";
var southEndZoneImage = "http://img178.imageshack.us/img178/2153/south1.jpg";
// 480x91 including outline
var enableLowerDecalLayer = true;
var northEndZoneImage = "http://img98.imageshack.us/img98/5074/sifag2.jpg";
var southEndZoneImage = "http://img98.imageshack.us/img98/5074/sifag2.jpg";



// x & y size MUST be set to the size of your image
var enableMiddleDecalLayer = true;
var middleDecalImage = "http://i41.tinypic.com/2yl4bvn.gif";
var middleDecalImageX = 250; //set to the x-axis length of your image if not using xml
var middleDecalImageY = 220; //set to the y-axis length of your image if not using xml
...
//if (p != null) console.log("mine: "+id+"("+x+","+y+","+z+","+p+")");
	...
	if (playerDiv[id] == null) {
		...
		if (id != "ball") {
			...
			div.className = 'player_icon';
			div.id = id;
            var color1; var color2; var border;
            if (hometeam == ptid[id]) {
                color1 = unsafeWindow.home_color1;
                color2 = unsafeWindow.home_color2;
                border = unsafeWindow.home_border;
            }
            else {
                color1 = unsafeWindow.away_color1;
                color2 = unsafeWindow.away_color2;
                border = unsafeWindow.away_border;
            }
    		var border_text = border ? '_border' : '';

    		div.style.backgroundImage = "url(/images/dots/" + color1 + ".gif)";
    		div.innerHTML = '<img src="/images/dots/' + color2 + border_text + '/' + unsafeWindow.players[id].position + '.gif" style="width: 100%; height: 100%">';
	...
	if (id == "ball") {
		...
		if (showFallenPlayers == true) {
			if ((p == null) || (currentFrame == 0)) {
			    if (playerDiv[id].firstChild.style.display == "none") {
                    playerDiv[id].firstChild.style.display = "block";
			    }
			}
			else {
				playerDiv[id].firstChild.style.display = "none";
			}
		}
	}
}
...
\n\
    ...
    <team id="181">\n\
        <field></field>\n\
        <line></line>\n\
        <north>http://img98.imageshack.us/img98/5074/sifag2.jpg</north>\n\
        <south>http://img98.imageshack.us/img98/5074/sifag2.jpg</south>\n\
        <middle xsize="140" ysize="125">http://i40.tinypic.com/iy2bmh.gif</middle>\n\
...
<team id="5754">\n\
        <field></field>\n\
        <line></line>\n\
        <north>http://i41.tinypic.com/296iubr.jpg</north>\n\
        <south>http://i41.tinypic.com/2lxeeqg.jpg</south>\n\
        <middle xsize="190" ysize="180">http://i42.tinypic.com/8zeiid.gif</middle>\n\
        <upper>http://img510.imageshack.us/img510/1931/eastshadowhs0.png</upper>\n\
    </team>\n\
<team id="7113">\n\
        <field></field>\n\
        <line></line>\n\
        <north>http://i43.tinypic.com/2rmo21s.jpg</north>\n\
        <south>http://i42.tinypic.com/2m8037r.jpg</south>\n\
        <middle xsize="185" ysize="130">http://i41.tinypic.com/30x9c2r.gif</middle>\n\
        <upper>http://img510.imageshack.us/img510/1931/eastshadowhs0.png</upper>\n\
    </team>\n\
<team id="3304">\n\
        <field></field>\n\
        <line></line>\n\
        <north>http://i43.tinypic.com/23hsjzo.jpg</north>\n\
        <south>http://i43.tinypic.com/23vjk1f.jpg</south>\n\
        <middle xsize="180" ysize="185">http://i41.tinypic.com/sgo8x4.gif</middle>\n\
        <upper>http://img510.imageshack.us/img510/1931/eastshadowhs0.png</upper>\n\
    </team>\n\
</root>\n\
';