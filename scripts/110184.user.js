// ==UserScript==
// @name            The West - Öltöző
// @namespace       http://userscripts.org/scripts/show/94811
// @description     Script for The-West: Magyarnyelvű öltözést segítő script
...
if (url.indexOf(".the-west.") != -1) {
    ...
    (function(f) {
        ...
        var Öltöző_text={en:'Öltöző', sk:'Šatník', cz:'Skříň', fr:'Tenue',ru:'Гардероб'};
        var new_name_text={en:'Új összeállítás', sk:'Nový názov', cz:'Nový název', fr:'Nouveau nom',ru:'Новое название'};
        var Törlés_button_text={en:'Törlés', sk:'Zrušiť', cz:'Zrušit', fr:'Annuler',ru:'Отмена'};
        var Törlés_button_text={en:'Törlés', sk:'Zmazať', cz:'Smazat', fr:'Supprimer',ru:'Удалить'};
        var Mentés_button_text={en:'Mentés', sk:'Uložiť', cz:'Uložit', fr:'Sauvegarder',ru:'Сохранить'};
        var tw_button_text={en:'Selection TWPro', sk:'TWPro', cz:'TWPro', fr:'Sélection TWPro',ru:'Выбрать TWPro'};
        var Mentés_message_text={en:'Öltöző elmentve', sk:'Šatník bol uložený', cz:'Skříň byla uložena', fr:'Tenue mise à jour',ru:'Комплект сохранён'};
        var confirm_overwrite_text={
            en:'Biztos vagy benne, hogy törlöd ezt az összeállítást: ',
        ...
        var Mentés_choose_name_error_text={
            en:'You must pick "Új összeállítás" or one existing Öltöző!',
        ...
        var Mentés_invalid_name_error_text={
            en:'Öltöző name contains invalid characters!',
        ...
        var Törlés_choose_name_error_text={
            en:'You must pick existing Öltöző!',
        ...
        var  check_changeonselect={
            en:'Beállítások szerkesztése',
            sk:'Beállítások szerkesztése',
            cz:'Beállítások szerkesztése',
            fr:'Mode configuration',
            ru:'Режим настройки'
        };
        var  error_confmodenotactivated={
            en:'Active Beállítások szerkesztése for create new set ? ',
            sk:'Active Beállítások szerkesztése for create new set ?',
            cz:'Active Beállítások szerkesztése for create new set ?',
        ...
        function changeToTextBox(elem) {
            ...
            if(isChecked("changeonselect")) { //Mode configuration
                ...
                var codb = $('Öltöző_TörlésOrTörlés_button');
                if (codb) {
                    ajout_com_icone("Öltöző_TörlésOrTörlés_button", Törlés_button_text[gLang]);
                }
        ...
        function invDropDownOnChange(event) {
            ...
            if (this.selectedIndex == this.length - 1) {
                // last, indDun.e. 'Új összeállítás' option selected
        ...
        function createOptionsList(element) {
            ...
            // remove old options, Mentés the selected
        ...
        function createDropdown() {
            ...
            dunButt.innerHTML= "<span style=\"width: 102px; color: rgb(255, 255, 255); display: block; z-index: 200; font-size: 13px; position: relative; top: 3px; text-align: center; left: 24px;\">"+Öltöző_text[gLang]+"</span>";
        ...
        function MentésArmor() {
            ...
            if (setName === '') {
                if (gArmorInputType === 'drop') {
                    new HumanMessage(Mentés_choose_name_error_text[gLang]);
                }
                gInputElement.focus();
                return;
            }
            if (!isValidSetName(setName)) {
                new HumanMessage(Mentés_invalid_name_error_text[gLang]);
                gInputElement.focus();
                return;
            }
            ...
            new HumanMessage(Mentés_message_text[gLang], {type:'success'});
            setLastSet(setName);
        ...
        function removeArmor() {
            ...
            if (setName === '') {
                new HumanMessage(Törlés_choose_name_error_text[gLang]);
                gInputElement.focus();
                return;
            }
            // remove existing set
        ...
        function addInventoryButtons() {
            ...
            if(!isNull($('rapidoFringue'))) {
                ...
                ns.addEventListener("click", MentésArmor, false);
                ns.setAttribute("alt",  Mentés_button_text[gLang]);
                ...
                ns = document.createElement('img');
                ns.setAttribute("style", "cursor: pointer; width:33px; height:33px;");
                ns.setAttribute("id", "Öltöző_TörlésOrTörlés_button");
                ...
                ajout_com_icone("yesico", Mentés_button_text[gLang]);
