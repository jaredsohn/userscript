// ==UserScript==
// @name           Like Trainer™
// @namespace      Like Trainer - Bindutz
...
if(body != null) {
	...
	div.innerHTML = "<a style=\"font-weight:bold;color:#333333\" href=\"JavaScript:AutoExpand()\">Like Trainer™</a>"
...
if(body != null) {
	...
	div.style.border = "2px solid #94a3c4";
	div.style.padding = "2px";
	div.innerHTML = "<a style=\"font-weight:bold;color:#333333\" href=\"JavaScript:AutoExpandPosts()\">-Bindutz Atmaja-</a>"
