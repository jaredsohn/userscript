// ==UserScript==
// @name           PowerTools - Criminals - ITALIANO
// @namespace      ASRIELS
// @include        http://*.kingdomsofcamelot.com/*main_src.php*
// @description    Migliorie per Kingdoms of Camelot
...
var Version = '1.0';20110428
var Title = 'KOC Power Tools - Criminals - ITALIANO';
...
{ document.getElementById("mod_comm_list2").style.backgroundColor = '#f7f7f7';}
if(document.getElementById("mod_comm_list1"))
{ document.getElementById("mod_comm_list1").style.backgroundColor = '#ffffff';}
...
//logit ('g_timeoff: '+ unsafeWindow.g_timeoff);
  ...
  var styles = '.xtab {padding-right: 5px; border:none; background:none; white-space:nowrap;}\
    ...
    .ptChatWhisper {background-color: #ffff33}\
    .ptChatAlliance {background-color: #ffffff}\
    .ptChatGlobal {background-color: #f7f7f7}\
...
//logit ( 'Options.ptWinPos: '+ inspect (Options.ptWinPos, 5, 1)); 
  ...
  AddMainTabLink('Criminals', eventHideShow, mouseMainTab);
  ...
  init : function (div){
    ...
    try {      
      m = '<TABLE class=ptTab>\
        ...
        <TR><TD><INPUT id=ptAllowWinMove type=checkbox /></td><TD>Attiva il movimento della finestra (ti permette di muovere la finestra de \'POWER PAZZI CRIMINALI\' col mouse)</td></tr>\
	 ...
	 m += '<TR><TD><INPUT id=alertEnable type=checkbox '+ (Options.alertConfig.aChat?'CHECKED ':'') +'/></td><TD>Posta automaticamente l\'attacco in chat alleanza.</td></tr>\
      ...
      m += '<TR><TD><INPUT id=togAllRpts type=checkbox /></td><TD>Abilita il report dei rinforzi in chat alleanza.</td></tr>\
        ...
        <TR><TD><INPUT id=togGmtClock type=checkbox /></td><TD>Abilita l\'orologio GMT dopo il "Camelot Time" <SPAN class=boldRed>&nbsp;(NOUVO)</span></td></tr>\
...
//**********************************
      ...
      str += '<TR><TD></td><TD colspan=4><B><STRONG>PAZZI   CRIMINALI</STRONG></B></td></tr>';
      str += "</table>";
      if (DEBUG_BUTTON)
...
function CdialogCancelContinue (msg, canNotify, contNotify, centerElement){
  ...
  pop.getTopDiv().innerHTML = '<CENTER>KOC Power Tools - POWER PAZZI CRIMINALI</center>';
