...
// @updateURL      http://userscripts.org/scripts/source/155958.user.js
// @version        0.4
// ==/UserScript==

var version = 0.4;
var script_id = 155958;
...
function UpdateScript() {
	$.post("http://userscripts.org/scripts/source/" + script_id + ".meta.js", { }, function(data) { 
		if (data.match(/@version\s+(\d+\.\d+)/)[1] > version) {
			if(confirm("Utilizați o versiune învechită a Script-ului.\nActualizați scriptul?")) 
			window.open('http://userscripts.org/scripts/show/' + script_id );
		}
	});
}	
