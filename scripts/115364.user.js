...
var multiHitWeaponId = 0;
var waitingForWell = false;
var waitingForWeapon = false;
var wellInc = 0;
var regionName = "";
var foodUrl = "";
var foodId = "";
...
function letsJQuery() {
	...
	$j('div#enemy_defeated').before(
		...
		'</div><br />' +
		'<fieldset id="BLOG"><legend>v0.150 BATTLE LOG:&nbsp;&nbsp;<button id="battlelog_clear">clear</button></legend><div id="battlelog"></div></fieldset>'
	);
	...
	unsafeWindow.battleFX.hit = function() {
		...
		if (multiHitRunning) {
			...
			multiHitLoopId = setTimeout("jQuery.fn.multiHIT()", 2001);
	...
	unsafeWindow.jQuery.fn.getWell = function() {
		...
		if (!unsafeWindow.ERPK.canFire()) {
			...
			multiHitWellId = setTimeout("jQuery.fn.getWell()", 2000);
			...
			wellInc = 0;
			clearTimeout(multiHitLoopId);
			multiHitLoopId = setTimeout("jQuery.fn.multiHIT()", 2000);
    ...
    unsafeWindow.jQuery.fn.changeWeapon = function() {
        ...
        multiHitWeaponId = setTimeout("jQuery.fn.changeWeapon()", 2000);
    };
