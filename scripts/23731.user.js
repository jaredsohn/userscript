	...
	if (location.href.search('galaxy') != -1 ) {
		...
		for (i = 0; i < publi.length; i++) {
			...
			if ((publi[i].width == 150) && (publi[i].innerHTML.length > 100)) {
				...
				{
				p.innerHTML = 'J: <font color=\'#FF0000\' size=1> ' + iRank + '</font>';  
				}
				if(iRank > 200 && iRank < 400)
				{
				p.innerHTML = 'J: <font color=\'#FFcc00\' size=1> ' + iRank + '</font>';  
				}
                if(iRank > 400 && iRank < 600)
                {
				p.innerHTML = 'J: <font color=\'#00DAB9\' size=1> ' + iRank + '</font>';  
				}
				if(iRank > 600 && iRank < 5000)
                {
				p.innerHTML = 'J: <font color=\'#00DDff\' size=1> ' + iRank + '</font>';   
				}
