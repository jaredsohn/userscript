...
function addSmiley(){
  var d = $('comments-block');
        d.innerHTML = d.innerHTML.replace(/\s:-*\)/g, ' <img src="http://img.photobucket.com/albums/v28/nainarulz/smile.gif" id="new" /> ');
        d.innerHTML = d.innerHTML.replace(/\s;-*\)/g, ' <img src="http://img.photobucket.com/albums/v28/nainarulz/emoz/icon_wink.gif" id="new" /> ');
        d.innerHTML = d.innerHTML.replace(/\s:-*\$/g, ' <img src="http://img.photobucket.com/albums/v28/nainarulz/blush.gif" id="new" /> ');
        d.innerHTML = d.innerHTML.replace(/\s:-*\(/g, ' <img src="http://img.photobucket.com/albums/v28/nainarulz/emoz/icon_sad.gif" id="new" /> ');
        d.innerHTML = d.innerHTML.replace(/\s:-*D/g, ' <img src="http://img.photobucket.com/albums/v28/nainarulz/emoz/icon_lol.gif" id="new" /> ');
        d.innerHTML = d.innerHTML.replace(/\s:-*P/g, '<img src="", "http://wolverinex02.googlepages.com/icon_question.gif");
	buttons += emoticonButton("razz", "http://img.photobucket.com/albums/v28/nainarulz/emoz/icon_razz.gif" id="new" /> ');
}
