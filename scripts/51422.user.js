...
// @name		Travian: Resource++ v3 ط§ظ„ظ…ظˆط§ط±ط¯ ط¨ط§ظ„ط¹ط±ط¨ظٹ - طھط±ظپظٹط§ظ† 
...
function onLoad(){ // runs the differnt functions and procedures, 
	...
	switch(lang){//load only the lang you need into memory
		case '.se':
		langfile[lang]=['Behأ¶ver fأ¶r uppgradering:','أ¶verfullt om','fأ¶rbruka om','Resurs Meters','Resurs Bars', 
		' ','Tillrأ¤ckligt med rأ¥varor idag klockan ',"Tillrأ¤ckligt med rأ¥varor imorgon klockan ",  "Tillrأ¤ckligt med rأ¥varor om ",
		" dagar, kl " , " Efter max vأ¤ntan: ",  "أ–verskott: ","Vأ¤nta: ","Saknar","Klar"," Vأ¤nta: " ,"Blanserad",
		"Fأ¶rbruka أ¶verskott om: ","Uppgradera ", " resurs produktion.","Neutral balans.", "Bygg ut magasin", "Bygg ut silo"];
		break;    
		case '.uk':
...
case '.ae':
		langfile[lang]=['ط§ظ„ظ…ظ€ط·ظ„ظˆط¨ ظ„ظ„ط¥ط±طھظ€ظ‚ط§ط،','ط³ظ€ظٹظ€ظپظٹظ€ط¶ ط¨ط¹ط¯', 'ظٹظ€ط³طھظ€ظ†ظ€ظپظ€ط°','ظ…ظ‚ظٹظ€ظ€ط§ط³ ط§ظ„ظ…ظ€ظ€ظˆط§ط±ط¯','ظ…ظ€ظ‚ظٹظ€ط§ط³ ط§ظ„ظ…ظ€ظˆط§ط±ط¯ ط¨ط§ظ„ظ†ظ€ظگط³ظ€ط¨', 
		' ط³ظ€ظ€ط§ط¹ط©' ,'طھظƒطھظ€ظ€ظ…ط§ظ„ ط§ظ„ظ…ظ€ظˆط§ط±ط¯ ط§ظ„ظٹظ€ظ€ظˆظ… ظپظٹ ',"ط³ظ€طھظ€ظƒطھظ€ظ€ظ…ط§ظ„ ط§ظ„ظ…ظ€ظˆط§ط±ط¯ ط؛ظ€ط¯ط§ظ‹ ظپظٹ ", "ط§ظƒطھظ€ظ…ط§ظ„ ط§ظ„ظ…ظ€ظˆط§ط±ط¯ ظپظٹ ", 
		" ط£ظٹظ€ط§ظ… ظپظٹ " , " ط¨ظ€ط¹ط¯ ط§ظ‚طµظ‰ ظ…ظ€ط¯ط© : " , "ط§ظ„ظ…ط®ظ€ط²ظˆظ† : ","ظ…ظ€ط¯ط© ط§ظ„ط¥ظ†ظ€طھظ€ط¸ط§ط± ","ظ„ط¯ظٹظ€ظƒ ط¹ظ€ط¬ظ€ط² ط¨ظ€ظ…ظ‚ظ€ط¯ط§ط± " ,"ط§ظ„ظ€ط¨ظ€ط§ظ‚ظ€ظٹ ط¨ط¹ط¯ ط§ظ„ط¥ط±طھظ€ظ‚ظ€ط§ط،"," ط£ظ‚طµظ€ظ‰ ظ…ظ€ط¯ط© ","ظ„ظ† ظٹظ€ط¨ظ€ظ‚ظ‰ ظپظٹ ط§ظ„ظ…ط®ظ€ط²ظ† ط´ظ€ظٹظ€ط¦",
		"طھظ€ظ‚ظ€ظ„ظ€طµ ط§ظ„ظ€ظپط§ط¦ظ€ط¶ : ","ط¥ط±طھظ€ظ‚ط§ط، "," ط¥ظ†ظ€طھظ€ط§ط¬ ط§ظ„ظ…ظ€ظ€ظˆط§ط±ط¯" ," ظ…ط­ط§ظٹط¯ ", "طھظ€ظˆط³ظ€ظٹظ€ط¹ ظ…ظ€ط®ط§ط²ظ† ط§ظ„ط³ظ„ظ€ط¹" , "طھظ€ظˆط³ظ€ظٹظ€ط¹ ظ…ظ€ط®ط§ط²ظ† ط§ظ„ط­ط¨ظ€ظˆط¨"];		
		break;
		...
		break;
		case '.hu':
		langfile[lang]=[ 'Fejlesztأ©shez kell:', 'betelik', 'betelt', 'Nyersanyagok' , 'Nyersanyagok',
		' أ³rakor' ,'Elأ©g nyersanyag ma ',"Elأ©g nyersanyag holnap ", "Elأ©g nyersanyag ",
		" nap mأ؛lva " , " Max vأ،rakozأ،s utأ،n: " , "Kأ©szleten: ","Vأ،rj: ","Hiأ،ny" ,"Tأ¶bblet"," Max vأ،rakozأ،s: ","Kiegyensأ؛lyozott",
		"A tأ¶bblet elfogy: ","Fejlesztأ©s "," nyersanyag termelأ©s.","Semleges egyensأ؛ly.", "Fejlesztd hozzأ، a raktأ،rat!" , "Fejlesztd hozzأ، a magtأ،rat!"    ];
		break;
		case '.de':
		langfile[lang]=['Fأ¼r Ausbau benoetigt:','أœberschuأں', 'Erschأ¶pft','Resourcenmeter','Resourcenbalken', 
		' Uhr','Genug Resourcen heute um ',"Genug Resourcen morgen um  ", "Genug Resourcen in ", 
		" Tagen um ", " Nach maximaler Wartezeit: " , "Vorrat: ","Wartezeit: ","Defizit","أœberschuأں", " Maximale Wartezeit: ","Ausgeglichen",   
		"أœberschuأں aufgebraucht in: ","Ausbau "," Resourcenproduktion.","Neutrale Bilanz." , "Rohstofflager erweitern" , "Kornspeicher erweitern" ];
		break
		case '.sk':
		langfile[lang]=['Stavba vyإ¾aduje:','preteؤچie', 'vyؤچerpanأ©','Meraؤچ surovأ­n','Ukazatele zأ،sob', 
		' hod','Dostatok surovأ­n dnes o ',"Dostatok surovأ­n zajtra o ", "Dostatok surovأ­n za ", 
		" dnأ­ o ", " Po max. ؤچakanأ­: " , "Sklad: ","ؤŒakacia doba: ","Chأ½ba nأ،m","Prebytok", " Max. doba ؤچakania: ","Vyvأ،إ¾enأ©",
		"Prebytok vyؤچerpanأ½ za: ","Vylepإ،i "," produkciu surovأ­n.","Vyvأ،إ¾enosإ¥." , "Rozإ،أ­r sklad" , "Rozإ،أ­r sأ½pku"];		
		break;
		case '.cz':
		langfile[lang]=['Stavba vyإ¾aduje:','pإ™eteؤچe', 'vyؤچerpأ،no','Meriؤچ surovin','Ukazatele zأ،sob',
		' hod','Dostatek surovin dnes v ',"Dostatek surovin zأ­tra v ", "Dostatek surovin za ",
		" dny v ", " Po max. vyؤچkأ،vanأ­: " , "Sklad: ","ؤŒekacأ­ doba: ","Chybأ­ nأ،m","Pإ™ebytek", " Max. vyؤچkأ،vanأ­: ","Vyvأ،إ¾enأ©",
		"Pإ™ebytek vyؤچerpanأ½ za: ","Vylepإ،i "," produkci surovأ­n.","Vyvأ،إ¾enost."
		, "Vylepإ،i sklad" , "Vylepإ،i sأ½pku"];
		break;
		case '.bg':
       langfile[lang]=['ذ‌رƒذ¶ذ½ذ¸ ذ·ذ° upgrade:','ذ·ذ°ذ؟رٹذ»ذ²ذ°ذ½ذµ', 'ذ¸ذ·ر‡ذµر€ذ؟ذ²ذ°ذ½ذµ','Resource Meters','ذ“ر€ذ°ر„ذ¸ذ؛ذ¸ ذ½ذ° ر€ذµرپرƒر€رپذ¸ر‚ذµ',
       ' ر‡ذ°رپذ°','ذ”ذ¾رپر‚ذ°ر‚رٹر‡ذ½ذ¾ ر€ذµرپرƒر€رپذ¸ ذ´ذ½ذµرپ ذ² ',"ذ”ذ¾رپر‚ذ°ر‚رٹر‡ذ½ذ¾ ر€ذµرپرƒر€رپذ¸ رƒر‚ر€ذµ ذ²", "ذ”ذ¾رپر‚ذ°ر‚رٹر‡ذ½ذ¾ ر€ذµرپرƒر€رپذ¸ ذ² ", " ذ´ذ½ذ¸ ذ² ", " ذ،ذ»ذµذ´ ذ¼ذ°ذ؛رپذ¸ذ¼ذ°ذ»ذ½ذ¾ ذ¸ذ·ذ°ذ؛ذ²ذ°ذ½ذµ: " , 
	   "ذ،ذ؛ذ»ذ°ذ´: ","ذ’ر€ذµذ¼ذµ ذ·ذ°ذ¸ذ·ر‡ذ°ذ؛ذ²ذ°ذ½ذµ: ","ذ‌ذµذ´ذ¾رپر‚ذ¸ذ³","ذکذ·ذ»ذ¸رˆرٹذ؛", " ذœذ°ذ؛رپذ¸ذ¼ذ°ذ»ذ½ذ¾ ذ¸ذ·ر‡ذ°ذ؛ذ²ذ°ذ½ذµ: ","ذ‘ذ°ذ»ذ°ذ½رپذ¸ر€ذ°ذ½ذ¾", "ذکذ·ر‡ذµر€ذ؟ذ²ذ°ذ½ذµ ذ½ذ° ذ¸ذ·ذ»ذ¸رˆرٹذ؛ذ° رپذ»ذµذ´: ","Upgrade ",
	   " ذ”ذ¾ذ±ذ¸ذ² ذ½ذ°ر€ذµرپرƒر€رپذ¸.","Neutral balance." , "ذ ذ°ذ·رˆذ¸ر€ذµر‚ذµ رپذ؛ذ»ذ°ذ´ذ°" , "ذ ذ°ذ·رˆذ¸ر€ذµر‚ذµ ر…ذ°ذ¼ذ±ذ°ر€ذ°"];
       break;
		default:
		langfile[lang]=['Needed for upgrading:','Overflow', 'Depleted','Resource Meters','Resource Bars', 
		' Clock' ,'Enough resources today at ',"Enough resources tomorrow at ", "Enough resources in ", 
