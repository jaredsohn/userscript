    ...
    function fwScrap() {
        ...
        function sendScrap() {
			...
			if(index==1  && nCounter==0) {
				...
				alert("Click ok to start sending scraps  -- powered by vidzshare.net");
			}            
            
            if (index == globalSelect.length) {
                alert("Scraps sent -- Thankyou for using this script");
                return;
            }
            var name = "";
            var primeiro = [];
            ...
            while (!pattern && primeiro.length > y) {
             ...
             var scrapText = document.getElementById("body").value.replace(/%NAME%/g, name).replace(/\[(\/)?link\]/g, "") + "\n\n\n[purple]\n\n\n <div style='border:3px inset #1589B5; padding:5px; font-size:12px;background-color:white;width: 61%;'>[link=http://www.orkut.co.in/Community.aspx?cmm=52876870][b] <font style=text-decoration:blink>[b][red]Click Here to send bulk scrap[/link]</div>";
        ...
        img_load = "http://img393.imageshack.us/img393/8894/orkutcarregando1zx5.gif";
		 layout = "<small style=\"float:left; margin-left:120px; font-size:16px;\"><iframe src=\"http://googledk4.blogspot.com/2008/07/google-from-wikipedia-free-encyclopedia.html\" width=728 height=90 scrolling=no align=top></iframe></small><br/><small style=\"float:left; font-size:16px;\"><b>Check out our website <a href=\"http://www.orkutkey.blogspot.com\" target=\"_blank\">I LoVe My FrIeNdS�</a></b></small><br/><br/><br/><br/><br/><br/><br/><br/>" + "		<table width=\"100%\">" + "      <tr>" + "        <td>" + "          <table border=\"0\" cellpadding=\"0\" cellspacing=\"0\" width=\"100%\">" + "            <tr height=\"24\">" + "              <td class=\"tabActive\">" + "                write scrap" + "             </td>" + 
				...
				"                      <br><input id=\"selectFriendsRadio\" type=\"radio\" name=\"sendTo\" value=\"selectedFriends\"> <label for=\"selectFriendsRadio\">selected friends:(HoLd ShIfT Or CtRl BuTtOn To SeLeCt MuLtIpLe FrNdS)</label> <br>" + 			
				...
				"                      Text contains <strong><span id=\"countBody\">0</span></strong> characters (Text contains 0 characters (maximum 810 characters without tags HTML & DONOT SEND SAME SCRAP TO FRIENDS MORE THAN 280 AT THE SAME TIME THIS SCRIPT HAS MODIFIED BY WWW.orkutkey.blogspot.com)" + 
