...
// @homepage      http://userscripts.org/scripts/show/168212
// @updateURL     https://userscripts.org/scripts/source/168212.meta.js
// @downloadURL   https://userscripts.org/scripts/source/168212.user.js
...
'    if (_core.contextPlayer._currentTrack.advertisement == true){\n'+
'        _core.contextPlayer._currentContext._context._rule.seek = true;\n'+
'        _core.contextPlayer.seek(_core.contextPlayer._currentTrack.duration);\n'+
...
'    if(typeof _core.contextPlayer !== "undefined"){\n'+
'        _core.contextPlayer.addEvent("ended", skippub);\n'+
'    }\n'+
'    else{\n'+
