// ==UserScript==
// Modified version only for RS by MikeHunt, created by hosts
// @name           Rapidshare Check
// @description    RS links checker
...
const urlRegex = /\b(?:|http\:\/\/www\.anonym\.to\/\?)(?:h\w\wp|http|hxxp|h  p|h\*\*p)((?:\:\/\/rapidshare\.com\/files\/[\d]*\/.*?\..*?[^"\s\<\>]*[^.,;'">\:\s\<\>\)\]\!]))/ig;
