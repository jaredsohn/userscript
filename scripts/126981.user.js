// ==UserScript==
// @name           DLeague Challenge Season 27
// @namespace      GLB_Chris465
// @description    Collect the stats for the DLeague Challenge, Season 27, LB.
...
var playerList = [3052632,3200948,4249295,3646987,3765010,3789893,3798111,3918220,4000162,2996511,4070655,4101489,3759476,4245393,3395050,4246225,4247059,4245026,3270006,4249339,4248467,4248577,3113765,4243723,4250618,4250466];
...
var agents = [];
agents["Henry Weinhard"]="1hottie";
agents["VOOM DED"]="Ahrens858";
agents["Dleague LB"]="AlBarsch";
agents["D-league player"]="an_old_dude";
agents["Edgardo Torres"]="AWolf02";
agents["Ig Is a Racist Bastard v. 3.0"]="Barlol";
agents["Jaxon DLeague BB LB"]="blitzboy";
agents["Dyrus Miller"]="cheesepillow";
agents["+ Houston We Have A Probl"]="Chivas";
agents["Javon Xoom"]="Chris465 DTD";
agents["DLeague Woodley"]="Chrome";
agents["Ervin Sadler"]="Dave Mr Majors";
agents["DLeague LB Champ"]="dlawilliams";
agents["+Jaxon Voom+"]="Dr Brawler";
agents["ig's D-League LB"]="ig";
agents["D-League LB King of Voomdom"]="Jaxon Voom";
agents["lol2ndJay's LB > lolVo"]="Jay Gold";
agents["Isuck Atthis"]="Jayadamo";
agents["Line    Backer"]="lexden11";
agents["Dominick Oliver"]="NYJets52";
agents["Boss D-League LB"]="o The Boss x";
agents["OH FU@KPuddles"]="Robbnva";
agents["Crappy D League Dot"]="Sabataged";
agents["Voomy Loves Chachi"]="vladykins";
agents["Beau Beau"]="wil75";
agents["Jackson Voomy"]="ZoSo1";
...
//console.log("Getting data...");
	...
	for each (playerNumber in playerList){
		...
		var page = "http://goallineblitz.com/game/player_game_log.pl?player_id="+ playerNumber + "&season=27&stat_type=raw";
...
function createDelimitedOutputWithPoints() {
	...
	for each (var player in players) {
		...
		output += agents[player.name]+delim+totalPoints.toString() +delim;
