// ==UserScript==
// @name           Omerta Donator Banner
// @author         Kredu
// @namespace      rankscript.net
// @description    Get a Donator Banner on Omerta
...
<td nowrap="nowrap" align="left" class="name"><a href="./bullets2.php" target="main"><b>B</b>ullets (buy):</a></td>\n\
\n\
<td nowrap="nowrap" align="right" id="bullet" width="40"> </td>\n\
<td nowrap="nowrap" align="left" class="name"><b>R</b>ace form:</td>\n\
...
function bannerUpdate(mid) {
  ...
  for (var i in DB.timers) mid.document.getElementById(i).innerHTML = DB.timers[i] <= 0 ? 'Now' : DB.timers[i] + 'S';
