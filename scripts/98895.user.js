// ==UserScript==
// @name           Oto insaat
// @namespace      Oto insaat
// @homepage       http://userscripts.org/scripts/show/98895
// @description    Kingdoms of Camelot Toolkit including Attack Informer and Build Helper and WideMap-Feature
// @version        13032011 Insaat 02
// @include       *kingdomsofcamelot*
// @require       http://ajax.googleapis.com/ajax/libs/jquery/1.3.2/jquery.min.js 
// @require       http://sizzlemctwizzle.com/updater.php?id=90005
// ==/UserScript==
...
function DD_POC_GUI(){
    ...
    window.GUI.clearstorage = function(){
        if (confirm("Kayitlar silinicektir emin misin?")) {
            tk_data = "";
            window.tk_data = new DD_POC_DATA();
            handler.saveObject(tk_data); 
            alert("Kayitlar silindi");
			
            if (confirm("Yeniden baslatmaniz gerekmektedir")) {
        ...
        for (i = 0; i <= storageLength; i++) {
           ...
           // storageContent += 'LOCALSTORAGE:<br><br>' + data + '<br>' + Saldiri + '<br>' + BT + '<br>' + next1 + '<br>' + next2 + '<br>' + next3 + '<br>' + next4;
        }
    ...
    window.GUI.build = function(){
        ...
        if (data == null) {
            alert('Ilk kullanim icin hazirlaniyor');
            window.tk_data = new DD_POC_DATA();
            
            var s = tk_data.states = new Object();
            
            //default values
            s.ScriptVersion = 'Flooger-13032011 Insaat 02';
            s.details = false;
            s.tabselected = 'log';
            s.mode = 0;
        ...
        if (typeof tk_data.states.ScriptVersion == 'undefined' || typeof tk_data.states.details == 'undefined' || typeof tk_data.states.tabselected == 'undefined' || typeof tk_data.states.mode == 'undefined' || typeof tk_data.states.pocbuildaction == 'undefined' || typeof tk_data.states.isnotrunning == 'undefined' || typeof tk_data.states.ispaused == 'undefined' || typeof tk_data.states.alerterOn == 'undefined' || typeof tk_data.states.ask4help == 'undefined' || typeof tk_data.options.widemap == 'undefined' || typeof tk_data.options.onattack == 'undefined' || typeof tk_data.options.minattack == 'undefined' || typeof tk_data.options.onscouts == 'undefined' || typeof tk_data.options.minscouts == 'undefined' || typeof tk_data.options.usechat == 'undefined' || typeof tk_data.options.chatchannel == 'undefined') {
            ...
            //default values
            s.ScriptVersion = '11122010 Build 01';
            s.details = false;
            s.tabselected = 'log';
            s.mode = 0;
            s.pocbuildaction = false;
        ...
        GUI.poclog.add("<b>Flooger versiyonu: 13032011 Insaat 02</b><br><br>");
        /*
        ...
        GUI.poclog.add('>>> Ilk kullanim icin hazirlaniyor......');
        GUI.poclog.add('If not just reset a second time until the message appears.');
        */
        
        GUI.logattack.add('Saldirilar kontrol ediliyor');
...
function DD_POC_FUNCTIONS(){
    ...
    window.GUI.poccontrols['refresh'] = function(){
        if (confirm("Degisiklerin kayit olasi icin Oto insaat sayfayi yenileyecek")) {
            location.reload(true);
        }
    }
    ...
    window.GUI.options.display = function(a){
        ...
        y.push('<td width="100%">');
        y.push('<b>Genis Harita</b>');
        y.push('</td><td><td>')
        if (GUI.widemap == false) {
            y.push('<a class="gem_button" id="widemap" onclick="GUI.togglewidemap();"><span>Kapali</span></a>');
        }
        else {
            y.push('<a class="button20" id="widemap" onclick="GUI.togglewidemap();"><span>Acik</span></a>');
        }
        y.push('</td></tr>');
        
        y.push('<tr><td>');
        y.push('<b>>>> Saldiri bilgilendirme ayarlari<<<</b>');
        y.push('</td></tr>');
        /*
         y.push('</tr>');
         ...
         */
        y.push('<td width="100%">');
        y.push('<b>Saldiri su mesafedeyken uyar ...</b>');
        if (GUI.onattack == false) {
            y.push('</td><td><input id="minattack" type="text" size="7" maxlength="7" value=' + GUI.minattack + '></td><td>');
            y.push('<a class="gem_button" id="alertOnAttack" onclick="GUI.toggleonattack();"><span>Kapali</span></a>');
        }
        else {
            y.push('</td><td><input id="minattack" type="text" size="7" maxlength="7" disabled="disabled" value=' + GUI.minattack + '></td><td>');
            y.push('<a class="button20" id="alertOnAttack" onclick="GUI.toggleonattack();"><span>Acik</span></a>');
        }
        y.push('</td></tr>');
    ...
    window.GUI.pocgui.getdisplay['build'] = function(){
        ...
        if (a.length > 0) {
            ...
            ret.push('<div align="center"> <b> Insaat yok</b></div>');
        }
        return ret.join('');
    }
    ...
    window.GUI.pocgui.getdisplay['log'] = function(){
        ...
        if (tk_data.log.length > 0) {
            ...
            ret.push('<div align="center"> <b>Kayit yok</b></div>');
        }
        return ret.join('');
    };
    //ATTACK
    window.GUI.pocgui.getdisplay['attack'] = function(){
        ...
        if (tk_data.attack.length > 0) {
            ...
            ret.push('<div align="center"> <b>Saldiri yok</b></div>');
        }
        return ret.join('');
    };
    //SCOUT
    window.GUI.pocgui.getdisplay['scout'] = function(){
        ...
        if (tk_data.scout.length > 0) {
            ...
            ret.push('<div align="center"> <b>Bt yok</b></div>');
        }
        return ret.join('');
    };
    //FAKE
	...
	*/
    ...
    window.GUI.settogglenames = function(){
        if (document.getElementById('timer_control')) {
            if (GUI.ispaused) {
                $('timer_control').innerHTML = 'Oto Insaat = Kapali';
            }
            else {
                $('timer_control').innerHTML = 'Oto Insaat = Acik';
            }
        }
        
        if (document.getElementById('txt_stopalert')) {
            if (GUI.alerterOn) {
                $('txt_stopalert').innerHTML = 'Alarm = Acik';
            }
            else {
                $('txt_stopalert').innerHTML = 'Alarm = Kapali';
            }
        }
        
        if (document.getElementById('txt_ask4help')) {
            if (GUI.ask4help) {
                $('txt_ask4help').innerHTML = 'Yardim = Acik';
            }
            else {
                $('txt_ask4help').innerHTML = 'Yardim = Kapali';
            }
        }
    };
    ...
    window.GUI.togglewidemap = function(){
        ...
        if (GUI.widemap) {
            ...
            handler.saveObject(tk_data);
            document.getElementById('refresh_text').innerHTML = "Buraya tikla sayfayi yenile degisiklerin kayit olsun";
            GUI.pocupdatedisplay();
        }
        else {
    ...
    window.GUI.togglebuildmode = function(){
	   ...
	   if (GUI.currentBuildMode == 'build') {
            $('txt_buildmode').innerHTML = 'Insaat Modu ';
            window.buildslot = GUI.pocbuild.add;
			GUI.nextBuildMode = "destruct";
        }
        if (GUI.currentBuildMode == 'destruct') {
            $('txt_buildmode').innerHTML = 'Yok etme Modu';
            window.buildslot = GUI.pocbuild.add;
			GUI.nextBuildMode = "off";
        }
		if (GUI.currentBuildMode == 'off') {
		   $('txt_buildmode').innerHTML = 'Insaat Modu = Kapali';
...
function DD_POC_VARIABLES(){
    ...
    window.pochtmls.controls['scout'] = '<a id="con_clearscout" class="gem_button" onclick="GUI.pocgui.control.onclick(this)"><span>Temizle</span></a> \
										<a id="con_stopalert" class="gem_button" style="margin-left: 8px;" onclick="GUI.poctogglealerter()"> \
										<span id="txt_stopalert"></span> \
										 </a>';
    window.pochtmls.controls['fake'] = '<a id="con_clearfake" class="gem_button" onclick="GUI.pocgui.control.onclick(this)"><span>Temizle</span></a>';
    window.pochtmls.controls['log'] = '<a id="con_clearlog" class="gem_button" onclick="GUI.pocgui.control.onclick(this)"><span>Temizle</span></a>';
    window.pochtmls.controls['options'] = '<a id="con_refresh" class="gem_button" onclick="GUI.pocgui.control.onclick(this)"><span id="refresh_text">Sayfa yenilemeye gerek yok</span></a>';
    ...
    var part3 = '<a class="gem_button" onclick="GUI.togglebuildmode()"><span style="text-align: center" id="txt_buildmode">Insaat Modu = Kapali</span></a>';
    
	if (GUI.ask4help) {
        var part4 = '<a class="gem_button" onclick="GUI.toggleask4help()"><span style="text-align: center" id="txt_ask4help">Yardim = Acik</span></a>';
    }
    else {
        var part4 = '<a class="gem_button" onclick="GUI.toggleask4help()"><span style="text-align: center" id="txt_ask4help">Yardim = Kapali</span></a>';
    }
    var part5 = '<a id="con_sortBT" class="gem_button" onclick="GUI.pocgui.control.onclick(this)"> \
					<span>Süreye göre</span> \
				</a> \
				<a id="con_sortBC" class="gem_button" onclick="GUI.pocgui.control.onclick(this)"> \
					<span>Sehre göre</span> \
				</a> \
    ...
    window.pochtmls.mainbody = '<table class="tabs_engagement" id="pochmain" style="position:fixed; top:0px; left:740px;" cellspacing="0" border="0" width="450"> \
								...
								<td style="background-color:#CCAA55; border-bottom:0px; width: 450px;" > \
									<div style="margin-left:0px;" widht="450" id="koc_menu"> \
										<a id="flag_attack" class="tab" onclick="GUI.pocgui.tabs.onlick(this)"><span id="s_attack">Saldiri</span></a> \
										<a id="flag_scout" class="tab" onclick="GUI.pocgui.tabs.onlick(this)"><span id="s_scout">BT</span></a> \
										<a id="flag_fake" class="tab" onclick="GUI.pocgui.tabs.onlick(this)"><span id="s_fake">Fake</span></a> \
										<a id="flag_build" class="tab" onclick="GUI.pocgui.tabs.onlick(this)"><span id="s_build">Insaat</span></a> \
										<a id="flag_options" class="tab" onclick="GUI.pocgui.tabs.onlick(this)"><span id="s_options">Ayarlar</span></a> \
										<a id="flag_log" class="tab" onclick="GUI.pocgui.tabs.onlick(this)"><span id="s_log">Bilgi</span></a> \
									</div> \
								</td> \
								...
								<td style="background-color:#FFF; border: 1px solid #A56631;" colspan="2">Foksiyonlar:  \
								...
								<td height="36px" style="border: 1px solid #A56631;" colspan="3" id="koc_bottom"> \
									<div style=" position:relative; margin-left:0px"> \
										<a class="button20" style="margin-left: 8px;" onclick="eval(prompt());"> \
											<span style="text-align: center" id="evaluate">Hata Ayikla</span> \
										</a> \
										<a class="button20" style="margin-left: 8px;" onclick="GUI.clearstorage();"> \
											<span style="text-align: center" id="clear">Yerel Kayitlri Sil</span> \
										</a> \
										<a class="button20" style="margin-left: 8px;" onclick="GUI.showLocalStorage();"> \
											<span style="text-align: center" id="clear">Yerel Kayitlari goster</span> \
										</a> \
									</div> \
								</td> \
								</tr> \
...
function DD_KOC_FUNCTIONS(){
    ...
    window.KOC.checkImpendingAttack = function(){
        ...
        Object.keys(seed.queue_atkinc).length > 0) {
            ...
            document.getElementById('s_attack').innerHTML = "Saldiri";
            document.getElementById('s_scout').innerHTML = "BT";
            document.getElementById('s_fake').innerHTML = "Fake";
            GUI.logattack.add('Saldiri yok');
            GUI.logscout.add('BT saldirisi yok');
            GUI.logfake.add('Fake Saldiri yok');
