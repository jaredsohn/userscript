// ==UserScript==
// @name        Unfriend In Single-Click on Facebook by Momo
// @description This script is useful if you don't want to delete each friends one by one.
// @namespace   Momo Stranger
// @include      *.facebook.com/*
// @require       http://ajax.googleapis.com/ajax/libs/jquery/1.7/jquery.js
// @version     3.6.1
// ==/UserScript==
// Developed by Momo Stranger - http://www.facebook.com/InuyashaPhc


function replace_msg(x) {
    $('div.dialog_body').html('Whuuuhuu! ' + x + ' friends has been deleted. Join us at <a target="_blank" href="http://www.facebook.com/LanunTarbus.my">Momo Stranger</a> for more useful tips/tricks and more!');
