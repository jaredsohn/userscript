...
function insertBox(divTarget)
{
	...
	divLink.innerHTML = '<b>RS Links</b>';
...
{
	linksHTML = '<br>';
	regRS = new RegExp(/href="http\:\/\/rapidshare.com\/files\/[0-9]{6,12}\/[A-Za-z-.0-9_]{1,120}(.rar|.avi.html|.0[0-9]{2})"/g);
	...
	if (linksHTML == '<br>') linksHTML += '<br><br><br><br><center>No RS Links Found</center>';
