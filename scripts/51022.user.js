// ==UserScript==
// @name          Black Nose -> Brown NOse
// @namespace     http://www.flowsion.net
// @description	Version 1.0: Filters Black Nose to Brown Nose. Based off Profanity Script..
// @include         *
// ==/UserScript==

/*

  Author: Flowsion: Thanks to MCE.
...
(function() {
	...
	var ReplacementText = "brown nose";
	
	//edit the words here
	//sorted alpha backwords to catch bad word groupings
	var badwords=['black nose'];
