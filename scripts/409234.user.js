...
<th><img src="/graphic/unit/unit_snob.png" onclick=\'$(".snoba").val(prompt("أدخل عدد النبلاء","1"));troops();\' title="نبيل"></th>');
                ...
                $(overview_villages).find("tr").find("td:first").after('<td><input type="text" style="width:40px" tabindex="6" value="0" class="axea" onchange="troops()"></td>\
...
<td><input type="text" style="width:40px" tabindex="6" value="1" class="rama" onchange="troops()"></td>\
<td><input type="text" style="width:40px" tabindex="6" value="0" class="snoba" onchange="troops()"></td>');
...
<td><input type="text" style="width:40px" tabindex="6" value="0" class="axeb"></td>\
<td><input type="text" style="width:40px" tabindex="6" value="0" class="spyb"></td>\
<td><input type="text" style="width:40px" tabindex="6" value="0" class="lightb"></td>\
<td><input type="text" style="width:40px" tabindex="6" value="1" class="ramb"></td>\
<td><input type="text" style="width:40px" tabindex="6" value="0" class="snobb"></td>\
</tr></tbody></table>');
