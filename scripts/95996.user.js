...
function ImageReplacement() {
	...
	for (i = 0; i < element.length; i++) {
		...
		while(postHTML.indexOf("[/video]") != -1)
		{
			...
			strUrlReduxv = strUrlReduxv.substring(0, endIndexv-9);
		...
		//Changes Smiley for Fu
		while(postHTML.indexOf("[fu]") != -1)
		{
			postHTML= postHTML.replace("[fu]", "<img src = \"http://img28.imageshack.us/img28/5143/fu1.gif\">");
			element[i].innerHTML = postHTML;
		}
