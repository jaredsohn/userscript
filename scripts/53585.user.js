...
// @description    Basicamente exibe algumas informações de forma amigável e tem o recurso 
...
var autoPlayMinStamina = 30;

// Nivel maximo e mínimo do risco para começar a ajudar ou roubar as pessoas
var autoPlayUpRiskLimit = 100;
var autoPlayDownRiskLimit = 90;
...
// Url do café
var autoPlayCoffee = "drink-cafe/2";
...
autoPlayUpRiskOrder[0] = "taxi.rob";
autoPlayUpRiskOrder[1] = "newcar.rob";
autoPlayUpRiskOrder[2] = "manager.rob";
autoPlayUpRiskOrder[3] = "manager.steal";
autoPlayUpRiskOrder[4] = "newcar.steal";
autoPlayUpRiskOrder[5] = "phone.steal";
autoPlayUpRiskOrder[6] = "punk.rob";

// Lista de URL para baixar o risco (ajudar)
var autoPlayDownRiskOrder = new Array();

autoPlayDownRiskOrder[0] = "kid.school";
autoPlayDownRiskOrder[1] = "mother.help";
autoPlayDownRiskOrder[2] = "drunk.soberize";
autoPlayDownRiskOrder[3] = "shaft.move";
autoPlayDownRiskOrder[4] = "garbage.clean";
autoPlayDownRiskOrder[0] = "mother.help";
autoPlayDownRiskOrder[1] = "drunk.soberize";
autoPlayDownRiskOrder[2] = "shaft.move";
autoPlayDownRiskOrder[3] = "garbage.clean";
autoPlayDownRiskOrder[4] = "postman.rob";
autoPlayDownRiskOrder[5] = "postman.cheat";
autoPlayDownRiskOrder[6] = "postman.help";
autoPlayDownRiskOrder[7] = "shaft.move";
autoPlayDownRiskOrder[8] = "dog.help";
autoPlayDownRiskOrder[9] = "drugdealer.police";
autoPlayDownRiskOrder[10] = "soccerboy.play";
autoPlayDownRiskOrder[11] = "lazyboy.pillow";
autoPlayDownRiskOrder[12] = "drunk.cash";
autoPlayDownRiskOrder[13] = "kid.school";
...
function autoPlayOn()
{
   if( autoPlay )
   {
	 ...
	 {	
	     ...
	     oLog.innerHTML = "AutoPlay ON (Acabou DownRisk!)<br>Mudando para " + 

autoPlayMapOrder[autoPlayMapOrderIdx];
             autoPlayActiveLink = getMapDirectionLink();
      	 }
      }
      ...
      else if( autoPlayDirection == "upRisk" )
      {
      	 ...
      	 {
      	    // Senão, exibe mensagem e muda de mapa
            oLog.innerHTML = "AutoPlay ON (Acabou UpRisk!)<br>Mudando para " + 
