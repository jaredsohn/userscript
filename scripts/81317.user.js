// ==UserScript==
// @name            Simple Troop Watch
// @namespace       se.tapirboy.travian
// @description     Shows ackumulated attack/defense of your offensive/defensive troops and total crop consumption.
// @include         http://*.travian.*/dorf1*
// @require         http://sizzlemctwizzle.com/updater.php?id=81317
// @author          Tapirboy
...
(function troopwatch() {
    ...
    // Teutons
    unit[11] = new Array(OFF,false,40,20,5,1,7); // club
    unit[12] = new Array(DEF,false,10,35,60,1,7); // spear
    unit[13] = new Array(OFF,false,60,30,30,1,6); // axe
    unit[14] = new Array(NONE,false,0,10,5,1,9); // scout
    unit[15] = new Array(DEF,true,55,100,40,2,10); // paladin
    unit[16] = new Array(OFF,true,150,50,75,3,9); // knight
    unit[17] = new Array(NONE,false,65,30,80,3,4); // ram
    unit[18] = new Array(NONE,false,50,60,10,6,3); // cata
    unit[19] = new Array(NONE,false,40,60,40,5,4); // chief
    unit[20] = new Array(NONE,false,0,80,80,1,5); // settler
    // Gaul
    ...
    // Other (don't change)
    unit[31] = new Array(DEF,false,0,25,20,1,0); // the rat
