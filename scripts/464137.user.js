...
//m += '  <option value="helm">Helm</option>';
            m += '</select></span></div></td>';
...
var itemTypes = {"weapon": 1, "chest": 2, "shield": 5, "helm": 17};
...
Tabs.organizer = {
        ...
        myDiv : null,
        itemLists : [],
        //itemTypes : { weapon: 0, shield: 1, armor: 2, helm:17 /*, banner: 3, advisor: 4, trophy: 5, candelabrum: 6, hero: 7*/ },
