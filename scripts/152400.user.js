...
(function () {
  ...
  var DOWNLOAD_LINK_MESSAGES={'ar':'تنزيل','de':'Herunterladen','en':'Download','es':'Descargar','fr':'Télécharger','it':'Scarica','pt':'Baixar','ro':'Descărcați','ru':'Скачать'};
  var DOWNLOAD_TOOLTIP_MESSAGES={'ar':'تنزيل هذا الفيديو','de':'Dieses Video herunterladen','en':'Download this video','es':'Descargar este vídeo','fr':'Télécharger cette vidéo','it':'Scarica questo video','pt':'Baixar este vídeo','ro':'Descărcați acest videoclip','ru':'Скачать это видео'};
  var DOWNLOAD_LINK_MESSAGE='Download';
  var DOWNLOAD_TOOLTIP_MESSAGE='BY ZABKAS';
...
function run() {
  ...
  if (videoId==null || videoTicket==null) { // HTML5
    ...
    if (typeof(unsafeWindow)!='undefined' && unsafeWindow===window) { // built-in Chrome
      ...
      usw=divElem.onclick(); // hack from https://github.com/greasemonkey/greasemonkey/issues/1614
    } 
