	...
	if (slickvars["Dramalinks"]==1 && page=="/showtopics.php")
	{
		...
		GM_xmlhttpRequest({
			...
			onload: function(responseDetails) {
				...
				t=t.replace(/\[(.+?)\]/g,"<a href=\"$1\" style=\"padding-left: 0px\"><img src=\"http://img294.imageshack.us/img294/3749/external2.png\"></a>");
				...
				{
					case "kermit":
					document.getElementById("dramalinks_ticker").style.border="0px solid #990099";
					bgcol="black";
					kermit=true;
					case "black":
					case "blue":
				...
				if (!kermit)
				{
				dramas="<span style='text-transform:capitalize'><font color='" + bgcol + "'>" + "</span>" + dramas.slice(2).replace(/\*/g,"&nbsp;&nbsp;&nbsp;&nbsp;")+"</div>";
				}
				else
				{
