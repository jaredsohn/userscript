...
// @namespace     http://tannock.net with edits by VSB SysAdmin
// @description	  v1.5 Search the VSB WEBCAT Libraries from Amazon book listings.  
// @include       http://*.amazon.*
// ==/UserScript==
...
(function(){
//	GM_log('Amazon Library Linky for VSB');	
 
	var libraryIsbnUrlPattern = 'http://webcat.vsb.bc.ca/ipac20/ipac.jsp?index=ISBNEX&term='
	var libraryTitleUrlPattern = 'http://webcat.vsb.bc.ca/ipac20/ipac.jsp?index=.TW&term='
	var libraryName = 'VSB Libraries';
