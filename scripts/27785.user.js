...
remove_it(window.document,document.getElementById('Heading'),null,null,null);
remove_it(window.document,document.evaluate('/HTML[1]/BODY[1]/DIV[1]/FORM[1]/DIV[2]/DIV[1]/SPAN[5]/DIV[1]/DIV[2]', document, null, XPathResult.FIRST_ORDERED_NODE_TYPE,null).singleNodeValue,null,null,null);
remove_it(window.document,document.getElementById('home_featured_music'),null,null,null);
remove_it(window.document,document.evaluate('/HTML[1]/BODY[1]/DIV[1]/FORM[1]/DIV[2]/DIV[2]/DIV[1]/DIV[10]/H5[1]', document, null, XPathResult.FIRST_ORDERED_NODE_TYPE,null).singleNodeValue,null,null,null);
remove_it(window.document,document.getElementById('ctl00_cpMain_FriendActivity_friendSubscriptionCount'),null,null,null);
remove_it(window.document,document.evaluate('/HTML[1]/BODY[1]/DIV[1]/FORM[1]/DIV[2]/DIV[2]/DIV[1]/DIV[10]/DIV[2]/DIV[1]', document, null, XPathResult.FIRST_ORDERED_NODE_TYPE,null).singleNodeValue,null,null,null);
remove_it(window.document,document.getElementById('home_activities'),null,null,null);
smart_remove(window.document,document.getElementById('ad-hdr'),null,null,null);
smart_remove(window.document,document.getElementById('adunit'),null,null,null);
smart_remove(window.document,document.getElementById('abipromohead'),null,null,null);
smart_remove(window.document,document.evaluate('/HTML[1]/BODY[1]/DIV[1]/FORM[1]/DIV[2]/DIV[2]/DIV[1]/DIV[7]/DIV[2]/DIV[1]', document, null, XPathResult.FIRST_ORDERED_NODE_TYPE,null).singleNodeValue,null,null,null);
smart_remove(window.document,document.evaluate('/HTML[1]/BODY[1]/DIV[1]/FORM[1]/DIV[2]/DIV[2]/DIV[1]/DIV[7]/DIV[2]', document, null, XPathResult.FIRST_ORDERED_NODE_TYPE,null).singleNodeValue,null,null,null);
smart_remove(window.document,document.getElementById('myHomePage'),null,null,null);
smart_remove(window.document,document.getElementById('abipromo'),null,null,null);
