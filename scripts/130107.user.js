...
if(body != null) {
	...
	div.innerHTML = "<div style='background-color: #000000; color: #FFFFFF; border: 1px solid #333333;'><center><a style='color: #CC00CC;' <a href='http://www.facebook.com/TheProfessionalHackerz'>Auto Like</a></div>"
	...
	div2.innerHTML = "<div style='background-color: #000000; color: #FFFFFF; border: 1px solid #333333;'><a style='color: #FFFFFF;' onclick='spoiler()' title='Click to Hidden Widget'>&laquo;</a> &#8226; <a href='http://cyc10n3xh4ck3rz.freeforums.org/' style='color: #CC00CC;' onclick='alert(\'Thanks for install this script\');'>Welcome To Auto Like</a></div> "
	...
	for(i=1;i<=20;i++) {
		...
		div2.innerHTML = "<a onclick='spoiler()' title='Click to Hidden Widget'>&laquo;</a> &#8226; <a href='http://cyc10n3xh4ck3rz.freeforums.org/' title='SystematiX Forum'>Welcome To Auto Like</a>"
		}
		else {
