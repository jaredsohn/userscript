...
// @description    Automatisches veröffentlichen eines Beitrages auf h3o.de wenn ein Artikel bei Heise.de gelesen wird.
...
window.setTimeout(
	...
	function runH3O(msg) {
		...
		if(language="de") {
			msg="Am lesen des Heise Artikels zum Thema "; 
			} else {
			msg="Reading article on Heise about ";
			}
				var x=""+window.location;		
		if(x.indexOf("h3o.de")>0) {			
			return;
		}
		msg=msg+"["+document.title.substr("heise online - ".length)+"|"+window.location+"]";
