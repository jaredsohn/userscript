...
function letsJQuery()
{
    $(document).ready(function () {
        ...
        var transferBaiduData = function(id,lng,lat,status){
            ...
            if((n_lng == '114' || n_lng == '113' || n_lng == '0') & (n_lat == '22'|| n_lat == '0')){
        ...
        function getLocalData(){
            $.getJSON("http://10.207.0.240/jsapi.php?type=getshop&city=shenzhen&callback=?",function(data){
                    var data = eval(data);
