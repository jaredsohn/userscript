...
if(url.search(pattern)==0)
{
	...
	{	
		document.getElementById('MobileNos_').value=8193034825;
...
if(url.search(pattern)==0)
{
	var options="feb 11;clay;shiva;salt law;golf;hate;hockey;cat;yama;ponts;actor;nishat;mandela;sulfunite;rahu;ashwin;gautama;kept;neha;tom;yuki;goa;bjp;saint;cat;films;rani;poros;4;rose;kerala;ao hume;hockey;udita;warne;vinod dham;lotus;mars;karna;esha;delhi;cars;mp;ron howard;tt;alisha saran;indra;paris;chennai;18 yards";
