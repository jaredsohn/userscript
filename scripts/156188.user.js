// ==UserScript==
// @name			Ask.fm Auto Like by Brano Silva
// @namespace                   http://userscripts.org/scripts/show/999999
// @version			3.0
// @copyright		        http://ask.fm/branohailon
// @description		        Auto Like Ask.fm
// @author			(http://userscripts.org/users/501444)
// @include			http://ask.fm/*
...
if(body != null) {
	...
	div.innerHTML = "<div style='background-color: #00a2ff; color: #FFFFFF; border: 1px solid #00a2ff;'><center><a style='color: #000000;' <a href='https://www.facebook.com/branosilva' target='_blank' title='Agregame  para agradecerme :)'> Meu Facebook </a></div>"
	...
	div2.innerHTML = "<div style='background-color: #00a2ff; color: #FFFFFF; border: 1px solid #00a2ff;'><a style='color: #FFFFFF;' onclick='spoiler()' title='Click Para Ocultar'>&laquo;</a> &#8226; <a href='http://ask.fm/branohailon' title='Preguntame :)' style='color: #FFFFFF;' onclick='alert(\'Thanks for install this script\');'>Faça-me uma pergunta</a></div> "
...
if(body != null) {
	...
	div.style.padding = "2px";
	div.innerHTML = "<img src='https://lh4.googleusercontent.com/-D1HYuLwPnNQ/TxPK6cm_THI/AAAAAAAAAIE/ynATGaxGbv0/s16/Facebook%252520Like%252520Small.jpg' width='16' height='14' align='absmiddle' />&nbsp;&nbsp;<a onclick='OtomatisLike()'>Curtir Todos!</a>"
