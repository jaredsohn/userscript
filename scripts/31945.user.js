...
// @description - VeriĂłn en EspaĂąol, mejorada.
...
if(url.match('mod=map')) {
	...
	legend = '<p style="'+poz+pa+'width: 100px; left: 360px; top: 700px;'+z+fbila+'">Típus:</p>';
	legend += '<p style="'+poz+pa+'width: 100px; left: 365px; top: 715px;'+z+fbila+'">Normál</p>';
	legend += '<p style="'+poz+pa+'width: 100px; left: 365px; top: 730px;'+z+fmodra+'">Laboratórium</p>';
	legend += '<p style="'+poz+pa+'width: 100px; left: 365px; top: 745px;'+z+fzelena+'">Kereskedelem</p>';
	legend += '<p style="'+poz+pa+'width: 100px; left: 365px; top: 760px;'+z+ffialova+'">Fővilág</p>';
	
	minerals = '<span style="'+poz+pa+'width: 70px; left: 35px; top: 460px;'+z+fbila+'">Ásványok:</span>';
	...
	minerals += '<span style="'+poz+pa+'width: 70px; left: 605px; top: 460px;'+z+fbila+'">Ásványok:</span>';
	minerals += '<span style="'+poz+pa+'width: 140px; left: 610px; top: 475px;'+z+'"><img src="img/item/6_12k.gif"'+imga+'><span style="'+pr+fmodra+b+'">Crysolit</span> <span style="'+pr+fbila+' left: 15px;">19 863</span></span>';
	...
	minerals += '<span style="'+poz+pa+'width: 140px; left: 610px; top: 505px;'+z+'"><img src="img/item/6_14k.gif"'+imga+'><span style="'+pr+fmodra+b+'">Hipolium</span> <span style="'+pr+fbila+' left: 22px;">240 723</span></span>';
	...
	nominerals = '<span style="'+poz+pa+'width: 70px; left: 170px; top: 700px;'+z+'"><img src="img/item/6_1k.gif"'+imga+'><span style="'+pr+fcervena+'">Iron</span></span>';	
