// ==UserScript==
// @name          1337's Quick Reply PM
// @namespace     1337/quickreply
// @description   Provides a quick reply textbox for users while reading the PM
// @include       http://free-leaks.com/private.php?action=read*
// @include       http://www.free-leaks.com/private.php?action=read*
// @version 	  1.1
// ==/UserScript==
...
for (var i=0; i < span.length; i++) {
	...
	if( theHTML.indexOf('<a href="http://www.free-leaks.com/member.php?action=profile&amp;uid=') != -1 ) {
