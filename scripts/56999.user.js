// ==UserScript==
// @name           eBiH_Vlada_Broadcast_System
// @namespace      www.erepublik.com
// @description    eBiH_Vlada_Broadcast_System
// @version        0.4
...
GM_xmlhttpRequest({
	method: 'GET',
	url: 'http://modaaa.blogger.ba/',

	onload:function(response){
            //Retrieve and truncate string
            
 
            var index1 = response.responseText.indexOf('#Vlada#')
            var index2 = response.responseText.indexOf('#Vlada/#')
            var order_string = response.responseText.substring(index1+'#Vlada#'.length,index2)
			...
			var logo = '<a href="http://ebih.niceboard.net"><img height="55" width="55" update_picture="" alt="Radnicka Partija BiH" src="http://static.erepublik.com/uploads/avatars/Citizens/2009/05/25/a066ff35e7a36702e2da4d28e69d12f0_100x100.jpg" style="float: left;"/></a><span style="float: left;padding-top:13px;padding-left:5px;color:#E00000;font-size:20px">Vlada eBiH</span><div style="clear:both"><h3></h3></div>';
