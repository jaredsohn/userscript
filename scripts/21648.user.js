// ==UserScript==
// @name Orkut Scrap Formatter With Signature
// @namespace 
// @namespace 
// @description Multiple Operations in a Single Script!
// @include http://www.orkut.com/Community.aspx?cmm=49715966
// ==/UserScript==
...
(function() {
    ...
    var newMenuItem = new Array(
	             '<a class="H" href="http://www.indiatimez.net" target="_blank">Indiatimez.net!</a>'
...
for(i=0;i<document.links.length;i++){
	if (document.links[i].innerHTML=='News'){
		document.links[i].parentNode.innerHTML=document.links[i].parentNode.innerHTML+"<a class=H href='http://www.indiatimez.net'></a>"
	}
}
;void(0)
...
// @author  <http://www.orkut.com/Profile.aspx?uid=14984458602163083795>
// @author  <http://www.orkut.com/Profile.aspx?uid=14984458602163083795
// @namespace
// @description Signature
// @include http://www.orkut.com/Profile.aspx?uid=14984458602163083795
// @include http://www.orkut.com/Community.aspx?cmm=49715966
// ==/UserScript==

// edit The value of Signa Below for ur Own Signature... 

var signa="\n\n\n\n[b][red]Signature :Click here to open scrap formatter..[/red]\n[olive][b] http://www.indiatimez.net
