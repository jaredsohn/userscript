// ==UserScript==
// @name Quicklinks 4 AE
// @namespace Quicklinks 4 AE
// @description v1
...
unsafeWindow.qbbuildinterior = function()
{
	...
	qbHTML += '<div id="qhead"><center><a style="color: #EB1204;" >Torins Bookmarks v'+version+'</a></center></div>';
	...
	if(unsafeWindow.places != "0")
	{
		...
		for(i = 0; i < splitplaces.length-1; i++){
			...
			if(i>0){
			qbHTML += '<a title="Move Quickmark Up" href="javascript:qbmoveup(\'' + placepiece[0] + '|' + placepiece[1] + ';\');"><img   src="http://s2.largeimagehost.com/HL/esrtcXc/tiny_arrow_up.gif" height="10" width="10" border="0"></a>';
			}
			else {
			...
			qbHTML += '<a title="Move Quickmark Down" href="javascript:qbmovedown(\'' + placepiece[0] + '|' + placepiece[1] + ';\');"><img   src="http://s2.largeimagehost.com/HL/esrtcXs/tiny_arrow_down.gif" height="10" width="10" border="0"></a>';
			}
			else {
			qbHTML += '<img src="http://s2.largeimagehost.com/HL/esrtcch/41px-Transparent_square.svg.png" height="10" width="10"   border="0">';
			}
			qbHTML += '<a title="Delete Quickmark" href="javascript:qbdeleteentry(\'' + placepiece[0] + '|' + placepiece[1] + ';\');"><img   src="http://s2.largeimagehost.com/HL/eshFXXr/x_red_transparent.gif" height="10" width="10" border="0"></a>';
			qbHTML += ' <a title="Rename Quickmark" href="javascript:qbrenameentry(\'' + placepiece[0] + '|' + placepiece[1] + ';\');"><img   src="http://s2.largeimagehost.com/HL/eshFXXt/Pencil_24.gif" height="10" width="10" border="0"></a><font color="EB1204"> - </font></td>';
	...
	{
	qbHTML += '<div style="border-bottom:1px #98AFC7 solid; width:376px; height:315px; overflow-y:auto; overflow-x:hidden;"><table style="width:375px;   border: none;"><tr><td align="center">No places saved</td></tr></table></div>';
	}

	qbHTML += '<a href="javascript:qbaddentry();">Quickmark current page</a><br><br>';
	qbHTML += '<a href="javascript:qbexport();" title="Export list"><img src="http://s2.largeimagehost.com/HL/eshFXrU/export.gif" height="20" width="20"   border="0"></a>';
	qbHTML += '<a href="javascript:qbimport();" title="Import list (Append)"><img src="http://s2.largeimagehost.com/HL/eshFXcc/import.gif" height="20"   width="20" border="0"></a>';
	qbHTML += '<a href="javascript:qbdeleteall();" title="Delete all Quickmarks"><img src="http://s2.largeimagehost.com/HL/eshFXXr/x_red_transparent.gif"   height="20" width="20" border="0"></a>';
        qbHTML += '</div>';
...
GM_addStyle("#quickbar { width:410px; position:fixed; left:-412px; height:420px; top:145px; z-index: 500;   background:url(http://s2.largeimagehost.com/HL/eshFXhh/stars2.jpg); background-repeat:repeat; border:1px gray solid;}");
...
GM_addStyle("#quicktab { z-index:496; background:url(http://s2.largeimagehost.com/HL/eshFXrt/tab.gif); width:26px; height:100px; position:absolute; right:-26px;   top:0px; } ");
