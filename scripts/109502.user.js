...
// Mods by Andy:
// - Smaller banking message
// - Battlefield Reload test faster for heal or attack again at "no data"
//    Unexpected city, taveling to... new 1s
//    Error healing. Try again in 2s
//    Some error in server response, try again in 1s
//    No fight result, continue in 1s
// - Atlantic City Link fixed (open in a new tab)
...
var scriptAppInfo = 
{
    ...
    appVer: '0.4.4.6',
	appVera: '0.4.4.6_3 Andys Mod',
	appUrla: 'http://userscripts.org/scripts/show/104383',
...
function modMenu()
{
    ...
    var menuOptions = [
        ...
        {name:'Go Atlantic City!',        'click': toAtlanticCity,       'main': true               },
		{name:'Mobsters Paradise!',       'click': MobstersParadise,                                       }
    ];
...
function MobstersParadise() {
unsafeWindow.open('http://www.facebook.com/groups/141471162577265/');
}
...
function Battlefieldv2() 
{
    ...
    var Regex = {
        ...
        icedCount: function(text) {
			//return Util.doRgx(/description..(\d+)/, text).$1 || 0;
    ...
    function genMainDom() {
        ...
        */
        ...
        popupElt.applyOptions({
            ...
            'bfopt_autopublishafter': {1:'1', 3:'3', 5:'5', 10:'10', 15:'15', 20:'20'},
    ...
    function travelTo(toCity, callback) {
        ...
        MW.travel(toCity, function(city) {
            if ((CurrentCity = parseInt(city)) === parseInt(toCity)) {
                ...
                statusTimer.start('Unexpected city, taveling to '+ global.cities[toCity] + ' in %N% seconds.', 1, tryAgain);
            }
        });
    }
    /**
            ...
            httpAjaxRequest({'url':url, 'success': function(jsonData) {
                try {
                    ...
                    if (fightStats.health < options.get('healWhen')) {
                        statusTimer.start(jsonData.hospital_message+' try again in %N% seconds.', 2, tryAgain);
                    }
                    else {
                    ...
                    statusTimer.start('Error healing. Try again in %N% seconds.', 2, tryAgain);
                }
            }});            
        }
...
(function(){
	...
	function addVersionText() {
	    ...
	    if (canvas_iframe !== null) {
			...
			'<a href="'+ scriptAppInfo.appUrla + '">Mod Updates</a></span>';
