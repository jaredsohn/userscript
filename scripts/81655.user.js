// ==UserScript==
// @name          Bettac LibraryLookup
// @namespace     http://ke0020.kohaexpress.com
// @description   Search the Bettac Library Catalog from Amazon book listings.
// @include       http://*.amazon.*
// @creator       Cab Vinton
...
var libraryUrlPattern = 'http://ke0020.kohaexpress.com/cgi-bin/koha/opac-search.pl?q=';
var libraryName = 'Bettac Library';
...
function setLibraryHTML(isbn, title, linktext, color) {
   ...
   if (link2catalog == false)
      {
         libraryUrlPattern = "mailto:tech_svcs@bettaclibrary.info?subject=Request for ISBN " ;
      }
