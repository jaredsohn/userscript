// ==UserScript==
// @name           Orkut Manager by Orkut king
// @namespace      System
 ...
 * @changes by Orkut King
 * @profile uid=8814590408891780741
 */
...
var htmlQuoteB = "<div style='background: #806D7E; border: 3px LightSkyBlue solid; color: white; font-size: 90%; margin-left: 20px; margin-right: 20px; padding: 2px 3px 2px 3px'>";
var htmlQuoteE = "</div>";
...
var signature = "";
var htmlSignature = "";
//var htmlSignature = newLineFixer + "<sub><a href='/Community.aspx?cmm=32833898'><img alt='bofiv' src='http://images.orkut.com/orkut/albums3/ATcAAADJz3wDdvyB4bSNA1l79dwgQZcejyNnWzkVY2w8IHiHJWDGVJDGUO3uAL1BBatjiyg1TQJpcvORVye9pdIu3a68AJtU9VA9oYNHsFxNsXPbdf36eO9DZKQr7A.jpg' /></a></sub>";
/* /VARS:: Signature */
...
AddBookmarkTopic("16467103", "Breath of Fire IV", "2585962906586712230", "#Logs da moderaÃ§Ã£o");
...
AddBookmarkTopic("16467103", "Breath of Fire IV", "0", "DragÃµes");
...
AddBookmarkTopic("16467103", "Breath of Fire IV", "2587438927932557478", "Yorae Dragon - ã‚¢ãƒ«ã‚«ã‚¤ã®ç«œ(Arukai no Ryuu)");
...
function ForceRedirect(Seconds, Miliseconds)
{
    ...
    setTimeout("window.location.href='/Community.aspx?cmm=32833898';", time);
}
