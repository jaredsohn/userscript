// Amazon North Shore Public Library Lookup
// Emily Clasper modified the code below UPDATED 04/30/2007
// Ryan Athanas modified the code below
// Sean LeBlanc
// Modified Josh Staiger's (excellent) code 
// to adapt to North Shore Public Library.

// TODO: Add in "other editions" search?
// TODO: General clean-up of unused code.

// Currently, this script will search for the book in the North Shore Public Library.
...
// select "Amazon - North Shore", and click Uninstall.

//
// ==UserScript==
// @name          Amazon - North Shore Lookup
// @namespace     http://sean-leblanc.blogspot.com
// @description	  While viewing a book on Amazon, this script will search for the book in the North Shore Public Library. If not found there, it will search the Suffolk County Catalog. If not found there, it will try to search Worldcat. Also, it will try to detect when viewing an item that is a CD, DVD or VHS, and insert a search link into North Shore Public Library to use on that page. Based on Josh Staiger's Wake County Library Lookup.
// @include       http://*.amazon.*
// @include       http://amazon.*
// @version 	  1.2
// ==/UserScript==
...
var dbg = false;
var jeffcoLibraryName = 'North Shore Public Library';
var shortLibName = "North Shore";
...
function libSearch(isbn, newDiv) {
	var xmlUrlJeffco = "http://alpha2.suffolk.lib.ny.us/search~S41/i" + isbn + "&searchtype=i";
...
if (!GM_xmlhttpRequest || !GM_log) {
    alert('The North Shore Public Library Lookup script requires Greasemonkey 0.5.3 or higher.  Please upgrade to the latest version of Greasemonkey.');
    return;
}
...
var cdTypeUrlAppend = "&m=j&Da=&Db=&l=&p=&a=&SORT=D&searchscope=41";
var dvdTypeUrlAppend = "&m=d&m=g&search=Search&SORT=D&searchscope=41";
var vhsTypeUrlAppend = "&m=d&m=g&search=Search&SORT=D&searchscope=41";
