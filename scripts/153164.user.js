// ==UserScript==
// @name        Facebook: Hide inactive users in chat sidebar
// @namespace   http://userscripts.org/users/115601
// @description   Hides the random selection of inactive users that Facebook for some reason thinks you want to see in the chat sidebar, and just shows the people that are actually available to chat (green dot or mobile).
...
function userScript_hideInactiveChatUsers()
{
	...
	cssCode = cssCode + "\n.fbChatOrderedList li.mobile { display:block; }";
