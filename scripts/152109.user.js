// ==UserScript==
// @name minionmyopenid
// @description  Automatically will form on myopenid.com, disable it after being done with minions. This is in development process. Numbers only for now. Just press CTRL + SHIFT + F!  To auto fill text boxes with a random number within a specified range (x through y) press CTRL + SHIFT + M. Cota and hunter are fucktards and stupid and idiots and i hate them.
// ==/UserScript==

function hunterisaRetard() {
...
waitForKeyElements ("#submit", clickTargetButton);

function iHateCota (jNode) {
