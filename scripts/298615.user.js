						...
						qx.Class.define("BaseInfo", {
							...
							members: {
								...
								initialize: function () {
									...
									// Tab 2
									this.MembersPage = new qx.ui.tabview.Page("Membres");
									...
									// Tab 3
									this.AboutPage = new qx.ui.tabview.Page("InfoScript");
								...
								showBasenwerte: function (ev) {
									...
									// Tab 1 Basenwerte
									this.BasenwerteVBox.add(new qx.ui.basic.Label("<table cellspacing='1' cellpadding='10'><tr><td><big><b><u>Information générale</u></b></big><br><b>role d'alliance:</b> " + newAusgabe["AllianzRolle"] + "<br><b>Nom de joueur:</b> " + newAusgabe["Spieler"] + "<br><b>Classe du joueur:</b> " + newAusgabe["Klasse"] + "<br><b>Heure actuelle:</b> " + newAusgabe["Uhrzeit"] + "Heure - " + newAusgabe["Datum"] + "<br><b>Rang:</b> " + newAusgabe["Rang"] + "<br><b>Maximale PC:</b> " + newAusgabe["maxKP"] + "<br><b>Temps de réparation:</b> " + newAusgabe["repZeit"] + " heures<br><b>Nombres de bases:</b> " + newAusgabe["Basen"] + "<br><b>Nombres de bases offensives:</b> " + newAusgabe["off_basen"] + "<br><b>Production de crédit:</b> " + newAusgabe["Creditproduktion"] + "<b>/h</b><br><b>production de Tibérium:</b> " + newAusgabe["Tiberiumproduktion"] + "<b>/h</b> (Sans Bonus: " + parseInt(TiberiumsProduction) + "/h)<br><b>Production de Cristal:</b> " + newAusgabe["Kristallproduktion"] + "<b>/h</b> (Sans Bonus: " + parseInt(CrystalsProduction) + "/h)<br><b>Ø défensive:</b> " + newAusgabe["def_durchschnitt"] + "<br><b>Bâtiment de soutien:</b> " + newAusgabe["support_basen"] + "<br><b>Niveau Ø des supports:</b> " + newAusgabe["support_lvl"] + "<br><b>CD Ø toutes Base:</b> " + newAusgabe["ve"] + "</td></tr></table>").set({rich: true}));
									// 1. und 2. Offensive
									this.BasenwerteVBox.add(new qx.ui.basic.Label("<table cellspacing='1' cellpadding='10'><tr><td><big><b><u>1. Base Offensive</u></b></big><br><b>Nom de base:</b> " + firstBaseName + "<br><b>Niveau de Base:</b> " + newAusgabe["1st_Base"] + "<br><b>Offensive:</b> " + newAusgabe["1st_Off"] + "<br><b>Défensive:</b> " + newAusgabe["1st_Def"] + "<br><b>Production d'énergie:</b> " + newAusgabe["1st_Stromproduktion"] + "<br><b>Rep. aérienne:</b> " + newAusgabe["1st_Flugzeuge"] + "<br><b>Rep. véhicule:</b> " + newAusgabe["1st_Fahrzeuge"] + "<br><b>Rep. infanterie:</b> " + newAusgabe["1st_Fusstruppen"] + "</td><td><big><b><u>2. Base Offensive</u></b></big><br><b>Nom de Base:</b> " + secondBaseName + "<br><b>Niveau de base:</b> " + newAusgabe["2nd_Base"] + "<br><b>Offensive:</b> " + newAusgabe["2nd_Off"] + "<br><b>Défensive:</b> " + newAusgabe["2nd_Def"] + "<br><b>Production d'électricité:</b> " + newAusgabe["2nd_Stromproduktion"] + "<br><b>Rep. aérienne:</b> " + newAusgabe["2nd_Flugzeuge"] + "<br><b>Rep. véhicule:</b> " + newAusgabe["2nd_Fahrzeuge"] + "<br><b>Rep. infanterie:</b> " + newAusgabe["2nd_Fusstruppen"] + "</td></tr></table>").set({rich: true}));
									// Werte übertragen + Worldmap Link
									this.BasenwerteVBox.add(new qx.ui.basic.Label("<table cellspacing='1' cellpadding='10'><tr><td><a href='http://ccta.php-gfx.net/baseinfo/index.php?usersubmit=" + escape(usersubmit) + "&amp;allBases=" + escape(allBases) + "' target='_blank'><button><b>&nbsp;&nbsp;Envoyer les données&nbsp;&nbsp;</b></button></a></td><td><a href='http://map.tiberium-alliances.com/map/"+worldidforWorldmap[3]+"#"+coordsforWorldmap+"|3|"+baseidforWorldmap+"|~' target='_blank'><button><b>&nbsp;&nbsp;Carte du Monde&nbsp;&nbsp;</b></button></a></td></tr></table>").set({rich: true}));
									...
									this.MembersVBox.add(new qx.ui.basic.Label("<table cellspacing='1' cellpadding='10'><tr><td><big><b><u>Liste des Membres (" + anzahl + ")</u></b></big><br><br>" + member + "</td></tr></table>").set({rich: true}));
									if(leaders.l.indexOf(PlayerID) != "-1")
										{
											this.MembersVBox.add(new qx.ui.basic.Label("<table cellspacing='1' cellpadding='10'><tr><td><span style='color: #bb0000;'><u>Visible uniquement aux CeC:</u></span></td></tr></table>").set({rich: true}));
											this.MembersVBox.add(new qx.ui.basic.Label("<table cellspacing='1' cellpadding='10'><tr><td><big><b><u>Ajustement des membres</u></b></big><br>Avec ce bouton vous pouvez écrire à tous les membres,<br>ajuster les informations des bases des anciens joueurs,<br>qui appartiennent à une autre alliance,<br>qui sont dans la liste.</td></tr></table>").set({rich: true}));
											this.MembersVBox.add(new qx.ui.basic.Label("<table cellspacing='1' cellpadding='10'><tr><td><a href='http://ccta.php-gfx.net/baseinfo/index.php?userreplace=" + escape(userreplace) + "' target='_blank'><button><b>&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;Membres abgleichen&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;</b></button></a><br><span style='color: #bb0000;'><i>Du musst auf der " + CLASS + "-Seite eingeloggt sein</i></span></td></tr></table>").set({rich: true}));
										}

									// Tab 3 ScriptInfo
									this.AboutVBox.add(new qx.ui.basic.Label("<table cellspacing='1' cellpadding='10'><tr><td><big><b><u>Information du script</u></b></big><br><b>Nom:</b> " + CLASS + "<br><b>Version:</b> " + VERSION + "<br><b>Auteur:</b> " + AUTHOR + "<br><b>Page d'accueil:</b> <a href='http://ccta.php-gfx.net/baseinfo' target='_blank'>ccta.php-gfx.net/baseinfo</a><br><br><big><b><u>Pourquoi faire ce script?</u></b></big><br>Il existe plusieurs raisons de l'utiliser. Pour un commandant voulant avoir un aperçu sur les valeurs individuelles de ses membres, d'autre part, les membres voir par eux-mêmes comment leurs valeurs évoluent.<br><br><big><b><u>Qu'est-ce que sont \"les valeurs de transfert \" \?</u></b></big><br>Avec le bouton \"valeurs de transfert» peuvent être transmis à une \"page d'accueil\" vos valeurs de base, où les CeF peuvent se connecter et être en mesure d'évaluer leur alliance. Après que les utilisateurs autorisés peuvent (ces pouvoirs doivent être transmis par ce CeF aux personnes autorisées), voir leur alliance et d'effectuer divers réglages. Les membres obtiennent un lien permanent qui apparaît avec le transfert de leurs valeurs qu'ils peuvent utiliser pour leurs propres valeurs. Vous verrez leurs 5 dernières entrées où ils peuvent évaluer eux-mêmes où ils se sont améliorées.</td></tr></table>").set({rich: true, width: 350}));
								}
							}
						});          
					}
