...
// @description    Rifornimenti (eRepublik)
// @version        0.1
...
GM_xmlhttpRequest({
	method: 'GET',
	url: 'http://dl.dropbox.com/u/77882521/form.xml',
	onload:function(response){
		...
		var earmy = $('#earmy');
		earmy.append('<div class="title"><h1 style="padding-bottom: 5px;"><embed class=\"sIFR-flash\" height=\"28\" width=\"250\" src=\"/flash/delicious.swf\" quality=\"best\" flashvars=\"txt=Rifornimenti T4L&&textcolor=#737373&hovercolor=null&linkcolor=null&w=250&h=28\" wmode=\"opaque\" bgcolor=\"null\" sifr=\"true\" type=\"application/x-shockwave-flash\" style=\"width: 250px; height: 28px;\"/><span class=\"sIFR-alternate\"> </span></h1></div>');

		earmy.append('<ul  style="float: left;" class="tabs">'
				+'<li id="Rifornimenti"><a class="on" href="#"><span style="width: 100px;">Rifornimenti</span></a></li>'
				+'<li id="irc" class="last"><a target="_BLANK" href="http://goo.gl/lDnMW"><span style="width: 100px;">IRC</span></a></li>'
				+'<li id="MU"><a target="_BLANK" href="http://www.erepublik.com/en/main/group-show/222"><span style="width: 100px;">MU </span></a></li>'
				+'</ul>');
		...
		for (i=0;i<ordenes.length;i++) {
			...
			orden += '<div style="color: #fff; background: #aaa; width: 100%;text-align: center; margin-top: 5px; border-bottom: 2px solid #aaa; float: left; clear: both;" class="pie">'+'<a style="color: white; text-decoration: underline;" href="'+ordenenlace+'">link</a> | '+fecha + ' da ' + autor + ((grupo!="")?" para "+grupo:"")+'</div></div>';
