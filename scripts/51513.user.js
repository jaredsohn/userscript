...
// @uso:script     51513
// @grant          GM_addStyle
// @history        1.1.6 finally got rid of the E4X stuff so it should work with FF17+ now
...
var GMSU_meta_51513 = usodata_51513.toString();
...
var GMSU = {
  ...
  createMCDiv: function() {
	...
	GM_addStyle('#GMSU_upd_alert input { border:1px outset #666; padding:3px 5px 5px 20px; background:no-repeat 4px center #eee; color: #000; border-radius:3px; cursor:pointer; margin-left:.5em; } #GMSU_upd_alert input:hover { background-color:#f9f9f9; }');
