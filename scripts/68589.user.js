// ==UserScript==
// @name            Canchallena.com print
// @include         http://www.canchallena.com/*-*
// ==/UserScript==

function do_platypus_script() {
fix_page_it(window.document,'/HTML[1]',null,null,null);
isolate(window.document,document.getElementById('segunda'),null,null,null);
relax(window.document,document.getElementById('segunda'),null,null,null);
isolate(window.document,document.getElementById('segunda'),null,null,null);
