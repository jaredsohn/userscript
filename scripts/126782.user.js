// ==UserScript==
// @name         Jegyzet Chrome
// @namespace    http://userscripts.org/scripts/show/126782
// @version      1.0
// @description  Kis Jegyzetek írására alkalmas a The West játékban. Google Chromera
// @author      w.vikice
...
//**************szövegdoboz**************
popup.innerHTML = popup_header + '<input type="text" name="kisjegyzet" title="Kisjegyzet :)" ><p align="center"><font color="#88fbef"><b>Jegyzet </b></font><img src=' +felkialtojel+ ' title="Jegyzetet beírása után a ki/be kapcsolás valamint az oldal frissítése (F5) esetén a jegyzet törlődik!!!"/> <img src=' +kerdojel+ ' title="Fogd meg az egérrel a jobb alsó sarkot <b>.::</b> és húzd kisebbre a szövegdobozt, hogy láthasd a Honlap gombokat a (W) alatt! - Persze csak Firefoxon ;)"/></p><p align="center"><textarea name="jegyzet" rows="7" cols="15" title="Jegyzettömb :)"></textarea></p><p align="center"><p align="center"><a href="http://www.whp.atw.hu" target="new blank"><img src=' +whp_img+ ' title="WHooP Kiadó Honlapja"/></a><a href="http://tw-db.info/" target="new blank"><img src=' +twdb+ ' title="TW-DB"/></a> <a href="http://www.west-help.tk" target="new blank"><img src=' +helptk+ ' title="West-Help"/></a> <a href="http://www.wini.lapunk.hu" target="new blank"><img src=' +wino+ ' title="Wini.lapunk"/></a> <a href="http://www.westforts.com/" target="new blank"><img src=' +forts+ ' title="West Forts"/></a> <a href="http://nyanit.com/www.the-west.hu/" target="new blank"><img src=' +nyan+ ' title="NYAN! + The West"/></a></p>';
//**************szövegdoboz_end**************
if (on_checker<1) {
