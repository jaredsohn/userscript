...
// Creazione link
links = new Array();
links[0]= new Array('Palazzo Pubblico' , 'build.php?gid=15');
links[1]= new Array('Base Militare' , 'build.php?gid=16');
links[2]= new Array('Caserma' , 'build.php?gid=19');
links[3]= new Array('Scuderia' , 'build.php?gid=20');
links[4]= new Array('Mercato' , 'build.php?gid=17');
links[5]= new Array('Beautiful Report' , ' http://travianreports.com/it');
links[6]= new Array('TravianTrucchi' , 'http://traviantrucchi.org');
