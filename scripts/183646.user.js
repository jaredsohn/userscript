		...
		request('xw_controller=stats&xw_action=view&user='+btoa('p|'+id),function(result){
			...
			if(tag&&llink) {
				$('#spartacus_hover'+nr+' > img').after(
					'<a href="http://facebook.mafiawars.zynga.com/mwfb/remote/html_server.php?xw_controller=clan&xw_action=view&xw_city=7&mwcom=1&id='+escape(btoa(fid))+'&from_red_link=1" class="mw_new_ajax" selector="#inner_page"><span style="color:red">'+tag+'</span></a> '
				);
			}
		});
	}
