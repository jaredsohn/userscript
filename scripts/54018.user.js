// ==UserScript==
// @name           Improved Deposit my cash!
// @namespace      For the Facebook game Gangster Battle!
// @description    Deposits money as soon as you get some.
...
try {
	...
	newdiv.innerHTML = "<div style='width: 100%; text-align: center; font-weight: bold; color: red;'>Time left:</div><div id='horloge_GM' onclick='pause_toggle();' style='width: 100%; text-align: center; font-size: 200%; cursor: pointer;' title='Pause the CountDown'>00:00</div>";
