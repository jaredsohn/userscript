// ==UserScript==
// @name          Amazon TPL Title Search Link
// @namespace     http://chrisnolan.ca/
// @description	  Insert a link on Amazon.ca to do a title search @ the Toronto Public Library
...
(function() {
  ...
  var mpl = new PublicLibraryInfo("Toronto Public Library", "http://hip.tpl.toronto.on.ca/ipac20/ipac.jsp?menu=search&aspect=basic_search&npp=10&ipp=25&profile=rs&ri=&index=TL&term=");
