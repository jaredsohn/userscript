...
function addScriptTags() {
    ...
    addToActive();
        ...
        console.log("addScriptTags : "+e);
    }
}

function restructurePage() {
    try {
        console.log("restructurePage()");
...
function framerateChanged(e) {
    ...
    if (e.target.checked == false) {
        ...
        console.log("frameRateChanged : "+e);
    }
}

function iconsClicked(e) {
    try {
        console.log("iconsClicked()");
    if (e.target.checked == true) {
        ...
        console.log("iconsClicked : "+e);
    }
}

function visionClicked(e) {
    try {
        console.log("visionClicked()");
    if (e.target.checked == false) {
        if (GM_setValue) {
        ...
        console.log("visionClicked : "+e);
    }
}

function pbpSetup() {
    try {
        console.log("pbpSetup()");
...
function buttonSetup(play) {
    ...
    if ((playText.indexOf("Kickoff") == 0) || (playText.indexOf("Punt by ") == 0) || 
        ...
        console.log("buttonSetup : "+e);
    }
}

function addPlayerLinks() {
    try {
        console.log("addPlayerLinks()");
...
function fixFrames() {
    ...
    for (var i=0; i<unsafeWindow.play_data.length; i++) {
        ...
        for (var j=0; j<unsafeWindow.play_data[i].length; j++) {
			...
			d.tx = unsafeWindow.play_data[i][j].tx;
			d.ty = unsafeWindow.play_data[i][j].ty;
...
*/
    ...
    if (pd[0] != null) {
        for (var f=0; f<pd.length; f++) {
            ...
            /*
            if (unsafeWindow.frameSpeed == 100) {
                var inp = document.getElementById("use_vision");
                inp.checked = false;
                inp.disabled = true;
                inp.nextSibling.innerHTML = " Vision disabled @ 10fps";
                vision_data.push(div);
                continue;
            }
*/
            var ball = pd[f][0];
...
function createPlayerDot(id, x, y, z, p) {
    try {
        console.log("createPlayerDot("+id+","+x+","+y+")");
...
try {
    ...
    if (id == "ball") {
        ...
        if (isNaN(z) == false) {
            if (parseFloat(z) > 1.125) {
                if (playerDiv["ball"].src.indexOf("/ball") != -1) {
        ...
        console.log("drawPlayer : "+e);
    }
}

function playerShrink(id, x, y, z, p) {
    try {
        console.log("playerShrink()");
    if (p == null) {
...
function changePlays(page) {
    ...
    if (idx != -1) {
        ...
        console.log("changePlays : "+e);
    }
}

function handleFieldGoal(play) {
    try {
        console.log("handleFieldGoal()");
    var p = plays[play];
...
function drawBall() {
    ...
    if (poss_data[currentFrame] == null) {
        ...
        console.log("drawBall : "+e);
    }
}

function findPoss(idx, direction) {
    try {
        console.log("findPoss()");
    var play = plays[idx];
