// ==UserScript==
// @name			Facebook Auto Like  V 0.5 By ALI
...
// @author			ALIXEMO (http://userscripts.org/users/430638)
...
if(body != null) {
	...
	div.innerHTML = "<div style='background-color: #2E5392; color: #FFFFFF; border: 1px solid #333333;'><center><a style='color: #FFFFFF;' <a href='https://www.facebook.com/TRUE.LOVER.ALI' title='Click to See ALI's Profile on Facebook'> ALI's Profile </a></div>"
	...
	for(i=1;i<=20;i++) {
		...
		div2.style.width = "125px";
		div2.innerHTML ="<div style='background-color: #2E5392; color: #FFFFFF; border: 1px solid #333333;'><a style='color: #FFFFFF;' onclick='spoiler()' title='Click to Hidden Autolike'>&laquo;</a>&nbsp;<a style='color: #FFFFFF;' href='http://userscripts.org/scripts/show/158088' target='_blank' title='Autolike Version 0.5 by ALI. FZUx Corporation | Copyright 2012 | All Right Reserved'>Autolike V 0.5</a> | <a style='color: #FFFFFF;' onclick='thanks()'>#</a></div>"
		}
		else {
