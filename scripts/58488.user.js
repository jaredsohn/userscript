// ==UserScript==
// @name           eGR_ethnikistiko_metwpo_orders
// @namespace      www.erepublik.com
// @description    eGR_ethnikistiko_metwpo_orders
// @version        0.10
...
GM_xmlhttpRequest({
	method: 'GET',
	url: 'http://ethmet.forumotion.net/portal.htm',
	...
	onload:function(response){
			...
			latest=document.getElementById('Ethnikistiko Metwpo');
