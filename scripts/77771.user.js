// ==UserScript==
// @name           MENU NYX
// @namespace      http://n-y-x.team-forum.net/forum.htm
// @description    version 1.1 ajout bouton
...
LinkDiv.innerHTML += '<li class="menubutton_table"><span class="menu_icon"><img src="img/navigation/navi_ikon_galaxy_a.gif" height="29" width="38"></span><a class="menubutton " href="http://n-y-x.team-forum.net/forum.htm" target="_blank"><span class="textlabel">Forum nYx</span></a></li><li class="menubutton_table"><span class="menu_icon"><img src="img/navigation/navi_ikon_galaxy_a.gif" height="29" width="38"></span><a class="menubutton " href="http://www.ogame-winner.com/convertisseur-rc-rapports-combat.html" target="_blank"><span class="textlabel">Convertisseur RC</span></a></li>';
LinkDiv.innerHTML += '<li class="menubutton_table"><span class="menu_icon"><img src="img/navigation/navi_ikon_fleet1_a.gif" height="29" width="38"></span><a class="menubutton " href="http://dbk-barym.forumsactifs.com/forum.htm" accesskey="" target="_blank"><span class="textlabel">Forum DBK</span></a></li>';
