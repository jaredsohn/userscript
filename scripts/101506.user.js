...
// @description		يقوم بتخزين عدد الوحدات المهجوم فيها ثم تستطيع وضعها في هجوم اخر
...
(function(){
	...
	$("<a href='javascript:;' id='saveInsertedUnits' />").text(" » تخزين الوحدات").click(function() {
		$.each(UnitInputs, function(idx, itm) { 
