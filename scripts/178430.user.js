// ==UserScript==
// @name           Facebook: Gefällt mir -> Like/Dislike
// @namespace      Constey
// @version 0.1
// @description    Benennt "Gefällt mir" zu "Like" um.
...
function Universal1(str){
    return str;
  /*return str.replace(/gefällt das./g,"hat es geliked.")
    .replace(/g[Ee][Ff][Ää][Ll][Ll][Tt][ ][Dd][Aa][Ss][Ss][.]/g,"hat es geliked.")
    .replace(/G[Ee][Ff][Ää][Ll][Ll][Tt][ ][Dd][Aa][Ss][Ss][.]/g,"hat es geliked.")*/
}
function Universal3(str){
  return str.replace(/Gefällt mir/g,"Like")
    .replace(/g[Ee][Ff][Ää][Ll][Ll][Tt][ ][Mm][Ii][Rr]/g,"Like")
    .replace(/G[Ee][Ff][Ää][Ll][Ll][Tt][ ][Mm][Ii][Rr]/g,"Like")
}
function Universal2(str){
  return str.replace(/Gefällt mir nicht mehr/g,"Dislike")
    .replace(/g[Ee][Ff][Ää][Ll][Ll][Tt][ ][Mm][Ii][Rr][ ][Nn][Ii][Cc][Hh][Tt][ ][Mm][Ee][Hh][Rr]/g,"Dislike")
    .replace(/G[Ee][Ff][Ää][Ll][Ll][Tt][ ][Mm][Ii][Rr][ ][Nn][Ii][Cc][Hh][Tt][ ][Mm][Ee][Hh][Rr]/g,"Dislike")
}	
