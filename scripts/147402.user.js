// ==UserScript==
// @name	CJ-Mod
// @description CJ's Mod for GuessX's Drone script
// ==/UserScript==
    ...
    JobEnergySelector.prototype = {
        doEnergyJob: function () {
            ...
            if (this.isUsingButton) {
                ...
                $('#city_job_' + this.EnergyJobId + ' > .job_action > a').click();
                setTimeout(DoEnergyJob, rjref[Drone.StoreThis.RepeatJobSpeed]);
                return;
            } else {
...
'<br><center><a class="sexy_button_new short red" href="#" id="resetconfig"><span><span>Reset Config</span></span></a>&nbsp;<a id="savedcfg" href="#" class="sexy_button_new short green"><span><span>SAVE</span></span></a></center></div></span>'+
        ...
        document.getElementById('li__tab1').addEventListener("click", function () {
            _tab("__tab1")
        }, false);
        document.getElementById('li__tab2').addEventListener("click", function () {
            _tab("__tab2")
        }, false);
        document.getElementById('li__tab3').addEventListener("click", function () {
            _tab("__tab3")
        }, false);
        document.getElementById('li__tab4').addEventListener("click", function () {
            _tab("__tab4")
        }, false);
        document.getElementById('li__tab5').addEventListener("click", function () {
            _tab("__tab5")
        }, false);
        document.getElementById('li__tab6').addEventListener("click", function () {
            _tab("__tab6")
        }, false);
        document.getElementById('li__tab7').addEventListener("click", function () {
            _tab("__tab7")
        }, false);
    ...
    function GoTime() {
        ...
        try {
            Drone.StoreThis.RatioingJobValue = parseFloat(document.getElementById("postformid1").value);
            Drone.StoreThis.NormalUntillValue = parseInt(document.getElementById("postformid2").value);
            Drone.StoreThis.RatioingStamValue = parseFloat(document.getElementById("postformid3").value);
...
document.getElementById("showstatus").style.display = ''
    ...
    function JobTravelr() {
        ...
        document.getElementById('ActiRes').innerHTML = Drone[Drone.JobOptions.JobPrimaryOrSecondary].EnergyJobName;
    ...
    function StaminaTravelr() {
        ...
        document.getElementById('ActiRes').innerHTML = Drone[Drone.JobOptions.StamPrimaryOrSecondary].StaminaJobName;
        if (Drone[Drone.JobOptions.StamPrimaryOrSecondary].isFobbing == true) {
            do_ajax('mainDiv', 'remote/html_server.php?xw_controller=travel&xw_action=travel&xw_city=7&from=job&zone=1&destination=' + Drone[Drone.JobOptions.StamPrimaryOrSecondary].StaminaJobCity + '&tab=' + Drone[Drone.JobOptions.StamPrimaryOrSecondary].StaminaJobTab + '');
    ...
    function CloseDoopidPopup() {
        if (Drone.Check.GiveMeAPause == 0) {
            ...
            if (actulevel != Drone.CurrentLevel) {
                ...
                document.getElementById('Levelscleared').innerHTML = Drone.Check.LevelsDone;
                grab_bonus();
                //return;
            }
            if ($('.pop_bg').length > 0) {
