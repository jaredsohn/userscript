...
// @updateURL https://userscripts.org/scripts/show/137882
// @downloadURL https://userscripts.org/scripts/show/137882
// @icon http://imgur.com/pAgU2
// ==/UserScript==
  ...
  Config = {
    main: {
      Enhancing: {
        ...
        'Check for Updates': [false, 'Check for updated versions of 4chanX']
      },
      Filtering: {
        'Anonymize': [false, 'Make everybody anonymous'],
        'Filter': [true, 'Hide tripfags and other shitposters'],
...
<div id=credits>\
<a target=_blank href=https://userscripts.org/scripts/show/137882>4chanX</a>\
 <a target=_blank href=https://userscripts.org/scripts/review/137882>' + Main.version + '</a>\
 <a target=_blank href=https://userscripts.org/scripts/issues/137882>Issues</a>\
</div>\
<div>\
...
*/
  ...
  Main = {
    ...
    message: function(e) {
      ...
      if (version && version !== Main.version && confirm('An updated version of 4chanX is available, would you like to install it now?')) {
    ...
    node: function(nodes, notify) {
      ...
      for (_i = 0, _len = _ref.length; _i < _len; _i++) {
        ...
        try {
          ...
          if (notify) {
            alert("4chanX has experienced an error. You can help by sending this snippet to:\nhttps://github.com/aeosynth/4chan-x/issues\n\n" + Main.version + "\n" + window.location + "\n" + navigator.userAgent + "\n\n" + err.stack);
          }
        }
      }
    },
...
box-shadow: inset 5px 0 rgba(128,0,128,0.5);\
}\
.filter_highlight > .reply {\
box-shadow: -5px 0 rgba(128,0,128,0.5);\
}\
.filtered {\
