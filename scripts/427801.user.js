// ==UserScript==
// @name           SearchEngineLINK
// @description    方便的在各个引擎之间跳转
// @version        4.0.1.0
// @lastUpdated    2014-3-25
// @grant          none
...
(function () {
	...
	/* 					keyword: function () {
			...
			engineList.web[4] = {
				name: 'Bangumi',
				url: 'http://bangumi.tv/subject_search/%s?cat=all',
				favicon: 'http://bangumi.tv/img/favicon.ico',
			};
			engineList.web[5] = {
				name: 'Getchu',
				url: 'http://www.getchu.com/php/nsearch.phtml?genre=all&search_keyword=%s',
				favicon: 'http://www.getchu.com/favicon.ico',
			};
			engineList.web[-6] = {
				name: 'DuckGo',
				url: 'https://duckduckgo.com/?q=%s&kl=cn-zh&kad=hans_XX&kp=-1&kw=w&kc=1&kn=1&kh=1&ku=1&k1=-1',
			...
			engineList.video[-6] = {
				...
				favicon: 'http://www.qiyipic.com/common/images/logo.ico',
			};
			engineList.video[-7] = {
				name: '乐视',
			...
			engineList.video[9] = {
				name: '网易公开课',
				url: 'http://c.open.163.com/search/search.htm?query=%s',
				favicon: 'http://www.163.com/favicon.ico',
			};
            ...
            engineList.download[1] = {
				name: 'NyaaTorrent',
				url: 'http://sukebei.nyaa.se/?page=search&cats=0_0&filter=0&term=%s',
				favicon: 'http://files.nyaa.se/favicon.png',
			};
            engineList.download[2] = {
				name: 'E-Hentai',
				url: 'http://g.e-hentai.org/?f_doujinshi=1&f_manga=1&f_artistcg=1&f_gamecg=1&f_western=1&f_non-h=1&f_imageset=1&f_cosplay=1&f_asianporn=1&f_misc=1&f_search=%s&f_apply=Apply+Filter',
				favicon: 'http://g.e-hentai.org/favicon.ico',
			};
            engineList.download[3] = {
				name: 'TokyoTosho',
				url: 'http://tokyotosho.info/search.php?terms=%s&type=0&size_min=&size_max=&username=',
				favicon: 'http://ttcdn.info/favicon.png',
			};
			...
			engineList.download[-7] = {
				name: '漫游字幕组',
				url: 'http://share.popgo.org/search.php?title=%s',
				favicon: 'http://share.popgo.org/favicon.ico',
			};
