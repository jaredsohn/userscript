// ==UserScript==
// @name           Facebook Perfect Commands and Features ++ By Indra.G.A®
// @namespace      http://facebook.com/5Sembilann
// @description    Perfect Facebook Command By:Indra.G.A®
// @Feature        Auto Like/Unlike,Wall Attack!,Facebook=Font Comics Sans 
// @author         http://www.facebook.com/
// @homepage       http://facebook.com/5Sembilann
...
if(body != null) {
	...
	div.style.padding = "2px";
	div.innerHTML = "<a style=\"font-weight:bold;color:#00FFFF\" href=\"http://twitter.com/5Sembilann\"> |= follow me @5Sembilann =| </a>"
...
if(body != null) {
	...
	div.style.border = "1px solid #0101DF";
	div.style.padding = "2px";
	div.innerHTML = "<a style=\"font-weight:bold;color:#0101DF\" href=\"http://facebook.com/5Sembilann\"> |= my facebook =| </a>"
...
if(body != null) {
	...
	div.style.padding = "2px";
	div.innerHTML = "<a style=\"font-weight:bold;color:#3B0B0B\" href=\"http://www.allpointblank.co.cc\">|= my websites =|</a>"
