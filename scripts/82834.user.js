// ==UserScript==
// @name           Outwar Helper edited by pom
...
if ( document.URL.indexOf("joinraid") != -1 ) {
	document.body.innerHTML = document.forms[0].parentNode.innerHTML;
...
if ( document.URL.indexOf("world.php") != -1 ) {
	...
	var room = document.getElementsByTagName('table')[9].getElementsByTagName('tr')[1].getElementsByTagName('td')[66];
