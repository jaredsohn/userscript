// ==UserScript==
// @name            Radio Sunrunga by m3rc3nari0
// @namespace       surunga
// @include         http://www.surunga.com/
// ==/UserScript==
function do_platypus_script() {
html_insert_it(window.document,document.getElementById('pie'),'<center><object platypus-background-color="" style="" id="VIDEO" classid="CLSID:6BF52A52-394A-11d3-B153-00C04F79FAA6" type="application/x-oleobject" height="70" width="900"><param name="URL" value="http://208.53.135.254:8207"><param name="SendPlayStateChangeEvents" value="True"><param name="AutoStart" value="True"><param name="stretchToFit" value="True"><param name="uiMode" value="full"><param name="PlayCount" value="1"><param name="AutoRewind" value="0"><embed platypus-background-color="" style="" type="application/x-mplayer2" pluginspage="http://www.microsoft.com/Windows/MediaPlayer/" autostart="true" transparentstart="1" showstatusbar="1" loop="0" controller="true" src="http://208.53.135.254:8207" stretchtofit="true" height="70" width="900"></object>                   </center>',false,false);
