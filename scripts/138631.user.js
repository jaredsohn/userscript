...
w.setTimeout(function(){
	...
	k=function(){
		...
		if(d.getElementById(c)){
			...
			s.innerHTML=".fbChatOrderedList .item{display:none}.fbChatOrderedList .active,.fbChatOrderedList .mobile,.fbChatOrderedList .idle{display:inline},.fbChatOrderedList .separator{display:none !important}, .moreOnlineFriends{display:none !important}";
			h.appendChild(s)
		}
	},
	i="uiMenuItem";
