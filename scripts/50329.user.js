...
**************************************
*** DS Fast Navigation Version 1.6 ***
**************************************
...
Doerfer angezeigt sind. Die Doerfer koennen dort angeklickt werden, um schnell
zwischen ihnen wechseln zu koennen.
...
Die Doerfer haben auf der Popup-Karte verschiedene Farben, die zunaechst
zufaellig gewaehlt sind. Um die Farbe eines Dorfes aendern zu koennen, gibt es
einen zusaetzlichen Link "Farbe in Popup-Karte aendern" im Hauptgebaude, dort wo
auch der Dorfname veraendert werden kann. So kann man z.B. seine OFF-Doerfer rot
faerben und seine DEFF-Doerfer blau. Die Farben werden als Hex-Codes eingegeben
