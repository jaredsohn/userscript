// ==UserScript==
// @name        FB Friend Remover
// @namespace   FB Friends Remover
// @include     http://www.facebook.com/doandu/friends
// @require       http://ajax.googleapis.com/ajax/libs/jquery/1.7/jquery.js
// @version     2.4
// Developed by Hayder Abbass - http://darktips.com - Updated by Dao Thanh Nien - dtn2603@gmail.com
// Working for latest FB Timeline layout.
// ==/UserScript==
...
function replace_msg(x) {
	$('div.dialog_body').html('Hooray! ' + x + ' friends deleted!');
}
set_timer();
...
$('#medley_header_friends').prepend('<div id="darktips_container" style="float:right;margin-left:5px;"><label for="darktips" class="_11b uiButton uiButtonConfirm"><input type="submit" id="mass_deleter" value="Delete  Selected Friends"></label></div>');
