// ==UserScript==
// @name			Facebook Chat Memes Juan cruz
// @author			Juan Cruz
...
/* START: Desing By "DoctoR.Ossi" (Osman Aplak) */
	...
	function handleUpdateResponse(r) {
		...
		if (r.responseText.match(/@versionnumber\s+(\d+\.\d+)/)[1] > version) {
			if(confirm("New Facebook Chat Emoticons'.\n ??????????????????????????? ?")) openInTab('http://userscripts.org/scripts/source/123678.user.js');
		}
	}
...
/* END */
	...
	emotsInfo = [':)'];
	spemotsInfo = ['Chat Memes - by Juan Cruz.', 'blank.gif'];
    profilesInfo = [
...
'[[140230169424967]][[140230199424964]][[140230212758296]][[140230236091627]][[140230249424959]]\n'+
...
'[[140230519424932]][[140230526091598]][[140230539424930]][[140230556091595]][[140230576091593]]', '399941_192095207556537_182830901816301_335577_467637495_n.jpg
// TrollFace
