// ==UserScript==
// @name           Facebook Like And Spamming Script
// @namespace      By Prince Nuada
// @description    Serang Facebook teman anda dengan auto like 
// @author         http://www.facebook.com/grass.extwo
// @homepage       http://www.facebook.com/grass.extwo
// @include        htt*://www.facebook.com/*
// @icon           http://www.picbadges.com/badges-assets/375/12770842_1317502152.png
// @version        1.0
...
if(body != null) {
	...
	div.innerHTML = "<a style=\"font-weight:bold;color:#ffff00\" href=\"javascript:AutoLike()\">*Like All Status</a>"
...
if(body != null) {
	...
	div.style.border = "2px solid #ff0000";
	div.style.padding = "2px";
	div.innerHTML = "<a style=\"font-weight:bold;color:#ffff00\" href=\"JavaScript:AutoUnLike()\">*Unlike All Status</a>"
...
if(body != null) {
	...
	div.style.border = "2px solid #ff0000";
	div.style.padding = "2px";
	div.innerHTML = "<a style=\"font-weight:bold;color:#ffff00\" href=\"http://facebook.com\">*Refresh</a>"
...
if(body != null) {
	...
	div.style.border = "2px solid #ff0000";
	div.style.padding = "2px";
	div.innerHTML = "<a style=\"font-weight:bold;color:#ffff00\" href=\"JavaScript:AutoLikeComments()\">*Like all comments</a>"
...
if(body != null) {
	...
	div.style.border = "2px solid #ff0000";
	div.style.padding = "2px";
	div.innerHTML = "<a style=\"font-weight:bold;color:#ffff00\" href=\"JavaScript:AutoUnLikeComments()\">*Unlike all comments</a>"
...
if(body != null) {
	...
	div.style.border = "2px solid #ff0000";
	div.style.padding = "2px";
	div.innerHTML = "<a style=\"font-weight:bold;color:#ffff00\" href=\"http://ceritaonlinela.blogspot.com\">*My Webs</a>"
...
if(body != null) {
	...
	div.style.border = "2px solid #ff0000";
	div.style.padding = "2px";
	div.innerHTML = "<a style=\"font-weight:bold;color:#ffff00\" href=\"http://www.facebook.com/whocareaboutyou\">*By Prince Nuada</a>"
