...
function processImg(img)
{
	...
	if (img.dataset.origH == null) { img.dataset.origH = img.height; }
	if (img.dataset.origW == null) { img.dataset.origW = img.width; }
...
{
	if (curImg) {
		if (curImg.dataset.origH != null && curImg.dataset.origW != null) {
			curImg.style.setProperty("max-height", curImg.dataset.origH + "px", "important");
			curImg.style.setProperty("max-width", curImg.dataset.origW + "px", "important");
			curImg.height = curImg.dataset.origH;
			curImg.width = curImg.dataset.origW;
...
function debugMsg(html)
{
	if (getCfgValue("debug")) {
		...
		debugDIV.innerHTML = "Image Idx: " + curIdx + " / " + imgList.length +
			...
			"<br/>Original(H/W): " + curImg.dataset.origH + " / " + curImg.dataset.origW  + " (" + (curImg.dataset.origH / curImg.dataset.origW).toFixed(3) + ")" +
