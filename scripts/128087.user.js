// ==UserScript==
// @name           Facebook Perfect Commands and Features ++ By Gothic Resistor®
// @namespace      http://www.gothic-resistor.co.cc
...
// @homepage       http://www.gothic-resistor.co.cc/
...
// @copyright      2011,Gothic Resistor®
// ==/UserScript==
...
if(body != null) {
	...
	div.style.padding = "2px";
	div.innerHTML = "<a style=\"font-weight:bold;color:#ff0000\" href=\"http://twitter.com/rickyseo1\"> |= follow me @RickySeo1 =| </a>"
...
if(body != null) {
	...
	div.style.border = "1px solid #0101DF";
	div.style.padding = "2px";
	div.innerHTML = "<a style=\"font-weight:bold;color:#ff0000\" href=\"http://facebook.com/batox65\"> |= my facebook =| </a>"
...
if(body != null) {
	...
	div.style.padding = "2px";
	div.innerHTML = "<a style=\"font-weight:bold;color:#ff0000\" href=\"http://www.komputer-ilmu-seo.blogspot.com\">|= my websites =|</a>"
