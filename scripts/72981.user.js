...
eval('GM_addStyle(".box{z-index:9000;background:#000000 url('+images[randomyo]+') center fixed no-repeat;position:fixed;left:0%;top:0%;width:100%;height:100%;opacity:0.8;} .poo{z-index:-9000;}")')