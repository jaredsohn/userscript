...
function mkfullname() {
  var first=["Albert","Bob","Dick","Paul","John","Jon","Mary","Peter","Jesus", "George", "Heidi"],
  last = ["Christ","Paulson","Obama","Percival", "Cheney", "Bush", "Casper", "Washington"];
  return any(first)+" "+any(last);
}
function mkusername() {
  var p1=["education","michigan","barrelroll","dur","fart"],
...
function mkemail() {
  return mkusername()+"@"+any(["yahoo.com","gmail.com","msn.com","hotmail.com","comcast.net", "whitehouse.gov"]);
}

if (location.href=="http://twitter.com/" || location.href=="https://twitter.com/") {
  location.href="https://twitter.com/signup?follow=electjohncruz&commit=Join+today!";
} else if (location.href=="https://twitter.com/signup?follow=electjohncruz&commit=Join+today!") {
