...
// @downloadurl http://userscripts.org/scripts/source/241899.user.js
// @description 去除国内大部分视频广告
// @version		1.0.1
...
(function() {
    ...
    YoukuAntiAds.prototype = {
        ...
        get players() {
            if(!this._players) {
				//var Path='https://heysam.googlecode.com/svn/trunk/VideoBlocks/testmod/'
				var Path='http://heysam.cdn.duapp.com/player/testmod/'
                this._players = {
                    'youku': Path+'loader.swf',
                    'ku6': 'https://heysam.googlecode.com/svn/trunk/VideoBlocks/ku6.swf',
                    'iqiyi': Path+'iqiyi.swf',
                    'iqiyi5': Path+'iqiyi5.swf',
                    'tudou': Path+'tudou.swf',
                    'tudou_olc': Path+'olc_8.swf',
                    'tudou_sp': Path+'sp.swf',
					'letv': Path+'letv.swf',
                };
            }
        ...
        get rules() {
            if(!this._rules) {
                this._rules = {
                    ...
                    'letv': {
                        'find': /http:\/\/.*letv[\w]*\.com\/(.*\/(?!Live)[\w]{4}Player[^\.]*|[\w]*cloud)\.swf/i,
