// ==UserScript==
// @name            Doublespace stats
// @namespace       Platypus
// @include         http://www.deadawaken.com/game.php?sec=train&scr=statstore&r=*
// ==/UserScript==
function do_platypus_script() {
html_insert_it(window.document,document.evaluate('/HTML[1]/BODY[1]/DIV[1]/DIV[6]/DIV[1]/TABLE[1]/TBODY[1]/TR[1]/TD[1]/B[2]', document, null, XPathResult.FIRST_ORDERED_NODE_TYPE,null).singleNodeValue,'<br>',true,false);
html_insert_it(window.document,document.evaluate('/HTML[1]/BODY[1]/DIV[1]/DIV[6]/DIV[1]/TABLE[1]/TBODY[1]/TR[1]/TD[1]/A[1]/B[1]', document, null, XPathResult.FIRST_ORDERED_NODE_TYPE,null).singleNodeValue,'<br>',true,false);
html_insert_it(window.document,document.evaluate('/HTML[1]/BODY[1]/DIV[1]/DIV[6]/DIV[1]/TABLE[1]/TBODY[1]/TR[1]/TD[1]/B[3]', document, null, XPathResult.FIRST_ORDERED_NODE_TYPE,null).singleNodeValue,'<br>',true,false);
html_insert_it(window.document,document.evaluate('/HTML[1]/BODY[1]/DIV[1]/DIV[6]/DIV[1]/TABLE[1]/TBODY[1]/TR[1]/TD[1]/B[4]', document, null, XPathResult.FIRST_ORDERED_NODE_TYPE,null).singleNodeValue,'<br>',true,false);
