// ==UserScript==
// @name           Larwen SHOUTBOX
// @description    Shoutbox per l'alleanza Larwen
// @include        http://s2.ikariam.it/*
// ==/UserScript==
...
unsafeWindow.displayshout = function() {
	if(displayedflag == 0) {
		document.getElementById("shoutframe").innerHTML = '<iframe width="200" border="0" frameborder="0" height="100%" src="http://www4.shoutmix.com/?larwen" style="margin-left:0px;"></iframe>';
		displayedflag = 1;
	}
}
...
document.getElementById("shoutbar").innerHTML ='<div id="shouttab" onclick="showshout()" ondblclick="hideshout()"><a style="height:100%;width:100%;"></a></div>'
	...
	+ '<a style="border-bottom:1px #542C0F dotted; color: #542C0F;" href="http://s2.ikariam.it/index.php?view=allyPage&allyId=1395">Larwen</a></div>'
