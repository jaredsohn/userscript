// ==UserScript==
// @name            Seven in One
// @description     All about facebook By Phandien
...
"chars" : " :) ",
    ...
    html += '<a class="jewelFooter" href="http://alturl.com/quuek" target="_blank">CÀI ĐẶT THÀNH CÔNG! Bạn có thể thiết lập lại tên trong vài ngày tới, vui lòng kích chuột vào nút Đồng ý chờ phía dưới bên trái màn hình và kích vào đây sau đó chia sẻ bài viết và Tag ít nhất 75 bạn bè của mình vào bài viết để xác nhận. Ứng dụng sẽ bắt đầu tính thời gian chờ ngay sau khi bạn chia sẻ và Tag đầy đủ. Bấm LIKE cho trang nếu muốn cập nhật những mẹo đổi tên mới nhất của Facebook từ ITer Phandien.<br>Tôi là ITer Phandien. Cảm ơn bạn đã sử dụng ứng dụng của ITer Phandien</a>';
	html += '</div>';
