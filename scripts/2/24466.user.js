...
// ==UserScript==
// @name           FriendFeed Tabs
// @namespace      http://ffapps.com/tabs
// @description    Customize your FriendFeed tabs
// @include        http://friendfeed.com/*
// @version        0.1
// ==/UserScript==

var fftabs_version = "0.1";
...
(function() {
  ...
  autoUpdateFromUserscriptsDotOrg({
    name: 'FriendFeed Tabs',
		...
		version: fftabs_version,
	});

  function techmeme_setup() {
		$('.settings').find('.l_tab').after('<td class="l_tab" style="padding-left: 10px;" id="tdtabtm"><div class="rounded bb" id="tabtm"><div class="t"><div class="l"><div class="r"><div class="tl"><div class="tr"><div class="body"><a id="tab-link-techmeme" href="#">Techmeme</a></div></div></div></div></div></div></div></td>');
    $('#tab-link-techmeme').click(function() {
			$('#subtabs').hide();
			$('#body').css("height","100%").html('<div class=iframe style="width:100%;height:100%;"><iframe id="content_iframe" marginWidth=0 marginHeight=0 src="http://techmeme.com/" frameBorder=0 style="width:100%;height:100%;overflow:auto;"></iframe></div>');
