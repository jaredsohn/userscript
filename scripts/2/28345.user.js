...
// ==/UserScript==
	...
	R   Application Navigation
	S   RunningBlinds "Comments on Hompage"
...
if ($('col3')) // Check that we're using the new skin
	...
	piece['J'] = $('googlead');
	piece['K'] = $('ctl00_cpMain_MarketingBox_userHomeTabs_userHomeTabs');
	...
	piece['Q'] = $('addressbook');
	piece['R'] = $('appnavigation');
	piece['S'] = $('comments');
	//Adblocking and other annoyances
	piece['Y'] = $('advert');
	piece['Z'] = $('footer');
