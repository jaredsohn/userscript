// ==UserScript==
// @name           Gl1TCHr.COM Auto-Alliance for World War
// @namespace      Kyle Butler
// @include        http://wwar.storm8.com/group.php*
// @include        http://gl1tchr.com/reg/gameplay.php*
// ==/UserScript==
...
else
{
	...
	if (numClick > 0)
	{
		...
		alert("You've added all of the codes! Tell us to get more!");
	}
}
...
var wwash = document.getElementsByClassName('Container')[0];
wwash.innerHTML += '<br><p align="center" style="font-size: 18px; color: #9dc8ff; padding: 0px 0">Auto-Add<br><input id="acdn" type="text" value="'+numClick+'" style="background: #000; color: #0f0; border: #0f0 1px solid; width: 30px"> Allies</p>';
