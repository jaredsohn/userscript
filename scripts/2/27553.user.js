...
// @description    Will notify you of any new mail, friend requests, etc., from anywhere on the 'net remix.
// @include        *
// ==/UserScript==
...
//This update was created by Jimbo
		...
		onload: function(responseDetails) {
			...
			if(show) {
				...
				GM_addStyle('#GM_MSNotify {' +
					...
					'background-color:#02b303 !important;' +
