// ==UserScript==
// @name          Greenville County, South Carolina, Library System
// @namespace     
// @description   Is this Amazon, Barnes and Noble, Powell's, or Netflix item (book, CD, DVD) available from the Greenvillle County, South Carolina, Library System?
...
function LibrarySCGreenville() { Library.call(this); }
LibrarySCGreenville.prototype = new Library();
LibrarySCGreenville.prototype.placeholderISBN13           = 'PLACEHOLDERISBN13';
LibrarySCGreenville.prototype.placeholderISBN10           = 'PLACEHOLDERISBN10';
LibrarySCGreenville.prototype.placeholderTitle            = 'PLACEHOLDERTITLE';
LibrarySCGreenville.prototype.placeholderAuthor           = 'PLACEHOLDERAUTHOR';
LibrarySCGreenville.prototype.placeholderSession          = 'PLACEHOLDERSESSION';
LibrarySCGreenville.prototype.locationSearch              = 'http://gclweb2.greenvillelibrary.org/web2/tramp2.exe/log_in?setting_key=english';
LibrarySCGreenville.prototype.locationSearchByISBN13      = 'http://gclweb2.greenvillelibrary.org/web2/tramp2.exe/do_keyword_search/PLACEHOLDERSESSION?qual1=+&term1=PLACEHOLDERISBN13&bool1=and&query=++PLACEHOLDERISBN13&submit=Search&index=default&query_screen=PowerSearch.html&servers=1home&location_group_filter=ALL&language_filter=all&material_filter=ALL&item_category2_filter=ALL&shadow_filter=NO&date_filter=all&sort_by_filter=';
LibrarySCGreenville.prototype.locationSearchByISBN10      = 'http://gclweb2.greenvillelibrary.org/web2/tramp2.exe/do_keyword_search/PLACEHOLDERSESSION?qual1=+&term1=PLACEHOLDERISBN10&bool1=and&query=++PLACEHOLDERISBN10&submit=Search&index=default&query_screen=PowerSearch.html&servers=1home&location_group_filter=ALL&language_filter=all&material_filter=ALL&item_category2_filter=ALL&shadow_filter=NO&date_filter=all&sort_by_filter=';
LibrarySCGreenville.prototype.locationSearchByTitleAuthor = 'http://gclweb2.greenvillelibrary.org/web2/tramp2.exe/do_keyword_search/PLACEHOLDERSESSION?qual1=TI&term1=PLACEHOLDERTITLE&bool1=and&qual2=AU&term2=PLACEHOLDERAUTHOR&bool2=+&query=TI+PLACEHOLDERTITLE+and+AU+PLACEHOLDERAUTHOR&submit=Search&index=default&query_screen=PowerSearch.html&servers=1home&location_group_filter=ALL&language_filter=all&material_filter=ALL&item_category2_filter=ALL&shadow_filter=NO&date_filter=all&sort_by_filter=';
LibrarySCGreenville.prototype.locationSearchByTitle       = 'http://gclweb2.greenvillelibrary.org/web2/tramp2.exe/do_keyword_search/PLACEHOLDERSESSION?qual1=TI&term1=PLACEHOLDERTITLE&bool1=+&query=TI+PLACEHOLDERTITLE&submit=Search&index=default&query_screen=PowerSearch.html&servers=1home&location_group_filter=ALL&language_filter=all&material_filter=ALL&item_category2_filter=ALL&shadow_filter=NO&date_filter=all&sort_by_filter=';
LibrarySCGreenville.prototype.xpath['holdingList']        = '//td[@class="searchsum"]/table[2]//ol/table';
LibrarySCGreenville.prototype.xpath['holding']            = '//div[@id="panel1"]/table';     
LibrarySCGreenville.prototype.xpath['holdingLibrary']     = '//div[@id="panel1"]/table/tbody/tr/td[position()=1][@class="holdingslist"]';
LibrarySCGreenville.prototype.xpath['holdingCopy']        = '//div[@id="panel1"]/table/tbody/tr/td[position()=3][@class="holdingslist"]';
LibrarySCGreenville.prototype.xpath['holdingMaterial']    = '//div[@id="panel1"]/table/tbody/tr/td[position()=4][@class="holdingslist"]';
LibrarySCGreenville.prototype.xpath['holdingLocation']    = '//div[@id="panel1"]/table/tbody/tr/td[position()=5][@class="holdingslist"]';

LibrarySCGreenville.prototype.search = function(success, failure) {
    this.success = success;
    this.failure = failure;

    var gf = new GreaseFunction();
    gf.request(this.locationSearch, this.searchHelper.bind(this));
}

LibrarySCGreenville.prototype.searchHelper = function(status, document) {
    if(status == this.statusPresent) {
        this.location = this.location.replace("PLACEHOLDERSESSION", stringFor('//form[@name="Entry"]//a[1]/@href', document).replace(/^\/web2\/tramp2.exe\/goto\/([^?]*)?.*$/g, '$1'));
...
Store.prototype = {
    ...
    attemptSearchByISBN10: function() {
        if(this.xpath['ISBN-10'] && this.ISBN10()) {
            ...
            this.library.searchByISBN10(this.ISBN10(), this.renderAfter.bind(this), this.attemptSearchByTitleAuthor.bind(this));
        }
        else {
            this.attemptSearchByTitleAuthor();
        }
    },
    ...
    attemptSearchByTitle: function() {
        if(this.title()) {
            ...
            this.library.searchByTitle(this.title(), this.renderAfter.bind(this), this.renderAfter.bind(this));
        }
        else {
            this.renderAfter();
        }
...
if(window.location.toString().match(/^http:\/\/www\.amazon\.com\//))          { new Amazon (new LibrarySCGreenville()); }
if(window.location.toString().match(/^http:\/\/[^\.]*.barnesandnoble.com\//)) { new Barnes (new LibrarySCGreenville()); }
if(window.location.toString().match(/^http:\/\/www\.powells\.com\//))         { new Powells(new LibrarySCGreenville()); }
if(window.location.toString().match(/^http:\/\/www\.netflix\.com\//))         { new Netflix(new LibrarySCGreenville()); }
