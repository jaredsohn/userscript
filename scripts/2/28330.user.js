/*
	...
	From The Inquisitr http://www.inquisitr.com
	code modified from http://ffapps.com/tabs/
*/

// ==UserScript==
// @name           FriendFeed Google Reader
// @namespace      http://www.inquisitr.com
// @description    把谷歌浏览器加到FriendFeed 
...
(function() {
  ...
  autoUpdateFromUserscriptsDotOrg({
    name: 'FriendFeed Google Reader',
		url: 'http://userscripts.org/scripts/source/27842.user.js',
		version: ffrb_version,
	});

  function googlereader_setup() {
		$('.settings').find('.l_tab:last').after('<td class="l_tab" style="padding-left: 10px;" id="tdtabtm"><div class="rounded bb" id="tabtm"><div class="t"><div class="l"><div class="r"><div class="tl"><div class="tr"><div class="body"><a id="tab-link-googlereader" href="#">谷歌浏览器</a></div></div></div></div></div></div></div></td>');
    $('#tab-link-googlereader').click(function() {
			$('#subtabs').hide();
			$('#body').css("height","100%").html('<div class=iframe style="width:100%;height:100%;"><iframe id="content_iframe" marginWidth=0 marginHeight=0 src="http://www.google.com/reader/" frameBorder=0 style="width:100%;height:100%;overflow:auto;"></iframe></div>');
