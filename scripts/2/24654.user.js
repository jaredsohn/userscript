...
// ==UserScript==
// @name           Typesites Redirect
// @namespace      http://binq.org/greasemonkey/
// @description    Typesites Redirect v2.0: CSS Beauty pages that are opened in a new tab/window take you directly to the dugg article.  It's very useful when looking through RSS feeds.
// @include        http://*.typesites.com/*/*
// @include        http://typesites.com/*/*
// ==/UserScript==
...
BINQ.typesitesLinkJumper = {
	init: function() {
		this.jumpToFirstValidLink = BINQ.linkJumper.jumpToFirstValidLink;
		return this;
	},
	searchPath: "//div[@class='entry']//a[1]",
}

if (history.length == 1) { BINQ.typesitesLinkJumper.init().jumpToFirstValidLink(); }