...
// @name           agebux
// @namespace      
// @description    auto clicks agebux ads
// @include        http://www.agebux.com/surf.php
// ==/UserScript==

//original script by dt (bux.to), modified by flameboy


const surfTable = '//table[@width="80%"]';
const linksx = '//a[@href]';
var currentWindow;
var currentElement;
var links;
...
function getLinks(){
	...
	for(var i=0;i<links.snapshotLength;i++){
		...
		if ((item.href.substring(0,34)=='http://www.agebux.com/view.php?ad=') &&
			!(item.href=='http://www.agebux.com/view.php?ad='))
			work.push(item);
	}
