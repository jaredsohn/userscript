// LokiAds - The Lokalisten Advertising Deleter
// Version 1.22
// 2008-07-27
...
// select "LokiAds", and click Uninstall.
//
// --------------------------------------------------------------------
//
// ==UserScript==
...
// @description   Deletes much advertising from Lokalisten.de -- Version: 1.22
...
if (mainFooter) {
    ...
    newElement.innerHTML = '<strong>&copy; Lokalisten 2008</strong> | ' +
        ...
        '<a href="/help/showHelp.do?method=help">Hilfe</a> | ' +
        '<a href="http://userscripts.org/scripts/show/22488" target="_blank">LokiAds</a>';
