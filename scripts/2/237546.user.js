// ==UserScript==
// @name	    Dmo from Final Fantasy XV
...
proxy.innerHTML = '<div style="position: fixed; top: 200px; left: 2%; background: white; padding: 5px"><button id="proxy_it" class="closing" onclick="document.location.href = \'http://www.proxfree.com/?proxy_it\'"><img src="http://img28.imageshack.us/img28/8129/qdro.png" /></button></div>';
