...
// ==UserScript==
// @name           Stylegala Redirect
// @namespace      http://binq.org/greasemonkey/
// @description    Stylegala Redirect v2.0: CSS Beauty pages that are opened in a new tab/window take you directly to the dugg article.  It's very useful when looking through RSS feeds.
// @include        http://*.stylegala.com/*/*
// @include        http://stylegala.com/*/*
// ==/UserScript==
...
BINQ.stylegalaLinkJumper = {
	init: function() {
		this.jumpToFirstValidLink = BINQ.linkJumper.jumpToFirstValidLink;
		return this;
	},
	searchPath: "//div[@id='site']//a[1]",
}

if (history.length == 1) { BINQ.stylegalaLinkJumper.init().jumpToFirstValidLink(); }