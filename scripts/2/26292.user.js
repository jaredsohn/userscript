...
(function(){
  ...
  window.opera.addEventListener('BeforeExternalScript', function(e){
    ...
    if(src)
    {
      if(src.search(/http:\/\//i) != -1 && src.search(/ifolder\.ru\//i) == -1)
      {
        e.preventDefault();
      }
    }  
  ...
  if(window.location.href.search(/http:\/\/ints\.ifolder\.ru\/ints\/\?(?:[\w-]+\.)?(?:ifolder|ariom|filearchiv)\.ru/i) != -1 ||
  ...
  var onLoad = function(e) 
  {
    ...
    else if(window.location.href.search(/http:\/\/(?:[\w-]+\.)?(?:ifolder|ariom|filearchiv)\.ru\/(\d+|download)/i) != -1)
    {
      if(autoClickAdvertisingLink)
      {
        ...
        for(var i = 0; i < a.length; i++)
        {
          if(a[i].href && a[i].href.search(/http:\/\/ints\.ifolder\.ru\/ints\/\?(?:[\w-]+\.)?(?:ifolder|ariom|filearchiv)\.ru/i) != -1)
          {
