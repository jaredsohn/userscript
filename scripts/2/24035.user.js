// ==UserScript==
// @name          Amazon Ottawa Public Library Linky
// @namespace     http://bryan.larsen.st
// @description	  v1.31 Search the Ottawa Public Library Catalog from Amazon book listings.  
// @include       http://*.amazon.*
// ==/UserScript==
...
//	GM_log('Amazon Ottawa Public Library Linky');	
	...
	var libraryIsbnUrlPattern = 'http://www.lirico.ca/ipac20/ipac.jsp?index=ISBNEX&term='
	var libraryTitleUrlPattern = 'http://www.lirico.ca/ipac20/ipac.jsp?index=ISBNEX&term='
