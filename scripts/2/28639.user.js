// ==UserScript==
  ...
  // @contributor		http://roosterteeth.com/joequincy
  // @contributor		http://roosterteeth.com/ijay
  // @contributor		http://roosterteeth.com/kwierso
  // @description		Displays a box when you have one or more new alert on RT, which provides links to check those alerts.
  // @version			3.0.0
  // @ff_max_version	3.0.*
  // @include			*
...
GM_xmlhttpRequest({
  method:"GET",
  url:"http://roosterteeth.com/members/index.php",
  headers:{
