// ==UserScript==
// @name           snowboard theme Facebook Skin
// @namespace      Facebook
// @description    snowboard theme facebook skin for Abi, by rob mason:-)
...
for (var i = 0; i < mylinks.length; i++) {
	if (mylinks[i].className.toLowerCase() == "go_home") {
		mylinks[i].style.background = "url(http://i223.photobucket.com/albums/dd237/demon_dragon_fly/Untitled-2copy.jpg)";
	}
}
...
document.body.style.backgroundImage = "url(http://i223.photobucket.com/albums/dd237/demon_dragon_fly/hawaiian_backdrop_by_reginepetrolac.jpg)";
