...
// @include        http*://prodgame*.alliances.commandandconquer.com/247/index.aspx*
// @grant unsafeWindow
							...
							members: {
								...
								initialize: function () {
									...
									/*GM_xmlhttpRequest({
										method: "POST",
										synchronous: true,
										url: "http://ks2014356.kimsufi.com/ccta/postPlayerInfos.php",
									...
									xhr.open('POST', 'https://ssl6.ovh.net/~simutran/ccta/postPlayerInfos.php', true);
