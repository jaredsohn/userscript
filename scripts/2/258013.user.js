// ==UserScript==
// @name           [Паутина] Напоминание о ДР
// @description    напоминает о днях рождениях сокланов
...
//
var my_profile_url = "http://berkut009.do.am/index.htm";
...
function addPanel(){
	...
	//
		...
		d.innerHTML = '<div align="center"><iframe width="350"  name="skills_iframe" id="skills_iframe" "+ " frameBorder="0" frameSpacing="0" marginWidth="0" marginHeight="0" scrolling="'+my_skills_scroll+'" src="'+my_profile_url+'"></iframe></div>';
