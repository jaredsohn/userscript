...
tradegoodText[1] = 'Vine';
tradegoodText[2] = 'Marble';
tradegoodText[3] = 'Crystal';
...
function makeRows() {
var rowsHTML = '';
rowsHTML +='<TR><TD><b>Coordinate</b></TD><TD><b>Name</b></TD><TD><b>God</b></TD><TD><b>Resource</b></TD><TD><b>Level</b></TD></TR>';
for(i in arrXY) {
islex = arrXY[i];
...
var initOK = 1;
var worldBoxHTML =
'<DIV style="vertical-align: middle; text-align:center; margin-bottom: 10px; height: 30px; background: RGB(228,184,115);"><B>The world of Ikariam</B></DIV>'+
