...
// select "TribalWars Enhancer", and click Uninstall.
//
// --------------------------------------------------------------------

// ==UserScript==
// @name           TribalWars Enhancer
// @version        0.8
// @namespace      gelu.kelu-at-gmail.com
// @description    Ads Remover. 15x15 Map. Shortcuts Bar. TW-Tools quick-access. Multi-Language. More to come!
...
// @copyright      Copyright (c) 2007, Gelu Kelu
// ==/UserScript==
...
// - 15x15 Map
// - Shortcuts Bar
// - TW-Tools quick-access
// - Multi-Language
//
// v0.2 - Oct 18, 2007
// - Ads remover
// - Villages dropdown (when more than one village)
// - Improved shortcuts bar
...
//
// v0.4 - Dec 08, 2007
// - New feature: Track village points
// - New translations:
//   - Czech (divokekmeny.cz) - thanks to Karel Žáček
//   - Dutch (tribalwars.nl)  - thanks to Jens Bourgeois
//
// v0.5 - Dec 12, 2007
// - New translations:
//   - Spanish (tribalwars.es)
//   - French  (tribalwars.fr)
//   - Italian (tribalwars.it)
//
// v0.6 - Dec 19, 2007
// - New feature: Added Opera suport - requested by DarXyde
// - New feature: Window title now shown the selected village - requested (kindof) by stan_tz
// - New translations:
//   - Swedish (tribalwars.se) - thanks to Andreas Svensson
// - Fix: Added translations for the "Attack again" options
// - Fix: Ad iframe not removed when in skyscrapper ads mode - reported by Knight
// - Fix: Remove forum/view-post ads
// - Fix: Show map tooltips for the new TW v4.0 (World 13 on .net and World 4 on .ro)
// - Major code cleanup - due to Opera compatibility
//
// v0.7 - Dec 21, 2007
// - New feature: Map size upto 30x30!
//
// v0.8 - Dec 24, 2007
// - Fix: "Attack again" options now dispatch attacks to the attacker village
// - New Feature: CSS Styling
// ==/ChangeLog==
...
function init_game_info(){
	...
	if(TW_Use_Cache === false){
		...
		tw_alert("TW-Enhancer: Cache updated!" , info);
	}
}
...
function enhance_map_screen(){
	...
	var iHtml = '<table><tr><td>Rozmiar Mapy:</td><td><select id="map_size_select" onchange="resize_map()">';
