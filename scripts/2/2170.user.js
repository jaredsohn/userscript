// ==UserScript==
// @name          San Francisco Library Lookup
// @namespace     http://www.sflib.org
// @description	  Search the San Francisco Public Library Catalog from Amazon book listings.
// @include       http://*.amazon.*
...
function() {
  var libraryUrlPattern = 'http://sflib1.sfpl.org/search/i?SEARCH=';  // The mimium search string for the Library
  var libraryName = 'San Francisco Public Library';	// what to Call the Library?
