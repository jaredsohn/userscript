...
// ==UserScript==
// @author      Risi fixed by bluelovers
...
///////////////////////////resource auto transportor/////////////////end
	...
	if (iTask != 5) {
		sTaskRepeated = ' '+t("or") + ' '
			+ t("EspacedTime")+ ' <input name="espacedTime"  type="text" id="espacedTime" value ="" />'
			...
			+'</select> '
			+ t('repeat')+ ' <input width="10" name="nbOfRepeat" type="text" id="nbOfRepeat" value = "1" /> '
			+ t('ForeachAddTime')+ ' <input width="10" name="nbOfRepeat_add" type="text" id="nbOfRepeat_add" value = "0" /> '
