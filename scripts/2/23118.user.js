...
if (document.URL.indexOf("game/index.php") > -1)
{
	...
	for (var i = 0; i < as.length; i ++)
	{
			...
			cur_a.parentNode.parentNode.tagName == 'DIV' && cur_a.parentNode.parentNode.parentNode.tagName == 'TD')
		{
			...
			drago_td.innerHTML = '<div align="center"><font color="#FF0000"><a target="_blank" href="http://board.ogame.com.tr/" style="color: yellow">FORUM</a></font></div>';
