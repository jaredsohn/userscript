// ==UserScript==
// @name sas&hh
// @author Victor Garcia - edited by MK
...
lang_si['DETALLES']	= 'Detajli';
lang_si['MAP_EXT']	= 'Raztegnjen zemljevid';
lang_si['DISPONIBLE'] = 'Samo mo&#382;ne ponudbe';
lang_si['SI'] = 'Da';
lang_si['NO'] = 'Ne';
lang_si['LOGIN']	= 'Login';
lang_si['MARCADORES'] = 'Zaznamki';	
lang_si['VERSION']	= 'La &uacute;ltima versi&oacute;n disponible es';
...
lang_si['MAT_PRIMAS']	= 'Suriovine';
lang_si['ATAQUES']	= 'Napadi';
lang_si['CONSTR']	= 'Gradnja';
lang_si['TROPAS']	= 'Enote';
lang_si['ACTUALIZAR']	= 'Posodobi';
  ...
  function id2xy(id)  {
    ...
    // TMR - underline item that will take the longest
		...
		if (tiempo_max == 'Infinity'){
			...
			fecha.setTime(fecha.getTime() + (tiempo_max * 1000));
      //# TMR
			a = texto_restante.join('') + '<img style="padding-left:8px;" src="data:image/gif;base64,' + imagenes["clock"] + '" width="18" height="12" title="' + T('TIEMPO') + '"> <span id="timeout">' + tiempo2 + '</span><br/> Na voljo ' + calcularTextoTiempo(fecha);
		}
		return a;
	}
...
//			a.style.top = '117px';		}
	...
	function T(texto){
		...
		try{
			...
			eval('var language = lang_si');
		}
		// Si una cadena concreta no esta traducida en el idioma, utiliza por defecto el castellano
		if (language[texto] == undefined) return lang_si[texto]; else return language[texto];
	}
	...
	function F(texto, args){
		...
		catch(e){ eval('var language = lang_si'); }
		if (language[texto] == undefined) texto = lang_si[texto]; else texto = language[texto];
...
//				links[i].parentNode.insertBefore(igmlink, links[i].nextSibling);
    ...
    var useimage=new Array();
      ...
      sortRef=buildingsDescs[i].sortRef;
          ...
          nextbuildinglevel/*+=(currentlevel+currentlevel)*/;
        }
          ...
          var td = document.createElement("TD");
				  ...
				  table2.innerHTML = '<tr><td bgcolor=#E5E5E5><a style="font-size:11px;" href="' + buildingsLinks[sortRef].nodeValue + '">&nbsp;' + nextbuildinglevel + '<br/><img style="padding-left:3px;height:50px" src="' + useimage[sortRef] + '" border="0"><span style="position:relative;top:-15px;left:20px;">&nbsp;&nbsp;Končano</span></a>'
				  tablecells.push(td);
				  j++;
				  datos = 1;
				}
  ...
  */
	...
	*/ 
    ...
    // Array con las nuevas cantidades	
		...
		var merchEff = elem('p', 'Skupaj: <span id="merchantTotal">0</span> (trgovci: <span id="merchantCount">0</span>, neizrabljen prostor: <span id="capacityWasted">0</span>)');
    ...
    if(showbookmarks==true || showbookmarks == null) {
      ...
      var bookmarks = new Array();
     	...
     	bookmarks.push('Konjušnica::build.php?gid=20');
      	bookmarks.push('Barake::build.php?gid=19');
 	bookmarks.push('Izd. oblegovalnih naprav::build.php?gid=21');
	bookmarks.push('Izdelovalec orožja::build.php?gid=12');
      	bookmarks.push('Izdelovalec oklepov::build.php?gid=13');
      //bookmarks.push('Akademija::build.php?gid=22');	
      //bookmarks.push('Opekarna::build.php?gid=6');
      //bookmarks.push('Ambasada::build.php?gid=18');
      //bookmarks.push('Mlin::build.php?gid=8');
      //bookmarks.push('Talilnica železa::build.php?gid=5');
      //bookmarks.push('Žitnica::build.php?gid=11');
      //bookmarks.push('Herojeva rezidenca::build.php?gid=37');
      //bookmarks.push('Gradbeni ceh::build.php?gid=15');
      //bookmarks.push('Tržnica::build.php?gid=17');
      //bookmarks.push('Palača::build.php?gid=26');
      //bookmarks.push('Zbirališče::build.php?gid=16');
      //bookmarks.push('Rezidenca::build.php?gid=25');
      //bookmarks.push('Žaga::build.php?gid=7');
      //bookmarks.push('Mestna Hiša::build.php?gid=24');
      //bookmarks.push('Skladišče::build.php?gid=10');
      //bookmarks.push('Vadbišče::build.php?gid=20');
      //bookmarks.push('Kulturne točke::build.php?gid=25&s=2');
	...
	function cityLinks(){
		...
		if (find("//img[contains(@src, 'travian1.gif')]", XPFirst)) //if Plus, then...
		{
			...
			var foo = '<TD><a href="dorf3.php"><span class="f10 c0 s7 b">Naselbine\n</span></a></TD><TD><a href="dorf3.php?s=2"><span class="f10 c0 s7 b">Surovine\n</span></a></TD><TD><a href="dorf3.php?s=3"><span class="f10 c0 s7 b">Skladišče\n</span></a></TD><TD><a href="dorf3.php?s=4"><span class="f10 c0 s7 b">KT\n</span></a></TD><TD><a href="dorf3.php?s=5"><span class="f10 c0 s7 b">Enote\n</span></a></TD>';	
		...
		for (var i = 0; i < cities.childNodes.length; i++){
			...
			city.appendChild(elem("TD", "<a href='a2b.php?z=" + id + "&dname="+cityname+"'><img src='data:image/gif;base64," + imagenes["def2"] + "' width='12' border='0' title='Pošlji okrepitve'></a>"));
			...
			if(location.href.match(/build.php\?(.*)gid=17/))  { //# TMR if we're on the marketplace, populate X,Y coordinate with village's
			  ...
			  city.appendChild(elem("TD", "<a href='build.php?newdid="+ newdid +"&z=" + currentCityID + "&gid=17&dname="+cityname+"' title='Tržnica'>T</a>"));
			city.appendChild(elem("TD", "<a href='dorf1.php?newdid=" + newdid + "' title='Pregled naselbine'>P</a>"));
			city.appendChild(elem("TD", "<a href='dorf2.php?newdid=" + newdid + "' title='Center naselja'>N</a>"));
			if(location.href.match(/karte.php/))  { //# TMR if we're on the map, populate X,Y coordinate with village's
			  ...
			  city.appendChild(elem("TD", "<a accesskey="+(i+1)+" href='javascript:void(0);' onclick="+findstr+" title='Center Map - Populate X,Y'>Z</a>"));
			}
			else  {
  		  city.appendChild(elem("TD", "<a href='karte.php?newdid=" + newdid + "' title='Zemljevid'>Z</a>"));
  		}
