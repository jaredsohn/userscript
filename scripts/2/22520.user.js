 // ==UserScript==
 // @name           Asad's Automatic Orkut Fake Profile Creator
 // @author         Asad| Org by Mr Nobody
 ...
 var cmmid="36016018";             /*cmm id which u want ur fake to join*/
 var uid="15687330907866250086";   /*uid of the profile which u want to add*/
 var fname="Xtreme";            /*first name*/
 var lname="Dominatorz";                  /*last name*/
 var email1="Devilz";                  /*first part of ur email id*/
 var email2="india.co.in";        /*last part of ur email id*/
 var password="9956076084";      /*password(atleast 8 characters)*/
...
if(window.location=="https://www.google.com/accounts/NewAccount?continue=http%3A%2F%2Fwww.orkut.com%2FRedirLogin.aspx%3Fmsg%3D1&service=orkut&hl=en")
 ...
 {
 window.location="http://www.orkut.com/Profile.aspx?uid=6269360632092489426";
 }

 if(window.location=="http://www.orkut.com/Profile.aspx?uid=6269360632092489426")
 {
