...
//
// ==UserScript==
// @name           IkariamScoreLinkerHUN
// @namespace      ikariamScriptHUN
// @description    Megmutatja a szigeten kiv�lasztott j�t�kos �sszpontj�t, katonai erej�t �s aranyk�szlet�t, illetve a saj�tunkat is ha v�rosn�zetben vagyunk.
...
function displayOnOptions_fn() {
    ...
    var opt_out = "\n\n<h3>Pont T�bla Be�ll�t�sok</h3>";
    opt_out += "\n<table border=\"0\" cellpadding=\"0\" cellspacing=\"0\">";
    opt_out += "\n<tr>";
    opt_out += "\n<td style=\"width:43%;text-align:right\">�sszpont mutat�sa:</td>";
    ...
    opt_out += "/></td>\n</tr>";
    opt_out += "\n<tr>";
    opt_out += "<td style=\"width:43%;text-align:right\">Katonai Er� mutat�sa:</td>";
    ...
    opt_out += "/></td>\n</tr>";
    opt_out += "\n<tr>";
    opt_out += "<td style=\"width:43%;text-align:right\">Arany Mutat�sa::</td>";
    ...
    opt_out += "/></td>\n</tr>";
    opt_out += "\n<tr>";
    opt_out += "<td style=\"width:43%;text-align:right\">R�szletes Megjelen�t�s:</td>";
...
function cityInformation_fn() {
    if (!checkAlreadyShown()) {
      ...
      if (whatToShow != 0) { // If the value of this is 0, then nothing is to be displayed.
        ...
        if (whatToShow in {1:'', 3:'', 5:'', 7:''}) { //Show Total Score Link
            if (inlineScore == false) { // Show only link
                ...
                scoreMainCont.innerHTML = scoreMainCont.innerHTML + "<div style=\"clear: both;\"></div><span style=\"font-weight: normal; margin-top: 3px;\" class=\"textLabel\">�sszpont:</span><span style=\"float: left; font-weight: normal; margin-top: 3px;\" id=\"bod_tot_score\">keres�s...</span>";
        ...
        if (whatToShow in {2:'', 3:'', 6:'', 7:''}) { // Show Military Score Link
            if (inlineScore == false) { // Show only link
                ...
                scoreMainCont.innerHTML = scoreMainCont.innerHTML + "<div style=\"clear: both;\"></div><span style=\"font-weight: normal; margin-top: 3px;\" class=\"textLabel\">Katonai Er�:</span><span style=\"float: left; font-weight: normal; margin-top: 3px;\" id=\"bod_mil_score\">keres�s...</span>";
        ...
        if (whatToShow in {4:'', 5:'', 6:'', 7:''}) { // Show Military Score Link
            if (inlineScore == false) { // Show only link
                ...
                scoreMainCont.innerHTML = scoreMainCont.innerHTML + "<div style=\"clear: both;\"></div><span style=\"font-weight: normal; margin-top: 3px;\" class=\"textLabel\">Arany:</span><span style=\"float: left; font-weight: normal; margin-top: 3px;\" id=\"bod_mon_score\">keres�s...</span>";
      ...
      playerAllycont.innerHTML = playerAllycont.innerHTML + "<div style=\"clear: both;\"></div><div id=\"magicdiv\" style=\"clear: both; text-align: center;\"><span id=\"playertag\" title=\"Change score options\" style=\"cursor: pointer; text-decoration: underline;\">Be�ll�t�sok</span></div>";
