...
// @description    This script makes training on Hobowars easier by adding a solve function and auto train to the university. Currently tested for Facebook version. Enjoy!
// @author         Xyan Flux
// @version        1.0.3
...
var auto = 0; //0=disabled, 1=enabled;
...
function solve() {
	...
	for(var i=0;i<16;++i){
		if(imgs[i].src.match(".*green.gif")){
			dots[i]=2;
		}else if(imgs[i].src.match(".*yellow.gif")){
			dots[i]=1;
		}
	}
