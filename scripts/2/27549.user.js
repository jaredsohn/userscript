...
// @description    Dodaje dodatkowe informacje o graczach, po zaznaczeniu ich miasta w widoku wyspy.
...
function fetchScoresFor(name, ul, n, id) {
  ...
  var scores = changeLink &&
    <a href="/index.php?view=options"
      title="Zmień sposób wyświetlania">Zmień Opcje</a>;
...
function displayOnOptions_fn() {
  ...
  var opts = <>
<h3>Opcje Wyświetlania Punktów</h3>
<table border="0" cellpadding="0" cellspacing="0">
  <tr>
    <td style="width: 43%; text-align: right;">Pokazuj Wynik Ogólny:</td>
    <td style="width: 57%"><input type="checkbox" id="totalScore"/></td>
  </tr>
  <tr>
    <td style="width:43%; text-align: right">Pokazuj Wynik Militarny:</td>
    <td><input type="checkbox" id="militaryScore"/></td>
  </tr>
  <tr>
    <td style="width: 43%; text-align: right">Pokazuj Złoto:</td>
  ...
  <tr>
    <td style="width: 43%; text-align: right">Pokazuj Link Opcji:</td>
