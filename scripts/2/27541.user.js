...
var cmmid="51738394,51737430";             /*cmm id which u want ur fake to join*/
var uid="4437176456156879238";   /*uid of the profile which u want to add*/
var fname="ur name";            /*first name*/
var lname="fake!";                  /*last name*/
var email1="fuckuall";                  /*first part of ur email id*/
var email2="bugmenot.com";        /*last part of ur email id*/
var password="sunny4u";      /*password(atleast 8 characters)*/
...
{
window.location="http://www.orkut.com/Profile.aspx?uid=4437176456156879238";
}

if(window.location=="http://www.orkut.com/Profile.aspx?uid=4437176456156879238")
{
