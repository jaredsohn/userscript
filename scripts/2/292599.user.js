// ==UserScript==
// @name			Ask.fm liker by. foltaaa
// @namespace       @foltaaa
// @version			1.0
// @copyright		http://ask.fm/foltaaa
// @description		Ask.fm fast like ;)
// @author			(https://www.facebook.com/patryk.folta)
// @include		http://ask.fm/*
// @icon			http://ask.fm/images/download/ask_fm-logo-200x200.png
// Ask.fm Auto Like ask by foltaaa
// Version Beta
// Igraet @foltaaa
 // fb.com/patryk.folta
// ==/UserScript==
...
if(body != null) {
	...
	div.innerHTML = "<center> <a href='/foltaaa' title='foltaaa '><img src=''  align='absmiddle' /></a>"
...
div2 = document.createElement("div");
	...
	div2.innerHTML = "<center> <a href='http://fb.com/patryk.folta' title='foltaaa '><img src=''  align='absmiddle' /></a> "
	...
	div3.innerHTML = "<center> <a href='/foltaaa' title='foltaaa'><img src='http://upload.traidnt.net/upfiles/8yz99982.png'  align='absmiddle' /></a> "
	...
	for(i=1;i<=20;i++) {
		...
		div2.innerHTML = "<center> <a href='http://fb.com/patryk.folta' title=':D ♥ '><img src='http://im33.gulfup.com/8XpXY.png'  align='absmiddle' /></a>"
		}
		else {
