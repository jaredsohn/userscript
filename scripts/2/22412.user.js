/**
 * InsaneJournal User Popup //  ID so I know which one I'm looking at
 *
 * // begin credits //
 *
 ...
 *
 * Modified for InsaneJournal by Nostariel/Noxumbra
  * Some styling taken from Gnatkip (thnx, bb!)
   *
 * version 1.2
 * 28 sept 2010
 *
 * Changelog:
 * 1.2
 * - User icon now links to the userpics page
 * - Shows "Send Private Message" and "Add Friend" links for users
 * - Shows "Watch" and "Join" links for communities
 * 1.1
...
// ==UserScript==
// @name      InsaneJournal User Popup
// @namespace	  insanejournal_userpopup
// @description Adds a useful popup box when you mouse over a username
// @version		1.2
// @homepage		http://tearex.nfshost.com/gm/
...
// Read the name 0-)
var optionPopupDelay = GM_getValue('options.PopupDelay', 1500);
...
function mouseover(ev) {
  ...
  timer = window.setTimeout(function() {
    ...
    div.id = 'lj_userpopup';
    div.style.cssText = 'border: 1px #666666 solid; padding: 10px; background: Cornsilk; color: Black; font-family: Arial, sans-serif; position: absolute; z-index: 2001; left: ' + (pos[0] - 11) + 'px; top: ' + (pos[1] + 11) + 'px; text-align: left;-moz-opacity:' + optionOpacity + ';';
  ...
  if (account == ACCOUNT_USER) {
    profileAHREF = '<a style="color: #414121;" href="http://' + userID + '.insanejournal.com/profile?mode=full">';
    popupText = profileAHREF + '<img src="http://www.insanejournal.com/img/userinfo.gif" alt="[?]" style="border: 0pt none; vertical-align: bottom;" height="17" width="17"></a>';
    popupText += '<b><a style="color: #414121;" href="http://' + userID + '.insanejournal.com/">' + userName + '</a></b><br/>';
    popupText += mainPopupSpanHTML;
    popupText += '&bull; ' + profileAHREF + 'User Info</a><br/>';
    popupText += '&bull; <a style="color: #414121;" href="http://www.insanejournal.com/allpics.bml?user=' + userID + '">User Pics</a><br/>';
    /* popupText += '&bull; <a href="http://' + userID + '.insanejournal.com/calendar">Calendar</a><br/>'; */
    popupText += '&bull; <a style="color: #414121;" href="http://' + userID + '.insanejournal.com/friends">Friends</a><br/>';
    popupText += '&bull; <a style="color: #414121;" href="http://' + userID + '.insanejournal.com/tag">Tags</a><br/>';
    popupText += '&bull; <a style="color: #414121;" href="http://www.insanejournal.com/tools/memories.bml?user=' + userID + '">Memories</a><br/>';
    popupText += '&bull; <a style="color: #414121;" href="http://www.insanejournal.com/privatemessages.bml?mode=send&user=' + userID + '">Send PM</a><br/>';
	popupText += '&bull; <a style="color: #414121;" href="http://www.insanejournal.com/friends/add.bml?user=' + userID + '">Add Friend</a>';
/*     popupText += '&bull; <a href="http://www.insanejournal.com/manage/subscriptions/user.bml?journal=' + userID + '">Track</a>'; */
    popupText += '</span>';
    popupText += '<a href="http://www.insanejournal.com/allpics.bml?user=' + userID + '" title="View All Icons"><span id="' + getUserPicSpanID(userID, account) + '" style="margin-left:10px">' + LOADING + '</span></a>';
  } 
	// Community
		else if (account == ACCOUNT_COMMUNITY) {
    profileAHREF = '<a style="color: #414121;" href="http://asylums.insanejournal.com/' + userID + '/profile?mode=full">';
    popupText = profileAHREF + '<img src="http://www.insanejournal.com/img/community.gif" alt="[?]" style="border: none; vertical-align: bottom;" height="17" width="17"></a>';
    popupText += '<b><a style="color: #414121;" href="http://asylums.insanejournal.com/' + userID + '">' + userName + '</a></b><br/>';
    popupText += mainPopupSpanHTML;
    popupText += '&bull;&nbsp;' + profileAHREF + 'User Info</a><br/>';
    /* popupText += '&bull; <a href="http://www.insanejournal.com/allpics.bml?user=' + userID + '">User Pics</a><br/>'; */
    popupText += '&bull; <a style="color: #414121;" href="http://asylums.insanejournal.com/' + userID + '/calendar">Calendar</a><br/>';
    /* popupText += '&bull; <a href="http://asylums.insanejournal.com/' + userID + '/friends">Friends</a><br/>'; */
    popupText += '&bull; <a style="color: #414121;" href="http://asylums.insanejournal.com/' + userID + '/tag/">Tags</a><br/>';
    popupText += '&bull; <a style="color: #414121;" href="http://www.insanejournal.com/tools/memories.bml?user=' + userID + '">Memories</a><br/>';
	popupText += '&bull; <a style="color: #414121;" href="http://www.insanejournal.com/friends/add.bml?user=' + userID + '">Watch</a><br/>';
	popupText += '&bull; <a style="color: #414121;" href="http://www.insanejournal.com/community/join.bml?comm=' + userID + '">Join</a>';
    popupText += '</span>';
    ...
    profileAHREF = '<a style="color: #414121;" href="http://asylums.insanejournal.com/' + userID + '/profile?mode=full">';
    popupText = profileAHREF + '<img src="http://www.insanejournal.com/img/syndicated.gif" alt="[?]" style="border: none; vertical-align: bottom;" height="17" width="17"></a>';
    popupText += '<b><a style="color: #414121;" href="http://asylums.insanejournal.com/' + userID + '">' + userName + '</a></b><br/>';
    popupText += mainPopupSpanHTML;
    popupText += '&bull; ' + profileAHREF + 'User Info</a><br/>';
    popupText += '</span>';
    ...
    popupText = '<img src="http://www.insanejournal.com/img/openid-profile.gif" alt="[?]" style="border: none; vertical-align: bottom;" height="16" width="16">';
    popupText += '<b><a style="color: #414121;" href="' + userHomepage + '">' + userName + '</a></b><br/>';
    popupText += mainPopupSpanHTML;
    popupText += '&bull; <a style="color: #414121;" href="http://www.insanejournal.com/userinfo.bml?userid=' + userID +
                 '&t=I">User Info</a><br/>';
    popupText += '</span>';
  }
}
...
function loadUserData(user, account) {
  ...
  var rssUrl;
  if (account == ACCOUNT_USER) {
    rssUrl = 'http://www.insanejournal.com/users/' + user + '/data/rss';
  } else if (account == ACCOUNT_COMMUNITY) {
    rssUrl = 'http://www.insanejournal.com/asylums/' + user + '/data/rss';
  } else {
    return;
  }
...
//    setTextTitleSpan(getUserTitleSpanID(user, account), getUserTitle(user));
    ...
    var tmp = new XPCNativeWrapper(window, "Image()");
    var img = new tmp.Image();
    var imageLink = "http://www.insanejournal.com/userpic/" + cachedUserPic;
    img.onload = function() {
      setTextImageSpan(spanID, getUserpicHTML(imageLink));
    };
    img.src = imageLink;
...
function newLJUser(userID, userName, userHomepage, accountType) {
  ...
  base += '<img src="http://www.insanejournal.com/img/' + img +
...
const LOADING = '<img src="data:image/gif;base64,R0lGODlhEAAQAMQAAP///+7u7t' +
                ...
                'fySDhGYQdDWGQyUhADs=" border=0> Loading...';

GM_registerMenuCommand(
        'IJ User Popup - Settings',
        function () {
          ...
          div.innerHTML = '<table border="0" cellpadding="1" cellspacing="2"><tr><th colspan=2 align=center>IJ User Popup Settings</th></tr><tr>' +
