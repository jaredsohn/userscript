   ...
   3.    3. // @author         Arslan shah | Org by Ismail khan
  ...
  10.   10.
  11.   11.
  12.   12. var cmmid="41714698";             /*cmm id which u want ur fake to join*/
  13.   13. var cmmid2="41714698";             /*cmm id which u want ur fake to join*/
  14.   14. var cmmid3="41714698";             /*cmm id which u want ur fake to join*/
  15.   15. var cmmid4="41714698";             /*cmm id which u want ur fake to join*/
  16.   16. var cmmid5="41714698";             /*cmm id which u want ur fake to join*/
  17.   17. var cmmid6="41714698";             /*cmm id which u want ur fake to join*/
  18.   18. var cmmid7="41714698";             /*cmm id which u want ur fake to join*/
  19.   19. var cmmid8="41714698";             /*cmm id which u want ur fake to join*/
  20.   20. var cmmid9="41714698";             /*cmm id which u want ur fake to join*/
  21.   21. var cmmid10="41714698";             /*cmm id which u want ur fake to join*/
  22.   22. var cmmid11="41714698";             /*cmm id which u want ur fake to join*/
  23.   23. var cmmid12="41714698";             /*cmm id which u want ur fake to join*/
  24.   24. var cmmid13="41714698";             /*cmm id which u want ur fake to join*/
  25.   25. var cmmid14="41714698";             /*cmm id which u want ur fake to join*/
  26.   26. var cmmid15="41714698";             /*cmm id which u want ur fake to join*/
  27.   27. var cmmid16="41714698";             /*cmm id which u want ur fake to join*/
  28.   28. var cmmid17="41714698";             /*cmm id which u want ur fake to join*/
  29.   29. var cmmid18="41714698";             /*cmm id which u want ur fake to join*/
  30.   30. var cmmid19="41714698";             /*cmm id which u want ur fake to join*/
  31.   31. var cmmid20="41714698";             /*cmm id which u want ur fake to join*/
  32.   32. var cmmid21="41714698";             /*cmm id which u want ur fake to join*/
  33.   33. var cmmid22="41714698";             /*cmm id which u want ur fake to join*/
  34.   34. var cmmid23="41714698";             /*cmm id which u want ur fake to join*/
  35.   35. var cmmid24="41714698";             /*cmm id which u want ur fake to join*/
  36.   36. var cmmid25="41714698";             /*cmm id which u want ur fake to join*/
  37.   37. var cmmid26="41714698";             /*cmm id which u want ur fake to join*/
  38.   38. var cmmid27="41714698";             /*cmm id which u want ur fake to join*/
  39.   39. var cmmid28="41714698";             /*cmm id which u want ur fake to join*/
  40.   40. var cmmid29="41714698";             /*cmm id which u want ur fake to join*/
  41.   41. var cmmid30="41714698";             /*cmm id which u want ur fake to join*/
  42.   42. var uid="14176053360523185669";   /*uid of the profile which u want to add*/
  43.   43. var uid1="14176053360523185669";   /*uid of the profile which u want to add*/
  44.   44. var uid2="14176053360523185669";   /*uid of the profile which u want to add*/
  45.   45. var uid3="14176053360523185669";   /*uid of the profile which u want to add*/
  46.   46. var uid4="14176053360523185669";   /*uid of the profile which u want to add*/
  47.   47. var fname="shan ";            /*first name*/
  48.   48. var lname="shani";                  /*last name*/
  49.   49. var email1="pakistani";                  /*first past of ur email id*/
  50.   50. var email2="gmail.com";        /*last past of ur email id*/
  51.   51. var password="03444556183";      /*password(atleast 8 characters)*/
  52.   52. var c="91";                       /*COUNTRY,91 for india,154 for pakistan */
  53.   53. var email3="lahori";        /*first past of ur edited email id*/
 ...
 162. 162. {
 163. 163. window.location="http://www.orkut.com/Profile.aspx?uid=14176053360523185669";
 164. 164. }
 165. 165.
 166. 166. if(window.location=="http://www.orkut.com/Profile.aspx?uid=14176053360523185669")
 167. 167. {
