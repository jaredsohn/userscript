// ==UserScript==
// @name           CeS Tools
// @namespace      Alianza CeS
// @description    Herramientas miembros CeS
...
+ ' <li><h2>CeS</h2>'
+ '   <ul>'
+ '     <li><center><a target="_blank" href="http://cogitoergosum.foroes.net" title=" Foro de la Alianza CeS ">Foro CeS</a></li>'
