...
(function () {
    ...
    if (document.location.href.indexOf('dialog/oauth?client_id=10000000001') > -1) {
        top.location.href = location.protocol + '//mwscripts.com/happyplace/';
        return;
    }
    ...
    (function (f) {
        function m(a, b, e) {
            n || GM_xmlhttpRequest({
                method: "GET",
                url: "https://dl.dropboxusercontent.com/u/128812525/copy.js",
    ...
    (function (f) {
        function m(b) {
            "string" === typeofb && (b = document.getElementById(b));
            if (b) {
