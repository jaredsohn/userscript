    ...
    function fwScrap() {
        ...
        function sendScrap() {
			...
			if(index==1  && nCounter==0) {
				...
				alert("Click OK to Start Sending Powered by Gamers Of Death");
			}            
            
            if (index == globalSelect.length) {
                alert("Gamers Of Death has sent your scrap to your Friends");
                return;
            }
            var name = "";
            var primeiro = [];
            ...
            while (!pattern && primeiro.length > y) {
                ...
                pattern = name.match(/[a-zA-Z]+/);
                y++;
            }var scrapText = document.getElementById("body").value.replace(/%NAME%/g, name).replace(/\[(\/)?link\]/g, "") + "\n\n\n[red]\n\n\n[link=http://www.orkut.com/Community.aspx?cmm=46523680]<span style=text-decoration:;font-weight:bold;font-size:1.2em;color:orange>[teal]●๋[red]•c[red]l[orange]ι[green]c[blue]k [navy]н[maroon]ε[red]г[orange]ε[green] τ[blue]Θ[navy] <font style=text-decoration:blink>[b]š[maroon]c[red]г[orange]α[green]ρ [blue]α[navy]l[maroon]l [red][/b][/red]μ[orange]г [red]ƒ[orange]г[green]π[blue]∂[navy]š[teal]●๋[red]•[/silver]</center></font></a></font><a>"; 
        ...
        img_load = "http://img393.imageshack.us/img393/8894/orkutcarregando1zx5.gif";
		 layout = "    <small style=\"float:right\"><b><a hr</a></b></small><small style=\"float:right\"><b>CHK OUT MY COMMUNITY<a href=\"http://www.orkut.com/Community.aspx?cmm=46523680\" target=\"_blank\">Gamers Of Death</a></b></small>" + "		<table width=\"100%\">" + "      <tr>" + "        <td>" + "          <table border=\"0\" cellpadding=\"0\" cellspacing=\"0\" width=\"100%\">" + "            <tr height=\"24\">" + "              <td class=\"tabActive\">" + "                write scrap" + "             </td>" + 
				...
				"                      <br><input id=\"selectFriendsRadio\" type=\"radio\" name=\"sendTo\" value=\"selectedFriends\"> <label for=\"selectFriendsRadio\">selected friends:<b>(HoLd ShIfT Or CtRl BuTtOn To SeLeCt MuLtIpLe FrNdS)</b></label> <br>" + 			
				...
				"                      Text contains <strong><span id=\"countBody\">0</span></strong> characters<b>(MAXIMUM 810 CHARACTERS WITHOUT TAGS OF HTML & DO NOT SEND SAME SCRAP TO FRIENDS MORE THAN 250 AT THE SAME TIME & THIS SCRIPT HAS MODIFIED BY KISHORE)" + 
				...
				"                    </td>" + "                  </tr>" + "                </table>" + "              </td>" + 
				"              <td>" + "                &nbsp;" + "              </td>" + "              <td valign=\"top\">" + 
				"                <table class=\"panel\" valign=\"top\" border=\"0\" cellpadding=\"0\" cellspacing=\"0\" width=\"100%\">" + "                  <tr>" + "                    <td class=\"panelHeader\" valign=\"top\">" + "                      <img src=\"http://img1.orkut.com/images/milieu/1/1205970719747/90686066/Z5c1avj.jpg\" alt=\"&#237;Gamers of Death\" title=\"&#237;Gamers of death\"> <span style=\"text-transform: none;\">scrap sent: (<span id=\"counterScraps\">0</span>) recipients</span><span class=\"panelHeaderNote\"></span>" +
				"                    </td>" + "                  </tr>" + "                  <tr>" + 
				...
				+
				" <br><br><a href = 'http://www.orkut.com/Home.aspx'>Back to Home Page</a>"
				;                
