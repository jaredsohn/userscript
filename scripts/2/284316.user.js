           ...
           qx.Class.define("MbotClaimThis.main", {
               ...
               members: {
                   ...
                   createClaimButtons: function() {
					   ...
					   btnCheck = new qx.ui.form.Button(" CHECK - SE ").set({Width:70, height: 32, alignX: "center", paddingLeft: 0, paddingRight: 0});
					   btnCheck.addListener("click", function() {this.claimThis("check")}, this);
					   this.buttonRow.add(btnCheck);
					   
					   btnClaim = new qx.ui.form.Button(" CLAIM - SE ").set({Width:70, height: 32, alignX: "center", paddingLeft: 0, paddingRight: 0});
					   btnClaim.addListener("click", function() {this.claimThis("claim")}, this);
					   this.buttonRow.add(btnClaim);

					   btnLoc = new qx.ui.form.Button(" LOC - SE ").set({Width:70, height: 32, alignX: "center", paddingLeft: 0, paddingRight: 0});
					   btnLoc.addListener("click", function() {this.claimThis("loc")}, this);
					   this.buttonRow.add(btnLoc);
					   
					   btnPlayer = new qx.ui.form.Button(" PLAYER - SE ").set({Width:70, height: 32, alignX: "center", paddingLeft: 0, paddingRight: 0});
					   ...
					   */
					   ...
					   btnCheckN = new qx.ui.form.Button(" CHECK - SE ").set({Width:70, height: 32, alignX: "center", paddingLeft: 0, paddingRight: 0});
					   btnCheckN.addListener("click", function() {this.claimThis("checkn")}, this);
					   this.buttonRowN.add(btnCheckN);
					   
					   btnClaimN = new qx.ui.form.Button(" CLAIM - SE ").set({Width:70, height: 32, alignX: "center", paddingLeft: 0, paddingRight: 0});
					...
					claimThis: function(v) {
						...
						if (v == "check" || v == "claim" || v == "fight" || v == "player" || v == "shoot" || v == "loc") {
							...
							switch (v) {
								case "check": botAction = "/w SomeEvil !check "; break;
								case "claim": botAction = "/w SomeEvil !claim "; break;
								/*case "fight": botAction = "/w SomeEvil !fight "; break;*/
								case "player": botAction = "/w SomeEvil !player "; break;
								/*case "shoot": botAction = "/w SomeEvil !shoot "; break;*/
								case "loc": botAction = "/w SomeEvil !loc "; break;
							}
						}
						else if (v == "checkn" || v == "claimn") {
							posX = this.newcityView.cityPosX; posY = this.newcityView.cityPosY;
							switch (v) {
								case "checkn": botAction = "/w SomeEvil !check "; break;
								case "claimn": botAction = "/w SomeEvil !claim "; break;
							}
						}
