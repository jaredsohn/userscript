  ...
  */
	...
	*/ 
    ...
    if(showbookmarks==true || showbookmarks == null) {
      ...
      bookmarks.push('Akadémia::build.php?gid=22');
      bookmarks.push('Páncélkovács::build.php?gid=13');
      bookmarks.push('Kaszárnya::build.php?gid=19');
      bookmarks.push('Fegyverkovács::build.php?gid=12');
      ...
      bookmarks.push('Hősök háza::build.php?gid=37');
      //bookmarks.push('Main Building::build.php?gid=15');
      bookmarks.push('Piac::build.php?gid=17');
      bookmarks.push('Palota::build.php?gid=26');
      bookmarks.push('Gyülekezőtér::build.php?gid=16');
      bookmarks.push('Rezidencia::build.php?gid=25');
      //bookmarks.push('Sawmill::build.php?gid=7');
      bookmarks.push('Műhely::build.php?gid=21');
      bookmarks.push('Istálló::build.php?gid=20');
      bookmarks.push('Tanácsháza::build.php?gid=24');
