...
// @name           OCBsTools
// @namespace      ikatips
// @description    Herraminetas para la alianza OCBs
// @include        http://*ikariam.*/index.php*
// @author         Original por Verx - Modificado por alkan para IKOS - Modificado por Lukas11 para OCBs
...
+ ' <li><h2>OCBs</h2>'
+ '   <ul>'
+ '     <li><center><a target="_blank" href="http://www.cuentame-ikariam.uni.cc" title=" Foro de la Alianza Cuéntame ">Foro OCBs</a></li>'
