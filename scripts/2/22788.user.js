// ==UserScript==
// @name            ogame kesif-bulma - Language: turkce
// @description     hangi gemiler kesifte hangi gemileri getirebilir..ogame-world.com sim. direkt link
// @author          MrMage
...
if (document.URL.indexOf("game/index.php") > -1)
{
	...
	for (var i = 0; i < as.length; i ++)
	{
			...
			cur_a.parentNode.parentNode.tagName == 'DIV' && cur_a.parentNode.parentNode.parentNode.tagName == 'TD')
		{
			...
			drago_td.innerHTML = '<div align="center"><font color="#FF0000"><a target="_blank" href="http://www.ogame-world.com/calculators.php?link=expeditions" style="color: red">Kesif-Bulma</a></font></div>';
