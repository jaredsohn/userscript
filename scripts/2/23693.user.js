...
// 00) Imagen del titulo de la tabla
			ali_td.innerHTML = '<div align="center"><img src="http://usuarios.lycos.es/mnemonic/public/menuenhanced/alianza.png" height="19" width="110"></a></div>\n';
...
//las imagenes tambien las pueden cambiar por alguna que hagan ustedes, las que yo puse, son bien feas para que les de ganas de hacer las suyas, lo que si les reomiendo hacerlas bien livianas para que se carguen rapido
			ali_td1.innerHTML = '<div><a href="index.php?page=allianzen&session=' + Session + '&a=4&sort1=3&sort2=1" title="Lista de miembros ordenada" alt="Lista de miembros ordenada"><img src="http://usuarios.lycos.es/mnemonic/public/menuenhanced/miembros.png" height="19" width="55"></a><a href="index.php?page=allianzen&session=' + Session + '&a=17" title="Enviar CC" alt="Enviar CC"><img src="http://usuarios.lycos.es/mnemonic/public/menuenhanced/enviarcc.png" height="19" width="55"></a></div>\n';
...
//los valores de "title" y de "alt" cuando los editen ponganles a ambos el mismo valor porque de lo contrario no se muestra el infotip
//las imagenes tambien las pueden cambiar por alguna que hagan ustedes, las que yo puse, son bien feas para que les de ganas de hacer las suyas, lo que si les reomiendo hacerlas bien livianas para que se carguen rapido
			ali_td2.innerHTML = '<div><a href="index.php?page=statistics&session=' + Session + '&start=1&who=ally" title="Top de alianzas" alt="Top de alianzas"><img src="http://usuarios.lycos.es/mnemonic/public/menuenhanced/topali.png" height="19" width="55"></a><a href="index.php?page=infos&session=' + Session + '&gid=43" title="Salto Cuantico" alt="Salto Cuantico"><img src="http://usuarios.lycos.es/mnemonic/public/menuenhanced/saltocuantico.png" height="19" width="55"></a></div>\n';
...
//los valores de "title" y de "alt" cuando los editen ponganles a ambos el mismo valor porque de lo contrario no se muestra el infotip
//las imagenes tambien las pueden cambiar por alguna que hagan ustedes, las que yo puse, son bien feas para que les de ganas de hacer las suyas, lo que si les reomiendo hacerlas bien livianas para que se carguen rapido
			ali_td3.innerHTML = '<div><a target="_blank" href="http://' + ServerName + '/game/pranger.php?from=00" title="Pranger UNI ' + Universe + '" alt="Pranger UNI ' + Universe + '"><img src="http://usuarios.lycos.es/mnemonic/public/menuenhanced/pranger.png" height="19" width="55"></a><a target="_blank" href="http://es.oticket.org/" title="O Tickets" alt="O Tickets"><img src="http://usuarios.lycos.es/mnemonic/public/menuenhanced/otickets.png" height="19" width="55"></a></div>\n';
			ali_tr3.appendChild(ali_td3);
			menu_table.appendChild(ali_tr3);

// 07) Foro de la alianza  alianza + 08) Galaxytool alianza
//aca le pueden cambiar las URL por la del foro y del galaxytool de su alianza.
//los valores de "title" y de "alt" cuando los editen ponganles a ambos el mismo valor porque de lo contrario no se muestra el infotip
//las imagenes tambien las pueden cambiar por alguna que hagan ustedes, las que yo puse, son bien feas para que les de ganas de hacer las suyas, lo que si les reomiendo hacerlas bien livianas para que se carguen rapido
			ali_td4.innerHTML = '<div><a target="_blank" href="http://forodetualianza.com/index.php" title="Foro alianza" alt="Foro alianza"><img src="http://usuarios.lycos.es/mnemonic/public/menuenhanced/foroali.png" height="19" width="55"></a><a target="_blank" href="http://galaxytooldetualianza/index.php" title="GalaxyTool alianza" alt="GalaxyTool alianza"><img src="http://usuarios.lycos.es/mnemonic/public/menuenhanced/gtoolali.png" height="19" width="55"></a></div>\n';
...
//los valores de "title" y de "alt" cuando los editen ponganles a ambos el mismo valor porque de lo contrario no se muestra el infotip
//las imagenes tambien las pueden cambiar por alguna que hagan ustedes, las que yo puse, son bien feas para que les de ganas de hacer las suyas, lo que si les reomiendo hacerlas bien livianas para que se carguen rapido
			ali_td5.innerHTML = '<div><a target="_blank" href="http://websim.speedsim.net/" title="SpeedSim Online" alt="SpeedSim Online"><img src="http://usuarios.lycos.es/mnemonic/public/menuenhanced/speedsimonline.png" height="19" width="55"></a><a target="_blank" href="http://www.toolsforogame.com/comercio/calculadoracomercio.aspx?idi=es-es#down" title="Calculadora de comercio" alt="Calculadora de comercio"><img src="http://usuarios.lycos.es/mnemonic/public/menuenhanced/calccomercio.png" height="19" width="55"></a></div>\n';
