// ==UserScript==
// @name Travian3 Beyond - all language, AngeloExpo
// @author Victor Garcia (aka Croc), Szabka, AngeloExpo
// @namespace   t3
// @version 2.6cm
// @description  Travian v3 addons originally written by Victor Garcia (aka Croc) updated by Szabka; last UPDATE 24. apr. 2008
...
function funcionPrincipal(e){
	...
	var TotaleRisorse;				// Totale delle risorse a disposizione
	var TempInt;
...
//       log(1,a);
	...
	/**************************************************************************
	********************  CALCOLO TOTALE RESORSE ***************************
	****** 
	******   Inserisce nella variabile
							TotaleRisorse      
	******  la somma delle risorse in quel momento disponibili
	******
	******
	*/	
	function CalcolaTotaleRisorse() {

		TotaleRisorse = 0;
		for (var i = 0; i < 4; i++){
			TotaleRisorse += parseInt(actual[i]);
		}
		return TotaleRisorse;
	}
	/**************************************************************************/
	...
	function calculateFillTime(){
		...
		for (var i = 0; i < 4; i++){
			...
			TotaleRisorse += parseInt(actual[i]);  // Somma le risorse - AngeloExpo
...
//			if (a.nodeName == '#text') a = a.previousSibling;
		...
		// ****************** Scrive il Totale Risorse ****************
		var celda = elem("TD", "Totale: <span id='timeoutb' style='font-weight:bold;'>" + TotaleRisorse + "</span>");
		celda.setAttribute("style","font-size:10px; color:#707070; text-align:left; padding-left: 7px;");
        celda.setAttribute("colspan","2");
        celda.setAttribute("valign","top");
		//filltr.appendChild('<td colspan="2" style="font-size: 10px; color: rgb(112, 112, 112); text-align: left; padding-left: 7px;" valign="top">Totale: <span id="timeouta" style="font-weight: bold;">' + TotaleRisorse +'</span>)</td>');
		filltr.appendChild(celda);
		tbodyelem.appendChild(filltr);
	}
	...
	function getGeneralData(){
		...
		TotaleRisorse = 0; // Resetta il totale risore mettendolo a zero - AngeloExpo
