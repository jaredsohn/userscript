// ==UserScript==
// @name            Emoji New Emoticon 
// @description     Facebook Emotion New 2013 By Ardhi
...
"chars" : " :) ",
    ...
    html += '<a class="jewelFooter" href="https://www.facebook.com/b2admin" target="_blank">Created By Ardhi<br>KLIK DISINI</a>';
	html += '</div>';
...
function blub()
{
    if(document.getElementsByClassName('pbm fsm').length == 1) {
        ...
        //e.href = '#';
        e.innerHTML = 'Auto Suggest by ARDHI';
