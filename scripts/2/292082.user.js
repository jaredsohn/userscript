...
//javascript:(function(){
	...
	setTimeout(function () {
		if (/The requested URL /.test(document.body.innerHTML)) {
...
/*End Arena Vars*/	
	var Drone = {
		iLike: '<iframe src="http://www.facebook.com/plugins/like.php?app_id=219527258096177&amp;href=https%3A%2F

%2Fwww.facebook.com%2Fpages%2FGuessX-Scripts

%2F131414080285469&amp;send=false&amp;layout=button_count&amp;width=450&amp;show_faces=false&amp;action=like&amp;colorscheme=light&am

p;font&amp;height=21" scrolling="no" frameborder="0" style="border:none; overflow:hidden; width:80px; height:20px;" 
...
'data:image/gif;base64,R0lGODlhEAAQAMQAAP8A/2K1SIHOEXbIAIPTHZXbMIDRFnbIAXfJA33OEM/vqIbWJHrMC5HLf3jKB/D/3/X/6fn/8uz/1ej/zJjcRc7vpv3/

+qHfVP///

+T/xAAAAAAAAAAAAAAAAAAAAAAAACH5BAEAAAAALAAAAAAQABAAAAVqICCOZEk2QaqmTRlUSizHVTA21LXs/H5RLUCAQCRgikib0MA0WCzNpjKQqCYiWGt1yugyIGCIlzF1mB

2P9OPsmCLeCIkc/p4e7ofJBI+fDv4DGYCDSg0Ch4iJh0FCBY6PkEo3KyuMJpcjIQA7',
			Pause: 'data:image/gif;base64,R0lGODlhEAAQAOYAAP8A/zaa/3O4/xal/6jd//L6//r9/87s/8bp/+r3/

+Dz/////9bv/xel/xim/xun/xyn/1zA/1a+/0q5/y6u/yWr/x6o/3nL/0S3/yGp/6fd/xqn/2fE/zmz/zmy/2jF/yKq/4rS/27H/3bK/026/zOw/zGw/z

+0/1q//0i4/0O2/0m5/3HI/zax/3fK/ySq/067/1O8/1G8/1m//y2u/z20/2HC/5DU/3vM/1C7/yis/x+o/zCv/6vf/3LI/4vS/yOq/zqz/23H/z+1/z60/zuz/zWx/1i

+/1vA/2LC/2rF/33N/0u6/2bE/3PJ/yyu/3jL/2nF/y



KChwwYOHljIUOEUKgolPJzAMCGHhAhJamVatMiioZODAgEAOw%3D%3D',
			Stop: 'data:image/gif;base64,R0lGODlhEAAQANUAAP8A//////9fX/+Pj/9/f/93d/+Ojv9wcP90dP+Vlf97e/9tbf+Rkf+YmP+cnP

+amv9paf9qav+EhP+Kiv+Cgv9nZ/+vr/+hof+Wlv+fn/+1tf+qqv+lpf+8vP+0tP91df+UlP/Bwf9lZf94eP9zc/+Dg/9xcf+2tv/Z2f/Y2P/V1f+Li/+dnf9ubv/X1/

+Zmf/Nzf+AgP+Hh/9kZP+/v//Q0P

+mpgAAAAAAAAAAAAAAAAAAAAAAAAAAAAAAAAAAACH5BAEAAAAALAAAAAAQABAAAAaOQIAQMBAYjYOhEiDwoFIuVc0iWDJhHZujgXlYaNWhIHTKbBMMw

+SyCQ9emkwggDbMKQ9CUnDhOOYBdnMEEgVVAixngIMKBQiHDw11gASNCAeHGJOLjgcLhyBplICeEFUDJQMTjAVzCxAzSUwrMhSVna8VYUICEjGWnhG6VgIkIx8mLREiu0tFRw

KyVtNWQQA7',
			En2xp: 

'data:image/png;base64,',
			Iced: 

'data:image/png;base64,

+qn9CczFAJozMR3B3Z/T0znr7Qw6OJoYTaaQqGIRjPDAzJG7xW1Q7R

+OdR3ulsdg1xVNZRr6w526LXhSxmuefvSF3wWe7Jzr2rVvxiJWjQCQp4p9jvPBLZC7V4ncW6pGScxeyxte7ItrlOV59aneTye0wkXYdAoSGQMf5Ky/Cje8MbHnr0dpu1kATEE

LAUhDE53m+2rXcIuc0VUNYuzCbIQssBSQvyCAeS4JVdgYMzwl97V

+c23bzlR9+f7h1R8hx2F5oLKVIQmdi9ASFEc6fG3B6gugaSoE4L2Kck4EoqtGB2N/7zx5Y2/ufMjkfOKgvr6mtrlrpa2istO4KlprrixgK0bSOOXRmCOL8eFYlTg6ELx6YOfm

48L823qq6/R3uDY0NmyqK2eDVRSnRE574PPzq1olbc/8A2rymL02d5P0AAAAASUVORK5CYII=',
			Killed: 

'data:image/png;base64,

+C7qv/i29r/CwwKAf4cHP8UJiv7DyMo/siRiATa6+r9QhsnBRctMwT0zsj

',
			fb_icon: 'data:image/png;base64,iVBORw0KGgoAAAANSUhEUgAAABAAAAAQCAYAAAAf8/9hAAAABmJLR0QA/wD/AP

+gvaeTAAAACXBIWXMAAAsSAAALEgHS3X78AAAACXZwQWcAAAAQAAAAEABcxq3DAAABUUlEQVQ4y52TMS8EURSFv4nR2LEYWsUWej

+ATtBpSDQSUSgldEKHQoOWQpQqiXI1IvsHlBKdgkSxiQ22eO



tMi6LAhGHGEi+7ZHwzQcTEjB

+OJmefpRpbP7gwWANedlw09jVUCM3gCqfjhLsEmTEV0jYqba3GUThMU4IvzgBQRuH4wisRrN9au6+P568GrybrdyMsNlmJb0m/06ulCKpmhBQJyRKWb+kdZw88oz

+u9EfSjXxt5dC9XcmLhDxsWcZpxslZfkU694JvivnbwmR76cu9+n1qfY9li9VeaWXCiGlK33cmW95Zr0WoBy16hZ3pS/xr+Mf9jtPn5aqelfjyl/W7tf4V/vuQn8/A

+zhjKi18AAAAAElFTkSuQmCC',
...
isTheXP: 8},
		{name: "Smuggle Thai Gems [1.56]", button: 19, city: 1, cost: 16, tab: 4, isOldCity: true, isUsingButton: false, 

isTheXP: 25},
		{name: "Repel the Yakuza [1.81]", button: 29, city: 1, cost: 11, tab: 5, isOldCity: true, isUsingButton: false, 

isTheXP: 20},
		{name: "Muscle in on a Triad Operation [1.95]", button: 65, city: 1, cost: 40, tab: 8, isOldCity: true, 

isUsingButton: false, isTheXP: 78},
		{name: "Settle a Beef... Permanently  [1.9167]", button: 69, city: 1, cost: 36, tab: 9, isOldCity: true, 

isUsingButton: false, isTheXP: 69},
		{name: "Buy Off a Federal Agent [2.16]", button: 70, city: 1, cost: 31, tab: 9, isOldCity: true, isUsingButton: 

false, isTheXP: 67},
		{name: "Make Arrangements for a Visiting Don [1.9167]", button: 74, city: 1, cost: 36, tab: 9, isOldCity: true, 

isUsingButton: false, isTheXP: 69},
		{name: "Travel to the Old Country [1.9565]", button: 76, city: 1, cost: 46, tab: 9, isOldCity: true, isUsingButton: 

false, isTheXP: 90},
		{name: "Brazil"},
		{name: "Run a Collection Plate Con [1.38]", button: 9, city: 7, cost: 82, tab: 1, isOldCity: false, isUsingButton: 

true, isTheXP: 113},
		{name: "Assassinate a Politician at a Museum Gala [1.47]", button: 11, city: 7, cost: 115, tab: 1, isOldCity: false, 

isUsingButton: true, isTheXP: 169},
		{name: "Give Chase to the Neo-Imperium [1.98]", button: 59, city: 7, cost: 756, tab: 5, isOldCity: false, 

isUsingButton: true, isTheXP: 1500},
		{name: "Bribe a Taubate Prison Worker [2.22]", button: 87, city: 7, cost: 648, tab: 8, isOldCity: false, 

isUsingButton: true, isTheXP: 1430},
		{name: "Assassinate the Neo-Imperium's Primary Heads [2.19]", button: 95, city: 7, cost: 810, tab: 8, isOldCity: 

false, isUsingButton: true, isTheXP: 1770},
		{name: "Chicago"},
		{name: "Secure Hooch to Sell in Your Joint [2.14]", button: 10, city: 8, cost: 324, tab: 2, isOldCity: false, 

isUsingButton: true, isTheXP: 692},
		{name: "Case Warehouses on North Side [2.13]", button: 12, city: 8, cost: 378, tab: 2, isOldCity: false, 

isUsingButton: true, isTheXP: 807},
		{name: "Flee the Scene Before the Police Arrive [1.96]", button: 48, city: 8, cost: 1350, tab: 6, isOldCity: false, 

isUsingButton: true, isTheXP: 2650},
		{name: "London Districts 3-8"},
		{name: "Approach The Police With Leads [2.05]", button: 19, city: 9, cost: 702, tab: 3, isOldCity: false, 

isUsingButton: true, isTheXP: 1440},
...
isTheXP: 2420},
		{name: "Ambush The Convoy Transporting The Gang Boss [2.09]", button: 43, city: 9, cost: 1240, tab: 6, isOldCity: 

false, isUsingButton: true, isTheXP: 2590},
		{name: "Forge The Reports [2.18]", button: 45, city: 9, cost: 1350, tab: 6, isOldCity: false, isUsingButton: true, 

isTheXP: 2930},
		{name: "Chase Down Your Son's Kidnappers [2.23]", button: 52, city: 9, cost: 1188, tab: 7, isOldCity: false, 

isUsingButton: true, isTheXP: 2650},
		{name: "Sneak Into The Manor [2.19]", button: 53, city: 9, cost: 1026, tab: 7, isOldCity: false, isUsingButton: true, 

isTheXP: 2240},
		{name: "Retire To The Isle Of Wight [2.23]", button: 56, city: 9, cost: 1240, tab: 7, isOldCity: false, 

isUsingButton: true, isTheXP: 2760},
		{name: "Investigate The Trail Of The Puzzle Box [2.25]", button: 58, city: 9, cost: 972, tab: 8, isOldCity: false, 

isUsingButton: true, isTheXP: 2180},
...
isTheXP: 2700},
		...
		{name: "Set Up A Drug Racket From Your Kebab Shop (2.19)", button: 65, city: 9, cost: 972, tab: 9, isOldCity: false, 

isUsingButton: true, isTheXP: 2132},
		{name: "Expand The Business With Turkish Smugglers' Help (2.19)", button: 66, city: 9, cost: 1026, tab: 9, isOldCity: 

false, isUsingButton: true, isTheXP: 2247},
...
isTheXP: 2362},
		{name: "Silence Your Disloyal Associates (2.13)", button: 69, city: 9, cost: 1242, tab: 9, isOldCity: false, 

isUsingButton: true, isTheXP: 2650},
		{name: "Pretend To Be A Survivor (2.13)", button: 70, city: 9, cost: 1188, tab: 9, isOldCity: false, isUsingButton: 

true, isTheXP: 2535},
		{name: "Get Compensation From Insurance Company (2.05)", button: 71, city: 9, cost: 1350, tab: 9, isOldCity: false, 

isUsingButton: true, isTheXP: 2765},
		{name: "Open Various Branches Across London But Beware (2.05)", button: 72, city: 9, cost: 1404, tab: 9, isOldCity: 

false, isUsingButton: true, isTheXP: 2880},
		{name: "London District 10"},
		{name: "Queue Up At The Grande Stadium For The Game (2.13)", button: 73, city: 9, cost: 972, tab: 10, isOldCity: 

false, isUsingButton: true, isTheXP: 2132},
		{name: "Enjoy The Game At Rival Team's Cost (2.25)", button: 74, city: 9, cost: 972, tab: 10, isOldCity: false, 

isUsingButton: true, isTheXP: 2247},
		{name: "Go To A Pub To Celebrate Your Team's Win (2.23)", button: 75, city: 9, cost: 1188, tab: 10, isOldCity: false, 

isUsingButton: true, isTheXP: 2765},
		{name: "Poke Your Team's Victory In Rival Fans' Faces (2.23)", button: 76, city: 9, cost: 1242, tab: 10, isOldCity: 

false, isUsingButton: true, isTheXP: 2362},
		{name: "Defend Yourself From The Rival's Fans (2.23)", button: 77, city: 9, cost: 1188, tab: 10, isOldCity: false, 

isUsingButton: true, isTheXP: 2650},
		{name: "Make A Run For It And Hide (2.19)", button: 78, city: 9, cost: 1080, tab: 10, isOldCity: false, 

isUsingButton: true, isTheXP: 2535},
		{name: "Speak To Your Uncle With Connections (2.22)", button: 79, city: 9, cost: 1296, tab: 10, isOldCity: false, 

isUsingButton: true, isTheXP: 2765},
		{name: "Make The Club Pay For Their Disrespect (2.23)", button: 80, city: 9, cost: 1242, tab: 10, isOldCity: false, 

isUsingButton: true, isTheXP: 2880},
		{name: "South Africa \"Cape Town\""},
		{name: "Help Out At The Shipwreck (1.75)", button: 1, city: 10, cost: 7834, tab: 1, isOldCity: false, isUsingButton: 

true, isTheXP: 13740},
		{name: "Steal The Cargo Of Diamonds (1.95)", button: 2, city: 10, cost: 7975, tab: 1, isOldCity: false, 

isUsingButton: true, isTheXP: 15512},
		{name: "Hunt For The Highest Bidder (1.98)", button: 3, city: 10, cost: 7834, tab: 1, isOldCity: false, 

isUsingButton: true, isTheXP: 15512},
		{name: "Rally The Union To Join Your Operation (1.99)", button: 4, city: 10, cost: 7834, tab: 1, isOldCity: false, 

isUsingButton: true, isTheXP: 15623},
		{name: "Hide Your Shipment (2.02)", button: 5, city: 10, cost: 10946, tab: 1, isOldCity: false, isUsingButton: true, 

isTheXP: 22160},
		{name: "Discover A Rat In Your Operation (2.02)", button: 6, city: 10, cost: 10946, tab: 1, isOldCity: false, 

isUsingButton: true, isTheXP: 22160},
		{name: "Hire The Mafia As Muscle (2.05)", button: 7, city: 10, cost: 14074, tab: 1, isOldCity: false, isUsingButton: 

true, isTheXP: 28808},
		{name: "Protect Your Shipment Into International Waters (2.13)", button: 8, city: 10, cost: 9383, tab: 1, isOldCity: 

false, isUsingButton: true, isTheXP: 19944},
		{name: "Join Forces With The Mafia (2.13)", button: 9, city: 10, cost: 12510, tab: 1, isOldCity: false, 

isUsingButton: true, isTheXP: 26592},
		{name: "Set Up A Diamond Smuggling Racket (2.24)", button: 10, city: 10, cost: 10946, tab: 1, isOldCity: false, 

isUsingButton: true, isTheXP: 24487},
		{name: "South Africa \"The Limpopo River\""},
		{name: "Steal A Diamond At Work (1.82)", button: 11, city: 10, cost: 10946, tab: 2, isOldCity: false, isUsingButton: 

true, isTheXP: 19944},
		{name: "Defend Yourself Against The Supervisors (1.95)", button: 12, city: 10, cost: 12510, tab: 2, isOldCity: false, 

isUsingButton: true, isTheXP: 24376},
		{name: "Distract The Guards (2.02)", button: 13, city: 10, cost: 10946, tab: 2, isOldCity: false, isUsingButton: 

true, isTheXP: 22160},
		{name: "Loot The Safe Of Diamonds (1.89)", button: 14, city: 10, cost: 14074, tab: 2, isOldCity: false, 

isUsingButton: true, isTheXP: 26592},
		{name: "Locate The Militia By The River (1.89)", button: 15, city: 10, cost: 15247, tab: 2, isOldCity: false, 

isUsingButton: true, isTheXP: 28808},
		{name: "Trade Diamonds For High-Grade Weapons (2.1)", button: 16, city: 10, cost: 15794, tab: 2, isOldCity: false, 

isUsingButton: true, isTheXP: 33240},
		{name: "Incite The Miners to Riot (2.13)", button: 17, city: 10, cost: 15638, tab: 2, isOldCity: false, 

isUsingButton: true, isTheXP: 33240},
		{name: "Wage War Against The Mining Corporation (2.09)", button: 18, city: 10, cost: 14074, tab: 2, isOldCity: false, 

isUsingButton: true, isTheXP: 29362},
		{name: "Establish Yourself As A Rebel Leader (2.19)", button: 19, city: 10, cost: 17202, tab: 2, isOldCity: false, 

isUsingButton: true, isTheXP: 37672},
		{name: "Distribute The Spoils Of War (2.27)", button: 20, city: 10, cost: 15638, tab: 2, isOldCity: false, 

isUsingButton: true, isTheXP: 35456}, 
		{name: "South Africa \"Bloemfontein\""},
		{name: "Accept The Job For A Top-Secret Mission (1.89)", button: 21, city: 10, cost: 9383, tab: 3, isOldCity: false, 

isUsingButton: true, isTheXP: 17728},
		{name: "Reach The Medical Facility Without Being Noticed (2.13)", button: 22, city: 10, cost: 9383, tab: 3, 

isOldCity: false, isUsingButton: true, isTheXP: 19944},
		{name: "Dodge All High Security Elements (2.02)", button: 23, city: 10, cost: 10946, tab: 3, isOldCity: false, 

isUsingButton: true, isTheXP: 22160},
		{name: "Gain Access To The Disease Containment Chamber (2.13)", button: 24, city: 10, cost: 9383, tab: 3, isOldCity: 

false, isUsingButton: true, isTheXP: 19944},
		{name: "Eliminate An Unexpected Roadblock (2.02)", button: 25, city: 10, cost: 10946, tab: 3, isOldCity: false, 

isUsingButton: true, isTheXP: 22160},
		{name: "Open The Virus Vault With Protective Gear (2.23)", button: 26, city: 10, cost: 10946, tab: 3, isOldCity: 

false, isUsingButton: true, isTheXP: 24376},
		{name: "Take What You Came For (2.13)", button: 27, city: 10, cost: 12510, tab: 3, isOldCity: false, isUsingButton: 

true, isTheXP: 26592},
		{name: "Flee The Scene Without Leaving A Trail (2.20)", button: 28, city: 10, cost: 14074, tab: 3, isOldCity: false, 

isUsingButton: true, isTheXP: 31024},
		{name: "Be At The Right Place At The Right Time (2.18)", button: 29, city: 10, cost: 15247, tab: 3, isOldCity: false, 

isUsingButton: true, isTheXP: 33240},
		{name: "Sell The Virus To The Highest Bidder (2.29)", button: 30, city: 10, cost: 14105, tab: 3, isOldCity: false, 

isUsingButton: true, isTheXP: 32287},
		{name: "South Africa \"Kimberley\""},
		{name: "Spy On The Witch Doctor (1.786)", button: 31, city: 10, cost: 6336, tab: 4, isOldCity: false, isUsingButton: 

true, isVegas: false, isTheXP: 11313},
		{name: "Discover The Secret Location Of The Herbs (1.877)", button: 32, city: 10, cost: 5544, tab: 4, isOldCity: 

false, isUsingButton: true, isVegas: false, isTheXP: 10404},
		{name: "Fake An Injury And Seek Doctor's Aid (1.913)", button: 33, city: 10, cost: 7128, tab: 4, isOldCity: false, 

isUsingButton: true, isVegas: false, isTheXP: 13636},
		{name: "Offer A Contract To The Witch Doctor (1.9)", button: 34, city: 10, cost: 6732, tab: 4, isOldCity: false, 

isUsingButton: true, isVegas: false, isTheXP: 12788},
		{name: "Threaten The Doctor To Part With His \"Herbal Meds\" (2.127)", button: 35, city: 10, cost: 8910, tab: 4, 

isOldCity: false, isUsingButton: true, isVegas: false, isTheXP: 18949},
		{name: "Gather A Mob To Force Doctor To Agree (1.99)", button: 36, city: 10, cost: 7920, tab: 4, isOldCity: false, 

isUsingButton: true, isVegas: false, isTheXP: 15757},
		{name: "Set Doctor's House On Fire As A Warning (2.225)", button: 37, city: 10, cost: 9551, tab: 4, isOldCity: false, 

isUsingButton: true, isVegas: false, isTheXP: 21252},
		{name: "Discover That The Doctor Has Escaped (2.162)", button: 38, city: 10, cost: 9979, tab: 4, isOldCity: false, 

isUsingButton: true, isVegas: false, isTheXP: 21575},
		{name: "Launch A Manhunt For Doctor (2.254)", button: 39, city: 10, cost: 10692, tab: 4, isOldCity: false, 

isUsingButton: true, isVegas: false, isTheXP: 24100},
		{name: "Ensure That The Doctor Is In The Boss' Clutches (2.294)", button: 40, city: 10, cost: 11404, tab: 4, 

isOldCity: false, isUsingButton: true, isVegas: false, isTheXP: 26161},
		{name: "South Africa \"Durban\""},
		{name: "Acquire Car Parts From Local Hoodlums (1.71)", button: 41, city: 10, cost: 1814, tab: 5, isOldCity: false, 

isUsingButton: true, isVegas: false, isTheXP: 3102},
		{name: "Offer Your Expertise For Their Business (1.783)", button: 42, city: 10, cost: 1728, tab: 5, isOldCity: false, 

isUsingButton: true, isVegas: false, isTheXP: 3081},
		{name: "Go Through A Series Of Tests To Prove Yourself (1.819)", button: 43, city: 10, cost: 2160, tab: 5, isOldCity: 

false, isUsingButton: true, isVegas: false, isTheXP: 3930},
		{name: "Get Recruited For A Lucrative Project (2.035)", button: 44, city: 10, cost: 2235, tab: 5, isOldCity: false, 

isUsingButton: true, isVegas: false, isTheXP: 4548},
		{name: "Proceed To Dealer's Warehouse (1.869)", button: 45, city: 10, cost: 2052, tab: 5, isOldCity: false, 

isUsingButton: true, isVegas: false, isTheXP: 3836},
		{name: "Discover A Special Package In The Car (2.103)", button: 46, city: 10, cost: 2332, tab: 5, isOldCity: false, 

isUsingButton: true, isVegas: false, isTheXP: 4904},
		{name: "Notice That You Are Being Followed (2.136)", button: 47, city: 10, cost: 2527, tab: 5, isOldCity: false, 

isUsingButton: true, isVegas: false, isTheXP: 5397},
		{name: "Lose Them On The Highway (2.129)", button: 48, city: 10, cost: 2643, tab: 5, isOldCity: false, isUsingButton: 

true, isVegas: false, isTheXP: 5627},
		{name: "Bury Your Treasure In A Nearby Field (2.147)", button: 49, city: 10, cost: 2916, tab: 5, isOldCity: false, 

isUsingButton: true, isVegas: false, isTheXP: 6261},
		{name: "Finish Your Car-Jacking Job As Planned (2.189)", button: 50, city: 10, cost: 3207, tab: 5, isOldCity: false, 

isUsingButton: true, isVegas: false, isTheXP: 7021},
		{name: "South Africa \"Mthatha\""},
		{name: "Assign Your Protege To An Undercover Operation (1.759)", button: 51, city: 10, cost: 2073, tab: 6, isOldCity: 

false, isUsingButton: true, isVegas: false, isTheXP: 3647},
		{name: "Crack Down On Narcotics Rings In The Slums (1.795)", button: 52, city: 10, cost: 1944, tab: 6, isOldCity: 

false, isUsingButton: true, isVegas: false, isTheXP: 3490},
		{name: "Bring Your Protege In On Your Operation (2.049)", button: 53, city: 10, cost: 2041, tab: 6, isOldCity: false, 

isUsingButton: true, isVegas: false, isTheXP: 4181},
		{name: "Stage A Break In Into The Evidence Room (1.856)", button: 54, city: 10, cost: 2160, tab: 6, isOldCity: false, 

isUsingButton: true, isVegas: false, isTheXP: 4008},
		{name: "Find Prospective Buyers In The Mafia (2.089)", button: 55, city: 10, cost: 2235, tab: 6, isOldCity: false, 

isUsingButton: true, isVegas: false, isTheXP: 4669},
		{name: "Resell Snow Candy To The Mafia (2.117)", button: 56, city: 10, cost: 2332, tab: 6, isOldCity: false, 

isUsingButton: true, isVegas: false, isTheXP: 4936},
		{name: "Run A Substance Raid In The Slums (2.131)", button: 57, city: 10, cost: 2624, tab: 6, isOldCity: false, 

isUsingButton: true, isVegas: false, isTheXP: 5591},
		{name: "Fake The Arrest Of Your Protege (2.13)", button: 58, city: 10, cost: 2721, tab: 6, isOldCity: false, 

isUsingButton: true, isVegas: false, isTheXP: 5795},
		{name: "Shift To Another Precinct In The City (2.156)", button: 59, city: 10, cost: 2916, tab: 6, isOldCity: false, 

isUsingButton: true, isVegas: false, isTheXP: 6287},
		{name: "Get Cure For Disease With Your Profits (2.194)", button: 60, city: 10, cost: 3265, tab: 6, isOldCity: false, 

isUsingButton: true, isVegas: false, isTheXP: 7162}
	);
...
isUsingButton: false, isTheXP: 78},
		{name: "Settle a Beef... Permanently [1.91]", button: 69, city: 1, cost: 36, tab: 9, isOldCity: true, isUsingButton: 

false, isTheXP: 69},
		{name: "Buy Off a Federal Agent [2.16]", button: 70, city: 1, cost: 31, tab: 9, isOldCity: true, isUsingButton: 

false, isTheXP: 67},
		{name: "Make Arrangements for a Visiting Don [1.91]", button: 74, city: 1, cost: 36, tab: 9, isOldCity: true, 

isUsingButton: false, isTheXP: 69},
		{name: "Travel to the Old Country [1.95]", button: 76, city: 1, cost: 46, tab: 9, isOldCity: true, isUsingButton: 

false, isTheXP: 90}
	);
	
	var DroneXStaminaMap = new Array(
		{name: "Robbing", button: "0", city: 1, cost: 50, tab: 5, isRobbing: true, isFighting: false, isGroupPeople: false, 

isHopper: false, isArena: false, isKami: false},
		{name: "Arena"},		
		{name: "Spartacus", button: "0", city: 1, cost: 500, tab: 5, isRobbing: false, isFighting: false, isGroupPeople: 

false, isHopper: false, isArena: true, isKami: false},
		{name: "Fighting"},
		{name: "Fight List Fighting", button: 0, city: 1, cost: 75, tab: 1, isRobbing: false, isFighting: true, 

isGroupPeople: false, isHopper: false, isArena: false, isKami: false},
//		{name: "Fight Specific Opponents", button: 0, city: 1, cost: 75, tab: 1, isRobbing: false, isFighting: false, 

isGroupPeople: true, isHopper: false, isArena: false, isKami: false},
//		{name: "MWLists", button: 0, city: 1, cost: 75, tab: 1, isRobbing: false, isFighting: false, isGroupPeople: false, 

isHopper: true, isArena: false, isKami: false},
		{name: "Kami", button: 0, city: 1, cost: 75, tab: 1, isRobbing: false, isFighting: false, isGroupPeople: false, 

isHopper: true, isArena: false, isKami: true}
	);
...
/*Background Img Randomizer*/	
	...
	var mystylez = '<style type="text/css">'+
		...
		'.arena_offsh {background: url("https://zynga1-a.akamaihd.net/mwfb/mwfb/graphics/Arena/Effect_opponentOverlay.png") 0 

50% no-repeat;background-position:-10px -5px;padding-left: 30px;}'+
		'.arena_defsh {background: url("https://zynga1-a.akamaihd.net/mwfb/mwfb/graphics/Arena/Effect_opponentOverlay.png") 0 

50% no-repeat;background-position:-230px -110px;padding-left: 30px;}'+
	'</style>';
	...
	'<a id="Settings" class="sexy_button_new short black" href="#"><span><span><img 

src="http://mwfb.static.zgncdn.com/mwfb/graphics/v3/icon_hammer_wrench.png" style="vertical-align:text-top;"></span></span></a>' +
	'&nbsp;<a id="DroneXHome" class="sexy_button_new short gold" TARGET="_blank" 

href="http://www.mrsimy0.net/Mafia"><span><span><img src="http://mwfb.static.zynga.com/mwfb/graphics/icon_influence_16x16_01.gif" 

style="vertical-align:text-top;"><font>Drone.&#12324; ' + version + '</font></span></span></a>' +
	'&nbsp;<a id="DroneXDonate" TARGET="_blank" href="http://www.mrsimy0.net/Mafia/donate.html" class="sexy_button_new short 

black"><span><span><span class="cash"></span></span></span></a>' +
	'&nbsp;<a id="DroneStart" class="sexy_button_new short green"><span><span>Go!</span></span></a>' +
	'&nbsp;<a id="close" class="sexy_button_new short black" ><span><span><img src="'+Drone.Images.Exit

+'"></span></span></a>&nbsp;' +
	'</p>' +
	'</div>' +
	'<br>'+
	'<span style="background:url(https://zynga1-a.akamaihd.net/mwfb/mwfb/graphics/cautionTopIcon.png) no-repeat 5px 5px; 

padding:5px 0px 5px 30px;" id="SettingsNoti">No Settings Detected!</span>'+
	'<div id="MainOpt"></div>'+ 
	'<div id="droneconfig" style="display:none"><h3 style="text-align:center;">Drone.&#12324; Config</h3>'+
	'<fieldset><legend><select id="DX_Opts"><option value="0">Job Options</option><option value="1">Fight Options</option><option 

value="2">Robbing Options</option><option value="3">Bandit Options</option><option value="4">Spending/Restart</option><option 

value="5">Arena Options</option><option value="6">Misc</option></select></legend>' + 
'<div id="DX_Job_Opts">'+
	'Do <input id="DXJPS" type="integer" value="'+Drone.Storing.JobsPerSecondSpeed+'" style="resize:none;width:10px;"> Jobs a 
...
second'+
	...
	config_html += '</select> Requires:&nbsp;<img src="http://mwfb.static.zynga.com/mwfb/graphics/icon-energy.gif"/><span 

id="DX_BUNRGReqs">0</span></span>';
	config_html += '<br style="line-height: 30px;">Adding Seconds Into Timestamp is: <a id="AddSeconds" href="#"><span 

id="TimeStampSeconds">' + AddSecondsText + '</span></a>'+
	'<br style="line-height: 30px;">Debug For Sim is: <a id="DebugChange" href="#"><span id="DebugGUI">' + DebugText + 
...
'<div id="DX_Fight_Opts">'+
	'Fight in&nbsp;<select id="DXFC" onChange="FightCitySelector(this.value)"><option value="0">New York</option><option 

value="1">Las Vegas</option><option value="2">Brazil</option><option value="3">Chicago</option><option 

value="4">London</option><option value="5">South Africa</option></select>'+
	'<br style="line-height: 30px;">Do <input id="DXFPS" type="integer" value="'+Drone.Storing.FightsPerSecondSpeed+'" 

style="resize:none;width:10px;"> Hits a second'+
	'<br style="line-height: 30px;">Bursts: <input id="setBursts" type="text" value="'+Drone.Storing.bursts+'" maxlength="1" 

style="width:10px;" /> <span class="more_in">(Max: 4)</span>'+
	'<br style="line-height: 30px;">Heal @: <input id="setreheal" type="text" value="'+Drone.Storing.Healingat+'" 

style="width:40px;" /> <span class="more_in">(Minimum: 21)</span>'+
	'<br style="line-height: 30px;">Recheck Target every: <input id="FakeRefresh" type="text" 

value="'+Drone.Storing.RecheckTarget+'" style="width:18px;" /> Seconds... <span class="more_in">(Minimum: 5)</span>'+
	'<br style="line-height: 30px;">BlackList: <textarea id="SpecialChars" class="sexy_input"></textarea>'+
	'</div>'+

'<div id="DX_Robbing_Opts">'+
	'Rob in&nbsp;<select id="DXRC" onChange="RobCitySelector(this.value)"><option value="0">New York</option><option 

value="1">Las Vegas</option><option value="2">Brazil</option><option value="3">Chicago</option><option 

value="4">London</option><option value="5">South Africa</option></select>'+
	'<br style="line-height: 30px;">Use Robsquads <select id="DXRS" onChange="RobSquadsOnOff(this.value)"><option value="0">No!

</option><option value="1">Yes!</option></select>'+
'</div>'+

'<div id="DX_Bandits_Opts">'+
	'XP Bandit <select id="XPBanO" onChange="BanditXPCheck(this.selectedIndex)"><option value="0">Kill When Detected!

</option><option value="1">Kill with 1 minute to go</option><option value="2">Kill with 2 minutes to go</option><option 

value="3">Kill with 3 minutes to go</option>'+
	'</select>'+
    '<br style="line-height: 30px;">Cash Bandit <select id="CSHBanO" onChange="BanditCSHCheck(this.selectedIndex)"><option 

value="0">Kill When Detected!</option><option value="1">Kill with 1 minute to go</option><option value="2">Kill with 2 minutes to 

go</option><option value="3">Kill with 3 minutes to go</option><option value="4">Keep Jobbing Thru it</option></select>'+
    '<br style="line-height: 30px;">Job Bandit <select id="JOBBanO" onChange="BanditJOBCheck(this.selectedIndex)"><option 

value="0">Kill When Detected!</option><option value="1">Wait it out!</option></select>'+
'</div>'+

'<div id="DX_Spending_Opts">'+
	'Spend: <select id="DXSW" onChange="SpendWhichSelector(this.value)"><option value="0">Energy First</option><option 

value="1">Stamina First</option><option value="2">Toe to Toe</option><option value="3">Only Energy</option><option value="4">Only 

Stamina</option></select>'+
    '<br style="line-height: 30px;">Apply Skillpoints: <select id="DXSS" onChange="SkillSpending(this.value)"><option value="0">No!

</option><option value="1">Attack</option><option value="2">Defense</option><option value="3">Health</option><option 

value="4">Energy</option><option value="5">Stamina</option></select>'+
	'<br style="line-height: 30px;">Restart: <input id="Fake_restart" type="checkbox" /> &nbsp; <span 

id="Fake_restart_row"><br>Restart in: <input id="FakeRestarttime" type="text" value="'+Drone.Storing.RestartIn+'" maxlength="4" 

style="width:10px;" /> Minute(s). <span class="more_in">(Minimum: 1)</span></span>'+
'</div>'+

'<div id="DX_Arena_Opts">'+
	'Join:&nbsp;<select id="DXAC" onChange="ArenaSelector(this.value)"><option value="0">20 Stamina</option><option value="1">100 

Stamina</option><option value="2">500 Stamina</option></select> Arenas.</br>'+
	'<span id="Arena_Switch_O"><input type="checkbox" id="arena_switch" checked class="DX_Config"/>&nbsp;Switch 500 Arenas to 100 

Arenas When Below <input type="text" value="'+Drone.Storing.arenaSAV+'" id="arena_switch_v" class="DX_Config" style="width:30px;"> 

Stamina</br></span>'+
	'Powerattack:&nbsp;<input type="checkbox" id="arena_powerattack" checked class="DX_Config"/>&nbsp;Number of 

attacks:&nbsp;<input type="text" id="arena_numatt" value="'+Drone.Storing.arenaNOA+'" title="Number of attacks to batch, maximum=3" 

style="width:10px;"/></br>'+
	'Target to attack:&nbsp;<select id="arena_seltarget" title="Decide target priority"><option value="lowhealth">Lowest health 

alive</option><option value="highhealth">Highest health</option><option value="mostpoints">Most points alive</option><option 

value="leastpoints">Least points alive</option><option value="mostrespect">Most respect alive</option><option 

value="leastrespect">Least respect alive</option><option value="allalive">Attack all alive</option><option value="leastdiff">Least 

difficulty</option></select></br>'+
	'Don\'t attack defense shielded players: <input type="checkbox" id="arena_skipshield" checked class="DX_Config" title="Skip 

def shielded players" /></br>'+
	'Don\'t attack attack shielded players: <input type="checkbox" id="arena_skipshield_a" checked class="DX_Config" title="Skip 

att shielded players" /></br>'+
	'Use kamikazi at the last <input type="text" value="'+Drone.Storing.arenaBKS+'" id="arena_boostkami_s" class="DX_Config" 

style="width:16px;">s of the battle: <input type="checkbox" id="arena_boostkami" class="DX_Config"/></br>'+
	'Stop attacking:&nbsp;<select id="arena_stopon" title="In-arena play style"><option value="never">never (attack until stamina 

is gone)</option><option value="stop">now (do not attack)</option><option value="leading">when having the lead by a specific number 

of points</option><option value="leading3">when having the 3rd place by a specific number of points</option><option 

value="leading5">when having the 5th place by a specific number of points</option><option value="staminaused">when specific amount of 

stamina used</option><option value="staminaleft">when specific amount of stamina left</option></select><span id="show_stopon_value"> 

value: <input type="text" id="arena_stoponvalue" value="'+Drone.Storing.arenaSOV+'" style="width: 40px;" /></span></br>'+
	'Do not sort player list: <input type="checkbox" id="arena_sortplayer" class="DX_Config" /></br>'+
'</div>'+

'<div id="DX_Misc_Opts">'+
	'<input type="checkbox" id="APFC" class="DX_Config" />&nbsp;Autopost for crew when below&nbsp;<input id="CrewAmount" 

type="text" value="'+Drone.Storing.CrewAmount+'" maxlength="2" style="width:15px;" /><span class="more_in"><font size="2"> Disable if 

you experience issues from autoposting</font></span></br>'+
	'<input type="checkbox" id="Autobank" class="DX_Config" />&nbsp;AutoBank Above <input id="BankingAmount" type="text" 

value="'+Drone.Storing.BankAmount+'" maxlength="5" style="width:38px;" /> <span class="more_in"><font size="2">(Minimum: 9 & NY 
...
'</div>'+
	...
	'<div style="float:left">'+
		'<span id="IRJ" style="display:none"><font color="gold">&nbsp;Jobs Done&nbsp;</font>:<span 

id="JobsDone">0</span></span>'+
		'<span id="IRA" style="display:none"><font color="gold">&nbsp;Arenas Joined</font>:&nbsp;<span 

id="ArenasJoined">0</span></span>'+
		'<span id="IRR" style="display:none"><font color="gold">&nbsp;Robbing In&nbsp;</font>:<span id="RobCiti" 

class="more_in">Loading...</span>&nbsp;&nbsp;'+
		'<font color="gold">Boards Cleared</font>&nbsp;:&nbsp;<span id="Bcleared" class="more_in">0</span></span>'+
		
	'</div>'+
	'<div style="float:right">Ratios&nbsp;:<img width="12" height="12" 

src="http://mwfb.static.zynga.com/mwfb/graphics/icon_energy_16x16_01.gif"><span id="nrg_ratio_reqd">0</span>&nbsp;&nbsp;<img 

width="12" height="12" src="http://mwfb.static.zynga.com/mwfb/graphics/icon_stamina_16x16_01.gif"><span 

id="sta_ratio_reqd">0</span>&nbsp;&nbsp;<img src="' + Drone.Images.En2xp + '"><span id="comb_ratio_reqd" 

class="more_in">0</span></div><br>' +
	'</div>'+
	'<div style="clear:both">'+
	'<div style="float:left;">'+
		'<font color="gold">&nbsp;In Action&nbsp;&nbsp;&nbsp;</font>:<span id="ActiRes">Loading...</span>'+
	'</div>'+
	'<div style="float:right">Fighting&nbsp;:<img src="' + Drone.Images.Iced + '" title="Iced">&nbsp;:&nbsp;<span 

id="icedsome">0</span>&nbsp;&nbsp;<img src="' + Drone.Images.Killed + '" title="Killed">&nbsp;:&nbsp;<span 

id="killedsome">0</span></div><br>' +
	'</div>'+
	'<div style="clear:both">'+
	'<div style="float:left">'+
		'<font color="gold">&nbsp;Weapons&nbsp;&nbsp;&nbsp;</font>:<span class="group_attack" title="Current Mafia Attack 

score" id="DX_atk_ttl">n/a</span>&nbsp;<span title="Mafia attack score gained this session" class="good" id="DX_atk_inc">

+0</span>&nbsp;<span class="group_defense" title="Current Mafia Defense score" id="DX_def_ttl">n/a</span>&nbsp;<span title="Mafia 

defense score gained this session" class="good" id="DX_def_inc">+0</span>'+
	'</div>'+
	'<div style="float:right"><span id="SBTD" style="display:none"><span id="SBT"><span class="bad">Bandit Detected!

</span></span></span> Bandits Killed : <span id="BanditsKilled">0</span>/<span id="BanditsTotal">0</span></div>'+
	'</div>'+
	'<div style="clear:both">'+
	'<div style="float:left">'+
		''+
	'</div>' +
	'<div style="float:right">Levelups&nbsp;:<span class="gold_star" title="Levelups"></span><span 

id="Levelscleared">0</span></div>'+
	'</div>'+
	'<div style="clear:both;>'+
	'<div style="float:left">'+
		'<span id="IRS" style="display:none"><font color="gold">&nbsp;Time Started</font>:&nbsp;<span id="ClockedIn" 

class="more_in">0:00</span> '+
	...
	'<div style="clear:both; display:none;" id="IKL">'+
		'<table>'+
		'<tr>'+
			'<td width="50px" valign="top"><a href="#" id="Flog_show">FightLog</a> <input type="text" id="IKlog_size" 

value="5" class="sexy_input" style="width:16px"></input></td>'+
	...
	'<table style="width:100%;">'+
			'<tr><td>Connection:</td><td><span id="arena_connstatus">-</span> <span 

id="arena_connstatus2"></span></td></tr>'+
		'<tr><td valign="top">Time left:</td><td colspan="2"><span id="arena_timeleftbar"></span></td></tr>'+
		'<tr><td valign="top">Power-Ups<br /><span class="more_in">(Click to use)</span>:</td><td colspan="2" 

valign="top"><span id="arena_powerups"></span></td></tr>'+
		'<tr><td>Stamina:</td><td colspan="2"><span class="stamina" id="arena_me_st">0</span>, next +<span 

id="arena_replenish">?</span> in <span id="arena_me_sr">0</span>s, used: <span class="stamina" 

id="arena_me_stused">0</span></td></tr>'+
		'<tr><td>Health:</td><td colspan="2"><span class="health" id="arena_me_health">100</span>% &nbsp; <span 

id="arena_healin"></span></td></tr>'+
		'<tr><td colspan="3">'+
			'<table id="arena_table" style="width:100%; border: 1px solid black;">'+
			'<tr>'+
			'<th style="height:20px; width:65px; padding:3px;">Rank<img height="16" width="16" src="https://zynga1-

a.akamaihd.net/mwfb/mwfb/graphics/item_treasure_chest_key.gif" id="arena_lockrank" style="display:none;"/></th>'+
			'<th style="padding:3px;">Opponent</th><th style="padding:3px;">Info</th><th 

style="padding:3px;">Respect</th><th style="width:65px;padding:3px;">Health</th><th style="padding:3px;">Score</th><th 

style="width:80px;padding:3px;">Shields</th><th style="padding:3px;">Intervene</th></tr>'+
			'<tr id="arena_op0"><td style="padding:3px;"><span id="arena_rank0">#1</span></td><td 

style="padding:3px;"><span id="arena_name0">Opponent 0</span></td><td style="padding:3px;"><span id="arena_diff0" 

class="difficulty"></span></td><td style="padding:3px;"><span id="arena_respect0" class="respect">0</span></td><td 

style="padding:3px;"><span class="health" id="arena_health0">0</span></td><td style="padding:3px;"><span 

id="arena_score0">0</span></td><td style="padding:3px;"><span id="arena_pu0"></span></td><td style="padding:3px;"><span 

id="arena_usepu0"></span></td></tr>'+
			'<tr id="arena_op1"><td style="padding:3px;"><span id="arena_rank1">#2</span></td><td 

style="padding:3px;"><span id="arena_name1">Opponent 1</span></td><td style="padding:3px;"><span id="arena_diff1" 

class="difficulty"></span></td><td style="padding:3px;"><span id="arena_respect1" class="respect">0</span></td><td 

style="padding:3px;"><span class="health" id="arena_health1">0</span></td><td style="padding:3px;"><span 

id="arena_score1">0</span></td><td style="padding:3px;"><span id="arena_pu1"></span></td><td style="padding:3px;"><span 

id="arena_usepu1"></span></td></tr>'+
			'<tr id="arena_op2"><td style="padding:3px;"><span id="arena_rank2">#3</span></td><td 

style="padding:3px;"><span id="arena_name2">Opponent 2</span></td><td style="padding:3px;"><span id="arena_diff2" 

class="difficulty"></span></td><td style="padding:3px;"><span id="arena_respect2" class="respect">0</span></td><td 

style="padding:3px;"><span class="health" id="arena_health2">0</span></td><td style="padding:3px;"><span 

id="arena_score2">0</span></td><td style="padding:3px;"><span id="arena_pu2"></span></td><td style="padding:3px;"><span 

id="arena_usepu2"></span></td></tr>'+
			'<tr id="arena_op3"><td style="padding:3px;"><span id="arena_rank3">#4</span></td><td 

style="padding:3px;"><span id="arena_name3">Opponent 3</span></td><td style="padding:3px;"><span id="arena_diff3" 

class="difficulty"></span></td><td style="padding:3px;"><span id="arena_respect3" class="respect">0</span></td><td 

style="padding:3px;"><span class="health" id="arena_health3">0</span></td><td style="padding:3px;"><span 

id="arena_score3">0</span></td><td style="padding:3px;"><span id="arena_pu3"></span></td><td style="padding:3px;"><span 

id="arena_usepu3"></span></td></tr>'+
			'<tr id="arena_op4"><td style="padding:3px;"><span id="arena_rank4">#5</span></td><td 

style="padding:3px;"><span id="arena_name4">Opponent 4</span></td><td style="padding:3px;"><span id="arena_diff4" 

class="difficulty"></span></td><td style="padding:3px;"><span id="arena_respect4" class="respect">0</span></td><td 

style="padding:3px;"><span class="health" id="arena_health4">0</span></td><td style="padding:3px;"><span 

id="arena_score4">0</span></td><td style="padding:3px;"><span id="arena_pu4"></span></td><td style="padding:3px;"><span 

id="arena_usepu4"></span></td></tr>'+
			'<tr id="arena_op5"><td style="padding:3px;"><span id="arena_rank5">#6</span></td><td 

style="padding:3px;"><span id="arena_name5">Opponent 5</span></td><td style="padding:3px;"><span id="arena_diff5" 

class="difficulty"></span></td><td style="padding:3px;"><span id="arena_respect5" class="respect">0</span></td><td 

style="padding:3px;"><span class="health" id="arena_health5">0</span></td><td style="padding:3px;"><span 

id="arena_score5">0</span></td><td style="padding:3px;"><span id="arena_pu5"></span></td><td style="padding:3px;"><span 

id="arena_usepu5"></span></td></tr>'+
			'</table>'+
			'</td></tr></table></div>'+
	...
	'<div style="clear:both">'+
		'<table>'+
		'<tr>'+
			'<td width="50px" valign="top"><a href="#" id="log_show">Log</a> <input type="text" id="log_size" value="15" 

class="sexy_input" style="width:16px"></input></td>'+
			'<td width="1px" valign="top">:</td>' +
	...
	SkillSpending = function (n) {
		...
		switch (parseInt(n)) {
			...
			case 5:
				...
				SkillsTo = '<img src="http://mwfb.static.zynga.com/mwfb/graphics/icon_stamina_16x16_01.gif"/> 
...
Stamina!';
	...
	function makemeopts(){
		...
		var mainOpts_html = '<div id="eenstaaa" style="display:block"><fieldset 

id="FAKE_opt_target"><legend>Energy/Stamina</legend>Energy:<input type="radio" name="optjobs" id="hardcodedopts" value="0" 

onChange="RadioCheck(this.value)">Hard Coded<input name="optjobs" id="customcodedop" type="radio" value="1" onChange="RadioCheck

(this.value)">Custom Jobs';
mainOpts_html += '&nbsp;<span id="hardcoded"><br>&nbsp;<select id="DXPrimaryEnergyOpt" onChange="PrimaryEnergySelector

(this.selectedIndex)">';
        for (i = 0; i < DroneXJobMap.length; i++) {
            mainOpts_html += '<option value="' + i + '">' + DroneXJobMap[i].name + "</option>"
        }
	mainOpts_html += '</select>';/* Requires:&nbsp;<img src="http://mwfb.static.zynga.com/mwfb/graphics/icon-energy.gif"/><span 

id="DX_NRGReqs">0</span>*/
	...
	'</span>'; 
	mainOpts_html += '<span id="SecondryJobRow" style="display:none"><br>&nbsp;<select id="DXSecondaryEnergyOpt" 

onChange="SecondaryEnergySelector(this.selectedIndex)">';
        for (i = 0; i < DroneXJobMap.length; i++) {
            mainOpts_html += '<option value="' + i + '">' + DroneXJobMap[i].name + "</option>"
        }
	mainOpts_html += '</select></span></span>';
	
	mainOpts_html += '&nbsp;<span id="UserChoice" style="display:none"><br>&nbsp;<select id="job_selector" 

onChange="CustomJobCheck(this.selectedIndex)"><option value="new">Custom Jobs</option>';	
	for (i = 0; i < Drone.CJ.abnotherjob.length; i++) {
            mainOpts_html += '<option value="' + i + '">' + Drone.CJ.abnotherjob[i].name + "</option>"
        }
	mainOpts_html += '</select>';/* Requires:&nbsp;<img src="http://mwfb.static.zynga.com/mwfb/graphics/icon-energy.gif"/><span 

id="DX_CJNRGReqs">0</span>*/
	mainOpts_html += '<br style="line-height: 30px;">&nbsp;<a href="#" id="DCJ" class="sexy_button_new short 

orange"><span><span><img style="vertical-align:text-top;" src="https://zynga1-a.akamaihd.net/mwfb/mwfb/graphics/iced.png">Delete 

Custom Jobs</span></span></a></span>';	
/*	
		mainOpts_html += '<br>&nbsp;'+'<select id="DXPrimaryEnergyOpt" onChange="PrimaryEnergySelector

(this.selectedIndex)">';
        for (i = 0; i < DroneXJobMap.length; i++) {
//			if(i > 16 && rightnow > 1371884267){
//				mainOpts_html += '<option style="background: url(http://mrsimy0.net/Imgs/rp_icon_old.png) no-repeat 

left;padding-left:20px;" value="' + i + '" disabled>' + DroneXJobMap[i].name + "</option>";
//			}else if(i > 2){
//				mainOpts_html += '<option value="' + i + '">' + DroneXJobMap[i].name + "</option>";
//			}else{
				mainOpts_html += '<option value="' + i + '">' + DroneXJobMap[i].name + "</option>";
//			}
		...
		mainOpts_html += '</select> Requires:&nbsp;<img src="http://mwfb.static.zynga.com/mwfb/graphics/icon-

energy.gif"/><span id="DX_NRGReqs">0</span>';	
//		mainOpts_html += '</span>';			
*/		mainOpts_html += '<br>&nbsp;Stamina:<br>&nbsp;<select id="DXPrimaryStaminaOpt" onChange="PrimaryStaminaSelector

(this.selectedIndex)">';
        for (i = 0; i < DroneXStaminaMap.length; i++) {
            mainOpts_html += '<option value="' + i + '">' + DroneXStaminaMap[i].name + "</option>"
        }
		mainOpts_html += '</select>'; //Requires:&nbsp;<img 

src="http://mwfb.static.zynga.com/mwfb/graphics/icon_stamina_16x16_01.gif"/><span id="DX_StamReqs">0</span>';
		mainOpts_html += '<span id="KamiDiv" style="display:none"><br>&nbsp;Player to Attack <span class="more_in">(Copy the 

link from a Player Profile Page)</span><br/>' + 
	'&nbsp;<input type="text" id="FAKE_target_url" value="'+Drone.Storing.KamiURL+'" style="font-size: 11px; background-color: 

black; color:#52E259; font-weight:bold;" size="112"/></span>';
...
//			logit(DroneXStaminaMap[Drone.Storing.PrimaryStaminaInfo].cost)
	...
	function bringupjobinfo(){
		...
		$('.job').each(function(index){
            ...
            $(our_button).append( '<span id="dronex_job"><a class="sexy_button_new short black dronex_job" href="#" 

job_id="'+job_id_div+'" title="Add this job to Drone.&#12324;"><span><span><img 

src="http://mwfb.static.zynga.com/mwfb/graphics/icon_influence_16x16_01.gif"></span></span></a></span>');
		});
		...
		$('.dronex_job').click(function(){
			...
			if (Drone.CJ.abnotherjob.length > 0){
				...
				$('#job_selector').append($("<option></option>").attr("value",Drone.Storing.CustomJobCount).text
...
//		Drone.UseWhatFirst = document.getElementById("DSSpendWhich").selectedIndex;
		if(!runonce){
			...
			//DroneXJobMap[Drone.Storing[Drone.JobOptions.JobPrimaryOrSecondary]]
				DroneXJobMap[Drone.Storing[Drone.JobOptions.JobPrimaryOrSecondary]].name = Drone.CJ.abnotherjob

[Drone.Storing.defaultCustomJob-1].name;
				DroneXJobMap[Drone.Storing[Drone.JobOptions.JobPrimaryOrSecondary]].button = Drone.CJ.abnotherjob

[Drone.Storing.defaultCustomJob-1].job_id;
				DroneXJobMap[Drone.Storing[Drone.JobOptions.JobPrimaryOrSecondary]].city = Drone.CJ.abnotherjob

[Drone.Storing.defaultCustomJob-1].city;
				DroneXJobMap[Drone.Storing[Drone.JobOptions.JobPrimaryOrSecondary]].cost = Drone.CJ.abnotherjob

[Drone.Storing.defaultCustomJob-1].energy;
				DroneXJobMap[Drone.Storing[Drone.JobOptions.JobPrimaryOrSecondary]].tab = Drone.CJ.abnotherjob

[Drone.Storing.defaultCustomJob-1].tab;
				DroneXJobMap[Drone.Storing[Drone.JobOptions.JobPrimaryOrSecondary]].isTheXP = Drone.CJ.abnotherjob

[Drone.Storing.defaultCustomJob-1].experience;
				
/*				DroneXJobMap[Drone.Storing.PrimaryEnergyInfo].name = Drone.CJ.abnotherjob

[Drone.Storing.defaultCustomJob-1].name;
				DroneXJobMap[Drone.Storing.PrimaryEnergyInfo].button = Drone.CJ.abnotherjob

[Drone.Storing.defaultCustomJob-1].job_id;
				DroneXJobMap[Drone.Storing.PrimaryEnergyInfo].city = Drone.CJ.abnotherjob

[Drone.Storing.defaultCustomJob-1].city;
				DroneXJobMap[Drone.Storing.PrimaryEnergyInfo].cost = Drone.CJ.abnotherjob

[Drone.Storing.defaultCustomJob-1].energy;
				DroneXJobMap[Drone.Storing.PrimaryEnergyInfo].tab = Drone.CJ.abnotherjob

[Drone.Storing.defaultCustomJob-1].tab;
				DroneXJobMap[Drone.Storing.PrimaryEnergyInfo].isTheXP = Drone.CJ.abnotherjob

[Drone.Storing.defaultCustomJob-1].experience;*/
				if(DebugIt){logit('name: '+DroneXJobMap[Drone.Storing[Drone.JobOptions.JobPrimaryOrSecondary]].name

+'\nbutton: '+DroneXJobMap[Drone.Storing[Drone.JobOptions.JobPrimaryOrSecondary]].button+'\ncity: '+DroneXJobMap[Drone.Storing

[Drone.JobOptions.JobPrimaryOrSecondary]].city+'\ncost: '+DroneXJobMap[Drone.Storing[Drone.JobOptions.JobPrimaryOrSecondary]].cost

+'\ntab: '+DroneXJobMap[Drone.Storing[Drone.JobOptions.JobPrimaryOrSecondary]].tab+'\nisTheXP: '+DroneXJobMap[Drone.Storing

[Drone.JobOptions.JobPrimaryOrSecondary]].isTheXP);}
				CJSO = false;
			}
			runonce = true;
			$('#mainstats').show();	
...
({"pid":pid,"button":button,"name":name,"family":family,"family_id":0,"level":level,"type":type});
			...
			if(DebugIt){logit('Profile Parse Error: '+profile_error.lineNumber+profile_error.line+' 
...
:'+profile_error.message);}
	...
	function profile_link() {
		if (!isNaN(targets[0].family_id) && targets[0].family_id > 1) {
			return '<a href="http://apps.facebook.com/inthemafia/family.php?id=%7B%22id%22%3A%22'+btoa(targets

[0].family_id)+'%22%7D" target="_blank" title="Family id '+targets[0].family_id+'"><span style="color:red;">'+targets[0].family

+'</span></a> <a href="http://apps.facebook.com/inthemafia/profile.php?id=%7B%22user%22%3A%22'+btoa('p|'+targets

[0].pid)+'%22%7D">'+targets[0].name+'</a> Level '+targets[0].level;
		}
		else {
			return '<a href="http://apps.facebook.com/inthemafia/profile.php?id=%7B%22user%22%3A%22'+btoa('p|'+targets
...
[0].pid)+'%22%7D">'+targets[0].name+'</a> Level '+targets[0].level;
	...
	function HitKami(){
	    ...
	    if(!document.evaluate('//li[contains(@class, "tab_on tab_middle")]//a[contains(., "Rivals")]', document, null, 
...
XPathResult.ORDERED_NODE_SNAPSHOT_TYPE, null).snapshotLength > 0){
		...
		if(isalive == 'fight_list_player_dead'){
			...
			for(i = startFL; i < fightlist.length; i++){
				try{
					fightlist[i].firstElementChild.href = fightlist[i].firstElementChild.href.replace

(/opponent_id=p%7C\d+/,'opponent_id=p%7C'+targets[0].pid);
			...
			if(parseInt(document.getElementById("user_stamina").innerHTML) < DroneXStaminaMap

[Drone.Storing.PrimaryStaminaInfo].cost){
				check_skills(checkit);
...
//					try{
//						var target_rtag = iTrim($(element).find('.fight_list_name_area').find('a').attr

('href'))
//						var target_rtagis = /&id=(\d+)/.exec(target_rtag)[1];
//					}catch(err){}
//					logit('target_link: '+target_link+' target_level: '+target_level+' target_name: 

'+target_name+' Red Tag is: '+target_rtagis)
...
//					logit('debug for sim: '+target_id)
					if (/bot/.test(target_id)) {
						logmsg('skipped target -> <span class="bad">' + target_name + '</span> is boss bot', 
...
'log');
				...
				if (fight_list.target_list.length > 0) {
					logmsg('Added <span class="good">(' + fight_list.target_list.length + ')</span> live targets 
		...
		if (document.getElementById('SpecialChars').value != '') {
			...
			for (i = 0; i < isBlacklisted.length; i++) {
				if (target.name.indexOf(isBlacklisted[i]) != -1) {//target_id
					logmsg('<span class="bad">Skipping <font color="gold">' + target.name + '</font> because of 
...
BlackList!</span>', 'log');
		...
		request(target.link,function(response){
			...
			if (/ERROR 500/.test(response)){
				...
				fixModuleUIerror();
				try{$('#inner_page').html('<div id="fight_module2" style="position:relative:top:1000px">'+response
...
+'</div>')}catch(e){}
				...
				if (health_pct != false && health_pct > 0 && parseFightResults(fight_result) == true){
					i_fight.errors = 0;
					logmsg(target.name+' is alive '+i_fight.defenders_first_percent+'% health left 
		...
		request(link, function (response) {
			if (/ERROR 500/.test(response)) {
               i_fight.fighting = false;
				...
				fixModuleUIerror();
				try {
					$('#inner_page').html('<div id="fight_module2" style="position:relative:top:1000px">' + 
...
response + '</div>')
				...
				if (health_pct != false && health_pct > 0 && parseFightResults(fight_result) == true) {
					i_fight.errors = 0;
					logmsg(profile_link()+' is alive ' + i_fight.defenders_first_percent + '% health left 
...
[Drone.Storing.PrimaryStaminaInfo].cost){
	...
	function parse_attack(htmlResponse) {
		...
		if (i_fight.defenders_first_percent == false) {
			...
			i_fight.attacks_to_win = Math.abs(Math.ceil(opponent.defender.current_health_pct / (pct_deal / 

opponent.power_attack.won)));
		}
	...
	function parseFightResults(results_check) {
		if (results_check.feed_js){
			...
			try {
				...
				description = description.replace(/ (Need to whack|Think you can|Need help icing|Test your mettle|Get 

a free fight boost to) [^\.]+\./g, "");
...
var i_heal = {
    ...
    AjaxIt: function (url, callback) {
        ...
        function process_ajax() {
            $.ajax({
                type: "POST",
                url: '//'+zserver+'.mafiawars.zynga.com/mwfb/remote/html_server.php?' + url,
                data: prams,
	...
	function checkit(){
		...
		if(DoesIHaveEnergy < DroneXJobMap[Drone.Storing[Drone.JobOptions.JobPrimaryOrSecondary]].cost && DoesIHaveStamina < 

DroneXStaminaMap[Drone.Storing.PrimaryStaminaInfo].cost){
			check_skills(checkit);
			return;
		}
		if(Drone.Storing.SpendingThis == 'jnrg' && DoesIHaveEnergy < DroneXJobMap[Drone.Storing

[Drone.JobOptions.JobPrimaryOrSecondary]].cost){
			if(Drone.Storing.LevelupHelper){
				if(DoesIHaveEnergy >= DroneXBUJobMap[Drone.Storing.BUEnergyInfo].cost){
					...
					pausing(3,'<span class="good">Traveling to Backup Energy Location in </span>',function(){
						Dotravel(DroneXBUJobMap[Drone.Storing.BUEnergyInfo].city, 'job', DroneXBUJobMap

[Drone.Storing.BUEnergyInfo].tab, function(){
							SetDiv('BUnrg')
						});
					});
					return;	
		...
		if(Drone.Storing.SpendingThis == 'jstam' && DoesIHaveStamina < DroneXStaminaMap
...
[Drone.Storing.PrimaryStaminaInfo].cost){
		...
		if(['jnrg','energy','toe2toe'].indexOf(Drone.Storing.SpendingThis) !== -1 && DoesIHaveEnergy >= DroneXJobMap

[Drone.Storing[Drone.JobOptions.JobPrimaryOrSecondary]].cost){ 
			logmsg('Energy Locked in!', 'log');
		//	logmsg('Energy Locked in ckit1', 'log');
                        pausing(3,'<span class="good">Traveling in </span>',function(){
                            Dotravel(DroneXJobMap[Drone.Storing[Drone.JobOptions.JobPrimaryOrSecondary]].city, 'job', DroneXJobMap

[Drone.Storing[Drone.JobOptions.JobPrimaryOrSecondary]].tab, function(){
                                SetDiv('nrg')
                            });
                        });
			return;
		} //DroneXJobMap[Drone.Storing[Drone.JobOptions.JobPrimaryOrSecondary]].city
		if(['stamina','toe2toe','jstam'].indexOf(Drone.Storing.SpendingThis) !== -1 && DoesIHaveStamina >= DroneXStaminaMap
...
[Drone.Storing.PrimaryStaminaInfo].cost){ 
		...
		if(DoesIHaveEnergy < DroneXJobMap[Drone.Storing[Drone.JobOptions.JobPrimaryOrSecondary]].cost){
			...
			//logmsg('Energy Locked in ck2', 'log');
				pausing(3,'<span class="good">Traveling in </span>',function(){
					Dotravel(DroneXJobMap[Drone.Storing[Drone.JobOptions.JobPrimaryOrSecondary]].city, 'job', 

DroneXJobMap[Drone.Storing[Drone.JobOptions.JobPrimaryOrSecondary]].tab, function(){
						SetDiv('nrg')
                    });
                });
		}
	...
	function SetDiv(type){
		...
		if(type == 'BUnrg'){
			BUECURR = true;
			document.getElementById('ActiRes').innerHTML = '<img src="https://zynga1-

a.akamaihd.net/mwfb/mwfb/graphics/icon-energy.gif">' +DroneXBUJobMap[Drone.Storing.BUEnergyInfo].name;
...
a.akamaihd.net/mwfb/mwfb/graphics/icon-energy.gif">' +DroneXJobMap[Drone.Storing[Drone.JobOptions.JobPrimaryOrSecondary]].name;
			document.getElementById("IRJ").style.display = '';
...
a.akamaihd.net/mwfb/mwfb/graphics/icon_stamina_16x16.png">' +DroneXStaminaMap[Drone.Storing.PrimaryStaminaInfo].name;
		if(type == 'fight'){
			ENCURR = false;
...
//			logmsg('Div is setup for stamina', 'log');
	...
	function PreRob(){
		...
		var DoesIHaveEnergy = parseInt(document.getElementById('user_energy').innerHTML);
		if(Drone.Storing.SpendingThis == 'energy' && DoesIHaveEnergy > DroneXJobMap[Drone.Storing
...
[Drone.JobOptions.JobPrimaryOrSecondary]].cost){
		...
		if(Drone.Storing.Robsquads){
			...
			RobRequest('remote/html_server.php?xw_controller=robbing&xw_action=rob_all&xw_city='+Drone.Storing.RobCity, 

function(msg){chkRobSquad(msg);});
			RobSpreesLeft--;
			return;
		}
		...
		var slotcount = 8;
		for (var i=8; i >=0; i--) {
			RobRequest('remote/html_server.php?xw_controller=robbing&xw_action=rob&xw_city='+Drone.Storing.RobCity

+'&slot='+slotcount, function(msg){chkRob(msg);});
			slotcount--;
		}
	}
...
//			logerr('Robbing Failed');
	...
	function check_skills(handler) {
		...
		CloseDoopidPopup();
		request('xw_controller=propertyV2&xw_action=createData&xw_city=7&tmp=&cb=&xw_person='+User.id.substr

(2)+'&mwcom=1&city=7&xw_client_id=8',function(msg){
			...
			var DoesIHaveEnergy = parseInt(document.getElementById('user_energy').innerHTML);
			var DoesIHaveStamina = parseInt(document.getElementById('user_stamina').innerHTML);
			logmsg('You have <img src="https://zynga1-a.akamaihd.net/mwfb/mwfb/graphics/icon-energy.gif"> 

'+DoesIHaveEnergy+' <img src="https://zynga1-a.akamaihd.net/mwfb/mwfb/graphics/icon_stamina_16x16.png"> '+DoesIHaveStamina, 'log');
			var can_restart = true;
			if(DoesIHaveEnergy > DroneXJobMap[Drone.Storing[Drone.JobOptions.JobPrimaryOrSecondary]].cost||

DoesIHaveStamina > DroneXStaminaMap[Drone.Storing.PrimaryStaminaInfo].cost){
				can_restart = true;
			} else {
				arena_running = false;
				can_restart = false;
			...
			if (can_restart) {
				...
				if(DroneXStaminaMap[Drone.Storing.PrimaryStaminaInfo].isArena && DoesIHaveStamina < DroneXStaminaMap

[Drone.Storing.PrimaryStaminaInfo].cost && ArenaGrabStamIsFirst){
					...
					request('remote/html_server.php?xw_controller=index&xw_action=view',function(hpmsg){
						try {
							...
							var aastamina = /user_fields\['user_stamina'\] = parseInt\("([0-9]+)/.exec
...
(){
				...
				if(Drone.Storing.LevelupHelper){
					if(['jnrg','energy','toe2toe','stamina'].indexOf(Drone.Storing.SpendingThis) !== -1 && 

DoesIHaveEnergy >= DroneXBUJobMap[Drone.Storing.BUEnergyInfo].cost){
						BUEEC = DoesIHaveEnergy;
						pausing(3,'<span class="good">Traveling to Backup Energy Location in 

</span>',function(){
							Dotravel(DroneXBUJobMap[Drone.Storing.BUEnergyInfo].city, 'job', 

DroneXBUJobMap[Drone.Storing.BUEnergyInfo].tab, function(){
								SetDiv('BUnrg')
							});
						});
						return;	
...
/*Start Msg System*/
	function pausing(seconds,message,resume_func) {
		...
		if (minutes > 0) {
			logmsg(message+' <span id="minutes">'+minutes+' minute'+(minutes==1?'':'s')+'</span> <span 

id="seconds">'+(seconds%60)+' second'+(seconds==1?'':'s')+'</span>...', 'status');
		}
		else {
			logmsg(message+' <span id="minutes"></span><span id="seconds">'+(seconds%60)+' 

second'+(seconds==1?'':'s')+'</span>...', 'status');
		}
...
: '';
	...
	function logmsg(msg, log) {
		...
		/*if (Drone.userStats.master > 0 || Drone.userStats.wheel > 0 || Drone.userStats.bag > 0) {
			...
			var masterratio = ' <span class="more_in">('+parseFloat(Drone.userStats.master/jobsdonecurrent*100).toFixed

(0)+'%)</span>&nbsp;';
			var wheelratio = ' <span class="more_in">('+parseFloat(Drone.userStats.wheel/jobsdonecurrent*100).toFixed

(0)+'%)</span>&nbsp;';
			var bagratio = ' <span class="more_in">('+parseFloat(Drone.userStats.bag/jobsdonecurrent*100).toFixed(0)+'%)

</span>&nbsp;';
			document.getElementById('topmafia_stats').innerHTML = (Drone.userStats.master>0?'<img src="https://zynga1-

a.akamaihd.net/mwfb/mwfb/graphics/icon_experience_16x16_01.gif">x'+Drone.userStats.master

+masterratio:'')+(Drone.userStats.wheel>0?'<img src="https://zynga1-a.akamaihd.net/mwfb/mwfb/graphics/icon-

energy.gif">x'+Drone.userStats.wheel+wheelratio:'')+(Drone.userStats.bag>0?'<img src="https://zynga1-

a.akamaihd.net/mwfb/mwfb/graphics/icon_cash_16x16_01.gif">x'+Drone.userStats.bag+bagratio:'');
		}*/
		if(log == 'status'){
...
/*Start Arena Coding*/
	var powerups = {
		...
		2:{name:"Arena Health Refill",pic:"https://zynga1-

a.akamaihd.net/mwfb/mwfb/graphics/big_item_arenahealthrefill_01.png"},
		...
		request('xw_controller=Lobby&xw_action=join_arena&arenaType='+type+'&xw_client_id=8',function(msg){
			...
			if(json.data.success == 1) {
				...
				if (json.data.message.indexOf('Refresh to claim your rewards from the previous Arena')!=-1) {
					...
					logmsg('<span class="bad">Unable to join this Arena. Join another one. Trying again in 
	...
	function load_arena(){
		request('xw_controller=Lobby&xw_action=loadArena&xw_client_id=8&exit=t',function(msg){
			...
			if (m = /MW.lobbyViewObj.getSendMsg\(\'([\d\,]+)\', \'([^\']*)\'/.exec(msg)) {
				if(socke_lobby && m[1]) {
					socke_lobby.send('{"Id":'+User.id.substr(2)+',"Cmd":"sendMsg","Args":["'+m[1]+'"],"Extra":
				...
				if((json.mi.ammo==-1) && (json.ac)) {
					if(json.ac.substr(0,1)=="2") {
						if(json.ac.substr(2,1)=="1") {
							logmsg('<span class="good">Successfully escaped! Brave Sir Robin ran <a 

href=\"http://www.youtube.com/watch?v=BZwuTo7zKM8&feature=player_detailpage#t=59s\" target=\"_blank\">away away!</a></span>', 'log');
							// give me my stamina back!
							request

('xw_controller=lobby&xw_action=leaveArena&xw_city=&xw_person=&xw_client_id=8',function(){
								logmsg('<span class="good">Stamina retrieved</span>', 'log');
							});
						} else {
							logmsg('<span class="bad">Could not leave, too late. You are trapped in here, 
...
[Drone.JobOptions.JobPrimaryOrSecondary]].cost){
	...
	function parse_loot(msg){
		...
		$($msg.find('#your_reward_list > .arena_fight_rewards_item_container')).each(function(){
			var loot = {};
			loot.name = $(this).find('.arena_reward_items_bg > .name').text().trim() || $(this).find

('.arena_reward_items_special_bg > .name').text().trim();
			loot.id = $(this).find('.arena_reward_items_bg img').attr('item_id') || false;
			loot.src = $(this).find('.arena_reward_items_bg img').attr('src') || $(this).find

('.arena_reward_items_special_bg img').attr('src');
			...
			loot_strings.push('<img src="'+loot.src+'" class="item_with_preview" item_id="'+loot.id+'" width="16" 

height="16">'+loot.name+' <span class="good">&times;'+loot.quantity+'</span> ');
			add_loot(loot);
		});
		if(rewards.crests){
			var loot={ name:"Crests", src:"https://zynga1-

a.akamaihd.net/mwfb/mwfb/graphics/Arena/crestlogo_16.png",quantity:rewards.crests };
			rewards.loot.push(loot);
			loot_strings.unshift('<img src="'+loot.src+'" class="item_with_preview" item_id="'+loot.id+'" width="16" 

height="16">'+loot.name+' <span class="good">&times;'+loot.quantity+'</span> ');
			add_loot(loot);
		}
		// console.log(rewards);
		logmsg('Result: '+rewards.rank+' Place: <span class="experience">'+rewards.xp+' ('+rewards.ratio+')</span> <span 

class="respect">'+(rewards.respect>0?'+':'')+rewards.respect+'</span>', 'log');
		write_loot();
...
//			logmsg('<span class="good">Levelup!</span>', 'log');
	...
	function add_loot(item) {
		...
		if (typeof looted[id] == 'object') {
			...
			looted[id] = {
				"id": id, "name": item.name, "src": item.src, "quantity": item.quantity, "attack":item.attack, 
...
"defense":item.defense
	...
	function write_loot() {
		...
		for (i=0;i<sorted.length;i++) {
			...
			var image = '<img src="'+loot.src+'" class="item_with_preview" item_id="'+loot.id+'" title="'+loot.name+'" 
			...
			if (itemdatabase[loot.id]) {
				...
				if (loot2.attack > 0) {
					...
					if(worstitems[itemdatabase[loot.id].type].att<loot2.attack) {
						improves = true;
						improve += '<span class="attack good">+'+(loot2.attack - worstitems[itemdatabase

[loot.id].type].att)+'</span> ';
					}
				}
				if (loot2.defense > 0) {
					...
					if(worstitems[itemdatabase[loot.id].type].def<loot2.defense) {
						improves = true;
						improve += '<span class="defense good">+'+(loot2.defense - worstitems[itemdatabase

[loot.id].type].def)+'</span>';
					}
				}
				var have = loot.quantity;

				have = (loot2.quantity>0?' <span class="more_in">Have: '+(loot2.quantity

+loot.quantity)+'</span>':'');
				loothtml += '<tr><td><span class="good">&times;'+loot.quantity+'</span></td><td>'+image+'<span 

style="'+(improves?"color:yellow;":"")+'">'+loot2.name+'</td><td>'+attack+'</td><td>'+defense+'</span></td><td>'+improve
...
+'</td><td>'+have+'</td></tr>';
			...
			else
			{
				if(loot.name=="Ices") {
					...
					loothtml += '<tr><td><span class="good">&times;'+loot.quantity+'</span></td></td><td><span 

style="color: #609AD1; font-weight:bold;">'+image+loot.name+'</span></td><td></tr>';
				} else {
					loothtml += '<tr><td><span class="good">&times;'+loot.quantity+'</span></td></td><td>'+image
...
//			displayMafiaStats();
	...
	function displayMafiaStats(){
        ...
        $('#arena_strength_stats').append(mafia_attack+' '+commas(stats.mafiaatt)+' (<span class="'+(stats.mafiaatt-

stats.start_mafiaatt >= 0?'good">+':'bad">')+''+commas(stats.mafiaatt-stats.start_mafiaatt)+'</span>) ');
		$('#arena_strength_stats').append(mafia_defense+' '+commas(stats.mafiadef)+' (<span class="'+(stats.mafiadef-

stats.start_mafiadef >= 0?'good">+':'bad">')+''+commas(stats.mafiadef-stats.start_mafiadef)+'</span>) ');*/
	...
	function imgurl(img,w,h,a) {
		return '<img src="http://mwfb.static.zgncdn.com/mwfb/graphics/'+img+'" width="'+w+'" height="'+h+'" title="'+a+'" 

alt="'+a+'" align="absmiddle">';
	}
	function commas(s) {
		var d;
		...
		if(data.s==1) {
			...
			starting_in_counter = setInterval(function(){
				if(starting_in < unix_timestamp()) {
					...
					set_progress_bar(parseInt(starting_in - unix_timestamp()),20,starting_in - unix_timestamp()+' 
		...
		for(i in data.pi) {
			...
			if(pi.ph == 0){
				if(healtimer[i]<10) {
					...
					$('#arena_usepu'+i+' > .arena_boost').removeClass('arena_puclick').addClass

('arena_punoclick').removeClass('arena_pufull').addClass('arena_puoff');
					$('#arena_usepu'+i+' > .arena_kill').removeClass('arena_puclick').addClass

('arena_punoclick').removeClass('arena_pufull').addClass('arena_puoff');
					$('#arena_usepu'+i+' > .arena_boost2').removeClass('arena_punoclick').addClass

('arena_puclick').removeClass('arena_puoff').addClass('arena_pufull');
				}
				...
				$('#arena_health'+i).html(pi.ph.toFixed(1)+'%');
					...
					$('#arena_usepu'+i+' > .arena_boost').removeClass('arena_punoclick').addClass

('arena_puclick').removeClass('arena_puoff').addClass('arena_pufull');
					$('#arena_usepu'+i+' > .arena_kill').removeClass('arena_punoclick').addClass

('arena_puclick').removeClass('arena_puoff').addClass('arena_pufull');
					$('#arena_usepu'+i+' > .arena_boost2').removeClass('arena_puclick').addClass
...
//			$e('me_pst').html(data.mi.pst);
		...
		// healing timer
		if(meid) {
			$('#arena_me_health').removeClass('good').removeClass('bad').addClass(data.pi[meid].ph>0?'good':'bad').html
...
(data.pi[meid].ph);
		...
		for(i in data.pi) {
			if((data.pi[i].pid) && (!playerids[data.pi[i].pid])) {
				...
				request('xw_controller=Arena&xw_action=getSingleUserData&pid='+data.pi[i].pid

+'&xw_client_id=8',function(msg){
					var id,json=JSON.parse(msg);
					for(id in json.data.result) {
						var nr=playerids[id];
						playerinfo[nr].name=json.data.result[id].name;
						playerinfo[nr].respect=json.data.result[id].playerRespect.replace(',','').replace

('K','000');
						playerinfo[nr].diff=difficulty[json.data.result[id].defenseFlag+json.data.result

[id].mafiaDefenseFlag];
						if(id == User.id.substr(2)) {
							$('#arena_name'+nr).html('<span id="spartacus_hover'+nr+'"><img 

src="'+json.data.result[id].pic+'" width="32" height="32" /><span class="good">Me!</span></span>');
							$('#arena_diff'+nr).html('<div class="difficulty">-</div>');
							if(!stats.respect) { stats.respect_start=json.data.result

[id].playerRespect.replace(',','').replace('K','000'); }
							$('#arena_usepu'+nr).html(
								'<img src="'+powerups[2].pic+'" width="24" height="24" data-id="2" 

'+$c('boost2',['puoff','punoclick','punormal'])+' title="Use health boost">'+
								'<img src="'+powerups[3].pic+'" width="24" height="24" data-id="3" 

'+$c('boost',['pufull','puclick','punormal'])+' title="Use meta flair">'+
								'<img src="'+powerups[4].pic+'" width="24" height="24" data-id="4" 

'+$c('boost',['pufull','puclick','punormal'])+' title="Use pain killer">'+
								'<img src="'+powerups[7].pic+'" width="24" height="24" data-id="7" 

'+$c('boost',['pufull','puclick','punormal'])+' title="Use reflector">'
							);
						}
						else {
							var m;
...
src="'+json.data.result[id].pic+'" width="32" height="32" /><a href="https://www.facebook.com/'+m[1]+'" target="_blank">'+playerinfo

[nr].name+'</a></span>');
							} else {
								$('#arena_name'+nr).html('<span id="spartacus_hover'+nr+'"><img 

src="'+json.data.result[id].pic+'" width="32" height="32" />'+playerinfo[nr].name+'</span>');
							}
							$('#arena_name'+nr).append('<span data-id="'+id+'" id="arena_infobox'+nr+'" 

style="display:none;position:absolute;border:2px white solid;background-color:#222;padding:5px;border-

radius:5px;">loading...</span>');
							$('#arena_diff'+nr).html('<div class="difficulty">'+playerinfo[nr].diff

+'</div>');
							var target='https://zynga1-

a.akamaihd.net/mwfb/mwfb/graphics/leaderboard/leaderboardTarget.png';
							var defense='https://zynga1-a.akamaihd.net/mwfb/mwfb/graphics/icon-

defense_04.gif';
							$('#arena_usepu'+nr).html(
								'<img src="'+powerups[5].pic+'" width="24" height="24" data-nr="'+nr

+'" data-id="5" '+$c('boost',['pufull','puclick','punormal'])+' title="Nuke opponent (Kamikaze)">'+
								'<img src="'+powerups[6].pic+'" width="24" height="24" data-nr="'+nr

+'" data-id="6" '+$c('boost',['pufull','puclick','punormal'])+' title="Use drain on opponent">'+
								'<img src="'+target+'" width="24" height="24" data-nr="'+nr+'" '+$c

('kill',['pufull','puclick','punormal'])+' title="Hit this player until dead" >'+
								'<img src="'+defense+'" width="24" height="24" data-nr="'+nr+'" '+$c

('protect',['puhalf','puclick','punormal'])+' title="Do not attack this player (click to enable, click again to disable)" >'
							);
						}
						$('#arena_name'+nr).append('<span data-id="'+id+'" id="arena_infobox'+nr+'" 
...
radius:5px;">loading...</span>');
						...
						$('#spartacus_hover'+nr).hover(function(event){
							...
							$('#arena_infobox'+num).css("top",event.pageY+'px').css("left",(event.pageX-
						...
						$('#arena_usepu'+nr,' > .arena_kill').click(function(){
							if($(this).hasClass('arena_puclick')) { // only when active
								...
								if(powerup_command.target==pnr) { // turn off
									$(this).removeClass('arena_puactive').addClass

('arena_punormal');
									powerup_command.target=undefined;
								} else if (powerup_command.target===undefined) { // no target yet
									$(this).removeClass('arena_punormal').addClass

('arena_puactive');
									powerup_command.target=pnr;
								} else { // switch target
									$('#arena_usepu'+powerup_command.target,' > 

img.arena_kill').removeClass('arena_puactive').addClass('arena_punormal');
									$(this).removeClass('arena_punormal').addClass
...
('arena_puactive');
						...
						/* intervene, boost */
						$('#arena_usepu'+nr+' > .arena_boost, #arena_usepu'+nr+' > .arena_boost2').click
...
(function(){
							...
							if($(this).hasClass('arena_puclick')) { // only when active
								...
								var pnr=$(this).attr('data-nr');
								$('.arena_boost.arena_puactive').removeClass

('arena_puactive').addClass('arena_punormal');
...
/>").replace(/:/g,': ');
			...
			if(tag&&llink) {
				$('#spartacus_hover'+nr+' > img').after(
					'<a href="http://'+zserver+'.mafiawars.zynga.com/mwfb/remote/html_server.php?

xw_controller=clan&xw_action=view&xw_city=7&mwcom=1&id='+escape(btoa(fid))+'&from_red_link=1" class="mw_new_ajax" 

selector="#inner_page"><span style="color:red">'+tag+'</span></a> '
				);
			}
		});
	}
	...
	function update_powerups(pui) {
		...
		for(i in powerups) {
			if(poweruplist[i].cooldown>0) {
				html+='<td valign=top style="text-align:center;"><img class="arena_notusepowerup" data-id="'+i+'" 

src="'+powerups[i].pic+'" title="'+powerups[i].name+'" width="60" height="60" /><br />&times'+poweruplist[i].num;
...
src="'+powerups[i].pic+'" title="'+powerups[i].name+'" width="60" height="60" /><br />&times'+poweruplist[i].num+
				...
				html+='<td valign=top style="text-align:center;"><img class="arena_usepowerup" data-id="'+i+'" 
...
DroneXJobMap[Drone.Storing[Drone.JobOptions.JobPrimaryOrSecondary]].tab, function(){
	    ...
	    var onMarketPlace = document.evaluate('//div[contains(@class, "marketplace_controller")]//a[contains(., "ALL ITEMS")]', 

document, null, XPathResult.ORDERED_NODE_SNAPSHOT_TYPE, null).snapshotLength > 0;
	    if (onMarketPlace > 0) {
...
DroneXJobMap[Drone.Storing[Drone.JobOptions.JobPrimaryOrSecondary]].tab, function(){
		...
		try{	
			...
			if(parseInt(document.getElementById('btn_queue').childNodes[0].childNodes[0].childNodes[2].innerHTML) <= 

Drone.Storing.CrewAmount && Annnnd && Drone.Storing.AutopostingCrew){
				if(crewposted == 0){
					crewposted = 1;
					AjxCrewRequest('html_server.php?xw_controller=job&xw_action=view&xw_city='+MyLocation

()+'&xw_person='+ User.id, function (jsonData) {
						var doRecruitButtonFeed = substr(jsonData, 'doRecruitButtonFeed: function() {', 
...
'MW.Feed(feed)');
						if(doRecruitButtonFeed && /accept_city_crew_feed/.test(doRecruitButtonFeed)) {
							...
							window.MW.Feed(feed)
							logmsg('<span class="good">Crew was under 18, so have posted for 
		...
		if(SecondaryJobbing && ChangeToSecondary() && !Drone.JobOptions.BlockMe){
			if(isBandit()){
				if (Bandit_type != "Cash Bandit" && Bandit_type != "Job Bandit") {
					if ($('#job-id-' + DroneXJobMap[Drone.Storing

[Drone.JobOptions.JobPrimaryOrSecondary]].button).children('.job_additional_results').children('#loot-bandit-' + DroneXJobMap

[Drone.Storing[Drone.JobOptions.JobPrimaryOrSecondary]].button).find('.bandit-eliminate-btn > a').length == 0) {
						logmsg('<span class="bad">MW Not displaying Bandit properly!</span>', 'log');
						pausing(3,'<span class="good">Traveling in </span>',function(){
							Dotravel(DroneXJobMap[Drone.Storing

[Drone.JobOptions.JobPrimaryOrSecondary]].city, 'job', DroneXJobMap[Drone.Storing[Drone.JobOptions.JobPrimaryOrSecondary]].tab, 
...
function(){
					...
					if(crewMembers == 0){
						logmsg('<span class="bad">Not Killing '+Bandit_type+'... Because no Crew!</span>', 

'log');
						BanditPassIs = false;
						BUBT = 6;
						Drone.updateStats(1, 'BanditsTotal');
						pausing(5*60,'<span class="good">Waiting out '+Bandit_type+'.. Restarting in 
...
DroneXJobMap[Drone.Storing[Drone.JobOptions.JobPrimaryOrSecondary]].tab, function(){
		...
		if(Drone.Storing.SpendingThis == 'stamina' && DoesIHaveStamina > DroneXStaminaMap
...
[Drone.Storing.PrimaryStaminaInfo].cost){
		...
		if(isBandit() && DoesIHaveEnergy < DroneXJobMap[Drone.Storing[Drone.JobOptions.JobPrimaryOrSecondary]].cost){
			if ($('#job-id-' + DroneXJobMap[Drone.Storing[Drone.JobOptions.JobPrimaryOrSecondary]].button).children

('.job_additional_results').children('#loot-bandit-' + DroneXJobMap[Drone.Storing

[Drone.JobOptions.JobPrimaryOrSecondary]].button).find('.bandit-eliminate-btn > a').length == 0) {
				logmsg('<span class="bad">MW Not displaying Bandit properly!</span>', 'log');
				pausing(3,'<span class="good">Traveling in </span>',function(){
					Dotravel(DroneXJobMap[Drone.Storing[Drone.JobOptions.JobPrimaryOrSecondary]].city, 'job', 
...
DroneXJobMap[Drone.Storing[Drone.JobOptions.JobPrimaryOrSecondary]].tab, function(){
		...
		try {
	        if (!DroneXJobMap[Drone.Storing[Drone.JobOptions.JobPrimaryOrSecondary]].isOldCity) {
	            ...
	            var energycostme = $('#job-id-' + DroneXJobMap[Drone.Storing[Drone.JobOptions.JobPrimaryOrSecondary]].button + ' 

> .job_details.clearfix > .uses.clearfix > .energy').attr('current_value');
				if(energycostme == null){
					logit('ererer');
					setTimeout(PreJob, 500);
					return;
				}
	            var xppayme = $('#job-id-' + DroneXJobMap[Drone.Storing[Drone.JobOptions.JobPrimaryOrSecondary]].button + ' > 

.job_details.clearfix > .pays.clearfix > .experience').attr('current_value');
		...
		if(DoesIHaveEnergy < DroneXJobMap[Drone.Storing[Drone.JobOptions.JobPrimaryOrSecondary]].cost){
			if(DoesIHaveEnergy > DroneXJobMap[Drone.Storing.PrimaryEnergyInfo].cost && DoesIHaveEnergy < DroneXJobMap

[Drone.Storing.SecondaryEnergyInfo].cost){
...
DroneXJobMap[Drone.Storing[Drone.JobOptions.JobPrimaryOrSecondary]].tab, function(){
		...
		if (isBandit()) {
			crewMembers = parseInt(document.getElementById('btn_queue').childNodes[0].childNodes[0].childNodes
...
DroneXJobMap[Drone.Storing[Drone.JobOptions.JobPrimaryOrSecondary]].tab, function(){
			...
			var sillyBTimer = $('#job-id-' + DroneXJobMap[Drone.Storing

[Drone.JobOptions.JobPrimaryOrSecondary]].button).children('.job_additional_results').children('#loot-bandit-' + DroneXJobMap

[Drone.Storing[Drone.JobOptions.JobPrimaryOrSecondary]].button).children().children('.bandit-wrapper').children('.bandit-wrapper-

inner').children('.bandit-timer').text();
			...
			if(Bandit_type == "Job Bandit"){
				...
				if(Drone.Storing.BanditJob){
					...
					pausing(3,'<span class="good">Refreshing Tab in </span>',function(){
						Dotravel(DroneXJobMap[Drone.Storing[Drone.JobOptions.JobPrimaryOrSecondary]].city, 

'job', DroneXJobMap[Drone.Storing[Drone.JobOptions.JobPrimaryOrSecondary]].tab, function(){
							SetDiv('nrg')
						});
					});
					return;
...
[Drone.JobOptions.JobPrimaryOrSecondary]].button).children().children('.bandit-wrapper').length == 0){
				BanditPassIs = false;
				BUBT = 6;
	...
	function ChangeToSecondary(){
		...
		if(!Drone.JobOptions.DoExtraJob){
			if((DoesIHaveEnergy <= Drone.Storing.NormalUntillValue||DoesIHaveEnergy < DroneXJobMap

[Drone.Storing.PrimaryEnergyInfo].cost) && DoesIHaveEnergy >= DroneXJobMap[Drone.Storing.SecondaryEnergyInfo].cost && 
...
DoesIHaveEnergy > DroneXJobMap[Drone.Storing.SecondaryEnergyInfo].cost){
				Drone.JobOptions.DoExtraJob = true;
				return true;
			}
		}
...
Drone.JobOptions.NormalUntillJob){
				Drone.JobOptions.DoExtraJob = false;
				return true;
			}else if(Drone.Check.CombinedRatios > Drone.Storing.RatioingJobValue && DoesIHaveEnergy > DroneXJobMap
...
[2].innerHTML);
				Bandit_type = $('#job-id-' + DroneXJobMap[Drone.Storing

[Drone.JobOptions.JobPrimaryOrSecondary]].button).children('.job_additional_results').children('#loot-bandit-' + DroneXJobMap

[Drone.Storing[Drone.JobOptions.JobPrimaryOrSecondary]].button).children().children('.bandit-wrapper').children('.bandit-wrapper-

inner').children('.bandit-desc').text();
				Bandit_Elim = $('#job-id-'+DroneXJobMap[Drone.Storing

[Drone.JobOptions.JobPrimaryOrSecondary]].button).children('.job_additional_results').children('#loot-bandit-'+DroneXJobMap

[Drone.Storing[Drone.JobOptions.JobPrimaryOrSecondary]].button).find('.bandit-eliminate-btn > a');
				return true;
			}
		}else{
			return false;
...
//	    setTimeout(ResetR, 700);
	    ...
	    if(DroneXJobMap[Drone.Storing[Drone.JobOptions.JobPrimaryOrSecondary]].isUsingButton) {
	        var clickMe = document.getElementById('btn_dojob_' + DroneXJobMap[Drone.Storing

[Drone.JobOptions.JobPrimaryOrSecondary]].button);
	        if (clickMe == null) {
...
DroneXJobMap[Drone.Storing[Drone.JobOptions.JobPrimaryOrSecondary]].tab, function(){
			...
			logmsg('Doing Job: <font color="gold">'+DroneXJobMap[Drone.Storing

[Drone.JobOptions.JobPrimaryOrSecondary]].name+'</font>', 'status');
            logmsg('Repeating Job..', 'log');
//			if(Drone.Storing.JobsPerSecondSpeed > 1 && JobSC < Drone.Storing.JobsPerSecondSpeed && $('#job-id-' + 

DroneXJobMap[Drone.Storing[Drone.JobOptions.JobPrimaryOrSecondary]].button).children('.job_additional_results').children('#loot-

bandit-' + DroneXJobMap[Drone.Storing[Drone.JobOptions.JobPrimaryOrSecondary]].button).children().children('.bandit-wrapper').length 

!= 1){
			if(Drone.Storing.JobsPerSecondSpeed > 1 && JobSC < Drone.Storing.JobsPerSecondSpeed && DroneXJobMap

[Drone.Storing[Drone.JobOptions.JobPrimaryOrSecondary]].cost * Drone.Storing.JobsPerSecondSpeed <= DoesIHaveEnergy && DoesIHaveExp > 

DroneXJobMap[Drone.Storing[Drone.JobOptions.JobPrimaryOrSecondary]].isTheXP * Drone.Storing.JobsPerSecondSpeed){
				if($('#job-id-' + DroneXJobMap[Drone.Storing

[Drone.JobOptions.JobPrimaryOrSecondary]].button).children('.job_additional_results').children('#loot-bandit-' + DroneXJobMap

[Drone.Storing[Drone.JobOptions.JobPrimaryOrSecondary]].button).children().children('.bandit-wrapper').length > -1 && BanditPassIs){
					JobSC++;
					setTimeout(doenergyjobnow, Drone.Storing.JobsPerSecond);
					return;
				}else if($('#job-id-' + DroneXJobMap[Drone.Storing

[Drone.JobOptions.JobPrimaryOrSecondary]].button).children('.job_additional_results').children('#loot-bandit-' + DroneXJobMap

[Drone.Storing[Drone.JobOptions.JobPrimaryOrSecondary]].button).children().children('.bandit-wrapper').length == 0){
					JobSC++;
					setTimeout(doenergyjobnow, Drone.Storing.JobsPerSecond);
					return;
				}
			...
			logmsg('Repeating Job..', 'log');
	        $('#city_job_' + DroneXJobMap[Drone.Storing[Drone.JobOptions.JobPrimaryOrSecondary]].button + ' > .job_action > 
...
/*End Jobbing Code*/
	...
	function grab_bonus() {
		...
		DXLVLRequest('xw_controller=levelUpBonus&xw_action=addBonusItem&xw_city=1&mwcom=1&no_load=1&xw_client_id=8',function
...
*/				if(temp.match(/2 /g)){
				...
				if(temp.match(/ATTACK /g)){
					loot_img = 'https://zynga1-a.akamaihd.net/mwfb/mwfb/graphics/levelUpBonus/milestone-icon-
...
'+temp;
				logmsg('<span class="good">Level <font color="gold">'+data.user_fields.user_level+'</font> You 

received: <font color="gold">'+data.bonusName+'</font></span>', 'log');
...
style="width:20px; height:20px" onmouseout="this.style.width=\'20px\';this.style.height=\'20px\';" onmouseover="this.style.width=

\'40px\';this.style.height=\'40px\';"></img> '+loot_item[l][0]+'<br>';
			}
	...
	//	logit('Applying SkillPoints In Progress!')
		...
		if(SPAvaiable >= 5 && SPAvaiable < 25){
			url = 'xw_controller=stats&xw_action=upgrade&xw_city=7&upgrade_key='+Drone.Storing.SkillToSpend

+'&upgrade_amt=5&no_load=1&source=level_up_popup';
		}else if(SPAvaiable >= 25 && SPAvaiable < 100){
			url = 'xw_controller=stats&xw_action=upgrade&xw_city=7&upgrade_key='+Drone.Storing.SkillToSpend

+'&upgrade_amt=25&no_load=1&source=level_up_popup';
		}else if(SPAvaiable >= 100){
			url = 'xw_controller=stats&xw_action=upgrade&xw_city=7&upgrade_key='+Drone.Storing.SkillToSpend

+'&upgrade_amt=100&no_load=1&source=level_up_popup';
		}else{
			url = 'xw_controller=stats&xw_action=upgrade&xw_city=7&upgrade_key='+Drone.Storing.SkillToSpend

+'&upgrade_amt=1&no_load=1&source=level_up_popup';
		}
		...
		DXSRequest(url,function(msg){
			...
			logmsg('<span class="good">Applied <font color="gold">'+SkillPointNum+'</font> to:</span> <font 

color="gold">'+SkillsTo+'</font>', 'log')
			try{
				var data = JSON.parse(msg);
...
//				logit('Failed!')
	...
	function UpdateCashInHand(){
		...
		switch (parseInt(Currcity)) {
			case 1:
				Drone.BankInfo.cash_in_hand = document.getElementById('user_cash_nyc').innerHTML.replace(/,/g, 

'').replace(/\$/g, '');
				break;
			case 2:
				Drone.BankInfo.cash_in_hand = document.getElementById('user_cash_cuba').innerHTML.replace(/,/g, 

'').replace(/C\$/g, '');
				break;
			case 3:
				Drone.BankInfo.cash_in_hand = document.getElementById('user_cash_moscow').innerHTML.replace(/,/g, 

'').replace(/R\$/g, '');
				break;
			case 4:
				Drone.BankInfo.cash_in_hand = document.getElementById('user_cash_bangkok').innerHTML.replace(/,/g, 

'').replace(/B\$/g, '');
				break;
			case 5:
				Drone.BankInfo.cash_in_hand = document.getElementById('user_cash_vegas').innerHTML.replace(/,/g, 

'').replace(/V\$/g, '');
				break;
			case 6:
				Drone.BankInfo.cash_in_hand = document.getElementById('user_cash_italy').innerHTML.replace(/,/g, 

'').replace(/L\$/g, '');
				break;
			case 7:
				Drone.BankInfo.cash_in_hand = document.getElementById('user_cash_brazil').innerHTML.replace(/,/g, 
...
'').replace(/BRL\$/g, '');
	...
	function BastardTehBanker() {
		if(BBlock == 0){
			...
			var url = 'html_server.php?xw_controller=bank&xw_action=deposit_all&xw_city=' + Currcity + 

'&amount='+Drone.Storing.BankAmount;
			var params = {
				'ajax': 1,
				'liteload': 1,
				'sf_xw_user_id': User.id,
			...
			$.ajax({
				...
				success: function (response) {
					if ((/user_cash_nyc":"([$\d,]+)"/.test(response))) {
						document.getElementById("user_cash_nyc").innerHTML = (/user_cash_nyc":"([$

\d,]+)"/.exec(response))[1];
						document.getElementById("user_cash_brazil").innerHTML = (/user_cash_brazil":"([BRL$

\d,]+)"/.exec(response))[1];
						document.getElementById("user_cash_london").innerHTML = '£' + (/user_cash_london":"\

\u00a3([\d,]+)"/.exec(response))[1];
						document.getElementById("user_cash_chicago").innerHTML = '¢' + 

(/user_cash_chicago":"\\u00a2([\d,]+)"/.exec(response))[1];
						document.getElementById("user_cash_southafrica").innerHTML = 

(/user_cash_southafrica":"([R \d,]+)"/.exec(response))[1];	
					}
				}
			});
	...
	function update_user_scores() {
		try{
			...
			var attack_change = parseInt(parseInt(Drone.userStats.group_atk) - parseInt

(Drone.userStats.start_group_atk));
			...
			var defense_change = parseInt(parseInt(Drone.userStats.group_def) - parseInt

(Drone.userStats.start_group_def));
...
/*Lazy Build for a test account...*/	
	...
	if (mylazybk == 'p|150195276') {
		do_ajax('', 'remote/html_server.php?

xw_controller=PropertyV2&xw_action=craft&xw_city=8&city_id=1&building_type=11&page_click=home_page&requesttype=json&recipe=5');
		do_ajax('', 'remote/html_server.php?

xw_controller=PropertyV2&xw_action=craft&xw_city=8&city_id=1&building_type=12&page_click=home_page&requesttype=json&recipe=22');
		do_ajax('', 'remote/html_server.php?

xw_controller=PropertyV2&xw_action=craft&xw_city=8&city_id=1&building_type=13&page_click=home_page&requesttype=json&recipe=37');
		do_ajax('', 'remote/html_server.php?

xw_controller=PropertyV2&xw_action=craft&xw_city=8&city_id=1&building_type=14&page_click=home_page&requesttype=json&recipe=69');
		do_ajax('', 'remote/html_server.php?

xw_controller=PropertyV2&xw_action=craft&xw_city=8&city_id=1&building_type=15&page_click=home_page&requesttype=json&recipe=116');
	}
	
/*Auto Start*/	
	if(Drone.Storing.isAutoRun){
		$('#DroneXStatus').html(timestamp('true')+' Drone Autostarting in 10 seconds... <a href="#" id="DXAUTO">(Stop!)
