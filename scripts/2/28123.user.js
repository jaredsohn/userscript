...
// @name           AdcTools
// @namespace      Adctips
// @description    ferramentas para a aliança Adc
// @include        http://*ikariam.*/index.php*
// @author         Original por Verx - Modificado por Lourix para Adc
// @version        20080609 160713 
// ==/UserScript==
...
+ '     <li><center><a target="_blank" href="http://ikariam.ogame-world.com/es/suche.php?view=suche_spieler" title=" Procura as cidades e coordenadas em que se encontra um jogador ">Procura Jogadores</a></li>'
+ '     <li><center><a target="_blank" href="http://ikariam.ogame-world.com/es/suche.php?view=suche_insel" title=" Procura as coordenadas de uma ilha">Procura Ilha</a></li>'
+'</ul>'
+'</DIV>';
