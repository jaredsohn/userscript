...
switch(sLang) {
	...
	case "de":  //by Metador
		...
		aLangTasks = ["Gebäude bauen", "Ausbau von", "Angriff", "Unterstützung", "verbessern", "Transport", "Trade"];
	...
	case "ae":
		aLangBuildings = ["", "الحطاب", "حفرة الطين", "منجم حديد", "حقل القمح", "معمل النشارة", "اعمال البناء", "حديد مسبك", "المطاحن", "مخبز", "مخزن", "مخزن الحبوب", "حداد", "مستوع الاسلحة", "ساحة البطولة", "المبنى الرئيسي", "نقطة التجمع", "السوق", "السفارة", "ثكنه", "الاسطبل", "المصانع الحربية", "الاكاديميه الحربية", "المخبأ", "البلدية", "السكن", "قصر", "غرفة الكنز", "المكتب التجاري", "ثكنة كبيرة", "اسطبل كبير", "سور القريه", "سور القرية", "الحاجز", "الحجار", "مصنع العصير", "الصياد", "قصر الأبطال", "مخزن كبير للمواد الخام", "ذاكرة حبوب كبيرة", "معجزه العالم"];
		aLangTasks = ["انشاء", "رفع مستوى", "هجوم", "اعادة بحث", "نقل", "تصدير", "بيع"];
		aLangStrings = ["انشاء لاحقا", "تطوير لاحقا", "الهجوم لاحقا", "اعادة البحث لاحقا", "جدولة المهام اللاحقة","سوف يبدء الانشاء", "سطو غير معروف النتائج", "المستوى", " لايمكن الانشاء", " لايمكن التطوير", "تم جدولة المهام", "العمل احالي", "لا يمكن جدولة هذه المهمه الان.", "مهم مجدولة غير متاحة", "اعمال مجدوله", "حذف", "ارسال لاحقا", "الاخبار","جيوشك لا يمكن ارسالها الى", "جيوشك لا يمكن ارسالها الى", "دعم", "هجوم", "غارة", "صوب المقلاع نحو","عَشْوائِي", "الى", "لاحقا", "ثانية", "دقيقة", "ساعة", "يوم", "التجسس على الجيوش و الموارد", "التجسس على الجيوش و الدفعات", "الطريقة", "لا يمكن جدولة الهجوم لان المنطقة المحددة غير دقيقة","لا يوجد في ذلك المكان", "الفرز بواسطة:", "نوع ", "الوقت ", "الهدف ", "خيارات ", "قرى ", "سجل المهام", "سجل الانتصارات","سوف يبدا اعدة البحث ", " لايمكن اعادة البحث"];
		aLangTroops[0] = ["Legionnaire", "Praetorian", "Imperian", "Equites Legati", "Equites Imperatoris", "Equites Caesaris", "Battering Ram", "Fire Catapult", "Senator", "Settler", "Hero"];  //Romans
		aLangTroops[1] = ["Clubswinger", "رامي", "Axeman", "مستكشف", "Paladin", "Teutonic Knight", "Ram","Catapult", "Chief", "Settler", "البطل"];  //Teutons
		aLangTroops[2] = ["Phalanx", "Swordsman", "Pathfinder", "Theutates Thunder", "Druidrider", "Haeduan", "Ram", "Trebuchet", "Chieftain", "Settler", "البطل"];  //Gauls
		aLangTransModel= ["اسلوب مختلط", "الطعام فقط", "المصدر فقط", "اسلوب االتعديلl"];
		aLangStringt   = ["منزل الجنود", "النق التلقائي", "تجارة تلقائية", "التجار", "من", "الى", "ارسال بواسطة", "وقت التكرار", "دقائق", "ثواني", "وقت النقل:", "مرة", "الوقت المتبقي للشحن التالي:", "اضيف ذلك", "المهم تنفذ", "عدد التجار غير كفي", "خطا في النقل", "المهم الاحقه ", "مصدر القمح: ", "Autotrade has done.", "Autotrade failed.", "مصدر الموارد:", "خشب", "طين", "حديد", "قمح", "تقسيم ميساوي", "طريقة التقسيم:", "تنبيه :تغيير القرية الاساسية غير مستحب", "Keep ZERO if you want to division equal among wood, clay and iron. fill the number otherwise.", "هذا هو وقت السرفر", "هذا هو وقت المنطقة","Force Trade On Scheduled Time (no delay check)"];
		break;
	...
	case "rs":  //by Sasha969
		...
		aLangTasks = ["Изгради", "Унапреди", "Нападни", "Истражи", "Обучи", "Транспортуј", "Тргуј"];
		aLangStrings = ["Изгради после", "Унапреди после", "Нападни после", "Истражи после", "Испланирај овај задатак за после.", "Почела је градња ", " покушано је са непознатим резултатом.", "ниво", " не може се иградити.", " не може се унапредити.", "Испланиран је задатак.", "Тренутна производња:", "Не може се сад испланирати овај задатак.", "Планирани задатак није доступан!", "Планирани задаци", "Обриши", "Пошаљи касније", "Трупе нису одабране.", "Ваша војска је послана на", "Ваша војска не може бити послана на", "Појачање", "Напад", "Пљачка", "Катапулти ће рушити", "случајно", "у", "или након", "секунди", "минута", "часова", "дана", "Шпијунирај ресурсе и трупе", "Шпијунирај трупе и одбрану", "далеко", "Напад не може бити испланиран јер дестинација није одређена.", "на страници бр.", "Сортирај по:", "тип ", "време ", "мета ", "опције ", "село "];
		aLangTroops[0] = ["Легионар", "Преториjанац", "Империjанац", "Извиђач", "Императорова Коњица", "Цезарева Коњица", "Ован", "Ватрени катапулт", "Сенатор", "Насељеник", "Херој"];  //Romans
		...
		aLangTransModel= ["Мешано", "Жито", "Ресурси", "Фиксно"];
		break;	
