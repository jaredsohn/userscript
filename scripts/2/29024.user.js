...
//
// ==UserScript==
// @name          friendfeed avatars
// @namespace     http://cloudforest.us/greasemonkey/
// @description   adds avatar images to friendfeed pages
// @include       http://friendfeed.com/*
// ==/UserScript==

var friendlinks = document.evaluate('//a[@uid]',document,null,XPathResult.UNORDERED_NODE_SNAPSHOT_TYPE,null);
