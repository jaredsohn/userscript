/**
 * JournalFen User Popup //  ID so I know which one I'm looking at
 *
 * // begin credits //
 *
 ...
 *
 * Modified for JournalFen by Nostariel/Noxumbra
...
// ==UserScript==
// @name      JournalFen User Popup
// @namespace     jf_userpopup
...
function mouseover(ev) {
  ...
  timer = window.setTimeout(function() {
    ...
    div.id = 'lj_userpopup';
    div.style.cssText = 'border: 1px black solid; padding: 10px; background: WhiteSmoke; color: Black; font-family: Arial, sans-serif; position: absolute; z-index: 2001; left: ' +
  ...
  if (account == ACCOUNT_USER) {
    profileAHREF = '<a style="color: MidnightBlue;" href="http://www.journalfen.net/users/' + userID + '/profile?mode=full">';
    popupText = profileAHREF + '<img src="http://www.journalfen.net/img/userinfo.gif" alt="[?]" style="border: 0pt none; vertical-align: bottom;" height="17" width="17"></a>';
    popupText += '<b><a href="http://www.journalfen.net/users/' + userID + '">' + userName + '</a></b><br/>';
    popupText += mainPopupSpanHTML;
    popupText += '&bull; ' + profileAHREF + 'User Info</a><br/>';
    popupText += '&bull; <a style="color: MidnightBlue;" href="http://www.journalfen.net/allpics.bml?user=' + userID + '">User Pics</a><br/>';
   /* popupText += '&bull; <a href="http://www.journalfen.net/users/' + userID + '/calendar">Archive</a><br/>'; */
    popupText += '&bull; <a style="color: MidnightBlue;" href="http://www.journalfen.net/users/' + userID + '/friends">Friends</a><br/>';
    popupText += '&bull; <a style="color: MidnightBlue;" href="http://www.journalfen.net/users/' + userID + '/tag/">Tags</a><br/>';
    popupText += '&bull; <a style="color: MidnightBlue;" href="http://www.journalfen.net/tools/memories.bml?user=' + userID + '">Memories</a><br/>';
    popupText += '&bull; <a style="color: MidnightBlue;" href="http://www.journalfen.net/inbox/compose.bml?user=' + userID + '">Send PM</a><br/>';
    popupText += '&bull; <a style="color: MidnightBlue;" href="http://www.journalfen.net/friends/add.bml?user=' + userID + '">Add Friend</a>';
/*     popupText += '&bull; <a href="http://www.journalfen.net/manage/subscriptions/user.bml?journal=' + userID + '">Track</a>'; */
    popupText += '</span>';
    popupText += '<a href="http://www.journalfen.net/allpics.bml?user=' + userID + '" title="View All Icons"><span id="' + getUserPicSpanID(userID, account) + '" style="margin-left:10px">' + LOADING + '</span></a><br/>';
    /* popupText += '<center><a style="color: MidnightBlue;" href="http://www.journalfen.net/allpics.bml?user=' + userID + '">User Pics</a></center>'; */
  } 
  	// Community
		else if (account == ACCOUNT_COMMUNITY) {
    profileAHREF = '<a style="color: MidnightBlue;" href="http://www.journalfen.net/community/' + userID + '/profile?mode=full">';
    popupText = profileAHREF + '<img src="http://www.journalfen.net/img/community.gif" alt="[?]" style="border: none; vertical-align: bottom;" height="17" width="17"></a>';
    popupText += '<b><a href="http://www.journalfen.net/community/' + userID + '">' + userName + '</a></b><br/>';
    popupText += mainPopupSpanHTML;
    popupText += '&bull;&nbsp;' + profileAHREF + 'User Info</a><br/>';
/*     popupText += '&bull; <a href="http://www.journalfen.net/allpics.bml?user=' + userID + '">User Pics</a><br/>'; */
    popupText += '&bull; <a style="color: MidnightBlue;" href="http://www.journalfen.net/community/' + userID + '/calendar">Archive</a><br/>';
/*     popupText += '&bull; <a href="http://www.journalfen.net/community/' + userID + '/friends">Friends</a><br/>'; */
    popupText += '&bull; <a style="color: MidnightBlue;" href="http://www.journalfen.net/community/' + userID + '/tag/">Tags</a><br/>';
    popupText += '&bull; <a style="color: MidnightBlue;" href="http://www.journalfen.net/tools/memories.bml?user=' + userID + '">Memories</a><br/>';
    popupText += '&bull; <a style="color: MidnightBlue;" href="http://www.journalfen.net/friends/add.bml?user=' + userID + '">Watch</a><br/>';
    popupText += '&bull; <a style="color: MidnightBlue;" href="http://www.journalfen.net/community/join.bml?comm=' + userID + '">Join</a><br/>';
/*     popupText += '&bull; <a href="http://www.journalfen.net/manage/subscriptions/user.bml?journal=' + userID + '">Track</a>'; */
    popupText += '</span>';
    popupText += '<a style="color: MidnightBlue;" href="http://www.journalfen.net/allpics.bml?user=' + userID + '" title="View All Icons"><span id="' + getUserPicSpanID(userID, account) + '" style="margin-left:10px">' + LOADING + '</span></a>';
  }
	// RSS Feed
		else if (account == ACCOUNT_SYNDICATE) {
    profileAHREF = '<a href="http://syndicated.journalfen.net/' + userID + '/profile?mode=full">';
    popupText = profileAHREF + '<img src="http://www.journalfen.net/img/syndicated.gif" alt="[?]" style="border: none; vertical-align: bottom;" height="17" width="17"></a>';
    popupText += '<b><a href="http://syndicated.journalfen.net/' + userID + '">' + userName + '</a></b><br/>';
    popupText += mainPopupSpanHTML;
    popupText += '&bull; ' + profileAHREF + 'User Info</a><br/>';
    popupText += '</span>';
  } 
    ...
    popupText = '<img src="http://www.journalfen.net/img/openid-profile.gif" alt="[?]" style="border: none; vertical-align: bottom;" height="16" width="16">';
    popupText += '<b><a href="' + userHomepage + '">' + userName + '</a></b><br/>';
    popupText += mainPopupSpanHTML;
    popupText += '&bull; <a href="http://www.journalfen.net/userinfo.bml?userid=' + userID +
                 '&t=I">User Info</a><br/>';
    popupText += '</span>';
  }
}
...
function loadUserData(user, account) {
  ...
  var rssUrl;
  if (account == ACCOUNT_USER) {
    rssUrl = 'http://www.journalfen.net/users/' + user + '/data/rss';
  } else if (account == ACCOUNT_COMMUNITY) {
    rssUrl = 'http://www.journalfen.net/community/' + user + '/data/rss';
  } else {
    return;
  }
...
//    setTextTitleSpan(getUserTitleSpanID(user, account), getUserTitle(user));
    ...
    var tmp = new XPCNativeWrapper(window, "Image()");
    var img = new tmp.Image();
    var imageLink = "http://www.journalfen.net/userpic/" + cachedUserPic;
    img.onload = function() {
      setTextImageSpan(spanID, getUserpicHTML(imageLink));
    };
    img.src = imageLink;
...
function newLJUser(userID, userName, userHomepage, accountType) {
  ...
  base += '<img src="http://www.journalfen.net/img/' + img +
...
GM_registerMenuCommand(
        ...
        function () {
          ...
          div.innerHTML = '<table border="0" cellpadding="1" cellspacing="2"><tr><th colspan=2 align=center>JF Better Popup Settings</th></tr><tr>' +
