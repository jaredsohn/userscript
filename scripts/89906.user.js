// coding: utf-8
// ==UserScript==
// @name		Atithasos Empire Board Graphic AddOn
// @namespace	empire-board.ikariam
// @version	19
// @author		atithasos
// @description	Graphic add-on for Ikariam v3 Empire Board script (require v193 or higher).
// @require	http://www.atithasos.org/scripts/Empire_Board/Addons/Graphic/60774.user.js
...
EmpireBoard.GraphicAddon.Apply_Styles = function()
	...
	#EmpireBoardResources th.population {background: url(skin/resources/icon_population.gif) no-repeat center 0px;}
	#EmpireBoardResources th.growth {background: url(skin/icons/growth_positive.gif) no-repeat center 2px;}
	...
	#EmpireBoardResources th.incomes {background: url(skin/icons/income_positive.gif) no-repeat center center;}
	...
	#EmpireBoardBuildings th.dump {background: url(skin/img/city/building_dump.gif) no-repeat -7px -12px;}
	...
	#EmpireBoardArmy th.upkeep {background: url(skin/resources/icon_upkeep.gif) no-repeat center center;}
	]]></>.toXMLString();
