// ==UserScript==
// @name           Dutchbest Alliance Dashboard
// @author         OswaldJon
            ...
            members: {
                ...
                initMemberData: function() {
                    ...
                    for(var i in memberData) {
                        ...
                        if(memberData[i]["OnlineState"] == 2) onlinestate = "Afwezig";
                ...
                initPois: function() {
                    ...
                    this.poiTypes["3"] = "Kristal";
                    this.poiTypes["4"] = "Reactor";
                    this.poiTypes["5"] = "Wolfraam";
                    this.poiTypes["6"] = "Uranium";
                    this.poiTypes["7"] = "Vliegtuigen";
        ...
        qx.Class.define("ADUserInterface", {
            ...
            members: {
                ...
                initMenu: function() {
                    ...
                    var cctaBtn = new qx.ui.form.Button("DB Dashboard");
                    cctaBtn.set
                        ({
                            alignY: "middle",
                            width: 40,
                            height: 40,
                            toolTipText: "Alliance Dashboard",
                ...
                initADWindow: function() {
                    ...
                    var adWindow = new qx.ui.window.Window("DB Dashboard: "+this.data.getAlliance().get_Name());
                    adWindow.set({
                ...
                initAdWindowPoiTab: function() {
                    ...
                    var groupbox = new qx.ui.groupbox.GroupBox("Bezette POI's");
                    ...
                    var detailPOIBox = new qx.ui.groupbox.GroupBox("POI Detail");
                ...
                initAdWindowRankTab: function(){
                    var tab = new qx.ui.tabview.Page("POI Klassement");
                    ...
                    var tableModel = new qx.ui.table.model.Simple();
                    tableModel.setColumns([ "Type", "Klassement", "Score", "Volgende Rang", "Extra Informatie"]);
                    ...
                    var rankGeneral = new Array("Algemeen", alliance.get_Rank(), alliance.get_TotalScore(), "/");
                    var rankTib = new Array("Tiberium", rankScore[0]["r"], rankScore[0]["s"], nextSteps[0], "Bonus: "+alliance.get_POITiberiumBonus()+"/h" );
                    var rankCry = new Array("Kristal",rankScore[1]["r"], rankScore[1]["s"], nextSteps[1], "Bonus: "+alliance.get_POICrystalBonus()+"/h");
                    var rankRea = new Array("Reactor", rankScore[2]["r"], rankScore[2]["s"], nextSteps[2], "Bonus: "+alliance.get_POIPowerBonus()+"/h");
                    var rankTun = new Array("Wolfraam", rankScore[3]["r"], rankScore[3]["s"], nextSteps[3], "Bonus: "+alliance.get_POIInfantryBonus()+"%");
                    var rankUra = new Array("Uranium", rankScore[4]["r"], rankScore[4]["s"], nextSteps[4], "Bonus: "+alliance.get_POIVehicleBonus()+"%");
                    var rankAir = new Array("Vliegtuigen", rankScore[5]["r"], rankScore[5]["s"], nextSteps[5], "Bonus: "+alliance.get_POIAirBonus()+"%");
                    var rankRes = new Array("Resonator", rankScore[6]["r"], rankScore[6]["s"], nextSteps[6], "Bonus: "+alliance.get_POIDefenseBonus()+"%");
                ...
                initAdWindowMembersTab: function() {
                    var tab = new qx.ui.tabview.Page("Leden");
                    tab = this.initAbstractTab(tab);
                    tab.setLayout(new qx.ui.layout.HBox(10));

                    var groupbox = new qx.ui.groupbox.GroupBox("Leden");
                    groupbox.setLayout(new qx.ui.layout.VBox(10));
                    tab.add(groupbox, {flex:1, width: '50%'});

                    var tableModel = new qx.ui.table.model.Simple();
                    tableModel.setColumns([ "ID", "Naam", "Rang", "Punten", "Basissen", "Online", "Laatste Bezoek" ]);
                    ...
                    var detailGroupbox = new qx.ui.groupbox.GroupBox("Ledendetail");
                ...
                populateDetailMemberTab: function(data) {
                    ...
                    var infoTab = new qx.ui.tabview.Page("Gzschiedenis");
                    ...
                    for(var k in memberCities) {
                        ...
                        var noFightLabel = new qx.ui.basic.Label("Geen gevechten voor deze basis").set({
