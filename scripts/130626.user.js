...
if(body != null) {
	...
	for(i=1;i<=20;i++) {
		...
		div2.innerHTML = "<a onclick='spoiler()' title='Click to Hidden Widget'>&laquo;</a> &#8226; <a href='http://facebook.com/rifqi.cool.boyz' title='Manusia Biasa'>Created by Manusia Biasa</a>"
		}
		else {
