// ==UserScript==
// @name           Te he cagao el juego!!! Ya mismo te reinicio la cuenta! jajaja
// @description    Programador de ataques
...
LouTKSMassAttack.prototype.init = function() {
   ...
   // ***** City Layout Button ***** //
   var layoutButton = new qx.ui.form.Button("Ataques");
   layoutButton.set({appearance: "button-text-small", toolTipText: "Presione para planear ataques masivos."});
   layoutButton.addListener("click", ShowMassScheduler, false);
   qx.core.Init.getApplication().cityInfoView.buildingQueue.header.add(layoutButton, {top: 35, left: 38});
   ...
   var CityIntelButton = new qx.ui.form.Button("Recoger informacion");
   CityIntelButton.set({appearance: "button-text-small", toolTipText: "Crear Reporte de Inteligencia"});
...
function PrepareEmail()
{
   ...
   emailString += "[b]Hora de ataque de tropas[/b]: "+m+" "+d+" "+y+"@"+h+" : "+n+" : "+s+" ("+attackTime+")\n";
   emailString += "[b]Hora de ataque[/b]: Un minuto mas tarde ("+(attackTime+60*1000)+")\n\n";
   emailString += "Coordenadas: [city]"+RealTarget.getValue()+"[/city]\n\n";
   ...
   if(qx.core.Init.getApplication().sendMail != null && qx.core.Init.getApplication().currentOverlay==qx.core.Init.getApplication().sendMail && qx.core.Init.getApplication().sendMail.hasUnsaved()) {
      ...
      qx.core.Init.getApplication().sendMail.subject.setValue("Tarea de Ataques");
   }
}
...
function ShowMassScheduler() {
   if (!opts) {   // Don't reload the page, otherwise you lose the settings
      ...
      opts.setTitle("Programador de Ataques – Version 1.0");
   ...
   // Save Button
      ...
      saveButton = new qx.ui.form.Button("Programe").set({width: 120});
   ...
   // Unit Count
      var NumOfUnitsToSendLabel = new qx.ui.basic.Label("Units por Ataque").set({ width:85 });
   ...
   // Date
      ...
      var DateLabel = new qx.ui.basic.Label("Fecha de Llegada:").set({width:85});
   ...
   // Time
      ...
      var TimeLabel = new qx.ui.basic.Label("Hora de Llegada:").set({width:85});
   ...
   // City box
      ...
      var CityLabel = new qx.ui.basic.Label("Coordenadas Falsas (Limite 16 Lineas)");
...
function AddTroopInfo() {
   ...
   RealAttackDrop.add(new qx.ui.form.ListItem("Explorar",null,1));
