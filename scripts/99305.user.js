...
// @name          Wall Express
// @version       2.1
// @require       http://sizzlemctwizzle.com/updater.php?id=99305
// @description   Sederhanakan Beranda/Wall Facebook Anda.
...
sty = new Array();
sty[8] = 'friendships'; sty[12] = 'Pertemanan';
sty[161] = 'likes'; sty[283] = 'Menyukai';
sty[4] = 'Grup';
sty[1] = 'events'; sty[38] = 'events'; sty[178] = 'Acara';
sty[6] = 'photo'; sty[7] = 'photo'; sty[60] = 'photo'; sty[65] = 'photo'; sty[247] = 'Foto';
sty[5] = 'link'; sty[263] = 'Link';
sty[173] = 'application'; sty[237] = 'Aplikasi';
sty[2] = 'note'; sty[66] = 'note'; sty[68] = 'Catatan';
sty[10] = 'Hubungan';
...
extras['Pertemanan'] = {'hide':true, 'class':'sx_7265c3'};
extras['Menyukai']     = {'hide':true, 'class':'sx_eff5a1'};
extras['Grup']    = {'hide':true, 'class':'sx_cc2fb5'};
extras['Acara']    = {'hide':true, 'class':'sx_2fab9c'};
extras['Foto']    = {'hide':true, 'class':'sx_823c2e'};
extras['Link']    = {'hide':true, 'class':'sx_36ce04'};
extras['Catatan']    = {'hide':true, 'class':'sx_aeb811'};
extras['Aplikasi']    = {'hide':true, 'class':'sx_application'};
extras['Hubungan']    = {'hide':true, 'class':'sx_relationship'};
extras['Video']    = {'hide':true, 'class':'sx_video'};
extras['Aktifitas']    = {'hide':true, 'class':'sx_activities'};
...
function createBox()
{
  ...
  boxTitle.innerHTML += '<div><h4 class="uiHeaderTitle">Wall Express <small>v'+script_version+'<small></h4></div>';
