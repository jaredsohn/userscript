...
// @name           I_GTools
// @namespace      ikatips
// @description    Herraminetas para la alianza I_G
// @include        http://*ikariam.*/index.php*
// @author         Original por Verx - Modificado por Mortimer para I_G - alkan para IKOS - acadian para MSI
...
+ ' <li><h2>I_G Tools</h2>'
+ '   <ul>'
+ '     <li><center><a target="_blank" href="http://ikariamghost.superforo.net" title=" Foro de la Alianza I_G ">Foro I_G</a></li>'
+ '     <li><center><a target="_blank" href="http://ikariamghost.webcindario.com/index.php" title=" Pagina de la Alianza I_G ">WebPage I_G</a></li>'
+ '     <li><center><a target="_blank" href="http://chatikariamghost.coolix.com" title=" Chat de la Alianza I_G ">Chat I_G</a></li>'
