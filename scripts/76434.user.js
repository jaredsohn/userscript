...
// ==UserScript==
// @name           	BBCode-Edit
// @namespace      	11235813[Bande:Dritteliga Penner]fixed by tooBIG
...
// @include        	http://*serserionline*/messages/write/*
// @include        	http://*serserionline*/gang/
// @exclude		   	*change*
// @version			0.3.2
// ==/UserScript==
...
function add_funcs() {
	...
	editor.addSmilie('http://static.pennergame.de/img/pv4/dots/0_1.gif');
	editor.addSmilie('http://static.pennergame.de/img/pv4/dots/1_1.gif');
	editor.addSmilie('http://static.pennergame.de/img/pv4/dots/2_1.gif');
	editor.addSmilie('http://static.pennergame.de/img/pv4/dots/1_0.gif');
	editor.addSmilie('http://static.pennergame.de/img/pv4/dots/0_0.gif');
	editor.addSmilie('http://static.pennergame.de/img/pv4/dots/2_0.gif');
	editor.addSmilie('http://static.pennergame.de/img/pv4/dots/evade.gif');
	editor.addSmilie('http://static.pennergame.de/img/pv4/dots/warning.gif');
