...
massDiv = '<fieldset>'+
'<legend><span lang="en-us">paltalk</span> قرية الدعم 3</legend>'+
'<table>'+
'<tr>'+
'<td>Cords:'+sel+'</td>'+
'</tr>'+
'<tr>'+
'<td>X:<input size="2" id="massX" value="-100" name="x"></td>'+
'<td>Y:<input size="2" id="massY" name="y" value="133"></td>'+
...
'</tr>'+
'<tr>'+
'<td>Wood:<input size="2" id="m_wood" name="q" value="5"></td>'+
'<td>Clay:<input size="2" id="m_clay" name="qq" value="5"></td>'+
'<td>Iron:<input size="2" id="m_iron" name="qqq" value="5"></td>'+
'<td>Wheat:<input size="2" id="m_wheat" name="qqqq" value="0"></td>'+
