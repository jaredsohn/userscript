...
function functionMain(e) {
	...
	if (b==null) {
		...
		if (lang == "lt") {   // Lithuanian
			langArr[0] = "RotuÅ¡Ä—";
			langArr[1] = "KareivinÄ—s";
			langArr[2] = "ArklidÄ—s";
			langArr[3] = "DirbtuvÄ—s";
			langArr[4] = "Akademija";
			langArr[5] = "KalvÄ—";
			langArr[6] = "SusibÅ«rimo vieta";
			langArr[7] = "Turgus";
		}
                if (lang == "ae") {   // Arabic
			langArr[0] = "Ù…Ø±ÙƒØ² Ø§Ù„Ù‚Ø±ÙŠÙ‡   ";
			langArr[1] = "Ø§Ù„Ø«ÙƒÙ†Ø§Øª   ";
			langArr[2] = "Ù„Ø§Ø³Ø·Ø¨Ù„";
			langArr[3] = "Ø§Ù„ÙˆØ±Ø´Ù‡   ";
			langArr[4] = "Ø§Ù„Ø§ÙƒØ§Ø¯Ù…ÙŠÙ‡   ";
			langArr[5] = "Ø§Ù„Ø­Ø¯Ø§Ø¯   ";
			langArr[6] = "Ù†Ù‚Ø·Ø© Ø§Ù„ØªØ¬Ù…Ø¹   ";
			langArr[7] = "Ø§Ù„Ø³ÙˆÙ‚";
		}
		if (lang == "br") {   // Spanish
			...
			langArr[0] = "FÅ‘hadiszÃ¡llÃ¡s";
			langArr[1] = "Barakk";
			langArr[2] = "IstÃ¡llÃ³";
			langArr[3] = "MÅ±hely";
			langArr[4] = "AkadÃ©mia";
			langArr[5] = "KovÃ¡csmÅ±hely";
			langArr[6] = "GyÃ¼lekezÅ‘hely";
			langArr[7] = "Piac";
		}
		if (lang == "nl") {   // dutch
