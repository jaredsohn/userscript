...
function FBZ_addSideBarBanner()
{
	...
	"<BR>&nbsp;<a STYLE='text-decoration:underline' onClick='FBZ_toggleScript();'>"+FBZ_ScriptEnable_str+"&nbsp;Facebook Zoom</a> <BR>"+	
	...
	var FBZ_innerHTML_str = "<BR><a onclick='FBZ_toggleItemDisplay(document.getElementById(\"FBZ_SideBarBanner_Menu\"));'>Facebook Zoom Menu</a>" + "<BR>" + FBZ_menu_str + FBZ_like_button;	
