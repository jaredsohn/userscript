// ==UserScript==
// @name        Howrse Coat Image Swap - Iberique
// @namespace   myHowrse
// @description Swaps the v3 default coat for the v4 default coat for the breeds that use the Iberique coats
// @include     http://*.howrse.com/elevage/fiche/*
// @include     http://*.howrse.com/elevage/chevaux/cheval*
// @version     1
// ==/UserScript==
//	Barb	iberique
//	Canadian horse	iberique
//	Lusitano	iberique
//	Peruvian Paso	iberique
//	Purebred Spanish Horse	iberique

if(document.body.textContent.indexOf("Breed: Barb") > 0 || document.body.textContent.indexOf("Breed: Lusitano") > 0 || document.body.textContent.indexOf("Breed: Canadian") > 0 || document.body.textContent.indexOf("Breed: Peruvian") > 0 || document.body.textContent.indexOf("Breed: Purebred") > 0)
{
	GM_log("here!");
