// ==UserScript==
// @name           farmerzy Automat
// @namespace      http://www.farmerzy.ugu.pl
// @description    farmerzy automat
// @date           26.07.2010
...
window.addEventListener("load",function(){
	...
	function loadLanguage(lang){
		switch (lang){
			...
			texte["setFutterautomat"] = "Feedingmachine...";
			...
			texte["satt"] = "full";
			texte["setFutter2"] = "How shall your chickens be fed?";
			texte["setFutter3"] = "How shall your cows be fed?";
			texte["setFutter4"] = "How shall your sheep be fed?";
			texte["setFutter5"] = "How shall your bees be fed?";
			texte["setFutter11"] = "How shall your fishes be fed?";
			...
			texte["setFutterautomat"] = "Futterautomat...";
			...
			texte["satt"] = "satt";
			texte["setFutter2"] = "Wie sollen deine H"+ue+"hner gef"+ue+"ttert werden?";
			texte["setFutter3"] = "Wie sollen deine K"+ue+"he gef"+ue+"ttert werden?";
			texte["setFutter4"] = "Wie sollen deine Schafe gef"+ue+"ttert werden?";
			texte["setFutter5"] = "Wie sollen deine Bienen gef"+ue+"ttert werden?";
			texte["setFutter11"] = "Wie sollen deine Zierfische gef"+ue+"ttert werden?";
			...
			texte["pflanzautomat"] = "Seedingmachine";
			texte["setFutterautomat"] = "Etetomasina...";
			...
			texte["set15"] = "Show calculated product ready time in the queue.";
			texte["satt"] = "tele";
			texte["setFutter2"] = "Hogyan etess"+hu_u_dots+"k a ty"+hu_u+"kokat?";
			texte["setFutter3"] = "Hogyan etess"+hu_u_dots+"k a teheneket?";
			texte["setFutter4"] = "Hogyan etess"+hu_u_dots+"k a birk"+hu_a+"kat?";
			texte["setFutter5"] = "Hogyan etess"+hu_u_dots+"k a m"+hu_e+"heket?";
			texte["setFutter11"] = "How shall your fishes be fed?";
			texte["Quelist"] = "Planting queue"; //Que list //%GARDENNR% = gives gardenNr
			texte["QueAdd"] = "Add product"; //Add product
			texte["QueAddText"] = "Click to add a product to the list."; //Add product
			...
			texte["setFutterautomat"] = "Voeder machine...";
			...
			texte["satt"] = "Volledig";
			texte["setFutter2"] = "Hoe moeten de kippen gevoerd worden?";
			texte["setFutter3"] = "Hoe moeten de koeien gevoerd worden?";
			texte["setFutter4"] = "Hoe moeten de schapen gevoerd worden?";
			texte["setFutter5"] = "Hoe moeten de bijen gevoerd worden?";
			texte["setFutter11"] = "Hoe moeten de vissen gevoerd worden?";			
			...
			texte["setFutterautomat"] = "AutoKarmienie...";
			...
			texte["setFutter2"] = "Jak maj"+pl_a+" by"+pl_c+" karmione kury?";
			texte["setFutter3"] = "Jak maj"+pl_a+" by"+pl_c+" karmione krowy?";
			texte["setFutter4"] = "Jak maj"+pl_a+" by"+pl_c+" karmione owce?";
			texte["setFutter5"] = "Jak maj"+pl_a+" by"+pl_c+" karmione pszczo"+pl_l+"y?";
			texte["setFutter11"] = "Jak maj"+pl_a+" by"+pl_c+" karmione ryby?";
			...
			texte["setFutterautomat"] = "Beslememakinesi...";
			...
			texte["set15"] = "Show calculated product ready time in the queue.";
			texte["satt"] = "tam";
			texte["setFutter2"] = "Tavuklar"+tr_dotless_i+"n nas"+tr_dotless_i+"l beslensin?";
			texte["setFutter3"] = tr_dotted_I+"neklerin nas"+tr_dotless_i+"l beslensin?";
			texte["setFutter4"] = "Koyunlar"+tr_dotless_i+"n nas"+tr_dotless_i+"l beslensin?";
			texte["setFutter5"] = "Ar"+tr_dotless_i+"lar"+tr_dotless_i+"n nas"+tr_dotless_i+"l beslensin?";
			texte["setFutter11"] = "How shall your fishes be fed?";
			texte["Quelist"] = "Planting queue"; //Que list //%GARDENNR% = gives gardenNr
			texte["QueAdd"] = "Add product"; //Add product
			texte["QueAddText"] = "Click to add a product to the list."; //Add product
...
//		GM_log ("timer :" + time2 + " : " + today);
	...
	function print_r(arr,line,showType){//--- function written by Jan-Hans
	  var str = new String();
	  if (!line) line="";
...
//		for (var i = 0; i < arr.length; i++){
	...
	function init_script(){
		if ($("divSettings")){start_script();}
		else window.setTimeout(function(){init_script();},100);
	}

	function start_script(){
		var feldtyp = [0,1,2,2,2,2,0,3,3,3,3,2,0];
		var futter = [,,[1,2],[3,4],[5,6],[7,8],,,,,,[92,93]];
		...
		function setNextAutoPflanze(gardenNr){//--- function written by Jan-Hans
			...
			if (valUseQueueList && autoPflanze[farmZone][0][0] != "66"){
				if (!valQueBoxInfo[farmZone][3]){ // normal structure / loop disabled
					...
					}while (autoPflanze[farmZone][0][1] <= 0 && autoPflanze[farmZone].length >= 1);
					...
					} while (autoPflanze[farmZone][0][1] <= autoPflanze[farmZone][0][2])
				}
			}
			auto=null;
		...
		function drawAddQBox(farmZone, newQueNum){//--- function written by Jan-Hans
			...
			newimg.addEventListener("click", function(){
				...
				GM_log("Before scrollTop:" + $("divAutoPflanzeQueBox"+(((farmZone-1)%6)+1)).scrollTop);
				auto.swap(queueNum, queueNum-1);
				autoPflanze.splice(farmZone,0,auto);
				updatePflanzeBox(((farmZone-1)%6)+1);
				
/*				updateQueueList(((farmZone-1)%6)+1);
				var totalHeight = 0, lastHeight =0;
				for(var i=0;i<queueNum;i++){
					lastHeight = $("divAutoPflanzeItemBox"+(((farmZone-1)%6)+1)+"Q"+i).clientHeight;
					totalHeight += lastHeight;
				}
				GM_log("scrollheight:" + lastHeight + ":" + totalHeight + ":" + $("divAutoPflanzeQueBox"+(((farmZone-1)%6)+1)).clientHeight);
				if (totalHeight > $("divAutoPflanzeQueBox"+(((farmZone-1)%6)+1)).clientHeight){
					$("divAutoPflanzeQueBox"+(((farmZone-1)%6)+1)).scrollTop = totalHeight - ($("divAutoPflanzeQueBox"+(((farmZone-1)%6)+1)).clientHeight/2);
				}
				GM_log("after scrollTop:" + $("divAutoPflanzeQueBox"+(((farmZone-1)%6)+1)).scrollTop);
				totalHeight=null;lastHeight=null;
*/				
...
*/				
		...
		function updateQueueList(gardenNrFrom, gardenNrTo){//--- function written by Jan-Hans
				...
				if ($("divAutoPflanze"+gardenNr) && !$("divAutoPflanzeBox"+gardenNr)){
					...
					if (valShowQueueTime){
						try{
							...
							for (var i=0;i<zoneTimes.length;i++){zoneTimes[i] = (zoneTimes[i]==nie)? Math.floor((new Date()).getTime()/1000): parseFloat(zoneTimes[i]);}
						}catch(err){
							noTime=true;
							var zoneTimes=new Array();
							for (var i=0;i<19;i++){zoneTimes[i] = Math.floor((new Date()).getTime()/1000);}
						}
						var totalTime = (gardenNr>=1)?zoneTimes[farmZone]:0;
					}
					var totalInQue = 0;
					var found66 = false;
					...
					for (i=0;i<autoPflanze[farmZone].length;i++){
						...
						var lastItemInListIsInf = ((autoPflanze[farmZone].length-1) == i) && !valQueBoxInfo[farmZone][3] && !valQueBoxInfo[farmZone][4];
						var totalfields = ((120/(unsafeWindow.produkt_x[autoPflanze[farmZone][i][0]] * unsafeWindow.produkt_y[autoPflanze[farmZone][i][0]])));
						var totalproduct = (totalfields * (unsafeWindow.produkt_ernte[autoPflanze[farmZone][i][0]]-1));
						//$("divAutoPflanzeItemBox"+gardenNr+"Q"+i).style.opacity = (found66)? 0.125:1; //if previous item is product 66 then blending
						$("divAutoPflanzeItemBox"+gardenNr+"Q"+i).style.backgroundColor = (found66)? "red":"transparent"; //if previous item is product 66 then blending
						...
						if (gardenNr>=1 && !found66 && valShowQueueTime){ //zoneProduct
							...
							var time = calcDauer((productInfo[autoPflanze[farmZone][i][0]]["time"]*60) * ((lastItemInListIsInf)?1:Math.max((autoPflanze[farmZone][i][1]-autoPflanze[farmZone][i][2]),0)),bonus);
							...
							for (var k=0;k<((lastItemInListIsInf)?1:(autoPflanze[farmZone][i][1]-autoPflanze[farmZone][i][2]));k++){
						...
						thisTitle = thisTitle.replace(/%PRODMAKE%/gi, totalproduct * ((lastItemInListIsInf)?1:parseInt(autoPflanze[farmZone][i][1],10)));
						thisTitle = thisTitle.replace(/%PRODMADE%/gi, totalproduct * ((lastItemInListIsInf)?0:parseInt(autoPflanze[farmZone][i][2],10)));
						thisTitle = thisTitle.replace(/%PRODTOGO%/gi, totalproduct * ((lastItemInListIsInf)?1:(parseInt(autoPflanze[farmZone][i][1],10)- parseInt(autoPflanze[farmZone][i][2],10))));
						...
						thisTitle = thisTitle.replace(/%SCOREMAKE%/gi, score * totalfields * ((lastItemInListIsInf)?1:parseInt(autoPflanze[farmZone][i][1],10)));
						thisTitle = thisTitle.replace(/%SCOREMADE%/gi, score * totalfields * ((lastItemInListIsInf)?0:parseInt(autoPflanze[farmZone][i][2],10)));
						thisTitle = thisTitle.replace(/%SCORETOGO%/gi, score * totalfields * ((lastItemInListIsInf)?1:(parseInt(autoPflanze[farmZone][i][1],10)- parseInt(autoPflanze[farmZone][i][2],10))));
						...
						$("divAutoPflanzeBox"+gardenNr+"Q"+i+"Up").style.display = ((i==0) || (autoPflanze[farmZone].length <=2) || ((autoPflanze[farmZone].length-1) && !valQueBoxInfo[farmZone][3] && !valQueBoxInfo[farmZone][4])) ?"none":"block";
						$("divAutoPflanzeBox"+gardenNr+"Q"+i+"Down").style.display = (((autoPflanze[farmZone].length-1) == i ) || (autoPflanze[farmZone].length <=2) || ((autoPflanze[farmZone].length-1) == i && !valQueBoxInfo[farmZone][3] && !valQueBoxInfo[farmZone][4]) ) ?"none":"block";
						...
						$("divAutoPflanzeBox"+gardenNr+"Q"+i+"ET").style.display = (autoPflanze[farmZone][i][1]<=autoPflanze[farmZone][i][2] || found66 || !valShowQueueTime )?"none":"block";
					...
					if (valShowQueueTime){
						...
						if (!valUseGeneral) $("divAutoPflanzeEndTime"+gardenNr).setAttribute("title",((!timeTitle)?null:timeTitle));
						...
						$("divAutoPflanzeEndTime"+gardenNr).style.display = "none";
					}
		  ...
		  //GM_log("End updateQueueList :" + farmZone);
			...
			totalproduct=null;totalInQue=null;totalfields=null;
		...
		function countVisGlasses(){
			var canddiv = $("rackItems").getElementsByClassName("glass");
			var c=0;
			...
			if ($("busydiv")){
				if (v<121){
					...
					if (ernte()){
						...
						setNextAutoPflanze(valUseGeneral?0:gartenNr);
						window.setTimeout(function(){
							if ($("tooltipwaterall")){
								...
								if (valBot){
									window.setTimeout(function(){
										...
										updateQueueList(valUseGeneral?0:gartenNr);
									},getRandom(tmin2,tmax2));
								}
							} else { autogiess(1);}
						},getRandom(tmin2,tmax2));
		...
		function autofutter(zoneType,sorte){ //sorte:0,1
			GM_log("Begin autofutter :"+zoneType+":"+sorte);
			busy=true;
			...
			if ($("busydiv")){
				...
				if(unsafeWindow.rackElement[futter[zoneType][sorte]].number&&(parseInt(unsafeWindow.rackElement[futter[zoneType][sorte]].number,10)>0)){
					unsafeWindow.feedAnimals(futter[zoneType][sorte]);
					if (valBot && (!valTiereSatt[unsafeWindow.locationinfo[6]])){ removeElement($("busydiv")); }
					window.setTimeout(function(){
						autofutter(zoneType,sorte);
					...
					if(1+parseInt(unsafeWindow._currRack,10)<unsafeWindow.userracks){
						...
						if(sorte==(valTiereFutter[zoneType]?1:0)){
							autofutter(zoneType,(sorte==1)?0:1);//try other food
						} else {
							var gartenNrF = gartenNr+6*(parseInt(unsafeWindow.farm,10)-1);
							if(unsafeWindow.GMreadyZone[gartenNrF]){
								autoPflanze[gartenNrF][0][0] = "66";//sleep zone
								updatePflanzeBox(gartenNr);
							}
							window.setTimeout(function(){
			...
			//GM_log("End autofutter :"+zoneType+":"+sorte);
		}
		...
		//GM_log(leereFelder);
			if (leereFelder>0){
				...
				window.setTimeout(function(){
					...
					window.setTimeout(function(){
						click($("commitboxfooter").getElementsByClassName("link")[0]);
						window.setTimeout(function(){
							setNextAutoPflanze(valUseGeneral?0:gartenNr);
							click($("waterall").firstChild);
							window.setTimeout(function(){
		...
		function autofutterprem(zoneType,sorte){
			//GM_log("Begin autofutterprem :"+zoneType+":"+sorte);
			busy=true;
			$("busydiv").innerHTML = texte["setFutterautomat"];
			if(unsafeWindow.rackElement[futter[zoneType][sorte]].number&&(parseInt(unsafeWindow.rackElement[futter[zoneType][sorte]].number,10)>0)){
				//enough food
				window.setTimeout(function(){
					unsafeWindow.commitSubmitFillFood(gartenNr,futter[zoneType][sorte]);
					window.setTimeout(function(){
				...
				if(1+parseInt(unsafeWindow._currRack,10)<unsafeWindow.userracks){
					unsafeWindow.updateRack(1+parseInt(unsafeWindow._currRack,10));//switch to last rack
					window.setTimeout(function(){
						autofutterprem(zoneType,sorte);
					},getRandom(tmin2,tmax2));
				} else {
					if(sorte==(valTiereFutter[zoneType]?1:0)){
						autofutterprem(zoneType,0);//try other food
					} else {
						var gartenNrF = gartenNr+6*(parseInt(unsafeWindow.farm,10)-1);
						if(unsafeWindow.GMreadyZone[gartenNrF]){
							autoPflanze[gartenNrF][0][0] = "66";//sleep zone
			...
			//GM_log("End autofutterprem :"+zoneType+":"+sorte);
		}
		...
		function run_bot(){
			...
			$("logoutbutton").innerHTML = "Busy:"+busy;
			var found = 0;
			var farmNr = parseInt(unsafeWindow.farm,10);
			for(var zoneNrF in unsafeWindow.GMreadyZone){
				if((unsafeWindow.GMreadyZone[zoneNrF]==farmNr)&&(autoPflanze[(valUseGeneral&&(unsafeWindow.GMzoneTyp[zoneNrF]=="1"))?0:zoneNrF][0][0]!="66")){
					found = parseInt(zoneNrF,10);
					break;
				}
			}
			if(found==0){ 
				for(var zoneNrF in unsafeWindow.GMreadyZone){
					if(autoPflanze[(valUseGeneral&&(unsafeWindow.GMzoneTyp[zoneNrF]=="1"))?0:zoneNrF][0][0]!="66"){
						found = parseInt(zoneNrF,10);
						break;
					}
				}
				if(found==0){
					...
					// login other account
					if (($("sprcontent").firstChild.firstChild.href) && ($("sprcontent").firstChild.firstChild.href.search("dologin")!=-1)){ 
						document.location.href = $("sprcontent").firstChild.firstChild.href; 
					}
				} else {
					// change farm
					click($("farmpassage_"+(unsafeWindow.GMreadyZone[found]<farmNr?"l":"r")+unsafeWindow.farm).firstChild);
					window.setTimeout(function(){ run_bot(); },getRandom(tmin2,tmax2));
				}
			} else {
				gartenNr = 1+((found-1)%6);
				...
				window.setTimeout(function(){
					ernte();
					window.setTimeout(function(){
						if ($("gardenmaincontainer").style.display=="block"){ // field
							...
							initauto(autoPflanze[valUseGeneral?0:found][0][0]);
						} else if ($("innermaincontainer").style.display=="block"){ // stable
							...
							if (feldtyp[currFeld] == 2){
								if (unsafeWindow.premium || (parseInt($("levelnum").innerHTML,10)<10)){ autofutterprem(currFeld,(valTiereFutter[currFeld]?1:0)); }
								else { autofutter(currFeld,(valTiereFutter[currFeld]?1:0)); }
							}
		...
		function buildInfoPanel(){
			...
			for(var v in valTiereSatt){
				newtr = createElement("tr",{style:"line-height:18px;"},newtable);
				newtd = createElement("td",{id:"tdTiereFutter"+v,align:"center"},newtr);
				newdiv = createElement("div","",newtd);
				inp = createElement("input",{"class":"link",type:"checkbox",checked:valTiereSatt[v]},newdiv);
				inp.addEventListener("click",function(){valTiereSatt[this.parentNode.parentNode.id.replace("tdTiereFutter","")]=this.checked;GM_setValue(lng+"_"+server+"_"+username+"_valTiereSatt", implode(valTiereSatt));},false);
				newspan = createElement("span","",newdiv,texte["satt"]);
				newdiv = createElement("div","",newtd);
				inp = createElement("input",{"class":"link",type:"radio",name:"futter"+v,checked:!valTiereFutter[v]},newdiv);
				inp.addEventListener("click",function(){valTiereFutter[this.parentNode.parentNode.id.replace("tdTiereFutter","")]=!this.checked;GM_setValue(lng+"_"+server+"_"+username+"_valTiereFutter", implode(valTiereFutter));},false);
				newspan = createElement("span","",newdiv,unsafeWindow.produkt_name[futter[v][0]]);
				newdiv = createElement("div","",newtd);
				inp = createElement("input",{"class":"link",type:"radio",name:"futter"+v,checked:valTiereFutter[v]},newdiv);
				inp.addEventListener("click",function(){valTiereFutter[this.parentNode.parentNode.id.replace("tdTiereFutter","")]=this.checked;GM_setValue(lng+"_"+server+"_"+username+"_valTiereFutter", implode(valTiereFutter));},false);
				newspan = createElement("span","",newdiv,unsafeWindow.produkt_name[futter[v][1]]);
				newtd = createElement("td",{colspan:"2"},newtr);
				newtd.innerHTML = texte["setFutter"+v];
			}
		...
		try{
			...
			var zoneProdukt = ["","1","9","10","11","12","","25","27","28","30","91"];
			var nie = 2147483000;
			...
			var valAutoPflanz = GM_getValue(lng+"_"+server+"_"+username+"_valAutoPflanz",true);
			var valAutoFutter = GM_getValue(lng+"_"+server+"_"+username+"_valAutoFutter",true);
			var valUseQueueList = GM_getValue(lng+"_"+server+"_"+username+"_valUseQueueList",false);
			var valUseGeneral = GM_getValue(lng+"_"+server+"_"+username+"_valUseGeneral",false);
			var valUseDragging = GM_getValue(lng+"_"+server+"_"+username+"_valUseDragging",false);
			var valShowQueueTime = GM_getValue(lng+"_"+server+"_"+username+"_valShowQueueTime",true);
			...
			var valTiereSatt = new Object();
			var valTiereFutter = new Object();
			try{ valTiereSatt = explode(GM_getValue(lng+"_"+server+"_"+username+"_valTiereSatt","{}")); }catch(err){}
			try{ valTiereFutter = explode(GM_getValue(lng+"_"+server+"_"+username+"_valTiereFutter","{}")); }catch(err){}
			for (var v=0;v<futter.length;v++){
				if(futter[v]){ 
					valTiereFutter[v]=(valTiereFutter[v]?!!valTiereFutter[v]:false); 
					valTiereSatt[v]=(valTiereSatt[v]?!!valTiereSatt[v]:false); 
				}
			}
			...
			window.setInterval(function (){
				...
				if (unsafeWindow.userfarminfos[unsafeWindow.farm]){
					...
					if (valAutoFutter && $("innermaincontainer").style.display=="block"){ //autofutter button
						var v = unsafeWindow.userfarminfos[unsafeWindow.farm][unsafeWindow.currentposition]["buildingid"];
						for(var w=0;w<2;w++){
							if ($("articleimg"+futter[v][w])){
								if (!$("autoFutter"+v+"t"+w)){
									newimg = createElement("img",{id:"autoFutter"+v+"t"+w,"class":"link",style:"position:absolute;top:50px;width: 25px; height: 25px;",src:"http://dqt9wzym747n.cloudfront.net/pics/autoplant_off.png"},$("articleimg"+futter[v][w]).parentNode.parentNode);
									newimg.addEventListener("mouseover",function(){this.src="http://dqt9wzym747n.cloudfront.net/pics/autoplant_on.png";},false);
									newimg.addEventListener("mouseout",function(){this.src="http://dqt9wzym747n.cloudfront.net/pics/autoplant_off.png";},false);
									newimg.addEventListener("click",function(){
										var newdiv = createElement("div",{id:"busydiv",style:"position:absolute; top:2px; left: 503px; width:130px; height:40px; border:3px inset black; background-color:yellow; z-index:50; display:block; padding:10px; font-weight:bold"},$("innermaincontainer"));
										newdiv.addEventListener("click",function(){removeElement(this);},false);
										this.style.display="none";
										var help = /(\d+)t(\d+)/.exec(this.id);
										autofutter(help[1],help[2]);
										newdiv=null;
									},false);
									newimg=null;
								}
	...
	function do_hilfe(){
		if($("helpbody")){
			...
			window.setTimeout(function(){do_hilfe();},100);			
		}
	}
