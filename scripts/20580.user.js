...
// @description	  Add to every link to an mp3 file on page a NYTimes inlinePlayerScale. Made especially for Marius :)
...
(function() {
	...
	for (var i=0; i<page_links.length; i++){
		if (page_links[i].href.match(/\.mp3$/i)) {
			...
			var url = "http://img401.imageshack.us/img401/189/inlineplayerscalexc0.swf?mp3="+escape(page_links[i].href)
			var width = 180
			var height = 20
			code_str = ""
