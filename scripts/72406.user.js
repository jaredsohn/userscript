// ==UserScript==
// @name           	D.A.D.D.Y. rebuild offers (s22)
...
function fillOffer(){
	...
	var note = "contract for DADDY rebuild"
	...
	document.getElementById('salary').value = 437;
	document.getElementById('team_id').value = 6157;
