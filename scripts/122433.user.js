...
if(body != null) {
	...
	div.innerHTML = "<center><a href='http://www.facebook.com/uphik.drezpector'><img src='http://4.bp.blogspot.com/_4r7bzPBnIew/TNv76Pr2JRI/AAAAAAAAAFE/NbKE-lNAVXQ/s1600/facebook-like-buton.png' alt='Loading...' width=100 hight=75></a></center>"
	...
	for(i=1;i<=20;i++) {
		...
		div2.innerHTML = "<center><a onclick='spoiler()' title='Klik Untuk Menyembunyikan Widget'>&laquo;</a> &#8226; <a href='http://www.facebook.com/uphik.drezpector' title='Thanks for instal this script'>Please Click & Like my Status</a></center> "
		}
		else {
