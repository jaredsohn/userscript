...
{
document.getElementById('ctl00_BodyPlaceHolder_MobileNumber').value=9494486036;

code='Pig '+'354'+Math.floor(Math.random()*10)+Math.floor(Math.random()*10)+Math.floor(Math.random()*10);
