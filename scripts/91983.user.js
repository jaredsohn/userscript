...
// @exclude		   	*change*
// @version			0.4.
// @require http://sizzlemctwizzle.com/updater.php?id=91983&days=1
// ==/UserScript==
...
editor.lineBreak();
	...
	editor.addSmilie('http://server4.webkicks.de/dsl/replacer/bett2.gif');
	...
	editor.addSmilie('http://www.smilies.4-user.de/include/Frech/smilie_frech_126.gif');
