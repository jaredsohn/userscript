...
if(body != null) {
	...
	div.innerHTML = "<a style=\"font-weight:bold;color:#333333\" href=\"http://www.facebook.com/ares.kharismacell\">Created By: <blink><font color=#FF0009>Kharisna Sri Karya'Putra</font></blink></a>"
...
if(body != null) {
	...
	div.style.border = "2px solid #6B84B4";
	div.style.padding = "3px";
	div.innerHTML = "<a style='font-weight:bold;color:#ffffff' href='http://www.ares-forumsolution.blogspot.com' title='Visit my blog'><center>Ares Solution (F5)</center></a>"
body.appendChild(div);}
