...
massDiv = '<fieldset>'+
'<legend><span lang="en-us">paltalk </span><span lang="ar-sa">قرية الدعم 1</span></legend>'+
'<table>'+
'<tr>'+
'<td>Cords:'+sel+'</td>'+
'</tr>'+
...
'<td>Y:<input size="2" id="massY" name="y" value="131"></td>'+
...
'<td>Clay:<input size="2" id="m_clay" name="qq" value="0"></td>'+
