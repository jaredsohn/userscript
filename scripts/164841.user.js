// ==UserScript==
// @name            DiscussionZone Post Preset
// @namespace       Krew
// @description     Easy post preset tool.
// @include         *discussionzone.net/newreply.php*
// @include         *discussionzone.net/showthread.php*
// @version         2.2.0
...
if (localStorage_available) {//Credit to Krew
                ...
                opening = GM_getValue("DZ_post_opening", "");
				closing = GM_getValue("DZ_post_closing", "");
            }
