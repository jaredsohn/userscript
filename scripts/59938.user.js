...
function getVersion(){
    ...
    GM_xmlhttpRequest({
        ...
        onload: function (data) {
            ...
            $('#content').append('<div class="holder"><h2 class="section">eCompany Calc</h2><div class="indent"><div class="infoholder"><div>'+new_version_desc+'<span class="regular">Your version '+VERSION+' from '+RELEASE_DAY+'.</span><br/><span style="color:red;"><b>Attention:</b> Unfortunately, I no longer play the game. The script continues to work, but I am not sure that I can keep it on. June 1 is the deadline for lease VPS, where the backend works. If someone can provide the VPS that can run Pylons project I can help with setting it. Currently, sources are available at <a href="http://github.com/toshka/erepublik">GitHub</a>. You can contact me via email bazanton@yandex.ru</span></div></div><div class="action">'+download_button+'<span class="vround-btn-start"><span class="vround-btn-end"><a href="http://www.erepublik.com/en/citizen/donate/items/1601051" title="" class="vround-btn-core">Support eCompanyCalc</a></span></span></div>');
        }
    });
}
...
//  0.38        27 Apr 2010         - Support message
