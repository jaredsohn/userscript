...
// ==UserScript==
// @name        Google Maps OpenStreetMap Link
// @namespace   Basique
// @description Creates a link on Google Maps to view the map on OpenStreetMap
// @include     http://maps.google.tld/*
// @include     https://maps.google.tld/*
// @license     MIT License; http://www.opensource.org/licenses/mit-license.php
// ==/UserScript==

GM_registerMenuCommand("GMaps: Set OSM URL", set_url);

var url = (GM_getValue('url','http://www.openstreetmap.org/?lat=<lat>&lon=<lon>&zoom=<zoom>&layers=M'));
...
(function() {
    function addOSMLink() {
        ...
        if (targets.snapshotLength == 1) {
            ...
            "<li class=gbt><a onclick=\"" + js + "\"class=gbzt href=\"#\"><span class=gbtb2></span><span class=gbts>View on OpenStreetMaps</span></a></li>";
        }
    }
    addOSMLink();
})();
