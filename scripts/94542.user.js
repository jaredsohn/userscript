// ==UserScript==
// @name           GI Player Notes_SR
// @namespace      Grid Iron Player Notes - SR
...
// compatible with original script Grid Iron Player Notes v0.0.1.0
...
//create save link
     ...
     saveLink.innerHTML = '<span style="cursor:pointer;"><font style="'+style+'">Sačuvaj</font></span>';
...
if (url.indexOf('pldetails') > 0) {
	...
	plyrNotes.innerHTML = '<div id="player_notes" class="content_container"><font style="'+style2+'">Dodatni info:<br>' +   '<textarea cols=70 rows=2 id="txtNotes"></textarea></font><div id="stored"></div></div>';
...
function saveNotes(){
       ...
       document.getElementById('stored').innerHTML='<font color=red style="'+style2+'">uspešno sačuvano</font>';
}
