...
// @copyright 	Jomofer-DiegoCom-Anthorlop-Spacesoul-ErPichi-Tulipy
// @version		0.8.4
// @license	http://creativecommons.org/licenses/by-nc-sa/3.0/es/
// ==/UserScript==

//Actualizados equipos de la temporada 2013/2014
//Thanks to Jomofer to allow this script to be mantained!
//Gracias a Anthorlop por las mejoras introducidas Próximas jornadas - Estado jugadores
//Gracias a ErPichi Por el autologin
//Añadida calculadora de Erpichi y anthorlop por Tulipy.
//Reparado el bug que no hacia funcionar el script en tampermonkey por Tulipy
...
var version = "0.8.4";	//Version of the script. For checking for updates
...
function checkUpdate(text) {
	...
	if( text.split(".").length < 3 ){	//Error if there are not at least 3 numbers
		...
		update = '<span class="button01">Versión vieja</span>' + 
				 '<a href=# onclick=window.open("http://userscripts.org/scripts/source/88692.user.js")> Actualizar!</a>'	
	}
...
// Excluimos de la ejecucion del resto del SCRIPT cuando estamos en ciertas páginas
// exclude directive only works in FF
if (document.location.href.match('www*.comunio.es/external/*') ) {    return;}
...
images['Elche'] = 'data:image/png;base64,'
...
var teamURL = new Array;
	...
	teamURL["AS"]["Elche"] = 'http://resultados.as.com/resultados/ficha/equipo/elche/121/';
...
var invocation = new XMLHttpRequest();
	var url = 'http://ns3362617.ovh.net/script/noplayers.php';
...
var invocation = new XMLHttpRequest();
var url = 'http://ns3362617.ovh.net/script/pointplayers.php';
	...
	for( var i=0; i<tables.length; i++ )
	{
		...
		for ( var j = 0; j < tableRows.length; j++ )
		{
			...
			var td = thisRow.getElementsByTagName('td');
				if (td[playerNameCol].offsetWidth > dMaxTDWidth)				{					dMaxTDWidth = td[playerNameCol].offsetWidth;				}
...
//espera un tiempo a que se generen las filas
if (window.location.href.indexOf( "exchangemarket" ) != -1)
{
	var tabla = document.getElementById("searchTextResults");
	var filas = tabla.getElementsByTagName("tr");
	filas[0].style.display="none";
	setTimeout(collectTables, 2000);
	setTimeout(actualizaEstado, 2150);
	setTimeout(actualizaPuntos, 2170);
...
dMaxTDWidth = dMaxTDWidthF();
	...
	for( var i=0; i<tables.length; i++ ){
		...
		for ( var j = 0; j < tableRows.length; j++ ){
			...
			//Columns of the row
			var td = thisRow.getElementsByTagName('td');
			//Añadidos thisRow.getAttribute('class') == 'ng-scope tr1' || thisRow.getAttribute('class') == 'ng-scope tr2'
			//Son los ¿nuevos? nombres de clase para las filas de la tabla del mercado.
		
			if( thisRow.getAttribute('class') == 'tr1' || thisRow.getAttribute('class') == 'tr2' || thisRow.getAttribute('class') == 'ng-scope tr1' || thisRow.getAttribute('class') == 'ng-scope tr2'){		//if it is a player...
				
				playerName = td[playerNameCol].textContent.replace( /\*/g, "" );
				teamName = td[teamNameCol].textContent;
				//(teamNameCol debe ser 1, correcto).
				...
				td[playerNameCol].innerHTML = 	'<br/><a title="Ver informacion sobre jugador en Ventana Nueva" href=# onclick=window.open("http://www.nomaskeine.com/estadisticas/comunio/jugador/' + 
												idPlayer + '/' + playerName.replace(/"/g, "&quot;").replace( /\ /g, "_" ) + '?utm_source=scr","nmk","scrollbars=yes,width=740,height=600")>' +
...
if ( window.location.href.indexOf( "news" ) != -1 && window.location.href.indexOf( "edit" ) == -1 ){
	...
	var posts = document.getElementsByClassName("article_content_text");
...
//Obtain all the links from news page
var anchors = document.getElementsByTagName("a");
var enlace = "";
var newNode = document.createElement("a");
for( var i=0; i<anchors.length; i++ ){
		if (anchors[i].href.indexOf("tradableInfo")!=-1)
		{
			anchors[i].removeAttribute('onclick');
			
			enlace = anchors[i].href.replace("http://www.comunio.es/tradableInfo.phtml?tid=","http://www.nomaskeine.com/estadisticas/comunio/jugador/");
			enlace = 'openSmallWindow("'+enlace+'/'+anchors[i].innerHTML+'?utm_source=scr'+'","nmk","width=740,height=500,scrollbars=yes")';
			anchors[i].setAttribute('onclick',enlace);
...
/// CREA LA TABLA CUANDO NOS ENCONTRAMOS EN  EL MERCADO
...
if ((window.location.href.indexOf( "exchangemarket.phtml" ) != -1
	...
	saldoControl.setAttribute( "style", "width:35%; height:24px;" );
    saldoControl.setAttribute( "align", "right" );
	saldoControl.setAttribute( "cellpadding", "3" );
	saldoControl.setAttribute( "cellspacing", "3" );
	saldoControl.innerHTML = '<tr><td><table style="width:100%; height:24px;" border="4" cellpadding="4" cellspacing="0" class="tableline02"><tr><td valign="MIDDLE" align="CENTER">"Calculadora de Saldos"</td></tr></table><table style="width:100%; height:20px;" border="0" cellpadding="4" cellspacing="0"><tr class="tr1"><td class="text" style="white-space:nowrap;font-size:10px;" align="right"><strong>Actual:</strong> <input size="22px" type="text" name="saldoActual" id="saldoActual" readonly="true" style="background-color:transparent;border:0px;color:#002000;font-size:12px;text-align:right;" /></td></tr></table><table style="width:100%; height:21px;" border="0" cellpadding="4" cellspacing="0"><tr id="abiertoTR" class="tr1"><td class="text" style="white-space:nowrap;font-size:10px"  align="right"><strong>Ofertas abiertas:</strong><input size="21px" type="text" name="abierto" id="abierto" readonly="true" style="background-color:transparent;border:0px;color:#002000;font-size:12px;text-align:right;" value="0"/><input type="hidden" id="abiertoNames" /></td></tr><tr class="tr1"><td class="text" style="white-space:nowrap;font-size:10px"  align="right"><strong>Ofrecido:</strong><input size="21px" type="text" name="ofrecido" id="ofrecido" readonly="true" style="background-color:transparent;border:0px;color:#002000;font-size:12px;text-align:right;" /></td></tr><tr class="tr1"><td class="text" style="white-space:nowrap;font-size:10px"  align="right"><strong>Vendido:</strong><input size="21px" type="text" name="vendido" id="vendido" readonly="true" style="background-color:transparent;border:0px;color:#002000;font-size:12px;text-align:right;" value="0 €"/><input type="hidden" id="vendidoNames" /></td></tr></table><table style="width:100%; height:20px;" border="1" cellpadding="4" cellspacing="0"><tr class="tr1"><td class="text" style="white-space:nowrap;font-size:10px" align="right"><img src="i/1/i_balancemoney.png" width="18" height="9" alt="Fondos de la cuenta si se aceptan todas las ofertas" /><strong>Total:</strong> <input size="23px" type="text" name="saldoTotal" id="saldoTotal" readonly="true" style="background-color:transparent;border:0px;color:#002000;font-size:12px;text-align:right;" /></td></tr></table></td></tr> ';
...
/// CREA LA TABLA CUANDO NOS ENCONTRAMOS EN  EL MERCADO - FIN
	...
	//erpichi 20120328 - en calculadora jugadores aceptados
		...
		function getJugadoresAbiertos(text) {
			...
			if (text.indexOf('title="Siguiente"', pujaspos) != -1) {
				...
				jQuery.get( comunio + "/" + hrefSiguientePuja, getJugadoresAbiertos );
			} else {
		...
		if (window.location.href.indexOf( "exchangemarket.phtml") != -1) {
			jQuery.get( window.location.href.replace( "exchangemarket.phtml", "" ) + 'exchangemarket.phtml?viewoffers_x=22', getJugadoresVendidos );
		} else if(window.location.href.indexOf( "placeOffers.phtml") != -1) {
			jQuery.get( window.location.href.replace( "placeOffers.phtml", "" ) + 'exchangemarket.phtml?viewoffers_x=22', getJugadoresVendidos );
		}
}
