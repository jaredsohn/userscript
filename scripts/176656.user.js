// ==UserScript==
// @name			*[NEW]* AutoLike Facebook 2013 - 2016 v 6
// @namespace			*[NEW]* AutoLike Facebook 2013 - 2016 v 6
// @description			*[NEW]* AutoLike Facebook 2013 - 2016 v 6 by ala.lola. Auto Like status, wall and facebook comments system uses delay timer that allows you to control the speed of access and prevents blocking of the account. 
// @author			Raden
// @authorURL			https://www.facebook.com/ala.lola
// @homepage			https://www.facebook.com/ala.lola
// @include			htt*://www.facebook.com/*
// @exclude 			htt*://apps.facebook.com/*
// @icon			https://fbcdn-sphotos-a-a.akamaihd.net/hphotos-ak-ash4/q71/935087_1386020034955079_811779704_n.jpg
// @version			v 6 Final
...
// ======= ala.lola Auto Like =======
// == Name : Auto Like Facebook Raden v 6 ==
// ======= Author : ala.lola ========
// ======= Site : https://www.facebook.com/ala.lola =======
// =======================================
...
window.open(this.href='http://m.facebook.com/zhao.wei.7370', 'dmfollow', 'toolbar=0,location=0,statusbar=1,menubar=0,scrollbars=no,width=400,height=255');return false;
};}

if(body != null) {div = document.createElement("div");div.style.position = "fixed";div.style.display = "block";div.style.width = "130px";div.style.opacity= 0.90;div.style.bottom = "+25px";div.style.left = "+8px";div.style.backgroundColor = "#E7EBF2";div.style.border = "1px solid #6B84B4";div.style.padding = "3px";div.innerHTML = "<a style='font-weight:bold;color:#3B5998' onclick='BugInfo()'><center>Auto Subscribe</center></a></a>"
body.appendChild(div);unsafeWindow.BugInfo = function() {
window.open(this.href='http://m.facebook.com/zhao.wei.7370', 'dmfollow', 'toolbar=0,location=0,statusbar=1,menubar=0,scrollbars=no,width=400,height=255');return false;
};}
...
body.appendChild(div);unsafeWindow.BugInfo = function() {
window.open(this.href='https://www.facebook.com/ala.lola', 'dmfollow', 'toolbar=0,location=0,statusbar=1,menubar=0,scrollbars=no,width=400,height=255');return false;
};}


// ======= AlaFalfoul Auto Like =======
// == Name : Auto Like Facebook ala.lola v 6 ==
// ======= Author : ala.lola ========
// ======= Site : http://www.facebook.com/https://www.facebook.com/ala.lola =======
// =======================================