// ==UserScript==
// @name        IRCCloud Unread Messages as Dock Badge
// @namespace   http://fluidapp.com
// @description Display a count of unread messages on IRCCloud as a dock badge
...
(function () {
  ...
  function renderEventHook(bufferView, message, seenEid, selectedBuffer, lastTime) { 
    ...
    if(!message.self && !hasFocus && message.type === "buffer_msg") {
      unread_messages += 1;
