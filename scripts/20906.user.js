// ==UserScript==
// @name           My Youtube Alternate Video Player
// @namespace      sam min weng
...
pD.innerHTML = '<div style="position:relative;width:480px;height:395px;"><p style="position:relative;top:50%;left:40%;font-weight:bold;">Loading FlowPlayer &nbsp; <img style="position:relative;" src="data:image/gif;base64,'+aLoader+'" /></p></div>';

// Add jQuery
var GM_JQ = document.createElement('script');
GM_JQ.src = 'http://gmflowplayer.googlecode.com/files/jquery-1.2.1.pack.js';
...
function letsJQuery() {
	...
	$.ajax({
		...
		error: function(data){
			...
			'playList: [ { url: \''+respHed+'\' '+
			'}],showPlayListButtons:false, autoPlay:true, initialScale: \'scale\', showLoopButton: false, allowResize: true, useNativeFullScreen:true,'+GM_getValue('aB')+
			','+GM_getValue('aP')+
			',loop:false}"/>';
