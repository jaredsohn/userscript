// ==UserScript==
// @name           nCore Hírfolyam bb | compatiblity version
// @namespace      by gala
...
tartalom += "<br / > <small>Ha a gombra kattintáskor bezáródik a szövegmező nyomj egy 'space'-t a szövegmezőben, utána menni fog.<br /> Ha kérdésed van akkor keress meg <a href='/profile.php?id=285006'>[ITT]</a></small>";
tartalom += " vagy <a onclick=\"profile_pm('285006', 'normal');\" href=\"javascript:void(0);\">[Üzenet küldés]<\/a>.";
tartalom += "		<table>";
tartalom += "		<tbody>";
tartalom += "		<tr>";
