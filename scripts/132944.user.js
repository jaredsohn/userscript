// ==UserScript==
// @name           Google Reader Sanity Uyghur Font Style
// @namespace      cqrt,akax
// @author         cqrt,akax
// @description    ===Uyghur Font Style=== Restore your Google Reader interface to it's former glory and restore your sanity. -=Cross-browser Update System=- -=Redesigned minimalist interface=- -=Inline Post Previews=- -=Reduced memory footprint=- -=Keyboard Shortcuts=- -=Collapsible Interface=- -=Auto Update=- -=True unread counts=- -=Enclosures restored=-
...
// @version        2.3.2
// @history        (2.3.2) Very minor update to the update notification code to provide a changelog and support for Semantic Version numbers. 2.4 will be released later today with tons of new features. 
// @updateURL      http://userscripts.org/scripts/source/117298.meta.js
// @downloadURL    http://userscripts.org/scripts/source/117298.user.js
...
#viewer-top-controls { padding-left: 15% !important;  } \
...
#viewer-header { z-index: 1; background: transparent !important; height:25px !important; margin-right: 15px!important; -webkit-box-shadow: 0px 14px 10px -10px #999 !important; -moz-box-shadow: 0px 14px 10px -10px #999 !important; box-shadow: 0px 14px 10px -10px #999 !important; } \
...
div.name-text.folder-name-text.name-text-d-1.name.folder-name.name-d-1.name-unread {font-family: UKIJ Tuz Tom, ALKATIP Tor Tom, Alpida Unicode System, Helvetica, sans-serif !important;}\
span.entry-source-title {font-family: UKIJ Tuz Tom, ALKATIP Tor Tom, Alpida Unicode System, Helvetica, sans-serif !important;}\
span.snippet {font-family: UKIJ Tuz Tom, ALKATIP Tor Tom, Alpida Unicode System, Helvetica, sans-serif !important;}\
h2.entry-title {font-family: UKIJ Tuz Tom, ALKATIP Tor Tom, Alpida Unicode System, Helvetica, sans-serif !important;font-size: 16px !important;}\
div.name-text.sub-name-text.name-text-d-1.name.sub-name.name-d-1 {font-family: UKIJ Tuz Tom, ALKATIP Tor Tom, Alpida Unicode System, Helvetica, sans-serif !important;}\
div.entry-container {font-family: UKIJ Tuz Tom, ALKATIP Tor Tom, Alpida Unicode System, Helvetica, sans-serif !important;font-size: 25px !important;}\
input.gbqfif {font-family: UKIJ Tuz Tom, ALKATIP Tor Tom, Alpida Unicode System, Helvetica, sans-serif !important;}\
div div div {font-family: UKIJ Tuz Tom, ALKATIP Tor Tom, Alpida Unicode System, Helvetica, sans-serif !important;}\
font p font {font-family: UKIJ Tuz Tom, ALKATIP Tor Tom, Alpida Unicode System, Helvetica, sans-serif !important;}\
#viewer-header-container {height: 0;}\
\ ");
