...
while(i <= 15) {
    ...
    if(6 <= i && i <= 10) {
        newHTML = newHTML + '<div class="galki-vpravo menu1" onclick="changeclass(\'01_'+i+'\');return false;"><a href="'+stream+'" id="01_'+i+'" class=""> #1 - '+room+' '+icon+'</a></div>';
    }
    if(11 <= i && i <= 15) {
        newHTML = newHTML + '<div class="galki-vpravo menu1" onclick="changeclass(\'01_'+i+'\');return false;"><a href="'+stream+'" id="01_'+i+'" class=""> #2 - '+room+' '+icon+'</a></div>';
    }
    i++;
}
i = 0;
while(i <= 27) {
    ...
    if(1 <= i && i <= 5) {
        newHTML = newHTML + '<div class="galki-vpravo menu1" onclick="changeclass(\'01_'+i+'\');return false;"><a href="'+stream+'" id="01_'+i+'" class=""> #3 - '+room+' '+icon+'</a></div>';
    }
    if(16 <= i && i <= 21) {
        newHTML = newHTML + '<div class="galki-vpravo menu1" onclick="changeclass(\'01_'+i+'\');return false;"><a href="'+stream+'" id="01_'+i+'" class=""> #4 - '+room+' '+icon+'</a></div>';
    }
    if(22 <= i && i <= 27) {
        newHTML = newHTML + '<div class="galki-vpravo menu1" onclick="changeclass(\'01_'+i+'\');return false;"><a href="'+stream+'" id="01_'+i+'" class=""> #5 - '+room+' '+icon+'</a></div>';
    }
    i++;
}
