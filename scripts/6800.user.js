// ==UserScript==
// @name		Jimbo log-in
// @namespace	http://myspace.com/1andonlyjimbo
// @description	Login Page By Jimbo
...
s = 'body {background-image:url(http://i14.tinypic.com/3z1cpdu.jpg); background-color:#000000}\n';
...
s+= '#header {background-color:transparent; height:100px; background:url(http://i11.tinypic.com/29n6khg.jpg) top center no-repeat;}\n';
s+= '#header div {visibility:hidden;}\n';

s+= '#topnav a:link, #topnav a:active, #topnav a:visited {letter-spacing:0px; color:#000000; font-size:13px; font-weight:bold; font-family:verdana; text-transform:lowercase; letter-spacing:0px;}\n';
s+= '#topnav a:hover {color:#0F6524; text-decoration:none;}\n';
s+= '#topnav {height:39px; background:url(http://i14.tinypic.com/4pd4ei8.jpg)top center no-repeat; padding-top:7px; font-size:1px !important; color:#E5E5E5; letter-spacing:2px;}\n';
s+= '#topnav span {display:none;}\n';

s+= '#splash_music {background:url(http://i16.tinypic.com/2uhqtfa.jpg);}\n';
...
s+= '#splash_greybox {border:2px solid #CFCFCF;-moz-border-radius:10px 10px 10px 10px; background:url(http://i16.tinypic.com/49hodnk.jpg) top center no-repeat; opacity:0.55;}\n';
...
document.getElementById('theForm').innerHTML = '<table width="250" height="150" border="0" align="center" cellpadding="0" cellspacing="5" background="http://i11.tinypic.com/43zxhmf.jpg"><tr><td align="center" colspan="3" height="35px" style="padding-right:5px;"></td></tr><tr><td width="50%" align="right" valign="top"><input type="text" name="email" id="email" style="background-image:url(http://img482.imageshack.us/img482/8890/theforminputbgks7.png);width:100px; height:20px; font-family:Verdana, Arial, Helvetica, sans-serif; font-size:9px; text-align:left;"></td><td width="50%" align="left"  valign="top" style="padding-left:5px;"><input name="password" type="password" id="password" style="background-image:url(http://img482.imageshack.us/img482/8890/theforminputbgks7.png); width:100px; height:20px; font-family:Verdana, Arial, Helvetica, sans-serif; text-align:left;"></td></tr><tr><td colspan="2" align="center" valign="top"><table width="100%" border="0" cellpadding="0" cellspacing="5" align="center"><tr><td align="right" valign="middle"><input src="http://i17.tinypic.com/4dypzx2.jpg" name="ctl00$Main$SplashDisplay$login$loginbutton" type="image" id="ctl00_Main_SplashDisplay_login_loginbutton" alt="Member Login" /></td><td><a id="ctl00_Main_SplashDisplay_login_HyperLink1" title="SignUp" href="http://signup.myspace.com/index.cfm?fuseaction=join"><img title="SignUp" src="http://i16.tinypic.com/2ik42ua.jpg" style="border-width:0px;" /></a></td></tr><tr><td colspan="3" height="20px"></td></tr><tr><td colspan="3" align="center" valign="middle"><a href="http://collect.myspace.com/index.cfm?fuseaction=user.retrievepassword" title="dumbass">Forgot your shit?</a></td></tr></table></td></tr></table>';
