...
Description:
	...
	on a style written for Pith Helmet by Jon Hicks: http://www.hicksdesign.co.uk/journal/skinning-sites-in-safari-with-pithhelmet

Author:
	Kreg Wallace, mail: kregwallace at gmail dot com
...
// ==UserScript==
// @name		Del.icio.us.ness
// @namespace		http://kreg.kombine.net/userscripts/
...
var cssStyles =	'body { font-family: lucida grande,arial,sans-serif; font-size: 1em; }' +
		...
		'h3.desc, h3.desc a { font-size: 13px; font-weight: bold; color: #333; padding-top: 8px !important; }' +
		...
		'td { padding: 5px; }' +
		'.date { float: none !important; color: #fff; font-weight: bold; background-color: #186afc; padding: 5px 0 4px 10px; font-size: 12px !important; }' +
