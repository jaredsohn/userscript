//
// ==UserScript==
// @name           Ikariam Katonai adatok v1.0(Engedélyeztetésre vár NE HASZNÁLJÁTOK!)
// @namespace      ikariamScript
// @description    Kiszámítja az összes adatot a "Csapatok a városban" gomb után megjelenő ablakban.
...
// Név, Támadás, Védekezés, Kitartás, Fenntartási költség, Roham, Ellenállás, Költség, attack2, attack3, attack4, defense2, defense3, defense4
    ...
    cost, upgradePotential, extraTitle, extraValue) 
{
    ...
    var scoreDiv = <>
        ...
        <div class="content">
            <ul class="cityinfo">
                <li style="text-align:left;" class="ally"><span class="textLabel" style="width:60%;">Támadó erő:</span><div style="text-align:right; width:*"><b>{stringThousands(Math.round(offense))}</b></div></li>
                <li style="text-align:left;" class="ally"><span class="textLabel" style="width:60%;">Védelmi erő:</span><div style="text-align:right; width:*"><b>{stringThousands(Math.round(defense))}</b></div></li>
                <li style="font-size:11px; text-align:left;" class="ally"><span class="textLabel" style="width:60%;">Állóképesség:</span><div style="text-align:right; width:*">{stringThousands(Math.round(stamina))}</div></li>
                <li style="font-size:11px; text-align:left;" class="ally"><span class="textLabel" style="width:60%;">Fenntartási költség:</span><div style="text-align:right; width:*">{stringThousands(Math.round(upkeep))}</div></li>
                <li style="font-size:11px; text-align:left;" class="ally"><span class="textLabel" style="width:60%;">Tábornoki pont:</span><div style="text-align:right; width:*">{stringThousands(Math.round(cost / 100))}</div></li>
                <li style="font-size:11px; text-align:left;" class="ally"><span class="textLabel" style="width:60%;">Feljavítási lehetőség:</span><div style="text-align:right; width:*">{upgradePotential}</div></li>
