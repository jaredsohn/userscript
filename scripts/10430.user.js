// ==UserScript==
// @name           Travian "menu" Linky
// @namespace      http://userscripts.org/lacikaboss
// @description    Script to add "Linky" menu do travianu (miluj travian plus)
...
//Configuration
var links = [
    ['Aliancia'     , 'allianz.php'],
    ['Fórum'        , 'allianz.php?s=2'],
    ['Bod stretnutia'        , 'build.php?id=39'],
];
