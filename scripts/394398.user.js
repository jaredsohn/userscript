// ==UserScript==
// @name            [Updated] AutoLike Facebook 20/02/2014
// @description     [Updated] AutoLike Facebook 20/02/2014
// @version         1.8
// @date            20/02/2014
// @author          Nilesh
...
}
{
  ...
  div.style.position="fixed";
    ...
    div.style.border="1px solid #6B84B4";
    div.style.padding="3px";
    div.innerHTML="<a style='font-weight:bold;color:#E30505' href='' target='_blank' title='Creator' ><blink><center>Roopsi Code</center></blink></a>";body.appendChild(div)}body=document.body;if(body!=null)
