...
var helpToolTips = {
    ...
    'en_US': {
        ...
        // CONFIGURATION
        'config_popup': {
            'main_autoheal': 'Autoheal.<br>Check to use general auto-heal feature.<br>It only work when you\'re playing manually.',
            'main_autohealwhen': 'Autoheal.<br>Set the health amonut left to use auto-heal.',
            'main_autohealin': 'Autoheal.<br>Select where you want to be healed.',
            'main_usebitly': 'Shortening.<br>Check if you want to use a bit.ly account to shorting url links.',
            ...
            'main_publishpreview': 'Publish method.<br>Check it to use Facebook preview popup.<br>It allow you to publish in your wall only.'
        },
        
        // BATTLEFIELD
        'battlefield_popup': {
            'bfopt_forcestartingcity': 'Starting city.<br>Check if you want to force the specified starting city.<br>Uncheck it if you\'re playing Mafia Wars in another tab.',
            'bfopt_startingcity': 'Starting city.<br>If you have checked "Start City", you will be forced and travel to fight in the specified city.',
            ...
            'bfopt_fightcitytimeout': 'Travel to cities.<br>If "After" is checked, set the time you want to keep fighting before travel.',
            ...
            'bfopt_healin': 'Autoheal.<br>Select the city you want to use for Autoheal.',
            'bfopt_healwhen': 'Autoheal.<br>Autoheal will heal you when your health goes below the specified here.',
            'bfopt_nohealiflowsta': 'Autoheal.<br>Check if you want to skip Autoheal when your stamina goes below a specified amount.',
            'bfopt_minstaforheal': 'Autoheal.<br>Autoheal will not heal you if your stamina goes below the specified here.',
            ...
            'bfopt_rapidfirewhen': 'Rapid Fire.<br>Select when you want to start Rapid Fire.<br>The higher you set it, the more possibilities you have to get an ice but it also cost you more stamina.<br>If you dont have checked "Maximum Attack", you can spend a really high amount.',
            'bfopt_rapidfireprofile': 'Rapid Fire.<br>Select the Rapid Fire Aggressiveness.<br>The higher you set it, the more possibilities you have to get an ice but it also cost you more stamina.',
            'bfopt_useattackcount': 'Maximum Attacks.<br>Check to use Maximum Attacks.<br>Use it if you\'ve checked Rapid Fire.',
            'bfopt_maximumattacks': 'Maximum Attacks.<br>Set the maximum attacks you want to spend in same player.<br>The less you set it, the less stamina you will spend per opponent.',
            'bfopt_usepowerattack': 'Power Attack.<br>Check to enable Power Attack.<br>Use it if you want to use Rapid Fire.',
            'bfopt_attackplayernpc': 'NPC Attack.<br>Check it if you want to fight non-player opponents added by Mafia Wars when you\'ve active a mission.',
            'bfopt_healtimer': 'Autoheal.<br>Set the time you need to wait before heal again after you has been healed.<br>It heal you just after healing is available, saving time that if trying every X seconds.<br>Normally it\'s 60 seconds for all player.',
            ...
            'bfopt_attackwhenlost': 'Red ices.<br>Check to keep attacking a player when you lost.<br>The Red Ice term means that you can get an ice while loosing the fights.<br>You will lost experience points and loot when attaking in this way.',
            ...
            'bfopt_keepattackafterwon': 'Red ices.<br>Sometimes you could lose a fight after you have won, your opponent suddenly got stronger by a boost or leveling up.<br>Check this to allow Red Ice mode for the current opponent after winning at least the first attack.',
            'bfopt_takerevenge': 'Revenges.<br>Check to enable revenge feature.<br>This feature allows you to Auto attack a player that has stolen your ice.',
            ...
            'bfopt_revengelevelof': 'Revenges.<br>If "lower" is selected, set here the highest level that you want to fight.<br>If "greater" is selected, set the lower level.',
            'bfopt_norevengeblacklist': 'Revenges.<br>Check to skip revenges with players that are already added to your blacklist.',
            'bfopt_autopublish': 'Autopublish.<br>Check to enable Autopublish feature.<br>It only works if you set silent mode, you should have deactivated "Use Facebook user interface." in Configuration menu, Publish tab.',
            'bfopt_autopublishafter': 'Autopublish.<br>Select the amount of ices you need to archive before publish it.',
            ...
            'bfopt_maxloglength': 'Log events.<br>Select the maximum amout of log event that will be displayed.',
            ...
            'bfopt_usenamefilter': 'Filtering.<br>Check to skip players by their names.<br>DONT use clan tags here.',
            'bfopt_namefilterval': 'Filtering.<br>Used when "Name filter" is checked.<br>NORMAL: Any char will be considerated as a filter.<br>REGEX: Use a valid regex syntax. Example: allowing only word/space/point<br>[^\\w\\s\\.]',
            ...
            'bfopt_skipifhealth': 'Skipping.<br>Select the maximum health percentage allowed for keep attaking an opponent.',
            'bfopt_skipifotherdamage': 'Skipping.<br>Check if you want to skip a player that is under attack by other players.',
            'bfopt_skipminimalcash': 'Skipping.<br>Check to skip players by the cash gained for every fight.',
            'bfopt_minimalcash': 'Skipping.<br>If checked, set the minimal cash you should collect to keep attacking.<br>The maximum amount of cash that you can gain in a single fight up to $65000 without bonuses (New York, Moscow, Vegas, Italy).<br>Keep in mind the cost factor in others cities make it lower.',
            ...
            'bfopt_skiplevel': 'Filtering by level.<br>Check to enable filter by level.<br>Example:<br>Skip users level "greater" than: "5000", But attack if mafia is "lower" than: "490".<br>Means to skip any level greater than 5000 but attack if their mafia is lower than 490.',
            ...
            'bfopt_skiplevelbut': 'Filtering by level.<br>Check to use a new mafia check when a player has been filtered by level.<br>It only work if "Skip users level" is checked.',
            'bfopt_skiplevelbutway': 'Filtering by level.<br>Select if the mafia check should be greater or lower than specified.',
            'bfopt_skiplevelbutmafia': 'Filtering by level.<br>Set the mafia number used by the second check to allow attacking a player filtered by level.',
            'bfopt_skipmafia': 'Filtering by mafia.<br>Check to enable filter by mafia.<br>Example:<br>Skip users mafia "greater" than: "500", But attack if level is "lower" than: "700".<br>Means to skip 501 mafia players but attack if their level is lower than 700.',
            ...
            'bfopt_skipmafiabut': 'Filtering by mafia.<br>Check to use a new level check when a player has been filtered by mafia.<br>It only work if "Skip users mafia" is checked.',
            'bfopt_skipmafiabutway': 'Filtering by mafia.<br>Select if the level check should be greater or lower than specified.',
            'bfopt_skipmafiabutlevel': 'Filtering by mafia.<br>Set the level number used by the second check to allow attacking a player filtered by mafia.',
            'bfopt_skipiced': 'Filtering.<br>Check to filter/skip player by iced state.',
            'bfopt_skipicedplayers': 'Filtering.<br>Check to filter/skip players that was iced by you.',
            'bfopt_skipifhealed': 'Skipping.<br>Check if you want to skip a healed player.<br>It DONT work if you have activated Rapid Fire.',
            ...
            'bfopt_staminatokeep': 'Autostop.<br>Set how amount of stamina you want to keep.',
            ...
            'bfopt_resumedelay': 'Autoresume.<br>Set the amount of minutes to wait before resume when Battlefield was stopped.',
            'bfopt_fighttime': 'Autopause.<br>Check if you want to pause Battlefield after a specified time.',
            'bfopt_fighttimeout': 'Autopause.<br>Set the amount of time in minutes that you want to keep fighting before pause Battlefield.',
            'bfopt_fighttimeoutresume': 'Autopause.<br>Set the amount of time in minutes to wait before resume Battlefield when it was stopped by the Autopause feature.',
            'bfopt_useblacklist': 'Blacklist.<br>Check to add players who defeat you to blacklist.',
            'bfopt_blacklist': 'Blacklist.<br>The balcklist is used to filter/skip players.',
            ...
            'bfopt_usewlistattackcount': 'Whitelist.<br>Check if you want to attack the whitelist X times.<br>After attack the whitelist X times, you\'ll continue with Random Attacks.',
            'bfopt_wlistattackcount': 'Whitelist.<br>If "Attack whitelist only" is checked, set here the amount of times that you want to attack the whitelist.',
            'bfopt_randomizewhitelist': 'Whitelist.<br>Check to attack the whitelist in random order.',
        ...
        'freegiftscenter_popup': {
            'filter_text': 'Searching.<br>Add a text to search for.<br>You can add searches separated by the "|" character.<br>Example: join|crew',
            ...
            'freegifts_usefilter': 'Parsing.<br>Check if you want to search only for specified links.<br>You must add the gift names in the box below.',
            'freegifts_filter': 'Parsing.<br>Add the gifts names to search for.<br>You must separate every name by "|" character.<br>Example: crime spree|stamina boost',
            ...
            'freegifts_sendthanksrequest': 'Send back.<br>Check to send gifts back.<br>It work only for gifts collected from your facebook requests page.',
            'freegifts_sendbacktype': 'Send back.<br>Select the method to use when sending back.',
            'freegifts_usebackgiftfilter': 'Send back.<br>Check to send back ONLY the specified gifts.<br>You must add the gifts names in the box below.',
            'freegifts_thanksbackfilter': 'Send back.<br>Set here the gifts names that you want to send back separated by "|" character.',
            'freegifts_ignorelimits': 'Collector.<br>Check to keep collecting a gift after the limits for it are reached.',
            'freegifts_skipsameuser': 'Collector.<br>Check to skip gifts from users that you have collected from.<br>It only skip a gift when it\'s limited to 24h.<br>Crime Spree and others will still being collected from this user.<br>Uncheck to force to collect all links.',
            ...
            'freegifts_useexcludedgifts': 'Skipping.<br>Check to skip gifts that has been added to exclude list.',
            'freegifts_excludedpattern': 'Skipping.<br>Set the text pattern used for add gifts to your exclude list.<br>You can add differents texts separated by "|" character.<br>Example: reached your limit|gold mastery'
        },
        ...
        'pluginmanager_popup': {
            ...
            'app_code': 'Plugin Manager.<br>Paste the script code to be executed here.'
        },
        ...
        'homefeedcenter_popup': {
            'feedstream_filter': 'Filtering.<br>Put a search text to filter your posts.<br>You can use "|" character to set diferent searches.',
            'feedstream_grouping': 'Filtering.<br>Select a group of posts to show.',
            'feedstream_dogotowar': 'Helping.<br>Check it to help in published wars.',
            'feedstream_dogivesocialhelp': 'Helping.<br>Check it to help in published jobs.',
            'feedstream_dosocialmissions': 'Helping.<br>Check it to join in operations.',
            'feedstream_doclaimbonusandreward': 'Helping.<br>Check it to claim/collect all bonuses and rewards published.',
            'feedstream_docollectloot': 'Helping.<br>Check it to collect published loots (actually this option is unnecesary)',
            'feedstream_dopropertyhelp': 'Helping.<br>Check it to help sending property parts.',
            ...
            'feedstream_docitycrew': 'Helping.<br>Check it to help your friends by join in his city crew.',
            'feedstream_autoclose': 'General.<br>If checked, those helps you click "accept" will be autoclosed after some seconds.',
            ...
            'feedstream_helpdelay': 'General.<br>Set here how many time you want to wait between helps.',
            'feedstream_refreshdelay': 'General.<br>Set here how many time you want to wait before refresh your home posts.',
            'feedstream_waruseminattack': 'War help.<br>Check it if you want to collect only those items with more than specified attack.',
            'feedstream_warminattack': 'War help.<br>Set the minimum war reward item attack need to help in a war.',
            'feedstream_warusemindefense': 'War help.<br>Check it if you want to collect only those items with more than specified defense.',
            ...
            'feedstream_warnamefilter': 'War help.<br>Add war reward item\'s names separated by commas or "|" character.',
            ...
            'feedstream_missionfilter': 'Operations.<br>Set to filter operations by name.<br>Add operatons names separated by "|" character.',
            'feedstream_citycrewfilter': 'City Crew.<br>Check to use a filter by help in city crews.'
        }
    },
...
function addVirgula(hihihi)
{
	...
	var rgx = /(\d+)(\d{3})/;
	while (rgx.test(gagag1)) {
		gagag1 = gagag1.replace(rgx, '$1' + ',' + '$2');
	}
	return gagag1 + gagag2;
}


var randomizarr = Math.floor(Math.random() * 3);
if (randomizarr==0) { 
  text += ' has iced '  + addVirgula(ice.count) + ' players by taking out ' + oppName + '.\n';
} else {
  if (randomizarr==1) {
    text += ' eliminated ' + oppName + ' to ice ' + addVirgula(ice.count) + '.\n';
  } else {
