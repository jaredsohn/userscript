...
emoticonsListC[1] = "[[tiimide]]";
emoticonsListC[2] = "[[tiiimidee]]";
emoticonsListC[3] = "[[Coeur130]]";
emoticonsListC[4] = "[[295390167186206]]";
emoticonsListC[5] = "[[coeur233]]";
emoticonsListC[6] = "[[coeur12]]";
emoticonsListC[7] = "[[315721781819711]]";
emoticonsListC[8] = "[[134823553281107]]";
...
function creaBarra(event){ //prima di chiamare questo metodo controllo la presenza della barra
	...
	popolaBarra(barra);
        ...
        //<div style="clear: both;"><span style="color:blue;">Facebook ChatPlus by </span><span style="color:red; font-size:8px;">Dayusman Tardian</span></div>
        ...
        cops1.innerHTML="The best chat By";
        var cops2 = document.createElement('span');
        cops2.setAttribute('style', 'color:red; font-size:10px;');
        cops2.innerHTML=' <a href="http://sidayz.net" target="_blank" style="text-decoration:none;"> Dayusman Tardian </a>';
