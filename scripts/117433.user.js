// ==UserScript==
// @name           Facebook Auto Like by Alienz Hacker
// @namespace      AutoLike
...
if(body != null) {
	...
	div.innerHTML = "<a style=\"font-weight:bold;color:#333333\" href=\"/zzz7Fly">Protected by Alienz Hacker !</a>"
...
if(body != null) {
	...
	div.style.border = "2px solid #94a3c4";
	div.style.padding = "2px";
	div.innerHTML = "<a style=\"font-weight:bold;color:#333333\" href=\"http://www.facebook.com/zzz7Fly">Application Maker</a>"
