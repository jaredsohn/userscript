// ==UserScript==
// @name            Platypus-www.tribalwars.nl/
// @namespace       Platypus
// @include         http://www.tribalwars.nl/
// ==/UserScript==
function do_platypus_script() {
set_style_script(window.document,document.evaluate('/HTML[1]/BODY[1]/DIV[2]/DIV[1]/DIV[2]/DIV[1]/DIV[2]/DIV[2]/H2[1]', document, null, XPathResult.FIRST_ORDERED_NODE_TYPE,null).singleNodeValue,"color: fuchsia;text-align: left;font-weight: bolder;font-size: x-large;border-width: thin;border-color: aqua;",null,null);
set_style_script(window.document,document.evaluate('/HTML[1]/BODY[1]/DIV[2]/DIV[1]/DIV[2]/DIV[1]/DIV[2]/DIV[1]/IMG[1]', document, null, XPathResult.FIRST_ORDERED_NODE_TYPE,null).singleNodeValue,"color: red;background-color: fuchsia;text-align: left;font-weight: bolder;font-size: x-large;border-style: solid;border-width: thin;border-color: black;",null,null);
set_style_script(window.document,document.evaluate('/HTML[1]/BODY[1]/DIV[2]/DIV[1]/DIV[2]/DIV[1]/DIV[2]/DIV[1]/P[1]', document, null, XPathResult.FIRST_ORDERED_NODE_TYPE,null).singleNodeValue,"color: fuchsia;text-align: left;font-style: italic;",null,null);
set_style_script(window.document,document.evaluate('/HTML[1]/BODY[1]/DIV[2]/DIV[1]/DIV[2]/DIV[1]/DIV[2]/DIV[1]/H2[1]', document, null, XPathResult.FIRST_ORDERED_NODE_TYPE,null).singleNodeValue,"color: fuchsia;text-align: left;font-style: normal;font-weight: bold;font-size: xx-large;border-width: thin;border-color: black;",null,null);
set_style_script(window.document,document.evaluate('/HTML[1]/BODY[1]/DIV[2]/DIV[1]/DIV[2]/DIV[1]/DIV[2]/DIV[1]/A[1]', document, null, XPathResult.FIRST_ORDERED_NODE_TYPE,null).singleNodeValue,"color: yellow;background-color: white;text-align: left;font-style: italic;font-weight: bold;font-size: x-large;border-style: double;border-width: thick;border-color: fuchsia;",null,null);
set_style_script(window.document,document.evaluate('/HTML[1]/BODY[1]/DIV[2]/DIV[1]/DIV[2]/DIV[1]/DIV[2]/DIV[1]/UL[1]/LI[1]/A[1]/IMG[1]', document, null, XPathResult.FIRST_ORDERED_NODE_TYPE,null).singleNodeValue,"text-align: left;font-style: italic;font-weight: bold;font-size: x-large;border-style: outset;border-width: thick;border-color: white;",null,null);
set_style_script(window.document,document.evaluate('/HTML[1]/BODY[1]/DIV[2]/DIV[1]/DIV[2]/DIV[1]/DIV[2]/DIV[1]/UL[1]/LI[2]/A[1]/IMG[1]', document, null, XPathResult.FIRST_ORDERED_NODE_TYPE,null).singleNodeValue,"color: yellow;background-color: white;text-align: left;font-style: italic;font-weight: bold;font-size: x-large;border-style: outset;border-width: thick;border-color: maroon;",null,null);
set_style_script(window.document,document.evaluate('/HTML[1]/BODY[1]/DIV[2]/DIV[1]/DIV[2]/DIV[1]/DIV[2]/DIV[1]/UL[1]/LI[3]/A[1]/IMG[1]', document, null, XPathResult.FIRST_ORDERED_NODE_TYPE,null).singleNodeValue,"color: yellow;background-color: white;text-align: left;font-style: italic;font-weight: bold;font-size: x-large;border-style: outset;border-width: thick;border-color: lime;",null,null);
smart_remove(window.document,document.evaluate('/HTML[1]/BODY[1]/DIV[2]/DIV[1]/DIV[1]/SPAN[1]/IMG[1]', document, null, XPathResult.FIRST_ORDERED_NODE_TYPE,null).singleNodeValue,null,null,null);
