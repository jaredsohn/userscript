...
function openSettings() {
        if (gid('div' + script) == undefined) {
                ...
                div += '<a id="close' + script + '" style="display: inline;" href="javascript:;">schlieكen</a></div>';
