// ==UserScript==
// @name                        Gaya Obrolan Facebook Lebih Dinamis | Cyber Kazuya
// @namespace                   gaya_obrolan_facebook_lebih_dinamis
// @description                 Ganti Gaya Obrolan Facebook Anda Dengan Sidebar Obrolan Facebook Yang Menampilkan Obrolan Teman Yang Active Melalui Handphone
	...
	var rocki = {
		'DOMContentLoaded':function(){
			...
			w.Arbiter.subscribe('buddylist-nub/initialized',function(a,c){
				...
				var listener = c.orderedList.subscribe('render',function(){
					c.orderedList.scrollTo(c.orderedList._root.firstChild);
