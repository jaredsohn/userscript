// ==UserScript==
// @name          Muleblock
// @namespace     http://saab92x.com
// @description   Saab 9-2x Muleblock
// @include       http://*saab92x.com/*
// ==/UserScript==

/*
* code is by iiam via http://userscripts.org/scripts/show/8537
* + only changed very slightly to work on saab92x, (GGTKPDX)
*/

/* this is the list of userids to ignore */
var ignore_list = [4784, 840, 4903];
