?// ==UserScript==
// @name            Auto-play ThirstOfNight3 (TON)
...
'<table width="100%" border="0" cellspacing="0" cellpadding="0">\
  ...
  <tr>\
	...
	<td style="font-family:\'Arial Narrow\',sans-serif;font-size:16px;">Reapers</td>\
	<td><input id="Change_Reapers" type="text" value="0" size="18" maxlength="5"/></td>\
...
function process_TON_action_reqs() {
	...
	case 2:
		...
		var reapers_to_change = get_element_or_log_if_absent('Change_Reapers', UI_MODULE, WARNING); 
        ...
        if (!(grunts_to_change && (grunts_to_change.value != 0)) && !(trucks_to_change && (trucks_to_change.value != 0)) && 
            ...
            !(reapers_to_change && (reapers_to_change.value != 0))) {
	...
	case 3:
		...
		var attacking_reapers = document.getElementById('Attack_Reapers', UI_MODULE, WARNING);
        ...
        if (!grunts && !trucks && !slashers && !sigbins && !flickerforms && !snipers && 
            !vampireBats && !nemesisBats && !armoredTrucks && !nosferatu && !impalers && !reapers) {
        ...
        if ((grunts < 0) || (trucks < 0) || (slashers < 0) || (sigbins < 0) || (flickerforms < 0) || (snipers < 0) || 
            (vampireBats < 0) || (nemesisBats < 0) || (armoredTrucks < 0) || (nosferatu < 0) || (impalers < 0) || (reapers < 0)) {
		...
		var units = get_units_map(grunts, trucks, slashers, sigbins, flickerforms, snipers, 
		    vampireBats, nemesisBats, armoredTrucks, nosferatu, impalers, reapers gargoyle, general);
...
function init() {
    ...
    troops_DOA_to_TON = {"Conscript": "Grunt", "Porter": "Truck", "Halberdsman": "Slasher", 
        ...
        "ArmoredTransport": "Armored Truck", "Giant": "Nosferatu", "FireMirror": "Impaler", "AquaTroop": "Reaper"};
...
function get_units_map(grunts, trucks, slashers, sigbins, flickerforms, snipers, vampireBats, nemesisBats, 
    armoredTrucks, nosferatu, impalers, reapers, gargoyle_type, general_id) {
    var units = {};
    if (grunts != 0) {
...
function init_attack_info() {
    ...
    attack_units['RedBloodCamp'][1][VAMPIRE_BATS] = {type:TROOP, qty:80000};
    attack_units['RedBloodCamp'][1]["Twilight Warfare"] = {type:TECHNOLOGY, level:4};
    attack_units['RedBloodCamp'][1]["Spectral Vision"] = {type:TECHNOLOGY, level:4};
    attack_units['RedBloodCamp'][1]["Endurance"] = {type:TECHNOLOGY, level:3};
    attack_units['RedBloodCamp'][1]["Blood Transfusions"] = {type:TECHNOLOGY, level:3};
