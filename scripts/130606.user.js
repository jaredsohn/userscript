// ==UserScript==
// @name Torn City Egg Notifier
// @match http://*.torn.com/*
// @exclude http://*.torn.com/*eggfind*
// ==/UserScript==
...
for ( var i = 0; i < links.length; i++ ) {
    ...
    if ( element.href.indexOf( "eggfind" ) > 0 ) {
        var img = element.firstChild;
        try 
        {

            var avg = getAverageRGB(img);
            var dom = getDominantColor(img);

            alert('Possible egg on page\n\nAverage: r' + avg.r + 'g' + avg.g + 'b' + avg.b + '\n Dominant: r' + dom.r + 'g' + dom.g + 'b' + dom.b);
        } catch (err) {}
        img.focus();        
