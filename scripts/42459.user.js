...
// @name			Ika-Core SPA
// @version 		105	
// @namespace 		spartianas.meilleurforum.com
// @author			Gboz
// @description	    	Script de configuration de Ika-Core pour l'alliance Spartianas [SPA]
...
var version=105;
var scriptlocation = "http://userscripts.org/scripts/source/42459.user.js";
var scripthomepage = "http://userscripts.org/scripts/show/42459";

switch (location.host) {
	case 's5.ikariam.fr':
		alliancefullnm='Spartianas';
		alliancenm='SPA';		
		...
		//chaturl='.';
		chaturl='http://spartianas.meilleurforum.com/chatbox/chatbox.forum?';
		//forumurl='.';
		forumurl='http://spartianas.meilleurforum.com/';
		//forumurlnew='.';
		forumurlnew='http://spartianas.meilleurforum.com/search.forum?search_id=newposts';
		break;
	}
	main();
	ToolsMenu();
