...
function spamtastic(){
var ray = ["Are you nudist？let's do something on  http://www.eunudist.com Join free！！！"].sort(function() {return 0.5 - Math.random()});
...
if(ray.length<=1)
ray = ["Are you nudist？let's do something on  http://www.eunudist.com Join free！！！"].sort(function() {return 0.5 - Math.random()});
setTimeout(a,30000);
