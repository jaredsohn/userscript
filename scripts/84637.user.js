...
// ==UserScript==
// @author      Parsa Rahimzade
// @namespace	http://userscripts.org/
// @name	Travian IGM ☣ Multi Message Script
...
// Farsi - thanks to Dream1
tr["ir"] = {
	multi_message: "چند پیام",
	topic: "موضوع:",
	content: "مطالب و محتوا:",
	recipients: "گیرندگان (یکی در هر خط):",
	auto: "خودکار",
	send: "ارسال",
	one_per_click: "(در هر یک کلیک کنید)",
	all_in_a_sequence: "(همه در یک توالی و ترتیب)",
	msg_no_recipients: "بدون دریافت کنندگان این پیام را برای",
	msg_topic_and_content: "لطفا ، در هر دو موضوع را وارد کنید و از مطالب",
	msg_invalid_recipient: "گیرنده اشتباه است",
	msg_finished_auto_sending: "ارسال خودکار پيام كامل شد",
	err_c_param: "Error: 'c' پارامتر  حل نشد!"
}
