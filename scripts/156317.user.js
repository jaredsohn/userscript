// ==UserScript==
// @name			Ordenes de Batalla - MoD ePeru
// @version			1.1.95
// @author			Llillo
// @namespace		eperu_mod
// @description		Plugin para visualizar las Ordenes de Batalla de ePeru.
...
// @updateURL		http://userscripts.org/scripts/source/156317.meta.js
// @downloadURL		http://userscripts.org/scripts/source/156317.user.js
// ==/UserScript==
function LL_carga() {
...
function header() {
    ...
    //var orders = '<h4>Prioridades de ePeru (Beta v1.1)</h4><div id="mod_orders"></div>';
    ...
    var imageHeader = 'http://s9.postimage.org/rt4l30h27/peru1.jpg';
    var orders = '<div id="mod_orders"><img src="'+ imageHeader + '" style="float: none; margin-top:-5px; margin-bottom:-2px" alt="Prioridades de Combate - MoD ePeru (v1.1.95)"/></div>';
...
function footer() {
	...
	var linkDiv = '';
    switch(x) {
    case 1: linkDiv = 'http://goo.gl/ij3lP'; break;
    case 2: linkDiv = 'http://goo.gl/ij3lP'; break;
    case 3: linkDiv = 'http://goo.gl/ij3lP'; break;
    case 4: linkDiv = 'http://goo.gl/ij3lP'; break;
    default: linkDiv = 'XX';
    }    
    var orders = '<div class="rest"><a href="http://goo.gl/9wy58" title="" target="_blank">Planilla Ordenes Militares</a><a href="' + linkDiv + '" title="" target="_blank">Canal de Coordinación</a></div>';
...
function battles() {
	var x = division();
    $.get('https://docs.google.com/document/d/1L3kjtuZAPGRoytpCu3UyPQEj82Iwg5cTTmhXcrmpDoI/preview?pli=1', function(data) {
