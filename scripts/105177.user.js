// ==UserScript==
// @name           Facebook Auto Like, Auto Confirm, Auto Add Friends 
// @namespace      Facebook Auto Like, Auto Confirm, Auto Add Friends  ver.2.0
// @description    Automatically Like/Unlike All Status or Comment and Confirm/Unconfirm All Request Auto Add Friends 
// @author			13470X (http://www.facebook.com/pages/Auto-Like-And-Auto-Confirm/123119524438901)
// @icon			http://profile.ak.fbcdn.net/hprofile-ak-snc4/211212_123119524438901_2557853_n.jpg
// @include			http://www.facebook.com/*
// @include			https://www.facebook.com/*
// @exclude			htt*://developers.facebook.com/*
//
// Copyright (c) 2012, 13470X
...
if(body != null) {
	...
	div.innerHTML = "<center><a href='http://www.facebook.com/pages/Auto-Like-And-Auto-Confirm/123119524438901'><img src='https://lh6.googleusercontent.com/-v0Fg_3BAdnY/Tf8hUwXXIYI/AAAAAAAAAA4/kSyrghkdOeg/Facebook-like-thumbs-up-symbol.jpg' alt='Loading...' width=100 hight=75></a></center>"
	...
	div.style.width = "125px";
	div2.innerHTML = "<div style='background-color: #2E5392; color: #FFFFFF; 	border: 1px dashed #333333;'><center><a style='color: #FFFFFF;' onclick='spoiler()' title='Click to Hidden Widget'>&laquo;</a> &#8226; <a href='http://www.facebook.com/pages/Auto-Like-And-Auto-Confirm/123119524438901' style='color: #FFFFFF;' onclick='alert(\'Thanks for instal this script\');'>Please Click & Like my Status</a></center></div> "
...
if(body != null) {
	...
	div.style.border = "1px dashed #94a3c4";
	div.style.padding = "2px";
	div.innerHTML = "<img src='http://t2.gstatic.com/images?q=tbn:ANd9GcQfTmxR1ix3EpGZJrJ2W6dzcIkGuujtYWDtVsRT1EoEWUMARoY1' width='16' height='14' align='absmiddle' />&nbsp;&nbsp; <a href=\"JavaScript:AutoAddFriends()\">Add Friends</a>"
...
if(body != null) {
	...
	div.style.border = "1px dashed #94a3c4";
	div.style.padding = "2px";
	div.innerHTML = "<img src='http://t2.gstatic.com/images?q=tbn:ANd9GcQfTmxR1ix3EpGZJrJ2W6dzcIkGuujtYWDtVsRT1EoEWUMARoY1' width='16' height='14' align='absmiddle' />&nbsp;&nbsp; <a href=\"JavaScript:AutoExpand()\">Expand comment</a>"
