...
// @description    Craigslist Enhancer with Family Friendly Toggle.
...
function top_bar() {
    ...
    bar += '<input type="text" id="query" name="query" value="search" onblur="if(this.value==\'\')this.value=\'search\';" onfocus="if (this.value == \'search\') { this.value = \'\'};" /> ';
    ...
    bar += '<p><a href="https://accounts.craigslist.org/">my account</a> <a href="/about/terms.of.use.html">terms of use</a> <a href="/about/">about us</a> <a href="/about/privacy_policy">privacy</a> <a href="/about/help/">help</a></p>';
    bar += '</div>';
	return bar;
}
