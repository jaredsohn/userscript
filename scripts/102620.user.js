...
function pbStartup (){
  ...
  window.name = 'PT';
  logit ("*  KOC ENGLISH KONTROLL v"+ Version +" Loaded");
  readOptions();
  readGlobalOptions ();
  setCities();
...
// TODO: Make sure WinPos is visible on-screen ?
  ...
  actionLog (" KOC ENGLISH KONTROLLv"+ Version +" Loaded  (KOC Version: "+ anticd.getKOCversion() +")");
  ...
  AddMainTabLink('KOC ENGLISH KONTROLL', eventHideShow, mouseMainTab);
  kocWatchdog ();
  WideScreen.init ();
...
Tabs.Marches = {
  ...
  init : function (div){
    ...
    t.myDiv = div;
    t.myDiv.innerHTML = '<TABLE class=ptTab align=center><TR><TD><INPUT class=pbSubtab ID=ptmrchSubA type=submit value=Attacks></td>\
          ...
          <TD><INPUT class=pbSubtab ID=ptmrchSubR type=submit value=Reinforcements></td>\
          <TD><INPUT class=pbSubtab ID=* type=submit value=Coming></td>\
          <TD><INPUT class=pbSubtab ID=* type=submit value=Coming></td></td></tr></table><HR class=ptThin>\
