// ==UserScript==
// @name           KOC Power Tools - City Hunter 110
// @description    Combination of George Jetson, DeathbyNumbers, Coolbum67 and Area52's work with search area extended to 110 spaces. 
// @namespace      mat
...
my.Search = {
  ...
  clickedSearch : function (){
    ...
    if (isNaN (t.opt.maxDistance) ||t.opt.maxDistance<1 || t.opt.maxDistance>110)
      errMsg += "Max Distance must be between 1 and 110<BR>";
    if (errMsg != ''){
