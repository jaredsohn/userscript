...
// @name        ruiptcbux
// @namespace   ruiptcbux
// @include     *://*ruiptcbux.com/index.php?view=click*
// @include     *://*ruiptcbux.com/index.php?view=account&ac=click*
// @include     *://*ruiptcbux.com/index.php?view=account&ac=ptra*
// @include     *://*ruiptcbux.com/gpt.php?v=entry*
// @include     *://*ruiptcbux.com/gpt.php?v=read*
// @include     *://*ruiptcbux.com/view.php?id=*
...
self == top){
	...
	if($('frame:last').attr('src').indexOf('cheat') >= 0 ){
		...
		if(wparent.location.host.indexOf('ruiptcbux')!=-1)cheatCheck=[37,15,33,30,5];;
