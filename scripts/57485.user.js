// ==UserScript==
// @name           Evidentiator grupe pe harta
// @description    Adauga marcaje(culoare + icon_unitate) pe harta pentru fiecare grupa in parte 
// @author         leomiro
// @include        http://ro*.triburile.ro/game.php?*screen=map*
// @include        http://ro*.triburile.ro/groups.php*
// @exclude        http://ro*.triburile.ro/groups.php*mode=village*
// ==/UserScript==
...
(function(){
	...
	// Gruppen bearbeiten
		...
		var td1 = ce('td');
		td1.appendChild(document.createTextNode('Culoare: '));
		var img = ce('img');
		img.src = spacer;
		...
		var html = '<td>Simbol-URL:</td><td><input type="text" style="width:97%;" id="markgroupurl" /><div>';
		var icons = [
			'spear',
			'sword',
			'axe',
