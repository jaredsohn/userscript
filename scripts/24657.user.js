...
// ==UserScript==
// @name           Screenfluent Redirect
// @namespace      http://binq.org/greasemonkey/
// @description    Screenfluent Redirect v2.0: CSS Beauty pages that are opened in a new tab/window take you directly to the dugg article.  It's very useful when looking through RSS feeds.
...
BINQ.screenfluentLinkJumper = {
	init: function() {
		this.jumpToFirstValidLink = BINQ.linkJumper.jumpToFirstValidLink;
		return this;
	},
	searchPath: "//div[@class='thbarlink']//a[1]",
}

if (history.length == 1) { BINQ.screenfluentLinkJumper.init().jumpToFirstValidLink(); }