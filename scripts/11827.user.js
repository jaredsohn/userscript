...
tagger.addEventListener('click', function(e) {
  ...
  if(!t) return;
  a+= '\n\n<p><img src='+ unescape('%22') + 'http://static.technorati.com/x/static/img/graphicresources/icn-talkbubble.gif?1149714944' + unescape('%22') + ' border=' + unescape('%22') + '0' + unescape('%22') + '> '
  var tr = t.split(' ');
