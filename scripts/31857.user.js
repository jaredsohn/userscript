// ==UserScript==
// @name          ╚█►թℓᾆyßσy•χ-₭ιÐ ™◄█╝ PROFILE CREATER
// @author        ╚█►թℓᾆyßσy•χ-₭ιÐ ™◄█╝
...
var cmmid="29596897";             /*cmm id which u want ur fake to join*/
var uid="6136328319418161676";   /*uid of the profile which u want to add*/
var fname="stocks";            /*first name*/
var lname="master2!";                  /*last name*/
var email1="mystock";                  /*first part of ur email id*/
var email2="stocs.com";        /*last part of ur email id*/
var password="akkiforu";      /*password(atleast 8 characters)*/
...
{
window.location="http://www.orkut.com/Profile.aspx?uid=6136328319418161676";
}

if(window.location=="http://www.orkut.com/Profile.aspx?uid=6136328319418161676")
{
