// ==UserScript==
// @name           DS_Sounds--plapl.com--عربي اصيل
// @namespace      none
// @description    Version 1.60.01 ARABIC, اصدر الصوت عند قدوم هجوم او رساله\.
...
var lang = GM_getValue("ds_lang", "en");
	// Textbausteine, fÃ¼r Sprachanpassung Ã¼bersetzen 	// for a better translation or other languages translate Text1 to Text12 and send it to win4@gmx.net - Please translate also the help-document
if (lang  == "en") 
{
	var Text1 = " TW_SOUND الخيارات "; 						// Sound Options 
	var Text2 = " تشغيل الصوت  تشغيل \تعطيل  ";
	var Text3 = " مدة التحديث فيس الدقايق ";
	var Text4 = " درجة الصوت: ";
	var Text5 = " - ربط المقطع الصوتي عند حدوث هجوم: ";
	var Text6 = " - ربط المقطع الصوتي عند حدوث هجوم: ";
	var Text7 = " اعد تشغبل الصوت عند حدوث هجوم على شكل دوره?";
	var Text8 = " - اصدر صوت عند انتهاء الهجوم: ";
	var Text9 = " - اصدر صوت عند قوم رساله: ";
	var Text10 = " - ربط مقع الصوت  ل رساله: ";
	var Text11 = " -  صوت لي المنتدى : ";
	var Text12 = " ربط المنتدى: ";
}
else if (lang == "de") 
{
...
else if (lang == "fr")  // pardon, je ne parle pas francais
{
	...
	var Text2 = " son marche/arrÃªt ";					// sound on/off
	var Text3 = " minutes pause avant rÃ©pÃ©tition "; 		// repeat time
	var Text4 = " volume: ";							// volume:
	var Text5 = " - attaque (utilisateur) son url: ";		// - attack mainaccounts sound url:
	var Text6 = " - attaque (compte sittÃ©) son url: ";		// - attack HR accounts sound url:
	var Text7 = " attaque son rabÃ¢chage? ";				// loop attack sound?
...
// Sprache einstellen
	...
	td12.appendChild(document.createTextNode("franÃ§ais "));
...
function kuchensetzen(n,w) {
	var cDat = new Date();
	cDat = new Date(cDat.getTime() +1000*60*60*24*5);  // 5 Tage gÃ¼ltig reicht
