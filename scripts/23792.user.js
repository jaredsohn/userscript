...
// --------------------------------------------------------------------
// ==UserScript==
// @name           TribalWars Enhancer v2.0 by Timas edited by OpenBSD
// @version        0.1d
// @namespace      i.am.timas-at-gmail.com
// @description    Ads Remover. 15x15 Map. Shortcuts Bar. TW-Tools quick-access. Multi-Language(now have br language) and more!
...
// @copyright      Copyright (c) 2008, Timas
// @maintainer     Timas
// ==/UserScript==
...
"br" : { // PortuguesBR
	"villages" : "Vilas",
	"overview" : "Planta do Vilarejo",
	"map"      : "Mapa",
	"main"     : "Quartel general",
	"place"    : "Praca de reunioes",
	"train"    : "{Train}",
	"barracks" : "Exercito",
	"stable"   : "Estabulo",
	"garage"   : "Oficina",
	...
	"player"   : "Jogador",
	"tribe"    : "Tribo",
	"i_player" : "Mostre as informacoes do infeliz",
	"i_tribe"  : "Mostre as informacoes da tribo",
	"loading"  : "Carregando..",
	"c_close"  : "Clique para fexar.",
	"track"    : "{track village}",
	"tracked"  : "{Village tracked}",
	"untrked"  : "{Village untracked}",
	"untrack"  : "{untrack village}",
	...
	"oktrack"  : "{tracked villages}",
	"at_none"  : "Ataque otra vez",
	"at_same"  : "Ataque otra vez com as mesmas tropas",
	"at_all"   : "Ataque otra vez com todas as tropas",
	"mapsize"  : "{Map size}",
	"pop_close": "{close_pop}",
	"pop_auto" : "{auto_pop}"
},
