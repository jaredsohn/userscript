...
// ==/UserScript==
(function(){
	GM_addStyle('.lzlz{background:url("http://tb2.bdstatic.com/tb/static-pb/img/lzl/login_btn_94180a4b.png") no-repeat scroll left top transparent;color:rgb(255,255,255);cursor:pointer; height:24px;text-align:center; width:51px; display:block; margin-left:-140px; margin-top: -24px;pointer-events:auto;}');
	...
	button.innerHTML= '&nbsp;<input type="button" value="蓝字" class="subbtn_bg" id="PUnicode">';
