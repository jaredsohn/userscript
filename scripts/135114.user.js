// ==UserScript==
// @name          Lectio Auto-Login 2012
// @author        Nikolaj Holck (Tidligere version: Jonas Hansen)
// @version       0.1 Beta
// @namespace     http://nikolajholck.dk/
...
if (GM_getValue('username', false)) {
	...
	$('m_Content_submitbtn2').value = 'Gem oplysninger og log ind';
	$('m_Content_submitbtn2').addEventListener("click", saveInformation, true);
}
