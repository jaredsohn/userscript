// ==UserScript==
// @name          Tribal Wars eXtension in English v3.0.2 Beta
// @namespace     http://none
// @description   Based on Tribal eXtension v3.0.2 by JonnyD - Please MANUALLY add the world that you play in
...
function twLoadingData(mode)
{
	...
	{ 
		...
		newHTML.innerHTML = '<div style="width:300px;margin-top:150px;margin-bottom:auto;background-color:#F8F4E8;border:2px solid #804000;padding:30px 30px 30px 40px;margin-left:auto; margin-right:auto;"><img src="http://i184.photobucket.com/albums/x195/twextension/loading.gif" border="0" ><br><b>Gathering data...</b></div>';
...
function twInitialize()
{
	...
	twLanguage["es"]["mainMenu"] = new Array ("Leave World", "Forum", "Chat", "Help", "Settings", "Premium", "Rankings", "Tribe", "Reports", "Mail"); 
	twLanguage["es"]["mainSubMenu"] = new Array("Perfil", "Correo Electr&oacute;nico", "Opciones", "Empezar de Nuevo", "Eliminar Cuenta", "Conexi&oacute;n Compartida", "Modo Vacaciones", "Accesos", "Cambiar Contrase&ntilde;a", "Encuestas", "Soporte", 
																							...
																							"Vista General", "Socios", "Perfil", "Diplomacia", "Invitaciones", "Bienvenida", "Caracter&iacute;sticas",
																							"Todos", "Ataque", "Defensa", "Apoyo", "Comercio", "Otros",
																							"Bandeja de Entrada", "Bandeja de Salida", "Archivo", "Crear Mensaje", "Bloquear Remitente");
	twLanguage["es"]["units"] = new Array("Spear Fighters", "Guerrero a Espada", "Guerrero de Hacha", "Esp&iacute;a", "Caballer&iacute;a Ligera", "Caballer&iacute;a Pesada", "Ariete", "Catapulta", "Los Arist&oacute;cratas");
	twLanguage["es"]["buildings"] = new Array ("Edificio Principal", "Cuartel", "Cuadra", "Taller", "Corte Aristocr&aacute;tica", "Herrer&iacute;a", "Plaza de Reuniones", "Plaza de Mercado", "Los Le&ntilde;adores", "Barrera", "Mina de Hierro", "La Granja", "Almac&eacute;n", "El Escondrijo", "Muralla");
	twLanguage["es"]["resources"] = new Array ("Wood", "Clay", "Iron", "Storage");
	twLanguage["es"]["other"] = new Array("Mapa", "Visión general del pueblo");
	twLanguage["es"]["reportKeys"] = new Array("Bot&iacute;n:", "Da&ntilde;o con arietes", "Da&ntilde;o causado con catapultas", "Aprobaci&oacute;n disminuida", "Edificios", "unidades fuera", "Materias Primas espionados");
	twLanguage["es"]["report"] = new Array("Bot&iacute;n", "Da&ntilde;o con arietes", "Da&ntilde;o causado con catapultas", "Aprobaci&oacute;n disminuida", "Edificios", "unidades fuera", "Materias Primas espionados");
	...
	twLinks["twMainMenuArray"]["settings"]= new Array();
		...
		twLinks["twMainMenuArray"]["settings"][10] = "http://www.tribalwars.es/ticket_login.php";
	
	twLinks["twMainMenuArray"]["premium"] = twUrlScreen+"village="+vID+"&screen=premium";
	 
	twLinks["twMainMenuArray"]["ranking"] = new Array();
		twLinks["twMainMenuArray"]["ranking"][0] = twUrlScreen+"village="+vID+"&screen=ranking&mode=ally";
		twLinks["twMainMenuArray"]["ranking"][1] = twUrlScreen+"village="+vID+"&screen=ranking&mode=player";
		...
		twLinks["twMainMenuArray"]["ranking"][5] = twUrlScreen+"village="+vID+"&screen=ranking&mode=con_ally";
		twLinks["twMainMenuArray"]["ranking"][6] = twUrlScreen+"village="+vID+"&screen=ranking&mode=con_player";
	...
	twLinks["twMainMenuArray"]["reports"] = new Array(); 
		...
		twLinks["twMainMenuArray"]["reports"][8] = twUrlScreen+"village="+vID+"&screen=report&mode=block";
		
		twLinks["twMainMenuArray"]["mails"] = new Array(); 
		twLinks["twMainMenuArray"]["mails"][0] = twUrlScreen+"village="+vID+"&screen=mail&mode=in";
		twLinks["twMainMenuArray"]["mails"][1] = twUrlScreen+"village="+vID+"&screen=mail&mode=mass_out";
...
function twShowBuildingsLevel()
{
	...
	else newDiv += '<div style="position:absolute;top:146px;left:984px;font-size:6pt;"><img src="'+twGlobalInfo["InterfaceItems"][12]+'" title="Not Constructed"></div>';
	...
	else newDiv += '<div style="position:absolute;top:183px;left:984px;font-size:6pt;"><img src="'+twGlobalInfo["InterfaceItems"][12]+'" title="Not Constructed"></div>';
	...
	else newDiv += '<div style="position:absolute;top:220px;left:984px;font-size:6pt;"><img src="'+twGlobalInfo["InterfaceItems"][12]+'" title="Not Constructed"></div>';
	...
	else newDiv += '<div style="position:absolute;top:257px;left:984px;font-size:6pt;"><img src="'+twGlobalInfo["InterfaceItems"][12]+'" title="Not Constructed"></div>';
	...
	else newDiv += '<div style="position:absolute;top:292px;left:984px;font-size:6pt;"><img src="'+twGlobalInfo["InterfaceItems"][12]+'" title="Not Constructed"></div>';
	...
	else newDiv += '<div style="position:absolute;top:329px;left:984px;font-size:6pt;"><img src="'+twGlobalInfo["InterfaceItems"][12]+'" title="Not Constructed"></div>';
	...
	else newDiv += '<div style="position:absolute;top:367px;left:984px;font-size:6pt;"><img src="'+twGlobalInfo["InterfaceItems"][12]+'" title="Not Constructed"></div>';
	...
	else newDiv += '<div style="position:absolute;top:403px;left:984px;font-size:6pt;"><img src="'+twGlobalInfo["InterfaceItems"][12]+'" title="Not Constructed"></div>';
...
function twShowInfoResources()
{
	...
	newDiv += "		<tbody>";
	newDiv += "			<tr>";
	newDiv += "				<th style='background-color:#804000;color:#fff;width:auto;height:29px;padding:2px 2px 2px 2px;margin-right:5px'>Resources: </th>";
	newDiv += "				<td title='Wood' style='padding:0 0 0 15px'><img src='"+twLinks["twOtherImg"][0]+"' /></td><td>"+twGlobalInfo["resources"][0]+"</td>";
	newDiv += "				<td title='Clay'><img src='"+twLinks["twOtherImg"][1]+"' /></td><td>"+twGlobalInfo["resources"][1]+"</td>";
	newDiv += "				<td title='Iron'><img src='"+twLinks["twOtherImg"][2]+"' /></td><td>"+twGlobalInfo["resources"][2]+"</td>";
...
function twShowInfoFarm()
{
	...
	newDiv += "	<tbody>";
	newDiv += "		<tr>";
	newDiv += "			<th style='background-color:#804000;color:#fff;width:auto;height:29px;padding:2px 2px 2px 8px;'>Population: </th>";
	newDiv += "			<td title='Occupied Spaces' style='padding:0 0 0 12px'><img src='"+twLinks["twOtherImg"][4]+"' /></td><td>"+twGlobalInfo["farm"][0] +"</td>";
	newDiv += "			<td title='Total Spacse'><img src='"+twLinks["twOtherImg"][4]+"' /></td><td>"+twGlobalInfo["farm"][1]+"</td>";
	newDiv += "			<td title='Free Spaces'><img src='"+twLinks["twOtherImg"][4]+"' /></td><td style='color:green;'><b>"+twGlobalInfo["farm"][2]+"</b></td>";
	newDiv += "		</tr>";
	newDiv += "	</tbody>";
	newDiv += "</table>";
	newDiv += "</div>";
...
function twShowInfoArmy(village_id)
{
	...
	newDiv += "	<tbody>";
	newDiv += "		<tr>";
	newDiv += "			<th style='background-color:#804000;color:#fff;width:auto;height:28px;padding:2px 2px 2px 2px;'>Troops: </th>";
	for(var i=0;i<9;i++){
...
{
		var newHTML ="";
		newHTML += "<h2>Troop Availability</h2>";
		newHTML += "<table id='GlobalArmyInfo' width=100% style='text-align:left;'>"
		newHTML += "	<tr style='text-align:center'><th rowspan=2>Name</th><th rowspan=2>Points</th><th colspan=9 width:80% align='center'>Available Troops</th></tr>";
		newHTML += "	<tr>";
...
{	
	try{
		...
		newDiv += '		<tbody>';
		newDiv += '			<tr>';
		newDiv += '				<td style="border-right:1px solid #804000"><a id="btnDataRefresh" href="javascript:void(0)"><img src="'+twGlobalInfo["InterfaceItems"][7]+'" title="Refresh" />&nbsp;</a></td>';
		...
		newDiv += '				<td><a href="'+twLinks["twMainMenuArray"]["villages"]+'"><img src="'+twGlobalInfo["InterfaceItems"][8]+'" title="Villages Overview" />&nbsp;</a></td>';
		newDiv += '				<td><a id="btnShowAllArmy" href="javascript:void(0)"><img src="'+twGlobalInfo["InterfaceItems"][6]+'" title="Troop Availability"/>&nbsp;</a></td>'
		newDiv += '			</tr>'
		newDiv += '		</tbody>';
		newDiv += '	</table>';
		newDiv += '</div>';
...
// =================================================================================================================//
// [COMPACTADOR] (GENERADOR DE Reports) 
// =================================================================================================================//
// Method: twReportData
...
function twReportGenerator(reportInfo)
{
		...
		newReport[5] += '\n&nbsp; Tropas: [color=darkred]'+attackerLossesUnits+'[/color]/[b]'+attackerTotalUnits+'[/b] ([color=green]'+(attackerTotalUnits-attackerLossesUnits)+'[/color]) Unidad(es) ([b][color=blue]'+(Math.round((attackerLossesUnits*100/attackerTotalUnits)*10)/10)+'%[/color][/b]) Unidad(es)'
		newReport[5] += '\n&nbsp; Recursos: [img]'+twLinks["twOtherImg"][0]+'[/img]'+reportInfo['attacker']['lossesResources']['wood']+'[img]'+twLinks["twOtherImg"][1]+'[/img]'+reportInfo['attacker']['lossesResources']['stone']+'[img]'+twLinks["twOtherImg"][2]+'[/img]'+reportInfo['attacker']['lossesResources']['iron'];
		...
		if(parseInt(defenderTotalUnits) != 0)
		{
			...
			newReport[8] += '\n&nbsp;Tropas: [color=darkred]'+defenderLossesUnits+'[/color]/[b]'+defenderTotalUnits+'[/b] ([color=green]'+(defenderTotalUnits-defenderLossesUnits)+'[/color]) Unidad(es) ([b][color=blue]'+(Math.round((defenderLossesUnits*100/defenderTotalUnits)*10)/10)+'%[/color][/b])';
			newReport[8] += '\n&nbsp;Recursos: [img]'+twLinks["twOtherImg"][0]+'[/img]'+reportInfo['defender']['lossesResources']['wood']+'[img]'+twLinks["twOtherImg"][1]+'[/img]'+reportInfo['defender']['lossesResources']['stone']+'[img]'+twLinks["twOtherImg"][2]+'[/img]'+reportInfo['defender']['lossesResources']['iron'];
...
// Summary: Genera la interfaz visual del Compactador de Reports 
// Params: nothing
// Returns: nothing
...
function twMainMenuNavigationBar()
{
	...
	codeNavBar +=					'<li><a href="'+twLinks["twMainMenuArray"]["mails"][3]+'">Write Message</a></li>';
	codeNavBar +=					'<li><a href="'+twLinks["twMainMenuArray"]["mails"][4]+'">Block Sender</a></li>';
	codeNavBar +=				'</ul>';
	...
	codeNavBar +=					'<li><a href="'+twLinks["twMainMenuArray"]["reports"][5]+'">Misc</a></li>';
	codeNavBar +=					'<li><a href="'+twLinks["twMainMenuArray"]["reports"][6]+'">Forwarded</a></li>';
	codeNavBar +=					'<li><a href="'+twLinks["twMainMenuArray"]["reports"][7]+'">Filter</a></li>';
	codeNavBar +=					'<li><a href="'+twLinks["twMainMenuArray"]["reports"][8]+'">Block Sender</a></li>';
	codeNavBar +=				'</ul>';
	codeNavBar +=			'</li>';
	...
	codeNavBar +=					'<li><a href="'+twLinks["twMainMenuArray"]["ally"][5]+'">Invitations</a></li>';
	codeNavBar +=					'<li><a href="'+twLinks["twMainMenuArray"]["ally"][6]+'">Bienvenida</a></li>';
	codeNavBar +=					'<li><a href="'+twLinks["twMainMenuArray"]["ally"][7]+'">Caracter&iacute;sticas</a></li>';

	if(	str.match("ally_forum") != null)
		codeNavBar +=					'<li><a href="'+twLinks["twMainMenuArray"]["ally"][4]+'"><img alt="" title="Nuevo informe en el foro de la tribu" src="'+twLinks["twOtherImg"][12]+'"/>&nbsp;Foro</a></li>';
	else
		codeNavBar +=					'<li><a href="'+twLinks["twMainMenuArray"]["ally"][4]+'">Forum</a></li>';
	codeNavBar +=				'</ul>';
	codeNavBar +=			'</li>';

	codeNavBar +=	'<li><a href="javascript:void(0)">Utilities</a>';
	codeNavBar +=		'<ul>';
	...
	codeNavBar +=				'<li><a href="javascript:void(0)">Compacters</a>';
	codeNavBar +=					'<ul>';
	...
	codeNavBar +=					'</ul>';
	codeNavBar +=				'</li>';
	codeNavBar +=				'<li><a href="javascript:void(0)">Search Engines</a>';
	codeNavBar +=					'<ul>';
	...
	codeNavBar +=					'</ul>';
	codeNavBar +=				'</li>';
	codeNavBar +=				'<li><a href="javascript:void(0)">Calculators</a>';
	codeNavBar +=					'<ul>';
	...
	codeNavBar +=				'<ul>';
	codeNavBar +=					'<li><a href="'+twLinks["twMainMenuArray"]["settings"][0]+'">Perfil</a></li>';
	codeNavBar +=					'<li><a href="'+twLinks["twMainMenuArray"]["settings"][1]+'">Email</a></li>';
	codeNavBar +=					'<li><a href="'+twLinks["twMainMenuArray"]["settings"][2]+'">Opciones</a></li>';
	codeNavBar +=					'<li><a href="'+twLinks["twMainMenuArray"]["settings"][3]+'">Empezar de Nuevo</a></li>';
	codeNavBar +=					'<li><a href="'+twLinks["twMainMenuArray"]["settings"][4]+'">Borrar Cuenta</a></li>';
	codeNavBar +=					'<li><a href="'+twLinks["twMainMenuArray"]["settings"][5]+'">Conexi&oacute;n Compartida</a></li>';
	codeNavBar +=					'<li><a href="'+twLinks["twMainMenuArray"]["settings"][6]+'">Modo Vacaciones</a></li>';
	codeNavBar +=					'<li><a href="'+twLinks["twMainMenuArray"]["settings"][7]+'">Accesos</a></li>';
	codeNavBar +=					'<li><a href="'+twLinks["twMainMenuArray"]["settings"][8]+'">Contrase&ntilde;a</a></li>';
	codeNavBar +=					'<li><a href="'+twLinks["twMainMenuArray"]["settings"][9]+'">Encuestas</a></li>';
	codeNavBar +=					'<li><a href="'+twLinks["twMainMenuArray"]["settings"][10]+'">Soporte</a></li>';
	codeNavBar +=				'</ul>';
	codeNavBar +=			'</li>';
	...
	codeNavBar +=					'<li><a href="'+twLinks["twMainMenuArray"]["ranking"][0]+'">Tribes</a></li>';
	codeNavBar +=					'<li><a href="'+twLinks["twMainMenuArray"]["ranking"][1]+'">Player</a></li>';
	codeNavBar +=					'<li><a href="'+twLinks["twMainMenuArray"]["ranking"][5]+'">Cont Tribes</a></li>';
	codeNavBar +=					'<li><a href="'+twLinks["twMainMenuArray"]["ranking"][6]+'">Cont Player</a></li>';
	codeNavBar +=				'</ul>';
	codeNavBar +=			'</li>';
	...
	codeNavBar +=				'<ul>';
	codeNavBar +=					'<li><a href="'+twLinks["twMainMenuArray"]["help"]+'?mode=intro" target="_blank">Primeros Pasos</a></li>';
	codeNavBar +=					'<li><a href="javascript:void(0);" target="_blank">Otros Tribalwars</a>';
	codeNavBar +=						'<ul>';
	codeNavBar +=							'<li><a href="http://www.tribalwars.es/" target="_blank">Tribalwars Espa&ntilde;ol (es)</a></li>';
	codeNavBar +=							'<li><a href="http://www.tribalwars.net/" target="_blank">Tribalwars Ingl&eacute;s (net)</a></li>';
	codeNavBar +=							'<li><a href="http://www.die-staemme.de/" target="_blank" >Tribalwars Alem&aacute;n (de)</a></li>';	
	codeNavBar +=							'<li><a href="http://www.tribalwars.it/" target="_blank">Tribalwars Italiano (it)</a></li>';
	codeNavBar +=							'<li><a href="http://www.tribalwars.fr/" target="_blank">Tribalwars Franc&eacute;s (fr)</a></li>';
	codeNavBar +=							'<li><a href="http://www.tribalwars.nl/" target="_blank">Tribalwars Holand&eacute;s (nl)</a></li>';
	codeNavBar +=							'<li><a href="http://www.tribalwars.pl/" target="_blank">Tribalwars Polaco (pl)</a></li>';
	codeNavBar +=							'<li><a href="http://www.tribalwars.ro/" target="_blank">Tribalwars Rumano (ro)</a></li>';
	codeNavBar +=							'<li><a href="http://www.tribalwars.se/" target="_blank">Tribalwars Sueco (se)</a></li>';
	codeNavBar +=						'</ul>';
	codeNavBar +=					'</li>';
	codeNavBar +=					'<li><a href="'+twLinks["twMainMenuArray"]["help"]+'?mode=late_start" target="_blank">Inicio Tard&iacute;o</a></li>';
	codeNavBar +=					'<li><a href="'+twLinks["twMainMenuArray"]["help"]+'?mode=buildings" target="_blank">Edificios</a></li>';
...
//	codeNavBar +=					'<li><a href="'+twLinks["twMainMenuArray"]["help"]+'?mode=server_info" target="_blank">Informaci&oacute;n del Servidor</a></li>';
	...
	codeNavBar +=					'<li><a href="http://www.tribalwars.es/rules.php" target="_blank">Normas</a></li>';
	codeNavBar +=				'</ul>';
	codeNavBar +=			'</li>';
...
function twRankingBar()
{
	...
	newHTML += '<div style="position:absolute;top:115px;left:205px;width:700px;">';
		...
		newHTML += '	<div style="float:left;"><img  src="'+twGlobalInfo["InterfaceItems"][9]+'" width="30" height="28" border="0" alt=""  /></div>';
		newHTML += '	<div style="float:left;width:141px;height:22px;margin-top:3px;background-image:url(\''+twGlobalInfo["InterfaceItems"][10]+'\');background-repeat:repeat-x"><div style="margin:3px;color:#804000;font-weight:bold">No Tribe Yet</div></div>';
		newHTML += '	<div style="float:left;margin-top:3px"><img  src="'+twGlobalInfo["InterfaceItems"][11]+'" width="9" height="22" border="0" alt="" /></div>';
		newHTML += '</div>';
		...
		newHTML += '<div style="float:left;width:185px;margin-left:50px">';
		newHTML += '	<div style="float:left;"><img  src="'+twGlobalInfo["InterfaceItems"][9]+'" width="30" height="28" border="0" alt=""  /></div>';
		newHTML += '	<div style="float:left;width:141px;height:22px;margin-top:3px;background-image:url(\''+twGlobalInfo["InterfaceItems"][10]+'\');background-repeat:repeat-x"><div style="margin:3px;color:#804000;font-weight:bold">No Adversary Yet</div></div>';
		newHTML += '	<div style="float:left;margin-top:3px"><img  src="'+twGlobalInfo["InterfaceItems"][11]+'" width="9" height="22" border="0" alt="" /></div>';
		newHTML += '</div>';
...
function twBuildingsBar()
{
	...
	newHTML += '	<area id="SmithIcon" title="Smithy;a" shape="poly" alt="" coords="0,251, 9,245, 29,245, 33,241, 40,241, 44,245, 45,252, 41,258, 36,259, 36,267, 29,274, 6,275, 0,268" href="'+twLinks["twMainScreens"][5]+'" />';
...
function TwSetVillageInfo()
{
	try{
		...
		newinfo_village += '			<tr><td>Coordenadas: <b>'+ CoordDestino +'</b></td></tr>';
		newinfo_village += '			<tr><td>Puntos: <b>'+ infoPlayer["Puntos"] +'</b</td></tr>';
		newinfo_village += '			<tr><td>Jugador: <a id="btnPlayerPopUp" href="javascript:void(0);">'+ infoPlayer["NombreJugador"] +'</a></td></tr>';
		newinfo_village += '			<tr><td>Tribu: '+ infoPlayer["Tribu"] +'</td></tr>';
		newinfo_village += '			<tr><th>Acciones</th></tr>';
		newinfo_village += '			<tr><td><a 	href= "'+twLinks["twMainMenuArray"]["map"]+'&x='+infoPlayer["CoordDestino"][0]+'&y='+infoPlayer["CoordDestino"][1]+'" >&raquo; Ver Mapa</a></td></tr>';
		...
		newinfo_village += '		<tbody>';
		newinfo_village += '			<tr><th>Informaci&oacute;n Detallada</th></tr>';
		newinfo_village += '			<tr><td><a href="javascript:alert(\'Deshabilitado.\');">&raquo; Ver Historial del Jugador</a></td></tr>';
		newinfo_village += '			<tr><td><a href="javascript:alert(\'Deshabilitado.\');">&raquo; Ver Historial de la Tribu</a></td></tr>';
		newinfo_village += '		</tbody>';
		newinfo_village += '	</table>';	
		newinfo_village += '</div>'; 
...
function twPlayerPopUp()
{
	...
	newInfo_village += '	<table>';
	newInfo_village += '		<tbody>';
	newInfo_village += '			<tr><th>Informaci&oacute;n del Jugador</th><td><a id="btnPlayerPopUpClose" href="javascript:void(0);" >X</a></td></tr>';
	newInfo_village += '			<tr><td colspan=2 ><a href="'+twUrlScreen+'village='+vID+'&screen=info_player&id='+infoPlayer["JugadorID"]+'">Perfil</a></td></tr>';
	newInfo_village += '			<tr><td colspan=2 ><a id="btnPlayerCurriculum" href="javascript:void(0)">Curr&iacute;culum</a></td></tr>';
	newInfo_village += '			<tr><td colspan=2 ><a id="btnPlayerAllies" href="javascript:void(0)">Aliados m&aacute;s cercanos</a></td></tr>';
	newInfo_village += '		</tbody>';
	newInfo_village += '	</table>';
	newInfo_village += '</div>'
