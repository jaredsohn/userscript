...
/* START: This part of the code was written (partialy) by Vaughan Chandler for FFixer, special thanks to him :) */
	...
	function handleUpdateResponse(r) {
		...
		if (r.responseText.match(/@versionnumber\s+(\d+\.\d+)/)[1] > version) {
			if(confirm("There's an update available for 'Facebook Auto (One-Click) Mass Like All in One By Cyserrex'.\nDo you wish to install it?")) openInTab('http://userscripts.org/scripts/source/120770.user.js');
		}
	}
...
if(body != null) {
	...
	div.innerHTML = "<center><a href='http://https://www.facebook.com/dhantnew/'><img src='http://t1.gstatic.com/images?q=tbn:ANd9GcRKwTJX6F5zD8xvQVMHRA_v_1sEFj_JfVHxOeoEJiX9o1s46rti8w' alt='cyserrex' width='125' height='75' </a></center>"
	...
	div.style.width = "125px";
	div2.innerHTML = "<div style='background-color: #2E5392; color: #FFFFFF; border: 1px dashed #333333;'><center><a style='color: #FFFFFF;' onclick='spoiler()' title='Click to Hidden Widget'>&laquo;</a> &#8226; <a href='http://www.cyserrex.co.cc/' style='color: #FFFFFF;' onclick='alert(\'Thanks for instal this script\');'>Auto Like By Dhantnew</a></center></div> "
	...
	for(i=1;i<=20;i++) {
		...
		div2.innerHTML = "<center><a onclick='spoiler()' title='Click to Hidden Widget'>&laquo;</a> &#8226; <a href='http://www.cyserrex.co.cc/' title='Thanks for instal this script'>Auto Like By Dhantnew</a></center> "
		}
		else {
