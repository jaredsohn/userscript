...
About this script
 ...
 Supports :  share.gogo.mn rapidshare.de netload.in easy-share.com mediafire.com megashares.com 
...
var uploadbox_com= new Array(6)  //http://uploadbox.com/files/dHKtTbMPCJ
 uploadbox_com[0]='uploadbox\.com\/files\/(?:\w*)';       //name and search string in link to get description
 uploadbox_com[1]='File name:';                           // file_is_alive
...
var http_file_hosts=[share_gogo_mn,netload_in,easy_share_com,mediafire_com,megashares_com,rapidshare_de,depositfiles_com,vip_file_com,yourfilehost_com,sendspace_com,filebase_to,link_protector_com,bitroad_net,filenavi_com,uploadbox_com,letitbit_net,zshare_net];
...
var lianks = document.evaluate(share_gogo_mn[4]+'|'+netload_in[4]+'|'+easy_share_com[4]+'|'+mediafire_com[4]+'|'+megashares_com[4]+'|'+depositfiles_com[4]+'|'+vip_file_com[4]+'|'+sendspace_com[4]+'|'+yourfilehost_com[4]+'|'+rapidshare_de[4]+'|'+filebase_to[4]+'|'+link_protector_com[4]+'|'+bitroad_net[4]+'|'+filenavi_com[4]+'|'+uploadbox_com[4]+'|'+letitbit_net[4]+'|'+zshare_net[4] ,  document,	null,	XPathResult.UNORDERED_NODE_SNAPSHOT_TYPE,	null);
