...
// --------------------------------------------------------------------
// ==UserScript==
// @name           TribalWars Enhancer mod arabic by abo abdoullah
// @version        3.6.1
// @namespace      alnemer-99@hotmail.com - almousafamily.com
...
// @copyright      Copyright (c) 2007,2008,2009,2010, Gelu Kelu, Timas & Mr.abo abdoullah
// ==/UserScript==
...
hotkeyHandler(e);
*/
			$("#serverDate")[0].innerHTML = 'هذا السكيربت انشئ عن طريقة آبو عبدآلله' + points2; // + storage + '|' + woodnew + '|' + stonenew + '|' + ironnew;
