/**
 * InsaneJournal User Popup - Pretty/No Pic //  ID so I know which one I'm looking at
 *
 * // begin credits //
 *
 ...
 *
 * InsaneJournal User Popup - Pretty/No Pic, by Nostariel/Noxumbra and Gnatkip
 * Modified for InsaneJournal by Nostariel/Noxumbra
 * Pretty-fied and De-picced by Gnatkip (thnx, bb!)
 */

// ==UserScript==
// @name      InsaneJournal User Popup - No Pic
// @namespace	  insanejournal_userpopup_nopic
...
// Special constants for userpics. Ugly, I know, but I can't stand against it.
...
// Controls where script holds cache for userpics data.
...
for (var n = 0; n < nodes.snapshotLength; ++n) {
  ...
  timer = window.setTimeout(function() {
    ...
    div.id = 'lj_userpopup';
    div.style.cssText = 'border: 1px black solid; padding: 10px; background: Cornsilk; color: Black; font-family: Arial, sans-serif; font-size: .9em; position: absolute; z-index: 2001; left: ' + (pos[0] - 11) + 'px; top: ' + (pos[1] + 11) + 'px; text-align: left;-moz-opacity:' + optionOpacity + ';';
  ...
  if (account == ACCOUNT_USER) {
    ...
    popupText += '&bull; <a style="color: #414121;" href="http://' + userID + '.insanejournal.com/calendar">Calendar</a><br/>';
    ...
    popupText += '&bull; <a style="color: #414121;" href="http://www.insanejournal.com/inbox/compose.bml?user=' + userID + '">Send PM</a><br/>';
    popupText += '&bull; <a style="color: #414121;" href="http://www.journalfen.net/friends/add.bml?user=' + userID + '">Add Friend</a>';
    ...
    popupText += '&bull; <a style="color: #414121;" href="http://asylums.insanejournal.com/' + userID + '/friends">Friends</a><br/>';
    ...
    popupText += '</span>';
	  ...
	  profileAHREF = '<a style="color: #414121;" href="http://feeds.insanejournal.com/' + userID + '/profile?mode=full">';
    ...
    popupText += '<b><a style="color: #414121;" href="http://feeds.insanejournal.com/' + userID + '">' + userName + '</a></b><br/>';
    popupText += mainPopupSpanHTML;
		popupText += '<br/>';
    popupText += '&bull; ' + profileAHREF + 'User Info</a><br/>';
