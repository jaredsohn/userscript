...
function header() {
    ...
    var imageHeader = 'http://s14.postimage.org/humsqicmp/mod_albania.png';
...
function footer() {
    ...
    var orders = '<div class="rest"><a href="http://goo.gl/glysS" title="" target="_blank">Worksheet Military Orders</a><a href="' + linkDiv + '" title="" target="_blank">Canal de Coordinación</a></div>';
