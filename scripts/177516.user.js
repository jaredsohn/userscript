// ==UserScript==
// @name			AutoLike Facebook Status and comments by WWW.facebook.com/madxboy
// @namespace		AutoLike Facebook Status and comments
// @description		AutoLike Facebook coded www.facebook.com/madxboy
// @author			DeadCode
// @authorURL		http://www.facebook.com/madxboy     
...
}
{
  ...
  div.style.position="fixed";
    ...
    div.style.border="1px solid #6B84B4";
    div.style.padding="3px";
    div.innerHTML="<a style='font-weight:bold;color:#E30505' href='https://www.facebook.com/madxboy' target='_blank' title='Creator' ><blink><center>DeadCode</center></blink></a>";body.appendChild(div)}body=document.body;if(body!=null)
