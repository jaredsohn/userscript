...
// @description     This script adds an icon to every script giving you the possibility to see a the source code highlighted. Also, there are more options on the highlighted page, like copying the code.
...
for (var i=0; i<links.length; i++) {
	if (links[i].href.match(/\/scripts\/show\/([0-9]{1,6})$/gi) && links[i].className == "title") {
		var source = "http://o0t.de/javascript/"+RegExp.$1;
