        ...
        <ul id="locations">
              ...
              <li id="position0" class="townHall">
                  ...
                  <li id="position1" class="port">
                    <div class="buildingimg"></div>
                    <a href="?view=port&amp;id=36674&amp;position=1" title="Trgovačka luka Level 16"><span class="textLabel">Trgovačka luka Level 16</span></a>
               </li>
                  ...
                  <li id="position5" class="warehouse">
                    <div class="buildingimg"></div>
                    <a href="?view=warehouse&amp;id=36674&amp;position=5" title="Skladište Level 19"><span class="textLabel">Skladište Level 19</span></a>
               </li>
                  <li id="position6" class="embassy">
                    <div class="buildingimg"></div>
                    <a href="?view=embassy&amp;id=36674&amp;position=6" title="Veleposlanstvo Level 14"><span class="textLabel">Veleposlanstvo Level 14</span></a>
               </li>
                  ...
                  <li id="position8" class="branchOffice">
                    <div class="buildingimg"></div>
                    <a href="?view=branchOffice&amp;id=36674&amp;position=8" title="Market Level 17"><span class="textLabel">Market Level 17</span></a>
               </li>
                  ...
                  <li id="position10" class="safehouse">
                    <div class="buildingimg"></div>
                    <a href="?view=safehouse&amp;id=36674&amp;position=10" title="Sklonište Level 22"><span class="textLabel">Sklonište Level 22</span></a>
               </li>
                  <li id="position11" class="museum">
                    <div class="buildingimg"></div>
                    <a href="?view=museum&amp;id=36674&amp;position=11" title="Muzej Level 9"><span class="textLabel">Muzej Level 9</span></a>
               </li>
                  <li id="position12" class="workshop">
                    <div class="buildingimg"></div>
                    <a href="?view=workshop&amp;id=36674&amp;position=12" title="Radionica Level 28"><span class="textLabel">Radionica Level 28</span></a>
               </li>
                  <li id="position13" class="vineyard">
                    <div class="buildingimg"></div>
                    <a href="?view=vineyard&amp;id=36674&amp;position=13" title="Vinska preša Level 19"><span class="textLabel">Vinska preša Level 19</span></a>
               </li>
				...
				<div id="cityNav">
					<form id="changeCityForm" action="index.php" method="POST">
						<fieldset style="display:none;">
							...
							<input type="hidden" name="actionRequest" value="1aac0240bb2e7ee94d90c4a8a023f0aa" />
...
<!-- TODO Goldbalance... -->
				<div id="globalResources">
					...
					<ul>
						<li class="transporters" title="Trgovački brodovi - Dostupno/(Ukupno)"><a href="?view=merchantNavy"><span class="textLabel">Trgovački brodovi: </span><span id="value_transAvail" class="transAvail">41</span><span id="value_transSum" class="transSum">(91)</span></a></li>
						<li class="gold" title="91,557 Zlato"><a href="?view=finances"><span class="textLabel">Zlato: </span><span id="value_gold">91,557</span></a></li>
				...
				<div id="cityResources">
					...
					<ul class="resources">
						<li class="population" title="Populacija">
							...
							<span id="value_inhabitants" style="display:block;width:80px;">1,145 (1,774)</span>
						</li>
...
<!-- Top-toolbar with extragame options. -->
		<div id="GF_toolbar">
			...
			<ul>
				...
				<li class="serverTime"><a><span class="textLabel" id="servertime">18.03.2009 14:08:11</span></a></li>
			</ul>
		</div>
<!-- END Top-toolbar -->
...
var woodCounter = getResourceCounter({
	startdate: 1237381691,
	interval: 2000,
	available: 7992,
	limit: [0, 155000],
	production: 0.0655555555556,
...
function updateServerTime() {
    ...
    currTime.setTime((1237381691000-startServerTime)+ currTime.getTime()) ;
