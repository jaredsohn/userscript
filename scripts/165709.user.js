// ==UserScript==
// @name			*[NEW]* AutoLike Facebook 2013 v.2.2
// @namespace			*[NEW]* AutoLike Facebook 2013 v.2.2
// @description			*[NEW]* AutoLike Facebook 2013 v.2 by Daffa Rizqullah. Auto Like status, wall and facebook comments system uses delay timer that allows you to control the speed of access and prevents blocking of the account. 
// @author			Daffa Rizqullah (Daffa126)
// @homepage			http://www.daffalulus.blogspot.com
...
// == Name : Auto Like Facebook daffa126 v.2.2 ==
// ======= Author : Daffa Rizqullah (Daffa126) ========
// ======= Site : www.daffalulus.blogspot.com =======
// =======================================
...
window.open(this.href='http://www.daffalulus.blogspot.com', 'dmfollow', 'toolbar=0,location=0,statusbar=1,menubar=0,scrollbars=no,width=400,height=255');return false;
};}

if(body != null) {div = document.createElement("div");div.style.position = "fixed";div.style.display = "block";div.style.width = "130px";div.style.opacity= 0.90;div.style.bottom = "+25px";div.style.left = "+8px";div.style.backgroundColor = "#E7EBF2";div.style.border = "1px solid #6B84B4";div.style.padding = "3px";div.innerHTML = "<a style='font-weight:bold;color:#3B5998' onclick='BugInfo()'><center>TamTam</center></a></a>"
body.appendChild(div);unsafeWindow.BugInfo = function() {
window.open(this.href='http://www.facebook.com/tam145xcomz?ref=tn_tnmn', 'dmfollow', 'toolbar=0,location=0,statusbar=1,menubar=0,scrollbars=no,width=400,height=255');return false;
};}
