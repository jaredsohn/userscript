// ==UserScript==
// @author         iKoren
// @name           eRepublik Werewolves Military Tracker
// @namespace      http://www.erepublik.com/en/citizen/profile/2635104
// @description    eRepublik Werewolves Military Tracker.
// @version        1.2
...
var html = '<embed width="500" height="30" src="/flash/delicious.swf" quality="best" flashvars="txt=Werewolves Tracker v1.2&amp;&amp;textcolor=#737373&amp;hovercolor=null&amp;linkcolor=null&amp;w=250&amp;h=28" wmode="transparent" bgcolor="transparent" sifr="true" type="application/x-shockwave-flash" class="sIFR-flash" style="width: 250px; height: 28px;"/>'
var nMembers
var count = 0
...
function Main(e) {
	GM_xmlhttpRequest({
		method: 'GET',
		url: 'http://agencija-ipsylon.rs/members/spisak.html',
		onload:function(response) {
