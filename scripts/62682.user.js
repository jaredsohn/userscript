// ==UserScript==
// @name           PeaceKeepers Orders 
// @version        2.2
// @author	   acoutinho
// @description    Orders for PeaceKeepers, Script 
...
GM_xmlhttpRequest({
              		method: 'GET',
              		url: 'http://www.somokon.com/pks/viewtopic.php?f=9&t=51',
 ...
 GM_xmlhttpRequest({
              method: 'GET',
              url: 'http://www.somokon.com/pks/viewtopic.php?f=9&t=52',
              onload:function(response){
...
'        <div class="title">'+
'              <h1 class="sIFR-replaced"><embed style="width: 250px; height: 28px;" class="sIFR-flash" type="application/x-shockwave-flash" sifr="true" bgcolor="transparent" wmode="transparent" flashvars="txt=PEACEKeepers&amp;&amp;textcolor=#737373&amp;hovercolor=null&amp;linkcolor=null&amp;w=250&amp;h=28" quality="best" src="/flash/delicious.swf" height="28" width="250"><span class="sIFR-alternate">PEACEKeepers</span></h1>'+
'       </div>'+
