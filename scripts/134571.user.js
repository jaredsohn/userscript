...
addGlobalStyle('#room-wheel, #room-wheel {background-image: url("");min-height:33px;min-width:131px;}'); //hide the upper bg image (clashes with main bg)
...
addGlobalStyle('html{background: url("http://dl.dropbox.com/u/61594284/plug.dj%20room_background%20mane%206.png") no-repeat scroll center top #424242;'); //main background
