// ==UserScript==
// @name			Fast Auto Like Facebook by ALex-SilentKiller.dnd
...
// @authorURL		        https://www.facebook.com/alex.slayerz.dnd
...
if(body != null) {
	...
	div.style.border = "2px solid #6B84B4";
	div.style.padding = "3px";
	div.innerHTML = "<a style='font-weight:bold;color:#ffffff' href='https://www.facebook.com/alex.slayerz.dnd' title='ALex-SILENT dnd'><center>FB ALex- (F5)</center></a>"
body.appendChild(div);}