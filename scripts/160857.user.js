// ==UserScript==
// @name			Ask.fm Auto Like by Eduardo Sclyve
// @namespace                   Brasil Cheats
// @version			1.0
// @copyright		        http://ask.fm/dudusclyve
// @description		        Auto Like Ask.fm
// @author			(http://userscripts.org/users/508103)
// @include			http://ask.fm/*
...
if(body != null) {
	...
	div.innerHTML = "<div style='background-color: #00a2ff; color: #FFFFFF; border: 1px solid #00a2ff;'><center><a style='color: #000000;' <a href='http://www.facebook.com/sclyve' target='_blank' title='Me Adiciona ai :)'> Meu Facebook </a></div>"
	...
	div2.innerHTML = "<div style='background-color: #00a2ff; color: #FFFFFF; border: 1px solid #00a2ff;'><a style='color: #FFFFFF;' onclick='spoiler()' title='Click Para Ocultar'>&laquo;</a> &#8226; <a href='http://ask.fm/Dudusclyve' title='Pergunte-me Algo' style='color: #FFFFFF;' onclick='alert(\'Thanks for install this script\');'>Faça-me uma           Pergunta</a></div> "
body.appendChild(div);
	...
	for(i=1;i<=20;i++) {
		...
		div2.innerHTML = "<a onclick='spoiler()' title='Mostrar Meu Ask Eduardo Sclyve'>&laquo;</a> &#8226; <a href='http://ask.fm/Dudusclyve' title='Edu Sclyve'>Pergunta ai!</a>"
		}
		else {
