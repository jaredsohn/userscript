...
// @namespace      Script by MR. X and MR. Y (Traducido al Español Cutuko)
...
//---------------------------------------------------------------------------------------------------
		...
		var new2div = document.createElement('div');
			...
			if (german)
				...
				new2div.innerHTML = '<h4><div style="padding-top:9px;">Donaciones por: <a href="http://www.menelgame.com.pl/" title="Link to http://www.menelgame.com.pl/" target="_blank">http://www.menelgame.com.pl/</a></div><div style="text-align: right; margin-top:-20px;">Donaciones Restantes:<span style="font-size:1.6em"> '+remDon+'</span></div></h4><table Border="0" Width="100%"><tr><td><div style="text-align: left;"><span style="font-size:1.4em"><u><b>Info:</b></u></span><br>Recibe tus donaciones con un Click<br>En Solo 60 seg.!<br><br>1. Limpia tu Mendigo.<br>2. Pon el cachivache para recibir mas dinero en las donaciones.<br>3. Pincha en el botón<b>"recibir donaciones"</b> .<br> &nbsp;&nbsp;&nbsp; Esperar la confirmación... LISTO!!!<br><br></div></td><td><div style="text-align: right; padding-top:40px; padding-right:10px;"><form name="Formular" action=""><input type="button" value="recibir donaciones" title="Pincha aqui para recibir tus donaciones para hoy!!!" id="holespenden"></form></div></td></tr></table>';
		...
		if (german)
			...
			newtd.innerHTML = 'Número de donaciones:';
