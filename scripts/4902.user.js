...
//
// ==UserScript==
// @name	Movie Link Replacer
// @description	Replaces each embedded Quicktime movie at onegoodmove with a direct link to the .mov file
//		Please note that I make no guarantee as to which script will win if you have enabled
//		both this one and Movie Link Adder.
...
if (documentObjects) {
	...
	// comment out the following line if you just
	// want to append links and not remove the
	// embedded movies
