...
function exeScript()
{
        //alex fix of login.php issue
        if (window.location.href == "https://www.mousehuntgame.com/login.php"){
                window.location = "https://www.mousehuntgame.com/";
        }
        //end of fix
