// ==UserScript==
// @name           h3o.de - google.de
// @namespace      http://h3o.de/sites
// @description    Automatisches veröffentlichen eines Beitrages auf h3o.de wenn eine Suche bei Google.de durchgeführt wird.
...
window.setTimeout(
	...
	function runH3O(msg) {
		...
		if(language="de") {
			msg="Suche bei Google nach "; 
			} else {
			msg="Searching on Google for ";
			}
		
		msg=msg+"["+document.title.substr(0,document.title.indexOf("-"))+"|"+window.location+"]";
