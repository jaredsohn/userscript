...
var language = { 
	...
	by: { textChoseLogSite: "Абярыце лагоўніцу:", 
        ...
        lv: { textChoseLogSite: "Izvēlies saglabāšanas vietu:",
              textHeader: "Saglabāt kaujas atskaiti",
              textSave: "Saglabāt",
              textGettingRound: " Saņemu raundu Nr.: ",
              textComment: "Pievienot komentāru:",
              textShort: "īsā",
              textFull: "pilnā",
              textLast3: "pēdējie 3 raundi",
              textGettingRoundError: "Kļūda saņemot raundu ",
              textHeaderSpy: "Saglabāt spiega atskaiti" },
	de: { textChoseLogSite: "Internetseite wählen:",
	      textHeader: "Kampf- / Spionagebericht speichern",
	      textSave: "speichern",
	      textGettingRound: " speichere Runde ",
	      textComment: "Kommentar hinzufügen:",
	      textShort: "kurz",
	      textFull: "alles",
	      textLast3: "letzten 3",
	      textGettingRoundError: "Fehler bei Runde ",
	      textHeaderSpy: "Speichere Spionbericht" }
}
               ...
               if(this.status == 200){
	               ...
	               switch (getCookie("chosenLogSite")) {
			        	...
			        	if (nextRound==null && prevRound==null){ //there is only one round. save it
			                	if (checkRoundExistence!=null) { //if we participated in this round
...
function handleError(message) {
        alert("Ikariam BattleLog saver: "+message);
        submitLogData();
        return;
}
		                     ...
		                     <div class="content"> \
        	                        <p>'+language[lang].textChoseLogSite+'</p> \
                	                    <select id="LoggingSelect" class="citySelect bigFont" name="LoggingId" onchange="return false;"> \
                                	        ...
                                	        <option class="coords" value="ShahterovLast3" ' + (LogSite == 'ShahterovLast3' ? 'selected="selected"' : '') + '><p>Shahterov.Net ('+language[lang].textLast3+')</p></option> \
