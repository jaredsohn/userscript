...
// @description    Automated features for me
// ==/UserScript==


var Version = '02092012beta';
  ...
  init : function (div){
    ...
    try {      
      m = '<DIV style="height:500px; max-height:500px; overflow-y:auto"><TABLE width=100% class=pbOptions cellspacing=0 cellpadding=0>\
        ...
        <TR><TD><INPUT id=pbFoodToggle type=checkbox /></td><TD>'+translate("Enable Food Alert (On less then 2 Hours of food checked every hour)")+'</td></tr>\
...
Tabs.Chat = {
  tabOrder : 300,                    // order to place tab in top bar
  tabDisabled : !ENABLE_CHAT_TAB, // if true, tab will not be added or initialized
  //tabLabel : 'Click Me',            // label to show in main window tabs
  myDiv : null,
  timer : null,  
