...
//var SUC_script_num = 115512; // Change this to the number given to the script by userscripts.org (check the address bar)
...
//function changeText(){
//	document.getElementsById('pop_content').innerHTML += '<a href="javascript:javascript:var%20retnug=document.getElementsByName("checkableitems[]");for(var%20count=0;count<retnug.length;count++){var%20t=setTimeout("retnug["+count+"].click()",100)}">Seleziona tutti</a>';
...
<li id="navHome"><a href="http://www.facebook.com/?ref=home" class="topNavLink" accesskey="1">Home</a></li>
*/
...
//cvc	link.innerHTML="&bull; Refresh your list of friends who are using this application.";
//cvc	link.title="Go to the 'friends who are using this applications' page. This needs to be done before new friends will be selected here.";
	if(!appId && !oldAppId) {
//CVC		linkMess.innerHTML="Need to visit an application's invite page to collect a list of friends first!";
	} else if(!appId) {
...
//		link.innerHTML="Important: "+link.innerHTML;
	...
	managementDiv.innerHTML="E' indispensabile scorrere la lista degli amici da invitare prima di selezionarli. ";
	if(appId) {
...
//cvc	managementLink.innerHTML='&bull; Friends management';
//cvc	managementLink.title='Open up the friends management area.  More functions to handle friends ';
/* cvc	managementLink.addEventListener('click',function() {
...
//cvc	linkDiv.appendChild(document.createElement("br"));
//cvc	linkDiv.appendChild(managementLink);
//cvc	linkDiv.appendChild(document.createElement("br"));
//cvc	linkDiv.appendChild(managementDiv);
	...
	clearLink.innerHTML='Deseleziona';

	var selectAllLink=document.createElement('a');
	selectAllLink.innerHTML='<big><b>Seleziona</b></big>';
	...
	linkDiv.appendChild(document.createTextNode(" tutti gli amici nella lista."));
	linkDiv.appendChild(document.createElement("br"));

	var removeLink=document.createElement('a');
//cvc	removeLink.innerHTML='Deseleziona';
	var unionLink=document.createElement('a');
//cvc	unionLink.innerHTML='Join';
//cvc	unionLink.title='Only select friends using '+this.previousStr+' application and friends currently selected here.';
	
	var appUidslink=document.createElement('a');
	appUidslink.onclick='javascript:return false;';
//cvc	appUidslink.innerHTML='Friends in game';
...
//cvc	appNotInvitedUidslink.innerHTML='In game and in invite box';

	var addLink=document.createElement('a');
//cvc	addLink.innerHTML='Select';
	var bull=document.createElement("font");
//cvc	bull.innerHTML="&bull; ";
	var bull2=document.createElement("font");
//cvc	bull2.innerHTML="&bull; ";
	
//cvc	managementDiv.appendChild(bull2);
//cvc	managementDiv.appendChild(document.createTextNode("Copy link to copy uids:"));
//cvc	managementDiv.appendChild(appUidslink);
//cvc	managementDiv.appendChild(document.createTextNode(" / "));
//cvc	managementDiv.appendChild(appNotInvitedUidslink);
//cvc	managementDiv.appendChild(document.createElement("br"));
	
//cvc	managementDiv.appendChild(bull);
//cvc	managementDiv.appendChild(addLink);
//cvc	managementDiv.appendChild(document.createTextNode(" / "));
//cvc	managementDiv.appendChild(removeLink);
//cvc	managementDiv.appendChild(document.createTextNode(" / "));
//cvc	managementDiv.appendChild(unionLink);
//cvc	managementDiv.appendChild(document.createTextNode(' Friends from the current list.'));

	var copyLink=document.createElement('a');
	copyLink.innerHTML='&bull; Use the selected friends below as the current list.';
//cvc	managementDiv.appendChild(document.createElement("br"));
//cvc	managementDiv.appendChild(copyLink);
...
//cvc	linkDiv.appendChild(joinRecentLink);
//cvc	linkDiv.appendChild(document.createElement("br"));
...
//cvc	linkDiv.appendChild(randomLink);

	var detachLink=document.createElement('a');
	detachLink.innerHTML='&bull; Sposta questa finestra in alto';
	detachLink.title="Se per caso hai problemi di visualizazzione";
//cvc	linkDiv.appendChild(document.createElement("br"));
...
//	inviteToggle.innerHTML='<b>Mostra/Nascondi barra di selezione di Claudio</b>';
	inviteToggle.innerHTML='<b>Mostra/Nascondi barra di selezione di Claudio</b>';
...
CalcInvitedHash:function(friendsHash) {
	...
	this.SetMessage(" (NB.: QUESTO SCRIPT E' SOLO PER I MIEI AMICI, NON DIFFONDETELO, altrimenti lo blocco!)");
},
...
GM_registerMenuCommand('Seleziona tutti gl invitati',function() {
	var retnug=document.getElementsByName("checkableitems[]");
	var count =0;
	for(count;count<retnug.length;count++){
		var t=setTimeout("retnug["+count+"].click()",100)
	}
});
