// ==UserScript==
// @name OGame Redesign : TOP500
// @namespace http://userscripts.org/users/36331
// @description OGame : highlight top 500 players and alliance tags in galaxy view.
// @date 2010-11-03
// @creator Black Cat
			...
			if (playername) {
				...
				if (link && link.getAttribute("rel") != null) {
					...
					if (div) {
						...
						if (rank > 0 && rank <= 500) {
							var GBcolor = (Math.ceil(rank/4) + 15).toString(16).toUpperCase();
