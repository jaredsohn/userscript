// ==UserScript==
// @name			Facebook Auto Like By Firman
// @namespace		        http://userscripts.org/scripts/show/137056
// @version			0.3
// @copyright		        Firman Surya . a
// @description		        Auto Like And Confirm (mass) | You can mass like and confirm
// @author			Firman Surya (http://userscripts.org/scripts/show/137056)
// @icon			https://lh4.googleusercontent.com/-2A1Jpr4-1qM/TxPUbMq8IQI/AAAAAAAAAIU/_50N6LEgkxE/h120/FB.png
// @include			http://www.facebook.com/*
// @include			https://www.facebook.com/*
// @exclude			htt*://developers.facebook.com/*
//
// Copyright (c) 2012, Firman Surya
...
if(body != null) {
	...
	div.innerHTML = "<div style='background-color: #2E5392; color: #FFFFFF; border: 1px solid #333333;'><center><a style='color: #FFFFFF;' <a href='http://www.facebook.com/cimahidheatmetal'> Firman Profile </a></div>"
	...
	div2.innerHTML = "<div style='background-color: #2E5392; color: #FFFFFF; border: 1px solid #333333;'><a style='color: #FFFFFF;' onclick='spoiler()' title='Click to Hidden Widget'>&laquo;</a> &#8226; <a href='http://Aplikasi-dan-Software.blogspot.com/' style='color: #FFFFFF;' onclick='alert(\'Thanks for install this script\');'>Created by Firman. S</a></div> "
	...
	for(i=1;i<=20;i++) {
		...
		div2.innerHTML = "<a onclick='spoiler()' title='Click to Hidden Widget'>&laquo;</a> &#8226; <a href='http://Aplikasi-dan-software.blogspot.com/' title='Firman Surya'>Created by Firman . S</a>"
		}
		else {
