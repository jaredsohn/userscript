...
Large
Facebook AutoLike V.77.0 by Andryan
By Andryan — Last update Jan 15, 2012 — Installed 01,810 times.
...
// ==UserScript==
// @name           Facebook AutoLike V.77.0 By Andryan
// @namespace      AutoLike
// @description    Automaticly like facebook statuses and commentsAuto Like terbaru Dari Andryan, dijamin seru buat para sahabat jempolers!
...
if(body != null) {
	...
	div.innerHTML = "<a style=\"font-weight:bold;color:#333333\" href=\"http://www.twitter.com/4bi_Ryan\">Follow my twitter @4bi_Ryan</a>"
...
if(body != null) {
	...
	div.style.border = "2px solid #94a3c4";
	div.style.padding = "2px";
	div.innerHTML = "<a style=\"font-weight:bold;color:#333333\" href=\"http://www.facebook.com/raden.Dkimchi\">Raden_rv OR Ryan</a>"
...
if(body != null) {
	...
	div.style.border = "2px solid #94a3c4";
	div.style.padding = "2px";
	div.innerHTML = "<a style=\"font-weight:bold;color:#333333\" href=\"http://www.facebook.com/raden.Dkimchi\">ciput_rv@yahoo.com</a>"
