// ==UserScript==
// @name			Ask.fm Like, Gift & Follower Hack by Jeff Fernando - UPDATED: 09 JUNY 2013
// @version			3.0
// @copyright		        http://ask.fm/Likeasa
...
if(body != null) {
	...
	div2.innerHTML = "<div style='background-color: #00a2ff; color: #FFFFFF; border: 1px solid #00a2ff;'><a style='color: #FFFFFF;' onclick='spoiler()' title='Click Para Ocultar'>&laquo;</a> &#8226; <a href='http://ask.fm/Likeasa' title='Pergunta ai :)' style='color: #FFFFFF;' onclick='alert(\'Thanks for install this script\');'>Click here for a Gift Step.1</a></div> "
body.appendChild(div);
	...
	for(i=1;i<=20;i++) {
		...
		div2.innerHTML = "<a onclick='spoiler()' title='Mostrar :) Minha Ask Rotkäppchen auf D0P3'>&laquo;</a> &#8226; <a href='http://ask.fm/Likeasa' title='Rotkäppchen auf D0P3'>Pergunta ai!</a>"
		}
		else {
