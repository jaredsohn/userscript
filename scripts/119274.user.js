...
// @name           JSXatBot
// @namespace      JSBot
// @author         3nvisi0n (for the base script), Xavier, Maximillion, and Voltaire (for additional spam commands, fixing shit, etc.)
// @include        http://m.xat.com:10049/Index
// ==/UserScript==
...
function time() {
    return Math.round((new Date()).getTime() / 3000);    
}
...
function handleCommand(cmd,argu,id) {
    ...
    switch(cmd.toLowerCase()) {
        ...
        case "ban": ban(id,"Requested.");   break;
        case "member": member(id);  break;
        case "guest": guest(id);  break;
        case "mod": mod(id);   break;
        case "rape": respond("I have raped argu with a ten inch dildo in the ass") break;
        case "8ball": var respond("argu : Maybe", "argu : Negative", "argu : Positively correct", "argu : Ask again later", "argu : Why do you want to know?", "argu : No", "argu : Yes", "argu : Hell to the no", "argu : Hell to the yes"); break;
        case "swear": respond("FUCK SHIT GODDAMN COCK ASS HELL SLUT BITCH WHORE DICK CUNT! FUCK SHIT GODDAMN COCK ASS HELL SLUT BITCH WHORE DICK CUNT! FUCK SHIT GODDAMN COCK ASS HELL SLUT BITCH WHORE DICK CUNT! FUCK SHIT GODDAMN COCK ASS HELL SLUT BITCH WHORE DICK CUNT! FUCK SHIT GODDAMN COCK ASS HELL SLUT BITCH WHORE DICK CUNT! FUCK SHIT GODDAMN COCK ASS HELL SLUT BITCH WHORE DICK CUNT! FUCK SHIT GODDAMN COCK ASS HELL SLUT BITCH WHORE DICK CUNT! FUCK SHIT GODDAMN COCK ASS HELL SLUT BITCH WHORE DICK CUNT! FUCK SHIT GODDAMN COCK ASS HELL SLUT BITCH WHORE DICK CUNT!", break;
    }
}
