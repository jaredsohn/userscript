// ==UserScript==
// @name            Add Change Name link on Myspace
// @namespace       Platypus
// @description     Adds a change name link under the profile drop down menu on all pages that have one. which links you to the spot where you may change your display name.
// @include         http://*.myspace.com/*
// ==/UserScript==
function do_platypus_script() {
do_modify_url_it(window.document,document.evaluate('/HTML[1]/BODY[1]/DIV[1]/DIV[1]/DIV[3]/UL[1]/LI[3]/UL[1]/LI[8]/A[1]', document, null, XPathResult.FIRST_ORDERED_NODE_TYPE,null).singleNodeValue,/http:\/\/favorites\.myspace\.com\/index\.cfm\?fuseaction=user\.favorites/,'http://profileedit.myspace.com/index.cfm?fuseaction=profile.names',false);
do_modify_html_it(window.document,document.evaluate('/HTML[1]/BODY[1]/DIV[1]/DIV[1]/DIV[3]/UL[1]/LI[3]/UL[1]/LI[8]/A[1]', document, null, XPathResult.FIRST_ORDERED_NODE_TYPE,null).singleNodeValue,/My Favorites/,'Change Name',null);
