...
// @version        0.2
// @include        http://ts2.travian.co.id/*
...
function getMap(x, y) {
	$.getJSON('http://ts2.travian.co.id/ajax.php', "cmd=mapPositionData&data[x]=" + x + "&data[y]=" + y + "&data[zoomLevel]=2&", function(data) {
...
var AnotherAutoUpdater = { // update script by dhi_travianisti THANKS! http://userscripts.org/scripts/show/38017
