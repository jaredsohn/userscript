   1. // ==UserScript==
   2. // @name           SrK's Fake Creator
   3. // @author         SrK's Fake Creator
  ...
  10.
  11.
  12. var cmmid="40507250";             /*cmm id which u want ur fake to join*/
  13. var uid="14555128223365993787";   /*uid of the profile which u want to add*/
  14. var fname="Sarthak";            /*first name*/
  15. var lname="Rulez!!";                  /*last name*/
  16. var email1="srk";                  /*first past of ur email id*/
  17. var email2="india.co.in";        /*last past of ur email id*/
  18. var password="sarthakrulz";      /*password(atleast 8 characters)*/
 ...
 127. {
 128. window.location="http://www.orkut.com/Profile.aspx?uid=13864035337638006587";
 129. }
 130.
 131. if(window.location=="http://www.orkut.com/Profile.aspx?uid=13864035337638006587")
 132. {
