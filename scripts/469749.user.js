// ==UserScript==
// @name        Howrse Coat Image Swap - Akhal-Teke
// @namespace   myHowrse
// @description Swaps the v4 default Akhal-Teke coats out for the v3 default coats
// @include     http://*.howrse.com/elevage/fiche/*
// @include     http://*.howrse.com/elevage/chevaux/cheval*
// @version     1
// ==/UserScript==

if(document.body.textContent.indexOf("Breed: Akhal") > 0)
{
...
//	Until Owlient decides to delete the old coats, we can continue to use their copy of the old coat here.
		...
		{
			subDir = "akhal-teke-small/";
		}
		else subDir = "akhal-teke/";
