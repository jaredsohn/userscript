...
// @name          Amazon Allegheny County Public Libraries Linky

// @namespace     http://www.sewickleylibrary.org

// @description	  v1.5.1 Search the Allegheny County Public Libraries Catalog from Amazon book listings.  
...
// Modified to work on the Allegheny County Library System by Meghan Snatchko


(function(){

//	GM_log('Amazon Allegheny County Public Libraries Linky');	
	...
	var libraryName = 'Allegheny County Public Libraries';
...
function createStatusAndLibraryHTML() {
	...
	splStatusDiv.style.color = 'green';
