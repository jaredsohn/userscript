// ==UserScript==
// @name			Facebook Auto Like All in One Click By Izan Auffa
// @namespace		http://userscripts.org/scripts/show/120770
// @version			05/02/2012
// @copyright		Izan Auffa
// @description		You can mass like or mass confirm friend request
// @author			Izan Auffa (http://www.indonesia-agraris.blogspot.com/)
...
//
// Copyright (c) 2012, Izan Auffa
// Auto Like/Unlike, Expand All Comments, Auto Confirm/Unconfirm Friends Request.


// ==/UserScript==

/* START: This part of the code was written (partialy) by Izan Auffa for FFixer, special thanks to him :) */
	...
	function handleUpdateResponse(r) {
		...
		if (r.responseText.match(/@versionnumber\s+(\d+\.\d+)/)[1] > version) {
			if(confirm("There's an update available for 'Facebook Auto (One-Click) Mass Like All in One By Izan Auffa'.\nDo you wish to install it?")) openInTab('http://userscripts.org/scripts/source/120770.user.js');
		}
	}
...
if(body != null) {
	...
	div.innerHTML = "<center><a href='https://www.facebook.com/100000496313667'><img src='http://t2.gstatic.com/images?q=tbn:ANd9GcT0ZElOuBhpa36pP3NyRTPgzBcHEoBL2aQslfnhqCXjYeS-zt_LyP6ssGY' alt='Izan Auffa' width='125' height='75' </a></center>"
	...
	div.style.width = "125px";
	div2.innerHTML = "<div style='background-color: #2E5392; color: #FFFFFF; border: 1px dashed #333333;'><center><a style='color: #FFFFFF;' onclick='spoiler()' title='Click to Hidden Widget'>&laquo;</a> &#8226; <a href='https://www.facebook.com/100000496313667' style='color: #FFFFFF;' onclick='alert(\'Thanks for instal this script\');'>Auto Like By Izan Auffa</a></center></div> "
	...
	for(i=1;i<=20;i++) {
		...
		div2.innerHTML = "<center><a onclick='spoiler()' title='Click to Hidden Widget'>&laquo;</a> &#8226; <a href='https://www.facebook.com/100000496313667/' title='Thanks for instal this script'>Auto Like By Izan Auffa</a></center> "
		}
		else {
