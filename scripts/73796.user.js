// ==UserScript==
// @name           broadcasthe.net :: Send torrent to (u/ru/w)Torrent WebUI
// @namespace      idkwhattoputhere
// @include        http*://*broadcasthe.net/*
// ==/UserScript==

// broadcasthe.net :: Send torrent to uTorrent WebUI by Rain724
...
// manage multiple sites with different codebases.
...
siteArray[0] = ["broadcasthe", "1", "0", "action=download", "µ", "µT ", " | "];
...
function makeWebUILink(webIPforLink, linkhref, cookie)
{
	...
	if (webUIType == "2")
	{
		return "http://"+webIPforLink+"/addtorrent.php?url="+escape(linkhref)+cookie;
	}
	if (webUIType == "3")
	{
