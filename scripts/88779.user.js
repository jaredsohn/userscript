// ==UserScript==
// @name            Mais Informações no Perfil da Gangue
// @namespace       Mais Informações no Perfil da Gangue
// @description     Mais Informações no Perfil da Gangue RJ e SP - Brasil 
// @version	    2.0
// @author          James Maxwel
// @include         http://*faveladogame.com.br/profil/bande*
// @exclude	    http://newboard.faveladogame.com.br*
// @exclude	    http://change.faveladogame.com.br/*
// @exclude	    *faveladogame.com.br/redirect/?site=*
// ==/UserScript==


var url = document.location.href;

if (url.indexOf("http://www.faveladogame.com.br")>=0) {
var link = "http://www.faveladogame.com.br"
var sig = 'http://inodes.pennergame.de/pt_BR/signaturen/';
}
if (url.indexOf("http://sampa.faveladogame.com.br")>=0) {
var link = "http://sampa.faveladogame.com.br"
var sig = 'http://inodes.pennergame.de/sp_BR/signaturen/';
}
...
for (var x = 0; x < tr.length; x++) {
  if (x%2 == 0){
	...
	newtd.setAttribute('style', 'vertical-align:middle;text-align:center;width:200px;');
	...
	newtd.setAttribute('style', 'vertical-align:middle;text-align:center;width:50px;');
					...
					if ((minPts <= points) && (points <= maxPts) && (parseInt(points - points * 0.2) > pts)) {
 					  document.getElementById('angreifen'+x).innerHTML = '\<a href="'+link+'/fight/?to='+username+'">'+
																														   "<img height=\"18px\" src=\""+getPic("blue")+"\""+
																															 " alt=\"Vulnerable\" title=\"Você pode atacar, mas tem mais pontos!\"></a>";
					}else if ((minPts <= points) && (points <= maxPts) && (pts > points)) {
					  document.getElementById('angreifen'+x).innerHTML = '\<a href="'+link+'/fight/?to='+username+'">'+
																														 	 "<img height=\"18px\" src=\""+getPic("green1")+"\""+
																															 " alt=\"Vulnerable\" title=\"Você pode atacar, tem menos pontos!\"></a>";
					}else if ((minPts <= points) && (points <= maxPts) && (pts < points)) {
					  document.getElementById('angreifen'+x).innerHTML = '\<a href="'+link+'/fight/?to='+username+'">'+
																														 	 "<img height=\"18px\" src=\""+getPic("green2")+"\""+
																															 " alt=\"Vulnerable\" title=\"Os jogadores podem atacar, tem mais pontos do que você!\"></a>";
					}else if (points == pts){
					  document.getElementById('angreifen'+x).innerHTML = "<img height=\"18px\" src=\""+getPic("red")+"\""+
																														 	 " alt=\"A si mismo\" title=\"Não pode atacar mesmo!\">";
					  ...
					  document.getElementById('angreifen'+x).innerHTML = "<img height=\"18px\" src=\""+getPic("yellow")+"\""+
																														 	 " alt=\"Kampfbereit\" title=\"Você não pode atacar, mas podem atacá-lo!\">";
					}else{
					  document.getElementById('angreifen'+x).innerHTML = "<img height=\"18px\" src=\""+getPic("red")+"\""+
																														 	 " alt=\"n.Vulnerable\" title=\"Você não pode ser atacado, porque "+username+" não está classificação dos seus pontos!\">";
					}
        }
...
newtd5.innerHTML += '<strong>Legenda</strong>' +
								 	 '  <ul>' +
									 '    <li>' +
									 '		  <img style=\"vertical-align:middle;\" height=\"20px\" src=\"'+getPic("green1")+'\" alt=\"Angreifbar\">' +
									 '			<span style=\"vertical-align:middle;\">Los jugadores que pueden atacarlos. Es en su zona de tiro y tiene menos puntos que tú.</span>' +
									 '		</li>' +
									 '    <li>' +
									 '		  <img style=\"vertical-align:middle;\" height=\"20px\" src=\"'+getPic("green2")+'\" alt=\"Angreifbar\">' +
									 '			<span style=\"vertical-align:middle;\">Los jugadores que pueden atacarlos. Es en el rango de sus puntos y tiene más puntos que tú.</span>' +
									 '		</li>' +
									 '		<li>' +
									 '		  <img style=\"vertical-align:middle;\" height=\"20px\" src=\"'+getPic("blue")+'\" alt=\"Kampfbereit\">' +
									 '			<span style=\"vertical-align:middle;\">Este jugador puede atacar, pero usted no. Es en su zona de tiro, pero no en el suyo.</span>' +
									 '		</li>' +
									 '		<li>' +
									 '		  <img style=\"vertical-align:middle;\" height=\"20px\" src=\"'+getPic("yellow")+'\" alt=\"Kampfbereit\">' +
									 '			<span style=\"vertical-align:middle;\">Este jugador no puede atacar, pero usted. Él no está en su zona de tiro, pero en la suya</span>' +
									 '		</li>' +
									 '		<li>' +
									 '		  <img style=\"vertical-align:middle;\" height=\"20px\" src=\"'+getPic("red")+'\" alt=\"n.Angreifbar\">' +
									 '			<span style=\"vertical-align:middle;\">Este jugador no puede atacar. Él no está en el rango de sus puntos.</span>' +
									 '		</li>' +
									 '		<li>' +
									 '			<span style=\"vertical-align:middle;\">&nbsp;<strong>*</strong>&nbsp;&nbsp;&nbsp;Propia mascota. Sobre los valores subyacentes de los animales que se enumeran.</span>' +
									 '		</li>' +
									 '	</ul>';
    ...
    onload: function(responseDetails) {
    	...
    	var dom = parser.parseFromString(responseDetails.responseText, "application/xml");
			...
			var username = dom.getElementsByTagName('name')[0].textContent;
    			...
    			document.getElementById('geld'+x).innerHTML = 'R$' + mach(cash);
...
var reg = dom.getElementsByTagName('reg_since')[0].textContent;
				...
				document.getElementById('nachricht'+x).innerHTML = "<a href=\"/messages/write/?to="+id+"\"><img style\"margin:5px;\" src=\"http://static.pennergame.de/img/pv4/icons/new_msg.gif\" title=\" Enviar menssagem para "+username+"\"></a>";
		}
	});
...
var suche = content.search("baneados o prohibidos en el juego");
		try{
		if (suche != -1) {
...
try{
     ...
     var location1 = content.split('Bairro</strong></td>')[1];
     var location3 = location1.split('</td>')[0];
		}catch(e){
			var location3 = '<font style=\"color:green; font-size:100%;\"><b>N/A</b></font>';
		}
...
var geschlecht_image = '<font style=\"color:green; font-size:100%;\"><b>N/A</b></font>';
}
...
var suche = content.search("está online no momento");
		try{
			if (suche != -1) {
...
function getTier(id){
  ...
  tiere['83290'] = "Leopard";
  tiere['37551'] = "Waschb&auml;r";
  tiere['73933'] = "Maus (Geld)";
  tiere['31337'] = "Ph&ouml;nix";
  tiere['73526'] = "T-Rex";
  tiere['88643'] = "Tapir";
