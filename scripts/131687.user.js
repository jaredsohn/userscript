// ==UserScript==
// @name           One Column Front Page - Expand Articles In Place - theverge.com
// @namespace      onefish
// @version        0.9.1.16
// @updateURL      https://userscripts.org/scripts/source/131687.meta.js
// @downloadURL    https://userscripts.org/scripts/source/131687.user.js
...
function makeCss() {
    addCss('\
.newarticle { border-bottom: 10px solid #FFFFFF; margin: 0 0 11px; padding-right: 12px; min-height: 135px; position: relative;}\
...
article .title { padding-left: 12px; padding-right: 12px; margin-left: 316px; margin-top: 10px; padding-top: 8px; line-height: 29px; }\
article .title > a { color: #5F5F5F; font-size: 23px; font-stretch: semi-condensed; font-weight: 600; word-spacing: 2px; }\
...
.newarticle quote { width: 400px; margin: -12px 8px -16px 0; font-size: 26px; line-height: 28px; letter-spacing: 0pt; text-align: right; }\
...
.bottom-reviews .feature-box .feature-meta { padding-top: 50%; }\
.bottom-reviews .feature-box .product-score-box { position: absolute; }\
.bottom-reviews div.review0 .feature-meta:before { background-image: -moz-linear-gradient(left top , #002F4B, #DC4225); background-image: -webkit-linear-gradient(left top , #002F4B, #DC4225); box-shadow: 0 0 30px 0 #721300 inset; content: ""; height: 246px; left: 0; opacity: 0.5; position: absolute; top: 0; width: 218px; z-index: -1; }\
.bottom-reviews div.review1 .feature-meta:before { background-image: -moz-linear-gradient(left top , #DC4225, #E0BE00); background-image: -webkit-linear-gradient(left top , #DC4225, #E0BE00); box-shadow: 0 0 30px 0 #721300 inset; content: ""; height: 246px; left: 0; opacity: 0.5; position: absolute; top: 0; width: 218px; z-index: -1; }\
.bottom-reviews div.review2 .feature-meta:before { background-image: -moz-linear-gradient(left top , #002F4B, #417711); background-image: -webkit-linear-gradient(left top , #002F4B, #417711); box-shadow: 0 0 30px 0 #721300 inset; content: ""; height: 246px; left: 0; opacity: 0.5; position: absolute; top: 0; width: 218px; z-index: -1; }\
...
.open-review div a .shadowbox { max-height: 220px; }\
...
function expand(thisArticle, html) {
    ...
    if (bigGuy.querySelector('.article-entry')) {
        ...
        for(u=0; u < updates.length; u++){
            ...
            updateList.lastElementChild.insertBefore(document.createElement('span'), updateList.lastElementChild.lastElementChild);
...
function createArticle(titleHTML, href, author, authLink, date, catsHTML, alt, src, heat, comments, quoteHTML, textBoxHTML) {
    ...
    artHTML += '" src="';
    artHTML += src;
    artHTML += '"></div></a></div><h2 class="title"><span style="height: 1em; display: inline-block; width: 20px;"></span>';
    artHTML += titleHTML;
