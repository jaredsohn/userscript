// ==UserScript==
// @name           Shortbus Allstars PF
// @namespace      Brings Shortbus Allstars team forum to top
...
function findName(test) {
    if (test.innerHTML.indexOf('/game/forum_thread_list.pl?team_id=6474', 0)>=0) return 1;
  return 0;
}
