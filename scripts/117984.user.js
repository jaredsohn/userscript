// ==UserScript==
// @name Independent Facebook link stripper
// @namespace http://www.a-i-media.co.uk/facebookindependent
// @description Strips out the Facebook bullshit from Independent links, allowing you to read the news in private.  Uses anonym.to to remove the REFERRER (which would redirect back to facebook, grrrrr...)
...
function stripit(links) {
	for (var i=0; i<links.length; i++) {
		var link=links[i];
		if (link.href.indexOf("independent.co.uk")>-1) {
