// ==UserScript==
// @name Travian3 Beyond "Hacked" - FULL PL + fixed
...
//				[T('CALC'), "http://www.denibol.com/~victor/travian_calc/", "_blank"],
    ...
    delreport.innerHTML='<td class=rgb colspan=2>&nbsp;<input style="font-weight:bold; font-size:8pt; height:14pt" onClick="document.location.href=\''+delreporthref+'\'" type=button value="Usuń">';
    ...
    if(find("//table[@class='tbg']//tr[@class='rbg']", XPFirst).textContent.match(/ supplies | reinforces /))  return;
  	...
  	var bookmarkRaid = '&nbsp;<input style="font-weight:bold; font-size:8pt; height:14pt" onClick="javascript:void(0);" value="Archiwizuj" type=button id=orange />';
  ...
  */
	...
	*/ 
    ...
    if(showbookmarks==true || showbookmarks == null) {
	  ...
	  bookmarks.push('<span style="color:#ff5500;font-size:11px;">Miejsce zbiórki</span>::build.php?gid=16');
      bookmarks.push('<span style="color:#ff5500;font-size:11px;">Koszary</span>::build.php?gid=19');
	  bookmarks.push('<span style="color:#ff5500;font-size:11px;">Stajnia</span>::build.php?gid=20');
	  bookmarks.push('<span style="color:#ff5500;font-size:11px;">Warsztat</span>::build.php?gid=21');
	  bookmarks.push('<span style="color:#ff5500;font-size:11px;">Rynek</span>::build.php?gid=17');
