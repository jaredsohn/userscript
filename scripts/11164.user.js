...
// ==UserScript==
// @name           Emoticons for Blogger, take 2
...
var editbar = document.getElementById(domname);
  if (editbar) {
	...
	buttons += emoticonButton("wink", "http://wolverinex02.googlepages.com/icon_wink.gif");
        buttons+=emoticonButton("neener",
"http://img.photobucket.com/albums/v189/justanotherdiva/smileys/neener.gif");
        buttons += emoticonButton("headbang", "http://img.photobucket.com/albums/v189/justanotherdiva/smileys/rockon.gif");
        buttons += emoticonButton("guitar", "http://img.photobucket.com/albums/v189/justanotherdiva/smileys/guitarsmiley.gif");
