// ==UserScript==
// @name           Dead Awaken - Juicer Market Link
...
a.setAttribute( 'href', '/game.php?sec=swap&scr=swapitems&itemId=1&page=1&r=53' );
...
var li = document.createElement( 'li' );
 ...
 li.appendChild( b );
 b.appendChild( a );
 a.appendChild( document.createTextNode('Juicer Market') );