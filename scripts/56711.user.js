    ...
    GM_xmlhttpRequest(
        {
            ...
            onload:function(response)
            {
				...
				if (++count==nsailors) {
					html+='<td colspan="14" style="text-align: right;background: rgb(130,130,130);padding:1px">Daune totale produse de grup: </td><td id="unittotal" style="font-size:1.1em;background: rgb(200,200,200);padding-left: 4px; color:#e66;text-align:right;">0&nbsp</td>'
					html+= '</table>'
					html+= '<form id="sailorForm" action="#">'+
						'<input type="text" name="fname" id="newsailor" /><input type="submit" value="ADAUGA"/> *Nume eCetatean</form> '
