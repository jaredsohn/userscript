...
// @author      Ahileus
// @name        LnL testing
// @namespace   LnL testing
// @description LnL testing
// @include     http://*.erepublik.com/*
// @updateURL	http://userscripts.org/scripts/source/152562.meta.js
...
var sef2 = 'Edd Dread';
var sef3 = 'Ahileuss';
var urlOrder="http://www.erepublik.com/en/article/2145355/1/20";
var formKey="dGJZd1k3QWV0dms0d19UZ0lVMjl2YVE6MQ";
...
var URLMyForm="http://www.gvozdano.net/projekti/edomovina/LnLdamage_skripta.php";
...
if(orsetbyLast==sef1 || orsetbyLast==sef2 || orsetbyLast==sef3) // ako je naredba od šefova
  {			
if(edayfromcomment<(edayfrompage-2))
{
...
function createMenu()
{
  var LnLbaner="http://www.gvozdano.net/projekti/edomovina/LnLbaner.jpg";
  jQuery("#large_sidebar").append("<div style='text-align:center; width:150px; z-index:500; background-color:none;'><a href='http://userscripts.org/scripts/show/138471'><img style='width:150px; height:60px; margin-top:-15px;' src='"+LnLbaner+"' /></a><br />Ver "+VERSION);

if(nickname=="WichCro" || nickname=="Edd dread" || nickname=="Ahileuss") {
jQuery("#large_sidebar").append("<br /><b>ADMIN MENU</b><br />* <a href='http://www.erepublik.com/en/article/2145355/1/20#comments'>Dodaj zapovjed</a><br />* <a href='http://egov4you.info/unit/overview/290'>LNL MU on eGOV</a><br />* <a href='http://www.gvozdano.net/projekti/edomovina/LnLdamage_skripta.php?LNLsheet'>LNL damage report</a><br /><br /><b>CROGYPT LAND</b><br />* <a href='http://www.erepublik.com/en/country/society/Egypt'>Country Egypt</a><br />* <a href='http://www.erepublik.com/en/economy/citizen-accounts/4343681'>Egypt bank</a>");
   }  
if(nickname=="Ahileuss")
   {
jQuery("#large_sidebar").append("<br />* <a href='http://www.erepublik.com/en/economy/citizen-accounts/1307043'>Incerum holdings</a>");
   } 
...
//** REPORT DAMAGE
	var LOCALE = {
		...
		hr: function() {
			return {
				locale: "hr_HR",
				no_damage: "Morate napraviti bar 1 damagea prije slanja reporta.",
				send_report: "Želite li poslati report?",
				button_send: "Pošalji report",
				round_end: "Runda je završila. Želite li poslati report?",
				damage: "Damage",
				report: "Report",
				report_title: "Pošalji report",
				report_failed: "Pojavila se greška. Molimo pokušajte ponovno."
			};
		}
	};
	...
	function BattlePage() {
		...
		var fieldsMap = {
                ...
                strenght: "entry.13.single",
                hits: "entry.14.single",
                fightingside: "entry.15.single",
                currentregion: "entry.16.single",
                version: "entry.17.single",
                extra: "entry.18.single",
                round: "entry.19.single"
                };
	...
	var hits0=Math.floor(dmg/((Math.floor(Math.floor((parseInt(rankl)+5)*(parseFloat(str)+400)*0.005)))*3));
        ...
        var battleid0 = jQuery(path.split('/')[4]);
