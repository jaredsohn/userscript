// ==UserScript==
// @name           Feuerwache.net Fahrzeugvorschlaege by TFM94
// @description    schlaegt Fahrzeuge zu Einsatzstichworten vor
// @include        http://www.feuerwache.net/*
// @author         tfm94  Grundbau: sawos und andere
// @version        2011-01-05 17:00
// ==/UserScript==
...
var Einsatzklassen = {
  ...
  'Auffahrunfall'               : {FZ: 'F2',            wiki: 'Auffahrunfall',                   RD: 'RTW'},
  'Baum auf Auto'               : {FZ: 'TH1',           wiki: 'Baum_auf_Auto',                   RD: 'RTW'},
  'Baum auf Dach'               : {FZ: 'TH1+DL',        wiki: 'Baum_auf_Dach',                   RD: 'RTW'},
  'Baum auf Straße'             : {FZ: 'TH1',           wiki: 'Baum_auf_Stra%C3%9Fe',            RD: 'RTW'},
  'Brand in KFZ-Werkstatt'      : {FZ: 'F2+TLF,FwK' ,   wiki: 'Brand_in_KFZ-Werkstatt',          RD: 'RTW'},
  'Brand in Schule'             : {FZ: 'F4',            wiki: 'Brand_in_Schule',                 RD: 'RTW'},
  'Brand in Spedition'          : {FZ: 'GSG+DL',        wiki: 'Brand_in_Spedition',              RD: 'RTW'},
  'Brand in Sporthalle'         : {FZ: 'F4+GW-A',       wiki: 'Brand_in_Sporthalle',             RD: 'RTW'},
  'Brand im Sägewerk'           : {FZ: 'F4',            wiki: 'Brand_im_S%C3%A4gewerk',          RD: 'RTW'},
  'Brand im Supermarkt'         : {FZ: 'F4',            wiki: 'Brand_im_Supermarkt',             RD: 'RTW'},
  'Brennende Bäume'             : {FZ: 'F2',            wiki: 'Brennende_B%C3%A4ume',            RD: 'RTW'},
  'Brennende Telefonzelle'      : {FZ: 'F2',            wiki: 'Brennende_Telefonzelle',          RD: 'RTW'},
  'Brennender LKW'              : {FZ: 'F2',            wiki: 'Brennender_LKW',                  RD: 'RTW'},
  'Brennender PKW'              : {FZ: 'F2',            wiki: 'Brennender_PKW',                  RD: 'RTW'},
  'Brennendes Gras'             : {FZ: 'F2',            wiki: 'Brennendes_Gras',                 RD: 'RTW'},
  ...
  'Container Brand'             : {FZ: 'F2',            wiki: 'Containerbrand',                  RD: 'RTW'},
  'Dachstuhlbrand'              : {FZ: 'F2+DL',         wiki: 'Dachstuhlbrand',                  RD: 'RTW'},
  'Fahrstuhl - Türöffnung'      : {FZ: 'TH1',           wiki: 'Fahrstuhl-T%C3%BCr%C3%B6ffnung',  RD: 'RTW'},
  'Fettbrand in Pommesbude'     : {FZ: 'F3+TLF',        wiki: 'Fettbrand_in_Pommesbude',         RD: 'RTW'},
  'Feuer im Altenheim'          : {FZ: 'F4',            wiki: 'Feuer_im_Altenheim',              RD: 'RTW'},
  'Feuer im Laubhaufen'         : {FZ: 'F2',            wiki: 'Feuer_im_Laubhaufen',             RD: 'RTW'},
  'Gartenlaubenbrand'           : {FZ: 'F2',            wiki: 'Gartenlaubenbrand',               RD: 'RTW'},
  'Gastronomiebrand'            : {FZ: 'F4+GW-A',       wiki: 'Gastronomiebrand',                RD: 'RTW'},
  'Kellerbrand'                 : {FZ: 'F2+GW-A',       wiki: 'Kellerbrand',                     RD: 'RTW'},
  'Keller unter Wasser'         : {FZ: 'LF',            wiki: 'Keller_unter_Wasser',             RD: 'RTW'},
  'Kinobrand'                   : {FZ: 'F4',            wiki: 'Kinobrand',                       RD: 'RTW'},
  'Motorrad-Brand'              : {FZ: 'F2',            wiki: 'Motorradbrand',                   RD: 'RTW'},
  'Mülleimer Brand'             : {FZ: 'F2',            wiki: 'M%C3%BClleimerbrand',             RD: 'RTW'},
  'Scheunenbrand'               : {FZ: 'F3+GW-L2',      wiki: 'Scheunenbrand',                   RD: 'RTW'},
  'Schornsteinbrand'            : {FZ: 'F2+DL',         wiki: 'Schornsteinbrand',                RD: 'RTW'},
  'Silobrand'                   : {FZ: 'F3',            wiki: 'Silobrand',                       RD: 'RTW'},
  'Sperrmüllbrand'              : {FZ: 'F2',            wiki: 'Sperrm%C3%BCllbrand',             RD: 'RTW'},
  'Strohballen Brand'           : {FZ: 'F2|GW-L2',      wiki: 'Strohballen_Brand',               RD: 'RTW'},
  'Traktorbrand'                : {FZ: 'F2+Öl',         wiki: 'Traktorbrand',                    RD: 'RTW'},
  'Verkehrsunfall'              : {FZ: 'F2|Öl,FwK',     wiki: 'Verkehrsunfall',                  RD: 'RTW'},
  'Wohnblockbrand'              : {FZ: 'F4',            wiki: 'Wohnblockbrand',                  RD: 'RTW'},
  'Wohnungsbrand'               : {FZ: 'F4',            wiki: 'Wohnungsbrand',                   RD: 'RTW'},
  'Brand-Weihnachtsbaum in Kirche': {FZ: 'F4+GW-A',     wiki: 'Brand-Weihnachtsbaum_in_Kirche',  RD: 'RTW'},
  'Brand auf Weihnachtsmarkt'   : {FZ: 'LZ',            wiki: 'Brand_auf_Weihnachtsmarkt',       RD: 'RTW'},
  'Feldbrand'                   : {FZ: 'F2',            wiki: 'Feldbrand',                       RD: 'RTW'},
  'Gewerbebrand'                : {FZ: 'F4+RW',         wiki: 'Gewerbebrand',                    RD: 'RTW'},
  'Brand im Baumarkt'           : {FZ: 'GSG+DL',        wiki: 'Brand_im_Baumarkt',               RD: 'RTW'},
  'Brennende S-Bahn'            : {FZ: 'F2+GW-S|FwK',   wiki: 'Brennende_S-Bahn',                RD: 'RTW'},
  'Schuppenbrand'               : {FZ: 'F2|GW-G,GW-M',  wiki: 'Schuppenbrand',                   RD: 'RTW'},
  'Brennender Sicherungskasten' : {FZ: 'F2',            wiki: 'Brennender_Sicherungskasten',     RD: 'RTW'},
  'Wohnwagenbrand'              : {FZ: 'F2',            wiki: 'Wohnwagenbrand',                  RD: 'RTW'},
  'Brand in Briefkasten'        : {FZ: 'F2',            wiki: 'Brand_in_Briefkasten',            RD: 'RTW'},
  'Kleiner Waldbrand'           : {FZ: 'F2',            wiki: 'Kleiner_Waldbrand',               RD: 'RTW'},
  'Brennender Müllwagen'        : {FZ: 'F2|FwK',        wiki: 'Brennender_M%C3%BCllwagen',       RD: 'RTW'},
  'Ölspur'                      : {FZ: 'LF,Öl',         wiki: '%C3%96lspur',                     RD: 'RTW'},
  'Brand in Zugdepot'           : {FZ: 'F4+GW-S,RW|FwK',wiki: 'Brand_im_Zugdepot',               RD: 'RTW'},
  'Brand in Autohaus'           : {FZ: 'GSG+DL',        wiki: 'Brand_in_Autohaus',               RD: 'RTW'},
  'Brand in Druckerei'          : {FZ: 'F4',            wiki: 'Brand_in_Druckerei',              RD: 'RTW'},
  'Brand in Lackfabrik'         : {FZ: 'GSG+DL',        wiki: 'Brand_in_Lackfabrik',             RD: 'RTW'},
  'Person im Fluss'             : {FZ: 'GW-T,LF',       wiki: 'Person_im_Fluss',                 RD: 'RTW'},
  'Trocknerbrand'               : {FZ: 'F2',            wiki: 'Trocknerbrand',                   RD: 'RTW'},
  'Brand in Reifenlager'        : {FZ: 'GSG+GW-L2',     wiki: 'Brand_in_Reifenlager',            RD: 'RTW'},
  'Brand im Casino'             : {FZ: 'F5+LF,TLF+GW-L2',wiki:'Brand_im_Casino',                 RD: 'RTW'},
  'Brennendes Gebüsch'          : {FZ: 'F2',            wiki: 'Brennendes_Gebüsch',              RD: 'RTW'},
  'Kioskbrand'                  : {FZ: 'F2',            wiki: 'Kioskbrand',                      RD: 'RTW'},
  'Garagenbrand'                : {FZ: 'F2',            wiki: 'Garagenbrand',                    RD: 'RTW'},
  'Mähdrescherbrand'            : {FZ: 'F2+TLF',        wiki: 'Mähdrescherbrand',                RD: 'RTW'},
  'Kaminbrand'                  : {FZ: 'F3+DL',         wiki: 'Kaminbrand',                      RD: 'RTW'},
  'PKW in Fluss'                : {FZ: 'LF,RW,GW-T|Fwk',wiki: 'PKW_in_Fluss',                    RD: 'RTW'},
  'Brand in Schloss'            : {FZ: 'F5',            wiki: 'Brand_in_Schloss',                RD: 'RTW'},
  'Brand in Kühlhaus'           : {FZ: 'GSG+DL',        wiki: 'Brand_in_Kühlhaus',               RD: 'RTW'},
  'Feuer im Krankenhaus'        : {FZ: 'GSG+LF',        wiki: 'Feuer_im_Krankenhaus',            RD: 'RTW'},
  ...
  'Brand in Eishalle'           : {FZ: 'F3+TLF',        wiki: 'Brand_in_Eishalle',               RD: 'RTW'},
  'Brand in Metzgerei'          : {FZ: 'F3',            wiki: 'Brand_in_Metzgerei',              RD: 'RTW'},
  'Brand in Gärtnerei'          : {FZ: 'GSG',           wiki: 'Brand_in_Gärtnerei',              RD: 'RTW'},
  ...
  'Feuer auf Boot (Mittel)'     : {FZ: 'HaF',           wiki: 'Feuer_auf_Boot_(mittel)',         RD: 'RtB'},  
  'Gabelstapler im Hafenbecken' : {FZ: 'HaF-Gabel',     wiki: 'Gabelstapler_im_Hafenbecken',     RD: 'RTW'},  
  'Verletztentransport'         : {FZ: '',              wiki: '',                                RD: 'RTW'},
  'Brand in Gemeindehaus'       : {FZ: 'F2',            wiki: 'Brand_in_Gemeindehaus',           RD: 'RTW'},
  'Brand in Steinbruch'         : {FZ: 'GSG',           wiki: 'Brand in Steinbruch',             RD: 'RTW'},
  'Maschinenbrand'              : {FZ: 'F3',            wiki: 'Maschinenbrand',                  RD: 'RTW'},
};
