// ==UserScript==
// @name            The West - Gardrop - Oğuzhan ÜNAL
...
if (url.indexOf(".the-west.") != -1) {
    ...
    (function(f) {
        ...
        var wardrobe_text={en:'Gardrop', sk:'Šatník', cz:'Skříň', fr:'Tenue',ru:'Гардероб'};
        var new_name_text={en:'Yeni isim', sk:'Nový názov', cz:'Nový název', fr:'Nouveau nom',ru:'Новое название'};
        var cancel_button_text={en:'İptal', sk:'Zrušiť', cz:'Zrušit', fr:'Annuler',ru:'Отмена'};
        var delete_button_text={en:'Sil', sk:'Zmazať', cz:'Smazat', fr:'Supprimer',ru:'Удалить'};
        var save_button_text={en:'Kaydet', sk:'Uložiť', cz:'Uložit', fr:'Sauvegarder',ru:'Сохранить'};
        var tw_button_text={en:'TWPro Seçimi', sk:'TWPro', cz:'TWPro', fr:'Sélection TWPro',ru:'Выбрать TWPro'};
        var save_message_text={en:'Gardrop kaydedildi', sk:'Šatník bol uložený', cz:'Skříň byla uložena', fr:'Tenue mise à jour',ru:'Комплект сохранён'};
        var confirm_overwrite_text={
            en:'Gerçekten gardobun üzerine kaydetmek istiyor musun? ',
        ...
        var save_choose_name_error_text={
            en:'Yeni isim" veya mevcut bir gardrop seçmelisin!!',
        ...
        var save_invalid_name_error_text={
            en:'Gardrop ismi geçersiz karakterler içeriyor!',
        ...
        var  error_confmodenotactivated={
            en:'Yeni set yaratmak için Ayarlama Modunu aktifleştir ? ',
