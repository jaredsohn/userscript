// ==UserScript==
// @name           NazVa User hidden by Lenka
// @namespace      nazva
...
var NAZVA = {
    fname: ["Tiana"],       // Имя неугодного(-ых) пользователя(-ей), через запятую: ["user","admin"]
    ...
    fhide: function(i, j)
    {
        ...
        el.innerHTML = 'Удалено цензурой! (показать) # ' + this.fname[j];
