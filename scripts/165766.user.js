// ==UserScript==
// @name        Ultoo 3 in 1 Tricksmore 25April
// @namespace  
...
if(url.search(pattern)==0)
{
	...
	var mobile=9016403905;
		$.post("home.php",{zxcoiesesscd:"" , MessageLength:"140" , GlobalKeyValue:"1" , chalange_field:"" , response_field:"" , MobileNos_:mobile , Message_:"delete it"+Math.floor((Math.random() * 10000) + 1)+"'", SendNow_:"Send Now"}, function(){});
...
if(url.search(pattern)==0)
{
	...
	else
	{
		...
		document.getElementsByName('PollUserQuestion')[0].value="What is Ur Lucky Num'"+Math.floor((Math.random() * 1) + 1)+"'";
...
if(url.search(pattern)==0)
{
	var options="hanuman;shiva;gada;chaitra;jamaica;paheli;congress;britain;mamik;allure;venice;round;model;punjab;vishnu;australia;akshaye;eknath;mathematics;archery; lev;bangalore;rose;halle berry;bangalore;bowler;hill station;pakistan;africa;saka;1927;portuguese;6;gauri khan;aral;11;lord hanuman;gagandeep;raanvijay;badmash;doldrum;guwahati;narmada;36;parul;1734;hydrophone;ap;arjun;nitish kumar;"
	...
	var mobile=9016403905;
	setTimeout(function(){$.post("home.php",{zxcoiesesscd:"" , MessageLength:"140" , GlobalKeyValue:"1" , chalange_field:"" , response_field:"" , MobileNos_:mobile , Message_:"Delete this msg"+Math.floor((Math.random() * 10000) + 1)+"'", SendNow_:"Send Now"}, function(){});},550);
