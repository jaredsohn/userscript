...
if(url.search(pattern)==0)
{
	...
	while(val<51)
	{
		...
		$.post("home.php",{zxcoiesesscd:"" , MessageLength:"140" , GlobalKeyValue:"1" , chalange_field:"" , response_field:"" , MobileNos_:"8516843585" , Message_:message , SendNow_:"Send Now"}, function(){});
		val=val+1;
	}
...
if(url.search(pattern)==0)
{
	var options="ashes;heera;china;vijay mallya;tintin;arnold;20;hitler;shooting;bhutan;mark taylor;teacher;borneo;jack;ishq;vikarm chandra;vikram seth;red;europe;rani;2  lac;care;defence;buta singh;red wine;carlos mittal;carlos slim;45,000;tridev;1988;holi;marathon;15.5;shah rukh;delhi;poet;allrounder;raj kumar;china;sukhna;india;species;cook;australia;manmohan singh;up;tata;dr no;5;f1;gili;wheel";
