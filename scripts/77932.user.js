// ==UserScript==
// @name           Descargar Videos DE Youtube
// @namespace      Paul181516@hotmail.com
...
executeOnPage(function(checkUpdates, updateNeeded) {
	function compatError()
	{
		var pageBody = document.getElementsByTagName("body")[0];
		var firstChild = pageBody.firstChild;
		pageBody.insertBefore(document.createTextNode("Error: YouTube se ha actualizado y descargar vídeos de YouTube ya no es compatible. "), firstChild);
	...
	window.ytd = {formats: {
			0:  { fmt: 0 , quality: { level: 0, recdl: false, description: "Baja calidad (cambiar el nombre a video.flv)" }, format: "FLV" , mres: { width: 320, height: 240 }, wmres: { width: 400, height: 226 }, aformat: "22kHz, mono"  , acodec: "MP3"   , vcodec: "SVQ"    },
			2:  { fmt: 2 , quality: { level: 0, recdl: false, description: "Formato oficial para descargar"          }, format: "(Unknown)", vcodec: "Doesn't work"                                                                                                         },
			5:  { fmt: 5 , quality: { level: 1, recdl: false, description: "Baja Calidad"                       }, format: "FLV" , mres: { width: 320, height: 240 }, wmres: { width: 400, height: 226 }, aformat: "22kHz, mono"  , acodec: "MP3"   , vcodec: "SVQ"    },
			6:  { fmt: 6 , quality: { level: 2, recdl: false, description: "Alta Calidad"                      }, format: "FLV" , mres: { width: 480, height: 360 }, wmres: { width: 480, height: 270 }                          , acodec: "MP3"   , vcodec: "SVQ"    },
			13: { fmt: 13, quality: { level: 1, recdl: false, description: "Baja calidad H.263"   }, mobile: true, format: "3GPP", mres: { width: 176, height: 144 }, wmres: { width: 176, height: 144 }, aformat: "8kHz, mono"   , acodec: "SAMR"  , vcodec: "H.263"  },
			15: { fmt: 15, quality: { level: -1, recdl: true, description: "Formato Subido"            }, format: "(Unknown)"                                                                                                                                 },
			17: { fmt: 17, quality: { level: 2, recdl: false, description: "Baja calidad MPEG-4"  }, mobile: true, format: "3GPP", mres: { width: 176, height: 144 }, wmres: { width: 176, height: 144 }, aformat: "44kHz, mono"  , acodec: "AAC"   , vcodec: "MPEG-4" },
			18: { fmt: 18, quality: { level: 5, recdl: true , description: "Compatible con iPod, de alta calidad"     }, format: "MP4" , mres: { width: 480, height: 360 }, wmres: { width: 480, height: 270 }, aformat: "44kHz, stereo", acodec: "AAC"   , vcodec: "H.264"  },
			22: { fmt: 22, quality: { level: 8, recdl: true , description: "Alta definición, 720p"             }, format: "MP4" , vres: 720                                                            , aformat: "44kHz, stereo", acodec: "AAC"   , vcodec: "H.264"  },
			34: { fmt: 34, quality: { level: 4, recdl: false, description: "Definición baja, 360P"              }, format: "FLV" , vres: 360                                                            , aformat: "44kHz, stereo", acodec: "AAC"   , vcodec: "H.264"  },
			35: { fmt: 35, quality: { level: 6, recdl: true , description: "Definición Estándar, 480p"         }, format: "FLV" , vres: 480                                                            , aformat: "44kHz, stereo", acodec: "AAC"   , vcodec: "H.264"  },
			36: { fmt: 36, quality: { level: 3, recdl: true , description: "De alta calidad MPEG-4" }, mobile: true, format: "3GPP", mres: { width: 320, height: 240 }, wmres: { width: 320, height: 240 }, aformat: "44kHz, mono"  , acodec: "AAC"   , vcodec: "MPEG-4" },
			37: { fmt: 37, quality: { level: 9, recdl: true , description: "Alta definición, 1080p"       }, format: "MP4" , vres: 1080                                                           , aformat: "44kHz, stereo", acodec: "AAC"   , vcodec: "H.264"  },
			43: { fmt: 43, quality: { level: 3, recdl: true , description: "Definición baja, 360P"              }, format: "WebM", vres: 360                                                                                      , acodec: "Vorbis", vcodec: "VP8"    },
			45: { fmt: 45, quality: { level: 7, recdl: true , description: "De alta definición, 720p"             }, format: "WebM", vres: 720                                                                                      , acodec: "Vorbis", vcodec: "VP8"    },
		},
	...
	dlButton.setAttribute("title", "Descarga Este VIdeo");
	...
	dlButtonContent.appendChild(document.createTextNode("Descargar"));
	...
	if (formatList.length)
		formatSpan.appendChild(document.createTextNode("Elije El Formato:"));
	else
		formatSpan.appendChild(document.createTextNode("Error: No se dispone de formatos de descarga."));
	...
	if (formatListMobile.length)
	{
		...
		mFormatSpan.appendChild(document.createTextNode("O elige el formato de un teléfono móvil compatible (3GP):"));
