...
//var stylehtml = '<a class="selected" href="javascript:void(0);">[Yotsuba B]</a><a href="javascript:void(0);">[Yotsuba]</a><a href="javascript:void(0);">[Futaba]</a><a href="javascript:void(0);">[Orange]</a><a href="javascript:void(0);">[dark]</a><a href="javascript:void(0);">[miku]</a><a href="javascript:void(0);">[wasabi]</a><a href="javascript:void(0);">[Ferus]</a></div>'
  ...
  postIs.setAttribute('style');
  postIs.attributes[1].value = "color: #8D3232 !important; display: inline-block; font-weight: bold; font-size: 17pt;";
...
function addSettings(Set) {
	Set.appendChild($New('div', {'class': aib.cReply}, [
		$new('div', {'id': 'de-cfg-head', 'text': 'Snakechan Extension Tools'}, null),
...
function checkForUpdates(isForce, Fn) {
	...
	GM_xmlhttpRequest({
		'method': 'GET',
		'url': 'http://userscripts.org/scripts/source/155174.user.js',
...
PostForm.prototype = {
	...
	_initForm: function() {
		...
		$event(this.subm, {'click': function(e) {
			...
			if(this.tNum && pByNum[this.tNum].subj === 'Snakechan Extension Tools' && !/`\-{50}`$/.test(val)) {
				val += '\n\n`' + new Array(51).join('-') + '`\n' +
					'`' + navigator.userAgent + '`\n`v' + version + '`' +
					'\n`' + new Array(51).join('-') + '`';
			}
