...
//	alert(menuBox.innerHTML);
	...
	var text = "<p><a href='build.php?gid=17'>بازار</a>"
		+ "<a href='build.php?gid=17&t=2'>پیشنهاد</a>"
		+ "<a href='build.php?gid=19'>سربازخانه</a>"
		+ "<a href='build.php?gid=22'>دارالفنون</a>"
		+ "<a href='build.php?gid=16'>اردوگاه</a>"
		+ "</p>";
	var text = text + "<p><a href='allianz.php'>اتحاد</a>"
		+ "<a href='allianz.php?s=3'>حمله های اتحاد</a>"
		+ "<a href='allianz.php?s=2'>فروم اتحاد</a>"
		+ "</p>";
