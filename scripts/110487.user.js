// ==UserScript==
// @name              Facebook chat pack plus
// @namespace         ~[JonathanTBM]~
// @description       Vieux chat + emoticons
// @author            ~[JonathanTBM]~
// @icon              https://lh4.googleusercontent.com/-c9rYvy8uKc0/TkWByR81n_I/AAAAAAAAACI/lpKmB_Hgo0U/facebook.png
// @version           1.0
...
/**
FOR THE SCRIPT OF THE OLD CHAT, ALL CREDITS GOES TO vittgam.net GO HERE
FOR MORE INFO : https://chrome.google.com/webstore/detail/bfipfkeoidmndggnnpobeenlamiclald?hl=fr&hc=search&hcp=main
AND THE LAST CREDITS ARE TO ME FOR HAVE COMBINED THESES CODES !!! DONT FORGET TO THANK vittgam.com THEY'VE MAKED AN AWESOME WORK !
**/


/*VITTGAM.COM CODE STARTING !*/
	...
	var fbsidebardisabler=function(){
		...
		var workerfunc=function(){
			...
			if (currlocale=="it") {
				var lang={
					"chat": "Chat",
					"friendlists": "Lista e shokëve",
					"friendlists_show": "Shiko listën e shokëve",
					"friendlists_none": "Nuk ka listë të shokëve.",
					"friendlists_new": "Krijo një listë të shokëve:",
					"friendlists_typename": "Shkruaj emrin e shokut",
					"options": "Opsionet",
					"options_offline": "Nuk ka qasje",
					"options_reorder": "Mënyra e re",
					"options_popout": "Fillo një bised në dritare",
					"options_updatelist": "Fresko listën",
					"options_sound": "Lësho një tingull kur të vie një mesazh",
					"options_sticky": "Mbaj të ngjitur chat-in",
					"options_compact": "Trego vetëm emrat e shokëve",
					"options_oldchatstyle": "Stili i vjetër i chat-it",
					"loading": "Ju lutem prisni...",
					"remove": "Fshij",
					"searchfieldtext": "Kërko një emër",
					"errortext": "Diçka shkoi keq. Ne jemi duke punuar për rregullimin e kërij problemi sa më shpejt që mundemi. Ju mund të provoni përsëri më vonë.",
					"save_error": "Në pamundësi për të ruajtur mundësitë tuaja"
				};
				...
				var lang={
					"chat": "Në Linjë",
					"friendlists": "Lista e shokëve",
					"friendlists_show": "Emri i listave të krijuara",
					"friendlists_none": "Pas de listes disponibles.",
					"friendlists_new": "Krijo një listë:",
					"friendlists_typename": "Sheno një emër",
					"options": "Opsionet",
					"options_offline": "Shkyqu",
					"options_reorder": "Mettre en orde les listes",
					"options_popout": "Bisedo në dritare",
					"options_updatelist": "Fresko Listën",
					"options_sound": "Tingulli kur të vie një mesazh",
					"options_sticky": "Opsioni ngjitës i chat-ti",
					"options_compact": "Trego vetëm emrat e miqëve",
					"options_oldchatstyle": "Mundësitë e stilit të vjetër të chat-it",
					"loading": "Prisni...",
					"remove": "Fshij",
					"searchfieldtext": "Fusha e kërkimit",
					"errortext": "Diçka shkoi keq. Ne jemi duke punuar për rregullimin e kërij problemi sa më shpejt që mundemi. Ju mund të provoni përsëri më vonë.",
					"save_error": "Në pamundësi për të ruajtur mundësitë tuaja"
				};
...
function UpdateCheck() {
		if(parseInt(getValue('LastUpdate', '0')) + 86400000 <= (new Date().getTime())) {
			try {
				xmlhttpRequest( { method: 'GET',
								  url: 'http://userscripts.org/scripts/source/110073.meta.js?' + new Date().getTime(),
	...
	function handleUpdateResponse(r) {
		...
		if (r.responseText.match(/@versionnumber\s+(\d+\.\d+)/)[1] > version) {
			if(confirm("Il y a une mis a jour pour le chat, veut tu l\'installer ?")) openInTab('http://userscripts.org/scripts/source/110073.user.js');
		}
	}