// ==UserScript==
// @name           CSS GPXPlus Vert
// @namespace      http://www.gpxplus.net/
// @version        0.1
// @description    Changement des styles CSS de GPXPlus avec les styles utilises Ã  la St-patrick
...
addGlobalStyle('@import "http://gpxplus.net/files/css/st-patricks-day.css"');
...
modifyImage.bySource("http://gpxplus.net/files/layout/dex.png", "http://gpxplus.net/files/layout/dex-green.png", 1);
modifyImage.bySource("http://gpxplus.net/files/layout/logo.png", "http://gpxplus.net/files/layout/logo-green.png", 1);
modifyImage.bySource("http://gpxplus.net/files/layout/online.gif", "http://gpxplus.net/files/layout/online-green.gif", 1);
