// ==UserScript==
// @name			HF Scripts - Easy Report Shopping Deals
// @namespace 		Glassy/hfreportingshoppingdeals
// @description 	Makes reporting posts/threads in Shopping Deals section to Glassy MUCH easier.
// @include  		*hackforums.net/showthread.php*
// @version  		1.1.2
// ==/UserScript==

var navBit = document.getElementsByClassName('navigation')[0];
if(navBit.innerHTML.indexOf('<a href="forumdisplay.php?fid=121">Shopping Deals</a>') != -1) {
