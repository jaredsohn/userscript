// ==UserScript==
// @name           VampireWars - Add Recent Friends To Vampire Wars
// @namespace      http://facebook.com
// @description    adds a Vampire Wars link for recently added friends page or any friends list
// @version        1.0
// @date           2009-05-01
...
window.addEventListener( 'load', function( e ) {
	...
	for (var i=0; i < lobjFriendRows.snapshotLength; i++ ) {
		...
		if (lobjRegExResult) {
			...
			lobjSpan.innerHTML = " [<a href='http://apps.facebook.com/vampiresgame/status_invite.php?from=" +  lobjRegExResult[1] + "' target='_blank'>Add to Vampire Wars</a>]";
