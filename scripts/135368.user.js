...
// @include       http://livebeta.kaskus.co.ids/edit_post/*
...
// @include       http://www.kaskus.co.id/blog.php?*
...
0.7.1
- clear up debug line
- add // @include       http://www.kaskus.co.id/group.php?* 
0.7 (idx)
- add // @include       http://www.kaskus.co.id/blog.php?* 
- enhance+antibetmen
- removed "Rossi"
0.6.7.1
- clearing up script
...
0.6.6.2
- use http://www.kaskus.co.id/showthread.php?* address
- removed "** SENSOR **" 
0.6.5
...
0.6.3
- add domain wap.kaskus.co.id, opera.kaskus.co.id, blackberry.kaskus.co.id
0.6.2
- add domain m.kaskus.co.id
0.6.1
- add cite sign
- fix autoupdate
0.6
