...
html_insert_it(window.document,document.getElementById('datum_plugin_rechts'),'<iframe src="http://newsfeed.zeit.de/leben/index#feed-greasemonkey" width="500" height="600"></iframe>',false,true);
