...
function funcionPrincipal(e){
	...
	var lang_cl = lang_es;
	var lang_mx = lang_es;
	lang_es['ALIANZA'] 	= 'Klán';
	lang_es['PERFIL'] 	= 'Profil';
	lang_es['SIM'] 		= 'Harc Szimulátor';
	lang_es['CALC'] 	= 'Kalkulátor';
	lang_es['SEGURO'] 	= 'Biztos Vagyok Benne?';
	lang_es['MARK'] 	= 'Összes Kijelölése';
	lang_es['PERDIDAS'] 	= 'Veszteségek';
	lang_es['RENT'] 	= 'Nyereség';
	lang_es['SUBIR_NIVEL'] 	= 'Építhető!';
	lang_es['JUGADOR'] 	= 'Játékos';
	lang_es['ALDEA'] 	= 'Falu Neve';
	lang_es['HAB'] 		= 'Népesség';
	lang_es['COORD'] 	= 'Koordináták';
	lang_es['ACCION'] 	= 'Akció';
	lang_es['ATACAR'] 	= 'Támadás';
	lang_es['COMERCIAR'] 	= 'Kereskedés';
	lang_es['GUARDADO'] 	= 'Mentés';
	lang_es['DESP_ABR'] 	= 'Ugrás';
	lang_es['FALTA'] 	= 'Még Kell :';
	lang_es['HOY'] 		= 'Ma';
	lang_es['MANYANA'] 	= 'Holnap';
	lang_es['PAS_MANYANA'] 	= 'Holnapután';
	lang_es['MERCADO']	= 'Piac';
	lang_es['CUARTEL']	= 'Kaszárnya';
	lang_es['PUNTO']	= 'Gyülekezőtér';
	lang_es['CORRAL']	= 'Istálló';
	lang_es['TALLER']	= 'Műhely';
	lang_es['ENVIAR']	= 'Piac';
	lang_es['COMPRAR']	= 'Vásárlás';
	lang_es['VENDER']	= 'Eladás';
	lang_es['ENVIAR_IGM']	= 'IGM Küldése';
	lang_es['LISTO']	= 'Kész';
	lang_es['EL']		= 'El';
	lang_es['A_LAS']	= 'Ekkor: ';
	lang_es['EFICIENCIA']	= 'Hatásfok';
	lang_es['NUNCA']	= 'Soha';
	lang_es['PC']		= 'Kultúrális Pont';
	lang_es['FUNDAR']	= 'Most már tudsz új falut alapítani vagy foglalni';
	lang_es['ALDEAS']	= 'Falu(k)';
	lang_es['ENV_TROPAS']	= 'Egységek Küldése';
	lang_es['RECURSO1']	= 'Fa';
	lang_es['RECURSO2']	= 'Agyag';
	lang_es['RECURSO3']	= 'Vas';
	lang_es['RECURSO4']	= 'Búza';
	lang_es['TIEMPO']	= 'Idő';
	lang_es['COMP']		= 'Jelentés';
	lang_es['STAT']		= 'Statisztika';
	lang_es['OFREZCO']	= 'Felajánlás';
	lang_es['BUSCO']	= 'Keresés';
	lang_es['TIPO']		= 'Típus';
	lang_es['CUALQUIERA']	= 'Valamennyi';
	lang_es['DETALLES']	= 'Detalles';
	lang_es['MAP_EXT']	= 'Mapa extendido';
	lang_es['DISPONIBLE']	= 'Csak Elérhető';
	lang_es['SI']		= 'Igen';
	lang_es['NO']		= 'Nem';
	lang_es['LOGIN']	= 'Bejelentkezés';
	lang_es['MARCADORES']	= 'Könyvjelzők';
	lang_es['ANYADIR']	= 'Hozzáad';
	lang_es['ENLACE']	= 'Új Könyvjelző URL-je';
	lang_es['TEXTO']	= 'Új Könyvjelző Neve';
	lang_es['ELIMINAR']	= 'Törlés';
	lang_es['MAPA']		= 'Térkép';
	lang_es['VERSION']	= 'A legfrissebb verzió';
	lang_es['MAXTIME']	= 'Max Idő';
	lang_es['CHECK']	= 'Új Verzió Keresése';
	lang_es['MAT_PRIMAS']	= 'Materias';
	lang_es['ATAQUES']	= 'Támadás';
	lang_es['CONSTR']	= 'Építés';
	lang_es['TROPAS']	= 'Sereg';
	lang_es['ACTUALIZAR']	= 'Frissít';
	lang_es['ARCHIVE']	= 'Archív';
	lang_es['RESUMEN']	= 'Összegzés';
	...
	lang_it['LOGIN'] 	= 'Login'; 
	lang_it['MAPA'] 	= 'Mappa'; 
	lang_it['VERSION'] 	= 'L&quot; ultima versione disponible ďż˝'; 
...
*/
	...
	/**
	 * Calcula el desplazamiento en pixeles a partir del 23ďż˝ enlace 
...
//				buildingCode = parseInt(buildingCode[0].substring(1, buildingCode[0].length));
	...
	*/ 
	...
	/**
	 * Realiza una comparaciďż˝n entre las casillas de la misma columna en distintas filas
	 *
	 * Params:
...
/*
TODO:
	- Optimizar algunas funciones para minimizar el tiempo de ejecuciďż˝n
	- Aďż˝adir resumen a la vista de todas las aldeas
...
FIXME:
	...
	- Mejorar los apaďż˝os en el codigo marcados por FIXMEs
