// ==UserScript==
// @name Gelişmiş Face 2.0 <By MsNKoPaT>
// @description En Gelişmiş Facebook
...
var lang = {
	...
	en : {
		...
		'Close' : 'Close',
		'ConfigureFacebookFixer' : 'Configure Gelişmiş Face',
		...
		'ConfFacebookFixerLanguage' : 'Language for Gelişmiş Face',
		'ConfFacebookTimestamps' : 'Show Facebook timestamps (eg. "3 hours ago").',
		'ConfFBFTimestamps' : 'Add Gelişmiş Face timestamps after Facebook timestamps (eg. "11:45").',
		'ConfFBFTimestamps24' : 'Show Gelişmiş Face timestamps in 24-hour format.',
		...
		'ConfSectionAbout' : 'About Gelişmiş Face',
		...
		'ConfUpdates' : 'Check Userscripts.org daily for updates to Gelişmiş Face. Or <a href="#" id="fbfUpdateLink" onclick="return false;">check now</a>.',
		...
		'UpdateAvailable1' : 'An update is available for Gelişmiş Face',
	...
	es : {
		...
		'Close' : 'Cerrar',
		'ConfigureFacebookFixer' : 'Configuración de Gelişmiş Face',
		...
		'ConfFacebookFixerLanguage' : 'Lenguaje del Gelişmiş Face',
		'ConfFacebookTimestamps' : 'Mostrar cuanto hace que fue creado (Ejemplo: "Hace 3 horas").',
		'ConfFBFTimestamps24' : 'Mostrar las marcas de tiempo de Gelişmiş Face en formato 24 horas.',
		'ConfFBFTimestamps' : 'Añadir las marcas de tiempo de Gelişmiş Face después de las marcas de tiempo de Facebook (Por ejemplo "11:45").',
		...
		'ConfSectionAbout' : 'Acerca de Gelişmiş Face',
		...
		'ConfShortcutList' : '<b>Atajos de Teclado</b> (sensible a la diferencia entre minúsculas y mayúsculas):<br /><br /><i>Desde cualquier página:</i><br />&nbsp;<b>A</b> - Álbumes/Fotos<br />&nbsp;<b>B</b> - Activar/Desactivar lista de amigos (Amigos conectados)<br />&nbsp;<b>C</b> - Configuración de Gelişmiş Face<br />&nbsp;<b>D</b> - Cumpleaños<br />&nbsp;<b>E</b> - Eventos<br />&nbsp;<b>F</b> - Amigos<br />&nbsp;<b>H</b> - Página de Inicio<br />&nbsp;<b>I</b> - Bandeja de Entrada<br />&nbsp;<b>K</b> - Añadir Marcador<br />&nbsp;<b>L</b> - Seleccionar vínculo para terminar la sesión (presione Enter después para terminar la sesión)<br />&nbsp;<b>N</b> - Notificaciones<br />&nbsp;<b>P</b> - Perfil<br />&nbsp;<b>R</b> - Peticiones<br />&nbsp;<b>S</b> - Saltar a el campo de búsqueda<br />&nbsp;<b>T</b> - Traducir el texto seleccionado<br />&nbsp;<b>?</b> - Mostrar la información de depuración de Gelişmiş Face<br />&nbsp;<b><escape></b> - Cerrar la ventana emergente creada por Gelişmiş Face<br /><br /><i>Desde la página de inicio (filtros)</i>:<br />&nbsp;<b>a</b> - Páginas<br />&nbsp;<b>f</b> - Live feed<br />&nbsp;<b>g</b> - Grupos<br />&nbsp;<b>l</b> - Vínculos<br />&nbsp;<b>n</b> - Noticias<br />&nbsp;<b>p</b> - fotos<br />&nbsp;<b>s</b> or <b>u</b> - Estatus de las Actualizaciones<br />&nbsp;<b>t</b> - Notas<br />&nbsp;<b>v</b> - Vídeos<br /><br /><i>Desde los perfiles</i>:<br />&nbsp;<b>i</b> - Información<br />&nbsp;<b>p</b> - Fotos<br />&nbsp;<b>w</b> - Muro<br />&nbsp;<b>x</b> - Cajas<br /><br /><i>Desde las páginas con paginación (previo, siguiente, etc)</i><br />&nbsp;<b><left arrow></b> - Previo<br />&nbsp;<b><right arrow></b> - Siguiente<br />&nbsp;<b><shift> + <left arrow></b> - Primera (cuando este disponible)<br />&nbsp;<b><shift> + <right arrow></b> - Ultimo (cuando este disponible)<br /><br /><i>Al ver albumes/fotos:</i><br />&nbsp;<b>a</b> - Ver todas la miniaturas (cuando este disponible)<br />&nbsp;<b>b</b> - Ver fotos grandes<br />&nbsp;<b>c</b> - Ver comentarios<br />&nbsp;<b>k</b> - De vuelta al álbum<br />&nbsp;<b>m</b> - Fotos de (personas) y yo<br /><br /><i>Al ver albumes recientes y fotos subidas/marcadas:</i><br />&nbsp;<b>a</b> or &nbsp;<b>r</b> - Albumes Recientes<br />&nbsp;<b>m</b> or &nbsp;<b>u</b> - Fotos de Móviles<br />&nbsp;<b>o</b> - Fotos de mi<br />&nbsp;<b>p</b> - Mis Fotos<br />&nbsp;<b>t</b> or &nbsp;<b>f</b> - Amigos Marcados', 'ConfTopBarHoverOpacity' : 'Al pasar el ratón por encima', 'FacebookFixerConflict' : 'Facebook Fixer ahora se llama Gelişmiş Face.<br /><br />Por el cambio de nombre es necesario desinstalar Facebook Fixer manualmente de su navegador o los dos programas entraran en conflicto.<br /><br />Si no sabe como desinstalar un userscript, <a %s>haga clic aquí para ver instrucciones</a>.',
		...
		'ConfUpdates' : 'Revisar Userscripts.org diarimente por si hay actualizaciones en Gelişmiş Face. O <a href="#" id="fbfUpdateLink" onclick="return false;">revisar Ahora</a>.',
		...
		'FacebookFixerConflict' : 'Facebook Fixer ahora se llama Gelişmiş Face.<br /><br />Por el cambio de nombre es necesario desinstalar Facebook Fixer manualmente de su navegador o los dos programas entraran en conflicto.<br /><br />Si no sabe como desinstalar un userscript, <a %s>haga clic aquí para ver instrucciones</a>.',
		...
		'UpdateAvailable1' : 'Hay una actualización disponible para Gelişmiş Face',
	...
	fr : {
		...
		'Close' : 'Fermer',
		'ConfigureFacebookFixer' : 'Configurer Gelişmiş Face',
		...
		'ConfFacebookFixerLanguage' : 'Langue de Gelişmiş Face',
		'ConfFacebookTimestamps' : 'Affichage de la datation Facebook (ex. "Il y a 3 heures").',
		'ConfFBFTimestamps' : 'Ajout de la datation Gelişmiş Face apr&egrave;s la datation Facebook (ex. "11:45").',
		'ConfFBFTimestamps24' : 'Affichage de la datation Gelişmiş Face au format 24 heures.',
		...
		'ConfSectionAbout' : 'A propos de Gelişmiş Face',
		...
		'ConfUpdates' : 'V&eacute;rifie quotidiennement si une mise &agrave; jour de Gelişmiş Face est disponible sur Userscripts.org. Ou <a href="#" id="fbfUpdateLink" onclick="return false;">v&eacute;rifier maintenant</a>.',
		...
		'FacebookFixerConflict' : 'Gelişmiş Face est maintenant devenu Gelişmiş Face. A cause du changement de nom, vous aurez besoin de d&eacute;sinstaller manuellement Gelişmiş Face de votre explorateur, ou les deux scripts rentreront en conflit. Si vous n\'&ecirc;tes pas s&ucirc;r de comment faire pour d&eacute;sinstaller un userscript, <a %s>cliquez ici pour la marche &agrave; suivre</a>.',
		...
		'Left' : 'Gauche',
		'ListeningRestarted' : 'Gelişmiş Face s\'est remit \340 l\'\351coute des changements \351ventuels.',
		'ListeningStopped' : 'Gelişmiş Face a arret\351 d\'\352tre \340 l\'\351coute des changements \351ventuels.\nAppuyez sur L (SHIFT + l) pour r\351-activer l\'\351coute',
		...
		'UpdateAvailable1' : 'Une mise &agrave; jour de Gelişmiş Face est disponible',
	...
	it : {
		...
		'Close' : 'Chiudi',
		'ConfigureFacebookFixer' : 'Impostazioni di Gelişmiş Face',
		...
		'ConfFacebookFixerLanguage' : 'Lingua di Gelişmiş Face',
		...
		'ConfSectionAbout' : 'Riguardo di Gelişmiş Face',
		...
		'FacebookFixerConflict' : 'Gelişmiş Face ha cambiato nome in Gelişmiş Face. A causa del cambiamento dovrai disinstallare manualmente Gelişmiş Face dal tuo browser, o i due script andranno in conflitto. Se non sei sicuro di come disinstallare un userscript <a %s>clicca qui per le istruzioni</a>.',
		...
		'Left' : 'Sinistra',
		'ListeningRestarted' : 'Registrazione dei cambiamenti da parte di Gelişmiş Face attivata.',
		'ListeningStopped' : 'Registrazione dei cambiamenti da parte di Gelişmiş Face disattivata.\nPremi L (SHIFT + l) per riabilitare la registrazione.',
		...
		'UpdateAvailable1' : 'È disponibile un update per Gelişmiş Face.',
	...
	de : {
		...
		'Close' : 'Schließen',
		'ConfigureFacebookFixer' : 'Gelişmiş Face konfigurieren',
		...
		'ConfFacebookFixerLanguage' : 'Sprache für Gelişmiş Face',
		...
		'ConfUpdates' : 'UÜberprüfen Sie Userscripts.org täglich auf Updates für Gelişmiş Face. <a href="#" id="fbfUpdateLink" onclick="return false;">Jetzt überprüfen</a>.',
		...
		'Left' : 'Links',
		'ListeningRestarted' : 'Gelişmiş Face reagiert wieder auf Änderungen.',
		'ListeningStopped' : 'Gelişmiş Face reagiert nicht auf Änderungen.\nL (SHIFT + l) drücken, um die Reaktion wieder zu aktvieren.',
		...
		'today' : 'heute',
		'UpdateAvailable1' : 'Es gibt ein Update für Gelişmiş Face',
	...
	bg : {
		...
		'Close' : 'Затваряне',
		'ConfigureFacebookFixer' : 'Конфигуриране на Gelişmiş Face',
		...
		'ConfFacebookFixerLanguage' : 'Език за Gelişmiş Face',
		...
		'ConfUpdates' : 'Проверяване на Userscripts.org ежедневно за ъпдейти на Gelişmiş Face. Или <a href="#" id="fbfUpdateLink" onclick="return false;">проверка сега</a>.',
		...
		'Left' : 'Отляво',
		'ListeningRestarted' : 'Gelişmiş Face възстанови проверките за промени.',
		'ListeningStopped' : 'Gelişmiş Face спря проверките за промени.\nНатиснете L (Shift + l) за повторно пускане',
		...
		'today' : 'днес',
		'UpdateAvailable1' : 'Излязло е обновление на Gelişmiş Face',
	...
	el : {
		...
		'Close' : 'Κλείσιμο',
		'ConfigureFacebookFixer' : 'Διαμόρφωση Gelişmiş Face',
		...
		'ConfFacebookFixerLanguage' : 'Γλώσσα για το Gelişmiş Face',
		'ConfFacebookTimestamps' : 'Εμφάνιση της ώρας του Facebook (πχ. "Πριν 3 ώρες").',
		'ConfFBFTimestamps' : 'Προσθήκη της ώρας του Gelişmiş Face μετά από την ώρα του Facebook (πχ. "11:45").',
		'ConfFBFTimestamps24' : 'Εμφάνιση της ώρας του Gelişmiş Face σε 24-ωρη μορφή.',
		...
		'ConfSectionAbout' : 'Σχετικά με το Gelişmiş Face',
		...
		'ConfUpdates' : 'Έλεγχος Userscripts.org καθημερινά για καινούργιες ενημερώσεις του Gelişmiş Face ή <a href="#" id="fbfUpdateLink" onclick="return false;">έλεγχος τώρα</a>.',
		...
		'UpdateAvailable1' : 'Υπάρχει καινούργια διαθέσιμη έκδοση του Gelişmiş Face',
	...
	sk : {
		...
		'Close' : 'Zavrieť',
		'ConfigureFacebookFixer' : 'Konfigurovať Gelişmiş Face',
		...
		'FacebookFixerConflict' : 'Facebook Fixer sa odteraz nazýva Gelişmiş Face.<br /><br />Pretože sa zmenil názov, je potrebné ručne odinštalovať Facebook Fixer z prehliadača, inak budú v konflikte dva skripty medzi sebou navzájom.<br /><br />Ak neviete, ako skript odinštalovať, <a %s>kliknutím sem otvorte pokyny</a>.',
	...
	nl : {
		...
		'Close' : 'Sluit',
		'ConfigureFacebookFixer' : 'Configureer Gelişmiş Face',
		...
		'ConfFacebookFixerLanguage' : 'Taal voor Gelişmiş Face',
		'ConfFacebookTimestamps' : 'Laat Facebook timestamps zien (bijv. "3 uur geleden").',
		'ConfFBFTimestamps' : 'Gelişmiş Face timestamps toevoegen na Facebook timestamps (bijv. "11:45").',
		'ConfFBFTimestamps24' : 'Laat Gelişmiş Face timestamps zien in 24-uurs formaat.',
		...
		'ConfShortcutList' : '<b>Keyboard Shortucts</b> (case sensitive):<br /><br /><i>From any page:</i><br />&nbsp;<b>A</b> - Albums/photos<br />&nbsp;<b>B</b> - Toggle buddy list (online friends)<br />&nbsp;<b>C</b> - Gelişmiş Face configuration<br />&nbsp;<b>D</b> - Birthdays<br />&nbsp;<b>E</b> - Events<br />&nbsp;<b>F</b> - Friends<br />&nbsp;<b>H</b> - Home page<br />&nbsp;<b>I</b> - Inbox<br />&nbsp;<b>L</b> - Select the logout link (press Enter afterwards to log out)<br />&nbsp;<b>N</b> - Notifications<br />&nbsp;<b>P</b> - Your profile<br />&nbsp;<b>R</b> - Requests<br />&nbsp;<b>S</b> - Jump to the search field<br />&nbsp;<b>T</b> - Translate selected text<br />&nbsp;<b>?</b> - Show Gelişmiş Face debug info<br />&nbsp;<b>&lt;escape&gt;</b> - Close pop-ups created by Gelişmiş Face<br /><br /><i>From the home page (filters)</i>:<br />&nbsp;<b>a</b> - Pages<br />&nbsp;<b>f</b> - Live feed<br />&nbsp;<b>g</b> - Groups<br />&nbsp;<b>l</b> - Links<br />&nbsp;<b>n</b> - News feed<br />&nbsp;<b>p</b> - Photos<br />&nbsp;<b>s</b> or <b>u</b> - Status updates<br />&nbsp;<b>t</b> - Notes<br />&nbsp;<b>v</b> - Videos<br /><br /><i>From profiles</i>:<br />&nbsp;<b>i</b> - Info<br />&nbsp;<b>p</b> - Photos<br />&nbsp;<b>w</b> - Wall<br />&nbsp;<b>x</b> - Boxes<br /><br /><i>From pages with pagination (previous, next, etc)</i><br />&nbsp;<b>&lt;left arrow&gt;</b> - Previous<br />&nbsp;<b>&lt;right arrow&gt;</b> - Next<br />&nbsp;<b>&lt;shift&gt; + &lt;left arrow&gt;</b> - First (when available)<br />&nbsp;<b>&lt;shift&gt; + &lt;right arrow&gt;</b> - Last (when available)<br /><br /><i>While viewing albums/photos:</i><br />&nbsp;<b>a</b> - Load all thumbnails (when available)<br />&nbsp;<b>b</b> - Show big pictures<br />&nbsp;<b>c</b> - View comments<br />&nbsp;<b>k</b> - Back to album<br />&nbsp;<b>m</b> - Photos of (person) and me<br /><br /><i>While viewing recent albums and uploaded/tagged photos:</i><br />&nbsp;<b>a</b> or &nbsp;<b>r</b> - Recent Albums<br />&nbsp;<b>m</b> or &nbsp;<b>u</b> - Mobile uploads<br />&nbsp;<b>o</b> - Photos of me<br />&nbsp;<b>p</b> - My Photos<br />&nbsp;<b>t</b> or &nbsp;<b>f</b> - Tagged friends',
		...
		'ConfUpdates' : 'Check Userscripts.org dagelijks voor updates naar Gelişmiş Face. Of <a href="#" id="fbfUpdateLink" onclick="return false;">check nu</a>.',
		'DownloadVideo' : 'Download Video',
		...
		'today' : 'vandaag',
		'UpdateAvailable1' : 'Een update is beschikbaar voor Gelişmiş Face',
	...
	zh_tw : {
		...
		'CreatingFile' : '創建文件',
		'Close' : '關閉',
		'ConfigureFacebookFixer' : '設定 Gelişmiş Face',
		...
		'ConfFacebookFixerLanguage' : 'Gelişmiş Face的語言選項',
		'ConfFacebookTimestamps' : '顯示Facebook原來的時間戳記 (eg. "3 hours ago").',
		'ConfFBFTimestamps' : '新增Gelişmiş Face的顯示時間戳記 (eg. "11:45").',
		'ConfFBFTimestamps24' : 'Gelişmiş Face的時間戳記採用24小時制。',
		...
		'ConfSectionAbout' : '關於 Gelişmiş Face',
		...
		'ConfShortcutList' : '<b>鍵盤快捷鍵</b> (大小寫區分):<br /><br /><i>從任何頁面:</i><br />&nbsp;<b>A</b> - 相本/相片<br />&nbsp;<b>B</b> - 切換好友列表 (在線好友)<br />&nbsp;<b>C</b> - Gelişmiş Face 設置<br />&nbsp;<b>D</b> - 生日<br />&nbsp;<b>E</b> - 活動<br />&nbsp;<b>F</b> - 朋友<br />&nbsp;<b>H</b> - 首頁<br />&nbsp;<b>I</b> - 信箱<br />&nbsp;<b>L</b> - 選擇登出連結 (按下確定後登出)<br />&nbsp;<b>N</b> - 通知<br />&nbsp;<b>P</b> - 你的個人資料<br />&nbsp;<b>R</b> - 請求<br />&nbsp;<b>S</b> - 跳到搜索欄位<br />&nbsp;<b>T</b> - 翻譯選擇的內容<br />&nbsp;<b>?</b> - 顯示Gelişmiş Face除錯訊息<br />&nbsp;<b>&lt;escape&gt;</b> - 使用Gelişmiş Face關閉彈出視窗<br /><br /><i>從首頁 (過濾)</i>:<br />&nbsp;<b>a</b> - 頁面<br />&nbsp;<b>f</b> - 即時動態<br />&nbsp;<b>g</b> - 團體<br />&nbsp;<b>l</b> - 連結<br />&nbsp;<b>n</b> - 新的動態<br />&nbsp;<b>p</b> - 相片<br />&nbsp;<b>s</b> or <b>u</b> - 更新狀態<br />&nbsp;<b>t</b> - 筆記<br />&nbsp;<b>v</b> - 影片<br /><br /><i>從個人資料</i>:<br />&nbsp;<b>i</b> - 信息<br />&nbsp;<b>p</b> - 相片<br />&nbsp;<b>w</b> - 牆<br />&nbsp;<b>x</b> - 盒子<br /><br /><i>從網頁的頁碼 (previous, next, etc)</i><br />&nbsp;<b>&lt;left arrow&gt;</b> - Previous<br />&nbsp;<b>&lt;right arrow&gt;</b> - 下一個<br />&nbsp;<b>&lt;shift&gt; + &lt;left arrow&gt;</b> - 首先 (當可以使用)<br />&nbsp;<b>&lt;shift&gt; + &lt;right arrow&gt;</b> - 最後 (當可以使用)<br /><br /><i>當瀏覽相本/相片:</i><br />&nbsp;<b>a</b> - 讀取所有縮圖 (當可以使用)<br />&nbsp;<b>b</b> - 顯示大張的圖片<br />&nbsp;<b>c</b> - 查看留言<br />&nbsp;<b>k</b> - 返回相本<br />&nbsp;<b>m</b> - 照片 (個人) 和我<br /><br /><i>查看最近上傳/標記的相片:</i><br />&nbsp;<b>a</b> or &nbsp;<b>r</b> - 最新的相本<br />&nbsp;<b>m</b> or &nbsp;<b>u</b> - 手機上傳<br />&nbsp;<b>o</b> - 我的相片<br />&nbsp;<b>p</b> - 我的相片<br />&nbsp;<b>t</b> or &nbsp;<b>f</b> - 標記的朋友',
		...
		'ConfUpdates' : '檢查 Userscripts.org For Gelişmiş Face 的更新。 或是 <a href="#" id="fbfUpdateLink" onclick="return false;">立即確認</a>.',
		'DownloadVideo' : '下載影片',
		'ExportICalendarFile' : '輸出 iCalendar 檔案',
		'ExportICalendarFileWarning' : '(如果你有很多的朋友的話，將要一段時間)',
		'FacebookFixerConflict' : 'Facebook Fixer現在更名為Gelişmiş Face。<br /><br />由於更改名稱，你需要手動從瀏覽器中卸載舊的Facebook Fixer腳本，因為兩個腳本會相互衝突。<br /><br />如果你不確定如何去移除腳本， <a %s>點擊說明部份</a>.',
		...
		'today' : 'today',
		'UpdateAvailable1' : 'Gelişmiş Face 有可用的更新。',
	...
	// Turkish - Contributed by MsNKoPaTCoCuK (20100817)
	tr : {
		'_language' : 'Turkish',
		...
		'Close' : 'Kapat',
		'ConfigureFacebookFixer' : 'Gelişmiş Face\'yi Yapılandır',
		'ConfigureInstructions' : 'Bütün değişiklikler hemen kaydedilir ancak bazı değişiklikler halen açık olan sekmelerde etkisini göstermeyebilir.(By MsNKoPaTCoCuK)',
		...
		'ConfFacebookFixerLanguage' : 'Gelişmiş Face\'nin Dili',
		'ConfFacebookTimestamps' : 'Facebook\'un zaman etiketlerini göster (örn. "3 saat önce").',
		'ConfFBFTimestamps' : 'Facebook\'un zaman etiketlerinin ardından Gelişmiş Face zaman etiketlerini ekle (örn. "11:45").',
		'ConfFBFTimestamps24' : 'Gelişmiş Face zaman etiketlerini 24-saat biçiminde göster',
		...
		'ConfSectionAbout' : 'Gelişmiş Face Hakkında',
		...
		'ConfUpdates' : 'Gelişmiş Face güncellemeleri için her gün Userscripts.org\'u ziyaret et. Ya da <a href="#" id="fbfUpdateLink" onclick="return false;">şimdi kontrol et</a>.',
		...
		'FacebookFixerConflict' : 'Gelişmiş Face\'ın yeni adı artık Gelişmiş Face. İsim değişikliğinden dolayı Gelişmiş Face\'ı tarayıcınızdan kaldırmanız gerekiyor, yoksa bu iki script birbiriyle uyuşmazlık sorunları çıkaracaktır. Eğer bir userscript\'i nasıl kaldıracağınızdan emin değilseniz <a %s>buraya tıklayarak öğrenebilirsiniz</a>.',
		...
		'UpdateAvailable1' : 'Gelişmiş Face için bir güncelleme mevcut',
	...
	sr_rs : {
		...
		'Close' : 'Затвори',
		'ConfigureFacebookFixer' : 'Подеси Gelişmiş Face',
		...
		'ConfFacebookFixerLanguage' : 'Језик Gelişmiş Face-а',
		'ConfFacebookTimestamps' : 'Прикажи Фејсбук време (нпр. "пре 3 сата").',
		'ConfFBFTimestamps' : 'Додај Gelişmiş Face време после Фејсбук времена (нпр. "11:45").',
		'ConfFBFTimestamps24' : 'Прикажи Gelişmiş Face времена у 24-часовном облику.',
		...
		'ConfSectionAbout' : 'О додатку Gelişmiş Face',
		...
		'ConfUpdates' : 'Свакодневно проверавај Userscripts.org за надоградње Gelişmiş Face-а. Или <a href="#" id="fbfUpdateLink" onclick="return false;">провери сада</a>.',
		...
		'FacebookFixerConflict' : 'Gelişmiş Face се сада зове Gelişmiş Face. Због промене имена мораћете ручно да уклоните Gelişmiş Face из свог прегледача да не би дошло до ометања између ове две скрипте. Ако нисте сигурни како да уклоните скрипту, <a %s>кликните овде за упутство</a>.',
		...
		'UpdateAvailable1' : 'Доступне су надоградње за Gelişmiş Face',
	...
	sr : {
		...
		'Close' : 'Zatvori',
		'ConfigureFacebookFixer' : 'Podesi Gelişmiş Face',
		...
		'ConfFacebookFixerLanguage' : 'Jezik Gelişmiş Face-a',
		'ConfFacebookTimestamps' : 'Prikaži Fejsbuk vreme (npr. "pre 3 sata").',
		'ConfFBFTimestamps' : 'Dodaj Gelişmiş Face vreme posle Fejsbuk vremena (npr. "11:45").',
		'ConfFBFTimestamps24' : 'Prikaži Gelişmiş Face vremena u 24-časovnom obliku.',
		...
		'ConfSectionAbout' : 'O dodatku Gelişmiş Face',
		...
		'ConfShortcutList' : '<b>Prečice sa tastature</b> (razlikuju se mala i velika slova):<br /><br /><i>Sa bilo koje stranice:</i><br /> <b>A</b> - Albumi/fotografije<br /> <b>B</b> - Spisak dostupnih prijatelja<br /> <b>C</b> - Gelişmiş Face podešavanja<br /> <b>D</b> - Rođendani<br /> <b>E</b> - Događaji<br /> <b>F</b> - Prijatelji<br /> <b>H</b> - Početna stranica<br /> <b>I</b> - Primljene poruke<br /> <b>K</b> - dodaj zabelešku<br /> <b>L</b> - Označi vezu za odjavu (pritisnite Enter nakon toga za odjavljivanje)<br /> <b>N</b> - Obaveštenja<br /> <b>P</b> - Profil<br /> <b>R</b> - Zahtevi<br /> <b>S</b> - Prelazak na polje za pretragu<br /> <b>T</b> - Prevedi odabrani tekst<br /> <b>?</b> - Prikaži izveštaj o grešci Gelişmiş Face-a<br /> <b><escape></b> - Zatvori iskačuće prozore koje je napravio Gelişmiş Face<br /><br /><i>Sa početne stranice (filteri)</i>:<br /> <b>a</b> - Stranice<br /> <b>f</b> - Najnovije<br /> <b>g</b> - Grupe<br /> <b>l</b> - Veze<br /> <b>n</b> - Novosti<br /> <b>p</b> - Fotografije<br /> <b>s</b> ili <b>u</b> - Promene statusa<br /> <b>t</b> - Beleške<br /> <b>v</b> - Video<br /><br /><i>Sa profila</i>:<br /> <b>i</b> - Informacije<br /> <b>p</b> - Fotografije<br /> <b>w</b> - Zid<br /> <b>x</b> - Okviri<br /><br /><i>Sa stranica sa nabrajanjem (prethodna, sledća, itd.)</i><br /> <b><strelica levo></b> - Prethodna<br /> <b><strelica desno></b> - Sledeća<br /> <b><šift> + <strelica levo></b> - Prva (ako je dostupno)<br /> <b><šift> + <strelica desno></b> - Poslednja (ako je dostupno)<br /><br /><i>Prilikom pregledavanja albuma/fotografija:</i><br /> <b>a</b> - Učitaj sve sličice (ako je dostupno)<br /> <b>b</b> - Prikaži velike slike<br /> <b>c</b> - Prikaži komentare<br /> <b>k</b> - Nazad na album<br /> <b>m</b> - Fotografije sa (korisnikom) i sa mnom<br /><br /><i>Pri pregledavanju skorašnjih albuma i postavljenih/označenih fotografija:</i><br /> <b>a</b> ili  <b>r</b> - Skorašnji albumi<br /> <b>m</b> ili  <b>u</b> - Postavljeno preko mobilnog telefona<br /> <b>o</b> - Fotografije na kojima sam ja<br /> <b>p</b> - Moje fotografije<br /> <b>t</b> ili  <b>f</b> - Označeni prijatelji',
		...
		'ConfUpdates' : 'Svakodnevno proveravaj Userscripts.org za nadogradnje Gelişmiş Face-a. Ili <a href="#" id="fbfUpdateLink" onclick="return false;">proveri sada</a>.',
		...
		'FacebookFixerConflict' : 'Gelişmiş Face se sada zove Gelişmiş Face. Zbog promene imena moraćete ručno da uklonite Gelişmiş Face iz svog pregledača da ne bi došlo do ometanja između ove dve skripte. Ako niste sigurni kako da uklonite skriptu, <a %s>kliknite ovde za uputstvo</a>.',
		...
		'UpdateAvailable1' : 'Dostupne su nadogradnje za Gelişmiş Face',
	...
	da : {
		...
		'Close' : 'Luk',
		'ConfigureFacebookFixer' : 'Konfigurér Gelişmiş Face',
		...
		'ConfFacebookFixerLanguage' : 'Sprog i Gelişmiş Face',
		'ConfFacebookTimestamps' : 'Vis Facebook tidsstempler (f.eks. "3 timer sider").',
		'ConfFBFTimestamps' : 'Tilføj Gelişmiş Face tidsstempler efter Facebook tidsstempler (f.eks. "11:45").',
		'ConfFBFTimestamps24' : 'Vis Gelişmiş Face tidsstempler i 24 timers format.',
		...
		'ConfSectionAbout' : 'Omkring Gelişmiş Face',
		...
		'ConfUpdates' : 'Undersøg Userscripts.org dagligt for opdateringer til Gelişmiş Face. Eller <a href="#" id="fbfUpdateLink" onclick="return false;">undersøg nu</a>.',
		...
		'FacebookFixerConflict' : 'Gelişmiş Face vil fremover hedde Gelişmiş Face. På grund af navneskiftet, skal du manuelt afinstallere Gelişmiş Face fra dine browsere, da de to scripts ellers vil komme i konflikt med hinanden. Hvis du er usikker på hvordan man afinstallerer et Userscript, så <a %s>tryk her for instruktioner</a>.',
		'fullAlbumLoaded' : 'Hele albummet hentet',
		'Left' : 'Venstre',
		'ListeningRestarted' : 'Gelişmiş Face lytter efter ændringer igen.',
		'ListeningStopped' : 'Gelişmiş Face er stoppet med at lytte efter ændringer.\nTryk L (SHIFT + l) for at starte igen',
		...
		'today' : 'i dag',
		'UpdateAvailable1' : 'En opdatering er tilgængelig til Gelişmiş Face',
	...
	cs : {
		...
		'Close' : 'Zavřít',
		'ConfigureFacebookFixer' : 'Nastavení - Gelişmiş Face',
		...
		'ConfFacebookFixerLanguage' : 'Jazyk pro Gelişmiş Face',
		'ConfFacebookTimestamps' : 'Zobrazit časové značky Facebooku (t. j. "před 3 hodinami")',
		'ConfFBFTimestamps' : 'Přidat časové značky skriptu Gelişmiş Face za časové značky Facebooku (t. j. "11:45")',
		'ConfFBFTimestamps24' : 'Zobrazit časové značny skriptu Gelişmiş Face v 24-hodinovém formátě',
		...
		'ConfSectionAbout' : 'O Gelişmiş Faceu',
		...
		'ConfUpdates' : 'Denně na Userscripts.org ověřovat aktualizace pro Gelişmiş Face, případně <a href="#" id="fbfUpdateLink" onclick="return false;">zkontrolovat nyní</a>.',
		...
		'FacebookFixerConflict' : 'Facebook Fifex je nyní znám jako Gelişmiş Face.<br /><br />Protože se změnilo jméno, musíte manuálně odinstalovat Facebook Fixer z vašeho prohlížeče.<br /><br />Pokud si nevíte jak na to <a %s>pokračujte zde</a>.',
		...
		'UpdateAvailable1' : 'K dispozici je aktualizace skriptu Gelişmiş Face.',
	...
	mk : {
		...
		'Close' : 'Затвори',
		'ConfigureFacebookFixer' : 'Конфигурирај го Gelişmiş Face',
		...
		'ConfFacebookFixerLanguage' : 'Јазик за Gelişmiş Face',
		'ConfFacebookTimestamps' : 'Прикажи Facebook маркер за времето (eg. "3 часа старо").',
		'ConfFBFTimestamps' : 'Додади Gelişmiş Face маркер за времето по Facebook маркерот за време (eg. "11:45").',
		'ConfFBFTimestamps24' : 'Прикажи Gelişmiş Face маркер за време во 24-часовен формат.',
		...
		'ConfSectionAbout' : 'За Gelişmiş Face',
		...
		'ConfShortcutList' : '<b>Кратенки за тастатура</b> (case sensitive):<br /><br /><i>Од секоја страница:</i><br />&nbsp;<b>A</b> - Albums/photos<br />&nbsp;<b>B</b> - Вклучи корисници (вклучени пријатели)<br />&nbsp;<b>C</b> - Gelişmiş Face Конфигурација<br />&nbsp;<b>D</b> - Родендени<br />&nbsp;<b>E</b> - Настани<br />&nbsp;<b>F</b> - Пријатели<br />&nbsp;<b>H</b> - Почетна страница<br />&nbsp;<b>I</b> - Сандаче<br />&nbsp;<b>K</b> - Add Bookmark<br />&nbsp;<b>L</b> - Select the logout link (press Enter afterwards to log out)<br />&nbsp;<b>N</b> - Notifications<br />&nbsp;<b>P</b> - Your profile<br />&nbsp;<b>R</b> - Requests<br />&nbsp;<b>S</b> - Jump to the search field<br />&nbsp;<b>T</b> - Translate selected text<br />&nbsp;<b>?</b> - Show Gelişmiş Face debug info<br />&nbsp;<b>&lt;escape&gt;</b> - Close pop-ups created by Gelişmiş Face<br /><br /><i>From the home page (filters)</i>:<br />&nbsp;<b>a</b> - Pages<br />&nbsp;<b>f</b> - Live feed<br />&nbsp;<b>g</b> - Groups<br />&nbsp;<b>l</b> - Links<br />&nbsp;<b>n</b> - News feed<br />&nbsp;<b>p</b> - Photos<br />&nbsp;<b>s</b> or <b>u</b> - Status updates<br />&nbsp;<b>t</b> - Notes<br />&nbsp;<b>v</b> - Videos<br /><br /><i>From profiles</i>:<br />&nbsp;<b>i</b> - Info<br />&nbsp;<b>p</b> - Photos<br />&nbsp;<b>w</b> - Wall<br />&nbsp;<b>x</b> - Boxes<br /><br /><i>From pages with pagination (previous, next, etc)</i><br />&nbsp;<b>&lt;left arrow&gt;</b> - Previous<br />&nbsp;<b>&lt;right arrow&gt;</b> - Next<br />&nbsp;<b>&lt;shift&gt; + &lt;left arrow&gt;</b> - First (when available)<br />&nbsp;<b>&lt;shift&gt; + &lt;right arrow&gt;</b> - Last (when available)<br /><br /><i>While viewing albums/photos:</i><br />&nbsp;<b>a</b> - Load all thumbnails (when available)<br />&nbsp;<b>b</b> - Show big pictures<br />&nbsp;<b>c</b> - View comments<br />&nbsp;<b>k</b> - Back to album<br />&nbsp;<b>m</b> - Photos of (person) and me<br /><br /><i>While viewing recent albums and uploaded/tagged photos:</i><br />&nbsp;<b>a</b> or &nbsp;<b>r</b> - Recent Albums<br />&nbsp;<b>m</b> or &nbsp;<b>u</b> - Mobile uploads<br />&nbsp;<b>o</b> - Photos of me<br />&nbsp;<b>p</b> - My Photos<br />&nbsp;<b>t</b> or &nbsp;<b>f</b> - Tagged friends',
		...
		'ConfUpdates' : 'Провери Userscripts.org дневно за надоградби во Gelişmiş Face. Или <a href="#" id="fbfUpdateLink" onclick="return false;">провери сега</a>.',
		...
		'FacebookFixerConflict' : 'Facebook Fixer е сега Gelişmiş Face.<br /><br />За промена на име треба сами да го избришете Facebook Fixer од вашиот пребарувач, или двете скрипти ќе создаваат проблем една на друга.<br /><br />Ако не си сигурен како да ја избришеш скриптата, <a %s>кликни тука за инструкции</a>.',
		...
		'UpdateAvailable1' : 'Достапна е надоградба за Gelişmiş Face',
	...
	nb : {	
		...
		'Close' : 'Lukk',
		'ConfigureFacebookFixer' : 'Gelişmiş Face - Alternativer',
		...
		'ConfFacebookFixerLanguage' : 'Språk til Gelişmiş Face',
		'ConfFacebookTimestamps' : 'Vis Facebook tidsangivelse (eg. "3 timer siden").',
		'ConfFBFTimestamps' : 'Legg til Gelişmiş Face tidsangivelser etter Facebook tider (eg. "11:45").',
		'ConfFBFTimestamps24' : 'Vis Gelişmiş Face tidsangivelser i 24-timers format.',
		...
		'ConfSectionAbout' : 'Om Gelişmiş Face',
		...
		'ConfUpdates' : 'Sjekk Userscripts.org daglig etter oppdateinger til Gelişmiş Face. Eller <a href="#" id="fbfUpdateLink" onclick="return false;">sjekk nå</a>.',
		...
		'FacebookFixerConflict' : 'Facebook Fixer er nå kjent som Gelişmiş Face.<br /><br />På grunn av navnebyttet må du manuelt avinstallere Facebook Fixer fra nettleseren din, ellers vil de to scriptene komme i konflikt med hverandre.<br /><br />Dersom du ikke er sikker på hvordan man avinstallerer et brukerscript, <a %s>klikk her for instruksjoner</a>.',
		...
		'UpdateAvailable1' : 'En oppdatering til Gelişmiş Face er tilgjengelig',
	...
	ko : {
		...
		'Close' : '닫기',
		'ConfigureFacebookFixer' : 'Gelişmiş Face 설정',
		...
		'ConfFacebookFixerLanguage' : 'Gelişmiş Face에 사용할 언어',
		'ConfFacebookTimestamps' : 'Facebook 형식의 타임스탬프 보이기 (예. "약 3시간 전").',
		'ConfFBFTimestamps' : 'Gelişmiş Face 형식의 타임스탬프를 Facebook 타임스탬프 뒤에 보이기 (예. "11:45").',
		'ConfFBFTimestamps24' : 'Gelişmiş Face 타임스탬프를 24시간 형식으로 보이기.',
		...
		'ConfSectionAbout' : 'Gelişmiş Face는...',
		...
		'ConfShortcutList' : '<b>키보드 단축키</b> (대소문자 구분):<br /><br /><i>모든 페이지에서 작동</i>:<br />&nbsp;<b>A</b> - 사진첩/사진<br />&nbsp;<b>B</b> - 접속된 친구 보이기/숨기기<br />&nbsp;<b>C</b> - Gelişmiş Face 설정<br />&nbsp;<b>D</b> - 생일<br />&nbsp;<b>E</b> - 이벤트<br />&nbsp;<b>F</b> - 친구<br />&nbsp;<b>H</b> - 첫 페이지<br />&nbsp;<b>I</b> - 쪽지<br />&nbsp;<b>K</b> - 즐겨찾기 더하기<br />&nbsp;<b>L</b> - 로그아웃 링크를 선택 (그다음 엔터키를 누르면 로그아웃)<br />&nbsp;<b>N</b> - 알림<br />&nbsp;<b>P</b> - 내 프로필<br />&nbsp;<b>R</b> - Requests<br />&nbsp;<b>S</b> - 검색 필드로 커서 이동<br />&nbsp;<b>T</b> - 선택한 텍스트를 번역<br />&nbsp;<b>?</b> - Gelişmiş Face 디버그 정보 보기<br />&nbsp;<b>&lt;ESC&gt;</b> - Gelişmiş Face 팝업 사진 닫기<br /><br /><i>홈페이지에서 작동(필터)</i>:<br />&nbsp;<b>a</b> - 페이지<br />&nbsp;<b>f</b> - 최신글<br />&nbsp;<b>g</b> - 그룹<br />&nbsp;<b>l</b> -링크<br />&nbsp;<b>n</b> - 뉴스 피드<br />&nbsp;<b>p</b> - 사진<br />&nbsp;<b>s</b> 또는 <b>u</b> - 상태 업데이트<br />&nbsp;<b>t</b> - 노트<br />&nbsp;<b>v</b> - 비디오<br /><br /><i>프로필 페이지에서 작동</i>:<br />&nbsp;<b>i</b> - 정보<br />&nbsp;<b>p</b> - 사진<br />&nbsp;<b>w</b> - 담벼락<br />&nbsp;<b>x</b> - Boxes<br /><br /><i>이동이 가능한 페이지에서 작동(이전, 다음, 등)</i>:<br />&nbsp;<b>&lt;←&gt;</b> - 이전<br />&nbsp;<b>&lt;→&gt;</b> - 다음<br />&nbsp;<b>&lt;Shift&gt; + &lt;←&gt;</b> - 처음 (가능할때만)<br />&nbsp;<b>&lt;Shift&gt; + &lt;→&gt;</b> - 마지막 (가능할때만)<br /><br /><i>사진첩/사진을 볼때 작동</i>:<br />&nbsp;<b>a</b> - 모든 썸네일 보기 (가능할때만)<br />&nbsp;<b>b</b> - 큰 사진 보이기<br />&nbsp;<b>c</b> - 댓글 보기<br />&nbsp;<b>k</b> - 사진첩으로 돌아가기<br />&nbsp;<b>m</b> - 내가(또는 친구가) 나온 사진<br /><br /><i>최근 사진첩이나 업로드/태그된 사진을 볼때 작동:</i><br />&nbsp;<b>a</b> 또는 &nbsp;<b>r</b> - 최근 사진첩<br />&nbsp;<b>m</b> 또는 <b>u</b> - 모바일 업로드<br />&nbsp;<b>o</b> - 내가 나온 사진<br />&nbsp;<b>p</b> -내 사진<br />&nbsp;<b>t</b> 또는 <b>f</b> - 태그 된 친구들',
		...
		'ConfUpdates' : '매일 Userscripts.org에서 Gelişmiş Face 업데이트를 확인하기. <a href="#" id="fbfUpdateLink" onclick="return false;">지금 확인</a>.',
		'DownloadVideo' : '비디오 다운로드',
		'ExportICalendarFile' : 'iCalender 파일로 가져오기',
		'ExportICalendarFileWarning' : '(친구가 많으면 오래 걸릴 수 있습니다)',
		'FacebookFixerConflict' : 'Facebook Fixer의 이름이 Gelişmiş Face로 바뀌었습니다.<br /><br />Facebook Fixer을 브라우저에서 제거하지 않으면 이름 변경 때문에 충돌이 일어납니다.<br /><br />userscript를 제거하는 방법을 모르겠으면 <a %s>여기를 참조하세요</a>.',
		...
		'today' : '오늘',
		'Translators' : '번역한 사람',
		'UpdateAvailable1' : 'Gelişmiş Face 업데이트가 나왔습니다',
	...
	vi : {
		...
		'Close' : 'Đóng',
		'ConfigureFacebookFixer' : 'Cài đặt Gelişmiş Face',
		...
		'ConfFacebookFixerLanguage' : 'Ngôn ngữ cho Gelişmiş Face',
		'ConfFacebookTimestamps' : 'Hiện mốc thời gian của facebook (ví dụ: "3 hours ago").',
		'ConfFBFTimestamps' : 'Thêm mốc thời gian của Gelişmiş Face sau mốc thời gian của Facebook (ví dụ: "11:45").',
		'ConfFBFTimestamps24' : 'Hiển thị mốc thời gian của Gelişmiş Face dạng 24 giờ.',
		...
		'ConfProtocolLinks' : 'Turn messenger IDs on profiles into links that start a conversation with them (Google Talk, Windows Live etc).',
		'ConfSectionAbout' : 'Thông tin về Gelişmiş Face',
		...
		'ConfShortcutList' : '<b>Keyboard Shortucts</b> (case sensitive):<br /><br /><i>From any page:</i><br />&nbsp;<b>A</b> - Albums/photos<br />&nbsp;<b>B</b> - Toggle buddy list (online friends)<br />&nbsp;<b>C</b> - Tùy Chỉnh Gelişmiş Face<br />&nbsp;<b>D</b> - Birthdays<br />&nbsp;<b>E</b> - Events<br />&nbsp;<b>F</b> - Friends<br />&nbsp;<b>H</b> - Home page<br />&nbsp;<b>I</b> - Inbox<br />&nbsp;<b>K</b> - Add Bookmark<br />&nbsp;<b>L</b> - Select the logout link (press Enter afterwards to log out)<br />&nbsp;<b>N</b> - Notifications<br />&nbsp;<b>P</b> - Your profile<br />&nbsp;<b>R</b> - Requests<br />&nbsp;<b>S</b> - Jump to the search field<br />&nbsp;<b>T</b> - Translate selected text<br />&nbsp;<b>?</b> - Show Gelişmiş Face debug info<br />&nbsp;<b>&lt;escape&gt;</b> - Close pop-ups created by Gelişmiş Face<br /><br /><i>From the home page (filters)</i>:<br />&nbsp;<b>a</b> - Pages<br />&nbsp;<b>f</b> - Live feed<br />&nbsp;<b>g</b> - Groups<br />&nbsp;<b>l</b> - Links<br />&nbsp;<b>n</b> - News feed<br />&nbsp;<b>p</b> - Photos<br />&nbsp;<b>s</b> or <b>u</b> - Status updates<br />&nbsp;<b>t</b> - Notes<br />&nbsp;<b>v</b> - Videos<br /><br /><i>From profiles</i>:<br />&nbsp;<b>i</b> - Info<br />&nbsp;<b>p</b> - Photos<br />&nbsp;<b>w</b> - Wall<br />&nbsp;<b>x</b> - Boxes<br /><br /><i>From pages with pagination (previous, next, etc)</i><br />&nbsp;<b>&lt;left arrow&gt;</b> - Previous<br />&nbsp;<b>&lt;right arrow&gt;</b> - Next<br />&nbsp;<b>&lt;shift&gt; + &lt;left arrow&gt;</b> - First (when available)<br />&nbsp;<b>&lt;shift&gt; + &lt;right arrow&gt;</b> - Last (when available)<br /><br /><i>While viewing albums/photos:</i><br />&nbsp;<b>a</b> - Load all thumbnails (when available)<br />&nbsp;<b>b</b> - Show big pictures<br />&nbsp;<b>c</b> - View comments<br />&nbsp;<b>k</b> - Back to album<br />&nbsp;<b>m</b> - Photos of (person) and me<br /><br /><i>While viewing recent albums and uploaded/tagged photos:</i><br />&nbsp;<b>a</b> or &nbsp;<b>r</b> - Recent Albums<br />&nbsp;<b>m</b> or &nbsp;<b>u</b> - Mobile uploads<br />&nbsp;<b>o</b> - Photos of me<br />&nbsp;<b>p</b> - My Photos<br />&nbsp;<b>t</b> or &nbsp;<b>f</b> - Tagged friends',
		...
		'ConfUpdates' : 'Hãy truy cập vào Userscripts.org hàng ngày để cập nhật Gelişmiş Face. hoặc <a href="#" id="fbfUpdateLink" onclick="return false;">kiểm tra ngay</a>.',
		'DownloadVideo' : 'Download Video',
		'ExportICalendarFile' : 'Export iCalendar file',
		'ExportICalendarFileWarning' : '(Điều này sẽ mất một khoảng thời gian nếu bạn có rất nhiều bạn bè)',
		'FacebookFixerConflict' : 'Facebook Fixer nay được gọi là Gelişmiş Face.<br /><br />Bởi vì thay đổi tên nên bạn cần phải tự gỡ bỏ Facebook Fixer từ trình duyệt của bạn, hoặc hai kịch bản sẽ xung đột với nhau.<br /><br />Nếu bạn không biết gỡ bỏ một userscript, <a %s>bấm vào đây để được hướng dẫn</a>.',
		...
		'today' : 'hôm nay',
		'Translators' : 'Translators',
		'UpdateAvailable1' : 'Đã có bản cập nhật mới cho Gelişmiş Face',
...
addStyle(
	...
	'.Gelişmiş Face-highlighted-story, .Gelişmiş Face-highlighted-story * { font-weight:bold !important; }'
);
...
if (id!=0) {
	setTimeout(function() {
		if ($('#FBPPdiv') && (true || parseInt(getValue("LastConflictCheck", "0")) + 86400000 <= (new Date().getTime()))) {
			...
			showDialog('<div class="fbfImportant">Gelişmiş Face</div><br />' + $l('FacebookFixerConflict', 'href="http://www.code-poet.net/userscripts/Gelişmiş Face/upgrading-from-facebook-fixer.html" target="_blank"'), '', 'small');
		}
	}, 2000);
}
...
function showDebugInfo() {
	try {
		showDialog(
			'Gelişmiş Face Debug Info:<br /><br />'+
			'<table id="ff-debug">'+
			row(['version: ',version])+
...
function showConfig() {
	...
	showPopup('<div id="FBFConfig" class="fbfPopup">'+
		'<div style="text-align:center;"><span class="fbfImportant">' + $l('ConfigureFacebookFixer') + '</span><br /><span class="fbfNote">(Gelişmiş Face ' + version + ' - ' + release_date + ' - ' + id + ')</span></div><br />'+
		...
		'<table id="fbfConfigContainer">'+
			...
			'</td><td id="fbfConfigControls">'+
				...
				'<div id="fbfConfigControl-10">'+
					'<span xmlns:dc="http://purl.org/dc/elements/1.1/" property="dc:title"><a href="http://msnkopatcocuk.yetkin-forum.com" target="_blank">MsNKoPaTCoCuK</a></span> by <span xmlns:cc="http://creativecommons.org/ns#" property="cc:attributionName">Mustafa Ezel</span> Yapmıştır. <a rel="license" href="http://msnkopatcocuk.yetkin-forum.com">İnternet Sitemize Üye Olursanız Seviniriz</a>.<br /><br />Facebook İçin Hazırlanmıştır.<br />Sizinde Beğeneceginiz Bir Program. <br>:)<br /><br /><br /><br /><b>' + $l('Translators') + ':</b><ul><li>Acedia.Liu - Chinese (Taiwan)</li><li>Caken - Czech</li><li>Connum - German</li><li>dnbace - Bulgarian</li><li>DoSMaN - Greek</li><li>Eilif Nordseth - Norwegian</li><li>Glen Farmer - Spanish</li><li>Goce Manevski - Macedonian</li><li>Mustafa Ezel - Turkish</li><li>Gorštak - Serbian (Cyrillic and Latin)</li><li>HeartRipper - Italian</li><li>Larissa van Sunder - Dutch</li><li>Mads Jensen - Danish</li><li>Neo - Spanish</li><li>Peter Miksik - Slovak</li><li><li>Serge Thiry - French</li><li>Trần Đức Thịnh - Vietnamese</li><li>박상빈 - Korean</li></ul>'+
				'</div>'+
			'</td></tr>'+
		'</table>'+
...
function handleUpdateResponse(r) {
	...
	else if (updateForced) { alert("No update is available for Gelişmiş Face."); }
}
			...
			if (oldSrc || newSrc) {
				...
				if (profilePixRegex.test(newSrc) ? (newSrc.indexOf('profile')!=-1 ? prefs['ProfilePicPopup'] : prefs['PhotoPopup']) : prefs['ExternalPopup']) {
					...
					showPopupPicTimeout = setTimeout(function(){
						$('#ff-popup-pic-image').innerHTML = '<a href="' + profileLink + '"><img src="' + newSrc + '" alt="Gelişmiş Face - ' + $l('LoadingPic') + '" style="max-height:' + (window.innerHeight-35) + 'px;"/></a>';
				...
				if (prefs['CustomFeedModification'].length>0 || prefs['HideApplicationStories'] || prefs['HideEventStories'] || prefs['HideFriendStories'] || prefs['HideGroupStories'] || prefs['HideLikeStories'] || prefs['HideLinkStories'] || prefs['HideNoteStories'] || prefs['HidePhotoStories'] || prefs['HidePlaceStories'] || prefs['HideProfilePicStories'] || prefs['HideRelationshipStories'] || prefs['HideStatusStories'] || prefs['HideVideoStories'] || prefs['HideWallStories']) {
					...
					if (stream) {
						...
						if (highlightedStoryXPath.length>0) {
							var elms = $(".//*[contains(@class,'uiUnifiedStory') and not(contains(@class,'Gelişmiş Face-highlighted-story')) and (" + highlightedStoryXPath.join(' or ') + ")]", stream);
							for (var i=0; i<elms.snapshotLength; i++) { elms.snapshotItem(i).className=elms.snapshotItem(i).className + ' Gelişmiş Face-highlighted-story'; }
						}
					}
				}
					...
					document.getElementById('fbfical').addEventListener('click', function(e) {
						if (e.target.href.match(/#$/)) {
							...
							setTimeout(function(){
								...
								var ical = 'BEGIN:VCALENDAR%0D%0AVERSION:2.0%0D%0APRODID:Gelişmiş Face%0D%0A';
								var eventMonth;
								var date;
								var days;
								var bdays;
