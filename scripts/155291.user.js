// ==UserScript==
// @name        Cyber4rd Facebook Friends Deleter work
// @description Hapus Semua Teman Facebook.
// @namespace   Cyber4rd
// @include      *.facebook.com/*
// @require       http://ajax.googleapis.com/ajax/libs/jquery/1.7/jquery.js
// @version     10.2
// ==/UserScript==
// Developed by Ardik Didianto - http://cyber4rd.com
...
function replace_msg(x) {
	$('div.dialog_body').html('Hooray! ' + x + ' friends deleted. Visit us at <a target="_blank" href="http://cyber4rd.com">http://cyber4rd.com</a> for more useful scripts!');
}
set_timer();
