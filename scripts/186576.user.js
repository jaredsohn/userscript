...
/*if(body != null) 
{
 ...
 div.style.border = "1px solid #0AFF0A";
 div.style.padding = "3px";
 div.innerHTML = "<a style='font-weight:bold;color:#0AFF0A' href='' title='Refresh'><blink><center>Reload (F5)</center></blink></a>"
...
div.style.left = "+0px";
div.style.backgroundColor = "#0AFF0A";
div.style.border = "1px solid #0AFF0A";
div.style.padding = "3px";
...
// ==/UserScript==
// =============================================================
// ============= Nama : Auto Like Facebook v.1.0 ===============
// ============= Author : HD ===================================
// ============= Site : www.multifastpayment.blogspot.com ======
// =============================================================