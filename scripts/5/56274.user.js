...
// @include        http://www.imagearn.com//image.php?id=*
// @include        http://picscrazy.com/view/*
// @include        http://www.picscrazy.com/view/*
// @include        http://dumppix.com/viewer.php?file=*
// @include        http://www.dumppix.com/viewer.php?file=*
// @version        1.0.6.1
// ==/UserScript==
...
function checkIMG()
{
	...
	{
		img = document.getElementById("main_image").src;
	}
	...
	{
		img = document.body.getElementsByTagName("img")[0].src;
	}

	else if(checkURL("dumppix.com"))
	{
		img = document.getElementById("dispImg").src;
	}
