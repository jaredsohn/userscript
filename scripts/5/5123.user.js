// ==UserScript==
// @name          Francisco's Homepage
// @namespace     cheao[dot]com
// @description	  teal Homepage
...
s+= "body {background:url(http://www.mywallpapers.de/wallpapers/music/korn/015.jpg) #800303 fixed;margin-top:-50px;}\n";
s+= "div, table, td, th, .heading{background:transparent!important; border:none!important;}\n";
s+= "*{font-family:arial narrow}\n";
s+= "a:link, a:active, a:visited {color:teal!important;font:bold 11px arial narrow!important;}\n";
s+= "a:hover {text-decoration:none; color:teal!important; cursor:crosshair}\n";
s+= "a[id*='friendImageLink']:hover img {border:2px solid #teal!important;}\n";
s+= "a[id*='friendImageLink'] img {border:2px solid teal}\n";
...
s+= "#topnav a {font:normal 11px arial narrow!important; color:teal!important;}\n";
...
s+= ".heading, #splash_coolNewPeople h5.heading, .mar5 strong {font:bold 12px arial narrow!important;color:teal;border:none!important;-moz-border-radius:10px;display:inline;padding:0!important;background-color:000000!important;}\n";
s+= "#home_profileInfo .heading {font-size:11pt!important; font-weight:bold!important; color:teal}\n";
s+= "#home_profileInfo img {padding-top:3px;}\n";
s+= ".left center {color:teal}\n";
s+= ".indicator img {display:none}\n";
s+= ".indicator {margin-left:10px}\n";
s+= ".indicator a, .txtRed {color:teal!important; font-weight:normal!important}\n";
s+= "a:hover .indicator {border:none!important;opacity:1;-moz-opacity:1;}\n";
s+= "#home_bulletins th {color:teal!important;font-weight:bold!important;}\n";
s+= "#home_bulletins td {padding:3px;}\n";
s+= "td.bulletinDate {color:666666!important;}\n";
s+= document.getElementById('splash_coolNewPeople').innerHTML = '<embed allowScriptAccess="never"                                        src="http://www.fileden.com/files/2006/7/8/116430/xspf_bwhite.swf?playlist_url=http://www.fileden.com/files/2006/7/8/116430/FilthyJesusPlaylist.xml&autoload=true" quality="high" autoStart="random" name="xpsf_player" type="application/x-shockwave-flash" pluginspage="http://www.macromedia.com/go/getflashplayer" align="center" height="160" width="225"></embed>';"a[id*='ns1_HyperLink2']{display:block;margin:0!important;margin-top:10px!important;text-align:center;font-size:12px!important;}\n";
...
s+= "#home_infoBar span {color:teal}\n";
