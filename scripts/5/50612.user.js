// ==UserScript==
          // @name	The BandOfBrothers Alliance Tool
          // @version 	3
          // @namespace 	kronosvl
          // @author	kronosvl
          // @description	Ika-core.org utilities for Ikariam.
          // @include		http://s8.ikariam.ro/*
          ...
          var version=3;
          var scriptlocation="http://userscripts.org/scripts/source/50612.user.js";
          
          switch (location.host) {	
          	default:
          		alliancefullnm='Band of Brothers';
          		alliancenm='BoB';		
