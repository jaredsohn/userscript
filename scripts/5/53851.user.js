// ==UserScript==
// @name           eCanada News Alert
// @namespace      eCanada News Alert
// @description    eCanada Breaking News and Battle Orders
// @version        1.02
...
GM_xmlhttpRequest({
	method: 'GET',
	url: 'http://ecanada.ws/forums/viewtopic.php?f=20&t=954&p=15643.0.html',
	...
	onload:function(response){
			...
			header.textContent = 'eCanada Alert ';
