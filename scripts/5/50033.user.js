...
pogbutton.innerHTML = '<input type="button" id="pogbutton">Player of the Night</input>';
boxscore.parentNode.insertBefore(pogbutton, boxscore.nextSibling);
pogbutton.addEventListener('click', function()
{
	...
	pogtable.innerHTML = '<div><table border="0" cellpadding="3" cellspacing="1" bgcolor="#000000">' +
			'<tr><td colspan="4" bgcolor="#000080" class="tableHeader2">Player of the Night Ratings</td></tr>' +
			...
			'<tr align="left"><td width="150" bgcolor="#F1E7C5" class="loginBottomText">' + player10 + '</td>' +
				...
				'</tr></table></div>';
	boxscore.parentNode.insertBefore(pogtable, boxscore.nextSibling);
}, false);
...
function pograting(fgm, fga, threem, threea, ftm, fta, oreb, dreb, reb, ast, stl, blk, to, pts, dif, name)
{
	...
	var pog = (m_pts*pts + m_reb*reb + m_ast*ast + m_blk*blk + m_stl*stl - m_to*to - (fga-fgm)*m_missfg - (fta-ftm)*m_missft) * m_dif + win;
