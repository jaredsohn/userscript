...
// @include                	http://*.staemme.ch/game.php?*mode=prod*
// @include                	http://*.staemme.ch/game.php?*screen=overview_villages
// @exclude		http://*.staemme.ch/game.php?*screen=train&mode=mass*
// @exclude		http://*.staemme.ch/game.php?*screen=snob*
// ==/UserScript==
