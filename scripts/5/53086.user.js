...
function TwSetVillageInfo()
{
	try{
		...
		newinfo_village += '			<tr><td><a 	href= "'+twLinks["twMainMenuArray"]["map"]+'&x='+infoPlayer["CoordDestino"][0]+'&y='+infoPlayer["CoordDestino"][1]+'" >&raquo; Center Map</a></td></tr>';
		...
		newinfo_village += '			<tr><td><a href="javascript:alert(\'Abandoned.\');">&raquo; Historia wioski</a></td></tr>';
		newinfo_village += '			<tr><td><a href="javascript:alert(\'Abandoned.\');">&raquo; Zmiany plemienia</a></td></tr>';
		newinfo_village += '		</tbody>';
		newinfo_village += '	</table>';	
		newinfo_village += '</div>'; 
...
function twPlayerInfoAllies()
{
	...
	GM_xmlhttpRequest({ 
		...
		onload: function(responseDetails) {
			...
			menu += '		<input type="button" name="getInfo" id="btnGetInfo" value="GetInfo" align=right/>'
			menu += '</fieldset>'
