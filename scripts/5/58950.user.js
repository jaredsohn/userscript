// ==UserScript==
// @name          Auto download free embroidery desing in every 12 minutes form embroideryfriend
// @namespace     http://userscripts.org/scripts/show/58950
// @include       http://www.embroideryfriend.com/index.php
// ==/UserScript==
// Notes:
...
var attachmentLinks = document.evaluate("//a[@href[contains(.,'.pes')]]", document, null, XPathResult.UNORDERED_NODE_SNAPSHOT_TYPE,null); 
