...
// @name		ePlus
// @version		1.0
// @description	eRepublik script that simplifies common tasks, original by PeekaBooh
// @author		eCitizen Isidro Spencer
// @namespace		eCitizenIsidro Spencer
...
// ===============================================================================
// Original file by Peekabooh... this was changed to suit my needs
...
var VERSION = '0.54';
var LOCALE = 'en/'
var BASE_URL = 'http://www2.erepublik.com/';
...
p://www2.erepublik.com/images/parts/icon_show-off.gif"/>&nbsp;&nbsp;' + STRINGS[0] + '</a>';
...
function addThirdPartyTools() {
	var thirdPartyTools = [
		{aname: 'Isidro Spencer',	aid: '1493879',	name: 'eRepublik Plus',					url: 'http://www2.erepublik.com/' + LOCALE + 'article/erepublik-plus-grand-tutorial-807662/1/20', img: 'http://static.erepublik.com/uploads/avatars/Newspapers/2009/05/15/81f97d040a2b499d539e0a7f61ce3788_55x55.jpg'},
...
function addNationalForums() {
	var nationalForums = [
		...
		{country: 'Mexico', 			url: 'http://erepublik.com.mx/', 				name: 'Official Forum of Mexico. &bull; Página principal'},
...
function saveLink(obj, what) {
	...
	if (GM_getValue(cID + 'eR_QL') != undefined)
		...
		lLinks = ['National Forums', 'http://wiki.erepublik.com/index.php/External_Community_Sites', '', 'Link 2', '', '', 'Link 3', '', '', 'Link 4', '', '', 'Link 5', '', '', 'Link 6', '', '', 'Link 7', '', '', 'Link 8', '', '', 'Donate to Isidro Spencer', 'http://www2.erepublik.com/' + LOCALE + 'citizen/donate/items/1493879', 'false', 'eRepublik Plus', 'http://www2.erepublik.com/' + LOCALE + 'newspaper/erepublik-plus-187657/1', 'false'];
...
//
//      0.55             7 Oct 2009             - Fixes: 
//                                                              1) Changed eRepublik server to http://www2.erepublik.com/*
//                                                              2) Changed eMexico's Forum to http://erepublik.com.mx
//
