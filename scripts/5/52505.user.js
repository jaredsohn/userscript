// ==UserScript==
// @name             Кнопки ресурсов х500 и х1000 (Ikariam x500, x1000 Payloads)
// @version	     4
// @author	     oliezekat / Darkbond (перевод на русский язык by Victor I hakergtr@yandex.ru)
// @namespace        x500-payloads.ikariam
// @description      Создает кнопки, которые позволяют побавлять по 500 и по 1000 ресурсов на рынке и в торговом порту
