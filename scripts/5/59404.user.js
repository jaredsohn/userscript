...
// @require        http://jquery-ui.googlecode.com/svn/tags/latest/ui/ui.slider.js
...
// @resource       uibase http://jquery-ui.googlecode.com/svn/tags/latest/themes/base/ui.base.css
// @resource       uitheme http://jquery-ui.googlecode.com/svn/tags/latest/themes/base/ui.theme.css
// ==/UserScript==

$(document).ready(function() {
	GM_addStyle(GM_getResourceText("css"));
	GM_addStyle(GM_getResourceText("uibase"));
	GM_addStyle(GM_getResourceText("uitheme"));
	...
	var float = function (){
		...
		var str = GM_getResourceText('html');
		$('body').append(str);
		...
		console.log(11);
		$('#icp_q3_txt_color').click(function(){
		console.log(33);
		console.log(iColorShow);
			iColorShow('q3_txt_color','icp_q3_txt_color');
		});
		...
		$('#q3_color_apply').click(function(){
			...
			console.log($('#q3_txt_color').val());
			console.log($('#q3_bg_color').val());
		});
		
		$("#q3_font_size_slider").slider(
			{
				max:60, 
				min:9, 
				step:1, 
				value:$('#q3_font_size').val(),
				change:function(event, ui){
					$('#q3_font_size').val(ui.value);
				}
			}
		);
		$('#q3_font_size').change(function(){
			$("#q3_font_size_slider").slider('value', $(this).val());
		});
		
		$("#q3_line_height_slider").slider(
			{
				max:200, 
				min:120, 
				step:5, 
				value:$('#q3_line_height').val(),
				change:function(event, ui){
					$('#q3_line_height').val(ui.value);
				}
			}
		);
		$('#q3_line_height').change(function(){
			$("#q3_line_height_slider").slider('value', $(this).val());
		});
		
		$("#q3_margin_width_slider").slider(
			{
				max:500, 
				min:0, 
				step:10, 
				value:$('#q3_margin_width').val(),
				change:function(event, ui){
					$('#q3_margin_width').val(ui.value);
				}
			}
		);
		$('#q3_margin_width').change(function(){
			$("#q3_margin_width_slider").slider('value', $(this).val());
		});
