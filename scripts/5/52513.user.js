// ==UserScript==
// @name           Русский-eRepublik mod by szeku
// @namespace      http://userscripts.org/users/97045
// @description    Русский перевод. Renszarv eredeti forráskódját Lopici Gaspar felturbózta, így már az AJAX-os szövegek is lefordíthatóakká váltak. A szövegeket via_mala (tolojeno) bővítgette ki.
...
"no active battles" : "нет активной войны",
"Buy extra storage" : "Покупка увеличенного склада",
"Buy wellness" : "Покупка здоровя",
"days" : "дни",
"months" : "месяцы",
"years" : "годы",
"online" : "в сети",
...
"Fights" : "Küzdelmek",
"See all donations" : "Посмотреть все переводы",
"Show all donations" : "Показать все переводы",
"Price with taxes" : "Цена с налогом",
"Show candidate list" : "Кандидаты",
"Show candidates list" : "Кндидаты",
"See candidate list" : "Показать всех кандидатов",
"No candidate proposed" : "Nincs javasolt jelölt",
"Candidate" : "Кандидат",
"candidates" : " Кандидаты",
"You haven't worked today." : "Сегодня ещё не работал",
"You have not worked today." : "Сегодня ещё не работал",
"Skill" : "Знание",
"Apply" : "Jelentkezés",
...
"Work" : "Работать",
"Back to company" : "Обратно к заводу",
...
"Train" : "Тренеровка",
"Training" : "Тренеровка",
"Train bonus" : "Бонус за тренеровки",
"Strength gained" : "Увеличение силы",
"Show my offers" : "Мои предложении",
"Post new offer" : "Новая предложения",
