// ==UserScript==
// @name           Nomads in toolbar
// @namespace       bamaplaya1
// @include         http://goallineblitz.com/game/*
// ==/UserScript==
function do_platypus_script() {
html_insert_it(window.document,document.getElementById('toolbar'),'<div id="toolbar"><a class="toolbar_item" href="http://goallineblitz.com/game/home.pl" style="" platypus-background-color="">Home</a><a class="toolbar_item" href="/game/leagues.pl">Leagues</a><a class="toolbar_item" href="/game/search.pl">Search</a><a class="toolbar_item" href="/game/market_free_agents.pl">Marketplace</a><a class="toolbar_item" href="/game/forum_main.pl">Forum</a><a class="toolbar_item" href="/game/inbox.pl">Inbox </a><a class="toolbar_item" href="/game/chat.pl">Chat</a><a class="toolbar_item" href="/game/flex_points.pl">Flex Points</a><a class="toolbar_item" href="/guides.html" style="display: none;">FAQ/Guides</a><a target="_new" class="toolbar_item" href="http://www.glbwiki.com" style="display: none;">Wiki</a><a target="_new" class="toolbar_item" href="http://www.blogtalkradio.com/GoalLine-Blitz-Radio" style="display: none;">GLB Radio</a><a class="toolbar_item" href="/game/support.pl">Support</a><a id="logout" class="toolbar_item" href="/game/logout.pl">Log Out</a><span><a platypus-background-color="" style="" class="toolbar_item" href="http://goallineblitz.com/game/team.pl?team_id=3446">Nomads</a></span><span><a platypus-background-color="" style="" class="toolbar_item" href="http://yukonnomads.chatango.com/">Nomads Chat</a></span><a href="http://goallineblitz.com/game/user_gm.pl" class="toolbar_item">GM Admin</a></div>',false,false);
