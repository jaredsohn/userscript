// ==UserScript==
// @name            Neuer pfandkurswarner by basti1012 alle games
  ...
  gewinn = '1';
   GM_setValue("gewinn" , gewinn);
	...
	GM_xmlhttpRequest(
	{
		...
		var bottel = text1.split('Pfandflaschen')[0];
...
var linkl = '<a class="tooltip"><font color="Black"><b> Kurs '+my_kurs+'</b><br><b>  Cent </b><br><b>('+menge+' &euro;)</b></font><span><small><br>'
	+'<font style=\"color:green; font-size:120%;\"><b>Im Inventar hast du genau</b></font><br>'
	 +'<font style=\"color:red; font-size:120%;\"><b>'+bottel+' Flaschen</b></font><br>'
	  +'<br><font style=\"color:blue; font-size:120%;\"><b>Beim sofortigen verkauf w&auml;hre das </b></font><br>'
	   +'<font style=\"color:red; font-size:120%;\"><b>'+menge+' Euro</b></font><br>'
	    +'<font style=\"color:green; font-size:120%;\"><b>Flaschen verkaufen?</b></font><br>'
	     +'<font style=\"color:green; font-size:120%;\"><b>Menge</b></font><input id="flaschenmenge" type="text" value="'+bottel+'" size="2"><br>'
	      +'<input type="button" id="verkauf" value="Flaschen Verkaufen"><br>'
	       //+'<font style=\"color:green; font-size:120%;\"><b>Sammeln gehen<br>(Dauer Auswahl ueber den capacha)</b></font><br>'
	        //+'<input type="button" id="sammeln" value="X-Minuten sammeln"><br>'
	         +'<font style=\"color:greeen; font-size:120%;\"><b><br>Letzte Aktion</b></font><br>'
	          +'<font style=\"color:red; font-size:120%;\"><b>'+GM_getValue("gewinn")+'</b></font><br>'
