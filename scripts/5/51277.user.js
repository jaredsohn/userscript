// ==UserScript==
// @name           Ikariam Aide-Memoire (Trade Score)
// @namespace      http://userscripts.org/scripts/show/51277
// @author         Martynius (http://userscripts.org/users/68307)
// @license        GNU GPL v3 (http://www.gnu.org/copyleft/gpl.html)
// @homepage       http://userscripts.org/scripts/show/51277
// @description    Shows the Trade score of a player in the island view afer you have looked it up in the highscores.
...
if ( PAGE_ID !== undefined ) {
	new IkariamAideMemoire( {
		...
		SCRIPT_NAME: "Ikariam Aide-Memoire (Trade Score)"
	});
}