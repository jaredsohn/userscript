// ==UserScript==
// @name           Last.fm - Highlight Same Artists - Fixed V2
// @namespace      
// @description    Highlights artists that you listen to on other users' profiles.
// @include        http://www.last.fm/user/*
// ==/UserScript==

var style = "font-weight: bold;";function xpath(query) {
...
//			var hasrecenttracks = xpath("//div[@id=\"recenttracks\"]").snapshotLength;
	      ...
	      if(isoverallpage == 1) {
 	      ...
 	      for (var j = 0; j < xmlArtists.length() && j < 50; j++) {	  // I've just added "&& j < 50" ;-)
