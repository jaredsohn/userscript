// ==UserScript==
// @name        cn-browse+
// @description Adds to browse
// @include     http*://cosanostra.mn/browse.php*
// @include     http*://www.cosanostra.mn/browse.php*
// ==/UserScript==

/* Script version: 2009-03-24 */
(function() {
	var link1 = document.createElement("a");
	var link2 = document.createElement("a");
	var link3 = document.createElement("a");
	link1.href = "browse.php?search1=TBH";
	link2.href = "browse.php?search1=[Staff.Pick]";
	link3.href = "browse.php?search=&blah=0&cat=0&incldead=2&sort=1&type=asc";
	var txt1 = document.createTextNode("The Black Hand (Internal Encodes)");
	var txt2 = document.createTextNode("Staff Picks (Freeleech)");
	var txt3 = document.createTextNode("Reseed (Keep Alive)");
	...
	var title_txt = document.createTextNode("Special Links:");
