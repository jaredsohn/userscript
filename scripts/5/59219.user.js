// ==UserScript==
// @name           IBM Lotus Connections Connections Menus
// @namespace      mrscripter.com/2009/09/greasemonkey-script-for-lotus-connections-dynamic-drop-down-menus/
// @include        *ibm.com/homepage*
// @include        *ibm.com/profiles*
// @include        *ibm.com/communities*
// @include        *ibm.com/blogs*
// @include        *ibm.com/dogear*
// @include        *ibm.com/files*
...
/*
* If you are configuring this script for your own Lotus Connections installation
* you will probably need to change the config_url variable to point to your base 
* URL. By default the Ajax calls use an absolute path /dogear/... for example but 
* your configuration might not be at ibm.com/dogear/... it might actually be at 
* ibm.com/connections/dogear/... so you'd set config_url="/connections";
*/
var config_url = "";  //No ending slash
//Examples:
//var config_url ="http://mysite.com/connections";
//var config_url ="/connections"; 
...
function reallyTruelyForRealsLoaded(){
  ...
  $("#lotusBannerHomepage")
      .append('<ul id="lotusBannerHomepageMenu" class="submenu"><li id="lotusBannerHomepageMenu_mypage"><a href="/homepage/web/widgets">My page<\/a><\/li><\/ul>')
      .hover(function(){$(this).find(".submenu").css("visibility","visible")},function(){$(this).find(".submenu").css("visibility","hidden")});
  
  $("#lotusBannerProfile")
      .append('<ul id="lotusBannerProfileMenu" class="submenu"><li id="lotusBannerProfileMenu_myprofile"><a href="/profiles/html/myProfileView.do">My profile<\/a><\/li><li id="lotusBannerProfileMenu_editprofile"><a href="/profiles/html/editMyProfileView.do">Edit my profile<\/a><\/li><\/ul>')
      .hover(function(){$(this).find(".submenu").css("visibility","visible")},function(){$(this).find(".submenu").css("visibility","hidden")})
  $("#lotusBannerCommunities")
      .append('<ul id="lotusBannerCommunitiesMenu" class="submenu"><li id="lotusBannerCommunitiesMenu_mycommunities"><a href="/communities/service/html/mycommunities">My communities</a><\/li><\/ul>')
      .hover(function(){$(this).find(".submenu").css("visibility","visible")},function(){$(this).find(".submenu").css("visibility","hidden")})
      //.hover(function(){$(this).find(".submenu").show(menuShowRate)},function(){$(this).find(".submenu").hide(menuHideRate)})
  
  $("#lotusBannerBlogs")
      .append('<ul id="lotusBannerBlogsMenu" class="submenu"><li id="lotusBannerBlogsMenu_myblogs"><a href="/blogs/roller-ui/myblogs/edit">My blogs<\/a><\/li><li id="lotusBannerBlogsMenu_myupdates"><a href="/blogs/roller-ui/myupdates">My updates<\/a><\/li><\/ul>')
      .hover(function(){$(this).find(".submenu").css("visibility","visible")},function(){$(this).find(".submenu").css("visibility","hidden")})
  
  $("#lotusBannerDogear")
      .append('<ul id="lotusBannerDogearMenu" class="submenu"><li id="lotusBannerDogearMenu_mybookmarks"><a href="/dogear/html/mybookmarks">My bookmarks<\/a><\/li><li id="lotusBannerDogearMenu_popularbookmarks"><a href="/dogear/html/popular">Popular bookmarks<\/a><\/li><li id="lotusBannerDogearMenu_updatesbookmarks"><a href="/dogear/html/inbox">My updates<\/a><\/li><\/ul>')
      .hover(function(){$(this).find(".submenu").css("visibility","visible")},function(){$(this).find(".submenu").css("visibility","hidden")})
  
  $("#lotusBannerActivities")
      .append('<ul id="lotusBannerActivitiesMenu" class="submenu"><li id="lotusBannerActivitiesMenu_myactivities"><a href="/activities/service/html/mainpage">My activities<\/a><\/li><li id="lotusBannerActivitiesMenu_todo"><a href="/activities/service/html/mainpage#todolist">To do list<\/a><\/li><li id="lotusBannerActivitiesMenu_templates"><a href="/activities/service/html/mainpage#dashboard,templates">Activity Templates<\/a><\/li><\/ul>')
      .hover(function(){$(this).find(".submenu").css("visibility","visible")},function(){$(this).find(".submenu").css("visibility","hidden")})
  
  $("#lotusBannerFiles")
      .append('<ul id="lotusBannerFilesMenu" class="submenu"><li id="lotusBannerFilesMenu_myfiles"><a href="/files">My files<\/a><\/li><li id="lotusBannerFilesMenu_collections"><a href="/files/app/collections">Collections<\/a><\/li><li id="lotusBannerFilesMenu_updates"><a href="/files/app/updates">Updates<\/a><\/li><li id="lotusBannerFilesMenu_shared"><a href="/files/app?#/shares?pivot=withme">Shared with me<\/a><\/li><li id="lotusBannerFilesMenu_myshared"><a href="/files/app?#/shares?pivot=byme">Shared by me<\/a><\/li><li id="lotusBannerFilesMenu_public"><a href="/files/app/public">Public files<\/a><\/li><\/ul>')
      .hover(function(){$(this).find(".submenu").css("visibility","visible")},function(){$(this).find(".submenu").css("visibility","hidden")})
  
  $("#lotusBannerWikis")
      .append('<ul id="lotusBannerWikiMenu" class="submenu"><li id="lotusBannerWikiMenu_mywikis"><a href="/wikis/home/mywikis">My wikis<\/a><\/li><\/ul>')
      .hover(function(){$(this).find(".submenu").css("visibility","visible")},function(){$(this).find(".submenu").css("visibility","hidden")})
...
var css = ""+
  ...
  "ul.submenu li,#communities-nav li .submenu li,.lotusui .lotusInlinelist li .submenu li  {display: block; float: none;} \n"+
...
if($("#communities-masthead").css('backgroundColor') == "rgb(0, 0, 0)"){  //external ibm.com/communities setting
css += ""+
  ...
  "";
}else if(!is_chrome && unsafeWindow.lconn_comm_global_currentTheme == "IBMDeepBlue"){
  css += ""+
...
$.get(config_url + "/communities/service/atom/communities/my?ps=50", function(data){
...
// /blogs/services/atom/  (service document)
// /blogs/home/api/blogs
$.get(config_url + "/blogs/home/api/blogs", function(data){
  var response = data.documentElement;
  if ($('entry',data.documentElement).length > 0){
...
// /activities/service/atom2/forms/activities
// Seems like the second one works better:
// /activities/service/atom2/activities
$.get(config_url + "/activities/service/atom2/activities", function(data){
  var response = data.documentElement;
  if ($('entry',data.documentElement).length > 0){
    ...
    $(".Myactivities").each(function(){
      ...
      if ($(this).attr('id') && $(this).attr('id') != ""){
        $.get(config_url + "/activities/service/atom2/descendants?nodeUuid=" + $(this).attr('id'), function(data){
          var response = data.documentElement;
          if ($('entry',data.documentElement).length > 0){
...
//My Files
$.get(config_url + "/files/form/api/myuserlibrary/feed", function(data){
  var response = data.documentElement;
  if ($('entry',data.documentElement).length > 0){
...
// /files/form/api/myshares/feed?page=1&direction=inbound&pageSize=25&sK=published&sO=dsc
// /files/basic/api/myshares/feed?direction=inbound
//Files shared with me
$.get(config_url + "/files/basic/api/myshares/feed?direction=inbound", function(data){
  var response = data.documentElement;
  if ($('entry',data.documentElement).length > 0){
...
// /files/basic/api/myshares/feed?direction=inbound
//Files shared by me
$.get(config_url + "/files/basic/api/myshares/feed?direction=outbound", function(data){
  var response = data.documentElement;
  if ($('entry',data.documentElement).length > 0){
...
// /wikis/form/api/mywikis/feed
$.get(config_url + "/wikis/form/api/mywikis/feed", function(data){
  var response = data.documentElement;
  if ($('entry',data.documentElement).length > 0){
...
// /dogear/api/app  (service document)
// /dogear/atom/mybookmarks
$.get(config_url + "/dogear/atom/mybookmarks", function(data){
  var response = data.documentElement;
  if ($('entry',data.documentElement).length > 0){
