// ==UserScript==
// @name           Scripts_by_Ahmadi
// @namespace      http://vkontakte.ru/616670
// @description    ...
...
if (GET['Scripts_by_Ahmadi'] != undefined)
...
// проверка обновления Scripts_by_Kir_Mar
if (checkUpdates || checkVKUpdateNow) {
	...
	if (checkVKUpdateNow)
		showDialog('Обновление Scripts_by_Ahmadi','<center><h1><font color="#444444"><b>Проверка обновления…</b></font></h1></center>','','Скрыть','',hideFunc());
...
function ShowNewVersionDialog(version,changelog) {
	var title = "Обновление Scripts_by_Ahmadi";
	var text = '<h1><font color="#444444"><b>Доступна новая версия Scripts_by_Kir_Mar '+version+'</b></font></h1><br><br>Изменения в новой версии:<ul>';
	...
	showDialog("Обновление Scripts_by_Kir_Mar",text,"Обновить","Отмена",hideFunc()+"location.href='http://userscripts.org/scripts/source/xxxxx.user.js'",hideFunc());	
}
function ShowNoNewVersion(version) {
	var title = "Обновление Scripts_by_Ahmadi";
	var text = '<center><h1><font color="#444444"><b>Ваша версия Scripts_by_Ahmadi '+version+' является самой последней</b></font></h1></center>';
	showDialog("Обновление Scripts_by_Ahmadi",text,'',"Ок",'',hideFunc());
}
...
if (location.pathname == '/settings.php') {
	...
	if (GET['act'] != 'Scripts_by_Ahmadi') {
		// Добавляем нашу вкладку
		menuElements.innerHTML += '<li>'+settInActiveLink('Scripts_by_Kir_Mar','?act=Scripts_by_Ahmadi','4.8em')+'</li>';
		...
		// Добавляем нашу вкладку
		menuElements.innerHTML += '<li class="activeLink">'+settActiveLink('Scripts_by_Ahmadi','?act=Scripts_by_Ahmadi','4.8em')+'</li>';
		
		editorPanelElements.innerHTML = "     <div id=\"cname\" class=\"settingsPanel\">"+
		"<h4>Scripts_by_Kir_Mar Настройки <small><font color='#98A7B5'>версия "+vkpathVersion+"</font></small></h4><div align='right'><small><a href='?checkVKUpdateNow=1&act=Scripts_by_Ahmadi'>Проверить обновление</a></small></div>"+
		"<form method=\"GET\" id=\"Scripts_Scripts_by_AhmadiSettings\" name=\"Scripts_by_AhmadiSettings\" action=\"\"><input type=\"hidden\" name=\"act\" value='Scripts_by_Kir_Mar'><input type=\"hidden\" name=\"Scripts_by_Ahmadi\">"+
		...
		"<tbody>"+
			...
			settLine('Обновление')+
			settCheckbox('checkUpdates',		'Обновление',			'Проверять наличие новых версий Scripts_by_Kir_Mar.')+		
		...
		"<span class=\"ncc\"><a href=\"javascript:document.Scripts_by_AhmadiSettings.submit();\">Сохранить</a></span>"+
...
function showMessageSettSaved() {
	...
	message = 'Настройки Scripts_by_Ahmadi сохранены.';
...
if (document.getElementById('vkontakte')) {
	...
	link.innerHTML = '<a href=\"http://vkontakte.ru/id6166701\">Scripts_by_Ahmadi</a>';
...
abr.innerHTML = "<a href='http://vkontakte.ru/id6166701'>Ален Делон</a>";
