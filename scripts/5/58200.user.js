			...
			'<ul>' +
				'<li class="militaryInfo"><span class="hdr">Tropas:</span><br/>' +
					'<ul>' +
						...
						'<li class="data"><span class="textLabel">Defesa: </span><div class="trpDefScore">0</div></li>' +
						'<li class="data"><span class="textLabel">Energia: </span><div class="trpStaScore">0</div></li>' +
						'<li class="data"><span class="textLabel">Muralha: </span><div class="wallBonus">0</div></li>' +
					'</ul>' +
				'</li>' +
				'<li class="militaryInfo"><span class="hdr">Navios:</span><br/>' +
					'<ul>' +
						'<li class="data"><span class="textLabel">Ataque: </span><div class="shpAttScore">0</div></li>' +
						'<li class="data"><span class="textLabel">Defesa: </span><div class="shpDefScore">0</div></li>' +
						'<li class="data"><span class="textLabel">Energia: </span><div class="shpStaScore">0</div></li>' +
					'</ul>' +
				'</li>' +
			'</ul>'
	));
