...
// @include http://de*.die-staemme.de/game.php?village=*&screen=report&mode=all&view=*
// ==/UserScript==
function leftover(tableid) {
 ...
 new_td.setAttribute("style", "text-align:center;border-top:1px solid black;");
 ...
 if (left == 0) {
 new_td.setAttribute("class", "hidden");
 percentage = 0;
 }
 else {
