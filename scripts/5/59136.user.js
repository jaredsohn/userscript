...
// @name           Jedna Sekunda
// @namespace      Olo
// @description    Zďż˝hlt die Ankunftszeit weiter
// @include        http://pl*.plemiona.pl/*screen=place&try=confirm*
// ==/UserScript==
...
function timeFormated(now,then) {
	...
	if (now.getDate()   == then.getDate() && now.getMonth()   == then.getMonth())	dd = 'Przybedzie';
...
function callArrivalDate() {
	...
	sTime.setHours(parseInt(field[0]));
