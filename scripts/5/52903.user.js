// ==UserScript==
// @name           Modified Minimal Google Reader
// @namespace      http://userscripts.org/users/97372
// @include        http*://www.google.com/reader/view/*
// @description    A modified version of Minimal Google Reader that changes the size of the font and shortens the size of the sidebar. All credit to the original author.
// ==/UserScript==
...
function alter() {
	...
	newStyle += "#nav {font-size:80%;width:180px;}";	//edited
	newStyle += "#sub-tree {width:175px;}";			//edited
	newStyle += "#chrome{margin-left:180px;}"; 		//edited
	...
	newStyle += "div.item-body{font-size: 105%;}";
	newStyle += "#entries-status{top:0;}";
	newStyle += "#entries .entry{font-size:90%;padding:0;}";
