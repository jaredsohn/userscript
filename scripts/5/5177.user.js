...
s+= "body {background:url(http://www.suomenkivivalmiste.fi/Kivimateriaalit%20iso/Korpi-black%20hiottu.jpg) #800303 fixed;margin-top:-50px;}\n";
...
s+= document.getElementById('splash_coolNewPeople').innerHTML = '<embed src= "http://www.fileden.com/files/28945/xspf_blkred.swf?playlist_url=http://www.fileden.com/files/28945/mp3playlist.xml&autoplay=true&info_button_text=Bands website" bgcolor="red" quality="high" name="xspf_player" type="application/x-shockwave-flash" pluginspage="http://www.macromedia.com/go/getflashplayer" height="70" width="225"></embed>';"a[id*='ns1_HyperLink2']{display:block;margin:0!important;margin-top:10px!important;text-align:center;font-size:12px!important;}\n";
s+= "#home_infoBar {position:absolute; right:-7px;;}\n";
s+= "#home_infoBar {width:63%;height:163px;margin:0;}\n";
