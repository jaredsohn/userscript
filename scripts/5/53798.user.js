...
// @name	نیرو های سپاه جاویدان
// @description	بروز رسان نیروهای شما در سرور 2 ایران
// @include     http://s2.travian.ir/*
// ==/UserScript==

var LOG_LEVEL = 1; // 0 - quiet, 1 - nearly quite, 2 - verbose, 3 - detailed
var sLang = "gr";
var sGetParameters = "";
var sCurrentServer = "s2.travian.ir";    
var sAuthKey;
...
switch(sLang) {
        ...
        case "ir":
                aLangStrings = ["لشگریان خودی", "برگشت از", "نیروی کمکی به", "نیروی کمکی از", "حمله", "غارت", "جاسوسی", "Preskumat opustene udolie", "اسیر شده در", "بروزرسانی اقدام شد ولی نتیجه مشخصی دریافت نشد ", "نیرو های شما با موفقیت بروزرسانی شدند.", "بروز رسانی موفق نبود!", "نصب Troop Tool", "بروزرسانی نیروها", "بروزرسان :", "Enter the authentication key from your Troop tool profile"];
                break;
	case "uk":
	default:
