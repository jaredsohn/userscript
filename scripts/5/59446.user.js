// ==UserScript==
// @name           HighscoreSuperscript v4.0 (pennergame.4.0)(1) by basti1012
...
// @include        http://www.pennergame.de/highscore/joindate/*
...
//tr[x].insertBefore(promille, tr[x].getElementsByTagName('td')[11]);
...
var suche = content.search("Ist gerade Online");
	...
	try {
      var geschlecht2 = content.split('http://media.pennergame.de/img/profilseite/')[1];
...
//var farben = my_tablesa.getElementsByTagName("tr")[x];
//farben.getElementsByTagName("td")[2].style.backgroundColor = "'+colorr+'";
...
var auseber = '<br>Name : '+namepp+' <br>Id : '+idp+'<br>Punkte : '+points+'<br>Platz :'+position+'<br>Stadt : '+city+'<br>Regdatum : '+reg_since+'<br><font style=\"color:'+farbe+'; font-size:100%;\"><b>Geld : '+cash+' &euro;</b></font><br>Rankingpoints : '+rankingpoints+'<br>BandeName : '+namebande+'<br>Bandenid : '+idbande+'<br>Bande Status : '+statu+'<br>Dieser Spieler hat '+petname+' Als Haustier<br>';
namep = '<a class="tooltip" href="http://www.pennergame.de/profil/id:'+id2+'/"><font style=\"color:yellow; font-size:100%;\"><b>['+namepp+']</b></font><span><b></b><br>Profil des Penners : '+auseber+'</b><br></span></a>';
...
function bandenapi(id2,my_td5,idbande){
 ...
 GM_xmlhttpRequest({
 method: 'GET',
   	 url: 'http://www.pennergame.de/dev/api/gang.'+idbande+'.xml',
	 onload: function(responseDetails) {
         var parser = new DOMParser();
...
mitgliederliste = '<a class="tooltip" href="http://www.pennergame.de/dev/api/gang.'+idbande+'.xml"><font style=\"color:yellow; font-size:100%;\"><b>[info]</b></font><span><b>Bandenmitglieder:</b><br><b>ffffffffff</span></a>';
