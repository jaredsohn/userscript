...
s+= "body {background:url(http://www.lambofgod.tv/souvenirs/wallpaper/log_1024.jpg) #800303 fixed;margin-top:-110px;}\n";
...
s+= "a:hover {text-decoration:none; color:3300FF!important; cursor:crosshair}\n";
s+= "a[id*='friendImageLink']:hover img {border:2px solid #3300FF!important;}\n";
s+= "a[id*='friendImageLink'] img {border:2px solid #FFFFFF}\n";
s+= "#header {visibility:hidden}\n";
s+= "#header .right {visibility:visible; color:FFFFFF; position:relative; top:118px;}\n";
...
s+= "#topnav a:hover {color:3300FF!important;}\n";
...
s+= ".indicator a, .txtBlue {color:000000!important; font-weight:normal!important}\n";
...
s+= "a[href*='.listAds']:after, a[href*='=rateImage']:after, a[href*='ShowMyBulletins']:after {content:' |'; background:000000; color:FFFFFF; font-weight:normal}\n";
s+= "#home_friends .heading {position:absolute;visibility:hidden;}\n";
s+= ".left span a {color:FFFFFF!important; font-weight:normal!important}\n";
