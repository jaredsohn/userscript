...
// @namespace      (:
// @description    Added on 20oct2009
...
var fakeText = (document.body.innerHTML.indexOf("Select a Treasure! NEEDS REPAIR!") != -1); //check if a fake Captcha or Repair detected
...
if(timervalue > 0 && (safeToFish || ignoreSafety || fakeText))
{
...
else if(treasureChest && !fakeText)
{
...
if(!safeToFish && !ignoreSafety && !fakeText)
{
   document.body.innerHTML = document.body.innerHTML + "
It was determined to be possibly unsafe to fish.
