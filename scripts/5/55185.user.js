// ==UserScript==
// @name           Shorten Amazon Product Links (internationally)
// @namespace      http://userscripts.org/users/callum
...
// ...but adjusted so it doesn't change the domain name, so it works on other Amazon sites
