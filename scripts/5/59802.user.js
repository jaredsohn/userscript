// ==UserScript==
// @name           GLB HomePageRewrite Season 12+
// @namespace      GLB
...
// @include        http://goallineblitz.com/game/boost_player.pl
...
$(document).ready(function(){
    ...
    function getBoosts(){
        ...
        script.text = "function GotoBoosts(playerid){document.cookie='boostid=' + playerid + '; expires=15/02/2010 00:00:00';window.location.href='http://goallineblitz.com/game/boost_player.pl';}";
        document.body.appendChild(script);
        
        $.get("http://goallineblitz.com/game/multi_boost_player.pl",function(returned_data){
            var boosttotal = 0;
                ...
                if ($('select',$(this)).size()>0) {
                    ...
                    for (var z=0;z<playersinfo.length;z++) {
                        if (('/game/player.pl?player_id=' + playersinfo[z][0]) == playerlink) {
                            ...
                            strholding = '<a href="http://goallineblitz.com/game/boost_player.pl?player_id=' + playersinfo[z][0] + '">Boost(' + boostsavail + ') Cost:' + boostcost + '</a>';
    ...
    function getTeamSpreads(){
        ...
        for (var q=0;q<pulllinks.length;q++) {
            ...
            overall2 = '';
            var myteamid ='';
            $.get("http://goallineblitz.com" + pulllinks[q],function(returned_data){
    ...
    function getPlayersInfo(){
        ...
        for (var c=0;c<playersinfo.length;c++) {
            $.get("http://goallineblitz.com/game/player.pl?player_id=" + playersinfo[c][0],function(returned_data){
                ...
                for (var te = 0; te < playersinfo.length;te++) {
                    if (parseInt(curplayerid) == parseInt(playersinfo[te][0])) {
                        ...
                        if (settingsarray[10]=='1') {
                            if (isNaN(parseInt(playervetpts))==false) {
                                ...
                                if (settingsarray[11]=='1') {
                                    playersinfo[te][7] =  pre1+ '<tr><td width="5%"><b>Vet Pts:</b></td><td align="left"><a href="http://goallineblitz.com/game/vet_skills.pl?player_id='+playersinfo[te][0]+'">'+playervetpts+'</a></td><td width="5%"><b>Age:</b></td><td align="left">'+playerage+' Days</td></tr>' + post1;
                                }else{
                                    playersinfo[te][7] = pre1+ '<tr><td width="5%"><b>Vet Pts:</b></td><td colspan=3 align="left"><a href="http://goallineblitz.com/game/vet_skills.pl?player_id='+playersinfo[te][0]+'">'+playervetpts+'</a></td></tr>' + post1;
                                }
                            }else{
                                var pre1 = playersinfo[te][7].substring(0,playersinfo[te][7].indexOf('</table>'));
                                var post1 = playersinfo[te][7].substring(playersinfo[te][7].indexOf('</table>'));
                        ...
                        if (settingsarray[12]=='1'){
                            ...
                            if (settingsarray[9]=='1') {
                                playersinfo[te][7] = playersinfo[te][7].substring(0,playersinfo[te][7].indexOf('</table>')) + '<tr><td width="5%"><b>Bonus:</b></td><td colspan=3 align="left"><a href="http://goallineblitz.com/game/bonus_tokens.pl?player_id='+playersinfo[te][0] + '">' + bonustokens + '</a></td></tr>' + playersinfo[te][7].substring(playersinfo[te][7].indexOf('</table>'));
                            }
                        }
    ...
    function getTeamColors(){
        ...
        $('div[class="team"]').each(function(fr){
            ...
            teamcolors[fr][2] = teamcolors[fr][2].replace('../','http://goallineblitz.com/')
        ...
        if (missingteams>0) {
            for (var te=0;te<teamcolors.length;te++) {
                if (teamcolors[te][1]=='') {
                    $.get("http://goallineblitz.com/game/team.pl?team_id="+teamcolors[te][0],function(data){
    ...
    if (window.location.href=="http://goallineblitz.com/game/boost_player.pl") {
    ...
    //if homepage
        ...
        $('div[class*="player_box_vet"]').each(function(e){
            ...
            if (settingsarray[12]=='1') {
                ...
                playersinfo[e][7] = pre + '<tr><td colspan="4"><a href="http://goallineblitz.com/game/equipment.pl?player_id=' + playersinfo[e][0] + '">EQ</a> | <a href="http://goallineblitz.com/game/player_tactics.pl?player_id=' + playersinfo[e][0] + '">Tactics</a> | <a href="http://goallineblitz.com/game/forum_thread_list.pl?team_id=' + playersinfo[e][17] + '">Forum</a> | <a href="http://goallineblitz.com/game/depth_chart.pl?team_id='+playersinfo[e][17]+'">DC</a> | <a href="http://goallineblitz.com/game/team_player_stats.pl?team_id='+playersinfo[e][17]+'">Leaders</a> | <a href="http://goallineblitz.com/game/training.pl?player_id='+playersinfo[e][0]+'">Train('+playersinfo[e][10]+')</a> | <a href="http://goallineblitz.com/game/bonus_tokens.pl?player_id='+playersinfo[e][0]+'">Bonus</a> | <a href="http://goallineblitz.com/game/adv_equipment.pl?player_id=' + playersinfo[e][0] + '">Shop</a></td></tr>' + post;
