// ==UserScript==
// @name           Ikariam TitleAlly
// @autor          Oberon
// @email          damn_it@tiscali.it
// @namespace      Ikariam
// @description    This script changes the title of circular messages to the first line of the message itself (if its lenght is < 40 chars)
