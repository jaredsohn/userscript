// ==UserScript==
// @name           Neobux 2+ (testing version)
// @namespace      Made by uriburu626 and translated by kumetys. Statistical enhancement by oselamet.
...
var updtlinkTR = "http://userscripts.org/scripts/source/49340.user.js";
var updtlinkEN = "http://userscripts.org/scripts/source/53344.user.js";
...
var avgIndex = 0;
	...
	for(var i=1; i<rows.length; i++) {
		...
		if(rows[i].childNodes.length < 7) {
			if(rows[i].childNodes.length==1 && rows[i].childNodes[0].innerHTML=='&nbsp;'){
				...
				rows[i].childNodes[0].innerHTML = "<font style='font-size:10px;color:#FFFFFF;font-weight:bold;'>&nbsp;|&nbsp;&nbsp; "+lang_totalClicks+" : "+clickSum+
				"&nbsp;&nbsp;|&nbsp;&nbsp; "+lang_totalClickAvg+" : "+formatDec((grandAVG/refCount),3)+
				"&nbsp;| &nbsp;"+lang_clickedToday+" : " + todayClickers+
	...
	if(!self){
		...
		formatDec(((netRentedIncome-(-directIncome))+""),3)+" &nbsp;(15) &nbsp;$"+
		formatDec(((netRentedIncome15-(-directIncome15))+""),3)+" &nbsp;(5) &nbsp;$"+
		...
		for(var i = 0;i< allTRs.length;i++){
			if(allTRs[i].childNodes[0].getAttribute("class") =="cx-3 cx-tg1 cxw"){
				...
				infoLabel.innerHTML = "<font style='font-size:10px;color:#444444'><b>&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;"+lang_statsSum+"</b><br/>"+
				...
				statsXML="&lt;neostats&gt;\n"+
				"&lt;datetime&gt;"+Today.getTime()+"&lt;/datetime&gt;\n"+
				"&lt;today&gt;\n"+
				"&lt;clicks&gt;\n"+
				"&lt;rented&gt;"+rentedClicksTday+"&lt;/rented&gt;\n"+
				"&lt;direct&gt;"+directClicksTday+"&lt;/direct&gt;\n"+
				"&lt;avg&gt;"+((rentedClicksTday-(-directClicksTday))/getRefCount())+"&lt;/avg&gt;\n"+
				"&lt;realavg&gt;"+((rentedClicksTday-(-directClicksTday)-(recycleCostTday*100))/getRefCount())+"&lt;/realavg&gt;\n"+
				"&lt;/clicks&gt;\n"+
				"&lt;expenses&gt;\n"+
				"&lt;recycle&gt;"+recycleCostTday+"&lt;/recycle&gt;\n"+
				"&lt;autopay&gt;"+autoPayCostTday+"&lt;/autopay&gt;\n"+
				"&lt;renew&gt;"+renewCostTday+"&lt;/renew&gt;\n"+
				"&lt;/expenses&gt;\n"+
				"&lt;/today&gt;\n"+
				"&lt;yesterday&gt;\n"+
				"&lt;clicks&gt;\n"+
				"&lt;rented&gt;"+rentedClicksYday+"&lt;/rented&gt;\n"+
				"&lt;direct&gt;"+directClicksYday+"&lt;/direct&gt;\n"+
				"&lt;avg&gt;"+((rentedClicksYday-(-directClicksYday))/getRefCount())+"&lt;/avg&gt;\n"+
				"&lt;realavg&gt;"+((rentedClicksYday-(-directClicksYday)-(recycleCostYday*100))/getRefCount())+"&lt;/realavg&gt;\n"+
				"&lt;/clicks&gt;\n"+
				"&lt;expenses&gt;\n"+
				"&lt;recycle&gt;"+recycleCostYday+"&lt;/recycle&gt;\n"+
				"&lt;autopay&gt;"+autoPayCostYday+"&lt;/autopay&gt;\n"+
				"&lt;renew&gt;"+renewCostYday+"&lt;/renew&gt;\n"+
				"&lt;/expenses&gt;\n"+
				"&lt;/yesterday&gt;\n"+
				"&lt;/neostats&gt;";
...
function addDonation(master){
	var donMsg = "Neobux 2+ için Bağış Yapın";
...
function showAvgStats(embed,index){
	...
	if(docRoot.tagName == "data"){
		...
		if(index <2){
			avgLabel.innerHTML = "&nbsp;"+lang_avgs+" :&nbsp; (15) &nbsp;" + formatDec((setSum / 15),3)+"  &nbsp;(15) &nbsp;"+formatDec((setSum10days / 15),3)+"  &nbsp;(5) &nbsp;"+formatDec((setSum5days / 5),3)+"&nbsp;";
		...
		if(!self){
			if(index < 2){
				...
				earnStr = " &nbsp;"+lang_dailyAvgIncome+" : (15) $" + formatDec(((setSum / 15)*refClickMultiplier),3)+
				...
				if(index==0){					//direct
					...
					directIncome = (setSum / 10)*refClickMultiplier;
					...
					rentedIncome = (setSum / 10)*refClickMultiplier;
				...
				if(index<5){
					earnStr = " &nbsp;"+lang_dailyAvgExpenses+" : (10) $" + + formatDec((setSum / 10),3)+
					...
					if(index ==5 ){
						...
						earnStr = " &nbsp;"+lang_dailyAvgTransfers+" : (10) $" + + formatDec((setSum / 10),3)+
						" &nbsp;(10) &nbsp;$"+formatDec((setSum10days / 10),3)+
						" &nbsp;(5) &nbsp;$"+formatDec((setSum5days / 5),3);
					}
					else if(index==6){
			...
			earnStr = " &nbsp;"+lang_dailyAvgEarnings+"  : (10) $" + formatDec(((setSum / 10)*selfClickMultiplier),3)+
