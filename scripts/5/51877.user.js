...
// @name		Travian: Resource++ v3 Ø§Ù„Ù…ÙˆØ§Ø±Ø¯ Ø¨Ø§Ù„Ø¹Ø±Ø¨ÙŠ - ØªØ±ÙÙŠØ§Ù† 
// @namespace	http://userscripts.org/
// @description	Travian resource summary, overflow of resources and timer, and resource per build item. Rewrite of original with HTML DOM methods instead of innerHTML. Thanks to everyone who sent translations. Works in Opera.
...
function onLoad(){ // runs the differnt functions and procedures, 
	...
	switch(lang){//load only the lang you need into memory
		case '.se':
		langfile[lang]=['BehÃ¶ver fÃ¶r uppgradering:','Ã¶verfullt om','fÃ¶rbruka om','Resurs Meters','Resurs Bars', 
		' ','TillrÃ¤ckligt med rÃ¥varor idag klockan ',"TillrÃ¤ckligt med rÃ¥varor imorgon klockan ",  "TillrÃ¤ckligt med rÃ¥varor om ",
		" dagar, kl " , " Efter max vÃ¤ntan: ",  "Ã–verskott: ","VÃ¤nta: ","Saknar","Klar"," VÃ¤nta: " ,"Blanserad",
		"FÃ¶rbruka Ã¶verskott om: ","Uppgradera ", " resurs produktion.","Neutral balans.", "Bygg ut magasin", "Bygg ut silo"];
		break;    
		case '.uk':
...
case '.ae':
		langfile[lang]=['Ø§Ù„Ù…Ù€Ø·Ù„ÙˆØ¨ Ù„Ù„Ø¥Ø±ØªÙ€Ù‚Ø§Ø¡','Ø³Ù€ÙŠÙ€ÙÙŠÙ€Ø¶ Ø¨Ø¹Ø¯', 'ÙŠÙ€Ø³ØªÙ€Ù†Ù€ÙÙ€Ø°','Ù…Ù‚ÙŠÙ€Ù€Ø§Ø³ Ø§Ù„Ù…Ù€Ù€ÙˆØ§Ø±Ø¯','Ù…Ù€Ù‚ÙŠÙ€Ø§Ø³ Ø§Ù„Ù…Ù€ÙˆØ§Ø±Ø¯ Ø¨Ø§Ù„Ù†Ù€ÙØ³Ù€Ø¨', 
		' Ø³Ù€Ù€Ø§Ø¹Ø©' ,'ØªÙƒØªÙ€Ù€Ù…Ø§Ù„ Ø§Ù„Ù…Ù€ÙˆØ§Ø±Ø¯ Ø§Ù„ÙŠÙ€Ù€ÙˆÙ… ÙÙŠ ',"Ø³Ù€ØªÙ€ÙƒØªÙ€Ù€Ù…Ø§Ù„ Ø§Ù„Ù…Ù€ÙˆØ§Ø±Ø¯ ØºÙ€Ø¯Ø§Ù‹ ÙÙŠ ", "Ø§ÙƒØªÙ€Ù…Ø§Ù„ Ø§Ù„Ù…Ù€ÙˆØ§Ø±Ø¯ ÙÙŠ ", 
		" Ø£ÙŠÙ€Ø§Ù… ÙÙŠ " , " Ø¨Ù€Ø¹Ø¯ Ø§Ù‚ØµÙ‰ Ù…Ù€Ø¯Ø© : " , "Ø§Ù„Ù…Ø®Ù€Ø²ÙˆÙ† : ","Ù…Ù€Ø¯Ø© Ø§Ù„Ø¥Ù†Ù€ØªÙ€Ø¸Ø§Ø± ","Ù„Ø¯ÙŠÙ€Ùƒ Ø¹Ù€Ø¬Ù€Ø² Ø¨Ù€Ù…Ù‚Ù€Ø¯Ø§Ø± " ,"Ø§Ù„Ù€Ø¨Ù€Ø§Ù‚Ù€ÙŠ Ø¨Ø¹Ø¯ Ø§Ù„Ø¥Ø±ØªÙ€Ù‚Ù€Ø§Ø¡"," Ø£Ù‚ØµÙ€Ù‰ Ù…Ù€Ø¯Ø© ","Ù„Ù† ÙŠÙ€Ø¨Ù€Ù‚Ù‰ ÙÙŠ Ø§Ù„Ù…Ø®Ù€Ø²Ù† Ø´Ù€ÙŠÙ€Ø¦",
		"ØªÙ€Ù‚Ù€Ù„Ù€Øµ Ø§Ù„Ù€ÙØ§Ø¦Ù€Ø¶ : ","Ø¥Ø±ØªÙ€Ù‚Ø§Ø¡ "," Ø¥Ù†Ù€ØªÙ€Ø§Ø¬ Ø§Ù„Ù…Ù€Ù€ÙˆØ§Ø±Ø¯" ," Ù…Ø­Ø§ÙŠØ¯ ", "ØªÙ€ÙˆØ³Ù€ÙŠÙ€Ø¹ Ù…Ù€Ø®Ø§Ø²Ù† Ø§Ù„Ø³Ù„Ù€Ø¹" , "ØªÙ€ÙˆØ³Ù€ÙŠÙ€Ø¹ Ù…Ù€Ø®Ø§Ø²Ù† Ø§Ù„Ø­Ø¨Ù€ÙˆØ¨"];		
		break;
		...
		break;
		case '.hu':
		langfile[lang]=[ 'FejlesztÃ©shez kell:', 'betelik', 'betelt', 'Nyersanyagok' , 'Nyersanyagok',
		' Ã³rakor' ,'ElÃ©g nyersanyag ma ',"ElÃ©g nyersanyag holnap ", "ElÃ©g nyersanyag ",
		" nap mÃºlva " , " Max vÃ¡rakozÃ¡s utÃ¡n: " , "KÃ©szleten: ","VÃ¡rj: ","HiÃ¡ny" ,"TÃ¶bblet"," Max vÃ¡rakozÃ¡s: ","KiegyensÃºlyozott",
		"A tÃ¶bblet elfogy: ","FejlesztÃ©s "," nyersanyag termelÃ©s.","Semleges egyensÃºly.", "Fejlesztd hozzÃ¡ a raktÃ¡rat!" , "Fejlesztd hozzÃ¡ a magtÃ¡rat!"    ];
		break;
		case '.de':
		langfile[lang]=['FÃ¼r Ausbau benoetigt:','ÃœberschuÃŸ', 'ErschÃ¶pft','Resourcenmeter','Resourcenbalken', 
		' Uhr','Genug Resourcen heute um ',"Genug Resourcen morgen um  ", "Genug Resourcen in ", 
		" Tagen um ", " Nach maximaler Wartezeit: " , "Vorrat: ","Wartezeit: ","Defizit","ÃœberschuÃŸ", " Maximale Wartezeit: ","Ausgeglichen",   
		"ÃœberschuÃŸ aufgebraucht in: ","Ausbau "," Resourcenproduktion.","Neutrale Bilanz." , "Rohstofflager erweitern" , "Kornspeicher erweitern" ];
		break
		case '.sk':
		langfile[lang]=['Stavba vyÅ¾aduje:','preteÄie', 'vyÄerpanÃ©','MeraÄ surovÃ­n','Ukazatele zÃ¡sob', 
		' hod','Dostatok surovÃ­n dnes o ',"Dostatok surovÃ­n zajtra o ", "Dostatok surovÃ­n za ", 
		" dnÃ­ o ", " Po max. ÄakanÃ­: " , "Sklad: ","ÄŒakacia doba: ","ChÃ½ba nÃ¡m","Prebytok", " Max. doba Äakania: ","VyvÃ¡Å¾enÃ©",
		"Prebytok vyÄerpanÃ½ za: ","VylepÅ¡i "," produkciu surovÃ­n.","VyvÃ¡Å¾enosÅ¥." , "RozÅ¡Ã­r sklad" , "RozÅ¡Ã­r sÃ½pku"];		
		break;
		case '.cz':
		langfile[lang]=['Stavba vyÅ¾aduje:','pÅ™eteÄe', 'vyÄerpÃ¡no','MeriÄ surovin','Ukazatele zÃ¡sob',
		' hod','Dostatek surovin dnes v ',"Dostatek surovin zÃ­tra v ", "Dostatek surovin za ",
		" dny v ", " Po max. vyÄkÃ¡vanÃ­: " , "Sklad: ","ÄŒekacÃ­ doba: ","ChybÃ­ nÃ¡m","PÅ™ebytek", " Max. vyÄkÃ¡vanÃ­: ","VyvÃ¡Å¾enÃ©",
		"PÅ™ebytek vyÄerpanÃ½ za: ","VylepÅ¡i "," produkci surovÃ­n.","VyvÃ¡Å¾enost."
		, "VylepÅ¡i sklad" , "VylepÅ¡i sÃ½pku"];
		break;
		case '.bg':
       langfile[lang]=['ÐÑƒÐ¶Ð½Ð¸ Ð·Ð° upgrade:','Ð·Ð°Ð¿ÑŠÐ»Ð²Ð°Ð½Ðµ', 'Ð¸Ð·Ñ‡ÐµÑ€Ð¿Ð²Ð°Ð½Ðµ','Resource Meters','Ð“Ñ€Ð°Ñ„Ð¸ÐºÐ¸ Ð½Ð° Ñ€ÐµÑÑƒÑ€ÑÐ¸Ñ‚Ðµ',
       ' Ñ‡Ð°ÑÐ°','Ð”Ð¾ÑÑ‚Ð°Ñ‚ÑŠÑ‡Ð½Ð¾ Ñ€ÐµÑÑƒÑ€ÑÐ¸ Ð´Ð½ÐµÑ Ð² ',"Ð”Ð¾ÑÑ‚Ð°Ñ‚ÑŠÑ‡Ð½Ð¾ Ñ€ÐµÑÑƒÑ€ÑÐ¸ ÑƒÑ‚Ñ€Ðµ Ð²", "Ð”Ð¾ÑÑ‚Ð°Ñ‚ÑŠÑ‡Ð½Ð¾ Ñ€ÐµÑÑƒÑ€ÑÐ¸ Ð² ", " Ð´Ð½Ð¸ Ð² ", " Ð¡Ð»ÐµÐ´ Ð¼Ð°ÐºÑÐ¸Ð¼Ð°Ð»Ð½Ð¾ Ð¸Ð·Ð°ÐºÐ²Ð°Ð½Ðµ: " , 
	   "Ð¡ÐºÐ»Ð°Ð´: ","Ð’Ñ€ÐµÐ¼Ðµ Ð·Ð°Ð¸Ð·Ñ‡Ð°ÐºÐ²Ð°Ð½Ðµ: ","ÐÐµÐ´Ð¾ÑÑ‚Ð¸Ð³","Ð˜Ð·Ð»Ð¸ÑˆÑŠÐº", " ÐœÐ°ÐºÑÐ¸Ð¼Ð°Ð»Ð½Ð¾ Ð¸Ð·Ñ‡Ð°ÐºÐ²Ð°Ð½Ðµ: ","Ð‘Ð°Ð»Ð°Ð½ÑÐ¸Ñ€Ð°Ð½Ð¾", "Ð˜Ð·Ñ‡ÐµÑ€Ð¿Ð²Ð°Ð½Ðµ Ð½Ð° Ð¸Ð·Ð»Ð¸ÑˆÑŠÐºÐ° ÑÐ»ÐµÐ´: ","Upgrade ",
	   " Ð”Ð¾Ð±Ð¸Ð² Ð½Ð°Ñ€ÐµÑÑƒÑ€ÑÐ¸.","Neutral balance." , "Ð Ð°Ð·ÑˆÐ¸Ñ€ÐµÑ‚Ðµ ÑÐºÐ»Ð°Ð´Ð°" , "Ð Ð°Ð·ÑˆÐ¸Ñ€ÐµÑ‚Ðµ Ñ…Ð°Ð¼Ð±Ð°Ñ€Ð°"];
       break;
		default:
		langfile[lang]=['Needed for upgrading:','Overflow', 'Depleted','Resource Meters','Resource Bars', 
		' Clock' ,'Enough resources today at ',"Enough resources tomorrow at ", "Enough resources in ", 
