// ==UserScript==
// @name           eBR Ordens de Batalha (eRep)
// @namespace      www.erepublik.com
// @description    eBR ORDENS DE BATALHA
// @version        0.1
// @include        http://www.erepublik.com/en
// @include        http://www.erepublik.com/es
// @Modifyed by	   eGo loLO (http://www.erepublik.com/en/citizen/profile/1672761)
// ==/UserScript==

GM_xmlhttpRequest({
	method: 'GET',
	url: 'http://erepublikbrasil.com/forum/index.php?topic=909.0',
	...
	onload:function(response){
			...
			updated_el.textContent ='Última atualização: ' + date_issued;
