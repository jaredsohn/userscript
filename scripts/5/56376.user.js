...
function makePrint(){
    ...
    dochtml+= '<i>Physical</i> Str:' + playerinfo[13] +', Spd:' + playerinfo[15] +', Agi:' + playerinfo[17] +', Jmp:' + playerinfo[19] +', Sta:' + playerinfo[21] +', Vis:' + playerinfo[23] +', Con:' + playerinfo[25] +'<br>';
    dochtml+= '<i>Football</i> Blk:' + playerinfo[14] +', Tak:' + playerinfo[16] +', Thr:' + playerinfo[18] +', Cat:' + playerinfo[20] +', Car:' + playerinfo[22] +', Kck:' + playerinfo[24] +', Pun:' + playerinfo[26] +'<br><br>';
