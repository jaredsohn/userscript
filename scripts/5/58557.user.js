...
var Einsatzklassen = {
  ...
  'Chemieunfall (an Schule)'       : 'GSG_Chemieunfall',
  'Chlorgas Alarm (Schwimmbad)'    : 'GSG_Chlorgas',
  ...
  'Feldbrand'                      : 'Feu_Feld',
  'Gewerbebrand'                   : 'Feu_Gewerbe',
  'Brand im Baumarkt'              : 'Feu_Baumarkt',
};
...
var Einsatzklasse_Fahrzeugzuordnung = {
  ...
  'TH_Auffahrunfall'            :  'LF,RW,GW-Öl',
  'TH_BaumAuto'                 :  'LF,RW,GW-Öl',
  'TH_BaumDach'                 :  'LF,RW,DL',
  'TH_BaumStraße'               :  'LF',
  'Feu_KFZ-Werkstatt'           :  'LF,LF,TLF,ELW',
  'Feu_Schule'                  :  'LF,LF,TLF,DL,ELW,GW-A',
  'Feu_Spedition'               :  'LF,LF,LF,ELW,TLF,DL,GW-W,RW,GW-M,GW-G,GW-A',
  'Feu_Baum'                    :  'LF/TLF,DL',
  ...
  'Feu_PKW'                     :  'LF/TLF,GW-Öl',
  'Feu_Sperrmüll'               :  'LF/TLF',
  'Feu_Traktor'                 :  'LF/TLF',
  'Feu_LKW'                     :  'LF/TLF,GW-Öl',
  'TH_Aufzug'                   :  'RW',
  'TH_KellerWasser'             :  'TLF/LF',
  'TH_VU'                       :  'LF,RW,GW-Öl',
  'Feu_Stroh'                   :  'LF/TLF,GW-W',
  'Feu_Keller'                  :  'LF,LF,TLF,ELW',
  'Feu_Dachstuhl'               :  'LF,LF,ELW,DL',
  'Feu_Schornstein'             :  'LF,ELW,DL',
  'Feu_Wohnung'                 :  'LF,LF,DL,ELW,GW-A',
  'Feu_Pommesbude'              :  'LF,LF,TLF,ELW',
  'Feu_Scheune'                 :  'LF,LF,LF,ELW,DL,GW-W,GW-A,RW',
  'Feu_Silo'                    :  'TLF,LF,LF,DL,ELW',
  'Feu_Supermarkt'              :  'LF,LF,LF,TLF,GW-A,ELW,DL',
  'Feu_Altenheim'               :  'LF,LF,LF,ELW,DL,GW-A',
  'Feu_Kino'                    :  'LF,LF,LF,TLF,ELW,DL,GW-A',
  'Feu_Sporthalle'              :  'LF,LF,ELW,TLF,DL,GW-W,GW-A,RW',
  'Feu_Sägewerk'                :  'LF,LF,LF,ELW,GW-W,GW-A,DL,RW',
  'Feu_Wohnblock'               :  'LF,LF,LF,TLF,ELW,DL,GW-A',
  'GSG_Chemieunfall'            :  'LF,LF,TLF,ELW,GW-M,GW-G',
  'GSG_Chlorgas'                :  'LF,LF,TLF,ELW,GW-M,GW-G,RW',
  ...
  'Feu_Gewerbe'                 :  'LF,LF,LF,DL,TLF,ELW,RW,GW-A',
  'Feu_Baumarkt'                :  'LF,LF,LF,DL,TLF,ELW,RW,GW-A,GW-M,GW-G,GW-W',
};
  ...
  { var D = document.getElementById("content");
    ...
    { if (TR.getElementsByTagName("td").length>5)
      { var TDs = TR.getElementsByTagName("td");
        var TD = TDs[5];
        var Stat = trim(TD.innerHTML);
        //mylog("Stat='"+Stat+"'");
        if (Stat == "Beim Einsatz") TD.style.color="#FF0000";
        if (Stat == "Frei - nicht im Dienst") TD.style.color="#555555";
        if (Stat == "Einsatzbereit") TD.style.color="#FFFFFF";
        if (Stat == "In der Feuerwehrschule") TD.style.color="#5555FF";
        
        TD = TDs[1];
        var Mot = parseInt(TD.innerHTML);
        if (Mot >= 75) TD.style.color = "#66FF66";
        if (Mot <= 25) TD.style.color = "#FF6666";
      }
    }
  }
...
mylog("V = " + InfotextVerfuegbar);
    ...
    if (InfotextVerfuegbar) Info += InfoVorspann + "verfügbar</th><td><font color='green'>" + InfotextVerfuegbar + "</font></td></tr>\n";
...
{ var FZArray = new Array();
  ...
  { var FZ;
    ...
    { FZ=TDs[2].innerHTML;
      FZ=getFahrzeugKlasse(FZ);
      if (!FZArray[FZ]) FZArray[FZ]=0;
      FZArray[FZ]++;
    }
  }
  
  var ret="";
  for (var i in FZArray)
    ret += FZArray[i] + "x" + i + ", ";

  if (ret.length>2) ret=ret.substr(0,ret.length-2);
  return ret;
}
...
{ mylog("SetVariables");
  ...
  showInfoVerfuegbar=confirm(T+"Liste aller verfügbarer Fahrzeuge");
...
{ 
  ...
  if (ichBins) return;
  // wenn gerade die Konfig abgefragt wird, ebenfalls nicht unterbrechen
