...
var chatURL = GM_getValue('chatURL', 'http://www.shoutmix.com/?ikabro');
...
baseElements += '<span id="chScriptName">BROTHERHOOD Chat</span>'; 
...
baseElements += '<div id="chMessagesList" style="height: 310px;overflow:auto;margin-right: 2em;border: 1px solid #CB9B6B;"><iframe src="http://www.shoutmix.com/?ikabro" frameborder="0" allowtransparency="true" scrolling="no" height="300" width="215"></iframe></div></div>';
