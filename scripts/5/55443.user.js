// ==UserScript==
// @name           TW GroepenBewerken
// @description    Mogelijkheid groepen te bewerken in Overzichten
// @include        http://nl*.tribalwars.nl/*screen=overview_villages&mode=combined*
// ==/UserScript==
...
for(var zeile=1;zeile<zeilen.length;zeile++){
    ...
    newElement.innerHTML='<a href="javascript:popup_scroll(\'groups.php?&amp;mode=village&amp;village_id='+dorfid+'\', 300, 400);">&raquo; bewerken</a>' 
