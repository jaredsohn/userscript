// ==UserScript==
// @name            Taringa funcion en Google/
// @namespace       Chupatestamandarina
// @include         http://www.google.com.ar/

// ==/UserScript==
function chupatestamandarina_script() {
do_modify_url_it(window.document,document.evaluate('/HTML[1]/BODY[1]/DIV[2]/SPAN[1]/DIV[1]/NOBR[1]/SPAN[1]/DIV[1]/NOBR[1]/A[1]', document, null, XPathResult.FIRST_ORDERED_NODE_TYPE,null).singleNodeValue,/http:\/\/www\.google\.com\.ar\/<a href=/,'http://www.taringa.net/perfil.php',false);
do_modify_url_it(window.document,document.evaluate('/HTML[1]/BODY[1]/DIV[2]/SPAN[1]/DIV[1]/NOBR[1]/SPAN[1]/DIV[1]/NOBR[1]/A[2]', document, null, XPathResult.FIRST_ORDERED_NODE_TYPE,null).singleNodeValue,/http:\/\/www\.google\.com\.ar\/<a href=/,'http://www.taringa.net/monitor/',false);
}; // Ends chupatestamandarina_script
window.addEventListener("load", function() { chupatestamandarina_script() }, false);
...
var platypusplatypuscouldntfi1 = mystrings.GetStringFromName("chupatestamandarinacouldntfi1");
var platypusthisusuallyhappens = mystrings.GetStringFromName("chupatestamandarinathisusuallyhappens");
