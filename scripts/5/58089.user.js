...
// question about how multiple names handled: Alfred Montapert does not work as author phrase; Montapert Alfred does
// maybe not an issue, i.e., almost everything has ISBNs?
LibraryGAFulton.prototype.locationSearchByISBN10  = 'http://splnh.kohalibrary.com/cgi-bin/koha/opac-search.pl?q=PLACEHOLDERISBN10';
LibraryGAFulton.prototype.locationSearchByISBN13 = 'http://splnh.kohalibrary.com/cgi-bin/koha/opac-search.pl?q= PLACEHOLDERISBN13';
LibraryGAFulton.prototype.locationSearchByTitleAuthor = 'http://splnh.kohalibrary.com/cgi-bin/koha/opac-search.pl?idx=au%2Cwrdl&q=PLACEHOLDERAUTHOR&op=and&idx=ti&q=PLACEHOLDERTITLE';
LibraryGAFulton.prototype.locationSearchByTitle = 'http://splnh.kohalibrary.com/cgi-bin/koha/opac-search.pl?idx=ti&q=PLACEHOLDERTITLE';
...
if(window.location.toString().match(/^http:\/\/www\.netflix\.com\//))         { new Netflix(new LibraryGAFulton()); }
