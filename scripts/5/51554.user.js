...
// @namespace      http://www.someonejohn.com
//@version         .01
// @description    Replace BBCode with html tags
// @include        http://www.debate.org/debate/*
// @include        http://www.debate.org/debates/*
// ==/UserScript==
...
function replaceBBCode(match)
{
	...
	switch(match[1].toLowerCase())
	{
		...
		case "list":
			return $ce(match[2]?"ol":"ul",/[*]/.test(match[3])?match[3].replace("[*]","").replace(/[*]/,"")+"":match[3],match[2]?{"type":match[2]}:null);
		case "spoiler":
