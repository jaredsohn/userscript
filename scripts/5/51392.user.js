// ==UserScript==
// @name          www.plapl.com-tribalwars-forum
// @description
// @namespace     c1b1.de
...
تم تعريب السكربات من قبل عربي اصيل
عضو في منتديات www.plapl.com
_______________________
...
function renderAllyMemberPage()
  ...
  th.appendChild(dom.text('تلاحظ'));
  elist[start_i].appendChild(th);

  var th = dom.n('th');
  th.appendChild(dom.text('عمل'));
  elist[start_i].appendChild(th);
  ...
  for(var i = start_i; len > i; i++)
    ...
    if(names[player])
      ...
      var a = dom.n('a');
      a.setAttribute('href','#');
      a.appendChild(dom.text('التفاصيل'));
...
function dialog_playerMenu(name)
  ...
  a_editNotes.appendChild(dom.text(String.fromCharCode('0187') + ' تحرير المذكرات'));
  ...
  a_editColour.appendChild(dom.text(String.fromCharCode('0187') + ' تغيير اللون'));
  ...
  a_addWarning.appendChild(dom.text(String.fromCharCode('0187') + ' تحذير'));
  ...
  if(data[1] != 0)
    ...
    a_removeWarning.appendChild(dom.text(String.fromCharCode('0187') + ' إزالة الإنذار'));
  ...
  frame.setTitle('خيارت - '+unescape(escape(name)));
  frame.setInstructions('معلومات لاعب '+unescape(escape(name)));
  frame.setButton('close','إغلاق');
...
function dialog_playerMenu_editNotes(name)
  ...
  frame.setTitle('تحرير المذكرات - '+unescape(escape(name)));
  frame.setInstructions('ملاحضاتك الخاصه');
  frame.setButton('cancel','الغاء');
  frame.setButton('button','حفظ',dialog_playerMenu_editNotes_save);
  frame.addContent('table',
    {
    0:[
      dom.text('ملاحظات :')
...
function dialog_playerMenu_editColour(name)
  ...
  frame.setInstructions('ما الون الذي تريد تلوين به مشاركات الاعب');
  frame.setButton('cancel','الغاء');
  frame.setButton('button','حفظ',dialog_playerMenu_editColour_save);
  frame.addContent('table',
    {
    0:[
      dom.text('لون الحالية :'),
      dom.text(''),
        [
        dom.text(data[0]),
...
function dialog_playerMenu_addWarning(name)
  {
  var affirmation = confirm('هل تريد عطاء '+unescape(escape(name))+' مخالفه?');
  if(affirmation)
    {
    var answer = prompt('ما سبب تحذير الاعب  '+unescape(escape(name))+' (:','');
...
function dialog_playerMenu_removeWarning(name)
  ...
  frame.setTitle('إزالة الإنذار لاعب - '+unescape(escape(name)));
  frame.setInstructions('اختيار حذف تحذير');
  frame.setButton('cancel','الغاء');
  frame.setButton('button','حذف',function() { dialog_playerMenu_removeWarning_save(name); });
  frame.addContent('table',
    {
    0:[
      dom.text('تحذيرات:'),
...
function dialog_playerMenu_removeWarning_save(name)
  ...
  var affirmation = confirm('هل تريد ازلة التحذير');
  if(affirmation)
    {
    var ar = colourThreadsNames.split(',');
    var names = new Array();
...
function dialog_settings()
  ...
  var td = dom.n('td');
  td.appendChild(dom.text('طريقة تلوين الردود'));
  tr.appendChild(td);
  ...
  var td = dom.n('td');
  td.appendChild(dom.text('استعرض الإبتسامات '));
  tr.appendChild(td);
  ...
  var td = dom.n('td');
  td.appendChild(dom.text('الحد الأقصى لحجم الخط'));
  tr.appendChild(td);
  ...
  var td = dom.n('td');
  td.appendChild(dom.text('الحد الأقصى لحجم الصورة'));
  tr.appendChild(td);
  ...
  var td = dom.n('td');
  td.appendChild(dom.text('الروابط الخارجية تلقائيا إلى الأمام'));
  tr.appendChild(td);
  ...
  var td = dom.n('td');
  td.appendChild(input);
  td.appendChild(dom.text('(ضمن tribalwars.ae)'))
  tr.appendChild(td);
  content.appendChild(tr);
  // autoRedirect->
  ...
  var td = dom.n('td');
  td.appendChild(dom.text('مكن زعماء القبائل'));
  tr.appendChild(td);
  ...
  var td = dom.n('td');
  td.appendChild(input);
  td.appendChild(dom.text('(قائمة الأعضاء)'))
  tr.appendChild(td);
  content.appendChild(tr);
  // memberlistSF->
  ...
  frame.setTitle('التفضيلات');
  frame.setInstructions('إعدادات عامة');
  frame.setButton('cancel','الغاء');
  frame.setButton('button','حفظ',save_dialog_settings);
...
function menu_extras()
  ...
  if(dom.id('menu_extras'))
    ...
    var a = dom.n('a');
    a.href = '#';
    a.appendChild(dom.text('التفضيلات'));
    dom.addEvent(a,'click',function()
      {
    ...
    var a = dom.n('a');
    a.href = '#';
    a.appendChild(dom.text('تصدير /استيراد'));
    dom.addEvent(a,'click',function()
      {
      dom.id('menu_extras').style.display = 'none';
      dialog_export();
    ...
    var a = dom.n('a');
    a.href = '#';
    a.appendChild(dom.text('ضبط مصنع'));
    dom.addEvent(a,'click',function()
      {
      dom.id('menu_extras').style.display = 'none';
      var q = confirm('هل تريد استرجع الخيرات الافتراضية');
      if(q)
        {
        var q = confirm('هل تريد استمرار\n\في العملية?');
        if(q)
          {
          setValue('reset',true);
          document.location.reload();
    ...
    var a = dom.n('a');
    a.href = '#';
    a.appendChild(dom.text('معلومات عن'));
    dom.addEvent(a,'click',function()
      {
      dom.id('menu_extras').style.display = 'none';
...
function clickedPlayerMenu(e,span)
  ...
  a.href = span.title;
  a.target = 'main';
  a.appendChild(dom.text( String.fromCharCode('0214') +'الملف الشخصي'));
  div.appendChild(a);
  ...
  a.target = 'main';
  a.appendChild(dom.text('ارسل رساله'));
  div.appendChild(a);

  var span = dom.n('span');
  span.setAttribute('style','display:block; font-size:x-small; padding-top:3px;');
  span.appendChild(document.createTextNode('الترتيب :'));
  ...
  a.appendChild(document.createTextNode('اللاعب'));
  div.appendChild(a);
  ...
  a.appendChild(document.createTextNode('ترتيب اللاعب على مستوي القارة'));
  div.appendChild(a);
  ...
  a.appendChild(document.createTextNode('كمهاجم'));
  div.appendChild(a);
  ...
  a.appendChild(document.createTextNode('كمدافع'));
  div.appendChild(a);
  ...
  a.appendChild(document.createTextNode('المجموع(كمدافع+كمهاجم)الترتيب'));
  div.appendChild(a);
...
function adjustMessagePopup()
  ...
  dom.id('message').setAttribute('style','background:white url(http://www.uploadat.com/upfiles/nV192220.png) bottom right no-repeat; ');
...
function addInviteLinks()
  ...
  dom.addEvent(a,'click',function()
    {
    if(confirm('في الحقيقة كل الدعوات zur'+String.fromCharCode('0252')+'طرح?'))
      returnAllInvitations();
    return false; });
  a.appendChild(dom.text('كل الدعوات تراجع'));
    ...
    switch(type)
      ...
      case 'close':
        ...
        if(type == 'cancel' || type == 0)
          ...
          {
          if(confirm('كل التغييرات غير المحفوظة سوف تضيع\لن تستطيع ارجعها?'))
...
function bar()
    ...
    a.appendChild(dom.text(' إضافات((www.plapl.com))-'));
    leftfont.appendChild(a);
