...
Der 'Codeblock' wird mit "(laufzeiten)" eingeleitet und mit "(/laufzeiten)" geschlossen (ï¿½hnlich BB-Codes).
...
Text nach dieser Angabe wird beachtet, allerdings dï¿½rfen keine BB-Codes benutzt werden.

Mehrere 'Codeblï¿½cke' sind mï¿½glich.

Nach dem einleitenden "(laufzeiten)" kann die Laufzeit pro Feld fï¿½r den Codeblock stehen, z.B.:
(laufzeiten)30
[village](xxx|yyy)[/village] 5offs fehlen noch
[village](xxxx|yyy)[/village]
(/laufzeiten)
Dieses Beispiel wï¿½rde fï¿½r diesen Block die Laufzeiten mit 30 Minuten pro Feld errechnen, also fï¿½r Rammen oder Katapulte.
