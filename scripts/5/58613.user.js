...
function eRepBarDamage(){
	...
	var eRepBarDamage = 	'<h3>Damage Calculator</h3>' +
							'<div id="eRepBarDamageStats">' +
								'<div><div class="inputdesc">Citizen name:</div><div class="input_holder"><input id="erbInputCitizenName" class="inputtext" style="width: 100px" value="' + $(".nameholder a").html() + '"></div><div class="inputholder_end"></div><div class="executeButtonSmall" id="erbLoadDamageData">Load</div></div>' +
								'<div><div class="inputdesc" style="clear: both">Wellness:</div><div class="input_holder"><input id="erbInputCurrentWellness" class="inputtext" style="width: 50px" value="' + $("#wellnessvalue").html() + '"></div><div class="inputholder_end"></div></div>' +
								'<div><div class="inputdesc" style="clear: both">Strenght:</div><div class="input_holder"><input id="erbInputStrength" class="inputtext" style="width: 50px" value="0.0"></div><div class="inputholder_end"></div></div>' +
								'<div><div class="inputdesc" style="clear: both">Weapon Quality (all):</div><div class="input_holder" style="width: 45px">' +
								...
								'</div><div class="inputholder_end"></div></div>' +
								'<div style="clear: both"><fieldset style="border: 1px solid #ccc; margin-bottom: 10px;"><legend style="margin-left: 10px;">Weapon Quality ~ Wellness: </legend>' + 
								...
								'</fieldset></div>' +
								'<div><div class="inputdesc" style="clear: both">Military Rank:</div><div class="input_holder" style="width: 110px">' +
								'<select class="inputselect" id="erbInputMilitaryRank" value="1"><option value="1.2">Private</option><option value="1.4">Corporal</option><option value="1.6">Sergeant</option><option value="1.8">Lieutenant</option><option value="2.0">Captain</option><option value="2.2">Colonel</option><option value="2.4">General</option><option value="2.6">Field Marshall</option></select>' +							
								'</div><div class="inputholder_end"></div></div>' +
							'</div>' +
							'<div id="eRepBarDamageResults">' +
								'<h2 class="special" style="padding-bottom: 20px;">First Fight:</h2>' +
								'<span class="display-strenght-start">' +
									'<span class="display-strenght-end">' +
								...
								'</span>' +
							'</div>' +
							'<h3>Cumulated Damage</h3>' +
							'<div style="clear: both">' +
								'<table class="offers" style="width: 740px"><tbody>' +
									'<tr><td style="width: 90px">5 Fights</td><td style="width: 90px">6 Fights</td><td style="width: 90px">10 Fights</td><td style="width: 90px">11 Fights</td><td style="width: 90px">20 <img src="/images/parts/icon-gold.gif"/> Tank</td><td style="width: 90px">40 <img src="/images/parts/icon-gold.gif"/> Tank</td><td style="width: 90px">60 <img src="/images/parts/icon-gold.gif"/> Tank</td><td style="width: 90px">80 <img src="/images/parts/icon-gold.gif"/> Tank</td></tr>' +
...
function eRepBarPreferences(){
	...
	var eRepBarPreferences = 	'<h3>Overall Preferences</h3>' +
								'<div style="clear: both;">' +
...
function eRepBarAbout(){
	var eRepBarAbout = 	'<h3>Welcome to eRepBar v 0.1!</h3>' +
						'<div style="clear: both;">' +
							'<div>' + 
							'<p style="font-size: 13px"><b>So, what is eRepBar exactly?</b></p><br>' +
							'<p>It is a set of common tools, that I (<a href="http://www.erepublik.com/en/citizen/profile/1467082">pi_wo</a>) developed to make your e-life a little bit' +
							' easier and implemented into the eRepublik UI to make sure you can access them quickly everytime you need them.</p><br>' +
							'<p style="font-size: 13px"><b>Features in v 0.1</b></p><br>' +
							'<ul style="list-style-type:circle; padding-left: 15px;">' +
							'<li>Wellness Calculator</li>' +
							'<li>Productivity Calculator</li>' +
							'<li>Damage Calculator</li>' +
							'<li>Company Management Tool</li>' +
							'</ul><br>' +
							'<p style="font-size: 13px"><b>License</b></p><br>' +
							'<p>eRepBar is a so called <strong>Donationware</strong>. You can use it free of any charge (in real or virtual currency). <b>But</b> if you like it, want to support me in my efforts and motivate me to work even harder on this project, you are most welcome to spare me some change for some beer:</p>' +
							'<p style="font-size: 16px; font-weight: bold;"><a href="http://www.erepublik.com/en/citizen/profile/1467082"><img src="' + beer_icon + '" align="center">Buy me a beer!</a></p>' +
							'<p>You are also free to modify it, but for your OWN USE ONLY. It means you cannot republish it (even in modified form) without consulting me and my >clear< approval.</p><br>' +
							'<p style="font-size: 13px"><b>Disclaimer</b></p><br>' +
							'<p>ABSOLUTELY NO GUARANTEE! :)</p><br>' +
							'<p style="font-size: 13px"><b>Bugs? Performance issues? Suggestions?</b></p><br>' +
							'<p>I\'m not a code ninja as some of you :) You can expect this piece of software to fail, crash or even explode (see disclaimer). Anyway, you can send all bug reports and/or suggestions to this address: erepbar@sefcat.pl</p>' +
						'</div>';
...
function eRepBarConstruct(){
	...
	var bar = 	'<div id="eRepBar">' +
					...
					'<div class="eRepBarBody"><span style="font-weight: bold; color: #fff;">eRepBar</span></div>' +
					'<div class="eRepBarRightCorner"></div>' +
				'</div>' +
				'<div id="eRepBarMainContainer">' +
					'<div id="eRepBarButtonContainer">' +
						'<div id="buttonWellness" class="eRepBarButton"><p>Wellness Calculator</p></div>' +
						'<div id="buttonDamage" class="eRepBarButton"><p>Damage Calculator</p></div>' +
						'<div id="buttonProductivity" class="eRepBarButton"><p>Productivity Calculator</p></div>' +
						'<div id="buttonCompanyManagement" class="eRepBarButton"><p>Company Management</p></div>' +
						'<div id="buttonPreferences" class="eRepBarButton"><p>Preferences</p></div>' +
						'<div id="buttonAbout" class="eRepBarButton"><p>About eRepBar</p></div>' +
					'</div>' +
