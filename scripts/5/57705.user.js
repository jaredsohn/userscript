// ==UserScript==
// @name           eRepublik Optimizer - România
...
if  (header) {
	...
	'<div style="float:left;">' + 
		...
		'<a href="http://www.erepublik.com/en/my-places/army">Armata</a> | ' + 
		'<a href="http://www.erepublik.com/en/wars/1">Războaiele</a> | ' + 
		'<strong><u>Piaţă:</u> </strong><a href="http://www.erepublik.com/en/market/country-'+nat_code+'-industry-1-quality-0">Mâncare</a>, ' + 
			'<a href="http://www.erepublik.com/en/market/country-'+nat_code+'-industry-2-quality-0">Cadou</a>, ' + 
			'<a href="http://www.erepublik.com/en/market/country-'+nat_code+'-industry-4-quality-0">Bilete avion</a>, ' + 
	...
	'<div style="float:right;" dir="ltr">' + 
		'<div class="information"><br>Ora: ' + livetime.innerHTML + ' @ ' + date + 
					'<br>Astăzi,Noua Lume <b>' + dateCount + '</b>. napja van.</div></div>' + 	'<br><div align="left">' + 
