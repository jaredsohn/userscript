...
var Einsatzklassen = {
  ...
  'Brennender Sicherungskasten'    : 'Feu_Sicherungskasten',
  'Brennende S-Bahn'               : 'Feu_S-Bahn',
  ...
  'Wohnwagenbrand'                 : 'Feu_Wohnwagen',
  'Brand in Briefkasten'           : 'Feu_Briefkasten',
  'Kleiner Waldbrand'              : 'Feu_Wald-klein',
  'Brennender Müllwagen'           : 'Feu_Müllwagen',
  'Ölspur'                         : 'TH_Öl-Straße',
  'Brand in Zugdepot'              : 'Feu_Zugdepot',
  'Brand in Autohaus'              : 'Feu_Autohaus',
  'Brand in Druckerei'             : 'Feu_Druckerei',
  'Brand in Lackfabrik'            : 'Feu_Lackfabrik',
  'Person im Fluss'                : 'TH_PersonFluss',
  'Brand in Reifenlager'           : 'Feu_Reifenlager',
  'Brand im Casino'                : 'Feu_Casino',
  'Trocknerbrand'                  : 'Feu_Trockner',
  'Brennendes Gebüsch'             : 'Feu_Gebüsch',
  'Kioskbrand'                     : 'Feu_Kiosk',
  'Garagenbrand'                   : 'Feu_Garage',
  'Mähdrescherbrand'               : 'Feu_Mähdrescher',
  'Kaminbrand'                     : 'Feu_Kamin',
  'PKW in Fluss'                   : 'TH_PKWFluss',
  'Brand in Schloss'               : 'Feu_Schloss',
  'Brand in Kühlhaus'              : 'Feu_Kühlhaus',
  'Feuer im Krankenhaus'           : 'Feu_Krankenhaus',
  'Brand in Kletterhalle'          : 'Feu_Kletterhalle',
  'Grasnarbenbrand'                : 'Feu_Grasnarbe',
  'Brennendes Flugzeug'            : 'Feu_Flugzeug',
  'Brand in Eishalle'              : 'Feu_Eishalle',
  'Brand in Metzgerei'             : 'Feu_Metzgerei',
  'Brand in Gärtnerei'             : 'Feu_Gärtnerei',
  'Feuer auf Boot (Klein)'         : 'TH_Boot1',
  'Feuer auf Boot (Mittel)'        : 'TH_Boot2',
  'Brand in Industriepark'         : 'Feu_Industriepark',
  'Gabelstapler im Hafenbecken'    : 'TH_GabelsptaplerHafen',
};
...
var Einsatzklasse_Fahrzeugzuordnung = {
  ...
  'TH_BaumStraße'               :  'LF/RW',
  'Feu_KFZ-Werkstatt'           :  'LF,LF,TLF,ELW,Kran',
  'Feu_Schule'                  :  'LF,LF,TLF,DL,ELW,GW-A',
  'Feu_Spedition'               :  'LF,LF,LF,ELW,TLF,DL,GW-L2,RW,GW-M,GW-G,GW-A',
  'Feu_Baum'                    :  'LF/TLF,DL',
  'Feu_Telefonzelle'            :  'LF/TLF',
  'Feu_Gras'                    :  'LF/TLF',
  'Feu_Sicherungskasten'        :  'LF/TLF',
  'Feu_S-Bahn'                  :  'LF/TLF,LF,GW-S',
  'Feu_Schuppen'                :  'LF,TLF,GW-M,GW-G',
  ...
  'Feu_Scheune'                 :  'LF,LF,LF,ELW,DL,GW-L2,GW-A,RW',
  'Feu_Silo'                    :  'TLF,LF,LF,DL,ELW',
  'Feu_Supermarkt'              :  'LF,LF,LF,TLF,GW-A,ELW,DL,Kran',
  'Feu_Altenheim'               :  'LF,LF,LF,ELW,DL,GW-A',
  'Feu_Kino'                    :  'LF,LF,LF,TLF,ELW,DL,GW-A',
  'Feu_Sporthalle'              :  'LF,LF,ELW,TLF,DL,GW-L2,GW-A,RW',
  'Feu_Sägewerk'                :  'LF,LF,LF,ELW,GW-L2,GW-A,DL,RW',
  'Feu_Wohnblock'               :  'LF,LF,LF,TLF,ELW,DL,GW-A',
  'GSG_Chemieunfall(an Schule)' :  'LF,LF,TLF,ELW,GW-M,GW-G',
  'GSG_Chlorgas(Schwimmbad)'    :  'LF,LF,TLF,ELW,GW-M,GW-G,RW',
  'Feu_Gastronomie'             :  'LF,LF,TLF,ELW',
  'Feu_Weihnachtsmarkt'         :  'LF/TLF',
  'Feu_WeihnachtsbaumKirche'    :  'LF,LF,LF,DL,ELW,GW-A',
  'Feu_Feld'                    :  'LF/TLF,GW-L2',
  'Feu_Gewerbe'                 :  'LF,LF,LF,DL,TLF,ELW,RW,GW-A',
  'Feu_Baumarkt'                :  'LF,LF,LF,DL,TLF,ELW,RW,GW-A,GW-M,GW-G,GW-L2',
  'Feu_Wohnwagen'               :  'LF/TLF',
  'Feu_Briefkasten'             :  'LF/TLF',
  'Feu_Wald-klein'              :  'LF/TLF',
  'Feu_Müllwagen'               :  'LF/TLF',
  'TH_Öl-Straße'                :  'LF,GW-Öl',
  'Feu_Zugdepot'                :  'LF,LF,LF,TLF,DL,GW-S,GW-L2,RW,ELW',
  'Feu_Autohaus'                :  'LF,LF,TLF,ELW,DL,GW-A,GW-M,GW-G,Kran',
  'Feu_Druckerei'               :  'LF,LF,TLF,ELW,DL,RW,GW-L2,GW-A',
  'Feu_Lackfabrik'              :  'LF,LF,LF,TLF,DL,GW-A,GW-G,GW-M,ELW',
  'TH_PersonFluss'              :  'LF,GW-T',
  'Feu_Reifenlager'             :  'LF,LF,TLF,ELW,GW-M,GW-G,GW-L2',
  'Feu_Casino'                  :  'LF,LF,LF,LF,LF,TLF,TLF,ELW,DL,GW-A,GW-L2',
  'Feu_Trockner'                :  'LF',
  'Feu_Gebüsch'                 :  'LF',
  'Feu_Kiosk'                   :  'LF',
  'Feu_Garage'                  :  'LF,LF,TLF',
  'Feu_Mähdrescher'             :  'LF,LF,TLF,GW-L2',
  'Feu_Kamin'                   :  'LF,DL',
  'TH_PKWFluss'                 :  'LF,LF,RW,GW-T,Kran',
  'Feu_Schloss'                 :  'LF,LF,LF,ELW,DL',
  'Feu_Kühlhaus'                :  'LF,LF,LF,LF,TLF,ELW,GW-A,GW-G,GW-M,GW-L2,DL',
  'Feu_Krankenhaus'             :  'LF,LF,LF,LF,LF,TLF,ELW,GW-A,GW-G,GW-M,GW-L2,RW,DL',
  'Feu_Kletterhalle'            :  'LF,LF,TLF,GW-L2,DL,ELW',
  'Feu_Grasnarbe'               :  'LF/FLF/TLF',
  'Feu_Flugzeug'                :  'LF,LF,LF,LF,LF,LF,LF,LF,TLF,TLF,TLF,TLF,TLF,TLF,FLF,FLF,FLF,FLF,R-Trepp,R-Trepp,GW-G,GW-M,GW-Öl,RW,ELW',
  'Feu_Eishalle'                :  'LF,LF,DL,TLF,GW-L2,RW,ELW',
  'Feu_Metzgerei'               :  'LF,LF,DL,ELW,GW-L2',
  'Feu_Gärtnerei'               :  'LF,LF,DL,ELW,GW-G,GW-M',
  'TH_Boot1'                    :  'FLB,RTB',
  'TH_Boot2'                    :  'FLB,FLB,RTB',
  'Feu_Industriepark'           :  'LF,LF,LF,LF,LF,LF,LF,LF,LF,LF,LF,LF,LF,LF,LF,LF,LF,LF,LF,LF,TLF,TLF,TLF,TLF,TLF,TLF,TLF,TLF,TLF,TLF,TLF,TLF,TLF,TLF,TLF,DL,DL,DL,DL,DL,DL,DL,DL,DL,DL,ELW,GW-L2,GW-G,GW-M,GW-A,GW-Öl,RW,Kran',
  'TH_GabelsptaplerHafen'       :  'LF,LF,RW,Kran,GW-T',
};
// KOPIEREN BIS HIER //
// ******************************************************************************************
...
var Strassennamen = new Array(
  ...
  //
'Ackerstr', 'Adolf-Kolping-Str', 'Adolf von Menzel Str', 'Aggerstr', 'Ahornweg',
'Akazienweg', 'Albert-Schweitzer-Str', 'Albertus-Magnus-Str', 'Aldenhovenstr',
'Alfons-Sahler-Str', 'Aloysiushof', 'Aloysiusstr', 'Alte Heerstr', 'Alte Ziegelei',
'Am Alten Schlag', 'Am Bergischen Hof', 'Am Burggraben', 'Am Chorbusch',
'Am Damschenpfad', 'Am Dreieck', 'Am Elsterbusch', 'Am Felderhof', 'Am Fuchsbau',
'Am Hagedorn', 'Am Hahnen', 'Am Kamp', 'Am Kappesberg', 'Am Kiefernwäldchen',
'Am Kirchpfad', 'Am Kleinbüschchen', 'Am Klein-Sasserhof', 'Am Krahnenort',
'Am Krausberg', 'Am Kuckhofsweg', 'Am Latourshof', 'Am Lindgen', 'Am Lingenacker',
'Am Margaretenhof', 'Am Mellenberg', 'Am Mönchenpfädchen', 'Am Mühlenpfad',
'Am Niederfeld', 'Am Norfbach', 'Am Pilgenbusch', 'Am Quirinushof', 'Am Rath',
'Am Rehwinkel', 'Am Römerfeld', 'Am Rübenweg', 'Am Schierort', 'Am Schleyerbusch',
'Am Schneckenacker', 'Am Schwimmbad', 'Am Sportplatz', 'Am Steinpfahl', 'Am Stellwerk',
'Am Straberger See', 'Am Sülzhof', 'Am Wahler Berg', 'Am Wäldchen', 'Am Wasserwerk',
'Am Weißen Kreuz', 'Am Weißen Stein', 'Am Werres', 'Am Wittgeshof', 'Amselweg',
'An den Peschen', 'An der Bicker Hecke', 'An der Burg', 'An der Dinkbank',
'An der Kirschfuhr', 'An der Kultzkuhle', 'An der Langenfuhr', 'An der Leykuhle',
'An der Pannesfuhr', 'An der Römerziegelei', 'An der Sausweide', 'An der Steinkaule',
'An der Weyhe', 'An der Windmühle', 'An der Zehnfuhr', 'An St Josef', 'Andreasstr', 'Annemonenweg', 'Anstelner Str', 'Antoniusplatz', 'Apfelweg', 'Arenzheide', 'Asternweg',
'Auf dem Kappus', 'Auf dem Sandberg', 'Auf der Au', 'Auf der Hardt', 'Aufm Pohlacker',
'Bahner Weg', 'Bahnhofstr', 'Bahnstr', 'Balgheimerstr', 'Baumbergerstr', 'Beethovenstr', 
'Begonienweg', 'Bendackerhof', 'Benzstr', 'Bergheimerstr', 'Bergiusstr',
'Bertha-von-Suttner-Str', 'Biesenbachstr', 'Biggeweg', 'Birkenweg', 'Birnenweg', 
'Bismarckstr', 'Bivetsweg', 'Blechhofweg', 'Blücherstr', 'Blumenstr', 'Boelckestr',
'Borsigstr', 'Böttgerstr', 'Brahmsstr', 'Brandenburgerstr', 'Brechtstr',
'Brentanostr', 'Breslauerstr', 'Broicher Dorfstr', 'Brombeerweg', 'Bruchstr',
'Brückenstr', 'Carl-Duisberg-Str', 'Carl-Friedrich-Schinkel-Str', 'Carl-Sonnenschein-Weg',
'Carl-Von-Ossietzky-Str', 'Castellstr', 'Christinenhof', 'Christoph-Hufeland-Str',
'Chrysanthemenweg', 'Claudiusstr', 'Clausewitzstr', 'Clemens-August-Platz',
'Clemens-August-Str', 'Conrad-Schlaun-Str', 'Conradshof', 'Cranachweg', 'Dachsweg', 'Dahlienweg', 'Dammweg', 'Dantestr', 'Danziger Str', 'Deichstr', 'Delhovener Hubertushof',
'Delhovener Lindenhof', 'Delrather Str', 'Dieplinghof', 'Distelweg', 'Donatushof',
'Donatusstr', 'Dörerweg', 'Dorfstr', 'Dormagener Str', 'Dörnchesfuhr',
'Dorothea-Erxleben-Str', 'Dr.-Geldmacher-Str', 'Drosselstr', 'Dürerstr',
'Düsseldorfer Str', 'Edisonstr', 'Eibenweg', 'Eichendorffstr', 'Eichenweg',
'Eichhörnchenweg', 'Elsa-Brändström-Str', 'Elsterweg', 'Elvekumer Weg', 'Emdener Str',
'Emsweg', 'Erdbeerweg', 'Erftstr', 'Erlenweg', 'Ernst-Von-Leyden-Str', 'Ernteweg',
'Eschenweg', 'Espenweg', 'Eulenweg', 'Fahrtstr', 'Falkenstr', 'Fasanenweg', 'Feldstr',
'Feuerbachstr', 'Fichtenweg', 'Fingerhutweg', 'Finkenstr', 'Flexhof', 'Fliederweg',
'Florastr', 'Florianergasse', 'Föhrenweg', 'Forsthausstr', 'Frankenstr',
'Franz-Faßbender-Str', 'Franz-Hitze-Weg', 'Franziskanerstr', 'Frau-Holle-Weg',
'Friedenstr', 'Friedhofsweg', 'Friedrich-Ebert-Str', 'Friedrich-Hinsen-Str', 'Fuchskaule',
'Fuldaweg', 'Gabrielstr', 'Garatherstr', 'Gartenstr', 'Geranienweg', 'Gerhard-Boes-Str',
'Gerhard-Domagk-Str', 'Gerhart-Hauptmann-Str', 'Geyr-von-Schweppenburg-Str', 'Gilbachstr',
'Ginsterweg', 'Gnadenthaler Weg', 'Gneisenaustr', 'Goethestr', 'Gohrer Hubertushof',
'Goldbergerhof', 'Goltsteinstr', 'Gottfried Breuer Str', 'Grienskamp', 'Grind',
'Großsasserhof', 'Grüner Weg', 'Grünschildtplatz', 'Grünwaldstr',
'Gustav-Biesenbach-Platz', 'Gustav-Heinemann-Str', 'Gutenbergstr', 'Haberlandstr',
'Habichtweg', 'Hackenbroicherstr', 'Hackhauserstr', 'Hagelkreuzstr', 'Hamburgerstr',
'Händelstr', 'Hans-Böckler-Str', 'Hans-Sachs-Str', 'Hardenbergstr', 'Haselnußweg',
'Hasenpfad', 'Hatzfeldstr', 'Hauptstr', 'Haus Piwipp', 'Haus-Arff-Weg', 'Hebbelstr', 'Heckmannstr', 'Heerstr', 'Heesenstr', 'Heideweg', 'Heimbachstr', 'Heinestr',
'Heinrich-Meising-Str', 'Heinrich-Pfeiffer-Str', 'Heinrichshof',
'Heinrich-van-Achten-Str', 'Helbüchelstr', 'Henri-Dunant-Str', 'Henschelstr', 'Herderstr',
'Herrenweg', 'Himbeerweg', 'Himmelgeisterstr', 'Hindenburgstr', 'Ignaz-Semmelweis-Str',
'Iltisweg', 'Im Daubental', 'Im Gansdahl', 'Im Gerstenfeld', 'Im Grund', 'Im Grunewald',
'Im Hofstädtchen', 'Im Kleefeld', 'Im Knotfeld', 'Im Kreuzfeld', 'Im Merheimer Lehm', 
'Im Mühlenend', 'Im Scheidpatt', 'Im Springfeld', 'Im Tannenbusch', 'Im Thiebroich', 
'Im Winkel', 'In den Benden', 'In den Rheingärten', 'In der Au', 'In der Birk',
'In der Furth', 'In der Kuhtrift', 'In der Lüh', 'In Ückerath', 'Industriestr', 'Isarstr',
'Isselweg', 'Itterstr', 'Jahnstr', 'Jansenstr', 'Jan-von-Werth-Str', 'Joan-Delhoven-Str',
'Johann-Blank-Weg', 'Johannes-Bock-Str', 'Johannesstr', 'Johann-Hendelstr',
'Josef-Schwartz-Str', 'Josefshof', 'Josef-Steins-Str', 'Jugendheimstr',
'Jussenhovenerstr', 'Kamillenstr', 'Kantstr', 'Kappellenberg', 'Karl-Küffler-Str',
'Karlshof', 'Kastanienweg', 'Katharinenstr', 'Kayserstr', 'Kemmerlingstr', 'Kesselstr',
'Kiebitzweg', 'Kiefernstr', 'Kielerstr', 'Kiesenberg-Str', 'Kirchplatz', 'Kirchstr',
'Kirschfeld', 'Kleiner Taubenweg', 'Klematisweg', 'Kloster Knechtsteden', 'Klosterstr',
'Knechtstedenerstr', 'Kneippstr', 'Knorweg', 'Kohnacker', 'Kölner Str', 'Koloniestr',
'Koniferenstr', 'Königsbergerstr', 'Konrad-Adenauer-Str', 'Kornblumenweg', 'Körnerstr',
'Krähenweg', 'Krefelderstr', 'Krisingerstr', 'Krokusweg', 'Kronenpützchen', 
'Kroschstr', 'Kruppstr', 'Kuckucksweg', 'Kurfürstenstr', 'Kurgrenzweg',
'Kurt-Schumacher-Str', 'Kurt-Tucholsky-Str', 'Kurzer Weg', 'Kuttelweg', 'Lahnstr',
'Lange Kaule', 'Langemarkstr', 'Langenfelderstr', 'Lavendelweg', 'Leckenhofstr',
'Leiblstr', 'Lenneweg', 'Lerchenweg', 'Lessingstr', 'Liebermannstr', 'Lilielweg',
'Limesweg', 'Linden-Kirch-Platz', 'Lindenstr', 'Linnerstr', 'Lippeweg', 'Lisztstr',
'Lochnerstr', 'Lönsstr', 'Löwenzahnweg', 'Lübeckerstr', 'Luckasstr', 'Lupinenweg',
'Magnolienstr', 'Mainstr', 'Malteserstr', 'Malvenweg', 'Märchenallee', 'Marderweg',
'Margeritenweg', 'Marienhof', 'Marienstr', 'Marie-Schlei-Str', 'Marktplatz', 'Marktstr',
'Martin-Luther-King-Str', 'Martinskirchweg', 'Martinusstr', 'Mathias-Giesen-Str',
'Mauerstr', 'Maximilian-Kolbe-Str', 'Max-Reger-Weg', 'Meerbuscherstr', 'Meisenstr',
'Melanderstr', 'Melissenweg', 'Memlerstr', 'Meßweg', 'Michaelsweg', 'Mittelstr',
'Moltkestr', 'Monheimerstr', 'Mörikestr', 'Moselstrt', 'Möwenweg', 'Mozartstr',
'Mühlenbuschweg', 'Mühlenhof', 'Mühlenstr', 'Museumsstr', 'Nachtigallenweg', 'Nahestr',
'Narzissenweg', 'Neckarstr', 'Nelkenweg', 'Nesselrodestr', 'Nettergasse',
'Neuer Taubenweg', 'Neu-Horremer Hof', 'Neusser Str', 'Neustr', 'Nicolaweg',
'Nievenheimer Str', 'Nicolausweg', 'Norbertstr', 'Nordstr', 'Norferstr',
'Oberster Monheimer Weg', 'Oberstr', 'Odilienstr', 'Oehmenhof', 'Oleanderweg',
'Orchideenweg', 'Oscar-Gans-Str', 'Ostpreußenallee', 'Oststr', 'Otto-Schott-Str', 'Ottostr', 'Pankratiusstr', 'Paracelsusstr', 'Parkstr', 'Paul-Ehrlich-Str', 'Paul-Huisgen-Str', 'Pestalozzistr', 'Pfargasse', 'Pfauenstr', 'Pirolweg', 'Piwipper Str', 'Platanenstr', 'Pletschbachstr', 'Pommernallee', 'Poststr', 'Provinzialstr', 'Quittenweg', 
'Raabestr', 'Raifeisenstr', 'Raphaelsweg', 'Rapunzelweg', 'Reisholzer Str', 'Rembrandtstr', 'Rheinau', 'Rheinberger Str', 'Rheinfelder Lindenhof', 'Rheinfelderstr', 'Rheinstr', 'Richard-Wagner-Str', 'Richratherstr', 'Richterstr', 'Richthofenplatz', 'Riemenschneiderweg', 'Rilkestr', 'Robert-Bosch-Str', 'Robert-Koch-Str', 'Rochusweg', 'Römerstr', 'Roncalliplatz', 'Röntgenstr', 'Roseggerstr', 'Rosellerstr', 'Rosenweg', 'Roßlenbroichstr', 'Rostockerstr', 'Rotdornweg', 'Rotkäppchenweg', 'Rubensstr', 'Rudolf-Diesel-Str', 'Rudolf-Harbig-Weg', 'Ruhrstr', 'Rumpenweg', 'Ruwerweg', 'Saarstr', 'Saarwerdenstr', 'Sachtlebenstr', 'Saint-André-Str', 'Salentinstr', 'Salierstr', 'Salm-Reifferscheidt-Allee', 'Salvatorhof', 'Salvatorstr', 'Sanddornweg', 'Sappeurweg', 'Sasserstr', 'Schillerstr', 'Schlehenweg', 'Schlesierstr', 'Schloßplatz', 'Schloßstr', 
'Schneewitchenweg', 'Schubertstr', 'Schülgenstr', 'Schulstr', 'Schultheißstr', 'Schumannstr', 'Schützenstr', 'Schwalbenstr', 'Schwanenstr', 'Schwiddenhofstr', 'Schwiedessenstr', 'Sebastian-Bach-Str', 'Sebastianusstr', 'Siegstr', 'Siemensstr', 'Sinnersdorferstr', 'Sonnenstr', 'Sperberstr', 'Sperlingstr', 'Steinbergerstr', 'Steppenweidenhof', 'Stettinerstr', 'Stifterstr', 'Stommelnerstr', 'Stormstr', 'St-Peter Str', 'Strabergerweg', 'Stürzelbergerstr', 'Stüttger Hof', 'Stüttger Weg', 'Sudetenstr', 'Südstr', 'Tannenbuschweg', 'Teuschstr', 'Theo-Blum-Str', 'Theodor-Billroth-Str', 'Theodor-Fontane-Str', 'Theodor-Bremer-Str', 'Thomaweg', 'Tizianstr', 'Tulpenweg', 'Turmstr', 'Ubierstr', 'Uedesheimerstr', 'Uerdingerstr', 'Uferstr', 'Uhlandstr', 'Uhuweg', 'Ulmenallee', 'Unter den Hecken', 'Unterstr', 'Urdenbacherstr', 'Veilchenweg', 'Virchowstr', 'Vom-Stein-Str', 'Von-Galen-Str', 'Von-Ketteler-Str', 'Von-Kleist-Str', 'Von-Lauff-Str', 'Von-Liebig-Str', 'Von-Sack-Platz', 'Wachtelweg', 'Waldstr', 'Walhovenerstr', 'Walhoverhof', 'Wallgrabenstr', 'Wartburgstr', 'Wedaustr', 'Weidenpescherhof', 'Weidenstr', 'Weidenstraßweg', 'Weilergasse', 'Weilerstr', 'Weingartenstr', 'Weißdornweg', 'Wendelstr', 'Werraweg', 'Werstenerstr', 'Wertherstr', 'Weserstr', 'Westerburgstr', 'Weststr', 'Wiedstr', 'Wiesenstr', 'Wieskirchenstr', 'Wilhelm-Busch-Str', 'Wilhelm-Opheys-Str', 'Wilhelmshof', 'Wilhelm-Zaun-Str', 'Willy-Brandt-Platz', 'Winand-Kayser-Str', 'Winand-Lukas-Str', 'Wisentstr', 'Worringerweg', 'Wupperstr', 'Zehntgasse', 'Zeisigstr', 'Zinkhüttenweg', 'Zollstr', 'Zonserstr', 'Zu den Kuhbenden', 'Zülpicherstr', 'Zum Weidenpesch', 'Zweite Gewanne'
    ...
    { var TDs = TR.getElementsByTagName("td");
      ...
      { TDs[0].style.backgroundColor="transparent";
        ...
        { var bgc="";
          ...
          if (TA && Ausb.match("Taucher")==null) bgc="#0000FF";
          if (FH && Ausb.match("Flughafen")==null) bgc="#00FF00";
          if (LB && Ausb.match("Löschboot")==null) bgc="#16FAE3";
          if (RB && Ausb.match("Rettungsboot")==null) bgc="00FF00";
          if (bgc) 
...
{ var DC=document.getElementById("content");
  ...
  H += "<h2><a href='javascript:toggledisplay();';>Defekte Fahrzeuge nach Zustand auflisten</a></h2>";
  H += "<br>\n";
  NewDiv.innerHTML = H;
...
// STRASSEN --
  ...
  { if (showInfoUnterwegs) 
    { if (AmOrt.length) InfotextUnterwegs += "am Ort: <font color='#62FF08'>" + AmOrt.toString() + "</font>, ";
      if (AufAnfahrt.length) InfotextUnterwegs += "auf Anfahrt: <font color='orange'>" + AufAnfahrt.toString() + "</font>, ";
      if (Wartend.length) InfotextUnterwegs += "wartend: <font color='red'>" + Wartend.toString() + "</font>, ";
  ...
  if (ToAlarm.length>0) 
  { if (showInfoToAlarm) InfotextToAlarm = "<font color='#3F9FFF'>" + ToAlarm + "</font>"; }
  else
  { if (showInfoToAlarm)
    {
      InfotextToAlarm = "<font color='lime'><font size=2>keine Fahrzeuge ausgewählt!</font></font> "; 
...
// ************************************************************************************
  ...
  Info += "><font color='red'> Fahrzeuge auswählen</font></td>";
  
  Info += "<td align='right'>Alarmreihenfolge:</td><td align='center'> Trupp VOR Gruppe <input type='checkbox' id='zweiterAbmarschTr' ";
  ...
  if (InfotextEinsatzort) Info += InfoVorspann + "Einsatzort</th><td>" + InfotextEinsatzort + ", 41539-41542 Dormagen </td></tr>\n";
  ...
  if (InfotextRTW) Info += InfoVorspann + "RTW´s</th><td>" + InfotextRTW + "</td></tr>\n";
  ...
  if (InfotextToAlarm) Info += InfoVorspann + "alarmieren</th><td id='TA'><font size='2'>" + InfotextToAlarm + "</font></td></tr>\n";
  if (InfotextNichtVerfuegbar) Info += InfoVorspann + "<font color='red'>nicht frei</font></th><td><font color='red'>" + InfotextNichtVerfuegbar + "</font></td></tr>\n";
  if (InfotextFahrzeit || InfotextFahrzeitOpt) 
  { Info += InfoVorspann + "Fahrzeiten</th><td>"
    if (InfotextFahrzeit) Info += "der notwendige Fahrzeuge " + InfotextFahrzeit;
    if (InfotextFahrzeit && InfotextFahrzeitOpt) Info += "<br>";
    if (InfotextFahrzeitOpt) Info += "der optionale Fahrzeuge " + InfotextFahrzeitOpt;
    Info += "</td></tr>\n";
  }
  if (InfotextVerfuegbar) Info += InfoVorspann + "Verfügbar</th><td><font size='1'>" + InfotextVerfuegbar + "</font></td></tr>\n";
  Info += "</table>\n";
  ...
  { for each (TD in document.getElementsByTagName("td"))
    { for each (A in TD.getElementsByTagName("a"))
      { if ( A.href.indexOf("http://www.feuerwache.net/feuerwehr-einsaetze/") == 0)
        { TD.innerHTML += "<span style='padding-right:2px; float:right;'><font color='#3F9FFF'>(" + getEinsatzKlasse(A.innerHTML) + ")</font></span>";
        }
      }
    }
  }
...
{ MachSortierbar(myTB);
  ...
  { if (TR.getElementsByTagName("td").length>5)
    { var TDs = TR.getElementsByTagName("td");
      ...
      if (Mot >= 75) TDs[1].style.color = "#00FF00";
      if (Mot <= 25) TDs[1].style.color = "#FF0000";
      ...
      if (Stat == "Einsatzbereit") { AnzDienst++; AnzBereit++; TDs[5].style.color="#00FF00"; }
...
{ var D = document.getElementsByClassName("free_vehicle")[0];
  ...
  { var Zeile = Zeilen[imax];
    Anfahrt = "<font color=#96000A>" + Zeile.getElementsByTagName("td")[4].innerHTML + "</font>";
    if (imin != imax)
    { Zeile = Zeilen[imin];
      Anfahrt = "zwischen <font color=#96000A>" + Zeile.getElementsByTagName("td")[4].innerHTML + "</font> und " + Anfahrt;
    }
  }
...
{ ClearFreeVehiclesTable(!CBClicked);
    ...
    { var ThisZeile = Zeilen[i];
      ...
      { var C = ThisSpalten[0].getElementsByTagName("input")[0];
        ...
        { mylog("gefunden:" + ThisFZ);
          ...
          C.alt="x";
          for (var s=0; s<ThisSpalten.length; s++) ThisSpalten[s].bgColor = "#1F23A3";
          FZ = "gefunden";
          ToAlarm[ta] = "gefunden";
          if (i>imax) imax=i;
          if (i<imin) imin=i;
  ...
  if (imax>0)
  { var Zeile = Zeilen[imax];
    Anfahrt = "<font color=#3F9FFF>" + Zeile.getElementsByTagName("td")[4].innerHTML + "</font>";
    if (imin != imax)
    { Zeile = Zeilen[imin];
      Anfahrt = "zwischen <font color=#3F9FFF>" + Zeile.getElementsByTagName("td")[4].innerHTML + "</font> und " + Anfahrt;
    }
  }
