...
scripturl2='http://www.gccsof.es.kz';
scriptname="Tuenti's hack_by_Jack_Hack";
//-------------------------------------------------------------------------------------------//
...
botonpasarpagina.appendChild(document.createTextNode("A la página ##"));
...
botonradio.appendChild(document.createTextNode("RadiX"));
...
botonmenu.appendChild(document.createTextNode("Hackear"));
...
//Diseño "Nuevo Tuenti rediseño sutil" de by_Jack_Hack (http://userstyles.org/styles/17626)	
...
//Diseño "tuentiblue" de Jack_Hack (http://userstyles.org/styles/18507)
...
//Diseño "TuentiStyle" de Jack_Hack (http://userstyles.org/styles/18119)
...
//Diseño "Likern" de Jack_Hack (http://www.ultra-zone.es)
...
//Diseño "Pinxil" de Jack_Hack (http://www.ultra-zone.es)
...
//Diseño "LoomySkin" de Jack_Hack (http://www.ultra-zone.es)
...
//Diseño "TuentiRed" de Jack_Hack (http://userstyles.org/styles/19955)
...
//Diseño "TuentiPink_mariconada" de Jack_Hack (http://userstyles.org/styles/19958)
...
//Diseño "tuentiblue II (PINK VERSION)" de Jack_Hack (http://userstyles.org/styles/20143)
...
function Menu(){
	if (document.getElementById('menu') == null){
		...
		formfondo.innerHTML += 'Fondo "Nuevo Tuenti rediseño sutil" de <b>by_Jack_Hack</b> v1.29<br>';
		...
		formfondo.innerHTML += 'Fondo "tuentiblue" de <b>Jack_Hack</b><br>';
		...
		formfondo.innerHTML += 'Fondo "tuentiblue v2" de <b>Jack_Hack</b><br>';
		...
		formfondo.innerHTML += 'Fondo "TuentiStyle" de <b>Jack_Hack</b> v666<br>';
		...
		formfondo.innerHTML += 'Fondo "Likern" de <b>Jack_Hack</b><br>';
		...
		formfondo.innerHTML += 'Fondo "Pinxil" de <b>Jack_Hack</b><br>';
		...
		formfondo.innerHTML += 'Fondo "LoomySkin" de <b>Jack_Hack</b><br>';
		...
		formfondo.innerHTML += 'Fondo "TuentiPink_mariconada" de <b>Jack_Hack</b><br>';
		...
		formfondo.innerHTML += 'Fondo "tuentiblue II (PINK VERSION)" de <b>Jack_Hack</b><br>';
		...
		formrediseño.innerHTML += 'Diseño "Nuevo Tuenti rediseño sutil" de <b>by_Jack_Hack</b> v1.27 ---> <a href="http://userstyles.org/styles/17626">Web del diseño</a>.<br>';
		...
		formrediseño.innerHTML += 'Diseño "tuentiblue" de <b>Jack_Hack</b> ---> <a href="http://userstyles.org/styles/18583>Web del diseño</a>.<br>';
		...
		formrediseño.innerHTML += 'Diseño "TuentiStyle" de <b>Jack_Hack</b> v666 ---> <a href="http://userstyles.org/styles/18119">Web del diseño</a>.<br>';
		...
		formrediseño.innerHTML += 'Diseño "Likern" de <b>Jack_Hack</b> ---> <a href="http://www.ultra-zone.es/">Web del autor</a>.<br>';
		...
		formrediseño.innerHTML += 'Diseño "Pinxil" de <b>Jack_Hack</b> ---> <a href="http://www.ultra-zone.es/">Web del autor</a>.<br>';
		...
		formrediseño.innerHTML += 'Diseño "LoomySkin" de <b>Jack_Hack</b> ---> <a href="http://www.ultra-zone.es/">Web del autor</a>.<br>';
		...
		formrediseño.innerHTML += 'Diseño "TuentiRed" de <b>Jack_Hack</b> ---> <a href="http://userstyles.org/styles/19955">Web del diseño</a>.<br>';
		...
		formrediseño.innerHTML += 'Diseño "TuentiPink_mariconada" de <b>Jack_Hack</b> ---> <a href="http://userstyles.org/styles/19958">Web del diseño</a>.<br>';
		...
		formrediseño.innerHTML += 'Diseño "tuentiblue II (PINK VERSION)" de <b>Jack_Hack</b> ---> <a href="http://userstyles.org/styles/20143">Web del diseño</a>.<br>';
		...
		menu.innerHTML += '<hr><h1>Radio:</h1><br>La radio ha sido creada y recopilada por <b>DJMeu</b>, <b>Jack_Hack</b> y <b>Nodsert</b>.<br><br><b>Las radios son:</b><br>Euro Dance<br>Europa FM<br>AH.FM - The Best in Trance & Progressive<br>MakinaMania<br>Reggaeton 94<br>RTVE<br>Cadena 100<br>Onda Cero<br>Kiss FM<br>Loca FM<br>FlaixFM<br>MasterFM<br>PQTP Radio Urbana<br>';
		menu.innerHTML += '<hr><h1>Webs recomendadas:</h1><br><center><a href=""></a><br> <a href="http://www.gccsoft.es.kz/"><img src="http://fixcler.files.wordpress.com/2009/02/hacking-full1.jpg"></a> </a>';

		botonaceptar = document.createElement("button");
		botonaceptar.appendChild(document.createTextNode("Save"));
		...
		botoncancelar.appendChild(document.createTextNode("Cancel"));
		...
		botonactualizar.appendChild(document.createTextNode("Update"));
		...
		botoninstalar.appendChild(document.createTextNode("Install last version"));
...
function menufoto(){
	if (document.getElementById("menufoto") == null) {
		...
		botondescargar.appendChild(document.createTextNode("Bajar"));
