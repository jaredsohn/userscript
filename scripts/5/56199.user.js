...
function getTinyAndInsert_BitLy(event) {
  ...
  GM_xmlhttpRequest({
		method: 'GET',
		url: "http://api.bit.ly/shorten?version=2.0.1&login=rickyli&apiKey=R_91b348b72c41f9722a792cd032ed7ec3&format=xml&longUrl=" + thelongurl,
		onload: function(responseDetails) {
...
function saveBookmark(event){
	...
	GM_xmlhttpRequest({
		method: 'POST',
		url: 'http://zhanlu-api.appspot.com/api/statuses/update.xml', 
