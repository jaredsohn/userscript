// ==UserScript==
// @name           Friendstock AutoBoost (X)
// @description    Auto boosting script. For Friend Stock Xtreme server WORKS ONLY ON PRO or VIP ACCOUNTS (Warning this script is a ALFA version)
// @version        0.0.1
// @creator        by BrAiNee
...
// SCRIPT STARTS HERE
var minutes      = 5; //set the boost intervall
var emerreload   = 60; //complete page reload
...
function main()
{
	...
	hec.appendChild(document.createTextNode("Friendstock Autoboost 0.01 (X) loaded"));
...
setTimeout('window.open(\"' + home_url + '\", "FSXAB-Window")', minutes*60000);
