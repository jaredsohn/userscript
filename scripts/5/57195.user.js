...
// @description Adds various useful buttons to the Ogame Menu (Sources traduites et modifiées pour fonctionner avec OGame.fr "by Joe`")
// @include http://*.ogame.*/*
// ==/UserScript==
