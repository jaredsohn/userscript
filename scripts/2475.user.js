...
// @description    Blocks Amazon sponsored links
...
var ads=document.evaluate("//SPAN[@class='h1']/.. | //IMG[contains(@src,'grey-pixel')]",document,null,XPathResult.UNORDERED_NODE_SNAPSHOT_TYPE,null);
for(var i=0;i<ads.snapshotLength;i++)
{
var workItem=ads.snapshotItem(i);
