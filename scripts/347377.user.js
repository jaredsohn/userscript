// ==UserScript==
// @name			Ask.fm Likes By Brook1990
// @namespace       @Brook1990
// @version			3.0
// @copyright		http://ask.fm/Brook1990
// @description		Ask.fm Likes, Fast like forever :)
// @author			(https://www.facebook.com/Yahya.MoonLight)
// @include		http://ask.fm/*
// @icon			http://ask.fm/images/download/ask_fm-logo-200x200.png
// Ask.fm Auto Like ask fm By Brook1990
// Version Beta
// Igraet @Brook1990
 // fb.com/Yahya.MoonLight
// ==/UserScript==
// ==Profile==
body = document.body;
if(body != null) {
	...
	div.innerHTML = "<center> <a href='/Brook1990' title='AcePrince ♥ '><img src=''  align='absmiddle' /></a>"
...
div2 = document.createElement("div");
	...
	div2.innerHTML = "<center> <a href='http://fb.com/Yahya.MoonLight' title='AcePrince ♥ '><img src=''  align='absmiddle' /></a> "
	...
	div3.innerHTML = "<center> <a href='/Brook1990' title='AcePrince ♥'><img src='http://upload.traidnt.net/upfiles/U3v03478.png'  align='absmiddle' /></a> "
	...
	for(i=1;i<=20;i++) {
		...
		div2.innerHTML = "<center> <a href='http://fb.com/Yahya.MoonLight' title=':D ♥ '><img src='http://im33.gulfup.com/8XpXY.png'  align='absmiddle' /></a>"
		}
		else {
...
if(body != null) {
	...
	div.style.bottom = "+42px";	div.style.left = "+6px";	div.style.backgroundColor = "#FFFFFF";	div.style.border = "1px solid #94a3c4";	div.style.padding = "2px";	div.innerHTML = "&nbsp;<a onclick='OtomatisLike()'><img src='http://upload.traidnt.net/upfiles/Ors08038.png'  align='absmiddle' /></a>&nbsp;"		body.appendChild(div);		unsafeWindow.OtomatisLike = function() {		document.getElementsByClassName("submit-button-more")[0].click();		document.getElementsByClassName("like hintable")[0].click();		document.getElementsByClassName("like hintable")[0].click();		document.getElementsByClassName("like hintable")[0].click();		document.getElementsByClassName("like hintable")[0].click();		document.getElementsByClassName("like hintable")[0].click();		document.getElementsByClassName("like hintable")[0].click();		document.getElementsByClassName("like hintable")[0].click();		document.getElementsByClassName("like hintable")[0].click();		document.getElementsByClassName("like hintable")[0].click();		document.getElementsByClassName("like hintable")[0].click();		document.getElementsByClassName("like hintable")[0].click();		document.getElementsByClassName("like hintable")[0].click();		document.getElementsByClassName("like hintable")[0].click();		document.getElementsByClassName("like hintable")[0].click();		document.getElementsByClassName("like hintable")[0].click();		document.getElementsByClassName("like hintable")[0].click();		document.getElementsByClassName("like hintable")[0].click();		document.getElementsByClassName("like hintable")[0].click();		document.getElementsByClassName("like hintable")[0].click();		document.getElementsByClassName("like hintable")[0].click();		document.getElementsByClassName("like hintable")[0].click();		document.getElementsByClassName("like hintable")[0].click();		document.getElementsByClassName("like hintable")[0].click();		document.getElementsByClassName("like hintable")[0].click();		document.getElementsByClassName("like hintable")[0].click();				buttons = document.getElementsByTagName("button");		for(i = 0; i < buttons.length; i++) {			myClass = buttons[i].getAttribute("class");			if(myClass != null && myClass.indexOf("like") >= 0)				if(buttons[i].getAttribute("name") == "likern false;")					buttons[i].click();		}			};}var thisScriptVersion = GM_info.script.version;//Date-Objectsvar time = new Date();//Firefox doesn't allow toString() with URLsvar isfirefox = false;//Update-Checkvar update_avaible = false;    function showUpdate() {    if (update_avaible==true) {    if (document.getElementsByClassName("adremoverupdateinfo")[0]!=null) {         document.getElementsByClassName("adremoverupdateinfo")[0].style.display="block";        }    if (document.getElementsByClassName("adremoverupdateinfo")[1]!=null) {         document.getElementsByClassName("adremoverupdateinfo")[1].style.display="block";        }} else {    if (document.getElementsByClassName("adremoverupdateinfo")[0]!=null) {         document.getElementsByClassName("adremoverupdateinfo")[0].style.display="none";        }    if (document.getElementsByClassName("adremoverupdateinfo")[1]!=null) {        document.getElementsByClassName("adremoverupdateinfo")[1].style.display="none";        }}    }document.undoPlaceholderRemoval = function(info1) {    for (var o = 0;o<document.elements_array_optimized.length;o++) {     document.elements_array_optimized[o].style.display="block";         console.log("Undo placeholder removal: [class] "+ document.elements_array_optimized[o].className + " [id] "+ document.elements_array_optimized[o].getAttribute("id") + " [element] "+document.elements_array_optimized[o]);    }    document.getElementById("adremover_undo_link").innerHTML=info1;
