...
window.createQuickbarShortcuts = function() {
	"<tr>   " + 
	newShortcut("http://ro1.the-west.ro/images/bank/city.png", "javascript:AjaxWindow.show('building_cityhall');", "Primarie");

newShortcut("http://bsienok.bs.funpic.org/thewesttoolbar/saloon.png", "javascript:AjaxWindow.show('building_saloon');", "Saloon");
newShortcut("http://bsienok.bs.funpic.org/thewesttoolbar/church.png", "javascript:AjaxWindow.show('building_church',{town_id:xx},'xx');", "Biserica");
newShortcut("http://bsienok.bs.funpic.org/thewesttoolbar/bank2.png", "javascript:AjaxWindow.show('building_bank',{town_id:xx},'xx');", "Banca");

newShortcut("http://bsienok.bs.funpic.org/thewesttoolbar/hotel3.png", "javascript:AjaxWindow.show('building_hotel',{town_id:xx},'xx');", "Hotel");

newShortcut("http://bsienok.bs.funpic.org/thewesttoolbar/gunsmith2.png", "javascript:AjaxWindow.show('building_gunsmith',{town_id:xx},'xx');", "Armurier");
newShortcut("http://bsienok.bs.funpic.org/thewesttoolbar/tailor3.png", "javascript:AjaxWindow.show('building_tailor',{town_id:xx},'xx');", "Croitor");

newShortcut("http://bsienok.bs.funpic.org/thewesttoolbar/general3.png", "javascript:AjaxWindow.show('building_general',{town_id:xx},'xx');", "Magazin");

newShortcut("http://bsienok.bs.funpic.org/thewesttoolbar/mortician.png", "javascript:AjaxWindow.show('building_mortician',{town_id:xx},'xx');", "Cioclu");
