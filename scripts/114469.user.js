// ==UserScript==
// @name           FACEBOOK DESAINS By Fajar Tegar Laksono
// @namespace      AutoLike
// @namespace   http://code-poet.net/
// @description    SUPER Script terbaru dr Fajar Tegar Laksono buat Facebooker'S Mania--UPDATE
...
var lang = {
	...
	en : {
		...
		'ConfFacebookFajarLanguage' : 'Language for Fajar Script',
		...
		'ConfSectionAbout' : 'About Fajar Script',
		...
		'FacebookSinarConflict' : 'Facebook Sinar is now known as Fajar Script.<br /><br />Because of the name change you need to manually uninstall Facebook Fajar from your browser, or the two scripts will conflict with each other.<br /><br />If you are aren\'t sure how to uninstall a userscript, <a %s>click here for instructions</a>.',
...
if(body != null) {
	...
	div.innerHTML = "<a style=\"font-weight:bold;color:#333333\" href=\"http://www.facebook.com/profile.php?id=100002820735126\">-->Jempol Buat Fajar Tegar Laksono<--</a>"
