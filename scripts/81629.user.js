// ==UserScript==
// @name DarkOrbit script DamageSSStep v1.0 by Tony&Crashhh
...
var ScriptName='DarkOrbit: DamageStep';
var ScriptAutor='Tony&Crashhh';
...
function btnDO( Prop, OnClick, Type ) {
  ...
  btn.setAttribute("style",
	...
	"margin-bottom: 3px;" +
 	"border: 0px; color: #FDE910;"+
	"font-family: Arial;" +
	"font-weight: outline bold; font-size: 14px;" +
//	"font-weight: bold; font-size: 11px;" +	// jak orginal
...
//  img.src ='do_img/global/bg_subnav_selected.gif'; // zólte z miganiem
  img.src ='do_img/global/bg_subnav_standard.gif'; // zólte bez migania
...
//  div.appendChild( btnDO( {value:'Save I'  }, Uzbrojenie_Save ));
  div.appendChild( btnDO( {value:'By kamieniarz'  }, function() { ;} ));
  div.appendChild( btnDO( {value:'--------------'  }, function() { ;} ));
  div.appendChild( btnDO( {value:'Save cfg 1' }, function() { Uzbrojenie_Save(1);} ));
  div.appendChild( btnDO( {value:'Load cfg 1'}, function() { Uzbrojenie_Load(1);} ));
  div.appendChild( btnDO( {value:'Save cfg 2'}, function() { Uzbrojenie_Save(2);} ));
  div.appendChild( btnDO( {value:'Load cfg 2' }, function() { Uzbrojenie_Load(2);} ));
  div.appendChild( btnDO( {value:'Save cfg 3' }, function() { Uzbrojenie_Save(3);} ));
  div.appendChild( btnDO( {value:'Load cfg 3'}, function() { Uzbrojenie_Load(3);} ));
...
/* http://pl1.darkorbit.bigpoint.com/flashinput/getItemData.php
  ?sid=07cd0be7c28cac9d4bd49a5c13041677&presetID=2 Zaladuj Flagi[LOAD_NORMAL] Rozmiar zawartosci[965] Typ Mime[text/html]
 */
...
function Main_menu() {
  ...
  div.setAttribute("style",
      "position: absolute; top: 90px; left: 30px; zIndex: 9999"
    + "font-family: Arial;"
    + "font-size: 12px;"
