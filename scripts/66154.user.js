// ==UserScript==
// @name        X-tra Weiterbildungsende TK
// @namespace    basti1012 kingfr3sh & das_bazie fixed by tooBIG
...
// @exclude		 http://change.serserionline.com/*
// @exclude		*.serserionline.com/redirect/?site=*
// ==/UserScript==
...
var vor_penner_training_wait = 'Bir sonraki eğitim bekleme listesinde</div>';
	...
	url: ""+gamelink+"/skills/",
		onload: function(response) {
			var content = response.responseText;
				...
				var stufe1 = content.split('</span> [Aşama ')[1].split(']')[0];
				}catch(e){}
				try{
				var stufe2 = content.split('</span> [Aşama ')[2].split(']')[0];
				}catch(e){} 
				...
				var weiterbildung_0_2 = "<div class=\"prozentbalken_bg_1\"><div class=\"prozentbalken_1\" id=\"active_prozent_1\" style=\"width:"+width_balken0+"px;>"+percger0+"&#37;</div></div>";
					...
					var weiterbildung_0_2 = "<div class=\"prozentbalken_bg_1\"><div class=\"prozentbalken_1\" id=\"active_prozent_1\" style=\"width:"+width_balken+"px;>"+percger+"&#37;</div></div>";
						...
						var weiterbildung_0_1 = "<font color=\"#FFFFFF\"><b>Weiterbildung!!!</b> </font>";
