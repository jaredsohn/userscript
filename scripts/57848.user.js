// ==UserScript==
// @name            Important Blog Ignorer
// @namespace       Platypus
// @include         http://runescape.salmoneus.net/forums/index.php?autocom=blog
// ==/UserScript==
function do_platypus_script() {
erase_it(window.document,document.evaluate('/HTML[1]/BODY[1]/DIV[1]/H3[1]', document, null, XPathResult.FIRST_ORDERED_NODE_TYPE,null).singleNodeValue,null,null,null);
erase_it(window.document,document.evaluate('/HTML[1]/BODY[1]/DIV[1]/DIV[10]', document, null, XPathResult.FIRST_ORDERED_NODE_TYPE,null).singleNodeValue,null,null,null);
erase_it(window.document,document.evaluate('/HTML[1]/BODY[1]/DIV[1]/H3[2]', document, null, XPathResult.FIRST_ORDERED_NODE_TYPE,null).singleNodeValue,null,null,null);
