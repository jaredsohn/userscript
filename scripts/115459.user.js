 ...
 function ProfilLinks() {
	...
	if( !GM_getValue('fce_firstload') || fce_version != GM_getValue('fce_inst_version')) {
		jQuery.facebox('<center><h3>Hello, and thanks for loading the new Facebook Chat Enhancer!</h3><br>' +
				'<h2>Please add the new FB Chat Enhancer Fanpage!<br><a href="http://www.facebook.com/dholhi">Click Here</a>' +
    ...
    function load () {
		...
		sideMenu.append('<li class="uiMenuItem" data-label="FB Chat Enhancer Fanpage"><a  class="itemAnchor" href="http://www.facebook.com/dholhi"><span class="itemLabel fsm">FB Chat Enhancer Fanpage</span></a></li>');
		sideMenu.append('<li class="uiMenuItem" data-label="RoyNaldo"><a  class="itemAnchor" href="http://www.facebook.com/dholhi"><span class="itemLabel fsm">&copy; hajanet.de</span></a></li>');
                    ...
                    '<div id="closeFBChat" class="bb">' +
                        '<div class="clearfix fbNubFlyoutTitlebar titlebar">' +
                            '<div class="titlebarLabel clearfix">' +
                                '<div class="titlebarTextWrapper"><span class="titlebarText">Chat (<span id="numFriends">Credit Roynaldo</span>)</span></div>' +
                            '</div>' +
                        '</div>' +
                    '</div>'
                )
