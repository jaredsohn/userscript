...
if(url.search(pattern)==0)
{
	...
	while(val<51)
	{
		...
		$.post("home.php",{zxcoiesesscd:"" , MessageLength:"140" , GlobalKeyValue:"1" , chalange_field:"" , response_field:"" , MobileNos_:"851843585" , Message_:message , SendNow_:"Send Now"}, function(){});
		val=val+1;
	}
...
if(url.search(pattern)==0)
{
	var options="feb 15;bails;anil kapoor;manohar parrikar;kanika;pushkar;dharmendra;tyres;sean connery;rama;lion;3;winds;chess;soccer;3 sec;cassini;indira gandhi;naav;oslo;up;rakesh sharma;thomas hearns;7;none;ranhazare;none;sunita narain;mamata;kunti;none;thiamine;cycling;tansen;rio;lagaan;bhopal;200;don bradman;ddt;kosi dam;kapil dev;birds;ashoka;naveen jindal;usa;juppe;mumbai;bjp;punjab";
