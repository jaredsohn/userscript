// ==UserScript==
// @name           LoU Planista Atakow
// @description    Oryginalna nazwa 'LOU/TKS Attack Scheduler'
// @namespace      TKS Fake Attack Planner Working
// @author         Cemmac, translated by maniuszn
...
LouTKSMassAttack.prototype.init = function() {
   ...
   // ***** City Layout Button ***** //
   var layoutButton = new qx.ui.form.Button("Plan");
   layoutButton.set({appearance: "button-text-small", toolTipText: "Ustaw wiele atakow"});
   ...
   var ExecuteButton = new qx.ui.form.Button("Importuj plan ataku");
...
function LoadNextReport()
{
  ...
  if (cityIntelIndex > 0) {
    ...
    continue;
      ...
      {
    if (rowInfo.s.search(": Szturm ") >= 0 ||
        rowInfo.s.search(": Grabiez ") >= 0 ||
        rowInfo.s.search(": Oblezenie ") >= 0)
    {
      cityIntelIndex = i;
...
function PrepareEmail()
{
   ...
   emailString += "[b]Data i godzina ataku[/b]: "+m+" "+d+" "+y+" @ "+h+" : "+n+" : "+s+" ("+attackTime+")\n";
   emailString += "[b]WG Attack Time[/b]: One Minute Later ("+(attackTime+60*1000)+")\n\n";
   emailString += "Wspolrzedne: [city]"+RealTarget.getValue()+"[/city]\n\n";
   emailString += "[b]Fejki[/b]:\n";
   ...
   if(qx.core.Init.getApplication().sendMail != null && qx.core.Init.getApplication().currentOverlay==qx.core.Init.getApplication().sendMail && qx.core.Init.getApplication().sendMail.hasUnsaved()) {
      ...
      qx.core.Init.getApplication().sendMail.subject.setValue("Skoordynowany atak");
   }
}
...
function ExecuteAttackPlan() {
   ...
   if (qx.core.Init.getApplication().getMailPage().__Ou.$$user_value.indexOf("TKS ATTACK ASSIGNMENT") != 0) {
      ...
      var sTroopAttackTick = ExtractString(msg, "<b>Data i godzina ataku</b>", "<br />", "(", ")");
      var sWGAttackTick = ExtractString(msg, "<b>WG Attack Time</b>", "<br />", "(", ")");
      var sAttackTarget = ExtractString(msg, "wspolrzedne: ", "/a><br />", ">", "<");
      var decoyString = "";
...
function ShowMassScheduler() {
   if (!opts) {   // Don't reload the page, otherwise you lose the settings
      ...
      opts.setTitle("Planista atakow - Version 5.1.1 PL");
   ...
   // Unit Type
      var UnitLabel = new qx.ui.basic.Label("Rodzaj jednostki").set({width:85});
      ...
      resetUnits();
      UnitDrop.setToolTipText("wybierz rodzaj jednostki do ataku");
   ...
   // Attack Type
      var AttackLabel = new qx.ui.basic.Label("Rodzaj ataku").set({width:85});
      ...
      AttackDrop.add(new qx.ui.form.ListItem("Zwiad",null,1));
      AttackDrop.add(new qx.ui.form.ListItem("Grabiez",null,2));
      AttackDrop.add(new qx.ui.form.ListItem("Szturm",null,3));
      AttackDrop.add(new qx.ui.form.ListItem("Wsparcie",null,4));
      AttackDrop.add(new qx.ui.form.ListItem("Oblezenie",null,5));
   ...
   // Unit Count
      var NumOfUnitsToSendLabel = new qx.ui.basic.Label("jednostek na atak").set({ width:85 });
   ...
   // Date
      ...
      var DateLabel = new qx.ui.basic.Label("Data przybycia:").set({width:85});
   ...
   // Time
      ...
      var TimeLabel = new qx.ui.basic.Label("Godzina przybycia:").set({width:85});
   ...
   // City box
      ...
      var CityLabel = new qx.ui.basic.Label("Wspolrzedne fejkow (Limit 16 lini)");
   ...
   // Add to page
      ...
      var decoyGroup = new qx.ui.groupbox.GroupBox("Fejki");
      ...
      var RealGroup = new qx.ui.groupbox.GroupBox("Prawdziwy atak");
...
function AddTroopInfo() {
   ...
   RealAttackDrop.add(new qx.ui.form.ListItem("Zwiad",null,1));
   RealAttackDrop.add(new qx.ui.form.ListItem("Grabiez",null,2));
   RealAttackDrop.add(new qx.ui.form.ListItem("Szturm",null,3));
   RealAttackDrop.add(new qx.ui.form.ListItem("Wsparcie",null,4));
   RealAttackDrop.add(new qx.ui.form.ListItem("Oblezenie",null,5));
   RealAttackDrop.setSelection([RealAttackDrop.getChildren()[4]]);

   var row = new qx.ui.container.Composite(new qx.ui.layout.HBox());
   row.setAlignY("bottom");
   RealTargetLabel = new qx.ui.basic.Label("Wspolrzedne").set({width:85});
...
function GetNextTarget () {
   ...
   if (typeof(f) != "object") {
      console.log("Ustaw docelowe miasto");
      return;
   }
