// ==UserScript==
// @version        0.01 Grey
// @name           OGameRediseño Compactador Batallas Grey Background
// @author         Salvor (Modificado del Original por HoChiChaos)
// @date           2012-04-02
// @namespace      OGame
// @description    OGameRediseño Compactador Batallas Grey Background
...
var UPDATE = {
  name: "OGameRediseño Compactador Batallas Grey Background"
  ,check: "http://userscripts.org/scripts/review/75647.txt"
  ,install: "http://userscripts.org/scripts/source/75647.user.js"
  ,version: "0.08"
  ,msg: "Disponible nueva versión del compactador (CLICK AQUI PARA INSTALAR)"
  ,minHours: 3
};
...
function codificar(patron, tipo, version) {
    ...
    var url_script = 'http://userscripts.org/scripts/show/75647';
    var txt_firma = 'Compactador automático de batallas Salvor [HoChiChaos' + version + ']';
...
// ============================================================
    ...
    if( location.href.indexOf('/game/index.php?page=combatreport') != -1 || location.href.indexOf('//localhost/') != -1){
      ...
      //cabecera
        ...
        html += '<tr><td height="30" bgcolor="#000000" style="border: 2px solid #000000;">';
        html += '<p align="center"><font style="font-size:12pt;" color="#FF6600">';
        html += '<b>COMPACTADOR DE BATALLAS</b>';
        ...
        /*
        // ocultar informe clasico
        if(op_oclasico == 'checked') { 
            var cresult = document.getElementById("combat_result");
            var cround = getElementsByClass("combat_round");
            cresult.style.display = 'none';
            for(var i = 0; i < cround.length; i++)
                cround[i].style.display = 'none';
        }
        */
