// ==UserScript==
// @name           siguiendonos creceremos!
// @namespace      siguiendonos
// @description    Script para la comunidad siguiendonos creceremos
// @include        *taringa.net/*
// @exclude        *taringa.net/comunidades/siguiendomos-creceremos/*
// ==/UserScript==
...
byClass('menuTabs').innerHTML += "<li id=\"tabbedWTF\" class=\"tabbed\">\n <a href=\"http://www.taringa.net/comunidades/siguiendomos-creceremos/\" onclick=\"menu(\'Siguiendonos creceremos! \', this.href);return false;\" title=\"Ir a la comunidad Siguiendonos creceremos!\">Siguiendonos! <img src=\n\"\" alt=\"\" /></a>\n</li>";
