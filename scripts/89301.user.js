	...
	var grepoFarmer = ( function() {
		...
		var bindDurationCounter_new = function() {
			if (TownInfo.type === 'farm_town_info') {
				...
				var html = '<div style="position: absolute; width: auto; right: 107px; top: 235px;">'
						...
						+ '<label><input type="checkbox" id="tilx_booty"> <em>Zsákmánnyal</em></label>'
						+ '</div>'
						+ '<div class="tilx_infos" style="background-image:url('
						+ images.mood_drop
		...
		return function() {
			...
			if (document.URL.indexOf('game/map') !== -1) {
				...
				uW.PopupFactory
						.addTexts( {
							tilx_res :'Az aktuális támadás maximális zsákmánya',
							tilx_mood_drop :'Az aktuális támadás hangulatcsökkentése (mikor teljesen kifosztott)',
							tilx_strength_drop :'Az aktuális támadás erőcsökkentése (mikor teljesen kifosztott)',
							tilx_strength :'Az aktuális támadás növelő ereje',
							tilx_strength_prev :'Az előző támadások erőnövelése',
							tilx_strength_now :'A nomád falu aktuális ereje',
							tilx_strength_total :'Új erő összesen'
						});
			}
		}
	}());
