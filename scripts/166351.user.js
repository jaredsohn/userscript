...
var amount   = parseInt(GM_getValue("amount",4500));
...
Auto payback player <input type=\"text\" style=\"border: 1px solid blue; width: 4em; color: #5858FA; background: black; text-align: center;\" id=\"autolistNum\" value=\""+autolistNum+"\" /> times for <input type=\"text\" style=\"border: 1px solid blue; width: 4em; color: #5858FA; background: black; text-align: center;\" id=\"amount\" value=\""+amount+"\" /> bounty<br>\
    \
