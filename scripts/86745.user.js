...
// @require       http://usocheckup.dune.net/8712.js
// ==/UserScript==
...
function inYoFace () {
  ...
  //new album images
  var newAlbumImages = document.evaluate("//a[@class='uiMediaThumb uiMediaThumbHuge']/i", document, null, XPathResult.UNORDERED_NODE_SNAPSHOT_TYPE, backgroundImages); 
