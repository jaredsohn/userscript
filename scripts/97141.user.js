...
// @author       sageo[http://berlin.pennergame.de/profil/id:1146285/]j
// @description  Stellt zahlreiche kleine und große Hilfen rund um das Thema Kämpfen zur Verfügung (HH, B, M, New York, Paris, Marseille, Warschau, Krakau, Madrid, Buenos Aires, Rio de Janeiro, Sao Paolo, St. Petersburg)
...
// @version      1.5.0 tłumaczenie Krzychu
// ==/UserScript==

// Daten über das aktuelle Skript für den Update-Mechanismus
var THISSCRIPTVERSION = "1.5.0";
var THISSCRIPTNAME = "Fightinfo PL";
var THISSCRIPTINSTALL_URL = 'http://userscripts.org/scripts/show/97141';           // URL für Hauptseite bei userscripts.org
var THISSCRIPTSOURCE_URL = 'http://userscripts.org/scripts/source/97141.user.js';  // Skript-URL bei userscripts.org
...
var flags = new Array();
    ...
    flags[1] = 'http://www.abload.de/img/united_kingdom67b7.png';
...
// Wenn in Krakau gespielt wird
	...
	currency = 'zl';
// Wenn in Krakau gespielt wird
} else if (location.toString().indexOf("reloaded.menelgame") != -1) {
	var TOWNBASE_URL = 'http://reloaded.menelgame.pl/';
	var ZONEBASE_URL = ''; 
	var TOWNEXTENSION = 'KR';
	var DFTownCode = "";
	var lang = 2;
...
var TxtAbility1 = new Array();
    ...
    TxtAbility1[2] = ' zdolności są już rozpoczęte';
...
var TxtLang = new Array();
    ...
    TxtLang[1] = "Language: english";
    TxtLang[2] = "Język: polski";
...
var TxtUserPoints = new Array();
    ...
    TxtUserPoints[2] = 'W tej chwili gracz ma %s punktów';
...
var TxtWaitAttack = new Array();
    ...
    TxtWaitAttack[2] = 'musisz odczekać %sh przed następnym atakiem.';
...
var TxtFightCom = new Array();
    ...
    TxtFightCom[2] = 'Jeśli chcesz, dopisz informacje o walce:';
...
var TxtFight = new Array();
    ...
    TxtFight[2] = 'Walka została opisana';
...
var TxtFights = new Array();
    ...
    TxtFights[2] = 'Walki zostały opisane';
...
var TxtPostPreMsg2 = new Array();
    ...
    TxtPostPreMsg2[2] = 'Trwające na mnie ataki:\n\n';
...
var TxtCheckFights = new Array();
    ...
    TxtCheckFights[2] = 'Wybież walkę do opisania w Soutboxie!';
    ...
    TxtCheckFights[6] = 'Пожалуйста бои, которые должны быть посланы крестиком маркировать!';
...
var TxtPostTitle = new Array();
    ...
    TxtPostTitle[2] = 'Opisz walki bezpośrednio w Shoutboxie';
    ...
    TxtPostTitle[6] = 'Маркирование бои в шаутбокс послать.';
...
var TxtPostTitle2 = new Array();
    ...
    TxtPostTitle2[2] = 'Opisz atak na %s w Shoutboxie.';
...
var TxtUpToPage = new Array();
    ...
    TxtUpToPage[2] = 'z ilu ostatnich stron:';
...
var TxtShowBBCode = new Array();
    ...
    TxtShowBBCode[2] = 'pokaż opis w BBCode';
...
var TxtMyFav = new Array();
    ...
    TxtMyFav[1] = 'My favourite opponents';
    TxtMyFav[2] = 'Moi ulubieńcy do klepania :)';
...
var TxtAddMarkedToFT = new Array();
    ...
    TxtAddMarkedToFT[2] = 'Dodaj do listy Moich ulubieńców';
    ...
    TxtAddMarkedToFT[6] = 'Маркированные записи добавить в лист с боями';
...
var TxtAdded1ToFT = new Array();
    ...
    TxtAdded1ToFT[6] = '1 запись была добавлена в лист с боями';
...
var TxtAddedToFT = new Array();
    ...
    TxtAddedToFT[6] = '%s запис. были добавлены в лист с боями';
...
var TxtNoAddedToFT = new Array();
    ...
    TxtNoAddedToFT[6] = 'Все записи были уже добавлены в лист с боями';
...
var TxtCheckBums = new Array();
    ...
    TxtCheckBums[6] = 'Пожалуйста все бомжи, которые добавлены должны быть, крестиком маркировать!';
...
var TxtAdd1ToFT = new Array();
    ...
    TxtAdd1ToFT[6] = 'Бомжи были добавлены к листу с боями !';
...
function ReplaceFightSearchIDs(userid, nrofpastfights, stats) {
	...
	function GetFightstring(nrofpastfights) {
		...
		switch (nrofpastfights) {
			case 0: {
				return fightstring = ' Jeszcze nie walczyłeś';
			}
			case 1: {
				return fightstring = ' 1 walki';
			}
			default: {
				return fightstring = nrofpastfights + ' walk';
			}
		}
	}
	...
	for (var i = 1; i <= nrofids; i++) {
		...
		if (infoimg != null) {
			...
			var fightstring = GetFightstring(nrofpastfights) + ((nrofpastfights > 0) ? " (W/R/P/TU/UP: " + stats + ")" : "");
...
function GetIconInsertHTML(userid, username, fighttime) {
	...
	if (userid != m_ownuserid)
		IconInsertHTML = IconInsertHTML + '<a href="' + FIGHTSEARCH_URL + username + '" target="_blank"><img border="0" id="fightsearchid:' + userid + "_" + (GetNrOfIDs(document, 'fightsearchid:' + userid) + 1) + '" src="' + lastfighticon + '" title="Bilans: -noch nicht ermittelt- Kämpfe z ' + username + lastfightadditionalinfo + '" height="14" width="14" alt="O" style="padding-left: 3px; padding-right: 4px;"></a>'
	else if (fighttime != "x")
	...
	if (fighttime != "" && fighttime != "x" && fighttime != "nofight") {
		...
		IconInsertHTML = IconInsertHTML + '<img id="' + username + "*" + fighttime + '" border="0" src="' + fightcommenticon + '" title="Dodaj komentarz do walki" height="14" width="14" alt="O" style="cursor: pointer">'
	}
	...
	if (userid == m_ownuserid && fighttime != "x")
		...
		IconInsertHTML = IconInsertHTML + '<a href="' + FIGHTTO_URL + username + '" target = "_blank"><img id="' + username + '*attack" border="0" src="' + ICON_ATTACK + '" title="Zaatakuj ' + username + '" height="14" width="14" alt="O" style="cursor: pointer"></a>';
...
function InsertSubmitButton(content, table, inGang) {
	...
	newdiv.innerHTML = '<div style="vertical-align:middle;background-color: rgb(42, 42, 42);padding:7px;float:left;width:200px><form name="bande"><span class="tiername">Szukaj wg bandy </span><input id="gangfilter" type="text"</form></div>';
	...
	{ 
		...
		newtd = document.createElement("td");
		newtd.setAttribute("colspan", "2");
		newtd.innerHTML = 'Trwa ładowanie walk, musisz chwile poczekać';
		newtr.appendChild(newtd);
...
function HandleProfile() {
	...
	if (ZONEBASE_URL != "" || userid != m_ownuserid) {
		...
		if (ZONEBASE_URL != "")
			...
			var Txt = "Informacje";
		newtr.getElementsByTagName("td")[2].innerHTML = '<strong>' + Txt + ' o walkach z ' + username + '</strong>';
...
function PrepareFightTable(table) {
	...
	newtd.innerHTML = "1";
	newtd.innerHTML = '<input name="FTCheckbox" id="FTCheckbox" type="checkbox"><span style="vertical-align: bottom">&nbsp;Włącz listę ulubieńców</span>';
	newtr.appendChild(newtd);
...
function InsertFightTable(fightIDList) {
	...
	function InsertHead(table, nrofcolumns) {
		...
		newtr.getElementsByTagName("th")[2].innerHTML = "Menel";   // Username
		newtr.getElementsByTagName("th")[2].setAttribute('style', 'width: 145px');

		newtr.getElementsByTagName("th")[3].innerHTML = "Banda";     // Bandenname
		newtr.getElementsByTagName("th")[3].setAttribute('style', 'width: 150px');

		newtr.getElementsByTagName("th")[4].innerHTML = "Punkty";    // aktuelle Punktzahl
		newtr.getElementsByTagName("th")[4].setAttribute('style', 'width: 75px; text-align: right; padding-right: 10px');
		
		newtr.getElementsByTagName("th")[5].innerHTML = "Rejestracja"; // Registrierungsdatum
		newtr.getElementsByTagName("th")[5].setAttribute('style', 'width: 65px');

		newtr.getElementsByTagName("th")[6].innerHTML = "Kasa";   // Geld
...
function InsertDFTable(id) {
	...
	GM_xmlhttpRequest({method: 'GET', url: DFurl[id], onload: function(responseDetails) {
		...
		if (responseDetails.status == 200) {
			...
			var dftable = divs[currentdiv].getElementsByTagName("table")[0];
