...
function eRepBarCompanyManagement(){
    ...
    var eRepBarCompanyManagement =     '<h3 id="erbCompanyName"><div id="erbCMcompanyName">Company Management</div><div class="executeButton" style="font-size: 12px; margin-left: 5px; position: relative; top: -20px;" id="CMsaveWages">Save Wages</div></h3>' +
...
function eRepBarProductivity(){
    ...
    var eRepBarProductivity =     '<h3>Productivity Calculator</h3>' +
...
function eRepBarEmpresas(){

    var eRepBarEmpresas =     '<h3>Empresas</h3>' +
                         '<div>' +
                                '<ul style="list-style-type:circle; padding-left: 15px;">' +
                               '<li><a href="http://www.erepublik.com/es/company/a-sword-div-metal-90-vit-198610">A.SWORD div. metal</li>' +
			       '<li><a href="http://www.erepublik.com/es/company/armas-crisol-207657">Armas Crisol</li>'+
			       '<li><a href="http://www.erepublik.com/es/company/epona-travels-212478">Epona Travels</li>'+
			       '<li><a href="http://www.erepublik.com/es/company/centro-pokemon-182236">Centro Pokemon</li>'+
					'<li><a href="http://www.erepublik.com/es/company/casas-de-obsidiana-225956">Casas de obsidiana</li>'+
				   '<li><a href="http://www.erepublik.com/es/company/poketienda-216753">Poketienda</li>'+
				   '</div>' ;

$('#eRepBarContent').empty();
$('#eRepBarContent').append(eRepBarEmpresas);

}
function eRepBarMartel(){
   var eRepBarMartel =     '<h3>Casa Martel</h3>' +
                         '<div>' +
                                '<ul style="list-style-type:circle; padding-left: 15px;">' +
                   '<li><a href="http://www.erepublik.com/es/organization/2604781">Organizacion</li>' +
			       '<li><a href="http://spreadsheets.google.com/ccc?key=0Ar_ia1Kx8PD5dFBHdDZnNjh5N1VpbzQ1ZUNUeGhkaGc&hl=es">Tabla Pretoriana</li>'+
			       '<li><a href="http://spreadsheets.google.com/ccc?key=0AkaFs7-dNKvMdG1lVllyTnZWUGQzclhUaDdnalBmUVE&hl=es">Tabla nazi</li>'+
			       '<li><a href="http://spreadsheets.google.com/ccc?key=0Ar_ia1Kx8PD5dFNZcHpLbVZ5c3hUb19XZnFma1ExMEE&hl=es">????????????</li>'+
			'</div>'+
			'<h3>Mercados</h3>' +
                        '<div>' +
                                '<ul style="list-style-type:circle; padding-left: 15px;">' +			
	   			   '<li><a href="http://www.erepublik.com/es/market/country-15-industry-3-quality-0-citizen_account-10289615">Armas q1</li>'+
				   '<li><a href="http://www.erepublik.com/es/market/country-15-industry-3-quality-2-citizen_account-10289615">Armas q2</li>'+
				   '<li><a href="http://www.erepublik.com/es/market/country-15-industry-3-quality-3-citizen_account-10289615">Armas q3</li>'+
				   '<li><a href="http://www.erepublik.com/es/market/country-15-industry-3-quality-4-citizen_account-10289615">Armas q4</li>'+
				   '<li><a href="http://www.erepublik.com/es/market/country-15-industry-3-quality-5-citizen_account-10289615">Armas q5</li>'+
				   '<li><a href="http://www.erepublik.com/es/market/country-15-industry-4-quality-0-citizen_account-10289615">Tickets q1</li>'+
				   '</div>' ;

$('#eRepBarContent').empty();
$('#eRepBarContent').append(eRepBarMartel);

}

function eRepBarOrgs(){

    var eRepBarOrgs =     '<h3>Organizaciones</h3>' +
                         '<div>' +
                                '<ul style="list-style-type:circle; padding-left: 15px;">' +
                               '<li><a href="http://www.erepublik.com/es/organization/1858478">A.SWORD</li>' +
			       '<li><a href="http://www.erepublik.com/es/organization/2120945">Crisol</li>'+
			       '<li><a href="http://www.erepublik.com/es/organization/2214241">Prisma Group</li>'+
			       '<li><a href="http://www.erepublik.com/es/organization/2379754">Triforce Group</li>'+
			       '<li><a href="http://www.erepublik.com/en/organization/2639728">Centro Pokemon</li>'+
			       '<li><a href="http://www.erepublik.com/es/organization/1806132">Japanese Companies</li>'+		
                               '</div>' ;

$('#eRepBarContent').empty();
$('#eRepBarContent').append(eRepBarOrgs);

}

function eRepBarMarkets(){

    var eRepBarMarkets =     '<h3>Mercados</h3>' +
                         '<div>' +
                                '<ul style="list-style-type:circle; padding-left: 15px;">' +
                               '<li><a href="http://www.erepublik.com/en/market/country-15-industry-7-quality-3-citizen_account-12090228">Hierro q3 España</li>' +
			       '<li><a href="http://www.erepublik.com/en/market/country-1-industry-7-quality-3-citizen_account-12090228">Hierro q3 Rumanía</li>'+
			       '<li><a href="http://www.erepublik.com/en/market/country-63-industry-7-quality-3-citizen_account-12090228">Hierro q3 Croacia</li>'+
			       '<li><a href="http://www.erepublik.com/en/market/country-27-industry-3-quality-1-citizen_account-12090228">Armas q1 Argentina</li>'+
			       '<li><a href="http://www.erepublik.com/en/market/country-44-industry-4-quality-1-citizen_account-12090228">Tickets q1 Grecia</li>'+		       
			       '<li><a href="http://www.erepublik.com/es/market/country-15-industry-2-quality-1-citizen_account-10289615">Regalos q1 España</li>'+	
				   '<li><a href="http://www.erepublik.com/es/market/country-15-industry-10-quality-3-citizen_account-10289615">Casas q3 España</li>'+	
                               '</div>' ;

$('#eRepBarContent').empty();
$('#eRepBarContent').append(eRepBarMarkets);
...
function renderWellnessPronosis(){
    ...
    WellnessPrognosisChart_url = "http://chart.apis.google.com/chart?cht=bvs&chbh=75&chco=009f37,C6D9FD&chm=N,000000,0,-1,11&chd=t:" + WellnessPrognosisChart_data + "|" + WellnessPrognosisChart_data2 + "&chg=0,50&chs=740x200&chxt=x,y&chxl=0:|Day0|Day1|Day2|Day3|Day4|Day5|Day6|Day7|1:|0|50|100";
...
function eRepBarWellness(){
    ...
    var eRepBarWellness =     '<h3>Wellness Calculator</h3>' +
                            ...
                            '<div>' +
                                ...
                                '<div class="executeButton" id="eRepBarWellnessChartRenderer">Render Projection</div>' +
                            '</div>' +
...
function eRepBarPreferences(){
    ...
    var eRepBarPreferences =     '<h3>Preferencias</h3>' +
                                '<div style="clear: both;">' +
                                    '<div><div class="inputdesc" style="width: 120px; text-align: center;">Start Page:</div><div class="input_holder" style="width: 170px">' +
                                    '<select class="inputselect" id="erbInputStartPage"><option value="about">About eRepBar</option><option value="wellC">Wellness Calculator</option><option value="dmgC">Damage Calculator</option><option value="prodC">Productivity Calculator</option><option value="CM">Company Management</option></select>' +                           
                                    '</div><div class="inputholder_end"></div></div>' +
                                '</div>' +
                                ...
                                '</div>' +
                                '<div style="clear: both;">' +
                                    '<div class="executeButton" id="eRepBarSavePrefs">Save Preferences</div>' +
                                '</div>';
...
function eRepBarAbout(){
    var eRepBarAbout =     '<h3>Bienvenido a eRepublikPONBar v 0.2!</h3>' +
                        '<div style="clear: both;">' +
                            '<div>' +
                            '<p style="font-size: 13px"><b>¿Y esta barra para que sirve?</b></p><br>' +
                            '<p>Esto es un acceso directo a las páginas del PON desarrollada para hacer la vida del PONero un poco mas facil </p><br>' +
			    ...
			    '<br>' +
                            ...
                            '<p>eRepPONBar es una herramienta <strong>Gratuita</strong>. Si te ha gustado y quieres colaborar escribeme un MP<a href="http://www.erepublik.com/es/citizen/profile/2261"><p>También acepto donaciones a modo de:</p>' +
...
function eRepBarCreateStyles(){
    ...
    GM_addStyle("#eRepBar {background: #009f37; width: 954px; height: 25px; display: block; clear: both; cursor: pointer; margin-bottom: 5px;}");
    GM_addStyle(".eRepBarLeftCorner {width: 25px; height: 25px; background: transparent url(http://img402.imageshack.us/img402/9830/maperepublikloggedmin.png) no-repeat scroll 0px -615px; float: left;}");
    GM_addStyle(".eRepBarArrow {width: 25px; height: 25px; background: transparent url(http://img402.imageshack.us/img402/9830/maperepublikloggedmin.png) no-repeat scroll -10px -907px; float: left;}");
    GM_addStyle(".eRepBarBody {width: 879px; height: 25px; float: left; margin-top: 5px}");
    GM_addStyle(".eRepBarRightCorner {width: 25px; height: 25px; background: transparent url(http://img402.imageshack.us/img402/9830/maperepublikloggedmin.png) no-repeat scroll -71px -615px; float: left;}");

    GM_addStyle("#eRepBarMainContainer {width: 954px; height: 300px; clear: both; display:none;}");
    ...
    GM_addStyle(".eRepBarButton {background: transparent url(http://img402.imageshack.us/img402/9830/maperepublikloggedmin.png) no-repeat scroll 0px -939px; width: 175px; height: 40px; float: left; padding-bottom: 15px; cursor: pointer; color: #808080}");
    GM_addStyle(".eRepBarButton:hover {background: transparent url(http://img402.imageshack.us/img402/9830/maperepublikloggedmin.png) no-repeat scroll 0px -899px; color: #fff}");
    ...
    GM_addStyle("#eRepBarEmpresasStats {width : 500px; height: 280px; float: left;}");
    GM_addStyle("#eRepBarEmpresasResults {width : 200px; height: 280px; float: right;}");
   
    GM_addStyle("#eRepBarOrgsStats {width : 500px; height: 220px; float: left;}");
    GM_addStyle("#eRepBarOrgsResults {width : 200px; height: 220px; float: right;}");
    ...
    GM_addStyle(".input_holder{float:left; height: 32px; background:transparent url(http://img402.imageshack.us/img402/9830/maperepublikloggedmin.png) no-repeat scroll 0 -110px;}");
    GM_addStyle(".inputdesc {float:left; width: 150px; height: 32px; margin-top: 10px;");
    GM_addStyle(".inputtext {background:transparent url(http://img402.imageshack.us/img402/9830/maperepublikloggedmin.png) no-repeat scroll 0 -110px; border:medium none; color:#808080; display:block; height: 24px; padding:8px 0 0 6px;}");
    ...
    GM_addStyle(".inputholder_end {background:transparent url(http://img402.imageshack.us/img402/9830/maperepublikloggedmin.png) no-repeat scroll -284px -110px; display:block; width: 5px; height: 32px; float: left;}");
    ...
    GM_addStyle(".executeButtonSmall {background: transparent url(http://img402.imageshack.us/img402/9830/maperepublikloggedmin.png) no-repeat scroll -232px -582px; color:#3C8FA7; display:block; height:26px; padding:5px 0 0 12px; margin-left: 20px; width:68px;  float: left; cursor: pointer;}");
...
function eRepBarConstruct(){
    ...
    var bar =     '<div id="eRepBar">' +
                    ...
                    '<div class="eRepBarBody"><span style="font-weight: bold; color: #fff;">eRepMinBar</span></div>' +
                    '<div class="eRepBarRightCorner"></div>' +
                '</div>' +
                '<div id="eRepBarMainContainer">' +
                    '<div id="eRepBarButtonContainer">' +
//                        '<div id="buttonWellness" class="eRepBarButton"><p>Calculadora de Wellness</p></div>' +
                        '<div id="buttonMinEmp" class="eRepBarButton"><p>Empresas</p></div>' +
                        '<div id="buttonMinOrg" class="eRepBarButton"><p>Organizaciones</p></div>' +
                        '<div id="buttonMarkets" class="eRepBarButton"><p>Mercados</p></div>' +
						'<div id="buttonMartel" class="eRepBarButton"><p>Casa Martel</p></div>' +
                        '<div id="buttonERTOOLS" class="eRepBarButton"><p>http://ereptools.net/</p></div>' +
//                        '<div id="buttonCompanyManagement" class="eRepBarButton"><p>Gestión de empresa</p></div>' +
//                        '<div id="buttonPreferences" class="eRepBarButton"><p>Preferencias</p></div>' +
//                        '<div id="buttonForo" class="eRepBarButton"><p>Foro del PON</p></div>' +
//                        '<div id="buttonRadioPON" class="eRepBarButton"><p>Radio del PON</p></div>' +
//                        '<div id="buttonIRC" class="eRepBarButton"><p>IRC del PON</p></div>' +
//                        '<div id="buttonAbout" class="eRepBarButton"><p>Sobre eRepPONBar</p></div>' +
                    '</div>' +
                    '<div id="eRepBarContent"></div>' +
                    '<div id="eRepBarLoadingMask"><img src="http://www.erepublik.com/images/parts/ajax-loader.gif" style="position: relative; top:-130px; left: 300px;"></div>' +
                '</div>';
...
//    $("#buttonWellness").click(function(){ eRepBarWellness();} );
    ...
    $("#buttonERTOOLS").click(function(){window.open('http://ereptools.net/');} );
    $("#buttonMinEmp").click(function(){ eRepBarEmpresas();} );
    $("#buttonMarkets").click(function(){ eRepBarMarkets();} );
    $("#buttonMinOrg").click(function(){ eRepBarOrgs();} );
    $("#buttonMartel").click(function(){ eRepBarMartel();} );
...
//    $("#buttonPreferences").click(function(){ eRepBarPreferences();} );
    ...
    switch(page){
        case "Calculadora de daño"        : eRepBarEmpresas(); break;
        case "Calculadora de Wellness"        : eRepBarOrgs(); break;
        case "Calculadora de Productividad"    : eRepBarProductivity(); break;
        case "Herramienta de gestión de empresa"        : eRepBarPreferences(); break;
        case "Foro del PON"            : eRepBarMartel(); break;
        case "IRC del PON"            : eRepBarAbout(); break;
        case "Sobre eRepPONBar"            : eRepBarAbout(); break;
