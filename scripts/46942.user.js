...
// Modified by syawal (http://syawalbudakcute.blogspot/) 
...
// ==UserScript==
// @name           Teddy Bear Emoticons for Blogger
...
var editbar = document.getElementById(domname);
  if (editbar) {
    ...
    var buttons = "<br />";
	buttons += emoticonButton("cry", "http://http://i231.photobucket.com/albums/ee256/liana_ilham/airmata.gif");
