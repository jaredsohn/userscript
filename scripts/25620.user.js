// ==UserScript==
// @name           Youtube Alternate Video Player (JW FLV Media Player version)
...
function timedCount(){
	...
	if( ( iCanHazSpanna && document.getElementById('tempLoader') )=== null){
		...
		pD.innerHTML = '<div id="tempLoader" style="position:relative;width:480px;height:395px;"><p style="position:relative;top:50%;left:40%;font-weight:bold;">Loading Player &nbsp; '+
		...
		'flashvars="height=395&width=480&file='+spanTex+'.flv&image=http://img.youtube.com/vi/'+vidID+'/default.jpg&overstretch=true&showdigits=true&autostart=false&bufferlength=3&repeat=false&volume=100&javascriptid=mediaplayer&autobuffer=true" '+
		'/>		';
