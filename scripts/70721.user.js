// ==UserScript==
// @name           himkolipopi jujikatus
// @description    neolo cotemptumus
...
new_button.addEventListener("click", function(){
	var query_url = unsafeWindow.document.forms[0].action + "?num=10&q="+escape(unsafeWindow.document.forms[0].q.value);
