// ==UserScript==
// @name           Tiberium Alliances Turkish Combat Simulator
// @description    Allows you to simulate combat before actually attacking.
// @namespace      https://prodgame*.alliances.commandandconquer.com/*/index.aspx*
// @include        https://prodgame*.alliances.commandandconquer.com/*/index.aspx*
// @version        1.4.0.2 Turkish
// @require 	   http://sizzlemctwizzle.com/updater.php?id=139741
// @Translated 	   By Nazmanya
// ==/UserScript==
(function () {
      ...
      qx.Class.define("TASuite.main", {
        ...
        members: {
          ...
          initialize: function () {
            ...
            this.buttons.attack.simulate = new qx.ui.form.Button("Dene");
            this.buttons.attack.simulate.set({
              width: 58,
              appearance: "button-text-small",
              toolTipText: "Savas Simulatorunu Baslat"
            });
            ...
            this.buttons.attack.unlock = new qx.ui.form.Button("Kilitli");
            this.buttons.attack.unlock.set({
              width: 55,
              height: 46,
              appearance: "button-text-small",
              toolTipText: "Saldır Dugmesini ac."
            });
      ...
      qx.Class.define("TASuite.main", {
        ...
        members: {
          ...
          initializeStats: function (tabView) {
            // ////////////////Stats ////////////////////
            this.statsPage = new qx.ui.tabview.Page("istatistik");
            ...
            eHBox1.add(new qx.ui.basic.Label("Dusman Ussu: "));
            ...
            eHBox4.add(new qx.ui.basic.Label("Savunma: "));
            ...
            eHBox5.add(new qx.ui.basic.Label("Binalar: "));
            ...
            eHBox2.add(new qx.ui.basic.Label("Santiye: "));
            ...
            eHBox3.add(new qx.ui.basic.Label("Savunma Karargahi: "));
            ...
            eHBox6.add(new qx.ui.basic.Label("Komuta Merkezi: "));
            ...
            this.labels.supportlevel = new qx.ui.basic.Label("Desteklenen Seviye ");
            ...
            tHBox1.add(new qx.ui.basic.Label("Onarim Zamani: "));
            ...
            tHBox5.add(new qx.ui.basic.Label("Toplam: "));
            ...
            tHBox2.add(new qx.ui.basic.Label("Yaya: "));
            ...
            tHBox3.add(new qx.ui.basic.Label("Motorize: "));
            ...
            tHBox4.add(new qx.ui.basic.Label("Ucak: "));
            ...
            hBox2.add(new qx.ui.basic.Label("Sonuc: "));
            ...
            hBox1.add(new qx.ui.basic.Label("Savas Zamani: "));
          ...
          initializeLayout: function (tabView) {
            // ////////////////Layouts ////////////////////
            var layoutPage = new qx.ui.tabview.Page("Planlar");
          ...
          initializeInfo: function (tabView) {
            // //////////////// Info ////////////////////
            var infoPage = new qx.ui.tabview.Page("Bilgi");
            ...
            var proHelpBar = new qx.ui.basic.Label().set({
              value: "<a target='_blank' href='https://www.facebook.com/CNCMetalFirtina'>MTF</a>",
              rich: true
            });
            ...
            infoPage.add(psVBox);
            psVBox.add(new qx.ui.basic.Label("Kaynaklar"));
            // Tiberium
          ...
          initialize: function () {
            ...
            this.buttons.simulate.back = new qx.ui.form.Button("Ayarla");
            this.buttons.simulate.back.set({
              width: 80,
              appearance: "button-text-small",
              toolTipText: "Savas ayarlarina don."
            });
            ...
            this.buttons.attack.unlockReset = new qx.ui.form.Button("Kilitli");
            this.buttons.attack.unlockReset.set({
              width: 55,
              height: 42,
              appearance: "button-text-small",
              toolTipText: "Sifirla Dugmesini ac."
            });
            ...
            this.buttons.attack.tools = new qx.ui.form.Button("Araclar");
            this.buttons.attack.tools.set({
              width: 58,
              appearance: "button-text-small",
              toolTipText: "Simulator araclarini ac."
            });
            ...
            this.battleResultsBox = new qx.ui.window.Window("Savas Simulatoru");
          ...
          updateStatsWindow: function () {
            ...
            this.labels.supportlevel.setValue('Desteklenen Seviye ' + SLabel + ': ');
