...
if(window.location.href.indexOf('account.aspx')!=-1) {

	//try to find out the player's name.
...
*/
	...
	GM_getValue('minimized', 0);
	GM_getValue('whosminimized', 0);
