...
// @version         0.30
//
// @history         0.30 Modified to fix spy table on .mx servers
                  ...
                  if (data[0] == Constants.View.HIDEOUT) {
                    ...
                    if (reportHeaders.length) {
                      ...
                      reportHeaders.each(function(index, reportHeader) {
                        ...
                        if (success && target) {
                          if ($('td.subject', reportHeader).text().indexOf("Materias primas en") == 0 &&
                          ...
                          } else if ($('td.subject', reportHeader).text().indexOf("Tropas en") == 0 &&
