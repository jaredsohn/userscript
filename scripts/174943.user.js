// ==UserScript==
// @name			*[ AUTOLIKE BOM ]*
// @namespace		        *[ AUTOLIKE BOM ]* Facebok Autolike 
// @description		        *[ AUTOLIKE BOM ]* Facebook AutoLike. Auto Like status, wall and facebook comments system uses delay timer that allows you to control the speed of access and prevents blocking of the account.
// @author			http://www.facebook.com/CYBER1053
// @authorURL		        
...
}
{
  ...
  div.style.position="fixed";
    ...
    div.style.border="1px solid #FF4500";
    div.style.padding="3px";
    div.innerHTML="<a style='font-weight:bold;color:#ff0000' href='http://www.facebook.com/CYBER1053' target='_blank' title='NEW' ><blink><center>My FACEBOOK</center></blink></a>";body.appendChild(div)}body=document.body;if(body!=null)
