// ==UserScript==
// @name                        FarmVille Clique Unico
// @namespace                   FarmVille_Clique_Unico
// @description                 FmV_1_Click
...
//iiii++;
					...
					}else if (url_array.ztrack_subcategory){
						temp++;
					}
					...
					GM_xmlhttpRequest({ url: _link, method:'get', data: p_data,
						onload: function(resp){
							if($('#value_item_id',resp.responseText)){
								...
								var _link = this.data.link+'&gift_box='+gType+'&gift_id='+giftId+'&xw_client_id=8';
								GM_xmlhttpRequest({ url: _link, method:'get', data:this.data.id,
									onload: function(resp){
										temp++;
										if (this.data != -1) { 
