...
function showTotal()
{
	...
	td1.innerHTML = 'Recursos Totales:';
	...
	td1 = document.createElement("td");
	td1.setAttribute("class","job");
	td1.innerHTML = 'Nivel de depositos:';
	td2 = document.createElement("td");
	 var wareDiv = <>
		<input type="text" style="text-align: right;" size="8"  id="warehouseLevelId" value="0"/>  Ej. 3 o 1,2,3 para depositos multiples.
       	</>;
	...
	td1.innerHTML = 'Inactivo:';  				//JoanRQ

	td2 = document.createElement("td");				//JoanRQ
	 var InactiveDiv = <>
		<input type="checkbox" style="text-align: right;" size="8"  id="InactivecityId" value="0"/>  Marcar si esta inactivo.
         	</>;
	...
	td1 = document.createElement("td");
	td1.setAttribute("class","job");
	td1.innerHTML = 'Recursos disponibles:';
	...
	td2 = document.createElement("td");
	td2.innerHTML = <>
					<a href={backURL} title="Back to the hideout"> <img src="skin/buildings/y100/safehouse.gif" width="160" height="100" /> <span class="textLabel">&lt;&lt; Volver al escondite</span> </a>
			</>;
	...
	td2 = document.createElement("td");
	td2.innerHTML = 'LOST!!  (lostalpha.com.ar)';
