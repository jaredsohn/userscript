// ==UserScript==
// @name           oron delay reduce timeout
// @description    Reduce the delay timeout on oron.com
// @version        0.2
// @date           2010-10-31
...
var SUC_script_num = 89300; // Change this to the number given to the script by userscripts.org (check the address bar)
...
try {
	...
	GM_registerMenuCommand(GM_getValue('SUC_target_script_name', '4shared delay reduce timeout') + ' - Manual Update Check', function()
	{
		updateCheck(true);
	});
