// ==UserScript==
// @name            Platypus-inputking.com/ime/ime_ne
// @namespace       Platypus
// @include         http://inputking.com/ime/ime_new.php
// ==/UserScript==
function do_platypus_script() {
smart_remove(window.document,document.getElementById('show_area'),null,null,null);
smart_remove(window.document,document.getElementById('logo'),null,null,null);
smart_remove(window.document,document.evaluate('/HTML[1]/BODY[1]/DIV[2]/TABLE[1]/TBODY[1]/TR[1]/TD[2]/DIV[1]/DIV[2]', document, null, 

XPathResult.FIRST_ORDERED_NODE_TYPE,null).singleNodeValue,null,null,null);
smart_remove(window.document,document.evaluate('/HTML[1]/BODY[1]/DIV[2]/TABLE[1]/TBODY[1]/TR[1]/TD[2]/DIV[1]', document, null, 

XPathResult.FIRST_ORDERED_NODE_TYPE,null).singleNodeValue,null,null,null);
remove_it(window.document,document.evaluate('/HTML[1]/BODY[1]/DIV[2]/TABLE[1]/TBODY[1]/TR[9]/TD[1]', document, null, 

XPathResult.FIRST_ORDERED_NODE_TYPE,null).singleNodeValue,null,null,null);
remove_it(window.document,document.getElementById('中'),null,null,null);
remove_it(window.document,document.getElementById('lang_option'),null,null,null);
