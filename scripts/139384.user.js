...
function fnInjectOverviewBar(){
	...
	fnInjectUnits();
	win.$('<tr><td colspan="3">إحداثيات القرية:<input id="snipe_coord" value="'+defaultCoords+'" class="text-input inactive" size="7" onFocus="this.select()" /></td><td colspan="1">توقيت الهجمة:<input id="arrival_time" size="25" class="text-input inactive" value="'+defaultDate+'" onFocus="this.select()" /></td><td><input type="button" value="إذهب" onClick="fnCalculateBackTime()" /></td></tr>').insertAfter(win.$('#menu_row2'));
