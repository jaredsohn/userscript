...
var BetterGSInsert = function($, window, undefined) {
			...
			BetterGS.init = function() {
					...
					if($('#userOptions').find('li').length) {
						$('#userOptions').prepend('<li><button id="BetterGS-options-caller" type="button" class="btn btn_style1"><span class="label">BetterGS</span></button></li>');
...
BetterGS.premium.init();
				BetterGS.version = '1.45';
			};
			/**
			 * Optionspanel
			 */
			 ...
			 * Only hides the ads
			BetterGS.premium = {};
			BetterGS.premium.version = '1.0';
			BetterGS.premium.init = function() {
				GS.user.IsPremium = 1;
				GS.ad.update();
			 */
			BetterGS.hideAds = {};
					...
					'<div id="BetterGS-content">' +
						'<div id="BetterGS-interact">' +
							'<div class="BetterGS-row BetterGS-head">' +
								...
								'<h3 id="BetterGS-head"><a target="_blank" href="http://userscripts.org/scripts/show/93354">BetterGS Lyrics</a></h3>' +
							'</div>' +
			...
			BetterGS.lyrics.resultsQuery = function() {
				var song = $.trim( $('#BetterGS-song').val() ) || 'Never Gonna Give You Up',
					...
					return 'USE \'https://github.com/yql/yql-tables/raw/master/google/google.search.xml\' AS google.search; ' + 
