// ==UserScript==
// @name           Joes Goals ad removal
// @namespace      ariah fine http://blog.iamnotashamed.net
// @description    removes ads
// @include         http://www.joesgoals.com/index.cfm
// ==/UserScript==

function do_platypus_script() {
remove_it(window.document,document.evaluate('/HTML[1]/BODY[1]/DIV[1]/DIV[1]/DIV[2]', document, null, XPathResult.FIRST_ORDERED_NODE_TYPE,null).singleNodeValue,null,null,null);
