...
// ==/UserScript==
      ...
      function CambiaCuadroTexto() {
      	...
      	var xhtml = "<table class='bbcodearea'> " +
      		    "<tr>    " +
		    '	 <td> </td>' + 
      		    '	<td><a tabindex="10" href="javascript:insertBB(\'player\','+random+');"><img src="http://yad.wz.cz/ext/t-w/player.png" alt="Spiller" title="Spiller" /></a></td>' +
      		    '	<td><a tabindex="11" href="javascript:insertBB(\'town\','+random+');"><img src="http://yad.wz.cz/ext/t-w/city.png" alt="By" title="By" /></a></td>' +
      		      '	<td><a tabindex="12" href="javascript:insertBB(\'fort\','+random+');"><img src="http://s03.radikal.ru/i176/0909/6a/4138ab37110a.png" alt="Fort" title="fort" /></a></td>' +
		    '   <td> </td>'+
      		    '	<td><a tabindex="13" href="javascript:insertBB(\'b\','+random+');"><img src="http://yad.wz.cz/ext/t-w/b.png" alt="Fed tekst" title="Fed skrift" /></a></td>' +
      		    '	<td><a tabindex="14" href="javascript:insertBB(\'i\','+random+');"><img src="http://yad.wz.cz/ext/t-w/i.png" alt="Skråskrift" title="Skråskrift" /></a></td>' +
      		    '	<td><a tabindex="15" href="javascript:insertBB(\'u\','+random+');"><img src="http://yad.wz.cz/ext/t-w/u.png" alt="Understreg tekst" title="Understreget" /></a></td>' +
      		     '	<td><a tabindex="16" href="javascript:insertBB(\'del\','+random+');"><img src="http://i064.radikal.ru/0909/ce/7988d649bac4.png" alt="Streg igennem tekst" title="Streg over" /></a></td>' +
      		    '	<td> </td>' +
      		    '	<td><a tabindex="17" href="javascript:insertBB(\'quote\','+random+');"><img src="http://www.offthemap.com/images/site/blockquote.jpg" alt="Citat" title="Citat" /></a></td>' +
      		    '	<td><a tabindex="18" href="javascript:insertBB(\'url\','+random+');"><img src="http://yad.wz.cz/ext/t-w/url.png" alt="Link (url)" title="Link (url)" /></a></td>' +
      		    '	<td><a tabindex="19" href="javascript:insertBB(\'img\','+random+');"><img src="http://yad.wz.cz/ext/t-w/img.png" alt="Billede (url)" title="Billede (url)" /></a></td>' +
		    '	<td> </td>' +
		    '	<td><a tabindex="20" href="javascript:insertBB(\'large text\','+random+');"><img src="http://forum.tribalwars.net/images/icons/icon14.gif" alt="Stor skrift (20)" title="Stor skrift (størrelse 20)" /></a></td>' +
		    '	<td><a tabindex="21" href="javascript:insertBB(\'small_text\','+random+');"><img src="http://forum.tribalwars.net/images/icons/icon13.gif" alt="lille skrift (8)" title="Lille skrift (størrelse 8)" /></a></td>' +


'	<td><a tabindex="25" href="javascript:insertBB(\'code\','+random+');"><img src="http://s02.radikal.ru/i175/0909/bb/d4cca2872746.jpg" title="#" title="#" /></a></td>' +
		    
		    
		   
		    
		    '	<td> </td>' +
		    '	<td><a tabindex="26" href="javascript:insertBB(\'white text\','+random+');"><img src="http://yad.wz.cz/ext/t-w/white.png" title="Hvid" /></a></td>' +
		    '	<td><a tabindex="27" href="javascript:insertBB(\'black text\','+random+');"><img src="http://yad.wz.cz/ext/t-w/black.png" title="Sort" /></a></td>' +	
		    '	<td><a tabindex="28" href="javascript:insertBB(\'red text\','+random+');"><img src="http://yad.wz.cz/ext/t-w/red.png" title="Rød" /></a></td>' +	
		    '	<td><a tabindex="29" href="javascript:insertBB(\'yellow text\','+random+');"><img src="http://yad.wz.cz/ext/t-w/yellow.png" title="Gul" /></a></td>' +
		    '	<td><a tabindex="30" href="javascript:insertBB(\'green text\','+random+');"><img src="http://yad.wz.cz/ext/t-w/green.png" title="Grøn" /></a></td>' +
		    '	<td><a tabindex="31" href="javascript:insertBB(\'cyan text\','+random+');"><img src="http://yad.wz.cz/ext/t-w/cyan.png" title="Lyseblå" /></a></td>' +
		    '	<td><a tabindex="32" href="javascript:insertBB(\'blue text\','+random+');"><img src="http://yad.wz.cz/ext/t-w/blue.png" title="Blå" /></a></td>' +
		    '	<td><a tabindex="33" href="javascript:insertBB(\'violet text\','+random+');"><img src="http://yad.wz.cz/ext/t-w/violet.png" title="Lilla" /></a></td>' +
		    '	<td></td>' +
      		    "</tr>   " +
		    '	<td></td>' +
