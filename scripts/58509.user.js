...
var lang_rented = "[b]Rented[/b]";
var lang_direct = "[b]Direct[/b]";
var lang_clicks = "[b]Clicks[/b]";
var lang_avg = "[b]Avg[/b]";
var lang_ravg = "[b]R.Avg[/b]";
var lang_avgs = "[b]Averages[/b]";
var lang_expenses = "[b]Expenses[/b]";
var lang_autopay = "Autopay";
var lang_recycle = "[b]Recycle[/b]";
var lang_renew = "[b]Renew[/b]";
var lang_net = "Net";
...
// kwah //
  ...
  GM_log('xpathResult.parentNode='+xpathResult.parentNode);
        ...
        "<br><font style='font-size:1px;color:#aaaaaa'><br/><b>[ "+lang_yesterday+" ]</b></font><b> - "+lang_net+" : $"+formatDec(((((rentedClicksYday-(-directClicksYday))*refClickMultiplier)-(recycleCostYday-(-autoPayCostYday)-(-renewCostYday)))),3)+"</b></br>"+
        "<hr width= \"155px\" height=\"1px\" color='#cccccc'/>"+
        "<br> &nbsp;&nbsp;- "+lang_rented+" : "+rentedClicksYday+"</br>"+ "<br> &nbsp;&nbsp;- "+lang_direct+" : "+directClicksYday+"</br>"+ "<br> &nbsp;&nbsp;- "+lang_avg+" : "+formatDec(((rentedClicksYday-(-directClicksYday))/getRefCount()),3)+"</br>"+ "<br> &nbsp;&nbsp;- "+lang_ravg+" : "+formatDec(((rentedClicksYday-(-directClicksYday)-(recycleCostYday*100))/getRefCount()),3)+"</br>"+ "<br> &nbsp;&nbsp;- "+lang_recycle+" : $"+recycleCostYday+"</br>"+ "<br> &nbsp;&nbsp;- "+lang_renew+" : $"+renewCostYday+"</br>"+
	"<p/>";
