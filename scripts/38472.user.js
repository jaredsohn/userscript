...
if (k == 66) {
    ...
    document.location.href = 'http://92.48.103.52/fantasy/game.php?var1=Small+Shield&var2=2&var3=10480&Submit=GO&command=Transfer&screen=TRANSFER';
  } if (k == 70) {
    ...
    document.location.href = 'http://92.48.103.52/fantasy/game.php?var1=Red+Rinker&var2=2&var3=10480&Submit=GO&command=Transfer&screen=TRANSFER';
  } if (k == 82) {
    document.location.href = 'http://92.48.103.52/fantasy/game.php?var1=Stripy+Dick&var2=3&var3=10480&Submit=GO&command=Transfer&screen=TRANSFER';
  } if (k == 83) {
    document.location.href = 'http://92.48.103.52/fantasy/game.php?screen=CHAT&var2=10005';
  } if (k == 84) {
    document.location.href = 'http://92.48.103.52/fantasy/game.php?var1=Traveling+Cloak&var2=2&var3=10480&Submit=GO&command=Transfer&screen=TRANSFER';
  } if (k == 85) {
    ...
    document.location.href = 'http://92.48.103.52/fantasy/game.php?var1=Small+Knife&var2=4&var3=10480&Submit=GO&command=Transfer&screen=TRANSFER';
  } if (k == 88) {
    document.location.href = 'http://92.48.103.52/fantasy/game.php?command=swapcharacter&var1=2090';
  } if (k == 89) {
    ...
    document.location.href = 'http://92.48.103.52/fantasy/game.php?var1=Blue+Mooner&var2=2&var3=10480&Submit=GO&command=Transfer&screen=TRANSFER';
  } if (k == 50) {
    document.location.href = 'http://92.48.103.52/fantasy/game.php?var1=Cloth+Belt&var2=3&var3=10480&Submit=GO&command=Transfer&screen=TRANSFER';
  } if (k == 51) {
    document.location.href = 'http://92.48.103.52/fantasy/game.php?var1=Cloth+Cap&var2=1&var3=10480&Submit=GO&command=Transfer&screen=TRANSFER';
  } if (k == 52) {
    document.location.href = 'http://92.48.103.52/fantasy/game.php?var1=Cloth+Gloves&var2=4&var3=10480&Submit=GO&command=Transfer&screen=TRANSFER';
  } if (k == 53) {
    document.location.href = 'http://92.48.103.52/fantasy/game.php?var1=Cloth+Leggings&var2=2&var3=10480&Submit=GO&command=Transfer&screen=TRANSFER';
  } if (k == 54) {
    document.location.href = 'http://92.48.103.52/fantasy/game.php?var1=Cloth+Shoes&var2=3&var3=10480&Submit=GO&command=Transfer&screen=TRANSFER';
  } if (k == 55) {
    document.location.href = 'http://92.48.103.52/fantasy/game.php?var1=Cloth+Shoes&var2=3&var3=10480&Submit=GO&command=Transfer&screen=TRANSFER';
  } if (k == 56) {
    document.location.href = 'http://92.48.103.52/fantasy/game.php?var1=Fingerbone&var2=2&var3=10480&Submit=GO&command=Transfer&screen=TRANSFER';
  } if (k == 57) {
    document.location.href = 'http://92.48.103.52/fantasy/game.php?var1=Green+Snapper&var2=4&var3=10480&Submit=GO&command=Transfer&screen=TRANSFER';
  } if (k == 48) {
    document.location.href = 'http://92.48.103.52/fantasy/game.php?var1=Nolly+Crab&var2=2&var3=10480&Submit=GO&command=Transfer&screen=TRANSFER';
  } if (k == 32) {
