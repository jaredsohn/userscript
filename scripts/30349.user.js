// ==UserScript==
// @name           FriendFeed Google Calendar
// @namespace      http://sheenonline.biz
// @description    FriendFeed Tab for Google Calendar
...
(function() {
  ...
  autoUpdateFromUserscriptsDotOrg({
    name: 'FriendFeed Google Calendar',
		url: 'http://userscripts.org/scripts/source/30349.user.js',
		version: ffrb_version,
	});

  function googleCalendar_setup() {
		$('.settings').find('.l_tab:last').after('<td class="l_tab" style="padding-left: 10px;" id="tdtabtm"><div class="rounded bb" id="tabtm"><div class="t"><div class="l"><div class="r"><div class="tl"><div class="tr"><div class="body"><a id="tab-link-googleCalendar" href="#"><img src="http://calendar.google.com/googlecalendar/images/favicon.ico"></a></div></div></div></div></div></div></div></td>');
    $('#tab-link-googleCalendar').click(function() {
			$('#subtabs').hide();
			$('#body').css("height","100%").html('<div class=iframe style="width:100%;height:100%;"><iframe id="content_iframe" marginWidth=0 marginHeight=0 src="http://google.com/calendar" frameBorder=0 style="width:100%;height:100%;overflow:auto;"></iframe></div>');
