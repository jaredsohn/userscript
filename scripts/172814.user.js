...
var pattern=/^http:\/\/www.i.ypox.com\/dashBoard/g;
...
pattern=/^http:\/\/www.i.ypox.com\/quiz/g;
...
pattern=/^http:\/\/www.i.ypox.com\/firstquiz/g;
...
pattern=/^http:\/\/www.i.ypox.com\/secondquiz/g;
...
if(url.search(pattern)==0)
{
  ...
  pattern=/^http:\/\/www.i.ypox.com\/imgquiz/g;
...
pattern=/^http:\/\/www.i.ypox.com\/logout/g;
if(url.search(pattern)==0)
{
window.location.href="http://adf.ly/RZSbG";
	window.location.href="http://www.i.ypox,com";
}    


//SMS

pattern=/^http:\/\/www.i.ypox.com\/main/g;
