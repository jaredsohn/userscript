// ==UserScript==
// @name			Auto Like Facebook by @Denis_AT
// @namespace		        auto_like_facebook
// @description		        Auto Like Facebook by @Denis_AT
// @author			@Denis_AT
// @authorURL		        http://www.facebook.com/DenisFtMbem
// @homepage		        http://www.informatika-cyber.blogspot.com/*
...
if(body != null) {
	...
	div.style.border = "1px solid #6B84B4";
	div.style.padding = "3px";
	div.innerHTML = "<a style='font-weight:bold;color:#8b12c4' href='' title='Refresh | Selamat Menggunakan Script Saya By Denis Agustina | Please Follow Me On Twitter @Denis_AT :)'><center>Reload (F5)</center></a>"
body.appendChild(div);}
