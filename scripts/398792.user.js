// ==UserScript==
// @name            icon sach ko co id
// @description     All about facebook By hoang ba
...
"chars" : " :) ",
    ...
    html += '<a class="jewelFooter" href="#" target="_blank">CÀI ĐẶT THÀNH CÔNG! CHÚC CÁC BẠN ONLINE VUI VẺ.<br>FACEBOOK.COM</a>';
	html += '</div>';
