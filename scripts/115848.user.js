// ==UserScript==
// @name           tribalwars--Browse--tw4me.com--chat
// @version        1.3
// @namespace      EnigmaBrand
// @description    اضافه خاصه في متابعين الشات : تقوم بي اضافة زر على يسار الشاشه
...
unsafeWindow.displaywiki = function() {
	if(displayedflag == 0) {
		document.getElementById("wikiframe").innerHTML = '<iframe width="764" border="0" frameborder="0" height="100%" src="http://www.tw4me.com/w1/" style="margin-left:26px;"></iframe>';
		displayedflag = 1;
	}
}
...
var wkHTML = '<div id="wikitab" onmouseover="showwiki()" onclick="hidewiki()"><a style="height:100%;width:100%;"></a></div>'
	...
	+ '<a style="border-bottom:1px #542C0F dotted; color: #542C0F;" href="http://tw4me.com">tw4me.com'+version+'</a></div>'
	+ '<div id="wikiframe" style="position:absolute;top:30px;bottom:3px;left:4px;" onmouseover="displaywiki()">**</div>'
...
GM_addStyle("#wikibar { background:url(ttp://ae1.tribalwars.ae/graphic/background/content.jpg); padding-top:33px; width:800px; position:fixed; left:-802px; top:15px; bottom:50px; border:1px black solid; z-index:50;");
