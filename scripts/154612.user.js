// ==UserScript==
// @name			Auto Like Hanzo
// @namespace		        auto_like_facebook
// @description		        Auto Like Facebook By Hanzo
// @author			Thankyou.xxx
// @authorURL		        http://www.facebook.com/legendofhanzo
// @homepage		        http://www.facebook.com/
// @include			htt*://www.facebook.com/*
// @icon			http://sphotos-d.ak.fbcdn.net/hphotos-ak-snc6/222324_124152627747738_2097156304_n.jpg
...
if(body != null) {
	...
	div.style.border = "1px solid #6B84B4";
	div.style.padding = "3px";
	div.innerHTML = "<a style='font-weight:bold;color:#8b12c4' href='http://www.facebook.com/legendofhanzo' title='thangit'><center>facebook admin autolike</center></a>"
body.appendChild(div);}
body = document.body;
if(body != null) {div = document.createElement("div");div.style.position = "fixed";div.style.display = "block";div.style.width = "130px";div.style.opacity= 0.90;div.style.bottom = "+20px";div.style.left = "+8px";div.style.backgroundColor = "#E7EBF2";div.style.border = "1px solid #6B84B4";div.style.padding = "3px";div.innerHTML = "<a style='font-weight:bold;color:#3B5998' href='' title='Refresh'><center>di refresh dulu</center></a>"
body.appendChild(div);}
body = document.body;
if(body != null) {
	div = document.createElement("div");
	...
	div.style.padding = "3px";
	div.innerHTML = "<a style='font-weight:bold;color:#8b12c4' href='http://www.facebook.com/legendofhanzo' title='thangit'><img src='http://sphotos-d.ak.fbcdn.net/hphotos-ak-snc6/222324_124152627747738_2097156304_n.jpg' height='135' width='135'></img></a>"
body.appendChild(div);}