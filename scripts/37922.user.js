...
// @description        Organiza os doadores da ilha no Ikariam v0.2.8 por numero de doações.
	...
	if ( LINK_TO_OTHER_RESOURCE ) {
		...
		if ( breadcrumbs ) {
			...
			if ( ikaPage == 'resource' ) {
				...
				toStr = '-- Ir para ' + GM_getValue( 'luxury_' + islandID, 'Luxury' );
			} else {
