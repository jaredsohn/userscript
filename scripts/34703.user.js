// ==UserScript==
// @name           FSU - Blackboard Auto Login
// @namespace      http://www.lonecanoe.com
// @author         Dustin Chilson
// @include        https://*fsuvista.ferris.edu/*
// @include        http://*fsuvista.ferris.edu/*
// ==/UserScript==
...
var form = document.forms.namedItem('useridForm');
var uid = form.elements.namedItem('webctid');
