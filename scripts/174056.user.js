// ==UserScript==
// @name           Twitter Non-native Retweet Edited by abdussalam
// @namespace      @Abdussalam_sid
...
(function() {
    ...
    function register() {
        // originally by @Abdussalam_sid (http://userscripts.org/scripts/show/70467), modified by @Abdussalam_sid
        ...
        function addRetweetLink(item) {
            ...
            insertRetweetLink(actions, "Edit Retweet");
