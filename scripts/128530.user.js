// ==UserScript==
// @name           Hynls_bypass_Adf.ly,...
// @namespace      http://*hynlsblog.blogspot.com
// @author         Hynls <cuonglsf@gmail.com>
// @description    Skip Paid Link redirects and forward directly to the target page
// @license        Hynls bypass v1
// @version        1.0
// @run-at         document-end
// @include        http*://*9.bb/*
...
function bypass(go_to) {
    if (go_to) {
        document.title = 'Đang bypass...';
        document.getElementsByTagName('html').innerHTML = 'Đang chuyển đến: <a href="' + go_to + '">' + go_to + '</a>';
