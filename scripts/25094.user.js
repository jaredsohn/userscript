// ==UserScript==
// @name           ScT+ for Movies (Other Releases)
...
function ScTPlusInsert() {
    ...
    td_name.innerHTML = "<b>ScT+ Rels</b><input type=\"button\" id=\"flickbutton\" onclick=\"flick('sctp_search_table'); flick('sctp_search_in'); setText();\" value=\"Show\" />";
    ...
    sctplus_table.setAttribute("style", "display: none;");
    sctplus_table.setAttribute("cellpadding", "3");
    
    insert(sctplus_table, getSearchResults(title));
