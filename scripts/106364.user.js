// ==UserScript==
// @name           La Multicomu {Script}
// @namespace      taringa
// @include        *taringa.net/*
// @exclude        *taringa.net/comunidades/multicomu-oficial/*
// @creator        Goku22111998 {Usuario de Taringa}
// ==/UserScript==

//////////////////////////////////////////////////////////
//////////////////////////////////////////////////////////
//                                                                                      //
// NO EDITES ESTO ESTO ES PROPIEDAD DE Goku22111998      //
//     PORQUE CAMBIES DE POSICION LAS COSAS (?)                //
//    PUES ES POSIBLE DE QUE SE NOTE DE QUE ES FAKE        //
//       CUIDADO QUE TOCAS O SE LIA :WINKY:                       //
//                                                                                      //
//////////////////////////////////////////////////////////
//////////////////////////////////////////////////////////
...
byClass('menuTabs').innerHTML += "<li id=\"tabbedMulticomu\" class=\"tabbed registrate\">\n <a href=\"http://www.taringa.net/comunidades/multicomu-oficial/\" onclick=\"menu(\'La Multicomu, \', registro_load_form(); return false;\" title=\"Ir a La Multicomu\">La Multicomu <img src=\n\"http://www.uploadimage.com.ar/images/83391059835751976560.png\" alt=\"Awesome Face - La Multicomu\" /></a>\n</li>";
...
function procesarEventos()
{
  ...
  {    
    div.innerHTML = '<div align="center"><img src="http://fc06.deviantart.com/fs43/f/2009/120/f/8/free_llama_running__3_by_MenInASuitcase.gif" alt="Obejita :D"></div>';
  }
}
