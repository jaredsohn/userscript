// ==UserScript==
// @name            taz_online_frontpage
// @namespace       Platypus
// @include         http://www.taz.de/index.php?id=start
...
do_modify_html_it(window.document,document.getElementById('content_gesamt'),/(<div[^>]+id="bilder_des_tages_header"[^>]+>[^~]+Ende linke Spalte -->)/,'<!-- trick17 -->$1',null);
do_modify_html_it(window.document,document.getElementById('content_gesamt'),/<!-- trick17 -->/i,'<p platypus-background-color="" style=""><a href="fileadmin/seite1/s1.pdf"><img src="http://www.taz.de/fileadmin/seite1/s1-big.png" alt="" /></a><img src="http://www.taz.de/fileadmin/seite1/kari.gif" alt="" />',null);
