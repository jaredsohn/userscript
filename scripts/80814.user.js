// ==UserScript==
// @name OGame rediseño : Recursos Volando
// @namespace http://userscripts.org/users/36331
// @description OGame : Recursos Volando
// @date 2010-07-05
// @creator Black Cat
...
(function(){
	...
	function displayResourcesOnTransit(resources,resourcesNames) {
		...
		var thisCoords = rightMenu.getElementsByClassName("active")[0].getElementsByClassName("planet-koords")[0].textContent;
				...
				$.get(
					...
					function (data) {
						...
						$(data).find("#eventContent .eventFleet").each(function () {
							...
							var detailsClass = eventFleet.find(".detailsFleet span").eq(0).attr("class");
