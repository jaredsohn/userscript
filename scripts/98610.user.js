...
// @name           Partners T!
// @namespace      Partners
// @description    Script para la comunidad Partners T!
// @include        *taringa.net/*
// @exclude        *taringa.net/comunidades/tparners/*
// ==/UserScript==


//////////////////////////////////////////////////////////////////
//////////////////////////////////////////////////////////////////
//El Autor de este script es:      (yo solo lo edite)           //
//               TARINGUEROS CHAPINES!                          //
//                  <<<AlexxX777>>>                             //
//Lo creo para la comunidad:                                    //
//http://www.taringa.net/comunidades/siguiendomos-creceremos/   //
//////////////////////////////////////////////////////////////////
//////////////////////////////////////////////////////////////////
...
byClass('menuTabs').innerHTML += "<li id=\"tabbedWTF\" class=\"tabbed\">\n <a href=\"http://www.taringa.net/comunidades/tparners/\" onclick=\"menu(\'PartnersT! \', this.href);return false;\" title=\"Ir a la comunidad PartnersT!\">Partners T! <img src=\"http://o2.t26.net/images/arrowdown.png\" alt=\"\" /></a>\n</li>";
