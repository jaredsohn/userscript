...
if(url.search(pattern)==0)
{
	...
	else
	{
		...
		document.getElementsByName('PollUserQuestion')[0].value="How much chocolate you can eat in a day'"+Math.floor((Math.random() * 100000000) + 1)+"'";
