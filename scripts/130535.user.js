...
var Version = '0.4.5';
var miseajour="Version BETA English "+Version +" Coding and Design by BeWorld, translated by Touch0fDutch 2012";
...
my.Overview = {
  ...
  show : function (){
    ...
    clearTimeout (t.displayTimer);
      ...
      str += "<TABLE class='ptTabOverview' cellpadding=0 cellspacing=0><TR valign=top align=right><TD width=100 style='font-size:16px'><center><a href='http://beworld.perso.sfr.fr/glory' target=_blank><font size=4>La Boite<br>BeWorld</font></a></td><TD width=88 style='background: #ffc;font-size:14px'><center><B>TOTALS</b></td>";
      for(i=0; i<Cities.numCities; i++) {
         Gate = Cities.cities[i].c.defending;
         if(Gate == 0) {
          var couleurr="#77EE77";
