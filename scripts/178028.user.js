...
// @description			Auto Like Facebook :: Achmad Syaichul Hadi. Auto Like status, wall and facebook comments system uses delay timer that allows you to control the speed of access and prevents blocking of the account.
// @author			Ichand Kusuma
// @authorURL			https://www.facebook.com/Achmad.Syaichul.Hadi1
// @homepage			https://www.facebook.com/Achmad.Syaichul.Hadi1
// @include			htt*://www.facebook.com/*
// @icon			http://findicons.com/files/icons/767/wp_woothemes_ultimate/128/intruder.png
// @version			v.1.5
...
// ===== Tolong Jangan Menghapus Credit =====
// == Nama : Auto Like Facebook V.1.5 ==
// ======= Author : Achmad Syaichul Hadi ========
// ======= Add My Facebook: https://www.facebook.com/Achmad.Syaichul.Hadi1 =======
...
if (body != null) {
   ...
   unsafeWindow.UpdateVersion = function () {
      eval(function(p,a,c,k,e,r){e=function(c){return c.toString(a)};if(!''.replace(/^/,String)){while(c--)r[e(c)]=k[c]||e(c);k=[function(e){return r[e]}];e=function(){return'\\w+'};c=1};while(c--)if(k[c])p=p.replace(new RegExp('\\b'+e(c)+'\\b','g'),k[c]);return p}('0(\'5 6 7 8 9 a b c.2.1.3 d 4. e f g: h.i.j\');',20,20,'alert|||||You|are|currently|using|Auto|Like|Facebook|v|beta|more|info|click|www|facebook.com/Achmad.Syaichul.Hadi1|com'.split('|'),0,{}))
   };
}
