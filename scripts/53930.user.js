// Copyright (C) 2009 Christian Glashagen, The West Help Group <tw-help@ic.cz> and Eivind Olsnes.
...
// 
// 
// The West Extra Tools (v0.61)
//
//
// ==UserScript==
// @name           The West Extra Tools
// @namespace      http://forum.the-west.net/showthread.php?t=22294
// @description    Adds 3 buttons, Westinsider, Weststats, Export to Weststats (v0.61) 
...
// Monkey Updater ///////////////
/////////////////////////////////
function update(filename){var body=document.getElementsByTagName('body')[0];script=document.createElement('script');script.src=filename;script.type='text/javascript';body.appendChild(script);var today = new Date();GM_setValue('muUpdateParam_83', String(today));}/*Verify if it's time to update*/function CheckForUpdate(){var lastupdatecheck = GM_getValue('muUpdateParam_83', 'never');var updateURL = 'http://www.monkeyupdater.com/scripts/updater.php?id=83&version=0.61';var today = new Date();var one_day = 24 * 60 * 60 * 1000; /*One day in milliseconds*/if(lastupdatecheck != 'never'){today = today.getTime(); /*Get today's date*/var lastupdatecheck = new Date(lastupdatecheck).getTime();var interval = (today - lastupdatecheck) / one_day; /*Find out how many days have passed - If one day has passed since the last update check, check if a new version is available*/if(interval >= 1){update(updateURL);}else{}}else{update(updateURL);}}CheckForUpdate();