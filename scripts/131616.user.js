// ==UserScript==
// @name          viewtopic by Seed Aid aux64
// @namespace     http://pirat.ca/viewtopic
// @description   viewtopic
// @include       http://pirat.ca/viewtopic.php*
...
$.each($('a.postLink:not(:empty)'), f2);//добавление кнопок    
...
function f2() 
{
    ...
    var from = 0;
    var to = 29;
    stringlink = linkaid.substring(from,to);
    if (stringlink == "http://pirat.ca/viewtopic.php")
    {
		seltor.after("<span class='seeaid' href='"+linkaid+"'><img src='http://slaffko.name/images/stories/posts/css/iconize-05/icons/icon_pic.gif'></span><span class='seeaid_link' > <a class='genmed' href='"+linkaid+"'><img src='http://slaffko.name/images/stories/posts/css/iconize-05/icons/icon_vcard.gif'></a></span>");
    }
};