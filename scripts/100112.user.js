...
// @description	Add buttons on views where you need to set resources payload. Require Ikariam v.0.3.x game server.
...
x500Payloads.View_Transport = function()
	...
	if (nodes != null)
		...
		#container .resourceAssign input.textfield { margin-top: 2px; margin-left: -30px; }
#container .resourceAssign a.setMin { margin-left: -20px; }
#container .resourceAssign a.setMax { margin-left: -20px; }
#container .resourceAssign div.sliderbg { margin-left: -20px; }
		input.x500Payloads,
