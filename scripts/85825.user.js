...
function doCheck() {
  if (unsafeWindow.buddyList) {
    ...
    GM_xmlhttpRequest({
      ...
      url: "http://www.facebook.com/ajax/typeahead/friends_page_search.php?1-1-1&u=" + facebookID + "&__a=1&time=" + Math.floor((new Date()).getTime() / 1000),
...
function inform(friend){
  if (document.getElementById("globalContainer")) {
    ...
    personRemoved.innerHTML = "<div class=\"image\"><span><img class=\"photo\" alt=\""+friend.t+"\" src=\""+(friend.photo?friend.photo:friend.it)+"\"/></span></div>"+
                              "<div class=\"info\"><dl class=\"clearfix\"><dt>Name:</dt><dd class=\"result_name fn\"><span class=\"url fn\">"+friend.t+"</span></dd>"+
                                                                         "<dt>Actions:</dt><dd class=\"fn\"><span class=\"url fn\"><a href=\""+(friend.path?"http://www.facebook.com"+friend.path:"http://www.facebook.com/profile.php?id="+friend.i)+"\">View Profile</a></span></dd>"+
