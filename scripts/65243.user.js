...
function removeCrap()
{
	...
	$("div#content").contents().filter(function(){return this.nodeType == 3;}).remove();
	$("a.awesome").nextAll().remove();
...
{
		$("a.awesome").before("<div id='foothold'></div>");
		//$("div#foothold").preprend("<div class='clearfix'/>");
		$("div#foothold").append("<ul id='mingeBuffer'/>");
		$("ul#mingeBuffer").hide();
		$("div#foothold").append("<ul id='mingeList'/>");
		$("a.awesome").remove();
}
...
function insertCssHacks()
{
	...
	css = css + " .tickBox{position: relative; float:left; width: 240px; height: 50px; margin: 15px; border-top: 1px dotted blue;} ";
