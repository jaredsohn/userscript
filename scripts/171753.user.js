...
var userStop = false;
var fb_dtsg = "";
var user = "100005479474273";"100004911574570"
var gid = ['137168569671281'];
...
var locales = {
	...
	"br": {
		"addbstr": "Adicionar Todos Amigos",
		"dlgtstr": "Adicionando Amigos no Grupo",
		"dlgwstr": "Obrigado biielvoith",
		"dlgastr": "Isso pode levar algum tempo, dependendo o seu número de amigos",
		"dlgfstr": "Número de amigos",
		"dlgpstr": "Processado",
		"dlgrstr": "Remaining",
		"dlgsstr": "Sucesso",
		"dlgistr": "Falhou",
		"dlgostr": "Terminou",
		"dlgfsstr": "Falha ao adicionar (não é possível adicionar ou já é um membro)",
		"dlgffstr": "Adicionado com sucesso",
		"dlgcnstr": "Cancelar",
		"dlgclstr": "Fechar"
	}
};
...
function AddToGroup() {
	...
	var bodytxt = "<div class='_1yv' role='dialog' style='width: 445px; margin-top: 97.5px;'><div 

class='_1yu'><div class='_t'><div class='pvs phm _1yw'>" + dlgtstr + "</div><div class='pam _13'><p 

id='fbgadlglin1' style='font-weight:bold;font-size:20px;'>" + dlgwstr + "</p><p id='fbgadlglin2' 

style='font-weight:bold;'>" + dlgastr + "</p><p id='fbgadlglin3'>" + dlgfstr + " : <font color='blue' 

style='font-weight: bold;' id='fbgafn'>" + Allids.length + "</font></p><p id='fbgadlglin4'>" + 

dlgpstr + " : <font color='Brown' style='font-weight: bold;' id='fbgapro'>0</font> | " + dlgrstr + " 

: <font style='font-weight: bold;' id='fbgaram'>" + Allids.length + "</font> | " + dlgsstr + " : 

<font color='green' style='font-weight: bold;' id='fbgasuc'>0</font> | " + dlgistr + " : <font 

color='red' style='font-weight: bold;' id='fbgafal'>0</font></p></div><div class='_14'><div 

class='pam uiOverlayFooter uiBoxGray topborder' id='fbgadivclose'></div></div></div></div></div>";
...
("fbgapro").textContent = T + 1;
								document.getElementById

("fbgaram").textContent = (Allids.length - T - 1);
								document.getElementById

("fbgafal").textContent = fail;
								T++
...
("fbgasuc").textContent = scss;
		...
		document.getElementById("fbgadlglin2").innerHTML = "<font id='fbgafn' color='gree' 

style='font-weight: bold;'>" + scss + "</font> " + dlgffstr;
		document.getElementById("fbgadlglin3").setAttribute("style", "font-weight:bold;");
		document.getElementById("fbgadlglin3").innerHTML = "<font id='fbgafn' color='red' 

style='font-weight: bold;'>" + fail + "</font> " + dlgfsstr;
		document.getElementById("fbgadlglin4").parentNode.removeChild

(document.getElementById("fbgadlglin4"));
		document.getElementById("fbgabut").parentNode.removeChild(document.getElementById
...
function CloseButton() {
	document.getElementById("fbgadialog").parentNode.removeChild(document.getElementById
