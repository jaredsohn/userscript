...
(function() { 
	...
	function dock(){
		...
		var attachment={
			...
			accText: {
				EAcoins10:'10 Coins',EAcoins25:'25 Coins',EAcoins50:'50 Coins',EAenergy1:'1 Energy',EAsendxk1:'Liberty Bond',
			...
			tests: [
				...
				{url:'LB_AskForParts',ret:'EAsend'},
				{url:'LB_AskForEnergy',ret:'EAenergy1'},
				{url:'LB_Passing',ret:'EAcoins50'},
				{url:'PlacementReward',ret:'EAcoins100'},
				{url:'ParticipationReward',ret:'EAenergy1'},
				{url:'LB_Summary',ret:'EAcoins100'},
			...
			menu: {
				EAsection_main:{type:"section",label:"Empires & Allies Manager Options ("+version+")",kids:{
					...
					EAsep:{type:'separator',label:'Resources',kids:{
						EAcoinblock:{type:"optionblock",label:"Coins:",kids:{
							EAcoins200:{type:'checkbox',label:'200'},
						...
						EAwoodblock:{type:"optionblock",label:"Wood:",kids:{
							EAwood100:{type:'checkbox',label:'100'},
							EAwood50:{type:'checkbox',label:'50'},
							EAwood25:{type:'checkbox',label:'25'},
							EAwood10:{type:'checkbox',label:'10'},
						}},
						EAoilblock:{type:"optionblock",label:"Oil:",kids:{
							EAoil100:{type:'checkbox',label:'100'},
							EAoil50:{type:'checkbox',label:'50'},
							EAoil25:{type:'checkbox',label:'25'},
							EAoil10:{type:'checkbox',label:'10'},
						}},
						EAmineblock:{type:"optionblock",label:"Minerals:",kids:{
						...
						EAotherblock:{type:"optionblock",label:"Other:",kids:{
							EAenergy1:{type:'checkbox',label:'Energy 1'},				
							EAxk1:{type:'checkbox',label:'Get Liberty Bond'},
						}},
					}},
					EAsendsep:{type:"separator",label:"Send Items",kids:{
						EAsendall:{type:"checkbox",label:"Send All (or check items below)"},
