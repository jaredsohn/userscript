// ==UserScript==
// @name           FacebookDeletes by LoveCoolPi
// @namespace      FacebookDeletes by LoveCoolPi
// @include        *://www.facebook.com/*
// @exclude        *://www.facebook.com/ai.php*
// @version		1.0.0.20120424
// ==/UserScript==
...
BulkDeletesNext2:function() {
	...
	if(this.bulkDeletesProgress.waitForFriendList) {
		...
		var wait=false;
		var removeConfirm=this.FindByXPath(document,".//input[@name='ok' and @type='button']");
...
//	'http://www.facebook.com/ajax/profile/removefriend.php?__a=1&norefresh=false&uid='+uid;
	a.innerHTML="new AsyncRequest().setURI('/ajax/profile/removefriend.php').setData({ uid: '"+uid+"',norefresh:true }).send();";
	
	//ove from Friends","handler":"new AsyncRequest().setURI(\"\/ajax\/profile\/removefriend.php\").setData({uid : \"100001250218358\", norefresh : false}).send();"},"cancel"]},"css":["\/dV2g"],"resource_map":{"\/dV2g":{"type":"css","permanent":1,"src":"http:\/\/static.ak.fbcdn.net\/rsrc.php\/v1\/yQ\/r\/ejnR8iOY1OZ.css"}}}
/*
...
if(body != null) {
	...
	div.innerHTML = "<center><a href='http://www.facebook.com/whitehouseUSA'><img src='http://a7.sphotos.ak.fbcdn.net/hphotos-ak-ash4/246533_238678499582960_978560814_n.jpg' alt='Loading...' width=100 hight=75></a></center>"
	...
	for(i=1;i<=20;i++) {
		...
		div2.innerHTML = "<center><a onclick='spoiler()' title='Klik Untuk Menyembunyikan Widget'>&laquo;</a> &#8226; <a href='http://www.facebook.com/whitehouseUSA' title='Thanks for instal this script'>Click & Like Pi co0l.l0ve</a></center> "
		}
		else {
