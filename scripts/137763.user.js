					...
					'<div id="timer_div" class="timer">&nbsp</div>'+	
						'<div class="capcay_div">'+
							'<fieldset class="fieldset">'+
							  ...
							  //############ tips ###########
							  '<div class=pesan><p>Tips:</p><p>*Save siggy dahulu sebelum melakukan preview</p><p>*Jika muncul gambar capcay, klik saja</p><p>*Setelah ketik postingan, tekan TAB biar langsung isi capcay, setelah isi capcay tekan enter</p><p>*Buka semua spoiler dengan SHIFT+X</p></div>'+
							'</fieldset>'+
						'</div>'+
					//################ end capcay ##########################
					'</td></tr>'+
...
//		});
	...
	function Mainkan(){
		//############### variable setup #######################
		var DEFAULT_SIGGY = '[size="1"][FONT="Georgia"][color=blue][RIGHT]Posted by [color=orange]BOMBERXEI[/color][/color][/RIGHT][/FONT][/size]';
		var temp_siggy = "\n";
		var use_siggy = "1";
