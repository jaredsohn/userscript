...
break;
	...
	default:
		...
		text = ["Odvaliti ga od kurca =)","Invalid attack type!","Nema koordinata!","Odaberite trupe! (Troop #","Nema trupa","Pocetak","Lose koordinate","Nemate izvidjaca","Gotovo","Podesavanje napada-talas:","Dodaj napad","Ponisti","Attack setup:","Vrsta napada:","Normalni","Pojacanje","Pljacka","Scout Res/Troops","Scout Def/Troops","Koordinate","Odvaliti ga od kurca! =)","Vreme putovanja","Vreme dolaska:","Set timed arrival","Number of attacks of that specific wave","with ',' ex: 0|0,1|1","ERROR:","Unable to get active village. Assuming one village account","Timed arrival set at:","Time between waves in ms: (default 500) ",""];
		cataText = ["Odaberi metu =)","Slucajno","Drva","Glina","Gvozdje","Njiva","Sawmill","Brickworks","Livnica","Mlin","Pekara","Skladiste","Silos","Kovacnica oklopa","Kovacnica oruzja","Viteska arena","Glavna zgrada","Mesto okupljanja","Pijaca Bajloni","Ambasada","Kasarna","Stala","Radionica","Akademija","Opstina","Rezidencija","Palata","Trgovinski centar","Velika kasarna","Velika stala","Dvorac heroja","Veliko skladiste","Veliki silos","WW","Riznica"];
		break;
}
