...
varFileObject = fso.OpenTextFile("D:\\Sachin.txt", 2, true,0); // 2=overwrite, true=create if not exist, 0 = ASCII
        ...
        var urlLoaded = function () {
          if (this.readyState == 4 && this.status == 200) {
            ...
            if (titleElt) {
              ...
              flagElt.innerHTML = (alive ? '*LIVE grrr* ' : '*ICED yeah* ');
