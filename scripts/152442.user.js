// ==UserScript==
// @name           Lunatica-Compact
// @description		Lunatica Compactador de Batallas 
// @version        1.0
// @author         BomBon Descafeinado
...
var SCRIPT = {
  name: "Lunatica-Compact"
  ,url: "http://userscripts.org/scripts/show/152442"
  ,version: "1.0"
...
function codificar(patron, tipo, version) {
    ...
    if(tipo == "HTML") {
        ...
        marcas = [
	    [/{DEMONS}/gi, '<img src="http://img19.imageshack.us/img19/7392/logolunaticareformasinf.png" border=0 alt="Demons Fornax"></a>'],
    ...
    if(tipo == "OGame") {
        ...
        marcas = [
            [/{DEMONS}/gi, '[[img]http://img19.imageshack.us/img19/7392/logolunaticareformasinf.png[/img]'],
