...
{
if(ulArray[i].innerHTML.match(/<li class=.larger.>/i))
{
ulArray[i].innerHTML = ulArray[i].innerHTML.replace(/<li>Member Since: <span id="ctl00_mainContent_lblMemberSince">[0-9]{1,}\/[0-9]{1,}\/[0-9]{4}/, "<li>Member Since: <span id=\"ctl00_mainContent_lblMemberSince\">"+datejoined+"</span></li>\n<li>Account Age: <span id=\"ctl00_mainContent_lblMemberSince\">"+daysApart+" Days</span></li>")
}
}
}
insertAge();