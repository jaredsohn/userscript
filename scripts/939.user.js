// ==UserScript==
// @name          The Pirate Bay Links in IMDb
// @namespace     http://www.artefxdesign.com/greasemonkey
// @description	  Adds Pirate Bay search links to IMDb pages. Ripped from Netflix code.
...
(function() 
{
	...
	function makeThePirateBayLink(movieName)
	{
		if (movieName != null && movieName.length > 0)
		{
			...
			newLink.setAttribute("href", "http://thepiratebay.org/search.php?video=1&q=" + movieName);
