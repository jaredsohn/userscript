...
addGlobalStyle('#wrap{width:960px; background-color:#4F3647;}' +
...
'.ForumTitleArea,#CommonBodyTable,#CommonBodyColumn,.CommonContentArea, .ForumContentArea {background-color:#4F3647;border:0px;}' +
...
'div.ForumPostContentText {background-image:url(http://img223.imageshack.us/img223/1842/skull4tj7.jpg);}' +
...
'.ForumMyNameColumn, .ForumMyRepliesColumn, .ForumMyImageColumn, .ForumGroupImageColumn, .ForumSubGroupNameColumn, .ForumGroupTotalThreadsColumn, .ForumGroupTotalPostsColumn, .ForumGroupNameColumn {color:#000000 !important;border-color:#EF3B97 !important;background-color:#4F3647;}' +
...
'div.tabPaneActive {border-color:#4F3647 !important;}' +
'div.ComposeHead, div.Headline, div.tr {background-color:#FFCFE7; border-color:#FFCFE7 !important;}' +
'SPAN.mceToolbarContainer {background-color:#EF3B97; !important;}' +
'div.ForumPostContentText {background-image:url(http://img223.imageshack.us/img223/1842/skull4tj7.jpg);background-position:bottom right;background-repeat:no-repeat;min-height:120px;}' +
