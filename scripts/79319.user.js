// ==UserScript==
// @name           The West_-_TW Pro
// @description    Calcule les meilleur vetements pour les travaux.
...
var sortSchlafImg2 = 'http://the-west.fr/images/items/right_arm/bowie_xmas.png'

var twpro_lang = {
	info: ['ryuk-kyu', 'http://ryuuku.olympe-network.com/the_west/scripts.php', 288102, '.37.'],
	WEBSITE: 'Site Web',
	AUTHOR: 'Auteur',
	...
	INVENTSTATS: 'Statistiques sur l\'inventaire',
	...
	SLEEPYONLY: 'Afficher le set du <b>Grincheux</b>',
	HOLLYDAYSONLY: 'Afficher le set des <b>Fêtes</b>'
};
var twpro_langs = {};
;
...
*/
	...
	function twpro_injectScript() {
		...
		twpro_supportLink.href = 'http://ryuuku.olympe-network.com';
		...
		twpro_supportAuthor.appendChild(document.createTextNode("Hack.Crows"));
		...
		$(twpro_supportAuthor.id).addMousePopup(new MousePopup('http://tw-pro.de'));
	...
	function twpro_insertList(twpro_data) {
		...
		//schlafmütz-button (by Hack.Crows)
		twpro_xhtml += '<div style="position:absolute;margin-top:25px;left:-80px"><a href="javascript:" onclick="TWPro.twpro_showhollydays()"><img id="twpro_hollydaysonly" alt="" src="http://the-west.fr/images/items/right_arm/bowie_xmas.png" width="20" height="17" style="background-image:url(data:image/png;base64,'+sortSchlafImg2+');background-position: 0px -17px" onmouseover="this.style.backgroundPosition=\'-0px 0\'" onmouseout="this.style.backgroundPosition=\'-0px -17px\'"/></a></div>';
		...
		twpro_xhtml = '<div style="left:385px;position:absolute;margin-top:0px;">';
		var imgorder = [20, 40, 60, 100], j=0;
		for(var i in TWPro.multipliers){
			twpro_xhtml += '<img src="images/transparent.png" alt="" style="background-image:url(data:image/png;base64,'+sortButtonImg+');background-position:-'+imgorder[j++]+'px 0;margin-left:1px" width="20" height="17" /><input type="text" style="width:30px" value="'+TWPro.multipliers[i]+'" onchange="TWPro.twpro_handleJobrank(this, \''+i+'\')" />';
		}
		twpro_xhtml += '</div>';
		// search inventory
		TWPro.searchInventory = {timer:null};
...
toggle_hollydays = 0;
	function twpro_showhollydays(){
	  if (toggle_hollydays == 0){
			toggle_hollydays = 1;
			var bag_items = document.getElementById('bag').getElementsByTagName('div'),
			i, j, anyresult, test,
			nores = document.getElementById('twpro_nosearchresult'),
		    customitems = new Array("dfgrocket1a","amulett","smells_like_eggspirit","cylinder_xmas","thanksgiving_boots","deathsythe");;
	...
	function twpro_showList() {
		...
		$('twpro_hollydaysonly').addMousePopup(new MousePopup(TWPro.lang.HOLLYDAYSONLY, 100, {opacity:0.95})); //by Hack.Crows
	...
	if(typeof window.TWPro == 'undefined'){try{
		...
		TWPro.twpro_showhollydays = twpro_showhollydays;
