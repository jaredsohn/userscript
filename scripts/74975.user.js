...
for(var x=0;x<imgs.length;x++){
	...
	if(imgs[x].src.indexOf("left_top.gif")>0){
		...
		imgs[x].src = "http://img222.imageshack.us/img222/250/xvid.png";
		...
		imgs[x].src = "http://i43.tinypic.com/1z2q4bd.png";  
	}else if(imgs[x].src.indexOf("misc.png")>0){
		imgs[x].src = "http://img521.imageshack.us/img521/3773/misci.png";
		...
		imgs[x].src = "http://img210.imageshack.us/img210/3667/hdtvw.png";
		...
		imgs[x].src = "http://img215.imageshack.us/img215/7104/music4.png";
		...
		imgs[x].src = "http://i43.tinypic.com/2z5m7vt.png";
		...
		imgs[x].src = "http://img710.imageshack.us/img710/672/buddylist.png";
