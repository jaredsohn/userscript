...
// @include       http://ae*.tribalwars.ae/*screen=ally*mode=overview*
...
'leaders' : 'علامات',
'others' : 'اخرى',
'report_url' : 'ادخل رابط التقرير:',
'linkreport' : 'عرض التقارير على شكل رابط',
'directreport' : 'عرض التقرير مباشرة',
'convertcoords' : 'Koordinaten in BB-Codes umwandeln',
'search' : 'بحث',
'searchterm' : 'ادخل الكلمة المراد البحث عنها',
'noresults' : 'هذه الكلمة غير موجودة !',
'personaltexts' : 'حافض النصوص',
'noentries' : 'لا يوجد اي نص',
'editentry' : 'إضافة/تحرير نص',
'editpersonalentries' : 'تحرير نص',
'del' : 'Löschen',
'confirm_delete' : 'هل انت متأكد من انك تريد الحذف ؟',
'newentry' : 'جديد',
'newentry' : 'جديد',
'close' : 'إلغاء',
'editpersonaltext' : 'تحرير النص',
'newpersonaltext' : 'إضافة نص جديد',
'title' : 'العنوان:',
'text' : 'النص:',
'ok' : 'موافق',
'cancel' : 'إلغاء'
...
if(document.getElementById('message') || document.getElementById('intern') || document.getElementById('desc_text'))
  ...
  //appendChild(document.createTextNode('DS Smilies-BB-Codes-List (ver'+ver+')'));
  ...
  if(forum || memo || mail || ally)
    {
    mainDiv.addButton('كود',icon_code,function() {
      insert('[code]','[/code]');
      return false;
      }
  ...
  if(forum || memo)
    {
    mainDiv.addButton('ايقونات',icon_icons,function() {
      toggle('bb_icons');
      return false;
      });
    }
  ...
  if(forum || memo)
    {
    mainDiv.addButton('ابتسامات',icon_smilies,function() {
      toggle('bb_smilies');
      return false;
      });
    }
