      ...
      function CambiaCuadroTexto() {
		...
		"</tr>" +
      	...
      	"</tr>" +
			...
			' <td><a tabindex="18" href="javascript:insertBB(\'smily SM\','+random+');"><img src="http://img9.xooimage.com/files/7/5/e/sadomaso-949960.gif" /></a></td>' +
		"<tr>" +
	...
	"</table>";
      	...
      	NuevaFuncionTW("insertBB", function(insertType, ident){
				...
				case 'smily KO':
      					...
      					break;
				case 'smily SM':
      					txtinsertBefore = "[img]http://img9.xooimage.com/files/7/5/e/sadomaso-949960.gif";
      					txtinsertAfter = "[/img]";
      					insertButton = '18';
      					break;
				case 'smily mrgreen':
