...
// @include        http://*.staemme.ch/*screen=report*
// @include        http://*.staemme.ch/*screen=overview_villages&mode=commands*
// @include        http://*.staemme.ch/*screen=overview_villages&mode=incomings*
// @include        http://*.staemme.ch/*screen=mail
// @include        http://*.staemme.ch/*screen=mail&action=*
// @include        http://*.staemme.ch/*screen=mail&mode=in*
// ==/UserScript==
