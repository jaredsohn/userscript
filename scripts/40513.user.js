...
document.location.href="http://92.48.103.52/fantasy/game.php?command=swapcharacter&var1=160309";
}
   else if(k==78) {
    ...
    document.location.href = 'http://92.48.103.52/fantasy/game.php?command=swapcharacter&var1=15803';
  }
  else if(k==50) {
    document.location.href = 'http://92.48.103.52/fantasy/game.php?var5=15803&var1=Lesser+Shield+Scroll&command=use&screen=SCROLLS';
}
  else if(k==51) {
    document.location.href ='http://92.48.103.52/fantasy/game.php?var5=15803&var1=Summon+Skeleton&command=use&screen=SCROLLS';
  }
  else if(k==49) {
    document.location.href =
'http://92.48.103.52/fantasy/game.php?var5=15803&var1=Lesser+Focus+Scroll&command=use&screen=SCROLLS';
  }
 else if(k==52) {
    document.location.href =
"http://92.48.103.52/fantasy/game.php?var5=15803&var1=Shield+Scroll&command=use&screen=SCROLLS";
  }
else if(k==53) {
    document.location.href =
"http://92.48.103.52/fantasy/game.php?var5=15803&var1=Focus+Scroll&command=use&screen=SCROLLS";
  }
else if(k==57) {
    ...
    document.location.href = 'http://92.48.103.52/fantasy/game.php?screen=CHAT&var2=12472';
  }
else if(k==88) {
    document.location.href = 'http://92.48.103.52/fantasy/game.php?command=swapcharacter&var1=16030';
  }
else if(k==75) {
    document.location.href = 'http://92.48.103.52/fantasy/game.php?screen=LOCATION&command=Move&var1=Krali%20Mountains';
  }
else if(k==87) {
    document.location.href = 'http://92.48.103.52/fantasy/game.php?screen=CHAT&var2=10375';
  }
else if(k==65) {
...
document.location.href = "http://92.48.103.52/fantasy/game.php?screen=LOCATION&command=Move&var1=Castle%20Dark%201001";
    ...
    document.location.href = 'http://92.48.103.52/fantasy/game.php?screen=CHAT&var2=12886';
  }
else if(k==86) {
    document.location.href = 'http://92.48.103.52/fantasy/game.php?screen=CHAT&var2=12783';
  }
else if(k==81) {
    document.location.href = 'http://92.48.103.52/fantasy/game.php?screen=CHAT&var2=7593';
}
else if(k==77) {
