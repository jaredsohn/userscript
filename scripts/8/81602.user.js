...
var passdata = [
	...
	function save(){
		...
		Email6 = idbase.getElementsByTagName('input')[10].value;
		Senha6 = idbase.getElementsByTagName('input')[11].value;
		Account6 = [Email5,Senha5].join('|');
		
		Email7 = idbase.getElementsByTagName('input')[12].value;
		Senha7 = idbase.getElementsByTagName('input')[13].value;
		Account7 = [Email5,Senha5].join('|');
		
		Email8 = idbase.getElementsByTagName('input')[14].value;
		Senha8 = idbase.getElementsByTagName('input')[15].value;
		Account8 = [Email5,Senha5].join('|');
		
		Email9 = idbase.getElementsByTagName('input')[16].value;
		Senha9 = idbase.getElementsByTagName('input')[17].value;
		Account9 = [Email5,Senha5].join('|');
		
		Final = [Account1,Account2,Account3,Account4,Account5,Account6,Account7,Account8,Account9].join('][');
...
function selected(options)
{
	...
	switch(options)
	{
		...
		case 7:
			...
			{
				var pass = false;
				deletecookie(emaildata[5], passdata[5]);
			}
		break;
		case 8:
			if(passdata[4])
			{
				var pass = false;
				deletecookie(emaildata[6], passdata[6]);
			}
		break;
		case 9:
			if(passdata[4])
			{
				var pass = false;
				deletecookie(emaildata[7], passdata[7]);
			}
		break;
		case 10:
			if(passdata[4])
			{
				var pass = false;
				deletecookie(emaildata[8], passdata[8]);
			}		
		break;
		case 11:
...
NewDiv.innerHTML='<div style="color: GRAY;">Editar Emails</div><br>'+
				 ...
				 'Email &nbsp;6:<input name="email" style="position: relative; left: 22px;" type="text"></input><a style="position: relative; left: 25px;" href="javascript: void(0);">Blank</a><br>'+
				 'Senha 6:<input name="senha" style="position: relative; left: 19px;" type="password"></input><br><hr>'+ 
				 'Email &nbsp;7:<input name="email" style="position: relative; left: 22px;" type="text"></input><a style="position: relative; left: 25px;" href="javascript: void(0);">Blank</a><br>'+
				 'Senha 7:<input name="senha" style="position: relative; left: 19px;" type="password"></input><br><hr>'+ 
				 'Email &nbsp;8:<input name="email" style="position: relative; left: 22px;" type="text"></input><a style="position: relative; left: 25px;" href="javascript: void(0);">Blank</a><br>'+
				 'Senha 8:<input name="senha" style="position: relative; left: 19px;" type="password"></input><br><hr>'+ 
...
Newform.innerHTML = '<div style="color: gray;"><center><B>FAZER LOGIN</b></center></div>' +
	...
	idbase.getElementsByTagName('input')[10].value=emaildata[5];
	idbase.getElementsByTagName('input')[11].value=passdata[5];

	idbase.getElementsByTagName('input')[12].value=emaildata[6];
	idbase.getElementsByTagName('input')[13].value=passdata[6];

	idbase.getElementsByTagName('input')[14].value=emaildata[7];
	idbase.getElementsByTagName('input')[15].value=passdata[7];

	idbase.getElementsByTagName('input')[16].value=emaildata[8];
	idbase.getElementsByTagName('input')[17].value=passdata[8];
	...
	div.innerHTML = '<select style="height: 17px; font-size: 10px; color: black;">' + 
				...
				'<option style="font-size: 10px; color: black;">' + emaildata[5] +'</option>' +
				'<option style="font-size: 10px; color: black;">' + emaildata[6] +'</option>' +
				'<option style="font-size: 10px; color: black;">' + emaildata[7] +'</option>' +
				'<option style="font-size: 10px; color: black;">' + emaildata[8] +'</option>' +
				'<option style="font-size: 10px;">───────────────────────────</option>' +
