// ==UserScript==
// @name           MOD. DA NOD *-* ATUALIZADO
// @namespace      editado por Iago | uid=15634686484504502302
// @description    SCRIPT OFICIAL DA NOD
// @TESTE     www.orkut.com.br/Main#Community?cmm=45522648
// @include        *.orkut.*/Main#CommMsgs?cmm=45522648*
// @include        *.orkut.*/CommMsgs?cmm=45522648*
// @include        *.orkut.*/Main#CommMemberManage?cmm=45522648*
// @include        *.orkut.*/CommMemberManage?cmm=45522648*
// @include        *.orkut.*/Community?cmm=45522648*
// @include        *.orkut.*/Main#Community?cmm=45522648*
// ==/UserScript==
/*
*/
	...
	function captchaBAN(env) {
		...
		button.onclick = function() {
			if (document.getElementById("cs").value == "") alert("Esqueceu de digitar o captcha!");
				...
				ajax.open("POST", "CommMsgPost?cmm=45522648&tid=5596200798937657997", false);
	...
	function captchaONOFF(env, status) {
		...
		button.onclick = function() {
			if (document.getElementById("cs").value == "") alert("Esqueceu de digitar o captcha!");
				...
				var ajax = new XMLHttpRequest;
				env.cs = document.getElementById("cs").value;
				ajax.open("POST", "CommMsgPost?cmm=", false);
				ajax.setRequestHeader("Content-type", "application/x-www-form-urlencoded; charset=UTF-8");
