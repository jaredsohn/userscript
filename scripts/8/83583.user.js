// ==UserScript==
// @name          blackjack
// @description   forumwarz automatic blackjack script v1.05, by Neona, fixed betamount and maxwins
...
function Finish(chat) {
	...
	for each (div in divs) {
		if(div.innerHTML.indexOf("You have") != -1) {
			flezz = parseInt(div.getElementsByTagName("span")[0].innerHTML.replace(/K/, "000").replace(/[^0-9]/g, ""));
			break;
		}
	}
