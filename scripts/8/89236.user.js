// ==UserScript==
// @name           formulawan_staff_expansion
// @namespace      formulawan_staff_expansion
// @description    This script allows you to simulate staff expansion information in the staff menu.
// @include	   http://www.formulawan.com/Fenetre_Staff.php?action=Gestion
// @version	   1.0
// @licence	   GPLv3
// ==/UserScript==
...
function trigger(){
	...
	div_txt.textContent = "(and "+nb_places+" place"+pluriel+" difference)";
...
center_th.textContent = "Summary of expenditure and Simulation"
var tr_contenu = document.createElement("tr");
var td_gauche = document.createElement("td");
var td_droit = document.createElement("td");
td_gauche.colSpan = 2;
td_droit.colSpan = 2;
var contenu_droit = "<center>Total expenditure: <span class=\"money\" title=\""+
...
div_txt.textContent = "(and 0 place difference)";
