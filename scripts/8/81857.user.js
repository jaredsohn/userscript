// roller.ru ignore script 
// version 0.1.5
// Copyright (c) 2010, Arthur Zalevsky
...
for ( var i=1; i < elem.length; i++ )
        ...
        {
	if ( !Nick.match('table') && ( Nick.match('name') || Nick.match('genmed') ) && Nick.match( win2unicode(igList[c]) ) )  
        {
