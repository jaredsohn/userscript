...
// @name           Seopult hack
// @version		   1.1
// @description    Seopult little hack
// @include        http://seopult.ru*
// @copyright      Vlad Zaritovsky
// ==/UserScript==
...
shortcut.add("Ctrl+Alt+S",function() {
	//alert ('All is ok!');
	var elems = document.getElementsByTagName('u');
	for(var i=0; i<elems.length; i++) elems[i].innerHTML = '#a#'+elems[i].innerHTML+'#/a#';
});
