...
// @  Aclaracion   Este codigo solo se modifico con la intencion de facilitar su lectura, // @               pero pertenece a HoChiChaos
...
function codificar(patron, tipo, version) {
    ...
    var txt_firma = 'Compactador automático de batallas HoChiChaos MOD[' + version + ']';
    
    patron = '{CENTER}' +  patron + '{/CENTER}';
    
    
    var colores = [
	        [/{COLOR_R1}/gi, '#ff4500'],   //totales perdidas y totales rentabilidad
			[/{COLOR_R2}/gi, '#ffff00'],   //Cantidades de perdidas(numericas)
			[/{COLOR_R3}/gi, '#98FB98'],   //escombros
			[/{COLOR_R4}/gi, '#98FB98'],   //recuersos.robo
			[/{COLOR_T1}/gi, '#CEF6F5'],   //textos titulares
			[/{COLOR_A1}/gi, '#00FF00'],   //texto color atacante
			[/{COLOR_A2}/gi, '#87CEEB'],   //perdidas atacante
			[/{COLOR_D1}/gi, '#FE9A2E'],   //naves
			[/{COLOR_D2}/gi, '#F7BE81'],   //texto general
			[/{COLOR_G1}/gi, '#ffffff']];  //texto perdidas
...
// ============================================================
    ...
    if( location.href.indexOf('/game/index.php?page=combatreport') != -1 || location.href.indexOf('//localhost/') != -1){
        ...
        patron += '{COLOR_G1}{B}{SIZE_PEQ}Batalla del día ' + getFecha() + '{/SIZE}{/B}{/COLOR}{NL}';
        ...
        for(var i = 0; i < lstAtaq.length(); i++){
             ...
             for(var j = 0; j < lstAtaq.getFlotas(i).length(); j++) {
                 ...
                 patron += "{COLOR_G1}{B}" + nombre + " {/B}{/COLOR}{COLOR_A1}" + unidades + "{/COLOR} {COLOR_A2}perdió " + perdidas +  "{/COLOR}{NL}";
             }
             patron += '{NL}';
        ...
        for(var i = 0; i < lstDef.length(); i++){
          ...
          for(var j = 0; j < lstDef.getFlotas(i).length(); j++) {
            ...
            patron += "{COLOR_G1}{B}" + nombre + " {/B}{/COLOR} {COLOR_D1}" + unidades + "{/COLOR} {COLOR_D2}perdió " + perdidas +  "{/COLOR}{NL}";
          }
          ...
          if(lstDef.getCostePerdidas(i)[3] != 0) {
             ...
             patron += '{COLOR_G1}{B}Perdidas: {/B}{/COLOR}{COLOR_R1}' + coste[3] + '{/COLOR}{NL}';
             patron += '( {COLOR_R2}' + coste[0] + '{/COLOR}, {COLOR_G1}Metal  {/COLOR}{COLOR_R2}' + coste[1] + '{/COLOR}{COLOR_G1}, Cristal, {/COLOR}{COLOR_R2}' + coste[2] + '{/COLOR}{COLOR_G1} Deuterio ){/COLOR}{NL}{NL}';
          }
        }
        ...
        patron += '{COLOR_G1}{B}Robo:{/B}{/COLOR} {COLOR_R4}{SIZE_MED}' + N_captura[0] + '{/SIZE}{/COLOR}{COLOR_G1} Metal, {/COLOR}{COLOR_R4}{SIZE_MED}' + N_captura[1] + '{/SIZE}{/COLOR}{COLOR_G1} Cristal y {/COLOR}{COLOR_R4}{SIZE_MED}' + N_captura[2] + '{/SIZE}{/COLOR}{COLOR_G1} Deuterio{/COLOR}{NL}';
        patron += '{COLOR_G1}{B}Escombros:{/B}{/COLOR} {COLOR_R3}{SIZE_MED}{B}' + N_escombros[0] + '{/B}{/SIZE}{/COLOR}{COLOR_G1} Metal y {/COLOR}{COLOR_R3}{SIZE_MED}{B}' +  N_escombros[1] + '{/B}{/SIZE}{/COLOR}{COLOR_G1} Cristal [ {/COLOR}{COLOR_R3}'   + N(calcularRecicladores(escombros[2])) + "{/COLOR}{COLOR_G1} recicladores ]{/COLOR}{NL}";
        
        patron += '{NL}{NL}'
        
                patron += '{COLOR_T1}{B}PERDIDAS{/B}{/COLOR}{COLOR_G1}{B} Atacantes: {/B}{/COLOR}{COLOR_R1}' + N_perdidasAtaq[3] + '{/COLOR}{NL}';
        patron += '{COLOR_G1}({/COLOR} {COLOR_R2}' + N_perdidasAtaq[0] + "{/COLOR}{COLOR_G1} metal , {/COLOR}{COLOR_R2}" + N_perdidasAtaq[1] + "{/COLOR}{COLOR_G1} cristal, {/COLOR}{COLOR_R2}" + N_perdidasAtaq[2] + "{/COLOR}{COLOR_G1} deuterio ){/COLOR}{NL}{NL}";
        
        patron += '{COLOR_T1}{B}PERDIDAS{/B}{/COLOR}{COLOR_G1}{B} Defensores: {/B}{/COLOR}{COLOR_R1}' + N_perdidasDef[3] + '{/COLOR}{NL}';
        patron += '{COLOR_G1}({/COLOR} {COLOR_R2}' + N_perdidasDef[0] + "{/COLOR}{COLOR_G1} metal , {/COLOR}{COLOR_R2}" + N_perdidasDef[1] + "{/COLOR}{COLOR_G1} cristal, {/COLOR}{COLOR_R2}" + N_perdidasDef[2] + "{/COLOR}{COLOR_G1} deuterio ){/COLOR}{NL}{NL}";
		
        patron += '{NL}'
        
        
        if(escombros[2] > 0) {
            patron += '{COLOR_T1}{B}RENTABILIDAD{/B}{/COLOR}{COLOR_G1} Atacantes reciclando: {/COLOR}{COLOR_R1}{B}' + N_renta_ataq_conReci[3] + '{/B}{/COLOR} [' + p_renta_ataq_conReci[3] + '%]{NL}';
            patron += '{COLOR_G1}Metal: {/COLOR}{COLOR_R2}' + N_renta_ataq_conReci[0]  + '{/COLOR} {SIZE_PEQ}[' + p_renta_ataq_conReci[0] + '%]{/SIZE}{NL}';
            patron += '{COLOR_G1}Cristal: {/COLOR}{COLOR_R2}' +  N_renta_ataq_conReci[1] + '{/COLOR} {SIZE_PEQ}[' + p_renta_ataq_conReci[1] + '%]{/SIZE}{NL}';
            patron += '{COLOR_G1}Deuterio: {/COLOR}{COLOR_R2}' +  N_renta_ataq_conReci[2] + '{/COLOR} {SIZE_PEQ}[' + p_renta_ataq_conReci[2] + '%]{/SIZE}{NL}';
            
            patron += '{COLOR_T1}{B}RENTABILIDAD{/B}{/COLOR}{COLOR_G1} Atacantes sin reciclar: {/COLOR}{COLOR_R1}{B}' + N_renta_ataq_sinReci[3] + '{/B}{/COLOR} [' + p_renta_ataq_sinReci[3] + '%]{NL}';
            patron += '{COLOR_G1}Metal: {/COLOR}{COLOR_R2}' +  N_renta_ataq_sinReci[0] + '{/COLOR} {SIZE_PEQ}[' + p_renta_ataq_sinReci[0] + '%]{/SIZE}{NL}';
            patron += '{COLOR_G1}Cristal: {/COLOR}{COLOR_R2}' +  N_renta_ataq_sinReci[1] + '{/COLOR} {SIZE_PEQ}[' + p_renta_ataq_sinReci[1] + '%]{/SIZE}{NL}';
            patron += '{COLOR_G1}Deuterio: {/COLOR}{COLOR_R2}' +  N_renta_ataq_sinReci[2] + '{/COLOR} {SIZE_PEQ}[' + p_renta_ataq_sinReci[2] + '%]{/SIZE}{NL}';

            patron += '{COLOR_T1}{B}RENTABILIDAD{/B}{/COLOR}{COLOR_G1} Defensores reciclando: {/COLOR}{COLOR_R1}{B}' + N_renta_def_conReci[3] + '{/B}{/COLOR} [' + p_renta_def_conReci[3] + '%]{NL}';
            patron += '{COLOR_G1}Metal: {/COLOR}{COLOR_R2}' +  N_renta_def_conReci[0] + '{/COLOR} {SIZE_PEQ}[' + p_renta_def_conReci[0] + '%]{/SIZE}{NL}';
            patron += '{COLOR_G1}Cristal: {/COLOR}{COLOR_R2}' +  N_renta_def_conReci[1] + '{/COLOR} {SIZE_PEQ}[' + p_renta_def_conReci[1] + '%]{/SIZE}{NL}';
            patron += '{COLOR_G1}Deuterio: {/COLOR}{COLOR_R2}' +  N_renta_def_conReci[2] + '{/COLOR} {SIZE_PEQ}[' + p_renta_def_conReci[2] + '%]{/SIZE}{NL}';
        }
        else {
            patron += '{COLOR_T1}{B}RENTABILIDAD{/B}{/COLOR}{COLOR_G1} Atacantes: {/COLOR}{COLOR_R1}' + N_renta_ataq_sinReci[3] + '{/COLOR} [' + p_renta_ataq_sinReci[3] + '%]{NL}';
            patron += '{COLOR_G1}Metal: {/COLOR}{COLOR_R2}' +  N_renta_ataq_sinReci[0] + '{/COLOR} {SIZE_PEQ}[' + p_renta_ataq_sinReci[0] + '%]{/SIZE}{NL}';
            patron += '{COLOR_G1}Cristal: {/COLOR}{COLOR_R2}' +  N_renta_ataq_sinReci[1] + '{/COLOR} {SIZE_PEQ}[' + p_renta_ataq_sinReci[1] + '%]{/SIZE}{NL}';
            patron += '{COLOR_G1}Deuterio: {/COLOR}{COLOR_R2}' +  N_renta_ataq_sinReci[2] + '{/COLOR} {SIZE_PEQ}[' + p_renta_ataq_sinReci[2] + '%]{/SIZE}{NL}';
        }
        ...
        if(getLuna().length > 4)
            patron += '{NL}{COLOR_G1}' + getLuna() + '{/COLOR}{NL}'
        
        
        patron += '{NL}{SIZE_MED}{COLOR_G1} Perdidas {/COLOR}{COLOR_T1}TOTALES{/COLOR}: {B}{COLOR_R3}' + N(perdidasTotales[3]) + '{/COLOR}{/B}{/SIZE}{NL}';
      ...
      //cabecera
		...
		html += '<tr><td colspan="2" height="450" bgcolor="" background="http://alidejavu.webcindario.com/ogamerc.jpg" style="border: 4px groove #000000;"><br><br>'
        ...
        html +=  '<br><center><table border="0" width="90%" style="">';
        html += '<tr><td colspan="2" height="100" bgcolor="" background="http://alidejavu.webcindario.com/ogamerc.jpg" style="border: 4px groove #000000;"><br><br>'
