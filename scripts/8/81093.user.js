// ==UserScript==  
// @name           דוקטור צחוק מציג : איקרים נושא פיראטים
// @namespace      http://s*.il.ikariam.*/*
// @description    הופך את מראה העיר למאורת פיראטים
// @version 		0.1
// @author		דוקטור צחוק
...
//an addaptation for the HEBREW servers , the original one can be downloaded at http://userscripts.org/scripts/show/43215

   var URL= "http://i752.photobucket.com/albums/xx165/firstcauchemar/cutthroat/";

GM_addStyle("#header                                                           {background:url(http://img228.imageshack.us/img228/8750/headerdv.png) no-repeat; position: relative}");
