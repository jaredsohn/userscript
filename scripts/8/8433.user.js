...
// @namespace		http://7.8.9g.pl/
// @author		Pawel Kubisz <kubisz AT dziennikarstwo.uni.wroc.pl>
// @include		http://*images.google.*/images*
// @description		Autoloads for next page of Google Images search results - starts with dblclick.
// @source	  	http://userscripts.org/scripts/show/8433
// @identifier	  	http://userscripts.org/scripts/source/8433.user.js
// @date	  	28-Sep-2009
// @version	  	0.04
// ==/UserScript==


// based on Google Auto Pager script by ma.la <timpo@ma.la> and contributors
