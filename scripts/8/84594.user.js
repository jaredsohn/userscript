// ==UserScript==
// @name           Facebook Notification sound
// @namespace      Facebook Notification sound
// @include        http://www.facebook.com/*
// ==/UserScript==

//Config
var remindMe = false;  //whether or not to continue beeping until the notification has been read
var remindTime = 0;  //time to remind (in seconds)
var checkTime = 1;    //time to check (in seconds)
var notifSound = "http://www.ctv.es/RECURSOS/SONIDOS/wav/error.wav"; //link to notification sound 
//Config
