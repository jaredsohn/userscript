// ==UserScript==
// @name            Financial Post print
// @include         http://www.financialpost.com/news/*/story.html
// ==/UserScript==

function do_platypus_script() {
fix_page_it(window.document,'/HTML[1]',null,null,null);
isolate(window.document,document.getElementById('npContentMain'),null,null,null);
relax(window.document,document.getElementById('npContentMain'),null,null,null);
