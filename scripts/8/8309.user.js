...
// @description    POST EMOTICONS!!!! Now with condense/expand!  Thanks to Forest21 for original: http://userscripts.org/scripts/show/8278
...
function condense(){
	//*****condensed emoticon window.  adjust height from 50px to whatever value desired.*****
	box.innerHTML= '<div style="overflow:auto; height:50px; float:left;border:1px solid black; padding-left:10px; padding-right:10px; padding-top:2px; padding-bottom:2px; width:90%; text-align:left;">'+
	
	 	//*****condensed emoticon list.  change them to whatever emoticons desired - just make sure to have the existing format for each line.*****
		 ...
		 '<div id="smWin" style="overflow:auto;height:35px;float:right;border:0px; padding:0px; width:5%; text-align:left;"></div>';
	
	//create + link
	var sW = document.createElement("a");
	sW.innerHTML="<font style='color:blue;'><b>+</b></font>";
	sW.addEventListener("click", expand, true);
	
	//add to smWin div
	var sDiv = document.getElementById("smWin");
	sDiv.appendChild(sW);
...
function expand(){
	//*****expanded emoticon window.  adjust height from 150px to whatever value desired.*****
	box.innerHTML= '<div style="overflow:auto;height:150px;float:left;border:1px solid black; padding:10px; width:90%; text-align:left;">'+
		 //*****expanded emoticon list.  change them to whatever emoticons desired - just make sure to have the existing format for each line.*****
		...
		'<div id="bigWin" style="overflow:auto; height:35px; float:right;border:0px; padding:0px; width:5%; text-align:left;"></div>';

	//create - link
	var bW = document.createElement("a");
	bW.innerHTML="<font style='color:blue;'><b>-</b></font>";
	bW.addEventListener("click", condense, true);
	
	//add to bigWin div
	var bDiv = document.getElementById("bigWin");
	bDiv.appendChild(bW);
}
