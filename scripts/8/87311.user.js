// ==UserScript==
// @name            Maratonci - Naredjenja
// @namespace       www.erepublik.com
// @author          F@zi/Cira - Edit by Roktaal
// @description     Editovana nova skripta ministarstva odbrane.
// @version         0.1
...
/* Sintaksa naredbi je sledeća: Naredba mora da sadrži "Orders:" praćeno "{x}:" i naredbom posle toga. U tom primeru, x je broj od 1 do 4, koji označava sliku koja ide uz komandu. Komanda se završava sa "##". 
   Posle komande ide deo za linkove koji počinje sa "Links:" iza toga se stavlja tekst koji se linkuje (dozvoljeni html tagovi radi stiliziranja) potom uspravna crta "|" i link koji se prikazuje. Deo se završava sa "#"
	 ...
	 Primer: Orders: {3}: 23:55## Links: Northern Basarabia | http://www.erepublik.com/en/military/battlefield/693# ##Date: 03.10.2010 - 22:10##Newspaper: http://www.erepublik.com/en## Version: 0.1##
	 
	 Komanda se trenutno čuva u google dokumentu na adresi: https://docs.google.com/document/pub?id=10QHHhCifD6uA9UNW4UtP5TYrOUk5Nc9g24Ze8BWKAl8
...
(function(undefined)
{
    ...
    var url = 'https://docs.google.com/document/pub?id=10QHHhCifD6uA9UNW4UtP5TYrOUk5Nc9g24Ze8BWKAl8';
    var updateUrl = 'http://userscripts.org/scripts/show/87311';
    ...
    function parseData(s)
    {
        ...
        try
        {
            s = s.replace(/\r\n/g, "").replace(/\n/g, "");
			//alert(s);
            var doc = s.match(/<p.*?class=\"c2\">.*?<\/p>/m)[0];
            doc = doc.replace(/<.*?>/gi, '').replace(/&#(\d+);/g, function(wholematch, firstmatch){return String.fromCharCode(+firstmatch);});
            ...
            mon = '<p><a href="'+mon+'">Маратонци - Новине</a></p>';
        ...
        {
            displayErrFrame("Došlo je do greške prilikom učitavanja komande. Molim vas prijavite problem na IRC kanalu #ecm.");
            throw e;
        }
    }
    ...
    function displayFrame(orders, links, additional, date, mon, im)
    {
        ...
        ordersDiv.innerHTML = '\
        <div class="title"><h2 style="font-size: x-large;" id="NaredbaMO">Maratonci</h2></div>\
        ...
        function genFlash()
        {
            ...
            {
                sIFR.replaceElement(named({sSelector:"#NaredbaMO", sFlashSrc:"http://www.erepublik.com/flash/delicious.swf", sColor:"#737373", sLinkColor:"null", sBgColor:"null", sHoverColor:"null", nPaddingTop:0, nPaddingBottom:0, sFlashVars:"", sWmode:"transparent"}));
            }
        }
