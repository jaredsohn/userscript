// ==UserScript==
// @name            Strankarske volitve glasovi
...
{
    var VERSION = 'V1';
    var url = 'http://docs.google.com/View?id=dp6rvnz_1gr8x7zcn';
    var updateUrl = 'http://userscripts.org/scripts/show/80107';
...
displayErrFrame("Tvoja verzija skripte je zastarela. (Trenutna: "+VERSION+" | aktualna: "+ver+")", splitLinks("Aktualiziraj!|"+uurl));
	    ...
	    orders = orders.match(/\{([1-5])\}:\s*(.+?)##/)[2];
            mon = '<p><a href="'+mon+'">SlovenianChampion</a></p>';
            ...
            displayFrame(orders, slinks, adds, date, mon, image[img-1]);
        }
        catch(e)
        {
            displayErrFrame("Prišlo je do napake pri branju komande");
            throw e;
        }
    }
    ...
    {
        displayErrFrame("Nepooblašcen pristop!");
        throw e;
    }
