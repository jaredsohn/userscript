// ==UserScript==
// @name           Create Vampire Wars game invites.
// @namespace      Vampire Wars friends.
// @description    Automatically invites people to your clan that you find on the fight page. Altered from http://userscripts.org/scripts/show/31912 and http://userscripts.org/scripts/review/37294
// @include        http://apps.facebook.com/vampiresgame/fight.php
// @include        http://apps.facebook.com/vampiresgame/recruit.php
// @include        http://apps.new.facebook.com/vampiresgame/fight.php
// @include        http://apps.new.facebook.com/vampiresgame/recruit.php
// @include        http://apps.facebook.com/vampiresgame/index.php?next=recruit.php
// @include        http://apps.facebook.com/vampiresgame/index.php?next=combat.php
// ==/UserScript==
...
if ((!reqID || since > 86400) && document.location.href.indexOf('fight') != -1) {
	document.location.href = 'http://apps.'+((newlayout)?'new.':'')+'facebook.com/vampiresgame/recruit.php';
	return;
}
...
if (document.location.href.indexOf('fight') == -1) {
	...
	var vars = false;
	var members = document.getElementsByXPath("//a[contains(@href,'/vampiregames/stats.php?user=')]");
...
var version_timestamp = 1219999991337;
/***
