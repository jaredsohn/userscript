// ==UserScript==
// @name           Uber-WoW Auto Vote
// @namespace      dav
// @match          http://www.uber-wow.info/vote/?act=vote
// @match          http://uber-wow.info/vote/?act=vote
// @include        http://www.uber-wow.info/vote/?act=vote
// @include        http://uber-wow.info/vote/?act=vote
// ==/UserScript==

var accountName = 'EDITME';
...
function postForm(id) {
    if (id == document.forms.length) {
        ...
        setTimeout(
            function() {
                window.location = 'http://uber-wow.info/vote/?';
            }, 800
        );
        return;
    }
