// ==UserScript==
// @name		BXS Custom Script
// @version 	86
// @namespace 	Gboz
// @author		Gboz
// @description	BXS Alliance Tools - ika-coredecodeURI(
...
var version=88;
var scriptlocation="http://userscripts.org/scripts/source/83965.user.js";

// Settings for every server
switch (location.host) {
	default:
		alliancefullnm='BIO-XS';
		alliancenm='BXS';		
		alliance=[	['No Alliance'	, NoAlliance],
			[ alliancenm	, Alliance	],
			['HAVOC'		, Allies	],
			['SoA'			, Allies	],				['DARK'			, Enemies 	],
			['-IV-'			, Enemies 	],  ];
		//Use the DOT (.) to not include the chat, forum, forumnew in the menu.
		//chaturl='http://bioxs.us/chat.php';
		chaturl='http://bioxs.us/chat.php';
		forumurl='http://bioxs.us/';
		//forumurl='http://bioxs.us/';
		forumurlnew='.';
