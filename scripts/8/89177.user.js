...
// @require      http://www.rockdown.net/Scripts/jQueryv1.3.2.js
// @require      http://www.rockdown.net/Styleupdater.php?id=89177
// @resource     bg http://www.rockdown.net/935271Untitled2.png
// ==/UserScript==

// Theme the Website, external CSS
...
return elementStyle;}
addStyleSheet('@import "http://rockdown.net/css/eseastyle.css";');

// Ensure jQuery Embeds (if @require fails, falls back to this.)
var script = document.createElement("script");
script.src = "http://www.rockdown.net/Scripts/jQueryv1.3.2.js";
document.getElementsByTagName("head")[0].appendChild(script);	

// Theme the Website, external CSS
function addfooter(a){
var getBody = document.getElementsByTagName("BODY")[0];
var FooterNode = window.document.createElement( 'a' );
var elementStyle= getBody.appendChild(FooterNode);
elementStyle.innerHTML = a;
return elementStyle;}
addfooter("<a name='footer'></a>");

//  VARS
var largeside = 'border:1px solid gray; background:#fff; color:#000; padding:10px; width:130px; height:280px; text-align:center';
var smallside = 'border:1px solid gray; background:#fff; color:#000; padding:10px; width:50px;  height:170px; text-align:center';
var lgbox = document.createElement('div');
var smbox = document.createElement('div');
var customsrch = document.createElement("div");
var headernav = document.createElement("div");
var modwhosplaying = document.getElementById("module-recent-downloads");
var tickr = document.getElementById("layout-ticker");

//  SIDEBAR Styling
lgbox.setAttribute('style', 'z-index:999; position:fixed; top:105px; left:1.5%; -moz-border-radius:6px; '+(largeside?largeside:''));
smbox.setAttribute('style', 'z-index:999; position:fixed; top:110px; left:1%; -moz-border-radius:6px; '+(smallside?smallside:''));

smbox.innerHTML = ("<div class='hlmenu-smres'><div class='smusricons'><a href='http://esea.net/index.php?s=upanel&d=manage'><img src='http://rockdown.net/eseauparrow5.png'></a><br><a href='http://esea.net/index.php?s=upanel&d=manage&tab=profile'><img src='http://rockdown.net/eseauparrow3.png'></a><br><a href='http://esea.net/index.php?s=forums&d=newtopic'><img src='http://rockdown.net/eseauparrow6.png' style='margin-top:3px;padding-right:2px;'></a><br><a href='#top'><img src='http://rockdown.net/eseauparrow1.png'></a><br><a href='#footer'><img src='http://rockdown.net/eseauparrow2.png'></a></div></div>");

lgbox.innerHTML = ("<div class='hlmenu-lgres'><div class='module-header'><img src='http://picsend.net/images/251848button_fastforward_green.png' height='17' width='17' style='float:right; padding-right:7px;padding-bottom:1px'>ESEA</div><a class='tab ' href='index.php?s=esports&d=list&type=46'>Changelog</a><br><br><a class='tab ' href='/index.php?s=forums'>Forums</a><br><br><a class='tab ' href='/index.php?s=league&d=schedule'>League</a><br><br><br><div class='module-header'><img src='http://picsend.net/images/121555button_fastforward_red.png' height='17' width='17' style='float:right; padding-right:7px;padding-bottom:1px'>ESEA Support</div><a class='tab ' href='/index.php?s=support&d=tickets'>Support Tickets</a><br><br><a class='tab ' href='/index.php?s=support&d=suspects'>Suspect List</a><br><br><a class='tab ' href='/index.php?s=support&d=bans'>Ban List</a><br><br><div id='SideSearchTckr'><form action='/index.php'><input type='hidden' name='s' value='search'><input type='text' name='query' value='' style='width:93px; padding-right:0;padding-left:5px;'><input type='image' src='http://file001.esportsea.com/images/esea/search_button.png'></form></div><div class='lgusricons'><a href='http://esea.net/index.php?s=upanel&d=manage'><img src='http://rockdown.net/eseauparrow5.png'></a><a href='http://esea.net/index.php?s=upanel&d=manage&tab=profile'><img src='http://rockdown.net/eseauparrow3.png'></a><a href='http://esea.net/index.php?s=forums&d=newtopic'><img src='http://rockdown.net/eseauparrow6.png'></a><a href='#top'><img src='http://rockdown.net/eseauparrow1.png'></a><a href='#footer'><img src='http://rockdown.net/eseauparrow2.png'></a></div></div>");

customsrch.innerHTML = "<div class='module-header'>Search ESEA</div><div id='SearchTckr'><form action='/index.php'><input type='hidden' name='s' value='search'><input type='text' name='query' value=''><input type='image' class='inputimage' src='http://file001.esportsea.com/images/esea/search_button.png'></form></div>";

tickr.innerHTML = //Navigat1on
("<div class='hmenu'><ul><li style='text-align:center'><span><a class='ESEA' href='/index.php'><img src='http://rockdown.net/images/eseamoduleheadereicon.png'></a>  </span></li><li style='text-align:center'><span align='center'><a href='/index.php?s=servers&type=pug'> PUG Now </a></span></li><li style='text-align:center'><span align='center'><a href='/index.php?s=stats'> Statistics </a></span></li><li style='text-align:center'><span align='center'><a href='/index.php?s=league&d=schedule'> League </a></span></li><li style='text-align:center'><span align='center'><a href='/index.php?s=events'> Events </a></span></li><li style='text-align:center'><span align='center'><a href='/index.php?s=downloads'> Downloads </a></span></li><li style='text-align:center'><span align='center'><a href='/index.php?s=forums'> Forums </a></span></li><li style='text-align:center'><span align='center'><a href='/index.php?s=support&d=faq'> Support </a></span></li></div>");

modwhosplaying.parentNode.insertBefore(customsrch,modwhosplaying);

//  Sidebar Condition - If Res0lution is greater then 1360x600 Show Sidebar, Else, don't!
if ((screen.width>=1360))
{ document.body.insertBefore(lgbox, document.body.firstChild); }else{ document.body.insertBefore(smbox, document.body.firstChild); }


// *****************************************
//  Credit to Greasedlightbox @ Joe Lencioni
// *****************************************
    var greasedLightbox = {
	version : 0.18,
	aspectRatio : null,
...
//  SearchDefinitions	
	searchDefs : [
		...
		// ESPORTSEA
		{
			name			: 'ESPORTSEA',
			includeRegExp		: /./, // used on every page
			linkRegExp			: /^http(s)?:\/\/esportsea.com\/.+/i,
			excludeLinkRegExp	: /\?/i,
			showFunction		: function(event) { greasedLightbox.show(event); return false; }
		}, // regular links to
	...
	init : function() {
		...
		cssStr							= ''+
		'#greasedLightboxOverlay { position: absolute; top: 0; left: 0; z-index: 10000000; height: 100%; width: 100%; background-image: ' + pngOverlay + '; background-repeat: repeat; cursor: pointer; }'+
		'#greasedLightboxMenu, a#greasedLightboxTitleLink, #greasedLightboxButtons { display:none }'+
		...
		'#greasedLightbox { position: absolute; margin-top:-15px; z-index: 10000050; text-align: center; background: #000; color: #aaa; padding: 10px; border: 1px solid #444; -moz-border-radius: 10px; font-family: verdana, sans-serif; font-size: 11px; }'+
...
var greasedLanguage = {
	...
	en : [
		{
			loading			: 'loading your image bro...',
