...
xmlhttpRequest({
    ...
    onload:function(response){
        ...
        earmy.append('<ul  style="float: left;" class="tabs">'
                +'<li id="ordenes"><a class="on" href="#"><span style="width: 100px;">Ordenes (C.G.)</span></a></li>'
                +'<li id="chat"><a class="on" href="http://02.chat.mibbit.com/?channel=%23coi&server=irc.rizon.net&channelkey=demoniocafetero" target="_blank"><span style="width: 100px;">Barracón (IRC)</span></a></li>'
                +'<li id="elecciones"><a class="on" href="#"><span style="width: 100px;">Elecciones</span></a></li>'
		+'</ul>');
