// ==UserScript==
// @name           FlickrGroupPoolTagChecker
// @namespace      http://www.flickr.com/alesadam
// @description    This script allows you to easily locate those images in your group pool that don't have the required tags set.
// @creator        Alesa Dam (http://flickr.com/alesadam/)
// @date           07/13/2010
// @version        2.2.0
// @icon	   https://lh3.googleusercontent.com/Q_hC4RC62b1OVkw5w_0-wfTz9sRkLy579bu3KpZ6rsT8-D6Qav2H-8B9qgJh4bbIOUbstnivHg=s128-h128-e365
// @modified       Aug. 17, 2013
//
// @include        http://*flickr.com/groups/*
// @exclude        http://*flickr.com/groups/*/?search*
//
// @downloadURL	   https://userscripts.org/scripts/source/81011.user.js
// @updateURL	   https://userscripts.org/scripts/source/81011.meta.js
//
// ==/UserScript==
//
// @run-at         document-end
//
// @copyright	2010-2012 Alesa Dam
// @license	GPL v3+
...
//
// Changelog on http://www.flickr.com/groups/flickrhacks/discuss/72157624324755123/
//
// --------------------------------------------------------------------
//
...
//
// --------------------------------------------------------------------
// If you have any suggestions for improvement, encounter bugs, have patches available,
// please FlickrMail me, and I will take care of it.
// Contact: 
// - Alesa Dam (http://flickr.com/alesadam/)

(function () {
var FGPTCtoolversion="2.2.0";
...
var installPage = 'http://userscripts.org/scripts/show/81011';
...
function getVersion(callbackId, callbackEvent) {
	$(callbackId).fireEvent(callbackEvent, { version: FGPTCtoolversion });
}
