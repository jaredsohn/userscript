...
items[133] = {item_id:133, nshort:'muzzleloader_bowie', name:'Дульнозарядное ружьё Бови', type:'left_arm', level:30, price:1480, image:'images/items/left_arm/muzzleloader_bowie.png', image_mini:'images/items/left_arm/mini/muzzleloader_bowie.png', characterClass:null, characterSex:null, speed:null, bonus:{skills:{}, attributes:{}}, set:{key:null, name:null}, shop:'drop'};\n\
\n\
\n\
...
items[261] = {item_id:261, nshort:'sleep_cap', name:'Ночной колпак', type:'head', level:45, price:1200, image:'images/items/head/sleep_cap.png', image_mini:'images/items/head/mini/sleep_cap.png', characterClass:null, characterSex:null, speed:null, bonus:{skills:{}, attributes:{}}, set:{key:'set_sleeper', name:'Набор сони'}, shop:'shop'};\n\
...
items[436] = {item_id:436, nshort:'slippers', name:'Тапочки', type:'foot', level:45, price:2000, image:'images/items/foot/slippers.png', image_mini:'images/items/foot/mini/slippers.png', characterClass:null, characterSex:null, speed:null, bonus:{skills:{}, attributes:{}}, set:{key:'set_sleeper', name:'Набор сони'}, shop:'shop'};\n\
\n\
...
items[567] = {item_id:567, nshort:'amulett', name:'Сердечный амулет', type:'neck', level:30, price:2412, image:'images/items/neck/amulett.png', image_mini:'images/items/neck/amulett.png', characterClass:null, characterSex:null, speed:null, bonus:{skills:{appearance:15, animal:15, trade:15, leadership:15}, attributes:{}}, set:{key:'season_set', name:'Праздничный наряд'}, shop:'shop'};\n\
items[568] = {item_id:568, nshort:'teethchain', name:'Талисман от вурдалака', type:'neck', level:40, price:2012, image:'images/items/neck/teethchain.png', image_mini:'images/items/neck/teethchain.png', characterClass:null, characterSex:null, speed:null, bonus:{skills:{tactic:4, leadership:8, hide:4}, attributes:{charisma:3}}, set:{key:null, name:null}, shop:'shop'};\n\
\n\
\n\
...
items[818] = {item_id:818, nshort:'deringer_bellestar', name:'Дерринджер Белль Старр', type:'right_arm', level:45, price:5500, image:'images/items/right_arm/deringer_bellestar.png', image_mini:'images/items/right_arm/mini/deringer_bellestar.png', characterClass:null, characterSex:null, speed:null, bonus:{skills:{hide:4, reflex:5}, attributes:{}}, set:{key:null, name:null}, shop:'shop'};\n\
...
items[856] = {item_id:856, nshort:'smells_like_eggspirit', name:'Тухлые яйца', type:'right_arm', level:45, price:2500, image:'images/items/right_arm/smells_like_eggspirit.png', image_mini:'images/items/right_arm/mini/smells_like_eggspirit.png', characterClass:null, characterSex:null, speed:null, bonus:{skills:{}, attributes:{}}, set:{key:'season_set', name:'Праздничный наряд'}, shop:'shop'};\n\
\n\
...
items[1751] = {item_id:1751, nshort:'ruby', name:'Рубин', type:'yield', level:null, price:66, image:'images/items/yield/ruby.png', image_mini:'images/items/yield/ruby.png', characterClass:null, characterSex:null, speed:null, bonus:{skills:{}, attributes:{}}, set:{key:null, name:null}, shop:'shop'};\n\
items[1756] = {item_id:1756, nshort:'mask', name:'Маска', type:'yield', level:null, price:200, image:'images/items/yield/mask.png', image_mini:'images/items/yield/mask.png', characterClass:null, characterSex:null, speed:null, bonus:{skills:{}, attributes:{}}, set:{key:null, name:null}, shop:'shop'};\n\
items[1757] = {item_id:1757, nshort:'dfprocket1', name:'Прототип', type:'yield', level:null, price:1, image:'images/items/yield/dfprocket1.png', image_mini:'images/items/yield/dfprocket1.png', characterClass:null, characterSex:null, speed:null, bonus:{skills:{}, attributes:{}}, set:{key:null, name:null}, shop:'shop'};\n\
items[1758] = {item_id:1758, nshort:'hgfrocket2', name:'Брак', type:'yield', level:null, price:1, image:'images/items/yield/hgfrocket2.png', image_mini:'images/items/yield/hgfrocket2.png', characterClass:null, characterSex:null, speed:null, bonus:{skills:{}, attributes:{}}, set:{key:null, name:null}, shop:'shop'};\n\
items[1759] = {item_id:1759, nshort:'dfgrocket1a', name:'Фейерверк', type:'yield', level:null, price:2700, image:'images/items/yield/dfgrocket1a.png', image_mini:'images/items/yield/dfgrocket1a.png', characterClass:null, characterSex:null, speed:null, bonus:{skills:{}, attributes:{charisma:2, dexterity:2, flexibility:2, strength:2}}, set:{key:'season_set', name:'Праздничный наряд'}, shop:'shop'};\n\
items[1760] = {item_id:1760, nshort:'bucket', name:'Пустое ведро', type:'yield', level:null, price:20, image:'images/items/yield/bucket.png', image_mini:'images/items/yield/bucket.png', characterClass:null, characterSex:null, speed:null, bonus:{skills:{}, attributes:{}}, set:{key:null, name:null}, shop:'shop'};\n\
items[1762] = {item_id:1762, nshort:'bucket_fire', name:'Ведро', type:'yield', level:null, price:25, image:'images/items/yield/bucket_fire.png', image_mini:'images/items/yield/bucket_fire.png', characterClass:null, characterSex:null, speed:null, bonus:{skills:{}, attributes:{}}, set:{key:'fireworker_set', name:'Набор пожарного'}, shop:'shop'};\n\
items[1769] = {item_id:1769, nshort:'goldgun', name:'Золотой револьвер', type:'yield', level:null, price:100, image:'images/items/yield/goldgun.png', image_mini:'images/items/yield/goldgun.png', characterClass:null, characterSex:null, speed:null, bonus:{skills:{}, attributes:{}}, set:{key:null, name:null}, shop:'shop'};\n\
items[1770] = {item_id:1770, nshort:'bloodycloth', name:'Окровавленный лоскут', type:'yield', level:null, price:1, image:'images/items/yield/bloodycloth.png', image_mini:'images/items/yield/bloodycloth.png', characterClass:null, characterSex:null, speed:null, bonus:{skills:{}, attributes:{}}, set:{key:null, name:null}, shop:'shop'};\n\
items[1771] = {item_id:1771, nshort:'photo', name:'Старая фотография', type:'yield', level:null, price:1, image:'images/items/yield/photo.png', image_mini:'images/items/yield/photo.png', characterClass:null, characterSex:null, speed:null, bonus:{skills:{}, attributes:{}}, set:{key:null, name:null}, shop:'shop'};\n\
items[1773] = {item_id:1773, nshort:'testament', name:'Завещание', type:'yield', level:null, price:1, image:'images/items/yield/testament.png', image_mini:'images/items/yield/testament.png', characterClass:null, characterSex:null, speed:null, bonus:{skills:{}, attributes:{}}, set:{key:null, name:null}, shop:'shop'};\n\
items[1774] = {item_id:1774, nshort:'engagementring', name:'Кольцо', type:'yield', level:null, price:1, image:'images/items/yield/engagementring.png', image_mini:'images/items/yield/engagementring.png', characterClass:null, characterSex:null, speed:null, bonus:{skills:{}, attributes:{}}, set:{key:null, name:null}, shop:'shop'};\n\
items[1775] = {item_id:1775, nshort:'birthcertificate', name:'Свидетельство о рождении', type:'yield', level:null, price:1, image:'images/items/yield/birthcertificate.png', image_mini:'images/items/yield/birthcertificate.png', characterClass:null, characterSex:null, speed:null, bonus:{skills:{}, attributes:{}}, set:{key:null, name:null}, shop:'shop'};\n\
items[1777] = {item_id:1777, nshort:'docreport', name:'Врачебное свидетельство', type:'yield', level:null, price:1, image:'images/items/yield/docreport.png', image_mini:'images/items/yield/docreport.png', characterClass:null, characterSex:null, speed:null, bonus:{skills:{}, attributes:{}}, set:{key:null, name:null}, shop:'shop'};\n\
items[1778] = {item_id:1778, nshort:'brandingiron', name:'Гнутое тавро', type:'yield', level:null, price:1, image:'images/items/yield/brandingiron.png', image_mini:'images/items/yield/brandingiron.png', characterClass:null, characterSex:null, speed:null, bonus:{skills:{}, attributes:{}}, set:{key:null, name:null}, shop:'shop'};\n\
items[1776] = {item_id:1776, nshort:'darkplans', name:'Коварные планы', type:'yield', level:null, price:1, image:'images/items/yield/darkplans.png', image_mini:'images/items/yield/darkplans.png', characterClass:null, characterSex:null, speed:null, bonus:{skills:{}, attributes:{}}, set:{key:null, name:null}, shop:'shop'};\n\
";
...
raboty[62] = {rus_name:'Миссионерство', name:'bible', malus:235, navyki:{tough:1,ride:1,trade:1,appearance:2}, resultaty:{dengi:5, opyt:61, vezenie:52, boom:77, produkty:{768:9}}};\n\
...
\n\
raboty[151] = {rus_name:'Здоровье', name:'health', malus:0, navyki:{health:1}, resultaty:{dengi:0, opyt:0, vezenie:0, boom:0, produkty:{}}};\n\
";
...
<form id=\"bi2_form\">\n\
	...
	<div' + aWindow.bi2_vblock + '>\n\
		...
		<input id=\"bi2_smo_mag\" type=\"checkbox\" style=\"margin:auto 25px auto 25px;\" >Лишь из &laquo;нужных&raquo; магазинов.</span><br />\n\
