...
new IkariamUserScriptUpdater( 82226, "Ikariam CR Converter" );

const lang = getLang();
const version = $("li.version span").text().substr(0, 7);

const crConvVersion = "1.0";

var language = { 
		en: {battleLand: "Battle", forCity: "for", battleSea: "Sea battle", nearCity: "near", from: " from ",
			attacker: "Attacker", attackers: "Attackers", defender: "Defender", defenders: "Defenders", winner: "Winner",
			...
			damage: "Damage", generals: "Generals", resources: "Resources", preview: "Preview", bbcode: "Ikariam forum",
			plaintext: "Plain text", htmlcode: "HTML", damageT: "Damage total", unknownCity: "<unknown city>", version: "version",
			army: "Army", armyLoot: "Army + loot", alliedTroops: "Allied Troops", finishedBattle: "Battle still in progress"},
         
		yu: {battleLand: "Borba", forCity: "za", battleSea: "Morksa bitka", nearCity: "kod", from: " iz ",
			attacker: "Napadač", attackers: "Napadači", defender: "Obranioc", defenders: "Obranioci", winner: "Pobjednik",
			...
			show: "Prikaži", cities: "Gradove", align: "Poravnaj", left: "Levo", center: "Sredina", right: "Desno",
		...
		rs: {battleLand: "Борба", forCity: "за", battleSea: "Поморска битка", nearCity: "поред", from: " из ",
			attacker: "Нападач", attackers: "Нападачи", defender: "Одбраниоц", defenders: "Одбраниоци", winner: "Победник",
			...
			show: "Прикажи", cities: "Градове", align: "Поравнај", left: "Лево", center: "Средина", right: "Десно",
 		...
 		ph: {battleLand: "Digmaan", forCity: "ng", battleSea: "Digmaan Pangkaragatan", nearCity: "ng", from: " ng ",
			attacker: "Umatake", attackers: "Mga Umatake", defender: "Dumipensa", defenders: "Mga Dumipensa", winner: "Nanalo",
		...
		de: {battleLand: "Schlacht", forCity: "um", battleSea: "Seeschlacht", nearCity: "nahe", from: " aus ",
			attacker: "Angreifer", attackers: "Angreifer", defender: "Verteidiger", defenders: "Verteidiger", winner: "Gewinner",
		...
		si: {battleLand: "Bitka", forCity: "za", battleSea: "Morska bitka", nearCity: "pri", from: " od ",
			attacker: "Napadalec", attackers: "Napadalci", defender: "Branilec", defenders: "Branilci", winner: "Zmagovalec",
...
var unitsLang = {   
		en: {slinger: "Slinger", swordsman: "Swordsman", hoplite: "Hoplite", marksman: "Sulphur Carabineers", mortar: "Mortar",
		...
		yu: {slinger: "Praćkar", swordsman: "Mačevalac", hoplite: "Kopljanik", marksman: "Sumforni Mušketar", mortar: "Minobacač",
			catapult: "Katapult", batteringRam: "Ovan", steamGiant: "Željezni div", balloonBombardier: "Balon Bombarder", cook: "Kuhar",
			doctor: "Doktor", gyrocopter: "Girokopter", archer: "Strijelac", wall: "Zid", spearThrower: "Bacač Koplja", barbarianAxeSwinger: "Barbarski Bacač Sjekire",
			ramShip: "Brod Ovan", lightvessel: "Vatreni Brod", divingBoat: "Podmornica", ballistaShip: "Brod kopljar",
			catapultShip: "Brod katapult", mortarShip: "Brod minobacač", paddleWheelRam: "Parni ratni brod"}, 
         
		rs: {slinger: "Праћкар", swordsman: "Мачевалац", hoplite: "Копљаник", marksman: "Сумпорни Мускетар", mortar: "Минобацач",
			catapult: "Катапулт", batteringRam: "Ован", steamGiant: "Челични див", balloonBombardier: "Балон Бомбардер", cook: "Кувар",
			doctor: "Доктор", gyrocopter: "Гирокоптер", archer: "Стрелац", wall: "Зид", spearThrower: "Бацач копља", barbarianAxeSwinger: "Варварски бацач секире",
			ramShip: "Брод ован", lightvessel: "Пламени брод", divingBoat: "Подморница", ballistaShip: "Брод копљар",
			catapultShip: "Брод катапулт", mortarShip: "Брод минобацач", paddleWheelRam: "Парни ратни брод"},          
         
		ph: {slinger: "Tagahagis", swordsman: "Mananabas", hoplite: "Sundalo", marksman: "Mamamaril", mortar: "Kanyon",
			catapult: "Katapult", batteringRam: "Ram", steamGiant: "Higanteng demakina", balloonBombardier: "Lobong Tagabomba", cook: "Kusinero",
			doctor: "Manggagamot", gyrocopter: "Salipawpaw", archer: "Tagapana", wall: "Wall", spearThrower: "Tagasibat", barbarianAxeSwinger: "Barbarian-Axe Swinger",
		...
		de: {slinger: "Steinschleuderer", swordsman: "Schwertkämpfer", hoplite: "Hoplit", marksman: "Schwefelbüchsen-Schützen", mortar: "Mörser",
			catapult: "Katapult", batteringRam: "Rammbock", steamGiant: "Dampfgigant", balloonBombardier: "Ballon-Bombardier", cook: "Koch",
			doctor: "Arzt", gyrocopter: "Gyrokopter", archer: "Bogenschütze", wall: "Stadtmauer", spearThrower: "Speerträger", barbarianAxeSwinger: "Barbaren-Axtschwinger",
		...
		si: {slinger: "Pračar", swordsman: "Mečevalec", hoplite: "Suličar", marksman: "Mušketir", mortar: "Minometalec",
			catapult: "Katapult", batteringRam: "Oven", steamGiant: "Parni velikan", balloonBombardier: "Balon Bombardir", cook: "Kuhar",
			doctor: "Zdravnik", gyrocopter: "Girokopter", archer: "Lokostrelec", wall: "Zid", spearThrower: "Metalec kopja", barbarianAxeSwinger: "Barbarski metalec sekire",
			ramShip: "Ladja ram", lightvessel: "Metalec plamena", divingBoat: "Podmornica", ballistaShip: "Ladja Ballista",
			catapultShip: "Ladja katapult", mortarShip: "Ladja Minometalec", paddleWheelRam: "Parna vojna ladja"},			
		};
...
var options = {
		...
		yu: { cities: true, loot: true, align: "Center", damage: "GeneralsA" },
...
if( GM_getValue("options_en", null) == null ) GM_setValue("options_en",options['en'].toSource());
if( GM_getValue("options_yu", null) == null ) GM_setValue("options_yu",options['yu'].toSource());
if( GM_getValue("options_rs", null) == null ) GM_setValue("options_rs",options['rs'].toSource());
if( GM_getValue("options_ph", null) == null ) GM_setValue("options_ph",options['ph'].toSource());
if( GM_getValue("options_de", null) == null ) GM_setValue("options_de",options['de'].toSource());
if( GM_getValue("options_si", null) == null ) GM_setValue("options_si",options['si'].toSource());
...
function createTextArea(){
	...
	if( language[lang] == null ){
		alert("Language is not suported. Visit http://userscripts.org/scripts/show/82226 .");
		return 0;
	}
	if( version != "v.0.3.4" ){
		alert("Version is not suported. Visit http://userscripts.org/scripts/show/82226 .");
		return 0;
	}
	...
	$("p.link").append(
		...
		'<br>' +
		'<div align="center">' +
			"<p ><br>Ikariam CR Converter<br>Greasemonkey edition</p><br>" +
			'<div id="top" align="left">' +
				...
				'<div style="float: left; margin: 5px 18px 5px 10px;">' +
					...
					'</div>	' +
					'<div id="top-frame">			' +
						'<input type="radio" id="radio2" name="radio2" value="GeneralsA"/>  ' + language[lang].generals + " - " + language[lang].army + '<br/>' +
						'<input type="radio" id="radio2" name="radio2" value="GeneralsAL"/>  ' + language[lang].generals + " - " + language[lang].armyLoot + '<br/>' +
                  '<input type="radio" id="radio2" name="radio2" value="ResourcesA"/>  ' + language[lang].resources + " - " + language[lang].army + '<br/>' +
                  '<input type="radio" id="radio2" name="radio2" value="ResourcesAL"/>  ' + language[lang].resources + " - " + language[lang].armyLoot + '<br/>' +                  
					'</div>' +
					'<div id="left">' +
   ...
   if( reportElements.winners[0] == null && reportElements.losers[0] == null )
	...
	bbCodeText = "[align=" + options[lang].align + "]" + font +
      ...
      textLoser +
		textDamage +
      finishedBattle +
		"\n\n\n[b][i][color=#999999]" + language[lang].created + " [url='http://userscripts.org/scripts/show/82226']Ikariam CR Converter: Greasemonkey Edition\n" + 
