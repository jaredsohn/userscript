...
(function(){
	...
	if (location.pathname.search('prod.php') != -1 ) {		
		...
		for (var i = 0; i < page.length; i++) {
			...
			newDiv.innerHTML =  "<input type='button'  STYLE='font-size:10pt;font-family:Verdana' value='-' onclick=\"cnt.value--\"><input type='button' value='+' STYLE='font-size:10pt;font-family:Verdana' onclick=\"cnt.value++\"><input type='button' value='Max' STYLE='font-size:10pt;font-family:Verdana' onclick=\"cnt.value='"+maximum+"'\"><input type='button' value='Max/2' STYLE='font-size:10pt;font-family:Verdana' onclick=\"cnt.value='"+maximum+"'/2\">";
			var parentDiv = page[i].parentNode;
			parentDiv.insertBefore(newDiv, page[i]);
		}
