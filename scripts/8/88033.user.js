...
var data = {
	"warehouse": [
		...
		{ b: 11140, w: 1940, m: 1940, c: 1940, s: 1940 },	// 23
...
function showTotal()
{
		...
		td2.innerHTML = <>
								<a
									...
									width="160" height="100" /> <span class="textLabel">&lt;&lt; Back to the Hideout (Angels Of War)</span>
								</a>
								</>;
		...
		td2 = document.createElement("td");
		td2.innerHTML = 'Enjoy!!  (Abu Radwan ^_^)';
