...
//	==Changelog==
//	 Added 2 more options to search users by.
//	 Fixed minor typos.
//	==/Changelog==

// ==UserScript==
// @name           Dark Orbit User Fetcher
// @namespace	    http://userscripts.org/users/ziegel/
// @description    Purpose of the script is to fast fetch all users from "Top users ranking" so information could be used on Trade of DO.
// @include        http://darkorbit.game.garena.com/indexInternal.es?action=internalHandel
// @include        http://*.darkorbit.bigpoint.com/indexInternal.es?action=internalHandel
// @require        http://ajax.googleapis.com/ajax/libs/jquery/1.3.2/jquery.min.js
// ==/UserScript==

var $ar_version = "0.2.2";
var $ar_script_url = "http://userscripts.org/scripts/show/79397";
...
function llaall(start,end,type){
	...
	if(!end){end = 2;}
	switch(type){
		case "s1": url_attr = 'User';
			break;
		case "s2": url_attr = 'Aliens';
			break;
		case "s3": url_attr = 'UserEP';
			break;		
...
$jq(function(){
	...
	$jq('<div id="ar_do_filter_wrap"><span>Nickname filter  <input type="text" id="ar_do_filter" name="ar_do_filter"/>  <span class="loading" style="display: none;"><img src="http://wimg.co.uk/GQf.gif" /> Please wait...</span></span></div><div id="ar_do_loaded_content"><div id="noresults" style="display: none;">No results on that nickname. Maybe try another set of pages or make sure that nickname you entered is correct.</div></div>').appendTo('#do_fetch_data');
