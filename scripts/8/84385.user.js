...
switch(job_tab_low){
        case '1': var t1=setTimeout("do_ajax('mainDiv', 'remote/html_server.php?xw_controller=story&xw_action=view&xw_city=3&story_tab=1', 0, 0)",2000);
    break;
        case '2': var t1=setTimeout("do_ajax('mainDiv', 'remote/html_server.php?xw_controller=story&xw_action=view&xw_city=3&story_tab=2', 0, 0)",2000);
    break;
        case '3': var t1=setTimeout("do_ajax('mainDiv', 'remote/html_server.php?xw_controller=story&xw_action=view&xw_city=3&story_tab=3', 0, 0)",2000);
    break;
        case '4': var t1=setTimeout("do_ajax('mainDiv', 'remote/html_server.php?xw_controller=story&xw_action=view&xw_city=3&story_tab=4', 0, 0)",2000);
    break;
        case '5': var t1=setTimeout("do_ajax('mainDiv', 'remote/html_server.php?xw_controller=story&xw_action=view&xw_city=3&story_tab=5', 0, 0)",2000);
    break;
        case '6': var t1=setTimeout("do_ajax('mainDiv', 'remote/html_server.php?xw_controller=story&xw_action=view&xw_city=3&story_tab=6', 0, 0)",2000);
    break;
        case '7': var t1=setTimeout("do_ajax('mainDiv', 'remote/html_server.php?xw_controller=story&xw_action=view&xw_city=3&story_tab=5', 0, 0)",2000);
    break;
        case '8': var t1=setTimeout("do_ajax('mainDiv', 'remote/html_server.php?xw_controller=story&xw_action=view&xw_city=3&story_tab=6', 0, 0)",2000);
    break;
    }
