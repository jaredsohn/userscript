// ==UserScript==
// @name            Scurtaturi cladiri 2.9 the west
// @description     bara cu scurtaturile cladirilor din oras pt versiune 2.9
...
//  #endregion
    ...
    if (footer_menu_left)
    {
        ...
        footer_menu_left_more.setAttribute('style', 'left: 313px; top: -88px; background-position: 0px 0px; padding-top: 5px; padding-left: -30px; width: 450px; height: 40px; position: absolute; z-index:2; border: 0px solid #3B240B; background: transparent repeat-x scroll 0 0;');
        ...
        setToolTip('footer_building_hotel',     '<b>' + ' ` Hotel de lux'      + '</b>');
        setToolTip('footer_building_bank',      '<b>' + ' ` Banca '       + '</b>');
        setToolTip('footer_building_church',    '<b>' + ' ` Biserică'     + '</b>');
        ...
        setToolTip('footer_item_trader',    '<b>' + ' ` Negustor'     + '</b>');
        setToolTip('footer_building_sheriff',    '<b>' + ' ` Şerif'     + '</b>');
        setToolTip('footer_building_market',    '<b>' + ' ` Piaţă'     + '</b>');
    }
