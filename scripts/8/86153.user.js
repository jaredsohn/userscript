...
GM_addStyle('#styleguide-v2, #styleguide-v2 #wrapper{background: #1F1F1F url(/images/navbar/nav_bar_bg.gif) repeat-x fixed 0 0;}');
GM_addStyle('#tn15 a:visited {color:#3E3E3E;font-weight:bold;}');
GM_addStyle('#tn15 a {color:#1F1F1F;font-weight:bold;}');
GM_addStyle('#tn15 a:link {color:#243757;text-decoration:none;}');
GM_addStyle('#tn15 a:hover {color:#5C5C5C;font-weight:bold;text-decoration:underline;}');
GM_addStyle('#tn15main table tr.even {background:#EDEDED none repeat scroll 0 0;}');
GM_addStyle('#tn15lhs a.link.selected {background:transparent url(/images/navbar/nav_bar_bg.gif) repeat scroll 0 0;}');
GM_addStyle('#tn15main table.boards th {font-size:95%;height:21px;background:transparent url(/images/navbar/nav_bar_bg.gif) repeat-x scroll 0 0;}');
GM_addStyle('#tn15crumbs {font-size:95%;padding-top:4px;}');
GM_addStyle('#tn15main h3 {font-size:151%;line-height:19px;}');
GM_addStyle('#tn15 h2, #tn15 h3, #tn15 h4, #tn15 select, #tn15 .small {font-family:Tahoma;}');
GM_addStyle('#tn15 h1 {font-family:Georgia;font-size:331%;letter-spacing:-3px;}');
GM_addStyle('#navbar input {color:white; height:14px !important; border:3px double #CC9933; color:#000000; font-size:10px;font-weight:bold; vertical-align:middle !important; padding:0.25em;}');
GM_addStyle('#tn15title span.pro-link {font-family:Arial,Helvetica,sans-serif;font-size:54%;}');
GM_addStyle('#pagecontent{background:#EDEDED;}');
GM_addStyle('.starbar .outer {background:transparent url(http://files-search.com/userscripts/stars.gif) no-repeat scroll 0 -20px;}');
GM_addStyle('.starbar .inner {background:transparent url(http://files-search.com/userscripts/stars.gif) no-repeat scroll 0 -20px;}');
GM_addStyle('#tn15main .strip {background:transparent none repeat scroll 0 0;}');
GM_addStyle('#adremovedvideospace {background:transparent none repeat scroll 0 0; border-left:9px solid transparent;}');
GM_addStyle('.keyword-spoiler {background-image:url(http://files-search.com/userscripts/keyword-spoilers.gif);}');
GM_addStyle('#tn15bot .right {background:transparent none repeat scroll 0 0; border-left:12px solid transparent;}');
GM_addStyle('#tn15lhs {background-color:#EDEDED;}');
GM_addStyle('#adremovedvideospace {background:transparent none repeat scroll 0 0 !important; border-left:9px solid transparent !important;}');
GM_addStyle('#footer hr {border-color:#EDEDED;border-style:dashed none none;border-width:5px 0 0;}');
GM_addStyle('.tinystarbar {border:1px solid black;}');
GM_addStyle('#navbar select {background:#FFFF99 url(/images/navbar/button-bg-primary.gif) repeat-x scroll left top;border:3px double #CC9933;font-size:12px;font-weight:bold;height:26px !important;padding:0.15em;vertical-align:middle;width:110px;}');

}

var nb_extra = document.getElementById('main_nav');

var inter_nb_extra = document.createElement('li');
var a_nb_extra = document.createElement('a');
a_nb_extra.innerHTML ='Dark Style';
a_nb_extra.href ='#';

inter_nb_extra.appendChild(a_nb_extra);
nb_extra.appendChild(inter_nb_extra);
a_nb_extra.addEventListener("click", changeTheStyle, true);
...
"<option value='megaupload2'>megaupload2"+
...
"<option value='hotfile.com'>hotfile.com"+
...
GM_addStyle('select#SharedHttpFilesId{background:white none repeat scroll 0 0; color:black; cursor:pointer; height:21px; left:4px; opacity:0.8; position:relative; top:0; width:101px;}');
...
GM_addStyle('#SubsResultsRHere { background:transparent url(/images/tn15/messageboard_header_bgd.gif) repeat-x scroll 0 0;font-family:Tahoma; -moz-border-radius-bottomleft:4px; -moz-border-radius-bottomright:4px; font-size:11px;font-weight:bold;margin:0px 0pt 3px;padding:0px 4px;position:absolute;right:14%;text-align:center;} ');
...
"<div class='strip toplinks'><b class='ch5'>Torrentz</b> <img border='0' class='control' src='"+imageWithControls+"' usemap='#Maptorrent'> "+
"<map name='Maptorrent'>"+
...
"</map>"+	
"<b class='ch5'>Vcdquality</b> <img border='0' class='control' src='"+imageWithControls+"' usemap='#MapVcdquality'> "+
...
"<area class='aa3' id='makebig' shape='rect' coords='1,1,15,15' href='#maximizehttpother' ALT='Get files from http hosts' TITLE='Get files from hotfile mediafire uploaded.to megashares.com rapidshare.de depositfiles netload.in'>"+
"<area class='aa2' id='makesmall' shape='rect' coords='16,1,31,15' href='#minimizehttpother' ALT='Close results from http hosts' TITLE='Close results from hotfile mediafire uploaded.to megashares.com rapidshare.de depositfiles netload.in'>"+
"</map-->";
     ...
     if (openRapidsharew[i].className == "SpaceForMoviesOnlineResults"){     	 
         ...
         GM_addStyle('div#SpaceForMoviesOnlineResults{  overflow-x:auto;}');       
	       ...
	       if(!document.getElementById('MoviesOnlineRHere')){
	        //googlesearchurl =	"http://www.google.com/ie?q=tt"+imdbID+"+%22rapidshare+com+files%22&num=100&hl=en&lr=&btnG=Search";
            //googlesearchurl =	"http://www.google.com/search?output=ie&q=tt"+imdbID+"+%22rapidshare+com+files%22&num=100&hl=en&lr=&btnG=Search";
			...
			for (i in json.results){
				if(json.results[i].title){
				   ...
				   var d = document.createElement('div');
				 	...
				 	d.innerHTML="<h2>"+title+"</h2><a href='"+vidur+"'><img style='float:left; padding:3px;' src='"+viimg+"'/></a>"+conte+"<br/><a href="+vidur+">link</a>";
...
"all" 						   : '"rapidshare.com/files"||"hotfile.com/?d"||"letitbit.net"||"badongo.com/file/"||"depositfiles.com/"||"vip-file.com/download"||"filefactory.com/file"||"storage.to/get"||"hotfile.com/dl"||"netload.in/date"',
//"all" 						   : "%22rapidshare.com%2Ffiles%22%7C%7C%hotfile.com%2F%3Fd%22%7C%7C%22letitbit.net%22%7C%7C%22badongo.com%2Ffile%2F%22%7C%7C%22depositfiles.com%2F%22%7C%7C%22vip-file.com%2Fdownload%22%7C%7C%22filefactory.com%2Ffile%22%7C%7C%22storage.to%2Fget%22%7C%7C%22hotfile.com%2Fdl%22%7C%7C%22netload.in%2Fdate%22",
//"all" 						   : "%22rapidshare.com%2Ffiles%2F%22||%22hotfile.com%2F%3Fd%3D%22||%22filefactory.com%2Ffile%2F%22",
"rapidshare"                   : "%22rapidshare.com/files/%22",
"hotfile"                   : "%22hotfile.com/?d=%22",
...
"hotfile.com"               : "%22hotfile.com/?d=%22",
...
otherhostssearchurl = "tt"+imdbID+"+%22interchangeable+links%22+OR+%22hotfile+com+d%22+OR+%22mediafire.com%2F%5C%5C%3F%22+OR+%22uploaded+to+id%22+OR+%22megashares.com%22+OR+%22rapidshare.de%5C%2Ffiles%22+OR+%22depositfiles%5C.com%22+OR+%22netload%5C%5C.in%22+OR+%22filefactory.com/file/%22";
...
function makeTheSearchQueryOtherhosts(event){
    //theSearchQueryOtherhosts = "http://www.google.com/search?output=ie&q="+escape(event.target.parentNode.childNodes[2].value)+"&num=100&hl=en&lr=&btnG=Search";
...
function closeSubs(){
	...
	for (var i = closeSubsw.length - 1; i >= 0; i--) {
     if (closeSubsw[i].className == "SpaceForSubsResults"){
...
GM_addStyle('div#onlinevideores{background-color:#FFFEEF; min-height:20em; border:1px solid #CCCCCC; float:left; margin:5px 5px 5px 5px; min-width:14em;overflow:hidden; padding:0px; width:22%;}');
 ...
 GM_xmlhttpRequest({
       ...
       if (responseDetails.responseText.match(/did not return any results/)){
	      ...
	      var gVideoRes = document.createElement('div');
     		  ...
     		  gVideoRes.innerHTML = responseDetails.responseText;

var divs = gVideoRes.getElementsByTagName('div');

for(var i = 0, n = divs.length; i < n; i++){
	if (divs[i].className=='rl-res') {
		var thisurl = divs[i].attributes[0].value;
		var thistitle = divs[i].childNodes[3].childNodes[1].textContent;
		thistitle = thistitle.replace(/\n/g,'');
		//var thisduration_ = getElementsByClassName("rl-special" , "div", divs[i]);	
	
		//thisduration = thisduration_[0].attributes[1].textContent;
		thisduration = divs[i].attributes[4].textContent;
		var tm=new Date(thisduration*1000)
...
var favicon = "http://"+RegExp.$2+"/favicon.ico";
	...
	if (!(thisurl.match(/(rottentomatoes)|(yahoo\.com)|(uzout\.com)|(video\.aol\.com)|(cineworld\.co\.uk)/))){		
		foundresults.innerHTML	+= "<div id='onlinevideoresgoogle'><h2 class='item-title' title='"+thistitle+"'>"+thistitle.substr(0,66)+" </h2><div id='item-img'><center><img style='width:124px;' src='"+thisthumbnail+"'/></center></div>"+
...
GM_addStyle('div#onlinevideoresgoogle{background:#FFFFCC url(/images/nb15/searchbg.gif) repeat-x scroll center bottom; min-height:22em; border:1px solid #CCCCCC; float:left; margin:5px 5px 5px 5px; min-width:14em;overflow:hidden; padding:0px; width:22%;}');
...
gtrans1 = "http://translate.google.com/translate?prev=_t&hl=en&ie=UTF-8&u=http%3A%2F%2Fso.youku.com%2Fsearch_playlist%2Fq_%2B"+moviename+"%2Fcateid_128&sl=zh-CN&tl=en&history_state0=";	
...
GM_xmlhttpRequest({
			...
			onload:function(responseDetails){
				...
				var orglinkyoukuvideourl = youkuvideourl;
					orglinkyoukuvideourl = unescape(orglinkyoukuvideourl.match(/http\:\/\/.*?u=(.*?)&prev=.*?$/)[1]);
  ...
  for(var i = 0, n = divs.length; i < n; i++){
    ...
    if (vTag[0]){
     ...
     if (runtime.match("^"+firstpartofthehour)){
		...
		"<h2 class='item-title' title='"+thetitle+"'>"+thetitle.substr(0,66)+" </h2>"+
...
function prepareforanewgooglesearch(evt){
	...
	//var googlesearchurl = 'http://www.google.com/search?output=ie&q='+evt.currentTarget.previousSibling.value+'+&num=100&hl=en&lr=&btnG=Search';
...
function GetAndShowMeTheRapidshare(googlesearchurl,where,rightpositionprs,TheQueryIsCommingFrom){
	...
	GM_addStyle('img#PleaseWaitForRapidshare{  display: block; padding:0px 70px 3px;}');
		...
		GM_xmlhttpRequest({
			...
			//var inputbox = 'Asking google for: '+googleresponse.match(/<input type=text name=q value=".*?>/);
			...
			GM_addStyle('li.g{display:inline-block;margin-bottom:10px;background-color:#EDECEB;-moz-border-radius:10px 10px 10px 10px;border:1px solid #FAFAFA;width:80%;}');
	   ...
	   */
		   ...
		   //no results from first query so we make a secont different query
  	       if (TheQueryIsCommingFrom == "openOtherhosts"){
  	       	//newgooglesearchurl =	"http://www.google.com/search?output=ie&q=%22"+moviename+"%22+%22interchangeable+links%22+OR+%22hotfile+com+d%22+OR+%22mediafire.com%2F%5C%5C%3F%22+OR+%22uploaded+to+id%22+OR+%22megashares.com%22+OR+%22rapidshare.de%5C%2Ffiles%22+OR+%22depositfiles%5C.com%22+OR+%22netload%5C%5C.in%22+OR+%22filefactory.com/file/%22&num=100&hl=en&lr=&btnG=Search";
	        newgooglesearchurl =	"http://www.google.com/search?hl=en&q=%22"+moviename+"%22+%22interchangeable+links%22+OR+%22hotfile+com+d%22+OR+%22mediafire.com%2F%5C%5C%3F%22+OR+%22uploaded+to+id%22+OR+%22megashares.com%22+OR+%22rapidshare.de%5C%2Ffiles%22+OR+%22depositfiles%5C.com%22+OR+%22netload%5C%5C.in%22+OR+%22filefactory.com/file/%22&num=100&btnG=Search";
  	       ...
  	       if (TheQueryIsCommingFrom == "openRapidshare"){
  	       	//newgooglesearchurl =	"http://www.google.com/search?output=ie&q=%22"+moviename+"%22+%22rapidshare+com+files%22&num=100&hl=en&lr=&btnG=Search";
...
if ( dalinks1.match(/ed2k/) ){
  ...
  if (myArray.length>0){           
     ...
     var therigthfoundlink = document.evaluate('//a[contains(@href, "'+linko+'")]',
                                  document, null, XPathResult.UNORDERED_NODE_SNAPSHOT_TYPE, null);
...
GM_xmlhttpRequest({
			...
			onload:function(responseDetails){
					...
					var opensubtitlesresults = '<br><table border="0" width="98%">';
...
GM_xmlhttpRequest({
	...
	if (items.length>1){
		...
		var all4divxresults = '<br><table border="0" width="98%">';
...
//searchvcd ='http://www.vcdquality.com/index.php?imdbid=';
searchvcd ='http://www.vcdq.com/search-vcdq?title=';
//urlvcd = searchvcd+imdbID;
urlvcd = searchvcd+moviename;
    GM_xmlhttpRequest({
        ...
        if (rd.status == 200) {
         ...
         //rd.responseText = rd.responseText.replace(/ /sites/all/themes/vcdq/images/jpg.gif /,'http://www.vcdq.com/sites'); 
 ...
 var somelayoutVCDQualityResults = document.getElementById('vcdqualitytbl');
    	 //somelayoutVCDQualityResults.rows[0].setAttribute('style', 'text-align:left; background:PaleGoldenrod;padding:0px 0pt 0px 8px;-moz-border-radius-topleft:7px;-moz-border-radius-topright:7px;');
     somelayoutVCDQualityResults.rows[0].setAttribute('id','vcdtablestyle');
...
function GetAndShowMeTheTorrentz()  {
...
window.setTimeout(function() {
	var torrentsmeta = document.getElementById('torrentsmeta');
	if ( torrentsmeta.contentWindow.URL = 'about:blank' ){

var Node1 = document.getElementById('torrentsmeta');
Node1.removeChild(Node1.childNodes[0]);
		
	//torrentsmeta.style.height = "auto";
	GetAndShowMeTheTorrentz();
	//alert('Hello world!'); 
    }
}, 2000);
...
GM_addStyle('img#PleaseWaitForTorrents{  display: block; padding:0px 70px 3px;}');	
	...
	iframe.setAttribute('src', 'http://files-search.com/torrents/imdbpirated.php?search='+query);
	iframe.setAttribute('width', '100%');
	iframe.setAttribute('height', '500px');
	iframe.setAttribute('border', 0);
	iframe.setAttribute('id', 'torrentsmeta');
	
GM_addStyle('iframe#torrentsmeta{  border:0px;}');	

  document.getElementById('SpaceForTorrentResults').appendChild(iframe);
...
var playerZoomWidth = document.getElementById('tn15main').clientWidth;
var playerZoomHeight = (parseInt(document.getElementById('tn15main').clientWidth)/parseInt(parseInt(document.getElementById('jeroenwijering').style.height)/parseInt(document.getElementById('jeroenwijering').style.width)));
...
var playerSmallWidth = 323;	
		...
		if(parseFloat(document.getElementById('jeroenwijering').width) != playerZoomWidth){ 
			// kanta megala
			document.getElementById('adremovedvideospace').style.width = playerZoomWidth+"px";			
			...
			document.getElementById('adremovedvideospace').style.width = "323px";		
...
var div = document.createElement('div');
	div.id = "holdinthem";
	div.innerHTML = '<h3 style="width:19em;overflow:hidden;height:1em;"> '+youtubelinktitle+'</h3>'; 
...
var embed_jeroenwijering = document.createElement('embed');
	...
	embed_jeroenwijering.src = "http://www.youtube.com/v/"+youtubeid+"&hl=en&fs=1&hd=1&color1=0xD4D9DD&color2=0xEEE7A0&showinfo=0&enablejsapi=1&playerapiid=ytplayer";
...
var img_toggleSize = document.createElement("img"); 
    ...
    img_toggleSize.setAttribute("style","cursor: pointer; float: right; z-index:10; position:relative; left:-7px;margin:-10px;top:9px;");
...
"id('vcdqualitytbl')/tbody/tr/td[4]/a",  
  document,
	null,
	XPathResult.UNORDERED_NODE_SNAPSHOT_TYPE,
	null);
...
GM_addStyle('div#bodyContent {background-color:#F0F1F7;margin-left:-7px;padding-left:7px;}');
...
function callback(url,response)
	{
	var myregexp = /<li><a href="(\/wiki\/.*?)" title="(.*?)">(.*?)<\/a>/;
...
function getInfoFromWikipedia()
	{
		...
		var div = document.createElement("div");
			...
			div.innerHTML = '<h5>Wikipedia Info:</h5>';
...
/*
http://movie-info.org/searchimdb
http://movie-info.org/browse
http://www.orlydb.com/?q=La+dolce+vita+xvid
*/
