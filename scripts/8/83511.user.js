...
javascript:(function(){
    ...
    try{ 
        document.getElementById('setup_progress_bar').parentNode.removeChild(document.getElementById('setup_progress_bar')); 
    } 
    catch(err){}
    ...
    try{
        document.getElementById('buyframe_link_container_anim').parentNode.removeChild(document.getElementById('buyframe_link_container_anim'));
    }
    catch(fberr){}
    try{
        document.getElementById('buyframe_link_cover_anim').parentNode.removeChild(document.getElementById('buyframe_link_cover_anim'));
    }
    catch(fberr){}
    ...
    var table_html='<table class="sexy_error_table" width=100% id="errormsg" border=2 rules=none bgcolor="black"><tr style="font-weight:bold"><td style="padding-left:15px;padding-right:15px;">Upcoming weekend is Boycott weekend. For more info about why, how, when, follow the links below - <br><br><a href="http://www.facebook.com/event.php?eid=139619596071923&index=1" target="_blank">Event Details</a> - <a href="http://mwlootlady.blogspot.com/2010/08/aug-14-15-no-play-click-or-trade-update.html" target="_blank">No Click, Play or Trade</a></td></tr></table><br>'+
            '<form id="something">'+
            ...
            '<tr>'+
            '<th width="50%" style="font-size:20px; padding-left:15px;text-align: left">Brawler v3.4</th>'+
...
//            '</select>'+
            ...
            '<td width="10%">Cash</td>'+
            '<td width="1%">:</td>'+
            '<td width="56%"><span id="cash"><span class="good"><img src="http://mwfb.static.zynga.com/mwfb/graphics/icon_cash_16x16_01.gif"></img> $0&nbsp;<img src="http://mwfb.static.zynga.com/mwfb/graphics/icon_cubanpeso_16x11_01.gif"></img>&nbsp;C$0&nbsp;<img src="http://mwfb.static.zynga.com/mwfb/graphics/icon_cash_moscow_16x16_01.gif"></img>&nbsp;R$0&nbsp;<img src="http://mwfb.static.zynga.com/mwfb/graphics/icon_cash_bangkok_16x16_01.gif"></img>&nbsp;B$0&nbsp;<img src="http://mwfb.static.zynga.com/mwfb/graphics/vegas-chip.png"></img>&nbsp;V$0</span></span></td>'+
            '<td width="1%">&nbsp;</td>'+
            '<td width="10%"><img src="http://mwfb.static.zynga.com/mwfb/graphics/victory_icon.gif"></img><span id="Victorycoins">0</span></td>'+
            '<td width="1%">&nbsp;</td>'+
            '<td width="8%">Delay</td>'+
            '<td width="1%">:</td>'+
...
//        health_lost = /fightres_health">took ([0-9]+)/.exec(attack_results)[1];
        ...
        exp_to_levelup = parseInt(/user_fields\['exp_for_next_level'\] = parseInt\("([0-9]+)/.exec(attack_results)[1]) - parseInt(document.getElementById('user_experience').innerHTML);
...
//                 user_urls[j]= 'http://facebook.mafiawars.com/mwfb/remote/html_server.php?xw_controller=fight&xw_action=attack&xw_city=1&tmp='+tmp_key+'&cb='+cb+'&opponent_id='+user_list[j]+'&xw_client_id=8&ajax=1&liteload=1&sf_xw_user_id='+userid+'&sf_xw_sig='+local_xw_sig;
                 user_urls[j]= 'http://facebook.mafiawars.com/mwfb/remote/html_server.php?xw_controller=fight&xw_action=attack&xw_city=1&tmp='+tmp_key[j]+'&cb='+cb+'&opponent_id='+user_list[j]+'&origin=fight_page&xw_client_id=8&ajax=1&liteload=1&sf_xw_user_id='+userid+'&sf_xw_sig='+local_xw_sig;
                 attack_user();
              }
            });
            return;
...
//            document.getElementById('attack_log').innerHTML += attack_log[l]+'<br>';
    ...
    function bank(amount,city){
        if(fight_city == 5){
            ...
            $.ajax({type: "POST", data: params, 
                    url: "http://facebook.mafiawars.com/mwfb/remote/html_server.php?xw_controller=propertyV2&xw_action=doaction&xw_city=5&doaction=ActionBankDeposit&tmp="+vault_tmp_variable+"&cb="+vault_cb_variable+"&amount="+amount+"&city=5&building_type=6&xw_client_id=8",
