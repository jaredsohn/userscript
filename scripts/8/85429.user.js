...
function showTotal()
{
		...
		td1 = document.createElement("td");
		td1.setAttribute("class","job");
		td1.innerHTML = 'Nível do Armazém:';

		td2 = document.createElement("td");
		 var wareDiv = <>
								<input type="text" style="text-align: right;" size="8"  id="warehouseLevelId" value="0"/>  Ex. 3 ou 1,2,3 para múltiplos armazéns.
								<input type="checkbox" ID="ActiveFieldCheckBox" name="Active" />Marque se for ativo
							</>;
		...
		td1 = document.createElement("td");
		td1.setAttribute("class","job");
		td1.innerHTML = 'Recursos Roubáveis:';
		...
		td2.innerHTML = <>
								<a
									href={backURL}
									title="Voltar para Espionagem"> <img
									src="skin/buildings/y100/safehouse.gif"
									width="160" height="100" /> <span class="textLabel">&lt;&lt; Voltar para Espionagem (Aba Espionagem)</span>
								</a>
								</>;
		...
		td2 = document.createElement("td");
		td2.innerHTML = 'Traduzido por Unknown Player';
