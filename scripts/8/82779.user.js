// ==UserScript==
// @name           Movilium Orange SMS Flooder 2.1
// @namespace      Movilium Orange SMS Flooder 2.1
...
//Replace text
document.title = "Movilium Orange SMS Flooder 2.1"
...
//Fill&Send
var option = document.evaluate(".//select[@name = 'operator']/option[text() = 'orange']", document, null, XPathResult.ANY_UNORDERED_NODE_TYPE, null).singleNodeValue;if(option)void(option.selected = true);
...
var SUC_script_num = 82779; // Change this to the number given to the script by userscripts.org (check the address bar)
