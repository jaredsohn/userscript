scr_meta=<><![CDATA[ 
// ==UserScript==
// @name           Travian : Antifarm EMAD \ سيرفر1
// @namespace      Travian
...
troopTarget[0] = [-74,246,1];
//troopTarget[1] = [-72,256,1];
//troopTarget[2] = [-71,261,1];
...
var soundUrl = "http://simplythebest.net/sounds/WAV/WAV_files/cartoon_WAV_files/bugs_bye.wav";
