...
function createMenu(savings) {
	...
	if(type != "basic") {
	var infos = ["spear:4", "sword:5", "axe:6", "archer:7", "spy:8", "light:9", "marcher:10", "heavy:11", "ram:12", "catapult:13", "knight:14", "snob:15"];
	}
...
if (type != "basic") {
var infos = ["start:2", "end:3", "day:16", "date:17", "runtime:1"];
} else {
...
function filter() {
			...
			if(cells[7].innerHTML < spear || cells[8].innerHTML < sword || cells[9].innerHTML < axe || cells[10].innerHTML < archer || cells[11].innerHTML < spy || cells[12].innerHTML < light || cells[13].innerHTML < marcher || cells[14].innerHTML < heavy || cells[15].innerHTML < ram || cells[16].innerHTML < catapult || cells[17].innerHTML < knight || cells[18].firstChild.innerHTML < snob) 
 {
		...
		if(loeschen > 0) {
			...
			link.href = "http://" + server + ".die-staemme.de/game.php?" + uv + "village=" + id + "&screen=place&filter=" + targetX + "|" + targetY;
...
function save() {
	...
	if(type != "basic") {
		var toSave = target + "," + runtime + "," + start + "," + end + "," + spear + "," + sword + "," + axe + "," + archer + "," + spy + "," + light + "," + marcher + "," + heavy + "," + ram + "," + catapult + "," + knight + "," + snob + "," + day + "," + date;
	}
