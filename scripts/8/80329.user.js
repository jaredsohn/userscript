	...
	switch(newLang){
	  // German - by Pimp Trizkit
		case "de":		newLangArray = [["Freie Schiffe","Rohstoffe", "Asteroiden", "Trümmer", "components", "resources", "stuff", "Battle"], // These words must be as they appear in EU2 or else functionality is lost."Free Ships" is seen on the EU2 Fleets screen. Its the second tab's name. "Resources" is seen when loading/unloading cargo at a planet. Its the first tab name. "Asteroiden" and "Wreckage" is used to detect objects in the StarSystem screen.
										["Chat","Main","Roids","Wreckages","Wormhole","Search","Battles", "Options", "Route","Find planet"], // eu2b Buttons
										...
										["Delete","Database","Click OK to Delete All the", "-&nbsp;Delete&nbsp;-<br>-&nbsp;Databases&nbsp;-","+&nbsp;Save&nbsp;+", "Keep Saved", "All", "New&nbsp;Data", "+&nbsp;New&nbsp;+<br>+&nbsp;Data&nbsp;+", "Delete&nbsp;New", "Save&nbsp;New"], // All those words on the eu2b options screen
										...
										["System","Distance","the goal is ","inside the zone:","inside the intersection of ", "this zones","in one of ","-- to find the goal planet --+<br>+indicates the systems and the distances+<br>+1)-you can indicates 2 ou 3 systems+<br>+2)-give for each the distance+<br>+3)-then click on 'Calc'+<br>+the result could be+<br>+an unique zone in case of 3 distances+<br>+two zones in case of only 2 distances given+<br>+","Accuracy"]]; //Words on the triangulation tool
						break;
		...
		case "fr":		newLangArray = 	[["Vaisseaux disponibles","Ressources", "Asteroiden", "Champs de débris ", "components", "resources", "stuff", "Battle"], // These words must be as they appear in EU2 or else functionality is lost."Free Ships" is seen on the EU2 Fleets screen. Its the second tab's name. "Resources" is seen when loading/unloading cargo at a planet. Its the first tab name. "Asteroiden" and "Wreckage" is used to detect objects in the StarSystem screen.
										...
										["Supprimer","Database","Click OK to Delete All the", "-&nbsp;Delete&nbsp;-<br>-&nbsp;Databases&nbsp;-","+&nbsp;Save&nbsp;+", "Keep Saved", "All", "New&nbsp;Data", "+&nbsp;New&nbsp;+<br>+&nbsp;Data&nbsp;+", "Delete&nbsp;New", "Save&nbsp;New"], // All those words on the eu2b options screen
										["Direct", "WH", "to", "Processing", "Please Wait!", "Your Browser will be frozen during this time.", "Improper Data.", "The Best Route I Can Find Is The Long Way:", "pc", "Just take the wormhole:", "Calculated in",  "seconds.", "Duplicates Removed", "Permutations", "Direct Route", "End", "WHs", "Distance", "Saved", "Find", "From:", "To:", "-- To Calculate route --<br>1)Indicate the source system.<br>2)Indicate the target system<br>3)Click on 'Find'<br><br>Warning! This could take several seconds! Depending on the number of wormholes in your database and the speed of your computer.<br><br>This <i>will</i> find the best possible route using 3 wormholes or less."], //Words on the Wormhole travel planner
										["Système","Distance","la cible se situe ","dans la zone suivante:","à l'intersection ", "des zones suivantes","dans l'une ","-- pour trouver une planète -- <br> indiquez les systèmes et les distances mesurées <br> 1)-on peut fournir 2 ou 3 systèmes <br> 2)pour chacun indiquer la distance mesurée <br> 3)-cliquer sur 'Calc' <br> le resultat sera<br>une zone unique dans le cas où 3 distances auront été fournies <br> deux zones dans le cas ou seulement 2 distances auront été fournies <br> , ","Precision"]]; //Words on the triangulation tool
						break;
		...
		case "nl": 		newLangArray = [["Vrije Schepen","grondstoffen", "Asteroiden", "Wrak", "components", "resources", "stuff", "Battle"], // These words must be as they appear in EU2 or else functionality is lost."Free Ships" is seen on the EU2 Fleets screen. Its the second tab's name. "Resources" is seen when loading/unloading cargo at a planet. Its the first tab name. "Asteroiden" and "Wreckage" is used to detect objects in the StarSystem screen.
						...
						break;
		// Turkey - by nemox
		case "tr": 		newLangArray = [["Boştaki gemiler","Hammadde", "Asteroiden", "Enkaz" , "components", "resources", "stuff", "Battle"],// These words must be as they appear in EU2 or else functionality is lost."Free Ships" is seen on the EU2 Fleets screen. Its the second tab's name. "Resources" is seen when loading/unloading cargo at a planet. Its the first tab name. "Asteroiden" and "Wreckage" is used to detect objects in the StarSystem screen.
										["Chat","Main","Roids","Wreckages","Wormhole","Search","Battles", "Options", "Route","Find planet"], // eu2b Buttons
										["Total Asteroids","Total Wrecks","Total Wormholes","Total Results"], // Totals
										["Objects","Star Systems","Planets","Fleets","Asteroids","Wreckages","Wormholes", "Keep<br>Current", "Goto", "Star System", "Star System not in Database!"], // eu2b Main screen words
										["Total","empty cargo", "mins (or", "hrs)", "to deplete","till full", "res"], // eu2b words added to EU2 Collect screen
										["Free Ships at", "Resources at", "empty", "Asc", "Dec", "Reload", "t=", "ms", "None", "no info", "Göktaşı", "Enkaz", "Nodig XP", "Error", "Not Miner", "Full", "In Use", "Goto Options, Click <i>Save New</i> for ", " to update this screen."], // Other words used
										["Delete","Database","Click OK to Delete All the", "-&nbsp;Delete&nbsp;-<br>-&nbsp;Databases&nbsp;-","+&nbsp;Save&nbsp;+", "Keep Saved", "All", "New&nbsp;Data", "+&nbsp;New&nbsp;+<br>+&nbsp;Data&nbsp;+", "Delete&nbsp;New", "Save&nbsp;New"], // All those words on the eu2b options screen
										["Direct", "WH", "to", "Processing", "Please Wait!", "Your Browser will be frozen during this time.", "Improper Data.", "The Best Route I Can Find Is The Long Way:", "pc", "Just take the wormhole:", "Calculated in",  "seconds.", "Duplicates Removed", "Permutations", "Direct Route", "End", "WHs", "Distance", "Saved", "Find", "From:", "To:", "-- To Calculate route --<br>1)Indicate the source system.<br>2)Indicate the target system<br>3)Click on 'Find'<br><br>Warning! This could take several seconds! Depending on the number of wormholes in your database and the speed of your computer.<br><br>This <i>will</i> find the best possible route using 3 wormholes or less."], //Words on the Wormhole travel planner
										["System","Distance","the goal is ","inside the zone:","inside the intersection of ", "this zones","in one of ","-- to find the goal planet --+<br>+indicates the systems and the distances+<br>+1)-you can indicates 2 ou 3 systems+<br>+2)-give for each the distance+<br>+3)-then click on 'Calc'+<br>+the result could be+<br>+an unique zone in case of 3 distances+<br>+two zones in case of only 2 distances given+<br>+","Accuracy"]]; //Words on the triangulation tool
						break;
		// Polish - by MrHayt 
		case "pl":		newLangArray = 	[["Wolne statki","Surowce", "Asteroid", "Złom", "components", "resources", "stuff", "Battle"], // These words must be as they appear in EU2 or else functionality is lost."Free Ships" is seen on the EU2 Fleets screen. Its the second tab's name. "Resources" is seen when loading/unloading cargo at a planet. Its the first tab name. "Asteroiden" and "Wreckage" is used to detect objects in the StarSystem screen.
										["Chat","Main","Aster","Pola złomu","Czerwotocze","Szukaj","Battles", "Opcje", "Route","Find planet"], // eu2b Buttons
										["Wszystkie Asteroid","Cały Złom","Wszystkie Czerwotocze","Wszystkie Wyniki"], // Totals
										["Obiektów","Sys.Gw.","Planet","Flot","Asteroid","Złomu","Czerwotoczy", "Zachowaj<br>Aktualne", "Iź do", "Sys.Gw.", "Sytemu Gwiezdnego nie ma w Bazie!"], // eu2b Main screen words
										["Razem","Wolna ładowność", "min. (lub", "godz.)", "Do zebrania","Do pełna", "jednostek"], // eu2b words added to EU2 Collect screen
										["Wolnych statków na", "Surowców na", "pusty", "1>9", "9>1", "Reload", "load:", "ms", "brak", "brak info", "Asteroida", "Złom", "Potrzebne XP", "Error", "Not Miner", "Full", "In Use", "Goto Options, Click <i>Save New</i> for ", " to update this screen."], // Other words used
										["Usuń","Bazy","Kliknij OK Aby usunąć wszstkie", "-&nbsp;Delete&nbsp;-<br>-&nbsp;Databases&nbsp;-","+&nbsp;Save&nbsp;+", "Keep Saved", "All", "New&nbsp;Data", "+&nbsp;New&nbsp;+<br>+&nbsp;Data&nbsp;+", "Delete&nbsp;New", "Save&nbsp;New"], // All those words on the eu2b options screen
										["Direct", "WH", "to", "Processing", "Please Wait!", "Your Browser will be frozen during this time.", "Improper Data.", "The Best Route I Can Find Is The Long Way:", "pc", "Just take the wormhole:", "Calculated in",  "seconds.", "Duplicates Removed", "Permutations", "Direct Route", "End", "WHs", "Distance", "Saved", "Find", "From:", "To:", "-- To Calculate route --<br>1)Indicate the source system.<br>2)Indicate the target system<br>3)Click on 'Find'<br><br>Warning! This could take several seconds! Depending on the number of wormholes in your database and the speed of your computer.<br><br>This <i>will</i> find the best possible route using 3 wormholes or less."], //Words on the Wormhole travel planner
										["System","Distance","the goal is ","inside the zone:","inside the intersection of ", "this zones","in one of ","-- to find the goal planet --+<br>+indicates the systems and the distances+<br>+1)-you can indicates 2 ou 3 systems+<br>+2)-give for each the distance+<br>+3)-then click on 'Calc'+<br>+the result could be+<br>+an unique zone in case of 3 distances+<br>+two zones in case of only 2 distances given+<br>+","Accuracy"]]; //Words on the triangulation tool
						break;
		// English - by Pimp Trizkit
		case "com":
		default:		newLangArray = [["Free ships","Resources", "Asteroiden", "Wreckage", "components" , "resources", "stuff", "Battle"], // These words must be as they appear in EU2 or else functionality is lost."Free Ships" is seen on the EU2 Fleets screen. Its the second tab's name. "Resources" is seen when loading/unloading cargo at a planet. Its the first tab name. "Asteroiden" and "Wreckage" is used to detect objects in the StarSystem screen.
										["Chat","Main","Roids","Wreckages","Wormhole","Search", "Battles", "Options", "Route","Find planet"], // eu2b Buttons
										["Total Asteroids","Total Wreckages","Total Wormholes","Total Results"], // Totals
...
function logData (index, myOrbTot, myOs ) {
	...
	for ( var i in myOs ) {
		if  ( (index != -1) && ((index == 0 && !getVal("eu2bTrack"+i+"CB",true)) || (index != 0 && index != i)) ) {
...
function saveData(index, ot, o){
	...
	bLog ("Saved " + s.slice(0,-2) + " in " + ((new Date().getTime()) - st) + " ms.");
}
...
function showRoute(){
	...
	if ( tDiv != null )	{
//		setTravelList("-- " + "Calculate route" + " --<br>" + "indicate the source system" + "<br>" + "indicate the target system" + "<br>" + "then click on 'Find'");
...
function showTriangulationTool(){
	...
	if ( tDiv != null )	{		
//		setTriangulationList("-- " + "triangulation tool" + " --<br>" + "indicates systems and distances" + "<br>" + "then click on 'Calc'");
		tDiv.style.visibility = "hidden";
		eu2bMainDiv.style.visibility = "hidden";
		eu2bRoidsDiv.style.visibility = "hidden";
		eu2bWreckagesDiv.style.visibility = "hidden";
...
function findRouteLauncher() {
	...
	if ( tOutDiv == null ) {
		tOutDiv.innerHTML = "<br>"+myLangArray[5][13];
		return false;
	}
...
function countSegs(tRouteData) {
	if ( tRouteData.length == 5 ) {
		if ( tRouteData[0] < 1 && tRouteData[1] < 1 ) return 0;
		else return 1;
	} else {
		var numSegs = 0;
		for ( var i = 0 ; i < tRouteData[3].length ; ++i ) numSegs += countSegs(tRouteData[3][i]);
		return numSegs;
	}
}
...
//
//	add'on triangulation
//

function Traduction (coordX, coordY) {
    if ( coordY < 10 )
        return (Math.round(coordX).toString() + "0" + Math.round(coordY).toString())
    else
        return (Math.round(coordX).toString() + Math.round(coordY).toString()) ;
}

function addOption(optionText, optionValue, selectObj,typeOpt) {
var tOpt;

	tOpt = document.createElement("option");
	tOpt.text = optionText;
	tOpt.value= optionValue;
	if (typeOpt == 1)
		selectObj.appendChild(tOpt)
	else
		selectObj.add(tOpt,null);
}


function centreGravite(system1, system2, system3, system4) {
	var X1 = new Number(system1);
	var X2 = new Number(system2);
	var X3 = new Number(system3);
	var X4 = new Number(system4);
	var Y1 = new Number(X1 % 100);
	var Y2 = new Number(X2 % 100);
	var Y3 = new Number(X3 % 100);
	var Y4 = new Number(X4 % 100);
	var cX, cy;
	cX = Math.floor((X1 + X2 + X3 + X4) / 400);
	cY = Math.floor((Y1 + Y2 + Y2 + Y4) / 4);
	if (cX > 99) cX = 99;
	if (cY > 99) cY = 99;
	if (cY < 10) 
		return (cX.toString() + "0" + cY.toString())
	else
		return (cX.toString() + cY.toString())
}

function Calculate(X0, Y0, R0, X1, Y1, R1) {
...
var N, Delta, A, B, C, Q ;
    ...
    Solution[2] = -1;
    Solution[3] = -1;
	bLog ( "résolution pour les coordonnées: " + X0 + "/" + Y0 + ":" + R0 + "<br>" + X1 + "/" + Y1 + ":" + R1); 
    if ( Y0 != Y1 ) {
		...
		bLog ("paramètres de l'équation: <br>N=" + N);
		bLog ("Q=" + Q);
		bLog ("A=" + A);
		bLog ("B=" + B);
		bLog ("C=" + C);
		bLog ("Delta=" + Delta);
        if ( Delta > 0.01 ) {
            Solution[0] = (-B + Delta) / 2 / A;
            Solution[2] = (-B - Delta) / 2 / A;
            Solution[1] = N - (Solution[0] * Q);
            Solution[3] = N - (Solution[2] * Q);
		}
        else
            Solution[0] = -B / 2 / A;
            Solution[1] = N - (Solution[0] * Q);
        ...
        N = ((R1 * R1) - (R0 * R0) - (X1 * X1) + (X0 * X0)) / 2 / (X0 - X1);
        Solution[0] = N;
        A = 1;
        B = -2 * Y1;
        C = (X1 * X1) + (N * N) - (2 * X1 * N) + (Y1 * Y1) - (R1 * R1);
        ...
        if ( Delta > 0.01) {
            Solution[2] = N;
            Solution[1] = (-B + Delta) / 2;
            Solution[3] = (-B - Delta) / 2;
			}
        else {
            Solution[1] = -B / 2;
        }
	...
	for (var i = 0; i < 4 ; i++) {
		...
		if (Solution[i] > 99) { Solution[i]=99 }
	}
    return(Solution);
}
...
var Disti_j = new Array;
	...
	quadran = [[["", ""],["", ""],["", ""],["", ""]],
			   ...
			   [["", ""],["", ""],["", ""],["", ""]],
			   [["", ""],["", ""],["", ""],["", ""]]];
	var X1 = new Number(parent.document.getElementById("eu2bOSStartTriangulation1").value) ;
	var X2 = new Number(parent.document.getElementById("eu2bOSStartTriangulation2").value) ;
	var X3 = new Number(parent.document.getElementById("eu2bOSStartTriangulation3").value) ;
	var D1 = new Number(parent.document.getElementById("eu2bDistanceTriangulation1").value) ;
	var D2 = new Number(parent.document.getElementById("eu2bDistanceTriangulation2").value) ;
	var D3 = new Number(parent.document.getElementById("eu2bDistanceTriangulation3").value) ;
	var precision = new Number(parent.document.getElementById("eu2bTriangulationAccuracy").value) ;
	
    tableSystems = [[Math.floor(X1/100) , X1 % 100, D1],
					[Math.floor(X2/100) , X2 % 100, D2],
					[Math.floor(X3/100) , X3 % 100, D3]];
	triangulationString = "";
	if (D1 != 0 && D2 != 0) {
		temp = Calculate(tableSystems[0][0], tableSystems[0][1], tableSystems[0][2] - precision, tableSystems[1][0], tableSystems[1][1], tableSystems[1][2] - precision);
		quadran[0][0][0] = Traduction(temp[0], temp[1]);
		quadran[0][0][1] = Traduction(temp[2], temp[3]);
		temp = Calculate(tableSystems[0][0], tableSystems[0][1], tableSystems[0][2] - precision, tableSystems[1][0], tableSystems[1][1],tableSystems[1][2] + precision);
		quadran[0][1][0] = Traduction(temp[0], temp[1]);
		quadran[0][1][1] = Traduction(temp[2], temp[3]);
		temp = Calculate(tableSystems[0][0], tableSystems[0][1], tableSystems[0][2] + precision, tableSystems[1][0], tableSystems[1][1],tableSystems[1][2] + precision);
		quadran[0][2][0] = Traduction(temp[0], temp[1]);
		quadran[0][2][1] = Traduction(temp[2], temp[3]);
		temp = Calculate(tableSystems[0][0], tableSystems[0][1],tableSystems[0][2] + precision, tableSystems[1][0], tableSystems[1][1], tableSystems[1][2] - precision);
		quadran[0][3][0] = Traduction(temp[0], temp[1]);
		quadran[0][3][1] = Traduction(temp[2], temp[3]);	
	}
	if (D1 != 0 && D3 != 0) {
		temp = Calculate(tableSystems[0][0], tableSystems[0][1], tableSystems[0][2] - precision, tableSystems[2][0], tableSystems[2][1], tableSystems[2][2] - precision);	
		quadran[1][0][0] = Traduction(temp[0], temp[1]);
		quadran[1][0][1] = Traduction(temp[2], temp[3]);
		temp = Calculate(tableSystems[0][0], tableSystems[0][1], tableSystems[0][2] - precision, tableSystems[2][0], tableSystems[2][1],tableSystems[2][2] + precision);
		quadran[1][1][0] = Traduction(temp[0], temp[1]);
		quadran[1][1][1] = Traduction(temp[2], temp[3]);
		temp = Calculate(tableSystems[0][0], tableSystems[0][1], tableSystems[0][2] + precision, tableSystems[2][0], tableSystems[2][1],tableSystems[2][2] + precision);
		quadran[1][2][0] = Traduction(temp[0], temp[1]);
		quadran[1][2][1] = Traduction(temp[2], temp[3]);
		temp = Calculate(tableSystems[0][0], tableSystems[0][1],tableSystems[0][2] + precision, tableSystems[2][0], tableSystems[2][1], tableSystems[2][2] - precision);
		quadran[1][3][0] = Traduction(temp[0], temp[1]);
		quadran[1][3][1] = Traduction(temp[2], temp[3]);	
		Disti_j[0] = calculateDistance (centreGravite(quadran[0][0][0],quadran[0][1][0],quadran[0][2][0],quadran[0][3][0]),
							   centreGravite(quadran[1][0][0],quadran[1][1][0],quadran[1][2][0],quadran[1][3][0])) ;
		Disti_j[1] = calculateDistance (centreGravite(quadran[0][0][1],quadran[0][1][1],quadran[0][2][1],quadran[0][3][1]),
							   centreGravite(quadran[1][0][0],quadran[1][1][0],quadran[1][2][0],quadran[1][3][0])) ;									
		Disti_j[2] = calculateDistance (centreGravite(quadran[0][0][0],quadran[0][1][0],quadran[0][2][0],quadran[0][3][0]),
							   centreGravite(quadran[1][0][1],quadran[1][1][1],quadran[1][2][1],quadran[1][3][1])) ;
		Disti_j[3] = calculateDistance (centreGravite(quadran[0][0][1],quadran[0][1][1],quadran[0][2][1],quadran[0][3][1]),
							   centreGravite(quadran[1][0][1],quadran[1][1][1],quadran[1][2][1],quadran[1][3][1]));
		bLog ("distances des CdG:" + Disti_j[0] + ":" + Disti_j[1] + ":" + Disti_j[2] + ":" + Disti_j[3] + ":");
		dMin = 999;
		j = -1;
		for (var i = 0; i < Disti_j.length; i++) if (dMin > Disti_j[i]) { dMin = Disti_j[i]; j = i};
		bLog("distance mini:" + dMin + " pour le coupe n°" + j);
		if (j == 0) {
			triangulationString += "<br>" + myLangArray[8][2] + myLangArray[8][4] + myLangArray[8][5] + "<br>";
			for (var i = 0; i < 4; i++) {
				triangulationString += ":" + quadran[0][i][0];
				}
			triangulationString +="<br>";
			for (var i = 0; i < 4; i++) {
				triangulationString += ":" + quadran[1][i][0];
			}		
		};
		if (j == 1) {
			triangulationString += "<br>" + myLangArray[8][2] + myLangArray[8][4] + myLangArray[8][5] + "<br>";
			for (var i = 0; i < 4; i++) {
				triangulationString += ":" + quadran[0][i][1];
				}
			triangulationString +="<br>";
			for (var i = 0; i < 4; i++) {
				triangulationString += ":" + quadran[1][i][0];
		...
		if (j == 2) {
			...
			triangulationString +="<br>";
			for (var i = 0; i < 4; i++) {
				triangulationString += ":" + quadran[1][i][1];
			}
	...
	{
		triangulationString += "<br>" + myLangArray[8][2] + myLangArray[8][6] + myLangArray[8][5] + "<br>";	
		for ( var i = 0 ; i < 2 ; i++ ) {
			for ( var j = 0 ; j < 4 ; j++ ) {
				triangulationString += ":" + quadran[0][j][i];
			}
			triangulationString += ":<br>";
		}		
	}
	parent.document.getElementById("eu2bTriangulationList").innerHTML = "<div id='TriangulationList' style='position:absolute;top:0;left:0'>" + triangulationString + "</div>";	
}
...
function calculateDistance(sourceOs, destOs) {
	bLog("calcul de la distancd du système " + sourceOs + " et du système " + destOs);
	if (sourceOs == "9999" || destOs == "9999" || sourceOs == "0" || destOs == "0") return(999);
	return Math.round(100 * (Math.sqrt(Math.pow (((Number(sourceOs) / 100) - (Number(destOs) / 100)),2) + Math.pow ((( Number(sourceOs) % 100) - ( Number(destOs) % 100)),2)))) / 100;
}
...
//
//	create frame for triangulation tool add'on
//
	...
	tDiv2 = document.createElement("div");
	tDiv2.setAttribute("id","eu2bTriangAccuracy");
	tDiv2.setAttribute("style", "position: absolute;top:40px;left:200px;background:black;font-size:10px");
	tDiv2.appendChild ( document.createTextNode(myLangArray[8][8]) );
	eu2bTriangulationDiv.appendChild ( tDiv2 );	
	
	tDiv2 = document.createElement("select");
	tDiv2.setAttribute("id","eu2bTriangulationAccuracy");
	tDiv2.setAttribute("type","text");
	tDiv2.setAttribute("style", "position:absolute;top:60px;left:200px;font-size:10px;color:black;background:white;cursor:text" );	
	addOption ("0,1 pc","0.1",tDiv2,0);
	addOption ("0,3 pc","0.3",tDiv2,0);
	addOption ("0,5 pc","0.5",tDiv2,0);
	eu2bTriangulationDiv.appendChild ( tDiv2 );
	...
	tDiv2.setAttribute("onMouseDown", "this.style.borderColor='#555555';this.style.backgroundColor='#007777';");
	tDiv2.setAttribute("onMouseUp", "this.style.borderColor='grey';this.style.backgroundColor='#000088';");	
	tDiv2.appendChild (document.createTextNode("Calc"));
	eu2bTriangulationDiv.appendChild (tDiv2);

	tDiv2 = document.createElement("div");
	tDiv2.setAttribute("id","eu2bTriangulationList");
	tDiv2.setAttribute("style", "position: absolute;top:120px;left:2px;height:475;width:270;background:black;font-size:10px;overflow:auto");
	tDiv2.innerHTML = myLangArray[8][7];	
	eu2bTriangulationDiv.appendChild ( tDiv2 );
	tDiv.appendChild(eu2bTriangulationDiv);	
	
//
//	end triangulation tool add'on frame creation
//	
	...
	eu2bOptionsDiv.innerHTML += tString + "</tbody></table>";
	...
	eu2bChatButtonDiv.setAttribute("style", "position: absolute; background:#000088; top: -1px; left: 28px;width:25; border-style:solid;border-width:1px;border-color:grey;z-index:auto;color:white;font-size:10px;text-align:center;padding-top:0px;padding-bottom:0px;padding-left:2px;padding-right:3px;cursor:pointer");
	...
	eu2bSearchButtonDiv.setAttribute("style", "position: absolute; background:#000088; top: 17px; left: 28px; border-style:solid;border-width:1px;border-color:grey;z-index:auto;color:white;font-size:10px;text-align:center;padding-top:0px;padding-bottom:0px;padding-left:2px;padding-right:3px;cursor:pointer");
	...
	eu2bBattleButtonDiv.setAttribute("class","eu2bMBs");
	eu2bBattleButtonDiv.setAttribute("style", "position: absolute; background:#000088; top: 17px; left: 70px; border-style:solid;border-width:1px;border-color:grey;z-index:auto;color:white;font-size:10px;text-align:center;padding-top:0px;padding-bottom:0px;padding-left:2px;padding-right:3px;cursor:pointer");
	...
	eu2bButtonsDiv.appendChild(eu2bBattleButtonDiv);
	...
	eu2bOptionsButtonDiv.setAttribute("style", "position: absolute; background:#000088; top: 17px; left: 117px; border-style:solid;border-width:1px;border-color:grey;z-index:auto;color:white;font-size:10px;text-align:center;padding-top:0px;padding-bottom:0px;padding-left:2px;padding-right:3px;cursor:pointer");
	...
	eu2bWormRouteButtonDiv.setAttribute("style", "position: absolute; background:#000088; top: 17px; left: 165px; border-style:solid;border-width:1px;border-color:grey;z-index:auto;color:white;font-size:10px;text-align:center;padding-top:0px;padding-bottom:0px;padding-left:2px;padding-right:3px;cursor:pointer");
...
/*
	eu2bWormTravelButtonDiv.setAttribute("onMouseOver", "this.style.borderColor='#cccccc';this.oldColor = this.style.backgroundColor;");
	eu2bWormTravelButtonDiv.setAttribute("onMouseOut", "this.style.borderColor='grey'; if (typeof(this.oldColor) != 'undefined') this.style.backgroundColor=this.oldColor;else this.style.backgroundColor='#000000';");
	eu2bWormTravelButtonDiv.setAttribute("onMouseDown", "this.style.borderColor='#555555'; this.style.backgroundColor='rgb(0, 119, 119)';");
	eu2bWormTravelButtonDiv.setAttribute("onMouseUp", "this.style.borderColor='grey';if (this.style.backgroundColor=='rgb(0, 119, 119)') { if ( this.parentNode ) {var tKids = this.parentNode.getElementsByClassName('eu2bMBs');for(var k = 0 ; k < tKids.length ; ++k) {tKids[k].style.backgroundColor='#000088';}}this.style.backgroundColor='#007700';this.oldColor = '#007700';} else { this.style.backgroundColor=this.oldColor;}");
...
//	
	...
	eu2bTriangulationButtonDiv.setAttribute("style", "position: absolute; background:#000088; top: 17px; left: 205px; border-style:solid;border-width:1px;border-color:grey;z-index:auto;color:white;font-size:10px;text-align:center;padding-top:0px;padding-bottom:0px;padding-left:2px;padding-right:3px;cursor:pointer");
...
//
//	end Triangulation button creation
//		
...
function doQuickCollect(evt) {
	...
	httpRequest.onreadystatechange = function() {
		if (httpRequest.readyState == 4 && httpRequest.status == 200) { // ok
			...
			bLog("Quick fleet_collect>type>" + orbType + "<");
			if ( orbType != "" ) {
				var i;
				var res = 0;
				var resType;
				...
				bLog("\nres>" + res + "<\ntotal>" + total + "<\nfactor>" + factor + "<\ncargo>" + cargo + "<");
				bLog ( "quick collect = " + unsafeWindow.parent.parent.quickCollect + ", cargo time = " + totalc + ", deplete time = " + total);
				var tTime, tOption;
...
//		delete myP.myOrbs[index];
		myP.myOrbs[index] = null;
//		delete myP.myTotals[index];
...
function unRegisterEvents() {
	...
	if ( myP.location.href.indexOf("/index.php") > -1 ) {
		...
		saveData(-1, myP.myTotals, myP.myOrbs);
	}
...
//
//	search Triangulation add'on button	
//
...
//
	...
	for ( var g in mOrbs ) {
		...
		if ( tDiv != null ) tDiv.removeEventListener("click", flipTrack, false);
...
function registerEvents () {
	...
	for ( var g in mOrbs ) {
		...
		if ( tDiv != null ) tDiv.addEventListener("click", doButtonUp, false);
		tDiv = myP.document.getElementById("eu2bTrack"+g+"CB");
		if ( tDiv != null ) tDiv.addEventListener("click", flipTrack, false);
		tDiv = myP.document.getElementById("eu2bNew"+g+"Delete");
		if ( tDiv != null ) tDiv.addEventListener("click", doButtonUp, false);
		tDiv = myP.document.getElementById("eu2bSaveNew"+g);
		if ( tDiv != null ) tDiv.addEventListener("click", doButtonUp, false);
...
function drawBattleReport ( tDestination, tShipList, groupByShipName, tIgnore, tIgnoreTextCB, tIgnoreText ) {
	...
	tReport.setAttribute("class","font_white");
	tReport.setAttribute("id", "eu2bBattleReport");
	tReport.setAttribute("style", "overflow:auto;z-index:99999;");
	var tBattleData = new Object();
	var i,c;
	for ( var k in tShipList ) {
		//bLog(k+">ship>" + tShipList[k]['caption'] + "<>" + tShipList[k]['ship_id'] + "<>" + tShipList[k]['AttacksOut'] );
		...
		if ( typeof(tBattleData[FFindex1][tShipName]) == "undefined" ) {
			...
			for ( i in tShipList[k] ) {
				if ( i != "ship_id" && i != "experience" && i != "font_color" && i != "caption" ) {
					...
					//if ( FFindex1 == "Friendly" ){ tStr += ("i ->" + i + "< "); }
				}
			}
			//bLog("new> tShipName = " + tShipName + ", tStr = " + tStr + "\n caption = " + tShipList[k]['caption']);
		} else {
			for ( i in tShipList[k] ) {
				if ( i != "ship_id" && i != "experience" && i != "font_color" && i != "caption" ) {
					tBattleData[FFindex1][tShipName][i] += parseInt(tShipList[k][i]);
	...
	if ( tDestination.firstChild ) {
		bLog("found firstChild, inserting before");
		tDestination.insertBefore(tReport, tDestination.firstChild);
	} else {
		bLog("No children.. appending.");
		tDestination.appendChild(tReport);
	}
...
function doToggleBACB (evt) {
	...
	bLog("doToggleBACB name = " + tBR.id );
	if ( tBR.firstChild.id == "eu2bBattleReport" ) {
		...
		bLog("doToggleBACB parent =>" + unsafeWindow.parent + "< doToggleBACB myParent =>" + myP.location + "<");
...
function activateBATab(evt) {
	...
	bLog("tab = " + activeTabDiv.id + ", tab id = " + activeTabID + ", bar = " + tTabBar.id + ", battle = " + tBattleWindow.id);
...
function getBattleData(activeBAID) {
	...
	//bLog("content = " + document.getElementsByTagName("head")[0].innerHTML);
...
if ( parent.location.href.indexOf("/index.php") == -1 && myLocation.indexOf('fleet_overview') == -1) {
	...
	//	bLog("content = " + document.body.innerHTML);
		if ( tDiv != null ) {
			...
			if ( tDiv2.length > 31 ) {
				...
				var theXP = parseInt(tDiv2[24].innerHTML);//.replace(/\./g,""));
				bLog("theXP = " + theXP);
				if ( isNaN(theXP) ) {
					theXP = parseInt(tDiv2[28].innerHTML.replace(/\./g,""));
					var theNextXP = parseInt(tDiv2[30].innerHTML.replace(/\./g,""));
				} else {
					theXP = parseInt(tDiv2[26].innerHTML.replace(/\./g,""));
					var theNextXP = parseInt(tDiv2[28].innerHTML.replace(/\./g,""));
				}
				bLog("theNextXP = " + theNextXP);
		...
		if ( typeof(tFonts[14]) != "undefined" && isNaN(parseInt(tFonts[14].innerHTML)) ) {
			//bLog("Quick Collect>" + tFonts[24].innerHTML + "<\n>"+ tFonts[23].innerHTML+"<" );
			...
			bLog("Quick Collect> cargo> " + tDiv + "/" + tDiv2 ); // the current/max cargo load
			if ( tDiv < tDiv2 ) {
		...
		//tDiv = myP.document.getElementById("eu2bPlanetTitleFleetEdit");
	...
	//		myP.document.body.appendChild(tDiv);
			parent.document.body.appendChild(tDiv);
		}

		//bLog("body = " + document.body.innerHTML);
		...
		if ( orbType != "" ) {
			...
			bLog ( "quick collect = " + myP.quickCollect + ", cargo time = " + totalc + ", deplete time = " + total);
			var tTime, tOption;
			if ( totalc < total ) tTime = totalc;
			else tTime = total;
			if ( tTime > 45 ) {
		...
		if ( tDiv[i].width == 30 ) {
			...
			if ( (tDiv2.indexOf("wreckage") != -1) || (tDiv2.indexOf("asteroid") != -1)){
				if ( i > 1 && tDiv[i-2].innerHTML.indexOf('id="fleet_') == -1 && tDiv[i-2].innerHTML.indexOf(myLangArray[0][7]) == -1 ) {
					...
					bLog("setting sUrl = " + sUrl + ", " + tDiv2.getAttribute("sCoords"));
