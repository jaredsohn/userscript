...
new Array(
'القوات بحجم كبير',
'http://ae5.tribalwars.ae/graphic/unit_big/spear.png?1',
'http://ae5.tribalwars.ae/graphic/unit_big/sword.png?1',
'http://ae5.tribalwars.ae/graphic/unit_big/axe.png?1',
'http://ae5.tribalwars.ae/graphic/unit_big/archer.png?1',
'http://ae5.tribalwars.ae/graphic/unit_big/spy.png?1',
'http://ae5.tribalwars.ae/graphic/unit_big/light.png?1',
'http://ae5.tribalwars.ae/graphic/unit_big/marcher.png?1',
'http://ae5.tribalwars.ae/graphic/unit_big/heavy.png?1',
'http://ae5.tribalwars.ae/graphic/unit_big/ram.png?1',
'http://ae5.tribalwars.ae/graphic/unit_big/catapult.png?1',
'http://ae5.tribalwars.ae/graphic/unit_big/knight.png?1',
'http://ae5.tribalwars.ae/graphic/unit_big/snob.png?1'
),
...
new Array(
'المباني بحجم كبير',
'http://ae3.tribalwars.ae/graphic/big_buildings/main3.png?1',
'http://ae3.tribalwars.ae/graphic/big_buildings/barracks3.png?1',
'http://ae3.tribalwars.ae/graphic/big_buildings/stable3.png?1',
'http://ae3.tribalwars.ae/graphic/big_buildings/garage3.png?1',
'http://ae3.tribalwars.ae/graphic/big_buildings/snob1.png?1',
'http://ae3.tribalwars.ae/graphic/big_buildings/smith3.png?1',
'http://ae3.tribalwars.ae/graphic/big_buildings/place1.png?1',
'http://ae3.tribalwars.ae/graphic/big_buildings/statue1.png?1',
'http://ae3.tribalwars.ae/graphic/big_buildings/market3.png?1',
'http://ae3.tribalwars.ae/graphic/big_buildings/wood3.png?1',
'http://ae3.tribalwars.ae/graphic/big_buildings/stone3.png?1',
'http://ae3.tribalwars.ae/graphic/big_buildings/iron3.png?1',
'http://ae3.tribalwars.ae/graphic/big_buildings/farm3.png?1',
'http://ae3.tribalwars.ae/graphic/big_buildings/storage3.png?1',
'http://ae3.tribalwars.ae/graphic/big_buildings/hide1.png?1',
'http://ae3.tribalwars.ae/graphic/big_buildings/wall3.png?1'
),

new Array(
'المباني بحجم صغير',
'http://ae5.tribalwars.ae/graphic/buildings/main.png?1',
'http://ae5.tribalwars.ae/graphic/buildings/barracks.png?1',
'http://ae5.tribalwars.ae/graphic/buildings/stable.png?1',
'http://ae5.tribalwars.ae/graphic/buildings/garage.png?1',
'http://ae5.tribalwars.ae/graphic/buildings/snob.png?1',
'http://ae5.tribalwars.ae/graphic/buildings/smith.png?1',
'http://ae5.tribalwars.ae/graphic/buildings/place.png?1',
'http://ae5.tribalwars.ae/graphic/buildings/statue.png?1',
'http://ae5.tribalwars.ae/graphic/buildings/market.png?1',
'http://ae5.tribalwars.ae/graphic/buildings/wood.png?1',
'http://ae5.tribalwars.ae/graphic/buildings/stone.png?1',
'http://ae5.tribalwars.ae/graphic/buildings/iron.png?1',
'http://ae5.tribalwars.ae/graphic/buildings/farm.png?1',
'http://ae5.tribalwars.ae/graphic/buildings/storage.png?1',
'http://ae5.tribalwars.ae/graphic/buildings/hide.png?1',
'http://ae5.tribalwars.ae/graphic/buildings/wall.png?1'
),

new Array(
'القرى',
'http://www.alamuae.com/up/uplong/a26415193301864.bmp',
'http://www.alamuae.com/up/uplong/b264152259216138.bmp',
'http://www.alamuae.com/up/uplong/c264153368666572.bmp',
'http://www.alamuae.com/up/uplong/d264154540202433.bmp',
'http://www.alamuae.com/up/uplong/e264155956572710.bmp',
'http://www.alamuae.com/up/uplong/f26415664141847.bmp',
'http://www.alamuae.com/up/uplong/g2641581093678516.bmp',
'http://www.alamuae.com/up/uplong/h264160727530520.bmp',
'http://www.alamuae.com/up/uplong/i264161638469976.bmp'
),

new Array(
'مصادر و موارد',
'http://ae5.tribalwars.ae/graphic/eisen.png?1',
'http://ae5.tribalwars.ae/graphic/lehm.png?1',
'http://ae5.tribalwars.ae/graphic/holz.png?1',
...
'http://www.alamuae.com/up/uplong/ggg264150230215005.bmp',
...
'http://www.alamuae.com/up/uplong/87264112781489875.bmp',
...
var icon_smilies = 'http://www.lakii.com/vb/smile/2_17.gif';
...
if(document.getElementById('message') || document.getElementById('intern') || document.getElementById('desc_text'))
  ...
  a.setAttribute('style','font-weight:bold; font-size:9pt; color:#4b0000; font-Arial:Broadway,Verdana,Arial; ');
  a.appendChild(document.createTextNode(' \n إضافات اخوكم majin vegeta من أجل المافيا والجميع\n  (ver'+ver+')'));
  ...
  if(forum || memo || ally || mail)
    {
    mainDiv.addButton('رابط تقرير',icon_report_link,function() {
  ...
  if(forum || memo || ally || mail)
    {
    mainDiv.addButton(' تظهر التقارير مباشرة(على شكل صورة)',icon_report_direct,function() {
      var url = prompt('أدخل عنوان لهذا التقرير :','');
      if(url != '')
        {
        if(url.indexOf('=') != -1)
  ...
  if(forum || memo || mail || ally)
    {
    mainDiv.addButton('تحويل الإحداثيات BB-Codes "قم بتظليل كل النص الموجود ثم اضغط هنا وسوف يقوم بتحويل الإحدثيات إلى روابط"',icon_convertCoords,function() {
  ...
  if(gm && (forum || memo || mail || ally))
    {
    mainDiv.addButton('أداة مفيدة جداً لمن يقوم باستخدام بعض النصوص بكترة فقط قم بكتابتها مرة واحدة فقط و قم بحفضها هنا مثل المقدمات الطويلة و الردود المعتادة اترك لك التجربة ',icon_usertexts,function() {
      // User Texts' Box
...
if(typeof(text[attr]) != 'function')
{
  ...
  function workWithEntry(texts,n)
    ...
    var td = document.createElement('td');
    td.setAttribute('class','tdbutton');
    td.appendChild(document.createTextNode('حفظ'));
    td.addEventListener('click',function() {
      var data = {
    ...
    var td = document.createElement('td');
    td.setAttribute('class','tdbutton');
    td.appendChild(document.createTextNode('إلغاء'));
    td.addEventListener('click',function() {
      this.parentNode.parentNode.parentNode.removeChild(this.parentNode.parentNode);
      return false;
    },false);
