// ==UserScript==
// @name           FPVB4 Optomistic = Shitpost
// @namespace      lol
// @include        http://fpvb4.compwhizii.net/*
// ==/UserScript==
var betteroptomistic = new Object();
betteroptomistic.src = 

"http://i132.photobucket.com/albums/q19/vertex_photos/shitpost.png"; 


var imageList = new Object();
imageList["http://fpvb4.compwhizii.net/fp/ratings/rainbow.png"] = 

{remove: false, fg: "#000", newimage:betteroptomistic.src};
...
(function() {
	...
	var ReplacementText = "Shit Post";
	
	//edit the words here
	//sorted alpha backwords to catch bad word groupings
	var badwords=['Optimistic'];
