...
// @translator     Enfo
// ==/UserScript==
var labor_points_text={en:'Labor points',ru:'Очки труда',cz:'PracovnГ­ body',sk:'PracovnГ© body',pl:'Punkty Pracy', hu:'Munkapont', se:'ArbetspoГ¤ng', de:'Arbeits Punkte', nl:'Arbeidspunten'};
var difficulty_text ={en:'Difficulty',ru:'Сложность',cz:'ObtГ­Еѕnost',sk:'ObtiaЕѕnosЕҐ',pl:'TrudnoЕ›Д‡', hu:'NehГ©zsГ©g', se:'SvГҐrighet', de:'Schwerigkeit', nl:'Moeilijkheid'};
