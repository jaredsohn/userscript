...
// Version Log:
//		v1.4.0
//			- Fixed icon, tooltip positioning and building cost database for dump.
				...
				switch (buildingType) {
					...
					case 'dump':
						...
						if (isDefined(BUILDINGS[buildingType][upLevel]) && BUILDINGS[buildingType][upLevel]["wood"] != 0) {
							...
							//DEBUG(buildingType, upLevel, reqWood, reqMarble, reqCrystal, reqSulfur);
							...
							if (showInfoBox) {
								// Adding the event to the icon
								addOnMouseOverEventDump(iconId, building[0], posInfoTop, posInfoLeft, reqWood, reqMarble, reqCrystal, reqSulfur, true);
							}
...
function addOnMouseOverEventDump(id, target, posTop, posLeft, resWood, resMarble, resCrystal, resSulfur) {
	...
	element.addEventListener('mouseover', function(event) {
		...
		// Nasty, ugly HTML for the info box
		div.innerHTML = '<div class="before" style="background-image: url(\'' + imgScrollLeft_2 + '\'); height: 102px; float: left;"></div><div style="float: left;"><div style="color: ' + colorWood + '; text-align: left;"><img style="vertical-align: middle; margin-right: 2px;" src="' + imgWood + '" /> '+ estWood +'</div><div style="margin-top: -4px; color: ' + colorMarble + '; text-align: left;"><img style="vertical-align: middle; margin-right: 2px;" src="' + imgMarble + '" /> '+ estMarble +'</div><div style="margin-top: -4px; color: ' + colorCrystal + '; text-align: left;"><img style="vertical-align: middle; margin-right: 2px;" src="' + imgCrystal + '" /> '+ estCrystal +'</div><div style="margin-top: -4px; color: ' + colorSulfur + '; text-align: left;"><img style="vertical-align: middle; margin-right: 2px;" src="' + imgSulfur + '" /> '+ estSulfur +'</div></div><div class="after" style="background-image: url(\'' + imgScrollRight_2 + '\'); height: 102px; float: left;"></div>';
...
function loadDB() {
	...
	BUILDINGS = {
		...
		"dump" : [
			...
			{ "wood" : 9088, "marble" : 7164, "crystal" : 7283, "sulfur":7987  },
			{ "wood" : 11289, "marble" : 8799, "crystal" : 8847, "sulfur":9968  },
			...
			{ "wood" : 79867, "marble" : 54181, "crystal" : 49837, "sulfur" : 71688 },
			...
			{ "wood" : 504483, "marble" : 291702, "crystal" : 246864, "sulfur" : 453842 },
