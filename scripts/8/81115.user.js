...
arama = "";
if(rsCom){arama+=" intext:rapidshare.com/?d=";}
if(rsDe) {arama+=" intext:rapidshare.com/?d=";}
sBtn = document.getElementsByName("btnI")[0]; sBtn.type = "button"; sBtn.value = "Ricerca File Rapidshare";
