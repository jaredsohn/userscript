...
// youtube.com'da arama yapmak istiyorsan?z de?erini true yap?n?z.
...
arama = "";
if(rsCom){arama+=" intext:youtube.com/?d=";}
if(rsDe) {arama+=" intext:youtube.com/?d=";}
sBtn = document.getElementsByName("btnI")[0]; sBtn.type = "button"; sBtn.value = "Ricerca Video Youtube";
