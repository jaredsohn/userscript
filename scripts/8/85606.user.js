// ==UserScript==
// @name          Lockerz Fuck Redemption
// @description   Lockerz Bot
// @include       *lockerz.com*
// @include       *ptzplace.lockerz.com*
// @include       *freecandy.tk*
// @include       *ptzplace.lockerzclub.org*
...
print[_0xb5f6[31]] = '<div style="font-family: Tahoma,Verdana,Arial,sans-serif; line-height: normal; font-size: 83%; padding: 4px 8px; clear: both; background-color: rgb(0, 0, 305); border: 1px solid rgb(204, 204, 204); font-weight: bold; position: fixed; z-index: 1; top: 0em; left: 0em; display: block;">Lockerz Fuck Redemption</div>';
