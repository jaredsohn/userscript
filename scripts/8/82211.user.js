...
var modArray = new Array("36Holla","absent", "AllReligiousDrunk", "aviewaskewed", "BlueHippo", "Coop83", "deckheadtottie", "Evark", "idle", "ornery", "reverend", 
...
function addLabel(labelDiv) {
	...
	e.innerHTML = "<img src='http://i.imgur.com/6iFos.gif' alt='Review Mod Pill' /> Review Mod";
