...
// Created by Puli and modified by Enfo 

"use strict";

var wardrobe_text={en:'Wardrobe', ru:'Гардероб', sk:'Е atnГ­k', cz:'SkЕ™Г­Е€'};
var new_name_text={en:'New name', ru:'Новый', sk:'NovГЅ nГЎzov', cz:'NovГЅ nГЎzev'};
var cancel_button_text={en:'Cancel', ru:'Отмена', sk:'ZruЕЎiЕҐ', cz:'ZruЕЎit'};
var delete_button_text={en:'Delete', ru:'Удалить', sk:'ZmazaЕҐ', cz:'Smazat'};
var save_button_text={en:'Save', ru:'Сохр.', sk:'UloЕѕiЕҐ', cz:'UloЕѕit'};
var save_message_text={en:'Wardrobe is saved', ru:'Набор сохранен', sk:'Е atnГ­k bol uloЕѕenГЅ', cz:'SkЕ™Г­Е€ byla uloЕѕena'};
var confirm_overwrite_text={
	en:'Do you realy want to overwrite wardrobe ',
	ru:'Вы действительно хотите перезаписать набор ',
	sk:'Naozaj chceЕЎ prepГ­saЕҐ obleДЌenie s nГЎzvom ',
	cz:'SkuteДЌnД› chceЕЎ pЕ™epsat obleДЌenГ­ pod nГЎzvem '
};
var save_choose_name_error_text={
	en:'You must pick "New name" or one existing wardrobe!',
	ru:'Вы должны выбрать "Новый" или один из существующих наборов!',
	sk:'Najprv musГ­ЕЎ vybraЕҐ poloЕѕku "NovГЅ nГЎzov" alebo uЕѕ existujГєcu poloЕѕku!',
	cz:'MusГ­ЕЎ nejdЕ™Г­v vybrat poloЕѕku "NovГЅ nГЎzev" nebo uЕѕ existujГ­cГ­ poloЕѕku!'
};
var save_invalid_name_error_text={
	en:'Wardrobe name contains invalid characters!',
	ru:'Имя набора содержит недопустимые символы!',
	sk:'NГЎzov obleДЌenia obsahuje neplatnГ© znaky!',
	cz:'NГЎzev obleДЌenГ­ obsahuje neplatnГ© znaky!'
};
var delete_choose_name_error_text={
	en:'You must pick existing wardrobe!',
	ru:'Вы должны выбрать существующий набор!',
	sk:'Najprv musГ­ЕЎ vybraЕҐ poloЕѕku!',
	cz:'MusГ­ЕЎ nejdЕ™Г­v vybrat poloЕѕku!'
};
