...
var twpro_lang = {
	info: ['pato95', 'mailto:slarka.p@gmail.com', 1273227, '.10.'],
	WEBSITE: 'Webstránka',
	AUTHOR: 'Autor',
	TRANSLATOR: 'Prekladač',
	TWPRO_DISABLED: 'Skript vypnutý',
	SORTBYNAME: 'Zoradiť podľa <b>name</b>',
	SORTBYXP: 'Zoradiť podľa <b>experience</b>',
	SORTBYWAGES: 'Zoradiť podľa <b>wages</b>',
	SORTBYLUCK: 'Zoradiť podľa <b>luck</b>',
	SORTBYCOMB: 'Zoradiť podľa <b>job rank</b>',
	SORTBYDANGER: 'Zoradiť podľa <b>danger</b>',
	SORTBYLABORP: 'Zoradiť podľa <b>labor points</b>',
	FILTERJOBS: 'Skryť práce, ktoré nemôžem robiť',
	FILTERCLOTHING: 'Len ukázať najlepšie oblečenie pre zvolenú prácu',
	CHOOSEJOB: 'Vybrať prácu...',
	CALCJOB: 'Počítam hodnoty, prosím počkaj...',
	INVENTSTATS: 'Štatistiky inventára',
	SELLVALUE: 'Predajná cena',
	EQUIPMENT: 'Aktuálne nosené oblečenie',
	BAG: 'Batoh',
	OBJECTS: 'Predmety',
	PRODUCTS: 'Produkty',
	TOTAL: 'Celkom',
	...
	HPTOTAL: 'Celkový počet bodov zdravia',
	STARTCALC: 'Vypočítať dáta...',
	CONVERT: 'Prepočítať',
	MULTISEL: 'Predať viacero vecí...',
	SELL: 'Predať vybrané',
	CONFIRMSELL: 'Naozaj chceš predať %1 vecí?',
	SELLING: 'Predávam...',
	SALEDONE: 'Vybrané predmety boli predané.',
	NONESELECTED: 'Musíš vybrať aspoň jeden predmet!',
	JOBRANKSETTINGS: 'Nastavenie hodnotenia prác',
	SEARCHINVENTORY: 'Hľadať v inventári',
	NOSEARCHRESULT: 'Hľadáš %1 žiadne výsledky nenájdené.%2Zobraziť všetky veci%3',
	SEARCHHELP: 'Prehľadať inventár. Môžeš použiť skratky: * pre 0 alebo viac vecí, ? pre 1 vec. ',
	APPLY: 'Použiť',
	HEALTH: 'Maximálny počet bodov zdravia',
	DUELSHOOTINGATT: 'Duelant na diaľku (útok)',
	DUELSHOOTINGDEF: 'Duelant na diaľku (obrana)',
	DUELVIGOR: 'Ručný duelant',
	FORTATTACK: 'Boj o pevnosť (útok)',
	FORTDEFEND: 'Boj o pevnosť (obrana)',
	SKILLRIDE: 'Jazda na koni'
};
var twpro_langs = {};
twpro_lang.sk = {
	info: ['pato95', 'mailto:slarka.p@gmail.com', 1273227, '.10.'],
...
*/
	...
	function twpro_insertList(twpro_data) {
		...
		twpro_xhtml = '<div style="left:20px;position:absolute;margin-top:560px;">'+TWPro.lang.JOBRANKSETTINGS+': ';
		...
		twpro_xhtml += '<div style="position:absolute;margin-top:560px;left:520px"><label style="position:absolute;top:4px;left:21px;font-style:italic;color:#636;cursor:pointer" for="twpro_searchinventory">'+TWPro.lang.SEARCHINVENTORY+'</label><input type="text" style="width:150px;background:#fff url(http://www.tribetool.nl/thewest/search.png) no-repeat scroll 0 0;padding:0 2px 0 19px" id="twpro_searchinventory" onfocus="previousSibling.style.display=\'none\'" onblur="if(this.value==\'\')previousSibling.style.display=\'block\'" onkeyup="TWPro.twpro_searchInventory(event.keyCode==13)" /><span id="twpro_search_help" style="font-weight:bold;color:#191970;cursor:help;background:#D4C7B0;width:20px;height:17px">?</span></div>';
		twpro_xhtml += ' <input id="twpro_clothingfilter" type="checkbox"' + (TWPro.twpro_preference('dispJobClothingOnly')?' checked="checked"':'') + '  onclick="TWPro.twpro_preference(\'dispJobClothingOnly\',this.checked);TWPro.twpro_bagVis()" style="position:absolute;margin-top:563px;left:495px" />';
