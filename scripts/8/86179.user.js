...
// @author         1st release author norm
// @Traducao       by Artolas
...
if(location.href.match(/action=view/)) { 
  ...
  var BerichtTitel = "[b][player]"+townOwner[0]+"[/player] da cidade [town]"+townName[0]+"[/town]  atacando  [player]"+townOwner[1]+"[/player] da cidade [town]"+townName[1]+"[/town][/b]";
  for(var c = 0; c < document.getElementsByTagName('div').length; c++) {
