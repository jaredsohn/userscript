// ==UserScript==
// @name           favotter_to_favstar
// @version        1.1.0
// @namespace      http://d.hatena.ne.jp/phithon/
// @description    Link each posts on Favotter to Favstar. / ふぁぼったー上の各ポストをFavstarへリンクします。
