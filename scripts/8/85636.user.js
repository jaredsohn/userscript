// ==UserScript==
// @name          facebook.com - simplified wall FIXER
// @version       1.8.1g
// @require       http://sizzlemctwizzle.com/updater.php?id=85636
// @description   Simplified (or hide) extra messages as pages, groups, new friendships and so on.
// @namespace     http://www.krakenstein.cz.cc
// @original      Kub4jz.cz <kub4jz@gmail.com> @ http://userscripts.org/scripts/show/71542
...
function createBox()
{
  ...
  boxTitle.innerHTML += '<div><h4 class="uiHeaderTitle">Simplified wall <small>v'+script_version+'<small></h4></div>';
