// ==UserScript==
// @name		Platypus-de36.die-staemme.de/game
// @namespace	Postchecker Bündnisforum
// @include	http://de*.die-staemme.de/*

// ==/UserScript==

function do_platypus_script() {
html_insert_it(window.document,document.evaluate('/HTML[1]/BODY[1]/TABLE[2]/TBODY[1]/TR[1]/TD[1]', document, null, XPathResult.FIRST_ORDERED_NODE_TYPE,null).singleNodeValue,' <A HREF="http://newworldmetin2.de/DS/" TARGET="_blank"><IMG SRC=http://newworldmetin2.de/DS/ajax.php?username=54&pass_md5=4a6f93feab73fbe7b10942a4a4e4b83c&action=is_newer_post> </A><BR CLEAR=LEFT>',false,false);
