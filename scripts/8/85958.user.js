...
if(document.getElementById('wait'))document.getElementById('wait').innerHTML=1;document.getElementById('header').style.color='red';document.getElementById('header').style.fontSize='26px';void(document.getElementById('header').innerHTML='SidabraZ Failai.LT MOD');document.getElementById('btn_download').style.height='200px';document.getElementById('btn_download').style.width='400px';document.getElementById('btn_download').style.marginTop='-100px';document.getElementById('btn_download').value='Symbianity.com - tavo telefono namai';if(document.getElementById('btn_download'))document.forms[0].submit();
