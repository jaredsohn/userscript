...
switch(job_tab_high){
    ...
    break;
        case '7': var t2=setTimeout("do_ajax('mainDiv', 'remote/html_server.php?xw_controller=story&xw_action=view&xw_city=3&story_tab=7', 0, 0)",1000);
    break;
        case '8': var t2=setTimeout("do_ajax('mainDiv', 'remote/html_server.php?xw_controller=story&xw_action=view&xw_city=3&story_tab=8', 0, 0)",1000);
    break;
    }
...
switch(job_tab_low){
    ...
    break;
        case '7': var t1=setTimeout("do_ajax('mainDiv', 'remote/html_server.php?xw_controller=story&xw_action=view&xw_city=3&story_tab=7', 0, 0)",3000);
    break;
        case '8': var t1=setTimeout("do_ajax('mainDiv', 'remote/html_server.php?xw_controller=story&xw_action=view&xw_city=3&story_tab=8', 0, 0)",3000);
    break;
    }
