...
newposts = oldposts + '<table><tbody><tr><td class="doubledash" nowrap="nowrap">&gt;&gt;</td><td class="reply"><span class="replytitle">'+titles[i]+'</span> <span class="commentpostername">' + posters[i] + '</span> '+times[i]+' <span id="norep254641373"><a href="newreply.php?do=newreply&amp;p='+ids[i]+'" class="quotejs">No.</a><a href="newreply.php?do=newreply&amp;p='+ids[i]+'" class="quotejs">'+ids[i]+'</a></span><blockquote>'+ messages[i] +'</blockquote></td></tr></tbody></table>';
