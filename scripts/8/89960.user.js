...
// XXX:Removed		if (document.getElementsByClassName('profileRight')[0].getElementsByTagName('b')[0].innerHTML != resanc)
//		{
//			alert("wrong profile!");
...
if (page == "bounty")
{
	...
	if (target == "Malachi")
	{
		alert("Don't bite the hand that feeds you.\nI don't care how mad you are at me, weigh whatever it is you think I did against\nhow useful this script is to you. And then ally me instead: \n2T9AWB");
	}
	else if (autosancNum > 0)
	{
