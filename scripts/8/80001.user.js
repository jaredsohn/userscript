...
// @description    Şehrinizdeki bina seviyelerini ve kaynak yeterli ise yükseltme yapabileceginizi gösteren işaret (ikariam.forumm.biz)
// @include        http://*.ikariam.*/*
// @exclude        http://board.ikariam.*/*
// @resource       build_available http://ikariamlibrary.com/tools/images/townenhancer/upgrade.png
// @resource       build_unknown   http://ikariamlibrary.com/tools/images/townenhancer/unknown.png
// @resource       build_max       http://opendia.net/library/ikariam/gm/ve/images/icon_max_green.png
// @resource       banner_left     http://ikariamlibrary.com/tools/images/townenhancer/scroll.png
// @resource       banner_right    http://ikariamlibrary.com/tools/images/townenhancer/scroll_rightend.png
...
var languages = {
	...
	cz: {
		...
		"settings-main-title": "Town Enhancer nastavení",
...
var data = {
	...
	"temple": [
		{w:216, g:173, t:"39m 36s"}, // Level 1
		{w:228, g:190, t:"43m 34s"}, // Level 2
		{w:333, g:290, t:"47m 55s"}, // Level 3
		{w:465, g:423, t:"52m 42s"}, // Level 4
		{w:598, g:567, t:"57m 59s"}, // Level 5
		{w:760, g:752, t:"1h 3m"}, // Level 6
		{w:958, g:989, t:"1h 10m"}, // Level 7
		{w:1197, g:1290, t:"1h 17m"}, // Level 8
		{w:1432, g:1610, t:"1h 24m"}, // Level 9
		{w:1773, g:2080, t:"1h 33m"}, // Level 10
		{w:2112, g:2586, t:"1h 42m"}, // Level 11
		{w:2512, g:3210, t:"1h 52m"}, // Level 12
		{w:3082, g:4109, t:"2h 4m"}, // Level 13
		{w:3655, g:5084, t:"2h 16m"}, // Level 14
		{w:4458, g:6471, t:"2h 30m"}, // Level 15
		{w:5126, g:7765, t:"2h 45m"}, // Level 16
		{w:6232, g:9850, t:"3h 1m"}, // Level 17
		{w:7167, g:11821, t:"3h 20m"}, // Level 18
		{w:8687, g:14952, t:"3h 40m"}, // Level 19
		{w:10247, g:18402, t:"4h 2m"}, // Level 20
		{w:11784, g:22082, t:"4h 26m"}, // Level 21
		{w:14228, g:27824, t:"4h 53m"}, // Level 22
		{w:16752, g:34183, t:"5h 22m"}, // Level 23
		{w:19265, g:41020, t:"5h 54m"}, // Level 24
		{w:23156, g:51514, t:"6h 30m"}, // Level 25
		{w:26663, g:61817, t:"7h 9m"}, // Level 26
		{w:32026, g:77477, t:"7h 51m"}, // Level 27
		{w:36830, g:92972, t:"8h 39m"}, // Level 28
	],
	"vineyard": [
...
if (view == "city") {
	...
	globalStyle(".tE_BannerLeft { display: block; visibility: hidden; position: absolute; top: 50px; text-align: center; line-height: 23px; height: 23px; background: transparent url("+GM_getResourceURL("banner_left")+") left; padding: 0 20px 0 20px; white-space: nowrap; font-size: 10px; color: #7e4a21; }");
	globalStyle(".tE_BannerRight { display: block; position: absolute; top: 0; right: 0; width: 12px; height: 23px; background-image: url("+GM_getResourceURL("banner_right")+"); }");
	globalStyle(".tE_Upgrade { display: block; position: absolute; top: 0; left: 0; width: 14px; padding: 0 2px; height: 23px; background: transparent url("+GM_getResourceURL("build_available")+") right no-repeat; }");
	globalStyle(".tE_Unknown { display: block; position: absolute; top: 0; left: 0; width: 14px; padding: 0 2px; height: 23px; background: transparent url("+GM_getResourceURL("build_unknown")+") right no-repeat; }");
// <Tezexlo Patch Part>
	globalStyle(".tE_Max { display: block; position: absolute; top: 0; left: 0; width: 14px; padding: 0 2px; height: 23px; background: transparent url("+GM_getResourceURL("build_max")+") right no-repeat; }");
// </Tezexlo Patch Part>
...
// </spy patch>
		...
		if (showUpgrade == true) {
			...
			else if (dataMax === true) {
				locationBanner.push({ nodeName: "span",	nodeAttributes: { "class": "tE_Max" }	});
			}
