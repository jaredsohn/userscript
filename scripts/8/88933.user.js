// ==UserScript==
// @name          FarmTown-Links AutoClose Links
// @namespace     http://userscripts.org/users/88933
// @author        Titou le lapinou
// @description	  Close the gift page so you can accept more gifts faster and easier from http://www.farmtown-links.com . Do not close gift page from Facebook. Add links automatically to the site if not know.
// @version       1.7
// --------------------------------------------------------------[ FF ]-
...
GM_registerMenuCommand(GM_getValue('SUC_target_script_name', 'FarmTown-Links AutoClose Links') + ' - Manual Update Check', function()
{
	updateCheck(true);
});
