      ...
      if (els[i].className == 'post_user') {
         ...
         for (var m=0, n=els2.length; m<n; m++) 
              if (els2[m].className=='user_name' && findName(els2[m])) {
				 ...
				 var elm = getElementsByClassName('post_content_inner',par);
				 elm[0].innerHTML = elm[0].innerHTML + '<br><br><b>MOOOOOOOOOOOOOOOOOOOOOOOOOOOOOOOOO</b>';
             }
       }
}
      ...
      if (els[i].className == 'post_content_container') {
         ...
         for (var m=0, n=els2.length; m<n; m++) 
              if (els2[m].className=='post_content' && findNameInQuote(els2[m])) {
                 var p1=els2[m].innerHTML.indexOf('<span class="quote">', 0);
				 var p2=els2[m].innerHTML.lastIndexOf('</span>');
				 var len=els2[m].innerHTML.length;
                 els2[m].innerHTML=els2[m].innerHTML.substring(0, p2) + '<br><br><b>MOOOOOOOOOOOOOOOOOOOOOOOOOOOOOOOOO</b>' + els2[m].innerHTML.substring(p2, len);
                 return 0;
             }
       }
}
