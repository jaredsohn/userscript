...
//
// ==UserScript==
// @name           FriendFeed Buddy List 1.50
// @namespace      http://userscripts.org/users/197192
// @description    Buddy list of online Friendfeeders [orginal script in : http://userscripts.org/scripts/show/32782] [edited by Peym4n(Pymnpe)] 
...
function parseEntries(entries,cached)
{
	...
	*/
	...
	html += '<td class="blHead" valign="middle" onclick="showANDHide()">Buddy List : ' + friends2.length + '&nbsp;</td>' ;
...
function ShowLoading(){
	...
	html = '';
	html += '<table class="showhide"  >';
	html += '<td class="blHead" valign="middle" onclick="showANDHide()">Buddy List : 0&nbsp;</td>' ;
	html += '<td class="blControl" valign="middle" align="right"><span id="ashowhide" onclick="showANDHide();">' + showHide + '</span>&nbsp;<span id="pSettings" onclick="PromtSettings();">Settings</span>&nbsp;<span id="leftright" onclick="BuddyListPos(this);">'+(leftRight=='right'?'&lt;':'&gt;')+'</span></td></table>';
