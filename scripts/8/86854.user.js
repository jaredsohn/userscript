// ==UserScript==
// @name           GLB Team Basic Tactics - printer-friendly
// @namespace      GLB
// @description    Creates a printer-friendly Team Basic Tactics Popup
// @version        1.0.0
// @author         ErDrRon
...
$(document).ready(function(){
	...
	function doPrint(){
		...
		var fullstring = '<font size =4><b>' + $('div[class*="big_head"]:first').text() + '</b></font><br>Team Tactics - Basic<br><font size =1>' + d + '</font><br><br>';
		...
		workingwindow=window.open('',"Team Tactics", "width=800,height=600,scrollbars=yes,resizable=yes,toolbar=yes,location=no,menubar=yes");
