/*//////////////////////////////////////////////////////////////////////////
// ==UserScript===
// @name            WLMessenger Hotmail msgplus compatible
...
// @description     Windows Live Messenger Web Extended - adaptação do v1.7 Beta
// @copyright       2007 - 2008 Jerone, 2010 Adaptado por Canton para Messenger no Hotmail
// @version         2.1 Beta
...
function teste(){
	var arrElem = [$('span[class=PersonalMessage_Text]'),$('span[dir=ltr]'), $('div[class=wlxim_msgwrap] span'), $('a[class=c_ic_name]'), $('span[class=c_ic_name]'), $('div[class=wlxim_infobar_message]')];
	for(var i=0; i<arrElem.length;i++){
		arrElem[i].each(function(){
		 if($(this)) {
			this.addEventListener('mousemove',teste,false);
			WLMW.init(this);
			}
		});
	}
...
(function() { 
teste();
$('div[id=wim]').addEventListener('mousemove',teste,false);
$('div[class=c_hl]').addEventListener('mousemove',teste,false);
$('li[class=c_mm_c c_mm_dn').addEventListener('mousemove',teste,false);
})();