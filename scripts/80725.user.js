// ==UserScript==
// @name           Angriffswarner Hamburg,Berlin und München  4.0 
// @namespace      pennertreff.de
...
if(on == 1){
var wasistlos = ' Deine Gegner ist online';
}else 
if(on == 2){
var wasistlos = ' Deine Gegner ist offline';
}else
if(on == 3){
var wasistlos = ' Deine Gegner wurde von Pennergame geloescht bitte breche den KAMPF SOFORT AB UM kEINE NACHTEILE DURCH DEN sYSTEMFEHLER ZU ERHALTEN';
}
var tbody = document.getElementsByClassName('zabsolute zleft')[0];
