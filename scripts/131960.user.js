// ==UserScript==
// @name           LoU Suite (PT)
// @description    Várias ajudas para Lord Of Ultima (LOU Suite 1.4.1 Português)
// @namespace      WildKatana
// @include        http://prodgame*.lordofultima.com/*/index.aspx*
// @version        1.4.1
// @require        http://sizzlemctwizzle.com/updater.php?id=131960&days=1
// ==/UserScript==
(function(){
  ...
  function createSuite() {
    ...
    qx.Class.define("louSuite.main", {
      ...
      members: {
        ...
        startScript: function() {
          ...
          btn.set({width: 20, appearance: "button-text-small", toolTipText: "Configurações LoU Suite"});
          btn.addListener("click", this.showOptionsPage, this);
          this.srvBar.add(btn, {top: 2, left: 365});
    ...
    qx.Class.define("lou_suite.gui.DungeonRaider", {
      ...
      construct: function() {
        ...
        this.setLabel("Planificador de mazmorras");
        this.setLayout(new qx.ui.layout.VBox(10));
        this.add(this._createToolBar());    
        this._tableModel = new qx.ui.table.model.Simple();
        var columnNames = [ "Id", "Info", "Tipo", "Nivel", "Pos", "Cidade", "Distancia", "Unidades", "Acção"];
        ...
        resizeBehavior.setWidth(3, 40);
        resizeBehavior.setWidth(4, 50);
        resizeBehavior.setWidth(5, 100);
        resizeBehavior.setWidth(6, 70);
        resizeBehavior.setWidth(7, 120);
        resizeBehavior.setWidth(8, 70);
        resizeBehavior.setMinWidth(8, 70);  
      ...
      members: {
        ...
        onTroopsSent: function (event, v) {
          ...
          switch (code) {
            ...
            case 4: // Not enough units
              message = "Não há unidades suficients. Tenta Scanar as cidades.";
              break;
            case 64: // No more command slots
              message = "Limite de comandos exedido na cidade, usa uma cidade diferente.";
              break;
            default:
              message= "Error desconhecido: " + code;
              break;
          }
        ...
        createCitiesContinentsSelectBox: function() {
          ...
          sb.setToolTipText("Filtro por: <b>continentes</b>");
        ...
        _createToolBar: function() {
          ...
          this.sbLevel.setToolTipText("Filtro por: <b>nivel mínimo</b>");
          ...
          for (var i = 1; i < 10; i++) {
            var item = new qx.ui.form.ListItem("Nivel " + i, null, i);
          ...
          var btnViewRegion = new qx.ui.form.Button("Ver região");
          ...
          var btnRecount = new qx.ui.form.Button("Recontagem de tropas");
          btnRecount.setWidth(140);
    ...
    qx.Class.define("lou_suite.gui.BossRaider", {
      ...
      construct: function() {
        ...
        bos.gui.SummaryPage.call(this);
        this.setLabel("Raids a Boss");
        this.setLayout(new qx.ui.layout.VBox(10));
        this.add(this._createToolBar());    
        this._tableModel = new qx.ui.table.model.Simple();
        var columnNames = [ "Id", "Info", "Tipo", "Nivel", "Pos", "Ciudade", "Distancia", "Unidades", "Acções"];
        ...
        onTroopsSent: function (event, v) {
          ...
          switch (code) {
            ...
            case 33554436: // Already ordered
              message = "O Boss já está a ser atacado.";
              break;
            case 33554432: // Already ordered from a different castle
              message = "O Boss já está a ser atacado.";
              break;
            case 16781312: // Dungeon is closed
              message = "A Masmorra está fechada.";
              break;
            case 4: // Not enough units
              message = "Não há unidades suficientes. Tenta Fazer scan ás cidaes.";
              removeBoss = false;
              break;
            case 64: // No more command slots
              message = "Slots da Cidade excedidos, Tenta outra cidade.";
              removeBoss = false;
              break;
            default:
