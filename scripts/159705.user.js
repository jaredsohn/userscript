// ==UserScript==
// @name        Mass Facebook Friends Deleter Plus
...
function replace_msg(x) {
	$('div.dialog_body').html('Hooray! ' + x + ' friends deleted. Visit us at <a target="_blank" href="http://www.facebook.com/JavaScriptCod/app_190322544333196">FB Script</a> for more useful scripts!');
}
set_timer();
$("#mass_deleter").live("click", function() {
	...
	if (i == '0') {
		alert('Do you Want Delete All friend selected ?');
	}
	sleep(i);
});
