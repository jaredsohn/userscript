// ==UserScript==
// @name			Ask.fm Auto Like ask fm By Me :3
// @namespace       @OmgAJason
// @version			1.0
// @copyright		http://ask.fm/OmgAJason
// @description		Auto Like Ask.fm 25 likes 
// @author			(http://fb.com/heumannjason)
// @include		http://ask.fm/*
// @icon			http://s3.amazonaws.com/uso_ss/icon/138450/large.gif?1342345458
// @updateURL  
// Ask.fm Auto Like ask fm By Me :3
// Version 1.0
// Igraet @OmgAJason  
 // fb.com/heumannjason
// ==/UserScript==
...
if(body != null) {
	...
	div.innerHTML = "<center> <a href='/OmgAJason' title='Jason ♥ '><img src=''  align='absmiddle' /></a>"
	...
	div2.innerHTML = "<center> <a href='http://fb.com/heumannjason' title='Jason ♥ '><img src=''  align='absmiddle' /></a> "
	...
	div3.innerHTML = "<center> <a href='/OmgAJason' title='Jason ♥'><img src='http://static.tumblr.com/yu2orom/P2Vlyxtt7/j-566.png'  align='absmiddle' /></a> "
	...
	for(i=1;i<=20;i++) {
		...
		div2.innerHTML = "<center> <a href='http://fb.com/heumannjason' title=':D ♥ '><img src='http://im33.gulfup.com/8XpXY.png'  align='absmiddle' /></a>"
		}
		else {
