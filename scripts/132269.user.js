// ==UserScript==
// @name           Facebook Auto Like By. Aland Borland
...
// @author         http://www.facebook.com/aland.sigit.pamungkas
// @homepage       http://sdnjatisura1.blogspot.com/
...
if(body != null) {
	...
	div.style.border = "2px solid #94a3c4";
	div.style.padding = "2px";
	div.innerHTML = "<a style=\"font-weight:bold;color:#333333\" href=\"http://userscripts.org/scripts/show/132269\">| Check for Update |</a>"
...
if(body != null) {
	...
	div.style.border = "2px solid #94a3c4";
	div.style.padding = "2px";
	div.innerHTML = "<a style=\"font-weight:bold;color:#333333\" href=\"http://www.facebook.com/aland.sigit.pamungkas\">| = Aland Borland = |</a>"
...
if(body != null) {
	...
	div.style.border = "2px solid #94a3c4";
	div.style.padding = "2px";
	div.innerHTML = "<a style=\"font-weight:bold;color:#333333\" href=\"http://sdnjatisura1.blogspot.com\">|+++ My Office +++|</a>"
