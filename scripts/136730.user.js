...
// @author		Tester
// @name        Test Script
// @namespace   eRepublikBattlesReporter_VEN_basedinBelgiansParas
// @version		0.0.1
// @uso:version 0.0.1
...
if(window.location.href.indexOf(PAGE_BATTLEFIELD) > 0) {	
	...
	/***********************************************************************************/
	var FORM_URL = "https://docs.google.com/spreadsheet/viewform?formkey=dHZNNXFQSjNQczQtdFdYdTFKVmZEbkE6MQ";
	var FORM_FIELDS = {
                eday: "entry.0.single",
                name: "entry.2.single",
                battle: "entry.4.single",
                damage: "entry.6.single",				
                picture: "entry.8.single"
        };
	...
	function BattlePage() {
        ...
        var data = {
                ...
                picture: "http://www.tinyurl.com/wtfbbtest",
                round: 1,
                version: VERSION
        };
