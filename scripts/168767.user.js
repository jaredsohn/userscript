...
make_no["검병"]     = ["剣兵"    ,301,     0,           0,         0,       0,          0,0,0];
make_no["창병"]     = ["槍兵"    ,303,     0,           0,         1,       0,          0,0,0];
make_no["궁병"]     = ["弓兵"    ,308,     0,           0,         2,       0,          0,0,0];
make_no["기병"]     = ["騎兵"    ,305,     0,           0,         3,       0,          0,0,0];
make_no["모창병"]   = ["矛槍兵"  ,304,     0,           0,         4,       0,          0,0,0];
make_no["노병"]     = ["弩兵"    ,309,     0,           0,         5,       0,          0,0,0];
make_no["근위기병"] = ["近衛騎兵",307,     0,           0,         6,       0,          0,0,0];
make_no["척후"]     = ["斥候"    ,310,     0,           0,         7,       0,          0,0,0];
make_no["척후기병"] = ["斥候騎兵",311,     0,           0,         8,       0,          0,0,0];
make_no["충차"]     = ["衝車"    ,312,     0,           0,         9,       0,          0,0,0];
make_no["투석기"]   = ["投石機"  ,313,     0,           0,        10,       0,          0,0,0];
...
//	ABfacContainer.appendChild(Build_Box);
	...
	ccreateCheckBoxKai2(td112, "OPT_CHKBOX",  9, " 연병소 　　","자동으로 Lv업을 할려는 건축물에 체크를하십시오.",0);
	ccreateCheckBoxKai2(td112, "OPT_CHKBOX", 10, " 창병사 　　","자동으로 Lv업을 할려는 건축물에 체크를하십시오.",0);
...
//	ABfacContainer.appendChild(Domestic_Box);
	...
	ccreateCheckBox(td21, "OPT_DOME1" , OPT_DOME[1] , " 벌채지식　", "この都市に来たら、自動的に内政スキル（" + DASkill[1]  + "）を発動します。", 0);
	ccreateCheckBox(td22, "OPT_DOME2" , OPT_DOME[2] , " 벌채기술  ", "この都市に来たら、自動的に内政スキル（" + DASkill[2]  + "）を発動します。", 0);
	ccreateCheckBox(td23, "OPT_DOME16", OPT_DOME[16], " 부    국　", "この都市に来たら、自動的に内政スキル（" + DASkill[16]  + "）を発動します。", 0);
	ccreateCheckBox(td24, "OPT_DOME12", OPT_DOME[12], " 농림지식　", "この都市に来たら、自動的に内政スキル（" + DASkill[12] + "）を発動します。", 0);
	ccreateCheckBox(td25, "OPT_DOME13", OPT_DOME[13], " 농림기술　", "この都市に来たら、自動的に内政スキル（" + DASkill[13] + "）を発動します。", 0);

	ccreateCheckBox(td21, "OPT_DOME4" , OPT_DOME[4] , " 채석지식　", "この都市に来たら、自動的に内政スキル（" + DASkill[4]  + "）を発動します。", 0);
	ccreateCheckBox(td22, "OPT_DOME5" , OPT_DOME[5] , " 채석기술　", "この都市に来たら、自動的に内政スキル（" + DASkill[5]  + "）を発動します。", 0);
	ccreateCheckBox(td23, "OPT_DOME17", OPT_DOME[17], " 부 국 론　", "この都市に来たら、自動的に内政スキル（" + DASkill[17]  + "）を発動します。", 0);
	ccreateCheckBox(td24, "OPT_DOME14", OPT_DOME[14], " 가공지식　", "この都市に来たら、自動的に内政スキル（" + DASkill[14] + "）を発動します。", 0);
	ccreateCheckBox(td25, "OPT_DOME15", OPT_DOME[15], " 가공기술　", "この都市に来たら、自動的に内政スキル（" + DASkill[15] + "）を発動します。", 0);

	ccreateCheckBox(td21, "OPT_DOME7" , OPT_DOME[7] , " 제철지식　", "この都市に来たら、自動的に内政スキル（" + DASkill[7]  + "）を発動します。", 0);
	ccreateCheckBox(td22, "OPT_DOME8" , OPT_DOME[8] , " 제철기술　", "この都市に来たら、自動的に内政スキル（" + DASkill[8]  + "）を発動します。", 0);
	ccreateCheckBox(td23, "OPT_DOME18", OPT_DOME[18], " 부국강병　", "この都市に来たら、自動的に内政スキル（" + DASkill[18]  + "）を発動します。", 0);
	ccreateCheckBox(td24, "OPT_DOME19", OPT_DOME[19], " 풍    요  ", "この都市に来たら、自動的に内政スキル（" + DASkill[19] + "）を発動します。", 0);
	ccreateCheckBox(td25, "OPT_DOME20", OPT_DOME[20], " 미옥가무  ", "この都市に来たら、自動的に内政スキル（" + DASkill[20] + "）を発動します。", 0);

	ccreateCheckBox(td21, "OPT_DOME10", OPT_DOME[10], " 식량지식  ", "この都市に来たら、自動的に内政スキル（" + DASkill[10]  + "）を発動します。", 0);
	ccreateCheckBox(td22, "OPT_DOME11", OPT_DOME[11], " 식량기술  ", "この都市に来たら、自動的に内政スキル（" + DASkill[11] + "）を発動します。", 0);
		ccreateText(td23, "Dummy" , "　", 0);
		ccreateText(td24, "Dummy" , "　", 0);
		ccreateText(td25, "Dummy" , "　", 0);

	ccreateCheckBox(td21, "OPT_DOME25", OPT_DOME[25], " 창병훈련  ", "この都市に来たら、自動的に内政スキル（" + DASkill[25]  + "）を発動します。", 0);
	ccreateCheckBox(td22, "OPT_DOME27", OPT_DOME[27], " 연병소훈련", "この都市に来たら、自動的に内政スキル（" + DASkill[27]  + "）を発動します。", 0);
	ccreateCheckBox(td23, "OPT_DOME29", OPT_DOME[29], " 궁병훈련  ", "この都市に来たら、自動的に内政スキル（" + DASkill[29]  + "）を発動します。", 0);
	ccreateCheckBox(td24, "OPT_DOME31", OPT_DOME[31], " 기병사훈련", "この都市に来たら、自動的に内政スキル（" + DASkill[31]  + "）を発動します。", 0);
	ccreateCheckBox(td25, "OPT_DOME33", OPT_DOME[33], " 병기훈련", "この都市に来たら、自動的に内政スキル（" + DASkill[33]  + "）を発動します。", 0);

	ccreateCheckBox(td21, "OPT_DOME26", OPT_DOME[26], " 창병수련", "この都市に来たら、自動的に内政スキル（" + DASkill[26]  + "）を発動します。", 0);
	ccreateCheckBox(td22, "OPT_DOME28", OPT_DOME[28], " 연병소수련", "この都市に来たら、自動的に内政スキル（" + DASkill[28]  + "）を発動します。", 0);
	ccreateCheckBox(td23, "OPT_DOME30", OPT_DOME[30], " 궁병수련", "この都市に来たら、自動的に内政スキル（" + DASkill[30]  + "）を発動します。", 0);
	ccreateCheckBox(td24, "OPT_DOME32", OPT_DOME[32], " 기병사수련", "この都市に来たら、自動的に内政スキル（" + DASkill[32]  + "）を発動します。", 0);
	ccreateCheckBox(td25, "OPT_DOME34", OPT_DOME[34], " 병기수련", "この都市に来たら、自動的に内政スキル（" + DASkill[34]  + "）を発動します。", 0);

		ccreateText(td21, "Dummy" , "　", 0);
	ccreateCheckBox(td22, "OPT_DOME3",  OPT_DOME[3],  " 궁병강화", "この都市に来たら、自動的に内政スキル（" + DASkill[3]  + "）を発動します。", 0);
	ccreateCheckBox(td23, "OPT_DOME6",  OPT_DOME[6],  " 창병강화", "この都市に来たら、自動的に内政スキル（" + DASkill[6]  + "）を発動します。", 0);
	ccreateCheckBox(td24, "OPT_DOME9",  OPT_DOME[9],  " 기병강화", "この都市に来たら、自動的に内政スキル（" + DASkill[9]  + "）を発動します。", 0);
		ccreateText(td25, "Dummy" , "　", 0);

	ccreateCheckBox(td21, "OPT_DOME21", OPT_DOME[21], " 혜풍", "この都市に来たら、自動的に内政スキル（" + DASkill[21]  + "）を発動します。", 0);
	ccreateCheckBox(td22, "OPT_DOME22", OPT_DOME[22], " 인선은력", "この都市に来たら、自動的に内政スキル（" + DASkill[22]  + "）を発動します。", 0);
	ccreateCheckBox(td23, "OPT_DOME23", OPT_DOME[23], " 오의 치세", "この都市に来たら、自動的に内政スキル（" + DASkill[23]  + "）を発動します。", 0);
	ccreateCheckBox(td24, "OPT_DOME24", OPT_DOME[24], " 왕좌의 재능", "この都市に来たら、自動的に内政スキル（" + DASkill[24]  + "）を発動します。", 0);
		ccreateText(td25, "Dummy" , "　", 0);
...
/*
			...
			buildStatus = "연구소 개발중:" + tempStr1[0];
			newAction[IDX2_DELETE] = false;
*/
			continue;
		}
...
//		console.log(generateDateString(computeTime(clock)));
	...
	for (var i = 0; i < actionsElem.snapshotLength; i++) {
		...
		newAction[IDX2_STATUS] = "행군:" + status;
...
//	if (getDispWaitTime()) {
		...
		text += " (대기시간 " + generateWaitTimeString(finishTime, nowTime) + ")";
//	}
	text += " ";
...
function getDomesticSkill(htmldoc) {
	...
	if (!useSkill.snapshotItem(0).innerHTML.match("--:--:--")) {
		...
		var status = "내정:사용(" + trim(useSkill.snapshotItem(0).innerHTML.split(":")[0]) + ":" + SkillName + ")";
	...
	for (var z=0;z<RecoveryCheck.snapshotLength;z++){
		if (RecoveryCheck.snapshotItem(z).innerHTML.match("内政中")) {
			...
			for (var x=0;x<RecoverySkill.snapshotLength;x++) {
				...
				var status = "회복";
				status = "내정:" + status + "(" + trim(Name) + "：" + SkillName + ")";
				data[IDX_ACTIONS][i][IDX2_STATUS] = status;
