// ==UserScript==
// @name            Featured books...REMOVAL
// @namespace       ddd
// @include         http://home.myspace.com/*
function do_platypus_script() {
remove_it(window.document,document.evaluate('/HTML[1]/BODY[1]/DIV[1]/DIV[3]/DIV[1]/SPAN[4]/DIV[1]/DIV[3]', document, null, XPathResult.FIRST_ORDERED_NODE_TYPE,null).singleNodeValue,null,null,null);
remove_it(window.document,document.getElementById('home_featured_books'),null,null,null);
