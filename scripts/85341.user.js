...
searchtext.innerHTML = '<nobr><img src="http://img5.imagebanana.com/img/xndtlqef/suchleiste_2spieler.jpg"/><input id="textbox" type="text" style="width: 95px; height: 19px; border:2px solid rgb(59, 36, 11); padding-left: 5px; " class="input_layout" value="Jogador" onclick="select();"/></nobr>';
