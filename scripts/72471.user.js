// ==UserScript==
// @name           Nataraja CR Editor
// @namespace      http://BinaryOm.com/CReditor.js
// @description    Grepolis Battle report editor 
// @author         C@s, 1st release author norm / Mod BinaryOm
// @include        http://*.grepolis.com/*
// ==/UserScript==

//-------------------------------------------------------------------------------------------//
// The official script is made from norm http://userscripts.org/users/86073                  //
// and it is called Grepolis Berichtformatierer http://userscripts.org/scripts/show/65163    //
// but it was made only for the German server. I just did a minor change to include          //
// the gr and com server!                                                                    //
// All Credits to norm                                                                       //
//                                                                                           //
// English Modification and translation by BinaryOm                                          //
// NaTaRaJa Alliance - Delta Server                                                          //
//-------------------------------------------------------------------------------------------//
if(location.href.match(/action=view/)) { 
  ...
  var BerichtTitel = "[quote]#####[ [b]NaTaRaJa Combat Report[/b] ]#####\n\n[quote][player]"+townOwner[0]+"[/player] [b]vs[/b] [player]"+townOwner[1]+"[/player][/quote]";
  for(var c = 0; c < document.getElementsByTagName('div').length; c++) {
  ...
  if (document.getElementById('ReportTextArea')) {
    ...
    BerichtMenue.innerHTML='<a onclick="document.getElementById(\'ReportTextArea\').style.display=\'block\'" href="#" class="submenu_link"><span class="left">&nbsp;</span><span class="middle">&#x3A8 Combat Report</span><span class="right">&nbsp;</span>&nbsp;</a>';
  ...
  if (document.getElementById('report_booty_bonus_fight')) {
    ...
    var fight_bonus = "[b]&#x3A8 Combat Bonus[/b]:\n\n[quote]"+fight_bonus+"";
  }
  if (document.getElementById('resources')) {
    ...
    if (wood) resourcesOutput+="[quote]Wood: "+wood+"\n";
    if (stone) resourcesOutput+="Stone: "+stone+"\n";
    if (iron) resourcesOutput+="Silver Coins: "+iron+"[/quote] ";
  }
  ...
  for(var c = 0; c < document.getElementsByTagName('script').length; c++) {
    if (document.getElementsByTagName('script')[c].innerHTML.match(/ReportViewer.initialize/)) {
      ...
      } else var dulOutput = 'None '; 
      if (document.getElementById('ReportTextArea')) {
        document.getElementById('ReportTextArea').innerHTML = ""+BerichtTitel+"\n\n"+fight_bonus+resourcesOutput+"\n\n[b]&#x3A8 Troops[/b]: [player]"+townOwner[0]+"[/player]\n\n[quote]"+auhOutput+"[/quote]\n\n[b]&#x3A8 Losses[/b]: [player]"+townOwner[0]+"[/player]\n\n[quote]"+aulOutput+"[/quote]\n\n[b]&#x3A8 Troops[/b]: [player]"+townOwner[1]+"[/player]\n\n[quote]"+duhOutput+"[/quote]\n\n[b]&#x3A8 Losses[/b]: [player]"+townOwner[1]+"[/player]\n\n[quote]"+dulOutput+"[/quote]\n#########[ [b]&#x3A8 NaTaRaJa &#x3A8[/b] ]#########[/quote]\n[quote][url]dwnld.it/nat[/url] : BinaryOm[/quote]";
      }
      break;
    }
  }  
