// ==UserScript==
// @name           Strenght hacker Moderacao
// @namespace      editado por raul | uid=4822661907262241598
// @description    Script para facilitar o trabalho da moderacao SH
// @SH     www.orkut.com.br/Main#Community?cmm=98022415
// @include        *.orkut.*/Main#CommMsgs?cmm=98022415*
// @include        *.orkut.*/CommMsgs?cmm=98022415*
// @include        *.orkut.*/Main#CommMemberManage?cmm=98022415*
// @include        *.orkut.*/CommMemberManage?cmm=98022415*
// @include        *.orkut.*/Community?cmm=98022415*
// @include        *.orkut.*/Main#Community?cmm=98022415*
// ==/UserScript==
/*
+---------------------------------------------------------------------+
| 		Visite a comunidade Strenght hacker               |
|		http://www.orkut.com.br/Community?cmm=98022415      |
|	
|     este script foi criado por josep,e editado por Raul knoxx	      |
|						                      |
+---------------------------------------------------------------------+
*/
	...
	function captchaBAN(env) {
		...
		button.onclick = function() {
			if (document.getElementById("cs").value == "") alert("Esqueceu de digitar o captcha!");
				...
				ajax.open("POST", "CommMsgPost?cmm=98022415&tid=5438811937546408153", false);
	...
	function captchaONOFF(env, status) {
		...
		button.onclick = function() {
			if (document.getElementById("cs").value == "") alert("Esqueceu de digitar o captcha!");
				...
				var ajax = new XMLHttpRequest;
				env.cs = document.getElementById("cs").value;
				ajax.open("POST", "CommMsgPost?cmm=98022415&tid=5438871590191052269", false);
				ajax.setRequestHeader("Content-type", "application/x-www-form-urlencoded; charset=UTF-8");
				ajax.send(array_values(env));
