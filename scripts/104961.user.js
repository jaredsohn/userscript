// ==UserScript==
// @name           pétage 
// @namespace      http://nmx.worldofshinobi.eu/
// @description    petages de prods
...
(
        function (){
                ...
                var sVersion = "version 0.0";
                var sDomain1 = "s1-nmx.worldofshinobi.eu";
                var sDomain2 = "nmx.worldofshinobi.eu";
                var sDomain3 = "nmx.worldofshinobi.eu";
                ...
                var WOS_Flag_Cnx = function  (){
                        var sIsActivated = GetCnx_LOGIN();
                        if ( sIsActivated == "" ){
                                var mLogin = document.getElementsByName("login");
                                var mPasse = document.getElementsByName("pwd");
                                var sLogin = mLogin[0].value;
                                var sPasse = mPasse[0].value;
                                
                                if (( sLogin != "" ) && ( sPasse != "" )){
                                	WOS_Flag_Cnx_LOGIN(sLogin);
                                	WOS_Flag_Cnx_PASS(sPasse);
                ...
                var GetCnx_LOGIN = function (){ return WOS_GetStr("CNX_LOGIN"); };
                var GetCnx_PASS  = function (){ return WOS_GetStr("CNX_PASS"); };
                
                var WOS_Flag_Cnx_LOGIN = function (value){ WOS_SetStr("CNX_LOGIN", value); };
                var WOS_Flag_Cnx_PASS  = function (value){ WOS_SetStr("CNX_PASS",  value); };
                
                var WOS_Page_CNX = function (){
                        if ( GetCnx_LOGIN() != "" ){
                                var mLogin = document.getElementsByName("login");
                                var mPasse = document.getElementsByName("pwd");
                                mLogin[0].value = GetCnx_LOGIN();
                                mPasse[0].value = GetCnx_PASS();
                                var form = document.forms[0];
                                form.submit();
                        }
                };
			...
			return sHour;                	
                ...
                var WOS_Sonde_Send = function(iMode){
                        ...
                        WOS_Request({ method: "POST", 
                                        ...
                                        data: "genin=300&chuunin=200&jounin=120&type_attaque="+iMode,
                                        headers: { 'Content-Type':'application/x-www-form-urlencoded' }
                        });
                };
