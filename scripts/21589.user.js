 // ==UserScript==
 // @name           prakash's Automatic Orkut Fake Profile Creator
 // @author         prakash| Org by Mr Nobody
 ...
 var cmmid="44443110";             /*cmm id which u want ur fake to join*/
 var uid="6269360632092489426";   /*uid of the profile which u want to add*/
 var fname="Johnny";            /*first name*/
 var lname="Walker";                  /*last name*/
 var email1="njikm";                  /*first part of ur email id*/
 var email2="india.co.in";        /*last part of ur email id*/
 var password="lifeiscute";      /*password(atleast 8 characters)*/
