// ==UserScript==
// @name           WWEForums.net - Maximum Image Size
// @namespace      spafic/maximagesize
// @description    Makes images on WWEForums.net have a maximum size so your browser does not "explode".
// @author         Spafic
...
//
// @match          *://*.wweforums.net/showthread.php?tid=*
// @match          *://*.wweforums.net/usercp.php?action=options
// @version        1.0.1
