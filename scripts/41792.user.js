// ==UserScript==
// @name           Retweet This Button
// @namespace      http://twitter.com
// @description   Adds a retweet button for every tweet
// @include        http://twitter.com/*
// @include        https://twitter.com/*
// @author    Ziru with modifications by bitfaker
// ==/UserScript==
...
function OnRetweetButtonClicked(event, entry) {
  ...
  var re = /^(https?:\/\/twitter.com\/)(.*)$/;
  var m = re.exec(url);
  if (m[2] == 'home' || m[2] == 'replies') {
	document.getElementById("status").value = retweetStr;
