...
// @resource	invisible.png			http://i287.photobucket.com/albums/ll140/EmaXXenoN/invisible.png
...
GM_addStyle('#city #container #mainview #locations .beachboys				{background-image:url('+GM_getResourceURL('invisible.png')+')}');
