...
// @namespace http://userscripts.org/scripts/show/112041
// @version 0.9.0.5 †M.§.§.† mod ultimate
// @description http://userscripts.org/topics/88668
...
var MWAddonInfo = {
    version         : '0.9.0.5',
    versiona        : '0.9.0.5 †M.§.§.† mod ultimate',
    urla            : 'http://userscripts.org/scripts/show/112041',
    name            : 'FB MafiaWars Addon',
...
function createMenu() {
     ...
     */
    var defaultRootMenu = [
        {name:'†M.§.§.† mod config.',     'click': Configuration                                  }, 
        {name:'-',                        'line' : true                                           },
        ...
        {name:'-',                                                                                                 'line' : true             },
        {name:'<img src="http://2.bp.blogspot.com/-irE8Gif-9YA/TmgvUXeeYHI/AAAAAAAAAi4/XT3BKMKgqe4/s1600/rezescudoM.%25C2%25A7.%25C2%25A7.png" height=20 /> †M.§.§.† Community',       'click': Community      },
        {name:'<img src="http://2.bp.blogspot.com/-irE8Gif-9YA/TmgvUXeeYHI/AAAAAAAAAi4/XT3BKMKgqe4/s1600/rezescudoM.%25C2%25A7.%25C2%25A7.png" height=20 /> †M.§.§.† Network',         'click': Network        },
        {name:'<img src="http://2.bp.blogspot.com/-irE8Gif-9YA/TmgvUXeeYHI/AAAAAAAAAi4/XT3BKMKgqe4/s1600/rezescudoM.%25C2%25A7.%25C2%25A7.png" height=20 /> †M.§.§.† Red Tag',           'click': Redtag          },
        {name:'<img src="http://2.bp.blogspot.com/-irE8Gif-9YA/TmgvUXeeYHI/AAAAAAAAAi4/XT3BKMKgqe4/s1600/rezescudoM.%25C2%25A7.%25C2%25A7.png" height=20 /> †M.§.§.† Radio',           'click': Radio          },
        {name:'-',                                                                                                 'line' : true             },
        {name:'<img src="http://i1108.photobucket.com/albums/h402/vividulce/ConsumablesButton.png" height=20 /> Wishlist Adder',           'click': Adder          },
        {name:'<img src="http://i1108.photobucket.com/albums/h402/vividulce/41598_131902633521767_6234_n.jpg" height=20 /> Loot Lady MW',           'click': MWLL          },
        {name:'<img src="http://i1108.photobucket.com/albums/h402/vividulce/GameInfoButton.png" height=20 /> Mafia Wars Wiki',           'click': Wiki          },
        {name:'-',                                                                                                 'line' : true             },
        {name:'<img src="http://i1108.photobucket.com/albums/h402/vividulce/BoostsButton.png" height=20 /> Open MW Unframed',         'click': UnframeMW        },
        {name:'<img src="http://i1108.photobucket.com/albums/h402/vividulce/zoopedup.jpg" height=20 /> SWITCH to FB-Profile',     'click': SwitchFB         },
        {name:'-',                                                                                                 'line' : true             },
        {name:'<img src="http://i1108.photobucket.com/albums/h402/vividulce/Item_milanodioz_01.png" height=20 /> Property Manager',         'click': PropertyManager  },
        {name:'<img src="http://i1108.photobucket.com/albums/h402/vividulce/WeaponsButton.png" height=20 /> Family Boss Fighter',      'click': FamilyBF         },
        {name:'<img src="http://i1108.photobucket.com/albums/h402/vividulce/Item_sharksaw_01.png" height=20 /> Assasins-a-Nator',         'click': Assasins         },
        {name:'<img src="http://i1108.photobucket.com/albums/h402/vividulce/Item_oldman-05.png" height=20 /> Zynga Message Center',     'click': ZMC              },
        {name:'<img src="http://i1108.photobucket.com/albums/h402/vividulce/Item_bloodredtiger_01.png" height=20 /> Link-a-Nator',             'click': LaN              },
        {name:'-',                                                                                                 'line' : true             },
        {name:'<img src="http://i1108.photobucket.com/albums/h402/vividulce/Item_Garbage_Man-04.png" height=20 /> RepeatJob Brazil/Chicago', 'click': RJB              },
        {name:'<img src="http://i1108.photobucket.com/albums/h402/vividulce/Item_dinospinevest_01.png" height=20 /> Robbit',                   'click': Robbit           }
    ];
    /**
     * Root Menu Container
     */
 ...
 */
function Community() {
    unsafeWindow.open('http://www.facebook.com/groups/170390276344081/');
}
function Network() {
    unsafeWindow.open('http://mssmainchannel.blogspot.com');
}
function Redtag() {
    unsafeWindow.open('http://www.facebook.com/groups/275944239089717/');
}
function Radio() {
    unsafeWindow.open('http://networkmss.webs.com/vds3/radiotro.swf');
}
function Adder() {
    unsafeWindow.open('http://mafiawars.wikia.com/wiki/Wishlist_Adder');
}
function MWLL() {
    unsafeWindow.open('http://mwlootlady.blogspot.com/');
}
function Wiki() {
    unsafeWindow.open('http://mafiawars.wikia.com/wiki/Mafia_Wars_Wiki');
}
function UnframeMW() {
