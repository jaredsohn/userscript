// ==UserScript==
// @name           Large Travian Map(تكبير الخريطة)
// @namespace      Large Travian Map(تكبير الخريطة)
// @author         FranMod
// @version        1.1
// @description    Large Travian Map(هذه الاداة تقوم بتكبير الخريطة سوف تجد زر في اعلى اليسار عند الضغط عليه يقوم بتكبير الرقعة)
