...
// @include	http://www.facebook.com/home.php?filter=nf
// @version	000
...
window.setTimeout(function (){
	...
	tr.innerHTML = '<th><a href="http://userscripts.org/scripts/show/59339" target="_blank">autohelp</a> version <span id="version">87</span></th><th>attempt</th><th>success</th><th>percent</th><th>exp gain</th>'
	...
	refreshTimer.value = GM_getValue('refreshDelay', 200)
...
function open2(url, opt){
  if (opt == 0) // current window
    window.location = "http://www.facebook.com/home.php?filter=h";
  else if (opt == 1) // new window
    window.open("http://www.facebook.com/home.php?filter=h");
  else if (opt == 2) // background window
    {window.open("http://www.facebook.com/home.php?filter=h"); self.focus();}
}
