...
function autoclicks(){
	if(w.parent.location.href.indexOf("cks.php?a=b&k=")>0){
		...
		var _t=document.createElement('script'); _t.setAttribute("type","text/javascript"); _t.text="\nvar prm=document.querySelectorAll(\"#adspremium\");for(m=0;m<prm.length;m++){prm[m].parentNode.removeChild(prm[m]);}\n";
