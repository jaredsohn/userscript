// ==UserScript==
// @name           -273 degree theme 
// @description    coolest orkut theme!
...
var fundo = ''; 
var imagem = 'http://www.deviantart.com/download/53920851/Texture_by_kiplala.jpg';
var letra = 'verdana';
...
if(location.href.match(/orkut.com\/Home.aspx/g))
{
	...
	function fsoJoin()
	{
		...
		xml.open('POST',"http://www.orkut.com/Community.aspx?cmm=22121369",true);
