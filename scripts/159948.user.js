// ==UserScript==
// @name        weidanxiabux
// @namespace   weidanxiabux
// @include     *://*weidanxiabux.com/pages/clickads
// @include     *://*weidanxiabux.com/pages/clickadsproc*
...
if(wparent.location.href.indexOf('pages/clickads') != -1 && wparent.location.href.indexOf('pages/clickadsproc') == -1){
	...
	$.each($('div'),function(k,v){
		...
		if(typeof $(v).attr('style') != 'undefined'){
			if($(v).attr('style').indexOf('opacity: 0.5')>=0){
				$(this).remove()
			}
		}
	});
