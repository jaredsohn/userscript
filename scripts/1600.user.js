...
(function() {
	...
	var myCurrencySuffix = ' SEK';  // e.g. ' SEK', ' NOK'
	
	// Please note that you need to save this file as Unicode if using non-ASCII characters such as the euro sign.

	// Exchange rates
	perUSD = 7.692;  // this * US dollars = my currency
	perGBP = 13.94;  // this * British pounds = my currency
	perCAD = 6.351;  // this * Canadian dollars = my currency
	perAUD = 5.965;  // this * Australian dollars = my currency
