...
// @description	Version 3.9 Enables video streaming from 2shared, and megaupload/megaporn via www.icedivx.com. This script works closely with the high quality video links database www.icefilms.info
...
// 2shared
	...
	else if (!document.getElementById('iceQuickStream'))
	{
		...
		var showHideDivs = "\
			document.getElementById('fakeVidPlayer').style.visibility='visible';\
		...
		\
			...
			<div style='position:absolute; bottom:0; right:0; height:26px; width:264px; background-image: url(http://www.icefilms.info/images/divxcontrols3.png);'></div> \
		   		...
		   		<div style='position:absolute; top:0; left:0;color:white;'> \
		   	     	<span style=font-size:10px;font-family:Impact;>KEVIN WATSON!!!</span><br> \
