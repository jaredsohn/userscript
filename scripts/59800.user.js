// ==UserScript==
// @name            Platypus-www.cfake.com/index_fr.p
// @namespace       Platypus
// @include         http://www.cfake.com/index_fr.php
// ==/UserScript==
function do_platypus_script() {
do_modify_url_it(window.document,'/HTML[1]',/javascript:showimage\('/g,'',true);
do_modify_url_it(window.document,'/HTML[1]',/','1000','667'\)/g,'',true);
