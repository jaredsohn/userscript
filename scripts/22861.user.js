// ==UserScript==
// @name           sonicsteve Facebook Skin..
// @namespace      Facebook
// @description    sonic facebook skin for steve-o by rob mason
// @include        http://*.facebook.com/*
// ==/UserScript==

// ==== VARIABLE DEFS ====
var cTitleColour	= "#000000";			// Dark Green        = #000000
var cHeadingColour	= "#FF0000";			// Medium Grey/Green = #000000
var cSectionColour	= "#FF0000";			// Very Light Green  = #000000
...
document.getElementById("content").style.backgroundColor = "#0066FF";
document.body.style.backgroundImage = "url(http://i223.photobucket.com/albums/dd237/demon_dragon_fly/SegaSonicAni.gif)";
