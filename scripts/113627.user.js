// ==UserScript==
// @name           Auto Search Booty Grab Script	
// @description    Based on previous version's of Awesomo's Stalk Good Tanks script.
// @include        *
// ==/UserScript==
						...
						if(glowT<=gaiaT){
							if(glowT+720>gaiaT){
								...
								if(open===true){
									...
									GM_openInTab('http://www.gaiaonline.com/landing/flashaquarium/?userid='+tankId);
								}
							}
							else{
								//alert('over');
