...
var MMHelperInsert = function($, window, undefined) {
	...
	var flag = 8;
	var mmList = { 
		1:000000,    //name1:http://www.erepublik.com/en/newspaper/264197/1
		2:000001,    //name2:http://www.erepublik.com/en/newspaper/264328/1
		3:000002,    //name3:http://www.erepublik.com/en/newspaper/263082/1
		4:000003,    //name4:http://www.erepublik.com/en/newspaper/260623/1
		};
	var inti = 0;
	var time = 500;
	var running = false;
	...
	$(document).ready ( function (){
		...
		if ((parent.document.location.toString().indexOf("/citizen/profile/"+c_id)==-1)===false) {
			$('div.place:last').after(
				'<div class="place"><h3><img src="http://www.erepublik.com/images/modules/_icons/press_director.png" alt="">#MMProjects</h3>'+
