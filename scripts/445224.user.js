// Linkify (for Grandstream Phones) - Click to Dial
// Author: Joseph Chen
...
//
// ==UserScript==
// @name           Grandstream Phone Click to Dial
// @namespace      
// @description    Turn phone numbers into hyperlinks so you can click them to auto-dial using Grandstream Phones
// @include        *
// @version        1.0
// ==/UserScript==
...
(function () {
    ...
    //replace with your ip address of phone and replace account with your username and password with your phone web login password
		return 'http://192.168.0.78/cgi-bin/api-make_call?phonenumber='+String(t).replace(/[^0-9+]/ig, "")+'&account=admin&password=admin';
	}
