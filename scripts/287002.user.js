// ==UserScript==
// @name           Gl1TCHr.COM Functions
// @namespace      Kyle Butler
// @description    All of the "glitch" functions for the Gl1tchr.com Platform. Based on the works of Dr. Drity Joe and Bennett
// @copyright      2013
// @version        2.0b
...
menu.innerHTML = "\
<input type=\"button\" value=\"Hide Gl1TCHr\" id=\"menutog\" style=\"border: 1px solid red; background: lightblue; text-align: center;\" /> \
<input type=\"checkbox\" id=\"autobank\" " + bchecked + " /> Auto-Bank \
<input type=\"checkbox\" id=\"autoAttack\" " + achecked + " /> Farm <INPUT type=\"button\" value=\"Auto-Build\" input id=\"roido\" /> \<input type=\"checkbox\" id=\"cleanWall\" " + cchecked + " /> Clear Comments <br>\
<input type=\"checkbox\" id=\"bounty\" " + schecked + " /> Auto-Kill <input type=\"text\" style=\"border: 1px solid green; width: 2em; color: #00ff00; background: black; text-align: center;\" id=\"bountylevel\" value=\"" + bountyLevel + "\" />  <input type=\"text\" style=\"border: 1px solid green; width: 2em; color: #00ff00; background: black; text-align: center;\" id=\"bountyammo\" value=\"" + bountyAmmo + "\" /> \
<span id=\"ntk\">What is your flag?<select style=\"border: 1px solid green; background: black; color: #00ff00; text-align: left;\" id=\"sancCountry\"> \
...
<input type=\"hidden\" id=\"messageBox\" " + mchecked + " /> \
Hitlist <input type=\"text\" style=\"border: 1px solid green; width: 2em; color: #00ff00; background: black; text-align: center;\" id=\"autosancNum\" value=\"" + autosancNum + "\" /> times for <input type=\"text\" style=\"border: 1px solid green; width: 5em; color: #00ff00; background: black; text-align: center;\" id=\"amount\" value=\"" + amount + "\" /> <input type=\"checkbox\" id=\"bk\" " + bkchecked + " /> Kill @ Bounty <br> \
ProfileSaver <select style=\"border: 1px solid green; width: 23em; background: black; text-align: left; color: #00ff00;\" id=\"selectboxPUID\" /> </select><br><input type=\"button\" value=\"GET\" input id=\"btnGETPUID\" /> <INPUT type=\"button\" value=\"CLR\" input id=\"btnCLRPUID\" /> <INPUT type=\"button\" value=\"CLR ALL\" input id=\"btnCLRALL\" /> <INPUT type=\"button\" value=\"SET\" input id=\"btnSET\" /> <br>\
<input type=\"checkbox\" id=\"ransanc\" " + ransancchecked + " /> Random Sanctioner \
...
<input type=\"checkbox\" id=\"dosearch\" " + zchecked + " /> Search Hitlist by Profile ID <input type=\"text\" style=\"border: 1px solid green; width: 8em; color: #00ff00; background: black; text-align: center;\" id=\"csearch\" value=\"" + csearch + "\" /> \
<input type=\"button\" value=\" ? \" id=\"faq\" style=\"border: 1px solid blue; background: red; text-align: center;\"/>";
...
displaytoggle.setAttribute('value', 'Gl1TCHr');
displaytoggle.style.display = hideorshow;
displaytoggle.style.padding = '10px';
displaytoggle.style.position = 'fixed';
displaytoggle.style.top = '7%';
displaytoggle.style.background = 'lightblue';
displaytoggle.style.border = '1px solid white';
