// ==UserScript==
// @name            BusinessWeek print
// @include         http://www.businessweek.com/*.html
// ==/UserScript==

function do_platypus_script() {
fix_page_it(window.document,'/HTML[1]',null,null,null);
isolate(window.document,document.getElementById('story-body'),null,null,null);
relax(window.document,document.getElementById('story-body'),null,null,null);
