// ==UserScript==
// @author		Gislaine (source : Angel Vladov)
// @name        FDC Script
// @namespace   eRepublikFDC
// @version		0.0.2
// @uso:version 0.0.2
// @include		http://*erepublik.com/*/military/battlefield/*
// @description    eRepublik Relatório de dano FDC
// ==/UserScript==
...
if(window.location.href.indexOf(PAGE_BATTLEFIELD) > 0) {	
	...
	/***********************************************************************************/
	var FORM_URL = "https://docs.google.com/spreadsheet/viewform?formkey=dDhKWFBIWFpEeVJ3eHk4bUREWlVSUWc6MQ#gid=0";
	var FORM_FIELDS = {
                eday: "entry.0.single",
                name: "entry.1.single",
