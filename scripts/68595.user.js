// ==UserScript==
// @name            La Nación home print
// @include         http://www.lanacion.com.ar/
// @include         http://www.lanacion.com.ar/index.asp?origen=metarefresh
// ==/UserScript==

function do_platypus_script() {
fix_page_it(window.document,'/HTML[1]',null,null,null);
smart_remove(window.document,document.evaluate('/HTML[1]/BODY[1]/DIV[7]/DIV[1]/DIV[1]/DIV[5]', document, null, XPathResult.FIRST_ORDERED_NODE_TYPE,null).singleNodeValue,null,null,null);
script_paste(window.document,document.evaluate('/HTML[1]/BODY[1]/DIV[7]/DIV[1]/DIV[2]/DIV[3]', document, null, XPathResult.FIRST_ORDERED_NODE_TYPE,null).singleNodeValue,document.evaluate('/HTML[1]/BODY[1]/DIV[7]/DIV[1]/DIV[1]/DIV[5]', document, null, XPathResult.FIRST_ORDERED_NODE_TYPE,null).singleNodeValue,null,null);
