// ==UserScript==
// @name HWM Silentio's Mod New Style
// @author Silentio
// @namespace HWM
// @version 0.9.1.3 20101112
...
function main(e){      
    ...
    //Combat experience table (16 levels)
    var combat_exp_lvl = [
    ...
    // Stile
    var cssStyle = "";
    cssStyle += ".bar_wrap {width:150px; margin:3px 0 3px 9px;border: 1px solid #1C1C1C;background-color: #65541B;-moz-box-shadow: 0 0 1px #666, inset 0 1px 1px #222;background-image: -moz-linear-gradient(#65541B, #8C7526 50%, #65541B);}.bar {height: 7px;background-color: #BABA53;border-right: 1px solid #282828;-moz-box-shadow: inset 0 0 1px #ddd;background-image: -moz-linear-gradient(#E1E266, #BABA53 50%, #ABAF4B 51%, #848738);-moz-transition: all 1s ease;-moz-animation-duration: 1s;-moz-animation-name: slidein;}@-moz-keyframes slidein {from {width: 100%}}.bar:hover {-moz-animation: animate-stripes 3s linear infinite;}@-moz-keyframes animate-stripes {0% {background-position: 0 0;} 100% {background-position:0 22px;}}.htooltip, .htooltip:visited, .tooltip:active {color: #0077AA;text-decoration: none;}.htooltip:hover {color: #0099CC;}.htooltip span {background-color: rgba(0,0,0, 0.8);-moz-border-radius: 15px 15px 15px 0px;-moz-box-shadow: 1px 1px 10px rgba(0, 0, 0, 0.5);color: #fff;margin-left: -1px;margin-top: -25px;opacity: 0;padding: 2px 5px;position: absolute;text-decoration: none;visibility: hidden;width: 100px;z-index: 10;-ms-transition: opacity 0.4s ease-in-out, visibility 0.4s ease-in-out;}.htooltip:hover span {position: absolute;opacity: 1;visibility: visible;}";
