...
/*
27.10.2011 v1.29.9
- Fixed 2.3.1, kudos to bontchev and 8arlock
		...
		getProduction: function(id, level)
		{
			...
			if (level == 0)
				return (id==1) ? 30 * Options.uni_SpeedFactor :
								(id==2) ? 20  * Options.uni_SpeedFactor : 0;
	...
	return mclass;
		...
		addRefreshButton: function(eventListWrap)
		{
			...
			refreshDetails = Utils.createElement("A", {href: "javascript:void(0);", class: "refresh_details"},
					[Utils.createElement("IMG", {src: "data:image/gif;base64,R0lGODlhEAAQAOYAAGB6jpGmtdXe5V54jXGKntrh5vDz9nCJnYedrqu7x/3+/+3w8+zw9LfFz/L1+GZ/k3ePo/7//42gsI2isrC+ycjT22uD lsDM1aGwvXONoIacreHm64ugsai2wpaotq+8x6GywHWOodri5pCltWF7j/Dz9crU3HSNoI+jsdDa4IqfrnmSpNjh6K+9yevv8/j5++Xq7qu4w2J7kMjU3HmRpKi5xtzi6KW 0v3iNn7rFzvr7/bzJ04SaqnaMnsjU3X+VpgAAAP///2+JnVx2iwAAAAAAAAAAAAAAAAAAAAAAAAAAAAAAAAAAAAAAAAAAAAAAAAAAAAAAAAAAAAAAAAAAAAAAAAAAAAAAAA AAAAAAAAAAAAAAAAAAAAAAAAAAAAAAAAAAAAAAAAAAAAAAAAAAAAAAAAAAAAAAAAAAAAAAAAAAAAAAAAAAAAAAAAAAAAAAAAAAAAAAAAAAAAAAAAAAAAAAAAAAAAAAAAAAA AAAAAAAAAAAAAAAAAAAAAAAAAAAACH5BAAAAAAALAAAAAAQABAAAAdxgEBDg4SFhYKGiYqGMoM/D4tDODc+FB4MPIoAMS8uJhtBQTskiQA5HRYDLQpBOiqRgz0oGB8SsItC ubq7vLscGidCB728AgsFFTTEuwmhLCsEGQECAb0QBiUOMCkiETYIxDUjEw0zFyAhy+q6QOu7QIEAOw=="})]);
		...
		fleet2_insertCSSRules: function()
		{
			...
			if (Options.fleet2_expandLists) {
				Utils.insertCSSRule('#slPanel { \
					padding: 5px; \
					margin: 2px 0 0 5px;\
					background-image: url("data:image/gif;base64,R0lGODlhmwIdAJECAA0QFAAAAAAAAAAAACH5BAEAAAIALAAAAACbAh0AAAL/lB0BCu0Po5y02ouz3rz7D4biSJbmiabqyrZupyTHfCTLi+f 6zvf+DwwKh8TiIxag0WwMo/MJjUqn1Kr1qkIqZ0ys9wsOi8fkclS7RcTM7Lb7DY/Ln+h0d47P6/f8vru+dec3SFhoeIg4AqgkmOj4CBkp2ba4tDaJmam5yalTyXXZKTpKWm ra8FkTesra6vqal6p2A1tre4tLJSvQmOv7CxycstsrbHyMnHy0kJTGu6ocLT39SgxNjZ2tLWlNu/0NHt7X3SRufo4+Rp7O3u5+xuz87P1eb3//so6/z98fou8voMCBEAASP IjwnsGEDBuaW+gwosRpECdavAisIsaNEBxdaewIMiSnjyJLmnS0qAAAOw=="); \
					width: 642px;\
				}');
