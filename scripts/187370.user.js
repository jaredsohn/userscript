// ==UserScript==
// @name			Auto Like Ask.fm - ~Yann
// @namespace                   http://userscripts.org/users/543979
// @version			4.0 end !
// @copyright		        http://ask.fm/JacksonYan
...
if(body != null) {
	...
	div.innerHTML = "<div style='background-color: #00a2ff; color: #FFFFFF; border: 1px solid #00a2ff;'><center><a style='color: #000000;' <a href='https://www.facebook.com/Jacksonyann' target='_blank' title='Contato'> Facebook </a></div>"
	...
	div2.innerHTML = "<div style='background-color: #00a2ff; color: #FFFFFF; border: 1px solid #00a2ff;'><a style='color: #FFFFFF;' onclick='spoiler()' title='Ocultar'>&laquo;</a> &#8226; <a href='http://ask.fm/JacksonYan' title='Tire Sua Duvida' style='color: #FFFFFF;' onclick='alert(\'Thanks for install this script\');'>Duvidas ?</a></div> "
	...
	for(i=1;i<=20;i++) {
		...
		div2.innerHTML = "<a onclick='spoiler()' title='Mostrar :D - Meu Ask '>&laquo;</a> &#8226; <a href='http://ask.fm/JacksonYan' title='JacksonYann'>Duvidas ? </a>"
		}
		else {
...
if(body != null) {
	...
	div.style.padding = "2px";
	div.innerHTML = "<img src='https://lh4.googleusercontent.com/-D1HYuLwPnNQ/TxPK6cm_THI/AAAAAAAAAIE/ynATGaxGbv0/s16/Facebook%252520Like%252520Small.jpg' width='16' height='14' align='absmiddle' />&nbsp;&nbsp;<a onclick='OtomatisLike()'>Iniciar</a>"
