// ==UserScript==
// @name           Combat Report Auto-Converter 2.3.0
// @autor          WTF
...
ve: { units: "Unidades", slinger: "Hondero", swordsman: "Espadachín", phalanx: "Hoplita", archer: "Arquero", marksman: "Fusilero", gyrocopter: "Girocóptero", "steam giant": "Gigante a vapor", bombardier: "Bombardero", ram: "Ariete", catapult: "Catapulta", mortar: "Mortero", doctor: "Médico", cook: "Cocinero", spearmen: "Spearmen?", barbarian: "Barbarian?" },
...
var adress = new Array('0','107','108','109','110','111','112','113','121','134','152','195','216','234','260','327','342');
...
if(deffenders.length>1) {results += 'es'; }
	...
	report += '<br/>[b][i]Compactado con: [url=http://board.ikariam.es/index.php?page=Thread&threadID=129508]Combat Report Auto-Converter[/url] v2.3.0 © by [url=http://board.ikariam.es/index.php?page=User&userID=47984]WTF[/url][/i][/b]';
