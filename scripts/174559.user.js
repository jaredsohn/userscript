// ==UserScript==
// @name        Laaptu-Script By Sachin - sac4temp
    ...
    if(url.match("quiz")){
        {
            ...
            if (laaptu_changeorder_bySac == "a2d")
            {
                for (var i = 0; i < ele.length; i++){
                    if(ele[i].style.display!="none" && ele[i].clientHeight=="41" && ele[i].clientLeft=="1" && ele[i].clientTop=="1" && ele[i].clientWidth=="301"){
                        ele[i].click();
                    }
                }
                for (var i = 0; i < ele.length; i++){
                    //alert("Width of div: " + $(ele[i]).width());
                    if(ele[i].style.display!="none" && ele[i].clientHeight=="27"  && ele[i].textContent=="Continue" ){
                    ...
                    if(ele[i].style.display!="none" && ele[i].clientHeight=="27" && ele[i].clientLeft=="0" && ele[i].clientTop=="0" && ele[i].clientWidth=="181"){
                        ele[i].click();
                    }
                    if(ele[i].style.display!="none" && ele[i].clientHeight=="27" && ele[i].clientLeft=="0" && ele[i].clientTop=="0" && ele[i].clientWidth=="131"){
                        ele[i].click();
                    }
                    if(ele[i].clientWidth=="0" && ele[i].clientHeight!="41" && ele[i].innerHTML=="Fun Quiz"){
                        ele[i].click();
                    }
                    /* if(ele[i].clientWidth=="0" && ele[i].clientHeight!="41" && ele[i].innerHTML=="Math Quiz"){
