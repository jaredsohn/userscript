...
function funcionPrincipal(e){
	...
	var lang_tr = new Array(); 
		...
		lang_tr['CHECK']		= 'Yeni versiyon kontrol et.';
	    lang_tr['ARCHIVE']		= 'Arsiv';
		lang_tr['RESUMEN']		= '&#214;zet';
...
*/
	...
	// Romanos 
	uc[1] = [0,0,0,0,0]; 		// Legionario 
	uc[2] = [0,0,0,0,0]; 		// Pretoriano 
	uc[3] = [0,0,0,0,0]; 		// Imperano 
	uc[4] = [0,0,0,0,0]; 		// Legati 
	uc[5] = [0,0,0,0,0];	 	// Imperatoris 
	uc[6] = [0,0,0,0,0]; 		// Caesaris 
	uc[7] = [0,0,0,0,0]; 		// Carnero 
	uc[8] = [0,0,0,0,0]; 		// Catapulta 
	uc[9] = [0,0,0,0,0]; 	        // Senador 
	uc[10] = [0,0,0,0,0]; 	        // Descubridor 

	// Germanos
	uc[11] = [0,0,0,0,0];		// Lanzador porras 
	uc[12] = [0,0,0,0,0];		// Luchador lanza 
	uc[13] = [0,0,0,0,0]; 		// Luchador hacha 
	uc[14] = [0,0,0,0,0]; 		// Emisario 
	uc[15] = [0,0,0,0,0]; 		// Paladin 
	uc[16] = [0,0,0,0,0]; 		// Caballista teutona 
	uc[17] = [0,0,0,0,0]; 		// Ariete 
	uc[18] = [0,0,0,0,0]; 		// Catapulta 
	uc[19] = [0,0,0,0,0]; 	// Cabecilla 
	uc[20] = [0,0,0,0,0]; 	// Descubridor 

	// Galos
	uc[21] = [0,0,0,0,0]; 		// Falange 
	uc[22] = [0,0,0,0,0]; 		// Luchador espada 
	uc[23] = [0,0,0,0,0]; 		// Batidor 
	uc[24] = [0,0,0,0,0]; 		// Rayo 
	uc[25] = [0,0,0,0,0]; 		// Druida 
	uc[26] = [0,0,0,0,0]; 		// Haeduanos 
	uc[27] = [0,0,0,0,0]; 		// Carnero 
	uc[28] = [0,0,0,0,0]; 		// Catapulta 
	uc[29] = [0,0,0,0,0]; 	// Cacique
	uc[30] = [0,0,0,0,0]; 	// Descubridor 
