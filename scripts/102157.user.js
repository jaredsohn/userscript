...
// // Trap check time different value (45 minutes - 60 minutes)
			...
			if (enableTrapCheck)
			{
				...
				if (!aggressiveMode)
				{
					displayTimer("Horn: " + timeformat(hornTime) + " | Check: " + timeformat(checkTime), 
						timeformat(hornTime) + "  <i>(included extra " + timeformat(hornTimeDelay) + " delay & +/- 1 seconds different from MouseHunt timer)</i>", 
