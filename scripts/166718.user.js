...
function LL_carga() {
    ...
    //var orders = '<h4>Prioridades de Argentina</h4><div id="mod_orders"></div>';
    ...
    var imageHeader = 'http://i.imgur.com/bJlXo26.jpg';
    var orders = '<div id="mod_orders"><img src="'+ imageHeader + '" style="float: none; margin-top:-5px; margin-bottom:-2px" alt="Prioridades de Combate - Argentina"/></div>';
...
function footer() {
	...
	var linkDiv = '';
    switch(x) {
    case 1: linkDiv = 'http://bit.ly/13j0WR1'; break;
    case 2: linkDiv = 'http://bit.ly/15mKljB'; break;
    case 3: linkDiv = 'http://bit.ly/15mKof6'; break;
    case 4: linkDiv = 'http://bit.ly/129Z3of'; break;
    default: linkDiv = 'XX';
    }    
    var orders = '<div class="rest">O Juremos con Roto morir<a href="http://goo.gl/W50MW" title="" target="_blank">Planilla Ordenes + Canales de Coordinacion</a><a href="' + linkDiv + '" title="" target="_blank">Canal de Coordinación</a></div>';
...
function battles() {
	var x = division();
    $.get('https://docs.google.com/spreadsheet/pub?key=0Ao9AwgenLRqIdDNCWGVGa3pZakNSNjRqWUhoNlk2SFE&single=true&gid=0&range=C19&output=txt', function(data) {
