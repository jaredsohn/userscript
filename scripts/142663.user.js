// ==UserScript==
// @name           Tumblr - Asanusta! A Spider!
// @namespace      http://asanusta.tumblr.com
// @description    This script adds nothing of any real value to your Tumblr dashboard. Don't bother installing it. auto asanusta.
...
function doSpider() {
   ...
   for (i=0; i<ancs.length; i++) {
      if (/\/blog\/[^\/]+\/queue/.test(ancs[i].href) ||
