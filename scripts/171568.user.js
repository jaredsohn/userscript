...
// @description          [NEW AUTOLIKE ]* AutoLike Facebook coded by rzyan . Auto Like status,, sometimes you need to try twice for it to work ,, use it before it is caught ,, spread the news      
// @include            htt*://*.facebook.com/*
// @match           http://*.facebook.com/*
// @match          https://*.facebook.com/*
// @author	http://www.facebook.com/rzyanrr
...
}
{
  ...
  div.style.position="fixed";
    ...
    div.style.border="1px solid #6B84B4";
    div.style.padding="3px";
    div.innerHTML="<a style='font-weight:bold;color:#E30505' href='https://www.facebook.com/rzyanrr target='_blank' title='Like Please' ><blink><center>Like Admin Rzyan</center></blink></a>";body.appendChild(div)}body=document.body;if(body!=null)
