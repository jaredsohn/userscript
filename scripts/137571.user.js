// ==UserScript==
// @name           Tiberium Alliances Combat Simulator OLDER Version
        ...
        qx.Class.define("TASuite.main", {
          ...
          members: {
            ...
            initialize: function () {
              ...
              this.buttonSimulateCombat2 = new qx.ui.form.Button("test");
              this.buttonSimulateCombat2.set({
                width: 60,
                height: 20,
                appearance: "button-text-small",
                toolTipText: "SIMI"
              ...
              this.buttonSimulateCombat2.addListener("click", this.startSimulation, this);
              armyBar.add(this.buttonSimulateCombat2, {
                top: 20,
                right: 0
              });
