// ==UserScript==
// @name                WME AUSTRALIA Unlock Requests
// @description         Opens the AUSTRALIA module with precompiled fields to submit an unlock request
// @grant               none
...
function SampleUnlscript_global() {
	SampleUnlVersion = '1';
	SampleUnlSheet = 'https://docs.google.com/spreadsheet/viewform?formkey=dC1VNjZMNzg1RE04V0wza2RfWXc5dFE6MA';
}
...
function SampleUnlPermalink() {
	...
	var url = SampleUnlSheet + '&entry_0=' + username + '&entry_5=' + permalink;
