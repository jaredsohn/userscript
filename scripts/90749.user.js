...
var version= '1.15';
var limit=100; 			//Number of messages displayed - to be configured
var dlurl = 'http://reton.com.pl/TNT.user.js';
var dataServer="http://reton.com.pl/TNT.user.js";
...
var lang={
  ...
  pl: {	'send': 'Wyślij',			'sh': 'Pokaż/Ukryj',		'msg': 'Wpisz wiadomość',		'swap': 'swap',
  	  	'cpub': 'RHO',	'cally': 'TNT',	'new': 'Nowa wersja',			'get': 'Zainstaluj',
...
function mkColor(d) { return (isPub(d) ? "#ECE" : (isAlly(d) ? "white" : "#FF8")); }
...
function evalBaseElements(dom, serdom) {
	...
	var baseElements = '<h3 class="header">';
	    ...
	    baseElements += '</h3><div id="chMessagesListBox" style="width:240px;height:405px; padding:1px 0;font-size:12px; margin-left: 6px; display:'+showStatus+'">';
	
	    baseElements += '<div id="chMessagesList" style="height: 400px;overflow:auto;margin-right: 2em;border: 1px solid #CB9B6B; font-size:8pt; background-color:'+color+'; text-align:left;"></div></div>';
