// ==UserScript==
// @name           Social-Fixer german-patch BETA (programierer)
...
Social Fixer German
(c) 2012 SocialFixerGerman
http://sfgp.de.vu/support/
*/
var version = 1.0;
var SCRIPT_TYPE = "firefox_addon";
var undef;
				...
				poll(function() {
					if(unsafeWindow&&unsafeWindow.console&&unsafeWindow.console.debug) { 
						if (console_logging_enabled) {
							try {
								unsafeWindow.console.debug.apply(this,"[Social Fixer German]","Logging wird gestartet...");
...
function delay(func,t){return setTimeout(func,t||10);}
...
function minimessage(str,okFunc,css) {
	var rule;
	okFunc = okFunc || (function(){});
	var mm = el('div','better_fb_mini_message',{innerHTML:str,title:'Klicken um Nachricht zu schließen'},{click:function(e) { 
		var t=target(e); 
...
function quickmessage(str,duration,func,style,remove) {
	...
	var msg = el('div','bfb_quickmessage mini_x',{title:'Klicken um zu verstecken'},{click:function(){if (typeof func=="function") {func();};this.style.display='none';}},str,{cursor:'pointer'});
...
var ls = {
	...
	'clear':function() {
		...
		if (confirm("Der Cache beinhaltet:\n"+dump+"\n\nSind Sie sicher, dass Sie den Cache löschen möchten?")) {
			for (k in store) {
				if (/^sfx_/.test(k)) {
					store.removeItem(k);
				}
		...
		if (error_container && error_list.length>0) {
			for (var i=0; i<error_list.length; i++) {
				...
				if (o.onclick) {
					...
					props.title = "klicken um den error zu löschen";
				}
	...
	if (typeof unsafeWindow.sfx=="undefined") {
		...
		var main = (function() { 
			try { // GLOBAL WRAPPER
				...
				log("[Social Fixer German]","running");
				log("runat",runat);
    ...
    return undef;
				...
				function get_remote_content(type,func,ref,force_refresh) {
					...
					//								add_error("No response received for remote content: "+type);
											...
											add_error('Es ist ein Fehler in der aufgerufenen Datei aufgetreten unter der URL: <a href="'+url+'">'+url+'</a>. Der Fehler lautet:<br>'+e.toString());
										}
									}
...
<div id="bfb_option_container">
	<div id="bfb_options_tab_list" class="tab_list">
		<div class="bfb_tab_selector bfb_tab_search">Suche: <input onfocus="this.select();" style="width:100px;" id="bfb_options_search" title="Type in text to find options"></div>
		<div class="bfb_tab_selector" rel="tab_popular">Wichtige Einstellungen</div>
		<div class="bfb_tab_selector" rel="tab_layout">Layout</div>
		<div class="bfb_tab_selector" rel="tab_posts">Beiträge</div>
		<div class="bfb_tab_selector" rel="tab_display">Anzeige</div>
		<div class="bfb_tab_selector" rel="tab_timeline">Timeline</div>
		<div class="bfb_tab_selector" rel="tab_hidden">versteckte Objekte</div>
		<div class="bfb_tab_selector" rel="tab_chat">Chat</div>
		<div class="bfb_tab_selector" rel="tab_theme">Theme</div>
		<div class="bfb_tab_selector" rel="tab_filtering">Filter</div>
		<div class="bfb_tab_selector" rel="tab_advanced">erweiterte Einstellungen</div>
		<div class="bfb_tab_selector" rel="tab_css">Styles (CSS)</div>
		<div class="bfb_tab_selector" rel="tab_user_prefs">Benutzer Scripte</div>
		<div class="bfb_tab_selector" rel="tab_about">Über Social Fixer German</div>
	</div>
	<div id="bfb_options_content" class="content">

		<div class="option tab_popular">
			<div class="desc">
				Starten Sie den <a id="bfb_guided_setup" style="text-decoration:underline;" href="#" onclick="return false;">Setup Wizard</a> um das Anfangs-Setup zu wiederholen
			</div>
		</div>
		<div class="option tab_popular" tooltip-alignh="right" data-hover="tooltip" title="Mit dieser Funktion können Sie, wenn Sie über Thumbnail-Bilder mit der Maus fahren, diese vergrößert sehen.">
			<div class="desc">
				%show_image_previews% Zeige Thumbnail-Bilder in Groß
			</div>
		</div>
		<div class="option tab_popular" tooltip-alignh="right" data-hover="tooltip" title="Facebook zeigt gerne Werbung als fenster an, die sogenannten &quot;Trending Articles&quot; oder &quot;Trending Videos&quot;. Dies können Sie hier deaktivieren. ">
			<div class="desc">
				%hide_trending_articles% Verstecke "Trending Articles" und "Trending Videos"
			</div>
		</div>
		<div class="option tab_popular" tooltip-alignh="right" data-hover="tooltip" title="Im Februar 2010 führte Facebook die Funktion der LightBox hinzu, damit steht die Funktion der Dia-Show zur verfügung.">
			<div class="desc">
				%disable_theater_view% Deaktiviere "Lightbox" (aka "Theater")
			</div>
		</div>
		<div class="option tab_popular" tooltip-alignh="right" data-hover="tooltip" title="Bei öfteren benutzen von Anwendungen, kann Social Fixer German diese Pinnwandeinträge inter in einem neuen Tab anzeigen.">
			<div class="desc">
				%tab_all_apps% Automatisches sorrtieren von Apps auf der Pinnwand
			</div>
		</div>
		<div class="option tab_popular" tooltip-alignh="right" data-hover="tooltip" title="Facebook änderte im Jahr 2010 seine Standart Schriftart von 13px auf 12px. Viele Anwender fanden die neue Schriftgröße zu klein, dies können Sie hier nun an Ihre bedürfnisse anpassen.">
			<div class="desc">
				%enable_font_size% Schriftgröße auf %post_font_size%px für Beiträge ändern und %comment_font_size%px für Kommentare</div>
		</div>
		<div class="option tab_popular" tooltip-alignh="right" data-hover="tooltip" title="Standartmäßig wird bei Kommentaren mit der drücken der ENTER Taste der Kommentar abgeschickt, mit dieser Funktion können Sie aber die alte Funktion der Taste wiederbeleben. Abschicken können Sie dann Ihren Kommentar über einen neuen Link, welche hinzugefügt wird.">
			<div class="desc">
				%fix_comments% Ändere die Funktion der "Enter-Taste" zum Zeilen umbruch in Kommentaren und füge einen neuen Button hinzu um den Kommentar abzuschicken</div>
		</div>
		
		<div class="option tab_popular" tooltip-alignh="right" data-hover="tooltip" title="Mit dieser Funktion können sie den oberen blauen Balken fixieren, um in nicht mit scrollen zulassen.">
			<div class="desc">
				%lock_header% Oberen blauen Balken fixieren und nicht mitscrollen lassen. (Funktion hat noch Probleme)
			</div>
		</div>

		<div class="option tab_popular" tooltip-alignh="right" data-hover="tooltip" title="Facebook hat eine integrierte Funktion, welche die News-Feeds chronologisch sorrtieren soll, dies funktioniert aber nicht immer. Mit dieser Funktion beheben Sie den Fehler.">
			<div class="desc">
				%auto_switch_to_recent_stories% schalte auf News-Feed um alle Beiträge chronologisch zu sorrtieren %auto_switch_to_recent_stories_show_message% (Meldung anzeigen wenn aktivviert)
			</div>
		</div>
		<div class="option tab_popular" tooltip-alignh="right" data-hover="tooltip" title="Wenn Sie diese Funktion aktiviert haben, fügt Social Fixer German bei jedem Kommentar einen Antwort-Link hinzu. Das vereinfacht bei verschiedenen Autoren, die Antworten Übersichtlicher zu machen.">
			<div class="desc">
				%comment_reply% Füge "Antworten" link zu Kommentaren und %comment_reply_float_textarea% zeige Antwort Box über den Kommentar. %comment_reply_tag% Makiere den User welchen Sie beantwortet haben.
			</div>
		</div>
		<div class="option tab_popular" tooltip-alignh="right" data-hover="tooltip" title="Standart mäßig zeigt Facebook maximal 15 Beiträge an, welche Sie mit klichen auf &quot;Ältere Post&quot; erweitern können. Mit dieser Funktion geschiet dies automatisch, so verpassen Sie nichts.">
			<div class="desc">
				%auto_click_older_posts% Automatisch auf "ältere Beiträge" klicken bei %auto_click_more_times% weiteren Beiträgen
			</div>
		</div>
		<div class="option tab_popular" tooltip-alignh="right" data-hover="tooltip" title="Wenn Freune/Seiten in kürzester Zeit viele Beiträge schreiben, dann zeigt Facebook nur den ersten an, erweiternt kann man dies durch klicken auf &quot;ähnliche Beiträge&quot;. Mit dieser Funktion können Sie dies automatisiseren.">
			<div class="desc">
				%expand_similar_posts% Automatisch ähnliche Beiträge anzeigen
			</div>
		</div>
		<div class="option tab_popular" tooltip-alignh="right" data-hover="tooltip" title="Freunde wechseln oft Ihre Profil-Bilder, so kann es schwierig sein zu sagen wer wer ist. Mit dieser funktion ersetzen Sie die Bilder mit deren Namen.">
			<div class="desc">
				%chat_images_to_names% Tausche kleine Profilbilder durch deren Namen aus
			</div>
		</div>
		...
		<div class="option tab_layout tab_layout">
			...
			Add quick links to left navigation: 
				...
				%show_nav_write_a_note% Write A Note 
				%show_nav_pages_i_admin% Pages I Admin 
				%show_nav_unblock_applications% Unblock Applications 
		</div>
		
		<div class="option tab_layout">
			Hide :
				%hide_left_nav_groups% Groups (%hide_left_nav_groups_create% Create Group)
				%hide_left_nav_lists% Lists 
				%hide_left_nav_pages% Pages
				%hide_left_nav_apps% Apps
				%hide_left_nav_interests% Interests
				%hide_chat_panel% Chat
				%hide_status_updater% My name and picture
		</div>
		...
		<div class="option tab_layout">
			...
			Auto-expand left panel sections:
				%expand_nav_messages2% Messages
				%expand_nav_events% Events
				%expand_nav_photos% Photos
				%expand_nav_apps% Apps
				%expand_nav_friends% Friends
				%expand_nav_friends_full% All friend groups
		</div>
		...
		<div class="option tab_posts">
			<help>The Facebook anti-spam feature often gives false positives and marks comments as spam when they are not. If you manage a Page that gets a lot of comments, it can be a lot of work to unmark posts as spam. Facebook has introduced a "Not Spam" link on comments to quickly mark them as not spam. Enabling this feature will automatically click all these links. If any comments really are spam, you will need to mark them manually.</help>
			%auto_unspam_comments% Automatically click the "Not Spam" link on comments marked as SPAM
		</div>
		<div class="option tab_posts">
		...
		<div class="option tab_posts">%process_recent_activity% Add post icons to "Recent Activity" posts so they can be marked read individually</div>
		<div class="option tab_posts">%expand_see_more% Auto-expand "see more" links in posts and comments to show the full content</div>
		<div class="option tab_posts">
		...
		<div class="option tab_posts">%hide_old_comments% Hide old (read) comments when new comments are found on a post</div>
		...
		<div class="option tab_display">%remove_recent_activity% Add a "remove all activity" link to <b>RECENT ACTIVITY</b> blocks
			<div>
...
<!-- -->
		...
		<div class="option tab_advanced">%reorder_tabbed% Reorder posts that are tabbed to force chronological order in tabs</div>
		...
		<div class="option tab_advanced">%messaging_fix_reply_tab_index% When Replying to messages, fix tabbing so Tab-&gt;Enter will Reply</div>
...
-->
		...
		<div class="option tab_chat">
			<help></help>
			%chat_hide_timeline_icon% Hide the "View Timeline" button shown when hovering over friends in Chat
		</div>
		<div class="option tab_chat">
	...
	<br style="clear:both;">
						...
						'						<input type="button" name="GM_options_save" id="GM_options_save" value="Sichern">		\n'+
						'						<input type="button" name="GM_options_cancel" id="GM_options_cancel" value="Abrechen">\n'+
						'					</div>		\n'+
						...
						'					<div class="bfb_options_minimized_hide"><div style="float:left;margin-right:100px;"><span id="bfb_options_title">Social Fixer German</span><br><i>Version '+version+'</i></div><span>Official Site: <b><a href="http://www.facebook.com/SocialFixerGermanPatch" target="_blank">/SocialFixerGermanPatch</a></b></span><br><br>Was ist neu? Schau hier nach: <b><a href="http://www.facebook.com/SocialFixerGermanPatch" target="_blank">/SocialFixerGermanPatch</a></b></div>'+
						'				</div>		\n'+
				...
				//		a('show_nav_edit_friends','checkbox',true );
						...
						a('hide_left_nav_lists','checkbox',false);
						a('hide_left_nav_apps','checkbox',false);
						a('hide_left_nav_pages','checkbox',false);
						a('hide_left_nav_interests','checkbox',false);
						...
						a('chat_hide_timeline_icon','checkbox',false);
						...
						a('messaging_fix_reply_tab_index','checkbox',true);
						...
						a('auto_unspam_comments','checkbox',false);
...
*/
	...
	.bfb_chat_ordered_list .item .status { float:right !important; }
	.bfb_chat_ordered_list .item .name { max-width:135px; overflow:hidden; float:left; }
	...
	html.hide_left_nav_lists #listsNav {display:none !important;}
	html.hide_left_nav_interests #interestsNav {display:none !important;}
	...
	html.chat_hide_timeline_icon .fbChatOrderedList .item .timeline_icon { display:none !important; }
	.fbChatOrderedList.compact img.pic { display:none !important; }
	.fbChatOrderedList.compact .name { line-height:normal !important; }
	.fbChatOrderedList.compact .item .icons { height:auto !important; }
...
//						'#fbNotificationsList { max-height:'+(window.innerHeight-100)+'px !important; overflow:auto !important; } '+
					...
					// for the rest of the functionality, so the document exists
						...
						var condition_options = [
							...
							'chat_hide',
							'chat_hide_timeline_icon',
							'hide_left_nav_groups',
							'hide_left_nav_groups_create',
							'hide_left_nav_lists',
							'hide_left_nav_apps',
							'hide_left_nav_pages',
							'hide_left_nav_interests',
							'hide_top_story_indicator',
							'ticker_scroll',
							'lock_header',
						...
						onIdLoad('pageNav',function(nav) {
							if ($('bfb_options_button')==null) {
								...
								if (options.get('disabled')) {
									...
									add_option_item('<b>Social Fixer Options</b>',null,function() { options.displayOptions(); hide_bfb_menu(); return false;  },'top');
									...
									add_option_item('Support and Feedback Page',null,function() { window.open('http://facebook.com/174424289341'); hide_bfb_menu(); return false;  },'top');
						...
						if (maxOlderPostsClickCount>0) {
							...
							onIdLoad('profile_pager',function(){ delayedFindAndClickOlderPosts(4000) });
							...
							try {
								if ( !unsafeWindow.JSCC || !unsafeWindow.AsyncRequest || (hasClass(document.getElementsByTagName("body")[0], 'home') && (!unsafeWindow.UIIntentionalStream || !unsafeWindow.UIIntentionalStream.instance || !unsafeWindow.UIPagelet )) ) {
									...
									if (true) {
										...
										else { if (misfires++<maxmisfires) { delayedFindAndClickOlderPosts(1000); } }
									}
									else {
										delayedFindAndClickOlderPosts(1000);
									}
								}
							} catch(e) { if (misfires++<maxmisfires) { delayedFindAndClickOlderPosts(1000); } }
						}
						...
						bind(document,"DOMNodeInserted", function (e) {
							...
							if (!$('better_fb_cp')) {
								...
								if (options.get('cp_button_mark_all_read')) { append(cp, button('Alles gelesen',markAllRead,'better_fb_mark_read') ); }
								if (options.get('cp_button_show_hide_all')) { append(cp, button('Alles anzeigen',toggle_show_all,'better_fb_show_hide_all') ); }
								if (options.get('cp_button_mute_all')) { append(cp, button('Alles Muten',mute_all,'better_fb_mute_all') ); }
								if (options.get('cp_button_reload')) { append(cp, button('Aktualisieren',reload,'better_fb_reload') ); }
								if (options.get('cp_button_undo')) { append(cp, button('Zurück',undo,'') ); }
								...
								tabCountTimers[tab_id] = setTimeout( function() { 
									...
									for (var i=0; i<L; i++) {
										...
										if (!hasClass(o,"bfb_duplicate") && !hasClass(o,'sfx_trending_articles') && !hasClass(o,'UIRecentActivity_Stream')) {
											total++;
											if (!hasClass(o,'bfb_hidden') && !hasClass(o,'sfx_trending_articles')&& (!hasClass(o,'bfb_read') || hasClass(o,'bfb_new_comments'))) {
												c++;
											}
										}
									}
						...
						function fixStory(o,isPageOrProfile,isGroupWall) {
							...
							if (!process_recent_activity && (hasClass(o,"UIRecentActivity_Stream") || hasClass(o,"uiStreamMinistory") || hasClass(o,"UIRecentActivityStory"))) {return; } // Don't process recent activity posts
							...
							if (hide_sponsored) {
								var sponsored = QS(o,'.uiStreamAdditionalLogging a[href="/help/sponsored-stories"]');
								if (sponsored) {
				...
				//			insertFirst(o,el('div',null,null,null,fbid,{'backgroundColor':'#ddd'}));
					...
					//					update_status('bfb_status_expanded',++count_expanded);
							...
							if (false) { //(!isGroupWall && (reorder || (tabbed && reorder_tabbed))) {
								var reorder_debug = "";
								...
								if (!post_time) {
									QS(o,'.timestamp,.livetimestamp,.bfb_timestamp',function(timestamp) {
										try { 
											if (timestamp.getAttribute('data-date')) {
												post_time = (((new Date(timestamp.getAttribute('data-date'))).getTime())*10000) + (post_counter++);
											}
											else if (timestamp.getAttribute('data-utime')) {
												post_time = timestamp.getAttribute('data-utime')*10000000 + (post_counter++);
											}
								...
								// Only continue with reordering if a timestamp was found
								if (post_time) {
									...
									reorder_debug += "<b>Not re-ordered because timestamp could not be found</b>\n";
									post_debug(fbid,reorder_debug);
								}
							}
				...
				//						window.open('https://getpocket.com/save?url='+url+'&title='+title,'SocialFixerSaver','height=500&width=500');
						...
						function fix_timestamps(o) {
							QSA(o,'abbr[data-utime][title]',function(a){ 
								...
								if (a.innerHTML.indexOf("ago")>0) {
									try {
										var now = new Date();
										var d = new Date(a.getAttribute('data-utime')*1000);
																...
																fetch_content_in_iframe(url,'content',function(content) {
																	...
																	if (content) {
																		...
																		if (img) {
																			...
																			preview_html += '<img class="bfb_notif_photo_preview" src="'+img.src+'" style="max-height:'+(window.innerHeight-50)+'px;">';
																		}
																		if (comments) {
					...
					//					}
						...
						function better_fb_options(tab_id) {
							...
							onIdLoad('profile_stream_composer',function(composer) {
								if ($('bfb_page_post_message')==null) {
									...
									var insert_message = function() {
										...
										if (!page_id) {
											page_id = QS(document,'input[data-profileid]','data-profileid');
										}
										...
										if (page_id && (page_id=="174424289341" || page_id=="119314224763738")) { // SFX, SFX Dev
											get_config_data('page_message',function(messages) {
												if (messages[page_id] && !($('bfb_page_post_message'))) {
													var insertPoint = QS(composer,'.showOnceInteracted');
													insertAfter( el('div','bfb_page_post_message showOnceInteracted',{id:'bfb_page_post_message'},null,messages[page_id]), insertPoint );
												}
											});
										}
									};
								...
								bind(document,'keydown',function(e) { 
									...
									if (t && t.tagName && t.tagName=="TEXTAREA" && t.name && t.name=="add_comment_text_text") {
										...
										if (container) {
											...
											if (!button) {
												button = el('div','sfx_comment_button',null,{'click':function(){alert("Social Fixer Message: You must press Tab-Enter to submit a comment, not click the button. I know this is not ideal, but right now it's the only way I can figure out to restore the Enter=Newline functionality. I'm still working on it. If you don't like Tab>Enter, you can disable it in Options.")}},default_text);
							...
							(function() {
								var float_textarea = false;//options.get('comment_reply_float_textarea');
...
//													ta.value = ta.value+prefix+text;
								...
								onSelectorLoad('.commentActions,.UFICommentActions',function(ca) { 
									if (!QS(ca,'.bfb_reply_link')) {
										...
										var reply = el('a','bfb_reply_link',null,{click:do_reply},'Antworten');
										append(ca,reply);
									}
								},"both");
							})();
						...
						if (options.get('undo_ctrl_z')) {
							...
							var a = el('a',null,{href:'#',title:'Change the screen to anonymize all users (for screenshots, etc)',id:'bfb_anonymize_screen'},{
								click:function() { 
									...
									QSA(document,'.actorName a,a.actorName,a.ego_title,span.blueName,a.passiveName,.fbxWelcomeBoxName,*[data-hovercard*="user"],a[href*="/profile.php"],#navAccountName,.headerTinymanName',function(o) {
										if (QS(o,'img')){return;}
										var c = o.innerHTML;
						...
						function make_hideable(selector,friendly_name,pref,inverse,frame_element,top,left) {
								...
								if (options.get('chat_show_all_online')) {
									...
									var render_chat_item = function(id) {
										...
										if (uinfo) {
											...
											var h = _template( ((<><![CDATA[
												<a style="%1%" class="clearfix" href="#" onclick="Chat.openTab('%2%','%3%','friend');return false;" rel="ignore">
													<img class="pic" src="%4%"/>
													<div class="icons">
											    		<img width="1" height="1" alt="" src="http://static.ak.fbcdn.net/rsrc.php/v2/y4/r/-PAXP-deijE.gif" class="lb_status icon img">
											    		<img onclick="window.open('%6%');return false;" width="1" height="1" alt="" src="http://static.ak.fbcdn.net/rsrc.php/v2/y4/r/-PAXP-deijE.gif" class="timeline_icon icon img" data-hover="tooltip" title="View Timeline" tabindex="0">
											    		<img width="1" height="1" alt="" src="http://static.ak.fbcdn.net/rsrc.php/v2/y4/r/-PAXP-deijE.gif" class="status icon img">
											    		</div>
													<div class="name">%5%</div>
												</a>
											]]></>).toString()), style, id, uinfo.name, uinfo.thumbSrc, displayName, uinfo.uri);

		//									var h = '<a style="'+style+'" class="clearfix" href="#" onclick="Chat.openTab('+id+',\''+uinfo.name+'\',\'friend\');return false;" rel="ignore"><img class="pic" src="'+uinfo.thumbSrc+'"/><span class="name">'+displayName+'</span><i class="status img sp_3xd8gf sx_94f6be"></i></a>';
											log("[chat]","Rendering",uinfo,status);
											return el('li','item '+status,null,null,h);
										}
										return null;
									};
				...
				*/
						...
						/* When writing a message reply, hitting "tab->enter" won't send because
						   the tabIndex is wrong on components */
						if (options.get('messaging_fix_reply_tab_index')) {
							onSelectorLoad('textarea.MessagingComposerBody',function(o){o.tabIndex=10;});
							onSelectorLoad('#MessagingSendReplyButton input',function(o){o.tabIndex=20;});
						}
