// ==UserScript==
// @name           Koc auto recolectador de regalos para anwyn263 
// @version        0.1
// @namespace      KOCQuickWidgets-AutoAcceptGifts
// @homepage       http://userscripts.org/
// @description    Este script automáticamente acepta todos tus regalos de kingdoms of camelot. Usar con  Facebook Gift Link Creator http://userscripts.org/scripts/show/84328
				...
				if(claim_gift){
					...
					if(domain_selector && (next_button1 || next_button2)){
						for(var i=0; i<domain_selector.options.length; i++){
							if(domain_selector.options[i].value == "263"){
