// ==UserScript==
// @name           Pestaña Gamers Pro - Taringa!
// @namespace      aguantelrojo - Taringa!
// @description    Gracias a este Script tendremos un Acceso rapido a la Comu!
// @include        *taringa.net/*
// @exclude        *taringa.net/comunidades/gamerspro/*
// @creator        Gamers Pro ® - Comunidad Gamer! Taringa!
// ==/UserScript==

//////////////////////////////////////////////////////////
//////////////////////////////////////////////////////////
//                                                      //
// NO EDITES ESTO ESTO ES PROPIEDAD DE Gamers Pro ®    //
...
\"http://www.taringa.net/comunidades/gamerspro/\" onclick=\"menu(\'Gamers Pro \', registro_load_form(); return 

false;\" title=\"Ir a Gamers Pro\">Gamers Pro <img src=\n\"http://k07.kn3.net/A7D423532.png\" alt=\"Joystick\" 
...
var estiloCuadrito="width:"+ancho+"px;background-color:white;position:fixed;left:0px;top:0px;border:1px solid 

#40BF00;padding:0px;-moz-border-radius:5px;"
...
function procesarEventos()
{
  if(con.readyState == 4)
  {
    ...
    div.innerHTML="<div style='background-color:#40BF00;color:white;padding:3px;'><b>"+autor+"</b></div><div 

style='padding:3px;'>"+texto+"</div>";                       
  } 
  else 
  {    
    div.innerHTML = '<div align="center"><img src="http://www.rincolnia.com/images/bunchie1.gif" 
...
{
   if(aas[x].getAttribute("href") != null && aas[x].getAttribute("href").indexOf("/posts/")==0 && aas[x].getAttribute

("href").indexOf("/posts/novatos/")!=0)
