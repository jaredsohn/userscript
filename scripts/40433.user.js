// ==UserScript==
// @name            Bar galáctico de nubalo v0.1
// @description     Foro del bar galáctico activado asta que se complete el nuevo
// @autor           henche
// @include         http://juego.nubalo.com/Juego.php?Seccion=Foro_Universo
// ==/UserScript==
function do_platypus_script() {
html_insert_it(window.document,document.evaluate('/HTML[1]/BODY[1]/TABLE[1]/TBODY[1]/TR[2]/TD[2]/DIV[1]/TABLE[1]', document, null, XPathResult.FIRST_ORDERED_NODE_TYPE,null).singleNodeValue,'<iframe src="http://nubalo.buyforum.net/forum.htm" width="610" height="930"></iframe>',false,false);
