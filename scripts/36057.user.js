...
// @name           AVALTools
// @namespace      ikatips
// @description    Herraminetas para la alianza AVALON
...
+ ' <li><h2>AVALON</h2>'
+ '   <ul>'
+ '     <li><center><a target="_blank" href="http://alianzaavalon.4rumer.com/forum.htm" title=" Foro de la Alianza AVALON ">Foro AVALON</a></li>'
