...
//
// --------------------------------------------------------------------
// Also in Zeile 516 steht das hier: function ajax_createVillageList() das ist das mim http request
// hier am anfang in zeile 101 werden die submenus erstellt...
// ab zeile 1225 werden sie den schnellleisten punkten zugeordnent und in die seite eingebunden...
// --------------------------------------------------------------------
// ==UserScript==
...
var my_menu_css = '.my_menu ul {padding: 0; margin: 0; list-style: none; background-color: #F1EBDD; }'+
					'.my_menu li {float: left; position: relative; display: block; padding-right: 10px; background-color: #F1EBDD; height: 20px; }'+
					...
					'.kommentar {font-size: 12px; color: #804000;}';
...
function expandStatueLink(statue_link)
{
	var submenu = document.createElement("ul");
	var paladin = createLinkNode("game.php?"+getUrlParam("village")+"&screen=statue","","Paladin","");
	var waffen = createLinkNode("game.php?"+getUrlParam("village")+"&screen=statue&mode=inventory","","Waffenkammer","");
	submenu.appendChild(paladin);
	submenu.appendChild(waffen);
	statue_link.appendChild(submenu);
	return statue_link;
}
...
function createMenubar()
{
	...
	var vers_platz_link = createLinkNode("game.php?"+getUrlParam("village")+"&screen=place","graphic/buildings/place.png","Truppenplatz","");
	...
	var statue_link = createLinkNode("game.php?"+getUrlParam("village")+"&screen=statue","graphic/unit/unit_knight.png","Statue","");

	//main_link = expandMainLink(main_link);
	
	//Statue-Link erweitern
	statue_link = expandStatueLink(statue_link);
	...
	ulnode.appendChild(statue_link);
