...
// ==UserScript==
// @name           FriendFeed Disqus
// @namespace      http://www.inquisitr.com
// @description    Add Disqus in a tab on FriendFeed 
...
(function() {
  ...
  autoUpdateFromUserscriptsDotOrg({
    name: 'FriendFeed Disqus',
		url: 'http://userscripts.org/scripts/source/27934.user.js',
		version: ffrb_version,
	});

  function Disqus_setup() {
		$('.settings').find('.l_tab:last').after('<td class="l_tab" style="padding-left: 10px;" id="tdtabtm"><div class="rounded bb" id="tabtm"><div class="t"><div class="l"><div class="r"><div class="tl"><div class="tr"><div class="body"><a id="tab-link-Disqus" href="#"><img src="http://media.disqus.com/images/dsq-favicon-16x16.ico"></a></div></div></div></div></div></div></div></td>');
    $('#tab-link-Disqus').click(function() {
			$('#subtabs').hide();
			$('#body').css("height","100%").html('<div class=iframe style="width:100%;height:100%;"><iframe id="content_iframe" marginWidth=0 marginHeight=0 src="http://www.Disqus.com" frameBorder=0 style="width:100%;height:100%;overflow:auto;"></iframe></div>');
