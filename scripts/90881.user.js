...
// @author      Larry The Knight
// @version    	1.15b
// @namespace   NIL
// @description Based on Ooi Keng Siang's Mousehunt AutoBot, this version DOES NOT refresh due to changes to trap check time.
...
function action()
{
	if (isKingReward)
	{
		...
		//Refresh if King's reward is solved from another device
		window.setTimeout(function() { document.location.reload(); } , 3600000);
