...
// ==UserScript==
// @name           Total War
// @description    Shoutbox para alianza TW, incluye cazaparÃ¡sitos de minas y el ally sorter sin puntuaciones
...
unsafeWindow.displayshout = function() {
	if(displayedflag == 0) {
		document.getElementById("shoutframe").innerHTML = '<iframe width="200" border="0" frameborder="0" height="100%" src="http://www4.shoutmix.com/?total_war" style="margin-left:0px;"></iframe>';
		displayedflag = 1;
	}
}
...
document.getElementById("shoutbar").innerHTML ='<div id="shouttab" onclick="showshout()" ondblclick="hideshout()"><a style="height:100%;width:100%;"></a></div>'
	...
	+ '<a style="border-bottom:1px #542C0F dotted; color: #542C0F;" href="http://s10.ikariam.es/index.php?view=allyPage&allyId=119">Total War</a></div>'
...
// @author         Olimpero para la Alianza TW
// @version        15092008 
// ==/UserScript==
...
'{display: block;}';
//esta caracterÃƒÂ­stica es casi estÃƒÂ¡ndar, utilizado en muchos scripts de Greasemonkey
...
+ '     <li><a target="_blank" href="http://alianzatotalwar.es.tl" title=" Total War " align="left">&nbsp;TW</a></li>'
+ '     <li><a target="_blank" href="http://totalwar.foroactivo.net/" title=" Total War - Kappa " align="left">&nbsp;TW Kappa</a></li>'
+'</ul>'
+'</DIV>';

'<div id="menu">'
+ '<ul>'
+ ' <li><h3>FORO Total War</h3>'
+ '   <ul>'
+ '     <li><a target="_blank" href="http://totalwar.foroactivo.net/" title="Foro Total War" align="left">&nbsp;foro TW</a></li>'
...
// @autor          Olimpero
// @email          parajodillo@hotmail.com
// @namespace      Ikariam
// @description    Script que ordena los miembros de la Alianza por puntaje
