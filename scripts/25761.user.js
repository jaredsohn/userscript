// ==UserScript==
// @name          GNN High Resolution (Update #2 Final)
// @namespace     http://totalstranger.gnn.tv, http://namaste_rich.gnn.tv
// @description   For http://gnn.tv - Changes forum/thread/headlines/articles/links/blogs/yard view. Not suitable for resolutions below 1024x768. Created with the help of a Platypus.  Final update by Namaste_Rich 2/3/09.
...
addGlobalStyle('body { background: #000000; background-repeat: no-repeat; color: #ffffff; font-size: 12px; line-height: 12px; } #page_id { clear: both; display: block; width: 745px; height: 80px; margin-bottom: 25px; background-color: #000000; background-image: url(http://i44.photobucket.com/albums/f32/namasterich/bn_01.jpg); background-repeat: no-repeat; opacity:.7;  } a { text-decoration: none !important; color: #5fab4c !important; } a:hover { text-decoration: underline !important;} b { color: #5fabc !important; font-size: 12px !important; } p { color: silver !important; font-size: 15px !important; padding-top: 0px; line-height: 18px !important; } h1 {color: white !important; text-align: left; margin: 0px; padding: 1px; padding-bottom: 15px; padding-top: 0px; font-size: 35px; } h2, h3, h4, h5, h6 { color: #ffffff !important; text-align: center; font-size: 20 px; padding-top: 1px; } #preview { background-color: #001A00 !important; } td { color: white !important; font-size: 13px; line-height: 14px !important; }  h2 { background-color: #153100 !important; } #headline { background-color: #001A00 !important; }  th { text-decoration: underline; color: #699060 !important; font-size: 11px !important; } #date { color: silver !important; } #replies #usr_name { background-color: transparent !important; padding-bottom: 7px; } #replies #usr_image_fl { padding-top: 5px; padding-bottom: 9px; padding-right: 9px; vertical-align: top; width: 0px; } #replies #usr_image_fl img { width: 65px; height: 65px; } #replies #rpl_text {width: 100%; } #site_id {background-color: #001A00 !important; } #rpl_max_dt {background-color: #153100 !important; } .summary {background-color: #001A00 !important; } .desc {color: white !important; } #_created_dt {background-color: black; } #art_headline {background-color: black; } #usr_name {background-color: black; } #desc {color: #2a6630 !important; font-style: italic !important; } #posted {color: silver !important; }  #body p { width: 720px !important; } #summary { background-image: none !important; background-color: #001A00 !important; border-color: #840215 !important } #posted_by { background-color: #001A00 !important; height: 140px !important; } #th #cat_title {background-color: #001A00 !important; } #th #thr_cnt {background-color: #001A00 !important; } #ad-bg img { display: none; } #yard_pub {height: 140px !important; } #lnk { height: 70px; background-color: black; } .element input { margin-top: 15px !important ; margin-bottom: 15px !important ; width: 400px !important ; height: 15px !important ; line-height: 17px !important ; } textarea { height: 320px !important ; width: 730px !important ; } select { margin-top: 15px !important ; margin-bottom: 15px !important ; width: 120px !important ; } .optional { border-left: 7px solid #001A00 !important; } .submit {border-left: 7px solid #001A00 !important; } #edit_reply textarea { width: 400px !important; } #ad-store { display: none; } #ad-true_lies { display: none } #site_info { display: none; } #left #menu {background-color: black; position: absolute; top: 475px !important; } #left #menu:hover {background-color: #001A00; position: absolute; top: 475px !important; } #left #google {position: absolute; top: 435px; background-color: maroon; opacity:.5} #left #google:hover {position: absolute; top: 435px; background-color: maroon; opacity:1} #control #user a {color: red !important; font-size: 12px;}  #related { background-color: #001A00 !important; border-color: #840215 !important; width: 745px; padding: 0px !important; } #asset_content { background-color: #001A00 !important; } #page_id h1 {font-size: 25px; opacity: 0.5; } #byline { color: #648464; background-color: #001A00 !important; font-weight: bold !important; } ul li { color: white !important; font-size: 15px !important; line-height: 15px;} .byline_article { font-weight: bold !important; font-size: 18px !important ;} #replies #rpl_text div {width: 630px !important; overflow: visible !important; } #replies #rpl_text p {width: 620px; overflow: visible !important;} blockquote p { font-style: italic !important; display: table !important; background-color: #001A00 !important; color: beige !important } blockquote p em {font-variant: small-caps; } #body {color: silver;} #wrapper #framework #content #pagination #pages { position: fixed;  top: 0px; right: 10px; font-size: 14px; color: red; background-color: black; opacity: .8; z-index: 1 !important;} #content #pagination a {color: #0cff00 !important; text-decoration: underline !important ; } #header h1 { font-size: 16px; position: absolute; top: 0px; left: 215px; width: 700px; overflow: visible; opacity: 0.8;} #replies tr.break { background-color: #004426; background-repeat: no-repeat; height: 3px; } #post a {color: #0cff00 !important; font-size: 9px; opacity: 0.8;} #post {width: 735px; text-align: center !important;} #wrapper #framework #content #trail {font-size: 20px; position: absolute; top: 61px; left: 323px ; color: white; opacity: 0.4;} #wrapper #framework #content #trail img {background-color: white;} #wrapper #framework #content #pagination {width: 750px; } #control #yard img { height: 70px;} #control #user { background-color: #001A00 ; opacity: .5 ;position: absolute !important; top: 2px !important; } #control { position: absolute; top: 105px; background-repeat: no-repeat; } #control .headerimg {visibility: hidden; height: 0px; }#wrapper #control #user #info {position: absolute; left: 80px; } body, h1, h2, h3, h4, li, td, th, p, textarea {font-family: "Tahoma" !important;} #right_site_info {visibility: hidden; height: 10px;} #right_ads {display: none;} #ad-rev {display: none;} #ab_banner {display: none;} #adspotBox {display:none;}#control {background-color: transparent; opacity:.3}#control:hover {background-color: transparent; opacity:1} #menu {opacity:.3} #menu:hover {opacity:1;} #thr_title:hover {background-color: #001A00;}');