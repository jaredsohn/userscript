...
//------------------------------  SBI DEBIT CARD --------------------------
		...
		if(urlst.indexOf('infinity.icicibank.co.in')!=-1)
			...
			var form1 = document.forms.namedItem('SignOn');
                if (form1) 
				{
				form1.elements.namedItem('CorporateSignonCorpId').value='-----';
				form1.elements.namedItem('CorporateSignonPassword').value='-----';
				}
				var form2 = document.forms.namedItem('frm');
				if(form2){
					form2.elements.namedItem('ValCorpTxnPwdTxnPwd').value='NA';
		...
		if(sbiform1){
			sbiform1.elements.namedItem('username').value='-----';
			sbiform1.elements.namedItem('password').value='-----';
