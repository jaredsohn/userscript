// ==UserScript==
// @name           JHunz's KOL Hippy/Fratboy Counter Pro + Last Update
				...
				for (var i=0;i<textnodes.snapshotLength;i++) {
					...
					if (s.length > 90) {
						...
						if (side == 'fratboys') {
							...
							if (s.match('karmic retribution!') || s.match('^You see a Green G') || s.match('^Elsewhere') || s.match('^You see a Wartender p') || s.match('^You see a Fire Spinner') || s.match('^Nearby, you see o') || s.match('^You see a member of the fr') || s.match('^You glance over your shoulder') || s.match('^You see a hippy shaman') || s.match('^You see a frat boy warrior p') || s.match('^You see an F\.R\.O\.G\.')) {
								delta = 2;
							}
