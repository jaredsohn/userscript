...
// @name		eRepBar FR
// @version		0.1
// @description		Compilation d'outils pour eRepublik
// @author		eCitizen pi_wo
// @traductor		Chtitbeau
...
function getCmData(companyId){
	...
	if(companyId == erbCompanyData['id']){
		...
		$("#erbCMcompanyName").html("Compagnie " + erbCompanyData['name']);
...
function eRepBarCompanyManagement(){
	...
	var eRepBarCompanyManagement = 	'<h3 id="erbCompanyName"><div id="erbCMcompanyName">Gestion de compagnie</div><div class="executeButton" style="font-size: 12px; margin-left: 5px; position: relative; top: -20px;" id="CMsaveWages">Sauvegarde salaires</div></h3>' +
								'<div id="eRepBarCmFilters">' +
									'<div style="width: 740px; float: left;">' + 
										'<div class="inputdesc" style="width: 90px; padding-left: 10px;">Compagnie ID</div><div class="input_holder"><input id="erbInputCompanyId" class="inputtext" style="width: 50px" value="' + lastCompany + '"></div><div class="inputholder_end"></div>' +
										'<div class="executeButtonSmall" id="erbLoadCmData">Charger</div>' +
										'<div class="inputdesc" style="width: 55px; padding-left: 10px;">Local <img src="/images/parts/icon-gold.gif"/> </div><div class="input_holder"><input id="erbInputGoldLoc" class="inputtext" style="width: 50px" value="' + exchangeRate + '"></div><div class="inputholder_end"></div>' + 
										'<div class="inputdesc" style="width: 90px; padding-left: 10px;">Prix de vente local</div><div class="input_holder"><input id="erbInputSellPrice" class="inputtext" style="width: 50px" value="' + sellPrice + '"></div><div class="inputholder_end"></div>' +
										'<div class="inputdesc" style="width: 65px; padding-left: 20px;">VAT (%) </div><div class="input_holder"><input id="erbInputVAT" class="inputtext" style="width: 50px" value="' + valueAddedTax + '"></div><div class="inputholder_end"></div>' +
									'</div>' +
									'<div style="width: 740px; float: left;">' + 
										'<div class="inputdesc" style="width: 90px; padding-left: 10px;">Qualité</div><div class="input_holder" style="width: 45px">' +
										...
										'<div class="inputdesc" style="width: 60px; padding-left: 10px;">Industrie</div><div class="input_holder" style="width: 150px">' +
										'<select class="inputselect" id="erbInputIndustryType"><option value="">arme</option><option value="">nourriture</option><option value="">cadeau</option><option value="">ticket de transport</option><option value="">grain</option><option value="">diamant</option><option value="">fer</option><option value="">pétrol</option><option value="">bois</option><option value="">maison</option><option value="">système de défense</option><option value="">hopital</option></select>' +							
										'</div><div class="inputholder_end"></div>' +
										'<div class="inputdesc" style="width: 90px; padding-left: 20px;">Ressources</div><div class="input_holder" style="width: 69px">' +
										'<select class="inputselect" id="erbInputRawMaterials"><option value="high">Haut</option><option value="med">Moyen</option><option value="low">Bas</option></select>' +							
										'</div><div class="inputholder_end"></div>' +
										'<div class="inputdesc" style="width: 65px; padding-left: 10px;">Prix HT <img src="/images/parts/icon-gold.gif"/></div><div class="input_holder"><input id="erbInputRawPrice" class="inputtext" style="width: 50px" value="' + rawPrice + '"></div><div class="inputholder_end"></div>' +
									'</div>' +
								'</div>' +
								'<div style="clear: both">' +
									'<table style="width: 750px;" id="erbCmTable"><tbody>' +
										'<tr class="erbCmTableHead"><td style="width: 20px"></td><td style="width: 20px"></td><td style="width: 180px; text-align: left;">Employé</td><td style="width: 70px">Comprétence</td><td style="width: 90px">Salaire</td><td style="width: 90px">Santé</td><td style="width: 90px">Productivité</td><td style="width: 90px">W/P Ratio</td><td style="width: 90px">Profit <img src="/images/parts/icon-gold.gif"/></td></tr>' +
										'<tr style="border: 0px; font-weight: bold;" id="CM_LastRow"><td colspan="3"><div id="erbCmAddNewEmployee" class="CMaddEmployeeButton"></div>Ajouter un nouvel Employé</td><td></td><td id="CM_TotalWage"></td><td></td><td id="CM_TotalProductivity"></td><td></td><td id="CM_TotalProfit"></td></tr>' +
									'</tbody></table>' +
								'</div>';
...
function eRepBarProductivity(){
	...
	var eRepBarProductivity = 	'<h3>Calcul de productivité</h3>' +
								'<div id="eRepBarProductivityStats">' +
									'<div><div class="inputdesc">Nom du Citoyen:</div><div class="input_holder"><input id="erbInputCitizenName" class="inputtext" style="width: 100px" value="' + $(".nameholder a").html() + '"></div><div class="inputholder_end"></div><div class="executeButtonSmall" id="erbLoadProductivityData">Charger</div></div>' +
									'<div><div class="inputdesc" style="clear: both">Santé:</div><div class="input_holder"><input id="erbInputCurrentWellness" class="inputtext" style="width: 50px" value="' + $("#wellnessvalue").html() + '"></div><div class="inputholder_end"></div></div>' +
									'<div><div class="inputdesc" style="clear: both">Compétence:</div><div class="input_holder"><input id="erbInputSkill" class="inputtext" style="width: 50px" value="0.0"></div><div class="inputholder_end"></div></div>' +
									'<div><div class="inputdesc" style="clear: both">Qualité de la compagnie:</div><div class="input_holder" style="width: 45px">' +
									...
									'<div><div class="inputdesc" style="clear: both">Type de compagnie:</div><div class="input_holder" style="width: 162px">' +
									'<select class="inputselect" id="erbInputCompanyType"><option value="manu">Fabrication</option><option value="land">Ressources naturelles</option><option value="cons">Bâtiment</option></select>' +							
									'</div><div class="inputholder_end"></div></div>' +
									'<div><div class="inputdesc" style="clear: both">Nombre d\'employés:</div><div class="input_holder"><input id="erbInputNoEmployees" class="inputtext" style="width: 50px" value="0"></div><div class="inputholder_end"></div></div>' +
									'<div><div class="inputdesc" style="clear: both">Ressource:</div><div class="input_holder" style="width: 84px">' +
									'<select class="inputselect" id="erbInputRawMaterials"><option value="high">Haute</option><option value="med">Moyenne</option><option value="low">Faible</option></select>' +							
									'</div><div class="inputholder_end"></div></div>' +
								'</div>' +
								'<div id="eRepBarProductivityResults">' +
									'<h2 class="special" style="padding-bottom: 20px;">Productivité:</h2>' +
...
function eRepBarDamage(){
	...
	var eRepBarDamage = 	'<h3>Calcul des dommages</h3>' +
							'<div id="eRepBarDamageStats">' +
								'<div><div class="inputdesc">Nom du citoyen:</div><div class="input_holder"><input id="erbInputCitizenName" class="inputtext" style="width: 100px" value="' + $(".nameholder a").html() + '"></div><div class="inputholder_end"></div><div class="executeButtonSmall" id="erbLoadDamageData">Charger</div></div>' +
								'<div><div class="inputdesc" style="clear: both">Santé:</div><div class="input_holder"><input id="erbInputCurrentWellness" class="inputtext" style="width: 50px" value="' + $("#wellnessvalue").html() + '"></div><div class="inputholder_end"></div></div>' +
								'<div><div class="inputdesc" style="clear: both">Force:</div><div class="input_holder"><input id="erbInputStrength" class="inputtext" style="width: 50px" value="0.0"></div><div class="inputholder_end"></div></div>' +
								'<div><div class="inputdesc" style="clear: both">Qualité des armes:</div><div class="input_holder" style="width: 45px">' +
								...
								'</div><div class="inputholder_end"></div></div>' +
								'<div style="clear: both"><fieldset style="border: 1px solid #ccc; margin-bottom: 10px;"><legend style="margin-left: 10px;">Qualité de l\'arme ~ Santé: </legend>' + 
								...
								'</fieldset></div>' +
								'<div><div class="inputdesc" style="clear: both">Rang militaire:</div><div class="input_holder" style="width: 89px">' +
								'<select class="inputselect" id="erbInputMilitaryRank" value="1"><option value="1.2">Soldat</option><option value="1.4">Caporal</option><option value="1.6">Sergent</option><option value="1.8">Lieutenant</option><option value="2.0">Capitaine</option><option value="2.2">Colonel</option><option value="2.4">Général</option><option value="2.6">Maréchal</option></select>' +							
								'</div><div class="inputholder_end"></div></div>' +
							'</div>' +
							'<div id="eRepBarDamageResults">' +
								'<h2 class="special" style="padding-bottom: 20px;">Premier combat:</h2>' +
								'<span class="display-strenght-start">' +
									'<span class="display-strenght-end">' +
								...
								'</span>' +
							'</div>' +
							'<h3>Dommages cumulés</h3>' +
							'<div style="clear: both">' +
								'<table class="offers" style="width: 740px"><tbody>' +
									'<tr><td style="width: 90px">5 Combats</td><td style="width: 90px">6 Combats</td><td style="width: 90px">10 Combats</td><td style="width: 90px">11 Combats</td><td style="width: 90px">20 <img src="/images/parts/icon-gold.gif"/> Tank</td><td style="width: 90px">40 <img src="/images/parts/icon-gold.gif"/> Tank</td><td style="width: 90px">60 <img src="/images/parts/icon-gold.gif"/> Tank</td><td style="width: 90px">80 <img src="/images/parts/icon-gold.gif"/> Tank</td></tr>' +
...
function eRepBarWellness(){
	...
	var eRepBarWellness = 	'<h3>Calcul de santé</h3>' +
							'<div id="eRepBarWellnessStats">' +
								'<div><div class="inputdesc" style="clear: both">Santé actuelle:</div><div class="input_holder"><input id="erbInputCurrentWellness" class="inputtext" style="width: 40px" value="' + $("#wellnessvalue").html() + '"></div><div class="inputholder_end"></div></div>' +
								'<div><div class="inputdesc" style="clear: both">Qualité de la nourriture:</div><div class="input_holder" style="width: 45px">' +
								...
								'</div><div class="inputholder_end"></div></div>' +
								'<div><div class="inputdesc" style="clear: both">Qualité de la maison:</div><div class="input_holder" style="width: 45px">' +
							...
							'<div id="eRepBarWellnessResults">' +
								'<h2 class="special" style="padding-bottom: 10px;">Santé gagné pour demain:</h2>' +
								'<span class="display-strenght-start">' +
									'<span class="display-strenght-end">' +
								...
								'</span>' +
							'</div>' +
							'<h3>Prévisualisation de la santé et du nombre de combats pour les 7 prochain jours</h3>' +
							'<div>' +
								'<div style="float: left;"><div class="inputdesc" style="width: 100px;">Qualité de l\'hopital:</div><div class="input_holder" style="width: 45px">' +
								...
								'</div><div class="inputholder_end"></div></div>' +
								'<div style="float: left;"><div class="inputdesc" style="width: 100px; margin-left: 10px;">Garder la santé*:</div><div class="input_holder" style="width: 66px">' +
								'<select class="inputselect" id="erbInputKeepWellness" value="1"><option value="90">Haute</option><option value="low">Basse</option></select>' +							
								'</div><div class="inputholder_end"></div></div>' +
								'<div style="float: left;"><div class="inputdesc"  style="width: 110px; margin-left: 10px;">Cadeaux Q1/jour:</div><div class="input_holder"><input id="erbInputGifts" class="inputtext" style="width: 50px" value="0"></div><div class="inputholder_end"></div></div>' +
								'<div class="executeButton" id="eRepBarWellnessChartRenderer">Prévisualisation</div>' +
							'</div>' +
							'<div style="color: #808080; font-size: 8px; font-style: italic; clear: both;">* Garder la santé en fin de journée: haute = 90 / basse = 100 - (Qualité de l\'hopital  * 10) - ((Qualité de la nourriture + Qualité de la maison)/1.5)</div>' +
...
function eRepBarPreferences(){
	...
	var eRepBarPreferences = 	'<h3>Options</h3>' +
								'<div style="clear: both;">' +
									'<div><div class="inputdesc" style="width: 120px; text-align: center;">Page de démarrage:</div><div class="input_holder" style="width: 170px">' +
									'<select class="inputselect" id="erbInputStartPage"><option value="about">A propos de eRepBar</option><option value="wellC">Calcul de santé</option><option value="dmgC">Calcul des dommages</option><option value="prodC">Calcul de productivité</option><option value="CM">Gestion de compagnie</option></select>' +							
									'</div><div class="inputholder_end"></div></div>' +
								'</div>' +
								'<h3 style="clear: both;">Options de gestion de compagnie</h3>' +
								'<div style="clear: both;">' +
									'<div><fieldset style="border: 1px solid #ccc; margin-bottom: 10px;"><legend style="margin-left: 10px;">Modèle d\'employers </legend>' +
									'<div><div class="inputdesc" style="width: 40px; margin-left: 10px;">Salaire</div><div class="input_holder"><input id="erbInputPrefWage" class="inputtext" style="width: 40px" value=""></div><div class="inputholder_end"></div></div>' +
									'<div><div class="inputdesc" style="width: 40px; margin-left: 10px;">Santé</div><div class="input_holder"><input id="erbInputPrefWell" class="inputtext" style="width: 40px" value=""></div><div class="inputholder_end"></div></div>' +
									'<div><div class="inputdesc" style="width: 75px; margin-left: 10px;">Compétence</div><div class="input_holder"><input id="erbInputPrefSkil" class="inputtext" style="width: 40px" value=""></div><div class="inputholder_end"></div></div>' +
									'</fieldset></div>' +
								'</div>' +
								'<div style="clear: both;">' +
									'<div class="executeButton" id="eRepBarSavePrefs">Sauvegarder les options</div>' +
								'</div>';
...
function eRepBarAbout(){
	var eRepBarAbout = 	'<h3>Bienvenue sur eRepBar v 0.1!</h3>' +
						'<div style="clear: both;">' +
							'<div>' + 
							'<p style="font-size: 13px"><b>Alors, qu\'est eRepBar exactement?</b></p><br>' +
							'<p>C\'est un regroupement d\'outils, que j\'ai (<a href="http://www.erepublik.com/en/citizen/profile/1467082">pi_wo</a>) développé pour rendre ma e-vie un petit peu plus' +
							' facile et intégré dans l\'interface d\'eRepublik pour être certain que vous puissiez y avoir accès rapidement à chaque fois que vous en aurez besoin.</p><br>' +
							'<p style="font-size: 13px"><b>Caractéristiques de cette v 0.1</b></p><br>' +
							'<ul style="list-style-type:circle; padding-left: 15px;">' +
							'<li>Calcul de santé</li>' +
							'<li>Calcul de productivité</li>' +
							'<li>Calcul des dommages</li>' +
							'<li>Outils de gestion de compagnie</li>' +
							'</ul><br>' +
							'<p style="font-size: 13px"><b>Licence</b></p><br>' +
							'<p>eRepBar est aussi appelé <strong>donaciel</strong>(Donationware). Vous pouvez l\'utiliser sans ne payer quoi que ce soit (vraie ou monnaie virtuelle). <b>Mais</b> si vous l\'aimez, voulez me soutenir dans mes efforts et me motiver à travailler encore plus dur sur ce projet, vous êtes les bienvenue de m\'échanger quelques pièces pour quelques bières:</p>' +
							'<p style="font-size: 16px; font-weight: bold;"><a href="http://www.erepublik.com/en/citizen/profile/1467082"><img src="' + beer_icon + '" align="center">Achetez moi une bière!</a></p>' +
							'<p>Vous êtes également libre de le modifier,mais pour VOTRE PROPRE UTILISATION. Cela veut dire que vous ne pouvez le republier (même sous forme modifiée) sans me consulter et sans mon approbation.</p><br>' +
							'<p style="font-size: 13px"><b>Avertissement</b></p><br>' +
							'<p>Absolument sans guarantie! :)</p><br>'
...
function eRepBarConstruct(){
	...
	var bar = 	'<div id="eRepBar">' +
					...
					'<div class="eRepBarBody"><span style="font-weight: bold; color: #fff;">eRepBar_____________________________________________________________________________________________________traduit par Chtitbeau</span></div>' +
					'<div class="eRepBarRightCorner"></div>' +
				'</div>' +
				'<div id="eRepBarMainContainer">' +
					'<div id="eRepBarButtonContainer">' +
						'<div id="buttonWellness" class="eRepBarButton"><p>Calcul de santé</p></div>' +
						'<div id="buttonDamage" class="eRepBarButton"><p>Calcul des dommages</p></div>' +
						'<div id="buttonProductivity" class="eRepBarButton"><p>Calcul de productivité</p></div>' +
						'<div id="buttonCompanyManagement" class="eRepBarButton"><p>Gestion de compagnie</p></div>' +
						'<div id="buttonPreferences" class="eRepBarButton"><p>Options</p></div>' +
						'<div id="buttonAbout" class="eRepBarButton"><p>A propos d\'eRepBar</p></div>' +
					'</div>' +
	...
	//About eRepBar</option><option value="wellC">Calcul de santé</option><option value="dmgC">Calcul des dommages</option><option value="prodC">Calcul de productivité</option><option value="CM">Gestion de comagnie</option>
	
	page = GM_getValue("eRepBarStartPage");
	
	switch(page){
		case "Calcul des dommages"	: eRepBarDamage(); break;
		case "Calcul de santé"		: eRepBarWellness(); break;
		case "Calcul de productivité"	: eRepBarProductivity(); break;
		case "Gestion de compagnie"	: eRepBarPreferences(); break;
		case "A propos d\'eRepBar"	: eRepBarAbout(); break;
