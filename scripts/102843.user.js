// ==UserScript==
// @name           3gokushi-Beyond　台湾ver
// @namespace      3gokushi-hatt　台湾ver
// @description    台湾ブラウザ三国志用便利機能色々ごった煮 by hatt
...
var VERSION_NAME = "ブラウザ三国志Beyond Ver1.27 by hatt";
...
//	ccreateCheckBox(td3, "OPT_REPORT_NP", OPT_REPORT_NP, "同盟ログ前後表示","同盟ログの詳細に、[前のログ]・[次のログ]を追加します（限定的）",0);
	...
	ccreateCheckBox(td3, "OPT_SMALLBTN_NY", OPT_SMALLBTN_NY, "ヨロズダスボタン無し","本鯖などでヨロズダスがない場合",20);
