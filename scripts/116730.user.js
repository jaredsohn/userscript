...
holder.innerHTML += '<a href="http://i3.photobucket.com/albums/y62/Cratic/List.jpg"' +
 ' title="Hockey Forum" target="_blank">Hockey Status</a>: ';
...
function getNames(){
	...
	{
	    method: 'GET',
	    url: 'http://hockeyscript.angelfire.com/',
	    headers: 
		{
