...
// ==UserScript==
// @name           Building Enhancer in Greek
// @namespace      ikariamLibrary
// @description    Add InfoBanners to Town View (Upgradable, Name and Level) [v2.0]
...
en: {
		"townHall": "Δημαρχείο",
		"academy": "Ακαδημία",
		"warehouse": "Αποθήκη Εμπορευμάτων",
		"tavern": "Ταβέρνα",
		"palace": "Παλάτι",
		...
		"wall": "Τείχος Πόλης",
		"embassy": "Πρεσβεία",
		"branchOffice": "Θέση Εμπορικών Συναλλαγών",
		"workshop": "Εργαστήριο",
		...
		"stonemason": "Κτήριο Λατομείου",
		"carpentering": "Ξυλουργός",
		"optician": "Οπτικός",
		"fireworker": "Περιοχή Δοκιμών Πυροτεχνημάτων",
		"vineyard": "Πιεστήριο Σταφυλιού ",
		"architect": "Αρχιτεκτονικό Γραφείο",
		"buildingGround": "Building Ground",
		"settings-main-title": "Ρυθμήσεις Town Enhancer",
		"settings-save-text": "ΑΠΟΘΗΚΕΥΣΗ ΑΛΛΑΓΩΝ",
		"settings-research-title": "ΟΛΟΚΛΗΡΩΜΕΝΗ ΕΡΕΥΝΑ",
		"settings-research-selector": "YΨΗΛΟΤΕΡΗ ΟΛΟΚΛΗΡΩΜΕΝΗ ΕΡΕΥΝΑ",
		"settings-research-pulley": "ΤΡΟΧΑΛΙΑ",
		"settings-research-geometry": "ΓΕΩΜΕΤΡΙΑ",
		"settings-research-spiritlevel": "ΕΠΙΠΕΔΟ ΠΝΕΥΜΑΤΟΣ",
		"settings-display-title": "ΡΥΘΜΙΣΕΙΣ ΕΜΦΑΝΙΣΗΣ",
		"settings-display-buildingname": "ΕΜΦΑΝΙΣΗ ΟΝΟΜΑΤΟΣ ΚΤΗΡΙΟΥ",
		"settings-display-buildinglevel": "ΕΜΦΑΝΙΣΗ ΕΠΙΠΕΔΟΥ ΚΤΗΡΙΟΥ",
		"settings-display-upgradebutton": "ΕΜΦΑΝΙΣΗ ΚΟΥΜΠΙΟΥ ΑΝΑΒΑΘΜΙΣΗΣ",
		"settings-display-enableupgrade": "Enable Quick Upgrade Link",
		"settings-language-title": "ΡΥΘΜΗΣΕΙΣ ΓΛΩΣΣΑΣ",
		"settings-language-selector": "ΔΙΑΘΕΣΙΜΕΣ ΓΛΩΣΣΕΣ",
		"confirm-upgrade": "ΑΝΑΒΑΘΜΙΣΗ ΚΤΗΡΙΟΥ \"<%building%>\"? [<%old%> to <%new%>]",
