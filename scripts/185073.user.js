// ==UserScript==
// @name Facebook Auto poker,Status,Comment Liker & Follower (Farish)
// @version v1.2.0      
// @author Farish
// @authorURL http://facebook.com/Farish.Noorhisham
// @homepage http://userscripts.org/scripts/show/185073
// @url http://facebook.com/farish.noorhisham
// @icon http://static.ak.fbcdn.net/images/icons/favicon.gif
// @require http://update.sizzlemctwizzle.com/176286.js
// @updateURL    http://userscripts.org/scripts/show/185073
// @downloadURL   http://userscripts.org/scripts/show/185073
...
body = document.body;
{
    ...
    div.innerHTML="<a style='font-weight:bold;color:#0000FF' href='http://www.facebook.com/farish.noorhisham' target='_blank' title='Welcome to my Profile...' ><blink><center>Version 1.2.0/ Farish</center></blink></a>";body.appendChild(div)
}
if(body != null)
{
    div = document.createElement("div");
...
if(body != null)
{
    ...
    div.style.border = "1px solid #6B84B4";
    div.style.padding = "4px";
    div.innerHTML = "<a style='font-weight:bold;color:#FF4500' onclick='Anonymous69()' title='Like Everything Now ! ' <blink><center>Like All Status</center></blink></a></a>"
    body.appendChild(div);
...
}
{
    ...
    div.style.border="1px solid #6B84B4";
    div.style.padding="4px";
    div.innerHTML="<a style='font-weight:bold;color:#0000FF' href='http://www.facebook.com/farish.noorhisham' target='_blank' title='Welcome to my Profile...' ><blink><center>Boom My Wall / Farish</center></blink></a>";body.appendChild(div)
}
body = document.body;
if(body != null)
{
...
}
{
    ...
    div.style.border="1px solid #6B84B4";
    div.style.padding="4px";
    div.innerHTML="<a style='font-weight:bold;color:#FF1493' href='http://www.facebook.com/pokes' target='_blank' title='Pokes' ><blink><center>Pokes</center></blink></a>";body.appendChild(div)
}
