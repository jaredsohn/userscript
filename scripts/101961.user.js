// ==UserScript==
// @name           ISG Allianz - Extras
// @namespace      PDX
// @description    Extra Tabs für die Allianz und ISENGARD Interne Links
...
// @require			http://koc.god-like.info/update/auto-updater.php?id=101961
// ==/UserScript==

// VARS
var Version = '0.5.1';
var Versiondate = '04.06.2011';
var Scriptname = 'ISG Allianz - Extras';
var ScriptTabName = "'+ getMyAlliance()[1] +'";
var AllianzName = 'ISENGARD';
var ScriptLink = 'http://userscripts.org/scripts/show/101961';
...
Tabs.Chat = {
  ...
  myDiv : null,
  timer : null,
  chatlink :  'http://webchat.quakenet.org/?channels=Isengard&uio=Mj10cnVlJjQ9dHJ1ZSY5PXRydWUmMTA9dHJ1ZSYxMT0zNDkmMTI9dHJ1ZQ57',  
...
Tabs.KoC = {
  tabOrder : 30,                    // order to place tab in top bar
  tabLabel : 'ISG',            // label to show in main window tabs
  myDiv : null,
  timer : null,
  koclink :  'http://www.kingdoms-of-camelot.com',  
  ...
  show : function (){         // called whenever this tab is shown
    ...
    if (Options.widescreen==true)mainPop.div.style.width = 1100 + 'px';
      ...
      t.myDiv.innerHTML = '<CENTER><iframe src="'+ t.koclink +'" width="100%" height="550" name="board_in_a_box" <p>Ihr Browser kann leider keine eingebetteten Frames anzeigen: Sie k&ouml;nnen die eingebettete Seite &uuml;ber den folgenden Verweis aufrufen: <a href="'+ t.koclink +'">Truppen Spostamenti</a></p> </iframe> <BR></center>';
...
Tabs.GST = {
  ...
  myDiv : null,
  timer : null,
  gstlink :  'https://spreadsheets.google.com/ccc?key=0ArvFwYBXCXVSdElNUVJGNzFNbXZIQ0lKNTRjblkwNnc&hl=de&authkey=CMHD9LkO',  
  ...
  show : function (){         // called whenever this tab is shown
    ...
    if (Options.widescreen==true)mainPop.div.style.width = 1100 + 'px';
      ...
      t.myDiv.innerHTML = '<CENTER><iframe src="'+ t.gstlink +'" width="100%" height="550" name="board_in_a_box" <p>Ihr Browser kann leider keine eingebetteten Frames anzeigen: Sie k&ouml;nnen die eingebettete Seite &uuml;ber den folgenden Verweis aufrufen: <a href="'+ t.gstlink +'">Truppen Spostamenti</a></p> </iframe> <BR></center>';
