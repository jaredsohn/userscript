// JF Instant Comment //  ID so I know which one I'm looking at
//
// begin credits //
//
// LJ Instant Comment
...
// Modified for JF by nostariel
// 
// ==UserScript==
// @name            JF Instant Comment 
// @namespace      jf_instant_comment
// @description	 Adds "Instant Comment" link besides "Comment on this"
// @copyright     Copyright (c) 2005-2007, Tim Babych (http://clear.com.ua/projects/firefox/instant_comment)
// @license       GPL; http://www.gnu.org/copyleft/gpl.html
// @attribution   Tim Babych (http://clear.com.ua/projects/firefox/instant_comment)
...
function trigger_submit_on_ctrl_enter(e) {
	...
	GM_xmlhttpRequest({
		...
		GM_xmlhttpRequest({
			method: 'POST',
			url: 'http://www.journalfen.net/talkpost_do.bml',
			headers: {
...
/* 
NAME.journalfen.net/123456.html
community.journalfen.net/NAME/123456.html
users.journalfen.net/NAME/123456.html
CURRENT JF URL FORMAT:
journalfen.net/users/NAME/123456.html
journalfen.net/community/NAME/123456.html
*/
get_itemid_regexp = /([\w\d-]+)\.journalfen\.net\/([\w\d]*\/)([\w\d]*\/)?(\d+)\.html/
var allReplies
