...
3 scripts (Buildungs and Menu icons and Fullscreen) from Chezh The West Help Group & TheWest++ 
(Translated for The West.ru)
(Thanks guys for excelent work)

3 скрипта от чехов (Вест на весь экран, иконки зданий города и дополнительные пункты меню)
...
function inv_updateTotalSellPrice (inv)
{
	...
	inv_TotalSellPrice.innerHTML = 'Bcero: $'+total+ ', ogemo: $'+equipworth+ ', B_CyMke: $'+bagworth+'<br>'+ '(npogykmbI: $'+productworth+ ', gpyroe: $'+otherworth+')';
}
