                   // ==UserScript==
// @name           OGame Pantalla de Recursos para XENOM.
// @author         Original Emilio, J.A. y Shuko - Modificado por SPAWN.
// @date           28-11-2007
// @version        1.0
...
//		Cookie recursos:  contiene el valor de los recursos metal, cristal y deuterio, su produccion por hora.
...
if (ResForm) {
	...
	CuentaRec.innerHTML = '<br /><table width="550">'+'<tr><td class="c" colspan="4">Producci&oacute;n extendida</td></tr>'+'<tr>'+'<td class="c">&nbsp;</td>'+'<th>Diaria</th>'+'<th>Semanal</th>'+'<th>Mensual</th>'+'</tr>'+'<tr>'+'<td class="c" width="110"><img src="http://xaflanhipnos37.iespana.es/xenom/metal.png" width="15" style="margin-right:15px;" /><font color="#ffcc00" style="margin-right:15px;font-style:bold;">Metal</font></td>'+'<th><font color="#00ff00">'+formatNmb(XMetal[0])+'</font></th>'+'<th><font color="#00ff00">'+formatNmb(XMetal[1])+'</font></th>'+'<th><font color="#00ff00">'+formatNmb(XMetal[2])+'</font></th>'+'</tr>'+'<tr>'+'<td class="c" width="110"><img src="http://xaflanhipnos37.iespana.es/xenom/cristal.png" width="15" style="margin-right:15px;" /><font color="#019bfc" style="margin-right:15px;font-style:bold;">Cristal</font></td>'+'<th><font color="#00ff00">'+formatNmb(XCristal[0])+'</font></th>'+'<th><font color="#00ff00">'+formatNmb(XCristal[1])+'</font></th>'+'<th><font color="#00ff00">'+formatNmb(XCristal[2])+'</font></th>'+'</tr>'+'<tr>'+'<td class="c" width="110"><img src="http://xaflanhipnos37.iespana.es/xenom/deute.png" width="15" style="margin-right:15px;" /><font color="#00ffb4" style="margin-right:15px;font-style:bold;">Deuterio</font></td>'+'<th><font color="#00ff00">'+formatNmb(XDeut[0])+'</font></th>'+'<th><font color="#00ff00">'+formatNmb(XDeut[1])+'</font></th>'+'<th><font color="#00ff00">'+formatNmb(XDeut[2])+'</font></th>'+'</tr>'+'</table><br />';
...
'</table><br />';
	...
	CuentaRec.innerHTML += '<table width="550">'+'<tr><td class="c" colspan="4">Producci&oacute;n Total de '+(planetas_format.length-1)+' planetas</td></tr><tr><td class="c" width="110" style="text-align:center;">Planetas</td><td class="c" colspan="3">'+planetas_format_final+'</td></tr>'+'<tr>'+'<td class="c">&nbsp;</td>'+'<th>Diaria</th>'+'<th>Semanal</th>'+'<th>Mensual</th>'+'</tr>'+'<tr>'+'<td class="c"><img src="http://xaflanhipnos37.iespana.es/xenom/metal.png" width="15" style="margin-right:15px;" /><font color="#ffcc00" style="margin-right:15px;font-style:bold;">Metal</font></td>'+'<th><font color="#00ff00">'+formatNmb(planetas_recursos_metal*24)+'</font></th>'+'<th><font color="#00ff00">'+formatNmb(planetas_recursos_metal*168)+'</font></th>'+'<th><font color="#00ff00">'+formatNmb(planetas_recursos_metal*720)+'</font></th>'+'</tr>'+'<tr>'+'<td class="c"><img src="http://xaflanhipnos37.iespana.es/xenom/cristal.png" width="15" style="margin-right:15px;" /><font color="#019bfc" style="margin-right:15px;font-style:bold;">Cristal</font></td>'+'<th><font color="#00ff00">'+formatNmb(planetas_recursos_cristal*24)+'</font></th>'+'<th><font color="#00ff00">'+formatNmb(planetas_recursos_cristal*168)+'</font></th>'+'<th><font color="#00ff00">'+formatNmb(planetas_recursos_cristal*720)+'</font></th>'+'</tr>'+'<tr>'+'<td class="c"><img src="http://xaflanhipnos37.iespana.es/xenom/deute.png" width="15" style="margin-right:15px;" /><font color="#00ffb4" style="margin-right:15px;font-style:bold;">Deuterio</td>'+'<th><font color="#00ff00">'+formatNmb(planetas_recursos_deuterio*24)+'</font></th>'+'<th><font color="#00ff00">'+formatNmb(planetas_recursos_deuterio*168)+'</font></th>'+'<th><font color="#00ff00">'+formatNmb(planetas_recursos_deuterio*720)+'</font></th>'+'</tr>'+'<tr>'+'<td class="c" style="text-align:center;"><font>Total</td>'+'<th><font color="#00ff00">'+formatNmb((planetas_recursos_metal*24)+(planetas_recursos_cristal*24)+(planetas_recursos_deuterio*24))+'</font></th>'+'<th><font color="#00ff00">'+formatNmb((planetas_recursos_metal*168)+(planetas_recursos_cristal*168)+(planetas_recursos_deuterio*168))+'</font></th>'+'<th><font color="#00ff00">'+formatNmb((planetas_recursos_metal*720)+(planetas_recursos_cristal*720)+(planetas_recursos_deuterio*720))+'</font></th>'+'</tr></table><br />';
