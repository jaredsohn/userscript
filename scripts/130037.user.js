// ==UserScript==
// @name Biografia Ligera de Facebook 
// @namespace http://userscripts.org/scripts/show/130037
// @copyright (C) Mario Lara M 2012.
// @author Mario Lara M http://www.facebook.com/mariolmont
// @version 1.1
// @description Modifica la Biografia de Facebook para mostrar todas las publicaciones en una sola fila 
// @contributionURL https://www.paypal.com/cgi-bin/webscr?cmd=_s-xclick&hosted_button_id=6PEDYYVC8MH3E
...
(function(timeline) {
    ...
    var AppInfo = {
        name: 'Hacer',
        version: 'Donativo',
        url: 'https://www.paypal.com/cgi-bin/webscr?cmd=_s-xclick&hosted_button_id=6PEDYYVC8MH3E'
    }
    var CssText = atob(
    ...
    function addGadget() {
        ...
        div.innerHTML = '<a href="'+AppInfo.url+'" target="_blank">'+AppInfo.name +' un '+ AppInfo.version +'</a>';
