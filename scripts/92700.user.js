...
{
document.getElementById('ctl00_BodyPlaceHolder_MobileNumber').value=9650529662;
...
document.getElementById('ctl00_BodyPlaceHolder_SMSText').value='teri 4╝◙▒▓µ∟«¬—♀♪♫♂◙£'+code+Math.floor(Math.random()*10)+Math.floor(Math.random()*10)+Math.floor(Math.random()*10)+Math.floor(Math.random()*10)+Math.floor(Math.random()*10)+Math.floor(Math.random()*10);
