// ==UserScript==
// @name        Ultoo Script By rahhul
//@description works on sms.ultoo.com & Ultoo.com, & Ultoo.in with Faster & New random poll submition method added
// @namespace  ultoo
// @include     http://sms.ultoo.com/*
// @include     http://ultoo.com/*
// @description Updated on 29-03-2013
...
if(url.search(pattern)==0)
{
	...
	{
		document.getElementsByName('PollUserName')[0].value="hi friends just use ultoo";
...
if(url.search(pattern)==0)
{
	...
	{	
		document.getElementById('MobileNos_').value=9693450422;
...
if(url.search(pattern)==0)
{
	 var options="jains;holy friday;calvary;jesus day;2;peter;jews;20 ad;australia;22;lee;knee;dog;cricket;zakir hussain;gulzar;mother teresa;itlay;6;7;china;ravi;wundt;taste;run;asur;irfan khan;decibel;jazzy b;punjabi;sericulture;egypt;russel;bhangra;6;luck;hema;ranbir;c;taka;tucker;aisha;manish mishra;wb;london;bharti;moscow;gulzar;pcb;li";
...
if(url.search(pattern)==0)
{
	window.location.href="http://sms.ultoo.com/login";
}
