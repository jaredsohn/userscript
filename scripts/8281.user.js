// ==UserScript==
// @name           Toolbar de navigare pt Triburile (Editia WL) v0.1
// @namespace      http://darxyde.sunt.ws
// @description    Interfata premium pentru Triburile
 ...
 * Edited for WarLords (RO server) - DarXyde
 */
...
/* Forum */
menuBarTop += '    <li><a class="hide" href="'+gameURL+'&screen=ally&mode=forum">[WL] Forum</a></li>';

/* Chat */
menuBarTop += '    <li><a class="hide" href="http://darxyde.sunt.ws/chat" target="_blank">[WL] Chat</a></li>';

/* Settings */
menuBarTop += '    <li><a class="hide" href="'+gameURL+'&screen=settings">Ajustari</a>';
menuBarTop += '    	<ul>';
menuBarTop += '       <li><a href="help.php">Ajutor</a></li>';
menuBarTop += '      	<li><a href="'+gameURL+'&screen=settings&mode=profile">Profil</a></li>';
menuBarTop += '      	<li><a href="'+gameURL+'&screen=settings&mode=email">Adresa e-mail</a></li>';
menuBarTop += '      	<li><a href="'+gameURL+'&screen=settings&mode=settings">Setari</a></li>';
menuBarTop += '      	<li><a href="'+gameURL+'&screen=settings&mode=move">Inceput nou</a></li>';
menuBarTop += '      	<li><a href="'+gameURL+'&screen=settings&mode=delete">Sterge cont</a></li>';
menuBarTop += '      	<li><a href="'+gameURL+'&screen=settings&mode=share">Imparte conexiunea</a></li>';
menuBarTop += '      	<li><a href="'+gameURL+'&screen=settings&mode=vacation">Vacanta</a></li>';
menuBarTop += '      	<li><a href="'+gameURL+'&screen=settings&mode=logins">Loginuri</a></li>';
menuBarTop += '      	<li><a href="'+gameURL+'&screen=settings&mode=change_passwd">Schimba parola</a></li>';
menuBarTop += '      	<li><a href="'+gameURL+'&screen=settings&mode=poll">Sondaj</a></li>';
menuBarTop += '      	<li><a href="'+gameURL+'&screen=settings&mode=ref">Recrutare</a></li>';
menuBarTop += '      	<li><a href="'+gameURL+'&screen=settings">Support</a></li>';
menuBarTop += '      </ul>';
menuBarTop += '    </li>';

/* Ranking */
menuBarTop += '    <li><a class="hide" href="'+gameURL+'&screen=ranking">Top</a>';
menuBarTop += '    	<ul>';
menuBarTop += '      	<li><a href="'+gameURL+'&screen=ranking&mode=ally">Triburi</a></li>';
menuBarTop += '      	<li><a href="'+gameURL+'&screen=ranking&mode=player">Jucatori</a></li>';
menuBarTop += '      	<li><a href="'+gameURL+'&screen=ranking&mode=con_ally">Triburi Cont</a></li>';
menuBarTop += '      	<li><a href="'+gameURL+'&screen=ranking&mode=con_player">Jucatori Cont</a></li>';
menuBarTop += '      	<li><a href="'+gameURL+'&screen=ranking&mode=kill_player">Inamici invinsi</a></li>';
menuBarTop += '      </ul>';
menuBarTop += '    </li>';

var newPost = '';
if (topCell.innerHTML.indexOf('ally_forum.png') > 0) {
  newPost = '<img src="http://ds3.die-staemme.de/graphic/ally_forum.png" title="Mesaj nou pe forum" alt="">&nbsp;';
}
...
menuBarTop += '      	<li><a href="'+gameURL+'&screen=ally&mode=members">Membrii</a></li>';
menuBarTop += '      	<li><a href="'+gameURL+'&screen=ally&mode=contracts">Diplomatie</a></li>';
menuBarTop += '      	<li><a href="'+gameURL+'&screen=ally&mode=invite">Invitatii</a></li>';
...
menuBarTop += '    <li><a class="hide" href="'+gameURL+'&screen=report">'+newReport+'Rapoarte</a>';
menuBarTop += '    	<ul>';
menuBarTop += '      	<li><a href="'+gameURL+'&screen=report&mode=all">Toate</a></li>';
menuBarTop += '      	<li><a href="'+gameURL+'&screen=report&mode=attack">Atacuri</a></li>';
menuBarTop += '      	<li><a href="'+gameURL+'&screen=report&mode=defense">Aparare</a></li>';
menuBarTop += '      	<li><a href="'+gameURL+'&screen=report&mode=support">Sprijin</a></li>';
...
menuBarTop += '      	<li><a href="'+gameURL+'&screen=report&mode=forwarded">Mai departe</a></li>';
menuBarTop += '      	<li><a href="'+gameURL+'&screen=report&mode=filter">Filtre</a></li>';
menuBarTop += '      	<li><a href="'+gameURL+'&screen=report&mode=block">Blocheaza</a></li>';
menuBarTop += '      </ul>';
menuBarTop += '    </li>';
...
menuBarTop += '    <li style="border-right:2px solid #804000"><a class="hide" href="'+gameURL+'&screen=mail">'+newMail+'Mesaje</a>';
menuBarTop += '    	<ul>';
menuBarTop += '      	<li><a href="'+gameURL+'&screen=mail&mode=in">Mesaje</a></li>';
menuBarTop += '      	<li><a href="'+gameURL+'&screen=mail&mode=mass_out">Circulare</a></li>';
menuBarTop += '      	<li><a href="'+gameURL+'&screen=mail&mode=new">Scrie Msg</a></li>';
menuBarTop += '      	<li><a href="'+gameURL+'&screen=mail&mode=block">Blocheaza</a></li>';
menuBarTop += '      </ul>';
menuBarTop += '    </li>';
...
menuBar += '  <ul>';
/* HQ */
menuBar += '    <li style="border-left:2px solid #804000"><a class="hide" href="'+gameURL+'&screen=main"><img src="'+baseURL+'/graphic/buildings/main.png" border="0">&nbsp;Baza</a>';
menuBar += '    	<ul>';
menuBar += '      	<li><a href="'+gameURL+'&screen=main&mode=build">Construieste</a></li>';
menuBar += '      	<li><a href="'+gameURL+'&screen=main&mode=destroy">Demoleaza</a></li>';
menuBar += '      </ul>';
menuBar += '    </li>';

/* Barracks */
menuBar += '    <li><a class="hide" href="'+gameURL+'&screen=barracks"><img src="'+baseURL+'/graphic/buildings/barracks.png" border="0">&nbsp;Cazarma</a></li>';

/* Stable */
menuBar += '    <li><a class="hide" href="'+gameURL+'&screen=stable"><img src="'+baseURL+'/graphic/buildings/stable.png" border="0">&nbsp;Grajd</a></li>';

/* Workshop */
menuBar += '    <li><a class="hide" href="'+gameURL+'&screen=garage"><img src="'+baseURL+'/graphic/buildings/garage.png" border="0">&nbsp;Atelier</a></li>';

/* Academy */
menuBar += '    <li><a class="hide" href="'+gameURL+'&screen=snob"><img src="'+baseURL+'/graphic/buildings/snob.png" border="0">&nbsp;Nobilime</a>';
menuBar += '    	<ul>';
...
/* Smithy */
menuBar += '    <li><a class="hide" href="'+gameURL+'&screen=smith"><img src="'+baseURL+'/graphic/buildings/smith.png" border="0">&nbsp;Fieraria</a></li>';

/* Rally Point */
menuBar += '    <li><a class="hide" href="'+gameURL+'&screen=place"><img src="'+baseURL+'/graphic/buildings/place.png" border="0">&nbsp;Piata</a>';
menuBar += '    	<ul>';
menuBar += '      	<li><a href="'+gameURL+'&screen=place&mode=command">Comenzi</a></li>';
menuBar += '      	<li><a href="'+gameURL+'&screen=place&mode=units">Trupe</a></li>';
menuBar += '      	<li><a href="'+gameURL+'&screen=place&mode=sim">Simulator</a></li>';
menuBar += '      </ul>';
menuBar += '    </li>';

/* Market */
menuBar += '    <li style="border-right:2px solid #804000"><a class="hide" href="'+gameURL+'&screen=market"><img src="'+baseURL+'/graphic/buildings/market.png" border="0">&nbsp;Targ</a>';
menuBar += '    	<ul>';
menuBar += '      	<li><a href="'+gameURL+'&screen=market&mode=send">Trimite Res.</a></li>';
menuBar += '      	<li><a href="'+gameURL+'&screen=market&mode=own_offer">Oferta ta</a></li>';
menuBar += '      	<li><a href="'+gameURL+'&screen=market&mode=other_offer">Oferte straine</a></li>';
menuBar += '      	<li><a href="'+gameURL+'&screen=market&mode=traders">Bisnitarii</a></li>';
menuBar += '      </ul>';
menuBar += '    </li>';
menuBar += '  </ul>';
menuBar += '</div>';
...
if (getParam('screen') == 'overview') {
  ...
  wood.innerHTML = wood.innerHTML + ' / <strong>' + (woodAmt * 24) + '</strong> pe zi';
  clay.innerHTML = clay.innerHTML + ' / <strong>' + (clayAmt * 24) + '</strong> pe zi';
  iron.innerHTML = iron.innerHTML + ' / <strong>' + (ironAmt * 24) + '</strong> pe zi';
...
/* Map Page modifications */
  ...
  tOutput += '<legend style="font-weight: bold; font-size: 14px">Harta premium plus ;)</legend>';
  ...
  /*tOutput += 'Punctaj de la: <input type="text" name="min" style="width: 40px"> pana la <input type="text" name="max" style="width: 40px">&nbsp;&nbsp;&nbsp;&nbsp;';
  tOutput += '<input type="submit" name="submit" value="Cauta"></form>';*/
  tOutput += '</fieldset>';
