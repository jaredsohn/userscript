// ==UserScript==
// @name           DS Filtern von Spyberichten
...
function ausblenden()
	{
		...
		for(i=0; i<h3; i++)
		{
			if (check.checked==true)
			{
				...
				holzbild.parentNode.parentNode.parentNode.style.display = 'none';
			}	
			else
			{
				...
				holzbild.parentNode.parentNode.parentNode.style.display = 'table';
			}
		}
