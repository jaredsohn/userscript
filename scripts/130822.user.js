// ==UserScript==
// @id             ijoikjm
// @name           vidxden player resize
// @version        1.0
// @namespace      vidxden player resize
// @author         drewmerc
// @description    vidxden player resize
// @include        http://www.vidxden.com/*
// @run-at         document-end
// ==/UserScript==

function do_platypus_script() {
do_modify_html_it(window.document,document.evaluate('/HTML[1]/BODY[1]/DIV[2]/DIV[1]/DIV[1]/DIV[1]/CENTER[1]', document, null, XPathResult.FIRST_ORDERED_NODE_TYPE,null).singleNodeValue,/align="center"/gi,'align="left"',null);
do_modify_html_it(window.document,document.getElementById('contmvshre'),/autostart=true" height="318" width="640"/,'autostart=true" height="618" width="940"',null);
