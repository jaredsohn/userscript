// ==UserScript==
// @name           Facebook: CONVIDAR AMIGOS
// @namespace      Aspi
// @description    Seleciona algo
...
(function () {
	...
	function addButton(inviteDialogParameter, isSubElement) {
		...
		if (inviteDialog !== undefined && !executing && !document.getElementById('selectAllButton')) {
			...
			// Button texts.
			var selectButtonText1 = 'Selecionar', selectButtonText2 = 'Cancelar todos';
			...
			// Create it's label.
			var autoScrollCheckBoxLabel = createLabel('Rolagem automatica?', autoScrollCheckBox);
			...
			// Create it's label
			var fromFieldLabelValues = ['Selecionar amigos apartir de #:', 'Select friends from #:'],
			...
			// Create it's label
			var toFieldLabelValues = ['Quantos? :', 'to #:'],
