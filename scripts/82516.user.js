// ==UserScript==
// @name         fightinfo_modificado_byjoanj.user
// @namespace    http://www.faveladogame.com.br
// @author       sageo, Modificado By Roxu82 y con código de d0whc3r, para mendigogame, por joanj para faveladogame 
// @description  Permite tomar notas personales de los ataques, y reportarlos a la bandeja de gritos(HH und B, PG-Version 4.0)
...
function InsertSubmitButton(content, table) {
	...
	newtd.innerHTML = '<table><tr><td style="vertical-align:text-top">' + SubmitButtonHTML + '</td><td style="vertical-align:middle">&nbsp;desde la página&nbsp;</td><td style="vertical-align:middle"><input name="seite" type="1" size="2" maxlength="3" id="seitebis"></td></tr></table><br />';
	newtr.appendChild(newtd);
