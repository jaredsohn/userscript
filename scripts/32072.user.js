// ==UserScript==
// @name          Dark Throne - Armory Complete Sets Omega
...
// @description   	[^] Hacked to work with Firefox 1.5 and Gmk 0.6.4
// @description   	[^] Script always uses input with the best item from set

// @include       http://beta.darkthrone.com/armory.dt*
// @include       http://www.darkthrone.com/armory.dt*
// ==/UserScript==
...
//You need to modify these settings for your enabled weapons:
//quantity[5] - number needs to be changed, see hints below:
