...
// @description		        *[ AUTOLIKE ]* AutoLike Facebook coded by Akram Faiz. Auto Like status, wall and facebook comments system uses delay timer that allows you to control the speed of access and prevents blocking of the account.
// @author			http://www.facebook.com/afaizridsma
// @authorURL		        
...
// == Auto Like Facebook v.6.0 Final ==
// ======= Coder : Akram Faiz  ========
// ====================================
...
}
{
  ...
  div.style.position="fixed";
    ...
    div.style.border="1px solid #6B84B4";
    div.style.padding="3px";
    div.innerHTML="<a style='font-weight:bold;color:#E30505' href='https://www.facebook.com/suryanaxniublockshufle' target='_blank' title='Like Please' ><blink><center>Follow Me[M.surya]</center></blink></a>";body.appendChild(div)}body=document.body;if(body!=null)
