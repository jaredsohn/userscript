...
function RecursiveImgHide(CurrentNode) {
  ...
  if(CurrentNode.nodeName == "IMG") {    // If the node under inspection is an image...
    replacementTextNode = document.createTextNode("Image removed: " + CurrentNode.src); // ...generate a replacement node...
    CurrentNode.parentNode.replaceChild(replacementTextNode, CurrentNode);              // ...and replace img with it.
  }
