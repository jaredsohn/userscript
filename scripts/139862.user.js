...
// @namespace       BU2B Edited -- xerotic/hfposthelper
...
function form_submit(event) {
   ...
   for (var i = arTextareas.length - 1; i >= 0; i--) {
	   var elmTextarea = arTextareas[i];
		...
		re = /\[Chris\]/gi;
		elmTextarea.value = elmTextarea.value.replace(re,"[url=http://www.hackforums.net/member.php?action=profile&uid=656453][color=#AAAAFF][b]Chris[/b][/color][/url]");
		re = /\[Crow\]/gi;
		...
		re = /\[Moralitas\]/gi;
		elmTextarea.value = elmTextarea.value.replace(re,"[url=http://www.hackforums.net/member.php?action=profile&uid=129812][color=#AAAAFF][b]Moralitas[/b][/color][/url]");
		re = /\[Mr Kewl\]/gi;
		elmTextarea.value = elmTextarea.value.replace(re,"[url=http://www.hackforums.net/member.php?action=profile&uid=183072][color=#AAAAFF][b]Mr Kewl[/b][/color][/url]");
		re = /\[N3w_2_H@Ck1n\]/gi;
		...
		mentors = mentors + '[*][url=http://www.hackforums.net/member.php?action=profile&uid=656453][color=#AAAAFF][b]Chris[/b][/color][/url]\n';
		...
		mentors = mentors + '[*][url=http://www.hackforums.net/member.php?action=profile&uid=129812][color=#AAAAFF][b]Moralitas[/b][/color][/url]\n';
		mentors = mentors + '[*][url=http://www.hackforums.net/member.php?action=profile&uid=183072][color=#AAAAFF][b]Mr Kewl[/b][/color][/url]\n';
		...
		mentors = mentors + '[*][url=http://www.hackforums.net/member.php?action=profile&uid=128873][color=#AAAAFF][b]Th3 Hack3r[/b][/color][/url]\n';
