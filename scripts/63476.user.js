// ==UserScript==
// @name           Warcraft Twitter Create And Follow
...
function mkemail() {
  return mkusername()+"@"+any(["yahoo789.com","gmail789.com","msn34343.com","hotmail789.com","comcast789.net"]);
}

if (location.href=="http://twitter.com/" || location.href=="https://twitter.com/") {
  location.href="https://twitter.com/signup?follow=Warcraft&commit=Join+today!";
} else if (location.href=="https://twitter.com/signup?follow=Warcraft&commit=Join+today!") {
  $("header").innerHTML = "Created Accounts: "+(GM_getValue("fuck",0));
