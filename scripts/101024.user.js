...
// @name           Taringa futbol!
// @namespace      futbol
// @description    Script para la comunidad de futbol
// @include        *taringa.net/*
// @exclude        *taringa.net/comunidades/taringa-torneos/*
// ==/UserScript==
...
byClass('menuTabs').innerHTML += "<li id=\"tabbedWTF\" class=\"tabbed\">\n <a href=\"http://www.taringa.net/comunidades/taringa-torneos/\" onclick=\"menu(\'T! Futbol \', this.href);return false;\" title=\"Ir a la comunidad de futbol!\">T! Futbol <img src=\n\"http://i1192.photobucket.com/albums/aa338/alex_tello/fut.png\" alt=\"\" /></a>\n</li>";
...
function procesarEventos()
{
  ...
  {    
    div.innerHTML = '<div align="center"><img src="http://i1192.photobucket.com/albums/aa338/alex_tello/fut.png" alt=""></div>';
  }
}
