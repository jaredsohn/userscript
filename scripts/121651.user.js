// ==UserScript==
// @name           Dutch Premium bar for Tribal Wars
// @namespace      www.tribalwars.nl
// @description    Dutch Premium bar for Tribalwars (Hoofdgebouw, Kazerne , Stal , WerkPlaats , Adelshoeve , Smederij , Verzamelplaats , Marktplaats)  
// @include        http://*.tribalwars.*
// @include        https://*.tribalwars.*  
// @version        1
// ==/UserScript==

var lang = "nl";   // Language option
...
function functionMain(e) {
	...
	if (b==null) {
		...
		window.createQuickbarShortcuts = function() {
			...
			//+ "<tr>   " + 
            newShortcut("", "/redir.php?url=www.google.com", langArr[8]);
			tableIdIndex++;
			trIdIndex++;
		}
	}
