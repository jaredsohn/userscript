...
for (i=0; i<textareas.snapshotLength; i++) {
  ...
  if (!textareas.snapshotItem(i).getAttribute('style') || textareas.snapshotItem(i).getAttribute('style').indexOf("display: none") == -1){
	...
	"<style type=\"text/css\"> #button {padding: 0; margin-top: 5px; font-weight:bold; display:inline; font-size: 20px;} a.button {text-decoration:none; text-align:center; width:70px; border:1px solid; padding:2px; } a.button:active {text-decoration:none; text-align:center; width:70px; border:1px solid; padding:2px;} a.button:hover {top:2px; left:2px; } .collapse { display: none; } .expand { display: inline; } </style>" +
      "<center>" +
	  "<a class=\"button\" href=\"javascript:tagIt('[b]','[/b]',"+ i +")\" accesskey=b title=\"Bold (Alt + B)\"><b>&nbsp;B&nbsp;</b></a> " +  //bold
      "<a class=\"button\" href=\"javascript:tagIt('[i]','[/i]',"+ i +")\" accesskey=i title=\"Italic (Alt + I)\"><i>&nbsp;I&nbsp;</i></a> " +  //italic
      "<a class=\"button\" href=\"javascript:tagIt('[u]','[/u]',"+ i +")\" accesskey=u title=\"Underline (Alt + U)\"><u>&nbsp;U&nbsp;</u></a> " +  //underline
	  "<a class=\"button\" href=\"javascript:tagIt('[s]','[/s]',"+ i +")\" accesskey=x title=\"Strike (Alt + X)\"><strike>&nbsp;S&nbsp;</strike></a> " + //strikethru
	  "<a class=\"button\" href=\"javascript:quoteIt("+i+")\" accesskey=q title=\"Quote (Alt + Q)\">&nbsp;&ldquo;&bdquo;&nbsp;</a> " +  //quote
	  "<a class=\"button\" href=\"javascript:tagIt('[align=center]','[/align]',"+ i +")\" accesskey=e title=\"Centre (Alt + E)\">&nbsp;&para;&nbsp;</a> " +  //align
	  "<a class=\"button\" href=\"javascript:sizeIt("+i+")\" accesskey=# title=\"Size (Alt + #)\">&nbsp;&ordf;&#97;&nbsp;</a> " +  //size
	  "<a class=\"button\" href=\"javascript:tagIt('[pre]','[/pre]',"+ i +")\" accesskey=p title=\"pre (Alt + P)\"><font face=monospace>pre</font></a> " +  //preformated
      "<br><br>" +
	  "<a class=\"button\" href=\"javascript:linkIt("+i+")\" accesskey=l title=\"Link (Alt + L)\">Link</a> " +  //link
      "<a class=\"button\" href=\"javascript:linkImg("+i+")\" accesskey=m title=\"Image (Alt + M)\">IMG</a> " +  //Iimg
	  "<a class=\"button\" href=\"javascript:colourIt("+i+")\" accesskey=k title=\"Color (Alt + K)\">RGB</a> " +  //colour
	  "<a class=\"button\" href=\"javascript:tagIt('[*]',' ',"+ i +")\" accesskey=.  title=\"List (Alt + .)\"><b>&nbsp;*&nbsp;</b></a> " +  //list
	  "<a class=\"button\" href=\"javascript:tagIt('[artist]','[/artist]',"+ i +")\" accesskey=a title=\"Artist link (Alt + A)\">&nbsp;Artist&nbsp;</a> " +  //artist
	  "<a class=\"button\" href=\"javascript:tagIt('[wiki]','[/wiki]',"+ i +")\" accesskey=w title=\"Wiki link (Alt + W)\">&nbsp;Wiki&nbsp;</a> " + //wiki
	  "<a class=\"button\" href=\"javascript:toggleemoticons();\" title=\"Emoticons\">&nbsp;&#9786;&nbsp;</a><br /> " +
	  "</div> " +
	  "";+
