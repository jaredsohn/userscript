...
var editbar = document.getElementById(domname);
  if (editbar) {
	...
	buttons += emoticonButton("wink", "http://wolverinex02.googlepages.com/icon_wink.gif");
        ...
        buttons += emoticonButton("tag", "http://www.netvibes.com/img/icons/tag_blue.gif");
	buttons += emoticonButton("thumb", "http://www.netvibes.com/img/icons/thumb_up.gif");
	buttons += emoticonButton("home", "http://www.netvibes.com/img/icons/house.gif");
	buttons += emoticonButton("comment", "http://www.netvibes.com/img/icons/comment.gif");
	buttons += emoticonButton("anchor", "http://www.netvibes.com/img/icons/anchor.gif");
	buttons += emoticonButton("thumbsdown", "http://www.netvibes.com/img/icons/thumb_down.gif");
	buttons += emoticonButton("linux_penguin", "http://www.netvibes.com/img/icons/tux.gif");
	buttons += emoticonButton("pencil", "http://www.netvibes.com/img/icons/pencil.gif");
	buttons += emoticonButton("monitor", "http://www.netvibes.com/img/icons/monitor.gif");
	buttons += emoticonButton("user", "http://www.netvibes.com/img/icons/user.gif");
	buttons += emoticonButton("dollar", "http://www.netvibes.com/img/icons/money_dollar.gif")
        buttons += emoticonButton("attach", "http://www.netvibes.com/img/icons/attach.gif");
	buttons += emoticonButton("rain", "http://www.netvibes.com/img/icons/weather_rain.gif");
