...
// @name           GLB Sort Players (fixed for season 13)
// @namespace      
...
{
this.id= num
this.name = getElementsByClassName("simple_level_container",info)[0].firstChild.innerHTML;
...
var text;
var levelText = getElementsByClassName("simple_player_level",info)[0].innerHTML;
this.level = parseFloat(levelText.substring(levelText.indexOf(".")+2));

var posText = getElementsByClassName("simple_level_container",info)[0].innerHTML;
...
var playerInfo = getElementsByClassName("content_container player_box_vet",document);
playerInfo = playerInfo.concat(getElementsByClassName("content_container_sp player_box_vet",document));
