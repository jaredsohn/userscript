...
//Linfeeder toggle
unsafeWindow.picrepeat = function( e ) {
	//Begin Gay wrapper
	window.setTimeout(function() {
		if (GM_getValue("picrepeat", false ) == true ){
			GM_setValue("picrepeat", false );
			alert('PicRepeatRemove Disabled');
			return;
		};
		if (GM_getValue("picrepeat", false ) == false ){
			GM_setValue("picrepeat", true );
			alert('PicRepeatRemove Enabled');
			return;
		};
	//End Gay wrapper
	}, 0);
...
function Menu_button_add(parm) {
	...
	crapmenuitem.innerHTML = "<li><img src='images/as/navsep2.gif' alt='' /></li><li id='tbcal'><a onclick=\"return ToggleDiv('ListFaceRaper', true);\" href=\"#\">FaceRaper..</a></li>"
	...
	if ( myfnlocation.search(/showthread.php/) != -1 || myfnlocation.search(/newreply.php/) != -1) {
		...
		crapmenuitem1 = document.createElement('div')
		crapmenuitem1.className = "cbutton"
		crapmenuitem1.innerHTML = "<a href='#' onclick=\"return ToggleDiv('otherstufffag', true);\">Tags</a>"
		baseel2.appendChild(crapmenuitem1)
...
function Upanel_Setup(param) {
	...
	//SHitty Menu Item 1
	crapmenuitem1 = document.createElement('p')
	crapmenuitem1.innerHTML = "<a href='#' onclick=\"return ToggleDiv('quick_forum_chooser', true);\">Quick Forum</a> - TEST"
	crapmenuinner.appendChild(crapmenuitem1)
...
function Cookies_Setup(param) {
	...
	//all
	crapmenuitem1 = document.createElement('p')
	crapmenuitem1.innerHTML = "<a href='#' onclick=\"delete_cookie('bblastvisit'); delete_cookie('bbsessionhash'); delete_cookie('bbuserid'); delete_cookie('bbpassword'); delete_cookie('bblastactivity'); alert('All cookies deleted.'); return false;\"><span style='font-size: 13px;'>DELETE ALL COOKIES</span></a>"
	crapmenushell.appendChild(crapmenuitem1)
...
function CFG_Setup(param) {
	...
	crapmenuitem1 = document.createElement('p')
	crapmenuitem1.innerHTML = "<a href='#' onclick=\"picrepeat();\">PicRepeatRemove (BETA): <span class='highlight'>"+ GM_getValue("picrepeat", false ) +"</span></a> - Removes repeated images"
	crapmenushell.appendChild(crapmenuitem1)
...
//Quick forum chooser
function QUICKFORUMSHIT_Setup(param) {
	...
	crapmenushell.style.display = "none"
	crapmenushell.style.width = "auto"
	crapmenushell.id = "quick_forum_chooser"
...
//Otherstufffag
function OtherstuffFag_Setup(param) {
	var mycruddyjs;
	var textelid, textelname, brotherelem, cocksdiv, cockstxt, cocksscr, cocksscrT;
	var crapmenushell, crapmenuitem1, crapmenuitem2, crapmenuitem3;
	...
	if ( textelid != "COCKFIGHT" ) {
		mycruddyjs = "function RapeMyFagTag( rapemehardbaby ) {" +
"	var quickreplys = document.getElementById('" + textelid + "');" +
"		if (quickreplys) {" +
"			var textcopy = quickreplys.value;" +
"			var slicedtxtsrt = textcopy.slice(0,quickreplys.selectionStart);" +
"			var slicedtxt = textcopy.slice(quickreplys.selectionStart,quickreplys.selectionEnd);" +
"			var slicedtxtend = textcopy.slice(quickreplys.selectionEnd,quickreplys.value.length);" +
"			var dbacksrt = quickreplys.selectionStart;" +
"			var dbackend = quickreplys.selectionEnd;" +

"			quickreplys.value = slicedtxtsrt + '[' + rapemehardbaby + ']' + slicedtxt + '[/' + rapemehardbaby + ']'+ slicedtxtend;" +
"			quickreplys.selectionStart = eval(dbacksrt + ' + ' + rapemehardbaby.length);" +
"			quickreplys.selectionEnd = eval(dbackend + ' + ' + rapemehardbaby.length);" +
"		} else {" +
"		alert('"+ textelname +" Failed!');" +
"	};" +
"};" +
"function RapeMyFagTagPopup( rapemehardbaby ) {" +
"	var quickreplys = document.getElementById('" + textelid + "');" +
"		if (quickreplys) {" +
"			var textcopy = quickreplys.value;" +
"			var slicedtxtsrt = textcopy.slice(0,quickreplys.selectionStart);" +
...
"			var dbacksrt = quickreplys.selectionStart;" +
"			var dbackend = quickreplys.selectionEnd;" +
"			var slicedtxt = prompt('Enter what should be inside the tag (if media tag, type youtube link)', 'Type it here.');" +
"			quickreplys.value = slicedtxtsrt + '[' + rapemehardbaby + ']' + slicedtxt + '[/' + rapemehardbaby + ']'+ slicedtxtend;" +
"			quickreplys.selectionStart = eval(dbacksrt + ' + ' + rapemehardbaby.length);" +
"			quickreplys.selectionEnd = eval(dbackend + ' + ' + rapemehardbaby.length);" +
"		} else {" +
...
"};"
		...
		crapmenushell.className = "SpecialPages"
		crapmenushell.style.display = "none"
		crapmenushell.style.width = "200px"
		crapmenushell.id = "otherstufffag"
		//Toggle Button
		crapmenuitem2 = document.createElement('div')
		crapmenuitem2.className = "cbutton"
		crapmenuitem2.style.display = "block"
		crapmenuitem2.style.marginLeft = "0px"
		crapmenuitem2.setAttribute("onclick", "return ToggleDiv('otherstufffag', false);")
		crapmenuitem2.innerHTML = "<span class=''>Toggle</span>"
		crapmenushell.appendChild(crapmenuitem2)
		
		//SHitty Menu Item 1
		crapmenuitem1 = document.createElement('p')
		crapmenuitem1.innerHTML = "<br/><font color='FF0000'>Using popups:</font>"
		crapmenushell.appendChild(crapmenuitem1)
		
		//SHitty Menu Item 1
		crapmenuitem1 = document.createElement('p')
		crapmenuitem1.innerHTML = "&nbsp;&nbsp;&nbsp;<a href='#' onclick=\"RapeMyFagTagPopup( 'media' ); return false;\">MEDIA</a>"
		crapmenushell.appendChild(crapmenuitem1)
		
		//SHitty Menu Item 1
		crapmenuitem1 = document.createElement('p')
		crapmenuitem1.innerHTML = "&nbsp;&nbsp;&nbsp;<a href='#' onclick=\"RapeMyFagTagPopup( 'img' ); return false;\">IMG</a>"
		crapmenushell.appendChild(crapmenuitem1)
		
		//SHitty Menu Item 1
		crapmenuitem1 = document.createElement('p')
		crapmenuitem1.innerHTML = "&nbsp;&nbsp;&nbsp;<a href='#' onclick=\"RapeMyFagTagPopup( 'IMG_THUMB' ); return false;\">IMG_THUMB</a>"
		crapmenushell.appendChild(crapmenuitem1)
		
		//SHitty Menu Item 1
		crapmenuitem1 = document.createElement('p')
		crapmenuitem1.innerHTML = "<br/><font color='FF0000'>Using Selection:</font>"
		crapmenushell.appendChild(crapmenuitem1)
		
		//SHitty Menu Item 1
		crapmenuitem1 = document.createElement('p')
		crapmenuitem1.innerHTML = "&nbsp;&nbsp;&nbsp;<a href='#' onclick=\"RapeMyFagTag( 'media' ); return false;\">MEDIA</a>"
		crapmenushell.appendChild(crapmenuitem1)
		
		//SHitty Menu Item 1
		crapmenuitem1 = document.createElement('p')
		crapmenuitem1.innerHTML = "&nbsp;&nbsp;&nbsp;<a href='#' onclick=\"RapeMyFagTag( 'img' ); return false;\">IMG</a>"
		crapmenushell.appendChild(crapmenuitem1)
		
		//SHitty Menu Item 1
		crapmenuitem1 = document.createElement('p')
		crapmenuitem1.innerHTML = "&nbsp;&nbsp;&nbsp;<a href='#' onclick=\"RapeMyFagTag( 'IMG_THUMB' ); return false;\">IMG_THUMB</a>"
		crapmenushell.appendChild(crapmenuitem1)
...
//picrepeat...
function D_PicFagSetup(param) {

	if (GM_getValue("picrepeat", false ) == false ){ return; }
	
	if ( myfnlocation.search(/showthread.php/) != -1 ) {
		//((((((((((((OOOOOoooooOOOOO))))))))))))=======--------===[ the mother is dead ]===--------=======((((((((((((OOOOOoooooOOOOO))))))))))))
		v1= document.getElementsByTagName("img");
		v2=v1.length - 1;
		for(i=0; i < v2; i++){
			elem = v1[i];
			if (elem.parentNode.getAttribute("class") == "messagetext" || elem.parentNode.parentNode.getAttribute("class") == "quote"){
				elemsource = elem.src;
				nextelemsource = v1[i+1].src;
				subsrc = elemsource.substring(0,42);
				if (subsrc != "http://forums.facepunchstudios.com/images/"){
					if (elemsource == nextelemsource){
