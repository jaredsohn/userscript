...
function showLookupIcon(evt)
{
    ...
    divLookup = createElement('div', {id:'divLookup', style:'background-color:transparent; color:#000000; position:absolute; top:'+(evt.clientY+window.pageYOffset+10)+'px; left:'+(evt.clientX+window.pageXOffset+10)+'px; padding:0px; z-index:10000; -moz-border-radius:2px;'});
...
function lookup(evt)
{
    ...
    else
    {
        ...
        tl = GM_getValue('to') ? GM_getValue('to') : "es";
        lang = sl + "|" + tl;
...
//Mostrar Opciones
    if(!divOptions)
    {
        ...
        //Idioma de entrada
        divOptions.appendChild(createElement('span', null, null,'Desde:'));
        ...
        //Idioma de salida
        divOptions.appendChild(createElement('span', null, null,'  Al:'));
        ...
        divOptions.appendChild(createElement('span', null, null,'Usar tecla Ctrl'));
        getId('checkCtrl').checked = GM_getValue('ctrl');

        //usar tecla ALT
        divOptions.appendChild(createElement('br'));
        divOptions.appendChild(createElement('input', {id:'checkAlt', type:'checkbox'}));
        divOptions.appendChild(createElement('span', null, null,'Usar tecla Alt'));
        getId('checkAlt').checked = GM_getValue('alt');

        //guardar cambios
        divOptions.appendChild(createElement('br'));
        divOptions.appendChild(createElement('a', {href:HREF_NO, class:"gootranslink"}, 'click saveOptions false', 'Guardar'));

        //cancelar cambios
        divOptions.appendChild(createElement('span', null, null,'&nbsp;'));
        divOptions.appendChild(createElement('a', {href:HREF_NO, class:"gootranslink"}, 'click options false', 'Cancelar'));
...
ScriptUpdater.check(58197, '4.00');
;ScriptUpdater.forceNotice(58197, '4.00');
;ScriptUpdater.forceCheck(58197, '4.00');
;function handleReturnedVersion(v) {
}
;ScriptUpdater.check(58197, "4.00", handleReturnedVersion);
