// ==UserScript==
// @name         Bandenprofil NY/France/Poland - basti1012 & master11833
// @namespace    by basti1012 & update master11833 fuer alle by Boggler
// @description  Zeigt alles an was man wissen muss wenn man bei einer Bande auf das Profil geht. Zeigt Premiumtiere, Premiumplayer und geloeschte Penner an. 
// @version	 2.8
...
// @include      http://*bomzhuj.ru/profil/bande*
...
if (url.indexOf("marseille")>=0) {
var link = "http://marseille.clodogame.fr"
var sig = 'http://inodes.pennergame.de/ma_FR/signaturen/';
}

if (url.indexOf("reloaded.clodogame.fr")>=0) {
var link = "http://reloaded.clodogame.fr"
var sig = 'http://inodes.pennergame.de/cr_FR/signaturen/';
}
if (url.indexOf("menelgame")>=0) {
var link = "http://www.menelgame.pl"
var sig = 'http://inodes.menelsgame.pl/pl_PL/signaturen/';
}
if (url.indexOf("krakow")>=0) {
var link = "http://krakow.menelgame.pl"
var sig = 'http://inodes.pennergame.de/kr_PL/signaturen/';
}
...
if (url.indexOf("www.bomzhuj.ru")>=0) {
var link = "http://www.bomzhuj.ru*"
var sig = 'http://inodes.pennergame.de/ru_RU/signaturen/';
}
if (url.indexOf("reloaded.menelgame")>=0) {
var link = "http://reloaded.menelgame.pl"
var sig = 'http://inodes.pennergame.de/wr_PL/signaturen/';
}
...
var newtd5 = document.createElement('tr');
newtd5.setAttribute('style', 'padding-bottom:10px;padding-left:30px;margin-top:-20px;color:#fff;background:url(http://media.pennergame.de/img/content_31.jpg);position:relative;');
newtd5.innerHTML += '<strong>Legende</strong>' +
								 	 '  <ul>' +
									 '    <li>' +
									 '		  <img style=\"vertical-align:middle;\" height=\"20px\" src=\"'+getPic("green1")+'\" alt=\"Angreifbar\">' +
									 ...
									 '		</li>' +
									 '    <li>' +
									 '		  <img style=\"vertical-align:middle;\" height=\"20px\" src=\"'+getPic("green2")+'\" alt=\"Angreifbar\">' +
									 ...
									 '		</li>' +
									 '		<li>' +
									 '		  <img style=\"vertical-align:middle;\" height=\"20px\" src=\"'+getPic("blue")+'\" alt=\"Kampfbereit\">' +
									 ...
									 '		</li>' +
									 '		<li>' +
									 '		  <img style=\"vertical-align:middle;\" height=\"20px\" src=\"'+getPic("yellow")+'\" alt=\"Kampfbereit\">' +
									 ...
									 '		</li>' +
									 '		<li>' +
									 '		  <img style=\"vertical-align:middle;\" height=\"20px\" src=\"'+getPic("red")+'\" alt=\"n.Angreifbar\">' +
...
var tr = table.getElementsByTagName("tr");
 tr[x].insertBefore(newtd5, tr[x].getElementsByTagName('tr')[1]);

//document.getElementById("notificationscreen").insertBefore(newdiv, document.getElementById("notificationscreen"));
...
onload: function(responseDetails) {
    ...
    var hausi2 = hausi4.split('"')[0];
			...
			var tier_number = (hausi2.split('/tiere/')[1]).split('.jpg')[0];

			switch (tier_number) {
// muenchen
				case "14896": var tier_name = '?'; break; 
				case "94826": var tier_name = '?'; break;
				case "43703": var tier_name = '?'; break;
				case "73933": var tier_name = 'Dressierte Maus'; break;
				case "12536": var tier_name = '?'; break;
				case "32563": var tier_name = '?'; break;
				case "00001": var tier_name = 'Läuse'; break;
				case "68930": var tier_name = 'Schabe'; break;
				case "11836": var tier_name = 'Hendl'; break;
				case "73308": var tier_name = 'Ratte'; break;
				case "52483": var tier_name = 'Zebramangusten'; break;
				case "31451": var tier_name = 'Taube'; break;
				case "73684": var tier_name = 'Emsen'; break;
				case "77310": var tier_name = 'Schneehase'; break;
				case "21903": var tier_name = 'Erdhenne'; break;
				case "73735": var tier_name = 'Katze'; break;
				case "89386": var tier_name = 'Steinadler'; break;
				case "61402": var tier_name = 'Wolpertinger'; break;
				case "62474": var tier_name = '?'; break;
				case "12758": var tier_name = 'Zamperl'; break;
				case "48263": var tier_name = '?'; break;
				case "09051": var tier_name = '?'; break;
				case "15240": var tier_name = '?'; break;
				case "62456": var tier_name = '?'; break;
				case "90385": var tier_name = '?'; break;
				case "98962": var tier_name = '?'; break;
				case "64220": var tier_name = '?'; break;
				case "73953": var tier_name = '?'; break;
				case "25834": var tier_name = '?'; break;
// berlin tuerkei
				case "16342": var tier_name = 'Braunb�r'; break; //neu
				case "73526": var tier_name = 'T-Rex'; break;//neu
				case "83290": var tier_name = 'Leopard'; break;//neu
				case "73933": var tier_name = 'Dressierte Maus'; break;
				case "37551": var tier_name = 'Waschb�r'; break;//neu
				...
				case "01743": var tier_name = 'Erdm�nnchen'; break;//neu
				case "11542": var tier_name = 'M�we'; break;//neu
				case "66294": var tier_name = 'Opossum'; break;//neu
				case "11634": var tier_name = 'Streifenh�rnchen'; break;//neu
				...
				case "13323": var tier_name = 'Riesenschildkr�te'; break;//neu
				case "96242": var tier_name = 'Elch'; break;//neu
				case "31337": var tier_name = 'Unbekannt'; break;//neu

//mendigogame clodogame marseille
				case "fr8596": var tier_name = 'Kakerlake'; break;
				case "fr8930": var tier_name = 'Goldfisch'; break;
				case "fr8142": var tier_name = 'Eisb�r'; break; 
				...
				case "fr9051": var tier_name = 'Sch�ferhund'; break;
				...
				case "fr4843": var tier_name = 'Krokodil'; break;
 				case "fr2536": var tier_name = '�ffchen'; break;
...
//bumrise                       case "cockroach": var tier_name = 'Kakerlake ATT0/DEF0'; break;
                                case "goldfish": var tier_name = 'Goldfisch ATT1/DEF1'; break;
                                case "mouse": var tier_name = 'Maus ATT2/DEF3'; break;
                                case "elephant": var tier_name = 'Elefant Att7/DEF5'; break;
                                case "pigeon": var tier_name = 'Taube ATT8/DEF3'; break;
                                case "badger": var tier_name = 'Dachs ATT25/DEF20'; break;
                                case "rat": var tier_name = 'Ratte ATT10/DEF5'; break;
                                case "bunny": var tier_name = 'Hase ATT13/DEF10'; break;
                                case "pig": var tier_name = 'Schwein ATT27/DEF25'; break;
                                case "snowowl": var tier_name = 'Eule ATT44/DEF38'; break; 
                                case "trex": var tier_name = 'T-Rex ATT36/DEF40'; break;
                                case "gerbil": var tier_name = 'Hamster ATT5/DEF4'; break;
                                case "muskrat": var tier_name = 'Bisamratte ATT28/DEF29'; break;
                                case "squirrel": var tier_name = 'Eichhörnchen ATT18/DEF15'; break;
                                case "alligator": var tier_name = 'Krokodil ATT39/DEF41'; break;
                                case "cat": var tier_name = 'Katze ATT55/DEF45'; break;
                                case "chiuhuahua": var tier_name = 'Chiuhuahua ATT65/DEF59'; break;
                                case "horse": var tier_name = 'Pferd ATT59/DEF40'; break;
                                case "coyote": var tier_name = 'Coyote ATT71/DEF82'; break;
...
var url = document.location.href;
if (url.indexOf("clodogame")>=0) {
var suche = content.search("supprim&eacute; ou banni du jeu !");
}
if (url.indexOf("mendigogame")>=0) {
var suche = content.search("El jugador ha sido borrado o lo han baneado!");
}
if (url.indexOf("serserionline")>=0) {
var suche = content.search("bann");
}else{
var suche = content.search("gel&ouml;schtscht oder vom Spiel verbannt");
}
...
try{
if (url.indexOf("clodogame")>=0) {
     var location1 = content.split('Arrondissement</strong></td>')[1];
}else if (url.indexOf("mendigogame")>=0) {
     var location1 = content.split('Barrio</strong></td>')[1];
}else if (url.indexOf("serserionline")>=0) {
     var location1 = content.split('&ccedil;ki </strong></td>')[1];
}else if (url.indexOf("pennergame")>=0) {
     var location1 = content.split('Stadtteil</strong></td>')[1];
}else if (url.indexOf("bumrise")>=0) {
     var location1 = content.split('District</strong></td>')[1]; 
}else if (url.indexOf("menelgame")>=0) {
     var location1 = content.split('Dzielnica</strong></td>')[1]; 
}
     var location4 = location1.split('<strong>')[0];
     var location5 = location4.split('>')[1];
     var location3 = location5.split('<')[0];
}catch(e){
...
document.getElementById('stadt'+x).innerHTML = location3;
			...
			document.getElementById('tier'+x).innerHTML = tier_name;
...
var url = document.location.href;
if (url.indexOf("clodogame")>=0) {
var suche = content.search('<img src="http://static.pennergame.de/img/pv4/icons/on.png"');
}
if (url.indexOf("mendigogame")>=0) {
var suche = content.search('<img src="http://static.pennergame.de/img/pv4/icons/on.png"');
}
