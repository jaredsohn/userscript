...
if(document.location.href.substring(document.location.href.length - 6) == "donate") {
	...
	buyCountSpan.appendChild(document.createTextNode("   Buy Count:"));
	maxPriceSpan.appendChild(document.createTextNode("   Max Price:"));
...
if(document.location.href.indexOf("market") != -1) {
	...
	document.getElementById("buyMarketOffer_amount").value = 20;
