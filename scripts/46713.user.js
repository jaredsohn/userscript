// ==UserScript==
// @name	Travian Big Map - in persian
// @namespace	TRAVIAN BIG MAP
// @author	Rashid & DMaster
// @description	Travian Big Map in persian                        
// @version	2.6.2.1
// @include	http://*.travian.*/karte.php*
// @include	http://*.travian3.*/karte.php*
// @exclude	http://speed.travian.co.il/karte.php?newdid*
// ==/UserScript==
...
//	loadFalseData();
	...
	function createInfoBox() {
		...
		info.innerHTML = '<table dir="rtl" class="f8 map_infobox_grey" width="100%" cellspacing="1" cellpadding="2">' +
				 '<tr><td class="c b" colspan="2" align="center">' + 'جزئيات' + '</td></tr>' +
				 '<tr><td class="c s7" width="45%" ><p align="right">' + 'بازيکن' + '</p></td><td class="c s7"><p align="center">-</p></td></tr>' +
				 '<tr><td class="c s7"><p align="right">' + 'جمعيت' + '</p></td><td class="c s7"><p align="center">-</p></td></tr>' +
				 '<tr><td class="c s7"><p align="right">' + 'اتحاد' + '</p></td><td class="c s7"><p align="center">-</p></td></tr>' +
				 '</table>';
		return info;
	}
	...
	function makeEventMouseOver() {
		return function() {
			...
			if (name) {
				var table = '<table dir="rtl" cellspacing="1" cellpadding="2" class="tbg f8"><tr>'+
					    '<td class="rbg f8" colspan="2"></a>' + name +
					    '</td></tr><tr><td width="45%" class="s7 f8"><p align="right">' + 'بازيکن' +
					    '</p></td><td class="s7 f8">' + owner +
					    '</td></tr><tr><td class="s7 f8"><p align="right">' + 'جمعيت' +
					    '</p></td><td class="s7 f8" id="ew">' + pop +
					    '</td></tr><tr><td class="s7 f8"><p align="right">' + 'اتحاد' +
					    '</td><td class="s7 f8">' + ally +
					    '</p></td></tr></table>';
				info.innerHTML = table;
			}
			else {
				var table = '<table dir="rtl" class="f8 map_infobox_grey" cellspacing="1" cellpadding="2"><tr><td class="c b" colspan="2" align="center"></a>' + 'جزئيات' +
					    '</td></tr><tr><td align="right" width="45%" class="c s7"><p align="right">' + 'بازيکن' +
					    '</p></td><td class="c s7"><p align="center">-</p></td></tr><tr><td class="c s7"><p align="right">' + 'جمعيت' +
					    '</p></td><td class="c s7"><p align="center">-</p></td></tr><tr><td class="c s7"><p align="right">' + 'اتحاد' +
					    '</p></td><td class="c s7"><p align="center">-</p></td></tr></table>';
				info.innerHTML = table;
			}
		}
	}
	...
	function makeEventMouseOut() {
		return function() {
			...
			var info = doc.getElementById('tb');
			var table = '<table dir="rtl" class="f8 map_infobox_grey" cellspacing="1" cellpadding="2"><tr><td class="c b" colspan="2" align="center"></a>' + 'جزئيات' +
					'</td></tr><tr><td width="45%" class="c s7"><p align="right">' + 'بازيکن' +
					'</p></td><td class="c s7"><p align="center">-</p></td></tr><tr><td class="c s7"><p align="right">' + 'جمعيت' +
					'</p></td><td class="c s7"><p align="center">-</p></td></tr><tr><td class="c s7"><p align="right">' + 'اتحاد' +
					'</p></td><td class="c s7"><p align="center">-</p></td></tr></table>';
			info.innerHTML = table;
