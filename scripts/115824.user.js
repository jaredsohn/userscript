...
var version = "1.2.232"; // cant use cdata+regexp to grab version dynamically because of webkit
...
switch(w) {
case "partyfavors": w="pumpkinlollipop"; break;
case "tickets": w="pumpkinlollipop"; break;
...
case "getone": if(text.find("Huge Jack-O'Lantern")) w="pumpkinlollipop";
...
whichAnimal : function(e) {
	...
	switch(w) {
		...
		case "appaloosa": case "stallion": case "unicorn": case "quarter": case "gyps": case "palomino": case "mini": case "pinto": case "bedazzled": case "andalusian": case "thoroughbred": w="foalwhitethoroughbred"; w="foal"; break;
		case "kitten": 
...
//	if(w.find("gray")) w = w.replace("gray", "grey");
	...
	if(lText.find("mini blue mane")) w="minibluemanegypsy";
