...
function display_songs(xml_data)
{
	...
	for(var i=0; i<tracks.length; i++)
	{
		...
		{
			var script = "http://www.michaelpardo.com/muxtape/index.php";
			song_a.setAttribute('href', script+"?name="+song_artist+" - "+song_title+"&link="+song_location);
