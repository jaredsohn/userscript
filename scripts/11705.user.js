...
// @name            taz_dlf_2
// @namespace       Platypus
// @include         http://www.dradio.de/presseschau/#taz
...
isolate(window.document,document.getElementById('inhalt-mitte'),null,null,null);

set_style_script(window.document,document.getElementById('inhalt-mitte'),"width: 475px;",null,null);

set_style_script(window.document,document.evaluate('/HTML[1]/BODY[1]/DIV[1]/DIV[1]/DIV[1]', document, null, XPathResult.FIRST_ORDERED_NODE_TYPE,null).singleNodeValue,"width: 475px;",null,null);

do_modify_html_it(window.document,document.getElementById('inhalt-mitte'),/<[^<]+class="sendungen-fuss"[^°]+/i,'',null);

do_modify_html_it(window.document,document.getElementById('inhalt-mitte'),/>PRESSESCHAU</,'>Deutschlandfunk PRESSESCHAU<',null);

do_modify_html_it(window.document,document.getElementById('inhalt-mitte'),/<\/h1>/,' <a href="http://ondemand-mp3.dradio.de/file/dradio/presseschau/presseschau.mp3">(hören)</a></h1>',null);
