...
// @name        buxhigh
// @namespace   buxhigh
// @include     *://*buxhigh.com/index.php?view=click*
// @include     *://*buxhigh.com/index.php?view=account&ac=click*
// @include     *://*buxhigh.com/index.php?view=account&ac=ptra*
// @include     *://*buxhigh.com/gpt.php?v=entry*
// @include     *://*buxhigh.com/gpt.php?v=read*
// @include     *://*buxhigh.com/view.php?id=*
// @require     http://userscripts.org/scripts/source/176798.user.js
// @include     *://*.*cks.com/
// @include     *://*cl.my/*
// @include     *://*ashcamel.net/index.php?ref=dhistya/*
// @include     *://*oc.us/*
// @include     *://*aidtoclick.in/index.php?ref=dhistya/*
// @version     1
// ==/UserScript==
//
		...
		function rec(ctr){
			...
			if(arr[ctr]){
				if(typeof adsWind == 'undefined')
					adsWind = wparent.open(arr[ctr].href,"salah","width=100,height=50,top=1000,left=20000");
				else	
...
self == top){
	if($('frameset frame:last').size()){
		if($('frameset frame:last').attr('src').indexOf('/hidesite') >= 0){
	...
	if($('frame:last').attr('src').indexOf('cheat') >= 0 ){
		...
		if(wparent.location.host.indexOf('cashcamel')!=-1)cheatCheck = [49,27,51,32,35,8,39,60,46,22,23,65,71];
		...
		if(wparent.location.host.indexOf('buxxxx')!=-1)cheatCheck=[5,6,9,15,16,18];
                if(wparent.location.host.indexOf('paidtoclick')!=-1)cheatCheck=[27,29];
