...
// @include             http://sozluk.siourtimes.org/stats.asp*
...
if(!GM_getValue('userApiKey')){
     GM_setValue('userApiKey', prompt('Ekşigator API Kodunuz:',''));
}
var userApiKey = GM_getValue('userApiKey');
