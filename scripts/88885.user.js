// ==UserScript==
// @name			Ikariam Upgrade Watcher (Logvar)
// @version			1.4.3
// @namespace		http://ikariam.org/
// @description		Attaches a simple icon on each building which show level and if upgradeable
// @author			Anh Tuan Nguyen Dao (http://www.atdao.dk) and now modified by Logvar
// @homepage		http://userscripts.org/scripts/show/88885 or http://www.atdao.dk/projects/scripts/ikariam-upgrade-watcher
...
// Version Log:
//              v1.4.3 (21 dec 2010) : add 17 to 20 level for museum.
//              v1.4.2 (18 nov 2010) : modified values for dump.
//		v1.4.1 (17 nov 2010)
//			- Fix some issues with Dump. Tested with 4.1 versions and before.
		...
		for (var i = 0; i < spot.length; i++) {
			...
			if (isDefined(building, 0) && building[0].className != 'flag') {		
				...
				if (building[0].className == 'constructionSite') {
					...
					if (buildingType == 'palace' || buildingType == 'palaceColony' || buildingType == 'dump') {
...
function addOnMouseOverEventDump(id, target, posTop, posLeft, resWood, resMarble, resCrystal, resSulfur) {
	...
	element.addEventListener('mouseover', function(event) {
		...
		// Nasty, ugly HTML for the info box
		div.innerHTML = '<div class="before" style="background-image: url(\'' + imgScrollLeft_2 + '\'); height: 80px; float: left;"></div><div style="float: left;"><div style="color: ' + colorWood + '; text-align: left;"><img style="vertical-align: middle; margin-right: 2px;" src="' + imgWood + '" /> '+ estWood +'</div><div style="margin-top: -4px; color: ' + colorMarble + '; text-align: left;"><img style="vertical-align: middle; margin-right: 2px;" src="' + imgMarble + '" /> '+ estMarble +'</div><div style="margin-top: -4px; color: ' + colorCrystal + '; text-align: left;"><img style="vertical-align: middle; margin-right: 2px;" src="' + imgCrystal + '" /> '+ estCrystal +'</div><div style="margin-top: -4px; color: ' + colorSulfur + '; text-align: left;"><img style="vertical-align: middle; margin-right: 2px;" src="' + imgSulfur + '" /> '+ estSulfur +'</div></div><div class="after" style="background-image: url(\'' + imgScrollRight_2 + '\'); height: 80px; float: left;"></div>';
		div.innerHTML = '<div class="before" style="background-image: url(\'' + imgScrollLeft_2 + '\'); height: 80px; float: left;"></div><div style="float: left;"><div style="color: ' + colorWood + '; text-align: left;"><img style="vertical-align: middle; margin-right: 2px;" src="' + imgWood + '" /> '+ estWood +'</div><div style="margin-top: -4px; color: ' + colorMarble + '; text-align: left;"><img style="vertical-align: middle; margin-right: 2px;" src="' + imgMarble + '" /> '+ estMarble +'</div><div style="margin-top: -4px; color: ' + colorCrystal + '; text-align: left;"><img style="vertical-align: middle; margin-right: 2px;" src="' + imgCrystal + '" /> '+ estCrystal +'</div><div style="margin-top: -4px; color: ' + colorSulfur + '; text-align: left;"><img style="vertical-align: middle; margin-right: 2px;" src="' + imgSulfur + '" /> '+ estSulfur +'</div></div><div class="after" style="background-image: url(\'' + imgScrollRight_2 + '\'); height: 80px; float: left;"></div>';
...
function loadDB() {
	...
	BUILDINGS = {
		...
		"dump" : [
			...
			{ "wood" : 1766, "marble" : 1445, "crystal" :1668, "sulfur" : 1398 },  //3
			{ "wood" : 2504, "marble" : 2051, "crystal" :2278, "sulfur" : 2061 },  //4
			{ "wood" : 3388, "marble" : 2762, "crystal" : 2991, "sulfur" : 2858 },  //5
			{ "wood" : 4450, "marble" : 3609, "crystal" : 3536, "sulfur" : 3813 },   // 6
			{ "wood" : 5724, "marble" : 4604, "crystal" : 4803, "sulfur" : 4960 }, // 7
			...
			{ "wood" : 25470, "marble" : 18862, "crystal" : 18257, "sulfur" : 22731 },	// 14
			{ "wood" : 30948, "marble" : 22602, "crystal" : 21687, "sulfur" : 27661 },	// 15
			{ "wood" : 37522, "marble" : 27016, "crystal" : 25700, "sulfur" : 33578 },	// 16
			{ "wood" : 45410, "marble" : 32225, "crystal" : 30395, "sulfur" : 40677 },	// 17
			{ "wood" : 54876, "marble" : 38371, "crystal" : 35889, "sulfur" : 49197 },	// 18
			{ "wood" : 66236, "marble" : 45623, "crystal" : 42316, "sulfur" : 59420 },	// level 19
			{ "wood" : 79869, "marble" : 54181, "crystal" : 49837, "sulfur" : 71688 },	// 20
		],
