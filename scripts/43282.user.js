...
// @name SPARTANS 300 Chat
// @version        0.1

// @namespace      Arrow

// @description    United we stand! United we fall! Spartans(300) Exclusive chat...
...
unsafeWindow.displayshout = function() {
	...
	if(displayedflag == 0) {
		...
		document.getElementById("shoutframe").innerHTML = '<iframe src="http://wolicer.freeshoutbox.net/" height="380" width="200" frameborder="0"></iframe>';
		displayedflag = 1;
...
document.getElementById("shoutbar").innerHTML ='<div id="shouttab" ondblclick="showshout()" onclick="hideshout()"><a style="height:100%;width:100%;"></a></div>'
	...
	+ '<a style="border-bottom:1px #542C0F dotted; color: #542C0F;" href="http://ikariam.ph">Ikariam PH - Spartans</a></div>'
