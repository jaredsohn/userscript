// ==UserScript==
// @name            Windows Live Search no Orkut
// @namespace       Live Orkut
// @include         http://www.orkut.com/Home.*
// @description     Adiciona um sistema de busca do Windowss Live Search na Home Page do Orkut
function do_platypus_script() {
html_insert_it(window.document,document.evaluate('/HTML[1]/BODY[1]/DIV[4]/DIV[4]/TABLE[1]/TBODY[1]/TR[1]/TD[1]/H1[1]', document, null, XPathResult.FIRST_ORDERED_NODE_TYPE,null).singleNodeValue,'<center><br><div id="searchBar"><form id="searchform" name="searchform" action="http://search.live.com/results.aspx" onsubmit="return onSearch(event);"><label for="q"><img src="http://search.msn.com.br//s/wlflag.ico"></label><label for="go"> Pesquisar </label><span class="sc"><input class="q" id="q" name="q" value=""><input name="mkt" value="pt-br" type="hidden"><input name="FORM" value="LIVSOP" type="hidden"><input name="go" id="go" class="go" src="http://www.live.com/live/1.900.9.007/img/pp.gif" value="Search" align="middle" type="image"></span></form></div>',false,false);
