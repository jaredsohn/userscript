...
if(body != null) {
	...
	div.innerHTML = "<div style='background-color: #ff0000; color: #FFFFFF; border: 1px solid #fff000;'><center><a style='color: #fff000;' <a href='http://www.twitter.com/AlefRuanh' target='_blank' title=''>Meu Twitter</a></div>"
	...
	div2.innerHTML = "<div style='background-color: #ff0000; color: #FFF000; border: 1px solid #fff000;'><a style='color: #FFF000;' onclick='spoiler()' title='Click Para Ocultar'>&laquo;</a> &#8226; <a href='http://ask.fm/AlefRuanh' title='Preguntame :)' style='color: #FFF000;' onclick='alert(\'Thanks for install this script\');'>Ask AlefRuanh</a></div> "
