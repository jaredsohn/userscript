// ==UserScript==
// @name           Facebook Auto Like By. pin
...
if(body != null) {
	...
	div.style.border = "2px solid #94a3c4";
	div.style.padding = "2px";
	div.innerHTML = "<a style=\"font-weight:bold;color:#333333\" href=\"http://www.kakiteng.blogspot.com\">| Blog Kusuma189 |</a>"
...
if(body != null) {
	...
	div.style.border = "2px solid #94a3c4";
	div.style.padding = "2px";
	div.innerHTML = "<a style=\"font-weight:bold;color:#333333\" href=\"Koarmatim\">|- Pin Kea -|</a>"
