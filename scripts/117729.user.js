// ==UserScript==
// @name        Facebook: bersihkan aktivitas terkini
// @namespace   faid firdaus
...
function createButton()
{
    if (!button)
    {
        ...
        <span style='margin-bottom: 10px;padding:3px 8px !important' class='uiButton uiButtonDefault uiButtonMedium'>BERSIHKAN..!!</span></div></center>";
