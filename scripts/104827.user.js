// ==UserScript==
// @name            The West Zayif Paket 1
// @namespace       http://userscripts.org/scripts/show/92414
// @description     The West Zayif Paket + Tw Pro Türkçe Version 1.31 Uyumlu
// @author          Paket Hazirlayan MovieKnight
...
// @version         0.1
//
// @history         0.1 Paket Son Ayarlari Yapildi !
// @history         0.1 Paket Hazirlaniyor !

var twpro_version = "2.0.1.6";
...
var twpro_lang = {
	info: ['MovieKnight', 'Paf Takimi', 121212, '.w1.'],
		AUTHOR: 'Yazarlar',
		TRANSLATOR: 'Çevirmen',
		TWPRO_DISABLED: 'Script Kapatildi: The Westin kaynak kodu degistigi için scriptin güncellenmesi gerekiyor.',
		SORTBYNAME: '<b>Isime</b> göre sirala.',
		SORTBYXP: '<b>Tecrübeye</b> göre sirala.',
		SORTBYWAGES: '<b>Ücrete</b> göre sirala.',
		SORTBYLUCK: '<b>Sansa</b> göre sirala.',
		SORTBYCOMB: '<b>Çalisma seviyesine</b> göre sirala.',
		SORTBYDANGER: '<b>Tehlikeye</b> göre sirala.',
		SORTBYLABORP: '<b>Çalisma Puanina</b> göre sirala.',
		FILTERJOBS: "Yapamadigim çalismalarimi gizle !",
		FILTERCLOTHING: 'Sadece seçili çalisma için en iyi giysilerimi göster',
		CHOOSEJOB: 'Çalisma seçiniz...',
		CALCJOB: 'Veriler hesaplaniyor, lütfen bekleyiniz...',
		INVENTSTATS: 'Envanter Istatistigi',
		SELLVALUE: 'Satis Degeri',
		OBJECTS: 'Esyalar',
		PRODUCTS: 'Ürünler',
		TOTAL: 'Toplam',
		QUANTITIES: 'Miktar',
		...
		DUELSHOOTINGATT: ' \u25B7 Atis Duellocusu (saldiran)',
		DUELSHOOTINGDEF: ' \u25B7 Atis Duellocusu (savunan)',
		DUELVIGOR: ' \u25B7 Vurus Duellocusu',
		FORTATTACK: ' \u25B7 Kale savasi (saldiran)',
		...
		CONFIRM: 'Onayla !',
		HIDEJOBDESC: 'Çalismalar buradan kapatilabilir. Otomatik hesaplanmayacak tüm aktiviteleri isaretle, ve onayla butonuna tiklamalisiniz.',
		SHOWN: 'Etkin',
		HIDDEN: 'Pasif',
		...
		USEFULITEMSPOPUP : " \u25B7 Kutu | Ayrintilari ile vurgulaniyor"
};
	var twpro_langs = {};
	twpro_langs.fr = {
...
//				if(TWPro.prefs['usefulItemsPopup']) bagitems[twpro_bag].popup.refresh(); //cookie
  ...
  // fix TogglePin on minimmap when scrolling to town or player
	...
	// fix for Crafting page reload
	eval('Bag.loadItems = ' + Bag.loadItems.toString().replace(/this\.add\(bag_content\[i\]\);\s*}/,"this.add(bag_content[i]);}if (TWPro.twpro_calculated && $(\'window_inventory_content\')){TWPro.twpro_changeItem(-1);}"));
	eval('Bag.setContent = ' + Bag.setContent.toString().replace(/this\.add\(bag_content\[j\]\);\s*}/,"this.add(bag_content[j]);}if (TWPro.twpro_calculated && $(\'window_inventory_content\')){TWPro.twpro_changeItem(-1);}"));
...
/*
  ...
  som_scripts_list[1].push(1, twpro_version);
 ...
 if(document.getElementById('som_scripts_manager')){
	...
	else if(document.getElementById('active_som_script_92'+'414')){
		document.getElementById('active_som_script_92'+'414').src="/images/confirm_buttons/yes.png";
		document.getElementById('active_som_script_92'+'414').title='<b>'+twpro_version+'</b>';
	}
	else{
		document.getElementById('som_scripts_div').innerHTML = document.getElementById('som_scripts_div').innerHTML.replace("</table>","<tr><td><img id='active_som_script_92414' src='/images/confirm_buttons/yes.png' width='16' height='16' title='<b>"+twpro_version+"</b>'></td><td><a href='http://userscripts.org/scripts/show/92414' target='_blank'>TW Pro+</a></td><td>Zyphir</td></tr></table>");
	}
 }
 else{
