// ==UserScript==
// @name         Beta V1  Bux.to Auto Click
// @namespace      http://userscripts.org/users/334117
// @description    Auto Click Ads On Bux.to. Auto relads after 2-4mins if no ads are present. By JoeSimmons Re made by ME
...
sec.setAttribute("style", "background:url('http://farm3.static.flickr.com/2747/5732418458_af133258c6_z.jpg); color:#ddd; border:8px ridge #000; padding:5em; position:absolute; top:"+window.innerHeight/3+"px; left:"+window.innerWidth/2+"px; text-align:center;");
