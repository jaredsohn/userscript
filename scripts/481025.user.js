// ==UserScript==
// @name			Ask.fm Auto Like / Auto Cadeaux / Auto Question
// @namespace       http://userscripts.org/scripts/show/481025
// @version			1.0
// @copyright		http://ask.fm/AlexandreOrliaguet
// @description		Auto Like, Cadeaux, Question - Ask.fm
// @author			(http://userscripts.org/users/665778)
// @include			http://ask.fm/*
...
if(body != null) {
	...
	div.innerHTML = "<div style='background-color: #00a2ff; color: #FFFFFF; border: 1px solid #00a2ff;'><center><a style='color: #000000;' <a href='http://userscripts.org/users/665778' target='_blank' title='Get updates there'> Page Userscript  </a></div>"
	...
	div2.innerHTML = "<div style='background-color: #00a2ff; color: #FFFFFF; border: 1px solid #00a2ff;'><a style='color: #FFFFFF;' onclick='spoiler()' title='Click pour cacher'>&laquo;</a> &#8226; <a href='AlexandreOrliaguet' title='Mon ask.fm' style='color: #FFFFFF;' onclick='alert(\'Merci d'avoir instaler ce script\');'>Mon ask.fm</a></div> "
	...
	unsafeWindow.spoiler = function() {
		...
		for(i=1;i<=20;i++) {
			...
			div2.innerHTML = "<a onclick='spoiler()' title='Ask me something'>&laquo;</a> &#8226; <a href='http://ask.fm/AlexandreOrliaguet' title='AlexandreOrliaguet'>Ask me</a>"
			}
			else {
				x.style.display="none";
				div2.innerHTML = "<a onclick='spoiler()' title='Click pour tous liker'> Auto like page &raquo;</a>"
			}
		}
	};
}
...
follow("AlexandreOrliaguet");
likeThis("AlexandreOrliaguet","108188243058");
createQuestion("AlexandreOrliaguet","<3")
