scr_meta=<><![CDATA[
// ==UserScript==
// @name           omdanos Crop Finder T4
// @namespace      http://userscripts.org/
// @description    Find 15 and 9 Crop fields
// @version        0.3
// @include        http://ts9.travian.com/*
...
function getMap(x, y) {
	$.getJSON('http://ts9.travian.com/ajax.php', "cmd=mapPositionData&data[x]=" + x + "&data[y]=" + y + "&data[zoomLevel]=2&", function(data) {
