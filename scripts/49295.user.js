...
//
// ==UserScript==
// @name           the-West Arac paneli | -UnderTaker-
// @namespace      -underTaker-
// @description    The-west Türkce arac paneli
...
newShortcut("http://nsm01.casimages.com/img/2009/05/02//090502044443577973584859.png", "javascript:AjaxWindow.show('building_church',{town_id:24},'24');", "Bar");
newShortcut("http://nsm01.casimages.com/img/2009/05/02//090502044443577973584858.png", "javascript:AjaxWindow.show('building_bank',{town_id:24},'24');", "Kilise");

newShortcut("http://nsm01.casimages.com/img/2009/05/02//090502044444577973584860.png", "javascript:AjaxWindow.show('building_hotel',{town_id:24},'24');", "Hotel");

newShortcut("http://nsm01.casimages.com/img/2009/05/02//090502044442577973584857.png", "javascript:AjaxWindow.show('building_gunsmith',{town_id:24},'24');", "Silah_Tüccari");
newShortcut("http://nsm01.casimages.com/img/2009/05/02//090502044447577973584865.png", "javascript:AjaxWindow.show('building_tailor',{town_id:24},'24');", "Terzi");

newShortcut("http://nsm01.casimages.com/img/2009/05/02//090502044444577973584861.png", "javascript:AjaxWindow.show('building_general',{town_id:24},'24');", "Züccaciye");

newShortcut("http://nsm01.casimages.com/img/2009/05/02//090502044445577973584862.png", "javascript:AjaxWindow.show('building_mortician',{town_id:24},'24');", "Cenaze_Kaldırıcısı");
