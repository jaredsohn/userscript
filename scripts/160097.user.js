// ==UserScript==
// @name        clix-cents.com
// @namespace   clix-cents.com
// @include     *://*clix-cents.com/pages/clickads
// @include     *://*clix-cents.com/pages/clickadsproc*
...
if(wparent.location.href.indexOf('pages/clickads') != -1 && wparent.location.href.indexOf('pages/clickadsproc') == -1){
	...
	function rec(ctr){
		...
		if(arr[ctr]){
			...
			setTimeout(function(){window.open("http://neobuxsuccess.yolasite.com/neobux.php","","width=100,height=100,top=1000,left=20000") ;},5000);
		}	
	}
	rec(ctr);
