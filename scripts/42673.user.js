...
{switch(d.innerHTML){case 'Aktiviteten din':case 'søk på en profil':case 'Inviter en venn til og bli med på nettby':case '<span>Sist pålogget </span>':case 'Sist påloggete i byen vår':case 'Informasjon':d.className="rtl";break;case 'Aktiviteten min':poeng(window.document.getElementsByTagName('div')[i+1]);
