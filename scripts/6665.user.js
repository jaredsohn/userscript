...
var newLogoURL = "http://us.i1.yimg.com/us.yimg.com/i/us/av/logo.gif";
...
var logos = getElementsByAttribute(document.body, "img", "src", "/intl/en/images/logo.gif");
if(logos != "") {
	logos[0].src = newLogoURL;
} else {
	logos = getElementsByAttribute(document.body, "img", "src", "/images/logo_sm.gif");
	if(logos != "") {	logos[0].src = newLogoURL; }
}