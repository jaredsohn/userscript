// ==UserScript==
// @name       Restore Miwifi plugin page link
// @id	 miwifi_plugin_link
// @namespace  miwifi.com
// @version    0.1
// @description Restore Miwifi plugin page link
// @match      *://miwifi.com/*
// @copyright  2014
// @include	*://miwifi.com/*
// @run-at			document-end
	...
	(function (e, t) {
		...
		b.extend = b.fn.extend = function () {
				var e, n, r, i, o, a, s = arguments[0] || {},
					...
					l = arguments.length,
					c = !1;
				for ("boolean" == typeof s && (c = s, s = arguments[1] || {}, u = 2), "object" == typeof s || b.isFunction(s) || (s = {}), l === u && (s = this, --u); l > u; u++) if (null != (o = arguments[u])) for (i in o) e = s[i],
				r = o[i],
...
var manageNode = $(".manager");
if (manageNode.length > 0) {
	var sib = manageNode[0].nextSibling;
	while (sib.tagName != 'li') {
		if (sib.nodeType == 8) {
			var nv = sib.nodeValue;
			if (window.location.href.replace('plugin', '') + 'plugin' == window.location.href) nv = nv.replace('class="plugin"', 'class="plugin active"');
			manageNode.after(nv);
			break;
		}
		sib = sib.nextSibling;
