...
#right_column{width: 740px; float:right;position:fixed;top:42px;z-index: -2;}\
#folder_container{ padding:10px !important; padding-top:20px; !important margin-left:590px;margin-top:0px; float:right;width:120px;line-height:16px; font-family:   Helvetica, Arial, sans-serif;font-size:11px !important; border-width: 1px; border-style: solid; border-color: #a4a4a4; border-radius: 15px 15px; -webkit-border-radius: 15px 15px; -moz-border-radius: 15px 15px; background: #f3f3f3;-webkit-box-shadow: 2px 2px 5px #666; -moz-box-shadow:2px 2px 5px #666; box-shadow:2px 2px 5px #666;z-index: -1;position:relative;}\
...
#folders div a{font-size:10px !important;font-weight:normal !important;}\
#bookmarkListDeckAd, #download_as,#tools_container,h3.section_header{display: none;}\
...
#story{padding-left:70px;padding-right:70px;padding-bottom:30px;padding-top:30px;background:#FFFFFF !important;top repeat-x;font-size: 18px;line-height:22px;}\
