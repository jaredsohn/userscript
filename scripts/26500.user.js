// ==UserScript==
// @name           Twitter Enhancements: Retweet This
...
// =================  MAIN ================= 
var statusBodyElems = document.getElementsByClassName('status-body');
if (!statusBodyElems) return;
for (var i = 0; i < statusBodyElems.length; i++)
  addRetweetButtonToEntry(statusBodyElems[i].parentNode);