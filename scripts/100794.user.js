	...
	EmpireBoard.ARexx.RegisterAddOn = function(AddOn)
		...
		if (this._Parent.Ikariam.Is_Logged() == true)
			...
			if (isOK == false)
				...
				this._Parent.Ikariam.Insert_Warning('Require <a href="http://userscripts.org/scripts/show/100793">Ikariam Empire Board</a> version '+AddOn.EmpireBoardRequiredVersion+' (or higher) with highest priority than this add-on.', AddOn.AddOnName);
				return false;
				}
