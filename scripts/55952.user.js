...
function addThirdPartyTools() {
	var thirdPartyTools = [
		{aname: 'PeeKaBooh',	aid: '1408159',	name: 'eRepublik Plus',					url: 'http://www.erepublik.com/' + LOCALE + 'article/erepublik-plus-grand-tutorial-807662/1/20', img: 'http://static.erepublik.com/uploads/avatars/Newspapers/2009/05/15/81f97d040a2b499d539e0a7f61ce3788_55x55.jpg'},
...
function addNationalForums() {
	var nationalForums = [
		...
		{country: 'Romania', 			url: 'http://www.ecetateni.com/', 					name: 'eCetateni.com :: Comunitatea romanilor din eRepublik - Index'},
		...
		{country: 'Colombia',	 		url: 'http://erepublikcol.foroactivo.com/', 		name: 'Erepublik Colombia'},
		{country: 'Chile',	 			url: 'http://echile.foroactivo.net/', 				name: 'Foro gratis : foro de todos los echile de erepubli'},
		{country: 'Canada', 			url: 'http://ecanada.forumotion.com/', 				name: 'The eCanadian Forums - For eCanadians everywhere'},
		...
		{country: 'Bolivia',			url: 'http://ebolivia.forums-free.com/',			name: 'Foro - e-Bolivia'},
...
function saveLink(obj, what) {
	...
	if (GM_getValue(cID + 'eR_QL') != undefined)
		...
		lLinks = ['Link 1', '', '', 'Link 2', '', '', 'Link 3', '', '', 'Link 4', '', '', 'Link 5', '', '', 'Link 6', '', '', 'Link 7', '', '', 'Link 8', '', '', 'Donate to PeekaBooh', 'http://www.erepublik.com/' + LOCALE + 'citizen/donate/items/1408159', 'false', 'eRepublik Plus', 'http://www.erepublik.com/' + LOCALE + 'newspaper/erepublik-plus-187657/1', 'false'];
...
function addAllCommentsAndTranslate() {
	...
	$("div.articlecontent div.largepadded a.dotted").each(function(i) {
		...
		$("#translate_news").click(function() {
			$("#translate_news").text(" Undo translate");
