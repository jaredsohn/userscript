// ==UserScript==
// @name Ogame FR : Standard buildings.php (Shipyard)
// @author Izcelion
// @description Ogame FR : Standard buildings.php (Shipyard)
// @language FR
// @include http://*/game/buildings.php*mode=Flotte*
...
if (isFinite(GetUniverse())){
	...
	//alert("Standard buildings.php (Shipyard) => Resize Image");
	...
	//alert("Standard buildings.php (Shipyard)");
