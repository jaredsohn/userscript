// ==UserScript==
// @name           Twitter Non-native Retweet MOD (Elliot MOD)
// @namespace      @Eleuterio_
...
(function() {
    ...
    function register() {
            ...
            setTimeout(function() {
                var impl = function($) {
                    try
                    {
                        ...
                        var box = $("#global-tweet-dialog .tweet-box:visible, #tweet_dialog .twitter-anywhere-tweet-box-editor:visible");
                        box.val(content);
                        box.focus().mouseup();

                        // Must be delayed, otherwise it doesn't work
                        setTimeout(function() {
                            box.get(0).setSelectionRange(0, 0);
                        }, 0);
                    } catch (e) {
                        console.error(e);
                    }
        ...
        document.addEventListener('DOMContentLoaded', function (e) {
            var tweets = document.getElementById("timeline").getElementsByClassName("js-stream-tweet");
