...
// @name           buxdotcom
// @namespace      
// @description    auto clicks buxdotcom ads
// @include        http://www.buxdotcom.com/surf.php
// ==/UserScript==

//original script by dt (bux.to), modified by flameboy


const surfTable = '//table[@width="728"]';
const linksx = '//a[@href]';
var currentWindow;
var currentElement;
var links;
...
function getLinks(){
	...
	for(var i=0;i<links.snapshotLength;i++){
		...
		if ((item.href.substring(0,37)=='http://www.buxdotcom.com/view.php?ad=') &&
			!(item.href=='http://www.buxdotcom.com/view.php?ad='))
			work.push(item);
	}
