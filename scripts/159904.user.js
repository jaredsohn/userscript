// ==UserScript==
// @name        PaisaLive by Raunak
// @namespace   http://pasalivehacked4u.blogspot.in
...
$(function(){
	$("body").append('<div class="banner" style="height: 40px; width:100px; right:20px; color:white; padding:5px; border-radius:5px; top:3px; overflow:auto; display: block;"><a href="http://www.ogean.com/?ref=49128" target="_blank" id="start">Click Here to Start Checking Mail</a></div>');
	$("#start").click(function(){
		$(this).parent().html("please Click To Go to OGN And Then Reload this Page after 10sec.");
