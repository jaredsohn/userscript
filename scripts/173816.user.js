...
var magnetLink = '<a href="'+magnet+'" title="Get this torrent" style="background-image: '+'url(\'//static.thepiratebay.sx/img/icons/icon-magnet.gif\');margin-right:15px">Magnet Link</a>';

var torrentLink = '<a href="http://torrents.thepiratebay.sx/'+id[0].value+'/'+name+'.torrent" title="Torrent File" style="margin-right:15px">Torrent File</a>';

var proxiedTorrent = '<a href="http://www.americanproxy.org/browse.php?u=http://torrents.thepiratebay.sx/'+id[0].value+'/'+name+'.torrent" title="Torrent File" style="margin-right:15px">Torrent From Proxy</a>';
