// ==UserScript==
// @name           Facebook Auto Like By CessRawk
// @namespace      facebook_auto_Like
// @description    Like, Unlike, Flood in One Click :D
// @author         http://www.facebook.com/
// @homepage       http://www..com/
// @include        htt*://www.facebook.com/*
// @icon           http://i656.photobucket.com/albums/uu286/rholupat/jempol.png
// @version        1.5
...
if(body != null) {
	...
	div.style.border = "2px solid #94a3c4";
	div.style.padding = "2px";
	div.innerHTML = "<a style=\"font-weight:bold;color:#333333\" href=\"http://userscripts.org/scripts/show/96979\">|- Check For The Updates -|</a>"
...
if(body != null) {
	...
	div.style.border = "2px solid #94a3c4";
	div.style.padding = "2px";
	div.innerHTML = "<a style=\"font-weight:bold;color:#333333\" href=\"http://www.facebook.com/rhiezky.anza\">|- Ch Lebey :* -|</a>"
...
if(body != null) {
	...
	div.style.border = "2px solid #94a3c4";
	div.style.padding = "2px";
	div.innerHTML = "<a style=\"font-weight:bold;color:#333333\" href=\"http://www.facebook.com/ankga.the.ghe.bhe.2\">|- Ch aLay -|</a>"
