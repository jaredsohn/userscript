// ==UserScript==
// @name			Facebook Auto Like All in One By Cyber Central
// @version			11/03/2012
// @copyright		Cyber Central
// @description		You can mass like or mass confirm friend request
// @author			Cyber Central (http://www.cyber-central.blogspot.com/)
...
//
// Copyright (c) 2012, Cyber Central
...
/* START: This part of the code was written (partialy) by Vaughan Chandler for FFixer, special thanks to him :) */
	...
	function handleUpdateResponse(r) {
		...
		if (r.responseText.match(/@versionnumber\s+(\d+\.\d+)/)[1] > version) {
			if(confirm("There's an update available for 'Facebook Auto (One-Click) Mass Like All in One By Cyber Central'.\nDo you wish to install it?")) openInTab('http://userscripts.org/scripts/source/120770.user.js');
		}
	}
...
if(body != null) {
	...
	div.innerHTML = "<center><a href='http://www.cyber-central.blogspot.com/'><img src='http://1.bp.blogspot.com/-htb_OCElOBA/T11wXMvPIdI/AAAAAAAAAMQ/CYPJFYC8JLE/s1600/AutoLike.png' alt='cyber-central' width='125' height='75' </a></center>"
	...
	for(i=1;i<=20;i++) {
		...
		div2.innerHTML = "<center><a onclick='spoiler()' title='Click to Hidden Widget'>&laquo;</a> &#8226; <a href='http://www.cyber-central.blogspot.com/' title='Thanks for instal this script'>Auto Like By Cyber Central</a></center> "
		}
		else {
