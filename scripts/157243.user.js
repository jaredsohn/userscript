// ==UserScript==
// @name            fotki.yandex.ru.better
// @version         2013.01.22
// @description     让图床更友好的展示 - 俄罗斯图床
// @downloadURL	    http://userscripts.org/scripts/source/157243.user.js
// @updateURL       http://userscripts.org/scripts/source/157243.meta.js
// @copyright       2013 - The CYW
// @include         http://*fotki.yandex.ru/users*
// @icon            http://fotki.yandex.ru/favicon.ico
// @grant           none
// ==/UserScript==
...
function main(){
    ...
    YaSlideshow.prototype.keyDownHandler = function(evnt){
        //enter
        if(evnt.which == 13 || evnt.which == 39 || evnt.which == 40){
            if(evnt.ctrlKey){
                this.play();
            }
            else{
        ...
        if(evnt.which == 37 || evnt.which == 38){
            if(evnt.ctrlKey){
                this.play();
            }
            else{
    ...
    YaSlideshow.prototype.goPrev = function(){
        if(this.prev){
            this.getImgSize(this.prev, this.switchImage);
