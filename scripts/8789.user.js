// ==UserScript==
// @name          Tribal eXtension! v3.0.2.1
// @namespace     http://none
// @description   Conjunto de Utilidades para TribalWars v3.0.2.1 by JonnyD
...
function twLoadingData(mode)
{
	...
	{ 
		...
		newHTML.innerHTML = '<div style="width:300px;margin-top:150px;margin-bottom:auto;background-color:#F8F4E8;border:2px solid #804000;padding:30px 30px 30px 40px;margin-left:auto; margin-right:auto;"><img src="http://i184.photobucket.com/albums/x195/twextension/loading.gif" border="0" ><br><b>Actualizando datos...</b></div>';
...
function twInitialize()
{
	...
	twLanguage["es"]["mainMenu"] = new Array ("Salir", "Foro", "Chat", "Ayuda", "Opciones", "Premium", "Clasificaci&oacute;n", "Tribu", "Informes", "Mensajes"); 
	...
	twLanguage["es"]["units"] = new Array("Lancero", "Guerrero a Espada", "Guerrero de Hacha", "Esp&iacute;a", "Caballer&iacute;a Ligera", "Caballer&iacute;a Pesada", "Ariete", "Catapulta", "Los Arist&oacute;cratas");
	...
	twLanguage["es"]["resources"] = new Array ("Madera", "Barro", "Hierro", "Almac&eacute;n");
...
function twShowInfoResources()
{
	...
	newDiv += "		<tbody>";
	newDiv += "			<tr>";
	newDiv += "				<th style='background-color:#804000;color:#fff;width:auto;height:29px;padding:2px 2px 2px 2px;margin-right:5px'>Recursos: </th>";
...
function twShowInfoFarm()
{
	...
	newDiv += "	<tbody>";
	newDiv += "		<tr>";
	newDiv += "			<th style='background-color:#804000;color:#fff;width:auto;height:29px;padding:2px 2px 2px 8px;'>Granja: </th>";
...
function twShowInfoArmy(village_id)
{
	...
	newDiv += "	<tbody>";
	newDiv += "		<tr>";
	newDiv += "			<th style='background-color:#804000;color:#fff;width:auto;height:28px;padding:2px 2px 2px 2px;'>Tropas: </th>";
	for(var i=0;i<9;i++){
...
{
		var newHTML ="";
		newHTML += "<h2>Resumen Global de Tropas</h2>";
...
{	
	try{
		...
		newDiv += '				<td><a href="'+twLinks["twMainMenuArray"]["overview"]+'"><img src="'+twGlobalInfo["InterfaceItems"][4]+'" title="Visi&oacute;n General del Pueblo" />&nbsp;</a></td>';
		newDiv += '				<td><a href="'+twLinks["twMainMenuArray"]["map"]+'"><img src="'+twGlobalInfo["InterfaceItems"][5]+'" title="Ir al Mapa" />&nbsp;</a></td>';
		newDiv += '				<td><a href="'+twLinks["twMainMenuArray"]["villages"]+'"><img src="'+twGlobalInfo["InterfaceItems"][8]+'" title="Resumen global de Pueblos" />&nbsp;</a></td>';
		newDiv += '				<td><a id="btnShowAllArmy" href="javascript:void(0)"><img src="'+twGlobalInfo["InterfaceItems"][6]+'" title="Resumen global de Tropas"/>&nbsp;</a></td>'
		newDiv += '			</tr>'
		newDiv += '		</tbody>';
		newDiv += '	</table>';
		newDiv += '</div>';
...
function twMainMenuNavigationBar()
{
	...
	codeNavBar +=				'<ul>';
	codeNavBar +=					'<li><a href="'+twLinks["twMainMenuArray"]["mails"][3]+'">Crear Mensaje</a></li>';
	codeNavBar +=					'<li><a href="'+twLinks["twMainMenuArray"]["mails"][0]+'">Buz&oacute;n Entrada</a></li>';
	codeNavBar +=					'<li><a href="'+twLinks["twMainMenuArray"]["mails"][1]+'">Buz&oacute;n Salida</a></li>';
	codeNavBar +=					'<li><a href="'+twLinks["twMainMenuArray"]["mails"][2]+'">Archivo</a></li>';
	codeNavBar +=					'<li><a href="'+twLinks["twMainMenuArray"]["mails"][4]+'">Bloquear</a></li>';
	codeNavBar +=				'</ul>';
	...
	codeNavBar +=				'<ul>';
	codeNavBar +=					'<li><a href="'+twLinks["twMainMenuArray"]["reports"][0]+'">Todos</a></li>';
	codeNavBar +=					'<li><a href="'+twLinks["twMainMenuArray"]["reports"][1]+'">Ataques</a></li>';
	codeNavBar +=					'<li><a href="'+twLinks["twMainMenuArray"]["reports"][2]+'">Defensa</a></li>';
	codeNavBar +=					'<li><a href="'+twLinks["twMainMenuArray"]["reports"][3]+'">Apoyos</a></li>';
	codeNavBar +=					'<li><a href="'+twLinks["twMainMenuArray"]["reports"][4]+'">Comercio</a></li>';
	codeNavBar +=					'<li><a href="'+twLinks["twMainMenuArray"]["reports"][5]+'">Otros</a></li>';
	codeNavBar +=				'</ul>';
	codeNavBar +=			'</li>';
	...
	codeNavBar +=				'<ul>';
	codeNavBar +=					'<li><a href="'+twLinks["twMainMenuArray"]["ally"][0]+'">Vista General</a></li>';
	codeNavBar +=					'<li><a href="'+twLinks["twMainMenuArray"]["ally"][1]+'">Socios</a></li>';
	codeNavBar +=					'<li><a href="'+twLinks["twMainMenuArray"]["ally"][2]+'">Perfil</a></li>';
	codeNavBar +=					'<li><a href="'+twLinks["twMainMenuArray"]["ally"][3]+'">Diplomacia</a></li>';
	codeNavBar +=					'<li><a href="'+twLinks["twMainMenuArray"]["ally"][5]+'">Invitaciones</a></li>';
	...
	if(	str.match("ally_forum") != null)
		...
		codeNavBar +=					'<li><a href="'+twLinks["twMainMenuArray"]["ally"][4]+'">Foro</a></li>';
	codeNavBar +=				'</ul>';
	codeNavBar +=			'</li>';

	codeNavBar +=	'<li><a href="javascript:void(0)">&nbsp;Utilidades</a>';
	codeNavBar +=		'<ul>';
	...
	codeNavBar +=					'<li><a href="'+twLinks["twMainMenuArray"]["ranking"][0]+'">Por Jugadores</a></li>';
	codeNavBar +=					'<li><a href="'+twLinks["twMainMenuArray"]["ranking"][1]+'">Por Tribus</a></li>';
	codeNavBar +=					'<li><a href="'+twLinks["twMainMenuArray"]["ranking"][2]+'">Por Adv. Vencidos</a></li>';
	codeNavBar +=				'</ul>';
	codeNavBar +=			'</li>';
...
function twRankingBar()
{
	...
	newHTML += '<div style="position:absolute;top:115px;left:205px;width:700px;">';
		...
		newHTML += '	<div style="float:left;"><img  src="'+twGlobalInfo["InterfaceItems"][9]+'" width="30" height="28" border="0" alt=""  /></div>';
		newHTML += '	<div style="float:left;width:141px;height:22px;margin-top:3px;background-image:url(\''+twGlobalInfo["InterfaceItems"][10]+'\');background-repeat:repeat-x"><div style="margin:3px;color:#804000;font-weight:bold">Opci&oacute;n desactivada</div></div>';
		newHTML += '	<div style="float:left;margin-top:3px"><img  src="'+twGlobalInfo["InterfaceItems"][11]+'" width="9" height="22" border="0" alt="" /></div>';
		newHTML += '</div>';
...
function twBuildingsBar()
{
	...
	newHTML += '	<area id="MarketIcon" title="Plaza del Mercado" shape="poly" alt="" coords="0,287, 9,281, 29,281, 33,277, 40,277, 44,281, 45,288, 41,294, 36,295, 36,303, 29,310, 6,311, 0,304" href="'+twLinks["twMainScreens"][7]+'" />';
	newHTML += '	<area id="SmithIcon" title="Herrer&iacute;a" shape="poly" alt="" coords="0,251, 9,245, 29,245, 33,241, 40,241, 44,245, 45,252, 41,258, 36,259, 36,267, 29,274, 6,275, 0,268" href="'+twLinks["twMainScreens"][5]+'" />';
	newHTML += '	<area id="PlaceIcon" title="Plaza de reuniones" shape="poly" alt="" coords="0,214, 9,207, 27,207, 33,202, 41,204, 44,208, 45,214, 42,219, 36,222, 36,230, 29,236, 8,236, 0,231" href="'+twLinks["twMainScreens"][6]+'" />';
	newHTML += '	<area id="SnobIcon" title="Corte Aristocr&aacute;tica" shape="poly" alt="" coords="0,176, 9,170, 29,170, 33,166, 40,166, 44,170, 45,177, 41,183, 36,184, 36,192, 29,199, 6,200, 0,193" href="'+twLinks["twMainScreens"][4]+'" />';
	newHTML += '	<area id="GarageIcon" title="Taller" shape="poly" alt="" coords="0,142, 7,135, 28,136, 32,132, 37,130, 42,133, 45,140, 42,147, 36,150, 36,158, 29,165, 7,165, 0,159" href="'+twLinks["twMainScreens"][3]+'" />';
	newHTML += '	<area id="StableIcon" title="Cuadra" shape="poly" alt="" coords="0,105, 7,98, 29,98, 33,93, 40,93, 44,99, 45,106, 41,112, 36,113, 36,121, 29,128, 7,127, 0,122" href="'+twLinks["twMainScreens"][2]+'" />';
	newHTML += '	<area id="BarracksIcon" title="Cuartel" shape="poly" alt="" coords="0,67, 9,61, 29,61, 33,57, 40,57, 44,61, 45,68, 41,74, 36,75, 36,83, 29,90, 6,91, 0,84" href="'+twLinks["twMainScreens"][1]+'" />';
	newHTML += '	<area id="MainIcon" title="Edificio Principal" shape="poly" alt="" coords="0,30, 9,24, 29,24, 33,20, 40,20, 44,24, 45,31, 41,37, 36,38, 36,46, 29,53, 6,54, 0,47" href="'+twLinks["twMainScreens"][0]+'" />';
	newHTML += '</map>';
