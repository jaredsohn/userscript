// ==UserScript==
// @name           Feuerwache.net AAO Script by MasterJM - Hogsmeade
...
var UPDATEURL="http://userscripts.org/scripts/show/79754";
// unter welchem URL finde ich das Script als Installation?
var INSTALLURL="http://userscripts.org/scripts/source/79754.user.js";
...
var Einsatzklassen = {
  ...
  'Baum auf Straße'             : 'F1',
  'Brand in KFZ-Werkstatt'      : 'F3+Kran',
  'Brand in Schule'             : 'F4+GW-A',
  'Brand in Spedition'          : 'F4G',
  'Brand in Sporthalle'         : 'F3+LF,GW-A,GW-L',
  'Brand im Sägewerk'           : 'F3+LF,GW-A,GW-L',
  'Brand im Supermarkt'         : 'F3+DL,Kran',
  'Brennende Bäume'             : 'F1',
  ...
  'Kinobrand'                   : 'F4+TLF,GW-A',
  'Motorrad-Brand'              : 'F1',
  'Mülleimer Brand'             : 'F1',
  'Scheunenbrand'               : 'F3+GW-L',
  'Schornsteinbrand'            : 'F2+DL',
  'Silobrand'                   : 'F3',
  'Sperrmüllbrand'              : 'F1',
  'Strohballen Brand'           : 'F2+GW-L',
  'Traktorbrand'                : 'F1',
  'Verkehrsunfall'              : 'TH1+GWÖl',
  'Wohnblockbrand'              : 'F3+LF,LF,GW-A',
  'Wohnungsbrand'               : 'F2',
// neue Einsatztypen (chronologisch, neuste unten (ab 28.12.2009)
  'Gewerbebrand'                : 'F4+GW-A,RW',
  'Feldbrand'                   : 'F1+GW-L',
...
// Einsätze neu ab 08.03.2010 (zehn neue Einsätze)
  ...
  'Brand in Zugdepot'           : 'F4+GW-L,RW,GW-S',
  'Brand in Autohaus'           : 'F4+GW-A,GW-M',
  'Brand in Druckerei'          : 'F4+GW-A,GW-L,RW',
  'Brand in Lackfabrik'         : 'GSG3',
// Einsätze neu ab 29.03.2010 (drei neue Einsätze)
  'Trocknerbrand'               : 'F1',
  'Brand in Reifenlager'        : 'GSG+GW-L,LF',
  'Brand im Casino'             : 'F5',
// Einsätze neu ab 23.04.2010 (zehn neue Einsätze)
  ...
  'Kaminbrand'                  : 'F1+DL',
  'PKW in Fluss'                : 'TH1+GW-T,Kran',
  'Brand in Schloss'            : 'F3+DL',
  'Brand in Kühlhaus'           : 'F5G',
  'Feuer im Krankenhaus'        : 'MANV',
...
// zu undef = unbekannten Einsatzen wird per Default jetzt ein LF geschickt
  ...
  'F3G'      :  'LF,LF,LF,LF,ELW,RW,GW-M,GW-G,GW-A',
  'F4G'      :  'LF,LF,LF,LF,ELW,DL,RW,TLF,GW-M,GW-G,GW-L',
  'F5'       :  'LF,LF,LF,LF,LF,DL,ELW,TLF,GW-A,GW-L',
  'F5G'      :  'LF,LF,LF,LF,LF,DL,ELW,GW-L,GW-G,GW-M',
  'TH1'      :  'RW,LF',
  'TH2'      :  'RW,LF,LF',
  'GSG'      :  'LF,LF,ELW,GW-M,GW-G',
  'GSG2'     :  'LF,LF,ELW,GW-M,GW-G,RW',
  'GSG3'     :  'LF,LF,LF,LF,ELW,DL,GW-A,GW-M,GW-G', 
  'MANV'     :  'LF,LF,LF,LF,LF,ELW,GW-L,RW,GW-M,GW-G,GW-A',
};
...
/*
  ...
  aufgeführt werden.
*/
  "Hier muss Wasser über weite Wegstrecken transportiert werden. Wir benötigen einen GW-L2 Wasser." : "GW-L",
  "Das Feuer ist weiter ausserhalb und alle Wasserreserven sind aufgebraucht. Wir brauchen einen GW-L2 -Wasser um weitere Schläuche verlegen zu können." : "GW-L",
  "Um Leitungen über weite Strecken legen zu können, benötigen wir einen GW - L2 - Wasser." : "GW-L",
};
...
var Strassennamen = new Array(
  ...
  // MIAXMIMAL 999 Strassen eintragen !!!!!
  //
'Drei-Besen-Straße', 'Gründer-Axel-Straße / Allee zum heiligen Axel', 'Straße zum Therapiezentrum', 'Winkelgasse', 'Hexenallee', 
'Zauberweg', 'Muggelweg', 'Snape-Gasse', 'Joanne-K.-Rowling-Ehrenallee', 'Dumbledore-Gedächtnis-Allee', 'Professor-Flitwick-Weg', 
...
'Dobby’s Weg', 'Ligusterweg', 'Ministeriumweg', 'Little-Whinging-Straße', 'Harry-Potter-Allee', 
'Lord-Voldemort-Hass-Straße / Du-weißt-schon-wer-Hass-Weg', 'Horlrux-Straße', 'Lucius-Malfoy-Gasse', 'Straße-Des-Brotes', 
'Landwirtschaftsweg / Träkkerweg', 'Hogsmeadeallee', 'Hermine-Granger-Weg', 'Am Hagrid-Hügel', 'Ronald-Weasley-Straße', 
...
'Professor-Dippet-Weg', 'Bibliothekarin-Pince-Gasse', 'Godric-Griffindor-Allee', 'Helga-Hufflepuff-Allee', 'Rowena-Ravenclaw-Allee', 
'Salazar-Slitherin-Allee', 'Draco-Malfoy-Gasse', 'Vincent-Crabbe-Weg', 'Gregory-Goyle-Straße', 'Pansy-Parkinson-Weg', 'Katie-Bell-Gasse', 
...
'Leitstellengasse', 'Feuerplatz', 'Griffindor-Allee', 'Hufflepuff-Allee', 'Ravenclaw-Allee', 'Slitherin-Allee', 
'Weg zum Schulleiterbüro', 'Wasserspeierstraße', 'Brandstraße', 'Godric’s-Hollow-Straße', 'Schlacht-um-Hogwarts-Straße', 
'Gemeinschaftsraumstraße-Griffindor', 'Gemeinschaftsraumstraße-Hufflepuff', 'Gemeinschaftsraumstraße-Ravenclaw', 
'Gemeinschaftsraumstraße-Slitherin', 'Große-Halle-Weg', 'U-Bahn-Station-Straße', 'Einsatzallee', 'Hilfeleistungsweg', 
'Rettungsgasse / Rettungsweg', 'Rätselstraße', 'An der heulenden Hütte', 'Küchenweg von Hogwarts', 'Anleitungsgasse', 
...
'Afshad-Ayres-Allee', 'Daisy-Bates-Weg' 
);
...
{ var DC=document.getElementById("content");
  ...
  H += "<h2><a href='javascript:toggledisplay();';>Toggle: Fahrzeuge nach Zustand auflisten</a></h2>";
  H += "<br>\n";
  NewDiv.innerHTML = H;
...
// ************************************************************************************
  ...
  if (InfotextEinsatzort) Info += InfoVorspann + "Einsatzort</th><td>" + InfotextEinsatzort + "</td></tr>\n";
  ...
  if (InfotextVerfuegbar) Info += InfoVorspann + "<a target='_new' href='http://www.feuerwache.net/feuerwehrfahrzeuge'>verfügbar</a></th><td><font color='green'><font size='1'>" + InfotextVerfuegbar + "</font></font></td></tr>\n";
  Info += "</table>\n";
  ...
  { for each (TD in document.getElementsByTagName("td"))
    { for each (A in TD.getElementsByTagName("a"))
      { if ( A.href.indexOf("http://www.feuerwache.net/feuerwehr-einsaetze/") == 0)
        { TD.innerHTML += "<span style='padding-right:2px; float:right;'><font color='red'>(" + getEinsatzKlasse(A.innerHTML) + ")</font></span>";
        }
      }
    }
  }
