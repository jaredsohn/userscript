...
// @name           YouTube Permalink

// @namespace      Youtube permalink
// @description    Permalink for youtube work best with
 http://userscripts.org/scripts/show/37874
...
(function () {
  ...
  if (video_id==null || video_hash==null) return;
   ...
   var yt_self_path ='http://www.youtube.com/watch?v='+video_id; 
   ...
   if (div_embed) {      
     ...
     div_download.innerHTML = '<br /> <span id=\'download-youtube-video\'> <a href=\''+yt_self_path+'\'>Permalink</a> '+ ((navigator.userAgent.indexOf('Safari')!=-1)?'(control-click and select <i>Download linked file as</i>)' : ('')) 
