...
if (Einsatzstichwort.indexOf('>' ) < 0)
var Einsatzart = Art(Einsatzstichwort.substring(14, Einsatzstichwort.length));
else
var Einsatzart = Art(Einsatzstichwort.substring(Einsatzstichwort.indexOf('>' )+14, Einsatzstichwort.length));
  // Einsatzart in Webseite anzeigen:
  // neuen Abschnitt anlegen:
  var InfoBereich = document.createElement("h2");
  InfoBereich.innerHTML = "Einsatzinformationen";
...
function PushFahrzeuge(Einsatzart)
{
  switch (Einsatzart)
  {
    ...
    case "F2DL":
      ...
      break;
    case "F2AS":
      ToAlarm.push("LF","LF","ELW","GW-A");
      break;
    case "F2TLF":
      ToAlarm.push("LF","LF","TLF","GW-W","GW-A");
      break;
    case "F3":
      ToAlarm.push("LF","LF","LF","ELW","DL","GW-A","GW-W");
      break;
    case "F3TLF":
      ToAlarm.push("LF","LF","LF","ELW","DL","GW-A","GW-W","TLF");
      break;
    case "F4":
      ToAlarm.push("LF","LF","LF","LF","ELW","DL","GW-A","GW-W");
      break;
    case "Wohnblockbrand":
      ToAlarm.push("LF","LF","LF","LF","LF","LF","LF","LF","ELW","DL","TLF");
      break;
    case "F4-Gefahrgut":
      ToAlarm.push("LF","LF","LF","LF","ELW","DL","GW-A","GW-W","GW-M","GW-G");
      break;
      case "Chemieunfall":
      ToAlarm.push("ELW","LF","LF","LF","LF","LF","DL","GW-A","RW","TLF","TLF","GW-W","GW-M","GW-G");
      break;
      case "Chlorgas":
      ToAlarm.push("ELW","LF","LF","LF","LF","DL","GW-A","RW","TLF","GW-W","GW-M","GW-G");
      break;
      case "ETH":
      ToAlarm.push("RW");
      break;
