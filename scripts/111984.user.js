// ==UserScript==
// @name           Comunidad T! Chapines
// @namespace      taringa
// @include        *taringa.net/*
// @exclude        *taringa.net/comunidades/chapines/*
// ==/UserScript==
...
byClass('menuTabs').innerHTML += "<li id=\"tabbedWTF\" class=\"tabbed registrate\">\n <a href=\"http://www.taringa.net/comunidades/chapines/\" onclick=\"menu(\'T! Chapines \', registro_load_form(); return false;\" title=\"Ir a la comunidad T! Chapines\">T! Chapines <img src=\n\"http://www.colgate.com/Colgate/US/HomePage_v2/nav/flags/guatemala.jpg\" alt=\"GarifunaX\" /></a>\n</li>";

var ancho=200;


var estiloCuadrito="width:"+ancho+"px;background-color:white;position:fixed;left:0px;top:0px;border:1px solid #F8F8FF;padding:0px;-moz-border-radius:5px;"
...
function procesarEventos()
{
  if(con.readyState == 4)
  {
    ...
    div.innerHTML="<div style='background-color:#40BF00;color:blue;padding:3px;'><b>"+autor+"</b></div><div style='padding:3px;'>"+texto+"</div>";                       
  } 
  else 
  {    
    div.innerHTML = '<div align="center"><img src="" alt="bunchie"></div>';
  }
}
