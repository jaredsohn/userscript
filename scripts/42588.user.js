// ==UserScript==
// @name           Draugu sarasas
// @namespace      transleyted by Nautilijus original made by Gorzong
// @description    Draudu sarasas
// @include        http://*ikariam.*/index.php*
// ==UserScript==
// ==UserScript==
// @name           IkariamCityList
// @version        0.5
// @namespace      Gorzong
// @description    This script adds a small button to your Ikariam playfield. On mouseover a field will expand where you will be able to add friends/Enemys/Cows and their respective URLs to a list allowing quick access to their islands.
// @include        http://*ikariam.*/index.php*
// ==/UserScript==
// ===========================================================================
// This script has been made by Elnaira (c) http://www.arisen-guild.com. 
// Added on by Gorzong.
// Remember this is still in beta. Please leave comments, tips, suggestions and feedback behind at http://userscripts.org/scripts/show/32826
//
// 		Beta
//
...
unsafeWindow.flAddFriend = function(){
	...
	if(flNewName.value == "" || flNewName.value == flNewName.defaultValue || flNewLink.value == "" || flNewLink.value == flNewLink.defaultValue){
		return alert("Prasom uzpildyti visus laukus");
	}
...
unsafeWindow.flDeleteFriend = function(FriendName, FriendLink){
	...
	var flConfirm = confirm("Ar tikrai norite istrinti " + FriendName + "?");
...
unsafeWindow.flDeleteEnemy = function(EnemyName, EnemyLink){
	...
	var flConfirm = confirm("Ar tikrai norite istrinti " + EnemyName + "?");
...
unsafeWindow.flDeleteTrade = function(TradeName, TradeLink){
	...
	var flConfirm = confirm("Ar tikrai norite istrinti " + TradeName + "?");
...
unsafeWindow.flToggleFrame = function(nr){
	...
	if(nr == 1){
		document.getElementById("flButtonArea").innerHTML = '<div id="flHeader" onClick="flToggleFrame(0);">Miestu sarasas</div>';
...
unsafeWindow.flExport = function(){
	...
	if(IkariamFriendList == "0"){
		return alert("Draugu sarasas tuscias");
	}
...
if(IkariamFriendList == "0"){
	...
	flHTML += '<center>Draugu nera</center>';
	...
	flHTML += '<center>Draugai:</center><ul id="flList">';
...
if(IkariamEnemyList == "0"){
	...
	flHTML += '<center>Priesu nera</center>';
	...
	flHTML += '<center>Priesai:</center><ul id="flList">';
...
if(IkariamTradeList == "0"){
	...
	flHTML += '<center>Fermu nera</center>';
	...
	flHTML += '<center>Fermos:</center><ul id="flList">';
...
flHTML += '<div style="text-align:center;"><hr>Prideti miesta<br><input type="text" name="flNewName" id="flNewName" value="Miestas" onFocus="javascript:if(this.value == this.defaultValue) this.value = \'\';" onblur="javascript:if(this.value == \'\') this.value = this.defaultValue;" /><p><a onClick="javascript:flInsertCurrentURL();" style="font-size: 9px; cursor: pointer;">Naudoti dabartini adresa</a></p><input type="text" name="flNewLink" id="flNewLink" value="URL" onFocus="javascript:if(this.value == this.defaultValue) this.value = \'\';" onblur="javascript:if(this.value == \'\') this.value = this.defaultValue;" /><br /><br /><input type="radio" name="type" onclick="javascript:flSet(this.value);" value="Friend" checked /> Draugas<br /><input type="radio" name="type" onclick="javascript:flSet(this.value);" value="Trader" /> Ferma<br /><input type="radio" name="type" onclick="javascript:flSet(this.value);" value="Enemy" /> Priesas<br /><input type="hidden" id="fte" value="Friend" /><br /><a href="javascript:flAddFriend();" class="button">&nbsp;&nbsp;&nbsp;Add&nbsp;&nbsp;&nbsp;</a><br><p style="padding-top: 8px;"><a href="javascript:flExport();" class="flSmall" style="font-size: 10px;">Export</a> | <a href="javascript:flImport();" class="flSmall" style="font-size: 10px;">Import</a></p></div>';

/*
// Add the HTML for the adding friends part
flHTML += '<div style="text-align:center;"><hr>Prideti miesta<br><input type="text" name="flNewName" id="flNewName" value="Miestas" onFocus="javascript:if(this.value == this.defaultValue) this.value = \'\';" onblur="javascript:if(this.value == \'\') this.value = this.defaultValue;" /><p><a onClick="javascript:flInsertCurrentURL();" style="font-size: 9px; cursor: pointer;">Naudoti dabartini adresa</a></p><input type="text" name="flNewLink" id="flNewLink" value="URL" onFocus="javascript:if(this.value == this.defaultValue) this.value = \'\';" onblur="javascript:if(this.value == \'\') this.value = this.defaultValue;" /><br /><br /><input type="radio" name="type" value="Friend" checked /> Draugas<br /><input type="radio" name="type" value="Trader" /> Trader<br /><input type="radio" name="type" value="Enemy" /> Priesas<br /><br /><a href="javascript:flAddFriend();" class="button">&nbsp;&nbsp;&nbsp;Add&nbsp;&nbsp;&nbsp;</a><br><p style="padding-top: 8px;"><a href="javascript:flExport();" class="flSmall" style="font-size: 10px;">Export</a> | <a href="javascript:flImport();" class="flSmall" style="font-size: 10px;">Import</a></p></div>';
*/
