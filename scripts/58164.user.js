...
// @name           eIran Orders
// @version        0.3
// @namespace      http://www.erepublik.com/en/citizen/profile/86571
// @include        http://www.erepublik.com/*
// ==/UserScript==

var ordersurl = "http://docs.google.com/View?id=dfvx72t5_0ggf8k9x3";

var selectedunit = GM_getValue("defaultunit");
if (selectedunit==undefined) selectedunit = 1;
var units = ["ارتش", "اطلاعیه دولت", "اخبار","درباره"];
var colours = ["#FFDDCC", "#CCFFCC", "#FFCCCC", "#EEEEFF"];
var ordersarr = [];
...
function main()
{
 ...
 title.innerHTML = '<embed class="sIFR-flash" width="250" height="28" src="/flash/delicious.swf" quality="best" flashvars="txt=اطلاعیه ها&&textcolor=#737373&hovercolor=null&linkcolor=null&w=250&h=28" wmode="transparent" bgcolor="transparent" sifr="true" type="application/x-shockwave-flash" style="width: 250px; height: 28px;"/>'
 ...
 ordersdiv.innerHTML = (ordersarr[selectedunit]?ordersarr[selectedunit]:"در حال دریافت اطلاعات...");
 ...
 GM_xmlhttpRequest({
  ...
  onload:function(response){
   ...
   for (x in units)
   {
    ...
    if (start==-1||end==-1) ordersarr[x] = "اطلاعاتی در قسمت" + unit + " موجود نمی باشد.";
