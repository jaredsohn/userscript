// ==UserScript==
// @name           TW Pro RUS
// @namespace      http://*.the-west.*/game.php*
...
function twpro_injectScript()
{
  ...
  TWPro.twpro_setBonus.set_dancer[5] = new Object();
  TWPro.twpro_setBonus.set_dancer[5].bonus = new Object();
  TWPro.twpro_setBonus.set_dancer[5].bonus.attributes = new Object();
  TWPro.twpro_setBonus.set_dancer[5].bonus.attributes.charisma = 11;
  TWPro.twpro_setBonus.set_dancer[5].bonus.skills = new Object();
  ...
  TWPro.twpro_setBonus.set_dancer[5].jobBonus = new Object();
  TWPro.twpro_setBonus.set_dancer[5].jobBonus.all = 50;
  TWPro.twpro_setBonus.set_dancer[5].speedBonus = 0;
  TWPro.twpro_setBonus.set_dancer[5].parsedBonus = new Object();
  ...
  twpro_supportAuthor.appendChild(document.createTextNode("Evgenatrix"));
  twpro_support.appendChild(document.createTextNode("TW Pro RUS: "));
...
function twpro_showList()
{
  ...
  $('twpro_jobsort_link_lohn').addMousePopup(new MousePopup('<b>по Деньгам</b>',100,{opacity:0.95}));
...
function twpro_getBagPopup()
{
  ...
  twpro_xhtml+='<table>';
  twpro_xhtml+='<tr><td class="item_popup_trader_price">Одето:&nbsp;&nbsp;</td>';
  ...
  item_popup_trader = TWPro.twpro_bag.twpro_priceWear+TWPro.twpro_bag.twpro_priceBag;
  twpro_xhtml+='<tr><td class="item_popup_trader_price">Всего:&nbsp;&nbsp;</td>';
  twpro_xhtml+='<td class="item_popup_trader_price">'+item_popup_trader+' $</td></tr>';
  twpro_xhtml+='</table>';
  ...
  twpro_allall = twpro_all+TWPro.twpro_bag.twpro_countType['yield'];
  twpro_xhtml+='<tr><td class="item_popup_trader_price">Общее количество:&nbsp;&nbsp;</td>';
  twpro_xhtml+='<td class="item_popup_trader_price">'+twpro_allall+'</td></tr>';
  twpro_xhtml+='</table>';
  twpro_xhtml+='</div>';
  return twpro_xhtml;
}
...
function twpro_insertListItems()
{
  ...
  twpro_jobElement.appendChild(document.createTextNode(((TWPro.twpro_jobs[twpro_i].name.length>25)?(TWPro.twpro_jobs[twpro_i].name.substr(0,23)+'...'):(TWPro.twpro_jobs[twpro_i].name)) + ' (' + twpro_apstmp + ' TO)')); //AP->TO  
    if(twpro_apstmp > 0)
    {
