...
// @description    Komplettscript fuer Alarmierung (AAO) und verwaltung fuer das Spiel Feuerwache.net
// @include        http://www.feuerwache.net/*
// @author         DarkPrince
// @version        15.04.2011 - 21:30 Uhr - Anpassung TUIS-Einsätze
// ==/UserScript==
...
// Die Variablen UPDATEURL und INSTALLURL müssen angepasst werden, 
// wenn Du das Script veränderst und selber eine Version zum Download anbietest !!!

// soll täglich nach einem Update des AAO-Scriptes gesucht werden?
var CHECKFORUPDATES=true;

// unter welchem URL finde ich Infos über das Script? (<= Bitte eigene URL eintragen)
var UPDATEURL="http://userscripts.org/scripts/show/63003";

// unter welchem URL finde ich das Script als Installation? (<= Bitte eigene URL eintragen)
...
var Einsatzklassen = {
  ...
  'Brand in Raffinerie'              : 'Feuer 3 - Großalarm - Gefahrgut+GW-TUIS|TLF',
  ...
  'Feuer im Krankenhaus'             : 'Feuer 4 - Großalarm - komplett|GW-W',
  ...
  'Kinobrand'                        : 'Feuer 3 - Großalarm - Leiter',
  ...
  'Tankbrand'                        : 'Feuer 3 - Großalarm - Tank|GW-TUIS',
  'Traktorbrand'                     : 'Feuer 1 - Klein',
  'Trocknerbrand'                    : 'Feuer 1 - Klein',
  'Verkehrsunfall'                   : 'TH 3 - Umwelt - Öl',
  'Verletztentransport'              : 'RD 1 - Transport',
  'Wohnblockbrand'                   : 'Feuer 3 - Großalarm',
...
// GW-A bei 3-Atem, 4-Groß und 3-Erweitert raus
  // ***************************************************************************************
...
var Fahrzeuggeschwindigkeiten = {
  ...
  'GW-TUIS'                        :   73     ,
  'Kran'                           :   55     ,
  'Flughafenlöschfahrzeugn'        :   110    ,
  'Rettungstreppenfahrzeug'        :   65     ,
  'Feuerlöschboot'                 :   60     ,
  'Rettungsboot'                   :   60     ,
};
...
var WikiLinks = {
  ...
  'Brand im Gemeindehaus'            : 'http://wiki.feuerwache.net/wiki/Brand im Gemeindehaus',
  ...
  'Feuer auf Boot (Klein)'           : 'http://wiki.feuerwache.net/wiki/Feuer auf Boot (Klein)',
  'Feuer auf Boot (Mittel)'          : 'http://wiki.feuerwache.net/wiki/Feuer auf Boot (Mittel)',
  ...
  'Verletztentransport'              : 'http://wiki.feuerwache.net/wiki/Verletztentransport',
...
// ************************************************************************************
        ...
        { var bgc="";
          ...
          if (FH && Ausb.match("Flughafen")            == null) bgc = "#CD9B1D";
          if (FLB && Ausb.match("Löschboot")           == null) bgc = "#0000FF";
          if (RTB && Ausb.match("Rettungsboot")        == null) bgc = "#C0C0C0";
          if (TUI && Ausb.match("TUIS")                == null) bgc = "#E0E0E0";
          if (bgc) 
...
// ************************************************************************************
  ...
  if (InfotextToAlarm) Info += InfoVorspann + "<font size='1'>zu alarmieren</font></th><td>" + InfotextToAlarm + "</td></tr>\n";
  if (InfotextVerfuegbar) Info += InfoVorspann + "<a target='_new' href='http://www.feuerwache.net/feuerwehrfahrzeuge'>verfügbare Fahrzeuge</a></th><td><font color='#DF7401'><font size='1,9'>" + InfotextVerfuegbar + "</font></font></td></tr>\n";
...
// ************************************************************************************
  ...
  if (AnzGG)
  { ret += "<font color='#FA58F4'>Gefahrgut: </font><font color='#FFD700'><b>" + AnzGG + " </b></font>insgesamt, <font color='lightblue'>" + AnzGGDienst + " im Dienst</font>";
