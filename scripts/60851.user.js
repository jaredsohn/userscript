// ==UserScript==
// @name           Add RvB Smilies
// @namespace      rvbavatars@rec.com
...
////////////// This is where you can add items to the dropdown. Just make sure the name is in quotes
            ...
            var characterArray = ["Sarge", "Simmons", "Grif", "Donut", "Lopez", "Church", "Tucker", "Caboose",
                                  ...
                                  "Agent South", "The Meta", "CT", "Epsilon", "Epsilon (Laser)"];
...
function postColor() {
    ...
    if(chosenName == "epsilon-laser") {
	postBox.value += tag.replace("REPLACETHIS.png", chosenName+".gif");}
    else {
