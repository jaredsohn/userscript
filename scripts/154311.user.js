// ==UserScript==
// @name			Ordenes de Batalla - MoD eChile
// @version			1.1.95
// @author			Llillo
// @namespace		echile_mod
// @description		Plugin para visualizar las Ordenes de Batalla de eChile.
...
function header() {
    ...
    var imageHeader = 'http://s1.postimage.org/w1k9nrawv/banner2.jpg';
...
function footer() {
	...
	var linkDiv = '';
    switch(x) {
    case 1: linkDiv = 'http://goo.gl/RhsIf'; break;
    case 2: linkDiv = 'http://goo.gl/Kkhbq'; break;
    case 3: linkDiv = 'http://goo.gl/uBnol'; break;
    case 4: linkDiv = 'http://goo.gl/mGvpI'; break;
    default: linkDiv = 'XX';
    }    
    var orders = '<div class="rest"><a href="http://goo.gl/s7rgi" title="" target="_blank">Planilla Ordenes Militares</a><a href="' + linkDiv + '" title="" target="_blank">Canal de Coordinación</a></div>';
