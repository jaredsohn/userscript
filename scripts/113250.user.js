// ==UserScript==
// @name			NizamiCedit Tools
// @namespace		        esatcan
// @description		        Pervy version
 ...
 ********************************************************************************/
// Script information
var Version = 'Green&Black English'; // Year, Month, Day, Revision, Maturity (e.g. YYYMMDDa_BETA)
...
var BUTTON_BGCOLOR = 'green';
var JOB_BUTTON_BGCOLOR = 'green';

var IsChrome = navigator.userAgent.toLowerCase().indexOf('chrome') > -1;

var wordArr = ['RedSoldier', 'TheGoldenEldest', 'Zümrüt', 'Kocaelispor', 'Antalyaspor', 'AdanaDemirspor', 'Ateş', 'Su', 'Lav', 'Metal', 'Dragons', 'of', 'Atlantis', 'Çocuk', 'Yeni', 'Fangled', 'Flugel', 'Horn', 'Perfect', 'Myth', 'Jelly', 'Graph', 'Quick', 'Thorn', 'Pitbull', 'Tech', 'Cow', 'Middle', 'Brow', 'Hammer', 'Chord', 'Dazzle', 'Elemental', 'Brillig', 'Craft', 'Thumb', 'Print', 'Crtyp', 'Torch', 'Light', 'Bank', 'Final', 'Epic', 'Desk', 'Marble', 'Aqua', 'Phoenix', 'Peanut', 'Halo', 'Nimbus', 'Cloud', 'Seed',];
...
var kFarm = 'çiftlik';
var kHome = 'ev';
var kMine = 'Maden ocağı';
var kSilo = 'ambar';
var kWall = 'sur';
var kQuarry = 'taş ocağı';
...
var kSentinel = 'gözcü';
var kLumbermill = 'odun';
var kDragonKeep = 'ejderha';
var kMetalsmith = 'Metal ustasu';
var kMusterPoint = 'MusterPoint';
var kStorageVault = 'StorageVault';
var kTrainingCamp = 'eğitim kampı';
var kScienceCenter = 'bilim merkezi';
var kOfficerQuarter = 'subay karargahı';

// Troops
var kPorter = 'hamal';
var kConscript = 'acemi asker';
var kSpy = 'casus';
var kSpies = 'casuslar';
...
var kBattleDragon = 'SavaşDragon';
var kArmoredTransport = 'Zırhlı';
var kGiant = 'dev';
var kFireMirror = 'ateş aynası';
var kAquaTroop = 'zp';
var kStoneTroop = 'oger';
var kFireTroop = 'lav';
var kWindTroop = 'ölüm perisi';
var kGreatDragon = 'BüyükDragon';
var kWaterDragon = 'SuDragon';
var kStoneDragon = 'TaşDragon';
var kFireDragon = 'AteşDragon';
var kWindDragon = 'RüzgarDragon';
...
var kBatDrg = 'savaşd.';
var kATrans = 'zırhlı';
var kFireM = 'ateş aynası';
var kGrtDrg = 'büyükd.';
var kWatDrg = 'su d.';
var kStnDrg = 'TaşDrg';
var kFreDrg = 'AteşDrg';
var kWndDrg = 'RüzgarDrg';
var kFang = 'zp';
var kOgre = 'Ogre';
var kLavaJaw = 'lav';
var kBanshee = 'ölüm perisi';

// Tabs
var kInfo = 'bilgilendirme';
var kWave = 'spam';
var kAttack = 'antropus';
var kTrain = 'eğitim';
var kBuild = 'inşa';
...
// Items
var kAquaTroopRespirator = 'pençe aleti';
var kStoneTroopItem = 'sihirli kök';
var kFireTroopItem = 'volcanic run';
var kWindTroopItem = 'rüzgar pençesi';
...
var kNoTroops = 'yeterli asker yok';
...
var kNotEnough = 'yetersiz ';
var kMusterPointFull = 'Muster Point Full';
var kNoGenerals = ' general yok';
...
var kDeleteMarchReports = 'raporları sil: ';
var kStopOnLoss = 'asker kaybında durdur: ';
var kMaxMarches = 'Maximum simultaneous marches: ';
var kRescanMap = '" harita aranıyor "';
...
var kSendingAttack = 'atağa yollandı';
var kOK = 'OK';
...
var OptionsDefaults = {
  ...
  objAttack     : {enabled:false, repeatTime:3660, delayMin:7, delayMax:20, levelEnable:[], levelDist:[null,10,10,10,10,10,10,10,10,10,10], deleteObjAttacks:false, stopAttackOnLoss:false, logAttacks:true, maxMarches:10, troops:[], clearAllTargets:false},
  currentTab    : false,
  attackTab     : 0,
  mapTab        : 0,
  jobsTab       : 0,
  ...
  //waves         : {enabled:false, iterationMin:7, iterationMax:25, stopOnLoss:true, deleteReports:false, targets:[], runTime:0},
  objStats      : null,
  objMarches    : {},
...
var Styles = '\
    div.' + rndClass['tab_title'] + ' {border:1px solid; border-color:black; font-weight:bold; padding-top:2px; padding-bottom:2px; text-align:center; color:black; background-color:green}\
    div.' + rndStyle['classPrefix'] + 'Subtitle {border:1px solid; border-color:black; font-weight:bold; padding-top:2px; padding-bottom:2px; text-align:center; color:black; background-color:green}\
    div.' + rndStyle['classPrefix'] + 'Input {border:2px ridge yellow; background-color:green; padding:3px}\
    div.' + rndStyle['status_ticker'] + ' {border:2px ridge black; background-color:green; padding:2px}\
	div.' + rndStyle['status_feedback'] + ' {height: 34px; border:1px solid black; background-color:green; padding: 2px 0px 2px 2px; text-align:left; font-weight:bold;}\
    ...
    div#qTip {padding: 3px; border: 1px solid #777; border-right-width: 2px; border-bottom-width: 2px; display: none; background: green; color: #fff; font: bold 9px Verdana, Arial, sans-serif; text-align: left; position: absolute; z-index: 1000}\
    table.' + rndStyle['classPrefix'] + 'TabPad tr td {border:none; background:white; white-space:nowrap; padding: 1px 1px}\
    table.' + rndStyle['classPrefix'] + 'Tab tr td {border:none; background:white; white-space:nowrap; padding: 1px 1px;}\
    table tr td.' + rndStyle['classPrefix'] + 'TabLeft {font-weight:bold; text-align:right; padding-right: 5px}\
    table.' + rndStyle['classPrefix'] + 'TabLined tr td {border-bottom:1px solid #ccc; background:white; padding: 1px 4px 1px 4px;}\
    table tr.' + rndStyle['classPrefix'] + 'TabHdr1 td {background-color:white; font-weight:bold}\
    ...
    tr.' + rndStyle['classPrefix'] + 'retry_ptpoptp td { background-color:white; color:#fff; border:none; height: 21px; padding:0px; }\
    tr.' + rndStyle['classPrefix'] + 'Owned {background-color: black; color:white}\
    ...
    table.' + rndStyle['classPrefix'] + 'MainTab tr td.sel    {font-weight:bold; font-size:13px; border: 1px solid; border-style: solid solid none solid; background-color:darkgreen; cursor:hand; cursor:pointer; padding: 2px;}\
    table.' + rndStyle['classPrefix'] + 'MainTab tr td.notSel {font-weight:bold; font-size:13px; border: 1px solid; border-style: solid solid none solid; background-color:green; color:white; border-color:black; cursor:hand; cursor:pointer; padding: 2px;}\
    .' + rndStyle['classPrefix'] + 'CP .' + rndStyle['classPrefix'] + 'CPMain { background-color:green; padding:6px;}\
    ...
    .button {cursor:hand; cursor:pointer; border: 1px solid #006; background: green; color: white; padding: 2px; font-weight:bold; font-size:13px; border-style: solid solid none solid;}\
//  .button:hover {background: green; font-weight:bold; font-size:13px; color: black; border-style: solid solid none solid; }\
//  .button:active {background: green; font-weight:bold; font-size:13px; color: black; border-style: none none none none;}\
...
Tabs.Waves = {
	...
	init : function (div) {
		...
		Data.init({waves: {enabled:false, iterationMin:7, iterationMax:25, stopOnLoss:true, deleteReports:false, target:{troopsWave:{}, x:0, y:0, type:null, level:0, stats:{numAttacks:0, spoils:{}}}, runTime:0}});
...
Tabs.AutoAttack = {
  ...
  init : function (div){
    ...
    div.innerHTML = '<DIV class=' + rndClass['tab_title'] + '>' + Data.options.mapChoice + ' </div>\
      ...
      <TABLE width=100% bgcolor=green align=center><TR><TD>\
...
//*** Attacks Tab - Stats Sub-tab ***
  ...
  // Data.options.objAttack {enabled:false, maxDist:7, repeatTime:3660, delayMin:7, delayMax:25, levelEnable:[]}
 ...
 // Data.options.campAttack {enabled:false, maxDist:7, repeatTime:3660, delayMin:7, delayMax:25, levelEnable:[], levelDist:[]}
...
//*** Attacks Tab - Maps Sub-tab ***
  tabMaps : function(){
    ...
    t.contentType = 4;
    document.getElementById('pbatMaps').style.backgroundColor = "#008000"; 
    ...
    var m = '<DIV class=' + rndStyle['classPrefix'] + 'Subtitle>'+ kMapCategories +'</div>\
        ...
        <TR align=center class=' + rndStyle['classPrefix'] + 'TabHdr1><TD style="background:#008000 !important;" colspan=2></td></tr>\
        </div>';
  ...
  hide : function (){
    ...
    showStuff : function (){
        ...
        m += '<TABLE style="margin-top:3px" width=100%>\
              <TR bgcolor=#008000 align=center><TD style="border-right: 1px solid; border-bottom: 1px solid;"><B>'+ kTroops +'</b></td>\
...
//    researchTimer   : null,
    ...
    outpost1Troops  : ['Spy', 'Longbowman', 'SwiftStrikeDragon', 'BattleDragon', 'ArmoredTransport', 'Giant', 'FireMirror', 'AquaTroop', 'StoneTroop', 'FireTroop', 'WindTroop'],
    outpost2Troops  : ['Spy', 'Longbowman', 'SwiftStrikeDragon', 'BattleDragon', 'ArmoredTransport', 'Giant', 'FireMirror', 'AquaTroop', 'StoneTroop', 'FireTroop', 'WindTroop'],
    outpost3Troops  : ['Spy', 'Longbowman', 'SwiftStrikeDragon', 'BattleDragon', 'ArmoredTransport', 'Giant', 'FireMirror', 'AquaTroop', 'StoneTroop', 'FireTroop', 'WindTroop'],
    outpost4Troops  : ['Spy', 'Longbowman', 'SwiftStrikeDragon', 'BattleDragon', 'ArmoredTransport', 'Giant', 'FireMirror', 'AquaTroop', 'StoneTroop', 'FireTroop', 'WindTroop'],
...
function CPopup (prefix, x, y, width, height, enableDrag, onClose) {
  ...
  this.div.style.background = "#008000";
  ...
  var m = '<TABLE cellspacing=0 width=100% height=100%>\
           <TR id="'+ rndPopup['bar'] +'" style="background-color: black;">\
           <TD width=100% valign=bottom>\
           <SPAN id="'+ rndPopup['top'] +'"></span></td>\
           <TD id='+ rndPopup['X'] +' align=right valign=middle onmouseover="this.style.cursor=\'pointer\'" style="color:#fff; background:#008000; font-weight:bold; font-size:14px; padding:0px 4px">X</td></tr>\
