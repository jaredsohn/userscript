...
function getCSS() {
	...
	css += 'a:hover, a:hover b { color: #CCCCCC; }';
	css += 'b { color: #3168C4; }';
    ...
    css += '#logo .image { background-color: #FFFFFF; color: #3168C4; }';
    css += '#logo:hover .image { background-color: #3168C4; color: #FFFFFF; }';
    css += '#logo .fap { background-color: #3168C4; color: #FFFFFF; }';
    css += '#logo:hover .fap { background-color: #FFFFFF; color: #3168C4; }';
...
function positionDialog() {
    ...
    var top = ((window.innerHeight / 2) - (dialogBox.offsetHeight / 2));
    if (top < 0)
        top = 0;
