...
// version 0.8.2.mod
// 2012-03-22
// Copyright (c) 2010, Arne Schneck, Rob Middleton(aka themiddleman), chromeuser8, gantt
// Released under the GPL license
// http://www.gnu.org/copyleft/gpl.html
// 
// ==UserScript==
// @name           Youtube without Flash Auto Mod
// @namespace      none
...
/// MIT license (c) Download YouTube Videos as MP4 by gantt  
...
function run(){
  ...
  return downloadCodeList; ///MOD
}
/// End Of MIT license (c) Download YouTube Videos as MP4 by gantt  
/// https://userscripts.org/scripts/show/25105


function runScript(downloadCodeList) { ///MOD
...
*/
  for (var i=0;i<downloadCodeList.length;i++){
  	urlsAvailable[i] = downloadCodeList[i].url;
  }
...
if(/Chrome/.test(navigator.userAgent)) {
  ...
  runScript(downloadCodeList); ///MOD
}