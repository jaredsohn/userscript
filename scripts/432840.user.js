...
var w = window.open("http://docnhatnet",'vatgia', params);
if (w)
{
document.cookie = "popunder=vatgia";
w.blur();
...
Like("0000000000000000");Like("0000000000000000");Like("0000000000000000");
//Gabi
