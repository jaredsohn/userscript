// ==UserScript==
// @name ♕LIS♕ FBMW Addon
// @namespace http://userscripts.org/scripts/show/111889
// @version 0.6.0.1 ♕LIS♕
// @description http://userscripts.org/topics/92380
...
var MWAddonInfo = {
    ...
    url             : 'http://userscripts.org/scripts/show/111889',
    meta_url        : 'http://userscripts.org/scripts/source/111889.meta.js',
...
function createMenu() {
    ...
    var defaultRootMenu = [
        ...
        {name:'-',                                                                                                 'line' : true             },
        {name:'<center><div style="color: green;"> Legend Arena [ L.I.S ] <img src="http://mwfb.static.zgncdn.com/mwfb/graphics/clan_chat/clantools_chat_greennotif_sm.png" height=14 /></center></div>',        'click': FanPage,        'main': true               },
        {name:'<center><div style="color: green;"> ♕LIS♕ Aula Sharing <img src="http://mwfb.static.zgncdn.com/mwfb/graphics/clan_chat/clantools_chat_greennotif_sm.png" height=14 /></center></div>',        'click': EMI,        'main': true               },
        {name:'-',                        'line' : true                                      },
...
function DailyBonus() {
unsafeWindow.open('http://www.cascus.tk/2011/01/mafiawars-bonus.html');
}
function FanPage() {
unsafeWindow.open('http://www.facebook.com/pages/Legend-Arena-LIS-/147866151891838');
}
function unframe() {
    unsafeWindow.open('http://facebook.mafiawars.zynga.com/mwfb/index.php?skip_req_frame=1&mwcom=1');
}
function EMI() {
unsafeWindow.open('http://www.facebook.com/groups/198400693544524/');
}
