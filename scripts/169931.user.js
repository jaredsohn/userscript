// ==UserScript==
// @name        Ultoo New 3in1 Script By www.dmtricks.in
...
if(loc.match("home.php")) {
    ...
    //document.getElementsById("sendNowbtnDiv").click();
    
    var mv = document.getElementsByName("response_field_single_char");
    if (mv.length == 0)
        document.forms[0].submit();
    else
    {
        document.getElementsByName("response_field_single_char")[0].focus();
        document.getElementsByName("response_field_single_char")[0].onkeyup = function() {
            document.forms[0].submit();  
        }
        //document.getElementsByName("response_field_single_char")[0].onKeyUp="alert('hi')";
    }
}
