...
(function() {
	...
	searchenginearray[2] = new Array('bing', 'q', 'cn.bing.', 'http://cn.bing.com/search?q=--keywords--', 1, 'http://cn.bing.com/favicon.ico');
	searchenginearray[3] = new Array('Yahoo', 'q', 'yahoo.', 'http://www.yahoo.cn/s?q=--keywords--', 1, 'http://www.yahoo.cn/favicon.ico');
	searchenginearray[4] = new Array('Gougou', 'search', 'gougou.', 'http://www.gougou.com/search?search=--keywords--', 1, 'http://img.gougou.com/image/so/gougou.ico');
	searchenginearray[5] = new Array('Sina ishare', 'key', 'ishare.iask.sina.', 'http://ishare.iask.sina.com.cn/search.php?key=--keywords--&from=index&format=', 1, 'http://www.sina.com/favicon.ico');
	searchenginearray[6] = new Array('Taobao', 'q', 's.taobao.', 'http://s.taobao.com/search?q=--keywords--', 1, 'http://www.taobao.com/favicon.ico');
