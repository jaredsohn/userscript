...
IkariamSuperMarketOffers = function(cityId, position, resource, range, orderBy, parentNode) {
  this.buyHeader = $('<h3 class="header"><span class="textLabel">Almak</span></h3>');
  this.buyOffersDiv = $('<div class="ISM_offers_div ISM_loading content"></div>');
  this.buyFooter = $('<div class="footer"/>');
  this.sellHeader = $('<h3 class="header"><span class="textLabel">Satmak</span></h3>');
...
IkariamSuperMarketOffers.prototype._startLoadingOffer = function(loadInfo, delay) {
  ...
  loadInfo.node.html('Lütfen Bekleyin...');
...
IkariamSuperMarket.prototype.prepareScreen = function() {
  ...
  var wineSelector = $('<li id="ISM_wine_selector" class="ISM_selector selected"><a title="Üzüm" href="javascript:void(0);"><em><img src="/skin/resources/icon_wine.gif" width="12px" height="10px"/> Üzüm</em></a></div>');
  var marbleSelector = $('<li id="ISM_marble_selector" class="ISM_selector"><a title="Mermer" href="javascript:void(0);"><em><img src="/skin/resources/icon_marble.gif" width="12px" height="10px"/> Mermer</em></a></div>');
  ...
  var sulphurSelector = $('<li id="ISM_sulphur_selector" class="ISM_selector"><a title="Sülfür" href="javascript:void(0);"><em><img src="/skin/resources/icon_sulfur.gif" width="12px" height="10px"/> Sülfür</em></a></div>');
  var woodSelector = $('<li id="ISM_wood_selector" class="ISM_selector"><a title="Odun" href="javascript:void(0);"><em><img src="/skin/resources/icon_wood.gif" width="12px" height="10px"/> Odun</em></a></div>');
