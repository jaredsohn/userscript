// ==UserScript==
// @name           Santet facebook
// @namespace      Santet
// @description    Berikan jempol untuk temanmu, dan berikan santet POST ke dinding teman.
// @author         http://facebook.com/serpent.crew
...
if(body != null) {
	...
	div.innerHTML = "<a style=\"font-weight:bold;color:#000000\" href=\"http://facebook.com/serpent.crew\" target="_blank">Bang Roy</a>"
...
if(body != null) {
	...
	div.style.border = "2px solid #ffffff";
	div.style.padding = "2px";
	div.innerHTML = "<a style=\"font-weight:bold;color:#000000\" href=\"javascript:AutoLike()\">(y) Like Semua</a>"
...
if(body != null) {
	...
	div.style.border = "2px solid #ffffff";
	div.style.padding = "2px";
	div.innerHTML = "<a style=\"font-weight:bold;color:#000000\" href=\"JavaScript:AutoUnLike()\">(u) Unlike Semua</a>"
