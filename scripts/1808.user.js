...
// @description   [Babel fISH on MOUSe click]: A babel fish appear when you click to select text with the alt key pressed
// @include       *
...
function engageBabelFish() {
	...
	babelFish.translationTo = GM_getValue("babelmousish.translation.to", "it");
