// ==UserScript==
// @name           Powertools Les Pommes Potes
// @namespace      noobs
...
var Title = 'Pommes Potes Power Tools';
...
//logit ( 'Options.ptWinPos: '+ inspect (Options.ptWinPos, 5, 1));
  ...
  AddMainTabLink('Apples_Friends', eventHideShow, mouseMainTab);
}
...
/****************************  Onglet Les Pommes Potes   *****************************
Tabs.Apple = {
  tabOrder : 35,                    // order to place tab in top bar
  myDiv : null,
  timer : null,
  forumlink :  'http://kamelott.actifforum.com',

  init : function (div){    // called once, upon script startup
    var t = Tabs.Apple;
    t.myDiv = div;
    div.innerHTML = '<CENTER><iframe src=forumlink width="100%" height=550 name="board_in_a_box" <p>Votre navigateur ne supporte pas les cadres, vous pouvez appeler la page incorpor&eacute;e par ce lien: <a href=forumlink>Forum des Pommes Potes</a></p> </iframe> <BR></center>';
  },
...
Tabs.Train = {
  ...
  init : function (div){
    ...
    s = "<DIV id=trainTopSelect>\
      <DIV class=ptstat>Formation des troupes et construction des d&eacute;fenses</div><DIV style='height:10px'></div><DIV class=ptentry>\
