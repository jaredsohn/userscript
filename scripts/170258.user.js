// ==UserScript==
// @name           Travian4 - Search for Farm and Farm Stats Pro + Last Update
...
switch(country){
	...
	break;
	case 'it':
		L['get_farm_stats']='Statistiche Farm';
		L['farm_stats']='Statistiche Farm:';
		L['ally']='Alleanza';
		L['ally_ranks']='Rank dell\'Alleanza';
		L['player_ranks']='Rank del Giocatore';
		L['alone_penality']='Penalit&agrave; Solitudine';
		L['new_version']='Nuova versione disponibile!';
		L['download']='Download!';
		L['overall']='Riassunto:';
		L['farming_possibilities']='C\'&egrave; il %s% delle possibilit&agrave; di farmare il player.';
		L['player_population_rank']='Rank Popolazione del Giocatore';
		L['player_defender_rank']='Rank Difensore del Giocatore';
		L['player_attacker_rank']='Rank Attaccante del Giocatore';
		L['player_no_ally']='Questo giocatore non ha un alleanza';
		L['ally_population_rank']='Rank Popolazione dell\'Alleanza';
		L['ally_defender_rank']='Rank Difensori dell\'Alleanza';
		L['ally_attacker_rank']='Rank Attaccanti dell\' Alleanza';
		L['loading_stats']='Caricamento... %s%';
	break;
}
