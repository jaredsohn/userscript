// ==UserScript==
          // @name         Pennerbar seitenmenue Hamburg by css_killa77 versin 1.0 einstellbare farben und Position
          // @namespace    Autor: zeigt ein menue am rand man sieht alles an daten was man wissen muss.Version fuer berlin. ab den 14.5.2009 ein neues menue 2 in 1 beide penner in ein menue besere kontrolle ohne hin und her gezeppe  recht links wahl
          // @author	 http://css_killa77.pennergame.de/
		  // @homepage	 http://css_killa77.pennergame.de/  
          ...
          var Zcss_killa77 = "<li><a target=\"_blank\" href=\"http://css_killa77.pennergame.de/\" title=\"killa Homepage\"><span style=\"color:blue\"><b>css_killa77</span></a></li>";
          ...
          var Linkkette = ""+Zkilla77 + ZBerlin + ZHamburg + ZName + ZBande + ZApi + ZPlatz + ZPunkte + ZSpendenstatistik + ZSauber + ZPromille + ZAtt + ZDef + ZAtmin + ZAtmax + ZGeld + ZFlaschen + ZSkill + ZSkill1 + ZSkill2 + ""
          ...
          // copiright by css_killa77 seine erste version multianzeigen menue Hamburg 14.5.2009
// ==/UserScript==