//
// ==UserScript==
// @name           Ikariam Military Score RO
    ...
    cost, upgradePotential, extraTitle, extraValue) 
{
    ...
    var scoreDiv = <>
        <h3 class="header">{title} <a class="help" href="http://userscripts.org/scripts/show/48061" title="Ajutor"><span class="textLabel">Need help?</span></a></h3>
        <div class="content">
            <ul class="cityinfo">
                <li style="text-align:left;" class="ally"><span class="textLabel" style="width:60%;">Putere ofensiva:</span><div style="text-align:right; width:*"><b>{stringThousands(Math.round(offense))}</b></div></li>
                <li style="text-align:left;" class="ally"><span class="textLabel" style="width:60%;">Putere defensiva:</span><div style="text-align:right; width:*"><b>{stringThousands(Math.round(defense))}</b></div></li>
                ...
                <li style="font-size:11px; text-align:left;" class="ally"><span class="textLabel" style="width:60%;">Intretinere:</span><div style="text-align:right; width:*">{stringThousands(Math.round(upkeep))}</div></li>
                <li style="font-size:11px; text-align:left;" class="ally"><span class="textLabel" style="width:60%;">Scor Generali:</span><div style="text-align:right; width:*">{stringThousands(Math.round(cost / 100))}</div></li>
                <li style="font-size:11px; text-align:left;" class="ally"><span class="textLabel" style="width:60%;">Potential Upgradare:</span><div style="text-align:right; width:*">{upgradePotential}</div></li>
...
function addArmySummary()
{
  ...
  addMilitaryBox("Armata Defensiva", offense, defense, stamina, upkeep,
      cost, upgradePotential, "Rezistentza Zidului:", townWallLevel);
  ...
  addMilitaryBox("Armata Ofensiva", offense, defense, stamina, upkeep,
      cost, upgradePotential, "Incalcari:", 0);
