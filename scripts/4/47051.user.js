// ==UserScript==
// @name           Orkut Quote by  Shaan
// @namespace      Quote
// @description    Quote messages for orkut
// @include        http://www.orkut.*/CommMsg*
// ==/UserScript==

/*
 * @author  Shanu Full credits to John Cena
 */
...
var botPath = "/html/body/div[4]/div[3]/table/tbody/tr[2]/td/div[$]/div";
var quotePath = "/html/body/div[4]/div[3]/table/tbody/tr[2]/td/div[$]/div[2]";
var postPath = '//*[@id="messageBody"]';
var usernamePath = "/html/body/div[4]/div[3]/table/tbody/tr[2]/td/div[$]/h3/a";
    ...
    if (window.location.href.indexOf(getter) > -1) {
        ...
        if (post) {
            ...
            if (headerColor > -1 && headerColor <= 18) {
                ...
                aquote =  "[" + colors[headerColor] + "][b]" + quote.substr(0, x) + "[/b][/" + colors[headerColor] + "]";
			}
            else
