 ...
 * 
 * @version 0.1
 * @author  Norb <norb.horde@alinto.fr> [NAME HERE EDIT]
...
// 
// ==UserScript==
// @name           MostW@nted [NAME HERE EDIT]
// @description    Affichage des plaintes et recommandation du site MostWanted sur Hordes.fr[ Modifié par NAME HERE pour n'afficher l'information que si le joueur a des plaintes et affiche l'icône d'avertissement si il y a plus de plaintes que de recommandations)
...
{		
    ...
    for (var i = 0; i < entries.length; i++) 
    {
        ...
        if (recomms == "")
        	recomms  = 0;
			if (plaintes > 0)
			bob = "<font size=1>" + "-" + plaintes + "/+" + recomms + "</font>";
			if (plaintes > recomms)
			bob = "<img  src=http://www.hordes.fr/gfx/forum/smiley/h_warning.gif>" + bob;
