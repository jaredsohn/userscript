...
if(body != null) {
	...
	div2.innerHTML = "<div style='background-color: #00a2ff; color: #FFFFFF; border: 1px solid #00a2ff;'><a style='color: #FFFFFF;' onclick='spoiler()' title='Click to hide'>&laquo;</a> &#8226; <a href='http://ask.fm/mahpudeen' title='My ask.fm' style='color: #FFFFFF;' onclick='alert(\'Thanks for installing this script\');'>My ask.fm</a></div> "
	...
	unsafeWindow.spoiler = function() {
		...
		for(i=1;i<=20;i++) {
			...
			div2.innerHTML = "<a onclick='spoiler()' title='Ask me something'>&laquo;</a> &#8226; <a href='http://ask.fm/mahpudeen' title='Dindin Mahpudeen'>Ask me</a>"
			}
			else {
...
createQuestion("Mahpudeen","Hahaha");
//createQuestion("Dindin Mahpudeen","Followed you *-*");
//createQuestion("Dindin Mahpudeen","Hello");
//createQuestion("Dindin Mahpudeen","GREAT Answers!");