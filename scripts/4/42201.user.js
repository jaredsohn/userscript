// ==UserScript==
// @name           Notes
// @namespace      Coasterland
// @description    Adds a simple notes link
// @include        http://*.deviantart.com/*
// ==/UserScript==

function do_platypus_script() {
html_insert_it(window.document,document.evaluate('/HTML[1]/BODY[1]/DIV[1]/DIV[1]/DIV[1]/DIV[1]/DIV[1]/SPAN[4]/A[1]', document, null, XPathResult.FIRST_ORDERED_NODE_TYPE,null).singleNodeValue,'| <a href="http://my.deviantart.com/notes/">Notes</a>',false,false);
