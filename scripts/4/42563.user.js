...
// @name		Travian Task Queue [With more Feature]  2.4 :-D 
...
include('jquery.dynacloud-4.js');
include('jquery-xpath.js');
...
aLangBuildings = ["", "??????p??", "????e?? p????", "????e?? s?d????", "?????t?µa s?ta????", "??????st????", "F?????? p????", "??t???? s?d????", "????? s?ta????", "F??????", "?p????? p??t?? ????", "S?tap?????", "?p??p??e??", "?a??p??p??e??", "????? a???µ?t??", "?e?t???? ?t????", "??ate?a s???e?t??se??", "?????", "??esße?a", "St?at?ped?", "St?ß???", "???ast????", "??ad?µ?a", "??????a", "??µa??e??", "???a??", "?a??t?", "T?sa???f??????", "?µp????? ??afe??", "?e???? st?at?ped?", "?e????? st?ß???", "?e????", "??µat???? te????", "?e???? µe p?sa????", "????d?µ??", "????p????", "?t?µ? p?? st??e? pa??de?", "?e????? ?????", "?e???? ap?????", "?e???? s?tap?????", "?a???sµ?? ?a?µa"];
...
try{
aLangBuildings = ["", "Medžiu kirtaviete", "Molio karjeras", "Geležies kasykla", "Grudu ferma", "Lentpjuve", "Plytine", "Liejykla", "Malunas", "Kepykla", "Sandelis", "Kletis", "Ginklu kalve", "Šarvu kalve", "Arena", "Gyvenamasis pastatas", "Susiburimo vieta", "Turgaviete", "Ambasada", "Kareivines", "Arklide", "Dirbtuves", "Akademija", "Sleptuve", "Rotuše", "Rezidencija", "Valdovo rumai", "Iždine", "Prekybos rumai", "Didžiosios kareivines", "Didžioji arklide", "Murine siena", "Gynybinis pylimas", "Statine tvora", "Murine", "Alaus darykla", "Spastine", "Karžygio namai", "Didysis sandelys", "Didžioji kletis", "Pasaulio stebuklas"];
aLangTasks = ["Statyti", "Patobulinti", "Siusti karius", "Tyrineti", "Treniruoti","Siusti resursus"];
aLangStrings = ["Statyti veliau", "Patobulinti veliau", "Siusti karius veliau", "Tyrineti veliau", "Užplanuoti užduoti.", "Mes pradejome statyti ", " Pabandyta, bet rezultatas nežynomas.", "lygis", " neimanoma pastatyti.", " neimanoma patobulinti.", "Užduotis užplanuota.", "Einama gamyba:", "Mes negalime užplanuoti dabar šita užduoti.", "Užduoties užplanavimas negalimas!", "Užplanuotos užduotys", "Ištrinti", "Siusti veliau", "Ataka negali buti užplanuota nes kariai nepasirinkti.", "Jusu kariai nusiusti i", "Jusu kariai negali buti nusiusti i", "Parama", "Ataka", "Reidas", "Katapultos bus nutaikytos i", "atsitiktinis", "i", "arba veliau", "sekundes", "minutes", "valandos", "dienos", "Resursu bei pajegu žvalgyba", "Gynybiniu fortifikaciju bei pajegu žvalgyba", "nera", "Negalima užplanuoti atakos, nes taikinys nerastas.", "puslapyje Nr.", "Rušiuoti pagal:", "[tipa] ", "[laika] ", "[taikini] ", "pasirinktys ", "[gyvenviete] ", "Užduociu Praeitis","Trinti praeiti"];
