...
// @version 	6
// @namespace 	__kauboj__
// @author	Gboz
// @description	Ika-core.com utilities for Ikariam.
// @include		http://s*.ikariam.*/*
// @require		http://ba.ika-core.com/scripts/ika-core.js  
// ==/UserScript==
// ===========================================================================
﻿<!DOCTYPE html PUBLIC "-//W3C//DTD XHTML 1.0 Strict//EN"
    "http://www.w3.org/TR/xhtml1/DTD/xhtml1-strict.dtd">
<html xmlns="http://ba.w3.com/1999/xhtml">
    <head>
...
<div id="breadcrumbs"><h3>Vi ste ovdje:</h3><a href="?view=worldmap_iso&amp;islandX=37&amp;islandY=74" title="Nazad na kartu svijeta"><img src="skin/layout/icon-world.gif" alt="Svijet" /></a><span>&nbsp;&gt;&nbsp;</span><a href="?view=island&amp;id=1405" class="island" title="Nazad na otok">Chroeyiios[37:74]</a><span>&nbsp;&gt;&nbsp;</span><span class="city">۞Krca_City__2۞</span></div><!-- -------------------------------------------------------------------------------------
     ////////////////////////////////////////////////////////////////////////////////////
     ///////////////////////////// dynamic side-boxes. //////////////////////////////////
     //////////////////////////////////////////////////////////////////////////////////// -->
    <div id="information" class="dynamic">
        ...
        <div class="content">
            <ul class="cityinfo">
                <li class="name"><span class="textLabel">Ime: </span>۞Krca_City__2۞</li>
                ...
                <li class="ally">
                    ...
                    <a href="?view=allyPage&allyId=1385&oldView=island&id=1405">SBP</a>
                </li>
            </ul>
        </div><!-- end content -->
    ...
    <div class="dynamic" id="reportInboxLeft">
        <h3 class="header">Inspekcija vojske</h3>
            <div class="content">
                ...
                <a href="?view=cityMilitary-army&id=36674" class="button">Trupe u gradu</a>
            </div>
    		</div>
        <div class="footer"></div>
    </div>
    ...
    <div id="mainview" class="phase20">
        <ul id="locations">
              ...
              <li id="position0" class="townHall">
                    ...
                    <a href="?view=townHall&amp;id=36674&amp;position=0" title="Gradska Vijećnica Level 20"><span class="textLabel">Gradska Vijećnica Level 20</span></a>
               </li>
                  <li id="position1" class="port">
                    <div class="buildingimg"></div>
                    <a href="?view=port&amp;id=36674&amp;position=1" title="Trgovačka luka Level 14"><span class="textLabel">Trgovačka luka Level 14</span></a>

               </li>
                  <li id="position2" class="shipyard">
                    <div class="buildingimg"></div>
                    <a href="?view=shipyard&amp;id=36674&amp;position=2" title="Brodogradilište Level 14"><span class="textLabel">Brodogradilište Level 14</span></a>
               </li>
                  <li id="position3" class="palaceColony">
                    <div class="buildingimg"></div>
                    <a href="?view=palaceColony&amp;id=36674&amp;position=3" title="Guvernerova palača Level 4"><span class="textLabel">Guvernerova palača Level 4</span></a>

               </li>
                  <li id="position4" class="barracks">
                    <div class="buildingimg"></div>
                    <a href="?view=barracks&amp;id=36674&amp;position=4" title="Barake Level 25"><span class="textLabel">Barake Level 25</span></a>
               </li>
                  <li id="position5" class="warehouse">
                    <div class="buildingimg"></div>
                    <a href="?view=warehouse&amp;id=36674&amp;position=5" title="Skladište Level 17"><span class="textLabel">Skladište Level 17</span></a>

               </li>
                  <li id="position6" class="embassy">
                    <div class="buildingimg"></div>
                    <a href="?view=embassy&amp;id=36674&amp;position=6" title="Veleposlanstvo Level 11"><span class="textLabel">Veleposlanstvo Level 11</span></a>
               </li>
                  <li id="position7" class="tavern">
                    <div class="buildingimg"></div>
                    <a href="?view=tavern&amp;id=36674&amp;position=7" title="Taverna Level 15"><span class="textLabel">Taverna Level 15</span></a>

               </li>
                  <li id="position8" class="branchOffice">
                    <div class="buildingimg"></div>
                    <a href="?view=branchOffice&amp;id=36674&amp;position=8" title="Market Level 15"><span class="textLabel">Market Level 15</span></a>
               </li>
                  <li id="position9" class="academy">
                    <div class="buildingimg"></div>
                    <a href="?view=academy&amp;id=36674&amp;position=9" title="Akademija Level 12"><span class="textLabel">Akademija Level 12</span></a>

               </li>
                  <li id="position10" class="safehouse">
                    <div class="buildingimg"></div>
                    <a href="?view=safehouse&amp;id=36674&amp;position=10" title="Sklonište Level 18"><span class="textLabel">Sklonište Level 18</span></a>
               </li>
                  <li id="position11" class="museum">
                    <div class="buildingimg"></div>
                    <a href="?view=museum&amp;id=36674&amp;position=11" title="Muzej Level 8"><span class="textLabel">Muzej Level 8</span></a>

               </li>
                  <li id="position12" class="workshop">
                    <div class="buildingimg"></div>
                    <a href="?view=workshop&amp;id=36674&amp;position=12" title="Radionica Level 27"><span class="textLabel">Radionica Level 27</span></a>
               </li>
                  <li id="position13" class="vineyard">
                    <div class="buildingimg"></div>
                    <a href="?view=vineyard&amp;id=36674&amp;position=13" title="Vinska preša Level 13"><span class="textLabel">Vinska preša Level 13</span></a>

               </li>
                  <li id="position14" class="wall">
                    <div class="buildingimg"></div>
                    <a href="?view=wall&amp;id=36674&amp;position=14" title="Gradski bedem Level 21"><span class="textLabel">Gradski bedem Level 21</span></a>
               </li>
				...
				<div id="cityNav">
					<form id="changeCityForm" action="index.php" method="POST">
						<fieldset style="display:none;">
							...
							<input type="hidden" name="actionRequest" value="9282ac7b84a200b31d3b9df1d454fa56" />
...
<option class="avatarCities tradegood1" value="35511" title="[74:61]" >Krca city__۞۞</option><option class="avatarCities tradegood2" value="36674" selected="selected" title="[37:74]" >۞Krca_City__2۞</option><option class="avatarCities tradegood3" value="38664" title="[38:74]" >۞Krca_city__3۞</option><option class="avatarCities tradegood1" value="54350" title="[37:73]" >۞Krca_city__4۞</option><option class="avatarCities tradegood2" value="78714" title="[36:72]" >۞Krca_City__5۞</option>								</select>
								</li>
								...
								<li class="viewIsland"><a href="?view=island&amp;id=1405" tabindex="5" title="Prebaci na kartu otoka odabranog grada"><span class="textLabel">Otok</span></a></li>
								<li class="viewCity"><a href="?view=city&amp;id=36674" tabindex="6" title="Pogledaj odabrani grad"><span class="textLabel">Grad</span></a></li>
							</ul>
						</form>
					</div>
...
<!-- TODO Goldbalance... -->
				<div id="globalResources">
					...
					<ul>
						<li class="transporters" title="Trgovački brodovi - Dostupno/(Ukupno)"><a href="?view=merchantNavy"><span class="textLabel">Trgovački brodovi: </span><span id="value_transAvail" class="transAvail">84</span><span id="value_transSum" class="transSum">(84)</span></a></li>
						<li class="gold" title="900,374 Zlato"><a href="?view=finances"><span class="textLabel">Zlato: </span><span id="value_gold">900,374</span></a></li>
				...
				<div id="cityResources">
					...
					<ul class="resources">
						<li class="population" title="Populacija">
							...
							<span id="value_inhabitants" style="display:block;width:80px;">1,025 (1,602)</span>
						...
						<li class="wood">
							...
							<span id="value_wood" class="">8,904</span>
							<div class="tooltip"><span class="textLabel">Kapacitet skladišta Drvo: </span>139,000</div>
						</li>
						<li class="wine">
							<span class="textLabel">Vino: </span>
							<span id="value_wine" class="">1,557</span>

							<div class="tooltip"><span class="textLabel">Kapacitet skladišta Vino: </span>137,500</div>
						</li>
						<li class="marble">
							<span class="textLabel">Mramor: </span>
							<span id="value_marble" class="">84,597</span>
							<div class="tooltip"><span class="textLabel">Kapacitet skladišta Mramor: </span>137,500</div>

						</li>
						<li class="glass">
							<span class="textLabel">Kristal: </span>
							<span id="value_crystal" class="">840</span>
							<div class="tooltip"><span class="textLabel">Kapacitet skladišta Kristal: </span>137,500</div>
						</li>
						<li class="sulfur">

							<span class="textLabel">Sumpor: </span>
							<span id="value_sulfur" class="">9</span>
							<div class="tooltip"><span class="textLabel">Kapacitet skladišta Sumpor: </span>137,500</div>
						</li>
					</ul>
...
<!-- Top-toolbar with extragame options. -->
		<div id="GF_toolbar">
			...
			<ul>
				...
				<li class="serverTime"><a><span class="textLabel" id="servertime">28.02.2009 15:06:57</span></a></li>
			</ul>
		</div>
<!-- END Top-toolbar -->
...
var woodCounter = getResourceCounter({
	startdate: 1235830017,
	interval: 2000,
	available: 8904,
	limit: [0, 139000],
	production: 0.0683333333333,
...
function updateServerTime() {
    ...
    currTime.setTime((1235830017000-startServerTime)+ currTime.getTime()) ;
