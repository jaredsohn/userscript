...
// README et DOC: faut pas rêver
// Copyright (c) 2008 DGM
// Merci à debeuze, boilooief, dfgr , deeee, pour leur aide précieuse.
...
// Choisir "Bastien33", et cliquer Uninstall.
//
// --------------------------------------------------------------------
//
// ==UserScript==
// @name          Bastien33
// @namespace     http://userscripts.org/users/75209
// @description   Permet de faire des commentaires en série sur userscripts.org sans avoir à lire les scripts ( scripts qui ont été inclus dans une base de données Greasefire sans que leur auteur l'ait demandé ).
// @include       http://www.hordes.fr/*
// ==/UserScript==


const DGM_DUMMY_VERSION  = '0.2';