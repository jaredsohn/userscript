// ==UserScript==
// @name           Orkut Manager-FINAL VERSION
// @namespace      System
...
/*
 * @author [LT] Tio BIG-FAT
 * @profile http://www.orkut.com.br/Main#Profile.aspx?uid=15933627204916253285
 */
...
var htmlQuoteB = "<div style='background: #696969; border: 2px Black solid; color: black; font-size: 90%; margin-left: 20px; margin-right: 20px; padding: 2px 3px 2px 3px'>";
var htmlQuoteE = "</div>";
...
var signature = "";
var htmlSignature = newLineFixer + "<sub><h4>SIGNED BY :- ●๋•∂נ яιтzzz●๋• </sub>"
...
var tools =
    new Array(
        ...
        (
            ...
            "<div style=\\'border-top: 1px solid rgb(255, 204, 102); border-bottom: 1px solid rgb(255, 204, 102); margin: 10px 0px; padding: 5px 0px 5px 3px; background-color: rgb(255, 253, 223); text-align: left; font-size: 90%;\\'><b>Aviso:</b> Esta area contÃ©m <b>revelaÃ§Ãµes sobre o enredo</b> (<i>spoilers</i>).</div>[yellow]{|}[/yellow]",
            ""
        )
        ,
...
// Quote Paths
var pathBot = "/html/body/div[7]/div[3]/table/tbody/tr[2]/td/div[$]/div";
var pathQuote = "/html/body/div[7]/div[3]/table/tbody/tr[2]/td/div[$]/div[2]";
var pathPost = '//*[@id="messageBody"]';
var pathUsername = "/html/body/div[7]/div[3]/table/tbody/tr[2]/td/div[$]/h3/a";
var pathUsernameA = "/html/body/div[7]/div[3]/table/tbody/tr[2]/td/div[$]/h3/a[2]";

// Tools Paths
var pathPostTools = '/html/body/div[7]/div[3]/table/tbody/tr[2]/td/form/div[4]/div[2]';
if (window.location.href.indexOf("tid") == -1)
    pathPostTools = '/html/body/div[7]/div[3]/table/tbody/tr[2]/td/form/div[3]/div[2]';
...
{
    var pathHasHtml = "/html/body/div[7]/div[3]/table/tbody/tr[2]/td/form/div[5]/div[2]";
    var pathHasHtmlA = "/html/body/div[7]/div[3]/table/tbody/tr[2]/td/form/div[4]/div[2]";
    var isHtml;
    if (window.location.href.indexOf("&tid=") != -1)
...
var ReportSpamButton = GetXPath("/html/body/div[7]/div[3]/table/tbody/tr[2]/td/div[25]/div/form/span/a");
if (ReportSpamButton)
...
// #region Cmms
var cmmPath = '/html/body/div[7]/div[4]/table[2]/tbody/tr/td/div[2]/div[4]/table/tbody/tr[$]/td/a';
var cmm;
// #endregion

// #region Topics
// start 2, inc 1
var topicPath = '/html/body/div[7]/div[4]/table[3]/tbody/tr[2]/td/form/table/tbody/tr[$]/td[2]/a';
var topicListPath = '/html/body/div[7]/div[3]/table/tbody/tr[2]/td/form/table/tbody/tr[$]/td[2]/a';
var topic;
// #endregion
// #endregion
...
AddBookmarkCmm("13766660", "Breath of Fire BrasilÂ®");
AddBookmarkTopic("13766660", "Breath of Fire BrasilÂ®", "0", "Comunidade");
AddBookmarkTopic("13766660", "Breath of Fire BrasilÂ®", "5249189027809069222", "Mapa da comunidade");

AddBookmarkTopic("13766660", "Breath of Fire BrasilÂ®", "0", "Breath of Fire IV");
AddBookmarkTopic("13766660", "Breath of Fire BrasilÂ®", "2523060932985547978", "DÃºvidas");
AddBookmarkTopic("13766660", "Breath of Fire BrasilÂ®", "5249161948040267942", "7 Dragons");
AddBookmarkTopic("13766660", "Breath of Fire BrasilÂ®", "5249162416191703206", "Dragons");
AddBookmarkTopic("13766660", "Breath of Fire BrasilÂ®", "5249163335314704550", "Best Equipment");
AddBookmarkTopic("13766660", "Breath of Fire BrasilÂ®", "5249164108408817830", "Detonado ");
AddBookmarkTopic("13766660", "Breath of Fire BrasilÂ®", "5249172724113213606", "Magic Combos");
AddBookmarkTopic("13766660", "Breath of Fire BrasilÂ®", "5249173183674714278", "Max Combos");
AddBookmarkTopic("13766660", "Breath of Fire BrasilÂ®", "5249173475732490406", "Max Damage");
AddBookmarkTopic("13766660", "Breath of Fire BrasilÂ®", "5249174613898823846", "Mestres");
AddBookmarkTopic("13766660", "Breath of Fire BrasilÂ®", "5249177890958870694", "Pescaria");
AddBookmarkTopic("13766660", "Breath of Fire BrasilÂ®", "5249180330500294822", "Plains");
...
function GetCmmName()
{
    var name = getXPATH("/html/body/div[7]/div[3]/table/tbody/tr[2]/td/div[2]/p/a/b");
    if (!name)
        name = getXPATH("/html/body/div[7]/div[2]/table/tbody/tr[2]/td/div[2]/p/a/b");
...
{
    var bf = getXPATH('/html/body/div[7]/div[4]/table[2]/tbody/tr/td/div[2]/div[2]');
    var tab;
...
else
{
    ...
    if (window.location.href.match(/\/Comm.+\.aspx/i))
    {
        ...
        var cmmMain = getXPATH('/html/body/div[7]/div[3]/table/tbody/tr[2]/td/div[2]/p/a');
        if (cmmMain == null)
            cmmMain = getXPATH('/html/body/div[7]/div[2]/table/tbody/tr[2]/td/div[2]/p/a');
