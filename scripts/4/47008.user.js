...
// borrowed from http://userscripts.org/scripts/show/61882
...
function buildTable() {
	...
	statsCell.innerHTML = '<a id="expandStatsLink" href="#" class="statsToggleExpand" onclick="expandStats();return false;">' + expandStatsText + '</a><a id="hideStatsLink" href="#" class="statsToggleExpand" onclick="hideStats();return false;" style="display: none;">' + collapseStatsText + '</a>';
