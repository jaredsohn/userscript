// ==UserScript==
// @name           Red Scorpions -ika-tools-
// @version        v1
// @namespace      http://lebedesign.ru
// @description    Red Scorpions Alliance - Ika-core tools
// @author         Eureka
...
var version=1;
var scriptlocation="http://userscripts.org/scripts/source/41553.user.js";
...
function defineLanguage(langTDL) {
    switch (langTDL) {
        ...
        case "gr":
            language = {
            fetch:"О±ОЅО¬ОєП„О·ПѓО·...",
            unknown:"Unknown",
            allyscore:"Ally Score",
            score:"О’О±ОёОјОїО»ОїОіОЇО±",
            military:"ОЈП„ПЃО±П„ОµПЌОјО±П„О±"};
            break;
        case "de":
            language = {
            fetch:"Laden...",
        ...
        case "cz":
            ...
            unknown:"Unknown",
            allyscore:"Ally Score",
            score: "CelkovГ© skГіre",
            military: "VojenskГ© skГіre"};
            break;
        case "sk":
            language = {
            fetch:"nahrГЎvam...",
        ...
        case "pl":
            ...
            unknown:"Unknown",
            allyscore:"Ally Score",
            score:"CaЕ‚kowity Wynik",
            military:"GeneraЕ‚owie"};
            break;
        case "ro":
            language = {
            fetch:"Incarc...",
        ...
        case "il":
            ...
            allyscore:"Ally Score",
            score:"Ч Ч™Ч§Ч•Ч“",
            military:"Ч›Ч— Ч¦Ч‘ЧђЧ™"};
            break;
        case "vn":
            language = { 
            fetch:"Дђang tбєЈi...",
            unknown:"KhГґng biбєїt",
            allyscore:"LiГЄn minh",
            score:"Tб»•ng Д‘iб»ѓm",
            military:"QuГўn sб»±" }
            break;
        case "ikariam":
            switch (subDomain) 
            {
                ...
                case  "ae":
                    ...
                    fetch:"ЩЉШ¬Щ„ШЁ...",
                    unknown:"Unknown",
                    allyscore:"Щ†Щ‚Ш§Ш· Ш§Щ„ШЄШ­Ш§Щ„ЩЃ",
                    score:"Ш§Щ„Щ…Ш¬Щ…Щ€Ш№ Ш§Щ„ЩѓЩ„ЩЉ",
                    military:"Ш§Щ„Щ†Щ‚Ш§Ш· Ш§Щ„Ш№ШіЩѓШ±ЩЉЩ‡"};
                    break;
                case  "ba":
                    language = {
                    fetch:"dohvati...",
