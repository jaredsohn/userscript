...
// @description Adds links behind villages Buttons
...
(function() {
	...
	var dsrbAddButtons = function(node) {
		...
		if(coords) {
			var center = dsrbCreateButton('game.php?' + uv + 'village=' + vilid.own + '&screen=map&x=' + coords[0] + '&y=' + coords[1], icons.center, 'Auf Karte zentrieren');
		}
		var troops = dsrbCreateButton('game.php?' + uv + 'village=' + vilid.own + '&screen=place&mode=command&target=' + vilid.target, icons.troops, 'Truppen schicken');
