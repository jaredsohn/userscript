// ==UserScript==
          // @name                SpeedRound Thief Script
          // @namespace           SRTS
          // @description         A thiefscript for solo play
          // @include             http://speed.nukezone.nu/*
          // ==/UserScript==
          ...
          if (document.location.href.search('search.asp') != -1 && document.location.href.search('X=') == -1)
          {
          	...
          	for (var j=1; j<provs.length; j++)
          	{
          		...
          		aprovid.setAttribute('href', 'http://speed.nukezone.nu/show.asp?Action=Players&X=' + prov);
          		...
          		aprovclan.setAttribute('href', 'http://speed.nukezone.nu/show.asp?Action=Clans&X=' + clan);
