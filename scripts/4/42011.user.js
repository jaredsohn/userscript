...
window.location.href=window.location.href.replace(/sub3/, "apps").replace("/xpl/freeabs_all.jsp", "/xpls/abs_all.jsp").replace(/Error[\?\/].*/i, "").replace(/([^\/])\/(?!\/)/, "$1.myaccess.library.utoronto.ca/");