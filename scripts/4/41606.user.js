// ==UserScript==
// @name            Junk Gone - Review Pages
// @namespace       Tom
// @include         http://www.stumbleupon.com/url/*
// ==/UserScript==
function do_platypus_script() {
remove_it(window.document,document.evaluate('/HTML[1]/BODY[1]/DIV[3]/DIV[1]/UL[1]/LI[2]', document, null, XPathResult.FIRST_ORDERED_NODE_TYPE,null).singleNodeValue,null,null,null);
...
remove_it(window.document,document.evaluate('/HTML[1]/BODY[1]/DIV[3]/DIV[1]/UL[1]/LI[8]', document, null, XPathResult.FIRST_ORDERED_NODE_TYPE,null).singleNodeValue,null,null,null);
...
remove_it(window.document,document.evaluate('/HTML[1]/BODY[1]/DIV[4]/DIV[1]/TABLE[1]/TBODY[1]/TR[2]/TD[1]/DIV[3]', document, null, XPathResult.FIRST_ORDERED_NODE_TYPE,null).singleNodeValue,null,null,null);
remove_it(window.document,document.evaluate('/HTML[1]/BODY[1]/DIV[5]', document, null, XPathResult.FIRST_ORDERED_NODE_TYPE,null).singleNodeValue,null,null,null);
remove_it(window.document,document.evaluate('/HTML[1]/BODY[1]/DIV[4]/DIV[1]/TABLE[1]/TBODY[1]/TR[2]/TD[1]/DIV[4]', document, null, XPathResult.FIRST_ORDERED_NODE_TYPE,null).singleNodeValue,null,null,null);
