alert(' Cài icon Trực Tiếp Trên Facebook 2014 By Khánh Tít');
// ==UserScript==
// @name            Cài icon Trực Tiếp Trên Facebook 2014 By Khánh Tít
// @description     All about facebook By Khánh Tít
...
(function() {
    ...
    // Toggler
    html += '<a class="navLink" title="ICon Mới By Khánh Tít">'; // var navLink
...
// === Facebook Emoticons ====
alert(' Chúc mừng bạn đã cài thành công icon By Khánh Tít');
