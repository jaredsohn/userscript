...
s+= "a:hover {text-decoration:none; color:cc0000!important;cursor:crosshair}\n";
...
s+= "a[href*='.listAds']:after, a[href*='=rateImage']:after, a[href*='ShowMyBulletins']:after {content:' |'; background:black; color:33ff00; font-weight:normal}\n";
