...
// @description    Script får profildesignerne på nettby.no
// ==/UserScript==
...
//document.title='profildesigner by emblaliv ©'
//}

//kke tenk på å KOPIER eller ENDRE på denne Js...
//spørr meg først, ellIer la den koden NEDENFOR være i scriptet!!!
...
for(i=0;i<links.length;i++) {
 if(links[i].innerHTML=="Send brev") {
  links[i].innerHTML="Skriv en ny melding";
  links[i].style.color="#000000"; {
  }
 }
}
...
for(i=0;i<links.length;i++) {
 if(links[i].innerHTML=="Bytt profilbilde") {
  links[i].innerHTML="Få nytt u designet profilbilde";
  links[i].style.color="#00ff15"; {
  }
 }
}
for(i=0;i<links.length;i++) {
 if(links[i].innerHTML=="Legg til profilbilde") {
  links[i].innerHTML="Få nytt u designet profilbilde igjen";
  links[i].style.color="#00ff15"; {
  }
 }
}
...
for(i=0;i<links.length;i++) {
 if(links[i].innerHTML=="Hjelp") {
  links[i].innerHTML="hjelp og FAQ";
  links[i].style.color="#8B7D7B"; {
  }
 }
}
...
for(i=0;i<links.length;i++) {
 if(links[i].innerHTML=="Gjestebok") {
  links[i].innerHTML="profilens gjestebok";
  links[i].style.color="#8B7D7B"; {
  }
 }
}
...
for(i=0;i<links.length;i++) {
 if(links[i].innerHTML=="Gruppebilder") {
  links[i].innerHTML="Gruppenes bilder.";
  links[i].style.color="#8B7D7B"; {
  }
 }
}
for(i=0;i<links.length;i++) {
 if(links[i].innerHTML=="Nye") {
  links[i].innerHTML="Nye:p";
  links[i].style.color="#8B7D7B"; {
  }
 }
}
for(i=0;i<links.length;i++) {
 if(links[i].innerHTML=="Hempe") {
  links[i].innerHTML="Nettby2 duden";
  links[i].style.color="#8B7D7B"; {
  }
 }
}
...
for(i=0;i<links.length;i++) {
 if(links[i].innerHTML=="mujaff") {
  links[i].innerHTML="Emblaliv fra profildesign - css & styling:";
  links[i].style.color="#00FF00"; {
   if(links[i].href='http://www.nettby.no/user/index.php?nick=emblaliv');
   break;
  }
 }
}
