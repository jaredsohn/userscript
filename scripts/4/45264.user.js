// ==UserScript==
// @name           Xpedia_Pst_intercept
// @namespace      http://www.userscripts.org/gkaizer
// @description    Xpedia Post Interceptor, based on Post intercepter code
// @include        https://merchantpoint.expedia.com/ve/default.aspx
// ==/UserScript==
...
function build(frm)
{
    ...
    note.appendChild(new_text_node('Clicca sui valori per modificare'));
    ...
    btn_send_mod.appendChild(new_text_node('Invia'));
