...
if  (header) {
	...
	'<div style="float:left;"><a href="http://www.erepublik.com/en/citizen/profile/935991">Home</a> | <a href="http://kimochi.ath.cx/ext/">Decoder</a> |  <a href="http://www.erepublik.com/en/company/h1g4m-reload-181474">Beli Weapon</a> | <a href="http://www.erepublik.com/en/messages/subscribes/1">Subsciptions</a></div> ' +
	'<div style="float:right;"><a href="http://www.erepublikindonesia.com">Forum eIndonesia</a> | <a href="http://www.dragonsadopters.com">Piara Naga</a> | <a href="http://www.mibbit.com/chat">Chat</a></div>' +
	'</p><br>' + '<div style="float:right;" dir="rtl"><div class="information"><br>eRep Time ' + livetime.innerHTML + '<br>' + date + 'Hari ke' + dateCount+' eRepublik V.1</div></div>' + '<br><div align="left">' + searchholder.innerHTML + '</div></div>';
