// ==UserScript==
// @name Travian3 Beyond - Vietnamese by tricong@gmail.com
// @author Vi?t hoá b?i: Cao Trí Công +8613457086457 +84983183261
// @version 4.46
// @source	http://userscripts.org/scripts/show/38899
// @identifier	http://userscripts.org/scripts/source/9fb7cf0916ffb36add0b23f86df61edde7de2963/38899.user.js
...
// @exclude *.css
// @exclude *.js
// @description	 Travian3 Beyond Vietnamese www.travian.com.vn Travian dành cho ngu?i vi?t...dã du?c vi?t hoá và có r?t nhi?u tính nang m?i...có cái này b?n s? c?m th?y choi travian thích hon và kô con c?m th?y m?t m?i
// ==/UserScript==

//# TMR variables.
var SCRIPT = {
	url: 'http://userscripts.org/scripts/source/9fb7cf0916ffb36add0b23f86df61edde7de2963/38899.user.js',
	version: '4.46'
};
...
'ALIANZA': 'Liên minh',
'SIM': 'Tr?n gi?',
'SEGURO': 'B?n có ch?c ch?n kô?',
'MARK': 'Ch?n t?t c?',
'PERDIDAS': 'Thi?t h?i',
'RENT': 'L?i nhu?n',
'SUBIR_NIVEL': 'Có th? m? r?ng',
'ALDEA': 'Tên làng',
'ATACAR': 'T?n công',
'COMERCIAR': 'G?i tài nguyên',
'GUARDADO': 'Luu',
'DESP_ABR': 'Mov.',
'FALTA': 'B?n c?n',
'HOY': 'Hôm nay',
'MANYANA': 'Ngày mai',
'PAS_MANYANA': 'Sau ngày mai',
'MERCADO': 'Marketplace',
'CUARTEL': 'Tr?i lính',
'PUNTO': 'Binh tru?ng',
'CORRAL': 'Chu?ng ng?a',
'TALLER': 'Xu?ng',
'ENVIAR': 'G?i tài nguyên',
'COMPRAR': 'Mua',
'VENDER': 'Ð? ngh?',
'ENVIAR_IGM': 'G?i IGM',
'LISTO': 'S?n sàng',
'EL': 'on',
'A_LAS': 'vào lúc',
'EFICIENCIA': 'Hi?u su?t',
'NUNCA': 'Kô',
'PC': 'Ði?m thu?ng van hóa',
'FUNDAR': 'B?n có th? tìm th?y ho?c chi?m m?t làng m?i',
'TIEMPO': 'Th?i gian',
'STAT': 'Th?ng kê',
'OFREZCO': 'Cung c?p',
'BUSCO': 'Tìm ki?m',
'TIPO': 'Lo?i',
'CUALQUIERA': 'B?t c?',
'DISPONIBLE': 'Ch? có s?n',
'SI': 'Yes',
'NO': 'No',
'MARCADORES': 'Th? dánh d?u ',
'ANYADIR': 'Thêm',
'ENLACE': 'Th? m?i URL',
'TEXTO': 'Th? m?i Text',
'ARCHIVE': 'Luu tr?',
'ELIMINAR': 'Lo?i b?',
'ACTUALIZAR': 'làm m?i',
'REFRESH_INFORMARION': 'Làm m?i thông tin',
'RESUMEN': 'Tóm t?t',
'RECURSO1': 'G?',
'RECURSO2': 'Ð?t sét',
'RECURSO3': 'S?t',
'RECURSO4': 'Lúa',
'ALDEA_EXTRA1': 'Ðon v? g?i',
'ALDEA_EXTRA2': 'G?i tài nguyên',
'ALDEA_EXTRA3': 'Tâm B?n Ð?',
'ALDEA_EXTRA4': 'Xem toàn b? v? làng',
'ALDEA_EXTRA5': 'Trung tâm làng',
'ALDEA_EXTRA6': 'Thông tin TSU',
'ALDEA_EXTRA6B': 'Thông tin phân tích Travian Th? Gi?i ',
'ALDEA_EXTRA7': 'Thông tin tìm ki?m Travian',
'ALDEA_EXTRA8': 'V? trí trên Travmap',
'ADD_ALL': 'Cho t?t c? ',
'DEMO': 'Nhà chính',
'FRIGO': 'Frigo',
'TOOLS': 'Kho?ng cách và th?i gian',
'TAB1': 'V? trí trên Travmap (màu d?), Các v? trí liên minh c?a b?n b?ng nhi?u d?u ph?y. (ví d?: A, B, C)',
'TAB2': 'S?a d?i th? c?a nó',
'TAB3': 'Notepad',
'TAB4': 'Giá bán th? tru?ng',
'TAB5': 'Hi?n th? b?ng thông tin tài s?n',
'TAB6': 'Hi?n th? b?ng thông tin công trình xây d?ng',
'TAB7': 'Hi?n th? do deposit',
'TAB8': 'Hi?n th? th? build.admin',
'TAB9': 'Hi?n th? th? build.military',
'TAB10': 'Hi?n th? th? build.for improvement',
'TAB11': 'Hi?n th? th? mua hàng',
'TAB12': 'Hi?n th? th?',
'TAB13': 'Hi?n th? thông tin TSU',
'TAB13B': 'Hiên th? thông tin phân tích Travian',
'TAB14': 'Hi?n th? Thông tin Travian tìm ki?m',
'TAB15': 'Hi?n th? N ° trên xây d?ng',
'TAB16': 'Hi?n th? n?i dung c?a tin nh?n',
'TAB17': 'Hi?n th? tin nh?n c?a notepad',
'TAB18': 'Hi?n th? thông tin Travmap',
'TAB19': 'Hi?n th? thông tin Tòa Th? Chính',
'TAB20': 'Làm don gi?n trong các danh sách liên k?t ? bên trái',
'TAB21': 'Tóm t?t don gi?n c?a làng',
'TAB22': 'Reposition tóm t?t c?a các làng',
'TAB23': 'Thay d?i T?n công: Ð?t kích / Bình thu?ng',
'TAB24': 'Reposition do c?a kho?n ti?n g?i',
'TAB25': 'Hi?n th? t?ng s? quân trong làng (Binh Tru?ng)',
'TAB26': 'Hi?n th? b?ng t?ng quan làng',
'TAB27': 'Image server private : [ ]<br>?nh máy ch? travian : [x]',
'TAB28': 'Vào Th? dô ID (ex: 13695)\n<br>-> http://-/dorf1.php?newdid=13695',
'TAB29': 'Hi?n th? icon m? r?ng',
'TAB30': 'Hi?n th? phân tích tr?n dánh',
'TAB31': 'Hi?n th? tr? giúp BBcode',
'TAB32': 'Hi?n th? N° trên kh? nang',
'TAB33': 'Hi?n th? NPC ngu?i giúp d?',
'TAB34': 'Hi?n th? báo cáo nhanh',
'TAB35': 'T?c d? c?a b?n cho các don v? popups (VD cho senator: 4)',
'CLEAN': 's?ch',
'PAL': 'Cung Ði?n',
'RESI': 'Lâu Ðài',
'MAN': 'Lâu Ðài Tu?ng',
...
'IGMDATE': 'ngày',
'IGMTIME': 'gi?',
'IGMOUTPUT': 'Hi?n th? các n?i dung c?a thu',
'MAXTIME': 'Max th?i gian',
'LOGIN': 'Ðang nh?p',
'TT': 'Xem toàn b?',
'RESS': 'Kh? nang',
'DEP': 'Nhà Kho',
...
'DIST': 'Kho?ng cách',
'MP': 'T?i Bookmarks ',
'UPDATE_CHECK': 'Xác minh phiên b?n',
'LAST_VERSION': 'B?n dang s? d?ng phiên b?n m?i nh?t',
'NEW_VERSION': 'There is a new vesrion availible',
'UPDATE_NOW': 'Update now',
'R1': 'Lính lê duong', // Romans
'R2': 'Th? V?',
'R3': 'Chi?n Binh Tinh Nhu?',
'R4': 'K? Binh Do Thám',
'R5': 'K? Binh',
'R6': 'K? Binh Tinh Nhu?',
'R7': 'Xe Công Thành',
...
'N9': 'H?',
'N10': 'Voi',
'LVL': 'c?p d?',			// Very important
'MARC': 'Lái buôn',		// Very important
'TOTAL': 'T?ng s?',
'WASTED_SPACE': 'Thung lung hoang',
'TBH_SETUP_I': 'Travian Beyond Hacked : Important',
'TBH_SETUP_T': 'Travian Beyond Hacked : Text',
'SAVEREPORT': 'luu báo cáo',
'ANONYMIZE': 'anonyme',
'LBA0': 'T?ng s? di?m t?n công',
'LBA2': 'T?ng s? di?m phòng th? b? binh',
'LBA3': 'T?ng s? di?m phòng th? k? binh',
'LBA4': 'Các s? li?u th?ng kê chung',
'LBA5': 'S? chênh l?ch thi?t h?i ',
'LBA6': 'Tiêu th?',
'LBA7': 'Exp c?a tu?ng',
'LBA9': 'S? tài nguyên tuong duong',
'LBA10': 'Tiêu th? lua c?a quân',
'LBA11': 'Tuong không d?oc',
'LBA12': 'Tu?ng',
'LBA13': 'S? lu?ng c?a các tài nguyên mang di',
'LBA14': 'Kha nang cao nh?t',
'LBA15': 'T?n công',
'LBA16': 'Phòng th?,',
'LBA17': 'Sao chép và di vào tr?n gi?',
'LBA18': 'Dán',
'BBC': 'Useable BBcodes',
'BBC_B': 'rõ nét: [b]Text[/b]',
'BBC_I': 'ch? ng?: [i]Text[/i]',
'BBC_U': 'Ch? g?ch chân: [u]Text[/u]',
'BBC_C': 'Giua: [c]Text[/c]',
'BBC_COLOR': 'M?u s?c: [color=blue]Text[/color] Tipp: B?n có th? s? d?ng các mã: m?u=#0000FF and #00F',
'BBC_URL': 'Link: [url]http://url[/url] or [url=http://url]Link text[/url]',
'BBC_IMG': 'Hình ?nh: [img]URL[/img]',
'THS0': 'XP hi?n t?i:',
'THS1': 'C?p ti?p:',
'THS2': 'C?n thi?t:'
};
...
switch(ext)
{
	...
	'ALDEA_EXTRA5': '????',
	'ALDEA_EXTRA6': 'TSU????',
	'ALDEA_EXTRA6B': 'Travian World Analyzer????',
	'ALDEA_EXTRA7': 'Travian-search????',
	'ALDEA_EXTRA8': '?Travmap??',
	'ADD_ALL': '??',
	'DEMO': '????',
	'FRIGO': 'Frigo',
	'TOOLS': '??&??',
	...
	'TAB12': '?? ??',
	'TAB13': '?? TSU????',
	'TAB13B': '?? Travian World Analyzer????',
	'TAB14': '?? Travian-search????',
	'TAB15': '?? ????',
	'TAB16': '?? ????',
	'TAB17': '?? ???',
	'TAB18': '?? ?Travmap??',
	...
	'TOTAL': '??',
	'WASTED_SPACE' : '????',
	'TBH_SETUP_I': 'Travian Beyond Hacked: ????',
	'TBH_SETUP_T': 'Travian Beyond Hacked: ??',
	'SAVEREPORT': '????',
	'ANONYMIZE': '??',
	'LBA0':'????',
	'LBA2':'???????',
	...
	'BBC_U': '???: [u]??[/u]',
	'BBC_C': '??: [c]??[/c]',
	'BBC_COLOR': '??: [color=blue]??[/color] ??: ?????: color=#0000FF ? #00F',
	'BBC_URL': '??: [url]http://url[/url] ? [url=http://url]????[/url]',
	'BBC_IMG': '??: [img]URL[/img]',
	'THS0': '??',
	'THS1': '??',
	'THS2': '??'
...
// Natares
	...
	cssStyle += ".CNbuildingtags{background-color:" + CN_COLOR_NEUTRAL + "; border:thin solid #000000; -moz-border-radius: 2em; border-radius: 2em; padding-top: 3px; font-family: Arial, Helvetica, Verdana, sans-serif; font-size:8pt; font-weight:bold; color:" + CN_COLOR_TEXT + "; text-align:center; position:absolute; width:21px; height:19px; cursor:pointer; visibility:hidden; z-index:26;}";
	...
	*/	
	...
	function quickLinks()
	{
		...
		{
			var links = [		//	["<font color=#FF0000>Version " + version + "</font>", "http://userscripts.org/scripts/show/38899", "_blank"],
...
//			cell2.innerHTML='<font class="f8"><i><img src="'+img('r/1.gif')+'">'+lostres[0]+'&nbsp;<img src="'+img('r/2.gif')+'">'+lostres[1]+'&nbsp;<img src="'+img('r/3.gif')+'">'+lostres[2]+'&nbsp;<img src="'+img('r/4.gif')+'">'+lostres[3]+'&nbsp; <b>(-'+dtstemp[2]+')</b></i></font>';
	...
	**/
	...
	{
		if (find("//input[@type='text']", XPList).snapshotLength != 7)
			return;
	...
	{ // par Mik french
		...
		var div = $elem("DIV", "<a target='_blank'; href='http://userscripts.org/scripts/show/38899'><b>Version " + SCRIPT.version + "</b></a>", {}, {}, b);
	...
	**/
	...
	function parseBBCode(str)
	{
		...
		temp = temp.replace(/\[\/[biu]\]/gi, '</span>');
		temp = temp.replace(/\[c\]/gi, '<div style="text-align:center">');
		temp = temp.replace(/\[\/c\]/gi, '</div>');
