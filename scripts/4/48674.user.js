// ==UserScript==
// @name           eRepublik Italia
// @description    eRepublik Italia
...
// menu
	...
	"Company" : "Azienda", 
	"Profile":"Profil", 
	"Party" : "Partito politico", 
	"Newspaper" :"Giornali",
	"Army" : "Esercito",
	"Country administration" : "Paese amministrazione",
        "Organizations" : "Organizzazioni",
	"Market" : "Mercato",
	"Monetary market" : "Mercato monetario",
	"Job market" : "Mercato del lavoro",
        "Companies for sale" : "Azienda per la vendita",
        "Get gold &amp; extras" : "Scarica l'oro e gli extra",
	"Rankings" : "Classifica",
	"Social stats" : "Statistica sociale",
	"Economic stats" : "Statistica economica",
	"Political stats" : "Statistica politica",
	"Military stats" : "Statistica militare",
	"Tools" : "strumenti",
	"Forum" : "Forum",
	"News" : "Notizie",
	"Invite friends" : "Invitare amici",
	"eRepublik Shop" : "eRepublik Shop",
	"Career path" : "Percorso di carriera",
	"Ok, thanks, next tip" : "Ok, grazie, il prossimo consiglio",
	"I have nothing more to say at the moment" : "Non ho niente altro da dire per il momento",
	"Select" : "Selezionare",
        "Latest events" : "Ultimi eventi"
        "More events" : "Piu eventi",
        "More news" : "Piu notizie",
	"Marketplace" : "Piazza",
	"Wars" : "Guerre",
...
// country page
	...
	"Total citizens" : "Totale dei cittadini",
	"New citizens today" : "Nuovi cittadini di oggi",
