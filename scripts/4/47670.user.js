...
//
// ==UserScript==
// @name           Barra Premium do Tribal Wars
// @namespace      www.tribalwars.net @description    Somente pros Brazucas !!!
...
window.createQuickbarShortcuts = function() {
	"<tr>   " + 
	newShortcut("http://ro5.triburile.ro/graphic/buildings/main.png", "/game.php?village="+VillId+"&screen=main", "Edificio Principal   ");
