// ==UserScript==
// @name            Platypus-nl1.tribalwars.nl/game.p
// @namespace       Platypus
// @include         http://nl1.tribalwars.nl/game.php?screen=overview_villages&intro&popup
// ==/UserScript==
function do_platypus_script() {
set_style_script(window.document,document.evaluate('/HTML[1]/BODY[1]/DIV[2]/TABLE[1]/TBODY[1]/TR[1]/TD[1]/TABLE[1]/TBODY[1]/TR[1]/TD[7]/A[1]/IMG[1]', document, null, XPathResult.FIRST_ORDERED_NODE_TYPE,null).singleNodeValue,"color: fuchsia;",null,null);
set_style_script(window.document,document.getElementById('wood'),"color: green;font-size: small;",null,null);
set_style_script(window.document,document.getElementById('stone'),"color: maroon;font-size: small;",null,null);
set_style_script(window.document,document.getElementById('iron'),"color: olive;font-size: small;",null,null);
set_style_script(window.document,document.getElementById('storage'),"color: blue;font-size: small;",null,null);
set_style_script(window.document,document.evaluate('/HTML[1]/BODY[1]/TABLE[2]/TBODY[1]/TR[1]/TD[3]/TABLE[1]/TBODY[1]/TR[1]/TD[1]/TABLE[1]/TBODY[1]/TR[1]/TD[2]', document, null, XPathResult.FIRST_ORDERED_NODE_TYPE,null).singleNodeValue,"color: purple;background-color: fuchsia;font-size: small;",null,null);
set_style_script(window.document,document.evaluate('/HTML[1]/BODY[1]/TABLE[2]/TBODY[1]/TR[1]/TD[3]/TABLE[1]/TBODY[1]/TR[1]/TD[1]/TABLE[1]/TBODY[1]/TR[1]/TD[2]', document, null, XPathResult.FIRST_ORDERED_NODE_TYPE,null).singleNodeValue,"color: teal;font-size: small;",null,null);
set_style_script(window.document,document.getElementById('storage'),"color: purple;font-size: small;",null,null);
do_modify_html_it(window.document,document.evaluate('/HTML[1]/BODY[1]/DIV[2]/TABLE[1]/TBODY[1]/TR[1]/TD[1]/TABLE[1]/TBODY[1]/TR[1]/TD[7]/A[2]', document, null, XPathResult.FIRST_ORDERED_NODE_TYPE,null).singleNodeValue,/Stam/,'OVI',null);
set_style_script(window.document,document.evaluate('/HTML[1]/BODY[1]/TABLE[4]/TBODY[1]/TR[1]/TD[1]/TABLE[1]/TBODY[1]/TR[1]/TD[1]/TABLE[1]/TBODY[1]/TR[1]/TD[1]/TABLE[3]/TBODY[1]', document, null, XPathResult.FIRST_ORDERED_NODE_TYPE,null).singleNodeValue,"color: blue;background-color: fuchsia;font-size: small;",null,null);
set_style_script(window.document,document.evaluate('/HTML[1]/BODY[1]/TABLE[4]/TBODY[1]/TR[1]/TD[1]/TABLE[1]/TBODY[1]/TR[1]/TD[1]/TABLE[1]/TBODY[1]/TR[1]/TD[1]/TABLE[2]/TBODY[1]/TR[1]/TD[2]', document, null, XPathResult.FIRST_ORDERED_NODE_TYPE,null).singleNodeValue,"color: blue;font-size: small;border-style: double;border-width: thin;border-color: black;",null,null);
