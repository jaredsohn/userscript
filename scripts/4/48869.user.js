// ==UserScript==
// @name            Ind3X's WkW sorted4ever
// @namespace       de
// @include         http://www.wer-kennt-wen.de/*
// ==/UserScript==
function do_platypus_script() {
do_modify_url_it(window.document,document.evaluate('/HTML[1]/BODY[1]/DIV[2]/DIV[2]/DIV[2]/DIV[1]/DIV[1]/UL[1]/LI[4]/A[1]', document, null, XPathResult.FIRST_ORDERED_NODE_TYPE,null).singleNodeValue,/http:\/\/www\.wer-kennt-wen\.de\/people\/friends/,'http://www.wer-kennt-wen.de/people/sorted',false);
}; 
