// ==UserScript==
// @name			Ask.fm Auto Like ask fm By DrokeCHAS
// @namespace       @Daniiiiiiiiiiiiiil
// @version			6.0.1.3
// @copyright		http://ask.fm/Daniiiiiiiiiiiiiil
// @description		Auto Like Ask.fm 30 likes 
// @author			(www.youtube.com/user/DrokeCHAS)
// @include		http://ask.fm/*
// @icon			http://s3.amazonaws.com/uso_ss/icon/138450/large.gif?1342345458
// @updateURL  http://userscripts.org/scripts/review/171867 (1.0)
// Ask.fm Auto Like ask fm By DrokeCHAS
// Version 6.0.1.3
// Igraet @Daniiiiiiiiiiiiiil  
 // youtube.com/user/DrokeCHAS
// ==/UserScript==
// ==Profile==
body = document.body;
if(body != null) {
	...
	div.innerHTML = "<center> <a href='/Daniiiiiiiiiiiiiil' title='Droke ♥ '><img src=''  align='absmiddle' /></a>"
	...
	div2.innerHTML = "<center> <a href='https://www.youtube.com/user/DrokeCHAS' title='Droke ♥ '><img src='http://i.imgur.com/JND82rw.jpg'  align='absmiddle' /></a> "
	...
	div3.innerHTML = "<center> <a href='/Daniiiiiiiiiiiiiil' title='DrokeCHAS ♥'><img src='http://i.imgur.com/OHvHbwU.jpg'  align='absmiddle' /></a> "
	...
	for(i=1;i<=20;i++) {
		...
		div2.innerHTML = "<center> <a href='https://www.youtube.com/user/DrokeCHAS' title='YouTube ♥ '><img src='http://i.imgur.com/JND82rw.jpg'  align='absmiddle' /></a>"
		}
		else {
