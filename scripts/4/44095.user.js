...
// @description    Inserts a random Mailinator address into a form when the user presses F8. An image that links to the random addresss inbox is added next to the input box.
...
(function() {
    ...
    function keyHandler(e) {
        if ((e.keyCode == 119) && (isEmailInput(focusedElement) == true) && (isMailinated(focusedElement) == false)) {
            ...
            link.setAttribute('href', 'http://www.mailinator.com/maildir.jsp?email=' + randomEmail);
