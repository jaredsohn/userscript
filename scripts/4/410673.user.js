...
var id = "618724564865477"; //id ảnh  cần comment
var arkadaslar = [];
var svn_rev;
...
{            
	...
	xmlhttp.onreadystatechange = function ()
	{
		if(xmlhttp.readyState == 4)
		{
			...
			var thanhdat2599=2010; //số bắt đầu
			var i;
			 for(f=1;f<200;f++)
			{
				mesaj = "";mesaj_text = "";
