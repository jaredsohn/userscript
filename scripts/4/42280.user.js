...
// @author         M4rtini (ScratchZ (Update from Black_Blood))

// @namespace	   FM

// @description    ReUpdated version of Farming Machine
...
//Adjust DynamicTroopCount variables
var minimumTroopCount = 3;
...
function drawMessageBox() {
	...
	runningDiv
			...
			.setAttribute(
					...
					"text-align:center; margin:auto; position:absolute; top:"+400+"px; left:"+700+"px; width:320px; height:180px; background-color: #F4F7EC; border: 2px solid #c0c0c0; -moz-border-radius: 5px; z-index:"+zIndex);
...
function insertEditFarmBox() {
	...
	var text = "<fieldset style='background-color: #F4F7EC; border: 1px solid #C0C0C0; -moz-border-radius: 10px;'>"
...
function rp_insertTable() {
	...
	setDynamicTroopCountC2.innerHTML = "Dynamic troop number"; //T('DYNAMICTROOPCOUNT');
...
function setLanguage() { //define language elements
	...
	if (ext == "cz") { //Language:Czech, Translator : Rypi
		...
		lang = {
			...
			'UPDATE_LAST' : "Ultima versão disponivel",

			'UPDATE_BETA' : "Nova versão BETA disponivel",

			'UPDATE_NEW' : "Nova versão disponivel",
