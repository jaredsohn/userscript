// ==UserScript==
// @name           Bungie Translate [EDITED]
// @author         Greg Brown (Sprool) & PKF 647 & RyanThePerson
// @version        1.1
// @namespace      http://www.bungie.net/
// @description    Translates specific Acronyms on Bungie. Originally by PKF_647.
...
// Edited to only change full words by RyanThePeron
...
function ParseSmileys()
{
    for (var I = 1; I < 25; I++)
    {
        ...
        if (Post = document.getElementById("ctl00_mainContent_postRepeater1_ctl" + IString + "_ctl00_postControl_skin_PostBlock") || document.getElementById("ctl00_mainContent_postForm_skin_originalPost_skin_PostBlock"))
        {
			            ...
			            Post.innerHTML = Post.innerHTML.replace(" odst", " Orbital Drop Shock Trooper");
			            Post.innerHTML = Post.innerHTML.replace(" OSDT", " WtF is OSDT? Orbital Shock Drop Trooper? Retard!");
			            Post.innerHTML = Post.innerHTML.replace(" osdt", " WtF is OSDT? Orbital Shock Drop Trooper? Retard!");
