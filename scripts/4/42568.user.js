...
// @version        0.2
// @autor          kyler (Barra Kingsage)
// @description    Forum Kingsage ORG that unfolds in the game.
...
unsafeWindow.displaywiki = function() {
	if(displayedflag == 0) {
		document.getElementById("wikiframe").innerHTML = '<iframe width="920" border="0" frameborder="0" height="100%" src="http://board.kingsage.es/" style="margin-left:26px;"></iframe>';
		displayedflag = 1;
	}
}
...
var wkHTML = '<div id="wikitab" onmouseover="showwiki()" onclick="hidewiki()"><a style="height:100%;width:100%;"></a></div>'
	...
	+ '<a style="border-bottom:1px #542C0F dotted; color: #542C0F;" href="http://www.kingsageES.ourtoolbar.com/">ForumBar Kingsage</a></div>'
	+ '<div id="wikiframe" style="position:absolute;top:30px;bottom:3px;left:4px;" onmouseover="displaywiki()">	
Move your mouse here to load the page.</div>'
...
GM_addStyle("#wikitab { background:url(http://img444.imageshack.us/img444/1179/foroopayafz7.gif); width:26px; height:100px; position:absolute; right:-26px; top:0px; } ");
