// ==UserScript==
// @name           XNova.es - Pantalla de Recursos Ampliada
// @author         adri93
// @date           02-04-2009
// @version        1.2b
// @namespace      OGame xnova Pantalla de Recursos Ampliada
// @description    XNova.es Pantalla Recursos Ampliada. Muestra una nueva tabla al final de la pantalla recursos con la suma de todas las producciones de todos los planetas y muestra en tiempo real los recursos. Funciona con el nuevo xnova
// @include        http://xnova.es/uni1/overview.php*
// @include        http://xnova.es/uni1/buildings.php*
// @include        http://xnova.es/uni1/resources.php*
// @include        http://xnova.es/uni1/fleet.php*
// @include        http://xnova.es/uni1/annonce.php*
// @include        http://xnova.es/uni1/techtree.php*
// @include        http://xnova.es/uni1/messages.php*
// @include        http://xnova.es/uni1/infos.php*
// @include        http://xnova.es/uni1/stat.php*
// @include        http://www.xnova.es/uni1/overview.php*
// @include        http://www.xnova.es/uni1/buildings.php*
// @include        http://www.xnova.es/uni1/resources.php*
// @include        http://www.xnova.es/uni1/fleet.php*
// @include        http://www.xnova.es/uni1/annonce.php*
// @include        http://www.xnova.es/uni1/techtree.php*
// @include        http://www.xnova.es/uni1/messages.php*
// @include        http://www.xnova.es/uni1/infos.php*
// @include        http://www.xnova.es/uni1/stat.php*
// ==/UserScript==
...
//Modificado y readaptado para el nuevo xnova.es por adri93
...
if( location.href.indexOf('xnova.es/uni1/resources.php') != -1 ){
   ...
   if( location.href.indexOf('xnova.es/uni1') != -1 ){
      metal = (metal * 3) / 24;
