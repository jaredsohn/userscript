// Simple translation updates by Whiskers, plus font size tweaks.
// 
// version 1.4.2 (lite)
// 2008-05-21
...
//
// ==UserScript==
// @name           Ikariam åˆ†æ•¸æ’ä»¶ (0.2.8 é©ç”¨)
...
function cityInformation() {
    ...
    if (playerName != GM_getValue("lastPlayerCheck") || GM_getValue("lastCheckedTimestamp") < checkedTime || GM_getValue("lastServerCheck") != 
...
function defineLanguage(langTDL) {
    switch (langTDL) {
        ...
        case "sk":
            ...
            break;
        case "tw":
            language = { inline:"ç©åˆ†è³‡è¨Š",
            fetch:"è®€å–ä¸­...",
            unknown:"ç„¡æ³•å¾—çŸ¥",
            allyscore:"è¯ç›Ÿåˆ†æ•¸",
            allymembers:"è¯ç›Ÿæˆå“¡",
            score:"ç¸½åˆ†",
            military:"æˆ°çˆ­å°‡è»",
            gold:"é»ƒé‡‘å­˜é‡",
            loot:"æ¶" };
        ...
        case "ikariam":
            ...
            if (subDomain == "ae") {
                ...
                fetch:"ÙŠØ¬Ù„Ø¨...",
                unknown:"Unknown",
                allyscore:"Ù†Ù‚Ø§Ø· Ø§Ù„ØªØ­Ø§Ù„Ù",
                allymembers:"Ally Members",
                score:"Ø§Ù„Ù…Ø¬Ù…ÙˆØ¹ Ø§Ù„ÙƒÙ„ÙŠ",
                military:"Ø§Ù„Ù†Ù‚Ø§Ø· Ø§Ù„Ø¹Ø³ÙƒØ±ÙŠÙ‡",
                gold:"Ø§Ù„Ø°Ù‡Ø¨",
                loot:"loot" };
            }
            if (subDomain == "ba") {
