...
switch(sLang) {
 ...
 case "ir":  //by saber_zaree
    aLangBuildings = ["", "Kawasan Pembalakan", "Kuari Tanah Liat", "Lombong Bijih Besi", "Ladang", "Kilang Papan", "Kilang Bata", "Faundri Besi", "Pengisar Bijian", "Kilang Roti", "Gudang", "Jelapang", "Kedai Senjata", "Kedai Perisai", "Gelanggang Latihan", "Bangunan Utama", "Titik Perhimpunan", "Pasar", "Kedutaan", "Berek", "Kandang Kuda", "Bengkel", "Akedemi", "Gua", "Dewan Perbandaran", "Residen", "Istana", "Perbendaharaan", "Pejabat Dagangan", "Berek Besar", "Kandang Kuda Besar", "Tembok Bandar", "Tembok Tanah", "Pagar Kubu", "Kedai Tukang Batu", "Brewery", "Perangkap", "Rumah Agam Wira", "Gedung Besar", "Jelapang Besar", "Wonder"];
    aLangTasks = ["Binakan", "Tingkatkan", "Serang", "Selidik", "Latih"];
    aLangStrings =["ساخته جنبی", "بهبود امکانات", "حمله بعدی", "پژوهش بعدی", "برنامه وظایف بعدی", "ما ساختن رو شروع کردیم شما بی خیال شو  ", " تلاش شما بی نتیجه بود برو بابا ", "مرحله", " ساختن انجام نشد", " لول آپ نشد", "لیست منتظر حمله ", "محصول باقی مانده:", "وظایف به درستی انجام نشد", "وظایف قابل شناسایی نیست", "وظایف برنامه ریزی شده*تقدیم به اتحادیه ی کایا ", "پاک کردن", "بعد فرستادن نیرو", "هیچ سربازی انتخاب نشده است", "سربازان شما حمله کردند", "سربازان شما قابل فرستادن نیستند", "پشتیبانی", "حمله", "هجومی", "هدفگیری منججنیق", "تصادفی", "در", "یا عقب", "ثانیه", "دقیقه", "ساعت", "روز", "جاسوسی نیرو ومنابع", "جاسوسی قدرت دفاعی و نیروها", "away", "جمله در زمان تعیین شده نتوانست انجام شود", "در موقعیت نیست", "طبقه بندی بر اساس::", "نوع ", "زمان ", "هدف ", "تنظیمات ", "روستا ", "وظایف انجام شده* تقدیم به اتحادیه ی کایا", "تمام وظایف", "ما جستوجو را شروع کردیم ", " نتوانستیم جستوجو کنیم", "افزودن بعداً", "جاسوس", "تربیت بعداً", "سربازها.", "تعلیم", "ما تعلیم را شروع کردیم ", " نتوانستیم تعلیم دهیم."];
    aLangTroops[0] = ["Askar Legion", "Pegawal Pertahanan", "Askar Empayar", "Kesatria Diplomatik", "Kesatria Empayar", "Kesatria Jeneral", "Kereta Pelantak", "Tarbil Api", "Senator", "Peneroka", "Hero"];  //Rom
    aLangTroops[1] = ["Askar Belantan", "Askar Lembing", "Askar Kapak", "Peninjau", "Kesatria Santo", "Kesatria Teutonik", "Kereta Pelantak", "Tarbil", "Penghulu", "Peneroka", "Hero"];  //Teuton
    aLangTroops[2] = ["Falanks", "Askar Pedang", "Penjelajah", "Guruh Theutates", "Penunggang Druid", "Haeduan", "Kereta Pelantak", "Tarbil", "Pemimpin", "Peneroka", "Hero"];  //Gaul
    break;
