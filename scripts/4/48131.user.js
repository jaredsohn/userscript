// ==UserScript==
          // @name         Pennerbar seitenmenue Hamburg by basti1012 versin 2.2 einstellbare farben und Position
          // @namespace    Autor: zeigt ein menue am rand man sieht alles an daten was man wissen muss.Version fuer hamburg pennergame
          // @author	 http://basti1012.okbb.de/forum.html    neue adresse ab juni
          // @homepage	 http://pennergame-basti1012.foren-city.de/  
          // @description  Fuegt ein informations menue am rand ein wird alles angezeigt was man ueber sein penner wissen muss .Mit einstlbaren menü man kann wählen wo das menü angezeigt werden soll und welche farbe das menü die scrift und so weiter haben soll by basti1012
          ...
          //Transparent (#1006F8)
          var Tran = GM_getValue("MenueBGtranIn");          // transparent minimum 0.4 eingeben nie wenniger nach speichern könnte das menue so transparent sein das ihr es nicht mehr sieht eine enderung geht dann nur noch im script
          ...
          GM_xmlhttpRequest({   // bandenid und namen
                method: 'GET',
                url: 'http://pennergame.de/dev/api/user.'+userid+'.xml',
          ...
          var maxspenden = "<span style=\"color:"+SchriftBG+"\"><big><b>50</b></big></span>" //hier kann man die spenden hoehe einstellen zur teit sind es 10
          ...
          var ZHamburg = "<li><a href=\"http://www.pennergame.de\" title=\"nach Hamburg\"<span style=\"color:blue\"><b>Hamburg</b></span></a></li>";
          ...
          var ZSauber = "<li><a target=\"_blank\" href=\"http://pennergame.de/city/washhouse/\" title=\"Spenden-Statistik\"><span style=\"color:"+SchriftBG+"\"><b>Sauber: </span><span style=\"color:"+SBG+"\"<middle>"+clean+"%</b></middle></span></a></li>";
          var ZPromille = "<li><a target=\"_blank\" href=\"http://pennergame.de/city/supermarket/\" title=\"bier kaufen\"><span style=\"color:"+SchriftBG+"\"><b>Promille: </span><span style=\"color:"+SBG+"\"<middle>"+prom2+"?</b></middle></span></a></li>";
          var ZApi = "<li><a target=\"_blank\" href=\"http://pennergame.de/dev/api/user."+userid+".xml\" title=\"penner api\"><span style=\"color:"+SchriftBG+"\"><b>Pennerid: </span><span style=\"color:"+SBG+"\"<middle>"+userid+"</b></middle></span></a></li>";
          var ZName = "<li><a href=\"http://pennergame.de/overview/\" title=\"pennername\"><span style=\"color:"+SchriftBG+"\"><b></span><span style=\"color:"+SBG+"\"<middle>"+Name+"</b></middle></span></a></li>";
          var ZAtt = "<li><a target=\"_blank\" href=\"http://pennergame.de/fight/overview/\" title=\"att\"><span style=\"color:"+SchriftBG+"\"><b>ATT:<span style=\"color:"+SBG+"\"<middle>"+att+"</b></middle></span></a></li>";
          var ZDef = "<li><a target=\"_blank\" href=\"http://pennergame.de/fight/overview/\" title=\"def\"><span style=\"color:"+SchriftBG+"\"><b>DEF:<span style=\"color:"+SBG+"\"<middle>"+def+"</middle></span></a></li>"; 
          var ZBande =  "<li><a target=\"_blank\" href=\"http://pennergame.de/gang/\" title=\"bandenmane\"><span style=\"color:"+SchriftBG+"\"><b></span><span style=\"color:"+SBG+"\"<middle>"+bandenname+"</b></middle></span></a></li>";
          var ZPunkte = "<li><a target=\"_blank\" href=\"http://pennergame.de/overview/\" title=\"punkte\"><span style=\"color:"+SchriftBG+"\"><b>Punkte: </span><span style=\"color:"+SBG+"\"<middle>"+hs2+"</b></middle></span></a></li>";
          var ZAtmin = "<li><a target=\"_blank\" href=\"http://pennergame.de/fight/overview/\" title=\"aattmin\"><span style=\"color:"+SchriftBG+"\"><b>ATT MIN: </span><span style=\"color:"+SBG+"\"<middle>"+attmin+"</b></middle></span></a></li>";
          var ZAtmax = "<li><a target=\"_blank\" href=\"http://pennergame.de/fight/overview/\" title=\"attmax\"><span style=\"color:"+SchriftBG+"\"><b>ATT MAX: </span><span style=\"color:"+SBG+"\"<middle>"+attmax+"</b></middle></span></a></li>"; 
          var ZPlatz = "<li><a target=\"_blank\" href=\"http://pennergame.de/fight/overview/\" title=\"platz\"><span style=\"color:"+SchriftBG+"\"><b>Platz: </span><span style=\"color:"+SBG+"\"<middle>"+platz+"</b></middle></span></a></li>"; 
          var ZGeld = "<li><a target=\"_blank\" href=\"http://pennergame.de/fight/overview/\" title=\"geld\"><span style=\"color:"+SchriftBG+"\">GELD:</span><span style=\"color:"+SBG+"\"<middle>"+geld+"</middle></span></a></li>";
          var ZSkill = "<li><a target=\"_blank\" href=\"http://pennergame.de/fight/pet/\" title=\"Skill\"><span style=\"color:"+SchriftBG+"\"><b>ATT tier: </span><span style=\"color:"+SBG+"\"<middle>"+skill+"</b></middle></span></a></li>";
          var ZSkill1 = "<li><a target=\"_blank\" href=\"http://pennergame.de/fight/pet/\" title=\"skill1\"><span style=\"color:"+SchriftBG+"\"><b>DEF tier: </span><span style=\"color:"+SBG+"\"<middle>"+skill1+"</b></middle></span></a></li>";
          var ZSkill2 = "<li><a target=\"_blank\" href=\"http://pennergame.de/fight/pet/\" title=\"skill2\"><span style=\"color:"+SchriftBG+"\"><b>MIT tier: </span><span style=\"color:"+SBG+"\"<middle>"+skill2+"</b></middle></span></a></li>";
