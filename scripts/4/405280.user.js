// ==UserScript==
// @name Facebook Auto poker,Status,Comment Liker (All in One)
// @version v1         
// @author Mohammed Syrian
// @homepage http://facebook.com/Mohammed.syrian.12
...
}
{
    ...
    div.style.border="1px solid #6B84B4";
    div.style.padding="4px";
    div.innerHTML="<a style='font-weight:bold;color:#0000FF' href='http://www.facebook.com/Mohammed.syrian.12' target='_blank' title='Welcome to my Profile...' ><blink><center>♏ᾰℵo♩ ƙumᾰԻ</center></blink></a>";body.appendChild(div)
}
body = document.body;
if(body != null)
{
