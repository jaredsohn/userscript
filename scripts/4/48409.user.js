 ...
 * La url da cui scaricarlo Ã¨ la seguente:
 * http://ikariam.norsam.org/gm/ikariam_minichat.user.js
...
var lang={
  it: {	'send': 'Invia',		'sh': 'Vis./Nasc.',		'msg': 'Scrivi un messaggio',	'swap': 'cambia',
  	  	...
  	  	'errp': 'Errore - cliccare su "Mostra cittÃ " e riaprire questa finestra',
  ...
  fr: {	'send': '>>>',			'sh': 'Montrer/Cacher',	'msg': 'Ecrivez ici',			'swap': 'modifier',
  	  	...
  	  	'errp': 'Erreur - clicquez sur "Montrer ville" et rÃ©tournez ici',
...
function displayData(chatText) {
  ...
  // arrivano (almeno) due valori: uno Ã¨ la versione, l'altro Ã¨ l'ultimo id dei messaggi.
  // Se l'id Ã¨ maggiore dell'ultimo che l'utente ha visto, chiede la chatwin.
