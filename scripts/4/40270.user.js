// ==UserScript==
// @name           Ignore Cobra Kai posts
// @namespace      Forum
// @include        http://goallineblitz.com/game/forum_thread.pl?*
// @include        http://goallineblitz.com/game/forum_thread_list.pl?*
// ==/UserScript==

var list = ['ImTheScientist', 'Nomad_Hokie', 'Robbnva', 'Skanker irl', 'jhunter', 'ReppinDaNorth21', 'blacksunshyne', 'hokeez', 'Fondolotz', 'rangray1', 'Steeeve', 'archstanton', 'rynoman01', 'JSSynister', 'Turkdog', 'King Henrik', 'Packer Fan', 'Racktacular', 'The Amplifire', 'jktooley', 'WVtackle72', 'Bladow', 'skinsneers', 'Dmac2008', 'IrishDawg42', 'Domer', 'BornANole', 'Erica', 'jfcvsrxb', 'Duckfan127', 'kalkmanc', 'Joebarber'];
