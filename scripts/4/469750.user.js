// ==UserScript==
// @name        Howrse Coat Image Swap - Arabian
// @namespace   myHowrse
// @description Swaps the v4 default Arabian coats out for the v3 default coats
// @include     http://*.howrse.com/elevage/fiche/*
// @include     http://*.howrse.com/elevage/chevaux/cheval*
// @version     1
// ==/UserScript==

if(document.body.textContent.indexOf("Breed: Arabian") > 0 || document.body.textContent.indexOf("Breed: Shagya") > 0)
{
