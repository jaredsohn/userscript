...
// @description    Add InfoBanners to Town View (Upgradable, Name and Level) [v1.3a]
...
// <setup>
var server = (function() { var host = document.location.hostname.split("."); if (host.length == 3 && host[1].toLowerCase() == "ikariam" && host[0].toLowerCase() != "board") { return host[0].trim(); } else { return false; } })();
