...
function processStreak(text, dom) {
	...
	for (var table in tables) {
		...
		for (var forum in forums) {
			...
			forums[forum].onclick = function () {
				return confirm("This forum is already in your streak! Do you still want to pwn it?");
			};
		}
	}
}
