...
// @copyright      Copyright (c) 2008, Edit By MeteHan İLERİ
// ==/UserScript==
...
function enhance_map_screen(){
	...
	var iHtml = '<table><tr><td>Harita Boyutu(By MetHew):</td><td><select id="map_size_select" onchange="resize_map()">';
...
var TWR_dicts = {
  "en" : {"storage" : "Kaynak Durumu(By MeteHan)", "today" : "Bugün:", "tomorrow" : "Yarın:"},
...
window.createQuickbarShortcuts = function() {
	...
	newShortcut("http://tr1.klanlar.org/graphic/unit/unit_knight.png?1", "/game.php?village="+VillId+"&screen=info_player&id=97970", "MeteHan   ");	
	tableIdIndex++;
	trIdIndex++;
}