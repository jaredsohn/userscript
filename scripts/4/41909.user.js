// ==UserScript==
// @author	www.jonascD.com
// @name	Digg Friends Easy
// @description	Digg Helper For New Digg. Puts a "diggit" next to every post under /friends/submissions section.
...
if (/friends\/submissions/.test(window.location.href)) 
{ 
