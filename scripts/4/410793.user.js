// ==UserScript==
// @name           DLeague Challenge Season 40
// @namespace      GLB_Chris465
// @description    Collect the stats for the DLeague Challenge, Season 40, FS.
// @include        http://*.warriorgeneral.com/game/home.pl
// ==/UserScript==
//

// Only variable to be modified.
var playerList = [4547286,4551571,4551468,4550766,4550530,4548056,4550498,4546096,4549797,4550364,4550099,4547525,4550312,4544303,4550294,4550842,4543590,4551951,4551996,4552050,4544982,4552775,4552848,4553075,4553118,4553250,4551063,4553251,4553358,4553385,4553393];
...
headings["Defense"] = ["Ply","Tk","MsTk","TFL","Hry","Sack","FFum","FumR","Int","DefTD","PD","RecAlw","KL"];
...
var points = [];
points["Defense"] = [0,1,-2,2,1,3,4,3,5,6,1,-1,1];
...
var agents = [];
agents["4547286"]="Briansimoneau";
agents["4551571"]="PsycoWard";
agents["4551468"]="ProfessionalKop";
agents["4550766"]="MissingNola";
agents["4550530"]="ee1409";
agents["4548056"]="rlawrence";
agents["4550498"]="an_old_dude";
agents["4546096"]="JBStar23";
agents["4549797"]="fogie";
agents["4550364"]="upsair";
agents["4550099"]="Steelernutt68";
agents["4547525"]="ChildishGambino";
agents["4550312"]="jpjn94";
agents["4544303"]="F8n4tune";
agents["4550294"]="Union Jack Jenson";
agents["4550842"]="Dr. Brawler";
agents["4543590"]="Coutinho";
agents["4551951"]="Jay Gold";
agents["4551996"]="Zernez";
agents["4552050"]="ninja turtles";
agents["4544982"]="AlBarsch";
agents["4552775"]="threadkiller";
agents["4552848"]="no14mike";
agents["4553075"]="Rube";
agents["4553118"]="xhail2skinsx";
agents["4553250"]="vladykins";
agents["4551063"]="Robbnva";
agents["4553251"]="Pena_FIN";
agents["4553358"]="Ahrens858";
agents["4553385"]="Fumanchuchu";
agents["4553393"]="joe";
...
//console.log("Getting data...");
	...
	for each (playerNumber in playerList){
		...
		// get game log page.
		var page = "http://glb.warriorgeneral.com/game/player_game_log.pl?player_id="+ playerNumber;
		var page = "http://glb.warriorgeneral.com/game/player_game_log.pl?player_id="+ playerNumber + "&season="+ season +"&stat_type=raw";
		//http://glb.warriorgeneral.com/game/player_game_log.pl?player_id=2252451&season=21&stat_type=raw
