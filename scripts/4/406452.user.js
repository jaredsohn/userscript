...
// @version     1.2.9 rev3.3 PT (C)
// @grant       none
// @downloadURL http://userscripts.org/scripts/source/389238.user.js
// @updateURL http://userscripts.org/scripts/source/389238.meta.js
// ==/UserScript==
...
(function(func) {
    ...
    var TW_Sets = [{
			name: "► Construir",
            items: [611, 40153, 237, 185, 41121, 897, 11116, 10225, 43101, 2188]
        }, {
			name: "► Sorte",
            items: [591, 278, 11153, 453, 40018, 10163, 880, 69, 153, 640, 2191]
        }, {
			name: "• Habilidade",
            items: [1863, 1864, 1871, 1872, 1873, 1981, 1879, 1982, 1946, 1984, 1988, 2285, 2286, 2287, 2288, 2289]
        }, {
			name: "• Batalha (Dano)",
            items: [1991, 1990, 1910, 1909, 1900, 1949, 2106, 2107, 2108, 2109, 2110, 2111, 2112, 2113, 2114, 2115, 2119, 2120, 2121, 2122, 2123, 2124, 2125, 2127, 2258, 2259, 2260, 2261]
        }, {
			name: "• Duelo",
            items: [1939, 1882, 1985, 1938, 1901, 1908, 1916, 1952, 1988, 1934, 2128, 2129, 2130, 2268, 2293, 2355, 12703, 13703, 185202]
        }, {
			name: "• Velocidade",
            items: [1934, 1987, 1927, 1926, 1919, 1918, 1952, 1937, 1968, 2135, 2229, 2262, 2263, 2264, 2284, 2292, 2354, 12702, 13702, 185201]
        }, {
			name: "• Energia",
            items: [1943, 1890, 1892, 1898, 1985, 1937, 1928, 1969, 1970, 1971, 1997, 2128 ,2129 ,2130, 2235, 2294, 2296, 2356, 2358, 12704, 12706, 13704, 13706, 185203, 185205]
        }, {
			name: "• Saúde",
            items: [1883,1892, 1898, 1991, 1974, 2116, 2117, 2235, 2253, 2254, 2255, 2256, 2257, 2295, 2296, 2357, 2358, 12705, 12706, 13705, 13706, 185204, 185205]
		}, {
			name: "• Trabalho",
            items: [1940, 1981, 1879, 1939, 1891, 1984, 1928, 1934, 1997, 1998, 2100, 2101, 2102, 2103, 2104, 2105, 2118, 2126, 2128, 2129, 2130, 2164, 2353, 12701, 13701, 185200, 2206, 2207, 2208, 2209, 2210, 2211, 2212, 2213, 2214, 2215, 2216, 2217, 2218, 2219, 2220, 2221, 2222, 2225, 2268, 2291]
		}, {
			name: "• Colecionáveis",
	    ...
	    name: "Cupido",
            ...
            name: "Dorminhoco",
            items: [261, 436, 375, 47, 132, 1717, 11207, 41203]
        }, {
            name: "Dourado",
            items: [858, 50, 136]
        }, {
    ...
    //        TW_QuickSearch.gui.popupMenu = new west.gui.Selectbox().setHeight(320);
   //         TW_QuickSearch.gui.popupMenu = new west.gui.Selectbox().setoverflow:auto;
