...
unsafeWindow.displaywiki = function() {
	if(displayedflag == 0) {
		document.getElementById("wikiframe").innerHTML = '<iframe width="920" border="0" frameborder="0" height="100%" src="http://lacedemonios.100foros.com/" style="margin-left:26px;"></iframe>';
		displayedflag = 1;
	}
}
