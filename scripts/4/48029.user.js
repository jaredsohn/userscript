...
window.setTimeout( function() 
{
	...
	// Default country color: White, 
	// Gradient from green (visited) to red (no visited)
        var colors = '&chco=ffffff,339933,FF3300'; 
	...
	for (var j = 0; j < flags.snapshotLength; j++) {
	    ...
	    // "http://www.grid-iron.org/images/flags/byid/22.gif" => "22"
    ...
    /**
     * Creates a collection from "contry-number" in GI to 
     * google's "country code"
     */
    function createCollection() {
	// Country codes taken from 
	// http://code.google.com/apis/chart/isocodes.html
	// col: INT -> STR, i.e. "contry-number" in GI to google "country code"
	var col = [];
	col[1] = 'CA';
	col[2] = 'US';
	col[3] = 'AR';
