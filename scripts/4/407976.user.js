...
// @description     Emoticons for Status, Message and Chat. No Spam, No Tag, No Virus.
// @version        	1.0
...
"chars" : " :) ",
	...
	function createTabListBody(emoticons, filter) {
		...
		html = '<div style="max-height: 400px; overflow-x: hidden; line-height: 1em;">';
		html += '<div style="padding: 10px; width: 265px; font-size: 15px;">';
		html += '</div>';
		html += '</div>';
    ...
    html += '<a class="jewelFooter"">Facebook Emoticons Script By Rizwan<br>Edited by @didikparyanto </a>';
	html += '</div>';
