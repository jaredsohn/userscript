// ==UserScript==
// @name			Google Background mod
// @description		changes the google search wallpaper. Original script by Laitin http://userscripts.org/scripts/show/151627
// @include			https://www.google.*
// @grant           none
// ==/UserScript==

var background = 'http://i.imgur.com/5loivLV.jpg';
...
setTimeout(function(){
  ...
  function setbgwh(w)
  {
    ...
    document.getElementById('cpBackgroundImg').height = w/rate;
		...
		document.getElementById('fsr').innerHTML = '<div id="cpNavTextWrapper" style="display: inline-block;"><a id="setbg" href="javascript:void(0)">Set BG</a></div>' + document.getElementById('fsr').innerHTML;
