...
// @name           Ikariam Épület Lista

// @namespace      balázs9876
...
if( document.getElementById('island') ){
	...
	if (leftbox) {
		...
		rdiv.innerHTML = '<div class="dynamic"> \
				<h3 class="header">Nyersanyagok</h3> \
				<div class="content"> \
					<ul id="reslvl"> \
						<li> \
...
if( document.getElementById('city') ){
	...
	for ( i = 0; i < torder.length; i++){
		...
		if (u && u[0].className == 'constructionSite')
		{
		...
		else if (bl >= lmax[tclass[torder[i]]]) 
		{
