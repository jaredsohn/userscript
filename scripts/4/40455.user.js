// ==UserScript==
// @name           Conejos Asesinos Delta
// @namespace      Alianza COAS
// @description    Herramientas miembros COAS
...
'<div id="menu">'
+ '<ul>'
+ ' <li><h2>COnejosASesinos</h2>'
+ '   <ul>'
+ '     <li><center><a target="_blank" href="http://semoscoas.foroactivo.com/forum.htm" title=" Foro de la Alianza CeS ">Foro COAS</a></li>'
