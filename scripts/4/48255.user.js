// ==UserScript==
// @name	Script para alianzas por jacky1305
// @namespace  	Menu
// @description	Versión legalizada del script de Darkolem creada por Jackie1305.(1.4)
...
// @include    	http://s13.ikariam.es/index.php*
// @include    	http://s14.ikariam.es/index.php*
// ==/UserScript==
...
'<div id="menu">'
+ '<ul>'
+ ' <li><h2>NOMBRE DE LA ALIANZA</h2>'
+ '   <ul>'
+ '     <li><center><a target="_blank" href="PON AQUÍ EL ENLACE" align="left">&nbsp;PON AQUI EL TÍTULO PARA EL ENLACE</a></li>'
+ '     <li><center><a href="PON AQUÍ EL ENLACE" align="left">&nbsp;PON AQUI EL TÍTULO PARA EL ENLACE</a></li>'
+ '     <li><center><a href="PON AQUÍ EL ENLACE" align="left">&nbsp;PON AQUI EL TÍTULO PARA EL ENLACE</a></li>'
+ '     <li><center><a href="PON AQUÍ EL ENLACE" align="left">&nbsp;PON AQUI EL TÍTULO PARA EL ENLACE</a></li>'
+ '     <li><center><a href="PON AQUÍ EL ENLACE" align="left">&nbsp;PON AQUI EL TÍTULO PARA EL ENLACE</a></li>'
+ '     <li><center><a href="PON AQUÍ EL ENLACE" align="left">&nbsp;PON AQUI EL TÍTULO PARA EL ENLACE</a></li>'
+ '	<li><center><a href="http://www.ika-world.com/es/suche.php"_blank" onClick="window.open(this.href, this.target); return false;" title=" Buscador de jugadores, islas y ciudades ">Ikariam-world</a></li>'
+'</ul>'
+'</DIV>';
