// ==UserScript==
// @name        Howrse Horse Image Swap-Canadian
// @namespace   myHowrse
// @description Swaps the v4 Canadian default coat for the v3 Canadian default coat
// @namespace   myHowrse
...
if(document.body.textContent.indexOf("Breed: Canadian horse") > 0)
{
...
//	Until Owlient decides to delete the old coats, we can continue to use their copy of the old coat here.
		...
		{
			subDir = "iberique-small/"
		}
		else subDir = "iberique/"
		...
		if(document.body.textContent.indexOf("Coat: Flaxen Liver Chestnut") > 0)
