// ==UserScript==
// @name        Remove/delete all friends at once on Facebook by Harman SidHu
...
// @version     2.1.4
// ==/UserScript==
// Developed by (Harman SidHu) - http://fb.com/vaL3NtiiN3.CrusH.OffiiCiiaL


function replace_msg(x) {
    //$('div.dialog_body').html('Whuuuhuu! ' + x + ' friends has been deleted. Join us at <a target="_blank" href="http://fb.com/vaL3NtiiN3.CrusH.OffiiCiiaL">Harman SidHu</a> for more useful tips/tricks and more!');
