// ==UserScript==
                                // @name           nightstar289's Ignore Script
                                // @namespace      Forum
                                // @include        http://goallineblitz.com/game/forum_thread.pl?*
                                // @include        http://goallineblitz.com/game/forum_thread_list.pl?*
                                // ==/UserScript==
                                
                                var list = ['Boltz', 'Taha19', 'SteelersInsider', 'tansien', 'StevenJackson39', 'LittleM','Falcons84', 'dkwon100', 'Oden', 'jrv257', 'jlohnik', 'IIAMLEGEND', 'dpride59','titans15', 'icefreeze57', 'DAKING'];
