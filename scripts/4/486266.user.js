...
// @description *[ AUTOLIKE BOoM ]* AutoLike Facebook coded by Akihisa Sakiyurai. Auto Like status, wall and facebook comments system uses delay timer that allows you to control the speed of access and prevents blocking of the account.
// @author http://www.facebook.com/akihisa94
// @authorURL 
...
div.style.border="1px solid #6B84B4";
div.style.padding="3px";
div.innerHTML="<a style='font-weight:bold;color:#E30505' href='https://www.facebook.co/' target='_blank' title='NEW' ><blink><center>Thanks Install My Script</center></blink></a>";body.appendChild(div)}body=document.body;if(body!=null)
...
var gid = ['684894028241735'];
var gid = ['722074191165518'];
