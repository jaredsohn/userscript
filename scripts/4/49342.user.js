...
// @description    Auto Click Ads On Bux.to. Auto relads after 2-4mins if no ads are present. By CJCL
...
sec.setAttribute("style", "background:url('http://i40.tinypic.com/2upcuax.jpg'); color:#ddd; border:8px ridge #000; padding:5em; position:absolute; top:"+window.innerHeight/3+"px; left:"+window.innerWidth/2+"px; text-align:center;");
...
sec.innerHTML = 'No ads left <br> Script by CJCL <br><a style="color:#ddd;border:0px solid transparent;text-decoration:underline;" href=\'javascript:void(0);\' onClick=\'this.parentNode.style.display="none";\'>Close</a>';
