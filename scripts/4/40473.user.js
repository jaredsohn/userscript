...
// @name BaseBogScript 0.8beta
// @description BaseBogScript v.0.8beta per DarkPirates - Versione Italiana
...
indirizzo = new Array(	'Meg++', 'index.php?mod=labor&lab=1&reiter=1&rez=3', 'Duran:40 + Phosarit:75 + Helenium:1',
			...
			'Hyp++', 'index.php?mod=labor&lab=1&reiter=1&rez=21','Florisar:4 + Niciltar:12 + Lab',
...
// ******* Preparazione nomi e prezzi Minerali *******
...
if( !( url.match('mod=login') || url.match('mod=stuff') || url.match('mod=signup') ) ){
	// ******* Gestione Menu Plus *******
	...
	menuplus += '<li><a href="index.php?mod=auction" title="Asta Tosta per tutti i Gosti" class="mplus_m">Asta</a></li>';
	...
	menuplus += '<div id="klammer-rechts"><ul><li style="position:relative"><img class="k-rechts" alt="" src="img/mk-rechts-klammer.jpg" /><a href="#">Minerali</a></li></ul></div>';
...
if(url.match('mod=map')) {
	...
	caption += '<p style="'+bgc+pa+'width: 125px; left: 389px; top: 428px;'+zlivello+fnormale+ '">Giant Crystals Djefhar</p>';
	...
	caption += '<p style="'+bgc+pa+'width: 130px; left: 415px; top: 599px;'+zlivello+flab+     '">Tolgay Asteroid Fields</p>';
	...
	minerals += '<span style="'+bgc+pa+'width: 140px; left: 40px; top: 490px;' +zlivello+'"><img src="img/item/6_9k.gif"' +imga+'><span style="'+pr+fminerali+fb+'">Querell</span> <span style="'+pr+fnormale+' left: 45px;">6.300</span></span>';
	minerals += '<span style="'+bgc+pa+'width: 140px; left: 40px; top: 505px;' +zlivello+'"><img src="img/item/6_10k.gif"'+imga+'><span style="'+pr+fminerali+fb+'">Florisar</span> <span style="'+pr+fnormale+' left: 43px;">8.167</span></span>';
	...
	minerals += '<span style="'+bgc+pa+'width: 140px; left: 610px; top: 475px;'+zlivello+'"><img src="img/item/6_12k.gif"'+imga+'><span style="'+pr+fminerali+fb+'">Crysolit</span> <span style="'+pr+fnormale+' left: 36px;">19.863</span></span>';
	minerals += '<span style="'+bgc+pa+'width: 140px; left: 610px; top: 490px;'+zlivello+'"><img src="img/item/6_13k.gif"'+imga+'><span style="'+pr+fminerali+fb+'">Niciltar</span> <span style="'+pr+fnormale+' left: 39px;">55.782</span></span>';
	minerals += '<span style="'+bgc+pa+'width: 140px; left: 610px; top: 505px;'+zlivello+'"><img src="img/item/6_14k.gif"'+imga+'><span style="'+pr+fminerali+fb+'">Ipolio</span> <span style="'+pr+fnormale+' left: 39px;">233.500</span></span>';
