// ==UserScript==
// @name           PetrolHeadHelper
// @namespace      http://userscripts.org/users/71206
// @description    Facebook Petrol Head Helper
// @version        0.6
// @date           2009-04-01
// @creator        Paul T. Clegg
// @include        http://apps.facebook.com/petrolhead/*
// @exclude		   http://apps.facebook.com/petrolhead/index.php
// @exclude		   http://apps.facebook.com/petrolhead/cars.php
// @exclude		   http://apps.facebook.com/petrolhead/customize.php
// @exclude		   http://apps.facebook.com/petrolhead/upgrades.php
// ==/UserScript==

const DEBUG = false; //Enable verbose interactive debugging?
const PATH_FRIENDS = '/petrolhead/friends.php';
const PATH_RACE = '/petrolhead/race.php';
const KEY_TRIM = 'trim';
