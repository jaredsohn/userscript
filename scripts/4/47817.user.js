// ==UserScript==
// @name            1UP New Posts Announce Icon
// @namespace       The Official 1up Boards
// @include         http://www.1up.com/boards/forums/show*
// ==/UserScript==
function do_platypus_script() {
do_modify_html_it(window.document,document.evaluate('/HTML[1]/BODY[1]/DIV[6]/DIV[1]/DIV[1]/DIV[1]', document, null, XPathResult.FIRST_ORDERED_NODE_TYPE,null).singleNodeValue,/<a href="javascript:markRead/g,'<div class="floatleft"><img height="13" src="http://www.1up.com/boards/templates/default/images/folder_announce.gif"></div><a href="javascript:markRead',null);
