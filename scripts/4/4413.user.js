...
s+= "div, table, td, th, .heading{background:#0f2b52!important; border:0px!important;}\n";
s+= "*{font-family:verdana}\n";
s+= "a:link, a:active, a:visited {color:#000000!important;font:10px tahoma!important;}\n";
s+= "a:hover {text-decoration:none;font-weight:bold!important; color:#000000!important;}\n";
s+= "a[id*='friendImageLink']:hover img {border:2px solid #000000!important;}\n";
...
s+= "#topnav a {font:normal 11px verdana!important; color:white!important;  background-color:black; border:0px solid #333333;}\n";
s+= "#topnav a:hover {color:white!important;  background-color:black; border:0px solid #333333;}\n";
s+= ".section {border:2px solid #333333!important;background-color:ffffff!important;padding:2px;}\n";
s+= ".heading, #splash_coolNewPeople h5.heading, .mar5 strong {font:bold 10px tahoma!important;color:white;border:none!important;display:inline;padding:0!important;background-color:#0f2b52!important;}\n";
s+= "#home_profileInfo .heading {font-size:11pt!important; font-weight:bold!important; color:white}\n";
s+= "#home_profileInfo img {padding-top:3px;}\n";
s+= ".left center {color:666666}\n";
s+= ".indicator {margin-left:10px}\n";
s+= ".indicator a, .txtRed {color:white!important; font-weight:normal!important}\n";
...
s+= "td.bulletinDate {color:pink!important;}\n";
...
s+= "#home_infoBar strong {display:block; color:white; font-weight:bold; margin-top:4px}\n";
...
s+= "a[href*='.listAds']:after, a[href*='=rateImage']:after, a[href*='ShowMyBulletins']:after {content:' |'; background:black; color:black; font-weight:normal}\n";
s+= "#home_friends .heading {font-size:10pt!important; font-weight:bold!important; color:white}\n";
...
s+= "#splash_coolNewPeopleBrowse {text-align:center; color:white}\n";
s+= "#home_friends .heading a {visibility:visible;}\n";
s+= "a[id*='friendLink'] img {display:none}\n";
s+= ".clear {font-size:0}\n";
s+= "#main{min-height:0; height:0!important}\n";
s+= "#home_messages .heading {font-size:10pt!important; font-weight:bold!important; color:pink}\n";
s+= "#home_messages img {padding-top:3px;}\n";
s+= "#home_bulletins .heading {font-size:10pt!important; font-weight:bold!important; color:pink}\n";
s+= "#home_bulletins img {padding-top:3px;}\n";
s+= "#home_schools .heading {font-size:10pt!important; font-weight:bold!important; color:pink}\n";
