// ==UserScript==
// @name    Facebook Metropolis Auto Populate
...
(function()
{
	...
	var metropolisRequests="http://apps.facebook.com/metropolisgame/populate.php";

	if (location.href.indexOf("populate.php")>0)
	{
	...
	else if (location.href.indexOf("players.php")>0)
	{
		...
		try
		{		
			unsafeWindow.a38075929120_giveYoung(id);
		}
		catch (e)
		{
			//alert("already popped.");
		}
