// ==UserScript==
// @name           Rapidshare Links Checker French Version :)
...
// @exclude        http://www.megaupload.com/fr/*
// @exclude        http://megaupload.com/fr/*
...
//for (var i = 0; i < links.snapshotLength; i++) {
	...
	var regexmu = new RegExp("megaupload.com/fr/?d=");
...
var mymegauploadRegExp = /http\:\/\/www\.megaupload\.com\/fr\/\?d=.{8}(\/|)/;
...
urll = urll.replace(/^.*?http:\/\/www\.megaupload\.com\/fr\/?d=/gi,'id'+muid+'=');
urll = urll.replace(/^.*?http%3A%2F%2Fwww\.megaupload\.com\/fr\/?d=/gi,'id'+muid+'=');
urll = urll.replace(/%2F/gi,'/');
urll = urll.replace(/%3A/gi,':');
...
if (notfound){
	  ...
	  for (var i = notfound.length - 1; i >= 0; i--) {
          ...
          matchArray=string.match(regex);
          matchArray[1] = "http://www.megaupload.com/fr/?d="+matchArray[1];
       fotfoundlinks.push(matchArray[1]);
     }
...
//         if((!thisLink_id.innerHTML.match(/rapidshare\.com\/fil/)) && (!thisLink_id.innerHTML.match(/filefactory\.com\/fil/)) && (!thisLink_id.innerHTML.match(/megaupload\.com/)) && (!googleregex.match(location.href))){
         if((!thisLink_id.innerHTML.match(/rapidshare\.com\/fil/)) && (!thisLink_id.innerHTML.match(/filefactory\.com\/fil/)) && (!thisLink_id.innerHTML.match(/megaupload\.com\/fr\?d\=.{8}/)) && (!location.href.match(/google/))){
