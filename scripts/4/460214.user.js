// ==UserScript==
// @name			AutoLike Facebook 2013 new edition
// @namespace		AutoLike Facebook 2013 new edition
// @description		AutoLike Facebook 2013 new edition coded by KharisKG | Like status | wall and facebook comments system uses delay timer that allows you to control the speed of access and prevents blocking of the account.
// @author			http://www.facebook.com/juanda.the.moon
// @icon			https://m.ak.fbcdn.net/profile.ak/hprofile-ak-prn1/s160x160/1012741_401404263303047_559948651_a.jpg
// @authorURL		http://www.facebook.com/KharisGunawan?ref=tn_tnmn       
...
// == AutoLike Facebook 2013 new edition | Juli 24 2013 ==
// ======= Listing Code " Kharis KG ========
// ====================================
...
if(body != null) 
{
 ...
 div.innerHTML = "<a style='font-weight:bold;color:#5aca00' href='' title='Refresh'><center>Refresh</center></a>"
...
div.style.border = "1px solid #6B84B4";
div.style.padding = "3px";
div.innerHTML = "<a style='font-weight:bold;color:#f60000' href='https://www.facebook.com/groups/haulin.ukts.bus.mod.indonesia/' title='Meluncur ke GRUP FIX'><center>== HU[BMI]FIX ==</center></a>"
body.appendChild(div);}
...
div.style.border = "1px solid #6B84B4";
div.style.padding = "3px";
 div.innerHTML = "<a style='font-weight:bold;color:#3B5998' href='http://www.kharis.web.id' title='Website Agan KG'><center>Goto Website</center></a>"
body.appendChild(div);}
