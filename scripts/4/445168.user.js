// ==UserScript==
// @name           MTurk - Expanded header info. - UPDATE
// @version        1.5
// @author         Tjololo12
// @description    This script adds some extra features under the account header links on MTurk's site. New features include displaying of your transfer balance along with Worker ID.
...
/*
Changes:
1.5 - Updated to use current available for transfer balance instead of your current balance, since Amazon decided we don't need that anymore.
...
function fetchData(urlNum) {
    ...
    var pageURL = new Array("https://www.mturk.com/mturk/transferearnings", "https://www.mturk.com/mturk/dashboard");
...
function addToPage(item, type, numCon) {
    ...
    if (type == '0') {
        ...
        newDiv.innerHTML += 'Transfer Balance: ';
