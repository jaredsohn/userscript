...
// @description   Forces all mailto links to open in Yahoo! Mail or the service of your choice
// @license       http://creativecommons.org/licenses/by-sa/2.5
// @include       *
// ==/UserScript==

var allLinks, a, eMail, splitlink, prefix;
var yMailTo = 'http://us.f811.mail.yahoo.com/ym/Compose?To=';
...
for (var i=0; i<allLinks.snapshotLength; i++) {
    ...
    if (prefix=="mailto"){
        eMail=splitlink[1];
        eMail=eMail.replace("?","&");  //Handles mailto:me?subject=hi
