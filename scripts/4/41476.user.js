...
// @name           VTA Tools_v2
// @namespace      VTA tips
// @description    Ferramentas para a aliança VTA, Ikariam, Mundo ETA - Versão 2
// @include        http://s7.ikariam.*/*
...
function addMenu(){
	...
	liEl.setAttribute('id', 'VTA Tools');
	...
	for(i=0;i<xTags.length;i++){
		...
		if (xLi.className == 'help') {
			...
			'<div id="menu">'
			+ '<ul>'
			+ '<li><h2><span>VTA Tools</span></h2>'
			+ '<ul>'
			+ '<li><center><a target="_self" href="http://s7.ikariam.com.pt/index.php?view=sendAllyMessage&oldView=diplomacyAdvisor&watch=4&id=59890&position=3&type=50" title="Enviar mensagem a todos os membros">Mensagem Circular</a></li>'
			+ '<li><center><a target="_blank" href="http://www.vaitudoabaixo.pt.vu/" title="Fórum da Aliança VTA">Fórum da VTA</a></li>'
