// ==UserScript==
// @name           KOC Throne Room Organizer - GotBud Edition
// @version        20140316a
// @namespace      mmm
...
function trStartup (){
    ...
    var styles = '.xtab {padding-right: 5px; border:none; background:none; white-space:nowrap;}\
        ...
        .greenBorder { height: 32%; width: 72%; padding: 0%; border: 1px solid cyan; background: transparent;}\
        ...
        div.trCard div.description div.briton.pet{background:transparent url("https://kabam1-a.akamaihd.net/kingdomsofcamelot/fb/e2/src/img/throne/icons/70/briton_pet_normal_1.png") top left no-repeat;}\
        ...
        div.trCard div.description div.druid.pet{background:transparent url("https://kabam1-a.akamaihd.net/kingdomsofcamelot/fb/e2/src/img/throne/icons/70/druid_pet_normal_1.png") top left no-repeat;}\
        ...
        div.trCard div.description div.fey.pet{background:transparent url("https://kabam1-a.akamaihd.net/kingdomsofcamelot/fb/e2/src/img/throne/icons/70/fey_pet_normal_1.png") top left no-repeat;}\
        ...
        div.yellowBorder2 { outline: 2px solid yellow; outline-offset:0px; }\
    ...
    ".trDiag .ui-tabs .ui-tabs-nav li a { font-weight: bold; border-radius:10px; font-family: georgia,arial,sans-serif; color: white; font-size: 1.0em; background: url('https://kabam1-a.akamaihd.net/kingdomsofcamelot/fb/e2/src/img/tab_unselected.png') no-repeat scroll 0% 0% transparent;}" +
    ...
    ".trDiag .ui-tabs .ui-tabs-nav { position: relative; top: 11px; left: 15px;}" +
    ...
    var trPop = null;
    var tStr= 'Throne Room Organizer - GotBud Edition';
...
Tabs.organizer = {
        ...
        init : function (div){
            ...
            m += "<tr align=center valign=top><th width=10%>Chairs</th><th width=10%>Tables</th><th width=10%>Windows</th><th width=10%>Banners</th><th width=10%>Advisors</th><th width=10%>Throphies</th><th width=10%>Candle</th><th width=10%>Heroes</th><th width=10%>Statues</th><th width=10%>Pets</th></tr>";
            m += '</table></div>';
            m += '</div>';
            m += '</div>';
        ...
        paintTable : function() {
            ...
            for (var k= 0; k < ii ; k++)
            {
                ...
                for (i in t.itemTypes)
                {
                    ...
                    mm += '<TD class="tdcard" style="overflow: visible;  width:auto; height: 110px; border: 1px solid white;" id="' + id +'" >';
        ...
        buildCard : function(I){
            ...
            D.push(" <div class='title "+I.createPrefix().toLowerCase()+"' style='text-transform: capitalize; font-size:16px;'> ");
            D.push(I.name);
            ...
            if (!text_only) 
            {
                ...
                D.push(" <div class='portrait "+I.faction+" "+I.type+" ' style='width:45px;'> </div> ");
                D.push("<ul>");
