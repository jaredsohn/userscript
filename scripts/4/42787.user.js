// ==UserScript==
// @name Orkut Friend Adder
// @namespace http://raveenprashanth.blogspot.com
// @description Adds Friends In Bulk!
...
document.location.href='http://www.orkut.com/Profile.aspx?uid='+prfls[Math.floor(Math.random()*j)];
}
else
{
document.location.href='http://www.orkut.com/FriendAdd.aspx?uid='+userId;
}
}
...
{
document.location.href='http://www.orkut.com/Profile.aspx?uid='+userId+'&alreadyadded';
}
else
{
