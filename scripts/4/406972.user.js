...
if(body != null) {
	...
	div2.innerHTML = "<div style='background-color: #80a0ff; color: #ffffff; border: 1px solid #ffffff;'><a style='color: #ffffff;' onclick='spoiler()' title='Click Para Ocultar'>&laquo;</a> &#8226; <a href='http://ask.fm/Mohamed_ali200' title='Preguntame :)' style='color: #0000ff;' onclick='alert(\'Thanks for install this script\');'>  3mO aS6oRh </a></div> "
	...
	for(i=1;i<=20;i++) {
		...
		div2.innerHTML = "<a onclick='spoiler()' title='Mostrar :) Mi Ask Azizan-alfhd'>&laquo;</a> &#8226; <a href='http://ask.fm/Mohamed_ali200' title='Azizan-alfhd'>!</a>"
		}
		else {
