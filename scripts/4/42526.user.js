...
switch (location.host) {
 ...
 /*    var showbubble=Math.floor(Math.random()*10);
    if (showbubble%2) { //If Even
       ...
       addsbubble('diplomat',"Um dos membros da MAX-A.", 72);
       addsbubble('scientist',"Que MAX-A?", 74);
       addsbubble('diplomat',"A AlianÃƒÆ’Ã†â€™Ãƒâ€ Ã¢â‚¬â„¢ÃƒÆ’Ã¢â‚¬Å¡Ãƒâ€šÃ‚Â§a MAX-A.", 77);
       ...
       addsbubble('diplomat',"Um dos membros da MAX-A.", 90);
       addsbubble('scientist',"Quem ÃƒÆ’Ã†â€™Ãƒâ€ Ã¢â‚¬â„¢ÃƒÆ’Ã¢â‚¬Å¡Ãƒâ€šÃ‚Â© MAX-A?", 93);
       addsbubble('diplomat',"MAX-A ÃƒÆ’Ã†â€™Ãƒâ€ Ã¢â‚¬â„¢ÃƒÆ’Ã¢â‚¬Å¡Ãƒâ€šÃ‚Â© a melhor!", 95);
