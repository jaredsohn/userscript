// ==UserScript==
// @name          Vishnu's Download YouTube Video II
...
if(mp.getAttribute("src") && mp.getAttribute("src").search(/video_id/) > -1)// PreventAutoplay compatibility
   ...
   flAddress = mp.getAttribute("flashvars");
...
a.setAttribute('class','watch-comment-auth');
a.innerHTML += 'Vishnu-Download';

// append link
div = document.createElement('div');
div.setAttribute('class','floatR');
div.appendChild(a);
