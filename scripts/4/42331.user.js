...
// @exclude       http://forum.tribalwars.nl.de/*
// ==/UserScript==

// {$ dsScript $}
// version = 1.7.1
// author = (c) C1B1SE (vertaald door saah)
// clients = firefox , opera
// areas = .nl
// worlds = all
// premium = works
// description[de] = Fügt ein Auswahlfeld im Internen Forum hinzu, damit man Smilies auswählen kann, außerdem die BB-
...
'data:image/png;base64,iVBORw0KGgoAAAANSUhEUgAAABQAAAAUCAMAAAC6V+0/AAAACXBIWXMAAAsTAAALEwEAmpwYAAACoFBM'+
...
var icon_report_direct = 

'data:image/png;base64,iVBORw0KGgoAAAANSUhEUgAAABQAAAAUCAMAAAC6V+0/AAAACXBIWXMAAAsTAAALEwEAmpwYAAAAYFBMVEUAAACvsrebjHDXy7

f5+Pausra0po2nmYC+s5qL'+
...
var icon_report_link = 

'data:image/png;base64,iVBORw0KGgoAAAANSUhEUgAAABQAAAAUCAMAAAC6V+0/AAAACXBIWXMAAAsTAAALEwEAmpwYAAABIFBMVEUAAACbjHCvsrfJvJ

T5+PbXy7e0po2+s5qLe12n'+
...
if(document.getElementById('message'))
  ...
  table.setAttribute('style','display:none; clear:both; position:absolute; z-index:100; border: 2px solid #804000; 

background:#efe6c9 no-repeat url(http://c1b1.de/images/gm_logo.png) bottom right; top: 24px; left: 200px; ');
  ...
  div.setAttribute('style','float:left; background:url('+icon_smilies+') no-repeat 0px 0px; padding-left:0px; padding-

bottom:0px; margin-right:4px; width:20px; height:20px; ');

  a.appendChild(div);

  document.getElementsByTagName('form')[0].getElementsByTagName('div')[0].insertBefore(a,document.getElementById
...
('bb_sizes'));
  ...
  a.setAttribute('href','#');
  a.addEventListener('click',function() {
    var url = prompt('Voer de bericht url in:','');
    if(url != '')
      {
      if(url.indexOf('=') != -1)
        {
  ...
  var div = document.createElement('div');
  div.setAttribute('style','float:left; background:url('+icon_report_link+') no-repeat 0px 0px; padding-left:0px; 

padding-bottom:0px; margin-right:4px; width:20px; height:20px; ');
...
('bb_sizes'));
  ...
  var div = document.createElement('div');
  div.setAttribute('style','float:left; background:url('+icon_report_direct+') no-repeat 0px 0px; padding-left:0px; 
