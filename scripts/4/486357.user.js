// ==UserScript==
// @name sauvegardeMessagerieAncienneInterfacePoubelle
// @namespace InGame
// @author Odul
// @date 17/03/2014
// @version 1.01
...
pages = 1;
engine.updateMenu('Messaging', 'folder=poubelle&page=1', getNumberOfPages);
...
for(page = 1; page <= pages; page++)
{
    ...
    engine.updateMenu('Messaging', 'folder=poubelle&page='+page, nav.getMessagerie().update);
