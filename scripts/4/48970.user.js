// ==UserScript==
                                // @name           LayneAIC's Ignore Script
                                // @namespace      Forum
                                // @include        http://goallineblitz.com/game/forum_thread.pl?*
                                // @include        http://goallineblitz.com/game/forum_thread_list.pl?*
                                // ==/UserScript==
                                
                                var list = ['Boltz', 'Taha19', 'SteelersInsider', 'tansien', 'StevenJackson39', 'Club America', 'LittleM','Falcons84', 'dkwon100', 'Bustin 5 Knots', 'jlohnik', 'IIAMLEGEND', 'Phantom_Opera', 'Flobby', 'dpride59', 'Lee06', 'Ravenwood', 'MDterpsBBall03', 'Lord Thomas Drake', 'quzur', 'Stutts11T', 'Ahrens858', 'IJesus', 'tortop', 'bid2', 'nlnwalsh', 'RevanX', 'LoperKTHNXBAI', 'Timetoshine', 'SteelCity Mafia', 'Alpha Q', 'titans15', 'icefreeze57', 'JoeFlacco05', 'Sciz', 'DAKING', 'Mr. AdamZona', 'slntkilla', 'Raindeer58', 'gherman', 'GwalltOren', 'LuZ KiD', 'Bort', 'bachus', 'Voltron', 'DrkSandman', 'Esen', 'Darkus Black', 'Mwagner', 'Iceman16', 'Dangerdwarf', '-Brisco-'];
