...
s+= "body {background:#b0bfd4 fixed;margin-top:-110px;}\n";
s+= "div, table, td, th, .heading{background:transparent!important; border:0px!important;}\n";
s+= "*{font-family:tahoma}\n";
s+= "a:link, a:active, a:visited {color:#b0bfd4!important;font:10px arial!important;}\n";
s+= "a:hover {text-decoration:none;font-weight:bold!important; color:#b0bfd4!important;}\n";
s+= "a[id*='friendImageLink']:hover img {border:2px solid #b0bfd4!important;}\n";
s+= "a[id*='friendImageLink'] img {border:2px solid #333333}\n";
s+= "#header {visibility:hidden}\n";
s+= "#header .right {visibility:visible; color:#b0bfd4; position:relative; top:118px;}\n";
s+= "#header .right a {font-weight:normal!important}\n";
s+= "#topnav {background-color:#98F5FF; border:0px solid white; padding:0!important; margin-bottom:10px;}\n";
s+= "#topnav a {font:normal 10px tahoma!important; color:white!important;  background-color:; border:0px solid #333333;}\n";
s+= "#topnav a:hover {color:white!important;  background-color:; border:0px solid #333333;}\n";
s+= ".section {border:2px solid #333333!important;background-color:#0f2b52!important;padding:2px;}\n";
...
s+= "#home_bulletins th {color:pink!important;font-weight:bold!important;}\n";
s+= "#home_bulletins td {padding:3px;}\n";
s+= "td.bulletinDate {color:pink!important;}\n";
s+= "#splash_coolNewPeople {width:46%; display:inline; margin-left:-7px!important;float:left!important;}\n";
...
s+= "#home_infoBar {position:absolute; right:10px;;float:left; }\n";
...
s+= "#home_friends .heading {font-size:10pt!important; font-weight:bold!important; color:#b0bfd4}\n";
