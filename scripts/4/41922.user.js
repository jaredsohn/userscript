...
var player1name = players.snapshotItem(14).innerHTML;
var player1 = players.snapshotItem(14).innerHTML.slice(players.snapshotItem(14).innerHTML.indexOf("pid=") + 4);
if(players.snapshotItem(14).innerHTML.slice(0,3) == '<b>')
{
	var player1start = 1;
}
else
...
var player2name = players.snapshotItem(15).innerHTML;
var player2 = players.snapshotItem(15).innerHTML.slice(players.snapshotItem(15).innerHTML.indexOf("pid=") + 4);
if(players.snapshotItem(15).innerHTML.slice(0,3) == '<b>')
{
	var player2start = 1;
}
else
...
var player3name = players.snapshotItem(16).innerHTML;
var player3 = players.snapshotItem(16).innerHTML.slice(players.snapshotItem(16).innerHTML.indexOf("pid=") + 4);
if(players.snapshotItem(16).innerHTML.slice(0,3) == '<b>')
{
	var player3start = 1;
}
else
...
var player4name = players.snapshotItem(17).innerHTML;
var player4 = players.snapshotItem(17).innerHTML.slice(players.snapshotItem(17).innerHTML.indexOf("pid=") + 4);
if(players.snapshotItem(17).innerHTML.slice(0,3) == '<b>')
{
	var player4start = 1;
}
else
...
var player5name = players.snapshotItem(18).innerHTML;
var player5 = players.snapshotItem(18).innerHTML.slice(players.snapshotItem(18).innerHTML.indexOf("pid=") + 4);
if(players.snapshotItem(18).innerHTML.slice(0,3) == '<b>')
{
	var player5start = 1;
}
else
...
var player6name = players.snapshotItem(19).innerHTML;
var player6 = players.snapshotItem(19).innerHTML.slice(players.snapshotItem(19).innerHTML.indexOf("pid=") + 4);
if(players.snapshotItem(19).innerHTML.slice(0,3) == '<b>')
{
	var player6start = 1;
}
else
...
var player7name = players.snapshotItem(20).innerHTML;
var player7 = players.snapshotItem(20).innerHTML.slice(players.snapshotItem(20).innerHTML.indexOf("pid=") + 4);
if(players.snapshotItem(20).innerHTML.slice(0,3) == '<b>')
{
	var player7start = 1;
}
else
...
var player8name = players.snapshotItem(21).innerHTML;
var player8 = players.snapshotItem(21).innerHTML.slice(players.snapshotItem(21).innerHTML.indexOf("pid=") + 4);
if(players.snapshotItem(21).innerHTML.slice(0,3) == '<b>')
{
	var player8start = 1;
}
else
...
var player9name = players.snapshotItem(22).innerHTML;
var player9 = players.snapshotItem(22).innerHTML.slice(players.snapshotItem(22).innerHTML.indexOf("pid=") + 4);
if(players.snapshotItem(22).innerHTML.slice(0,3) == '<b>')
{
	var player9start = 1;
}
else
...
var player10name = players.snapshotItem(23).innerHTML;
var player10 = players.snapshotItem(23).innerHTML.slice(players.snapshotItem(23).innerHTML.indexOf("pid=") + 4);
if(players.snapshotItem(23).innerHTML.slice(0,3) == '<b>')
{
	var player10start = 1;
}
else
...
function calculate1(url)
{
	GM_xmlhttpRequest({
		...
		onload: function(responseDetails) {
			...
			if(0) //reference.indexOf('Endurance:') == -1)
			{
				player1speed = 0;
				player1end = 0;
				player1ball = 0;
