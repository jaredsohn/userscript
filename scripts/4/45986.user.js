...
// @name	Trooptool Updater GR (gr4)
// @description	Update your troop tool with one click from the rally point. (Ready for s4.travian.gr)
...
var sLang = "gr";
var sGetParameters = "";
var sCurrentServer = "s4.travian.gr";    // Set this to the server's url to override automatic server detection
                            // (i.e. s1.travian.net)
                            // Dont set it if you're playing on multiple servers simultaneously!
							//Allready set for s4.travian.gr
