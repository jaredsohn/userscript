// ==UserScript==
// @name           Pennergame Berlin Pennerprofil V 2.3.4 (Berlin updates by me ;)
// @namespace      11235813[Kuestenpenner]
// @description    Zeigt Geld und Promille im Profil an, Erkennt falsche/vorgetaeuschte IDs, ist absolut taeuschungssicher, zeigt mehr Infos. Premiumanzeige funktioniert in Berlin noch nicht...
...
GM_xmlhttpRequest({
    method: 'GET',
    url: 'http://berlin.pennergame.de/dev/api/user.getname.xml?name='+name,
    ...
    onload: function(responseDetails) {
		...
		GM_xmlhttpRequest({
			method: 'GET',
			url: 'http://berlin.pennergame.de/dev/api/gang.'+bandenid+'.xml',
			onload: function(responseDetails) {
				var parser = new DOMParser();
