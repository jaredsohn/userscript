// ==UserScript== 
// @name           Group 3 Final Iteration Loader
...
if(window.location.href.match(/^http:\/\/thefump.com\/sideshow.php/) || window.location.href.match(/^http:\/\/www.thefump.com\/sideshow.php/)) // href location added by Dan Netry April 23rd 3:50pm
// regular expression match added by Ben Hedrick and Jason Pocino
{ 
    myScript.src = 'http://127.0.0.1:4001/sideshowTheFump.js'; //script location added by Dan Netry April 23rd 3:50pm 

    document.getElementsByTagName('head')[0].appendChild(myScript); 
} 

else if(window.location.href == "http://thefump.com/whatis.php" || window.location.href == "http://www.thefump.com/whatis.php")
{ 
    myScript.src = 'http://127.0.0.1:4001/aboutTheFump.js';
...
{ 
    myScript.src = 'http://127.0.0.1:4001/mainTheFump.js'; // script location added by Dan Netry April 23rd 3:50pm 
