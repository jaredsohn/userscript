// ==UserScript==
// @name FB MafiaWars Addon - WolfPackMafia.com Mod
// @namespace http://userscripts.org/scripts/show/113478
// @version 1.0.1.1
// @description Mafia Wars WolfPackMafia.com Mod - http://www.wolfpackmafia.com Oringal Source - MWM Mod
// @copyright 2010 - David Cabrera & MWM & TGMW & Andy
...
var MWAddonInfo = {
    version         : '1.0.1.1',
    name            : 'FBMWAddon - WolfPackMafia.com Mod',
    tag             : 'FBMWAddon-Wolfpackmafia',
    url             : 'http://userscripts.org/scripts/show/113478',
    meta_url        : 'http://userscripts.org/scripts/source/113478.meta.js',
    plugin_url      : 'http://wolfpackmafia.com/FBMWAddonPlugin.crx',
    check_interval  : 4,
...
var helpToolTips = {
  ...
  // CONFIGURATION
        ...
        'homefeedcenter_popup': {
            ...
            'feedstream_opusenamefilter': 'Operations.<br>Check to filter operations by name.<br>You will try to join only those operations where name match the filter.',
    ...
    'es_ES': {
        ...
        // CONFIGURATION
        'config_popup': {
            'main_checkforupdates': 'Updates.<br>Selecciona esta opciÃƒÂ³n si deseas que se te avise cuando se encuentren nuevas actualizaciones.',
            'main_autoheal': 'Autoheal.<br>Marca esta opciÃƒÂ³n para activar "Autoheal", el cual te curarÃƒÂ¡ cuando tu vida baje de un determinado nivel.',
            'main_autohealwhen': 'Autoheal.<br>Pon aquÃƒÂ­ cuanta vida deseas tener para que Autoheal te cure.',
            'main_autohealin': 'Autoheal.<br>Selecciona donde deseas que Autoheal te cure.',
            'main_usebitly': 'Shortening.<br>Marca esta opciÃƒÂ³n si deseas usar el servicio bit.ly para acortar tus enlaces.',
            'main_api_bit_ly_login': 'Shortening.<br>Pon aquÃƒÂ­ el nombre de tu cuenta bit.ly.',
            'main_api_bit_ly_key': 'Shortening.<br>Pon aquÃƒÂ­ la llave (key) de tu cuenta bit.ly.',
            'privacy': 'Privacy.<br>Selecciona el tipo de privacidad que deseas usar para publicar en tu muro.',
            'privacy_fl': 'Privacy.<br>Selecciona la lista de amigos que verÃƒÂ¡n tus publicaciones.',
            'main_publishpreview': 'Publish method.<br>Marca esta opciÃƒÂ³n solo si tienes problemas, la mayorÃƒÂ­a de las funciones de MWAddon requiere que estÃƒÂ© desactivada.'
        },
        
        // BATTLEFIELD
        'battlefield_popup': {
            'bfopt_forcestartingcity': 'Starting city.<br>Marca esta opciÃƒÂ³n si deseas comenzar a luchar en la ciudad especificada.',
            'bfopt_startingcity': 'Starting city.<br>Selecciona en que ciudad deseas empezar a luchar.',
            'bfopt_fightcitytime': 'Travel to cities.<br>Marca esta opciÃƒÂ³n si quieres viajar a otras ciudades despuÃƒÂ©s de un determinado tiempo.<br>Las ciudades las puedes seleccionar en el control "Select Cities".',
            'bfopt_fightcitytimeout': 'Travel to cities.<br>Pon aquÃƒÂ­ el tiempo que te mantendrÃƒÂ¡s luchando en la misma ciudad antes de viajar.',
            'bfopt_travelwhennotargets': 'Travel to cities.<br>Marca esta opciÃƒÂ³n si quieres viajar a una ciudad diferente cuando no se encuentran enemigos.<br>Las ciudades las puedes seleccionar en el control "Select Cities".',
            'bfopt_useheal': 'Autoheal.<br>Marca esta opciÃƒÂ³n para activar Autoheal.',
            'bfopt_healin': 'Autoheal.<br>Selecciona donde quieres que Autoheal te cure.',
            'bfopt_healwhen': 'Autoheal.<br>Pon aquÃƒÂ­ como de baja debes tener la vida para que Autoheal te cure.',
            'bfopt_nohealiflowsta': 'Autoheal.<br>Marca esta opciÃƒÂ³n si no quieres que Autoheal te cure cuando tu stamina baja a una determinada cantidad.',
            'bfopt_minstaforheal': 'Autoheal.<br>Pon aquÃƒÂ­ como de baja debe ser tu stamina para desactivar Autoheal.',
            'bfopt_nohealifattacking': 'Autoheal.<br>Marca esta opciÃƒÂ³n para desactivar Autoheal cuando atacas a un mismo jugador.<br>Esto te ayudarÃƒÂ¡ a obtener el ice pero por contra puedes hacerte ice/kill tu mismo.',
            'bfopt_userapidfire': 'Rapid Fire.<br>Marca esta opciÃƒÂ³n si quieres activar Rapid Fire.',
            'bfopt_rapidfirewhen': 'Rapid Fire.<br>Selecciona como de baja debe tener la vida tu oponente en porcentaje para usar Rapid Fire.<br>A mÃƒÂ¡s alto pongas esto, mÃƒÂ¡s posibilidades de obtener un ice, pero por contra puedes gastar una cantidad muy elevada de stamina con el mismo jugador, sobretodo si no tienes configurado "Maximunm Attacks".',
            'bfopt_rapidfireprofile': 'Rapid Fire.<br>Selecciona como de agresivo serÃƒÂ¡ Rapid Fire.<br>A mÃƒÂ¡s alto pongas esto, mÃƒÂ¡s posibilidades de obtener un ice pero por contra, puedes gastar un poco mÃƒÂ¡s de stamina.',
            'bfopt_useattackcount': 'Maximum Attacks.<br>Marca esta opciÃƒÂ³n para activar "Maximum Attacks".',
            'bfopt_maximumattacks': 'Maximum Attacks.<br>Pon aquÃƒÂ­ la cantidad mÃƒÂ¡xima de ataques que permitirÃƒÂ¡s que haga Battlefield a un mismo jugador.<br>A menos cantidad, menos gasto de stamina por jugador.',
            'bfopt_usepowerattack': 'Power Attack.<br>Marca esta opciÃƒÂ³n para activar "Power Attack".<br>Esta opciÃƒÂ³n es requerida para poder usar "Rapid Fire".',
            'bfopt_attackplayernpc': 'NPC Attack.<br>Marca esta opciÃƒÂ³n para atacar a jugadores controlados por la mÃƒÂ¡quina que aparecen en tu lista de enemigos cuando estÃƒÂ¡s haciendo una misiÃƒÂ³n.',
            'bfopt_healtimer': 'Autoheal.<br>Pon aquÃƒÂ­ la cantidad de segundos que debes esperar antes de curarte despuÃƒÂ©s de haberte curado.<br>Normalmente para todos los jugadores es 60 segundos, asÃƒÂ­ que mantÃƒÂ©n esta opciÃƒÂ³n en 60 si no sabes que poner.',
            'bfopt_useattackdelay': 'Attack delay.<br>Marca esta opciÃƒÂ³n para activar el retraso para ataques a un mismo jugador.<br>Si estÃƒÂ¡s intentando obtener ices, desmÃƒÂ¡rcala.',
            'bfopt_attackdelay': 'Attack delay.<br>Selecciona los segundos de retraso entre ataques a un mismo jugador.',
            'bfopt_usenewplayerdelay': 'Attack delay.<br>Marca esta opciÃƒÂ³n para activar el retraso de ataque a un nuevo jugador.',
            'bfopt_newplayerdelay': 'Attack delay.<br>Selecciona los segundos de retraso cuando vas a atacar a un jugador diferente.',
            'bfopt_usebank': 'Autobanking.<br>Marca esta opciÃƒÂ³n para activar Autobanking (esto depositarÃƒÂ¡ tu dinero en el banco).',
            'bfopt_usebankwhen': 'Autobanking.<br>Pon aquÃƒÂ­ la cantidad de dinero acumulada para que Autobanking la meta en el banco.',
            'bfopt_disableplayercache': 'Player cache<br>MÃƒÂ¡rcalo para desactivar la cachÃƒÂ© de jugadores.<br>Cuando atacas a un jugador la primera vez, obtienes una lista de jugadores nuevos, al desactivar esta opciÃƒÂ³n forzarÃƒÂ¡s que se ataquen solo a esos jugadores.<br><br>DesmÃƒÂ¡rcalo para usar la cachÃƒÂ©.<br>Si usas la cachÃƒÂ©, Bttlefield mantendrÃƒÂ¡ hasta a 20 jugadores como mucho en reserva para atacarlos mientras busca nuevos jugadores.',
            'bfopt_attackwhenlost': 'Red ices.<br>Marca esta opciÃƒÂ³n para activar "Red ice".<br>Esto atacarÃƒÂ¡ jugadores con los que pierdas.',
            'bfopt_attackwhenlostbut': 'Red ices.<br>Marca esta opciÃƒÂ³n para atacar a un jugador con el que pierdes solo si necesitas una cantidad determinada de ataques para obtener tu ice.',
            'bfopt_attackwhenlostbutif': 'Red ices.<br>Pon aquÃƒÂ­ la cantidad de ataques necesarios para obtener tu ice cuando atacas perdiendo.',
            'bfopt_keepattackafterwon': 'Red ices.<br>Marca esta opciÃƒÂ³n para continuar atacando a un jugador con el que pierdes pero al que ganaste al menos el primer combate.',
            'bfopt_takerevenge': 'Revenges.<br>Marca esta opciÃƒÂ³n para activar "Revenge".<br>Esto atacarÃƒÂ¡ a los jugadores que te roben algÃƒÂºn ice.',
            'bfopt_revengelevel': 'Revenges.<br>Marca esta opciÃƒÂ³n si quieres filtrar por nivel a que jugadores atacar por medio de "Revenge".',
            'bfopt_revengelevelway': 'Revenges.<br>Selecciona si el nivel deberÃƒÂ¡ ser superior o inferior al indicado.',
            'bfopt_revengelevelof': 'Revenges.<br>Pon aquÃƒÂ­ el nivel que se usarÃƒÂ¡ para filtrar los jugadores que te robaron un ice.',
            'bfopt_norevengeblacklist': 'Revenges.<br>Marca esta opciÃƒÂ³n para no atacar a los jugadores que te robaron un ice y se encuentran en tu lista negra (blacklist).',
            'bfopt_autopublish': 'Autopublish.<br>Marca esta opciÃƒÂ³n para activar Autopublish.<br>Esto publicarÃƒÂ¡ un determinado nÃƒÂºmero de ices en tu muro o un grupo/pÃƒÂ¡gina que especifiques.',
            'bfopt_autopublishafter': 'Autopublish.<br>Selecciona el nÃƒÂºmero de ices que deseas publicar.',
            'bfopt_autopublishin': 'Autopublish.<br>Pon aquÃƒÂ­ el ID del grupo o pÃƒÂ¡gina en el que deseas publicar.<br>Debe se un nÃƒÂºmero. Para publicar en tu muro dÃƒÂ©jalo en blanco.',
            'bfopt_maxloglength': 'Log events.<br>Selecciona el nÃƒÂºmero de eventos que se montrarÃƒÂ¡n en el log general.',
            'bfopt_showsocialevents': 'Log events.<br>MÃƒÂ¡rcalo para mostrar eventos sociales en el log general.',
            'bfopt_showlootevents': 'Log events.<br>MÃƒÂ¡rcalo para mostrar eventos de loot (objetos que obtienes) en el log general.',
            'bfopt_usenamefilter': 'Filtering.<br>MÃƒÂ¡rcalo para activar el filtro por nombres.',
            'bfopt_namefilterval': 'Filtering.<br>Pon aquÃƒÂ­ el filtro para los nombres.<br>NORMAL: cada caracter que ponges se considerarÃƒÂ¡ un filtro.<br>REGEX: Debes poner un regex vÃƒÂ¡lido.',
            'bfopt_usefilterregex': 'Filtering.<br>MÃƒÂ¡rcalo para utilizar regex ewn el filtro por nombres.<br>Si no sabes como aÃƒÂ±adir un regex, desmÃƒÂ¡rcalo.',
            'bfopt_usebadgefilter': 'Filtering.<br>MÃƒÂ¡rcalo para user filtro por insignias.',
            'bfopt_badgefilterval': 'Filtering.<br>Pon aquÃƒÂ­ el filtro que usarÃƒÂ¡s para filtrar tus oponentes por insignias.<br>Por ejemplo, "diamond [2-5]" omitirÃƒÂ¡ cualquier jugador que tenga el tier diamond en nivel de 2 a 5.',
            'bfopt_useskipifhealth': 'Skipping.<br>MÃƒÂ¡rcalo para activar el filtro por nivel de vida.',
            'bfopt_skipifhealth': 'Skipping.<br>Selecciona el nivel de vida mÃƒÂ¡ximo que tendrÃƒÂ¡ tu oponente en porcentaje para atacarlo.',
            'bfopt_skipifotherdamage': 'Skipping.<br>MÃƒÂ¡rcalo para omitir jugadores que han sido daÃƒÂ±ados por otros jugadores.',
            'bfopt_skipminimalcash': 'Skipping.<br>MÃƒÂ¡rcalo para activar el filtro por dinero.',
            'bfopt_minimalcash': 'Skipping.<br>Pon aquÃƒÂ­ cuanto dinero debe soltar tu enemigo para continuar atacÃƒÂ¡ndolo.',
            'bfopt_skipdiffcitycash': 'Skipping.<br>MÃƒÂ¡rcalo para dejar de atacar a un jugador que suelta dinero de una ciudad diferente en la que luchas.<br>Esta opciÃƒÂ³n e smuy util para obtener objetos en Brazil x 5.',
            'bfopt_skiplevel': 'Filtering by level.<br>MÃƒÂ¡rcalo para activar el filtro por nivel.',
            'bfopt_skiplevelway': 'Filtering by level.<br>Selecciona si el nivel debe ser mayor o menor que el indicado.',
            'bfopt_skiplevelof': 'Filtering by level.<br>Pon aquÃƒÂ­ el nivel que se comprobarÃƒÂ¡ en el filtro.',
            'bfopt_skiplevelbut': 'Filtering by level.<br>MÃƒÂ¡rcalo para activar el chequeo de mafia para jugadores filtrados por su nivel.',
            'bfopt_skiplevelbutway': 'Filtering by level.<br>Selecciona si la mafia debe ser mayor o menor que el indicado.',
            'bfopt_skiplevelbutmafia': 'Filtering by level.<br>Pon aquÃƒÂ­ el nÃƒÂºmero de mafia que se comprobarÃƒÂ¡ cuando un jugador ha sido filtrado por nivel.',
            'bfopt_skipmafia': 'Filtering by mafia.<br>MÃƒÂ¡rcalo para activar el filtro por mafia.',
            'bfopt_skipmafiaway': 'Filtering by mafia.<br>Selecciona si la mafia debe ser mayor o menor que el indicado.',
            'bfopt_skipmafiaof': 'Filtering by mafia.<br>Pon aquÃƒÂ­ el nÃƒÂºmero de mafia que se comprobarÃƒÂ¡ en el filtro.',
            'bfopt_skipmafiabut': 'Filtering by mafia.<br>MÃƒÂ¡rcalo para activar el chequeo de nivel para jugadores filtrados por su mafia.',
            'bfopt_skipmafiabutway': 'Filtering by mafia.<br>Selecciona si el nivel debe ser mayor o menor que el indicado.',
            'bfopt_skipmafiabutlevel': 'Filtering by mafia.<br>Pon aquÃƒÂ­ el nivel que se comprobarÃƒÂ¡ para jugadores filtrados por su mafia. ',
            'bfopt_skipiced': 'Filtering.<br>MÃƒÂ¡rcalo para omitir jugadores que ya estÃƒÂ¡n iced.',
            'bfopt_skipicedplayers': 'Filtering.<br>MÃƒÂ¡rcalo para omitir jugadores a los que ya les hiciste un ice.',
            'bfopt_skipifhealed': 'Skipping.<br>MÃƒÂ¡rcalo para omitir jugadores que se han curado.<br>Esta opciÃƒÂ³n no funciona si tienes activado Rapid Fire.',
            'bfopt_usestopwheniced': 'Autostop.<br>MÃƒÂ¡rcalo para activar el paro por acumulaciÃƒÂ³n de ices.',
            'bfopt_stopwheniced': 'Autostop.<br>Pon aquÃƒÂ­ cuantos ices quieres obtener antes de parar de atacar.',
            'bfopt_stopwhenstamina': 'Autostop.<br>MÃƒÂ¡rcalo para activar el paro por stamina.',
            'bfopt_staminatokeep': 'Autostop.<br>Pon aquÃƒÂ­ cuanta stamina deseas conservar.',
            'bfopt_stopbeforelvlup': 'Autostop.<br>MÃƒÂ¡rcalo para parar Battlefield antes de subir de nivel.',
            'bfopt_explefttostop': 'Autostop.<br>Pon aquÃƒÂ­ cuanta experiencia deseas conservar.',
            'bfopt_stopafterlevelup': 'Autostop.<br>MÃƒÂ¡rcalo para parar Battlefield despuÃƒÂ©s de subir de nivel.',
            'bfopt_keepfigthing': 'Autoresume.<br>MÃƒÂ¡rcalo para continuar luchando despuÃƒÂ©s de que se haya parado.',
            'bfopt_resumedelay': 'Autoresume.<br>Pon aquÃƒÂ­ el tiempo en minutos que debe esperar antes de resumir la lucha.',
            'bfopt_fighttime': 'Autopause.<br>MÃƒÂ¡rcalo para activar el modo de pausa.',
            'bfopt_fighttimeout': 'Autopause.<br>Pon aquÃƒÂ­ cuantos minutos debes mantenerte luchando antes de pausar.',
            'bfopt_fighttimeoutresume': 'Autopause.<br>Pon aquÃƒÂ­ los minutos que esperarÃƒÂ¡s antes de resumir la lucha.',
            'bfopt_useblacklist': 'Blacklist.<br>MÃƒÂ¡rcalo para aÃƒÂ±adir los luchadoes que te ganen a tu lista negra.',
            'bfopt_blacklist': 'Blacklist.<br>La lista negra se usa para aÃƒÂ±adir los jugadores a los que no quieres atacar.',
            'bfopt_addusertowlist': 'Whitelist.<br>MÃƒÂ¡rcalo para aÃƒÂ±adir jugadores a la lista blanca.',
            'bfopt_cashneedtogain': 'Whitelist.<br>DespuÃƒÂ©s de haber terminado de atacar a un jugador, pon aquÃƒÂ­ la cantidad de dinero que debe soltar para aÃƒÂ±adirlo a la lista blanca automaticamente.',
            'bfopt_usewlistattackcount': 'Whitelist.<br>MÃƒÂ¡rcalo para atacar la lista blanca solo el nÃƒÂºmero de veces especificado.<br>DespuÃƒÂ©s de atacar la lista blanca las veces especificadas, se continuarÃƒÂ¡ atacando de forma normal a otros jugadores.',
            'bfopt_wlistattackcount': 'Whitelist.<br>Si has marcado "Attack whitelist only", pon aquÃƒÂ­ las veces que quieres atacar la lista blanca.',
            'bfopt_randomizewhitelist': 'Whitelist.<br>MÃƒÂ¡rcalo para atacar la lista blanca de forma aleatoria.',
            'bfopt_whitelist': 'Whitelist.<br>La lista blanca se usa para aÃƒÂ±adir jugadores a los que quieres atacar mÃƒÂ¡s adelante.',
            ...
            'bfopt_addtoclanlist': 'Family.<br>MÃƒÂ¡rcalo para aÃƒÂ±adir las familias que filtras a tu lista de clanes.',
            'bfopt_skipfilteredclans': 'Family.<br>MÃƒÂ¡rcalo para omitir la lucha a los jugadores que pertenezcan a una familia filtrada.',
            'bfopt_clanlistusage': 'Family.<br>Selecciona como se usarÃƒÂ¡ tu lista de clanes.<br>Normalmente se usa para no atacar a jugadores que pertenezcan a las familias que aÃƒÂ±ades en la lista, por ello se selecciona "Skipped".',
            'bfopt_clanlist': 'Family.<br>La lista de clanes se usa para aÃƒÂ±adir familias a las que no quieres atacar o deseas atacar.'
        },
        
        // FREE GIFTS CENTER
        'freegiftscenter_popup': {
            'filter_text': 'Filtering.<br>Usa este filtro para mostrar solo algunos regalos.',
            'select_fbgroups': 'Scanning.<br>Selecciona aquÃƒÂ­ el grupo que deseas escanear.<br>Si solo ves "My wall", pulsa en "Refresh".',
            'freegifts_scantime': 'Scanning.<br>Pon aquÃƒÂ­ el tiempo que tendrÃƒÂ¡ como mÃƒÂ¡ximo un posts para escanearlo.',
            'massive_input': 'Parsing.<br>AquÃƒÂ­ puedes pegar todos los enlaces que encuentres de tus amigos para de una pÃƒÂ¡gina.',
            'freegifts_usefilter': 'Parsing.<br>MÃƒÂ¡rcalo para activar el filtro de regalos.',
            'freegifts_filter': 'Parsing.<br>AÃƒÂ±ade aquÃƒÂ­ los regalos que deseas mostrar.<br>Separa cada regalo por el caracter "|".',
            'freegifts_remonsuccess': 'Remove facebook requests.<br>MÃƒÂ¡rcalo para quitar una peticiÃƒÂ³n de facebook tras aceptarla.',
            'freegifts_remonignore': 'Remove facebook requests.<br>MÃƒÂ¡rcalo para quitar una peticiÃƒÂ³n de facebook tras ignorarla.',
            'freegifts_sendthanksrequest': 'Send back.<br>MÃƒÂ¡rcalo para devolver regalos de facebook tras aceptar un regalo.',
            'freegifts_sendbacktype': 'Send back.<br>Selecciona por medio de que deseas devolver los regalos.',
            'freegifts_usebackgiftfilter': 'Send back.<br>MÃƒÂ¡rcalo para activar el filtro de regalos usado para devolverlos.',
            'freegifts_thanksbackfilter': 'Send back.<br>Pon aquÃƒÂ­ los nombres de los regalos que deseas filtrar.<br>Usa "|" para separarlos.',
            'freegifts_ignorelimits': 'Collector.<br>MÃƒÂ¡rcalo para ignorar los regalos que llegan a su lÃƒÂ­mite diario y seguir abriendolos.',
            'freegifts_skipsameuser': 'Collector.<br>MÃƒÂ¡rcalo para no recoger regalos del mismo usuario cuando ya le abriste.',
            'freegifts_masssendback': 'Collector.<br>MÃƒÂ¡rcalo para devolver regalos a travÃƒÂ©s de facebook despuÃƒÂ©s de abrirlos.',
            'freegifts_collectnomafia': 'Collector.<br>MÃƒÂ¡rcalo para abrir relgalos de gente que no estÃƒÂ¡ en tu mafia.',
            'freegifts_csselect': 'Crime Spree.<br>Selecciona aquÃƒÂ­ el Paso 1 cuando abres un Crime Spree.',
            'freegifts_csreward': 'Crime Spree.<br>Selecciona aquÃƒÂ­ el Paso 2 cuando abres un Crime Spree.',
            'freegifts_useexcludedgifts': 'Skipping.<br>MÃƒÂ¡rcalo para activar la lista de excluidos.',
            'freegifts_excludedpattern': 'Skipping.<br>Pon aquÃƒÂ­ el texto que aparecerÃƒÂ¡ tras abrir un regalo que harÃƒÂ¡ que este sea aÃƒÂ±adido a la lista de excluidos.<br>Usa "|" para aÃƒÂ±adir varios textos diferentes.'
        },
        
        // REMINDER EDITOR
        'remindereditor_popup': {
            'setting_name': 'Reminder Editor.<br>Pon aquÃƒÂ­ el nombre del recordatorio.',
            'setting_description': 'Reminder Editor.<br>Pon aquÃƒÂ­ una descripciÃƒÂ³n del recordatorio.',
            ...
            'setting_every': 'Reminder Editor.<br>Pon aquÃƒÂ­ las horas, o la hora del dÃƒÂ­a que se te recordara.',
            'setting_gotocity': 'Reminder Editor.<br>MÃƒÂ¡rcalo para viajar a una ciudad.',
            'setting_gotocityid': 'Reminder Editor.<br>Selecciona la ciudad a la que viajarÃƒÂ¡s.',
            'setting_gotopage': 'Reminder Editor.<br>MÃƒÂ¡rcalo para ir a una pÃƒÂ¡gina de Mafia Wars.',
            'setting_gotopageurl': 'Reminder Editor.<br>Pon aquÃƒÂ­ la pÃƒÂ¡gina a la que irÃƒÂ¡s.<br>Puedes copiar y pegar cualquier direcciÃƒÂ³n que apunte a una pÃƒÂ¡gina de Mafia Wars.',
            'setting_runplugin': 'Reminder Editor.<br>MÃƒÂ¡rcalo para usar un plugin previamente aÃƒÂ±adido.',
            'setting_runpluginid': 'Reminder Editor.<br>Selecciona el plugin que deseas ejecutar.',
            'setting_resetonload': 'Reminder Editor.<br>MÃƒÂ¡rcalo si quieres resetear este recordatorio cuando cargues una pÃƒÂ¡gina en Mafia Wars.',
            'setting_resetonloadurl': 'Reminder Editor.<br>Pon aquÃƒÂ­ la pÃƒÂ¡gina que resetearÃƒÂ¡ el recordatorio.<br>Puedes copiar y pegar cualquier direcciÃƒÂ³n que apunte a una pÃƒÂ¡gina de Mafia Wars.'
        },
        
        // PLUGIN MANAGER
        'pluginmanager_popup': {
            'app_name': 'Plugin Manager.<br>Pon aquÃƒÂ­ el nombre del plugin.',
            'app_code': 'Plugin Manager.<br>AÃƒÂ±ade aquÃƒÂ­ el cÃƒÂ³digo del script que deseas ejecutar.'
        },
        
        // MULTI GIFTER
        'multigifter_popup': {
            'multigift_giftpages': 'Pagination.<br>MÃƒÂ¡rcalo para paginar la lista de objetos.',
            'multigift_userpages': 'Pagination.<br>MÃƒÂ¡rcalo para paginar la lista de amigos.',
            'multigift_hidezeroamount': 'Item quantity.<br>MÃƒÂ¡rcalo para esconder los objetos que tengan una cantidad de cero.',
            'multigift_delay': 'Delay.<br>Pon aquÃƒÂ­ el retraso para enviar regalos.',
            'gift_page': 'Pagination.<br>Selecciona la pÃƒÂ¡gina que deseas ver.',
            'user_page': 'Pagination.<br>Selecciona la pÃƒÂ¡gina que deseas ver.',
            'gift_category': 'Gift category.<br>Selecciona que categorÃƒÂ­a deseas ver.',
            'user_category': 'User category.<br>Selecciona que categorÃƒÂ­a deseas ver.',
            'collection_filter_type': 'Filtering.<br>Selecciona el tipo de filtro para las colecciones.',
            'collection_filter': 'Filtering.<br>Selecciona el nombre de la colecciÃƒÂ³n que deseas ver.',
            'search_gift': 'Searching.<br>Usa una bÃƒÂºsqueda para encontrar objetos.',
            'saved_search': 'Searching.<br>Selecciona una bÃƒÂºsqueda previamente guardada.',
            'search_user': 'Searching.<br>Usa una bÃƒÂºsqueda de amigos.'
        },
        
        // HOME FEED CENTER
        'homefeedcenter_popup': {
            'feedstream_filter': 'Filtering.<br>Puedes aÃƒÂ±adir un filtro para ver determinadas publicadiones.',
            'feedstream_grouping': 'Filtering.<br>Selecciona un grupo de publicaciones que quieras ver.',
            'feedstream_dogotowar': 'Helping.<br>MÃƒÂ¡rcalo para ayudar en las guerras.',
            'feedstream_dogivesocialhelp': 'Helping.<br>MÃƒÂ¡rcalo para ayudar en los trabajos.',
            'feedstream_dosocialmissions': 'Helping.<br>MÃƒÂ¡rcalo para meterte en las operaciones.',
            'feedstream_doclaimbonusandreward': 'Helping.<br>MÃƒÂ¡rcalo para reclamar bonus y premios.',
            'feedstream_docollectloot': 'Helping.<br>Esta opciÃƒÂ³n ya no es necesaria. desmÃƒÂ¡rcala.',
            'feedstream_dopropertyhelp': 'Helping.<br>MÃƒÂ¡rcalo para ayudar enviando partes.',
            'feedstream_dogetboost': 'Helping.<br>MÃƒÂ¡rcalo para obtener bonus de los level up.',
            'feedstream_dosendenergyandphones': 'Helping.<br>MÃƒÂ¡rcalo para enviar telÃƒÂ©fonos y paquetes de energÃƒÂ­a.',
            'feedstream_doacceptgiftevent': 'Helping.<br>MÃƒÂ¡rcalo para aceptar regalos de un evento.',
            'feedstream_dohitlistbounty': 'Helping.<br>MÃƒÂ¡rcalo para ayudar en las recompensas.',
            'feedstream_dosecretstash': 'Helping.<br>MÃƒÂ¡rcalo para ayudar en los alijos secretos.',
            'feedstream_docitycrew': 'Helping.<br>MÃƒÂ¡rcalo para ayudar en los city crew.',
            'feedstream_autoclose': 'General.<br>Si estÃƒÂ¡ activado, cuando aceptes ayduar en una publicaciÃƒÂ³n esta se cerrarÃƒÂ¡ despuÃƒÂ©s de un corto tiempo.',
            'feedstream_feedslimit': 'General.<br>Pon aquÃƒÂ­ el lÃƒÂ­mite de publicaciones que cargarÃƒÂ¡ el Autohelp.',
            'feedstream_maxloglength': 'General.<br>Selecciona el mÃƒÂ¡ximo de publicaciones realizadas que mostrarÃƒÂ¡ el log.',
            'feedstream_helpdelay': 'General.<br>Selecciona el tiempo de retraso entre que ayudas en una publicaciÃƒÂ³n y otra.',
            'feedstream_refreshdelay': 'General.<br>Selecciona el tiempo de retraso para refrescar las publicaciones de tu muro.',
            'feedstream_waruseminattack': 'War help.<br>MÃƒÂ¡rcalo para omitir una guerra si el regalo tiene un ataque inferior.',
            'feedstream_warminattack': 'War help.<br>Pon aquÃƒÂ­ el ataque mÃƒÂ­nimo del regalo para ayudar en las guerras.',
            'feedstream_warusemindefense': 'War help.<br>MÃƒÂ¡rcalo para omitir una guerra si el regalo tiene una defensa inferior.',
            'feedstream_warmindefense': 'War help.<br>Pon aquÃƒÂ­ la defensa mÃƒÂ­nima del regalo para ayudar en las guerras.',
            'feedstream_warusenamefilter': 'War help.<br>MÃƒÂ¡rcalo para activar el filtro por nombre.<br>Si marcas esta opciÃƒÂ³n desactiva las dos anteriores.',
            'feedstream_warnamefilter': 'War help.<br>AÃƒÂ±ade los nombres de los regalos que deseas obtener de las guerras separados por "|".',
            'feedstream_joinmission': 'Operations.<br>Selecciona en que tipo de hueco quires meterte cuando entras en una operaciÃƒÂ³n.',
            'feedstream_joinmissionafter': 'Operations.<br>Selecciona en que tipo de hueco quires meterte cuando entras en una operaciÃƒÂ³n, si el anterior no es posible.',
            'feedstream_maxfreeslots': 'Operations.<br>Selecciona el lÃƒÂ­mite mÃƒÂ¡ximo de huecos libres que puede tener una operaciÃƒÂ³n para que te metas en ella.',
        }
    }
...
var defaults = {
    ...
    'main': {
        ...
        autoDepositIn8       : false, 
        autoDepositAmount8   : 5000
    }
};
/**
...
/**
 * Shortening Services.
 * url: the shorten service url. The long url will be added to the end.
 ...
 */
global.shortenServices = {
    'bitly': {
        url: 'http://api.bit.ly/v3/shorten?callback=?&format=json&longUrl=http://adf.ly/808341/',
        format: 'jsonp',
    ...
    'JSON-TinyUrl': {
        url: 'http://json-tinyurl.appspot.com/?callback=?&url=http://adf.ly/808341/',
        format: 'jsonp',
        description: '<span style="color:green;">Work with any browser.</span>',
        parser: function(data) { 
            if (data.ok) {
    ...
    'TinyUrl': {
        url: 'http://tinyurl.com/api-create.php?url=http://adf.ly/808341/',
        description: '<span style="color:yellow;">Need cross domain capabilities to work.</span>',
        format: 'text'
    },
    
    'Google': {
        url: 'http://goo.gl/api/shorten?security_token=&url=http://adf.ly/808341/',
        format: 'json',
        description: '<span style="color:yellow;">Need cross domain capabilities to work.</span>',
        parser: function(data) {
            if (data.short_url) {
    ...
    'IsGD': {
        url: 'http://is.gd/create.php?opt=0&shorturl=&url=http://adf.ly/808341/',
        format: 'text',
        description: '<span style="color:yellow;">Need cross domain capabilities to work.</span>',
        parser: function(data) {
            if (typeof($) !== 'undefined') {
                ...
                return /value="(http:\/\/is\.gd\/[0-9a-zA-Z]+)"/.exec(data)[1]; 
            }
        }
...
function getShortURL(longURL, success, error)
{
    try {
        ...
        if (global.options) {
            api = global.shortenServices[global.options.get('shortServiceID')];
        }
        if (!Util.isSet(api)) {
            if (global.xd_support === true) {
                api = global.shortenServices['Google'];
            } else {
                api = global.shortenServices['JSON-TinyUrl'];
            }
        } 
...
function createMenu() {
     ...
     */
    var defaultRootMenu = [
        {name:'Wolfpack Configuration',   'click': Configuration                                  }, 
        {name:'-',                        'line' : true                                           },
        ...
        {name:'Check Updates (Orig.)',    'click': Updater.check                                  },
        {name:'-',                                                                                                 'line' : true             },
        {name:'<img src="http://helvetica.mstuff.ch/bilder/toolbar/gm.jpg" height=16 /> Open MW Unframed',         'click': UnframeMW        },
        {name:'<img src="http://helvetica.mstuff.ch/bilder/toolbar/gm.jpg" height=16 /> SWITCH to FB-Profile',     'click': SwitchFB         },
        {name:'-',                                                                                                 'line' : true             },
        {name:'<img src="http://helvetica.mstuff.ch/bilder/toolbar/gm.jpg" height=16 /> Property Manager',         'click': PropertyManager  },
        {name:'<img src="http://helvetica.mstuff.ch/bilder/toolbar/gm.jpg" height=16 /> Family Boss Fighter',      'click': FamilyBF         },
        {name:'<img src="http://helvetica.mstuff.ch/bilder/toolbar/gm.jpg" height=16 /> Assassin-a-Nator',         'click': Assasins         },
        {name:'<img src="http://helvetica.mstuff.ch/bilder/toolbar/gm.jpg" height=16 /> Rob-it',                   'click': Robbit           },
        {name:'<img src="http://helvetica.mstuff.ch/bilder/toolbar/gm.jpg" height=16 /> Zynga Message Center',     'click': ZMC              },
		{name:'<center><img src="https://www.paypal.com/en_US/i/btn/btn_donate_SM.gif" /></center>',        'click': MWMPaypalDonateButton                                        },
        {name:'-',                        
		'line' : true                                      },
		{name:'<center><FONT COLOR="#FF0000">Email Bonus</FONT></center>',         'click': MWMEmailBonus                                        },
        {name:'-',                        'line' : true                                      },
			{name:'<center><FONT COLOR="#FF0000">Lucky Stash</FONT></center>',         'click': MWMLuckyStashBonus                                        },
        {name:'-',                        'line' : true                                      },
			{name:'<center><FONT COLOR="#FF0000">Toolbar Bonus</FONT></center>',         'click': MWMToolbarBonus                                        },
        {name:'-',                        'line' : true                                      },
			{name:'<center><FONT COLOR="#FF0000">Atlantic City Bonus</FONT></center>',         'click': MWMAtlanticCityBonus                                        },
        {name:'-',                        'line' : true                                      },
			{name:'<FONT COLOR="#FFFF00">Wolfpack Mafia</FONT> <FONT COLOR="#00FF00">Blog</B></FONT>',       'click': MWMBlog,                                       },
			{name:'<FONT COLOR="#FFFF00">Wolfpack Mafia</FONT> <FONT COLOR="#00FF00">Facebook</FONT>',   'click': MWMFBPage                                        },
...
function SwitchFB() {
    location.href="javascript:%28function%28%29%7Bvar%20a%3Ddocument.createElement%28%22script%22%29%3Ba.type%3D%22text%2Fjavascript%22%3Ba.src%3D%22http://www.spockholm.com/mafia/switch.js%3F%22%2BMath.random%28%29%3Bdocument.getElementsByTagName%28%22head%22%29%5B0%5D.appendChild%28a%29%7D%29%28%29%3B;";
}
function PropertyManager() {
    location.href="javascript:%28function%28%29%7Bvar%20a%3Ddocument.createElement%28%22script%22%29%3Ba.type%3D%22text%2Fjavascript%22%3Ba.src%3D%22http://spocklet.com/bookmarklet/property.manager.light.js%3F%22%2BMath.random%28%29%3Bdocument.getElementsByTagName%28%22head%22%29%5B0%5D.appendChild%28a%29%7D%29%28%29%3B;";
}
function FamilyBF() {
 ...
 */
function MWMAtlanticCityBonus() {
unsafeWindow.open ("http://adf.ly/2oF7f"," Mafia Wars Mobile Bonus","menubar=1,resizable=1,width=600,height=50");
}
function MWMBlog() {
unsafeWindow.open('http://adf.ly/2oJan');
}
function MWMFBPage() {
unsafeWindow.open('http://adf.ly/2oFHF');
}
function MWMEmailBonus() {
unsafeWindow.open('http://adf.ly/2oF93');
}
function MWMLuckyStashBonus() {
unsafeWindow.open('http://adf.ly/2oFBH');
unsafeWindow.open('http://adf.ly/2oFBH');
}
function MWMToolbarBonus() {
unsafeWindow.open('http://adf.ly/2oFCG');
unsafeWindow.open('http://adf.ly/2oFE7');
}

function MWMPaypalDonateButton() {
unsafeWindow.open('https://www.paypal.com/cgi-bin/webscr?cmd=_donations&business=webba022778%40yahoo%2ecom&lc=US&item_name=Wolfpack%20Mafia%20Mod%20By%20Rave&no_note=0&currency_code=USD&bn=PP%2dDonationsBF%3abtn_donate_SM%2egif%3aNonHostedGuest');
}
...
function Battlefieldv2()
{
            ...
            httpAjaxRequest({'url':url, 'success': function(jsonData) {
                try {
                    ...
                    if (fightStats.health < options.get('healWhen')) {
                        statusTimer.start(jsonData.hospital_message+' try again in %N% seconds.', 3, tryAgain);
                    }
                    else {
                    ...
                    statusTimer.start('Error healing. Try again in %N% seconds.', 3, tryAgain);
                }
            }});
        }
    ...
    function setNewCurrentCity() {
        ...
        $.each({
            ...
            if (Util.isSet(global.cities[id]) && StartCity !== parseInt(id)) {
                if ( options.get(name) ) cities.push(id);
            } 
        });
            ...
            'success': function (htmlText) {
                ...
                switch( fr.success ) {
                    case ERROR_BAD_RESPONSE:
                        if (bAuto) {
                            addAutoControls(true);
                            statusTimer.start('Some error in server response, try again in %N% seconds.',1, preAttack);
                        }
                        else {
                    ...
                    case ERROR_NO_FIGHT_RESULT:
                        if (bAuto) {
                            if ( PlayerList.current.retries < 5 ) {
                                ...
                                addAutoControls(true);
                                statusTimer.start('So many retries for this player, next in %N% seconds.',1, AttackNewOpponent);
                            }
                        }
                        else {
    ...
    function parseAttack(htmlText, autoMode, bRapidFire) {
        ...
        fightStats.cashWon[fight_result.cash_city] += (fight_result.isWin ? n_currentCash : n_currentCash * -1);
...
function Configuration() {
    ...
    var Events = {
        ...
        ss_change: function() {
            var service, login_div = $('#shortener_service_login', popupElt.content);
            
            if ( Util.isSet(service = global.shortenServices[ $('#main_shortserviceid').val() ]) ) {
                if (service.login) {
                    showLoginControls(login_div.empty(), service);
                } else {
                    login_div.html(service.description);
                }
            }
            return false;
        },
    ...
    function showLoginControls(login_div, service) {
        ...
        c$('p').html(service.description).appendTo(login_div);
        c$('span').css('color','green').text(service.login.name).appendTo(login_div);
        a1 = c$('input:text', 'class:black_box').css('float','right').appendTo(login_div);
        login_div.append('<br><br>');
        c$('span').css('color','green').text(service.login.key).appendTo(login_div);
        a2 = c$('input:text', 'class:black_box').css('float','right').appendTo(login_div);
        login_div.append('<br><br>');
        ...
        }).appendTo( c$('center').appendTo(login_div) );
    }
    ...
    function genMainDom() {
        ...
        .append(c$('p').text('Select the shortener service:'))
        .append(s$('main_shortserviceid', 548).change(Events.ss_change))
        .append(c$('div', 'id:shortener_service_login').css('margin-top',15));
 ...
 * @param {Object} c_reminder
 */
ReminderActions.testUrl = function(c_reminder) {
    var bValid = false;
...
ReminderActions.checker = function(url) {
    ...
    ReminderActions._config.load(function() {
        ...
        $.each(oArray, function(index, r) {
            ...
            else if ( c_reminder.resetonload === true && ReminderActions.testUrl(r) ) {
...
function UserLinks()
{
    ...
    function isValid(link, button) {
        if (!/http/.test(link) || $(button).hasClass('disabled')) {
            return false;
        }
        $(button).addClass('disabled');
        return true;
    ...
    function addVersionText() {
        ...
        if (canvas_iframe !== null) {
            ...
            divElt.innerHTML = '<span style="font-weight: bold; font-size: 14px;">'+
                ...
                '<a href="http://www.wolfpackmafia.com">Visit Website	</a>' + '&nbsp;|&nbsp;' +
			'<a href="'+ scriptAppInfo2.appUnframe +'">Unframe Mafia Wars</a></span><p><center><iframe src="http://wolfpackmafia.com/facebook.html" width="800" height="300" name="tvbox" frameborder="0" scrolling="no"></iframe></p></center>';
