...
// @name           DS_Sounds
// @namespace      none
// @description    Version 1.60.01 english, deutsch, francais. sound for TribalWars, Sound für Die Staemme, son pour TribalWars.
...
var lang = GM_getValue("ds_lang", "en");
	// Textbausteine, für Sprachanpassung übersetzen 	// for a better translation or other languages translate Text1 to Text12 and send it to win4@gmx.net - Please translate also the help-document
if (lang  == "nl") 
{
...
{
	var Text1 = " - TW_SON OPTIONS - "; 					// Sound Options (title)
...
// Sprache einstellen
	...
	td12.appendChild(document.createTextNode("français "));
