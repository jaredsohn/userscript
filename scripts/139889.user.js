// ==UserScript==
// @name			HF Scripts - Easy Report Monetizing Techniques
// @namespace 		Glassy/hfreportingmonetizingtechniques
// @description 	Makes reporting posts/threads in Monetizing Techniques section to Glassy MUCH easier.
// @include  		*hackforums.net/showthread.php*
// @version  		1.1.2
// ==/UserScript==

var navBit = document.getElementsByClassName('navigation')[0];
if(navBit.innerHTML.indexOf('<a href="forumdisplay.php?fid=120">Monetizing Techniques</a>') != -1) {
