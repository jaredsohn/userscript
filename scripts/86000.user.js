// ==UserScript==
// @name            CSR Battle orders
// @namespace       www.erepublik.com
// @author          Venta
// @description     Erepublik battle orders for Czech Socialist Republic
// @version         1.00
...
(function(undefined)
{
	...
	var url = 'http://ccpml.xtreemhost.com/army/order.php?name='+botName;
    var updateUrl = 'http://userscripts.org/scripts/show/86000';
    ...
    function parseData(s)
    {
        ...
        try
        {
            ...
            mon = '<p><a href="'+mon+'" target="_blank">Official Newspaper of CSR MoD</a></p>';
    ...
    function displayFrame(orders, links, additional, date, mon, im)
    {
        ...
        ordersDiv.innerHTML = '\
        <div class="title"><h1>Czech Socialist Republic</h1></div>\
        <div class="latest_events box">\
            <div class="item elem">\
                <div class="iconholder"><img class="test" src="'+im+'" alt=""/></div>\
                <div class="holder">\
		    <p>Welcome comrade,' + botName + '. Follow the orders for day '+date+'</p>\
		    <p style="color: #000000;">'+orders+'<br/>Fight: '
                    +links+
                    '</p>'
                    +additional+
