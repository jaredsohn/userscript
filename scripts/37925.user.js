		...
		for (i = 0; i <allLinks.length; ++i)
			{
				...
				{
				allLinks [i].href = allLinks [i].href.replace ("//forum.51nb.com", "//www.51nb.com/forum");
				}
				if (allLinks [i].href.indexOf ("//www.thinkpad.cn/forum") > 0)
				{
				allLinks [i].href = allLinks [i].href.replace ("//www.thinkpad.cn/forum", "//www.51nb.com/forum");
				}
				if (allLinks [i].href.indexOf ("//51nb.com/forum") > 0)
				{
				allLinks [i].href = allLinks [i].href.replace ("//51nb.com/forum", "//www.51nb.com/forum");
				}
			}
	}
}
