// ==UserScript==
// @name           LoU Suite | TEK M13
// @description    Various Helpers for Lord Of Ultima
// @namespace      totopoubelle7
// @include        http://prodgame*.lordofultima.com/*/index.aspx*
// @version        1.0.4
// @require 	   http://userscripts.org/scripts/show/153384
// //require       http://sizzlemctwizzle.com/updater.php?id=127647&days=1
// //basedOn        LoU Suite | 76s Edit | SmileyGirl Edit  | AL fix | version 1.1.2
// //basedOnUrl     http://userscripts.org/scripts/show/149073
// ==/UserScript==
		...
		function createSuite() {
			...
			qx.Class.define("louSuite.optionsPage", {
				...
				construct: function() {
					...
					this.setTitle("LoU Suite | TEK Edit");
							...
							if (dungeon['state'] && (dungeon['level'] >= min_level)) {
								...
								for (var cityId in LT.player.cities) {
									...
									if (typeof(units_to_send)=='object') {
										...
										var units_string = "";
										onlyGuardians = 0; // 0=NotTest; 1=Guardians; 2=OtherThanGuardians
										...
										if (onlyGuardians==1)
										{
											// Suppression de la ligne seule guardians
										}
										else if(distance>20)
										{
											// Suppression des trop loins
										}
										else
										{
