...
// @description   http://userscripts.org/scripts/show/69385
...
// @include       http://www.google.co.uk/images?*
// @copyright      NJA
// @version        1.0.1
...
var div = document.evaluate("//div[@id = 'ImgContent']", document, null,
  XPathResult.FIRST_ORDERED_NODE_TYPE, null).singleNodeValue;
div.addEventListener('DOMNodeInserted', function (event) {
  if (event.target.id == "imgtb") {
    window.setTimeout(createLinks, 100);
  }
}, false);
...
function createLinks() {
  ...
  var googFonts = document.evaluate("//td/font/span[@class = 'a']|" +
    ...
    XPathResult.ORDERED_NODE_SNAPSHOT_TYPE, null);
  if (googFonts.snapshotLength == 0) {
    googFonts = document.evaluate("//div[@class = 'std']/div[@class = 'a']/" +
      "cite", document, null, XPathResult.ORDERED_NODE_SNAPSHOT_TYPE, null);
  }
