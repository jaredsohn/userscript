// ==UserScript==
// @name           Travian links
// @namespace      http://userscripts.org/scripts/show/69727
// @description    Shows quick links below villages. At the moment links are stored inside 
// @namespace      Travian
// @version 	1
...
document.getElementById("downArrow").addEventListener("click", contentDown, false);
        ...
        document.getElementById("visibilityContainer").appendChild(divTag);
		divTag.innerHTML = "<img src=\"http://upload.wikimedia.org/wikipedia/commons/2/28/Smile-tpvgames.gif\" />";
