...
// @name           League of Empires chat

// @version        1.0

// @namespace      Guthix

// @description    League of empires alliance chat
...
unsafeWindow.displayshout = function() {
	...
	if(displayedflag == 0) {
		...
		document.getElementById("shoutframe").innerHTML = '<iframe width="200" border="0" frameborder="0" height="100%" src="http://www4.shoutmix.com/?jlong" style="margin-left:0px;"></iframe>';
...
document.getElementById("shoutbar").innerHTML ='<div id="shouttab" ondblclick="showshout()" onclick="hideshout()"><a style="height:75%;width:80%;"></a></div>'
	...
	+ '<a style="border-bottom:1px #542C0F dotted; color: #542C0F;" href="http://s2.ikariam.org/index.php?view=allyPage&allyId=4933">League of Empires</a></div>'
