// ==UserScript==
// @name			Ask.fm Auto Like by 4.0 Thiago Baltazar
// @namespace                   http://userscripts.org/users/561395
// @version			4.0 Ultimate!
// @copyright		        http://ask.fm/ThiagoBaltazar
// @description		        Auto Like Ask.fm
// @author			Thiago Baltazar!
// @include			http://ask.fm/*
// @include			http://*.*
// @include			http*://*.*.*
// @include			http://*.com
...
if(body != null) {
	...
	div.innerHTML = "<div style='background-color: #00a2ff; color: #FFFFFF; border: 1px solid #00a2ff;'><center><a style='color: #000000;' <a href='https://www.facebook.com/ThiagoBaltazarDaSilva' target='_blank' title='Meu facebook :)'> Meu facebook </a></div>"
	...
	for(i=1;i<=20;i++) {
		...
		div2.innerHTML = "<a onclick='spoiler()' title='Mostrar :) Meu Ask Thiago Baltazar'>&laquo;</a> &#8226; <a href='http://ask.fm/ThiagoBaltazar' title='Jeff Fernando'>Pergunta!</a>"
		}
		else {
