// ==UserScript==
// @name           Travian Attack Auto - MY Server
// @author         Dupd
...
// @version        1.0 BETA
// ==/UserScript==
// 08/22/2008 fedora -add translation in english to be used in MY server (line 578-581)
// 08/26/2008 fedora - grouping 2 legend of attack settings category and fix reset()(line 939-1101/ line601-624)
...
switch(sLang){
	...
	case "com":
		...
		break;
	case "my":
		text = ["Askar Dihantar..","Invalid attack!","Invalid target!","Askar Tidak Cukup! (Troops#","Serangan tidak berjaya","Hantar Askar","Salah lokasi","Tidak ada Peninjau","Askar yg telah dihantar","Attack Setting","Serangan Baru","Default Setting","Attack Setting:","Jenis Serangan:","Serangan","Bantuan","Serbuan","Tinjau sumber/askar","Tinjau askar/bangunan","Attack Target","Hantar Sekarang","","Masa tiba pada:","Set Masa Ketibaan","Bilangan Serangan","Guna <span style='color: red; font-weight: bold'>" + targetSplit + "</span> to split village、 <span style='color: red; font-weight: bold'>" + cordsSplit + "</span> to split coordinate，Eg. 0" + cordsSplit + "0" + targetSplit + "1" + cordsSplit + "1","Error:","Can't retrieve information","Masa Ketibaan askar:"];
		cataText = ["Cata Target","Auto","Kws. Pembalakan","Kuari Tanah Liat","Lombong Bijih Besi","Ladang","Kilang Papan","Kilang Bata","Kilang Besi","Pengisar Bijian","Kilang Roti","Gudang","Jelapang","Kedai Senjata","Kedai Perisai","Gelanggang Latihan","Bangunan Utama","Titik Perhimpunan","Pasar","Kedutaan","Berek","Kandang Kuda","Bengkel","Akademi","Dewan Perbandaran","Residen","Istana","Pejabat Dagangan","Berek Besar","Kandang Kuda Besar","Rumah Agama Wira","Gedung Besar","Jelapang Besar","Dunia Keajaiban"];
		break;
	case "hk":
...
1="Invalid attack!"
2="Invalid target!"
3="Askar Tidak Cukup! (Troops#"
4="Serangan tidak berjaya"
5="Hantar Askar"
6="Salah lokasi"
7="Tidak ada Peninjau"
8="Askar yg telah dihantar"
9="Attack Setting"
10="Serangan Baru"
11="Default Setting"
12="Attack Setting:"
...
15="Bantuan"
16="Serbuan"
17="Tinjau sumber/askar"
18="Tinjau askar/bangunan"
19="Attack Target"
20="Hantar Sekarang"
21="Masa Ketibaan"
22="Masa tiba pada:"
23="Set Masa Ketibaan"
24="Bilangan Serangan"
25="Guna <span style='color: red; font-weight: bold'>" + targetSplit + "</span> to split village、 <span style='color: red; font-weight: bold'>" + cordsSplit + "</span> to split coordinate，Eg. 0" + cordsSplit + "0" + targetSplit + "1" + cordsSplit + "1"
26="Error:"
27="Can't retrieve information"
28="Masa Ketibaan askar:"
*/
//attack interface
...
var table = "<table id=\"myTable\"><tr></td>#*</td>";
for (var count = startIcon;count<startIcon+9;count++) //icons
{
    table += "<td><img src=\"/img/un/u/" + count + ".gif\"></td>";
}
...
attackInterface.innerHTML = '<fieldset><legend>'+text[12]+'</legend><div id=start>' +
	...
	'<tr><td colspan="3">' +
		...
		'</select>' +
	'</td></tr><tr><td>' 
	+ waveInterfaceElement.innerHTML + '</td></tr>'
	+'<tr><td colspan="3">'+text[19]+' ' + ' <span style="font: 11px/1.5em Tahoma,Verdana,Arial !important; color:grey;">( '+text[25]+' )</span>' + '</td>'+
	'</tr><tr><td colspan="3">'+
	...
	'</td><td>'+
		'<button id=\"arrivalTime\" disabled=\"True\">'+text[21]+'</button>'+
	'</td><td>'+
	'<div id=\"arrivalTimeDiv\"></div>'+
	'</td></tr></table><tr><td colspan="3">' + text[22]+
	'</td></tr><tr><td colspan="3">'+
		'<input id=\"timedArrivalInput\" value=\"hh:mm:ss" class=\"fm\"> <button id=\"timedArrivalButton\" disabled=\"True\">'+text[23]+'</button>'+
	'</td></tr></table>';
