// ==UserScript==
// @name           Create Fashion wars invites.
// @namespace      Fashion wars friends.
// @description    Automatically invites people to your posse that you find on the fight page. Carolina altered the original code from Andy Calderbanks  "Create dragon wars invites" http://userscripts.org/scripts/show/31912
// @include        http://apps.facebook.com/fashionwarsgame/fight.php
// @include        http://apps.facebook.com/fashionwarsgame/recruit.php
// @include        http://apps.new.facebook.com/fashionwarsgame/fight.php
// @include        http://apps.new.facebook.com/fashionwarsgame/recruit.php
// ==/UserScript==
...
if ((!reqID || since > 86400) && document.location.href.indexOf('fight') != -1) {
	document.location.href = 'http://apps.'+((newlayout)?'new.':'')+'facebook.com/fashionwarsgame/recruit.php';
	return;
}
...
if (document.location.href.indexOf('fight') == -1) {
	...
	var vars = false;
	var members = document.getElementsByXPath("//a[contains(@href,'/fashionwarsgame/stats.php?user=')]");
	...
	if (vars) {
		...
		GM_xmlhttpRequest({
			method: "POST",
			url: 'http://apps.'+((newlayout)?'new.':'')+'facebook.com/fashionwarsgame/recruit.php?action=create',
