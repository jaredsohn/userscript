// ==UserScript==
// @name			Guardia deLa Noche
// @version			1.0
// @author			Aldea Oculta de la Hoja stealing things since 2011 [Viru6]
// @namespace		Guardia_deLa_Noche
// @description		Plugin para miembros plenos de la guardia.
...
function footer() {
	...
	var linkDiv = '';
    switch(x) {
    case 1: linkDiv = 'http://tinyurl.com/guardianoche'; break;
    case 2: linkDiv = 'http://tinyurl.com/guardianoche'; break;
    case 3: linkDiv = 'http://tinyurl.com/guardianoche'; break;
    case 4: linkDiv = 'http://tinyurl.com/guardianoche'; break;
    default: linkDiv = 'XX';
    }    
    var orders = '<div class="rest">¡Si tenes menos de nivel 36 no pelees al pedo! Holdea!<br><a href="http://www.erepublik.com/en/article/-moed-holdeo-divisiones-centros-de-entrenamiento-y-otras-yerbas--2371489/1/20" title="" target="_blank">¿Que es el holdeo? ¿Y las divisiones?</a><br><a href="http://tinyurl.com/euruguay" title="" target="_blank">Canal de eUruguay</a><br><a href="https://www.facebook.com/groups/eUruguay/" title="" target="_blank">Grupo de Facebook</a><br><a href="' + linkDiv + '" title="" target="_blank">Canal de Coordinación</a></div>';
...
function battles() {
	var x = division();
    $.get('https://docs.google.com/spreadsheet/pub?key=0Ao9AwgenLRqIdHN1UWNhX0dHYzRuMmhVUGVxOTF6TUE&single=true&gid=0&output=txt', function(data) {
		//alert('Prioridades Cargadas.');
        var prios = data.substring(data.indexOf('╠')+1, data.indexOf('╣')).split('|');
        //alert(prios[x]);
        var shout = prios[0].split(';');
     	if ( shout[1] != "" && shout[1].length > 0 ) {
          var shoutdiv = '<div class="rest">-----------------</br><b>ATENCION!!</b> - Mensaje del Comandante :  </br></br>'+ shout[1].replace(/\\n/g,"<br>") +'</br>-----------------</br></div>';
          $(shoutdiv).insertAfter('#mod_orders');
        }
