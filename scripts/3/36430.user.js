...
// @version        0.0.1
// @namespace      Menu GDE
// @description    Un petit menu pour les Gardiens d'Eden
...
'<div id="menu">'
+ '<ul>'
+ ' <li><h2>Gardiens Eden [GDE-GDE2]</h2>'
+ '   <ul>'
+ '     <li><center><a target="_blank" href="http://lesgde.free.fr/forums" title=" Faut etre logge auto sur le forum">Forum GDE</a></li>'
