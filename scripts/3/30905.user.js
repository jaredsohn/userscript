// ==UserScript==
// @name           MySpace - Comments With Comment Box
// @namespace      http://myspace.com/tylerabell
// @description    Adds A Comment Box To The Comments Page
// @include        http://comment.myspace.com/index.cfm?fuseaction=user.viewComments&friendID=*
// @author         Tyler_Abell (www.myspace.com/tylerabell)
// ==/UserScript==
...
// Edited the script for a comment box on myspace comments page
...
+'<textarea name="f_comments" style="width:430px;height:55px;border-width:1px;border-color:black; border-style:solid;scrollbar-face-color:FFFFFF;scrollbar-highlight-color:FFFFFF;scrollbar-3dlight-color:FFFFFF;scrollbar-shadow-color:FFFFFF;scrollbar-darkshadow-color:FFFFFF;scrollbar-arrow-color:FFFFFF;scrollbar-track-color:FFFFFF;">hey!</textarea><br />'
+'<input class="cmntbutton" name="cmntbutton" type="submit" value="Post Comment" tabindex="5" />'
+'</form>'
+'</div>';
