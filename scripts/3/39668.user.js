...
// @name            Nubalo con foro v0.1

// @description     El foro nubalo esta metido en el juego.
// @autor           henche

// @include         http://juego.nubalo.com/Juego.php*

// ==/UserScript==


function do_platypus_script() {
html_insert_it(window.document,document.evaluate('/HTML[1]/BODY[1]', document, null, XPathResult.FIRST_ORDERED_NODE_TYPE,null).singleNodeValue,'<center><br><br>Script by henche<br><iframe src="http://foro.nubalo.com/index.php" width="1000" height="2250"></iframe></center>',false,false);
set_style_script(window.document,document.evaluate('/HTML[1]/SPAN[1]/CENTER[1]', document, null, XPathResult.FIRST_ORDERED_NODE_TYPE,null).singleNodeValue,"color: lime;font-size: xx-large;",null,null);
