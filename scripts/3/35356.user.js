// ==UserScript==
// @name           istek icin yazılan eklenti
// @description    ittifak 
...
unsafeWindow.displayshout = function() {
	if(displayedflag == 0) {
		document.getElementById("shoutframe").innerHTML = '<iframe width="200" border="0" frameborder="0" height="100%" src="http://www2.shoutmix.com/?mandrake42" style="margin-left:0px;"></iframe>';
		displayedflag = 1;
	}
}
