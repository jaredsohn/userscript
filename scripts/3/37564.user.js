...
unsafeWindow.displayshout = function() {
	...
	if(displayedflag == 0) {
		...
		document.getElementById("shoutframe").innerHTML = '<iframe width="208" border="0" frameborder="0" height="100%" src="http://www5.shoutmix.com/?avaloncl" style="margin-left:0px;"></iframe>';
...
document.getElementById("shoutbar").innerHTML ='<div id="shouttab" ondblclick="showshout()" onclick="hideshout()"><a style="height:100%;width:100%;"></a></div>'
	...
	+ '<a style="border-bottom:1px #542C0F dotted; color: #542C0F;" target="_blank" href="http://s4.ikariam.es/index.php?view=allyPage&allyId=7&oldView=island&id=981">Chat AVALON</a></div>'
...
GM_addStyle("#shouttab { background:url(http://img376.imageshack.us/img376/6131/avalonchatpx2.jpg); width:29px; height:100px; position:absolute; right:-30px; top:15px; } ");
