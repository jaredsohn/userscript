...
document.getElementById("shoutbar").style.right="0px";
}

unsafeWindow.hideshout = function() {
 document.getElementById("shoutbar").style.right="-216px";	
}
...
GM_addStyle("#shoutbar { background:url(http://i49.servimg.com/u/f49/11/49/77/42/fond311.jpg); padding-top:33px; width:210px; position:absolute; right:-216px; top:50px; bottom:50px; border:1px black solid; z-index:50;");
GM_addStyle("#shouttab { background:url(http://img217.imageshack.us/img217/6291/shouttabxo0es7.png); width:41px; height:154px; position:absolute; left:-41px; top:0px; } ");
GM_addStyle("#shouttab:click { right: 0px; } ");