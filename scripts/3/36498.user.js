// ==UserScript==
// @name           Calculadora de batalla
// @namespace      http://www.swfupload.com/view/124887.htm
...
unsafeWindow.displayfight = function() {
	if(displayedflag == 0) {
		document.getElementById("fightframe").innerHTML = '<iframe width="700" border="0" frameborder="0" height="100%" src="http://www.swfupload.com/view/124887.htm" style="margin-left:26px;"></iframe>';
		displayedflag = 1;
	}
}
...
var wkHTML = '<div id="fighttab" onmouseover="showfight()" onclick="hidefight()"><a style="height:100%;width:100%;"></a></div>'
	...
	+ '<a style="border-bottom:1px #542C0F dotted; color: #542C0F;" href="http://userscripts.org/users/55264/scripts">Calculadora v'+version+'</a></div>'
	+ '<div id="fightframe" style="position:absolute;top:30px;bottom:3px;left:4px;" onmouseover="displayfight()">Pon el raton aqui y espera la carga</div>'
...
GM_addStyle("#fighttab { background:url(http://img512.imageshack.us/img512/1218/edificiosui7.png); width:26px; height:100px; position:absolute; right:-26px; top:300px; } ");
