// ==UserScript==
// @name           TrophyManager Show TrExMa on SquadFP
...
document.showPlayerSkills = function(playerRow) {
  ...
  if (tableData.length > 1) {
	...
	if (playersPositions[1] != "NIC") {
	  tableData[4].innerHTML = playersPositions[0].slice(0,playersPositions[0].indexOf(" "))+playersPositions[0].slice(playersPositions[0].indexOf(" ")+1,playersPositions[0].length)+"/"+playersPositions[1].slice(0,playersPositions[1].indexOf(" "))+playersPositions[1].slice(playersPositions[1].indexOf(" ")+1,playersPositions[1].length);
	}
	else {
	  tableData[4].innerHTML = playersPositions[0].slice(0,playersPositions[0].indexOf(" "))+playersPositions[0].slice(playersPositions[0].indexOf(" ")+1,playersPositions[0].length);
	}
