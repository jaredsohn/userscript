// ==UserScript==
// @author METHEW
// @name Darkpirates Harita Türkçe
...
if(url.match('mod=map')) {
	...
	legend = '<p style="'+poz+pa+'width: 100px; left: 360px; top: 700px;'+z+fbila+'">Harita Açıklaması:</p>';
	legend += '<p style="'+poz+pa+'width: 100px; left: 365px; top: 715px;'+z+fbila+'">Normal</p>';
	legend += '<p style="'+poz+pa+'width: 100px; left: 365px; top: 730px;'+z+fmodra+'">Laboratuar</p>';
	legend += '<p style="'+poz+pa+'width: 100px; left: 365px; top: 745px;'+z+fzelena+'">Ticaret</p>';
	legend += '<p style="'+poz+pa+'width: 100px; left: 365px; top: 760px;'+z+ffialova+'">Ana Dünya</p>';
	...
	nominerals = '<span style="'+poz+pa+'width: 70px; left: 170px; top: 700px;'+z+'"><img src="img/item/6_1k.gif"'+imga+'><span style="'+pr+fcervena+'">Demir</span></span>';	
