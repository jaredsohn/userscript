...
// @author         Me
// @description    سكربت النهب التلقائي
...
var amountSoldier0 = 10; // Phalange
var amountSoldier1 = 0; // Combatant ?  l'?©p?©
var amountSoldier2 = 0; // Eclaireur
var amountSoldier3 = 0; // Eclaire de toutatis
var amountSoldier4 = 0; // Cavalier druide
var amountSoldier5 = 0; // H?©douin
var amountSoldier6 = 0; // B?©lier
...
function addForm() {
	...
	addButton.innerHTML = "»أضافة الى حقل النهب";
...
function geefOverzicht() {
	...
	if(GM_getValue("valaan"+document.domain,0) == 0)	onoffButton.innerHTML = "حالة النهب [أغلاق]";	//http://s3.travian.lt/img/un/a/del.gif
	...
	ntd1.innerHTML = "<span class='c0'><a href='http://userscripts.org/scripts/source/35927.user.js'>تحديث النسخة</a></span>";
...
function valAan()
{
	...
	if(GM_getValue("valaan"+tekst,0) == 1)
	{
		...
		addButton.value = "النهب الاوتوماتيكي يعمل ... اضغط هنا لايقافه";
