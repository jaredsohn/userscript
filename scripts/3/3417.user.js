...
if(fixAdverts){
	...
	function do_platypus_script() {	remove_it(window.document,document.evaluate('/HTML[1]/BODY[1]/TABLE[1]/TBODY[1]/TR[1]/TD[1]/TABLE[1]/TBODY[1]/TR[1]/TD[1]', document, null, XPathResult.FIRST_ORDERED_NODE_TYPE,null).singleNodeValue,null,null,null);	};	window.addEventListener("load", function() { do_platypus_script() }, false);	function remove_it(doc, node) {	  if (doc == null || node == null) return;	  if (!node.parentNode) return;	  node.style.display = "none";	  doc.last_removed_node = node;	};}
//Fix images
if(transformImages){
var allElements, thisElement;
allAnchorElements = document.getElementsByTagName('a');
