...
function keyHandler(event) {
  ...
  if (k == 65) {
    document.location.href = 'http://92.48.103.52/fantasy/game.php?screen=EQUIPMENT&command=Remove&var1=Werewolf%20Hide%20Cloak';
  }
if (k == 66) {
    ...
    document.location.href = 'http://92.48.103.52/fantasy/game.php?screen=LOCATION&command=Move&var1=Pass%20of%20Sorl';
  } if (k == 70) {
    document.location.href = 'http://92.48.103.52/fantasy/game.php?screen=INVENTORY&command=remove&var1=Cloak%20of%20Magi';
  } if (k == 71) {
    document.location.href = 'http://92.48.103.52/fantasy/game.php?screen=INVENTORY&command=equip&var1=Werewolf%20Hide%20Cloak';
  } if (k == 72) {
    document.location.href = 'http://92.48.103.52/fantasy/game.php?screen=INVENTORY&command=equip&var1=Lesser%20Healing%20Potion';
  } if (k == 73) {
    document.location.href = 'http://92.48.103.52/fantasy/game.php?var1=Flee&var2=None&var3=%3C+100%25&var4=%3E+0&var5=%3E+0&var6=None&var7=PvPPvM&var8=100&var10=17809&command=updaterule&screen=ADVANCEDCOMBAT&Submit2=Submit';
  } if (k == 74) {
    document.location.href = 'http://92.48.103.52/fantasy/game.php?screen=EQUIPMENT&command=Remove&var1=Werewolf%20Hide%20Cloak';
  } if (k == 75) {
    document.location.href = 'http://92.48.103.52/fantasy/game.php?screen=INVENTORY&command=equip&var1=Cloak%20of%20Magi';
  } if (k == 76) {
    document.location.href = 'http://92.48.103.52/fantasy/game.php?var1=Werewolf+Hide+Cloak&var2=1&var3=6316&Submit=GO&command=Transfer&screen=TRANSFER';
  } if (k == 77) {
    document.location.href = 'http://92.48.103.52/fantasy/game.php?var1=Potion&var2=Greater+Healing+Potion&var3=%3C+30%25&var4=%3E+0&var5=%3E+0&var6=None&var7=PvPPvM&var8=100&var10=&command=updaterule&screen=ADVANCEDCOMBAT&Submit2=Submit';
  } if (k == 78) {
    ...
    document.location.href = 'http://92.48.103.52/fantasy/game.php?screen=LOCATION&command=Move&var1=Vai%20Forest';
  } if (k == 83) {
    document.location.href = 'http://92.48.103.52/fantasy/game.php?var1=Werewolf+Hide+Cloak&var2=1&var3=2090&Submit=GO&command=Transfer&screen=TRANSFER';
  } if (k == 84) {
    document.location.href = 'http://92.48.103.52/fantasy/game.php?screen=LOCATION&command=Move&var1=Woods%20of%20Vai';
  } if (k == 85) {
    document.location.href = 'http://92.48.103.52/fantasy/game.php?screen=LOCATION';
  } if (k == 86) {
    document.location.href = 'http://92.48.103.52/fantasy/game.php?var1=Greater+Healing+Potion&command=Inventory&var2=10&Submit=GO&screen=BANK';
  } if (k == 87) {
    document.location.href = 'http://92.48.103.52/fantasy/game.php?screen=LOCATION&command=Move&var1=Gorin%20Castle';
  } if (k == 88) {
    document.location.href = 'http://92.48.103.52/fantasy/game.php?screen=INVENTORY&command=equip&var1=Werewolf%20Hide%20Cloak';
  } if (k == 89) {
    document.location.href = 'http://92.48.103.52/fantasy/game.php?screen=INVENTORY&command=equip&var1=Healing%20Potion';
  } if (k == 90) {
    document.location.href = 'http://92.48.103.52/fantasy/game.php?command=swapcharacter&var1=6316';
  } if (k == 49) {
    document.location.href = 'http://92.48.103.52/fantasy/game.php?var1=Lesser+Focus+Scroll&command=Inventory&var2=5&Submit=GO&screen=BANK';
  } if (k == 50) {
    document.location.href = 'http://92.48.103.52/fantasy/game.php?var1=Lesser+Shield+Scroll&command=Inventory&var2=5&Submit=GO&screen=BANK';
  } if (k == 51) {
    document.location.href = 'http://92.48.103.52/fantasy/game.php?var1=Summon+Skeleton&command=Inventory&var2=5&Submit=GO&screen=BANK';
  } if (k == 52) {
