// ==UserScript==
// @name           Emote Plurk (version 1)
// @namespace      http://userscript.org/
// @description    Easy to insert custom smiley (or emote) on Plurk. Based on Seven Yu's Plurk Smile 4.6 with more emote and in Bahasa Indonesia
