// ==UserScript==
// @name           Travian: Village Manager for ML&C
// @version        1.0.0
// @description    Modify for using probably with Travian3 Beyond - ML&CN
// @author         Mario Cheng
// @email          chenghokwan@hotmail.com
// @date           2008-10-25
// @namespace      travian
// @source         http://userscripts.org/scripts/show/35991
// @identifier     http://userscripts.org/scripts/source/35991.user.js
...
var SCRIPT = {
	url: 'http://userscripts.org/scripts/source/35991.user.js',
	version: '1.0.0'
};
...
function makeEventVillageStats(villageName, villageId, cValue, coordX, coordY)
{
	...
	celltxt.href = 'karte.php?d='+villageId+'&c='+cValue+'&qplinks=false';
