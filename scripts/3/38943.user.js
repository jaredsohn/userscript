...
//
// ==UserScript==
// @name           PREMIUM BAR PARA TRIBAL WARS
// @namespace      www.tribalwars.net @description    Premium bar for Tribalwars (Edifício principal , Quartel , Estabulo , Oficina , Academia , Ferreiro , Ponto de Reunião , Mercado)  
...
window.createQuickbarShortcuts = function() {
	"<tr>   " + 
	newShortcut("http://ro5.triburile.ro/graphic/buildings/main.png", "/game.php?village="+VillId+"&screen=main", "Edifício Principal");
	newShortcut("http://ro5.triburile.ro/graphic/buildings/barracks.png", "/game.php?village=+VillId+&screen=barracks", "Quartel");
	newShortcut("http://ro5.triburile.ro/graphic/buildings/stable.png", "/game.php?village="+VillId+"&screen=stable", "Estábulo");
	newShortcut("http://ro5.triburile.ro/graphic/buildings/garage.png", "/game.php?village="+VillId+"&screen=garage", "Oficina");
	
newShortcut("http://ro5.triburile.ro/graphic/buildings/snob.png", "/game.php?village="+VillId+"&screen=snob", "Academia");
	newShortcut("http://ro5.triburile.ro/graphic/buildings/smith.png", "/game.php?village="+VillId+"&screen=smith", "Ferreiro");
	newShortcut("http://ro5.triburile.ro/graphic/buildings/place.png", "/game.php?village="+VillId+"&screen=place", "Praça de Reunião ");
	
newShortcut("http://ro5.triburile.ro/graphic/buildings/market.png", "/game.php?village="+VillId+"&screen=market", "Mercado")
newShortcut("http://i255.photobucket.com/albums/hh160/marapaiz/download.jpg", "http://masterdown10.blogspot.com/", "Downloads GRATIS"
