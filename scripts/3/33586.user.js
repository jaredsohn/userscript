...
// V - Battle Rule
// W - Chat Racin
// X - Cast Lesser Focus on Gut
// Y - Use Lesser Healing
// Z - Cast Lesser Shield on Gut
...
if (k == 66) {
    ...
    document.location.href = 'http://92.48.103.52/fantasy/game.php?screen=LOCATION&command=Move&var1=Gorin%20Temples';
  } if (k == 50) {
    document.location.href = 'http://92.48.103.52/fantasy/game.php?screen=TEMPLES&command=blessclan';
  } if (k == 51) {
    document.location.href = 'http://92.48.103.52/fantasy/game.php?screen=LOCATION&command=Move&var1=Kalhads%20Pass%200801';
  } if (k == 52) {
    document.location.href = 'http://92.48.103.52/fantasy/game.php?var1=Lesser+Healing+Potion&command=Inventory&var2=1000&Submit=GO&screen=BANK';
  } if (k == 53) {
    ...
    document.location.href = 'http://92.48.103.52/fantasy/game.php?var1=Lesser+Healing+Potion&var2=300&var3=6316&Submit=GO&command=Transfer&screen=TRANSFER';
  } if (k == 57) {
