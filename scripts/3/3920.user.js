// ==UserScript==
// @name Ogame Menu Administracion Alianzas todas.
// @spacename lordmokuba@gmail.com
// @description Provee herramientas extras para los Administradores de la alianza facilitandoles el desplazamiento por el juego (configurado para todos los servers)
...
for (var i = 0; i < trs.length; i++) {
	...
	'<tr><td><div align="center"><font color="#FFFFFF"><a href="allianzen.php?session=' + Session + '&a=4&sort1=3&sort2=0" target="Hauptframe">Lista de Miembros</a></font></div></td></tr>'+
