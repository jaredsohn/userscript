...
'http://92.48.103.52/fantasy/game.php?var5=4462&var1=Lesser+Focus+Scroll&command=use&screen=SCROLLS';
    ...
    document.location.href =
"http://92.48.103.52/fantasy/game.php?var5=4462&var1=Shield+Scroll&command=use&screen=SCROLLS";
  }
else if(k==53) {
    document.location.href =
"http://92.48.103.52/fantasy/game.php?var5=4462&var1=Focus+Scroll&command=use&screen=SCROLLS";
  }
else if(k==57) {
