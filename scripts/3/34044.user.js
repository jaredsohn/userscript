...
// ==/UserScript==
	var FFBetaPlus_version = "0.2a";

	var defaultTabs = new Array();

	defaultTabs[0] = new Object();
	defaultTabs[0].name = "FaceBook";
	defaultTabs[0].url = "http://facebook.com/";
	defaultTabs[0].favicon = "http://facebook.com/favicon.ico";
	...
	Settingsobject.prototype.get=function(name){
	  ...
	  if(value.indexOf("{b}")==0)
	    return !!parseInt(value.substr(9));
	  if(value.indexOf("{n}")==0)
	    return parseFloat(value.substr(9));
	...
	(function() {
	  ...
	  autoUpdateFromUserscriptsDotOrg({
		name: 'FFBetaPlus',
		url: 'http://userscripts.org/scripts/source/34044',
		version: FFBetaPlus_version,
	});	 	
	  ...
	  function showOptions() {	
		...
		if (div2==null)
		{
			...
			var text1="";
			text1+="<center><font size=\"+1\">FFBetaPlus</a> Options</font><br>By:&nbsp;<a href=\"http://gridempire.com\" target=\"_blank\">Grid Empire</a></center>";
	  ...
	  function tab_setup(name, url, favicon) {
		...
		$('.account').before('<td class="l_tab" style="padding-right: 3px;" id="tdtabtm"><div class="rounded bb" id="tabtm"><div class="t"><div class="l"><div class="r"><div class="tl"><div class="tr"><div class="body"><a id="tab-link-' + tabLink + '" href="#"><img width=16 height=16 src="' + favicon  + '"></a></div></div></div></div></div></div></div></td>');
	  ...
	  function lets_jquery() {
		GM_registerMenuCommand('FFBetaPlus', showOptions);
