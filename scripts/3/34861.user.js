...
GM_addStyle("#conExtraDiv3                                                     {background-image:url("+URL+"bg/design.png); position: absolute; width: 96px; height: 78px; left: -42px; top: 4px}");
GM_addStyle("#conExtraDiv4                                                     {background-image:url("+URL+"bg/design_bg.png); position: absolute; width: 205px; height: 129px; left: -174px; top: 20px}");
/* colored banner at the top of the page */
GM_addStyle("#GF_toolbar *                                                     {color: #193f00; top: 1px; left: -73px; text-decoration: none}");
GM_addStyle("#GF_toolbar *:hover, #GF_toolbar .premium a .textLabel            {color: #46a600}");
GM_addStyle("#GF_toolbar .premium a .textLabel:hover                           {color: #000000}");
...
GM_addStyle("#advisors #advCities a.normalactive                               {background-image:url("+URL+"mainview/adv_city.png); background-position: 0px -216px; margin: -2px 0px 0px  0px; font-weight: bold; color: #193f00}");
GM_addStyle("#advisors #advCities a.normalactive:hover                         {background-image:url("+URL+"mainview/adv_city.png); background-position: 0px -324px; margin: -2px 0px 0px  0px; font-weight: bold; color: #193f00}");
...
GM_addStyle("#advisors #advCities a.premiumactive                              {background-image:url("+URL+"mainview/adv_city.png); background-position: 0px -216px; margin: -2px 0px 0px  0px; font-weight: bold; color: #193f00}");
GM_addStyle("#advisors #advCities a.premiumactive:hover                        {background-image:url("+URL+"mainview/adv_city.png); background-position: 0px -324px; margin: -2px 0px 0px  0px; font-weight: bold; color: #193f00}");
...
GM_addStyle("#advisors #advMilitary a.normalactive                             {background-image:url("+URL+"mainview/adv_military.png); background-position: 0px -216px; margin: -2px 0px 0px  0px; font-weight: bold; color: #193f00}");
GM_addStyle("#advisors #advMilitary a.normalactive:hover                       {background-image:url("+URL+"mainview/adv_military.png); background-position: 0px -324px; margin: -2px 0px 0px  0px; font-weight: bold; color: #193f00}");
...
GM_addStyle("#advisors #advMilitary a.premiumactive                            {background-image:url("+URL+"mainview/adv_military.png); background-position: 0px -216px; margin: -2px 0px 0px  0px; font-weight: bold; color: #193f00}");
GM_addStyle("#advisors #advMilitary a.premiumactive:hover                      {background-image:url("+URL+"mainview/adv_military.png); background-position: 0px -324px; margin: -2px 0px 0px  0px; font-weight: bold; color: #193f00}");
...
GM_addStyle("#advisors #advResearch a.normalactive                             {background-image:url("+URL+"mainview/adv_research.png); background-position: 0px -216px; margin: -2px 0px 0px  0px; padding: 0 0 0 1px; font-weight: bold; color: #193f00}");
GM_addStyle("#advisors #advResearch a.normalactive:hover                       {background-image:url("+URL+"mainview/adv_research.png); background-position: 0px -324px; margin: -2px 0px 0px  0px; padding: 0 0 0 1px; font-weight: bold; color: #193f00}");
...
GM_addStyle("#advisors #advResearch a.premiumactive                            {background-image:url("+URL+"mainview/adv_research.png); background-position: 0px -216px; margin: -2px 0px 0px  0px; padding: 0 0 0 1px; font-weight: bold; color: #193f00}");
GM_addStyle("#advisors #advResearch a.premiumactive:hover                      {background-image:url("+URL+"mainview/adv_research.png); background-position: 0px -324px; margin: -2px 0px 0px  0px; padding: 0 0 0 1px; font-weight: bold; color: #193f00}");
...
GM_addStyle("#advisors #advDiplomacy a.normalactive                            {background-image:url("+URL+"mainview/adv_diplomacy.png); background-position: 0px -216px; margin: -2px 0px 0px -1px; padding: 0 0 0 3px; width: 88px; font-weight: bold; color: #193f00}");
GM_addStyle("#advisors #advDiplomacy a.normalactive:hover                      {background-image:url("+URL+"mainview/adv_diplomacy.png); background-position: 0px -324px; margin: -2px 0px 0px -1px; padding: 0 0 0 3px; width: 88px; font-weight: bold; color: #193f00}");
...
GM_addStyle("#advisors #advDiplomacy a.premiumactive                           {background-image:url("+URL+"mainview/adv_diplomacy.png); background-position: 0px -216px; margin: -2px 0px 0px -1px; padding: 0 0 0 3px; width: 88px; font-weight: bold; color: #193f00}");
GM_addStyle("#advisors #advDiplomacy a.premiumactive:hover                     {background-image:url("+URL+"mainview/adv_diplomacy.png); background-position: 0px -324px; margin: -2px 0px 0px -1px; padding: 0 0 0 3px; width: 88px; font-weight: bold; color: #193f00}");
...
GM_addStyle(".militaryAdvisorTabs #tabz td.selected a                                   {background-image:url("+URL+"content/contentbox_militaryover.png); color: #193f00}");
GM_addStyle(".militaryAdvisorTabs #tabz td a:hover                                      {background-image:url("+URL+"content/contentbox_militaryover.png); color: #46a600; text-decoration: none}");
...
GM_addStyle("div.diplomacyAdvisorTabs #tabz td a                               {color: #193f00}");
GM_addStyle("div.diplomacyAdvisorTabs #tabz td a:hover                         {color: #46a600; text-decoration: none}");
...
GM_addStyle("#highscore #mainview div.content table.table01 tr.own             {background-color: #96ff00; color: #000000}");
...
GM_addStyle(".yui-navset .yui-nav .selected a                                  {background-image:url("+URL+"content/contentbox_hideoutover.png); margin-left: 25px; color: #193f00}");
GM_addStyle(".yui-navset .yui-nav a:hover                                      {background-image:url("+URL+"content/contentbox_hideoutover.png); color: #46a600; text-decoration: none}");
...
GM_addStyle("#CityOverview h3 a                                                {background-image:url("+URL+"hardcode/invisible.png); color: #96ff00; margin-top: -6px; width: 40px}");
GM_addStyle("#CityOverview h3 a:hover                                          {background-image:url("+URL+"hardcode/invisible.png); color: #46a600}");
...
GM_addStyle("#SatisfactionOverview .basic .base                                {background-image:url("+URL+"mainview/graph_basic.png); border: none; background-position: left; color: #193f00}");
...
unsafeWindow.qbbuildinterior = function()
{
    ...
    if(unsafeWindow.places != "0")
    {
        ...
        for(i = 0; i < splitplaces.length-1; i++){
            ...
            if(i>0){
            qbHTML += '<a title="Move Quickmark Up" href="javascript:qbmoveup(\'' + placepiece[0] + '|' + placepiece[1] + ';\');"><img src="http://www.ikariamods.com/gunmetal/cadmium/content/btn_increase.png" border="0"></a>';
            }
            else {
            ...
            qbHTML += '<a title="Move Quickmark Down" href="javascript:qbmovedown(\'' + placepiece[0] + '|' + placepiece[1] + ';\');"><img src="http://www.ikariamods.com/gunmetal/cadmium/content/btn_decrease.png" border="0"></a>';
            }
            else {
            qbHTML += '<img src="http://www.imgboot.com/images/enigmabrand/movetrans.png" height="10" width="10" border="0">';
            }
            qbHTML += '<a title="Delete Quickmark" href="javascript:qbdeleteentry(\'' + placepiece[0] + '|' + placepiece[1] + ';\');"><img src="http://www.ikariamods.com/gunmetal/cadmium/content/delete.png" border="0"></a>';
            qbHTML += ' <a title="Rename Quickmark" href="javascript:qbrenameentry(\'' + placepiece[0] + '|' + placepiece[1] + ';\');"><img src="http://www.ikariamods.com/gunmetal/cadmium/content/rename.png" border="0"></a>-</td>';
    ...
    qbHTML += '<a href="javascript:qbexport();" title="Export list"><img src="http://www.ikariamods.com/gunmetal/cadmium/content/btn_increase.png" border="0"></a>';
    qbHTML += ' <a href="javascript:qbimport();" title="Import list (append)"><img src="http://www.ikariamods.com/gunmetal/cadmium/content/btn_decrease.png" border="0"></a>';
    qbHTML += ' <a href="javascript:qbdeleteall();" title="Delete all quickmarks"><img src="http://www.ikariamods.com/gunmetal/cadmium/content/delete.png" border="0"></a>';
    qbHTML += '</div>';
    qbHTML += '<div id="qfoot"></div>';
    document.getElementById("quickbar").innerHTML = qbHTML;
}

GM_addStyle("#qhead          {background:url(http://www.ikariamods.com/gunmetal/cadmium/bg/notebar_header.png); position: absolute; height: 21px; width: 282px; line-height: 20px; font-weight: bold; font-size: 11px; background-repeat: no-repeat; border-right: 2px double #000000}");
GM_addStyle("#quicktab       {background:url(http://www.ikariamods.com/gunmetal/cadmium/bg/quickbar_title.png); position: absolute; height: 85px; width: 17px; left: 284px}");
GM_addStyle("#quickbar       {width: 284px; position: absolute; left: -284px; height: 228px; top: 129px; z-index: 150; background-color: #d2d2d2; background:url(http://www.ikariamods.com/gunmetal/cadmium/bg/quickbar_title.png)}");
GM_addStyle("#quickbar:hover {width: 284px; left: 0px; background:url(http://www.ikariamods.com/gunmetal/cadmium/bg/quickbar.png); background-repeat: no-repeat}");
...
GM_addStyle("#nhead         {background:url(http://www.ikariamods.com/gunmetal/cadmium/bg/notebar_header.png); position: absolute; height: 21px; width: 343px; line-height: 20px; font-weight: bold; font-size: 11px; background-repeat: no-repeat}");
GM_addStyle("#notetab       {background:url(http://www.ikariamods.com/gunmetal/cadmium/bg/notebar_title.png); position: absolute; height: 85px; width: 17px; left: 345px}");
GM_addStyle("#notebar       {width: 345px; position: absolute; left: -345px; height: 228px; top: 36px; z-index: 150; background-color: #d2d2d2; background:url(http://www.ikariamods.com/gunmetal/cadmium/bg/notebar_visible.png)}");
GM_addStyle("#notebar:hover {width: 345px; left: 0px; background:url(http://www.ikariamods.com/gunmetal/cadmium/bg/notebar.png); background-repeat: no-repeat}");
...
scriptName='Gunmetal Ikariam (Cadmium Edition)';
scriptId='34861';
scriptVersion=0.86;
scriptUpdateText='For a full list of changes visit: http://userscripts.org/scripts/show/34861';
...
GM_addStyle("#gm_update_alert                      {background-image:url(http://www.ikariamods.com/gunmetal/cadmium/bg/sidebox_header.png); position: fixed; z-index:100000; top: "+((winH/2)-160)+"px; left: "+((winW/2)-200)+"px; width: 224px; background-repeat: no-repeat; background-position: -2px -2px; background-color: #131c23; padding-top: 2px; text-align: left; border: 2px double #000000}");
GM_addStyle("#gm_update_alert_buttons              {position: relative; top: -5px; margin: 7px}");
GM_addStyle("#gm_update_alert_button_close         {background-image:url(http://www.ikariamods.com/gunmetal/cadmium/misc/button.png); font-weight: bold; font-size: 11px; width: 35px; height: 14px; position: absolute; top: 112px; left: 84px; padding: 3px 6px 3px 6px; z-index: inherit; color: #000000; cursor:pointer}");
...
GM_addStyle("#gm_update_alert_buttons span a:hover {text-decoration:none; color: #d80000; font-weight: bold; cursor:pointer}");
                ...
                +'  <center><b><font color="#000000">Gunmetal Ikariam (Cadmium Edition)</font></b><br><br>'
