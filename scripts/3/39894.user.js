...
// @name		Travian Trooptool Updater BA
...
var LOG_LEVEL = 2; // 0 - quiet, 1 - nearly quite, 2 - verbose, 3 - detailed
var sLang = "ba";
var sGetParameters = "";
...
function promptKey() {
	...
	if(re.test(newKey)) {
		...
		setVariable("TTU_KEY", newKey);
			_log(2, "zadana NEplatna adresa!xx");
	}
		_log(3, "<--promptKey");
}
