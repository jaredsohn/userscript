...
var htmlQuoteB = "<div style='background: #C8E1FF; border: 2px LightSkyBlue solid; color: black; font-size: 100%; margin-left: 20px; margin-right: 35px; padding: 2px 3px 2px 3px'>";
var htmlQuoteE = "</div>";
var htmlHeaderB = "<div style='font-size: 100%'>Quote (";
var htmlHeaderE = ")</div>";
