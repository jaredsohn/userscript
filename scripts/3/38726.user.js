// ==UserScript==
// @name            TGDaily_Barebones
// @namespace       Platypus
// @include         http://www.tgdaily.com/html_tmp/*
// @include         http://www.tgdaily.com/content/*
// ==/UserScript==
function do_platypus_script() {
remove_it(window.document,document.getElementById('banner'),null,null,null);
remove_it(window.document,document.getElementById('search'),null,null,null);
remove_it(window.document,document.getElementById('nav'),null,null,null);
remove_it(window.document,document.getElementById('left_padding'),null,null,null);
remove_it(window.document,document.getElementById('right'),null,null,null);
remove_it(window.document,document.getElementById('home-menu'),null,null,null);
remove_it(window.document,document.getElementById('horiz-menu'),null,null,null);
remove_it(window.document,document.getElementById('written_comments_title'),null,null,null);
remove_it(window.document,document.getElementById('commentTools'),null,null,null);
remove_it(window.document,document.getElementById('right_banner'),null,null,null);
remove_it(window.document,document.getElementById('jc_commentsDiv'),null,null,null);
remove_it(window.document,document.getElementById('jc_commentFormDiv'),null,null,null);
remove_it(window.document,document.getElementById('comments'),null,null,null);
remove_it(window.document,document.getElementById('jc_busyDiv'),null,null,null);
remove_it(window.document,document.getElementById('write_comment_title'),null,null,null);
remove_it(window.document,document.getElementById('dealalertz-widget'),null,null,null);
remove_it(window.document,document.getElementById('user2'),null,null,null);
remove_it(window.document,document.getElementById('mod_search_searchword'),null,null,null);
remove_it(window.document,document.getElementById('footer'),null,null,null);
remove_it(window.document,document.getElementById('footer_mod'),null,null,null);
remove_it(window.document,document.getElementById('mainlevel'),null,null,null);
set_style_script(window.document,document.getElementById('header'),"height: 94px;",null,null);
do_modify_html_it(window.document,document.evaluate('/HTML[1]/BODY[1]/DIV[1]/DIV[3]/DIV[3]/TABLE[2]/TBODY[1]/TR[4]/TD[1]', document, null, XPathResult.FIRST_ORDERED_NODE_TYPE,null).singleNodeValue,/.*BEGIN: Constant Contact Basic Opt-in Email List Form.*\n.*\n.*\n.*\n.*\n.*\n.*\n.*\n.*\n.*\n.*\n.*\n.*\n.*\n.*\n.*\n.*\n.*\n.*\n.*\n.*\n.*\n.*\n.*\n.*\n.*\n.*\n.*\n.*\n.*\n.*\n.*\n.*\n.*\n.*\n.*\n.*END: Constant Contact Basic Opt-in Email List Form.*\n/i,'',null);
do_modify_html_it(window.document,document.evaluate('/HTML[1]/BODY[1]/DIV[1]/DIV[3]/DIV[3]/TABLE[1]', document, null, XPathResult.FIRST_ORDERED_NODE_TYPE,null).singleNodeValue,/.*\<td.*class="buttonheading".*\n.*\n.*\n.*\<\/td\>*\n/gi,'',null);
do_modify_html_it(window.document,document.evaluate('/HTML[1]/BODY[1]/DIV[1]/DIV[3]/DIV[3]/TABLE[2]/TBODY[1]', document, null, XPathResult.FIRST_ORDERED_NODE_TYPE,null).singleNodeValue,/.*\<tr\>\n.*\<td.*\>\n.*\n.*\n.*\n.*\<\/tr\>.*\n/i,'',null);
do_modify_html_it(window.document,document.getElementById('content_lr'),/.*\<iframe src="http:\/\/digg.com.*\n.*\n.*\n.*\n.*\n.*\n.*\n.*\n.*\n.*\<\/table\>/i,'',null);
do_modify_html_it(window.document,document.evaluate('/HTML[1]/BODY[1]/DIV[1]/DIV[3]/DIV[3]/TABLE[2]/TBODY[1]/TR[3]/TD[1]', document, null, XPathResult.FIRST_ORDERED_NODE_TYPE,null).singleNodeValue,/\<!-- Input form end --\>\<br\>.*\n/i,'',null);
do_modify_html_it(window.document,document.getElementById('content_lr'),/.*\<iframe.*id="dealalertz-widget".*\n/i,'',null);
do_modify_html_it(window.document,document.getElementById('content_lr'),/.*\<span.*class="article_seperator".*\n.*\n.*\n.*Back.*\n.*\n/i,'',null);
do_modify_html_it(window.document,document.evaluate('/HTML[1]/BODY[1]', document, null, XPathResult.FIRST_ORDERED_NODE_TYPE,null).singleNodeValue,/.*\<div.*class="bottom_page".*/i,'',null);
do_modify_html_it(window.document,document.evaluate('/HTML[1]/BODY[1]', document, null, XPathResult.FIRST_ORDERED_NODE_TYPE,null).singleNodeValue,/.*\<span.*style="color: rgb\(255, 255, 255\);".*\n.*\n.*\n.*\n.*\<\/span\>\n/i,'',null);
relax(window.document,document.getElementById('inner_wrapper'),null,null,null);
