//
// Hebrew Translation to Score Linker
// I just edit this very good Spanish script, translating it and making it work in Ikariam Israel
// All the original credit goes to the author below
// 
// 
//
// version 0.5.7
...
//
// ==UserScript==
// @name           IkariamScoreLinkerHebrew
// @namespace      ikariamScript
// @description    Adds a link to the Scoreboard besides a players name after selecting their town on the Island Overview or when viewing their Town. (Hebrew)
...
function displayOnOptions_fn() {
    ...
    mybox.setAttribute("style", "text-align: right;");
      ...
      if (whatToShow != 0) { // If the value of this is 0, then nothing is to be displayed.
        ...
        if (whatToShow in {1:'', 3:'', 5:'', 7:''}) { //Show Total Score Link
            if (inlineScore == false) { // Show only link
                ...
                scoreMainCont.innerHTML = scoreMainCont.innerHTML + "<div style=\"clear: both;\"></div><span style=\"font-weight: normal; margin-top: 3px;\" class=\"textLabel\">ניקוד:</span><span style=\"float: right; font-weight: normal; margin-top: 3px;\" id=\"bod_tot_score\">טוען...</span>";
        ...
        if (whatToShow in {2:'', 3:'', 6:'', 7:''}) { // Show Military Score Link
            if (inlineScore == false) { // Show only link
                ...
                scoreMainCont.innerHTML = scoreMainCont.innerHTML + "<div style=\"clear: both;\"></div><span style=\"font-weight: normal; margin-top: 3px;\" class=\"textLabel\">גנרלים:</span><span style=\"float: right; font-weight: normal; margin-top: 3px;\" id=\"bod_mil_score\">טוען...</span>";
        ...
        if (whatToShow in {4:'', 5:'', 6:'', 7:''}) { // Show Military Score Link
            if (inlineScore == false) { // Show only link
                ...
                scoreMainCont.innerHTML = scoreMainCont.innerHTML + "<div style=\"clear: both;\"></div><span style=\"font-weight: normal; margin-top: 3px;\" class=\"textLabel\">זהב:</span><span style=\"float: right; font-weight: normal; margin-top: 3px;\" id=\"bod_mon_score\" align=right>טוען...</span>";
