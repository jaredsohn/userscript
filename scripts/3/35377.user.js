...
February 8, 2009
Copyright (c) 2006–09, Joe Lencioni
...
Hungarian Lőrincz Attila (http://codemonkey.blogter.hu)
	...
	*/
	searchDefs : [
		...
		*/
		...
		{
			name				: 'doubanpic',
			includeRegExp		: /^http:\/\/movie\.douban\.com\/subject\/[0-9]+\//i,
		...
		// douban_subject_photos
		{
			name				: 'douban_subject_photos',
			includeRegExp		: /^http:\/\/movie\.douban\.com\/subject\/[0-9]+\/photos/i,
			linkRegExp			: /^http:\/\/movie\.douban\.com\/photos\/photo\/([0-9]+)\/$/i,
			replaceString		: 'http://t.douban.com/view/photo/photo/public/p$1.jpg',
			showFunction		: function(event) { greasedLightbox.showFrom(event, 'douban_subject_photos'); return false; }
		}, // douban_subject_photos
