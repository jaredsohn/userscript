        ...
        this.initialize = function(browserWin) {
            try {
                ...
                */
                ...
                craigslist.fusion.Utilities.createStyle(this.browserWin.document, "ul", "{list-style: disc !important; padding: 5 !important;}");

                craigslist.fusion.Utilities.createStyle(this.browserWin.document, "ul.ul, ol.ol", "{list-style: disc !important; padding: 5 !important;}");

                craigslist.fusion.Utilities.createStyle(this.browserWin.document, "ul li", "{padding-left: 5px !important; margin-left: 5px !important; list-style: circle !important; list-style-type: circle !important; }");

                craigslist.fusion.Utilities.createStyle(this.browserWin.document, ".liCssStyle", "{ padding-left: 5px !important; margin-left: 5px !important; list-style: disc !important; list-style-type: disc !important; }");
        ...
        this.modifyListing = function() {
            try {
                ...
                for (i = 0; i < cookies.length; i++) {
                    ...
                    //console.log("name: " + name + ", value: " + unescape(value));
                ...
                if (queryMap.get("useMap") == "1") {
                    ...
                    return;
                } else if (queryMap.get("altView") == "imggrid" || (typeof cookieMap.get("cl_img") != "undefined" && 
                        (unescape(cookieMap.get("cl_img")) == "sss:list,hhh:grid" || unescape(cookieMap.get("cl_img")) == "sss:grid,hhh:list"))) {
                        this.showImages = false;
                ...
                if (responseText) {
                    ...
                    */
                    ...
                    if (typeof location != "undefined" && location != null) {
                        if (subject.toLowerCase().indexOf(location[1].toLowerCase()) < 0) {
                            lastNode = newTextNextTo(" - " + location[1], lastNode);
                        }
                    }
                    ...
                    if (matches) {
                        ...
                        if (this.doShowGridViewImageIcons) {
                            var p = craigslist.fusion.Utilities.searchParent(link, "P", {"class": "row"});
                            if (p) {
                                var gridImage = craigslist.fusion.Utilities.findNode(p, "img");
                                if (gridImage) {
                    ...
                    if (this.showPreviewText && this.preferences.getShowTextPreview().getValue()) {
                        ...
                        subDetailText = craigslist.fusion.Utilities.parseEntity(subDetailText);
    ...
    */
        ...
        */
        ...
        this.renderDetailArea = function(link, detailArea, detailText, location, advInfo, doc) {
            ...
            if (typeof location != "undefined" && location != null) {
                if (subjText.toLowerCase().indexOf(location[1].toLowerCase()) < 0) {
                    subjText += " - " + location[1];
                }
            }
        ...
        this.showDriveToInGoogleMap = function(evt, toLocation, fromLocation) {
            ...
            var address;
            try {
                var location = toLocation[0];
                /*
                if (craigslist.fusion.Utilities.isEmpty(toLocation[1], false) == false) {
                    var modLoc = craigslist.fusion.Utilities.trimText(toLocation[1].toLowerCase());
                ...
                if (this.preferences.getUseEmbeddedMapWindow().getValue()) {
                    address = "http://maps.google.com/maps?output=embed&saddr=" + fromLocation + "&daddr=" + escape(location);
                    this.googleMap.setVisible(true);
                    craigslist.fusion.Utilities.removeAllChildren(this.googleMap.contentArea);
                    var frame = craigslist.fusion.Utilities.addNew("iframe", this.googleMap.contentArea);
                    frame.setAttribute("height", "100%");
    ...
    craigslist.fusion.CraigslistPreferences = function() {
        ...
        */
        ...
        component = new craigslist.fusion.ui.TextField("entryGradientColor2", "Entry Background Gradient Color:");
        var entryGradientColor = this.prefList[this.prefList.length] = new craigslist.fusion.Preference(null, component, "#EFEFDE");
