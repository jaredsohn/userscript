// ==UserScript==
// @name            HƯỚNG DẪN CÁC BẠN CẬP NHẬT CHỨC NĂNG ICON CỰC ĐẸP M9X.VN
...
"chars" : " :) ",
	...
	html += '<span style="vertical-align: middle;"><img src="http://m9x.vn/logo.png"></img></span>';
	html += '</a>';
    ...
    html += '<a class="jewelFooter" href="http://m9x.vn" target="_blank">Wap tải game, Tải nhạc MP3 cho điện thoại Android, iOs, Java và Symbian miễn phí<br><b style="color:#f00">M9X.VN</b></a>';
	html += '</div>';
