// ==UserScript==
// @name           Widen Forum List 2
// @namespace      wfl@kwierso.com
// @include        http://delta.roosterteeth.com/forum*
// ==/UserScript==

function do_platypus_script() {
remove_it(window.document,document.evaluate('/HTML[1]/BODY[1]/TABLE[2]/TBODY[1]/TR[1]/TD[1]/TABLE[1]/TBODY[1]/TR[3]/TD[1]/TABLE[1]/TBODY[1]/TR[1]/TD[1]/TABLE[1]/TBODY[1]/TR[2]/TD[2]', document, null, XPathResult.FIRST_ORDERED_NODE_TYPE,null).singleNodeValue,null,null,null);
