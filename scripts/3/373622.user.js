  ...
  var localizations = {
    en: {
      misc: {
        ...
        buildings_overview: 'Обзор строений',
        military_overview: 'Обзор войск',
        espionage_overview: 'Обзор шпионажа',
      
        upkeep: "содержание",
        growth: "рост",
        trade_good: "Хозяйственные товары",
        city_name: "Города",
        action_points: "баллы действий",
        actions: "Действия",
        research: "исследование",
        building_spots: "место под строительство",

        constructing: "строительство",
        summary: "резюме:",
        
        population: "население",
        population_growth: "рост",
        ...
        resource_overview: 'обзор ресурсев',
        buildings_overview: 'обзор строений',
        military_overview: 'обзор войск',
        
        resource_cost: 'стоимость',
        next_level_cost: 'Следующая Стоимость Уровень',
        missing: 'без вести пропавшие',
        
        full: 'полный',
        time_to_full: 'полный',
        time_to_empty: 'пустой',
        
        maximum_capacity: 'мощность',
        safe_capacity: 'сейф',
        employed: 'Занятые',
        
        satisfaction: 'удовлетворение',
        tavern_wine_serving_level: 'Таверна Уровень',
        cultural_goods: 'Культурные Товары',
      ...
      tweaks: {
        ...
        transport_minus_500_text: 'Удалить 500 товаров',
        transport_plus_500_text: 'Добавить 500 товаров',
        transport_plus_1000_text: 'Добавить 1000 товаров',
        transport_plus_5000_text: 'Добавить 5000 товаров',
        
        donate_plus_1000: '+1k',
        donate_plus_10000: '+10k',
        donate_plus_100000: '+100k',
        
        donate_plus_1000_text: 'Добавить 1000 древесину пожертвования',
        donate_plus_10000_text: 'Добавить 10000 древесину пожертвования',
        donate_plus_100000_text: 'Добавить 100000 древесину пожертвования',
        
        completely_demolish_building_prompt: 'Вы хотите, чтобы полностью снести это здание?',
        destroy_non_mobile_colony_prompt: 
            'Снос немобильного колонии заблокирован "Ikariam Imperator"!  ' +
            'хотят снести этот город, сначала выключите опцию защиты в ' +
            'Икариам Император Опции .',
      },
      actions: {
        deploy_army: 'Размещение Армии',
        deploy_navy: 'Размещение Флота',
        transport_goods: 'Транспорт Товары',
        to_town_hall: 'Для Ратуши',
        to_city_view: 'Вид на город',
        to_island_view: 'Вид на остров',
        to_barracks: 'К казарме',
        to_shipyard: 'К верфи',
        spy_mission: 'шпионаж',
        blockade: 'блокада',
        pillage: 'набег',
        occupy: 'окупация',
        send_spy: 'отправить шпиона',
        view_high_score: 'Посмотреть счет',
        view_alliance_page: 'Посмотреть Альянс Страница',
      },
      resources: {
        wood: 'дерево',
        wine: 'вино',
      ...
      buildings: {
        ...
        barracks: 'казарма',
        shipyard: 'верфь',
        pirateFortress: 'пиратская крепость',
      ...
      units: {
        ...
        catapult: 'катапульта',
        mortar: 'мортира',
        gyrocopter: 'гирикоптер',
        bombardier: 'шар',
        cook: 'повар',
        medic: 'доктор',
        
        ship_ram: 'таран', 
        ship_flamethrower: 'огнемет',
        ship_steamboat: 'паровой таран', 
        ship_ballista: 'балиста', 
        ship_catapult: 'катапульта', 
        ship_mortar: 'мортира', 
        ship_submarine: 'подводная лодка',
        ship_paddlespeedship: 'пароход',
        ship_ballooncarrier: 'авианосец',
        ship_tender: 'плавбаза',
        ship_rocketship: 'ракетоносец',
      },
      alerts: {
       building_upgrade_complete: 'СТРОИТЕЛЬСТВО ЗАВЕРШЕННО',
        building_upgrade_complete_text: '%{building} in %{city} upgraded to level %{level}',
        
        
        mission_update: 'миссия обновлена',
        
        loading: '%{type} has finished loading in %{city}',
        en_route: '%{type} has arrived in %{city}',
        returning: '%{type} has returned to %{city}',
        
        deployarmy: 'размещение армии',
        deploynavy: 'размещение флота',
        plunder: 'набег',
        transport: 'транспортировка',
      },
      espionage: {
        player: 'игрок',
        townhall_level: 'Ратуша Уровень',
        wall_level: 'Стена Уровень',
        travel_time: 'Время в пути',
        resources_lootable: 'Лут состоянии',
        resources_looted: 'разграблены',
        combats: 'бои',
        military_score: 'генералы',
        location: 'расположение',
        view_island: 'Посмотреть Остров',
        occupied_by: 'окупация',
        blockaded_by: 'блокада',
        time_since: 'время',
        remove_target: 'удальть цель',
      },
      settings: {
        general: 'Общиее',
        language: 'Язык',
        ...
        tweaks: 'Твики',
        auto_accept_daily_bonus: 'Автоматически принимать ежедневный бонус',
        hide_ads: 'Скрыть объявления',
        hide_facebook: 'Скрыть кнопку Фейсбук',
        hide_friends_bar: 'Скрыть бар друзей',
        hide_chat: 'Скрыть чат',
        transport_buttons: 'Добавить кнопки транспортировки: -500, 500, 1к, 5к',
        donation_buttons: 'Добавить кнопки пожертвования: +1k, +10k, +100k',
        show_city_owners: 'Показать владельца города рядом с названием города (вид остров)',
        prevent_accidental_colony_destruction: 'Предотвратить разрушение немобильные колоний',
        initialize_colonization_missions_for_pirate_raiding: 
            'Инициализация колонизации миссии с дерева и мрамора построить уровня 1 пиратский крепость и использовать максимальное проект скорость',
        
        alerts: 'Оповещения',
        do_test: 'Тест',
        test_desktop_alert: 'Уведомление на рабочем столе (тест)',
        test_desktop_alert_title: 'уведомление Тест',
        test_desktop_alert_text: 'Извещение о! Нажмите, чтобы удолить.',
        desktop_alerts_not_supported: 
             'Предупреждения на рабочем столе не поддерживается браузером. Вы можете попробовать HTML Desktop' + 
             'Расширение Извещение Firefox ' + 
             '(https://addons.mozilla.org/en-us/firefox/addon/html-notifications/) ' + 
             'или переход на Chrome (www.google.com/chrome/).',
             
        building_completion_alert_desktop: 'Уведомление рабочего: здание обновить полное',
        transport_loaded_alert_desktop: 'Уведомление рабочего: транспорт миссия загружается',
        transport_arrived_alert_desktop: 'Уведомление рабочего: транспорт миссия прибыла',
        transport_returned_alert_desktop: 'Уведомление рабочего: транспорт миссии вернулись',
        deploy_army_loaded_alert_desktop: 'Уведомление рабочего: развернуть армию загружен',
        deploy_army_arrived_alert_desktop: 'Уведомление рабочего: развернуть армию прибыл',
        deploy_army_returned_alert_desktop: 'Уведомление рабочего: развернуть армии вернулся',
        deploy_navy_arrived_alert_desktop: 'Уведомление рабочего: развернуть флот прибыл',
        deploy_navy_returned_alert_desktop: 'Уведомление рабочего: развернуть флот вернулся',
        pillage_loaded_alert_desktop: 'Уведомление рабочего: грабеж загружалась',
        pillage_arrived_alert_desktop: 'Уведомление рабочего: грабеж прибыли',
        pillage_returned_alert_desktop: 'Уведомление рабочего: грабеж вернулся',
    ...
    ba: {
      misc: {
        resource_overview: 'Просмотр ресурсов',
        buildings_overview: 'Просмотр зданий',
        military_overview: 'Обзор Вооруженных Сил',
