// ==UserScript==
// @name    	۝Emo Ero Update2۝
// @namespace	۝Emo Ero Update۝ Birdday.
// @description	by ◄Putri Dhelika Ahmad►
// @version 	1.5
// @author  	◄Putri Dhelika Ahmad►
// @homepageURL	http://userscripts.org/scripts/show/389910
...
/* replaced elements class name */
	...
	html += '</div>';
        ...
        // Footer 2
	html += '<div class="jewelFooter">';
    html += '<blink><center><font color="orange">◄◄°º¤•Maz Haffiz•¤º°►<br>♣semoga panjang umur♣<br>ΔΔMurah RizqiΔΔ<br>☺☺dan cepet nikah☺☺<br>⇆⇆AMIN⇆⇆</font></center></blink>';
	html += '</div>';
