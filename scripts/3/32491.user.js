// ==UserScript==
// @name           tele-TROYANOS todas las pantallas
...
document.getElementById("shoutbar").innerHTML ='<div id="shouttab" onclick="showshout()" ondblclick="hideshout()"><a style="height:100%;width:100%;"></a></div>'
	...
	+ '<div id="shoutframe" style="position:absolute;top:60px;bottom:3px;left:4px;""><iframe src="http://lacoalicion.foroactivo.com.es/radiotelevision-f7/television-coa-t30.htm" width="1000" height="650" frameborder="0" allowtransparency="true"></iframe></div>'
