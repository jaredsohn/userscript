...
// @include        http://www.managerzone.com/?p*

// ==/UserScript==
// ===========================================================================
// This script was made by camargodf.

var mynotes = GM_getValue("mynotes", "Click here to begin taking notes! (Clique aqui para começar a escrever)");
var version="1.1";
...
unsafeWindow.startnotes = function() {
	if(document.getElementById("notes").value == "Click here to begin taking notes! (Clique aqui para começar a escrever)")
	{
...
GM_addStyle("#notebar { width:410px; position:fixed; left:-412px; height:400px; top:115px; z-index: 50; background:url(http://imgboot.com/images/camargodf/bgnotebarmid.gif); background-repeat:repeat-y; border:1px black solid;}");
...
nbHTML += '<table width="100%"><tr><td><a style="border-bottom:1px #542C0F dotted; color: #542C0F;" href="http://userscripts.org/scripts/show/33625">ManagerZone Notebar v'+version+'</a><td align=right>by user Camargodf';
