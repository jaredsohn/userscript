// ==UserScript==
// @name           	Cazaparasitos  para La Marabunta
// @namespace      http://hightekcafe.com/ikariam
// @description    	cazaparasitos con foto de colores con significado
// @include       	 http://s*.ikariam.*/*
// @exclude        	http://board.ikariam.*/*
// ==/UserScript==
// Original script built by Leecher Checker v 1.2.3, Modificado por Gullichwolf
			...
			if (thisElement.elements[0].value == 'Options')
			{
				...
				div.innerHTML = 
					"<div id='leecher_checker'>"+
						"<h3>Cazaparasitos de Paco "+lversion+" Opciones</h3>"+
...
// ==UserScript==
// @name           ALIANZA La Marabunta
// @namespace      ikatips
// @description    Herraminetas para la alianza 
// @include        http://*ikariam.*/index.php*
// @author         Original por Verx - Modificado Gullichwolf para la Alianza DKn -
...
'<div id="menu">'
+ '<ul>'
+ ' <li><h2>La Marabunta</h2>'
+ '   <ul>'
+ '     <li><a target="_blank" href="http://lamarabuntalambda.100foros.com/index.php" title="FORO La Marabunta" align="left">&nbsp;Foro La Marabunta</a></li>'
+ '     <li><a target="_blank" href="http://s11.ikariam.es/index.php?view=sendAllyMessage&oldView=embassy&id=5331&position=3&type=50" title=" Mensaje a todos " align="left">&nbsp;Mensaje a todos</a></li>'
+ '     <li><a target="_blank" href="http://s11.ikariam.es/index.php?view=allyPage&allyId=2785&oldView=island&id=878" title=" Pagina Interna " align="left">&nbsp;Pagina Interna</a></li>'
+'</ul>'
+'</DIV>';
