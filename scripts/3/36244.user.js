// ==UserScript==
// @name           Douban Subject Map
// @namespace      http://npchen.blogspot.com
// @description    海报墙Reloaded 
...
//$("#in_tablem div.indent div.fil a:first").click(function(){
    button = $("<span id='postwall'/>").html("【海报墙】") 
    $("#in_tablem div.related_info div.obss h2").append(button);
    $("#postwall").click(function(){
	var id = window.location.pathname.match('[0-9]+')[0];
	var title = $("form h1").text();
	var image_src = $("#mainpic a img").attr('src').replace('lobelia.douban.com/mpic', 'otho.douban.com/spic')
