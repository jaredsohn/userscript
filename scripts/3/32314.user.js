...
//TRADUIT EN FRANCAIS PAR JEAN CHRISTOPHE ATKINSON MAIL: ATKINSON_JEANCHRISTOPHE@YAHOO.FR
// --------------------------------------------------------------------
//
// ==UserScript==
// @name           Ikariam préciseur d'infos
// @namespace      ikariamScript
// @description    Ajoute plus d'info sur le tableau de bord en plus du nom du joueur, après la sélection des joueurs d'une ville sur l'aperçu de l'île ou lorsqu'il selectionne leur propre ville. Traduit par Jean Christophe Atkinson
...
function fetchScoresFor(name, ul, n, id) {
  ...
  var scores = changeLink &&
    <a href="/index.php?view=options"
      title="Changer les options">Changer les Options</a>;
...
<table border="0" cellpadding="0" cellspacing="0">
  <tr>
    <td style="width: 43%; text-align: right;">Montrer Les Points Totaux:</td>
    <td style="width: 57%"><input type="checkbox" id="totalScore"/></td>
  </tr>
  <tr>
    <td style="width:43%; text-align: right">Montrer La Valeur Militaire:</td>
    <td><input type="checkbox" id="militaryScore"/></td>
  </tr>
  <tr>
    <td style="width: 43%; text-align: right">Montrer Le Total Or:</td>
    <td><input type="checkbox" id="goldScore"/></td>
  </tr>
  <tr>
    <td style="width: 43%; text-align: right">Montrer Les Totaux en Ligne:</td>
    <td><input type="checkbox" id="inlineScore"/></td>
  </tr>
  <tr>
    <td style="width: 43%; text-align: right">Lien Changer Les Options:</td>
