// ==UserScript==
// @name            MP3lyrics.org Lyrics Only
// @namespace       Platypus
// @include         http://www.mp3lyrics.org/*/*/*/
// ==/UserScript==
function do_platypus_script() {
isolate(window.document,document.getElementById('EchoTopic'),null,null,null);
remove_it(window.document,document.evaluate('/HTML[1]/BODY[1]/DIV[1]/DIV[1]/FONT[1]', document, null, XPathResult.FIRST_ORDERED_NODE_TYPE,null).singleNodeValue,null,null,null);
