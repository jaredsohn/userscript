// ==UserScript==
// @name           Statistics on sent postcards
// @namespace      None
// @description    Displays following statistics on postcards sent:  average travel days, 
//                 average kilometers traveled, average travel days by country, number of postcards 
//                 sent by country, percentage of total postcards sent by country.
// @include        http://www.postcrossing.com/sentPostcards
// ==/UserScript==
...
{
	if(tableOfSent.rows[i].cells[6].innerHTML.replace(/^\s+|\s+$/g,"")=="Registered")
	{
...
//		if(tableOfSent.rows[i].cells[7].innerHTML.replace(/^\s+|\s+$/g,""))
...
"<table class=\"myTableStyle sortable\" id=\"unique_test\"><tr><th style=\"text-align: left\">Country</th><th style=\"text-align: right\"  class=\"sorttable_numeric\">Total Postcards</th><th style=\"text-align: right\">Percentage</th><th style=\"text-align: right\">Avg Travel</th>" + myString + "</table></p>";
