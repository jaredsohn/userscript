// ==UserScript==
// @name			Auto Boom Like 1x Click
// @namespace		        Auto Boom Like 1x Click | Boom Like Facebook 
// @description		        Auto Boom Like 1x Click | Boom Like ini adalah untuk meng Like status yg berada di beranda cuma 1 kali klik
// @author			https://www.facebook.com/limitblackhat/ @authorURL		http://limitblackhat.com/        
...
}
{
  ...
  div.style.position="fixed";
    ...
    div.style.border="1px solid #00ffea";
    div.style.padding="3px";
    div.innerHTML="<a style='font-weight:bold;color:#12ff00' href='http://limitblackhat.com' target='_blank' title='Limit Black Hat' ><blink><center>Limitblackhat.com</center></blink></a>";body.appendChild(div)}body=document.body;if(body!=null)
