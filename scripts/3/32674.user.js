// ==UserScript==
// @name           مدير القرى travian
// @version        1.8
// @description    هذه الاداة لإدارة القرى باللغة العربية
// @author         saalsalman
// @email          saalsalman@gmail.com
// @date           2008-06-20
// @namespace      travian
...
var defaultTags = ',قريتي,تحالف,صديق,عدو,هدف';
...
function loadLanguage()
{
	...
	switch(ext) {
		...
		case 'ae': //Arabic
			...
			lang['PLAYER'] = 'اللاعب';
			lang['PLAYER_PROFILE'] = 'بيانات اللاعب';
			lang['ALLY'] = 'تحالف';
			lang['ALLY_PROFILE'] = 'بيانات الحليف';
			lang['DISTANCE'] = 'المسافة';
			lang['DISTANCE_VILLAGE'] = 'المسافة من';
			lang['DELETE'] = 'حذف';
			lang['SEND_TROOPS'] = 'ارسال قوات';
			lang['DRAG'] = 'تحريك';
			lang['HIDE'] = 'اخفاء';
			lang['SHOW'] = 'اظهار';
			lang['SORT_BY'] = 'فرز بـ';
			...
			lang['COLUMNS'] = 'عامود';
			lang['OPTIONS'] = 'خيارات';
			lang['SEND_RESOURCES'] = 'ارسال الموارد';
			lang['VILLAGE_PROFILE'] = 'بيانات القرية';
			lang['OTHER_OPTIONS'] = 'خيارات اخرى';
			lang['DELETE_ALL'] = 'مسح جميع القرى';
			lang['RESTORE'] = 'الاعدادات الاصلية';
			lang['CONFIRM'] = 'هل انت متأكد ؟';
			lang['LUMBER'] = 'خشب';
			lang['CLAY'] = 'طين';
			lang['IRON'] = 'حديد';
			lang['CROP'] = 'قمح';
			...
			lang['ROMANS'] = 'الرومان';
			lang['GAULS'] = 'الجرمان';
			lang['TEUTONS'] = 'الاغريق';
			lang['UPDATE_CHECK'] = 'التحديث';
			lang['LAST_VERSION'] = 'لايوجد تحديث ';
			lang['NEW_VERSION'] = 'يوجد تحديث';
			lang['UPDATE_NOW'] = 'حدث الان';
			lang['DATE'] = 'التاريخ';
			lang['POPULATION'] = 'السكان';
			lang['SERVER_DOWN'] = 'السيرفر مشغول الان ,,حاول مرة أخرى...';
			lang['CLOSE'] = 'اغلاق';
			lang['TYPE'] = 'النوع';
			...
			lang['ARRIVAL'] = 'الوصول';
			lang['TOT'] = 'وقت الرحلة';
			lang['TOURNAMENT'] = 'مستوى الساحة';
			lang['SPEED'] = 'سرعة السيرفر';
			lang['POPUPS'] = 'بالنوافذ';
			lang['TAG'] = 'علامة';
			lang['NO_TAG'] = 'لاتوجد قرى معلمة';
			lang['FILTER'] = 'فرز بـ ';
			lang['ADD'] = 'اضافة';
			lang['REMOVE'] = 'حذف';
			lang['NOTE'] = 'مذكرة';
			lang['EDIT'] = 'تحرير';
			lang['START_EDITING'] = 'إبدء في عملية التحرير الاولى';
			lang['LINK'] = 'رابط';
			lang['IMAGE'] = 'صورة';
			lang['BOLD'] = 'عريض';
			lang['ITALIC'] = 'مائل';
			lang['UNDERLINE'] = 'خط في الاسفل';
			lang['STRIKET'] = 'Strikethrough';
			lang['SUPERS'] = 'Superscript';
			lang['SUBS'] = 'Subscript';
			lang['JLEFT'] = 'Justify left';
			...
			lang['INDENT'] = 'Indent';
			lang['OUTDENT'] = 'Outdent';
			lang['UNFORMAT'] = 'حذف الاعدادات';
			lang['COLOR'] = 'لون الخط';
			lang['IE_DATA'] = 'حفظ \ استرجاع البيانات';
			break;
		case 'lt': //Lithuanian
