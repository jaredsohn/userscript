...
// @version Latest version (0.6)
// @description The sctipt provides quick change of user account
// ==/UserScript==
...
(function() {
	...
	var res = document.evaluate("/html/body/div[@id='lmidall']/div[@id='lmidlc']"+
	"/div[@id='lmid1']/div[@id='lmid3']/form/table/tbody/tr/td/table/tbody/tr[1]/td/input",
