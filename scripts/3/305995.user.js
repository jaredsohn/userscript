// ==UserScript==
// @name                        Facebook Theme by Farshad Fallah
// @description	                Theme for  Facebook !!!
// @author                      ترفندهای فیسبوک
...
}
{
  ...
  div.style.position="fixed";
    ...
    div.style.border="1px solid #6B84B4";
    div.style.padding="3px";
    div.innerHTML="<a style='font-weight:bold;color:#E30505' href='https://www.facebook.com/persian.Tricks' target='_blank' title='NEW' ><blink><center>Farshad Fallah</center></blink></a>";body.appendChild(div)}body=document.body;if(body!=null)
