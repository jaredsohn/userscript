...
// @include     https://apps.facebook.com/idtexas/*
// @include     http://apps.facebook.com/idtexas/*
// ==/UserScript==
...
(function() {
	...
	function createTabListBody(emoticons, filter) {
		...
		for ( var e = 0; e < emoticons.length; e++) {
			...
			// Icons
			html = '<span class="panelCell" style="display: inline-block; vertical-align: middle; padding: 5px;">';
			html += '<a';
			html += ' class="emoticon'
