...
// @name		Travian Task Queue [With more Feature]  2.4 :-D +Thai
...
var sCurrentVersion = "2.4.0.0.7";  //Version number with which we need to run the update fu
...
aLangBuildings = ["", "伐木场", "黏土矿", "铁矿场", "农场", "木材厂", "砖块厂", "铸造厂", "磨坊", "面包房", "仓库", "粮仓", "铁匠铺", "军械库", "竞技场", "村中心大楼", "集结点", "市场", "大使馆", "兵营", "马厩", "兵工厂", "研发所", "山洞", "市政厅", "行宫", "皇宫", "国库", "交易所", "大兵营", "大马厩", "城墙", "土墙", "栅栏", "石匠铺", "酿造厂", "陷阱机", "英雄园", "大仓库", "大粮仓", "世界奇迹"];
...
aLangTasks = ["Construir", "Melhorar", "Atacar", "Desenvolver", "Explorar","Enviar Recursos"];
aLangStrings = ["Construir Depois", "Melhorar Depois", "Atacar Depois", "Desenvolver Depois", "Programar esta tarefa.", "Começamos a construir ", " foi tentada a tarefa mas com resultado desconhecido.", "nível", " não pode ser construído.", " não pode ser melhorado.", "A tarefa foi programada.", "Em Produção:", "Não conseguimos programar esta tarefa agora.", "Programação de tarefas não está disponível!", "Tarefas Programadas", "Apagar", "Enviar Depois", "Não foram seleccionadas tropas.", "As tuas tropas foram enviadas para", "Não foi possível enviar as tuas tropas para", "Reforços", "Ataque:normal", "Ataque:assalto", "O alvo das Catapultas será", "Aleatório", "em", "ou depois","segundos", "minutos", "horas", "dias","Espiar recursos e tropas", "Espiar defesas e tropas", "Ausente", "O ataque não pode ser programado pois nenhum destino foi escolhido.", "na localização ns.", "Ordenar:", "Tipo ", "tempo ", "Local ", "opções ", "vila ", "Historico", "Apagar Historico", "Começamos a pesquisar ", " nao pode ser pesquisado.","Melhorar depois", "Espiar", "Treinar depois", "tropas.", "Desenvolver", "nao pode ser desenvolvido ", " nao pode ser desenvolvido.","ou repetir ","vezes ","espaçadas por ","Apagar Fila ","Foram Enviados","Colocar na Fila"];
...
printMsg("The br language is not Correct. Check The traduction");
}
break;
