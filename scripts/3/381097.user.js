...
(function () {
    ...
    s.innerHTML = "(" + (function() {
        extend_fn = function(first, other){return function () { other.apply(this, arguments); first.apply(this, arguments); }};
        function makeDraggable(el) {
            var mousex, mousey, elx, ely, dragging = false;
            el.style.position='absolute';
            el.onmousedown = extend_fn((el.mousedown || function(){}), function (e) {
                mousex = e.clientX;
                mousey = e.clientY;
                elx = this.offsetLeft;
                ely = this.offsetTop;
            ...
            el.onmousemove = extend_fn((el.onmousemove || function(){}), function (e) {
                if (!dragging) return;
                this.style.left = (e.clientX-mousex+elx)+'px';
                this.style.top = (e.clientY-mousey+ely)+'px';
                return false;
            });
            document.body.onmouseup = extend_fn((document.body.onmouseup || function(){}), function (e) {
                dragging = false;
                return false;
            });
        }
