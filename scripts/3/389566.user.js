...
xlpanh = xlpanh.concat('虚弱增强')
xlpan = xlpan.concat('Faster Weaken')
xlpanh = xlpanh.concat('虚弱加速')
xlpan = xlpan.concat('Better Imperil')
xlpanh = xlpanh.concat('削弱增强')
xlpan = xlpan.concat('Faster Imperil')
xlpanh = xlpanh.concat('削弱加速')
xlpan = xlpan.concat('Better Blind')
xlpanh = xlpanh.concat('目盲增强')
xlpan = xlpan.concat('Faster Blind')
xlpanh = xlpanh.concat('目盲加速')
xlpan = xlpan.concat('Mind Control')
xlpanh = xlpanh.concat('支配意志')
xlpan = xlpan.concat('Better Silence')
xlpanh = xlpanh.concat('沉默增强')
xlpan = xlpan.concat('Better MagNet')
xlpanh = xlpanh.concat('磁链增强')
xlpan = xlpan.concat('Better Slow')
xlpanh = xlpanh.concat('减速增强')
xlpan = xlpan.concat('Better Drain')
xlpanh = xlpanh.concat('吸血增强')
xlpan = xlpan.concat('Faster Drain')
xlpanh = xlpanh.concat('吸血加速')
xlpan = xlpan.concat('Ether Theft')
xlpanh = xlpanh.concat('法力汲取(圣)')
xlpan = xlpan.concat('Spirit Theft')
xlpanh = xlpanh.concat('精神汲取(暗)')
xlpan = xlpan.concat('Better Haste')
xlpanh = xlpanh.concat('迅捷增强')
xlpan = xlpan.concat('Better Shadow Veil')
xlpanh = xlpanh.concat('影纱增强')
xlpan = xlpan.concat('Better Absorb')
xlpanh = xlpanh.concat('法术吸收增强')
xlpan = xlpan.concat('Stronger Spirit')
xlpanh = xlpanh.concat('精神盾增强')
xlpan = xlpan.concat('Better Heartseeker')
xlpanh = xlpanh.concat('寻心增强')
xlpan = xlpan.concat('Better Arcane Focus')
xlpanh = xlpanh.concat('秘法专注增强')
xlpan = xlpan.concat('Better Regen')
xlpanh = xlpanh.concat('恢复增强')
xlpan = xlpan.concat('Better Cure')
xlpanh = xlpanh.concat('治疗增强')
xlpan = xlpan.concat('Better Spark')
xlpanh = xlpanh.concat('火花增强')
xlpan = xlpan.concat('Better Protection')
xlpanh = xlpanh.concat('防护增强')
xlpan = xlpan.concat('Flame Spike Shield')
xlpanh = xlpanh.concat('烈焰盾刺')
xlpan = xlpan.concat('Frost Spike Shield')
xlpanh = xlpanh.concat('霜寒盾刺')
xlpan = xlpan.concat('Shock Spike Shield')
xlpanh = xlpanh.concat('雷鸣盾刺')
xlpan = xlpan.concat('Storm Spike Shield')
xlpanh = xlpanh.concat('风暴盾刺')
xlpan = xlpan.concat('Conflagration')
xlpanh = xlpanh.concat('烈焰')
xlpan = xlpan.concat('Cryomancy')
xlpanh = xlpanh.concat('霜寒')
xlpan = xlpan.concat('Havoc')
xlpanh = xlpanh.concat('雷鸣')
xlpan = xlpan.concat('Tempest')
xlpanh = xlpanh.concat('风暴')
xlpan = xlpan.concat('Sorcery')
xlpanh = xlpanh.concat('巫师(一阶增强)')
xlpan = xlpan.concat('Elementalism')
xlpanh = xlpanh.concat('元素师(二阶增强)')
xlpan = xlpan.concat('Archmage')
xlpanh = xlpanh.concat('大法师(三阶增强)')
try
{
...
temp=temp.innerHTML.replace('+10% Proficiency Gain Rate','+10%熟练度获取率(一点足矣)')
...
temp=temp.innerHTML.replace('+1 Battle Infusion Slots','+1个附魔携带数')
...
xlpanh = xlpanh.concat('>莫古邮箱')
xlpan = xlpan.concat('>Weapon Lottery')
xlpanh = xlpanh.concat('>武器彩票')
xlpan = xlpan.concat('>Armor Lottery')
xlpanh = xlpanh.concat('>防具彩票')
