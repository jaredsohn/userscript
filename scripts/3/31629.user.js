...
// @exclude        http://*.orkut.*/Main#Communities.aspx?*
// ==/UserScript==

/* (ORIGINAL AUTHOR)
 * @Original author Bruno Leonardo Michels
 * @Original author profile http://www.orkut.com/Profile.aspx?uid=11584069900845257050
 */

/* (EDITED BY)
 * @Edited by Felipe Asakura ~ Shaman King Br
 * @profile http://www.orkut.com.br/Profile.aspx?uid=316336138657885814
 * @cmm http://www.orkut.com.br/Community.aspx?cmm=66832
 */
...
/* VARS:: QuickReply */
QReplyAccept("66832", "Shaman King Br");
QReplyAccept("1683797", "Mangá Shaman King");
/* /VARS:: QuickReply */
...
var tools =
    new Array(
        ...
        (
            ...
            "<b>Spoiler</b> (selecione o texto para poder ler).<div style=\\'border-top: 1px solid rgb(255, 204, 102); border-bottom: 1px solid rgb(255, 204, 102); margin: 10px 0px; padding: 5px 0px 5px 3px; background-color: rgb(255, 255, 0); text-align: left; font-size: 90%;\\'>[yellow]{|}[/yellow]</div>",
        ...
        new Array /* Citar */
        (
            "<span style='cursor: pointer; color: green'>Citar</span>",
        ...
        new Array /* Dividir */
        (
            "<span style='cursor: pointer; color:green'>Hr</span>",
            "<hr>{|}",
            ""
        )
        ,
...
AddBookmarkCmm("66832", "Shaman King Br");

// tid 0 indicates that it is a separator

AddBookmarkTopic("66832", "Shaman King Br", "2496823826025913927", "CHAT");
