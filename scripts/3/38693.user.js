...
// ==UserScript==
// @name            platypus-hi5-groups
// @namespace       Platypus
// @include         http://*hi5.com/friend/group/*topic*
// @description     Uses wide layout for hi5.com groups. Large reply boxes. Topic name is forward order, "Discuss" is reverse order.  See http://www.hi5.com/friend/group/displayTopic.do?groupId=1021&topicId=15398321
// @date            6 March 2009
...
document.title = document.title.replace(/hi5 -.* Groups - /,'');
...
// Remove left menu:
smart_remove(window.document,document.getElementById('left-nav'),null,null,null);
...
// Change "Discuss" links to display topic's replies in reverse order:
// Programmer note: needed "if (element == null) return;" added to do_modify_html_it to handle some included pages
do_modify_html_it(window.document,document.evaluate('./DIV[3]/DIV[1]/DIV[2]/DIV[1]/DIV[4]/TABLE[1]/TBODY[1]', main_div, null, XPathResult.FIRST_ORDERED_NODE_TYPE,null).singleNodeValue,/href="([0-9]*)--([0-9]*)--(.*)--topic-html">Discuss »/g,'href="$1--$2--0--1--2--$3--topic-html">Discuss »',null);

// Make reply textboxes larger (plug in any number of rows & columns you want, I like 26 by 103):
do_modify_html_it(window.document,document.evaluate('./DIV[3]/DIV[1]/DIV[3]/DIV[1]/DIV[1]', main_div, null, XPathResult.FIRST_ORDERED_NODE_TYPE,null).singleNodeValue,/rows="5" cols="59"/g,'rows="26" cols="103"',null);

// Get rid of help text under reply textboxes:
do_modify_html_it(window.document,document.evaluate('./DIV[3]/DIV[1]/DIV[3]/DIV[1]/DIV[1]', main_div, null, XPathResult.FIRST_ORDERED_NODE_TYPE,null).singleNodeValue,/Note: To add an image or link.*/g,'',null);
