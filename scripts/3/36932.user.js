// ==UserScript==
// @name           Puntuaciones para Los Valientes
// @description    Informa las puntuaciones de los jugadores, y las puntuaciones de la alianza
...
function createBaseDiv() {
    ...
    var scoreDiv = <>
		...
		<li style="margin: 2px 10px;" id="ally_members" class="name">
			<span style="float:left;width:80px;" class="textLabel">{lang['allyscore']}:</span>
