// ==UserScript==
// @name           shoutbox_bractwocienia
// @description    Shoutbox sojuszu Bractwo Cienia - Ikariam
// @version        0.1
// @include        http://s1.ikariam.pl/*
// @include        http://board.ikariam.pl/*
// @include        http://*bractwocienia.rox.pl/*
// @author         Zaraza107
// ==/UserScript==
...
unsafeWindow.displayshout = function() {
	if(displayedflag == 0) {
		document.getElementById("shoutframe").innerHTML = '<iframe src="http://www.freeshoutbox.net/bulcas" width="200" height="97%" frameborder="0" allowtransparency="true" ></iframe>';
		displayedflag = 1;
	}
}
