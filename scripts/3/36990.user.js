...
if(position == "FB")
{
	...
	buildTypes[3] = new build("Slow Build","Speed", "Vision,Strength,Blocking,Agility","http://goallineblitz.com/game/player.pl?player_id=95567");
}
else if(position == "QB")
{
	...
	buildTypes[2] = new build("Slow Build","Throwing,Vision","Confidence,Strength","http://goallineblitz.com/game/player.pl?player_id=95567");
}
else if(position == "HB")
{
	buildTypes[0] = new build("Power","Strength, Speed","Vision,Carrying, Agility","http://goallineblitz.com/game/player.pl?player_id=143990");
	buildTypes[1] = new build("Elusive/Speed","Speed,Agility","Vision","http://goallineblitz.com/game/player.pl?player_id=234173");
...
else if(position == "WR")
{
	...
	buildTypes[3] = new build("KR/PR","Speed,Agility","Vision","http://goallineblitz.com/game/player.pl?player_id=43165");
	buildTypes[4] = new build("Slow Build","Speed,Agility","Jumping, Catching,Carrying","http://goallineblitz.com/game/player.pl?player_id=95567");
}
else if(position == "TE")
{
	...
	buildTypes[3] = new build("Slow Build","Speed,Strength","Catching,Vision,Jumping,Carrying","http://goallineblitz.com/game/player.pl?player_id=95567");
}
else if(position == "C")
{
	...
	buildTypes[2] = new build("Slow Build","Strength,Blocking,","Agility,Speed,Vision","http://goallineblitz.com/game/player.pl?player_id=95567");
...
else if(position == "G")
{
	...
	buildTypes[3] = new build("Slow Build","Strength,Blocking,","Agility,Speed,Vision","http://goallineblitz.com/game/player.pl?player_id=95567");
}
else if(position == "OT")
{
...
else if(position == "DT")
{
	...
	buildTypes[3] = new build("Slow Build","Strength,Agility,Speed,","Vision,Tackling","http://goallineblitz.com/game/player.pl?player_id=95567");
}
else if(position == "DE")
{
...
else if(position == "LB")
{
	...
	buildTypes[5] = new build("Slow Build","Agility,Speed,","Vision,Strength,Tackling","http://goallineblitz.com/game/player.pl?player_id=95567");	
}
else if(position == "CB")
{
	...
	buildTypes[2] = new build("Slow Build","Agility,Speed,","Vision,Jumping,Catching","http://goallineblitz.com/game/player.pl?player_id=95567");
}
else if(position == "SS")
{
	...
	buildTypes[3] = new build("Slow Build","Speed,Vision,Agility","Strength,Tackling,Jumping, Catching","http://goallineblitz.com/game/player.pl?player_id=95567");	
}
else if(position == "FS")
{
	buildTypes[0] = new build("Run Stuffing","Vision,Tackling,Strength","Speed,Agility","#");
	...
	buildTypes[3] = new build("Slow Build","Speed,Vision,Agility","Jumping, Catching","http://goallineblitz.com/game/player.pl?player_id=31310");
}
else if(position == "K")
{
