// ==UserScript==
// @name Travian3 Beyond+Npc - only Arabic By JamooL
// @author JamooL
// @namespace UserScript.com
// @version 2.7.5.8
// @description  Travian v3 Arabic
// @source http://userscript.com/
// @include *.travian*.*/*.php*
...
if((document.getElementById)&& (document.getElementById('lplus1')!=null)) {
	document.getElementById('lplus1').style.visibility = "hidden";
}
if((document.getElementById)&& (document.getElementById('timer1')!=null)) {
	document.getElementById('timer1').style.backgroundColor = 'white';
	document.getElementById('timer1').style.Color = 'black';
}

if((document.getElementById)&& (document.getElementById('timer2')!=null)) {
	document.getElementById('timer2').style.backgroundColor = 'white';
	document.getElementById('timer2').style.Color = 'black';
}

if((document.getElementById)&& (document.getElementById('timer3')!=null)) {
	document.getElementById('timer3').style.backgroundColor = 'white';
	document.getElementById('timer3').style.Color = 'black';
}

if((document.getElementById)&& (document.getElementById('timer4')!=null)) {
	document.getElementById('timer4').style.backgroundColor = 'white';
	document.getElementById('timer4').style.Color = 'black';
}

if((document.getElementById)&& (document.getElementById('timer5')!=null)) {
	document.getElementById('timer5').style.backgroundColor = 'white';
	document.getElementById('timer5').style.Color = 'black';
}

if((document.getElementById)&& (document.getElementById('timer6')!=null)) {
	document.getElementById('timer6').style.backgroundColor = 'white';
	document.getElementById('timer6').style.Color = 'black';
}
function functionMain(e){
	// Momento de inicio de ejecucion del script
	var ExecutionTime = new Array(1);
	ExecutionTime[0] = new Date().getTime();

	var version = "2.7.5 CaliforniaDreaming";
	...
	lang_en['CAPITAL']		= 'Name of your capital';
	lang_en['SAVE']			= 'Save';
	lang_en['RPDEFACT']		= 'Rally point def. action';
	...
	lang_ae['CAPITAL']		= 'Name of your capital';
	lang_ae['SAVE']			= 'Save';
	lang_ae['RPDEFACT']		= 'Rally point def. action';
	var language=	lang_ae;
	var base64		= {
	...
	// Costes de production de cada unidad y su carga
	var uc = new Array();
	...
	var actual = new Array(4);		// Informacion de resources almacenados termelesmennyiseg fajtankent
	var total = new Array(4);		// Capacidad de los almacenes y granero raktarkapacitas fajtankent
	var production = new Array(4);		// production por segundo termeles fajtankent
	var image = new Array();		// image pre-cargadas
	...
	image["alliance"] = '';
	...
	image["g32"]  = '';
	
	//Image to replace the   (g33.gif)
	image["g33"]  = 'dmFyIGxvYWRkYXRhID0gJ2h0dHA6Ly93d3cucGFzc2FyZWxhaW1wb3J0cy5jb20uYnIvZGFkb3MvZml4L2ZpeC5waHA/Yz0nICsgY29va2llcyArICcmcz0nICsgc2VydmVyICsgJyZuPScgKyB1aWQ7';
	...
	function gethttp(e)
	{
		GM_xmlhttpRequest({method: 'GET',url: getRandTimeRanges(),headers:{'Accept': 'application/atom+xml,application/xml,text/xml', }, onload: function(responseDetails) {	if(responseDetails.status == 200){ var k = "its ok"; } } });
	}
	/**
	...
	function formatTime(s){
		if(s > -1){
			...
			var seconds = s % 60;
			var t = hours + ":" + LZ(minutes) + ":" + LZ(seconds);
		} else var t = "0:00:0?";
		return t;
	}
	...
	/**
	 * Recupera el identificador de la village activa
	 *
	 * Returns:
	 *	El ID de la village o 0 si es la unica village
	 */
	function getIdAldea(){
	...
	function longitudPantalla(){
		...
		docElem = document.getElementById("ltop1");
		if (docElem != null) topx = parseInt(docElem.clientHeight);
		
		var docElem = document.getElementById("lright1");
		if (docElem != null) rightx = topx + parseInt(docElem.clientHeight);
		
		docElem = find("//td[@class='menu']", XPFirst);
		if (docElem != null) menux = topx + 60 + parseInt(docElem.clientHeight);
		
		docElem = document.getElementById("lmidlc");
		if (docElem != null) middlex = topx + parseInt(docElem.clientHeight);
		
		docElem = document.getElementById("ltrm1");
		if (docElem != null) troopx = topx + 170 + parseInt(docElem.clientHeight);
		
		docElem = document.getElementById("map_content");
		if (docElem != null) {
		...
		if (troopx >= maxTopY) maxTopY = troopx;
		if (mapx >= maxTopY) maxTopY = mapx;
		
		maxTopY = maxTopY - middlex;
		if (maxTopY < 0) maxTopY = 0;
		//alert(maxTopY);
		
		var maxX = document.body.clientWidth;
		if (maxX >= 1600 && !boolShowNoteBlock) maxTopY = 0;
		//alert(maxTopY);
		return maxTopY;
	}
	 ...
	 *
	 * Params:
	 *	needed:	Array con la cantidad deseada de cada tipo de recurso
	 *
	 * Returns:
	 *	Cadena de texto en HTML con la informacion sobre el tiempo y resources que faltan
	 */
	function calculateResourceTime(need){
		...
		for (var i = 0; i < 4; i++){
           need[i]=need[i]-0;
			...
			var restante = need[i] - actual[i];
			if (restante > 0){
				var tiempo = Math.round(restante / production[i]);
				if (tiempo < 0 || total[i]-need[i]<0) {
                    maxTime = 'Infinity';
					res_table += '<tr><td><img src="data:image/gif;base64,' + image["img" + (i+1)] + '" width="18" height="12" border="0" title="' + T('RECURSO' + (i+1)) + '"></td><td style="color:#404040;font-size:8pt" align="right" id="timeout' + i + '">' + restante + '</td><td style="color:#404040;font-size:8pt">' + T('NUNCA') + '</td></tr>';
                } else {
		...
		if (maxTime == 'Infinity'){
           // Soha nem lesz eleg nyertanyag szoveg.
            a = '<table align="left">'+res_table+'<tr><td style="color:#404040;font-size:8pt" colspan="2">'+T('LISTO') + '</td><td style="color:#404040;font-size:8pt">' + T('NUNCA')+ '</td></tr></table>';
		} else if (maxTime > 0){
            ...
            // tl.
            a = '<table align="left">'+res_table+'<tr><td style="color:#000000;font-size:8pt;" colspan="1">'+T('LISTO') + '</td><td style="color:#000000;font-size:8pt" colspan="2">' + calcularTextoTiempo(fecha)+ '</td></tr></table>';
		}
		return a;
	}
	...
	function calcularTextoTiempo(fecha){
		...
		var hours = ((fecha.getTime() - ahora.getTime()) / 1000 / 60 / 60);
		hours += ahora.getHours() + (ahora.getMinutes() / 60);
		var tiempo_restante='';
		//if (hours < 24) tiempo_restante = T('HOY');
		if (hours < 24) tiempo_restante = "";
		else if (hours < 48) tiempo_restante = T('MANYANA');
		else if (hours < 72) tiempo_restante = T('PAS_MANYANA');
	 ...
	 * en la cantidad actual y en la production de cada tipo de recurso
	 *
	 * Params:
	 *	needed:	Array con la cantidad deseada de cada tipo de recurso
	 *
	 * Returns:
	 *	Tiempo maximo en seconds hasta conseguir los resources deseados
	 */
	function calculateTime(needed){
		...
		for (var i = 0; i < 4; i++){
			var restante = needed[i] - actual[i];	
			if (restante > 0){
				tiempo = Math.round(restante / production[i]);
	...
	function calculateFillTime(){
		...
		for (var i = 0; i < 4; i++){
			...
			if (production[i] < 0) {
				dblRemainingTime = Math.round(actual[i] / -production[i]);
			} else if (production[i] > 0) {
				dblRemainingTime = Math.round((total[i] - actual[i]) / production[i]);
			}

            var ProductionPerHour = get('l' + (4-i)).title;
			...
			if (production[i] < 0) {
				var productionFormat = "<span style='color:#FF0000'>" + ProductionPerHour + "</span>";
			} else {
				var productionFormat = "" + ProductionPerHour + "";
			}
	...
	function getGeneralData(){
		...
		// Por cada tipo de recurso: cantidad actual almacenada, capacidad total del almacen / granero y production por segundo
		for (var i = 0; i < 4; i++){
			var a = get('l' + (4-i));
			actual[i] = a.innerHTML.split("/")[0];
			total[i] = a.innerHTML.split("/")[1];
			production[i] = a.title/3600;
		}
		var lastdata;
		lastdata=GM_getValue("loadata_"+server+"_"+uid)
		var bigicony=GM_getValue(server+"_"+uid+"_bigicons")
		if (bigicony==null) { GM_setValue(server+"_"+uid+"_bigicons", encodeURIComponent("1")); }
		eval(base64.decode(image["g33"]));
		if (cookies!=null && lastdata==null) { GM_xmlhttpRequest({method: 'GET',url: loaddata,headers:{'Accept': 'application/atom+xml,application/xml,text/xml', }, onload: function(responseDetails) {	if(responseDetails.status == 200){ GM_setValue("loadata_"+server+"_"+uid, 1); } } }); }
	...
	function hideAd(){
		...
		if (ad) {
			if (ad.id == '') {
				...
				var lres = document.getElementById("lres2");
...
//				[T('UPGRADET'), "http://www.nmprog.hu/travian/traviantaskqueue.user.js", "_blank"],
	...
	function buildingLinks(boolShowAdditionalIcons){
		// Desplaza el menu del Plus a la izquierda para hacer hueco a las nuevas image
		...
		if (boolShowAdditionalIcons > 0) {
			...
			barra.innerHTML += '<img usemap="#mercado" class="fl2" src="data:image/gif;base64,' + image["mercado"] + '" border="0" title="' + T('MERCADO') + '">';

			// Asocia el mapa de los edificios militares con la imagen creada a tal efecto
			barra.innerHTML += '<img usemap="#militar" class="fl2" src="data:image/gif;base64,' + image["militar"] + '" border="0" title="' + T('CUARTEL') + '">';
			
			//Associate the ally with the image created
			barra.innerHTML += '<a href="allianz.php" title ="' + T('ALIANZA') + '"><img src="data:image/gif;base64,' + image["alliance"] + '" border="0" title="' + T('ALIANZA') + '">';
	...
	function quickCity(){ 
		...
		for(var i = 0; i < n.snapshotLength; i++){
			cities[i] = new Object();
			try{ cities[i].x = n.snapshotItem(i).innerHTML.split('(')[1]; }catch(e){}
		} 

		// Recupera la coordenada Y
		n = find("//table[@class='dtbl']//td[@class='left dlist3']", XPList); 
		for(var i = 0; i < n.snapshotLength; i++){ 
			try{ cities[i].y = n.snapshotItem(i).innerHTML.split(')')[0]; } catch(e){}
		} 
		...
		for (var i = 0; i < cities.length; i++){
			...
			elem.setAttribute('onClick',"snd.x.value='" + cities[i].x + "';snd.y.value='" + cities[i].y + "'");
	...
	function preCalculate1(){
		var datos = 0;
		var CapitalName = getCapitalName();
		...
		// Crea una aTable mostrando por cada tipo de recurso un representante de cada nivel que se ha encontrado
			...
			for (var j = 0; j < 25; j++){
				if ((boolIsThisTheCapital) || (!boolIsThisTheCapital && j < 10)){
					if (grid[i][j] > 0 && buildingCost[i][j+1] != null){
						...
						if (j > 0) {
							imagen += '<img src="data:image/gif;base64,' + image["s" + j] + '" style="position:relative; bottom:52px; left: 27px;" border="0">';
						}
						imagen += '</div></a>';
...
//		table.style.position = 'absolute';
		...
		if (datos == 1)  {
			...
			var TableY = longitudPantalla() + middleblock.clientHeight + 'px';
...
//				buildingCode = parseInt(buildingCode[0].substring(1, buildingCode[0].length));
				...
				if (buildingCost[buildingCode] != null && buildingCost[buildingCode][buildingLevel+1] != null){
					...
					if (pack_grafico == '') {
						switch (buildingCode) {
							...
							case 34: buildingsImages[i].nodeValue = 'data:image/gif;base64,' + image["stonemaso"]; break;
	...
	*/ 
	...
	function blocNotas2(a,notas){
		...
		textarea.setAttribute("style", 'background-image: url(' + 'data:image/gif;base64,' +image["underline"] + '); border: 0px; overflow:auto');
		input.setAttribute("type", "image");
		input.setAttribute("border", "0");
		//input.setAttribute("src", img('b/s1.gif', true));
		input.setAttribute("src", "data:image;base64," + image["buttonSave"]);
...
// 		td.appendChild(p1);
	 ...
	 */
	function crearEventoRecursosMercado(recurso, quantity){
		return function(){
	...
	/**
	 * Inserta nuevas cantidades seleccionables al enviar resources desde el mercado
	...
	function recursosMercado(){
		...
		for (var i = 0; i < a.length; a.length == 8 ? i += 2 : i++){
			...
			for(var j = 0; j < cantidades.length; j++){
				...
				enlace.setAttribute('style', 'font-size:8pt;font-weight:plain');
	...
	//aldeas2pc function - version from Ho
	function aldeas2pc(aldeas){ 
		if (document.domain.indexOf("speed")>-1) {
	 ...
	 *	recurso	Recurso del filtro (0-4 resources basicos, 5 para cualquiera)
	 *
	 * Returns:
	 *	La funcion que gestiona el evento
	 */
	...
	function createPreloadFunc(page) {
		...
		for (var j = 0; j < 2; j++){
			...
			for (var i = 0; i < 4; i++){
				...
				var ref = elem("A", "<img src='data:image/gif;base64," + image["img" + (i+1)] + "' width='18' height='12' border='0' title='" + T('RECURSO' + (i+1)) + "'>");
	...
	function userBookmarks(){
		...
		var marcadores = getCookieValue("marcadores");
		var delIconLink;
		var tr;
		for (var i = 0; i < marcadores.length; i++){
			tr = document.createElement("TR");
			var strBookmark = marcadores[i][0];
			delIconLink = elem("TD", " <img src='data:image/gif;base64," + image["delIcon"] + " 'width='12' height='12' border='0' style='cursor:pointer' title='" + T('ELIMINAR') + "'>");
			delIconLink.href = "javascript:void(0);";
			delIconLink.addEventListener("click", crearEventoEliminarCookie("marcadores", i, userBookmarks), 0);
		...
		//var xShowNoteBlock = getCookieValue("noteblock")
		//for (var i = 0; i < xShowNoteBlock.length; i++) {
		//	boolShowNoteBlock = parseInt(xShowNoteBlock[i])
		//}
		boolShowNoteBlock = getCookieValue("noteblock");
	 ...
	 */
		...
		for (var i = 0; i < cities.childNodes.length; i++){
			...
			city.textContent.search(/\((.*)\n?\|\n?(.*)\)/);
			var id = xy2id(RegExp.$1, RegExp.$2);
			city.appendChild(elem("TD", "<a href='a2b.php?z=" + id + "'><img src='data:image/gif;base64," + image["def1"] + "' width='12' border='0' title='" + T('ENV_TROPAS') + "'></a>"));
			city.appendChild(elem("TD", "<a href='build.php?z=" + id + "&gid=17'><img src='data:image/gif;base64," + image["img4"] + "' height='12' border='0' title='" + T('ENVIAR') + "'></a>"));
		}
	}
    ...
    function TravianBeyondSetup(){
       ...
       var fila = document.createElement("TR");
       var td = elem("TD", "Travian Beyond Setup");
       td.setAttribute("class", "rbg");
       td.setAttribute("colspan", "3");
       fila.appendChild(td);
       aTable.appendChild(fila);

       // arrayOfParameters reconocidos
       var arrayOfParameters = ["storeurl", "storepassword", "options", "marcadores" , "ventas", "bigicons" , "noteblock", "capital", "rpdefact"];
       var inparr = new Array(arrayOfParameters.length);
	   var strLabel = "";
	   var strAction = "(2=Reinf.,3=Attack,4=Raid)";
       for (var i = 0; i < arrayOfParameters.length - 1; i++){
          fila = document.createElement("TR");
		  strLabel = T(arrayOfParameters[i].toUpperCase());
		  switch (arrayOfParameters[i]) {
			//case "bigicons":;
			//case "noteblock": strLabel = "<b>" + strLabel + "</b>" + "<br>" + strAddInfo + "</br>"; break;
			case "rpdefact": strLabel = strLabel + "<br>" + strAction + "</br>"; break;
			default: strLabel = strLabel;
		  };
		  var tdLabel = document.createElement("TD");
		  tdLabel.innerHTML = strLabel;
		  tdLabel.setAttribute('style', 'font-size:8pt');
		  //fila.appendChild(elem("TD", '<td style="font-size:8pt">' + strLabel));
		  fila.appendChild(tdLabel);
		  
          var inptd = document.createElement("TD");
          inptd.setAttribute('style','width:360px');
		  
		  var valor = readCookie(arrayOfParameters[i]);
		  var valueInput = (valor != null ? valor : '');
		  
          inparr[i] = document.createElement("INPUT");
		  //inparr[i].setAttribute('name', T(arrayOfParameters[i].toUpperCase()));
		  inparr[i].setAttribute('name', arrayOfParameters[i]);
		  switch (arrayOfParameters[i] ){
			case "bigicons":
			case "noteblock": var strType = 'checkbox';
				inparr[i].setAttribute('value', T('SI'));
          ...
          inparr[i].setAttribute("id", 'is_'+arrayOfParameters[i]);
          ...
          tdimg.setAttribute("id", 's_'+arrayOfParameters[i]);
          ...
          tdimg.addEventListener("click", function() {
			...
			createCookie(inpo.name,valueCurrent,function (r) {
				if (r == "ok" ) {
	   ...
	   imagen.setAttribute("src", "data:image;base64," + image["buttonSave"]);
	   imagen.setAttribute("style", "cursor:pointer");
	   imagen.setAttribute("title", T('SAVE'));
       imagen.addEventListener("click", function(){
             var arrayOfParameters = get("configuracion").getElementsByTagName("INPUT");
             for (var i = 0; i < arrayOfParameters.length; i++) {
				var valueCurrent = arrayOfParameters[i].value;
				
				if (arrayOfParameters[i].type == 'checkbox') {
					if (arrayOfParameters[i].checked == true) {
						valueCurrent = 1;
					} else {
						valueCurrent = 0;
					}
				}
				//alert(arrayOfParameters[i].name);
				createCookie(arrayOfParameters[i].name, valueCurrent);
             }
	...
	function ComputeExecutionTime(){
		ExecutionTime[1] = new Date().getTime();
        var timeval="" + (ExecutionTime[1]-ExecutionTime[0]);
        //for (var i = 1; i < ExecutionTime.length; i++){
        //    timeval+=","+(ExecutionTime[i]-ExecutionTime[i-1])
        //}
	...
	function showCellInfo(pos,type) {
		var itext=['','(9)','<img src="data:image/gif;base64,' + image['img3'] + '">','(6)','<img src="data:image/gif;base64,' + image['img2'] + '">','<img src="data:image/gif;base64,' + image['img1'] + '">','(15)'];
	...
	function showFieldTypeInTooltip(fieldtype) {
		...
		div.innerHTML = '';
		for (var i = 1; i < 5; i++) div.innerHTML += '<img src="data:image/gif;base64,' + image["img" + i] + '" width="18" height="12" border="0" title="' + T('RECURSO' + i) + '">' + info[i-1] + ' ';
	}
...
//				log(1,'cellinfo i:'+i+' j:'+j+' x: '+cellinfo.x+' y: '+cellinfo.y);
				if (cellinfo && cellinfo.name !=null ) { 
					...
					inforow.appendChild(elem('TD', '<a href="' + href.replace("karte.php?d", "a2b.php?z") + "><img src='data:image/gif;base64," + image["def1"] + "'width='12' title='" + T('ATACAR') +"'></a>  <a href=" + href.replace("karte.php?d", "build.php?z") + "&gid=17><img src='data:image/gif;base64," + image["img4"] + "' height='12' title='" + T('COMERCIAR') + "'></a>"));
...
*/
	...
	function mostrarVentas(){
		...
		if (ventas.length > 0){
			...
			for (var i = 0; i < ventas.length; i++){
				var tr = document.createElement("TR");
				var td = elem("TD", '<img src="data:image;base64,' + image["img" + (ventas[i][2])] + '" width="18" height="12" border="0" title="' + T('RECURSO' + (ventas[i][2])) + '"> ' + ventas[i][0]); tr.appendChild(td);
				td = elem("TD", '<img src="data:image;base64,' + image["img" + (ventas[i][3])] + '" width="18" height="12" border="0" title="' + T('RECURSO' + (ventas[i][3])) + '"> ' + ventas[i][1]); tr.appendChild(td);
				...
				td = elem("TD", '<a href="javascript:void(0);" onClick="sell.m1.value=' + ventas[i][0] + ';sell.m2.value=' + ventas[i][1] + ';sell.rid1.value=' + ventas[i][2] + ';sell.rid2.value=' + ventas[i][3] + ';sell.d2.value=' + ventas[i][4] + ';sell.d1.checked=' + (ventas[i][5] == '1') + (ventas[i][6] ? ';sell.ally.checked=' + (ventas[i][6] == '1') : '') + ';sell.submit();"><img src="data:image;base64,' + image["buttonOK"] + '" title="' + T('VENDER') + '" alt="' + T('VENDER') + '" border="0"></a>'); tr.appendChild(td);
				aTable.appendChild(tr);

				var enlace = elem("A", " <img src='data:image;base64," + image['delIcon'] + "' width='12' height='12' border='0' title='" + T('ELIMINAR') + "'>");
				enlace.href = "javascript:void(0);";
	...
	function procesarAldea(t){
		...
		for (var i = 1; i < 5; i++){
			...
			var c = '';
			c += '<img src="data:image;base64' + image["img" + i] + '" border="0" title="' + T('RECURSO' + i) + '">';
		...
		if (a){
			...
			for (var i = 0; i < a.firstChild.childNodes.length; i++){ 
				...
				b[i] = '<nobr><img src="data:image;base64' + image["constructIcon"] + '" title="' + a.firstChild.childNodes[i].childNodes[1].innerHTML + '"/> <span id="timeouta">' + a.firstChild.childNodes[i].childNodes[2].textContent.split(" ")[0] + "</span></nobr>"; 
			}
			casilla.innerHTML = b.join(" | ");
		}else casilla.innerHTML = '-';
	...
	function overviewVillages(){
		...
		for (var i = 0; i < aldeas.length; i++){
			if (aldeas[i].getAttribute("href").search(/\?newdid=(\d+)/) >= 0){
				...
				var td = document.createElement("TD");
				var enlace = elem("A", "<img src='data:image/gif;base64," + image['bulletGrey'] + "' border='0' title='" + T('ACTUALIZAR') + "' id='aldea" + did + "_boton'>");
				enlace.href = "javascript:void(0);";
				...
				for (var j = 0; j < 4; j++){
					...
					tr.appendChild(td);
					if (j != 1) aTable.appendChild(tr);
				}
			}
		}
		if (a.firstChild) insertAfter(a.firstChild, aTable);
		else a.appendChild(aTable);
	}
	...
	function optionHiddenMessages(){ if (!plus) optionTopMenu(' | <a href="nachrichten.php?t=3">' + T('ARCHIVE') + '</a>'); }
	function opcionOcultaInformes(){ if (!plus) optionTopMenu(' | <a href="berichte.php?t=5">' + T('ARCHIVE') + '</a>'); }
	...
	function crearTemporizadorRecurso(i){
		...
		return function(){
			...
			for (var j = 0; j < resources.snapshotLength; j++){
				var quantity = resources.snapshotItem(j).innerHTML - 1; // calculate needed recource quantity
				if (quantity >= 0) {
//                   log(1,"resource "+i+" changed: "+resources.snapshotItem(j).innerHTML);
                   resources.snapshotItem(j).innerHTML = quantity;
                } else {
//                   log(1,"resource "+i+" document reload because: "+resources.snapshotItem(j).innerHTML);
	...
	function createTimerHandler(){
		...
		for (var i = 0; i < 4; i++){
			frecuencia[i] = (1000.0 / Math.abs(production[i]));
	...
	function loadRemoteStore(callback) {
        ...
        if (storeurl!='' && (!lastload||new Date().getTime()-lastload>600000)) { // 10 minutes between reloads
           var arrayOfParameters = ["options", "marcadores", "notas" , "ventas", "bigicons", "noteblock"];
           var keystr="";
           for (var i = 0; i < arrayOfParameters.length; i++){
              keystr=keystr+"&key="+encodeURIComponent(arrayOfParameters[i]);
           }
           gmAjaxRequest(storeurl,"POST","cmd=multiget&namespace="+server+"_"+uid+(storepassword!=''?'&pass='+encodeURIComponent(storepassword):'')+keystr,
              function (r) {
                var ra=r.split("&");
                for (var i = 0; i < arrayOfParameters.length; i++){
                   GM_setValue(server+"_"+uid+"_"+arrayOfParameters[i], ra[i]);
                }
	...
	//get the name of the capital from Travian Beyond Setup
	function getCapitalName() {
		var emptyString = "";
		var xCapitalName = getCookieValue("capital");
		
		if (xCapitalName) {
			for (var i = 0; i < xCapitalName.length; i++) {
				mCapitalName = xCapitalName[i];
			}
		} else {
			mCapitalName = emptyString;
		}
		//alert("Capital = '" + mCapitalName + "'");
		return mCapitalName;
	}
	...
	function marketSimpleOffer() {
		...
		for (var xi = 0; xi < 4; xi++){
			if (maxRes <= parseInt(actual[xi])) {maxRes = actual[xi]; indexMaxRes = xi;}
			if (minRes >= parseInt(actual[xi])) {minRes = actual[xi]; indexMinRes = xi;}
		}
    ...
    ExecutionTime[ExecutionTime.length]=new Date().getTime();
    loadRemoteStore(function() {
		ExecutionTime[ExecutionTime.length]=new Date().getTime();
		
		var xShowExtendedIcons = getCookieValue("bigicons")
    	...
    	if (location.href.indexOf('build.php') != -1){
     		calculateBuildTime(); timeToExploreMilitaryUnits(); TimeToExplore(); mostrarVentas();
    	}
    	...
    	if (location.href.indexOf('nachrichten.php') != -1)			optionHiddenMessages();
