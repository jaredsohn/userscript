// ==UserScript==
// @name          	Remember The Milk GTD Extension
...
varProjectsSectionBackgoundColor = "#AAAAAA";		// Backgound color for Project list section
varOtherBucketsSectionBackgroundColor = "#99FFCC";	// Backgound color for 'Other Buckets' list section
varNextActionsSectionBackgroundColor = "#FFFF00";	// Background color for Next Actions list section
varEmptyInboxFontSize ="16px";				// font size of Inbox list item when it  doesn't contain any tasks
...
varNonEmptyInboxFontSize = "35px";			// font size of Inbox list item when it has some tasks in it - by default doubled in size to call attention to itself
...
varMisstaggedFontSize = "35px";				// font size of Misstagged list
...
varLoneActionsFontSize = "9px";				// font size of Lone Actions list - made small by default since this generally won't be a list that you look at often or at all.
...
varNonEmptySentFontSize = "9px";			// font size of Sent list that has some items in it (empty sent list doesn't display at all) - by default this font is small because (at least for me) this list is almost never used 
...
varEmptyProjectListFontSize = "20px";			// font size for a project list item that has no tasks in it - this is a way to call attention to project lists that have nothing in them.
...
varOtherBucketsFontSize = "18px";			// font size for list items within the "Other Buckets" section (aside from the section header & tickler).
...
varNextActionFontSize = "18px";				// font size for list items within the "Next Actions" section (aside from the section header).
...
varTicklerFontSize = "40px";				// font size for Tickler File link - make larger to make a more obvious "alert"
