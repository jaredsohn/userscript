// ==UserScript==
// @name           Gunmetal Ikariam (Cadmium) - Israeli Right to Left
// @namespace      Ikariam
// @description    A visual redesign for the Cadmium Edition that Fungah made, I just made it for the Right to Left version of Ikariam - v. 0.9 (last updated Oct. 18 2008)
// @version        0.9
...
// ==/UserScript==
   ...
   var URL= "http://www.ikariamods.com/gunmetal/cadmium/";
   var URL2= "http://i200.photobucket.com/albums/aa94/ExtraKiller/";   

/* IKARIAM BORDER
   border outside game window; advisors, info pane, resources etc. */
GM_addStyle("#header                                                           {background:url("+URL2+"header.png) no-repeat; position: relative; left: 139px}");
GM_addStyle("body                                                              {background:url("+URL+"hardcode/invisible.png); color: #5e5e5e; background-color: #d2d2d2}");
GM_addStyle("#footer                                                           {background-image:url("+URL2+"footer.png); position: relative; left: -5px; color: #f0f0f0; text-align: right; padding: 33px 8px 0px 39px; height: 15px; width: 962px; bottom: -18px}");
GM_addStyle("#footer a                                                         {color: #f0f0f0}");
GM_addStyle("#footer a:hover                                                   {color: #ffff00}");
GM_addStyle("#container2                                                       {background-image:url("+URL2+"content.png); position: relative}");
...
GM_addStyle("#conExtraDiv1                                                     {background-image:url("+URL+"bg/footer_bottom.png); position: absolute; width: 1020px; height: 16px; right: -16px; bottom: -14px}");
GM_addStyle("#conExtraDiv2                                                     {background-image:url("+URL2+"corner.png); position: relative; width: 154px; height: 20px; right: 819px; bottom: 48px}");
GM_addStyle("#conExtraDiv3                                                     {background-image:url("+URL2+"design.png); position: absolute; width: 96px; height: 78px; right: -58px; top: 19px}");
GM_addStyle("#conExtraDiv4                                                     {background-image:url("+URL2+"design_bg.png); position: absolute; width: 161px; height: 129px; right: -130px; top: 20px}");
/* colored banner at the top of the page */
GM_addStyle("#GF_toolbar *                                                     {color: #000000; top: 1px; left: 0px; text-decoration: none}");
GM_addStyle("#GF_toolbar *:hover, #GF_toolbar .premium a .textLabel            {color: #000000}");
GM_addStyle("#GF_toolbar .premium a .textLabel:hover                           {color: #ff0000}");
/* banner inside the game window */
GM_addStyle("#breadcrumbs                                                      {background:url("+URL+"mainview/breadcrumbs.png) no-repeat; position: absolute; left: 251px; width: 720px; height: 23px; padding: 0 0 0 1px; color: #c3c3c3; font-weight: bold; font-size: 11px}");
...
GM_addStyle("#advisors #advCities a.normal                                     {background-image:url("+URL2+"adv_city.png); margin: -2px 0px 0px  0px;  color: #000000}");
GM_addStyle("#advisors #advCities a.normal:hover                               {background-image:url("+URL2+"adv_city.png); background-position: 0px -108px; margin: -2px 0px 0px  0px;  color: #000000}");
GM_addStyle("#advisors #advCities a.normalactive                               {background-image:url("+URL2+"adv_city.png); background-position: 0px -216px; margin: -2px 0px 0px  0px;  color: #000000}");
GM_addStyle("#advisors #advCities a.normalactive:hover                         {background-image:url("+URL2+"adv_city.png); background-position: 0px -324px; margin: -2px 0px 0px  0px;  color: #000000}");
GM_addStyle("#advisors #advCities a.premium                                    {background-image:url("+URL2+"adv_city.png); margin: -2px 0px 0px  0px;  color: #000000}");
GM_addStyle("#advisors #advCities a.premium:hover                              {background-image:url("+URL2+"adv_city.png); background-position: 0px -108px; margin: -2px 0px 0px  0px;  color: #000000}");
GM_addStyle("#advisors #advCities a.premiumactive                              {background-image:url("+URL2+"adv_city.png); background-position: 0px -216px; margin: -2px 0px 0px  0px;  color: #000000}");
GM_addStyle("#advisors #advCities a.premiumactive:hover                        {background-image:url("+URL2+"adv_city.png); background-position: 0px -324px; margin: -2px 0px 0px  0px;  color: #000000}");
GM_addStyle("#advisors #advMilitary a.normal                                   {background-image:url("+URL2+"adv_military.png); margin: -2px 0px 0px  0px;  color: #000000}");
GM_addStyle("#advisors #advMilitary a.normal:hover                             {background-image:url("+URL2+"adv_military.png); background-position: 0px -108px; margin: -2px 0px 0px  0px;  color: #000000}");
GM_addStyle("#advisors #advMilitary a.normalactive                             {background-image:url("+URL2+"adv_military.png); background-position: 0px -216px; margin: -2px 0px 0px  0px;  color: #000000}");
GM_addStyle("#advisors #advMilitary a.normalactive:hover                       {background-image:url("+URL2+"adv_military.png); background-position: 0px -324px; margin: -2px 0px 0px  0px;  color: #000000}");
GM_addStyle("#advisors #advMilitary a.normalalert                              {background-image:url("+URL2+"adv_military.png); background-position: 0px -432px; margin: -2px 0px 0px  0px;  color: #000000}");
GM_addStyle("#advisors #advMilitary a.normalalert:hover                        {background-image:url("+URL2+"adv_military.png); background-position: 0px -540px; margin: -2px 0px 0px  0px;  color: #000000}");
GM_addStyle("#advisors #advMilitary a.premium                                  {background-image:url("+URL2+"adv_military.png); margin: -2px 0px 0px  0px;  color: #000000}");
GM_addStyle("#advisors #advMilitary a.premium:hover                            {background-image:url("+URL2+"adv_military.png); background-position: 0px -108px; margin: -2px 0px 0px  0px; font-weight: bold; color: #000000}");
GM_addStyle("#advisors #advMilitary a.premiumactive                            {background-image:url("+URL2+"adv_military.png); background-position: 0px -216px; margin: -2px 0px 0px  0px; font-weight: bold; color: #000000}");
GM_addStyle("#advisors #advMilitary a.premiumactive:hover                      {background-image:url("+URL2+"adv_military.png); background-position: 0px -324px; margin: -2px 0px 0px  0px; font-weight: bold; color: #000000}");
GM_addStyle("#advisors #advMilitary a.premiumalert                             {background-image:url("+URL2+"adv_military.png); background-position: 0px -432px; margin: -2px 0px 0px  0px; font-weight: bold; color: #000000}");
GM_addStyle("#advisors #advMilitary a.premiumalert:hover                       {background-image:url("+URL2+"adv_military.png); background-position: 0px -540px; margin: -2px 0px 0px  0px; font-weight: bold; color: #000000}");
GM_addStyle("#advisors #advResearch a.normal                                   {background-image:url("+URL2+"adv_research.png); margin: -2px 0px 0px  0px;  color: #000000}");
GM_addStyle("#advisors #advResearch a.normal:hover                             {background-image:url("+URL2+"adv_research.png); background-position: 0px -108px; margin: -2px 0px 0px  0px;  color: #000000}");
GM_addStyle("#advisors #advResearch a.normalactive                             {background-image:url("+URL2+"adv_research.png); background-position: 0px -216px; margin: -2px 0px 0px  0px; padding: 0 0 0 1px;  color: #000000}");
GM_addStyle("#advisors #advResearch a.normalactive:hover                       {background-image:url("+URL2+"adv_research.png); background-position: 0px -324px; margin: -2px 0px 0px  0px; padding: 0 0 0 1px;  color: #000000}");
GM_addStyle("#advisors #advResearch a.premium                                  {background-image:url("+URL2+"adv_research.png); margin: -2px 0px 0px  0px;  color: #000000}");
GM_addStyle("#advisors #advResearch a.premium:hover                            {background-image:url("+URL2+"adv_research.png); background-position: 0px -108px; margin: -2px 0px 0px  0px;  color: #000000}");
GM_addStyle("#advisors #advResearch a.premiumactive                            {background-image:url("+URL2+"adv_research.png); background-position: 0px -216px; margin: -2px 0px 0px  0px; padding: 0 0 0 1px;  color: #000000}");
GM_addStyle("#advisors #advResearch a.premiumactive:hover                      {background-image:url("+URL2+"adv_research.png); background-position: 0px -324px; margin: -2px 0px 0px  0px; padding: 0 0 0 1px;  color: #000000}");
GM_addStyle("#advisors #advDiplomacy a.normal                                  {background-image:url("+URL2+"adv_diplomacy.png); margin: -2px 0px 0px -1px;	width: 90px; color: #000000}");
GM_addStyle("#advisors #advDiplomacy a.normal:hover                            {background-image:url("+URL2+"adv_diplomacy.png); background-position: 0px -108px; margin: -2px 0px 0px -1px; width: 90px; color: #000000}");
GM_addStyle("#advisors #advDiplomacy a.normalactive                            {background-image:url("+URL2+"adv_diplomacy.png); background-position: 0px -216px; margin: -2px 0px 0px -1px; width: 90px; color: #000000}");
GM_addStyle("#advisors #advDiplomacy a.normalactive:hover                      {background-image:url("+URL2+"adv_diplomacy.png); background-position: 0px -324px; margin: -2px 0px 0px -1px; width: 90px; color: #000000}");
GM_addStyle("#advisors #advDiplomacy a.premium                                 {background-image:url("+URL2+"adv_diplomacy.png); margin: -2px 0px 0px -1px; width: 90px;  color: #000000}");
GM_addStyle("#advisors #advDiplomacy a.premium:hover                           {background-image:url("+URL2+"adv_diplomacy.png); background-position: 0px -108px; margin: -2px 0px 0px -1px; width: 90px; color: #000000}");
GM_addStyle("#advisors #advDiplomacy a.premiumactive                           {background-image:url("+URL2+"adv_diplomacy.png); background-position: 0px -216px; margin: -2px 0px 0px -1px; width: 90px; color: #000000}");
GM_addStyle("#advisors #advDiplomacy a.premiumactive:hover                     {background-image:url("+URL2+"adv_diplomacy.png); background-position: 0px -324px; margin: -2px 0px 0px -1px; width: 90px; color: #000000}");
GM_addStyle("#advisors a .textLabel 										   {position:absolute;	top:89px;	width:90px;	height:18px;	line-height:23px;	text-align:center;	cursor:pointer}");
...
GM_addStyle("#container ul.resources .wood                                     {background-image:url("+URL+"hardcode/wood.png)}");
GM_addStyle("#container ul.resources .marble                                   {background-image:url("+URL+"hardcode/marble.png)}");
GM_addStyle("#container ul.resources .wine                                     {background-image:url("+URL+"hardcode/wine.png)}");
GM_addStyle("#container ul.resources .glass                                    {background-image:url("+URL+"hardcode/glass.png)}");
GM_addStyle("#container ul.resources .sulfur                                   {background-image:url("+URL+"hardcode/sulfur.png)}");
GM_addStyle("#container ul.resources .population                               {background-image:url("+URL+"misc/population.png)}");
GM_addStyle("#container ul.resources .actions                                  {background-image:url("+URL2+"actions.png); font-weight: bold}");
/* resource images in dropdown box */
GM_addStyle("#cityNav .citySelect .tradegood1 span.cityresource                {background-image:url("+URL+"hardcode/wine.png);background-position: 5px 0px; height: 21px}");
GM_addStyle("#cityNav .citySelect .tradegood2 span.cityresource                {background-image:url("+URL+"hardcode/marble.png);background-position: 5px 0px; height: 21px}");
GM_addStyle("#cityNav .citySelect .tradegood3 span.cityresource                {background-image:url("+URL+"hardcode/glass.png);background-position: 5px 0px; height: 21px}");
GM_addStyle("#cityNav .citySelect .tradegood4 span.cityresource                {background-image:url("+URL+"hardcode/sulfur.png);background-position: 5px 0px; height: 21px}");
/* resource mouseover */
...
GM_addStyle("#globalResources .transporters a                                  {background-image:url("+URL2+"btn_transports.png); color: #f0f0f0; padding: 0 0 0 3px; text-align: left}");
GM_addStyle("#globalResources .transporters a.hover                            {background-image:url("+URL2+"btn_transports.png)}");
GM_addStyle("#globalResources .transporters a.down                             {background-image:url("+URL2+"btn_transports.png) background-position: 0px -53px}"); 
GM_addStyle("#globalResources .gold a                                          {background-image:url("+URL2+"btn_treasure.png); color: #f0f0f0; padding: 0 0 0 2px}");
GM_addStyle("#globalResources .gold a.hover                                    {background-image:url("+URL2+"btn_treasure.png)}");
GM_addStyle("#globalResources .gold a.down                                     {background-image:url("+URL2+"btn_treasure.png) background-position: 0px -53px}"); 
...
GM_addStyle("#cityNav .citySelect *                                            {background-image:url("+URL2+"citynav.png); font-weight: bold}");
GM_addStyle("#cityNav .citySelect .optionList li                               {background-image:url("+URL2+"citynav.png); color: #000000}");
GM_addStyle("#cityNav .citySelect .dropbutton                                  {color: #f0f0f0}");
/* SIDEBOXES
   info pane borders on lefthand side of page */
GM_addStyle("#container .dynamic                                               {background-image:url("+URL+"bg/sidebox.png); margin: -2px 11px 0px 17px}");
...
GM_addStyle("#container .dynamic div.footer                                    {background-image:url("+URL+"bg/sidebox_footer.png); width: 100%; height: 2px}");
GM_addStyle("#container .help                                                  {background-image:url("+URL+"misc/help.png); width: 22px; height: 30px; top: -4px; left: 3px}");
...
GM_addStyle("#island #actions .plunder                                         {background:url("+URL2+"act_pillage.png) no-repeat top center; background-position: 2px 0px}");
GM_addStyle("#island #actions .plunder a                                       {background:url("+URL2+"act_pillage.png) no-repeat top center; background-position: 2px -50px}");
GM_addStyle("#island #actions .plunder a:hover                                 {background:url("+URL2+"act_pillage.png) no-repeat top center; background-position: 2px -100px}");
...
GM_addStyle("#container #resUpgrade h4                                         {font-weight: bold; text-align: right; padding: 0 0 0 7px; margin: 8px 0 0 0; background-color: #131c23; border-left: 2px double #000000; border-right: 2px double #000000}");
GM_addStyle("#container #resUpgrade #donateForm                                {border: none; background-color: #131c23}");
GM_addStyle("#container #resUpgrade #donate label                              {font-weight: bold; text-align: right; padding: 0 0 0 1px; margin: -4px 0 1px 0}");
...
GM_addStyle("#buildingUpgrade h4                                               {background-color: #131c23; border-left: 2px double #000000; border-right: 2px double #000000; text-align: right; font-weight: bold; padding: 0 0 0 7px}");
...
GM_addStyle("#container #buildingUpgrade .resources li.time                    {float: right; margin: 0 0 3px -1px; padding: 0 0 10 80px}");
...
GM_addStyle(".militaryAdvisorTabs                                                       {background-image:url("+URL2+"contentbox_militarytabs.png); height: 18px; margin-bottom: 0px}");
GM_addStyle(".militaryAdvisorTabs #tabz td a                                            {color: #000000; font-size: 11px; margin: -3px 0 0 45px; height: 18px; line-height: 6px}");
GM_addStyle(".militaryAdvisorTabs #tabz td.selected a                                   {background-image:url("+URL2+"contentbox_militaryover.png)}");
GM_addStyle(".militaryAdvisorTabs #tabz td a:hover                                      {background-image:url("+URL2+"contentbox_militaryover.png); color: #000000; text-decoration: none}");
...
/* diplomacy advisor */
GM_addStyle("div.diplomacyAdvisorTabs                                          {background-image:url("+URL2+"contentbox_diplomacytabs.png); height: 18px; margin-bottom: 0px; line-height: 1px; font-size: 11px}");
GM_addStyle("div.diplomacyAdvisorTabs #tabz td a                               {color: #000000}");
GM_addStyle("div.diplomacyAdvisorTabs #tabz td.selected a                      {background:url("+URL2+"contentbox_diplomacyover.png); margin-top: -4px; padding-top: 8px; line-height: 3px}");
GM_addStyle("div.diplomacyAdvisorTabs #tabz td a:hover                         {background:url("+URL2+"contentbox_diplomacyover.png); margin-top: -4px; padding-top: 8px; line-height: 3px}");
...
GM_addStyle("div.diplomacyAdvisorTabs #tabz td a                               {color: #000000}");
GM_addStyle("div.diplomacyAdvisorTabs #tabz td a:hover                         {color: #000000; text-decoration: none}");
...
GM_addStyle("#container #mainview #notice                                      {background-image:url("+URL2+"contentbox_message.png); color: #c3c3c3}");
...
GM_addStyle("#missionSummary .transporters                                     {background-image:url("+URL+"content/ship_transport.png); 	text-align:left; color: #000000; margin-left: 140px; padding-left: 90px}");
GM_addStyle("#container #mainview #missionSummary .transporters #transporterCount {color: #000000}");
GM_addStyle("#mainview .sliderinput .setMin                                    {background-image:url("+URL+"hardcode/btn_max.png); margin-top: -2px; margin-left: 9px}");
GM_addStyle("#mainview .sliderinput .setMax                                    {background-image:url("+URL+"hardcode/btn_min.png); margin-top: -2px; margin-left: -14px}");
GM_addStyle("#mainview .sliderinput .sliderbg                                  {background-image:url("+URL2+"slider_empty.png)}");
GM_addStyle("#mainview .sliderinput .sliderbg .actualValue                     {background-image:url("+URL2+"slider_full.png)}");
GM_addStyle("#mainview .sliderinput .sliderbg .sliderthumb                     {background-image:url("+URL2+"slider_button.png); height: 29px; width: 16px}");
...
GM_addStyle("#academy #mainview #setScientists #sliderbg                       {background-image:url("+URL2+"slider_empty_lg.png)}");
GM_addStyle("#academy #mainview #setScientists #sliderbg #actualValue          {background-image:url("+URL2+"slider_full_lg.png)}");
GM_addStyle("#academy #mainview #setScientists .setMin                         {background-image:url("+URL+"hardcode/btn_max.png); margin-top: -6px; margin-left: 12px}");
GM_addStyle("#academy #mainview #setScientists .setMax                         {background-image:url("+URL+"hardcode/btn_min.png); margin-top: -6px; margin-left: -16px}");
GM_addStyle("#academy #mainview #setScientists #sliderbg #sliderthumb          {background-image:url("+URL2+"slider_button_lg.png); height: 34px; width: 16px}");
...
GM_addStyle("#academy #mainview div#currentResearch .progressBar               {height: 10px; border: 2px double #000000; background-color: #c3c3c3}");
GM_addStyle("#academy #mainview div#currentResearch .progressBar .bar          {background-color: #96ff00; height: 10px; border-right: 2px double #000000}");
...
GM_addStyle("#mainview #setWorkers .setMin                                     {background-image:url("+URL+"hardcode/btn_max.png); margin-top: -6px; margin-left: 7px}");
GM_addStyle("#mainview #setWorkers .setMax                                     {background-image:url("+URL+"hardcode/btn_min.png); margin-top: -6px; margin-left: -21px}");
GM_addStyle("#mainview #setWorkers #sliderbg                                   {background-image:url("+URL2+"slider_empty_lg.png);}");
GM_addStyle("#mainview #setWorkers #sliderbg #actualValue                      {background-image:url("+URL2+"slider_full_lg.png);}");
GM_addStyle("#mainview #setWorkers #sliderbg #sliderthumb                      {background-image:url("+URL2+"slider_button_lg.png);}");
GM_addStyle("#mainview #setWorkers #sliderbg #overcharge                       {background-image:url("+URL2+"slider_over.png); margin: -6px 0 0 -16px}");
...
GM_addStyle("#cityMilitary-army #container #mainview .content table th         {border: 0px double #000000}");
GM_addStyle("#cityMilitary-fleet #container #mainview .content table th        {border: 0px double #000000}");
...
GM_addStyle("#cityMilitary-army #tabz td a                                     {margin-right: -11px; margin-top: -1px; height: 17px}");
GM_addStyle("#cityMilitary-army #tabz td.selected a                            {background-image:url("+URL2+"contentbox_militaryover.png)}");
GM_addStyle("#cityMilitary-army #tabz td a:hover                               {background-image:url("+URL2+"contentbox_militaryover.png)}");
GM_addStyle("#cityMilitary-fleet #tabz td a                                    {margin-right: -11px; margin-top: -1px; height: 17px}");
GM_addStyle("#cityMilitary-fleet #tabz td.selected a                           {background-image:url("+URL2+"contentbox_militaryover.png)}");
GM_addStyle("#cityMilitary-fleet #tabz td a:hover                              {background-image:url("+URL2+"contentbox_militaryover.png)}");
/* high score */
...
/* embassy */
GM_addStyle("#embassy #container #mainview table.table01 td.online             {background-image:url("+URL2+"On.png)}");
GM_addStyle("#embassy #container #mainview table.table01 td.offline            {background-image:url("+URL2+"Off.png)}");
...
GM_addStyle("#buildingGround #container #mainview .building .resources li 	   {width:200px;   display:block;   padding-right:40px}");
GM_addStyle(".yui-navset .yui-content 										   {no-repeat 0px 4px;	color:#906646}");
GM_addStyle(".yui-navset .yui-nav .selected a, .yui-navset .yui-nav a:hover, .yui-navset .yui-content {background:url(rtl/layout/bg_tabs_single.jpg) no-repeat 0px 0px;	color:#906646}");
...
unsafeWindow.qbrenameentry = function(renameme) {
    var renameto = prompt("שנה שם לקיצור דרך:","");
...
unsafeWindow.qbaddentry = function() {
    ...
    var addname = prompt("איזה שם תרצה לקיצור דרך?","");
    if((addname.search(/\|/) != -1) || (addname.search(/;/) != -1))
    {
        alert('שם לא מובן לא | או ;!');
        exit;
    }
...
unsafeWindow.qbexport = function() {
    if(unsafeWindow.places != "0"){
        prompt("העתק את זה! תוכל ליצא את זה מאוחר יותר!", unsafeWindow.places);
    }
    else {
        alert("אין לך קיצורי דרך ליצא!");
    }
    unsafeWindow.qbbuildinterior();
}

unsafeWindow.qbimport = function() {
    var imported = prompt("הדבק כאן את קיצורי הדרך שלך, וודא כי הם כתובים באופן הנכון! (שם קיצור הדרך|http://pagelocationgoeshere.com;)","");
    if(unsafeWindow.places == "0"){
...
unsafeWindow.qbdeleteall = function() {
    if(confirm("האם אתה בטוח שהינך רוצה למחוק את כל קיצורי הדרך?"))
    {
        unsafeWindow.places = "0";
...
unsafeWindow.qbbuildinterior = function()
{
    ...
    qbHTML    += '<div id="qhead"><a style="color: #f0f0f0;">קיצורי דרך</a></div>';
    ...
    if(unsafeWindow.places != "0")
    {
        ...
        for(i = 0; i < splitplaces.length-1; i++){
            ...
            if(i>0){
            qbHTML += '<a title="הזז למעלה" href="javascript:qbmoveup(\'' + placepiece[0] + '|' + placepiece[1] + ';\');"><img src="http://www.ikariamods.com/gunmetal/cobalt/content/btn_increase.png" border="0"></a>';
            }
            else {
            ...
            qbHTML += '<a title="הזז למטה" href="javascript:qbmovedown(\'' + placepiece[0] + '|' + placepiece[1] + ';\');"><img src="http://www.ikariamods.com/gunmetal/cobalt/content/btn_decrease.png" border="0"></a>';
            }
            else {
            qbHTML += '<img src="http://www.imgboot.com/images/enigmabrand/movetrans.png" height="10" width="10" border="0">';
            }
            qbHTML += '<a title="מחק קיצור דרך" href="javascript:qbdeleteentry(\'' + placepiece[0] + '|' + placepiece[1] + ';\');"><img src="http://www.ikariamods.com/gunmetal/cobalt/content/delete.png" border="0"></a>';
            qbHTML += ' <a title="שנה שם לקיצור דרך" href="javascript:qbrenameentry(\'' + placepiece[0] + '|' + placepiece[1] + ';\');"><img src="http://www.ikariamods.com/gunmetal/cobalt/content/rename.png" border="0"></a>-</td>';
    ...
    {
    qbHTML += '<div style="border-bottom:1px #000000 solid; width:271px; height:166px; overflow-y:auto; overflow-x:hidden;"><table style="width:271px; border: none; color: #000000"><tr><td align="center">לא נשארו מקומות</td></tr></table></div>';
    }

    qbHTML += '<a href="javascript:qbaddentry();"><b><small>הוסף דף נוכחי כקיצור דרך</b></small></a><br>';
    qbHTML += '<a href="javascript:qbexport();" title="יצא רשימה"><img src="http://www.ikariamods.com/gunmetal/cobalt/content/btn_increase.png" border="0"></a>';
    qbHTML += ' <a href="javascript:qbimport();" title="יבא רשימה"><img src="http://www.ikariamods.com/gunmetal/cobalt/content/btn_decrease.png" border="0"></a>';
    qbHTML += ' <a href="javascript:qbdeleteall();" title="מחק את כל קיצורי הדרך"><img src="http://www.ikariamods.com/gunmetal/cobalt/content/delete.png" border="0"></a>';
    qbHTML += '</div>';
...
GM_addStyle("#quicktab       {background:url(http://img264.imageshack.us/img264/7137/quickbartitlekb3.png); position: absolute; height: 85px; width: 17px; left: 284px}");
...
var mynotes = GM_getValue("mynotes", "לחץ כאן בכדי להתחיל לכתוב!");
...
unsafeWindow.startnotes = function() {
    if(document.getElementById("notes").value == "לחץ כאן בכדי להתחיל לכתוב!")
    {
...
GM_addStyle("#notetab       {background:url(http://img521.imageshack.us/img521/9503/notebartitledi6.png); position: absolute; height: 85px; width: 17px; left: 345px}");
...
nbHTML    += '<div id="nhead"><a style="color: #f0f0f0;">כתבן</a></div>';
...
scriptName='Gunmetal Ikariam (Cadmium) - Israeli Right to Left';
scriptId='34968';
scriptVersion=0.9;
scriptUpdateText='לרשימה מלאה של השינויים: http://userscripts.org/scripts/show/34968';
...
GM_addStyle("#gm_update_alert_buttons span a:hover {text-decoration:none; color: #ffff00; font-weight: bold; cursor:pointer}");
                ...
                +'  <center><b><font color="#f0f0f0">Gunmetal Ikariam (Cadmium) - Israeli Right to Left</font></b><br><br>'
                +'  עידכון זמין!</center>'
                +'  <div id="gm_update_alert_button_close">'
                +'      <center>סגור</center></div>'
                +'  <div id="gm_update_alert_buttons">'
                +'  <span id="gm_update_alert_button_upgrade"><a href="http://userscripts.org/scripts/source/'+scriptId+'.user.js">עדכן מגרסא'+scriptVersion+'לגרסא'+onSiteVersion+'</a></span>&nbsp;&nbsp;'
                +'  <span id="gm_update_alert_button_scripthome"><a target="_blank" href="http://userscripts.org/scripts/show/'+scriptId+'">שף הבית של הסקריפט</a></span>&nbsp;&nbsp;'
                +'  <span id="gm_update_alert_button_wait"><a href="#">הזכר לי מחר</a></span>&nbsp;&nbsp;'
                +'  <span id="gm_update_alert_button_waitnextversion"><a href="#">הזכר לי בגרסא הבאה</a></span> </div><br>';
                document.body.insertBefore(newversion, document.body.firstChild);
                document.getElementById('gm_update_alert_button_wait').addEventListener('click', function(event) {GM_setValue('lastCheck', currentTime);alert("לא תקבל אישכור עד מחר");document.body.removeChild(document.getElementById('gm_update_alert'));}, true);
                document.getElementById('gm_update_alert_button_waitnextversion').addEventListener('click', function(event) {GM_setValue('lastVersion', onSiteVersion);alert("לא תקבל איזכור עד לעידכון הבא.");document.body.removeChild(document.getElementById('gm_update_alert'));}, true);
