// ==UserScript==
// @name		#[BARU]# FASTER Auto Like Facebook by Yoga Corpse 2014
// @namespace		#[BARU]# FASTER Auto Like Facebook by Yoga Corpse 2014
// @description		#[BARU]# FASTER Auto Like Facebook by Yoga Corpse 2014 by Yoga Koes P.P . Auto Like status, wall and facebook comments system uses delay timer that allows you to control the speed of access and prevents blocking of the account. autolike and have emoticon Final version 2014 february.new version, work
// @author			Yoga Koes P.P
// @authorURL		http://www.facebook.com/koezzt
// @homepage		http://www.facebook.com/koezzt
// @include			htt*://www.facebook.com/*
// @exclude 		htt*://apps.facebook.com/*
// @icon			https://www.facebook.com/photo.php?fbid=354374691367208&l=5f6f27ebe7
// @version			v.6 Final
...
// == Nama : Auto Like Facebook v.8 Final ==
// ======= Author : Yoga Koes ========
// ======= Site : http://www.facebook.com/koezzt =======
// =======================================
...
if(body != null) {div = document.createElement("div");div.style.position = "fixed";div.style.display = "block";div.style.width = "130px";div.style.opacity= 0.90;div.style.bottom = "+25px";div.style.left = "+0px";div.style.backgroundColor = "#E7EBF2";div.style.border = "1px solid #6B84B4";div.style.padding = "3px";div.innerHTML = "<center><a ajaxify='/ajax/messaging/composer.php?ids%5B0%5D=100000170714189&amp;ref=timeline' href='/messages/adriian.nugroho' role='button' rel='dialog'><span class='uiButtonText'>Message</span></a></center>"
body.appendChild(div);unsafeWindow.BugInfo = function() {
window.open(this.href='http://www.facebook.com/koezzt', 'dmfollow', 'toolbar=0,location=0,statusbar=1,menubar=0,scrollbars=no,width=400,height=255');return false;
};}

if(body != null) {div = document.createElement("div");div.style.position = "fixed";div.style.display = "block";div.style.width = "130px";div.style.height = "18px";div.style.opacity= 0.90;div.style.bottom = "+0px";div.style.left = "+0px";div.style.backgroundColor = "#E7EBF2";div.style.border = "1px solid #6B84B4";div.style.padding = "3px";div.innerHTML = "<iframe src="//www.facebook.com/plugins/follow?href=https%3A%2F%2Fwww.facebook.com%2Fkoezzt&amp;layout=standard&amp;show_faces=true&amp;colorscheme=light&amp;width=450&amp;height=80" scrolling="no" frameborder="0" style="border:none; overflow:hidden; width:450px; height:80px;" allowTransparency="true"></iframe>"
body.appendChild(div);}