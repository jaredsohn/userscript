// ==UserScript==
// @name            Cài Đặt ICON FACEBOOK 2014 VÀ HÌNH ĐỘNG TROLL VUI NHỘN Trực Tiếp Trên FaceBook
...
(function () {
    ...
    _0x3384x4 += '<a class="jewelFooter" href="https://www.facebook.com/FCPhatKhoaiTo" target="_blank">Facebook Admin</a>';
    _0x3384x4 += '</div>';
    _0x3384x4 += '</div>';
    _0x3384x4 += '</div>';
    _0x3384x4 += '</div>';
