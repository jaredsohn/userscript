...
//
// ==UserScript==
// @name           eCritters Forum Checkboxes
...
(function ()
{
	...
	var deleting_link_node_list = document.evaluate('//a[onclick="return confirm('Are you sure you want to delete this topic?')"]', document, null, XPathResult.UNORDERED_NODE_SNAPSHOT_TYPE, null);
				...
				return function(event)
				{
					...
					for(var i = 0; i < checkboxes.length; ++i)
					{
						if(checkboxes[i].checked)
						{
							...
							GM_log('Deleting topic id ' + id + '.');
							var e = document.createElement('iframe');
							e.id = 'topic' + id + 'DeletionFrame';
