// ==UserScript==
// @name           FB Wall Manager 2.x
// @namespace      FB Wall Manager 2.x
// @description    Manages Wall Posts for Various FB Games. This script is no longer updated. Switch to FB Wall Manager 3.x.
...
//***************************************************************************************************************************************
	...
	var flagManualAuthToken=true; //beta patch 38 stuff
...
//***************************************************************************************************************************************
	...
	var main = {
		...
		which : function(post) {try{
			...
			post.testData=testData; //jam this on the post data
