// ==UserScript==
// @name		The Corsairs Tools GDE
// @version 	74
// @namespace 	Gboz
// @author		Gboz
// @description	The Corsair Tools à la sauce GDE
...
switch (location.host) {
	default:
		...
		chaturl='.';
		//forumurl='.';
		forumurl='http://lesgde.free.fr/forums/';
		//forumurlnew='.';
		forumurlnew='http://lesgde.free.fr/forums/index.php?action=unread';
		break;
