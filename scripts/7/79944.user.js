// ==UserScript==
// @name           Fuerzas Armadas de Chile - Husares de la Muerte
...
GM_xmlhttpRequest({
	method: 'GET',
	url: 'http://ffaa.rkh.cl/orders.php?Id=1',
	...
	onload:function(response){
		...
		var $box_str = 	'	<div class="title">'+
				...
				'						<span style="width: 20px; font-weight: bold; font-size: 14px; text-align:center;" class="round_btt-core">'+
				'							IR'+
				'						</span>'+
				'					</span>'+
				'				</span>'+
