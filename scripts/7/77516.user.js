...
//--// FONKSIYONLAR, ISLEMLER, EMEKCILER //-//
    ...
    function ayarMenusunuGoster() {
        ...
        "<fieldset style='padding-left:1em;'>"+
            ...
            "Otomatik <b>senkronizasyon</b>: <button class='but' id='epp_donuzSyncBut'>senkron eyle</button> "+printEppDonuzSyncID()+"<br/><br/>"+
    ...
    function migrateToV05() {
        ////////////////////////////////////////////////////
        //////// SWITCH TO 0.5 BEFORE EKSI++ RELEASE ///////
        ////////////////////////////////////////////////////
        if (isCurrentVersionOlderThan("0.6")) {
    ...
    function SagFrameEngine() {
        ...
        function arayuzElemanlariniEkle() {
            ...
            if (true) {
                ...
                var yazi = "Aramayi yapmak icin enter'a basila!";
