...
// @include        http://s6.battleknight.onet.pl/*
// @exclude	   http://s6.battleknight.onet.pl/bk.php?loc=mail2*
// @exclude	   http://s6.battleknight.onet.pl/bk.php?loc=clan9*
// ==/UserScript==
// ===========================================================================
...
unsafeWindow.showquick = function() {
	if(document.getElementById("quickbar").style.left == "-512px")
	{
...
unsafeWindow.hidequick = function() {
	document.getElementById("quickbar").style.left = "-512px;"
}
...
unsafeWindow.qbbuildinterior = function()
{
	...
	qbHTML += '<div id="qhead"><a style="border-bottom:1px #542C0F dotted; color: #542C0F;" href="http://userscripts.org/users/55264/scripts">Battle Knight Quickbar v'+version+'</a></div>';
	...
	if(unsafeWindow.places != "0")
	{
		...
		for(i = 0; i < splitplaces.length-1; i++){
			...
			if(i>0){
			qbHTML += '<a title="Move Quickmark Up" href="javascript:qbmoveup(\'' + placepiece[0] + '|' + placepiece[1] + ';\');"><img src="http://www.iconfinder.net/data/icons/twotiny_expansion/icons/arrow-up.gif" border="0"></a>';
			}
			else {
			qbHTML += '<img src="http://i43.tinypic.com/295wdxs.png" width="10" height="10" border="0">';
			}
			if(i<splitplaces.length-2){
			qbHTML += '<a title="Move Quickmark Down" href="javascript:qbmovedown(\'' + placepiece[0] + '|' + placepiece[1] + ';\');"><img src="http://www.iconfinder.net/data/icons/twotiny_expansion/icons/arrow-down.gif" border="0"></a>';
			}
			else {
			qbHTML += '<img src="http://i43.tinypic.com/295wdxs.png" height="10" width="10" border="0">';
			}
			qbHTML += '<a title="Delete Quickmark" href="javascript:qbdeleteentry(\'' + placepiece[0] + '|' + placepiece[1] + ';\');"><img src="http://i41.tinypic.com/2r2sw8j.gif" border="0"></a>';
			qbHTML += ' <a title="Rename Quickmark" href="javascript:qbrenameentry(\'' + placepiece[0] + '|' + placepiece[1] + ';\');"><img src="http://i39.tinypic.com/349baeg.png" border="0"></a> - </td>';
	...
	qbHTML += '<a href="javascript:qbexport();" title="Export list"><img src="http://i40.tinypic.com/2q405jt.gif" border="0"></a>';
	qbHTML += ' <a href="javascript:qbimport();" title="Import list (Append)"><img src="http://i44.tinypic.com/2upxpgi.gif" border="0"></a>';
	qbHTML += ' <a href="javascript:qbdeleteall();" title="Delete all Quickmarks"><img src="http://i41.tinypic.com/27zyag7.png" border="0"></a>';
	qbHTML += '</div>';
...
// Add the style
GM_addStyle("#quickbar { width:410px; position:fixed; left:-412px; height:400px; top:0px; z-index: 500; background:url(http://i41.tinypic.com/106y1aw.gif); background-repeat:repeat-y; border:1px black solid;}");
GM_addStyle("#qhead { height:30px; width:410px; position:absolute; left:0px; top:0px; background:url(http://i41.tinypic.com/106y1aw.gif); line-height:38px; font-weight:bold; font-size:11px;} ");
...
GM_addStyle("#quicktab { z-index:496; background:url(http://i41.tinypic.com/27zddmq.png); width:26px; height:100px; position:absolute; right:-26px; top:0px; } ");
