// ==UserScript==
// @name           Grepolis Battle Report Editor
// @namespace      http://userscripts.org/scripts/show/65163
// @description    Grepolis Battle report editor prints the report as picture 
// @author         C@s, 1st release author norm
...
if(location.href.match(/action=view/)) { 
  ...
  var BerichtTitel = "[b][player]"+townOwner[0]+"[/player]'s city [town]"+townName[0]+"[/town] is attacking [player]"+townOwner[1]+"[/player][/b]";
  for(var c = 0; c < document.getElementsByTagName('div').length; c++) {
  ...
  if (document.getElementById('ReportTextArea')) {
    ...
    BerichtMenue.innerHTML='<a onclick="document.getElementById(\'ReportTextArea\').style.display=\'block\'" href="#" class="submenu_link"><span class="left">&nbsp;</span><span class="middle">BBCodes</span><span class="right">&nbsp;</span>&nbsp;</a>';
  ...
  if (document.getElementById('resources')) {
    ...
    if (wood) resourcesOutput+="[b]Wood[/b] "+wood+" ";
    if (stone) resourcesOutput+="[b]Stone[/b] "+stone+" ";
    if (iron) resourcesOutput+="[b]Silver[/b] "+iron+" ";
  }
