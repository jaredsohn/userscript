...
// objects
function CConfig() {
	this.buildingNames = ["main","barracks","stable","garage","snob","smith","place","statue","market","wood","stone","iron","farm","storage","hide","wall"];
	this.defaultBuildingLevels = [20,25,20,15,1,20,1,1,25,30,30,30,30,30,10,20];
}
