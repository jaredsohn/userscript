	...
	var grepoFarmer = ( function() {
		...
		return function() {
			...
			if (document.URL.indexOf('game/map') !== -1) {
				...
				uW.PopupFactory
						.addTexts( {
							tilx_res: 'Prada maxima a atacului curent',
					tilx_mood_drop: 'Scaderea dispozitiei la atacul curent ( in caz de prada )',
					tilx_strength_drop: 'Scaderea puterii la atacul curent ( in caz de prada )',
					tilx_strength: 'Cresterea puterii la atacul curent',
					tilx_strength_prev: 'Cresterea puterii la atacurile anterioare ( in caz de atac pentru crestere putere )',
					tilx_strength_now: 'Puterea polisului in acest moment',
					tilx_strength_total: 'Puterea dupa atac ( in caz de atac pentru crestere putere )'
