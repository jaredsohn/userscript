// JavaScript Document
// ==UserScript==
// @name           Ikariam Savaç Raporu Hazır v.1
// @autor          holyschmidt
// @license        GNU GPL v3 (http://www.gnu.org/copyleft/gpl.html)
// @homepage       
// @description    www.ikariam.forumm.biz Biz en iyisini yapana kadar en iyisi bu :)
...
// @version        2.8.2
// @exclude        http://www.ikariam.forumm.biz
...
const DEFAULT_IKCRC_FORMATTERS = {
	"bbcode"  : {  open: '[', close: ']', separator: '&#9472;', center: '[center]{TEXT}[/center]', color: '[color=#{COLOR}]{TEXT}[/color]', bold: '[b]{TEXT}[/b]', font: '[font={FONT}]{TEXT}[/font]', link: 'www.ikariam.forumm.biz', image: '[img]{IMAGE}[/img]', size: '{TEXT}' },
};
...
function BuildPlayPen() 
{
	...
	$("#troopsReport").append(	
		'<div id="ikcrcPlayPen" class="contentBox01h">' +
			'<h3 class="header">' +
				'<span id="ikcrcVersion"><a href="javascript:" id="ikcrcUpdater">(İkariam.Forumm.Biz) v' + ScriptUpdater.scriptCurrentVersion + '</a></span>' +
				'<span id="ikcrcSettings" title="Show/Hide Settings Window">Ayarlar</span>' +
				'Ikariam Savaş Raporu Hazırlayıcı v.1 ' +
			'</h3>' + 
			'<div class="content">' +
	...
	$("#ikcrcOptions").append('<span class="ikcrcEnables">' +
			'<input id="ikcrcEnableColor" type="checkbox" ' + ena_color + '/>&nbsp;Renkli' +
			'<input id="ikcrcEnableEvents" type="checkbox" ' + ena_events +'/>&nbsp;Yorumlu' +
		'</span>');
