// ==UserScript==
// @name           Post number unblock and dubs and trips alert 
// @namespace      ee
// @description    Shows post numbers and gets, and auto noko
// @include        *4chan.org*
// ==/UserScript==
	...
	if (type != 0) {
		...
		if (getType > 0) {
			...
			if (getType < colors.length)
				elements[i].innerHTML += "<b style=\"color:red" + colors[getType] + "\"> " + ++getType + "x GET!</b>";
			else
