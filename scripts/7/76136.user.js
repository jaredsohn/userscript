...
// @description    Replaces "Random Link" with "Needy Links", links that need votes. Written by shaldengeki.
...
{
	if(as[x].innerHTML == "Random link")
	{
		as[x].addEventListener("click", goNeedy, true);
		as[x].href = '';
		as[x].innerHTML= "Needy Links";
		break;
	}
}