// ==UserScript==
// @name           Turul-Master veszteség konvertáló
// @author         gaborka27
// @license        free
...
ResCalc = 
{
	...
	init : function()
	{
		...
		uW.PopupFactory.addTexts({
					rcwood_lost  : "<h4>Fa</h4></br>Milícia nincs benne.",
					rcstone_lost : "<h4>Kő</h4></br>Milícia nincs benne.",
					rciron_lost  : "<h4>Ezüst</h4></br>Milícia nincs benne.",
					rcfavor_lost : "<h4>Áldás</h4></br>",
					rcbh_lost    : "<h4>Népesség</h4>Milícia nincs benne.",
					rcatt_lost   : "Total loss by Aggressors",
					rcdef_lost   : "Total loss by Defenders",
					openResBox   : "Veszteség ablak megnyitása",
					closeResBox  : "Veszteség ablak bezárása",
		...
		if ( ResCalc.UnitData )
		{
			...
			else if ( uW.document.URL.indexOf( "action=simulator") > 0 ) 
			{
				...
				ResCalc.createResPopup('fcSim', '  <h4>  Nyersanyag táblázat  </h4> ');
			...
			else if ( uW.document.URL.indexOf( "game/building_wall?") > 0 ) 
			{
				...
				ResCalc.createResPopup( 'fcWall', 'Resources Lost' );
				...
				if (rv)
				{
					...
					if ( attCostsTable.length | defCostsTable.length )
					{
						var sumNode = $("<div style='text-align:left;font-size:9px;'>"
								+"<center><span style='text-decoration:underline;'><b>Nyersanyag veszteség</b></span>"
								+"<table cellpadding='0px' cellspacing='0px'>"
								+"<tr><td>"+attCostsTable+"</td>"
								
								+ "<td><b><table cellpadding='0px' cellspacing='0px'>"
								+ "<tr><td align=center>Fa  </td></tr>"
								+ "<tr><td align=center>Kő </td></tr>"
								+ "<tr><td align=center>&nbsp;&nbsp;Ezüst&nbsp;&nbsp;</td></tr>"
								+ "<tr><td align=center>Áldás</td></tr>"
								+ "<tr><td align=center>&nbsp;&nbsp;Népesség&nbsp;&nbsp;</td></tr></table></b></td>"
