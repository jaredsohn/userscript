// ==UserScript==
// @name           Kontrola ataków w menelgame.pl(Warszawa i Kraków)
// @namespace      s
// @description    Skrypt umożliwia kontrolę ataków i ostrzega przed zbliżającymi się walkami.
// @version        1.8.6
// @include        http://*menelgame.pl/*
// @exclude        http://board.menelgame.pl
// @exclude        http://change.menelgame.pl/*
// @exclude        http://*menelgame.pl/logout/*
// @exclude        http://*menelgame.pl/redirect/?site=*
// ==/UserScript==
...
// ***********************************************************************************************
// ***********************************************************************************************
var THISSCRIPTVERSION = "1.8.6";
var THISSCRIPTNAME = "Kontrola ataków w menelgame.pl (Warszawa, Warszawa Reloaded i Kraków)";
var THISSCRIPTINSTALL_URL = 'http://userscripts.org/scripts/show/77037';          // URL fuer Hauptseite bei userscripts.org
var THISSCRIPTSOURCE_URL = 'http://userscripts.org/scripts/source/77037.user.js'; // Skript-URL bei userscripts.org
...
var fightUrl = 'http://www.menelgame.pl/fight/'
}
if (url.indexOf('http://menelgame')>=0) {
var staticsnra = 9;
var staticsnrb = 10;
var link = 'http://www.menelgame.pl'
var fightUrl = 'http://www.menelgame.pl/fight/'
...
var fightUrl = 'http://krakow.menelgame.pl/fight/'
}
if (url.indexOf('http://www.krakow.menelgame') >=0) {
var staticsnra = 9;
var staticsnrb = 10;
var link = 'http://krakow.menelgame.pl'
var fightUrl = 'http://krakow.menelgame.pl/fight/'
}
if (url.indexOf('http://warszawa.menelgame') >=0) {
var staticsnra = 9;
var staticsnrb = 10;
var link = 'http://warszawa.menelgame.pl'
var fightUrl = 'http://warszawa.menelgame.pl/fight/'
}
if (url.indexOf('http://www.warszawa.menelgame') >=0) {
var staticsnra = 9;
var staticsnrb = 10;
var link = 'http://warszawa.menelgame.pl'
var fightUrl = 'http://warszawa.menelgame.pl/fight/'
}
if (url.indexOf('http://reloaded.menelgame') >=0) {
var staticsnra = 9;
var staticsnrb = 10;
var link = 'http://reloaded.menelgame.pl'
var fightUrl = 'http://reloaded.menelgame.pl/fight/'
}
if (url.indexOf('http://www.reloaded.menelgame') >=0) {
var staticsnra = 9;
var staticsnrb = 10;
var link = 'http://reloaded.menelgame.pl'
var fightUrl = 'http://reloaded.menelgame.pl/fight/'
...
GM_xmlhttpRequest({
	...
	onload: function(responseDetails) {
		var content = responseDetails.responseText;
		if(content.match(/już trwa/)){
			try{
				var idausgang = content.split('już trwa')[1].split("Anuluj atak")[0];
				var idaus = idausgang.split('<a href="/profil/id:')[1].split("/")[0];
				var TimeOfImpact2 = content.split(".2013")[1].split("<br />")[0];
					...
					var penner = 'Menel:<font style=\"color:#006400;\"> </font> <a href="/profil/id:'+id2+'/"><font style=\"color:#006400;\"><b>'+name+'</b></font></a>'
					var bande = 'Banda: <font style=\"color:#006400;\"></font><a href="/profil/bande:'+id21+'/"><font style=\"color:#006400;\"><b>'+name1+'</b></font></a>'
					
					var sms ='<a title="Napisz wiadomość" href="'+link+'/messages/write/?to='+id2+'"><img src="'+statics+'icons/new_msg.gif" style=\"margin-bottom:2px;\"></img></a>';
...
var suche = content.search("Nowa wiadomość!");
		try{
			if (suche != -1) {
...
// male http://i45.tinypic.com/17zojs.png   -  http://i47.tinypic.com/2zz3n86.png
					...
					tbody.innerHTML += '<div style="height: 83px; top: 105px; left: -1px; padding-top:3px;  background: url(http://static.pennergame.de/img/pv4/bg_notifyme.png);" id="notifyme" class="zabsolute zleft"><div style="margin-top:-12px; margin-right:-12px; margin-left:-14px;" class="icon ok zleft" id="nicon">&nbsp;</div><div style="margin-top:6px;" class="zleft right" id="ntext"><font style=\"color:#000000; font-size:106%;\"><u><b>Twoja bieżąca walka:</b></u></font><p><div style=\"color:#000000; font-size:12px; margin-right:-55px;\">'+penner+' <div style=\"margin-left:187px; margin-top:-22px; margin-bottom:2px;\">'+onlinex+'&nbsp;'+sms+'&nbsp;'+geschlecht_imagex+'</div></div><div style=\"color:#000000; font-size:12px; margin-right:-55px;\">'+bande+'</div><div style=\"color:#000000; font-size:12px; margin-right:-35px;\">Pieniądze:<font style=\"color:#006400; font-size:12px;\"> <b>'+cash6+' zł.; </b><font style=\"color:#000000; font-size:12px;\"> &nbsp; Koniec:</font><b><font style=\"color:#006400; font-size:12px;\">'+TimeOfImpact2+'</b></font></font></div></font></div></div>';
...
var sms2 ='<a title="Napisz wiadomość" href="'+link+'/messages/write/?to='+id2+'"><img src="'+statics+'icons/new_msg.gif" width="15" height="11"</a>';
...
+'<font style=\"color:#000000; font-size:106%;\"><u><b>Nadchodząca walka  '+anzahl+'</b></u></font><p>'
+'<div style=\"color:#000000; font-size:12px; margin-right:-55px;\">Menel: <a href="/profil/id:'+id2+'/"><font style=\"color:#006400; font-size:12px;\"><b>'+name+'</b></font></a><div style=\"margin-left:187px; margin-top:-22px; margin-bottom:2px;\">'+online+'&nbsp;'+sms2+'&nbsp;'+geschlecht_imagex2+'</div></div>'
+'<div style=\"color:#000000; font-size:12px; margin-right:-55px;\">Banda: <a href="/profil/bande:'+id21+'/"><font style=\"color:#006400; font-size:12px;\"><b>'+name1+'</b></font></a></div>'
+'<div style=\"color:#000000; font-size:12px; margin-right:-25px;\">Pieniądze: <font style=\"color:#006400; font-size:12px;\"><b>'+cash3+' zł.; </b></font>'
+'<b></b> &nbsp;&nbsp;Koniec: <font style=\"color:#006400; font-size:12px;\"> <b>'+TimeOfImpact+'</b></font> </div></div></div>';
...
if(on == 1){
var wasistlos = 'Twój przeciwnik jest online';
}else 
if(on == 2){
var wasistlos = 'Twój przeciwnik jest offline';
}else
if(on == 3){
