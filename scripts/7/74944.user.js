// ==UserScript==
// @name OGame Redesign : Perfect Plunder
// @namespace http://userscripts.org/users/74944
// @description OGame : Displays how many small/large cargos (+++ nbr of battleships and destroyers) needed to raid 1/2 of the resources on the target  
// @date 2010-08-24
// @version 	  2.1
// @creator Black Cat/modified by la faucille
// @include http://*/game/index.php?page=showmessage*
...
(function()
{
	...
	var str_small_cargo = "Sc ------->";
	var str_large_cargo = "Lc------->";
	var str_vb = "Bs------>";
	var str_dest = "Dest---->";
