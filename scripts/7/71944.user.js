// ==UserScript==
// @name           CSS GPXPlus Vert Clair
// @namespace      http://www.gpxplus.net/
// @version        0.1
// @description    Changement des styles CSS de GPXPlus avec des styles personnalises : Vert Clair
...
addGlobalStyle('@import "http://s2.e-monsite.com/2010/03/20/05/css-vertclair3.css"');
...
modifyImage.bySource("http://gpxplus.net/files/layout/dex.png", "http://s2.e-monsite.com/2010/03/20/05/dex-green.png", 1);
modifyImage.bySource("http://gpxplus.net/files/layout/logo.png", "http://s2.e-monsite.com/2010/03/20/05/logo-green.png", 1);
modifyImage.bySource("http://gpxplus.net/files/layout/online.gif", "http://s2.e-monsite.com/2010/03/20/05/online.gif", 1);
