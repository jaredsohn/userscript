...
//####################################################
// THIS PART IS COPIED FROM doyousketch2's KoC-WideMap
// found at http://userscripts.org/scripts/review/78937
...
function CHF_USERINTERFACE() {
	...
	var Floskel	= "Fear the GermanConquererCrew ]:->";
	...
	window.CHF_UI.build = function () {
		...
		var	UIdiv_main = document.createElement("div");
			...
			UIdiv_control.innerHTML = "<center>Willkommen bei Net^Devil's " + ScriptName + " ; " + Version + "<br/><b>" + Floskel + "</b><hr/></center>";
			...
			UIdiv_debug_main.innerHTML = 'Anzahl an Zeichen im Debugfenster: <input type="text" id="CHF_UI_Debug_setMaxLength" size="5" value="2000" onkeyup="CHF_setDebugMaxlength();"> (0 für keine)<hr/>';
