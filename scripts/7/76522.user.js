// ==UserScript==
// @name            techdirt print
// @include         http://*techdirt.com/articles/*.shtml
// ==/UserScript==

function do_platypus_script() {
isolate(window.document,document.evaluate('/HTML[1]/BODY[1]/DIV[4]/DIV[1]/DIV[1]/DIV[3]/DIV[2]', document, null, XPathResult.FIRST_ORDERED_NODE_TYPE,null).singleNodeValue,null,null,null);
