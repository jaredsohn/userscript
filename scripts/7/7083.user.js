// ==UserScript==
// @name           VCDQ - Binsearch + The Pirtate Bay Searcher
// @namespace      Dink
// @description    Adds a "U" and "T" button to a release's line on the main page, and the release's page itself, on VCDQ.com - Search for releases on usenet (via Binsearch.info) or torrents (via The Pirate Bay.org) - Based on the original script created by Smiths *http://userscripts.org/scripts/show/10656*
// @include        http://www.vcdq.com/*


// ==/UserScript==
var searchurl = 'http://binsearch.info/?q=$1&max=100&adv_age=365&server=';
...
{ 
	...
	{	
			...
			searchurl = 'http://binsearch.info/?q=' + fulltitle + '&max=100&adv_age=365&server=';
