// ==UserScript==
// @name          tribalwars - Smili es-BB-Codes-List-www.no9ba.eb2a.com
// @version       2.1-arabic
...
if(document.getElementById('message') || document.getElementById('intern') || document.getElementById('desc_text'))
  ...
  // Infotext
  var a = document.createElement('a');
  a.setAttribute('href','http://www.no9ba.eb2a.com');
  ...
  a.appendChild(document.createTextNode(' \n تعريب اخوكم ميدو    mido89 النخبة :)\n http://www.no9ba.eb2a.com (ver'+ver+')'));
...
if(typeof(text[attr]) != 'function')
{
  ...
  function workWithEntry(texts,n)
    ...
    if(typeof(n) != 'undefined')
      {
      var header = 'Pers?nlichen Text bearbeiten';
