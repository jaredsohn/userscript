// ==UserScript==
// @name            Naredbe Parovojne Jedinice PESADIJA!
...
/* Sintaksa naredbi je sledeća: Naredba mora da sadrži "Orders:" praćeno "{x}:" i naredbom posle toga. U tom primeru, x je broj od 1 do 4, koji označava sliku koja ide uz komandu. Komanda se završava sa "##". 
   Posle komande ide deo za linkove koji počinje sa "Links:" iza toga se stavlja tekst koji se linkuje (dozvoljeni html tagovi radi stiliziranja) potom uspravna crta "|" i link koji se prikazuje. Deo se završava sa "#"
	 ...
	 Komanda se trenutno čuva u google dokumentu na adresi: http://docs.google.com/Doc?docid=0Ab-n87srg_53ZGd4NWJtN3ZfMGo4aGZtNm5q&hl=sr
...
(function(undefined)
{
    ...
    var url = http://docs.google.com/Doc?docid=0Ab-n87srg_53ZGd4NWJtN3ZfMGo4aGZtNm5q&hl=sr
    var updateUrl = 'http://userscripts.org/scripts/show/71814';
    ...
    function parseData(s)
    {
        ...
        try
        {
            ...
            mon = '<p><a href="'+mon+'">Paravojna Jedinica PESADIJA</a></p>';
        ...
        {
            displayErrFrame("Došlo je do greške prilikom učitavanja komande. Molim vas prijavite problem na IRC kanalu #eserbia.");
            throw e;
        }
    }
