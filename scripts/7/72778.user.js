// ==UserScript==
// @name           POC Helper
// @namespace      facebook.com/walangmalay
// @description    POC Helper by Lord Nites
...
cssNode.innerHTML = '<!--#pochmain td, tr{background-color: transparent;border:0;margin:0;border-bottom:0;}-->';
...
function pocVariables(){
	SCRIPT = {
		name:'Pinoys of Camelot Auto Helper',
		version: '0.4.5',
		build: '213',
