...
// Linkadressen fuer faveladogame.com.br
if (url.indexOf("faveladogame.com.br")>=0) {

var siglink1 = "http://inodes.pennergame.de/br_PT/signaturen/";
//var siglink1 = "http://img.mendigogame.es/cache/bl_DE/signaturen/";
var tierlinks = "http://static.pennergame.de/img/pv4/shop/br_PT/tiere/";
var tierhadline = "http://www.faveladogame.com.br/headline/";
...
function user (x, id, dom, premium_bild, trk) {
	...
	if (check(7)){
		...
		if (status == 3){
			...
			var bandenstatus = 'Status: Mendigo';
		}
		else {
...
//faveladogame
				case "00001": var tier_name = 'cucaracha'; break;
				case "68930": var tier_name = 'pez colores'; break;
				case "75284": var tier_name = 'sapo'; break; 
				case "02514": var tier_name = 'paloma'; break;
				case "11836": var tier_name = 'raton'; break;
				case "58964": var tier_name = 'tatu'; break;
				case "11542": var tier_name = 'gaviota'; break;
				case "66294": var tier_name = 'gamba'; break;
				case "21903": var tier_name = 'ardilla'; break;
				case "11743": var tier_name = 'puercoespin'; break;
				case "47838": var tier_name = 'cerdo'; break;
...
//favelogame
				...
				case "cucaracha": var tier_werte = t_att +' 0 '+ t_def +' 0 '+ t_mit +' 0'; break;//neu
				case "pez colores": var tier_werte = t_att +' 1 '+ t_def +' 1 '+ t_mit +' 1'; break;//neu
				case "raton": var tier_werte = t_att +' 2 '+ t_def +' 3 '+ t_mit +' 7'; break;//neu
				case "tatu": var tier_werte = t_att +' 5 '+ t_def +' 4 '+ t_mit +' 12'; break;//neu
				case "gaviota": var tier_werte = t_att +' 7 '+ t_def +' 5 '+ t_mit +' 16'; break;//neu
				case "ardilla": var tier_werte = t_att +' 8 '+ t_def +' 3 '+ t_mit +' 1'; break;//neu
				case "puercoespin": var tier_werte = t_att +' 10 '+ t_def +' 5 '+ t_mit +' 0'; break;//neu
				case "cerdo": var tier_werte = t_att +' 13 '+ t_def +' 10 '+ t_mit +' 17'; break;//neu
				case "Igel": var tier_werte = t_att +' 18 '+ t_def +' 15 '+ t_mit +' 19'; break;//neu
				case "Hausschwein": var tier_werte = t_att +' 25 '+ t_def +' 20 '+ t_mit +' 32'; break;//neu
				case "Schneeeule": var tier_werte = t_att +' 27 '+ t_def +' 25 '+ t_mit +' 22'; break;//neu
				case "Bisamratte": var tier_werte = t_att +' 44 '+ t_def +' 38 '+ t_mit +' 10'; break;//neu
...
var table_setting = '<br /><table width = "100%" style="border-color:#000000; border:5px; border-style:groove; "><tr><th colspan="6" style="border-bottom-color:#000000; border-bottom:5px; border-bottom-style:groove; "><b><h2>Einstellung der Highscorescriptanzeige<h2></b></th></tr><tr><td colspan="2" style="border-right-color:#000000; border-right:3px; border-right-style:groove; border-bottom-color:#000000; border-bottom:1px; border-bottom-style:solid;"><b>Informacion del Mendigo: </b></td><td colspan="2" style="border-right-color:#000000; border-right:3px; border-right-style:groove; border-bottom-color:#000000; border-bottom:1px; border-bottom-style:solid;"><b>Informacion de Banda: </b></td><td colspan="2" style="border-bottom-color:#000000; border-bottom:1px; border-bottom-style:solid;"><b>Informacion mascota:</td></tr><tr style="height:12px;"><td>Puntos:</td><td style="border-right-color:#000000; border-right:3px; border-right-style:groove;">&nbsp;<input type="checkbox" name="wert1" value="points"></td><td>Puntos:</td><td style="border-right-color:#000000; border-right:3px; border-right-style:groove;">&nbsp;<input type="checkbox" name="wert2" value="points_gang"></td><td>Nombre masc:</td><td>&nbsp;<input type="checkbox" name="wert3" value="tier_name"></td></tr><tr><td>Fecha registro:</td><td style="border-right-color:#000000; border-right:3px; border-right-style:groove;">&nbsp;<input type="checkbox" name="wert4" value="reg"></td><td>num miembros:</td><td style="border-right-color:#000000; border-right:3px; border-right-style:groove;">&nbsp;<input type="checkbox" name="wert5" value="member"></td><td>Imagen:</td><td>&nbsp;<input type="checkbox" name="wert6" value="tier_bild"></td></tr><tr><td>status:</td><td style="border-right-color:#000000; border-right:3px; border-right-style:groove;">&nbsp;<input type="checkbox" name="wert7" value="cat.banda"></td><td>Barrio:</td><td style="border-right-color:#000000; border-right:3px; border-right-style:groove;">&nbsp;<input type="checkbox" name="wert8" value="points_gang"></td><td>Descripcion:</td><td>&nbsp;<input type="checkbox" name="wert9" value="tier_def"></td></tr><tr><td>Dinero:</td><td style="border-right-color:#000000; border-right:3px; border-right-style:groove;">&nbsp;<input type="checkbox" name="wert10" value="cash"></td><td>&Oslash; Puntos:</td><td style="border-right-color:#000000; border-right:3px; border-right-style:groove;">&nbsp;<input type="checkbox" name="wert26" value="duch_punktzahl"></td><td>Mascota fake:</td><td>&nbsp;<input type="checkbox" name="wert18" value="tier_tip"></td></tr><tr><td>grado alcohol:</td><td style="border-right-color:#000000; border-right:3px; border-right-style:groove;">&nbsp;<input type="checkbox" name="wert17" value="prom"></td><td>amigos-ene:*<sup><small><small>5</small></small></sup></td><td style="border-right-color:#000000; border-right:3px; border-right-style:groove;">&nbsp;<input type="checkbox" name="wert27" value="enemy_friend"></td><td>texto:</td><td>&nbsp;<input type="checkbox" name="wert28" value="tier_text"></td></tr><tr><td>Saqueo:</td><td style="border-right-color:#000000; border-right:3px; border-right-style:groove;">&nbsp;<input type="checkbox" name="wert23" value="Plunder"></td><td></td><td style="border-right-color:#000000; border-right:3px; border-right-style:groove;"></td><td>valores basicos:</td><td>&nbsp;<input type="checkbox" name="wert29" value="tier_werte"></td></tr><tr><td style="border-bottom-color:#000000; border-bottom:3px; border-bottom-style:groove;">Notiz eingabe:</td><td style="border-right-color:#000000; border-right:3px; border-right-style:groove; border-bottom-color:#000000; border-bottom:3px; border-bottom-style:groove;">&nbsp;<input type="checkbox" name="wert20" value="Notiz"></td><td style="border-bottom-color:#000000; border-bottom:3px; border-bottom-style:groove;">B-Notiz eingabe:</td><td style="border-right-color:#000000; border-right:3px; border-right-style:groove; border-bottom-color:#000000; border-bottom:3px; border-bottom-style:groove;">&nbsp;<input type="checkbox" name="wert21" value="B-Notiz"></td><td style="border-bottom-color:#000000; border-bottom:3px; border-bottom-style:groove;"></td><td style="border-bottom-color:#000000; border-bottom:3px; border-bottom-style:groove;"></td></tr><tr><td colspan="5" style="border-bottom-color:#000000; border-bottom:2px; border-bottom-style:groove;"><b>Resaltar victimas:</b></td><td style="border-bottom-color:#000000; border-bottom:2px; border-bottom-style:groove;">&nbsp;<input type="checkbox" name="wert25" value="att_color"></td></tr><tr><td colspan="6" style="height:22px; vertical-align:middle; text-align:center; border-bottom-color:#000000; border-bottom:1px; border-bottom-style:solid;"><b>Ver en columnas:</b></td></tr><tr><td style="border-bottom-color:#000000; border-bottom:2px; border-bottom-style:groove;">Puntos mendigo:</td><td style="border-bottom-color:#000000; border-bottom:2px; border-bottom-style:groove; border-right-color:#000000; border-right:2px; border-right-style:groove;">&nbsp;<input type="checkbox" name="wert12" value="points_2"></td><td style="border-bottom-color:#000000; border-bottom:2px; border-bottom-style:groove;">Dinero:</td><td style="border-bottom-color:#000000; border-bottom:2px; border-bottom-style:groove; border-right-color:#000000; border-right:2px; border-right-style:groove;">&nbsp;<input type="checkbox" name="wert13" value="cash2"></td><td style="border-bottom-color:#000000; border-bottom:2px; border-bottom-style:groove;">Alcohol:</td><td style="border-bottom-color:#000000; border-bottom:2px; border-bottom-style:groove;">&nbsp;<input type="checkbox" name="wert14" value="prom2"></td></tr><tr><td colspan="4" style="border-bottom-color:#000000; border-bottom:2px; border-bottom-style:groove;"><b>Plantilla visualizacion 1-6</b>&nbsp;*</td><td colspan="2" style="border-bottom-color:#000000; border-bottom:2px; border-bottom-style:groove;"><input name="ausgabe" type="text" size="2" maxlength="1" value="'+ ausgabe[0] +'"></td></tr><tr><td colspan="5" style="border-bottom-color:#000000; border-bottom:1px; border-bottom-style:groove;"><b>Dinero a color:</b>&nbsp;*<sup><small><small>2</small></small></sup></td><td style="border-bottom-color:#000000; border-bottom:1px; border-bottom-style:solid;">&nbsp;<input type="checkbox" name="wert15" value="color_cash"></td></tr><tr><td colspan="6" style="border-bottom-color:#000000; border-bottom:1px; border-bottom-style:solid;">casilla entera <input type="radio" name="wert22" value="Zelle"> solo dinero  <input type="radio" name="wert22" value="Text"> marcar en color ?</td></tr><tr><td colspan="2" style="border-right-color:#000000; border-right:1px; border-right-style:solid;">Dinero en verde :</td><td colspan="2" style="border-right-color:#000000; border-right:1px; border-right-style:solid;">Dinero en amarillo :</td><td colspan="2" style="border-right-color:#000000; border-right:1px; border-right-style:solid;">Dinero en rojo :</td></tr><tr><td colspan="2" style="border-bottom-color:#000000; border-bottom:2px; border-bottom-style:groove; border-right-color:#000000; border-right:1px; border-right-style:solid;">De:&nbsp;<input name="ausgabe" type="text" size="5" maxlength="15" value="'+ ausgabe[1] +'"> <br />a:&nbsp;&nbsp;<input name="ausgabe" type="text" size="5" maxlength="15" value="'+ ausgabe[2] +'"></td><td colspan="2" style="border-bottom-color:#000000; border-bottom:2px; border-bottom-style:groove; border-right-color:#000000; border-right:1px; border-right-style:solid;">De:&nbsp;<input name="ausgabe" type="text" size="5" maxlength="15" value="'+ ausgabe[3] +'"> <br />a:&nbsp;&nbsp;<input name="ausgabe" type="text" size="5" maxlength="15" value="'+ ausgabe[4] +'"></td><td colspan="2" style="border-bottom-color:#000000; border-bottom:2px; border-bottom-style:groove; border-right-color:#000000; border-right:1px; border-right-style:solid;">De:&nbsp;<input name="ausgabe" type="text" size="5" maxlength="15" value="'+ ausgabe[5] +'"> <br />a:&nbsp;&nbsp;<input name="ausgabe" type="text" size="5" maxlength="15" value="'+ ausgabe[6] +'"></td></tr><tr><td colspan="4" style="border-bottom-color:#000000; border-bottom:2px; border-bottom-style:groove;"><b>Mensaje por dinero superior:</b> *<sup><small><small>3</small></small></sup></td><td style="border-bottom-color:#000000; border-bottom:2px; border-bottom-style:groove;">De:&nbsp;<input name="ausgabe" type="text" size="5" maxlength="15" value="'+ ausgabe[7] +'">&nbsp;&euro;</td><td style="border-bottom-color:#000000; border-bottom:2px; border-bottom-style:groove;">&nbsp;<input type="checkbox" name="wert16" value="alert_M"></td></tr>               <tr><td colspan="5" style="border-bottom-color:#000000; border-bottom:2px; border-bottom-style:groove;"><b>Activar funcion de busqueda:</b> *<sup><small><small>4</small></small></sup></td><td style="border-bottom-color:#000000; border-bottom:2px; border-bottom-style:groove;">&nbsp;<input type="checkbox" name="wert11" value="kill_submenu"></td></tr>                  <tr><td colspan="5" style="border-bottom-color:#000000; border-bottom:2px; border-bottom-style:groove;"><b>insertar estado nuestro mendigo:</b></td><td style="border-bottom-color:#000000; border-bottom:2px; border-bottom-style:groove;">&nbsp;<input type="checkbox" name="wert19" value="status"></td></tr><tr><td colspan="5" style="border-bottom-color:#000000; border-bottom:2px; border-bottom-style:groove;"><b>Funcion de busqueda<sup><small><small>4</small></small></sup>:</b></td><td style="border-bottom-color:#000000; border-bottom:2px; border-bottom-style:groove;">&nbsp;<input type="checkbox" name="wert24" value="points_sort"></td></tr><tr><td colspan="6"  style="border-bottom-color:#000000; border-bottom:3px; border-bottom-style:groove;"><b>*</b>&nbsp;Die Sortieroption dient dazu die Werte in den Feldern "Pennerinfo" und "Bandeninfo" unterschiedlich zu gestalten. Es kann sein das bei wenig ausgewählten Anzeigewerten die verschiedenen Sortieroptionen keinen sichtbaren Unterschied haben, bei allen Anzeigewerten gibt es jedoch immer einen Unterschied.<br /><b>*</b><sup><small><small>2</small></small></sup>&nbsp;"Geldanzeige farbig hervorheben" dient dazu das ab einen, für den Nutzer wichtigen Geldwert, dieser farbig hervorgehoben wird. Es müssen <u>nicht</u> alle Farben genutzt werden! Es ist darauf zu achten das die eingegebenen Werte in dem Schema "Von" niedrigen "Bis" zum höheren Wert angegeben werden.<br /><b>*</b><sup><small><small>3</small></small></sup>&nbsp;Die Alarmmeldung gibt ab den eingestellten Wert eine Alertfenster aus und markiert den Treffer farbig.<br />                 <b>*</b><sup><small><small>4</small></small></sup>&nbsp;Schaltet die Pennergame suchfunktion an und aus ,somit erspart ich euch das ewige klicken auf der Lupe.(das suchfeld ist immer an oder aus wie man es gerade einstellt<br />                 <b>*</b><sup><small><small>5</small></small></sup> "Bü/Fe -anzeigen" steht für Bündnis- Feindeanzeigen. Die Funktion schreibt im Bandenbereich ob jemand ein Freund oder ein Feind ist. Bei Freunden wird gleichzeitig die Angriffsmöglichkeit entfernt.</tr><tr><td colspan="4" style="border-right-color:#000000; border-right:2px; border-right-style:groove;">Eguardar cambios:&nbsp;&nbsp;<input type="button" value="Guardar"></td><td colspan="2"><input type="button" name="closeSetting" value="terminar"></td></tr></table>';
...
try {			
	...
	div.innerHTML += '<br /><input type="button" name="setting" value="Configuracion">'
