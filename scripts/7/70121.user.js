// ==UserScript==
	// @name		        g.e-hentai.org monkeystyle template v.1.1
	// @namespace	        none
...
//frontpage_check = _Frontpage_Check() // 1 = frontpage or any frontpage subpage like page 2,3,4 etc.
...
//=============================================================
function _Put_img_scr_toarray(i,item_src, item_data, item_alt, item_href)
{
...
function _append_divs_to_dummy_divTag(i)
{
	...
	var divTag = document.createElement("div");
		...
		+'<div style="width:202px; height:290px; margin:auto; text-align:center; overflow:hidden"><a href=" ' +gallery_href[i]+ ' "><img src="'+img_scr[i]+'" alt="'+gallery_name[i]+'" title="'+gallery_name[i]+'" style="border:0; margin:auto" /></a></div>'
		+'</div>';		
