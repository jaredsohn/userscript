...
// @namespace      http://hikmahnet.co.cc
// @description    Emoticon for Status and chat
...
String.prototype.isPrefixOf = function(str, from){
	...
	var emoticons = [];
	emoticons[":)"] = {
		src: "http://www.addemoticons.com/emoticon/animated/AddEmoticons04225.gif",
		alt: "happy"
	};
	emoticons[":("] = {
		src: "http://www.addemoticons.com/emoticon/animated/AddEmoticons04242.gif",
		alt: "sad"
	};
	emoticons[";)"] = {
