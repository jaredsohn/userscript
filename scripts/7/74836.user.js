...
// @namespace      http://userscripts.org/users/111686
// @description    Treasure Isle Wall Manager Turkce Versiyon 1.2 ana sayfadan arkadaşlarınızın yayınladığı hediyeleri toplar 
// @include        http://*.facebook.com/*
// @include        https://*.facebook.com/*
// @include        http://facebook.com/*
// @include        https://facebook.com/*
// @copyright      Turkce Versiyon Ozay DEMIR
// @version        1.2
...
var version = "1.2 Turkce Versiyon Ozay DEMIR"; // cant use cdata+regexp to grab version dynamically because of webkit
...
// $g by JoeSimmons Turkce Ozay DEMIR. Supports ID, Class, and XPath (full with types) in one query
...
// GM_config by JoeSimmons Tr Ozay DEMIR/sizzlemctwizzle/izzysoft
var GM_config = {
...
pauseCount : 0,
profile : "",
acceptedText : "Animal Adopted!",
failText : "Failed to Get!",
...
whichRegex : /(gem|bonus|save|fruit|unknown|fatto)/,
ampRegex : /&amp;/g,
spaceRegex : /\s+/g,
...
accText : {
			...
			bonus : "Bonus Alindi!",
			save : "Hayvan Alindi",
			unknown : "Bilinmeyen Hayvanlar Alindi!",
			fruit : "Bulunan Meyveler Alindi!",
			fatto : "Fatto Alindi!",
		},

// Created by avg, modified by JoeSimmons Tr Modifiye Ozay DEMIR. shortcut to create an element
...
switch(w) {
case "bonus": w="bonus"; break;
case "fruit": w="fruit"; break;
case "gem": w="gem"; break;
...
var statusText = !main.boxFull ? (!main.paused?"["+main.gameAcronym+"] "+main.currReqs+" Requests Currently.":(!main.pauseClick?("["+main.pauseCount+"] "):"")+"[PAUSED] Click This Box to Unpause") : "[STOP] Gift box FULL - Refresh Page To Continue";
...
// pre-load the config
GM_config.init("<center><table><tr><td><img src='"+imgs.logo+"' width=50% height=50%></td><td>Treasure Isle Wall Manager v. "+version+" by Sisko English Conversion by Michael</td></tr></table></center>", {
	bonus : {
		section : ["Ayarlar"],
	...
	adopt : {
		label : "Hayvanlar Alinsinmi?",
		type: "checkbox",
		"default" : true,
		kids : {
			unknown : {
				label : "Bilinmeyen Hayvanlar alinsinmi?",
				type: "checkbox",
				"default" : true
			}
		}
	...
	gem : {
		label : "Mucevherler Alinsinmi?",
		type: "checkbox",
		"default" : true,
	},
	fruit : {
		label : "Meyve Alinsinmi?",
		type: "checkbox",
		"default" : true,
	},
	sloth : {
		section : ["Alinan Hayvan Ozellikleri"],
		label : "Tembel Hayvan",
		type : "checkbox",
		"default" : false,
	},
	margay : {
		label : "Amarikan vahsi kedisi",
		type : "checkbox",
		"default" : false,
	},
	toucan : {
	...
	arinterval : {
			...
			options : {
				...
				five : "5 Dakika",
				ten : "10 Dakika",
				"30s2m" : "30 saniyede 2 dakikada bir rasgele gonder"
			},
			"default" : "30sny-2dk rasgele"
	},
	filteronly : {
		label : "Sadece Filtre Sayfasinda Calissinmi?",
		type : "checkbox",
		"default" : false
	},
	/*autolike : {
		label : "Otomatik \"Benzer\" Mesajlara Tiklansinmi? (buggy; use at own risk)",
		type : "checkbox",
		"default" : false
	},*/
	status : {
	...
	inputtimeoutenable : {
		label : "Yazmak icin Durdur",
		type : "checkbox",
		"default" : false,
		kids : {
			inputtimeout : {
				label : "Zaman Asimi (Durma suresi)",
				type : "float",
				"default" : 30
			}
		}
...
try {
GM_registerMenuCommand("Treasure Isle Wall Manager Ayarlar v. "+version, main.config);
} catch(e) {}
...
main.create("a", {className:"item", href:"javascript:void(0);", onclick:main.config}, new Array(
	...
	main.create("span", {textContent:"Treasure Isle Wall Manager Ayarlar v. "+version})
))
)));
}
