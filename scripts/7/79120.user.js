// ==UserScript==
    // @name           InfoDefenScript
    // @namespace      www.erepublik.com
    // @description    Ordens ePortugal (eRepublik)
    // @version        1.7
...
// ========= ADD FROM HERE ONWARDS TO YOUR SCRIPT =========
	...
	scriptName='InfoDefenScript';
	scriptId='79120';
	scriptVersion=1.7;
	scriptUpdateText='UPDATE 1.7- tirar o titulo "Script" para aspecto mais limpo';
	// === Stop editing here. ===
