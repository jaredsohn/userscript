...
thisElement.parentNode.insertBefore(lnk, thisElement);

var Share = document.getElementById('watch-actions-share');  // currently in development
var Twitterbtn = document.createElement('input');	     // instead of clicking share this will put the twitter
Twitterbtn.setAttribute('type', 'button');		     // button on the page
Twitterbtn.value = "Twitter";
Share.parentNode.appendChild(Twitterbtn, Share);
