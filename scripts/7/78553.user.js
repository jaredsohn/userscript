// ==UserScript==
// @name           eRepublik Poslovensky
// @author          Nicneumel, radim, ferok
// @description   eRepublik Poslovensky
...
// menu
  "Home" : "Domov",
  "Donate" : "Pošli peniaze",
  "May" : "Máj",
  "June" : "Jún",
  "July" : "Júl",
  "Day " : "Deň ",
  " of the New World" : " nového sveta",
  "Rank" : "Hodnotenie",
  "Company" : "Firma",
  "Training grounds" : "Trening v kasárňach",
  "Profile": "Profil",
  "Party" : "Strana",
  "Newspaper" : "Noviny",
  "Army" : "Armáda",
  "Country administration" : "Správa zeme",
  "Organizations" : "Organizácie",
  "Market" : "Obchod",
  "Monetary market" : "Zmenáreň",
  "Monetary Market" : "Zmenáreň",
  "Job market" : "Trh práce",
  "Companies for sale" : "Firmy na predaj",
  "Get Gold & Extras" : "Získaj zlato a bonusy",
  "Rankings" : "Štatistiky",
  "Social stats" : "Sociální štatistiky",
  ...
  "Blog" : "Blog",
  "News" : "Noviny",
  "Invite friends" : "Pozvi kamaráta",
  "eRepublik Shop" : "eRepublik shop",
  "Shop" : "Obchod",
  "Press" : "Tlač",
  "Contact" : "Kontakt",
  "Jobs" : "Práca",
  "Terms of Service" : "Podmienky prevádzky",
  "Privacy" : "Sukromie",
  "Affiliates" : "Pobočky",
  "eRepublik Laws" : "Zákony eRepublik",
  "Career path" : "Kariérný postup",
  "You should work today" : "Dnes by si mal ísť do práce",
...
// flash menu
  "My places > Army" : "Moje místa > Armáda",
