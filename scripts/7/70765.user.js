// ==UserScript==
// @name           Newgrounds Search Filter
// @namespace      greasemonkey.knugen.com/ngsearchfilter
// @description    Allows you to filter out results when using the portal search
// @include        http://www.newgrounds.com/portal/search/*
// @include        http://newgrounds.com/portal/search/*
// ==/UserScript==
...
{
	var score	= tr.getElementsByClassName('sts')[0].getElementsByClassName('yellow')[0].textContent;
	return score;
}
