// ==UserScript==
// @name           seanb1979 owner label
// @namespace      seanb1979 owner label
...
function findName(test) {
    if (test.innerHTML.indexOf('/game/home.pl?user_id=211285', 0)>=0) return 1;
  return 0;
}
...
for(var i=0,j=els.length; i<j; i++) {
	if (findName(els[i])){
		...
		els[i].innerHTML = els[i].innerHTML + '<b>R.I.P. Shortbus Allstars</b><br/>'
