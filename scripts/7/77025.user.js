...
addGlobalStyle('div#main_container { position:absolute; top:98px; left:54%; margin-left:-27px; width:214px;}')
// textkopf
addGlobalStyle('span.Head {line-height:180%; font-size:11px; font-weight:bold; color:#FFFFFF; text-decoration:underline; padding:8px 0px 0px 30px;}')
// container groesse und aussehen schriftausrichtung
addGlobalStyle('.inhalt_container { padding-bottom:5px; padding-left:6px; background: url(http://membres.lycos.fr/kendo2000/ende.png);background-position:-10px -5px; -moz-border-radius:10px; font-weight:bold; color:#000000; font-size:11px; text-align:left; } ')
...
addGlobalStyle('div.prozentbalken_1 { background-repeat: repeat-x; border:none;border-right:1px solid #000;padding-left:3px;background:url('+medialink+'/img/processbar.jpg);font:9px Verdana,Arial,Helvetica,sans-serif;position:relative;height:11px;z-index:1;}')
...
addGlobalStyle('div#container_pet_training { position:absolute; top:206px; left:54%; margin-left:-27px; width:214px; }')
...
GM_xmlhttpRequest({
  ...
  url: gamelink+"/overview/",
      ...
      var content = response.responseText;
		...
		// menue bilden
		Weiterbildung.innerHTML = "<div id=\"main_container\" >"+inhalt_container_2+"<div class=\"inhalt_container\"><br/>En cours: <span style=\"color:#FFFFFF;\">"+w_type1+" ["+w_type1_stufe+"]</span><br/>"+weiterbildung_0_1+"<br/>"+weiterbildung_0_2+"</div></div>";
	...
	url: gamelink+"/skills/pet/",
		onload: function(response) {
			...
			try {
				...
				// menue bilden
				pettraining.innerHTML = "<div id=\"container_pet_training\"><div class=\"inhalt_container\"><br/>En cours: <span style=\"color:#FFFFFF;\">"+w_type1+" ["+w_type1_stufe+"]</span><br/>"+weiterbildung_0_1+"<br/>"+weiterbildung_0_2+"</div></div>";
