// ==UserScript==
// @name           [K]Highscore v1.4.6 Poprawki + tlumaczenie + rozszerzenie by pepies + update by VILQ
// @namespace      
...
// @include        http://*krakow.menelgame.pl/highscore/*
// ==/UserScript==
...
var siglink = "http://img.krakow.menelgame.pl/cache/signaturen/";
...
function Geldladen(id,x) {
	GM_xmlhttpRequest({
    	method: 'GET',
   	url: 'http://www.krakow.menelgame.pl/dev/api/user.' + id + '.xml',
        ...
        onload: function(responseDetails) {
			...
			if (id_gang != 0 && id_gang != 'None') {
				GM_xmlhttpRequest({
					method: 'GET',
					url: 'http://www.krakow.menelgame.pl/dev/api/gang.' + id_gang +'.xml',
					onload: function(responseDetails) {
			...
			GM_xmlhttpRequest({
				method: 'GET',
				url: 'http://www.krakow.menelgame.pl/profil/id:'+ id +'/',
				onload: function(responseDetails) {
					...
					try {
						var side_split_3 = side_split_2[0].split('<img style="margin-top:3px" src="http://www.krakow.menelgame.pl/headline/');
					...
					try {
					    ...
					    //var haustier = ' <img style="margin-top:3px" src="http://www.krakow.menelgame.pl/headline/' + tier_ueberschrift +'/?size=28" /><br />'+ haustier_bild + '<br />' +  tier_tip;
				...
				if(hausi2 == '<img src="http://media.krakow.menelgame.pl/img/tiere/94826.jpg">')
			{
				var petname = 'Słoń';
			}
			else if(hausi2 == '<img src="http://media.krakow.menelgame.pl/img/tiere/25834.jpg">')
			{
				var petname = 'Nosorożec';
			}
			else if(hausi2 == '<img src="http://media.krakow.menelgame.pl/img/tiere/14896.jpg">')
			{
				var petname = 'Niedźwiedź';
			}
			else if(hausi2 == '<img src="http://media.krakow.menelgame.pl/img/tiere/12536.jpg">')
			{
				var petname = 'Małpa';
			}
			else if(hausi2 == '<img src="http://media.krakow.menelgame.pl/img/tiere/43703.jpg">')
			{
				var petname = 'Tygrys';
			}
			else if(hausi2 == '<img src="http://media.krakow.menelgame.pl/img/tiere/73953.jpg">')
			{
				var petname = 'Krokodyl';
			}
			else if(hausi2 == '<img src="http://media.krakow.menelgame.pl/img/tiere/98962.jpg">')
			{
				var petname  = "Żyrafa";
			}
			else if(hausi2 == '<img src="http://media.krakow.menelgame.pl/img/tiere/64220.jpg">')
			{
				var petname  = "Hipopotam";
			}
			else if(hausi2 == '<img src="http://media.krakow.menelgame.pl/img/tiere/90385.jpg">')
			{
				var petname  = "Koń";
			}
			else if(hausi2 == '<img src="http://media.krakow.menelgame.pl/img/tiere/32563.jpg">')
			{
				var petname  = "Chihuahua";
			}
			else if(hausi2 == '<img src="http://media.krakow.menelgame.pl/img/tiere/62456.jpg">')
			{
				var petname  = "Cockerspaniel";
			}
			else if(hausi2 == '<img src="http://media.krakow.menelgame.pl/img/tiere/15240.jpg">')
			{
				var petname  = "Pitbull";
			}
			else if(hausi2 == '<img src="http://media.krakow.menelgame.pl/img/tiere/09051.jpg">')
			{
				var petname  = "Owczarek";
			}
			else if(hausi2 == '<img src="http://media.krakow.menelgame.pl/img/tiere/48263.jpg">')
			{
				var petname  = "Orzeł";
			}
			else if(hausi2 == '<img src="http://media.krakow.menelgame.pl/img/tiere/12758.jpg">')
			{
				var petname  = "Pudel";
			}
			else if(hausi2 == '<img src="http://media.krakow.menelgame.pl/img/tiere/62474.jpg">')
			{
				var petname  = "Koza";
			}
			else if(hausi2 == '<img src="http://media.krakow.menelgame.pl/img/tiere/61402.jpg">')
			{
				var petname  = "Wąż";
			}
			else if(hausi2 == '<img src="http://media.krakow.menelgame.pl/img/tiere/89386.jpg">')
			{
				var petname  = "Sokół";
			}
			else if(hausi2 == '<img src="http://media.krakow.menelgame.pl/img/tiere/73735.jpg">')
			{
				var petname  = "Kot";
			}
			else if(hausi2 == '<img src="http://media.krakow.menelgame.pl/img/tiere/21903.jpg">')
			{
				var petname  = "Fretka";
			}
			else if(hausi2 == '<img src="http://media.krakow.menelgame.pl/img/tiere/77310.jpg">')
			{
				var petname  = "Zając";
			}
			else if(hausi2 == '<img src="http://media.krakow.menelgame.pl/img/tiere/73684.jpg">')
			{
				var petname  = "Szczur";
			}
			else if(hausi2 == '<img src="http://media.krakow.menelgame.pl/img/tiere/31451.jpg">')
			{
				var petname  = "Gołąb";
			}
			else if(hausi2 == '<img src="http://media.krakow.menelgame.pl/img/tiere/52483.jpg">')
			{
				var petname  = "Papużka";
			}
			else if(hausi2 == '<img src="http://media.krakow.menelgame.pl/img/tiere/73308.jpg">')
			{
				var petname  = "Chomik";
			}
			else if(hausi2 == '<img src="http://media.krakow.menelgame.pl/img/tiere/11836.jpg">')
			{
				var petname  = "Mysz";
			}
			else if(hausi2 == '<img src="http://media.krakow.menelgame.pl/img/tiere/68930.jpg">')
			{
				var petname  = "Złota Rybka";
			}
			else if(hausi2 == '<img src="http://media.krakow.menelgame.pl/img/tiere/00001.jpg">')
			{
