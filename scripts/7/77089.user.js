// ==UserScript==
// @name            eWeek print
// @include         http://www.eweek.com/index2.php?option=content&task=view&id=*
// ==/UserScript==

function do_platypus_script() {
fix_page_it(window.document,'/HTML[1]',null,null,null);
isolate(window.document,document.getElementById('intelliTxt'),null,null,null);
relax(window.document,document.getElementById('intelliTxt'),null,null,null);
