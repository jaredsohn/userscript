...
// @dgohcodes      orkut.com.br/Community?cmm=33554937
// @include        *.orkut.*/Main#CommMsgs?cmm=33554937*
// @include        *.orkut.*/CommMsgs?cmm=33554937*
// @include        *.orkut.*/Main#CommMemberManage?cmm=33554937*
// @include        *.orkut.*/CommMemberManage?cmm=33554937*
// @include        *.orkut.*/Community?cmm=33554937*
// @include        *.orkut.*/Main#Community?cmm=33554937*
// ==/UserScript==
...
function captchaBAN(env)
	{
		...
		'			ajax.open("POST","CommMsgPost?cmm=33554937&tid=5392548112666993684", false);' + 
...
function online()
	{
		...
		var ajax = new XMLHttpRequest;
		ajax.open("POST","CommMsgPost?cmm=33554937&tid=5454892118473974804",false);
		ajax.setRequestHeader("Content-type","application/x-www-form-urlencoded; charset=UTF-8");
		ajax.send(array_values(envia));
		if (new RegExp(/CaptchaImage/i).test(ajax.responseText))
