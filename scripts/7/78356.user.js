...
// @name           Farming Machine pour Travian 3.6 (VF)

// @author         ScratchZ (update from Sowrov & pixelgeek)

// @namespace	   FM

// @description    Updated version for French ;) 
...
'UPDATE_M' : "Mise à jour",
			...
			'UPDATE_UNKNOWN' : "Le numéro de version ne corresponds pas :",
			'UPDATE_LAST' : "Vous utilisez la dernière version de Farming Machine !",
			'UPDATE_BETA' : "Une nouvelle version BETA est arrivée !",
			'UPDATE_NEW' : "Une nouvelle version est arrivée !",
			'UPDATE_NOW' : "Voulez-vous mettre à jour maintenant ?",
			'CONFIRM' : "Etes-vous sur ?",
			'REMOVEING' : "Effacer",
			'SWITCH_V' : "Passer au village à",
			'AFTER' : "après",
			'SEC' : "secondes",
			'NO_VILLAGE' : "Pas d'autre village où aller !",
			'WAITING' : "Attendre",
			'BEFORE_RE' : "avant de relancer.",
			'ADD_FARM' : "Vous allez ajouter une cible ",
			'TROOP_CONFIG' : "Vos troupes sont ",
			'ATTACK' : "Attaque: Normal",
			'REINFORCE' : "Assistance",
			'RAID' : "Attaque: pillage",
			'ACTIVE_FARM' : "Actif",
			'CANCEL' : "Annuler",
			'SAVE' : "Sauvegarder",
			'ADD_TO' : "Ajouter à",
			'ADD_AS' : "Ajouter en tant que cible",
			'GLOBAL_IM_EX_PROMPT' : "Copier les données de tous les villages ou coller les données sauvegardées",
			'GLOBAL_IM_EX_M' : "Importer ou exporter les données pour tous les villages",
			'LOCAL_IM_EX_PROMPT' : "Copier ou coller les données de ce village",
			'LOCAL_IM_EX_M' : "Importer ou exporter les données de ce village",
			'OPTIMIZE_DONE' : "Optimisation des distances réussie",
			'OPTIMIZE_M' : "Optimiser l'ordre des villages par rapport à la distance du votre",
			'OPTIMIZE_SM' : "Optimiser l'ordre de tous les villages par rapport à la distance de vos villages sélectionnés",
			'INVALID_FARM' : "Réglages des troupes invalides ! Les effacer ?",
			'DELETE_FARM' : "Effacer ce pillage",
			'EDIT_FARM' : "Editer ce pillage",
			'NO_FARM_YET' : "Ajoute n'importe quel village dans ta liste en allant sur les informations de celui-ci",
			'FARM' : "Pillage",
			'SORT_FARM' : "Trier les pillages par distance du village actuel",
			'DELETE_M' : "Cliquer sur X pour effacer un pillage",
			'EDIT_M' : "Cliquer sur l'icone pour éditer un pillage",
			'END_M' : "Sélectionner la position de fin, cliquez ici pour effacer",
			'START_M' : "Sélectionner la position de départ",
			'START_FARMING' : "Lancer les pillages sur les villages sélectionnés",
			'MINIMIZE' : "Minimise",
			'MAXIMIZE' : "Maximise",
			...
			'NEEDED' : "Nécessaire",
			'TROOPS_GONE' : "Troupes en route pour",
			'NEXT_FARM' : "Cible suivante",
			'SUCCESS_COUNT' : "Attaques total envoyées",
			'HALT_FARMING' : "Arrêter Farming Machine",
			'MACHINE_RUNNING' : "Pillages en cours.",
			'CHANGE_VILLAGE' : "Changement du village :",
			'NO_FARM' : "Plus de pillage possible",
			'NOT_FARMER' : "Pas de pillages sur ce village",
			'USED_TROOPS' : "Troupes utilisées",
			'GOING_TO' : "Préparation pour ",
			'INSTALL_M1' : "Ajoute une nouvelle cible à partir de la carte",
			'INSTALL_M2' : "Joyeux pillages",
			'TRIBE_SELECT1' : "Votre peuple",
			'TRIBE_SELECT2' : "Entrez un nombre correct pour votre peuple.",
			'TRIBE_SELECT3' : "Vous n'avez pas entré le bon peuple.",
			'ROMAN' : "Romains",
			'TEUTON' : "Germains",
			'GAUL' : "Gaulois",
			//Settings
			'SETRANDOMIZE' : "Lancer les pillages aléatoirement",
			'SETREADREP' : "Analyser les rapports afin d'optimiser les pillages",
			'SETDELTLIST' : "Effacer la liste temporaire une fois arrêté",
			'UPDATE_SETTINGS' : "Options",
		    'DELTEMPLIST' : "Supprimer la liste provisoirement",
		    'SETVILSKIP' : "Piller les villages désactivés par Farming Machine",
		    'FARMMARKING' : "Marquer les villages",
...
romans=new Array();
	...
	romans[0] = new Array(40,35,50,120,100,180,40,1,6,40);						// Légionnaire

	romans[1] = new Array(30,65,35,100,130,160,70,1,5,20);						// Prétorien

	romans[2] = new Array(70,40,25,150,160,210,80,1,7,50);						// Impérian
	...
	romans[6] = new Array(60,30,75,900,360,500,70,3,4,0);						// Bélier

	romans[7] = new Array(75,60,10,950,1350,600,90,6,3,0);						// Catapulte de feu

	romans[8] = new Array(50,40,30,30750,27200,45000,37500,4,4,0);				// Sénateur

	romans[9] = new Array(0,80,80,5800,5300,7200,5500,1,5,1600);				// Colon

	romans[10] = new Array(0,0,0,0,0,0,0,6,0,0);								// Héro
...
teutons=new Array();
	...
	teutons[0] = new Array(40,20,5,95,75,40,40,1,7,60);							// Combattant au gourdin

	teutons[1] = new Array(10,35,60,145,70,85,40,1,7,40);						// Combattant à la lance

	teutons[2] = new Array(60,30,30,130,120,170,70,1,6,50);						// Combattant à la hache

	teutons[3] = new Array(0,10,5,160,100,50,50,1,9,0);						    // Eclaireur

	teutons[4] = new Array(55,100,40,370,270,290,75,2,10,110);					// Paladin

	teutons[5] = new Array(150,50,75,450,515,480,80,3,9,80);					// Cavalier Teuton

	teutons[6] = new Array(65,30,80,1000,300,350,70,3,4,0);						// Bélier

	teutons[7] = new Array(50,60,10,900,1200,600,60,6,3,0);						// Catapulte

	teutons[8] = new Array(40,60,40,35500,26600,25000,27200,4,4,0);				// Chef de tribu

	teutons[9] = new Array(10,80,80,7200,5500,5800,6500,1,5,1600);				// Colon

	teutons[10] = new Array(0,0,0,0,0,0,0,6,0,0);								// Héro
...
gauls = new Array(10);
	...
	gauls[1] = new Array(65,35,20,140,150,185,60,1,6,45);						// Combattant à l'épée

	gauls[2] = new Array(0,20,10,170,150,20,40,2,17,0);							// Eclaireur

	gauls[3] = new Array(90,25,40,350,450,230,60,2,19,75);						// Eclair de Toutatis

	gauls[4] = new Array(45,115,55,360,330,280,120,2,16,35);					// Cavalier druide

	gauls[5] = new Array(140,50,165,500,620,675,170,3,13,65);					// Hédouin

	gauls[6] = new Array(50,30,105,950,555,330,75,3,4,0);						// Bélier

	gauls[7] = new Array(70,45,10,960,1450,630,90,6,3,0);						// Catapulte de Guerre

	gauls[8] = new Array(40,50,50,30750,45400,31000,37500,4,5,0);				// Chef

	gauls[9] = new Array(0,80,80,5500,7000,5300,4900,1,5,1600);					// Colon

	gauls[10] = new Array(0,0,0,0,0,0,0,6,0,0);									// Héro
...
nature = new Array(10)
	...
	nature[1] = new Array(20,35,40,0,0,0,0,1,20,0);							// Araignée

	nature[2] = new Array(60,40,60,0,0,0,0,1,20,0);							// Serpent

	nature[3] = new Array(80,66,50,0,0,0,0,1,20,0);							// Chauve-souris

	nature[4] = new Array(50,70,33,0,0,0,0,2,20,0);							// Sanglier

	nature[5] = new Array(100,80,70,0,0,0,0,2,20,0);						// Loup

	nature[6] = new Array(250,140,200,0,0,0,0,3,20,0);						// Ours

	nature[7] = new Array(450,380,240,0,0,0,0,3,20,0);						// Crocodile

	nature[8] = new Array(200,170,250,0,0,0,0,3,20,0);						// Tigre

	nature[9] = new Array(600,440,520,0,0,0,0,5,20,0);						// Eléphant
