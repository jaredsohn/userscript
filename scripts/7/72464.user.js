...
IkariamSuperMarketOffers = function(cityId, position, resource, range, orderBy, parentNode) {
  this.buyHeader = $('<h3 class="header"><span class="textLabel">Kopen</span></h3>');
  this.buyOffersDiv = $('<div class="ISM_offers_div ISM_loading content"></div>');
  this.buyFooter = $('<div class="footer"/>');
  this.sellHeader = $('<h3 class="header"><span class="textLabel">Verkopen</span></h3>');
...
IkariamSuperMarket.prototype.prepareScreen = function() {
  ...
  var wineSelector = $('<li id="ISM_wine_selector" class="ISM_selector selected"><a title="Wijn" href="javascript:void(0);"><em><img src="/skin/resources/icon_wine.gif" width="12px" height="10px"/> Wijn</em></a></div>');
  var marbleSelector = $('<li id="ISM_marble_selector" class="ISM_selector"><a title="Marmer" href="javascript:void(0);"><em><img src="/skin/resources/icon_marble.gif" width="12px" height="10px"/> Marmer</em></a></div>');
  var crystalSelector = $('<li id="ISM_crystal_selector" class="ISM_selector"><a title="Kristal" href="javascript:void(0);"><em><img src="/skin/resources/icon_crystal.gif" width="12px" height="10px"/> Kristal</em></a></div>');
  var sulphurSelector = $('<li id="ISM_sulphur_selector" class="ISM_selector"><a title="Zwavel" href="javascript:void(0);"><em><img src="/skin/resources/icon_sulfur.gif" width="12px" height="10px"/> Zwavel</em></a></div>');
  var woodSelector = $('<li id="ISM_wood_selector" class="ISM_selector"><a title="Hout" href="javascript:void(0);"><em><img src="/skin/resources/icon_wood.gif" width="12px" height="10px"/> Hout</em></a></div>');
