// ==UserScript==
// @name           Bux.to Autoclick. 3xMedia edition
// @namespace      http://userscripts.org/users/126161
// @description    Auto clicks ads on Bux.to. Automatically reloads if no ads are present. Based off Joe Simmon's script. For instructions on usage please refer to http://3xmedia.co.cc/earn-with-bux-to/
// @include        http://*bux.to/*
// ==/UserScript==
...
sec.setAttribute("style", "background:url('http://exmedia.ipbfree.com/index.php?act=Attach&type=post&id=64'); color:#736357; border:8px ridge #000; padding:5em; position:absolute; top:"+window.innerHeight/3+"px; left:"+window.innerWidth/2+"px; text-align:center;");
