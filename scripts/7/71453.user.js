...
var RANKS = ['редник', 'ефрейтор', 'сержант', 'лейтенант', 'капитан', 'полковник', 'генерал', 'фелдмаршал'];
var INDUSTRIES = ['', 'Храна', 'Подаръци', 'Оръжие', 'Билети'];
var SKILLS = ['всички', 'производство', 'земя', 'строителство'];
var TOOLS = ['Значки', 'RSS Feed', 'ТретиСтрани', 'Форуми', 'eRepPlusНастройки'];
var SETTINGS_BITS = '11111111111111111111';
var STRINGS = [	'Размени валутите',
				'Линк',
				'Удебелено',
				'Наклонено',
				'Подчерано',
				...
				'Най-популярни новини',											//	10
				'Последни новини',
				'Военни новини',
				'Моля влезте ',
				'Бързи линкове &nbsp;&nbsp;&nbsp;',
				'Всички коментари и Преведи на&nbsp;&nbsp;&nbsp;',
				'Интерактивна карта',
				'Описание на новините',
				'"Инструменти от Трети Страни" и "Национални страници и Форуми"',
				'Калкулатор на здравето на профила',
				'Помощник за статии във Вестника и Форума',						//	20
				'Страницата Тренировъчна площадка показва щетата с различни качества оръжие',
				'Филтриране на Пазара на Труда ',
				'Бутона "Размени валутите" на валутния пазар',
				'Цена на продуктите и ресурсите за единица',
				'Изпрати съобщение и/или прати подарък на страницата с Рабтниците',
				'Запази линковеnbsp;&nbsp;&nbsp;',
				'Включено',
				'Изключено',
				'Num',
				...
				'Линк',
				'Нов прозорец',
				'Инструменти от Трети Страни',
				'Национални страници и Форуми',
				'Настройки на Плюс',
				' (Всички) ',
				' Преведи ',
				'Качество на болниците на Общество',
				'Калкулация на следващия медал Супер Войник',
				'Тренировки до следващия медал:\n',								//	40
				'Заплати и цени в злато',
				' Отмени превода',
				'Всички дарения',
				'Прати подарък',
				'Изпрати съобщение',
				'Не моцжете да пратите подарък на себе си.',
				'Боеве',
				'Статистики',
				'Статистики на бойното поле',
				'Шапката на Платон',												//	50
				'<br/>{0}%: <strong>{2}</strong> ({1} golds)',
				'Показване максимум бойци на разширенотп бойно поле:&nbsp;&nbsp;&nbsp;',
				'Линк към всички войни в Моите Места и Тренировъчната Площадка',
				'Войни'
];
...
var languages = [
  ...
  {l: 'Български', s: 'bg'},
  {l: 'Китайски', s: 'zh'},
  {l: 'Китайски_опростен', s: 'zh-cn'},
  {l: 'Китайски_традиционен', s: 'zh-tw'},
  {l: 'Хървтатски', s: 'hr'},
  {l: 'Чешки', s: 'cs'},
  {l: 'Датски', s: 'da'},
  {l: 'Холандски', s: 'nl'}, 
...
function EmployeeMessageAndGifts() {
	...
	$("table.employees_details tr").each(function(i) {
		if (i > 0)
		{
			...
			where.append('<a id="donate_link_' + citizenID + '" style="position: relative; top: 5px; display: inline; width: 25px; height:25px;" title="' + STRINGS[44] + '" href="javascript:void(0);"><img alt="' + STRINGS[44] + '" src="/images/parts/icon_industry_gift.gif" width="25px" height="25px" onclick="">'); //.click(function() {
...
function addNationalForums() {
	var nationalForums = [
		...
		{country: 'Ukraine',			url: 'http://eRepublik.in.ua/', 					name: 'eRepublik.in.UA - форум онлайн игры eRepublik - Index page'},
		{country: 'Turkey',				url: 'http://www.erepublik.gen.tr', 				name: 'Erepublik Türkiye &bull; Pano anasayfası'},
		...
		{country: 'South-Africa',		url: 'http://www.erepubliksa.com',					name: 'eSouth Africa Forum - Index'},
		...
		{country: 'Russia', 			url: 'http://www.erespublika.ru/forum/', 			name: 'eRepublik • русскоязычное сообщество - Главная страница'},
		...
		{country: 'Iran', 				url: 'http://erepublik.ir/forum/', 					name: 'eRepublik.ir - صفحه اصلی'},
		...
		{country: 'France', 			url: 'http://www.erepfrance.com/forum/', 			name: 'ErepFrance - Forum &bull; Page d’index'},
		...
		{country: 'Bulgaria',			url: 'http://forum.ebulgaria.biz',					name: 'Форум на еБългария'},
		...
		{country: 'Australia',			url: 'http://community.auserepublik.com/',			name: 'eAustralia - Index'},
	...
	eRepPlusSettings.forEach(function(p) {
		...
		if (p.pos == 10) {
			$("#reset_saved_links").click(function() {
				...
				UpdateLinks();
				location.reload();
				alert('Изтриването на Запазените Линкове беше успешно!');
			});
		}
...
function saveLink(obj, what) {
	...
	if (GM_getValue(cID + 'eR_QL') != undefined)
		...
		lLinks = ['Link 1', '', '', 'Link 2', '', '', 'Link 3', '', '', 'Link 4', '', '', 'Link 5', '', '', 'Link 6', '', '', 'Link 7', '', '', 'Link 8', '', '', 'Подкрепете eRep+', BASE_URL + 'citizen/donate/items/1408159', 'false', 'eRepublik Plus', BASE_URL + 'newspaper/erepublik-plus-187657/1', 'false'];
...
function addBattleStats() {
	...
	$("div.defender:eq(0)").append('<ul class="profilemenu"><li><a class="goright" target="_blank" href="http://ereptools.net/battles/info/id/' + battleID + '">' + STRINGS[48] + '</a></li></ul>');
	if (getSetting(17) == '1') {
