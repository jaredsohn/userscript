...
var Einsatzklassen = {
  ...
  'Motorrad-Brand'              : 'F2',
  'Mülleimer Brand'             : 'F2',
  'Scheunenbrand'               : 'F3+GW-W',
  'Schornsteinbrand'            : 'F2+DL',
  'Silobrand'                   : 'F3',
  'Sperrmüllbrand'              : 'F2',
  'Strohballen Brand'           : 'F2|GW-W',
  'Traktorbrand'                : 'F2+Öl',
  'Verkehrsunfall'              : 'F2|Öl',
  'Wohnblockbrand'              : 'F4',
  'Wohnungsbrand'               : 'F4',
  ...
  'Ölspur'                      : 'LF,Öl',
  'Brand in Zugdepot'           : 'F4+GW-S,RW',
  'Brand in Autohaus'           : 'GSG',
  'Brand in Druckerei'          : 'F4',
  'Brand in Lackfabrik'         : 'GSG+DL',
  'Person im Fluss'             : 'GW-T,LF',
  'Trocknerbrand'               : 'F1',
  'Brand in Reifenlager'        : 'F4|GW-G,GW-M',
  'Brand im Casino'             : 'F4+LF,TLF',
};
