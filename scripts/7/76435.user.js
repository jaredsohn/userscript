// ==UserScript==
// @name           eRepublik Toilet Sex 
// @namespace      http://www.erepublik.com/en/referrer/Roge+Chan
// @description    "New look of erepublik training session" was changed
// @version        1
...
var generals_txt = ["Oral Sexl", "Normal Sex", "Anal Sex"];

var generals_pix = ["http://imgur.com/kPgTK.jpg", "http://imgur.com/CJorZ.jpg", "http://imgur.com/xUM6H.jpg"];
...
function replace_generals()
    {
        ...
        var old_general_txt  = ["Kim Jong il", "Barack Obama", "Vladimir Putin"];
    ...
    //Replace Lana
    GM_addStyle('.lana_holder { background-image:url(http://imgur.com/zOptj.jpg);}');
