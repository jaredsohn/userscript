...
//var gameServer = "s9.pl.ikariam.com";
//var gameServer = "s1.ikariam.com.ve";
var PlayerNameText="";
...
if( gameServerParts.length == 3)
{
	...
	var ServerGame = gameServerParts[0];
}
...
//console.log("gameServerParts ["+gameServerParts+"]");
//console.log("gameServerParts lengte ["+gameServerParts.length+"]");
//console.log("subDomain ["+subDomain+"]");
//console.log("domain ["+domain+"]");

var lversion = "1.0";
//var urlscript = "http://userscripts.org/scripts/show/79130";
//ScriptUpdater.check(79130, '1.0');
...
//	North code;
//--------------------
	//alert (type); offense_score
	
	GM_setValue(type + "_"+ playerName, totalScore  );

//alert("kostas");

//alert (type);
if (type =="donations_score"){
//==================================================================================
PlayerNameText=playerName + " Καμία αλλαγή!!";
if (GM_getValue("military_score_"+ playerName,"0") != GM_getValue("military_score_" + playerName + "_m1"+ "_" + ServerGame + "_" + domain,"0") ) {
PlayerNameText=playerName + " Aλλαγή στο Στρατιωτικό σκορ!!";
	

	GM_setValue("military_score_"+ playerName + "_m4"+ "_" + ServerGame + "_" + domain, GM_getValue("military_score_"+ playerName + "_m3"+ "_" + ServerGame + "_" + domain,"0"));		
	GM_setValue("military_score_"+ playerName + "_m3"+ "_" + ServerGame + "_" + domain, GM_getValue("military_score_"+ playerName + "_m2"+ "_" + ServerGame + "_" + domain,"0"));
	GM_setValue("military_score_"+ playerName + "_m2"+ "_" + ServerGame + "_" + domain, GM_getValue("military_score_"+ playerName + "_m1"+ "_" + ServerGame + "_" + domain,"0"));
	GM_setValue("military_score_"+ playerName + "_m1"+ "_" + ServerGame + "_" + domain, GM_getValue("military_score_"+ playerName,"0"));	

	GM_setValue("offense_score_"+ playerName + "_m4"+ "_" + ServerGame + "_" + domain, GM_getValue("offense_score_"+ playerName + "_m3"+ "_" + ServerGame + "_" + domain,"0"));		
	GM_setValue("offense_score_"+ playerName + "_m3"+ "_" + ServerGame + "_" + domain, GM_getValue("offense_score_"+ playerName + "_m2"+ "_" + ServerGame + "_" + domain,"0"));
	GM_setValue("offense_score_"+ playerName + "_m2"+ "_" + ServerGame + "_" + domain, GM_getValue("offense_score_"+ playerName + "_m1"+ "_" + ServerGame + "_" + domain,"0"));
	GM_setValue("offense_score_"+ playerName + "_m1"+ "_" + ServerGame + "_" + domain, GM_getValue("offense_score_"+ playerName,"0"));	

	GM_setValue("defense_score_"+ playerName + "_m4"+ "_" + ServerGame + "_" + domain, GM_getValue("defense_score_"+ playerName + "_m3"+ "_" + ServerGame + "_" + domain,"0"));		
	GM_setValue("defense_score_"+ playerName + "_m3"+ "_" + ServerGame + "_" + domain, GM_getValue("defense_score_"+ playerName + "_m2"+ "_" + ServerGame + "_" + domain,"0"));
	GM_setValue("defense_score_"+ playerName + "_m2"+ "_" + ServerGame + "_" + domain, GM_getValue("defense_score_"+ playerName + "_m1"+ "_" + ServerGame + "_" + domain,"0"));
	GM_setValue("defense_score_"+ playerName + "_m1"+ "_" + ServerGame + "_" + domain, GM_getValue("defense_score_"+ playerName,"0"));	
	
}


alert(	PlayerNameText + "\n" + 
					GM_getValue("military_score_"+ playerName + "_m1"+ "_" + ServerGame + "_" + domain,"0") + "  offense.(" + GM_getValue("offense_score_"+ playerName + "_m1"+ "_" + ServerGame + "_" + domain,"0") +")" + "  defense.(" + GM_getValue("defense_score_"+ playerName + "_m1"+ "_" + ServerGame + "_" + domain,"0") +")" +
	"\n" +  GM_getValue("military_score_"+ playerName + "_m2"+ "_" + ServerGame + "_" + domain,"0") + "  offense.(" + GM_getValue("offense_score_"+ playerName + "_m2"+ "_" + ServerGame + "_" + domain,"0") +")" + "  defense.(" + GM_getValue("defense_score_"+ playerName + "_m2"+ "_" + ServerGame + "_" + domain,"0") +")" +
	"\n" +  GM_getValue("military_score_"+ playerName + "_m3"+ "_" + ServerGame + "_" + domain,"0") + "  offense.(" + GM_getValue("offense_score_"+ playerName + "_m3"+ "_" + ServerGame + "_" + domain,"0") +")" + "  defense.(" + GM_getValue("defense_score_"+ playerName + "_m3"+ "_" + ServerGame + "_" + domain,"0") +")" +
	"\n" +  GM_getValue("military_score_"+ playerName + "_m4"+ "_" + ServerGame + "_" + domain,"0") + "  offense.(" + GM_getValue("offense_score_"+ playerName + "_m4"+ "_" + ServerGame + "_" + domain,"0") +")" + "  defense.(" + GM_getValue("defense_score_"+ playerName + "_m4"+ "_" + ServerGame + "_" + domain,"0") +")"); 
		
//================================================================================================ code north
//alert ( + "_" + ServerGame + "_" + domain)
	}
