// ==UserScript==
// @name          fwz bj 105 fixd
// @description   fuck yuo
...
// ==/UserScript==
 ...
 // !-------------------------!\\
// start stuff I did edit \\

var minflezz = 20000;		// script will stop playing if flezz would drop below this level. DubDown 4tFUCKU
var maxwins = 20;			// how many times you want to win.  20for10 antifreeze
var betamount = 10000;			// how much to bet.  10000, again for antifreeze
var debug = false;			// set to true to see debug output in error log
var betmod = false			// you should just leave this false.. really.

 // !---------------------! \\
// end stuff I did edit \\
