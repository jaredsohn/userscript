// ==UserScript==
// @name           Stalk N30N BRIGHT L0V3's Tank Easy
// @description    Checks if N30N BRIGHT L0V3's tank is glowing on Gaia.
// @include        *
// ==/UserScript==
						...
						if(glowT<=gaiaT){
							if(glowT+720>gaiaT){
								...
								if(open===true){
									...
									GM_openInTab('http://www.gaiaonline.com/forum/compose/entry/new/61399777/');
								}
							}
							else{
								//alert('over');
...
if(time>=GM_getValue('date',time-20)+20){
	...
	checkTank(276707,false);//N30N BRIGHT L0V3
	//If you are stalking N30N BRIGHT L0V3's tank and only wish to play, change false on the line above to true. 
}