...
// check latest version at http://userscripts.org/scripts/show/23775
...
const broken_icon = "resource://gre/res/broken-image.png";//formal: .gif
...
if (do_linkify)
{
	...
	var imgs = document.evaluate("//img[@src and not(@onclick) and count(ancestor::*[name() = 'a' or @onclick][1]) = 0]", document, null, XPathResult.UNORDERED_NODE_SNAPSHOT_TYPE, null);//formal: 'A'
	for (var i = 0; i < imgs.snapshotLength; i++)
