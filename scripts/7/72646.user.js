...
// @name	Travian Multi Message Script(inicz.com)add iran lang
...
if(locale == "ir" || locale == "ir" || tr[locale] == undefined){
	locale = "ir";
}
...
tr["ir"] = {
	...
	msg_finished_auto_sending: "فرم انتقادات و ارسال خودکار",
