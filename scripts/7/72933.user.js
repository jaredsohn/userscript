// ==UserScript==
// @name         (NMR111) Travian: Attack Builder (2)
...
var table = "<legend>"+text[9]+"</legend><table id=\"myTable\"  ><tr></td>кол-во</td>";
