// ==UserScript==
// @name           Travian big map viewer Multi-language 
// @namespace      Travian
// @description    Travian big map viewer Multi-language
// @author	   Dank
// @version	   3.6.0.2
...
switch (mlang) {
	case "de":
		titlestring = ["große Karte", "Village", "Spieler", "Population", "Allianz"];
		break;
	case "hk":
	case "tw":
		...
		break;
	case "cn":
		titlestring = ["扩增地图", "村庄名", "玩家", "人口数", "公会"];
		break;
        case "ae":
        case "sa":
        case "sy":
	...
	case "com":default:
        ...
        break;
	case "ir":
        titlestring = ["نقشه بزرگ", "دهکده", "بازیکن", "جمعیت", "اتحاد"];
        break;
}
