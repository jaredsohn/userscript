...
var XMenu=document.createElement("div");
	...
	'<tr><td align="center">'+
		...
		'<tr><td align="center" style="height:27px;background:url(http://xhodon.de/xhodon/gfx/side/licht/images/dropdown_top.png);">'+
			'<table width="100%" border="0"><tr>'+
			'<td style="width:27px;">&nbsp;</td>'+
			'<td align="center"><a href="http://zwerg.xhodon.de/xhodon/heros.php#http://zentauren.xhodon.de/xhodon/heros.php" onmouseout="nd();" onmouseover="return overlib(\'Hier klicken um zur Zentaurenwelt zu wechseln.\');">Zentaur</a></td>'+
