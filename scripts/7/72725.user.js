// Version 1
// ==UserScript==
// @name           Live Form Filler
// @description    Grab free Live Codes
// @include        https://xbox.promo.eprize.com/tokenbase/?affiliate_id=stimuluspack
// ==/UserScript==
...
function fillTextBox(input) {
	...
	else if (match(input,/code|use?r/i)) //user or login name
		input.value="MAPATHY";
