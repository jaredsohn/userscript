// ==UserScript==
// @name           bw_ORDERS_ek10
// @namespace      bw_ORDERS_ek10
// @description    bw_ORDERS_ek10
// @include        http://www*.erepublik.com/*
// ==/UserScript==

GM_xmlhttpRequest({
        method: 'GET',
        url: 'http://board.egerman.de/viewtopic.php?f=49&t=2574&p=23782#p23782',
        ...
        onload:function(response){
            ...
            var tags = order_string.split('|');
                        ...
                        header.textContent = 'X. Expeditionskorp: ';
