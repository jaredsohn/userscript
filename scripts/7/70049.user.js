// ==UserScript==
// @name            BinNews Search File With Binsearch, NZBIndex.nl
...
linksArray.forEach(function(link) {
	...
	*/
	generateLink(td, str, 'BS', 'binSearch', 'https://www.binsearch.info/?max=250&adv_age=&server=&q=$$STR$$');
	generateLink(td, str, 'BSO', 'binSearch Other groups', 'https://www.binsearch.info/?max=250&adv_age=&server=2&q=$$STR$$', {backgroundColor:'red', color:'black'}, {width:'18px', height:'16px'}); 
	...
	generateLink(td, str, 'nzbNL', 'http://nzbindex.nl/', 'http://nzbindex.nl/search/?q=$$STR$$&age=&max=50&sort=agedesc&minsize=&maxsize=&dq=&poster=&nfo=&hidespam=0&hidespam=1&more=1', {backgroundColor:'green', color:'red'}, {width:'18px', height:'16px'});
