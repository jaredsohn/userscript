...
// @include        http://www.formulawan.fr/Fenetre_Sponsor.php?action=Gestion
// @license       GPL v3
// @version       1.02
// ==/UserScript==
var inc = 4+1;
...
while(document.getElementsByTagName('h2')[0].nextSibling.nextSibling.getElementsByTagName('li')[i]){
	var ligue = parseInt(document.getElementsByTagName('h2')[0].nextSibling.nextSibling.getElementsByTagName('li')[i].getElementsByTagName('strong')		[0].nextSibling.textContent.replace(new RegExp('ligue|,| |\t|\n|\r|', 'g'),''));
...
div_gain_max.innerHTML = "Gains (min/max): de " 
		+ gain_mini 
		+ " à "
		+ gain_mini*7 
