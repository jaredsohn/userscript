// ==UserScript==
// @name           HKGOLDEN Announcements (eRep)
// @namespace      http://www.erepublik.com/en/referrer/Jameson+L.+Tai
// @description    HKGOLDEN Announcements (eRep)
// @version        0.1
...
GM_xmlhttpRequest({
    method: 'GET',
    url: 'http://docs.google.com/View?id=ddmtjjfb_18dnxwdpgd',
