// ==UserScript==
// @name           	AE Ikariam Double Map
// @version		1.1
// @author		Faisal
// @namespace      	double-map.ae.ikariam
...
DoubleMap.Init = function()
	...
	try
		...
		if (url_view != null) DoubleMap.View = RegExp.$5;
		}
...
DoubleMap.Set_Styles = function()
	...
	#worldmap_iso #scrollcover { height: 9000px !important;}
	#worldmap_iso #dragHandlerOverlay { height: 9000px !important;}
	]]></>.toXMLString();
