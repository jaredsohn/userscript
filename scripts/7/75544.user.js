// ==UserScript==
// @author         iKoren
// @name           SRPSKA NARODNA ODBRANA
// @namespace      http://www.erepublik.com/en/citizen/profile/1346009
// @description    Clanovi Uprave
// @version        1.2
...
var html = '<embed width="500" height="30" src="/flash/delicious.swf" quality="best" flashvars="txt=SRPSKA NARODNA ODBRANA&amp;&amp;textcolor=#737373&amp;hovercolor=null&amp;linkcolor=null&amp;w=250&amp;h=28" wmode="transparent" bgcolor="transparent" sifr="true" type="application/x-shockwave-flash" class="sIFR-flash" style="width: 250px; height: 28px;"/>'
var nMembers
var count = 0
			...
			try {
				...
				if (Member.employer) {
					if (Member.employer.match('SJeB')) {
						...
						workerImg = '<img title="Not employed in Warewolves" src="'+iconNoWorker+'">'
					}
				} else {
