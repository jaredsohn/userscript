// ==UserScript==
// @name           Farmville Turkiye - Hayvan, Buket, Yumurta, Bonus Toplama V1.2.17706 Plus Paskalya Yumurtasi ilaveli
...
// @version        1.2.17706 Plus
// @license        http://creativecommons.org/licenses/by-nc-nd/3.0/us/
// @require        http://sizzlemctwizzle.com/updater.php?id=62135
// ==/UserScript==

var version = "1.2.17706 Plus"; // cant use cdata+regexp to grab version dynamically because of webkit
...
accText : {
			...
			collectibletwine : "Sicimler Alindi!",
...
GM_config.init("<img src='"+imgs.logo+"'> v"+version, {
	...
	raising : {
		label : "Ahir Yukseltme Yardimi ile & Tavuk Kumesleri Genisletilme Alinsinmi?",
		type : "checkbox",
		"default" : false
	},
	hatchwhite : {
	...
	materialshorse : {
		...
		kids : {
			materialsmaison : {
				label : "La Maison \"Materyalleri\" Alinsinmi?",
				type: "checkbox",
				"default" : false
			}
		}
	...
	decoration : {
		label : "La Maison \"Dekorasyonlari\" Alinsinmi?",
		type : "checkbox",
		"default" : false
	},
	...
	present : {
		...
		kids : {
			box : {
				label : "Sihirli Kutular Alinsinmi?",
				type: "checkbox",
				"default" : false,
			}
		}
	...
	eggs : {
		...
		kids : {
			claimeggs : {
				label : "Bahar Oge istekleri Alinsinmi?",
				type : "checkbox",
				"default" : false
			}
		}
	...
	reqtimeout : {
		label : "Oge Kabul Etme Zaman Asimi (saniye)",
		type : "float",
		"default" : 30
	},
	inputtimeoutenable : {
