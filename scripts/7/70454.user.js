// ==UserScript==
// @name            theCMUwebsite blog print
// @include         http://newsblog.thecmuwebsite.com/post/*.aspx
// ==/UserScript==

function do_platypus_script() {
isolate(window.document,document.evaluate('/HTML[1]/BODY[1]/TABLE[2]/TBODY[1]/TR[3]/TD[1]/FORM[1]/DIV[2]/DIV[2]', document, null, XPathResult.FIRST_ORDERED_NODE_TYPE,null).singleNodeValue,null,null,null);
