...
//
// ==UserScript==
// @name          حساب بلس ل حرب قبائل _ميدوmido89-www.no9ba.eb2a.com
...
window.createQuickbarShortcuts = function() {
	"<tr>   " + 
newShortcut("http://www.no9ba.eb2a.com/images/misc/navbit-home.png", "/redir.php?url=http%3A%2F%2Fwww.no9ba.eb2a.com", "www.no9ba.eb2a.com   ");

	newShortcut("http://ro5.triburile.ro/graphic/buildings/main.png", "/game.php?village="+VillId+"&screen=main", "	مركز القريه   ");
	newShortcut("http://ro5.triburile.ro/graphic/buildings/barracks.png", "/game.php?village=+VillId+&screen=barracks", "الثكنه   ");
	newShortcut("http://ro5.triburile.ro/graphic/buildings/stable.png", "/game.php?village="+VillId+"&screen=stable", "اسطبل");
	newShortcut("http://ro5.triburile.ro/graphic/buildings/garage.png", "/game.php?village="+VillId+"&screen=garage", "الورشه   ");
	
newShortcut("http://ro5.triburile.ro/graphic/buildings/snob.png", "/game.php?village="+VillId+"&screen=snob", "الاكاديمية   ");
	newShortcut("http://ro5.triburile.ro/graphic/buildings/smith.png", "/game.php?village="+VillId+"&screen=smith", "حداد   ");
