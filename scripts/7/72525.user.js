// ==UserScript==
// @name        Refresh Automatico
// @version     1.0
// @include 	http://www.facebook.com/home.php?filter=app_102452128776&show_hidden=true&ignore_self=true*
// @description esegue il refresh di pagina allo scadere di un timeout prefissato. Menu di configurazione premendo "Shift + T".
// @require        http://sizzlemctwizzle.com/updater.php?id=72525
// ==/UserScript==
...
Array(English, German, Spanish, Dutch, Italiano (by sisko)) */
reload = ['How often would you like your page to reload?  This number is in seconds.', 'In welchem Intervall -in Sekunden- soll die Seite neugeladen werden?', 'Cada cuantos segundos quiere actualizar la página?','Hoe vaak wilt u de pagina verversen?, Interval is in seconden','Quanto spesso vuoi che la pagina si ricarichi? (secondi)'];
statusbar_before_time = ['', 'Die Seite wird in ', 'La página será cargada de nuevo en ','De pagina wordt in ',''];
statusbar_behind_seconds = [' seconds remaining...', ' Sekunden neugeladen...', ' segundos...',' seconden over...','secondi rimanenti...'];
statusbar_behind_minutes = [' minutes remaining...', ' Minuten neugeladen...', ' minutos...',' minuten over...','minuti rimanenti...'];
statusbar_behind_hours = [' hours remaining...', ' Stunden neugeladen...', ' horas...',' uren over...','ore rimanenti...'];
statusbar_stop_refresh = ['The countdown has been cancelled...', 'Die Aktualisierung wurde abgebrochen...', 'La cuenta atrás ha sido cancelada...', 'Het aftellen is geannuleerd...','Il conto alla rovescia è stato cancellato'];
offline_box_message = ['Lost connection to site. Page will be reloaded, when the connection is restored...','Verbindung fehlgeschlagen. Die Seite wird neugeladen, sobald wieder eine Verbindung besteht... ','Pérdida de conexion. La página será recargada cuando se recupere la conexion...','Verbinding met site verbroken. Als de verbinding is hersteld, zal de pagina opnieuw worden geladen...','Connessione persa. La pagina verrà ricaricata, quando la connessione sarà ripresa...'];
options_title = ['\"Auto F5 reload window\" options', 'Optionen für \"Auto F5 reload window\"', 'Opciones de \"Auto F5 reload window\"','\"Auto F5 reload window optie\'s\"','Opzioni Refresh Automatico by Sisko v. '+versione];
options_default_timeout = ['Default timeout', 'Standardtimeout', 'Tiempo de recarga estándar','Standaard timeout','Default Timeout'];
options_timeout = ['Timeout for this page', 'Timeout der aktuellen Seite', 'Tiempo de recarga de esta página','Timeout voor deze pagina','Timeout per questa pagina'];
options_random = ['Add random value to timeout between 0 and', 'Zufallswert zu Timeout hinzufügen. Zwischen 0 und', 'Añadir número aleatorio entre 0 y','Voeg een willekeurige waarde aan timeout toe, tussen 0 en','Assegna un valore casuale al timeout tra 0 e'];
options_hotKeys = ['Show and hide menu ', 'Menü ein- und ausblenden ', 'Mostrar y esconder menu ','Toon en verberg menu ','Mostra/Nascondi menu (SHIFT+)'];
options_separators = ['Ignore everything after these symbols in URL(separate with spaces)', 'Ignoriere URLs nach folgenden Symbolen(mit Leerzeichen trennen)', 'Ignorar todo despues de estos símbolos en URLs (separar con espacios)','Negeer alles na deze symbolen in URL(gescheiden door spatie\'s)','Ignora tutto dopo i seguenti simboli nell\'indirizzo (separati da uno spazio)'];
options_separators_incl = ['Include the separators in the URL saved', 'Speichere URLs einschließlich Trennsymbole', 'Incluir separadores en la URL','Scheidingstekens insluiten in de opgeslagen URL','Includi i separatori nell\'indirizzo salvato'];
options_autoclose = ['Hide menu when clicking outside the menu', 'Bei Click außerhalb des Menüs, Menü ausblenden', 'Ocultar menú al clickear fuera del menú','Verberg menu als er buiten het menu wordt geklikt','Nascondi il menu quando clicchi fuori da esso'];
options_click_extend = ['Prolong timeout on mouseclicks or keyboard input', 'Bei Mausklicks oder Tastatureingaben Timeout hinauszögern', 'Prolongar cuenta atras cliqueando o tecleando','Verleng timeouts muis klik of toetsenbord invoer','Prolunga il timeout se stai scrivendo'];
options_refresh_all = ['Reload all pages with default timeout, which has no timeout set', 'Aktualisiere alle Seiten mit Standardtimeout, für die kein Timeout gesetzt wurde', 'Actualiza todas las páginas con tiempo de recarga estándar, sin propio tiempo de recarga','Herlaad alle pagina\'s met standaard time-out, welke niet ingesteld zijn op standaard','Ricarica tutte le pagine con il timeout di default, se non hanno un timeout settato'];
options_btn_ok = ['OK', 'OK', 'OK', 'OK','OK'];
options_btn_cancel = ['Cancel', 'Abbrechen', 'Cancelar','Annuleren','Annulla'];
options_btn_abort = ['Abort reload', 'Neuladen verhindern', 'Abortar recarga','Herladen afbreken','Ferma script'];
options_number_format = ['Format examples: hh:mm:ss, h:m:ss, m:sss, s etc. like 1:20:30 oder 500 oder 3:100', 'Formatbeispiele: hh:mm:ss, h:m:ss, m:sss, s, also 1:20:30 oder 500 oder 3:100','Ejemplos de formato: hh:mm:ss, h:m:ss, m:sss, s etc. como 1:20:30 oder 500 oder 3:100','Formaat voorbeelden: hh:mm:ss, h:m:ss, m:sss, s etc. zoals 1:20:30 of 500 of 3:100','Formati di esempio: hh:mm:ss, h:m:ss, m:sss, s etc. tipo 1:20:30 o 500 o 3:100'];
num_err_default = ['Please enter a positiv numeric value for default timeout.', 'Bitte eine positive ganze Zahl für Standardtimeout eingeben.', 'Introducir número entero y postivo de tiempo de recarga estándar por favor', 'A.u.b. voer een positief getal in voor standaard time-out','Per favore inserisci un numero positivo per il timeout di default.'];
num_err_timeout = ['Please enter a positiv numeric value for timeout.', 'Bitte eine positive ganze Zahl für Timeout eingeben.', 'Introducir número entero y postivo de tiempo de recarga por favor','A.u.b. voer een positief getal in voor time-out','Per favore inserisci un numero positivo per il timeout.'];
num_err_random = ['Please enter a positiv numeric value for random value.', 'Bitte eine positive ganze Zahl für Zufallszahl eingeben.', 'Introducir número entero y postivo de número aleatorio por favor','A.u.b. voer een positief getal in voor een willekeurige waarde','Per favore inserisci un numero positivo per il timeout casuale'];
time_format_err = ['Please do not enter more than three \':\'', 'Bitte nicht mehr als drei \':\' eingeben', 'No poner mas de tres \':\' por favor','A.u.b. voer niet meer dan drie \':\'','Per favore non inserire più di tre \':\''];
hotkey_err = ['Please enter a hotkey.', 'Bitte geben Sie ein Hotkey ein.', 'Por favor introduzca un hotkey.','A.u.b. voer een sneltoets in','Per favore inserisci un carattere']; 
...
offline_box.innerHTML = '<div id="F5rw_offline_box" style="text-align:left; position:fixed; bottom:10px; right: 10px; margin:0px; margin:auto; padding:4px; color:#A00; border:1px solid #A00; background:#FFF; font:10px arial; z-index:99999;">' + 
