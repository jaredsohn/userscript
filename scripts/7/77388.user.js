// ==UserScript==
// @name           Dinheiro_no_perfil_br
// @namespace      http://www.yelidmod.com/mendigo/
// @description    Permite ver o dinheiro de cada perfil
...
var siglink = "http://img.mendigogame.es/cache/es_ES/signaturen/";

if (id) {
	GM_xmlhttpRequest({
		method: 'GET',
   		url: 'http://www.faveladogame.com.br/dev/api/user.' + id + '.xml',
...
function user(dom){
	...
	tr[8].innerHTML = '<td><strong>&nbsp;Dinheiro:</strong></td><td>'+ cash_show +'</td><td><strong>&nbsp;</strong></td><td></td>';
