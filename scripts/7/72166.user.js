// ==UserScript==
// @name           Wikipedia -> Dbpedia
// @author         Spencer kelly
// @namespace      http://spencerwaterbed.com/soft
// @description    Provide link from wikipedia pages to the equivelent dbpedia topic.
...
myurl=myurl.replace('http://en.wikipedia.org/wiki/','');
  ...
  $('#siteSub').append('<a href="http://dbpedia.org/page/'+myurl+'">dbpedia</a>');
});
*/
...
$(document).ready( function() {
	...
	$('#content .firstHeading').append('<a href="http://www.dbpedia.org/view/wikipedia/en/'+newkey+'"><img src="http://www.dbpedia.org/favicon.ico" style="margin-left:0.5em"></a>');
});