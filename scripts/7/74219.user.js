// ==UserScript==
// @name           Calculadora de Precios de Venta de Cachivaches V 2.2
// @namespace      NewMan edit by kingfr3sh
// @namespace      http://forum.ego-shooters.net
// @description    Calculadora de Precios de Venta de Cachivaches
// @include        *mendigogame.es/stock/plunder/*
// @exclude        *mendigogame.es/stock/plunder/craft/*
// ==/UserScript==
...
// link für berlin
if (url.indexOf("http://mendigogame")>=0) {
var gamelink = "http://mendigogame.es";
}
