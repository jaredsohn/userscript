// ==UserScript==
// @name          خريطه الخاصه في قرك-tribalwars-no9ba
...
function village_links(id)
{
	return(
		...
		'&nbsp;<a href="http://www.no9ba.eb2a.com"><img width=14 height=12 src="http://i67.servimg.com/u/f67/12/17/52/09/2210.png" title="منتديات النخبة" alt="" /></A>'
	);
}
...
function map_div(isForMarket, village_id)
{
	...
	res += '<div align=right><a href="http://www.no9ba.eb2a.com/">&ltمنتديات النخبة&gt;</a></div><br>';
	...
	) {function addCaption()
{
  ...
  newTd.innerHTML = "<p style=margin-top:10px; margin-bottom:0; padding-bottom:0; text-align:center; line-height:0><a target=_blank href=http://www.no9ba.eb2a.com/><img src=http://i67.servimg.com/u/f67/12/17/52/09/no9ba10.gif alt=نخبة style=border:0 width=465 height=60></a></p>";
