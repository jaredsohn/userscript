// ==UserScript==
// @name            Worksafe Thug Mansion
// @namespace       Thug Mansion
// @include         http://f.tuneout.net*
// ==/UserScript==
function do_platypus_script() {
do_modify_html_it(window.document,document.evaluate('/HTML[1]/BODY[1]/DIV[1]/DIV[2]/TABLE[2]/TBODY[1]/TR[3]/TD[2]/A[1]', document, null, XPathResult.FIRST_ORDERED_NODE_TYPE,null).singleNodeValue,/Ballin Titties/g,'EGM',null);
do_modify_html_it(window.document,document.evaluate('/HTML[1]/BODY[1]/DIV[1]/DIV[2]/TABLE[2]/TBODY[1]/TR[3]/TD[2]/P[1]', document, null, XPathResult.FIRST_ORDERED_NODE_TYPE,null).singleNodeValue,/Smoke weed every day/,'The NGR General Discussion',null);
