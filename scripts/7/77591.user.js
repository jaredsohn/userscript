...
function trouverVIE(creaturename){
	...
	if (creaturename.search("Harpies") != -1){creaturevie = 64;} 
	if (creaturename.search("Aigles blancs") != -1){creaturevie = 68;} 
	if (creaturename.search("Morlocks") != -1){creaturevie = 72;} 
	...
	if (creaturename.search("Behemoth") != -1){creaturevie = 200;} 
	if (creaturename.search("Ogres") != -1){creaturevie = 240;} 
...
function trouverDEF(creaturename){
	...
	if (creaturename.search("Gnomes") != -1){creaturedef = 5;} 
	...
	if (creaturename.search("Harpies") != -1){creaturedef = 16;} 
	if (creaturename.search("Aigles blancs") != -1){creaturedef = 17;} 
	if (creaturename.search("Morlocks") != -1){creaturedef = 18;} 
	...
	if (creaturename.search("Cyclopes") != -1){creaturedef = 40;} 
	if (creaturename.search("Mantikors") != -1){creaturedef = 45;} 
	if (creaturename.search("Behemoth") != -1){creaturedef = 50;} 
	if (creaturename.search("Ogres") != -1){creaturedef = 60;} 
...
function trouverPA(creaturename){
	...
	if (creaturename.search("Gnomes") != -1){creaturePoint = 10;creatureatatque = 2;} 
	...
	if (creaturename.search("Harpies") != -1){creaturePoint = 32;creatureatatque = 8;} 
	if (creaturename.search("Aigles blancs") != -1){creaturePoint = 34;creatureatatque = 8;} 
	if (creaturename.search("Morlocks") != -1){creaturePoint = 36;creatureatatque = 9;} 
	...
	if (creaturename.search("Cyclopes") != -1){creaturePoint = 80;creatureatatque = 20;} 
	if (creaturename.search("Mantikors") != -1){creaturePoint = 90;creatureatatque = 22;} 
	if (creaturename.search("Behemoth") != -1){creaturePoint = 100;creatureatatque = 25;} 
	if (creaturename.search("Ogres") != -1){creaturePoint = 120;creatureatatque = 30;} 
...
{	
	var creaturePoint = 0;
	if (creaturename.search("Farfadet") != -1){
		creaturePoint = 5;
	} 
	if (creaturename.search("Guerrier de glace") != -1){
	  					creaturePoint = 10;
	  				} 
	if (creaturename.search("Enfants du pouvoir") != -1){
	  					creaturePoint = 6;
	  				} 
	if (creaturename.search("Prêtre de guerre") != -1){
	  					creaturePoint = 17;
	  				} 
	if (creaturename.search("Nains aux haches oscillantes") != -1){
	  					creaturePoint = 32;
	  				} 
	if (creaturename.search("Archers elfiques") != -1){
	  					creaturePoint = 36;
	  				} 
	if (creaturename.search("Nains aux haches doubles") != -1){
	  					creaturePoint = 43;
	  				} 
	if (creaturename.search("Les géants arboricoles") != -1){
	  					creaturePoint = 70;
	  				} 
	if (creaturename.search("Mages elfiques") != -1){
	  					creaturePoint = 108;
	  				} 
	if (creaturename.search("Œuf de Dragon") != -1){
	  					creaturePoint = 2251;
	  				} 
	if (creaturename.search("Chariots de licorne") != -1){
	  					creaturePoint = 7;
	  				} 
	if (creaturename.search("Centaure hystérique") != -1){
	  					creaturePoint = 11;
	  				} 
	if (creaturename.search("Fées de feu") != -1){
	  					creaturePoint = 30;
	  				} 
	if (creaturename.search("Centaures sauvages") != -1){
	  					creaturePoint = 21;
	  				} 
	if (creaturename.search("Les demi-géants chanteurs") != -1){
	  					creaturePoint = 96;
	  				} 
	if (creaturename.search("Trolls jeteurs de pierres") != -1){
	  					creaturePoint = 135;
	  				} 
	if (creaturename.search("Fées d'orage") != -1){
	  					creaturePoint = 33;
	  				} 
	if (creaturename.search("Salamandres") != -1){
	  					creaturePoint = 2;
	  				} 
	if (creaturename.search("Freluquets de racine") != -1){
	  					creaturePoint = 4;
	  				} 
	if (creaturename.search("Bourdons carnivores") != -1){
	  					creaturePoint = 6;
	  				} 
	if (creaturename.search("Les scarabées") != -1){
	  					creaturePoint = 8;
	  				} 
	if (creaturename.search("Gnomes") != -1){
	  					creaturePoint = 10;
	  				} 
	if (creaturename.search("Lumières trompeuses") != -1){
	  					creaturePoint = 12;
	  				} 
	if (creaturename.search("Skrälings") != -1){
	  					creaturePoint = 14;
	  				} 
	if (creaturename.search("Rats aux verrues empoisonnées") != -1){
	  					creaturePoint = 16;
	  				} 
	if (creaturename.search("Sylphes") != -1){
	  					creaturePoint = 18;
	  				} 
	if (creaturename.search("Serpents Midgard") != -1){
	  					creaturePoint = 20;
	  				} 
	if (creaturename.search("Nymphes") != -1){
	  					creaturePoint = 22;
	  				} 
	if (creaturename.search("Plantes grimpantes") != -1){
	  					creaturePoint = 24;
	  				} 
	if (creaturename.search("Sirènes") != -1){
	  					creaturePoint = 26;
	  				} 
	if (creaturename.search("Loup-garou") != -1){
	  					creaturePoint = 28;
	  				} 
	if (creaturename.search("Gorgones") != -1){
	  					creaturePoint = 30;
	  				} 
	if (creaturename.search("Harpies") != -1){
				creaturePoint = 32;
			} 
	if (creaturename.search("Aigles blancs") != -1){
		creaturePoint = 34;
	} 
	if (creaturename.search("Morlocks") != -1){
		creaturePoint = 36;
	} 
	if (creaturename.search("Araignées Marok géantes") != -1){
		creaturePoint = 38;
	} 
	if (creaturename.search("Diables de feu") != -1){
		creaturePoint = 40;
	} 
	if (creaturename.search("Loup de Fenris") != -1){
		creaturePoint = 44;
	} 
	if (creaturename.search("Daimons") != -1){
		creaturePoint = 50;
	} 
	if (creaturename.search("Golems de corne") != -1){
		creaturePoint = 56;
	} 
	if (creaturename.search("Cheveaux de soleil") != -1){
		creaturePoint = 60;
	} 
	if (creaturename.search("Minautaures") != -1){
		creaturePoint = 64;
	} 
	if (creaturename.search("Greifs") != -1){
		creaturePoint = 70;
	} 
	if (creaturename.search("Lutins de sang") != -1){
		creaturePoint = 76;
	} 
	if (creaturename.search("Cyclopes") != -1){
		creaturePoint = 80;
	} 
	if (creaturename.search("Mantikors") != -1){
		creaturePoint = 90;
	} 
	if (creaturename.search("Behemoth") != -1){
		creaturePoint = 100;
	} 
	if (creaturename.search("Ogres") != -1){
		creaturePoint = 120;
	} 
	if (creaturename.search("Vers de sable") != -1){
		creaturePoint = 150;
	} 
	if (creaturename.search("Anges de mort") != -1){
		creaturePoint = 200;
	} 
	if (creaturename.search("Sphinx d'or") != -1){
		creaturePoint = 240;
	} 
	if (creaturename.search("Dragons aux épines de feu") != -1){
		creaturePoint = 300;
	} 
	if (creaturename.search("Dragons aux yeux de glace") != -1){
		creaturePoint = 400;
	} 
	if (creaturename.search("Dragons au cou de serpent") != -1){
		creaturePoint = 500;
	} 
