// ==UserScript==
// @name	  eRepublik Products and RM AutoDonater
// @version       2
...
// @author	  Endy
// @namespace	  http://www.erepublik.com/*/newspaper/180922/1
...
if (junk) {
	...
	stuff.innerHTML = '<div> Desired Amount: <input type="text" id="NumberToDonate" value="' + MyNumberToDonate + '" size="2" /><br/>Actual: <span id="Num"></span><br/><br/><input type="button" id="AutoDonateButton" value="Transfer Amount" class="vround-btn-core" style="color: green" /></div>';
