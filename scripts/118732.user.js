// ==UserScript==
// @name           FrendzForum Enhancer
// @namespace      o_O
// @include        http://*.frendzforum.org/*
// @include        http://frendzforum.org/*
// @include        http://*.frendz4m.com/*
// @include        http://frendz4m.com/*
// @include        http://*.fzc.me/*
// @include        http://fzc.me/*
// @include        http://*.fzdownloads.com/*
// @include        http://fzdownloads.com/*
// @include        http://*.moviesmobile.net/*
// @include        http://moviesmobile.net/*
// ==/UserScript==
...
try{
	strNewTitle=GM_getValue("Title","My Forum");
}catch(e){
	strNewTitle="My Forum";
}
...
function repairHTML(){
	...
	for(var i=0;i<tds.length;i++){
		var strHTML=tds[i].innerHTML;
		while(strHTML.indexOf("&amp;")!=-1){
			strHTML=strHTML.replace(/\&amp\;/ig,String.fromCharCode(38));
		}
		tds[i].innerHTML=strHTML;
	}
}
removeInlineStyles();
repairHTML();
