/*
	FriendFeed http://kwippy.com Tab 0.01
	Tweaked by http://friendfeed.com/czarphanguye
	Original by Duncan Riley/ http://www.inquisitr.com
	Code modified from http://ffapps.com/tabs/
*/

// ==UserScript==
// @name           FriendFeed kwippy.com
// @namespace      Czar/ http://kwippy.com
// @description    Add kwippy.com in a tab on FriendFeed 
...
// Disabled due to quick hack
//  autoUpdateFromUserscriptsDotOrg({
//    name: 'FriendFeed Identica',
//		url: 'http://userscripts.org/scripts/source/29500.user.js',
//		version: ffrb_version,
//	});

  function kwippy_setup() {
		$('.settings').find('.l_tab:last').after('<td class="l_tab" style="padding-left: 10px;" id="tdtabtm"><div class="rounded bb" id="tabtm"><div class="t"><div class="l"><div class="r"><div class="tl"><div class="tr"><div class="body"><a id="tab-link-kwippy" href="#"><img src="http://kwippy.com/favicon.ico"></a></div></div></div></div></div></div></div></td>');
    $('#tab-link-kwippy').click(function() {
			$('#subtabs').hide();
			$('#body').css("height","100%").html('<div class=iframe style="width:100%;height:100%;"><iframe id="content_iframe" marginWidth=0 marginHeight=0 src="http://kwippy.com/" frameBorder=0 style="width:100%;height:100%;overflow:auto;"></iframe></div>');
