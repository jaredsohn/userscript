// ==UserScript==
// @name           IkariamFriendlist Sv
// @namespace      Calippo94
// @description    Ikariam Friendlist translated to Swedish
//
//Image: <img src="http://img512.imageshack.us/img512/9140/ikariamfriendlistscreenbq0.png">
...
unsafeWindow.flAddFriend = function(){
	...
	if(flNewName.value == "" || flNewName.value == flNewName.defaultValue || flNewLink.value == "" || flNewLink.value == flNewLink.defaultValue){
		return alert("Var snäll och fyll i alla fälten.");
	}
...
unsafeWindow.flDeleteFriend = function(FriendName, FriendLink){
	...
	var flConfirm = confirm("Är du säker på att du vill ta bort " + FriendName + "?");
...
unsafeWindow.flToggleFrame = function(nr){
	...
	if(nr == 1){
		document.getElementById("flButtonArea").innerHTML = '<div id="flHeader" onClick="flToggleFrame(0);">Vänner</div>';
...
unsafeWindow.flExport = function(){
	...
	if(IkariamFriendList == "0"){
		return alert("There are no friends on the list");
	}
	
	prompt('Copy this text', IkariamFriendList);
	
}

// Import function
unsafeWindow.flImport = function(){
	var flImportValue = prompt('Please paste in the exported data');
...
unsafeWindow.flRemplaza = function(){
	var flRemplazaValue = prompt('To erase the friends list, type 0.');
...
if(IkariamFriendList == "0"){
	...
	flHTML += '<center>You have no friends =[</center>';
...
flHTML += '<div style="text-align:center;"><hr>Lägg till en vän<br><input type="text" name ="flNewName" id="flNewName" value="Namn" onFocus="javascript:if(this.value == this.defaultValue) this.value = \'\';" onblur="javascript:if(this.value == \'\') this.value = this.defaultValue;" /><p><a onClick="javascript:flInsertCurrentURL();" style="font-size: 9px; cursor: pointer;">Använd aktuell URL</a></p><input type="text" name ="flNewLink" id="flNewLink" value="URL" onFocus="javascript:if(this.value == this.defaultValue) this.value = \'\';" onblur="javascript:if(this.value == \'\') this.value = this.defaultValue;" /><br /><br /><a href="javascript:flAddFriend();" class="button">&nbsp;&nbsp;&nbsp;Lägg till&nbsp;&nbsp;&nbsp;</a><br><p style="padding-top: 8px;"><a href="javascript:flExport();" class="flSmall" style="font-size: 10px;">Exportera</a> | <a href="javascript:flImport();" class="flSmall" style="font-size: 10px;">Importera</a></p> <p><a href="javascript:flRemplaza();" class="flSmall" style="font-size: 10px;">Att ersätta</a></p></div>';
