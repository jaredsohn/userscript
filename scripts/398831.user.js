// ==UserScript==
// @name       JVC Unlimited Smiley
// @namespace  http://use.i.E.your.homepage/
// @version    1.5
// @description  Problèmes de bug dans les envois en cours de résolution, désormais seule la réponse rapide de JVCMaster est incompatible! 
// @include     http://www.jeuxvideo.com/*
// @include     http://*.forumjv.com/*
// @copyright  2014...2016, Jean-Pelouse, forumer JVC aussi connu sous le pseudo de Jean-PeIouse
// ==/UserScript==
...
chaine=chaine.replace(reg,"<img border='0' src='http://image.jeuxvideo.com/smileys_img/nyu.gif' />");
