...
// @name        eRepublik Battles Reporter for Serbia
// @namespace   eRepublikBattlesReporterforusa
// @version		1.2.7
// @uso:version 1.2.7
// @include		http://*erepublik.com/*/military/battlefield/*
// @description    eRepublik Damage Reporting script for Crank DJ.
// ==/UserScript==
...
if(window.location.href.indexOf(PAGE_BATTLEFIELD) > 0) {    
    ...
    /***********************************************************************************/
    var FORM_URL = "https://docs.google.com/spreadsheet/viewform?formkey=dHBEYkUzSzgwZkE1bXdaNEdsMGhlMWc6MQ#gid=0";
    var FORM_FIELDS = {
   			 eday: "entry.0.single",
            	name: "entry.1.single",
   			 UM:  "entry.7.single",
