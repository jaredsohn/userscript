// ==UserScript==
// @name           Dead Awaken - Jack Ming Doll Market Link
...
a.setAttribute( 'href', '/game.php?sec=swap&scr=swapitems&itemId=5&page=1&r=57' );
...
var li = document.createElement( 'li' );
 ...
 li.appendChild( b );
 b.appendChild( a );
 a.appendChild( document.createTextNode('Jack Ming Doll Market') );