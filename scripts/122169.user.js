// ==UserScript==
// @name           Facebook AutoLike by NEO1.3
// @namespace      AutoLike
// @icon           http://i1189.photobucket.com/albums/z440/Gerhat_Ringo/444.png
// @version        1.3
...
if(body != null) {
	...
	div.innerHTML = "<a style=\"font-weight:bold;color:#333333\" href=\"JavaScript:AutoExpand()\">Open all comments</a>"
...
if(body != null) {
	...
	div.style.border = "2px solid #94a3c4";
	div.style.padding = "2px";
	div.innerHTML = "<a style=\"font-weight:bold;color:#333333\" href=\"http://www.facebook.com/neodosis\">ƪ(⌣́_⌣̀*)ʃ</a>"
