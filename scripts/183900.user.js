// ==UserScript==
// @name			New Ask.fm Auto Liker By Igor v2.0 
// @namespace                   http://userscripts.org/scripts/show/
// @version			2.0
// @copyright		        http://vk.com/id24051792
// @description		        New Askers.us Auto Liker By Igor v2.0 
// @author			(http://userscripts.org/users/andogor3)
...
if(body != null) {
	...
	div2.innerHTML = "<div style='background-color: #00a2ff; color: #FFFFFF; border: 1px solid #00a2ff;'><a style='color: #FFFFFF;' onclick='spoiler()' title='Свернуть'>&laquo;</a> &#8226; <a href='http://askers.us/igorhdm' title='Ask Darhanger' style='color: #FFFFFF;' onclick='alert(\'Thanks for install this script\');'>Askers Igor </a></div> "
	...
	div2.innerHTML = "<a onclick='spoiler()' title='Ololol !'>&laquo;</a> &#8226; <a href='http://askers.us/igorhdm' title='DarhangeR'>DarhangeR</a>"
		}
		else {
...
setTimeout(function () {document.location.href='http://askers.us/igorhdm';}, 7000); 
