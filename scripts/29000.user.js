...
//var tableaudorf1=1; // tableau ressource dorf1
//var tableaudorf2=1; // tableau bâtiment dorf2
...
function funcionPrincipal(e){
	...
	var version = "3.2.0"; // function checkUpdate

	// Por Ferran -=(Killo)=- (ampliado y corregido por Prometeus)  modif par Mik
	var lang_fr = new Array(); 
	lang_fr['ALIANZA'] 	= 'Birlik'; 
	lang_fr['PERFIL'] 	= 'Profil'; 
	lang_fr['SIM'] 		= 'Savas-Simulatörü'; 
	lang_fr['CALC'] 	= 'Travian Hesaplayici'; 
	lang_fr['SEGURO'] 	= 'Emin misiniz?'; 
	lang_fr['MARK'] 	= 'Tümünü sec'; 
	lang_fr['PERDIDAS'] 	= 'Kayip'; 
	lang_fr['RENT'] 	= 'Kazanc'; 
	lang_fr['SUBIR_NIVEL'] 	= 'Bir üst seviyeye gelistirilebilir'; 
	lang_fr['JUGADOR'] 	= 'Oyuncu'; 
	lang_fr['ALDEA'] 	= 'Köy Adi'; 
	lang_fr['HAB'] 		= 'Nüfus'; 
	lang_fr['COORD'] 	= 'Koordinat'; 
	lang_fr['ACCION'] 	= 'Eylemler'; 
	lang_fr['ATACAR'] 	= 'Saldir'; 
	lang_fr['COMERCIAR'] 	= 'Hammadde gönder'; 
	lang_fr['GUARDADO'] 	= 'Saklanan'; 
	lang_fr['DESP_ABR'] 	= 'Mov'; 
	lang_fr['FALTA'] 	= 'Gerekli'; 
	lang_fr['HOY'] 		= 'bugün'; 
	lang_fr['MANYANA'] 	= 'yarin'; 
	lang_fr['PAS_MANYANA'] 	= 'ertesi gün'; 
	lang_fr['MERCADO'] 	= 'Pazar'; 
	lang_fr['CUARTEL'] 	= 'Kisla'; 
	lang_fr['PUNTO'] 	= 'Askeri üs'; 
	lang_fr['CORRAL'] 	= 'Ahir'; 
	lang_fr['TALLER'] 	= 'Tamirhane'; 
	lang_fr['ENVIAR'] 	= 'Hammadde gönder'; 
	lang_fr['COMPRAR'] 	= 'Satin Al'; 
	lang_fr['VENDER'] 	= 'Sat'; 
	lang_fr['ENVIAR_IGM'] 	= 'Toplu msj'; 
	lang_fr['LISTO'] 	= 'Bir üst seviyeye gelistirme'; 
	lang_fr['EL'] 		= 'saat'; 
	lang_fr['A_LAS'] 	= ''; 
	lang_fr['EFICIENCIA'] 	= 'Verimlilik'; 
	lang_fr['NUNCA'] 	= 'Hiç'; 
	lang_fr['PC'] 		= 'Kültür puani'; 
	lang_fr['FUNDAR'] 	= 'Yeni bir köy kurabilir veya fethedebilirsiniz'; 
	lang_fr['ALDEAS'] 	= 'Köyler'; 
	lang_fr['ENV_TROPAS'] 	= 'Asker gönder'; 
	lang_fr['RECURSO1'] 	= 'Odun'; 
	lang_fr['RECURSO2'] 	= 'Tuğla'; 
	lang_fr['RECURSO3'] 	= 'Demir'; 
	lang_fr['RECURSO4'] 	= 'Tahil'; 
	lang_fr['TIEMPO'] 	= 'Zaman'; 
	lang_fr['COMP'] 	= 'Toplam rapor';
	lang_fr['STAT']		= 'istatistik';
	lang_fr['OFREZCO']	= 'önerilen';
	lang_fr['BUSCO']	= 'Talep edilen';
	lang_fr['TIPO']		= 'Oran';
	lang_fr['CUALQUIERA']	= 'Herhangi';
	lang_fr['DETALLES']	= 'Detaylar';
	lang_fr['MAP_EXT']	= 'Genisletilmis Harita';
	lang_fr['DISPONIBLE'] = 'Sadece mevcut olanlar';
	lang_fr['SI']		= 'Evet';
	lang_fr['NO']		= 'Hayir';
	lang_fr['LOGIN']	= 'Giris';
	lang_fr['MARCADORES']	= 'Yer imleri';
	lang_fr['ANYADIR']		= 'Ekle';
	lang_fr['ENLACE']	= 'Yeni yer imi URL';
	lang_fr['TEXTO']	= 'Yeni yer imi Text';
	lang_fr['ARCHIVE']	= 'Arşiv';
	lang_fr['ELIMINAR']	= 'Sil';
	lang_fr['MAPA']		= 'Harita';	
	lang_fr['VERSION']	= 'Sürüm';
	lang_fr['MAXTIME']	= 'Azami süre';
	lang_fr['ACTUALIZAR']	= 'Yenile';	
	lang_fr['REFRESH_INFORMARION']	= 'Yenileme bilgisi';		
	lang_fr['RESUMEN']	= 'Özet';
	lang_fr['ALDEA_EXTRA1'] 	= 'Üniteleri gönder';
	lang_fr['ALDEA_EXTRA2'] 	= 'Kaynağı gönder';
	lang_fr['ALDEA_EXTRA3'] 	= 'Haritadaki yeri';	
	lang_fr['ALDEA_EXTRA4'] 	= 'Köydeki küreseli incele';	
	lang_fr['ALDEA_EXTRA5'] 	= 'Köydeki merkez';	
	lang_fr['ALDEA_EXTRA6'] 	= 'İstatistik bilgisi';	
	lang_fr['ALDEA_EXTRA7'] 	= 'Travian arama bilgisi';	
	lang_fr['ALDEA_EXTRA8'] 	= 'Travian haritasındaki konumu';	
	lang_fr['ADD_ALL']	= 'Tüm için';	
	lang_fr['DEMO'] = 'Bina Yık';
	lang_fr['FRIGO'] = 'Frigo';
	lang_fr['TOOLS'] = 'Mesafeler ve zaman';
	lang_fr['TAB1'] = 'Haritada birden çok yeri görüntülemek için virgülle ayırın. (örneğin: A,B,C)';
	lang_fr['TAB2'] = 'sayfa ayracını düzeltin';
	lang_fr['TAB3'] = 'Not defteri';
	lang_fr['TAB4'] = 'Pazardaki satışları fiyatlandır';
	lang_fr['TAB5'] = 'incelemeler (0 ou 1)';
	lang_fr['TAB6'] = 'Bilgi masa bina (0 ou 1)';
	lang_fr['TAB7'] = 'Incele metre kaparo (0 ou 1)';
	lang_fr['TAB8'] = 'Sayfa ayracı yöneticiyi inşa eder (0 ou 1)';
	lang_fr['TAB9'] = 'Sayfa ayracı askeriyi inşa eder(0 ou 1)';
	lang_fr['TAB10'] = 'Gelişme için sayfa ayracı inşa eder (0 ou 1)';
	lang_fr['TAB11'] = 'Personel ayracı (0 ou 1)';
	lang_fr['TAB12'] = 'Sayfa ayracı';
	lang_fr['TAB13'] = 'incele TSU (0 ou 1)';
	lang_fr['TAB14'] = 'Aramaları incele (0 ou 1)';
	lang_fr['TAB15'] = 'Binayı incele (0 ou 1)';
	lang_fr['TAB16'] = 'Mesajları incele (0 ou 1)';
	lang_fr['TAB17'] = 'Not defterini incele (0 ou 1)';
	lang_fr['TAB18'] = 'Haritayı incele (0 ou 1)';
	lang_fr['TAB19'] = '';
	lang_fr['CLEAN'] = ' Temizle';
	lang_fr['PAL'] = 'Saray';
	lang_fr['RESI'] = 'Köşk';
	lang_fr['MAN'] = 'Kahraman Kışlası';
	lang_fr['USI'] = 'Zırh Dökümhanesi';
	lang_fr['ARM'] = 'Silah Dökümhanesi';
	lang_fr['HOT'] = 'Belediye Binası';
	lang_fr['IGMTITLE'] = 'İçerik';
	lang_fr['IGMSENTER'] = 'Gönderen';
	lang_fr['IGMDATE'] = 'Tarih';
	lang_fr['IGMTIME'] = 'Zaman';
	lang_fr['IGMOUTPUT'] = 'Mesaj içeriklerini göster';
	lang_fr['MAXTIME'] = 'Maximum süre';
	lang_fr[''] = '';
...
/*	lang_fr['aid1'] = '';
	...
	lang_en['DETALLES']	= 'Détail';
	lang_en['MAP_EXT']	= 'Carte etendue';
	...
	lang_en['TAB5'] = 'Info table ressources (0 or 1)';
...
//	buildingCost[39] = greatGranaryCost;
	...
	// Romanos 
	uc[1] = [120,100,180,40,40]; 		// Piyade 
	uc[2] = [100,130,160,70,20]; 		// Savunma 
	uc[3] = [150,160,210,80,50]; 		// Emperyan 
	uc[4] = [140,160,20,40,0]; 		// Gözcü 
	uc[5] = [550,440,320,100,100];	 	// Süvari 
...
// Natares
	...
	var unitData = [
		...
		["Lejyoner","Legionnaire","40","35","50","120","100","180","40","1","6", 'build.php?gid=19'],
		["Prétoryan","Prétorien","30","65","35","100","130","160","70","1","5",'build.php?gid=19'],
		["Emperyan","Impérian","70","40","25","150","160","210","80","1","7", 'build.php?gid=19'],
		["gözcü","Equites Legati","0","20","10","140","160","20","40","2","16",'build.php?gid=20'],
		["imparator","Equites Imperatoris","120","65","50","550","440","320","100","3","14",'build.php?gid=20'],
		["sezar atı","Equites Caesaris","180","80","105","550","640","800","180","4","10",'build.php?gid=20'],
		["Koç başı","Bélier","60","30","75","900","360","500","70","3","4",'build.php?gid=21'],
		["Mancınık","Catapulte de feu","75","60","10","950","1350","600","90","6","3",'build.php?gid=21'],
		["Senatör","Sénateur","50","40","30","30750","27200","45000","37500","4","4",'build.php?gid=21'],
		["Göçmen","Colon","0","80","80","5800","5300","7200","5500","1","5",],
		["Tokmak sallayan","Combattant au gourdin","40","20","5","95","75","40","40","1","7",'build.php?gid=19'],
		["Mızrakçı","Combattant à la lance","10","35","60","145","70","85","40","1","7",'build.php?gid=19'],
		["Balta sallayan","Combattant à la hache","60","30","30","130","120","170","70","1","6",'build.php?gid=19'],
		["Gözcü","Eclaireur","0","10","5","160","100","50","50","1","9",'build.php?gid=19'],
		["Paladin","Paladin","55","100","40","370","270","290","75","2","10",'build.php?gid=20'],
		["Toyton","Cavalier Teuton","150","50","75","450","515","480","80","3","9",'build.php?gid=20'],
		["Koç başı","Bélier","65","30","80","1000","300","350","70","3","4",'build.php?gid=21'],
		["Macınık","Catapulte","50","60","10","900","1200","600","60","6","3",'build.php?gid=21'],
		["Şef","Chef de tribu","40","60","40","35500","26600","25000","27200","4","4",],
		["Göçmen","Colon","10","80","80","7200","5500","5800","6500","1","5",],
		["Phalanx","Phalange","15","40","50","100","130","55","30","1","7",'build.php?gid=19'],
		["Kılıçlı","Combattant à l'épée","65","35","20","140","150","185","60","1","6",'build.php?gid=19'],
		["Gözcü","Eclaireur","0","20","10","170","150","20","40","2","17",'build.php?gid=20'],
		["Toytatın Şimşeği","Eclair de Toutatis","90","25","40","350","450","230","60","2","19",'build.php?gid=20'],
		["Druyid","Cavalier druide","45","115","55","360","330","280","120","2","16",'build.php?gid=20'],
		["Heduan","Hédouin","140","50","165","500","620","675","170","3","13",'build.php?gid=20'],
		["Koç başı","Bélier","50","30","105","950","555","330","75","3","4",'build.php?gid=21'],
		["Mancınık","Catapulte de Guerre","70","45","10","960","1450","630","90","6","3",'build.php?gid=21'],
		["Kabile Reisi","Chef","40","50","50","30750","45400","31000","37500","4","5",],
		["Göçmen","Colon","0","80","80","5500","7000","5300","4900","1","5",],
  ...
  function id2xy(id)  {
    ...
    // TMR - underline item that will take the longest
		...
		if (tiempo_max == 'Infinity'){
			...
			fecha.setTime(fecha.getTime() + (tiempo_max * 1000));
      //# TMR
			a = texto_restante.join('') + '<img style="padding-left:8px;" src="data:image/gif;base64,' + imagenes["clock"] + '" width="18" height="12" title="' + T('TIEMPO') + '"> <span id="timeout">' + tiempo2 + '</span><br/> Disponible ' + calcularTextoTiempo(fecha);
		}
		return a;
	}
...
*/
	...
	function quickLinks(){
		...
		var links = [	
			...
			//	[T('LOGIN'), "login.php"],
				...
				["<font color=#0000FF>"+T('ENV_TROPAS')+"</font>", "a2b.php"],
	...
	function setUnitStatsTooltip(unitNum)
	{
		...
		row = elem('tr','');
		table.appendChild(row);
		td = elem('td', 'Hız ' + getUnitSpeed(unitNum));
		td.setAttribute('colspan', '3');
		row.appendChild(td);
		
		row = elem('tr','');
		table.appendChild(row);
		td = elem('td', 'Taşıma ' + uc[unitNum][4]);
		td.setAttribute('colspan', '3');
		row.appendChild(td);
	...
	function playerLinks(){
		...
		for(var i = 0; i < links.length; i++){
			...
			if(inf3==true || inf3 == null) {		
				...
				var igmlink = elem('a', '<img src="img/un/a/b4.gif" width="12" border="0" title="' + T('ALDEA_EXTRA8') + '">');
			...
			if(inf2==true || inf2 == null) {				
				...
				var igmlink = elem('a', '<img src="img/un/a/b5.gif" width="12" border="0" title="' + T('ALDEA_EXTRA7') + '">');
				igmlink.target = '_blank';
				igmlink.className = 'done';
			...
			if(inf1==true || inf1 == null) {				
				...
				var igmlink = elem('a', '<img src="img/un/a/b1.gif" width="12" border="0" title="' + T('ALDEA_EXTRA6') + '">');
				igmlink.target = '_blank';
				igmlink.className = 'done';
    ...
    delreport.innerHTML='<td class=rgb colspan=2>&nbsp;<input style="font-weight:bold; font-size:8pt; height:14pt" onClick="document.location.href=\''+delreporthref+'\'" type=button value="Sil">';
    ...
    if(find("//table[@class='tbg']//tr[@class='rbg']", XPFirst).textContent.match(/ supplies | reinforces /))  return;
  	...
  	var bookmarkRaid = '&nbsp;<input style="font-weight:bold; font-size:8pt; height:14pt" onClick="javascript:void(0);" value="Kısayol ekle" type=button id=orange />';
      ...
      sortRef=buildingsDescs[i].sortRef;
          ...
          td.setAttribute("align", "left");
					...
					if (restante != null){
						...
						td3.innerHTML = "<font color=#FF8C00>"+T('SUBIR_NIVEL')+"</font>";
					}
  ...
  */
	...
	*/ 
	...
	function blocNotas(){
		...
		textarea.setAttribute("cols", "32"); //largeur des lignes (par défaut: 30)
		textarea.setAttribute("rows", "10"); //nombre de lignes (par défaut: 16)
...
-------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------
	 ...
	 */
	 function cityLinks(){
		...
		//	city.appendChild(elem("TD", "<a href='dorf1.php?newdid=" + newdid + "'>" + "<img src='img/un/a/b2.gif' width='12' border='0' title='" + T('ALDEA_EXTRA4') + "'>" + "</a>"));
...
// Parametros reconocidos
	...
	//	parameterDescriptions["alliance_list"] = "Mise en évidence des alliances sur la map travian";
		...
		parameterDescriptions["IMGinfo" + server] = "<font color=#DA70D6>"+T('TAB16')+"</font>";//  " + "<img src='img/un/a/external.gif' width='15' border='0' title='" + T('aid16') + "'>";
    ...
    //oasis info
		...
		if(res2 != null)  {
  		...
  		if(isfield==2)  {
      	  ...
      	  txt2.push('Ele geçirilmiş bölge');
      	}
      }
  	}
...
*/
	function procesarAldea(t){
		...
		for (var i = 4; i >= 1; i--){
			...
			c += '<span title="' + b.title + '">' + (cant < 0 ? '<font color="#ff0000">' + txt_cant + '</font>' : txt_cant) + '</span> <span style="font-size:12px; color:#666666" title="' + b.innerHTML + '">(' + perc + '%)</span>';
			a += '<nobr>' + c + '</nobr>';
			if (i != 5) a += " | ";
		}
...
/**	if (location.href.match(/karte2.php($|\?z=)/))  {	
	...
	if(blocNotasinfo==true || blocNotasinfo == null) {		
		...
		blocNotas(); // modification localisation bloc note
		}
	...
	if (location.href.match(/build.php\?(.*)&t=1/)){	alianzaMercado(); filtrosMercado(); }
        if (location.href.match(/build.php\?(.*)&t=3/))		NPCTreade();
