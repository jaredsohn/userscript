...
// @name           GyF_Tool_Bar
// @namespace      GyFtips
// @description    Herraminetas para la alianza GyF
// @include        http://s10.ikariam.*/index.php*
// @author         Original por Verx - Modificado por Taz2781 para GyF
// @version        20080615 102433
// ==/UserScript==

var GyFToolsIds  = new Array("opclos","FontForm","buscaBox","worldBox");
...
astreaToolsLink.setAttribute('id', 'GyFTool');
...
document.getElementById('GyFTool').innerHTML =
'<div id="menu">'
+ '<ul>'
+ ' <li><h2>GyFTool</h2>'
+ '   <ul>'
+ '     <li><center><a target="" href="http://s10.ikariam.es/index.php?view=sendIKMessage&msgType=51&allyId=1920" title="Envia mensaje Circular">Mensaje Circular</a></li>'
+ '     <li><center><a target="_blank" href="http://gordosyfeos.co.cc/" title=" Foro de laAliansa GyF ">Foro GyF</a></li>'
...
//+ '     <li><a href="#" title="Cambia il font" onclick="showTools(1)">Font <input style="margin-left:10px; visibility:hidden;" id="c'+GyFToolsIds[0]+'" type=CheckBox CHECKED DISABLED /></a></li>'
...
//+ '     <li><a href="#" title="Cerca un bersaglio" onclick="showTools(3)">Scansione <input style="margin-left:10px; visibility:hidden;" id="c'+GyFToolsIds[3]+'" type=CheckBox CHECKED DISABLED/></a></li>'
//+ '     <li><center><a target="_blank" href="http://board.ikariam.es/board.php?boardid=146&sid=07e8c02a8cb9918ddff893ebca524b33" title="Foro Oficial, Mundo kappa">Foro Oficial</a></li>'
+ '     <li><center><a target="_blank" href="http://support.ikariam.es/" title="Reportar a un GO">Envia un Ticket</a></li>'
...
elemToShow = document.getElementById(GyFToolsIds[toolID[i]]);

if (elemToShow) {
 if ((toolID[i] == 0) || (toolID[i] == 1)) {if (document.getElementById(GyFToolsIds[0]).style.visibility == 'hidden') {
 document.getElementById(GyFToolsIds[0]).style.visibility = 'visible';
 document.getElementById(GyFToolsIds[1]).style.visibility = 'visible';
 if (document.getElementById('c'+GyFToolsIds[0])) document.getElementById('c'+GyFToolsIds[0]).style.visibility='visible';
 } else {
 document.getElementById(GyFToolsIds[0]).style.visibility = 'hidden';
 document.getElementById(GyFToolsIds[1]).style.visibility = 'hidden';
 if (document.getElementById('c'+GyFToolsIds[0])) document.getElementById('c'+GyFToolsIds[0]).style.visibility='hidden';
 }  } else {
 if (elemToShow.style.visibility == 'hidden') {elemToShow.style.visibility = 'visible'; if (document.getElementById('c'+GyFToolsIds[toolID[i]])) document.getElementById('c'+GyFToolsIds[toolID[i]]).style.visibility='visible';}
 else {elemToShow.style.visibility = 'hidden'; if (document.getElementById('c'+GyFToolsIds[toolID[i]])) document.getElementById('c'+GyFToolsIds[toolID[i]]).style.visibility='hidden';}
 }
}
}
}
...
var elemTrigger = document.getElementById(GyFToolsIds[0]);
