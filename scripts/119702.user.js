...
// ==/UserScript==
			...
			.replace(/:ecchifans:/g, "<style> .md img { display:inline; } .rageface { visibility:visible; } </style><img src=\'http://ecchifans.net23.net/Temas/default/images/logoBeta.png\' title='ecchifans' />")
