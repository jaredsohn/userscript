// ==UserScript==
// @name           MyFitnessPal Percentages and TOTAL Carbs w/Fiber Display
// @version 1.1
// @namespace      mcGusto231
// @description    Adds display of Carb/Protein/Fat/Fiber percentages to any daily food diary page. Also adds "Real Calories" calcalation based off 4/4/9 algorithm. Based on "MyFitnessPal Percentages", modified by Surye. Displays total carbs rather than net.
 ...
 *  ------------------------------------------------------------
 *  Slightly adjusted http://userscripts.org/scripts/show/124645
 *  Credit to Surye and Bompus
 */
...
function main()
{
	...
	var remaining_tr_elements = jQuery('.container tr.total.remaining');
