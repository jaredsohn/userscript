...
*/
// ==UserScript==
// @name          Amazon2bookdepository.co.uk
// @description	Make every Amazon book page link to bookdepository.co.uk (free delivery worldwide)
// @version       0.0.3
// @include       http://*.amazon.*
// ==/UserScript==
/*
			   "Amazon2bookdepository.co.uk"

This version completely based on Sean M. Burke's script Amazon2ISBN.nu 
http://userscripts.org/scripts/show/4012

Whenever you visit the Amazon page for a book, this script will add a
link on that page to the bookdepository.co.uk page for that book, so you can
compare prices, etc.
...
function my_link (a, isbn) {
  a.setAttribute('href', 'http://www.bookdepository.co.uk/WEBSITE/WWW/WEBPAGES/showbook.php?id=' + isbn);
  a.setAttribute('accesskey','j');
  a.setAttribute('title',"[alt-j]  Look this up at bookdepository.co.uk");
  a.setAttribute('target','_blank');
  a.appendChild( document.createTextNode('bd')); 
  a.style.border = '0';
