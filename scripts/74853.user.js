// ==UserScript==
// @name			Ikariam Ampliador De Edificios Con Templo
// @version			1.3.2
// @namespace		http://ikariam.org/
// @description		El mismo ampliador de edificios que conociamos pero le eh agregado el templo.
// @author			Tossko Snake Hotline [906]
// @homepage		
...
if (view == "options") {
    ...
    child = '<h3 class="header"><span class="textLabel">Ampliador De Edificios By Tossko Snake </span></h3><div class="content"><form action="index.php" method="GET"><input type=hidden name=view value="options"><table cellpadding="0" cellspacing="0"><tr><th>¿Mostar Cuadro De Informacion?</th><td><input type="radio" name="iuwInfoBox" value="true" '+checkedYes+'> Si (Recomendado)<br><input type="radio" name="iuwInfoBox" value="false" '+checkedNo+'> No</td></tr></table><div class="centerButton"><input class="button" type="submit" value="Save Setting" /></div></form></div><div class="footer"></div></div>';
