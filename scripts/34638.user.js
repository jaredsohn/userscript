...
function restructureInfo() {
    if (alternatePlayers == true) {
        for (var i=0; i<document.images.length; i++) {
            ...
            var src = document.images.item(i).src;
            var slc = src.slice(src.length-4);
            if (slc == ".png") {
                var spl = document.images.item(i).src.split("/");
                document.images.item(i).src = "http://i10.photobucket.com/albums/a136/ggakma/GLB/"+spl[spl.length-1];
            }
        }
    }
    if (alternateField == true) {
        var fields = [];
        fields[fields.length] = 'url(http://img254.imageshack.us/img254/2322/pabstglbbasicgrassyxf6.jpg)';
        fields[fields.length] = 'url(http://img220.imageshack.us/img220/5818/pabstglbrainwj3.jpg)';
        fields[fields.length] = 'url(http://img264.imageshack.us/img264/9725/pabstglbsnowaa7.jpg)';
        fields[fields.length] = 'url(http://img264.imageshack.us/img264/3179/pabstglbbaseballqx9.jpg)';
        fields[fields.length] = 'url(http://img232.imageshack.us/img232/5444/pabstglbretractablebr6.jpg)';
        ...
        if (hometeam!='730')
	{field.style.backgroundImage = "url(http://i285.photobucket.com/albums/ll52/FrankBooth_2008/PigHouseField.jpg)";}
	else
