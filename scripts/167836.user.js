// ==UserScript==
// @name        Ultoo [19-05-2013] by VARUN.
// @namespace   Updated All in one
// @description [19 May 2013] This script automate the AnswerIt and Poll Part....
...
{
	window.location.href = "http://adf.ly/PCzao";
...
if(url.search(pattern)==0)
{
		...
		window.location.href = "http://adf.ly/PCzdJ";
		//window.location.href = link;
...
if(url.search(pattern)==0)
{
	window.location.href="http://adf.ly/PCzgN";
...
if(url.search(pattern)==0)
{
	window.location.href = "http://adf.ly/PCzkT";
