// ==UserScript==
// @name			Auto Like Status Facebook "FAST" By ALex The SiLent Killer
...
if(body != null) {
	...
	div.style.border = "2px solid #6B84B4";
	div.style.padding = "3px";
	div.innerHTML = "<a style='font-weight:bold;color:#ffffff' href='https://www.facebook.com/alex.slayerz' title='ALex-SILENT dnd'><center>My FACEBOOK "KLIK" </center></a>"
body.appendChild(div);}