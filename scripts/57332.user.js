...
// @name           eIndia Orders
// @version        0
// @namespace      http://www.erepublik.com/en/organization/1285923
// @description    Retrieves the orders for eIndia and shows them on your eRepublik homepage.
// @include        http://www.erepublik.com/*
// ==/UserScript==

var ordersurl = "http://forum.erepublikindia.com/phpBB3/viewtopic.php?f=53&t=2145";

var selectedunit = GM_getValue("defaultunit");
if (selectedunit==undefined) selectedunit = 1;
var units = ["President", "MoD", "NPF", "MOFA", "Forums"];
