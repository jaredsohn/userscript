// ==UserScript==
                // @name	Travian Big Map For AE
                // @namespace	TRAVIAN BIG MAP
                // @author	hassan
                // @description	Travian Big Map For AE                        
                // @version	1.0.0
                // @include	http://*.travian.*/karte.php*
                // ==/UserScript==
                
                /*** Code to create Large Map Button -- translate by hassan ***************************************************************************************/
                ...
                //	loadFalseData();
                	...
                	function createInfoBox() {
                		...
                		info.innerHTML = '<table dir="rtl" class="f8 map_infobox_grey" width="100%" cellspacing="1" cellpadding="2">' +
                				 '<tr><td class="c b" colspan="2" align="center">' + '������� ������' + '</td></tr>' +
                				 '<tr><td class="c s7" width="45%" ><p align="right">' + '��� ������' + '</p></td><td class="c s7"><p align="center">-</p></td></tr>' +
                				 '<tr><td class="c s7"><p align="right">' + '������' + '</p></td><td class="c s7"><p align="center">-</p></td></tr>' +
                				 '<tr><td class="c s7"><p align="right">' + '�������' + '</p></td><td class="c s7"><p align="center">-</p></td></tr>' +
                				 '</table>';
                		return info;
                	}
                	...
                	function createMapAreas() {
                		var map = dst.cn('map');
                		map.name = 'map2';
                		map.innerHTML = '<area dir="north" href="#" coords="762,115,30" shape="circle" title="צפו�?">' +
                				'<area dir="east"  href="#" coords="770,430,30" shape="circle" title="�?זרח">' +
                				'<area dir="south" href="#" coords="210,430,30" shape="circle" title="דרו�?">' +
                				'<area dir="west"  href="#" coords="200,115,30" shape="circle" title="�?ערב">';
                		...
                		return function() {
                			...
                			if (name) {
                				var table = '<table dir="rtl" cellspacing="1" cellpadding="2" class="tbg f8"><tr>'+
                					    ...
                					    '</td></tr><tr><td width="45%" class="s7 f8"><p align="right">' + '������' +
                					    '</p></td><td class="s7 f8">' + owner +
                					    '</td></tr><tr><td class="s7 f8"><p align="right">' + '������' +
                				...
                				var table = '<table dir="rtl" class="f8 map_infobox_grey" cellspacing="1" cellpadding="2"><tr><td class="c b" colspan="2" align="center"></a>' + '������� ������' +
                					    '</td></tr><tr><td align="right" width="45%" class="c s7"><p align="right">' + '��� ������' +
                					    '</p></td><td class="c s7"><p align="center">-</p></td></tr><tr><td class="c s7"><p align="right">' + '������' +
                					    '</p></td><td class="c s7"><p align="center">-</p></td></tr><tr><td class="c s7"><p align="right">' + '�������' +
                	...
                	function makeEventMouseOut() {
                		return function() {
                			...
                			var info = doc.getElementById('tb');
                			var table = '<table dir="rtl" class="f8 map_infobox_grey" cellspacing="1" cellpadding="2"><tr><td class="c b" colspan="2" align="center"></a>' + '������� ������' +
                					'</td></tr><tr><td width="45%" class="c s7"><p align="right">' + '��� ������' +
                					'</p></td><td class="c s7"><p align="center">-</p></td></tr><tr><td class="c s7"><p align="right">' + '������' +
                					'</p></td><td class="c s7"><p align="center">-</p></td></tr><tr><td class="c s7"><p align="right">' + '�������' +
                					'</p></td><td class="c s7"><p align="center">-</p></td></tr></table>';
                			info.innerHTML = table;
