// ==UserScript==
// @name          TribalWars Plus v0.7.1 Spanish
// @namespace     http://diveintogreasemonkey.org/download/
// @description   Barra de navegacion para TribalWars. Optimo para ancho a 900 pixels (cambiar en Preferencias -> Opciones en TribalWars)
// @include       http://tw*.tribalwars.net/game.php*
// @include       http://w*.tribalwars.es/game.php*
// ==/UserScript==
...
function updateMap() {
  ...
  $.get(gameURL+'&screen=map&xml&start_x='+mapx+'&start_y='+mapy+'&size_x=7&size_y=7',
  ...
  //if (GM_getValue('villageDropdown') == null) {
    ...
    $.get(gameURL,
      ...
      function(data) {
        ...
        /* List of Villages */
        var dStart = '<tr><th>Pueblo</th><th>Puntos</th><th>Recursos</th><th>Almacén</th><th>La Granja</th>';
        var dEnd = '</table>';
        ...
        pTable.innerHTML = sDropDown + '</select> - <a href="'+gameURL+'&screen=overview_villages">Pueblos</a> - <a href="'+gameURL+'&screen=map">Mapa</a> - <a href="'+gameURL+'&screen=overview">Visión General Pueblo</a>';
      }
    );
  //}
}
...
/* MenuBar Styles */
var newStyles = '';
newStyles += '.menu {font: 12px arial; width:900px; position:relative; margin:0px 0 0px 0; z-index:10;}';
newStyles += '.menu ul li a, .menu ul li a:visited {display:block; text-decoration:none; color:#000;width:104px; height:16px; text-align:center; color:#804000; border:2px solid #804000; border-left: 0px; border-right: 0px; background:#f1ebdd; line-height:20px; padding: 4px; overflow:hidden;}';
...
newStyles += '.menu ul li:hover ul {display:block; position:absolute; top:28px; left:0; width:104px;}';
newStyles += '.menu ul li:hover ul li a.hide {background:#804000; color:#fff}';
newStyles += '.menu ul li:hover ul li:hover a.hide {color:#000; background:#ded3b9;}';
newStyles += '.menu ul li:hover ul li ul {display: none;}';
newStyles += '.menu ul li:hover ul li a {display:block; background:#f1ebdd; border: 1px solid #804000; border-top: 0; color:#804000;}';
newStyles += '.menu ul li:hover ul li a:hover {color:#000; background:#ded3b9;}';
...
newStyles += '.filtro_td { border-left: dotted 1px #BBBBBB; border-right: dotted 1px #BBBBBB; text-align: center;}';
/*
...
menuBarTop += '  <ul>';
/* Logout */
menuBarTop += '    <li style="border-left:2px solid #804000"><a class="hide" href="'+gameURL+'&screen=&action=logout&h='+myHash+'">Salir</a></li>';

/* Foro */
menuBarTop += '    <li><a class="hide" href="http://board.tribalwars.es/">Foro</a>';
menuBarTop += '    	<ul>';
menuBarTop += '      	<li><a href="http://board.tribalwars.es">Español</a></li>';
menuBarTop += '      	<li><a href="http://forum.tribalwars.net">Inglés</a></li>';
menuBarTop += '       </ul>';
menuBarTop += '    </li>';
...
/* Settings */
menuBarTop += '    <li><a class="hide" href="'+gameURL+'&screen=settings">Preferencias</a>';
menuBarTop += '    	<ul>';
menuBarTop += '       <li><a href="help.php">Ayuda</a></li>';
menuBarTop += '      	<li><a href="'+gameURL+'&screen=settings&mode=profile">Perfil</a></li>';
menuBarTop += '      	<li><a href="'+gameURL+'&screen=settings&mode=email">Email</a></li>';
menuBarTop += '      	<li><a href="'+gameURL+'&screen=settings&mode=settings">Opciones</a></li>';
menuBarTop += '      	<li><a href="'+gameURL+'&screen=settings&mode=move">Reiniciar</a></li>';
menuBarTop += '      	<li><a href="'+gameURL+'&screen=settings&mode=delete">Borrar cuenta</a></li>';
menuBarTop += '      	<li><a href="'+gameURL+'&screen=settings&mode=share">Compartir Conex.</a></li>';
menuBarTop += '      	<li><a href="'+gameURL+'&screen=settings&mode=vacation">Vacaciones</a></li>';
menuBarTop += '      	<li><a href="'+gameURL+'&screen=settings&mode=logins">Accesos</a></li>';
menuBarTop += '      	<li><a href="'+gameURL+'&screen=settings&mode=change_passwd">Cambiar Passwd</a></li>';
menuBarTop += '      	<li><a href="'+gameURL+'&screen=settings&mode=poll">Encuestas</a></li>';
menuBarTop += '      </ul>';
menuBarTop += '    </li>';

/* Ranking */
menuBarTop += '    <li><a class="hide" href="'+gameURL+'&screen=ranking">Clasificación</a>';
menuBarTop += '    	<ul>';
menuBarTop += '      	<li><a href="'+gameURL+'&screen=ranking&mode=ally">Tribus</a></li>';
menuBarTop += '      	<li><a href="'+gameURL+'&screen=ranking&mode=player">Jugadores</a></li>';
menuBarTop += '      	<li><a href="'+gameURL+'&screen=ranking&mode=con_ally">Tribus Continente</a></li>';
menuBarTop += '      	<li><a href="'+gameURL+'&screen=ranking&mode=con_player">Jugad. Continente</a></li>';
menuBarTop += '      	<li><a href="'+gameURL+'&screen=ranking&mode=kill_player">Advers. Vencidos</a></li>';
menuBarTop += '      </ul>';
menuBarTop += '    </li>';
...
/* Tribe */
menuBarTop += '    <li><a class="hide" href="'+gameURL+'&screen=ally">'+newPost+'Tribu</a>';
menuBarTop += '    	<ul>';
menuBarTop += '      	<li><a href="'+gameURL+'&screen=ally&mode=overview">Vista general</a></li>';
menuBarTop += '      	<li><a href="'+gameURL+'&screen=ally&mode=profile">Perfil</a></li>';
menuBarTop += '      	<li><a href="'+gameURL+'&screen=ally&mode=members">Socios</a></li>';
menuBarTop += '      	<li><a href="'+gameURL+'&screen=ally&mode=contracts">Diplomacia</a></li>';
menuBarTop += '      	<li><a href="'+gameURL+'&screen=ally&mode=invite">Invitaciones</a></li>';
menuBarTop += '      	<li><a href="'+gameURL+'&screen=ally&mode=forum">Foro</a></li>';
menuBarTop += '      </ul>';
menuBarTop += '    </li>';
...
menuBarTop += '    <li><a class="hide" href="'+gameURL+'&screen=report">'+newReport+'Informes</a>';
menuBarTop += '    	<ul>';
menuBarTop += '      	<li><a href="'+gameURL+'&screen=report&mode=all">Todos</a></li>';
menuBarTop += '      	<li><a href="'+gameURL+'&screen=report&mode=attack">Ataques</a></li>';
menuBarTop += '      	<li><a href="'+gameURL+'&screen=report&mode=defense">Defensa</a></li>';
menuBarTop += '      	<li><a href="'+gameURL+'&screen=report&mode=support">Apoyo</a></li>';
menuBarTop += '      	<li><a href="'+gameURL+'&screen=report&mode=trade">Comercio</a></li>';
menuBarTop += '      	<li><a href="'+gameURL+'&screen=report&mode=other">Otros</a></li>';
menuBarTop += '      	<li><a href="'+gameURL+'&screen=report&mode=forwarded">Reenviado</a></li>';
menuBarTop += '      	<li><a href="'+gameURL+'&screen=report&mode=filter">Filtro</a></li>';
menuBarTop += '      	<li><a href="'+gameURL+'&screen=report&mode=block">Bloquear remitente</a></li>';
menuBarTop += '      </ul>';
menuBarTop += '    </li>';
...
menuBarTop += '    <li style="border-right:2px solid #804000"><a class="hide" href="'+gameURL+'&screen=mail">'+newMail+'Mensajes</a>';
menuBarTop += '    	<ul>';
menuBarTop += '      	<li><a href="'+gameURL+'&screen=mail&mode=in">Entrada</a></li>';
menuBarTop += '      	<li><a href="'+gameURL+'&screen=mail&mode=mass_out">Salida</a></li>';
menuBarTop += '      	<li><a href="'+gameURL+'&screen=mail&mode=new">Escribir</a></li>';
menuBarTop += '      	<li><a href="'+gameURL+'&screen=mail&mode=block">Bloquear remitente</a></li>';
menuBarTop += '      </ul>';
menuBarTop += '    </li>';
...
menuBar += '  <ul>';
/* HQ */
menuBar += '    <li style="border-left:2px solid #804000"><a class="hide" href="'+gameURL+'&screen=main"><img src="'+baseURL+'/graphic/buildings/main.png" border="0">&nbsp;Centro</a>';
menuBar += '    	<ul>';
menuBar += '      	<li><a href="'+gameURL+'&screen=main&mode=build">Construir</a></li>';
menuBar += '      	<li><a href="'+gameURL+'&screen=main&mode=destroy">Derribo</a></li>';
menuBar += '      	<li><a href="http://www.guscreations.com/item.php?key=buscador_tribalwars" target="_blank">Buscar Pueblos</a></li>';
menuBar += '      	<li><a href="http://www.freewebs.com/bydarkmen/calcu2.html" target="_blank">Calculad. Tropas</a></li>';
menuBar += '      	<li><a href="http://www.freewebs.com/bydarkmen/calcuup.html" target="_blank">Calculadora Bot&iacute;n</a></li>';
menuBar += '      	<li><a href="http://www.freewebs.com/bydarkmen/perdida.html" target="_blank">Calc.Recuperaci&oacute;n</a></li>';
menuBar += '      </ul>';
menuBar += '    </li>';

/* Barracks */
menuBar += '    <li><a class="hide" href="'+gameURL+'&screen=barracks"><img src="'+baseURL+'/graphic/buildings/barracks.png" border="0">&nbsp;Cuartel</a></li>';

/* Stable */
menuBar += '    <li><a class="hide" href="'+gameURL+'&screen=stable"><img src="'+baseURL+'/graphic/buildings/stable.png" border="0">&nbsp;Cuadra</a></li>';

/* Workshop */
menuBar += '    <li><a class="hide" href="'+gameURL+'&screen=garage"><img src="'+baseURL+'/graphic/buildings/garage.png" border="0">&nbsp;Taller</a></li>';

/* Academy */
menuBar += '    <li><a class="hide" href="'+gameURL+'&screen=snob"><img src="'+baseURL+'/graphic/buildings/snob.png" border="0">&nbsp;Corte</a>';
menuBar += '    	<ul>';
menuBar += '      	<li><a href="'+gameURL+'&screen=snob&mode=fetch">Almacenar</a></li>';
menuBar += '      </ul>';
menuBar += '    </li>';

/* Smithy */
menuBar += '    <li><a class="hide" href="'+gameURL+'&screen=smith"><img src="'+baseURL+'/graphic/buildings/smith.png" border="0">&nbsp;Herrería</a></li>';

/* Rally Point */
menuBar += '    <li><a class="hide" href="'+gameURL+'&screen=place"><img src="'+baseURL+'/graphic/buildings/place.png" border="0">&nbsp;Plaza</a>';
menuBar += '    	<ul>';
menuBar += '      	<li><a href="'+gameURL+'&screen=place&mode=command">Ordenes</a></li>';
menuBar += '      	<li><a href="'+gameURL+'&screen=place&mode=units">Tropas</a></li>';
menuBar += '      	<li><a href="'+gameURL+'&screen=place&mode=sim">Simulador</a></li>';
menuBar += '      </ul>';
menuBar += '    </li>';

/* Market */
menuBar += '    <li style="border-right:2px solid #804000"><a class="hide" href="'+gameURL+'&screen=market"><img src="'+baseURL+'/graphic/buildings/market.png" border="0">&nbsp;Mercado</a>';
menuBar += '    	<ul>';
menuBar += '      	<li><a href="'+gameURL+'&screen=market&mode=send">Enviar</a></li>';
menuBar += '      	<li><a href="'+gameURL+'&screen=market&mode=own_offer">Mis Ofertas</a></li>';
menuBar += '      	<li><a href="'+gameURL+'&screen=market&mode=other_offer">Otras Ofertas</a></li>';
menuBar += '      	<li><a href="'+gameURL+'&screen=market&mode=traders">Comerciantes</a></li>';
menuBar += '      </ul>';
menuBar += '    </li>';
menuBar += '  </ul>';
menuBar += '</div>';
...
if (getParam('screen') == 'overview') {
  ...
  wood.innerHTML = wood.innerHTML + ' / <strong>' + (woodAmt * 24) + '</strong> por Día';
  clay.innerHTML = clay.innerHTML + ' / <strong>' + (clayAmt * 24) + '</strong> por Día';
  iron.innerHTML = iron.innerHTML + ' / <strong>' + (ironAmt * 24) + '</strong> por Día';
...
/*  pTable = allTables[5].tBodies[0].rows[0].cells[0].childNodes[1];
  ...
  tOutput += '<legend style="font-weight: bold; font-size: 14px">Encontrar Nuevas Granjas</legend>';
  tOutput += '<form action="http://www.guscreations.com/scripts/tribalwars/tribalwars_lista.php">';
  tOutput += '<table width="100%" class="filtro_table"><tr>';
  tOutput += '<input type="hidden" name="x" value="'+myCoords[0]+'">';
  tOutput += '<input type="hidden" name="y" value="'+myCoords[1]+'">';
  tOutput += '<td class="filtro_td">Distancia mýx: <input type="text" size="1" maxlength="5" value="5"></td>';
  tOutput += '<td class="filtro_td">Puntos mýn: <input type="text" size="2" maxlength="6" value="300"></td>';
  tOutput += '<td class="filtro_td">Abandonados: <input name="filtro_deshabitado" id="filtro_deshabitado"  type="checkbox" checked></td>';
  tOutput += '<td class="filtro_td">Sin tribu: <input type="checkbox"></td>';
  tOutput += '<td class="filtro_td">Con tribu: <input type="checkbox"></td>';
  tOutput += '<input type="hidden" name="world" value="'+nWorld+'">';
  tOutput += '<td class="filtro_td">Ordenar por:<select>';
  tOutput += '<option value ="distancia" selected>Distancia</option><option value ="puntos">Puntos</option></select></td><tr>';
  tOutput += '<td class="filtro_td"><input type="submit" name="submit" value="Buscar"></form></fieldset>';
