...
// @description	Version 4.2 Enables video streaming from 2shared, and megaupload/megaporn via www.icedivx.com. This script works closely with the high quality video links database www.icefilms.info
	...
	else if (!document.getElementById('iceQuickStream'))
	{
		...
		for (var i=0;i<a.length;i++){
			if (a[i].href.indexOf('megaupload.com/files/') > 0){
				...
				var ss = document.createElement("script");
				ss.text = "function Ice(){}function countdown(){}function setTimeout(){}";
				var hh = document.getElementsByTagName('head')[0];
				hh.appendChild(ss);
				iceEmbed();
				break;
