// ==UserScript==
// @id             Gift acceptor 343
// @name           Auto Gift acceptor For 343 Edited ßy RedSoldier
// @version        Fetih_1453
// @namespace      Auto Gift acceptor For 343 Edited ßy RedSoldier
// @homepage       http://userscripts.org/
// @author         RedSoldier
// @description    Auto Gift Acceptor For Annwyn343
				...
				if(claim_gift){
					...
					if(domain_selector && (next_button1 || next_button2)){
						for(var i=0; i<domain_selector.options.length; i++){
							if(domain_selector.options[i].value == "343"){
