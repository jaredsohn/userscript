// ==UserScript==
// @name            Facebook Auto Subscriber(convert any group to fan page)
// @namespace       Facebook Auto Subscriber(convert any group to fan page)
// @Hak Cipta       Smart Boy
