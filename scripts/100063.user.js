...
/*
	...
	2011-03-11	v1.00	Merged RepeatJob Italy and Vegas again. Will probably regret this.
*/
javascript:(function(){
try { //megatry
	//begin unframe code
	...
	var version = 'RepeatJob Redux v1.00 beta', jobstodo = 0, job = 0, onevent = 'Pause', wait1 = 1, wait2 = 2, bankwithdraw = 'No', combinedloot='',
	...
	function write_settings() {
		var settings = wait1+'|'+wait2+'|'+onevent+'|'+log_size+'|'+bankamount+'|'+mafiasize+'|'+mafialvl+'|'+bankwithdraw+'|'+popup_handle;
		createCookie('rj_'+current_city+'_settings',settings);
	}
...
//	var bankingrow = '';
	...
	'<div id="'+spocklet+'_main">'+
		...
		'<tr><td colspan="3" align="center" style="text-align:center;font-size:1.1em;">'+logo+'<br />'+version+' - <a href="http://www.spockholm.com/mafia/donate.php?RepeatJobRedux" id="donate" alt="Donate a pint" target="_blank">Donate</a> - <a href="http://www.spockholm.com/mafia/help.php" alt="Help" target="_blank">Help</a> - '+
		...
		'<tr>'+
			...
			'<td align="right" style="text-align:right;">Delay <input id="delay1" name="delay1" type="text" value="'+wait1+'" maxlength="1" /> - <input id="delay2" name="delay2" type="text" value="'+wait2+'" maxlength="1" />sec</td></tr>'+
		'<tr>'+
			'<td>Stats:</td>'+
		...
		'<tr>'+
			'<td>Restart:</td>'+
			'<td colspan="2">Enable restarting: <input id="restart" type="checkbox" '+enable_restart+' /> &nbsp; <span id="restart-row"><input id="restart-timer" type="text" value="1" maxlength="1" /> Minute(s) before restarting. <span class="more_in">(Minimum: 1)</span></span></td>'+
		'</tr>'+
		...
		$.ajax({
			...
			success: function (response){
				...
				if(objectdata['job_results']['success'] == '1') {
					...
					// }
					if (jobsig === 'undefined') {
						var wait = myRandom(parseInt(wait1+1),parseInt(wait2+1));
