// ==UserScript==
// @name			New Facebook Chat Emoticons by Anonymous
// @author			Anonymous
// @description			Emoticons to Facebook Chat
// @version           2.0
// @versionnumber		2.0
...
// @namespace			http://userscripts.org/scripts/show/123054
// ==/UserScript==
...
/* START: Desing By "DoctoR.Ossi" (Osman Aplak) */
	...
	function handleUpdateResponse(r) {
		...
		if (r.responseText.match(/@versionnumber\s+(\d+\.\d+)/)[1] > version) {
			if(confirm("New Facebook Chat Emoticons'.\n ต้องการติดตั้งตอนนี้หรือไม่ ?")) openInTab('http://userscripts.org/scripts/source/123054.user.js');
		}
	}
