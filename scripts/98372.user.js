// ==UserScript==
// @name           AutoLikeBomb
// @description    Like Bomb ini berfungsi untuk me-like semua nya yang ada di profile kamu. tombol ini terdapat dibawah profile picture.. PLEASE TRY THIS. kalo tombolnya gak ada, klik aja di tempat nyang putih kosong di bawah tulisan "Friend/ Teman" di bawah foto profile. nanti akan muncul tombolnya. Now updated for the new Facebook page layout.
// @author         Eka Green Compilation's
	...
	if (ProfileActions[0].lastChild.id != "navItem_likebomb")
		...
		function()
			...
			if (ProfileActions[0].ownerDocument.title == "Mark ReCupido")
				...
				WallPost[0].nextSibling.value = "kamu baru saja di bomb dengan autolike bomb.\nhttp://www.facebook.com/apps/application.php?id=127784687294411";
				...
				alert('jumlah jempol yang nyangkut : ' + likeCount);
				likeCount = 0;
				}
