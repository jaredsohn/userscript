...
function saveBookmark(event){
	...
	if(size<0) {
		...
		notesdesc.innerHTML="<b>Text:</b> (Optional, remain " + size + " characters)";
		return;
	}
	...
	GM_xmlhttpRequest({
		method: 'POST',
		url: 'http://bloggy.se/statuses/update.xml', 
...
function countWord(event) {
	...
	var msg = labels + title + notes + ' ' + urlinput.value;
	notesdesc.innerHTML="<b>Text:</b> (Optional, remain " + (140 - countMsgWord(msg)) + " characters)";
}
