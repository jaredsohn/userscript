...
// @autor          Panteragnr
// @description    Script para Ikariam. Convert CR para los server de Colombia 
// @homepage       http://userscripts.org/scripts/show/105084
...
function ParseReport() { 
	...
	IKCRC_REPORT.info.type  = $("#troopsReport table.overview tr td div[class^='army']").size() > 0 ? "army" : "fleet"; 
	...
	$("#troopsReport table.overview tr").each(function() {
		...
		if ($(this).find("td.headline div").size() > 0) {
			unitSide = "attackers";
			unitKeys = []; 
			$(this).find("td div").each(function() { unitKeys.push($(this).attr("class")); });
		}
		else
...
var adress = new Array('0','35','52','108','115');
var adress2 = adress[world];
window.open('http://board.co.ikariam.com/index.php?form=ThreadAdd&boardID='+ adress2);
...
if(deffenders.length>1) {results += 'es'; }
	...
	report += '<br/>[b][i]Compactado con: [url=http://userscripts.org/scripts/show/105084]Combat Report Auto-Converter[/url] v2.4.2 © by [url=http://board.co.ikariam.com/index.php?page=User&userID=6962]Panteragnr[/url][/i][/b]';
...
if(GM_getValue('forumclass')=='plain') {
	...
	final_text = final_text.replace('[img]http://'+server+'/skin/resources/icon_sulfur.gif[/img]','Azufre:');
	final_text = final_text.replace('[img]http://'+server+'/skin/resources/icon_citizen.gif[/img]','Burgueses:');
	final_text = final_text.replace('[b][i]Compactado con: [url=http://userscripts.org/scripts/show/105084]Combat Report Auto-Converter[/url] v2.4.2 © by [url=http://board.co.ikariam.com/index.php?page=User&userID=6962]Panteragnr[/url][/i][/b]','Compactado con: Combat Report Auto-Converter v2.4.2 © by Panteragnr');
...
var new_mainview =  '<div class="footer"></div></div><div class="contentBox01h"><h3 class="header"><a href="http://board.ikariam.es/index.php?page=Thread&threadID=129508" target="_blank">Combat Report Auto-Converter</a> v2.4.2 © by <a href="http://board.co.ikariam.com/index.php?page=User&userID=6962" target="_blank">Panteragnr</a></b></h3><div class="content"><table style="border:none;"><tr><td style="border:none; height:8px;"></td></tr><tr><td style="vertical-align:middle; text-align:center; border:none;">Haz click sobre Seleccionar la parte que quieras, pulsa CTRL+C y luego pégala en el foro pulsando CTRL+V';
...
new_mainview += '</td></tr><tr style="border:none;"><td style="border:none;"><table style="border:none;"><tr style="border:none;"><td style="width:20px; border:none;"></td><td style="vertical-align:middle; border:none;"><textarea id="CRAC_toselectsubject" style="width:0px; height:0px; border:none;">' + final_subject + '</textarea></td><td colspan="3" style="text-align:center; border:none;"><button class="button" id="CRAC_selectallsubject">Seleccionar asunto</button></td><td style="width:20px; border:none;"></td><td style="vertical-align:middle; border:none;" id="copytext_td"><textarea id="CRAC_toselect" style="width:0px;  height:0px; border:none;">' + final_text + '</textarea></td><td colspan="2" style="text-align:center; border:none;"><button class="button" id="CRAC_selectall">Seleccionar contenido</button></td><td style="width:20px; border:none;"></td><td style="vertical-align:middle; border:none;">';
