// Mass community moderation script 1.1.
...
//
// var communityIds = ['31312201','28505227','25675519'];
//
...
//
// Example: 
// http://www.orkut.com/Community.aspx?cmm=25675519
//
// In the above address, 25675519 is the community ID.	
//
//----------------------------------------------------------------------
...
// -----------------------------------------------------------------------
// ==UserScript==
// @name          Mass Community Moderation Script V1.1
...
window.addEventListener("load", function(e) 
{
	...
	var communityIds = ['25675519','28505227','31312201'];
	...
	removeButton.setAttribute('style', 'font-weight:bold; color:#334f90; border: 3px double #000a0; padding:3px; width:85%; height:24px;');
	...
	banButton.setAttribute('style', 'font-weight:bold; color:#334f90; border: 3px double #000a0; padding:3px; width:85%; height:24px;');
	...
	delButton.setAttribute('style', 'font-weight:bold; color:#334f90; border: 3px double #000a0; padding:3px; width:85%; height:24px;');
