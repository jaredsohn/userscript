// ==UserScript==
// @name           Halkuretim Superscript
// @version        0.1
// @namespace      http://www2.erepublik.com/en/organization/1372492
// @description    Halküretim içinde mesajlaşmayı sağlayan scripttir.
// @include        http://www*.erepublik.com/*
// ==/UserScript==

var ordersurl = "http://halkuretim.110mb.com/deneme.html";

var selectedunit = GM_getValue("defaultunit");
if (selectedunit==undefined) selectedunit = 1;
var units = ["1", "2", "3", "4", "5"];
var colours = ["#EEEEFF", "#EEEEFF", "#EEEEFF", "#EEEEFF", "#EEEEFF"];
var ordersarr = [];
...
function main()
{
 ...
 title.innerHTML = '<embed class="sIFR-flash" width="250" height="28" src="/flash/delicious.swf" quality="best" flashvars="txt=Halkuretim Haberleri&&textcolor=#737373&hovercolor=null&linkcolor=null&w=250&h=28" wmode="transparent" bgcolor="transparent" sifr="true" type="application/x-shockwave-flash" style="width: 250px; height: 28px;"/>'
 ...
 ordersdiv.innerHTML = (ordersarr[selectedunit]?ordersarr[selectedunit]:"Yükleniyor...");
 ...
 GM_xmlhttpRequest({
  ...
  onload:function(response){
   ...
   for (x in units)
   {
    ...
    if (start==-1||end==-1) ordersarr[x] = "" + unit + " emirlerine ulaşılamıyor.";
