...
// V0.2 : modified to remove the 4 challenge maximum
// --------------------------------------------------------------------
//
...
if (chlgstatus=="Filled") return "This challenge has 3 photos in it and is waiting to be set to vote by an admin/mod. You may vote in it already if you want.";
...
{ 
	if (playernumber==15)
	 ...
	 wanchor.style.display='block';
	 wanchor=thisdocument.getElementById("CheckPlayStatus");
	 wanchor.innerHTML="You entered 15 challenges and have reached your maximum play limit!";
	 wanchor.style.color='red';
	 }
	if (playernumber>15)
	 {
	 ...
	 wanchor.style.display='block';
	 wanchor=thisdocument.getElementById("CheckPlayStatus");
	 wanchor.innerHTML="You entered over 15 challenges and are thus breaking the rules! " + 
