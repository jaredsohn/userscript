// ==UserScript==
// @name           IK sujet message
// @namespace      
// @description    Permet d'ajouter un sujet aux messages envoyés
...
function optionsPage() {
   ...
   newElement.innerHTML =
      "<div class='contentBox01h'>" +
         "<h3 class='header'>" +
            "<a href='http://ikariam.norsam.org/ikariam_subject.en.html' target='_blank'>Ikariam Subject (ver. " + version + ")</a>" +
            "<span style='font-size:10px;'>  by <a href='http://ikariam.norsam.org/' target='_blank'>Sampisa</a></span>" +
         "</h3>" +
         "<div class='content'>" +
