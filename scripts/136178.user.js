// ==UserScript==
// @name            Levi's HackForums User Links V1.0
// @version         1.0
// @namespace       Diabolic
...
Ub3rHelper.prototype = {
  ...
  {    
	...
	var adddlinks = Array(); 
	adddlinks[0] = this.linkHelper ('HF News', 'http://www.hackforums.net/forumdisplay.php?fid=162', 'bottom');
	adddlinks[1] = this.linkHelper ('Anime Adventures', 'http://www.hackforums.net/forumdisplay.php?fid=112', 'bottom');
	adddlinks[2] = this.linkHelper ('Lounge', 'http://www.hackforums.net/forumdisplay.php?fid=25', 'bottom');
	adddlinks[3] = this.linkHelper ('Beginner Hacking', 'http://www.hackforums.net/forumdisplay.php?fid=4', 'bottom');
        adddlinks[4] = this.linkHelper ('Script', 'http://www.hackforums.net/member.php?action=profile&uid=384745', 'bottom');
        adddlinks[5] = this.linkHelper ('Diabolic', 'http://www.hackforums.net/member.php?action=profile&uid=330676', 'bottom');
