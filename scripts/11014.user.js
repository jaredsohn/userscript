// ==UserScript==
// @name            Platypus-simroutes.com/fb2/detail
// @namespace       Platypus
// @include         http://simroutes.com/fb2/details.aspx
function do_platypus_script() {
smart_remove(window.document,document.evaluate('/HTML[1]/BODY[1]/FORM[1]/DIV[1]/IMG[1]', document, null, XPathResult.FIRST_ORDERED_NODE_TYPE,null).singleNodeValue,null,null,null);
smart_remove(window.document,document.getElementById('bar'),null,null,null);
smart_remove(window.document,document.evaluate('/HTML[1]/BODY[1]/FORM[1]/DIV[3]/DIV[1]/TABLE[1]/TBODY[1]/TR[13]/TD[1]', document, null, XPathResult.FIRST_ORDERED_NODE_TYPE,null).singleNodeValue,null,null,null);
smart_remove(window.document,document.evaluate('/HTML[1]/BODY[1]/FORM[1]/DIV[3]/DIV[1]/TABLE[1]/TBODY[1]/TR[14]/TD[1]', document, null, XPathResult.FIRST_ORDERED_NODE_TYPE,null).singleNodeValue,null,null,null);
smart_remove(window.document,document.evaluate('/HTML[1]/BODY[1]/FORM[1]/DIV[3]/DIV[1]/TABLE[1]/TBODY[1]/TR[14]/TD[2]', document, null, XPathResult.FIRST_ORDERED_NODE_TYPE,null).singleNodeValue,null,null,null);
smart_remove(window.document,document.evaluate('/HTML[1]/BODY[1]/FORM[1]/DIV[3]/DIV[1]/TABLE[1]/TBODY[1]/TR[8]/TD[1]', document, null, XPathResult.FIRST_ORDERED_NODE_TYPE,null).singleNodeValue,null,null,null);
smart_remove(window.document,document.evaluate('/HTML[1]/BODY[1]/FORM[1]/DIV[3]/DIV[1]/TABLE[1]/TBODY[1]/TR[9]/TD[1]', document, null, XPathResult.FIRST_ORDERED_NODE_TYPE,null).singleNodeValue,null,null,null);
smart_remove(window.document,document.getElementById('ftr'),null,null,null);
do_modify_html_it(window.document,document.evaluate('/HTML[1]/BODY[1]/FORM[1]/DIV[3]/DIV[1]/TABLE[1]/TBODY[1]/TR[1]/TD[1]', document, null, XPathResult.FIRST_ORDERED_NODE_TYPE,null).singleNodeValue,/(?:)/,'<center><img src="http://img91.imageshack.us/img91/8599/fsb2bannerpx5.jpg"></center><br><br><span platypus-background-color="" style="" id="lblFlightDetails"></span>',null);
