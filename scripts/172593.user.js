...
document.title = document.title.replace('Homoseksualne prawiczki podkładające bomby pod szpitale', 'Radom'); 
document.body.innerHTML = document.body.innerHTML.replace('Homoseksualne prawiczki podkładające bomby pod szpitale', 'Radom');
