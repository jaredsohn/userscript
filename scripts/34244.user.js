// ==UserScript==
// @name           TSO Link Checker For Staff
...
if ((!fotfoundlinks) && (livelinklinks) && (Send_The_Links_You_Are_Checking_In_The_Open_Database == 'no' )){ // if on the page are only alinve  
