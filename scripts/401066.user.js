// ==UserScript==
// @name            Radio Filter - Personal Version
// @version         1.1.1
// @description     Creates four moveable filter boxes
// @include         http://myanimelist.net/animelist/*
// @updateURL       https://userscripts.org/scripts/source/401066.meta.js
// @downloadURL     https://userscripts.org/scripts/source/401066.user.js	
// @include         http://myanimelist.net/animelist/*
...
///////////////////////////////////////////////////////////////////////
// Original script by andreino : http://userscripts.org/users/161948 //
///////////////////////////////////////////////////////////////////////
...
// Edit these to change positions

// Type
table.style.right='50px';
table.style.top='50px';
// Score //
table2.style.left='50px';
table2.style.top='190px';
// Progress
table3.style.right='50px';
table3.style.top='250px';
// Status //
table4.style.left='50px';
...
$(".drag").css({"position":"fixed","background":"white","opacity":"0.7","padding":"10px","borderRadius":"10px"});
