// ==UserScript==
// @name          eRepublik IHA Napiparancs ÚJ
// @version       2.3.2
// @releasedate   20110415
// @description   eRepublik script for Indo-Hungarians' Alliance v2.3.2
// @author        daniferi & bubi
...
Változások
2.3.2
-- Működik a frissítés és az IHAevent is
-- Css korrekciók
-- Lecserélve jópár ajánlott oldal linkje, a nem elérhetőek törölve, újak hozzá adva
2.3.1
-- Újra működik a bal oldali kis box
2.3
...
$("#nagydoboz").each(function(){
    ...
    $(this).append("<div class='ugras'><a href='http://www.erepublik.com/hu/news/latest/all/Hungary/1' target='_self'>Friss hírek</a></div>");
    $(this).append("<div class='ugras'><a href='http://tinyurl.com/ihanapi' target='_blank'>IHAnapi</a></div>");
    ...
    $(this).append("<div class='ugras'><a href='http://userscripts.org/scripts/show/80226' target='_blank'>eRepublik Advanced</a></div>");
    $(this).append("<div class='ugras'><a href='http://erep.maxihellas.com/' target='_blank'>Maxihellas</a></div>");
    $(this).append("<div class='ugras'><a href='http://erepublik-market.com/news.html' target='_blank'>eRepMarket</a></div>");
    $(this).append("<div class='ugras'><a href='http://erep.ugu.pl/' target='_blank'>Battle Monitor</a></div>");
...
$("#articles").css({'z-index':'1'});
$(".land_holder li .main").css({'z-index':'1'});
...
var updateCheck = function (){
    if (document.getElementById("battle_listing"))
//    if (document.getElementById("latestnews"))
    { 
        GM_xmlhttpRequest({
            method: 'GET',
            url: 'http://userscripts.org/scripts/source/101157.meta.js',
            onload:function(updateDetails){
                ...
                if (updateText[0].match(/\d+/) > CurrentReleaseDate) {
                    var updatehere = '<br><hr><a href="http://userscripts.org/scripts/show/101157" target="_blank">';
...
var eventInsert = function (tags){
    if (document.getElementById("battle_listing")){
//    if (document.getElementById("latestnews")){
        $("#battle_listing").before("<div id='IHAevent' class='item elem'><div class='iconholder'></div><div class='holder'></div></div>");
//        $("#news > div:first-child").before("<div id='IHAevent' class='item elem'><div class='iconholder'></div><div class='holder'></div></div>");
$("#IHAevent").css({clear:'both',display:'block',float:'left'});
$(".iconholder").css({display:'block',float:'left',width:'50px',paddingRight:'10px'});
$(".holder").css({display:'block',float:'left',width:'270px',fontSize:'12px',fontFamily:'Arial,Helvetica,sans-serif',lineHeight:'18px',color:'#9F9F9F'});
