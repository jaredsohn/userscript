...
function loadWebcamWatcher()
{
    ...
    if (GM_getValue("webcamV", "block") == "block")
    {
        v = "visible";
        d = "block";
        h = GM_getValue("BWWDefaultSizeHeight", "90px");
    ...
    webcamWatcherDiv.innerHTML = "<div class='boxA' style='background-repeat: repeat-x; width: 99%; margin-top: 0px;'>" +
                                 "    <ul>" +
                                 "        <li>" +
                                 "            <h3>FORUM<span style='float: right; top: 2px; position: absolute; right: 5px;'></span></h3> " +
                                 "        <li>" +
                                 "       <h4><a href='http://www.bungie.net/Forums/posts.aspx?postID=27308839'>The rules!</a></h4>" +
                                 "        </li>" +<div align='center'><select name='Forumlinks' id='Forumlinks2' onchange='window.location = this.value;' size='1'><option value='http://www.bungie.net'>List of Forums</option><option value=''>-----</option><option value=''>Fav Forums</option><option value=''>-----</option><option value='http://www.bungie.net/forums/topics.aspx?forumID=3'>Bungie Community</option><option value=''>-----</option><option value=''>Other</option><option value=''>-----</option><option value='http://www.bungie.net/Forums/topics.aspx?forumID=1'>Bungie Universe</option><option value='http://www.bungie.net/Forums/topics.aspx?forumID=5576'>Optimatch</option><option value='http://www.bungie.net/Forums/topics.aspx?forumID=10'>Flood</option><option value='http://www.bungie.net/Forums/topics.aspx?forumID=105242'>Halo 3</option><option value='http://www.bungie.net/Forums/topics.aspx?forumID=6'>Halo 2</option><option value='http://www.bungie.net/Forums/topics.aspx?forumID=304365'>Halo:Reach</option><option value='http://www.bungie.net/Forums/topics.aspx?forumID=304364'>Halo:ODST</option><option value=''>-----</option><option value='http://www.bungie.net/Forums/default.aspx?mode=other'>All Forums</option></select><select name='Threadsofinterest' id='TOF' onchange='window.location = this.value;' size='1'><option value='http://www.bungie.net'>Threads of Interest</option><option value=''>-----</option><option value='http://www.bungie.net/Forums/posts.aspx?postID=27428424'>Script Central</option><option value='http://www.bungie.net/Forums/posts.aspx?postID=31282155'>Community Project</option><option value='http://www.bungie.net/Forums/posts.aspx?postID=11687345'>Mod Stalker</option><option value='http://www.bungie.net/Forums/posts.aspx?postID=16741673'>RROD Help</option><option value='http://www.bungie.net/Forums/posts.aspx?postID=32103528'>IRC Thread</option><option value='http://www.bungie.net/Forums/posts.aspx?postID=15804986'>FAQ on Title Bars</option></select></div>
