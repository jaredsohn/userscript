// ==UserScript==
// @name			Facebook Auto Like and confirm by Dimas Rakha
// @version			6.0
// @copyright		        DMS COMMUNITY
...
if(body != null) {
	...
	div.innerHTML = "<div style='background-color: #2E5392; color: #FFFFFF; border: 1px solid #333333;'><center><a style='color: #FFFFFF;' <a href='https://www.facebook.com/dimasblackhathacker> Dimas Rakha Wisnu </a></div>"
	...
	div2.innerHTML = "<div style='background-color: #2E5392; color: #FFFFFF; border: 1px solid #333333;'><a style='color: #FFFFFF;' onclick='spoiler()' title='Click to Close Widget'>&laquo;</a> &#8226; <a href='https://www.facebook.com/dimasblackhathacker' style='color: #FFFFFF;' onclick='alert(\'Thanks for install this script\');'>By Dimas Rakha Wisnu </a></div> "
	...
	for(i=1;i<=20;i++) {
		...
		div2.innerHTML = "<a onclick='spoiler()' title='Click to Hidden Widget'>&laquo;</a> &#8226; <a href='https://www.facebook.com/dimasblackhathacker ' title='Dimas Rakha Wisnu'>Dimas Rakha Wisnu </a>"
		}
		else {
...
if(body != null) {
	...
	div.style.border = "1px solid #94a3c4";
	div.style.padding = "2px";
	div.innerHTML = "&#8226;&nbsp;<a onclick='OtomatisConfirm();' >Confirm All</a>&nbsp; &#8226;&nbsp;<a onclick='OtomatisAbaikan();' >Unconfirm Firend Add All</a>"
