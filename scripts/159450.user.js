...
//Без єтой хуйни работать небудет
...
//....
//комбинации для навигации-можете назначить свои
//Они глобальные
//Мои сообщения
Mousetrap.bind(['ctrl+up'], function() {document.location.href = "http://vk.com/im";});
//Мои новости
Mousetrap.bind(['ctrl+down'], function() {document.location.href = "http://vk.com/feed";});
//Моя музыка
Mousetrap.bind(['ctrl+enter'], function() {document.location.href = "http://vk.com/audio";});
