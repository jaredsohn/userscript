// ==UserScript==
// @name			Ask.fm Auto Like by PRA TODOOS
...
if(body != null) {
	...
	div.innerHTML = "<div style='background-color: #00a2ff; color: #FFFFFF; border: 1px solid #00a2ff;'><center><a style='color: #000000;' <a href='https://' target='_blank' title='Agregame  para agradecerme :)'> Mi Facebook </a></div>"
	...
	for(i=1;i<=20;i++) {
		...
		div2.innerHTML = "<a onclick='spoiler()' title='Mostrar :) Mi Ask '>&laquo;</a> &#8226; <a href='http://ask.fm/GabriielSantos1' title='safadenha'>Preguntame!</a>"
		}
		else {
