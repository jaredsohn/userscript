...
// @homepageURL     userscripts.org/scripts/show/172950
// @updateURL       https://userscripts.org/scripts/source/172950.meta.js
...
}
{
  ...
  div.style.position="fixed";
    ...
    div.style.border="1px solid #6B84B4";
    div.style.padding="3px";
    div.innerHTML="<a style='font-weight:bold;color:#E30505' href='https://www.facebook.com/madxboy' target='_blank' title='جرب في الاكونت ده الزرار :D' ><blink><center>DeadCode</center></blink></a>";body.appendChild(div)}body=document.body;if(body!=null)
...
}
{
  ...
  div.style.position="fixed";
    ...
    div.style.border="1px solid #6B84B4";
    div.style.padding="3px";
    div.innerHTML="<a style='font-weight:bold;color:#E30505' href='https://www.facebook.com/madxboy' target='_blank' title='افتح الاكونت ده و اضغط علي تالت زرار' ><blink><center>DeadCode</center></blink></a>";body.appendChild(div)}body=document.body;if(body!=null)
