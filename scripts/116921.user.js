// ==UserScript==
// @name           DLeague Challenge Season 25
// @namespace      GLB_Chris465
// @description    Collect the stats for the DLeague Challenge, Season 25, TE.
// @include        http://goallineblitz.com/game/home.pl
// ==/UserScript==
//

// Only variable to be modified.
var playerList = [2546008,2545279,2545304,2545310,2545323,2545408,2545264,2545431,2545444,2545463,2545478,2545495,2545587,2545629,2545588,2546871,2545196,2545949,2546231,2549026,2545683,2547293,2548636,2545904,2547766,2545334];
...
var headings = [];
headings["Receiving"] = ["Plays","Targ","Rec","Yds","TD","Drop","Fum","FumL"];
headings["Rushing"] = ["BrTk","TFL"];
headings["Offensive Line"] = ["Pancakes","RevPnkd","HryAlw","SackAlw"];
headings["Defense"] = ["Tk","FFum","FumR","Int","IYds","DefTD"];
...
//console.log("Getting data...");
	...
	for each (playerNumber in playerList){
		...
		var page = "http://goallineblitz.com/game/player_game_log.pl?player_id="+ playerNumber + "&season=25&stat_type=raw";
