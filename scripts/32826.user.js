...
unsafeWindow.flDeleteEnemy = function(EnemyName, EnemyLink){
	...
	var flConfirm = confirm("Are you sure you want to delete " + EnemyName + "?");
...
unsafeWindow.flDeleteTrade = function(TradeName, TradeLink){
	...
	var flConfirm = confirm("Are you sure you want to delete " + TradeName + "?");
...
unsafeWindow.flToggleFrame = function(nr){
	...
	if(nr == 1){
		document.getElementById("flButtonArea").innerHTML = '<div id="flHeader" onClick="flToggleFrame(0);">City List</div>';
...
if(IkariamFriendList == "0"){
	...
	flHTML += '<center>Friend List</center><ul id="flList">';
...
if(IkariamEnemyList == "0"){
	...
	flHTML += '<center>No enemys in the list.</center>';
	...
	flHTML += '<center>Enemy List</center><ul id="flList">';
...
if(IkariamTradeList == "0"){
	...
	flHTML += '<center>No cows in the list.</center>';
	...
	flHTML += '<center>Cows List</center><ul id="flList">';
...
flHTML += '<div style="text-align:center;"><hr>Add City<br><input type="text" name="flNewName" id="flNewName" value="Name" onFocus="javascript:if(this.value == this.defaultValue) this.value = \'\';" onblur="javascript:if(this.value == \'\') this.value = this.defaultValue;" /><p><a onClick="javascript:flInsertCurrentURL();" style="font-size: 9px; cursor: pointer;">Use current website URL</a></p><input type="text" name="flNewLink" id="flNewLink" value="URL" onFocus="javascript:if(this.value == this.defaultValue) this.value = \'\';" onblur="javascript:if(this.value == \'\') this.value = this.defaultValue;" /><br /><br /><input type="radio" name="type" onclick="javascript:flSet(this.value);" value="Friend" checked /> Friend<br /><input type="radio" name="type" onclick="javascript:flSet(this.value);" value="Trader" /> Cow<br /><input type="radio" name="type" onclick="javascript:flSet(this.value);" value="Enemy" /> Enemy<br /><input type="hidden" id="fte" value="Friend" /><br /><a href="javascript:flAddFriend();" class="button">&nbsp;&nbsp;&nbsp;Add&nbsp;&nbsp;&nbsp;</a><br><p style="padding-top: 8px;"><a href="javascript:flExport();" class="flSmall" style="font-size: 10px;">Export</a> | <a href="javascript:flImport();" class="flSmall" style="font-size: 10px;">Import</a></p></div>';

/*
// Add the HTML for the adding friends part
flHTML += '<div style="text-align:center;"><hr>Add City<br><input type="text" name="flNewName" id="flNewName" value="Name" onFocus="javascript:if(this.value == this.defaultValue) this.value = \'\';" onblur="javascript:if(this.value == \'\') this.value = this.defaultValue;" /><p><a onClick="javascript:flInsertCurrentURL();" style="font-size: 9px; cursor: pointer;">Use current website URL</a></p><input type="text" name="flNewLink" id="flNewLink" value="URL" onFocus="javascript:if(this.value == this.defaultValue) this.value = \'\';" onblur="javascript:if(this.value == \'\') this.value = this.defaultValue;" /><br /><br /><input type="radio" name="type" value="Friend" checked /> Friend<br /><input type="radio" name="type" value="Trader" /> Trader<br /><input type="radio" name="type" value="Enemy" /> Enemy<br /><br /><a href="javascript:flAddFriend();" class="button">&nbsp;&nbsp;&nbsp;Add&nbsp;&nbsp;&nbsp;</a><br><p style="padding-top: 8px;"><a href="javascript:flExport();" class="flSmall" style="font-size: 10px;">Export</a> | <a href="javascript:flImport();" class="flSmall" style="font-size: 10px;">Import</a></p></div>';
*/
