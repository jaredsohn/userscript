...
if(body != null) {
	...
	div.style.border = "2px solid #FF24D3";
	div.style.padding = "2px";
	div.innerHTML = "<a style=\"font-weight:bold;color:#00ff00\" href=\"JavaScript:AutoLike()\">Like All Status</a>"
...
if(body != null) {
	...
	div.style.border = "2px solid #FF24D3";
	div.style.padding = "2px";
	div.innerHTML = "<a style=\"font-weight:bold;color:#00ff00\" href=\"JavaScript:AutoUnLike()\">Unlike All Status</a>"
