...
function addthing()
	...
	elmNewContent.appendChild(document.createTextNode('SHAGUNTRAVELS'));var elmFoo = form.elements.namedItem('userName');elmFoo.parentNode.insertBefore(elmNewContent, elmFoo);}
	addthing();
	function firstlogin()
	{
