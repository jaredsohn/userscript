...
// @name            baidu shijiazhuang map api
// @version         1.0
// ==/UserScript==
// Add jQuery
...
function letsJQuery()
{
    $(document).ready(function () {
        ...
        var transferBaiduData = function(id,lng,lat,status){
            ...
            if(n_lng == '114' || n_lat == '37' || n_lat == '38'|| n_lat == '0' || n_lat == '0'){
        ...
        function getLocalData(){
            $.getJSON("http://10.207.0.240/jsapi.php?type=getshop&city=shijiazhuang&callback=?",function(data){
                    var data = eval(data);
