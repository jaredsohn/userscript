// ==UserScript==
// @name        Dodatker dla Opery
// @match       http://*.wykop.pl/*
// @match       https://*.wykop.pl/*
// @include     http://*wykop.pl*
// @include     https://*wykop.pl*
// @version     BETA
// @description Dodatek, ktory ułatwia tworzenie dodatków oraz zarządzanie nimi
// @namespace   MS
// ==/UserScript==
/*jslint nomen:true, continue: true, regexp: true, browser: true*/


//wersja dla Opery. Ile sie z tym gownem meczylem, zeby dzialalo, to nawet nie wiecie.
//@Uzytkownicy Opery: usuncie konta. I zmiencie pregladarke. Amen.
window.addEventListener('DOMContentLoaded', function () {
    ...
    //--------FRAGMENT KODU EKSKLUZYWNY DLA OPERY--------

        //style Dodatkera
        style,

        //poniewaz Opera ssie, trzeba dorzucic cale jQuery do tego skryptu. Na wszelki wypadek zapisuje istniejaca referencje
        _$ = window.$,
    ...
    //przywroc wszystko tak, jak bylo i zeby do nowego jQuery wskazywala tylko lokalna zmienna $
    $ = window.$;
    ...
    //--------KONIEC KODU EKSKLUZYWNEGO DLA OPERY--------
    ...
    //i kolejny
    contextCheck = _core.utils.contextCheck;
        ...
        if ($("#notificationsBtn").length > 0) {
            ...
            $("#addonsNotificationsBtn").on("click", function (e) {
                ...
                if ($(this).parent().hasClass("scaledrop")) {
                    ...
                    var offsetModerBottom = $(this).next().position().top + $(this).next().height();
                    var heightAdd = viewPort - offsetModerBottom;
    ...
    Dodatker = function (newAddon) {
        ...
        //trafia do jakiegos domkniecia i zaden szerzacy zlo i destrukcje dodatek ich nie pozmienia
        for (i in newAddon) {
