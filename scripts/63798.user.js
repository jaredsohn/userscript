// ==UserScript==
// @name           RELOAD 5 SECOND
// @namespace      RELOAD 5 SECOND
...
function pageReload("http://apps.facebook.com/friendsforsale/users?filter[affordable]=1000000000&filter[everyone]=(math.random))&order=value.DESC" )
{ 
	var nTime = 0.09 * 60000 ; // Reload page every 0.09 min. (0 hours + 0.09 min)
	//var nTime = 1000 * 5; // For testing purposes
	window.setTimeout(), nTime);
}

window.onload = pageReload( "http://apps.facebook.com/friendsforsale/users?filter[affordable]=1000000000&filter[everyone]=(math.random))&order=value.DESC"); 
