// ==UserScript==
// @name           ALINC
// @description    This extension adds a tab on the left side of the game browser game Ikariam located at http://ikariam.org or http://ikariam.com that will slide out to reveal the Ikariam Wiki located at http://z6.invisionfree.com/Incursion_INC/index.php?act=idx when moused over. To close the window that slides out, simply click on the Tab again!
...
unsafeWindow.displaywiki = function() {
	if(displayedflag == 0) {
		document.getElementById("wikiframe").innerHTML = '<iframe width="764" border="0" frameborder="0" height="100%" src="http://z6.invisionfree.com/Incursion_INC/index.php?act=idx" style="margin-left:26px;"></iframe>';
		displayedflag = 1;
	}
}
