// ==UserScript==
// @name           Sort Froogle by Price
// @namespace      www.prism.gatech.edu/~mflaschen3/
// @description    By default, sort Froogle searches by price, from low to high
// @include        *google.*/products*q=*
// ==/UserScript==
...
if(url.indexOf("scoring") == -1)
     location.replace(url += "&scoring=p");
