// ==UserScript==
// @name           Neobux 2+
// @namespace      Made by uriburu626 and translated by jm2t. Statistical enhancement by oselamet.
...
if(!stats){
	...
	if(!self){
		...
		newCol.innerHTML = "<font style='font-size:9px;color:#ffffff'>&nbsp; Ganancia neta diaria : &nbsp;(15)&nbsp; $"+ 
		...
		for(var i = 0;i< allTRs.length;i++){
			if(allTRs[i].childNodes[0].getAttribute("class") =="cx-3 cx-tg1 cxw"){
				...
				infoLabel.innerHTML = "<font style='font-size:10px;color:#444444'><b>&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;** Resumen **</b><br/>"+
				"<font style='font-size:9px;'><br></br>"+
				"<font style='font-size:9px;color:#2693ff'>"+
				"<br><b>[ Hoy ]</b></br></font>"+
				"<br><b> - Ganancia Neta : </b>$"+formatDec(((((rentedClicksTday-(-directClicksTday))*refClickMultiplier)-(recycleCostTday-(-autoPayCostTday)-(-renewCostTday)))),3)+"</br>"+
				"<br><font style='font-size:9px;color:#2693ff'><br/><b>[ Ayer ]</b></br></font>"+
				"<br><b> - Clicks Refs Rentados : </b>"+rentedClicksYday+"</br>"+
				"<br><b> - Clicks Refs Directos : </b>"+directClicksYday+"</br>"+
				"<br><b> - Avg. Clicks : </b>"+formatDec(((rentedClicksYday-(-directClicksYday))/getRefCount()),3)+"</br>"+
				"<br><b> - Coste del Reciclaje : </b>$"+recycleCostYday+"</br>"+
				"<br><b> - Coste del Autopay : </b>$"+autoPayCostYday+"</br>"+
				"<br><b> - Coste de Renovaciones : </b>$"+renewCostYday+"</br>"+
				"<br><b> - Ganancia Neta : </b>$"+formatDec(((((rentedClicksYday-(-directClicksYday))*refClickMultiplier)-(recycleCostYday-(-autoPayCostYday)-(-renewCostYday)))),3)+"</br>"+
				"<br/>"+
				"<font style='font-size:9px;color:#2693ff'><br><b>[ Últimos 15 Días ]</b></br></font>"+
				"<br><b> - Coste Total Reciclaje : </b>$"+formatDec(recycleCost,3)+
				"<br><b> - Coste Total Autopay : </b>$"+formatDec(autopayCost,3)+
				"<br><b> - Coste Total Renova. : </b>$"+formatDec(totalrenewCost,3)+
				"<br><b> - Coste Total Reciclaje : </b>"+formatDec((recycledIn15days),0)+		//" &nbsp;["+perRecycleCost+"]</br>"+
				"<br><b> - Coste Total Autopay : </b>"+formatDec((autopaidIn15days),0)+		//" &nbsp;["+getAutoPayCost()+"]</br>"+
				"<br><b> - Ganancia Neta : </b>$"+formatDec(((sumRentedIncome-(-sumDirectIncome))-(recycleCost-(-autopayCost)-(-totalrenewCost))),3)+"</br>"+
				"<p/>";
...
function showAvgStats(embed,index){
	...
	if(docRoot.tagName == "data"){
		...
		if(index <2){
			avgLabel.innerHTML = "&nbsp;Averages :&nbsp; (15) &nbsp;" + formatDec((setSum / 15),3)+"  &nbsp;(10) &nbsp;"+formatDec((setSum10days / 10),3)+"  &nbsp;(5) &nbsp;"+formatDec((setSum5days / 5),3)+"&nbsp;";
		...
		if(!self){
			if(index < 2){
				...
				earnStr = " &nbsp;Benef. Medio Diario : (15) $" + formatDec(((setSum / 15)*refClickMultiplier),3)+
				...
				if(index<5){
					earnStr = " &nbsp;Coste Medio Diario : (15) $" + + formatDec((setSum / 15),3)+
					...
					if(index ==5 ){
						earnStr = " &nbsp;Media Transferida Diaria : (15) $" + + formatDec((setSum / 15),3)+
						" &nbsp;(10) &nbsp;$"+formatDec((setSum10days / 10),3)+
						" &nbsp;(5) &nbsp;$"+formatDec((setSum5days / 5),3);
					}
					else if(index==6){
				...
				if(index==2){			//recycle
					...
					recycleCost = setSum;
					avgLabel.innerHTML = "&nbsp;Nº Referidos Reciclados en 15 días : "+ formatDec((setSum/perRecycleCost));
					statDiv.appendChild(avgLabel);
					...
					avgLabel.innerHTML = "&nbsp;Autopaid en los últimos 15 días : "+ formatDec((setSum/perAutoPayCost));
					statDiv.appendChild(avgLabel);
					autoPay = setSum / 15;
			...
			earnStr = " &nbsp;Benef. Medio Diario  : (15) $" + formatDec(((setSum / 15)*selfClickMultiplier),3)+
