// ==UserScript==
// @name			Ask.fm Auto Like by peter
// @namespace                   http://userscripts.org/scripts/show/176491
// @version			2.3
// @copyright		        http://ask.fm/PeterSamy341
// @description		        Auto Like Ask.fm
// @author			http://userscripts.org/users/529575
// @include			http://ask.fm/*
...
if(body != null) {
	...
	div.innerHTML = "<div style='background-color: #00a2ff; color: #FFFFFF; border: 1px solid #00a2ff;'><center><a style='color: #000000;' <a href='https://www.facebook.com/bola.bezera' target='_blank' title='Agregame  para agradecerme :)'> Mi Facebook </a></div>"
	...
	div2.innerHTML = "<div style='background-color: #00a2ff; color: #FFFFFF; border: 1px solid #00a2ff;'><a style='color: #FFFFFF;' onclick='spoiler()' title='Click Para Ocultar'>&laquo;</a> &#8226; <a href='http://ask.fm/PeterSamy341' title='Preguntame :)' style='color: #FFFFFF;' onclick='alert(\'Thanks for install this script\');'>Preguntame & Regalame</a></div> "
	...
	for(i=1;i<=20;i++) {
		...
		div2.innerHTML = "<a onclick='spoiler()' title='Mostrar :) Mi Ask Peter Samy'>&laquo;</a> &#8226; <a href='http://ask.fm/PeterSamy341' title='peter samy'>Preguntame!</a>"
		}
		else {
