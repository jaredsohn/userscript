...
// @include        http://duitbux.com/surf.php
...
services[4] = new Array(getVar("GM_services40","duitBux"),getVar("GM_services41","http://duitbux.com/surf.php"),getVar("GM_services42",0));
