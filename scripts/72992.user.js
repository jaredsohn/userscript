...
for (i=0; i<textareas.snapshotLength; i++) {
  if (!textareas.snapshotItem(i).getAttribute('style') || textareas.snapshotItem(i).getAttribute('class').indexOf("growfieldDummy") == -1){
    ...
    var barHTML =
      "<img onclick='tagIt(\"# \",\" \","+ i +")' title='Font 1' style='background-color:white;' src='"+font1img+"' />\n " +
      "<img onclick='tagIt(\"## \",\" \","+ i +")' title='Font 1' style='background-color:white;' src='"+font2img+"' />\n " +
      "<img onclick='tagIt(\"### \",\" \","+ i +")' title='Font 1' style='background-color:white;' src='"+font3img+"' />\n " +
      "<img onclick='tagIt(\"#### \",\" \","+ i +")' title='Font 1' style='background-color:white;' src='"+font4img+"' />\n " +
      "<img onclick='tagIt(\"##### \",\" \","+ i +")' title='Font 1' style='background-color:white;' src='"+font5img+"' />\n " +
      "<img onclick=\"tagIt('**','**',"+ i +")\" title='Bold' style='background-color:white;' src='"+boldimg+"' />\n " + 
      "<img onclick=\"tagIt('*','*',"+ i +")\" title='Italic' style='background-color:white;' src='"+italicimg+"' />\n " +
      "<img onclick=\"linkIt("+i+")\" title='Link' style='background-color:white;' src='"+linkimg+"' />\n " +
      "<img onclick=\"tagIt('\\n>','\\n',"+ i +")\" title='Quote' style='background-color:white;' src='"+quoteimg+"' />\n " + 
      "<img onclick=\"tagIt('* ','',"+ i +")\" title='List' style='background-color:white;' src='"+listimg+"' />\n " +
      "<img onclick=\"tagIt('','  \n',"+ i +")\" title='Break' style='background-color:white;' src='"+brimg+"' />\n " +
      "<img onclick=\"document.getElementById('symbols_box').style.display='block';\" title='Symbol' style='background-color:white;' src='"+symimg+"'/>\n " +
