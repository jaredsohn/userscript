// ==UserScript==
// @name           KOC Power Bot Working Audio Alert
// @namespace      mat 
// @include        http://*.kingdomsofcamelot.com/*main_src.php*
// @include        http://apps.facebook.com/kingdomsofcamelot/*
// @description    Temp Fix Has Working Audio Tower Alert
// @require        http://sizzlemctwizzle.com/updater.php?id=99856
// ==/UserScript==
...
//	logit(div);
	...
	e_checkTower: function(){
			...
			for (var k in Seed.queue_atkinc){
				...
				if ((m.marchType==3 || m.marchType==4) && parseIntNan(m.arrivalTime)>now){
					if (t.alertState.running == true) {
						var soundSrc = "http://www.falli.org/app/download/3780510256/fliegeralarmsire.mp3";
        ...
        t.secondTimer = setTimeout(t.e_checkTower, 45000);
    },
