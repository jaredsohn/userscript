...
wparent.location.href.indexOf('?view=ads') != -1)&& self == top){
	...
	div.css({color:'#000',zIndex:1000000,textAlign:'center',padding:5,position:'fixed',width:200,height:20,background:'#00C7F8',border:'2px solid blue',bottom:1,right:1})
		.text('clicking: '+clickNum+' loading : '+ loading);
	div2.css({overflow:'auto',font:'bold 10px arial',zIndex:1000000000,textAlign:'center',padding:5,position:'fixed',width:200,height:60,background:'#00C7F8',border:'2px solid blue',bottom:45,right:1})
	jQuery.ajax({
	...
	div2.append(
		$('<h3 class="titleBheepH">').text('Sites PTC 2013  ')		
	)	
