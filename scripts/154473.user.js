...
// @include        *
// @exclude        http://*.renren.com/*
// @revise
// @by 	jaccho@163.com & greenworld &Opera
// @description	show image url to image.
// @date  15:33 2013/1/29
// ==/UserScript==

document.addEventListener("DOMContentLoaded",function () {
    const urlRegex = /\b((?:(?:https?|ftp|telnet|ldap|nntp|news|irc|ed2k):\/\/[\w\-.+$!*\/(),~%?:@#&=\\]*)(?:[\w\-+$\/~%?@&=\\]|\b)|(?:(about|opera):[.\w?=%-&]{4,15})\b)/gi;

	//revise code
	const imgPrefixes = /(jpg|gif|png|jpeg|bmp)$/i;
    ...
    var allowedParents = [
        ...
        "s", "strong", "sub", "sup", "td", "th", "tt", "u", "ca", "var"
        ];
