...
// @version        1.4.1
// @require        http://sizzlemctwizzle.com/updater.php?id=94420&days=1
// ==/UserScript==
//This script just as a pt language string added for use on a pt server from the LoU Tweak form AmpliDude
(function(){
	...
	var LT_mainFunction = function() {
		...
		LT_strings = {
			"pt": {
				"options_btn_tt": "Mostar opções do xVx LoU Tweak",
				"layout_btn_tt": "Gerar dados da cidade",
				"chat_btn_city": "Cidade",
				"chat_btn_player": "Jogador",
				"chat_btn_alliance": "Aliança",
				"chat_btn_url": "Link",
				"copy_coords_btn": "Copiar coordenadas para o chat",
				"up_count_tt": "Edificos disponiveis para upgrade:",
				"opts_max_chatlines": "Maximo de lnhas do chat:",
				"opts_chat_opacity": "Transparencia do Chat:",
				"opts_switch_to_ally_tab": "Mudara para o Tab da aliança no Inicio",
				"opts_show_queue_win": "Mostar janela da fila",
				"opts_limit_req_res": "Limitar recursos requesitados em função do espaço livre na cidade",
				"opts_inc_res": {
					"lab": "Recursos a Entrar:",
				...
				"opts_lang": {
					"lab": "xVx Tweak language",
					"pt": "Portuges (Portuges)",
					"de": "German (Deutsch)",
					"es": "Spanish (Español)",
					"pl": "Polish (Polski)"
				},
			...
			"es": {
				...
				"opts_tagless_coords": "Hacer que coordenadas sin etiquetas sean clickables",
				"opts_minimap": {
			...
			"pl": {
				"options_btn_tt": "Kliknij aby otworzyc okno opcji LoU Tweak",
				"layout_btn_tt": "Kliknij aby wygenerowac plan (ShareString) tego miasta",
				"chat_btn_city": "Miasto",
				"chat_btn_player": "Gracz",
				"chat_btn_alliance": "Sojusz",
				"chat_btn_url": "Link",
				"copy_coords_btn": "Kopiuj wspólrzedne do czatu",
				"up_count_tt": "Ilosc budynków mozliwych do rozbudowy:",
				"opts_max_chatlines": "Maksymalna liczba linii czatu:",
				"opts_chat_opacity": "Przezroczystosc tla czatu:",
				"opts_switch_to_ally_tab": "Przelacz na karte Sojuszu podczas startu",
				"opts_show_queue_win": "Pokaz okno z czasami kolejek",
				"opts_limit_req_res": "Ogranicz zamawiane surowce do wolnego miejsca",
				"opts_inc_res": {
					"lab": "Okno przybywajacych surowców:",
					"disabled": "Wylaczone",
					"always": "Zawsze wlaczone",
					"context": "Kontekstowo"
				},
				"opts_separator": {
					"lab": "Separator tysieczny:",
					"period": "'.' (kropka)",
					"comma": "',' (przecinek)",
					"space": "' ' (spacja)",
					"none": "brak"
				...
				"opts_city_tag": {
					...
					"info": "Informacje o miescie",
					"region": "Widok regionu"
				},
				"opts_lowest_lvl": {
					"lab1": "Wybierz budynki, które chcesz rozbudowac przy pomocy skrótu 'L (rozbuduj najnizszy poziom)'",
					"lab2": "Zdefinuj poziomy dla kazdej grupy, przy których skrót 'L' przestanie ulepszac",
					"towers": "Wieze:",
					"military": "Wojskowe:",
					"resource": "Surowce:",
					"cottage": "Chatki:",
					"barracks": "Baraki:",
					"utilities": "Uzytecznosci:"
				},
				"opts_set_hotkeys": "Aby przypisac skrót, kliknij na przycisku, a nastepnie wcisnij klawisz na klawiaturze",
				"opts_hotkey_labels": {
					"lab1": "Skróty konstrukcyjne:",
					"lab2": "Skróty ulepszen:",
					"lab3": "",
					...
					"next_city": "Nastepne miasto"
				},
				"opts_clr_inc_res": "Kolory okna przybywajacych surowców:",
				"opts_clr_chat": {
					"lab": "Kolory czatu:",
					"all": "Wszyscy:",
					"alliance": "Sojusz:",
				...
				"opts": {
					...
					"export": "Eksport",
					"import": "Import",
					"export_lab": "Mozesz zapisac ten tekst w pliku tekstowym i w razie potrzeby przywrócic opcje.",
					"import_lab": "Wklej zapisane opcje LoU Tweak i wcisnij OK.",
					"import_invalid": "Wklejony ciag jest niepoprawny"
				},
				"layout": {
					"city": "Plan miasta",
				...
				"opts_lang": {
					...
					"de": "Niemiecki (German)",
					"es": "Hiszpanski (Spanish)",
					"pl": "Polski (Polish)"
				},
				"purify_btn_tt": "Kliknij aby otworzyc okno oczyszczania surowców",
				"opts_tagless_coords": "Wspólrzedne bez tagów mozliwe do klikniecia",
				"opts_minimap": {
					"enable_lab": "Wlacz MiniMape",
					"clrs_lab": "Kolory MiniMapy:",
					"show_cities": "Pokaz miasta",
					"show_none": "Zadne",
		...
		qx.Class.define("louTweak.main", {
			...
			members: {
				...
				tweakLoU: function() {
					...
					this.app.desktop.add(this.miniMap.clientArea, {right:0,top:62}); // add to top right
					...
					for (i=0; i<btns.length; i++) {
						btn = new qx.ui.form.Button(btns[i].lab).set({appearance: "button-text-small", padding: [2,3,2,3]});
					...
					this.app.visMain.addListener("changeMapLoaded", function(){this.tabView.setSelection([this.tabView.getChildren()[0]]); this.louFCPlink.setVisibility("hidden"); this.win.close(); this.showOverlayLayout();}, this.layoutWindow);
					this.getCity();
					//
		...
		qx.Class.define("louTweak.optionsPage", {
			...
			construct: function() {
				...
				// ----- LoU Tweak language
				cont = new qx.ui.container.Composite(new qx.ui.layout.HBox()).set({marginLeft: 20});
				...
				cgb = new qx.ui.container.Composite(gr).set({paddingLeft: 20});
			...
			members: {
				...
				getContinentPrefix: function() {
					...
					return {
						px:Math.floor(x/100),
						py:Math.floor(y/100),
						csx:Math.floor(x/100)*100,
						csy:Math.floor(y/100)*100,
						cx:x,
						cy:y
					};
				},
				...
				getCityType: function(cid, aid) {
					ct = -1;
					if ((cid >= 0 && cid <= 7) || (cid >= 20 && cid <= 27)) ct = 2;
					else if ((cid >= 10 && cid <= 15) || (cid >= 30 && cid <= 35)) ct = 3;
