...
// ==UserScript==
// @name           Way2Sms Flooder By Chakry
...
// ==/UserScript==
	...
	var number="number";
	document.forms[0].elements[4].value="Gud Nite ra :)" +Math.floor(Math.random()*22321313);
	document.forms[0].elements[6].value=9912258518
