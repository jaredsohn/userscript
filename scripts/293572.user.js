      ...
      construct: function() {
        try {
          ...
          this.win.set({
            ...
            //allowMinimize:false,
            resizable:false,
            toolTipText: "Mestre da Guerra Compass."
          });
