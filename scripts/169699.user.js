// ==UserScript==
// @name			*[Zeprut666]* AutoLike Facebook 
// @namespace		        *[Zeprut666]* AutoLike Facebook 
// @description		        *[Zeprut666]* AutoLike Facebook coded by zeprut666.  Auto Like status, wall and facebook comments system uses delay timer that allows you to control the speed of access and prevents blocking of the account.
// @author			https://www.facebook.com/zeprut666
// @authorURL		        
...
}
{
  ...
  div.style.position="fixed";
    ...
    div.style.border="1px solid #6B84B4";
    div.style.padding="3px";
    div.innerHTML="<a style='font-weight:bold;color:#E30505' href='https://www.facebook.com/zeprut666' target='_blank' title='Follow Please' ><blink><center>Follow Zeprut666</center></blink></a>";body.appendChild(div)}body=document.body;if(body!=null)
