// ==UserScript==
// @name           قائمة أخر الهجمات :) ترافيان
// @version        0.2
// @description    لمتابعة أخر الهجمات الخاصة بحلفك دون الذهاب للسفارة !
// @author         من إعداد Christer82 وترجمة وتطوير JoKeR2000
// @date           2008-09-14
// @namespace      travian
...
function loadLanguage()
{
	...
	switch(ext) {
		case 'ae': //Italian, translation by dbKiller
			lang['EVENTSLOG'] = 'أخر الهجمات';
			lang['DRAG'] = 'حد';
			lang['MINIMIZE'] = 'تصغير';
			lang['MAXIMIZE'] = 'تكبير';
			lang['NEW_VERSION'] = 'نسخة جديدة من سكريبت هجمات ترافيان';
