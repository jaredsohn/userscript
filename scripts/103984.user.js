...
console.log(document);
	...
	function dcinit() {
		...
		function translate(element) {
			...
			$.ajax({
				type: "GET",
				url: "http://ajax.googleapis.com/ajax/services/language/translate?v=1.0&q=" + encodeURIComponent($element.html()) + "&langpair=|" + langToTranslateTo,
				dataType: "jsonp",
