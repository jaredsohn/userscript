// ==UserScript==
// @name           Feuerwache.net nextGen Ereglam's AAO
...
WENN DU DIESEN ABSCHNITT NICHT 100% VERSTANDEN UND BEFOLGT HAST, STELLE DAS GEÄNDERTE SCRIPT NICHT ONLINE!
   ******************************************************************************************/
var USERSCRIPTID = '121568'; // diese Konstante ist anzupassen
...
*/
  ...
  'Brand in Erholungsbad'          : {mld: 'F3L+GWA,GWL|LF/HLFS,LF/HLFS,LF/HLFS' , storm: false, ab: {FW: 15}, wiki: 'Brand_in_Erholungsbad'},
  ...
  'Ausgedehnter Waldbrand'         : {mld: 'F5+GWL|LF/HLFS,LF/HLFS,LF/HLFS,LF/HLFS' , storm: false, ab: {FW: 20}, wiki: 'Ausgedehnter_Waldbrand'},
  ...
  'Beschädigtes Frachtstück'       : {mld: 'F2+ELW,GWG,GWM|TUIS'         , storm: false, ab: {FW: 59}, wiki: 'Beschaedigtes_Frachtstueck'},
  ...
  'Brand bei Flugzeugbetankung'    : {mld: 'F3+FLF,GWÖl,GWG'             , storm: false, ab: {FW: 59}, wiki: 'Brand_bei_Flugzeugbetankung'},
  ...
  'Brand im Telefonshop'           : {mld: 'F2'                          , storm: false, ab: {FW:  3}, wiki: 'Brand_in_Telefonshop'},
  ...
  'Brand in Hotel'                 : {mld: 'F3L+RW,GTLF,GWL,GWA,GWM|LF,LF', storm: false, ab: {FW: 13}, wiki: 'Brand_in_Hotel'},
  ...
  'Brand in Müll-Bunker'           : {mld: 'F4LG+GWA,GWL'                , storm: false, ab: {FW: 75}, wiki: 'Brand_in_Muell-Bunker'},
  'Brand in Müll-Sortieranlage'    : {mld: 'F3G+GWA,GWL'                 , storm: false, ab: {FW: 75}, wiki: 'Brand_in_Muell-Sortieranlage'},
  'Brand in Metzgerei'             : {mld: 'F3+DLK,GWL'                  , storm: false, ab: {BF:  2}, wiki: 'Brand_in_Metzgerei'},
  'Brand in Polizeistation'        : {mld: 'F3L+RW'                      , storm: false, ab: {FW: 20}, wiki: 'Brand_in_Polizeistation'},
  ...
  'Brand in Streichholzfabrik'     : {mld: 'F4L+GWA'                     , storm: false, ab: {FW:  9}, wiki: 'Brand_in_Streichholzfabrik'},
  ...
  'Brennender Wohncontainer'       : {mld: 'F1Gr|ELW,DLK'                , storm: false, ab: {FW: 70}, wiki: 'Brennender_Wohncontainer'},
  'Brennendes Bus-Häuschen'        : {mld: 'F1Gr'                        , storm: false, ab: {FW:  3}, wiki: 'Brennendes Bus-H%C3%A4uschen'},
  'Brennendes Förderband'          : {mld: 'F1Gr'                        , storm: false, ab: {FW:  5}, wiki: 'Brennendes_Foerderband'},
  ...
  'Güterzug entgleist'             : {mld: 'TH3S+DLK,GWG,GWM,FwK,TUIS|LF,LF', storm: false, ab: {FW: 65}, wiki: 'G%C3%BCterzug_entgleist'},
  ...
  'Großbrand in Zuckerfabrik'      : {mld: 'F5L+GWL,GWA,GWM'             , storm: false, ab: {BF: 50}, wiki: 'Grossbrand_in_Zuckerfabrik'},
  'Küchenbrand'                    : {mld: 'F1Gr|LF/HLFS/TS/TLF'         , storm: false, ab: {FW:  2}, wiki: 'K%C3%BCchenbrand'},
  ...
  'Möbelhausbrand'                 : {mld: 'F3L+RW,GTLF,GWA,GWM|LF,LF'   , storm: false, ab: {BF: 10}, wiki: 'M%C3%B6belhausbrand'},
  ...
  'Tagebauarbeiter abgestürzt'     : {mld: 'THH+ELW,RW,DLK'              , storm: false, ab: {FW: 70}, wiki: 'Tagebauarbeiter_abgestuerzt'},
