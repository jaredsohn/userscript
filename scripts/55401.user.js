// ==UserScript==
// @name            Custom MC Menu by Fugazi
// @namespace       Fugazi
// @include         http://*.mafiacorruption.com/*
// ==/UserScript==
function do_platypus_script() {
erase_it(window.document,document.evaluate('/HTML[1]/BODY[1]/DIV[2]/DIV[2]/DIV[1]/DIV[2]/UL[1]/LI[2]', document, null, XPathResult.FIRST_ORDERED_NODE_TYPE,null).singleNodeValue,null,null,null);
erase_it(window.document,document.evaluate('/HTML[1]/BODY[1]/DIV[2]/DIV[2]/DIV[1]/DIV[2]/UL[1]/LI[7]', document, null, XPathResult.FIRST_ORDERED_NODE_TYPE,null).singleNodeValue,null,null,null);
erase_it(window.document,document.evaluate('/HTML[1]/BODY[1]/DIV[2]/DIV[2]/DIV[1]/DIV[2]/UL[1]/LI[9]', document, null, XPathResult.FIRST_ORDERED_NODE_TYPE,null).singleNodeValue,null,null,null);
erase_it(window.document,document.evaluate('/HTML[1]/BODY[1]/DIV[2]/DIV[2]/DIV[1]/DIV[2]/UL[1]/LI[10]', document, null, XPathResult.FIRST_ORDERED_NODE_TYPE,null).singleNodeValue,null,null,null);
erase_it(window.document,document.evaluate('/HTML[1]/BODY[1]/DIV[2]/DIV[2]/DIV[1]/DIV[2]/UL[1]/LI[13]', document, null, XPathResult.FIRST_ORDERED_NODE_TYPE,null).singleNodeValue,null,null,null);
erase_it(window.document,document.evaluate('/HTML[1]/BODY[1]/DIV[2]/DIV[2]/DIV[1]/DIV[2]/UL[1]/LI[14]', document, null, XPathResult.FIRST_ORDERED_NODE_TYPE,null).singleNodeValue,null,null,null);
erase_it(window.document,document.evaluate('/HTML[1]/BODY[1]/DIV[2]/DIV[2]/DIV[1]/DIV[2]/UL[1]/LI[20]', document, null, XPathResult.FIRST_ORDERED_NODE_TYPE,null).singleNodeValue,null,null,null);
erase_it(window.document,document.evaluate('/HTML[1]/BODY[1]/DIV[2]/DIV[2]/DIV[1]/DIV[2]/UL[1]/LI[21]', document, null, XPathResult.FIRST_ORDERED_NODE_TYPE,null).singleNodeValue,null,null,null);
erase_it(window.document,document.evaluate('/HTML[1]/BODY[1]/DIV[2]/DIV[2]/DIV[1]/DIV[2]/UL[1]/LI[23]', document, null, XPathResult.FIRST_ORDERED_NODE_TYPE,null).singleNodeValue,null,null,null);
erase_it(window.document,document.evaluate('/HTML[1]/BODY[1]/DIV[2]/DIV[2]/DIV[1]/DIV[2]/UL[5]/LI[3]', document, null, XPathResult.FIRST_ORDERED_NODE_TYPE,null).singleNodeValue,null,null,null);
erase_it(window.document,document.evaluate('/HTML[1]/BODY[1]/DIV[2]/DIV[2]/DIV[1]/DIV[2]/UL[5]/LI[4]', document, null, XPathResult.FIRST_ORDERED_NODE_TYPE,null).singleNodeValue,null,null,null);
erase_it(window.document,document.evaluate('/HTML[1]/BODY[1]/DIV[2]/DIV[2]/DIV[1]/DIV[2]/UL[5]/LI[5]', document, null, XPathResult.FIRST_ORDERED_NODE_TYPE,null).singleNodeValue,null,null,null);
erase_it(window.document,document.evaluate('/HTML[1]/BODY[1]/DIV[2]/DIV[2]/DIV[1]/DIV[2]/UL[1]/LI[19]/A[1]/FONT[1]/B[1]', document, null, XPathResult.FIRST_ORDERED_NODE_TYPE,null).singleNodeValue,null,null,null);
html_insert_it(window.document,document.evaluate('/HTML[1]/BODY[1]/DIV[2]/DIV[2]/DIV[1]/DIV[2]/UL[5]/LI[1]', document, null, XPathResult.FIRST_ORDERED_NODE_TYPE,null).singleNodeValue,'                    <li><img src="images/arrow-icon.jpg" alt=""> <a href="ask.php" title="">Ask the Staff</a></li>                    <li><img src="images/arrow-icon.jpg" alt=""> <a href="/forum/" target="_blank" title="">Forums</a></li>',true,false);
html_insert_it(window.document,document.evaluate('/HTML[1]/BODY[1]/DIV[2]/DIV[2]/DIV[1]/DIV[2]/UL[1]/LI[24]', document, null, XPathResult.FIRST_ORDERED_NODE_TYPE,null).singleNodeValue,'                    <li><img src="images/arrow-icon.jpg" alt=""> <a href="usershop.php?op=shopadmin" title="">Shop Admin</a></li>                    <li><img src="images/arrow-icon.jpg" alt=""> <a href="yourgang.php" title="">Your Gang</a></li>                    <li><img src="images/arrow-icon.jpg" alt=""> <a href="yourgang.php?action=warview" title="">Gang Hit List</a></li>                    <li><img src="images/arrow-icon.jpg" alt=""> <a href="yourgang.php?action=atklog" title="">Gang Attack logs</a></li>                    <li><img src="images/arrow-icon.jpg" alt=""> <a href="halloffame.php?action=respect&filter=all" title="">Gang Rankings</a></li>',false,false);
html_insert_it(window.document,document.evaluate('/HTML[1]/BODY[1]/DIV[2]/DIV[2]/DIV[1]/DIV[2]/UL[1]/LI[6]', document, null, XPathResult.FIRST_ORDERED_NODE_TYPE,null).singleNodeValue,'                    <li><img src="images/arrow-icon.jpg" alt=""> <a href="drive.php" title="">Drive</a></li>                    <li><img src="images/arrow-icon.jpg" alt=""> <a href="jettravel.php" title="">Airport</a></li>',false,false);
