// ==UserScript==
// @name          Travian: Attack Builder For 3.5 Works on new updates. Multi Language
...
attackInterface.innerHTML = '<fieldset><legend>'+text[12]+'</legend><div id=start>' +
	...
	'</tr><tr><td colspan="3">'+
		'<input type=\"text\" value="' +getCords() +  '" name=\"cords\" id=\"cords\" class=\"fm\" style=\"width: 98%\" /><br>'+ text[29] +'<input class=\"fm\" style=\"color:#0000ff;\" id=\"timebetween\" type=\"text\" value=\"100\" size=\"4\" />' +
	'</td>'+
	'</tr><tr><td>'+
