// ==UserScript==
// @name           [ RH +] Radio Hunter ᴾˡᵘˢ - Auto up 
// @namespace      Brenno Lopes
// @description    auto upar os topicos de dica e tuto
// @include        http://www.orkut.com/CommMsgs*117249465
// ==/UserScript==
tpcos = ["[DIC]","[DICA]","[TUT]","[TUTO]","[FIXO]"];
...
msg += "\n-----ATEN\xc7AO!-----";
mens = "uup, Chuck Norris Gosta desse tópico, por isso ele foi Upado ;D !"; //Modifique a mensagem do up aqui
