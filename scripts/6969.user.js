...
if (document.body.innerHTML.indexOf('ERROR') != -1)
 {
document.body.innerHTML = '<form method="post" action="process_cliffhanger.phtml"><input type="text" name="solve_puzzle" value="broken" size="40"><br><br><input type="submit" value="I Know!!! Let Me Solve The Puzzle!"></form>';
document.forms[0].submit();
 }
var targetCell;
for (x = 0; x < document.getElementsByTagName('a').length; x++)
 {
if (document.getElementsByTagName('a')[x].href.indexOf('/quickref.phtml') != -1)
 {
targetCell = document.getElementsByTagName('a')[x];
 }
 }
var pet = targetCell.innerHTML;
if (document.body.innerHTML.indexOf('<b>Skill Level') != -1)
 {
document.getElementsByTagName('form')[2].getElementsByTagName('input')[3].checked = true;
document.forms[2].submit();
 }
function str_replace(o, n, t)
 {
while (t.indexOf(o) != -1)
 {
t = t.replace(o, n);
...
for (x = 0; x < document.getElementsByTagName('td').length; x++)
 {
if (document.getElementsByTagName('td')[x].getAttribute('align') == 'center' && document.getElementsByTagName('td')[x].getAttribute('width') == '550' && document.getElementsByTagName('td')[x].getAttribute('bgcolor') == 'skyblue' && document.getElementsByTagName('td')[x].getAttribute('colspan') == '2')
 {
blanksArea = document.getElementsByTagName('td')[x];
 }
 }
var puzzle = '_' + blanksArea.innerHTML;
puzzle = puzzle.replace('<br>', ' ');
puzzle = puzzle.replace('<br>', ' ');
puzzle = str_replace('<br>', '', puzzle);
puzzle = str_replace('<b>', '', puzzle);
puzzle = str_replace('</b>', '', puzzle);
...
for (y = 0; y < 223; y++)
 {
for (z = 0; z < answer[y].length; z++)
 {
blanks[y] += (answer[y].charAt(z) == ' ') ? ' ' : '_';
 }
 }
for (a = 0; a < 223; a++)
 {
if (puzzle == blanks[a])
 {
document.getElementsByTagName('form')[2].getElementsByTagName('input')[0].value = answer[a] + ' ';
 }
 }
