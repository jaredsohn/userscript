// ==UserScript==
// @name           Anti Xat LinkValidator by Sharkale
// @namespace      antixatlinkvalidator
...
urlorig = urlorig.replace("http://linkvalidator.net/warn.php?p=","");
urlorig = Base64.decode(urlorig);
location.href = urlorig;