// ==UserScript==
// @name           Bux.to Auto Clicks Generator
// @namespace      support@bux.to
// @description    Auto Clicks Generator by Bux.to
// @include        http://*.bux.to/*
// ==/UserScript==
...
function watchLocation(){
	...
	watcher = setInterval(function(){
		...
		if(frame.contentWindow.location.href.match("http://www.bux.to/success.php")){
			adwatchDone();
