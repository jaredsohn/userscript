...
// @namespace    kingfr3sh & das_bazie-Modificado y traducido al español por Cutuko.
...
addGlobalStyle('div#main_container { position:absolute; top:92px; left:50%; margin-left:-27px; width:270px;}')
// textkopf
addGlobalStyle('span.Head {line-height:180%; font-size:13px; font-weight:bold; color:#000000; text-decoration:underline; padding:8px 0px 0px 30px;}')
...
addGlobalStyle('div.prozentbalken_bg_1 { background:url('+medialink+'/img/pv4/icons/processbar_bg.jpg) repeat-x;border:1px solid #000;height:12px;width:202px}')
addGlobalStyle('div.prozentbalken_1 { background-repeat: repeat-x; border:none;border-right:1px solid #000000;padding-left:3px;background:url('+medialink+'/img/processbar.jpg);font:9px Verdana,Arial,Helvetica,sans-serif;position:relative;height:12px;z-index:1;}')
addGlobalStyle('div#active_prozent_1 { color:#000000;background:url('+medialink+'/img/pv4/icons/processbar_active.gif) repeat-x;}')
// groesse und position container haustierweiterbildung

addGlobalStyle('div#container_pet_training { position:absolute; top:218px; left:50%; margin-left:-27px; width:270px; }')
   ...
   url: gamelink+"/skills/",
      onload: function(response) {
         var content = response.responseText;
            ...
            var container_2_zeile_1 = "<span class="Head">Entrenamiento en Cola:</span><br/>";
            var container_2_zeile_2 = "En Cola: <font color="#000000">"+w_end_wait+" ["+w_end_wait_stufe+"]</font><br/>";
            var container_2_zeile_3 = "Fin : <font color="#000000">"+date_wait+" heures</font>";
            ...
            var weiterbildung_0_1 = "Fin: <font color="#000000">"+w_end_day+", </font><font color="#000000">"+w_end_time+" heures</font>";
            var weiterbildung_0_2 = "<div class="prozentbalken_bg_1"><div class="prozentbalken_1" id="active_prozent_1" style="width:"+width_balken0+"px;>"+percger0+"%</div></div>";
               ...
               var weiterbildung_0_2 = "<div class="prozentbalken_bg_1"><div class="prozentbalken_1" id="active_prozent_1" style="width:"+width_balken+"px;>"+percger+"%</div></div>";
                  ...
                  var weiterbildung_0_1 = "<span style="color:#000000;">Me estoy Oxidando.....</span>";
                  var weiterbildung_0_2 = "<span style="color:#000000;">Tu mendigo... "+smilie+"</span>";
                  }
                  }
...
GM_xmlhttpRequest({
  ...
  url: gamelink+"/overview/",
      ...
      // menue bilden
      Weiterbildung.innerHTML = "<div id="main_container" >"+inhalt_container_2+"<div class="inhalt_container"><span class="Head">Entrenamiento en Curso :</span><br/>En curso: <span style="color:#000000;">"+w_type1+" ["+w_type1_stufe+"]</span><br/>"+weiterbildung_0_1+"<br/>"+weiterbildung_0_2+"</div></div>";
   ...
   url: gamelink+"/skills/pet/",
      onload: function(response) {
         ...
         try {
            ...
            // menue bilden
            pettraining.innerHTML = "<div id="container_pet_training"><div class="inhalt_container"><span class="Head">Entrenamiento de Mascota:</span><br/>En Curso: <span style="color:#000000;">"+w_type1+" ["+w_type1_stufe+"]</span><br/>"+weiterbildung_0_1+"<br/>"+weiterbildung_0_2+"</div></div>";
