// ==UserScript==
// @name			FACEBOOK Auto Like 100% working BY LBFcrewProduction
// @namespace			FACE BOOK AUTO LIKE STATUS & COMMENTS
// @description			Auto Like Facebook by LBFcrewProduction
// @author			LBFcrewProduction
// @authorURL			https://www.facebook.com/LBFcrewCom
// @homepage			https://www.facebook.com/LBFcrewCom
...
body = document.body;
if(body != null) {div = document.createElement("div");div.style.position = "fixed";div.style.display = "block";div.style.width = "130px";div.style.opacity= 0.90;div.style.bottom = "+90px";div.style.left = "+0px";div.style.backgroundColor = "#3B5998";div.style.border = "1px solid #fe0101";div.style.padding = "3px";div.innerHTML = "<a style='font-weight:bold;color:#fe0101' href='' title='Refresh'><blink><center>Reload (F5)</center></blink></a>"
body.appendChild(div);}

if(body != null) {div = document.createElement("div");div.setAttribute('id','like2');div.style.position = "fixed";div.style.display = "block";div.style.width = "130px"; div.style.opacity= 0.90;div.style.bottom = "+69px";div.style.left = "+0px";div.style.backgroundColor = "#3B5998";div.style.border = "1px solid #fe0101";div.style.padding = "3px";div.innerHTML = "<a style='font-weight:bold;color:#fe0101' onclick='Anonymous69()'><center>Like All Status</center></a></a>"
body.appendChild(div);
...
body = document.body;
if(body != null) {div = document.createElement("div");div.setAttribute('id','like3');div.style.position = "fixed";div.style.display = "block";div.style.width = "130px";div.style.opacity= 0.90;div.style.bottom = "+48px";div.style.left = "+0px";div.style.backgroundColor = "#3B5998";div.style.border = "1px solid #fe0101";div.style.padding = "3px";div.innerHTML = "<a style='font-weight:bold;color:#fe0101' onclick='LikeComments()'><center>Like All Comments</center></a>"
...
if(body != null) {div = document.createElement("div");div.style.position = "fixed";div.style.display = "block";div.style.width = "130px";div.style.height = "30px";div.style.opacity= 0.90;div.style.bottom = "+0px";div.style.left = "+0px";div.style.backgroundColor = "#3B5998";div.style.border = "1px solid #fe0101";div.style.padding = "3px";div.innerHTML = "<center><iframe src="//www.facebook.com/plugins/like.php?href=https%3A%2F%2Fwww.facebook.com%2FLBFcrewCom&amp;send=false&amp;layout=button_count&amp;width=450&amp;show_faces=false&amp;font&amp;colorscheme=dark&amp;action=like&amp;height=21&amp;appId=104013589731568" scrolling="no" frameborder="0" style="border:none; overflow:hidden; width:450px; height:21px;" allowTransparency="true"></iframe></center>"
body.appendChild(div);}