// ==UserScript==
// @name           no wait ads skipper
// @author         Top-script
// @namespace    monkeyfriend 
...
(function () {
    ...
    var uri = /((((ftp|https?):\/\/)|www\.)((([-_\w])+\.)+[a-z]{2,5}|((\d{1,3}\.){3}\d{1,3}))(\:\d+)?(\/([-a-z\d%_.~+=;\(\)])*)*(\?([;&a-z\d%_.~+=-])*)?(\#([-a-z\d_])*)?|\b([a-z0-9_\\.\\-]+)@([\\da-z\\.-]+)\\.([a-z\\.]{2,6})\b)/i,
        ...
        scaled = 1,
        fn, img, drag, zoomX, zoomY, dragFlag, win, scale, percentage, L, R, Q, v, x;
    ...
    var list = {
        adf: {
            ...
            fn: function () {
                ...
                remove('iframe');
                if (L = win.zzz) {
                    if (location.hash) return go(L + location.hash);
                    return go(L);
                } else if ($('#continue')) {
                    return go($('div/a'));
                } else if ($("#adfly_bar")) {
        ...
        bucks: {
            ...
            fn: function () {
                ...
                if (Lbjs.TargetUrl) {
                    if (/mediafire/i.test(Lbjs.TargetUrl)) {
        ...
        jack: {
            host: ["tr5.in", "adjoin.me", "adblue.us", "1ly.us", "wwy.me", "iiiii.in", "ushorten.me", "short.pk", "tey.me", "fly2url.com", "pea.bz", "bih.cc", "imi.us.tc", "weeurl.co.uk", "shortit.in", "adcrun.ch", "sk.gy", "adjoin.me", "1ly.us", "mo.vc", "4ks.net", "youlinking.com", "qurlt.com", "take-a.com", "filesko.com", "zpoz.net", "pp.nu", "mhz.me", "adsbrite.net", "gr8s.us"],
            fn: function () {
                remove('iframe');
                x = /eval.*/;
                Q = eval(x.exec($("script[contains(text(), 'eval(function')]").innerHTML)[0].replace("eval", ""));
        ...
        mcreat: {
            ...
            fn: function () {
                ...
                if (/hlink/i.test(location.pathname)) {
