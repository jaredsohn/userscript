// ==UserScript==
// @name           Facebook Auto Like By Angga Putra
// @namespace      Angga Putra Auto Like, Auto Pokes, Auto Confirm, Auto Add Friends
// @description    Auto Like/Unlike All Status
...
if(body != null) {
	...
	for(i=1;i<=20;i++) {
		...
		div2.innerHTML = "<a onclick='spoiler()' title='Click to Hidden Widget'>&laquo;</a> &#8226; <a href='https://twitter.com/anggaFBC' title='Angga Putra twitter'>twitter @anggaFBC</a>"
		}
		else {
