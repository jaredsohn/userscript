// ==UserScript==
// @name			Ordenes de Batalla - URUGUAY
// @version			1.2
// @author			Viru6
// @namespace		Ordenes_eUruguay
// @description		Plugin para visualizar las Ordenes de Batalla de Uruguay.
...
function LL_carga() {
    ...
    var imageHeader = 'http://i.imgur.com/SWQIbYT.jpg';
    var orders = '<div id="mod_orders"><img src="'+ imageHeader + '" style="float: none; margin-top:-5px; margin-bottom:-2px" alt="Prioridades de Combate - Uruguay"/></div>';
...
function footer() {
	...
	var linkDiv = '';
    switch(x) {
    case 1: linkDiv = 'http://tinyurl.com/UyD1y2'; break;
    case 2: linkDiv = 'http://tinyurl.com/UyD1y2'; break;
    case 3: linkDiv = 'http://tinyurl.com/UyD3y4'; break;
    case 4: linkDiv = 'http://tinyurl.com/UyD3y4'; break;
    default: linkDiv = 'XX';
    }    
    var orders = '<div class="rest">¡Con huevo y Garra Uruguay!<a href="http://tinyurl.com/ogzclls" title="" target="_blank">Planilla Ordenes + Canales de Coordinacion</a><a href="' + linkDiv + '" title="" target="_blank">Canal de Coordinación</a></div>';
...
function battles() {
	var x = division();
    $.get('https://docs.google.com/spreadsheet/pub?key=0Ao9AwgenLRqIdHN1UWNhX0dHYzRuMmhVUGVxOTF6TUE&single=true&gid=0&range=C19&output=txt', function(data) {
        ...
        var shout = prios[0].split(';');
     	if ( shout[1] != "" && shout[1].length > 0 ) {
          var shoutdiv = '<div class="rest">-----------------</br><b>ATENCION!!</b> - Mensaje del MoD :  </br></br>'+ shout[1].replace(/\\n/g,"<br>") +'</br>-----------------</br></div>';
