// ==UserScript==
// @name           Muttley's TR Organizer for The Knights From Hell
// @version        20121221a
// @namespace      mmm
// @homepage       https://userscripts.org/scripts/show/154531
// @delay 1000
...
// @updateURL      https://userscripts.org/scripts/source/154531.meta.js
// @downloadURL    https://userscripts.org/scripts/source/154531.user.js
...
// @description    Muttley's TR Organizer for The Knights From Hell DOMAIN 359 ONLY!!!!!
// ==/UserScript==


var Version = '20121221a_mm';
...
Tabs.options = {
        ...
        init : function (div) {
            ...
            m += '<tr><td colspan=2>  <INPUT id=trBuffsCheck type=checkbox '+ (upgradeData.buffsOff?'CHECKED ':'') +'/> Automatically unselect upgrade tokens on upgrade panel</td></tr> ';
                                           ...
                                           if(rslt.ok){
                                               ...
                                               if (rslt.success)
                                               {
                                                   ...
                                                   if (qItem)
                                                   {
                                                       ...
                                                       var msg = 'Enhanced '+unsafeWindow.kocThroneItems[eItem].name + ' to quality ' + rslt.item.quality+ " in " + qItem.triesThis + " attempts. " + qItem.triesTotal + " total attempts for this item.";
                                                       trSuccessLog(msg);
                       ...
                       doUpgrade : function(uItem, bypass) {
                           ...
                           new AjaxRequest(unsafeWindow.g_ajaxpath + "ajax/_dispatch53.php" + unsafeWindow.g_ajaxsuffix, {
                               ...
                               onSuccess: function (transport) {
                                       ...
                                       if (rslt.success)
                                       {
                                           ...
                                           if (bypass !=true)
                                           {
                                               ...
                                               if (qItem) {
                                                   ...
                                                   var msg = 'Upgraded '+unsafeWindow.kocThroneItems[uItem].name + ' to level ' + rslt.item.level + " in " + qItem.triesThis + " attempts. " + qItem.triesTotal + " total attempts for this item.";
                                                   if (upgradeData.whisperToMe) sendChat("/"+ Seed.player.name +' ' + msg);
                                                   trSuccessLog(msg);
                                   ...
                                   {
                                       if (bypass !=true) t.setStatus("Upgrade request not accepted.  Waiting for next cycle.");
