// ==UserScript==
// @name           Turul-Master Birodalom
// @description    csatajelentés konvertáló
// @author         gaborka27
...
if(location.href.match(/action=view/)) { 
  ...
  var BerichtTitel = "[quote][b][ally]Turul - Master Birodalom[/ally] Jelentés konvertáló[/b]  [quote] [player]"+townOwner[0]+"[/player] [b]vs.[/b] [player]"+townOwner[1]+"[/player][/quote]";
  for(var c = 0; c < document.getElementsByTagName('div').length; c++) {
