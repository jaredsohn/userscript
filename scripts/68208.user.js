// ==UserScript==
// @name           Homepage Catch22 Tracker
// @namespace      GLB
// @description    Shows the lesser of the last 10 posts of last 2 weeks of posts by Catch22 on your home page under Announcements section.
...
var addr = "http://goallineblitz.com/game/search_forum.pl?page=1&age=90&user_name=Catch22&action=Search";
...
function main() {
	...
	divHeader.innerHTML = "Catch22 Tracker ( <a href='http://goallineblitz.com/game/search_forum.pl?page=1&age=14&user_name=Catch22&action=Search'>Full Search Page</a> )";
	
	var buttonLoad = document.createElement("input");
	buttonLoad.setAttribute("type","button");
	buttonLoad.setAttribute("value", "Load Catch22 Posts");
