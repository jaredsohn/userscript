// ==UserScript==
// @name           Darwin's Config
// @namespace      Darwin's Config
// @description    Configuracion de Darwin's.
// @author         Monkey
// ==/UserScript==
...
var scriptname    		= "Darwin's";
var scriptinstall 		= "http://userscripts.org/scripts/source/49091.user.js";
var scriptsource  		= "http://userscripts.org/scripts/review/49091?format=txt";
var scriptsite			= "http://userscripts.org/scripts/show/42504";
...
var BUILDINGS_IMAGES    = getCfgValue("BUILDINGS_IMAGES", true);
var ARMY_IMAGES   		= getCfgValue("ARMY_IMAGES", true);
var QUICK_UPGRADE   	= getCfgValue("QUICK_UPGRADE", true);
var DOUBLE_MAP       	= getCfgValue("DOUBLE_MAP", false);
