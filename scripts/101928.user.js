...
// @description Version 1.6.3 Fügt in DS an etlichen Stellen Laufzeiten (teileweise als Tooltip) ein 
// @author Hypix
...
// @exclude http://de*.die-staemme.de/game.php*overview*
// ==/UserScript==

(function(){
// Einstellungen: ja/an = true, nein/aus = false;
var showArrivalTime = true;   // Ankunftszeit anzeigen true/false;
var arrivalTimeOffset = 120;  // Anzahl der Sekunden, die auf die LOKALE Rechnerzeit addiert werden soll um die Startzeit zu ermitteln für die die Ankunftszeiten ermittelt werden
...
var texts = {
  de: 
  {
    gui:
    {
      ...
      arrival: "Ankunft",
      returnTime: "Rückkehr",
      cancelReturnTime: "Rückkehr bei Abbruch",
      dist: "Entf.",
