...
// @namespace     http://userscripts.org/scripts/source/64009.user.js
// @description   Version 1 - Organizes raid logs to a readable format - modified for SPCC by slyz
...
// --------------------------------------------------------------------------------------
// 12/11/2009 Version 1   - Point system for the Country Club
// --------------------------------------------------------------------------------------
// Old changelogs
// --------------------------------------------------------------------------------------
...
var boss_kills_pts = [0, -0.1, -0.3, -0.6, -0.9, -1.2, -1.5] ;
...
var scriptURL = "http://userscripts.org/scripts/source/64009.user.js";
...
function getTotalPoints()
{
    for (var i=0; i < swr_chars.length; i++ )
    {
        ...
        for (var j=0; j < 6; j++ )
		{
			if ( bosses[j] == swr_chars[i] )
			{
				bossKills = bossKills + 1;
			}
		}
        ptsArray[i][8] = totalpts + totalpts*boss_kills_pts[bossKills];
    ...
    {	
          ...
          if (ptsArray[z][9] != 0)
          {
			  ...
			  dataTable += '<td class="sewer' + shaded + '">' + parseFloat(swr_char_total_pts[swrIndex].toFixed(2)) + '</td>'+
						   '<td class="normal' + shaded + '">' + parseFloat(ptsArray[z][1].toFixed(2)) + '</td>'+
						   '<td class="burn' + shaded + '">' + parseFloat(ptsArray[z][2].toFixed(2)) + '</td>'+
						   '<td class="exp' + shaded + '">' + parseFloat(ptsArray[z][3].toFixed(2)) + '</td>'+
						   '<td class="heap' + shaded + '">' + parseFloat(ptsArray[z][4].toFixed(2)) + '</td>'+
						   '<td class="burial' + shaded + '">' + parseFloat(ptsArray[z][5].toFixed(2)) + '</td>'+
						   '<td class="purple' + shaded + '">' + parseFloat(ptsArray[z][6].toFixed(2)) + '</td>'+
						   '<td class="normal' + shaded + '">' + parseFloat(ptsArray[z][7].toFixed(2)) + '</td>'+
						   '<td class="normal' + shaded + '">' + parseFloat(ptsArray[z][8].toFixed(2)) + '</td>'+
						   '</tr>';
      ...
      dataTable += '<tr>'+
                   '<td class="normal_total">Total</td>'+
                   '<td class="sewer_total">' + parseFloat(totalArray[0].toFixed(2)) + '</td>'+
                   '<td class="normal_total">' + parseFloat(totalArray[1].toFixed(2)) + '</td>'+
                   '<td class="burn_total">' + parseFloat(totalArray[2].toFixed(2)) + '</td>'+
                   '<td class="exp_total">' + parseFloat(totalArray[3].toFixed(2)) + '</td>'+
                   '<td class="heap_total">' + parseFloat(totalArray[4].toFixed(2)) + '</td>'+
                   '<td class="burial_total">' + parseFloat(totalArray[5].toFixed(2)) + '</td>'+
                   '<td class="purple_total">' + parseFloat(totalArray[6].toFixed(2)) + '</td>'+
                   '<td class="normal_total">' + parseFloat(totalArray[7].toFixed(2)) + '</td>'+
                   '<td class="normal_total">' + parseFloat(totalArray[8].toFixed(2)) + '</td>'+
                   '</tr>';
...
function getSection(section, headerArray, pointArray, css, dataArray, totalArray, messageArray, bossNum)
{
    ...
    for (var z=0; z < dataArray.length; z++ )
    {
        ...
        {
            total += dataArray[z][y];
            dataTable += '<td>' + parseFloat(dataArray[z][y].toFixed(2)) + '</td>\n';
    ...
    {
        dataTable += '<td>' + parseFloat(totalArray[v].toFixed(2)) + '</td>\n';
    }
