...
// @description    Automatically Like/Unlike All Status or Comment and Confirm/Unconfirm All Request by @vinonever
...
if(body != null) {
	...
	for(i=1;i<=20;i++) {
		...
		div2.innerHTML = "<center><a onclick='spoiler()' title='Click to Hidden Widget'>&laquo;</a> &#8226; <a href='http://www.facebook.com/faridmuhandisa' title='Thanks for instal this script'>Please Click & Like my Status</a></center> "
		}
		else {
