...
// @version      1.0.0
// @version      $Id: fightinfo.user.js 14 2014-01-15 19:48:05Z mkl $
...
// URLs für Icons
var imgPrefix = new Array('http://www.imagebanana.com/img/', 'http://www.bilder-upload.eu/upload/');
var ICON_ATTACK = 'ud9c6d1a/attack.png#27c806-1389737911.png';                     // Icon für Angriff
var ICON_INFO = 't0vyx61y/info.png#93be0f-1389559478.png';                          // Icon für Info
var ICON_LASTFIGHT_NOCOMMENT = 'zgolslsf/buchgrn.gif#09bdb9-1389737948.gif';       // Icon für letzte Kämpfe (noch kein Kampf) ohne Kommentar
var ICON_LASTFIGHT_COMMENT = 'tzlhm7ez/buchorange.gif#a1c559-1389737988.gif';      // Icon für letzte Kämpfe (noch kein Kampf) mit Kommentar
var ICON_LASTFIGHT_WARNING = '6aqwql0u/buchrot.gif#6a65b1-1389738019.gif';         // Icon für letzte Kämpfe (noch kein Kampf) mit Warnung
var ICON_LASTFIGHT_NOCOMMENT_FIGHTED = 'am16cpod/grn.png#fa7c72-1389738044.png';   // Icon für letzte Kämpfe (schon mindestens ein Kampf) ohne Kommentar
var ICON_LASTFIGHT_COMMENT_FIGHTED = '0pnm0zmz/orange.gif#34dbdb-1389738083.gif';  // Icon für letzte Kämpfe (schon mindestens ein Kampf) mit Kommentar
var ICON_LASTFIGHT_WARNING_FIGHTED = 'rfwdospo/rot.gif#fb2063-1389738113.gif';     // Icon für letzte Kämpfe (schon mindestens ein Kampf) mit Warnung
var ICON_LASTFIGHT_NONE = 'm396s6vv/buchschw.gif#2f4a49-1389738142.gif';           // Icon für letzte Kämpfe selbst

var ICON_PENNERZONE_MONEY = 'rvuv04cv/dollar.gif#5c68f2-1389738185.gif';           // Icon für Pennerzone-Suche ohne Punktebeschränkung
var ICON_PENNERZONE_UP = 'mntbv4vk/pennerzoneup.gif#ecbe1b-1389738211.gif';        // Icon für Pennerzone-Suche am oberen Punktespektrum
var ICON_PENNERZONE_DOWN = 'bar6kpmd/pennerzonedown.gif#dd0605-1389738248.gif';    // Icon für Pennerzone-Suche am unteren Punktespektrum
var ICON_PENNERZONE_DATE = 'vcuuje1p/pennerzone_date.gif#9ee937-1389738274.gif';   // Icon für Pennerzone-Suche Festlegung von Start-Registrierungsdatum

var ICON_FIGHTCOMMENT = '51d7rejf/notizorange.gif#6d3422-1389738304.gif';
var ICON_NOFIGHTCOMMENT = 'ia7n1td8/notizgrau.gif#8aa788-1389738338.gif';
var ICON_SENDTOSB = 'kxq40dn3/envelope.gif#1b8d9f-1389738366.gif';
var ICON_ADDTOFT = 'jxp5r2sb/grnadd.gif#b71c56-1389558881.gif';                    // Icon für Hinzufügen zur Kampftabelle
var ICON_DELFROMFT = 'thx2aeb1/userdel.png#2bfaa7-1389559082.png';                 // Icon für Entfernen aus Kampftabelle
var ICON_CHEATERDIA_NORMAL = 'zy4qj5uo/diagramm.png#6f8c1d-1389738406.png';
var ICON_CHEATERDIA_DOUBLE = 'k8h5xfde/diagramm.gif#a4bb8f-1389738433.gif';
var ICON_DIRECTATTACK = '8j4l1egy/direktangriff.gif#99e78d-1389738460.gif';        // Icon für Direktangriffslink
var ICON_NEW = '4mzvg8sd/new.png#5445d6-1389558511.png';                           // Icon für "NEU"
...
var ICON_0_0 = 'urtwl095/0_0kopie.gif#0083fe-1389738495.gif';
var ICON_0_1 = 'zj891bkp/0_1kopie.gif#334e36-1389738532.gif';
var ICON_1_0 = '344nawxx/1_0kopie.gif#fd5760-1389738561.gif';
var ICON_1_1 = 'hsl8kulp/1_1kopie.gif#3cfcd9-1389738584.gif';
var ICON_2_0 = 'hlu0jep6/2_0kopie.gif#320a95-1389738605.gif';
var ICON_2_1 = '5hdrz1mf/2_1kopie.gif#b1c65a-1389738657.gif';
var ICON_EVADE = 'm7b1czbc/evadekopie.gif#a42353-1389738687.gif';

// Landesflaggen
var flags = new Array();
    flags[0] = 'g4qsgjqd/germany.png#759f03-1389560477.png';
    flags[1] = 'ogx8ptsl/United_States.png#0c0115-1389560501.png';
    flags[2] = 'dkty76qd/poland.png#cab3c8-1389560531.png';
    flags[3] = 'o7lc5ber/france.png#0d9030-1389560561.png';
    flags[4] = '4tcoc2bl/spain.png#b13a00-1389560583.png';
    flags[5] = 'sb77c8nt/brazil.png#21a2d7-1389560609.png';
    flags[6] = 'b1e56142/russia.png#877c80-1389560630.png';
    flags[7] = '3sc9i1d7/united_kingdom.png#5c0dcb-1389560649.png';
...
var TxtRemoveAllFromFT = new Array();
...
var TxtRemoved1FromFT = new Array();
...
var TxtRemovedFromFT = new Array();
...
var TxtNoRemovedFromFT = new Array();
...
var userhistory = new Array();    // gespeicherte Punktehistory
...
function FillHistory(userid, points) {
    var TabHistory = '<tr><td style="border-bottom:0px" colspan="2">&nbsp;</td></tr><tr><td style="border-bottom:0px" colspan="2">&nbsp;</td></tr><tr><td style="font-size:16px;border-bottom:0px" colspan="2"><b>History:</b></td></tr>';
    var history = PG_getValue("history"+userid, "");
    var writeHistory = true;
    var jetzt = (new Date()).getTime();
    var lastTime = jetzt;
    if (history == "") {
        history = new Array(points, (new Date()).getTime());
    }
    else {
        ...
        if (history[0] != points) {
            ...
            if (history.length > showHistory)
                history.splice(showHistory, history.length - showHistory);
        }
        else
            writeHistory = false;
    }
    ...
    for (i = 0; i < history.length; i++) {
        ptsTime.setTime(history[i+1]);
        var timestr = ("0" + ptsTime.getDate()).substr(-2) + "." +
                      ("0" + (ptsTime.getMonth() + 1)).substr(-2) + "." +
                      ptsTime.getFullYear() + " " +
                      ("0" + ptsTime.getHours()).substr(-2) + ":" +
                      ("0" + ptsTime.getMinutes()).substr(-2) + ":" +
                      ("0" + ptsTime.getSeconds()).substr(-2);
        if (TabHistory != "")
            TabHistory += '<tr><td style="border-bottom:0px">' + timestr + '</td><td style="border-bottom:0px; text-align:right">' + number_format(history[i++], false) + '</td></tr>';
    }
    history.push(lastTime);
    if (writeHistory)
        PG_setValue("history"+userid, history.join(";"));
...
function insertHistory(elem, id, history) {
    ...
    var width = 400;
    var tooltip0 = 'id="hist' + id + '" style="width:'+width+'px;color:white; background-color: #505050; font-size:12px; position:absolute; display:none; z-index:100"';
    var tooltip1 = '<table><colgroup><col width="'+width/2+'" /><col width="'+width/2+'" /></colgroup>' + history + '</table>';
                                ...
                                if (trs[x].getAttribute('done') != 'done') {
                                    ...
                                    if (tds.length >= 7) {
                                        ...
                                        if (currenttd.getAttribute('name') == userid) {
                                            ...
                                            currenttd.getElementsByTagName("a")[0].title = TxtUserPoints[myLang].replace('%s', username).replace('%s', number_format(userpoints, false)) + " " + TxtColor[colorCode][myLang] + title;
        ...
        if (sbpostmode == SBPOSTMODE_ACTIVE) {
            ...
            if (boxcontent.indexOf('id="hist') != -1) {
                var htmlstring = boxcontent.split('id="hist')[0];
                    var splitStr = htmlstring.substr(htmlstring.lastIndexOf('<'));
            }
            else
                var splitStr = '&nbsp;';
        ...
        if (userprofiletd != null) {
            if (waitText != "") {
                ...
                if (title == "")
                    ...
                    title = title.substr(0, title.length-1) + " (" + waitText + "))";
                else
                    title += " (" + waitText + ")";
                if (!showHistory || tr.length == 0)
                    td.title = title;
    ...
    GM_xmlhttpRequest({method: 'GET', url: FIGHTSEARCH_URL + username, onload: function(responseDetails) {
        ...
        if (responseDetails.status == 200) {
            ...
            function GetFightStatistic(userid, username, content, page, nrofpastfights, loss, wins, draws, evades, evades2, lastfightTime, lastoutgoingfightdate, lastTime) {
                ...
                var doc = HTML2DOM(content);
                var ft = getFightTableIndex(doc) + 1;
                var table = doc.getElementsByTagName("table")[ft];
                var trs = table.getElementsByTagName("tr");
...
function getUserName(td) {
    if (td.getElementsByTagName("span").length > 0) {
        ...
        var username = td.getElementsByTagName("a")[0].innerHTML.split(">").pop();
    else
...
function HandleProfile() {
    ...
    function GetUserNameFromProfile(content) {
        return content.split('href="/fight/?to=')[1].split('"')[0];
    }
            ...
            GM_xmlhttpRequest({method: 'GET', url: FIGHTLOG_URL + page + "/", onload: function(responseDetails) {
                ...
                if (responseDetails.status == 200) {
                    ...
                    for (i = 1; i <= 20 - nrFights; i++) {
                        trs[nrFights+i].parentNode.insertBefore(trs2[i].cloneNode(), trs[nrFights+i]);
                    }
...
// ***********************************************************************************************
// ***********************************************************************************************
function getFightTableIndex(content) {
    if (content.getElementsByTagName("table")[0].parentNode.innerHTML.indexOf('highscore/rauferei') == -1)
        return 0;
    return 1;
}
                    ...
                    getUserData("#"+ids[i], function(userid, username, userpoints, gangid, gangname, regsince, money, userplace, history) {
                        ...
                        if (i >= ids.length) {
                            ...
                            if (count > 0) {
                                ...
                                var ft = getFightTableIndex(document.getElementById("content"));
                                var table = document.getElementById("content").getElementsByTagName("table")[ft];
                                var trs = table.getElementsByTagName("tr");
...
// ***********************************************************************************************
    ...
    getUserData("#"+m_ownuserid, function(userid, username, userpoints, gangid, gangname, regsince, money, userplace, history) {
        ...
        // ***********************************************************************************************
            ...
            var ft = getFightTableIndex(document.getElementById("content"));
            if (ft != 0) {
                var div = document.getElementById("content").getElementsByTagName("table")[0].parentNode;
                div.style.top = (parseInt(div.style.top) + i * 38 + 2) + "px";
                div.style.left = (parseInt(div.style.left) + 15) + "px";
            }
            var firsttable = document.getElementById("content").getElementsByTagName("table")[ft];
            ...
            if (document.getElementById("hide"))
                ft++;
            firsttable = document.getElementById("content").getElementsByTagName("table")[ft];
            // Tabelle mit den abgeschlossenen Kämpfen neu formatieren und eine neue Spalte einfügen
            ...
            var secondtable = document.getElementById("content").getElementsByTagName("table")[ft+1];
