...
Credit to Thomas Chapin. You can use the Power Bot to accept gifts now (it is easier than using this script's method).
				...
				if(claim_gift){
					...
					if(domain_selector && (next_button1 || next_button2)){
						for(var i=0; i<domain_selector.options.length; i++){
							if(domain_selector.options[i].value == "291"){
