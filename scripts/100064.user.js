// ==UserScript==
// @name           Bagi – Bagi Jempol
// @namespace      AutoLike
// @namespace   http://code-poet.net/
// @description    Script terbaru buat Facebooker'S Mania--UPDATE
...
var lang = {
	...
	en : {
		...
		'Close' : 'Close',
		'ConfigureFacebookBucek' : 'Configure Bucek Script',
		...
		'ConfFacebook BucekLanguage' : 'Language for Bucek Script',
		'ConfFacebookTimestamps' : 'Show Facebook timestamps (eg. "3 hours ago").',
		'ConfFBFTimestamps' : 'Add Bucek Script timestamps after Facebook timestamps (eg. "11:45").',
		'ConfFBFTimestamps24' : 'Show Bucek Script timestamps in 24-hour format.',
		...
		'ConfSectionAbout' : 'About Bucek Script',
		...
		'ConfUpdates' : 'Check Userscripts.org daily for updates to Bucek Script. Or <a href="#" id="fbfUpdateLink" onclick="return false;">check now</a>.',
		...
		'Facebook Bucek Conflict' : 'Facebook Bucek is now known as Bucek Script.<br /><br />Because of the name change you need to manually uninstall Facebook Bucek from your browser, or the two scripts will conflict with each other.<br /><br />If you are aren\'t sure how to uninstall a userscript, <a %s>click here for instructions</a>.',
		...
		'UpdateAvailable1' : 'An update is available for Bucek Script',
	...
	es : {
		...
		'Close' : 'Cerrar',
		'ConfigureFacebookBucek' : 'Configuración de Bucek Script',
		...
		'ConfFacebookBucekLanguage' : 'Lenguaje del Bucek Script',
		'ConfFacebookTimestamps' : 'Mostrar cuanto hace que fue creado (Ejemplo: "Hace 3 horas").',
		'ConfFBFTimestamps24' : 'Mostrar las marcas de tiempo de Bucek Script en formato 24 horas.',
		'ConfFBFTimestamps' : 'Añadir las marcas de tiempo de Bucek Script después de las marcas de tiempo de Facebook (Por ejemplo "11:45").',
		...
		'ConfSectionAbout' : 'Acerca de Bucek Script',
		...
		'ConfShortcutList' : '<b>Atajos de Teclado</b> (sensible a la diferencia entre minúsculas y mayúsculas):<br /><br /><i>Desde cualquier página:</i><br />&nbsp;<b>A</b> - Álbumes/Fotos<br />&nbsp;<b>B</b> - Activar/Desactivar lista de amigos (Amigos conectados)<br />&nbsp;<b>C</b> - Configuración de Bucek Script<br />&nbsp;<b>D</b> - Cumpleaños<br />&nbsp;<b>E</b> - Eventos<br />&nbsp;<b>F</b> - Amigos<br />&nbsp;<b>H</b> - Página de Inicio<br />&nbsp;<b>I</b> - Bandeja de Entrada<br />&nbsp;<b>K</b> - Añadir Marcador<br />&nbsp;<b>L</b> - Seleccionar vínculo para terminar la sesión (presione Enter después para terminar la sesión)<br />&nbsp;<b>N</b> - Notificaciones<br />&nbsp;<b>P</b> - Perfil<br />&nbsp;<b>R</b> - Peticiones<br />&nbsp;<b>S</b> - Saltar a el campo de búsqueda<br />&nbsp;<b>T</b> - Traducir el texto seleccionado<br />&nbsp;<b>?</b> - Mostrar la información de depuración de Bucek Script<br />&nbsp;<b><escape></b> - Cerrar la ventana emergente creada por Bucek Script<br /><br /><i>Desde la página de inicio (filtros)</i>:<br />&nbsp;<b>a</b> - Páginas<br />&nbsp;<b>f</b> - Live feed<br />&nbsp;<b>g</b> - Grupos<br />&nbsp;<b>l</b> - Vínculos<br />&nbsp;<b>n</b> - Noticias<br />&nbsp;<b>p</b> - fotos<br />&nbsp;<b>s</b> or <b>u</b> - Estatus de las Actualizaciones<br />&nbsp;<b>t</b> - Notas<br />&nbsp;<b>v</b> - Vídeos<br /><br /><i>Desde los perfiles</i>:<br />&nbsp;<b>i</b> - Información<br />&nbsp;<b>p</b> - Fotos<br />&nbsp;<b>w</b> - Muro<br />&nbsp;<b>x</b> - Cajas<br /><br /><i>Desde las páginas con paginación (previo, siguiente, etc)</i><br />&nbsp;<b><left arrow></b> - Previo<br />&nbsp;<b><right arrow></b> - Siguiente<br />&nbsp;<b><shift> + <left arrow></b> - Primera (cuando este disponible)<br />&nbsp;<b><shift> + <right arrow></b> - Ultimo (cuando este disponible)<br /><br /><i>Al ver albumes/fotos:</i><br />&nbsp;<b>a</b> - Ver todas la miniaturas (cuando este disponible)<br />&nbsp;<b>b</b> - Ver fotos grandes<br />&nbsp;<b>c</b> - Ver comentarios<br />&nbsp;<b>k</b> - De vuelta al álbum<br />&nbsp;<b>m</b> - Fotos de (personas) y yo<br /><br /><i>Al ver albumes recientes y fotos subidas/marcadas:</i><br />&nbsp;<b>a</b> or &nbsp;<b>r</b> - Albumes Recientes<br />&nbsp;<b>m</b> or &nbsp;<b>u</b> - Fotos de Móviles<br />&nbsp;<b>o</b> - Fotos de mi<br />&nbsp;<b>p</b> - Mis Fotos<br />&nbsp;<b>t</b> or &nbsp;<b>f</b> - Amigos Marcados', 'ConfTopBarHoverOpacity' : 'Al pasar el ratón por encima', 'FacebookBucekConflict' : 'Facebook Bucek ahora se llama Bucek Script.<br /><br />Por el cambio de nombre es necesario desinstalar Facebook Bucek manualmente de su navegador o los dos programas entraran en conflicto.<br /><br />Si no sabe como desinstalar un userscript, <a %s>haga clic aquí para ver instrucciones</a>.',
		...
		'ConfUpdates' : 'Revisar Userscripts.org diarimente por si hay actualizaciones en Bucek Script. O <a href="#" id="fbfUpdateLink" onclick="return false;">revisar Ahora</a>.',
		...
		'FacebookBucekConflict' : 'Facebook Bucek ahora se llama Bucek Script.<br /><br />Por el cambio de nombre es necesario desinstalar Facebook Bucek manualmente de su navegador o los dos programas entraran en conflicto.<br /><br />Si no sabe como desinstalar un userscript, <a %s>haga clic aquí para ver instrucciones</a>.',
		...
		'UpdateAvailable1' : 'Hay una actualización disponible para Bucek Script',
	...
	fr : {
		...
		'Close' : 'Fermer',
		'ConfigureFacebookBucek' : 'Configurer Bucek Script',
		...
		'ConfFacebookBucekLanguage' : 'Langue de Bucek Script',
		'ConfFacebookTimestamps' : 'Affichage de la datation Facebook (ex. "Il y a 3 heures").',
		'ConfFBFTimestamps' : 'Ajout de la datation Bucek Script apr&egrave;s la datation Facebook (ex. "11:45").',
		'ConfFBFTimestamps24' : 'Affichage de la datation Bucek Script au format 24 heures.',
		...
		'ConfSectionAbout' : 'A propos de Bucek Script',
		...
		'ConfUpdates' : 'V&eacute;rifie quotidiennement si une mise &agrave; jour de Bucek Script est disponible sur Userscripts.org. Ou <a href="#" id="fbfUpdateLink" onclick="return false;">v&eacute;rifier maintenant</a>.',
		...
		'FacebookBucekConflict' : 'Bucek Script est maintenant devenu Bucek Script. A cause du changement de nom, vous aurez besoin de d&eacute;sinstaller manuellement Bucek Script de votre explorateur, ou les deux scripts rentreront en conflit. Si vous n\'&ecirc;tes pas s&ucirc;r de comment faire pour d&eacute;sinstaller un userscript, <a %s>cliquez ici pour la marche &agrave; suivre</a>.',
		...
		'Left' : 'Gauche',
		'ListeningRestarted' : 'Bucek Script s\'est remit \340 l\'\351coute des changements \351ventuels.',
		'ListeningStopped' : 'Bucek Script a arret\351 d\'\352tre \340 l\'\351coute des changements \351ventuels.\nAppuyez sur L (SHIFT + l) pour r\351-activer l\'\351coute',
		...
		'UpdateAvailable1' : 'Une mise &agrave; jour de Bucek Script est disponible',
	...
	it : {
		...
		'Close' : 'Chiudi',
		'ConfigureFacebookBucek' : 'Impostazioni di Bucek Script',
		...
		'ConfFacebookBucekLanguage' : 'Lingua di Bucek Script',
		...
		'ConfSectionAbout' : 'Riguardo di Bucek Script',
		...
		'FacebookBucekConflict' : 'Bucek Script ha cambiato nome in Bucek Script. A causa del cambiamento dovrai disinstallare manualmente Bucek Script dal tuo browser, o i due script andranno in conflitto. Se non sei sicuro di come disinstallare un userscript <a %s>clicca qui per le istruzioni</a>.',
		...
		'UpdateAvailable1' : 'È disponibile un update per Bucek Script.',
	...
	de : {
		...
		'Close' : 'Schließen',
		'ConfigureFacebookBucek' : 'Bucek Script konfigurieren',
		...
		'ConfFacebookBucekLanguage' : 'Sprache für Bucek Script',
		...
		'ConfUpdates' : 'UÜberprüfen Sie Userscripts.org täglich auf Updates für Bucek Script. <a href="#" id="fbfUpdateLink" onclick="return false;">Jetzt überprüfen</a>.',
		...
		'Left' : 'Links',
		'ListeningRestarted' : 'Bucek Script reagiert wieder auf Änderungen.',
		'ListeningStopped' : 'Bucek Script reagiert nicht auf Änderungen.\nL (SHIFT + l) drücken, um die Reaktion wieder zu aktvieren.',
		...
		'today' : 'heute',
		'UpdateAvailable1' : 'Es gibt ein Update für Bucek Script',
	...
	bg : {
		...
		'Close' : 'Затваряне',
		'ConfigureFacebookBucek' : 'Конфигуриране на Bucek Script',
		...
		'ConfFacebookBucekLanguage' : 'Език за Bucek Script',
		...
		'ConfUpdates' : 'Проверяване на Userscripts.org ежедневно за ъпдейти на Bucek Script. Или <a href="#" id="fbfUpdateLink" onclick="return false;">проверка сега</a>.',
		...
		'Left' : 'Отляво',
		'ListeningRestarted' : 'Bucek Script възстанови проверките за промени.',
		'ListeningStopped' : 'Bucek Script спря проверките за промени.\nНатиснете L (Shift + l) за повторно пускане',
		...
		'today' : 'днес',
		'UpdateAvailable1' : 'Излязло е обновление на Bucek Script',
	...
	el : {
		...
		'Close' : 'Κλείσιμο',
		'ConfigureFacebookBucek' : 'Διαμόρφωση Bucek Script',
		...
		'ConfFacebookBucekLanguage' : 'Γλώσσα για το Bucek Script',
		'ConfFacebookTimestamps' : 'Εμφάνιση της ώρας του Facebook (πχ. "Πριν 3 ώρες").',
		'ConfFBFTimestamps' : 'Προσθήκη της ώρας του Bucek Script μετά από την ώρα του Facebook (πχ. "11:45").',
		'ConfFBFTimestamps24' : 'Εμφάνιση της ώρας του Bucek Script σε 24-ωρη μορφή.',
		...
		'ConfSectionAbout' : 'Σχετικά με το Bucek Script',
		...
		'ConfUpdates' : 'Έλεγχος Userscripts.org καθημερινά για καινούργιες ενημερώσεις του Bucek Script ή <a href="#" id="fbfUpdateLink" onclick="return false;">έλεγχος τώρα</a>.',
		...
		'UpdateAvailable1' : 'Υπάρχει καινούργια διαθέσιμη έκδοση του Bucek Script',
	...
	sk : {
		...
		'Close' : 'Zavrieť',
		'ConfigureFacebookBucek' : 'Konfigurovať Bucek Script',
		...
		'ConfFacebookBucekLanguage' : 'Jazyk pre Facebook Bucek',
		'ConfFacebookTimestamps' : 'Zobraziť časové značky Facebooku (t. j. "pred 3 hodinami")',
		'ConfFBFTimestamps' : 'Pridať časové značky skriptu Facebook Bucek za časové značky Facebooku (t. j. "11:45")',
		'ConfFBFTimestamps24' : 'Zobraziť časové značky skriptu Facebook Bucek v 24-hodinovom formáte',
		...
		'ConfSectionAbout' : 'Čo je Facebook Bucek',
		...
		'ConfUpdates' : 'Denne na Userscripts.org overovať aktualizácie pre Facebook Bucek, prípadne <a href="#" id="fbfUpdateLink" onclick="return false;">skontrolovať teraz</a>.',
		...
		'FacebookBucekConflict' : 'Facebook Bucek sa odteraz nazýva Bucek Script.<br /><br />Pretože sa zmenil názov, je potrebné ručne odinštalovať Facebook Bucek z prehliadača, inak budú v konflikte dva skripty medzi sebou navzájom.<br /><br />Ak neviete, ako skript odinštalovať, <a %s>kliknutím sem otvorte pokyny</a>.',
		...
		'UpdateAvailable1' : 'K dispozícii je aktualizácia skriptu Facebook Bucek.',
	...
	nl : {
		...
		'Close' : 'Sluit',
		'ConfigureFacebookBucek' : 'Configureer Bucek Script',
		...
		'ConfFacebookBucekLanguage' : 'Taal voor Bucek Script',
		'ConfFacebookTimestamps' : 'Laat Facebook timestamps zien (bijv. "3 uur geleden").',
		'ConfFBFTimestamps' : 'Bucek Script timestamps toevoegen na Facebook timestamps (bijv. "11:45").',
		'ConfFBFTimestamps24' : 'Laat Bucek Script timestamps zien in 24-uurs formaat.',
		...
		'ConfShortcutList' : '<b>Keyboard Shortucts</b> (case sensitive):<br /><br /><i>From any page:</i><br />&nbsp;<b>A</b> - Albums/photos<br />&nbsp;<b>B</b> - Toggle buddy list (online friends)<br />&nbsp;<b>C</b> - Bucek Script configuration<br />&nbsp;<b>D</b> - Birthdays<br />&nbsp;<b>E</b> - Events<br />&nbsp;<b>F</b> - Friends<br />&nbsp;<b>H</b> - Home page<br />&nbsp;<b>I</b> - Inbox<br />&nbsp;<b>L</b> - Select the logout link (press Enter afterwards to log out)<br />&nbsp;<b>N</b> - Notifications<br />&nbsp;<b>P</b> - Your profile<br />&nbsp;<b>R</b> - Requests<br />&nbsp;<b>S</b> - Jump to the search field<br />&nbsp;<b>T</b> - Translate selected text<br />&nbsp;<b>?</b> - Show Bucek Script debug info<br />&nbsp;<b>&lt;escape&gt;</b> - Close pop-ups created by Bucek Script<br /><br /><i>From the home page (filters)</i>:<br />&nbsp;<b>a</b> - Pages<br />&nbsp;<b>f</b> - Live feed<br />&nbsp;<b>g</b> - Groups<br />&nbsp;<b>l</b> - Links<br />&nbsp;<b>n</b> - News feed<br />&nbsp;<b>p</b> - Photos<br />&nbsp;<b>s</b> or <b>u</b> - Status updates<br />&nbsp;<b>t</b> - Notes<br />&nbsp;<b>v</b> - Videos<br /><br /><i>From profiles</i>:<br />&nbsp;<b>i</b> - Info<br />&nbsp;<b>p</b> - Photos<br />&nbsp;<b>w</b> - Wall<br />&nbsp;<b>x</b> - Boxes<br /><br /><i>From pages with pagination (previous, next, etc)</i><br />&nbsp;<b>&lt;left arrow&gt;</b> - Previous<br />&nbsp;<b>&lt;right arrow&gt;</b> - Next<br />&nbsp;<b>&lt;shift&gt; + &lt;left arrow&gt;</b> - First (when available)<br />&nbsp;<b>&lt;shift&gt; + &lt;right arrow&gt;</b> - Last (when available)<br /><br /><i>While viewing albums/photos:</i><br />&nbsp;<b>a</b> - Load all thumbnails (when available)<br />&nbsp;<b>b</b> - Show big pictures<br />&nbsp;<b>c</b> - View comments<br />&nbsp;<b>k</b> - Back to album<br />&nbsp;<b>m</b> - Photos of (person) and me<br /><br /><i>While viewing recent albums and uploaded/tagged photos:</i><br />&nbsp;<b>a</b> or &nbsp;<b>r</b> - Recent Albums<br />&nbsp;<b>m</b> or &nbsp;<b>u</b> - Mobile uploads<br />&nbsp;<b>o</b> - Photos of me<br />&nbsp;<b>p</b> - My Photos<br />&nbsp;<b>t</b> or &nbsp;<b>f</b> - Tagged friends',
		...
		'ConfUpdates' : 'Check Userscripts.org dagelijks voor updates naar Bucek Script. Of <a href="#" id="fbfUpdateLink" onclick="return false;">check nu</a>.',
		'DownloadVideo' : 'Download Video',
		...
		'today' : 'vandaag',
		'UpdateAvailable1' : 'Een update is beschikbaar voor Bucek Script',
	...
	zh_tw : {
		...
		'CreatingFile' : '創建文件',
		'Close' : '關閉',
		'ConfigureFacebookBucek' : '設定 Bucek Script',
		...
		'ConfFacebookBucekLanguage' : 'Bucek Script的語言選項',
		'ConfFacebookTimestamps' : '顯示Facebook原來的時間戳記 (eg. "3 hours ago").',
		'ConfFBFTimestamps' : '新增Bucek Script的顯示時間戳記 (eg. "11:45").',
		'ConfFBFTimestamps24' : 'Bucek Script的時間戳記採用24小時制。',
		...
		'ConfSectionAbout' : '關於 Bucek Script',
		...
		'ConfUpdates' : '檢查 Userscripts.org For Bucek Script 的更新。 或是 <a href="#" id="fbfUpdateLink" onclick="return false;">立即確認</a>.',
		'DownloadVideo' : '下載影片',
		'ExportICalendarFile' : '輸出 iCalendar 檔案',
		'ExportICalendarFileWarning' : '(如果你有很多的朋友的話，將要一段時間)',
		'FacebookBucekConflict' : 'Facebook Bucek現在更名為Bucek Script。<br /><br />由於更改名稱，你需要手動從瀏覽器中卸載舊的Facebook Bucek腳本，因為兩個腳本會相互衝突。<br /><br />如果你不確定如何去移除腳本， <a %s>點擊說明部份</a>.',
		...
		'today' : 'today',
		'UpdateAvailable1' : 'Bucek Script 有可用的更新。',
	...
	tr : {
		...
		'Close' : 'Kapat',
		'ConfigureFacebookBucek' : 'Bucek Script\'ı Yapılandır',
		...
		'ConfFacebookBucekLanguage' : 'Bucek Script\'ın Dili',
		'ConfFacebookTimestamps' : 'Facebook\'un zaman etiketlerini göster (örn. "3 saat önce").',
		'ConfFBFTimestamps' : 'Facebook\'un zaman etiketlerinin ardından Bucek Script zaman etiketlerini ekle (örn. "11:45").',
		'ConfFBFTimestamps24' : 'Bucek Script zaman etiketlerini 24-saat biçiminde göster',
		...
		'ConfSectionAbout' : 'Bucek Script Hakkında',
		...
		'ConfUpdates' : 'Bucek Script güncellemeleri için her gün Userscripts.org\'u ziyaret et. Ya da <a href="#" id="fbfUpdateLink" onclick="return false;">şimdi kontrol et</a>.',
		...
		'FacebookBucekConflict' : 'Bucek Script\'ın yeni adı artık Bucek Script. İsim değişikliğinden dolayı Bucek Script\'ı tarayıcınızdan kaldırmanız gerekiyor, yoksa bu iki script birbiriyle uyuşmazlık sorunları çıkaracaktır. Eğer bir userscript\'i nasıl kaldıracağınızdan emin değilseniz <a %s>buraya tıklayarak öğrenebilirsiniz</a>.',
		...
		'UpdateAvailable1' : 'Bucek Script için bir güncelleme mevcut',
	...
	sr_rs : {
		...
		'Close' : 'Затвори',
		'ConfigureFacebookBucek' : 'Подеси Bucek Script',
		...
		'ConfFacebookBucekLanguage' : 'Језик Bucek Script-а',
		'ConfFacebookTimestamps' : 'Прикажи Фејсбук време (нпр. "пре 3 сата").',
		'ConfFBFTimestamps' : 'Додај Bucek Script време после Фејсбук времена (нпр. "11:45").',
		'ConfFBFTimestamps24' : 'Прикажи Bucek Script времена у 24-часовном облику.',
		...
		'ConfSectionAbout' : 'О додатку Bucek Script',
		...
		'ConfUpdates' : 'Свакодневно проверавај Userscripts.org за надоградње Bucek Script-а. Или <a href="#" id="fbfUpdateLink" onclick="return false;">провери сада</a>.',
		...
		'FacebookBucekConflict' : 'Bucek Script се сада зове Bucek Script. Због промене имена мораћете ручно да уклоните Bucek Script из свог прегледача да не би дошло до ометања између ове две скрипте. Ако нисте сигурни како да уклоните скрипту, <a %s>кликните овде за упутство</a>.',
		...
		'UpdateAvailable1' : 'Доступне су надоградње за Bucek Script',
	...
	sr : {
		...
		'Close' : 'Zatvori',
		'ConfigureFacebookBucek' : 'Podesi Bucek Script',
		...
		'ConfFacebookBucekLanguage' : 'Jezik Bucek Script-a',
		'ConfFacebookTimestamps' : 'Prikaži Fejsbuk vreme (npr. "pre 3 sata").',
		'ConfFBFTimestamps' : 'Dodaj Bucek Script vreme posle Fejsbuk vremena (npr. "11:45").',
		'ConfFBFTimestamps24' : 'Prikaži Bucek Script vremena u 24-časovnom obliku.',
		...
		'ConfSectionAbout' : 'O dodatku Bucek Script',
		...
		'ConfUpdates' : 'Svakodnevno proveravaj Userscripts.org za nadogradnje Bucek Script-a. Ili <a href="#" id="fbfUpdateLink" onclick="return false;">proveri sada</a>.',
		...
		'FacebookBucekConflict' : 'Bucek Script se sada zove Bucek Script. Zbog promene imena moraćete ručno da uklonite Bucek Script iz svog pregledača da ne bi došlo do ometanja između ove dve skripte. Ako niste sigurni kako da uklonite skriptu, <a %s>kliknite ovde za uputstvo</a>.',
		...
		'UpdateAvailable1' : 'Dostupne su nadogradnje za Bucek Script',
	...
	da : {
		...
		'Close' : 'Luk',
		'ConfigureFacebookBucek' : 'Konfigurér Bucek Script',
		...
		'ConfFacebookBucekLanguage' : 'Sprog i Bucek Script',
		'ConfFacebookTimestamps' : 'Vis Facebook tidsstempler (f.eks. "3 timer sider").',
		'ConfFBFTimestamps' : 'Tilføj Bucek Script tidsstempler efter Facebook tidsstempler (f.eks. "11:45").',
		'ConfFBFTimestamps24' : 'Vis Bucek Script tidsstempler i 24 timers format.',
		...
		'ConfSectionAbout' : 'Omkring Bucek Script',
		...
		'ConfUpdates' : 'Undersøg Userscripts.org dagligt for opdateringer til Bucek Script. Eller <a href="#" id="fbfUpdateLink" onclick="return false;">undersøg nu</a>.',
		...
		'FacebookBucekConflict' : 'Bucek Script vil fremover hedde Bucek Script. På grund af navneskiftet, skal du manuelt afinstallere Bucek Script fra dine browsere, da de to scripts ellers vil komme i konflikt med hinanden. Hvis du er usikker på hvordan man afinstallerer et Userscript, så <a %s>tryk her for instruktioner</a>.',
		'fullAlbumLoaded' : 'Hele albummet hentet',
		'Left' : 'Venstre',
		'ListeningRestarted' : 'Bucek Script lytter efter ændringer igen.',
		'ListeningStopped' : 'Bucek Script er stoppet med at lytte efter ændringer.\nTryk L (SHIFT + l) for at starte igen',
		...
		'today' : 'i dag',
		'UpdateAvailable1' : 'En opdatering er tilgængelig til Bucek Script',
	...
	cs : {
		...
		'Close' : 'Zavřít',
		'ConfigureFacebookBucek' : 'Nastavení - Bucek Script',
		...
		'ConfFacebookBucekLanguage' : 'Jazyk pro Bucek Script',
		'ConfFacebookTimestamps' : 'Zobrazit časové značky Facebooku (t. j. "před 3 hodinami")',
		'ConfFBFTimestamps' : 'Přidat časové značky skriptu Bucek Script za časové značky Facebooku (t. j. "11:45")',
		'ConfFBFTimestamps24' : 'Zobrazit časové značny skriptu Bucek Script v 24-hodinovém formátě',
		...
		'ConfSectionAbout' : 'O Bucek Scriptu',
		...
		'ConfUpdates' : 'Denně na Userscripts.org ověřovat aktualizace pro Bucek Script, případně <a href="#" id="fbfUpdateLink" onclick="return false;">zkontrolovat nyní</a>.',
		...
		'FacebookBucekConflict' : 'Facebook Fifex je nyní znám jako Bucek Script.<br /><br />Protože se změnilo jméno, musíte manuálně odinstalovat Facebook Bucek z vašeho prohlížeče.<br /><br />Pokud si nevíte jak na to <a %s>pokračujte zde</a>.',
		...
		'UpdateAvailable1' : 'K dispozici je aktualizace skriptu Bucek Script.',
	...
	mk : {
		...
		'Close' : 'Затвори',
		'ConfigureFacebookBucek' : 'Конфигурирај го Bucek Script',
		...
		'ConfFacebookBucekLanguage' : 'Јазик за Bucek Script',
		'ConfFacebookTimestamps' : 'Прикажи Facebook маркер за времето (eg. "3 часа старо").',
		'ConfFBFTimestamps' : 'Додади Bucek Script маркер за времето по Facebook маркерот за време (eg. "11:45").',
		'ConfFBFTimestamps24' : 'Прикажи Bucek Script маркер за време во 24-часовен формат.',
		...
		'ConfSectionAbout' : 'За Bucek Script',
		...
		'ConfShortcutList' : '<b>Кратенки за тастатура</b> (case sensitive):<br /><br /><i>Од секоја страница:</i><br />&nbsp;<b>A</b> - Albums/photos<br />&nbsp;<b>B</b> - Вклучи корисници (вклучени пријатели)<br />&nbsp;<b>C</b> - Bucek Script Конфигурација<br />&nbsp;<b>D</b> - Родендени<br />&nbsp;<b>E</b> - Настани<br />&nbsp;<b>F</b> - Пријатели<br />&nbsp;<b>H</b> - Почетна страница<br />&nbsp;<b>I</b> - Сандаче<br />&nbsp;<b>K</b> - Add Bookmark<br />&nbsp;<b>L</b> - Select the logout link (press Enter afterwards to log out)<br />&nbsp;<b>N</b> - Notifications<br />&nbsp;<b>P</b> - Your profile<br />&nbsp;<b>R</b> - Requests<br />&nbsp;<b>S</b> - Jump to the search field<br />&nbsp;<b>T</b> - Translate selected text<br />&nbsp;<b>?</b> - Show Bucek Script debug info<br />&nbsp;<b>&lt;escape&gt;</b> - Close pop-ups created by Bucek Script<br /><br /><i>From the home page (filters)</i>:<br />&nbsp;<b>a</b> - Pages<br />&nbsp;<b>f</b> - Live feed<br />&nbsp;<b>g</b> - Groups<br />&nbsp;<b>l</b> - Links<br />&nbsp;<b>n</b> - News feed<br />&nbsp;<b>p</b> - Photos<br />&nbsp;<b>s</b> or <b>u</b> - Status updates<br />&nbsp;<b>t</b> - Notes<br />&nbsp;<b>v</b> - Videos<br /><br /><i>From profiles</i>:<br />&nbsp;<b>i</b> - Info<br />&nbsp;<b>p</b> - Photos<br />&nbsp;<b>w</b> - Wall<br />&nbsp;<b>x</b> - Boxes<br /><br /><i>From pages with pagination (previous, next, etc)</i><br />&nbsp;<b>&lt;left arrow&gt;</b> - Previous<br />&nbsp;<b>&lt;right arrow&gt;</b> - Next<br />&nbsp;<b>&lt;shift&gt; + &lt;left arrow&gt;</b> - First (when available)<br />&nbsp;<b>&lt;shift&gt; + &lt;right arrow&gt;</b> - Last (when available)<br /><br /><i>While viewing albums/photos:</i><br />&nbsp;<b>a</b> - Load all thumbnails (when available)<br />&nbsp;<b>b</b> - Show big pictures<br />&nbsp;<b>c</b> - View comments<br />&nbsp;<b>k</b> - Back to album<br />&nbsp;<b>m</b> - Photos of (person) and me<br /><br /><i>While viewing recent albums and uploaded/tagged photos:</i><br />&nbsp;<b>a</b> or &nbsp;<b>r</b> - Recent Albums<br />&nbsp;<b>m</b> or &nbsp;<b>u</b> - Mobile uploads<br />&nbsp;<b>o</b> - Photos of me<br />&nbsp;<b>p</b> - My Photos<br />&nbsp;<b>t</b> or &nbsp;<b>f</b> - Tagged friends',
		...
		'ConfUpdates' : 'Провери Userscripts.org дневно за надоградби во Bucek Script. Или <a href="#" id="fbfUpdateLink" onclick="return false;">провери сега</a>.',
		...
		'FacebookBucekConflict' : 'Facebook Bucek е сега Bucek Script.<br /><br />За промена на име треба сами да го избришете Facebook Bucek од вашиот пребарувач, или двете скрипти ќе создаваат проблем една на друга.<br /><br />Ако не си сигурен како да ја избришеш скриптата, <a %s>кликни тука за инструкции</a>.',
		...
		'UpdateAvailable1' : 'Достапна е надоградба за Bucek Script',
	...
	nb : {	
		...
		'Close' : 'Lukk',
		'ConfigureFacebookBucek' : 'Bucek Script - Alternativer',
		...
		'ConfFacebookBucekLanguage' : 'Språk til Bucek Script',
		'ConfFacebookTimestamps' : 'Vis Facebook tidsangivelse (eg. "3 timer siden").',
		'ConfFBFTimestamps' : 'Legg til Bucek Script tidsangivelser etter Facebook tider (eg. "11:45").',
		'ConfFBFTimestamps24' : 'Vis Bucek Script tidsangivelser i 24-timers format.',
		...
		'ConfSectionAbout' : 'Om Bucek Script',
		...
		'ConfUpdates' : 'Sjekk Userscripts.org daglig etter oppdateinger til Bucek Script. Eller <a href="#" id="fbfUpdateLink" onclick="return false;">sjekk nå</a>.',
		...
		'FacebookBucekConflict' : 'Facebook Bucek er nå kjent som Bucek Script.<br /><br />På grunn av navnebyttet må du manuelt avinstallere Facebook Bucek fra nettleseren din, ellers vil de to scriptene komme i konflikt med hverandre.<br /><br />Dersom du ikke er sikker på hvordan man avinstallerer et brukerscript, <a %s>klikk her for instruksjoner</a>.',
		...
		'UpdateAvailable1' : 'En oppdatering til Bucek Script er tilgjengelig',
	...
	ko : {
		...
		'Close' : '닫기',
		'ConfigureFacebookBucek' : 'Bucek Script 설정',
		...
		'ConfFacebookBucekLanguage' : 'Bucek Script에 사용할 언어',
		'ConfFacebookTimestamps' : 'Facebook 형식의 타임스탬프 보이기 (예. "약 3시간 전").',
		'ConfFBFTimestamps' : 'Bucek Script 형식의 타임스탬프를 Facebook 타임스탬프 뒤에 보이기 (예. "11:45").',
		'ConfFBFTimestamps24' : 'Bucek Script 타임스탬프를 24시간 형식으로 보이기.',
		...
		'ConfSectionAbout' : 'Bucek Script는...',
		...
		'ConfShortcutList' : '<b>키보드 단축키</b> (대소문자 구분):<br /><br /><i>모든 페이지에서 작동</i>:<br />&nbsp;<b>A</b> - 사진첩/사진<br />&nbsp;<b>B</b> - 접속된 친구 보이기/숨기기<br />&nbsp;<b>C</b> - Bucek Script 설정<br />&nbsp;<b>D</b> - 생일<br />&nbsp;<b>E</b> - 이벤트<br />&nbsp;<b>F</b> - 친구<br />&nbsp;<b>H</b> - 첫 페이지<br />&nbsp;<b>I</b> - 쪽지<br />&nbsp;<b>K</b> - 즐겨찾기 더하기<br />&nbsp;<b>L</b> - 로그아웃 링크를 선택 (그다음 엔터키를 누르면 로그아웃)<br />&nbsp;<b>N</b> - 알림<br />&nbsp;<b>P</b> - 내 프로필<br />&nbsp;<b>R</b> - Requests<br />&nbsp;<b>S</b> - 검색 필드로 커서 이동<br />&nbsp;<b>T</b> - 선택한 텍스트를 번역<br />&nbsp;<b>?</b> - Bucek Script 디버그 정보 보기<br />&nbsp;<b>&lt;ESC&gt;</b> - Bucek Script 팝업 사진 닫기<br /><br /><i>홈페이지에서 작동(필터)</i>:<br />&nbsp;<b>a</b> - 페이지<br />&nbsp;<b>f</b> - 최신글<br />&nbsp;<b>g</b> - 그룹<br />&nbsp;<b>l</b> -링크<br />&nbsp;<b>n</b> - 뉴스 피드<br />&nbsp;<b>p</b> - 사진<br />&nbsp;<b>s</b> 또는 <b>u</b> - 상태 업데이트<br />&nbsp;<b>t</b> - 노트<br />&nbsp;<b>v</b> - 비디오<br /><br /><i>프로필 페이지에서 작동</i>:<br />&nbsp;<b>i</b> - 정보<br />&nbsp;<b>p</b> - 사진<br />&nbsp;<b>w</b> - 담벼락<br />&nbsp;<b>x</b> - Boxes<br /><br /><i>이동이 가능한 페이지에서 작동(이전, 다음, 등)</i>:<br />&nbsp;<b>&lt;←&gt;</b> - 이전<br />&nbsp;<b>&lt;→&gt;</b> - 다음<br />&nbsp;<b>&lt;Shift&gt; + &lt;←&gt;</b> - 처음 (가능할때만)<br />&nbsp;<b>&lt;Shift&gt; + &lt;→&gt;</b> - 마지막 (가능할때만)<br /><br /><i>사진첩/사진을 볼때 작동</i>:<br />&nbsp;<b>a</b> - 모든 썸네일 보기 (가능할때만)<br />&nbsp;<b>b</b> - 큰 사진 보이기<br />&nbsp;<b>c</b> - 댓글 보기<br />&nbsp;<b>k</b> - 사진첩으로 돌아가기<br />&nbsp;<b>m</b> - 내가(또는 친구가) 나온 사진<br /><br /><i>최근 사진첩이나 업로드/태그된 사진을 볼때 작동:</i><br />&nbsp;<b>a</b> 또는 &nbsp;<b>r</b> - 최근 사진첩<br />&nbsp;<b>m</b> 또는 <b>u</b> - 모바일 업로드<br />&nbsp;<b>o</b> - 내가 나온 사진<br />&nbsp;<b>p</b> -내 사진<br />&nbsp;<b>t</b> 또는 <b>f</b> - 태그 된 친구들',
		...
		'ConfUpdates' : '매일 Userscripts.org에서 Bucek Script 업데이트를 확인하기. <a href="#" id="fbfUpdateLink" onclick="return false;">지금 확인</a>.',
		'DownloadVideo' : '비디오 다운로드',
		'ExportICalendarFile' : 'iCalender 파일로 가져오기',
		'ExportICalendarFileWarning' : '(친구가 많으면 오래 걸릴 수 있습니다)',
		'FacebookBucekConflict' : 'Facebook Bucek의 이름이 Bucek Script로 바뀌었습니다.<br /><br />Facebook Bucek을 브라우저에서 제거하지 않으면 이름 변경 때문에 충돌이 일어납니다.<br /><br />userscript를 제거하는 방법을 모르겠으면 <a %s>여기를 참조하세요</a>.',
		...
		'today' : '오늘',
		'Translators' : '번역한 사람',
		'UpdateAvailable1' : 'Bucek Script 업데이트가 나왔습니다',
	...
	vi : {
		...
		'Close' : 'Đóng',
		'ConfigureFacebookBucek' : 'Cài đặt Bucek Script',
		...
		'ConfFacebookBucekLanguage' : 'Ngôn ngữ cho Bucek Script',
		'ConfFacebookTimestamps' : 'Hiện mốc thời gian của facebook (ví dụ: "3 hours ago").',
		'ConfFBFTimestamps' : 'Thêm mốc thời gian của Bucek Script sau mốc thời gian của Facebook (ví dụ: "11:45").',
		'ConfFBFTimestamps24' : 'Hiển thị mốc thời gian của Bucek Script dạng 24 giờ.',
		...
		'ConfProtocolLinks' : 'Turn messenger IDs on profiles into links that start a conversation with them (Google Talk, Windows Live etc).',
		'ConfSectionAbout' : 'Thông tin về Bucek Script',
		...
		'ConfShortcutList' : '<b>Keyboard Shortucts</b> (case sensitive):<br /><br /><i>From any page:</i><br />&nbsp;<b>A</b> - Albums/photos<br />&nbsp;<b>B</b> - Toggle buddy list (online friends)<br />&nbsp;<b>C</b> - Tùy Chỉnh Bucek Script<br />&nbsp;<b>D</b> - Birthdays<br />&nbsp;<b>E</b> - Events<br />&nbsp;<b>F</b> - Friends<br />&nbsp;<b>H</b> - Home page<br />&nbsp;<b>I</b> - Inbox<br />&nbsp;<b>K</b> - Add Bookmark<br />&nbsp;<b>L</b> - Select the logout link (press Enter afterwards to log out)<br />&nbsp;<b>N</b> - Notifications<br />&nbsp;<b>P</b> - Your profile<br />&nbsp;<b>R</b> - Requests<br />&nbsp;<b>S</b> - Jump to the search field<br />&nbsp;<b>T</b> - Translate selected text<br />&nbsp;<b>?</b> - Show Bucek Script debug info<br />&nbsp;<b>&lt;escape&gt;</b> - Close pop-ups created by Bucek Script<br /><br /><i>From the home page (filters)</i>:<br />&nbsp;<b>a</b> - Pages<br />&nbsp;<b>f</b> - Live feed<br />&nbsp;<b>g</b> - Groups<br />&nbsp;<b>l</b> - Links<br />&nbsp;<b>n</b> - News feed<br />&nbsp;<b>p</b> - Photos<br />&nbsp;<b>s</b> or <b>u</b> - Status updates<br />&nbsp;<b>t</b> - Notes<br />&nbsp;<b>v</b> - Videos<br /><br /><i>From profiles</i>:<br />&nbsp;<b>i</b> - Info<br />&nbsp;<b>p</b> - Photos<br />&nbsp;<b>w</b> - Wall<br />&nbsp;<b>x</b> - Boxes<br /><br /><i>From pages with pagination (previous, next, etc)</i><br />&nbsp;<b>&lt;left arrow&gt;</b> - Previous<br />&nbsp;<b>&lt;right arrow&gt;</b> - Next<br />&nbsp;<b>&lt;shift&gt; + &lt;left arrow&gt;</b> - First (when available)<br />&nbsp;<b>&lt;shift&gt; + &lt;right arrow&gt;</b> - Last (when available)<br /><br /><i>While viewing albums/photos:</i><br />&nbsp;<b>a</b> - Load all thumbnails (when available)<br />&nbsp;<b>b</b> - Show big pictures<br />&nbsp;<b>c</b> - View comments<br />&nbsp;<b>k</b> - Back to album<br />&nbsp;<b>m</b> - Photos of (person) and me<br /><br /><i>While viewing recent albums and uploaded/tagged photos:</i><br />&nbsp;<b>a</b> or &nbsp;<b>r</b> - Recent Albums<br />&nbsp;<b>m</b> or &nbsp;<b>u</b> - Mobile uploads<br />&nbsp;<b>o</b> - Photos of me<br />&nbsp;<b>p</b> - My Photos<br />&nbsp;<b>t</b> or &nbsp;<b>f</b> - Tagged friends',
		...
		'ConfUpdates' : 'Hãy truy cập vào Userscripts.org hàng ngày để cập nhật Bucek Script. hoặc <a href="#" id="fbfUpdateLink" onclick="return false;">kiểm tra ngay</a>.',
		'DownloadVideo' : 'Download Video',
		'ExportICalendarFile' : 'Export iCalendar file',
		'ExportICalendarFileWarning' : '(Điều này sẽ mất một khoảng thời gian nếu bạn có rất nhiều bạn bè)',
		'FacebookBucekConflict' : 'Facebook Bucek nay được gọi là Bucek Script.<br /><br />Bởi vì thay đổi tên nên bạn cần phải tự gỡ bỏ Facebook Bucek từ trình duyệt của bạn, hoặc hai kịch bản sẽ xung đột với nhau.<br /><br />Nếu bạn không biết gỡ bỏ một userscript, <a %s>bấm vào đây để được hướng dẫn</a>.',
		...
		'today' : 'hôm nay',
		'Translators' : 'Translators',
		'UpdateAvailable1' : 'Đã có bản cập nhật mới cho Bucek Script',
	...
	id : {
	   ...
	   'Close' : 'Tutup',
	   'ConfigureFacebookBucek' : 'Atur Bucek Script',
	   ...
	   'ConfFacebookBucekLanguage' : 'Bahasa untuk Bucek Script',
	   'ConfFacebookTimestamps' : 'Tampilkan cap waktu Facebook (contoh "3 jam lalu").',
	   'ConfFBFTimestamps' : 'Tambahkan cap waktu Bucek Script setelah cap waktu Facebook (contoh "11:45").',
	   'ConfFBFTimestamps24' : 'Tampilkan cap waktu Bucek Script dalam format 24 jam.',
	   ...
	   'ConfSectionAbout' : 'Tentang Bucek Script',
	   ...
	   'ConfUpdates' : 'Cek Userscripts.org setiap hari untuk update Bucek Script. Atau <a href="#" id="fbfUpdateLink" onclick="return false;">cek sekarang</a>.',
	   ...
	   'FacebookBucekConflict' : 'Facebook Bucek sekarang dikenal dengan nama Bucek Script.<br /><br />Karena pergantian nama Anda harus menguninstal Facebook Bucek dari browser Anda, atau dua script ini akan bertentangan satu sama lain.<br /><br />Jika Anda tidak mengetahui cara untuk menguninstal script ini, <a %s>Klick disini untuk tata caranya</a>.',
	   ...
	   'UpdateAvailable1' : 'Update tersedia untuk Bucek Script',
	...
	ja : {
		...
		'Close' : '閉じる',
		'ConfigureFacebookBucek' : 'Bucek Script設定',
		...
		'ConfSectionAbout' : 'Bucek Scriptについて',
		...
		'ConfShortcutList' : '<b>キーボード ショートカット</b>（大文字と小文字で異なります）:<br /><br /><i>どのページでも可能:</i><br />&nbsp;<b>A</b> - アルバム/写真<br />&nbsp;<b>B</b> - 連絡先リスト（オンラインの友達）の切替え<br />&nbsp;<b>C</b> - Bucek Script設定<br />&nbsp;<b>D</b> - 誕生日<br />&nbsp;<b>E</b> - イベント<br />&nbsp;<b>F</b> - 友達<br />&nbsp;<b>H</b> - ホーム<br />&nbsp;<b>I</b> - 受信箱<br />&nbsp;<b>K</b> - ブックマークに追加<br />&nbsp;<b>L</b> - ログアウトへのリンクを選択 （その後でEnterを押すとログアウトします）<br />&nbsp;<b>N</b> - お知らせ<br />&nbsp;<b>P</b> - プロフィール<br />&nbsp;<b>R</b> - リクエスト<br />&nbsp;<b>S</b> - 検索ボックスにジャンプ<br />&nbsp;<b>T</b> - 選択されたテキストを翻訳<br />&nbsp;<b>?</b> - Bucek Scriptのデバッグ情報を表示<br />&nbsp;<b>&lt;escape&gt;</b> - Bucek Scriptが作成したポップアップを閉じる<br /><br /><i>ホームで可能（フィルタ）</i>:<br />&nbsp;<b>a</b> - ページ<br />&nbsp;<b>f</b> - 最新情報<br />&nbsp;<b>g</b> - グループ<br />&nbsp;<b>l</b> - リンク<br />&nbsp;<b>n</b> - ニュースフィード<br />&nbsp;<b>p</b> - 写真<br />&nbsp;<b>s</b> / <b>u</b> - 近況アップデート<br />&nbsp;<b>t</b> - ノート<br />&nbsp;<b>v</b> - 動画<br /><br /><i>プロフィールで可能</i>:<br />&nbsp;<b>i</b> - 基本データ<br />&nbsp;<b>p</b> - 写真<br />&nbsp;<b>w</b> - ウォール<br />&nbsp;<b>x</b> - ボックス<br /><br /><i>ページ付け（前へ，次へ等）があるページで可能</i><br />&nbsp;<b>←</b> - 前へ<br />&nbsp;<b>→</b> - 次へ<br />&nbsp;<b>&lt;shift&gt; + ←</b> - 最初へ（可能な時のみ）<br />&nbsp;<b>&lt;shift&gt; + →</b> - 最後へ（可能な時のみ）<br /><br /><i>アルバム/写真の閲覧時:</i><br />&nbsp;<b>a</b> - 全てのサムネイルを読み込む（可能な時のみ）<br />&nbsp;<b>b</b> - 大きい画像を表示<br />&nbsp;<b>c</b> - コメントを表示<br />&nbsp;<b>k</b> - アルバムに戻る<br />&nbsp;<b>m</b> - （誰かと）あなたの写真<br /><br /><i>友達の写真やアップロード/タグ付けされた写真の閲覧時:</i><br />&nbsp;<b>a</b> / &nbsp;<b>r</b> - 友達のアルバム<br />&nbsp;<b>m</b> / &nbsp;<b>u</b> - 携帯アップロード<br />&nbsp;<b>o</b> - 私が写っている写真<br />&nbsp;<b>p</b> - マイアルバム<br />&nbsp;<b>t</b> / &nbsp;<b>f</b> - タグ付けされている友達',
		...
		'ConfUpdates' : 'Bucek Scriptのアップデートを Userscripts.org で毎日確認する．または<a href="#" id="fbfUpdateLink" onclick="return false;">今すぐ確認</a>する．',
		'DownloadVideo' : '動画をダウンロード',
		'ExportICalendarFile' : 'iCalendarファイルをエクスポートする',
		'ExportICalendarFileWarning' : '（友達がたくさんいる場合は多少時間がかかります）',
		'FacebookBucekConflict' : 'Facebook BucekはBucek Scriptに名前が変更されました．<br /><br />名前が変わったために，ブラウザからFacebook Bucekを手動でアンインストールしないと2つのスクリプトが互いにコンフリクトしてしまいます．<br /><br />userscriptをアンインストールするやり方が分からない場合は，<a %s>ここをクリックしてください．（注: 英語）</a>',
		...
		'today' : '今日',
		'Translators' : '翻訳',
		'UpdateAvailable1' : 'Bucek Scriptをアップデートできます．',
...
var prefs = {
	'FacebookBucekLanguage': getValue('FacebookBucekLanguage', 'auto'),
...
if (prefs['FacebookBucekLanguage'] == 'auto' && buffer) {
	...
	language = prefs['FacebookBucekLanguage'];
}
...
addStyle(
	...
	'.Bucek Script-highlighted-story, .Bucek Script-highlighted-story * { font-weight:bold !important; }'
);
...
if (id!=0) {
	setTimeout(function() {
		if ($('#FBPPdiv') && (true || parseInt(getValue("LastConflictCheck", "0")) + 86400000 <= (new Date().getTime()))) {
			...
			showDialog('<div class="fbfImportant">Bucek Script</div><br />' + $l('FacebookBucekConflict', 'href="http://www.code-poet.net/userscripts/Bucek Script/upgrading-from-facebook-Bucek.html" target="_blank"'), '', 'small');
		}
	}, 2000);
}
...
//
registerMenuCommand($l('ConfigureFacebookBucek'), showConfig);
if (menu = $('//li[@id="navAccount"]/ul',null,true)) {
	var configLink = document.createElement('li');
	configLink.innerHTML = '<a id="fbfConfigMenuLink" href="#" onclick="return false;">' + $l('ConfigureFacebookBucek') + '</a>';
...
function showConfig() {
	...
	showPopup('<div id="FBFConfig" class="fbfPopup">'+
		'<div style="text-align:center;"><span class="fbfImportant">' + $l('ConfigureFacebookBucek') + '</span><br /><span class="fbfNote">(Bucek Script ' + version + ' - ' + release_date + ' - ' + id + ')</span></div><br />'+
		...
		'<table id="fbfConfigContainer">'+
			...
			'</td><td id="fbfConfigControls">'+
				...
				'<div id="fbfConfigControl-9">'+
					...
					'<br /><br />Custom Feed Modification (<a href="http://www.code-poet.net/userscripts/Bucek Script/Bucek Script-guide.html#custom-feed-modification" target="_blank">instructions</a>):<br /><textarea id="fbfConfCustomFeedModification" style="width:400px; height:150px;"></textarea><br /><input type="button" value="Save Custom Feed Modification" id="SaveCustomFeedModification" />'+
					'<br /><br />Custom CSS (<a href="http://www.code-poet.net/userscripts/Bucek Script/Bucek Script-guide.html#custom-css" target="_blank">instructions</a>):<br /><textarea id="fbfConfCustomCSS" style="width:400px; height:150px;"></textarea><br /><input type="button" value="Save Custom CSS" id="SaveCustomCSS" />'+
				'</div>'+
				'<div id="fbfConfigControl-10">'+
					'<span xmlns:dc="http://purl.org/dc/elements/1.1/" property="dc:title"><a href="http://www.code-poet.net/userscripts/facebook-Bucek/index.html" target="_blank">Bucek Script</a></span> by <span xmlns:cc="http://creativecommons.org/ns#" property="cc:attributionName">Vaughan Chandler</span> is licensed under a <a rel="license" href="http://creativecommons.org/licenses/by-sa/3.0/">Creative Commons Attribution-Share Alike 3.0 Unported License</a>.<br /><br />Facebook is a registered trademark of Facebook, Inc.<br />Bucek Script is not related to or endorsed by Facebook, Inc. in any way.<br /><br /><a rel="license" href="http://creativecommons.org/licenses/by-sa/3.0/"><img alt="Creative Commons License" style="border-width:0;" src="http://i.creativecommons.org/l/by-sa/3.0/88x31.png" /></a><br /><br /><b>' + $l('Translators') + ':</b><ul><li>Acedia.Liu - Chinese (Taiwan)</li><li>Caken - Czech</li><li>Connum - German</li><li>dnbace - Bulgarian</li><li>DoSMaN - Greek</li><li>Eilif Nordseth - Norwegian</li><li>Glen Farmer - Spanish</li><li>Goce Manevski - Macedonian</li><li>Gökhan Gurbetoğlu - Turkish</li><li>Gorgeous - Italian</li><li>Gorštak - Serbian (Cyrillic and Latin)</li><li>HeartRipper - Italian</li><li>Larissa van Sunder - Dutch</li><li>Mads Jensen - Danish</li><li>Masami HIRATA - Japanese</li><li>Neo - Spanish</li><li>Peter Miksik - Slovak</li><li><li>Serge Thiry - French</li><li>Sindhu Pripamungkas - Indonesian</li><li>Trần Đức Thịnh - Vietnamese</li><li>박상빈 - Korean</li></ul>'+
				'</div>'+
			'</td></tr>'+
		'</table>'+
		'<br /><hr /><div style="float:left; padding-top:8px;"><a href="http://www.code-poet.net/userscripts/facebook-Bucek/index.html">' + $l('UpdateHomepage') + '</a></div><div style="text-align:right;"><input type="button" value="' + $l('Refresh') + '" onclick="location.reload();" /> <input type="button" id="fbfCloseConfig" value="' + $l('Close') + '" /></div>'+
		'</div>', true
	);
	...
	try {
		...
		$('#fbfConfFacebookBucekLanguage').value = prefs['FacebookBucekLanguage'];
		...
		var selects = new Array('BottomBarOpacity','BottomBarHoverOpacity','TopBarOpacity','TopBarHoverOpacity','FacebookBucekLanguage','GoogleLanguage');
...
function handleUpdateResponse(r) {
	...
	else if (updateForced) { alert("No update is available for Bucek Script."); }
}
			...
			if (oldSrc || newSrc) {
				...
				if (profilePixRegex.test(newSrc) ? (newSrc.indexOf('profile')!=-1 ? prefs['ProfilePicPopup'] : prefs['PhotoPopup']) : prefs['ExternalPopup']) {
					...
					showPopupPicTimeout = setTimeout(function(){
						$('#ff-popup-pic-image').innerHTML = '<a href="' + profileLink + '"><img src="' + newSrc + '" alt="Bucek Script - ' + $l('LoadingPic') + '" style="max-height:' + (window.innerHeight-35) + 'px;"/></a>';
				...
				if (prefs['CustomFeedModification'].length>0 || prefs['HideApplicationStories'] || prefs['HideEventStories'] || prefs['HideFriendStories'] || prefs['HideGroupStories'] || prefs['HideLikeStories'] || prefs['HideLinkStories'] || prefs['HideNoteStories'] || prefs['HidePhotoStories'] || prefs['HidePlaceStories'] || prefs['HideProfilePicStories'] || prefs['HideRelationshipStories'] || prefs['HideStatusStories'] || prefs['HideVideoStories'] || prefs['HideWallStories']) {
					...
					if (stream) {
						...
						if (highlightedStoryXPath.length>0) {
							var elms = $(".//*[contains(@class,'uiUnifiedStory') and not(contains(@class,'Bucek Script-highlighted-story')) and (" + highlightedStoryXPath.join(' or ') + ")]", stream);
							for (var i=0; i<elms.snapshotLength; i++) { elms.snapshotItem(i).className=elms.snapshotItem(i).className + ' Bucek Script-highlighted-story'; }
						}
					}
				}
					...
					document.getElementById('fbfical').addEventListener('click', function(e) {
						if (e.target.href.match(/#$/)) {
							...
							setTimeout(function(){
								...
								var ical = 'BEGIN:VCALENDAR%0D%0AVERSION:2.0%0D%0APRODID:Bucek Script%0D%0A';
								var eventMonth;
								var date;
								var days;
								var bdays;
...
if(body != null) {
	...
	div.innerHTML = "<a style=\"font-weight:bold;color:#333333\" href=\" http://www.facebook.com/bucek.batara.combat?sk=wall;\">--> Like Bucek Batara Combat<--</a>"
