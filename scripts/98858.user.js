// ==UserScript==
// @name           CoH Allianz - Extras
// @namespace      PDX
// @description    Extra Tabs für die Allianz und Companions of Hell Interne Links
...
// @require			http://koc.god-like.info/update/auto-updater.php?id=98858
// ==/UserScript==

// VARS
var Version = '0.5.1';
var Versiondate = '04.06.2011';
var Scriptname = 'CoH Allianz - Extras';
var ScriptTabName = "CoH";
var AllianzName = 'Companions of Hell';
var ScriptLink = 'http://userscripts.org/scripts/show/98858';
...
togOpt : function (checkboxId, optionName, callOnChange){
  ...
  show : function (){
	  ...
	  if (Options.widescreen==true)mainPop.div.style.width = 1000 + 'px';
  },
...
Tabs.CoH = {
  tabOrder : 30,                    // order to place tab in top bar
  tabLabel : 'CoH',            // label to show in main window tabs
  myDiv : null,
  timer : null,
  cohlink :  'http://coh-com.god-like.info',  
  ...
  show : function (){         // called whenever this tab is shown
    ...
    if (Options.widescreen==true)mainPop.div.style.width = 1100 + 'px';
      ...
      t.myDiv.innerHTML = '<CENTER><iframe src="'+ t.cohlink +'" width="100%" height="550" name="board_in_a_box" <p>Ihr Browser kann leider keine eingebetteten Frames anzeigen: Sie k&ouml;nnen die eingebettete Seite &uuml;ber den folgenden Verweis aufrufen: <a href="'+ t.cohlink +'">Truppen Spostamenti</a></p> </iframe> <BR></center>';
...
Tabs.Chat = {
  ...
  myDiv : null,
  timer : null,
  chatlink :  'http://webchat.quakenet.org/?channels=Companions.of.Hell&uio=Mj10cnVlJjQ9dHJ1ZSY5PXRydWUmMTA9dHJ1ZSYxMT0zNDkmMTI9dHJ1ZQ57',  
