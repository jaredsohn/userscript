// ==UserScript==
// @name           	BBCode-Edit Pennergame *edit by Chat*
// @namespace      	11235813 *edit by Chat*
...
//==========================================================//
//
// @version			smileys BBcode by Chat
// @version        smileys BBcode by Chat
...
editor.addSmilie('http://www.vegegifs.com/smiley-emoticon/sautelunettes.gif');
...
editor.addSmilie('http://a69.g.akamai.net/n/69/10688/v1/img5.allocine.fr/acmedia/image/icone/communaute/icon17.gif');
editor.addSmilie('http://a69.g.akamai.net/n/69/10688/v1/img5.allocine.fr/acmedia/image/icone/communaute/icon36.gif');
editor.addSmilie('http://a69.g.akamai.net/n/69/10688/v1/img5.allocine.fr/acmedia/image/icone/communaute/icon47.gif');
editor.addSmilie('http://a69.g.akamai.net/n/69/10688/v1/img5.allocine.fr/acmedia/image/icone/communaute/icon29.gif');
editor.addSmilie('http://a69.g.akamai.net/n/69/10688/v1/img5.allocine.fr/acmedia/image/icone/communaute/icon32.gif');
editor.addSmilie('http://a69.g.akamai.net/n/69/10688/v1/img5.allocine.fr/acmedia/image/icone/communaute/icon16.gif');
editor.addSmilie('http://a69.g.akamai.net/n/69/10688/v1/img5.allocine.fr/acmedia/image/icone/communaute/icon48.gif');
editor.addSmilie('http://a69.g.akamai.net/n/69/10688/v1/img5.allocine.fr/acmedia/image/icone/communaute/icon53.gif');
editor.addSmilie('http://a69.g.akamai.net/n/69/10688/v1/img5.allocine.fr/acmedia/image/icone/communaute/icon45.gif');
editor.addSmilie('http://a69.g.akamai.net/n/69/10688/v1/img5.allocine.fr/acmedia/image/icone/communaute/icon33.gif');
editor.addSmilie('http://a69.g.akamai.net/n/69/10688/v1/img5.allocine.fr/acmedia/image/icone/communaute/icon24.gif');
editor.addSmilie('http://a69.g.akamai.net/n/69/10688/v1/img5.allocine.fr/acmedia/image/icone/communaute/icon40.gif');
editor.addSmilie('http://www.greensmilies.com/smile/smiley_emoticons_fies.gif');
editor.addSmilie('http://www.greensmilies.com/smile/smiley_emoticons_kilroy_sofa.gif');
...
editor.addSmilie('http://www.greensmilies.com/wp-includes/images/smilies/smiley_emoticons_shocked.gif');
editor.addSmilie('http://www.greensmilies.com/wp-includes/images/smilies/smiley_emoticons_doh.gif');
editor.addSmilie('http://www.greensmilies.com/wp-includes/images/smilies/smiley_emoticons_motz.gif');
editor.addSmilie('http://www.greensmilies.com/wp-includes/images/smilies/smiley_emoticons_seb_zunge.gif');
editor.addSmilie('http://www.planete-smiley.com/images/Communiquer/communiquer.27.gif');
editor.addSmilie('http://www.planete-smiley.com/images/Communiquer/communiquer.25.gif');
editor.addSmilie('http://www.planete-smiley.com/images/Communiquer/communiquer.53.gif');
editor.addSmilie('http://www.planete-smiley.com/images/Communiquer/communiquer.64.gif');
editor.addSmilie('http://www.planete-smiley.com/images/Communiquer/communiquer.74.gif');
editor.addSmilie('http://www.planete-smiley.com/images/Communiquer/communiquer.70.gif');
editor.addSmilie('http://www.planete-smiley.com/images/Communiquer/communiquer.50.gif');
editor.addSmilie('http://www.planete-smiley.com/images/Cartoon/cartoon.29.gif');
editor.addSmilie('http://www.planete-smiley.com/images/Vacance/vacance.4.gif');
editor.addSmilie('http://www.planete-smiley.com/images/Violence/violence.67.gif');
editor.addSmilie('http://smileys.surlatoile.org/repository/Triste/larmes-aux-yeux-524.gif');
editor.addSmilie('http://smileys.surlatoile.org/repository/Musique/joue-du-violon2.gif');
editor.addSmilie('http://smileys.surlatoile.org/repository/Anges_et_d%E9mons/0106.gif');
editor.addSmilie('http://smileys.surlatoile.org/repository/Messages/pancarte-chuis-cache.gif');
editor.addSmilie('http://smileys.surlatoile.org/repository/Animaux/hippo-baille-94212.gif');
editor.addSmilie('http://smileys.surlatoile.org/repository/Animaux/grenouille-saute.gif');
editor.addSmilie('http://smileys.surlatoile.org/repository/Chiens_et_chats/minisalem1.gif');
editor.addSmilie('http://smileys.surlatoile.org/repository/Films_et_TV/mickey-mouse.gif');
editor.addSmilie('http://smileys.surlatoile.org/repository/Boulet/boulet-repere.gif');
editor.addSmilie('http://www.maniak-gt-jaket.com/gif_animee/gif_animee_43.gif');
editor.addSmilie('http://img801.imageshack.us/img801/2810/tsrfi96b864.gif');
editor.addSmilie('http://www.vegegifs.com/smiley-emoticon/fouetter.gif');
