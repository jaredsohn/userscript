...
text = ["Los Geht´s!","Unmöglicher Angriffstyp!","Keine Koordinaten!","Nicht genügend Truppen! (Truppen #","Keine Truppen Eingestellt","Start","Evtl. Falsche Koordinaten","Keine Späher","Erledigt","Wellen Einstellungen:","Neue Welle","Löschen","Angriffseinstellungen:","Angriffstyp:","Normal","Unterstützung","Raubzug","Spähen Ress./Truppen","Spähen Vert.Anlagen/Truppen","Koordinaten","Los Geht´s!","Ankunftszeit","Ankommen um:","Ankunft Festlegen","Wellenanzahl","weitere koordinaten durch '|' trennen zB: 50,43|12,99","FEHLER:","Aktuelles Dorf nicht Möglich. Assuming one village account","Festgelegte Ankunftszeit um:"];

cataText = ["Ziel? =)","-Zufall-","Holzfäller","Lehmgrube","Eisenmine","Getreidefarm","Sägewerk","Lehmbrennerei","Eisenschmelze","Getreidemühle","Bäckerei","Rohstofflager","Kornspeicher","Rüstungsschmied","Waffenschmied","Turnierplatz","Hauptgebäude","Versammlungsplatz","Marktplatz","Botschaft","Kaserne","Stall","Werkstatt","Akademie","Rathaus","Residenz","Palast","Handelskontor","Große Kaserne","Großer Stall","Heldenhof","Großes Rohstofflager","Großer Kornspeicher","Weltwunder"]; 
break;
