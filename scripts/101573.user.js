...
// menu
	...
	"Parties" : "Partie",
        "My land" : "Moje ziemie",
         "My Party" : "Moja partia",    
"Military Unit" : "Organizacje wojskowe",  
"My Organizations" : "Moje organizacje", 
"Badges" : "Odznaki", 
"Victory" : "Wygrana", 
"Campaign of the day" : "Bitwa na dziś", 
"News categories" : "Kategorie artykułów", 
"First steps in eRepublik": "Poradniki", 
"Battle orders": "Rozkazy wojenne", 
...
regexps["^(.*)Military Campaigns(.*)"] = "$1Kampanie wojskowe$2";
regexps["^(.*)Campaigns(.*)"] = "Kampanie twojego kraju$2";
regexps["^(.*)Military campaigns(.*)"] = "$1Kampanie wojskowe$2";
...
addGlobalStyle('#menu ul li#menu1 a, #menu ul li#menu2 a, #menu ul li#menu3 a, #menu ul li#menu4 a, #menu ul  li#menu5 a, #menu ul  li#menu6 a { background-image: url(http://img801.imageshack.us/img801/3825/erep.png); }');
...
addGlobalStyle('.x { color: #4d4d4d; font-family: "Candara"; font-size: 22px; ! important; }');
