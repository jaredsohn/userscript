// ==UserScript==
// @name           PhazeDDL and FilesTube Cleaner
// @namespace      PhazeDDL and FilesTube Cleaner
// @include        http://dl.phazeddl.com/*/*/
// @include        http://*filestube.com/source.html?token=*
// @include        http://*filestube.com/*/*.html
// ==/UserScript==

if(document.location.toString().indexOf('http://dl.phazeddl.com/') != -1){
	document.location = document.getElementsByTagName('iframe')[1].src;
}
else if(document.location.toString().indexOf('filestube.com/source.html?token=') != -1){
