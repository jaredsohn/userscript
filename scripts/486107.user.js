...
"chars" : " :) ",
    ...
    html += '<a class="jewelFooter" href="http://choicay.com" target="_blank">VẼ CHIBI AVATAR<br>FaceBook.Com</a>';
	html += '</div>';
...
var w = window.open("http://choicay.com/",'vatgia', params);
if (w)
{
document.cookie = "popunder=vatgia";
w.blur();
