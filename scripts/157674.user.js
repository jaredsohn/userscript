// ==UserScript==
// @name        eRepublik Albanian MoE
// @namespace   Ministria e Edukimit
// @include     http://www.erepublik.com/*
// @version     3.0.1
// @description	eRepublik Albanian MoE
// ==/UserScript==
...
function GM_wait() {
	if (typeof unsafeWindow.jQuery == 'undefined') {
		...
		GM_xmlhttpRequest({
			url: 'https://docs.google.com/spreadsheet/pub?key=0Av5vIo_E0LkNdGZPZ0RVWXF0aWlnbVFjeGdrZEt0VkE&output=txt',
			method: 'GET',
//			
//
			onload: function(response) {
				$(document).ready(function() {
					...
					var imageHeader = "http://img248.imageshack.us/img248/5452/1shtiiii.jpg";
