...
GM_addStyle('#advisors #advCities a.normal { background-image:url('+URL+'07991769116673618504.gif); }');
GM_addStyle('#advisors #advCities a.normalactive { background-image:url('+URL+'97426948000392565848.gif); }');

GM_addStyle('#advisors #advMilitary a.normal { background-image:url('+URL+'75168361564884820845.gif); }');-
...
GM_addStyle('#advisors #advDiplomacy a.normal { background-image:url('+URL+'75006504243799109374.gif);	}');
GM_addStyle('#advisors #advDiplomacy a.normalactive { background-image:url('+URL+'66187802118193065008.gif);	}');

GM_addStyle('#advisors #advResearch a.normal { background-image:url('+URL+'05826794195606379480.gif); }');
