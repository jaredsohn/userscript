  ...
  if (!e.altKey && !e.shiftKey) {
	if (isNaN(key)) {
      switch (String.fromCharCode(e.keyCode)) {
        ...
        case 'T': return location.href = getBuildingUrl("townHall");
        case 'P': return location.href = getBuildingUrl("port");
        case 'S': return location.href = getBuildingUrl("shipyard");
        case 'E': return location.href = getBuildingUrl("safehouse");
        ...
        case 'L': return location.href = getBuildingUrl("palaceColony");
        case 'K': return location.href = getBuildingUrl("warehouse");
      }
    } else {
	  var n = (key || 14) - 1;
	  var id = cityIDs()[n];
