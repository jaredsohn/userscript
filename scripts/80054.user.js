// ==UserScript==
// @name          Ikariam Hızlı İletişim
// @version       1.0
// @copyright     2009, Yoshi Toranaga
// @license       GPLv3+ (http://www.gnu.org/copyleft/gpl.html)
// @namespace     Ikariam/QuickLinks
// @description   Hızlı İletişim Menüsü (ikariam.forumm.biz)
...
iql.SettingWindow = function() {
	...
	$('body').append( $(
		'<div id="iqlSettingContainer"><div id="iqlSetting">' +
			'<h3>Ikariam Hızlı İletişim </h3>' +
			'<h3>www.ikariam.forumm.biz </h3>' +
			'<div><table cellpadding="0" cellspacing="0"><tbody>' +
				'<tr><th>Site İsmi</th><td colspan="3"><input id="iqlSetTitle" type="textfield" class="textfield" name="iqlSetTitle" size="28" /></td></tr>' +
				'<tr><th>Adres</th><td colspan="3"><input id="iqlSetURL" type="textfield" class="textfield" name="iqlSetURL" size="28" /></td></tr>' +
				'<tr><th>Resim</th>' +
			    ...
			    '</tr>' +
				'<tr><th>Farklı Sayfada Aç</th><td colspan="3" align="left"><input id="iqlSetExt" type="checkbox" class="checkbox" name="iqlSetExt" /></td></tr>' +
				'<tr><th colspan="4"><div class="padded"><div class="goleft"><a href="#" id="iqlButtonCancel" class="button">İptal</a></div><div class="goleft"><a href="#" id="iqlButtonOK" class="button">Tamam</a></div></div></th></tr>' +
...
iql.Renderer.prototype = {
	...
	remove : function(link) {
		if (this.settings.length() == 1) {
			alert("Bu baglantıyı kaldırmaya yetkiniz yok.\nSadece yeni baglantılar ekleyebilirsiniz.");
		} else {
...
$( function() {
	...
	$('body').append($(
			'<div class="contextMenu" id="iqlContextMenu"><ul>' +
				'<li id="new">Link Ekle</li>' +
				'<li id="edit">Linki Düzelt</li>' +
				'<li id="remove">Linki Sil</li>' +
	...
	$('#iqlRenderer .quicklink').contextMenu('iqlContextMenu', {
		bindings: {
	        ...
	        'remove': function(t) {
				if (confirm('Sen bu baglantıyı silmek istediginden emin misin ?')) {
					renderer.remove(t);
				}
	        },
