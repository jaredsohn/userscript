// ==UserScript==
// @name           UserScripts.org Text Formatter Suite 
// @namespace      http://userscripts.org/users/Hamza7
// @description    Add a toolbar above posting area in forums (for topics and replies) in order to facilitate formatting with HTML in UserScripts.org forums equipped with preview feature embedded.
...
UFE.FT.innerHTML="<h1>UserScripts Text Formatter Suite <sub>By Hamza Abbad</sub></h1>";
...
UFE.link.alt=UFE.link.title="Insert a Hyperlink";
...
UFE.image.alt=UFE.image.title="Add an Image";
...
UFE.heading.alt=UFE.heading.title="Insert a heading";
...
UFE.bold.alt=UFE.bold.title="Make bold";
...
UFE.italic.alt=UFE.italic.title="Make italic";
...
UFE.underlined.alt=UFE.underlined.title="Make underlined";
...
UFE.strike.alt=UFE.strike.title="Make strikethrough";
...
UFE.ICode.alt=UFE.ICode.title="Insert inline code";
...
UFE.BCode.alt=UFE.BCode.title="Insert block code";
...
UFE.quote.alt=UFE.quote.title="Insert quote";
...
UFE.LBreak.alt=UFE.LBreak.title="Add new line";
...
UFE.preview.value=UFE.preview.title="Preview";
...
UFE.reset.value=UFE.reset.title="Reset textfield";
