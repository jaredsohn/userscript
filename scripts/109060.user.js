...
(function(){
 ...
 function ProfilLinks() {
	...
	if( !GM_getValue('fce_firstload') || fce_version != GM_getValue('fce_inst_version')) {
		jQuery.facebox('<center><h3>Hello, and thanks for using F-Chatty!</h3><br>' +
				'<h2>Please like the F-Chatty fanpage!!<br><a href="http://www.facebook.com/pages/F-Chatty/214712198577261">Click Here</a>' +
				'F-Chatty is based on Facebook Chat Enchancer. As the developer stopped developing more updates.' +
				'I Will do my best to keep the F-Chatty up to date. As i do this for education purposes to learn more scripting!' +
				'<input type="submit" value="close" class="closefirst"></center>' + 
				'<div style="float: right; text-align: right;">&copy; swipper.org</div>');
