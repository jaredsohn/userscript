// ==UserScript==
// @name           BBCodes para L2soc
// @namespace      KellyBBCODER
// @description    BBCoder L2soc (Crear post, comentarios, menÃº) ATENCION: Si te molesta ser miembro de mi comunidad no instales el script!
// @include        http://*l2soc.com/*
...
var postscript = 'http://l2soc.com/posts/l2soc/4932435/';
...
var Tar = /l2soc/i.test(Dom);
var Tiny = /tinypic.com/i.test(Dom);
var Dom2 = Tar? 'tar':'por';
var nuevosemot = 0;
var txt = $$('body_comm')||$$('body_resp')||$$('markItUp');
var Categorias = new Array(-1,"","Ver Todas",7,"animaciones","Animaciones",18,"apuntes-y-monografias","Apuntes y MonografÃ­as",4,"arte","Arte",
	...
	21,"recetas-y-cocina","Recetas y Cocina",27,"salud-bienestar","Salud y Bienestar",20,"solidaridad","Solidaridad",28,"L2soc","L2soc!",
