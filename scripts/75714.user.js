// ==UserScript==
// @name           国防部战斗指令 Dosd Order
// @namespace      www.erepublik.com
// @description    实时更新每日eC军令
// @version        0.1
...
/*关于军令格式: {1}是起义 {2}协防 {3}攻击{4}叹号 {5}叉子
电子文档保留在 http://docs.google.com/View?id=dc9jxm96_1dbhj9tcj
*/
(function(undefined)
{
    var VERSION = '0.1';

    var url = 'http://docs.google.com/View?id=dc9jxm96_1dbhj9tcj';
    var updateUrl = 'http://userscripts.org/scripts/show/75714';

    /* ---------------------------------- */
    var images = ["images/parts/icon_military_42.gif",
"/images/parts/icon_military_134.gif",
"/images/parts/icon_military_93.gif", 
"/images/parts/info-ico.gif",
"/images/parts/invalid-round.gif"];
    ...
    function parseData(s)
    {
        ...
        try
        {
            ...
            if(ver != VERSION)
            {
                ...
                displayErrFrame("Your script version expired. (Trenutna: "+VERSION+"| aktuelna: "+ver+")", splitLinks("Aktuelizuj|"+uurl));
                return;
            }
            ...
            mon = '<p><a href="'+mon+'">Ministry of SinoDefence Order</a></p>';
        ...
        {
            displayErrFrame("Please contact panbidong#eChina.");
            throw e;
        }
    }
    ...
    function displayFrame(orders, links, additional, date, mon, im)
    {
        ...
        ordersDiv.innerHTML = '\
        <div class="title"><h2 style="font-size: x-large;" id="Ringo"></h2></div>\
        ...
        function genFlash()
        {
            ...
            {
                sIFR.replaceElement(named({sSelector:"#Ringo", sFlashSrc:"/flash/delicious.swf", sColor:"#4c4c4c", sLinkColor:"null", sBgColor:"null", sHoverColor:"null", nPaddingTop:0, nPaddingBottom:0, sFlashVars:"", sWmode:"transparent"}));
            }
        }
    ...
    function loadURL_GM(url, xhr)
    {
        ...
        xhr({
            ...
            {
                displayErrFrame("(GM) Loading error "+response.status+" ("+response.statusText+") Page not available.");
            }
        });
    }
    ...
    function loadURL_XHR(url, xhr)
    {
        ...
        xhr.onreadystatechange = function()
        {
            if(xhr.readyState == 4)
            {
                ...
                {
                    displayErrFrame("Loading error"+xhr.status+" ("+xhr.statusText+") Page not available.");
                }
            }
        };
        xhr.timeout = 15000;
    ...
    try
    {
        ...
        else if(isOp)
        {
            ...
            {
                displayErrFrame("Incorrect installation script. Reinstall the script.");
                return;
            }
    ...
    {
        displayErrFrame("Access without authorization!");
        throw e;
    }
})();