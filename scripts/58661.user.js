...
addGlobalStyle('#main_footnotes{position:absolute !important; top:80px !important; left:-450px !important;}');
...
// twhelp_link.innerHTML (оригинал ссылки на "tw-help.ic.cz", вместо Динабурга)
...
//  publish_duel.innerHTML (оригинал ссылки картинки дуэльной кнопки меню)
...
//inv_val.innerHTM (встроенный чешский калькулятор инвентаря. Не полный. Заменён на инвентарь TheWest++)
...
items[818] = {item_id:818, nshort:'deringer_bellestar', name:'Дерринджер Бель Старр', type:'right_arm', level:45, price:5500, image:'images/items/right_arm/deringer_bellestar.png', image_mini:'images/items/right_arm/mini/deringer_bellestar.png', characterClass:null, characterSex:null, speed:null, bonus:{skills:{hide:4, reflex:5}, attributes:{}}, set:{key:null, name:null}, shop:'quest'};\
...
// @description    Localization fo Russian: Evgenatrix & Storan
// @include        http://*.the-west.*/game.php*
// ==/UserScript==
// 
(function(){
	...
	function convertDuelReport(div) {
		...
		ttt = outcome.indexOf('away without');
		if (ttt===-1)
			ttt = outcome.indexOf('points and steals') + 7;
