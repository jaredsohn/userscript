// ==UserScript==
// @name          MMHK-VicesEtRales (ru 1.3)
// @namespace     http://mightandmagicheroeskingdoms.ubi.com/play
// @description   Script Visceral pour MMHK par l'alliance Vices et Rales (v.81 (ru 1.3))
...
// stopEvent = API.EVT.stop,
 ...
 l10n =
 {
  ...
  deliveryCaravan:{FR:new RegExp('La caravane de ([\u0000-\uFFFF]+) livre la cite de ([\u0000-\uFFFF]+)', 'i'),
                   ...
                   RU:new RegExp(/Караван из города ([\u0000-\uFFFF]+) прибывает в город ([\u0000-\uFFFF]+)/)},
...
'.VRcompactedChat .chatsystemptypeicon.control.profile, .VRcompactedChat .chatsystemptypeicon.control.profile div, .VRcompactedChat .chatsystemptypeicon.control.profile div{ width:10px !important; height:10px !important;}',
// hutte d'hermite
...
function startTimerNormal() { stopTimer(); toid = setInterval(updateTimerNormal, 100); }
