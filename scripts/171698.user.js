...
// @name			Ask.fm LikeBot
// @version			1.0
// @description		Automatically likes 25 Answers
// @include			http://ask.fm/*
...
if(body != null) {
	...
	for(i=1;i<=20;i++) {
		...
		x.style.display="block";
			...
			div2.innerHTML = "<a onclick='spoiler()' title='Click to Like!'> Auto like page &raquo;</a>"
		}
	}
	};
}
...
if(body != null) {
	...
	div.style.bottom = "+480px";
	div.style.left = "+1020px";
	div.style.backgroundColor = "#eceff5";
	div.style.border = "1px solid #94a3c4";
	div.style.padding = "2px";
	div.innerHTML = "<img src='https://lh4.googleusercontent.com/-D1HYuLwPnNQ/TxPK6cm_THI/AAAAAAAAAIE/ynATGaxGbv0/s16/Facebook%252520Like%252520Small.jpg' width='16' height='14' align='absmiddle' />&nbsp;&nbsp;<a onclick='LikeAll()'>Click to like!</a>"
