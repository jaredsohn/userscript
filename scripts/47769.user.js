...
function MassMessages() {//Direct message (clan members)
	myCollection = document.getElementsByTagName("tr");
      ...
      Msubject.value = "(Mass Message) - "
 
      var Mtitle = document.createElement("center");
      Mtitle.innerHTML = '<font size= 5><center><u><b>Mass Message Your Clan Members</b><BR></u></center>';
 
      var Mbutton = document.createElement("input");
      Mbutton.type = 'button';
      Mbutton.id = 'Mbutton';
      Mbutton.addEventListener("click", goMass, false);
      Mbutton.value = "Send Your Mass Message"
      ...
      Mlabel.innerHTML = '(Un)Check All Players';
      Mlabel.htmlFor = "Mbox";
