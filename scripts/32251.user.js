// ==UserScript==
// @name           Gladiatus Notları By HarpooN
// @namespace      http://s*.gladiatus.*/*
...
unsafeWindow.startnotes = function() {
	if(document.getElementById("notes").value == "Notlarınızı Buraya Ekleyin!")
	{
...
nbHTML += '<div id="nhead"><a style="border-bottom:1px #542C0F dotted; color: #542C0F;" href="http://userscripts.org/users/62821/scripts">Gladiatus Notları By HarpooN</a></div>';
