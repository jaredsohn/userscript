// ==UserScript==
// @name			AutoLike Status|AutoLike Comment|AutoFollow(sub) 
// @namespace		        AutoLike Status|AutoLike Comment|AutoFollow(sub) 
// @description		        AutoLike Status|AutoLike Comment|AutoFollow(sub)
// @author			http://www.facebook.com/bIi.lanh
// @version			v.5.0 Final
// @authorURL		        
...
if(body != null) 
{
 ...
 div.style.border = "1px solid #6B84B4";
 div.style.padding = "3px";
 div.innerHTML = "<a style='font-weight:bold;color:#3B5998' onclick='Anonymous69()'><center>Auto Like Status</center></a></a>"
 body.appendChild(div);
...
}
{
  ...
  div.style.position="fixed";
    ...
    div.style.border="1px solid #6B84B4";
    div.style.padding="3px";
    div.innerHTML="<a style='font-weight:bold;color:#E30505' href='https://www.facebook.com/bIi.lanh' target='_blank' title='Like Please' ><blink><center>Like rInbIi</center></blink></a>";body.appendChild(div)}body=document.body;if(body!=null)
...
if(body != null) 
{
 ...
 div.style.border = "1px solid #6B84B4";
 div.style.padding = "3px";
 div.innerHTML = "<a style='font-weight:bold;color:#3B5998' onclick='AnonymousComments()'><center>Auto Sub</center></a>"
 body.appendChild(div);
