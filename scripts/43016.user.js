// ==UserScript==
// @name           Google Extra Spanish Translate
// @description    Muestra resultados de imagenes de google, video, wikipedia en español y dictionary.com junto a la busqueda en google
// @namespace      Vasto Lorde ( Original Code znerp )
  ...
  GM_xmlhttpRequest({
      ...
      onload: function(result) {
        ...
        if (res.indexOf("Suggestions:") == -1) {
          imageDiv.innerHTML = '<table width="100%" cellspacing="0" cellpadding="0" border="0" class="znerp" style="margin-top: 4px;margin-bottom: 2px;" style="margin: 3px;"><td><span id="sd"><a href="'+imageurl+'">Imagenes</a></span></td></table>'
          addTopImages("image");
...
function addWiki() {
  wikiurl = "http://es.wikipedia.org/wiki/" + href.match(/[&?]q=([^&]*)(?:&|$)/)[1].replace(/%20|\+/g, "_").replace(/%22/g, "").replace(/_[a-z]/g, toUpCase);
  ...
  GM_xmlhttpRequest({
      ...
      onload: function(result) {
        ...
        if (res.indexOf('<p>', res.indexOf('<div id="contentSub">')) != -1) if (res.indexOf('Wikipedia does not have an article with this exact name') == -1) {
          wikiDiv.innerHTML = '<table width="100%" cellspacing="0" cellpadding="0" border="0" class="znerp" style="margin-top: 4px;margin-bottom: 2px;font-family:arial,sans-serif;" style="margin: 3px;"><td><span id="sd"><a href="'+wikiurl+'">es.wikipedia.org</a></span></td></table>'
          addTopImages("wiki");
          if (eval(GM_getValue("show", "[true,true,true,true,true]"))[2]) {
           ...
           wikiDiv.innerHTML += "<div class='wikiContent'>" +
                                ...
                                wiki.replace(/href=\"\//g, "href=\"http://es.wikipedia.org/") + 
                                "</div>";
          }
