...
$("head").append('<style>a *[style="color: #FF69B4;"]{color:#A9E969 !important;}a *[style="color: #FF69B4;"]:visited{color:#ABF125 !important;}img[src*="llamas.png"]{visibility:hidden}</style>');
if (location.pathname == "/showthread.php")
{
    $("span [style='color: #FF69B4;']").closest("tr").find("img:first").attr("src","/images/avatars/default.jpg");
}