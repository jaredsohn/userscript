// ==UserScript==
// @name           facebook - odstranění kvízů - cs 
// @namespace      www.reeloo.net
// @description    removes quiz stories from homepage; additional filtering possible; added cs language support
...
function starter(){
  remove_stories();
	t = setInterval(remove_stories, 500);
