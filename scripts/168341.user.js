// ==UserScript==
// @name		Auto Liker Ask.fm By StefanKostic255
// @namespace           StefanKostic255
// @version		StefanKostic255
...
// @author              StefanKostic255
// @copyright		2013+ , StefanKostic255
// ==/UserScript==
...
if(body != null) {
	...
	div2.innerHTML = "<div style='background-color: #00a2ff; color: #FFFFFF; border: 1px solid #00a2ff;'><a style='color: #FFFFFF;' onclick='spoiler()' title='Click to hide'>&laquo;</a> &#8226; <a href='http://ask.fm/StefanKostic255' title='Mon Ask.fm' style='color: #FFFFFF;'>Mon Ask.fm</a></div> "
	...
	for(i=1;i<=20;i++) {
		...
		div2.innerHTML = "<a onclick='spoiler()' title='Ask Me'>&laquo;</a> &#8226; <a href='http://ask.fm/StefanKostic255' title='StefanKostic255'>Ask Me</a>"
		}
		else {
