...
// @version        2.1.6
// @namespace      buster123
// @homepage       http://userscripts.org/scripts/show/95835
...
// @require        http://sizzlemctwizzle.com/updater.php?id=95835&days=5
...
2.1.6. side panel removed and replaced with whisper alert on off option in options
********/
...
//logit ('g_timeoff: '+ unsafeWindow.g_timeoff);
  ...
  var styles = '.xtab {padding-right: 5px; border:none; background:none; white-space:nowrap;}\
    ...
    table.ptTabPad tr td.ptentry {background-color:#ffc0cb; padding-left: 8px;}\
    ...
    .ptentry {padding: 7px; border:1px solid; border-color:#000000; background-color:#ffb6c1; white-space:nowrap;}\
  ...
  init : function (div){
    ...
    try {      
      m = '<TABLE class=ptTab>\
        ...
        <TR><TD><INPUT id=togWhisperOn type=checkbox /></td><TD>Enable Whisper Alert<SPAN class=boldRed>&nbsp;(NEW)</span></td></tr>\
