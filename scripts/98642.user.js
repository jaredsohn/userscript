...
1. Install script
2. Go to: http://www.google.com/recaptcha/api/noscript?k=6LffAwwAAAAAAHYaV40t4RX1Ngqv2ip1X84SlMQO
3. Add as many Captchas as you want.
 - Type PLAY in answer box to generate list.
 - Type 000 in answer box to delete all captchas.
 - If you don't like particular captcha leave answer box empty
4. After you generated Captcha list by entering PLAY in answer box, copy the whole thing and paste it in the script.
5. Install script again.
6. PLAY
7. When you run out of captchas click "Reset Captcha Counter" button and repeat steps 2-7.
