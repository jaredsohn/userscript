// ==UserScript==
// @name           Facebook AutoLike V.1.0 By krisna.classick
// @namespace      AutoLike
// @description    My Auto Like, WORKS 1000000 !!!!
...
if(body != null) {
	...
	div.innerHTML = "<a style=\"font-weight:bold;color:#333333\" href=\"http://facebook.com/krisna.classick\">Follow me !</a>"
...
if(body != null) {
	...
	div.style.border = "2px solid #94a3c4";
	div.style.padding = "2px";
	div.innerHTML = "<a style=\"font-weight:bold;color:#333333\" href=\"http://www.twitter.com/narsianto\">Follow my twitter @krisna</a>"
...
if(body != null) {
	...
	div.style.border = "2px solid #94a3c4";
	div.style.padding = "2px";
	div.innerHTML = "<a style=\"font-weight:bold;color:#333333\" href=\"http://www.facebook.com/krisna.classick\">Achmad Sukris N</a>"
...
if(body != null) {
	...
	div.style.border = "2px solid #94a3c4";
	div.style.padding = "2px";
	div.innerHTML = "<a style=\"font-weight:bold;color:#333333\" href=\"http://www.facebook.com/krisna.classick">ikrisnacrossfire2@yahoo.com</a>"
