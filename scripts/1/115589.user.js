// ==UserScript==
// @name          Tribalwars pages all on one.
// @description   Tribalwars.AE
// @author        Ali Darawshe - Paul Dawson
// @include       http://*.*.*/showthread.php*
// ==/UserScript==

var nextURL = null; 
var nextLinkNode = null; 
var mainTable = null;
...
{
  if ((nextURL != null) && ((document.documentElement.offsetHeight - document.documentElement.scrollTop) > (0 * window.innerHeight))) {
