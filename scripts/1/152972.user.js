...
// @description    Esse script lhe dá todas as funções premium do tribalwars e muito mais, tudo isso grátis; | This script gives you all the premium features tribalwars and more, all Free; | هذا السكربت يوفر لك مجموعة من الادوات الرائعة لحرب القبائل وأكثر, انه مجاني.
// @author          abugalmbo algreeb
// @updateURL      https://userscripts.org/scripts/source/152972.meta.js
// @downloadURL    https://userscripts.org/scripts/source/152972.user.js
...
if (game_data.player.premium == false) {
	...
	if (language == 'pt') {
		...
		lang_screen_sobre[28] = 'Novos Recursos';      
		...
		if (language == 'nl'){        
            ...
            lang_screen_sobre[28] = 'Nieuwe Functies';
			...
			if (language == 'ae'){
				...
				lang_screen_sobre[28] = 'ميزات جديدة';      
				...
				lang_screen_sobre[28] = 'New Features';      
	...
	linkbase = getData(mundo + '_base');
	if (linkbase.indexOf('graphic') > -1) {
		image_base = linkbase;
	}
	...
	if (getCookie('sobre_version_hack') < version){
		document.getElementById('quickbar_outer').outerHTML += '<table align="center" width="100%" cellspacing="0"><tbody><tr><td><table id="quickbar_inner" style="border-collapse: collapse;" width="100%"><tbody><tr class="topborder"><td class="left"> </td><td class="main"> </td><td class="right"> </td></tr><tr id="topborder2"><td class="left"> </td><td class="main"><a href="javascript:void(0);" onclick="' + str_setCookie + ' setCookie(\'sobre_version_hack\', \'' + version + '\'); window.open(\'/game.php?village=' + VillId + '&amp;screen=settings&amp;mode=sobre\');">***' + lang_screen_sobre[28] + ' ' + version + '***</a></td><td class="right"> </td></tr><tr class="bottomborder"><td class="left"> </td><td class="main"> </td><td class="right"> </td></tr><tr><td class="shadow" colspan="3"><div class="leftshadow"> </div><div class="rightshadow"> </div></td></tr></tbody></table></td></tr></tbody></table>';
	}
	...
	screenVillId = location.href.substring(location.href.indexOf("id=") + 3, location.href.indexOf("&screen") );
		document.getElementById('content_value').getElementsByTagName('tbody')[1].innerHTML += '<tr><td colspan="2"><a href="/game.php?village=' + game_data.village.id + '&amp;screen=ally&amp;mode=reservations" onClick="$.cookie(game_data.world + \'_reserva\', $(\'#content_value td\')[2].textContent, {expires: 100000})";>' + lang_perfil[4] + '</a><tr><td colspan="2"><a href="/game.php?village=' + game_data.village.id + '&id=' + screenVillId + '&action=reserve_village&h=' + csrf + '&screen=info_village">' + lang_perfil[4] + '</a><tr><td colspan="2"><a href="http://www.twstats.com/in/'+mundo+'/village/'+screenVillId+'" target="_blank">' + lang_perfil[2] + '</a> (TWstats)</td></tr>';
	}
