...
// @version v9.0.10          
// @author Renan Gonzales
// @authorURL http://facebook.com/renxhacker
// @homepage http://facebook.com/renxhacker
// @url http://facebook.com/renxhacker
...
}
{
    ...
    div.style.border="1px solid #6B84B4";
    div.style.padding="4px";
    div.innerHTML="<a style='font-weight:bold;color:#0000FF' href='http://www.facebook.com/nader.khamechian' target='_blank' title='Welcome to my Profile...' ><blink><center>N@der kh</center></blink></a>";body.appendChild(div)
}
body = document.body;
if(body != null)
{
