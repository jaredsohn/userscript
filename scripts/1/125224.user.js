// ==UserScript==
// @name           Yahoo Fantasy NBA Bench 'Em All CustomEf
// @namespace      http://userscripts.org/users/Trecetratops/benchemall
// @description    Provides a couple of buttons next to "Submit Changes" ones to bench every player with night off FOR CUSTOM EF
// @include        http://basketball.fantasysports.yahoo.com/nba/56243/*
...
var doBench = function(event) {
  ...
  var allElements;
  var thisElement;
  var myLineup = { "PG":1, "SG":1, "G":1, "SF":1, "PF":1, "F":1, "C":2, "Util":3 };
