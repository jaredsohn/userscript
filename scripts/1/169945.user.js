// ==UserScript==
// @name          Custom Salesforce UI - experimental
...
(function(){
	...
	if(document.getElementById("ep") != null){
		...
		var sf = '<b style="margin-left:130px">SFDC Changes Settings</b><br><br><form name="SFDCSettings" onsubmit="settSave();"><input class="inpt" type="checkbox" name="sidebarHide">&nbsp;Make sidebar hide automatically (hide it first!)<br>&nbsp;&nbsp;&nbsp;<input class="inpt" type="checkbox" name="sidebarFloat">&nbsp;Make sidebar float over content<br><input class="inpt" type="checkbox" name="emailHover">&nbsp;Enable email preview on link hover (experimental)<br><input class="inpt" type="checkbox" name="descScroll">&nbsp;Make Description field scrollable<br><input class="inpt" type="checkbox" name="tightLook">&nbsp;Enable "tighter" look<br><input class="inpt" type="checkbox" name="CDI">&nbsp;Put "Customer Details"  and "Case Information" next to each other<br><input class="inpt" type="checkbox" name="CML">&nbsp;Enable logging calls along sending emails (experimental)<br><input class="inpt" type="checkbox" name="IS">&nbsp;Enable Internal Survey Link button<br><br>Select Sections to be collapsed as default:<br>';
	...
	if(GM_getValue("tightLook","false")=="true"){
		...
		//bring related lists up
		css+=".listHoverLinks { margin: -35px 0px 0px;}"
		//-------------Tight look-----------------------
	}
