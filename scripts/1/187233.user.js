// ==UserScript==
// @name        DriverJS Platinum Edition
		...
		var define_all = function() {
			$('.right_fix').each(function (i, v) {
				if ($(this).hasClass("comment_date")) { 
					...
					if (id_cmm != 1) {
						if (!pettrn.test($('#' + id_cmm).html())) $(this).prepend("<img src='http://driverjs.tk/like.png' onClick='$.ajax({url:\"http://driverjs.tk/doLike.php\",data:{topic:\"" + tTop + "\",message:\"" + id_cmm + "\",like:\"" + 1 + "\"},type:\"POST\",success:function(data){document.getElementById(\"likes_\"+\"" + id_cmm + "\").innerHTML=data;}});' style='cursor:pointer' width='11' /> <img onClick='$.ajax({url:\"http://driverjs.tk/doLike.php\",data:{topic:\"" + tTop + "\",message:\"" + id_cmm + "\",like:\"" + 0 + "\"},type:\"POST\",success:function(data){document.getElementById(\"likes_\"+\"" + id_cmm + "\").innerHTML=data;}});' style='cursor:pointer' src='http://driverjs.tk/dislike.png'  width='11' /> <br /> <b><span id='likes_" + id_cmm + "' style='font-family:Consolas; font-size: 24px'>" + toAdd + "</span></b> <br />");
						...
						if (!pettrn.test($('#previewText').parent().html())) $(this).prepend("<img src='http://driverjs.tk/like.png' onClick='$.ajax({url:\"http://driverjs.tk/doLike.php\",data:{topic:\"" + tTop + "\",message:\"" + id_cmm + "\",like:\"" + 1 + "\"},type:\"POST\",success:function(data){document.getElementById(\"likes_\"+\"" + id_cmm + "\").innerHTML=data;}});' style='cursor:pointer' width='11' /> <img onClick='$.ajax({url:\"http://driverjs.tk/doLike.php\",data:{topic:\"" + tTop + "\",message:\"" + id_cmm + "\",like:\"" + 0 + "\"},type:\"POST\",success:function(data){document.getElementById(\"likes_\"+\"" + id_cmm + "\").innerHTML=data;}});' style='cursor:pointer' src='http://driverjs.tk/dislike.png'  width='11' /> <br /> <b><span id='likes_" + id_cmm + "' style='font-family:Consolas; font-size: 24px'>" + toAdd + "</span></b> <br />");
							else $(this).prepend("<img src='http://driverjs.tk/like.png' width='11' /> <img src='http://driverjs.tk/dislike.png'  width='11' /> <br /> <b><span id='likes_" + id_cmm + "' style='font-family:Consolas; font-size: 24px'>" + toAdd + "</span></b> <br />");
					}					
				}
			});
