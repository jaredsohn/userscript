...
// @namespace      marki
// @description    Preview profile images on SportsDirect webshop
// @include        http://*.sportsdirect.com/*
// @version        0.1
// @icon           http://www.sportsdirect.com/favicon.ico
// ==/UserScript==
...
// full:    http://images.sportsdirect.com/images/products/55606891_l.jpg

picRegex = /http:\/\/(images\.sportsdirect\.com)\/images\/products\/([0-9]+_pl\.jpg)/;
...
function showPopupPic(e) {
	try {
		...
		if (t.tagName == 'IMG' && picRegex.test(t.src)) { newSrc = t.src.replace(/_pl/, "_l"); }
