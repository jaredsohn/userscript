// ==UserScript==
// @name           Web3 Castle Age - Construction Logger
// @namespace      Web3 Castle Age
...
GM_config.init("Web3 Castle Age - Construction Logger Options", {
	guild : {
		section : [
		"Logger Options"
		],
...
GM_registerMenuCommand("Web3 Castle Age - Construction Logger Options", GM_config.open);
