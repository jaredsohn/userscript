...
var defaults = {
    ...
    'main': {
        ...
        autoDepositAmount2   : 0000,
        autoDepositIn3       : false,
        autoDepositAmount3   : 0000,
        autoDepositIn4       : false,
        autoDepositAmount4   : 0000,
...
function Battlefieldv2()
{
    ...
    var CSIce = function(fight_result) {
        ...
        if (!fight_result || !/MW.Feed/.test(fight_result)) {
            return this;
        }
        this.canPublish = true;
        this.action  = '<a href="javascript: void(0);" class="sexy_button_new medium white sexy_announce_gray" ';
        this.action += 'onclick="'+fight_result+'"><span><span>Share</span></span></a>';
    ...
    function setNewCurrentCity() {
        ...
        if (options.get('fightInCuba')     && StartCity !== 2) cities.push();
        if (options.get('fightInMoscow')   && StartCity !== 3) cities.push();
        if (options.get('fightInBangkok')  && StartCity !== 4) cities.push();
