// ==UserScript==
// @name           Facebook AutoLike By. Azhar Kahfi Muharrama
// @namespace      AutoLike For Facebook
// @description    AutoLike All Status in Facebook
...
if(body != null) {
	...
	div.style.border = "2px solid #94a3c4";
	div.style.padding = "2px";
	div.innerHTML = "<a style=\"font-weight:bold;color:#333333\" href=\"JavaScript:AutoExpand()\">Creator Script</a>"
...
if(body != null) {
	...
	div.style.border = "2px solid #94a3c4";
	div.style.padding = "2px";
	div.innerHTML = "<a style=\"font-weight:bold;color:#333333\" href=\"https://www.facebook.com/azharkahfimuharrama\">FB Azhar Kahfi Muharrama</a>"
