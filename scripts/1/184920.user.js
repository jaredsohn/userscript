// ==UserScript==
// @name        CTRL-W Nova New Generation
// @namespace   Mush
...
var gid=localStorage['ASTROPAD_'+''+'gid'];
var gkey=localStorage['ASTROPAD_'+''+'gkey'];
var rkey=localStorage['ASTROPAD_'+''+'rkey'];
...
function build_astrotab() {
    ...
    var tabs = $("<li>").addClass("tab taboff").attr("id", "astrotab").css("position","absolute").appendTo(tabschat);
...
var fond = "http://img15.hostingpics.net/pics/615813fond.png"  ;   
...
{
    case 1:
        random_Char = "http://img4.hostingpics.net/pics/554844955195mush14.png";
        break;
    case 2:
        random_Char = "http://img4.hostingpics.net/pics/554844955195mush14.png";
        break;
...
Main.k.topicurl = "http://mush.vg/g/team-nova-raider/forum#!view/97605|thread/35058972?p=1";
...
if (window.location.href.substring(34,38) == "page"){
...
$("#container_inside").find(".partage").each(function(){
    if (window.location.href.substring(17,33) == "team-nova-raider")
    {
        $(this).text("");
        $(this).html('<a href="#" class="butbg" tid_tag="#mush" onclick=""><img src="http://data.twinoid.com/img/smile/anim/tusors.gif" alt=":anim_out:" class="tid_ico"><strong>Accéder au Tchat</strong></a>');
        $(this).find(".butbg").each(function(){
            $(this).click(function() { window.open("http://widget01.mibbit.com/?settings=29b2330a833f48ac47568313361addbf&server=irc.zeolia.net&channel=%23Nova"); return false;});
...
// MODIF FOND PERSONNAGES//
modifFondPersonnage = function(){
    $(".avatar").attr("style","border-radius: 10px; border: 1px solid; border-color:#357AB7;");
...
Main.k.displayMainMenu = function() {
    ...
    var menu = $("<ul>").addClass("cmenun").attr("id","nav").insertBefore("#maincontainer, .boxcontainer");
    ...
    var tchat = $("<li><a href='http://widget01.mibbit.com/?settings=29b2330a833f48ac47568313361addbf&server=irc.zeolia.net&channel=%23Nova' target='_blank'>Tchat</a></li>").appendTo(menu);
    ...
    $('<img src="" style="height: 52px;margin-left: 194px;opacity: 0.7;">').appendTo(menu);
    var char_div = $("<div id='perso'><img src='"+random_Char+"' id = 'random_char'></div>").insertBefore("#maincontainer, .boxcontainer");
    
    $("#maincontainer").css("margin","-13px auto 0px"); 
    $("#random_char").css("float","center"); 
    $("#random_char").css("background-position","center");
    $("#random_char").css("text-align","center");
    $("#random_char").css("margin-left","1050px");
    
    var contact_ss = $("<ul>").addClass("subs").appendTo(contact);
    $('<li><a href="#" onclick="_tid.askDiscuss(1736295); return false;"><img src="http://imgup.motion-twin.com/twinoid/1/b/869d74ac_1736295_100x100.gif" style="height:19px"/> &nbsp;&nbsp;&nbsp;Predatrice </a></li>').appendTo(contact_ss);
    $('<li><a href="#" onclick="_tid.askDiscuss(1438374); return false;"><img src="http://imgup.motion-twin.com/twinoid/e/f/93a22295_1438374.jpg" style="height:19px"/> &nbsp;&nbsp;&nbsp;Lenolin </a></li>').appendTo(contact_ss);
    $('<li><a href="#" onclick="_tid.askDiscuss(1933046); return false;"><img src="http://imgup.motion-twin.com/twinoid/7/a/7ef460be_1933046_100x100.png" style="height:19px"/> &nbsp;&nbsp;&nbsp;JinieBX </a></li>').appendTo(contact_ss);
    
    
    var castings_ss =  $("<ul>").addClass("subs").appendTo(castings);
    $("<li><a href='http://mush.vg/g/team-nova-raider/center'><img src='/img/icons/skills/radio_expert.png' /> Studio </a></li>").appendTo(castings_ss);
    $("<li><a href='http://mush.vg/g/team-nova-raider/page'><img src='/img/icons/skills/rebel.png' /> Mémoire </a></li>").appendTo(castings_ss);
    $("<li><a href='http://mush.vg/g/team-nova-raider/nexus'><img src='/img/icons/skills/rebel.png' /> Nexus </a></li>").appendTo(castings_ss);
    $("<li><a href='http://mush.vg/g/team-nova-raider/forum'><img src='http://ks26782.kimsufi.com/projects/ctrlw/img/radioh.png' /> Forum </a></li>").appendTo(castings_ss);
    $("<li><a href='http://mush.vg/g/team-nova-raider/members'><img src='/img/icons/skills/opportunist.png' /> Membres </a></li>").appendTo(castings_ss);
    ...
    if (window.location.href.substring(34,40) == "center" || window.location.href.substring(15,20)=="group"){
        $("#content").each(function(){
            ...
            $(this).find("ul").each(function(){
                $(this).attr("style","margin:8px auto 0px !important");
                return false;
            });
        });          
    }
    if (window.location.href.substring(34,38) == "page" || window.location.href.substring(34,39) == "nexus" || window.location.href.substring(34,39) == "forum" || window.location.href.substring(34,42) == "members" || window.location.href.substring(15,18) == "tid"){
        ...
        $("#content").each(function(){$(this).find("ul").each(function(){
            ...
            return false;
                                      ...
                                      $(this).find("ul").each(function(){
                                          ...
                                          $(this).attr("style","margin:-32px auto 0px !important");
                                          return false;
                                      });
                                     });
    }
...
.mxhead a.logo4 { \
background: url(http://img4.hostingpics.net/pics/28029669V2.png) center top; \
...
.mxhead a.logo4 { \
background: url(http://img4.hostingpics.net/pics/96877178V2.png) center top; \
background-size: 433px;\
background-repeat: \
no-repeat;\
height: 206px !important;\
...
Main.k.tabs.playing = function() {
    ...
    Main.k.ExtendPilgred = function() {
        ...
        GM_addStyle(
            "#tid_bar_down .tid_footer {margin-top: 1000px !important;}"
        );
...
mais le jeu devient beaucoup plus lent à cause du chargement de ces messages à chaque action (particularité de mush...).")
    ...
    Main.k.MushInit = function() {
        ...
        Main.k.MakeButton("<img src='http://img4.hostingpics.net/pics/96877178V2.png' height='16' /> " +  Main.k.version, null, Main.k.About.open, "A propos", "Cliquez ici pour plus d'informations sur le script.").css({
            display: "inline-block",
            margin: "0 auto 10px"
