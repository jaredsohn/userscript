...
// TODO Ð¡Ð°Ð¶Ð°Ñ‚ÑŒ Ñ Ð·Ð°Ð´ÐµÑ€Ð¶ÐºÐ¾Ð¹, Ñ‡Ñ‚Ð¾Ð±Ñ‹ Ð½Ðµ Ð·Ð°Ð±Ð°Ð½Ð¸Ð»Ð¸
// BUG  ÐÐµ Ð²ÑÐµÐ³Ð´Ð° ÑÑ€Ð°Ð±Ð°Ñ‚Ñ‹Ð²Ð°ÐµÑ‚ ÐºÐ½Ð¾Ð¿ÐºÐ° Ð¿Ð¾Ð»Ð¸Ð²Ð°
// TODO Ð¡Ð°Ð¶Ð°Ñ‚ÑŒ Ð¾Ð¿Ñ€ÐµÐ´ÐµÐ»ÐµÐ½Ð½Ð¾Ðµ ÐºÐ¾Ð»-Ð²Ð¾ Ð¾Ð²Ð¾Ñ‰ÐµÐ¹
// BUG  Ð¡Ð°Ð¶Ð°Ñ‚ÑŒ Ð¼Ð¾Ð¶Ð½Ð¾ Ñ‚Ð¾Ð»ÑŒÐºÐ¾ Ð² Ð½ÐµÐ·Ð°Ð½ÑÑ‚Ñ‹Ñ… ÐºÐ»ÐµÑ‚ÐºÐ°Ñ… Ð½Ð° Ð¿Ð¾Ð»Ðµ
// TODO ÐšÐ¾Ð»-Ð²Ð¾ Ð¿Ð¾Ð»Ð¾Ðº Ð¿Ð¾ Ñ‡Ð¸ÑÐ»Ñƒ Ð¾Ð²Ð¾Ñ‰ÐµÐ¹/Ð´ÐµÐºÐ¾Ñ€Ñƒ
// TODO ÐÐ°ÑÑ‚Ñ€Ð¾Ð¹ÐºÐ¸ (Ð¾Ñ‚ÐºÐ»ÑŽÑ‡ÐµÐ½Ð¸Ðµ Ñ„ÑƒÐ½ÐºÑ†Ð¸Ð¹)
// TODO Ð¡Ð¾Ñ€Ñ‚Ð¸Ñ€Ð¾Ð²ÐºÐ° Ð¿Ð¾Ð»ÐºÐ¸: Ñ€ÐµÐ½Ñ‚Ð°Ð±ÐµÐ»ÑŒÐ½Ð¾ÑÑ‚ÑŒ, Ð²Ñ€ÐµÐ¼Ñ, ÐºÐ¾Ð»-Ð²Ð¾
// TODO Ð£Ð¼ÐµÐ½ÑŒÑˆÐ°Ñ‚ÑŒ need Ð¿Ñ€Ð¸ Ð¿Ñ€Ð¾Ð´Ð°Ð¶Ðµ ÑÐ¸Ð¼Ð¿Ð°
// TODO Ð£Ñ‡ÐµÑ‚ ÐºÐ²ÐµÑÑ‚Ð¾Ð² Ð² ÑÐ¿Ð¸ÑÐºÐµ Ð½ÑƒÐ¶Ð½Ñ‹Ñ… Ñ‚Ð¾Ð²Ð°Ñ€Ð¾Ð²

// ÑÐ·Ñ‹ÐºÐ¾Ð²Ñ‹Ðµ Ñ„Ñ€Ð°Ð·Ñ‹
var LNG_MARKET_DEL_FILTER = 'Ð£Ð´Ð°Ð»Ð¸Ñ‚ÑŒ Ñ„Ð¸Ð»ÑŒÑ‚Ñ€';
var LNG_MARKET_BACK       = ' Ð½Ð°Ð·Ð°Ð´';
var LNG_MARKET_BUY        = 'ÐºÑƒÐ¿Ð¸Ñ‚ÑŒ|Ð´Ð¾Ñ€Ð¾Ð³Ð¾|ÑÐ½ÑÑ‚|ÑÐ½ÑÑ‚ÑŒ';
var LNG_STATUS_MONEY      = 'Ð”ÐµÐ½ÐµÐ³';
var LNG_STATUS_LEVEL      = 'Ð£Ñ€Ð¾Ð²ÐµÐ½ÑŒ';
var LNG_STATUS_SCORE      = 'ÐžÑ‡ÐºÐ¸';
var LNG_QUEST             = 'ÐšÐ²ÐµÑÑ‚';
var LNG_QUEST_NO          = 'ÐšÐ²ÐµÑÑ‚Ð° Ð½ÐµÑ‚';
var LNG_BTN_HELP          = 'ÐŸÐ¾Ð¼Ð¾Ñ‰ÑŒ';
var LNG_BTN_PLANT         = 'ÐŸÐ¾ÑÐ°Ð´Ð¸Ñ‚ÑŒ';
var LNG_BTN_WATER         = 'ÐŸÐ¾Ð»Ð¸Ñ‚ÑŒ';
var LNG_PROD_REST         = 'Ð¾ÑÑ‚.';
var LNG_WITH_PROD_IN_RACK = 'Ð¡ ÑƒÑ‡ÐµÑ‚Ð¾Ð¼ Ð¿Ñ€Ð¾Ð´ÑƒÐºÑ‚Ð¾Ð² Ð½Ð° Ð¿Ð¾Ð»ÐºÐµ';
var LNG_BUY_IN_SHOP       = 'ÐšÑƒÐ¿Ð¸Ñ‚ÑŒ Ð² Ð¼Ð°Ð³Ð°Ð·Ð¸Ð½Ðµ">[ ÐšÐ’Ðœ ]';
var LNG_NEW_VERSION       = 'Ð”Ð¾ÑÑ‚ÑƒÐ¿Ð½Ð° Ð½Ð¾Ð²Ð°Ñ Ð²ÐµÑ€ÑÐ¸Ñ ÑÐºÑ€Ð¸Ð¿Ñ‚Ð°. Ð¥Ð¾Ñ‚Ð¸Ñ‚Ðµ ÑÐºÐ°Ñ‡Ð°Ñ‚ÑŒ?';
var LNG_PRODUCTS          = 'Ð‘Ð°Ð½Ð¾Ðº';
var LNG_CLEAR             = 'Ð¾Ñ‡Ð¸ÑÑ‚Ð¸Ñ‚ÑŒ';
