...
// @name           MaTaR
// @namespace      education
// @description    enable flash in mt"r site (educational index)
// @include        http://www.matar.ac.il/
// ==/UserScript==
...
//
// fix each flash object in page
//

if (document.baseURI == 'http://www.matar.ac.il/')
{
//alert(document.baseURI);
var obj = document.getElementById("DivFlash");
if (obj) {

	var so = new SWFObject("http://www.matar.ac.il/flash/bar1a-small_new.swf", "bar1a-small_new", "430", "63", "0", "#EFFCD2");
