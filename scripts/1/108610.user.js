// ==UserScript==
// @name			Reproductor Anime Digital
// @description			Reproducelos videos de megavideo en HD
...
link = "http://www"+s+".megavideo.com/files/"+decrypt(un,k1,k2)+"/"+title+""
mv = 1;

document.getElementById("playerdiv").innerHTML = '<embed type="application/x-shockwave-flash" src="http://www.animedigital.co/reproductor/player.swf" width="976" height="574" style="undefined" id="mpl" name="mpl" quality="high" allowscriptaccess="always" wmode="transparent" allowfullscreen="true" flashvars="file='+link+'&amp;">'
