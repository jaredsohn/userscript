...
$("body").append("<img id=\"scrolltop_btn\" class=\"mpbtn\" src=\"https://drive.google.com/uc?export=view&id=0B6X6OuoExTBXU29jTjRpVkZxVjQ\"style=\"right:5px;display:none\"></img>");$("#scrolltop_btn").click(function(){aniScroll(0)});;
//stuff
...
function createStyle(){
    ...
    style.type = "text/css";
    style.innerHTML += "body{background-image:url('https://drive.google.com/uc?export=view&id=0B6X6OuoExTBXMXNwanhZUUo5U2c')}";
