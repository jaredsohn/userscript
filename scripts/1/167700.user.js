...
(function($){
	$('div.detName').each(function(){
		var wrapper = $(this);
		var href = '//torrents.thepiratebay.sx/'+ wrapper.find('a').attr('href').replace('/torrent/','')+ '.torrent';
		wrapper.after($('<a>').attr('href', href).append('<img src="http://static.thepiratebay.sx/img/dl.gif" alt="downlad torrent"/>'));
	});
})(jQuery);
...
var xx = "http://torrents.thepiratebay.sx/"+TPB_ID+"/"+title.substring(3, title.length-1).replace(/ /gi, '_')+"."+TPB_ID+".TPB.torrent";
