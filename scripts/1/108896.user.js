// ==UserScript==
// @name           NZBMatrix English Language Filter
// @version        0.15
...
(function(){
  ...
  var hideElements = function(elements) {
	...
	images = document.evaluate('//tr/td/img[@src="'+window.location.protocol+'//nzbmatrix.com/images/flags/hindi.gif"]',document,null,XPathResult.UNORDERED_NODE_SNAPSHOT_TYPE,null)
	for (i = 0; i < images.snapshotLength; i++) {
		(foo = images.snapshotItem(i).parentNode.parentNode).parentNode.removeChild(foo)
	}
