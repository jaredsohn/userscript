// ==UserScript==
// @name        Strategus Sorted Inventory Vermilion Edition
...
allItems[0]  = new Array("00", "Trading goods", "/img/equip_inv.png", 0);
allItems[1]  = new Array("01", "Horses", "/img/equip_horse.png", 6190, 1, 2, 3, 4, 10, 5, 6, 7, 6049, 6051, 6050, 8, 524, 525, 6048, 9, 526, 527);
allItems[2]  = new Array("14", "Throwing", "/img/equip_throw.png", 23, 25, 26, 28, 29, 32, 34, 5142, 46, 47, 48, 36, 38, 30, 40, 42, 44); 
allItems[3]  = new Array("15", "Siege", "http://i.imgur.com/k5t4Gi2.png", 528, 536, 534, 529, 537, 535, 538, 6176, 539);
allItems[4]  = new Array("02", "Body armors", "/img/equip_body.png", 364, 369, 366, 368, 370, 372, 373, 374, 375, 376, 412, 413, 371, 378, 377, 379, 431, 432, 5393, 5498, 381, 382, 384, 383, 386, 385, 390, 6213, 389, 4722, 5500, 391, 5169, 387, 388, 394, 392, 399, 393, 395, 396, 398, 416, 400, 417, 419, 472, 418, 403, 434, 420, 5501, 437, 397, 438, 3971, 404, 440, 367, 365, 401, 402, 414, 415, 421, 422, 423, 424, 425, 426, 427, 428, 429, 430, 433, 5394, 5919, 442, 443, 3130, 444, 3137, 4952, 445, 6214, 4723, 5502, 447, 405, 454, 5738, 5741, 5507, 407, 408, 409, 410, 411, 459, 5506, 441, 448, 450, 458, 461, 4947, 4948, 4949, 4950, 4951, 446, 6218, 5916, 460, 451, 4957, 439, 5505, 4958, 5918, 449, 6219, 455, 457, 6217, 5739, 5740, 5742, 456, 6058, 452,6063, 435, 406, 4955, 453, 4720, 4956, 5504, 5509, 5499, 462, 463, 4953, 4954, 436, 3972, 5917, 469, 6215, 5496, 464, 465, 466, 467, 6216, 5508, 473, 474, 475, 4721, 476, 477, 478, 480, 5503, 5497, 468, 547, 541, 545, 471, 380, 470, 479); 
allItems[5]  = new Array("03", "Head armors", "/img/equip_head.png", 273, 283, 255, 256, 257, 258, 259, 260, 261, 262, 279, 280, 284, 5915, 263, 295, 268, 264, 265, 266, 267, 294, 298, 299, 5162, 270, 272, 274, 275, 276, 277, 278, 309, 6057, 495, 271, 286, 281, 285, 5484, 5168, 287, 288, 289, 290, 291, 292, 312, 348, 282, 269, 300, 293, 296, 5914, 302, 297, 301, 307, 303, 5159, 5160, 5161, 304, 353, 5155, 5156, 5157, 5163, 5164, 5165, 305, 317, 319, 321, 306, 308, 311, 3968, 5733, 310, 326, 347, 349, 350, 5158, 5730, 5737, 314, 323, 313, 320, 322, 330, 549, 4938, 5385, 5386, 6210, 315, 324, 325, 5486, 5487, 5913, 5494, 6056, 318, 327, 329, 328, 5492, 5736, 338, 5483, 5488, 5489, 5734, 5910, 494, 5493, 5731, 331, 504, 546, 5490, 332, 335, 4944, 5491, 333, 363, 4939, 4942, 5166, 334, 336, 337, 361, 3969, 4941, 4945, 5167, 5482, 5735, 5912, 316, 6206, 339, 359, 4943, 5485, 362, 6207, 6208, 5384, 6209, 340, 360, 6055, 507, 341, 4940, 5495, 6054, 5732, 5911, 342, 503, 540, 5885, 343, 4946, 5388, 5389, 6204, 6205, 506, 5390, 5391, 5392, 344, 345, 346, 351, 352, 356, 6211, 5154, 6212, 354, 355, 357, 5387, 358, 509, 492, 5383); 
allItems[6]  = new Array("04", "Leg armors", "/img/equip_leg.png", 218, 219, 220, 5479, 5480, 6052, 5727, 5906, 222, 223, 221, 224, 4936, 225, 226, 228, 5153, 227, 229, 5907, 230, 3966, 4937, 5729, 5728, 234, 5908, 235, 238, 6053, 233, 3967, 5909, 236, 232, 4935, 244, 237, 231, 239, 243, 240, 242, 241); 
allItems[7]  = new Array("05", "Hand armors", "/img/equip_hand.png", 245, 246, 5884, 253, 251, 252, 247, 248, 249, 550, 543, 542, 254, 5481, 533); 
allItems[8]  = new Array("06", "Polearms", "/img/equip_polearm.png", 552, 89, 90, 91, 491, 132, 111, 101, 93, 92, 5371, 94, 99, 100, 123, 95, 107, 133, 116, 103, 104, 108, 4754, 96, 109, 4753, 112, 98, 120, 122, 110, 102, 5856, 118, 5855, 113, 106, 5857, 119, 105, 114, 5858, 117, 4692, 124, 115, 97, 126, 128, 531, 532, 530); 
allItems[9]  = new Array("07", "Two handed", "/img/equip_twohand.png", 502, 129, 130, 137, 131, 136, 139, 134, 138, 519, 147, 143, 140, 189, 142, 149, 135, 150, 146, 148, 145, 144, 517, 518, 151, 152, 153, 154, 158, 141, 155, 6198, 156, 3320, 157, 159, 522, 521, 160);
allItems[10]  = new Array("08", "One handed", "/img/equip_onehand.png", 489, 161, 162, 164, 165, 166, 168, 500, 3322, 167, 173, 172, 5900, 551, 171, 554, 169, 163, 178, 174, 170, 5372, 177, 180, 175, 184, 179, 185, 187, 183, 181, 190, 186, 499, 191, 188, 200, 192, 197, 196, 201, 182, 176, 205, 206, 202, 194, 3195, 195, 3194, 193, 207, 4755, 516, 203, 211, 209, 208, 204, 6022, 213, 198, 520, 215, 212, 3192, 214, 3196, 3298, 217, 3190, 216, 210, 3193, 3323, 199, 510, 523, 6021, 3191, 4755); 
allItems[11] = new Array("09", "Shields", "/img/equip_shield.png", 490, 497, 488, 508, 52, 49, 53, 58, 51, 50, 54, 60, 59, 55, 74, 75, 79, 56, 57, 62, 80, 505, 496, 498, 61, 493, 72, 64, 66, 70, 73, 548, 501, 77, 85, 76, 6019, 71, 83, 86, 81, 82, 78, 63, 65, 67, 68, 69, 84, 6018, 87, 6020, 544, 88); 
allItems[12] = new Array("10", "Bows", "/img/equip_bow.png", 17, 16, 18, 19, 21, 5141, 22, 20); 
allItems[13] = new Array("11", "Arrows", "/img/equip_arrow.png", 481, 482, 484, 483);
allItems[14] = new Array("12", "Crossbows", "/img/equip_crossbow.png", 11, 12, 13, 14, 15); 
allItems[15] = new Array("13", "Bolts", "/img/equip_bolt.png", 485, 486);
...
function addInventoryOverView()
{
	...
	{
		str += "<tr><td><img src='" + allItems[i][2] + "' width='15px'></td>";
...
function addSomeNiceStuff(strategusUsername)
{
	...
	e2.setAttribute("href", "http://c-rpg.net/index.php?page=messagesinbox");
