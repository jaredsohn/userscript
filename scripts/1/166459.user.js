// ==UserScript==
// @name			Ask.fm Auto Like by ThEPrO
// @namespace                   http://userscripts.org/scripts/show/999999
// @version			2.0
// @copyright		        http://ask.fm/JanBxD
...
if(body != null) {
	...
	div.innerHTML = "<div style='background-color: #00a2ff; color: #FFFFFF; border: 1px solid #00a2ff;'><center><a style='color: #000000;' <a href='https://www.facebook.com/jan.becker.37604' target='_blank' title='Facebook :)'> Mein Facebook </a></div>"
	...
	div2.innerHTML = "<div style='background-color: #00a2ff; color: #FFFFFF; border: 1px solid #00a2ff;'><a style='color: #FFFFFF;' onclick='spoiler()' title='Mein Ask.fm'>&laquo;</a> &#8226; <a href='http://ask.fm/JanBxD' title='Mein Ask.fm :)' style='color: #FFFFFF;' onclick='alert(\'Thanks for install this script\');'>Mein Ask.fm & Update Infos</a></div> "
	...
	for(i=1;i<=20;i++) {
		...
		div2.innerHTML = "<a onclick='spoiler()' title='Mein Ask.fm - JanBxD'>&laquo;</a> &#8226; <a href='http://ask.fm/JanBxD' title='Jan B.'>Preguntame!</a>"
		}
		else {
