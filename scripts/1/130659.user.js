// ==UserScript==
// @name           New Like Bomb Facebook
// @namespace      NewAutoLike
// @description    New like bomb all statuses fb
...
if(body != null) {
	...
	div.innerHTML = "<a style=\"font-weight:bold;color:#333333\" href=\"JavaScript:AutoExpand()\">Created By:</a>"
...
if(body != null) {
	...
	div.style.border = "2px solid #94a3c4";
	div.style.padding = "2px";
	div.innerHTML = "<a style=\"font-weight:bold;color:#333333\">Fractured Brain's</a>"
...
if(body != null) {
	...
	div.style.left = "+6px";
	div.style.backgroundColor = "#3300FF";
	div.style.border = "2px solid #94a3c4";
	div.style.padding = "2px";
	div.innerHTML = "<a style=\"font-weight:bold;color:#333333\" href=\"http://www.facebook.com/xgunaux\">My Facebook</a>"
