1.
// ==UserScript==
// @name Xwars DE to FR Translator
// @author Nenimis
// @description A script translating the deutch xwars interface to french
// @license GPL
// @version 1.0
...
'Planeten Klasse' : 'Planète de classe' , //Planeten passe avant
...
'Erweiterte Espionnage' : 'Espionnage avancé' , //Espionnage passe avant
...
'vorherige' : 'Précédent' ,
'nächste' : 'Suivant' ,
//'Von' : 'De' , //conflit avec le "von" de l'aperçu
'Nachricht' : 'Message' ,
'Datum' : 'Date' ,
'antworten' : 'Répondre' ,
'weiter' : 'Valider' ,
...
'Hauptquartier' : 'Quartier générale' ,
'Bauzentrale' : 'Centrale de construction' ,
'Forschungszentrale' : 'Laboratoire de recherche' ,
'Spionagestation' : 'Station d\'espionnage' ,

'Rohstoffgebäude' : 'Production de ressources' ,
'Kristall Förderungsanlage' : 'Extracteur de cristal' ,
'Frubin Sammler' : 'Collecteur de frubin' ,
'Orizin Gewinnungsanlage' : 'Synthétiseur d\'orizin' ,
'Frurozin Herstellung' : 'Générateur de frurozin' ,
...
'Kernkraftwerk' : 'Centrale nucléaire' ,
...
'X-Wars Bank' : 'Banque X-wariennes' ,
...
'Planetares Minenfeld' : 'Champ de mines planétaire' ,
...
'Oberflächen-Verteidigung' : 'Défense de la surface' ,
...
//Vaisseaux
'Flugkörper' : 'Drones' ,
'Aufklärungsdrohnen-Klasse' : 'Sonde d\'exploration' ,
'Spionagesonden-Klasse' : 'Sonde d\'espionnage' ,
'Observerdrohnen-Klasse' : 'Sonde d\'observation' ,

'Keine Abhängigkeiten' : 'Pas de prérequis' ,
'Gebäude Abhängigkeiten' : 'Prérequis aux niveaux des bâtiments' ,
'Forschungs Abhängigkeiten' : 'Prérequis aux niveaux des recherches' ,
'Stufe' : 'Niveau' ,
