...
// ==/UserScript==http://userscripts.org/scripts/show/152527

GM_addStyle(GM_getResourceText("css"));

(function ()
 {var myshoutboxID = "fornaxemy";
	 ...
	 var chatHTML = '<div id="shoutboxbox"><iframe id="shoutbox" src="http://' + myshoutboxID + '.freeshoutbox.net/" width="160" height="591" frameborder="0" allowTransparency="true"></iframe></div>'
