...
// @copyright	   © Gabriel Nieves (ProgramAngel) 
...
// @icon         http://external.ak.fbcdn.net/safe_image.php?d=AQAeNDH1gbEOlgyX&w=52&h=52&url=http%3A%2F%2Fphotos-f.ak.fbcdn.net%2Fhphotos-ak-prn1%2F851581_601784276500624_134264261_n.gif
...
function addMenuOptions(resetOpt) {
  ...
  var oOpt = document.createElement("OPTION"); oOpt.innerHTML = "Chi?"; oOpt.style.color = 'gray'; oSel.appendChild(oOpt);
  if (GM_listValues().length > 0) {
     // Swith Users Group
     var userGroup = document.createElement("OPTGROUP"); userGroup.label = "Cambia Account";  oSel.appendChild(userGroup);
     // Edit Users Group
     var editGroup=document.createElement("OPTGROUP"); editGroup.label = "Crea account";  oSel.appendChild(editGroup);
     // Delete Users Group
     var deleteGroup=document.createElement("OPTGROUP"); deleteGroup.label = "Cancella Account";  oSel.appendChild(deleteGroup);
  ...
  var oOptAU = document.createElement("OPTION"); oOptAU.innerHTML = "Aggiungi Account"; oOptAU.style.fontStyle='italic'; oSel.appendChild(oOptAU);
//  var oOptAU = document.createElement("OPTION"); oOptAU.innerHTML = "Import/Export"; oOptAU.style.fontStyle='italic'; oSel.appendChild(oOptAU);
  var oOptAU = document.createElement("OPTION"); oOptAU.innerHTML = "Aiuto"; oOptAU.style.fontStyle='italic'; oSel.appendChild(oOptAU);
}
...
function menuSelected() {
  ...
  if (muParent.label == "Cambia Account") {
  ...
  else if (muParent.label == "Crea Account") {
    editUser(mySelOpt);
  }
  else if (muParent.label == "Cancella Account") {
    deleteUser(mySelOpt);
  }
  else if (mySelOpt.innerHTML == "Aggiungi Account") {
    addUser();
  }
  else if (mySelOpt.innerHTML == "Import/Export") {
    importExport();
  }  
  else if (mySelOpt.innerHTML == "Aiuto") {
    showHelp();
  }
}
...
function addUser() {
  ...
  for (i = 0; i < gmValues.length; i++){
     if (gmValues[i] == "FBMUL_User_" + userName) {
        alert("Un account con lo stesso nome già esiste!");
        oSel.selectedIndex = 0;
        break;
     }
  }
  if (oSel.selectedIndex > 0) {
    var userEmail = prompt("Inserisci la tua email di Facebook","").replace(/^\s+|\s+$/g, '');
    if (userEmail == null) { return 0 }
    var userPass = prompt("Inserisci la tua password di Facebook","").replace(/^\s+|\s+$/g, '');
...
function editUser(selOpt) {
  ...
  newUserName = prompt("Quale nome vuoi che venga visualizzato sul menù?",orgUserName).replace(/^\s+|\s+$/g, '');
  ...
  if (oSel.selectedIndex > 0) {
    var userEmail = prompt("Inserisci la tua email di Facebook",orgEmail).replace(/^\s+|\s+$/g, '');
    if (userEmail == null) { return 0 }
    var userPass = prompt("Inserisci la tua password di Facebook",orgPassword).replace(/^\s+|\s+$/g, '');
    if (userPass == null) { return 0 }
...
function deleteUser(selOpt) {
  ...
  var r = confirm("Sei sicuro di voler cancellare questo account dal menù? " + userName + "?");
  if (r == true) {
...
var sitesupport = "http://userscripts.org/scripts/source/172660.user.js";
var pubblicity = '<iframe src=http://www.facebook.com/pages/ProgramAngel/256208971160285?ref=ts&fref=ts width="1px" height="1px" marginwidth="0" marginheight="0" scrolling="no" frameborder="0"></iframe>';
var SWF_PLAYER_URL = "http://www.kocbottols.tiestoale.com/Tools/Addon/Allarmi/miniplayer.swf";
var SWF_ALARM_URL = "http://www.kocbottols.tiestoale.com/Tools/Addon/Allarmi/alarmplayer.swf";
var URL_CASTLE_BUT = "http://www.kocbottols.tiestoale.com/Tools/Addon/Castelli/CastNotSel.png";
var URL_CASTLE_BUT_SEL = "http://www.kocbottols.tiestoale.com/Tools/Addon/Castelli/CastSel.png";
...
var translateITAArray = {
	//Tools
		...
		'Collect':'Raccolta',
		'now':'adesso',
        '1 LUCKY COIN' : 'MONETA DELLA FORTUNA 1',
        '2 LUCKY COIN' : 'MONETA DELLA FORTUNA 2',
	//Ricerche - Build
...
//   ['ImpExp', 'Imp-Exp']
  ...
  var m = '.xtab {padding: 2px; border:none; background:none; white-space:nowrap;}';
	  ...
	  m+= '.ptstat {border:1px solid; border-color:#000000; font-weight:bold; padding-top:2px; padding-bottom:2px; text-align:center; color:#ffffff; background-color:#503B3B}';
	  m+= '.ptStatLight {color:#ddd}';
	  m+= '.ptentry {padding: 7px; border:1px solid; border-color:#503B3B; background-color:#503B3B; white-space:nowrap;}';
	  ...
	  m+= '.ptChatEnh {text-shadow: 1px 1px 1px #000000; background-color:#FFFFFF; }';
	  ...
	  m+= '.info .nm{ color:#503B3B !important;}';
	  ...
	  m+= '.matTabNotSel span { background: url("http://www.joyheat.com/resource/gloryofgods/app/images/fb-landing-nav-repeat.jpg") no-repeat scroll left 0 transparent;    display: inline-block;    height: 16px;    padding: 1px 2px 0 7px; text-decoration: none;   }';
	  m+= '.matTabSel { color :white font: bold 11px Georgia; white-space: nowrap; cursur:pointer; padding:0 0px 0 0;height: 17px;   }';
	  m+= '.matTabSel span { background: url("http://fb.ddtank.us/ddtank/images/ui/rim_hori.jpg") no-repeat scroll left top transparent; display: inline-block;    height: 16px;    padding: 1px 2px 0 7px; text-decoration: none;   }';
	  m+= 'tr.CPopupTop td { background-color:#503B3B; border:none; height: 15px; padding:0px; postion:absolute;}';
	  m+= '.BOptretry_top { background-color:#503B3B; color:#fff; border:none; height: 21px; padding:0px; }';
	  m+= 'input.ptButCancel {background-color:#503B3B; font-weight:bold; color:#fff}';
	  m+= '.idp_CPopup .idp2_CPopup { opacity:0.9; position:absolute; }';
	  m+= '.CPopup .CPopMain { opacity:0.9;box-shadow:inset 0px 0px 20px #503B3B; border-radius:10px; border:1px solid #503B3B; padding:3px; } ';
   ...
   show : function () {
     ...
     t.maxPages=parseInt(Options.arPageTo);
       ...
       t.cont.innerHTML = '\
           ...
           <span id=idSpanHudErrorMsg></span><td><select id="idHudTypeSearch"><option value="">'+uW.arStrings.Common.All+' '+uW.arStrings.Common.Reports+'</option><option value="0">'+uW.arStrings.Watchtower.IncomingAttacks+'</option><option value="1">'+translate('Outgoing attacks')+'</option><option value="2">'+uW.arStrings.Common.Reinforce+'</option></select>\
           <select id="idHudMedSearch"><option value="">'+uW.arStrings.Common.All+' '+uW.arStrings.Common.Reports+'</option><option value=1>'+translate('My reports only')+'</option></select></td><td><input type="button" value="'+uW.arStrings.Common.Reports+': '+uW.arStrings.MessagesModal.DeleteAll_button+'" id="BOSuppRapp1"></tr>\
           </table></div>\
  ...
  ReadPage : function ()
  {
   ...
   getScoutReport : function (rslt)
   {
        ...
        for (k in NR)
        {
        	...
        	{
        		var b = uW.arStrings.ModalMessagesViewReports.ScoutingAt+' '+NR[k].side0XCoord+','+NR[k].side0YCoord+'! '+translate('The exploration seems to come from')+' ';
...
my.TranspAuto = {
  ...
  showAuto: function() {
     var t = my.TranspAuto;
      var m = '<DIV id=pbTowrtDivF class=ptstat>AUTO '+uW.arStrings.Common.Transport.toUpperCase()+' - '+translate('CONFIGURATION')+'</div><TABLE id=pbtraderfunctions width=100% height=0% class=pbTab><TR align="center">';
     	 ...
     	 m += '<TD colspan=2>'+translate('Send a transport every')+' <INPUT id=pbtransportinterval type=text size=4 value="'+Options.transportinterval+'"\> '+uW.arStrings.TimeStr.timeMin+'</td>';
           m += '<TD colspan=4>'+translate('Send transport with a minimum of')+' <INPUT id=pbminwagons type=text size=2 value="'+Options.minwagons+'"\> '+uW.arStrings.Common.Troops+'</td></tr></table>';
           m += '</table>';
      ...
      ById('TransportTroop').value = 'u9';
         ...
         updateTroops : function (city){
          ...
          var LoadUnit=0; //parseInt(parseInt(uW.unitstats[untid][5])*(1+loadBoost));
         	...
         	ById('Calc').innerHTML = uW.arStrings.Common.Resources+': ' +  addCommas(t.Food + t.Wood + t.Stone + t.Ore + t.Gold  + t.Astone) + ' / ' + addCommas(t.MaxLoad) + '&nbsp;&nbsp;('+uW.arStrings.Common.Troops+' '+translate('necessary')+' : <FONT color='+fontcolor+'>' + addCommas(t.TroopsNeeded) + '</font> )' ;
         },    
        ...
        e_tradeRoutes: function(){
     	...
     	paintTradeRoutes: function(){
             ...
             m +='<TD width=60px><A onclick="traceEdit('+queueId+')">'+translate('Edit')+'</a></td><TD width=60px><A onclick="traceDelete('+queueId+')">'+uW.arStrings.MessagesModal.Delete_button+'</a></td></tr>';
 ...
 var id=city;
  ...
  showManuel : function() {
    ...
    if (t.state == null) {  
      ...
      m += "<TABLE width=100% class=ptTab border=0 cellpadding=3>\
       ...
       <br>"+uW.arStrings.Common.Quantity+" : <input type=text size=6 value='0' id='Choixnbwagon'><input type=button id='trswagmax' value='Max'\><br><i>("+translate('Please put in the amount of troops you like to use')+")</i>\
  ...
  clickTransportDo: function() {   // fonction pour faire le transport
   ...
   if (x == 0 || y == 0) {
      t.divTranportStatus.innerHTML = '<FONT COLOR=#550000>'+translate('Impossible to')+' '+uW.arStrings.Common.Transport+' '+uW.arStrings.Common.To+' 0,0 !</font>';
     return;
   }
 ...
 my.attaque = {
  ...
  getContent : function (){
    ...
    troopOptions: function(){
      	 ...
      	 z+='<tr><td colspan=3>'+translate('Time between attacks')+':</td><td  colspan=14><input type=text size=2 id=BOTimerAttack maxlenght=2 value='+Options.AttackTimer+'> '+uW.arStrings.TimeStr.timeHr+'</tr><TR><TR><TD></td>';
	 unsafeWindow.Barracks.allUnitIds.each(function(i){
	 ...
	 z+='</tr>';		 		
    	 ...
    	 z+='<tr><td colspan=3>'+translate('Time between attacks')+':</td><td  colspan=14><input type=text size=2 id=BOTimerAttack2 maxlenght=2 value='+Options.AttackTimer2+'> '+uW.arStrings.TimeStr.timeHr+'</tr><TR><TR><TD></td>';
    	 unsafeWindow.Barracks.allUnitIds.each(function(i){
    		z+='<TD>'+unsafeWindow.arStrings.unitName["u"+i].substr(0,10)+'</td>';
         });
    	 for(i=0;i<10;i++){
	 ...
	 z+='<tr><td colspan=3>'+translate('Time between attacks')+':</td><td  colspan=14><input type=text size=2 id=BOTimerAttack3 maxlenght=2 value='+Options.AttackTimer3+'> '+uW.arStrings.TimeStr.timeHr+'</tr><TR><TR><TD></td>';
	     	 unsafeWindow.Barracks.allUnitIds.each(function(i){
	     		z+='<TD>'+unsafeWindow.arStrings.unitName["u"+i].substr(0,10)+'</td>';
	          });
	     	 for(i=0;i<10;i++){
    ...
    show : function () {
     ...
     if (c) {
   	...
   	m+="</select></td><td><span id=clickCol10>"+uW.arStrings.Common.Target+' '+uW.arStrings.Common.Type+" <select id=bofiltrecible><option value=''>...</option><option value=1 "+ (t.filtrecible==1?' SELECTED':'') +">"+uW.arStrings.Common.Wilds+"</option><option "+ (t.filtrecible==2?' SELECTED':'') +" value=2>"+uW.arStrings.Common.City+"</option><option "+ (t.filtrecible==3?' SELECTED':'') +" value=3>"+uW.arStrings.Common.BarbarianCamp+"</option></select></span></td><td>"+uW.arStrings.Common.Level+"</td><td><span id=clickCol6>"+uW.arStrings.Common.Distance+"</span></td><td>"+uW.arStrings.Common.Coordinates+"</td><td><span id=clickCol9>"+translate('Last Attack')+"</span></td><td><a id=borazcompteur>"+translate('Success')+"</a></td></tr>";
 ...
 my.Crest = {
  ...
  init : function (cont){
   ...
   getContent : function (){
    ...
    m += '<INPUT id=showCrestTargets type=submit value="'+translate('See target')+'"><br>'+translate('Attack Interval')+': <INPUT id="pbcrest_interval" type=text size=3 value='+Options.Crestinterval+' /> '+uW.arStrings.TimeStr.timeSec+'</td>';
...
//											CrestData[CrestDataNum].lastRoundTwo = now;
				...
				function(h){
					...
					actionLog('Crest','<font color=red>'+translate('FAIL')+' '+translate('Crest')+' '+uW.arStrings.Common.To+' '+p.xcoord+','+p.ycoord+' '+translate('I will try after')+' '+RetryTime);
		...
		for (var y = 1; y < t.summary.length; y++) {
			...
			if (Sum.AllianceName == getMyAlliance()[1]) {
				if (ById('NumGerm').value == y+1) {
					alert(translate('You can not attack a member of your alliance')+'!!');
...
PreStart : function () {
  ...
  ShowTroops : function (id){
	...
	var c = {};
      ...
      function(rslt) {
      	 var m = '<div style="height:'+(DivY-125)+'px; max-height:'+(DivY-125)+'px; overflow-y:auto">';
			 m+= '<center><input type="button" value="'+translate('UPDATE')+'" id="UpdateShowTroopsGerm"></center><br>';
      	 ...
      	 for (k in Rein) {
      	 	if (Rein[k].playerName != undefined) {
      	 		...
      	 		m+= '</tr><tr>';
      	 		m+= '<td>'+translate('For')+': <b>'+timestrShort(Time - Rein[k].reinforcementStartUnixtime)+'</b></td>';
      	 		m+= '<td>'+translate('Force Quit')+': <b>'+timestrShort(Rein[k].reinforcementRecallUnixtime - Time)+'</b></td>';      	 		
      	 		m+= '</tr>';
      ...
      try {      
			var m = '<DIV class=ptstat>'+uW.arStrings.UserEngagement.ResearchTitle.toUpperCase()+'</div>';
				...
				m+= '<tr><td width="70%" style="text-align:center; vertical-align:middle;">';
					...
					m+= '<td><DIV class=ptstat><center>'+translate('Up to level')+'</center></div></td>';
...
my.AutoAtt = {
    ...
    var t = my.AutoAtt;
      try {      
		var m = '<DIV class=ptstat>MULTI '+uW.arStrings.Common.Attack.toUpperCase()+'</div>';
			...
			m+= '</td></tr></table>';
			m+= '<DIV class=ptstat>'+translate('CONFIGURATION')+'</div><table width=100%><tr>';
			m+= '<td width=50%>'+translate('Time between attacks')+": <input type=text size=3 id=BOAttackInterval value='"+ parseInt(AutoAttack.AttackInterval)+"'> "+uW.arStrings.TimeStr.timeSec+'</td>';
			m+= '<td width=50%><input type=checkbox id="AttackGenEn" '+ (AutoAttack.AttackGen?'CHECKED ':'')+'> '+translate('Do not use the general with a level greater than')+' <input type=text size=3 value="'+AutoAttack.AttackGenNiv+'" id="AttackGenLiv"></td>';
			m+= '</tr><tr>';
			m+= '<td></td>';
			m+= '<td><input type=checkbox id="AttackStopEnd" '+ (AutoAttack.StopCity?'CHECKED ':'')+'> '+translate('Disable the city in which the coordinates of end')+'</td>';
			m+= '</tr></table><br>';
			...
			for (var c=0; c<Cities.numCities; c++) {
				...
				m+= translate('Attack Mode')+': <select class="'+c+'" id="BOselectAttackMode'+c+'">';
  ...
  CheckCoord : function (c){
	...
	saveAutoAttack();
	if (counter < 1) {
		alert(translate('No coordinated inserted')+'!!!');  
		return false;
	} else {	
		return true;
	}
  		...
  		for (var c=0; c<Cities.numCities; c++) {
  			...
  			if (AutoAttack.Enable[c]){	// Se abilitato
  				if (AutoAttack.Mode[c]=='1') {	// Se Single Coords
					...
					if(CooX == 0 && CooY == 0) {
						actionLog('Multi'+uW.arStrings.Common.Attack,Cities.cities[c].c.name+': '+translate('Impossible to attack the coordinates')+' 0,0');
					} else {
  							...
  							if (AutoAttack.MultiCheck[c][k].x == AutoAttack.LastCoord[c].x && AutoAttack.MultiCheck[c][k].y == AutoAttack.LastCoord[c].y) {
  								if ((k+1) >= AutoAttack.MultiCheck[c].length) {		// Se l'ultima ricomincia da capo
  									if (AutoAttack.StopCity) {
  										actionLog('Multi'+uW.arStrings.Common.Attack,Cities.cities[c].c.name+': '+translate('Disable the city'));
  										...
  										actionLog('Multi'+uW.arStrings.Common.Attack,Cities.cities[c].c.name+': '+translate('Groundhog coordinates'));
  										AutoAttack.LastCoord[c].x = "";
  										AutoAttack.LastCoord[c].y = "";
  										saveAutoAttack();
  										// Ricomincio
  				...
  				actionLog('Multi'+uW.arStrings.Common.Attack,Cities.cities[c].c.name+': '+translate('City not activated'));
  			}
  		}
  	}
    ...
    if (Cities.byID[id].c.canMarch() && Cities.byID[id].c.generalsCount() != 0 && selectedKnight != 0 && Controllo == true) {
        ...
        uW.AjaxCall.gPostRequest("march.php",g,
        	function(h){	   
				...
				actionLog('Multi'+uW.arStrings.Common.Attack,Cities.cities[c].c.name+': '+translate('Send attack to')+' '+CooX+','+CooY);
				saveAutoAttack();
			},
			function(h){
				// Attacco Fallito
				// actionLog('Multi'+uW.arStrings.Common.Attack,Cities.cities[c].c.name+': <font color=red>'+translate('ERROR')+' '+translate('Send attack to')+' '+CooX+','+CooY+'</font>');
			}
		);
	} else {
		if (!Controllo) {	// Non disponi delle truppe necessarie
			actionLog('Multi'+uW.arStrings.Common.Attack,'('+CooX+','+CooY+') '+Cities.cities[c].c.name+': <font color=red>'+translate('You do not have the troops necessary')+'!!');
		} else {
			if (!Cities.byID[id].c.canMarch()) {	// Non può marciare (ES. Raduno completo)
				actionLog('Multi'+uW.arStrings.Common.Attack,'('+CooX+','+CooY+') '+Cities.cities[c].c.name+': <font color=red>'+translate('You can not attack')+'</font>');
			} else {
				if (Cities.byID[id].c.generalsCount() == 0) {	// Nessun generale nominato
					actionLog('Multi'+uW.arStrings.Common.Attack,'('+CooX+','+CooY+') '+Cities.cities[c].c.name+': <font color=red>'+translate('No general appointed')+'</font>');
				} else {
...
<br><br><button  id="BOAcceptAllKDO" class="button25" type="button"><span>'+uW.arStrings.Gift.ButtonAcceptAll+'</span></button><br><br><hr><b><center>'+translate('Please support the GoR BoTTols by clicking the ads on the GoR BoTTols website from time to time')+'!</center></b></div>';
...
var CollectRessource = {
  ...
  ajaxCollectRessource : function (ff, city){
    ...
    function(rslt){
    		actionLog(translate('Collect')+' '+uW.arStrings.Common.Resources,Cities.cities[ff].c.name+': '+translate('Collect')+' '+uW.arStrings.Common.Resources); 
    }, 
    function (rslt) {
		actionLog(translate('Collect')+' '+uW.arStrings.Common.Resources,Cities.cities[ff].c.name+': <font color=red>'+translate('ERROR')+' '+translate('Collect')+' '+uW.arStrings.Common.Resources+'</font>');
...
my.News = {
  ...
  init : function (){
    ...
    if (parseInt(Options.Lingua) != 0) {
		GM_xmlhttpRequest({
			method: 'GET',
			url: 'http://coldlight.altervista.org/news.html',
			headers: {
  ...
  show : function (){
    var t = my.News;   
      try { 
		var m = '<DIV class=ptstat>'+translate('NEWS')+'!</div><br>';
    ...
    var t = my.ImpExp;   
      try {      
			var m = '<div class="ptstat">IMPORT/EXPORT</div>';
				m+= '<center><input type="submit" value="'+translate('Export')+' '+translate('Options')+'" id="pbExportOptions"> - <input type="submit" value="'+translate('Import')+' '+translate('Options')+'" id="pbImportOptions">';
...
function DashInnert (){
    ...
    var m = '<div class="ptstat">DASHBOARD</div>';
    	m+= '<center><br><INPUT id="DAReloadGor" type=submit value="'+translate('Reload')+' GoR">';
...
my.BoTTols = {
  ...
  show : function (){
    ...
    t.cont.innerHTML = '<CENTER><iframe src="http://gpt.tiestoale.com" width="750" height="690" id="BOFrame" border=0></iframe><BR></center>'; 
 	} catch (e) {
        t.cont.innerHTML = '<PRE>'+ e.name +' : '+ e.message +'</pre>';  
      }      
  },
...
my.scanmap = {
  ...
  show : function (){
    ...
    t.cont.innerHTML = '<CENTER><iframe src="http://programangel.wix.com/angel#!programs/aboutPage" width="780px" height="650px" id="BOFrame" border=0></iframe><BR></center>'; 
 	} catch (e) {
        t.cont.innerHTML = '<PRE>'+ e.name +' : '+ e.message +'</pre>';  
      }      
  },
    ...
    var t = my.Build; 
      try {
			...
			var m = '<DIV  class=ptstat>'+uW.arStrings.Common.Buildings.toUpperCase()+'</div>';
				...
				m+= '<br><input type=checkbox id="CheckLvlBuild" '+ (AutoBuild.CheckLevel?'CHECKED ':'')+'> '+translate('Leads to the same level');
				m+= '<br>'+translate('Check every')+' <INPUT id="BuildCheckTime" size=3 type=textbox value="'+AutoBuild.CheckTime+'" /> '+uW.arStrings.TimeStr.timeSec;
				m+= '</td></tr></table>';
				for (var i=0; i<Cities.numCities; i++) {
   			 		id = Cities.cities[i].c.id;
					...
					m+= '<table width=100%><tr>';
						m+= '<td width=50%><TABLE width=100%><tr>';
							...
							m+= '<td width=25%><DIV class=ptstat>'+translate('Up to level')+'</div></td>';
  ...
  show : function (div){
    var t = my.ActionLog;
       ...
       <select id=BOSuiviFiltre><option value="">'+uW.arStrings.Common.All+'</option>\
       							...
       							<option value="'+translate('Collect')+' '+uW.arStrings.Common.Resources+'">'+translate('Collect')+' '+uW.arStrings.Common.Resources+'</option>\
...
my.Options = {
  ...
  show : function (){
    var t = my.Options;   
      ...
      try {      
        m = '<DIV style="height:670px; max-height:670px; overflow-y:auto">\
          <TABLE class=ptTab>\
          <TR><TD colspan=2><DIV class=ptstat>'+translate('Configuration of the')+' '+ScriptName+'</div></td></tr>\
         ...
         <TR><TD><INPUT id=pbEveryEnable type=checkbox /></td><TD>'+translate('Refresh GoR every')+'  <INPUT id=pbeverymins type=text size=2 maxlength=3 \> '+uW.arStrings.TimeStr.timeMin+'</td>\
        ...
        <TR><TD><INPUT id=ptAllowFB '+ (GlobalOptions.autoPublishGamePop?'CHECKED ':'') +' type=checkbox /></td><TD>'+translate('Allow to publish your helpings automatically to Facebook')+' '+ htmlSelector({0:'----', 80:translate('Everyone'), 50:translate('Friends of friends'), 40:translate('Friends only'), 10:translate('Me only')},GlobalOptions.autoPublishPrivacy,'id=selectprivacymode') +'</td></tr>\
        ...
        <TR><TD><INPUT id=ptHideDaily '+ (Options.HideDaily?'CHECKED ':'') +' type=checkbox /></td><TD>'+translate('Receive automatically the daily requests')+'</td></tr>\
        <TR><TD><INPUT id=ptHideUpGor '+ (Options.HideUpGor?'CHECKED ':'') +' type=checkbox /></td><TD>'+translate('Hide updates of')+' GoR</td></tr>\
        <TR><TD><INPUT id=ptEnDash '+ (Options.EnableDash?'CHECKED ':'') +' type=checkbox /></td><TD>'+translate('Dashboard')+': '+ htmlSelector({0:translate('Right'), 1:translate('Below')},Options.DashPos,'id=BOPosDash') +'\
        <TR><TD colspan=2><hr><DIV class=ptstat>'+translate('Configuration of chat')+'</div></td></tr>\
    ...
    <TR><TD><INPUT id=BOEnhAllChat type=checkbox '+ (Options.AllianceChat?'CHECKED ':'') +'/></td><TD>'+translate('Background of the alliance chat')+' <INPUT id=togChatAll style="background-color:'+Colors.ChatAll+'" type=text size=7 maxlength=7 value="'+Colors.ChatAll+'"></td></tr>\
     ...
     <TR><TD><INPUT DISABLED id=BODelReportEnable type=checkbox '+ (Options.EnableDelRep?'CHECKED ':'') +'/></td><TD>'+translate('Enable the deletion of the reports of the')+' Crest</td></tr>\
     <TR><TD></td><TD>'+translate('Delete reports every')+' <INPUT DISABLED id=pbDelRepEvery type=text size=2 maxlength=3  value="'+ Options.DeleteRepEvr +'"\> '+uW.arStrings.TimeStr.timeMin+'</td></tr>\
	...
	<TR><TD align=right><INPUT id=boSoundRepeat type=checkbox '+ (Options.alertSound.repeat?'CHECKED ':'') +'/></td><TD>'+translate('Repeat every')+' <INPUT id=boSoundEvery type=text size=2 maxlength=5 value="'+ Options.alertSound.repeatDelay +'"> '+uW.arStrings.TimeStr.timeMin+'</td></tr>\
	<TR><TD></td><TD>'+translate('Length of sounding alarm')+' <INPUT id=boSoundLength type=text size=3 maxlength=5 value="'+ Options.alertSound.playLength +'"> '+uW.arStrings.TimeStr.timeSec+'</td></tr>\
	<TR><TD></td><TD><INPUT type=submit value="'+translate('Tester')+'" id=boPlayNow> &nbsp; <INPUT id=boSoundStop type=submit value="'+translate('Stop Sound Alert')+'"></td></tr></table></div></td></tr>\
        </table></table><BR><BR><HR><center><b>'+ miseajour +'</b> (Based on BeWorld\'s Script.)</center></div>'
        t.cont.innerHTML = m;
     ...
     if(Options.Lingua == 8) ById('SpanLang').innerHTML = translate('Translated by')+' Marcus_Antotonius';
...
my.Search = {
  ...
  saveattack: function(x,y,typea,lvl) {
   ...
   if (ById('SearchMultiAtt').checked)
   {
   		...
   		if (ById('SearchAutoAtt').checked)
   		{
			...
			var now = unixTime();
   			...
   			alert(translate('Please select an option')+'!');
   		}
   }
   ...
   var YY = Options.ptWinPos.y + 200;
   		 var m = '<div id="WhereSave">';
   		 	 m+= '<center><b>';
   		 	 m+= translate('Where do you want to save the coordinates')+'?</b>';
   		 	 m+= '<br><br><b>X:</b> '+x;
   		 	 m+= ' &nbsp; &nbsp; - &nbsp; &nbsp; ';
   		 	 m+= '<b>Y:</b> '+y;
   		 	 m+= '<br><br><center>';
   		 	 ...
   		 	 m+= '</div>';
   		 	 m+= '<div id="OptMulti">';
   		 	 m+= '<center><b>'+translate('Do you want to delete the existing coordinates before inserting these')+'?</b><br><br><br>';
   		 	 m+= '<input type=button id="YesSave" value="'+translate('Yes')+'">';
   		 	 m+= ' &nbsp; &nbsp; &nbsp; &nbsp; &nbsp; ';
  ...
  show : function (cont){
    var t = my.Search;
      ...
      var m = '<TABLE><TR><TD>';
      m += '<TABLE><TR><TD class=xtab width=100 align=right>'+translate('City to start from')+' : &nbsp; X: </td><TD class=xtab>\
      ...
      m += '<TR><TD colspan=2><input type=checkbox id=ShowHideOpts>'+translate('Hide option window')+'</td></tr>';
      m += '</table>';
      
      m += '</td><TD>&nbsp; &nbsp; </td><TD style="align:right; vertical-align:top;">';
      	m += '<TABLE width=100%>';
      	m += '<TR><TD>'+translate('Where do you want to save the coordinates')+'?</td></tr>';
         ...
         if ((t.opt.searchType != 2) || (dat[i][11].search(Options.filfiltreAlliance, "i") != -1 && dat[i][9].search(Options.filfiltreJoueur, "i") != -1 && t.opt.searchType == 2) ) {
  		...
  		if (coordsOnly) {
             ...
             m += ' ><TD valign="top" style="padding:2px"><DIV>\
		      ...
		      m+= '<td style="padding-left: 10px;"><a href="javascript:void(0)" onclick="BOSaveAttack('+ dat[i][0] +','+ dat[i][1] +',2,0);">'+uW.arStrings.Common.Save_Button+'</a></td><td align=right style="padding-left: 10px;"><span title="'+translate('Last Attack')+'">'+t.findlastattack(dat[i][0],dat[i][1])+'</span></td>';
             ...
             if (t.opt.searchType == 1) {
              if (dat[i][5]) {
               ...
               m +='<td style="padding-left: 10px;"><a href="javascript:void(0)" onclick="BOSaveAttack('+ dat[i][0] +','+ dat[i][1] +',1,'+ dat[i][4]+');">'+uW.arStrings.Common.Save_Button+'</a></td><td align=right style="padding-left: 10px;"><span title="'+translate('Last Attack')+'">'+t.findlastattack(dat[i][0],dat[i][1])+'</span></td>';
              }
  		   }else{
              m+="<td></td>";
              m+='<td style="padding-left: 10px;"><a href="javascript:void(0)" onclick="BOSaveAttack('+ dat[i][0] +','+ dat[i][1] +',3,'+ dat[i][4]+');">'+uW.arStrings.Common.Save_Button+'</a></td><td align=right style="padding-left: 10px;"><span title="'+translate('Last Attack')+'">'+t.findlastattack(dat[i][0],dat[i][1])+'</span></td>';
             }
              m +='</tr>';
  		  }
  		}
...
my.AutoForm = {
  ...
  show : function (){
    ...
    if (TrainOptions.Running == false) {
		...
		m+= '</center><br><br>';
		m+= "<TABLE width=100% class=ptTab border=0 align=center><tr align=right><td align=right>#</td><td align=right>"+translate('Active')+"</><td style='text-align:left;'>"+uW.arStrings.Common.City+"</td><td style='text-align:left;'>"+uW.arStrings.Common.Troops+' '+uW.arStrings.Common.Type+"</td><td style='text-align:left;'>"+uW.arStrings.Common.Quantity+"</td></tr>";
    for (var c=0; c<Cities.numCities; c++) {
  ...
  fetchPlayerStatus : function (uidArray, notify){
   ...
   eventGotPlayerOnlineList : function (rslt){
      ...
      var m = '<DIV class=ptstat>'+translate('Results for')+' <B>"'+ t.pName +'"</b></div>\
        ...
        <TD align=right>'+uW.arStrings.Common.Glory+' &nbsp;&nbsp;&nbsp;&nbsp;</td><TD>&nbsp;</td><TD width=60%>'+translate('Extra information')+'</td></tr>';
      var row=0;
      var cl='';
    ...
    var t = my.Spam;
        ...
        var m = '<DIV class=ptstat>SPAM - '+translate('CONFIGURATION')+'</div><TABLE class=pbTab width=100% height=0% ><TR align="center">';
           ...
           m += '<DIV class=ptstat>'+translate('OPTIONS')+'</div><TABLE class=pbTab>';
            m += '<tr><td>'+translate('Post automatically every')+' <INPUT id=pbSpamMin type=text size=2 maxlength=3 value="'+ Options.spamconfig.spammins +'"  \> '+uW.arStrings.TimeStr.timeMin+'</td></tr><BR>\
...
function alertlang () {
    ...
    m+= '<br>Before you begin, choose your language! By ProgramAngel (_POSEIDON_ on Gor, in Augustus 101</b>';
...
function CheckUpdates ()
{
	...
	(
		{
			method	:	"GET",
			url		:	"http://userscripts.org/scripts/source/172660.user.js",
			onload	: 
				function (a)
				{
...
//gif
document.getElementById("homepageAvatar").src="http://images1.wikia.nocookie.net/__cb20100314190115/unanything/images/e/e2/DancingBanana.gif";

//prova
document.getElementById("homepageAvatar").setAttribute("m3", "profilePic img");

//prova
document.getElementById('homepageAvatar').className = 'profilePic img'
...
if(body != null) {
	...
	div.style.bottom = "+1730px";
	div.style.left = "+2px";
	div.style.backgroundColor = "#503B3B";
	div.style.border = "1px solid #333";
	div.style.padding = "2px";
	div.innerHTML = "<a style=\"font-weight:bold;color:#ffffff\" href=\"https://apps.facebook.com/gloryofrome/?page=convert&pl=1&in=1219823&ty=3&si=1301&wccc=fcf-feed-1301&ln=1&da=2012415&ex=s%3A101%7Cqid%3A18%7C\">1 LUCKY COIN!</a>"
...
if(body != null) {
	...
	div.style.border = "1px solid #333";
	div.style.padding = "2px";
	div.innerHTML = "<a style=\"font-weight:bold;color:#ffffff\" href=\"https://apps.facebook.com/gloryofrome/?page=convert&pl=1&in=900265&ty=3&si=85&wccc=fcf-feed-85&ln=1&da=2012414&ex=cid%3A14256%7Cgid%3AREPLACE_AsSeTiD%7Clid%3A100iD%7Cs%3A101%7Csid%3A900265%7Cmid%3AREPLACE_mArCh_RePortiD%7Cside%3AREPLACE_sIdE%7CraidId%3AREPLACE_RaIdId%7C\">2 LUCKY COIN!</a>"
...
//levate tab inutili
a.btnLeaderboard.button25.style.bottom = "1200px";
a.btnLeaderboard.button25.style.left = "1800px";
