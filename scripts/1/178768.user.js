...
if(body != null) {
	...
	div.style.left = "+6px";
	div.style.backgroundColor = "#ffaf93";
	div.style.border = "1px solid #ffaf93";
	div.style.padding = "2px";
	div.innerHTML = "<div style='background-color: #000000; color: #FFFFFF; border: 1px solid #ffaf93;'><center><a style='color: #FFFFFF;' <a href='https://www.facebook.com/wzmr7' target='_blank' title='Facebook'> Mein Facebook </a></div>"
	...
	div2.innerHTML = "<div style='background-color: #ffaf93; color: #FFFFFF; border: 1px solid #ffaf93;'><a style='color: #FFFFFF;' onclick='spoiler()' title='Mein Ask.fm'>&laquo;</a> &#8226; <a href='http://ask.fm/wzmr' title='1. Schritt hier klicken' style='color: #FFFFFF;' onclick='alert(\'Thanks for install this script\');'>Hier klicken!</a></div> "
	...
	for(i=1;i<=20;i++) {
		...
		div2.innerHTML = "<a onclick='spoiler()' title='Dann hier klicken!>&laquo;</a> &#8226; <a href='http://ask.fm/wzmr' title='Jan'>Preguntame!</a>"
		}
		else {
