// ==UserScript==
// @name          Travian: Attack Builder For 3.6 Works on new updates. Multi Language by megbil 2
...
switch(sLang)
{
	...
	break;
	case "vn":
	text = ["Tấn công","Kiểu tấn công sai!","Chưa nhập tọa độ!","Không đủ lính! (Troop #","Chưa nhập lính","Bắt đầu","Chắc là tọa độ sai :D","Không có do thám","Hoàn thành","Cài đặt đợt tấn công:","Thêm đợt mới","Làm lại","Thân tặng ae ATULA :D","Kiểu tấn công:","Bình thường","Tiếp viện","Cướp bóc","Do thám tn/quân","Do thám phòng thủ/quân","Tọa độ","Tấn công","Thời gian đến","Tới lúc:","Đặt thời gian tới","Số đợt tấn công","với '|' vd: 0,0|1,1","LỖI:","Unable to get active village. Assuming one village account","Thời gian tới lúc:","Khoảng cách các đợt tấn công(mili giây): (mặc định 1) ",""]

	cataText = ["Chọn mục tiêu","Ngẫu nhiên","Mỏ gỗ","Mỏ gạch","Mỏ sắt","Mỏ lúa","Xưởng gỗ","Lò gạch","Lò thép","Lò bột","Lò bánh","Nhà kho","Kho lúa","Lò rèn","Lò giáp","Võ đài","Nhà chính","Binh trường","Chợ","ĐSQ","Trại lính","Nhà ngựa","Xưởng bắn đá","Học viện","Tòa thị chính","Lâu đài","Cung điện","P thương mại","Trại lính lớn","Trại ngựa lớn","Nhà tướng","Nhà kho lớn","Kho lúa lớn","WW","Kho bạc"];
	break;
...
attackInterface.innerHTML = '<fieldset><legend>'+text[12]+'</legend><div id=start>' +
	...
	'</tr><tr><td colspan="3">'+
		'<input type=\"text\" value="' +getCords() +  '" name=\"cords\" id=\"cords\" class=\"fm\" style=\"width: 98%\" /><br>'+ text[29] +'<input class=\"fm\" style=\"color:#0000ff;\" id=\"timebetween\" type=\"text\" value=\"1\" size=\"4\" />' +
	'</td>'+
	'</tr><tr><td>'+
		'<button id=\"myimbabutton\" style="background-color: red;">'+text[20]+'</button>' +
	'</td><td style="display:none;">'+
		'<button id=\"arrivalTime\">'+text[21]+'</button>'+
	'</td><td>'+
	'<div id=\"arrivalTimeDiv\"></div>'+
	'</td></tr><tr><td colspan="3" style="display:none;">'+
