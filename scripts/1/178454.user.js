...
if (page.url.indexOf('youtube.com/watch') != -1) {
  ...
  if (!ytPlayerWindow) {
	...
	if (ytVideoCode) {
	  ...
	  if (myVideoCode) {
	    ...
	    if (ytVideo.match(/&sig=/)) ytVideo = ytVideo.replace (/&sig=/, '&signature=');
	      ...
	      if (ytSig) {
		var s = ytSig[1].split('');
		s = s.slice(30, 87).reverse().join('') + s[88] + s.slice(9, 29).reverse().join('') + s.slice(0, 3).reverse().join('');
	...
	/* Create Player */
	var ytDefaultVideo = 'High Definition MP4';
	player = {
...
// =====DailyMotion===== //
  ...
  if (!dmPlayerWindow) {
	...
	/* Create Player */
	var dmDefaultVideo = 'High Definition MP4';
	player = {
...
// =====Vimeo===== //
  ...
  if (!viPlayerWindow) {
	...
	for (var viVideoCode in viVideoFormats) {
      ...
      if (viVideoFound) {
	/* Create Player */
	var viDefaultVideo = 'High Definition MP4';
...
// =====Break===== //
  ...
  if (!brPlayerWindow) {
	...
	/* Create Player */
	var brDefaultVideo = 'High Definition MP4';
...
// =====FunnyOrDie===== //
  ...
  if (!fodPlayerWindow) {
	...
	/* Create Player */
	fodDefaultVideo = 'High Definition MP4';
	player = {
...
// =====Videojug===== //
  ...
  if (!vjPlayerWindow) {
	...
	/* Create Player */
	var vjDefaultVideo = 'High Definition MP4';
	player = {
...
// =====Blip===== //
  ...
  if (!blipPlayerWindow) {
    ...
    if (blipVideosContent) {
      ...
      var blipDefaultVideo = 'High Definition MP4';
...
// =====Veoh===== //
  ...
  if (!veVideoContainer || !veVideoPlayer) {
	...
	/* Create Player */
	var veDefaultVideo = 'High Definition MP4';
	player = {
...
// =====Crackle===== //
  ...
  if (!crPlayerWindow) {
	...
	crVideoList[myVideoCode] = crVideo;
      ...
      /* Create Player */
      var crDefaultVideo = 'High Definition MP4';
      player = {
