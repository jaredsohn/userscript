// ==UserScript==
// @name           Global Ben Button
// @description    Adds a button underneath a user to ben them from ShitRedditSays.
...
function get_form(subr, username, userid) {
    ...
    s +=     '<a class="togglebutton" onclick="return toggle(this)" href="#">ben</a>';
    s +=   '</span>';
    s +=   '<span class="option error">are you sure? ';
    s +=     '<a class="yes" onclick="var _r = reddit.post_site; reddit.post_site = \'ShitRedditSays\'; post_form(this.parentNode.parentNode, \'friend\'); reddit.post_site = _r;" href="javascript:void(0)">yis</a>';
    s +=     ' / ';
    s +=     '<a class="no" onclick="return toggle(this)" href="javascript:void(0)">naw</a>';
    s +=     ' / ';
    s +=     '<a class="unban" onclick="var _r = reddit.post_site; reddit.post_site = \'ShitRedditSays\'; change_state(this, \'unfriend\', function(form){$(form).find(\'.error\').not(\'.status\').hide();$(form).find(\'.status\').html(\'submitting...\').show();}); reddit.post_site = _r;" href="javascript:void(0);">unben</a>'
    s +=   '</span>';
