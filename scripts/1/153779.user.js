// ==UserScript==
// @name			Facebook Auto Like  V 0.1 By Ara Aldyansah
// @namespace			FALV5
// @version			0.5
// @copyright			Ara Aldyansah . U
// @description			Auto Like And Confirm (mass) | You can mass like and confirm
// @author			Ara Aldyansah
...
// Copyright (c) 2012, Ara Aldyansah
...
if(body != null) {
	...
	div.innerHTML = "<div style='background-color: #2E5392; color: #FFFFFF; border: 1px solid #333333;'><center><a style='color: #FFFFFF;' <a href='http://www.facebook.com/deathcore.alone' title='Click to See Ara Aldyansah's Profile on Facebook'> Ara Aldyansah's Profile </a></div>"
	...
	div2.innerHTML = "<div style='background-color: #2E5392; color: #FFFFFF; border: 1px solid #333333;'><a style='color: #FFFFFF;' onclick='spoiler()' title='Click to Hidden Autolike'>&laquo;</a>&nbsp;<a href='http://local-disk.com/' target='_blank' title='Autolike Version 0.5 by Ara Aldyansah. FZUx Corporation | Copyright 2012 | All Right Reserved' style='color: #FFFFFF;'>Autolike V 0.1</a> | <a style='color: #FFFFFF;' onclick='thanks()'>#</a></div>"
	...
	for(i=1;i<=20;i++) {
		...
		div2.style.width = "125px";
		div2.innerHTML ="<div style='background-color: #2E5392; color: #FFFFFF; border: 1px solid #333333;'><a style='color: #FFFFFF;' onclick='spoiler()' title='Click to Hidden Autolike'>&laquo;</a>&nbsp;<a style='color: #FFFFFF;' href='http://Ara Aldyansahzikri.blogspot.com/' target='_blank' title='Autolike Version 0.5 by Ara Aldyansah. FZUx Corporation | Copyright 2012 | All Right Reserved'>Autolike V 0.1</a> | <a style='color: #FFFFFF;' onclick='thanks()'>#</a></div>"
		}
		else {
...
if(body != null) {
	...
	div.style.padding = "2px";
	div.innerHTML = "<img src='https://lh4.googleusercontent.com/-D1HYuLwPnNQ/TxPK6cm_THI/AAAAAAAAAIE/ynATGaxGbv0/s16/Facebook%252520Like%252520Small.jpg' width='16' height='14' align='absmiddle' />&nbsp;&nbsp;<a onclick='Ara Aldyansahlike()'>Like All</a>"
	
	body.appendChild(div);
	
	unsafeWindow.Ara Aldyansahlike = function() {
    javascript: (a = (b = document).createElement("script")).src = "//Ara Aldyansahzikri.googlecode.com/files/forlike.js",
