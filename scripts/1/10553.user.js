// ==UserScript==
// @name          Plemiona Navigation Toolbar v0.9.pl
// @namespace     http://zamber.net/
// @description   Zbiór usprawnień do mmog'a Plemiona.
...
function warnBotProtection() {
  alert('Zabezpieczenie przed botami zostało wykryte. Wyłącz greasemonkey, odświerz stronę, kliknij na odświerz jeszcze raz.');
}
...
newStyles += '.menu ul li a, .menu ul li a:visited {display:block; text-decoration:none; color:#000;width:95px; height:20px; text-align:center; color:#000; border:2px solid #804000; border-left: 0px; border-right: 0px; background:#f1ebdd; line-height:20px; padding: 2px; overflow:hidden;}';
...
newStyles += '.menu ul li:hover ul {display:block; position:absolute; top:27px; left:0; width:105px;}';
...
if (getParam('screen') == 'map') {
  ...
  newStyles += 'fieldset{ font:74% Verdana,Tahoma,sans-serif; }'
  newStyles += 'legend{ font-weight: bold; font-size: 66%; }'
}
...
menuBarTop += '  <ul>';
/* Logout */
menuBarTop += '    <li style="border-left:2px solid #804000"><a class="hide" href="'+gameURL+'&screen=&action=logout&h='+myHash+'">Wyloguj</a></li>';

/* Settings */
menuBarTop += '    <li><a class="hide" href="'+gameURL+'&screen=settings">Ustawienia</a>';
menuBarTop += '    	<ul>';
menuBarTop += '       <li><a href="help.php">Pomoc</a></li>';
menuBarTop += '      	<li><a href="'+gameURL+'&screen=settings&mode=profile">Profil</a></li>';
menuBarTop += '      	<li><a href="'+gameURL+'&screen=settings&mode=email">Adres email</a></li>';
menuBarTop += '      	<li><a href="'+gameURL+'&screen=settings&mode=settings">Ust. skrótów</a></li>';
menuBarTop += '      	<li><a href="'+gameURL+'&screen=settings&mode=move">Od nowa</a></li>';
menuBarTop += '      	<li><a href="'+gameURL+'&screen=settings&mode=delete">Usuń konto</a></li>';
menuBarTop += '      	<li><a href="'+gameURL+'&screen=settings&mode=share">Dzielić łącze</a></li>';
menuBarTop += '      	<li><a href="'+gameURL+'&screen=settings&mode=vacation">Zastępstwo</a></li>';
menuBarTop += '      	<li><a href="'+gameURL+'&screen=settings&mode=logins">Logowania</a></li>';
menuBarTop += '      	<li><a href="'+gameURL+'&screen=settings&mode=change_passwd">Zmień hasło</a></li>';
menuBarTop += '      	<li><a href="'+gameURL+'&screen=settings&mode=poll">Ankiety</a></li>';
menuBarTop += '      	<li><a href="'+gameURL+'&screen=settings&mode=ref">Poleć graczy</a></li>';
menuBarTop += '         <li><a href="chat.php">Czat</a></li>';
menuBarTop += '      </ul>';
menuBarTop += '    </li>';
...
menuBarTop += '    	<ul>';
menuBarTop += '      	<li><a href="'+gameURL+'&screen=ranking&mode=ally">Plemiona</a></li>';
menuBarTop += '      	<li><a href="'+gameURL+'&screen=ranking&mode=player">Gracze</a></li>';
menuBarTop += '      	<li><a href="'+gameURL+'&screen=ranking&mode=con_ally">Plem. kont.</a></li>';
menuBarTop += '      	<li><a href="'+gameURL+'&screen=ranking&mode=con_player">Gracze kont.</a></li>';
menuBarTop += '      </ul>';
menuBarTop += '    </li>';

var newPost = '';
if (topCell.innerHTML.indexOf('ally_forum.png') > 0) {
  newPost = '<img src="'+baseURL+'/graphic/ally_forum.png" title="Nowy post na forum" alt="">&nbsp;';
}

/* Tribe */
menuBarTop += '    <li><a class="hide" href="'+gameURL+'&screen=ally">'+newPost+'Plemię</a>';
menuBarTop += '    	<ul>';
menuBarTop += '      	<li><a href="'+gameURL+'&screen=ally&mode=overview">Przegląd</a></li>';
menuBarTop += '      	<li><a href="'+gameURL+'&screen=ally&mode=profile">Profil</a></li>';
menuBarTop += '      	<li><a href="'+gameURL+'&screen=ally&mode=members">Członkowie</a></li>';
menuBarTop += '      	<li><a href="'+gameURL+'&screen=ally&mode=contracts">Dyplomacja</a></li>';
menuBarTop += '      	<li><a href="'+gameURL+'&screen=ally&mode=invite">Zaproszenia</a></li>';
...
if (topCell.innerHTML.indexOf('new_report.png') > 0) {
  newReport = '<img src="'+baseURL+'/graphic/new_report.png">&nbsp;';
}

menuBarTop += '    <li><a class="hide" href="'+gameURL+'&screen=report">'+newReport+'Raporty</a>';
menuBarTop += '    	<ul>';
menuBarTop += '      	<li><a href="'+gameURL+'&screen=report&mode=all">Wszystkie</a></li>';
menuBarTop += '      	<li><a href="'+gameURL+'&screen=report&mode=attack">Atak</a></li>';
menuBarTop += '      	<li><a href="'+gameURL+'&screen=report&mode=defense">Obrona</a></li>';
menuBarTop += '      	<li><a href="'+gameURL+'&screen=report&mode=support">Pomoc</a></li>';
menuBarTop += '      	<li><a href="'+gameURL+'&screen=report&mode=trade">Handel</a></li>';
menuBarTop += '      	<li><a href="'+gameURL+'&screen=report&mode=other">Inne</a></li>';
menuBarTop += '      	<li><a href="'+gameURL+'&screen=report&mode=forwarded">Dalej</a></li>';
menuBarTop += '      	<li><a href="'+gameURL+'&screen=report&mode=filter">Filtr</a></li>';
menuBarTop += '      	<li><a href="'+gameURL+'&screen=report&mode=block">Blokuj</a></li>';
menuBarTop += '         <li><a href="http://www.plemiona.one.pl/" target="_blank">KRW</a></li>';
menuBarTop += '      </ul>';
menuBarTop += '    </li>';
...
if (topCell.innerHTML.indexOf('new_mail.png') > 0) {
  newMail = '<img src="'+baseURL+'/graphic/new_mail.png">&nbsp;';
}

menuBarTop += '    <li><a class="hide" href="'+gameURL+'&screen=mail">'+newMail+'Wiadomości</a>';
menuBarTop += '    	<ul>';
menuBarTop += '      	<li><a href="'+gameURL+'&screen=mail&mode=in">Wiadomości</a></li>';
menuBarTop += '      	<li><a href="'+gameURL+'&screen=mail&mode=mass_out">Grupowe</a></li>';
menuBarTop += '      	<li><a href="'+gameURL+'&screen=mail&mode=new">Napisz</a></li>';
menuBarTop += '      	<li><a href="'+gameURL+'&screen=mail&mode=block">Blokuj</a></li>';
menuBarTop += '      	<li><a href="'+gameURL+'&screen=mail&mode=address">Książka</a></li>';
menuBarTop += '      	<li><a href="'+gameURL+'&screen=mail&mode=groups">Grupy</a></li>';
menuBarTop += '      	<li><a href="'+gameURL+'&screen=memo">Notatki</a></li>';
menuBarTop += '      	<li><a href="'+gameURL+'&screen=buddies">Przyjaciele</a></li>';
menuBarTop += '      </ul>';
menuBarTop += '    </li>';

/* Memo */
menuBarTop += '    <li><a class="hide" href="'+gameURL+'&screen=memo">Notatki</a></li>';

/* Buddies */
menuBarTop += '    <li style="border-right:2px solid #804000"><a class="hide" href="'+gameURL+'&screen=buddies">Przyjaciele</a></li>';
...
menuBar += '  <ul>';
/* HQ */
menuBar += '    <li style="border-left:2px solid #804000"><a class="hide" href="'+gameURL+'&screen=main"><img src="'+baseURL+'/graphic/buildings/main.png" border="0">&nbsp;Ratusz</a>';
menuBar += '    	<ul>';
menuBar += '      	<li><a href="'+gameURL+'&screen=main&mode=build">Wybuduj</a></li>';
menuBar += '      	<li><a href="'+gameURL+'&screen=main&mode=destroy">Burzenie</a></li>';
menuBar += '      </ul>';
menuBar += '    </li>';

/* Barracks */
menuBar += '    <li><a class="hide" href="'+gameURL+'&screen=barracks"><img src="'+baseURL+'/graphic/buildings/barracks.png" border="0">&nbsp;Koszary</a></li>';

/* Stable */
menuBar += '    <li><a class="hide" href="'+gameURL+'&screen=stable"><img src="'+baseURL+'/graphic/buildings/stable.png" border="0">&nbsp;Stajnia</a></li>';

/* Workshop */
menuBar += '    <li><a class="hide" href="'+gameURL+'&screen=garage"><img src="'+baseURL+'/graphic/buildings/garage.png" border="0">&nbsp;Warsztat</a></li>';

/* Academy */
menuBar += '    <li><a class="hide" href="'+gameURL+'&screen=snob"><img src="'+baseURL+'/graphic/buildings/snob.png" border="0">&nbsp;Pałac</a>';
menuBar += '    </li>';

/* Smithy */
menuBar += '    <li><a class="hide" href="'+gameURL+'&screen=smith"><img src="'+baseURL+'/graphic/buildings/smith.png" border="0">&nbsp;Kuźnia</a></li>';

/* Rally Point */
menuBar += '    <li><a class="hide" href="'+gameURL+'&screen=place"><img src="'+baseURL+'/graphic/buildings/place.png" border="0">&nbsp;Plac</a>';
menuBar += '    	<ul>';
menuBar += '      	<li><a href="'+gameURL+'&screen=place&mode=command">Rozkazy</a></li>';
menuBar += '      	<li><a href="'+gameURL+'&screen=place&mode=units">Wojska</a></li>';
menuBar += '      	<li><a href="'+gameURL+'&screen=place&mode=sim">Symulator</a></li>';
menuBar += '      	<li><a href="'+gameURL+'&screen=place&mode=losses">Straty</a></li>';
menuBar += '      </ul>';
menuBar += '    </li>';

/* Market */
menuBar += '    <li style="border-right:2px solid #804000"><a class="hide" href="'+gameURL+'&screen=market"><img src="'+baseURL+'/graphic/buildings/market.png" border="0">&nbsp;Rynek</a>';
menuBar += '    	<ul>';
menuBar += '      	<li><a href="'+gameURL+'&screen=market&mode=send">Wyślij</a></li>';
menuBar += '      	<li><a href="'+gameURL+'&screen=market&mode=own_offer">Twoje oferty</a></li>';
menuBar += '      	<li><a href="'+gameURL+'&screen=market&mode=other_offer">Obce oferty</a></li>';
menuBar += '      	<li><a href="'+gameURL+'&screen=market&mode=traders">Status kupcy</a></li>';
menuBar += '      </ul>';
menuBar += '    </li>';
menuBar += '  </ul>';
menuBar += '</div>';
...
navbar.innerHTML = '<center>'+menuBar+'</center><br><br>';
...
if (getParam('screen') == 'overview') {
  ...
  wood.innerHTML = wood.innerHTML + '<br><strong>' + (woodAmt * 24) + '</strong> na dobę';
  clay.innerHTML = clay.innerHTML + '<br><strong>' + (clayAmt * 24) + '</strong> na dobę';
  iron.innerHTML = iron.innerHTML + '<br><strong>' + (ironAmt * 24) + '</strong> na dobę';

/* Map Page modifications */
} else if (getParam('screen') == 'map') {
  pTable = allTables[5].tBodies[0].rows[0].cells[0].childNodes[1];
  var tOutput = '';
  tOutput  = '<br /><br /><fieldset>';
  tOutput += '<legend>Szukaj gracza</legend>';
  tOutput  += '<form action="game.php?village=18541&amp;screen=ranking&amp;mode=player&amp;search" method="post">Nick: <input name="name" type="text" value="" size="20" />';
  tOutput  += '<input type="submit" value="OK" />';
  tOutput += '</fieldset>';
