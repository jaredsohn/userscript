...
var langs = ['اختيار تلقائي للسان اللعبة \\ Automatic (au)',' خير الألسنة: لسان الضاد (العربية) (ar)', 'English (en)', '????????? (bg)','Bosanski (bs)','Deutsch (de)','فارسي (fa)','Français (fr)','Hrvatski (hr)','Magyar (hu)','Italiano (it)','Polski (pl)','Português (pt)','Român? (ro)','??????? (ru)','?????? (sr)','Svenska (sv)','?????????? (ua)'];
