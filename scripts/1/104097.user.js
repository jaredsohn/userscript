  ...
  showOptions : function (){
    ...
    try {
      m = '<DIV style="height:500px; max-height:500px;"><TABLE width=100% class=pbOptions cellspacing=0 cellpadding=0>\
        ...
        </table><p><b>DA Power Tools :-<SPAN class=boldRed>&nbsp;'+ (Version)+'</b></span><br>Visit&nbsp;<a href="http://userscripts.org/scripts/show/102352"target="blank"><u>Userscripts</u></a>&nbsp;for Updates & Support&nbsp;<SPAN class=boldRed>~Wigga</span></B></div>';
