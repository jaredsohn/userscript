// ==UserScript==
// @name           Script para la comunidad PSCO - T!
// @namespace      cixdesis_
// @description    Añade un botón de la comunidad PSCO a Taringa!
// @include        *taringa.net/*
// @exclude        *taringa.net/comunidades/camietas/*
// ==/UserScript==
...
byClass('menuTabs').innerHTML += "<li id=\"tabbedWTF\" class=\"tabbed\">\n <a href=\"http://www.taringa.net/comunidades/camietas/\" onclick=\"menu(\'PSCO! \', this.href);return false;\" title=\"Ir a PSCO\">PSCO! <img src=\n\"\" alt=\"\" /></a>\n</li>";
