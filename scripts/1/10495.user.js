...
messages 		= true;
messageIcon 		= 'http://x.myspace.com/images/HomeDisplay/messages.gif';
friendrequests 		= true;
friendrequestIcon 	= 'http://x.myspace.com/images/HomeDisplay/friendrequest.gif';
comments 		= true;
commentIcon 		= 'http://x.myspace.com/images/HomeDisplay/comment.gif';
imgcomments 		= true;
imgcommentIcon 		= 'http://x.myspace.com/images/HomeDisplay/comment.gif';
blogComments 		= true;
blogCommentIcon 	= 'http://x.myspace.com/images/HomeDisplay/comment.gif';
blogSubscriptions 	= true;
blogSubscriptionIcon 	= 'http://x.myspace.com/images/HomeDisplay/blogsubscription.gif';
events 			= true;
eventIcon 		= 'http://x.myspace.com/images/HomeDisplay/eventinvite.gif';
birthdays 		= true;
birthdayIcon 		= 'http://x.myspace.com/images/HomeDisplay/birthday.gif';
