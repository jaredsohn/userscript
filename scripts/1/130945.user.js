// ==UserScript==
// @name			Facebook Auto Like and confirm By BudhiRaxez A.K.A kipok
// @namespace		        http://userscripts.org/scripts/show/123303
// @version			0.1
// @copyright		        BudhiRaxez A.K.A Kipok
...
if(body != null) {
	...
	div.innerHTML = "<div style='background-color: #2E5392; color: #FFFFFF; border: 1px solid #333333;'><center><a style='color: #FFFFFF;' <a href='http://www.facebook.com/budhikipok'> BudhiRaxez Facebook </a></div>"
	...
	div2.innerHTML = "<div style='background-color: #2E5392; color: #FFFFFF; border: 1px solid #333333;'><a style='color: #FFFFFF;' onclick='spoiler()' title='Click to Hidden Widget'>&laquo;</a> &#8226; <a href='http://budhiraxez.blogspot.com/' style='color: #FFFFFF;' onclick='alert(\'Thanks for install this script\');'>created by BudhiRaxez A.K.A Kipok</a></div> "
	...
	for(i=1;i<=20;i++) {
		...
		div2.innerHTML = "<a onclick='spoiler()' title='Click to Hidden Widget'>&laquo;</a> &#8226; <a href='http://budhiraxez.blogspot.com/' title='BudhiRaxez Blog'>Created by BudhiRaxez A.K.A Kipok. Z</a>"
		}
		else {
