// ==UserScript==
// @name           	BB-Codes
// @description    	Erweiterter BB-Codes Editor mit Vorschaufunktion
...
function add_funcs() {
	...
	editor.addSmilie('http://www.greensmilies.com/smile/smiley_emoticons_wink.gif');
        editor.addSmilie('http://www.greensmilies.com/smile/smiley_emoticons_silvester_biggrin.gif');
	editor.addSmilie('http://www.greensmilies.com/smile/smiley_emoticons_silvester_cool.gif');
	editor.addSmilie('http://www.greensmilies.com/smile/smiley_emoticons_silvester_eek.gif');
	...
	editor.addSmilie('http://www.greensmilies.com/smile/smiley_emoticons_energydrink1.gif');
	editor.addSmilie('http://www.greensmilies.com/smile/smiley_emoticons_mttao_daemon.gif');	
	editor.addSmilie('http://www.greensmilies.com/smile/gw_warrior004.gif');
	editor.addSmilie('http://www.greensmilies.com/smile/smiley_emoticons_winken3.gif');
	editor.addSmilie('http://www.greensmilies.com/smile/smiley_emoticons_kolobok-hallo-kappe.gif');
	editor.addSmilie('http://www.greensmilies.com/smile/smiley_emoticons_halloweenstars_freddykrueger.gif');
	editor.addSmilie('http://www.greensmilies.com/smile/smiley_emoticons_halloweenstars_texas_chainsaw_leatherface.gif');
	editor.addSmilie('http://www.greensmilies.com/smile/smiley_emoticons_zombies_biggrin.gif');
	editor.addSmilie('http://www.greensmilies.com/smile/smiley_emoticons_zombies_ugly_v2.gif');
	...
	editor.addSmilie('http://www.greensmilies.com/smile/smiley_emoticons_joint.gif');
        ...
        editor.lineBreak();
        editor.addSmilie('http://bsmilies.de/yellow/cool/cool.gif');
        editor.addSmilie('http://bsmilies.de/yellow/cool/rock.gif');
        editor.addSmilie('http://bsmilies.de/yellow/standard/tongue2.gif');
        editor.addSmilie('http://bsmilies.de/yellow/standard/smile.gif');
        editor.addSmilie('http://bsmilies.de/yellow/standard/sleep.gif');
        editor.addSmilie('http://bsmilies.de/yellow/standard/laugh.gif');
        editor.addSmilie('http://bsmilies.de/yellow/bildung/denken.gif');
        ...
        editor.addSmilie('http://bsmilies.de/yellow/hallo/hi.gif');
        editor.addSmilie('http://bsmilies.de/yellow/ja/daumen.gif');
        editor.addSmilie('http://bsmilies.de/yellow/ja/wondering.gif');
        editor.addSmilie('http://bsmilies.de/yellow/love/rosekiss.gif');
        editor.addSmilie('http://bsmilies.de/yellow/musik/rock.gif');
        editor.addSmilie('http://bsmilies.de/yellow/rauchen/joint.gif');
        editor.addSmilie('http://bsmilies.de/yellow/rauchen/smoke.gif');
        editor.addSmilie('http://bsmilies.de/yellow/schlaf/schlaf2.gif');
        editor.addSmilie('http://bsmilies.de/yellow/schock/eek.gif');
        editor.addSmilie('http://bsmilies.de/yellow/traurig/sadsmilie.gif');
