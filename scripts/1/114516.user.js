...
Tabs.AutoTrain = {
  ...
  t.amt = Math.floor(t.idle/(cost[6])).toFixed(0);
   if (Math.floor(t.food/(cost[1]*2)) < t.amt) t.amt = Math.floor(t.food/(cost[1]*2)).toFixed(0);
   if (Math.floor(t.wood/(cost[2]*2)) < t.amt) t.amt = Math.floor(t.wood/(cost[2]*2)).toFixed(0);
   if (Math.floor(t.stone/(cost[3]*2)) < t.amt) t.amt = Math.floor(t.stone/(cost[3]*2)).toFixed(0);
   if (Math.floor(t.ore/(cost[4]*2)) < t.amt) t.amt = Math.floor(t.ore/(cost[4]*2)).toFixed(0);
