// ==UserScript==
// @name           Koc auto acceptation des cadeaux pour galatine 211 Edité par marc29
// @version        211
// @homepage       http://userscripts.org/
// @description    Ce script va accepter automatiquement tous vos cadeaux de Kingdoms of Camelot dans vos demandes Jeu Facebook. Acceptera sur le serveur 211.
				...
				if(claim_gift){
					...
					if(domain_selector && (next_button1 || next_button2)){
						for(var i=0; i<domain_selector.options.length; i++){
							if(domain_selector.options[i].value == "211"){
