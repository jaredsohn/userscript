...
if (location.href.indexOf(".the-west.") != -1 && location.href.indexOf("game.php") != -1) { 
  ...
  if (document.getElementById('westforts_js')) { return; }
    ...
    westforts_link.setAttribute('style', 'position:absolute;z-index:1000000;width:85px;cursor:pointer;text-align:center;color:#9f9f9f;font-size:12px;padding:5px 5px 0px 2px;right:30px;');
    ...
    westforts_link.onclick = function(){
      ...
      if (this.style.color != 'rgb(159, 159, 159)')
      {
