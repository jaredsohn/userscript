...
// @scriptsource	http://google.monkeyr.com/script/1.6.2/googlemonkeyr.user.js
/* StartHistory
...
//		document.addEventListener("DOMAttrModified", function(e){monkeyr.log(e.target)}, false);
		...
		this.addStyle("@namespace url(http://www.w3.org/1999/xhtml); #cnt #center_col, #cnt #foot, .mw {margin-left:0 !important; width:auto !important; max-width:100% !important;}#rhs {left:auto; !important}#botstuff .sp_cnt,#botstuff .ssp, #ires{display:none} .s{max-width:98%!important;} .vshid{display:inline} #res h3.r {white-space:normal}");
		if(UIL.Config.getHideSearch())
		{
//			this.addStyle("@namespace url(http://www.w3.org/1999/xhtml); #rcnt{margin-top:1em} #sfcnt,#sftr,#searchform{display:none!important;}#cnt{padding:0}#cnt .mw:first-child{position:absolute;top:4.5em;right:0}#rshdr .sfcc{position:absolute;top:2em;right:0}");
		...
		{
			this.addStyle("@namespace url(http://www.w3.org/1999/xhtml); #rhs {display:none} #center_col {margin-left:0 !important}");
		}
