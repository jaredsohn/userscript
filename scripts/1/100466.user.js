// ==UserScript==
// @name           BD Allianz - Extras
// @namespace      PDX
// @description    Extra Tabs für die Allianz und Black Dragon Interne Links
...
// @require			http://koc.god-like.info/update/auto-updater.php?id=100466
// ==/UserScript==

// VARS
var Version = '0.5.1';
var Versiondate = '04.06.2011';
var Scriptname = 'BD Allianz - Extras';
var ScriptTabName = "'+ getMyAlliance()[1] +'";
var AllianzName = 'Black Dragon';
var ScriptLink = 'http://userscripts.org/scripts/show/100466';
...
Tabs.BlackDragon = {
  tabOrder : 30,                    // order to place tab in top bar
  tabLabel : 'BD',            // label to show in main window tabs
  myDiv : null,
  timer : null,
  bdlinks :  'http://www.blackdragon-allianz.de',  
  
  init : function (div){    // called once, upon script startup
    var t = Tabs.BlackDragon;
    t.myDiv = div;
    div.innerHTML = "";
  },
  ...
  show : function (){         // called whenever this tab is shown
    ...
    if (Options.widescreen==true)mainPop.div.style.width = 1100 + 'px';
      ...
      t.myDiv.innerHTML = '<CENTER><iframe src="'+ t.bdlinks +'" width="100%" height="550" name="board_in_a_box" <p>Ihr Browser kann leider keine eingebetteten Frames anzeigen: Sie k&ouml;nnen die eingebettete Seite &uuml;ber den folgenden Verweis aufrufen: <a href="'+ t.bdlinks +'">Truppen Spostamenti</a></p> </iframe> <BR></center>';
...
Tabs.Chat = {
  ...
  myDiv : null,
  timer : null,
  chatlink :  'http://www.blackdragon-allianz.de/index.php?chatlogin',  
