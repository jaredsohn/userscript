// ==UserScript==
// @name           Hacker Forever Extension "By ToXx"
// @namespace      HF-EXT
// @description    Extension for Hacker Forever
// @include        http://www.hackerforever.com/
// @include        http://www.hackerforever.com/index.php
// @include        http://www.hackerforever.com/index.php?h=jail
// @include        http://www.hackerforever.com/index.php?h=joblist
// @include        http://www.hackerforever.com/index.php?h=main
// ==/UserScript==


function do_platypus_script() {
script_paste(window.document,document.evaluate('/HTML[1]/BODY[1]/DIV[1]/DIV[2]/DIV[1]/TABLE[4]/TBODY[1]/TR[1]/TD[1]/DIV[1]/A[1]', document, null, XPathResult.FIRST_ORDERED_NODE_TYPE,null).singleNodeValue,document.getElementById('jcount'),null,null);
script_paste(window.document,document.evaluate('/HTML[1]/BODY[1]/DIV[1]/DIV[2]/DIV[1]/TABLE[4]/TBODY[1]/TR[1]/TD[1]/DIV[1]/A[4]', document, null, XPathResult.FIRST_ORDERED_NODE_TYPE,null).singleNodeValue,document.getElementById('pcount'),null,null);
script_paste(window.document,document.evaluate('/HTML[1]/BODY[1]/DIV[1]/DIV[2]/DIV[1]/TABLE[4]/TBODY[1]/TR[1]/TD[1]/DIV[1]/A[2]', document, null, XPathResult.FIRST_ORDERED_NODE_TYPE,null).singleNodeValue,document.getElementById('mcount'),null,null);
script_paste(window.document,document.evaluate('/HTML[1]/BODY[1]/DIV[1]/DIV[2]/DIV[1]/TABLE[4]/TBODY[1]/TR[1]/TD[1]/DIV[1]/A[5]', document, null, XPathResult.FIRST_ORDERED_NODE_TYPE,null).singleNodeValue,document.getElementById('scount'),null,null);
