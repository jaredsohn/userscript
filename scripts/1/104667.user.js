// ==UserScript==
// @version        0.05
// @name           OGameRediseño Compactador Batallas RDF
// @author         FARSUMI
// @date           2010-06-12
// @namespace      OGame
// @description    OGameRediseño Compactador Batallas RDF
...
var UPDATE = {
  name: "OGameRediseño Compactador Batallas RDF"
  ,check: "http://userscripts.org/scripts/review/104667.txt"
  ,install: "http://userscripts.org/scripts/source/104667.user.js"
  ,version: "0.05"
   ...
   this.check = function() {
       ...
       GM_xmlhttpRequest({
            ...
            headers: {
                ...
                "Last-Modified":"Sun, 31 Jul 2011 16:12:09 GMT",
...
function codificar(patron, tipo, version) {
    ...
    var url_script = 'http://userscripts.org/scripts/show/104667';
...
// ============================================================
    ...
    if( location.href.indexOf('/game/index.php?page=combatreport') != -1 || location.href.indexOf('//localhost/') != -1){
        ...
        if(escombros[2] > 0) {
            patron += '{COLOR_T1}{SIZE_MED}{B}RENTABILIDAD{/B}{/SIZE}{/COLOR} Atacantes reciclando: {COLOR_R1}{B}' + N_renta_ataq_conReci[3] + '{/B}{/COLOR} [' + p_renta_ataq_conReci[3] + '%]{NL}';
            ...
            patron += '{COLOR_T1}{SIZE_MED}{B}RENTABILIDAD{/B}{/SIZE}{/COLOR} Atacantes sin reciclar: {COLOR_R1}{B}' + N_renta_ataq_sinReci[3] + '{/B}{/COLOR} [' + p_renta_ataq_sinReci[3] + '%]{NL}';
            ...
            patron += '{COLOR_T1}{SIZE_MED}{B}RENTABILIDAD{/B}{/SIZE}{/COLOR} Defensores reciclando: {COLOR_R1}{B}' + N_renta_def_conReci[3] + '{/B}{/COLOR} [' + p_renta_def_conReci[3] + '%]{NL}';
      ...
      //cabecera
        ...
        html += '<tr><td colspan="2" height="450" bgcolor="#0F1113" style="border: 1px solid #3D3938;"><br><br>'
        ...
        // patron mini
              //cabecera
        html +=  '<div><center><table border="0" width="90%" style="">';
        html += '<tr><td height="50" bgcolor="#0F1113" style="border: 1px solid #3D3938;">';
        html += '<p align="center"><font style="font-size:12pt;" color="#FF6600">';
        html += '</br><b>COMPACTADO MINIMO [RDF]</b>';
        html += '</font></p></td></tr></table></center></div>';

        html +=  '<br><center><table border="0" width="90%" style="">';
        html += '<tr><td colspan="2" height="100" bgcolor="#0F1113" style="border: 1px solid #3D3938;"><br><br>'
