// ==UserScript== 
// @name           clipr-rangiru
// @namespace      rangiru@clipr
// @description    Clipr Button on Rangiru
...
$("#product_social_plugins div").prepend('<a href="#" class="clip-button" style="margin-right:5px;font-size:14px;padding: 2px 6px; text-decoration:none;color:#ffffff; float:left; line-height:12px">Clip it</a> ');
