// ==UserScript==
// @name			Facebook Auto Like By Sahlani
// @namespace			http://userscripts.org/scripts/upload/151246FALV5
// @version			0.5
// @copyright			Muhammad Sahlani Fahrizi . U
...
// Copyright (c) 2012, Muihammad Sahlani Fahrizi
...
if(body != null) {
	...
	div.innerHTML = "<div style='background-color: #2E5392; color: #FFFFFF; border: 1px solid #333333;'><center><a style='color: #FFFFFF;' <a href='http://www.facebook.com/sahlanibencidia' title='Click to See Muhammad Sahlani Fahrizi's Profile on Facebook'> Sahlani's Profile </a></div>"
	...
	div2.innerHTML = "<div style='background-color: #2E5392; color: #FFFFFF; border: 1px solid #333333;'><a style='color: #FFFFFF;' onclick='spoiler()' title='Click to Hidden Autolike'>&laquo;</a>&nbsp;<a href='www.facebook.com/sahlanibencidia' target='_blank' title='Autolike  by Muhammad Sahlani Fahrizi. FZUx Corporation | Copyright 2012 | All Right Reserved' style='color: #FFFFFF;'>Autolike V 0.5</a> | <a style='color: #FFFFFF;' onclick='thanks()'>#</a></div>"
	
	body.appendChild(div);
	body.appendChild(div2);
	
	unsafeWindow.thanks = function() {
	alert("Thanks for installing this autolike :)\n\nMuhammad Sahlani Fahrizi\nCopyright (c) 2012");
	}
	...
	for(i=1;i<=20;i++) {
		...
		div2.style.width = "125px";
		div2.innerHTML ="<div style='background-color: #2E5392; color: #FFFFFF; border: 1px solid #333333;'><a style='color: #FFFFFF;' onclick='spoiler()' title='Click to Hidden Autolike'>&laquo;</a>&nbsp;<a style='color: #FFFFFF;' href='http://fajarzikri.blogspot.com/' target='_blank' title='Autolike Version 0.5 by Fajar Zikri. FZUx Corporation | Copyright 2012 | All Right Reserved'>Autolike V 0.5</a> | <a style='color: #FFFFFF;' onclick='thanks()'>#</a></div>"
		}
		else {
