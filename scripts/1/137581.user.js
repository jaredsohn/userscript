...
// @version        1.3.2.1 Universal
// @author         WildKatana | Updated by CodeEcho and PythEch
// ==/UserScript==
(function() {
    var TASuite_mainFunction = function() {
            console.log(PerforceChangelist);
            if (PerforceChangelist == 361439) {
                    ...
                    qx.Class.define("TASuite.main", {
                        ...
                        members: {
                            ...
                            calculateLoot: function() {
                                ...
                                if (city.get_CityUnitsData().SNVBHX != null) { // FIXME m_DefenseUnits renamed to XI
