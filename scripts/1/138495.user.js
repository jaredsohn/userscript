...
/*
	- Fixed the "Click frenzy" issue !!! =D =D =D
	- Probably fixed the buildings issue too !
	- Added a __DEBUG__ var. It will be useful ! ;)
	- The AutoClick can now go up to 1000 clicks per second. Does it work ? I don't know, my pc is not that powerful ! :x
	- Fixed the Chain multiplicator condition.
*/
...
var cssText = "" +
	"<style>" +
		...
		"#upgradesListContainer, #buildingsListContainer, #savesListContainer" +
		"{" +
...
var buildingTemplate = '<span class="superGood buildingName"></span> <span class="imAState howManyBought"></span> <span class="imAState">State :</span> <span class="superGood goodState">ON</span>/<span class="badState superBad currentState">OFF</span>' +
		'<div class="btns">' +
...
var upgradeTemplate = '<span class="superGood upgradeName"></span> <span class="imAState unlockedOrNot"></span> <span class="imAState">State :</span> <span class="superGood goodState">ON</span>/<span class="badState superBad currentState">OFF</span>' +
		'<div class="btns">' +
			'<a class="superBtn superGood myGoBtn">Go</a> <a class="superBtn superWarning myPauseBtn">Pause</a> <a class="superBtn superBad myRemoveBtn">Remove</a>' +
		'</div>';

var saveTemplate = '<span class="superGood saveName""></span><input type="text" class="enterNameSave" class="superFont" style="display:none;></input> <span class="imAState saveDate"></span>' +
		'<div class="btns">' +
...
var specialTemplate = '<div class="tabElem"><div style="height:20px;text-align:center;padding:10px">' +
			'<a class="superBtn superGood myGoAllBtn" style="padding:10px;font-size:16px;margin:10px;">Go all !</a> <a class="superBtn superWarning myPauseAllBtn" style="padding:10px;font-size:16px;margin:10px;">Pause all !</a> <a class="superBtn superBad myRemoveAllBtn" style="padding:10px;font-size:16px;margin:10px;">Remove all !</a>' +
		'</div></div>';
...
$("#comments").append('<div id="cheatButton" class="warning button">Cheat</div>');
...
Tools.choices = {
	...
	"chain multiplicator": {
		...
		type: "chain",
		message: "'Chain multiplicator : cookie production x' + this.params.frenzy + ' for ' + this.realTime + ' seconds !'",
		recalculateGains: true,
		params: {
			chainNumber: "1 + 0.5 * i", // i = Game.goldenCookie.chain
			chainType: "cpsChange",
			chainStop: {
				or: {
					vals: [
						"Math.random() < 0.1",
						"this.chainRealNumber > 10"
					]
				},
				vals: "this.chainRealNumber > 4"
			},
			...
			baseTime: "4 + this.chainRealNumber * 2",
		}
	},
	"cheaper": {
		active: true,
...
Game.UpdateMenu=function()
{
	...
	if (Game.onMenu === "cheat") { // Cheat menu here
    	if (typeof tools === "undefined")
    		tools = {};
    	str+='<div class="section warning">Cheat (You <span style="font-size:120%; font-weight:bold; text-decoration:underline">bad</span> boy !)</div>'+
        ...
        '<div class="listing">' +
        	'<div id="newSaveForm">' +
	            '<form>' +
		            ...
		            '<br />' +
		            '<br />' +
		            '<input type="text" id="saveCode" class="superRight superFont" disabled="1" value="' + newGame + '" style="width:100%;"></input>' +
		            '<br />' +
		            '<br />' +
	        ...
	        '</div>' +
	        '<br /><br />' + 
	        '<div class="superhidden" id="savesListContainer" style="overflow:auto;max-height:200px"></div>'+
	    '</div>' +
    	...
    	'<br>' +
    	'<br>' +
        '<div class="title">Cookie amount to keep safely (It\'s soooo safe)</div>'+ // Cookie to keep
        ...
        '<div class="listing"><small>(Note : I can\'t guarantee that the cheat will click as fast as you want. It depends on your computer.)</small></div>'+
        '<div class="listing" id="autoClickDiv">' +
        	...
        	'<span id="clickingSpeedText" class="superFont imAState"></span> <input id="clickingSpeed" type="range" name="speed" min="1" max="1000" step="1">' +
        ...
        '<div class="listing">' +
        	'<div id="newForm">' +
	            '<form>' +
	            	'<p class="superFont">' +
	            		'Building : ' +
		                '<select id="selectBuilding" class="superRight superFont"></select>' +
		            '</p>' +
		            '<br />' +
		            '<br />' +
	            	'<p class="superFont">' +
	        ...
	        '</div>' +
	        '<br /><br />' + 
	        '<div class="superhidden" id="buildingsListContainer" style="overflow:auto;max-height:200px"></div>'+
	    '</div>' +
        ...
        '<div class="listing">' +
        	'<div id="newUpgradeForm">' +
	            '<form>' +
	            	'<p class="superFont">' +
	            		'Upgrade : ' +
		                '<select id="selectUpgrade" class="superRight superFont" style="width:70%;"></select>' +
		            '</p>' +
		            '<br />' +
		            '<br />' +
	            	'<p class="superFont">' +
	        ...
	        '</div>' +
	        '<br /><br />' + 
	        '<div class="superHidden" id="upgradesListContainer" style="overflow:auto;max-height:200px"></div>'+
	    '</div>';
    }
