...
// @updateURL	   https://userscripts.org/scripts/source/165272.meta.js
// @downloadURL	   https://userscripts.org/scripts/source/165272.user.js
// @version        1.2
// @grant          metadata
// @require        https://userscripts.org/scripts/source/49700.user.js
// @require        https://ajax.googleapis.com/ajax/libs/jquery/1.9.0/jquery.min.js
// @include        htt*://*.conrad.at/*
// @match          http://*.conrad.at/*
// @match          https://*.conrad.at/*
// ==/UserScript==

var $ = unsafeWindow.jQuery;

var storeIds = new Array('2011', '2034', '2073', '2074', '2075', '2014');

$(document).ready(function() {
   
    GM_config.init('Conrad.at Lagerstatus - Optionen' ,  
    {
        'conrad_store_at': 
        {
                'label': 'Für welchen Store soll der Lagerbestand ermittelt werden?',
                'type': 'select',
                'options': { 0 : 'Graz', 1 : 'Linz', 2 : 'Salzburg', 3 : 'Vösendorf', 4 : 'Wien Meiselmarkt', 5 : 'Wien Stadlau' }, // List of possible options
                'default': '1'
        }
    });
    ...
    $( ".list-product-item" ).each(function( index ) {
        ...
        productAvailable('in-shop-available_'+pid, pid, storeIds[GM_config.get('conrad_store_at')]);
...
function productAvailable(modEl, productId, shopId)
{
    ...
    var url = 'http://www.conrad.at/ce/RetailStoreInventoryCheck.html?productcode='+productId+'&chainstoreId='+shopId;
