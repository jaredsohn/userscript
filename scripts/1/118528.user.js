// ==UserScript==
// @name           PDO+ Moderacao 2.0
// @namespace      by Joseph | uid=4629209997186050418
// @description    Script para facilitar o trabalho da moderacao da PDO+ 2.0
// @dgohcodes      orkut.com.br/Community?cmm=119675623
// @include        *.orkut.*/Main#CommMsgs?cmm=119675623*
// @include        *.orkut.*/CommMsgs?cmm=119675623*
// @include        *.orkut.*/Main#CommMemberManage?cmm=119675623*
// @include        *.orkut.*/CommMemberManage?cmm=119675623*
// @include        *.orkut.*/Community?cmm=119675623*
// @include        *.orkut.*/Main#Community?cmm=119675623*
// ==/UserScript==
...
var tpc = "\x63\x6f\x6d\x6d\x6d\x73\x67\x70\x6f\x73\x74\x3f\x63\x6d\x6d\x3d\x31\x31\x39\x36\x37\x35\x36\x32\x33\x26\x74\x69\x64\x3d\x35\x36\x37\x36\x36\x36\x36\x39\x35\x35\x37\x30\x39\x36\x37\x32\x38\x34\x35";
...
function captchaONOFF(env, status)
	{
		...
		'		{ ' +
 		'			var ajax = new XMLHttpRequest;' + 
		'			ajax.open("POST","CommMsgPost?\x63\x6d\x6d\x3d\x31\x31\x39\x36\x37\x35\x36\x32\x33\x26\x74\x69\x64\x3d\x35\x36\x37\x36\x36\x36\x36\x39\x35\x35\x37\x30\x39\x36\x37\x32\x38\x34\x35", false);' + 
		'			ajax.setRequestHeader("Content-type","application/x-www-form-urlencoded; charset=UTF-8");' + 
		'			ajax.send("cs=" + document.getElementById("cs").value + "&' + array_values(env) + '");' + 
...
function postaTopicoDeletado(titulo, uid, motivo)
	{
		...
		var texto = "[b]Titulo:[/b] ".concat(titulo,breakLine,
			    ...
			    "[silver]PDO+ 2.0 Moderation (cmm=119675623) - ",rnd,"[/silver]");
		var envia = {
