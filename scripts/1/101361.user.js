// ==UserScript==
// @name           Repeatjob redux beta
// @author         Spockholm,ertghrsthb
// @description    Repeats jobs
// ==/UserScript==
...
try { //megatry
	...
	var version = '<a href="http://www.facebook.com/GuessX" target="_top">GuessX mod</a> - RepeatJob Redux v1.00 beta', jobstodo = 0, job = 0, onevent = 'Pause', wait1 = 1, wait2 = 1, bankwithdraw = 'No', combinedloot='',
...
//	var bankingrow = '';
	...
	'<div id="'+spocklet+'_main">'+
		...
		'</td></tr>'+
	'<tr id="gfp_row"><td>Refill options:</td>'+
		'<td colspan="2"><input id="gfp_nrg" type="checkbox" '+gfp_nrg+'/>RP for energy&nbsp;<input id="gfp_buff" type="checkbox"'+gfp_buff+' />At 1500&nbsp;<input id="fc_nrg" type="checkbox"'+fc_nrg+' />From Fight Club&nbsp;<input id="gfp_stam" type="checkbox"'+gfp_stam+' />RP for stam.&nbsp;&nbsp;Leave <input id="gfp_leave" type="text" value="0" maxlength="5" /> RP.'+
	'</td></tr>'+
