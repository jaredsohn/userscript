// ==UserScript==
// @name          Amazon EBPL Lookup
// @namespace     http://ebpl.org/
// @description	  Search East Brunswick Library Catalog from Amazon book listings.
// @include       http://*.amazon.*
// ==/UserScript==
...
Save money, borrow this book from East Brunswick Public Library\
								</td>\
							</tr>\
					";
					...
					table_content = table_content + "<TR style='background-color:#ffffff; padding:8px; font-weight:bold;'><TD colspan=2><a style='color:#000000;' href='http://librarycatalog.ebpl.org/ipac20/ipac.jsp?&menu=search&index=PISBN&term=" + isbn + "'>Check if this title is available</a></td></tr>";
