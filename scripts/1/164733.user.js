// ==UserScript==
// @name       Trakt External Button (BTN, HDB)
...
$('.external-links').append('<a href="http://hdbits.org/browse2.php#film/sort=title&dir=ASC&searchtype=film&yeargt='+ Year +'&actorfilm=film&search='+ Name +'" rel="external" class="button external last" target="_blank">HDBits</a>');
};