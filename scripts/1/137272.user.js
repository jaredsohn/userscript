...
var undef;
var config_url = "http://socialfixer.com/config.json";
...
function insertAfter(el,ref) { var container, ns; if ( (container=ref.parentNode) && (ns=ref.nextSibling) ) { insertBefore(el, ns); } else if (container) { append(container,el); } }
...
/*/GM_PREFS*/
				...
				function insertStylesheet(url,id) { 
					...
					if (SCRIPT_TYPE=="grease"+"monkey" || /socialfixer\.com/i.test(url)) {
...
<div id="bfb_option_container">
	...
	<div id="bfb_options_content" class="content">
		...
		<div class="option tab_popular" tooltip-alignh="right" data-hover="tooltip" title="When you move your mouse over thumbnail images, Social Fixer will show the full-sized image in a popup, so you don't have to click on the picture to see the whole thing.">
			<div class="desc">
				%show_image_previews% Show full image previews when hovering your mouse over pictures
			</div>
		</div>
		<div class="option tab_popular" tooltip-alignh="right" data-hover="tooltip" title="Facebook sometimes groups news stories into a container and shows them as &quot;Trending Articles&quot; or &quot;Trending Videos&quot;. You can hide this by checking this option. ">
			<div class="desc">
				%hide_trending_articles% Hide "Trending Articles" and "Trending Videos"
			</div>
		</div>
		<div class="option tab_popular" tooltip-alignh="right" data-hover="tooltip" title="In February 2011, Facebook introduced a new &quot;Light Box&quot; photo viewer with a black background when you click on photos. If you don't like this new photo viewer, check this option to disable it.">
			<div class="desc">
				%disable_theater_view% Disable the "Lightbox" (aka "Theater") photo viewer popup
			</div>
		</div>
		<div class="option tab_popular" tooltip-alignh="right" data-hover="tooltip" title="If you (or your friends) play Facebook games or often use Facebook applications, Social Fixer can automatically move those posts to their own tab, so they don't interrupt the flow of the rest of your feed.">
			<div class="desc">
				%tab_all_apps% Automatically move posts from Applications (games) into their own tabs
			</div>
		</div>
		<div class="option tab_popular" tooltip-alignh="right" data-hover="tooltip" title="Facebook changed their default font size from 13px to 12px in 2010. Many users found the new font size to be too small. You can use this option to set any font size you wish.
		...
		<div class="option tab_popular" tooltip-alignh="right" data-hover="tooltip" title="When you post comments on friends' status, like pages, or take other actions on Facebook, one-line &quot;Recent Activity&quot; posts will appear in your profile and let others know what you are up to. Enable this option to automatically remove these posts every time you visit your profile.

		In the Display tab, you can select exactly which types of stories to delete, while preserving others.">
			<div class="desc">
				%auto_remove_recent_activity% Auto-remove Recent Activity posts from my profile
			</div>
		</div>
		<div class="option tab_popular" tooltip-alignh="right" data-hover="tooltip" title="By default, when entering comments, clicking Enter will submit the comment. Enable this option to restore the old functionality, where Enter = New Line, and a Comment button exists to post the message.">
			<div class="desc">
				%fix_comments% Fix "Enter" key behavior to be a newline when adding comments, rather than submit
			</div>
		</div>
		
		<div class="option tab_popular" tooltip-alignh="right" data-hover="tooltip" title="For small screens, Facebook &quot;unlocks&quot; the blue bar header. Enabling this option will force it to always be locked.">
			<div class="desc">
				%lock_header% Lock the blue header bar at the top even if the screen is small
			</div>
		</div>

		<div class="option tab_popular" tooltip-alignh="right" data-hover="tooltip" title="Facebook has a built-in feature available to most users to sort the news feed chronologically. However, this setting sometimes doesn't stick, and users need to switch it back to chronological often. This setting will automatically switch to chronological view if it detects that you are not on it.">
			<div class="desc">
		...
		<div class="option tab_popular" tooltip-alignh="right" data-hover="tooltip" title="When enabled, a &quot;reply&quot; link will appear in each post comment next to Like. When clicked, you will easily be able to reply to a specific comment, tag the person you are replying to, and even quote part of their message.">
			<div class="desc">
		...
		<div class="option tab_popular" tooltip-alignh="right" data-hover="tooltip" title="By default, Facebook shows you 15 posts. In the footer of the page is a link to &quot;Older Posts&quot; which retrieves more posts. Better Facebok can auto-click this link any number of times to retrieve more posts, so you won't miss anything.">
			<div class="desc">
				%auto_click_older_posts% Auto-click "Older Posts" %auto_click_more_times% times to get more posts
			</div>
		</div>
		<div class="option tab_popular" tooltip-alignh="right" data-hover="tooltip" title="When friends or pages post multiple posts in a small amount of time, Facebook will show just the first one, with a link to &quot;show similar posts&quot;.
		...
		<div class="option tab_popular" tooltip-alignh="right" data-hover="tooltip" title="Friends change their profile pictures often, and it can be difficult to tell who is who.

		Select this option to revert to names instead of pictures.">
			<div class="desc">
		...
		<div class="option tab_display">%alternate_read_display% Show old stories as grayed out rather than hiding them completely</div>
...
-->
	...
	<br style="clear:both;">
						...
						var render_filter_lists = function(tbody) {
							...
							get_remote_content('typeahead_new',function(response) {
								...
								var renderFilterBody = function(filter,options,tr) {
									...
									tds.push('Matching text:<br> <input class="nosave regex" name="regex" value="'+(filter.criteria.regex?htmlescape(filter.criteria.regex):'')+'" size="10"><br>Advanced:<br>Use regular expressions<br>like /text|text2/<br>( | = OR )');
									tds.push(''+
						...
						'		</div>', {'options':optionsContent,'key':this.key} );
							...
							bind('sfx_option_check_update_reset','click',function(e) {
									options.set('update_show_after',0,false);
									options.set('version_ack',0,false);
				...
				//		a('show_nav_edit_friends','checkbox',true );
						...
						a('fix_comment_cursor','checkbox', (SCRIPT_TYPE=="grease"+"monkey" || SCRIPT_TYPE=="firefox_addon" || SCRIPT_TYPE=="firefox_addon_official") );
	...
	.bfb_read, .bfb_muted, .bfb_read ~ .spinePointer { display:none !important; }
	.bfb_read.bfb_new_comments, .bfb_read.bfb_new_comments .bfb_new_comment_notif, .bfb_read.bfb_new_comments ~ .spinePointer { display:block !important; }
	.bfb_hidden,.bfb_hidden.bfb_new_comments, .bfb_hidden ~ .spinePointer { display:none !important; }
	...
	#content .bfb_show_all .bfb_processed,
	#timeline_tab_content .bfb_show_all .bfb_processed,
	#content .bfb_show_all .sfx_trending_articles
		{ display:block !important; }
	#content .bfb_show_all .bfb_duplicate { display:block !important; opacity:.5; }
...
*/
	...
	/* Feed Tabs */
	#bfb_feed_tabs .bfb_tab { font-size:110%; z-index:0; }
	...
	.bfb_tab_empty { background-color:#ddd !important; color:#aaa !important; font-style:italic !important; border:1px solid #aaa !important; }
	...
	.bfb_chat_ordered_list #pagelet_dock .item .name { max-width:100px; }
	...
	html.timeline_single_column body.timelineLayout .fbTimelineUnit { float:none !important; }
...
//						'#fbNotificationsList { max-height:'+(window.innerHeight-100)+'px !important; overflow:auto !important; } '+
						...
						if (options.get('enable_font_size')) {
							...
							if (post_size) { css2 += '.uiStreamMessage,.UIStory_Message,.mall_post_body,.timelineLayout .tlTxFe {font-size:'+post_size+'px !important;} .timelineLayout .tlTxFe { line-height:'+(+post_size+2)+'px !important; } '; }
...
//							if (QS(o,'.checkableListItem')) {
								if ($('bfb_select_all_friends')==null) {
									var dialog_content = parent(o,'.dialog_content,.-cx-PRIVATE-uiDialog__content');
									...
									var select_all = button('Select All',function() { 
										...
										all_links=[];
										QSA(dialog_content,'.checkableListItem a.anchor',function(a) { 
											all_links.push(a);
										});
...
//							}
						...
						if (maxOlderPostsClickCount>0) {
							onIdLoad('pagelet_stream_pager',function() { delayedFindAndClickOlderPosts(2500); });
							onIdLoad('profile_pager',function(){ delayedFindAndClickOlderPosts(2500) });
						...
						if (options.get('auto_subscribe_news') && !options.get('auto_subscribe_news_done')) {
							onSelectorLoad('#pinnedNav',function(o) {
								if (!QS(o,'#navItem_fl_10150970104052276')) {
									var data = {
										'__a':1,
										'fb_dtsg':$Env('fb_dtsg'),
										'__user':userid
				...
				//				if (is_timeline()) { return; }
							...
							if (cn && cn.length) {
								...
								for (var i=0; i<L; i++) {
									...
									if (!hasClass(o,"bfb_duplicate") && !hasClass(o,'sfx_trending_articles') && !hasClass(o,'UIRecentActivity_Stream')) {
										...
										else if (!hasClass(o,'bfb_hidden') && !hasClass(o,'sfx_trending_articles')&& (!hasClass(o,'bfb_read') || hasClass(o,'bfb_new_comments'))) {
											c++;
										}
									}
								}
						...
						function fixStory(o,isPageOrProfile,isGroupWall) {
							...
							if (hide_trending) {
								var trending = QS(o,'.ogStaticPagerHeader,.ogStaticSlidePagerUserHeader,.ogSliderAnimPageHeader');
								if (trending) {
				...
				//			}
					...
					//					update_status('bfb_status_expanded',++count_expanded);
							...
							if (!isGroupWall && (reorder || (tabbed && reorder_tabbed))) {
								var reorder_debug = "";
				...
				//						window.open('https://getpocket.com/save?url='+url+'&title='+title,'SocialFixerSaver','height=500&width=500');
						...
						onSelectorLoad('#rightCol .uiSideHeader h4, #pagelet_ego_pane .uiSideHeader h4, #MessagingNetegoSidebar .uiSideHeader h4, .UIStandardFrame_SidebarAds .uiSideHeader h4, #rightCol h3.uiHeaderTitle',function(o) {
						...
						onSelectorLoad('#rightCol',function(o) {
							...
							if (options && options.get('pagelet_toggle')) {
								QSA(o,"h4,h3",function(o2) { 
									o.title="Click to expand/collapse this pagelet"; 
								...
								bind(o,'click',function(e) {
									var e = target(e);
									if (e.tagName=="H4" || e.tagName=="H3" || hasClass(e,'bfb_sidebar_header_expand')) {
										var pagelet = e;
										var pagelet_id = null;
							...
							var get_content = function(key,ignore_cache,ttl,func) {
								...
								if (ignore_cache) {
									...
									getValue(cache_key,null,function(data) {
									...
									get_content('messages',invalidate_cache,(1*weeks),function(message_list) {
										...
										for (var i=0;i<message_list.length; i++) {
											...
											if (m && m.id && m.id>0 && m.id>last_message_id) {
												...
												var c = pagelet_box(feed_right_column,'bfb_message_pagelet','Support Social Message',m.content);
							...
							if (options.get('tips_of_the_day')) {
								...
								// Otherwise, make sure we've gone past the time checkpoint before showing
									...
									// Get the content (perhaps cached) and display it
									get_content('tips',false,(1*weeks),function(tips) {
								...
								// If it's past the time to check, then check!
									...
									get_content('update',true,update_check_interval,function(update) {
										...
										if (update && update.version && update.version>version_ack && update.version>version) {
											var url = null;
											if (SCRIPT_TYPE=="grease"+"monkey") {url="http://SocialFixer.com/socialfixer.user.js";}
					...
					//					}
						...
						if (options.get('show_image_previews')) {
							...
							bind(document,'keydown',function(e) { if(e.keyCode==27) { hide_preview(); } })
							...
							(function() {
								...
								var do_reply = function(e) {
									...
									QS(post,'.uiUfiAddComment',function(ac) {
										...
										var actor = QS(comment,'.actorName');
										if (!actor) { return; }
...
//													ta.value = ta.value+prefix+text;
						...
						if (!$('bfb_anonymize_screen')) {
							var a = el('a',null,{href:'#',title:'Change the screen to anonymize all users (for screenshots, etc)',id:'bfb_anonymize_screen'},{
								click:function() { 
									...
									var eventhash = {};
									var eventcount = 1;
									QSA(document,'.uiProfilePhoto,.profilePic,img.bfb_friend_activity_img,.UIImageBlock_MED_Image img,#navAccountPic img,a.UIImageBlock_ENT_Image img,.smallPic .img,.fbChatOrderedList .pic',function(i) {
						...
						window.addEventListener('mousedown',function(e){
							...
							if (a && a.tagName && a.tagName=="A") {
								if (prevent_redirect && a.removeAttribute) {
							...
							(function() {
								...
								unsafeWindow.ArbiterMonitor = {
									record: function(type,i,c,a) {
										if ( unsafeWindow.console && type!='done' && !/^pagelet_event/.test(i) && !/^function_ext/.test(i) && !(/^bootload/.test(i)) && !(/^phase/.test(i)) ) {
											var msg = arguments[1];
