// ==UserScript==
// @name           Reklam Savaşçısı
// @author         Turk0 Development
// @namespace      hhttp://userscripts.org/users/turk0development
// @description    Reklamlı Siteleri Hızlı Bir Şekilde Beklemeden Geçin...
// @updateURL      http://userscripts.org/scripts/source/176782.meta.js
// @installURL     http://userscripts.org/scripts/source/176782.user.js
// @version        5.2
// @grant          unsafeWindow
...
(function () {
    ...
    var list = {
        adf: {
            ...
            fn: function () {
                cook();
                try { win.onbeforeunload = null } catch(e){ noop() };
