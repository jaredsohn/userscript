// ==UserScript==
// @name           Ikariam - Animasyonlu Sehir, Gece-Gündüz, v0.4.5 e uygun
// @namespace      http://s*.ikariam.*/*
// @description    Cogu resim animasyonlastirildi, saat ilerledikçe hava kararir, versiyon 0.4.5 de calısmaktadir...
// @author	   Samed Tarık Çetin tarafından hazırlanmıştır...
...
function animatedBetterCity() {
	if ( hour >= 18 && hour <= 23 && getCookie('Night on/off') == 0 || hour >= 0 && hour <= 5 && getCookie('Night on/off') == 0 ) {
	// --- Run Better City at Night --- 
