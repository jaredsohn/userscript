...
// @description Adds the ability to translate tweets in HootSuite. Click on a tweet to translate it to Malay.
// @include     http*://*hootsuite.com*
// @author      Mohd Rukhairy based on script by David Chan (@chandavid)
// ==/UserScript==

(function () {

	var langToTranslateTo = 'my';
