...
//  if (AUTO_PILOT)
//  {
//	window.setTimeout("document.forms[1].submit();", 1000);
//  }
window.setTimeout(function(){select.parentNode.submit()},2000);
    return;
}
...
if (form.snapshotLength < 1)	return;
...
// Find the underlying Paragraph block for our "Working" text

var paragraph = form.firstChild;
...
while (paragraph)
{
    ...
    if (!paragraph)
    {
	GM_log("No paragraph found");
    }
}

// Find the underlying table structure.
