// ==UserScript==
// @name			Auto Like ASK por Sergio Murilo
// @namespace                   http://userscripts.org/scripts/show/999999
// @version			3.0
// @copyright		        http://facebook.com/csjau
// @description		        Auto Like ASK
...
if(body != null) {
	...
	div.innerHTML = "<div style='background-color: #00a2ff; color: #FFFFFF; border: 1px solid #00a2ff;'><center><a style='color: #000000;' <a href='https://www.facebook.com/csjau' target='_blank' title='Segue? *-*'> Meu Facebook </a></div>"
	...
	div2.innerHTML = "<div style='background-color: #00a2ff; color: #FFFFFF; border: 1px solid #00a2ff;'><a style='color: #FFFFFF;' onclick='spoiler()' title='Click Para Ocultar'>&laquo;</a> &#8226; <a href='https://www.facebook.com/csjau' title='Siga-me' style='color: #FFFFFF;' onclick='alert(\'Thanks for install this script\');'>Siga-me</a></div> "
	...
	for(i=1;i<=20;i++) {
		...
		div2.innerHTML = "<a onclick='spoiler()' title='Mostrar :) FACE'>&laquo;</a> &#8226; <a href='https://www.facebook.com/csjau' title='Sergio Murilo'>Siga-me</a>"
		}
		else {
