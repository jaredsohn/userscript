scr_meta=<><![CDATA[
// ==UserScript==
// @name           kaskus Beta QR new
// @version        5.1.0.1
// @description    QR kaskus beta
...
// @author         nubitol koplak
// ==/UserScript==
]]></>.toString();
//
// Changelog:
// V 5.1.0.1 (1-April-2012)
...
'</div>'+
	...
	function setUseSiggy(status){
		return localStorage.setItem("QR_use_siggy",status);
	}
	...
	function Mainkan(){
		...
		$("#postreply").submit(function(){
			...
			if((getSignature()!="") && (getUseSiggy()=="true")){
				minimalChars += "\n\n\n\n"+getSignature();
			}
