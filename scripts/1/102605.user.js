// ==UserScript==
// @name           Powertools Ultimate Edition
// @namespace      noobs
...
//logit ('g_timeoff: '+ unsafeWindow.g_timeoff);
  ...
  var styles = '.xtab {padding-right: 5px; border:none; background:none; white-space:nowrap;}\
    ...
    .ptChatGlobal {background-color: LimeGreen}\
    .ptChatIcon {border: 3px inset blanchedalmond}\
...
if (TEST_WIDE){
  ...
  for(i=0; i<Seed.cities.length; i++){
    Seed.cities[i][1] = Seed.cities[i][1] ;
...
//logit ( 'Options.ptWinPos: '+ inspect (Options.ptWinPos, 5, 1)); 
  ...
  mainPop = new CPopup ('ptmain', Options.ptWinPos.x, Options.ptWinPos.y, 750,750, Options.ptWinDrag, 
      function (){
        tabManager.hideTab();
...
//t.fetchTEST();    
    ...
    var m = '<DIV class=ptentry><TABLE width=100% cellpadding=0>\
        ...
        <TR><TD class=xtab>OR: </td><TD class=xtab> Enter all or part of an alliance name: &nbsp;</td>\
		  ...
		  <TR><TD class=xtab>OR: <INPUT align=left id=allListSubmit type=submit value="List Alliances" /></td>\
          <TD class=xtab><INPUT align=right id=allGotoPage type=submit value="Page" />\
		    ...
		    <TD class=xtab><INPUT id=myAllSubmit type=submit value="'+ getMyAlliance()[1] +'" /> </tr>\
  ...
  init : function (div){
    ...
    try {      
      m = '<TABLE class=ptTab>\
        ...
        <TR><TD><INPUT id=togWhisperOn type=checkbox /></td><TD>Turn on Audio Whisper <SPAN class=boldRed>&nbsp;(To Deactivate Turn On Then Off)</span></td></tr>\
	 ...
	 m += '<TR><TD><INPUT id=alertEnable type=checkbox '+ (Options.alertConfig.aChat?'CHECKED ':'') +'/></td><TD>Automatically post incoming attacks to alliance chat.</td></tr>\
      ...
      m += '<TR><TD><INPUT id=togAllRpts type=checkbox /></td><TD>Enable enhanced Alliance Reports.</td></tr>\
        ...
        <TR><TD><INPUT id=togChatStuff type=checkbox /></td><TD>Enable Chat enhancements (clickable coords, lime green global messages, click on icon to whisper) <SPAN class=boldRed>&nbsp;(NEW)</span></td></tr>\
...
var AudioAlert = {
  ...
  sound : function(tf){
   var t = AudioAlert;
	...
	if(tf){
	divs.innerHTML = '<iframe src="http://www.filefreak.com/files/792876_2dzwh/ding.mp3" height="20" width="100"></iframe>';
	t.alert = true;
	} else {
            ...
            for (var j = 0; j < tx_div_collection.length; j++) {
                if (tx_div_collection[j].getAttribute("class") == "time") {
                    ...
                    if (tx_div_collection[j].innerHTML != GM_getValue("lastMsgTime")) {
                        ...
                        iframe.setAttribute("src", "http://www.filefreak.com/files/792876_2dzwh/ding.mp3");
                    ...
                    if (bS[j].innerHTML == ' whispers to you:') {
                        ...
                        if (foundMsg == false) {
							...
							//	alert('have set message value');
                                ...
                                alertDiv.innerHTML = '<iframe src="http://www.filefreak.com/files/792876_2dzwh/ding.mp3" height="20" width="100"></iframe>';
