// ==UserScript==
// @name           Saga Age Of Empires
// @namespace      KLRZ
// @description    Script para la comunidad de age of empires
// @include        *taringa.net/*
// @include        *taringa.net/posts/*
// @include        *taringa.net/comunidades/*
// @exclude        *taringa.net/comunidades/serialageofempires/*
// ==/UserScript==
...
byClass('menuTabs').innerHTML += "<li id=\"tabbedWTF\" class=\"tabbed\">\n <a href=\"http://www.taringa.net/comunidades/serialageofempires/\" onclick=\"menu(\'Klrz \', this.href);return false;\" title=\"Ir a la comunidad de Age Of Empires\">Klrz <img src=\"www.clankrlz.com.ar/favicon.ico\" alt=\"\" /></a>\n</li>";
