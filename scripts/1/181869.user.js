...
// @version        1.1
// @namespace      Alianza
// @description    Romanitos E_U_D_L_F_
// @copyright	   © (No copiamos, mezclamos) 
// @include        *gloryofrome*/*gameChrome_src.php*
// @include		   *gloryofrome*/*iframeCanvas.php*
// @include		   *gloryofrome*
// @include 	   *facebook.com/4oh4.php
// @include		   *facebook.com/dialog/feed*
// @icon           http://akihabarablues.com/wp-content/uploads/2013/01/caras-caballeros-zodiaco.jpg
// @grant       GM_getValue
// @grant		unsafeWindow
...
(function() {
var Version = '1.1';
var Autore = ' E_U_D_L_F_';
var ScriptName = 'Tabla E_U_D_L_F_';
var miseajour = ScriptName + ' ' + Version + ' - by ' + Autore;
var sitesupport = "http://johnnyduranweb.wix.com/alianzaeudlf";
...
var translateITAArray = {
	//Tools
		'Please support the GoR BoTTols by clicking the ads on the GoR BoTTols website from time to time':'Por favor, apoye a BoTTols Gor haciendo clic en los anuncios en el sitio web de vez en cuando',
		'Version':'Version',
		'available':'disponible',
		'Install':'Instalar',
		'You must belong to an alliance in order to use this feature':'Debe pertenecer a una alianza para utilizar esta funcion',
		'Translated by':'Traducido por',
		'Reload':'Recarga',
		'Set your city bunker':'Elige tu ciudad refugio',
		'Collect':'Recolecta',
		'now':'Ahora',
	//Ricerche - Build
		'Up to level':'subir al nivel',
		'Leads to the same level':'Subir al mismo nivel',
	//Germania
		'City for scout/attack':'Ciudad para explorar/atacar',
		'You can not attack a member of your alliance':'No puedes atacar a un miembro de tu alianza',
		'Wait':'Espera',
		'UPDATE':'ACTUALIZA',
		'For':'Para',
		'Force Quit':'Forzar apagado',
		'Errors':'Errores',
		'Select all':'Seleccionar todos',
		'I suggest you refresh the page. Some data may not be real':'Te sugiero refrescar la pagina, algunos datos pueden no ser correctos',
		'The attacks are many and may stop responding':'Los ataques son muchos y pueden dejar de responder',
		'Do you want to continue anyway':'Deseas continuar de todas formas',

	// Diplomacy
  		'Unaligned':'Sin alianza',
  		'Friendly To Them':'Amigable con todos',
  		'Friendly To You':'Amigable contigo',
	//Food Alert
		'My city':'Mi ciudad',
		'is running out of food':'se esta quedando sin alimentos',
		'so please send some':'por favor enviame un poco',
		'Current stock':'stock actual',
	//Tower Alerts
		'The exploration seems to come from':'La exploracion parece provenir de',
   	  	'BUNKER':'REFUGIO',
   	  	'MY TROOPS':'MIS TROPAS',
   	//Overview
   		'Joined on':'Empezaste a jugar el',
   		'World':'Mundo',
   	//Alliance Manager
   		'Alliance Manager':'Gestion de Alianza',
   		'Message Manager':'Gestion de mensajes',
   		'ALLIANCE INFO':'INFORMACION DE LA ALIANZA',
   		'MEMBERS INFO':'INFORMACION DE LOS MIEMBROS',
   		'Founder':'Creador',
   		'Avatar':'Avatar',
   		...
   		'Get Info/Member':'Obtener informacion/miembros',
   		'Enter a message':'Abrir el mensaje',
   		'Message by':'Mensaje de',
   		'Message sent to all the alliance by':'Mensaje enviado a toda la alianza por',
   		'Message sent to all officer by':'Mensaje enviado a todos los oficiales por',
   		'Read members page':'Leer pagina de miembros',
      	'Message send to':'Mensaje enviado a',
      	'Remove Member':'Elimina miembro',
      	'Sorry, but this feature is only for official':'Lo siento pero esta funcion es solo para oficiales',
      	'Do you really want to remove this user':'Realmente quieres eliminar a este usuario',
   	//Search
  	    'City to start from':'Empezar a partir de',
  	    'Launch search':'Iniciar busqueda',
  	    'SEARCH FINISHED':'BUSQUEDA FINALIZADA',
  	    'The minimum distance cannot be lower than 0':'La distancia minima no puede ser menor a 0',
    	'The distance has to be higher than 1':'La distancia debe ser superior a 1',
    	'The maximum/minimum distance has been exceeded':'La distancia maxima/minima a sido superada',
     	'The distance cannot be higher than 375':'La distancia no puede ser superior a 375',
     	'NOTE : WARNING, there is no limitation to the search, but this can have consequences on the performance of your browser':'NOTA : CUIDADO, no hay limitacion para la busqueda, pero esto puede traer consecuencias en el desarrollo de tu navegador',
     	'Hide option window':'Esconder la ventana de opciones',
     	'Not found':'No encontrado',
     	'More info':'Mas informacion',
		'Non-occupied only':'Solo sin ocupar',
		'free':'libre',
		'Minimum':'Minima',
		'Maximum':'Maximo',
		'content':'contenido',
		'Where do you want to save the coordinates':'Donde quieres guardar las coordenadas',
		'Do you want to delete the existing coordinates before inserting these':'Quieres borrar las coordenadas existentes antes de introducir estas',
		'Yes':'Si',
		'No':'No',
	//Reassing
		'Not possible to send to same city':'No es posible enviar a la misma ciudad',
   	...
   	//Transport
   		...
   		'TRANSPORTING GOODS FROM CITY TO CITY':'TRANSPORTAR RECURSOS DE CIUDAD A CIUDAD',
   		'Please put in the amount of troops you like to use':'Por favor introduzca la cantidad de tropas que desea utilizar',
   		'Please check the resource you want to transport':'Por favor revisa los recursos que deseas transportar',
   		'Send a transport every':'Enviar un transporte cada',
   		'Send transport with a minimum of':'Enviar un transporte con un minimo de',
   		'ADD A TRANSPORT':'ANNADIR UN TRANSPORTE',
   		'Available':'Disponible',
   		'Estimate':'Estimado',
   		'necessary':'necesario',
   		'Keep':'tener',
   		'Show routes':'Mostrar rutas',
   		'Add a route':'Annadir ruta',
   		'the route':'la ruta',
   		'Edit':'Modificar',
   	//Crest
   		'Help':'Ayuda',
   		'See target':'Mostrar objetivo',
   		'Add target':'Annadir objetivo',
   		'Wave':'Oleada',
   		'Do not use the general with the energy below':"No utilice un general con energia menor a",
   	//Import-Export
   		'Import':'Importar',
   		'Export':'Exportar',
    //AutoAttack 2
    	'AUTOMATED ATTACKS':'ATAQUES AUTOMATICOS',
    	'ATTACK':'ATACAR',
    	'Do not use the general with a level greater than':'No usar general con nivel mayor a',
    	'Last Attack':'Ultimo ataque',
    	'Success':'Suceso',
    	'CITY SET PARAMETERS':'PARAMETROS DE LA CIUDAD',
    //Marches
    	'OUTGOING MARCHES':'MARCHAS SALIENTES',
    	'City reinforcements':'Refuerzos de la ciudad',
    //Reports
    	'CHECK ALLIANCE REPORTS':"VER INFORMES DE LA ALIANZA",
    	'No reports found':'Sin Informes',
    	'of':'de',
    	'Outgoing attacks':'Ataques salientes',
    	'My reports only':'Solo mis informes',
		'unknown':'desconocido',
		'Number of tours':'Numero de marcha',
		'Results found':'Resultado encontrados',
		'Objects found':'Objetos encontrados',
	//Player
		'Results for':'Resultados para',
		'See members':'Ver miembros',
   	...
   	//AutoAttack
   		...
   		'Attack Mode':'Modo de ataque',
   		'No coordinated inserted':'Sin coordenadas',
   		'Impossible to attack the coordinates':'No se puede atacar esas coordenadas',
   		'Groundhog coordinates':'Resetear coordenadas',
   		'City not activated':'Ciudad sin activar',
   		'Send attack to':'Enviar ataque a',
   		'You do not have the troops necessary':'No tienes las tropas necesarias',
   		'You can not attack':'No puedes atacar',
   		'Unknown error':'Error desconocido',
   		'Disable the city in which the coordinates of end':'Desactivar la ciudad cuando terminen las coordenadas',
   		'Disable the city':'Desactivar la ciudad',
   	//Spam
      	'OPTIONS':'OPCIONES',
   		'Post automatically every':'Enviar mensaje automaticamente cada',
		'Your spam message':'Tu mensaje de publicidad',
	//Generals
		'Actions':'Acciones',
		'Outside the city':'Fuera de la ciudad',
   	//AutoTrain
   		'AUTO-BUILDING TROOPS':'AUTO CREAR TROPAS', 
   		'Active':'Activo',
   		'Deactive':'Desactivado',
   		'Actions':'Acciones',
   		'seconds of training between the cities':'Segundos de entrenamiento entre ciudades',
   		'Start at':'Comenzar a',
   		'of the population available':'de la poblacion disponible',
   		'Use at':'Utilizar',
   		'IF YOU GET ANY ERRORS, CHECK IF YOUR CITY HAS ENOUGH FOOD AND RESOURCES':'Si recibe algÃƒÂºn error, compruebe si su ciudad TIENE SUFICIENTE COMIDA Y / O RECURSOS',
   		'Initiating training':'Iniciar entrenamiento',
   		'Conditions not met':'Condiciones no logradas',
   		
   	//Train
   		'Max':'Maximo',
   		'Number of troops per slot':'Numero de tropas por turno',
   		'Number of slots':'Numero de turnos',
   		'Queue':'Cola',
   		'barracks':'Barracas',
   		'Cancel training':'Cancelar entrenamiento',
   		'Number of troops per slot must be greater than':'El numero de tropas por turno deben ser mayores que',
      	'Cannot train that many troops':'No es posible entrenar tantas tropas',
      	'max is':'el maximo es',
      	'total':'total',
     	'Invalid number of slots':'Numero de turnos invalido',
     	'Training succesful':'Entrenamiento terminado',
     	'Formation':'Formacion',
	//Options
		'Configuration of the':'Configuracion de la',
		'Allow the toolbox window to be moved freely':'Habilitar el movimiento de la ventana con el raton',
		'Dimensions Tools':'Dimensiones de la ventana',
		'Width':'Ancho',
		'Height':'Alto',
		'Refresh GoR every':'Refrescar GoR cada',
		'Organize a Tax event (if happiness':'Organizar un evento de cobro de impuestos en el coliseo (si la felicidad es',
		'every':'cada',
		'Collect now':'Recolectar ahora',
		'Allow to publish your helpings automatically to Facebook':'Habilitar las publicaciones automaticas en facebook',
		'Everyone':'A todos',
		'Friends of friends':'Amigos de amigos',
		'Friends only':'Solo ammigos',
		'Me only':'Solo yo',
		'Show shortcut keys':'Mostrar botones de atajo',
		'Hide useless keys of the game (Fan page, Discussions ..)':'Esconder botones inutiles del juego (paginas de fans, Discusiones ..)',
		'Receive automatically the daily requests':'Recibir automaticamente la recompensa diaria',
		'Hide updates of':'Esconder actualizaciones de',
		'Right':'Derecha',
		'Below':'Abajo',
		'Configuration of chat':'Configuracion del chat',
		'Move the chat window to the right of the game':'Mover la ventana de chat a la derecha del juego',
        'Allow to publish an alert in chat when your food level is low':'Habilitar la publicacion automatica en el chat cuando el nivel de comida sea bajo',
        'Auto-click help requests, such as building help':'Hacer click automaticamente en los pedidos de ayuda para construccion',
        'Hide all help requests in chat':'Ocultar las solicitudes de ayuda del chat',
        'Hide the rules of the chat':'Ocultar las reglas del chat',
        'Show smileys':'Mostrar emoticonos',
        'Open':'Abrir',
		'Warning sound when receiving a whisper':'Sonido de aviso cuando me susurran',
		'Enable audio in case of ATTACK (Alliance)':'Habilitar sonido en caso de ataque(Alianza)',
		'Enable audio in case of SCOUT (Alliance)':'Habilitar sonido en caso de exploracion(Alianza)',
		'Table of colors':'Tabla de colores',
		'Background of the global chat':'Fondo del chat global',
		'Background of the alliance chat':'Fondo del chat de alianza',
		'Enable color for the leader':'Habilitar color para los lideres',
		'Configuration of Reports':'Configuracion de Informes',
		'Enable the deletion of the reports of the':'Habilitar el borrado de informes de',
		'Delete reports every':'Todos los informes',
		'Enable the deletion of the message of the Kabam':'Habilitar el borrado de mensajes de Kabam',
		'Enable red background color in case of ATTACK (Alliance)':'Habilitar fondo rojo del chat en caso de ataque(Alianza)',
		'Sound file (URL MP3)':'Archivo de sonido(URL MP3)',
        'Configuration of the Tower alert':'Configuracion de alerta de la torre',
        'Allow to post scout alerts in chat':'Enviar al chat de alianzas alertas de exploracion',
        'Allow to post attack alerts in chat':'Enviar al chat de alianzas alertas de ataques entrantes',
        'Allow to sound an alarm when under attack (handy when you are away from keyboard)':'Habilitar alarma cuando reciba un ataque (util cuando te encuentras lejos del teclado)',
        'Message':'Mensaje',
        'Show the bunker':'Mostrar el refugio',
        'Show my troops':'Mostrar mis tropas',
        'Loading the SWF player':'Cargar el SWF player',
        'LOAD':'CARGAR',
        'DEFAULT':'POR DEFECTO',
        'Repeat every':'Repetir cada',
        'Length of sounding alarm':'Volumen del sonido de la alarma',
        'Tester':'Probar',
        'Stop Sound Alert':'Detener sonido de alarma',
        'Error':'Error',
        'Loaded':'Cargado',
		'':''
};
...
function DashInnert (){
    ...
    var Red = 'BODefButOff';
    var m = '<div class="ptstat">ATAJOS</div>';
...
my.Options = {
  ...
  show : function (){
	...
	<TR><TD></td><TD><INPUT type=submit value="'+translate('Tester')+'" id=boPlayNow> &nbsp; <INPUT id=boSoundStop type=submit value="'+translate('Stop Sound Alert')+'"></td></tr></table></div></td></tr>\
     ...
     if(Options.Lingua == 2) ById('SpanLang').innerHTML = translate('Translated by')+' JDF'; 
