// ==UserScript==
// @name           facebook-fkv-x-ves
// @namespace      IndigenousTweets.com
// @description    Translate Facebook into Kven Finnish (vesta)
...
// Translations go here
  ...
  d = r(d, '(^|="|>)(<a [^>]+>(?:<span[^>]+>)?[^<]+(?:</span>)?</a>)<span[^>]+>, </span>(<a [^>]+>(?:<span[^>]+>)?[^<]+(?:</span>)?</a>)<span[^>]+> og </span>(<a [^>]+>(?:<span[^>]+>)?[^<]+(?:</span>)?</a>)<span[^>]+> liker dette\.</span>(?=($|"|<))', "$1"+"$2"+", "+"$3"+" ja "+"$4"+" tykäthään tästä.");
  d = r(d, '(^|="|>)(<a [^>]+>[^<]+</a>) har lagt til et nytt bilde\.(?=($|"|<))', "$1"+"$2"+" lisäsi uuđen kuvan.");
  d = r(d, '(^|="|>)(<a [^>]+>[^<]+</a>) har lagt til ([0-9,]+) nye bilder\.(?=($|"|<))', "$1"+"$2"+" lisäsi "+"$3"+" uutta kuvvaa.");
  d = r(d, '(^|="|>)(<a [^>]+>[^<]+</a>) har lagt til et nytt bilde i albumet (<a [^>]+>[^<]+</a>)\.(?=($|"|<))', "$1"+"$2"+" lisäsi 1 uuđen kuvan albumhiin "+"$3");
  ...
  d = r(d, '(^|="|>)(<a [^>]+>[^<]+</a>) og (<a [^>]+>[^<]+</a>) kommenterte e[nt] (<a [^>]+>)livshendelse</a>\.(?=($|"|<))', "$1"+"$2"+" ja "+"$3"+" kommenteerathiin "+"$4"+"elämäntapattummaa</a>"+".");
  d = r(d, '(^|="|>)(<a [^>]+>[^<]+</a>) og (<a [^>]+>[^<]+</a>) kommenterte e[nt] (<a [^>]+>)lenke</a>\.(?=($|"|<))', "$1"+"$2"+" ja "+"$3"+" kommenteerathiin "+"$4"+"linkkii</a>"+".");
  ...
  d = r(d, '(^|="|>)(<a [^>]+>[^<]+</a>) og (<a [^>]+>[^<]+</a>) kommenterte e[nt] (<a [^>]+>)statusoppdatering</a>\.(?=($|"|<))', "$1"+"$2"+" ja "+"$3"+" kommenteerathiin "+"$4"+"staattuksen uuđistamista</a>"+".");
  d = r(d, '(^|="|>)(<a [^>]+>[^<]+</a>) og (<a [^>]+>[^<]+</a>) kommenterte e[nt] (<a [^>]+>[^<]+</a>)\.(?=($|"|<))', "$1"+"$2"+" ja "+"$3"+" kommenteerathiin "+"$4"+".");
  d = r(d, '(^|="|>)(<a [^>]+>[^<]+</a>) og (<a [^>]+>[^<]+</a>) liker (<a [^>]+>[^<]+</a>)\.(?=($|"|<))', "$1"+"$2"+" ja "+"$3"+" tykäthään laiđasta "+"$4"+".");
  d = r(d, '(^|="|>)(<a [^>]+>(?:<span[^>]+>)?[^<]+(?:</span>)?</a>)<span[^>]+> og </span>(<a [^>]+>(?:<span[^>]+>)?[^<]+(?:</span>)?</a>)<span[^>]+> liker dette\.</span>(?=($|"|<))', "$1"+"$2"+" ja "+"$3"+" tykäthään tästä.");
  ...
  d = r(d, '(^|="|>)Om(?=($|"|<))', "$1"+"Tiettoi");
  d = r(d, '(^|="|>)for ca\. en time siden(?=($|"|<))', "$1"+"kohta tiima aikkaa");
  d = r(d, '(^|="|>)for ca\. ett minutt siden(?=($|"|<))', "$1"+"kohta minutti aikkaa");
  d = r(d, '(^|="|>)Kontoinnstillinger(?=($|"|<))', "$1"+"Konton asetukset");
  d = r(d, '(^|="|>)(<a [^>]+>[^<]+</a>) har byttet profilbilde\.(?=($|"|<))', "$1"+"$2"+" vaihetti oman profiilikuvan.");
  d = r(d, '(^|="|>)(<a [^>]+>[^<]+</a>) har byttet profilbilde\.(?=($|"|<))', "$1"+"$2"+" vaihetti oman profiilikuvan.");
  d = r(d, '(^|="|>)(<a [^>]+>[^<]+</a>) kommenterte e[nt] (<a [^>]+>)livshendelse</a>\.(?=($|"|<))', "$1"+"$2"+" kommenteerasi "+"$3"+"elämäntapattummaa</a>"+".");
  d = r(d, '(^|="|>)(<a [^>]+>[^<]+</a>) kommenterte e[nt] (<a [^>]+>)lenke</a>\.(?=($|"|<))', "$1"+"$2"+" kommenteerasi "+"$3"+"linkkii</a>"+".");
  ...
  d = r(d, '(^|="|>)(<a [^>]+>[^<]+</a>) kommenterte e[nt] (<a [^>]+>)statusoppdatering</a>\.(?=($|"|<))', "$1"+"$2"+" kommenteerasi "+"$3"+"staattuksen uuđistamista</a>"+".");
  d = r(d, '(^|="|>)(<a [^>]+>[^<]+</a>) kommenterte e[nt] (<a [^>]+>[^<]+</a>)\.(?=($|"|<))', "$1"+"$2"+" kommenteerasi "+"$3"+".");
  d = r(d, '(^|="|>)(<a [^>]+>[^<]+</a>) kommenterte si[nt]t? ege[nt] (<a [^>]+>)livshendelse</a>\.(?=($|"|<))', "$1"+"$2"+" kommenteerasi ommaa "+"$3"+"elämäntapattummaa</a>"+".");
  d = r(d, '(^|="|>)(<a [^>]+>[^<]+</a>) kommenterte si[nt]t? ege[nt] (<a [^>]+>)lenke</a>\.(?=($|"|<))', "$1"+"$2"+" kommenteerasi ommaa "+"$3"+"linkkii</a>"+".");
  ...
  d = r(d, '(^|="|>)(<a [^>]+>[^<]+</a>) kommenterte si[nt]t? ege[nt] (<a [^>]+>)statusoppdatering</a>\.(?=($|"|<))', "$1"+"$2"+" kommenteerasi ommaa "+"$3"+"staattuksen uuđistamista</a>"+".");
  ...
  d = r(d, '(^|="|>)(<a [^>]+>[^<]+</a>) kommenterte si[nt]t? ege[nt] (<a [^>]+>)statusoppdatering</a>\.(?=($|"|<))', "$1"+"$2"+" kommenteerasi ommaa "+"$3"+"staattuksen uuđistamista</a>"+".");
  d = r(d, '(^|="|>)(<a [^>]+>[^<]+</a>) kommenterte si[nt]t? ege[nt] (<a [^>]+>[^<]+</a>)\.(?=($|"|<))', "$1"+"$2"+" kommenteerasi ommaa "+"$3"+".");
  d = r(d, '(^|="|>)(<a [^>]+>[^<]+</a>) kommenterte di[nt]t? (<a [^>]+>)livshendelse</a>\.(?=($|"|<))', "$1"+"$2"+" kommenteerasi sinun "+"$3"+"elämäntapattummaa</a>"+".");
  d = r(d, '(^|="|>)(<a [^>]+>[^<]+</a>) kommenterte di[nt]t? (<a [^>]+>)lenke</a>\.(?=($|"|<))', "$1"+"$2"+" kommenteerasi sinun "+"$3"+"linkkii</a>"+".");
  ...
  d = r(d, '(^|="|>)(<a [^>]+>[^<]+</a>) kommenterte di[nt]t? (<a [^>]+>)statusoppdatering</a>\.(?=($|"|<))', "$1"+"$2"+" kommenteerasi sinun "+"$3"+"staattuksen uuđistamista</a>"+".");
  ...
  d = r(d, '(^|="|>)Legg til interesser \.\.\.(?=($|"|<))', "$1"+"Lissää intressin...");
  ...
  d = r(d, '(^|="|>)(<a [^>]+>[^<]+</a>) liker e[nt] (<a [^>]+>)livshendelse</a>\.(?=($|"|<))', "$1"+"$2"+" tykkää "+"$3"+"elämäntapattumasta</a>"+".");
  ...
  d = r(d, '(^|="|>)(<a [^>]+>[^<]+</a>) liker e[nt] (<a [^>]+>)statusoppdatering</a>\.(?=($|"|<))', "$1"+"$2"+" tykkää "+"$3"+"staattuksen uuđistamisesta</a>"+".");
  d = r(d, '(^|="|>)(<a [^>]+>[^<]+</a>) liker e[nt] (<a [^>]+>[^<]+</a>)\.(?=($|"|<))', "$1"+"$2"+" tykkää "+"$3"+".");
  d = r(d, '(^|="|>)(<a [^>]+>[^<]+</a>) liker (<a [^>]+>[^<]+</a>) si[nt]t? (<a [^>]+>)livshendelse</a>\.(?=($|"|<))', "$1"+"$2"+" tykkää "+"$4"+"elämäntapattumasta</a>"+" jonka "+"$3"+" oon julkaissu.");
  ...
  d = r(d, '(^|="|>)(<a [^>]+>[^<]+</a>) liker (<a [^>]+>[^<]+</a>) si[nt]t? (<a [^>]+>)statusoppdatering</a>\.(?=($|"|<))', "$1"+"$2"+" tykkää "+"$4"+"staattuksen uuđistamisesta</a>"+" jonka "+"$3"+" oon julkaissu.");
  d = r(d, '(^|="|>)(<a [^>]+>[^<]+</a>) liker (<a [^>]+>[^<]+</a>) si[nt]t? (<a [^>]+>[^<]+</a>)\.(?=($|"|<))', "$1"+"$2"+" tykkää "+"$4"+" jonka "+"$3"+" oon julkaissu.");
  d = r(d, '(^|="|>)(<a [^>]+>[^<]+</a>) liker (<a [^>]+>[^<]+</a>) og (<a [^>]+>[^<]+</a>)\.(?=($|"|<))', "$1"+"$2"+" tykkää laiđasta "+"$3"+" ja "+"$4"+".");
  d = r(d, '(^|="|>)(<a [^>]+>(?:<span[^>]+>)?[^<]+(?:</span>)?</a>)<span[^>]+> liker dette\.</span>(?=($|"|<))', "$1"+"$2"+" tykkää tästä.");
  d = r(d, '(^|="|>)(<a [^>]+>(?:<span[^>]+>)?[^<]+(?:</span>)?</a>)<span[^>]+> liker dette\.</span>(?=($|"|<))', "$1"+"$2"+" tykäthään tästä.");
  ...
  d = r(d, '(^|="|>)(<a [^>]+>[^<]+</a>) ble tagget i (<a [^>]+>[^<]+</a>) si[nt]t? (<a [^>]+>)livshendelse</a>\.(?=($|"|<))', "$1"+"$2"+" oon merkitty "+"$4"+"elämäntapattumhaan</a>"+" jonka "+"$3"+" julkaisi.");
  ...
  d = r(d, '(^|="|>)(<a [^>]+>[^<]+</a>) ble tagget i (<a [^>]+>[^<]+</a>) si[nt]t? (<a [^>]+>)statusoppdatering</a>\.(?=($|"|<))', "$1"+"$2"+" oon merkitty "+"$4"+"staattuksen uuđistamisheen</a>"+" jonka "+"$3"+" julkaisi.");
  d = r(d, '(^|="|>)(<a [^>]+>[^<]+</a>) ble tagget i (<a [^>]+>[^<]+</a>) si[nt]t? (<a [^>]+>[^<]+</a>)\.(?=($|"|<))', "$1"+"$2"+" oon merkitty "+"$4"+" jonka "+"$3"+" julkaisi.");
  d = r(d, '(^|="|>)(<a [^>]+>[^<]+</a>) ble tagget i e[nt] (<a [^>]+>)livshendelse</a>\.(?=($|"|<))', "$1"+"$2"+" oon merkitty "+"$3"+"elämäntapattumhaan</a>"+".");
  ...
  d = r(d, '(^|="|>)(<a [^>]+>[^<]+</a>) ble tagget i e[nt] (<a [^>]+>)statusoppdatering</a>\.(?=($|"|<))', "$1"+"$2"+" oon merkitty "+"$3"+"staattuksen uuđistamisheen</a>"+".");
  ...
  d = r(d, '(^|="|>)(<a [^>]+>[^<]+</a>) oppdaterte forsidebildet sitt\.(?=($|"|<))', "$1"+"$2"+" uuđisti oman etulaiđan kuvan.");
  d = r(d, '(^|="|>)(<a [^>]+>[^<]+</a>) oppdaterte forsidebildet sitt\.(?=($|"|<))', "$1"+"$2"+" uuđisti oman etulaiđan kuvan.");
  ...
  d = r(d, '(^|="|>)Opprett en side(?=($|"|<))', "$1"+"Luo laiđan");
  d = r(d, '(^|="|>)Opprett en gruppe \.\.\.(?=($|"|<))', "$1"+"Luo roikan...");
  d = r(d, '(^|="|>)Opprett ny gruppe(?=($|"|<))', "$1"+"Luo roikan");
  d = r(d, '(^|="|>)Utviklere(?=($|"|<))', "$1"+"Kehittäjät");
  d = r(d, '(^|="|>)1 hour ago(?=($|"|<))', "$1"+"1 tiima aikkaa");
  d = r(d, '(^|="|>)for ([0-9,]+) timer siden(?=($|"|<))', "$1"+"$2"+" tiimaa aikkaa");
  d = r(d, '(^|="|>)1 minute ago(?=($|"|<))', "$1"+"1 minutti aikkaa");
  d = r(d, '(^|="|>)for ([0-9,]+) minutter siden(?=($|"|<))', "$1"+"$2"+" minuttii aikkaa");
  ...
  d = r(d, '(^|>)1 other page(?=($|<))', "$1"+"1 muusta laiđasta");
  d = r(d, '(^|>)([0-9,]+) sider til(?=($|<))', "$1"+"$2"+" muusta laiđasta");
  ...
  d = r(d, '(^|="|>)1 second ago(?=($|"|<))', "$1"+"1 sekuntti aikkaa");
  d = r(d, '(^|="|>)for ([0-9,]+) sekunder siden(?=($|"|<))', "$1"+"$2"+" sekunttii aikkaa");
  d = r(d, '(^|="|>)1 deling(?=($|"|<))', "$1"+"1 jako");
  d = r(d, '(^|="|>)([0-9,]+) delinger(?=($|"|<))', "$1"+"$2"+" jakkoo");
  d = r(d, '(^|="|>)Endre alternativer(?=($|"|<))', "$1"+"Muuta alternatiivii");
  d = r(d, '(^|="|>)Rediger eller fjern(?=($|"|<))', "$1"+"Muuta tahi poista");
  d = r(d, '(^|="|>)Norsk \\(bokmål\\)(?=($|"|<))', "$1"+"Kvääni/Kainu (vesta)");
  d = r(d, '(^|="|>)Skriv inn navnet eller e-postadressen til en venn(?=($|"|<))', "$1"+"Lissää ystävän nimen tahi e-postiadressin");
  d = r(d, '(^|="|>)Arrangementer(?=($|"|<))', "$1"+"Tapattumat");
  d = r(d, '(^|="|>)Familie(?=($|"|<))', "$1"+"Peret");
  d = r(d, '(^|="|>)FAVORITTER(?=($|"|<))', "$1"+"FAVORIITIT");
  d = r(d, '(^|="|>)Finn venner(?=($|"|<))', "$1"+"Haje ystävii");
  d = r(d, '(^|="|>)Finn flere sider(?=($|"|<))', "$1"+"Haje enämen laittoi");
  ...
  d = r(d, '(^|="|>)Livshendelse(?=($|"|<))', "$1"+"Elämäntapattuma");
  d = r(d, '(^|="|>)Liker(?=($|"|<))', "$1"+"Tykkää");
  d = r(d, '(^|="|>)Liker(?=($|"|<))', "$1"+"Tykkäämiset");
  d = r(d, '(^|="|>)Lik side(?=($|"|<))', "$1"+"Tykkää laiđasta");
  d = r(d, '(^|="|>)Lik denne siden(?=($|"|<))', "$1"+"Tykkää tästä laiđasta");
  ...
  d = r(d, '(^|="|>)Mer(?=($|"|<))', "$1"+"Enämen");
  d = r(d, '(^|="|>)MER(?=($|"|<))', "$1"+"ENÄMEN");
  d = r(d, '(^|="|>)Vis alle hendelser(?=($|"|<))', "$1"+"Enämen muisteluksii");
  ...
  d = r(d, '(^|="|>)Nå(?=($|"|<))', "$1"+"Nyt");
  d = r(d, '(^|="|>)SIDER(?=($|"|<))', "$1"+"LAIÐAT");
  d = r(d, '(^|="|>)Personer som liker dette(?=($|"|<))', "$1"+"Ihmiset jokka tykäthään tästä");
  ...
  d = r(d, '(^|="|>)Se vennskap(?=($|"|<))', "$1"+"Näytä ystävyyđen");
  d = r(d, '(^|="|>)Vis flere(?=($|"|<))', "$1"+"Näytä enämen");
  d = r(d, '(^|="|>)Send(?=($|"|<))', "$1"+"Lähätä");
  d = r(d, '(^|="|>)Send en ny melding(?=($|"|<))', "$1"+"Lähätä uuđen mellingin");
  d = r(d, '(^|="|>)Del(?=($|"|<))', "$1"+"Jaa");
  d = r(d, '(^|="|>)SORTER(?=($|"|<))', "$1"+"SORTTEERAA");
  d = r(d, '(^|="|>)Sponset(?=($|"|<))', "$1"+"Sponsoreerattu");
  d = r(d, '(^|="|>)Status(?=($|"|<))', "$1"+"Staattus");
  d = r(d, '(^|="|>)Abonnementer(?=($|"|<))', "$1"+"Abonnementit");
  d = r(d, '(^|="|>)Foreslåtte grupper(?=($|"|<))', "$1"+"Ehđotetut roikat");
  d = r(d, '(^|="|>)Tag venner(?=($|"|<))', "$1"+"Merkitte ystävii");
  d = r(d, '(^|="|>)Betingelser(?=($|"|<))', "$1"+"Käyttöehđot");
  d = r(d, '(^|="|>)ticker(?=($|"|<))', "$1"+"Uutiset nyt");
  d = r(d, '(^|="|>)Tidslinje(?=($|"|<))', "$1"+"Aikalinja");
  d = r(d, '(^|="|>)(<a [^>]+><abbr [^>]+>[^<]+</abbr></a>) i nærheten av (<a [^>]+>[^<]+</a>)(?=($|"|<))', "$1"+"$2"+" likelä tätä paikkaa: "+"$3");
  d = r(d, '(^|="|>)Til:(?=($|"|<))', "$1"+"Kenele:");
  d = r(d, '(^|="|>)Topphendelser(?=($|"|<))', "$1"+"Tärkkeimät muistelukset");
  d = r(d, '(^|="|>)Liker ikke(?=($|"|<))', "$1"+"En tykkääkhään");
  d = r(d, '(^|="|>)Oppdater informasjon(?=($|"|<))', "$1"+"Uuđista tiettoi");
  d = r(d, '(^|="|>)Status(?=($|"|<))', "$1"+"Uuđista staattuksen");
  d = r(d, '(^|="|>)Bruk Facebook som:(?=($|"|<))', "$1"+"Valitte mitä Facebook-laittaa käytät:");
  d = r(d, '(^|="|>)View 1 comment(?=($|"|<))', "$1"+"Näytä 1 kommentaarin");
  d = r(d, '(^|="|>)Vis alle ([0-9,]+) kommentarene(?=($|"|<))', "$1"+"Näytä kaikki "+"$2"+" kommentaarii");
  d = r(d, '(^|="|>)Veggbilder(?=($|"|<))', "$1"+"Etulaiđan kuvat");
  ...
  d = r(d, '(^|>)livshendelse(?=($|<))', "$1"+"elämäntapattuman");
  d = r(d, '(^|>)lenke(?=($|<))', "$1"+"linkin");
  d = r(d, '(^|>)bilde(?=($|<))', "$1"+"kuvan");
  d = r(d, '(^|>)innlegg(?=($|<))', "$1"+"muisteluksen");
  d = r(d, '(^|>)status(?=($|<))', "$1"+"staattuksen");
  d = r(d, '(^|>)statusoppdatering(?=($|<))', "$1"+"staattuksen uuđistamisen");
  return d;
}
