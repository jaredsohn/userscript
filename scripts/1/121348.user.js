// ==UserScript==
// @name           Tiberium Alliances Tweak
// @description    Additions to Tiberium Alliances: Credits production, Command Points timer, Logout and Options buttons, Autocollect bonuses in all cities, Base tooltip resources, Autorepair
		...
		qx.Class.define("TATweak.main", {
			...
			members: {
				...
				tweakTA: function() {
					...
					window.setInterval(this.autoCollect, 15000);
					window.setInterval(this.autoRepair, 15000);
				},
						...
						for (var CurrentCity in this.AllCitiesData) {
							...
							if (this.buildings != 'undefined'){
								for (var i=0; (i < this.buildings.l.length); i++)
								{
									...
									if(((this.CurrentBuilding.get_BonusPackageFullStep$0() == 0) || (ClientLib.Data.MainData.GetInstance$9().get_Time$3().GetServerStep$0() < this.CurrentBuilding.get_BonusPackageReadyStep$0())) || (this.CurrentBuilding.GetPossibleResourcesToCollect$0() <= 0))
									{}
									else
									{						
										ClientLib.Net.CommunicationManager.GetInstance().SendCommand ("CollectResource",{cityid:ThisCity.m_Id,posX:this.CurrentBuilding.get_CoordX$0(),posY:this.CurrentBuilding.get_CoordY$0()}, (new ClientLib.Net.CommandResult).$ctor(ThisCity,ThisCity.CollectResourcesCommandDone$0), this.CurrentBuilding.get_ResourceStep$0(), true);
									}
								}
							}
				...
				setMenuBar: function() {
					try
					{
						...
						qx.core.Init.getApplication().__cV.add(qx.core.Init.getApplication().__db, {left: 0, top: 0});
					}
					catch(err){}
				},
				setPlayerBar: function() {
					try
					{
						...
						qx.core.Init.getApplication().__cV.add(qx.core.Init.getApplication().__dg, {left: 0, top: 0});
					}
					catch(err){}
				}
			}
...
//================== TATweak.AppointmentsBar ====================		
		...
		qx.Class.define("TATweak.AppointmentsBar", {
			...
			construct: function () {
				...
				var R = new qx.ui.basic.Image("webfrontend/ui/common/bgr_appointments_t.png");
				var Q = this.__yn();
				...
				var T = new qx.ui.basic.Image("webfrontend/ui/common/bgr_appointments_scaler.png").set({
					allowGrowY: true,
					allowShrinkY: true,
					scale: true,
					height: 0
				...
				var U = new qx.ui.basic.Image("webfrontend/ui/common/bgr_appointments_b.png");
				...
				this.__yf.set({
					decorator: new qx.ui.decoration.Background().set({
						...
						backgroundImage: "webfrontend/ui/menues/win_overlay/win_overlay_grid.png"
					})
				});
			...
			members: {
				...
				__yj: function () {
					...
					for (var i = 0; i < this.arrCity.length; i++) {
						...
						cityIcon = "resource/webfrontend/battleview/neutral/gui/icn_gdi.png"
						}
						...
						cityIcon = "resource/webfrontend/battleview/neutral/gui/icn_nod.png"
						}
						...
						cityIcon = "resource/webfrontend/battleview/neutral/gui/icn_mutants.png"
						}
						...
						bb.add('<div style="display: inline-block; width: 150px;"><img src="resource/webfrontend/ui/common/icn_res_tiberium.png" width="23" height="21" style="vertical-align: middle;"/>&nbsp;',webfrontend.gui.Util.formatNumbers(Math.floor(ClientLib.Data.MainData.GetInstance().get_Cities().GetCity(bm.cityId).GetResourceCount(ClientLib.Base.EResourceType.Tiberium)), true), '</div><br />');
...
//================== TATweak.MenuBar ====================		
		...
		try {
			if (typeof qx != 'undefined') {
				...
				if (a && mb) {
					...
					window.setTimeout(TA_checkIfLoaded, 1000);
			} else {
				window.setTimeout(TA_checkIfLoaded, 1000);
			}
		} catch (e) {
	...
	var TATweakScript = document.createElement("script");
		txt = TA_mainFunction.toString();
		TATweakScript.innerHTML = "(" + txt + ")();";
