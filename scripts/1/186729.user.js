...
// @namespace    https://github.com/liu8563525
// @description  预读+翻页..全加速你的浏览体验...
// @author       liu8563525 && NLF(原作者)
// @version      1.0.1
// @homepageURL  https://userscripts.org/scripts/show/186729
// @downloadURL  https://userscripts.org/scripts/source/186729.user.js
// @updateURL    https://userscripts.org/scripts/source/186729.meta.js
// @grant        GM_addStyle
// @grant        GM_getValue
// @grant        GM_setValue
    ...
    var SITEINFO=[
        ...
        {name: 'Mozilla Addons',
            ...
            autopager: {
                ...
                pageElement: '//div[@id="pjax-results" or @class="separated-listing"]/div[@class="items"] | //section[@class="primary"]/div/div[@class="items"] | //ul[@class="personas-grid"]',
                relatedObj: true,
        ...
        {name: 'User Scripts',
            ...
            nextLink: 'auto;',
            autopager: {
                pageElement: 'id("content")/table | id("review-list") | id("main")/table[@class="posts wide"]',
