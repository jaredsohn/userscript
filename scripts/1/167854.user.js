// ==UserScript==
// @name           e-Sim Link Bar [EN]
// @description    This script add a new menu under the orignal, where you can set/delet links.
// @version        0.1
...
function set(i)
 {
	...
	linkp=window.prompt("Please set the link ","");
	valuep=window.prompt("Please set the title","");
 ...
 function clear()
 {
	...
	select=window.prompt("Please set which link do you want to delet, give the number only\n1-10","");
	select--;
 ...
 window.onload = function() {
	...
	tabla+="<td><div style=\"cursor:pointer;\" id=\"del\"><img src=\"http://www.ximcard.com/images/closeicon.png\"></div></td></tr></table>";
