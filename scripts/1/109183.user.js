...
// ==/UserScript==
 ...
 if(loc[1] == 'comunidades' && loc[2] == 'whatthefuck'){
  ...
  var loc = window.location.pathname.split('/');
  $('.denunciar').before('<img class="dwtf" src="http://www.comunidad-wtf.net/denuncias/imagen.php" width="72" height="12" /><a class="hist">Historial</a><style>.denunciar{display:none}'+
