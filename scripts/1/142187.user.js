...
// @version        1.2.7
// @namespace      DarkDove
// @description    A collection of helper tools - Kingdoms of Camelot KOC 
// @homepage       http://userscripts.org/scripts/show/142187
...
var Version = '1.2.7';
var Versiondate = '12.13.2012'; 
var Scriptname = 'KoC Flex Toy';
var ScriptTabName = "'+ getMyAlliance()[1] +'";
var AllianzName = 'Kingdom of Camelot';
var ScriptLink = 'http://userscripts.org/scripts/show/142187';
...
// TODO: Make sure WinPos is visible on-screen ?
 ...
 // actionLog (""+Scriptname +" v"+ Version +" by Gengar loaded!");
  ...
  AddMainTabLink('KoC Flex Toy', eventHideShow, mouseMainTab);
}
...
Tabs.Berichte = {
  ...
  init : function (div){
    ...
    <DIV class=pdxEntry>\
          <table width="100%">\
          <tr>\
          <td class=xtab colspan="3" align="center">TR Copy: <INPUT id=trCopy type=text value="" size="90" />  <INPUT id=trSendButton type=submit value="Chat." /></td>\
          </tr>\
          <tr>\
   ...
   <DIV class=pdxEntry>\
        ...
        <DIV><td style="background-color:white" font-size:7pt; text-align:right; align="right" colspan="4"><a target="_blank" href="http://userscripts.org/scripts/show/142187">Koc Flex Toy v. '+Version+' </a></td>\
   </div>';
        ...
        document.getElementById('trSendButton').addEventListener ('click', t.addslashes, false);
    ...
    addslashes : function() {
    var t = Tabs.Berichte;
    var str = document.getElementById("trCopy").value;
    str = str.replace(/(\-?\d+\.\d+%)/gi, "/ $1");
    sendChat("/a " + str);
    document.getElementById("trCopy").value = "";
   },
    ...
    for ( var i=0; i<t.data.length;i++) {
       var rpt = data[i];
          ...
          //    msg += '<tbody>';
            ...
            <td> Report No: '+rpt.reportId+' #'+rpt.reportId+'# </td>\
            <tr>\
            </tr>';
