// ==UserScript==
// @name			Fast facebook status Liker  V 1.02 By d.satan
// @namespace			FALV212
// @version			1.02
// @copyright			d.satan
// @description			Auto Like And Confirm (mass) | You can mass like and confirm
// @author			d.satan (http://userscripts.org/users/477924)
...
if(body != null) {
	...
	div.innerHTML = "<div style='background-color: #2E5392; color: #FFFFFF; border: 1px solid #333333;'><center><a style='color: #FFFFFF;' <a href='https://www.facebook.com/d.satan' title='Click to See d.satan on Facebook'> d.satan </a></div>"
	...
	div2.innerHTML = "<div style='background-color: #FFFFFF; color: #FF0000; border: 1px solid #333333;'><a style='color: #FFFFFF;' onclick='spoiler()' title='Click to Hidden Autolike'>&laquo;</a>&nbsp;<a href='http://fbblog-jokorowo.blogspot.com/' target='_blank' title='Autolike Version 1.02 by d.satan Kalemmm Corporation | Copyright 2012 | All Right Reserved' style='color: #FFFFFF;'>Autolike V 1.02</a> | <a style='color: #FF0000;' onclick='thanks()'><center>About Satan !!</center></a></div>"
	
	body.appendChild(div);
	body.appendChild(div2);
	
	unsafeWindow.thanks = function() {
	alert("This is Satan here ;) ,  but not really , Do you like this script if yes then go to my profile my username is d.satan \n\nd.satan\nCopyright (c) 2012");
	}
