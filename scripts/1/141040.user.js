...
// @author			RIRIMA
// @description			เพิ่มอีโมติค่อนลงในกล่องแชท Facebook พัฒนาโดย RIRIMA เวอร์ชั่น 3.3 (http://www.facebook.com/riorizamaulana)
// @version			3.3
// @versionnumber		3.3
...
emoticonsListC[53] = "[[mahosejati]]";
emoticonsListC[54] = "[[196431117116365]]";
emoticonsListC[55] = "[[kaskus]]";
emoticonsListC[56] = "[[334954663181745]]";
emoticonsListC[57] = "[[244961858909298]]";
emoticonsListC[58] = "[[344113652270150]]";
emoticonsListC[59] = "[[344991278847613]]";
emoticonsListC[60] = "[[164461493653696]]";
emoticonsListC[61] = "[[196752423751220]]";
emoticonsListC[62] = "[[301630573215430]]";
emoticonsListC[63] = "[[251496118250464]]";
emoticonsListC[64] = "[[266394220086654]]";
emoticonsListC[65] = "[[164866556948132]]";
emoticonsListC[66] = "[[180599335371968]]";
emoticonsListC[67] = "[[209067005843651]]";
emoticonsListC[68] = "[[238594039545396]]";
emoticonsListC[69] = "[[147702285338528]]";
emoticonsListC[70] = "[[309221402452022]]";
emoticonsListC[71] = "[[180901405340714]]";
emoticonsListC[72] = "[[246506925416551]]";
emoticonsListC[73] = "[[333343613344059]]";
emoticonsListC[74] = "[[123128367803569]]";
emoticonsListC[75] = "[[316143388416019]]";
emoticonsListC[76] = "[[334073456605673]]";
emoticonsListC[77] = "[[199626093460643]]";
emoticonsListC[78] = "[[224202614323263]]";
emoticonsListC[79] = "[[336032459740792]]";
emoticonsListC[80] = "[[205228226232732]]";
emoticonsListC[81] = "[[142420399202282]]";
emoticonsListC[82] = "[[157919817645224]]";
emoticonsListC[83] = "[[likemerah]]";
emoticonsListC[84] = "[[rio.rizamaulana]]";
emoticonsListC[85] = "[[asu]]";
...
function creaBarra(event){ //prima di chiamare questo metodo controllo la presenza della barra
	...
	popolaBarra(barra);
        ...
        cops2.innerHTML='<img src="http://image.free.in.th/z/in/facebook_like_buton.png" width="20" style="padding-top:5px;"> <a href="http://www.facebook.com/riorizamaulana" target="_blank" style="text-decoration:none;">RIRIMA</a>';
...
function popolaBarra(barra){
    try{
            ...
            for(i=0;i<emoticonsListS.length;i++){
                    ...
                    imag.setAttribute('style',"cursor: pointer; background: url('http://static.ak.fbcdn.net/rsrc.php/v2/yM/r/WlL6q4xDPOA.png') no-repeat scroll " + posX +"px "+ posY +"px transparent; height:14px; width:14px; ");
		...
		var altezzaemo = 145;
            if(listaemoticons.style.visibility == "hidden"){
               listaemoticons.style.visibility = "visible";
                ...
                fbnubflyoutfooter.style.height= "187px";
                ...
                minimize.innerHTML= "Six Two Five";
...
var chatNewHeight = 350; //limited by other stuff not to fly off the page
var chatNewWidth = 250; // Take up ALL of usable space
