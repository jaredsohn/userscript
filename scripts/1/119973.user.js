...
//    alert("showing window");
    s_gm.type = 'text/html';
    s_gm.id = 'yegmbinder';
    var text = "<div class=\"twttr-dialog-container draggable ui-draggable\" \
    style=\"left: 150px; top: 200px; visibility: visible; display: block;\"> \
	<div class=\"twttr-dialog\" style=\"width: 500px; height: auto;\"> \
		<div class=\"twttr-dialog-header\">\
			<h3>Select Draft</h3>\
			<div class=\"twttr-dialog-close\">\
			<a href=\"javascript:yeCloseDraftWin()\"><b>x</b></a></div>\
		</div>\
    ...
    <div class=\"twttr-dialog-overlay\" style=\"display: block; \"></div>";
    s_gm.innerHTML = text;
...
//  var si = document.getElementById('page-node-home');
  var si = document.getElementById('global-nav');
