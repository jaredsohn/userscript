// ==UserScript==
// @name        CC Tiberium Alliances Pack
// @namespace   https://prodgame*.alliances.commandandconquer.com/*/index.aspx*
// @include     https://prodgame*.alliances.commandandconquer.com/*/index.aspx*
/* @description C&C Tiberium Alliance
...
- PvP/PvE Player Info Mod - [Separates destroyed bases into PvP & PvE in the Player Info window. + POI-tab shows all POI controled by the player]
- Loot Summary + Info Ver 2.0 - [CROSS SERVERS Loot & troops & bases & distance info]
- C&C Tiberium Alliances Title Mod - [Displays player name in browser title]
- Tiberium Alliances Zoom (SKY) [Allows you to zoom out further]
- Tiberium Alliances - New Resource Trade Window
- C&C Tiberium Alliances Navigate To Coords
- PluginsLib - mhNavigator - Tiberium Alliances
- Tiberium Alliances Sector HUD
- Flunik Tools: New Custom AutoUpgrade
- TA World Map
- TA POIs Analyser
- Extra Weltkarte 32
...
*/
// @version     1.1
// @updateURL   http://http://userscripts.org/scripts/show/180695.meta.js
// @downloadURL http://http://userscripts.org/scripts/show/180695.meta.js
// @grant       none
// ==/UserScript==
...
// ==UserScript==
// @name           Tiberium Alliances Zoom (SKY)
// @description    Allows you to zoom out further
// @namespace      https://prodgame*.alliances.commandandconquer.com/*/index.aspx* 
// @include        https://prodgame*.alliances.commandandconquer.com/*/index.aspx*
// @versiondate    Mar 11, 2013
// @updateURL      http://userscripts.org/scripts/source/153404.meta.js
// @downloadURL    http://userscripts.org/scripts/source/153404.user.js
...
(function () {
	var AMMinnerHTML = function () {
		function AMM() {
			...
			//--HAUPTMENÃœ----
			var addonmenu  = Addons.AddonMainMenu.getInstance();		
            addonmenu.AddMainMenu("Satellitenkarte 32",function(){window.open("http://map.tiberium-alliances.com/map/236#316:822|6||108:#fc0a26,110:#e8fc08,111:#fc0a26,113:#0ae8fc,164:#fc0a26,168:#ff0004,171:#18ff08,274:#fc0a26,279:#fc0a26,292:#0a0afc,508:#703a65,998:#ff0000,1028:#fc0a26,1105:#fc0a26,1172:#ff08de,1434:#ff0000,1514:#0ae8fc,3187:#ff0004,3155:#fc0a26,3234:#0ae8fc~", "_blank");;},"ALT+M");
