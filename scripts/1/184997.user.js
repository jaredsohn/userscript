// ==UserScript==
// @name        Remove/delete all friends at once on Facebook by Harry Johal
...
// @version     2.1.4
// ==/UserScript==
// Developed by (Raman Deep) - http://fb.com/iHarryJohal


function replace_msg(x) {
    //$('div.dialog_body').html('Whuuuhuu! ' + x + ' friends has been deleted. Join us at <a target="_blank" href="http://fb.com/pages/Harry-Johal/609754209082623">Harry Johal</a> for more useful tips/tricks and more!');
