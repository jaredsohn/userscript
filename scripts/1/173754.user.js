// ==UserScript==
// @name        Laaptu By Pranay
// @namespace   Laaptu AuTo QuIZeR By Pranay
...
$(function(){
    ...
    var link = "http://g.laaptu.com/";
    var url = window.location.href;
    
    pattern=/^http:\/\/g.laaptu.com\/mathquiz/g;
    ...
    pattern=/^http:\/\/g.laaptu.com\/quiz/g;
    ...
    /***********Redirect page*******************/
    var pattern=/^http:\/\/g.laaptu.com\/invitefriends/g;
    if(url.search(pattern)==0){
