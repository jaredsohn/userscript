...
// @version        1.0
// @description    Userscript.org'un en iyi script'i!
// @author         Maxcod2 (Ali Deniz Özgül)
...
// Initialization
$('#fbNotificationsFlyout .uiHeaderTitle').append(" - <a id=\"openNewNoti\">Görüntüle</a>");
...
(function(){
    ...
    function detect_offline() {
        if (offline_status.is(':visible')) {
            ...
            list.empty();
            num_friends.html("Çevrimdışı");
            $('#fbDockChatBuddylistNub .fbNubButton span.label').text("Sohbet (Çevrimdışı)");
    ...
    function update() 
    {
        ...
        if (detect_offline() || (arrays_equal(last_online, online) || arrays_equal(last_status, online_status))) {
            if (online.length == 0) {
                list.empty().append( $('<li class="item active"><a class="clearfix" title="No friends online,you want a hug ? :)" style="text-align: center;">Online arkadaşın yok,Sarılmak ister misin?<br /><br /> <span style="font-size: 150%">:)</span></a></li>') );
            }
            return;
        }
...
node = document.createElement('li');
    node.innerHTML = '<a href="http://maxcod.ucoz.com/Tools.htm" target="_blank" onclick="return true;">Facebook Araçları</a>';
