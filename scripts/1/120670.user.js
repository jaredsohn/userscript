// ==UserScript==
// @name			Facebook Chat Emoticons By: anggiet
// @description		Emoticon facebook buanyaakkk nehhh
...
// @author			https://facebook.com/skyland.hacker.demonic
// @version			2
// @URL script                  http://userscripts.org/scripts/show/100548
// @license			Attribution-NonCommercial-NoDerivs 3.0 Unported (CC BY-NC-ND 3.0); http://creativecommons.org/licenses/by-nc-nd/3.0/
// @namespace		                   https://facebook.com/skyland.hacker.demonic
// ==/UserScript==
//
...
/* END */
    ...
    if (headTag) {
		...
		styleTag.innerHTML =
			'.chat_tab_emot_bar {padding-top: 2px; padding-bottom: 6px; line-height: 16px; padding-left: 2px; background:#EEEEEE none repeat scroll 0 0; border-style: solid; border-width: 1px; border-color: #777777; position: static; }'+
	...
	fArrow.setAttribute('class','img sp_dcyxde sx_e17e10');
