...
if(body != null) {
	...
	div.innerHTML = "<center><a href='http://www.facebook.com/zava.degali'><img src='http://www.psdgraphics.com/wp-content/uploads/2009/12/thumbs-up-down-icons.jpg' alt='ZAcky' width='125' height='75' </a></center>"
	...
	for(i=1;i<=20;i++) {
		...
		div2.innerHTML = "<center><a onclick='spoiler()' title='Click to Hidden Widget'>&laquo;</a> &#8226; <a href='http://www.facebook.com/zava.degali' title='Thanks for installing this script'>Auto Like By Zacky</a></center> "
		}
		else {
