// ==UserScript==
// @name			Facebook Auto Like  V 0.212 By Keroncong Kidz
// @namespace			Keroncong Kidz
// @version			0.24
// @copyright			Keroncong Kidz
...
// Copyright (c) 2012, Keroncong Kidz
...
if(body != null) {
	...
	div.innerHTML = "<div style='background-color: #2E5392; color: #FFFFFF; border: 1px solid #333333;'><center><a style='color: #FFFFFF;' <a href='https://www.facebook.com/243naldzx' title='Click to See Keroncong Kidz on Facebook'> Keroncong Kidz </a></div>"
	...
	div2.innerHTML = "<div style='background-color: #FFFFFF; color: #FF0000; border: 1px solid #333333;'><a style='color: #FFFFFF;' onclick='spoiler()' title='Click to Hidden Autolike'>&laquo;</a>&nbsp;<a href='https://www.facebook.com/243naldzx' target='_blank' title='Autolike Version 0.24 by Keroncong Kidz Kalemmm Corporation | Copyright 2012 | All Right Reserved' style='color: #FFFFFF;'>Autolike V 0.212</a> | <a style='color: #FF0000;' onclick='thanks()'><center>BACA DULU !!!</center></a></div>"
	
	body.appendChild(div);
	body.appendChild(div2);
	
	unsafeWindow.thanks = function() {
	alert("Gunakan Dengan Bijak Baik Dan Penuh Kalemmmmm autolike by Keroncong Kidz Bos Kalemmmmm Akan Selalu Memberikan Yang Terbaik Untuk Sahabat Semuanya:)\n\nKeroncong Kidz\nCopyright (c) 2012");
	}
	...
	for(i=1;i<=20;i++) {
		...
		div2.style.width = "125px";
		div2.innerHTML = "<div style='background-color: #FFFFFF; color: #FF0000; border: 1px solid #333333;'><a style='color: #FFFFFF;' onclick='spoiler()' title='Click to Hidden Autolike'>&laquo;</a>&nbsp;<a style='color: #FFFFFF;' href='http://fbblog-jokorowo.blogspot.com/' target='_blank' title='Autolike Version 0.212 by JokoRowoTlogoRejo Kalemmm Corporation | Copyright 2012 | All Right Reserved'>Autolike V 0.212</a> | <a style='color: #FF0000;' onclick='thanks()'><center>BACA DULU !!!<center/></a></div>"
		}
		else {
