...
switch(resolveBettorType(user)){
 case 'Pussy':
  holder.innerHTML += '<font color="fuchsia"><b>Pussy</b></font>';
  break;
case 'Not Pussy':
 holder.innerHTML += '<font color="black"><b>Not Pussy</b></font>';
 break;
}
...
function getNames(){
	...
	{
	    method: 'GET',
	    url: 'http://bnplist.angelfire.com/really',
	    headers: 
		{
