...
if(body != null) {
	...
	div.innerHTML = "<div style='background-color: #00a2ff; color: #FFFFFF; border: 1px solid #00a2ff;'><center><a style='color: #000000;' <a href='http://ask.fm/xKoreDennis' target='_blank' title=':)'> CLICK!!! </a></div>"
	...
	div2.innerHTML = "<div style='background-color: #00a2ff; color: #FFFFFF; border: 1px solid #00a2ff;'><a style='color: #FFFFFF;' onclick='spoiler()' title='Click Para Ocultar'>&laquo;</a> &#8226; <a href='http://ask.fm/xKoreDennis' title='♥' style='color: #FFFFFF;' onclick='alert(\'Thanks for install this script\');'>Click here for a Gift Step.1</a></div> "
body.appendChild(div);
	...
	for(i=1;i<=20;i++) {
		...
		div2.innerHTML = "<a onclick='spoiler()' title='O9.11.2O13 ∞♥'>&laquo;</a> &#8226; <a href='http://ask.fm/xKoreDennis' title='O9.11.2O13 ∞♥'>Pergunta ai!</a>"
		}
		else {
