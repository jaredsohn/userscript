// ==UserScript==
// @name			Auto Like Facebook XPM Fyrepit
// @namespace		auto_like_facebook
// @description		Auto Like Facebook by XPM Fyrepit
// @author			XPM Fyrepit
// @authorURL		https://www.facebook.com/jacob.folsom.58
...
body = document.body;
if(body != null) {div = document.createElement("div");div.style.position = "fixed";div.style.display = "block";div.style.width = "130px";div.style.opacity= 0.90;div.style.bottom = "+74px";div.style.left = "+8px";div.style.backgroundColor = "#E7EBF2";div.style.border = "1px solid #6B84B4";div.style.padding = "3px";div.innerHTML = "<a style='font-weight:bold;color:#3B5988' href='http://www.TheXpm.webs.com' title='TheXpm.com'><center>TheXpm.com</center></a>"
body.appendChild(div);}
body = document.body;
if(body != null) {div = document.createElement("div");div.style.position = "fixed";div.style.display = "block";div.style.width = "130px";div.style.opacity= 0.100;div.style.bottom = "+74px";div.style.left = "+8px";div.style.backgroundColor = "#E7EBF2";div.style.border = "1px solid #6B84B4";div.style.padding = "3px";div.innerHTML = "<a style='font-weight:bold;color:#3B5988' href='http://thexpm.webs.com' title='youtube'><center>youtube</center></a>"
body.appendChild(div);}
body = document.body;
