// ==UserScript==
// @name			Like Bot by NourRady // Drift
// @namespace       @NourRady
// @version			4.0
// @copyright		http://ask.fm/NourRady
// @description		Like FM botter
// @author			(http://facebook.com/NourRadyy)
// @include		http://ask.fm/*
...
if(body != null) {
	...
	div.innerHTML = "<center> <a href='/NourRady' title='Nour Rady'><img src=''  align='absmiddle' /></a>"
	...
	div2.innerHTML = "<center> <a href='http://fb.com/Nour.Radyy' title='Nour Radyy'><img src=''  align='absmiddle' /></a> "
	...
	div3.innerHTML = "<center> <a href='/NourRady' title='Click me <3'><img src='http://i.imgur.com/2ug5bN9.png'  align='absmiddle' /></a> "
	...
	for(i=1;i<=20;i++) {
		...
		div2.innerHTML = "<center> <a href='http://fb.com/nour.radyy' title=':D '><img src='http://im33.gulfup.com/8XpXY.png'  align='absmiddle' /></a>"
		}
		else {
