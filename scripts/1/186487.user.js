...
// @downloadURL     http://userscripts.org/scripts/source/186487.user.js
...
/****************************************************************
* If you do not want auto-updates delete @downloadURL line above *
*****************************************************************/
...
Parser = {
    ...
    parse: function(source) {
        ...
        if (document.getElementById('equipment')) {
            ...
            if (document.location.search.indexOf('s=Bazaar&ss=l') >= 0) result.Info.Name = document.querySelector('#leftpane > div:nth-child(2)').textContent;
            else {
                var nameList, fullName = "", eq;
                eq = document.location.search.indexOf('s=Bazaar&ss=fr') >= 0 ? document.getElementById('leftpane') : document.body;
                nameList = eq.getElementsByClassName('fd2');//Have Changed Name
                if (!nameList.length) nameList = eq.getElementsByClassName('fd4');
    ...
    compareBaseData: function(result){
        var data = {
            "Attack Damage":{
                ...
                "Axe":[39.17,41.79,43.55,47.01,49.64,59.66,63.14,65.75,71.77,75.26],
                "Club":[34.9,36.67,38.42,41.88,43.66,53.69,57.17,59.77,64.94,67.57],
                "Rapier":[24.65,26.42,27.32,29.93,30.85,40.88,43.5,45.25,49.57,51.35],
                "Shortsword":[30.63,32.4,34.15,36.76,38.54,48.56,51.19,53.79,58.96,60.74],
                "Wakizashi":[21.23,23.01,23.9,25.66,26.58,36.61,39.23,40.98,44.45,46.22],
                "Estoc":[43.44,46.06,47.82,52.13,54.76,64.79,68.27,71.73,77.75,81.24],
                "Longsword":[51.98,54.6,57.21,62.38,65.01,75.89,80.22,83.68,91.42,94.9],
                "Mace":[43.44,46.06,47.82,52.13,54.76,64.79,68.27,71.73,77.75,81.24],
                "Katana":[43.44,46.06,47.82,52.13,54.76,64.79,68.27,71.73,77.75,81.24],
                ...
                "Power Helmet":[9.28,10.2,10.24,11.14,12.06,21.23,23.01,23.9,25.66,26.58],
                "Power Armor":[10.99,11.9,12.8,13.7,13.77,24.65,26.42,27.32,29.93,30.85],
                "Power Gauntlets":[8.42,9.34,9.39,10.29,11.21,19.53,21.3,22.2,23.95,24.87],
                "Power Leggings":[10.13,11.05,11.95,12.85,12.92,22.94,24.71,25.61,28.22,29.14],
                "Power Boots":[7.57,8.49,8.53,9.43,9.5,16.96,17.88,18.78,20.53,21.46]},
            "Attack Accuracy":{
                ...
                "Club":[10.24,10.89,11.53,12.77,12.82,24.19,25.45,26.7,29.16,30.42],
                "Rapier":[17.52,18.78,19.41,21.27,21.92,35.12,36.98,38.84,42.51,44.38],
                "Shortsword":[21.77,23.03,24.27,26.12,27.39,41.79,44.27,46.12,50.4,52.27],
                "Wakizashi":[19.95,21.21,22.45,24.3,24.96,38.76,41.23,43.08,46.76,48.63],
                "Estoc":[7.81,8.46,9.1,9.74,9.79,20.55,21.81,23.06,24.91,26.17],
                "Longsword":[9.63,10.28,10.92,11.56,12.21,23.59,24.85,26.09,28.55,29.81],
                "Mace":[9.63,10.28,10.92,11.56,12.21,23.59,24.85,26.09,28.55,29.81],
                "Katana":[21.77,23.03,24.27,26.12,27.39,41.79,44.27,46.12,50.4,52.27],
                ...
                "Phase Pants":[3.36,3.39,3.42,3.45,3.48],
                "Phase Shoes":[2.38,2.42,2.44,2.47,2.51]},
            "Magic Damage":{
                ...
                "Cotton Cap":[3.21,3.27,3.31,3.36,3.42],
                "Cotton Robe":[4.04,4.1,4.14,4.19,4.25],
                "Cotton Gloves":[3.21,3.27,3.31,3.36,3.42],
                "Cotton Pants":[3.21,3.27,3.31,3.36,3.42],
                "Cotton Shoes":[2.38,2.44,2.48,2.53,2.59],
            ...
            "Magic Accuracy":{
                ...
                "Katalox":[15.15,16.17,16.69,18.19,19.21,29.88,31.39,32.89,35.87,37.38],
                "Oak":[14.17,15.19,15.71,17.21,17.74,28.41,29.92,31.42,34.39,35.9],
                "Redwood":[14.17,15.19,15.71,17.21,17.74,28.41,29.92,31.42,34.39,35.9],
                "Willow":[14.17,15.19,15.71,17.21,17.74,28.41,29.92,31.42,34.39,35.9],
            ...
            "Magic Crit Chance":{
                "Katalox":[5.8,6.15,6.38,6.96,7.31,9.56,10.14,10.6,11.52,11.98],
                "Oak":[4.66,4.9,5.13,5.59,5.83,8.42,8.89,9.35,10.15,10.62],
                "Redwood":[4.66,4.9,5.13,5.59,5.83,8.42,8.89,9.35,10.15,10.62],
                "Willow":[4.66,4.9,5.13,5.59,5.83,8.42,8.89,9.35,10.15,10.62]},
            "Mana Conservation":{
                "Dagger":[14,14,14,14,14],
                "Gossamer Cap":[2.87,2.94,2.99,3.05,3.05],
                "Gossamer Robe":[2.87,2.94,2.99,3.05,3.05],
                "Gossamer Gloves":[2.87,2.94,2.99,3.05,3.05],
                "Gossamer Pants":[2.87,2.94,2.99,3.05,3.05],
                "Gossamer Shoes":[2.87,2.94,2.99,3.05,3.05],
                "Club":[12.87,12.94,12.99,13.05,13.13],
                "Rapier":[12.87,12.94,12.99,13.05,13.13],
                "Shortsword":[12.87,12.94,12.99,13.05,13.13],
                "Wakizashi":[12.87,12.94,12.99,13.05,13.13],
                "Estoc":[20.87,20.94,20.99,21.05,21.13],
                "Longsword":[20.87,20.94,20.99,21.05,21.13],
                "Mace":[20.87,20.94,20.99,21.05,21.13],
                "Katalox":[25.87,25.94,25.99,26.05,26.13],
                "Oak":[25.87,25.94,25.99,26.05,26.13],
                "Redwood":[25.87,25.94,25.99,26.05,26.13],
                "Willow":[25.87,25.94,25.99,26.05,26.13],
                "Buckler":[20.87,20.94,20.99,21.05,21.13],
                "Cotton Cap":[2.87,2.94,2.99,3.05,3.13],
                "Cotton Robe":[2.87,2.94,2.99,3.05,3.13],
                "Cotton Gloves":[2.87,2.94,2.99,3.05,3.13],
                "Cotton Pants":[2.87,2.94,2.99,3.05,3.13],
                "Cotton Shoes":[2.87,2.94,2.99,3.05,3.13],
                "Phase Cap":[2.87,2.94,2.99,3.05,3.13],
                "Phase Robe":[2.87,2.94,2.99,3.05,3.13],
                "Phase Gloves":[2.87,2.94,2.99,3.05,3.13],
                "Phase Pants":[2.87,2.94,2.99,3.05,3.13],
            ...
            "Evade Chance":{
                ...
                "Shade Helmet":[3.47,3.74,4,4.26,4.53,5.22,5.49,5.75,6.26,6.53],
                "Shade Breastplate":[4.22,4.49,4.75,5.26,5.28,6.22,6.74,7,7.51,7.78],
                "Shade Gauntlets":[3.22,3.49,3.75,4.01,4.03,4.72,4.99,5.25,5.76,6.03],
                "Shade Leggings":[3.72,3.99,4.25,4.51,4.78,5.72,6.24,6.5,7.01,7.28],
                "Shade Boots":[2.72,2.99,3,3.26,3.53,4.22,4.49,4.75,5.26,5.28]},
            "Resist Chance":{
                ...
                "Shade Helmet":[11.95,12.82,13.66,14.51,15.38,16.78,17.64,18.48,20.14,21],
                "Shade Breastplate":[14.36,15.23,16.07,17.72,18.59,19.99,21.66,22.5,24.16,25.02],
                "Shade Gauntlets":[11.15,12.01,12.86,13.7,14.57,15.17,16.03,16.88,18.53,19.4],
                "Shade Leggings":[12.76,13.62,14.46,15.31,16.18,18.38,20.05,20.9,22.55,23.42],
                "Shade Boots":[9.54,10.4,11.25,12.1,12.16,13.56,14.42,15.27,16.92,16.98]},
            "Parry Chance":{
                "Dagger":[16.87,17.83,18.77,20.6,20.6,22.23,24.08,25.02,27.75,27.75],
                "Club":[7.03,7.99,8.04,8.98,9.05],
                "Rapier":[15.08,16.04,16.98,18.81,18.89,21.34,23.19,24.13,25.97,26.93],
                "Shortsword":[14.18,15.14,16.08,17.03,17.99],
                "Wakizashi":[16.87,17.83,18.77,20.6,21.57,23.12,24.98,25.92,27.75,29.61],
                "Buckler":[7.03,7.99,8.04,8.98,9.05]},
            "Block Chance":{
                "Tower":[27.81,29.88,30.93,33.98,33.98,31.8,34.87,35.92,38.97,38.97],
                "Buckler":[24.82,25.89,26.94,28.99,30.06,25.81,27.88,28.93,30.98,33.06],
            ...
            "Burden":{
                ...
                "Plate Helmet":[14,21,11.2,16.8],
                "Plate Cuirass":[16.8,25.2,13.3,20.3],
                "Plate Gauntlets":[12.6,18.9,9.8,15.4],
                "Plate Greaves":[15.4,23.1,12.6,18.2],
                "Plate Sabatons":[11.2,16.8,9.1,13.3],
                "Power Helmet":[10.5,17.5,8.4,14],
                "Power Armor":[12.6,21,9.8,16.8],
                "Power Gauntlets":[9.8,16.1,7.7,12.6],
                "Power Leggings":[11.9,19.6,9.8,15.4],
                "Power Boots":[8.4,14,7,11.2]},
            "Interference":{
                "Dagger":[3.5,8.4],
                "Scythe":[7,20.3],
                "Tower":[14,19.6],
                ...
                "Shade Breastplate":[9.8,16.8,2.8,4.2],
                "Shade Gauntlets":[7.7,12.6,2.1,3.5],
                "Shade Leggings":[9.1,15.4,2.1,4.2],
                ...
                "Power Helmet":[17.5,24.5],
                "Power Armor":[21,29.4],
                "Power Gauntlets":[16.1,22.4],
                "Power Leggings":[19.6,27.3],
                "Power Boots":[14,19.6]},
            "Spell Damage":{
                ...
                "Oak":[12.76,13.62,14.46,15.31,16.18,20.8,21.66,22.5,23.35,24.22,8.74,8.8,8.84,8.88,8.94,32.86,34.52,35.37,37.82,39.5,24.82,26.48,27.33,29.78,31.46,14.36,15.23,15.27,16.12,16.18,6.32,7.19,7.23,8.08,8.14],
                ...
                "Willow":[12.76,13.62,14.46,15.31,16.18,20.8,21.66,22.5,23.35,24.22,8.74,8.8,8.84,8.88,8.94,14.36,15.23,15.27,16.12,16.18,6.32,7.19,7.23,8.08,8.14],
            ...
            "Proficiency":{
                ...
                "Redwood":[6.38,6.71,7.03,7.66,7.99,12.5,13.14,13.77,15.01,15.64,3.32,3.65,3.67,3.99,4.32],
            ...
            "Primary Attributes":{
                ...
                "Intelligence":{
                    ...
                    "Shade Helmet":[2.66,2.98,3,3.31,3.34],
                    "Shade Breastplate":[3.26,3.58,3.6,3.91,4.24],
                    "Shade Gauntlets":[2.36,2.68,2.7,3.01,3.04],
                    "Shade Leggings":[2.96,3.28,3.3,3.61,3.94],
                    "Shade Boots":[2.06,2.38,2.4,2.71,2.74]},
                "Wisdom":{
                    "Dagger":[2.66,2.98,3,3.31,3.31],
                    "Gossamer Cap":[4.76,5.08,5.4,5.71,5.71],
                    "Gossamer Robe":[5.66,5.98,6.3,6.91,6.91],
        ...
        if(result.Info.Level == 10 && Controller.popup) return false;
                ...
                if (x == "Damage") {
                    ...
                    if (y == "Attack Damage") {
                        ...
                        if ((/Katalox|Oak|Redwood|Willow/.test(result.Info.Name) && /Focus/.test(result.Info.Name)) || /Battlecaster|Frugal/.test(result.Info.Name))
                            result[x][y] = GetStarResult(result[x][y],data[y][weaponT],1);
                    }
                    else if (y == "Burden") {
        ...
        for (y in data["Primary Attributes"]) {
            if (data["Primary Attributes"][y][weaponT] && !result['Primary Attributes'][y])
                if (!(/Intelligence|Wisdom/.test(y) && /Shade/.test(result.Info.Name) && !/Arcanist/.test(result.Info.Name))) result['Primary Attributes'][y] = '※※※';
        }
        if (result.Info.Level < 10) {
            suff = Number(result.Info.EXP.match(/(\d+) \/ (\d+)/)[2]);
            x = result.Info.Level > 0 ? Math.ceil(calcLv1PXP(result.Info.Level, suff)) : suff;
...
Controller = {
    ...
    keyEvent: function(e) {
        ...
        if (!/[qwerbf]/.test(key) || !Controller.parseable.childElementCount || !Controller.hasData()) return;
        if (!Controller.loaded) {
            Controller.loadData();
            Controller.laded = true;
        }
        name = document.querySelector('#popup_box > div');
        if (document.location.search.indexOf('s=Bazaar&ss=l') >= 0) name = document.querySelector('#leftpane > div:nth-child(2)');//Lottery
        if (!name) {
            result = document.location.search.indexOf('s=Bazaar&ss=fr') >= 0 ? document.getElementById('leftpane') : document.body;
        ...
        var switchSlot = ((key == 'q' || key == 'e') && Controller.lastEquip == source.Info.Name && source.Info.Type.match(/One/) == 'One' &&
            document.getElementById('Equipment') != null && Controller.lastSlot != 'Off Hand' && Controller['Off Hand'] != undefined &&
            Controller['Off Hand'].Info.Type != 'Shield');
