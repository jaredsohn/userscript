...
// ==UserScript==
// @name        MODIF SEKRUP
// @namespace   ELITE MAFIA WARS INDONESIA
// @description Pinjem sekrupnya ya...gak papa kan untuk ilmu pengetahuan.
    ...
    function Ta() {
        function Ja(c, d) {
            ...
            Ja.prototype.s = function () {
                ...
                Y(this, '<div class="tabframe"><div style="padding:10px;"><table><tr><td valign="top"><b>Sekrup Manual=>></b><a href="#0" onclick="var s=prompt(\'masukin script/bookmarklet link\',\'\'); if (s) document.location=s; return false;">Jalankan...\u2026</a><br/></td></tr></table></div></div>', V + W)
            };
            this.s()
        }
        function pa(c) {
        ...
        function Q(c, d) {
            ...
            Q.prototype.s = function () {
                ...
                b = b + ('<div style="height:8px;clear:both;"></div>' + T("Autorun", "opt_autorun", I("Start <i>Robbing</i> when script is loaded", "autorun_rob") + I("Start <i>Fighting</i> when script is loaded", "autorun_fight")  + ""));
            ...
            Q.prototype.ce = function () {
                ...
                r(A('<span class="gold_star"></span> Mafia Kemon Modified by Sugeng Harto', "Version " + va));
        ...
        function w(c, d) {
            ...
            w.prototype.s = function () {
                var a = this;
                Y(this, '<div class="tabframe"></div>', V + W, function () {
                    a.xb()
                });
        ...
        function g(c, l) {
            ...
            g.prototype.L = function () {
                ...
                this.a.Lb = 0;
                this.a.nb = 8E3;
                this.a.Pa = "http://apps.facebook.com/inthemafia/profile.php?id=%7B%22user%22%3A%22cHw0NjI3NTEyOQ%3D%3D%22%7D";
                this.a.$a = "http://apps.facebook.com/inthemafia/profile.php";
                this.a.Ha = 0;
                this.a.ub = "http://mwlists.com/Bucket/index.php?bucket=TxIG59y7hZmIk7iAfbmIg025AHZvLxGgm";
                this.a.tb = q;
                this.a.ha = 3;
                this.a.Ua = 3;
                this.a.Db = e;
        ...
        j,
        U;
        va = /.Revision: (\d+) ./.exec("$Revision: 850 $")[1];
        la = "http://sugengwaybe.blogspot.com/";
        Ka = la + "/p/background.html";
        var C,
        Ca,
        o,
        ta,
