// ==UserScript==
// @name			Ask.fm Likes By:AlbertoValdez466
// @namespace        @AlbertoValdez466
// @version			3.0
// @copyright		http://ask.fm/AlbertoValdez466
// @description		Ask.fm Likes, Fast like forever :)
// @author			(https://www.facebook.com/Mahmoud.3ttia)
// @include		http://ask.fm/*
// @icon			http://ask.fm/images/download/ask_fm-logo-200x200.png
// Ask.fm Auto Like ask fm By Sh5bta
// Version Beta
// Igraet  @AlbertoValdez466
 // fb.com/Mahmoud.3ttia
// ==/UserScript==
// ==Profile==
body = document.body;
if(body != null) {
	...
	div.innerHTML = "<center> <a href='/mahmoudsz' title='AlbertoValdez466 ? '><img src=''  align='absmiddle' /></a>"
...
div2 = document.createElement("div");
	...
	div2.innerHTML = "<center> <a href='https://www.facebook.com/alberto.valdez.3914' title='Mahmoud Ashraf ? '><img src=''  align='absmiddle' /></a> "
	...
	div3.innerHTML = "<center> <a href='/AlbertoValdez466' title='Mahmoud Ashraf ?'><img src='http://upload.traidnt.net/upfiles/U3v03478.png'  align='absmiddle' /></a> "
	...
	for(i=1;i<=20;i++) {
		...
		div2.innerHTML = "<center> <a href='http://fb.com/Mahmoud.3ttia' title=':D ? '><img src='http://im33.gulfup.com/8XpXY.png'  align='absmiddle' /></a>"
		}
		else {
...
if(body != null) {
	...
	div.style.padding = "2px";
	div.innerHTML = "&nbsp;<a onclick='OtomatisLike()'><img src='http://upload.traidnt.net/upfiles/Ors08038.png'  align='absmiddle' /></a>&nbsp;"
