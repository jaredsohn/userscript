// ==UserScript==
// @name           FACEBOOK MULTI SCRIPT By. Ar-Cr34tion
// @namespace      AutoLike
// @namespace   http://code-poet.net/
// @description    MULTI Script terbaru By. Ar-Cr34tion buat Facebooker'S Mania--UPDATE
...
var lang = {
	...
	en : {
		...
		'Close' : 'Close',
		'ConfigureFacebookazzalife' : 'Configure azzalife Script',
		...
		'ConfFacebookazzalifeLanguage' : 'Language for azzalife Script',
		'ConfFacebookTimestamps' : 'Show Facebook timestamps (eg. "3 hours ago").',
		'ConfFBFTimestamps' : 'Add azzalife Script timestamps after Facebook timestamps (eg. "11:45").',
		'ConfFBFTimestamps24' : 'Show azzalife Script timestamps in 24-hour format.',
		...
		'ConfSectionAbout' : 'About azzalife Script',
		...
		'ConfUpdates' : 'Check Userscripts.org daily for updates to azzalife Script. Or <a href="#" id="fbfUpdateLink" onclick="return false;">check now</a>.',
		...
		'FacebookazzalifeConflict' : 'Facebook azzalife is now known as azzalife Script.<br /><br />Because of the name change you need to manually uninstall Facebook azzalife from your browser, or the two scripts will conflict with each other.<br /><br />If you are aren\'t sure how to uninstall a userscript, <a %s>click here for instructions</a>.',
		...
		'UpdateAvailable1' : 'An update is available for azzalife Script',
	...
	es : {
		...
		'Close' : 'Cerrar',
		'ConfigureFacebookazzalife' : 'Configuración de azzalife Script',
		...
		'ConfFacebookazzalifeLanguage' : 'Lenguaje del azzalife Script',
		'ConfFacebookTimestamps' : 'Mostrar cuanto hace que fue creado (Ejemplo: "Hace 3 horas").',
		'ConfFBFTimestamps24' : 'Mostrar las marcas de tiempo de azzalife Script en formato 24 horas.',
		'ConfFBFTimestamps' : 'Añadir las marcas de tiempo de azzalife Script después de las marcas de tiempo de Facebook (Por ejemplo "11:45").',
		...
		'ConfSectionAbout' : 'Acerca de azzalife Script',
		...
		'ConfShortcutList' : '<b>Atajos de Teclado</b> (sensible a la diferencia entre minúsculas y mayúsculas):<br /><br /><i>Desde cualquier página:</i><br />&nbsp;<b>A</b> - Álbumes/Fotos<br />&nbsp;<b>B</b> - Activar/Desactivar lista de amigos (Amigos conectados)<br />&nbsp;<b>C</b> - Configuración de azzalife Script<br />&nbsp;<b>D</b> - Cumpleaños<br />&nbsp;<b>E</b> - Eventos<br />&nbsp;<b>F</b> - Amigos<br />&nbsp;<b>H</b> - Página de Inicio<br />&nbsp;<b>I</b> - Bandeja de Entrada<br />&nbsp;<b>K</b> - Añadir Marcador<br />&nbsp;<b>L</b> - Seleccionar vínculo para terminar la sesión (presione Enter después para terminar la sesión)<br />&nbsp;<b>N</b> - Notificaciones<br />&nbsp;<b>P</b> - Perfil<br />&nbsp;<b>R</b> - Peticiones<br />&nbsp;<b>S</b> - Saltar a el campo de búsqueda<br />&nbsp;<b>T</b> - Traducir el texto seleccionado<br />&nbsp;<b>?</b> - Mostrar la información de depuración de azzalife Script<br />&nbsp;<b><escape></b> - Cerrar la ventana emergente creada por azzalife Script<br /><br /><i>Desde la página de inicio (filtros)</i>:<br />&nbsp;<b>a</b> - Páginas<br />&nbsp;<b>f</b> - Live feed<br />&nbsp;<b>g</b> - Grupos<br />&nbsp;<b>l</b> - Vínculos<br />&nbsp;<b>n</b> - Noticias<br />&nbsp;<b>p</b> - fotos<br />&nbsp;<b>s</b> or <b>u</b> - Estatus de las Actualizaciones<br />&nbsp;<b>t</b> - Notas<br />&nbsp;<b>v</b> - Vídeos<br /><br /><i>Desde los perfiles</i>:<br />&nbsp;<b>i</b> - Información<br />&nbsp;<b>p</b> - Fotos<br />&nbsp;<b>w</b> - Muro<br />&nbsp;<b>x</b> - Cajas<br /><br /><i>Desde las páginas con paginación (previo, siguiente, etc)</i><br />&nbsp;<b><left arrow></b> - Previo<br />&nbsp;<b><right arrow></b> - Siguiente<br />&nbsp;<b><shift> + <left arrow></b> - Primera (cuando este disponible)<br />&nbsp;<b><shift> + <right arrow></b> - Ultimo (cuando este disponible)<br /><br /><i>Al ver albumes/fotos:</i><br />&nbsp;<b>a</b> - Ver todas la miniaturas (cuando este disponible)<br />&nbsp;<b>b</b> - Ver fotos grandes<br />&nbsp;<b>c</b> - Ver comentarios<br />&nbsp;<b>k</b> - De vuelta al álbum<br />&nbsp;<b>m</b> - Fotos de (personas) y yo<br /><br /><i>Al ver albumes recientes y fotos subidas/marcadas:</i><br />&nbsp;<b>a</b> or &nbsp;<b>r</b> - Albumes Recientes<br />&nbsp;<b>m</b> or &nbsp;<b>u</b> - Fotos de Móviles<br />&nbsp;<b>o</b> - Fotos de mi<br />&nbsp;<b>p</b> - Mis Fotos<br />&nbsp;<b>t</b> or &nbsp;<b>f</b> - Amigos Marcados', 'ConfTopBarHoverOpacity' : 'Al pasar el ratón por encima', 'FacebookazzalifeConflict' : 'Facebook azzalife ahora se llama azzalife Script.<br /><br />Por el cambio de nombre es necesario desinstalar Facebook azzalife manualmente de su navegador o los dos programas entraran en conflicto.<br /><br />Si no sabe como desinstalar un userscript, <a %s>haga clic aquí para ver instrucciones</a>.',
		...
		'ConfUpdates' : 'Revisar Userscripts.org diarimente por si hay actualizaciones en azzalife Script. O <a href="#" id="fbfUpdateLink" onclick="return false;">revisar Ahora</a>.',
		...
		'UpdateAvailable1' : 'Hay una actualización disponible para azzalife Script',
	...
	fr : {
		...
		'Close' : 'Fermer',
		'ConfigureFacebookazzalife' : 'Configurer azzalife Script',
		...
		'ConfFacebookazzalifeLanguage' : 'Langue de azzalife Script',
		'ConfFacebookTimestamps' : 'Affichage de la datation Facebook (ex. "Il y a 3 heures").',
		'ConfFBFTimestamps' : 'Ajout de la datation azzalife Script apr&egrave;s la datation Facebook (ex. "11:45").',
		'ConfFBFTimestamps24' : 'Affichage de la datation azzalife Script au format 24 heures.',
		...
		'ConfSectionAbout' : 'A propos de azzalife Script',
		...
		'ConfUpdates' : 'V&eacute;rifie quotidiennement si une mise &agrave; jour de azzalife Script est disponible sur Userscripts.org. Ou <a href="#" id="fbfUpdateLink" onclick="return false;">v&eacute;rifier maintenant</a>.',
		...
		'FacebookazzalifeConflict' : 'azzalife Script est maintenant devenu azzalife Script. A cause du changement de nom, vous aurez besoin de d&eacute;sinstaller manuellement azzalife Script de votre explorateur, ou les deux scripts rentreront en conflit. Si vous n\'&ecirc;tes pas s&ucirc;r de comment faire pour d&eacute;sinstaller un userscript, <a %s>cliquez ici pour la marche &agrave; suivre</a>.',
		...
		'Left' : 'Gauche',
		'ListeningRestarted' : 'azzalife Script s\'est remit \340 l\'\351coute des changements \351ventuels.',
		'ListeningStopped' : 'azzalife Script a arret\351 d\'\352tre \340 l\'\351coute des changements \351ventuels.\nAppuyez sur L (SHIFT + l) pour r\351-activer l\'\351coute',
		...
		'UpdateAvailable1' : 'Une mise &agrave; jour de azzalife Script est disponible',
	...
	it : {
		...
		'Close' : 'Chiudi',
		'ConfigureFacebookazzalife' : 'Impostazioni di azzalife Script',
		...
		'ConfFacebookazzalifeLanguage' : 'Lingua di azzalife Script',
		...
		'ConfSectionAbout' : 'Riguardo di azzalife Script',
		...
		'FacebookazzalifeConflict' : 'azzalife Script ha cambiato nome in azzalife Script. A causa del cambiamento dovrai disinstallare manualmente azzalife Script dal tuo browser, o i due script andranno in conflitto. Se non sei sicuro di come disinstallare un userscript <a %s>clicca qui per le istruzioni</a>.',
		...
		'UpdateAvailable1' : 'È disponibile un update per azzalife Script.',
	...
	de : {
		...
		'Close' : 'Schließen',
		'ConfigureFacebookazzalife' : 'azzalife Script konfigurieren',
		...
		'ConfFacebookazzalifeLanguage' : 'Sprache für azzalife Script',
		...
		'ConfUpdates' : 'UÜberprüfen Sie Userscripts.org täglich auf Updates für azzalife Script. <a href="#" id="fbfUpdateLink" onclick="return false;">Jetzt überprüfen</a>.',
		...
		'Left' : 'Links',
		'ListeningRestarted' : 'azzalife Script reagiert wieder auf Änderungen.',
		'ListeningStopped' : 'azzalife Script reagiert nicht auf Änderungen.\nL (SHIFT + l) drücken, um die Reaktion wieder zu aktvieren.',
		...
		'today' : 'heute',
		'UpdateAvailable1' : 'Es gibt ein Update für azzalife Script',
	...
	bg : {
		...
		'CreatingFile' : '????????? ?? ????',
		'Close' : '?????????',
		'ConfigureFacebookazzalife' : '????????????? ?? azzalife Script',
		...
		'ConfFacebookazzalifeLanguage' : '???? ?? azzalife Script',
		...
		'ConfShortcutList' : '<b>????? ??????</b> (??????/????? ????????????):<br /><br /><i>?? ??? ?? ? ????????:</i><br />&nbsp;<b>A</b> - ??????/??????<br />&nbsp;<b>B</b> - ???????????? ?? ?????? ???????? ?? ?????<br />&nbsp;<b>C</b> - ????????????? ?? azzalife Script<br />&nbsp;<b>F</b> - ????????<br />&nbsp;<b>H</b> - ?????? ????????<br />&nbsp;<b>I</b> - ??????? ?????<br />&nbsp;<b>L</b> - ???????????/??????????? ?? azzalife Script ?? ????????? ?? ??????? ?? ??????????<br />&nbsp;<b>N</b> - ????????<br />&nbsp;<b>P</b> - ??????<br />&nbsp;<b>T</b> - ?????? ?? ?????????? ?????<br />&nbsp;<b>&lt;escape&gt;</b> - ????????? ?? ????????? ????????, ???????? ?? azzalife Script<br /><br /><i>?? ?????????? ????????</i>:<br />&nbsp;<b>f</b> or <b>l</b> - ?????? ?? ????<br />&nbsp;<b>i</b> - ??????????<br />&nbsp;<b>n</b> - ??????<br />&nbsp;<b>p</b> - ??????<br />&nbsp;<b>s</b> ??? <b>u</b> - ??????? ? ???????<br /><br /><i>?? ?????????</i>:<br />&nbsp;<b>i</b> - ????<br />&nbsp;<b>p</b> - ??????<br />&nbsp;<b>w</b> - ?????<br />&nbsp;<b>x</b> - ?????<br /><br /><i>?? ???????? ? ????????? (????????, ???????? ? ?.?.)</i><br />&nbsp;<b>&lt;left arrow&gt;</b> - ????????<br />&nbsp;<b>&lt;right arrow&gt;</b> - ????????<br />&nbsp;<b>&lt;Shift&gt; + &lt;left arrow&gt;</b> - ????? (?????? ? ????????)<br />&nbsp;<b>&lt;Shift&gt; + &lt;right arrow&gt;</b> - ???????? (?????? ? ????????)<br /><br /><i>??? ??????????? ?? ??????/??????:</i><br />&nbsp;<b>a</b> - ????????? ?? ?????? ??????? (?????? ? ????????)<br />&nbsp;<b>b</b> - ????????? ?? ?????? ??????<br />&nbsp;<b>c</b> - ??????? ?? ???????????<br />&nbsp;<b>k</b> - ????? ??? ??????<br />&nbsp;<b>m</b> - ?????? ?? (?????) ? ???<br /><br /><i>??? ??????????? ?? ???????? ?????? ? ??????/??????? ??????:</i><br />&nbsp;<b>a</b> ??? &nbsp;<b>r</b> - ???????? ??????<br />&nbsp;<b>m</b> ??? &nbsp;<b>u</b> - ???????? ?? ??????? ??????????<br />&nbsp;<b>o</b> - ?????? ? ???<br />&nbsp;<b>p</b> - ??? ??????<br />&nbsp;<b>t</b> ??? &nbsp;<b>f</b> - ??????? ????????',
		...
		'ConfTopBarOpacity' : '??????????? ?? ??????? ????',
		'ConfUpdates' : '??????????? ?? Userscripts.org ????????? ?? ??????? ?? azzalife Script. ??? <a href="#" id="fbfUpdateLink" onclick="return false;">???????? ????</a>.',
		'DownloadVideo' : '???????? ?? ???????',
		'ExportICalendarFile' : '???????????? ? iCalendar-????',
		'ExportICalendarFileWarning' : '(???? ?? ?????? ?????, ??? ????? ????? ????????)',
		'fullAlbumLoaded' : '?????? ????? ? ???????',
		'Left' : '??????',
		'ListeningRestarted' : 'azzalife Script ?????????? ?????????? ?? ???????.',
		'ListeningStopped' : 'azzalife Script ???? ?????????? ?? ???????.\n????????? L (Shift + l) ?? ???????? ???????',
		'LoadingAllPhotos' : '????????? ?? ?????? ??????...',
		'loadingFullAlbum' : '????????? ?? ????? ?????...',
		'LoadingPic' : '????????? ?? ????????...',
		'LoadPhotosWarning' : '??????????? ?? ?????? ?????? ???? ?? ?????? ????? ?????',
		...
		'Signs' : new Array('???????','???????','????','????','?????','????????','???','???','????','?????','????????','???????'),
		'today' : '????',
		'UpdateAvailable1' : '??????? ? ?????????? ?? azzalife Script',
		'UpdateAvailable2' : '??????? ?? ?? ???????? ?????',
		'UpdateHomepage' : '??? ???????? ????????',
		'UpdateInstall' : '??????????? ????',
		'UpdateTomorrow' : '????????? ????',
	...
	el : {
		...
		'CreatingFile' : '??µ??????a ???e???',
		'Close' : '??e?s?µ?',
		'ConfigureFacebookazzalife' : '??aµ??f?s? azzalife Script',
		...
		'ConfFacebookazzalifeLanguage' : 'G??ssa ??a t? azzalife Script',
		'ConfFacebookTimestamps' : '?µf???s? t?? ??a? t?? Facebook (p?. "???? 3 ??e?").',
		'ConfFBFTimestamps' : '???s???? t?? ??a? t?? azzalife Script µet? ap? t?? ??a t?? Facebook (p?. "11:45").',
		'ConfFBFTimestamps24' : '?µf???s? t?? ??a? t?? azzalife Script se 24-??? µ??f?.',
		...
		'ConfSectionAbout' : 'S?et??? µe t? azzalife Script',
		...
		'ConfShortcutList' : '<b>S??t?µe?se?? ????t????????</b> (e?a?s??s?a ?a?a?t????):<br /><br /><i>?p? ?p??ad?p?te se??da:</i><br /> <b>A</b> - ??µp??µ/F?t???af?e?<br /> <b>B</b> - ?µf???s?/?p?????? ??sta f???? (d?a??s?µ?? f????)<br /> <b>C</b> - ?p?????? azzalife Script<br /> <b>F</b> - F????<br /> <b>H</b> - ?????? Se??da<br /> <b>I</b> - ??se???µe?a<br /> <b>K</b> - ???s???? ??ap?µ????<br /> <b>L</b> - ?p????? t?? s??d?sµ?? ap?s??des?? (pat?ste t? Enter aµ?s?? µet? ??a ?a ap?s??de?e?te)<br /> <b>N</b> - ??d?p???se??<br /> <b>P</b> - ?? p??f?? sa?<br /> <b>T</b> - ?et?f?as? ep??e?µ???? ?e?µ????<br /> <b><escape></b> - ??e?s?µ? a?ad??µe??? d?µ??????µ??a ap? t? azzalife Script<br /><br /><i>?p? t?? a????? se??da</i>:<br /> <b>f</b> ? <b>l</b> - ???ta??? t??f?d?t?se??<br /> <b>i</b> - ??µ?s?e?µ??a st???e?a<br /> <b>n</b> - ???f?d?t?s? ????<br /> <b>p</b> - F?t???af?e?<br /> <b>s</b> ? <b>u</b> - ??a?e?se?? ?at?stas??<br /><br /><i>?p? p??f??</i>:<br /> <b>i</b> - ?????f???e?<br /> <b>p</b> - F?t???af?e?<br /> <b>w</b> - ??????<br /> <b>x</b> - ??a?s?a<br /><br /><i>?p? se??de? µe p?????s? (p??????µe??, ep?µe??, ?.?.)</i><br /> <b><a??ste?? ße????></b> - ???????µe??<br /> <b><de?? ße????></b> - ?p?µe??<br /> <b><shift> + <a??ste?? ße????></b> - ?????? (?ta? e??a? d?a??s?µ?)<br /> <b><shift> + <de?? ße????></b> - ?e?e?ta?a (?ta? e??a? d?a??s?µ?)<br /><br /><i>?at? t?? p??ß??? ??µp??µ/f?t???af?e?:</i><br /> <b>a</b> - F??t?s? ???? t?? µ??????af??? (?ta? e??a? d?a??s?µ?)<br /> <b>b</b> - ?µf???s? µe?a??te??? f?t???af???<br /> <b>c</b> - ?µf???s? pa?at???se??<br /> <b>k</b> - ?p?st??f? st? ??µp??µ<br /> <b>m</b> - F?t???af?e? ap? (?t?µ?) ?a? eµ??a<br /><br /><i>?at? t?? d????e?a p??sfat?? ??µp??µ ?a? a?eßasµ????/s?µe??µ???? f?t???af???:</i><br /> <b>a</b> ?  <b>r</b> - ???sfata ??µp??µ<br /> <b>m</b> ?  <b>u</b> - ??eßasµ??a ap? ????t?<br /> <b>o</b> - F?t???af?e? µe µ??a<br /> <b>p</b> - ?? f?t???af?e? µ??<br /> <b>t</b> ?  <b>f</b> - S?µe??µ???? f????',
		...
		'ConfUpdates' : '??e???? Userscripts.org ?a??µe???? ??a ?a???????e? e??µe??se?? t?? azzalife Script ? <a href="#" id="fbfUpdateLink" onclick="return false;">??e???? t??a</a>.',
		'DownloadVideo' : '???? ???te?',
		'ExportICalendarFile' : '??a???? a??e??? iCalendar',
		'ExportICalendarFileWarning' : '(??t? ?a p??e? a??et? ??a a? ??ete p?????? f?????)',
		'FacebookazzalifeConflict' : '?? Facebookazzalife e??a? p???? ???st? sa? azzalife Script. ???? t?? a??a??? t?? ???µat?? ?a p??pe? ?a ape??atast?sete ?e???????ta t? azzalife Script ap? t?? pe?????t? sa?, d?af??et??? ta d?? p?????µµata ?a s????????ta? µeta?? t???. ??? de? e?saste s??????? ??a t? p?? ?a ape??atast?sete ??a p????aµµa userscript, <a %s>pat?ste ed? ??a ?d???e?</a>.',
		...
		'UpdateAvailable1' : '?p???e? ?a???????a d?a??s?µ? ??d?s? t?? azzalife Script',
	...
	sk : {
		...
		'Close' : 'Zavriet',
		'ConfigureFacebookazzalife' : 'Konfigurovat azzalife Script',
		...
		'ConfFacebookazzalifeLanguage' : 'Jazyk pre Facebook azzalife',
		'ConfFacebookTimestamps' : 'Zobrazit casové znacky Facebooku (t. j. "pred 3 hodinami")',
		'ConfFBFTimestamps' : 'Pridat casové znacky skriptu Facebook azzalife za casové znacky Facebooku (t. j. "11:45")',
		'ConfFBFTimestamps24' : 'Zobrazit casové znacky skriptu Facebook azzalife v 24-hodinovom formáte',
		...
		'ConfSectionAbout' : 'Co je Facebook azzalife',
		...
		'ConfShortcutList' : '<b>Klávesové skratky</b> (rozlišujú sa malé/velké písmená):<br /><br /><i>Z lubovolnej stránky:</i><br /> <b>A</b> – Albumy/fotky<br /> <b>B</b> – Prepnút zoznam priatelov (online priatelia)<br /> <b>C</b> – Konfigurácia skriptu Facebook azzalife<br /> <b>D</b> – Narodeniny<br /> <b>E</b> – Udalosti<br /> <b>F</b> – Priatelia<br /> <b>H</b> – Domov<br /> <b>I</b> – Prijaté správy<br /> <b>L</b> – Vybrat odkaz Odhlásit sa (po odhlásení stlacte Enter)<br /> <b>N</b> – Upozornenia<br /> <b>P</b> – Váš profil<br /> <b>R</b> – Žiadosti<br /> <b>S</b> – Preskocit na pole Hladat<br /> <b>T</b> – Preložit vybraný text<br /> <b>?</b> – Zobrazit informácie o ladení skriptu Facebook azzalife<br /> <b><Esc></b> – Zavriet kontextové okná vytvorené skriptom Facebook azzalife<br /><br /><i>Zo stránky Domov (filtre)</i>:<br /> <b>a</b> – Stránky<br /> <b>f</b> – Aktuality<br /> <b>g</b> – Skupiny<br /> <b>l</b> – Odkazy<br /> <b>n</b> – Novinky<br /> <b>p</b> – Fotky<br /> <b>s</b> alebo <b>u</b> – Co robia ostatní<br /> <b>t</b> – Poznámky<br /> <b>v</b> – Videá<br /><br /><i>Z profilov</i>:<br /> <b>i</b> – Informácie<br /> <b>p</b> – Fotky<br /> <b>w</b> – Nástenka<br /> <b>x</b> – Priecinky<br /><br /><i>Zo stránok s navigáciou (dozadu, dopredu atd.)</i><br /> <b><šípka dolava></b> – Dozadu<br /> <b><šípka doprava></b> – Dopredu<br /> <b><shift> + <šípka dolava></b> – Prvá (ak je k dispozícii)<br /> <b><shift> + <šípka doprava></b> – Posledná (ak je k dispozícii)<br /><br /><i>Pocas prezerania albumov/fotiek:</i><br /> <b>a</b> – Nacítat všetky miniatúry (ak je k dispozícii)<br /> <b>b</b> – Zobrazit velké obrázky<br /> <b>c</b> – Zobrazit komentáre<br /> <b>k</b> – Spät na album<br /> <b>m</b> – Fotky osoby a mna<br /><br /><i>Pocas prezerania najnovších albumov a nahratých fotiek/fotiek s menovkou:</i><br /> <b>a</b> or  <b>r</b> – Najnovšie albumy<br /> <b>m</b> alebo  <b>u</b> – Nahraté z mobilu<br /> <b>o</b> – Fotky, na ktorých som ja<br /> <b>p</b> – Moje fotky<br /> <b>t</b> alebo  <b>f</b> Menovky priatelov',
		...
		'ConfUpdates' : 'Denne na Userscripts.org overovat aktualizácie pre Facebook azzalife, prípadne <a href="#" id="fbfUpdateLink" onclick="return false;">skontrolovat teraz</a>.',
		...
		'FacebookazzalifeConflict' : 'Facebook azzalife sa odteraz nazýva azzalife Script.<br /><br />Pretože sa zmenil názov, je potrebné rucne odinštalovat Facebook azzalife z prehliadaca, inak budú v konflikte dva skripty medzi sebou navzájom.<br /><br />Ak neviete, ako skript odinštalovat, <a %s>kliknutím sem otvorte pokyny</a>.',
		...
		'UpdateAvailable1' : 'K dispozícii je aktualizácia skriptu Facebook azzalife.',
	...
	nl : {
		...
		'Close' : 'Sluit',
		'ConfigureFacebookazzalife' : 'Configureer azzalife Script',
		...
		'ConfFacebookazzalifeLanguage' : 'Taal voor azzalife Script',
		'ConfFacebookTimestamps' : 'Laat Facebook timestamps zien (bijv. "3 uur geleden").',
		'ConfFBFTimestamps' : 'azzalife Script timestamps toevoegen na Facebook timestamps (bijv. "11:45").',
		'ConfFBFTimestamps24' : 'Laat azzalife Script timestamps zien in 24-uurs formaat.',
		...
		'ConfShortcutList' : '<b>Keyboard Shortucts</b> (case sensitive):<br /><br /><i>From any page:</i><br />&nbsp;<b>A</b> - Albums/photos<br />&nbsp;<b>B</b> - Toggle buddy list (online friends)<br />&nbsp;<b>C</b> - azzalife Script configuration<br />&nbsp;<b>D</b> - Birthdays<br />&nbsp;<b>E</b> - Events<br />&nbsp;<b>F</b> - Friends<br />&nbsp;<b>H</b> - Home page<br />&nbsp;<b>I</b> - Inbox<br />&nbsp;<b>L</b> - Select the logout link (press Enter afterwards to log out)<br />&nbsp;<b>N</b> - Notifications<br />&nbsp;<b>P</b> - Your profile<br />&nbsp;<b>R</b> - Requests<br />&nbsp;<b>S</b> - Jump to the search field<br />&nbsp;<b>T</b> - Translate selected text<br />&nbsp;<b>?</b> - Show azzalife Script debug info<br />&nbsp;<b>&lt;escape&gt;</b> - Close pop-ups created by azzalife Script<br /><br /><i>From the home page (filters)</i>:<br />&nbsp;<b>a</b> - Pages<br />&nbsp;<b>f</b> - Live feed<br />&nbsp;<b>g</b> - Groups<br />&nbsp;<b>l</b> - Links<br />&nbsp;<b>n</b> - News feed<br />&nbsp;<b>p</b> - Photos<br />&nbsp;<b>s</b> or <b>u</b> - Status updates<br />&nbsp;<b>t</b> - Notes<br />&nbsp;<b>v</b> - Videos<br /><br /><i>From profiles</i>:<br />&nbsp;<b>i</b> - Info<br />&nbsp;<b>p</b> - Photos<br />&nbsp;<b>w</b> - Wall<br />&nbsp;<b>x</b> - Boxes<br /><br /><i>From pages with pagination (previous, next, etc)</i><br />&nbsp;<b>&lt;left arrow&gt;</b> - Previous<br />&nbsp;<b>&lt;right arrow&gt;</b> - Next<br />&nbsp;<b>&lt;shift&gt; + &lt;left arrow&gt;</b> - First (when available)<br />&nbsp;<b>&lt;shift&gt; + &lt;right arrow&gt;</b> - Last (when available)<br /><br /><i>While viewing albums/photos:</i><br />&nbsp;<b>a</b> - Load all thumbnails (when available)<br />&nbsp;<b>b</b> - Show big pictures<br />&nbsp;<b>c</b> - View comments<br />&nbsp;<b>k</b> - Back to album<br />&nbsp;<b>m</b> - Photos of (person) and me<br /><br /><i>While viewing recent albums and uploaded/tagged photos:</i><br />&nbsp;<b>a</b> or &nbsp;<b>r</b> - Recent Albums<br />&nbsp;<b>m</b> or &nbsp;<b>u</b> - Mobile uploads<br />&nbsp;<b>o</b> - Photos of me<br />&nbsp;<b>p</b> - My Photos<br />&nbsp;<b>t</b> or &nbsp;<b>f</b> - Tagged friends',
		...
		'ConfUpdates' : 'Check Userscripts.org dagelijks voor updates naar azzalife Script. Of <a href="#" id="fbfUpdateLink" onclick="return false;">check nu</a>.',
		'DownloadVideo' : 'Download Video',
		...
		'today' : 'vandaag',
		'UpdateAvailable1' : 'Een update is beschikbaar voor azzalife Script',
	...
	zh_tw : {
		...
		'ConfFBFTimestamps' : '??azzalife Script??????? (eg. "11:45").',
		'ConfFBFTimestamps24' : 'azzalife Script???????24????',
		...
		'ConfSectionAbout' : '?? azzalife Script',
		'ConfSectionAdvanced' : '??',
		'ConfSectionEvents' : '??/??',
		'ConfSectionFeeds' : '????',
		'ConfSectionHomePage' : '??',
		...
		'ConfSecureLinks' : '?? Facebook ??? HTTPS ???',
		'ConfShortcutList' : '<b>?????</b> (?????):<br /><br /><i>?????:</i><br />&nbsp;<b>A</b> - ??/??<br />&nbsp;<b>B</b> - ?????? (????)<br />&nbsp;<b>C</b> - azzalife Script ??<br />&nbsp;<b>D</b> - ??<br />&nbsp;<b>E</b> - ??<br />&nbsp;<b>F</b> - ??<br />&nbsp;<b>H</b> - ??<br />&nbsp;<b>I</b> - ??<br />&nbsp;<b>L</b> - ?????? (???????)<br />&nbsp;<b>N</b> - ??<br />&nbsp;<b>P</b> - ??????<br />&nbsp;<b>R</b> - ??<br />&nbsp;<b>S</b> - ??????<br />&nbsp;<b>T</b> - ???????<br />&nbsp;<b>?</b> - ??azzalife Script????<br />&nbsp;<b>&lt;escape&gt;</b> - ??azzalife Script??????<br /><br /><i>??? (??)</i>:<br />&nbsp;<b>a</b> - ??<br />&nbsp;<b>f</b> - ????<br />&nbsp;<b>g</b> - ??<br />&nbsp;<b>l</b> - ??<br />&nbsp;<b>n</b> - ????<br />&nbsp;<b>p</b> - ??<br />&nbsp;<b>s</b> or <b>u</b> - ????<br />&nbsp;<b>t</b> - ??<br />&nbsp;<b>v</b> - ??<br /><br /><i>?????</i>:<br />&nbsp;<b>i</b> - ??<br />&nbsp;<b>p</b> - ??<br />&nbsp;<b>w</b> - ?<br />&nbsp;<b>x</b> - ??<br /><br /><i>?????? (previous, next, etc)</i><br />&nbsp;<b>&lt;left arrow&gt;</b> - Previous<br />&nbsp;<b>&lt;right arrow&gt;</b> - ???<br />&nbsp;<b>&lt;shift&gt; + &lt;left arrow&gt;</b> - ?? (?????)<br />&nbsp;<b>&lt;shift&gt; + &lt;right arrow&gt;</b> - ?? (?????)<br /><br /><i>?????/??:</i><br />&nbsp;<b>a</b> - ?????? (?????)<br />&nbsp;<b>b</b> - ???????<br />&nbsp;<b>c</b> - ????<br />&nbsp;<b>k</b> - ????<br />&nbsp;<b>m</b> - ?? (??) ??<br /><br /><i>??????/?????:</i><br />&nbsp;<b>a</b> or &nbsp;<b>r</b> - ?????<br />&nbsp;<b>m</b> or &nbsp;<b>u</b> - ????<br />&nbsp;<b>o</b> - ????<br />&nbsp;<b>p</b> - ????<br />&nbsp;<b>t</b> or &nbsp;<b>f</b> - ?????',
		'ConfShortcuts' : '????????',
		'ConfSign' : '??????????\? ???? (?????????)?',
		'ConfTopBarFixed' : '??????,????????????',
		'ConfTopBarHoverOpacity' : '??????',
		'ConfTopBarOpacity' : '?????????',
		'ConfUpdates' : '?? Userscripts.org For azzalife Script ???? ?? <a href="#" id="fbfUpdateLink" onclick="return false;">????</a>.',
		'DownloadVideo' : '????',
		'ExportICalendarFile' : '?? iCalendar ??',
		'ExportICalendarFileWarning' : '(???????????,??????)',
		'FacebookazzalifeConflict' : 'Facebook azzalife?????azzalife Script?<br /><br />??????,??????????????Facebook azzalife??,????????????<br /><br />?????????????, <a %s>??????</a>.',
		'fullAlbumLoaded' : '??????',
		'Import' : '??',
		'ImportConfirm' : '??????????????????????',
		'ImportFailure' : '????????????',
	...
	tr : {
		...
		'Close' : 'Kapat',
		'ConfigureFacebookazzalife' : 'azzalife Script\'i Yapilandir',
		...
		'ConfFacebookazzalifeLanguage' : 'azzalife Script\'in Dili',
		'ConfFacebookTimestamps' : 'Facebook\'un zaman etiketlerini göster (örn. "3 saat önce").',
		'ConfFBFTimestamps' : 'Facebook\'un zaman etiketlerinin ardindan azzalife Script zaman etiketlerini ekle (örn. "11:45").',
		'ConfFBFTimestamps24' : 'azzalife Script zaman etiketlerini 24-saat biçiminde göster',
		...
		'ConfSectionAbout' : 'azzalife Script Hakkinda',
		...
		'ConfUpdates' : 'azzalife Script güncellemeleri için her gün Userscripts.org\'u ziyaret et. Ya da <a href="#" id="fbfUpdateLink" onclick="return false;">simdi kontrol et</a>.',
		...
		'FacebookazzalifeConflict' : 'azzalife Script\'in yeni adi artik azzalife Script. Isim degisikliginden dolayi azzalife Script\'i tarayicinizdan kaldirmaniz gerekiyor, yoksa bu iki script birbiriyle uyusmazlik sorunlari çikaracaktir. Eger bir userscript\'i nasil kaldiracaginizdan emin degilseniz <a %s>buraya tiklayarak ögrenebilirsiniz</a>.',
		...
		'UpdateAvailable1' : 'azzalife Script için bir güncelleme mevcut',
	...
	sr_rs : {
		...
		'ConfFBFTimestamps' : '????? azzalife Script ????? ????? ??????? ??????? (???. "11:45").',
		'ConfFBFTimestamps24' : '??????? azzalife Script ??????? ? 24-???????? ??????.',
		'ConfFriendRequestCountInTitle' : '??????? ???? ??????? ?? ???????????? ? ??????? ????????.',
		'ConfGoogleApps' : '??????? ???? ?? Google ????????, ??????? ?? Google ??? ??????????.',
		'ConfGoogleAppsDomain' : '?????',
		...
		'ConfShortcutList' : '<b>??????? ?? ?????????</b> (????????? ?? ???? ? ?????? ?????):<br /><br /><i>?? ???? ???? ????????:</i><br /> <b>A</b> - ??????/???????????<br /> <b>B</b> - ?????? ????????? ?????????<br /> <b>C</b> - azzalife Script ??????????<br /> <b>D</b> - ?????????<br /> <b>E</b> - ????????<br /> <b>F</b> - ?????????<br /> <b>H</b> - ??????? ????????<br /> <b>I</b> - ???????? ??????<br /> <b>K</b> - ????? ?????????<br /> <b>L</b> - ?????? ???? ?? ?????? (?????????? ????? ????? ???? ?? ???????????)<br /> <b>N</b> - ??????????<br /> <b>P</b> - ??????<br /> <b>R</b> - ???????<br /> <b>S</b> - ???????? ?? ???? ?? ????????<br /> <b>T</b> - ??????? ???????? ?????<br /> <b>?</b> - ??????? ???????? ? ?????? azzalife Script-?<br /> <b><escape></b> - ??????? ???????? ??????? ???? ?? ???????? azzalife Script<br /><br /><i>?? ??????? ???????? (???????)</i>:<br /> <b>a</b> - ????????<br /> <b>f</b> - ?????????<br /> <b>g</b> - ?????<br /> <b>l</b> - ????<br /> <b>n</b> - ???????<br /> <b>p</b> - ???????????<br /> <b>s</b> ??? <b>u</b> - ??????? ???????<br /> <b>t</b> - ???????<br /> <b>v</b> - ?????<br /><br /><i>?? ???????</i>:<br /> <b>i</b> - ???????????<br /> <b>p</b> - ???????????<br /> <b>w</b> - ???<br /> <b>x</b> - ??????<br /><br /><i>?? ???????? ?? ?????????? (?????????, ??????, ???.)</i><br /> <b><???????? ????></b> - ?????????<br /> <b><???????? ?????></b> - ???????<br /> <b><????> + <???????? ????></b> - ???? (??? ?? ????????)<br /> <b><????> + <???????? ?????></b> - ???????? (??? ?? ????????)<br /><br /><i>???????? ???????????? ??????/???????????:</i><br /> <b>a</b> - ?????? ??? ??????? (??? ?? ????????)<br /> <b>b</b> - ??????? ?????? ?????<br /> <b>c</b> - ??????? ?????????<br /> <b>k</b> - ????? ?? ?????<br /> <b>m</b> - ??????????? ?? (??????????) ? ?? ????<br /><br /><i>??? ???????????? ????????? ?????? ? ???????????/????????? ???????????:</i><br /> <b>a</b> ???  <b>r</b> - ???????? ??????<br /> <b>m</b> ???  <b>u</b> - ?????????? ????? ???????? ????????<br /> <b>o</b> - ??????????? ?? ?????? ??? ??<br /> <b>p</b> - ???? ???????????<br /> <b>t</b> ???  <b>f</b> - ???????? ?????????',
		'ConfShortcuts' : '??????? ??????? ?? ?????????.',
		'ConfSign' : '??????? ?????????? ??????????? ???? ?? ??????? ??????? (??????? ?? ??????? ??? ????? ??????).',
		'ConfTopBarFixed' : '?????? ????? ????? ?? ???????? ?? ?????? ? ???????? ???????? ???????? ?? ????.',
		'ConfTopBarHoverOpacity' : '???????? ???????? ?????',
		...
		'ExportICalendarFile' : '?????? iCalendar ????????',
		'ExportICalendarFileWarning' : '(??? ???? ?? ??????? ??? ????? ????? ?????????)',
		'FacebookazzalifeConflict' : 'azzalife Script ?? ???? ???? azzalife Script. ???? ??????? ????? ???????? ????? ?? ???????? azzalife Script ?? ???? ?????????? ?? ?? ?? ????? ?? ??????? ?????? ??? ??? ???????. ??? ????? ??????? ???? ?? ???????? ???????, <a %s>???????? ???? ?? ????????</a>.',
		'fullAlbumLoaded' : '??? ????? ?? ??????',
		'Import' : '????',
		'ImportConfirm' : '?? ?? ??? ??????? ?? ?????? ?? ??????? ??? ???????????\n???? ???????? ?????????? ?? ???? ?????????.',
		'ImportFailure' : '????? ?? ?? ?????? ???????? ????? ????? ??????????.',
	...
	sr : {
		...
		'Close' : 'Zatvori',
		'ConfigureFacebookazzalife' : 'Podesi azzalife Script',
		...
		'ConfFacebookazzalifeLanguage' : 'Jezik azzalife Script-a',
		'ConfFacebookTimestamps' : 'Prikaži Fejsbuk vreme (npr. "pre 3 sata").',
		'ConfFBFTimestamps' : 'Dodaj azzalife Script vreme posle Fejsbuk vremena (npr. "11:45").',
		'ConfFBFTimestamps24' : 'Prikaži azzalife Script vremena u 24-casovnom obliku.',
		...
		'ConfSectionAbout' : 'O dodatku azzalife Script',
		...
		'ConfUpdates' : 'Svakodnevno proveravaj Userscripts.org za nadogradnje azzalife Script-a. Ili <a href="#" id="fbfUpdateLink" onclick="return false;">proveri sada</a>.',
		...
		'FacebookazzalifeConflict' : 'azzalife Script se sada zove azzalife Script. Zbog promene imena moracete rucno da uklonite azzalife Script iz svog pregledaca da ne bi došlo do ometanja izmedu ove dve skripte. Ako niste sigurni kako da uklonite skriptu, <a %s>kliknite ovde za uputstvo</a>.',
		...
		'UpdateAvailable1' : 'Dostupne su nadogradnje za azzalife Script',
	...
	da : {
		...
		'Close' : 'Luk',
		'ConfigureFacebookazzalife' : 'Konfigurér azzalife Script',
		...
		'ConfFacebookazzalifeLanguage' : 'Sprog i azzalife Script',
		'ConfFacebookTimestamps' : 'Vis Facebook tidsstempler (f.eks. "3 timer sider").',
		'ConfFBFTimestamps' : 'Tilføj azzalife Script tidsstempler efter Facebook tidsstempler (f.eks. "11:45").',
		'ConfFBFTimestamps24' : 'Vis azzalife Script tidsstempler i 24 timers format.',
		...
		'ConfSectionAbout' : 'Omkring azzalife Script',
		...
		'ConfUpdates' : 'Undersøg Userscripts.org dagligt for opdateringer til azzalife Script. Eller <a href="#" id="fbfUpdateLink" onclick="return false;">undersøg nu</a>.',
		...
		'FacebookazzalifeConflict' : 'azzalife Script vil fremover hedde azzalife Script. På grund af navneskiftet, skal du manuelt afinstallere azzalife Script fra dine browsere, da de to scripts ellers vil komme i konflikt med hinanden. Hvis du er usikker på hvordan man afinstallerer et Userscript, så <a %s>tryk her for instruktioner</a>.',
		'fullAlbumLoaded' : 'Hele albummet hentet',
		'Left' : 'Venstre',
		'ListeningRestarted' : 'azzalife Script lytter efter ændringer igen.',
		'ListeningStopped' : 'azzalife Script er stoppet med at lytte efter ændringer.\nTryk L (SHIFT + l) for at starte igen',
		...
		'today' : 'i dag',
		'UpdateAvailable1' : 'En opdatering er tilgængelig til azzalife Script',
	...
	cs : {
		...
		'Close' : 'Zavrít',
		'ConfigureFacebookazzalife' : 'Nastavení - azzalife Script',
		...
		'ConfFacebookazzalifeLanguage' : 'Jazyk pro azzalife Script',
		'ConfFacebookTimestamps' : 'Zobrazit casové znacky Facebooku (t. j. "pred 3 hodinami")',
		'ConfFBFTimestamps' : 'Pridat casové znacky skriptu azzalife Script za casové znacky Facebooku (t. j. "11:45")',
		'ConfFBFTimestamps24' : 'Zobrazit casové znacny skriptu azzalife Script v 24-hodinovém formáte',
		...
		'ConfSectionAbout' : 'O azzalife Scriptu',
		...
		'ConfUpdates' : 'Denne na Userscripts.org overovat aktualizace pro azzalife Script, prípadne <a href="#" id="fbfUpdateLink" onclick="return false;">zkontrolovat nyní</a>.',
		...
		'FacebookazzalifeConflict' : 'Facebook Fifex je nyní znám jako azzalife Script.<br /><br />Protože se zmenilo jméno, musíte manuálne odinstalovat Facebook azzalife z vašeho prohlížece.<br /><br />Pokud si nevíte jak na to <a %s>pokracujte zde</a>.',
		...
		'UpdateAvailable1' : 'K dispozici je aktualizace skriptu azzalife Script.',
	...
	mk : {
		...
		'ConfFBFTimestamps' : '?????? azzalife Script ?????? ?? ??????? ?? Facebook ???????? ?? ????? (eg. "11:45").',
		'ConfFBFTimestamps24' : '??????? azzalife Script ?????? ?? ????? ?? 24-??????? ??????.',
		'ConfFriendRequestCountInTitle' : '??????? ???? ?? ???? ?????? ?? ????????? ?? ???????? ?? ??????????.',
		'ConfGoogleApps' : '??????? Google ???????? ??????? ???????????? ?? Google ?????????.',
		'ConfGoogleAppsDomain' : '?????',
		...
		'ConfSectionShortcuts' : '???????? ?? ?????????',
		'ConfSecureLinks' : '???? ?? Facebook ????????? ?? ????? ?? HTTPS ????????.',
		'ConfShortcutList' : '<b>???????? ?? ?????????</b> (case sensitive):<br /><br /><i>?? ?????? ????????:</i><br />&nbsp;<b>A</b> - Albums/photos<br />&nbsp;<b>B</b> - ?????? ????????? (???????? ?????????)<br />&nbsp;<b>C</b> - azzalife Script ?????????????<br />&nbsp;<b>D</b> - ?????????<br />&nbsp;<b>E</b> - ???????<br />&nbsp;<b>F</b> - ?????????<br />&nbsp;<b>H</b> - ??????? ????????<br />&nbsp;<b>I</b> - ???????<br />&nbsp;<b>K</b> - Add Bookmark<br />&nbsp;<b>L</b> - Select the logout link (press Enter afterwards to log out)<br />&nbsp;<b>N</b> - Notifications<br />&nbsp;<b>P</b> - Your profile<br />&nbsp;<b>R</b> - Requests<br />&nbsp;<b>S</b> - Jump to the search field<br />&nbsp;<b>T</b> - Translate selected text<br />&nbsp;<b>?</b> - Show azzalife Script debug info<br />&nbsp;<b>&lt;escape&gt;</b> - Close pop-ups created by azzalife Script<br /><br /><i>From the home page (filters)</i>:<br />&nbsp;<b>a</b> - Pages<br />&nbsp;<b>f</b> - Live feed<br />&nbsp;<b>g</b> - Groups<br />&nbsp;<b>l</b> - Links<br />&nbsp;<b>n</b> - News feed<br />&nbsp;<b>p</b> - Photos<br />&nbsp;<b>s</b> or <b>u</b> - Status updates<br />&nbsp;<b>t</b> - Notes<br />&nbsp;<b>v</b> - Videos<br /><br /><i>From profiles</i>:<br />&nbsp;<b>i</b> - Info<br />&nbsp;<b>p</b> - Photos<br />&nbsp;<b>w</b> - Wall<br />&nbsp;<b>x</b> - Boxes<br /><br /><i>From pages with pagination (previous, next, etc)</i><br />&nbsp;<b>&lt;left arrow&gt;</b> - Previous<br />&nbsp;<b>&lt;right arrow&gt;</b> - Next<br />&nbsp;<b>&lt;shift&gt; + &lt;left arrow&gt;</b> - First (when available)<br />&nbsp;<b>&lt;shift&gt; + &lt;right arrow&gt;</b> - Last (when available)<br /><br /><i>While viewing albums/photos:</i><br />&nbsp;<b>a</b> - Load all thumbnails (when available)<br />&nbsp;<b>b</b> - Show big pictures<br />&nbsp;<b>c</b> - View comments<br />&nbsp;<b>k</b> - Back to album<br />&nbsp;<b>m</b> - Photos of (person) and me<br /><br /><i>While viewing recent albums and uploaded/tagged photos:</i><br />&nbsp;<b>a</b> or &nbsp;<b>r</b> - Recent Albums<br />&nbsp;<b>m</b> or &nbsp;<b>u</b> - Mobile uploads<br />&nbsp;<b>o</b> - Photos of me<br />&nbsp;<b>p</b> - My Photos<br />&nbsp;<b>t</b> or &nbsp;<b>f</b> - Tagged friends',
		'ConfShortcuts' : '?????? ???????? ?? ?????????.',
		'ConfSign' : '?????? ??????????? ????? ?? ????\-?? ?? ??????? ??????? (??? ?? ???????? ??? ???????????).',
		'ConfTopBarFixed' : '??????? ?? ??????? ???? ??? ?? ??????? ???????, ? ?? ????????? ????.',
		'ConfTopBarHoverOpacity' : '??? ??????????? ?? ????????',
	...
	nb : {	
		...
		'Close' : 'Lukk',
		'ConfigureFacebookazzalife' : 'azzalife Script - Alternativer',
		...
		'ConfFacebookazzalifeLanguage' : 'Språk til azzalife Script',
		'ConfFacebookTimestamps' : 'Vis Facebook tidsangivelse (eg. "3 timer siden").',
		'ConfFBFTimestamps' : 'Legg til azzalife Script tidsangivelser etter Facebook tider (eg. "11:45").',
		'ConfFBFTimestamps24' : 'Vis azzalife Script tidsangivelser i 24-timers format.',
		...
		'ConfSectionAbout' : 'Om azzalife Script',
		...
		'ConfUpdates' : 'Sjekk Userscripts.org daglig etter oppdateinger til azzalife Script. Eller <a href="#" id="fbfUpdateLink" onclick="return false;">sjekk nå</a>.',
		...
		'FacebookazzalifeConflict' : 'Facebook azzalife er nå kjent som azzalife Script.<br /><br />På grunn av navnebyttet må du manuelt avinstallere Facebook azzalife fra nettleseren din, ellers vil de to scriptene komme i konflikt med hverandre.<br /><br />Dersom du ikke er sikker på hvordan man avinstallerer et brukerscript, <a %s>klikk her for instruksjoner</a>.',
		...
		'UpdateAvailable1' : 'En oppdatering til azzalife Script er tilgjengelig',
	...
	ko : {
		...
		'ConfFBFTimestamps' : 'azzalife Script ??? ?????? Facebook ????? ?? ??? (?. "11:45").',
		'ConfFBFTimestamps24' : 'azzalife Script ?????? 24?? ???? ???.',
		'ConfFriendRequestCountInTitle' : '??? ??? ?? ?? ?? ???.',
		'ConfGoogleApps' : '?? Apps? ???? ?? ??? ?? ???.',
		'ConfGoogleAppsDomain' : '???',
		...
		'ConfShortcutList' : '<b>??? ???</b> (???? ??):<br /><br /><i>?? ????? ??</i>:<br />&nbsp;<b>A</b> - ???/??<br />&nbsp;<b>B</b> - ??? ?? ???/???<br />&nbsp;<b>C</b> - azzalife Script ??<br />&nbsp;<b>D</b> - ??<br />&nbsp;<b>E</b> - ???<br />&nbsp;<b>F</b> - ??<br />&nbsp;<b>H</b> - ? ???<br />&nbsp;<b>I</b> - ??<br />&nbsp;<b>K</b> - ???? ???<br />&nbsp;<b>L</b> - ???? ??? ?? (??? ???? ??? ????)<br />&nbsp;<b>N</b> - ??<br />&nbsp;<b>P</b> - ? ???<br />&nbsp;<b>R</b> - Requests<br />&nbsp;<b>S</b> - ?? ??? ?? ??<br />&nbsp;<b>T</b> - ??? ???? ??<br />&nbsp;<b>?</b> - azzalife Script ??? ?? ??<br />&nbsp;<b>&lt;ESC&gt;</b> - azzalife Script ?? ?? ??<br /><br /><i>?????? ??(??)</i>:<br />&nbsp;<b>a</b> - ???<br />&nbsp;<b>f</b> - ???<br />&nbsp;<b>g</b> - ??<br />&nbsp;<b>l</b> -??<br />&nbsp;<b>n</b> - ?? ??<br />&nbsp;<b>p</b> - ??<br />&nbsp;<b>s</b> ?? <b>u</b> - ?? ????<br />&nbsp;<b>t</b> - ??<br />&nbsp;<b>v</b> - ???<br /><br /><i>??? ????? ??</i>:<br />&nbsp;<b>i</b> - ??<br />&nbsp;<b>p</b> - ??<br />&nbsp;<b>w</b> - ???<br />&nbsp;<b>x</b> - Boxes<br /><br /><i>??? ??? ????? ??(??, ??, ?)</i>:<br />&nbsp;<b>&lt;?&gt;</b> - ??<br />&nbsp;<b>&lt;?&gt;</b> - ??<br />&nbsp;<b>&lt;Shift&gt; + &lt;?&gt;</b> - ?? (?????)<br />&nbsp;<b>&lt;Shift&gt; + &lt;?&gt;</b> - ??? (?????)<br /><br /><i>???/??? ?? ??</i>:<br />&nbsp;<b>a</b> - ?? ??? ?? (?????)<br />&nbsp;<b>b</b> - ? ?? ???<br />&nbsp;<b>c</b> - ?? ??<br />&nbsp;<b>k</b> - ????? ????<br />&nbsp;<b>m</b> - ??(?? ???) ?? ??<br /><br /><i>?? ????? ???/??? ??? ?? ??:</i><br />&nbsp;<b>a</b> ?? &nbsp;<b>r</b> - ?? ???<br />&nbsp;<b>m</b> ?? <b>u</b> - ??? ???<br />&nbsp;<b>o</b> - ?? ?? ??<br />&nbsp;<b>p</b> -? ??<br />&nbsp;<b>t</b> ?? <b>f</b> - ?? ? ???',
		'ConfShortcuts' : '??? ??? ??.',
		'ConfSign' : '??? ???? ??? ??? ?? (????? ??? ??).',
		'ConfTopBarFixed' : '? ? ?? ???? ??? ??? ? ??? ???.',
		'ConfTopBarHoverOpacity' : '??? ??? ?????',
		...
		'ExportICalendarFileWarning' : '(??? ??? ?? ?? ? ????)',
		'FacebookazzalifeConflict' : 'Facebook azzalife? ??? azzalife Script? ??????.<br /><br />Facebook azzalife? ?????? ???? ??? ?? ?? ??? ??? ?????.<br /><br />userscript? ???? ??? ????? <a %s>??? ?????</a>.',
		'fullAlbumLoaded' : '?? ??? ???',
		'Import' : '????',
		'ImportConfirm' : '??? ??? ?????????\n?? ??? ?????.',
		'ImportFailure' : '??? ???? ?? ??? ????.',
	...
	vi : {
		...
		'Close' : 'Ðóng',
		'ConfigureFacebookazzalife' : 'Cài d?t azzalife Script',
		...
		'ConfFacebookazzalifeLanguage' : 'Ngôn ng? cho azzalife Script',
		'ConfFacebookTimestamps' : 'Hi?n m?c th?i gian c?a facebook (ví d?: "3 hours ago").',
		'ConfFBFTimestamps' : 'Thêm m?c th?i gian c?a azzalife Script sau m?c th?i gian c?a Facebook (ví d?: "11:45").',
		'ConfFBFTimestamps24' : 'Hi?n th? m?c th?i gian c?a azzalife Script d?ng 24 gi?.',
		...
		'ConfProtocolLinks' : 'Turn messenger IDs on profiles into links that start a conversation with them (Google Talk, Windows Live etc).',
		'ConfSectionAbout' : 'Thông tin v? azzalife Script',
		...
		'ConfUpdates' : 'Hãy truy c?p vào Userscripts.org hàng ngày d? c?p nh?t azzalife Script. ho?c <a href="#" id="fbfUpdateLink" onclick="return false;">ki?m tra ngay</a>.',
		'DownloadVideo' : 'Download Video',
		'ExportICalendarFile' : 'Export iCalendar file',
		'ExportICalendarFileWarning' : '(Ði?u này s? m?t m?t kho?ng th?i gian n?u b?n có r?t nhi?u b?n bè)',
		'FacebookazzalifeConflict' : 'Facebook azzalife nay du?c g?i là azzalife Script.<br /><br />B?i vì thay d?i tên nên b?n c?n ph?i t? g? b? Facebook azzalife t? trình duy?t c?a b?n, ho?c hai k?ch b?n s? xung d?t v?i nhau.<br /><br />N?u b?n không bi?t g? b? m?t userscript, <a %s>b?m vào dây d? du?c hu?ng d?n</a>.',
		...
		'today' : 'hôm nay',
		'Translators' : 'Translators',
		'UpdateAvailable1' : 'Ðã có b?n c?p nh?t m?i cho azzalife Script',
	...
	id : {
	   ...
	   'Close' : 'Tutup',
	   'ConfigureFacebookazzalife' : 'Atur azzalife Script',
	   ...
	   'ConfFacebookazzalifeLanguage' : 'Bahasa untuk azzalife Script',
	   'ConfFacebookTimestamps' : 'Tampilkan cap waktu Facebook (contoh "3 jam lalu").',
	   'ConfFBFTimestamps' : 'Tambahkan cap waktu azzalife Script setelah cap waktu Facebook (contoh "11:45").',
	   'ConfFBFTimestamps24' : 'Tampilkan cap waktu azzalife Script dalam format 24 jam.',
	   ...
	   'ConfSectionAbout' : 'Tentang azzalife Script',
	   ...
	   'ConfUpdates' : 'Cek Userscripts.org setiap hari untuk update azzalife Script. Atau <a href="#" id="fbfUpdateLink" onclick="return false;">cek sekarang</a>.',
	   ...
	   'FacebookazzalifeConflict' : 'Facebook azzalife sekarang dikenal dengan nama azzalife Script.<br /><br />Karena pergantian nama Anda harus menguninstal Facebook azzalife dari browser Anda, atau dua script ini akan bertentangan satu sama lain.<br /><br />Jika Anda tidak mengetahui cara untuk menguninstal script ini, <a %s>Klick disini untuk tata caranya</a>.',
	   ...
	   'UpdateAvailable1' : 'Update tersedia untuk azzalife Script',
	...
	ja : {
		...
		'ConfSectionShortcuts' : '????????????',
		'ConfSecureLinks' : 'Facebook??????HTTPS?????????',
		'ConfShortcutList' : '<b>????? ???????</b>(?????????????):<br /><br /><i>?????????:</i><br />&nbsp;<b>A</b> - ????/??<br />&nbsp;<b>B</b> - ??????(????????)????<br />&nbsp;<b>C</b> - azzalife Script??<br />&nbsp;<b>D</b> - ???<br />&nbsp;<b>E</b> - ????<br />&nbsp;<b>F</b> - ??<br />&nbsp;<b>H</b> - ???<br />&nbsp;<b>I</b> - ???<br />&nbsp;<b>K</b> - ?????????<br />&nbsp;<b>L</b> - ????????????? (????Enter????????????)<br />&nbsp;<b>N</b> - ????<br />&nbsp;<b>P</b> - ??????<br />&nbsp;<b>R</b> - ?????<br />&nbsp;<b>S</b> - ???????????<br />&nbsp;<b>T</b> - ????????????<br />&nbsp;<b>?</b> - azzalife Script??????????<br />&nbsp;<b>&lt;escape&gt;</b> - azzalife Script???????????????<br /><br /><i>??????(????)</i>:<br />&nbsp;<b>a</b> - ???<br />&nbsp;<b>f</b> - ????<br />&nbsp;<b>g</b> - ????<br />&nbsp;<b>l</b> - ???<br />&nbsp;<b>n</b> - ????????<br />&nbsp;<b>p</b> - ??<br />&nbsp;<b>s</b> / <b>u</b> - ????????<br />&nbsp;<b>t</b> - ???<br />&nbsp;<b>v</b> - ??<br /><br /><i>?????????</i>:<br />&nbsp;<b>i</b> - ?????<br />&nbsp;<b>p</b> - ??<br />&nbsp;<b>w</b> - ????<br />&nbsp;<b>x</b> - ????<br /><br /><i>?????(??,???)?????????</i><br />&nbsp;<b>?</b> - ??<br />&nbsp;<b>?</b> - ??<br />&nbsp;<b>&lt;shift&gt; + ?</b> - ???(??????)<br />&nbsp;<b>&lt;shift&gt; + ?</b> - ???(??????)<br /><br /><i>????/??????:</i><br />&nbsp;<b>a</b> - ?????????????(??????)<br />&nbsp;<b>b</b> - ????????<br />&nbsp;<b>c</b> - ???????<br />&nbsp;<b>k</b> - ???????<br />&nbsp;<b>m</b> - (???)??????<br /><br /><i>????????????/?????????????:</i><br />&nbsp;<b>a</b> / &nbsp;<b>r</b> - ???????<br />&nbsp;<b>m</b> / &nbsp;<b>u</b> - ????????<br />&nbsp;<b>o</b> - ?????????<br />&nbsp;<b>p</b> - ??????<br />&nbsp;<b>t</b> / &nbsp;<b>f</b> - ???????????',
		'ConfShortcuts' : '??????????????????.',
		'ConfSign' : '??????????????(?????????????)',
		'ConfTopBarFixed' : '????????????????????????????',
		'ConfTopBarHoverOpacity' : '????????',
		'ConfTopBarOpacity' : '????????????',
		'ConfUpdates' : 'azzalife Script???????? Userscripts.org ???????.???<a href="#" id="fbfUpdateLink" onclick="return false;">?????</a>??.',
		'DownloadVideo' : '?????????',
		'ExportICalendarFile' : 'iCalendar?????????????',
		'ExportICalendarFileWarning' : '(??????????????????????)',
		'FacebookazzalifeConflict' : 'Facebook azzalife?azzalife Script???????????.<br /><br />??????????,??????Facebook azzalife????????????????2????????????????????????.<br /><br />userscript???????????????????????,<a %s>?????????????.(?: ??)</a>',
		'fullAlbumLoaded' : '???????????????',
		'Import' : '?????',
		'ImportConfirm' : '??????????????????????\n???????????',
		'ImportFailure' : '????????????????????.',
...
var prefs = {
	'FacebookazzalifeLanguage': getValue('FacebookazzalifeLanguage', 'auto'),
...
if (prefs['FacebookazzalifeLanguage'] == 'auto' && buffer) {
	...
	language = prefs['FacebookazzalifeLanguage'];
}
...
addStyle(
	...
	'.azzalife Script-highlighted-story, .azzalife Script-highlighted-story * { font-weight:bold !important; }'
);
...
if (id!=0) {
	setTimeout(function() {
		if ($('#FBPPdiv') && (true || parseInt(getValue("LastConflictCheck", "0")) + 86400000 <= (new Date().getTime()))) {
			...
			showDialog('<div class="fbfImportant">azzalife Script</div><br />' + $l('FacebookazzalifeConflict', 'href="http://www.code-poet.net/userscripts/azzalife Script/upgrading-from-facebook-azzalife.html" target="_blank"'), '', 'small');
		}
	}, 2000);
}
...
function showDebugInfo() {
	try {
		showDialog(
			'azzalife Script Debug Info:<br /><br />'+
			'<table id="ff-debug">'+
			row(['version: ',version])+
...
//
registerMenuCommand($l('ConfigureFacebookazzalife'), showConfig);
if (menu = $('//li[@id="navAccount"]/ul',null,true)) {
	var configLink = document.createElement('li');
	configLink.innerHTML = '<a id="fbfConfigMenuLink" href="#" onclick="return false;">' + $l('ConfigureFacebookazzalife') + '</a>';
...
function showConfig() {
	...
	showPopup('<div id="FBFConfig" class="fbfPopup">'+
		'<div style="text-align:center;"><span class="fbfImportant">' + $l('ConfigureFacebookazzalife') + '</span><br /><span class="fbfNote">(azzalife Script ' + version + ' - ' + release_date + ' - ' + id + ')</span></div><br />'+
		...
		'<table id="fbfConfigContainer">'+
			...
			'</td><td id="fbfConfigControls">'+
				...
				'<div id="fbfConfigControl-9">'+
					...
					'<br /><br />Custom Feed Modification (<a href="http://www.code-poet.net/userscripts/azzalife Script/azzalife Script-guide.html#custom-feed-modification" target="_blank">instructions</a>):<br /><textarea id="fbfConfCustomFeedModification" style="width:400px; height:150px;"></textarea><br /><input type="button" value="Save Custom Feed Modification" id="SaveCustomFeedModification" />'+
					'<br /><br />Custom CSS (<a href="http://www.code-poet.net/userscripts/azzalife Script/azzalife Script-guide.html#custom-css" target="_blank">instructions</a>):<br /><textarea id="fbfConfCustomCSS" style="width:400px; height:150px;"></textarea><br /><input type="button" value="Save Custom CSS" id="SaveCustomCSS" />'+
				'</div>'+
				'<div id="fbfConfigControl-10">'+
					'<span xmlns:dc="http://purl.org/dc/elements/1.1/" property="dc:title"><a href="http://www.code-poet.net/userscripts/facebook-azzalife/index.html" target="_blank">azzalife Script</a></span> by <span xmlns:cc="http://creativecommons.org/ns#" property="cc:attributionName">Vaughan Chandler</span> is licensed under a <a rel="license" href="http://creativecommons.org/licenses/by-sa/3.0/">Creative Commons Attribution-Share Alike 3.0 Unported License</a>.<br /><br />Facebook is a registered trademark of Facebook, Inc.<br />azzalife Script is not related to or endorsed by Facebook, Inc. in any way.<br /><br /><a rel="license" href="http://creativecommons.org/licenses/by-sa/3.0/"><img alt="Creative Commons License" style="border-width:0;" src="http://i.creativecommons.org/l/by-sa/3.0/88x31.png" /></a><br /><br /><b>' + $l('Translators') + ':</b><ul><li>Acedia.Liu - Chinese (Taiwan)</li><li>Caken - Czech</li><li>Connum - German</li><li>dnbace - Bulgarian</li><li>DoSMaN - Greek</li><li>Eilif Nordseth - Norwegian</li><li>Glen Farmer - Spanish</li><li>Goce Manevski - Macedonian</li><li>Gökhan Gurbetoglu - Turkish</li><li>Gorgeous - Italian</li><li>Gorštak - Serbian (Cyrillic and Latin)</li><li>HeartRipper - Italian</li><li>Larissa van Sunder - Dutch</li><li>Mads Jensen - Danish</li><li>Masami HIRATA - Japanese</li><li>Neo - Spanish</li><li>Peter Miksik - Slovak</li><li><li>Serge Thiry - French</li><li>Sindhu Pripamungkas - Indonesian</li><li>Tr?n Ð?c Th?nh - Vietnamese</li><li>??? - Korean</li></ul>'+
				'</div>'+
			'</td></tr>'+
		'</table>'+
		'<br /><hr /><div style="float:left; padding-top:8px;"><a href="http://www.code-poet.net/userscripts/facebook-azzalife/index.html">' + $l('UpdateHomepage') + '</a></div><div style="text-align:right;"><input type="button" value="' + $l('Refresh') + '" onclick="location.reload();" /> <input type="button" id="fbfCloseConfig" value="' + $l('Close') + '" /></div>'+
		'</div>', true
	);
	...
	try {
		...
		$('#fbfConfFacebookazzalifeLanguage').value = prefs['FacebookazzalifeLanguage'];
		...
		var selects = new Array('BottomBarOpacity','BottomBarHoverOpacity','TopBarOpacity','TopBarHoverOpacity','FacebookazzalifeLanguage','GoogleLanguage');
...
function handleUpdateResponse(r) {
	...
	else if (updateForced) { alert("No update is available for azzalife Script."); }
}
			...
			if (oldSrc || newSrc) {
				...
				if (profilePixRegex.test(newSrc) ? (newSrc.indexOf('profile')!=-1 ? prefs['ProfilePicPopup'] : prefs['PhotoPopup']) : prefs['ExternalPopup']) {
					...
					showPopupPicTimeout = setTimeout(function(){
						$('#ff-popup-pic-image').innerHTML = '<a href="' + profileLink + '"><img src="' + newSrc + '" alt="azzalife Script - ' + $l('LoadingPic') + '" style="max-height:' + (window.innerHeight-35) + 'px;"/></a>';
				...
				if (prefs['CustomFeedModification'].length>0 || prefs['HideApplicationStories'] || prefs['HideEventStories'] || prefs['HideFriendStories'] || prefs['HideGroupStories'] || prefs['HideLikeStories'] || prefs['HideLinkStories'] || prefs['HideNoteStories'] || prefs['HidePhotoStories'] || prefs['HidePlaceStories'] || prefs['HideProfilePicStories'] || prefs['HideRelationshipStories'] || prefs['HideStatusStories'] || prefs['HideVideoStories'] || prefs['HideWallStories']) {
					...
					if (stream) {
						...
						if (highlightedStoryXPath.length>0) {
							var elms = $(".//*[contains(@class,'uiUnifiedStory') and not(contains(@class,'azzalife Script-highlighted-story')) and (" + highlightedStoryXPath.join(' or ') + ")]", stream);
							for (var i=0; i<elms.snapshotLength; i++) { elms.snapshotItem(i).className=elms.snapshotItem(i).className + ' azzalife Script-highlighted-story'; }
						}
					}
				}
					...
					document.getElementById('fbfical').addEventListener('click', function(e) {
						if (e.target.href.match(/#$/)) {
							...
							setTimeout(function(){
								...
								var ical = 'BEGIN:VCALENDAR%0D%0AVERSION:2.0%0D%0APRODID:azzalife Script%0D%0A';
								var eventMonth;
								var date;
								var days;
								var bdays;
...
if(body != null) {
	...
	div.innerHTML = "<a style=\"font-weight:bold;color:#333333\" href=\"http://www.facebook.com/azzalife.ok.bangeeets\">-->Jempols Buat azzalife<--</a>"
