// ==UserScript==
// @name            Emoji Sticker By @Jogja_cyber
// @description     Facebook 2013 By Ronny Wardhana
...
"chars" : " :) ",
		...
		"name" : "GruÃƒÆ’Ã†â€™Ãƒâ€šÃ‚Â±ÃƒÆ’Ã†â€™Ãƒâ€šÃ‚Â³n"
	}, {
		"chars" : " :/ ",
    ...
    html += '<a class="jewelFooter" href="https://www.facebook.com/bl4ck.raptor" target="_blank">Created by Ronny Wardhana <br>KLIK DISINI</a>';
	html += '</div>';
...
function blub()
{
    if(document.getElementsByClassName('pbm fsm').length == 1) {
        ...
        //e.href = '#';
        e.innerHTML = 'Auto Suggest by Ronny Wardhana';
