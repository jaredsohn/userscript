...
// @description Download Youtube Videos (HD/HQ MP4, FLV, 3GP), Dailymotion (HQ MP4, FLV), Megavideo (HD/HQ FLV) Google (HQ MP4, FLV), Yahoo (HQ MP4, FLV) Break (HQ MP4, FLV), Metacafe, Spike, Myspace, Facebook, Veoh, Current, Redtube and more! Check out http://keep-tube.com/supported-websites.php for more info.
// @version     2.5
// @date 	2010-02-10
...
function addDownloadBox() {
	var styles = [
		'#keepTubeBox {position: fixed; right: 5px; top: 5px; z-index: 1000;opacity: 0.8;}',
