...
(function()
{
	...
	var hideBitrates 		= /junk/; 		// Hide whatever you want from the above list, separated by |s, in between /s.	
	var preferredBitrates 	= /V0/;	// Highlight whatever you want from the above list, separated by |s, in between /s.
