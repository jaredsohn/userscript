...
// @description    Отображение бонусов на главной странице персонажа. (v 1.2.30.05.11.1427)
...
function main_func_my_bonus(){
	
var request = new XMLHttpRequest();
var gap = check_desing();

var content = document.getElementsByTagName('table')[7 - gap];
var now_url = ''+content.getElementsByTagName('a')[0];
var sind_url = 'http://www.ganjawars.ru/syndicate.php';
var url_player = gap > 0 ? document.getElementsByTagName('a')[1] : document.getElementsByTagName('a')[2];
...
var span = document.createElement('span');
    ...
    bonus_txt = span.getElementsByTagName('table')[10 - gap].rows[12].cells[1].getElementsByTagName('table')[0].innerHTML;
    bonus_txt = '<table align=center>' + bonus_txt +' </table>';
              
//----------------------------------------------------------------------------------------------------------------------
              
    if (now_url.indexOf(sind_url) != -1) {
