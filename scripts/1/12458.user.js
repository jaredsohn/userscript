// ==UserScript==
// @name	  OGame - Spijuniranje Mjeseca + Recikliranje
// @namespace	  OGame - Spijuniranje Mjeseca + Recikliranje 
// @author 	  OgamerNL Prijevod: LudjakUni9
// @description   OGame BA : Direktno iz pregleda galaksije spijunirajte mjesec ili posaljite reciklere na rusevinu
...
// Variables to be translated for other languages
	var sMoon="Mjesec";
	var sRecycle="Vaditi";
	var sDebris="Rusevina:";
	var sSpy="Spijuniranje";
// Variables to be translated for other languages
