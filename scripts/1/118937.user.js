...
// @name JeffTransoprt
// @namespace 
// @description OGame : JeffTransoprt
// @date 2011-11-24
// @creator Jeffcryer
...
//	.fleft {    float:left;}
	...
	div1.innerHTML = format(total, 0, '.') + " Сумма всех ресурсов";// + " total" + (total>1?"s":"");
...
//	.fleft {    float:left;}
	div1.style.paddingLeft = "7px";
	div1.innerHTML = format(sc, 0, '.') + " ЛТ";// + " small cargo" + (sc>1?"s":"");
	div1.setAttribute("onClick","document.shipsChosen.am202.value=" + sc + "; checkIntInput('ship_202', 0, " + max_sc + "); checkShips('shipsChosen'); return false;");
	div_parent.appendChild(div1);
...
//	.fright {   float:right;}
	...
	div2.innerHTML = format(lc, 0, '.') + " БТ";// + " large cargo" + (lc>1?"s":"");
