// ==UserScript==
// @namespace       heroeswm
// @name            HWM Player Info
// @description     Расширяет информацию об игроке.
// @version         2.4.0
...
Player.parseTableBase = function(player, table) {
    ...
    for (var i = 1; i < table.rows.length - 2; i++) {
        ...
        // Состояния персонажа
        player.states = {
            lastSeen: (new RegExp('В последний раз был')).test(table.innerHTML),
            online: (new RegExp('Персонаж сейчас в игре')).test(table.innerHTML),
            inBattle: (new RegExp('Персонаж сейчас в бою')).test(table.innerHTML),            
            onHalloewn: (new RegExp('Нападать Тыквиком можно раз в 5 минут')).test(table.innerHTML)
        };
...
Player.parseTableSkills = function(player, table) {
    ...
    //GreaseMonkey.log('Player.parsePlayerResources(player);');
    Player.parsePlayerResources(player);
    //GreaseMonkey.log('Player.parsePlayerSkills(player);');
    Player.parsePlayerSkills(player);
    //GreaseMonkey.log('Player.parsePlayerGuilds(player);');
    Player.parsePlayerGuilds(player);
    //GreaseMonkey.log('Player.parsePlayerTalents(player);');
    Player.parsePlayerTalents(player);
    //GreaseMonkey.log('done');
...
Player.parsePlayerResources = function(player) {
    ...
    for (var i = 0; i < nodes.length; i++) {
        ...
        player.resources[resource.title] = resource;        
...
Player.parsePlayerSkills = function(player) {
    ...
    for (var i = 0; i < nodes.length; i++) {
        ...
        player.skills[skill.title] = skill;
...
Player.parsePlayerGuilds = function(player) {
    ...
    var text = $(player.nodes.skills).text();
    player.guilds = {};
...
/** Класс работы со снаряжением на странице информации об игроке
*
* @file libPlayerEquipment.js
* @version 1.0.1
* @author hotamateurxxx
* @license GPL
*
...
/*
<table width="230" cellspacing="0" cellpadding="0" border="0" background="http://dcdn.heroeswm.ru/i/kukla/new2/kukla101.jpg"> <tbody><tr>
    <td width="50"><div id="slot8"><img width="50" border="0" height="50" title="Кольцо" src="http://dcdn3.heroeswm.ru/i/transparent.gif"></div></td>
    <td width="10"><img width="10" border="0" height="50" src="http://dcdn.heroeswm.ru/i/transparent.gif"></td>
    <td width="50"><div id="slot1"><img width="50" border="0" height="50" title="Голова" src="http://dcdn3.heroeswm.ru/i/transparent.gif"></div></td>
    <td width="10"><img width="10" border="0" height="50" src="http://dcdn.heroeswm.ru/i/transparent.gif"></td>
    <td width="50"><div id="slot2"><img width="50" border="0" height="50" title="Шея" src="http://dcdn3.heroeswm.ru/i/transparent.gif"></div></td>
    <td width="10"><img width="10" border="0" height="50" src="http://dcdn.heroeswm.ru/i/transparent.gif"></td>
    <td width="50"><img width="50" border="0" height="50" title="Книга магии" src="http://dcdn.heroeswm.ru/i/book2.jpg"></td>
  </tr>
  <tr>
    <td width="50"><img width="50" border="0" height="25" src="http://dcdn.heroeswm.ru/i/transparent.gif"></td>
    <td width="10"><img width="10" border="0" height="25" src="http://dcdn.heroeswm.ru/i/transparent.gif"></td>
    <td width="50"><img width="50" border="0" height="25" src="http://dcdn.heroeswm.ru/i/transparent.gif"></td>
    <td width="10"><img width="10" border="0" height="25" src="http://dcdn.heroeswm.ru/i/transparent.gif"></td>
    <td width="50"><img width="50" border="0" height="25" src="http://dcdn.heroeswm.ru/i/transparent.gif"></td>
    <td width="10"><img width="10" border="0" height="25" src="http://dcdn.heroeswm.ru/i/transparent.gif"></td>
  ...
  <tr>
    <td width="50"><div id="slot9"><img width="50" border="0" height="50" title="Кольцо" src="http://dcdn3.heroeswm.ru/i/transparent.gif"></div></td>
    <td width="10"><img width="10" border="0" height="50" src="http://dcdn.heroeswm.ru/i/transparent.gif"></td>
    <td width="50"><div id="slot3"><table cellspacing="0" cellpadding="0" border="0" background="http://dcdn1.heroeswm.ru/i/artifacts/chainarmor_s.jpg"><tbody><tr><td colspan="5"><div style="font-size: 9px; padding: 0px 1px; border: 1px solid rgb(238, 205, 89); margin: 2px; background: none repeat scroll 0% 0% rgb(255, 255, 255); position: absolute;">21</div><a href="art_info.php?id=hauberk&amp;uid=206931608"><img width="50" border="0" height="40" src="http://dcdn3.heroeswm.ru/i/transparent.gif" title="Боевая кольчуга [A1] 
Защита: &nbsp;+3 
Прочность: 21/40"></a></td></tr><tr><td><a href="art_info.php?id=hauberk&amp;uid=206931608"><img width="10" border="0" height="10" title="Боевая кольчуга [A1] 
Защита: &nbsp;+3 
Прочность: 21/40" src="http://dcdn3.heroeswm.ru/i/transparent.gif"></a></td><td><a href="art_info.php?id=hauberk&amp;uid=206931608"><img width="10" border="0" height="10" title="Боевая кольчуга [A1] 
Защита: &nbsp;+3 
Прочность: 21/40" src="http://dcdn3.heroeswm.ru/i/transparent.gif"></a></td><td><a href="art_info.php?id=hauberk&amp;uid=206931608"><img width="10" border="0" height="10" title="Боевая кольчуга [A1] 
Защита: &nbsp;+3 
Прочность: 21/40" src="http://dcdn3.heroeswm.ru/i/transparent.gif"></a></td><td><a href="art_info.php?id=hauberk&amp;uid=206931608"><img width="10" border="0" height="10" title="Боевая кольчуга [A1] 
Защита: &nbsp;+3 
Прочность: 21/40" src="http://dcdn3.heroeswm.ru/i/transparent.gif"></a></td><td><a href="art_info.php?id=hauberk&amp;uid=206931608"><img width="10" border="0" height="10" title="Защита от магии воздуха 2%" src="http://dcdn1.heroeswm.ru/i/mods/armor/A1.gif"></a></td></tr></tbody></table></div></td>
    <td width="10"><img width="10" border="0" height="50" src="http://dcdn.heroeswm.ru/i/transparent.gif"></td>
    <td width="50"><div id="slot4"><div style="font-size: 9px; padding: 0px 1px; border: 1px solid rgb(238, 205, 89); margin: 2px; background: none repeat scroll 0% 0% rgb(255, 255, 255); position: absolute;">10</div><a href="art_info.php?id=shortbow"><img width="50" border="0" height="50" src="http://dcdn.heroeswm.ru/i/artifacts/shortbow_s.jpg" title="Короткий лук 
Прочность: 10/20"></a></div></td>
    <td width="10"><img width="10" border="0" height="50" src="http://dcdn.heroeswm.ru/i/transparent.gif"></td><td width="50"><img width="50" border="0" height="50" src="http://dcdn.heroeswm.ru/i/transparent.gif"></td>
  </tr>
  <tr>
    <td width="50"><img width="50" border="0" height="25" src="http://dcdn.heroeswm.ru/i/transparent.gif"></td>
    <td width="10"><img width="10" border="0" height="25" src="http://dcdn.heroeswm.ru/i/transparent.gif"></td>
  ...
  <tr>
    <td width="50"><div id="slot5"><div style="font-size: 9px; padding: 0px 1px; border: 1px solid rgb(238, 205, 89); margin: 2px; background: none repeat scroll 0% 0% rgb(255, 255, 255); position: absolute;">11</div><a href="art_info.php?id=def_sword"><img width="50" border="0" height="50" src="http://dcdn2.heroeswm.ru/i/artifacts/def_sword_s.jpg" title="Меч расправы 
Нападение: &nbsp;+2 
Защита: &nbsp;+1 
Прочность: 11/40"></a></div></td>
    <td width="10"><img width="10" border="0" height="50" src="http://dcdn.heroeswm.ru/i/transparent.gif"></td>
    <td width="50"><div id="slot7"><img width="50" border="0" height="50" title="Ноги" src="http://dcdn3.heroeswm.ru/i/transparent.gif"></div></td>
    <td width="10"><img width="10" border="0" height="50" src="http://dcdn.heroeswm.ru/i/transparent.gif"></td>
    <td width="50"><div id="slot6"><table cellspacing="0" cellpadding="0" border="0" background="http://dcdn1.heroeswm.ru/i/artifacts/protectshield_s.jpg"><tbody><tr><td colspan="5"><div style="font-size: 9px; padding: 0px 1px; border: 1px solid rgb(238, 205, 89); margin: 2px; background: none repeat scroll 0% 0% rgb(255, 255, 255); position: absolute;">34</div><a href="art_info.php?id=defender_shield&amp;uid=204666710"><img width="50" border="0" height="40" src="http://dcdn3.heroeswm.ru/i/transparent.gif" title="Щит хранителя [D2] 
Защита: &nbsp;+3 
Прочность: 34/40"></a></td></tr><tr><td><a href="art_info.php?id=defender_shield&amp;uid=204666710"><img width="10" border="0" height="10" title="Щит хранителя [D2] 
Защита: &nbsp;+3 
Прочность: 34/40" src="http://dcdn3.heroeswm.ru/i/transparent.gif"></a></td><td><a href="art_info.php?id=defender_shield&amp;uid=204666710"><img width="10" border="0" height="10" title="Щит хранителя [D2] 
Защита: &nbsp;+3 
Прочность: 34/40" src="http://dcdn3.heroeswm.ru/i/transparent.gif"></a></td><td><a href="art_info.php?id=defender_shield&amp;uid=204666710"><img width="10" border="0" height="10" title="Щит хранителя [D2] 
Защита: &nbsp;+3 
Прочность: 34/40" src="http://dcdn3.heroeswm.ru/i/transparent.gif"></a></td><td><a href="art_info.php?id=defender_shield&amp;uid=204666710"><img width="10" border="0" height="10" title="Щит хранителя [D2] 
Защита: &nbsp;+3 
Прочность: 34/40" src="http://dcdn3.heroeswm.ru/i/transparent.gif"></a></td><td><a href="art_info.php?id=defender_shield&amp;uid=204666710"><img width="10" border="0" height="10" title="Уменьшение атаки нападающего отряда на 2%" src="http://dcdn2.heroeswm.ru/i/mods/armor/D2.gif"></a></td></tr></tbody></table></div></td>
    <td width="10"><img width="10" border="0" height="50" src="http://dcdn.heroeswm.ru/i/transparent.gif"></td>
    <td width="50"><img width="50" border="0" height="50" title="Серебристый eдинорог" alt="" src="http://dcdn.heroeswm.ru/i/transport/104.jpg"></td>
  </tr>
  <tr>
    <td width="50"><img width="50" border="0" height="5" src="http://dcdn.heroeswm.ru/i/transparent.gif"></td>
    <td width="10"><img width="10" border="0" height="5" src="http://dcdn.heroeswm.ru/i/transparent.gif"></td>
    <td width="50"><img width="50" border="0" height="5" src="http://dcdn.heroeswm.ru/i/transparent.gif"></td>
    <td width="10"><img width="10" border="0" height="5" src="http://dcdn.heroeswm.ru/i/transparent.gif"></td>
    <td width="50"><img width="50" border="0" height="5" src="http://dcdn.heroeswm.ru/i/transparent.gif"></td>
    <td width="10"><img width="10" border="0" height="5" src="http://dcdn.heroeswm.ru/i/transparent.gif"></td>
...
*/
PlayerEquipment.parseElement = function(element) {
    
    equipment = {};
    equipment.slots = [];
    
    for (var i = 1; i < 9 + 1; i++)
        equipment.slots[equipment.slots.length] = PlayerEquipmentSlot.parseElement($('#slot' + i, element).get(0));
    
    // Подсчитываем количество артефактов
    equipment.artCount = 0;
    for (var i in equipment.slots)
        if (equipment.slots[i].art !== undefined)
            equipment.artCount++;
...
if (window === top) {
    ...
    var desc = {
        'details':
              '<ul>'
            + '<li>Добавляет информацию о суммарном здоровье армии.</li>'
            + '<li>Добавляет информацию о количестве ОА, суммарном крафте и стоимости боя.</li>'
            + '<li>Добавляет информацию о количестве очков навыков.</li>'
            + '<li>Ориганальная идея и первая реализация принадлежит Alex Kocharin &lt;alex@kocharin.ru&gt;.</li>'
            +'</ul>',
...
* @param Array arts
*/
function onArtsLoad(player, equipment, arts) {
    var totalAp = 0;
    var descAp = '';
    var totalCostBat = 0;
    var descCostBat = '';
    for (var i in arts) {
        ...
        descCostBat += (descCostBat.length > 0 ? "\n" : '') + arts[i].title + ': ' + Number(arts[i].costBat).toFixed(1);
        //GreaseMonkey.log(arts[i].id + '(' + arts[i].uid + '), ' + arts[i].ap + ' ОА');
    }
    //GreaseMonkey.log('totalAp == ' + totalAp);
    //GreaseMonkey.log('totalCostBat == ' + totalCostBat);
    ...
    for (var i in equipment.slots) {
        if (equipment.slots[i].art === undefined)
            continue;
        totalCraft += equipment.slots[i].art.craftValue;
        if (equipment.slots[i].art.craftValue > 0)
            descCraft += (descCraft.length > 0 ? "\n" : '') + equipment.slots[i].art.title + ': ' + equipment.slots[i].art.craftValue + '%';
        //GreaseMonkey.log(equipment.slots[i].art.title + ' ' + equipment.slots[i].art.craftValue + '%');
    }
    
    function createRow(image, imageTitle, value, valueTitle) {
        return '<tr height="23"><td align="center"><img title="' + imageTitle + '" src="' + image + '" width="16" height="16"></td><td title="' + valueTitle + '" align="center"><b>' + value + '</b></td></tr>';
    }
    
    var titleAp = 'Очков аммуниции с учетом крафта';
    ...
    $('table', player.nodes.params).append(createRow(imageAp, titleAp, totalAp, descAp));
    
    var titleCraft = 'Суммарный крафт снаряжения';
    var imageCraft = '/i/mod_common.gif';
    $('table', player.nodes.params).append(createRow(imageCraft, titleCraft, totalCraft + '%', descCraft));
    
    var titleCostBat = 'Номинальная стоимость боя';
    var imageCostBat = '/i/gold.gif';
    $('table', player.nodes.params).append(createRow(imageCostBat, titleCostBat, totalCostBat.toFixed(0), descCostBat));
...
*/
function onCreaturesLoad(player, army, creatures) {
    var averageIni = 0;
    var totalHp = 0;
    for (var i in army)
    ...
    $(player.nodes.army.parentNode).append("<div>Суммарное здоровье: " + totalHp + "</div>");
    $(player.nodes.army.parentNode.lastChild).css(style).attr('title', 'Суммарное здоровье всех отрядов (без учета влияния героя)');
    $(player.nodes.army.parentNode).append("<div>Средняя инициатива: " + averageIni.toFixed(1) + "</div>")
    $(player.nodes.army.parentNode.lastChild).css(style).attr('title', 'Средневзвешенная по здоровью инициатива отрядов (без учета влияния героя)');
}
...
if (!disabled) {
    ...
    // http://www.heroeswm.ru/pl_info.php?id=97354
    if (url.attr('path') == '/pl_info.php') {
        
        // Если мы зашли на страницу информации об игроке
        var player = Player.parse(url.param('id'), document);
        
        // Разбираем навыки игрока
        if (SkillWheel.fracData[player.fractionId] !== undefined) {
            player.tp = 0;
            for (var i in player.talents) {
                var name = (player.talents[i].name != 'main') ? player.talents[i].name : player.talents[i].list[0];
                var count = player.talents[i].list.length;
                var cost = SkillWheel.fracData[player.fractionId][name];
                player.tp += cost * count;
            }
            //GreaseMonkey.log('player.tpMax == ' + player.tpMax);
            //GreaseMonkey.log('player.tp == ' + player.tp);
            $(player.nodes.talents).append("<b>Очки навыков: " + player.tp + "/" + player.tpMax + "</b>");
        }
        
        // Разбираем артефакты игрока
        var equipment = PlayerEquipment.parseElement(player.nodes.equipment);
        var arts = [];
        for (var i in equipment.slots) {
            if (equipment.slots[i].art === undefined)
                continue;
            //GreaseMonkey.log('equipment.slots[' + i + '].art.title == ' + equipment.slots[i].art.title);
            var art = Art.loadObject(equipment.slots[i].art.id, equipment.slots[i].art.uid);
            if (art !== undefined) {
                arts[arts.length] = art;
                if (equipment.artCount == arts.length)
                    onArtsLoad(player, equipment, arts);
            } else {
                Art.loadParse(
                    equipment.slots[i].art.id,
                    equipment.slots[i].art.uid,
                    function(art) {
                        Art.saveObject(art);
                        arts[arts.length] = art;
                        if (equipment.artCount == arts.length)
        ...
        var army = Army.parseArmyObject(player.nodes.army);
        var creatures = [];
        for (var i in army) {
            ...
            if (creature !== undefined) {
                ...
                if (creatures.length == army.length)
                    onCreaturesLoad(player, army, creatures);                    
            } else {
                Creature.loadParse(
                    army[i].person, 
                    function(creature) {
