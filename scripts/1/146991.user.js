    ...
    var main = function () {
		...
		function LoUPakMap() {
			try {
                ...
                const bossDef =  [625,3750,25000,50000,125000,187500,250000,375000,562500,750000];
                const bossDef2 = [420,2500,17000,33000,83000, 125000,170000,250000,375000,500000];
						...
						if(mode == 'c' || mode == 'd') {
							...
							if(text != null || text.length > pId) {
								...
								if(type == nameC) { // Name:
									...
									var bonus6 = 100 / (100 + shrine6 + research6);
									...
									var bonus10 = 100 / (100 + shrine10 + research10);
									...
									var bonus11 = 100 / (100 + shrine11 + research11);
									...
									var bonus12 = 100 / (100 + shrine12 + research12);

									var zergs6 = webfrontend.gui.Util.formatNumbers(parseInt(bossDef[ parseInt(level) - 1] / 50 * 4 * bonus6));
									if (weak == "Infantry")
										zergs6 = webfrontend.gui.Util.formatNumbers(parseInt(bossDef2[ parseInt(level) - 1] / 50 * 4 * bonus6));
									var zergs10 = webfrontend.gui.Util.formatNumbers(parseInt(bossDef[ parseInt(level) - 1] / 60 * 4 * bonus10));
									if (weak == "Cavalry")
										zergs10 = webfrontend.gui.Util.formatNumbers(parseInt(bossDef2[ parseInt(level) - 1] / 60 * 4 * bonus10));
									var zergs11 = webfrontend.gui.Util.formatNumbers(parseInt(bossDef[ parseInt(level) - 1] / 90 * 4 * bonus11));
									if (weak == "Cavalry")
										zergs11 = webfrontend.gui.Util.formatNumbers(parseInt(bossDef2[ parseInt(level) - 1] / 90 * 4 * bonus11));

									var warlock = webfrontend.gui.Util.formatNumbers(parseInt(bossDef[ parseInt(level) - 1] / 120 * 4 * bonus12));
									if (weak == "Magic")
										warlock = webfrontend.gui.Util.formatNumbers(parseInt(bossDef2[ parseInt(level) - 1] / 120 * 4 * bonus12));

									sb.add(text, sHdr, weakT, weak, "</td></tr><tr><td>", zergT6, zergs6, "</td></tr></td></tr><tr><td>", zergT10, zergs10, "</td></tr></td></tr><tr><td>", zergT11, zergs11, "</td></tr></td></tr><tr><td>", "warlock:</td><td>", warlock, "</td></tr></table>");
									tip.setLabel(sb.get());
                                    
//                                    PakDebug(webfrontend.data.Tech.getInstance().getBonus("unitDamage", webfrontend.data.Tech.research, 1));
//                                    PakDebug(webfrontend.data.Tech.getInstance().getBonus("unitDamage", webfrontend.data.Tech.research, 2));
//                                    PakDebug(webfrontend.data.Tech.getInstance().getBonus("unitDamage", webfrontend.data.Tech.research, 3));
//                                    PakDebug(webfrontend.data.Tech.getInstance().getBonus("unitDamage", webfrontend.data.Tech.research, 4));
//                                    PakDebug(webfrontend.data.Tech.getInstance().getBonus("unitDamage", webfrontend.data.Tech.research, 5));
//                                    PakDebug(webfrontend.data.Tech.getInstance().getBonus("unitDamage", webfrontend.data.Tech.research, 6));
//                                    PakDebug(webfrontend.data.Tech.getInstance().getBonus("unitDamage", webfrontend.data.Tech.research, 7));
//                                    PakDebug(webfrontend.data.Tech.getInstance().getBonus("unitDamage", webfrontend.data.Tech.research, 8));
//                                    PakDebug(webfrontend.data.Tech.getInstance().getBonus("unitDamage", webfrontend.data.Tech.research, 9));
//                                    PakDebug(webfrontend.data.Tech.getInstance().getBonus("unitDamage", webfrontend.data.Tech.research, 10));
//                                    PakDebug(webfrontend.data.Tech.getInstance().getBonus("unitDamage", webfrontend.data.Tech.research, 11));
//                                    PakDebug(webfrontend.data.Tech.getInstance().getBonus("unitDamage", webfrontend.data.Tech.research, 12));
//                                    PakDebug(webfrontend.data.Tech.getInstance().getBonus("unitDamage", webfrontend.data.Tech.research, 13));
//                                    PakDebug(webfrontend.data.Tech.getInstance().getBonus("unitDamage", webfrontend.data.Tech.research, 14));
