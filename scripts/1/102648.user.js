...
function pbStartup (){
  ...
  window.name = 'PT';
  logit ("*  KOC 2 X TOOLS  v"+ Version +" Loaded");
  readOptions();
  readGlobalOptions ();
  setCities();
...
// TODO: Make sure WinPos is visible on-screen ?
  ...
  actionLog (" KOC 2 x TOOLS v"+ Version +" Loaded  (KOC Version: "+ anticd.getKOCversion() +")");
  ...
  AddMainTabLink('KOC 2 X TOOLS', eventHideShow, mouseMainTab);
  kocWatchdog ();
  WideScreen.init ();
  ...
  m += '</tr><TR align=center>';
    ...
    m += '<BR><DIV class=pbStat>WACHTURM  EINSTELLUNG</div><TABLE class=pbTab>\
        ...
        <TR><TD></td><TD><TABLE cellpadding=0 cellspacing=0>\
            ...
            <TR><TD align=right>Spähr Versuch: &nbsp; </td><TD><INPUT id=pbalertSpäher type=checkbox '+ (Options.alertConfig.scouting?'CHECKED ':'') +'/></td></tr>\
