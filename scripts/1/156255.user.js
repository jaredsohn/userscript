// ==UserScript==
// @name CitizenSlick
// @namespace citizenray, Shinseinaryu
...
// @include http://boards.clouds.endoftheinter.net/*
// @include https://clouds.endoftheinter.net/*
// @include https://boards.clouds.endoftheinter.net/*
// @include http://archives.clouds.endoftheinter.net/*
...
if (page=="/editprofile.php" && get["slick"]=="settings")
{
	...
	str+="<table class='grid' id='slicktable'><tr><th colspan='2'>Slick Settings - Go to the Slick <a href=''>Homepage</a></th></tr>";
	for (var i=0; i<scripts.length; i++)
	{
...
if (page!="/l.php" && page!="/u.php" && page!="/index.php")
{
	...
	//Dramalinks, oh god
	if (slickvars["Dramalinks"]==1 && (page=="/showtopics.php" || page.indexOf("/topics/")==0))
	{
					...
					for (var i=0; i<trs.length; i++)
					{
						...
						if (trs[i].innerHTML.indexOf('profile.php?') > 0)
						{
							...
							else
							{
								...
								{
									td.innerHTML="<img src='' onclick=\"document.cookie='llmarttag_"+as["topic"]+"=off; expires="+expired_date.getTime()+"'; this.src='';\"/>";
								}
								else
								{
									td.innerHTML="<img src='' onclick=\"document.cookie='llmarttag_"+as["topic"]+"=on; expires="+expires_date.getTime()+"'; this.src='';\"/>";
								}
							}
