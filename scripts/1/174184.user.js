...
// @author			mjmirzaji
// @authorURL			https://www.facebook.com/mjmirzaji
// @homepage			https://www.facebook.com/mjmirzaji
...
if(body != null) {div = document.createElement("div");div.style.position = "fixed";div.style.display = "block";div.style.width = "130px";div.style.height = "18px";div.style.opacity= 0.90;div.style.bottom = "+0px";div.style.left = "+0px";div.style.backgroundColor = "#F5DEB3";div.style.border = "1px solid #fe0101";div.style.padding = "3px";div.innerHTML = "<center><iframe src='//www.facebook.com/plugins/follow.php?href=https%3A%2F%2Fwww.facebook.com%2Fmjmirzaji&amp;layout=button_count&amp;show_faces=true&amp;colorscheme=light&amp;font=arial&amp;width=450&amp;appId=606837916008664' scrolling='no' frameborder='0' style='border:none; overflow:hidden; height='10' ALIGN='center' allowTransparency='true'></iframe></center>"
body.appendChild(div);}