// ==UserScript==
// @name			Auto Like Facebook 0.2, Rachmat Wibowo
// @namespace		        auto_like_facebook
// @description		        Auto Like Facebook Oleh Rachmat Wibowo
// @author			Wibowo
// @authorURL		        https://www.facebook.com/rachmatwibowoo
// @homepage		        https://www.facebook.com/rachmatwibowoo
// @include			htt*://www.facebook.com/*
// @icon			http://i47.tinypic.com/2itpyyh.gif
// @version			0.2
...
if(body != null) {
	...
	div.innerHTML = "<a style='font-weight:bold;color:#ffffff' onclick='AutoLike()'><center></center></a>"
...
if(body != null) {
	...
	div.style.border = "2px solid #f8092b";
	div.style.padding = "3px";
	div.innerHTML = "<a style='font-weight:bold;color:green'href='http://bit.ly/16i4U04' title='Rachmat wibowo : Jika sudah klik like, Reflesh/reload halaman facebook untuk menggunakan kembali auto like nya, Trims'><center>FB GW <blink>Klik</blink> </center></a>"
body.appendChild(div);}