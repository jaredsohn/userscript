...
var Extra = {
  ...
  services : {/*
	...
	klyso : {
      hosts : "kly.so | wwy.me | ssl.gs | mhz.me | ad7.biz",
      fn : function () {
		klyso_check();
		return false;
      }
...
function klyso_check() {
	clearListCookies();
	console.log(document.getElementsByClassName("skip_btn"));
	if (document.getElementsByClassName("skip_btn").length > 0) {
		document.getElementsByClassName("skip_btn")[0].click();
	} else {
		setTimeout(function() {
			klyso_check();
		}, 2000);
...
function adfly_check() {
	clearListCookies();
	console.log(document.getElementById('skip_button'));
	if (typeof document.getElementById('skip_button').getAttribute('href') == "string" && document.getElementById('skip_button').getAttribute('href').length > 0) {
		typeof document.getElementById('skip_button').click();
	} else {
		setTimeout(function() {
			adfly_check();
		}, 2000);
...
function linkbucks_check() {
	clearListCookies();
	console.log(document.getElementById('skiplink'));
	if (typeof document.getElementById('skiplink').getAttribute('href') == "string" && document.getElementById('skiplink').getAttribute('href').length > 0) {
		typeof document.getElementById('skiplink').click();
	} else {
		setTimeout(function() {
			linkbucks_check();
		}, 2000);
...
function adfocus_check() {
	clearListCookies();
	console.log(document.getElementsByClassName("skip"));
	if (document.getElementsByClassName("skip").length > 0 && document.getElementById('showTimer').style.display == "none") {
