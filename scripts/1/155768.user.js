﻿// ==UserScript==
// @name           اسکریپت امکانات تراوین
// @namespace      http://userscripts.org/scripts/show/155768
// @description    امکانات تراوین
// @author         محمد بهمنی راد
// @license        ساخته شده توسط محمد بهمنی راد
...
var namespace = 'http://userscripts.org/scripts/show/155768';
...
var sM = 1;
var sC = [1.6,1000];
if( /[xyz]3|speed/i.test(crtPath) ) { sM = 3; sK = 2; sC = [16/3,100]; }
if( /[xyz]2|t1|final/i.test(crtPath) ) { sM = 2; sK = 2; sC = [8,100]; }
if( /[xyz]5/i.test(crtPath) ) { sM = 5; sK = 2; sC = [3.2,100]; }
if( /[xyz]10/i.test(crtPath) ) { sM = 10; sK = 4; sC = [1.6,100]; }
// also culturePoints()
...
DICT = {
	...
	fa: { // Persian, thx Reza Moghadam
		...
		racelist : ['رومی ها','توتن ها','گول ها'],
		onallp : "همه ی صفحات",
...
function reportsDelOrSearch () {
	...
	if( ver4FL ) {
		...
		newDel.setAttribute('title',$gc('button-contents',newDel)[0].innerHTML.trim());
