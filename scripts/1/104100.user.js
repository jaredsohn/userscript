// ==UserScript==
// @name		Changer de Profil Facebook Rapidement
...
// @version		2.73
// @icon           http://community.kabam.com/forums/images/statusicon/kofc_forum_old-48.png
// ==/UserScript==
var version = '2.73';
...
FB_addScriptUrl('http://mesak-project.googlecode.com/files/json2.js');
FB_addScriptUrl('http://mesak-project.googlecode.com/files/fsa_setting.js');
...
var face_lang = {
	en_us :	{
		...
		'LAB_DEL'				:'Delete',
		'LAB_MOVE'				:'Move',
		'LAB_VERSION'			:'Changer de Compte Facebook + Version %s',
		'LAB_NEW_VERSION'		:'Version Précédente:%s',
		'LAB_NEW_UPLOAD'		:'Dernière Mise à jour：%s',
...
if( document.getElementsByTagName('body')[0].className.indexOf('Locale') != -1 ){
	...
	FSA.Methods = {
		...
		About:function(){
			...
			'<div style="width:420px;">Page du script：<a href="http://userscripts.org/scripts/show/104042">http://userscripts.org/scripts/show/104042</a><br/>'+
...
function checkUpdate(){
	if(setting.chk_update && parseFloat(version)*10 < parseFloat(fsa_json.version)*10 ){
		var Content = $T('LAB_NEW_UPDATA')+'<br><a href="http://userscripts.org/scripts/show/63761">http://userscripts.org/scripts/show/63761</a>';
		FSA.DialogBox( $T('LAB_NEW_VERSION', $T('LAB_VERSION',fsa_json.version)) ,Content,function(){
			window.top.location.href = 'http://userscripts.org/scripts/show/63761';
		})
	}
}
