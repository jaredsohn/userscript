...
.replace(/:neptune:/g, "<style>.md img { display:inline; } .rageface { visibility:visible; } </style><img  src=\'http://www.geocities.ws/tainppd00015/emo/neptune.png\' title='Neptune' />")
...
.replace(/\:kiss\:/g, "<style> .md img { display:inline; } .rageface { visibility:visible; } </style><img src=\'http://vozforums.com/images/smilies/Off/sweet_kiss.gif\' title=\'Kiss\' />")
...
.replace(/\:\v/g, "<style> .md img { display:inline; } .rageface { visibility:visible; } </style><img src=\'http://www.geocities.ws/tainppd00015/emo/v.png\' title=\'Pacman\' />")
...
.replace(/:sex:/g, "<style> .md img { display:inline; } .rageface { visibility:visible; } </style><img src=\'http://beat.vn/forum/images/smilies/SEX.gif\' title=\'\sex\' />")

.replace(/:xoatay/g, "<style> .md img { display:inline; } .rageface { visibility:visible; } </style><img src=\'http://hoangmanhhiep.info/smiles/vinaget/KAKA.gif\' title=\'\xoatay\' />")

.replace(/:hihi/g, "<style> .md img { display:inline; } .rageface { visibility:visible; } </style><img src=\'http://beat.vn/forum/images/smilies/Smile/421.gif\' title=\'\hihi\' />")

.replace(/:cuoideu3/g, "<style> .md img { display:inline; } .rageface { visibility:visible; } </style><img src=\'http://beat.vn/forum/images/smilies/Smile/cuoideu3.gif\' title=\'\cuoideu3\' />")

.replace(/:kung/g, "<style> .md img { display:inline; } .rageface { visibility:visible; } </style><img src=\'http://beat.vn/forum/images/smilies/kung122.gif\' title=\'\kung\' />")

.replace(/:dot/g, "<style> .md img { display:inline; } .rageface { visibility:visible; } </style><img src=\'http://beat.vn/forum/images/smilies/tho%20dit%20nhau.gif\' title=\'\dot\' />")

.replace(/:haynhi/g, "<style> .md img { display:inline; } .rageface { visibility:visible; } </style><img src=\'http://s9.postimage.org/mwj89ryob/j8be_OFBII2mwe.png\' title=\'\haynhi\' />")

.replace(/:gianac/g, "<style> .md img { display:inline; } .rageface { visibility:visible; } </style><img src=\'http://beat.vn/forum/images/smilies/Cute/72.gif\' title='gianac' />")
				...
				function commonInsert(obj) {
					if(typeof(obj)=="object") {
						replaceByClass('tweet-text', obj); //Twitter
                                                ...
                                                replaceByClass('aboveUnitContent', obj);
                                                replaceByClass('UnitContent', obj);
