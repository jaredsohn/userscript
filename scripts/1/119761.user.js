// ==UserScript==
// @name           Magic
// @namespace      Little Mushro0m
// @description    xxx
// @include        *neopets.com/auctions.phtml*
// ==/UserScript==

var maxBid    = 500; //max you are willing to bid
var minRef    = 500; //min refresh time (ms)
var maxRef    = 1000; //max refresh time (ms)
...
if(document.body.innerHTML.indexOf("Time Left in Auction") > -1) {
	...
	var url = "http://www.neopets.com/auctions.phtml?type=bids&auction_id=" + document.body.innerHTML.match(/auction_id=(\d+)/)[1];
