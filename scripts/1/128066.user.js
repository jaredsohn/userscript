// ==UserScript==
// @name           Vista Previa Imagen en NegociosUnidos
// @namespace      edgart
// @description    Vista Previa Imagen en MecadoLibre
// @include        http://negociosunidos.com/*
// @version        0.1.1
...
//p: http://negociosunidos.com/terra_nu/684_terra_nu/thumbs/tn_pagina_684_144.jpg
//f: http://negociosunidos.com/terra_nu/684_terra_nu/full/pagina_684_144.jpg
...
function showPopupPic(e) {
	try {
		...
		if (t.tagName == 'IMG') { newSrc = t.src.replace("thumbs/tn_", "full/"); }
