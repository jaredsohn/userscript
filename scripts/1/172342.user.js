// ==UserScript==
// @id             	NTK Scriptsammlung Firefox
// @name           	NTK Scriptsammlung Firefox
// @namespace      	NTK Scriptsammlung Firefox
// @author         	OMI
// @description    	Scriptesammlung 
// @downloadURL   	http://userscripts.org/scripts/show/172342.user.js
// @updateURL      	http://userscripts.org/scripts/show/172342.meta.js
...
(function () {
	var AMMinnerHTML = function () {
		function AMM() {
			...
			addonmenu.AddMainMenu("UPDATE",function(){window.open("http://userscripts.org/scripts/source/172342.user.js", "_blank");;},"ALT+U");
            //--UNTERMENÃœ I--
...
(function(){
	var ccta_apa = function(){
		...
		var setLayout = function(){
			...
			var tab = new qx.ui.tabview.Page("POI Overview");
