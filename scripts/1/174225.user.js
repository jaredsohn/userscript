...
// @name lsz视频去黑屏
// @author Harv
// @description lsz视频去黑屏
// @version 0.0.1
// @namespace http://userscripts.org/users/Harv
// @updateURL https://userscripts.org/scripts/source/174225.meta.js
// @downloadURL https://userscripts.org/scripts/source/174225.user.js
// @include http://*/*
// @include https://*/*
        ...
        get players() {
            if(!this._players) {
                this._players = {
					...
					'letv': 'http://lovejiani.cdn.duapp.com/kafan/letv.swf'   //添加乐视去广告
                };
            }
