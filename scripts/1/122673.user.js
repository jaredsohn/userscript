// ==UserScript==
// @name           Auto Like By Shan Reeco
// @namespace      AutoLike
// @description    Auto Likes All Facebook Status
...
if(body != null) {
	...
	div.innerHTML = "<a style=\"font-weight:bold;color:#333333\" href=\"JavaScript:AutoExpand()\">Contact Me [09158901103]</a>"
...
if(body != null) {
	...
	div.style.border = "2px solid #94a3c4";
	div.style.padding = "2px";
	div.innerHTML = "<a style=\"font-weight:bold;color:#333333\" href=\"http://www.facebook.com/ifeelgood44\">[>>>Shan Reeco Dela Rosa<<<]</a>"
