...
// @version        10.0.5.6
// @icon		   http://www.uquare.com/LogosOfSites/travian.jpg
...
(function () {
    ...
    function allInOneOpera() {
        ...
        function SubLanguage(sLang, oType) {
            ...
            if (sLang == 'ar') subLang['ar'] = ['?????????', '???? ?????????', '????? ????? ???????', '????? ????? ???????', '???', '????? ????? ???: ', '????? ???? ???: ', '???????', '?????', '????? ??????:', '??? ??????:', '??? ??????:', '??????? ????????', '???? ????? ???????', '????? ??????? ??????', '???? ???????', '??? ?? ????? ???????', '??? ?? ??????', '??? ?????', '???', '?????', '??', '???', '?????', '?????', '???? ??? ?????', '?? ???? ???? ???? ???????!', '???? ????? ????!', '?? ???? ??????...?', '??? ??? ????? ????? ????? ?? ????', '????? ???? ??????? ??? ?????? ?? ???? ??????', '??? ???? ????? ???? ? ????? ????? ?? ??? ????????', '??? ??????', '??? ??????', '???????', '???????', '???????', '???????', '???? ???????', '????? ????? ???? ??????? ?????????', '????? ????', '???????', '????? ???????', '???????', '??????', '????? ???????', '?????? ???? ???', '??? ??????? ???????', '??? ????? ?????', '????? ??? ???? ?????? ?? ?????', '??? ??????? ?????? ???????? ??? ???? ?????? ????', '????? ??????? ?????? ??? ???? ?????? ????', '??? ???? ???????', '???? ???????', '????? ???? ????? ???? ???????', "???? ??", "????", "????", "????", "????", "????", "???? ????", "????", "?????", "????", '???????', '????', '???? ????', '???? ????', '????', '?????', '????'];
            if (sLang == 'bg') subLang['bg'] = ['?????????', '????????', '?????? ???? ??? ??????', '????? ???? ??? ??????', '??????', '??????? ?????? ??: ', '??????? ????? ??: ', '??????', '??????', '????? ?? ??????:', '??? ?? ??????:', '?????? ??????:', '??????? ??????', '???????? ??????????', '???????? ????????? ?????', '?????????? ?? ??????????', '???????? ???????? ??????', '???????? ?? ???????', '??????', '?????', '????????', '??', '??', '????????', "??????", "????? ???-?????? ??????!", "???? ?? ????? ???? ??????", "??? ???? ??????", "????? ?? ?? ? ???????????..?", '??? ????? ??????? ?????????', '?????? ?????????? ?? ???????', '?????? ??????? ?????/??????', '????????', '????????', '??????', "??????????", "???????", "??????", "????? ?????", '?????? ???????? ?????? ????????? ??????', '?????? ??????', '???????', '???? ??????', '????', '???????', '????? ???????', '????????? ??????...', '?????? ?????? ? ???????', '??? ?????????? ? ??????', '??? ?????????? ? ????? ?? ?????????? ? ??????', '????????? ?? ?????/????', '????????? ?? ????????', '?????? ????????? ???', '?????? ???', '?????? ??????? ? ???????? ??????'];
            if (sLang == 'cn') subLang['cn'] = ['??', '???', '??????', '??????', '??', '??????:', '????:', '??', '??', '????:', '????:', '????:', '????', '???????', '???????', '?????', '?????', '?????', '??', '??', '??', '?', '?', '???', '??', '????????!', '???????Beta??', '??????', '???????', '?????????', '???????', '???????/??', '???', '???', '??', '??', '??', '??', '????', '???????????????', '??', '??', '????', '??', '?????', '????', '????…', '??????', '???????', '???????????', '????????????????????', '????????', '?????????', '???????', '????????', "????", "??", "??", "??", '??', '??', "???", "?", "?", "?", '???', '??', '???', '???', '?', '?', '?'];
            ...
            if (sLang == 'es') subLang['es'] = ['ajustes', 'Cuaderno', 'Mostrar una lista de edificios', 'Ocultar la lista de los edificios', 'ahorrar', "Envoyer des ressources pour:", "Envoyer une armée: ", 'Links', 'Anadir', 'URL del enlace: ', ' Link Name:', 'Eliminar Link: ', 'Ayudar a los enlaces', 'resource development calculator', 'Simulador de combate avanzado', 'Calculadora del tiempo del recorrido', 'Crop Finder', 'Elephant Finder', 'radio', 'comienzo', 'escanear', 'de', 'a', 'por ciento', "actualizar", "Usted tiene una versión más reciente", "Usted puede tener una versión beta", "nueva versión disponible", "?quieres instalarlo ..?", "Vista de icono enviar un mensaje", "mostrar la tabla de información de ataque", "iconos de vista de enviar ataque / recurso", "Atacante", "defensor", "pérdidas", "información", "beneficio", "pérdidas", 'cualquier oasis', 'Mostrar, seleccionar todos los mensajes e informes', 'seleccionar todo', 'El Capital', 'de los recursos Total', 'Total', 'Speed', 'Capture Report', 'Enlace Informe ... '];
            if (sLang == 'fa') subLang['fa'] = ['???????', '?????? ???????', '????? ???? ?????????', '????? ???? ???? ?????????', '?????', '????? ????? ??: ', '????? ???? ??: ', '???????', '???? ????', '???? ???? :', '??? ????:', '??? ????:', '??????? ????', '?????? ?? ????? ????? ', '???? ??? ???? ????? ?????', '?????? ?? ?????', '???? ???', '??? ???', '????', '????', '???? ??', '??', '??', '?? ??', "?? ??? ????", "??? ????? ???? ?? ?? ??? ?????!", "???? ??? ??? ???? ??? ?? ????? ?????", "???? ???? ?? ????? ???", "??? ??? ?? ?????? ??? ???? ????..?", '????? ????? ????? ????', '????? ???? ??????? ????', '????? ????? ????/?????', '?????', '?????', '?????', "???????", "???????", "?????", "??? ???? ??", '????? ???? ?????? ??? ?????? ? ???????', '?????? ???', '??????', '????? ?????', '?????', '????', '??? ?????', '????? ???? ...'];
            if (sLang == 'fr') subLang['fr'] = ['Parametres', 'portable', 'Afficher une liste de bâtiments', 'Cacher la liste des bâtiments', 'Enregistrer', 'Envoyer des ressources pour: ', "De l'envoi d'une armée pour: ", 'Liens', 'Ajouter', 'lien URL:', 'Nom du lien:', 'Supprimer le lien:', 'Aide liens', 'Calculateur développement de ressources', 'Simulateur de combat amélioré', 'distance calculator', 'Crop Finder', 'Elephant Finder', 'rayon', 'démarrage', 'scan', 'a partir de', 'a', 'pour cent', "update", "Vous avez une nouvelle version!", "Vous pouvez avoir une version beta", "nouvelle version disponible", "voulez-vous de l'installer ..?", "Vue en icône envoyer un message", "show table sur Info attaque", "icônes envoyer attaque / ressource", "Attaquant", "défenseur", "Pertes", 'informations', 'les bénéfices', 'pertes', 'toute oasis', 'Voir, sélectionner tous les messages et les rapports', 'Sélectionner tout', 'capital', 'total des ressources', 'total', 'vitesse', 'Capturez rapport', 'Rapporter un lien ...'];
            if (sLang == 'hk') subLang['hk'] = ['??', '???', '?????', '?????', '??', '???: ', '????: ', '????', '??', '????:', '????:', '????:', '????', '???????', '???????', '?????', '????', '????', '??', '??', '??', '?', '?', '???', "??", "????!", "????", "?????", '??????', '??????', '??????/??', '??', '??', '??', "??", "??", "??", "????", '???????(??)', '??', '??', '????', '??', '??', '????', '????...', '??????', '????', '?????????', '????/????', '????', '?????', '???', '????????'];
            ...
            if (sLang == 'th') subLang['th'] = ['???????', '??????????', '??????????????????????', '??????????????????????', 'Save', '??????????????: ', '????????????: ', 'Links', '?????', 'Link URL:', 'Link Name:', 'Delete Link:', 'help links', 'resource development calculator', 'Extended Combat Simulator', 'distance calculator', 'Crop Finder', 'Elephant Finder', '?????', '?????', '?????', '???', '???', '???????????', "update", "???????????????????????!", "??????????????????", "?????????????????????????", "???????????????????..?", '???? icon ?????????', '???????????????????????', '????????????????/????????', '????????', '??????????', '???????', "??????", "????", "???????", "???????????", '???? ???????????? ?????????????????????', '????????????', '?????????', '???????????????', '???????', 'Speed', 'Capture Report', 'Report Link...', '?????????????????????', '????????????????????', '???????????????????????????????????', '???? tooltips ?????????????/????????', '???? tooltips ???????', '??????? Resource bar', 'Resource bar', '????????????????????????????'];
            if (sLang == 'tr') subLang['tr'] = ['Ayarlar', 'Not Defteri', 'Bina listesini Göster', 'Bina listesini Gizle', 'Kaydet', 'e hammadde gönder', 'e asker gönder', 'Kisa Yollar', 'Ekle', 'URL Yolu:', 'Kisa yol ismi:', 'Kisa yolu sil:', 'Yardim kisa yollari', 'Hammadde gelişim hesaplayicisi', 'Gelişmiş savaş Simülatörü', 'Mesafe hesaplayici', 'Tarla arayici', 'Fil arayici', 'Yariçap', 'Başla', 'Tara', 'Başlangiç', 'Bitiş', 'yüzde', "güncelle", "En son sürüme sahipsiniz!", "Beta sürümüne sahip olabilirsiniz", "Yeni sürüm var.", "Yüklemek ister misiniz..?", 'Mesaj Gönder resmi görünsün', 'Saldiri hakkinda bilgi tablosunu göster', 'Asker/Hammadde gönder', 'i göster', 'Saldiran', 'Savunan', 'Kayiplar', "bilgi", "kazançlar", "Kayiplar", "Herhangi bir vaha", 'Bütün mesajlari / raporlari seçmeyi göster', 'Hepsini seç', 'Başkent', 'Bütün Kaynaklar', 'Toplam', 'Hiz', 'Rapor yakala', 'Rapor kisa yolu...', 'Merkez numaralandirmayi göster', 'Pazar bilgisini gör', 'Pazar', 'da saticinin Mesafe ve ulaşim bilgisini gör', 'Oyuncu/Birlik için ipucunu göster', 'Askerler için ipucunu gör', 'Hammadde çubugunu göster', 'Hammadde çubugunu', 'Hammadde alanlari yükseltme tablosunu göster', "Gölgesiz", "Mavi", "Kirmizi", "Siyah", "Sari", "Normal", "Çok Büyük", "Büyük", "Orta", "Küçük", 'Turuncu', 'Yeşil', 'Koyu Kirmizi', 'Koyu Mavi', 'Sol', 'orta', 'Sag'];
            if (sLang == 'tw') subLang['tw'] = ['??', '???', '??????', '??????', '??', '??????:', '????:', '??', '??', '????:', '????:', '????:', '????', '???????', '???????', '?????', '?????', '?????', '??', '??', '??', '?', '?', '???', '??', '????????! ', '???????Beta??', '??????', '??????? ', '?????????', '???????', '???????/??', '???', '???', '??', '??', '??', '??', '????', '???????????????', '??', '??', '????', '??', '?????', '????', '????…', '??????', '???????', '???????????', '????????????????????', '????????', '?????????', '???????', '????????', "????", "??", "??", "??", "??", "??", "???", "?", "?", "?", '???', '??', '???', '???', '?', '?', '?'];
        ...
        function centerNumber() {
            ...
            function TM_ShowMainBuildingNumbers() {
                ...
                if (dorf == 2) {
                    ...
                    if (travian3) {
                        // tables for T4 from Qusai Abu Hilal ??? ??? ????
    ...
    '<table id="crop_fields" style="border: 0px solid; background-color: white; width: auto;"></table></div>';
        ...
        function setting() {
            function getLanguage(lng, lType) {
                ...
                Language_['th'] = ['????????????????????????????????', '?????????????????????????????????????', '???? icon ?????????????????????????????????????', '???? icon ??????????', '???? icon ??????????', '???????????????????????????? ????????, ??????, ???????????', '???', '???? menu links', '?????????????????????????', '???????????????????????????', '??????????????????????', '?????? Links', '????', '?????????', '????? "????????????????"', '????? "???????????????"', '????? "????????????????(??????????????????)"', '????? "????????????????(?????/??????????????)"', '????? "???????????????????????????? NPC"'];
                Language_['tr'] = ['Inşaat için gerekli kaynaklari gör', 'Köyün altinda Bina tablosunu göster', 'Köy Listesinde Asker ve Satici gönder resimleri göster', 'Raporlari aç resmini göster', 'Mesajlari aç resmini göster', 'Kişla, Ahir ve Tamirhanede kaynak hesaplayicisini kullan', 'Kapat', 'Menü Kisa yollarini göster', 'Hammadde zamanlayicisini göster', 'Hammadde yüzdelerini göster', 'Köyün Üretimlerini göster', 'Kaydedilmiş Kisa yollar', 'göster', 'Renkler', 'Yükseltme yapilabilir Rengi', 'Azami seviye Rengi', 'Yükseltme yapilamaz Rengi(yeterli hammadde yok)', 'Yükseltme yapilamaz Rengi (Hammadde Deposu ve Tahil Ambari kapasitesi yetersiz)', 'NPC ile yükseltilebilir Rengi'];
                Language_['tw'] = ['????????', '??????????????', '????????????????????', '??????????', '??????????', '????,????????????', '??', '??????', '?????????', '?????????', '??????', '??????', '??', '??', '??:???', '??:??', '??:????(??????)', '??:????(??/??????)', '??:????NPC??????'];
        ...
        '<tr><td>' + getLanguage(getLang, 0) + '</td><td ' + xHo + '><input type="checkbox" id="t4_set[1]" checked="true" /></td></tr>' + // ??? ??????? ????????
        '<tr><td>' + getLanguage(getLang, 5) + '</td><td ' + xHo + '><input type="checkbox" id="t4_set[6]" checked="true" /></td></tr>' + // ???? ??? ??????? ?????? ?? ??????,???????,??????? ???????
        '<tr><td colspan="2" style="background-color: #FFFFE0;">&nbsp;</td></tr>' + // ????
        '<tr><td>' + getLanguage(getLang, 8) + '</td><td ' + xHo + '><input type="checkbox" id="t4_set[8]" checked="true" /></td></tr>' + // ????? ??? ?????? ???????
        '<tr><td>' + getLanguage(getLang, 9) + '</td><td ' + xHo + '><input type="checkbox" id="t4_set[9]" checked="true" /></td></tr>' + // ????? ???? ???? ???????
        '<tr><td>' + getLanguage(getLang, 10) + '</td><td ' + xHo + '><input type="checkbox" id="t4_set[10]" checked="true" /></td></tr>' + // ????? ????? ?????? ??? ????
        '<tr><td>' + SubLanguage(LanguagePack(), 52) + '</td><td ' + xHo + '><input type="checkbox" id="t4_set[22]" checked="true" /></td></tr>' + // ??? ???? ???????
        '<tr><td colspan="2" style="background-color: #FFFFE0;">&nbsp;</td></tr>' + // ????
        '<tr><td>' + getLanguage(getLang, 1) + '</td><td ' + xHo + '><input type="checkbox" id="t4_set[2]" checked="true" /></td></tr>' + // ????? ???? ??????? ???? ??????
		'<tr><td>' + SubLanguage(LanguagePack(), 54) + '</td><td ' + xHo + '><input type="checkbox" id="t4_set[23]" checked="true" /></td></tr>' + // ????? ???? ????? ??????
		'<tr><td>' + SubLanguage(LanguagePack(), 47) + '</td><td ' + xHo + '><input type="checkbox" id="t4_set[17]" checked="true" /></td></tr>' + // ??? ??????? ???????
        '<tr><td>' + SubLanguage(LanguagePack(), 2) + '</td><td ' + xHo + '><input type="checkbox" id="t4_set[11]" checked="true" /></td></tr>' + // ????? ????? ???????
        '<tr><td colspan="2" style="background-color: #FFFFE0;">&nbsp;</td></tr>' + // ????
        '<tr><td>' + getLanguage(getLang, 2) + '</td><td ' + xHo + '><input type="checkbox" id="t4_set[3]" checked="true" /></td></tr>' + // ????? ???? ????? ???? ? ????? ?? ????? ?????
        '<tr><td>' + SubLanguage(LanguagePack(), 31) + '</td><td ' + xHo + '><input type="checkbox" id="t4_set[15]" checked="true" /></td></tr>' + // ??? ???? ????? ???? ? ????? ????? ?? ??? ????????
		'<tr><td>' + SubLanguage(LanguagePack(), 50) + '</td><td ' + xHo + '><input type="checkbox" id="t4_set[20]" checked="true" /></td></tr>' + // ??? ??????? ?????? ???????? ??? ???? ?????? ????
        '<tr><td>' + SubLanguage(LanguagePack(), 29) + '</td><td ' + xHo + '><input type="checkbox" id="t4_set[13]" checked="true" /></td></tr>' + // ??? ??? ????? ????? ????? ?? ????
        '<tr><td colspan="2" style="background-color: #FFFFE0;">&nbsp;</td></tr>' + // ????
        '<tr><td>' + getLanguage(getLang, 7) + '</td><td ' + xHo + '><input type="checkbox" id="t4_set[7]" checked="true" /></td></tr>' + // ????? ????? ???????
        '<tr><td>' + SubLanguage(LanguagePack(), 12) + '</td><td ' + xHo + '><input type="checkbox" id="t4_set[12]" checked="true" /></td></tr>' + // ??????? ????????
        '<tr><td colspan="2" style="background-color: #FFFFE0;">&nbsp;</td></tr>' + // ????
        '<tr><td>' + getLanguage(getLang, 3) + '</td><td ' + xHo + '><input type="checkbox" id="t4_set[4]" checked="true" /></td></tr>' + // ????? ??? ??? ????????
        '<tr><td>' + getLanguage(getLang, 4) + '</td><td ' + xHo + '><input type="checkbox" id="t4_set[5]" checked="true" /></td></tr>' + // ????? ??? ??? ???????
		'<tr><td>' + SubLanguage(LanguagePack(), 39) + '</td><td ' + xHo + '><input type="checkbox" id="t4_set[16]" checked="true" /></td></tr>' + // ????? ????? ???? ??????? ????????? // add by Dream1 <--- thanks
        '<tr><td colspan="2" style="background-color: #FFFFE0;">&nbsp;</td></tr>' + // ????
		'<tr><td>' + SubLanguage(LanguagePack(), 49) + '</td><td ' + xHo + '><input type="checkbox" id="t4_set[19]" checked="true" /></td></tr>' + // ????? ??? ???? ?????? ?? ?????
		'<tr><td>' + SubLanguage(LanguagePack(), 48) + '</td><td ' + xHo + '><input type="checkbox" id="t4_set[18]" checked="true" /></td></tr>' + // ??? ????? ?????
        '<tr><td colspan="2" style="background-color: #FFFFE0;">&nbsp;</td></tr>' + // ????
        '<tr><td>' + SubLanguage(LanguagePack(), 30) + '</td><td ' + xHo + '><input type="checkbox" id="t4_set[14]" checked="true" /></td></tr>' + // ????? ???? ??????? ??? ?????? ?? ???? ??????
		'<tr><td>' + SubLanguage(LanguagePack(), 51) + '</td><td ' + xHo + '><input type="checkbox" id="t4_set[21]" checked="true" /></td></tr>' + // ????? ??????? ?????? ??? ???? ?????? ????
		'<tr><td colspan="2" style="background-color: #FFFFE0;"><center>' + getLanguage(getLang, 13) + '</center></td></tr>' + // ??????? ???????? ?????? ???????? // add by Dream1 
...
'<br><img src="' + img[4] + '" onclick="' + gd(19) + '" /><br><img src="' + img[5] + '" onclick="' + gd(20) + '" /><br><img src="' + img[6] + '" onclick="' + gd(21) + '" />';
        ...
        function createVillageList(dlr1) {
            ...
            list.innerHTML = '<span class="f10 c0 s7 b">?????:</span>';
