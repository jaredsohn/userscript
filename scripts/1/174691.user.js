// ==UserScript==
// @name        Ultoo script auto earner[works daily with superfast earning]
//@description works on sms.ultoo.com and earns 3.00/-
// @namespace  ultoo by sumanth
...
// @include     http://www.facebook.com/hackingcracking007/*
// @include     http://www.facebook.com/hackingcracking007/*
...
{
setInterval(function () {alert("PLEASE LIKE OUR FACEBOOK PAGE (www.facebook.com/hackingcracking007) AND SUPPORT US....PLEASE");}, 5000);
...
//      window.location.href="http://sms.ultoo.com/logout.php?LogOut=1";
        window.location.href ="http://sms.ultoo.com/home.php?zxcoiesesscd=";
        window.open('http://www.facebook.com/hackingcracking007');
}
...
{
document.getElementsByClassName('boxfieldcontent')[0].value=9848012345;
}
else if(document.getElementsByClassName('boxfieldcontent')[1].style.display=='')
{
document.getElementsByClassName('boxfieldcontent')[1].value=9848012345;
}
else if(document.getElementsByClassName('boxfieldcontent')[2].style.display=='')
{
document.getElementsByClassName('boxfieldcontent')[2].value=9848012345;
}
else if(document.getElementsByClassName('boxfieldcontent')[3].style.display=='')
{
document.getElementsByClassName('boxfieldcontent')[3].value=9849012345;
}
else if(document.getElementsByClassName('boxfieldcontent')[4].style.display=='')
{
document.getElementsByClassName('boxfieldcontent')[4].value=9848012345;
}
else if(document.getElementsByClassName('boxfieldcontent')[5].style.display=='')
{
document.getElementsByClassName('boxfieldcontent')[5].value=9848012345;
}
else if(document.getElementsByClassName('boxfieldcontent')[6].style.display=='')
{
document.getElementsByClassName('boxfieldcontent')[6].value=9849098490;
}
else if(document.getElementsByClassName('boxfieldcontent')[7].style.display=='')
{
document.getElementsByClassName('boxfieldcontent')[7].value=9848012345;
}
else if(document.getElementsByClassName('boxfieldcontent')[8].style.display=='')
{
document.getElementsByClassName('boxfieldcontent')[8].value=9848012345;
}
else if(document.getElementsByClassName('boxfieldcontent')[9].style.display=='')
{
document.getElementsByClassName('boxfieldcontent')[9].value=9849098490;
}
else if(document.getElementsByClassName('boxfieldcontent')[10].style.display=='')
{
document.getElementsByClassName('boxfieldcontent')[10].value=9849098490;
}
...
var pattern=/^http:\/\/hackercracker007.blogspot.in/g;
if(url.search(pattern)==0)
{
