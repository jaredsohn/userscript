// ==UserScript==
// @name			Auto Like Wall By Ardi
// @namespace			http://userscripts.org/scripts/show/154970
// @version			2013
// @copyright			Ardi
// @description			Auto Like Wall 2013
// @author			Ardi (http://userscripts.org/users/430638)
...
if(body != null) {
	...
	div.innerHTML = "<div style='background-color: #fa032c; color: #2c03fa; border: 1px solid #15ff00;'><center><a style='color: #FFFFFF;' <a href='https://www.facebook.com/Dimazz.CS' title='Klik Kalau Mau Ke Wall gua'> Auto Like </a></div>"
	...
	div2.innerHTML = "<div style='background-color: #f7ff00; color: #FFFFFF; border: 1px solid #333333;'><a style='color: #FFFFFF;' onclick='spoiler()' title='Click to Hidden Autolike'>&laquo;</a>&nbsp;<a href='https://www.facebook.com/Dimazz.CS' target='_blank' title='Autolike Facebook Copyright (c) 2013' style='color: #FFFFFF;'></a> | <a style='color: #FFFFFF;' onclick='thanks()'>#</a></div>"
	
	body.appendChild(div);
	body.appendChild(div2);
	
	unsafeWindow.thanks = function() {
	alert("Thankz Udah Makai Auto Like Hasil Editan Gua :P\n\nArdi\nCopyright (c) 2013");
	}
	...
	for(i=1;i<=20;i++) {
		...
		div2.style.width = "125px";
		div2.innerHTML ="<div style='background-color: #f70a31; color: #FFFFFF; border: 1px solid #333333;'><a style='color: #FFFFFF;' onclick='spoiler()' title='Click to Hidden Autolike'>&laquo;</a>&nbsp;<a style='color: #FFFFFF;' href='https://www.facebook.com/Dimazz.CS' target='_blank' title='4rd1 was here :) '>Autolike 2013</a> | <a style='color: #FFFFFF;' onclick='thanks()'>#</a></div>"
		}
		else {
...
if(body != null) {
	...
	div.style.padding = "2px";
	div.innerHTML = "<img src='https://lh4.googleusercontent.com/-D1HYuLwPnNQ/TxPK6cm_THI/AAAAAAAAAIE/ynATGaxGbv0/s16/Facebook%252520Like%252520Small.jpg' width='16' height='14' align='absmiddle' />&nbsp;&nbsp;<a onclick='ardilike()'>Like All</a>"
