// ==UserScript==
// @name           scriptALC by pook version 2.0
// @namespace      Pook
// @description    4eme version du chat spécial pour les alliés (SA et ALC dans un premier temps : version pour les ALC)
...
// ==/UserScript==
	...
	*/
	...
	function creerElement(chat,id1,id2){
		...
		choix1.addEventListener("click",function(){GM_setValue("nbchat", "102678")},false);
