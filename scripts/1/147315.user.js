// ==UserScript==
// @name        GalaxyInfo-french_translate
...
oGameVersionCheck('GalaxyInfo','5.0.1','http://userscripts.org/scripts/show/136509');
...
GM_xmlhttpRequest({
  ...
  onload: function(response) {
    ...
    score=score[1].split('"');
    score=dot(score[0]);
    document.getElementById("player"+id).getElementsByTagName('ul')[0].innerHTML=document.getElementById("player"+id).getElementsByTagName('ul')[0].innerHTML+"<li><span>Économíe : "+score+"</span></li>";
