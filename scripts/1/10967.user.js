// ==UserScript==
// @name        Add 5 mirrors to Digg articles
// @description Adds 5 mirror links to Digg Articles
// @include     http://digg.com/*
// @include     http://*.digg.com/*
// ==/UserScript==
// Script originally created by coollettuce, only minor edits made by NikoKun
...
//creates the actual on page buttons
addGlobalStyle("a.sam_coralcacheicon, a.sam_duggmirroricon, a.sam_duggbackicon, a.sam_googleicon, a.sam_waybackicon { padding-left: 15px; background: center no-repeat; }");
...
addGlobalStyle("a.sam_coralcacheicon:hover, a.sam_duggmirroricon:hover, a.sam_duggbackicon:hover, a.sam_googleicon:hover, a.sam_waybackicon:hover { opacity: 0.5; }");
