    ...
    $(document).ready(function () {
        ...
        var transferBaiduData = function(id,lng,lat,status){
            ...
            var n_lat = parseInt(lat);
             if((n_lng == '116' || n_lng == '117' || n_lng == '0') & (n_lat == '40'|| n_lat == '39'|| n_lat == '38'|| n_lat == '0')){
        ...
        function getLocalData(){
            $.getJSON("http://10.207.0.240/jsapi.php?type=getshop&city=tianjin&callback=?",function(data){
                    var data = eval(data);
