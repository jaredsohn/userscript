    ...
    function Ta() {
        ...
        function g(c, l) {
            ...
            g.prototype.V = function () {
                if (L() && (this.o && this.ra) && (this.t || (this.t = $("#" + this.id + "_stats")), this.t)) {
                    var a = "";
                    this.r.kc && (a += "Won: " + u(this.r.oa) + " | Lost: " + u(this.r.na) + " | Damage Done: " + u(this.r.Yb) + " | Damage Taken: " + u(this.r.yc) + " | Ices: " + u(this.r.Ad) + " | Kills: " + u(this.r.Bd) + " | Total: " + u(p(this.r.Ad + this.r.Bd * 2)) + " <br/>", a += "Running for: " + Z(this.r.kc) + " | Damage per Second: " + u(p(this.r.Yb / this.r.kc)));
                    this.t.html(a);
                    X.Ga()
                }
            };
