...
Main.k.initData = function() {
	...
	Main.k.HEROES_SHORTDESC = [
		"Commandant suprÃªme du Daedalus.",
		"Scientifique millÃ©naire.",
		"Grand architecte du Daedalus.",
		"Psychologue Digitale aux atouts certains.",
		"Humoriste pilote de chasse Ã  ses heures.",
		"Exploratrice de l'extrÃªme.",
		"Officier principal des Communications du Daedalus.",
		"Chef de la sÃ©curitÃ© du Daedalus.",
		"Biologiste de renommÃ©e internationale, pionniÃ¨re dans l'Ã©tude du Mush.",
		"Cuisinier le plus dangereux de la galaxie.",
		"Chercheur frugivore flexible.",
		"Dernier espoir de l'HumanitÃ©.",
		"GÃ©nie de la physique quantique fÃ©linophile.",
		"Armateur philantrophobe.",
		"Investigatrice dÃ©chue de premier plan.",
		"Technophile motorisÃ©."
	];
...
Main.k.displayMainMenu = function() {
	...
	var play = $("<li class='kmenuel active first'><a href='http://mush.twinoid.com/chooseHero'>Jouer</a></li>").appendTo(menu);
	var account = $("<li class='kmenuel'><a href='http://mush.twinoid.com/me'>Mon Compte</a></li>").appendTo(menu);
	var casting = $("<li class='kmenuel'><a href='http://mush.twinoid.com/group/list'>Castings</a></li>").appendTo(menu);
	var rankings = $("<li class='kmenuel'><a href='http://mush.twinoid.com/ranking'>Classement</a></li>").appendTo(menu);
	var forum = $("<li class='kmenuel'><a href='http://mush.twinoid.com/tid/forum'>Forum</a></li>").appendTo(menu);
	var help = $("<li class='kmenuel last'><a href='http://mush.twinoid.com/help'>Aide</a></li>").appendTo(menu);

	var play_ss = $("<ul>").appendTo(play);
	$("<a class='kssmenuel' href='http://mush.twinoid.com/vending'><li><img src='/img/icons/skills/rebel.png' /> Distributeur</li></a>")
	.css("display", "none").attr("id", "vendingmenu").appendTo(play_ss);

	var account_ss = $("<ul>").attr("id", "accountmenu").appendTo(account);
	$("<a class='kssmenuel' href='http://mush.twinoid.com/me'><li><img src='/img/icons/skills/persistent.png' /> ExpÃ©rience</li></a>").appendTo(account_ss);
	$("<a class='kssmenuel' href='http://mush.twinoid.com/me?profile'><li><img src='/img/icons/skills/opportunist.png' /> Ma fiche</li></a>").appendTo(account_ss);
	$("<a class='kssmenuel' href='http://mush.twinoid.com/me?config'><li><img src='/img/icons/skills/engineer.png' /> RÃ©glages</li></a>").appendTo(account_ss);
	$("<a class='kssmenuel' href='http://mush.twinoid.com/me?news'><li><img src='/img/icons/skills/radio_expert.png' /> News</li></a>").appendTo(account_ss);

	var rankings_ss = $("<ul>").appendTo(rankings);
	$("<a class='kssmenuel' href='http://mush.twinoid.com/ranking'><li><img src='/img/icons/skills/persistent.png' /> Classements</li></a>").appendTo(rankings_ss);
	...
	$("<a class='kssmenuel ext' href='http://mush.twinoid.com/tid/forum#!view/67061'><li><img src='" + Main.k.servurl + "/img/radioh.png' /> Discussion</li></a>").appendTo(forum_ss);
	$("<a class='kssmenuel ext' href='http://mush.twinoid.com/tid/forum#!view/67561'><li><img src='" + Main.k.servurl + "/img/radioh.png' /> Entraide</li></a>").appendTo(forum_ss);
	$("<a class='kssmenuel ext' href='http://mush.twinoid.com/tid/forum#!view/74323'><li><img src='" + Main.k.servurl + "/img/radioh.png' /> DÃ©tente</li></a>").appendTo(forum_ss);
	$("<a class='kssmenuel ext' href='http://mush.twinoid.com/tid/forum#!view/93847'><li><img src='" + Main.k.servurl + "/img/radioh.png' /> Castings</li></a>").appendTo(forum_ss);
	if (Main.k.silver) $("<a class='kssmenuel ext' href='http://mush.twinoid.com/tid/forum#!view/78267'><li><img src='/img/icons/skills/rebel.png' /> Officiers</li></a>").appendTo(forum_ss);

	var help_ss = $("<ul>").appendTo(help);
	$("<a class='kssmenuel' href='http://mush.twinoid.com/help'><li><img src='/img/icons/skills/genius.png' /> Aide Mush</li></a>").appendTo(help_ss);
	$("<a class='kssmenuel' href='http://mush.twinoid.com/patchlog'><li><img src='/img/icons/skills/persistent.png' /> Patchlog</li></a>").appendTo(help_ss);
	if (Main.k.ownHero && Main.k.tutorials[Main.k.ownHero]) {
		var charname = Main.k.ownHero.replace("_", "");
		$("<a class='kssmenuel ext' href='http://mush.twinoid.com/tid/forum#!view/67561|thread/" + Main.k.tutorials[Main.k.ownHero] + "'><li><img src='/img/icons/ui/" + charname + ".png' /> Tuto " + Main.k.ownHero.capitalize() + "</li></a>").appendTo(help_ss);
	}
	...
	if (Main.k.fds) {
		$("<a class='kssmenuel ext' href='http://mush.twinoid.com/tid/forum#!view/77714'><li><img src='/img/icons/skills/cold_blood.png' /> Magistrature</li></a>").appendTo(forum_ss);

		$("<a class='kssmenuel' href='http://mush.twinoid.com/fds'><li><img src='/img/icons/skills/cold_blood.png' /> FDS</li></a>").appendTo(play_ss);
	}
}
...
//  Option Name,	Option Object,				Need refresh,	After(),				Desc
	["cbubbles",	Main.k.Options.cbubbles,	false,			Main.k.customBubbles,	"Activer la mise en forme personnalisÃ©e des messages (bordure + couleur nom + image de fond)."],
	["cbubblesNB",	Main.k.Options.cbubblesNB,	false,			Main.k.customBubbles,	"Simplifier la mise en forme personnalisÃ©e des messages (suppression de l'image de fond)."],
	["dlogo",		Main.k.Options.dlogo,		true,			null,					"Afficher le logo Mush au dessus des onglets."],
	["splitpjt",	Main.k.Options.splitpjt,	false,			Main.k.updateBottom,	"SÃ©parer les projets / recherches / pilgred sous la zone de jeu."],
...
Main.k.Options.open = function() {
	...
	if (!Main.k.Options.initialized) {
		...
		$("<p>").addClass("warning").html("Gestion des options en cours de dÃ©veloppement. Les options affichÃ©es ci-dessous sont cependant configurables.").appendTo(td);
		

		for (var i=0; i<Main.k.Options.options.length; i++) {
			var opt = Main.k.Options.options[i];
			var html = opt[4];
			if (opt[2]) html += " NÃ©cessite un rechargement de la page.";
...
Main.k.css.ingame = function() {
	...
	/** pour rÃ©gler les probleme du au scale css3 sur firefox**/\
...
Main.k.tabs.playing = function() {
	...
	Main.onWallFocus = function(jq) {
		...
		if (!jq.parent().find(".formatbtn").get(0)) {
			...
			.attr("_title", "Partager son Ã©tat de santÃ©")
			.attr("_desc", "InsÃ¨re votre nombre de points de vie et de moral dans la zone de texte active, de la forme&nbsp;:</p><p>TODO: example")
			...
			.attr("_desc", "InsÃ¨re l'inventaire de la piÃ¨ce dans la zone de texte active, de la forme&nbsp;:</p><p><strong>Couloir central :</strong> <i>Combinaison</i>, <i>Couteau</i>, <i>MÃ©dikit</i>, <i>Extincteur</i>")
			.on("mouseover", Main.k.CustomTip)
			.on("mouseout", Main.hideTip);
			...
			if ($("#plantmanager").length > 0) {
				...
				.attr("_title", "Partager l'Ã©tat des plantes")
			...
			if ($(".shareprojectbtn").length > 0) {
				...
				.attr("_desc", "InsÃ¨re la liste de projets dans la zone de texte active, de la forme&nbsp;:</p><p>" +
			...
			if ($(".shareresearchbtn").length > 0) {
				...
				.attr("_desc", "InsÃ¨re la liste de recherches dans la zone de texte active, de la forme&nbsp;:</p><p>" +
				"<li><strong>Nom de la recherche</strong> - 0%<br/>Description de la recherche<br/>Bonus : <i>Biologiste</i>, <i>MÃ©decin</i></li>" +
				"<li><strong>Nom de la recherche</strong> - 0%<br/>Description de la recherche<br/>Bonus : <i>Biologiste</i>, <i>MÃ©decin</i></li>" +
				"<li><strong>Nom de la recherche</strong> - 0%<br/>Description de la recherche<br/>Bonus : <i>Biologiste</i>, <i>MÃ©decin</i></li>")
				.on("mouseover", Main.k.CustomTip)
				.on("mouseout", Main.hideTip);
			...
			if ($("#biosModule").length > 0) {
				...
				.attr("_title", "Partager les paramÃ¨tres BIOS")
				.attr("_desc", "InsÃ¨re la liste de paramÃ¨tres BIOS Neron dans la zone de texte active, de la forme&nbsp;:</p><p>TODO: aperÃ§u")
				.on("mouseover", Main.k.CustomTip)
				.on("mouseout", Main.hideTip);
			}
			...
			if ($("#navModule").length > 0) {
				...
				.attr("_title", "Partager les planÃ¨tes")
				.attr("_desc", "TODO: Texte | SÃ©parer les planÃ¨tes en deux boutons")
				.on("mouseover", Main.k.CustomTip)
				.on("mouseout", Main.hideTip);
			}
			...
			.attr("_title", "InsÃ©rer un smiley")
			.attr("_desc", "BientÃ´t disponible.")
			.on("mouseover", Main.k.CustomTip)
			.on("mouseout", Main.hideTip);
...
/*	Main.onWallInput = function(event) {
	...
	Main.k.UpdateDialog = function() {
		...
		//conf.title = "Mise Ã  jour du script CTRL+W";
		...
		var ok = "<div class='updatesactions'><div id=\"ok\" class=\"but updatesbtn\" onclick=" + okAc + "><div class=\"butright\"><div class=\"butbg\"><a href=\"#\">Mettre Ã  jour</a></div></div></div>";
	...
	Main.k.FormatInventory = function() {
		...
		if (ncamera) inv += ncamera + " camÃ©ra" + (ncamera != 1 ? "s" : "");
		if (ncamera && ndrones) inv += " - ";
	...
	Main.k.FormatPlants = function() {
		...
		$("#room").find("[data-id='TREE_POT']").each(function(i) {
			...
			if (dry) problems.push("//DessÃ©chÃ©//");
	...
	Main.k.FormatResearch = function() {
		...
		$("#cdModuleContent ul.dev li.cdProjCard").each(function(i) {
			...
			var pct = $(this).find("span").html().trim();
			var desc = parse($(this).find("div.desc").html().trim());
			var bonus1 = /<strong>([^<]+)<\/strong>/.exec($(this).find("div.suggestprogress ul li img").first().attr("onmouseover"))[1].trim().replace("MÃ©deÃ§in", "MÃ©decin");
			var bonus2 = /<strong>([^<]+)<\/strong>/.exec($(this).find("div.suggestprogress ul li img").last().attr("onmouseover"))[1].trim().replace("MÃ©deÃ§in", "MÃ©decin");
			ret += "\r\n**" + name + "** - " + pct + "\n";
			ret += "" + desc + "\n";
			ret += "Bonus : //" + bonus1 + "//, //" + bonus2 + "//";
		});
	...
	Main.k.About.open = function() {
		...
		if (!Main.k.About.initialized) {
			...
			Vous pourrez Ã©galement y trouver de l'aide ou faire des suggestions.</p><p><strong>Chan #ctrlw sur Quakenet</strong>")
			...
			$("<p>").css({
				...
				color: "#CCC",
				"text-align": "center"
			}).html("Script dÃ©veloppÃ© par <a href='http://twinoid.com/user/8297'>kill0u</a>. <br/>\
			Le logo, les images (mise en forme personnalisÃ©e des messages) et le design du site web ont Ã©tÃ© faits par \
			...
			$("<h2>").css({
				color: "#EEE",
				margin: "10px 15px 0"
			}).html("FonctionnalitÃ©s Ã  venir&nbsp;:").appendTo(td);
			var ul = $("<ul>").css({
			...
			$("<li>").html("AmÃ©lioration du Manager").appendTo(ul);
			$("<li>").html("AmÃ©lioration de la gestion des plantes").appendTo(ul);
			$("<li>").html("Gestion des mÃ©dicaments et de la nourriture").appendTo(ul);
			$("<li>").html("Gestion des animations distributeur").appendTo(ul);
			$("<li>").html("Informations sur le dÃ©montage d'objets").appendTo(ul);
			$("<li>").html("Assistant Admin. Neron + messages prÃ©-enregistrÃ©s").appendTo(ul);
			$("<li>").html("Whiteboard (surprise)").appendTo(ul);
			$("<li>").css("list-style-type", "none").html("<a href='" + Main.k.website + "'>Liste des mises Ã  jour</a>").appendTo(ul);
	...
	Main.k.Manager.open = function(after) {
		...
		if (!Main.k.Manager.initialized) {
			...
			// Tooltips
			$("#tabstats").attr("_title", "Statistiques").attr("_desc", "Affiche les statistiques, et permet de gÃ©rer le nombre de messages chargÃ©s dans la page.");
			$("#tabnew").attr("_title", "Nouveaux Messages").attr("_desc", "Beaucoup de messages Ã  lire ? Le manager permet de rattraper son retard plus facilement. En chargeant tous les messages dans l'onglet Statistiques, vous pouvez aussi voir les messages non lus manquÃ©s Ã  cause du bug (Mush) des messages.");
			$("#tabsearch").attr("_title", "Recherche de Messages").attr("_desc", "Une discussion Ã  retrouver ? Envie de savoir combien d'incendies se sont dÃ©clarÃ©s ? (@neron incendie daedalus)");
			$("#tabwall").attr("_title", "Discussion").attr("_desc", "Le canal de discussion est indispensable pour s'organiser avec l'Ã©quipage.</p><p>Pour participer vous devez possÃ©der un <strong>talkie-walkie</strong>.");
			$("#tabfav").attr("_title", "Favoris").attr("_desc", "Votre sÃ©lection de sujets favoris.");
			...
			$("<img>").attr("src", "/img/icons/ui/wall.png").appendTo(
				$("<li>").addClass("tab tabon").attr("id", "tabtopic").attr("_title", "Discussion").attr("_desc", "Le canal de discussion est indispensable pour s'organiser avec l'Ã©quipage.").appendTo(tabs)
			);
			...
			$("<p>").addClass("warning").html("Aucun topic sÃ©lectionnÃ©.").appendTo(topic);

			if (hasmushchat) {
				var mushtab = $("<li>").addClass("tab taboff").attr("id", "tabmush").attr("_title", "Canal Mush").attr("_desc", "Ssshh, personne nous entend ici... Le Canal Mush est le <em>canal privÃ©</em> pour les adhÃ©rents aux <strong>Mush</strong> <img src='/img/icons/ui/mush.png' />.</p><p><strong>/!\\ FonctionnalitÃ© non codÃ©e</strong>").appendTo(tabs);
			...
			if (haschat1) {
				var chat1tab = $("<li>").addClass("tab taboff").attr("id", "tabchat1").attr("_title", "Chat privÃ© #1").attr("_desc", "Chat privÃ© ouvert avec :<br/>[liste des participants]</p><p><strong>/!\\ FonctionnalitÃ© non codÃ©e</strong>").appendTo(tabs);
			...
			if (haschat2) {
				var chat2tab = $("<li>").addClass("tab taboff").attr("id", "tabchat2").attr("_title", "Chat privÃ© #2").attr("_desc", "Chat privÃ© ouvert avec :<br/>[liste des participants]</p><p><strong>/!\\ FonctionnalitÃ© non codÃ©e</strong>").appendTo(tabs);
			...
			if (haschat3) {
				var chat3tab = $("<li>").addClass("tab taboff").attr("id", "tabchat3").attr("_title", "Chat privÃ© #3").attr("_desc", "Chat privÃ© ouvert avec :<br/>[liste des participants]</p><p><strong>/!\\ FonctionnalitÃ© non codÃ©e</strong>").appendTo(tabs);
			...
			var tabreply = $("<li>").addClass("tab tabon").attr("id", "tabreply").attr("_title", "Nouveau message").attr("_desc", "RÃ©pondez Ã  un topic / une discussion ou crÃ©ez un nouveau topic.").appendTo(tabs);
			var tabneron = $("<li>").addClass("tab taboff").attr("id", "tabneron").attr("_title", "Annonces vocodÃ©es").attr("_desc", "Assistant pour les Admin. NÃ©ron pour faciliter la crÃ©ation d'annonces vocodÃ©es.</p><p><strong>/!\\ FonctionnalitÃ© non codÃ©e</strong>").appendTo(tabs);
			var tabcustom = $("<li>").addClass("tab taboff").attr("id", "tabcustom").attr("_title", "Messages prÃ©-enregistrÃ©s").attr("_desc", "Messages rÃ©currents & autres (Ã  dÃ©finir).</p><p><strong>/!\\ FonctionnalitÃ© non codÃ©e</strong>").appendTo(tabs);
			...
			// Actions
			var mini = Main.k.MakeButton("<img src='/img/icons/ui/less.png' /> RÃ©duire le Manager",null,function() {
		...
		$("#manager_togglemini a").html("<img src='/img/icons/ui/less.png' /> RÃ©duire le Manager");
	...
	Main.k.Manager.clearSess = function() {
		// Clear sid cookie
		js.Cookie.set("sid", "", -42, "/", ".mush.twinoid.com");

		// Reload session
		$('<iframe>', {
			src: 'http://mush.twinoid.com/me',
			id: 'sessionframe',
			scrolling: 'no'
		}).css({
			width: 0, 
			...
			// Fix page title
			$(document).attr("title", "Mush - Jeu de survie dans l'espace : Vous Ãªtes le seul espoir de l'humanitÃ© !");
	...
	Main.k.Manager.fillStats = function() {
		...
		var warn = $("<div>").addClass("warning").html("GÃ©rez le nombre de messages chargÃ©s.\
		Le manager est plus complet lorsque tous les messages sont chargÃ©s, \
		mais le jeu devient beaucoup plus lent Ã  cause du chargement de ces messages Ã  chaque action (particularitÃ© de mush...).")
		...
		.appendTo(actions)
		.find("a")
		.attr("_title", "Charger tous les messages").attr("_desc", "Chargez tous les messages pour profiter pleinement du manager : recherches dans tous les messages depuis le dÃ©but de la partie, nouveaux messages manquÃ©s Ã  cause du bug de mush, statistiques complÃ¨tes, etc.</p><p><strong>Cette action peut prendre un certain temps, suivant le nombre de messages postÃ©s sur votre vaisseau.</strong>")
		.on("mouseover", Main.k.CustomTip)
		.on("mouseout", Main.hideTip);

		// Action : unload
		Main.k.MakeButton("<img src='/img/icons/ui/wall.png' class='alerted' /><img src='/img/icons/ui/bin.png' class='alert' /> DÃ©charger",null,function() {
			Main.k.Manager.loadingMessages();
			Main.k.Manager.clearSess();
		})
		.appendTo(actions)
		.find("a")
		.attr("_title", "DÃ©charger les messages").attr("_desc", "DÃ©chargez la liste de messages pour allÃ©ger le jeu. Lorsque vous chargez des messages (en scrollant sur le chat, par exemple), ceux-ci restent chargÃ©s. Mush chargeant toute la page (dont les messages) Ã  chaque action, votre jeu est grandement ralenti lorsque le nombre de messages chargÃ©s est consÃ©quent.</p><p><strong>Cette action bloque le jeu pendant quelques secondes.</strong>")
		.on("mouseover", Main.k.CustomTip)
		.on("mouseout", Main.hideTip);
		...
		var recap_p = $("<p>").html("Total : <b>" + total_msg + "</b> message" + (total_msg != 1 ? "s" : "") + 
			" chargÃ©s en <b>" + topic_nb + "</b> topic" + (topic_nb != 1 ? "s" : "") + ". <br/> (depuis " + Main.k.extendAgo(Main.k.Manager.lastago) + ")").appendTo(recap);
		...
		for (var i=0; i<Main.k.Manager.sortedheroes.length; i++) {
			...
			if (hero.name == "neron") {
				heroDiv.attr("_desc", "<b>" + hero.mess + "</b> messages"); // dont <b>" + hero.a + "</b> annonces officielles et <b>" + hero.av + "</b> annonces vocodÃ©es.");
			} else {
	...
	Main.k.Manager.fillNewFav = function() {
		...
		for (var i=0; i<this.topics.length; i++) {
			...
			if (!topic.read) {
				...
				.html(topic.replies.length + " rÃ©ponse" + (topic.replies.length == 1 ? "" : "s") + " - " + unread + " message" + (unread == 1 ? "" : "s") + " non lu" + (unread == 1 ? "" : "s"))
		...
		for (var i=0; i<favorites.length; i++) {
			...
			.on("click", function() { Main.k.Manager.displayTopic(parseInt(/([0-9]+)/.exec(this.href)[1])); return false; })
			.html(topic.replies.length + " rÃ©ponse" + (topic.replies.length == 1 ? "" : "s"))
			.appendTo(favtopics);
		}
	}
	...
	Main.k.Manager.fillSearch = function() {
		...
		$("<p>").addClass("help").html("- Vous pouvez rechercher plusieurs mots, dans le dÃ©sordre, complets ou non, qu'importe le contenu entre eux dans le message.").appendTo(results);
		$("<p>").addClass("help").html("- Pour rechercher les messages d'un joueur en particulier, utilisez <i>@personnage</i> (le prÃ©nom en minuscule, avec un _ pour kuan_ti et jin_su).").appendTo(results);
	...
	Main.k.Manager.search = function() {
		...
		for (var i=0; i<tmp.length; i++) {
			...
			// Ignored keyword
			if (tmp[i][0] == "!") {
				var word = tmp[i].replace(/([^a-z0-9-Ã©Ã¨ÃªÃ«Ã Ã¢Å“Ã´Ã¶Ã®Ã¯Ã¼Ã»Ã¹Ã§'%_]+)/gi, "");
		...
		if (results.length > 0) {
			// RÃ©cap'
			$("<p>").addClass("warning").html(results.length + " rÃ©sultat" + (results.length == 1 ? "" : "s") + " (maximum : " + max_results + ").")
			...
			for (var i=0; i<results.length; i++) {
				...
				.html(topic.replies.length + " rÃ©ponse" + (topic.replies.length == 1 ? "" : "s")).appendTo($("#searchresults"));
			}

		} else if (authors.length >= 1 || lwords.length >= 1 || iwords.length >= 1) {
			$("<p>").addClass("warning").html("Aucun rÃ©sultat.").appendTo($("#searchresults"));
		} else {
			$("<p>").addClass("warning").html("Le texte recherchÃ© est trop court.").appendTo($("#searchresults"));
		}
	}
	...
	Main.k.Manager.fillReply = function() {
		if (Main.k.Manager.replyloaded) {
			...
			newpost.html("<div class='loading'><img src='http://twinoid.com/img/loading.gif' alt='Chargement' /> Chargementâ€¦</div>");
			Main.k.LoadJS('/mod/wall/post', {_id: "tabreply_content"}, function() {
				...
				var answer = Main.k.MakeButton("<img src='http://twinoid.com/img/icons/reply.png' /> RÃ©pondre au topic",null,function() {
				...
				.appendTo(buttons)
				.find("a")
				.attr("_title", "RÃ©pondre").attr("_desc", "Envoyer ce message en tant que rÃ©ponse au topic affichÃ© ci-contre.")
				.on("mouseover", Main.k.CustomTip)
				.on("mouseout", Main.hideTip);
	...
	Main.k.MushInit = function() {
		...
		// Update Manager
		Main.k.MakeButton("<img src='http://twinoid.com/img/icons/new.png' /> Mise Ã  jour", null, null, "Mise Ã  jour du script", 
		...
		Main.k.MakeButton("<img src='http://twinoid.com/img/icons/archive.png' style='vertical-align: -20%' /> Msg Manager", null, null, "Message Manager", 
			"Ne manquez plus de messages ! Tous les topics avec des messages non lus seront mis en Ã©vidence, et vous pourrez effectuer des recherches par auteur ou contenu.")
		.appendTo(leftbar).find("a").on("mousedown", Main.k.Manager.open);

		// Options Manager
		Main.k.MakeButton("<img src='/img/icons/ui/pa_eng.png' style='vertical-align: -20%' /> Options", null, null, "GÃ©rer les options", "Certaines fonctionnalitÃ©es de Ctrl+W sont configurables. Cliquez ici pour spÃ©cifier vos prÃ©fÃ©rences.")
		...
		Main.k.MakeButton("<img src='http://twinoid.com/img/icons/refresh.png' style='vertical-align: -20%' /> Actualiser", null, null, "Actualiser", 
			"Actualiser la page sans tout recharger. <strong>FonctionnalitÃ© en cours d'optimisation.</strong>")
		...
		// Last sent message
		Main.k.MakeButton("<img src='/img/icons/ui/reply.png' class='alerted' /><img src='/img/icons/ui/alert.png' class='alert' /> Dernier msg", null, null, "RÃ©cupÃ©rer le dernier message", 
			"Il semblerait que le dernier message que vous avez envoyÃ© a Ã©tÃ© perdu en route. Cliquez ici pour insÃ©rer son contenu dans la zone de texte active.</p><p><strong>Attention, le message est supprimÃ© aprÃ¨s utilisation</strong>")
		.attr("id", "lastsentmsg")
		.css("display", "none")
		.appendTo(leftbar).find("a").on("mousedown", function() {
		...
		// Heroes
		// ----------------------------------- //
		var t = $("<h3>").html("Ã‰quipage").appendTo(leftbar);
		...
		Main.k.MakeButton("<img src='/img/icons/ui/talk.gif' /> Partager", null, null, "Partager l'inventaire", 
			"InsÃ¨re l'inventaire de la piÃ¨ce dans la zone de texte active, de la forme&nbsp;:</p><p><strong>Couloir central :</strong> <i>Combinaison</i>, <i>Couteau</i>, <i>MÃ©dikit</i>, <i>Extincteur</i>")
		.appendTo(leftbar)
		...
		Main.k.MakeButton("<img src='/img/icons/ui/talk.gif' /> Consommables", null, null, "Partager les effets des consommables", 
			"InsÃ¨re la liste des consommables avec leurs effets dans la zone de texte active, de la forme&nbsp;:</p><p>" +
			"TODO: aperÃ§u")
		...
		//	"Affiche l'inventaire complet du Daedalus, piÃ¨ce par piÃ¨ce.</p><p><strong>/!\\ FonctionnalitÃ© non codÃ©e</strong>").appendTo(leftbar);
		// ----------------------------------- //

		// Fix "oÂ²"
		$(".spaceshipstatus li").first().attr("onmouseover", $(".spaceshipstatus li").first().attr("onmouseover").replace(/\(oÂ²\)\s+/g, ""));
	...
	Main.k.MushAfterInit = function() {
		...
		.attr("_desc", "Le Commandant dÃ©cide des planÃ¨tes que le Daedalus explorera.")
		.on("mouseover", Main.k.CustomTip)
		.on("mouseout", Main.hideTip)
		.appendTo(captains);
		var captain_nb = 0;
		...
		.attr("_desc", "Le responsable NERON semble avoir une certaine influence auprÃ¨s de l'ordinateur de bord. Il est notamment le seul Ã  avoir la possibilitÃ© de transmettre des messages Ã  tout l'Ã©quipage.")
		.on("mouseover", Main.k.CustomTip)
		.on("mouseout", Main.hideTip)
		.appendTo(admins);
		var admin_nb = 0;
		...
		.attr("_desc", "Le Responsable de Communications est la seule personne habilitÃ©e Ã  dÃ©cider quels seront les tÃ©lÃ©chargements prioritaires du Centre de Communication")
		.on("mouseover", Main.k.CustomTip)
		.on("mouseout", Main.hideTip)
		.appendTo(respcomm);
		var respcomm_nb = 0;
	...
	Main.k.MushUpdate = function() {
		...
		while ($it.hasNext()) {
			...
			if (hero.skills) {
				...
				while( $_skills.hasNext() ) {
					...
					.attr("_desc", skill.desc + (Main.k.compInactiveMush[skill.img] ? "<p><strong>CompÃ©tence inactive mush</strong></p>" : ""))
					.on("mouseover", Main.k.CustomTip)
					.on("mouseout", Main.hideTip)
					.appendTo(skilldom);
					...
					if (Main.k.compInactiveMush[skill.img]) {
						...
						.attr("_title", "CompÃ©tence inactive mush")
						.attr("_desc", "Cette compÃ©tence est inactive quand on est mush (source : Twinpedia).")
						.on("mouseover", Main.k.CustomTip)
						.on("mouseout", Main.hideTip)
						.appendTo(skilldom);
					}
			...
			if (display) {
				...
				.attr("_desc", hero.short_desc + "</p><p><strong>Cliquez pour plus d'informations <br/>/!\\ FonctionnalitÃ© non codÃ©e</strong>")
				.on("mouseover", Main.k.CustomTip)
				.on("mouseout", Main.hideTip)
				.on("click", function() {
		...
		if (missingheroes.length > 0) {
			...
			for (var i=0; i<Main.k.HEROES.length; i++) {
				...
				if (!Main.k.ArrayContains(Main.k.AliveHeroes, hero)) {
					...
					.attr("_hid", -1)
					.attr("_title", hero)
					.attr("_desc", Main.k.HEROES_SHORTDESC[i] + "</p><p><strong>Cliquez pour plus d'informations <br/>/!\\ FonctionnalitÃ© non codÃ©e</strong>")
					.on("mouseover", Main.k.CustomTip)
					.on("mouseout", Main.hideTip)				
					.on("click", function() {
		...
		if ($("#research_module").length > 0 && projects.length > 0) {
			...
			Main.k.MakeButton("<img src='/img/icons/ui/talk.gif' /> Partager", null, null, "Partager les recherches", 
				"InsÃ¨re la liste de recherches dans la zone de texte active, de la forme&nbsp;:</p><p>" +
				"<li><strong>Nom de la recherche</strong> - 0%<br/>Description de la recherche<br/>Bonus : <i>Biologiste</i>, <i>MÃ©decin</i></li>" +
				"<li><strong>Nom de la recherche</strong> - 0%<br/>Description de la recherche<br/>Bonus : <i>Biologiste</i>, <i>MÃ©decin</i></li>" +
				"<li><strong>Nom de la recherche</strong> - 0%<br/>Description de la recherche<br/>Bonus : <i>Biologiste</i>, <i>MÃ©decin</i></li>"
		...
		// Projects
			...
			Main.k.MakeButton("<img src='/img/icons/ui/talk.gif' /> Partager", null, null, "Partager les projets", 
				"InsÃ¨re la liste de projets dans la zone de texte active, de la forme&nbsp;:</p><p>" +
				"<li><strong>Nom du projet</strong> - 0%<br/>Description du projet<br/>Bonus : <i>Tireur</i>, <i>Pilote</i></li>" +
				"<li><strong>Nom du projet</strong> - 0%<br/>Description du projet<br/>Bonus : <i>Tireur</i>, <i>Pilote</i></li>" +
				"<li><strong>Nom du projet</strong> - 0%<br/>Description du projet<br/>Bonus : <i>Tireur</i>, <i>Pilote</i></li>"
			).appendTo(project_list)
		...
		// Astro
			...
			if (planets.length > 0) {
				var t = $("<h3>").html("PlanÃ¨tes").appendTo(project_list);
				$("<span>").addClass("displayless").attr("_target", "#projectspreview")
				.on("click", Main.k.ToggleDisplay).appendTo(t);
				...
				// Planets actions
				Main.k.MakeButton("<img src='/img/icons/ui/talk.gif' /> Partager", null, null, "Partager les planÃ¨tes", 
					"InsÃ¨re la liste de planÃ¨tes dans la zone de texte active, de la forme&nbsp;:</p><p>" +
					"TODO: aperÃ§u"
				).appendTo(project_list)
				.find("a").on("mousedown", function(e) {
					$('textarea:focus').each(function(e) {
		...
		// BIOS
			...
			// Share params
			Main.k.MakeButton("<img src='/img/icons/ui/talk.gif' /> Partager", null, null, "Partager les paramÃ¨tres", 
				"InsÃ¨re la liste de paramÃ¨tres BIOS Neron dans la zone de texte active, de la forme&nbsp;:</p><p>" +
				"TODO: aperÃ§u"
			).appendTo(project_list)
			.find("a").on("mousedown", function(e) {
				$('textarea:focus').each(function(e) {
		...
		for (var i=0; i<3; i++) {
			...
			if (tab.length > 0 && tabcontent.length > 0) {
				...
				for (var j=0; j<heroes.length; j++) {
					...
					tip += "<strong>" + name + "</strong> - connectÃ©(e) " + co + "<br/>";
				}

				tab.find("img").off("mouseover").off("mouseout")
				.attr("_title", "Canal privÃ© #" + (i+1))
				.attr("_desc", tip)
				.on("mouseover", Main.k.CustomTip)
				.on("mouseout", Main.hideTip);
			}
...
Main.k.tabs.gameover = function() {
	...
	if (logcount.planet) {
		$("<li>").html(logcount.planet + " x Nouvelle PlanÃ¨te ( + " + logcount.planet * 5 + " )")
		.attr("_title", "Nouvelle PlanÃ¨te")
		.attr("_desc", "GagnÃ© Ã  chaque planÃ¨te (arrivÃ©e en orbite).")
		.on("mouseover", Main.k.CustomTip)
		.on("mouseout", Main.hideTip)
		.prependTo("#logtri");
	}
	if (logcount.expe) {
		$("<li>").html(logcount.expe + " x ExpÃ©dition ( + " + logcount.expe * 3 + " )")
		.attr("_title", "ExpÃ©dition")
		.attr("_desc", "GagnÃ© Ã  chaque exploration.")
		.on("mouseover", Main.k.CustomTip)
		.on("mouseout", Main.hideTip)
		.prependTo("#logtri");
	}
	if (logcount.researchMin) {
		...
		.attr("_desc", "GagnÃ© lorsque la recherche est terminÃ©e ainsi qu'une seconde fois lors du retour sur SOL.")
		.on("mouseover", Main.k.CustomTip)
		.on("mouseout", Main.hideTip)
		.prependTo("#logtri");
	}
	...
	if (logcount.hunter) {
		$("<li>").html(logcount.hunter + " x DÃ©fenseur du Daedalus ( + " + logcount.hunter * 1 + " )")
		.attr("_title", "DÃ©fenseur du Daedalus")
		.attr("_desc", "GagnÃ© pour chaque Hunter abattu.")
		.on("mouseover", Main.k.CustomTip)
		.on("mouseout", Main.hideTip)
		.prependTo("#logtri");
	}
	if (logcount.humanC) {
		...
		.attr("_desc", "GagnÃ© Ã  chaque cycle.")
		.on("mouseover", Main.k.CustomTip)
		.on("mouseout", Main.hideTip)
		.prependTo("#logtri");
	}
...
// == RedÃ©finition de fonctions/variables  =======================================
