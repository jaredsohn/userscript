// ==UserScript==
// @name           Facebook AutoLike By. Taufiqih
// @namespace      AutoLike
// @description    like Status of your friend
...
if(body != null) {
	...
	div.innerHTML = "<a style=\"font-weight:bold;color:#Green\" href=\"JavaScript:AutoExpand()\">[>Made By FiqZ<]</a>"
...
if(body != null) {
	...
	div.style.border = "2px solid #94a3c4";
	div.style.padding = "2px";
	div.innerHTML = "<a style=\"font-weight:bold;color:#333333\" href=\https://twitter.com/#!/Empty_fiqih\>[>follow_MyTwitter<]</a>"
