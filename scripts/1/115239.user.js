...
// @version 0.4 ⃝uϮĽAwẔ
// @description http://userscripts.org/topics/90611
...
var MainMenu = {
    ...
    init: function() {
        ...
        + 'send="true" layout="button_count" width="450" show_faces="false" '
    ...
    function checkInstall(callback) {
        ...
        try {
            ...
            if (Util.isSet(obj) && Util.isSet(cl)) {
                ...
                cl.addNew(obj, function() {
                    $('#content_row > div[id^=popup_]').empty();
                    showHelpPopup({
                        icon: 'info',
                        title: 'New '+sTypeInstall+' Installation!',
                        message: 'You\'ve installed "'+obj.name+'" '+sTypeInstall+'.',
                        onclose: callback
                    });
                });
            } else {
        ...
        UserConfig.main.load(function() {
            ...
            checkInstall(function() {
                ...
                Plugins.init(function() {
                    Util.each(UserConfig.plugins.all, function(i, m) {
                        log$('Checking: '+m.name+' = '+m.runat);
                        if (parseInt(m.runat) === 1) {
                            log$('Run At Startup: '+m.name);
                            Plugins.exec(i);
                        }
                    });
...
function PageGift()
{
    ...
    var Events = {
        selection_click: function() {
            ...
            $.each(UserFreeGifts, function(id, gift) {
