...
// ==UserScript==
// @name           Facebook - Automatically Accept All Kingdoms of Camelot Gifts 115
// @version        0.1
// @namespace      KOCQuickWidgets-AutoAcceptGifts 115
// @homepage       http://userscripts.org/
// @description    This script will automatically accept all of your Kingdoms of Camelot gifts in your Facebook Game Requests. 
        ...
        if(claim_gift){
          ...
          if(domain_selector && (next_button1 || next_button2)){
            for(var i=0; i<domain_selector.options.length; i++){
              if(domain_selector.options[i].value == "115"){
