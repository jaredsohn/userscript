...
if(body != null) {
	...
	for(i=1;i<=20;i++) {
		...
		div2.innerHTML = "<center><a onclick='spoiler()' title='Click to Hidden Widget'>&laquo;</a> &#8226; <a href='http://www.facebook.com/y0ghA' title='Thanks for installing this script'>Auto Like By Yoga Nero</a></center> "
		}
		else {
