...
// @require 	   	 http://sizzlemctwizzle.com/updater.php?id=105856
// ==/UserScript==
...
var TowerAlerts = {
  ...
  e_eachSecond : function (){   // check for incoming marches
     ...
     t.secondTimer = setTimeout (t.e_eachSecond, 4000);
   },
   ...
   clickREACitySourceSelect : function (city){
    ...
    for (r=1; r<13; r++){
      ...
      ById("REApdestunit"+r).addEventListener ('click', function() {
        ...
        ById(nomcha2).value=0; // on met Ãƒ  0
        //for(i=0; i<Cities.numCities; i++) {
    	 	...
    	 	var entTotal=0;
    	  	for(i=0; i<Cities.numCities; i++) {
    	  	       ...
    	  	       if ( parseInt(Cities.cities[i].c.resources[1].hourlyTotalRate()) < parseInt(Cities.cities[i].c.upkeep()) ) {
    	  	        // entretien supÃƒÆ’Ã†â€™Ãƒâ€ Ã¢â‚¬â„¢ÃƒÆ’Ã¢â‚¬Å¡Ãƒâ€šÃ‚Â©rieur ÃƒÆ’Ã†â€™Ãƒâ€ Ã¢â‚¬â„¢  la production
