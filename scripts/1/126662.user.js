// ==UserScript==
// @name           FocalPrice.com  Vista Previa Imagen Grande 
// @namespace      EdgarT
// @include        http://*.focalprice.com/*
// ==/UserScript==
...
// preview: http://img.focalprice.com/155x120/HA/HA0022/HA0022Y.jpg
// full:    http://img.focalprice.com/348x270/HA/HA0022/HA0022Y.jpg
...
function showPopupPic(e) {
	try {
		...
		//if (t.tagName == 'IMG') { newSrc = t.src.replace("155x120", "348x270"); } //TAMAÑO MEDIANO
		if (t.tagName == 'IMG') { newSrc = t.src.replace(/[0-9]+x[0-9]+/, "860x666"); } //860x666 TAMAÑO GRANDE
