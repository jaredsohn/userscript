// ==UserScript==
// @name            HF Script - HF Post Help Docs Helper P1
// @namespace       Yellows/hfhelpdocshelperP1
// @description     Adds additional phrases from the Help Docs that can be used in posts to assist members. P1
