	...
	else
	{
		if(opt == 'Attack')
		{
			...
			if(Gtimer.innerHTML == "0.0") 
			{
				...
				document.getElementById("status").value = "LolWut...";
			} else {
				document.getElementById("status").value = "Beatin' Off...";			
			}
		}
		else if(opt == 'Forage')
		{
...
function nextLevel() {
	...
	if (!set1) {	
		var exp1 = document.createElement('div');
			...
			exp1.style.color =  "#FFFFFF";
			exp1.innerHTML =  levelIn + " experience is required for " + playername + " to reach level " + levelUp + ".";
			document.getElementById("content").appendChild(exp1);	
	} else {
			set1.innerHTML = levelIn + " experience is required for " + playername + " to reach level " + levelUp + ".";
	}	
...
var welcome = document.createElement('span');
		welcome.innerHTML = "Turkey for " + playername + ", turkey for you, I love turkey in a big brown shoe! =3 <br /><br />";		
...
var footer = document.getElementById("footer");		
	footer.innerHTML = "YOU SEE NOTHING!!!";
