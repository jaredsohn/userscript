// ==UserScript==
// @name           DC Card Necklace
// @namespace      http://userscripts.org/users/26909
// @description    Puts your card necklaces into your display case
...
switch(window.location.pathname){
	case "/managecollection.php":
		...
		if(x=getElementsByXPath('//form[@name="addgoodies"]//option[(@value="2016") or (@value="2018") or (@value="1995") or (@value="2017") ]')){
