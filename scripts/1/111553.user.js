// ==UserScript==
// @name           	BBCode-Edit Pennergame *edit by Bengy* 
// @namespace      	11235813 *edit by Bengy* 
// @description    	Erweiterter BB-Code Editor *Centerstyle* mit Vorschaufunktion + Smileys
// @include        	http://*game*/gang/
// @include        	http://*game*/gang/?force*
// @include        	http://*bumrise*/gang/
// @include        	http://*bumrise*/gang/?force*
...
// @exclude		   	*change*
// @version			1.4 ACHTUNG! Falls ihr nach diesem Update immernoch täglich ein update bekommt, deinstalliert bitte in Greasemonkey alle Scripte die sich BBCode-Edit nennen und installiert anschließend das ganze nochmal neu! Wer nicht weiß wie das geht, kontaktiert mich bitte auf userscripts! 
// ==/UserScript==
...
//==========================================================//
//
// @version			1.3 Funktioniert jetzt in der Bündnis-SB und lädt beim Seitenwechseln neu mit, danke an We1nachtsmann!!!
// @version			1.2 Paar neue Smileys , youtube- und ref-Button entfernt 
// @version			1.1 Centerstyle, Smileys (aus)sortiert (ACHTUNG: alte Smileys werden komplett Ueberschrieben!), Farbauswahlfenster gefixt
...
editor.addSmilie('http://www.greensmilies.com/smile/smiley_emoticons_mrcool.gif');
...
editor.addSmilie('http://www.greensmilies.com/smile/smiley_emoticons_thumbs-down_new.gif');
...
editor.addSmilie('http://www.greensmilies.com/smile/smiley_emoticons_baeh.gif');
...
editor.addSmilie('http://www.greensmilies.com/smile/smiley_emoticons_hypnoaugen.gif');
...
editor.addSmilie('http://www.ich-mags.eu/images/like-it.png');
