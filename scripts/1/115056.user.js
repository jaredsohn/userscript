...
// @description	  Various Tweaks For Fetlife, Including Ad-Killers,  Unprotectors, List Makers And Mass Messagers
...
killme = document.getElementsByClassName("protect_pic large_pic"); for(var i=0;i<killme.length;i++)killme[i].style.display="none";
killme = document.getElementsByClassName("pic"); for(var i=0;i<killme.length;i++)killme[i].style.display="none";
