...
";
   ...
   var credit = "[b]Visit www[i].[/i]orkut[i].[/i]com[i]/[/i]CommunityJoin[i].[/i]aspx?cmm=38669425 [/b]"; // It will make me happy if you put this line while posting in communities however its not necessary to put in it.
