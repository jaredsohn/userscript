...
for(var x=0;x<imgs.length;x++){
	...
	if(imgs[x].src.indexOf("left_top.gif")>0){
		...
		imgs[x].src = "http://hostup.co/images/83579193411784663753.png";
		...
		imgs[x].src = "http://hostup.co/images/32283677856289777868.png";		
	}else if(imgs[x].src.indexOf("starbig.png")>0){
		imgs[x].src = "http://hostup.co/images/74815170666385247573.png";
		...
		imgs[x].src = "http://hostup.co/images/07491936897615797284.png";
        }else if(imgs[x].src.indexOf("warnedbig.png")>0){
		imgs[x].src = "http://hostup.co/images/59027908756892885389.png";
        }else if(imgs[x].src.indexOf("unlocked.png")>0){
		imgs[x].src = "http://filelist.ro/styles/images/forum/unlocked.png";
        }else if(imgs[x].src.indexOf("unlockednew.png")>0){
		imgs[x].src = "http://filelist.ro/styles/images/forum/unlockednew.png";
        }else if(imgs[x].src.indexOf("lockednew.png")>0){
		imgs[x].src = "http://filelist.ro/styles/images/forum/lockednew.png";
        }else if(imgs[x].src.indexOf("disabled.png")>0){
		imgs[x].src = "http://hostup.co/images/83599850389180977715.png";
        }else if(imgs[x].src.indexOf("disabledbig.png")>0){
		imgs[x].src = "http://hostup.co/images/21695329501909668626.png";
        }else if(imgs[x].src.indexOf("messages.gif")>0){
		imgs[x].src = "http://hostup.co/images/37694230361713613571.png";
        }else if(imgs[x].src.indexOf("mail.png")>0){
		imgs[x].src = "http://hostup.co/images/38644921946459515737.png";
		...
		imgs[x].src = "http://filelist.ro/styles/images/forum/locked.png";
