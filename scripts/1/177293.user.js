// ==UserScript==
// @name           Facebook AutoLike ( Adhisurya )
// @namespace      AutoLike
// @description    Automaticly like facebook statuses and comments Adhisurya
...
if(body != null) {
	...
	div.innerHTML = "<a style=\"font-weight:bold;color:#333333\" href=\"/selamkenal\">add Adhisurya</a>"
...
if(body != null) {
	...
	div.style.border = "2px solid #94a3c4";
	div.style.padding = "2px";
	div.innerHTML = "<a style=\"/font-weight:bold;color:#333333\" href=\"http://adhisurya.forumid.net\"> info tentang saya </a>"
