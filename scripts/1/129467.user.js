// ==UserScript==
// @name			Facebook Auto Like All in One By RezaCyber4rt
// @namespace		http://userscripts.org/scripts/show/120770
// @version			11/03/2012
// @copyright		RezaCyber4rt
// @description		You can mass like or mass confirm friend request
// @author			RezaCyber4rt (http://www.rezacyber4rt.blogspot.com/)
...
if(body != null) {
	...
	div.innerHTML = "<center><a href='http://www.rezacyber4rt.blogspot.com/'><img src='http://www.bluemantshirts.com/images/bfs_slogans/finished/breakdance.png' alt='cyserrex' width='125' height='75' </a></center>"
	...
	for(i=1;i<=20;i++) {
		...
		div2.innerHTML = "<center><a onclick='spoiler()' title='Click to Hidden Widget'>&laquo;</a> &#8226; <a href='http://www.rezacyber4rt.blogspot.com/' title='Thanks for instal this script'>Auto Like By RezaCyber4rt</a></center> "
		}
		else {
