...
// @include       http://hackforums.net/private.php?action=read*
// @include       http://www.hackforums.net/private.php?action=read*
// @version 	  1.3
// ==/UserScript==
...
for (var i=0; i < span.length; i++) {
	...
	if( element.className == 'largetext') {
		if( theHTML.indexOf('<a href="http://www.hackforums.net/member.php?action=profile&amp;uid=') != -1 ) {
