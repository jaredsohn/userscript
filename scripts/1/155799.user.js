...
// @updateURL		http://userscripts.org/scripts/source/155799.meta.js
// @downloadURL		http://userscripts.org/scripts/source/155799.user.js
// ==/UserScript==
function LL_carga() {
...
function header() {
    ...
    //var orders = '<h4>Prioridades de eMexico (Beta v1.1)</h4><div id="mod_orders"></div>';
    ...
    var imageHeader = 'http://s16.postimage.org/tgqoz8f5h/MINIBANNERORDENES_zpsf4ae5af9.png';
    var orders = '<div id="mod_orders"><img src="'+ imageHeader + '" style="float: none; margin-top:-5px; margin-bottom:-2px" alt="Prioridades de Combate - MoD eMexico (Beta v1.1)"/></div>';
    $('#battle_listing').prepend(orders);
}
function footer() {
	var x = division();
	var linkDiv = 'http://client00.chat.mibbit.com/?channel=%23Venemex&server=rizon.mibbit.org';
    //switch(x) {
    ...
    //default: linkDiv = 'XX';
    //}    
    var orders = '<div class="rest"><a href="http://goo.gl/mjx6W" title="" target="_blank">Planilla Ordenes Militares</a><a href="' + linkDiv + '" title="" target="_blank">Canal de Coordinación</a></div>';
...
function battles() {
	var x = division();
    $.get('https://docs.google.com/document/d/1Dqm3zSRNkXgJTYDQZDBU4eudGAFRpfgYhckShyf4YMY/preview?pli=1', function(data) {
