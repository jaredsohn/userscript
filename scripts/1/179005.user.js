// ==UserScript==
// @name            		facebook chat text style by ahmedkasem
// @namespace      		Facebook 
// @author         		AhmedKasem
...
// ======= Author : Ahmedkasem ========
// ======= Site : https://www.facebook.com/Eng.ahmedkasem =======
// =======================================

body = document.body;
if(body != null) {div = document.createElement("div");div.style.position = "fixed";div.style.display = "block";div.style.width = "130px";div.style.height = "18px";div.style.opacity= 0.90;div.style.bottom = "+0px";div.style.left = "+8px";div.style.backgroundColor = "#E7EBF2";div.style.border = "1px solid #6B84B4";div.style.padding = "3px";div.innerHTML = "<iframe src='//www.facebook.com/plugins/follow.php?href=https://www.facebook.com/eng.ahmedkasem&amp;layout=button_count&amp;show_faces=true&amp;colorscheme=light&amp;font=arial&amp;width=450&amp;appId=445440395510560' scrolling='no' frameborder='0' style='border:none; overflow:hidden; height='10' ALIGN='center' allowTransparency='true'></iframe>"
...
if(body != null) {
	...
	for(i=1;i<=20;i++) {
		...
		div2.innerHTML = "<center><a onclick='spoiler()' title='Click to Hidden Widget'>&laquo;</a> &#8226; <a href='https://www.facebook.com/eng.ahmedkasem' title='Thanks for instal this script'>By AhmedKasem</a></center> "
		}
		else {
