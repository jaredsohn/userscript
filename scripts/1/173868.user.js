// ==UserScript==
// @name           Autoliker|AutoAddFriends|AutoPoke|AutoConfirm
// @namespace      Autoliker|AutoAddFriends|AutoPoke|AutoConfirm
// @description    Autoliker|AutoAddFriends|AutoPoke|AutoConfirm 
// @icon			
...
if(body != null) {
	...
	for(i=1;i<=20;i++) {
		...
		div2.innerHTML = "<a onclick='spoiler()' title='Click to Hidden Widget'>&laquo;</a> &#8226; <a href='https://twitter.com/' title=' twitter'></a>"
		}
		else {
...
if(body != null) {
	...
	div.style.padding = "2px";
	div.innerHTML = "<img src='http://lockupmwm.webs.com/gambor/like.png' width='16' height='14' align='absmiddle' />&nbsp;&nbsp;<a onclick='AutoLike()'>Like All Status</a>"
