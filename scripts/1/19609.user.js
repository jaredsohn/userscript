// ==UserScript==
// @name Travian: Beyond_LT
// @author Victor Garcia (aka Croc), Szabka, HaxLi
// @namespace  T3
// @version 2.6cmc
// @description  Travian v3 addons originally written by Victor Garcia (aka Croc) updated by Szabka and some changes by HaxLi
...
function funcionPrincipal(e){
	...
	var version = "2.6c modded by Szabka, HaxLi";
	var storeurl = '';
    var LOG_LEVEL = 0;
   	
    // Lithuania translation by HaxLi (Žygis); Skype: zygisb
    var lang_lt = new Array();
	lang_lt['MAXTIME']	= 'Max. laikas';
	lang_lt['LOGIN']	= 'Login';
	lang_lt['ALIANZA'] 	= 'Ally';
	lang_lt['PERFIL'] 	= 'Žaidėjo profilis';
	lang_lt['SIM'] 		= 'Mušio sim.';
	lang_lt['CALC'] 	= 'Skaičiuotuvas';
	lang_lt['SEGURO'] 	= 'Ar tikrai?';
	lang_lt['MARK'] 	= 'viską';
	lang_lt['PERDIDAS'] 	= 'Nuostoliai';
	lang_lt['SUBIR_NIVEL'] 	= 'NETRŪKSTA';
	lang_lt['RENT'] 	= 'Nauda';
	lang_lt['JUGADOR'] 	= 'Žaidėjas';
	lang_lt['ALDEA'] 	= 'Gyvenvietės pavadinimas';
	lang_lt['HAB'] 		= 'Populiacija';
	lang_lt['COORD'] 	= 'koordinatės';
	lang_lt['ACCION'] 	= 'Veiksmas';
	lang_lt['ATACAR'] 	= 'Pulti';
	lang_lt['COMERCIAR'] 	= 'Siųsti resursų';
	lang_lt['GUARDADO'] 	= 'Išsaugota';
	lang_lt['DESP_ABR'] 	= 'Per.';
	lang_lt['FALTA'] 	= '';
	lang_lt['HOY'] 		= 'ŠIANDIEN';
	lang_lt['MANYANA'] 	= 'RYTOJ';
	lang_lt['PAS_MANYANA'] 	= 'PORYT';
	lang_lt['MERCADO'] 	= 'Turgus';
	lang_lt['CUARTEL'] 	= 'Kareivinės';
	lang_lt['PUNTO'] 	= 'Susibūrimo vieta';
	lang_lt['CORRAL'] 	= 'Sostinė';
	lang_lt['TALLER'] 	= 'Dirbtuvės';
	lang_lt['ENVIAR'] 	= 'Siųsti resursus';
	lang_lt['COMPRAR'] 	= 'Pirkti';
	lang_lt['VENDER'] 	= 'Parduoti';
	lang_lt['ENVIAR_IGM'] 	= 'Siųsti PM';
	lang_lt['LISTO'] 	= '';
	lang_lt['EL'] 		= 'on';
	lang_lt['A_LAS'] 	= '»';
	lang_lt['EFICIENCIA'] 	= 'Užpildymas'; 
	lang_lt['NUNCA']	= 'Niekada';
	lang_lt['PC']           = 'kultūros taškai';
	lang_lt['FUNDAR']       = 'You can found or conquer a new village';
	lang_lt['ALDEAS']       = 'Village(s)';
	lang_lt['ENV_TROPAS'] 	= 'Mūšis';
	lang_lt['RECURSO1']     = 'Mediena';
	lang_lt['RECURSO2']     = 'Molis';
	lang_lt['RECURSO3']     = 'Geležis';
	lang_lt['RECURSO4']     = 'Grūdai';
	lang_lt['TIEMPO']       = 'Laikas';
	lang_lt['COMP']         = 'Klaidos';
	lang_lt['STAT']		= 'Statistika';
	lang_lt['OFREZCO']	= 'Siūloma';
	lang_lt['BUSCO']	= 'Ieškoma';
	lang_lt['TIPO']		= 'Filtras';
	lang_lt['DISPONIBLE']	= 'Tik pasiekiamus';
	lang_lt['CUALQUIERA']	= 'Any';
	lang_lt['SI']		= 'Taip';
	lang_lt['NO']		= 'Ne';
        lang_lt['MARCADORES']   = 'Nuorodos';
        lang_lt['ANYADIR']      = 'Pridėti';
        lang_lt['ENLACE']       = 'Nuorodos adresas';
        lang_lt['TEXTO']        = 'Nuorodos tekstas';
	lang_lt['ELIMINAR']	= 'Trinti';
	lang_lt['MAPA']		= 'Žemėlapis';
	lang_lt['CHECK']	= 'Tikrinti naują versiją';
	lang_lt['ARCHIVE']	= 'Archyvas';
	lang_lt['RESUMEN']	= 'Santrauka';
  lang_lt['TOOL']         	= 'Statistika';
  lang_lt['TCALC'] = 'Travel calc';
	...
	lang_en['UPGRADE'] 			= 'Upgrade';
	lang_en['UPGRADET'] 		= 'TTQ Upgrade';
    lang_en['TOOL']         	= 'Toolbox';
    lang_en['WARLOG']         	= 'Travilog';
    ...
    function log(level, msg) {
       if (level <= LOG_LEVEL) {
          if (console != undefined) {
             console.log(msg);
             if (storeurl!='')
               gmAjaxRequest(storeurl,"POST","cmd=log&namespace="+server+"_"+uid+"&msg="+encodeURIComponent(msg),function (r){});
          }
       }
    }
           ...
           necesario[i]=necesario[i]-0;
			...
			if (restante > 0){
				...
				if (tiempo < 0 || total[i]-necesario[i]<0) {
                    tiempo_max = 'Infinity';
                    res_table += '<tr><td><img class="res" src="' + img('r/' + (i+1) + '.gif') + '" title="' + T('RECURSO' + (i+1)) + '"></td><td align="right" id="timeout' + i + '">' + restante + ' </td><td align="right" width="54"> ' + T('NUNCA') + '</td></tr>';
                } else {
                   if (tiempo > tiempo_max && tiempo_max !='Infinity') {
                      tiempo_max = tiempo;
                   }
                   tiempo = formatear_tiempo(tiempo+5);
                   res_table += '<tr><td><img class="res" src="' + img('r/' + (i+1) + '.gif') + '" title="' + T('RECURSO' + (i+1)) + '"></td><td align="right" id="timeout' + i + '">' + restante + ' </td><td align="right" id="timeout" width="54"> ' + tiempo + '</td></tr>';
                }
			}
//            log(1,"v3 t:"+total[i]+" n:'"+necesario[i]+"' r:"+restante+ " tn:"+tiempo_max);
		...
		if (tiempo_max == 'Infinity'){
           // Soha nem lesz eleg nyertanyag szoveg.
            a = '<table cellspacing="1" cellpadding="0" align="left" style="color: #808080">'+res_table+'<tr><td colspan="3" align="right"><b>' + T('NUNCA')+ '</b></td></tr><tr><td colspan="3">&nbsp;</td></tr></table></table>';
            ...
            // tl.
            a = '<table cellspacing="1" cellpadding="0" align="left" style="color: #808080">'+res_table+'<tr><td colspan="3" align="right"><b>' + calcularTextoTiempo(fecha)+ '</b></td></tr><tr><td colspan="3">&nbsp;</td></tr></table>';
		}
//       log(1,a);
		return a;
	}
	...
	function calculateFillTime(){
		...
		for (var i = 0; i < 4; i++){
            ...
            celda.setAttribute("style","font-size:10px; color:#909090; text-align:left; padding-left: 20px;");
            celda.setAttribute("colspan","2");
            celda.setAttribute("valign","top");
            log(1,"tiempoRestante: "+tiempoRestante);
...
//			if (a.nodeName == '#text') a = a.previousSibling;
	...
	function quickLinks(){
		...
		var links = [	0,
				...
				[T('SIM'), "http://kirilloid.ru/travian/warsim.php", "_blank"],
//				0,
...
//				[T('UPGRADET'), "http://www.nmprog.hu/travian/traviantaskqueue.user.js", "_blank"],
				...
				[T('MAPA'), "http://travmap.shishnet.org/", "_blank"],
        [T('TCALC'), "http://www.javaschubla.de/2006/travian/wegerechner/wegerechner-t3i.html?lang=en", "_blank"],
				[T('WARLOG'), "http://logs.travianas.lt/"+idioma+"/", "tr3_travilog"],
//				[T('UPGRADE'), "http://www.nmprog.hu/travian/travian3beyond.user.js", "_blank"],
...
//                    td.setAttribute("rowspan","5");
					...
					if (restante != null) { 
                       ...
                       td3.innerHTML = '<font color=#808080><b>' + T('SUBIR_NIVEL') + '</b></font><br/><br/>&nbsp;';
                    }
				}
			}
		}
...
//				buildingCode = parseInt(buildingCode[0].substring(1, buildingCode[0].length));
				...
				if (buildingCost[buildingCode] != null && buildingCost[buildingCode][buildingLevel+1] != null){
					...
					else td3.innerHTML = '<font color=#808080><b>' + T('SUBIR_NIVEL') + '</b></font><br/><br/>&nbsp;';
				}
			}
		}
...
//            log(1,"base: "+base+" i:"+i+" d:"+d+" despli:"+despl[i]+" zval:"+zval);
	...
	function desplazarMapa(){
		...
		var d = getOption("desp",3,"integer");
...
//          fila.appendChild(elem("TD", "<input type='text' name='" + parametros[i] + "' value='" + (valor != null ? valor : '') + "' class='fm' style='width:275px;'/>"));
          ...
          tdimg.addEventListener("click", function() {var inpo=get('i'+this.id);  createCookie(inpo.name,inpo.value,function (r) { if (r == "ok" ) {alert(inpo.name+' '+T('GUARDADO'));}});},0);
...
/*       var p = document.createElement("P");
	...
	function crearEventoRecursosCasilla(href){
		...
		return function(){ timeout = setTimeout(function(){ ajaxRequest(href, "GET", null, procesarCasilla, dummy); }, 300); };
	}
