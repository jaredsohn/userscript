...
function letsJQuery()
{
    $(document).ready(function () {
        ...
        var transferBaiduData = function(id,lng,lat,status){
            ...
            if((n_lng == '118' || n_lng == '118' || n_lng == '0') & (n_lat == '31'|| n_lat == '32'|| n_lat == '0')){
        ...
        function getLocalData(){
            $.getJSON("http://10.207.0.240/jsapi.php?type=getshop&city=nanjing&callback=?",function(data){
                    var data = eval(data);
