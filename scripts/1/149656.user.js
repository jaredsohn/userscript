// ==UserScript==
// @name        MyEpisodes.com Links to NZBMatrix
// @namespace   http://userscripts.org/users/416433
// @description It Creates Links next to each episode and season to search at NZBMatrix
...
// let it search on NZBMatrix

// Version 1.0

// Fixed search attributes in link
var searchAttributes = "";
// Node Text
var SearchText = "NZB";
// Search Url
var SearchURL = 'http://nzbmatrix.com/nzb-search.php?search=';
...
if(seasonHeaders.length>0){
   ...
   table.innerHTML+="<tbody><tr class='header' align='center'><td style='border-bottom: 1px solid black;'>" + SearchText + "</td></tr><tr align='center'><td><a href='"+ createSimpleSearchURL(showName) +"' target='_blank' class='flatbutton'>Search</a></td></tr></tbody>";
...
function getTPBcell(linkURL, fadeLink){
   ...
   link.appendChild(document.createTextNode(SearchText));
   if(fadeLink){
...
function createSimpleSearchURL(searchterm){
   var url = SearchURL + searchterm + searchAttributes;
   return url;
}
