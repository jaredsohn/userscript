// ==UserScript==
// @name           DLeague Challenge Season 37
// @namespace      GLB_Chris465
// @description    Collect the stats for the DLeague Challenge, Season 37, TE.
// @include        http://goallineblitz.com/game/home.pl
// ==/UserScript==
//

// Only variable to be modified.
var playerList = [4502258,4502329,4499231,4494369,4502501,4500654,4497911,4502777,4503081,4499555,4503038,4503095,4503248,4503332,4502573,4500500,4503453,4503732,4504109,4504246,4500047,4502448,4504644,4504682,4504874,4503359,4505244,4505439,4505740,4502641,4506277,4504323,4505988,4505671,4506030,4506082,4505741,4502768,4505061,4506337,4506740,4506444,4506468,4506948,4503958,4507336,4507544,4506510,4508176,4502414,4498821,4508508,4508464,4503944];
...
//var statTypes = ["Receiving","Rushing","Offensive Line","Defense"];
var statTypes = ["Receiving","Rushing","Offensive Line"];
//var statTypes = ["Defense","Special Teams"];
//var statTypes = ["Passing","Rushing"];
...
var headings = [];
headings["Receiving"] = ["Plays","Targ","Rec","Yds","YAC","TD","Drop","Fum"];
headings["Rushing"] = ["TFL"];
headings["Offensive Line"] = ["Pancakes","RevPnkd","HryAlw","SackAlw"];
...
points["Receiving"] = ["0","0","1","0.1","0.1","6","-2","-4"];
points["Rushing"] = ["-2"];
points["Offensive Line"] = ["1.25","-1.25","-0.5","-4"]
//safety = 4

var agents = [];
agents["4502258"]="PsychoWard"; 
agents["4502329"]="groganite";
agents["4499231"]="joe";
//agents["4502391"]="Runnin'Ute"; Closed
agents["4494369"]="F8n4tune";
//agents["4506012"]="CyberNinja"; League 10
//agents["4502505"]="Rube"; retired league 9 or 10
agents["4502501"]="Football Mom";
agents["4500654"]="SikoraP13 DTD";
agents["4497911"]="spindoctor02";
agents["4502777"]="vladykins";
agents["4503081"]="hokegoalie";
//agents["4498900"]="upsair"; closed
agents["4499555"]="d3v";
agents["4503038"]="an_old_dude";
//agents["4503089"]="Trev O";
agents["4503095"]="MissingNola";
agents["4503248"]="InRomoWeTrust";
agents["4503332"]="jpjn94";
agents["4502573"]="no14mike";
agents["4500500"]="dlcurt";
agents["4503453"]="Longhornfan1024";
agents["4503732"]="ProfessionalKop";
agents["4504109"]="Little M";
agents["4504246"]="Jay Gold";
agents["4500047"]="AlBarsch";
agents["4502448"]="ZoSo1";
agents["4504644"]="tragula";
agents["4504682"]="Pena_FIN";
agents["4504874"]="Chris465 DTD";
agents["4503359"]="lexden11";
agents["4505244"]="ninja turtles";
agents["4505439"]="Sabataged";
agents["4505740"]="eglefan72";
agents["4502641"]="Dustin.";
agents["4506277"]="Coutinho";
agents["4504323"]="Boozer";
agents["4505988"]=".spider.";
agents["4505671"]="mikl972";
agents["4506030"]="crazy224";
agents["4506082"]="MileHighShoes";
agents["4505741"]="xhail2skinsx";
agents["4502768"]="rlawrence";
agents["4505061"]="fogie55";
agents["4506337"]="Farlig";
agents["4506740"]="Union Jack Jensen";
agents["4506444"]="Ice Nine";
agents["4506468"]="choco";
agents["4506948"]="mhayes";
agents["4503958"]="tordman";
agents["4503944"]="Ahrens858"; //Closed week 1
agents["4507336"]="briansimoneau";
agents["4507544"]="Loco Moco -Cult-";
//agents["4506409"]="o The Boss x"; Closed
//agents["4507811"]="Fumanchuchu"; League 9
agents["4506510"]="JackBeQuick";
agents["4508176"]="kswetnam";
//agents["4508230"]="yello1"; retired league 9 or 10
agents["4502414"]="Robbnva";
agents["4498821"]="Dave Mr Majors";
agents["4508508"]="hatchman";
agents["4508464"]="Dr. Brawler";
...
function getReceiving(stats) {
	for each (var s in stats) {
		console.log(s["YAC"] + " " + s["Rec"]);
		s["YAC"] = s["YAC"] * s["Rec"];
		console.log(s["YAC"]);
		
	}
	console.log("Get Receiving");
