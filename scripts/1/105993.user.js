...
function loadImages() {
	var u = xpathMany("//div[contains(@class,'post')]//img");
	var viewer = new PhotoViewer();
	for (var i = 0; i < u.snapshotLength; i++){
		viewer.add(u.snapshotItem(i).src);
	}
	viewer.show(0);
}
...
{/* HACK, commented out: return */};if(n==undefined)
