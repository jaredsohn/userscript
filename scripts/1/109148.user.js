...
javascript: (function () {
/*
	Original script written by Bobby Heartrate
	Lots of mods on the way by many users:
...
*/
	...
	if (/apps.facebook.com.inthemafia/.test(document.location)) {
		...
		if (id = get_id_from_game()) {
			top.location.href = 'http://www.facebook.com/profile.php?id='+id;
			...
			top.location.href = 'http://apps.facebook.com/inthemafia/track.php?next_controller=stats&next_action=view&next_params=%7B%22user%22%3A%22$ID%22%7D'.replace('$ID', id);
		} else {
