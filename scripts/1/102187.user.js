// ==UserScript==
// @name           IW Tower Alert
// @namespace      Tower_Alert
// @include        http://*.kingdomsofcamelot.com/*main_src.php*
// @include        http://apps.facebook.com/kingdomsofcamelot/*
// @description    Incoming Attack Alerts Simple and easy to read
     
// ==/UserScript==


var Version = 'IW Tower Alert (Version 1.0 Released 03-05-2011)';
var Versiondate = '02.05.2011';
var Scriptname = 'IW Tower Alert';
var ScriptTabName = 'IW Tower Alert';
...
var Tabs = {};
var currentName = 'IW Tower Alert';
...
Tabs.Test = {
  ...
  tabLabel : 'IW Tower Alert Testing',
  myDiv : null,
  ...
  init : function (div){
    ...
    var m = '<TABLE><TR><TD align=right>Scout: </td><TD><INPUT type=checkbox id=pcfakeIsScout></td></tr>\
        ...
        <DIV id=pctestDiv style="background-color:#ffffff; maxwidth:675; maxheight:350px; height:350px; overflow-y:auto;"></div>';
    div.innerHTML = m;
  ...
  createFakeAttack : function (cityNum, isScout, isWild, isFalse, secs, numMilitia){
    ...
    march.players.u1234567.n = 'Hostile';
...
Tabs.Options = {
  tabOrder: 40,
  tabLabel : 'IW Tower Alert Options',
  myDiv : null,
...
var TowerAlerts = {
  ...
  e_eachSecond : function (){   // check for incoming marches
	...
	postToChat: function(m, force){
		...
		if (!force) { 
			if (atkType == 'SCOUT')
				msg = '** THE ENEMY IS SCOUTING MY CITY ** ';
			if (atkType == 'ATTACK')
				msg = '** THE ENEMY IS ATTACKING MY CITY ** ';
		}
	//	msg += 'My Main: ' + aCity + '. ';
		msg += 'Target: ' + target ;
		msg += 'Attacker: ' + who ;
