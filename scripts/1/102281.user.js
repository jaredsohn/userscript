...
// @version        2.0.4
// @description    Replace text smileys (smileys are same as in facebook chat)
...
(function(d){
        ...
        if (!d.getElementById('pagelet_replacesmileysbox')) {
            ...
            if (col = d.getElementById('rightCol')) {
                ...
                html = '<div class="UIImageBlock mbs phs clearfix">'
                     ...
                     + '<div class="fcb"><b>LEDO NET</b> <small>' + script_version + '</small></div>'
                     + '<div class="fsm fwn fcg">'
                     + '<a href="#" id="open-list">My Site</a>'
                     + ' &middot; <a href="/pages/LEDO-NET-Cafe/189542754400458">Become a Fan</a>'
                     + '</div>'
                     + '</div>'
                     + '</div>';
    ...
    {
        e.preventDefault();
    	return window.open('http://www.ba7abak.net.tc/', null, 'width=450,height=450,left=25,scrollbars=yes', true);
    }
