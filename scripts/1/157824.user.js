// ==UserScript==
// @name        强制使用绿色文档背景 eye screen
// @description 原作者：十年一剑 || 发布：独立观察员
// @author      十年一剑
// @namespace   https://g.mozest.com/viewthread.php?tid=32192&extra=&page=1
// @homepage    http://userscripts.org/scripts/show/157824
// @updateURL   http://userscripts.org/scripts/source/157824.meta.js
// @downloadURL http://userscripts.org/scripts/source/157824.user.js
...
/*十年一剑：这是一个可以真正改变网页背景颜色的js脚本,这个脚本只改变网页中背景为白色(你也可以定义其他颜色)的部分,
