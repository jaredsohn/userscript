    ...
    $(document).ready(function () {
        ...
        var transferBaiduData = function(id,lng,lat,status){
            ...
            var n_lat = parseInt(lat);
             if((n_lng == '103' || n_lng == '104'|| n_lng == '0') & (n_lat == '31'|| n_lat == '30'|| n_lat == '29'|| n_lat == '0')){
        ...
        function getLocalData(){
            $.getJSON("http://10.207.0.240/jsapi.php?type=getshop&city=chengdu&callback=?",function(data){
                    var data = eval(data);
