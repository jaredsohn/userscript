// ==UserScript==
// @name       Staff Userscript
// @namespace  Staff Userscript
// @version    1.0
// @description  Checks the ask staff subforums to check for new posts and alerts the user if there are- by osc-rwar/HypnoToad/Gnome
// @include      http://leakforums.org*
// @include      http://*.leakforums.org*
// @updateURL https://userscripts.org/scripts/source/178840.meta.js
// @downloadURL https://userscripts.org/scripts/source/178840.user.js
// @copyright  2013+, Oscar Sanchez
// @icon	http://i.imgur.com/iXRTn0u.png
