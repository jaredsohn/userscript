// ==UserScript==
// @name          Download FB Album by Farshad Fallah
// @version       1
...
var dFAinit = function(){
  ...
  var t = document.querySelector('#userNavigation') || document.querySelector('.dropdown ul');
...
function getPhotos(){
  ...
  var i,elms=g.elms||qS('#album_pagelet')||qS('#static_set_pagelet')||qS('#pagelet_photos_stream')||qS('.fbStarGrid')||qS('#group_photoset'),
