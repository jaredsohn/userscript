// ==UserScript==
// @name           KOC Power Bot
// @version        _empowerTRAINbot009a_
// @namespace      mat
// @homepage       http://userscripts.org/scripts/show/11596
...
var Version = '_empowerTRAINbot009a_';
...
// end test switches
	...
	var Options = {
	  ...
	  pbWideMap    : false,
	  pbFoodAlert  : false,
	  alertConfig  : {aChat:true, aPrefix:'** Cookie Thief!!! **', scouting:true, wilds:true, defend:true, minTroops:1, spamLimit:10, lastAttack:0, barbautoswitch:false, raidautoswitch: {}, },
	  ...
	  spamconfig   : {aspam:false, spamvert:'ONE for Me!!', spammins:'1', atime:2 , spamstate:'a'},
	...
	************/
	...
	Tabs.ActionLog = {
	  ...
	  init : function (div){
		...
		t.myDiv = div;
		t.myDiv.innerHTML = '<DIV class=pbStat>ONE Log: '+ Version+'</div><DIV style="height:535px; max-height:535px; overflow-y:auto">\
	...
	Tabs.AutoTrain = {
	  ...
	  init: function(div){
		...
		var m = '<DIV class=pbStat>AUTO SPEED TRAIN</div><TABLE width=100% height=0% class=pbTab><TR><TD width=200></td>';
	  ...
	  helpPop : function (){
		var helpText = '<BR><DL><dt>Autotrain:<dd><LI>Toggle the box in front of the row to enable autotrain for that city (the number is the citynumer).</dd>\
			...
			<dt>Turn it on: </dt>\
			  <dd><LI>Hit the AutoTrain toggle button. Speed/Gamble Train will be auto activated at 4x resources cost</dd></ul>';
		var pop = new CPopup ('giftHelp', 0, 0, 550, 250, true);
		pop.centerMe (mainPop.getMainDiv());  
		pop.getMainDiv().innerHTML = helpText;
		pop.getTopDiv().innerHTML = '<CENTER><B>Power Bot Help</b>:  Auto Speed Train</center>';
		pop.show (true);
	  },
	...
	Tabs.Spam = {
	 ...
	 e_spamOptChanged : function (){
	  ...
	  if(parseInt(Options.spamconfig.spammins) < 0){
