// ==UserScript==
// @name LinkFoCC// @namespace  Miembros y foro y cc

// @description Agrega el link en la barra izquierda  CC y Foro
...
{
  var aff_newVersion =' <li><span class="menu_icon"></span><a class="menubutton" target="parent_"  href="'+lien+'" accesskey="" target="_parent"><span class="textlabel">'+nom+'</span></a></li>';
var tableau = document.createElement("span");
tableau.innerHTML = aff_newVersion;
document.getElementById('MAJ gal').insertBefore(tableau,document.getElementById('MAJ gal').firstChild);
}

 afficheLeftMenu ( 'Correo Circular', 'http://s122-es.ogame.gameforge.com/game/index.php?page=alliance&tab=broadcast') ; //
