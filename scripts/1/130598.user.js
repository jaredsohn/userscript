...
(function(){
    ...
    var lucky_star_collection=[
      ...
      //兔鱼妹
    var tym_collection_name='兔鱼妹';
    var tym_collection=['http://hiphotos.baidu.com/%C7%A7%C4%EA%B5%C4%B3%D9%B5%BD/pic/item/0190718264b66a9df11f36d7.jpg',
...
'http://hiphotos.baidu.com/sostuanyuan/pic/item/229f1d8bc9177f3edeff9ead70cf3bc79e3d5628.jpg'
    ...
    setTimeout(function(){
        ...
        fun_UserDefinedSmiley(zf_collection_name, zf_collection, 'tab24', 'tab_24');
        fun_UserDefinedSmiley(lucky_star_collection_name, lucky_star_collection, 'tab25', 'tab_25');
		fun_UserDefinedSmiley(tym_collection_name, tym_collection, 'tab26', 'tab_26');
		fun_UserDefinedSmiley(konata_collection_name, konata_collection, 'tab27', 'tab_27');
		fun_UserDefinedSmiley(mr_star_collection_name, mr_collection, 'tab28', 'tab_28');
    }, 0);
