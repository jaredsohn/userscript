// ==UserScript==
// @name           SRDotDX - wpatter6/JHunz/Warfust
// @namespace      tag://kongregate
// @description    Easier Kongregate's Dawn of the Dragons
// @author         SReject, chairmansteve, JHunz, wpatter6, Warfust
// @version        0.1.7.1
// @date           09.16.2012
...
// if any1 needs a simple way to calculate damage: atk*4+def+legionpower*5
	...
	window.SRDotDX = {
		...
		raids: {
			...
			krykagrius:{name: 'Krykagrius', shortname: 'Krykagrius',  id: 'krykagrius', stat: 'ESH', size:90000, duration:96, health: ['Unlimited','Unlimited','Unlimited','Unlimited','Unlimited','Unlimited'],loottiers: [['1','1M','5M','10M','20M','50M','100M','150M','300M','450M','600M','750M','1B','2B','3B','4B','5B','10B','15B','20B'],[],[],[],[],[]]},
		...
		raidArray: [ "agony","djinn","animated_armor","spider","rhino","gladiators","bellarius","werewolfpack",
			...
			"hydra","ironclad","kang","3dawg","kessovtowers","kessovforts","kessovcastle","krykagrius","kalaxia","tyranthius",
