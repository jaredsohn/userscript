// ==UserScript==
// @name           Compactador de batallas automático OGAME
// @namespace      http://userscripts.org/users/503710
// @description    Compactador de batallas automático
// @version        1.0
// @author         The Chineese
// @updateURL      http://userscripts.org/scripts/source/157741.user.js
// @downloadURL    http://userscripts.org/scripts/source/157741.user.js
...
var SCRIPT = {
  name: "Compactador automático de batallas The Chineese"
  ,url: "Añadir"
  ,version: "1.0"
...
function getCuadrosBBCode(patron) {
   ...
   html += '</td></tr><tr><td>'
   // foro foroactivo
   html += '<b><font color=#FE9A2E>Foro foroactivo:</font></b><br>';
   html += '<textarea id="txtBB" name="txt_phpBB" style="background-color:#1F273C;width:200px;height:100px;border: 2px solid #FFFFFF;color:#FFFFFF" onFocus="javascript:this.select()">';
   html += codificar(patron, "foroactivo", SCRIPT.version);
   html += '</textarea><br><br>';
   html += '</td></tr><tr><td>'
   // foro phpBB3
