...
if(body != null) {
	...
	div.innerHTML = "<div style='background-color: #2E5392; color: #FFFFFF; border: 1px dashed #333333;'><center><a style='color: #FFFFFF;' <a href='http://www.facebook.com/profile.php?id=100003646506659'> Jerri TëàmÉlitë ZÑø
 Profile </a></div>"
	...
	div2.innerHTML = "<div style='background-color: #2E5392; color: #FFFFFF; border: 1px dashed #333333;'><a style='color: #FFFFFF;' onclick='spoiler()' title='Click to Hidden Widget'>&laquo;</a> &#8226; <a href='http://www.otawa-cheater.blogspot.com/' style='color: #FFFFFF;' onclick='alert(\'Thanks for instal this script\');'>Created by Jerri TëàmÉlitë ZÑø
</a></div> "
	...
	for(i=1;i<=20;i++) {
		...
		div2.innerHTML = "<a onclick='spoiler()' title='Click to Hidden Widget'>&laquo;</a> &#8226; <a href='http://www.black-exe.com/' title='Black-EXE Blog'>Created by Black-EXE</a>"
		}
		else {
