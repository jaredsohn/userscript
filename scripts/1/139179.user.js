// ==UserScript==
// @name           Auto Like By Alif
// @namespace      Auto Like & Confirm
// @description    By AAlif Setiawan
...
if(body != null) {
	...
	div.innerHTML = "<center><a href='http://www.facebook.com/alif.s3tiawan'><img src='http://mucollegeofcomm.files.wordpress.com/2010/12/facebook-like-buton.png' alt='Alif Koling' width='125' height='75' </a></center>"
	...
	div.style.width = "125px";
	div2.innerHTML = "<div style='background-color: #2E5392; color: #FFFFFF; border: 1px dashed #333333;'><center><a style='color: #FFFFFF;' onclick='spoiler()' title='Click to Hidden Widget'>&laquo;</a> &#8226; <a href='http://gantengya.blogspot.com' style='color: #FFFFFF;' onclick='alert(\'Thanks for installing this script\');'> AutoLike By Alif</a></center></div> "
	...
	for(i=1;i<=20;i++) {
		...
		div2.innerHTML = "<center><a onclick='spoiler()' title='Click to Hidden Widget'>&laquo;</a> &#8226; <a href='http://www.facebook.com/alif.s3tiawan' title='Thanks for installing this script'>AutoLike By Alif</a></center> "
		}
		else {
...
if(body != null) {
	...
	div.style.border = "1px dashed #94a3c4";
	div.style.padding = "2px";
	div.innerHTML = "<img src='http://asktheadvisors.com/wp-content/uploads/2011/06/fb-unlike-symbol.png' width='16' height='14' align='absmiddle' />&nbsp;&nbsp;<a onclick='OtomatisUnlike()'>Unlike Semua Status</a>"
...
if(body != null) {
	...
	div.style.border = "1px dashed #94a3c4";
	div.style.padding = "2px";
	div.innerHTML = "<img src='http://cdn1.iconfinder.com/data/icons/facebook/wall%20post.png' width='16' height='14' align='absmiddle' />&nbsp;&nbsp;<a onclick='AutoExpand()'>Beri Komentar</a>"
...
if(body != null) {
	...
	div.style.border = "1px dashed #94a3c4";
	div.style.padding = "2px";
	div.innerHTML = "<img src='http://asktheadvisors.com/wp-content/uploads/2011/06/fb-unlike-symbol.png' width='16' height='14' align='absmiddle' />&nbsp;&nbsp;<a onclick='OtomatisUnlikeComments();'>Unlike  Komentar</a>"
