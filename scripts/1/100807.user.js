// ==UserScript==
// @name           StatScript
// @description    Stat Script for Uni2 SFC// @version        1.2
...
crystaltotal = Comma(eval(parseInt(GM_getValue("crystal0", 0))+parseInt(GM_getValue("crystal46", 0))+parseInt(GM_getValue("crystal51", 0))+parseInt(GM_getValue("crystal6", 0))+parseInt(GM_getValue("crystal11", 0))+parseInt(GM_getValue("crystal16", 0))+parseInt(GM_getValue("crystal21", 0))+parseInt(GM_getValue("crystal26", 0))+parseInt(GM_getValue("crystal31", 0))+parseInt(GM_getValue("crystal36", 0))+parseInt(GM_getValue("ore41", 0))));
...
if (/^http:\/\/uni2.playstarfleet.com\/statistics\//.test(window.location))
{
