...
// @namespace      SWR
// @include        http://speakwhatsreal.com/t.php?id=*
// @include       http://speakwhatsreal.com/u.php?id=*
// @include       http://speakwhatsreal.com/pmv.php?tid=*
// ==/UserScript==
...
holder.innerHTML += '<a href="http://speakwhatsreal.com/f.php?id=19"' +
...
function getNames(){
	...
	{
	    method: 'GET',
	    url: 'http://swrpoker.angelfire.com/',
	    headers: 
		{
