...
var strings = {
	...
	"Next elections in" : "انتخابات بعدي در",
	"No" : "خير",
	"No." : "رديف",
	...
	"Email must be valid for registration, so do not cheat" : "آدرس اي-ميل بايد واقعي باشد زيرا تاييديه‌اي براي آن ارسال خواهد شد، پس تقلب نکنيد" ,
	...
	"Only active conversations from the last 14 days are shown." : "فقط مکالمات فعال را از 14 روز گذشته نشان داده شده است." ,
	"USA Campaigns" : "جنگ هاي ايالات متحده" ,
	"Congratulations" : "تبريک" ,
	"You have successfully bought a land!" : "شما موفق شديد زمين را بخريد" ,
	"OK" : "باشه" ,
	"Select building type" : "انتخاب نوع ساختمان" ,
	"Training Facilities" : "امکانات آموزشي" ,
	"You have built a Grain Farm." : "مزرعه گندم ساخته شد" ,
	"View rank" : "نمايش رتبه" ,
	"Join Poland" : "جنگ براي لهستان" ,
	"Food units" : "واحد مواد غذايي" ,
	"Completed!" : "به پايان رسيد" ,
	"Join Italy" : "جنگ هاي ايتاليا" ,
	"New location" : "مکان جديد" ,
	"Join Slovakia" : "جنگ براي اسلواکي" ,
	"Join Bulgaria" : "جنگ براي بلغارستان" ,
	"Bulgaria Campaigns" : "جنگ هاي بلغارستان" ,
	"Belgium is not involved in any active battles." : "بلژيک در هر جنگ فعال است." ,
	"You have successfully edited your profile" : "شما با موفقيت مشخصات خود را ويرايش کرديد" ,
	"Your password" : "رمز عبور شما" ,
	"only .jpeg pictures allowed" : "فقط عکس با پسوند jpeg مورد قبول است" ,
	"link" : "پيوند" ,
	"Eat" : "خوردن غذا" ,
	"+1 strength" : "+1 قدرت" ,
	"Congratulations for completing your collection!" : "شاد باش مجموعه تو تکميل شده است" ,
	"Saudi …" : "عربستان صعودي" ,
	"Join Slovenia" : "جنگ براي اسلووني" ,
	"Slovenia Campaigns" : "جنگ هاي اسلووني" ,
	"No weapon" : "سلاح موجود نيست" ,
	"Enemy Defeated" : "دشمن شکست خورد" ,
	"New Achievement" : "دستاورد جديد" ,
	"Congratulations, you have worked for 30 days in a row. You earned an achievement." : "تبريک مي گويم شما به مدت 30 روز بدون وقفه کارکرديد ومدال کارگر سخت کوش را گرفتيد." ,
	"Doubles the amount of collected raw materials" : "توليد دو برابر مواد خام" ,
	"Toolbox" : "جعبه ابزار" ,
	"" : "" ,
	"" : "" ,
	"" : "" ,
