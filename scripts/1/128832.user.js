// ==UserScript==
// @name			Emotes for Hellmouth - Avocet
// @author			Alchemist811
// @description			Adds Hellmouth - Avocet members as emotes! 
// @version             1.2
// @versionnumber		1.2
...
// @namespace			
// ==/UserScript==
// I USED MOST OF THIS SCRIPT FROM New Version* Facebook Chat Emoticons by Kayzhen Himura
// IT was not intended to be passed around but for personal use! 
(function(d){
...
// :) :( :D >:( -_- :/ o.O :p :'( >:O :v 3:) :o :3 ;) :* :|] 8) <3 :putnam: 8| ^_^ (^^^) O:) <(") :42:
    ...
    ProfileImgURL = HttpsOn?'https://graph.facebook.com/':'https://graph.facebook.com/';
...
// Hellmouth - Avocet
    '[[580537693]]', '580537693/picture', // Felise an amazing first ;D
	'[[100001093057914]]', '100001093057914/picture' , // Alchemist
	'[[811508231]]', '811508231/picture' , // Jo = sexy button~ 
	'[[100001642261018]]', '100001642261018/picture' , // Shameless Button!
	'[[72106557]]', '72106557/picture' , // Steph changed her pic and made me update my code to become more dynamic >:P
	'[[1399654710]]', '1399654710/picture' , // Chris
	'[[749848112]]', '749848112/picture' , // Leah
	'[[834205359]]', '834205359/picture' , // Daniel fits in a button ;P
	'[[835903221]]', '835903221/picture' , //Tara
	'[[1001341892]]', '1001341892/picture' , //Isabela
	'[[100001210520852]]', '100001210520852/picture' , //Syd = Pure Yummy ;D
	'[[100002525045014]]', '100002525045014/picture' , //Justin
	'[[1468680440]]', '1468680440/picture' , //David 
	'[[100002995542615]]', '100002995542615/picture' , //Coastal Sewer
	'[[100000477586040]]', '100000477586040/picture' , //Shahril Nordin
	'[[1489791676]]', '1489791676/picture' , // Brad
	'[[1356912611]]', '1356912611/picture' , // Sherri
	/*
	'[[]]', '/picture' ,
	'[[]]', '/picture' ,
	'[[]]', '/picture' , 
