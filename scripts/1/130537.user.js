...
// @namespace      Constey
// @version 0.1
// @description    Facebook Leider Geil Button
...
function Universal1(str){
  return str.replace(/gefällt das./g,"findet das leider geil.")
    .replace(/g[Ee][Ff][Ää][Ll][Ll][Tt][ ][Dd][Aa][Ss][Ss][.]/g,"findet das leider geil.")
    .replace(/G[Ee][Ff][Ää][Ll][Ll][Tt][ ][Dd][Aa][Ss][Ss][.]/g,"findet das leider geil.")
}
function Universal3(str){
  return str.replace(/Gefällt mir/g,"Leider geil!")
    .replace(/g[Ee][Ff][Ää][Ll][Ll][Tt][ ][Mm][Ii][Rr]/g,"Leider geil!")
    .replace(/G[Ee][Ff][Ää][Ll][Ll][Tt][ ][Mm][Ii][Rr]/g,"Leider geil!")
}
function Universal2(str){
  return str.replace(/Gefällt mir nicht mehr/g,"Nein Mann!")
    .replace(/g[Ee][Ff][Ää][Ll][Ll][Tt][ ][Mm][Ii][Rr][ ][Nn][Ii][Cc][Hh][Tt][ ][Mm][Ee][Hh][Rr]/g,"Nein Mann!")
    .replace(/G[Ee][Ff][Ää][Ll][Ll][Tt][ ][Mm][Ii][Rr][ ][Nn][Ii][Cc][Hh][Tt][ ][Mm][Ee][Hh][Rr]/g,"Nein Mann!")
}	
