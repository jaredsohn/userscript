// ==UserScript==
// @name            Platypus-scholarships.nmsu.edu/ap
// @namespace       Platypus
// @include         http://scholarships.nmsu.edu/application/application.php
// ==/UserScript==
function do_platypus_script() {
do_modify_html_it(window.document,document.evaluate('/HTML[1]/BODY[1]/DIV[4]/DIV[1]/FORM[1]/TABLE[1]/TBODY[1]/TR[8]/TD[4]', document, null, XPathResult.FIRST_ORDERED_NODE_TYPE,null).singleNodeValue,/2.73/,'2.96',null);
do_modify_html_it(window.document,document.evaluate('/HTML[1]/BODY[1]/DIV[4]/DIV[1]/FORM[1]/TABLE[1]/TBODY[1]/TR[8]/TD[4]', document, null, XPathResult.FIRST_ORDERED_NODE_TYPE,null).singleNodeValue,/2.73/,'2.96',null);
