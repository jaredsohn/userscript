...
// @include        http://www.facebook-games-cheats.co.uk*
...
// @exclude        http://linkc.at/*market.php?*
// @exclude        http://linkc.at/?default_ad*
// ==/UserScript==
			...
			linkbee: {
				...
				run: function(){
					...
					if((o=document.getElementById('urlholder')))
						...
						this.targetUrl=document.title.replace(/(LNK.co|linkc.at|Linkbee)\s*:\s*/,'');
					this.redirect();
				}
			},
                       
                        linkc: {
				rule: /(linkc\.at|lnk\.co)/,
				run: function(){
					var o;
					if((o=document.getElementById('urlholder')))
						this.targetUrl=o.value;
