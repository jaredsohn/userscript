...
for (i = 0; i < uidList.length; i++ ) {
	...
	form += '<select name="reputation" class="bitButton" id="reputation" style="border:1px solid black;" >';
	...
	form += '</select>';
	form += ' <input type="text" class="bitButton" name="comments" size="25" maxlength="250" style="border:1px solid black;" />';
	form += ' <input type="submit" class="bitButton" value="Rate" style="border:1px solid black;" onclick="window.open(\'http://www.hackforums.net/reputation.php\', \'myrepwindow\', \'status=1,width=400,height=350\')"/>';
	form += '</form>';
