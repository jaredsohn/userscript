...
// @author        BiggestFox
// @description   Увеличение имён пользователей на страницах их профилей
// @version       1.0.1
// @license       GNU GPL
...
function processUserProfilePage() {
  if ( /otvety\.google\.ru\/otvety\/user/ .test(window.location.href)) {
   jQuery('.wuvunmCSS').css('font-size', '18pt');
  }
}
...
(function() {
  if (document.readyState == "complete") {
    ...
    window.addEventListener('load', function() { processUserProfilePage(); }, true);
  }
})();