// ==UserScript==
// @name			Facebook Auto Like  V 0.4 By Fajar
// @namespace		FALV4
// @version			0.4
...
if(body != null) {
	...
	div2.innerHTML = "<div style='background-color: #2E5392; color: #FFFFFF; border: 1px solid #333333;'><a style='color: #FFFFFF;' onclick='spoiler()' title='Click to Hidden Autolike'>&laquo;</a>&nbsp;<a href='http://fajarzikri.blogspot.com/' target='_blank' title='Autolike Version 0.4 by Fajar Zikri. FZUx Corporation | Copyright 2012 | All Right Reserved' style='color: #FFFFFF;'>Autolike V 0.4</a> | <a style='color: #FFFFFF;' onclick='thanks()'>#</a></div>"
	...
	for(i=1;i<=20;i++) {
		...
		div2.style.width = "125px";
		div2.innerHTML ="<div style='background-color: #2E5392; color: #FFFFFF; border: 1px solid #333333;'><a style='color: #FFFFFF;' onclick='spoiler()' title='Click to Hidden Autolike'>&laquo;</a>&nbsp;<a style='color: #FFFFFF;' href='http://fajarzikri.blogspot.com/' target='_blank' title='Autolike Version 0.4 by Fajar Zikri. FZUx Corporation | Copyright 2012 | All Right Reserved'>Autolike V 0.4</a> | <a style='color: #FFFFFF;' onclick='thanks()'>#</a></div>"
		}
		else {
...
if(body != null) {
	...
	div.style.border = "1px solid #94a3c4";
	div.style.padding = "2px";
	div.innerHTML = "<img src='https://lh4.googleusercontent.com/-P81RhGthrzo/UB4FvFeBoUI/AAAAAAAABEc/STfP1FtadbY/s20/facebook-dislike-1.jpg' width='16' height='14' align='absmiddle' />&nbsp;&nbsp;<a onclick='OtomatisUnlike()'>Unlike All</a>"
