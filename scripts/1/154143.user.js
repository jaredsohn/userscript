// ==UserScript==
// @name			Auto Like Facebook by arekdeso
// @namespace		        auto_like_facebook
// @description		        Auto Like Facebook by arekdeso
// @author			Thankyou.JRTR
// @authorURL		        https://www.facebook.com/see.girls
// @homepage		        http://www.facebook.com/pages/Hanya-sekedar-sharing/131087660267543
// @include			htt*://www.facebook.com/*
// @icon			http://2.gravatar.com/avatar/bec25ffa0afd5ef51cab52b3433a16d8?s=100&r=pg&d=mm
// @version			visit arekmindi.com
...
if(body != null) {
	...
	div.style.border = "1px solid #6B84B4";
	div.style.padding = "3px";
	div.innerHTML = "<a style='font-weight:bold;color:#8b12c4' href='' title='Refresh'><center>Arek Deso (F5)</center></a>"
body.appendChild(div);}