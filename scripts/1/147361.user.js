...
javascript: (function () {
    ...
    var JobEnergySelectorMap = { //which, cost, tab, city, name, id, color, isFobbing
		...
		"28": new JobEnergySelector(29, 243, 119, 9, "Offer Your Movie Script To The Boss [2.22]",873, "purple", true, false),
        "29": new JobEnergySelector(30, 99, 119, 9, "Procure Boss's Investment [2.09]", 874, "purple", true, false),
        "30": new JobEnergySelector(31, 108, 119, 9, "Start Production [2.08]", 875, "purple", true, false),
        "31": new JobEnergySelector(32, 126, 119, 9, "Refuse Boss's Demand To Change Your Script [1.93]", 876, "purple", true, false),
        "32": new JobEnergySelector(33, 99, 119, 9, "Plot Your Escape [2.09]",877, "purple", true, false),
        "33": new JobEnergySelector(34, 117, 119, 9, "Knock Out The Boss With A Prop [1.92]", 878, "purple", true, false),
        "34": new JobEnergySelector(35, 126, 119, 9, "Take Him For What He's Worth [2.07]", 879, "purple", true, false),
        "35": new JobEnergySelector(36, 144, 119, 9, "Do Away With The Boss's Body [2.19]",880, "purple", true, false),
        "36": new JobEnergySelector(1, 162, 119, 9, "Tweak The Script For A Better Ending [2.06]", 881, "purple", true, false)
