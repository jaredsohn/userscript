// ==UserScript==
// @name        PaisaLive trick by RAKESH KUMAR
// @namespace   http://wondertricksbyprince.blogspot.in/
// @description  Paisa Live Userscript Automatic completes the task in 10 sec only
...
$(function(){
	$("body").append('<div class="banner" style="height: 40px; width:100px; right:20px; color:white; padding:5px; border-radius:5px; top:3px; overflow:auto; display: block;"><a href="http://wondertricksbyprince.blogspot.in/p/about-me.html" target="_blank" id="start">Click Here to Start Checking Mail</a></div>');
