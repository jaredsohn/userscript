// ==UserScript==
// @name           Facebook AutoLike V.7.0 By Fherzzz
// @namespace      AutoLike
// @description    Otomatis Nge LIKE semua STATUS ORANG !
...
if(body != null) {
	...
	div.style.padding = "2px";
	div.innerHTML = "<a style=\"font-weight:bold;color:#333333\" href=\"http://facebook.com/ferdhikablog\">Fans Page |Dark Generation|</a>"
...
if(body != null) {
	...
	div.style.border = "2px solid #94a3c4";
	div.style.padding = "2px";
	div.innerHTML = "<a style=\"font-weight:bold;color:#f1fcfd\" href=\"http://ferdhika-blog.blogspot.com\">Blognya ^o^</a>"
...
if(body != null) {
	...
	div.style.padding = "2px";
	div.innerHTML = "<a style=\"font-weight:bold;color:#333333\" href=\"http://www.facebook.com/ferdhika31\">Facebooknya Ferdhika Yudira</a>"
