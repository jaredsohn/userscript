...
withjQuery(function($)
{
    var me = qzoneFilter = 
    {
        ...
        {   
            ...
            {
                //var $user = me.$ifeeds.find('li.f_single[id^=fct_' + this + ']');
                //$user.remove();
        ...
        {
            var $result = me.$ifeeds.find('.f_single.imgBlock.bor2').has('a.qz_hot_keyword:contains("生日礼物")');
            $result.remove();
        ...
        removeApp : function()
        {
            var $result = me.$ifeeds.find('.f_single.imgBlock.bor2').has('div.f_ct_appfeed');
            $result.remove();
        ...
        removeVote : function()
        {
            var $result = me.$ifeeds.find('.f_single.imgBlock.bor2').has('div.qz_vote');
            $result.remove();
