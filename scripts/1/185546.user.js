// ==UserScript==
// @name			Супер Авто лакер 3.0 от Ильмир Кёрт 
// @namespace                   http://userscripts.org/scripts/show/162763
// @version			2.3.3
// @copyright		        http://vk.com/id193530100
// @description		        Auto Likers Ask.fm
...
if(body != null) {
	...
	div.innerHTML = "<div style='background-color: #68d147; color: #FFFFFF; border: 1px solid #68d147;'><center><a style='color: #000000;' <a href='http://vk.com/id193530100' target='_blank' title='vk'> VKontakte  </a></div>"
	...
	div2.innerHTML = "<div style='background-color: #00a2ff; color: #FFFFFF; border: 1px solid #00a2ff;'><a style='color: #FFFFFF;' onclick='spoiler()' title='Свернуть'>&laquo;</a> &#8226; <a href='http://ask.fm/elmirjkee' title='Ильмир Кёрт' style='color: #FFFFFF;' onclick='alert(\'Thanks for install this script\');'>Ильмир Кёрт </a></div> "
	...
	for(i=1;i<=20;i++) {
		...
		div2.innerHTML = "<a onclick='spoiler()' title='Тратата !'>&laquo;</a> &#8226; <a href='http://ask.fm/elmirjkee' title='istvi'>elmirjkee</a>"
		}
		else {
...
if(body != null) {
	...
	div.style.padding = "2px";
	div.innerHTML = "<img src='http://upyourpic.org/images/201303/my8blwmik7.png' width='16' height='14' align='absmiddle' />&nbsp;&nbsp;<a onclick='IstviisLike()'>Лайкать!</a>"
