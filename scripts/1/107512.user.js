...
var USP = {
    ...
    CSS: ''+
        ...
        '   #US-prefs p{display:block;margin:5px 1px 1em 5px;font-family:arial,sans-serif}\n'+
        '   #US-prefs p>b{font-weight:bold}\n'+
        '   #US-prefs>div{display:block;width:300px;height:450px;margin:0 auto;text-align:center;}\n'+
        '   #US-prefs>div>div{display:block;width:275px;margin:0 auto;text-align:center}\n'+
