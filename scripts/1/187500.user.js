// ==UserScript==
// @name        flnielsen - Command & Conquer TA POIs Analyzer
...
// @author flnielsen
/* @description This script is based on zdoom's POI Analyser, see http://userscripts.org/scripts/show/171353, but taken from his version 1.5.3; the last bug-free version from zdoom.
Many thanks to zdoom for his great work.
// @updateURL https://userscripts.org/scripts/source/187500.meta.js
// @downloadURL https://userscripts.org/scripts/source/187500.user.js
// ==/UserScript==
			...
			qx.Class.define('ccta_pa',
			{
				...
				construct: function()
				{
					try
					{
						...
						var label = new qx.ui.basic.Label("Made by flnielsen.");
							label.set({
