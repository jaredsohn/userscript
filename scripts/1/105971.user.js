// ==UserScript==
// @name           Postar Ações da Moderação Tofe by Thiago
// @description    Postar Ações da Moderação da Comunidade do Café Mania.
// @namespace      SCRIPT
// @include        http://www.orkut.com.br/Main#CommMsgs?cmm=63969357&tid=5486832454735089045
// ==/UserScript==

eval("6930341642114025970");

/* Idéia do Script Por : Joseph
   Update do Script por : Thiago H. */
	...
	function captchaBAN(env) {
		...
		button.onclick = function() {
			if (document.getElementById("cs").value == "") alert("Esqueceu de digitar o captcha!");
				...
				ajax.open("POST", "CommMsgPost?cmm=63969357&tid=5486832454735089045&start=1", false);
