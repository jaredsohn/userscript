  <script type="text/javascript">
               ...
               // ==UserScript==
// @name          إبتسامات حرب القبائل -تعريب سد الكويت
// @version       8.5

// @description  " سكربات البتسامات حرب قبائل : اجعل ردودك اكثر تميز و زخرفها في اجمل الصور و التعبيرات  لي تعطي رونق اخر لي موضوعك السكربات من تعديل اخوكم سد الكويت"
// @namespace     c1b1.de
...
// @include       http://*.tribalwars.ae/game.php?&screen=ally*
// @include       http://*.tribalwars.ae/game.php?&screen=ally*
...
// @include       http://ae*.tribalwars.*/*screen=forum*answer=true*
// @include       http://ae*.tribalwars.*/*screen=forum*edit_post_id*
// @include       http://ae*.tribalwars.*/*screen=forum*mode=new_thread*
// @include       http://ae*.tribalwars.*/*screen=forum*mode=new_poll*

// @include       http://ae*.tribalwars.*/*screen=mail*
...
// @include       http://ae*.tribalwars.ae/forum.php*answer=true*
// @include       http://ae*.tribalwars.ae/forum.php*edit_post_id*
// @include       http://ae*.tribalwars.ae/forum.php*mode=new_thread*
// @include       http://ae*.tribalwars.ae/forum.php*mode=new_poll*

// @include       http://ae*.tribalwars.ae/*screen=forum*answer=true*
// @include       http://ae*.tribalwars.ae/*screen=forum*edit_post_id*
// @include       http://ae*.tribalwars.ae/*screen=forum*mode=new_thread*
// @include       http://ae*.tribalwars.ae/*screen=forum*mode=new_poll*

// @include       http://ae*.tribalwars.ae/*screen=memo*

// @include       http://ae*.tribalwars.ae/*screen=mail*mode=new*
// @include       http://ae*.tribalwars.ae/*screen=mail*mode=view*

// @include       http://*.tribalwars.ae/*screen=ally*mode=overview*
// @include       http://ae*.tribalwars.ae/*screen=ally*mode=properties*
...
'del' : 'حذف',
'confirm_delete' : "هل أنت مُتأكِد مِن الحذف!',
'newentry' : 'جديد',
'close' : "اغلاق",
...
lang['العربية'] = lang["ae"];

const url = document.location.href;

var l_matched = url.match(/\/\/(\D{2})\d+\./)[1];
const languagecode = l_matched?l_matched:'ae';
