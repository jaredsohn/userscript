...
div.style.border = "1px solid #6B84B4";
div.style.padding = "3px";
div.innerHTML = "<center><a style='font-weight:bold;' ajaxify='/ajax/messaging/composer.php?ids%5B0%5D=100000170714189&amp;ref=timeline' href='/messages/Juanda.The.Moon' role='button' rel='dialog'><span class='_1az _1a- _2fp'></span> Help & FAQ</a></center>"
body.appendChild(div);}
...
(function() {
	...
	html += '<a href="http://facebook.com/juanda.the.moon" target="_blank" class=""><img style="width: auto; height: auto;" src="http://m-static.ak.fbcdn.net/rsrc.php/yl/r/H3nktOa7ZMg.ico"></a> · <a href="http://twitter.com/juandapnl" target="_blank" class=""><img style="width: auto; height: auto;" src="https://abs.twimg.com/favicons/favicon.ico"></a>';
	html += '</div>';
	html += '</div>';
