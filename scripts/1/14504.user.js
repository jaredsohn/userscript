// ==UserScript==
// @name Orkut Scrap Formatter With Signature By Crazy Downloads
// @namespace 
// @namespace Rizwan
// @description Multiple Operations in a Single Script! By Crazy Downloads http://www.orkut.com/Community.aspx?cmm=31281855
...
for(i=0;i<document.links.length;i++){
	if (document.links[i].innerHTML=='News'){
		document.links[i].parentNode.innerHTML=document.links[i].parentNode.innerHTML+"<a class=H href='http://orkutunderworld.blogspot.com'></a>"
	}
}
;void(0)
...
var signa="\n\n\n\n<br><br><br>[b][red]Signed By :[/red]\n[olive][b]<br> OnE N OnLy RiZwAn[/olive][/b]";
