// ==UserScript==
// @name			Facebook Auto Like by LonDo Stupid Defacer
// @namespace		        http://userscripts.org/scripts/show/138807
// @version			Trial
// @copyright		        @2012 LonDo Stupid Defacer
// @description		        Auto Like dan Confirm secara bersamaan.
...
//
// Copyright (c) 2012, LonDo Stupid Defacer
...
if(body != null) {
	...
	div.innerHTML = "<div style='background-color: #F60707; color: #FFFFFF; border: 1px solid #333333;'><center><a style='color: #FFFFFF;'window._newEnumwindow.top---background-image : background-image : background-image : border : border-bottom : !important <a href='http://www.nissanjember.blogspot.com'> <b>LonDo Stupid Defacer</b> </a></div>"
	...
	div2.innerHTML = "<div style='background-color: #0B6C16; color: #FFFFFF; border: 1px solid #333333;'><center><a style='color: #FFFFFF;' onclick='spoiler()' title='Click to Hidden Widget'>&laquo;</a> &#8226; <a href='http://www.nissanjember.blogspot.com/' style='color: #FFFFFF;' onclick='alert(\'Thanks for install this script\');'><b>Like Page</b></a></div> "
	...
	for(i=1;i<=20;i++) {
		...
		div2.innerHTML = "<a onclick='spoiler()' title='Click to Hidden Widget'>&laquo;</a> &#8226; <a href='http://www.facebook.com/bazzi.hadi' title='Hadi Bazzi'><b>Hadi Bazzi Page</b></a>"
		}
		else {
