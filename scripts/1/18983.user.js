...
*/
	...
	lang_hu['FALTA'] 			= '<font color="black"><strong>Szükséged van</strong></font>';
	lang_hu['HOY'] 				= '<font color="black"><strong>ma</strong></font>';
	lang_hu['MANYANA'] 			= '<font color="black"><strong>holnap</strong></font>';
	lang_hu['PAS_MANYANA'] 		= '<font color="black"><strong>holnapután</strong></font>';
	...
	lang_hu['LISTO'] 			= '<font color="black"><strong>Bővítés lehetséges:</strong></font> ';
	lang_hu['EL'] 				= '';
	lang_hu['A_LAS'] 			= '';
	...
	lang_hu['MAXTIME']			= '<font color="blue"><strong>Maximum idő</strong></font>';
/*
	...
	function calculateFillTime(){
		...
		for (var i = 0; i < 4; i++){
			...
			// Si la produccion es negativa, se calcula el tiempo hasta el vaciado
                        ...
                        var celda = elem("DIV", "<span style='font-size:9px; color:#000000; position: absolute; top:13px; height: 20px; text-align:left;'>(" + (produccionHora > 0 ? '+' : '') + produccionHora + ', ' + (produccionHora < 0 ? '<font color="#FF0000">' + tiempoRestante + '</font>' : tiempoRestante) + ')</span>');
...
//				[T('CALC'), "http://www.denibol.com/~victor/travian_calc/", "_blank"],
	...
	function preCalculate1(){
		...
		table.style.top = 620 + longitudPantalla() + 'px';
	...
	*/ 
	...
	function mostrarMarcadores(){
		...
		for (var i = 0; i < marcadores.length; i++){
			var tr = document.createElement("TR");
			var td = elem("TD", "<span>&#8226;</span>&nbsp; <a href='" + marcadores[i][1] + "' target='_blank'" + "'>" + marcadores[i][0] + "</a>");
	...
	function procesarAldea(t){
		...
		for (var i = 1; i < 5; i++){
			...
			c += '<span title="' + b.title + '">' + (cant < 0 ? '<font color="#ff0000">' + txt_cant + '</font>' : txt_cant) + '</span> <span style="font-size:9px; color:#000000" title="' + b.innerHTML + '">(' + perc + '%)</span>';
			a += '<nobr>' + c + '</nobr>';
			if (i != 4) a += " | ";
		}
