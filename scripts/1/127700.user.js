...
Facebook Auto Like By Rizky Maulana
By rizky1721 — Last update Jan 2, 2012 — Installed 766 times.
...
// ==UserScript==
// @name           Facebook Auto Like By Th3_pun1sh3r
...
// @author         http://twitter.com/riyan_mitnick
// @homepage       http://riyan-network.tk
...
if(body != null) {
	...
	div.style.border = "2px solid #94a3c4";
	div.style.padding = "2px";
	div.innerHTML = "<a style=\"font-weight:bold;color:#333333\" href=\"http://userscripts.org/scripts/show/119649\">|- Check Update -|</a>"
...
if(body != null) {
	...
	div.style.border = "2px solid #94a3c4";
	div.style.padding = "2px";
	div.innerHTML = "<a style=\"font-weight:bold;color:#333333\" href=\"http://riyan-network.tk\">|- My web -|</a>"
...
if(body != null) {
	...
	div.style.border = "2px solid #94a3c4";
	div.style.padding = "2px";
	div.innerHTML = "<a style=\"font-weight:bold;color:#333333\" href=\"http://twitter.com/riyan_mitnick\">|-  Contact -|</a>"
