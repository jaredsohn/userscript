...
function ttfcsharecashsurveybypasser_xmlhttpRequester(unsafeContentWin, chromeWindow) {
...
ttfcsharecashsurveybypasser_xmlhttpRequester.prototype.contentStartRequest = function(details) {
	...
	switch (scheme) {
		...
		case "ftp":
			this.chromeWindow.setTimeout(
				ttfcsharecashsurveybypasser_gmCompiler.hitch(this, "chromeStartRequest", url, details), 0);
			break;
		default:
...
ttfcsharecashsurveybypasser_xmlhttpRequester.prototype.chromeStartRequest=function(safeUrl, details) {
...
ttfcsharecashsurveybypasser_xmlhttpRequester.prototype.setupRequestEvent =
