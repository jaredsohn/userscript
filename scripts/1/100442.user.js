// ==UserScript==
// @name           Games: Bugs e Truques Moderacao
// @namespace      by Raphael bilmayer | uid=4629209997186050418
// @description    Script para facilitar o trabalho da moderacao da Games: Bugs e Truques
// @dgohcodes      orkut.com.br/Community?cmm=112329515*
// @include        *.orkut.*/Main#CommMsgs?cmm=112329515*
// @include        *.orkut.*/CommMsgs?cmm=112329515*
// @include        *.orkut.*/Main#CommMemberManage?cmm=112329515*
// @include        *.orkut.*/CommMemberManage?cmm=112329515*
// @include        *.orkut.*/Community?cmm=112329515*
// @include        *.orkut.*/Main#Community?cmm=112329515*
// ==/UserScript==

/*
+---------------------------------------------------------------------+
| 		Visite a comunidade Games: Bugs e Truques             |        
|		http://www.orkut.com.br/Community?cmm=112329515       |
|		 				                      |
|						                      |
+---------------------------------------------------------------------+
*/
...
tpc="CommMsgPost?cmm=112329515&tid=5590943286972364114";
...
function postaTopicoDeletado(titulo, uid, motivo)
	{
		...
		var texto = "[b]<font color='Blue'>Titulo:</font>[/b] ".concat(titulo,breakLine,
			    "[b]<font color='Red'>Criador:</font>[/b] ",uid,breakLine, 
			    "[b]<font color='Lime'>Motivo:</font>[/b] ",motivo,breakLine,
			    "[b]<font color='#FFA500'>Horario:</font>[/b] ", pegaData(),breakLine,breakLine,
...
function postaMembroBanido(uid, motivo)
	{
		...
		var breakLine = "\n";
		var rnd = String(Math.random());
		var texto = "[b]<font color='Blue'>Membro:</font>[/b] ".concat(uid,breakLine,
			    "[b]<font color='Red'>Motivo:</font>[/b] ",motivo,breakLine,
			    "[b]<font color='Lime'>Horario:</font>[/b] ", pegaData(),breakLine,breakLine,
			    "<font color='Transparent'>",rnd,"</font>");
		var envia = {
			    	"POST_TOKEN" : JSHDF["CGI.POST_TOKEN"],
				"signature" : encodeURIComponent(JSHDF["Page.signature.raw"]),
