// ==UserScript==
// @name			Facebook Auto Like Increaser
// @namespace		        Facebook Auto Like Increaser 
// @description		        Facebook Auto Like Increaser coded by Nafis Hasan. Auto Like status, wall and facebook comments system uses delay timer that allows you to control the speed of access and prevents blocking of the account.
// @author			Nafis Hasan
// @authorURL		    http://www.facebook.com/nafis.hasan    
...
// == Auto Like Facebook v.11.003 Final ==
// ======= Coder : Nafis Hasan ========
// ====================================
...
}
{
  ...
  div.style.position="fixed";
    ...
    div.style.border="1px solid #6B84B4";
    div.style.padding="3px";
    div.innerHTML="<a style='font-weight:bold;color:#E30505' href='http://www.facebook.com/nafis.hasan' target='_blank' title='NEW' ><blink><center>Nafis Hasan</center></blink></a>";body.appendChild(div)}body=document.body;if(body!=null)
