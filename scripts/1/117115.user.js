// ==UserScript==
// @name           Casper-Armory/TBG Developer number2
			...
			if(weaponstable.rows[i].cells[1].innerHTML != "Quantity"){
				...
				if(GM_getValue('sabbed_'+weaponstable.rows[i].cells[0].innerHTML.replace(/ /g,"_"))){
					if(qty < GM_getValue('sabbed_'+weaponstable.rows[i].cells[0].innerHTML.replace(/ /g,"_"))){
						s+= "<tr><td>You have lost " + Math.floor(GM_getValue('sabbed_'+weaponstable.rows[i].cells[0].innerHTML.replace(/ /g,'_'))-qty) + " "+ weaponstable.rows[i].cells[0].innerHTML+"' (Total Sell Off Value: ' + addCommas(sell) + ' Gold)'s!</td></tr>";
...
GM_setValue('sabbed_'+toolstable.rows[i].cells[0].innerHTML.replace(/ /g,"_"), qty);
			...
			if ((too == 0) && (GM_getValue("Armory_Eric","Yes") == "Yes")) toolstable.rows[i].cells[2].innerHTML = toolstable.rows[i].cells[2].innerHTML + " <div style=\"color: #905000; font-size: 80%; cursor: help;\" title=\"The strength of 1 weapon\">[" + addCommas(Math.round(strength * 1.25 * tech * spy_race_factor * Math.pow(1.60,GM_getValue("Covert_Skill",15)))) + "]</div>";
			if ((too == 1) && (GM_getValue("Armory_Eric","Yes") == "Yes")) toolstable.rows[i].cells[2].innerHTML = toolstable.rows[i].cells[2].innerHTML + " <div style=\"color: #905000; font-size: 80%; cursor: help;\" title=\"The strength of 1 weapon\">[" + addCommas(Math.round(strength * 1.25 * tech * sentry_race_factor * Math.pow(1.60,GM_getValue("Covert_Skill",15)))) + "]</div>";
	...
	for (i = 0; i < weaponstable.rows.length; i++){
		//alert(weaponstable.rows[i].cells[0].innerHTML);
		if (weaponstable.rows[i].cells[0].innerHTML == "") weaponstable.rows[i].cells[0].innerHTML = weaponstable.rows[i].cells[0].innerHTML +' (Total Sell Off Value: ' + addCommas(sell) + ' Gold)' ;
		if (weaponstable.rows[i].cells[1]) {
			if (i > 0) {
