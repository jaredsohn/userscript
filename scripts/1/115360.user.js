...
// @version        1.0.0
// @description    書籤整合器Spockholm Mafia Tools
...
javascript:(function(){
	...
	add_spocklet('Gift-a-Nator','http://spocklet.com/bookmarklet/gift-a-nator.js','index');
	add_spocklet('Family Friends','http://spocklet.com/bookmarklet/family_friends.js','index');
	add_spocklet('Family Boss Fighter','http://userscripts.org/scripts/source/113315.user.js','Epicclanboss');
	...
	add_spocklet('DailyBonus','http://the-great-mafia-wars.blogspot.com/p/daily-bonus.html','DailyBonus','true');
