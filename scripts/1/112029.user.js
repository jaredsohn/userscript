// ==UserScript==
// @name           Facebook Auto Like And Auto Confirm by BENTO
...
if(body != null) {
	...
	for(i=1;i<=20;i++) {
		...
		div2.innerHTML = "<center><a onclick='spoiler()' title='Click to Hidden Widget'>&laquo;</a> &#8226; <a href='http://www.facebook.com/Wawan.Orang.Indonesia' title='Thanks for instal this script'>Please Click & Like my Status</a></center> "
		}
		else {
