...
// @include        http://*.bbsr-maql.jp/facility/castle_send_troop.php*
// @include        https://*.bbsr-maql.jp/facility/castle_send_troop.php*
// @description    <内蔵版>ブラウザバサラ 領地敵兵算出機（全ワールド対応） by Craford, BSE（原版作者 きょう）（Cal1.3.7）＋賊討伐シミュレータ by きの。 (ver 1.05a) edit byV
// @author         Craford,kino.,BSE,base_Kyou
// @version        1.3.8 + 1.05a+1.0
// ==/UserScript==
...
(function(){
		...
		if(season>0){
			...
			msg = msg + "このスクリプトはブラ三用を改悪したものです。苦情・文句・情報提供などは受け付けません<br>\n";
