	...
	if(prefs.dropDownList.horizontal){
		...
		//网页搜索/////////////第一个可以当模板看///////////////////////////////////////////////////////////////////////////////
			{name:"google网页搜索",			//你要加载的网站的名字(方便自己查找)
				...
				//在哪个网站上加载,正则.
				url:/^https?:\/\/\w{2,10}\.google(?:\.\D{1,3}){1,2}\/(?!music\/)+[^?]+(?:.(?!&tbm=)(?!&hl=en))+$/i,
...
//---------------------------------------------------------------
			{name:"google en网页搜索",
				enabled:true,
				url:/^https?:\/\/\w{2,10}\.google(?:\.\D{1,3}){1,2}\/(?!music\/)+[^?]+(?:.+&hl=en.+(?!&tbm=))+$/i,
				engineList:"web",
				style:'\
					border-bottom:1px solid #E5E5E5;\
					border-top:1px solid #E5E5E5;\
			...
			{name:"维基百科",
				url:/^https?:\/\/.+\.wikipedia\.org\/wiki\/.+/i,
				enabled:true,
				engineList:"web",
				style:'\
					padding-left:5px;\
...
//翻译/////////////////////////////////////////////////////////////////////////////////////////
			...
			{name:"Dictionary",
				url:/^https?:\/\/dictionary\.reference\.com\/browse/i,
				enabled:true,
				engineList:"translate",
				style:"\
					margin-left:152px;\
