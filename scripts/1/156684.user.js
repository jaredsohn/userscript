		...
		function createClasses()
		{
			...
			qx.Class.define("Simulator", 
			{
				...
				construct: function()
				{
					...
					{						
						...
						optionBtn = new qx.ui.form.Button("Опции");
						optionBtn.set
						({
							alignY: "middle", 
							width: 60,
							height: 28,
							toolTipText: "Открывает настройки симулятора",
							appearance: "button-text-small"
						});
						...
						statBtn = new qx.ui.form.Button("Меню");
						statBtn.set
						({
							alignY: "middle", 
							width: 60,
							height: 28,
							toolTipText: "Открывает/Закрывает меню симулятора",
							appearance: "button-text-small"
						});
						...
						layoutBtn = new qx.ui.form.Button("Сейвер");
						layoutBtn.set
						({
							alignY: "middle", 
							width: 60,
							height: 28,
							toolTipText: "Сохранение/Загрузка/Удаление расположений войск для данной базы",
							appearance: "button-text-small"
						});
						...
						unlockCmtBtn = new qx.ui.form.Button("Снять");
						unlockCmtBtn.set
						({
							alignY: "middle",
							width: 50,
						...
						unlockRTBtn = new qx.ui.form.Button("Снять");
						unlockRTBtn.set
						({
							alignY: "middle",
							width: 50,
						...
						({
							...
							width: 30,
							height: 20,
							toolTipText: "Смещение всех войск вверх",
							appearance: "button-text-small"
						});
						...
						({
							...
							width: 30,
							height: 20,
							toolTipText: "Смещение всех войск вниз",
							appearance: "button-text-small"
						});
						...
						({
							...
							width: 30,
							height: 20,
							toolTipText: "Смещение всех войск влево",
							appearance: "button-text-small"
						});
						...
						({
							...
							width: 30,
							height: 20,
							toolTipText: "Смещение всех войск вправо",
							appearance: "button-text-small"
						});
						...
						mirrorBtn = new qx.ui.form.Button("З");
						mirrorBtn.set
						({
							alignY: "middle",
							width: 35,
							height: 35,
							toolTipText: "Расположение войск в зеркальном отражении",
							appearance: "button-text-small"
						});
						...
						({
							...
							width: 35,
							height: 35,
							toolTipText: "Активирует/Деактивирует все войска",
							appearance: "button-text-small"
						});
						...
						({
							...
							width: 35,
							height: 35,
							toolTipText: "Возвращает к предыдущей позиции расположения войск",
							appearance: "button-text-small"
						});
						...
						quickSaveBtn = new qx.ui.form.Button("БС");
						quickSaveBtn.set
						({
							alignY: "middle",
							width: 35,
							height: 35,
							toolTipText: "Сохраняет текущее расположение войск не заходя в Сейвер (не работает на других базах)",
							appearance: "button-text-small"
						});
						...
						var replayStatBtn = new qx.ui.form.Button("Меню");
						replayStatBtn.set
						({
							width: 50,
							height: 24,
							appearance: "button-text-small",
							toolTipText: "Открывает меню симулятора"
						});
					...
					{
						console.log("Ошибка запуска настроек симулятора: " );
			...
			qx.Class.define("Simulator.StatWindow", 
			{
				...
				construct: function()
				{
					...
					var enemyHealthTitle = new qx.ui.basic.Label("Повреждения базы").set({ alignX: "center", alignY: "top", font: "font_size_14_bold"});
					...
					var eHLabelOverall = new qx.ui.basic.Label("Общее:");
					var eHLabelBase = new qx.ui.basic.Label("База:");
					var eHLabelDefense = new qx.ui.basic.Label("Защита:");
					var eHLabelCY = new qx.ui.basic.Label("СЦ:");
					var eHLabelDF = new qx.ui.basic.Label("ОЦ:");
					...
					var pRLabelStorage = new qx.ui.basic.Label("Всего:");
					var pRLabelOverall = new qx.ui.basic.Label("Затраты:");
					...
					var miscTitle = new qx.ui.basic.Label("Результат атаки").set({ alignX: "center", alignY: "top", font: "font_size_14_bold"});
					...
					var miscOutcome = new qx.ui.basic.Label("Исход:");
					...
					var battleLootTitle = new qx.ui.basic.Label("Полученные ресурсы").set({ alignX: "center", alignY: "top", font: "font_size_14_bold"});
					...
					battleLootTib.setToolTipText("Тибериум");
					battleLootCry.setToolTipText("Кристалы");
					battleLootCred.setToolTipText("Деньги");
					battleLootRP.setToolTipText("Исследования");
					battleLootTotal.setToolTipText("Общее");
					...
					simStatBtn = new qx.ui.form.Button("Запуск").set({allowGrowX: false});
					simStatBtn.setToolTipText("Обновить данные");
					simStatBtn.addListener("click", this.simulateStats, this);
					
					simReplayBtn = new qx.ui.form.Button("Повтор").set({allowGrowX: false});
					simReplayBtn.setToolTipText("Показать повтор последней симуляции");
				...
				members: 
				{
					...
					getSimulationInfo: function(data)
					{
						...
						try
						{
							...
							if (allOffHP == 0)
							{
								 this.__labelMiscOutcome.setLabel("Поражение");
					...
					disableSimulateStatButtonTimer: function(timer)
					{
						...
						{
							console.log("Ошибка отключения кнопки");
							console.log(e.toString());
						}
					}
				}
			...
			qx.Class.define("Simulator.OptionWindow", 
			{
				...
				construct: function()
				{
					...
					var genPage = new qx.ui.tabview.Page("Основные");
					...
					this._buttonLocCB = new qx.ui.form.CheckBox("Справа");
					this._buttonSizeCB = new qx.ui.form.CheckBox("Обычный вид");
					...
					this._disableRTBtnCB = new qx.ui.form.CheckBox("Блокировка ремонта");
					...
					this._disableCmtBtnCB = new qx.ui.form.CheckBox("Блокировка атаки");
					...
					this._autoSimulateCB = new qx.ui.form.CheckBox("Автозапуск симуляции");
					...
					var statsPage = new qx.ui.tabview.Page("Меню");
					...
					var statWindowTitle = new qx.ui.basic.Label("Главное окно:");
					...
					this._autoOpenCB = new qx.ui.form.CheckBox("Автозапуск");
					...
					var repairSecTitle = new qx.ui.basic.Label("Отображение времени ремонта (ВР):");
					...
					var repairDisplayOpt1 = new qx.ui.form.RadioButton("C/ВР");
					var repairDisplayOpt2 = new qx.ui.form.RadioButton("HP/ВР");
					var repairDisplayOpt3 = new qx.ui.form.RadioButton("Только ВР");
					...
					var hideSecTitle = new qx.ui.basic.Label("Свернуть секции (при запуске):");
					...
					this._hideHealthCB = new qx.ui.form.CheckBox("База");
					this._hideRepairCB = new qx.ui.form.CheckBox("Ремонт");
					this._hideMiscCB = new qx.ui.form.CheckBox("Атака");
					...
					var statPosTitle = new qx.ui.basic.Label("Зафиксировать окно симулятора:").set({alignY: "middle"});
					statPosTitle.setFont("bold");
					var statPosBtn = new qx.ui.form.Button("ОК").set({allowGrowX: false, allowGrowY: false, height: 20});
					...
					setButtonSize: function()
					{
						try
						{
							...
							if (value == true)
							{
								...
								statBtn.setLabel("Меню");
								statBtn.setWidth(80);
								
								optionBtn.setLabel("Опции");
								optionBtn.setWidth(80);
								
								layoutBtn.setLabel("Сейвер");
								layoutBtn.setWidth(80);
							}
							else
							{
								simBtn.setLabel("См");
			...
			qx.Class.define("Simulator.LayoutWindow", 
			{
				...
				construct: function()
				{
					...
					var layoutListTitle = new qx.ui.basic.Label("Сейвер позиций").set({ alignX: "center", alignY: "top", font: "font_size_14_bold"});
					...
					var loadButton = new qx.ui.form.Button("Выбрать");
					...
					saveButton.set({ height: 10, width: 80, alignX: "center" });
					...
					this.persistentCheck = new qx.ui.form.CheckBox("Сделать постоянным");
					this.persistentCheck.setTextColor("white");
					this.persistentCheck.setFont("bold");
					this.persistentCheck.setToolTipText("Если установлено, то настройки армии могут быть применены на другой базе.");
					...
					noticeText.setValue("<p align=\'justify\'><b>Если позиция не загружается, попробуйте переместить одного юнита, а затем попробуйте еще раз.</b></p>"); 
					...
					var clearAllLayoutsBtn = new qx.ui.form.Button("Очистить список").set({alignX: "center", width: 140});
				...
				members:
				{
					...
					{		
						try
						{
							...
							for (var item = 0; item < children.length; item++)
							{
								...
								if (thisItem == model)
								{
									alert("Неудача: Такое имя уже есть");
									return;
								}
							}
					...
					{				
						try
						{
							...
							var rUSure = confirm('Вы уверены в удалении данной позиции?');
							if(!rUSure)
							{
								return;
							}
					...
					clearAllLayouts: function()
					{
						try
						{
							console.log("Удаление всех позиций");
							var rUSure = confirm("Нажмите ОК для удаления всех позиций для всех баз!");
							
							if (rUSure)
							{
								localStorage.removeItem('savedFormations');
								this.layoutsArray = new Array();
								alert("Все позиции были удалены.");
								
								this.updateLayoutList();
							}
							else
							{
								alert("Позиции не были удалены.");
							}
						}
						catch(e)
						{
							console.log("Ошибка удаления позиций");
							console.log(e);
						}
					}
				}
