// ==UserScript==
// @name           Facebook emot kaskus --> cenz edited 2012 (kaskus.co.id)
...
// @require        http://userscripts.org/scripts/source/134665.user.js
...
String.prototype.isPrefixOf = function(str, from){
	...
	emoticons[":o"] = {
		src: "http://www.kaskus.co.id/images/smilies/sumbangan/07.gif",
		alt: "csgakmod"
	};
	...
	emoticons[":babyboy"] = {
		src: "http://static.kaskus.co.id/images/smilies/babyboy.gif",
		alt: "csgakmod"
	};
	emoticons[":ngacir"] = {
