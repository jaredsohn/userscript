...
(function() {
    ...
    YoukuAntiAds.prototype = {
        ...
        get players() {
            if(!this._players) {
                this._players = {
                    'youku': 'http://www.ecdevelop/swf/loader.swf',
                    'ku6': 'http://www.ecdevelop/swf/ku6.swf',
                    'iqiyi': 'http://www.ecdevelop/swf/iqiyi.swf',
                    'iqiyi5': 'http://www.ecdevelop/swf/iqiyi5.swf',
                    'tudou': 'http://www.ecdevelop/swf/tudou.swf',
                    'tudou_olc': 'http://www.ecdevelop/swf/olc_8.swf',
                    'tudou_sp': 'http://www.ecdevelop/swf/sp.swf',
                    'letv': 'http://www.ecdevelop/swf/letv.swf'
                };
            }
        ...
        initPreHandlers: function() {
            ...
            this.rules['tudou_out']['preHandle'] = function(elem, find, replace, player) {
                ...
                GM_xmlhttpRequest({
                    ...
                    url: isFx ? player : 'http://www.ecdevelop/kafan/tfetcher?turl=' + encodeURIComponent(player + '/v.swf'),
