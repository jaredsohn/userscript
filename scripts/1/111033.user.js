// ==UserScript==
// @name           Ajuda Para Treinamento
// @include         http://trophymanager.com/training_new.php*
...
appdiv.innerHTML = '<div id="tbuddy" style="position: fixed; top: 120px; left: 20px; height: 150px; width: 140px; -moz-opacity: .8; text-align: left; border: 2px #333333 outset; display:inline;"><img src="http://imbx.us/Pro.gif"><p style="text-decoration: underline;">TREINOS</p><ul><li><a href="" target="_self" style="font-size: 10px;" title="">- Fisico: For, Res e Emp</a></li><li><a href="" target="_self" style="font-size: 10px;" title="">- Defesa: Des e Mar</a></li></ul><li><a href="" target="_self" style="font-size: 10px;" title="">- Técnica: Pas, B. Par e Téc.</a></li></ul><li><a href="" target="_self" style="font-size: 10px;" title="">- Laterais: Vel e Cru.</a></li></ul><li><a href="" target="_self" style="font-size: 10px;" title="">- Cabeceio: Pos e Cab</a></li></ul><li><a href="" target="_self" style="font-size: 10px;" title="">- Ataque: Fin e C. Lon.</a></li></ul></div>';
}
//Transferseite
