// ==UserScript==
// @name           SilentAll.Com
// @description    TurboBit Speed Download - DroiD
// @version        3.0.3
// @date           2013-04-12
// @author         DroiD
// @require        http://ajax.googleapis.com/ajax/libs/jquery/1.8.3/jquery.min.js
// @homepageURL    http://userscripts.org/scripts/show/165986
...
(function(){
    function main() {
        ...
        if (data != null){
        	...
        	$(".download-file").append("<br /><center><img src='http://i.imgur.com/lqUdIQG.png'><br />Copyright © 2013 SilentAll.Com - Türkiye'nin Katılımsız Platformu</center>")
