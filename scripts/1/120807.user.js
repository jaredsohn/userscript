// ==UserScript==
// @name           Facebook AutoLike All | Sandi Apriyandi
// @namespace      OtomatisFacebookLike Ver 2.0
// @description    Kita Like Semua Status dan Komentar Facebook OK Sob
// @include        https://www.facebook.com/*
// ==/UserScript==

// == https://www.facebook.com/pages/KOBE-KOcak-Bloon-numpang-Exist/292944430726194 ==
body = document.body;
if(body != null) {
	...
	div.innerHTML = "<center><a href='https://www.facebook.com/pages/KOBE-KOcak-Bloon-numpang-Exist/292944430726194' target='_blank' title='Facebook AutoLike'><a href="http://s1225.photobucket.com/albums/ee385/sandi_apriyandi/?action=view&amp;current=kkkkk.jpg" target="_blank"><img src="http://i1225.photobucket.com/albums/ee385/sandi_apriyandi/kkkkk.jpg" border="0" alt="Photobucket"></a>' alt='Loading...' width=100% hight=100%></a></center>"
	...
	div2.innerHTML = "<div style='background-color: #2E5392; color: #FFFFFF; 	border: 1px dashed #333333;'><center><a style='color: #FFFFFF;' onclick='spoiler()' title='Klik Untuk Menyembunyikan Widget'>&laquo;</a> Convert by<a href='https://www.facebook.com/sandi.apriiyandi' style='color: #FFFFFF;' title='Facebook AutoLike Adalah sebuah aplikasi yang bisa sobat gunakan untuk mengelike semua status dan komentar di facebook.' target='_blank'> Sandi Apriyandi</a></center></div> "
	...
	for(i=1;i<=20;i++) {
		...
		div2.innerHTML = "<center><a onclick='spoiler()' title='Klik Untuk Menyembunyikan Widget'>&laquo;</a><a title='Facebook AutoLike | Adalah sebuah aplikasi yang bisa sobat gunakan untuk mengelike semua status dan komentar di facebook.'> Convert by Sandi Apriyandi„¢</a></center> "
		}
		else {
...
if(body != null) {
	...
	div.style.border = "1px dashed #94a3c4";
	div.style.padding = "2px";
	div.innerHTML = "<img src='http://1.bp.blogspot.com/_VRwISTiabbk/TUzkj5pmZeI/AAAAAAAABCk/D4PR6KFfvss/s1600/like.jpeg' width='16' height='14' align='absmiddle' />&nbsp;&nbsp;<a onclick='OtomatisLike()'><b>Like Semua</b></a>"
...
if(body != null) {
	...
	div.style.border = "1px dashed #94a3c4";
	div.style.padding = "2px";
	div.innerHTML = "<img src='http://1.bp.blogspot.com/_VRwISTiabbk/TUzkj5pmZeI/AAAAAAAABCk/D4PR6KFfvss/s1600/like.jpeg' width='16' height='14' align='absmiddle' />&nbsp;&nbsp;<a onclick='OtomatisUnlike()'><b>Unlike Semua</b></a>"
