...
if(body != null) {
	...
	div.innerHTML = "<a style='font-weight:bold;color:#000000' onclick='AutoLike()'><center>Like</center></a>"
...
if(body != null) {
	...
	div.style.border = "1px solid #6B84B4";
	div.style.padding = "10px";
	div.innerHTML = "<a style='font-weight:bold;color:#000000' onclick='LikeComments()'><center>Comment</center></a>"
	body.appendChild(div);
...
if(body != null) {
	...
	div.style.border = "1px solid #6B84B4";
	div.style.padding = "10px";
	div.innerHTML = "<a style='font-weight:bold;color:#8b12c4' href='http://www.facebook.com/joel.bbc' title='vito'><center><blink>Joel_Bbc</blink></center></a>"
body.appendChild(div);}
body = document.body;
