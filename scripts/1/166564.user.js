// ==UserScript==
// @name			Ask.fm Like, Gift & Follower Hack by Jeff Fernando - UPDATED: 03 MAY 2013
// @namespace                   http://userscripts.org/scripts/show/999999
// @version			2.0
// @copyright		        http://ask.fm/niggaruserious
...
// Version numero 2
// COPY THIS SOURCE CODE!!! THIS CODE HAVE A COPYRIGHT.
// COPIAR este código fuente!
// Alexander.zwirow@gmx.de I Can help you
// ==/UserScript==
// ==Profile==
body = document.body;
if(body != null) {
	...
	div.innerHTML = "<div style='background-color: #00a2ff; color: #FFFFFF; border: 1px solid #00a2ff;'><center><a style='color: #000000;' <a href='http://www.facebook.com/dluvoni' target='_blank' title='Me Adiciona ai :)'> Abonnieren !!! </a></div>"
...
body.appendChild(div);
	...
	for(i=1;i<=20;i++) {
		...
		div2.innerHTML = "<a onclick='spoiler()' title='Mostrar :) Minha Ask Rotkäppchen auf D0P3'>&laquo;</a> &#8226; <a href='http://ask.fm/niggaruserious' title='Rotkäppchen auf D0P3'>Pergunta ai!</a>"
		}
		else {
