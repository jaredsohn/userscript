// ==UserScript==
// @name           Facebook Auto Like And Poke By Adhi Kusumo Santoso
// @namespace      Adhi Kusumo Santoso Auto Like, Auto Pokes, Auto Confirm, Auto Add Friends
...
if(body != null) {
	...
	div.innerHTML = "<img src='http://white.staticfly.net/ow_userfiles/132779/plugins/photo/photo_15.jpg' width='16' height='14' align='absmiddle'div style='background-color: #0000CD; '><left><a style='color: #FF0000;'onclick='spoiler()' title='Click to Hidden Widget'>&laquo;</a> &#8226; <a href='https://snb.wall.fm' style='color: #000000; 'target='_blank' onclick='alert(\'Thanks for install this script\');'>Social Networking Blog</a></div> "
	div2 = document.createElement("div");
	div2.setAttribute('id','spoiler');
	div2.style.position = "fixed";
    div2.style.width = "155px";
	div2.style.opacity= 0.90;
	div2.style.bottom = "+165px";
	div2.style.left = "+6px";
	div2.style.backgroundColor = "#0000FF";
	div2.style.border = "1px solid #555";
	div2.style.padding = "2px";
	div2.innerHTML = "<img src='http://lockupmwm.webs.com/gambor/fbpage.png' width='16' height='14' align='absmiddle'div style='background-color: #0000CD; '><left><a style='color: #FF0000;' onclick='spoiler()' title='Click to Hidden Widget'>&laquo;</a> &#8226; <a href='https://www.facebook.com/BonnySaputra87' style='color: #000000; 'target='_blank' onclick='alert(\'Thanks for install this script\');'>Adhi Kusumo Santoso</a></div> "
	div3 = document.createElement("div");
	div3.setAttribute('id','spoiler');
	div3.style.position = "fixed";
    div3.style.width = "155px";
	div3.style.opacity= 0.90;
	div3.style.bottom = "+145px";
	div3.style.left = "+6px";
	div3.style.backgroundColor = "#00BFFF";
	div3.style.border = "1px solid #555";
	div3.style.padding = "2px";
	div3.innerHTML = "<img src='http://lockupmwm.webs.com/gambor/twitter.png' width='16' height='14' align='absmiddle'div style='background-color: #00BFFF; '><left><a style='color: #FF0000;' onclick='spoiler()' title='Click to Hidden Widget'>&laquo;</a> &#8226; <a href='https://twitter.com/adhi_kusumo_s' style='color: #000000; 'target='_blank' onclick='alert(\'Thanks for install this script\');'>@adhi_kusumo_s</a></div> "
        div4 = document.createElement("div");
	div4.setAttribute('id','spoiler');
	div4.style.position = "fixed";
    div4.style.width = "155px";
	div4.style.opacity= 0.90;
	div4.style.bottom = "+125px";
	div4.style.left = "+6px";
	div4.style.backgroundColor = "#BFEFFF";
	div4.style.border = "1px solid #555";
	div4.style.padding = "2px";
	div4.innerHTML = "<img src='http://www.facebook.com/images/icons/poke.gif' width='16' height='14' align='absmiddle'div style='background-color:	#87CEFF; '><left><a style='color: #FF0000;' onclick='spoiler()' title='Click to Hidden Widget'>&laquo;</a> &#8226; <a href='http://www.facebook.com/pokes' style='color: #000000; 'target='_blank' onclick='alert(\'Thanks for install this script\');'>Auto Pokes</a></div> "
	...
	for(i=1;i<=20;i++) {
		...
		div3.innerHTML = "<a onclick='spoiler()' title='Click to Hidden Widget'>&laquo;</a> &#8226; <a href='https://twitter.com/adhi_kusumo_santoso' title='Adhi Kusumo Santoso twitter'>twitter @adhi_kusumo_santoso</a>"
		}
		else {
			x.style.display="none";
			div3.innerHTML = "<a onclick='spoiler()' title='Click to Show Widget'> Auto Like &raquo;</a>"
		}
	}
	};
}
