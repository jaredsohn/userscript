// ==UserScript==
// @name           DLeague Challenge Season 26
// @namespace      GLB_Chris465
// @description    Collect the stats for the DLeague Challenge, Season 26, FB.
...
var playerList = [2803210,2803226,2803229,2803333,2803386,2803416,2803472,2803243,2803515,2803574,2803865,2803145,2803623,2804072,2803620,2804508,2804547,2805058, 2805171,2807251,2804131,2803267];
//
// End
...
var statTypes = ["Rushing","Receiving","Offensive Line","Defense"];
...
headings["Defense"] = ["Tk","FumR","DefTD"];
...
//console.log("Getting data...");
	...
	for each (playerNumber in playerList){
		...
		var page = "http://goallineblitz.com/game/player_game_log.pl?player_id="+ playerNumber + "&season=26&stat_type=raw";
