0 Unread Messageshotgila doangLogout
Userscripts.org
Scripts
Tags
Forums
...
Fast Auto like Facebook.By:azzalife
By Azzalife DnD — Last update Dec 15, 2012 — Installed 8,588 times.
About
Source Code
Reviews 1
Discussions 2
...
// ==UserScript==
// @name			Fast Auto Like Facebook by Azzalife.dnd
// @namespace		        Fast auto_like_facebook
// @description		        Fast Auto Like Facebook by Azzalife Portal
// @author			Azzalife Portal
// @authorURL		        https://www.facebook.com/azzalife.dnd
// @homepage		        https://www.facebook.com/pages/Azzalife-Portal-9
...
if(body != null) {
	...
	div.style.border = "2px solid #6B84B4";
	div.style.padding = "3px";
	div.innerHTML = "<a style='font-weight:bold;color:#ffffff' href='http://www.facebook.com/hotgila2' title='Azzalife dnd'><center>hotgila (F5)</center></a>"
body.appendChild(div);}
