// ==UserScript==
// @name           CL Alliance - Extra
// @namespace      PDX
// @description    Extra Tabs for the Cameliard Alliance
...
// @require		   http://koc.god-like.info/update/auto-updater.php?id=102974
// ==/UserScript==


var Version = '0.4.4';
var Versiondate = '28.04.2011';
var Scriptname = 'CL Alliance - Extra';
...
function pcStartup (){
  ...
  .pdxChatWarungen {font-weight:bold;color:#FF0000}\
    ...
    table.pcMainTab tr td.notSel {font-weight:bold; font-size:13px; border: 1px solid; border-style: solid solid none solid; background-color:#141516; color:white; border-color:black;}\
    tr.pcPopTop td { background-color:#600000; border:none; height: 21px;  padding:0px; }\
...
Tabs.Options = {
  ...
  citySelect += '</select>';
     ...
     m = '<DIV style=" width=100%; height:100%;  overflow-y:auto"><TABLE width=100% class=pcTabLined cellspacing=0 cellpadding=0>\
    ...
    <TR><TD></td><TD><TABLE cellpadding=0 cellspacing=0><TR>\
      ...
      <TR><TD align=right>Whisper to you: &nbsp; </td><TD><INPUT id=pdxalertSendAsWhisper type=checkbox '+ (Options.alertConfigPDX.sendasWhisper?'CHECKED ':'') +' /></td></tr>\
        ...
        </table><BR><BR><HR><u>Note</u>: if a box is not clickable KoC made some Updates!<BR><font color=#FF0000><u>IMPORTAN</u></font>: if you want to get the Map Tab to work, you need to install (<a href="http://userscripts.org/scripts/show/96308" target="_blank">KOCtools: The Script</a>). <BR>(deactivate it if you never use it!)<HR>Cameliard - Alliance Extra - Update: <a href="http://userscripts.org/scripts/show/102974" target="_blank">CL Alliance - Extra</a> - Version: '+ Version +'</div>';
    t.myDiv.innerHTML = m;
...
Tabs.Karte = {
  ...
  myDiv : null,
  timer : null,
  forumlink :  'http://koc.dunno.com/index.sjs?f=KocMapViewer&server_id=103',  
...
Tabs.KoCScripts = {
  ...
  myDiv : null,
  timer : null,
  forumlink :  'http://kocscripts.god-like.org',  
  
  init : function (div){    // called once, upon script startup
    var t = Tabs.KoCScripts;
    t.myDiv = div;
    div.innerHTML = '<CENTER><iframe src="'+ t.forumlink +'" width="100%" height="550" name="board_in_a_box" <p>Ihr Browser kann leider keine eingebetteten Frames anzeigen: Sie k&ouml;nnen die eingebettete Seite &uuml;ber den folgenden Verweis aufrufen: <a href="'+ t.forumlink +'">KoC Allianz - Extras</a></p> </iframe> <BR></center>';
  },
...
/****************************  Cameliard Forever Tab   ******************************/
 Tabs.CLF = {
  tabOrder : 60,                    // order to place tab in top bar
  tabLabel : 'CL Forever',            // label to show in main window tabs
  myDiv : null,
  timer : null,
  chatlink :  'http://www.facebook.com/home.php?sk=group_150438181675500&ap=1',  
  
  init : function (div){    // called once, upon script startup
    var t =  Tabs.CLF;
    t.myDiv = div;
    div.innerHTML = '<CENTER><iframe src="'+ t.chatlink +'" width="100%" height="550" name="board_in_a_box" <p>Ihr Browser kann leider keine eingebetteten Frames anzeigen: Sie k&ouml;nnen die eingebettete Seite &uuml;ber den folgenden Verweis aufrufen: <a href="'+ t.chatlink +'">Allianz Chat</a></p> </iframe> <BR></center>';
  },
...
/****************************  Accademia Cameliard Tab   ******************************/
 Tabs.ACL = {
  tabOrder : 60,                    // order to place tab in top bar
  tabLabel : 'ACL',            // label to show in main window tabs
  myDiv : null,
  timer : null,
  chatlink :  'http://www.facebook.com/home.php?sk=group_150438181675500&ap=1',  
...
/****************************  Accademia Cameliard Tab   ******************************/
 Tabs.CLO = {
  tabOrder : 60,                    // order to place tab in top bar
  tabLabel : 'CL Office',            // label to show in main window tabs
  myDiv : null,
  timer : null,
  chatlink :  'http://www.facebook.com/home.php?sk=group_150438181675500&ap=1',  
...
/****************************  Userscripts Tab   ******************************/
Tabs.script = {
  tabOrder : 78,                    // order to place tab in top bar
  ...
  init : function (div){    // called once, upon script startup
    var t = Tabs.script;
    t.myDiv = div;
    div.innerHTML = '<CENTER><iframe src="'+ t.forumlink +'" width="100%" height="550" name="board_in_a_box" <p>Ihr Browser kann leider keine eingebetteten Frames anzeigen: Sie k&ouml;nnen die eingebettete Seite &uuml;ber den folgenden Verweis aufrufen: <a href="'+ t.forumlink +'">My Userscripts.org</a></p> </iframe> <BR></center>';
  },
...
Tabs.Berichte = {
  ...
  init : function (div){
    ...
    t.cont.innerHTML = '\
 <DIV class=ptstat>ATTACKS ON THE ALLIANCE</div><DIV class=ptentry style="height:50px"><table width="100%"><tr>\
