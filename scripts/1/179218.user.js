// ==UserScript==
// @name			Ordenes de Batalla - MoD eMexico
// @version			1.7
// @author			KodaK
// @namespace		eMexico_mod
// @description		Plugin para visualizar las Ordenes de Batalla de eMexico.
...
// @updateURL		http://userscripts.org/scripts/source/154311.meta.js
// @downloadURL		http://userscripts.org/scripts/source/154311.user.js
// ==/UserScript==
function LL_carga() {
...
function header() {
    ...
    var orders = '<h4>Prioridades de eMexico (Beta v1.7)</h4><div id="mod_orders"></div>';
    ...
    var imageHeader = 'http://img203.imageshack.us/img203/3504/gu9i.png';
...
function footer() {
	...
	var linkDiv = '';
    switch(x) {
    case 1: linkDiv = 'http://client00.chat.mibbit.com/?channel=%23mod.mexico&server=rizon.mibbit.org'; break;
    case 2: linkDiv = 'http://client00.chat.mibbit.com/?channel=%23mod.mexico&server=rizon.mibbit.org'; break;
    case 3: linkDiv = 'http://client00.chat.mibbit.com/?channel=%23mod.mexico&server=rizon.mibbit.org'; break;
    case 4: linkDiv = 'http://client00.chat.mibbit.com/?channel=%23mod.mexico&server=rizon.mibbit.org'; break;
    default: linkDiv = 'XX';
    }    
    var orders = '<div class="rest"><a href="http://j.mp/M-eMex" title="" target="_blank">Planilla Ordenes Militares</a><a href="' + linkDiv + '" title="" target="_blank">Canal de Coordinación</a></div>';
...
function battles() {
	var x = division();
    $.get('https://docs.google.com/spreadsheet/ccc?key=0AkWkuZNd850DdHJKTkY1dTBMVDFZYmNNUVRxY1MxS2c&single=true&gid=2&range=b13&output=txt', function(data) {
