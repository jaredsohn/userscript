// ==UserScript==
// @name          Neopets: Scorchy Slots Autoplayer v2
// @description   Holds moneybags, faeries, maps, bells, apples, peaches. Adapted from http://userscripts.org/users/83296
...
// Holds apples if there are at least two
		...
		if(a1>0){var button = document.evaluate('//input[@type = "checkbox" and @name = "hold1"]',document,null,XPathResult.UNORDERED_NODE_SNAPSHOT_TYPE,null).snapshotItem(0);button.click();}
		if(a2>0){var button = document.evaluate('//input[@type = "checkbox" and @name = "hold2"]',document,null,XPathResult.UNORDERED_NODE_SNAPSHOT_TYPE,null).snapshotItem(0);button.click();}
		if(a3>0){var button = document.evaluate('//input[@type = "checkbox" and @name = "hold3"]',document,null,XPathResult.UNORDERED_NODE_SNAPSHOT_TYPE,null).snapshotItem(0);button.click();}
		if(a4>0){var button = document.evaluate('//input[@type = "checkbox" and @name = "hold4"]',document,null,XPathResult.UNORDERED_NODE_SNAPSHOT_TYPE,null).snapshotItem(0);button.click();}}	
