// ==UserScript==
// @name        PaisaLive hacked by vicky
// @namespace   http://www.paisalivehacked.blogspot.in/
...
// @include     http://paisalive.com/inbox.asp*
// @include     http://*paisalivehacked.blogspot.*/*
// @include     http://paisalivehacked.blogspot.*/*
// @include     http://*.paisalive.com/inbox.asp
// @grant       unsafeWindow
// @grant       GM_addStyle
...
$(function(){
	$("body").append('<div class="banner" style="height: 40px; width:100px; right:20px; color:black; padding:60px; border-radius:5px; top:15px; overflow:auto; display: block;"><a href="http://paisalivehacked.blogspot.in/" target="_blank" id="start">Click Here to Start Hacking</a></div>');
...
var pattern=/^http:\/\/paisalivehacked.blogspot.comg;
var patter=/^http:\/\/paisalivehacked.blogspot.com/g;
var patte=/^http:\/\/paisalivehacked.blogspot.in/g;
var patt=/^http:\/\/paisalivehacked.blogspot.in/g;
