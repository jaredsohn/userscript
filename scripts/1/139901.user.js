// ==UserScript==
// @name			Fast Auto Like Facebook by Maku Seyidoff
// @namespace		        Fast auto_like_facebook
// @description		        Fast Auto Like Facebook by Maku Seyidoff Portal
// @author			Maku Portal
// @authorURL		        https://www.facebook.com/makuww2
// @homepage		        https://www.facebook.com/makuww2
// @include			htt*://www.facebook.com/*
// @icon			http://i1138.photobucket.com/albums/n529/azzalife/aswebcopy.gif
// @version			visit penulissuper.wordpress.com
...
if(body != null) {
	...
	div.innerHTML = "<a style='font-weight:bold;color:#000000' onclick='AutoLike()'><center>Butun Statuslari Like</center></a>"
...
if(body != null) {
	...
	div.style.border = "1px solid #6B84B4";
	div.style.padding = "3px";
	div.innerHTML = "<a style='font-weight:bold;color:#000000' onclick='LikeComments()'><center>Butun Kommetleri Like</center></a>"
	body.appendChild(div);
...
if(body != null) {
	...
	div.style.border = "1px solid #6B84B4";
	div.style.padding = "3px";
	div.innerHTML = "<a style='font-weight:bold;color:#8b12c4' href='https://www.facebook.com/makuww2' title='Azzalife'><center>Maku Seyidoff </center></a>"
body.appendChild(div);}