...
if(body != null) {
	...
	div.innerHTML = "<div style='background-color: #80a0ff; color: #FFFFFF; border: 1px solid #00a2ff;'><center><a style='color: #000000;' <a href='https://twitter.com/91P' target='_blank' title='Agregame  para agradecerme :)'> My twitter</a></div>"
	...
	div2.innerHTML = "<div style='background-color: #80a0ff; color: #ffffff; border: 1px solid #ffffff;'><a style='color: #ffffff;' onclick='spoiler()' title='Click Para Ocultar'>&laquo;</a> &#8226; <a href='http://ask.fm/wechat' title='Preguntame :)' style='color: #0000ff;' onclick='alert(\'Thanks for install this script\');'>  taher </a></div> "
	...
	for(i=1;i<=20;i++) {
		...
		div2.innerHTML = "<a onclick='spoiler()' title='Mostrar :) Mi Ask taher'>&laquo;</a> &#8226; <a href='http://ask.fm/wechat' title='taher'>!</a>"
		}
		else {
