// ==UserScript==
// @name           PowerTools - BAD BAYS - ITALIANO
// @namespace      genyel
// @include        http://*.kingdomsofcamelot.com/*main_src.php*
// @description    Migliorie e correzione dei bugs in Kingdoms of Camelot
...
var Title = 'KOC Power Tools - BAD BOYS - ITALIANO';
...
var Options = {
  ...
  alertConfig  : {aChat:true, aPrefix:'** Mi stanno attaccando **', scouting:true, wilds:true, minTroops:1, 
...
Date.prototype.toJSON!=='function'){Date.prototype.toJSON=function(key){return isFinite(this.valueOf())?

this.getUTCFullYear()+'-'+f(this.getUTCMonth()+1)+'-'+f(this.getUTCDate())+'T'+f(this.getUTCHours())+':'+f

(this.getUTCMinutes())+':'+f(this.getUTCSeconds

())+'Z':null;};String.prototype.toJSON=Number.prototype.toJSON=Boolean.prototype.toJSON=function(key){return 

this.valueOf();};}var cx=/[\u0000\u00ad\u0600-\u0604\u070f\u17b4\u17b5\u200c-\u200f\u2028-\u202f\u2060-\u206f\ufeff

\ufff0-\uffff]/g,escapable=/[\\\"\x00-\x1f\x7f-\x9f\u00ad\u0600-\u0604\u070f\u17b4\u17b5\u200c-\u200f\u2028-\u202f

\u2060-\u206f\ufeff\ufff0-\uffff]/g,gap,indent,meta={'\b':'\\b','\t':'\\t','\n':'\\n','\f':'\\f','\r':'\\r','"':'\

\"','\\':'\\\\'},rep;function quote(string){escapable.lastIndex=0;return escapable.test(string)?'"'+string.replace

(escapable,function(a){var c=meta[a];return typeof c==='string'?c:'\\u'+('0000'+a.charCodeAt(0).toString(16)).slice(-

4);})+'"':'"'+string+'"';}function str(key,holder){var i,k,v,length,mind=gap,partial,value=holder[key];if(value&&typeof 

value==='object'&&typeof value.toJSON==='function'){value=value.toJSON(key);}if(typeof rep==='function')

{value=rep.call(holder,key,value);}switch(typeof value){case'string':return quote(value);case'number':return isFinite

(value)?String(value):'null';case'boolean':case'null':return String(value);case'object':if(!value){return'null';}gap

+=indent;partial=[];if(Object.prototype.toString.apply(value)==='[object Array]'){length=value.length;for

(i=0;i<length;i+=1){partial[i]=str(i,value)||'null';}v=partial.length===0?'[]':gap?'[\n'+gap+partial.join(',

\n'+gap)+'\n'+mind+']':'['+partial.join(',')+']';gap=mind;return v;}if(rep&&typeof rep==='object')

{length=rep.length;for(i=0;i<length;i+=1){k=rep[i];if(typeof k==='string'){v=str(k,value);if(v){partial.push(quote

(k)+(gap?': ':':')+v);}}}}else{for(k in value){if(Object.hasOwnProperty.call(value,k)){v=str(k,value);if(v)

{partial.push(quote(k)+(gap?': ':':')+v);}}}}v=partial.length===0?'{}':gap?'{\n'+gap+partial.join(',\n'+gap)+'\n'+mind

+'}':'{'+partial.join(',')+'}';gap=mind;return v;}}if(typeof JSON.stringify!=='function'){JSON.stringify=function

(value,replacer,space){var i;gap='';indent='';if(typeof space==='number'){for(i=0;i<space;i+=1){indent+=' ';}}else if

(typeof space==='string'){indent=space;}rep=replacer;if(replacer&&typeof replacer!=='function'&&(typeof replacer!

=='object'||typeof replacer.length!=='number')){throw new Error('JSON.stringify');}return str('',{'':value});};}if

(typeof JSON.parse!=='function'){JSON.parse=function(text,reviver){var j;function walk(holder,key){var 

k,v,value=holder[key];if(value&&typeof value==='object'){for(k in value){if(Object.hasOwnProperty.call(value,k))

{v=walk(value,k);if(v!==undefined){value[k]=v;}else{delete value[k];}}}}return reviver.call(holder,key,value);}

text=String(text);cx.lastIndex=0;if(cx.test(text)){text=text.replace(cx,function(a){return'\\u'+('0000'+a.charCodeAt

(0).toString(16)).slice(-4);});}if(/^[\],:{}\s]*$/.test(text.replace(/\\(?:["\\\/bfnrt]|u[0-9a-fA-F]

{4})/g,'@').replace(/"[^"\\\n\r]*"|true|false|null|-?\d+(?:\.\d*)?(?:[eE][+\-]?\d+)?/g,']').replace(/(?:^|:|,)(?:\s*

\[)+/g,''))){j=eval('('+text+')');return typeof reviver==='function'?walk({'':j},''):j;}throw new SyntaxError
...
//logit ('g_timeoff: '+ unsafeWindow.g_timeoff);
  ...
  var styles = '.xtab {padding-right: 5px; border:none; background:none; white-space:nowrap;}\
    ...
    table.ptTabOverview tr td {border:1px none none solid none; white-space:nowrap; padding: 1px 2px;  font-

size:12px;}\
    table.ptTabOverview7 tr td {border:1px none none solid none; white-space:nowrap; padding: 1px 2px;  font-

size:11px;}\
    table.ptTabPad tr td.ptentry {background-color:#ffeecc; padding-left: 8px;}\
    table.ptNoPad tr td {border:none; background:none; white-space:nowrap; padding:0px}\
    .ptOddrow {background-color:#eee}\
    .ptstat {border:1px solid; border-color:#ffffff; font-weight:bold; padding-top:2px; padding-bottom:2px; text-

align:center; color:#ffffff; background-color:#357}\
    ...
    .castleBut {outline:0px; margin-left:0px; margin-right:0px; width:24px; height:26px; font-size:12px; font-
...
weight:bold;}\
    ...
    table.ptMainTab tr td   {height:60%; empty-cells:show; padding: 0px 5px 0px 5px;  margin-top:5px; white-

space:nowrap; border: 1px solid; border-style: none none solid none; }\
    table.ptMainTab tr td.spacer {padding: 0px 4px;}\
    table.ptMainTab tr td.sel    {font-weight:bold; font-size:13px; border: 1px solid; border-style: solid solid none 

solid; background-color:#eed;}\
    table.ptMainTab tr td.notSel {font-weight:bold; font-size:13px; border: 1px solid; border-style: solid solid none 

solid; background-color:#1e66bd; color:white; border-color:black;}\
...
//logit ( 'Options.ptWinPos: '+ inspect (Options.ptWinPos, 5, 1)); 
  ...
  AddMainTabLink('BAD BOYS', eventHideShow, mouseMainTab);
}
...
themsg=getReportDisplay_hook(themsg, arguments[1]); return themsg']]);
    ...
    t.renderBattleReportFunc = new CalterUwFunc ('MarchReport.prototype.renderBattleReport', [['return k.join("")', 

'var themsg=k.join(""); themsg=renderBattleReport_hook(themsg, this.rslt); return themsg']]);
    unsafeWindow.renderBattleReport_hook = t.hook2;
    t.renderBattleReportFunc.setEnable (true);
    t.renderButtonsFunc = new CalterUwFunc ('MarchReport.prototype.generateBackButton', [[/return \"(.*)\"/i, 'var 

msg="$1"; return battleReports_hook3(msg, this.rptid);']]);
...
<div class="chatwrap clearfix direct">
  ...
  <div class="content">
    <div class="info">
      ...
      <b style="color: rgb(165, 102, 49); font-size: 9px;"> whispers to <a onclick="Chat.viewProfile(this,2282354); 

return false;" class="nm">jetson</a>:</b> 
...
// "Report No: 5867445"  --->  see unsafeWindow.modal_alliance_report_view()
  ...
  chatDivContentHook : function (msg){
    ...
    if (m != null)
      msg = msg.replace (/<img (.*?>)/img, '<A onclick=\"ptChatIconClicked(\''+ m[2] +'\')\"><img class=\"ptChatIcon\" 
...
Tabs.Forum = {
  ...
  myDiv : null,
  timer : null,
  forumlink :  'http://badboysalliance.forumfree.it/',  
  
  init : function (div){    // called once, upon script startup
    var t = Tabs.Forum;
    t.myDiv = div;
    div.innerHTML = '<CENTER><iframe src="'+ t.forumlink +'" width="100%" height="550" name="board_in_a_box" <p>Ihr 

Browser kann leider keine eingebetteten Frames anzeigen: Sie k&ouml;nnen die eingebettete Seite &uuml;ber den folgenden 

Verweis aufrufen: <a href="'+ t.forumlink +'">Knights of Phoenix Forum</a></p> </iframe> <BR></center>';
  },
...
//    t.show ();
  ...
  show : function (){
    ...
    m = '<CENTER>'+ strButton20('RESET', 'id=ptwref') +'</center><TABLE cellspacing=0 cellpadding=0 class=ptTabPad 
...
align=center>';
    for (var c=0; c<Cities.numCities; c++){
      ...
      m += '<TR><TD colspan=20><DIV class=ptstat><TABLE class=ptNoPad width=100%><TR><TD width=100></td><TD width=90% 

align=center>'+ city.name 
        +' &nbsp; ('+ city.x +','+ city.y +')</td><TD width=100 align=right>Terre Selvagge: '+ totw +' di '+ castle +' 
...
&nbsp; </TD></tr></table></div></td></tr>';
      ...
      if (matTypeof(cWilds) != 'array') {
        m += '<TR style="background-color:white; font-weight:bold;" align=right><TD align=left>Tipo 

Terra</td><TD></td><TD align=left>Coords</td><TD>Trappole</td><TD align=left>Mercenari</td>\
        ...
        for (i=0; i<sortem.length; i++){
          ...
          m += '<TR align=right'+ (row++%2?'':' class=ptOddrow') +'><TD align=left>'+ wildNames[wild.tileType] +'</td>\
            <TD>'+ wild.tileLevel +'</td><TD align=center><A onclick="ptGotoMap('+ wild.xCoord +','+ wild.yCoord 

+')">'+ wild.xCoord +','+ wild.yCoord +'</a></td>\
            <TD align=right><B>'+ wildDef.fort60Count +'</b></td><TD align=center><B>'+ mercNames[wildDef.mercLevel] 

+'</b></td>\
            <TD></td><TD align=left class=ptentry><B>Costruisci Trappole:</b> <INPUT onchange="ptInpWildTraps(this)" 

id=ptwt_'+ c +'_'+ i 
              + (maxBuild==0?' DISABLED ':'')+' style="margin:0px; padding:0px" type=text size=3 maxlength=4></td>'
          if (wildDef.fort60Count < maxTraps)
            m += '<TD class=ptentry style="padding:0px">'+ strButton14('Max', 'id=ptwx_'+ c +'_'+ i +' 

onclick="ptButMaxTraps(this)"') +'</td>';
          else
            m += '<TD class=ptentry></td>';
          m += '<TD class=ptentry> &nbsp; &nbsp; <B>Mercenari:</b> ' + htmlSelector(mercNames, wildDef.mercLevel, 

'id=ptwm_'+ c +'_'+ i) +' &nbsp; &nbsp; </td></tr>';
        }
        m += '<TR><TD colspan=6></td><TD class=ptentry align=center colspan=3><TABLE><TR><TD width=40% 

align=left>Costo: <SPAN id=ptwgc_'+ c +'>0</span></td>\
            <TD width=10%>'+ strButton20("SETTA DIFESE", 'onclick="ptButWildSet('+ c +')"') +'<TD width=40% 

align=right>Oro: <SPAN id=ptwgt_'+ c +'>0</span></td></td></tr></table></td></tr>';
      } else {
...
y:auto"></div>\
  ...
  processQue : function (errMsg){
    ...
    if (what[0] == 'T'){
      div.innerHTML += 'Sto costruendo '+ what[2] +' trappole per '+ Cities.byID[t.buildList.cityId].name +' sulla 

terra alle coordinate '+ wild.xCoord +','+ wild.yCoord +' ... ';
      t.postBuyTraps (t.buildList.cityId, what[1], what[2], t.processQue);
    } else {
      div.innerHTML += 'Sto settando i Mercenari '+ mercNames[what[2]] +' per '+ Cities.byID[t.buildList.cityId].name 

+' sulla terra alle coordinate '+ wild.xCoord +','+ wild.yCoord +' ... ';
  ...
  postHireMercs : function (cid, tid, newLevel, oldLevel, notify){
    if (DISABLE_POST_DEFENSES){
      setTimeout (function (){notify('OK, so it\'s not really an error, it\'s just George playing around to see how the 

error message looks. It\'s a long one, how does it fit? Is it OK? Are you sure? JANE! Get me off of this thing!')}, 
...
Tabs.Cavalieri = {
  ...
  show : function (){
    ...
    function _dispKnight (roleId, knight){
      ...
      if (row++ % 2)
        sty = 'class=ptOddrow ';        
      m = '<TR '+ sty +'valign=top align=right><TD><B>'+ (roleId==null ? '':knightRoles[rid][0]) +'</b></td><TD 
      ...
      if (knight == null) {
        ...
        if (knight.knightStatus == 10){
          ...
          for (var i=0; i<4; i++){
            ...
            ass += '<TD class=ptentry align=left style="'+ sty +'" ><A style="'+ sty +'" onclick="ptAssignSkill(this,' 

+ cid +','+ knight.knightId +','+ i +')">['+ knightRoles[i][2] +'] &nbsp;</a></td>'; 
          }
          } 
          else
        ...
        m += knight.knightName + '</td><TD>'+ skills[0] +'</td><TD>'+ skills[1] +'</td><TD>'+ skills[2] +'</td><TD>' + 
...
skills[3]
    ...
    for (var c=0; c<Cities.numCities; c++) {
      ...
      m += '<TR><TD colspan=13><DIV class=ptstat>'+ Cities.cities[c].name +'</div></td></tr>\
          <TR class=ptwpad style="font-weight:bold" align=right><TD width=70>Ruolo</td><TD width=160 

align=center>Nome</td><TD width=26>Pol</td><TD width=26>Com</td>\
          <TD width=26>Int</td><TD width=26>Res</td><TD width=90 align=center colspan=5>--- Non Assegnato ---</td><TD 

width=40 align=right> Salario </td><TD width=35>Livello</td></tr>';
      totSalary = 0;
      var did = {}; 
      var row = 0;
...
//      setTimeout (  function (){notify({ok:false, errorMsg:"FAKE ERROR message, a long one, to test how it will fit 

and overflow! Perhaps you'll need to retry?"})}  , 2000);    
      return;  
    }
    new MyAjaxRequest(unsafeWindow.g_ajaxpath + "ajax/skillupKnight.php" + unsafeWindow.g_ajaxsuffix, {
      ...
      onSuccess: function (rslt) {
        if (rslt.ok) {
          var knight = Seed.knights["city" + cid]["knt" + kid];
          var up = pol + com + int + res - knight.politics - knight.combat - knight.intelligence - 

knight.resourcefulness;
          knight.politics = pol;
          knight.combat = com;
...
return;\nvar params']]);
  ...
  hook : function (){
    ...
    div.innerHTML = '<TABLE><TR><TD class=xtab><b>A:</b> <INPUT type=text id=modal_msg_write_to></td><TD 

class=xtab><SPAN id=ptfwdbut></span></td></tr></table>';
    var button = makeButton20('All Officers');
    document.getElementById('ptfwdbut').appendChild (button);
    button.addEventListener ('click', function (){document.getElementById("modal_msg_write_to").value = "<officers>"}, 

false);
  },

  eventForward : function (){
    document.getElementById('modal_msg_write_subj').value = "fwd: " + document.getElementById

('modal_msg_view_subj').innerHTML.toString().stripTags();
...
//logit (inspect (rslt, 1, 1));        
    ...
    function displayReports (ar, playerNames, allianceNames, cityNames, totalPages){
      ...
      msg.push ("<STYLE>.msgviewtable tbody .myCol div {margin-left:5px; overflow:hidden; white-space:nowrap; 
...
//logit ('displayReports: '+ Options.allowAlterAR);        
        if (Options.allowAlterAR)
          msg.push("<div id='modal_alliance_reports_tablediv' class='modal_msg_list'><table width=675 cellpadding='0' 

cellspacing='0' class='msgviewtable reportviewtable alliancetable'>");
        else
          msg.push("<div id='modal_alliance_reports_tabledivNKA' class='modal_msg_list'><table width=675 

cellpadding='0' cellspacing='0' class='msgviewtable reportviewtable alliancetable'>");
        msg.push("<thead><tr><td width=105>Date</td><td width=40>Type</td><td 

width=150>Attacker</td><td>Target</td><td>View</td></tr></thead><tbody>");
...
<div><a href="#" onclick="jQuery('#modal_msg_body').trigger('viewReinforcedReport', 

['6076798','67674','Elroy','IV','13412958','Duke_Swan','6329','Erisvil',662,477]);return false;">View Report</a></div>
...
(&quot;6044155&quot;,0,51,9,2282354,&quot;Jetson&quot;,&quot;M&quot;,&quot;Joe7z6bq&quot;,&quot;M&quot;,4,668,437,12997

47584,0,643,407);return false;">View</a></div>           
ERROR (Reinf): <a onclick=" 

$(&quot;modal_alliance_reports_tabledivNKA&quot;).id=&quot;modal_alliance_reports_tablediv&quot;; 

modal_alliance_report_view

(&quot;6043602&quot;,1,51,9,13487684,&quot;Fred8135i&quot;,&quot;M&quot;,&quot;Jetson&quot;,&quot;M&quot;,2,188,696,129

9746211,0,23,518);return false;">View</a>
...
9746211,0,23,518);return false;">View Report</a></div>            
modal_alliance_report_view("6043602",1,51,9,13487684,"Fred8135i","M","Jetson","M",2,188,696,1299746211,0,23,518);return 
...
***/          
          ...
          // 'view report' link ...
          if (Options.allowAlterAR)
            msg.push("</div></td><TD class="+ colClass  +"><div><a onclick=' modal_alliance_report_view(\"");   // 

ONCLICK ???
          else
            msg.push("</div></td><TD class="+ colClass  +"><div><a onclick=' $(\"modal_alliance_reports_tabledivNKA

\").id=\"modal_alliance_reports_tablediv\"; modal_alliance_report_view(\"");   // ONCLICK ???
          msg.push(rpt.reportId);
          msg.push('",');
  ...
  e_eachMinute : function (){   
    ...
    for(i=0; i < Cities.numCities; i++) {
      ...
      if (timeLeft<0){
        ...
        var msg = '';
        msg += 'Nella mia cittÃ  ' + Cities.cities[i].name.substring(0,10);
        msg += ' (' + Cities.cities[i].x +','+ Cities.cities[i].y + ')';
        msg += ' Ã¨ quasi finito il cibo. Ne resta : '+addCommasWhole(foodleft);
...
var TowerAlerts = {
  ...
  init : function (){
    ...
    t.viewImpendingFunc = new CalterUwFunc ('attack_viewimpending_view', [[/Modal.showModal\((.*)\)/im, 

'Modal.showModal\($1\); ptViewImpending_hook(a);']]);
...
= ptGenerateIncoming_hook(); }']]);
  ...
  viewImpending_hook : function (atkinc){    
    ...
    if (!isFalse){
      ...
      d.innerHTML = '<BR><TABLE><TR><TD><a id=towerPostToChat class=button20><span>Post to Alliance 

Chat</span></a></td></tr></table>';
      div.appendChild (d);
      document.getElementById('towerPostToChat').addEventListener('click', function (){t.e_buttonPostToChat(atkinc)}, 
    ...
    if ( city.tileId == m.toTileId )
      ...
      for (k in Seed.wilderness['city'+m.toCityId]){
        if (Seed.wilderness['city'+m.toCityId][k].tileId == m.toTileId){
          target += ' in '+ Seed.wilderness['city'+m.toCityId][k].xCoord +','+ Seed.wilderness['city'+m.toCityId]
    ...
    if ( city.tileId == m.toTileId ){
      ...
      if (emb.count > 0){
        ...
        for (k in Seed.queue_atkinc){
          if (Seed.queue_atkinc[k].marchType==2 && Seed.queue_atkinc[k].toCityId==m.toCityId && Cities.byID
...
Tabs.AllianceList = {
  ...
  init : function (div){
    ...
    var m = '<DIV class=ptentry><TABLE width=100% cellpadding=0>\
        <TR><TD class=xtab align=right></td><TD class=xtab>Inserisci il nome o una parte del nome del giocatore: 

&nbsp;</td>\
          <TD width=80% class=xtab><INPUT id=allPlayName size=20 type=text /> &nbsp; <INPUT id=playSubmit type=submit 

value="Cerca Giocatore" /></td>\
        ...
        <TR><TD class=xtab>OR: </td><TD class=xtab> Inserisci il nome o una parte del nome dell\'alleanza: &nbsp;</td>\
          <TD class=xtab><INPUT id=allAllName type=text /> &nbsp; <INPUT id=allSubmit type=submit value="Cerca 
...
Alleanza" /></td>\
    ...
    document.getElementById('allAllName').addEventListener ('focus', function (){document.getElementById

('ptallErr').innerHTML='';}, false);
    document.getElementById('allPlayName').addEventListener ('focus', function (){document.getElementById

('ptplayErr').innerHTML='';}, false);
  ...
  eventGotPlayerList : function (rslt){
    ...
    for (k in rslt.matchedUsers){
      ...
      if (++row % 2)
        ...
        cl = '';
      m += '<TR '+ cl +'valign=top><TD>'+ u.genderAndName +'</td><TD>'+u.userId+'</td><TD align=right>'+ addCommasInt

(u.might) +'</td>\
          <TD align=center><A target="_tab" href="http://www.facebook.com/profile.php?id='+ u.fbuid 

+'">profile</a></td>\
          <TD><SPAN onclick="PTpd(this, '+ u.userId +')"><A>details</a> &nbsp; <BR></span><SPAN onclick="PTpl(this, 

\''+ u.userId +'\')"><A>leaderboard</a></span> &nbsp; <BR></span><SPAN onclick="PCpo(this, \''+ u.userId 

+'\')"><A>onlinestatus</a></span>&nbsp; <BR></span><SPAN onclick="PCplo(this, \''+ u.userId +'\')"><A>last 
...
Login</a></span></td></tr>';
  ...
  gotPlayerLeaderboard : function (rslt, span){
    ...
    m = '<TABLE cellspacing=0 class=ptTab><TR><TD><B>Leaderboard: </b></td><TD colspan=2> Might: '+ p.might  +' &nbsp; 
...
Alliance: '+ an +'</td></tr>'; 
    for (var i=0; i<p.cities.length; i++){
      ...
      +' (<a onclick="ptGotoMap ('+ c.xCoord +',' +c.yCoord+ ')">'+ c.xCoord +','+ c.yCoord +'</a>)</td><TD width=75%> 
...
'
  ...
  eventGotAllianceList : function (rslt){
    ...
    <TABLE><TR style="font-weight:bold"><TD class=xtab>Alliance Name</td><TD class=xtab>Rank</td><TD 

class=xtab>Members</td>\
    ...
    for (k in rslt.alliancesMatched){
      ...
      if (all.relation && all.relation==1)
        ...
        dip = 'Hostile';
      m += '<TR><TD class=xtab>'+ all.allianceName +'</td><TD align=right class=xtab>'+ all.ranking +'</td><TD 

align=right class=xtab>'+ all.membersCount +'</td>\
    ...
    for (var i=0; i<rslt.results.length; i++){
      ...
      if (p.userId == 0){
        ...
        for (var c=0; c<p.cities.length; c++){
          t.dat.push ([p.displayName, parseInt(p.might), p.officerType, parseInt(p.numCities), parseInt(p.cities
...
[c].tileLevel),
  ...
  eventGotOtherAlliancePage : function (rslt){
    ...
    for (var i=0; i<rslt.otherAlliances.length; i++) {
      ...
      m += '<TR class="pt'+ dip + '"><TD class=xtab>' + alliance.name +'</td><TD align=right class=xtab>'+ 

alliance.ranking +'</td><TD align=right class=xtab>'+ alliance.membersCount +'</td>\
	...
	if  (t.curPage > 1) {
		m +=' &nbsp;<a onclick="PCalClickPrev(-1)"> [|<] </a> &nbsp;<a onclick="PCalClickPrev(1)"> [<] 
...
&nbsp;';
  ...
  reDisp : function (){
    ...
    for (var i=0; i<t.dat.length; i++){
      ...
      m += '<TR style="max-height:30px"><TD class='+ tabclass +'>'+ t.dat[i][0] +'</td><TD align=right class='+ 

tabclass +'>'+ addCommasInt(t.dat[i][1]) +'</td><TD align=center class='+ tabclass +'>'+ t.dat[i][3] +'</td>\
            <TD class='+ tabclass +'>'+ officerId2String(t.dat[i][2]) +'</td><TD class='+ tabclass +'>'+ t.dat[i][7] 

+'</td><TD align=right class='+ tabclass +'>'+ t.dat[i][4] +'</td>\
            <TD align=center class='+ tabclass +'><DIV onclick="ptGotoMap('+ t.dat[i][5] +','+ t.dat[i][6] +')"><A>'+ 

t.dat[i][5] +','+ t.dat[i][6] +'</a></div></td>\
            <TD align=right class='+ tabclass +' style="padding-right:20px;">'+ t.dat[i][8].toFixed(2) +'</td>\
			<td class='+ tabclass +'><SPAN onclick="PCpo(this, \''+t.dat[i][9] 

+'\')"><A>onlinestatus</a></span></td>\
			<td class='+ tabclass +'><SPAN onclick="PCplo(this, \''+ t.dat[i][9] +'\')"><A>last 
...
//new CtableToText('tabAllMembers').toText();
  ...
  displayMembers : function (allName, numPlayers){
    ...
    var m = '<STYLE>.clickable{background-color:#ddd; border:2px outset; border-color:#555; padding-left:5px; padding-
...
right:5px}\
      ...
      <DIV class=ptstat><TABLE id=tabAllMembers cellpadding=0  width=100%><TR font-weight:bold"><TD class=xtab> &nbsp; 

'+ allName +'</td>\
        <TD class=xtab width=80% align=center>Distance is from <SPAN id=distFrom>'+ Cities.cities[0].name +' ('+ 

Cities.cities[0].x +','+ Cities.cities[0].y +')</span></td><TD class=xtab align=right>'+ numPlayers +' players found 

&nbsp; </td></tr></table></div>\
      <TABLE id=tabAllMembers align=center cellpadding=0 cellspacing=0><THEAD>\
      <TR style="font-weight:bold"><TD id=clickCol0 onclick="PTalClickSort(this)" 

class=clickable><A><DIV>Player</div></a></td>\
      ...
      <DIV style="top:670px; left:0px; position:static; width:100%;  background-color:#ffffff; border-top:1px solid; 

margin-top:8px; color:#700; font-weight:bold;">\
    ...
    document.getElementById('altInput').innerHTML = '<HR><TABLE width=100% cellpaddding=0><TR align=center>\
        <TD class=xtab>Show distance from: &nbsp; X: <INPUT size=2 type=text id=plyrX /> Y: <INPUT size=2 type=text 

id=plyrY /> &nbsp; Or, choose city: <span id=dmcoords></span></td></tr></table>';
    document.getElementById('clickCol'+t.sortColNum).className = 'clickable clickableSel';
    t.reDisp();
    new CdispCityPicker ('plyrdcp', document.getElementById ('dmcoords'), true, t.eventCoords, 0).bindToXYboxes

(document.getElementById('plyrX'), document.getElementById('plyrY'));
  },
  ...
  fetchAllianceList : function (allianceName, myAid, notify) {   // at least 3 chars :)
    ...
    function combineResults (rsltA, rsltM, notify){
      ...
      if (rsltM.ok){
        rsltA.alliancesMatched['a'+rsltM.allianceInfo.allianceId] = {allianceId: rsltM.allianceInfo.allianceId, 
...
Tabs.Test = {
  ...
  init : function (div){
    ...
    var m = '<TABLE><TR><TD align=right>Eaplorazione: </td><TD><INPUT type=checkbox id=fakeIsScout></td></tr>\
		...
		<TR><TD align=right># di S. Semplici: </td><TD><INPUT type=text size=6 value=0 

id=faketroop1></td></tr>\
		<TR><TD align=right># di Esploratori: </td><TD><INPUT type=text size=6 value=0 

id=faketroop2></td></tr>\
		  <TR><TD align=right># di Lancieri: </td><TD><INPUT type=text size=6 value=0 id=faketroop3></td></tr>\
		  <TR><TD align=right># di Spadaccini: </td><TD><INPUT type=text size=6 value=0 

id=faketroop4></td></tr>\
		  <TR><TD align=right># di Arcieri: </td><TD><INPUT type=text size=6 value=0 id=faketroop5></td></tr>\
		  <TR><TD align=right># di Cavallini: </td><TD><INPUT type=text size=6 value=0 

id=faketroop6></td></tr>\
		  <TR><TD align=right># di Cavalloni: </td><TD><INPUT type=text size=6 value=0 
...
id=faketroop7></td></tr>\
		  ...
		  <TR><TD align=right># di Catapulte: </td><TD><INPUT type=text size=6 value=0 

id=faketroop11></td></tr>\
		  <TR><TD align=right>Nome di chi ti attaca: </td><TD><INPUT type=text size=13 value=oftheNOOBS 

id=fakeName></td></tr>\
		  <TR><TD align=right>Coordinate CittÃ : </td><TD>'+citySelect+'</td></tr>\
        <TR><TD colspan=2 align=center><INPUT id=testSendMarch type=submit value="Invia Attacco Falso" 

\></td></tr></table>\
        <INPUT id=ptReloadKOC type=submit value="Riavvia KOC" \>\
        <BR><DIV id=testDiv style="background-color:#fffff0; maxwidth:675; max-height:430px; height:430px; overflow-
...
y:auto;"></div>';
  ...
  reloadKOC : function (){
    ...
    var t = '<FORM target="_top" action="'+ goto +'" method=post><INPUT id=xxptButReload type=submit 

value=RELOAD><INPUT type=hidden name=s value="'+ getServerId() +'"</form>';
...
Tabs.Info = {
  ...
  init : function (div){
    ...
    m = '<STYLE>.xtabH {background:#ffffe8; border:none; padding-right: 5px; padding-left: 5px; margin-left:10px; }\
            .xtabHL { background:#ffffe8; border-width: 1px; border-style: none none none solid; padding-right:5px; 

padding-left:5px; margin-left:10px; }\
            .xtabL { background:none; border-width: 1px; border-style: none none none solid; padding-right:5px; 

padding-left: 5px; margin-left:10px; }\
            .xtabLine { padding:0px; spacing:0px; height:1px; border-color:black; border-width: 1px; border-style: none 

none solid none }</style>\
        <DIV style="height:650px; max-height:650px; overflow-y:auto; overflow-x:hidden"><DIV class=ptstat>INFORMAZIONI 

SULLE UNITA\'</div><TABLE align=center cellpadding=1 cellspacing=0>\
        <TR align=center><TD class=xtab></td><TD class=xtabHL colspan=5><B>COSTO COSTRUZIONE</b></td><TD class=xtabHL 

colspan=7><B>STATISTICHE</b></td><TD class=xtabHL><B>Consumo</b></td></tr>\
        <TR valign=bottom align=right><TD class=xtab></td><TD class=xtabHL>Cibo</td><TD class=xtabH>Legna</td><TD 

class=xtabH>Pietre</td>\
        <TD class=xtabH>Miner.</td><TD class=xtabH>Popol.</td><TD class=xtabHL>Pot.</td><TD class=xtabH>Vita</td><TD 

class=xtabH>Att.o</td><TD class=xtabH>Dif.</td><TD class=xtabH>Vel.</td><TD class=xtabH>Range</td><TD 

class=xtabH>Carico</td>\
        <TD class=xtabHL>Cibo</td></tr>\
        <TR style="height:1px;"><TD style="padding:0px; spacing:0px; height:1px; border-color:black; border-width: 1px; 

border-style: none none solid none" colspan=14></td></tr>';
    for (ui=1; ui<13; ui++){
      if (++rownum % 2)
        rsty = '';
      else
      ...
      m += '<TR '+ rsty +'align=right><TD class=xtab align=left><B>'+ cost[0].substr(0,16) +'</b></td><TD 

class=xtabL>'+ cost[1] +'</td><TD class=xtab>'+ cost[2] +'</td>\
          <TD class=xtab>'+ cost[3] +'</td><TD class=xtab>'+ cost[4] +'</td><TD class=xtab>'+ cost[6] +'</td><TD 

class=xtabL>'+ might +'</td>\
          <TD class=xtab>'+ stats[0] +'</td><TD class=xtab>'+ stats[1] +'</td><TD class=xtab>'+ stats[2] +'</td><TD 

class=xtab>'+ stats[3] +'</td>\
    ...
    for (k in unsafeWindow.fortcost){
      ...
      m += '<TR '+ rsty +'align=right><TD align=left class=xtab><B>'+ name +'</b></td><TD class=xtabL>'+ cost[1] 

+'</td><TD class=xtab>'+ cost[2] +'</td>\
          <TD class=xtab>'+ cost[3] +'</td><TD class=xtab>'+ cost[4] +'</td><TD class=xtab>'+ cost[6] +'</td><TD 
...
var crestreq = { 3:{1101:4, 1102:2, 1103:1},
 ...
 m += '<DIV class=ptstat>RICERCA ELMI</div><TABLE align=center cellpadding=1 cellspacing=0>\
	  ...
	  <TR style="height:1px;"><TD style="padding:0px; spacing:0px; height:1px; border-color:black; border-width: 

1px; border-style: none none solid none" colspan=14></td></tr>';
	  rownum = 0;
	  for(k in crestreq){
	  if (++rownum % 2)
        rsty = '';
 ...
 m += '</TABLE>';
	//End crest info
    m += '<BR><DIV class=ptstat>CALCOLA DISTANZA</div><DIV class=ptentry><TABLE align=center cellpadding=1 

cellspacing=0>\
      <TR><TD class=xtab align=right><B>Coord. Partenza: </b></td><TD  class=xtab> X: <INPUT id=calcX type=text\> Y: 

<INPUT id=calcY type=text\> oppure seleziona la cittÃ : <SPAN id=ptloc1></span></td></tr>\
      <TR><TD class=xtab><B>Coord. Arrivo: </b></td><TD class=xtab> X: <INPUT id=calcX2 type=text\> Y: <INPUT id=calcY2 

type=text\> oppure seleziona la cittÃ : <SPAN id=ptloc2></span></td></tr></table>\
      <CENTER><DIV style="width:60%; font-size:14px; border: 1px solid; background-color:white; margin:20px 3px 3px 

0px; padding:4px" id=ptdistout></div></div>\
      <BR><BR><DIV class=ptstat>MAPPA PROVINCE</div><DIV id=ptProvMap><IMG width=680 height=654 SRC="'+ 

URL_PROVINCE_MAP +'"></div></center>';

    t.cont.innerHTML = m;
    new CdispCityPicker ('ptloc1', document.getElementById('ptloc1'), true, t.eventLocChanged, 0).bindToXYboxes

(document.getElementById('calcX'), document.getElementById('calcY'));
    new CdispCityPicker ('ptloc2', document.getElementById('ptloc2'), true, t.eventLocChanged, 0).bindToXYboxes

(document.getElementById('calcX2'), document.getElementById('calcY2'));
...
//    ce.style.top = (off.top+y+provMapCoords.topMargin-eMap.offsetHeight) +'px';      
  ...
  eventLocChanged : function (city, x, y){
    ...
    var m = 'La distanza da '+ x1 +','+ y1 +' a '+ x2 +','+ y2 +' Ã¨: &nbsp;<B>'+ distance (x1, y1, x2, y2).toFixed(2) 
  ...
  init : function (div){
    ...
    try {      
      m = '<TABLE class=ptTab>\
        ...
        <TR><TD><INPUT id=ptAllowWinMove type=checkbox /></td><TD>Attiva il movimento della finestra (ti permette di 

muovere la finestra de \'BAD BOYS\' col mouse)</td></tr>\
        <TR><TD><INPUT id=togWhisperOn type=checkbox /></td><TD>Attiva il Sussuro Audio <SPAN class=boldRed>&nbsp;

(NUOVO)</span></td></tr>\
        <TR><TD><INPUT id=ptHideOnGoto type=checkbox /></td><TD>Fai sparire questa finestra quando si clicca sulle 

coordinate sulla mappa. <SPAN class=boldRed>&nbsp;(NUOVO)</span></td></tr>\
        <TR><TD><INPUT id=ptEnableFoodWarn type=checkbox /></td><TD>Visualizza \"l\'autonomia del cibo\" in ROSSO se il 

cibo Ã¨ inferiore a \
            <INPUT id=optFoodHours type=text size=3 value="'+ Options.foodWarnHours +'"> ore. QUESTA OPZIONE POSTA IN 

CHAT L\'AVVISO !</td></tr>\
        <TR><TD colspan=2><P><B>Caratterizza KofC:</b></td></tr>\
        <TR><TD><INPUT id=togMsgCountFix type=checkbox /></td><TD>Visualizza il numero di messaggi separatamente dal 

numero di reports sull\'icona messaggi.</td></tr>';
		if (ENABLE_ALERT_TO_CHAT){
	 m += '<TR><TD><INPUT id=alertEnable type=checkbox '+ (Options.alertConfig.aChat?'CHECKED ':'') 

+'/></td><TD>Posta automaticamente l\'attacco in chat alleanza.</td></tr>\
          <TR><TD></td><TD><TABLE cellpadding=0 cellspacing=0>\
          <TR><TD align=right>Prefisso messaggio: &nbsp; </td><TD><INPUT id=alertPrefix type=text size=60 maxlength=120 

value="'+ Options.alertConfig.aPrefix +'" \></td></tr>\
          <TR><TD align=right>Allerta se mi esplorano: &nbsp; </td><TD><INPUT id=alertScout type=checkbox '+ 

(Options.alertConfig.scouting?'CHECKED ':'') +'/></td></tr>\
          <TR><TD align=right>Alleerta se attaccano le miet terre: &nbsp; </td><TD><INPUT id=alertWild type=checkbox '+ 

(Options.alertConfig.wilds?'CHECKED ':'') +'/></td></tr>\
          <TR><TD align=right>Posta la diplomazia tra le nostre alleanze: &nbsp; </td><TD><INPUT id=alertAlliance 

type=checkbox '+ (Options.alertConfig.includealliance?'CHECKED ':'') +'/></td></tr>\
          <TR><TD align=right>Posta il potere di chi attacca: &nbsp; </td><TD><INPUT id=alertMight type=checkbox '+ 

(Options.alertConfig.includemight?'CHECKED ':'') +'/></td></tr>\
          <TR><TD align=right>Avvisami con un suono: &nbsp; </td><TD><INPUT id=alertSound type=checkbox '+ 

(Options.alertConfig.sound?'CHECKED ':'') +'/></td></tr>\
          <TR><TD align=right>Minimo numero di truppe: &nbsp; </td><TD><INPUT id=alertTroops type=text size=7 value="'+ 

Options.alertConfig.minTroops +'" \> &nbsp; &nbsp; <span id=alerterr></span></td></tr>\
          </table></td></tr>';
		  }
      m += '<TR><TD><INPUT id=togAllRpts type=checkbox /></td><TD>Abilita il report dei rinforzi in chat 

alleanza.</td></tr>\
        <TR><TD><INPUT id=togAllowAlter type=checkbox /></td><TD>Consenti agli altri scripts di cambiare il formato dei 

reports in chat alleanza.</td></tr>\
        <TR><TD><INPUT id=togEnhanceMsging type=checkbox /></td><TD>Abilita altri pulsanti nei messaggi (pulsante 

"forward" e "all officers").</td></tr>\
        <TR><TD><INPUT id=togPageNav type=checkbox /></td><TD>Rafforza la navigazione dei messaggi e dei 

reports.</td></tr>\
        <TR><TD><INPUT id=togWarnZero type=checkbox /></td><TD>Avvisa se stai mandando un attacco alle coordinate 

0,0.</td></tr>\
        <TR><TD><INPUT id=togGmtClock type=checkbox /></td><TD>Abilita l\'orologio GMT dopo il "Camelot Time" <SPAN 

class=boldRed>&nbsp;(NOUVO)</span></td></tr>\
        <TR><TD><INPUT id=togChatStuff type=checkbox /></td><TD>Abilita opzioni supplementari (coordinate cliccabili, 

messaggi globali in viola, click sull\'icona per bisbigliare) <SPAN class=boldRed>&nbsp;(NUOVO)</span></td></tr>\
        <TR><TD><INPUT id=togAttackPicker type=checkbox /></td><TD>Abilita le coordinate della cittÃ  dell\'attacco 

(rinfozi, riassigna e transporto) <SPAN class=boldRed>&nbsp;(NUOVA opzione)</span></td></tr>\
        <TR><TD><INPUT id=togBatRounds type=checkbox /></td><TD>Visualizza il numero di round nei repots delle 

battaglie <SPAN class=boldRed>&nbsp;(NUOVO)</span></td></tr>\
        <TR><TD><INPUT id=togAtkDelete type=checkbox /></td><TD>Abilita il pulsante DELETE nei repots di battaglia<SPAN 

class=boldRed>&nbsp;(NUOVO)</span></td></tr>\
        <TR><TD colspan=2><BR><BR><B>KofC Bug Fixes:</b></td></tr>\
        <TR><TD><INPUT id=togTowerFix type=checkbox /></td><TD>Correggi i repots della torre per visualizzare 

esattamente gli obbiettivi (cittÃ , terre o non valide)</td></tr>\
        <TR><TD><INPUT id=togMapDistFix type=checkbox /></td><TD>Correggi la mappa per visualizzare correttamente le 

distanze dalla cittÃ  selezionata, invece che sempre dalla prima cittÃ .</td></tr>\
        <TR><TD><INPUT id=togTowerFix2 type=checkbox /></td><TD>Correggi i falsi attacchi creati da semplici 

esplorazioni.</td></tr>\
        <TR><TD><INPUT id=togKnightSelect type=checkbox /></td><TD>Non selezionare automaticamente un cavaliere quando 

si cambia da attacco a esplorazione, transporto o riassegna <SPAN class=boldRed>(NUOVO)</span></td></tr>\
        <TR><TD><INPUT id=togCoordBox type=checkbox /></td><TD>Mantieni il riquadro delle coordinate della mappa sopra 

le attivitÃ  dela truppa <SPAN class=boldRed>(NUOVO)</span></td></tr>\
        </table><BR><BR><HR>Nota : se l\'opzione Ã¨ in grigio probabilmente hanno modificato il codice di KofC, questo 

rende l\'opzione non piÃ¹ disponibile.';
      t.cont.innerHTML = m;
      ...
      t.togOpt ('togTowerFix2', 'fixTower2', TowerAlerts.enableFixFalseReports, 

TowerAlerts.isFixFalseReportsAvailable);
      ...
      var checkbox = document.getElementById('togAllRpts');
       ...
       checkbox.addEventListener ('change', function() {Options.enhanceARpts=document.getElementById

('togAllRpts').checked; saveOptions(); AllianceReports.enable(Options.enhanceARpts);}, false);
...
Tabs.Cerca = {
  ...
  init : function (div){
    ...
    t.cont = div;
    t.cont.innerHTML = '\
      <DIV class=ptentry><table><tr><td><TABLE><TR valign=bottom><TD class=xtab width=100 align=right>Ricerca per: 

</td><TD>\
      <SELECT id="srcType">\
        <OPTION value=0>Campi Barbari</option>\
        <OPTION value=1>Terre Selvagge</option>\
		<OPTION value=2>CittÃ </option>\
      </select></td></tr>\
      </table>\
      <DIV id="srcOpts" style="height:100px"></div></td><td style="visibility:hidden"><DIV id=divOutOpts 

style="background:#e0e0f0; padding:10px ;visibility:hidden"></div></td></tr></table></div>\
	...
	m += '</td></tr><TR><TD class=xtab align=right>Distanza Max: </td><TD class=xtab><INPUT id=srcDist size=4 

value=10 /> &nbsp; <SPAN id=spInXY></span></td></tr>';
    ...
    new CdispCityPicker ('srchdcp', document.getElementById('spInXY'), true, null, 0).bindToXYboxes

(document.getElementById ('srchX'), document.getElementById ('srchY'));
...
clickedPlayerDetail : function (span, uid){
  ...
  gotPlayerLeaderboard : function (rslt, span){
    ...
    if (rslt.totalResults == 0){
      span.innerHTML = '<B>Informazioni:</b> Non trovato! (sarÃ  nascosto sotto nebbia ?)';
      return;
    }
    var p = rslt.results[0];
    var an = p.allianceName;
    if (!an || an=='' || p.officerType==4)
      ...
      an += ' ('+ officerId2String(p.officerType) +')';
    m = '<TABLE cellspacing=0 class=ptTab><TR><TD><B>Informazioni: </b></td><TD colspan=2> Potere: '+ p.might  +' 

&nbsp; Alleanza: '+ an +'</td></tr>'; 
    for (var i=0; i<p.cities.length; i++){
      var c = p.cities[i];
      m += '<TR><TD align=right><B>CittÃ  #'+ (i+1) +':</b></td><TD> &nbsp; '+ c.cityName +' '+coordLink (c.xCoord, 

c.yCoord)+'</td><TD width=75%> &nbsp; livello: '
        + c.tileLevel +' &nbsp; &nbsp; stato: '+ cityStatusString (c.cityStatus) +' &nbsp; &nbsp; creata: ' + 
...
c.dateCreated.substr(0,10) +'</td></tr>';
  ...
  gotPlayerDetail : function (rslt, span){
    ...
    if (u.allianceName)
      a = u.allianceName +' ('+ getDiplomacy(u.allianceId) + ')';
    var m = '<TABLE cellspacing=0 class=ptTab><TR><TD><B>Dettagli:</b> &nbsp; </td><TD>Alleanza: '+ a +' &nbsp; CittÃ : 
...
//End edit city search
  ...
  clickedSearch : function (){
    ...
    m = '<DIV class=ptstat><TABLE width=100% cellspacing=0><TR><TD class=xtab width=125><DIV 

id=statSearched></div></td>\
      ...
      <TABLE width=100%><TR><TD><DIV id=divOutTab style="width:100%; height:470px; max-height:470px; overflow-
...
y:auto;"></div></td></tr></table>';
    ...
    m = '<CENTER><B>Ricerca per '+ typeName +'<BR>\
        ...
        <DIV class=ptentry><TABLE cellspacing=0 width=100%><TR align=center><TD class=xtab colspan=10><B>LISTA 

OPZIONI:</b><BR></td></tr>';
	if (t.opt.searchType == 1 || t.opt.searchType == 0) {
      m += '<TR><TD class=xtab align=right>Livello Min. da cercare:</td><TD class=xtab> <INPUT id=filMinLvl size=2 

value='+ Options.srcMinLevel +' /></td></tr>\
        <TR><TD class=xtab align=right>Livello Max. da cercare:</td><TD class=xtab> <INPUT id=filMaxLvl size=2 value='+ 

Options.srcMaxLevel +' /></td></tr>';
	}
    if (t.opt.searchType == 1){
      m += '<TR><TD class=xtab align=right>Tipo di Terre:</td><TD class=xtab><SELECT id=filWildType>';
      m += htmlOptions ( {1:'Radure/Laghi', 3:'Foreste', 4:'Colline', 5:'Montagne', 6:'Pianure', 0:'TUTTE'}, 

Options.wildType );
      m += '</select></td></tr><TR><TD class=xtab align=right>Solo Non Conquistate:</td>\
			<TD class=xtab><INPUT id=filUnowned type=CHECKBOX '+ (Options.unownedOnly?' CHECKED':'') 

+'\><td></tr>';
    }
	if (t.opt.searchType == 1 || t.opt.searchType == 0) {
	  m += '<TR><TD class=xtab align=right>Ordina per:</td><TD class=xtab><SELECT id=filSortBy>\
				<OPTION value="level" '+ (Options.srcSortBy=='level'?'SELECTED':'')  

+'>Livello</option>\
				<OPTION value="level" '+ (Options.srcSortBy=='dist'?'SELECTED':'')  

+'>Distanza</option>\
            </select></td></tr>\
            <TR><TD class=xtab align=right>Visualizza solo Coordinate:</td><TD class=xtab><INPUT type=checkbox 

id=coordsOnly \></td></tr>\
            </table></div><BR><SPAN id=srchSizeWarn></span>';
	} else {
	 m += '<TR><TD class=xtab align=right>Tipo CittÃ :</td><TD class=xtab><SELECT id=filCities>';
     m += htmlOptions ( {1:'Tutte', 2:'Alleate', 3:'Amichevoli', 4:'Ostili', 5:'Neutrali', 6:'Senza Alleanza', 7:'Sotto 

Nebbie'}, Options.cityType );
     m += '</select></td></tr>';		
	 m += '<TR><TD class=xtab align=right>Ordina per:</td><TD class=xtab><SELECT id=filSortBy>\
		   ...
		   <TR><TD class=xtab align=right>Potere Min da visualizzare:</td><TD class=xtab><INPUT type=text 

id=minMight value='+Options.MightSrc+' size=3 \></td></tr>\
           <TR><TD class=xtab align=right>Visualizza solo Coordinate:</td><TD class=xtab><INPUT type=checkbox 
...
if (DEBUG_TRACE) logit (" 0 clickedSearch()... setTimeout ..:" + xxx +' , '+ yyy +' , '+ t.mapCallback.name);
  ...
  dispMapTable : function (){
    var tileNames = ['Campo Barbari', 'Radura', 'Lago', 'Foresta', 'Collina', 'Montagna', 'Pianura', 'CittÃ ' ];
    var t = Tabs.Cerca;
...
if (DEBUG_TRACE) DebugTimer.display('SEACHdraw: SORT');
      if (coordsOnly)
        m = '<TABLE align=center id=srcOutTab cellpadding=2 cellspacing=2><TR style="font-weight: 

bold"><TD>Coordinate</td></tr>';
      else {
        if (t.opt.searchType == 2) {
			m = '<TABLE id=srcOutTab cellpadding=2 cellspacing=2><TR style="font-weight: 

bold"><TD>Coordinate</td><TD >Distanza</td><TD>CittÃ </td><TD>Utente</td><TD>Potere</td><td>Alleanza               

</td><TD width=80% style="font-size:10px;">Altre Info</td><TD style="padding-left: 10px;"></td></tr>';
		} else { 
			m = '<TABLE id=srcOutTab cellpadding=2 cellspacing=2><TR style="font-weight: 

bold"><TD>Coordinate</td><TD style="padding-left: 10px">Distanza</td><TD style="padding-left: 10px;">Livello</td><TD 

width=80%> &nbsp; Tipo</td><TD style=""></td></tr>';
		}
	  }
      var numRows = dat.length;
      if (numRows > 500 && t.searchRunning){
        numRows = 500;
        document.getElementById('srchSizeWarn').innerHTML = '<FONT COLOR=#600000>NOTA: La Tabella visualizza solo 500 

risultati di '+ dat.length +'.</font>';
      }
      for (i=0; i<numRows; i++){
	    m += '<TR valign="top"';
		 if (dat[i][12]) m += 'class="pt'+dat[i][12]+'"';
        m += ' ><TD><DIV onclick="ptGotoMapHide('+ dat[i][0] +','+ dat[i][1] +')"><A>'+ dat[i][0] +','+ dat[i][1] 
...
+'</a></div></td>';
        if (coordsOnly)
          m += '</tr>';
			...
			if (t.opt.searchType == 2) { 
				 m += '<TD align="left"  valign="top">'+ dat[i][2].toFixed(2) +' &nbsp; </td><TD 

align=left>'+ dat[i][8] +'</td><TD valign="top">'+dat[i][9]+'</td><TD valign="top">'+dat[i][10]+'</td><td>'+dat[i]

[11]+'</td><td>';
				 if (dat[i][5]) {
					m += '<DIV onclick="PTscout('+ dat[i][0] +','+ dat[i][1] +');return false;"><A 

style="font-size:9px;" >Esploralo</a></div>';
				} else 
					m += '<DIV onclick="PTpd(this, '+ dat[i][7] +')"><A style="font-size:9px;" 

>Dettagli</a></div>\
					<DIV style="" onclick="PTpd2(this, '+ dat[i][7] +')"><A style="font-

size:9px;">Informazioni</a></div>\
					<DIV style="" onclick="PCpo2(this, '+ dat[i][7] +')"><A style="font-

size:9px;">Stato</a></div>\
					<DIV style="" onclick="PCplo2(this, '+ dat[i][7] +')"><A style="font-

size:9px;">Ultimo Accesso</a></div>';
					m+= '</td><TD  valign="top">'+ (dat[i][5]?' Sotto nebbie':'') +'</td></tr>';
			} else { 
          m += '<TD align=right>'+ dat[i][2].toFixed(2) +' &nbsp; </td><TD align=right>'+ dat[i][4] +'</td><TD> &nbsp; 
...
if (DEBUG_TRACE) logit (" 3 mapCallback()");
    ...
    for (k in map){
      ...
      if (dist <= t.opt.maxDistance){
		...
		t.mapDat.push ([map[k].xCoord, map[k].yCoord, dist, type, map[k].tileLevel, isMisted, map

[k].tileCityId, map[k].tileUserId, map[k].cityName,nameU,mightU,aU,aD ]);
			}
...
if (DEBUG_TRACE) logit (" 0 mapCallback()... setTimeout ..:" + x +' , '+ y +' , '+ t.mapCallback.toString().substr 
...
Tabs.Truppa = {
  ...
  init : function (div){
    ...
    s = "<DIV id=trainTopSelect>\
      <DIV class=ptstat>Truppare e Costruire le Difese delle Mura</div><DIV style='height:10px'></div><DIV 

class=ptentry>\
      <DIV style='text-align:center; margin-bottom:10px;'>Seleziona la CittÃ : &nbsp; <span 

id=ptspeedcity></span></div>\
      ...
      <TR><TD align=right>Numero di slots: </td><TD><INPUT id='ptttInpSlots' size=2 type='text' value='1'\></td>\
        <TD width=75%><INPUT id='ptttButMaxSlots' type=submit value='max'\> &nbsp; (max <span 

id=ptttSpMaxSlots>1</span>)</td></tr>\
      <TR><TD align=right valign=top>Seleziona come truppare: </td><TD colspan=2><INPUT type=CHECKBOX id=chkPop"+ 

(Options.maxIdlePop?' CHECKED ':'') +"> \
        <SPAN style='white-space:normal;'>Ti permette di truppare di piÃ¹, ma porta la popolazione in 

negativo.</span></td></tr>\
      <TR><TD colspan=3 align=center><DIV style='height:10px'></div><INPUT id='ptttButDo' type=submit value='Inizia a 
...
Truppare'\></td></tr>\
      ...
      <TR><TD align=right>Numero di slots: </td><TD><INPUT id='pttdInpSlots' size=2 type='text' value='1'\></td>\
        <TD width=75%><INPUT id='pttdButMaxSlots' type=submit value='max'\> &nbsp; (max <span 

id=pttdSpMaxSlots>1</span>)</td></tr>\
      <TR align=center><TD colspan=3><SPAN id=pttdSpace></span></td></tr>\
      <TR><TD colspan=3 align=center><DIV style='height:10px'></div><INPUT id='pttdButDo' type=submit value='Costruisci 

Difese'\></td></tr></table>\
      </td></tr></table></div></div>\
      <TABLE align=center width=425 class=ptTab><TR><TD><div id=ptTrainStatus style='overflow-y:auto; max-height:78px; 
...
height: 78px;'></div></td></tr></table>\
      ...
      <TR><TD width=50% style='padding-left:15px; padding-right:15px'><DIV style='text-align:center'><B>Coda Truppe 

&nbsp; (<SPAN id=statTTtot></span>)</b><BR><HR></div><DIV id=divSTleft style='overflow-y: auto; height:210px; max-

height:210px'></div></td>\
        <TD width=50% style='padding-left:15px; padding-right:15px'><DIV style='text-align:center'><B>Coda Difese 

&nbsp; (<SPAN id=statDTtot></span>)</b><BR><HR></div><DIV id=divSTright style='overflow-y: auto; height:210px; max-

height:210px'></div></td></tr>\
      </div>";
    t.cont.innerHTML = s;
...
if (t.limitingFactor){
  ...
  clickTroopDo : function (){
    ...
    if (perSlot<1){
      t.divTrainStatus.innerHTML = '<FONT COLOR=#550000>Il numero di truppe per slot deve essere maggiore di 

0.</font>';
      return;
    }
    if (perSlot*numSlots > t.stats.MaxTrain){
      t.divTrainStatus.innerHTML = '<FONT COLOR=#550000>Non posso accodare queste truppe (il max Ã¨ '+ t.stats.MaxTrain 
...
/*******  DEF  ******/  
  ...
  updateTopDef : function (){
    ...
    t.TDspSpace.innerHTML = 'Livello Mura: <B>'+ t.stats.wallLevel +'</b><BR>Spazio sulle Mura: '+ 
...
+')</font>';
  ...
  doDefQueue : function (cityId, que, errMsg){
    ...
    try {
      ...
      if (cmd[0] == 'T'){
        t.dispTrainStatus ('Accodamento '+ cmd[2] +' '+  fortNamesShort[cmd[1]] +' in '+ Cities.byID[cityId].name +' 

(restano '+ que.length +' slots)<BR>');
        doDefTrain ( cityId, cmd[1], cmd[2], 
          function(errMsg){
            t.trainTimer = setTimeout(function (){Tabs.Truppa.doDefQueue(cityId, que, errMsg);}, (Math.random()
...
*3500)+1500);
  ...
  displayCityStats : function (){
    ...
    if (Options.maxIdlePop)
      ...
      t.stats.idlePop = parseInt(Seed.citystats['city'+cityId].pop[0]) - parseInt(Seed.citystats['city'+cityId].pop

[3]);
    t.stats.barracks = getCityBuilding (cityId, 13).count;
    var m = '<CENTER><B>'+ Cities.byID[cityId].name +' &nbsp; ('+ Cities.byID[cityId].x +','+ Cities.byID[cityId].y 
...
m += '<TABLE class=ptTab width=100%><TR align=center>\
 ...
 m += '<TR align=center><TD width=8%>'+Seed.units['city'+cityId]['unt1']+'</td><TD width=8%>'+Seed.units
...
['city'+cityId]['unt2']+
 ...
 '<TD width=8%>'+Seed.units['city'+cityId]['unt11']+'</td><TD width=8%>'+Seed.units['city'+cityId]
...
//end of added21mar
    m += '<TABLE class=ptTab width=100%><TR align=center>\
        ...
        <TD width=16%><SPAN id=ptttr_pop><B>Popolazione :</b><BR>'+ addCommasInt(t.stats.idlePop) 
    ...
    if ( qs == t.lastQueString){
      ...
      if (q!=null && q.length>0 ){
        ...
        for (var i=0; i<q.length; i++){
          ...
          if (first)
            m += '</td><TD> &nbsp; '+  timestr(end-start, true) +'</td><TD> (<SPAN id=ptttfq>'+ timestr(actual, true) 
    ...
    if ( qs == t.lastDQueString){
      ...
      if (q!=null && q.length > 0 ){
        ...
        for (i=0; i<q.length; i++){
          ...
          if (first)
            m += '</td><TD> &nbsp; '+  timestr(end-start, true) +'</td><TD> (<SPAN id=pttdfq>'+ timestr(actual, true) 
...
+'</span>)';
  ...
  doQueue : function (cityId, que, errMsg){
    ...
    try {
      ...
      if (cmd[0] == 'T'){
        t.dispTrainStatus ('Accodamento '+ cmd[2] +' '+  unsafeWindow.unitcost['unt'+cmd[1]][0] +' in '+ Cities.byID

[cityId].name +' (restano '+ que.length +' slots)<BR>');
        doTrain (cityId, cmd[1], cmd[2], 
          function(errMsg){
            if (t.running)
              t.trainTimer = setTimeout(function (){Tabs.Truppa.doQueue(cityId, que, errMsg);}, (Math.random()
...
//DebugTimer.start(); 
    try {
      ...
      str = '<DIV class=ptstat style="margin-top:5px; margin-bottom:5px;"><TABLE cellspacing=0 cellpadding=0 

class=ptTab width=97% align=center>\
        ...
        <TD align=right><SPAN class=ptStatLight>Dominio:</span> ' + unsafeWindow.domainName 
...
+'</td></tr></table></div>';
      ...
      str += "<TABLE class="+ tabClass +" cellpadding=0 cellspacing=0><TR valign=top align=right><TD width=65></td><TD 

width=88 style='background: #ffc'><B>TOTALE</b></td>";
      for(i=0; i<Cities.numCities; i++) {
        str += "<TD width=81><B>"+ Cities.cities[i].name.substring(0,11) +'</b><BR>'+ coordLink (Cities.cities[i].x, 

Cities.cities[i].y) +"<BR>"+ unsafeWindow.provincenames['p'+ Cities.cities[i].provId] +"</td>";
      }
      if (Options.includeMarching)
	  ...
	  for(i=0; i<Cities.numCities; i++){
		...
		if(Gate == 0)
			...
			str += '<TD style=\'background: #CCFFCC\' ><SPAN class=boldRed><blink>In 

Difesa</blink></span></td>';
	  }
...
supply_t=militia_t=scout_t=pike_t=sword_t=archer_t=cavalry_t=heavy_t=wagon_t=ballista_t=ram_t=catapult_t=0 ;     
   	  	  for (var i=0; i<q.length; i++){
	    	switch(q[i][0])
	    	{
	      	case '1':
      ...
      str += '<TR><TD class=xtab></td><TD class=xtab colspan=4><BR><INPUT type=CHECKBOX id=idCheck'+ 

(Options.includeMarching?' CHECKED':'') +'>Includi Truppe e Risorse in marcia</td></tr>';
      str += '<TR><TD></td><TD colspan=4>PowerTools - BAD BOYS by genyel</td></tr>';
      str += "</table>";
      if (DEBUG_BUTTON)
...
Tabs.Marce = {
  ...
  init : function (div){
    ...
    t.cont = div;
    t.cont.innerHTML = '<TABLE class=ptTab align=center><TR><TD><INPUT class=pbSubtab ID=ptmrchSubA type=submit 
...
value=Attacchi></td>\
  ...
  showReinforcements : function (){
    var rownum = 0;
    var names = ['Truppe Trasporto', 'Soldati Semplici', 'Esploratori', 'Lancieri', 'Spadaccini', 'Arcieri', 

'Cavallini', 'Cavalloni', 'Carretti', 'Baliste', 'Arieti', 'Catapulte'];
    var t = Tabs.Marce;
    clearTimeout (t.displayTimer);
...
//logit ("enc: "+ inspect (enc, 6, 1));    
    ...
    if (numSlots == 0){
      ...
      s += '<TABLE cellspacing=0 width=100%><TR align=right><TD align=left width=16%><B>Giocatore (cavaliere)
...
// TODO: Only allow 'send home' if troops are here now  (marchStatus = ?)              
              s += '<TR align=right><TD align=left>'+ player + knight +' <A><SPAN onclick="r8x6Home('+ march.marchId 
...
+')">X</span></a></td>'
    ...
    s += '<BR><BR><DIV style="font-size: 10px">NOTA: Hai bisogno di refreshare  il KofC per visualizzare le nuove 

truppe accampate o quelle che restano dopo una battaglia.</div>';
  ...
  new Ajax.Request(g_ajaxpath + "ajax/kickoutReinforcements.php" + g_ajaxsuffix, {
    ...
    onSuccess: function(transport) {
      ...
      if (rslt.ok) {
        ...
        seed.resources["city" + currentcityid].rec1[3] = parseInt(seed.resources["city" + currentcityid].rec1[3]) - 
...
//logit ('loadPage_pagination: '+  divId +','+ t.cpPager.divId +','+ currentPage +','+ callbackFunction +','+ 

totalPages +','+ t.cpPager.getCurrentPage()); 
  ...
  Cpager : function (a, b){
    ...
    function getHtmlElement (){
      function aButton (msg, evtPage){
        return '<A class=ptPageNav onclick="pageNavigatorView.e_but(\''+ evtPage +'\')"><SPAN class=ptPageNav>'+ msg 
...
+'</span></a>';
      ...
      div.innerHTML = '<STYLE>table.ptPageNav tr td  {border:none; text-align:center; padding:0px 1px;}\
        ...
        A.ptPageNav {background-color:#44e; color:#ff4; display:block; border:1px solid #666666; height:18px; 
...
width:18px;}\
        ...
        <TD style="margin-right:15px">'+ aButton('<SPAN style="padding-right:0.8em; letter-spacing:-

0.99em;">&#x258f;&#x258f;&#x25c4;</span>', 'F') +'</td>\
        <TD>'+ aButton('&#x25c4', '-') +'</td>\
        <TD>'+ aButton('&#x25ba', '+') +'</td>\
        <TD style="margin-right:15px">'+ aButton('<SPAN style="padding-right:1.05em; letter-spacing:-

0.99em;">&#x25ba;&#x2595;&#x2595;</span>', 'L') +'</td>\
        <TD width=20></td><TD>Page <INPUT id=ptPagerPageNum onChange="pageNavigatorView.e_inp()" type=text size=1> OF 

<span id=ptPagerNumPages>?</span></td>\
        </tr></table>';
...
var WarnZeroAttack = {
  ...
  hook : function (){
    ...
    && parseIntZero(document.getElementById('modal_attack_target_coords_y').value) == 0){
      new CdialogCancelContinue ('<SPAN class=boldRed>Stai mandando un\'attacco alle coordinate 0,0!</span>', null, 

unsafeWindow.modal_attack_check, document.getElementById('modalInner1'));      
    } else {
...
var tabManager = {
  ...
  init : function (mainDiv){
    ...
    for (var i=0; i<sorter.length; i++)
      m += '<TD class=spacer></td><TD class=notSel id=pttc'+ sorter[i][1].name +' ><A><SPAN>'+ sorter[i][1].label 
...
function CdialogCancelContinue (msg, canNotify, contNotify, centerElement){
  ...
  pop.getTopDiv().innerHTML = '<CENTER>KOC Power Tools - BAD BOYS</center>';
  pop.getMainDiv().innerHTML = '<TABLE class=ptTab align=center style="height: 100%"><TR align=center height=90%><TD>'+ 

msg +'</td></tr>\
      <TR align=center><TD><INPUT id=ptcccancel type=submit value="CANCELLA" \> &nbsp; &nbsp; <INPUT id=ptcccontin 

type=submit value="CONTINUA" \></td></tr></table>';
...
function dialogRetry (errMsg, seconds, onRetry, onCancel){
  ...
  pop.getTopDiv().innerHTML = '<CENTER>KOC Power Tools - BAD BOYS</center>';
  pop.getMainDiv().innerHTML = '<CENTER><BR><FONT COLOR=#550000><B>Si Ã¨ verificato un errore:</b></font><BR><BR><DIV 

id=paretryErrMsg></div>\
      <BR><BR><B>Ci riprovo fra <SPAN id=paretrySeconds></b></span> secondi ...<BR><BR><INPUT id=paretryCancel 

type=submit value="CANCEL Retry" \>';
...
if (DEBUG_TRACE) logit (" 1b myAjaxRequest.mySuccess() !ok : "+ inspect(rslt, 3, 1));
    rslt.errorMsg = unsafeWindow.printLocalError((rslt.error_code || null), (rslt.msg || null), (rslt.feedback || 
...
'tech,tutorial,items,quests,wilderness,wildDef,buildings,knights,allianceDiplomacies,appFriends,players',
  ...
  doit : function (){ 
    ...
    if (t.popDebug == null){  
      ...
      t.popDebug.getMainDiv().innerHTML = '<DIV><INPUT type=submit id=dbsuball value=ALL> &nbsp; <INPUT type=submit 

id=dbsubnone value=NONE> &nbsp; \
        <INPUT type=submit id=dbdefaults value=DEFAULTS> &nbsp; <INPUT type=submit id=dbsubdo value=SHOW> &nbsp; <INPUT 

type=submit id=dbsubscripts value=SCRIPTS></div>\
...
function strButton20 (label, tags){
  if (tags == null)
    tags = '';
  return ('<TABLE class=ptNoPad><TR><TD><A class="button20 ptButton20" '+ tags +'><SPAN>'+ label 
...
function doTrain (cityId, unitId, num, notify){
  ...
  new MyAjaxRequest(unsafeWindow.g_ajaxpath + "ajax/train.php" + unsafeWindow.g_ajaxsuffix, {
    ...
    onSuccess: function(rslt) {
      if (rslt.ok) {
        for (var i = 1; i < 5; i++) {
          unsafeWindow.seed.resources["city" + cityId]["rec" + i][0] = parseInt(unsafeWindow.seed.resources["city" + 

cityId]["rec" + i][0]) - parseInt(unsafeWindow.unitcost["unt" + unitId][i]) * 3600 * parseInt(num)
        }
        unsafeWindow.seed.citystats["city" + cityId].gold[0] = parseInt(unsafeWindow.seed.citystats["city" + 

cityId].gold[0]) - parseInt(unsafeWindow.unitcost["unt" + unitId][5]) * parseInt(num);
        unsafeWindow.seed.citystats["city" + cityId].pop[0] = parseInt(unsafeWindow.seed.citystats["city" + 

cityId].pop[0]) - parseInt(unsafeWindow.unitcost["unt" + unitId][6]) * parseInt(num);
        unsafeWindow.seed.queue_unt["city" + cityId].push([unitId, num, rslt.initTS, parseInt(rslt.initTS) + time, 0, 
...
function debugPos  (e){
  return 'client - offset: '+ e.clientLeft +','+ e.clientTop +','+ e.clientWidth +','+ e.clientHeight
          +' - '+ e.offsetLeft +','+ e.offsetTop +','+ e.offsetWidth +','+ e.offsetHeight +' '+ e +' --OP--> '+ 
...
function CPopup (prefix, x, y, width, height, enableDrag, onClose) {
  ...
  var m = '<TABLE cellspacing=0 width=100% height=100%><TR id="'+ prefix +'_bar" class="'+ topClass +'"><TD width=99% 

valign=bottom><SPAN id="'+ prefix +'_top"></span></td>\
      <TD id='+ prefix +'_X align=right valign=middle onmouseover="this.style.cursor=\'pointer\'" style="color:#fff; 

background:#333; font-weight:bold; font-size:14px; padding:0px 5px">X</td></tr>\
      <TR><TD height=100% valign=top class="CPopMain '+ prefix +'_CPopMain" colspan=2 id="'+ prefix 
...
//t.dispEvent ('eventMOVE', me);
  ...
  function debug  (msg, e){
    ...
    logit ('offsetLeft, Top, Width, Height (parent): '+ e.offsetLeft +','+ e.offsetTop +','+ e.offsetWidth +','+ 

e.offsetHeight +' ('+ e.offsetParent +')');
    logit ('scrollLeft, Top, Width, Height: '+ e.scrollLeft +','+ e.scrollTop +','+ e.scrollWidth +','+ 
                    ...
                    if (bS[j].innerHTML == ' whispers to you:') {
                        ...
                        if (foundMsg == false) {
							...
							//	alert('have set message value');
                                ...
                                alertDiv.innerHTML = '<iframe src="http://corpr8.co.uk/newalert.html" height="20" 
