...
function get_history_url() {
    ...
    // 一般地址
    // http://www.quanlala.com/product/数字.html
    if (current_url.indexOf('http://www.360buy.com/product/') != -1) {
        return current_url.replace('360buy', 'quanlala');
    }
    ...
    history_url = "http://www.quanlala.com/product/" + product_uid + ".html";
    return history_url;
}
...
function get_history_image_url(text) {
    ...
    imgage_url = "http://www.quanlala.com" + text.match(reg);
    return imgage_url;
}
