// ==UserScript==
// @name Travian3 Beyond - just for Norway lang
...
lang_tr['ALIANZA']      = 'Birlik';
   ...
   // Norsk oversettelse av ThePirate (TheEvilPirate)
    ...
    lang_no['TALLER']       = 'V&#230;rksted';
    lang_no['ENVIAR']       = 'Send r&#229;stoffer';
    lang_no['COMPRAR']      = 'Kj&#248;p';
    lang_no['VENDER']       = 'Selg';
    lang_no['ENVIAR_IGM']   = 'Send IGM';
    lang_no['LISTO']        = 'Udvidelse tilgjengelig';
    lang_no['EL']           = 'den';
    lang_no['A_LAS']        = 'ved';
    lang_no['EFICIENCIA']   = 'Effektivitet';
    lang_no['NUNCA']        = 'Aldri';
    lang_no['PC']           = 'kultur poeng';
    lang_no['FUNDAR']       = 'Du kan grundlegge eller overta en ny by';
    ...
    lang_no['BUSCO']        = 'Selger';
    lang_no['TIPO']         = 'Type';
    lang_no['DISPONIBLE']   = 'Kun tilgjengelig';
    lang_no['CUALQUIERA']   = 'Alle';
    lang_no['SI']           = 'Ja';
    lang_no['NO']           = 'Nei';
    lang_no['MARCADORES']   = 'Lenke';
    lang_no['ANYADIR']      = 'Tilf&#248;y';
    lang_no['ENLACE']       = 'Ny lenke URL';
    lang_no['TEXTO']        = 'Ny lenke tekst';
    lang_no['ELIMINAR']     = 'Slett';
    lang_no['MAPA']         = 'Kart';
    lang_no['CHECK']        = 'Se etter ny version';
    lang_no['ARCHIVE']      = 'Arkiv';
    lang_no['RESUMEN']      = 'Forsett';
...
TODO:
	...
	- Traduccion a noruego, hongkones, esloveno y bosnio (please, use Unicode HTML entities like &#334; For example, use this converter http://konieczny.be/unicode.html )
