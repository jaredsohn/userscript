...
//							}
						...
						// ==================================================================
						if (false && options.get('auto_subscribe_news') && !options.get('auto_subscribe_news_done')) {
				...
				//				if (is_timeline()) { return; }
						...
						function fixStory(o,isPageOrProfile,isGroupWall) {
							...
							if (hide_trending) {
								var trending = QS(o,'.ogStaticPagerHeader,.ogStaticSlidePagerUserHeader,.ogSliderAnimPageHeader,.ogSliderAnimPager');
								if (trending) {
				...
				//						window.open('https://getpocket.com/save?url='+url+'&title='+title,'SocialFixerSaver','height=500&width=500');
						...
						onSelectorLoad('#rightCol .uiSideHeader h5, #pagelet_ego_pane .uiSideHeader h5, #MessagingNetegoSidebar .uiSideHeader h5, .UIStandardFrame_SidebarAds .uiSideHeader h5, #rightCol h3.uiHeaderTitle',function(o) {
						...
						onSelectorLoad('#rightCol',function(o) {
							...
							if (options && options.get('pagelet_toggle')) {
								...
								bind(o,'click',function(e) {
									var e = target(e);
									if (e.tagName=="H5" || e.tagName=="H4" || e.tagName=="H3" || hasClass(e,'bfb_sidebar_header_expand')) {
										var pagelet = e;
										var pagelet_id = null;
