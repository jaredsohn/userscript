// ==UserScript==
// @name           Ro-BOT ESPANOL Traducido por Luis KOC
// @version        20110527a-1.es
// @namespace      mat
...
var Options = {
  ...
  pbWideMap    : false,
  pbFoodAlert  : false,
  alertConfig  : {aChat:false, aPrefix:'** ATENCION ATENCION Estoy siendo atacado! **', scouting:false, wilds:false, defend:true, minTroops:10000, spamLimit:10, lastAttack:0 },
  ...
  spamconfig   : {aspam:false, spamvert:'Unete a mi Alianza!!', spammins:'10', atime:2 , spamstate:'a'},
...
// TODO: Make sure WinPos is visible on-screen ?
  ...
  AddMainTabLink('Ro-BOT ESPANOL', eventHideShow, mouseMainTab);
  kocWatchdog ();
  WideScreen.init ();
...
Tabs.tower = {
  ...
  init: function(div){
    ...
    var m = '<center><table width="200" border="1"><tr><td><!--Notificacion de version--><iframe src="http://negociodisponible.com/ads/image.php?size_id=3" width="238"  height="62"  scrolling="no" frameborder="0" marginheight="0"  marginwidth="0" vspace="0" hspace="0"></iframe><!--Fin Notificacion de version--></td><td><!--BANNER--><iframe src="http://negociodisponible.com/ads/image.php?size_id=2" width="480"  height="60"  scrolling="no" frameborder="0" marginheight="0"  marginwidth="0" vspace="0" hspace="0"><br /></iframe><!--FIN DEL BANNER--></td></tr></table></center><DIV class=pbStat>TORRE DE ALERTAS</div><TABLE class=pbTab><TR align=center>';
    ...
    m += '</tr></table><BR><DIV><CENTER><INPUT id=pbSoundStop type=submit value="Detener Sonido Alerta"></center></div><DIV id=pbSwfPlayer></div>';
    ...
    <td align=left>Mensaje de texto entrantes a un ataque: <INPUT id=pbnum1 type=text size=4 maxlength=4 value="'+ Options.celltext.num1 +'"  '+(Options.celltext.provider==0?'DISABLED':'')+'\>\
&nbsp;<INPUT id=pbnum2 type=text size=3 maxlength=3 value="'+ Options.celltext.num2 +'"  '+(Options.celltext.provider==0?'DISABLED':'')+'\>\
&nbsp;<INPUT id=pbnum3 type=text size=4 maxlength=4 value="'+ Options.celltext.num3 +'"  '+(Options.celltext.provider==0?'DISABLED':'')+'\> <span style="color:#800; font-weight:bold">(Tenga en cuenta las tarifas estándar de mensajes de texto)</span></td></tr><tr><td></td>\
 ...
 if(t.Providers[i].country == t.Providers[Options.celltext.provider].country)
    ...
    m += '</select></td></tr>\
        <TR><TD><INPUT id=pbalertEnable type=checkbox '+ (Options.alertConfig.aChat?'CHECKED ':'') +'/></td><TD>Automáticamente después de los ataques de entrada a la alianza de chat.</td></tr>\
        <TR><TD></td><TD><TABLE cellpadding=0 cellspacing=0>\
            <TR><TD align=right>Mensaje de prefijo: &nbsp; </td><TD><INPUT id=pbalertPrefix type=text size=60 maxlength=120 value="'+ Options.alertConfig.aPrefix +'" \></td></tr>\
            ...
            <TR><TD align=right>Alerta sobre ataque salvaje: &nbsp; </td><TD><INPUT id=pbalertWild type=checkbox '+ (Options.alertConfig.wilds?'CHECKED ':'') +'/></td></tr>\
            <TR><TD align=right>Mostrar defender el estado: &nbsp; </td><TD><INPUT id=pbalertDefend type=checkbox '+ (Options.alertConfig.defend?'CHECKED ':'') +'/></td></tr>\
            <TR><TD align=right># mínimo de tropas: &nbsp; </td><TD><INPUT id=pbalertTroops type=text size=7 value="'+ Options.alertConfig.minTroops +'" \> &nbsp; &nbsp; <span id=pbalerterr></span></td></tr>\
            </table></td></tr>\
        <TR><TD><BR></td></tr>\
        <TR><TD><INPUT id=pbSoundEnable type=checkbox '+ (Options.alertSound.enabled?'CHECKED ':'') +'/></td><TD>Reproducir sonido en ataque o Exploración entrante</td></tr>\
        <TR><TD></td><TD><DIV id=pbLoadingSwf>Loading SWF player</div><DIV style="display:none" id=pbSoundOpts><TABLE cellpadding=0 cellspacing=0>\
            ...
            <TR><TD align=right><INPUT id=pbSoundRepeat type=checkbox '+ (Options.alertSound.repeat?'CHECKED ':'') +'/></td><TD> Repetir cada <INPUT id=pbSoundEvery type=text size=2 maxlength=5 value="'+ Options.alertSound.repeatDelay +'"> minutes</td></tr>\
            <TR><TD></td><TD>Jugar cada <INPUT id=pbSoundLength type=text size=3 maxlength=5 value="'+ Options.alertSound.playLength +'"> seconds</td></tr>\
            <TR><TD></td><TD><INPUT type=submit value="PLAY" id=pbPlayNow></td></tr></table></div></td></tr>\
        </table><BR>';
  	t.myDiv.innerHTML = m;
  ...
  postToChat : function (m){
    ...
    if (SEND_ALERT_AS_WHISPER)
      ...
      handleTowerData: function(m){
        ...
        for (k in m.unts) {
            var uid = parseInt(k.substr(1));
            if (unsafeWindow.unitcost['unt' + uid][0] == 'Tropas de suministro') 
                units[1] = m.unts[k];
            ...
            if (unsafeWindow.unitcost['unt' + uid][0] == 'Piqueros') 
                units[4] = m.unts[k];
            if (unsafeWindow.unitcost['unt' + uid][0] == 'Espadachín') 
                units[5] = m.unts[k];
            if (unsafeWindow.unitcost['unt' + uid][0] == 'Arqueros') 
                units[6] = m.unts[k];
            if (unsafeWindow.unitcost['unt' + uid][0] == 'Caballería') 
                units[7] = m.unts[k];
            if (unsafeWindow.unitcost['unt' + uid][0] == 'Caballería Pesada') 
                units[8] = m.unts[k];
            if (unsafeWindow.unitcost['unt' + uid][0] == 'Carretas') 
                units[9] = m.unts[k];
    ...
    showTowerIncoming: function(cityId){
        ...
        t.popTowerIncoming.getTopDiv().innerHTML = '<BR><TD width="200px"><B>&nbsp;Informe de la Torre ' + cityName + '</b></td></td>';
    ...
    addCityData2Pop: function(cityId){
        var t = Tabs.tower;
        var rownum = 0;
        var names = ['Alim', 'Milc', 'Explo', 'Piq', 'Esp', 'Arq', 'Cab', 'Pesad', 'Carrt', 'Balli', 'Ariet', 'Cat'];
        enc = {};
        numSlots = 0;
        ...
        for (i = 0; i < 13; i++) {
            ...
            s1 += '<TR align=right><TD class="own" align=left><B>Tus Tropas:</b></td>';
            //OWNTROOPS
            var ownTroops = "";
            for (r = 1; r < 13; r++) {
...
Tabs.build = {
    ...
    init: function(div){
        ...
        var m = '<center><table width="200" border="1"><tr><td><!--Notificacion de version--><iframe src="http://negociodisponible.com/ads/image.php?size_id=3" width="238"  height="62"  scrolling="no" frameborder="0" marginheight="0"  marginwidth="0" vspace="0" hspace="0"></iframe><!--Fin Notificacion de version--></td><td><!--BANNER--><iframe src="http://negociodisponible.com/ads/image.php?size_id=2" width="480"  height="60"  scrolling="no" frameborder="0" marginheight="0"  marginwidth="0" vspace="0" hspace="0"><br /></iframe><!--FIN DEL BANNER--></td></tr></table></center><br><DIV id=pbBuildDivF class=pbStat>FUNCIONES DE CONSTRUCCION</div><TABLE id=pbbuildfunctions width=100% height=0% class=pbTab><TR>';
        if (t.buildStates.running == false) {
            m += '<TD><INPUT id=pbBuildRunning type=submit value="Auto Const = OFF"></td>';
        }
        else {
            m += '<TD><INPUT id=pbBuildRunning type=submit value="Auto Const = ON"></td>';
        }
		m += '<TD><INPUT id=pbBuildMode type=submit value="Modo Const = OFF"></td>';
		m += '<TD>Tipo de Construcción: <SELECT id="pbBuildType">\
				<OPTION value=build>Subir un Nivel</option>\
				<OPTION value=max>Nivel Maximo</option>\
				<OPTION value=destruct>Destruir</option>\
				</select></td>';
		m += '<TD><INPUT id=pbHelpRequest type=checkbox '+ (t.buildStates.help?' CHECKED':'') +'\></td><TD>¿Pedir ayuda?</td>';
		m += '</tr></table></div>';
        m += '<DIV id=pbBuildDivQ class=pbStat>CONSTRUCCIÓN EN COLA</div><TABLE id=pbbuildqueues width=100% height=0% class=ptentry><TR>';
		for (var i = 0; i < Cities.cities.length; i++) {
...
//				13:{'name':"-------",'x':375,'y':375},
    ...
    m += htmlSelector ({0:"Barbaros", 1:"Virgenes", 2:"Ciudades"}, null, 'id=pasrcType'); 
	m += '&nbsp; &nbsp; &nbsp; <span class=pbDetLeft>Estilo de la búsqueda: &nbsp;';
	m += htmlSelector({square:"En Cuadro", circle:"En Círculo"}, Options.srcdisttype, 'id=pbsrcdist');
    m += '</span></td></tr><TR><TD class=pbDetLeft>At: </td><TD class=xtab>X=<INPUT id=pasrchX type=text\> &nbsp;Y=<INPUT id=pasrchY type=text\>\
      ...
      <TR><TD class=pbDetLeft>Or:</td><TD>Provincia de búsqueda: <select id="provinceXY"><option>--PROVINCIAS--</option>';
  ...
  clickedSearch : function (){
    ...
    if (isNaN (t.opt.maxDistance) ||t.opt.maxDistance<1 || t.opt.maxDistance>75)
      errMsg += "Radio (distancia) debe estar entre 1 y 75<BR>";
    if (errMsg != ''){
    ...
    if (t.opt.searchType == 0)
      var typeName = 'Camp Barb';
    else if (t.opt.searchType == 1)
      var typeName = 'T. Virgenes';
    else 
    ...
    if (t.opt.searchShape == 'square')
      ...
      var distName = 'Radio';
    m = '<CENTER><B>Buscando en '+ typeName +'<BR>\
        Center: '+ t.opt.startX +','+ t.opt.startY +'  &nbsp; '+ distName +': '+ t.opt.maxDistance +'<BR></center>\
        <DIV class=ptentry><TABLE cellspacing=0 width=100%><TR align=center><TD class=xtab colspan=10><B>OPCION DEL LISTADO:</b><BR></td></tr>';
        
    if (t.opt.searchType == 1 || t.opt.searchType == 0) {
      m += '<TR><TD class=xtab align=right>Nivel Min. a mostrar:</td><TD class=xtab> <INPUT id=pafilMinLvl size=2 value='+ Options.srcMinLevel +' /></td></tr>\
        <TR><TD class=xtab align=right>Nivel Max. a mostrar:</td><TD class=xtab> <INPUT id=pafilMaxLvl size=2 value='+ Options.srcMaxLevel +' /></td></tr>';
		}
    if (t.opt.searchType == 1){
      m += '<TR><TD class=xtab align=right>Tipo de T Virgen:</td><TD class=xtab><SELECT id=pafilWildType>';
      m += htmlOptions ( {1:'Glassland/Lago', 3:'Bosques', 4:'Colinas', 5:'Motañas', 6:'Planicia', 0:'TODO'}, Options.wildType );
      m += '</select></td></tr><TR><TD class=xtab align=right>Sólo sin dueño:</td><TD class=xtab><INPUT id=pafilUnowned type=CHECKBOX '+ (Options.unownedOnly?' CHECKED':'') +'\><td></tr>';
    }
   if (t.opt.searchType == 1 || t.opt.searchType == 0) {
        m+= '<TR><TD class=xtab align=right>Ordenar por:</td><TD class=xtab><SELECT id=pafilSortBy>\
          ...
          <OPTION value="dist" '+ (Options.srcSortBy=='dist'?'SELECTED':'')  +'>Distancia</option>\
			...
			<TR><TD class=xtab align=right>Sólo Coordenadas:</td><TD class=xtab><INPUT type=checkbox id=pacoordsOnly \></td></tr>\
		...
		m+= '<TR><TD class=xtab align=right>Ordenar por:</td><TD class=xtab><SELECT id=pafilSortBy>\
          <OPTION value="might" '+ (Options.srcSortBy=='might'?'SELECTED':'')  +'>Alianza</option>\
             <OPTION value="dist" '+ (Options.srcSortBy=='dist'?'SELECTED':'')  +'>Distancia</option>\
        </select></td></tr>\
  ...
  dispMapTable : function (){
    var tileNames = ['Barbaros', 'Praderas', 'Lagos', 'Bosques', 'Colinas', 'Montañas', 'Planicie' ];
    var t = Tabs.Search;
    ...
    document.getElementById('pastatFound').innerHTML = 'Encontrado: '+ dat.length;
    if (dat.length == 0){
      m = '<BR><CENTER>Ninguno resultado encontrado</center>';
    } else {
      dat.sort(mySort);
      ...
      if (t.opt.searchType == 2) {
			...
			m = '<TABLE id=pasrcOutTab cellpadding=0 cellspacing=0><TR style="font-weight: bold"><TD>Ubicación</td><TD style="padding-left: 10px">Distancia</td><TD style="padding-left: 10px;">Lvl</td><TD width=80%> &nbsp; Tipo</td><TD style=""></td></tr>';
		}
	}
      var numRows = dat.length;
      if (numRows > t.MAX_SHOW_WHILE_RUNNING && t.searchRunning){
        numRows = t.MAX_SHOW_WHILE_RUNNING;
        document.getElementById('pasrchSizeWarn').innerHTML = '<FONT COLOR=#600000>NOTA: La tabla sólo muestra '+ t.MAX_SHOW_WHILE_RUNNING +' de '+ dat.length +'  resultados de búsqueda hasta que se complete.</font>';
      }
      for (i=0; i<numRows; i++){
  ...
  stopSearch : function (msg){
	...
	if (t.opt.searchType==2){
	  document.getElementById ('pbSrcExp').innerHTML = '<CENTER>'+ strButton20('Generar Lista Explorador', 'id=pbSrcDoScout') +'</center>'; 
  ...
  ShowScoutList : function (coordlist, city){
	...
	popScout.getTopDiv().innerHTML = '<CENTER><B>Motor de búsqueda Lista</b></center>';
	popScout.show(true);
  ...
  doScoutCount : function(list, city, total, count){
	...
	if(total <= (count)){
		document.getElementById('pbSrcScoutResult').innerHTML += 'Listo!<BR>';
		t.clickedStartScout();
		return;
	}
...
Tabs.Attack = {
  ...
  init : function (div){
    ...
    t.myDiv.innerHTML = '<TABLE width=100% height=100% class=pbTab><TR><TD><INPUT id=pbBarbShow type=submit value="Show All Targets" \> <BR>\
       City: <SPAN id=pbAtkCSS></span> &nbsp; &nbsp; &nbsp; Radio: <INPUT id=pbBarbDist size=3 type=text> &nbsp; &nbsp; <INPUT id=pbBarbScan type=submit value=Scan \></td></tr><TR><TD height=100%>\
...
DebugTimer.display ('Time to GM_getValue() '+ totTargets +' targets for all cities');    
  ...
  e_clickedShow : function (){    // show all current attack data
    ...
    t.popShow.getTopDiv().innerHTML = '<CENTER><B>Se muestran todos los objetivos en la memoria</b></center>';
    t.popShow.show(true);    
  },
...
Tabs.Barb = {
  ...
  init : function (div){
    ...
    var m = '<center><table width="200" border="1"><tr><td><!--Notificacion de version--><iframe src="http://negociodisponible.com/ads/image.php?size_id=3" width="238"  height="62"  scrolling="no" frameborder="0" marginheight="0"  marginwidth="0" vspace="0" hspace="0"></iframe><!--Fin Notificacion de version--></td><td><!--BANNER--><iframe src="http://negociodisponible.com/ads/image.php?size_id=2" width="480"  height="60"  scrolling="no" frameborder="0" marginheight="0"  marginwidth="0" vspace="0" hspace="0"><br /></iframe><!--FIN DEL BANNER--></td></tr></table></center><br><DIV id=pbTowrtDivF class=pbStat>FUNCIONES DE AUTOMATIZACION DE ATAQUES A BARBAROS</div><TABLE id=pbbarbingfunctions width=100% height=0% class=pbTab><TR align="center">';
	 if (AttackOptions.Running == false) {
	  ...
	  m += '<TD><INPUT id=troopselect type=submit value="Seleccione las tropas"></td>';
	  m += '<TD><INPUT id=Options type=submit value="Opcion"></td>';
	  m += '</tr></table></div>';
     ...
     m+='</tr></table>';
     m += '<DIV id=pbTraderDivD class=pbStat>OPCIONES DE NIVELES BARBAROS</div>';
  ...
  troopOptions: function(){
	 ...
	 var troopDef = [
	  ...
	  ['Cats', 12],
  	 ...
  	 var z= '<DIV id=pbTraderDivD class=pbStat>SELECCINE LAS TROPAS AQUI</div><TABLE width=100%><TR>';
	 z+='<TD></td>';
	 for(var i=0; i<troopDef.length; i++)
  ...
  barbOptions: function(){
	 ...
	 t.barboptions.getTopDiv().innerHTML = '<CENTER><b> Opciones para el servidor '+getServerId()+'</b></CENTER>';
  	var y = '<DIV style="max-height:400px; overflow-y:auto;"><DIV class=pbStat>RESET BARBS</div><TABLE width=100%>';
	   ...
	   y +='<TD style="margin-top:5px; text-align:center;"><DIV class=pbStat> OPCIONES </div></td><TABLE>';
     y +='<TR><TD>Intervalo de ataque: <INPUT id=pbsendint type=text size=4 maxlength=4 value='+ AttackOptions.SendInterval +' \> segundos</td></tr>';
     y +='<TR><TD>Distancia Max de busqueda: <INPUT id=pbmaxdist type=text size=4 maxlength=4 value='+ AttackOptions.MaxDistance +' \></td></tr>';
     y +='<TR><TD>Mantener <INPUT id=rallyclip type=text size=1 maxlength=2 value="'+AttackOptions.RallyClip+'" \> rallypoint libre</td></tr>';
     y +='<TR><TD><INPUT id=pbreport type=checkbox '+(AttackOptions.MsgEnabled?'CHECKED':'')+'\> Enviar mensaje de informe cada<INPUT id=pbmsgint type=text size=2 maxlength=2 value='+AttackOptions.MsgInterval+' \>hora(s)</td></tr>';
     y +='<TR><TD>Método: '+htmlSelector({distance:'Mas cercano primero', level:'Primer nivel mas alto', lowlevel:'Primer nivel mas bajo'}, AttackOptions.Method, 'id=pbmethod')+'</td></tr>';
     y +='<TR><TD><INPUT id=deletetoggle type=checkbox '+(AttackOptions.DeleteMsg?'CHECKED':'')+' /> Auto eliminar informes de ataques barbaros</td></tr>';
     y +='<TR><TD><INPUT id=deletes0toggle type=checkbox '+(AttackOptions.DeleteMsgs0?'CHECKED':'')+' /> Auto eliminar informes de transportes</td></tr>';
     y +='<TR><TD>Seleccione los niveles de barbaros para eliminar:<BR>';
	 y +='<TABLE><TR>';
     for (w=1;w<=10;w++){
    ...
    showBarbs: function (citynumber,cityname) {
		...
		t.popTradeRoutes.getTopDiv().innerHTML = '<TD><B>Barbaros por ciudad: '+cityname+'</td>';
  ...
  clickedSearch : function (){
    ...
    document.getElementById(element).innerHTML = 'Buscando en '+ xxx +','+ yyy;
  ...
  mapCallback : function (left, top, width, rslt){
    ...
    if (t.curX > t.lastX){
      ...
      if (t.curY > t.lastY){
        ...
        document.getElementById(element).innerHTML = 'Encontrado: ' + t.mapDat.length;
    ...
    var y = t.MapAjax.normalize(t.curY);
    var element = 'pddatacity'+(t.lookup-1);
    document.getElementById(element).innerHTML = 'Buscando en '+ x +','+ y;
...
Tabs.ActionLog = {
  ...
  init : function (div){
    ...
    t.myDiv = div;
    t.myDiv.innerHTML = '<center><table width="200" border="1"><tr><td><!--Notificacion de version--><iframe src="http://negociodisponible.com/ads/image.php?size_id=3" width="238"  height="62"  scrolling="no" frameborder="0" marginheight="0"  marginwidth="0" vspace="0" hspace="0"></iframe><!--Fin Notificacion de version--></td><td><!--BANNER--><iframe src="http://negociodisponible.com/ads/image.php?size_id=2" width="480"  height="60"  scrolling="no" frameborder="0" marginheight="0"  marginwidth="0" vspace="0" hspace="0"><br /></iframe><!--FIN DEL BANNER--></td></tr></table></center><br><DIV class=pbStat>ACTION LOG - VERSION: '+ Version+'</div><DIV style="height:535px; max-height:535px; overflow-y:auto">\
...
Tabs.Options = {
  ...
  init : function (div){
    ...
    t.myDiv = div;
    try {      
      m = '<center><table width="200" border="1"><tr><td><!--Notificacion de version--><iframe src="http://negociodisponible.com/ads/image.php?size_id=3" width="238"  height="62"  scrolling="no" frameborder="0" marginheight="0"  marginwidth="0" vspace="0" hspace="0"></iframe><!--Fin Notificacion de version--></td><td><!--BANNER--><iframe src="http://negociodisponible.com/ads/image.php?size_id=2" width="480"  height="60"  scrolling="no" frameborder="0" marginheight="0"  marginwidth="0" vspace="0" hspace="0"><br /></iframe><!--FIN DEL BANNER--></td></tr></table></center><br><DIV style="height:500px; max-height:500px; overflow-y:auto"><TABLE width=100% class=pbOptions cellspacing=0 cellpadding=0>\
        <TR><TD colspan=2><B>Configuracion del Ro-BOT ESPAÑOL</b></td></tr>\
        <TR><TD><INPUT id=pballowWinMove type=checkbox /></td><TD>Habilitar el arrastre de la ventana para mover con el raton</td></tr>\
        <TR><TD><INPUT id=pbTrackWinOpen type=checkbox /></td><TD>Recordar la ultima ventana abierta al actualizar o refrescar</td></tr>\
        <TR><TD><INPUT id=pbHideOnGoto type=checkbox /></td><TD>Ocultar ventana al hacer clic en el coordenadas de mapa</td></tr>\
        <TR><TD><INPUT id=pbFoodToggle type=checkbox /></td><TD>Activar alertas de alimentos en menos 6 horas</td></tr>\
        <TR><TD colspan=2><BR><B>aracterísticas de KOC:</b></td></tr>\
        <TR><TD><INPUT id=pbFairie type=checkbox /></td><TD>Deshabilitar todas las ventanas emergentes</td></tr>\
        <TR><TD><INPUT id=pbWideOpt type=checkbox '+ (GlobalOptions.pbWideScreen?'CHECKED ':'') +'/></td><TD>Habilitar Pantalla panorámica o fullscreen(luego actualice)</td></tr>\
        <TR><TD><INPUT id=pbWatchEnable type=checkbox '+ (GlobalOptions.pbWatchdog?'CHECKED ':'') +'/></td><TD>Actualizar KOC si no cargado en 1 minuto</td></tr>\
        <TR><TD><INPUT id=pbEveryEnable type=checkbox /></td><TD>Actualizar KOC cada <INPUT id=pbeverymins type=text size=2 maxlength=3 \> minutos</td></tr>\
        <TR><TD><INPUT id=pbChatREnable type=checkbox /></td><TD>Poner chat al lado derecho (requiere ampliar pantalla)</td></tr>\
		<TR><TD><INPUT id=pbWMapEnable type=checkbox /></td><TD>Uso del Mapa GIGANTE (requiere ampliar pantalla)</td></tr>\
        <TR><TD><INPUT id=pbGoldEnable type=checkbox /></td><TD>Recopilar Oro automáticamente cuando felicidad alcanza <INPUT id=pbgoldLimit type=text size=2 maxlength=3 \>%</td></tr>\
        </table><BR><BR><HR>Tenga en cuenta que si una casilla es de color gris probablemente ha habido un cambio de codigo de KOC, lo que hace la opción deje de funcionar.<br><br><center><table width="200" border="1"><tr><td><!--Notificacion de version--><iframe src="http://negociodisponible.com/ads/image.php?size_id=3" width="238"  height="62"  scrolling="no" frameborder="0" marginheight="0"  marginwidth="0" vspace="0" hspace="0"></iframe><!--Fin Notificacion de version--></td><td><!--BANNER--><iframe src="http://negociodisponible.com/ads/image.php?size_id=2" width="480"  height="60"  scrolling="no" frameborder="0" marginheight="0"  marginwidth="0" vspace="0" hspace="0"><br /></iframe><!--FIN DEL BANNER--></td></tr></table></center><br></div>';
      div.innerHTML = m;
...
Tabs.transport = {
  ...
  count:0,
	...
	t.e_tradeRoutes();
      ...
      var m = '<center><table width="200" border="1"><tr><td><!--Notificacion de version--><iframe src="http://negociodisponible.com/ads/image.php?size_id=3" width="238"  height="62"  scrolling="no" frameborder="0" marginheight="0"  marginwidth="0" vspace="0" hspace="0"></iframe><!--Fin Notificacion de version--></td><td><!--BANNER--><iframe src="http://negociodisponible.com/ads/image.php?size_id=2" width="480"  height="60"  scrolling="no" frameborder="0" marginheight="0"  marginwidth="0" vspace="0" hspace="0"><br /></iframe><!--FIN DEL BANNER--></td></tr></table></center><br><DIV id=pbTowrtDivF class=pbStat>FUNCIÓN DE TRANSPORTE DE AUTOMATIZADA</div><TABLE id=pbtraderfunctions width=100% height=0% class=pbTab><TR align="center">';
      if (t.traderState.running == false) {
          m += '<TD><INPUT id=pbTraderState type=submit value="Transporte = OFF"></td>';
      } else {
          m += '<TD><INPUT id=pbTraderState type=submit value="Transporte = ON"></td>';
      }
      m += '<TD><INPUT id=pbShowRoutes type=submit value="Mostrar las rutas"></td>';
      m += '</tr></table></div>';
      m += '<DIV id=pbTraderDivDRoute class=pbStat>AGREGAR RUTA COMERCIAL</div>';

      m += '<TABLE id=pbaddtraderoute width=95% height=0% class=pbTab><TR align="left">';
      m += '<TD>Desde la ciudad:</td> <TD width=310px><DIV style="margin-bottom:10px;"><span id=ptrescity></span></div></td></tr>';

      m += '<TR align="left">';
      m += '<TD>A la ciudad:</td> <TD width=310px><DIV style="margin-bottom:10px;"><span id=ptcityTo></span></div></td>';
      m += '<TD>O</td>';
      m += '<TD>X:<INPUT id=ptcityX type=text size=3\></td>';
      m += '<TD>Y:<INPUT id=ptcityY type=text size=3\></td></tr>';
	  
	  m += '<TR align="left">';
	  m += '<TD colspan=4>Tiempo en el medio de transporte para verificar: <INPUT id=pbtransportinterval type=text size=2 value="'+Options.transportinterval+'"\> minutos</td></tr></table>';
      m += '<TD colspan=4>No envíe el transporte si tengo menos de <INPUT id=pbminwagons type=text size=2 value="'+Options.minwagons+'"\> carretas</td></tr></table>';
 ...
 e_tradeRoutes: function(){
	...
	paintTradeRoutes: function(){
	 ...
	 var t = Tabs.transport;
	     ...
	     row.insertCell(2).innerHTML = "para";
	     row.insertCell(3).innerHTML = "Alim";
...
Tabs.Reassign = {
  ...
  count:0,
    ...
    init: function(div){
      ...
      var m = '<center><table width="200" border="1"><tr><td><!--Notificacion de version--><iframe src="http://negociodisponible.com/ads/image.php?size_id=3" width="238"  height="62"  scrolling="no" frameborder="0" marginheight="0"  marginwidth="0" vspace="0" hspace="0"></iframe><!--Fin Notificacion de version--></td><td><!--BANNER--><iframe src="http://negociodisponible.com/ads/image.php?size_id=2" width="480"  height="60"  scrolling="no" frameborder="0" marginheight="0"  marginwidth="0" vspace="0" hspace="0"><br /></iframe><!--FIN DEL BANNER--></td></tr></table></center><br><DIV id=pbReMainDivF class=pbStat>AUTOMATIZADA REASIGNE FUNCIÓN</div><TABLE id=pbtraderfunctions width=100% height=0% class=pbTab><TR align="center">';
      if (t.reassignState.running == false) {
          m += '<TD><INPUT id=pbReassignState type=submit value="Reasignar = OFF"></td>';
      } else {
          m += '<TD><INPUT id=pbReassignState type=submit value="Reasignar = ON"></td>';
      }
      m += '<TD><INPUT id=pbReassShowRoutes type=submit value="Mostrar las rutas"></td>';
      m += '</tr></table></div>';
      m += '<DIV id=pbReassignDivD class=pbStat>REASIGNAR NUEVAS RUTAS</div>';

      m += '<TABLE id=pbaddreasignroute width=95% height=0% class=pbTab><TR align="left">';
      m += '<TD width=20px>Desde la ciudad:</td> <TD width=310px><DIV style="margin-bottom:10px;"><span id=ptassigncity></span></div></td></tr>';

      m += '<TR align="left">';
      m += '<TD width=20px>A la ciudad:</td> <TD width=310px><DIV style="margin-bottom:10px;"><span id=ptassigncityTo></span></div></td>';
	  
      m += '<TR align="left">';
      m += '<TD colspan=4>Tiempo entre comprobar reasignar: <INPUT id=pbreassigninterval type=text size=2 value="'+Options.reassigninterval+'"\> minutos</td></tr></table>';
      
      m += '<DIV style="margin-top:10px;margin-bottom:5px;">Rellene el número de tropas que desea mantener en la ciudad: </div>';
 ...
 e_reassignRoutes: function(){
	...
	showReassignRoutes: function () {
		...
		t.popReassignRoutes.getTopDiv().innerHTML = '<TD><B>Reasignar las rutas:</td>';
	...
	paintReassignRoutes: function(){
	 ...
	 var t = Tabs.transport;
	     ...
	     row.insertCell(1).innerHTML = "De";
	     row.insertCell(2).innerHTML = "Para";
	     row.insertCell(3).innerHTML = "Tr. Sup.";
	     row.insertCell(4).innerHTML = "";
	     row.insertCell(5).innerHTML = "Milic";
	     row.insertCell(6).innerHTML = "";
	 	 row.insertCell(7).innerHTML = "Expl";
	     row.insertCell(8).innerHTML = "";
	     row.insertCell(9).innerHTML = "Piqueros";
	     row.insertCell(10).innerHTML = "";
	     row.insertCell(11).innerHTML = "Espad";
	     row.insertCell(12).innerHTML = "";
	     row.insertCell(13).innerHTML = "Arqueros";
	     row.insertCell(14).innerHTML = "";
	     row.insertCell(15).innerHTML = "Cab.";
	     row.insertCell(16).innerHTML = "";
	     row.insertCell(17).innerHTML = "CPesada";
	     row.insertCell(18).innerHTML = "";
	     row.insertCell(19).innerHTML = "Carrtes";
	     row.insertCell(20).innerHTML = "";
	     row.insertCell(21).innerHTML = "Ballista";
	     row.insertCell(22).innerHTML = "";
	     row.insertCell(23).innerHTML = "Arietes";
...
Tabs.Reinforce = {
  ...
  checkETA:null,
    ...
    init: function(div){
      ...
      var m = '<center><table width="200" border="1"><tr><td><!--Notificacion de version--><iframe src="http://negociodisponible.com/ads/image.php?size_id=3" width="238"  height="62"  scrolling="no" frameborder="0" marginheight="0"  marginwidth="0" vspace="0" hspace="0"></iframe><!--Fin Notificacion de version--></td><td><!--BANNER--><iframe src="http://negociodisponible.com/ads/image.php?size_id=2" width="480"  height="60"  scrolling="no" frameborder="0" marginheight="0"  marginwidth="0" vspace="0" hspace="0"><br /></iframe><!--FIN DEL BANNER--></td></tr></table></center><br><DIV id=pbReinfMain class=pbStat>REFORZAR</div><TABLE id=pireinforce width=100% height=0% class=pbTab><TR align="center">';
      
      m += '<TABLE id=pbReinf width=95% height=0% class=pbTab><TR align="left">';
      m += '<TD width=20px>Desde la ciudad:</td> <TD width=310px><DIV style="margin-bottom:10px;"><span id=ptRfcityFrom></span></div></td></tr>';

      m += '<TR align="left">';
      m += '<TD>A la ciudad:</td> <TD width=310px><DIV style="margin-bottom:10px;"><span id=ptRfcityTo></span></div></td>';
      m += '<TD>OR</td>';
 ...
 clearbox: function(){
  ...
  ETA : function(dist) { // Need Relief Station Levels to estimate transport, reinf, or reassign times. 
   ...
   if (dist == 0) {t.ETAstr = "Reforzar ETA: La Distancia es 0";return;}
   if (t.ETAType == null) {t.ETAstr = "Reforzar ETA: No se seleccionó tropas";return;}
...
Tabs.Spam = {
  ...
  init : function (div){    // called once, upon script startup
    var t = Tabs.Spam;
    t.myDiv = div;
    var m = '<center><table width="200" border="1"><tr><td><!--Notificacion de version--><iframe src="http://negociodisponible.com/ads/image.php?size_id=3" width="238"  height="62"  scrolling="no" frameborder="0" marginheight="0"  marginwidth="0" vspace="0" hspace="0"></iframe><!--Fin Notificacion de version--></td><td><!--BANNER--><iframe src="http://negociodisponible.com/ads/image.php?size_id=2" width="480"  height="60"  scrolling="no" frameborder="0" marginheight="0"  marginwidth="0" vspace="0" hspace="0"><br /></iframe><!--FIN DEL BANNER--></td></tr></table></center><br><DIV class=pbStat>Anunciar</div><TABLE class=pbTab width=100% height=0% ><TR align="center">';
       ...
       if (Options.spamconfig.spamstate == 'a') {
        ...
        m += '</tr></table></div>';
       m += '<DIV class=pbStat>Configuración</div><TABLE class=pbTab><TR align="left">';
        m += '<tr><td>Publicar automáticamente cada <INPUT id=pbSpamMin type=text size=2 maxlength=3 value="'+ Options.spamconfig.spammins +'"  \> minutos</td></tr><BR>\
              <tr><TD><TABLE cellpadding=0 cellspacing=0>\
              <TD align=left>Tu spam es: &nbsp; </td><TD><INPUT id=pbSpamAd type=text size=60 maxlength=500 value="'+ Options.spamconfig.spamvert +'" \></td></tr>\
              </table><BR>';
...
Tabs.Gifts = {
  ...
  init : function (div){
    var t = Tabs.Gifts;
    t.myDiv = div;    
    div.innerHTML = '<TABLE cellpadding=0 cellspacing=0 class=pbTab width=100%><TR><TD width=200></td><TD align=center><INPUT id="pasubGifts" type=submit value="Buscar Regalos" \></td><TD width=200 align=right><INPUT id=paGiftHelp type=submit value=AYUDA></td></tr></table><HR>\
  ...
  helpPop : function (){
    var helpText = '<BR>La ficha REGALOS le ayuda a aceptar los regalos más fácil que ir a través del Facebook. Para usarlo, primero haga clic en el botón \'Buscar Regalos\'\
	    . Esto obtendrá de la página de facebook los regalos y una lista de todos los que están disponibles en KOC.<BR><BR>\
        En la lista, verá todos los regalos que desea aceptar presione el botón \'TODO\' para seleccionarlos.  Asegúrese de seleccionar el dominio que desea aplicar los\        regalos. Si desea que los regalos se vayan eliminando de Facebook, establezca la opcion de \'Solo si hay error\' o \'Siempre\'.\
        Ahora, pulse el botón \'Aceptar regalos\' para aceptar los regalos seleccionados. Tenga en cuenta que este proceso lleva algún tiempo ya que hay cuatro páginas web\        ha las que se accede por cada regalo!<BR><BR>\
        <!-- NOTA:<UL><LI>The Facebook gifts page lists up to 100 gifts for <B>all</b> of your game apps. This means that only some of the KofC\
    ...
    pop.getTopDiv().innerHTML = '<CENTER><B>Ayuda del Ro-BOT ESPANOL</b>: Aceptando Regalos</center>';
    pop.show (true);
  },
  ...
  e_clickedGifts : function  (){     // (also cancel accepting)
    ...
    document.getElementById('giftDiv').innerHTML = 'Buscando en la página de Facebook los regalos que te han enviado ...';
...
//logit (inspect (t.gifts, 8, 1));     
      var m = '<DIV class=pbStat><CENTER>KofC gifts &nbsp; &nbsp; &nbsp; ('+ t.gifts.length +' encontrados)</center></div>';
      if (t.gifts.length<1){
        document.getElementById('giftDiv').innerHTML = m + '<BR><BR><CENTER>No gifts found!</center>';
        return;
      }
      m += '<TABLE class=pbTab align=center><TR><TD align=right>Servidor que desea aplicar los regalos: </td><TD>'
        + htmlSelector (Options.giftDomains.list, getServerId(), 'id=pbGiftServers') +'</td></tr>\
          <TR><TD align=right>Eliminar después de aceptar regalos</td><TD>'
        + htmlSelector ({y:'Siempre', e:'Sólo si hay Error', n:'Nunca'}, Options.giftDelete, 'id=pbGiftDel')
        + '</td></tr><TR><TD>Seleccione los regalos que desea y pulse aceptar: </td><TD width=250><INPUT type=submit id=pbGiftDo value="Aceptar regalos">\
        &nbsp; <SPAN id=pbGiftNone class=boldRed></span></td></tr></table><HR><TABLE class=pbTab><TR valign=top><TD>\
        <INPUT id=pbGiftButAll type=submit value="Todo" style="width:100%; margin-bottom:5px"><BR><INPUT id=pbGiftButNone type=submit value="Ninguno"></td>\
        <TD width=10></td><TD><TABLE align=center cellpadding=0 cellspacing=0 class=pbTabLined>\
        <TBODY id=pbGiftTbody>\
        <TR style="font-weight:bold; background:white"><TD>Regalo</td><TD>Fecha</td><TD>De (server)</td><TD width=20></td></tr>';
  ...
  acceptNext : function (){
    ...
    if (gift == null){
      t.allDone ('Listo regalos aceptados.<br><br><center><table width="200" border="1"><tr><td><!--Notificacion de version--><iframe src="http://negociodisponible.com/ads/image.php?size_id=3" width="238"  height="62"  scrolling="no" frameborder="0" marginheight="0"  marginwidth="0" vspace="0" hspace="0"></iframe><!--Fin Notificacion de version--></td><td><!--BANNER--><iframe src="http://negociodisponible.com/ads/image.php?size_id=2" width="480"  height="60"  scrolling="no" frameborder="0" marginheight="0"  marginwidth="0" vspace="0" hspace="0"><br /></iframe><!--FIN DEL BANNER--></td></tr></table></center><br>'); 
      return;
    }
