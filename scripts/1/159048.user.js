// ==UserScript==
// @name			TANKS4LIFE Battle Priorities (ENG)
// @version			1.01
...
function header() {
    ...
    //var orders = '<h4>TANKS4LIFE Battle Orders</h4><div id="mod_orders"></div>';
...
function footer() {
    ...
    var orders = '<div class="rest"><a href="http://www.tanks4life.com/p/engagement-rules.html" title="" target="_blank">Rules of Tanks4life</a><a href="' + linkDiv + '" title="" target="_blank">Join our chat</a></div>';
