// ==UserScript==
// @name           Bux.to Auto Clicker
// @namespace      http://userscripts.org/105685/
// @description    Auto Click Ads On Bux.to
...
var switch_to_ad_page = false;      // Switch to ad page after logging in (true/false)
////////////
...
// Switch to ads.php if you just logged in
if(logoutexist && page(index_url) && switch_to_ad_page) {go(ad_page_url);}

	function setTimers() {
v	var intV = setInterval(function(){
...
sec.setAttribute("style", "background:url('http://img846.imageshack.us/img846/5952/unledcm.png'); color:#ddd; border:8px ridge #000; padding:5em; position:absolute; top:"+window.innerHeight/3+"px; left:"+window.innerWidth/2+"px; text-align:center;");
