...
function showOptions(){
	...
	if(!movesOptionsBox){
		$('div#js_MilitaryMovementsFleetMovementsTable.content').prepend(
			...
			+'<a id="movesOptionsBoxOptionHide" href="#" title="Nospiediet, lai paslēptu opcijas">Paslēpt opcijas</a>'
			+'<a id="movesOptionsBoxOptionShow" style="display:none;" href="#" title="Nospiediet, lai parādītu opcijas">Rādīt opcijas</a>'
			+'<table style="width:100%;">'
			+'<tr class="movesOptionsBoxRow">'
			+'<td colspan="2" style="text-align:center;font-weight:bold;background:#f5dbb3;padding-bottom:2px;">Manas kustības</td>'
			+'<td colspan="2" style="text-align:center;font-weight:bold;background:#FAEAC6;padding-bottom:2px;">Svešas kustības</td>'
			+'</tr>'
			+'<tr class="movesOptionsBoxRow">'
			+'<td style="padding-left:15px;background:#f5dbb3"><input name="ownTransportMoves" id="ownTransportMoves" type="checkbox" style="vertical-align: bottom;" '+ retrieveState("ownTransportMoves",true) +'/><label for="ownTransportMoves" style="padding-left:2px;" title="Atzīmējiet, kuras kustības rādīt/slēpt">Transportēšana</label></td>'
			+'<td style="padding-left:10px;background:#f5dbb3"><input name="ownCommercialMoves" id="ownCommercialMoves" type="checkbox" style="vertical-align: bottom;" '+ retrieveState("ownCommercialMoves",true) +'/><label for="ownCommercialMoves" style="padding-left:2px;" title="Atzīmējiet, kuras kustības rādīt/slēpt">Tirgošanās</label></td>'
			+'<td style="padding-left:15px;background:#FAEAC6"><input name="otherTransportMoves" id="otherTransportMoves" type="checkbox" style="vertical-align: bottom;" '+ retrieveState("otherTransportMoves",true) +'/><label for="otherTransportMoves" style="padding-left:2px;" title="Atzīmējiet, kuras kustības rādīt/slēpt">Transportēšana</label></td>'
			+'<td style="padding-left:10px;background:#FAEAC6"><input name="otherCommercialMoves" id="otherCommercialMoves" type="checkbox" style="vertical-align: bottom;" '+ retrieveState("otherCommercialMoves",true) +'/><label for="otherCommercialMoves" style="padding-left:2px;" title="Atzīmējiet, kuras kustības rādīt/slēpt">Tirgošanās</label></td>'
			+'</tr>'
			+'<tr class="movesOptionsBoxRow">'
			+'<td style="padding-left:15px;background:#f5dbb3"><input name="ownArmyDeploy" id="ownArmyDeploy" type="checkbox" style="vertical-align: bottom;" '+ retrieveState("ownArmyDeploy",true) +'/><label for="ownArmyDeploy" style="padding-left:2px;" title="Atzīmējiet, kuras kustības rādīt/slēpt">Kareivju izvietošana</label></td>'
			+'<td style="padding-left:10px;background:#f5dbb3"><input name="ownFleetDeploy" id="ownFleetDeploy" type="checkbox" style="vertical-align: bottom;" '+ retrieveState("ownFleetDeploy",true) +'/><label for="ownFleetDeploy" style="padding-left:2px;" title="Atzīmējiet, kuras kustības rādīt/slēpt">Kara kuģu izvietošana</label></td>'   
			+'<td style="padding-left:15px;background:#FAEAC6"><input name="otherArmyDeploy" id="otherArmyDeploy" type="checkbox" style="vertical-align: bottom;" '+ retrieveState("otherArmyDeploy",true) +'/><label for="otherArmyDeploy" style="padding-left:2px;" title="Atzīmējiet, kuras kustības rādīt/slēpt">Kareivju izvietošana</label></td>'
			+'<td style="padding-left:10px;background:#FAEAC6"><input name="otherFleetDeploy" id="otherFleetDeploy" type="checkbox" style="vertical-align: bottom;" '+ retrieveState("otherFleetDeploy",true) +'/><label for="otherFleetDeploy" style="padding-left:2px;" title="Atzīmējiet, kuras kustības rādīt/slēpt">Kara kuģu izvietošana</label></td>'     
			+'</tr>'
			+'<tr class="movesOptionsBoxRow">'
			+'<td style="padding-left:15px;background:#f5dbb3"><input name="ownTownDefendMoves" id="ownTownDefendMoves" type="checkbox" style="vertical-align: bottom;" '+ retrieveState("ownTownDefendMoves",true) +'/><label for="ownTownDefendMoves" style="padding-left:2px;" title="Atzīmējiet, kuras kustības rādīt/slēpt">Pilsētas aizsargāšana ville</label></td>'      
			+'<td style="padding-left:10px;background:#f5dbb3"><input name="ownPortDefendMoves" id="ownPortDefendMoves" type="checkbox" style="vertical-align: bottom;" '+ retrieveState("ownPortDefendMoves",true) +'/><label for="ownPortDefendMoves" style="padding-left:2px;" title="Atzīmējiet, kuras kustības rādīt/slēpt">Ostas aizsargāšana</label></td>'
			+'<td style="padding-left:15px;background:#FAEAC6"><input name="otherTownDefendMoves" id="otherTownDefendMoves" type="checkbox" style="vertical-align: bottom;" '+ retrieveState("otherTownDefendMoves",true) +'/><label for="otherTownDefendMoves" style="padding-left:2px;" title="Atzīmējiet, kuras kustības rādīt/slēpt">Pilsētas aizsargāšana</label></td>'      
			+'<td style="padding-left:10px;background:#FAEAC6"><input name="otherPortDefendMoves" id="otherPortDefendMoves" type="checkbox" style="vertical-align: bottom;" '+ retrieveState("otherPortDefendMoves",true) +'/><label for="otherPortDefendMoves" style="padding-left:2px;" title="Atzīmējiet, kuras kustības rādīt/slēpt">Ostas aizsargāšana</label></td>'
			+'</tr>'
			+'<tr class="movesOptionsBoxRow">'
			+'<td style="padding-left:15px;background:#f5dbb3"><input name="ownPlunderMoves" id="ownPlunderMoves" type="checkbox" style="vertical-align: bottom;" '+ retrieveState("ownPlunderMoves",true) +'/><label for="ownPlunderMoves" style="padding-left:2px;" title="Atzīmējiet, kuras kustības rādīt/slēpt">Laupīšana</label></td>'      
			+'<td style="padding-left:10px;background:#f5dbb3"><input name="ownPiracyMoves" id="ownPiracyMoves" type="checkbox" style="vertical-align: bottom;" '+ retrieveState("ownPiracyMoves",true) +'/><label for="ownPiracyMoves" style="padding-left:2px;" title="Atzīmējiet, kuras kustības rādīt/slēpt">Pirātu sirojumi</label></td>'             
			+'<td style="padding-left:15px;background:#FAEAC6"><input name="otherPlunderMoves" id="otherPlunderMoves" type="checkbox" style="vertical-align: bottom;" '+ retrieveState("otherPlunderMoves",true) +'/><label for="otherPlunderMoves" style="padding-left:2px;" title="Atzīmējiet, kuras kustības rādīt/slēpt">Laupīšana</label></td>'      
			+'<td style="padding-left:10px;background:#FAEAC6"><input name="otherPiracyMoves" id="otherPiracyMoves" type="checkbox" style="vertical-align: bottom;" '+ retrieveState("otherPiracyMoves",true) +'/><label for="otherPiracyMoves" style="padding-left:2px;" title="Atzīmējiet, kuras kustības rādīt/slēpt">Pirātu sirojumi</label></td>'             
			+'</tr>'
			+'<tr class="movesOptionsBoxRow">'
			+'<td style="padding-bottom:7px;padding-left:15px;background:#f5dbb3"><input name="ownOccupyMoves" id="ownOccupyMoves" type="checkbox" style="vertical-align: bottom;" '+ retrieveState("ownOccupyMoves",true) +'/><label for="ownOccupyMoves" style="padding-left:2px;" title="Atzīmējiet, kuras kustības rādīt/slēpt">Okupēšana</label></td>'
			+'<td style="padding-bottom:7px;padding-left:10px;background:#f5dbb3"><input name="ownBlockadeMoves" id="ownBlockadeMoves" type="checkbox" style="vertical-align: bottom;" '+ retrieveState("ownBlockadeMoves",true) +'/><label for="ownBlockadeMoves" style="padding-left:2px;" title="CAtzīmējiet, kuras kustības rādīt/slēpt">Blokāde</label></td>'             
			+'<td style="padding-bottom:7px;padding-left:15px;background:#FAEAC6"><input name="otherOccupyMoves" id="otherOccupyMoves" type="checkbox" style="vertical-align: bottom;" '+ retrieveState("otherOccupyMoves",true) +'/><label for="otherOccupyMoves" style="padding-left:2px;" title="Atzīmējiet, kuras kustības rādīt/slēpt">Okupēšana</label></td>'
			+'<td style="padding-bottom:7px;padding-left:10px;background:#FAEAC6"><input name="otherBlockadeMoves" id="otherBlockadeMoves" type="checkbox" style="vertical-align: bottom;" '+ retrieveState("otherBlockadeMoves",true) +'/><label for="otherBlockadeMoves" style="padding-left:2px;" title="Atzīmējiet, kuras kustības rādīt/slēpt">Blokāde</label></td>'             
			+'</tr>'			
			+'</table>'
			+'</div>'
		);		
		...
		rows.each(function(){
		  ...
		  $(this).append('<td><input type="checkbox" title="Ieķeksējiet, lai saglabātu kustību redzamu" id="' + cbId +'" class="movesOptionsKeepMove" ' + retrieveState(cbId,false) + '></input></td>');		  		  
		});	
