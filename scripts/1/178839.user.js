// ==UserScript==
// @name       Writers Userscript
// @namespace  Writers Userscript
// @version    1.0
// @description  Checks the Writers subforums to check for new posts and alerts the user if there are- by osc-rwar/HypnoToad/Gnome
// @include      http://leakforums.org*
// @include      http://*.leakforums.org*
// @updateURL https://userscripts.org/scripts/source/178839.meta.js
// @downloadURL https://userscripts.org/scripts/source/178839.user.js
// @copyright  2013+, Oscar Sanchez
// @icon	http://i.imgur.com/zmpo59L.png
