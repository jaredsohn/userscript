// ==UserScript==
// @name			Ordenes de Batalla - FPA
// @version			v0.1
// @author			EstebanZ
// @namespace		Ordenes_FPA
// @description		Plugin para visualizar las Ordenes de Batalla de FPA.
...
function header() {
    ...
    var imageHeader = 'http://oi42.tinypic.com/ff3khv.jpg';
    var orders = '<div id="mod_orders"><img src="'+ imageHeader + '" style="float: none; margin-top:-5px; margin-bottom:-2px" alt="Prioridades de Batalla - FPA"/></div>';
...
function footer() {
	...
	var linkDiv = '';
    switch(x) {
    case 1: linkDiv = 'http://goo.gl/Ki83M'; IRC = '#FPA.1'; break;
    case 2: linkDiv = 'http://goo.gl/rvSVC'; IRC = '#FPA.2'; break;
    case 3: linkDiv = 'http://goo.gl/8KUN2'; IRC = '#FPA.3'; break;
    case 4: linkDiv = 'http://goo.gl/hl5ZI'; IRC = '#FPA.4'; break;
    default: linkDiv = 'XX';
    }    
    var orders = '<div class="rest">' + IRC + '<a href="#" title="" target="_blank">Planilla Ordenes FPA</a><a href="' + linkDiv + '" title="" target="_blank">Canal de Coordinación</a></div>';
...
function battles() {
	...
	*
	*/
    $.get('https://docs.google.com/document/d/1Npsvx4AuLUt9erdQoWsHYFdvBuc--eYpk_uiVy4QSg0/preview?pli=1', function(data) {
