...
if(window.location.href.indexOf(PAGE_BATTLEFIELD) > 0) {	
	...
	/***********************************************************************************/
	var FORM_URL = "https://docs.google.com/spreadsheet/viewform?formkey=dGNEbi1wRFM5eUZzcWFjeHhrQ0hVRWc6MQ";
	var FORM_FIELDS = {
	...
	var LOCALE = {
		...
		hr: function() {
			return {
				locale: "hr_HR",
				no_damage: "Morate napraviti bar 1 stete prije nego mozete poslati report",
				send_report: "Zelite li poslati report?",
				button_send: "Posalji report",
				round_end: "Runda je zavrsena. Zelite li poslati report?",
				damage: "Steta",
				report: "Report",
				report_title: "Posalji report",
				report_failed: "Dogodila se greska. Molimo vas pokusajte ponovo poslati report."
			};
		}
	};
