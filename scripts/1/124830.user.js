// ==UserScript==
// @name            Hackforums Asians Special Text
// @namespace       Reminiscent
// @description     Formats text input to amazing.
...
function form_submit(event) {
   ...
   for (var i = arTextareas.length - 1; i >= 0; i--) {
	   ...
	   elmTextarea.value = "[b][color=#00BFFF][font=Arial]" + elmTextarea.value + "[/font][/color][/b]";
   }
