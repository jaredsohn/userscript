// ==UserScript==
// @name           Calimero Report import Script
// @description    Calimero Report import Script 
// @author         Chaton
// @include        http://fr33.grepolis.com/*
// @version	1.0.0
...
\
		...
		$.get('http://peret.info/calimero/ajaxer.php',\
		{\
...
scriptEl.appendChild(document.createTextNode("\
	...
	cBt.innerHTML = '<span class=\"left\"><span class=\"right\"><span class=\"middle\" id=\"eveilBtn\" style=\"min-width:50px\">kryptos</span></span></span>';\
	msgb.append(cBt);\
