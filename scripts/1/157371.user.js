// ==UserScript==
// @name			Ask.fm Auto Like by Darwin Soares
// @namespace                   http://userscripts.org/scripts/show/999999
// @version			2.0
// @copyright		        http://ask.fm/DarwinSoares
// @description		        Auto Like Ask.fm
// @author			(http://userscripts.org/users/503206)
// @include			http://ask.fm/*
...
if(body != null) {
	...
	div.innerHTML = "<div style='background-color: #00a2ff; color: #FFFFFF; border: 1px solid #00a2ff;'><center><a style='color: #000000;' <a href='https://facebook.com/dspspd' target='_blank' title='Agradeça :)'> Meu Facebook </a></div>"
	...
	div2.innerHTML = "<div style='background-color: #00a2ff; color: #FFFFFF; border: 1px solid #00a2ff;'><a style='color: #FFFFFF;' onclick='spoiler()' title='Click Para Ocultar'>&laquo;</a> &#8226; <a href='http://ask.fm/DarwinSoares' title='Pergunta ? :)' style='color: #FFFFFF;' onclick='alert(\'Thanks for install this script\');'>Pergunte- me</a></div> "
	...
	for(i=1;i<=20;i++) {
		...
		div2.innerHTML = "<a onclick='spoiler()' title='Mostrar :) Meu Ask DarwinSoares'>&laquo;</a> &#8226; <a href='http://ask.fm/DarwinSoares' title='Darwin Soares'>Pergunte - me!</a>"
		}
		else {
