// ==UserScript==
// @name         TW-DB.info Quick Import Button Pro + Last Update
// @include       http*://*.facebook.com/*
// @version      1.2.3
// @description  A new button next to the minimap, that quickly launches the TW-DB Import script
// @author       Petee
...
+'img alt="TW-DB Import" id="TWDBI_import_button" style="position:absolute;left:2'+(TheWestApi.version>=1.35?7:3)+'5px;top:1px;cursor:pointer" title="<'
