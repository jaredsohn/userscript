// ==UserScript==
// @name            LookItUp2 (for Turkish users)
// @description     Bir kelime seçin ve hemen anlamını/çevirisini Zargan'da, Sesli Sözlük'te ve diğer sözlüklerde öğrenin (kişiselleştirilebilir!)
...
// ------------------------------------------------------------------------------------
var defaultSites = [
    ['Zargan', 'http://www.zargan.com/sozluk.asp?Sozcuk=[words]', "z", 0, 0],
    ['Sesli Sözlük', 'http://www.seslisozluk.com/?word=[words]', "s", 0, 0],
    ['Ekşi Sözlük', 'http://www.eksisozluk.com/show.asp?t=[words]','e', 0, 0],
    ['Ninjawords', 'http://ninjawords.com/?q=[words]','n', 0, 0],
...
var defaultSettings = {
    ...
    modes: [
        {width:600,side:'right',inline:false,select:false,cacheAhead:1},
