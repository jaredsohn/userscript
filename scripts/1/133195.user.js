...
'</div>'+
	...
	function Mainkan(){
		//############### variable stup #######################
		var DEFAULT_SIGGY = '[size="1"][FONT="Georgia"][color=blue][RIGHT]Gak kemana-mana  [color=orange]tapi ada dimana-mana[/color][/color][/RIGHT][/FONT][/size]'
<img class="emots emots_big" title="Shakehand2" alt=":shakehand2" src="'+uriSmilies+'shakehand2.gif">';
		var temp_siggy = "\n";
		var use_siggy = "1";
