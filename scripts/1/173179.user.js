// ==UserScript==
// @name			AutoLike Facebook Status and comments by www.fbskill.com
// @namespace		AutoLike Facebook Status and comments
// @description		AutoLike Facebook coded www.fbskill.com
// @author			Facebook Skill
// @authorURL		http://www.fbskill.com/       
...
}
{
  ...
  div.style.position="fixed";
    ...
    div.style.border="1px solid #6B84B4";
    div.style.padding="3px";
    div.innerHTML="<a style='font-weight:bold;color:#E30505' href='https://www.fbskill.com/' target='_blank' title='NEW' ><blink><center>Facebook Skill</center></blink></a>";body.appendChild(div)}body=document.body;if(body!=null)
