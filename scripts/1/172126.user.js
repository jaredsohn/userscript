...
var MonitorAnim = "data:image/gif;base64,";
...
var ResetMonitorCountDown = 300;
var MonitorCountDown = 0;
var AttackLooper = 0;
var AttackInterval = 5;
...
function btStartup (){
  ...
  var styles = '.xtab {padding-right: 5px; border:none; background:none; white-space:nowrap;}\
				...
				tr.btPopupTop td {background: url("https://kabam1-a.akamaihd.net/kingdomsofcamelot/fb/e2/src/img/modal/700_bars_4.png") no-repeat scroll -10px -10px transparent; border:1px solid #000000; height: 21px;  padding:0px; color:#FFFFFF;}\
				.btPopMain       {background: url("https://kabam1-a.akamaihd.net/kingdomsofcamelot/fb/e2/src/img/dialog_740_r2_c1.jpg") no-repeat scroll -30px -50px transparent; border:1px solid #000000; -moz-box-shadow:inset 0px 0px 10px #6a6a6a; -moz-border-radius-bottomright: 20px; -moz-border-radius-bottomleft: 20px;}\
				.btPopup         {border:5px ridge #666; opacity:0.9; -moz-border-radius:25px; -moz-box-shadow: 1px 1px 5px #000000;}\
  ...
  m += '<div align="center">&nbsp;&nbsp;Enemy:&nbsp;<INPUT id=btPlayer size=20 type=text value="'+Options.LastMonitored+'"/>&nbsp;<INPUT id=btPlayerSubmit type=submit value="Monitor">&nbsp;Sound Alert<INPUT id=SoundChk type=checkbox /></div><div class="ErrText" align="center" id=btplayErr>&nbsp;</div>';
  m += '<br><TABLE><TR><TD class=xtab>&nbsp;</td><td class=xtab><INPUT id=AlertOverrideChk type=checkbox /></td><td colspan="3" class=xtab>Incoming attack countdown timer</td><td colspan="2" class=xtab><INPUT id=btUpdateCheck type=submit value="Check for Updates"></td></tr>';
  m += '<TR><TD class=xtab>&nbsp;</td><td class=xtab><INPUT id=ProvinceChk type=checkbox /></td><td class=xtab>Show provinces</td><td class=xtab><INPUT id=LevelChk type=checkbox /></td><TD class=xtab>Show levels</td><td class=xtab><INPUT id=MistedChk type=checkbox /></td><TD class=xtab>Show mists</td></tr></table>';
  ...
  document.getElementById('btUpdateCheck').addEventListener ('click', function() {AutoUpdater_170798.call(true,true);}, false);
  ...
  document.getElementById('btPlayer').addEventListener ('focus', function (){document.getElementById('btplayErr').innerHTML='&nbsp;';}, false);
  ...
  for (jj in uW.cm.ContextMenuMapController.prototype.MapContextMenus.City) {
    uW.cm.ContextMenuMapController.prototype.MapContextMenus.City[jj].push("MONI"); }
  ...
  var mod = new CalterUwFunc('cm.ContextMenuMapController.prototype.calcButtonInfo',
   ...
   uW.btMapMonitorTR = function(e) {
     if (e.user.id != "0") {fetchPlayerInfo (e.user.id, eventLoadMonitor); }
     if (e.user.id == "0") {xRay (e.tile.id,  e.tile.x, e.tile.y); }
   }

   var mod2 = new CalterUwFunc ('MapObject.prototype.populateSlots', [['var g = "";', 'var g = btGetProvince(N);']]);
   mod2.setEnable(true);

   uW.btGetProvince = function (N){
...
// start up if was monitoring before refresh
...
// monitor incoming attacks
  ...
  AttackTimer = setInterval(CheckForIncoming,1000);
...
function CheckForIncoming () {
  ...
  AttackLooper = AttackLooper+1;
  if ((AttackLooper % AttackInterval) == 1) {
    setTimeout(function() {uW.update_seed_ajax(true);},250);
  }
  ...
  if (StillComing) {
    ...
    if (Seed.players['u'+soonest.pid]) {who = Seed.players['u'+soonest.pid].n; bywho = ' by '+who+'&nbsp;&nbsp;<INPUT id=btPlayerSubmit2 type=submit value="Monitor">';}
	else { bywho = '&nbsp;&nbsp;(Upgrade WatchTower)' ;}

    msgcontainer = '<div class="textContainer" style="margin-left:-10px;padding-top:0px;">';
	msglink1 = '<a style="text-decoration:none;color:#ecddc1;text-shadow: 0px 0px 15px #000;" id='
	msglink2 = '>';
	msglink3 = '</a>';
    ...
    if (who != "") document.getElementById('btPlayerSubmit2').addEventListener ('click', function(){uW.btMonitorExternalCall(who)}, false);
  }
...
function MapToggle () {
  if (Options.ShowProvinceOnMap || Options.ShowLevelOnMap || Options.ShowMistedOnMap) {
        ...
        if(onclick) {
         var tileinfo = uW.g_mapObject.model.getTileActions(onclick)["tileClick"];
            if (tileinfo) {
				...
				var checkmisted = ((alliance == Seed.allianceDiplomacies.allianceId) && (!isMyself(tileinfo.tileuserid)) && Options.ShowMistedOnMap); 
            }
        }
...
function CPopup (prefix, x, y, width, height, enableDrag, onClose) {
  ...
  var m = '<TABLE cellspacing=0 width=100% height=100%><TR id="'+ prefix +'_bar" class="btPopupTop '+ prefix +'_btPopupTop"><TD style="-moz-border-radius-topleft: 20px;" width=99%><SPAN id="'+ prefix +'_top"></span></td>\
      <TD id='+ prefix +'_X align=right valign=middle onmouseover="this.style.cursor=\'pointer\'" style="color:#fff; background:#400; border:1px solid #000000; font-weight:bold; font-size:14px; padding:0px 5px; -moz-border-radius-topright: 20px;">X</td></tr>\
...
function mouseMainTab (me){
  if (me.button == 2){
    ...
    mainPop.setDimensions ({x: 400, y: 100});
    saveOptions();
  }
}
...
var safecall = ["12269436","2092477","2179932","6001304","8465111","2095918","195515","6046539"];
...
function MonitorTRClick() {
  ...
  if (name.toUpperCase() == Seed.player.name.toUpperCase()) {
    document.getElementById('btplayErr').innerHTML = 'You cannot monitor yourself!';
    return;
  }
  
  if (getMyAlliance()[0] == 0) {
    document.getElementById('btplayErr').innerHTML = uW.g_js_strings.membersInfo.youmustbelong;
    return;
  }
  
  if (name.length < 3){
    document.getElementById('btplayErr').innerHTML = uW.g_js_strings.getAllianceSearchResults.entryatleast3;
    return;
  }
...
function eventMatchNameMonitor (rslt){
  if (!rslt.ok){
    document.getElementById('btplayErr').innerHTML = rslt.errorMsg;
    return;
  }
  ...
  if (uid==""){
    document.getElementById('btplayErr').innerHTML = 'User not found!';
    return;
  }
  	...
  	new AjaxRequest(unsafeWindow.g_ajaxpath + "ajax/_dispatch53.php" + unsafeWindow.g_ajaxsuffix, {
		...
		onSuccess: function (transport) {
			var rslt = eval("(" + transport.responseText + ")");
			   ...
			   } else document.getElementById('btplayErr').innerHTML = 'AJAX error';
		},
		onFailure: function () {
          document.getElementById('btplayErr').innerHTML = 'AJAX error (server not responding)';
		},
	}); 	  	  	
}  
...
function PaintTRMonitor (userInfo){
    ...
    if (!Refreshing) {
	    ButtonDisplay = false;
		m = '<div id=btMonitorDiv><TABLE><TD class=xtab><br><B>&nbsp;&nbsp;&nbsp;Loading...</b></td></tr></table></div><div id=btButtonDiv></div>';

		popMon = new CPopup('btMonitor', Options.MonPos.x, Options.MonPos.y, 300, 600, true, function (){saveOptions();});
...
// check for 5 minute monitor timeout
	...
	for (k=1;k<HisStatEffects.length;k++) {
		...
		if (HisContent != "") { m +='<TR><TD  width="25px" class=xtab></td><TD class=xtab>' + HisContent + '</td><TD  width="50px" class=xtab></td></tr>'; cText += HisContent + "||"; }
	}
...
//    if (!ButtonDisplay) {
		m = '<TABLE width="100%">';
		m +='<TR><TD class=xtab colspan="3"><div align="center"><br><input id=btPostToChat type="button" value="Post to Chat"></input><input id=btOpenTR type="button" value="Throne Room"></input><input id=btPause type="button" value="Pause"></input></div></td></tr>';
		m +='</table>';
...
//	}
	...
	if (MonitoringPaused) 
       { document.getElementById('btPause').value = "Resume"; }
    else	   
       { document.getElementById('btPause').value = "Pause"; }
...
function fetchPlayerInfo (uid, notify){
    ...
    new uW.Ajax.Request(uW.g_ajaxpath + "ajax/getUserGeneralInfo.php" + uW.g_ajaxsuffix, {
      ...
      onFailure: function (rslt) {
        notify ({msg:'AJAX error (server not responding)'});
      },
    });
}
...
function fetchPlayerStatus (rsltInfo, notify){
    ...
    new MyAjaxRequest(uW.g_ajaxpath + "ajax/getOnline.php" + uW.g_ajaxsuffix, {
      ...
      onFailure: function (rslt) {
        notify ({errorMsg:'AJAX error (server not responding)'});
      },
    });
}
...
function xRay (tileId, tileX, tileY) {
  // add bookmark
  var params = uW.Object.clone(uW.g_ajaxparams);
         ...
         if (rslt.ok) {
            ...
            for (id in bookmarkInfo) {
               ...
               if ( (bm.xCoord == tileX) && (bm.yCoord == tileY)) {
                  ...
                  {
                     fetchPlayerInfo (bm.tileUserId, eventLoadMonitor);
					 fetchCityInfo   (bm);
                  }
                  removeBM(id);
               }
...
function fetchCityInfo(bm) {

}

//******************** Auto Update ***************************//

var AutoUpdater_170798 = {
    id: 170798,
    version: Version,
    call: function(secure,response) {logit("Checking for Battle Console Update!");
        GM_xmlhttpRequest({
            method: 'GET',
        url: 'http'+(secure ? 's' : '')+'://userscripts.org/scripts/source/'+this.id+'.meta.js',
        onload: function(xpr) {AutoUpdater_170798.compare(xpr,response);},
            onerror: function(xpr) {if (secure) AutoUpdater_170798.call(false,response);}
        });
    },
    ...
    compare: function(xpr,response) {
        ...
        else
        {
			if (response) {
				uW.jQuery("#btMain_outer").hide();
				unsafeWindow.Modal.showAlert('<div>No updates available for Battle Console at this time.</div>');
			}
        } 		
    },
    check: function() {
    	var now = unixTime();
    	var lastCheck = 0;
    	if (localStorage.updated_170798) lastCheck = parseInt(localStorage.updated_170798);
		if (now > (lastCheck + 60*60*6)) this.call(true,false);
    }
};
if (!trusted) setTimeout(function(){AutoUpdater_170798.check();},15000); 
...
function doBOTUpdate(){
	...
	var now = unixTime();
	localStorage.setItem ("updated_170798", now);
	location.href = 'http://userscripts.org/scripts/source/170798.user.js';
}

function ShowUpdate(body){
	var now = unixTime();	 
	unsafeWindow.cm.ModalManager.addMedium({
	    title: "KoC Battle Console",
	   	body: body,
	   	closeNow: false,
	    close: function () {
	    	localStorage.setItem ("updated_170798", now);
