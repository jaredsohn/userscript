// ==UserScript==
// @name         中文排版
// @namespace    http://zhiliao.in/
// @description  以适合中文阅读的方式展示内容
// @version      0.5
// @include      *
// 
// @author       Unstop
// @homepage     http://unstop.in/
// @contributor  Vinta(http://vinta.ws/) jiefoxi (https://github.com/jiefoxi)
...
function insert_space(text) {
    ...
    // 中文在前
    text = text.replace(/([\u4e00-\u9fa5\u3040-\u30FF])([a-zA-Z])/ig, '$1 $2');

    // 中文在後
    text = text.replace(/([a-zA-Z])([\u4e00-\u9fa5\u3040-\u30FF])/ig, '$1 $2');
