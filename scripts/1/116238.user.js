// ==UserScript==
// @name			DoA RedSoldier Power Tools Pluss
 ...
 ********************************************************************************/
// Script information
var Version = 'Green&Black'; // Year, Month, Day, Revision, Maturity (e.g. YYYMMDDa_BETA)
...
// Help pages
var urlError = 'http://www.facebook.com/pages/RedSoldier/105645826209894';
...
var Styles = '\
    div.' + rndClass['tab_title'] + ' {border:1px solid; border-color:#000000; font-weight:bold; padding-top:2px; padding-bottom:2px; text-align:center; color:#000000; background-color:#008000}\
    div.' + rndStyle['classPrefix'] + 'Subtitle {border:1px solid; border-color:#000000; font-weight:bold; padding-top:2px; padding-bottom:2px; text-align:center; color:#000000; background-color:#008000}\
    div.' + rndStyle['classPrefix'] + 'Input {border:2px ridge black; background-color:#008000; padding:3px}\
    div.' + rndStyle['status_ticker'] + ' {border:2px ridge black; background-color:#008000; padding:2px}\
	div.' + rndStyle['status_feedback'] + ' {height: 34px; border:1px solid black; background-color:#008000; padding: 2px 0px 2px 2px; text-align:left; font-weight:bold;}\
    ...
    div#qTip {padding: 3px; border: 1px solid #777; border-right-width: 2px; border-bottom-width: 2px; display: none; background: #008000; color: #000; font: bold 9px Verdana, Arial, sans-serif; text-align: left; position: absolute; z-index: 1000}\
    table.' + rndStyle['classPrefix'] + 'TabPad tr td {border:none; background:#008000; white-space:nowrap; padding: 1px 1px}\
    table.' + rndStyle['classPrefix'] + 'Tab tr td {border:none; background:#008000; white-space:nowrap; padding: 1px 1px;}\
    table tr td.' + rndStyle['classPrefix'] + 'TabLeft {font-weight:bold; text-align:right; padding-right: 5px}\
    table.' + rndStyle['classPrefix'] + 'TabLined tr td {border-bottom:1px solid #ccc; background:#008000; padding: 1px 4px 1px 4px;}\
    table tr.' + rndStyle['classPrefix'] + 'TabHdr1 td {background-color:#008000; font-weight:bold}\
    ...
    tr.pbretry_ptpoptp td { background-color:#a00; color:#000; border:none; height: 21px; padding:0px; }\
    tr.' + rndStyle['classPrefix'] + 'retry_ptpoptp td { background-color:#008000; color:#000; border:none; height: 21px; padding:0px; }\
    tr.' + rndStyle['classPrefix'] + 'Owned {background-color: #008000; color:black}\
    ...
    table.' + rndStyle['classPrefix'] + 'MainTab tr td.sel    {font-weight:bold; font-size:13px; border: 1px solid; border-style: solid solid none solid; background-color:black; color:green; border-color:green; cursor:hand; cursor:pointer; padding: 2px;}\
    table.' + rndStyle['classPrefix'] + 'MainTab tr td.notSel {font-weight:bold; font-size:13px; border: 1px solid; border-style: solid solid none solid; background-color:#008000; color:black; border-color:black; cursor:hand; cursor:pointer; padding: 2px;}\
    .' + rndStyle['classPrefix'] + 'CP .' + rndStyle['classPrefix'] + 'CPMain { background-color:#008000; padding:6px;}\
...
Tabs.Waves = {
	...
	cont : null,
	troopList : [kSpy, kATrans, kLBM, kSSDrg, kBatDrg, kFireM, kFang, kOgre, kLavaJaw, kBanshee, kGrtDrg, kWatDrg, kStnDrg, kFreDrg, kWndDrg],
	enabled : false,
	attackTimer : null,
	marchTimer: null,
	attackErrors : 0,
...
Tabs.AutoAttack = {
  ...
  init : function (div){
    ...
    div.innerHTML = '<DIV class=' + rndClass['tab_title'] + '>' + Data.options.mapChoice + ' </div>\
      ...
      <TABLE width=100% bgcolor=#008000 align=center><TR><TD>\
...
//*** Attacks Tab - Stats Sub-tab ***
  tabStats : function (){
    ...
    t.contentType = 3;
    document.getElementById('pbatStats').style.backgroundColor = "black"; 
    document.getElementById('pbatStats').style.color = "green"; 
 ...
 // Data.options.campAttack {enabled:false, maxDist:7, repeatTime:3660, delayMin:15, delayMax:25, levelEnable:[], levelDist:[]}
  ...
  tabConfigLevels : function (){
    ...
    t.contentType = 0;
    document.getElementById('pbatConfigL').style.backgroundColor = "black"; 
    document.getElementById('pbatConfigL').style.color = "green";
...
//*** Attacks Tab - Config Sub-Tab ***
  tabConfigGeneral : function (){
    ...
    t.contentType = 1;
    document.getElementById('pbatConfigG').style.backgroundColor = "black"; 
    document.getElementById('pbatConfigG').style.color = "green"; 
...
//*** Attacks Tab - Targets Sub-Tab ***
  tabTargets : function (){
    ...
    t.contentType = 2;
    document.getElementById('pbatTargets').style.backgroundColor = "black"; 
    document.getElementById('pbatTargets').style.color = "green";
...
//*** Attacks Tab - Maps Sub-tab ***
  tabMaps : function(){
    ...
    t.contentType = 4;
    document.getElementById('pbatMaps').style.backgroundColor = "black"; 
    document.getElementById('pbatMaps').style.color = "green";
...
//    researchTimer   : null,
	...
	init : function (div){
		...
		// Tab initialization
		t.cont = div;
		div.innerHTML =  '<TABLE width=100% bgcolor=#008000 align=center><TR><TD>\
	...
	tabJobInfo : function (){
        ...
        t.contentType = 0;
	    document.getElementById(rndStyle['subtab_info']).style.backgroundColor = "black"; 
        document.getElementById(rndStyle['subtab_info']).style.color = "green";
	...
	tabJobTrain : function (){
        ...
        t.contentType = 1;
        document.getElementById(rndStyle['subtab_train']).style.backgroundColor = "black"; 
        document.getElementById(rndStyle['subtab_train']).style.color = "green"; 
	...
	tabJobBuild : function (){
        ...
        t.contentType = 2;
        document.getElementById(rndStyle['subtab_build']).style.backgroundColor = "black"; 
        document.getElementById(rndStyle['subtab_build']).style.color = "green"; 
	...
	tabJobResearch : function (){
        ...
        t.contentType = 3;
        document.getElementById(rndStyle['subtab_research']).style.backgroundColor = "black"; 
        document.getElementById(rndStyle['subtab_research']).style.color = "green"; 
...
//      return;
    ...
    tabTrain : function(){
        ...
        document.getElementById('pbttTrain').style.backgroundColor = "black"; 
        document.getElementById('pbttTrain').style.color = "green";
    ...
    tabConfigTrain : function(){
        ...
        document.getElementById('pbttConfigTrain').style.backgroundColor = "black"; 
        document.getElementById('pbttConfigTrain').style.color = "green";
  ...
  function CcityButHandler (t){
    ...
    function clickedCityBut (e){
      ...
      if (that.coordBoxX){
        ...
        that.coordBoxX.style.backgroundColor = '#008000';
        that.coordBoxY.style.backgroundColor = '#008000';
      }
      if (that.notify != null)
...
function CPopup (prefix, x, y, width, height, enableDrag, onClose) {
  ...
  var m = '<TABLE cellspacing=0 width=100% height=100%>\
           <TR id="'+ rndPopup['bar'] +'" style="background-color: #008000;">\
           <TD width=100% valign=bottom>\
           <SPAN id="'+ rndPopup['top'] +'"></span></td>\
           <TD id='+ rndPopup['X'] +' align=right valign=middle onmouseover="this.style.cursor=\'pointer\'" style="color:black; background:#008000; font-weight:bold; font-size:14px; padding:0px 4px">X</td></tr>\
...
t.state = null; 
  ...
  write : function (msg){
    ...
    if (++t.lineNum % 2)    
      ...
      te.style.backgroundColor = '#008000'; 
    var now = new Date();
    var m = [];
