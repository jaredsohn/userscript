// ==UserScript==
// @name            No Atualizações
// @namespace       No Atualizações
// @include         http://www.orkut.com/Home.*
// @description     Retira o quadro "Atualizações dos seus amigos" da home do seu Orkut
function do_platypus_script() {
smart_remove(window.document,document.evaluate('/HTML[1]/BODY[1]/DIV[4]/DIV[4]/TABLE[4]/TBODY[1]/TR[2]/TD[1]', document, null, XPathResult.FIRST_ORDERED_NODE_TYPE,null).singleNodeValue,null,null,null);
smart_remove(window.document,document.evaluate('/HTML[1]/BODY[1]/DIV[4]/DIV[4]/TABLE[4]/TBODY[1]/TR[1]/TD[1]', document, null, XPathResult.FIRST_ORDERED_NODE_TYPE,null).singleNodeValue,null,null,null);
smart_remove(window.document,document.evaluate('/HTML[1]/BODY[1]/DIV[4]/DIV[4]/TABLE[4]', document, null, XPathResult.FIRST_ORDERED_NODE_TYPE,null).singleNodeValue,null,null,null);
