...
function parsePlayerPage(address, page) {
    ...
    getInetPage("http://goallineblitz.com/game/home.pl", parseCurrentDay);
}
...
function parseCurrentDay(address, page) {
    ...
    setDay(parseInt(d));
    getInetPage("http://goallineblitz.com/game/bonus_tokens.pl?player_id="+playerId, loadTrainingUpgrades);
}
...
function loadTrainingUpgrades(address, page) {
    ...
    getInetPage("http://goallineblitz.com/game/boost_player.pl?player_id="+playerId, loadAvailableBoosts);
    getInetPage("http://goallineblitz.com/game/xp_history.pl?player_id="+playerId, loadBoostCount);
}
