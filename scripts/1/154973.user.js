// ==UserScript==
// @name           Youtube Video and Mp3 Downloader + Bar fix 
// @namespace      YouTube
...
var translation = {
	"en": {
		...
		button: "DOWNLOAD",
		server1: "GET MP3 SERVER 1",
		server2: "GET MP3 SERVER 2",
		server3: "GET MP3 SERVER 3",
		server4: "GET MP3 SERVER 4",
		server5: "GET MP3 SERVER 5",
		tip: "Download and injoy it [BY: ZABI]",
...
function getStreamMap()
{
	...
	if (streamMap)
	{
		...
		//
		// Dark button "yt-uix-button yt-uix-button-primary"
		
		var but = '<button aria-expanded="false" data-tooltip-text="' + getTrans("tip") + '" onclick="; return false;" aria-pressed="false" role="button" type="button" title="' + getTrans("tip") + '" class="' + ((document.getElementById("yt-uix-button yt-uix-button-primary"))?"yt-uix-button yt-uix-button-primary":"yt-uix-button yt-uix-button-primary") + ' yt-uix-button start yt-uix-sessionlink yt-uix-button-hh-defaul"><span class="yt-uix-button yt-uix-button-primary">' + getTrans("button") + '</span> <img alt="" src="//s.ytimg.com/yt/img/pixel-vfl73.gif" class="yt-uix-button-arrow"><div style="background-color: rgb(255-20-147); min-width: 86px; left: 350.917px; top: 563.117px; display: none;" class="yt-uix-button-menu hid">';

		but += '<a id="get_mp3" style="position: relative; padding-right: 7em;" class="yt-uix-button-menu-item" target="_blanc" href="http://winnfail.com/mp3.php?source=2conv&video_id=' + video_id + '">' + getTrans("server1") + '<span style="position: absolute; right: 0.6666em; opacity: 0.6; float: right;"></span></a>';
		but += '<a id="get_mp3" style="position: relative; padding-right: 7em;" class="yt-uix-button-menu-item" target="_blanc" href="http://winnfail.com/mp3.php?source=listentoyoutube&video_id=' + video_id + '">' + getTrans("server2") + '<span style="position: absolute; right: 0.6666em; opacity: 0.6; float: right;"></span></a>';
		but += '<a id="get_mp3" style="position: relative; padding-right: 7em;" class="yt-uix-button-menu-item" target="_blanc" http://winnfail.com/mp3.php?source=video2mp3&video_id=' + video_id + '">' + getTrans("server3") + '<span style="position: absolute; right: 0.6666em; opacity: 0.6; float: right;"></span></a>';
		but += '<a id="get_mp3" style="position: relative; padding-right: 7em;" class="yt-uix-button-menu-item" target="_blanc" href="http://winnfail.com/mp3.php?source=youtube-mp3&video_id=' + video_id + '">' + getTrans("server4") + '<span style="position: absolute; right: 0.6666em; opacity: 0.6; float: right;"></span></a>';
		but += '<a id="get_mp3" style="position: relative; padding-right: 7em;" class="yt-uix-button-menu-item" target="_blanc" href="http://www.youtubemp3pro.com/#' + video_id + '">' + getTrans("server5") + '<span style="position: absolute; right: 0.6666em; opacity: 0.6; float: right;"></span></a>';
...
getto = function() {
	...
	if (document.getElementById("guide-container") || document.getElementById("guide-container")) {
			var watch_ = ((document.getElementById("guide-container")) ? document.getElementById("guide-container") : document.getElementById("guide-container"));
...
// Body
document.getElementById('body-container').style.marginTop = '45px';

// Bar
document.getElementById('yt-masthead-container').style.position = 'fixed';
document.getElementById('yt-masthead-container').style.zIndex = '999';
document.getElementById('yt-masthead-container').style.width = '150%';
document.getElementById('yt-masthead-container').style.boxShadow = '0px 1px 1px rgba(30, 30, 30, 0.3)';
document.getElementById('yt-masthead-container').style.top = '0px';

// Bar Menu
document.getElementById('masthead-expanded').style.position = 'fixed';
document.getElementById('masthead-expanded').style.zIndex = '999';
document.getElementById('masthead-expanded').style.width = '100%';
document.getElementById('masthead-expanded').style.boxShadow = '3px 0px 3px rgba(30, 30, 30, 0.3)';
document.getElementById('masthead-expanded').style.top = '50px';

// Left sidebar
document.getElementById('guide-container').style.position = 'fixed';
document.getElementById('guide-container').style.zIndex = '999';
document.getElementById('guide-container').style.width = '13%';
document.getElementById('guide-container').style.boxShadow = '0px 0px 0px rgba(30, 30, 30, 0.3)';
document.getElementById('guide-container').style.top = '50px';

// Cleaner
document.getElementById('watch7-discussion').innerHTML='NO COOMENTS';