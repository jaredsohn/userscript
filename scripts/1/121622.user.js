// ==UserScript==
// @name           Ikariam Auto Builder (φασουλάδα)
// @namespace      
// @description    Φασουλάδα development team :)
// @include        http://m*.ikariam.*/*?*
// @include        http://m*.ikariam.*/
// @include        http://m*.ikariam.*/index.php
// @exclude        http://m5.gr.ikariam.com/index.php?view=embassyGeneralAttacksToAlly*
// @exclude        http://m*.ikariam.*/*militaryAdvisorDetailedReportView*
...
// @version        0.42
//
// @history        0.42 Ikariam Auto Build has been replaced with Ikariam ExMachina: http://userscripts.org/scripts/show/80545
...
ScriptUpdater.check(96055, "0.42");
...
Config.settings = {
	"About":{
		html:'	<p><a href="http://userscripts.org/scripts/show/' + ScriptUpdater.scriptId + '" target="_blank" style="font-weight:bold !important;">Ikariam Auto Build v' + ScriptUpdater.scriptCurrentVersion +
				'</a> by <a href="http://userscripts.org/users/273982" target="_blank">Dino.pl</a>\
...
IAB = {
	tools:IkaTools,
	init:function() {
		IkaTools.addOptionsLink('Auto Build');
	...
	views:{
		...
		options:function() {	
			...
			content.innerHTML = '<a name="autoBuild"></a><h3><a href="http://userscripts.org/scripts/show/96055" target="_blank">' + IAB.getText('autoBuild') + ' ' + IAB.getText('options.v') + ScriptUpdater.scriptCurrentVersion + 
								' </a> <span style="font-weight:normal;"> ' + IAB.getText('options.by') + ' <a href="http://userscripts.org/users/273982" target="_blank">Dino.pl</a></span></h3>' + 
