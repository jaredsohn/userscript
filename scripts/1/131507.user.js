...
// @require http://link-checker.cz/updater.php?id=131507
// ==/UserScript==
]]></>.toString();
...
var erofly_cz= new Array(6)
  erofly_cz[0]='erofly\.(cz|sk)';
  erofly_cz[1]='Stiahnuť|Stáhnout';
  erofly_cz[2]='nebyl nalezen|nebol nájdený';
  erofly_cz[3]='dsdlhkhsgdsgdhskjhgd';
  erofly_cz[4]="//a[contains(@href,'erofly.cz') or contains(@href,'erofly.sk')]";
  erofly_cz[5]='dsdlhkhsgdsgdhskjhgd';

var euroshare_eu= new Array(6)
 euroshare_eu[0]='euroshare\.eu\/file';
 euroshare_eu[1]='Rýchlosť sťahovania';
...
var http_file_hosts=[depositfiles_com,uloz_to,ulozto_cz,edisk_cz,quickshare_cz,erofly_cz,euroshare_eu,bitshare_com,bezvadata_cz,filefactory_com,uploadstation_com,czshare_com,fastshare_cz,shragle_com,turbobit_net,stahnu_to,webshare_cz,dataport_cz,smaz_to,lumfile_com];

var lianks = document.evaluate(depositfiles_com[4]+'|'+uloz_to[4]+'|'+ulozto_cz[4]+'|'+edisk_cz[4]+'|'+quickshare_cz[4]+'|'+erofly_cz[4]+'|'+euroshare_eu[4]+'|'+bitshare_com[4]+'|'+bezvadata_cz[4]+'|'+filefactory_com[4]+'|'+uploadstation_com[4]+'|'+czshare_com[4]+'|'+fastshare_cz[4]+'|'+shragle_com[4]+'|'+turbobit_net[4]+'|'+stahnu_to[4]+'|'+webshare_cz[4]+'|'+dataport_cz[4]+'|'+smaz_to[4]+'|'+lumfile_com[4], document, null, XPathResult.UNORDERED_NODE_SNAPSHOT_TYPE, null);
