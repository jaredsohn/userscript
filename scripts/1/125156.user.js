// ==UserScript==
// @name The West - Job Group Button
// @namespace      http://www.the-west.ru
// @include        http://*.the-west.*/game.php*
// @description This will add a button, for grouping jobs. Find a job, click the '+' to add it to your collection. Jobs can be started fron your list /
// @author         Billy Black
// @translator     Enfo
// ==/UserScript==
...
function addMotivationButton() {
	...
	menuElem.innerHTML = '<a href="#" onclick="MoCheck.openMotivationWindow();">' +
						 '  <span style="display:block; width:105px; font-weight:normal; color:#fff; margin-left:25px; padding-top:5px;"><b>Мотивация</b></span>' +
						 '</a>';
...
function getAuthor() {
	...
	return '<a href=\"' + hrefStr + '\">JoeSmith</a>';
}
