...
// ==UserScript==
// @name           Routing Blocker
// @author         .
// @namespace      http://userscripts.org/scripts/show/166362
// @description    Bekleme Yok, Reklam Yok.. Daha ne Olsun!! [www.silentall.com]
// @updateURL      http://userscripts.org/scripts/source/166362.meta.js
// @installURL     http://userscripts.org/scripts/source/166362.user.js
// @version        1.1.0.14
// @grant          unsafeWindow
        ...
        bcvc: {
            ...
            fn: function () {
                ...
                if (v) {
                    ...
                    append('script', i);
                    document.title = "Routing Blocker...";
                }
            }
        },
        jack: {
