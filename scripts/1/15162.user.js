// ==UserScript==
// @name        Washington County Public Library - LibraryLookup
// @description Check book availability in Washington County Public Library.  When you look at a book on Amazon.com, this script will check the Washington County Public Library catalog, then show you in the best link to get the book.  Written by Nick Baker, Reference and Web Services Librarian; adapted for wccls by Rudi Pittman.
// @include     http://www.amazon.*
// @include     http://books.google.*
// ==/UserScript==
// V1.1 on 10/28/2010 to support new Amazon changes for Polaris Library System.
...
(
   function()
   {
      ...
      var colpub =
      {
            ...
            {
               var prefix = 'http://www.wccls.org/polaris/search/searchresults.aspx?ctx=1.1033.0.0.1&type=Keyword&term=';
            ...
            keepLooking: function()
            {
               if ( 0 == extraIsbns.length && 1 == this.libraries.length )
               {
				   ...
				   var sfx = '<a target="_blank" style="text-decoration:none" ' +
				   		'href="http://www.wccls.org/library_services/interlibrary_loan">' +
