...
// @description    Automated features 
// @require        
// ==/UserScript==
...
Tabs.Search = {
  ...
  clickedSearch : function (){
    ...
    if (t.opt.searchType == 1){
      ...
      m += htmlOptions ( {1:'Glassland/Lake', 3:'Woodlands', 4:'Hills', 5:'Mountain', 6:'Plain', 7:'BOGS', 0:'ALL'}, Options.wildType );
	  m+= '</select></td></tr>';
      ...
      m+= '<TR><TD class=xtab align=right>BOGS:</td><TD class=xtab><INPUT name=pbfil id=pafilBOGS type=CHECKBOX '+ (Options.BOGSOnly?' CHECKED':'') +'\><td></tr>';
	}
   if (t.opt.searchType == 1 || t.opt.searchType == 0) {
  ...
  dispMapTable : function (){
    var tileNames = ['Barb Camp', 'Grassland', 'Lake', 'Woodlands', 'Hills', 'Mountain', 'Plain', 'BOG' ];
    var t = Tabs.Search;
