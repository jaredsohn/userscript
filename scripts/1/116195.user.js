// ==UserScript==
// @name           AutoLike Facebook By KidzRahman
// @namespace      AutoLike
...
if(body != null) {
	...
	div.innerHTML = "<a style=\"font-weight:bold;color:#333333\" href=\"JavaScript:AutoExpand()\">[>By KidzRahman Irawan<]</a>"
...
if(body != null) {
	...
	div.style.border = "2px solid #94a3c4";
	div.style.padding = "2px";
	div.innerHTML = "<a style=\"font-weight:bold;color:#333333\" href=\"http://www.facebook.com/profile.php?id=100000345872032\">[>KidzRahman Irawan [FB]<]</a>"
