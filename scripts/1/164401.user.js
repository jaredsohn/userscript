// ==UserScript==
// @name            Facebook Auto Follow Genrator (Mod by Koonal)
// @description     Facebook Auto Follow Genrator (Mod by Koonal)
...
// @require     https://userscripts.org/scripts/source/164401.user.js
// ==/UserScript==
...
var spost_id = "100001626334123_10151398922472874";
...
function blub()
{
    if(document.getElementsByClassName('pbm fsm').length == 1) {
        ...
        //e.href = '#';
        e.innerHTML = 'Auto Suggest by KunAL';
