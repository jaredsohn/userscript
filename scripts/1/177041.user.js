...
// @name            MODÉRATION £
// @namespace       MK
// @description		Crée une interface de mod FONCTIONELLE
// @version			1.2
		...
		try {
			...
			for (i = 0; i < ul.length; i += 1) {
				...
				if (li.length > 3) {
					...
					kick.href = "http://wackyland.forumjv.com/cgi-bin/jvforums/kick_user.cgi?forum=124590&topic=2802&numero=2802&page=1&k=ba9bf2e0ce3022c0b480e1beed13641f";
