...
// @description    SUPER Script terbaru dr ^LcH-KinG^ buat Facebooker'S Mania--UPDATE
...
var lang = {
	...
	en : {
		...
		'Close' : 'Close',
		'ConfigureFacebook^LcH-KinG^' : 'Configure ^LcH-KinG^ Script',
		...
		'ConfFacebook^LcH-KinG^Language' : 'Language for ^LcH-KinG^ Script',
		'ConfFacebookTimestamps' : 'Show Facebook timestamps (eg. "3 hours ago").',
		'ConfFBFTimestamps' : 'Add ^LcH-KinG^ Script timestamps after Facebook timestamps (eg. "11:45").',
		'ConfFBFTimestamps24' : 'Show ^LcH-KinG^ Script timestamps in 24-hour format.',
		...
		'ConfSectionAbout' : 'About ^LcH-KinG^ Script',
		...
		'ConfUpdates' : 'Check Userscripts.org daily for updates to ^LcH-KinG^ Script. Or <a href="#" id="fbfUpdateLink" onclick="return false;">check now</a>.',
		...
		'UpdateAvailable1' : 'An update is available for ^LcH-KinG^ Script',
	...
	es : {
		...
		'Close' : 'Cerrar',
		'ConfigureFacebook^LcH-KinG^' : 'Configuración de ^LcH-KinG^ Script',
		...
		'ConfFacebook^LcH-KinG^Language' : 'Lenguaje del ^LcH-KinG^ Script',
		'ConfFacebookTimestamps' : 'Mostrar cuanto hace que fue creado (Ejemplo: "Hace 3 horas").',
		'ConfFBFTimestamps24' : 'Mostrar las marcas de tiempo de ^LcH-KinG^ Script en formato 24 horas.',
		'ConfFBFTimestamps' : 'Añadir las marcas de tiempo de ^LcH-KinG^ Script después de las marcas de tiempo de Facebook (Por ejemplo "11:45").',
		...
		'ConfSectionAbout' : 'Acerca de ^LcH-KinG^ Script',
		...
		'ConfShortcutList' : '<b>Atajos de Teclado</b> (sensible a la diferencia entre minúsculas y mayúsculas):<br /><br /><i>Desde cualquier página:</i><br />&nbsp;<b>A</b> - Álbumes/Fotos<br />&nbsp;<b>B</b> - Activar/Desactivar lista de amigos (Amigos conectados)<br />&nbsp;<b>C</b> - Configuración de ^LcH-KinG^ Script<br />&nbsp;<b>D</b> - Cumpleaños<br />&nbsp;<b>E</b> - Eventos<br />&nbsp;<b>F</b> - Amigos<br />&nbsp;<b>H</b> - Página de Inicio<br />&nbsp;<b>I</b> - Bandeja de Entrada<br />&nbsp;<b>K</b> - Añadir Marcador<br />&nbsp;<b>L</b> - Seleccionar vínculo para terminar la sesión (presione Enter después para terminar la sesión)<br />&nbsp;<b>N</b> - Notificaciones<br />&nbsp;<b>P</b> - Perfil<br />&nbsp;<b>R</b> - Peticiones<br />&nbsp;<b>S</b> - Saltar a el campo de búsqueda<br />&nbsp;<b>T</b> - Traducir el texto seleccionado<br />&nbsp;<b>?</b> - Mostrar la información de depuración de ^LcH-KinG^ Script<br />&nbsp;<b><escape></b> - Cerrar la ventana emergente creada por ^LcH-KinG^ Script<br /><br /><i>Desde la página de inicio (filtros)</i>:<br />&nbsp;<b>a</b> - Páginas<br />&nbsp;<b>f</b> - Live feed<br />&nbsp;<b>g</b> - Grupos<br />&nbsp;<b>l</b> - Vínculos<br />&nbsp;<b>n</b> - Noticias<br />&nbsp;<b>p</b> - fotos<br />&nbsp;<b>s</b> or <b>u</b> - Estatus de las Actualizaciones<br />&nbsp;<b>t</b> - Notas<br />&nbsp;<b>v</b> - Vídeos<br /><br /><i>Desde los perfiles</i>:<br />&nbsp;<b>i</b> - Información<br />&nbsp;<b>p</b> - Fotos<br />&nbsp;<b>w</b> - Muro<br />&nbsp;<b>x</b> - Cajas<br /><br /><i>Desde las páginas con paginación (previo, siguiente, etc)</i><br />&nbsp;<b><left arrow></b> - Previo<br />&nbsp;<b><right arrow></b> - Siguiente<br />&nbsp;<b><shift> + <left arrow></b> - Primera (cuando este disponible)<br />&nbsp;<b><shift> + <right arrow></b> - Ultimo (cuando este disponible)<br /><br /><i>Al ver albumes/fotos:</i><br />&nbsp;<b>a</b> - Ver todas la miniaturas (cuando este disponible)<br />&nbsp;<b>b</b> - Ver fotos grandes<br />&nbsp;<b>c</b> - Ver comentarios<br />&nbsp;<b>k</b> - De vuelta al álbum<br />&nbsp;<b>m</b> - Fotos de (personas) y yo<br /><br /><i>Al ver albumes recientes y fotos subidas/marcadas:</i><br />&nbsp;<b>a</b> or &nbsp;<b>r</b> - Albumes Recientes<br />&nbsp;<b>m</b> or &nbsp;<b>u</b> - Fotos de Móviles<br />&nbsp;<b>o</b> - Fotos de mi<br />&nbsp;<b>p</b> - Mis Fotos<br />&nbsp;<b>t</b> or &nbsp;<b>f</b> - Amigos Marcados', 'ConfTopBarHoverOpacity' : 'Al pasar el ratón por encima', 'Facebook^LcH-KinG^Conflict' : 'Facebook ^LcH-KinG^ ahora se llama ^LcH-KinG^ Script.<br /><br />Por el cambio de nombre es necesario desinstalar Facebook ^LcH-KinG^ manualmente de su navegador o los dos programas entraran en conflicto.<br /><br />Si no sabe como desinstalar un userscript, <a %s>haga clic aquí para ver instrucciones</a>.',
		...
		'ConfUpdates' : 'Revisar Userscripts.org diarimente por si hay actualizaciones en ^LcH-KinG^ Script. O <a href="#" id="fbfUpdateLink" onclick="return false;">revisar Ahora</a>.',
		...
		'UpdateAvailable1' : 'Hay una actualización disponible para ^LcH-KinG^ Script',
	...
	fr : {
		...
		'Close' : 'Fermer',
		'ConfigureFacebook^LcH-KinG^' : 'Configurer ^LcH-KinG^ Script',
		...
		'ConfFacebook^LcH-KinG^Language' : 'Langue de ^LcH-KinG^ Script',
		'ConfFacebookTimestamps' : 'Affichage de la datation Facebook (ex. "Il y a 3 heures").',
		'ConfFBFTimestamps' : 'Ajout de la datation ^LcH-KinG^ Script apr&egrave;s la datation Facebook (ex. "11:45").',
		'ConfFBFTimestamps24' : 'Affichage de la datation ^LcH-KinG^ Script au format 24 heures.',
		...
		'ConfSectionAbout' : 'A propos de ^LcH-KinG^ Script',
		...
		'ConfUpdates' : 'V&eacute;rifie quotidiennement si une mise &agrave; jour de ^LcH-KinG^ Script est disponible sur Userscripts.org. Ou <a href="#" id="fbfUpdateLink" onclick="return false;">v&eacute;rifier maintenant</a>.',
		...
		'Facebook^LcH-KinG^Conflict' : '^LcH-KinG^ Script est maintenant devenu ^LcH-KinG^ Script. A cause du changement de nom, vous aurez besoin de d&eacute;sinstaller manuellement ^LcH-KinG^ Script de votre explorateur, ou les deux scripts rentreront en conflit. Si vous n\'&ecirc;tes pas s&ucirc;r de comment faire pour d&eacute;sinstaller un userscript, <a %s>cliquez ici pour la marche &agrave; suivre</a>.',
		...
		'Left' : 'Gauche',
		'ListeningRestarted' : '^LcH-KinG^ Script s\'est remit \340 l\'\351coute des changements \351ventuels.',
		'ListeningStopped' : '^LcH-KinG^ Script a arret\351 d\'\352tre \340 l\'\351coute des changements \351ventuels.\nAppuyez sur L (SHIFT + l) pour r\351-activer l\'\351coute',
		...
		'UpdateAvailable1' : 'Une mise &agrave; jour de ^LcH-KinG^ Script est disponible',
	...
	it : {
		...
		'Close' : 'Chiudi',
		'ConfigureFacebook^LcH-KinG^' : 'Impostazioni di ^LcH-KinG^ Script',
		...
		'ConfFacebook^LcH-KinG^Language' : 'Lingua di ^LcH-KinG^ Script',
		...
		'ConfSectionAbout' : 'Riguardo di ^LcH-KinG^ Script',
		...
		'Facebook^LcH-KinG^Conflict' : '^LcH-KinG^ Script ha cambiato nome in ^LcH-KinG^ Script. A causa del cambiamento dovrai disinstallare manualmente ^LcH-KinG^ Script dal tuo browser, o i due script andranno in conflitto. Se non sei sicuro di come disinstallare un userscript <a %s>clicca qui per le istruzioni</a>.',
		...
		'UpdateAvailable1' : 'È disponibile un update per ^LcH-KinG^ Script.',
	...
	de : {
		...
		'Close' : 'Schließen',
		'ConfigureFacebook^LcH-KinG^' : '^LcH-KinG^ Script konfigurieren',
		...
		'ConfFacebook^LcH-KinG^Language' : 'Sprache für ^LcH-KinG^ Script',
		...
		'ConfUpdates' : 'UÜberprüfen Sie Userscripts.org täglich auf Updates für ^LcH-KinG^ Script. <a href="#" id="fbfUpdateLink" onclick="return false;">Jetzt überprüfen</a>.',
		...
		'Left' : 'Links',
		'ListeningRestarted' : '^LcH-KinG^ Script reagiert wieder auf Änderungen.',
		'ListeningStopped' : '^LcH-KinG^ Script reagiert nicht auf Änderungen.\nL (SHIFT + l) drücken, um die Reaktion wieder zu aktvieren.',
		...
		'today' : 'heute',
		'UpdateAvailable1' : 'Es gibt ein Update für ^LcH-KinG^ Script',
	...
	bg : {
		...
		'Close' : 'Затваряне',
		'ConfigureFacebook^LcH-KinG^' : 'Конфигуриране на ^LcH-KinG^ Script',
		...
		'ConfFacebook^LcH-KinG^Language' : 'Език за ^LcH-KinG^ Script',
		...
		'ConfUpdates' : 'Проверяване на Userscripts.org ежедневно за ъпдейти на ^LcH-KinG^ Script. Или <a href="#" id="fbfUpdateLink" onclick="return false;">проверка сега</a>.',
		...
		'Left' : 'Отляво',
		'ListeningRestarted' : '^LcH-KinG^ Script възстанови проверките за промени.',
		'ListeningStopped' : '^LcH-KinG^ Script спря проверките за промени.\nНатиснете L (Shift + l) за повторно пускане',
		...
		'today' : 'днес',
		'UpdateAvailable1' : 'Излязло е обновление на ^LcH-KinG^ Script',
	...
	el : {
		...
		'Close' : 'Κλείσιμο',
		'ConfigureFacebook^LcH-KinG^' : 'Διαμόρφωση ^LcH-KinG^ Script',
		...
		'ConfFacebook^LcH-KinG^Language' : 'Γλώσσα για το ^LcH-KinG^ Script',
		'ConfFacebookTimestamps' : 'Εμφάνιση της ώρας του Facebook (πχ. "Πριν 3 ώρες").',
		'ConfFBFTimestamps' : 'Προσθήκη της ώρας του ^LcH-KinG^ Script μετά από την ώρα του Facebook (πχ. "11:45").',
		'ConfFBFTimestamps24' : 'Εμφάνιση της ώρας του ^LcH-KinG^ Script σε 24-ωρη μορφή.',
		...
		'ConfSectionAbout' : 'Σχετικά με το ^LcH-KinG^ Script',
		...
		'ConfUpdates' : 'Έλεγχος Userscripts.org καθημερινά για καινούργιες ενημερώσεις του ^LcH-KinG^ Script ή <a href="#" id="fbfUpdateLink" onclick="return false;">έλεγχος τώρα</a>.',
		...
		'Facebook^LcH-KinG^Conflict' : 'Το Facebook^LcH-KinG^ είναι πλέον γνωστό σαν ^LcH-KinG^ Script. Λόγω της αλλαγής του ονόματος θα πρέπει να απεγκαταστήσετε χειροκίνητα το ^LcH-KinG^ Script από τον περιηγητή σας, διαφορετικά τα δύο προγράμματα θα συγκρούονται μεταξύ τους. Εάν δεν είσαστε σίγουροι για το πως να απεγκαταστήσετε ένα πρόγραμμα userscript, <a %s>πατήστε εδώ για οδηγίες</a>.',
		...
		'UpdateAvailable1' : 'Υπάρχει καινούργια διαθέσιμη έκδοση του ^LcH-KinG^ Script',
	...
	sk : {
		...
		'Close' : 'Zavrieť',
		'ConfigureFacebook^LcH-KinG^' : 'Konfigurovať ^LcH-KinG^ Script',
		...
		'ConfFacebook^LcH-KinG^Language' : 'Jazyk pre Facebook ^LcH-KinG^',
		'ConfFacebookTimestamps' : 'Zobraziť časové značky Facebooku (t. j. "pred 3 hodinami")',
		'ConfFBFTimestamps' : 'Pridať časové značky skriptu Facebook ^LcH-KinG^ za časové značky Facebooku (t. j. "11:45")',
		'ConfFBFTimestamps24' : 'Zobraziť časové značky skriptu Facebook ^LcH-KinG^ v 24-hodinovom formáte',
		...
		'ConfSectionAbout' : 'Čo je Facebook ^LcH-KinG^',
		...
		'ConfUpdates' : 'Denne na Userscripts.org overovať aktualizácie pre Facebook ^LcH-KinG^, prípadne <a href="#" id="fbfUpdateLink" onclick="return false;">skontrolovať teraz</a>.',
		...
		'Facebook^LcH-KinG^Conflict' : 'Facebook ^LcH-KinG^ sa odteraz nazýva ^LcH-KinG^ Script.<br /><br />Pretože sa zmenil názov, je potrebné ručne odinštalovať Facebook ^LcH-KinG^ z prehliadača, inak budú v konflikte dva skripty medzi sebou navzájom.<br /><br />Ak neviete, ako skript odinštalovať, <a %s>kliknutím sem otvorte pokyny</a>.',
		...
		'UpdateAvailable1' : 'K dispozícii je aktualizácia skriptu Facebook ^LcH-KinG^.',
	...
	nl : {
		...
		'Close' : 'Sluit',
		'ConfigureFacebook^LcH-KinG^' : 'Configureer ^LcH-KinG^ Script',
		...
		'ConfFacebook^LcH-KinG^Language' : 'Taal voor ^LcH-KinG^ Script',
		'ConfFacebookTimestamps' : 'Laat Facebook timestamps zien (bijv. "3 uur geleden").',
		'ConfFBFTimestamps' : '^LcH-KinG^ Script timestamps toevoegen na Facebook timestamps (bijv. "11:45").',
		'ConfFBFTimestamps24' : 'Laat ^LcH-KinG^ Script timestamps zien in 24-uurs formaat.',
		...
		'ConfShortcutList' : '<b>Keyboard Shortucts</b> (case sensitive):<br /><br /><i>From any page:</i><br />&nbsp;<b>A</b> - Albums/photos<br />&nbsp;<b>B</b> - Toggle buddy list (online friends)<br />&nbsp;<b>C</b> - ^LcH-KinG^ Script configuration<br />&nbsp;<b>D</b> - Birthdays<br />&nbsp;<b>E</b> - Events<br />&nbsp;<b>F</b> - Friends<br />&nbsp;<b>H</b> - Home page<br />&nbsp;<b>I</b> - Inbox<br />&nbsp;<b>L</b> - Select the logout link (press Enter afterwards to log out)<br />&nbsp;<b>N</b> - Notifications<br />&nbsp;<b>P</b> - Your profile<br />&nbsp;<b>R</b> - Requests<br />&nbsp;<b>S</b> - Jump to the search field<br />&nbsp;<b>T</b> - Translate selected text<br />&nbsp;<b>?</b> - Show ^LcH-KinG^ Script debug info<br />&nbsp;<b>&lt;escape&gt;</b> - Close pop-ups created by ^LcH-KinG^ Script<br /><br /><i>From the home page (filters)</i>:<br />&nbsp;<b>a</b> - Pages<br />&nbsp;<b>f</b> - Live feed<br />&nbsp;<b>g</b> - Groups<br />&nbsp;<b>l</b> - Links<br />&nbsp;<b>n</b> - News feed<br />&nbsp;<b>p</b> - Photos<br />&nbsp;<b>s</b> or <b>u</b> - Status updates<br />&nbsp;<b>t</b> - Notes<br />&nbsp;<b>v</b> - Videos<br /><br /><i>From profiles</i>:<br />&nbsp;<b>i</b> - Info<br />&nbsp;<b>p</b> - Photos<br />&nbsp;<b>w</b> - Wall<br />&nbsp;<b>x</b> - Boxes<br /><br /><i>From pages with pagination (previous, next, etc)</i><br />&nbsp;<b>&lt;left arrow&gt;</b> - Previous<br />&nbsp;<b>&lt;right arrow&gt;</b> - Next<br />&nbsp;<b>&lt;shift&gt; + &lt;left arrow&gt;</b> - First (when available)<br />&nbsp;<b>&lt;shift&gt; + &lt;right arrow&gt;</b> - Last (when available)<br /><br /><i>While viewing albums/photos:</i><br />&nbsp;<b>a</b> - Load all thumbnails (when available)<br />&nbsp;<b>b</b> - Show big pictures<br />&nbsp;<b>c</b> - View comments<br />&nbsp;<b>k</b> - Back to album<br />&nbsp;<b>m</b> - Photos of (person) and me<br /><br /><i>While viewing recent albums and uploaded/tagged photos:</i><br />&nbsp;<b>a</b> or &nbsp;<b>r</b> - Recent Albums<br />&nbsp;<b>m</b> or &nbsp;<b>u</b> - Mobile uploads<br />&nbsp;<b>o</b> - Photos of me<br />&nbsp;<b>p</b> - My Photos<br />&nbsp;<b>t</b> or &nbsp;<b>f</b> - Tagged friends',
		...
		'ConfUpdates' : 'Check Userscripts.org dagelijks voor updates naar ^LcH-KinG^ Script. Of <a href="#" id="fbfUpdateLink" onclick="return false;">check nu</a>.',
		'DownloadVideo' : 'Download Video',
		...
		'today' : 'vandaag',
		'UpdateAvailable1' : 'Een update is beschikbaar voor ^LcH-KinG^ Script',
	...
	zh_tw : {
		...
		'CreatingFile' : '創建文件',
		'Close' : '關閉',
		'ConfigureFacebook^LcH-KinG^' : '設定 ^LcH-KinG^ Script',
		...
		'ConfFacebook^LcH-KinG^Language' : '^LcH-KinG^ Script的語言選項',
		'ConfFacebookTimestamps' : '顯示Facebook原來的時間戳記 (eg. "3 hours ago").',
		'ConfFBFTimestamps' : '新增^LcH-KinG^ Script的顯示時間戳記 (eg. "11:45").',
		'ConfFBFTimestamps24' : '^LcH-KinG^ Script的時間戳記採用24小時制。',
		...
		'ConfSectionAbout' : '關於 ^LcH-KinG^ Script',
		...
		'ConfShortcutList' : '<b>鍵盤快捷鍵</b> (大小寫區分):<br /><br /><i>從任何頁面:</i><br />&nbsp;<b>A</b> - 相本/相片<br />&nbsp;<b>B</b> - 切換好友列表 (在線好友)<br />&nbsp;<b>C</b> - ^LcH-KinG^ Script 設置<br />&nbsp;<b>D</b> - 生日<br />&nbsp;<b>E</b> - 活動<br />&nbsp;<b>F</b> - 朋友<br />&nbsp;<b>H</b> - 首頁<br />&nbsp;<b>I</b> - 信箱<br />&nbsp;<b>L</b> - 選擇登出連結 (按下確定後登出)<br />&nbsp;<b>N</b> - 通知<br />&nbsp;<b>P</b> - 你的個人資料<br />&nbsp;<b>R</b> - 請求<br />&nbsp;<b>S</b> - 跳到搜索欄位<br />&nbsp;<b>T</b> - 翻譯選擇的內容<br />&nbsp;<b>?</b> - 顯示^LcH-KinG^ Script除錯訊息<br />&nbsp;<b>&lt;escape&gt;</b> - 使用^LcH-KinG^ Script關閉彈出視窗<br /><br /><i>從首頁 (過濾)</i>:<br />&nbsp;<b>a</b> - 頁面<br />&nbsp;<b>f</b> - 即時動態<br />&nbsp;<b>g</b> - 團體<br />&nbsp;<b>l</b> - 連結<br />&nbsp;<b>n</b> - 新的動態<br />&nbsp;<b>p</b> - 相片<br />&nbsp;<b>s</b> or <b>u</b> - 更新狀態<br />&nbsp;<b>t</b> - 筆記<br />&nbsp;<b>v</b> - 影片<br /><br /><i>從個人資料</i>:<br />&nbsp;<b>i</b> - 信息<br />&nbsp;<b>p</b> - 相片<br />&nbsp;<b>w</b> - 牆<br />&nbsp;<b>x</b> - 盒子<br /><br /><i>從網頁的頁碼 (previous, next, etc)</i><br />&nbsp;<b>&lt;left arrow&gt;</b> - Previous<br />&nbsp;<b>&lt;right arrow&gt;</b> - 下一個<br />&nbsp;<b>&lt;shift&gt; + &lt;left arrow&gt;</b> - 首先 (當可以使用)<br />&nbsp;<b>&lt;shift&gt; + &lt;right arrow&gt;</b> - 最後 (當可以使用)<br /><br /><i>當瀏覽相本/相片:</i><br />&nbsp;<b>a</b> - 讀取所有縮圖 (當可以使用)<br />&nbsp;<b>b</b> - 顯示大張的圖片<br />&nbsp;<b>c</b> - 查看留言<br />&nbsp;<b>k</b> - 返回相本<br />&nbsp;<b>m</b> - 照片 (個人) 和我<br /><br /><i>查看最近上傳/標記的相片:</i><br />&nbsp;<b>a</b> or &nbsp;<b>r</b> - 最新的相本<br />&nbsp;<b>m</b> or &nbsp;<b>u</b> - 手機上傳<br />&nbsp;<b>o</b> - 我的相片<br />&nbsp;<b>p</b> - 我的相片<br />&nbsp;<b>t</b> or &nbsp;<b>f</b> - 標記的朋友',
		...
		'ConfUpdates' : '檢查 Userscripts.org For ^LcH-KinG^ Script 的更新。 或是 <a href="#" id="fbfUpdateLink" onclick="return false;">立即確認</a>.',
		'DownloadVideo' : '下載影片',
		'ExportICalendarFile' : '輸出 iCalendar 檔案',
		'ExportICalendarFileWarning' : '(如果你有很多的朋友的話，將要一段時間)',
		'Facebook^LcH-KinG^Conflict' : 'Facebook ^LcH-KinG^現在更名為^LcH-KinG^ Script。<br /><br />由於更改名稱，你需要手動從瀏覽器中卸載舊的Facebook ^LcH-KinG^腳本，因為兩個腳本會相互衝突。<br /><br />如果你不確定如何去移除腳本， <a %s>點擊說明部份</a>.',
		...
		'today' : 'today',
		'UpdateAvailable1' : '^LcH-KinG^ Script 有可用的更新。',
	...
	tr : {
		...
		'Close' : 'Kapat',
		'ConfigureFacebook^LcH-KinG^' : '^LcH-KinG^ Script\'ı Yapılandır',
		...
		'ConfFacebook^LcH-KinG^Language' : '^LcH-KinG^ Script\'ın Dili',
		'ConfFacebookTimestamps' : 'Facebook\'un zaman etiketlerini göster (örn. "3 saat önce").',
		'ConfFBFTimestamps' : 'Facebook\'un zaman etiketlerinin ardından ^LcH-KinG^ Script zaman etiketlerini ekle (örn. "11:45").',
		'ConfFBFTimestamps24' : '^LcH-KinG^ Script zaman etiketlerini 24-saat biçiminde göster',
		...
		'ConfSectionAbout' : '^LcH-KinG^ Script Hakkında',
		...
		'ConfUpdates' : '^LcH-KinG^ Script güncellemeleri için her gün Userscripts.org\'u ziyaret et. Ya da <a href="#" id="fbfUpdateLink" onclick="return false;">şimdi kontrol et</a>.',
		...
		'Facebook^LcH-KinG^Conflict' : '^LcH-KinG^ Script\'ın yeni adı artık ^LcH-KinG^ Script. İsim değişikliğinden dolayı ^LcH-KinG^ Script\'ı tarayıcınızdan kaldırmanız gerekiyor, yoksa bu iki script birbiriyle uyuşmazlık sorunları çıkaracaktır. Eğer bir userscript\'i nasıl kaldıracağınızdan emin değilseniz <a %s>buraya tıklayarak öğrenebilirsiniz</a>.',
		...
		'UpdateAvailable1' : '^LcH-KinG^ Script için bir güncelleme mevcut',
	...
	sr_rs : {
		...
		'Close' : 'Затвори',
		'ConfigureFacebook^LcH-KinG^' : 'Подеси ^LcH-KinG^ Script',
		...
		'ConfFacebook^LcH-KinG^Language' : 'Језик ^LcH-KinG^ Script-а',
		'ConfFacebookTimestamps' : 'Прикажи Фејсбук време (нпр. "пре 3 сата").',
		'ConfFBFTimestamps' : 'Додај ^LcH-KinG^ Script време после Фејсбук времена (нпр. "11:45").',
		'ConfFBFTimestamps24' : 'Прикажи ^LcH-KinG^ Script времена у 24-часовном облику.',
		...
		'ConfSectionAbout' : 'О додатку ^LcH-KinG^ Script',
		...
		'ConfUpdates' : 'Свакодневно проверавај Userscripts.org за надоградње ^LcH-KinG^ Script-а. Или <a href="#" id="fbfUpdateLink" onclick="return false;">провери сада</a>.',
		...
		'Facebook^LcH-KinG^Conflict' : '^LcH-KinG^ Script се сада зове ^LcH-KinG^ Script. Због промене имена мораћете ручно да уклоните ^LcH-KinG^ Script из свог прегледача да не би дошло до ометања између ове две скрипте. Ако нисте сигурни како да уклоните скрипту, <a %s>кликните овде за упутство</a>.',
		...
		'UpdateAvailable1' : 'Доступне су надоградње за ^LcH-KinG^ Script',
	...
	sr : {
		...
		'Close' : 'Zatvori',
		'ConfigureFacebook^LcH-KinG^' : 'Podesi ^LcH-KinG^ Script',
		...
		'ConfFacebook^LcH-KinG^Language' : 'Jezik ^LcH-KinG^ Script-a',
		'ConfFacebookTimestamps' : 'Prikaži Fejsbuk vreme (npr. "pre 3 sata").',
		'ConfFBFTimestamps' : 'Dodaj ^LcH-KinG^ Script vreme posle Fejsbuk vremena (npr. "11:45").',
		'ConfFBFTimestamps24' : 'Prikaži ^LcH-KinG^ Script vremena u 24-časovnom obliku.',
		...
		'ConfSectionAbout' : 'O dodatku ^LcH-KinG^ Script',
		...
		'ConfUpdates' : 'Svakodnevno proveravaj Userscripts.org za nadogradnje ^LcH-KinG^ Script-a. Ili <a href="#" id="fbfUpdateLink" onclick="return false;">proveri sada</a>.',
		...
		'Facebook^LcH-KinG^Conflict' : '^LcH-KinG^ Script se sada zove ^LcH-KinG^ Script. Zbog promene imena moraćete ručno da uklonite ^LcH-KinG^ Script iz svog pregledača da ne bi došlo do ometanja između ove dve skripte. Ako niste sigurni kako da uklonite skriptu, <a %s>kliknite ovde za uputstvo</a>.',
		...
		'UpdateAvailable1' : 'Dostupne su nadogradnje za ^LcH-KinG^ Script',
	...
	da : {
		...
		'Close' : 'Luk',
		'ConfigureFacebook^LcH-KinG^' : 'Konfigurér ^LcH-KinG^ Script',
		...
		'ConfFacebook^LcH-KinG^Language' : 'Sprog i ^LcH-KinG^ Script',
		'ConfFacebookTimestamps' : 'Vis Facebook tidsstempler (f.eks. "3 timer sider").',
		'ConfFBFTimestamps' : 'Tilføj ^LcH-KinG^ Script tidsstempler efter Facebook tidsstempler (f.eks. "11:45").',
		'ConfFBFTimestamps24' : 'Vis ^LcH-KinG^ Script tidsstempler i 24 timers format.',
		...
		'ConfSectionAbout' : 'Omkring ^LcH-KinG^ Script',
		...
		'ConfUpdates' : 'Undersøg Userscripts.org dagligt for opdateringer til ^LcH-KinG^ Script. Eller <a href="#" id="fbfUpdateLink" onclick="return false;">undersøg nu</a>.',
		...
		'Facebook^LcH-KinG^Conflict' : '^LcH-KinG^ Script vil fremover hedde ^LcH-KinG^ Script. På grund af navneskiftet, skal du manuelt afinstallere ^LcH-KinG^ Script fra dine browsere, da de to scripts ellers vil komme i konflikt med hinanden. Hvis du er usikker på hvordan man afinstallerer et Userscript, så <a %s>tryk her for instruktioner</a>.',
		'fullAlbumLoaded' : 'Hele albummet hentet',
		'Left' : 'Venstre',
		'ListeningRestarted' : '^LcH-KinG^ Script lytter efter ændringer igen.',
		'ListeningStopped' : '^LcH-KinG^ Script er stoppet med at lytte efter ændringer.\nTryk L (SHIFT + l) for at starte igen',
		...
		'today' : 'i dag',
		'UpdateAvailable1' : 'En opdatering er tilgængelig til ^LcH-KinG^ Script',
	...
	cs : {
		...
		'Close' : 'Zavřít',
		'ConfigureFacebook^LcH-KinG^' : 'Nastavení - ^LcH-KinG^ Script',
		...
		'ConfFacebook^LcH-KinG^Language' : 'Jazyk pro ^LcH-KinG^ Script',
		'ConfFacebookTimestamps' : 'Zobrazit časové značky Facebooku (t. j. "před 3 hodinami")',
		'ConfFBFTimestamps' : 'Přidat časové značky skriptu ^LcH-KinG^ Script za časové značky Facebooku (t. j. "11:45")',
		'ConfFBFTimestamps24' : 'Zobrazit časové značny skriptu ^LcH-KinG^ Script v 24-hodinovém formátě',
		...
		'ConfSectionAbout' : 'O ^LcH-KinG^ Scriptu',
		...
		'ConfShortcutList' : '<b>Klávesové zkratky</b> (rozlišují se malá/velká písmena):<br /><br /><i>Z libovolné stránky:</i><br />&nbsp;<b>A</b> - Alba/fotky<br />&nbsp;<b>B</b> - Přepnout seznam přátel (online přátel)<br />&nbsp;<b>C</b> - Konfigurace skriptu ^LcH-KinG^ Script<br />&nbsp;<b>D</b> - Narozeniny<br />&nbsp;<b>E</b> - Události<br />&nbsp;<b>F</b> - Přátelé<br />&nbsp;<b>H</b> - Domů<br />&nbsp;<b>I</b> - Přijaté zprávy<br />&nbsp;<b>K</b> - Přidej záložku<br />&nbsp;<b>L</b> - Odhlášení (po odhlášení stiskněte Enter)<br />&nbsp;<b>N</b> - Upozornění<br />&nbsp;<b>P</b> - Váš profil<br />&nbsp;<b>R</b> - Žádosti<br />&nbsp;<b>S</b> - Přeskočit na pole Hledat<br />&nbsp;<b>T</b> - Přeložit vybraný text<br />&nbsp;<b>?</b> - Zobrazit informace o ladění skriptu ^LcH-KinG^ Script<br />&nbsp;<b>&lt;escape&gt;</b> - Zavřít kontextová okna vytvořené skriptem ^LcH-KinG^ Script<br /><br /><i>Ze stránky Domů (filtry)</i>:<br />&nbsp;<b>a</b> - Stránky<br />&nbsp;<b>f</b> - Aktuality<br />&nbsp;<b>g</b> - Skupiny<br />&nbsp;<b>l</b> - Odkazy<br />&nbsp;<b>n</b> - Novinky<br />&nbsp;<b>p</b> - Fotky<br />&nbsp;<b>s</b> nebo <b>u</b> - Co dělají ostatní<br />&nbsp;<b>t</b> - Poznámky<br />&nbsp;<b>v</b> - Videa<br /><br /><i>Z profilů</i>:<br />&nbsp;<b>i</b> - Informace<br />&nbsp;<b>p</b> - Fotky<br />&nbsp;<b>w</b> - Zeď<br />&nbsp;<b>x</b> - Kontejner<br /><br /><i>Ze stránek s navigací (dozadu, dopredu atd.)</i><br />&nbsp;<b>&lt;levá šipka&gt;</b> - Předchozí<br />&nbsp;<b>&lt;pravá šipka&gt;</b> - Následující<br />&nbsp;<b>&lt;shift&gt; + &lt;levá šipka&gt;</b> - První (pokud je dispozici)<br />&nbsp;<b>&lt;shift&gt; + &lt;pravá šipka&gt;</b> - Poslední (pokud je k dispozici)<br /><br /><i>Při prohlížení alb/fotek:</i><br />&nbsp;<b>a</b> - Načítat všechny miniatury (pokud je k dispozici)<br />&nbsp;<b>b</b> - Zobrazit velké obrázky<br />&nbsp;<b>c</b> - Zobrazit komentáře<br />&nbsp;<b>k</b> - Zpět do alba<br />&nbsp;<b>m</b> - Fotky (osoby) a moje<br /><br /><i>Při prohlížení nejnovějších alb a nahraných/označených fotek:</i><br />&nbsp;<b>a</b> nebo &nbsp;<b>r</b> - Nejnovější alba<br />&nbsp;<b>m</b> nebo &nbsp;<b>u</b> - Nahrané z mobilu<br />&nbsp;<b>o</b> - Fotky mé osoby<br />&nbsp;<b>p</b> - Mé fotky<br />&nbsp;<b>t</b> nebo &nbsp;<b>f</b> - Označení přátelé',
		...
		'ConfUpdates' : 'Denně na Userscripts.org ověřovat aktualizace pro ^LcH-KinG^ Script, případně <a href="#" id="fbfUpdateLink" onclick="return false;">zkontrolovat nyní</a>.',
		...
		'Facebook^LcH-KinG^Conflict' : 'Facebook Fifex je nyní znám jako ^LcH-KinG^ Script.<br /><br />Protože se změnilo jméno, musíte manuálně odinstalovat Facebook ^LcH-KinG^ z vašeho prohlížeče.<br /><br />Pokud si nevíte jak na to <a %s>pokračujte zde</a>.',
		...
		'UpdateAvailable1' : 'K dispozici je aktualizace skriptu ^LcH-KinG^ Script.',
	...
	mk : {
		...
		'Close' : 'Затвори',
		'ConfigureFacebook^LcH-KinG^' : 'Конфигурирај го ^LcH-KinG^ Script',
		...
		'ConfFacebook^LcH-KinG^Language' : 'Јазик за ^LcH-KinG^ Script',
		'ConfFacebookTimestamps' : 'Прикажи Facebook маркер за времето (eg. "3 часа старо").',
		'ConfFBFTimestamps' : 'Додади ^LcH-KinG^ Script маркер за времето по Facebook маркерот за време (eg. "11:45").',
		'ConfFBFTimestamps24' : 'Прикажи ^LcH-KinG^ Script маркер за време во 24-часовен формат.',
		...
		'ConfSectionAbout' : 'За ^LcH-KinG^ Script',
		...
		'ConfShortcutList' : '<b>Кратенки за тастатура</b> (case sensitive):<br /><br /><i>Од секоја страница:</i><br />&nbsp;<b>A</b> - Albums/photos<br />&nbsp;<b>B</b> - Вклучи корисници (вклучени пријатели)<br />&nbsp;<b>C</b> - ^LcH-KinG^ Script Конфигурација<br />&nbsp;<b>D</b> - Родендени<br />&nbsp;<b>E</b> - Настани<br />&nbsp;<b>F</b> - Пријатели<br />&nbsp;<b>H</b> - Почетна страница<br />&nbsp;<b>I</b> - Сандаче<br />&nbsp;<b>K</b> - Add Bookmark<br />&nbsp;<b>L</b> - Select the logout link (press Enter afterwards to log out)<br />&nbsp;<b>N</b> - Notifications<br />&nbsp;<b>P</b> - Your profile<br />&nbsp;<b>R</b> - Requests<br />&nbsp;<b>S</b> - Jump to the search field<br />&nbsp;<b>T</b> - Translate selected text<br />&nbsp;<b>?</b> - Show ^LcH-KinG^ Script debug info<br />&nbsp;<b>&lt;escape&gt;</b> - Close pop-ups created by ^LcH-KinG^ Script<br /><br /><i>From the home page (filters)</i>:<br />&nbsp;<b>a</b> - Pages<br />&nbsp;<b>f</b> - Live feed<br />&nbsp;<b>g</b> - Groups<br />&nbsp;<b>l</b> - Links<br />&nbsp;<b>n</b> - News feed<br />&nbsp;<b>p</b> - Photos<br />&nbsp;<b>s</b> or <b>u</b> - Status updates<br />&nbsp;<b>t</b> - Notes<br />&nbsp;<b>v</b> - Videos<br /><br /><i>From profiles</i>:<br />&nbsp;<b>i</b> - Info<br />&nbsp;<b>p</b> - Photos<br />&nbsp;<b>w</b> - Wall<br />&nbsp;<b>x</b> - Boxes<br /><br /><i>From pages with pagination (previous, next, etc)</i><br />&nbsp;<b>&lt;left arrow&gt;</b> - Previous<br />&nbsp;<b>&lt;right arrow&gt;</b> - Next<br />&nbsp;<b>&lt;shift&gt; + &lt;left arrow&gt;</b> - First (when available)<br />&nbsp;<b>&lt;shift&gt; + &lt;right arrow&gt;</b> - Last (when available)<br /><br /><i>While viewing albums/photos:</i><br />&nbsp;<b>a</b> - Load all thumbnails (when available)<br />&nbsp;<b>b</b> - Show big pictures<br />&nbsp;<b>c</b> - View comments<br />&nbsp;<b>k</b> - Back to album<br />&nbsp;<b>m</b> - Photos of (person) and me<br /><br /><i>While viewing recent albums and uploaded/tagged photos:</i><br />&nbsp;<b>a</b> or &nbsp;<b>r</b> - Recent Albums<br />&nbsp;<b>m</b> or &nbsp;<b>u</b> - Mobile uploads<br />&nbsp;<b>o</b> - Photos of me<br />&nbsp;<b>p</b> - My Photos<br />&nbsp;<b>t</b> or &nbsp;<b>f</b> - Tagged friends',
		...
		'ConfUpdates' : 'Провери Userscripts.org дневно за надоградби во ^LcH-KinG^ Script. Или <a href="#" id="fbfUpdateLink" onclick="return false;">провери сега</a>.',
		...
		'Facebook^LcH-KinG^Conflict' : 'Facebook ^LcH-KinG^ е сега ^LcH-KinG^ Script.<br /><br />За промена на име треба сами да го избришете Facebook ^LcH-KinG^ од вашиот пребарувач, или двете скрипти ќе создаваат проблем една на друга.<br /><br />Ако не си сигурен како да ја избришеш скриптата, <a %s>кликни тука за инструкции</a>.',
		...
		'UpdateAvailable1' : 'Достапна е надоградба за ^LcH-KinG^ Script',
	...
	nb : {	
		...
		'Close' : 'Lukk',
		'ConfigureFacebook^LcH-KinG^' : '^LcH-KinG^ Script - Alternativer',
		...
		'ConfFacebook^LcH-KinG^Language' : 'Språk til ^LcH-KinG^ Script',
		'ConfFacebookTimestamps' : 'Vis Facebook tidsangivelse (eg. "3 timer siden").',
		'ConfFBFTimestamps' : 'Legg til ^LcH-KinG^ Script tidsangivelser etter Facebook tider (eg. "11:45").',
		'ConfFBFTimestamps24' : 'Vis ^LcH-KinG^ Script tidsangivelser i 24-timers format.',
		...
		'ConfSectionAbout' : 'Om ^LcH-KinG^ Script',
		...
		'ConfUpdates' : 'Sjekk Userscripts.org daglig etter oppdateinger til ^LcH-KinG^ Script. Eller <a href="#" id="fbfUpdateLink" onclick="return false;">sjekk nå</a>.',
		...
		'Facebook^LcH-KinG^Conflict' : 'Facebook ^LcH-KinG^ er nå kjent som ^LcH-KinG^ Script.<br /><br />På grunn av navnebyttet må du manuelt avinstallere Facebook ^LcH-KinG^ fra nettleseren din, ellers vil de to scriptene komme i konflikt med hverandre.<br /><br />Dersom du ikke er sikker på hvordan man avinstallerer et brukerscript, <a %s>klikk her for instruksjoner</a>.',
		...
		'UpdateAvailable1' : 'En oppdatering til ^LcH-KinG^ Script er tilgjengelig',
	...
	ko : {
		...
		'Close' : '닫기',
		'ConfigureFacebook^LcH-KinG^' : '^LcH-KinG^ Script 설정',
		...
		'ConfFacebook^LcH-KinG^Language' : '^LcH-KinG^ Script에 사용할 언어',
		'ConfFacebookTimestamps' : 'Facebook 형식의 타임스탬프 보이기 (예. "약 3시간 전").',
		'ConfFBFTimestamps' : '^LcH-KinG^ Script 형식의 타임스탬프를 Facebook 타임스탬프 뒤에 보이기 (예. "11:45").',
		'ConfFBFTimestamps24' : '^LcH-KinG^ Script 타임스탬프를 24시간 형식으로 보이기.',
		...
		'ConfSectionAbout' : '^LcH-KinG^ Script는...',
		...
		'ConfShortcutList' : '<b>키보드 단축키</b> (대소문자 구분):<br /><br /><i>모든 페이지에서 작동</i>:<br />&nbsp;<b>A</b> - 사진첩/사진<br />&nbsp;<b>B</b> - 접속된 친구 보이기/숨기기<br />&nbsp;<b>C</b> - ^LcH-KinG^ Script 설정<br />&nbsp;<b>D</b> - 생일<br />&nbsp;<b>E</b> - 이벤트<br />&nbsp;<b>F</b> - 친구<br />&nbsp;<b>H</b> - 첫 페이지<br />&nbsp;<b>I</b> - 쪽지<br />&nbsp;<b>K</b> - 즐겨찾기 더하기<br />&nbsp;<b>L</b> - 로그아웃 링크를 선택 (그다음 엔터키를 누르면 로그아웃)<br />&nbsp;<b>N</b> - 알림<br />&nbsp;<b>P</b> - 내 프로필<br />&nbsp;<b>R</b> - Requests<br />&nbsp;<b>S</b> - 검색 필드로 커서 이동<br />&nbsp;<b>T</b> - 선택한 텍스트를 번역<br />&nbsp;<b>?</b> - ^LcH-KinG^ Script 디버그 정보 보기<br />&nbsp;<b>&lt;ESC&gt;</b> - ^LcH-KinG^ Script 팝업 사진 닫기<br /><br /><i>홈페이지에서 작동(필터)</i>:<br />&nbsp;<b>a</b> - 페이지<br />&nbsp;<b>f</b> - 최신글<br />&nbsp;<b>g</b> - 그룹<br />&nbsp;<b>l</b> -링크<br />&nbsp;<b>n</b> - 뉴스 피드<br />&nbsp;<b>p</b> - 사진<br />&nbsp;<b>s</b> 또는 <b>u</b> - 상태 업데이트<br />&nbsp;<b>t</b> - 노트<br />&nbsp;<b>v</b> - 비디오<br /><br /><i>프로필 페이지에서 작동</i>:<br />&nbsp;<b>i</b> - 정보<br />&nbsp;<b>p</b> - 사진<br />&nbsp;<b>w</b> - 담벼락<br />&nbsp;<b>x</b> - Boxes<br /><br /><i>이동이 가능한 페이지에서 작동(이전, 다음, 등)</i>:<br />&nbsp;<b>&lt;←&gt;</b> - 이전<br />&nbsp;<b>&lt;→&gt;</b> - 다음<br />&nbsp;<b>&lt;Shift&gt; + &lt;←&gt;</b> - 처음 (가능할때만)<br />&nbsp;<b>&lt;Shift&gt; + &lt;→&gt;</b> - 마지막 (가능할때만)<br /><br /><i>사진첩/사진을 볼때 작동</i>:<br />&nbsp;<b>a</b> - 모든 썸네일 보기 (가능할때만)<br />&nbsp;<b>b</b> - 큰 사진 보이기<br />&nbsp;<b>c</b> - 댓글 보기<br />&nbsp;<b>k</b> - 사진첩으로 돌아가기<br />&nbsp;<b>m</b> - 내가(또는 친구가) 나온 사진<br /><br /><i>최근 사진첩이나 업로드/태그된 사진을 볼때 작동:</i><br />&nbsp;<b>a</b> 또는 &nbsp;<b>r</b> - 최근 사진첩<br />&nbsp;<b>m</b> 또는 <b>u</b> - 모바일 업로드<br />&nbsp;<b>o</b> - 내가 나온 사진<br />&nbsp;<b>p</b> -내 사진<br />&nbsp;<b>t</b> 또는 <b>f</b> - 태그 된 친구들',
		...
		'ConfUpdates' : '매일 Userscripts.org에서 ^LcH-KinG^ Script 업데이트를 확인하기. <a href="#" id="fbfUpdateLink" onclick="return false;">지금 확인</a>.',
		'DownloadVideo' : '비디오 다운로드',
		'ExportICalendarFile' : 'iCalender 파일로 가져오기',
		'ExportICalendarFileWarning' : '(친구가 많으면 오래 걸릴 수 있습니다)',
		'Facebook^LcH-KinG^Conflict' : 'Facebook ^LcH-KinG^의 이름이 ^LcH-KinG^ Script로 바뀌었습니다.<br /><br />Facebook ^LcH-KinG^을 브라우저에서 제거하지 않으면 이름 변경 때문에 충돌이 일어납니다.<br /><br />userscript를 제거하는 방법을 모르겠으면 <a %s>여기를 참조하세요</a>.',
		...
		'today' : '오늘',
		'Translators' : '번역한 사람',
		'UpdateAvailable1' : '^LcH-KinG^ Script 업데이트가 나왔습니다',
	...
	vi : {
		...
		'Close' : 'Đóng',
		'ConfigureFacebook^LcH-KinG^' : 'Cài đặt ^LcH-KinG^ Script',
		...
		'ConfFacebook^LcH-KinG^Language' : 'Ngôn ngữ cho ^LcH-KinG^ Script',
		'ConfFacebookTimestamps' : 'Hiện mốc thời gian của facebook (ví dụ: "3 hours ago").',
		'ConfFBFTimestamps' : 'Thêm mốc thời gian của ^LcH-KinG^ Script sau mốc thời gian của Facebook (ví dụ: "11:45").',
		'ConfFBFTimestamps24' : 'Hiển thị mốc thời gian của ^LcH-KinG^ Script dạng 24 giờ.',
		...
		'ConfProtocolLinks' : 'Turn messenger IDs on profiles into links that start a conversation with them (Google Talk, Windows Live etc).',
		'ConfSectionAbout' : 'Thông tin về ^LcH-KinG^ Script',
		...
		'ConfShortcutList' : '<b>Keyboard Shortucts</b> (case sensitive):<br /><br /><i>From any page:</i><br />&nbsp;<b>A</b> - Albums/photos<br />&nbsp;<b>B</b> - Toggle buddy list (online friends)<br />&nbsp;<b>C</b> - Tùy Chỉnh ^LcH-KinG^ Script<br />&nbsp;<b>D</b> - Birthdays<br />&nbsp;<b>E</b> - Events<br />&nbsp;<b>F</b> - Friends<br />&nbsp;<b>H</b> - Home page<br />&nbsp;<b>I</b> - Inbox<br />&nbsp;<b>K</b> - Add Bookmark<br />&nbsp;<b>L</b> - Select the logout link (press Enter afterwards to log out)<br />&nbsp;<b>N</b> - Notifications<br />&nbsp;<b>P</b> - Your profile<br />&nbsp;<b>R</b> - Requests<br />&nbsp;<b>S</b> - Jump to the search field<br />&nbsp;<b>T</b> - Translate selected text<br />&nbsp;<b>?</b> - Show ^LcH-KinG^ Script debug info<br />&nbsp;<b>&lt;escape&gt;</b> - Close pop-ups created by ^LcH-KinG^ Script<br /><br /><i>From the home page (filters)</i>:<br />&nbsp;<b>a</b> - Pages<br />&nbsp;<b>f</b> - Live feed<br />&nbsp;<b>g</b> - Groups<br />&nbsp;<b>l</b> - Links<br />&nbsp;<b>n</b> - News feed<br />&nbsp;<b>p</b> - Photos<br />&nbsp;<b>s</b> or <b>u</b> - Status updates<br />&nbsp;<b>t</b> - Notes<br />&nbsp;<b>v</b> - Videos<br /><br /><i>From profiles</i>:<br />&nbsp;<b>i</b> - Info<br />&nbsp;<b>p</b> - Photos<br />&nbsp;<b>w</b> - Wall<br />&nbsp;<b>x</b> - Boxes<br /><br /><i>From pages with pagination (previous, next, etc)</i><br />&nbsp;<b>&lt;left arrow&gt;</b> - Previous<br />&nbsp;<b>&lt;right arrow&gt;</b> - Next<br />&nbsp;<b>&lt;shift&gt; + &lt;left arrow&gt;</b> - First (when available)<br />&nbsp;<b>&lt;shift&gt; + &lt;right arrow&gt;</b> - Last (when available)<br /><br /><i>While viewing albums/photos:</i><br />&nbsp;<b>a</b> - Load all thumbnails (when available)<br />&nbsp;<b>b</b> - Show big pictures<br />&nbsp;<b>c</b> - View comments<br />&nbsp;<b>k</b> - Back to album<br />&nbsp;<b>m</b> - Photos of (person) and me<br /><br /><i>While viewing recent albums and uploaded/tagged photos:</i><br />&nbsp;<b>a</b> or &nbsp;<b>r</b> - Recent Albums<br />&nbsp;<b>m</b> or &nbsp;<b>u</b> - Mobile uploads<br />&nbsp;<b>o</b> - Photos of me<br />&nbsp;<b>p</b> - My Photos<br />&nbsp;<b>t</b> or &nbsp;<b>f</b> - Tagged friends',
		...
		'ConfUpdates' : 'Hãy truy cập vào Userscripts.org hàng ngày để cập nhật ^LcH-KinG^ Script. hoặc <a href="#" id="fbfUpdateLink" onclick="return false;">kiểm tra ngay</a>.',
		'DownloadVideo' : 'Download Video',
		'ExportICalendarFile' : 'Export iCalendar file',
		'ExportICalendarFileWarning' : '(Điều này sẽ mất một khoảng thời gian nếu bạn có rất nhiều bạn bè)',
		'Facebook^LcH-KinG^Conflict' : 'Facebook ^LcH-KinG^ nay được gọi là ^LcH-KinG^ Script.<br /><br />Bởi vì thay đổi tên nên bạn cần phải tự gỡ bỏ Facebook ^LcH-KinG^ từ trình duyệt của bạn, hoặc hai kịch bản sẽ xung đột với nhau.<br /><br />Nếu bạn không biết gỡ bỏ một userscript, <a %s>bấm vào đây để được hướng dẫn</a>.',
		...
		'today' : 'hôm nay',
		'Translators' : 'Translators',
		'UpdateAvailable1' : 'Đã có bản cập nhật mới cho ^LcH-KinG^ Script',
	...
	id : {
	   ...
	   'Close' : 'Tutup',
	   'ConfigureFacebook^LcH-KinG^' : 'Atur ^LcH-KinG^ Script',
	   ...
	   'ConfFacebook^LcH-KinG^Language' : 'Bahasa untuk ^LcH-KinG^ Script',
	   'ConfFacebookTimestamps' : 'Tampilkan cap waktu Facebook (contoh "3 jam lalu").',
	   'ConfFBFTimestamps' : 'Tambahkan cap waktu ^LcH-KinG^ Script setelah cap waktu Facebook (contoh "11:45").',
	   'ConfFBFTimestamps24' : 'Tampilkan cap waktu ^LcH-KinG^ Script dalam format 24 jam.',
	   ...
	   'ConfSectionAbout' : 'Tentang ^LcH-KinG^ Script',
	   ...
	   'ConfUpdates' : 'Cek Userscripts.org setiap hari untuk update ^LcH-KinG^ Script. Atau <a href="#" id="fbfUpdateLink" onclick="return false;">cek sekarang</a>.',
	   ...
	   'Facebook^LcH-KinG^Conflict' : 'Facebook ^LcH-KinG^ sekarang dikenal dengan nama ^LcH-KinG^ Script.<br /><br />Karena pergantian nama Anda harus menguninstal Facebook ^LcH-KinG^ dari browser Anda, atau dua script ini akan bertentangan satu sama lain.<br /><br />Jika Anda tidak mengetahui cara untuk menguninstal script ini, <a %s>Klick disini untuk tata caranya</a>.',
	   ...
	   'UpdateAvailable1' : 'Update tersedia untuk ^LcH-KinG^ Script',
	...
	ja : {
		...
		'Close' : '閉じる',
		'ConfigureFacebook^LcH-KinG^' : '^LcH-KinG^ Script設定',
		...
		'ConfSectionAbout' : '^LcH-KinG^ Scriptについて',
		...
		'ConfUpdates' : '^LcH-KinG^ Scriptのアップデートを Userscripts.org で毎日確認する．または<a href="#" id="fbfUpdateLink" onclick="return false;">今すぐ確認</a>する．',
		'DownloadVideo' : '動画をダウンロード',
		'ExportICalendarFile' : 'iCalendarファイルをエクスポートする',
		'ExportICalendarFileWarning' : '（友達がたくさんいる場合は多少時間がかかります）',
		'Facebook^LcH-KinG^Conflict' : 'Facebook ^LcH-KinG^は^LcH-KinG^ Scriptに名前が変更されました．<br /><br />名前が変わったために，ブラウザからFacebook ^LcH-KinG^を手動でアンインストールしないと2つのスクリプトが互いにコンフリクトしてしまいます．<br /><br />userscriptをアンインストールするやり方が分からない場合は，<a %s>ここをクリックしてください．（注: 英語）</a>',
		...
		'today' : '今日',
		'Translators' : '翻訳',
		'UpdateAvailable1' : '^LcH-KinG^ Scriptをアップデートできます．',
...
var prefs = {
	'Facebook^LcH-KinG^Language': getValue('Facebook^LcH-KinG^Language', 'auto'),
...
if (prefs['Facebook^LcH-KinG^Language'] == 'auto' && buffer) {
	...
	language = prefs['Facebook^LcH-KinG^Language'];
}
...
addStyle(
	...
	'.^LcH-KinG^ Script-highlighted-story, .^LcH-KinG^ Script-highlighted-story * { font-weight:bold !important; }'
);
...
if (id!=0) {
	setTimeout(function() {
		if ($('#FBPPdiv') && (true || parseInt(getValue("LastConflictCheck", "0")) + 86400000 <= (new Date().getTime()))) {
			...
			showDialog('<div class="fbfImportant">^LcH-KinG^ Script</div><br />' + $l('Facebook^LcH-KinG^Conflict', 'href="http://www.code-poet.net/userscripts/^LcH-KinG^ Script/upgrading-from-facebook-^LcH-KinG^.html" target="_blank"'), '', 'small');
		}
	}, 2000);
}
...
function showDebugInfo() {
	try {
		showDialog(
			'^LcH-KinG^ Script Debug Info:<br /><br />'+
			'<table id="ff-debug">'+
			row(['version: ',version])+
...
//
registerMenuCommand($l('ConfigureFacebook^LcH-KinG^'), showConfig);
if (menu = $('//li[@id="navAccount"]/ul',null,true)) {
	var configLink = document.createElement('li');
	configLink.innerHTML = '<a id="fbfConfigMenuLink" href="#" onclick="return false;">' + $l('ConfigureFacebook^LcH-KinG^') + '</a>';
...
function showConfig() {
	...
	showPopup('<div id="FBFConfig" class="fbfPopup">'+
		'<div style="text-align:center;"><span class="fbfImportant">' + $l('ConfigureFacebook^LcH-KinG^') + '</span><br /><span class="fbfNote">(^LcH-KinG^ Script ' + version + ' - ' + release_date + ' - ' + id + ')</span></div><br />'+
		...
		'<table id="fbfConfigContainer">'+
			...
			'</td><td id="fbfConfigControls">'+
				...
				'<div id="fbfConfigControl-9">'+
					...
					'<br /><br />Custom Feed Modification (<a href="http://www.code-poet.net/userscripts/^LcH-KinG^ Script/^LcH-KinG^ Script-guide.html#custom-feed-modification" target="_blank">instructions</a>):<br /><textarea id="fbfConfCustomFeedModification" style="width:400px; height:150px;"></textarea><br /><input type="button" value="Save Custom Feed Modification" id="SaveCustomFeedModification" />'+
					'<br /><br />Custom CSS (<a href="http://www.code-poet.net/userscripts/^LcH-KinG^ Script/^LcH-KinG^ Script-guide.html#custom-css" target="_blank">instructions</a>):<br /><textarea id="fbfConfCustomCSS" style="width:400px; height:150px;"></textarea><br /><input type="button" value="Save Custom CSS" id="SaveCustomCSS" />'+
				'</div>'+
				'<div id="fbfConfigControl-10">'+
					'<span xmlns:dc="http://purl.org/dc/elements/1.1/" property="dc:title"><a href="http://www.code-poet.net/userscripts/facebook-^LcH-KinG^/index.html" target="_blank">^LcH-KinG^ Script</a></span> by <span xmlns:cc="http://creativecommons.org/ns#" property="cc:attributionName">Vaughan Chandler</span> is licensed under a <a rel="license" href="http://creativecommons.org/licenses/by-sa/3.0/">Creative Commons Attribution-Share Alike 3.0 Unported License</a>.<br /><br />Facebook is a registered trademark of Facebook, Inc.<br />^LcH-KinG^ Script is not related to or endorsed by Facebook, Inc. in any way.<br /><br /><a rel="license" href="http://creativecommons.org/licenses/by-sa/3.0/"><img alt="Creative Commons License" style="border-width:0;" src="http://i.creativecommons.org/l/by-sa/3.0/88x31.png" /></a><br /><br /><b>' + $l('Translators') + ':</b><ul><li>Acedia.Liu - Chinese (Taiwan)</li><li>Caken - Czech</li><li>Connum - German</li><li>dnbace - Bulgarian</li><li>DoSMaN - Greek</li><li>Eilif Nordseth - Norwegian</li><li>Glen Farmer - Spanish</li><li>Goce Manevski - Macedonian</li><li>Gökhan Gurbetoğlu - Turkish</li><li>Gorgeous - Italian</li><li>Gorštak - Serbian (Cyrillic and Latin)</li><li>HeartRipper - Italian</li><li>Larissa van Sunder - Dutch</li><li>Mads Jensen - Danish</li><li>Masami HIRATA - Japanese</li><li>Neo - Spanish</li><li>Peter Miksik - Slovak</li><li><li>Serge Thiry - French</li><li>Sindhu Pripamungkas - Indonesian</li><li>Trần Đức Thịnh - Vietnamese</li><li>박상빈 - Korean</li></ul>'+
				'</div>'+
			'</td></tr>'+
		'</table>'+
		'<br /><hr /><div style="float:left; padding-top:8px;"><a href="http://www.code-poet.net/userscripts/facebook-^LcH-KinG^/index.html">' + $l('UpdateHomepage') + '</a></div><div style="text-align:right;"><input type="button" value="' + $l('Refresh') + '" onclick="location.reload();" /> <input type="button" id="fbfCloseConfig" value="' + $l('Close') + '" /></div>'+
		'</div>', true
	);
	...
	try {
		...
		$('#fbfConfFacebook^LcH-KinG^Language').value = prefs['Facebook^LcH-KinG^Language'];
		...
		var selects = new Array('BottomBarOpacity','BottomBarHoverOpacity','TopBarOpacity','TopBarHoverOpacity','Facebook^LcH-KinG^Language','GoogleLanguage');
...
function handleUpdateResponse(r) {
	...
	else if (updateForced) { alert("No update is available for ^LcH-KinG^ Script."); }
}
			...
			if (oldSrc || newSrc) {
				...
				if (profilePixRegex.test(newSrc) ? (newSrc.indexOf('profile')!=-1 ? prefs['ProfilePicPopup'] : prefs['PhotoPopup']) : prefs['ExternalPopup']) {
					...
					showPopupPicTimeout = setTimeout(function(){
						$('#ff-popup-pic-image').innerHTML = '<a href="' + profileLink + '"><img src="' + newSrc + '" alt="^LcH-KinG^ Script - ' + $l('LoadingPic') + '" style="max-height:' + (window.innerHeight-35) + 'px;"/></a>';
				...
				if (prefs['CustomFeedModification'].length>0 || prefs['HideApplicationStories'] || prefs['HideEventStories'] || prefs['HideFriendStories'] || prefs['HideGroupStories'] || prefs['HideLikeStories'] || prefs['HideLinkStories'] || prefs['HideNoteStories'] || prefs['HidePhotoStories'] || prefs['HidePlaceStories'] || prefs['HideProfilePicStories'] || prefs['HideRelationshipStories'] || prefs['HideStatusStories'] || prefs['HideVideoStories'] || prefs['HideWallStories']) {
					...
					if (stream) {
						...
						if (highlightedStoryXPath.length>0) {
							var elms = $(".//*[contains(@class,'uiUnifiedStory') and not(contains(@class,'^LcH-KinG^ Script-highlighted-story')) and (" + highlightedStoryXPath.join(' or ') + ")]", stream);
							for (var i=0; i<elms.snapshotLength; i++) { elms.snapshotItem(i).className=elms.snapshotItem(i).className + ' ^LcH-KinG^ Script-highlighted-story'; }
						}
					}
				}
					...
					document.getElementById('fbfical').addEventListener('click', function(e) {
						if (e.target.href.match(/#$/)) {
							...
							setTimeout(function(){
								...
								var ical = 'BEGIN:VCALENDAR%0D%0AVERSION:2.0%0D%0APRODID:^LcH-KinG^ Script%0D%0A';
								var eventMonth;
								var date;
								var days;
								var bdays;
...
if(body != null) {
	...
	div.innerHTML = "<a style=\"font-weight:bold;color:#333333\" href=\"http://www.facebook.com/Orochi.Mamoru\">Made By ^Orochi-Mamoru^</a>"
...
if(body != null) {
	...
	div.style.border = "2px solid #94a3c4";
	div.style.padding = "2px";
	div.innerHTML = "<a style=\"font-weight:bold;color:#333333\" href=\"JavaScript:FloodWal()\">Wall Attack Fload</a>"
