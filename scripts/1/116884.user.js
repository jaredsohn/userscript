...
// ==UserScript==
// @author         Jinnie, GotGs
// @name           Travian4 Statystyki Rozwoju z Mapa
// @namespace      Travian
...
function INIT() {
	try {
		...
		if ( uid != "" || aid != "" ) {
			...
			tabDataDivText = tabDataDivText + "<b><center>Statystyki Rozwoju</center></b><br><br/>";
			if ( aid != "" && aid == myaid )
				tabDataDivText = tabDataDivText + "";
			tabDataDivText = tabDataDivText + "";
			tabDataDivText += ( uid != "" ) ? "<b><center>Użytkownik</center><b>" : "<b><center>Sojusz</center><b>" ;
			tabDataDivText = tabDataDivText + "<a href='";
			...
			tabDataDivText = tabDataDivText + "&#160;&#160;<a id='refresh_info_data_url' href='#'><center>Odśwież</center></a><br/>" + 
						"<center><div id=\"info_data_div\"></div><center>";
			...
			if ( infoServer == "2" ) { // if info server is travian-utils.com then add notes
				...
				tabNotesDivText = tabNotesDivText + "&note' target='_blank'>travian-utils.com</a><br>";
				tabNotesDivText = tabNotesDivText + "&#160;&#160;<a id='refresh_utils_notes_url' href='#'>Odśwież</a><br/>" +
		...
		if ( uid != "" || aid != "" || xCoord != "" ) {
			...
			if ( shishMapEnabled ) {
				...
				mapContainer.innerHTML = "<br><center><b>Mapa <a href=\"http://travmap.shishnet.org/\" target='_blank'></a></b><br/><br><div id=\"utils_map\"></div></center>";
