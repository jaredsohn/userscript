// ==UserScript==
// @name        Hide fleets (Persian)
// @author      Microbe
// @translator  SHAB_RO
// @include     http://s*ir.ikariam.*/index.php*
// @version     1.1
// @grant       GM_getValue
// @grant       GM_setValue
...
function showOptions(){
	...
	if(!movesOptionsBox){
		$('div#js_MilitaryMovementsFleetMovementsTable.content').prepend(
			...
			+'<a id="movesOptionsBoxOptionHide" href="#" title="Cliquez pour masquer les options">بستن تنظيمات</a>'
			+'<a id="movesOptionsBoxOptionShow" style="display:none;" href="#" title="Cliquez pour afficher les options">تنظيمات نمايش</a>'
			+'<table style="width:100%;">'
			+'<tr class="movesOptionsBoxRow">'
			+'<td colspan="2" style="text-align:center;font-weight:bold;background:#f5dbb3;padding-bottom:2px;">حركت هاى من</td>'
			+'<td colspan="2" style="text-align:center;font-weight:bold;background:#FAEAC6;padding-bottom:2px;">حركت هاى ديگران</td>'
			+'</tr>'
			+'<tr class="movesOptionsBoxRow">'
			+'<td style="padding-left:15px;background:#f5dbb3"><input name="ownTransportMoves" id="ownTransportMoves" type="checkbox" style="vertical-align: bottom;" '+ retrieveState("ownTransportMoves",true) +'/><label for="ownTransportMoves" style="padding-left:2px;" title="Cochez/décochez une case pour afficher/masquer les mouvements correspondants">حمل و نقل</label></td>'
			+'<td style="padding-left:10px;background:#f5dbb3"><input name="ownCommercialMoves" id="ownCommercialMoves" type="checkbox" style="vertical-align: bottom;" '+ retrieveState("ownCommercialMoves",true) +'/><label for="ownCommercialMoves" style="padding-left:2px;" title="Cochez/décochez une case pour afficher/masquer les mouvements correspondants">تجارت</label></td>'
