// ==UserScript==
// @name           [Паутина]панель руководства 
// @namespace      berkut009
...
if (serv == 'com') {
	...
	text_ppp = '<a style="text-decoration: none;" href="clan_info.php?id=3695">#3695 Боевая академия Паутины</a>';
	...
	text_10 = '<a style="text-decoration: none;" href="forum_messages.php?tid=926425&page=last">Форум</a>';
