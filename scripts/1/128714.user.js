// ==UserScript==
// @name        Moh3n travian speed
// @namespace   http://userscripts.org/
// @description Calculate capacity resource

// @include 	http://ts*.travian.*/berichte.php*
// @include 	http://ts*.travian.*/a2b.php*
// @include     http://*.tra*.*/*
...
function attackLink(userId,unitId,capacity,unit_capacity) {
	var tedad = parseInt(capacity / unit_capacity);
	var imgSarbaz = '<a target="_blank" href="http://ts4.travian.ir/a2b.php?z=' + userId + '&'+unitId.substring(unitId.lastIndexOf(' ') + 1,unitId.length)+'=' + tedad + '"><img class="' + unitId + '" src="img/x.gif" style="margin-left: 0px;"/></a>' + '&nbsp;&nbsp;';
	var tedadLink = '<a target="_blank" href="http://ts4.travian.ir/a2b.php?z=' + userId + '&'+unitId.substring(unitId.lastIndexOf(' ') + 1,unitId.length)+'=' + tedad + '&att=auto">' + tedad + '</a>';
	return imgSarbaz + tedadLink + '&nbsp;&nbsp;&nbsp;&nbsp;';	
}




function attackLink2_1(userId,capacity) {
	var shovalie_tedad = parseInt(capacity / 100);
	shovalie_tedad = parseInt(shovalie_tedad / 2.7);
	shamshirzan_tedad = parseInt(((shovalie_tedad * 120) * 2) / 70);
	
//	var imgSarbaz = '<a target="_blank" href="http://ts4.travian.ir/a2b.php?z=' + userId + '&u3=' + shamshirzan_tedad + '&u5=' + shovalie_tedad + '&att=2-1' ">2-1</a>' + '&nbsp;&nbsp;';
	var imgSarbaz = '<a target="_blank" href="http://ts4.travian.ir/a2b.php?z=' + userId + '&u3=' + shamshirzan_tedad + '&u5=' + shovalie_tedad + '&att=2-1"><img style="margin-left: 0px;" src="img/x.gif" class="unit u3"><img style="margin-left: 0px;" src="img/x.gif" class="unit u3"><img style="margin-left: 0px;" src="img/x.gif" class="unit u5"></a>' + '&nbsp;&nbsp;';
	return imgSarbaz + '&nbsp;';	
}


function attackLink1_1(userId,capacity,unit_capacity) {
	var tedad = parseInt(capacity / unit_capacity);
	var lejion = parseInt(tedad / 2);
	var shamshirzan = parseInt(tedad / 2);
	
	var imgSarbaz = '<a target="_blank" href="http://ts4.travian.ir/a2b.php?z=' + userId + '&u1=' + lejion + '&u3=' + shamshirzan + '&att=1-1"><img style="margin-left: 0px;" src="img/x.gif" class="unit u1"><img style="margin-left: 0px;" src="img/x.gif" class="unit u3"></a>' + '&nbsp;&nbsp;';
	return imgSarbaz + '&nbsp;';	
}
...
function addListAttackLink1(unit, start, end) {
	var content = '<div class="option" style="width: 300px"><img class="unit u' + unit + '" src="img/x.gif" style="float: right">';	
	var margin = '20px';
	for(var i = start; i <= end; i = parseInt(i * 1.5) + start) {
		content = content + '<a href="http://ts4.travian.ir/a2b.php?z=' + xyToId(getParameterByName('x'),getParameterByName('y')) + '&u' + unit + '=' + i + '&att=auto" style="margin-right: ' + margin + '; float: right"><div style="width: 25px">' + i + '</div></a>';		
	}
	content = content + '<div />';
	$("div.detailImage:eq(0)").append(content);
}
function addListAttackLink2(unit1,unit2, start, end) {
	var content = '<div class="option" style="width: 300px"><div style="width: 60px; float: right;"><img class="unit u' + unit1 + '" src="img/x.gif" style="float: right"><img class="unit u' + unit2 + '" src="img/x.gif" style="float: right"></div>';	
	var margin = '20px';
	for(var i = start; i <= end; i = parseInt((i + 10) + (i / 5))) {
		var j = parseInt(i/2.3);
		content = content + '<a href="http://ts4.travian.ir/a2b.php?z=' + xyToId(getParameterByName('x'),getParameterByName('y')) + '&u' + unit1 + '=' + i + '&u' + unit2 + '=' + j + '&att=auto" style="margin-right: ' + margin + '; float: right"><div style="width: 25px">' + i + '</div></a>';
	}
	content = content + '<div />';
	$("div.detailImage:eq(0)").append(content);
}
function addListAttackLink3(unit1,unit2,unit3, start, end) {
	var content = '<div class="option" style="width: 300px"><div style="width: 60px; float: right;"><img class="unit u' + unit1 + '" src="img/x.gif" style="float: right"><img class="unit u' + unit2 + '" src="img/x.gif" style="float: right"><img class="unit u' + unit3 + '" src="img/x.gif" style="float: right"></div>';	
	var margin = '20px';
	for(var i = start; i <= end; i = parseInt(i + (i / 2))) {
		content = content + '<a href="http://ts4.travian.ir/a2b.php?z=' + xyToId(getParameterByName('x'),getParameterByName('y')) + '&u' + unit1 + '=' + i + '&u' + unit2 + '=' + i + '&u' + unit3 + '=' + i + '&att=auto" style="margin-right: ' + margin + '; float: right"><div style="width: 25px">' + i + '</div></a>';
	}
	content = content + '<div />';
	$("div.detailImage:eq(0)").append(content);
}

function addListAttackKata(unit1,unit2, start, end) {
	var content = '<div class="option" style="width: 300px"><div style="width: 60px; float: right;"><img class="unit u' + unit1 + '" src="img/x.gif" style="float: right"><img class="unit u' + unit2 + '" src="img/x.gif" style="float: right"></div>';	
	var margin = '20px';
	for(var i = start; i <= end; i = parseInt(i + 20)) {
		content = content + '<a href="http://ts4.travian.ir/a2b.php?z=' + xyToId(getParameterByName('x'),getParameterByName('y')) + '&u' + unit1 + '=' + i + '&u' + unit2 + '=' + parseInt(i / 4) + '&att=auto" style="margin-right: ' + margin + '; float: right"><div style="width: 25px">' + i + '</div></a>';
	}
	content = content + '<div />';
	$("div.detailImage:eq(0)").append(content);
}

function addListAttackKata2(unit1,unit2,unit3, start, end) {
	var content = '<div class="option" style="width: 300px"><div style="width: 60px; float: right;"><img class="unit u' + unit1 + '" src="img/x.gif" style="float: right"><img class="unit u' + unit2 + '" src="img/x.gif" style="float: right"><img class="unit u' + unit3 + '" src="img/x.gif" style="float: right"></div>';	
	var margin = '20px';
	for(var i = start; i <= end; i = parseInt(i + 10)) {
		content = content + '<a href="http://ts4.travian.ir/a2b.php?z=' + xyToId(getParameterByName('x'),getParameterByName('y')) + '&u' + unit1 + '=' + i + '&u' + unit2 + '=' + i + '&u' + unit3 + '=' + parseInt(i / 2) + '&att=auto" style="margin-right: ' + margin + '; float: right"><div style="width: 25px">' + i + '</div></a>';
	}
	content = content + '<div />';
	$("div.detailImage:eq(0)").append(content);
}

// اضافه کردن لینک حمله
if(window.location.href.substring(0,38) == "http://ts4.travian.ir/position_details") {
	
	// پاک کردن هیدر های سمت چپ صفحه 
	$("#map_details > h4").remove();
	// پاک کردن تصویر دهکده
	$("div.detailImage").attr('style','background:none; padding-top: 0px');
	$("div.detailImage:eq(0)").append('<br />');

	addListAttackLink1(4,1, 20);
	addListAttackLink1(1,8, 190);
	addListAttackLink1(2,8, 190);
	addListAttackLink1(3,8, 190);
	addListAttackLink1(5,8, 190);

	$("div.detailImage:eq(0)").append('<br />');
	addListAttackLink2(3,5,50, 190);
	addListAttackLink3(1,3,5,20, 100);
	
	$("div.detailImage:eq(0)").append('<br />');
	addListAttackKata(3,8,20, 100);	
	addListAttackKata2(1,3,8,20, 60);	
...
if(ID("troops") != null) {
	jQuery("input[name=c][value=4]").attr('checked','checked');
	

/*
	// تغییر یه مقدار نیروهایی که با تراوین تاکتیک میفرستیم
...
*/
	...
	// رومی ها
	if(getParameterByName('u1') != null) {
   		$("input[name=t1]").val(getParameterByName('u1'));		
 	}
	if(getParameterByName('u2') != null) {
   		$("input[name=t2]").val(getParameterByName('u2'));		
 	}
	if(getParameterByName('u3') != null) {
   		$("input[name=t3]").val(getParameterByName('u3'));		
 	}
	if(getParameterByName('u4') != null) {
   		$("input[name=t4]").val(getParameterByName('u4'));		
 	} 	 	
	if(getParameterByName('u5') != null) {
 		$("input[name=t5]").val(getParameterByName('u5'));	
 	} 	
	if(getParameterByName('u6') != null) {
 		$("input[name=t6]").val(getParameterByName('u6'));	
 	}
	if(parseInt(getParameterByName('u8')) > 1) {
		jQuery("input[name=c][value=3]").attr('checked','checked');
 		$("input[name=t8]").val(getParameterByName('u8'));	
 	}

 	if(getParameterByName('att') == "auto") {
		$("form[name=snd]").submit();
	}	
	
/*	
	// توتن ها
	if(getParameterByName('u11') != null) {
   		$("input[name=t1]").val(getParameterByName('u11'));		
 	}
	if(getParameterByName('u12') != null) {
   		$("input[name=t3]").val(getParameterByName('u12'));		
 	} 	
	if(getParameterByName('u13') != null) {
 		$("input[name=t5]").val(getParameterByName('u13'));	
 	} 	
	if(getParameterByName('u15') != null) {
 		$("input[name=t6]").val(getParameterByName('u15'));	
 	}
 	if(getParameterByName('att') == "auto") {
		$("form[name=snd]").submit();
	}
...
function getUserId() {
	var id = 0
	if($(".goods:eq(0) tr:eq(0) th:eq(0)").text() == "منابع") {
		var b = $(".troopHeadline a:last-child:eq(1)");
		b = b.attr('href');
		var id = b.substring(b.lastIndexOf('?d=') + 3,b.length);	
	}
	return id;
}

	if(ID("attacker").childNodes[7].childNodes[0].childNodes[1].childNodes[0].childNodes[0].lastChild.data != null)
		hidden = parseInt(ID("attacker").childNodes[7].childNodes[0].childNodes[1].childNodes[0].childNodes[0].lastChild.data);
	else
		hidden = 0;
    
	resource = parseInt(ID("attacker").childNodes[6].lastChild.childNodes[1].childNodes[0].childNodes[0].lastChild.data);
	if(resource > hidden)
		capacity = capacity + (resource - hidden);

	resource = parseInt(ID("attacker").childNodes[6].lastChild.childNodes[1].childNodes[0].childNodes[1].lastChild.data);
	if(resource > hidden)
		capacity = capacity + (resource - hidden);

	resource = parseInt(ID("attacker").childNodes[6].lastChild.childNodes[1].childNodes[0].childNodes[2].lastChild.data);
	if(resource > hidden)
		capacity = capacity + (resource - hidden);

	resource = parseInt(ID("attacker").childNodes[6].lastChild.childNodes[1].childNodes[0].childNodes[3].lastChild.data);
	if(resource > hidden)
		capacity = capacity + (resource - hidden);
	capacity = parseInt(capacity);

	// پاک کردن تصویر از صفحه جاسوسی
	ID("report_surround").childNodes[3].childNodes[1].childNodes[0].childNodes[1].style.height = "0px";
	


	if(capacity > 40) {	

		if(ID("attacker").childNodes[2].childNodes[0].childNodes[4].childNodes[0].alt == "خبرچین" || ID("attacker").childNodes[2].childNodes[0].childNodes[3].childNodes[0].alt == "رد یاب") {
			$(".res:eq(1):first-child").append("<br /><br />" + '<img class="carry full" alt="حداکثر غارت" src="img/x.gif"/>' + capacity + '&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;');
	    	$(".res:eq(1):first-child").append(attackLink(getUserId(),"unit u1",capacity,50));
	    	$(".res:eq(1):first-child").append(attackLink(getUserId(),"unit u3",capacity,50));
	    	$(".res:eq(1):first-child").append(attackLink(getUserId(),"unit u5",capacity,100));
	    	$(".res:eq(1):first-child").append(attackLink(getUserId(),"unit u6",capacity,70));
	    	$(".res:eq(1):first-child").append('<br /><br /><div style="width: 81px; float: right; height: 10px;"></div>');
	    	$(".res:eq(1):first-child").append(attackLink2_1(getUserId(),capacity));
	    	$(".res:eq(1):first-child").append(attackLink1_1(getUserId(),capacity,50));
    	}
    }
	/*
	if(capacity > 60) {	
		if(ID("attacker").childNodes[2].childNodes[0].childNodes[4].childNodes[0].alt == "جاسوس") {
			$(".res:eq(1):first-child").append("<br /><br />" + '<img class="carry full" alt="حداکثر غارت" src="img/x.gif"/>' + capacity + '&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;');
	    	$(".res:eq(1):first-child").append(attackLink(getUserId(),"unit u11",capacity,60));
	    	$(".res:eq(1):first-child").append(attackLink(getUserId(),"unit u12",capacity,40));
	    	$(".res:eq(1):first-child").append(attackLink(getUserId(),"unit u13",capacity,50));
	    	$(".res:eq(1):first-child").append(attackLink(getUserId(),"unit u15",capacity,110));
    	}    
	}
	
	if(capacity > 30) {	
		if(ID("attacker").childNodes[2].childNodes[0].childNodes[3].childNodes[0].alt == "رد یاب") {
			$(".res:eq(1):first-child").append("<br /><br />" + '<img class="carry full" alt="حداکثر غارت" src="img/x.gif"/>' + capacity + '&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;');
	    	$(".res:eq(1):first-child").append(attackLink(getUserId(),"unit u21",capacity,30));
	    	$(".res:eq(1):first-child").append(attackLink(getUserId(),"unit u22",capacity,45));
	    	$(".res:eq(1):first-child").append(attackLink(getUserId(),"unit u24",capacity,75));
	    	$(".res:eq(1):first-child").append(attackLink(getUserId(),"unit u25",capacity,35));
