// ==UserScript==
// @author		Angel Vladov
// @revised		Candymanson and Lorcema
// @name        EPIC battle stats
// @version		1.0.8
// @uso:version	1.0.8
// @include		http://*erepublik.com/*
// @description    Sistema de reporte de daño de EPIC
// ==/UserScript==

var FORM_URL = "https://docs.google.com/spreadsheet/viewform?formkey=dE9HSW5sQjBISVNmYjV1aVYyTGZ2UkE6MQ#gid=0";
...
var LOCALE = {
	en:function() {
		return {
			...
			send_report: "Do you want to send a report to EPIC commander?",
	...
	bg: function() {
		return {
			...
			send_report: "Estas listo para enviar el reporte al comandante de EPIC?",
...
var main = function() {
	...
	$.find("#logo").append(
		...
		'<div><b><u>EPIC battle stats</u></b></div>' +
		'<b>Autor: </b>Lorcema (gracias candymanson)<br />' +
	...
	<a title="Reportar a EPIC" href="javascript:;" id="bs_report_pop_send">Reportar a EPIC</a>                                         \
