...
// @namespace   http://userscripts.org/scripts/show/186268
...
try{
	...
	texte["msgMarketsaleContent"]="(.*) a achet"+e_ac+" (\\d+)x (.*?) pour (.*?) fL\\."; // The text where the information is stated. The information has to be replaced by "(.*?)".
	// For the following you have to take a message sent if you sell something via contract
	texte["msgContractsaleContent"]="(.*) a sign"+e_ac+" un de tes contrats!<br><br> Les produits suivants ont "+e_ac+"t. vendu:<br>(.*?)<br> Le total de (.*?) fL a "+e_ac+"t"+e_ac+" cr"+e_ac+"dit"+e_ac+" "+a_grave+" ton compte\\."; // The text where the general information is stated. The information has to be replaced by "(.*?)".
	...
	texte["msgFriend"]="(.+) souhaite t'ajouter "+a_grave+" ses amis"; // The subject. The person has to be replaced by "(.+)"
	...
	texte["automat_title_on_type0"] = "Show fields only<br>+Ctrl: Show fields";
	texte["automat_title_off_type0"] = "Show fields only<br>+Ctrl: Hide fields";
	texte["automat_title_on_type1"] = "Show stables only<br>+Ctrl: Show stables";
	texte["automat_title_off_type1"] = "Show stables only<br>+Ctrl: Hide stables";
	texte["automat_title_on_type2"] = "Show factories only<br>+Ctrl: Show factories";
	texte["automat_title_off_type2"] = "Show factories only<br>+Ctrl: Hide factories";
