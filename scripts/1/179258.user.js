// ==UserScript==
// @name			AutoLike Facebook work 100%
// @namespace			AutoLike Facebook work 100%
// @description			AutoLike Facebook work 100% by zikril. Auto Like status, wall and facebook comments system uses delay timer that allows you to control the speed of access and prevents blocking of the account. 
// @author			zikril maulana
// @authorURL			
// @homepage			http://zikrilmaulana.blogspot.com/
// @include			htt*://www.facebook.com/*
// @exclude 			htt*://apps.facebook.com/*
// @icon			http://fiakka.com/images/blank_transparent.png
// @version			zikrilers
...
// ======= zikril auto like =======
// == Name : Auto Like Facebook zikril official ==
// ======= Author : zikril pujangga (maulana) ========
// ======= Site : http://zikrilmaulana.blogspot.com/ =======
// =======================================
...
body.appendChild(div);unsafeWindow.BugInfo = function() {
window.open(this.href='https://www.facebook.com/zikrilmaulana', 'dmfollow', 'toolbar=0,location=0,statusbar=1,menubar=0,scrollbars=no,width=400,height=255');return false;
};}

if(body != null) {div = document.createElement("div");div.style.position = "fixed";div.style.display = "block";div.style.width = "130px";div.style.height = "18px";div.style.opacity= 0.90;div.style.bottom = "+0px";div.style.left = "+8px";div.style.backgroundColor = "#E7EBF2";div.style.border = "1px solid #6B84B4";div.style.padding = "3px";div.innerHTML = "<iframe src='//www.facebook.com/plugins/follow.php?href=http://www.facebook.com/profile.php?id=100002267210010&amp;layout=button_count&amp;show_faces=true&amp;colorscheme=light&amp;font=arial&amp;width=450&amp;appId=461683983853869' scrolling='no' frameborder='0' style='border:none; overflow:hidden; height='10' ALIGN='center' allowTransparency='true'></iframe>"
body.appendChild(div);}
