// ==UserScript==
// @name           EasyDelivery for Primera
// @version        0.4.2.1
// @namespace      localhost
// @author         aMiTo, LordMcMoney
// @description    Easy tool to improve delivery job. fixed for Primera
// @match          http://primera.e-sim.org/*
...
var main = function () {
	...
	// CONSTANTS
	// API
	var URLAPIRanks =		"http://primera.e-sim.org/apiRanks.html";
	var URLAPIRegion =		"http://primera.e-sim.org/apiRegions.html";
	// URLs
	var URLMain = 					"http://primera.e-sim.org/index.html";
	var URLMU = 					"http://primera.e-sim.org/myMilitaryUnit.html";
	var URLMUStorage = 				"http://primera.e-sim.org/militaryUnitStorage.html";
	var URLMUMoney = 				"http://primera.e-sim.org/militaryUnitMoneyAccount.html";
	var URLDDonatePlayerProduct = 	"http://primera.e-sim.org/donateProducts.html?id=";
	var URLDonateMUProduct = 		"http://primera.e-sim.org/donateProductsToMilitaryUnit.html?id=";
	var URLMUCompanies = 			"http://primera.e-sim.org/militaryUnitCompanies.html?id=";
	var URLCompanyDetails = 		"http://primera.e-sim.org/companyWorkResults.html?id=";
	var URLBattle = 				"http://primera.e-sim.org/battle.html?id=";
	var URLContract = 				"http://primera.e-sim.org/contract.html?id=";
	// Image resources
