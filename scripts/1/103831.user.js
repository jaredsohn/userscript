...
var Title = 'TLTTF KOC Power Tools';
...
Tabs.Test = {
  ...
  var citySelect = '   <SELECT id=fakeCity>';
    ...
    <TR><TD align=right># of Scouts: </td><TD><INPUT type=text size=6 value=0 id=faketroop2></td></tr>\
      ...
      <TR><TD align=right>Fake name to use: </td><TD><INPUT type=text size=13 value=A_PINK_ELEPHANT id=fakeName></td></tr>\
...
function dialogRetry (errMsg, seconds, onRetry, onCancel){
  ...
  pop.getTopDiv().innerHTML = '<CENTER>TLTTF KOC Power Tools</center>';
