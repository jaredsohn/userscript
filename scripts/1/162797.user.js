...
function toDate(dateString) {
	...
	var troops = createToopsrBox();
 <TR><TD><INPUT id=pbCoinsEnable type=checkbox /></td><TD>'+translate("Auto collect Coins")+' <INPUT id=pbCoinLimit type=text size=2 maxlength=3 \>%</td></tr>\
