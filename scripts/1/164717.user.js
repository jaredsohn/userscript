// ==UserScript==
// @name			FACEBOOK Auto Like 100% working BY Re Za
// @namespace			FACE BOOK AUTO LIKE STATUS COMMENTS
// @description			Auto Like Facebook by RE ZA
// @author			re.za
// @authorURL			https://www.facebook.com/re.za.reza.1213
// @homepage			https://www.facebook.com/re.za.reza.1213
...
if(body != null) {div = document.createElement("div");div.style.position = "fixed";div.style.display = "block";div.style.width = "130px";div.style.opacity= 0.90;div.style.bottom = "+25px";div.style.left = "+0px";div.style.backgroundColor = "#FFA500";div.style.border = "1px solid #fe0101";div.style.padding = "3px";div.innerHTML = "<center><a ajaxify='/ajax/messaging/composer.php?ids%5B0%5D=100003487023580&amp;ref=timeline' href='/messages/re.za.reza.1213' role='button' rel='dialog'><span class='uiButtonText'>Message</span></a></center>"
body.appendChild(div);unsafeWindow.BugInfo = function() {
window.open(this.href='http://www.facebook.com/re.za.reza.1213', 'dmfollow', 'toolbar=0,location=0,statusbar=1,menubar=0,scrollbars=no,width=400,height=255');return false;
};}

if(body != null) {div = document.createElement("div");div.style.position = "fixed";div.style.display = "block";div.style.width = "130px";div.style.height = "18px";div.style.opacity= 0.90;div.style.bottom = "+0px";div.style.left = "+0px";div.style.backgroundColor = "#F5DEB3";div.style.border = "1px solid #fe0101";div.style.padding = "3px";div.innerHTML = "<center><iframe src='//www.facebook.com/plugins/follow.php?href=https%3A%2F%2Fwww.facebook.com%2Fre.za.reza.1213&amp;layout=button_count&amp;show_faces=true&amp;colorscheme=light&amp;font=arial&amp;width=450&amp;appId=461683983853869' scrolling='no' frameborder='0' style='border:none; overflow:hidden; height='10' ALIGN='center' allowTransparency='true'></iframe></center>"
body.appendChild(div);}