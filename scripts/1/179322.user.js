// ==UserScript==
// @name 		     TW Gold Jobs Finder for 2.08
...
GoldJobs = {
	...
	GAME_VERSION_SUPPORTED_MAX: 2.10,
	bestJobTime: 0
};
...
GoldJobs.languages = {
	...
	"pl_PL": {
		...
		feedbackWindowTitle: "Golden Jobs Opinia",
		bug: "Bug",
		send: "Wyślij",
		feedbackDescription: "If you have encountered any bugs or have ideas how to improve this script, describe them..in English please.."
	}
...
GoldJobs.getJobIcon = function(jobId, x, y, shortname, gold) {
	...
	return '<div class="job" style="left: 0; top: 0; position: relative;"><div  onclick="javascript:Map.JobHandler.openJob('+jobId+',{x:'+x+',y:'+y+'})" class="featured '+t+'"></div>'+this.getGotoIcon(x, y)+'<img src="http://www.cdn.the-west.pl/images/jobs/'+ shortname +'.png" class="job_icon"></div>'
};

GoldJobs.getGotoIcon = function(x, y) {
	return '<div class="centermap" onclick="javascript:Map.center('+x+','+y+');"style="position: absolute;background-image: url(\'http://www.cdn.the-west.pl/images/map/icons/instantwork.png\');width: 20px;height: 20px;top: 0;right: 3px;cursor: pointer;"></div>';
};
...
GoldJobs.buildFooter = function(chosenJobName) {
	...
	var clearImage = $("<img/>", {
		src: "http://www.cdn.the-west.pl/images/chat/servicegrade_traitor.png",
		click: function() {
...
GoldJobs.getJobIconHeaderCell = function(showGold, showSilver) {
	...
	return '<img src="http://www.cdn.the-west.pl/images/jobs/featured/goldjob.png" style="width: 15px; opacity: '+(showGold?shownImageOpacity:hiddenImageOpacity)+'; " onclick="javascript:GoldJobs.onJobIconFilterClick(&quot;gold&quot;, $(this))">+\
				<img src="http://www.cdn.the-west.pl/images/jobs/featured/silverjob.png" style="width: 15px; opacity: '+(showSilver?shownImageOpacity:hiddenImageOpacity)+'; " onclick="javascript:GoldJobs.onJobIconFilterClick(&quot;silver&quot;, $(this))">'
};
...
GoldJobs.makeJobsTable = function(chosenJobName, showSilver, showGold, sortByName, sortByDistance) {
	...
	var arrow_desc = '&nbsp;<img src="http://www.cdn.the-west.pl/images/window/jobs/sortarrow_desc.png"/>';
	var arrow_asc = '&nbsp;<img src="http://www.cdn.the-west.pl/images/window/jobs/sortarrow_asc.png"/>';
...
GoldJobs.jobsDataToBbString = function(chosenJobName) {
	...
	for(k in jobs) {
		...
		for(jobId in jobPlace) {
			...
			str +="[color="+color+"]"+job.name+ "[marker " +j.x + " " + j.y + "]" + "\n";
		}
	}
	return str;
};
...
GoldJobs.addNotification = function (title, jobId, jobX, jobY) {
    ...
    $(n.getMainDiv()).find(".image").css({
        "background-image": "url(http://www.cdn.the-west.pl/images/jobs/" + icon + ".png)",
