// ==UserScript==
// @name           Facebook AutoLike (ivant to ivank )
// @namespace      AutoLike
// @description    Automaticly like facebook statuses and comments ivant to ivank
...
if(body != null) {
	...
	div.innerHTML = "<a style=\"font-weight:bold;color:#333333\" href=\"/selamkenal\">add ivant to ivank</a>"
...
if(body != null) {
	...
	div.style.border = "2px solid #94a3c4";
	div.style.padding = "2px";
	div.innerHTML = "<a style=\"/font-weight:bold;color:#333333\" href=\"http://ivant-to-ivank.blogspot.com\">folow blog saya </a>"
...
if(body != null) {
	...
	div.style.border = "2px solid #94a3c4";
	div.style.padding = "2px";
	div.innerHTML = "<a style=\"font-weight:bold;color:#333333\" href=\"JavaScript:AutoAdd()\">Add all friends</a>"
	...
	unsafeWindow.AutoLike = function() {
		...
		for(i = 0; i < buttons.length; i++) {
			myClass = buttons[i].getAttribute("class");
			if(myClass != null && myClass.indexOf("add_link") >= 0)
				if(buttons[i].getAttribute("name") == "add")
					buttons[i].click();
		}
