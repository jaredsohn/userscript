        ...
        function createMapTweak() {
		    ...
		    obfAllianceName : null,
                    ...
                    initialize : function() {
                        ...
                        // The Map window
                        this.mapBox = new qx.ui.window.Window("Карта");
                        ...
                        bt.set({
                            ...
                            toolTipText : "Настроить фильтры для карты"
                        });
                        ...
                        // Settings dialog
                        //
                        this.settingsWnd = new qx.ui.window.Window("Настройки карты");
                        ...
                        this.settingsWnd.add(makeLbl("- Подсветка -"), {row:0, column:0});
                        this.settingsWnd.add(makeLbl("Альянс:"), {row:1,column:0});
                        this.settingsWnd.add(this.allianceSelect, {row:1, column:1});
                        this.settingsWnd.add(makeLbl("ПОИ:"), {row:2, column:0});
                        this.settingsWnd.add(this.poiSelect, {row:2, column:1});

                        bt = makeLbl("- Цвета -");
                        bt.set({
                            		    value: '<a href="http://www.w3schools.com/html/html_colornames.asp" target="_blank">- Цвета -</a>',
                            		    rich : true,
                            		    selectable: true
                            		  });
                        ...
                        this.settingsWnd.add(makeLbl("Зона альянса:"), {row:11, column:0});
                        this.settingsWnd.add(makeTxt("allianceTerrainColor"), {row:11, column:1});

                        this.settingsWnd.add(makeLbl("База:"), {row:12, column:0});
                        ...
                        this.settingsWnd.add(makeLbl("Город:"), {row:14, column:0});
                        ...
                        this.settingsWnd.add(makeLbl("Мой город:"), {row:17, column:0});
                        this.settingsWnd.add(makeTxt("ownBaseColor"), {row:17, column:1});

                        this.settingsWnd.add(makeLbl("ПОИ:"), {row:18, column:0});
                        this.settingsWnd.add(makeTxt("poiColor"), {row:18, column:1});

                        this.settingsWnd.add(makeLbl("Тоннель:"), {row:19, column:0});
                        this.settingsWnd.add(makeTxt("tunnelColor"), {row:19, column:1});

                        var changeColor = new qx.ui.form.Button("Изменить");
                        changeColor.set({
                            appearance : "button-text-small",
                            toolTipText : "Созраняет настройки цветов"
                        });
