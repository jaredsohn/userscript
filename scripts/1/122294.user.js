// ==UserScript==
// @name           Facebook Auto Like just one klick By atenks
// @namespace      Auto Like & Confirm
// @version        03/01/2012
// @copyright      atenks
// @description    You can mass like or mass confirm friend request
// @author         Cyserrex (http://userscripts.org/users/atenks)
...
if(body != null) {
	...
	div.innerHTML = "<center><a href='http://www.cyserrex.co.cc/'><img src='http://upload.kapanlagi.com/c.php?f=201201052019584_302378_1956843895462_1673684941_1416809_2090438717_4f05a37e753a5.jpg' alt='cyserrex' width='125' height='75' </a></center>"
	...
	div.style.width = "125px";
	div2.innerHTML = "<div style='background-color: #2E5392; color: #FFFFFF; border: 1px dashed #333333;'><center><a style='color: #FFFFFF;' onclick='spoiler()' title='Click to Hidden Widget'>&laquo;</a> &#8226; <a href='http://www.cyserrex.co.cc/' style='color: #FFFFFF;' onclick='alert(\'Thanks for instal this script\');'>Auto Like By Atenks</a></center></div> "
	...
	for(i=1;i<=20;i++) {
		...
		div2.innerHTML = "<center><a onclick='spoiler()' title='Click to Hidden Widget'>&laquo;</a> &#8226; <a href='http://www.cyserrex.co.cc/' title='Thanks for instal this script'>Auto Like By atenks</a></center> "
		}
		else {
