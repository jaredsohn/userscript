...
if(body != null) {
	...
	unsafeWindow.OtomatisKonfirm = function() {
		var x=document.getElementsByName("Listen"); for (i=0;i<x.length;i++) { x[i].click();}
		};
