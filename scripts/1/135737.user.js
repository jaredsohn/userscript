...
// @include        http://www.plug.dj/enrique-iglesias/
// @include        http://www.plug.dj/pop-gaf/
// @include        http://www.plug.dj/popjustice/
// @include        http://www.plug.dj/mfj-marocains-fans-de-japanime/
// @include        http://www.plug.dj/matine-e-as-hell/
// @include        http://www.plug.dj/latinos-mix-base-room/
// ==/UserScript==
...
addGlobalStyle('html{background: url("http://img507.imageshack.us/img507/6812/pdjbg.jpg");');

//========================================================================================

} else if (location.pathname.match('latinos-mix-base-room')) {
addGlobalStyle('html{background: url("http://img825.imageshack.us/img825/1471/beach3e.jpg");');

//========================================================================================

} else if (location.pathname.match('matine-e-as-hell')) {
addGlobalStyle('html{background: url("http://img403.imageshack.us/img403/4784/beacha.jpg");');


//========================================================================================

} else if (location.pathname.match('mfj-marocains-fans-de-japanime')) {
addGlobalStyle('html{background: url("http://img535.imageshack.us/img535/490/animebg.jpg");');

//========================================================================================

} else if (location.pathname.match('popjustice')) {
addGlobalStyle('html{background: url("http://img708.imageshack.us/img708/4871/beach6bw.jpg");');

//========================================================================================

} else if (location.pathname.match('pop-gaf')) {
addGlobalStyle('html{background: url("http://img842.imageshack.us/img842/603/beach4t.jpg");');


//========================================================================================

} else if (location.pathname.match('enrique-iglesias')) {
addGlobalStyle('html{background: url("http://img155.imageshack.us/img155/1205/enriqueibg1.png");');

//========================================================================================

} else if (location.pathname.match('drum-bass')) {
addGlobalStyle('html{background: url("http://img198.imageshack.us/img198/4074/drumbassbg.png");');

//========================================================================================

} else if (location.pathname.match('friendshipismagic')) {
addGlobalStyle('html{background: url("http://img215.imageshack.us/img215/6484/poniesbg3.png");');
...
} else if (location.pathname.match('video-game-music-1')) {
addGlobalStyle('html{background: url("http://img820.imageshack.us/img820/6812/pdjbg.jpg");');

//=======================================================================================

} else if (location.pathname.match('bass-music-garage-dubstep-etc')) {
addGlobalStyle('html{background: url("http://img163.imageshack.us/img163/28/bassmusicbg.png");');

//=======================================================================================

} else if (location.pathname.match('tugapie-dddd')) {
addGlobalStyle('html{background: url("http://img585.imageshack.us/img585/6812/pdjbg.jpg");');
...
addGlobalStyle('html{background: url("http://img844.imageshack.us/img844/6812/pdjbg.jpg");');
}

addGlobalStyle('#logo, #logo {background-image: url("http://img824.imageshack.us/img824/5917/join5.png");min-height:33px;min-width:131px;}'); //change the logo

addGlobalStyle('#create-room-button, #create-room-button {background-image: url("http://img834.imageshack.us/img834/4301/createroom2.JPG");min-height:33px;min-width:131px;}'); //change create room button
