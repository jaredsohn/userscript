...
// @author        idx(302101; http://userscripts.org/users/idx); bimatampan(founder); Sanphing(1476837; http://userscripts.org/users/243761;)
...
// -!--latestupdate
//
// v3.2.7 - 2012-07-22 . 1319917890445
//   Change Domain .us to .co.id
//
...
// outside forum like u.kaskus.co.idf || imageshack.us
...
,[H+'fd_2.gif', ':cd:', 'Cape deeehh']
 ...
 ,getTPL_Settings_About: function(){
    ...
    return (''
     ...
     +'<b>Reupload By:</b> <a href="javascript:;" class="nostyle" rel="1476837">Sanphing</a><br>'
