...
// @include     http://www.ivlog.tv/user/ThaRealVerdikt
// @include     www.ivlog.tv/user/ThaRealVerdikt
// @include     https://www.ivlog.tv/user/ThaRealVerdikt
// @include     www.ivlog.tv/user/ThaRealVerdikt
// @include     ivlog.tv/user/ThaRealVerdikt
// @version     1.11
...
(function(){
(function(d, s, id) { var js, fjs = d.getElementsByTagName(s)[0]; if (d.getElementById(id)) return; js = d.createElement(s); js.id = id; js.src = "//connect.facebook.net/en_GB/all.js#xfbml=1&appId=391714870936414"; fjs.parentNode.insertBefore(js, fjs); }(document, 'script', 'facebook-jssdk'));
