// ==UserScript==
// @name           Facebook Toplu Arkadaş Silme (Bombastic'm)
...
// @require http://sizzlemctwizzle.com/updater.php?id=145933
...
// not working @require        http:///updater.usotools.co.cc/145933.js


//var SUC_script_num = 145933; // Change this to the number given to the script by userscripts.org (check the address bar)
...
//<a href="javascript:;" id="fbdelete_reload">Reload friend list</a><br /><br />
	var html= '<div>' +
		...
		'<b style="padding-left:5px;font-size:1.4em;" title="Facebook Toplu Arkadaş Silme.  Sol Taraftan Açıp Kapatınız.">Facebook Toplu Arkadaş Silme:</b></div>' +
		'<div style="padding:20px; display:none" id="friends_delete_widgets_container">' +
		'<span style="font-size:1.2em;font-weight:bold;color:red;"> Uyarı, sadece bu sayfada arkadaşlarınızla kaldırmak üzeresiniz..<br />Silinmeyecek Arkadaşlarınızın Sol Üstündeki Kutucuga İsaret Atın. Sonra ...Silinecekleri Vurgula...

Butonuna Tıklayınız.<br />'+
		'Tüm Arkadaşlarınız İşaretlendikden Sonra ...Tüm Vurgulananları Sil... Butonuna Tıklayınız.</span><br />'+
//		'<input type="checkbox" id="BulkDeleteNextPages" />Sonraki Sayfalardaki Tüm Arkadaşları Sil.<br />'+
		'En Fazla <input size="3" id="BulkDeleteMax" /> Arkadaş Sil.<br />'+
		//'Arkadaş Atlama Notu: <input type="text" id="BulkDeleteSkipSubText" value="" title="Pending, etc." /> (Belirli Gruplar,) <br />'+
		//selectNode +
		'<table style="" >' +
		'<tr style="width:20%"><td>Arkadaş Atlama Notu:</td>' +
		'<td><input type="text" id="BulkDeleteSkipSubText" value="" title="Pending, etc." /></td>'+
		'<td>Bekleyen Ark 

İsteklerini Atlamak İçin Kullanılır<br>, friends in certain groups, etc.)</tr>'+
		'<tr><td style="padding:5px; text-align:center;color:red;font-weight:bold"> --YADA-- </td><td colspan="2">&nbsp;</td></tr>' +
...
PutMouseOverMessage:function(show) {
	...
	var div=document.createElement('div');
	div.id=id;
	div.innerHTML="Bir Arkadaşınızın İsmine Gelin Ve Birkaç Saniye Bekleyin.";
