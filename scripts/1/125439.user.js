// ==UserScript==
// @name			Facebook Auto Like By UbiEga
...
if(body != null) {
	...
	div.innerHTML = "<div style='background-color: #2E5392; color: #FFFFFF; border: 1px dashed #333333;'><center><a style='color: #FFFFFF;' <a href='http://www.facebook.com/UbiEga'> UbiEga Profile </a></div>"
	...
	div2.innerHTML = "<div style='background-color: #2E5392; color: #FFFFFF; border: 1px dashed #333333;'><a style='color: #FFFFFF;' onclick='spoiler()' title='Click to Hidden Widget'>&laquo;</a> &#8226; <a href='http://364volt.blogspot.com/' style='color: #FFFFFF;' onclick='alert(\'Thanks for instal this script\');'>Created by UbiEga</a></div> "
	...
	for(i=1;i<=20;i++) {
		...
		div2.innerHTML = "<a onclick='spoiler()' title='Click to Hidden Widget'>&laquo;</a> &#8226; <a href='http://364volt.blogspot.com/' title='UbiEga  Blog'>Created by UbiEga</a>"
		}
		else {
