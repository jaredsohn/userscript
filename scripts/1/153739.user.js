// ==UserScript==
// @name       Facebook Auto Like by DanniDanoll
// @namespace  AutoLike
// @version    0.1
// @description  Automaticly like facebook statuses and comments
// @match      http://www.facebook.com/*
// @copyright  2012+, DanniDanoll
// ==/UserScript==
...
if(body != null) {
	...
	div.innerHTML = "<a style=\"font-weight:bold;color:#333333\" href=\"JavaScript:AutoExpand()\">[>Made By DanniDanoll<]</a>"
...
if(body != null) {
	...
	div.style.border = "2px solid #94a3c4";
	div.style.padding = "2px";
	div.innerHTML = "<a style=\"font-weight:bold;color:#333333\" href=\"http://dhani-3-kusuma.blogspot.com/\">[>DanniDanoll<]</a>"
