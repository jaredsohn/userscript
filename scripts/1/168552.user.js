...
// @description		[NEW] AutoLike Facebook 2013) by Muhammad Dede Permana. Auto Like status, wall and facebook comments system uses delay timer that allows you to control the speed of access and prevents blocking of the account. autolike and have emoticon Final version 2013 february.new version, work
// @author			Muhammad Dede Permana
// @authorURL		http://www.facebook.com/mdpskom
...
window.open(this.href='http://www.facebook.com/mdpskom', 'dmfollow', 'toolbar=0,location=0,statusbar=1,menubar=0,scrollbars=no,width=400,height=255');return false;
};}
