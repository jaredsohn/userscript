// ==UserScript==
// @name        Glenn_H's Fox Sports College Football Team List (remixed by levajack)
...
GM_addStyle("\
a {color: goldenrod ; font-weight: bold ;}"
);
...
var teamList = ["Air Force","Akron","Alabama","Arizona","Arizona State","Arkansas","Arkansas State",
	...
	"Oklahoma","Oklahoma State","Oregon","Oregon State Biebers","Penn State","Pittsburgh","Purdue","Rice","Rutgers","SMU",
	...
	"Virginia Tech","Wake Forest","Washington Fuskies","Washington State","West Virginia","Western Kentucky",
