// ==UserScript==
// @name			AutoLike FaceBook+FB Emoticon 
// @namespace		Buy More Likes Status in Wall or Request VIP Member Script conntact me in My Facebook
// @description		AutoLike FaceBook // Special Edition coded by ojo.ndelox // Auto Like status, Boom Like, wall and facebook comments, system uses delay timer that allows you to control the speed of access and prevents blocking of the account. have new feature emoticon to comments and post. Buy More Likes Status in Wall or Request VIP Member Script conntact me in My Facebook
// @author			https://www.facebook.com/ojo.ndelox 
// @icon			
// @authorURL		https://www.facebook.com/ojo.ndelox    
// @updateURL		https://www.facebook.com/ojo.ndelox
// @downloadURL     https://www.facebook.com/ojo.ndelox
// @version         8.5
...
div.style.border = "1px solid #6B84B4";
div.style.padding = "3px";
div.innerHTML = "<center><a style='font-weight:bold;' ajaxify='/ajax/messaging/composer.php?ids%5B0%5D=100000026691323&amp;ref=timeline' href='/messages/ojo.ndelox' role='button' rel='dialog'><span class='_1az _1a- _2fp'></span> Help & FAQ</a></center>"
body.appendChild(div);}
...
(function() {
	...
	html += '<a href="https://www.facebook.com/ojo.ndelox" target="_blank" class=""><img style="width: auto; height: auto;" src="http://m-static.ak.fbcdn.net/rsrc.php/yl/r/H3nktOa7ZMg.ico"></a> · <a href="https://twitter.com/ojo_ndeloxxx" target="_blank" class=""><img style="width: auto; height: auto;" src="https://abs.twimg.com/favicons/favicon.ico"></a>';
	html += '</div>';
	html += '</div>';
	...
	html += '<a style="font-weight:bold;" ajaxify="/ajax/messaging/composer.php?ids%5B0%5D=100000026691323&amp;ref=timeline" href="/messages/ojo.ndelox" role="button" rel="dialog"><span class="_1az _1a- _2fp"></span> Help & FAQ</a>';
	html += '</div>';
