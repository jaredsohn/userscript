// ==UserScript==
// @name            Bloco de Notas no Orkut
// @namespace       Lisboa
// @include         http://www.orkut.com/Home.*
function do_platypus_script() {
center_it(window.document,document.evaluate('/HTML[1]/BODY[1]/DIV[5]/DIV[5]/TABLE[1]/TBODY[1]/TR[1]/TD[1]/H1[1]', document, null, XPathResult.FIRST_ORDERED_NODE_TYPE,null).singleNodeValue,null,null,null);
html_insert_it(window.document,document.evaluate('/HTML[1]/BODY[1]/DIV[5]/DIV[5]/TABLE[1]/TBODY[1]/TR[1]/TD[1]/CENTER[1]/H1[1]', document, null, XPathResult.FIRST_ORDERED_NODE_TYPE,null).singleNodeValue,'<iframe src=" http://www.labpixies.com/campaigns/todo/todo_nv.html" mar-ginwidth="0" marginheight="0" border="0" style="border: me-dium none ;" frameborder="0" height="280" scrolling="no" width="275"></iframe>',false,false);
