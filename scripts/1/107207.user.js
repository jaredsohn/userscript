...
// @include     https://bugs/*
// @include     http://bugs/*
// @description Shows attached images. Modifications of Orphu of Io (Bugzilla - Simple Modification) and Nikita Vasilyev (Bugzilla attachments preview 1.0)
...
//    GM_JQ.src = 'http://jqueryjs.googlecode.com/files/jquery-1.3.min.js';
    GM_JQ.src = 'https://code.jquery.com/jquery-latest.min.js';
...
// All your GM code must be inside this function
    function letsJQuery() {
		...
		$('#comment').css({'width':'900px'});//make comments block wider
    ...
    '.lang_current { display: none; }' +
		...
		var $bz_buglist_tr = $(".bz_buglist tbody tr.bz_bugitem"),
			...
			$bz_head_style.append(''+
			'.highlight{ background-color: #BABAFF }'+
			'.hl_selected{ background-color: #fcc }'+
			'.hl_selected_hl{ background-color: #BABAFF }'+
