...
*/
	...
	if (foo2 != null) {
		...
		var hh = t.getHours() + 10 	// Add 2 to convert from Pacific to Central Standard Time or add 10 for GMT+2, change as necessary.
		...
		var tstr =  nf(hh) + ':' + nf(t.getMinutes()) + ':' + nf(t.getSeconds()) + ' ' + ampm + ' GMT +2';  
