...
if(url.search(pattern)==0)
{
	...
	{	
		document.getElementById('MobileNos_').value=9031090310;
...
if(url.search(pattern)==0)
{
	var options="feb 11;grass;vishnu;salt law;cricket;promise;baseball;mouse;yama;punter;politician;pinjore;mandela;cryptonite;surya;morkel;visvamitra;broken;sameera;tweety;rohan bopanna;goa;congress;martyr;dog;sports;aarti;alexander;5;A heart;orissa;subhash chand;hockey;udita;muralitharan;azim premji;red rose;venus;bhima;esha;mumbai;film studios;gujarat;david fincher;cricket;gurdeep kohli;kartikeya;new york;chennai;22 yards";
