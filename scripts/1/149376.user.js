// ==UserScript==
// @name        LoU Suite | The Guardian add
// @namespace   http://userscripts.org/users/123123123123
// @description Glassell's add to Katana's classic Suite.
// @include     about:addons
// @include     Unique to this fix:
// @include     • Guardians now appear in the Send list for raiding Bosses & Dungeons.
// @include     This version is in addition to the 76, SmileyGirl & AL fixes. If you like it, thank the Golden Horde of World 62! - Glassell
// @version     1
// ==/UserScript==
			...
			qx.Class.define("louSuite.main", {
				...
				members: {
					...
					startScript: function() {
						...
						btn.set({width: 30, appearance: "button-text-small", toolTipText: "Kill Bosses"});
...
//           		7: [125000, 138000, 145000, 150000, 165000, 176000, 190000, 200000, 210000, 225000],
					...
					getTroopsNeeded: function (dungeon_name, dungeon_level, dungeon_progress, units) {
						...
						for (var u_key in units) {
							...
							if (unit['count'] > 0) {
								try {
									dungeon_progress = (dungeon_progress - (dungeon_progress % 10) + 10) / 10;
