...
// @description	        Aboolink - Công c? t?i uu d?t hàng trên taobao
...
function taobao(cart_url) {
    ...
    this.htmlOnLoad = function() {
        ...
        var s = '<li class="clearfix" id="gia-tinphat" style="height: 40px; border: 2px solid blue;">' +
			...
			'<span style="font-weight:bold;color: blue;width: 195px; font-size: 24px;line-height:40px;" id="tinphat-price">' + (price_result) + ' VNÐ</span> <div style="float:right;"><a id="id_user_nhaphang_add_cart" target="_blank" href="' + href + '"><img src="' + src + '" alt="" /></a></div></div></div></li>' +
			'';
...
function paipai(cart_url) {
    ...
    this.htmlOnLoad = function() {
        ...
        s += '<div><span style="float:right" id="block_button"><a id="id_nhaphang_add_cart" target="_blank" href="' + href + '"><img src="' + src + '" alt="" /></a></span>&nbsp;<span style="font-weight:bold;color: blue; font-size: 24px;float:left;" id="hangnhap-price">' + (price_result) + ' VNÐ</span> </div>';
