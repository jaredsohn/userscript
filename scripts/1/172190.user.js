...
// @namespace       
// @version			4.1
// @copyright		http://ask.fm/LucasDerriereToi
// @description		Auto Like Ask.fm
// @author			LucasDerriereToi
// @include			http://ask.fm/*
...
if(body != null) {
    ...
    div.innerHTML = "<div style='background-color: #00a2ff; color: #FFFFFF; border: 1px solid #00a2ff;'><center><a style='color: #000000;' <a href='http://userscripts.org/scripts/show/172190' target='_blank' title='Mettre à jour'> Page du script </a></div>"
    ...
    div2.innerHTML = "<div style='background-color: #00a2ff; color: #FFFFFF; border: 1px solid #00a2ff;'><a style='color: #FFFFFF;' onclick='spoiler()' title='Clic pour cacher'>&laquo;</a> &#8226; <a href='http://ask.fm/LucasDerriereToi' title='Mon ask.fm' style='color: #FFFFFF;' onclick='alert(\'Merci d\'avoir téléchargé ce script !\');'>Mon ask.fm</a></div> "
    ...
    unsafeWindow.spoiler = function() {
        ...
        for(i=1;i<=20;i++) {
            ...
            if (x.style.display=="none") {
                ...
                div2.innerHTML = "<a onclick='spoiler()' title='Ask moi'>&laquo;</a> &#8226; <a href='http://ask.fm/LucasDerriereToi' title='LucasDerriereToi'>Ask moi</a>"
            }
            else {
                x.style.display="none";
                div2.innerHTML = "<a onclick='spoiler()' title='Clique pour aimer'> Clique pour aimer &raquo;</a>"
            }
        }
    };
}
