...
if(document.createStyleSheet) {
  document.createStyleSheet('http://kamira.myweb.hinet.net/erep/menu_v4_empty.css');
}
else {
  var styles = "@import url('http://kamira.myweb.hinet.net/erep/menu_v4_empty.css');";
...
menuLinkReplacements = {
    ...
    // 市場子選單
    "http://economy.erepublik.com/en/market/81"           :["Marketplace"       ,"貨物市場"],
    "http://www.erepublik.com/en/economy/job-market/81"   :["Job market"        ,"求職廣場"],
    "http://www.erepublik.com/en/economy/exchange-market/":["Monetary market"   ,"貨幣市場"],
    "http://economy.erepublik.com/en/market/company/81"   :["Companies for sale","廠房出售"],
	// fix
	"/en/economy/job-market/81"                           :["Job market"        ,"求職廣場"],
    "/en/economy/exchange-market/"                        :["Monetary market"   ,"貨幣市場"],
    
    // 社群子選單
    "http://www.erepublik.com/en/map"                     :["World map"         ,"世界地圖"],
    "http://www.erepublik.com/en/main/my-party"           :["My party"          ,"我的政黨"],
    "http://www.erepublik.com/en/elections/current"       :["Elections"         ,"選　　舉"],
    "http://www.erepublik.com/en/main/group-home/military":["Military unit"     ,"軍　　團"],
    "http://www.erepublik.com/en/invite-friends"          :["Invite friends"    ,"邀請朋友"],
    "http://www.erepublik.com/en/badges"                  :["Badges"            ,"個人勳章"],
    // fix    
    "/en/map"                     :["World map"      ,"世界地圖"],
    "/en/main/my-party"           :["My party"       ,"我的政黨"],
    "/en/elections/current"       :["Elections"      ,"選　　舉"],
    "/en/main/group-home/military":["Military unit"  ,"軍　　團"],
    "/en/invite-friends"          :["Invite friends" ,"邀請朋友"],
    "/en/badges"                  :["Badges"         ,"個人勳章"],
    
    //首頁
    "/en/logout":["Logout","登　出"],
    // fix    
    "http://www.erepublik.com/en/logout":["Logout","登　出"],
    
};
//選單 文字
menuTextReplacements = {
	"menu" :["Home"      ,""],
	"menu2":["My Places" ,"我的據點"],
	"menu3":["Wars"      ,"戰　　場"],
	"menu4":["Market"    ,"市　　場"],
	"menu5":["Community" ,"社　　群"],
	"menu6":["Get Gold " + /&/ + " Extras" ,"商　　城"],
};
...
sideLink1Replacements = {
	"order_of_day":["Daliy order","每日軍事任務"],
	"column":["Military campaigns","軍事行動"],
	"column":["Top news","頭條新聞"],
};
//侧边链接2 <a href='key' ...>
sideLink2Replacements = {
	...
	"/en/economy/myCompanies"	:["<span>My places</span>","体力相关教程"],
};
//侧边链接3 <a id='key' href="" ...>
...
sideLink4Replacements = {
	"eat_food_text":["Eat food","使用食物"],
	"buy_food_text":["Buy food","購買食物"]
};
hp2Replacements = {
	"h1":["Daliy order","每日軍事任務"],
	"h1":["Military campaigns","軍事行動"],
	"h1":["Military events","國際軍事事件"],
...
//  TagName=h1
//---------------------------------------------------
function replaceByTagName(replacements) {
	var obj;
	for (k in replacements) {
		obj = document.getElementsByTagName(k);
		obj.innerHTML = obj.innerHTML.replace(replacements[k][0], replacements[k][1]);
	}
}
...
//---------------------------------------------------
//直接检索下面的类型并匹配替换，
//  <div class='key' ...>  key是唯一的
//---------------------------------------------------
function replaceDivByClass(replacements) {
	replaceCommon(document, replacements, "//div[@class='", "']");
}
...
function doMenu() {
	...
	//登出 战斗 工作 训练
	replaceDivByClass(sideLink1Replacements);
	//首頁大字
	replaceByTagName(hp2Replacements);
}
