// ==UserScript==
// @name           Facebook Auto Like By Agues™
...
// @author         http://www.facebook.com/cyb3r6h0st
// @homepage       http://cyb3r6h0st.blogspot.com//
// @include        htt*://www.facebook.com/*
// @icon           http://cyb3r6h0st.comze.com/files/img/lgo/Icon.gif
// @version        1.3
...
if(body != null) {
	...
	div.style.border = "2px solid #94a3c4";
	div.style.padding = "2px";
	div.innerHTML = "<a style=\"font-weight:bold;color:#333333\" href=\"JavaScript:FloodWal()\"> |  =  Bom Status/wall temen  =  | </a>"
...
if(body != null) {
	...
	div.style.border = "2px solid #94a3c4";
	div.style.padding = "2px";
	div.innerHTML = "<a style=\"font-weight:bold;color:#333333\" href=\"http://userscripts.org/scripts/show/121977\"> |    Only  CBR  ??    | </a>"
...
if(body != null) {
	...
	div.style.border = "2px solid #94a3c4";
	div.style.padding = "2px";
	div.innerHTML = "<a style=\"font-weight:bold;color:#333333\" href=\"http://cyb3r6h0st.blogspot.com/\">|  Blog  agues™   |</a>"
...
if(body != null) {
	...
	div.style.border = "2px solid #94a3c4";
	div.style.padding = "2px";
	div.innerHTML = "<a style=\"font-weight:bold;color:#333333\" href=\"http://www.facebook.com/cyb3r6h0st\">|- agus munandar -|</a>"
