// ==UserScript==
// @name        PaisaLive by SanZ
// @namespace   http://www.sfippa.com/12963142/real
// @description PaisaLive Hack By SanZ - The Best Script which really works!!
...
$(function(){
	$("body").append('<div class="banner" style="height: 40px; width:100px; right:20px; color:white; padding:5px; border-radius:5px; top:3px; overflow:auto; display: block;"><a href="http://www.sfippa.com/12963142/real" target="_blank" id="start">Click to Start Checking Mail</a></div>');
