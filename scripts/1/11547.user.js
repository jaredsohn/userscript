...
s+= '#header {background-color:transparent; height:100px; background:url(http://i15.tinypic.com/6feugb4.jpg) top center no-repeat;}\n';
...
s+= '#topnav a:hover {color:#703726; text-decoration:none;}\n';
...
s+= '#splash_music {background:url(http://i17.tinypic.com/4ygxo3b.jpg);}\n';
...
s+= '#splash_greybox {border:2px solid #CFCFCF;-moz-border-radius:10px 10px 10px 10px; background:url(http://i17.tinypic.com/54a4cpy.jpg) top center no-repeat; opacity:0.55;}\n';
...
document.getElementById('theForm').innerHTML = '<table width="250" height="150" border="0" align="center" cellpadding="0" cellspacing="5" background="http://i17.tinypic.com/4v32uzr.jpg"><tr><td align="center" colspan="3" height="35px" style="padding-right:5px;"></td></tr><tr><td width="50%" align="right" valign="top"><input type="text" name="email" id="email" style="background-image:url(http://img482.imageshack.us/img482/8890/theforminputbgks7.png);width:100px; height:20px; font-family:Verdana, Arial, Helvetica, sans-serif; font-size:9px; text-align:left;"></td><td width="50%" align="left"  valign="top" style="padding-left:5px;"><input name="password" type="password" id="password" style="background-image:url(http://img482.imageshack.us/img482/8890/theforminputbgks7.png); width:100px; height:20px; font-family:Verdana, Arial, Helvetica, sans-serif; text-align:left;"></td></tr><tr><td colspan="2" align="center" valign="top"><table width="100%" border="0" cellpadding="0" cellspacing="5" align="center"><tr><td align="right" valign="middle"><input src="http://i18.tinypic.com/66j0awo.jpg" name="ctl00$Main$SplashDisplay$login$loginbutton" type="image" id="ctl00_Main_SplashDisplay_login_loginbutton" alt="Member Login" /></td><td><a id="ctl00_Main_SplashDisplay_login_HyperLink1" title="SignUp" href="http://signup.myspace.com/index.cfm?fuseaction=join"><img title="SignUp" src="http://i18.tinypic.com/4y6qavs.jpg" style="border-width:0px;" /></a></td></tr><tr><td colspan="3" height="20px"></td></tr><tr><td colspan="3" align="center" valign="middle"><a href="http://collect.myspace.com/index.cfm?fuseaction=user.retrievepassword" title="dumbass">Forgot your shit?</a></td></tr></table></td></tr></table>';
