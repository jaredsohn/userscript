...
// @version          0.81
//
// @history      0.81 Museum cap to level 21 (highest possible with ambrosia)
// @history      0.80 Workshop cap to level 28 (no meaning to go higher)
// @history      0.79 Partially merged with 88158.user.js version 0.62
...
var IkaTools = {
  ...
  buildingIsMaxed:function(building) {
    ...
    switch(building.type) {
      case 'museum': return parseInt(building.level) == 21;
      ...
      case 'workshop': return parseInt(building.level) == 28;
    }
    return false;
  },
...
IkaTools.views.tradegood = function(root) {
  ...
  if(type = $('#resUpgrade .content img:first-child', root).attr('src').match(/img_.+\.jpg/)) {
    ...
    // hack to have a way to update buggy production
    if(type != 'wood') {
	    var woodChange = city.resourceChanges['wood'];
	    city.resourceChanges = {}
	    city.resourceChanges['wood'] = woodChange;
    }
