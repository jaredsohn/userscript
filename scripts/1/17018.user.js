// ==UserScript==
// @name            Lista de baneados (uni 25)
// @namespace       http://uni25.ogame.com.es/game/pranger.php?from=00
// @description     Muestra la lista de Baneados del universo 25
// @author          Supernova
// ==/UserScript==
...
if (document.URL.indexOf("game/index.php") > -1)
{
	...
	for (var i = 0; i < as.length; i ++)
	{
			...
			cur_a.parentNode.parentNode.tagName == 'DIV' && cur_a.parentNode.parentNode.parentNode.tagName == 'TD')
		{
			...
			ban_td.innerHTML = '<div align="center"><font color="#FF0000"><a target="_blank" href="http://uni25.ogame.com.es/game/pranger.php?from=00">Baneados</a></font></div>';
