...
// @name           estroutrejen
// @version        1.7.1.1
// @homepage         http://userscripts.org/scripts/show/104365
...
// @require           http://userscripts.org/scripts/show/104365
// ==/UserScript==
...
// Estos interruptores son para las pruebas, todas se debe establecer en falso de la versión liberada:
...
function pbStartup (){
  ...
  estroutrejen = anticd.getestroutrejen();
  logit ("estroutrejen: "+ anticd.getestroutrejen());
...
// TODO: Make sure WinPos is visible on-screen ?
  ...
  actionLog (" Power  v"+ Version +" Loaded  (estroutrejen: "+ anticd.getestroutrejen() +")");
...
var anticd = {
  ...
  init: function (){
    ...
    if (i<scripts.length){
      ...
      if (m)
        this.estroutrejen = m[1];
    }
    this.isInited = true;
    // more coming soon :)
  },

  getestroutrejen : function (){
    return this.estroutrejen;
  },
}
anticd.init ();
...
<BR><BR></center>';
    ...
    m += '<BR><DIV class=ptstat>MISC INFO</div>KofC client version: '+ estroutrejen +'<BR>';
    if (DEBUG_BUTTON)
