// ==UserScript==
// @name            Enhanced Steam Community for Firefox
// @author          onisuly
...
// @downloadURL     http://userscripts.org/scripts/source/174584.user.js
// @updateURL       http://userscripts.org/scripts/source/174584.meta.js
// ==/UserScript==
...
function autoBuy() {
	...
	document.getElementsByClassName("market_dialog_totals_label")[4].style = "font-size:14px;color:#F00;font-weight:bold";
	document.getElementById("market_buynow_dialog_totals_total").style = "font-size:14px;color:#F00;font-weight:bold";
}
		...
		if ( typeof(g_bViewingOwnProfile) != 'undefined' && g_bViewingOwnProfile )
		{
			...
			elViewButton.onclick = function(){
				...
				if( MarketHashName.match(/^(\d+-)?[A-Za-z0-9 \t\r\n\v\f\]\[!"#$%&'()*+,./\\:;<=>?@\^_`{|}~-]+$/) ) {
					window.open("http://steamcommunity.com/market/listings/" + AppID + "/" + MarketHashName);
				}
				else {
