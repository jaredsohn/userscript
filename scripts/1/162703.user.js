...
// @version 		0.60c
// @updateURL           https://userscripts.org/scripts/source/162703.meta.js
// @downloadURL         https://userscripts.org/scripts/source/162703.user.js
// ==/UserScript==
			...
			qx.Class.define("TGCTools.POIWindow", 
			{
				...
				{	
					try
					{
						...
						//Buttons
						var buttonBox = new qx.ui.container.Composite(new qx.ui.layout.HBox(7)).set({allowGrowX: false, allowGrowY: false, alignX: "center"});
