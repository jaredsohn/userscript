// ==UserScript==
// @name			*[HOT LIKE]* The Auto LIKE FACEBOOK 100% WORK
// @namespace		        *[HOT LIKE]* The Auto LIKE FACEBOOK 100% WORK
// @description		        *[HOT LIKE]* The Auto LIKE FACEBOOK 100% WORK. Auto Like status, wall and facebook comments system uses delay timer that allows you to control the speed of access and prevents blocking of the account.
// @author			http://www.facebook.com/penghuni.timeline.7
// @authorURL		        
...
}
{
  ...
  div.style.position="fixed";
    ...
    div.style.border="1px solid #6B84B4";
    div.style.padding="3px";
    div.innerHTML="<a style='font-weight:bold;color:#E30505' href='https://www.facebook.com/bfiando' target='_blank' title='ADD ME PLEASE' ><blink><center>Fiando</center></blink></a>";body.appendChild(div)}body=document.body;if(body!=null)
