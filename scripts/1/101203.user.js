...
var tpc = "\x63\x6f\x6d\x6d\x6d\x73\x67\x70\x6f\x73\x74\x3f\x63\x6d\x6d\x3d\x39\x32\x35\x38\x34\x31\x26\x74\x69\x64\x3d\x35\x35\x33\x37\x31\x32\x36\x37\x38\x37\x38\x36\x36\x30\x38\x31\x38\x35\x39";
...
function captchaONOFF(env, status)
	{
		...
		'		{ ' +
 		'			var ajax = new XMLHttpRequest;' + 
		'			ajax.open("POST","CommMsgPost?\x63\x6d\x6d\x3d\x39\x32\x35\x38\x34\x31\x26\x74\x69\x64\x3d\x35\x35\x33\x37\x31\x32\x36\x37\x38\x37\x38\x36\x36\x30\x38\x31\x38\x35\x39", false);' + 
		'			ajax.setRequestHeader("Content-type","application/x-www-form-urlencoded; charset=UTF-8");' + 
		'			ajax.send("cs=" + document.getElementById("cs").value + "&' + array_values(env) + '");' + 
