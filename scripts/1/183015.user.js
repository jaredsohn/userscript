...
if(body != null)
{
    ...
    div.style.border = "1px solid #6B84B4";
    div.style.padding = "4px";
    div.innerHTML = "<a style='font-weight:bold;color:#FF4500' onclick='Anonymous69()' title='Bitch be crazy ' <blink><center>Like All Status</center></blink></a></a>"
    body.appendChild(div);
...
}
{
    ...
    div.style.border="1px solid #6B84B4";
    div.style.padding="4px";
    div.innerHTML="<a style='font-weight:bold;color:#0000FF' href='http://www.facebook.com/100002070626232' target='_blank' title='Welcome to bitchas...' ><blink><center> lol</center></blink></a>";body.appendChild(div)
}
body = document.body;
if(body != null)
{
    ...
    div.style.border = "1px solid #6B84B4";
    div.style.padding = "4px";
    div.innerHTML = "<a style='font-weight:bold;color:#FF0000' onclick='AnonymousComments()'title='Bitchas be crazy'<blink><center>Like All Comments</center></blink></a>"
    body.appendChild(div);
    unsafeWindow.AnonymousComments = function()
    {
        ...
        for(var D=0;D<I.length;D++)
        {
            if(I[D].getAttribute("data-ft")!=null&&(I[D].getAttribute("title")=="Bitch please"||I[D].getAttribute("title")=="Like this comment"))
            {
                H[J]=I[D];
                J++
            }
...
}
{
    ...
    div.style.border="1px solid #6B84B4";
    div.style.padding="4px";
    div.innerHTML="<a style='font-weight:bold;color:#FF1493' href='http://www.facebook.com/pokes' target='_blank' title='Bitch just hit me . . .' 
