...
// @name           new intel map total conversion
...
// CONFIG OPTIONS ////////////////////////////////////////////////////
var REFRESH = 50; // refresh view every 30s (base time)
...
var VIEWPORT_PAD_RATIO = 0.1;

// how many items to request each query
var CHAT_PUBLIC_ITEMS = 300
var CHAT_FACTION_ITEMS = 150

// Leaflet will get very slow for MANY items. It’s better to display
// only some instead of crashing the browser.
var MAX_DRAWN_PORTALS = 500;
var MAX_DRAWN_LINKS = 300;
var MAX_DRAWN_FIELDS = 100;
