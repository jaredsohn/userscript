...
function installHandlerFunctions() {
    ...
    var renderPanel2 = function(v1, v2) {
        ...
        if (upgradeData.removeTokens) {
            ...
            $("#buffDropDown option").each( function() {
...
Tabs.organizer = {
        ...
        init : function (div){
            ...
            m += "<tr align=center valign=top><th width=14%>Chairs</th><th width=14%>Tables</th><th width=14%>Windows</th><th width=14%>Banners</th><th width=14%>Advisors</th><th width=14%>Throphies</th><th width=14%>Candelabra</th><th width=14%>Heroes</th></tr>";
            m += '</table></div>';
            m += '</div>';
            m += '</div>';
        ...
        showNext : function () {
            ...
            else if ( (X.level + bump) > maxTrLevel)
            {
                bump =  maTrLevel - X.level;
            }
