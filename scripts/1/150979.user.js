...
// @version    1.2
// @description  Adds usefull features w/o changes to cart
...
(function(){
    ...
    $(function(){
        ...
        mifi = mifi?mifi:0;
        usb = usb?usb:0;
        var cur = total-usb-mifi;
        counts[0] = counts[0] - mifi - usb;
        ...
        links.append(hr);//.append(ps);//.append(cp);
        $('#Model').after(links);
    });
})();