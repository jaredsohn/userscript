// ==UserScript==
// @name           emo
// @namespace      http://www.facebook.com/tuancom19931
// @description    Duoc Su dung Yahoo Messenger Emoticons and Voz emoticon,Vo lam emoticon  cho cac mang xa hoi Facebook, Twitter, Youtube... Thanks to VOZ Forums and dinhkhanh_dk
// @include        *
// @version        2.0.1.1
// ==/UserScript==
...
.replace(/\:neptune\:/g, "<style> .md img { display:inline; } .rageface { visibility:visible; } </style><img src=\'http://up.ssc.vn/images/765nep.jpg\' title=\'neptune\' />")
