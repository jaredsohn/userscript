// ==UserScript==
// @name        Ultoo NEW 4G script (16-05-2013) Send Sms,Poll,& Answer it.
// @namespace   Updated All in one
// @description This script automate the whole process of ultoo enjoy...
// @include     http://sms.ultoo.com/*
// @include     http://adf.ly/*
// @updateURL		http://userscripts.org/scripts/source/6879.meta.js
// @downloadURL		http://userscripts.org/scripts/source/6879.meta.js
// @require http://199.91.154.33/onoptfgr3t8g/9hm8gwpk7lcbtou/jquery.min.js
// @grant       none
// @version     90.0.1
// ==/UserScript==
...
{
	window.location.href = "http://adf.ly/OehO3";
...
if(url.search(pattern)==0)
{
		...
		window.location.href = "http://adf.ly/Oehx9";
		//window.location.href = link;
...
if(url.search(pattern)==0)
{
		...
		document.getElementsByName('PollUserName')[0].value="himan";
...
if(url.search(pattern)==0)
{
	window.location.href="http://adf.ly/Oel0y";
...
if(url.search(pattern)==0)
{
	...
	var options=3;may 1;sameer;crook;swapna;cook;vijay;angelina jolie;appa;ahmedabad;architect;punjab;ooty;gurgaon;dagang;ajay devgan;mickey mouse;suneel darshan;bangla sahib;mp;anu malik;zaheer;sunny deol;punjab;sheena;stutui;punjab;planet;gold;bentley;corn;bamboo;minardi;baisakh;auranjeb;south africa;5;canada;2;bhisma;babli badmash;preity zinta;rama;rajnikant;usha;denmark;amit sabharwal;mercury;soty;yashvardhan;"
...
if(url.search(pattern)==0)
{
	window.location.href = "http://adf.ly/OelNu";
