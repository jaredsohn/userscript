...
var acpl = {
    searchURL: 'http://webcat.acpl.lib.in.us/uhtbin/cgisirsi/x/x/0/5?library=ALL&user_id=catalog&srchfield1=GENERAL^SUBJECT^GENERAL^^words+or+phrase&submit=Find+It+!&searchdata1=',
...
var libraryLookup = {
    ...
    insertLink: function(node, hrefTitle, aLabel, url ) {
        ...
        link.setAttribute('style', 'font-weight: bold; color: #00e;');
            ...
            onload:function(results)
                ...
                if ( liby.availableStr.test(page) )
                    ...
                    libraryLookup.insertLink (
                      node,
                      "On the shelf now!",
                      "Not available " + liby.libraryName,
                      liby.searchURL+isbn
                       );
                    }
                }
...
libraryLookup.doLookup(isbn, acpl, origTitle);
