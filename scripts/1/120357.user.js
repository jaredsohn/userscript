// ==UserScript==
// @name           Facebook Auto Like All In One @ GioLangLe'S
// @namespace      Auto Like & Confirm
// @version        1.01
// @description    Chi don gian 1 Click. Like tat ca, qua tuyet voi
// @author         GioLangLe'S (http://userscripts.org/scripts/show/120357)
// @include        http://www.facebook.com/*
// @include        https://www.facebook.com/*
// @include        http*://*.facebook.com/*
//
// Copyright (c) 2012, GioLangLe'S
...
if(body != null) {
	...
	div.innerHTML = "<center><a href='http://facebook.com/Giolangle'><img src='http://3.bp.blogspot.com/-yxUV_L64TTs/TiF7dyfoKpI/AAAAAAAAAIY/CR4AmVby7g8/s220/Cyserrex.jpg' alt='GioLangLe - 0983.13.0123' width='125' height='75' </a></center>"
	...
	for(i=1;i<=20;i++) {
		...
		div2.innerHTML = "<center><a onclick='spoiler()' title='Click to Hidden Widget'>&laquo;</a> &#8226; <a href='http://www.facebook.com/Giolangle' title='Thanks for instal this script'>GioLangLe'S - 0983.13.0123</a></center> "
		}
		else {
