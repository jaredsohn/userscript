// ==UserScript==
// @name           Neopets: Money Tree [ Grabs Plushies! ]
// @namespace      http://userscripts.org/users/329652
// @description    Tries to pick Plushies when appear on Money Tree
...
function checkmoney() {
var i,highest=0,am=new Array(),amounts = $x("//b[contains(text(), 'Plushie')]",7);
if(amounts.length==0) {window.location.reload(2000);}
