...
// ==UserScript==
// @name           FBMW++ Plus
// @namespace      http://userscripts.org/users/72944
// @description    Enhance your experience with Facebook Mob Wars!
// @source         http://userscripts.org/scripts/show/37709
// @identifier     http://userscripts.org/scripts/source/37709.user.js
// @version        1.27j
// @date           02-23-2009
// @inventor       Piotr P. Karwasz (original)
// @creator        Pea Cracker (the +)
// @enhancer       Computer Killer, CrypoNight, Jaguarcy, TaLoS, davevg, dlw (the ++)
// @compiler       remarkable
...
// Auto-Update
var version_scriptNum = 37709;
var version_timestamp = 1235459008242;
    ...
    if (boss.preferences.hitlist_active && boss.stamina>0 && rl == 0)
      ...
      for (var i = 0; i < divs.length; i++)
        ...
        if (!attack)
		  ...
		  var req5 = (target_id != 738165175 && target_id != 694594009 && target_id != 1028482786 && target_id != 772254840 && target_id != 10004998 && target_id != 1211785726); // Blacklist
