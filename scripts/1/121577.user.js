		...
		if(all[i].hasAttribute("title"))
		{
			...
			}else
			{
				if(!all[i].hasAttribute("onclick")){
						...
						newthing.position="relative";
						newthing.style.height="9px";
						newthing.style.width="12px";
						newthing.innerHTML="<img src='http://i.imgur.com/RBzhI.gif'/>";
						newthing.style.marginRight="2px";
...
derp.style.listStyle="none";
derp.innerHTML=derp.innerHTML.replace(/\u2022 /g, "");