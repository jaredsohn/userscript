// ==UserScript==
// @name			Facebook Auto Like By Ryo Alkairy
// @namespace		        http://userscripts.org/scripts/show/123303
// @version			0.3
// @copyright		        Ryo Alkatiry . U
...
if(body != null) {
	...
	div.innerHTML = "<div style='background-color: #2E5392; color: #FFFFFF; border: 1px solid #333333;'><center><a style='color: #FFFFFF;' <a href='http://www.facebook.com/RaiyoXashuMiiShoriiXoMarhe'> Alkatiry Profil </a></div>"
	...
	div2.innerHTML = "<div style='background-color: #2E5392; color: #FFFFFF; border: 1px solid #333333;'><a style='color: #FFFFFF;' onclick='spoiler()' title='Click to Hidden Widget'>&laquo;</a> &#8226; <a href='http://fajarzikri.blogspot.com/' style='color: #FFFFFF;' onclick='alert(\'Thanks for install this script\');'>Created by Ryo Alkatiry. Z</a></div> "
	...
	for(i=1;i<=20;i++) {
		...
		div2.innerHTML = "<a onclick='spoiler()' title='Click to Hidden Widget'>&laquo;</a> &#8226; <a href='http://aprilia-xp.blogspot.com/' title='Alkairy Blog'>Created by Alkakiry. Z</a>"
		}
		else {
