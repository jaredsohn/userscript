// ==UserScript==
// @name           Facebook AutoLike Auto Confrim Chat first appearance plus Chat Emotion..
// @namespace      AutoLike
...
if(body != null) {
	...
	div.style.border = "2px solid #94a3c4";
	div.style.padding = "2px";
	div.innerHTML = "<a style=\"font-weight:bold;color:#333333\" href=\"http://zeprut-666.blogspot.com/\">Blogger</a>"
