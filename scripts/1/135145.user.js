// ==UserScript==
// @name            Monster World Link Clicker - English Version
// @namespace       Monster World Link Clicker - English Version
// @description     Automatically Opens Monster World Links
// @include         http://monster-world-links.blogspot.*/*
...
var txt = {
      de: {
          ...
          options: {
            options:              'Options',
            windowpos:            'Position',
            usewindows:           'Simultaneous Requests',
            delay:                'Wait after Link-Click',
            delayLike:            'Wait after "I like"',
            writeemail:           'Write e-mail',
            lkuserscripts:        'Link Clicker in UserScripts.org',
            language:             'Language',
            dbmax:                'Stop DB-mode after',
            stopafterlimreach:    'Stop after reach Daily Limit'
          },
          tag: {
            windowpos:            '"Position of the menu on-screen. Zero is upper right corner."',
            usewindows:           '"Amount of simultaneous requests to the server"',
          ...
          error: {
            ...
            cantfindkey:          'Signed_request-Key not found - logged in Facebook??',
          ...
          message: {
            message102:           'Links from server received - Starting processing.',
          ...
          prompt: {
            imonfb:               'You try to start Clicker outside of Facebook. Ensure that you are logged in in Facebook.\nContinue?',
