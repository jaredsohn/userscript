// ==UserScript==
// @author   	 MC46
// @name        T4L-Damage Report By MC46
// @version		1.4.1
// @uso:version 1.4.1
// @include		http://*erepublik.com/*/military/battlefield/*
// @description     Script per reportare il danno etc... solo per la MU T4L.
...
if(window.location.href.indexOf(PAGE_BATTLEFIELD) > 0) {    
    ...
    /***********************************************************************************/
    var FORM_URL = "https://docs.google.com/spreadsheet/viewform?formkey=dHRFYnUxbk50R000dnoydWhMa2JKS3c6MQ#gid=0";
    ...
    var LOCALE = {
		en: function() {
			return {
				locale: "en_US",
				no_damage: "Devi fare almeno 1 di danno prima di mandare un report.",
				send_report: "Vuoi inviare un re'?",
				button_send: "Invia report",
				round_end: "Il round è finito, inviare report?",
				damage: "Danno",
				report: "Report",
				report_title: "Invia report",
				report_failed: "Errore sconosciuto.Riprovare più tardi"
			};
   	 }
    };
    ...
    (function() { // Update form fields
   	 if(FORM_URL.startsWith("https://docs.google.com/")) {
   		 ...
   		 FORM_URL = "https://docs.google.com/spreadsheet/formResponse?formkey=" + formKey + "&ifq";
   	 }
    })();
