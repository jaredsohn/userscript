// ==UserScript==
// @name Addon 2
// @include http://userscripts.org/scripts/source/107179.meta.js*
...
var scriptAppInfo = 
{
    ...
    appUrl: 'http://userscripts.org/scripts/show/107179',
    appMeta: 'http://userscripts.org/scripts/source/107179.meta.js',
...
function modMenu()
{
    ...
    var menuOptions = [
        ...
        {name:'Assassin-a-Nator <img src="http://img30.imageshack.us/img30/9505/stamina.png" height=14 />',          'click': AssassinANator                                    },
        {name:'Robber BG Beta <img src="http://img30.imageshack.us/img30/9505/stamina.png" height=14 />',          'click': RobberBGBeta                                    },
        {name:'RepeatJob Beta (Loader) <img src="http://img18.imageshack.us/img18/1452/energyc.png" height=14 />',          'click': RepeatJobBetaLoader                                    },
        {name:'Quick Healer <img src="http://img231.imageshack.us/img231/4852/healthm.png" height=14 />',          'click': QuickHealer                                    },
        ...
        {name:'My Links',                 'click': UserLinks                                        },
       		{name:'<center><img src="https://www.paypal.com/en_US/i/btn/btn_donate_SM.gif" /></center>',        'click': MWMPaypalDonateButton,       'main': true               },
		{name:'<center><FONT COLOR="#FF0000">Mafia Wars Maniac - <br><font size=4>Email Bonus</font></FONT></center>',         'click': MWMEmailBonus, 'timer':'MWMEmailBonus',  'main': true 			},
		{name:'<center><FONT COLOR="#FF0000">Mafia Wars Maniac - <br><font size=4>Lucky Stash Bonus</font></FONT></center>',         'click': MWMLuckyStashBonus, 'timer':'MWMLuckyStashBonus',  'main': true 			},
		{name:'<center><FONT COLOR="#FF0000">Mafia Wars Maniac - <br><font size=4>Toolbar Bonus</font></FONT></center>',         'click': MWMToolbarBonus, 'timer':'MWMToolbarBonus',  'main': true 			},
		{name:'<center><FONT COLOR="#FF0000">Mafia Wars Maniac - <br><font size=4>Atlantic City Bonus</font></FONT></center>',         'click': MWMAtlanticCityBonus, 'timer':'MWMAtlanticCityBonus',  'main': true 			},
		{name:'<FONT COLOR="#FFFF00">Mafia Wars Maniac:</FONT> <FONT COLOR="#00FF00">Blog</B></FONT>',       'click': MWMBlog,                                       },
		{name:'<FONT COLOR="#FFFF00">Mafia Wars Maniac:</FONT> <FONT COLOR="#00FF00">Facebook</FONT> <br><center><img src="http://img171.imageshack.us/img171/3006/mwmmodoptions.png" height=170 /></center>    ',   'click': MWMFBPage,       'main': true               },
    ];
    ...
    var menuEnter = function() {
        ...
        if (menu.timer) {
	        ...
	        if (nTime) {
	            $(this).attr('title', 'You run this option ' +Util.toDateString(nNow - nTime)+' ago.');
	        }
        }
...
unsafeWindow.open ("http://adf.ly/2K2im"," MWM Atlantic City Bonus","menubar=1,resizable=1,width=550,height=450");
}
function MWMBlog() {
unsafeWindow.open('http://mafia-wars-maniac.blogspot.com/');
}
function MWMFBPage() {
unsafeWindow.open('http://www.facebook.com/MWMBlog/');
}
function MWMEmailBonus() {
unsafeWindow.open('http://adf.ly/2JFur');
}
function MWMLuckyStashBonus() {
unsafeWindow.open('http://adf.ly/2JFvt');
}
function MWMToolbarBonus() {
unsafeWindow.open('http://adf.ly/2L2TW');
unsafeWindow.open('http://adf.ly/2L2WD');
}
function MWMAtlanticCityBonus() {
unsafeWindow.open ("http://adf.ly/2K2im"," MWM Atlantic City Bonus","menubar=1,resizable=1,width=550,height=450");
}
...
unsafeWindow.open('https://www.paypal.com/cgi-bin/webscr?cmd=_donations&business=MafiaWarsManiac%40hotmail%2esg&lc=US&item_name=Mafia%20Wars%20Maniac&no_note=0&currency_code=USD&bn=PP%2dDonationsBF%3abtn_donate_SM%2egif%3aNonHostedGuest');
}
...
function Battlefieldv2() 
{
     ...
     * @return {CSIce}
     */
    var CSIce2 = function(fight_result) {
		this.count  = fight_result.total_ice_count;
		
		fightStats.ices_so_far = fight_result.ices_so_far;
		fightStats.ices_target = fight_result.ices_target;
		fightStats.ices_total = fight_result.total_ice_count;
    ...
    function genMainDom() {
        ...
        */
        ...
        $.each([
            ...
            {name:'Total Eliminated:',  cls:'stat_kill',           id:'total_ices'                         },
            {name:'Stolen Ices:',       res:'thief_icon',          id:'stolenices'                         },
            {name:'Revenge:',           cls:'attack',              id:'revenges'                           },
            {name:'Ice Season Count:',        cls:'stamina',             id:['ices_target','ices_so_far']        },
			{name:'Total Ice Count:',        cls:'stamina',             id:'ices_total'                         },
    ...
    function travelTo(toCity, callback) {
        ...
        MW.travel(toCity, function(city) {
            if ((CurrentCity = parseInt(city)) === parseInt(toCity)) {
                ...
                statusTimer.start('Unexpected city, taveling to '+ global.cities[toCity] + ' in %N% seconds.', 3, tryAgain);
            }
        });
    }
    /**
    ...
    function showIcedOverlays(fight_data, opp, first_attack) {
        ...
        if( fight_data.show_ice_season ) {
            ...
            $('.fv2_defender_overlay_next_count', popupElt.content).html(fight_data.ices_target + '/' + fight_data.ices_so_far);
        } else {
...
(function(){
	...
	function addVersionText() {
	    ...
	    if (canvas_iframe !== null) {
            ...
            '<a href="'+ scriptAppInfo.appUrl + '">Check For Updates</a>' + '&nbsp;|&nbsp;' +
