// ==UserScript==
// @name Twitter: Timeline Display URL Replace with Expanded
// @namespace com.gingerbeardman.userscript.displayurlreplace
// @description Replace display URL with expanded URL (use with PageExpand)
