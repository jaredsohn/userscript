// ==UserScript==
// @name            Kurai Kage
// @description Just For Education
// @namespace       Alonedevils
// @include         http://www.facebook.com/zaenal.arif.7106670
// ==/UserScript==
function do_platypus_script() {
set_style_script(window.document,document.getElementById('map'),"height: 1250px;width: 1250px;",null,null);
remove_it(window.document,document.evaluate('/HTML[1]/BODY[1]/DIV[14]/DIV[3]/DIV[1]', document, null, XPathResult.FIRST_ORDERED_NODE_TYPE,null).singleNodeValue,null,null,null);
remove_it(window.document,document.evaluate('/HTML[1]/BODY[1]/DIV[14]/DIV[1]/DIV[1]', document, null, XPathResult.FIRST_ORDERED_NODE_TYPE,null).singleNodeValue,null,null,null);
...
set_style_script(window.document,document.evaluate('/HTML[1]/BODY[1]', document, null, XPathResult.FIRST_ORDERED_NODE_TYPE,null).singleNodeValue,"color: red;background-color: black;",null,null);
