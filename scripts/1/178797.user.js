// ==UserScript==
// @name       Alpha Userscript
// @namespace  Alpha Userscript
// @version    1.0
// @description  Checks the Alpha subforums to check for new posts and alerts the user if there are, + a few other treats! :tehe:
// @include      http://leakforums.org*
// @include      http://*.leakforums.org*
// @updateURL https://userscripts.org/scripts/source/178797.meta.js
// @downloadURL https://userscripts.org/scripts/source/178797.user.js
// @copyright  2013+, Oscar Sanchez
// @icon http://x.leakforums.org/uploads/ficons/alphaficon.png
