...
function letsJQuery()
{
    $(document).ready(function () {
        ...
        var transferBaiduData = function(id,lng,lat,status){
           ...
           if((n_lng == '105' || n_lng == '106' || n_lng == '107'|| n_lng == '108'|| n_lng == '109' || n_lng == '0') & (n_lat == '29'|| n_lat == '30'|| n_lat == '31'|| n_lat == '0')){
        ...
        function getLocalData(){
            $.getJSON("http://10.207.0.240/jsapi.php?type=getshop&city=chongqing&callback=?",function(data){
                    var data = eval(data);
