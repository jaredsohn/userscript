...
// @name AntiADs
// @author phanil
// @description modified by phanil from https://code.google.com/p/haoutil/
// @version 0.0.1
// @namespace http://userscripts.org/users/phanil
// @updateURL https://userscripts.org/scripts/source/xxxxxx.meta.js
// @downloadURL https://userscripts.org/scripts/source/xxxxxx.user.js
// @include http://*/*
// @include https://*/*
...
(function() {
    ...
    YoukuAntiAds.prototype = {
        ...
        get players() {
            if(!this._players) {
                this._players = {
                    'youku_loader': 'http://avad.qiniudn.com/trunk/youku/loader.swf', 
                    'youku_player': 'http://avad.qiniudn.com/trunk/youku/player.swf',
                    'ku6': 'http://avad.qiniudn.com/trunk/player/ku6.swf',
                    'ku6_out': 'http://avad.qiniudn.com/trunk/player/ku6_out.swf',
                    'iqiyi': 'http://avad.qiniudn.com/trunk/player/testmod/iqiyi.swf',
                    'iqiyi5': 'http://avad.qiniudn.com/trunk/player/testmod/iqiyi5.swf',
                    'iqiyi_out': 'http://avad.qiniudn.com/trunk/player/testmod/iqiyi_out.swf',
                    'tudou': 'http://avad.qiniudn.com/trunk/player/testmod/tudou.swf',
                    'tudou_olc': 'http://avad.qiniudn.com/trunk/player/testmod/olc_8.swf',
                    'tudou_sp': 'http://avad.qiniudn.com/trunk/player/testmod/sp.swf',
                    'letv': 'http://avad.qiniudn.com/trunk/player/testmod/letv.swf'
                };
            }
        ...
        initPreHandlers: function() {
            ...
            this.rules['tudou_out']['preHandle'] = function(elem, find, replace, player) {
                ...
                GM_xmlhttpRequest({
                    ...
                    url: isFx ? player : 'https://query.yahooapis.com/v1/public/yql?format=json&q=' + encodeURIComponent('use"http://avad.qiniudn.com/trunk/firefox/tudou_redirect.yql.xml" as tudou; select * from tudou where url="' + player + '" and referer="' + window.location.href + '"'),
