...
'</div>'+
	...
	function assignCSS(){
		...
		".capcay_div{padding-right:5px; padding-top:45px;}"+
		...
		".timer{font-family:impact; color:#457BB7; text-align:right; padding-right:10px; padding-top:13px;}"	
		);
	}
	...
	function setSiggy4(siggy){
		localStorage.setItem("QR_siggy4",siggy);
	}
	function getSiggy4(){
		return localStorage.getItem("QR_siggy4");
	}
	function setSiggy5(siggy){
		localStorage.setItem("QR_siggy5",siggy);
	}
	function getSiggy5(){
		return localStorage.getItem("QR_siggy5");
	}
	function setSiggy6(siggy){
		localStorage.setItem("QR_siggy6",siggy);
	}
	function getSiggy6(){
		return localStorage.getItem("QR_siggy6");
	}
	function setSiggy7(siggy){
		localStorage.setItem("QR_siggy7",siggy);
	}
	function getSiggy7(){
		return localStorage.getItem("QR_siggy7");
	}
	function setSiggy8(siggy){
		localStorage.setItem("QR_siggy8",siggy);
	}
	function getSiggy8(){
		return localStorage.getItem("QR_siggy8");
	}
	function setSiggy9(siggy){
		localStorage.setItem("QR_siggy9",siggy);
	}
	function getSiggy9(){
		return localStorage.getItem("QR_siggy9");
	}
	function setSiggy10(siggy){
		localStorage.setItem("QR_siggy10",siggy);
	}
	function getSiggy10(){
		return localStorage.getItem("QR_siggy10");
	}
	function setSiggy11(siggy){
		localStorage.setItem("QR_siggy11",siggy);
	}
	function getSiggy11(){
		return localStorage.getItem("QR_siggy11");
	}
	function setSiggy12(siggy){
		localStorage.setItem("QR_siggy12",siggy);
	}
	function getSiggy12(){
		return localStorage.getItem("QR_siggy12");
	}
	function setSiggy13(siggy){
		localStorage.setItem("QR_siggy13",siggy);
	}
	function getSiggy13(){
		return localStorage.getItem("QR_siggy13");
	}
	function setSiggy14(siggy){
		localStorage.setItem("QR_siggy14",siggy);
	}
	function getSiggy14(){
		return localStorage.getItem("QR_siggy14");
	}
	function setSiggy15(siggy){
		localStorage.setItem("QR_siggy15",siggy);
	}
	function getSiggy15(){
		return localStorage.getItem("QR_siggy15");
	}
	function setSiggy16(siggy){
		localStorage.setItem("QR_siggy16",siggy);
	}
	function getSiggy16(){
		return localStorage.getItem("QR_siggy16");
	}
	function setSiggy17(siggy){
		localStorage.setItem("QR_siggy17",siggy);
	}
	function getSiggy17(){
		return localStorage.getItem("QR_siggy17");
	}
	function setSiggy18(siggy){
		localStorage.setItem("QR_siggy18",siggy);
	}
	function getSiggy18(){
		return localStorage.getItem("QR_siggy18");
	}
	function setSiggy19(siggy){
		localStorage.setItem("QR_siggy19",siggy);
	}
	function getSiggy19(){
		return localStorage.getItem("QR_siggy19");
	}
	function setSiggy20(siggy){
		localStorage.setItem("QR_siggy20",siggy);
	}
	function getSiggy20(){
		return localStorage.getItem("QR_siggy20");
	}
	...
	function Mainkan(){
		//############### variable stup #######################
		var DEFAULT_SIGGY = '[size="1"][FONT="Georgia"][color=blue][RIGHT]Posted with [color=orange]kaskusBetaQR[/color][/color][/RIGHT][/FONT][/size]';
		var temp_siggy = "\n";
		var use_siggy = "1";
		var siggy1 = DEFAULT_SIGGY;
		var siggy2 = DEFAULT_SIGGY;
		var siggy3 = DEFAULT_SIGGY;
		var siggy4 = DEFAULT_SIGGY;
		var siggy5 = DEFAULT_SIGGY;
		var siggy6 = DEFAULT_SIGGY;
		var siggy7 = DEFAULT_SIGGY;
		var siggy8 = DEFAULT_SIGGY;
		var siggy9 = DEFAULT_SIGGY;
		var siggy10 = DEFAULT_SIGGY;
		var siggy11 = DEFAULT_SIGGY;
		var siggy12 = DEFAULT_SIGGY;
		var siggy13 = DEFAULT_SIGGY;
		var siggy14 = DEFAULT_SIGGY;
		var siggy15 = DEFAULT_SIGGY;
		var siggy16 = DEFAULT_SIGGY;
		var siggy17 = DEFAULT_SIGGY;
		var siggy18 = DEFAULT_SIGGY;
		var siggy19 = DEFAULT_SIGGY;
		var siggy20 = DEFAULT_SIGGY;
		var lastTimePost = 0;
		//############### local storage setup #################
		...
		if((getSiggy4()==null)||(getSiggy4()=="")){
			setSiggy4(siggy4);
		}
		if((getSiggy5()==null)||(getSiggy5()=="")){
			setSiggy5(siggy5);
		}
		if((getSiggy6()==null)||(getSiggy6()=="")){
			setSiggy6(siggy6);
		}
		if((getSiggy7()==null)||(getSiggy7()=="")){
			setSiggy7(siggy7);
		}
		if((getSiggy8()==null)||(getSiggy8()=="")){
			setSiggy8(siggy8);
		}
		if((getSiggy9()==null)||(getSiggy9()=="")){
			setSiggy9(siggy9);
		}
		if((getSiggy10()==null)||(getSiggy10()=="")){
			setSiggy10(siggy10);
		}
		if((getSiggy11()==null)||(getSiggy11()=="")){
			setSiggy11(siggy11);
		}
		if((getSiggy12()==null)||(getSiggy12()=="")){
			setSiggy12(siggy12);
		}
		if((getSiggy13()==null)||(getSiggy13()=="")){
			setSiggy13(siggy13);
		}
		if((getSiggy14()==null)||(getSiggy14()=="")){
			setSiggy14(siggy14);
		}
		if((getSiggy15()==null)||(getSiggy15()=="")){
			setSiggy15(siggy15);
		}
		if((getSiggy16()==null)||(getSiggy16()=="")){
			setSiggy16(siggy16);
		}
		if((getSiggy17()==null)||(getSiggy17()=="")){
			setSiggy17(siggy17);
		}
		if((getSiggy18()==null)||(getSiggy18()=="")){
			setSiggy18(siggy18);
		}
		if((getSiggy19()==null)||(getSiggy19()=="")){
			setSiggy19(siggy19);
		}
		if((getSiggy20()==null)||(getSiggy20()=="")){
			setSiggy20(siggy20);
		}
		//################# Post Timer Setup ##################
		...
		$("#sig4").click(function(){
			setUseSiggy(4);
			setTempSiggy(getSiggy4());
			updateSiggyContent();
			$("#btnEditSiggy").show();
		})
		$("#sig5").click(function(){
			setUseSiggy(5);
			setTempSiggy(getSiggy5());
			updateSiggyContent();
			$("#btnEditSiggy").show();
		})
		$("#sig6").click(function(){
			setUseSiggy(6);
			setTempSiggy(getSiggy6());
			updateSiggyContent();
			$("#btnEditSiggy").show();
		})
		$("#sig7").click(function(){
			setUseSiggy(7);
			setTempSiggy(getSiggy7());
			updateSiggyContent();
			$("#btnEditSiggy").show();
		})
		$("#sig8").click(function(){
			setUseSiggy(8);
			setTempSiggy(getSiggy8());
			updateSiggyContent();
			$("#btnEditSiggy").show();
		})
		$("#sig9").click(function(){
			setUseSiggy(9);
			setTempSiggy(getSiggy9());
			updateSiggyContent();
			$("#btnEditSiggy").show();
		})
		$("#sig10").click(function(){
			setUseSiggy(10);
			setTempSiggy(getSiggy10());
			updateSiggyContent();
			$("#btnEditSiggy").show();
		})
		$("#sig11").click(function(){
			setUseSiggy(11);
			setTempSiggy(getSiggy11());
			updateSiggyContent();
			$("#btnEditSiggy").show();
		})
		$("#sig12").click(function(){
			setUseSiggy(12);
			setTempSiggy(getSiggy12());
			updateSiggyContent();
			$("#btnEditSiggy").show();
		})
		$("#sig13").click(function(){
			setUseSiggy(13);
			setTempSiggy(getSiggy13());
			updateSiggyContent();
			$("#btnEditSiggy").show();
		})
		$("#sig14").click(function(){
			setUseSiggy(14);
			setTempSiggy(getSiggy14());
			updateSiggyContent();
			$("#btnEditSiggy").show();
		})
		$("#sig15").click(function(){
			setUseSiggy(15);
			setTempSiggy(getSiggy15());
			updateSiggyContent();
			$("#btnEditSiggy").show();
		})
		$("#sig16").click(function(){
			setUseSiggy(16);
			setTempSiggy(getSiggy16());
			updateSiggyContent();
			$("#btnEditSiggy").show();
		})
		$("#sig17").click(function(){
			setUseSiggy(17);
			setTempSiggy(getSiggy17());
			updateSiggyContent();
			$("#btnEditSiggy").show();
		})
		$("#sig18").click(function(){
			setUseSiggy(18);
			setTempSiggy(getSiggy18());
			updateSiggyContent();
			$("#btnEditSiggy").show();
		})
		$("#sig19").click(function(){
			setUseSiggy(19);
			setTempSiggy(getSiggy19());
			updateSiggyContent();
			$("#btnEditSiggy").show();
		})
		$("#sig20").click(function(){
			setUseSiggy(20);
			setTempSiggy(getSiggy20());
			updateSiggyContent();
			$("#btnEditSiggy").show();
		})
