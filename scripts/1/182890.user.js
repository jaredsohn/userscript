...
// @match         http://hentaiverse.org/?s=Bazaar&ss=lt&lottery*
// @match		  http://alt.hentaiverse.org/?s=Bazaar&ss=es*
// @match		  http://alt.hentaiverse.org/?s=Character&ss=eq*
// @match		  http://alt.hentaiverse.org/pages/showequip.php?eid=*&key=*
// @match		  http://alt.hentaiverse.org/?s=Bazaar&ss=fr*
// @match		  http://alt.hentaiverse.org/?s=Battle&ss=iw*
// @match		  http://alt.hentaiverse.org/?s=Character&ss=in
	...
	compareBaseData: function(source,result){
		...
		if (weaponT=source.Info.Name.match(/Axe|Club|Estoc|Mace|Scythe|Longsword|Katana/)){//双手武器以及斧子棍棒
			...
			mdamageData ={	'Katalox':	[25.61,27.33,28.20,30.74,   41.37,43.92,45.62,49.82],
							'Oak':		[23.95,25.67,26.54,29.08], 
							'Redwood':	[23.95,25.67,26.54,29.08,   38.88,41.43,43.14,47.33],
							'Willow':	[23.95,25.67,26.54,29.08,   38.88,41.43,43.14,47.33] 
			}
			edbData      ={	'Katalox':	[8.74,9.6,9.64,10.49,	    16.78,17.64,17.68,18.53,    8.74,8.8,8.84,8.88,         28.84,30.5,31.35,33,        20.8,22.46,23.31,24.96],
							...
							'Redwood':	[8.74,9.6,9.64,10.49,       8.74,8.8,8.84,8.88,         16.78,17.64,17.68,18.53,     28.84,30.5,31.35,33 ,   20.8,22.46,23.31,24.96],
