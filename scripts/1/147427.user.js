// ==UserScript==
// @author   	 Patanok (source : Angel Vladov).
// @name    	eRepublik's Damage Report Script FRA
// @namespace   eRepublikDamageReport_FRA
// @version   	 2.2
// @uso:version 2.2
// @include   	 http://*erepublik.com/*/military/battlefield/*
// @description	eRepublik Damage Report Script for France
// ==/UserScript==
...
if(window.location.href.indexOf(PAGE_BATTLEFIELD) > 0) {    
    ...
    /***********************************************************************************/
    var FORM_URL = "https://docs.google.com/spreadsheet/viewform?formkey=dDllRTBXR0djSk1USUk5MXhMcXdpdHc6MQ#gid=0";
    var FORM_FIELDS = {
   			 eday: "entry.0.single",
            	name: "entry.1.single",
   			      UM:  "entry.7.single",
    ...
    var LOCALE = {
     	fr:function() {
			return {
				locale: "fr_FR",
				no_damage: "Vous devez tuer au moins un ennemi avant d'envoyer vos fights.",
				send_report: "Vous voulez envoyer vos fights?",
				button_send: "Envoyer",
				round_end: "Round terminé. Envoyer vos fights?",
				damage: "Influence",
				report: "Envoyer vos fights",
				report_title: "Votre influence totale :",
				report_failed: "Une erreur est apparue. Essaye encore."
			};
		},
   	 en: function() {
			return {
