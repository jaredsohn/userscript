// ==UserScript==
// @name           TA Sim PvP edit
// @description    Allows you to simulate combat before actually attacking.
// @namespace      https://prodgame*.alliances.commandandconquer.com/*/index.aspx*
// @include        https://prodgame*.alliances.commandandconquer.com/*/index.aspx*
// @version        1.2p
// @author         Quor | WildKatana | Updated by CodeEcho, PythEch, Matthias Fuchs, Enceladus, KRS_L, TheLuminary, Panavia2 and Da Xue
...
function initializeTools() {
	...
	var toolsbtn = new qx.ui.form.Button("Tools");
    toolsbtn.set({
        width: 64,
        height: 26,
        appearance: "button-text-small",
        toolTipText: "Tools: NOT WORKING YET!"
	});
	toolsbtn.addListener("click", function () {
	...
	var battleResultsBox = (new qx.ui.window.Window("Battle Simulator", "FactionUI/icons/icon_loading_logo.gif")).set({
		contentPaddingTop: 0,
	...
	/*
		...
		statsPage.setLayout(new qx.ui.layout.VBox(1));
		...
		eHBox1.setLayout(new qx.ui.layout.HBox(5));
		eHBox1.add(new qx.ui.basic.Label("Enemy Base: "));
		labels.damage.overall = new qx.ui.basic.Label("100");
		eHBox1.add(labels.damage.overall);
		labels.damage.overall.setTextColor("red");
		eVBox.add(eHBox1);
		...
		eHBox4.setLayout(new qx.ui.layout.HBox(5));
		eHBox4.add(new qx.ui.basic.Label("Defences: "));
		labels.damage.units.overall = new qx.ui.basic.Label("100");
		eHBox4.add(labels.damage.units.overall);
		labels.damage.units.overall.setTextColor("green");
		eVBox.add(eHBox4);
		// Buildings
		var eHBox5 = new qx.ui.container.Composite();
		eHBox5.setLayout(new qx.ui.layout.HBox(5));
		eHBox5.add(new qx.ui.basic.Label("Buildings: "));
		labels.damage.structures.overall = new qx.ui.basic.Label("100");
		eHBox5.add(labels.damage.structures.overall);
		labels.damage.structures.overall.setTextColor("green");
		eVBox.add(eHBox5);
		// Command Center
		var eHBox2 = new qx.ui.container.Composite();
		eHBox2.setLayout(new qx.ui.layout.HBox(5));
		eHBox2.add(new qx.ui.basic.Label("Construction Yard: "));
		labels.damage.structures.construction = new qx.ui.basic.Label("100");
		eHBox2.add(labels.damage.structures.construction);
		labels.damage.structures.construction.setTextColor("red");
		eVBox.add(eHBox2);
		// Defense Facility
		var eHBox3 = new qx.ui.container.Composite();
		eHBox3.setLayout(new qx.ui.layout.HBox(5));
		eHBox3.add(new qx.ui.basic.Label("Defense Facility: "));
		labels.damage.structures.defense = new qx.ui.basic.Label("100");
		eHBox3.add(labels.damage.structures.defense);
		labels.damage.structures.defense.setTextColor("red");
		eVBox.add(eHBox3);
		// Command Center
		var eHBox6 = new qx.ui.container.Composite();
		eHBox6.setLayout(new qx.ui.layout.HBox(5));
		eHBox6.add(new qx.ui.basic.Label("Command Center: "));
		labels.damage.structures.command = new qx.ui.basic.Label("100"), eHBox6.add(labels.damage.structures.command);
		labels.damage.structures.command.setTextColor("red");
		eVBox.add(eHBox6);
		// The Support Horizontal Box
		var hboxSupportContainer = new qx.ui.container.Composite();
		hboxSupportContainer.setLayout(new qx.ui.layout.HBox(5));
		labels.supportlevel = new qx.ui.basic.Label("Suport lvl ");
		hboxSupportContainer.add(labels.supportlevel);
		labels.damage.structures.support = new qx.ui.basic.Label("--: 100");
		hboxSupportContainer.add(labels.damage.structures.support);
		labels.damage.structures.support.setTextColor("red");
		eVBox.add(hboxSupportContainer);
		// The Troops Vertical Box
		var tVBox = new qx.ui.container.Composite();
		tVBox.setLayout(new qx.ui.layout.VBox(5));
		...
		tHBox1.setLayout(new qx.ui.layout.HBox(5));
		tHBox1.add(new qx.ui.basic.Label("Repair Time: "));
		labels.repair.overall = new qx.ui.basic.Label("0:00:00");
		tHBox1.add(labels.repair.overall);
		labels.repair.overall.setTextColor("blue");
		tVBox.add(tHBox1);
		// The Troop Strength Label
		var tHBox5 = new qx.ui.container.Composite();
		tHBox5.setLayout(new qx.ui.layout.HBox(5));
		tHBox5.add(new qx.ui.basic.Label("Overall: "));
		labels.health.overall = new qx.ui.basic.Label("100");
		tHBox5.add(labels.health.overall);
		...
		tHBox2.setLayout(new qx.ui.layout.HBox(5));
		tHBox2.add(new qx.ui.basic.Label("Infantry: "));
		labels.health.infantry = new qx.ui.basic.Label("100");
		tHBox2.add(labels.health.infantry);
		labels.health.infantry.setTextColor("green");
		tVBox.add(tHBox2);
		// The Vehicle Troop Strength Label
		var tHBox3 = new qx.ui.container.Composite();
		tHBox3.setLayout(new qx.ui.layout.HBox(5));
		tHBox3.add(new qx.ui.basic.Label("Vehicle: "));
		labels.health.vehicle = new qx.ui.basic.Label("100");
		tHBox3.add(labels.health.vehicle);
		labels.health.vehicle.setTextColor("green");
		tVBox.add(tHBox3);
		// The Air Troop Strength Label
		var tHBox4 = new qx.ui.container.Composite();
		tHBox4.setLayout(new qx.ui.layout.HBox(5));
		tHBox4.add(new qx.ui.basic.Label("Aircraft: "));
		labels.health.aircraft = new qx.ui.basic.Label("100");
		tHBox4.add(labels.health.aircraft);
		labels.health.aircraft.setTextColor("green");
		tVBox.add(tHBox4);
		...
		hBox2.setLayout(new qx.ui.layout.HBox(5));
		hBox2.add(new qx.ui.basic.Label("Outcome: "));
		labels.damage.outcome = new qx.ui.basic.Label("Unknown");
		hBox2.add(labels.damage.outcome);
		...
		hBox1.setLayout(new qx.ui.layout.HBox(5));
		hBox1.add(new qx.ui.basic.Label("Battle Time: "));
		labels.time = new qx.ui.basic.Label("120");
		hBox1.add(labels.time);
		labels.time.setTextColor("black");
		vBox.add(hBox1);
		statsPage.add(vBox);
	*/
	...
	t.add(new qx.ui.basic.Label("Enemy Base:"), {
		row: 0,
		column: 0
		}), labels.damage.overall = new qx.ui.basic.Label("100"), t.add(labels.damage.overall, {
		row: 0,
		column: 1
		}), t.add(new qx.ui.basic.Label("Defences:"), {
		row: 1,
		column: 0
		}), labels.damage.units.overall = new qx.ui.basic.Label("100"), t.add(labels.damage.units.overall, {
		row: 1,
		column: 1
		}), t.add(new qx.ui.basic.Label("Buildings:"), {
		row: 2,
		column: 0
		}), labels.damage.structures.overall = new qx.ui.basic.Label("100"), t.add(labels.damage.structures.overall, {
		row: 2,
		column: 1
		}), t.add(new qx.ui.basic.Label("Construction Yard:"), {
		row: 3,
		column: 0
		}), labels.damage.structures.construction = new qx.ui.basic.Label("100"), t.add(labels.damage.structures.construction, {
		row: 3,
		column: 1
		}), t.add(new qx.ui.basic.Label("Defense Facility:"), {
		row: 4,
		column: 0
		}), labels.damage.structures.defense = new qx.ui.basic.Label("100"), t.add(labels.damage.structures.defense, {
		row: 4,
		column: 1
		}), t.add(new qx.ui.basic.Label("Command Center:"), {
		row: 5,
		column: 0
		}), labels.damage.structures.command = new qx.ui.basic.Label("100"), t.add(labels.damage.structures.command, {
		row: 5,
		column: 1
		}), labels.supportlevel = new qx.ui.basic.Label(""), t.add(labels.supportlevel, {
		row: 6,
		column: 0
	...
	t.add(new qx.ui.basic.Label("Overall:"), {
		row: 0,
		column: 0
		}), labels.health.overall = new qx.ui.basic.Label("100"), t.add(labels.health.overall, {
		row: 0,
		column: 1
		}), t.add(new qx.ui.basic.Label("Infantry:"), {
		row: 1,
		column: 0
		}), labels.health.infantry = new qx.ui.basic.Label("100"), t.add(labels.health.infantry, {
		row: 1,
		column: 1
		}), t.add(new qx.ui.basic.Label("Vehicle:"), {
		row: 2,
		column: 0
		}), labels.health.vehicle = new qx.ui.basic.Label("100"), t.add(labels.health.vehicle, {
		row: 2,
		column: 1
		}), t.add(new qx.ui.basic.Label("Aircraft:"), {
		row: 3,
		column: 0
		}), labels.health.aircraft = new qx.ui.basic.Label("100"), t.add(labels.health.aircraft, {
		row: 3,
		column: 1
	}), t = new qx.ui.container.Composite, n = new qx.ui.layout.Grid, n.setColumnAlign(1, "right", "middle"), n.setColumnFlex(0, 1), t.setLayout(n), t.setThemedFont("bold"), t.setThemedBackgroundColor("#eef"), statsPage.add(t);
	t.add(new qx.ui.basic.Label("Outcome:"), {
		...
		row: 1,
		column: 0
		}), labels.time = new qx.ui.basic.Label("120"), t.add(labels.time, {
		row: 1,
		column: 1
	});
	...
	layoutsList = new qx.ui.form.List();
	layoutsList.set({
		height: 200,
		width: 180,
		selectionMode: "one"
	...
	// Add the buttons for save, load and delete
	var layHBox = new qx.ui.container.Composite();
	layHBox.setLayout(new qx.ui.layout.HBox(5));
	// Load button
	buttons.attack.layout.load = new qx.ui.form.Button("Load");
	buttons.attack.layout.load.set({
		width: 80,
		appearance: "button-text-small",
		toolTipText: "Load this saved layout."
	});
	buttons.attack.layout.load.addListener("click", loadCityLayout, this);
	layHBox.add(buttons.attack.layout.load);
	// Delete button
	buttons.attack.layout.deletef = new qx.ui.form.Button("Delete");
	buttons.attack.layout.deletef.set({
		width: 80,
		appearance: "button-text-small",
		toolTipText: "Delete this saved layout."
	});
	buttons.attack.layout.deletef.addListener("click", deleteCityLayout,
	this);
	layHBox.add(buttons.attack.layout.deletef);
	layoutPage.add(layHBox);
	...
	layHBox2.setLayout(new qx.ui.layout.HBox(5));
	layHBox2.add(new qx.ui.basic.Label("Name: "));
	layoutsLabelText = new qx.ui.form.TextField();
	layHBox2.add(layoutsLabelText);
	layVBox.add(layHBox2);
	
	buttons.attack.layout.save = new qx.ui.form.Button("Save");
	buttons.attack.layout.save.set({
		width: 80,
		appearance: "button-text-small",
		toolTipText: "Save this layout."
	});
	buttons.attack.layout.save.addListener("click", saveCityLayout, this);
	layVBox.add(buttons.attack.layout.save);
	layoutPage.add(layVBox);
