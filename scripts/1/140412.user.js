...
*/
	...
	if(!hasnodelete) {
		for(var u=0; u<users.length; u++) {
			...
			inp.title="Centang ini agar teman kamu yang ini ga kehapoos!.";
...
//<a href="javascript:;" id="fbdelete_reload">Reload friend list</a><br /><br />
	var html= '<div>' +
		...
		'<b style="padding-left:5px;font-size:1.4em;" title="HeJuLiOsA Friends Remover.  Klik pada judul untuk menampilkan / menutup menu.">HeJuLiOsA Friends Remover:</b></div>' +
		'<div style="padding:20px; display:none" id="friends_delete_widgets_container">' +
		'<span style="font-size:1.2em;font-weight:bold;color:red;"> Perhatian, saat ini loe mau hapus temen yang hanya ada di halaman ini!.<br />Jika loe ga yakin, klik aja tombol "Sorot Saja" untuk mengetes mana aja nanti yang akan dihapus.<br />'+
		'PENTING: Pergilah / Arahkan ke Paling bawah bawah halaman sehingga semua teman-2 loe terlihat dan akan mempermudah kamu memilih mana yang dihapus dan mana yang tidak dihapus!.</span><br />'+
//		'<input type="checkbox" id="BulkDeleteNextPages" />Hapus Juga teman pada halaman selanjutnya.<br />'+
		'Hapus maksimal <input size="3" id="BulkDeleteMax" /> teman.<br />'+
		<!--//'Skip friends with this note: <input type="text" id="BulkDeleteSkipSubText" value="" title="Pending, dll." /> (digunakan untuk melewati teman tertunda, teman-teman di group2 tertentu, dll.)<br />'+
		//selectNode +
		'<table style="" >' +
		'<tr style="width:20%"><td>Skip friends with this note:</td>' +
		'<td><input type="text" id="BulkDeleteSkipSubText" value="" title="Pending, dll." /></td>'+
		'<td>(used for skipping pending friends<br>, friends in certain groups, dll.)</tr>'+ 
		'<tr><td style="padding:5px; text-align:center;color:red;font-weight:bold"> --OR-- </td><td colspan="2">&nbsp;</td></tr>' + -->
		
		
		'<tr style="width:20%;"><td><select id="BulkDeleteSkipInclude"><option value="skip">Jangan hapus</option><option value="noskip">Hanya hapus</option></select> teman yang dipilih didalam daftar:</td><td colspan="2">' + selectNode + '</td>'+ 
		
		
		'<tr><td><input style="width:100%;background:red;" type="submit" value="Sorot Saja" title="Untuk ngetest" id="BulkToggle" /></td>'+
		'<td><input  style="width:100%;" type="submit" value="Tandai Semua / Hilangkan Tanda" id="ToggleAll" /></td>'+
		//'<br /><br />'+
		'<td><input  style="width:100%;font-weight:900;" type="submit" value="Hapus semua KECUALI yang ditandai" title="AWAS, hal ini ga bisa dibatalin!" id="BulkDelete" /></td>'+
		'</tr></table>'+ 
