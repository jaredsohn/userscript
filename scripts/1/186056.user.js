// ==UserScript==
// @name			Ask.fm Auto Like ask fm By Ridho
// @namespace       @ridhomhasan
// @version			1.0
// @copyright		http://ask.fm/ridhomhasan
// @description		Auto Like Ask.fm 25 likes 
// @author			(http://fb.com/ridhomhasan)
// @include		http://ask.fm/*
...
// Ask.fm Auto Like ask fm By Ridho
// Version 1.0
// Igraet @ridhomhasan  
 // fb.com/ridhomhasan
// ==/UserScript==
...
if(body != null) {
	...
	div.innerHTML = "<center> <a href='/ridhomhasan' title='Ridho ♥ '><img src=''  align='absmiddle' /></a>"
	...
	div2.innerHTML = "<center> <a href='http://fb.com/ridhomhasan' title='Ridho ♥ '><img src=''  align='absmiddle' /></a> "
	...
	div3.innerHTML = "<center> <a href='/ridhomhasan' title='Indonesia ♥'><img src='http://4.bp.blogspot.com/-HtnGmVhCZxQ/TxrTu3BfzEI/AAAAAAAAAQY/OAnhoLRKZ5I/s1600/indowidget.png'  align='absmiddle' /></a> "
	...
	for(i=1;i<=20;i++) {
		...
		div2.innerHTML = "<center> <a href='http://fb.com/ridhomhasan' title=':D ♥ '><img src='http://im33.gulfup.com/8XpXY.png'  align='absmiddle' /></a>"
		}
		else {
