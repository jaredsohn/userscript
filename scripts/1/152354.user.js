// ==UserScript==
// @author   	Ahileus 
// @name        VA battle report
// @namespace   BattlesReporter
// @version	3.43
// @include	http://www.erepublik.com/*/military/battlefield/*
// @description Damage Reporting script for Akademija
// @updateURL	http://userscripts.org/scripts/source/152354.meta.js
...
var formKey="dDZPdTNoeGdSUEVNUm41TnAyM2NpWkE6MA";
...
function createMenu()
{
  ...
  jQuery("#large_sidebar").append("<div style='text-align:center; width:150px; z-index:500; background-color:none;'><a href='http://userscripts.org/scripts/show/152354'><img style='width:150px; height:60px; margin-top:-15px;' src='"+LnLbaner+"' /></a><br />Ver "+VERSION);

if(nickname==sef1 || nickname==sef2 || nickname==sef3 || nickname==sef4 || nickname==sef5) {
jQuery("#large_sidebar").append("<br /><b>ADMIN MENU</b><br />* <a href='"+urlOrder+"#comments'>Dodaj zapovjed</a>");
   }  
