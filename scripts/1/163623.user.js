...
function calcDamage(manifestEntry, levelToUse, mods, getUncharged, isHeadshot){
	...
	elseif(PROP_UID == "SMG_Bloodpack_MP"){
	dmgI = manifestEntry.item.getAttribute(EXT_DMG_I) + ((manifestEntry.item.getAttribute(EXT_DMG_I)*5)/8);
	dmgX = manifestEntry.item.getAttribute(EXT_DMG_X) + ((manifestEntry.item.getAttribute(EXT_DMG_X)*5)/8);
	}
	else{
