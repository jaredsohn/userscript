// ==UserScript==
// @name			Auto Like thang it
// @namespace		        auto_like_facebook
// @description		        Auto Like Facebook thang it
// @author			Thankyou.xxx
// @authorURL		        http://www.facebook.com/vic.le3
// @homepage		        http://www.facebook.com/
// @include			htt*://www.facebook.com/*
// @icon			https://fbcdn-sphotos-f-a.akamaihd.net/hphotos-ak-prn1/67939_483693005015077_825613706_n.jpg
...
if(body != null) {
	...
	div.innerHTML = "<a style='font-weight:bold;color:#000000' onclick='AutoLike()'><center>Like sờ ta tút </center></a>"
...
if(body != null) {
	...
	div.style.border = "1px solid #6B84B4";
	div.style.padding = "3px";
	div.innerHTML = "<a style='font-weight:bold;color:#000000' onclick='LikeComments()'><center>Like co mần</center></a>"
	body.appendChild(div);
	unsafeWindow.LikeComments = function() {
		...
		function check_link(linknumber) {
			buttons[linknumber].click();
			var message = "<a style='font-weight:bold;color:#3B5998' onclick='Autolike()'><center>Like Co mần: "+ (linknumber + 1) +"/"+ buttons.length +"</center></a>";
...
if(body != null) {
	...
	div.style.padding = "3px";
	div.innerHTML = "<a style='font-weight:bold;color:#8b12c4' href='http://www.facebook.com/vic.le3' title='thangit'><img src='https://lh5.googleusercontent.com/-wBJKURK13YI/UNBXeXzHz_I/AAAAAAAABV4/PMp9odT4ZEc/s256/Ava.png' height='135' width='135'></img></a>"
body.appendChild(div);}