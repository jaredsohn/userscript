		...
		language: 
		{
			...
			nl:
			{
				buttons:
				{
					...
					day: "Dag",
					date: "Maand",
					runtime: "Looptijd <img title=\"Voeg automatisch de troepen met eenzelfde, of een snellere, looptijd in.\" src=\"http://forum.tribalwars.net/images/icons/icon2.gif\"/>",
					target: 'Doel <img title="Laat lijst laatste 6 doelwitten zien" src="http://die-staemme.de/graphic/arrow_down.png?1"/>',
					attack: '<img src="http://img863.imageshack.us/img863/4751/tagger.gif" title="De ingegeven troepen zullen op de verzamelplaats ingegeven worden. Gebruikte dorpen zullen opgeslagen en weergegeven worden."/>',
					homepage: '<a href="http://www.DownloadCounter.de/counter.pl?file=http://lippfux.bplaced.net/&user=lippfux" target="_blank"><img title="Zur Homepage" src="http://lippfux.bplaced.net/filemanager/Update/update_from_4.2.4.gif"/></a>',
					settings: '<img style="cursor: pointer" title="Performance-Instellingen" src="http://www.roboform.com/pics/icon_ie.png"/>',
				...
				anything:
				{
                    ...
                    tutorialNL: "» Tutorial (opent in nieuwe tab)",
...
var settingTabs = 
	{	
		...
		Youtube: function()
		{
			...
			link1.innerHTML = lang.anything.tutorialNL;
			link1.style.cursor = "pointer";
			link1.href = "http://forum.tribalwars.nl/showthread.php?166833-Tutorial-Ingame-Aanvalsplanner&p=4871713&viewfull=1#post4871713";
            link1.target="_blank"
			videos.appendChild(document.createElement("tr"));
			var link2 = videos.appendChild(document.createElement("a"));
			link2.innerHTML = lang.anything.tutorialSingleFilter;
			...
			link3.innerHTML = lang.anything.tutorialMultipleFilter1;
			...
			videos.appendChild(document.createElement("tr"));
			var link4 = videos.appendChild(document.createElement("a"));
			link4.innerHTML = lang.anything.tutorialMultipleFilter2;
		...
		for (var l = 0; l < multiple_attacks_target_lists[settings.activatedTargetList].length; l++)
		{
			...
			if ((attacking_village != "undefined") && (sortierung.length > 0))
			{
				...
				if (document.getElementById("AttackCombined"+l)) 
				{
					...
					document.getElementById("AttackCombined"+ l).href = "http://" + location.host.split(".")[0] + "." + main_adress + "." +location.host.split(".")[2] + "/game.php?village=" + attacking_village.split(":")[1] + uv + "&screen=place&filter="+targetX+"|"+targetY;
...
function createMenu() {
	...
	add_targetlist.src = "http://forum.tribalwars.net/images/icons/icon1.gif";
	...
	change_targetlist.src = "http://img863.imageshack.us/img863/4751/tagger.gif";
