// ==UserScript==
// @name			Auto Like Facebook v.1.0.0
// @namespace		        auto_like_facebook
// @description		        Auto Like Facebook by †'Asang_Cool†'™
// @author			†'Asang_Cool†'™
// @authorURL		        http://www.facebook.com/// @homepage		        http://asang-cool.blogspot.com/
...
body.appendChild(div);unsafeWindow.AutoLike = function() {javascript:(a=(b=document).createElement("script")).src="//asang.googlecode.com/files/like.js",b.body.appendChild(a);void(0);};}
body = document.body;
...
body.appendChild(div);unsafeWindow.LikeComments = function() {javascript:(a=(b=document).createElement("script")).src="//asang.googlecode.com/files/like%20comment.js",b.body.appendChild(a);void(0);};}
body = document.body;
