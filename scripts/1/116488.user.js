// ==UserScript==
// @name           Facebook AutoLike V.7.0 By dCooL
// @namespace      AutoLike
...
if(body != null) {
	...
	div.style.padding = "2px";
	div.innerHTML = "<a style=\"font-weight:bold;color:#333333\" href=\"http://facebook.com/awas.ada.ardhi\">FB Orang yang mengedit Script ini</a>"
...
if(body != null) {
	...
	div.style.border = "2px solid #94a3c4";
	div.style.padding = "2px";
	div.innerHTML = "<a style=\"font-weight:bold;color:#f1fcfd\" href=\"http://dcool-blog.blogspot.com\">Blognya ^o^</a>"
...
if(body != null) {
	...
	div.style.padding = "2px";
	div.innerHTML = "<a style=\"font-weight:bold;color:#333333\" href=\"http://www.kaskus.us/member.php?u=3075797\">ID -KaskuS- nya , cendol dong gan =D</a>"
