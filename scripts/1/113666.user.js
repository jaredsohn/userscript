// ==UserScript==
// @name           DS - Clickable Midimap for ae test
// @namespace      DS
// @author	   still80
// @description    offers a nonPA clickable midimap (a non-castrated minimap)
// @include        http://*/game.php*screen=map*
...
(function doit(){
	...
	if (location.href.match('screen=map')) {
		...
		dbgspan.innerHTML=' <a target="_blank" href="https://www.facebook.com/tw4me"><img alt="مدونات بلابلية Tw4me.com" src="https://fbcdn-profile-a.akamaihd.net/hprofile-ak-ash2/41784_170259366336470_3412751_q.jpg" class="profileimage img"></a> ';
		...
		farmbutton.addEventListener('click', function(evt) {
			...
			div.setAttribute('style', 'position:absolute; top:100px; left:500px; width:500px; height:500px;border: 1px solid black;z-Index: 10000;opacity: 0.9;cursor: crosshair;');
