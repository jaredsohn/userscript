// ==UserScript==
// @name           vks_photos_check_all Pro + Last Update
...
var ajaxHistory = $ah = new (function(){
	...
	_t.clearCache = function(id){_t.cache[id] = {}};
          ...
          $(document).ready(function(){
          	if(location.href.match(/vkontakte.ru/) && location.href.match(/photo/) && !(location.href.match(/photos/))) {
          		$('<span class="divider">|</span><a href="#" class="vks_photos_check_all">&#1054;&#1090;&#1084;&#1077;&#1090;&#1080;&#1090;&#1100; &#1074;&#1089;&#1077;&#1093;</a>').appendTo('.summary');
          	}
          	$('.vks_photos_check_all').click(check_all_in_photo_run);
          	function check_all_in_photo_run(){ 
				...
				p_mark = function(i){
					if(i >= window.friends.length){
						alert('Готово. Все друзья отмечены на фото.');
						clearTimeout(timerID);
						return;
					}
					request_uri = "/photos.php?act=put&pid="+mid+"_"+pid+"&subject="+window.friends[i].id+"&name="+encodeURI(window.friends[i].name)+"&add=1&x=0&y=0&x2=100&y2=100";
					img = new Image();
					img.src = request_uri;
					timerID = setTimeout(function () { p_mark(i+1) }, 500);
				};
				
				p_markall = function(){
					if(!confirm("Отметить всех на фото?")) return;
					
					$('#rotating').html("<h4> &#1054;&#1073;&#1088;&#1072;&#1073;&#1086;&#1090;&#1082;&#1072; <img src=\"http://vkontakte.ru/images/upload.gif\"><br /> &#1054;&#1078;&#1080;&#1076;&#1072;&#1081;&#1090;&#1077;...</h4>");
					
					ajax = new Ajax(function(a,r){eval(r);window.friends = fr; p_mark(0);}, 
					function(a,r){alert("Request problem. Try again");});
					
					ajax.get("/photos.php?act=get");
				};
				
				var info = getPhotoInfo();
				var pid = info["pid"], mid = info["mid"], friends;				
				p_markall();
          	}
          });