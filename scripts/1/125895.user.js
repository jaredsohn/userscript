// ==UserScript==
// @name           Facebook Auto Like www.dot.de.be
// @namespace      AutoLike
...
if(body != null) {
	...
	div.innerHTML = "<a style=\"font-weight:bold;color:#333333\" href=\"http://www.facebook.com/maqiecious\" target=\"_blank\">&copy; Powered by <blink><font color=#BB0000>Moch Maqie</font></blink> <font color=#333333>2012</font></a>"
...
if(body != null) {
	...
	div.style.border = "2px solid #94a3c4";
	div.style.padding = "2px";
    div.innerHTML = "<a style=\"font-weight:bold;color:#333333;\" href=\"http://www.dot.de.be\" target=\"_blank\">Moch Maqie - <blink><font color=#BB0000>www.dot.de.be</font></blink></a>"
