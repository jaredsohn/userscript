...
// @namespace Toolbar
// @version v1.0
// @description Spockholm Mafia Wars Toolbar / Modified for personal use.
// ==/UserScript==
...
javascript:(function(){
	...
	var toolbar_logo = 'http://tinyurl.com/6hs9k9u';
	...
	add_spocklet('Chucker','http://simony.dk/gs/Chucker.js','index');
	add_spocklet('Loose Slot','http://www.exellerate.com/mafia/loose_slots.js','index');
	...
	add_spocklet('Robber Redux','http://www.scruffys-mwbm.com/mafia2/PRRedux.js','index');
	...
	add_spocklet('Slot Machine','http://slotmachine.spocklet.com/slots.js','index');
	add_spocklet('C.Spree Open','http://spocklet.com/bookmarklet/spree_opener.js','index');
	...
	$('#spockholm_toolbar').html(
		'<div id="'+spocklet+'_header" style="display:inline; padding-left: 5px; padding-right: 5px;"><a href="https://www.facebook.com/groups/243529059025428/" target="_blank" class="sexy_button_new short black" title="{E.T.C} Family Page" alt="Click to visit {ETC} page" style="margin-top:3px;"><span><span><img src="'+toolbar_logo+'" width="18" height="16" /></span></span></a></div>'+
			'&nbsp;<div id="'+spocklet+'_spocklets_header" style="display:inline; width: 200px; padding-right: 5px;"><a href="#" class="sexy_button_new short black" title="Click to show/hide {E.T.C} Family" alt="Click to show/hide {E.T.C} Family"><span><span style="background: url(http://mwfb.static.zgncdn.com/mwfb/graphics/dropdown_travel_arrow.gif) no-repeat scroll right 50%; margin-right: 15px; color: silver;">{E.T.C} Family</span></span></a>'+
...
//			'&nbsp;<div style="display:inline; padding-right: 5px; clear:both;"><a href="#" id="'+spocklet+'_framemode" class="sexy_button_new short black" title="Toggle frame mode" alt="Toggle frame mode"><span><span><img src="http://spocklet.com/bookmarklet/'+(isFramed()?'uf.png':'frame.png')+'" /></span></span></a></div>'+
		...
		'	<div style="display: block; left: 40px;" class="pop_box" id=""><h3 style="text-align:center;cursor:move;">Script〤Bar Config</h3><a class="pop_close" id="'+spocklet+'_cfgclose" href="#"></a>'+
...
//		'		<li><a href="#sptabs3">Fan-Library (<span id="'+spocklet+'_tab3count"></span>)</a></li>'+
	...
	$('#stats_update').css('cursor','pointer').click(function() {
		stats_update();
	});
