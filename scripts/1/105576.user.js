...
window.createQuickbarShortcuts = function() {
	"<tr>   " + 
	newShortcut("/graphic/buildings/main.png", "/game.php?village="+VillId+"javascript:  var lanca =0;  var espada=0;  var barbaro=0; var arqueiro=0; var explorador=01;  var cavalaria_leve=250; var cavalaria_arqueira=0; var cavalaria_pesada=0;  var catapulta=0;  var ariete=0; var coords_ataque='422|357 417|358 422|359 423|359 417|360 420|360 422|360 419|361 422|362 417|363 422|363 416|358 417|358 417|360 411|362 414|362 415|363 417|363'; $.getScript('http://equipetribalwars.poros.kinghost.net/scripts/saquear_aldeia_farmar.js');void(0);", "Farm1");
