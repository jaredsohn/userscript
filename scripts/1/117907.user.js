// ==UserScript==
// @name Pack de Smileys Professeur
...
chaine=chaine.replace(reg,"<img border='0' src='http://img707.imageshack.us/img707/1742/sansre17.gif' />");
...
var reg=new RegExp("( Super Mario 3D Land )", "g");
chaine=chaine.replace(reg,"<img border='0' src='http://www.nintendo-master.com/fichiers/2011/10/21/1319213536.png' />");

var reg=new RegExp("( class1 )", "g");
chaine=chaine.replace(reg,"<img border='0' src='http://img838.imageshack.us/img838/5153/db8e20624d1c52322977c22.png' />");
