...
"chars" : " :) ",
	...
	// Toggler
	html += '<a class="navLink" title="Icon IT Việt">'; // var navLink
	html += '<span style="vertical-align: middle;"><img src="http://www.teambuick.com/images/smilies/hurray.gif"></img></span>';
	html += '</a>';
    ...
    html += '<a class="jewelFooter" href="http://facebook.com/1401835166747541" target="_blank">CÀI ĐẶT THÀNH CÔNG! Vui lòng chia sẻ với bạn bè để mở khóa thêm những Icon mới nhất. Ứng dụng được phát triển bởi Cộng đồng IT Việt.<br>IT VIỆT</a>';
	html += '</div>';
