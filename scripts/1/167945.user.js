// ==UserScript==
// @name        Ultoo all 3in1 by Modernhackerss.blogspot.com.
// @namespace   Updated All in one
// @description [20 May 2013] This script automate the AnswerIt and Poll Part....
...
{
	window.location.href = "http://adf.ly/PHyMS";
...
if(url.search(pattern)==0)
{
		...
		window.location.href = "http://adf.ly/PHyZ6";
		//window.location.href = link;
...
if(url.search(pattern)==0)
{
	window.location.href = "http://adf.ly/PHyek";
