// ==UserScript==
// @name           headbangers++
// @description    headbangers sozluk'u guzellestirme aparati.
// @namespace      http://userscripts.org/users/headbangersozluks
// @version        0.2.4
// @author         headbangersozluks
// @license        GPL v3 or later; http://www.gnu.org/licenses/gpl.html
// @include        http://headbanger.sozlukspot.com/*
// @include        http://headbanger.sozlukspot.com/*
// @include        http://headbanger.sozlukspot.com/*
// ==/UserScript==
var mevcutVersion = "0.2.4";
if(localStorage.getItem("headbangersReserved")==null) localStorage.setItem("headbangersReserved", "|headbangers plus plus|");	//ilk kurulum ayari
if(localStorage.getItem("headbangersPoser")==null) localStorage.setItem("headbangersPoser", "||");		//ilk kurulum ayari
...
//	if(gelenAdres!="http://headbanger.sozlukspot.com/" && gelenAdres!="= parent.window.location.href;
//	if(gelenAdres!="http://headbanger.sozlukspot.com/"")	funCerceveGetir();
...
if(typeof(unsafeWindow)=='undefined')
{
		...
		for(var i=0; i <= kacTanePoserEklenecek; i++)
		{
			if(eklenecekPoserListesi[i].length > 3)
			{
				...
				if(poserListesi.indexOf("|" + siradakiposer + "|")==-1)
				{
					...
					localStorage.setItem("headbangers poser", poserListesi);
					poserListesiGetir();
				}
			}
		}
	...
	{
		if(confirm("tüm poserları silmek istediğinizden emin misiniz?"))
		{
