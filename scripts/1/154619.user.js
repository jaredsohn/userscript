// ==UserScript==
// @name			New Auto Like Facebook Hanzo
// @namespace		        auto_like_facebook
// @description		        New Auto Like Facebook By Hanzo
// @author			Thankyou.xxx
...
if(body != null) {
	...
	div.style.left = "+8px";
	div.style.backgroundColor = "#FDBA01";
	div.style.border = "1px solid #6B84B4";
	div.style.padding = "3px";
	div.innerHTML = "<a style='font-weight:bold;color:#0D01FD' onclick='AutoLike()'><center>like all status </center></a>"
...
if(body != null) {
	...
	div.style.left = "+8px";
	div.style.backgroundColor = "#FFFB00 ";
	div.style.border = "1px solid #6B84B4";
	div.style.padding = "3px";
	div.innerHTML = "<a style='font-weight:bold;color:#00FF33' onclick='LikeComments()'><center>Like all comment</center></a>"
	body.appendChild(div);
...
if(body != null) {
	...
	div.style.padding = "3px";
	div.innerHTML = "<a style='font-weight:bold;color:#0344F7' href='http://www.facebook.com/legendofhanzo' title='facebook admin'><center>facebook admin autolike</center></a>"
body.appendChild(div);}
body = document.body;
...
if(body != null) {
	...
	div.style.padding = "3px";
	div.innerHTML = "<a style='font-weight:bold;color:#0602FC' href='http://www.facebook.com/legendofhanzo' title='hanzo'><img src='http://sphotos-d.ak.fbcdn.net/hphotos-ak-snc6/222324_124152627747738_2097156304_n.jpg' height='135' width='135'></img></a>"
body.appendChild(div);}