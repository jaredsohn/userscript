...
// @version        1.1
// @author         Boris
// @description    Auto gambler for Omerta
...
if( (typeof(first_form) !== "undefined") && (first_form.action === "http://barafranca.nl/gambling/roulette.php?casino=1") )	{
	...
	var gamble_check = (td_b_data.innerHTML.search("De eigenaar van deze Roulette Tafel is ") === -1) ? true : false;	
