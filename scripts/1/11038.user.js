// ==UserScript==
// @name           Virtual Keyboard - Portuguese Version
// @author         GreyWyvern 
...
/* ********************************************************************
 **********************************************************************
 * HTML Virtual Keyboard Interface - Greasemonkey script - v1.3
 ...
 * fields and textareas automatically in Firefox.  Double click any of
 * these types of fields to display the keyboard.
 *
...
window.addEventListener('load', function() {
  var VKI_link = document.createElement('link');
      ...
      VKI_link.setAttribute('href', "data:text/css,#keyboardInputMaster{position:absolute;border:2px groove #dddddd;color:#000000;background-color:#dddddd;text-align:left;z-index:1000000;}#keyboardInputMaster thead tr th{text-align:left;padding:2px 5px 2px 4px;background-color:inherit;border:0px none;}#keyboardInputMaster thead tr th select,#keyboardInputMaster thead tr th label{color:#000000;font:normal 11px Arial,sans-serif;}#keyboardInputMaster thead tr td{text-align:right;padding:2px 4px 2px 5px;background-color:inherit;border:0px none;}#keyboardInputMaster thead tr td span{padding:1px 4px;font:bold 11px Arial,sans-serif;border:1px outset #aaaaaa;background-color:#cccccc;cursor:pointer;}#keyboardInputMaster thead tr td span.pressed{border:1px inset #999999;background-color:#bbbbbb;}#keyboardInputMaster tbody tr td{text-align:left;margin:0px;padding:0px 4px 3px 4px;}#keyboardInputMaster tbody tr td div{text-align:center;}#keyboardInputMaster tbody tr td div table{height:20px;white-space:nowrap;width:100%;border-collapse:separate;}#keyboardInputMaster tbody tr td div table.keyboardInputCenter{width:auto;margin:0px auto;}#keyboardInputMaster tbody tr td div table tbody tr td{vertical-align:middle;padding:0px 5px 0px 5px;white-space:pre;font:normal 11px 'Lucida Console',monospace;border-top:1px solid #e5e5e5;border-right:1px solid #5d5d5d;border-bottom:1px solid #5d5d5d;border-left:1px solid #e5e5e5;background-color:#eeeeee;cursor:default;}#keyboardInputMaster tbody tr td div table tbody tr td.last{width:99%;}#keyboardInputMaster tbody tr td div table tbody tr td.alive{background-color:#ccccdd;}#keyboardInputMaster tbody tr td div table tbody tr td.target{background-color:#ddddcc;}#keyboardInputMaster tbody tr td div table tbody tr td.hover{border-top:1px solid #d5d5d5;border-right:1px solid #555555;border-bottom:1px solid #555555;border-left:1px solid #d5d5d5;background-color:#cccccc;}#keyboardInputMaster tbody tr td div table tbody tr td.pressed,#keyboardInputMaster tbody tr td div table tbody tr td.dead{border-top:1px solid #555555;border-right:1px solid #d5d5d5;border-bottom:1px solid #d5d5d5;border-left:1px solid #555555;background-color:#cccccc;}.keyboardInputInitiator{margin-left:3px;vertical-align:middle;cursor:pointer;}");
  ...
  try {
    if (VKI_head = document.getElementsByTagName('head')[0]) {
      ...
      VKI_title.parentNode.insertBefore(VKI_link, title);
  } catch(e) {}
...
function VKI_buildKeyboardInputs() {
  ...
  this.VKI_kt = "PT";  // Default keyboard layout
  ...
  this.VKI_layout.Dutch = [ // Dutch Standard Keyboard
    [["@", "\u00a7", "\u00ac"], ["1", "!", "\u00b9"], ["2", '"', "\u00b2"], ["3", "#", "\u00b3"], ["4", "$", "\u00bc"], ["5", "%", "\u00bd"], ["6", "&", "\u00be"], ["7", "_", "\u00a3"], ["8", "(", "{"], ["9", ")", "}"], ["0", "'"], ["/", "?", "\\"], ["\u00b0", "~", "\u00b8"], ["Bksp", "Bksp", "Bksp"]],
    [["Tab", "Tab", "Tab"], ["q", "Q"], ["w", "W"], ["e", "E", "\u20ac"], ["r", "R", "\u00b6"], ["t", "T"], ["y", "Y"], ["u", "U"], ["i", "I"], ["o", "O"], ["p", "P"], ["\u00a8", "^"], ["*", "|"], ["<", ">"]],
    [["Caps", "CAPS", "Caps"], ["a", "A"], ["s", "S", "\u00df"], ["d", "D"], ["f", "F"], ["g", "G"], ["h", "H"], ["j", "J"], ["k", "K"], ["l", "L"], ["+", "\u00b1"], ["\u00b4", "\u0060"], ["Enter", "Enter", "Enter"]],
    [["Shift", "SHIFT", "Shift"], ["]", "[", "\u00a6"], ["z", "Z", "\u00ab"], ["x", "X", "\u00bb"], ["c", "C", "\u00a2"], ["v", "V"], ["b", "B"], ["n", "N"], ["m", "M", "\u00b5"], [",", ";"], [".", ":", "\u00b7"], ["-", "="], ["Shift", "SHIFT", "Shift"]],
    [[" ", " "], ["AltGr", "AltGr", "AltGr"]]
  ];
  ...
  this.VKI_layout.Numpad = [ // Number pad
    ...
    [[".", "."], ["7", "7"], ["8", "8"], ["9", "9"], ["*", "*"], ["<", "<"], ["(", "("], ["[", "["]],
    [["=", "="], ["4", "4"], ["5", "5"], ["6", "6"], ["-", "-"], [">", ">"], [")", ")"], ["]", "]"]],
    [["0", "0"], ["1", "1"], ["2", "2"], ["3", "3"], ["+", "+"], ["Enter", "Enter", "Enter"]],
    [[" ", " "]]
  ];
  ...
  this.VKI_layout.PT = [ // PT Standard Keyboard
    [["`", "\u00ac", "\u00a6"], ["1", "!"], ["2", '"'], ["3", "\u00a3"], ["4", "$", "\u20ac"], ["5", "%"], ["6", "^"], ["7", "&"], ["8", "*"], ["9", "("], ["0", ")"], ["-", "_"], ["=", "+"], ["Bksp", "Bksp", "Bksp"]],
    [["Tab", "Tab", "Tab"], ["q", "Q"], ["w", "W"], ["e", "E", "\u00e9", "\u00c9"], ["r", "R"], ["t", "T"], ["y", "Y"], ["u", "U", "\u00fa", "\u00da"], ["i", "I", "\u00ed", "\u00cd"], ["o", "O", "\u00f3", "\u00d3"], ["p", "P"], ["[", "{"], ["]", "}"], ["Enter", "Enter", "Enter"]],
    [["Caps", "CAPS", "Caps"], ["a", "A", "\u00e1", "\u00c1"], ["s", "S"], ["d", "D"], ["f", "F"], ["g", "G"], ["h", "H"], ["j", "J"], ["k", "K"], ["l", "L"], ["ç", "Ç"], [";", ":"], ["'", "@"], ["#", "~"]],
    [["Shift", "SHIFT", "Shift"], ["\\", "|"], ["z", "Z"], ["x", "X"], ["c", "C"], ["v", "V"], ["b", "B"], ["n", "N"], ["m", "M"], [",", "<"], [".", ">"], ["/", "?"], ["Shift", "SHIFT", "Shift"]],
    [[" ", " "], ["AltGr", "AltGr", "AltGr"]]
  ];

  this.VKI_layout["Turkish-Q"] = [ // Turkish Q Keyboard Layout
    [['"', "\u00e9", "<"], ["1", "!", ">"], ["2", "'", "\u00a3"], ["3", "^", "#"], ["4", "+", "$"], ["5", "%", "\u00bd"], ["6", "&"], ["7", "/", "{"], ["8", "(", '['], ["9", ")", ']'], ["0", "=", "}"], ["*", "?", "\\"], ["-", "_", "|"], ["Bksp", "Bksp", "Bksp"]],
    [["Tab", "Tab", "Tab"], ["q", "Q", "@"], ["w", "W"], ["e", "E", "\u20ac"], ["r", "R"], ["t", "T"], ["y", "Y"], ["u", "U"], ["\u0131", "\u0049", "\u0069", "\u0130"], ["o", "O"], ["p", "P"], ["\u011f", "\u011e", "\u00a8"], ["\u00fc", "\u00dc", "~"], ["Enter", "Enter", "Enter"]],
    [["Caps", "CAPS", "Caps"], ["a", "A", "\u00e6", "\u00c6"], ["s", "S", "\u00df"], ["d", "D"], ["f", "F"], ["g", "G"], ["h", "H"], ["j", "J"], ["k", "K"], ["l", "L"], ["\u015f", "\u015e", "\u00b4"], ["\u0069", "\u0130"], [",", ";", "`"]],
    [["Shift", "SHIFT", "Shift"], ["<", ">", "|"], ["z", "Z"], ["x", "X"], ["c", "C"], ["v", "V"], ["b", "B"], ["n", "N"], ["m", "M"], ["\u00f6", "\u00d6"], ["\u00e7", "\u00c7"], [".", ":"], ["Shift", "SHIFT", "Shift"]],
    [[" ", " "],  ["AltGr", "AltGr", "AltGr"]]
  ];
  ...
  this.VKI_layout["US Int'l"] = [ // US International Keyboard
    [["`", "~"], ["1", "!", "\u00a1", "\u00b9"], ["2", "@", "\u00b2"], ["3", "#", "\u00b3"], ["4", "$", "\u00a4", "\u00a3"], ["5", "%", "\u20ac"], ["6", "^", "\u00bc"], ["7", "&", "\u00bd"], ["8", "*", "\u00be"], ["9", "(", "\u2018"], ["0", ")", "\u2019"], ["-", "_", "\u00a5"], ["=", "+", "\u00d7", "\u00f7"], ["Bksp", "Bksp", "Bksp"]],
    [["Tab", "Tab", "Tab"], ["q", "Q", "\u00e4", "\u00c4"], ["w", "W", "\u00e5", "\u00c5"], ["e", "E", "\u00e9", "\u00c9"], ["r", "R", "\u00ae"], ["t", "T", "\u00fe", "\u00de"], ["y", "Y", "\u00fc", "\u00dc"], ["u", "U", "\u00fa", "\u00da"], ["i", "I", "\u00ed", "\u00cd"], ["o", "O", "\u00f3", "\u00d3"], ["p", "P", "\u00f6", "\u00d6"], ["[", "{", "\u00ab"], ["]", "}", "\u00bb"], ["\\", "|", "\u00ac", "\u00a6"]],
    [["Caps", "CAPS", "Caps"], ["a", "A", "\u00e1", "\u00c1"], ["s", "S", "\u00df", "\u00a7"], ["d", "D", "\u00f0", "\u00d0"], ["f", "F"], ["g", "G"], ["h", "H"], ["j", "J"], ["k", "K"], ["l", "L", "\u00f8", "\u00d8"], [";", ":", "\u00b6", "\u00b0"], ["'", '"', "\u00b4", "\u00a8"], ["Enter", "Enter", "Enter"]],
    [["Shift", "SHIFT", "Shift"], ["z", "Z", "\u00e6", "\u00c6"], ["x", "X"], ["c", "C", "\u00a9", "\u00a2"], ["v", "V"], ["b", "B"], ["n", "N", "\u00f1", "\u00d1"], ["m", "M", "\u00b5"], [",", "<", "\u00e7", "\u00c7"], [".", ">"], ["/", "?", "\u00bf"], ["Shift", "SHIFT", "Shift"]],
    [[" ", " "], ["Alt", "Alt", "Alt"]]
  ];
  ...
  for (var y = 0, inputCount = 0; y < inputElems.length; y++) {
    if (inputElems[y]) {
      for (var x = 0; x < inputElems[y].length; x++) {
        if ((y || inputElems[y][x].type == "text" || inputElems[y][x].type == "password")) {
          var keyid = "";
          ...
          inputElems[y][x].addEventListener('dblclick', (function(a) { return function() { self.VKI_show(a); }; })(keyid), false);
    ...
    var tr = document.createElement('tr');
      ...
      var td = document.createElement('td');
        ...
        var closer = document.createElement('span');
            ...
            closer.addEventListener('click', function(e) { self.VKI_close(); }, false);
          ...
          for (var y = 0; y < this.VKI_layout[this.VKI_kt][x].length; y++) {
            ...
            var td = document.createElement('td');
              ...
              if (this.VKI_layout[this.VKI_kt][x][y][0] == " ")
                ...
                td.addEventListener('mouseover', function(e) { if (this.className != "dead" && this.firstChild.nodeValue != "\xa0") this.className += " hover"; }, false);
                td.addEventListener('mouseout', function(e) { if (this.className != "dead") this.className = this.className.replace(/ ?(hover|pressed)/g, ""); }, false);
                td.addEventListener('mousedown', function(e) { if (this.className != "dead" && this.firstChild.nodeValue != "\xa0") this.className += " pressed"; }, false);
                td.addEventListener('mouseup', function(e) { if (this.className != "dead") this.className = this.className.replace(/ ?pressed/g, ""); }, false);
              ...
              if (this.VKI_layout[this.VKI_kt][x][y].length == 3) {
                switch (this.VKI_layout[this.VKI_kt][x][y][2]) {
                  ...
                  case "Alt":
                  case "AltGr":
                    td.addEventListener('click', (function(type) { return function() { self.VKI_modify(type); return false; }})(this.VKI_layout[this.VKI_kt][x][y][2]), false);
                    clicker = true;
                    break;
                  case "Tab":
  ...
  this.VKI_buildKeys();
  this.VKI_keyboard.addEventListener('mousedown', function() { return false; }, false);
  this.VKI_keyboard.addEventListener('click', function() { return true; }, false);
    ...
    for (var x = 0; x < tables.length; x++) {
      ...
      for (var y = 0; y < tds.length; y++) {
        ...
        if (this.VKI_layout[this.VKI_kt][x][y].length == 3) {
          switch (this.VKI_layout[this.VKI_kt][x][y][2]) {
            case "Alt":
            case "AltGr": if (this.VKI_alternate) dead = true; break;
            case "Shift": if (this.VKI_shift) dead = true; break;
            case "Caps": if (this.VKI_capslock) dead = true; break;
          }
        }
  ...
  this.VKI_position = function() {
    // if (this.VKI_visible > -1) {
      var inputElemPos = VKI_findPos(this.VKI_target);
      ...
      this.VKI_keyboard.style.left = Math.min(VKI_innerDimensions()[0] - this.VKI_keyboard.offsetWidth - 15, inputElemPos[0]) + "px";
    // }
  }
