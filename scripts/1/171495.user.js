// ==UserScript==
// @name           Pinboard-Shortcuts (Bookmark + Read Later)
// @author         leplay / jekyll
// @namespace      http://userscripts.org/scripts/show/171493
// @description    Press Ctrl + D to add the opened webpage to pinboard.in using the same-page tag-cloud bookmarklet, press Ctrl + D followed by R to read later
// @grant          none
// ==/UserScript==

// original script by leplay - http://userscripts.org/scripts/show/120694
// modified by jekyll@0x4a.net 
// mousetrap 1.4.2 - http://craig.is/killing/mice


Mousetrap.bind('ctrl+d r', addReadlater(), 'keydown');
Mousetrap.bind('ctrl+d', addBookmark(), 'keydown');
