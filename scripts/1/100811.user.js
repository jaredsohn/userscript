// ==UserScript==
// @name           Cutthroat Ikariam by md
// @namespace      http://s*.ikariam.*/*
// @description    Make your city look like a pirate cove! Edited by moondoggie, the original scrip is not being maintained. ver 0.3
...
var URL= "http://ikariam.gotei13.org/cutthroat_ikariam/";
...
GM_addStyle("#cityNav .viewIsland .textLabel                                   {font-weight: bold}");
GM_addStyle("#cityNav .viewIsland a                                            {background-image:url("+URL+"btn_island.jpg)}");
GM_addStyle("#cityNav .viewIsland a.hover                                      {background-image:url("+URL+"btn_island.jpg)}");
GM_addStyle("#cityNav .viewIsland a.down                                       {background-image:url("+URL+"btn_island.jpg) background-position: 0px -56px}");

GM_addStyle("#cityNav .viewCity .textLabel                                     {font-weight: bold}");
GM_addStyle("#cityNav .viewCity a                                              {background-image:url("+URL+"btn_city.jpg)}");
GM_addStyle("#cityNav .viewCity a.hover                                        {background-image:url("+URL+"btn_city.jpg) background-position: 0px -58px}");
GM_addStyle("#cityNav .viewCity a.down                                         {background-image:url("+URL+"btn_city.jpg) background-position: 0px -116px}");

GM_addStyle("#cityNav .viewWorldmap .textLabel                                 {font-weight: bold}");
GM_addStyle("#cityNav .viewWorldmap a                                          {background-image:url("+URL+"btn_world.jpg)}");
GM_addStyle("#cityNav .viewWorldmap a:hover                                    {background-image:url("+URL+"btn_world.jpg)}");
GM_addStyle("#cityNav .viewWorldmap a.down                                     {background-image:url("+URL+"btn_world.jpg) background-position: 0px -108px}");
...
GM_addStyle("#container ul.resources .wood                                     {background-image:url("+URL+"wood.png); background-position: 4px 2px}");
GM_addStyle("#container ul.resources .marble                                   {background-image:url("+URL+"marble.png); background-position: 2px 2px}");
GM_addStyle("#container ul.resources .wine                                     {background-image:url("+URL+"wine.png); background-position: 4px 2px}");
GM_addStyle("#container ul.resources .glass                                    {background-image:url("+URL+"glass.png); background-position: 4px 2px}");
GM_addStyle("#container ul.resources .sulfur                                   {background-image:url("+URL+"sulfur.png); background-position: 2px 2px}");

GM_addStyle("#globalResources .ambrosiaNoSpin a                                {background:url("+URL+"plussign.gif)no-repeat; position:0px 12px}; text-align:right;padding-right:12px;line-height:12px");
GM_addStyle("#globalResources .ambrosia a                                      {background:url("+URL+"plussign.gif)no-repeat; position:0px 12px}; text-align:right;padding-right:12px;line-height:12px");
GM_addStyle("globalResources  .ambrosia a:hover                                {background:url("+URL+"plussign.gif)no-repeat; position:0px 0px}");
GM_addStyle("#globalResources .ambrosiaNoSpin a:hover                          {background:url("+URL+"plussign.gif)no-repeat; position:0px 0px}");
GM_addStyle("#globalResources .ambrosia a.down								   {background:url("+URL+"plussign.gif)no-repeat; position:0px 12px}");
GM_addStyle("#globalResources .ambrosiaNoSpin a.down                           {background:url("+URL+"plussign.gif)no-repeat; position:0px 12px}");
...
GM_addStyle('#advisors #advCities a.normal                                      {background-image:url('+URL+'mayor1.png); }');
GM_addStyle('#advisors #advCities a.normalactive                                {background-image:url('+URL+'mayor2.png); }');

GM_addStyle('#advisors #advMilitary a.normal                                    {background-image:url('+URL+'war1.png); }');-
GM_addStyle('#advisors #advMilitary a.normalactive                              {background-image:url('+URL+'war2.png); }');-
GM_addStyle('#advisors #advMilitary a.normalalert                               {background-image:url('+URL+'war3.png); }');

GM_addStyle('#advisors #advDiplomacy a.normal                                   {background-image:url('+URL+'diplo1.png);	}');
GM_addStyle('#advisors #advDiplomacy a.normalactive                             {background-image:url('+URL+'diplo2.png);	}');

GM_addStyle('#advisors #advResearch a.normal                                    {background-image:url('+URL+'rese1.png); }');
GM_addStyle('#advisors #advResearch a.normalactive                              {background-image:url('+URL+'rese2.png); }');
