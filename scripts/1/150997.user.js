// ==UserScript==
// @name        Trade's Command Center for Global Warfare
// @namespace   tradestoolkit
// @description Tools for Global Warfare
// @version     10.25.2012
...
Seed = unsafeWindow.seed;
  ...
  AddMainTabLink('Trades_Tools', eventHideShow, mouseMainTab);
...
Tabs.BILGI = {
  ...
  show : function (div){
    ...
    // 18=SpecForces
    // 19=Cargo Transport
    // 20=Orbital Ion Cannon
    // 21=SAM Elite
    // 22=AntiTank Elite
    // 23= ---
    // 24=Gunship Elite
    var WeaponList=[1,5,6,4,18,7,8,17,9,11,10,12,19,16,13,15,20,21,24,22];
...
Tabs.Artefacts = {
  ...
  init : function (div){
    ...
    t.cont = div;
		...
		out.push('<td width="50">&nbsp;</td>');
		out.push('<td><b>AntiTank Elite.:</b>&nbsp;</td>');
