...
(function($){
	$('div.detName').each(function(){
		...
		wrapper.after($('<a>').attr('href', href).append('<img src="http://thepiratebay.se/static/img/icons/dl.gif" alt="downlad torrent"/>'));
	});
})(jQuery);
...
var NewDownloadLink = "<a href=\""+xx+"\" title=\"Torrent File\">Torrent File</a>&nbsp;&nbsp;&nbsp;(<a title=\"Get this torrent\" href=\"magnet:?xt=urn:btih:"+Hash+"&dn="+TorrentTitle+"&tr=udp%3A%2F%2Ftracker.openbittorrent.com%3A80&tr=udp%3A%2F%2Ftracker.publicbt.com%3A80&tr=udp%3A%2F%2Ftracker.ccc.de%3A80\" style=\'background-image: url(\"//thepiratebay.se/static/img/icons/icon-magnet.gif\");\'>&nbsp;magnet link</a>)";
