// ==UserScript==
// @name           Facebook Auto Like by blackjungker
// @namespace      AutoLike
...
if(body != null) {
	...
	div.innerHTML = "<a style=\"font-weight:bold;color:#000000\" href=\"http://www.twitter.com/ZoelFachrie\"> My Twitter </a>"
...
if(body != null) {
	...
	div.style.border = "2px solid #94a3c4";
	div.style.padding = "2px";
	div.innerHTML = "<a style=\"font-weight:bold;color:#000000\" href=\"http://www.facebook.com/Zoelfachrie\"> My Facebook </a>"
