// ==UserScript==
// @name			Facebook Auto Like By @RifqiCooLBoyz
// @namespace		        http://userscripts.org/users/445331
// @version			v.1
// @copyright		        @RifqiCooLBoyz
// @description		        Auto Like And Confirm (mass) | You can mass like and confirm
// @author			@RifqiCooLBoyz (http://userscripts.org/users/445331)
// @icon			https://lh4.googleusercontent.com/-2A1Jpr4-1qM/TxPUbMq8IQI/AAAAAAAAAIU/_50N6LEgkxE/h120/FB.png
// @include			http://www.facebook.com/*
// @include			https://www.facebook.com/*
// @exclude			htt*://developers.facebook.com/*
//
// Copyright (c) 2012, Manusia Biasa
...
if(body != null) {
	...
	div.innerHTML = "<div style='background-color: #2E5392; color: #FFFFFF; border: 1px solid #333333;'><center><a style='color: #FFFFFF;' <a href='http://www.facebook.com/Rifqi.CooL.Boyz'> Manusia Biasa </a></div>"
	...
	div2.innerHTML = "<div style='background-color: #2E5392; color: #FFFFFF; border: 1px solid #333333;'><a style='color: #FFFFFF;' onclick='spoiler()' title='Click to Hidden Widget'>&laquo;</a> &#8226; <a href='https://twitter.com/RifqiCooLBoyz' style='color: #FFFFFF;' onclick='alert(\'Thanks for install this script\');'>@RifqiCooLBoyz </a></div> "
	...
	for(i=1;i<=20;i++) {
		...
		div2.innerHTML = "<a onclick='spoiler()' title='Click to Hidden Widget'>&laquo;</a> &#8226; <a href='http://facebook.com/Rifqi.CooL.Boyz' title='Manusia Biasa'>@RifqiCooLBoyz</a>"
		}
		else {
