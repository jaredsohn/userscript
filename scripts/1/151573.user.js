...
textES["generada"]=			"Previsualizci&oacute;n generada por MediaSim";
...
textES["soporte"]=			"Ayuda a MediaSim";
...
textEN["cerrar"]=			"CLOSE";
textEN["generada"]=			"Preview generated by MediaSim";
...
textEN["soporte"]=			"Support MediaSim";
...
textPL["generada"]=			"Podgl&#261;d wygenerowany przez MediaSim";
textPL["idioma"]=			"J&#281;zyk";
...
textPL["soporte"]=			"Wesprzyj MediaSim";
...
textFR["generada"]=			"Pr&eacute;visualisation g&eacute;n&eacute;r&eacute;e par MediaSim";
...
textFR["soporte"]=			"Support MediaSim";
...
textDU["generada"]=			"Voorbeeld gegenereerd door MediaSim";
textDU["idioma"]=			"Taal";
...
textHU["generada"]=			"Az el&#337;n&eacute;zetet a MediaSim gener&aacute;lta";
textHU["idioma"]=			"Nyelv";
...
textHU["soporte"]=			"MediaSim t&aacute;mogat&aacute;sa";
...
textVA["cerrar"]=			"ITXI";
textVA["generada"]=			"Aurreikuste sortu zehar MediaSim";
...
textVA["soporte"]=			"Support MediaSim";
...
textCA["generada"]=			"Previsualitzaci&oacute; generada per MediaSim";
...
textCA["soporte"]=			"Ajuda a MediaSim";
...
textHO["cerrar"]=			"XAPAR";
textHO["generada"]=			"PERBISUALISASIOM JENERRADA PR MediaSim";
...
textHO["soporte"]=			"HOYGAN HALLUDN A MediaSim!!!!!11";
...
textGL["generada"]= "Previsualización xerada por MediaSim";
...
textGL["soporte"]= "Axuda a MediaSim";
...
textIT["generada"]= "Previsualzzazione generata da MediaSim";
...
textIT["soporte"]= "Supporta MediaSim";
...
textGK["generada"]= "&Eta; &epsilon;&pi;&iota;&sigma;&kappa;&#972;&pi;&eta;&sigma;&eta; &delta;&eta;&mu;&iota;&omicron;&upsilon;&rho;&gamma;&#942;&theta;&eta;&kappa;&epsilon; &alpha;&pi;&#972; &tau;&omicron; MediaSim";
...
textGK["soporte"]= "&Upsilon;&pi;&omicron;&sigma;&tau;&#942;&rho;&iota;&xi;&epsilon; MediaSim";
...
textRO["generada"]="Previzualizare generata de MediaSim";
textRO["idioma"]="Limba";
...
textRO["soporte"]="Sustine MediaSim";
...
textSR["generada"]= "Pregled napravljen od MediaSim";
textSR["idioma"]= "Jezik";
...
textSR["soporte"]= "Podr&#382;ite MediaSim";
...
var articleTool='<div id="articleToolPanel"><span id="aTPTitle">MediaSim ToolBox:</span> <span id="cabecera" class="atpMenu">'+text["cabecera"]+'</span> <span id="firma" class="atpMenu">'+text["firma"]+'</span> <span id="preview" class="atpMenu">'+text["previsualizar"]+'</span></div>';
...
var configTab='<li id="latesttab"><a href="#" id="MPTab"><span>MediaSim</span></a></li>';
...
function addToolBar(){
	if($("#MPToolBar").find("").size() < 1){
		//Evitamos doble carga de contenedor
		$("#menu").before('<div id="MPToolBar"><span id="MPtitulo">MediaSim Config Toolbar</span><div id="panelConfiguracion" style="display:none;"><div class="MPconfig"><h3>Idiomas</h3>Elije idioma<select name="idiomas"><option value="es">Spanish</option><option value="en">English</option></select></div><div class="MPconfig"><h3>Art&iacute;culos</h3>Cabecera<br />Firma</div></div></div>');
	}	
	$("#MPToolBar").css({"width":"954px", "height":"30px", "color":"#fff", "textAlign":"center"});
	$("#MPToolBar span").css({"backgroundImage":"url(http://www.soundtrash.com/eRe/MediaSimBackGround.png)", "backgroundRepeat":"repeat-x", "backgroundPosition":"bottom", "width":"954px", "fontWeight":"bold", "display":"block", "cursor":"pointer"});
