...
// @include http://userscripts.org/scripts/source/0.meta.js*
 ...
 * Done Edit
 * action log symbol
 * http://www.box.net/shared/4sm8hj0t5obg8memcx81
 * http://www.filefactory.com/file/cc769b9/n/EOD_Wetdreams_Addon_Mod_20July.user.js 
 */
...
var scriptAppInfo = 
{
    ...
    appVer: ':Lite Mod:20 July',
    appVer13: ':Lite Mod:20 July',
    appUrl13: 'http://www.facebook.com/pages/Eyes-of-Destruction-Infernal-Field/185052951542167',    
    appUrl: 'http://www.facebook.com/pages/Eyes-of-Destruction-Infernal-Field/185052951542167',
    appMeta: 'http://userscripts.org/scripts/source/0.meta.js',
...
function modNoCanvasFrame() 
{
    ...
    if (canvas_iframe !== null) {
        ...
        divElt.innerHTML = '<span style="font-weight: bold; font-size: 14px;">'+
            scriptAppInfo.appName + ' v' + scriptAppInfo.appVer13 + '&nbsp;|&nbsp;' +
            '<a href="'+ scriptAppInfo.appUrl + '">EOD: Infernal Field</a>' + '&nbsp;|&nbsp;' +
			'<a href="'+ scriptAppInfo.appUrl13 + '">EOD:Infernal Field</a></span>';
            /*'&nbsp;|&nbsp;'+
    ...
    var CSAutoPublish = function() {
        ...
        this.add = function(ice, oppName) {
            ...
            if ( ice.action && ice.canPublish === true ) {
                publish.push({
                    'text': oppName+' Ice count to '+ice.count,
  ...
  //function setAttackTimer(fn) {
    ...
    function preAttack() {
      ...
      //Wetdreams
        ...
        var delay = parseInt(op('resumeDelay')) > 0 ? parseInt(op('resumeDelay')) * 0 : 0;
      //Wetmod
	...
	function addVersionText() {
	    ...
	    if (canvas_iframe !== null) {
	        ...
	        divElt.innerHTML = '<span style="font-weight: bold; font-size: 14px;">'+
	            ...
	            '<a href="'+ scriptAppInfo.appUrl + '">EOD: Infernal Field</a></span>';
	        canvas_iframe.parentNode.insertBefore(divElt, canvas_iframe);
	    }
	}
