...
*/
    attack_units['RedBloodCamp'][4][vampire bats] = {type:TROOP, qty:12000};
    attack_units['RedBloodCamp'][4]["Twilight Warfare"] = {type:TECHNOLOGY, level:5};
    attack_units['RedBloodCamp'][4]["Spectral Vision"] = {type:TECHNOLOGY, level:3};
    attack_units['RedBloodCamp'][4]["Endurance"] = {type:TECHNOLOGY, level:5};
    attack_units['RedBloodCamp'][4]["Blood Transfusions"] = {type:TECHNOLOGY, level:1};
/*
    attack_units['RedBloodCamp'][4][IMPALERS] = {type:TROOP, qty:1000};
    attack_units['RedBloodCamp'][4]["Twilight Warfare"] = {type:TECHNOLOGY, level:5};
    attack_units['RedBloodCamp'][4]["Spectral Vision"] = {type:TECHNOLOGY, level:3};
    attack_units['RedBloodCamp'][4]["Endurance"] = {type:TECHNOLOGY, level:5};
    attack_units['RedBloodCamp'][4]["Blood Transfusions"] = {type:TECHNOLOGY, level:1};
