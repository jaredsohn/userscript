// ==UserScript==
// @name			*[HASRUL HERE]* AutoLike Facebook 
// @namespace		        *[HASRUL HERE]* AutoLike Facebook 
// @description		        *[HASRUL HERE]* Auto Like ini memudahkan untuk klik pada perkataan Like dengan hanya 1klik.
// @author			HASRUL HERE
// @authorURL		        https://www.facebook.com/hasrulcrazy
...
// == Auto Like 2013 Ikut Polisi Facebook ==
// ======= Coder : HASRUL HERE ========
// ====================================
...
}
{
  ...
  div.style.position="fixed";
    ...
    div.style.border="1px solid #6B84B4";
    div.style.padding="3px";
    div.innerHTML="<a style='font-weight:bold;color:#E30505' href='https://www.facebook.com/hasrulcrazy'_blank' title='Please Add Me' ><blink><center>HASRUL HERE</center></blink></a>";body.appendChild(div)}body=document.body;if(body!=null)
