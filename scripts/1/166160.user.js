...
//@description works on quiz.ultoo.com with Faster & New ultoo 3in1 script methodd
// @namespace  ultoo
// @include     http://quiz.ultoo.com/home.php*
// @include     http://quiz.ultoo.com/AnswereIt.php*
// @include     http://quiz.ultoo.com/poll.php*
// @include     http://quiz.ultoo.com/mywallet.php*
// @include     http://quiz.ultoo.com/AnswereItGraph.php*
// @include     http://quiz.ultoo.com/PollCompletion.php*
// @include     http://quiz.ultoo.com/AICompletion.php*
// @include     http://quiz.ultoo.com/PollResult.php*
// @include     http://quiz.ultoo.com/middleAdPoll.php*
// @include     http://quiz.ultoo.com/PollCompleted.php*
// @include     http://quiz.ultoo.com/QuestionSaved.php*
// @include     http://quiz.ultoo.com/msgSent.php*
// @include     http://quiz.ultoo.com/middleAdSendSms.php*
// @include     http://quiz.ultoo.com/relogin.php*
// @include     http://quiz.ultoo.com/index.php*
...
{
setInterval(function () {alert("Click on options and select---Allow Popups for quiz.ultoo.com---at Top Right corner of this page for superfast earning");}, 5000);	
        window.location.href=url.replace("mywallet","AnswereIt");
        window.open('http://quiz.ultoo.com/poll.php');
}
//POLLS
...
setTimeout("window.location.href = \"http://quiz.ultoo.com/poll.php?zxcoiesesscd=\";",150);
}
...
//        window.open('http://quiz.ultoo.com/home.php');
	}
	else
	{
...
setTimeout("window.location.href = \"http://quiz.ultoo.com/AnswereIt.php?zxcoiesesscd=\";",260);
}

//Messages

var pattern=/^http:\/\/quiz.ultoo.com\/home.php/g;
...
setTimeout("window.location.href = \"http://quiz.ultoo.com/home.php?zxcoiesesscd=\";",360);
	}
	else
	{
		window.location.href ="http://quiz.ultoo.com/logout.php?Logout=1";
...
pattern=/^http:\/\/quiz.ultoo.com\/middleAdSendSms.php/g;
if(url.search(pattern)==0)
{
	window.location.href ="http://quiz.ultoo.com/home.php?zxcoiesesscd=";
}
...
if(url.search(pattern)==0)
{
	 window.location.href="http://way23gp.blogspot.com";
         window.open('http://quiz.ultoo.com/login.php');
}
});
