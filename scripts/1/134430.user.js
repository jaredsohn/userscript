...
// @name        Damages Report Script for UMA
// @namespace   eRepublikBattlesReporter_UMA
// @version		0.0.1
// @uso:version 0.0.1
// @include		http://*erepublik.com/*/military/battlefield/*
// @description    eRepublik Damage Reporting script for UMA
// ==/UserScript==
...
if(window.location.href.indexOf(PAGE_BATTLEFIELD) > 0) {	
	...
	/***********************************************************************************/
	var FORM_URL = "https://docs.google.com/spreadsheet/viewform?formkey=dGZxcEpmM2hqQWUydlJOR2FPS0FIaGc6MA#gid=0";
	var FORM_FIELDS = {
                eday: "entry.0.single",
                name: "entry.2.single",
	...
	var LOCALE = {
		en:function() {
			return {
				locale: "en_US",
				no_damage: "Пустий звіт неможливо відправити, вбий хоча б одного противника.",
				send_report: "Відіслати звіт?",
				button_send: "Відіслати звіт командиру",
				round_end: "Раунд закінчено, бажаєте відіслати звіт?",
				damage: "Дамаг",
				report: "Звіт",
				report_title: "Звіт для командира УВА",
				report_failed: "Виникла помилка при відсиланні звіту. Спробуйте ще раз"
			};
		},
		ru: function() {
			return {
