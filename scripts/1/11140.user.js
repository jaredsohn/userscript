// ==UserScript==
// @name           oGame Flight Calculator
// @namespace      
// @description    Calculates Flight Time
...
var calcTextoBotao  = 'Show calculator';
...
function CriarCalculador ()
{
	...
	// Opcao 1
	dc += '<tr><td class="c">Flight Calculator</td></tr>';
	dc += '<tr><th style="text-align: left;"> <a href="#" onClick="var obj = document.getElementById(\'PCD\'); if (obj.style.display == \'none\') obj.style.display = \'block\'; else obj.style.display = \'none\';"> 1. To the planet next to you </a></th></tr>';

	// CD
	dc += '<tr><th>';
	dc += '<table id="PCD" style="display: none" width="100%" border="0">';
	dc += '<tr><td width="80%">At what speed percentage? </td><td><input type="text" id="pcd_porc" size="4"></td></tr>';
	dc += '<tr><td width="80%">What is the speed of the slowest ship? </td><td><input type="text" id="pcd_velo" size="4"></td></tr>';
	dc += '<tr><td width="80%">Flight time: <span id="pcd_hor"></span><span id="pcd_min"></span><span id="pcd_seg"></span></td><td>';
	dc += '<input type="button" value="See" onClick="';
	...
	dc += '</th></tr>';
 	...
 	// Opcao 2
	dc += '<tr><th style="text-align: left;"><a href="#" onClick="var obj = document.getElementById(\'MSS\'); if (obj.style.display == \'none\') obj.style.display = \'block\'; else obj.style.display = \'none\';"> 2. In the same solar system </a></th></tr>';
	
	// In the same solar system
	dc += '<tr><th>';
	dc += '<table id="MSS" style="display: none" width="100%" border="0">';
	dc += '<tr><td width="80%">At what speed percentage? </td><td><input type="text" id="mss_porc" size="4"></td></tr>';
	dc += '<tr><td width="80%">What is the speed of the slowest ship? </td><td><input type="text" id="mss_velo" size="4"></td></tr>';
	dc += '<tr><td width="80%">How many planets between you? </td><td><input type="text" id="mss_plan" size="4"></td></tr>';
	dc += '<tr><td width="80%">Flight Time: <span id="mss_hor"></span><span id="mss_min"></span><span id="mss_seg"></span></td><td>';
	dc += '<input type="button" value="Ser" onClick="';
	...
	// Opcao 3
	dc += '<tr><th style="text-align: left;"><a href="#" onClick="var obj = document.getElementById(\'MG\'); if (obj.style.display == \'none\') obj.style.display = \'block\'; else obj.style.display = \'none\';"> 3. In the same galaxy </a></th></tr>';

	// In the same galaxy
	dc += '<tr><th>';
	dc += '<table id="MG" style="display: none" width="100%" border="0">';
	dc += '<tr><td width="80%">At what speed percentage? </td><td><input type="text" id="mg_porc" size="4"></td></tr>';
	dc += '<tr><td width="80%">What is the speed of the slowest ship? </td><td><input type="text" id="mg_velo" size="4"></td></tr>';
	dc += '<tr><td width="80%">How many systems between you?</td><td><input type="text" id="mg_sist" size="4"></td></tr>';
	dc += '<tr><td width="80%">Flight time: <span id="mg_hor"></span><span id="mg_min"></span><span id="mg_seg"></span></td><td>';
	dc += '<input type="button" value="See" onClick="';
	...
	// Opcao 4
	dc += '<tr><th style="text-align: left;"><a href="#" onClick="var obj = document.getElementById(\'EG\'); if (obj.style.display == \'none\') obj.style.display = \'block\'; else obj.style.display = \'none\';"> 4. In a  different galaxy </a></th></tr>';

	// Between galaxies
	dc += '<tr><th>';
	dc += '<table id="EG" style="display: none" width="100%" border="0">';
	dc += '<tr><td width="80%">At what speed percentage? </td><td><input type="text" id="eg_porc" size="4"></td></tr>';
	dc += '<tr><td width="80%">What is the speed of the slowest ship? </td><td><input type="text" id="eg_velo" size="4"></td></tr>';
	dc += '<tr><td width="80%">How many galaxies between you?</td><td><input type="text" id="eg_gala" size="4"></td></tr>';
	dc += '<tr><td width="80%">Flight time: <span id="eg_hor"></span><span id="eg_min"></span><span id="eg_seg"></span></td><td>';
	dc += '<input type="button" value="See" onClick="';
