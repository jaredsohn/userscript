...
// @namespace  http://kisexu.com/huami/
// @version    0.4.x
// @description  花密 Flower Password --- 可记忆的密码管理方案
// @include    http://*
// @include    https://*
// @require    http://lib.sinaapp.com/js/jquery/1.7/jquery.min.js
// @require    http://file.kisexu.com/fp/js/md5.js
    ...
    function lazyInject() {
        ...
        $('body').append(
            '<div id="flower-password-input" style="display: none;">' +
        	    ...
        	    '<p id="flower-password-hint">· 记忆密码：可选择一个简单易记的密码，用于生成其他高强度密码。<br>· 区分代号：用于区别不同用途密码的简短代号，如淘宝账号可用“taobao”或“tb”等。<br>· 按Enter键或Esc键关闭本窗口。<br>· 花密官网地址：<a href="http://kisexu.com/huami/" target="_blank">http://kisexu.com/huami/</a></p>' +
        	'</div>'
        );
