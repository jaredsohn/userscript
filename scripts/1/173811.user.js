...
//---------------------------------------------------------------
		...
		//音乐搜索/////////////////////////////////////////////////////////////////////////////////////////////////////////////////////
			{name:"谷歌音乐",
				url:/^https?:\/\/www\.google\.cn\/music/i,
				enabled:true,
				engineList:"music",
				style:"\
		...
		//翻译/////////////////////////////////////////////////////////////////////////////////////////
			...
			{name:"海词",
				...
				insertIntoDoc:{
					keyword:'css;#q',
					target:'css;.cont-bottom.clearFix',
					where:'beforeBegin',
				},
			},
		...
		var icons={
			...
			,v56:'http://www.56.com/favicon.ico'
                        ,digikey:'http://www.digikey.com/favicon.ico'
                        ,WK:'http://www.dzsc.com/favicon.ico'
                        ,suning:'http://www.suning.com/favicon.ico'
                        ,yixun:'http://www.yixun.com/favicon.ico'
                        ,cecb2b:'http:/www.cecb2b.com/favicon.ico'
                        ,JG:'http://www.findchips.com/favicon.ico'
                        ,IC:'http://www.findchips.com/favicon.ico'
                        ,pdf:'http://www.alldatasheet.com/favicon.ico'
                        ,pdf2:'http://img.china.alibaba.com/favicon.ico'
			...
			,youku:'http://www.youku.com/favicon.ico'
			...
			,downg:'http://www.downg.com/favicon.ico'
		};
		...
		//网页搜索列表
		list.web=[];
		list.web[0]=['Google','http://www.google.com.hk/search?hl=zh-CN&newwindow=1&safe=off&ie=utf-8&oe=utf-8&q=%s',icons.google]
		list.web[2]=['百度','http://www.baidu.com/s?wd=%s&ie=utf-8',icons.baidu]
		list.web[3]=[' 华强网 ','http://www.hqew.com/ic/%s.html']
		list.web[4]=[' 查货 ','http://www.digikey.cn/scripts/dksearch/dksus.dll?vendor=0&amp;keywords=%s',icons.digikey]
		list.web[5]=[' 价格 ','http://www.findchips.com/avail/?part=%s',icons.JG]
		list.web[6]=[' 查货英文 ','http://www.digikey.com/product-search/en?x=0&y=0&KeyWords=%s',icons.digikey]
		list.web[7]=[' 查询PDF ','http://www.datasheetarchive.com/?q=%s',icons.pdf]
		list.web[8]=[' 阿里巴巴 ','http://s.1688.com/selloffer/offer_search.htm?keywords=%s',icons.pdf2]
                list.web[9]=[' 维库 ','http://www.dzsc.com/ic/sell_search.html?keyword=%s&fengzhuang=&addr=&imageField3.x=0&imageField3.y=0',icons.WK]
		list.web[11]=['IC交易网','http://www.ic.net.cn/partsearch/%s.html',icons.IC]
...
//视频搜索列表
		...
		list.music[1]=['谷歌音乐','http://www.google.cn/music/search?q=%s',icons.google]
		...
		list.image[0]=['谷歌图片','https://www.google.com.hk/search?tbm=isch&q=%s',icons.google]
		...
		list.download[2]=['狗狗','http://www.gougou.com/search?search=%s&id=utf-8',icons.gougou]
		list.download[3]=['极影','http://bt.ktxp.com/search.php?keyword=%s',icons.ktxp]
		list.download[6]=['下载吧','http://www.xiazaiba.com/word/%s',icons.xiazaiba]
		list.download[4]=['绿盟','http://www.xdowns.com/tag.asp?keyword=%s',icons.xdowns,'gbk']
		list.download[5]=['绿色下载','http://search.downg.com/search.asp?action=s&sType=ResName&keyword=%s',icons.greendown,'gbk']
		list.download[1]=['射手字幕','http://shooter.cn/search/%s',icons.shooter]
		list.download[7]=['天空软件','http://www.skycn.com/search.php?ss_name=%s',icons.skycn,'gbk']
		list.download[8]=['太平洋','http://ks.pconline.com.cn/download.jsp?q=%s',icons.pconline,'gbk']
		list.download[9]=['华军','http://search.newhua.com/search_list.php?searchname=%s',icons.newhua]
		...
		list.shopping[4]=['易迅','http://searchex.yixun.com/html?area=1001&charset=utf-8&as=1&key=%s',icons.yixun,'gbk']
		list.shopping[5]=['苏宁','http://search.suning.com/emall/search.do?keyword=%s',icons.suning,'gbk']
		list.shopping[6]=['新蛋','http://www.newegg.com.cn/Search.aspx?keyword=%s',icons.newegg,'gbk']

		//翻译列表
		list.translate=[];
		list.translate[0]=['百度词典','http://dict.baidu.com/s?wd=%s&ie=utf-8',icons.baidu]
		list.translate[1]=['海词','http://dict.cn/%s',icons.dict]
		list.translate[2]=['爱词霸','http://www.iciba.com/%s/',icons.iciba]
		list.translate[3]=['沪江日语','http://dict.hjenglish.com/app/jp/cj/%s',icons.hj]
		list.translate[4]=['沪江英语','http://dict.hjenglish.com/app/w/%s',icons.hj]
		list.translate[5]=['有道词典','http://dict.youdao.com/search?q=%s&ue=utf8',icons.youdao]
		list.translate[6]=['谷歌翻译','http://translate.google.com/translate_t?q=%s&oe=utf-8&ie=UTF-8',icons.google]
