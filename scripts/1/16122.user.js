...
// @name 			Shortcuts
// @author 			Starsac
// @description 	Creates Shortcuts in Orkut
...
//addEventListener("load",function(){
	...
	scrap.title		= "View Scrapbook";
	msgs.title		= "Send Message ";
	foto.title		= "View Album";
	video.title		= "View Videos";
	add.title		= "Add as friend";
	
	forum.title		= "View Forum";
	forumnew.title	= "Post New Topic";
	join.title		= "Join Community";
	part.title		= "Sair da Comunidade";
	members.title	= "View Members";

	last.title		= "Enter";
	reply.title		= "Reply to Topic";
