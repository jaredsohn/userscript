...
// @include     *cp.rpg-city.de*funktion=_beschwerden_admin_ansicht*
// @include		*cp.rpg-city.de/index.php?funktion=_admin_beschwerden&ticket=*
// @version     1
// @grant metadaten
// ==/UserScript==

if(document.URL.search(/_beschwerden_admin_ansicht/) != -1)
{
