...
-------------------------------------------------------------------------------------------------------- */
	...
	styleText+='.folder .folder .folder-toggle {height: 8px; margin-left: 8px;top: 6px; width: 8px;}';
...
-------------------------------------------------------------------------------------------------------- */
	...
	/* unread  */
	styleText+='.unread-count {color:#AAA !important}'; //any color you want here
