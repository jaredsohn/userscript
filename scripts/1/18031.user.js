// ==UserScript==
// @name            LEJDU-STOP-LA-NEIGE
// @namespace       Platypus
// @include         http://www.lejdu.com/forum/*
function do_platypus_script() {
do_modify_html_it(window.document,document.evaluate('/HTML[1]/BODY[1]', document, null, XPathResult.FIRST_ORDERED_NODE_TYPE,null).singleNodeValue,/onload/g,'',null);
