// ==UserScript==
// @name           	GCmunzer
// @description     This Script adds a link to the drawQRzee Munzee map on every Geocaching.com Listing page. The map will show the Munzees around the Geocache's location. 
// @namespace      	da-fi.de
  ...
  if (typeof config.fields == "undefined") {
    ...
    config.css = {
      basic: "#GM_config * { font-family: arial,tahoma,myriad pro,sans-serif; }"
             ...
             + '\n' + "#GM_config .section_header { font-size: 13pt; background: #414141; color: #FFF; margin-bottom: 10px;"
...
GM_configStruct.prototype = {
  ...
  open: function () {
    ...
    function buildConfigWin (body, head) {
	  ...
	  bodyWrapper.appendChild(create('div', {
              className: '',
              innerHTML: '<br/><a href="https://www.paypal.com/cgi-bin/webscr?cmd=_s-xclick&amp;hosted_button_id=TX2ZVNY3VU2XC" target="_blank"><img alt="" src="https://www.paypalobjects.com/en_US/i/btn/btn_donate_LG.gif"></a><a href="http://flattr.com/thing/1230880/GCmunzer-Userscript" target="_blank"><img style="margin-left:30px;" src="http://api.flattr.com/button/flattr-badge-large.png" alt="Flattr this" title="Flattr this" border="0" /></a>'
            }));
    ...
    var defaultStyle = 'position:fixed; top:0; left:0; opacity:0; display:none; z-index:1001;' +
                       'width:55%; height:65%; max-height:95%; max-width:95%;' +
...
$(document).ready(function(){
	//init Config
	GM_config.init('GCmunzer Settings',{
	  munzername:		{ section: ['GCmunzer Configuration', ''], label: ' Munzee.com Username:', type: 'text', default: 'name' },
	  ex_own:	{ label: 'exclude own Munzees / eigene Munzees ausblenden:', type: 'checkbox', default: true },
	  ex_cap:	{ label: 'exclude captured Munzees / gefundene Munzees ausblenden:', type: 'checkbox', default: true }
	});
	
	var coords = document.getElementById('ctl00_ContentBody_lnkConversions').href.split("?")[1].split("&");
	var url = "http://da-fi.de/public/munzee/bbmap2.php?" + coords[0] + "&" + coords[1] + "&ex_own=" + confget("ex_own") + "&ex_cap=" + confget("ex_cap") + "&name=" + GM_config.get("munzername");
	
	$("#ctl00_ContentBody_MapLinks_MapLinks li:last").after("<li><a target='_blank' href='" + url + "'>drawQRzee Munzee Map</a></li>");
	$("ul.CacheDetailsNavLinks li:last").after("<li><a target='_blank' href='" + url + "'><img style='width:16px;margin-right:5px;margin-top:2px;' src='http://da-fi.de/public/munzee/pins/munzee.png'><span>drawQRzee Munzee Map</span></a></li>");
	
	//add Config-Button
	$('#ctl00_liNavProfile ul').append('<li class=""><a href="#" id="click_config">GCmunzer Settings</a></li>');
	$('#click_config').click(function() {
		GM_config.open();
	});
});
