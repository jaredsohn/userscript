// ==UserScript==
// @name           	Clodogame - BBCode +
// @author      	Memphis007
// @description    	Ajoute des raccourci BBCode sous la Shoutbox Clodogame
// @maj				Ajout des BBCodes sur la page de rédaction des MPs
// @version			1.3
...
function init_shoutbox_reloaded() {
	...
	unsafeWindow.ddajaxtabs.loadpage = function(page_request, pageurl, tabinstance){
		...
		var target = par_div.getElementsByTagName('input')[0].value;
		par_div.innerHTML = "";
		par_div.style.textAlign='left';
		par_div.appendChild(createElement('style',{type:'text/css'},'#smilies,#buttons { text-align:left;}'));
		par_div.appendChild(createElement('textarea',{id:'f_text',name:name,style:'width:94%',rows:10},value));
		par_div.appendChild(createElement('input',{type:'hidden',value:target,name:'target_pid'}));
		...
		par_div.appendChild(createElement('div',{id:'preview',style:'border:1px solid #222;text-align:left;padding:5px;width:94%;'},'<center>'+language.preview_window+'</center>'));
		editor.addPreview($('prev'),$('preview'));	
		par_div.appendChild(createElement('div',{id:'update',style:'border:1px solid #222;text-align:left;padding:5px;width:94%;'}));
	}
}
...
function init_shoutbox() {
	...
	if(url.match(/write/)) {
		...
		var value = textarea.value;
		var name = 'f_text';
		var par_div_temp = textarea.parentNode;
		var par_div = par_div_temp.parentNode;
		var target = document.getElementById('form1').getElementsByTagName('input')[0].value;
		par_div.innerHTML = "";
		...
		var par_div = textarea.parentNode;
		var target = par_div.parentNode.getElementsByTagName('input')[0].value;
		par_div.innerHTML = "";
		par_div.style.textAlign='left';
	} else {
		var textarea = $('f_text');
	...
	if (url.indexOf("/messages/") == -1) {
		par_div.appendChild(createElement('input',{type:'hidden',value:target,name:'f_did'}));
	} else {
		par_div.appendChild(createElement('input',{type:'hidden',value:target,name:'target_pid'}));
	}
	par_div.appendChild(createElement('div',{id:'smilies',width:'98%'}));
...
function add_funcs() {
	...
	editor.addSmilie('http://static.pennergame.de/img/pv4/shop/cr_FR/inventar/Pfandflasche.png');
	editor.addSmilie('http://static.pennergame.de/img/pv4/icons/att.png');
	editor.addSmilie('http://static.pennergame.de/img/pv4/icons/def.png');
	editor.addSmilie('http://static.pennergame.de/img/pv4/icons/mitleid.png');
	editor.lineBreak();
	...
	editor.addSmilie('http://www.emoticonland.net/smileys/Verts/verts147.gif');
	editor.addSmilie('http://www.emoticonland.net/smileys/Verts/verts136.gif');
	...
	editor.addSmilie('http://www.greensmilies.com/smile/smiley_emoticons_ahhh.gif');
	...
	editor.addSmilie('http://www.greensmilies.com/smile/smiley_emoticons_mazzn_psycho.gif');
	...
	editor.addSmilie('http://www.greensmilies.com/smile/smiley_emoticons_waffe02.gif');
	editor.lineBreak();
	...
	editor.addSmilie('http://www.greensmilies.com/smile/smiley_emoticons_alien6.gif');
	editor.addSmilie('http://www.greensmilies.com/smile/smiley_emoticons_wink_gruen.gif');
	editor.addSmilie('http://nsm08.casimages.com/img/2013/12/06//1312060545347385911796414.gif');
	editor.lineBreak();	
//Décommentez le bloc qui suit en retirant /* */ pour activer les smileys supplémentaires :

/*
//Amour:
	editor.addSmilie('http://smileys.inzenet.org/repository/Amour/0007.gif');
	editor.addSmilie('http://smileys.inzenet.org/repository/Amour/0054.gif');
	editor.addSmilie('http://smileys.inzenet.org/repository/Amour/0059.gif');
	editor.addSmilie('http://smileys.inzenet.org/repository/Amour/bouquet.gif');
//Bastons:
	editor.addSmilie('http://smileys.inzenet.org/repository/Baston%21/boxe1.gif');
	editor.addSmilie('http://smileys.inzenet.org/repository/Baston%21/BOXE_2.GIF');
	editor.addSmilie('http://smileys.inzenet.org/repository/Baston%21/comeandgetsome.gif');
	editor.addSmilie('http://smileys.inzenet.org/repository/Baston%21/22.GIF');
	editor.addSmilie('http://smileys.inzenet.org/repository/Baston%21/BOXER.GIF');
//Boissons:
	editor.addSmilie('http://smileys.inzenet.org/repository/Boissons/trinquer2.gif');
	editor.addSmilie('http://smileys.inzenet.org/repository/Boissons/0024.gif');
	editor.addSmilie('http://smileys.inzenet.org/repository/Boissons/0001.gif');
	editor.addSmilie('http://www.paranoland.com/emoticones-smileys/smileys/boire/08.gif');
	editor.addSmilie('http://www.paranoland.com/emoticones-smileys/smileys/boire/36.gif');
	editor.addSmilie('http://www.paranoland.com/emoticones-smileys/smileys/boire/41.gif');
//Boulets:
	editor.addSmilie('http://smileys.inzenet.org/repository/Boulet/0078.gif');
	editor.addSmilie('http://smileys.inzenet.org/repository/Boulet/0116.gif');
	editor.addSmilie('http://smileys.inzenet.org/repository/Boulet/boulet283.gif');
	editor.addSmilie('http://www.paranoland.com/emoticones-smileys/smileys/boulet/1.gif');
	editor.addSmilie('http://www.paranoland.com/emoticones-smileys/smileys/boulet/5.gif');
	editor.addSmilie('http://www.paranoland.com/emoticones-smileys/smileys/boulet/6.gif');
//Confus:
	editor.addSmilie('http://smileys.sur-la-toile.com/repository/Confus/0030.gif');
	editor.addSmilie('http://smileys.sur-la-toile.com/repository/Confus/non-desol%E9-987.gif');
//Fumeur:
	editor.addSmilie('http://smileys.inzenet.org/repository/Fume/0080.gif');
	editor.addSmilie('http://smileys.inzenet.org/repository/Fume/0066.gif');
	editor.addSmilie('http://www.paranoland.com/emoticones-smileys/smileys/fumeur/9.gif');
	editor.addSmilie('http://smileys.sur-la-toile.com/repository/Fume/canabis-je-vole.gif');
	editor.addSmilie('http://smileys.sur-la-toile.com/repository/Fume/fume-gele.gif');
	editor.addSmilie('http://smileys.sur-la-toile.com/repository/Fume/joint-20060614.gif');
	editor.lineBreak();
*/
	editor.addBBCode('b');
	editor.addBBCode('i');
...
CheckScriptForUpdate = {
 ...
 name: 'Clodogame - BBCode +', // Script Name
 version: '1.3', // Version
 id: '102616', // Script id on Userscripts.org
