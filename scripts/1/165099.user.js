...
// @name			PR UML 1.2
// @version			1.2
// @author			ProfesordeChile
// @namespace		pr_uml
// @description		Plugin para visualizar las Ordenes de Batalla del PR y la UML eChile.
...
// @updateURL		http://userscripts.org/scripts/source/165099.user.js
// @downloadURL		http://userscripts.org/scripts/source/165099.user.js
// ==/UserScript==
function LL_carga() {
...
function header() {
    ...
    //var orders = '<h4>Prioridades de eChile (Beta v1.1)</h4><div id="mod_orders"></div>';
    ...
    $('head').append('<style type="text/css">#battle_listing .prio_do em{color: #ffcc00;}#battle_listing .prio_do li{border-color: #ffcc00;background-color: #ffcc00;}#battle_listing .prio_me li .tank_img{background-position: left -14px;}#battle_listing .prio_me li a.county{background-position: left top;}#battle_listing .prio_me li a.county span{background-color: #000000;color: #8a560c;}#battle_listing .prio_me li a.county:hover{background-position: left top !important;}#battle_listing .prio_me li a{background-position: left -102px;}#battle_listing .prio_me li a span{background-position: right -102px;text-shadow: #a63301 0px -1px 0px;}#battle_listing .prio_me li a:hover{background-position: left -136px;}#battle_listing .prio_me li a:hover span{background-position: right -136px;}#battle_listing .prio_me li a:active{background-position: left -170px;}#battle_listing .prio_me li a:active span{color: #f49e9e;background-position: right -170px;}#battle_listing .prio_me strong{color: #8a560c;}#battle_listing .prio_me small{color: #b16a00;}</style>');
    $('head').append('<script type="text/javascript" src="/js/jquery.tipsy.1334921039.js"></script>');
    var imageHeader = 'http://www.espartako.cl/erepublik/bannerlautaro1.png';
...
function footer() {
	...
	var linkDiv = '';
    switch(x) {
    case 1: linkDiv = 'http://client01.chat.mibbit.com/?channel=%23um.lautaro&server=irc.rizon.net'; break;
    case 2: linkDiv = 'http://client01.chat.mibbit.com/?channel=%23um.lautaro&server=irc.rizon.net'; break;
    case 3: linkDiv = 'http://client01.chat.mibbit.com/?channel=%23um.lautaro&server=irc.rizon.net'; break;
    case 4: linkDiv = 'http://client01.chat.mibbit.com/?channel=%23um.lautaro&server=irc.rizon.net'; break;
    default: linkDiv = 'XX';
    }    
    var imagefooter = 'http://www.espartako.cl/erepublik/cartelpr01.png';
    var orders = '<div class="rest"><img src="'+ imagefooter + '" style="float: none; margin-top:-5px; margin-bottom:-2px" alt="Competencia de Regimientos"/><a href="http://www.espartako.cl/erepublik" title="" target="_blank">Información PR - UML</a><a href="http://www.espartako.cl/erepublik/commanderuml.html" title="" target="_top">News UML</a><a href="http://www.espartako.cl/erepublik/pdtepr.html" title="" target="_top">News PR</a>  <a href="' + linkDiv + '" title="" target="_blank">Chat UMLautaro</a> <a href="http://bit.ly/PRChile" title="" target="_top">Chat P. Rodriguista</a><a href="http://www.erepublik.com/es/newspaper/educar-echile-224968/1" title="" target="_top">Educar eChile</a> <a href="http://bit.ly/escuelita" title="" target="_top">#escuelita on line</a><a href="http://www.erepublik.com/es/newspaper/cultura-y-educacion-202573/1" title="" target="_top">Boletín UeChile</a><a href="http://www.erepublik.com/en/article/2184561/1/20">Crea tu avatar de Lautaro</a> </div>';
...
function nameprio2(i) {
    ...
    case 8: x = 'CAPITANES PONER LA DO AQUI'; break;
    default: x = 'XX';
    }    
	return x;
}
function infoprio(i) {
    ...
    switch(i) {
        ...
        case 7: x = 'NO LUCHAR: Se necesita perder la campaña por asuntos estrategícos. NO luches en esta campaña, debemos perderla.'; break;
 		case 8: x = 'ORDEN DIARIA: Capitán debes poner tu orden diaria en esta batalla.'; break;
...
function battles() {
	var x = division();
    $.get('https://docs.google.com/document/d/1tw1JiZKQuPSEx7bkOXMc1tZdwTcPhjSeJvKWtqUt7Ls/edit', function(data) {
