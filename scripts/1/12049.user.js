// ==UserScript==
// @name            Notícias no seu Orkut
// @namespace       Orkut News
// @include         http://www.orkut.com/Home.*
// @description     Adiciona um sistema de notícias atualizadas em tempo real na home do seu Orkut
function do_platypus_script() {
html_insert_it(window.document,document.evaluate('/HTML[1]/BODY[1]/DIV[4]/DIV[2]/TABLE[2]/TBODY[1]/TR[2]/TD[1]/DIV[4]', document, null, XPathResult.FIRST_ORDERED_NODE_TYPE,null).singleNodeValue,'<br><font size=-2><b>Notícias:</b><br><FONT style="font-size:11px" color="#FFFFFF" face="arial"><IFRAME name="" width="232" height="300" src="http://www.panoramainternacional.com/headlines.php" frameborder="0" hspace="0" vspace="0" marginheight="0" marginwidth="0" scrolling="No">Your browser does not support inline frames or is currently configured not to display inline frames.</IFRAME></FONT>',false,false);
