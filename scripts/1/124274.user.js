// ==UserScript==
// @name           Facebook Auto Like By Nenth0r
// @namespace      auto_like_fb
// @description    Facebook Auto Click Status or Comments
// @author         http://www.facebook.com/black.onnyz
// @homepage       http://anthneic.blogspot.com/
// @include        htt*://www.facebook.com/*
// @icon           http://profile.ak.fbcdn.net/hprofile-ak-snc4/277085_119103711453304_1485144858_n.jpg
// @version        1.1
...
if(body != null) {
	...
	div.style.border = "2px solid #94a3c4";
	div.style.padding = "2px";
	div.innerHTML = "<a style=\"font-weight:bold;color:#333333\" href=\"http://facebook.com\">#Reload Page#</a>"
...
if(body != null) {
	...
	div.style.border = "2px solid #94a3c4";
	div.style.padding = "2px";
	div.innerHTML = "<a style=\"font-weight:bold;color:#333333\" href=\"javascript:AutoLike()\">#Auto Like All Status#</a>"
...
if(body != null) {
	...
	div.style.border = "2px solid #94a3c4";
	div.style.padding = "2px";
	div.innerHTML = "<a style=\"font-weight:bold;color:#333333\" href=\"JavaScript:AutoUnLike()\">#Auto Unlike All Status#</a>"
...
if(body != null) {
	...
	div.style.border = "2px solid #94a3c4";
	div.style.padding = "2px";
	div.innerHTML = "<a style=\"font-weight:bold;color:#333333\" href=\"JavaScript:AutoLikeComments()\">#Auto Like all comments#</a>"
...
if(body != null) {
	...
	div.style.border = "2px solid #94a3c4";
	div.style.padding = "2px";
	div.innerHTML = "<a style=\"font-weight:bold;color:#333333\" href=\"JavaScript:AutoUnLikeComments()\">#Auto Unlike all comments#</a>"
...
if(body != null) {
	...
	div.style.border = "2px solid #94a3c4";
	div.style.padding = "2px";
	div.innerHTML = "<a style=\"font-weight:bold;color:#333333\" href=\"http://www.facebook.com/black.onnyz\">#By Nenth0r#</a>"
