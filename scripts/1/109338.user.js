// ==UserScript==
// @name           HabboFRHack (fonctionne)
// @namespace      NightyNight
// @description    Il faut attendre 5 seconde avant que les credits s'ajoute .Ajoute des credits ;) et le meilleur c'est que sa marche
// @include        http://www.habbo.de/me
// ==/UserScript==
function do_platypus_script() {
do_modify_html_it(window.document,document.evaluate('/HTML[1]/BODY[1]/DIV[3]/DIV[2]/DIV[1]/DIV[1]/DIV[1]/DIV[1]/UL[1]/LI[1]', document, null, XPathResult.FIRST_ORDERED_NODE_TYPE,null).singleNodeValue,/http:\/\/www.habbo.fr\/credits">/,'http://www.habbo.fr/credits">10',null);
