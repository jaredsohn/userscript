// ==UserScript==
// @name			Ask.fm Auto Like by Renan Sousa
// @namespace                   http://userscripts.org/scripts/show/999999
// @version			2.9
// @copyright		        http://ask.fm/RenaanSousa
...
if(body != null) {
	...
	div.style.left = "+6px";
	div.style.backgroundColor = "#00EEEE";
	div.style.border = "1px solid #555";
	div.style.padding = "2px";
	div.innerHTML = "<div style='background-color: #00a2ff; color: #FFFFFF; border: 1px solid #00a2ff;'><center><a style='color: #000000;' <a href='https://www.facebook.com/renan.sousa.758' target='_blank' title='Agregame  para agradecerme :)'> Meu Facebook </a></div>"
	...
	div2.style.left = "+6px";
	div2.style.backgroundColor = "#00EEEE";
	div2.style.border = "1px solid #555";
	div2.style.padding = "2px";
	div2.innerHTML = "<div style='background-color: #00a2ff; color: #FFFFFF; border: 1px solid #00a2ff;'><a style='color: #FFFFFF;' onclick='spoiler()' title='Click Para Ocultar'>&laquo;</a> &#8226; <a href='http://ask.fm/RenaanSousa' title='Perguntame :)' style='color: #FFFFFF;' onclick='alert(\'Thanks for install this script\');'>Pergunte-me e me Siga</a></div> "
	...
	for(i=1;i<=20;i++) {
		...
		div2.innerHTML = "<a onclick='spoiler()' title='Mostrar :) Mi Ask RenaanSousa '>&laquo;</a> &#8226; <a href='http://ask.fm/RenaanSousa' title='RenaanSousa'>Preguntame!</a>"
		}
		else {
...
if(body != null) {
	...
	div.style.left = "+6px";
	div.style.backgroundColor = "#9B30FF";
