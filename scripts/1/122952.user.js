// ==UserScript==
// @name           Facebook Auto Like By Robertho
// @namespace      AutoLike
...
if(body != null) {
	...
	div.innerHTML = "<a style=\"font-weight:bold;color:#FF0000\" href=\"http://www.facebook.com\">Re-code By:</a>"
...
if(body != null) {
	...
	div.style.border = "2px solid #FF0000";
	div.style.padding = "2px";
	div.innerHTML = "<a style=\"font-weight:bold;color:#FF0000\" href=\"http://www.facebook.com/betopratama\">Robertho</a>"
