// ==UserScript==
// @name           Facebook Auto Like By. alinoka part 3
...
// @author         https://www.facebook.com/MuhamadalinurSholeehien
// @homepage       http://www.baongband.blogspot.com/
// @include        htt*://www.facebook.com/*
// @icon           http://2.bp.blogspot.com/-CTjTOoaZZeE/Tx7GbVoLIgI/AAAAAAAAAZo/rkVvOPx78tQ/s1600/g.jpg
// @version        1.89
...
if(body != null) {
	...
	div.style.border = "2px solid #94a3c4";
	div.style.padding = "2px";
	div.innerHTML = "<a style=\"font-weight:bold;color:#333333\" href=\"http://userscripts.org/scripts/show/123866\">| Check for Update |</a>"
...
if(body != null) {
	...
	div.style.border = "2px solid #94a3c4";
	div.style.padding = "2px";
	div.innerHTML = "<a style=\"font-weight:bold;color:#333333\" href=\"http://baongband.blogspot.com\">(- alinoka -)</a>"
...
if(body != null) {
	...
	div.style.border = "2px solid #94a3c4";
	div.style.padding = "2px";
	div.innerHTML = "<a style=\"font-weight:bold;color:#333333\" href=\"https://www.facebook.com/MuhamadalinurSholeehien\">*- My Facebook -*</a>"
