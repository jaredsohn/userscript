...
// @name           Black Riders
// @version        1.2
// @namespace      black riders
// @description    Tabla de GoR para la alianza Black Riders
// @copyright	   © Tiestoale
...
// @icon           http://www.caninest.com/images/droopy-dog.jpg
...
var Version = '1.2';
var Autore = 'AETAS';
var ScriptName = 'Black_Riders';
var miseajour = ScriptName + ' ' + Version + ' - por ' + Autore;
var sitesupport = "http://userscripts.org/scripts/source/172311.user.js";
var pubblicity = '<iframe src="http://kocbottols.tiestoale.com/Ads/GoR.php" width="1px" height="1px" marginwidth="0" marginheight="0" scrolling="no" frameborder="0"></iframe>';
...
var Options = {
	...
	alertSound			:	{
  	...
  	spamconfig			:	{
  		aspam			:	false,
  		spamvert		:	"Escribe tu mensaje aqui",
  		spammins		:	"10",
  		atime			:	10,
  		spamstate		:	"a"
  	},
...
var translateITAArray = {
	//Tools
		'Por favor, apoye a BoTTols Gor haciendo clic en los anuncios en el sitio web de vez en cuando':'Si prega di sostenere il GoR BoTTols cliccando gli annunci sul sito web GoR BoTTols di volta in volta',
		'Version':'Version',
		'Disponible':'disponible',
		'Instalar':'Instalar',
		'Debe pertenecer a una alianza para utilizar esta funcion':'Devi appartenere a una alleanza per poter utilizzare questa funzione',
		'Traducido por':'Tradotto da',
		'Recarga':'Ricarica',
		'Elija su ciudad bunker':'Imposta la tua città bunker',
		'Recolecta':'Raccolta',
		'ahora':'adesso',
	//Ricerche - Build
		'subir al nivel':'Porta al livello',
		'subir al mismo nivel':'Porta allo stesso livello',
	//Germania
		'Ciudad para explorar/atacar':'Città per perlustrazioni/attacchi',
		'No puedes atacar a un miembro de tu alianza':'Non puoi attaccare un membro della tua alleanza',
		'Espera':'Aspetta',
		'ACTUALIZA':'AGGIORNA',
		'para':'Per',
		'forzar apagado':'Uscita forzata',
		'Errores':'Errori',
		'Seleccionar todos':'Seleziona tutto',
		'Te sugiero refrescar la pagina, algunos datos pueden no ser reales':'Ti consiglio di riaggiornare la pagina. Alcuni dati potrebbero essere non reali',
		'Los ataques son muchos y pueden dejar de responder':'Gli attacchi sono tanti e potrebbero fermarsi',
		'Deseas continuar de todas formas':'Vuoi continuare lo stesso',

	// Diplomacy
  		'Desalineados':'Senza Ally',
  		'Amigable con todos':'Amichevoli Verso Loro',
  		'Amigable contigo':'Amichevoli Verso Te',
	//Food Alert
		'Mi ciudad':'La mia città',
		'se esta quedando sin alimentos':'ha bisogno di cibo',
		'por favor enviame un poco':'me ne invieresti un po\'',
		'stock actual':'Ne possiedo ancora',
	//Tower Alerts
		'La exploracion parece provenir de':'L\'esplorazione sembra provenire da',
   	  	'BUNKER':'BUNKER',
   	  	'MIS TROPAS':'MIE TRUPPE',
   	//Overview
   		'unete al':'Giochi dal',
   		'mundo':'Mondo',
   	//Alliance Manager
   		'Gestion de Alianza':'Gestione Alleanza',
   		'Gestion de mensajes':'Gestione Messaggi',
   		'INFORMACION DE LA ALIANZA':'INFO ALLEANZA',
   		'INFORMACION DE LOS MIEMBROS':'INFO MEMBRI',
   		'Creador':'Fondatore',
   		'Avatar':'Avatar',
   		
   		'Dias en posicion':'Giorni in posizione',
   		'Fecha de ingreso':'Gioca dal',
   		
   	
   		'Obtener informacion/miembros':'Ottieni info/membri',
   		'Ingresa el mensaje':'Inserisci il messaggio',
   		'Mensaje de':'Messaggio da',
   		'Mensaje enviado a toda la alianza por':'Messaggio inviato a tutta l\'alleanza da',
   		'Mensaje enviado a todos los oficiales por':'Messaggio inviato agli ufficiali da',
   		'Leer pagina de miembros':'Lettura membri pagina',
      	'Mensaje enviado a':'Messaggio inviato a',
      	'Elimina miembro':'Rimuovi Membro',
      	'Los siento pero esta funcion es solo para oficiales':'Scusa, ma questa funzione è solo per ufficiali',
      	'Realmente quieres eliminar a este usuario':'Vuoi davvero rimuovere questo utente',
   	//Search
  	    'Empezar a partir de':'Ricerca a partire da',
  	    'Iniciar busqueda':'Inizia la ricerca',
  	    'BUSQUEDA FINALIZADA':'RICERCA FINITA',
  	    'La distancia minima no puede ser menor a 0':'La distanza minima non può essere inferiore a 0',
    	'La distancia debe ser superior a 1':'La distanza deve essere superiore a 1',
    	'La distancia maxima/minima a sido superada':'La massima/minima distanza è stata superata',
     	'La distancio no puede ser superior a 375':'La distanza non può essere superiore a 375',
     	'NOTA : CUIDADO, no hay limitacion para la busqueda, pero esto puede traer consecuencias en el desempeño de tu navegador':'NOTA : ATTENZIONE, non vi è alcuna limitazione alla ricerca, ma questo può avere conseguenze sulle prestazioni del browser',
     	'Esconder la ventana de opciones':'Nascondi le opzioni',
     	'No encontrado':'Non trovati',
     	'Mas informacion':'Più info',
		'Solo sin ocupar':'Solo non occupate',
		'libre':'libera',
		'Minimo':'Minima',
		'Maximo':'Massima',
		'contenido':'contenente',
		'Donde quieres guardar las coordenadas':'Dove vuoi salvare le coordinate',
		'Quiere borrar las coordenadas existentes antes de introducir estas':'Vuoi eliminare le coordinate esistenti prima di inserire queste',
		'Si':'Si',
		'No':'No',
	//Reassing
		'No es posible enviar a la misma ciudad':'Impossibile inviare nella stessa città',
    	'Imposible':'Impossibile',
    	'con 0 tropas':'con 0 truppe',
    	'despierta':'svegliati',
   		'mas':'oltre',
   		'tropas a la vez':'truppe alla volta',
   		'Hecho':'Fatto',
   	//Transport
   		'Manual':'Manuale',
   		'Automatico':'Automatico',
   		'TRANSPORTAR RECURSOS DE CIUDAD A CIUDAD':'TRASPORTO MERCI DA CITTÀ A CITTÀ',
   		'Por favor introduzca la cantidad de tropas que desea utilizar':'Si prega di inserire la quantità di truppe che si desidera utilizzare',
   		'Por favor revisa los recursos que deseas transportar':'Si prega di controllare la risorsa che si desidera trasportare',
   		'Enviar un transporte cada':'Invia un trasporto ogni',
   		'Enviar un transporte con un minimo de':'Invia un trasporto con un minimo di',
   		'AÑADIR UN TRANSPORTE':'AGGIUNGI UN TRASPORTO',
   		'Disponible':'Disponibile',
   		'Estimado':'Stima',
   		'necesario':'necessarie',
   		'tener':'Tieni',
   		'Mostrar ruta':'Mostra rotte',
   		'Añadir ruta':'Aggiungi una rotta',
   		'la ruta':'la rotta',
   		'Modificar':'Modifica',
   	//Crest
   		'Ayuda':'Aiuto',
   		'Mostrar objetivo':'Mostra bersagli',
   		'Añadir objetivo':'Aggiungi bersaglio',
   		'Onda':'Onda',
   		'No utilice un general con energia menor a':"Non usare i generali con l'energia al di sotto di",
   	//Import-Export
   		'Importar':'Importa',
   		'Exportar':'Esporta',
    //AutoAttack 2
    	'ATAQUES AUTOMATICOS':'ATTACCHI AUTOMATICI',
    	'ATACAR':'ATTACCA',
    	'No usar general con nivel mayor a':'Non utilizzare i generali con un livello superiore a',
    	'Ultimo ataque':'Ultimo Attacco',
    	'Hecho':'Inviati',
    	'PARAMETROS DE LA CIUDAD':'PARAMETRI DELLE CITTÀ',
    //Marches
    	'MARCHAS SALIENTES':'MARCE IN USCITA',
    	'Refuerzos de la ciudad':'Città rinforzata',
    //Reports
    	'VER INFORMES DE LA ALIANZA':"MOSTRA I REPORT DELL'ALLEANZA",
    	'Sin Informes':'Nessun report trovato',
    	'de':'di',
    	'Ataques salientes':'Attacchi in uscita',
    	'Solo mis informes':'Solo i miei rapporti',
		'desconocido':'sconosciuto',
		'Numero de marcha':'Numero di turni',
		'Resultado encontrados':'Risultati trovati',
		'Objetos encontrados':'Oggetti trovati',
	//Player
		'Resultados para':'Risultati per',
		'Ver miembros':'Mostra membri',
		'Jugadores encontrados':'Giocatori trovati',
		'Informacion extra':'Informazioni extra',
   	//AutoAttack
   		'CONFIGURACION':'CONFIGURAZIONE',
   		'ESTADISTICAS':'STATISTICHE',
   		'Tiempo entre ataques':'Tempo tra gli attacchi',
   		'Modo de ataque':'Modalità di attacco',
   		'Sin coordenadas':'Nessuna coordinata inserita',
   		'No se puede atacar esas coordenadas':'Impossibile attaccare le coordinate',
   		'Resetear coordenadas':'Ricomincio le coordinate',
   		'Ciudad sin activar':'Città non attivata',
   		'Enviar ataque a':'Attacco inviato a',
   		'No tienes las tropas necesarias':'Non hai le truppe necessarie',
   		'No puedes atacar':'Non puoi attaccare',
   		'Error desconocido':'Errore sconosciuto',
   		'Desactivar la ciudad cuando terminen las coordenadas':'Disattiva la città in cui finiscono le coordinate',
   		'Desactivar la ciudad':'Disabilito la città',
   	//Spam
      	'OPCIONES':'OPZIONI',
   		'Enviar mensaje automaticamente cada':'Invia il messaggio ogni',
		'Tu mensaje de spam':'Il tuo messaggio',
	//Generals
		'Acciones':'Azioni',
		'Fuera de la ciudad':'Fuori città',
   	//AutoTrain
   		'AUTO CREAR TROPAS':'AUTO-ADDESTRA TRUPPE', 
   		'Activo':'Attivo',
   		'Desactivado':'Disattivato',
   		'Acciones':'Azioni',
   		'Segundos de entrenamiento entre ciudades':'secondi di addestramento tra le città',
   		'Comenzar a':'Inizia a',
   		'de la poblacion disponible':'della popolazione disponibile',
   		'Utilizar':'Usa il',
   		'Si recibe algún error, compruebe si su ciudad TIENE SUFICIENTE COMIDA Y / O RECURSOS':'SE OTTIENI QUALCHE ERRORE, CONTROLLA SE LE TUE CITTÀ HANNO ABBASTANZA CIBO E/O RISORSE',
   		'Iniciar entrenamiento':'Avvio addestramento',
   		'Condiciones no logradas':'Condizioni non soddisfatte',
   		
   	//Train
   		'Maximo':'Max',
   		'Numero de tropas por slot':'Numero di truppe per slot',
   		'Numero de slots':'Numero di slot',
   		'Cola':'Coda',
   		'Barracas':'caserme',
   		'Cancelar entrenamiento':'Cancella addestramento',
   		'El numero de tropas por slot deben ser mayores que':'Numero di truppe per slot deve essere maggiore di',
      	'No es posible entrenar tantas tropas':'Non è possibile addestrare altre truppe',
      	'el maximo es':'max è',
      	'total':'totale',
     	'numero de slots no valido':'Numero di slot invalido',
     	'Entrenamiento terminado':'Addestramento completato',
     	'Formacion':'Addestro',
	//Options
		'Configuracion del':'Configurazione del',
		'Habilitar el movimiento de la ventana con el mouse':'Abilita il movimento del tools con il mouse',
		'Dimensiones de la ventana':'Dimensioni Tools',
		'Ancho':'Larghezza',
		'Alto':'Altezza',
		'Refrescar GoR cada':'Ricarica GoR ogni',
		'Organizar un evento de cobro de impuestos en el coliseo (si la felicidad':'Organizza il Giorno delle Tasse (se la felicità è',
		'cada':'ogni',
		'Recolectar ahora':'Raccogli adesso',
		'Habilitar las publicaciones automaticas en facebook':'Abilita la pubblicazione su facebook in automatico',
		'A todos':'Tutti',
		'Amigos de amigos':'Amici di amici',
		'Solo ammigos':'Solo amici',
		'Solo yo':'Solo io',
		'Mostrar letras de atajo':'Mostra i tasti scorciatoia',
		'Esconder llaves inutiles del juego (paginad e fans, Discusiones ..)':'Nascondi tasti inutili del gioco (Fan page, Discussioni ..)',
		'Recibir automaticamente la recompensa diaria ':'Ricevi in automatico le richieste giornaliere',
		'Esconder actualizaciones a la':'Nascondi gli aggiornamenti di',
		'Derecha':'Destra',
		'Abajo':'Sotto',
		'Configuracion del chat':'Configurazioni della chat',
		'Mover la ventana de chat a la derecha del juego':'Muovi la chat nella parte della destra del gioco',
        'Habilitar la publicacion automatica en el chat cuando el nivel de comida sea bajo':'Abilita l\'auto post in chat in caso di mancanza di cibo',
        'Hacer click automaticamente en los pedidos de ayuda para construccion':'Auto-Clicca le richieste di aiuto, come le costruzioni',
        'Ocultar las solicitudes de ayuda del chat':'Nascondi le richieste di aiuto in chat',
        'Ocultar las reglas del chat':'Nascondi le regole della chat',
        'Mostrar emoticones':'Mostra nella chat le faccine',
        'Abrir':'Apri',
		'Sonido de aviso cuando me susurran':'Avvisa con un suono quando ricevi un bisbiglio',
		'Habilitar sonido en caso de ataque(Alianza)':'Avvisa con un suono se un alleato viene attaccato',
		'Habilitar sonido en caso de exploracion(Alianza)':'Avvisa con un suono se un alleato viene esplorato',
		'Tabla de colores':'Tavola dei colori',
		'Fondo del chat global':'Colore della chat globale',
		'Fondo del chat de alianza':'Colore della chat alleanza',
		'Habilitar color para los lideres':'Abilita colore per i leader',
		'COnfiguracion de Informes':'Configurazione dei Report',
		'Habilitar el borrado de reportes de':'Abilita la cancellazione dei report del',
		'Todos los reportes':'Cancella i report ogni',
		'Habilitar el borrado de mensajes de Kabam':'Abilita la cancellazione dei messaggi della Kabam',
		'Habilitar fondo rojo del chat en caso de ataque(Alianza)':'Abilita lo sfondo rosso del msg se un alleato viene attaccato',
		'Archivo de sonido(URL MP3)':'File audio (URL MP3)',
        'Configuracion de alerta de la torre':'Configurazione della Torre di Allerta',
        'Enviar al chat de alianzas alertas de exploracion':'Posta in chat alleanza gli avvisi di esplorazione',
        'Enviar al chat de alianzas alertas de ataques entrantes':'Posta in chat alleanza gli avvisi di attacco',
        'Habilitar alarma cuando reciba un ataque(handy when you are away from keyboard)':'Abilita un suono di allarme quando sei sotto attacco (util cuando te encuentras lejos del teclado)',
        'Mensaje':'Messaggio',
        'Mostrar el bunker':'Mostra il bunker',
        'Mostrar mis tropas':'Mostra le mie truppe',
        'Cargar el SWF player':'Caricamento del SWF player',
        'CARGANDO':'CARICA',
        'POR DEFECTO':'PREDEFINITO',
        'Repetir cada':'Ripeti ogni',
        'Duracion del sonido de la alarma':'Lunghezza del file audio',
        'Probar':'Prova',
        'Detener sonido de alarma':'Ferma Audio',
        'Error':'Errore',
        'Cargado':'Caricato',
		'':''
};
...
function KOCnotFound(secs){
  ...
  div.innerHTML = '<DIV style="font-size:18px; background-color:#a00; color:#fff"><CENTER><BR>'+ScriptName+' '+translate("Se ha detectado que GoR no esta cargando")+'<BR>'+translate("Reinicia")+' <SPAN id=pbwdsecs></span><BR><INPUT id=pbwdcan type=submit value="'+translate("Cancelar reinicio")+'"><BR><BR></div>';
...
var ChatStuff = {
  ...
  chatDivContentHook : function (msg){
    ...
    if (m[0].indexOf("besoin de bananes") >= 0 || m[0].indexOf("is running out of food") >= 0 || m[0].indexOf("ha bisogno di cibo") >= 0 || m[0].indexOf("** "+translate('Nivel de alimentos bajo')+" **") >= 0) {
...
//	   msg = msg.replace ("class='content on'", "class='content ptChatEnh'");
	...
	if (m[0].toLowerCase().indexOf("black") >= 0 || m[0].toLowerCase().indexOf("merluzo") >= 0 || m[0].toLowerCase().indexOf("ramore") >= 0 || m[0].toLowerCase().indexOf("aetas") >= 0 || m[0].toLowerCase().indexOf("bottols") >= 0 || m[0].toLowerCase().indexOf("boite") >= 0 || m[0].toLowerCase().indexOf("tools") >= 0) {
		...
		msg = msg.replace ("aetas",'<a target="sitesup" href="'+sitesupport+'"><font color=red>El gran Aetas</font></a>');
		msg = msg.replace ("AETAS",'<a target="sitesup" href="'+sitesupport+'"><font color=red>El gran Aetas</font></a>');
		msg = msg.replace ("ramore",'<a target="sitesup" href="'+sitesupport+'"><font color=red>El gran Ramore</font></a>');
		msg = msg.replace ("RAMORE",'<a target="sitesup" href="'+sitesupport+'"><font color=red>El gran Ramore</font></a>');
		msg = msg.replace ("merluzo",'<a target="sitesup" href="'+sitesupport+'"><font color=red>El gran Merluzo</font></a>');
		msg = msg.replace ("MERLUZO",'<a target="sitesup" href="'+sitesupport+'"><font color=red>El gran Merluzo</font></a>');		
		msg = msg.replace ("BLACK RIDERS",'<a target="sitesup" href="'+sitesupport+'"><font color=black><b>BLACK RIDERS</b></font></a>');
		msg = msg.replace ("black riders",'<a target="sitesup" href="'+sitesupport+'"><font color=black><b>BLACK RIDERS</b></font></a>');
		msg = msg.replace ("BLACK_RIDERS",'<a target="sitesup" href="'+sitesupport+'"><font color=black><b>BLACK RIDERS</b></font></a>');
		msg = msg.replace ("black_riders",'<a target="sitesup" href="'+sitesupport+'"><font color=black><b>BLACK RIDERS</b></font></a>');
		msg = msg.replace ("BLACKRIDERS",'<a target="sitesup" href="'+sitesupport+'"><font color=black><b>BLACK RIDERS</b></font></a>');
		msg = msg.replace ("blackriders",'<a target="sitesup" href="'+sitesupport+'"><font color=black><b>BLACK RIDERS</b></font></a>');
     ...
     Cities.byID[f.id].c.incomingDefendingMarches().each(function(e){
        ...
        ms+="</td><td>"+ arrivalTime +"</td></tr>";
           ...
           if (ms!="") {
             ...
             m += "<table class='marches' width=100% cellspacing=0 bordercolor=black cellpadding=4><tr style='height:30px'><td></td><td><b>"+translate('Refuerzos de la ciudad')+"</td><td><b>"+uW.arStrings.Embassy.SentFrom+"</td><td><b>"+uW.arStrings.Common.UpKeep+"</td><td>"+uW.arStrings.Common.Troops+"</td><td>"+uW.arStrings.Common.Time+"</td></tr>";
                 m += ms;
                 m += "</table><br>";
 ...
 my.Hud = {
   ...
   show : function () {
     ...
     t.maxPages=parseInt(Options.arPageTo);
       ...
       t.cont.innerHTML = '\
           <DIV class=ptstat>'+translate('VER REPORTES DE ALIANZA')+'</div>\
           ...
           <select id="idHudMedSearch"><option value="">'+uW.arStrings.Common.All+' '+uW.arStrings.Common.Reports+'</option><option value=1>'+translate('Solo mis reportes')+'</option></select></td><td><input type="button" value="'+uW.arStrings.Common.Reports+': '+uW.arStrings.MessagesModal.DeleteAll_button+'" id="BOSuppRapp1"></tr>\
           </table></div>\
...
//	   ById('TestDelRep').addEventListener('click', t.getScoutReport, false);
  	 ...
  	 if (rslt['conquered']==1) m+='<TD><FONT color="#CC0000" size="3px">'+uW.arStrings.Common.Conquered+'</font></td></tr>';
  	     ...
  	     if (rslt['winner']==1 || rslt['winner']==2) m+='<TR><TD style="background-color:white;"><FONT color="green" size="3px"><b>'+uW.arStrings.AllianceReport.AllyVictorious+'<br><br></font>';
             m+="</table>";
  	  		...
  	  		if (rslt['rnds']!=undefined) m+='<br>'+translate('Cantidad de marchas')+': '+rslt['rnds']+'<br>';
  	  	...
  	  	if (rslt['pop'] != undefined) {
  	  	   ...
  	  	   m += '</table><tr><td style="background-color:white;"><b><u>'+translate('Resultados encontrados')+'</u></b><br><br>';
  	   ...
  	   m+="<br><br></table>";
      	...
      	t.popReport.getTopDiv().innerHTML = '<TD align="center"><B>'+translate('Informes de batalla')+' - '+unsafeWindow.formatDateByUnixTime(Date1)+'</td>';
    ...
    DisplayReports : function (){
      ...
      if(!t.data.length) {
         results.innerHTML = '<center><b>'+translate('No se encontraron reportes')+'</b></center>';
         return;
      }
  	   ...
  	   style=' style="background-color:#99EF99;padding:2px;"';
          ...
          m+='&nbsp;</td>\
            <td '+style+'>'+unsafeWindow.formatDateByUnixTime(rpt.reportUnixTime)+'</td>\
              ...
              <td '+style+'>'+rpt.side1AllianceName.replace(translate('Desalineado'),'-')+'</td>\
  	     ...
  	     m +='<TD '+style+'><FONT color="FF0033">'+rpt.marchName+'</font></td>';
  	      ...
  	      if (rpt.side0Name!=undefined) {
              ...
              m+='<td '+style+'>'+rpt.side0AllianceName.replace(translate('Desalineado'),'-')+'</td>\
  ...
  ReadPage : function ()
  {
   ...
   getScoutReport : function (rslt)
   {
        ...
        for (k in NR)
        {
        	...
        	{
        		var b = uW.arStrings.ModalMessagesViewReports.ScoutingAt+' '+NR[k].side0XCoord+','+NR[k].side0YCoord+'! '+translate('La exploracion parece venir de')+' ';
      ...
      for(i=0; i < Cities.numCities; i++) {
    	...
    	var timeLeft = parseInt(Cities.cities[i].c.resources[1].count)  / (0-usage) * 3600;
          ...
          if (timeLeft<0){
              ...
              msg += ' '+translate('se esta quedando sin alimentos')+', '+translate('puedes enviarme un poco')+'? '+translate('cantidad actual')+': '+addCommasWhole(foodleft).replace(',',' ').replace(',',' ').replace(',',' ').replace(',',' ')+' ('+timestrShort(timeLeft)+') '+uW.arStrings.Common.Production+': '+addCommas(usage).replace(',',' ').replace(',',' ').replace(',',' ').replace(',',' ');
                sendChat ("/a " + msg);
                //alert(msg);
          }
      }  
...
my.Reassign = {
 ...
 init : function (){
  ...
  unsafeWindow.Barracks.allUnitIds.each(function(r){
     ...
     if (totalunit==0) {
        t.statutREA.innerHTML = '<FONT COLOR=#550000>'+translate('imposible')+' '+unsafeWindow.arStrings.Common.Reassign+' '+translate('con 0 tropas')+'... pfff, '+translate('levantate')+' !</font>';
          return;
   }
      ...
      if (totalunit>maxtroupe) {
       t.statutREA.innerHTML = '<FONT COLOR=#550000>'+translate('Imposible')+' '+unsafeWindow.arStrings.Common.Reassign+' '+translate('mas')+' '+maxtroupe+' '+translate('tropas al mismo tiempo')+'.</font>';
       return;
      }
     ...
     if (Cities.byID[SourceId].c.canMarch()) {
       ...
       unsafeWindow.AjaxCall.gPostRequest("march.php",g,function(zz){	
             ...
             t.statutREA.innerHTML ="<font color=red size='3px'><b>"+translate('Hecho')+"<b></font>";
      t.actionREA.disabled=false; 
                	 	},
                 		function(zz){
...
my.TranspAuto = {
     ...
     var t = my.TranspAuto;
      var m = '<DIV id=pbTowrtDivF class=ptstat>AUTO '+uW.arStrings.Common.Transport.toUpperCase()+' - '+translate('CONFIGURACION')+'</div><TABLE id=pbtraderfunctions width=100% height=0% class=pbTab><TR align="center">';
          ...
          if (t.traderState.running == false) {
           ...
           m += '<TD><INPUT id=pbShowRoutes type=submit value="'+translate('Mostrar marchas')+'"></td>';
           m += '</tr></table></div>';
     	 ...
     	 m += '<TD colspan=2>'+translate('Enviar transporte cada')+' <INPUT id=pbtransportinterval type=text size=4 value="'+Options.transportinterval+'"\> '+uW.arStrings.TimeStr.timeMin+'</td>';
           m += '<TD colspan=4>'+translate('Enviar transporte con un minimo de')+' <INPUT id=pbminwagons type=text size=2 value="'+Options.minwagons+'"\> '+uW.arStrings.Common.Troops+'</td></tr></table>';
           m += '</table>';
           ...
           m+='<TD width=75px>'+translate('Estimado')+' :&nbsp;</td><TD id=CarryAmount align=left width=75px></td>';
           ...
           m += '<TD width=180px  align=left>'+translate('Mantener')+' : <INPUT id=pbtargetamountFood type=text size=11 maxlength=12 value="0" disabled=true\></td>';
           ...
           m += '<TD width=180px align=left>'+translate('Mantener')+' : <INPUT id=pbtargetamountWood type=text size=11 maxlength=12 value="0" disabled=true\></td>';
           ...
           m += '<TD width=180px align=left>'+translate('Mantener')+' : <INPUT id=pbtargetamountStone type=text size=11 maxlength=12 value="0" disabled=true\></td>';
           ...
           m += '<TD width=180px align=left>'+translate('Mantener')+' : <INPUT id=pbtargetamountOre type=text size=11 maxlength=12 value="0" disabled=true\></td>';
           ...
           m += '<DIV style="text-align:center; margin-top:15px"><INPUT id=pbSaveRoute type=submit value="'+translate('Añadir marcha')+'"></div>';
      ...
      ById('TransportTroop').value = 'u9';
         ...
         updateTroops : function (city){
          ...
          var LoadUnit=0; //parseInt(parseInt(uW.unitstats[untid][5])*(1+loadBoost));
         	...
         	ById('Calc').innerHTML = uW.arStrings.Common.Resources+': ' +  addCommas(t.Food + t.Wood + t.Stone + t.Ore + t.Gold  + t.Astone) + ' / ' + addCommas(t.MaxLoad) + '&nbsp;&nbsp;('+uW.arStrings.Common.Troops+' '+translate('necesario')+' : <FONT color='+fontcolor+'>' + addCommas(t.TroopsNeeded) + '</font> )' ;
         },    
        ...
        e_tradeRoutes: function(){
     	...
     	showTradeRoutes: function () {
     		...
     		t.popTradeRoutes.getTopDiv().innerHTML = '<TD><B>'+translate('Mostrar marchas')+' : </td>';
     		t.paintTradeRoutes();
     	...
     	paintTradeRoutes: function(){
     		...
     		for (var i=0;i<(r.length);i++) {
     			  citynameTo = null;
     				...
     				if (r[i].route_state) var status = '<FONT color=green>'+translate('Activar')+'</font>';
     				else var status = '<FONT color=red>'+translate('Desactivar')+'</font>';
     	 ...
     	 editQueueElement: function(queueId){
            ...
            var n = '<TABLE id=editRoutes class=pbTab>';
     	     ...
     	     n +='<TD><INPUT id=TradeStatus type=checkbox>&nbsp;'+translate('Activar')+' '+translate('La marcha')+'</td>';
 ...
 var id=city;
  ...
  showManuel : function() {
    var t = my.TranspAuto;  
    if (t.state == null) {  
      m = "<DIV class=ptstat>"+translate('TRANSPORTAR RECURSOS DE CIUDAD A CIUDAD')+"</div>";
      ...
      m += "<TABLE width=100% class=ptTab border=0 cellpadding=3>\
       ...
       <br>"+uW.arStrings.Common.Quantity+" : <input type=text size=6 value='0' id='Choixnbwagon'><input type=button id='trswagmax' value='Max'\><br><i>("+translate('Ponga la cantidad de tropas que le gustaria usar')+")</i>\
  ...
  clickTransportDo: function() {   // fonction pour faire le transport
   ...
   if (!document.getElementById("ChoixRess0").checked && !document.getElementById("ChoixRess1").checked && !document.getElementById("ChoixRess2").checked && !document.getElementById("ChoixRess3").checked && !document.getElementById("ChoixRess4").checked) {
       t.divTranportStatus.innerHTML = '<FONT COLOR=#550000>'+translate('Verifique los recursos que va a transportar')+' !</font>';
      return;
   }
   ...
   t.divTranportStatus.innerHTML = '<FONT COLOR=#550000>'+translate('Imposible')+' '+uW.arStrings.Common.Transport+' '+translate('con 0 tropas')+'... pfff, '+translate('levantate')+' !</font>';
     return;
   }
  ...
  if (Cities.byID[SourceId].c.canMarch()) {
        ...
        unsafeWindow.AjaxCall.gPostRequest("march.php",g,function(zz){	
             	  			...
             	  			a.to.tileType=Number(zz.tileType);
             	   			...
             	   			Cities.byID[id].c.marches.outgoing[a.id]=a;
             	   			unsafeWindow.KTrack.event(["_trackEvent","March",i,unsafeWindow.player.level]);
              t.divTranportStatus.innerHTML ="<font color=red size='3px'><b>"+translate('Hecho')+"<b></font>";
       t.TTbutTransport.disabled=false; 
                 	 	},
                  		function(zz){
 ...
 my.attaque = {
  ...
  getContent : function (){
    ...
    troopOptions: function(){
      	 ...
      	 z+='<tr><td colspan=3>'+translate('Tiempo entre ataques')+':</td><td  colspan=14><input type=text size=2 id=BOTimerAttack maxlenght=2 value='+Options.AttackTimer+'> '+uW.arStrings.TimeStr.timeHr+'</tr><TR><TR><TD></td>';
	 unsafeWindow.Barracks.allUnitIds.each(function(i){
	 ...
	 z+='</tr>';		 		
    	 ...
    	 z+='<tr><td colspan=3>'+translate('Tiempo entre ataques')+':</td><td  colspan=14><input type=text size=2 id=BOTimerAttack2 maxlenght=2 value='+Options.AttackTimer2+'> '+uW.arStrings.TimeStr.timeHr+'</tr><TR><TR><TD></td>';
    	 unsafeWindow.Barracks.allUnitIds.each(function(i){
    		z+='<TD>'+unsafeWindow.arStrings.unitName["u"+i].substr(0,10)+'</td>';
         });
    	 for(i=0;i<10;i++){
	 ...
	 z+='<tr><td colspan=3>'+translate('Tiempo entre ataques')+':</td><td  colspan=14><input type=text size=2 id=BOTimerAttack3 maxlenght=2 value='+Options.AttackTimer3+'> '+uW.arStrings.TimeStr.timeHr+'</tr><TR><TR><TD></td>';
	     	 unsafeWindow.Barracks.allUnitIds.each(function(i){
	     		z+='<TD>'+unsafeWindow.arStrings.unitName["u"+i].substr(0,10)+'</td>';
	          });
	     	 for(i=0;i<10;i++){
    ...
    show : function () {
     ...
     m+= '</td></tr>';
     m+='<tr><td colspan=2><input type=checkbox id=BOGenAttack '+ (Options.AttackGen?'CHECKED ':'')+'> '+translate('No use general con nivel mayor a')+' <input type=text size=3 value="'+Options.AttackGenNiv+'" id=BOGenNivAttack>';
     m+='</table><br><DIV class=ptstat>'+translate('FIJAR PARAMETRO DE CIUDADES')+'</div>';
     ...
     if (c) {
   	...
   	m+="</select></td><td><span id=clickCol10>"+uW.arStrings.Common.Target+' '+uW.arStrings.Common.Type+" <select id=bofiltrecible><option value=''>...</option><option value=1 "+ (t.filtrecible==1?' SELECTED':'') +">"+uW.arStrings.Common.Wilds+"</option><option "+ (t.filtrecible==2?' SELECTED':'') +" value=2>"+uW.arStrings.Common.City+"</option><option "+ (t.filtrecible==3?' SELECTED':'') +" value=3>"+uW.arStrings.Common.BarbarianCamp+"</option></select></span></td><td>"+uW.arStrings.Common.Level+"</td><td><span id=clickCol6>"+uW.arStrings.Common.Distance+"</span></td><td>"+uW.arStrings.Common.Coordinates+"</td><td><span id=clickCol9>"+translate('Ultimo ataque')+"</span></td><td><a id=borazcompteur>"+translate('Hecho')+"</a></td></tr>";
 ...
 my.Crest = {
  ...
  init : function (cont){
   ...
   getContent : function (){
    ...
    m += '<INPUT id=showCrestTargets type=submit value="'+translate('Ver objetivo')+'"><br>'+translate('Intervalo de ataque')+': <INPUT id="pbcrest_interval" type=text size=3 value='+Options.Crestinterval+' /> '+uW.arStrings.TimeStr.timeSec+'</td>';
    m += '<TD>'+translate('No use general con energia baja')+' <INPUT id=pbgenenergy value='+ Options.CrestEnergy +' type=text size=3 \></td>';
	m += '</tr></table>';
    ...
    m += '<DIV id=pbWave1 class=ptstat>'+translate('Onda')+' <b>1</b>:</div>';
    m += '<table><tr>';
    ...
    m += '</table><br><br>';
	m += '<DIV id=pbWave1 class=ptstat>'+translate('Onda')+' <b>2</b>:</div>';
    m += '<table><tr>';
    ...
    m += '<DIV style="text-align:center; margin-top:15px"><INPUT id=pbSaveRouteCrest type=submit value="'+translate('Añadir objetivo')+'"></div>';
...
helpPop : function (){
    ...
    showCrestRoute : function () {
		...
		t.popCrestTargets.getTopDiv().innerHTML = '<TD><B>'+translate('atacar objetivo')+'</td>';
		t.paintCrestTargets();
		t._addTabHeader();
...
/** add header **/
    _addTabHeader : function () {
		...
		row.vAlign = 'top';
	     	...
	     	row.insertCell(1).innerHTML = translate('Onda') + " #";
    ...
    _addTabCrest : function (QueID, col0, col1, col2, col3, col4, col5, col6, col7, col8, col9, col10, col11, col12, col13, col14, col15, col16) {
		...
		for (var i = 0; i < 17; i++) {
			if (i == 15 && col15 == uW.arStrings.NeighborsPage.Remove) {
			  ...
			  if ( i == 16 && col16 == translate('Activar')) {
			   row.insertCell(i).innerHTML = "<input type=button id='BOCrestAct_" + QueID + "'  value='"+translate('Activar')+"'>";
			  ...
			  } else if (i == 16 && col16 ==translate('Desactivar')) {
			   row.insertCell(i).innerHTML = "<input type=button id='BOCrestAct_" + QueID + "'  value='"+translate('Desactivar')+"'>";
...
//											CrestData[CrestDataNum].lastRoundTwo = now;
				...
				function(h){
					...
					actionLog('Crest','<font color=red>'+translate('FALLA')+' '+translate('Crest')+' '+uW.arStrings.Common.To+' '+p.xcoord+','+p.ycoord+' '+translate('Intentare mas tarde')+' '+RetryTime);
    ...
    var t = my.Germ;   
      try {
		...
		var m = '<DIV class=ptstat>'+translate('GERMANIA')+'</div>';
			m+= '<center>'+translate('Ciudad para explorar/atacar')+' <span id="CityGerm"></span><br>';
			...
			m+= '<div id="AttackGeneral">';
				...
				m+= '</tr><tr><td><br></td></tr><tr>';	 
				m+= '</tr><tr>';
				m+= '<td><b>'+uW.arStrings.Common["Generales"]+':</b></td>';
			...
			ById('HideStatGen').addEventListener('click', function(){
				...
				t.getGeneral(); 
				t.UpdateTroops();
				ById('MessageGerm').innerHTML = '<font color=red><b>'+translate('Te sugiero refrescar la pagina, alguna informacion puede no ser real')+'!</b></font>';
			}, false);
		...
		for (var y = 1; y < t.summary.length; y++) {
			...
			if (Sum.AllianceName == getMyAlliance()[1]) {
				if (ById('NumGerm').value == y+1) {
					alert(translate('No puedes atacar a un miembro de tu alianza')+'!!');
  ...
  paint : function () {
	...
	for (var y = 1; y < t.summary.length; y++) {
		...
		cc+= '<td style="text-align:center; vertical-align:middle;" width="'+WW+'">'+y+': <b><font color="'+Color+'">'+Sum.AllianceName + '</font></b><br>\
																				   ...
																				   '+translate('Forzar cierre')+': <b>'+timestrShort(Sum.KickOut)+'</b><br><br>';
																				    if(Sum.AllianceName != getMyAlliance()[1]) { 
      ...
      function(rslt) {
      	 ...
      	 for (k in Rein) {
      	 	if (Rein[k].playerName != undefined) {
      	 		...
      	 		m+= '<td>'+translate('Forzar cierre')+': <b>'+timestrShort(Rein[k].reinforcementRecallUnixtime - Time)+'</b></td>';      	 		
      	 		m+= '</tr>';
      ...
      try {      
			var m = '<DIV class=ptstat>'+uW.arStrings.UserEngagement.ResearchTitle.toUpperCase()+'</div>';
				...
				m+= '<tr><td width="70%" style="text-align:center; vertical-align:middle;">';
					...
					m+= '<td><DIV class=ptstat><center>'+translate('Nivel alcanzado')+'</center></div></td>';
...
my.AutoAtt = {
    ...
    var t = my.AutoAtt;
      try {      
		var m = '<DIV class=ptstat>MULTI '+uW.arStrings.Common.Attack.toUpperCase()+'</div>';
			...
			m+= '<td width=50%>'+translate('Tiempo entre ataques')+": <input type=text size=3 id=BOAttackInterval value='"+ parseInt(AutoAttack.AttackInterval)+"'> "+uW.arStrings.TimeStr.timeSec+'</td>';
			m+= '<td width=50%><input type=checkbox id="AttackGenEn" '+ (AutoAttack.AttackGen?'CHECKED ':'')+'> '+translate('No usar general con nivel mayor a')+' <input type=text size=3 value="'+AutoAttack.AttackGenNiv+'" id="AttackGenLiv"></td>';
			m+= '</tr><tr>';
			m+= '<td></td>';
			m+= '<td><input type=checkbox id="AttackStopEnd" '+ (AutoAttack.StopCity?'CHECKED ':'')+'> '+translate('Desactivar la ciudad cuando terminen las coordenadas')+'</td>';
			m+= '</tr></table><br>';
  ...
  CheckCoord : function (c){
	...
	saveAutoAttack();
	if (counter < 1) {
		alert(translate('No hay coordenadas')+'!!!');  
		return false;
	} else {	
		return true;
	}
  		...
  		for (var c=0; c<Cities.numCities; c++) {
  			...
  			if (AutoAttack.Enable[c]){	// Se abilitato
  				if (AutoAttack.Mode[c]=='1') {	// Se Single Coords
					...
					if(CooX == 0 && CooY == 0) {
						actionLog('Multi'+uW.arStrings.Common.Attack,Cities.cities[c].c.name+': '+translate('Imposible atacar esas coordenadas')+' 0,0');
					} else {
  							...
  							if (AutoAttack.MultiCheck[c][k].x == AutoAttack.LastCoord[c].x && AutoAttack.MultiCheck[c][k].y == AutoAttack.LastCoord[c].y) {
  								if ((k+1) >= AutoAttack.MultiCheck[c].length) {		// Se l'ultima ricomincia da capo
  									if (AutoAttack.StopCity) {
  										actionLog('Multi'+uW.arStrings.Common.Attack,Cities.cities[c].c.name+': '+translate('Desactivar ciudad'));
  										...
  										actionLog('Multi'+uW.arStrings.Common.Attack,Cities.cities[c].c.name+': '+translate('Reiniciar coordenadas'));
  										AutoAttack.LastCoord[c].x = "";
  										AutoAttack.LastCoord[c].y = "";
  										saveAutoAttack();
  										// Ricomincio
    ...
    if (Cities.byID[id].c.canMarch() && Cities.byID[id].c.generalsCount() != 0 && selectedKnight != 0 && Controllo == true) {
        ...
        uW.AjaxCall.gPostRequest("march.php",g,
        	function(h){	   
				...
				actionLog('Multi'+uW.arStrings.Common.Attack,Cities.cities[c].c.name+': '+translate('enviar ataque a')+' '+CooX+','+CooY);
				saveAutoAttack();
			},
			function(h){
				// Attacco Fallito
		...
		if (!Controllo) {	// Non disponi delle truppe necessarie
			...
			if (!Cities.byID[id].c.canMarch()) {	// Non può marciare (ES. Raduno completo)
				...
				if (Cities.byID[id].c.generalsCount() == 0) {	// Nessun generale nominato
					actionLog('Multi'+uW.arStrings.Common.Attack,'('+CooX+','+CooY+') '+Cities.cities[c].c.name+': <font color=red>'+translate('Sin general seleccionado')+'</font>');
				} else {
...
<br><br><button  id="BOAcceptAllKDO" class="button25" type="button"><span>'+uW.arStrings.Gift.ButtonAcceptAll+'</span></button><br><br><hr><b><center>'+translate('Por favor apoya GoRBoTTools haciendo click en la pagina web de vez en cuando')+'!</center></b></div>';
...
function reloadKOC (){
  ...
  actionLog(translate('Recargar'),translate('Recargar')+' '+translate('Ahora')+'!');
...
my.News = {
  ...
  init : function (){
    ...
    if (parseInt(Options.Lingua) != 0) {
		GM_xmlhttpRequest({
			method: 'GET',
			url: 'http://galeon.hispavista.com/blackriders/recursos/GoRNews.txt',
			headers: {
  ...
  show : function (){
    var t = my.News;   
      try { 
		var m = '<DIV class=ptstat>'+translate('Novedades')+'!</div><br>';
		if(t.News.status != 200) {
			m += '<center><div style="background-color:#DEDEDE; width:600px; height:800px; text-align:left; overflow-y:auto;"><b>Unable to fetch news <br>Error: '+t.News.status+'</b></div></center>';
			return;
		}
		m += '<center>';
		m += '<div style="background-color:#DEDEDE; width:600px; height:800px; text-align:left; overflow-y:auto;">';
    ...
    var t = my.ImpExp;   
      try {      
			var m = '<div class="ptstat">IMPORT/EXPORT</div>';
				m+= '<center><input type="submit" value="'+translate('Exportar')+' '+translate('Opciones')+'" id="pbExportOptions"> - <input type="submit" value="'+translate('Importar')+' '+translate('Opciones')+'" id="pbImportOptions">';
				m+= '<br><input type="submit" value="'+translate('Exportar')+' Auto'+uW.arStrings.Common.Train+'" id="pbExportTrain"> - <input type="submit" value="'+translate('Importar')+' Auto'+uW.arStrings.Common.Train+'" id="pbImportTrain">';
...
function DashInnert (){
    ...
    var Red = 'BODefButOff';
    var m = '<div class="ptstat">PIZARRA</div>';
    	m+= '<center><br><INPUT id="DAReloadGor" type=submit value="'+translate('Recargar')+' GoR">';
		...
		m+= '</tr></table><br>';
		m+= '<div class="ptstat">AMULETOS</div><table width="70%"><tr><td colspan="3">&nbsp;</td></tr><tr><td style="background-color:'+couleurr+';text-align:center" align="center"><a href="http://apps.facebook.com/gloryofrome/?page=helpfriend&tid=13&in=1746705&qid=1197&s=108&inviterServer=108&lp=12&ty=3&si=104&ln=1" target="_top"><img src="http://galeon.hispavista.com/blackriders/recursos/coin.png" border="0"><br>AMULETO Nº 1</a></td><td  style="background-color:'+couleurr+';text-align:center" align="center"><a href="http://apps.facebook.com/gloryofrome/?page=helpfriend&s=108&inviterServer=108&tid=7&sid=1746705&lp=17&entrychannel=%404&in=1746705&ty=3&si=85&ln=1" target="_top"><img src="http://galeon.hispavista.com/blackriders/recursos/coin.png" border="0"><br>AMULETO Nº 2</a></td><td  style="background-color:'+couleurr+';text-align:center" align="center"><a href="https://apps.facebook.com/gloryofrome/?page=convert&pl=1&in=1255954&ty=3&si=502&wccc=fcf-feed-502&ln=1&da=201372&ex=cid%3A66370%7Cgid%3AREPLACE_AsSeTiD%7Clid%3A100iD%7Cs%3A306%7Csid%3A1255954%7Cmid%3AREPLACE_mArCh_RePortiD%7Cside%3AREPLACE_sIdE%7CraidId%3AREPLACE_RaIdId%7C" target="_top"><img src="http://galeon.hispavista.com/blackriders/recursos/coin.png" border="0"><br>AMULETO Nº 3</a></td></tr>'; 
    ...
    var t = my.Build; 
      try {
			...
			var m = '<DIV  class=ptstat>'+uW.arStrings.Common.Buildings.toUpperCase()+'</div>';
				...
				m+= '<br><input type=checkbox id="CheckLvlBuild" '+ (AutoBuild.CheckLevel?'CHECKED ':'')+'> '+translate('Llevar al mismo nivel');
				m+= '<br>'+translate('Revisar cada')+' <INPUT id="BuildCheckTime" size=3 type=textbox value="'+AutoBuild.CheckTime+'" /> '+uW.arStrings.TimeStr.timeSec;
				m+= '</td></tr></table>';
				for (var i=0; i<Cities.numCities; i++) {
   			 		id = Cities.cities[i].c.id;
					...
					m+= '<table width=100%><tr>';
						m+= '<td width=50%><TABLE width=100%><tr>';
							...
							m+= '<td width=25%><DIV class=ptstat>'+translate('Subir al nivel')+'</div></td>';
...
my.Manager = {
  ...
  show : function (){
    var t = my.Manager;
      if (getMyAlliance()[1]==uW.arStrings.Common.None) {
        t.cont.innerHTML = '<BR><BR><CENTER><b>'+translate('Debes pertenecer a una alianza para utilizar esta caracteristica')+'</center>';
        return;
      }
     t.totalmembers=0;
     t.alliancemembers=[];
	...
	uW.RemoveMember=t.RemoveMember;   
      try { 
     	var m ='<center><INPUT id=boAlliance type=submit value="'+translate('Panel de alianza')+'"><INPUT id=boMessage type=submit value="'+translate('panel de mensajes')+'"><INPUT id=boLeaderboard type=submit value="'+translate('Tabla de posiciones')+'"></center>';
     		m+='<div id=ShowAlliance>';
			m+='<DIV  class=ptstat>'+translate('Panel de alianza').toUpperCase()+'</div>';
			m+='<center><INPUT id=boGetMem type=submit value="'+translate('Obtener informacion/miembros')+'"> <INPUT id=boGetStat type=submit value="'+translate('Obtener diplomacia de alianza')+'"></center>';
			...
			m+='<option value="dip">'+translate('Dias en la posicion')+' (DIP)</option></select>';
	   		...
	   		m+='<DIV  class=ptstat>'+translate('Panel de mensajes').toUpperCase()+'</div><center>';
  ...
  ResAllianceInfo : function (rslt){
  		...
  		var b = '<DIV  class=ptstat>'+translate('INFORMACION DE LA ALIANZA')+'</div>';
  			...
  			b+= '<td>'+translate('encontrar')+': '+AI.founderGenderAndName+'</td></tr></table>';
  			b+= '<table width=100%><tr>';
    ...
    _addTabHeader: function() {
    var t = my.Manager;
    	ById('DivInfoMem').innerHTML = '<DIV  class=ptstat>'+translate('INFORMACION DE LOS MIEMBROS')+'</div>';
        var row = ById('alOverviewTab').insertRow(0);
             ...
             row.insertCell(5).innerHTML = '<b>'+translate('Dias en la posicion')+'</b>';
             row.insertCell(6).innerHTML = '<b>'+translate('Fecha de ingreso')+'</b>';
  ...
  MessageToAllAlly : function (){
      var t = my.Manager;   
 		var b=prompt('(To Alliance) - '+translate('Escribir mensaje')+":", "");
 		if (b){      
      var c= {};
      unsafeWindow.AjaxCall.gPostRequest("allianceGetInfo.php",c,
        function(rslt){
           ...
           for (var f=1; f<=TotPage; f++) {
           ById('MessageProgress').innerHTML += '<font color=blue>'+translate('Leer pagina de miembros')+': '+f+'</font><br>';
      		var c= {};
      		c.pageNo = f;
      		unsafeWindow.AjaxCall.gPostRequest("allianceGetMembersInfo.php",c,
        	function(rslt){
    			...
    			for (var k in MI){
    				...
    				if (Name != undefined){
       				var c= {};
      				c.toIds = MI[k].userId;
      				c.subject = translate('Enviar mensajes a la alianza')+" "+uW.player.name;
      				c.message = b;
        			...
        			function(rslt){	
        				...
        				ById('MessageProgress').innerHTML += '<font color=red>'+translate('Mensaje enviado a')+': '+Name+'... ERROR!</font><br>';
        				}
        			});	
        		}
//        		ById('MessageProgress').innerHTML += '<font color=green>'+translate('Message send to')+': '+Name+'... OK!</font><br>';
        		}
				ById('MessageProgress').innerHTML += '<font color=red>'+translate('Terminado')+'!</font><br>';
        	});
           }
        }
      );
  ...
  MessageToOfficial : function (){
      var t = my.Manager;   
 		var b=prompt('(To Officer) - '+translate('Ingresar mensaje')+":", "");
 		if (b){      
      var c= {};
      unsafeWindow.AjaxCall.gPostRequest("allianceGetInfo.php",c,
        function(rslt){
        	...
        	function(rslt){
    			...
    			for (var k in MI){
    				...
    				if (Pos == 3|| Pos == 2 || Pos == 1){
       				var c= {};
      				c.toIds = MI[k].userId;
      				c.subject = translate('Mensaje enviado a todos los oficiales por')+" "+uW.player.name;
      				c.message = b;
      				unsafeWindow.AjaxCall.gPostRequest("sendMessage.php",c,
        			function(rslt){	
        				if(!rslt.ok){
        		...
        		ById('MessageProgress').innerHTML += '<font color=green>'+translate('Mensaje enviado a')+': '+Name+'... OK!</font><br>';
        		}
        		}
        		}
        	});
    			...
    			for (var k in MI){
    				...
    				if (Pos != undefined || Name != undefined){
    					if(Name == uW.player.name){
    						...
    						var a = confirm(translate('Disculpa, pero esta opcion es solo para oficiales'));
    						ById('MessageProgress').innerHTML = '';
    						}
    					}
    				}
  ...
  MessageToAll : function (a){
  		var t = my.Manager; 	
  		var text = prompt(translate('Ingresa el mensaje')+":", "");
  		if(text){	
  		var c= {};
  		c.cityId = 5378;
      	c.pageNo = 1;
        		...
        		for (var f=1; f<=NumPage; f++) {
        					...
        					function(rslt){
        						...
        						for (k in AN){	
        							...
        							var c= {};
      								c.toIds = LID;
      								c.subject = translate('Mensaje de')+" "+uW.player.name;
      								c.message = text;
      								unsafeWindow.AjaxCall.gPostRequest("sendMessage.php",c,
        							function(rslt){
        								if(rslt.ok){
  ...
  RemoveMember : function (userId){
  		var t = my.Manager;
  		var a = confirm(translate('Realmente quieres eleminar a este usuario')+'?');
  		if(a){
  		var c = {};
  		c.memberId = userId;
  ...
  SendMessage : function (userId){
  		var t = my.Manager;
 		var b=prompt(translate('Ingresa el mensaje')+":", "");
 		if (b){
  ...
  GetDiplomacy : function (){
        ...
        function(rslt){
	    	 ...
	    	 var AF = rslt.diplomaticAlliances["friendlyToThem"];
  				 b+= '<b>'+translate('Amistad con ellos')+':</b><br><table width=100%><tr>';
  			for (k in AF){
	    	 ...
	    	 var AF = rslt.diplomaticAlliances["friendlyToYou"];
  				 b+= '<b>'+translate('Amistad conmigo')+':</b><br><table width=100%><tr>';
  			for (k in AF){
  					b+= '<td><font color=blue>'+uW.arStrings.Common.Name+': '+AF[k]["allianceName"]+'</font><br>';
  					b+= uW.arStrings.Alliance.Members+': '+AF[k]["membersCount"]+'</td>';
  			}
...
my.ActionLog = {
  ...
  show : function (div){
    var t = my.ActionLog;
        ...
        t.myDiv = this.myDiv;
        t.myDiv.innerHTML = '<DIV  class=ptstat>'+translate('Registro de acciones')+'</div><DIV style="height:535px; max-height:535px; overflow-y:auto">\
       <select id=BOSuiviFiltre><option value="">'+uW.arStrings.Common.All+'</option>\
       							...
       							<option value="'+translate('Recargar')+'">'+translate('Recargar')+'</option>\
...
my.Options = {
  ...
  creatediv : function(){
	...
	ab.style.left="0";
	chat.appendChild(ab);
	ab.innerHTML="<span>"+translate('Smyle')+"</span>";
  ...
  show : function (){
    var t = my.Options;   
      ...
      try {      
        m = '<DIV style="height:670px; max-height:670px; overflow-y:auto">\
          <TABLE class=ptTab>\
          <TR><TD colspan=2><DIV class=ptstat>'+translate('Configuracion de')+' '+ScriptName+'</div></td></tr>\
          <TR><TD>&nbsp;</td><TD>'+uW.arStrings.FTE.Language+': '+ htmlSelector({0:'...', 1:'Español', 2:'Italiano'},Options.Lingua,'id=BOLangue') +'&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;<span id=SpanLang></span></td></tr>\
          <TR><TD><INPUT id=ptAllowWinMove type=checkbox /></td><TD>'+translate('Permitir mover la ventana con el mouse')+'</td></tr>\
          <TR><TD></td><TD>'+translate('Dimensiones de la ventana')+': '+translate('Ancho')+': <INPUT id=pbWidthTools type=text size=2 maxlength=3  value="'+ Options.WidthTools +'"\>px - '+translate('Alto')+': <INPUT id=pbHeightTools type=text size=2 maxlength=3  value="'+ Options.HeightTools +'"\>px</td></tr>\
         <TR><TD><INPUT id=pbEveryEnable type=checkbox /></td><TD>'+translate('Refrescar GoR cada')+'  <INPUT id=pbeverymins type=text size=2 maxlength=3 \> '+uW.arStrings.TimeStr.timeMin+'</td>\
         <TR><TD><INPUT id=pbGoldEnable type=checkbox /></td><TD>'+translate('Organizar enventos de impuestos en el coliseo(si la felicidad')+' >= <INPUT id=pbgoldLimit type=text size=2 maxlength=3 \>%)</td></tr>\
        ...
        <TR><TD>&nbsp;</td><td>Mostrar conservación en  rojo y enviar alerta de chat solo cuando falten<INPUT id=optFoodHours type=text size=3 value="'+ Options.foodWarnHours +'"> horas de alimento  <br>(for chat alert, also check box in chat configuration section !)</td></tr>\
        <TR><TD><INPUT id=ptAllowFB '+ (GlobalOptions.autoPublishGamePop?'CHECKED ':'') +' type=checkbox /></td><TD>'+translate('Permitir publicar ayudas en facebook')+' '+ htmlSelector({0:'----', 80:translate('a todos'), 50:translate('amigos de amigos'), 40:translate('solo amigos'), 10:translate('solo yo')},GlobalOptions.autoPublishPrivacy,'id=selectprivacymode') +'</td></tr>\
        <TR><TD><INPUT id=ptHideTab '+ (Options.HideTab?'CHECKED ':'') +' type=checkbox /></td><TD>'+translate('Esconder las entradas inutiles (pagina de fans, Discuciones ..)')+'</td></tr>\
        <TR><TD><INPUT id=ptHideDaily '+ (Options.HideDaily?'CHECKED ':'') +' type=checkbox /></td><TD>'+translate('Recibir automaticamente la recompenza diaria')+'</td></tr>\
        <TR><TD><INPUT id=ptHideUpGor '+ (Options.HideUpGor?'CHECKED ':'') +' type=checkbox /></td><TD>'+translate('Esconder actualizaciones')+' GoR</td></tr>\
        <TR><TD><INPUT id=ptEnDash '+ (Options.EnableDash?'CHECKED ':'') +' type=checkbox /></td><TD>'+translate('Dashboard')+': '+ htmlSelector({0:translate('Derecha'), 1:translate('Abajo')},Options.DashPos,'id=BOPosDash') +'\
        <TR><TD colspan=2><hr><DIV class=ptstat>'+translate('Configuracion del chat')+'</div></td></tr>\
        <TR><TD><INPUT id=pbChatREnable type=checkbox /></td><TD>'+translate('Mover la ventana de chat a la derecha del juego')+'</td></tr>\
        <TR><TD><INPUT id=ptEnableFoodWarnTchat type=checkbox /></td><TD>'+translate('Publicar en el chat cuando el nivel de comida sea bajo')+'</td></tr>\
        <TR><TD><INPUT id=HelpReq type=checkbox /></td><TD>'+translate('Auto-click en los pedidos de ayuda para construccion')+'</td></tr>\
        <TR><TD><INPUT id=DelReq type=checkbox /></td><TD>'+translate('Esconder los pedidos de ayuda del chat')+'</td></tr>\
        <TR><TD><INPUT id=DelReg type=checkbox /></td><TD>'+translate('Esconder las reglas del chat')+'</td></tr>\
        <TR><TD><INPUT id=BOSmiley type=checkbox /></td><TD>'+translate('Mostrar emoticones')+' <INPUT id=EmoHelp type=submit value="'+translate('Open')+'"></td></tr>\
	<TR><TD><INPUT id=BOChuchoEnable type=checkbox '+ (Options.Chuchoenabled?'CHECKED ':'') +'/></td><TD>'+translate('Sonido de advertencia cuando me susurren')+'</td></tr>\
	...
	<TR><TD><INPUT id=BOAttackEnable type=checkbox '+ (Options.Attackenabled?'CHECKED ':'') +'/></td><TD>'+translate('Habilitar audio en caso de ataque (Alianza)')+'</td></tr>\
        <TR><TD>&nbsp;</td><TD>'+translate('Archivo de sonido (URL MP3)')+' : <INPUT id=BOurlAttack type=text size=55 maxlength=220 value="'+ Options.urlAttack +'" \></td></tr>\
	<TR><TD><INPUT id=BOSpyEnable type=checkbox '+ (Options.Spyenabled?'CHECKED ':'') +'/></td><TD>'+translate('Habilitar audio en caso de exploracion (Alianza)')+'</td></tr>\
        <TR><TD>&nbsp;</td><TD>'+translate('Archivo de sonido (URL MP3)')+' : <INPUT id=BOurlSpy type=text size=55 maxlength=220 value="'+ Options.urlSpy+'" \></td></tr>\
    ...
    <TR><TD><INPUT id=BOEnhAllChat type=checkbox '+ (Options.AllianceChat?'CHECKED ':'') +'/></td><TD>'+translate('Fondo del chat de alianzas')+' <INPUT id=togChatAll style="background-color:'+Colors.ChatAll+'" type=text size=7 maxlength=7 value="'+Colors.ChatAll+'"></td></tr>\
	  <TR><TD><INPUT id=EnColLeader type=checkbox '+ (Options.ColorsLeader?'CHECKED ':'') +'/></td><TD>'+translate('Habilitar color para los lideres')+'</td></td>\
     ...
     <TR><TD><INPUT DISABLED id=BODelReportEnable type=checkbox '+ (Options.EnableDelRep?'CHECKED ':'') +'/></td><TD>'+translate('Habilitar borrado de informes')+' Crest</td></tr>\
     <TR><TD></td><TD>'+translate('Borrar todos los informes')+' <INPUT DISABLED id=pbDelRepEvery type=text size=2 maxlength=3  value="'+ Options.DeleteRepEvr +'"\> '+uW.arStrings.TimeStr.timeMin+'</td></tr>\
     <TR><TD><INPUT id=BODelMessEnable type=checkbox '+ (Options.EnableMesRep?'CHECKED ':'') +'/></td><TD>'+translate('Habilitar los el borrado de mensajes de kabam')+' (Solo italiano)</td></tr>\
     <TR><TD colspan=2><DIV class=ptstat>'+translate('Configuracion de la torre de vigilancia')+'</div></b></td></tr>\
     <TR><TD><INPUT id=pcalertScoutEnable type=checkbox '+ (Options.alertConfig.aChatScout?'CHECKED ':'') +'/></td><TD>'+translate('Permitir el aviso con mensajes en el chat de la alianza cuando me exploren')+'</td></tr>\
	<TR><TD><INPUT id=pcalertEnable type=checkbox '+ (Options.alertConfig.aChat?'CHECKED ':'') +'/></td><TD>'+translate('Permitir el aviso con mensajes en el chat de la alianza cuando me ataquen')+'</td></tr>\
	...
	<TR><TD align=right> &nbsp; </td><TD><INPUT id=pcalertQG type=checkbox '+ (Options.alertConfig.MonQG?'CHECKED ':'') +' />'+translate('Mostrar el bunker')+' ';
          m+= '<SELECT id=pcalertHQ name=pcalertHQ><option value="">.....</option>';
   		...
   		<TR><TD> &nbsp;</td></tr>\
        <TR><TD><INPUT id=boSoundEnable type=checkbox '+ (Options.alertSound.enabled?'CHECKED ':'') +'/></td><TD>'+translate('Permitir la alarma cuando me ataquen (util cuando estas lejos del teclado)')+'</td></tr>\
	<TR><TD></td><TD><DIV id=boLoadingSwf>'+translate('Cargar el reproductor SWF')+'</div><DIV style="display:none" id=boSoundOpts><TABLE cellpadding=0 cellspacing=0>\
	<TR><TD align=right>'+translate('Archivo de sonido (URL MP3)')+' : &nbsp; </td><TD><INPUT id=bosoundFile type=text size=55 maxlength=160 value="'+ Options.alertSound.soundUrl +'" \>\
	&nbsp; </td><TD><INPUT id=boSoundLoad type=submit value="'+translate('CARGAR')+'"><INPUT id=boSoundDefault type=submit value="'+translate('POR DEFECTO')+'"></td></tr>\
	...
	<TR><TD></td><TD>'+translate('tiempo de duracion de la alarma')+' <INPUT id=boSoundLength type=text size=3 maxlength=5 value="'+ Options.alertSound.playLength +'"> '+uW.arStrings.TimeStr.timeSec+'</td></tr>\
	<TR><TD></td><TD><INPUT type=submit value="'+translate('Probar')+'" id=boPlayNow> &nbsp; <INPUT id=boSoundStop type=submit value="'+translate('Detener sonido de alerta')+'"></td></tr></table></div></td></tr>\
     ...
     if(Options.Lingua == 1) ById('SpanLang').innerHTML = translate('Translated by')+' AETAS';
...
my.Search = {
   ...
   if (ById('SearchMultiAtt').checked)
   {
   		...
   		if (ById('SearchAutoAtt').checked)
   		{
			...
			var now = unixTime();
   			...
   			alert(translate('Por favor elija una opcion')+'!');
   		}
   }
  ...
  show : function (cont){
    var t = my.Search;
      ...
      var m = '<TABLE><TR><TD>';
      m += '<TABLE><TR><TD class=xtab width=100 align=right>'+translate('Inciar en')+' : &nbsp; X: </td><TD class=xtab>\
      ...
      m += '<TR><TD colspan=2><input type=checkbox id=ShowHideOpts>'+translate('Esconder la ventana de opciones')+'</td></tr>';
      m += '</table>';
      
      m += '</td><TD>&nbsp; &nbsp; </td><TD style="align:right; vertical-align:top;">';
      	m += '<TABLE width=100%>';
      	m += '<TR><TD>'+translate('Donde quieres guardar las coordenadas')+'?</td></tr>';
  ...
  clickedSearch : function (){
    ...
    if (isNaN (t.opt.maxDistanceA) ||t.opt.maxDistanceA<0)
         errMsg += translate("La distancia minima no puede ser menor a 0")+"<BR>";
    if (isNaN (t.opt.maxDistance) ||t.opt.maxDistance<1)
          errMsg += translate("La distancia tiene que ser mayor a 1")+"<BR>";
    if (t.opt.maxDistance<=t.opt.maxDistanceA)
          errMsg += translate("La distancia maxima/minima ha sido excedida")+"<BR>";
     if(t.opt.maxDistanceA > 375)
           errMsg += translate("La distancia no puede ser mayor a 375")+" ! <BR>";
        if (errMsg != ''){
   ...
   if (t.opt.searchType == 0)
     ...
     if (t.opt.searchType == 1){
       ...
       m += '<TR><TD class=xtab align=right>'+translate('solo sin ocupar')+' :</td><TD class=xtab><INPUT id=filUnowned type=CHECKBOX '+ (Options.unownedOnly?' CHECKED':'') +'\><td></tr>';
     } 
     if (t.opt.searchType == 1 || t.opt.searchType == 0) {
 		...
 		m+= '<TR><TD class=xtab align=right >'+uW.arStrings.MapHelper.Filter+' :</td><TD class=xtab align=left ><SELECT style="width: 135px" id=idSrchFilter>\
            ...
            <OPTION value=1>'+uW.arStrings.Alliance.relationHostile+' '+uW.arStrings.Common.Cities+'</option>\
 	     	<OPTION value=2>'+translate('Solo ciudades con niebla')+'</option>\
         ...
         <tr><TD class=xtab align=right>'+translate('Min')+' '+uW.arStrings.Common.Glory+' :</td><TD class=xtab><select id=filPuissance>\
          ...
          <tr><TD class=xtab align=right>'+uW.arStrings.Common.Alliance+' '+translate('contenido')+' :</td><td class=xtab><input type=text size=10 id=filfiltreAlliance value="'+Options.filfiltreAlliance+'"></td></tr>\
        <tr><TD class=xtab align=right>'+uW.arStrings.Common.Player+' '+translate('contenido')+' :</td><td class=xtab><input type=text size=10 id=filfiltreJoueur value="'+Options.filfiltreJoueur+'"></td></tr>\
   ...
   dispMapTable : function (){
      ...
      for (i=0; i<t.mapDat.length; i++){
  	  ...
  	  switch(parseInt (Options.citySrchFilter)) {
                  ...
                  case 5:
                     ...
                     break;
                   case 6:
                     if ((t.mapDat[i][12] == translate('Desalineado')) && (Options.filPuissance<=Glory && Glory<=Options.filPuissanceMax)) {
                      dat.push(t.mapDat[i]);
                     }
                     break;
               }
      ...
      if (dat.length == 0){
        ...
        //  numRows = 1000;
         document.getElementById('srchSizeWarn').innerHTML = '<FONT COLOR=#600000>'+translate('NOTA : CUIDADO, no hay limitaciones para la busqueda, pero esto puede traer consecuencias en el rendimiento de tu navegador')+'.</font>';
        }
        for (i=0; i<numRows; i++){
         ...
         if ((t.opt.searchType != 2) || (dat[i][11].search(Options.filfiltreAlliance, "i") != -1 && dat[i][9].search(Options.filfiltreJoueur, "i") != -1 && t.opt.searchType == 2) ) {
  		...
  		if (coordsOnly) {
             ...
             m += ' ><TD valign="top" style="padding:2px"><DIV>\
		      ...
		      m+= '<td style="padding-left: 10px;"><a href="javascript:void(0)" onclick="BOSaveAttack('+ dat[i][0] +','+ dat[i][1] +',2,0);">'+uW.arStrings.Common.Save_Button+'</a></td><td align=right style="padding-left: 10px;"><span title="'+translate('Ultimo ataque')+'">'+t.findlastattack(dat[i][0],dat[i][1])+'</span></td>';
             ...
             if (t.opt.searchType == 1) {
              if (dat[i][5]) {
               ...
               m +='<td style="padding-left: 10px;"><a href="javascript:void(0)" onclick="BOSaveAttack('+ dat[i][0] +','+ dat[i][1] +',1,'+ dat[i][4]+');">'+uW.arStrings.Common.Save_Button+'</a></td><td align=right style="padding-left: 10px;"><span title="'+translate('Ultimo ataque')+'">'+t.findlastattack(dat[i][0],dat[i][1])+'</span></td>';
              }
  		   }else{
              m+="<td></td>";
...
my.Train = {
  ...
  cancelTrainingBO : function (i,cityId,typetrn,numtrptrn,p5,p6,p7,trainingId) {
   ...
   t.dispTrainStatus ('<font color=#550000><B>'+translate('Cancelar entrenamiento')+'</b></font><BR>');
          t.displayCityStats();
   })
    ...
    if (t.state == null){
     unsafeWindow.BOcancelTraining = t.cancelTrainingBO;
      s = "<DIV id=trainTopSelect>\
        ...
        <TR><TD align=right>"+translate('Numero de tropas por slot')+" : </td><TD><INPUT id='ptttInpPS' size=5 type='text' value='0'\></td>\
        ...
        <TR><TD align=right>"+translate('Numero de slots')+" : </td><TD><INPUT id='ptttInpSlots' size=2 type='text' value='1'\></td>\
  ...
  clickTroopDo : function (){
    ...
    t.displayCityStats ();
    if (perSlot<1){
      t.divTrainStatus.innerHTML = '<FONT COLOR=#550000>'+translate('El numero de tropas por slot debe ser mayor a')+' 0.</font>';
      return;
    }
    if (perSlot*numSlots > t.stats.MaxTrain){
      t.divTrainStatus.innerHTML = '<FONT COLOR=#550000>'+translate('No se puede entrenar tantas tropas')+' ('+translate('el maximo es')+' '+ t.stats.MaxTrain +' '+translate('total')+')</font>';
      return;
    }
    if (numSlots<1 || numSlots>t.stats.barracks - t.stats.queued){
      t.divTrainStatus.innerHTML = '<FONT COLOR=#550000>'+translate('numero de slots invalido')+'.</font>';
      return;
    }
    t.setBusy(true);
    var que = [];
...
/*******  DEF  ******/  
  ...
  clickDefDo : function (){
    ...
    t.displayCityStats ();
    if (perSlot<1){
      t.divTrainStatus.innerHTML = '<FONT COLOR=#550000>'+translate('El numero de unidades por slot debe ser mayor a')+' 0.</font>';
      return;
    }
    if (perSlot*numSlots > t.stats.MaxDefTrain){
      t.divTrainStatus.innerHTML = '<FONT COLOR=#550000>'+translate('No se puede entrenar tantas tropas')+' ('+translate('el maximo es')+' '+ t.stats.MaxDefTrain +' '+translate('total')+')</font>';
      return;
    }
  ...
  doDefQueue : function (cityId, que, errMsg){
    ...
    try {
      ...
      var cmd = que.shift();
      if (!cmd){
        t.dispTrainStatus ('<B>'+translate('Defensas en cola terminadas')+'.</b><BR>');
        t.setBusy(false);
        return;
      }
      if (cmd[0] == 'T'){
        t.dispTrainStatus (translate('Entrenar')+' '+ cmd[2] +' '+  fortNamesShort[cmd[1]] +'<BR>');
  ...
  doQueue : function (cityId, que, errMsg){
    ...
    try {
      ...
      var cmd = que.shift();
      if (!cmd){
        t.dispTrainStatus ('<B>'+translate('Entrenamiento terminado')+'</b><BR>');
        t.setBusy(false);
        return;
      }
      if (cmd[0] == 'T'){
        t.dispTrainStatus (translate('Formacion')+' : '+ cmd[2] +' '+  unsafeWindow.arStrings.unitName["u"+cmd[1]] +'<BR>');
  ...
  show : function (){
    ...
    clearTimeout (t.displayTimer);
      ...
      str = '<div style="height:670px;max-height:670px;overflow-y:auto"><DIV class=ptstat style="margin-top:2px; margin-bottom:2px; "><TABLE cellspacing=0 cellpadding=0 class=ptTab width=97% align=center>\
        ...
        <TD><SPAN class=ptStatLight>'+translate('Unido a')+' :</span><br>'+ dt.toLocaleDateString() +'</td>\
...
my.AutoForm = {
  ...
  show : function (){
    ...
    if (TrainOptions.Running == false) {
		...
		m+= '<input id=aFtimelauch type=text size=2 value="'+parseIntNan(TrainOptions.timelauch)+'"> '+translate('Segundos de entrenamiento entre ciudades');
		m+= '</center><br><br>';
		m+= "<TABLE width=100% class=ptTab border=0 align=center><tr align=right><td align=right>#</td><td align=right>"+translate('Activar')+"</><td style='text-align:left;'>"+uW.arStrings.Common.City+"</td><td style='text-align:left;'>"+uW.arStrings.Common.Troops+' '+uW.arStrings.Common.Type+"</td><td style='text-align:left;'>"+uW.arStrings.Common.Quantity+"</td></tr>";
    for (var c=0; c<Cities.numCities; c++) {
...
//	setInterval(t.displayCityStats,parseInt(5*1000));
  ...
  cancelTrainingBO : function (i,cityId,typetrn,numtrptrn,p5,p6,p7,trainingId) {
   ...
   actionLog('Auto'+uW.arStrings.Common.Train,Cities.cities[cityId].c.name+' <font color=#550000><B>'+translate('Cancelar el entrenamiento')+' - ID:'+i+'</b></font>');
          t.displayCityStats();
   })
 },  
    ...
    var t = my.Spam;
        ...
        var m = '<DIV class=ptstat>SPAM - '+translate('CONFIGURACION')+'</div><TABLE class=pbTab width=100% height=0% ><TR align="center">';
           ...
           m += '<DIV class=ptstat>'+translate('OPCIONES')+'</div><TABLE class=pbTab>';
            m += '<tr><td>'+translate('enviar mensaje automatico cada')+' <INPUT id=pbSpamMin type=text size=2 maxlength=3 value="'+ Options.spamconfig.spammins +'"  \> '+uW.arStrings.TimeStr.timeMin+'</td></tr><BR>\
                  <tr><TD><TABLE cellpadding=0 cellspacing=0>\
                  <TD align=left>'+translate('tu mensaje')+' : &nbsp; </td><TD><INPUT id=pbSpamAd type=text size=60 maxlength=250 value="'+ Options.spamconfig.spamvert +'" \></td></tr>\
                  </table><BR>';
...
function ResRequest () {
    ...
    popResRequest.getTopDiv().innerHTML = '<CENTER><B>'+translate('Recursos pedidos')+'</b></center>';
    var m = '<br><b>'+translate('Que recursos quieres pedir a tu alianza')+'?</b>';
    	m+= '<br>';
...
function alertlang () {
		...
		var m = '<center><b><i>Gracias por instalar '+ScriptName+'</i>';
			m+= '<br>Antes de empezar elija su lenguaje!</b>';
			m+= '<br><br>'+htmlSelector({0:'...', 1:'Español', 2:'Italiano'},Options.Lingua,'id=BOFirstLangue');
...
function alerthq () {
		...
		var m = '<center><br><br><b>'+translate('Elije tu ciudad bunker');
			m+= '<br><br>';
...
function CheckUpdates ()
{
	...
	(
		{
			method	:	"GET",
			   url		:	"http://userscripts.org/scripts/source/172311.user.js",
			/*url		:	"http://www.kocbottols.tiestoale.com/Tools/GoR/bottols.user.js",*/
			onload	: 
				function (a)
				{
					var b = /\/\/\s*@version\s+(.+)\s*\n/i.exec(a.responseText);
       				...
       				if (b)
       				{
       					if (b[1] > c)
       					{
							...
							var m = '<center><br><b>'+translate('Version')+" "+b[1]+" "+translate('disponible')+"!";
								m+= '<br><br><input type="button" value="'+translate('Instalar')+'" id=BOInstall>';
