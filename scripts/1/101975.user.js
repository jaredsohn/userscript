...
// @namespace      Servicio
// @description    Script para la comunidad Servicio Tecnico para PC
// @include        *taringa.net/*
// @exclude        *http://www.taringa.net/comunidades/serviciotecnico/*
// ==/UserScript==
...
byClass('menuTabs').innerHTML += "<li id=\"tabbedWTF\" class=\"tabbed\">\n <a href=\"http://www.taringa.net/comunidades/serviciotecnico/\" onclick=\"menu(\'Servicio Tecnico para PC \', this.href);return false;\" title=\"Ir a la comunidad Servicio Tecnico para PC\">S.T.P.P. <img src=\n\"\" alt=\"\" /></a>\n</li>";
