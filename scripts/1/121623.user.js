// coding: utf-8
// ==UserScript==
// @name	Ikariam Empire Board(Φασουλάδα)
// @version	208
// @author	Φασουλάδα
...
EmpireBoard.Renders.Buildings_Table_Content = function()
	...
	for (CityId in Cities)
		...
		s += "<td class='nolf city_name' nowrap>"+createLinkToChangeCity(Cities[CityId].name, CityId, i, (usedspaces > 0) ? 17-usedspaces : '', 'Green', 'Available free spaces')+"</td>";
...
EmpireBoard.Renders.Resources_Table_Content = function()
	...
	function createLinkToResources(city_id)
		...
		if (res.island_id != undefined)
			{
			rHTML += '<a class="changeCity" cityid="'+city_id+'" href="?view=resource&type=resource&id=' + res.island_id + '" title="View island saw mill"><img height="12" align="absmiddle" src="skin/resources/icon_wood.png" /></a>';
			rHTML += '&nbsp;';
			
			if (res.prodgood == 'wine')
				{
				rHTML += '<a class="changeCity" cityid="'+city_id+'" href="?view=tradegood&type=tradegood&id=' + res.island_id + '" title="View island vineyard"><img height="12" align="absmiddle" src="skin/resources/icon_wine.png" /></a>';
				}
			else if (res.prodgood == 'marble')
				{
				rHTML += '<a class="changeCity" cityid="'+city_id+'" href="?view=tradegood&type=tradegood&id=' + res.island_id + '" title="View island quarry"><img height="12" align="absmiddle" src="skin/resources/icon_marble.png" /></a>';
				}
			else if (res.prodgood == 'glass')
				{
				rHTML += '<a class="changeCity" cityid="'+city_id+'" href="?view=tradegood&type=tradegood&id=' + res.island_id + '" title="View island crystal mine"><img height="12" align="absmiddle" src="skin/resources/icon_glass.png" /></a>';
				}
			else if (res.prodgood == 'sulfur')
				{
				rHTML += '<a class="changeCity" cityid="'+city_id+'" href="?view=tradegood&type=tradegood&id=' + res.island_id + '" title="View island sulphur pit"><img height="12" align="absmiddle" src="skin/resources/icon_sulfur.png" /></a>';
				}
...
EmpireBoard.Renders.IconTo_researchAdvisor = function(Title)
	...
	rHTML += '<a view="researchAdvisor" href="?view=researchAdvisor" title="'+Title+'"><img align="absmiddle" src="skin/resources/icon_scientist.png"/></a>';
...
EmpireBoard.Intl.Load_Texts_PL = function()
	...
	buildings = {
		...
		"dump"			 : ["SkĹ‚adowisko", "SkĹ‚adowisko"], 
		"wall"			 : ["Mur", "Mur"],
	...
	texts = {
		...
		"finishedBuilding"	: "Budowa zakoĹ„czona",
		"Incomes"			: "Bilans zĹ‚ota",
		"Trading"			: "Handel",
		"Wood"				: "Drewno",
		"Wine"				: "Wino",
		"Marble"			: "Marmur",
