// ==UserScript==
// @name           Legacy Membership Script 2.0
// @namespace      AirMcMVP
// @version        2.0
// @date           2013.04.17
...
var SCRIPT = {
	name: 'Legacy Membership Script 2.0',
	namespace: 'AirMcMVP',
	source: 'http://userscripts.org/scripts/show/165156',
	identifier: 'http://userscripts.org/scripts/source/165156.user.js',
	meta: 'http://userscripts.org/scripts/source/165156.meta.js',
	version: '2.0',
	date: '2013.04.17',
};

var threadURL = 'http://goallineblitz.com/game/forum_thread.pl?thread_id=5067297';
var postId = '47178086';
...
var list = {
	...
	apprentice: {
		...
		agentTitle: function(id, name) { return 'Inactive'; },
		forumAccess: 1,
	},
	promoteme: {
		member: {},
	...
	waitlist: {
		member: {},
		title: 'waitlist',
		style: 'color: Purple; background-color: pink; padding: 0px 3px 0px 3px;',
	...
	hitlist: {
		...
		agentTitle: function(id, name) { return 'Former Legacy Members'; },
		forumAccess: 0,
	},
};
var listName = {};
...
//						data.html(data.html().replace(n + '</a>', n + '</a> (real name: ' + realName.replace('(banned)', '<b><i>(banned)</i></b>') + ')'));
			...
			if (membersFNG) {
				statusMsg += prefix + '<b style="color: green;">' + membersFNG + ' Inactive Members</b>';
				prefix = ', ';
			}
			if (membersPromoteMe) {
			...
			if (membersHitList) {
				statusMsg += prefix + '<b style="color: white; background-color: black; padding: 0px 3px 0px 3px;">' + membersHitList + ' Former Members</b>';
				prefix = ', ';
			}
			if (unknown.length) {
