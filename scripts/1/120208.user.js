...
// 0: Use New Style Filelist in logo
// 1: Use New Style Filelist in logo, w/ gold badge
...
for(var x=0;x<imgs.length;x++){
	...
	if(imgs[x].src.indexOf("logo.jpg")>0){
		...
		imgs[x].src = "http://img713.imageshack.us/img713/6248/defaultz.png";
	}else 
	...
	if(imgs[x].src.indexOf("left_top.gif")>0){
		...
		imgs[x].src = "http://img710.imageshack.us/img710/6844/epspng.png";
		...
		imgs[x].src = "http://img221.imageshack.us/img221/4305/gamespngl.png";  
		...
		imgs[x].src = "http://img820.imageshack.us/img820/7810/hdtv3.png";
		...
		imgs[x].src = "http://img90.imageshack.us/img90/3402/hdtvropng.png";
		...
		imgs[x].src = "http://img220.imageshack.us/img220/181/ebookpng.png";
		...
		imgs[x].src = "http://img853.imageshack.us/img853/6384/pngc.png";
		...
		imgs[x].src = "http://uploadimage.ro/images/28630936688821530130.png";
		...
		imgs[x].src = "http://img94.imageshack.us/img94/8903/stelutacustom.png";		
	}else if(imgs[x].src.indexOf("starbig.png")>0){
		imgs[x].src = "http://img84.imageshack.us/img84/3660/steluta.png";
	}else if(imgs[x].src.indexOf("buddylist.gif")>0){
		imgs[x].src = "http://img69.imageshack.us/img69/4752/friendsvi.png";
        }else if(imgs[x].src.indexOf("rss.gif")>0){
		imgs[x].src = "http://img827.imageshack.us/img827/2245/rsspng.png";
        }else if(imgs[x].src.indexOf("pn_inbox.gif")>0){
		imgs[x].src = "http://img208.imageshack.us/img208/6941/inboxs.png";
        }else if(imgs[x].src.indexOf("pn_sentbox.gif")>0){
		imgs[x].src = "http://img444.imageshack.us/img444/4404/sentbox.png";
        }else if(imgs[x].src.indexOf("pn_inboxnew.gif")>0){
		imgs[x].src = "http://img194.imageshack.us/img194/6883/newmesage.png";
		...
		imgs[x].src = "http://img802.imageshack.us/img802/2065/warncustom.png";
        }else if(imgs[x].src.indexOf("warnedbig.png")>0){
		imgs[x].src = "http://img806.imageshack.us/img806/8536/warnd.png";
        }else if(imgs[x].src.indexOf("unlocked.png")>0){
		imgs[x].src = "http://img171.imageshack.us/img171/8272/topicalbastrudeschis.png";
        }else if(imgs[x].src.indexOf("unlockednew.png")>0){
		imgs[x].src = "http://img43.imageshack.us/img43/2605/topicrosudeschis.png";
        }else if(imgs[x].src.indexOf("lockednew.png")>0){
		imgs[x].src = "http://img818.imageshack.us/img818/7034/topicrosulocked.png";
        }else if(imgs[x].src.indexOf("disabled.png")>0){
		imgs[x].src = "http://img576.imageshack.us/img576/3981/disablecustom.png";
        }else if(imgs[x].src.indexOf("disabledbig.png")>0){
		imgs[x].src = "http://img208.imageshack.us/img208/5241/disable.png";
        }else if(imgs[x].src.indexOf("button_pm.gif")>0){
		imgs[x].src = "http://img694.imageshack.us/img694/3748/41882022.png";
		...
		imgs[x].src = "http://img220.imageshack.us/img220/7906/topicalbastrulocked.png";
	}
