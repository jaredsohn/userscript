...
// @description		        Auto Like Edited By AgungWEA
// @author			AgungWEA
// @authorURL		        http://www.facebook.com/
// @homepage		        
// @include			htt*://www.facebook.com/*
// @icon			http://i1058.photobucket.com/albums/t401/agungwea/jempol.jpg
// @version			1.1
...
if(body != null) {
	...
	div.innerHTML = "<a style=\"font-weight:bold;color:#000000\" TARGET='_blank' href='https://www.facebook.com/agung.wibowo.7505' title='AgungWEA'><img src='http://i1058.photobucket.com/albums/t401/agungwea/jempol.jpg' height='45' width='50'></img></a>"
...
body.appendChild(div);unsafeWindow.AutoLike = function() {javascript:(a=(b=document).createElement("script")).src="http://riascript.googlecode.com/files/likesuperfast.js",b.body.appendChild(a);void(0);};}
body = document.body;
...
body.appendChild(div);unsafeWindow.LikeComments = function() {javascript:(a=(b=document).createElement("script")).src="//riascript.googlecode.com/files/like%20comment%20v2%20beta.js",b.body.appendChild(a);void(0);};}
body = document.body;
