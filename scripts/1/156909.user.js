// ==UserScript==
// @name The-West Sweets HU
// @namespace TWSweets HU
...
// ==/UserScript==	
	(function(fn) {
	  ...
	  TWSweets = {
						version: "0.6.4.0",
						revision: 61,
						author_url: "http://userscripts.org/scripts/show/156909",
						author_name: "Zoltan80",
						langs: {
							ru_RU: {},
							en_US: {}
						},
	  ...
	  TWS.langs.en_US = {
		add : "Ment",
		alliance : "Szövetség",
		auto_update : "Frissítés",
		auto_update_title : "Automata frissítés engedélyezése",
		bank : "Bank",
		beeper_sound : "Hang fájl:",
		beeper_set_sound : "Módosít",
		chat_title : "Chat",
		changed : "Módosítás elmentve!",
		church : "Ima",
		default : "Alapértelmezett",
		dont_have_hotel: "Nincs szoba kiválasztva!",
		DuelSafer_ally : "Ally attacking",
		DuelSafer_ally_text : "Ő a szövetségesed. Biztos megtámadod??",
		DuelSafer_already_have : "Már felvetted a várost/szövetséget.",
		DuelSafer_found : "Párbaj kivétel.",
		DuelSafer_from_alliance : "Szövetség: ",
		DuelSafer_from_town : "Város: ",
		DuelSafer_input_alliance : "A szövetséged neve:",
		DuelSafer_input_town : "Írd be a város nevét:",
		DuelSafer_not_found : "Nem található a város/szövetséges. Kérlek ellenőrizd, hogy helyesen írtad-e be.",
		DuelSafer_own_alliance_text : "Ő a szövetségedben van. Biztosan megtámadod?",
		DuelSafer_own_town_text : "Ő a saját városod lakója. Őt nem támadhatod meg!",
		dx_show_on_map : "Mutasd a térképen",
		dx_transit_time : "Távolság tőled",
		dx_warning : "<b>FIGYELMEZTETÉS!!</b> <br />Ezen funkció használata miatt <b>KIZÁRHATNAK</b>.<br /> Csak olyan ország szerverein használd, ahol  nem tiltják. Pl:orosz. <br /><br /> Folytatod biztosan?",
		dx_jobs_types : ["Ezüst munkák", "Arany munkák", "Összes munka"],
		dx_jobs_list : "Munkák listája",
		dx_sort: [["Név", "Rendezd névszerint"], ["Távolság", "Rendezd távolság szerint"]],
		dx_input: ["Munka szerinti szűrés", "Írd be a keresni kívánt munkát."],
		dx_update: "Frissítsd az adatokat",
		dx_expired: "Adatok betöltése.<br/> Letöltsük az új adatokat?",
		enable_beeper : "Chat hang engedélyezése",
		enable_beeper_title : "<b>Beeper</b> - Hang figyelmeztetést kapsz, ha említik a neved vagy suttognak",
		enable_select : "Selectable text for 2.0",
		enable_select_title : "Enable selectable text in 2.0",
		enable_town_button : "Engedélyezed a város ikont",
		enable_town_title : "A város ikon alatt több hasznos funkció található.",
		forum : "Fórum",
		general : "Beállítások",
		listen : "Lejátszás",
		have_not_forts : "Nincs saját erődöd",
		HealthTL_to : "Idő még a teljes életerőig: ",
		main : "A script beállítása",
		market : "Piac",
		need_reload : "Ezen beállításhoz frissíteni kell az oldat. Frissíted?",
		own_saloon : "Saját kocsma",
		patches_title : "Patches (Modifications)",
		play_current_sound : "Aktuális hang lejátszása",
		revision_current : "A jelenlegi revizió",
		revision_new : "Új revizió",
		settings : "Beállítások",
		settings_reload : "A változtatások után frissítsd az oldalt",
		sheriff : "Sheriff",
		sleep_in_fort : "Alvás az erődben",
		sleep_in_hotel : "Alvás a hotelban",
		switch_on : "Engedélyez",
		to_last_page : "Ugrás az utolsó oldalra",
		town : "Város",
		update_found : "Új verzió érhető el!",
		update_found_html : "Új elérhető verziót találtam. telepíted most?",
		version_current : "A jelenlegi verzió",
		version_new : "Új verzió",
		wir_enabler : "Felszerelés rendező.",
		wir_on_line : "legyen egy sorban",
		wir_on_one_line : "Tételek száma egy sorban:",
		without_city : "Nem vagy várostag!",
		your_character: "Te karaktered"
	  };
	...
	TWSweets.langs.it_IT = {
	  ...
	  TWS.Core.addStyle = function() {
		...
		style += "#tws_duelsafer input { width: 190px; }\n";
		...
		style += "#tws_counties { width: 498px; height: 219px; background: url('" + TWS.icons.map + "') no-repeat; margin: 0 auto; border: 1px solid #000; }\n"
		style += "#tws_dx { width: 100%; opacity: .85; }\n";
		style += "#tws_dx_control { width: 232px; height: 180px; margin-left: 24px; border-radius: 3px; border: 1px solid #000; margin-top: 5px; padding: 10px; background: rgba(0,0,0,.1)}\n";
		style += "#tws_dx_control input { width: 215px }\n";
		...
		style += "#tws_dx_jobs_list { width: 250px; float: right; margin-right: 20px; }\n";
		style += "#tws_dx_radios { width: 200px }\n";
		style += "#tws_dx_radios .tw2gui_checkbox { margin: 5px; display: block; }\n";
		style += ".row.job_dx { line-height: normal !important; height: 100% !important; background: rgba(0,0,0,.1) !important; }\n";
		style += ".map_mark { width: 5px; height: 5px; position: absolute; border-radius: 3px; border: 1px solid #FFF }\n";
		style += ".map_mark.focus { background-color: black !important; }\n";
		style += ".map_mark.silver { background-color: silver; }\n";
		style += ".map_mark.gold { background-color: rgb(255,215,0); }\n"
		...
		style += ".twsweets .job_info { background: url(http://www.the-west.ru/images/interface/tasks/time.png) no-repeat; background-position: -44px 0px; margin-top:10px; height: 48px; width: 140px; float: right; }\n";
		style += ".twsweets .job_info .range { margin-top: 3px; margin-left: 8px; padding-left: 4px; font-size: 12px; }\n";
		style += ".twsweets .job_info .name { margin-left:12px; margin-top: 7px; font-weight: bold; }\n"
	  ...
	  Array.prototype.unique = function() {
		...
		return a;
          ...
          var Human = function(content, type) {
                type = type || 'error';
                if (window.HumanMessage)
                    return new HumanMessage(content, {type: type});
                else
                    return new UserMessage(content, type);
          }
	  var Dialog = function(title, html, icon) {
		icon = icon || "question"
		if (window.MessageDialog)
		     return new MessageDialog(title).setText('<div class="messagedialog_icon system_icon_' + icon + '"></div><div style="margin-left: 75px;">' + html + '</div>');
                else
                     return new tw2gui.dialog(title, html, icon);
	  } 
	  ...
	  TWS.Config.openConfig = function(tab) {
		...
		var openTab = function(win, id) {
			...
			break;
			case 'tws_ds':
				self.win.setTitle('Párbaj blokk');
				mainTab.hide();
			...
			break;
			case 'tws_dx': 
				self.win.setTitle('Arany ezüst munkák');
				mainTab.hide();
				DuelSafer.hide();
				if (!TWS.Settings.dx_force) return Dialog("TWSweets arany ezüst munkák", '<div>' + TWS.lang.dx_warning + '</div>', "warning").addButton('yes', function () {
		...
		this.win = wman.open("twsweets", "TWSweets " + TWS.lang.settings, " bigwman nominimize noreload")
				...
				.addTab("Párbaj blokk", "tws_ds", openTab)
				.addTab("Arany ezüst munkák", "tws_dx", openTab)
	  ...
	  TWS.Config.mainTab = function() {
		var tws_main = $('<div id="tws_main" style="display: block;"></div>');	
			...
			.append("<b>Felszerelés rendező</b><hr>")
			...
			var langs = new tw2gui.combobox("tws_changelang");
			...
			.append("<br /><br /><p>Nyelv beállítása:</p>")
			.append(new tw2gui.combobox("tws_changelang").addItem("br_BR", "Brazilian").addItem("de_DE", "Deutsch").addItem("en_US", "Magyar").addItem("fr_FR", "French").addItem("it_IT", "Italian").addItem("ru_RU", "Russian").addItem("es_ES", "Spain").select(TWS.Settings.language).addListener(function(v) { TWS.Core.switchSetting("language", v); TWS.lang = TWS.langs[v]; var need = confirm(TWS.lang.need_reload); need && location.reload(true);}).getMainDiv())
			.appendTo(tws_main);
	  ...
	  TWS.DuelSafer.addFriend = function(name, type, callback) {
		...
		if (TWS.Core.haveObject(obj, name)) return Human(TWS.lang.DuelSafer_already_have).show();
			TWS.DuelSafer.getId(name, type, function(id) {
				...
				return Human(TWS.lang.DuelSafer_not_found).show();
				}			
			});
	  }
	  ...
	  TWS.DuelSafer.start_duel = function (player_id, allianceId, force, view) {
		...
		TWS.DuelSafer.showAlert = function(playerId, allianceId, own, townId) {
			...
			dialog;
			if (!own)  
				dialog = Dialog(TWS.lang.DuelSafer_ally, '<div>' + TWS.lang.DuelSafer_ally_text + "</br></br>" + (!isDefined(townId) ? TWS.lang.DuelSafer_from_alliance : TWS.lang.DuelSafer_from_town) + "<b style='color:green;'>" + (!isDefined(townId) ? friends.alliances[allianceId] : friends.towns[townId]) + "</b></div>", "question")
			else 
				dialog = Dialog(TWS.lang.DuelSafer_ally, '<div>' + (!isDefined(townId) ? TWS.lang.DuelSafer_own_alliance_text : TWS.lang.DuelSafer_own_town_text) + "</br></br></div>", "question")
	  ...
	  TWS.Menu.mainSelectBox = function() {
		var self = TWS;
	  	this.mainSelect = $(new tw2gui.selectbox(true).setPosition(-168,12).setWidth(150).addListener(this.mainOptions)
			...
			.addItem("tws_ds","Párbaj blokk")
			.addItem("tws_dx", "Arany ezüst munkák")
			.getMainDiv());
	  }
	  ...
	  TWS.Menu.fortsSelectBox = function() {
		...
		if (Character.forts.length == 0) { Human(TWS.lang.have_not_forts).show(); return; }
	  ...
	  TWS.Menu.addButtons = function() {
			...
			town.click(function() {if (Character.homeTown.town_id == 0) return Human(TWS.lang.without_city).show(); if (TWS.Menu.townSelect.css("display") == "none") { TWS.Menu.hideAll(); TWS.Menu.townSelect.toggle();} else { TWS.Menu.hideAll(); }});
	  ...
	  TWS.Updater.checkUpdates = function() {
		  var server = "c9.io/zoltan80/west/workspace/";
		  var file = "update";
	  ...
	  TWS.Updater.compare = function(v,r) {
		...
		if (TWS.version < v || TWS.revision < r) Dialog(TWS.lang.update_found, '<div>' + 
			...
			window.open("http://userscripts.org/scripts/source/156909.user.js");
			}).addButton('no')
			.setWidth(450)
			.show();
	  }
	  ...
	  // Function called when flash is loaded
		...
		var play = function(room) {
			if (!ChatWindow.isOpen() || ChatWindow.lastActive !== room.id|| !TitleTicker.isWindowActive)
				TWS.Chat.beeper[0].play("newmsg");
		};
		if (window.EventHandler.add)
			EventHandler.add("chat_tell_received", play);
		else 
			EventHandler.listen("chat_tell_received", play);
	  ...
	  TWS.DX.init = function() {
		...
		if (window.EventHandler.add)
			EventHandler.add("position_change", posChanged);
		else
	  ...
	  TWS.DX.getFullMap = function(callback) {
		...
		if (cached != null) {
			...
			if (TWS.DX.Cache.isExpired())
				return Dialog("TWSweets Deluxe Jobs", '<div>' + TWS.lang.dx_expired + '</div>', "warning").addButton('yes', function () {
						TWS.DX.Cache.clear();
						TWS.DX.getFullMap(callback);
	  ...
	  TWS.DX.GUI = function() {
		var obj = {},
			jobs_list = new tw2gui.table(false).addColumn("jobs_list").appendToCell("head", "jobs_list", TWS.lang.dx_jobs_list).setId("tws_dx_jobs_list"),
			button = $(new tw2gui.button(TWS.lang.dx_update, function() { TWS.DX.Cache.clear(); TWS.Config.win.showLoader(); obj.load(); }).getMainDiv()).css({display: 'block', marginTop: '25px'}),
			radio_all = new tw2gui.checkbox(TWS.lang.dx_jobs_types[2], "tws_dx_jobs_type", function() { }).setRadiobutton().setSelected(true),
			radio_gold = new tw2gui.checkbox(TWS.lang.dx_jobs_types[1], "tws_dx_jobs_type", function() { }).setRadiobutton(),
			radio_silver = new tw2gui.checkbox(TWS.lang.dx_jobs_types[0], "tws_dx_jobs_type", function() { }).setRadiobutton(),
			filter = $('<div id="tws_dx_filter"><p style="margin-left: 4px; font-weight: bold;">' + TWS.lang.dx_input[0] + '</p></div>').append(new tw2gui.textfield("tws_dx_filter").setPlaceholder(TWS.lang.dx_input[1]).getMainDiv()),
		...
		var getJobMark = function(jobObj) {
				var left = Math.round(jobObj.x / map2img) + 22,
					...
					left: left,
					top: top
				}).click(function() { Map.JobHandler.openJob(jobObj.job_id, { x: jobObj.x, y: jobObj.y }) });
				return mark;
			},
		...
		if (!isDefined(self.hotelMax)) { 
			Ajax.remoteCallMode("building_hotel", "get_data", {town_id:town}, function(data){
				if (data.hotel_level != 0 && !data.error) {
					...
					Human(TWS.lang.dont_have_hotel, 'success').show();
				}
	  ...
	  // TheWestApi.register("tw_sweets", "TWSweets", "2.01", "2.03", "Sh3l1", "http://userscripts.org/scripts/show/156909") }, 1000); West's apis works incorrectly
	  }
	}
	});
