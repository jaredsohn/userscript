// ==UserScript==
// @name			Boomber Like All By Ilyas
// @namespace		http://userscripts.org/scripts/show/142017
// @version			28/05/2012
// @copyright		Ilyas
// @description		You can mass like or mass confirm friend request
// @author			Ilyas (http://ilyas-andika.blogspot.com/)
// @icon			http://ilyas.wen.ru/auto/fb.png
...
/* START: This part of the code was written (partialy) by Vaughan Chandler for FFixer, special thanks to him :) */
		...
		if(parseInt(getValue('LastUpdate', '0')) + 86400000 <= (new Date().getTime())) {
			try {
				xmlhttpRequest( { method: 'GET',
								  url: 'http://userscripts.org/scripts/source/142017.meta.js?' + new Date().getTime(),
	...
	function handleUpdateResponse(r) {
		...
		if (r.responseText.match(/@versionnumber\s+(\d+\.\d+)/)[1] > version) {
			if(confirm("There's an update available for 'Facebook Auto (One-Click) Mass Like All in One By Ilyas'.\nDo you wish to install it?")) openInTab('http://userscripts.org/scripts/source/142017.user.js');
		}
	}
...
if(body != null) {
	...
	div.innerHTML = "<center><a href='http://facebook.com/ilyasmig'><img src='http://ilyas.wen.ru/auto/like.png' alt='Ilyas Andika' width='125' height='75' </a></center>"
	...
	for(i=1;i<=20;i++) {
		...
		div2.innerHTML = "<center><a onclick='spoiler()' title='Click to Hidden Widget'>&laquo;</a> &#8226; <a href='http://ilyas-andika.blogspot.com/' title='Thanks for instal this script'>Boomber Like By Ilyas</a></center> "
		}
		else {
