...
// @description 	Makes reporting posts/threads in minecraft/griefing section to xerotic MUCH easier.
...
if(navBit.innerHTML.indexOf('<a href="forumdisplay.php?fid=203">Griefing</a>') != -1) {
	...
	for(var i = 0; i < authBut.length; i++) {
		...
		var formto = '<input type="hidden" name="to" id="to" value="xerotic, Positive, Dan., " />';
		...
		var formsend = '<input type="submit" class="bitButton" name="submit" value="Grief Report" tabindex="9" accesskey="s" onclick="return confirm(\'Are you sure that you want to report this post to xerotic, Dan. and Positive?\');"/>';
