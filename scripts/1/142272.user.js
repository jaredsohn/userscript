...
// @icon        http://s3.amazonaws.com/uso_ss/icon/142272/large.jpg?1351348974
// @version     Master Hwoarang
// ==/UserScript==
    ...
    function Ta() {
        ...
        function Q(c, d) {
            ...
            Q.prototype.ce = function () {
                this.b.j = e;
                r(A("GembuL", "Version " + (new Date(1E3 * p(User.bt))).toUTCString()));
                r(A('<span class="gold_star"></span> Gaya 69 </span><span class="gold_star"></span>', "Version " + va));
        ...
        function g(c, l) {
            ...
            g.prototype.Hf = function (a) {
                this.a.ha = Math.max(1, Math.min(p($(a).val()), 12));
                $(a).val(this.a.ha);
                this.d();
                return e
            };
            g.prototype.Jf = function (a) {
                this.a.Ua = Math.max(1, Math.min(p($(a).val()), 12));
                $(a).val(this.a.Ua);
                this.d();
                return e
            };
            ...
            g.prototype.cf = function (a) {
                this.a.R = Math.max(1, Math.min(p($(a).val()), 6));
                $(a).val(this.a.R);
                this.d();
                return e
            };
        ...
        j,
        U;
        va = /.Revision: (\d+) ./.exec("$Revision: 69 $")[1];
        la = "GEMBUL";
        var C,
        Ca,
        o,
