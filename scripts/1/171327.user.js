...
// @include        http://*.1kibaku.jp/facility/castle_send_troop.php*
// @include        http://*.bmcaxis.jp/map.php*
// @include        http://*.bmcaxis.jp/alliance/info.php*
// @include        http://*.bmcaxis.jp/user/*
// @include        http://*.bmcaxis.jp/facility/castle_send_troop.php*

// @description    ブラウザ一騎当千 地図ツール by 浮浪プログラマ(どらごら改造バージョン4+ex3)一騎当千化
// ==/UserScript==
...
var USER_COLORS_DEF = new Array(
	"#0000a0", "#a00000", "#00a000", "#808000", "#008080", "#ffff00", "#ff7f00", "#ff0000", "#ff007f", "#ff00ff",
	"#0000a0", "#a00000", "#00a000", "#808000", "#008080", "#ccff00", "#cc7f00", "#cc0000", "#cc007f", "#cc00ff",
	"#0000a0", "#a00000", "#00a000", "#808000", "#008080", "#99ff00", "#997f00", "#990000", "#99007f", "#9900ff"
	);
...
var MINPEI = [
	[1,"★"                ,"学1 体0 武0 食0" , 5 ,  0   ,  0   ,  0   ,   0 ,  0  ,   0 ],
	[1,"★"                ,"学0 体1 武0 食0" , 5 ,  0   ,  0   ,  0   ,   0 ,  0  ,   0 ],
	[1,"★"                ,"学0 体0 武1 食0" , 5 ,  0   ,  0   ,  0   ,   0 ,  0  ,   0 ],
	[1,"★"                ,"学0 体0 武0 食1" , 5 ,  0   ,  0   ,  0   ,   0 ,  0  ,   0 ],
	[1,"★★"              ,"学3 体0 武0 食0" , 0 ,  0.5 ,  4   ,  0.5 ,   0 ,  0  ,   0 ],
	[1,"★★"              ,"学0 体3 武0 食0" , 0 ,  4   ,  0.5 ,  0.5 ,   0 ,  0  ,   0 ],
	[1,"★★"              ,"学0 体0 武3 食0" , 0 ,  0.5 ,  0.5 ,  4   ,   0 ,  0  ,   0 ],
	[1,"★★★"            ,"学1 体1 武1 食0" , 0 ,  6   ,  6   ,  6   ,   0 ,  0  ,   0 ],
 	[1,"★★★"            ,"学0 体0 武0 食4" , 0 ,  7.5 ,  7.5 ,  7.5 ,   0 ,  0  ,   0 ],
 	[1,"★★★★"          ,"学2 体2 武2 食0" , 0 , 12.5 , 12.5 , 12.5 ,   0 ,  0  ,   0 ],
	[1,"★★★★"          ,"学0 体0 武0 食8" , 0 , 12.5 , 12.5 , 12.5 ,   0 ,  0  ,   0 ],
	[1,"★★★★"          ,"学2 体2 武2 食2" , 0 , 11   , 11   , 11   ,   0 ,  0  ,   0 ],
	[1,"★★★★★"        ,"学6 体0 武0 食0" , 0 , 10   , 40   , 10   ,   0 ,  0  ,   0 ],
	[1,"★★★★★"        ,"学0 体6 武0 食0" , 0 , 40   , 10   , 10   ,   0 ,  0  ,   0 ],
	[1,"★★★★★"        ,"学0 体0 武6 食0" , 0 , 10   , 10   , 40   ,   0 ,  0  ,   0 ],
	[1,"★★★★★★"      ,"学10 体0 武0 食0", 0 , 75   , 15   , 15   ,   0 ,  0  ,   0 ],
	[1,"★★★★★★"      ,"学0 体10 武0 食0", 0 , 15   , 75   , 15   ,   0 ,  0  ,   0 ],
	[1,"★★★★★★"      ,"学0 体0 武10 食0", 0 , 15   , 15   , 75   ,   0 ,  0  ,   0 ],
	[2,"★★★★★★★"    ,"学2 体4 武4 食0",  0 ,  0   ,  0   , 0    ,  65   ,  22.5 ,  65   ],
	[2,"★★★★★★★"    ,"学0 体0 武0 食1",  0 ,  0   ,  0   , 0    ,  65   ,  65   ,  22.5 ],
	[2,"★★★★★★★"    ,"学0 体0 武0 食12", 0 ,  0   ,  0   , 0    ,  22.5 ,  65   ,  65   ],
	[2,"★★★★★★★★"  ,"学4 体1 武2 食0",  0 ,  0   ,  0   , 0    ,  50   , 250   ,  25   ],
	[2,"★★★★★★★★"  ,"学2 体4 武1 食0",  0 ,  0   ,  0   , 0    , 250   ,  50   ,  25   ],
	[2,"★★★★★★★★"  ,"学1 体2 武4 食0",  0 ,  0   ,  0   , 0    ,  25   ,  50   , 250   ],
	[2,"★★★★★★★★★","学4 体4 武4 食4",  0 ,  0   ,  0   , 0    , 200   , 200   , 200   ],
	[2,"★★★★★★★★★","学1 体1 武1 食2",  0 ,  0   ,  0   , 0    , 190   , 190   , 190   ],
	[2,"★★★★★★★★★","学0 体0 武0 食18", 0 ,  0   ,  0   , 0    , 175   , 175   , 175   ]
	,
	[3,"★",                "学1 体0 武0 食0",  5 ,  0   ,  0   , 0    ,   0 ,   0 ,   0 ],
	[3,"★",                "学0 体1 武0 食0",  5 ,  0   ,  0   , 0    ,   0 ,   0 ,   0 ],
	[3,"★",                "学0 体0 武1 食0",  5 ,  0   ,  0   , 0    ,   0 ,   0 ,   0 ],
	[3,"★",                "学0 体0 武0 食1",  5 ,  0   ,  0   , 0    ,   0 ,   0 ,   0 ],
	[3,"★★",              "学3 体0 武0 食0",  0 ,  0.5 , 10   , 0.5  ,   0 ,   0 ,   0 ],
	[3,"★★",              "学0 体3 武0 食0",  0 ,  10  ,  0.5 , 0.5  ,   0 ,   0 ,   0 ],
	[3,"★★",              "学0 体0 武3 食0",  0 ,  0.5 ,  0.5 , 10   ,   0 ,   0 ,   0 ],
	[3,"★★★",            "学1 体1 武1 食0",  0 ,  9   ,  9   , 9    ,   0 ,   0 ,   0 ],
	[3,"★★★",            "学0 体0 武0 食4",  0 , 20   ,  6   , 6    ,   0 ,   0 ,   0 ],
	[3,"★★★",            "学0 体0 武0 食1",  0 ,  7   , 22   , 7    ,   0 ,   0 ,   0 ],
	[3,"★★★★",          "学2 体2 武2 食0",  0 , 16   , 16   , 16   ,   0 ,   0 ,   0 ],
	[3,"★★★★",          "学2 体2 武2 食0",  0 ,  7.5 ,  7.5 , 35   ,   0 ,   0 ,   0 ],
	[3,"★★★★",          "学0 体0 武0 食8",  0 , 19   , 19   , 19   ,   0 ,   0 ,   0 ],
	[3,"★★★★★",        "学6 体0 武0 食0",  0 , 12.5 , 75   , 12.5 ,   0 ,   0 ,   0 ],
	[3,"★★★★★",        "学0 体6 武0 食0",  0 , 75   , 12.5 , 12.5 ,   0 ,   0 ,   0 ],
	[3,"★★★★★",        "学0 体0 武6 食0",  0 , 12.5 , 12.5 , 75   ,   0 ,   0 ,   0 ],
	[3,"★★★★★",        "学0 体0 武0 食1",  0 , 32.5 , 32.5 , 32.5 ,   0 ,   0 ,   0 ],
	[3,"★★★★★",        "学2 体2 武1 食0",  0 , 35   , 35   , 35   ,   0 ,   0 ,   0 ],
	[3,"★★★★★",        "学1 体1 武2 食0",  0 , 37.5 , 37.5 , 37.5 ,   0 ,   0 ,   0 ],
	[3,"★★★★★★",      "学10 体0 武0 食0", 0 ,  0   ,  0   , 0    ,  20 ,  90 ,  20 ],
	[3,"★★★★★★",      "学0 体10 武0 食0", 0 ,  0   ,  0   , 0    ,  90 ,  20 ,  20 ],
	[3,"★★★★★★",      "学0 体0 武10 食0", 0 ,  0   ,  0   , 0    ,  20 ,  20 ,  90 ],
	[3,"★★★★★★",      "学2 体2 武2 食0",  0 ,  0   ,  0   , 0    ,  40 ,  40 ,  40 ],
	[3,"★★★★★★★",    "学2 体4 武4 食0",  0 ,  0   ,  0   , 0    , 110 ,  30 ,  30 ],
	[3,"★★★★★★★",    "学0 体0 武0 食1",  0 ,  0   ,  0   , 0    , 110 , 110 ,  30 ],
	[3,"★★★★★★★",    "学0 体0 武0 食12", 0 ,  0   ,  0   , 0    ,  30 , 110 ,  30 ],
	[3,"★★★★★★★★",  "学14 体0 武0 食0", 0 ,  0   ,  0   , 0    , 250 ,  75 ,  75 ],
	[3,"★★★★★★★★",  "学0 体14 武0 食0", 0 ,  0   ,  0   , 0    ,  75 , 250 ,  75 ], 
	[3,"★★★★★★★★",  "学0 体0 武14 食0", 0 ,  0   ,  0   , 0    ,  75 ,  75 , 250 ],
	[3,"★★★★★★★★",  "学4 体1 武2 食0",  0 ,  0   ,  0   , 0    ,  50 , 250 ,  25 ],
	[3,"★★★★★★★★",  "学2 体4 武1 食0",  0 ,  0   ,  0   , 0    , 250 ,  50 ,  25 ],
	[3,"★★★★★★★★",  "学1 体2 武4 食0",  0 ,  0   ,  0   , 0    ,  25 ,  50 , 250 ],
	[3,"★★★★★★★★★","学1 体0 武0 食0",  0 ,  0   ,  0   , 0    , 150 , 300 , 150 ],
	[3,"★★★★★★★★★","学0 体1 武0 食0",  0 ,  0   ,  0   , 0    , 300 , 150 , 150 ],
	[3,"★★★★★★★★★","学0 体0 武1 食0",  0 ,  0   ,  0   , 0    , 150 , 150 , 300 ],
	[3,"★★★★★★★★★","学4 体4 武4 食4",  0 ,  0   ,  0   , 0    , 300 , 300 , 300 ], 
	[3,"★★★★★★★★★","学1 体1 武1 食2",  0 ,  0   ,  0   , 0    , 250 , 250 , 250 ],
	[3,"★★★★★★★★★","学0 体0 武0 食18", 0 ,  0   ,  0   , 0    , 200 , 200 , 200 ]
	,
	[4,"★"                ,"学1 体0 武0 食0" , 5 ,  0  ,   0  ,  0  ,  0,   0 ,  0],
	[4,"★"                ,"学0 体1 武0 食0" , 5 ,  0  ,   0  ,  0  ,  0,   0 ,  0],
	[4,"★"                ,"学0 体0 武1 食0" , 5 ,  0  ,   0  ,  0  ,  0,   0 ,  0],
	[4,"★"                ,"学0 体0 武0 食1" , 5 ,  0  ,   0  ,  0  ,  0,   0 ,  0],
	[4,"★★"              ,"学3 体0 武0 食0" , 0 ,  1  ,  12.5,  1  ,  0,   0 ,  0],
	[4,"★★"              ,"学0 体3 武0 食0" , 0 , 12.5,   1  ,  1  ,  0,   0 ,  0],
	[4,"★★"              ,"学0 体0 武3 食0" , 0 ,  1  ,   1  , 12.5,  0,   0 ,  0],
	[4,"★★★★★★★★★","学1 体1 武1 食2" , 0 ,  0  ,   0  ,  0  ,400, 400 ,400],
	[4,"★★★★★★★★★","学0 体0 武0 食18", 0 ,  0  ,   0  ,  0  ,350, 350 ,350]
];
var SPEC = [
	[ 15, 10, 10, 10, 15],	//剣兵
	[ 50, 40, 25, 55, 40],	//槍兵
...
var MAP_WOOD_COLOR	= 0; //学
var MAP_STONE_COLOR	= 1; //体
var MAP_IRON_COLOR	= 2; //武
var MAP_RICE_COLOR	= 3; //食
...
(function(){
	...
	if (location.pathname == "/map.php") {
		...
		//資源表示
		DISP_MATERIAL = GM_getValue(location.hostname + "DISP_MATERIAL", false);
		DISP_PICTURE = GM_getValue(location.hostname + "DISP_PICTURE", true);
...
function addHeadHtml(parentElem) {
	...
	addElem.innerHTML = 
		...
		//-----
	//バージョン
	document.getElementById("configopen").value  = "Ver." + VERSION;
...
//console.log(location.hostname + "DISP_NPC_FALLEN: " + GM_getValue(location.hostname + "DISP_NPC_FALLEN"));
			...
			GM_setValue(location.hostname + "DISP_MATERIAL", DISP_MATERIAL);
			DISP_PICTURE = document.getElementById("material_picture").checked;
			GM_setValue(location.hostname + "DISP_PICTURE", DISP_PICTURE);
...
function genPopupText(data, x, y) {
	...
	if (DISP_MATERIAL) {
		if (data[IDX_WOOD]!=0)  {
			getTxt += " 学" + Math.floor(data[IDX_WOOD]  * this.distance * 10) + "～" + Math.floor(data[IDX_WOOD]  * this.distance * 105);
		}
		if (data[IDX_STONE]!=0) { 
			getTxt += " 体" + Math.floor(data[IDX_STONE] * this.distance * 10) + "～" + Math.floor(data[IDX_STONE] * this.distance * 105);
		}
		if (data[IDX_IRON]!=0)  {
			getTxt += " 武" + Math.floor(data[IDX_IRON]  * this.distance * 10) + "～" + Math.floor(data[IDX_IRON]  * this.distance * 105);
		}
		if (data[IDX_RICE]!=0)  {
			getTxt += " 食" + Math.floor(data[IDX_RICE]  * this.distance * 10) + "～" + Math.floor(data[IDX_RICE]  * this.distance * 105);
		}
	} else {
		if (data[IDX_WOOD]!=0)  {
			getTxt += " 学" + Math.floor(data[IDX_WOOD]  * this.distance * 1595 / 100);
		}
		if (data[IDX_STONE]!=0) { 
			getTxt += " 体" + Math.floor(data[IDX_STONE] * this.distance * 1595 / 100);
		}
		if (data[IDX_IRON]!=0)  {
			getTxt += " 武" + Math.floor(data[IDX_IRON]  * this.distance * 1595 / 100);
		}
		if (data[IDX_RICE]!=0)  {
			getTxt += " 食" + Math.floor(data[IDX_RICE]  * this.distance * 1595 / 100);
		}
	}
...
function sendTroop() {
	...
	j$(".notice:eq(3)").append(
		"<div id='sendTroopInfo'>" +
			...
			"<tr>" +
				"<th class='mainTtl'>学</th>" +
				"<th class='mainTtl'>体</th>" +
				"<th class='mainTtl'>武</th>" +
				"<th class='mainTtl'>食</th>" +
...
function allianceCSV(){
	...
	j$("#csvMake").click(function() {
		...
		MEMBER_INFO_TEXT = "Ｘ座標,Ｙ座標,君主,領地,人口,本拠地,戦力,学,体,武,食,備考\n";
		setWaitCursor();
