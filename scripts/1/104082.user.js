...
// -------------------------------------------------------
// ---------- Definicion de las variables de bases ----------
// -------------------------------------------------------

// On définis le chemin du site
var siteUrl = 'http://legion-alpha-chile.foroactivo.org/';

// On définis la version actuel
var currentVersion = 'Ikart 2.0 by Dante';
...
// Obtener el vínculo de imagen para ver el menú de la izquierda para la ciudad
...
if(document.getElementById('options')) {
	...
	if(param == 'ikart') {
		...
		if(langage == 'fr') {
			...
			iLang2='';
			iHelp = '<center><b>Bienvenidos a la Ayuda</b></center><br /><center>-------</center><br /><b>Recordatorio :</b> Para eliminar un punto, no debe ser "1" en ambos cuadros del mismo periodo.<br /><br />Los siguientes diagramas muestran las veces que se puede quitar:<br /><br />- "Día + Noche + Atardecer + amanecer "no elimine periodo.<br />- "Jour + Nuit" il faut supprimer l\'Aube et le Cr&eacute;puscule.<br />- "Jour" il faut supprimer la Nuit, l\'Aube et le Cr&eacute;puscule.<br /><br /><center>-------</center><br />Pour pouvoir enregistrer les options, il faut qu\'aucune erreur ne soit d&eacute;tect&eacute;e, pour cela, v&eacute;rifiez bien :<br /><br /></br />- Qu\'aucune plage horaire n\'est utilis&eacute;e deux fois.<br />- Qu\'aucune plage horaire ne reste vide.<br />- Qu\'un des sch&eacute;mas pour la suppression des p&eacute;riodes est respect&eacute;.<br /><center>-------</center><br />Si toute fois vous n\'y arrivez toujours pas, vous pouvez revenir &agrave; l\'une des trois configurations de bases plus bas...<br /><br />';
			titleOptions = 'Opciones Legion Alpha';
			optionSite = 'Sitio Oficial L-A';
			siteAccess = 'Acceder';
			optionVersion = 'Version del script';
			...
			optionStretchView = 'Amplie la vista de la polis';
			optionReverseWine = 'Invertir prensa y viñedo';
			optionActiveAdvisors = 'Activar los consejeros especiales';
			optionActiveIcons = 'Cambiar los iconos de los recursos';
			titlePeriods = 'Configuracion de los periodos';
			optionHelp = 'Ayuda';
			optionDefaultConfiguration = 'Configuracion por defecto';
			configurationAll = 'Configuracion: Amanecer + Dia + Atardecer + Noche';
			configurationDayNight = 'Configuration: Dia + Noche';
			configurationDay = 'Configuration: Dia';
			optionDawn = 'Amanecer';
			optionDay = 'Dia';
			...
			periodEnd =  '59h';
			titleAddOption = 'Optiones adicionales';
			optionMessagePerPage = 'Numeros de mensajes por pagina';
			buttonSave = 'Guardar la Configuracion !!!';
			optionActiveCompletCityName = 'Ver los nombres completos de las polis';
		}
		else if(langage == 'org') {
...
// -------- Layout --------
STYLE('#container #header {		background-image: url(http://img706.imageshack.us/img706/6521/16642629.jpg); }');
...
STYLE('#extraDiv2 {		background-image: url(http://img600.imageshack.us/img600/9084/56624936.jpg); }');
