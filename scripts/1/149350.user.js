...
// @description    Показывает карту региона
// @namespace      https://prodgame*.alliances.commandandconquer.com/*/index.aspx*
// @include        https://prodgame*.alliances.commandandconquer.com/*/index.aspx*
// @version        1.5 RUS Fix
// @author         KSX | Translation & FIX 777lexa777
            ...
            qx.Class.define("TAMap.main", {
                ...
                members : {
                    ...
                    initialize : function() {
                        ...
                        // The Map window
                        this.mapBox = new qx.ui.window.Window("Карта [v"+this.version+" Translation & Fix 777lexa777]");
                        ...
                        makePoiItem( -1                                   ,"<< Ничего >>"          );
                        makePoiItem(ClientLib.Base.EPOIType.AirBonus      ,"Авиация GNT"           );
                        makePoiItem(ClientLib.Base.EPOIType.CrystalBonus  ,"Кристалы CNH"          );
                        makePoiItem(ClientLib.Base.EPOIType.DefenseBonus  ,"Резонатор NT (Оборон)" );
                        makePoiItem(ClientLib.Base.EPOIType.InfanteryBonus,"Вольфрам C (Пехота)"   );
                        makePoiItem(ClientLib.Base.EPOIType.PowerBonus    ,"Реактор (Энергия)"     );
                        makePoiItem(ClientLib.Base.EPOIType.TiberiumBonus ,"Тибериум CN"           );
                        makePoiItem(ClientLib.Base.EPOIType.VehicleBonus  ,"Уран C (Техника)"      );
						...
						// Button "Settings"
                        var bt = new qx.ui.form.Button("Настройка");
                        bt.set({
							appearance : "button-text-small",
                            toolTipText : "Набор фильтров для карты"
                        });
						...
						this.settingsWnd.add(makeLbl("POIs у альянса:"), {row:3, column:0});
						...
						this.settingsWnd.add(makeLbl("Рамка расположения:"), {row:5, column:0});
                        this.settingsWnd.add(this.showSectionFrame, {row:5, column:1});

                        bt = makeLbl("- Colors -");
                        bt.set({
                            value: '<a href="http://www.w3schools.com/html/html_colornames.asp" target="_blank"><font color="#fff2c0">-= Палитра тут =-</font></a>',
                            rich : true,
                            selectable: true
                        });
                        ...
                        this.settingsWnd.add(makeLbl("Территория альянса:"), {row:11, column:0});
                        this.settingsWnd.add(makeTxt("allianceTerrainColor"), {row:11, column:1});
						
                        this.settingsWnd.add(makeLbl("Базы забытых:"), {row:12, column:0});
                        this.settingsWnd.add(makeTxt("baseColor"), {row:12, column:1});
						
                        this.settingsWnd.add(makeLbl("Лагерь:"), {row:13, column:0});
                        this.settingsWnd.add(makeTxt("campColor"), {row:13, column:1});
						
                        this.settingsWnd.add(makeLbl("Базы игроков:"), {row:14, column:0});
                        this.settingsWnd.add(makeTxt("cityColor"), {row:14, column:1});
						
                        this.settingsWnd.add(makeLbl("Враг:"), {row:15, column:0});
                        ...
                        this.settingsWnd.add(makeLbl("Тунель:"), {row:19, column:0});
