...
// ---------- 16th October 2011
// Version 1.1.7
// - Fixed bug on non-german languages with the world selector (always changed game language to german)
// - When you log into an (previously) unknown world in the scripts cache, the list will be automatically reloaded
// - buyables from town options are now not popping up anymore. all buyables should now be toggled permanently with the buyables on/off switch
// - Auto-scan for world map has been added. on firefox worlds with many players may be very slow, so take a break while scanning.
// - Added time preview for caravans (including own cities, other players cities, portals, hero skill for faster caravans).
...
(function() {
 ...
 var version = '1.2.2'; // also, check meta-data field @version
 ...
 //
  ...
  var $themeswitcher;﻿paypal = 
[ '<form target="new" action="https://www.paypal.com/cgi-bin/webscr" method="post">'
, '<input type="hidden" name="cmd" value="_s-xclick">'
, '<input type="hidden" name="encrypted" value="-----BEGIN PKCS7----------END PKCS7-----'
, '">'
...
function inject(target, when, injection)
{
  ...
  function callback()
  {
    ...
    var injRetVal = injection.apply(this, arguments);
    if(typeof injRetVal != 'undefined')
      retVal = injRetVal;
 ...
 function HOMMK_worldMap_center(x, y){
  ...
  {
    var worldSize = HOMMK.worldMap.get('_size');
    var w = worldSize, w2 = w / 2, dx = Math.abs(b.x - a.x), dy = Math.abs(b.y - a.y);
    if ( dx > w2 ) { dx = w - dx; }
    if ( dy > w2 ) { dy = w - dy; }
...
function approximateDurationToString(duration)
{
  function to1(num) { return Number(num).toFixed(1); }

  if(duration >= 24*60*60)
    return '~' + to1(duration / 60 / 60 / 24) + HOMMK.DATEUTILS_TIME_FORMAT_LOCALE_DAYS_SHORT;
  if(duration >= 60*60)
    return '~' + to1(duration / 60 / 60) + HOMMK.DATEUTILS_TIME_FORMAT_LOCALE_HOURS_SHORT;
  if(duration >= 10*60)
    return '~' + Math.round(duration / 60) + HOMMK.DATEUTILS_TIME_FORMAT_LOCALE_MINUTES_SHORT;
  if(duration >= 10)
    return '~' + to1(duration / 60) + HOMMK.DATEUTILS_TIME_FORMAT_LOCALE_MINUTES_SHORT;
  return '' + duration + 's';
}
...
function isHeroInTown( heroId )
{
  var inTownActions = [
  , "UPGRADE_MINE"
  , "HERO_BUILD_ZONEBUILDING"
  , "IMPROVE_MINE"
  , "HERO_LEARN_SKILL"
  , "HERO_LEARN_CLASS"
  , "HERO_DIG_ZONE"
  , "HERO_UPGRADE_ZONEBUILDING_MOVE"
  ];
  var ma = HOMMK.elementPool.get("MasterAction");
  for(var a in ma.obj)
  {
    var action = ma.get(a).content;
    if( action.heroId == heroId )
      return inTownActions.indexOf( action.type ) >= 0;
  }
  return false;
}

//function getCaravanSpeedLevel( pos )
function getSkillLevel( pos, skillEntityTag )
{
  var level = 0;
  cities = HOMMK.elementPool.get("RegionCity");
  for(var c in cities.obj)
  {
    var city = cities.get(c).content;   
    if( city.x == pos.x && city.y == pos.y )
    {
      for(var h = 0; h < city.attachedHeroList.length; h++ )
      {
        ...
        if( !isHeroInTown( hero.id ) )
          continue;
        
        if( hero.heroBonuses && hero.heroBonuses.skills && hero.heroBonuses.skills.local )
        {
          var skills = hero.heroBonuses.skills.local;
          
          for(var s = 0; s < skills.length; s++)
          {
            var skill = skills[s];
            if( skill.heroClassSkillEntityTagName == skillEntityTag )
            {
              level = (skill.level > level) ? skill.level : level;
            }
          }
        }
      }
...
function getRegionCount( playerId )
{
  var count = 0;
  var regs = HOMMK.elementPool.get("Region").obj;
  for(var r in regs)
  {
    if(regs[r].content.pId == playerId)
      count += regs[r].content.aRL.length;
  }
...
extend( locale_strings_default,
  { 'UPDATE_DONATE_MSG': 'To support me on creating and updating this script you are free to donate.'
  , 'UPDATE_DIALOG_TITLE': 'Script History'
});

extend( locale_strings_de,
  { 'UPDATE_DONATE_MSG': 'Wenn du mich beim Erstellen und Aktualisieren des Skriptes unterstützen möchtest, freue ich mich über eine freie Spende.'
  , 'UPDATE_DIALOG_TITLE': 'Skript Änderungen'
});

update = (function(){

  var history = undefined;
  var firstVersion = '1.1.6';
  var dialog;
  ...
  function createHistory()
  {
    ...
    if(locale == 'de')
    {
      ...
      history['1.2.0'] = [ 'Fehler behoben, bei dem im nicht-deutschen Client die Sprache auf Deutsch umgestellt wurde.'
                         , 'Wenn eine (dem Skript) unbekannte Welt gestartet wird, wird die Auswahlliste der Welten automatisch aktualisiert.'
                         , 'Kauf-Optionen der Städte poppen nun nicht mehr unregelmäßig auf. Alle Kauf-Optionen sollten nun permanent aktiviert und deaktiviert werden.'
                         , 'Anzeige der Karawanen-Reisezeit dem Marktplatz hinzugefügt (für eigene Städte, fremde Städte, Portale, Helden-Fähigkeiten für schnellere Karawanen.'
                         , 'Anzeige über einem entbindenden Artefakt für die Zeitdauer hinzugefügt.'
                         , 'Große Teile der Schnittstelle von Jactari neu geschrieben.'
                         , 'Vermächtnis-Fähigkeiten werden nun direkt abgefragt, ohne "Mein Profil" zu öffnen.'
                         , 'Bug in HOMMK behoben: Die Gesamtproduktion wurde nur beim Öffnen des Dialoges aktualisiert. Problemlösung wurde an UBI weitergeleitet, warte noch auf eine Antwort.'
                         , 'Bug in HOMMK behoben: Beim betreten des Artefakt-Handels werden keine Artefakte angezeigt.'
                         ];
      history['1.2.1'] = [ 'Problem mit Firefox und der Anzeige für entbindende Artefakte gelöst'
                         ];
      history['1.2.2'] = [ 'Problem mit Firefox und dem Bugfix für den Artefakthandel gefixt'
                         ];
    }
    else
    {
      history[firstVersion] = [''];
      history['1.2.0'] = [ 'Fixed a bug on non-german users when using the world selector (always changed game language to german).'
                         , 'When logging into an (previously) unknown world (regarding the worldlist), this list will be reloaded automatically.'
                         , 'Buyables from town options are now not popping up anymore. all buyables should now be toggled permanently with the buyables on/off switch.'
                         , 'Added duration preview for caravans (including own cities, other players cities, portals, hero skill for faster caravans).'
                         , 'Added a balloon for unbinding artefacts with the time duration.'
                         , 'Major rewrite of some parts for the jactari interface.'
                         , 'Heredity information is now retrieved directly without opening the "Profile Frame"'
                         , 'Fixed a HOMMK bug where the total production will only be refreshed one time. Bugfix is sent to UBI. Waiting for an answer.'
                         , 'Fixed a HOMMK bug where the artefact auction does not display any artefacts on initialization.'
                         ];
      history['1.2.1'] = [ 'Fixed a bug with firefox and the balloon for unbinding artefacts.'
                         ];
      history['1.2.2'] = [ 'Fixed a bug with firefox and the artefact auction display.'
                         ];
    }
  }
  ...
  function getHistory(from, to)
  {
    ...
    for(var h in history)
    {
      ...
      {
        result += '<p><h3>Version ' + h + '</h3><ul style="list-style: disc; margin-left: 20px;">';
        foreach( history[h], function(a){ result += '<li>' + a + '</li>'; } );
        result += '</ul></p>';
  ...
  function showHistory( oldVersion )
  {
    if(!dialog)
      dialog = $('<div id="mekls-hommk-history"></div>')
  
    dialog.dialog(
    { position: 'center'
    , show: 'slide'
    , title: localize('UPDATE_DIALOG_TITLE')
    , width: 600
    , height: 400
    , zIndex: 90000
    })
    ...
    .html('')
    .append( '<p style="margin-bottom: 10px"><h2>Mekls Jactari Damned v' + version + '</h2> \251 Mekl 2011 \251 jeyries 2010 <a href="http://userscripts.org/scripts/show/111232" class="ui-state-default" target="_blank">[userscripts.org]</a></p>' )
    .append( '<p style="margin-top: 10px"><b>' + localize('UPDATE_DONATE_MSG') + '</b>' + paypal + '</p>')
    .append( getHistory(oldVersion || firstVersion, version) )
    .append( $('<div style="padding-top: 6px"></div>').append($themeswitcher) )
  ...
  function init()
  {
    var oldVersion = localStorage_getObject( 'Mekls_HOMMK_version', firstVersion);
    var newVersion = version;
    
    console.log( [ 'Version Information', oldVersion, newVersion ] );
    
    if(newVersion != oldVersion)
      showHistory( oldVersion );
    
    localStorage_setObject( 'Mekls_HOMMK_version', newVersion );
  }
...
﻿jactari = (function()
{
  ...
  function globa( oldbase )
  {
    if( oldbase === true )
      return global.a;
    if( oldbase === false )
      return global.d;
    if( typeof oldbase == 'undefined' )
      return global.a;
    
    return oldbase;
  }
  
  function setGloba( oldbase, newbase )
  {
    if( oldbase === true )
      global.a = newbase;
    else if( oldbase === false )
      global.d = newbase;
    
    return newbase;
  }
  
  function setHero( hero, oldbase )
  {
    base = globa( oldbase );
    ...
    base.faction = convert_faction[ hero.factionEntityTagName ] || 0;
    //base.statut = 0; // needs rework (?!)
    base.heros = (hero.name || hero.factionEntityTagName || hero._level) ? 1 : 0;
    base.niveau = hero._level || 0;
    base.archetype = convert_archetype[ hero.heroTrainingEntityTagName ] || 0;
    
    return setGloba( oldbase, base );
  }
  
  function setPlayer( player, oldbase )
  {
    base = globa( oldbase );
    
    base.statut = (player == true) ? 1 : 0;
    
    return setGloba( oldbase, base );
  }
  
  function setSkills( skills, oldbase )
  {
    base = globa( oldbase );
    
    base.tacticien = base.ecuyer = base.tireur_elite =  base.commandant_infanterie = 0;
    base.tacticien_defenseur = base.ecuyer_defenseur = base.expert_tirs_barrage = base.inebranlable = base.logisticien = 0;
    base.arcanes = base.expert[0] = base.instinct[0] = 0;
    base.arcanes = base.expert[1] = base.instinct[1] = 0;
    base.arcanes = base.expert[2] = base.instinct[2] = 0;
    base.arcanes = base.expert[3] = base.instinct[3] = 0;
    base.harangueur = base.massacreur = base.bon_payeur = 0;
    ...
    if( skills )
      skills.forEach(function(skill){         
        ...
        switch(  skill.heroClassSkillEntityTagName ){
          ...
          // combattant
          case 'ARMY_ATTACK_POWER_INCREASE': base.tacticien= skill.level; break;
          case 'CAVALRY_ATTACK_POWER_INCREASE': base.ecuyer= skill.level; break;
          case 'SHOOTER_ATTACK_POWER_INCREASE': base.tireur_elite= skill.level; break;
          case 'INFANTRY_ATTACK_POWER_INCREASE': base.commandant_infanterie= skill.level; break;

          // chevalier
          case 'ARMY_DEFENSE_POWER_INCREASE': base.tacticien_defenseur= skill.level; break;
          case 'CAVALRY_DEFENSE_POWER_INCREASE': base.ecuyer_defenseur= skill.level; break;
          case 'SHOOTER_DEFENSE_POWER_INCREASE': base.expert_tirs_barrage= skill.level; break;
          case 'INFANTRY_DEFENSE_POWER_INCREASE': base.inebranlable= skill.level; break;
          case 'ATTRITION_RATE_DECREASE': base.logisticien= skill.level; break;

          // ordre des magies pour Jactari : invocation tenebre lumiere destruction

          // invocation
          case 'SUMMON_ADDED_BATTLE_SPELL_LEVEL': base.arcanes= skill.level; break; 
          case 'SUMMON_SPELLBOOK_SPELL_NUMBER': break;
          case 'SUMMON_SPELL_EFFICIENCY': base.expert[0]=skill.level; break; 
          case 'SUMMON_ADDED_MAGIC_POINTS': base.instinct[0]=skill.level; break; 

          // tenebres
          case 'DARK_ADDED_BATTLE_SPELL_LEVEL': base.arcanes= skill.level; break; 
          case 'DARK_SPELLBOOK_SPELL_NUMBER': break;
          case 'DARK_SPELL_EFFICIENCY': base.expert[1]=skill.level; break; 
          case 'DARK_ADDED_MAGIC_POINTS': base.instinct[1]=skill.level; break; 

          // lumiere
          case 'LIGHT_ADDED_BATTLE_SPELL_LEVEL': base.arcanes= skill.level; break; 
          case 'LIGHT_SPELLBOOK_SPELL_NUMBER': break;
          case 'LIGHT_SPELL_EFFICIENCY': base.expert[2]=skill.level; break; 
          case 'LIGHT_ADDED_MAGIC_POINTS': base.instinct[2]=skill.level; break; 

          // destruction
          case 'DESTRUCTION_ADDED_BATTLE_SPELL_LEVEL': base.arcanes= skill.level; break; 
          case 'DESTRUCTION_SPELLBOOK_SPELL_NUMBER': break;
          case 'DESTRUCTION_SPELL_EFFICIENCY': base.expert[3]=skill.level; break; 
          case 'DESTRUCTION_ADDED_MAGIC_POINTS': base.instinct[3]=skill.level; break;          
          ...
          case 'ATTACK_POWER_PER_UNIT_INCREASE': base.harangueur=skill.level; break; 

          // barbare
          case 'SCOUTING_DETECT_LEVEL_INCREASE': break;
          case 'ATTRITION_RATE_INCREASE': base.massacreur=skill.level; break; 
          case 'PILLAGE_INCREASE': break;

          // taverne
          case 'DEFENSE_POWER_PER_UNIT_INCREASE': base.bon_payeur=skill.level; break; 
  ...
  function setArtefacts( artefacts, oldbase )
  {
    base = globa( oldbase );
    
    base.artefacts = [0, 0, 0, 0, 0, 0, 0, 0];
    
    for (var k=0; k < (artefacts ? artefacts.length : 0) ; k++)
    {
      ...
      base.artefacts[pos] =  artefact.id; // Jactari V4
    }
    
    return setGloba( oldbase, base );
  }
  
  function setSpells( spells, oldbase )
  {
    base = globa( oldbase );
    
    base.sort = [ {id: -1, tour: 1}, {id: -1, tour: 2} ];
    ...
    for (var k=0; k <spells.length; k++){
      ...
      base.sort[k].id = convert_spell[ spell.spellEntityTagName ];
      base.sort[k].tour = spell.roundPosition;
    }
      
    return setGloba( oldbase, base );
  }
  
  function setLevelInfo( levelInfo, oldbase )
  {
    base = globa( oldbase );
    
    //levelInfo = convert_levelInfo(levelInfo);
    
    base.antimagic = levelInfo.antimagie || 0;
    base.ballista = levelInfo.ballista || 0;
    base.traps = levelInfo.fallen || 0;
    
    return setGloba( oldbase, base );
  }
  
  function setHeredity( heredity, oldbase )
  {
    base = globa( oldbase );
    
    base.tir_de_barrage = 0;
    base.resistance_magique = 0;
    base.maitrise_des_sorts = 0;
    base.resurrection = 0;
    base.butin_de_guerre = 0;
    base.revelation_de_caracteristiques = 0;
    base.moral_eleve = 0;
    base.heros_superieur = 0;
    base.relever_les_morts = 0;
    
    for(var i = 0; i < (heredity ? heredity.heredityList.length : 0); i++)
    {
      ...
      switch(abName)
      {
        ...
        case "BARRAGE_FIRE": base.tir_de_barrage = abLevel; break;
        case "MAGIC_RESISTANCE": base.resistance_magique = abLevel; break;
        case "SPELL_MASTERY": base.maitrise_des_sorts = abLevel; break;
        case "RESURRECTION": base.resurrection = abLevel; break;
        case "BATTLE_LOOT": base.butin_de_guerre = abLevel; break;
        case "CHARACTERISTICS_ILLUMINATION": base.revelation_de_caracteristiques = abLevel; break;
        case "MORAL_BOOST": base.moral_eleve = abLevel; break;
        case "TOUGHER_HERO": base.heros_superieur = abLevel; break;
        case "RAISE_DEAD": base.relever_les_morts = abLevel; break;
    ...
    base.classement_voies = c;
    
    return setGloba( oldbase, base );
  }
  
  function setTarget( levelInfo, oldbase )
  {
    base = globa( oldbase );
  ...
  function setUnits( units, oldbase )
  {
    base = globa( oldbase );
    
    base.troupes = [ {}, {unite:255,nombre:0}, {unite:255,nombre:0}, {unite:255,nombre:0}, {unite:255,nombre:0}, {unite:255,nombre:0}, {unite:255,nombre:0}, {unite:255,nombre:0} ];
    
    for (var k=0; k < (units ? units.length : 0); k++){
      
      var unit = units[k].content || units[k];
      
      console.log("unit=%s quantity=%d",
        unit.unitEntityTagName, unit.quantity
        );
      
      //base.troupes[unit.stackPosition] = convert_unit(unit);
      base.troupes[ unit.stackPosition || unit.powerPosition ] = 
        { unite: (unit.factionEntityTagName == "NEUTRAL")
                   ? ( convert_neutral[ unit.tier ] )
                   : ( faction_offset[ unit.factionEntityTagName ] + convert_tier[ unit.tier ] % 15 )
        , nombre: unit.quantity
        };
    }
  ...
  function setSpy( list, oldbase )
  {
    ...
    // todo : pour choisir la reco, utiliser scoutingLevel ou creationDate
      ...
      //base.statut = 1;
      base = setPlayer( true, base );

      if (content.cityFortificationTagName) {
        console.log("scouting: fortification=%s", content.cityFortificationTagName );
        base.fortification= convert_fortification[ content.cityFortificationTagName ];
      }
      ...
      if ( content.heroList && content.heroList.length >= 1){
        ...
        base = jactari.hero( hero, base );
        base = jactari.artefacts( hero.artefactList, base );
  ...
  {
    return{ statut:0 // 1:joueur/0:PNJ
  ...
  function getUrl( donnees )
  {
    if( typeof donnees == 'undefined' )
      donnees = global;
  
    return 'http://mmhk.jactari.info/' + localize('JACTARI_FIGHT') + '?info='+ encode_donnees_combat(donnees)
         + ((HOMMK.player.content.worldSeasonNumber == 3) ? "&S3=y" : "")
         + "&mekl=" + encode_mekl_url(donnees)
         ;
  }

  function updateAsBox( att, def )
  {
    if(att === true)
      $("#asatt").removeClass("ui-state-disabled").addClass("ui-state-active");
    if(def === true)
      $("#asdef").removeClass("ui-state-disabled").addClass("ui-state-active");
    
    if( (!$("#asatt").hasClass("ui-state-disabled")) && (!$("#asdef").hasClass("ui-state-disabled")) )
      $("#asshow").removeClass("ui-state-disabled").addClass("ui-state-active");
  }
  ...
  mail = (function()
  {
    function init()
    {
      // define function to inject new functions
      var displayMessage = HOMMK.MessageBoxFrame.prototype.displayMessage;
      
      HOMMK.MessageBoxFrame.prototype.displayMessage = function()
      {
        var retVal;
        
        retVal = displayMessage.apply(this, arguments);
        
        console.log( arguments );
        
        // any troop information there?
        if(arguments.length >= 1 && arguments[0].type == "TROOP_SCOUTING")
        {
          var json = arguments[0].contentJSON;
          var str = arguments[0].id;
          
          function makeCB( hero, attacker)
          {
            return function() {
              jactari.hero( hero, attacker );
              jactari.player( true, attacker );
              jactari.units( hero.attachedUnitStackList, attacker );
              jactari.updateAsBox( attacker, !attacker );
            };
          }
          
          for(var i = 0; i < (json.heroList.length || 0); i++)
          {
            var hero = json.heroList[i];
            str += '_' + hero.id;
            $('#ScoutingResultHero' + str + 'UnitStackList')
            .after(
              $("<div></div>")
              ...
              .append(
                $('<span>As Attacker</span>')
                .css("float", "left")
                .css("background", "black")
                .css("color", "white")
                .css("padding", "1px 5px")
                .css("border", "1px solid #4D332E")
                .click( makeCB( hero, true ) )
              )
              .append(
                $('<span>As Defender</span>')
                .css("float", "right")
                .css("background", "black")
                .css("color", "white")
                .css("padding", "1px 5px")
                .css("border", "1px solid #4D332E")
                .click( makeCB( hero, false ) )
              )
            );
          }
        }
...
buyables = (function()
{
  ...
  function init()
  {
    ...
    var prev = HOMMK.RegionCity.prototype.display;
    HOMMK.RegionCity.prototype.display = function(){
      var result = prev.apply(this, arguments);
      
      try{
        this.getChildElement("CompleteViewCityOptionsContentContainer").style.display = (buyables.state() === true) ? "" : "none";
...
worlds = (function()
{
  ...
  function loadWorldList(ondone)
  {
    ...
    {
      default:
      case 'en_US': worldUrl = 'us/gameWorlds'; break;
      case 'en_GB': worldUrl = 'en/gameWorlds'; break;
      case 'de_DE': worldUrl = 'de/spielwelten'; break;
      case 'fr_FR': worldUrl = 'fr/gameWorlds'; break;
      case 'ru_RU': worldUrl = 'ru/gameWorlds'; break;
    }
    
    ajax.open("GET", HOMMK.BASE_URL + worldUrl, true);
...
heredity = (function() 
{
  ...
  function init()
  {
    ...
    do_request({"elParamList":[{"elementType":"ProfileFrame","elementId":HOMMK.player.content.id}]},
      function(json)
      {
        if(json && json.d && json.d["ProfileFrame" + HOMMK.player.content.id])
        {
          var hl = json.d["ProfileFrame" + HOMMK.player.content.id].playerHeredityAbilityList || [];
...
})();﻿function updateArtefactTime()
{
  try{
    if(this.isUnbinding())
    {
      this.unbindingImage.innerHTML = ''
      + '<div style="height: 12px; background-color: #50332B; margin-left: -29px; border: 1px solid black; border-radius: 5px; font-size: 10px; padding-left: 4px; padding-right: 4px; width: 35px; text-align: center; color: white;">'
      + approximateDurationToString(this.getTimeLeftBeforeRemoteTimestamp(this.content.unbindDate))
      + '</div>'
      ;
    }
    else
...
// no access to "HOMMK.Artefact.prototype.displayBindingState.delay missing" in Firefox
//inject('HOMMK.Artefact.prototype.displayBindingState', 'after', updateArtefactTime);

inject('HOMMK.Artefact.prototype.display', 'after', updateArtefactTime);
inject('HOMMK.Artefact.prototype.getUnbindingTooltipContent', 'after', updateArtefactTime);
﻿   //HOMMK.elementPool.get("RegionCity").get("673922").content.attachedHeroList[0].heroBonuses
  
market = (function(){
  
  // Caravan Time Preview
  function updateCaravanTime()
  {
    try {
      var source = Math.floor( this.elementId / 10 + 1 );
      var cd = this.getChildElement("CaravanDestination");
      var dest = parseInt( cd.value, 10 ) ||
                 parseInt( this.getChildElement("CaravanDestinationRegionNumber").value, 10 ) || 
                 parseInt( ( /\d+$/.exec( cd.options[cd.selectedIndex].textContent ) || [""] )[0], 10)
                 ;
      
      source = HOMMK.getXYFromRegionNumber( source );
      dest = HOMMK.getXYFromRegionNumber( dest );
      
      var distance = getDistance( source, dest );
      //var duration = Math.round( (distance || 0) * 360 / (1 + getCaravanSpeedLevel(source)*0.5 ));
      var duration = Math.round( (distance || 0) * 360 / (1 + getSkillLevel(source, "CARAVAN_SPEED_INCREASE")*0.5 ));
      var now = HOMMK.DateUtils.getCurrentTimestamp();
      
      this.getChildElement('CaravanDeliveryDuration').innerHTML =  (duration == 0) ? '' : 'Ankunft: ' + HOMMK.DateUtils.durationToString( duration );
      this.getChildElement('CaravanReturnDuration').innerHTML =  (duration == 0) ? '' : 'Heimkehr: ' + HOMMK.DateUtils.durationToString( 2*duration );
      
      if(this.content.caravanAvailability[0] === false)
        duration = 0;
      
      this.getChildElement('CaravanDeliveryTime').innerHTML =  (duration == 0) ? '' : 'Ankunft: ' + HOMMK.DateUtils.timestampToString( now + duration );
      this.getChildElement('CaravanReturnTime').innerHTML =  (duration == 0) ? '' : 'Heimkehr: ' + HOMMK.DateUtils.timestampToString( now + 2*duration );
    } catch(err) { console.log( err ); }
  }
  
  function init()
  {
    var prev1 = HOMMK.MarketPlaceFrame.prototype.initializeCaravanTab; 
    HOMMK.MarketPlaceFrame.prototype.initializeCaravanTab = function(){
    var res = prev1.apply(this, arguments);
    var self = this;

    try{
      /*
      this.RegionCityNameAutocompleter.$events.onSelect.push(
        function() { updateCaravanTime.apply(self); }
      );
      */
      
      //this.RegionCityNameAutocompleter.addEvent("onSelect", function() { updateCaravanTime.apply(self); }.bind(this) );
      
      /*
      var pac = this.RegionCityNameAutocompleter.$events.onSelect[0];
      this.RegionCityNameAutocompleter.$events.onSelect[0] = function() {
        updateCaravanTime.apply( this );
        return retval;
      };
      */
      //this.RegionCityNameAutocompleter.addEventListener("onselect", function() { alert("test"); } );
      
      //console.log( this.RegionCityNameAutocompleter.$events.onSelect[0] );
      window.setInterval( updateCaravanTime.bind(this), 1000 );
      
      jQuery(this.getChildElement("DestinationRessourceList")).removeClass("Voffset27");
      jQuery(this.getChildElement("CurrentDestinationRowLabel")).css("margin-top", "22px");
      jQuery(this.getChildElement("ContributeRessourceList")).css("margin-top", "0px").css("margin-bottom", "0px");
      
      var id = this.mainElementId;
      var row = jQuery("<div></div>")
      .css("margin-top", "3px")
      .css("margin-bottom", "3px")
      .append( $('<span></span>').attr('id', id + 'CaravanDeliveryTime').css('font-weight', 'bold').css('margin-right', '10px') )
      .append( $('<span></span>').attr('id', id + 'CaravanReturnTime').css('font-weight', 'bold').css('margin-right', '25px') )
      .append( $('<span></span>').attr('id', id + 'CaravanDeliveryDuration').css('font-weight', 'bold').css('margin-right', '10px') )
      .append( $('<span></span>').attr('id', id + 'CaravanReturnDuration').css('font-weight', 'bold') )
      ;
      
      jQuery(this.caravanDestinationElement).parent().append(row);
    } catch(err) { console.log( err ); }
    
    return res;
  }
    
    var prev2 = HOMMK.MarketPlaceFrame.prototype.updateCaravanView;
    HOMMK.MarketPlaceFrame.prototype.updateCaravanView = function(){
      var result = prev2.apply(this, arguments);
...
﻿bugfix = (function(){
  ...
  function init()
  {
    var prev3 = HOMMK.RessourcesSummaryFrame.prototype.initializeDisplay;
    HOMMK.RessourcesSummaryFrame.prototype.initializeDisplay = function(){
      var result = prev3.apply(this, arguments);
      /*
      try{
        var rsf = jQuery( this.contentMainElement ).find("#RessourcesSummaryFrame");
        rsf.append( $('<div id="CaravanListing">Test</div>') );
      } catch(err) { console.log( err ); }
      */
      return result;
    };
    
    var prev4 = HOMMK.RessourcesSummaryFrame.prototype.updateRessourceStackList;
    HOMMK.RessourcesSummaryFrame.prototype.updateRessourceStackList = function(){
      var result = prev4.apply(this, arguments);
      /*
      try{
        var div = jQuery( this.contentMainElement ).find("#CaravanListing");
        
        var deliveries = [];
        HOMMK.elementPool.get("MasterAction").each(
          function(action) {
            action = action.content;
            if(action.type == "CARAVAN_DELIVERY")
            {
              action.attachedSlaveActionList.each(
                function(sa)
                {
                  if(sa.type == "CARAVAN_DELIVERY_MOVE")
                  {
                    deliveries .push ( { end: sa.endDate, desc: action.actionDescription
                      , GOLD: sa.paramList[0]
                      , WOOD: sa.paramList[2], ORE: sa.paramList[3]
                      , CRYSTAL: sa.paramList[4], MERCURY: sa.paramList[5]
                      , GEM: sa.paramList[6], SULFUR: sa.paramList[7]
                    } );
                  }
                }
              );
        ...
        deliveries.sort( function( a, b ) { return a.end > b.end; } );
        var types = ["GOLD", "WOOD", "ORE", "CRYSTAL", "MERCURY", "GEM", "SULFUR"];
        ...
        for(var d = 0; d < deliveries.length; d++)
        {
          ...
          var newDiv = $('<div></div>');
          newDiv.append( $('<div class="clearBoth"></div>').text( del.desc ) );
          ...
          types.each( function(t) {
            ...
            var icon = $('<div></div>');
            newDiv.append( icon ).append( del[t] );
            //HOMMK.setCssSpriteBackground( icon, "Ressources", t );
            setSprite( icon, "Ressources", t );
        ...
        //div.text( "überschreiben" + HOMMK.DateUtils.getCurrentTimestamp() );
      } catch(err) { console.log(err); }
      */
      return result;
    };
      ...
      /*
      HOMMK.setCssSpriteBackground(this.getChildElement("GOLDStackIcon", HOMMK.player.content.id), "Ressources", "GOLD");
      HOMMK.setCssSpriteBackground(this.getChildElement("WOODStackIcon", HOMMK.player.content.id), "Ressources", "WOOD");
      HOMMK.setCssSpriteBackground(this.getChildElement("OREStackIcon", HOMMK.player.content.id), "Ressources", "ORE");
      HOMMK.setCssSpriteBackground(this.getChildElement("CRYSTALStackIcon", HOMMK.player.content.id), "Ressources", "CRYSTAL");
      HOMMK.setCssSpriteBackground(this.getChildElement("MERCURYStackIcon", HOMMK.player.content.id), "Ressources", "MERCURY");
      HOMMK.setCssSpriteBackground(this.getChildElement("GEMStackIcon", HOMMK.player.content.id), "Ressources", "GEM");
      HOMMK.setCssSpriteBackground(this.getChildElement("SULFURStackIcon", HOMMK.player.content.id), "Ressources", "SULFUR");
      */
    
    // [BUGFIX] Gesamtvorräte & Produktion wird nicht aktualisiert, wenn sich die Stadtvorräte ändern
    inject('HOMMK.RessourceStack.prototype.refreshRessource', 'after', function(){
      try{
        var rsf = HOMMK.getFrame("RessourcesSummaryFrame", HOMMK.player.content.id);
        if(rsf.displayInitialized)
          rsf.updateRessourceStackList();
      } catch(err) { console.log(err); }
    });

    // [BUGFIX] Es werden im Marktplatz anfänglich keine Artefakte angezeigt
    inject("HOMMK.MarketPlaceFrame.prototype.initializeArtefactAuctionTab", 'after', function(){
      try{
        //this.artefactAuctionBodyPartFilterList = [];
        this.toggleArtefactAuctionBodyPartFilter(undefined);
      } catch(err) { console.log(err); }
    });
  }
...
.appendTo($dialog_cartographe);
  ...
  var $AutoScan = $('<button></button>').html(localize("CARTO_AUTO"))
  .button()
  .appendTo($div)
  .click(function() {
    ...
    var params = { xmin: 1
                 , ymin: 1
                 , xmax: HOMMK.worldMap.content._size
                 , ymax: HOMMK.worldMap.content._size
                 , xcur: 1
                 , ycur: 1
                 , regCount: -1
                 , retry: 0
    ...
    window.setTimeout( nextScanStep, 0, params );
    
    function nextScanStep(params)
    {
      var regCount = HOMMK.elementPool.get("Region").length;
      if(regCount == params.regCount && params.retry < 50)
      {
        params.retry++;
        window.setTimeout( nextScanStep, 100, params );
        return;
      }
      ...
      {
        var now = new Date();
        alert("Autoscan done! [" + (now - params.start) + "ms]");
        return;
      }
      
      params.retry = 0;
      params.regCount = regCount;
      
      //var step = 12;
      var step = 34;
      var smid = step/2;
      
      console.log( "center on (" + (params.xcur+smid) + ", " + (params.ycur+smid) + ")" );
      
      HOMMK_worldMap_center( params.xcur + smid, params.ycur + smid );
      
      params.xcur += step;
      
      if((params.xcur+step) > params.xmax)
      {
        params.xcur = 0;
        params.ycur += step;
      }
      if((params.ycur+step) > params.ymax)
      {
        params.ycur = 0;
        params.done = true;
      }
  ...
  function build(panel) {
    ...
    moves.forEach(function (item) {
      ...
      function setSprite(N /*ode*/ , C /*onf*/ , S /*prite*/ ) {
        var conf = HOMMK.CSSSPRITE_CONF[C],
          sprite = conf.sprites[S],
          x = sprite.x,
          y = sprite.y,
      ...
      function getContent(R /*egion*/ , P /*rop*/ , D /*ef*/ ) {
        return R && 'content' in R && P in R.content ? R.content[P] : D;
      }
      ...
      function cacheFromMove(x, y) {
        ...
        if (reg && reg.content) {
          var c = reg.content;
          if (c.pN) CACHE.add('PlayerName', c.pId, c.pN);
          if (c.cN) CACHE.add('TownName', coord(x, y), c.cN);
          if (c.iAN) {
...
/*
      ...
      */
      ...
      //openAllianceFrame
      $('<a href="#goto" class="ui-state-default">' + guildName + '</a>').appendTo($(guild)).click(function () {
        if (guildId) openAllianceFrame(guildId);
        return false;
      });

      $('<a href="#goto" class="ui-state-default">' + playerName + '</a>').appendTo($(player)).click(function () {
        HOMMK.openPlayerProfileFrame(move.playerId);
        return false;
      });

      $('<a href="#goto" class="ui-state-default">' + fromName + '</a>').appendTo($(from)).click(function () {
        HOMMK_worldMap_center(move.x1, move.y1);
        return false;
      });

      $('<a href="#goto" class="ui-state-default">' + posName + '</a>').appendTo($(pos)).click(function () {
        HOMMK_worldMap_center(item.x1p, item.y1p);
        return false;
      });

      $('<a href="#goto" class="ui-state-default">' + toName + '</a>').appendTo($(to)).click(function () {
...
/*
  ...
  function build_playerinfo(json, panel) {
    ...
    c.forEach(function (item) {
      ...
      var cell = row.insertCell(-1);
      $('<a href="#goto" class="ui-state-default" style="text-align:center">' + coord(item.x, item.y) + '</a>').appendTo($(cell)).click(function () {
  ...
  function build_tooltip(obj, id) {
    ...
    return "Alliance: " + obj.d["ProfileFrame" + id].allianceName;
    return "Alliance: " + obj.d["ProfileFrame" + id].allianceName;
    return "";
  }
  ...
  function toggle_player(json) {
    ...
    $player_info = $("<div id='hommk-user-vigie'></div>").dialog({
      zIndex: 95001,
      width: 327,
      minWidth: 327,
      maxWidth: 327,
      ...
      ////////////////////////////////////////
      close: function (event, ui) {
        $player_info.dialog('destroy').remove();
        $player_info = null;
      },
  ...
  function toggle_vigie() {
    ...
    // create view
    $dialog = $("<div id='hommk-user-vigie'></div>").html(localize("VIGIE_SEARCH_TROOPS")).dialog({
      zIndex: 90000,
      width: 627,
      height: 480,
      minWidth: 627,
...
ui = (function(){
  ...
  function init()
  {
    ...
    .appendTo($panel_extended)
    .append(
      $('<div id="asatt" class="ui-button ui-widget ui-state-default ui-button-text-only ui-state-disabled ui-corner-left"><span class="ui-button-text">Att</span></div>')
    )
    .append(
      $('<div id="asdef" class="ui-button ui-widget ui-state-default ui-button-text-only ui-state-disabled"><span class="ui-button-text">Def</span></div>')
    )
    .append(
      $('<div id="asshow" class="ui-button ui-widget ui-state-default ui-button-text-only ui-state-disabled ui-corner-right"><span class="ui-button-text">Show</span></div>')
      .click( function() {
        GM_openInTab( jactari.url() );
        $('#asatt').removeClass("ui-state-active");
        $('#asdef').removeClass("ui-state-active");
        $('#asshow').removeClass("ui-state-active");
      })
    )
    ;
    */
...
(function() {
 ...
 function convert_unit( content ) {
  ...
  function convert_levelInfo(string)
  {
    var retVal = 
    {
      stufe: undefined,
...
function launch_jactari(switch_combat_side){
  ...
  var donnees = jactari.empty();
  
  donnees.saison = HOMMK.player.content.worldSeasonNumber>=2 ? 1 : 0;
  
  // Level Info
  try{
    if( frame.unitStackLevelSelectElement && frame.unitStackLevelSelectElement.selectedIndex >= 0 )
    {
      var unitStackLevel = frame.unitStackLevelSelectElement.options[ frame.unitStackLevelSelectElement.selectedIndex ];
      if( unitStackLevel && unitStackLevel.innerHTML)
      {
        console.log( unitStackLevel.innerHTML );
        var levelInfo = convert_levelInfo(unitStackLevel.innerHTML);
        donnees.d = jactari.levelInfo( levelInfo, donnees.d );
        
        if(levelInfo.angreifer == false)
          switch_combat_side = true;
        if(levelInfo.angreifer == true)
          switch_combat_side = false;
      }
    }
  } catch(err) { console.log(err); }
  ...
  try{
    ...
    {
       donnees.a = jactari.hero( hero.content, donnees.a );
       donnees.a = jactari.heredity( hero.content.isMainHero ? heredity : undefined, donnees.a );
    }
  } catch(err) { console.log(err); }
  ...
  try{
    if ( frame.content ) // HeroFrame
      skills = frame.content.heroSkillList;
    
    if ( hero && hero.content && hero.content.heroBonuses && hero.content.heroBonuses.skills ) 
      skills = hero.content.heroBonuses.skills.local;

    donnees.a = jactari.skills( skills, donnees.a );
  } catch(err) { console.log(err); }
  ...
  try{
    ...
    if ( hero && hero.content && hero.content.heroBonuses && hero.content.heroBonuses.artefacts) // BattlePrepFrame, ZoneBuildingPortalUpgradeFrame
      artefacts = hero.content.heroBonuses.artefacts.local;    
         
    donnees.a = jactari.artefacts( artefacts, donnees.a );
  } catch(err) { console.log(err); }
  
  // Spells
  try{
    if( frame.RoundSpellStackList )
      donnees.a = jactari.spells( frame.RoundSpellStackList.elementList, donnees.a );
  } catch(err) { console.log(err); }

  // Units - Attacker
  try{
    var units = (frame.attackerUnitStackList || frame.heroUnitStackList || hero.unitStackList || frame.actionHeroUnitStackList );
    if( units.elementList )
      donnees.a = jactari.units( units.elementList, donnees.a );
  } catch(err) { console.log(err); }

  // Units- Defender
  try{
    var units = (frame.defenderUnitStackList || frame.npcUnitStackList || frame.infoNpcUnitStackList);
    if ( units && units.elementList )
      donnees.d = jactari.units( units.elementList, donnees.d );
  } catch(err) { console.log(err); }
  ...
  try{
    ...
    if( list )
      jactari.spy( frame.content.scoutingResultList, donnees.d );
  } catch(err) { console.log(err); }
...
function preInit()
{
  ...
  market.init();
  buyables.init();
  if(typeof buildings != 'undefined') buildings.init();
}

if(document.body)
  //window.setTimeout(VR.init, 5000);
  startInit();
else
  document.addEventListener("DOMContentLoaded", startInit, false);
