// ==UserScript==
// @name			HF Scripts - Easy Report Free Services and Giveaways
// @namespace 		Glassy/hfreportingfreeservicesandgiveaways
// @description 	Makes reporting posts/threads in Free Services and Giveaways section to Glassy MUCH easier.
// @include  		*hackforums.net/showthread.php*
// @version  		1.1.2
// ==/UserScript==

var navBit = document.getElementsByClassName('navigation')[0];
if(navBit.innerHTML.indexOf('<a href="forumdisplay.php?fid=186">Free Services and Giveaways</a>') != -1) {
