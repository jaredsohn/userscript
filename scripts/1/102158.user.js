// ==UserScript==
// @name           KoC Alliance - Extra
// @namespace      PDX
// @description    Extra Tabs for the Alliance - English Version
...
var Version = '0.4.7';
var Versiondate = '28.05.2011'; 
var Scriptname = 'KoC Alliance - Extra';
...
Tabs.Options = {
  ...
  citySelect += '</select>';
     ...
     m = '<DIV style="height:100%;  overflow-y:auto"><TABLE width=100% class=pdxTabLined cellspacing=0 cellpadding=0>\
        <TR><TD colspan=2><B><u>Alliance Extra - Settings</u></b></td></tr><TR>\
          <TD><INPUT id=pdxwidescreenEnable type=checkbox '+ (Options.widescreen?'CHECKED ':'') +'/></td>\
          <TD>Fix the Window Size! <font color=#FF0000>(need widescreen)</font></td></tr>\
		  <TD><INPUT id=pdxHideOnGoto type=checkbox /></td><TD>Close KoC Alliance - Extra after clicking Coords.</td></tr>\
        <TR><TD colspan=2><B><u>Tower - Settings</u></b></td></tr>\
        <TR><TD width="6%"><INPUT id=pdxalertEnable type=checkbox '+ (Options.alertConfigPDX.aChat?'CHECKED ':'') +'/></td><TD width="94%">Post Attacks to Alliance Chat.</td></tr>\
        <TR><TD><span style=\"font-size:10px; color:#600000; line-height:18px; \"><b>Importan</b></span></b>:</td>\
        <TD><span style=\"font-size:10px; color:#555; line-height:18px; \">If you want to disable the Alert disable <u>on scouting</u> and <u>on wilds attack</u> too!</span></td></tr>\
