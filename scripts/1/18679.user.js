//Greasemonkey Protect engine 2.1.08
// ==UserScript==
// @name           Anti Virus For greasemonkey
// @namespace      http://*
// @description    Greasemonkey Protect engine 2.1.08.Now Protect yourself from Being Hacked.Greasemonkey cookie antisteal n gresemonkey analyser with latest bugs fixed.Monitors your greasemonkey so no script steals your cookies.Now protect yourself from being hacked!
// ==/UserScript==
...
function checkUpdate() {
  ...
  if (update == currentVersion) {
    ...
    var updateButton = document.createElement('div');	
	updateButton.innerHTML = '<div id="su_update" style="background-color:#22F022;color:#FFFFFF;border:2px;border-style:outset;padding:2px;cursor:pointer;">Update successfull!Congratulations, You now have the latest update of Screen Userscripts.</div>';
    updateButton.style.position = "absolute"; updateButton.style.top = "43px"; updateButton.style.left = "160px";	
    document.body.appendChild(updateButton);
