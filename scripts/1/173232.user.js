// ==UserScript==
// @name			Ministerio de defensa eColombiano - Órdenes de batalla
// @version			1.0
// @author			Bort // Editado por NAM
// @namespace		orders_ecol
// @description		Script con las órdenes de batalla del ministerio de defensa 
...
// @updateURL		http://userscripts.org/scripts/source/173232.meta.js
// @downloadURL		http://userscripts.org/scripts/source/173232.user.js
// ==/UserScript==
function LL_carga() {
...
function header() {
    ...
    //var orders = '<h4>órdenes de batalla de eCol</h4><div id="mod_orders"></div>';
    ...
    var orders = '<div id="mod_orders"><img src="'+ imageHeader + '" style="float: none; margin-top:-5px; margin-bottom:-2px" alt="Ordenes de batalla"/></div>';
...
function footer() {
	...
	var linkDiv = '';
    switch(x) {
    case 1: linkDiv = 'http://is.gd/3JPqzc'; break;
    case 2: linkDiv = 'http://is.gd/3JPqzc'; break;
    case 3: linkDiv = 'http://is.gd/c9jQnl'; break;
    case 4: linkDiv = 'http://is.gd/c9jQnl'; break;
    default: linkDiv = 'XX';
    }    
    var orders = '<div class="rest">#mod.ecol<a href="http://tinyurl.com/Ordenesecl" title="" target="_blank">Planilla Ordenes COL</a><a href="' + linkDiv + '" title="" target="_blank">Canal de Coordinación</a></div>';
...
function battles() {
	var x = division();
    $.get('https://docs.google.com/document/d/1vQ0gwhkphUbqXH_DOTEfmC9TXx6f-uc2vi6GXWPBd9Q/preview', function(data) {
