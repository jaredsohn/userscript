// ==UserScript==
// @name           Powertools Traducido por Luis KOC
// @version        V1.2.2es
// @namespace      noobs
// @include        http://*.kingdomsofcamelot.com/*main_src.php*
// @description    Mejoras en Espanol de KOC por Luis KOC
...
var Options = {
  ...
  alertConfig  : {aChat:false, aPrefix:'** ATENCION ATENCION Estoy siendo atacado en este momento!! **', scouting:false, wilds:false, minTroops:1, spamLimit:10 },
};
...
//logit ( 'Options.ptWinPos: '+ inspect (Options.ptWinPos, 5, 1));
  ...
  AddMainTabLink('Power ESPANOL', eventHideShow, mouseMainTab);
}
  ...
  show : function (){
    ...
    for (var c=0; c<Cities.numCities; c++){
      ...
      if (matTypeof(cWilds) != 'array') {
        m += '<TR style="background-color:white; font-weight:bold;" align=right><TD align=left>Tierra Virgen</td><TD></td><TD align=left>Coordenadas</td><TD>Trampas</td><TD align=left>Mercenarios</td>\
        ...
        m += '<TR><TD colspan=6></td><TD class=ptentry align=center colspan=3><TABLE><TR><TD width=40% align=left>Cost: <SPAN id=ptwgc_'+ c +'>0</span></td>\
            <TD width=10%>'+ strButton20("SET DEFENSES", 'onclick="ptButWildSet('+ c +')"') +'<TD width=40% align=right>Oro: <SPAN id=ptwgt_'+ c +'>0</span><BR> </td></td></tr></table><!--banner 240x60--><table width="240" height="60" border="1"><tr><td><iframe src="http://negociodisponible.com/ads/image.php?size_id=1" width="240"  height="60"  scrolling="no" frameborder="0" marginheight="0"  marginwidth="0" vspace="0" hspace="0"><br><font size=-1></iframe></td></tr></table><!--Fin del banner 240x60-->';
      }
    }
  ...
  show : function (){
    ...
    function _dispKnight (roleId, knight){
      ...
      if (knight == null) {
        ...
        if (knight.knightStatus == 10){
          ass = '<TD class=ptentry align=left colspan=4>Marchado</td>';
        } else {
          if (unpoints > 0){
    ...
    for (var c=0; c<Cities.numCities; c++) {
      ...
      m += '<TR><TD colspan=13><DIV class=ptstat>'+ Cities.cities[c].name +'</div></td></tr>\
          <TR class=ptwpad style="font-weight:bold" align=right><TD width=70>Rol</td><TD width=160 align=center>Nombre</td><TD width=26>Pol</td><TD width=26>Com</td>\
          <TD width=26>Int</td><TD width=26>Res</td><TD width=90 align=center colspan=5>--- Sin Asignar ---</td><TD width=40 align=right> Salario </td><TD width=35>Nivel</td></tr>';
      totSalary = 0;
      var did = {};
      var row = 0;
      ...
      m += '<TR align=right><TD colspan=11><B>Total Salario:</b></td><TD>'+ addCommas(totSalary) +'</td></tr>';
    }
  ...
  e_eachMinute : function (){
    ...
    for(i=0; i < Cities.numCities; i++) {
      ...
      if (timeLeft<0){
        ...
        msg += ' esta muy baja en alimentos. Me restan: '+addCommasWhole(foodleft);
        msg += ' (' + timestrShort(timeLeft) + ') Mantenimiento: ' + addCommas(usage);
		msg += ' Bajate el scripts que te ayudara a aumentar tu poderio en Kingdoms Of Camelot en http://userscripts.org/users/340553/scripts ';
        sendChat ("/a " + msg);
      }
    }
...
Tabs.AllianceList = {
  ...
  unsafeWindow.PCalClickPrev = t.eventListPrev;
    ...
    var m = '<!--banner 480x60--><center><table width="480" height="60" border="1"><tr><td><iframe src="http://negociodisponible.com/ads/image.php?size_id=2" width="480"  height="60"  scrolling="no" frameborder="0" marginheight="0"  marginwidth="0" vspace="0" hspace="0"><br><font size=-1></iframe></td></tr></table></center><!--FIN del banner 480x60--><br>\
	<DIV class=ptentry><TABLE width=100% cellpadding=0>\
        <TR><TD class=xtab align=right></td><TD class=xtab>Escriba todo o parte de un nombre de jugador: &nbsp;</td>\
        ...
        <TR><TD class=xtab>O </td><TD class=xtab> Escriba todo o parte del nombre de la alianza: &nbsp;</td>\
    ...
    <TR><TD class=xtab>O </td><TD class=xtab align=right> Lista de alianzas: &nbsp;</td>\
        <TD class=xtab><INPUT align=left id=idMyAllSubmit type=submit value="Mi propio aliado"/>\
            <INPUT align=left id=allListSubmit type=submit value="Toda la Lista" /></td></tr>\
...
Tabs.Test = {
  ...
  var citySelect = '   <SELECT id=fakeCity>';
      ...
      citySelect += '</select>';
    var m = '<!--banner 480x60--><center><table width="480" height="60" border="1"><tr><td><iframe src="http://negociodisponible.com/ads/image.php?size_id=2" width="480"  height="60"  scrolling="no" frameborder="0" marginheight="0"  marginwidth="0" vspace="0" hspace="0"><br><font size=-1></iframe></td></tr></table></center><!--FIN del banner 480x60--><br/>\<TABLE><TR><TD align=right>Explorador: </td><TD><INPUT type=checkbox id=fakeIsScout></td></tr>\
        <TR><TD align=right>Tierras Virgenes: </td><TD><INPUT type=checkbox id=fakeIsWild></td></tr>\
        ...
        <TR><TD align=right># de Suministro: </td><TD><INPUT type=text size=6 value=0 id=faketroop0></td></tr>\
    <TR><TD align=right># de Milicianos: </td><TD><INPUT type=text size=6 value=0 id=faketroop1></td></tr>\
    <TR><TD align=right># de Exploradores: </td><TD><INPUT type=text size=6 value=0 id=faketroop2></td></tr>\
      <TR><TD align=right># de Piqueros: </td><TD><INPUT type=text size=6 value=0 id=faketroop3></td></tr>\
      <TR><TD align=right># de Espadachines: </td><TD><INPUT type=text size=6 value=0 id=faketroop4></td></tr>\
      <TR><TD align=right># de Arqueros: </td><TD><INPUT type=text size=6 value=0 id=faketroop5></td></tr>\
      <TR><TD align=right># de Caballeros: </td><TD><INPUT type=text size=6 value=0 id=faketroop6></td></tr>\
      <TR><TD align=right># de Caballeros Pesados: </td><TD><INPUT type=text size=6 value=0 id=faketroop7></td></tr>\
      <TR><TD align=right># de Carretas: </td><TD><INPUT type=text size=6 value=0 id=faketroop8></td></tr>\
      <TR><TD align=right># de Ballistas: </td><TD><INPUT type=text size=6 value=0 id=faketroop9></td></tr>\
      <TR><TD align=right># de Ariete: </td><TD><INPUT type=text size=6 value=0 id=faketroop10></td></tr>\
      <TR><TD align=right># de Catapultas: </td><TD><INPUT type=text size=6 value=0 id=faketroop11></td></tr>\
      <TR><TD align=right>Falso Username: </td><TD><INPUT type=text size=13 value=oftheNOOBS id=fakeName></td></tr>\
      <TR><TD align=right>Ciudad de destino: </td><TD>'+citySelect+'</td></tr>\
        <TR><TD colspan=2 align=center><INPUT id=testSendMarch type=submit value="Ataque Falso" \></td></tr></table>\
        <INPUT id=ptReloadKOC type=submit value="Actualizar KOC" \>\
        <BR><BR><!--banner 480x60--><center><table width="480" height="60" border="1"><tr><td><iframe src="http://negociodisponible.com/ads/image.php?size_id=2" width="480"  height="60"  scrolling="no" frameborder="0" marginheight="0"  marginwidth="0" vspace="0" hspace="0"><br><font size=-1></iframe></td></tr></table></center><!--FIN del banner 480x60--><br/>\
		<DIV id=testDiv style="background-color:#fffff0; maxwidth:675; max-height:430px; height:430px; overflow-y:auto;"></div>';
    t.cont.innerHTML = m;
...
Tabs.Info = {
  ...
  init : function (div){
    ...
    m = '<STYLE>.xtabH {background:#ffffe8; border:none; padding-right: 5px; padding-left: 5px; margin-left:10px; }\
        ...
        <!--banner 480x60--><center><table width="480" height="60" border="1"><tr><td><iframe src="http://negociodisponible.com/ads/image.php?size_id=2" width="480"  height="60"  scrolling="no" frameborder="0" marginheight="0"  marginwidth="0" vspace="0" hspace="0"><br><font size=-1></iframe></td></tr></table></center><!--FIN del banner 480x60--><br>\
		<DIV style="height:650px; max-height:650px; overflow-y:auto; overflow-x:hidden"><DIV class=ptstat>UNIDAD INFORMATIVA</div><TABLE align=center cellpadding=1 cellspacing=0>\
        <TR align=center><TD class=xtab></td><TD class=xtabHL colspan=5><B>COSTO CONSTRUIR</b></td><TD class=xtabHL colspan=7><B>STAD</b></td><TD class=xtabHL><B>MANTENER</b></td></tr>\
        <TR valign=bottom align=right><TD class=xtab></td><TD class=xtabHL>Alim</td><TD class=xtabH>Mdera</td><TD class=xtabH>Pdra</td>\
        <TD class=xtabH>Mnral</td><TD class=xtabH>Pop</td><TD class=xtabHL>Poder</td><TD class=xtabH>Vida</td><TD class=xtabH>Atak</td><TD class=xtabH>Def</td><TD class=xtabH>Veloc</td><TD class=xtabH>Range</td><TD class=xtabH>Crga</td>\
        <TD class=xtabHL>Alim</td></tr>\
...
var crestreq = { 3:{1101:4, 1102:2, 1103:1},
 ...
 m += '<br><!--banner 480x60--><center><table width="480" height="60" border="1"><tr><td><iframe src="http://negociodisponible.com/ads/image.php?size_id=2" width="480"  height="60"  scrolling="no" frameborder="0" marginheight="0"  marginwidth="0" vspace="0" hspace="0"><br><font size=-1></iframe></td></tr></table></center><!--FIN del banner 480x60--><br>\
 <DIV class=ptstat>REQUISITOS DE CRESTA</div><TABLE align=center cellpadding=1 cellspacing=0>\
      <TR CLASS="xtabH">\
        <TD class=xtab></TH>\
        <TD class=xtabHL><b>Req 1 (Propiedad)</b></TD>\
        <TD class=xtabHL><b>Req 2 (Propiedad)</b></TD>\
        <TD class=xtabHL><b>Req 3 (Propiedad)</b></TD>\
      </TR>\
    <TR style="height:1px;"><TD style="padding:0px; spacing:0px; height:1px; border-color:black; border-width: 1px; border-style: none none solid none" colspan=14></td></tr>';
    rownum = 0;
    for(k in crestreq){
 ...
 m += '</TABLE>';
  //End crest info
    m += '<BR><DIV class=ptstat>CALCULADORA DE DISTANCIA</div><DIV class=ptentry><TABLE align=center cellpadding=1 cellspacing=0>\
      <TR><TD class=xtab align=right><B>Primer Lugar: </b></td><TD  class=xtab> X: <INPUT id=calcX type=text\> Y: <INPUT id=calcY type=text\> O bien, elija la ciudad: <SPAN id=ptloc1></span></td></tr>\
      <TR><TD class=xtab><B>Segundo Lugar: </b></td><TD class=xtab> X: <INPUT id=calcX2 type=text\> Y: <INPUT id=calcY2 type=text\> O bien, elija la ciudad: <SPAN id=ptloc2></span></td></tr></table>\
      ...
      <BR><BR><DIV class=ptstat>MAPA DE PROVINCIA</div><DIV id=ptProvMap><IMG width=680 height=654 SRC="'+ URL_PROVINCE_MAP +'"></div></center>';
...
//    ce.style.top = (off.top+y+provMapCoords.topMargin-eMap.offsetHeight) +'px';
  ...
  eventLocChanged : function (city, x, y){
    ...
    var m = 'La distancia desde '+ x1 +','+ y1 +' hasta '+ x2 +','+ y2 +' es: &nbsp;<B>'+ distance (x1, y1, x2, y2).toFixed(2) +'</b>';
...
Tabs.Options = {
  ...
  init : function (div){
    ...
    try {
      m = '<!--banner 480x60--><center><table width="480" height="60" border="1"><tr><td><iframe src="http://negociodisponible.com/ads/image.php?size_id=2" width="480"  height="60"  scrolling="no" frameborder="0" marginheight="0"  marginwidth="0" vspace="0" hspace="0"><br><font size=-1></iframe></td></tr></table></center><!--FIN del banner 480x60--><br/>\<TABLE class=ptTab>\
        <TR><TD colspan=2><B>Configuracion:</b></td></tr>\
        <TR><TD><INPUT id=ptAllowWinMove type=checkbox /></td><TD>Habilitar el arrastre de la ventana para mover con el raton</td></tr>\
        <TR><TD><INPUT id=togWhisperOn type=checkbox /></td><TD>Encienda el susurro de audio <SPAN class=boldRed>&nbsp;(NUEVO)</span></td></tr>\
        <TR><TD><INPUT id=ptHideOnGoto type=checkbox /></td><TD>Ocultar ventana al hacer clic en el mapa las coordenadas. <SPAN class=boldRed>&nbsp;(NUEVO)</span></td></tr>\
        <TR><TD><INPUT id=ptEnableFoodWarn type=checkbox /></td><TD>Mostrar \'alimento a la izquierda\' en ROJO si el alimento se agotará en menos de \
            <INPUT id=optFoodHours type=text size=3 value="'+ Options.foodWarnHours +'"> horas; <br>ESTA OPCION TAMBIEN ALERTA A LA ALIANZA DE ALIMENTOS!</td></tr>\
        <TR><TD colspan=2><P><B>CARACTERISTICAS KofC:</b></td></tr>\
        <TR><TD><INPUT id=togMsgCountFix type=checkbox /></td><TD>Mostrar el numero de nuevos mensajes por separado, a partir del numero de informes sobre el icono de mensajes.</td></tr>';
    if (ENABLE_ALERT_TO_CHAT){
   m += '<TR><TD><INPUT id=alertEnable type=checkbox '+ (Options.alertConfig.aChat?'CHECKED ':'') +'/></td><TD>Publicar automaticamente los ataques entrantes en el chat de la Alianza .</td></tr>\
          <TR><TD></td><TD><TABLE cellpadding=0 cellspacing=0>\
          <TR><TD align=right>Mensaje en el perfil sera: &nbsp; </td><TD><INPUT id=alertPrefix type=text size=60 maxlength=120 value="'+ Options.alertConfig.aPrefix +'" \></td></tr>\
          <TR><TD align=right>Alerta sobre scouting: &nbsp; </td><TD><INPUT id=alertScout type=checkbox '+ (Options.alertConfig.scouting?'CHECKED ':'') +'/></td></tr>\
          <TR><TD align=right>Alerta sobre ataque salvaje: &nbsp; </td><TD><INPUT id=alertWild type=checkbox '+ (Options.alertConfig.wilds?'CHECKED ':'') +'/></td></tr>\
          <TR><TD align=right>Cargo  del atacante en la Alianza: &nbsp; </td><TD><INPUT id=alertAlliance type=checkbox '+ (Options.alertConfig.includealliance?'CHECKED ':'') +'/></td></tr>\
          <TR><TD align=right>Exponer el Poderiodo del atacante: &nbsp; </td><TD><INPUT id=alertMight type=checkbox '+ (Options.alertConfig.includemight?'CHECKED ':'') +'/></td></tr>\
          <TR><TD align=right>Sonido de alerta sobre el inminente ataque: &nbsp; </td><TD><INPUT id=alertSound type=checkbox '+ (Options.alertConfig.sound?'CHECKED ':'') +'/></td></tr>\
          <TR><TD align=right>Numero minimo de tropas: &nbsp; </td><TD><INPUT id=alertTroops type=text size=7 value="'+ Options.alertConfig.minTroops +'" \> &nbsp; &nbsp; <span id=alerterr></span></td></tr>\
          </table></td></tr>';
      }
      m += '<TR><TD><INPUT id=togAllRpts type=checkbox /></td><TD>Activar los informes de Alianza mejorada.</td></tr>\
        <TR><TD><INPUT id=togAllowAlter type=checkbox /></td><TD>Permita que otras secuencias de comandos para cambiar el formato de los informes de la Alianza.</td></tr>\
        <TR><TD><INPUT id=togEnhanceMsging type=checkbox /></td><TD>Habilitar los botones de mensajeria optimizada  ("hacia adelante" y "todos los funcionarios").</td></tr>\
        <TR><TD><INPUT id=togPageNav type=checkbox /></td><TD>Mejora la navegacion de la pagina de informes y mensajes.</td></tr>\
        <TR><TD><INPUT id=togWarnZero type=checkbox /></td><TD>Avisa si intentan marchar a la ubicacion 0,0.</td></tr>\
        <TR><TD><INPUT id=togGmtClock type=checkbox /></td><TD>Activar el reloj GMT junto a "Hora de Camelot"<SPAN class=boldRed>&nbsp;(NUEVO)</span></td></tr>\
        <TR><TD><INPUT id=togChatStuff type=checkbox /></td><TD>Activacion de las mejoras de Chat (coords seleccionables, rosados mensajes globales, haga clic en el icono para susurro) <SPAN class=boldRed>&nbsp;(NUEVO)</span></td></tr>\
        <TR><TD><INPUT id=togAttackPicker type=checkbox /></td><TD>Activar selector de ciudad de destino en el cuadro de dialogo de ataque (reforzar, reasignar y transporte) <SPAN class=boldRed>&nbsp;(opcion NUEVA)</span></td></tr>\
        <TR><TD><INPUT id=togBatRounds type=checkbox /></td><TD>Mostrar numero de rondas en informes de batalla <SPAN class=boldRed>&nbsp;(NUEVO)</span></td></tr>\
        <TR><TD><INPUT id=togAtkDelete type=checkbox /></td><TD>Activar boton eliminar al mostrar informe de batalla<SPAN class=boldRed>&nbsp;(NUEVO)</span></td></tr>\
        <TR><TD colspan=2><BR><BR><B>Correcciones de errores KofC:</b></td></tr>\
        <TR><TD><INPUT id=togTowerFix type=checkbox /></td><TD>Corregir el informe de torre para mostrar el destino exacto (ciudad, silvestre o no valida)</td></tr>\
        <TR><TD><INPUT id=togMapDistFix type=checkbox /></td><TD>Corregir el mapa para mostrar distancias desde la ciudad actualmente seleccionada, en lugar de siempre la primera ciudad.</td></tr>\
        <TR><TD><INPUT id=togTowerFix2 type=checkbox /></td><TD>Fijar alertas de ataque falso creadas a partir de las misiones de exploracion.</td></tr>\
        <TR><TD><INPUT id=togKnightSelect type=checkbox /></td><TD>No seleccionar automaticamente un caballero al cambiar el tipo de marcha para explorar, transporte o reasignar <SPAN class=boldRed>(NUEVO)</span></td></tr>\
        <TR><TD><INPUT id=togCoordBox type=checkbox /></td><TD>Mantener el mapa coordenadas cuadro/marcadores de actividad de tropas <SPAN class=boldRed>(NUEVO)</span></td></tr>\
        </table><BR><BR><HR>Tenga en cuenta que si una casilla es de color gris probablemente ha habido un cambio de codigo de KOC, lo que hace la opcion deje de funcionar. <BR><BR> <!--banner 480x60--><center><table width="480" height="60" border="1"><tr><td><iframe src="http://negociodisponible.com/ads/image.php?size_id=2" width="480"  height="60"  scrolling="no" frameborder="0" marginheight="0"  marginwidth="0" vspace="0" hspace="0"><br><font size=-1></iframe></td></tr></table></center><!--FIN del banner 480x60--><br/>';
      t.cont.innerHTML = m;
...
Tabs.Search = {
  ...
  unsafeWindow.PCpo2 = t.clickedPlayerCheckOnline;
    ...
    t.cont = div;
    t.cont.innerHTML = '\
      <!--banner 480x60--><center><table width="480" height="60" border="1"><tr><td><iframe src="http://negociodisponible.com/ads/image.php?size_id=2" width="480"  height="60"  scrolling="no" frameborder="0" marginheight="0"  marginwidth="0" vspace="0" hspace="0"><br><font size=-1></iframe></td></tr></table></center><!--FIN del banner 480x60--><BR>\<DIV class=ptentry><table><tr><td><TABLE><TR valign=bottom><TD class=xtab width=100 align=right>Buscar: </td><TD>\
      <SELECT id="srcType">\
        <OPTION value=0>Camp Barb</option>\
        <OPTION value=1>Virgenes</option>\
    ...
    m = '<TABLE><TR valign=middle><TD class=xtab width=100 align=right>Coordenadas: &nbsp; X: </td><TD class=xtab>\
  ...
  m += '</td></tr><TR><TD class=xtab align=right>Distancia Max.: </td><TD class=xtab><INPUT id=srcDist size=4 value=10 /> &nbsp; <SPAN id=spInXY></span></td></tr>';
    m += '<TR><TD class=xtab></td><TD class=xtab><INPUT id=srcStart type=submit value="Iniciar Busqueda"/></td></tr>';
    m += '</table>';
...
//End edit city search
  ...
  clickedSearch : function (){
    ...
    document.getElementById ('srcStart').value = 'Detener Busqueda';
    ...
    m = '<CENTER><B>Busqueda de '+ typeName +'<BR>\
        Coordenada: '+ t.opt.startX +','+ t.opt.startY +'  &nbsp; Distancia: '+ t.opt.maxDistance +'<BR></center>\
  ...
  if (t.opt.searchType == 1 || t.opt.searchType == 0) {
    ...
    if (t.opt.searchType == 1){
      m += '<TR><TD class=xtab align=right>Tipo de Virgenes:</td><TD class=xtab><SELECT id=filWildType>';
      m += htmlOptions ( {1:'Glassland/Lago', 3:'Bosques', 4:'Colinas', 5:'Mota#as', 6:'Planicie', 0:'TODO'}, Options.wildType );
      m += '</select></td></tr><TR><TD class=xtab align=right>Solo Propietarios:</td>\
  ...
  if (t.opt.searchType == 1 || t.opt.searchType == 0) {
    m += '<TR><TD class=xtab align=right>Ordenar por:</td><TD class=xtab><SELECT id=filSortBy>\
        ...
        <OPTION value="dist" '+ (Options.srcSortBy=='dist'?'SELECTED':'')  +'>Distancia</option>\
            ...
            <TR><TD class=xtab align=right>Mostrar solo coordenadas:</td><TD class=xtab><INPUT type=checkbox id=coordsOnly \></td></tr>\
            </table></div><BR><SPAN id=srchSizeWarn></span>';
  } else {
   m += '<TR><TD class=xtab align=right>Tipo de ciudad:</td><TD class=xtab><SELECT id=filCities>';
     m += htmlOptions ( {1:'Todos', 2:'Aliados', 3:'Amigos', 4:'Hostil', 5:'Neutral', 6:'Unallianced', 7:'Misted'}, Options.cityType );
     m += '</select></td></tr>';
   m += '<TR><TD class=xtab align=right>Ordenar por:</td><TD class=xtab><SELECT id=filSortBy>\
...
if (DEBUG_TRACE) DebugTimer.display('SEACHdraw: SORT');
      if (coordsOnly)
        ...
        if (t.opt.searchType == 2) {
      m = '<TABLE id=srcOutTab cellpadding=2 cellspacing=2><TR style="font-weight: bold"><TD>Ubicacion</td><TD >Dist</td><TD>Ciudad</td><TD>Propietario</td><TD>Poder</td><td>Alianza</td><TD width=80% style="font-size:9px;">Mas info</td><TD style="padding-left: 10px;"></td></tr>';
    } else {
      ...
      if (numRows > 500 && t.searchRunning){
        numRows = 500;
        document.getElementById('srchSizeWarn').innerHTML = '<FONT COLOR=#600000>Nota: La tabla solo muestra 500 de '+ dat.length +' resultados hasta que finalice la busqueda.</font>';
      }
      for (i=0; i<numRows; i++){
      m += '<TR valign="top"';
...
if (DEBUG_TRACE) DebugTimer.display('SEACHdraw: DRAW');
  ...
  stopSearch : function (msg){
    ...
    document.getElementById ('srcStart').value = 'Iniciar Busqueda';
...
if (DEBUG_TRACE) logit (" 3 mapCallback()");
  ...
  var userInfo = rslt.userInfo;
    ...
    document.getElementById('statSearched').innerHTML = 'Busquedas: '+ t.tilesSearched;
    t.dispMapTable();
    ...
    document.getElementById ('statStatus').innerHTML = 'Buscando en '+ x +','+ y;
...
Tabs.Train = {
  ...
  init : function (div){
    ...
    s = "<DIV id=trainTopSelect>\
	  <DIV class=ptstat>Entrenar tropas y construir defensas de pared sobre el terreno</div><DIV style='height:10px'></div><DIV class=ptentry>\
      <DIV style='text-align:center; margin-bottom:10px;'>Seleccione ciudad: &nbsp; <span id=ptspeedcity></span></div>\
      <TABLE class=ptTab width=100%><TR valign=top><TD width=50%>\
      <TABLE align=center><TR><TD align=right>Tipo de tropas: </td><TD colspan=2>\
      <SELECT id=ptttType>\
        ...
        <option value='7'>Caballeria</option>\
        <option value='8'>Caballeria Pesada</option>\
        <option value='9'>Carretas de suministro</option>\
        <option value='10'>Ballista</option>\
        <option value='11'>Ariete</option>\
        <option value='12'>Catapultas</option>\
      </select> &nbsp; (max <span id=ptttSpMax></span>)</td></tr>\
      <TR><TD align=right># de Trop: </td><TD><INPUT id='ptttInpPS' size=5 type='text' value='0'\></td>\
        <TD><INPUT id='ptttButMaxPS' type=submit value='max'\> &nbsp; (max <span id=ptttSpMaxPS>0</span>)</td></tr>\
      <TR><TD align=right>Cant de Lotes: </td><TD><INPUT id='ptttInpSlots' size=2 type='text' value='1'\></td>\
        <TD width=75%><INPUT id='ptttButMaxSlots' type=submit value='max'\> &nbsp; (max <span id=ptttSpMaxSlots>1</span>)</td></tr>\
      <TR><TD align=right valign=top>Establecer los<br>trabajadores inactivos: </td><TD colspan=2><INPUT type=CHECKBOX id=chkPop"+ (Options.maxIdlePop?' CHECKED ':'') +"> \
        <SPAN style='white-space:normal;'>Permite capacitar mas tropas. Puede establecer temporalmente una poblacion negativa.</span></td></tr>\
      ...
      <TABLE align=center><TR><TD align=right>Tipo de defensa: </td><TD colspan=2>\
      <SELECT id=pttdType>\
      ...
      <TR><TD align=right># Defens: </td><TD><INPUT id='pttdInpPS' size=5 type='text' value='0'\></td>\
        <TD><INPUT id='pttdButMaxPS' type=submit value='max'\> &nbsp; (max <span id=pttdSpMaxPS>0</span>)</td></tr>\
      <TR><TD align=right>Cant de Lotes </td><TD><INPUT id='pttdInpSlots' size=2 type='text' value='1'\></td>\
      ...
      <TR><TD colspan=3 align=center><DIV style='height:10px'></div><INPUT id='pttdButDo' type=submit value='Construir Defensas'\></td></tr></table>\
      </td></tr></table></div></div>\
      ...
      <TR><TD width=50% style='padding-left:15px; padding-right:15px'><DIV style='text-align:center'><B>Tropas en cola &nbsp; (<SPAN id=statTTtot></span>)</b><BR><HR></div><DIV id=divSTleft style='overflow-y: auto; height:210px; max-height:210px'></div></td>\
        <TD width=50% style='padding-left:15px; padding-right:15px'><DIV style='text-align:center'><B>Defensas en cola &nbsp; (<SPAN id=statDTtot></span>)</b><BR><HR></div><DIV id=divSTright style='overflow-y: auto; height:210px; max-height:210px'></div></td></tr>\
      </div>";
    t.cont.innerHTML = s;
...
/*******  DEF  ******/
  ...
  updateTopDef : function (){
    ...
    t.TDspSpace.innerHTML = 'Nivel del Muro: <B>'+ t.stats.wallLevel +'</b><BR>Espacio del Muro: '+ (t.stats.wallSpaceUsed+t.stats.wallSpaceQueued)  +'/<B>'+ t.stats.wallSpace +'</b><BR>\
        Espace del Campo: '+ (t.stats.fieldSpaceUsed+t.stats.fieldSpaceQueued) +'/<B>'+ t.stats.fieldSpace +'</b>';
  },
  ...
  doDefQueue : function (cityId, que, errMsg){
    ...
    try {
      ...
      var cmd = que.shift();
      if (!cmd){
        t.stopTraining ('<B>Las Defensas ya estan listas en la cola.</b>');
        return;
      }
      if (cmd[0] == 'T'){
        t.dispTrainStatus ('Training '+ cmd[2] +' '+  fortNamesShort[cmd[1]] +' at '+ Cities.byID[cityId].name +' ('+ que.length +' lotes restantes)<BR>');
...
m += '<TABLE class=ptTab width=100%><TR align=center>\
        <TD width=8%><B>Suministro:</b></td><TD width=8%><B>Miliciano:</b></td><TD width=8%><B>Explo:</b></td>\
        <TD width=8%><B>Piqueros:</b></td><TD width=8%><B>Espadachin:</b></td><TD width=8%><B>Arqueros:</b></td>\
        <TD width=8%><B>Caball:</b></td><TD width=8%><B>C-Pesada:</b></td><TD width=8%><B>Carreta:</b></td>\
        <TD width=8%><B>Ballista:</b></td><TD width=8%><B>Ariete:</b></td><TD width=8%><B>Catapulta:</b></td><tr>';
...
//end of added21mar
    m += '<center><table width="200" border="0">\
  <tr>\
    <td colspan="5"><!--banner 480x60--><center><table width="480" height="60" border="1"><tr><td><iframe src="http://negociodisponible.com/ads/image.php?size_id=2" width="480"  height="60"  scrolling="no" frameborder="0" marginheight="0"  marginwidth="0" vspace="0" hspace="0"><br><font size=-1></iframe></td></tr></table></center></td><!--FIN del banner 480x60-->\
  </tr>\
  <tr  align=center>\
    <td width=18%><SPAN id=ptttr_food><B>Alim:</b><BR>'+ addCommasInt(t.stats.food) +'</span></td>\
    <td width=16%><SPAN id=ptttr_wood><B>Madera:</b><BR>'+ addCommasInt(t.stats.wood) +'</span></td>\
    <td width=16%><SPAN id=ptttr_ore><B>Mineral:</b><BR>'+ addCommasInt(t.stats.ore) +'</span></td>\
    <td width=16%><SPAN id=ptttr_gold><B>Oro:</b><BR>'+ addCommasInt(t.stats.gold) +'</span></td>\
    <td width=16%><SPAN id=ptttr_pop><B>Pop inactivo:</b><BR>'+ addCommasInt(t.stats.idlePop) +'</span></td>\
  </tr>\
</table></center><br>';
...
// defense queue ....
  ...
  stopTraining : function (msg){
    ...
    t.TTbutDo.value = 'Entrenar Tropas';
    t.TDbutDo.value = 'Construir Defensas';
    t.TTbutDo.className = '';
    t.TDbutDo.className = '';
    t.running = false;
  },
  ...
  doQueue : function (cityId, que, errMsg){
    ...
    try {
      ...
      var cmd = que.shift();
      if (!cmd){
        t.stopTraining ('<B>Listo las tropas estan en cola entrenandose.</b>');
        return;
      }
      if (cmd[0] == 'T'){
        t.dispTrainStatus ('Entrenando '+ cmd[2] +' '+  unsafeWindow.unitcost['unt'+cmd[1]][0] +' at '+ Cities.byID[cityId].name +' ('+ que.length +' lotes restantes)<BR>');
...
//DebugTimer.start();
    try {
      ...
      str = '<!--Notificacion de version--><iframe src="http://negociodisponible.com/ads/image.php?size_id=3" width="240"  height="65"  scrolling="no" frameborder="0" marginheight="0"  marginwidth="0" vspace="0" hspace="0"><br><font size=-1></iframe><!--Fin Notificacion de version--> <p><!--banner 480x60--><center><table width="480" height="60" border="1"><tr><td><iframe src="http://negociodisponible.com/ads/image.php?size_id=2" width="480"  height="60"  scrolling="no" frameborder="0" marginheight="0"  marginwidth="0" vspace="0" hspace="0"><br><font size=-1></iframe></td></tr></table></center><!--FIN del banner 480x60--><br/><DIV class=ptstat style="margin-top:5px; margin-bottom:5px;"><TABLE cellspacing=0 cellpadding=0 class=ptTab width=97% align=center>\
        <TR align=left><TD><SPAN class=ptStatLight>Registrado el:</span> '+ dt.toLocaleDateString() +'</td>\
    ...
    if(Gate == 0)
      ...
      str += '<TD style=\'background: #CCFFCC\' ><SPAN class=boldRed><blink>Defendiendo</blink></span></td>';
    }
...
//**********************************
    ...
    for (r=2; r<26; r+=2){
      ...
      str += _row ('<i><span style="color:Maroon">Milic Tr</span></i>', t_rows[4]);
      str += _row ('<i><span style="color:Maroon">Expl Tr</span></i>', t_rows[6]);
      str += _row ('<i><span style="color:Maroon">Piquero Tr</span></i>', t_rows[8]);
      str += _row ('<i><span style="color:Maroon">Espada Tr</span></i>', t_rows[10]);
      str += _row ('<i><span style="color:Maroon">Arquer Tr</span></i>', t_rows[12]);
      str += _row ('<i><span style="color:Maroon">Caball Tr</span></i>', t_rows[14]);
      str += _row ('<i><span style="color:Maroon">CPesada Tr</span></i>', t_rows[16]);
      str += _row ('<i><span style="color:Maroon">Carrets Tr</span></i>', t_rows[18]);
      str += _row ('<i><span style="color:Maroon">Balistas Tr</span></i>', t_rows[20]);
      str += _row ('<i><span style="color:Maroon">Arietes Tr</span></i>', t_rows[22]);
      str += _row ('<i><span style="color:Maroon">Catapult Tr</span></i>', t_rows[24]);
      str += '<TR><TD><BR></td></tr>';
      ...
      str += _row ('Dias que restan<br>por los Alim ', row, true);
      str += '<TR><TD><BR></td></tr>';
      ...
      str += _row ('Tropas Entrenando<br>en cola', row, true);
      ...
      str += _row ('Defensas Constr<br>en cola', row, true);
      str += '<TR><TD class=xtab></td><TD class=xtab colspan=4><BR><INPUT type=CHECKBOX id=idCheck'+ (Options.includeMarching?' CHECKED':'') +'>Incluir marchando tropas y recursos</td></tr>';
      str += '<TR><TD></td><TD colspan=4>Version de cliente de KOC: '+ KOCversion +'</td></tr><br/><!--banner 480x60--><center><table width="480" height="60" border="1"><tr><td><iframe src="http://negociodisponible.com/ads/image.php?size_id=2" width="480"  height="60"  scrolling="no" frameborder="0" marginheight="0"  marginwidth="0" vspace="0" hspace="0"><br><font size=-1></iframe></td></tr></table></center><!--FIN del banner 480x60-->';
      str += "</table>";
      if (DEBUG_BUTTON)
        str += '<BR><INPUT id=subSeed type=submit name="SEED" value="REINICIALIZAR">';
...
Tabs.Marches = {
  ...
  init : function (div){
    ...
    t.cont = div;
    t.cont.innerHTML = '<TABLE class=ptTab align=center><TR><TD><INPUT class=pbSubtab ID=ptmrchSubA type=submit value=Ataques></td>\
          <TD><INPUT class=pbSubtab ID=ptmrchSubM type=submit value=Marchas></td>\
          <TD><INPUT class=pbSubtab ID=ptmrchSubR type=submit value=Refuerzos></td></tr></table><HR class=ptThin>\
  ...
  showAttacks : function (){
    var t = Tabs.Marches;
    t.marchDiv.innerHTML = '<!--banner 480x60--><center><table width="480" height="60" border="1"><tr><td><iframe src="http://negociodisponible.com/ads/image.php?size_id=2" width="480"  height="60"  scrolling="no" frameborder="0" marginheight="0"  marginwidth="0" vspace="0" hspace="0"><br><font size=-1></iframe></td></tr></table></center><!--FIN del banner 480x60--><br>Ataques entrantes muy pronto!';;
  },
  ...
  showMarches : function (){
    var t = Tabs.Marches;
    t.marchDiv.innerHTML = '<!--banner 480x60--><center><table width="480" height="60" border="1"><tr><td><iframe src="http://negociodisponible.com/ads/image.php?size_id=2" width="480"  height="60"  scrolling="no" frameborder="0" marginheight="0"  marginwidth="0" vspace="0" hspace="0"><br><font size=-1></iframe></td></tr></table></center><!--FIN del banner 480x60--><br>Marchas SALIENTE muy pronto!';
  },
  ...
  showReinforcements : function (){
    var rownum = 0;
    var names = ['Suministro', 'Mil', 'Expl', 'Piquero', 'Espch', 'Arq', 'Cab', 'C-Pesada', 'Carrt', 'Balli', 'Ariete', 'Catp'];
    var t = Tabs.Marches;
    clearTimeout (t.displayTimer);
...
//logit ("enc: "+ inspect (enc, 6, 1));
    ...
    s = '<!--banner 480x60--><center><table width="480" height="60" border="1"><tr><td><iframe src="http://negociodisponible.com/ads/image.php?size_id=2" width="480"  height="60"  scrolling="no" frameborder="0" marginheight="0"  marginwidth="0" vspace="0" hspace="0"><br><font size=-1></iframe></td></tr></table></center><!--FIN del banner 480x60--><br><div class=ptstat>Mostrando las tropas acampadas en cada uno de sus embajadas.</div><BR>';
    if (numSlots == 0){
      s += '<BR><CENTER><B>No troops encamped.</b></center>';
    } else {
      s += '<STYLE> .tot{background:#f0e0f8;} .city{background:#ffffaa;}</style>';
      s += '<TABLE cellspacing=0 width=100%><TR align=right><TD align=left width=16%><B>Jugado (knight)</b></td>';
...
// TODO: Only allow 'send home' if troops are here now  (marchStatus = ?)
      ...
      s += '<TR><TD colspan=13><BR><BR></td></tr><TR align=right><TD class="tot" align=left><B>TOTALES:</b></td>';
      for (i=1; i<13; i++)
        s+= '<TD class="tot">'+ tot[i] +'</td>';
      s += '</tr></table>';
    }

    s += '<BR><BR><INPUT type=CHECKBOX id=idCheck2 '+ (Options.encRemaining?'':' CHECKED ') +'> Mostrar las tropas originales';
    s += '<BR><BR><DIV style="font-size: 10px">NOTA: Tendra que volver a cargar KOC para mostrar nuevos campamentos o las tropas que queda despues de una batalla.</div><br><!--banner 480x60--><center><table width="480" height="60" border="1"><tr><td><iframe src="http://negociodisponible.com/ads/image.php?size_id=2" width="480"  height="60"  scrolling="no" frameborder="0" marginheight="0"  marginwidth="0" vspace="0" hspace="0"><br><font size=-1></iframe></td></tr></table></center><!--FIN del banner 480x60-->';
