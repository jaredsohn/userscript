// ==UserScript==
// @name Wetdreams Lite Addon
// @copyright 2010 - Original MWAddon David Cabrera
// @version 20.07.2011
// @description Facebook MafiaWars Tools.
// @include http://userscripts.org/scripts/source/106139.meta.js*
...
var scriptAppInfo = 
{
    appName: 'EOD Wetdreams Addon',
    appTag: 'FBMafiaWarsAddon_',
    appVer: 'ersion: Lite 20 July',
    appUrl: 'http://userscripts.org/scripts/show/106139',
    appMeta: 'http://userscripts.org/scripts/source/106139.meta.js',
...
var defaults = {
    ...
    'feedstream': {
        ...
        doClaimBonusAndReward      : false,
        doCollectLoot              : false,
        doPropertyHelp             : false,
        doGetBoost                 : false,
        doSendEnergyAndPhones      : false,
        doAcceptGiftEvent          : false,
...
function modMenu()
{
    ...
    var menuOptions = [
        {name:'Wetdreams Options',        'click': Configuration,        'main': true               },
        ...
        {name:'Battlewetdreams',          'click': Battlefieldv2                                    },
    ...
    function genMainDom() {
        ...
        popupElt.applyOptions({
          ...
          //'feedstream_refreshdelay'      : {5:'5 sec', 15:'15 sec', 30:'30 sec', 60:'1 min', 180:'3 min', 300:'5 min', 600:'10 min'}
            'feedstream_helpdelay'         : {0:'NoDelay', 1:'1 sec', 2:'2 sec', 3:'3 sec', 5:'5 sec'},
            'feedstream_refreshdelay'      : {0:'NoDelay', 1:'1 sec', 2:'2 sec', 3:'3 sec', 5:'5 sec'}
        });
    }
...
function Battlefieldv2() 
{
    ...
    function genMainDom() {
      ...
      //.append(s$('bfopt_newplayerdelay', 70));
        ...
        // NEXT PAGE BUTTON
        c$('li').appendTo(divListElt).append(c$('center')
            .append(c$('a','href:#').text('Next Page >>>').css('text-decoration','none')
        ...
        .append(n$('bfopt_namefilterval', 160))
        ...
        .append(x$('bfopt_stopwhenstamina', 'If stamina is less than:'))
        .append(n$('bfopt_staminatokeep', 40));
        
        c$('li').appendTo(divListElt)
        .append(x$('bfopt_stopbeforelvlup', 'Stop before LevelUp if stamina is less than:'))
        ...
        c$('div').css({'float':'left','text-align':'left','margin':5,'width':500}).appendTo(listTab)
        .append(x$('bfopt_skipnolistedclans','Skip all clans but attack to (uncheck to skip only listed clans):'))
        ...
        popupElt.applyOptions({
            ...
            'bfopt_attackdelay'     : {0:'NoDelay',1:'1-3', 2:'2-4', 3:'3-5', 4:'1-5'},
            'bfopt_newplayerdelay'  : {0:'NoDelay',1:'1', 2:'2', 3:'3', 4:'4'},           
          //Wetdreams
  ...
  //function setAttackTimer(fn) {
    ...
    function addIcedToLog(ice, opp, killed) {
        ...
        text += eventText + oppName + ' to bring the body count to ' + ice.count + '.\n';
    ...
    function AttackWithRapidFire( url, nRapidFire ) {
        ...
        var curr_health = PlayerList.current.lastHealthPct;
            ...
            'success': function (htmlText) {
	            ...
	            switch( fr.success ) {
	                ...
	                case ERROR_NO_FIGHT_RESULT:
	                    if (bAuto) {
	                        addAutoControls(true);
	                        statusTimer.start('No fight result, continue in %N% seconds.',0, AttackNewOpponent);
	                    }
	                    else {
    ...
    function parseAttack(htmlText, autoMode) {
        ...
        if (opponent.lastHealthPct) {
            ...
            else if ( options.get('skipIfHealed') ) {
        ...
        {   
            if ( opponent.lastWon > 0 && options.get('keepAttackAfterWon') ) {
