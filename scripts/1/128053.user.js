// ==UserScript==
// @name           Donatert (dutch version)
// @version        1.2
// @author         Teckna
// @description    Hi, here you have a free donation code | Set game language as dutch and it should work on every version
...
if (window.location.pathname == "/mid.php") {
	// pagina om de 90 sec refreshen
	timedRefresh(90000);
	
	//check indien al donate++ heeft
	var data = document.getElementsByTagName('html')[0].innerHTML
	if (data.indexOf('nowrap="nowrap"') == -1) {
		//positie & punten ophalen
		if (data.indexOf('<b>P</b>ositie:') != -1) {
			var pos = data.indexOf('<b>P</b>ositie:');
		...
		if (data.indexOf('<b>P</b>unten:') != -1) {
			var pos = data.indexOf('<b>P</b>unten:');
		...
		$.get('/information.php', function(b) {
			if (b.indexOf('Je hebt jouw kliklimiet bereikt.')==-1) {
				//wachttijd autojatpoging
				var cars_tot = 0;
				var cars_min = 0;
				var cars_sec = 0;
				...
				//geld
				if (b.indexOf('Op zak') != -1) {
					var pos = b.indexOf('Op zak');
				...
				//kogels
				if (b.indexOf('<b>Kogels</b>') != -1) {
					var pos = b.indexOf('<b>Kogels</b>');
					var pos1 = b.indexOf('<td>',pos)+4;
					var pos2 = b.indexOf('</td>',pos1);
				...
				//rv
				if (b.indexOf('Rangvordering') != -1) {
					var posbegin = b.indexOf('Rangvordering');
					var poseinde = b.indexOf('Leven');
				...
				//leven
				if (b.indexOf('Leven') != -1) {
					var posbegin = b.indexOf('Leven');
					var poseinde = b.indexOf('Uitbraakervaring');
				...
				//uitbraakervaring
				if (b.indexOf('Uitbraakervaring') != -1) {
					var posbegin = b.indexOf('Uitbraakervaring');
					var poseinde = b.indexOf('Racevorm');
				...
				//bodyguard info ophalen
				$.get('/BeO/webroot/index.php?module=Bodyguards', function(b) {
					if (b.indexOf('Je hebt jouw kliklimiet bereikt.')==-1) {
						if (b.indexOf('Je zit in de gevangenis')==-1){
							...
							//gevangenis bodyguards
							show(cars_tot,crime_tot,flight_tot,bullet_tot);
						}
					}
					else {
						//kliklimiet bodyguards
						show(cars_tot,crime_tot,flight_tot,bullet_tot);
					}
				});
			}
			else {
				//kliklimiet mijn acc page
				show(0,0,0,0);
			}
		});
	}
...
function show(cars_tot,crime_tot,flight_tot,bullet_tot) {
	...
	$("table:last").html(' \
		<table> \
			<tbody> \
				<tr> \
					<td align="left" class="name" valign="top" nowrap="nowrap"><b>P</b>ositie:</td> \
					<td nowrap="nowrap" align="right">'+GM_getValue(version+'positie','#10000+')+'</td> \
					<td nowrap="nowrap" align="left" class="name"><a href="./BeO/webroot/index.php?module=Crimes" target="main"><b>M</b>isdaad:</a></td> \
					<td nowrap="nowrap" align="right" id="crime" width="40">&nbsp;</td> \
					<td nowrap="nowrap" align="left" class="name"><b>R</b>angvordering:</td> \
				...
				<tr> \
					<td nowrap="nowrap" align="left" class="name"><b>P</b>unten:</td> \
					<td nowrap="nowrap" align="right">'+GM_getValue(version+'punten',"0")+'</td> \
					<td nowrap="nowrap" align="left" class="name"><a href="./BeO/webroot/index.php?module=Cars" target="main"><b>A</b>uto:</a></td> \
					<td nowrap="nowrap" align="right" id="car" width="40">&nbsp;</td> \
					<td nowrap="nowrap" align="left" class="name"><b>L</b>even:</td> \
				...
				<tr> \
					<td nowrap="nowrap" align="left" class="name"><b>G</b>eld:</td> \
					<td nowrap="nowrap" align="right"><a href="./bank.php" target="main">'+GM_getValue(version+'geld',"$0")+'</a></td> \
					<td nowrap="nowrap" align="left" class="name"><a href="./BeO/webroot/index.php?module=Travel" target="main"><b>V</b>lucht:</a></td> \
					<td nowrap="nowrap" align="right" id="flight" width="40">&nbsp;</td> \
					<td nowrap="nowrap" align="left" class="name"><b>U</b>itbreekervaring:</td> \
				...
				<tr> \
					<td nowrap="nowrap" align="left" class="name"><b>K</b>ogels:</td> \
					<td nowrap="nowrap" align="right">'+GM_getValue(version+'kogels',"0")+'</td> \
					<td nowrap="nowrap" align="left" class="name"><a href="./bullets2.php" target="main"><b>K</b>ogel Deal:</a></td> \
