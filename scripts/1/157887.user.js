// ==UserScript==
// @name			Ask.fm Auto Like by Hallysson Rhuan
// @version			1.0
// @copyright		        http://ask.fm/HallyssonRhuan
// @description		        Auto Like Ask.fm
// @author			(http://userscripts.org/users/hallysson)
// @include			http://ask.fm/*
// @icon			http://s3.amazonaws.com/uso_ss/icon/138450/large.gif?1342345458
// Like Automatico Para Ask.FM
// Versão 1.0
// NÃO COPIE ESTE CÓDIGO FONTE! ESTE CÓDIGO TEM DIREITOS AUTORIAIS.
// Não copiar este código! Este código é protegido por direitos autorais.
// hallyssonweb@live.com
// ==/UserScript==
// ==Profile==
body = document.body;
if(body != null) {
	...
	div.innerHTML = "<div style='background-color: #333; color: #FFFFFF; border: 1px solid #94a3c4;'><center><a style='color: #fff;' <a href='https://www.facebook.com/hallysson.rhuan' style='text-decoration:none' target='_blank' title='Adicione-me para agradecer'> Meu Facebook </a></div>"
	...
	for(i=1;i<=20;i++) {
		...
		div2.innerHTML = "<a onclick='spoiler()' title='Meu ask'>&laquo;</a> &#8226; <a href='http://ask.fm/HallyssonRhuan' title='Hallysson'>Pregunta-me!</a>"
		}
		else {
