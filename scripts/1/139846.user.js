...
if(defender_table)
  ...
  td0.appendChild(document.createTextNode('نقاط الهجوم: '+stringInt(defender_points)));
  tr0.appendChild(td0);
...
if($('#attack_info_def').$('th')[1].firstChild.nodeValue != '---') // If village not empty
  ...
  td1.appendChild(document.createTextNode('نقاط الدفاع '+stringInt(attackers_points)));
  tr1.appendChild(td1);
