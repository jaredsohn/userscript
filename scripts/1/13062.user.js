...
function evoOverview() {
	...
	landtable.rows[0].cells[1].innerHTML = "<center><div style=\"border: 1px solid rgb(201, 201, 201); float: top; width: 50px; height: 50px;\"><table style=\"background: ffffff; height: "+per+"%; width: 50px;\" cellpadding=\"0\" cellspacing=\"0\"><tbody><tr style=\"height : "+Math.round(per*0.5)+"px;\"><td></td></tr><tr>"+stMet+stMin+stFood+"</tr></tbody></table></div></center>"
	...
	if( table != null ) {
		...
		for(var i=2; i < table.rows.length; i++) {
			...
			if( matchr ) {
				...
				table.rows[i].cells[4].innerHTML = '<span style="color:lime"> Online now</span>';
			}
			...
			if( target < smin ) cell3.style.color = 'red';
			else if( target > tmax ) cell3.style.color ='black';
		...
		if( git != null ) {
			...
			d.className = "navyblue_bg_row2";
			d.innerHTML = '<td>Score colours:</td><td colspan="3" align="center">Players with <span style="color: red">this score</span> can attack you, but you can\'t attack them <img src="http://evolution.neondragon.net/ui/emoticons/sad.png" alt=":(" align="absmiddle" /><br />Players with <span style="color: lime">this score</span> can attack you, and you can also attack them <img src="http://evolution.neondragon.net/ui/emoticons/smile.png" alt=":)" align="absmiddle" /><br />Players with <span style="color: Black">this score</span> can\'t attack you, but you can attack them <img src="http://evolution.neondragon.net/ui/emoticons/cool.png" alt="B)" align="absmiddle" /></td>';
		}
	}
evoVTF();
evoUniverseNav();
...
function evoAmpRatio() {
	...
	scantable.rows[3].cells[2].innerHTML = scantable.rows[3].cells[2].innerHTML + '<br /><span style="text-size: 0.8em;color: red">' + ratio + '</span>';
}
...
function evoFleets() {
	...
	function updateFleetsAddRow(fleetsTable, isAttack) {
		...
		updateFleetsAddCell(row, 2, "blue_bg", getFleetScore(2, fleetsTable, isAttack));
...
function allPages() {
	...
	hDiv.style.backgroundColor = 'navyblue';
