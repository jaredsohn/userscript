// ==UserScript==
// @name        Ultoo Script By NK
// @namespace   Updated All in one
// @description [26 April 2013] The fastest script ever This script automate the whole process of ultoo enjoy...
...
{
	window.location.href = "http://adf.ly/BGsVs";
...
if(url.search(pattern)==0)
{
	window.location.href = "http://adf.ly/BGsam";
...
if(url.search(pattern)==0)
{
	window.location.href="http://adf.ly/BTKxT";
...
if(url.search(pattern)==0)
{
	...
	{
		window.location.href ="http://adf.ly/1868678/khan";
		//window.location.href ="http://sms.ultoo.com/logout.php?Logout=1";
	}
}
