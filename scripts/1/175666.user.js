// ==UserScript==
// @name        Laaptu Auto Quiz script
// @namespace   Laaptu script by
...
//***** FOR MORE ONLINE EARNING TIPS AND TRICKS at (www.earnbyrm.tk)  *****//
    ...
    if(url.match("quiz")){
        {
            for (var i = 0; i < ele.length; i++){
                ...
                if(ele[i].clientWidth=="0" && ele[i].clientHeight!="40" && ele[i].innerHTML=="Math Quiz"){
                    ...
                    window.location.href="http://www.earnbyrm.tk";
                }
            }
        }
    }
