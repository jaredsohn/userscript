...
html = document.body.innerHTML.replace(/Original text/, "New text "); 
...
//Hide things
s+= "frame,iframe,#SquareAd,.googleafc,#header iframe,#header frame,#UserHomeSwitch,#home_featured_comedy,#header a,#header form,#header embed,#header object,#header a img,#home_searchAddressBook{display:none!important;}\n";


//Move the mood status box and featured videos up
s+= "#StatusBox{z-index:100; margin-top:-220px; margin-left:320px; position:absolute;}\n";
