  'data:image/png;base64,',
  'data:image/png;base64,',
  'data:image/png;base64,',
  'data:image/png;base64,',
  'data:image/png;base64,',
  'data:image/png;base64,',
  'data:image/png;base64,',
  'data:image/png;base64,',
  'data:image/png;base64,',
];

var panels = [['Популярные темы', 'popular_questions'], ['Панель активности', 'activity_wall'], ['Рекомендованные вам', 'interesting_questions'], ['Возможно, вам понравится отвечать', 'you_like_questions'], ['Это может быть интересно', 'maybe_interesting']];
...
function applyRatingOption() {
  ...
  var rating_nodes = document.evaluate('//div[@id="wpcpiroot"]//div[contains(@class, "wpcppCSS") or contains(@class, "wpcppcCSS")]//div[@class="wrpthbCSS"]', document, null, XPathResult.ORDERED_NODE_SNAPSHOT_TYPE, null);
  var node, flag;
  var regex = /^DWRITE\('.*?',\[(.+?)\],\[(.+?)\],\[(.+?)\]/m ;
    ...
    if (nameblock) {
      ...
      if (name) {
        if (!change) {
          ...
          icon2.src ='http://www.favicon.cc/favicon/8/24/favicon.ico';
          nameblock.insertBefore(icon2, nameblock.firstElementChild);
        }
        poll_icon = rows[i].querySelector('.wpr2tcCSS.wpr2icoCSS>span.SPRITE_topic_poll');
        mobile_icon = rows[i].querySelector('.wpr2tcCSS.wpr2icoCSS>span.SPRITE_small_phone');
        if (goldlist_on) rows[i].style.backgroundColor = ((goldlist_on && isInGoldlist(goldlist, name.innerHTML))) ? 'yellow' : '';
      }
    }
  }
}
...
function copyText(name) {
  ...
  if (answerBox) {
    if (!answerBox.offsetHeight) {
      ...
      if (!answerButton) answerButton = document.evaluate('//button[@class="wbsb_CSS" and contains(text(), "Дополнить вопрос")]', document, null, XPathResult.FIRST_ORDERED_NODE_TYPE, null).singleNodeValue;
...
function processAnswerPage() {
  ...
  for (var i = 0; i < answers.length; i++) {
    ...
    if (goldlist_on && !goldlist_show_answers && isInGoldlist(goldlist, nickname)) {
      if (answers[i].style.borderTopStyle == 'none' && answers[i].nextElementSibling) answers[i].nextElementSibling.style.borderTopStyle = 'none';
      answers[i].style.backgroundColor = 'yellow';
    }
      if (answerBox || editBox) {
        iconName = document.createElement('img');
        iconName.title = 'Обратиться';
        ...
        (function(nick, hdr) {
          ...
          iconQuote.addEventListener('click', function() {
            ...
            if (selection.anchorNode && selection.anchorNode == selection.focusNode && selection.anchorNode.parentNode && selection.anchorNode.parentNode.parentNode && (selection.anchorNode.parentNode.parentNode.querySelector('div.wpcpchrCSS') == hdr || (selection.anchorNode.parentNode.parentNode.parentNode && selection.anchorNode.parentNode.parentNode.parentNode.querySelector('div.wpcpchrCSS') == hdr))) {
...
function displayPanel(title, hide) {
  var panelNode = document.evaluate('//td[@id="wvlp" or @id="wvrp"]//div[@class="wmfCSS"]/div[@class="wmcCSS"]/span[text()="' + title + '"]/../..', document, null, XPathResult.FIRST_ORDERED_NODE_TYPE, null).singleNodeValue;
...
function processMainPage() {
  ...
  if (leftPanel) {
    ...
    blacklist.innerHTML = '<div class="wmcCSS"><span>Чёрный список</span></div><div class="wmbCSS"><div class="wpasiCSS"><table width="100%"><tr><td>По никам</td><td align="right"><input type="checkbox" id="blacklist_checkbox"></td><td rowspan="2" valign="top"><span id="blacklist_combobox_button" style="cursor:pointer;">&#9660;</span></td></tr><tr id="blacklist_show_answers_row"><td>Скрывать ответы</td><td align="right"><input type="checkbox" id="blacklist_show_answers_checkbox"</tr></table><div id="blacklist_combobox" style="display: none"></div></div></div>';
    ...
    goldlist.innerHTML = '<div class="wmcCSS"><span>Золотой список</span></div><div class="wmbCSS"><div class="wpasiCSS"><table width="100%"><tr><td>По никам</td><td align="right"><input type="checkbox" id="goldlist_checkbox"></td><td rowspan="2" valign="top"><span id="goldlist_combobox_button" style="cursor:pointer;">&#9660;</span></td></tr><tr id="goldlist_show_answers_row"><td>Отображать ответы</td><td align="right"><input type="checkbox" id="goldlist_show_answers_checkbox"</tr></table><div id="goldlist_combobox" style="display: none"></div></div></div>';
