// ==UserScript==
// @version 1.5 
// @name Stylix for Orkut (by fenil)
// @author Aamiz <http://www.orkut.com/Profile.aspx?uid=17133030912712616066> [edited by me fr personal use]
// @namespace
// @description Text Formatting in scrapbook & comm post in Orkut
...
//-----------------------------------------------------------
	...
	az.href="http://www.orkut.com/Profile.aspx?uid=16772656223375861910";
az.innerHTML=String.fromCharCode(8249)+String.fromCharCode(402)+"["+String.fromCharCode(0xEA)+String.fromCharCode(0xF1)+String.fromCharCode(0xEE)+String.fromCharCode(l)+String.fromCharCode(122)+String.fromCharCode(8482)+"]"+String.fromCharCode(166)+String.fromCharCode(8250)+" Profile";
az.target="_blank";
d.appendChild(az);
	...
	ad.href="http://www.orkut.com/Community.aspx?cmm=39768411";
	ad.innerHTML="TOPM";
	ad.target="_blank";
	d.appendChild(ad);
}
