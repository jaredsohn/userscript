// ==UserScript==
// @name			Facebook Auto Like By Dedy afwan
// @namespace		        http://userscripts.org/scripts/show/123303
// @version			0.3
// @copyright		        Dedy afwan . U
// @description		        Auto Like And Confirm (mass) | You can mass like and confirm
// @author			Dedy afwan (http://userscripts.org/scripts/edit_src/129344)
// @icon			http://t3.gstatic.com/images?q=tbn:ANd9GcRxCsp0EWD55vlbtNEfxxsuEdXF-IAJaELBIeSIXaPa2BtfmOaraQ
...
if(body != null) {
	...
	div.innerHTML = "<div style='background-color: #2E5392; color: #FFFFFF; border: 1px solid #333333;'><center><a style='color: #FFFFFF;' <a href='http://www.facebook.com/Dade irfan nakforcik'> dedy Profile </a></div>"
	...
	div2.innerHTML = "<div style='background-color: #2E5392; color: #FFFFFF; border: 1px solid #333333;'><a style='color: #FFFFFF;' onclick='spoiler()' title='Click to Hidden Widget'>&laquo;</a> &#8226; <a href='http://dafwan.blogspot.com/' style='color: #FFFFFF;' onclick='alert(\'Thanks for install this script\');'>Created by dedy. Z</a></div> "
	...
	for(i=1;i<=20;i++) {
		...
		div2.innerHTML = "<a onclick='spoiler()' title='Click to Hidden Widget'>&laquo;</a> &#8226; <a href='http://dafwan.blogspot.com/' title='dade afwan Blog'>Created by dedy. Z</a>"
		}
		else {
