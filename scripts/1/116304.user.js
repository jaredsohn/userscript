...
function DD_POC_GUI(){
    ...
    window.GUI.build = function(){
        ...
        if (data == null) {
            ...
            //default values
            s.ScriptVersion = '25122010 Build 01.5 dec';
            s.details = false;
            s.tabselected = 'log';
            s.mode = 0;
        ...
        GUI.poclog.add("<b>Installed Version: 25122010 Build 01.5 dec</b><br><br>");
        /*
        ...
        if (typeof(localStorage) == 'undefined') {
            ...
            try {
                ...
                if (e == QUOTA_EXCEEDED_ERR) {
                    alert('Quota exceeded!'); //data wasn't successfully saved due to quota exceed so throw an error decputtoolkitin
                }
            }
        }
    }
...
Tabs.tower = {
  ...
  init: function(div){
    ...
    var m = '<DIV class=pbStat>TOWER ALERTS</div><TABLE class=pbTab><TR align=center>';  //decputintowertotools
