// ==UserScript==
// @name        CTRL+W Nova by Korhian
// @namespace   Mush
// @include     http://mush.vg/*
// @include     http://mush.twinoid.com/*
// @include     http://mush.twinoid.es/*
// @downloadURL http://userscripts.org:8080/scripts/source/184928.user.js
...
Main.k.displayMainMenu = function() {
    ...
    var casting_ss = $("<ul>").attr("id", "castingmenu").appendTo(casting);
    $("<a class='kssmenuel' href='"+Main.k.mushurl+"/g/team-nova-raider/center'><li><img src='/img/icons/skills/radio_expert.png' /> Studio </li></a>").appendTo(casting_ss);
    $("<a class='kssmenuel' href='"+Main.k.mushurl+"/g/team-nova-raider/page'><li><img src='/img/icons/skills/rebel.png' /> Mémoire </li></a>").appendTo(casting_ss);
    $("<a class='kssmenuel' href='"+Main.k.mushurl+"/g/team-nova-raider/nexus'><li><img src='/img/icons/skills/rebel.png' /> Nexus </li></a>").appendTo(casting_ss);
    $("<a class='kssmenuel' href='"+Main.k.mushurl+"/g/team-nova-raider/forum'><li><img src='/img/icons/skills/radio_expert.png' /> Forum </li></a>").appendTo(casting_ss);
    $("<a class='kssmenuel' href='"+Main.k.mushurl+"/g/team-nova-raider/members'><li><img src='/img/icons/skills/opportunist.png' /> Membres </li></a>").appendTo(casting_ss);
...
var fond = "http://img15.hostingpics.net/pics/806805space.jpg"  ; 
...
text-align: center;\
	...
	.mxhead a.logo4 { \
background: transparent url('http://img15.hostingpics.net/pics/24406959V2.png') no-repeat center top !important; \
...
.kmenu{ margin: 60px auto 20px !important;}\
...
Main.k.tabs.playing = function() {
	...
	Main.k.About.open = function() {//TODO: MULTILANG
		...
		if (!Main.k.About.initialized) {
            ...
            "Traducteurs : <a href='http://twinoid.com/user/7845671'>Avistew</a><br/>"+
			"Adapté pour le Casting Nova par <a href='http://twinoid.com/user/5140898'>Fraise</a> et maintenu par <a href='http://twinoid.com/user/4877343'>Korhian</a>")).appendTo(td);
