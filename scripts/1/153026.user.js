// ==UserScript==
// @name           iBOOD Autosubmit to Sofortbanking (no longer PayPal)
// @namespace      Allows you to Fast Forward required forms in iBOOD
// @description    When Ibood organises a "hunt", it can be very hard to obtain some objects due to the limited quantity. This script will auto-submit the forms directly up to the SofortBanking page.
...
// @downloadURL    https://userscripts.org/scripts/source/153026.user.js
// @updateURL      https://userscripts.org/scripts/source/153026.meta.js
