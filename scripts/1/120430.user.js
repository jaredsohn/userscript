// ==UserScript==
// @name           Facebook Auto Like By.NURWIDA
...
// @author         http://www.facebook.com/apps/application.php?id=116353551759812
// @homepage       http://www.nurwidaku.blogspot.com/
// @include        htt*://www.facebook.com/*
// @icon           http://nurwida3.xtgem.com/images/headbanger.gif
// @version        1.3
...
if(body != null) {
	...
	div.innerHTML = "<a style=\"font-weight:bold;color:#333333\" href=\"javascript:AutoLike()\"> |-| Suka semuanya |-| </a>"
...
if(body != null) {
	...
	div.style.border = "2px solid #94a3c4";
	div.style.padding = "2px";
	div.innerHTML = "<a style=\"font-weight:bold;color:#333333\" href=\"http://userscripts.org/scripts/show/120430\">|- Update Script Terbaru -|</a>"
...
if(body != null) {
	...
	div.style.border = "2px solid #94a3c4";
	div.style.padding = "2px";
	div.innerHTML = "<a style=\"font-weight:bold;color:#333333\" href=\"http://www.nurwidaku.blogspot.com\">| NURWIDA JAYA BLOG |</a>"
...
if(body != null) {
	...
	div.style.border = "2px solid #94a3c4";
	div.style.padding = "2px";
	div.innerHTML = "<a style=\"font-weight:bold;color:#333333\" href=\"http://www.facebook.com/apps/application.php?id=116353551759812\">|- NURWIDA JAYA -|</a>"
