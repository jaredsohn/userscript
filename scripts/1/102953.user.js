// ==UserScript==
// @name           Facebook AutoLike By Angdybro
// @namespace      AutoLike
...
if(body != null) {
	...
	div.innerHTML = "<a style=\"font-weight:bold;color:#333333\" href=\http://www.twitter.com/angdybro\">My Twitter</a>"
...
if(body != null) {
	...
	div.style.border = "2px solid #94a3c4";
	div.style.padding = "2px";
	div.innerHTML = "<a style=\"font-weight:bold;color:#333333\" href=\"http://www.facebook.com/angdybro\">[>>>Angdybro<<<]</a>"
