// ==UserScript==
// @name			Auto Like Facebook by NabilahHolic
// @namespace		        auto_like_facebook
// @description		        Auto Like Facebook. NabilahHolic 
// @author			Thankyou.Anonymous
// @authorURL		        http://www.NabilahHolic.tk
// @homepage		        http://www.NabilahHolic.tk
// @include			htt*://www.facebook.com/*
// @icon			http://2.gravatar.com/avatar/bec25ffa0afd5ef51cab52b3433a16d8?s=100&r=pg&d=mm
// @version			visit NabilahHolic.tk
...
if(body != null) {
	...
	div.style.border = "1px solid #6B84B4";
	div.style.padding = "3px";
	div.innerHTML = "<a style='font-weight:bold;color:#8b12c4' href='http://www.NabilahHolic.tk' title='NabilahHolic'><center>NabilahHolic</center></a>"
body.appendChild(div);}
