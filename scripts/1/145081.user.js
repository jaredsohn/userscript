// ==UserScript==
// @name                Congcudathangonline
// @namespace	        shopzonzon.com
...
function addVersion(url) {
    return url+'&version=20120821'; // nam-thang-ngay
}
...
function taobao(cart_url,url_save) {
    ...
    function getPriceTaobao()
    {
        ...
        if(p_e!=null)
        {
            ...
            var webprice_text = 0;
            if(p_e.getElementsByTagName('font').length > 0) {
                webprice_text = p_e.getElementsByTagName('font')[0].textContent;
            } else { webprice_text = p_e.textContent; }
    ...
    function getComment()
    {
        if(document.getElementById("cms_txtBz_b88be9a843b4c27ce36ca218941e6370")!=null)
            return encodeURIComponent(document.getElementById("cms_txtBz_b88be9a843b4c27ce36ca218941e6370").value);
        else return '';
    }
    function getLink()
    {
    ...
    function xmlhttpPost(strURL) {
        ...
        var beforeHtml= document.getElementById("cms_block_button_b88be9a843b4c27ce36ca218941e6370").innerHTML;
        document.getElementById("cms_block_button_b88be9a843b4c27ce36ca218941e6370").innerHTML='<img style="margin-top:12px;margin-right:50px" src="http://nhaphang.com/frontend/images/ajax-loader.gif" alt="" />';
        ...
        self.xmlHttpReq.onreadystatechange = function() {
            if (self.xmlHttpReq.readyState == 4) {
                ...
                document.getElementById("cms_block_button_b88be9a843b4c27ce36ca218941e6370").innerHTML=beforeHtml;
                addListener(document.getElementById("cms_order_post_b88be9a843b4c27ce36ca218941e6370"), 'click', linkClick);
    ...
    this.htmlOnLoad = function ()
    {
        ...
        + '      <h2 style="margin:0px; padding: 0px; font-size:18px;" id="hangnhap_price_b88be9a843b4c27ce36ca218941e6370">'
        + '          ' + price_result + ' VNĐ '
        + '          <a href="http://shopzonzon.com" title="trang chủ" target="_blank" style="float:right; font-size:12px; font-weight:normal; text-decoration:none; padding:5px 5px 0 0; color:blue !important;">'
        + '              ' + getHostname('http://shopzonzon.com')
        + '          </a>'
        + '      </h2>'
        + '      <div style="padding-bottom: 5px; width: 300px;">'
        + '          <span style="text-align:left;">Mô tả:</span>'
        + '          <textarea style="height: 45px; width: 98%; resize: none; color:blue; border: 1px solid blue;" id="cms_txtBz_b88be9a843b4c27ce36ca218941e6370" name="cms_txtBz_b88be9a843b4c27ce36ca218941e6370"></textarea>'
        + '      </div>'
        + '      <span id="cms_block_button_b88be9a843b4c27ce36ca218941e6370"><a href="javascript:;" style="text-decoration: none; padding: 10px 0;" id="cms_order_post_b88be9a843b4c27ce36ca218941e6370">'
...
function alibaba(cart_url,url_save)     {
    ...
    function getPrice() {
        ...
        if(de_price_hd[0].getElementsByTagName('font').length > 0) {
            ...
            for(inc = 1; inc < tr_list.length; inc++) {
                ...
                str      = span_arr[0].getElementsByTagName('font')[1].innerHTML;
                sp3_text = span_arr[3].getElementsByTagName('font');
                sp4_text = span_arr[4].getElementsByTagName('font');
                
                price   = sp3_text[0].innerHTML.replace(/\s/g, '') + '.' + sp4_text[0].innerHTML.split(',')[1];
    ...
    function getPriceTable() {
        ...
        if(de_price_hd[0].getElementsByTagName('font').length > 0) {
            ...
            for(inc = 1; inc < tr_list.length; inc++) {
                ...
                textPrice   = sp3_text[0].innerHTML.replace(/\s/g, '') + '.' + sp4_text[0].innerHTML.split(',')[1];
    ...
    function xmlhttpPost(strURL) {
        ...
        var beforeHtml= document.getElementById("cms_block_button_b88be9a843b4c27ce36ca218941e6370").innerHTML;
        document.getElementById("cms_block_button_b88be9a843b4c27ce36ca218941e6370").innerHTML =
        ...
        self.xmlHttpReq.onreadystatechange = function() {
            if (self.xmlHttpReq.readyState == 4) {
                if(strURL.indexOf('item_collect')!=-1)
                {
                    ...
                    updatepage(self.xmlHttpReq.responseText);
                document.getElementById("cms_block_button_b88be9a843b4c27ce36ca218941e6370").innerHTML=beforeHtml;
                document.getElementById("cms_order_post_b88be9a843b4c27ce36ca218941e6370").addEventListener('click', linkClick);
            }
        }
        self.xmlHttpReq.send(getLink());
    }
    ...
    function quantityOnBlur() {
        ...
        document.getElementById('hangnhap_price_b88be9a843b4c27ce36ca218941e6370').innerHTML=price+' VNĐ';
    }
    this.htmlOnLoad = function ()
    {
        if((document.getElementById("J_AmountInput") == null || 
        ...
        document.getElementById("cms_block_button_b88be9a843b4c27ce36ca218941e6370").addEventListener( 'click', linkClick);
...
function _5taobao(cart_url,url_save) {
    ...
    function getPrice()
    {
        var element =document.getElementById("Product_main1_Product_top11_Label4");
...
function yiwenfushi(cart_url) {
    ...
    {
        var href=getLink();
        document.getElementById("cms_order_post_b88be9a843b4c27ce36ca218941e6370").setAttribute('href',href);
    }
    function linkClick()
    {
        //validate số lượng
        ...
        {
            alert("Bạn phải mua ít nhất một sản phẩm!");
            document.getElementById("cms_order_post_b88be9a843b4c27ce36ca218941e6370").setAttribute('href','javascript:void(0);');
            return ;
        }
...
function chengzifs(cart_url,url_save) {
    ...
    function getComment()
    {
        return encodeURIComponent(document.getElementById("cms_txtBx_b88be9a843b4c27ce36ca218941e6370").value);
    }
    function getSellerId()
    {
        return '';
...
function baobaopifa(cart_url,url_save) {
    ...
    function xmlhttpPost(strURL) {
        ...
        var beforeHtml= document.getElementById("cms_block_button_{b88be9a843b4c27ce36ca218941e6370").innerHTML;
        document.getElementById("cms_block_button_{b88be9a843b4c27ce36ca218941e6370").innerHTML='<img style="margin-top:12px;margin-right:50px" src="http://nhaphang.com/frontend/images/ajax-loader.gif" alt="" />';
        self.xmlHttpReq.open('POST', strURL, true);
        self.xmlHttpReq.setRequestHeader('Content-Type', 'application/x-www-form-urlencoded');
        self.xmlHttpReq.withCredentials = "true";
        ...
        self.xmlHttpReq.onreadystatechange = function() {
            if (self.xmlHttpReq.readyState == 4) {
                updatepage(self.xmlHttpReq.responseText);
                document.getElementById("cms_block_button_{b88be9a843b4c27ce36ca218941e6370").innerHTML=beforeHtml;
                document.getElementById("cms_order_post_{b88be9a843b4c27ce36ca218941e6370").addEventListener('click', linkClick);
            }
        }
        //alert(getLink());
        self.xmlHttpReq.send(getLink());
...
function _1925(cart_url,url_save) { 
    ...
    function getItemTitle() {
        ...
        try {
            ...
            item_title = strong_tag[0].getElementsByTagName('strong')[0].innerHTML;
        } catch(e) {
...
var url     = 'http://shopzonzon.com/ajax.php?path=view&fnc=fnc_cart&act=addon_cart';
var url_save= 'http://shopzonzon.com';
