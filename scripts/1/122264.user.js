// ==UserScript==
			   // @name           rajeshwer
			   // @namespace      harish choudhary
			   // @description    harish power for Plan My Travel.
  ...
  function heading()
	...
	cell.style.fontWeight='Bold';
		var cellText = document.createTextNode('RED-KING(NATVAR)');
...
var cell = document.createElement('td');
	...
	var cellText = document.createTextNode('SUBMIT AT 08:00:01');
	cell.appendChild(cellText);
	row.appendChild(cell);
if(row1!=''){
...
var tbl     = document.createElement('table');
	...
	cell.setAttribute('align', 'center');
	cell.style.color='white';
	var cellText = document.createTextNode('AUTO SUBMIT AT 7:59:55');
	cell.appendChild(cellText);
	row.appendChild(cell);
	tblBody.appendChild(row);
