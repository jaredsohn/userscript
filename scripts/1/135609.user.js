...
// @namespace      ikariam
// @version        0.2.8
// @downloadURL    https://userscripts.org/scripts/source/135609.user.js
// @updateURL      https://userscripts.org/scripts/source/135609.meta.js
//
...
var Emotiworld = new function() {
	...
	this.languageData = {
		'en':{
			...
			CRUndoTitle:'Emotiworld has found a combat report. Click here to revert to basic message.'
                ...
                'lv':{
			manage:'Pārvaldīt savus smaidiņus',
			add:'Pievienot',
			findIcons:'Atrast jaunus smaidiņus [link]',
			close:'Aizvērt',
			replyToAll:'Atbildēt visiem',
			CRUndoTitle:'Emotiworld ir atradis kaujas atskaiti. Klikšķiniet šeit, lai atgrieztos uz pamata ziņu.'
		},
		'fr':{
	...
	this.postInit = function() {
		...
		$('#emotiworldAdd').click(function() {
			var icon = prompt("Ievadiet smaidiņu, lai pievienotu to sarakstam:");
			Emotiworld.add(icon);
		});
...
$(function() {
	...
	if(!Emotiworld.icons)
		Emotiworld.icons = ['ツ', '(●‿●)', '(˘◡˘)', '◤(¬‿¬)◥', '(´ᗣ｀)', '(º_•)', '⊙_⊙', '(╯°□°）╯︵ ┻━┻', '=^..^=', '웃'];
