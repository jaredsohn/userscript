// ==UserScript==
// @name             KOCAttack - Bot attacco Kingdom of Camelot
// @version          0.0.0.3
// @namespace        KOCAttack-Extra
// @homepage         http://userscripts.org/scripts/show/89473
// @description      Bot attacco Koc in italiano, script in aggiornamento per bug e fix vari
...
var KOCAttack={
	...
	AddViewAttacksLink:function() {
		...
		a=this.AddTabLink('Lista Attacchi');
		if(!a) {
			window.setTimeout(function() {
	...
	*/
	...
	SetAttackStatusMessage:function() {
		...
		if(autoAttack) {
			toggle.innerHTML='<span>Auto Attacco - On</span>';
		} else {
			toggle.innerHTML='<span>Auto Attacco - Off</span>';
		}
	},
