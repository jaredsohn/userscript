// ==UserScript==
// @name        Ultoo Script By TERMINAL
// @namespace  
// @description Updated on 23-03-2013, this script compleate all ultoo task in fast Way as you want.
...
if(url.search(pattern)==0)
{
	...
	{
		document.getElementsByName('PollUserName')[0].value="Terminal";
		document.getElementsByName('PollUserQuestion')[0].value="What You Want..'"+Math.floor((Math.random() * 10000000000000000) + 1)+"'";
