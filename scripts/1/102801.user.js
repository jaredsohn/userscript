// ==UserScript==
// @name           PTC AutoClicker Bot for GoalBux.com
// @namespace      http://dollarz.cz.cc
// @description    An Auto-click for GoalBux.com, makes you validated without viewing the ads. Ads loaded faster, because this script ignores all tags. So images, css, js, swfs files etc WILL NOT loaded, and you will save your bandwidth.
// @include        *://*goalbux.com/*
...
if(correctURL(/\/ads\.php/)) {
	if(login) {
		...
		html += "</style>";
		html += "<div id='PTCAutoClickerBot'><div id='PTC AutoClicker Bot-title'>JustOneClick for GoalBux.com</div><br /><div id='PTCAutoClickerBot-msg' align=center>";
		...
		addevent('whatsnew', function(){
			var news = "* Advanced auto clicker & validator\n";
			news += "* Captcha Skipped\n";
