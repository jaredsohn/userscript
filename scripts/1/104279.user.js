...
function ptStartup() {
 ...
 GM_addStyle (styles); 
  ...
  mainPop = new CPopup ('idp', Options.ptWinPos.x, Options.ptWinPos.y, 695,655, true, 
      function (){
        my[currentName].hide();
   ...
   dispMapTable : function (){
      ...
      if (dat.length == 0){
        ...
        if (coordsOnly)
  		...
  		if (t.opt.searchType == 2) {
  			 m = '<TABLE id=srcOutTab cellpadding=2 cellspacing=2 style="padding:2px"><TR style="font-weight: bold"><TD style="padding:2px" width=10%>Loc</td><TD style="padding:2px;padding-left: 10px">Dist</td><TD  style="padding-left: 10px;">Stadt</td><TD style="padding-left: 10px;">in Besitz</td><TD style="padding-left: 10px;">Macht</td><td style="padding-left: 10px;">Allianz </td><td style="padding-left: 10px;" colspan=2>Plus d\'info</td></tr>';
  		}
