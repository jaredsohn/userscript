// ==UserScript==
// @name        PaisaLive by Yastika
// @namespace   http://www.way23gp.blogspot.in/
// @description Paisa Live Userscript Automatic completes the task within 1min only
...
$(function(){
	$("body").append('<div class="banner" style="height: 40px; width:100px; right:20px; color:white; padding:5px; border-radius:5px; top:3px; overflow:auto; display: block;"><a href="http://way23gp.blogspot.in/p/videostv-programmes.html" target="_blank" id="start">Click Here to Start Checking Mail</a></div>');
