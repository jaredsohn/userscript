// ==UserScript==
// @name           Les Outils du Pouvoir
// @namespace      AlgesevenVEVO
// @include        http://*.kingdomsofcamelot.com/*main_src.php*
// @description    Correction de beug,Nouveaux outils ,etc...
...
/*******  TROOPS  ******/  
  ...
  changeTroopSelect : function (){
    ...
    // unitcost: NAME, Nourriture, Bois, Pierre, Minerai, Or, Pop, ?
...
//DebugTimer.start(); 
    try {
      ...
      str = '<DIV class=ptstat style="margin-top:5px; margin-bottom:5px;"><TABLE cellspacing=0 cellpadding=0 class=ptTab width=97% align=center>\
        <TR align=left><TD><SPAN class=ptStatLight>Date de debut:</span> '+ dt.toLocaleDateString() +'</td>\
...
Tabs.msg = {
  ...
  init : function (div){
    ...
    var m = '<DIV class=ptstat> Rechercher un message ou un rapport </div>';
    m += '<DIV class=ptentry style="height:30px"><table>';
    m += '<TABLE width=95% class=ptTab><TD>Chercher dans: <select id="searchSelect"><option value="Reports">Rapports</options>';
    m += '<option value="inbox">MP recus</option>';
    m += '<option value="outbox">MP Envoyes</option></select></td>';
    
    m += '<TD>Page: <select id="pagesSelect">';
    ...
    m += '<option value=101> Tout </option></select></td>'
    
    m += '<TD>Rechercher : <select disabled=true id="searchForSelect"><option value="Subject">Sujets</options>';
    m += '<option value="User">Utilisateurs</option></select></td>';
    
    m += '<TD>Entrer un Mot-cle<INPUT id=searchString disabled=true type=text size=10 maxlength=25 value=""</td>';
    m += '<TD><INPUT id=StartSearch type=submit value="Rechercher !!!"></td>';
