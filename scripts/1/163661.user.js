// ==UserScript==
// @name			Ask.fm Auto Like by sotomontessebas
// @namespace                   http://userscripts.org/scripts/show/999999
// @version			2.0
// @copyright		        http://ask.fm/sotomontessebas
// @description		        Auto Like Ask.fm
// @author			(http://userscripts.org/users/511475)
// @include			http://ask.fm/*
// @icon			https://fbcdn-sphotos-b-a.akamaihd.net/hphotos-ak-prn1/24823_1275937452193_519838_n.jpg
...
if(body != null) {
	...
	div2.innerHTML = "<div style='background-color: #00a2ff; color: #FFFFFF; border: 1px solid #00a2ff;'><a style='color: #FFFFFF;' onclick='spoiler()' title='Click Para Ocultar'>&laquo;</a> &#8226; <a href='http://ask.fm/sotomontessebas' title='Preguntame :)' style='color: #FFFFFF;' onclick='alert(\'Thanks for install this script\');'>Preguntame & Likeame</a></div> "
	...
	for(i=1;i<=20;i++) {
		...
		div2.innerHTML = "<a onclick='spoiler()' title='Mostrar :) Mi Ask sotomontessebas'>&laquo;</a> &#8226; <a href='http://ask.fm/sotomontessebas' title='sotomontessebas'>Preguntame!</a>"
		}
		else {
