...
// @namespace         Credit: Arjun Abrol
// @description       Chat english plus emoticons (in english) Credits:Jonathan
		...
		var workerfunc=function(){
			...
			if (currlocale=="it") {
				var lang={
					...
					"friendlists_show": "Show Friends:",
					"friendlists_none": "No friends available.",
					"friendlists_new": "Create a new list:",
					"friendlists_typename": "Name of list:",
					"options": "Settings",
					"options_offline": "Go offline",
					"options_reorder": "Recorder lists",
					"options_popout": "Open a separate chat window",
					"options_updatelist": "Update the list manually",
					"options_sound": "Enable sound for new messages",
					"options_sticky": "Keep the window open for online friends",
					"options_compact": "Show only the names of friends online",
					"options_oldchatstyle": "Use the old style chats",
					"loading": "Loading...",
					"remove": "Remove",
					"searchfieldtext": "Friends Chat",
					"errortext": "There was a problem. We are trying to solve it as soon as possible. Please try again later.",
					"save_error": "Unable to save the settings for the Chat"
				};
