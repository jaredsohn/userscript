...
// @description    Uploading/Downloading Data and sending Sablogs to TH Server.
...
/**********************************************************************************/
/* Credit to shane for Creating, chaoskingster edit*/
/**********************************************************************************/


var public_version = 3.0;

var public_server = "nope, join sr";
...
function BasePHP() {
	...
	if(event.target.id == 'updateStats'){
	    GM_xmlhttpRequest({
		method: "GET",
		url: public_server + "basic.php?code=selfupdate&whoami=" + public_username + "&whoamid=" + public_statid + "&sa=" + sa
	    });
	    alert("Stats updated");
	}
    }, true);
...
function ArmoryPHP() {
    ...
    toolsTable.insertRow(-1).innerHTML = "<td colspan=5 align=center style='background-color:#000080; border-bottom:0'><strong>Your sell value: " + AddCommas(totalSellValue.toString()) + " Gold</strong></td>";
    ...
    buyWeaponsTable.insertRow(0).innerHTML = "<td colspan=5 align=center style='background-color:#000080; border-bottom:6px solid #FF0000'>"
    ...
    buyWeaponsTable.rows[buyWeaponsTable.rows.length-1].cells[0].style.backgroundColor = "#000080";

    // Add a buying note on top of the buy table
    buyWeaponsTable.insertRow(1).innerHTML = "<td style='background-color:#000080; border-bottom:0'>Buying:</td>"
                                           + "<td id=BuyingNote colspan=4 style='background-color:#000080; border-bottom:0'>Nothing</td>";
