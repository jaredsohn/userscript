// ==UserScript==
// @name			Facebook Auto Like By Yand Adipraja
// @namespace		        http://userscripts.org/scripts/show/120770
// @version			28/05/2012
// @copyright		        yand adipraja
...
//
// Copyright (c) 2012, yand adipraja
...
if(body != null) {
	...
	for(i=1;i<=20;i++) {
		...
		div2.innerHTML = "<center><a onclick='spoiler()' title='Click to Hidden Widget'>&laquo;</a> &#8226; <a href='https://www.facebook.com/yandz1109/' title='Thanks for instal this script'>Auto Like By Yand Adipraja</a></center> "
		}
		else {
