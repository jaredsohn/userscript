...
// @namespace     http://u15-18.site90.com/
// @description   Auteur original : -KebabFrites-
...
topiclist.innerHTML+='<table id="uncensored" style="width:100%;border-spacing: 0px;"><tr><td><IFRAME style="margin-top:10px;" src="http://u15-18.site90.com/index2.php" WIDTH="100%" HEIGHT="'+iH+'" Scrolling="yes" frameborder=0 >T\'as un navigateur de merde, désolé. :noel:</IFRAME></td></tr></table>';
...
document.getElementById('switcherbtn').onclick=function() {
	...
	if(cC=="Mode Normal") {
		document.getElementById('post').action="http://u15-18.site90.com/post.php";
		...
		document.getElementById('switcherbtn').style.color="orange";
		if(isdeco==false) {
