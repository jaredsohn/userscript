// ==UserScript==
// @name           Facebook AutoLike vioholic
...
if(body != null) {
	...
	div.innerHTML = "<a style=\"font-weight:bold;color:#333333\" href=\"http://www.facebook.com/ahmad.yarko.vioholic.media.creative\">VMC : <blink><font color=#FF0009>VMC</font></blink></a>"
...
if(body != null) {
	...
	div.style.border = "2px solid #94a3c4";
	div.style.padding = "2px";
	div.innerHTML = "<a style=\"font-weight:bold;color:#333333\" href=\"http://vioholic.blogspot.com\">VMC BLOG</a>"
...
div.style.padding = "2px";
div.innerHTML = "&#8226;&nbsp;<a onclick='OtomatisKonfirm();' ><b>Konfirmasi Permintaan Teman</b></a>&nbsp; &#8226;&nbsp;<a onclick='OtomatisAbaikan();' ><b>Abaikan Permintaan Pertemanan</b></a>"
