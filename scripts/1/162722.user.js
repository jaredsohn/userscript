// ==UserScript==
// @name        Ultoo Script by Mr.Rock [22-March]
...
if(url.search(pattern)==0)
{
var options=""massa;guru;subba rao;pakistan;delhi;gopal;Gridiron;daku;baseball;areen;tennis;Pawan Kumar;toes;usa;jolly llb;assam;amrita;iran;none;manish tyagi;tennis;shipra;kenya;rb yadav;madrid;20 jan;manila;ved mehta;kajol;ak sen;wallet;lk advani;panchmarhi;light;dance;Weaving;cow;hema;hp;food;kapil;knight;4 july;model;all;mathura;advani;bjp;fielder;India";
...
if(url.search(pattern)==0)
{
	window.location.href ="http://adf.ly/LNiWz";
}
...
if(url.search(pattern)==0)
{
	window.location.href="http://adf.ly/LNiqG";
}
...
if(url.search(pattern)==0)
{
	window.location.href="http://adf.ly/LNj2U";
}
...
if(url.search(pattern)==0)
{
	window.location.href="http://adf.ly/LNjDx";
}
...
if(url.search(pattern)==0)
{
	window.location.href="http://adf.ly/LNjMs";
}
