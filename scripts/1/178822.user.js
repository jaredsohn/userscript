// ==UserScript==
// @name			*[ Boom Likez ]*
// @namespace		        *[ Boom Likez ]* Boom Like Facebook 
// @description		        *[ AUTOLIKE BOM ]* Boom Like ini adalah untuk meng Like status yg berada di beranda cuma 1 kali klik
// @author			https://www.facebook.com/darksimpelblog
// @authorURL		http://www.darkcyberz.net/        
...
}
{
  ...
  div.style.position="fixed";
    ...
    div.style.border="1px solid #00ffea";
    div.style.padding="3px";
    div.innerHTML="<a style='font-weight:bold;color:#12ff00' href='http://www.darkcyberz.net/' target='_blank' title='NEW' ><blink><center> [[Dark Cyberz]]</center></blink></a>";body.appendChild(div)}body=document.body;if(body!=null)
