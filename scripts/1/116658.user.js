...
// @include       http://forum.tribalwars.ae//forums/1-*
// @include       http://forum.tribalwars.ae//profil/*
// @include       http://forum.tribalwars.ae//forums/3-*
// @include       http://*.blog.jeuxvideo.com/*
// @include       http://forum.tribalwars.ae//commentaires/*
// @exclude       http://forum.tribalwars.ae//forums/0-*
// ==/UserScript==
...
var reg=new RegExp("(:kiraihi:)", "g");
chaine=chaine.replace(reg,"<img border='0' src='http://imageshack.us/photo/my-images/534/kiraihi.gif/' />");
...
chaine=chaine.replace(reg,"<img border='0' src='http://betaforum.kinssha.org/generateurSmileys/smiley142906.gif' />");

var reg=new RegExp("(:sparta:)", "g");
chaine=chaine.replace(reg,"<img border='0' src='http://betaforum.kinssha.org/generateurSmileys/smiley142903.gif' />");

var reg=new RegExp("(:troismains:)", "g");
chaine=chaine.replace(reg,"<img border='0' src='http://betaforum.kinssha.org/generateurSmileys/smiley142910.gif' />");

var reg=new RegExp("(:grospouce:)", "g");
chaine=chaine.replace(reg,"<img border='0' src='http://betaforum.kinssha.org/generateurSmileys/smiley142911.gif' />");

var reg=new RegExp("(:fake:)", "g");
chaine=chaine.replace(reg,"<img border='0' src='http://betaforum.kinssha.org/generateurSmileys/smiley999.gif' />");

var reg=new RegExp("(:pendre:)", "g");
chaine=chaine.replace(reg,"<img border='0' src='http://betaforum.kinssha.org/generateurSmileys/smiley142925.gif' />");

var reg=new RegExp("(:osef:)", "g");
chaine=chaine.replace(reg,"<img border='0' src='http://betaforum.kinssha.org/generateurSmileys/smiley142927.gif' />");

var reg=new RegExp("(:yeux:)", "g");
chaine=chaine.replace(reg,"<img border='0' src='http://betaforum.kinssha.org/generateurSmileys/smiley142928.gif' />");

var reg=new RegExp("(:bouchebe:)", "g");
chaine=chaine.replace(reg,"<img border='0' src='http://betaforum.kinssha.org/generateurSmileys/smiley142938.gifhttp://betaforum.kinssha.org/generateurSmileys/smiley142938.gif' />");
