...
// @author         SReject, chairmansteve, JHunz, wpatter6, modified by YepoMax (thank : Duck313 and cryophallion !)
// @version        0.3.8
// @date           02-02-2013
// @grant          none
...
// if any1 needs a simple way to calculate damage: atk*4+def+legionpower*5
	...
	window.SRDotDX = {
		...
		config: (function(){
			...
			tmp.refreshGameToJoin = (typeof tmp.refreshGameToJoin == 'boolean'? tmp.refreshGameToJoin:false);
			...
			tmp.asyncJoin = (typeof tmp.asyncJoin == 'boolean'?tmp.asyncJoin:true);
		...
		gui: {
			...
			unmuteall: function(){
				...
				document.getElementById('mutedppllist').innerHTML = "Empty";

				SRDotDX.echo('All users unmuted.');
			},
					
			tounmute: function(namemuted){
				delete SRDotDX.config.mutedUsers[namemuted];
				SRDotDX.echo('User "' + namemuted + '" unmuted.');
				SRDotDX.config.save(false);
				var nbm=0;
				listmuted="";
				for(var gens in SRDotDX.config.mutedUsers){
					listmuted += "<a href='#' onClick='return false' onMouseDown='SRDotDX.gui.tounmute(\""+ gens +"\")'>" + gens + "</a><br>" ;
					nbm++;
				}
				if(nbm==0)listmuted="Empty";
				document.getElementById('mutedppllist').innerHTML = listmuted;
			},
			
			mutebys: function(){
				
				var tomute = document.getElementById("mutesub").value;
				SRDotDX.config.mutedUsers[tomute]=true;
				document.getElementById("mutesub").value="";
				var nbm=0;
				listmuted="";
				for(var gens in SRDotDX.config.mutedUsers){
					listmuted += "<a href='#' onClick='return false' onMouseDown='SRDotDX.gui.tounmute(\""+ gens +"\")'>" + gens + "</a><br>" ;
			...
			importyepo: function(){
				...
				if((!SRDotDX.gui.importingPastebin && !SRDotDX.gui.ExportingPaste) || SRDotDX.gui.PastebinCollisions>10){
					SRDotDX.gui.PastebinCollisions=0;
					url= 'http://pastebin.com/raw.php?i=UbV16U3W';
					console.log("[SRDotDX] Importing Yepo pastebin ");
					SRDotDX.gui.importingPastebin=true;
					document.getElementById("SRDotDX_pastebin").src = url;
				} else {
					SRDotDX.gui.PastebinCollisions++;
			...
			setlsect: function(){
				document.getElementById('lastsect').src = "http://pastebin.com/raw.php?i=gVsaVHj3";
			},
			
			commentlink: function(){
				window.open("https://userscripts.org/scripts/discuss/157276");
				SRDotDX.echo("Thank you for comment !");
			},
			
			updatev: function(){
				window.open("http://userscripts.org/scripts/show/157276");
			...
			WRcalc: function(){
				...
				var mnt=new Date();
				var aaa = document.getElementById('wrinf').innerHTML;
				alert(aaa);
			},
				...
				if (typeof holodeck == 'object' && typeof holodeck._tabs == 'object' && typeof holodeck._tabs.addTab == 'function') {
					...
					var pane = SRDotDX.gui.cHTML('div').set({id: 'lots_tab_pane'}).html(' \
						...
						<ul id="SRDotDX_tabpane_tabs"> \
							<li class="tab active"> \
								...
								<div class="tab_pane"> \
									<div id="FPXRaidFilterDiv" class="collapsible_panel"> \
										<p class="panel_handle spritegame mts opened_link" onclick="SRDotDX.gui.toggleDisplay(\'FPXRaidFiltering\', this, \'raid_list\')"> <a> Raid Filtering </a> </p> \
										<div id="FPXRaidFiltering"> \
									...
									<div id="FPXRaidActionsDiv" class="collapsible_panel"> \
										<p class="panel_handle spritegame mts opened_link" onclick="SRDotDX.gui.toggleDisplay(\'FPXRaidActions\', this, \'raid_list\');SRDotDX.gui.UpdateSelectedRaidCount();"> <a> Raid Actions </a> </p> \
										<div id="FPXRaidActions"> \
											<hr> \
								...
								<div id="FPXRaidSpamDiv"> \
										<FORM name="FPXRaidSpamForm" onSubmit="return false"> \
											<div id="FPXShareDiv" class="collapsible_panel"> \
												...
												<div id="FPXShare"> <hr>\
													<input name="Submit"  type="submit" tabIndex="-1" style="font-size:110%" value="Post Links to Chat" onClick="SRDotDX.gui.FPXspamRaids();return false;"/> \
													<input name="Submit1" type="submit" disabled="disabled" tabIndex="-1" style="font-size:110%" value="Cancel Posting" onClick="SRDotDX.gui.FPXStopPosting();return false;"/><br> \
											...
											<div id="FPXShareDiv" class="collapsible_panel"> \
												...
												<div id="FPXImport"> <hr>\
													<input name="Submit4" type="button" tabIndex="-1" value="Quick Yepo Import" onClick="SRDotDX.gui.importyepo();return false;" style="font-size:80%">(<a href="#" onclick="return false" onmouseout="FPX.tooltip.hide();" onmouseover="FPX.tooltip.show(\'This button import YepoMax pastebin. Check my profile for more details : http://pastebin.com/u/YepoMax \');">?</a>) \
													<input name="Submit5" type="button" tabIndex="-1" value="Quick wpatter6 Import" onClick="SRDotDX.gui.importpat();return false;" style="font-size:80%">(<a href="#" onclick="return false" onmouseout="FPX.tooltip.hide();" onmouseover="FPX.tooltip.show(\'This button import wpatter6 pastebin.\');">?</a>)<br> \
													<input name="Submit2"  type="submit" tabIndex="-1" value="Import to Raid Tab" style="font-size:90%" onClick="SRDotDX.gui.FPXimportRaids();return false;"/> (<a href="#" onclick="return false" onmouseout="FPX.tooltip.hide();" onmouseover="FPX.tooltip.show(\'This will add any new raids in the share box below to the raid tab.\');">?</a>)\
													<input name="Submit3"  type="submit" tabIndex="-1" value="Delete and Import" style="font-size:90%" onClick="SRDotDX.gui.FPXdeleteAllRaids();SRDotDX.gui.FPXimportRaids();return false;"/>(<a href="#" onclick="return false" onmouseout="FPX.tooltip.hide();" onmouseover="FPX.tooltip.show(\'This will delete all raids on the raid tab and refresh the data with any raids in the share box below.\');">?</a>)<br> \
							...
							<li class="tab"> \
								<div class="tab_head">Tools</div> \
									<div class="tab_pane"> \
										<div class="collapsible_panel"> \
											<p class="panel_handle spritegame mts opened_link" onclick="SRDotDX.gui.toggleDisplay(\'filter\', this)"> <a> Filter </a> </p> \
											<div id="filter" > <hr> \
												...
												<div align="center"><hr align="center" width="175px"></div> \
										...
										<div class="collapsible_panel"> \
											<p class="panel_handle spritegame mts closed_link" onclick="SRDotDX.gui.toggleDisplay(\'Muted\', this)"> <a> Mute manager </a> </p> \
											<div id="Muted" style="display:none"> <hr>\
												<table border="0"><tr><td colspan=3><label>Muted people list :</label></td></tr> \
												<tr><td rowspan=2><div id="mutedppllist" style="width: 175px;height: 100px; border: 1px solid #cccccc;"></div></td><td valign="middle"><input type="button" style="margin: auto" value="DISABLED"></td><td valign="middle">(<a href="#" onclick="return false" onmouseout="FPX.tooltip.hide();" onmouseover="FPX.tooltip.show(\'Disabled in BETA version.\');">?</a>)</td></tr><tr><td valign="middle"><input type="button" style="margin: auto" value="Unmute all" onClick="SRDotDX.gui.unmuteall()"></td><td valign="middle" algin="right">(<a href="#" onclick="return false" onmouseout="FPX.tooltip.hide();" onmouseover="FPX.tooltip.show(\'Click to unmute all users.\');">?</a>)</td></tr> \
												<tr><td colspan=3><label>What they say :</label></td></tr> \
												<tr><td colspan=3 style="height: 300px; border: 1px solid #cccccc;"><div style="height: 300px;overflow-x: hidden;" id="mutedbox"></div></td></tr> \
												<tr><td colspan=3><label>People you want to mute :</td></tr> \
												<tr><td><input type="text" id="mutesub"></td><td><input type="button" value="Mute" onClick="SRDotDX.gui.mutebys()"</td><td>(<a href="#" onclick="return false" onmouseout="FPX.tooltip.hide();" onmouseover="FPX.tooltip.show(\'You can also do it by typing "/mute thename" in chat.\');">?</a>)</td></tr></table> \
											</div> \
										</div> \
										<div class="collapsible_panel"> \
											<p class="panel_handle spritegame mts closed_link" onclick="SRDotDX.gui.toggleDisplay(\'TNLcalc\', this)"> <a> TNL calculator </a> </p> \
											<div id="TNLcalc" style="display:none"> <hr> \
												<iframe src="http://leon-dotd.clanteam.com/pages/tnl_mini.htm" style="height: 500px; width: 280px;overflow-x: hidden;"></iframe> \
										</div> \
										<div class="collapsible_panel"> \
											<p class="panel_handle spritegame mts closed_link" onclick="SRDotDX.gui.toggleDisplay(\'TODO2\', this)"> <a> More </a> </p> \
											<div id="TODO2" style="display:none"> <hr> \
											COMING SOON</div> \
										</div> \
									</div> \
							</li> \
							<li class="tab"> \
								<div class="tab_head" onClick="SRDotDX.gui.setlsect()">News</div> \
									<div class="tab_pane"> \
									<iframe id="lastsect" scrolling="no" style="height: 400px; width: 270px;" src="http://pastebin.com/raw.php?i=gVsaVHj3"></iframe> \
									<div id="Supportetc" class="collapsible_panel"> \
										<p class="panel_handle spritegame mts opened_link" onclick="SRDotDX.gui.toggleDisplay(\'Support\', this)"> <a> Other </a> </p> \
										<div id="Support"> <hr>\
											<table border="0"> \
											<tr><td align="center" valign="middle"><input type="button" style="margin: auto" value="Comment !"></td><td valign="middle" onClikc="SRDotDX.gui.commentlink()">(<a href="#" onclick="return false" onmouseout="FPX.tooltip.hide();" onmouseover="FPX.tooltip.show(\'Link to the userscript.org comment page.\');">?</a>)</td></tr> \
											<tr><td align="center" valign="middle"><input type="button" style="margin: auto" value="UPDATE" onClick="SRDotDX.gui.updatev()"></td><td valign="middle">(<a href="#" onclick="return false" onmouseout="FPX.tooltip.hide();" onmouseover="FPX.tooltip.show(\'Click to update to latest version.\');">?</a>)</td></tr> \
											<tr><td align="center"><form action="https://www.paypal.com/cgi-bin/webscr" method="post" target="_blank"> \
											...
											</form></td><td valign="middle" algin="right">(<a href="#" onclick="return false" onmouseout="FPX.tooltip.hide();" onmouseover="FPX.tooltip.show(\'Click this button to support JHunz and wpatter6 work.\');">?</a>)</td></tr>\
											<tr><td align="center"><form action="https://www.paypal.com/cgi-bin/webscr" method="post"><input type="hidden" name="cmd" value="_donations"><input type="hidden" name="business" value="maximilien.smout@hotmail.com"><input type="hidden" name="lc" value="US"><input type="hidden" name="item_name" value="YepoMax"><input type="hidden" name="no_note" value="0"><input type="hidden" name="currency_code" value="EUR"><input type="hidden" name="bn" value="PP-DonationsBF:btn_donate_LG.gif:NonHostedGuest"><input type="image" src="https://www.paypalobjects.com/en_US/i/btn/btn_donate_LG.gif" border="0" name="submit" alt="PayPal - The safer, easier way to pay online!"><img alt="" border="0" src="https://www.paypalobjects.com/fr_FR/i/scr/pixel.gif" width="1" height="1"></form></td><td>(<a href="#" onclick="return false" onmouseout="FPX.tooltip.hide();" onmouseover="FPX.tooltip.show(\'Click this button to support YepoMax work.\');">?</a>)</td></tr></table> \
											</div> \
									</div> \
								</div> \
							</li> \
					...
					if(nbm==0)listmuted="Empty";
					mav = document.getElementById('mutedppllist').innerHTML.concat(listmuted);
					document.getElementById('mutedppllist').innerHTML = mav;
		...
		load: function (fails) {
			...
			if (typeof holodeck == 'object' && typeof ChatDialogue == 'function' && typeof activateGame == 'function' && typeof document.getElementById('kong_game_ui') != 'null') {
				...
				ChatDialogue.prototype.displayUnsanitizedMessage=function (b,d,e,f) {
					if(!this._user_manager.isMuted(b)){
						...
						if (typeof raid == 'object') {
							...
							if (raid.url.indexOf("maraak")!==-1 || raid.url.indexOf("tisi")!==-1 || raid.url.indexOf("serp")!==-1){
								d += " (<a href='#' onClick='return false' onMouseDown='SRDotDX.loadRaid(\""+raid.url+"\")'>Quick join</a>)"; // onMouseDown='SRDotDX.gui.loadRaid(\""+raid.url+"\")'
							}
						...
						if(SRDotDX.config.mutedUsers[b]){
							...
							if (pair==0){
								av = document.getElementById('mutedbox').innerHTML.concat(("<font color=#851063>" + b + "</font> : " + d +"<br>").replace('&nbsp; (<a class="reply_link" onclick="'+"holodeck.insertPrivateMessagePrefixFor('"+b+"'"+');return false;" href="#">reply</a>)',' <font color="#b8b9c8">(whisper)</font>').replace('',''));
								document.getElementById('mutedbox').innerHTML = av;
								document.getElementById('mutedbox').scrollTop = document.getElementById('mutedbox').scrollHeight;
								pair=1;
								}
							else pair=0
				...
				holodeck.addChatCommand("mute",function (deck, text){
					...
					if(s.length == 2 && s[1] != "" ){
						if (!(SRDotDX.config.mutedUsers[s[1]]==true)){listmuted+=s[1]+'\n'}
						var nbm=0;
				...
				holodeck.addChatCommand("import",function (deck, text){
					SRDotDX.gui.importyepo();
					SRDotDX.echo("Importing last YepoMax's pastebin ...");
					return false;
				}),
				...
				holodeck.addChatCommand("ad", function(deck,text) {
					SRDotDX.gui.FPXdoWork('http://userscripts.org/scripts/review/157276');
					return false;
				});
