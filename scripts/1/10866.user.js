// ==UserScript==
// @name              Community Topic Viewer
// @author            Zamaan
// @namespace         Zamaan
// @description     	It shows first and last posts of the topics without needing to enter in them .
// @Ideas & Helpers   Zamaan, Ajin, Winston, Zohaib, Davis, David, Jeevan, Sajid, Avinash, Faizan, Ect .
...
function firstPost(cmm,tid)
{
	...
	+'<br><p><label id="firstPost'+tid+'"><img width="16" height="16" src="'+imgLoading+'">Loading First Postï¿½</label></p>'
  ...
  +'</table>'
	...
	xml.onreadystatechange=function()
	{
		if(xml.readyState==4)
		{
			...
			{
				/*
				Descomentar se nï¿½o quiser um recarregamento dos posts a cada click
