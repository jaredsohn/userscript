...
function form_submit(event) {
   ...
   for (var i = arTextareas.length - 1; i >= 0; i--) {
	   var elmTextarea = arTextareas[i];
		...
		elmTextarea.value = elmTextarea.value.replace("[w1]","Hey guys what's up i just got returned, :smile:");
        elmTextarea.value = elmTextarea.value.replace("[infected1]","Read  [url=http://www.hackforums.net/showthread.php?tid=686793][b]I am infected! What do I do?[/b][/url] Then, Gather the requested logs and paste them on [url=pastebin.com][b]Pastebin.[/b][/url] And create a new Thread in [url=http://www.hackforums.net/forumdisplay.php?fid=115][b]HijackThis Log Analyzer and Tutorials[/b][/url] With your logs.");
