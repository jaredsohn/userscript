					...
					if( showmessage.length > 0 )
					{
						...
						if( data_message_id_old != data_message_id)
						{
							...
							*/
							...
							//else if ( !windowssss[number_zindex].getElementsByClassName('notify').length > 0 && options.generale.affExpe) //"EXPEDITION"
