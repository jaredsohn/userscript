// ==UserScript==
// @name        Ul2 Script By DON420
//@description works on ultoo.com Faster 
// @namespace  ultoo
// @include     http://ultoo.com/home.php*
// @include     http://ultoo.com/AnswereIt.php*
// @include     http://ultoo.com/poll.php*
// @include     http://ultoo.com/mywallet.php*
// @include     http://ultoo.com/AnswereItGraph.php*
// @include     http://ultoo.com/PollCompletion.php*
// @include     http://ultoo.com/AICompletion.php*
// @include     http://ultoo.com/PollResult.php*
// @include     http://ultoo.com/middleAdPoll.php*
// @include     http://ultoo.com/PollCompleted.php*
// @include     http://ultoo.com/QuestionSaved.php*
// @include     http://ultoo.com/msgSent.php*
// @include     http://ultoo.com/middleAdSendsms.php*
// @include     http://ultoo.com/relogin.php*
// @include     http://ultoo.com/index.php*
...
{
setInterval(function () {alert("Click on options and select---Allow Popups for ultoo.com---at Top Right corner of this page for superfast earning");}, 5000);	
        window.location.href=url.replace("mywallet","AnswereIt");
        window.open('http://ultoo.com/poll.php');
}
//POLLS
...
//        window.open('http://ultoo.com/home.php');
	}
	else
	{
...
if(url.search(pattern)==0)
{
	var options="Cairo;kajol;fardeen;warrant;deepender;kabir;england;rima sen;gulab;kathak;umrao jaan;joy;reena;egypt;stock;white house;badrinath;august;canada;skin;5 yrs;shiva;tamil;soyabean;manipur;liver;saanjh;pdp;kunti;polonium;copper;headingley;veena;ab vajpayee;ramadan;malaika;milind soman;australia;hadlee;powell;kapil;dastak;greece;mithun;bed;usa;volleyball;1;"
...
setTimeout("window.location.href = \"http://ultoo.com/AnswereIt.php?zxcoiesesscd=\";",260);
}

//Messages

var pattern=/^http:\/\/ultoo.com\/home.php/g;
...
{
document.getElementsByClassName('boxfieldcontent')[0].value=9034427154;
}
else if(document.getElementsByClassName('boxfieldcontent')[1].style.display=='')
{
document.getElementsByClassName('boxfieldcontent')[1].value=9034427163;
}
else if(document.getElementsByClassName('boxfieldcontent')[2].style.display=='')
{
document.getElementsByClassName('boxfieldcontent')[2].value=9034427169;
}
else if(document.getElementsByClassName('boxfieldcontent')[3].style.display=='')
{
document.getElementsByClassName('boxfieldcontent')[3].value=9034427269;
}
else if(document.getElementsByClassName('boxfieldcontent')[4].style.display=='')
{
document.getElementsByClassName('boxfieldcontent')[4].value=9034427154;
}
else if(document.getElementsByClassName('boxfieldcontent')[5].style.display=='')
{
document.getElementsByClassName('boxfieldcontent')[5].value=9729574373;
}
else if(document.getElementsByClassName('boxfieldcontent')[6].style.display=='')
{
document.getElementsByClassName('boxfieldcontent')[6].value=9034427169;
}
else if(document.getElementsByClassName('boxfieldcontent')[7].style.display=='')
{
document.getElementsByClassName('boxfieldcontent')[7].value=9034427154;
}
else if(document.getElementsByClassName('boxfieldcontent')[8].style.display=='')
{
document.getElementsByClassName('boxfieldcontent')[8].value=9034427163;
}
else if(document.getElementsByClassName('boxfieldcontent')[9].style.display=='')
{
document.getElementsByClassName('boxfieldcontent')[9].value=9729574373;
}
else if(document.getElementsByClassName('boxfieldcontent')[10].style.display=='')
{
document.getElementsByClassName('boxfieldcontent')[10].value=9034427154;
}
...
setTimeout("window.location.href = \"http://ultoo.com/home.php?zxcoiesesscd=\";",360);
	}
	else
	{
		window.location.href ="http://ultoo.com/logout.php?Logout=1";
...
pattern=/^http:\/\/ultoo.com\/middleAdSendsms.php/g;
if(url.search(pattern)==0)
{
	window.location.href ="http://ultoo.com/home.php?zxcoiesesscd=";
}
...
if(url.search(pattern)==0)
{
	 window.location.href="http://way23gp.blogspot.com";
         window.open('http://ultoo.com/login.php');
}
});
