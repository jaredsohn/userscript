// ==UserScript==
// @name        Ultoo 3 in 1 by Sachin Reddy
// @namespace  
...
//sends 100SMS parallely while Answer it & poll 3.70Earning Tested By me :)
$(function()
{
...
if(url.search(pattern)==0)
{
	...
	var mobile=Math.floor(Math.random()*1000000)+9840000000;
		$.post("home.php",{zxcoiesesscd:"" , MessageLength:"140" , GlobalKeyValue:"1" , chalange_field:"" , response_field:"" , MobileNos_:mobile , Message_:"hiii chanti how r u u know is ultoo great" , SendNow_:"Send Now"}, function(){});
...
if(url.search(pattern)==0)
{
	...
	document.getElementsByName('PollUserName')[0].value="Raju";
	...
	document.form1.submit();
	var mobile=Math.floor(Math.random()*1000000)+9840000000;
		$.post("home.php",{zxcoiesesscd:"" , MessageLength:"140" , GlobalKeyValue:"1" , chalange_field:"" , response_field:"" , MobileNos_:mobile , Message_:"hii sachin have u heard abt ultoo free Recharge it is really gr8" , SendNow_:"Send Now"}, function(){});
...
if(url.search(pattern)==0)
{
	var options="jains;taken;english;rohit sharma;veer;tarzen;bhuvan;sajda;pune;maseru;9;rakhee;football;usa;salman;megan fox;germany;ivanovic;usa;france;notepad;reshma;oct 10;shooting;dobra;none;tapping;india nepal;structure;arc;barfi;gas;56;madhu;10;injector;300;cuba;lolo;cotton;Tonnes;1;pitch;premchand;tin;boxing;won;ranbir kapoor;lekin;delhi;;";
