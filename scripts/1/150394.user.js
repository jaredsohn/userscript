// ==UserScript==
// @name 	   uni_hwm_Silentios_Mod
// @author 	   Silentio
// @namespace 	   HWM
// @version 	   0.9.5	
// @description    Add progress bar for Combat, Faction and Guilds levels. (2012.12.13)
// @homepage       http://userscripts.org/scripts/show/150394
...
function main(e){      
    ...
    lang_en['Show all factions']    = '\u041F\u043E\u043A\u0430\u0437\u0430\u0442\u044C \u0432\u0441\u0435 \u0444\u0440\u0430\u043A\u0446\u0438\u0438';
    lang_en['Show active faction']  = '\u041F\u043E\u043A\u0430\u0437\u0430\u0442\u044C \u0442\u043E\u043B\u044C\u043A\u043E \u0430\u043A\u0442\u0438\u0432\u043D\u0443\u044E';
    ...
    lang_ru['Demon']                = '\u0414\u0435\u043C\u043E\u043D';
    lang_ru['Dwarf']                = '\u0413\u043D\u043E\u043C';
    lang_ru['StBarbar']             = '\u0421\u0442\u0435\u043F\u043D\u043E\u0439 \u0432\u0430\u0440\u0432\u0430\u0440';
    ...
    var factions = [
        ...
        T('Dark elf'),T('Demon'),T('Dwarf'),T('StBarbar')
    ];
    ...
    var laborers_guild_lvl = [
        90,180,360,720,1500,
        3000,5000,8000,12000,17000,23000,30000,38000,47000
    ];
    ...
    var thieves_guild_lvl = [
        50,120,240,400,600,
        840,1200,2000,3000,4300,6000,8000,10800,14000
    ];
    ...
    var mercenaries_guild_lvl = [
        50,120,300,600,1000,
        1500,2200,3000,4000,5500,7800,11000
    ];
    ...
    function makeProgressBar(exp_attuale, lvl_attuale, exp_lvls){
        ...
        var progress_bar_html = "<DIV class=\"table_progress\" title=\""+ perc_text +"%\">"+
            "<img src=\"i/top/logot.jpg\" height=\"3\" width=\""+ perc +"\" title=\""+ perc_text +"%\" alt\""+ perc +"%\">"+
            "</DIV>";
