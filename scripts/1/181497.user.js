...
var main = function () {
    ...
    var URLSCRIPT = "/profile.html?id=1545";
    // CUSTOM IMAGE LINKS
...
//                changeEatButtons();
    ...
    function message(msg, clr) {
        ...
        var btnUnblock = $('<a class="button" style="margin: 15px auto 1px;" id="unblockButton" href="#"><span class="okIcon">OK</span></a>');
        ...
        var msgDiv = $("<div id='msgDiv' style='overflow-y: scroll;padding:15px;font-size:larger; min-height:100px; height:600px;width: auto; max-height: 1200px;text-align: center; background: #ebf4ff; color:" + clr + "'></div>");
        msgDiv.html(msg);
...
//            console.log("value: ", value);
        ...
        function autoEat(value) {
            ...
            var foodLimit = Number($('#foodLimit').text());
            var giftLimit = Number($('#giftLimit').text());
            var foodInStorage = Number($('#selectable').find('li.ui-selected').find('span[id^="food"].ui-selectee').clone().children().remove().end().text());
            var giftInStorage = Number($('#selectable2').find('li.ui-selected').find('span[id^="gift"].ui-selectee').clone().children().remove().end().text());
...
//                console.log("curretnHP, userHP ", currentHP, useHP);
                ...
                if (( $("#useFood:checked").length == 1 ) && ( $("#eatButton").attr("disabled") != "disabled" && foodLimit != 0 && !foodError)) {
                    ...
                    if (foodInStorage != 0) {
                        ...
                        foodError = true;
                        message("<h2>Can not fight.</h2> " + errorMessage, "red");
                    }
...
//                        console.log("errorMessage ", errorMessage);
                        ...
                        message("<h2 style='padding-top: 24px;'>Can not fight. </h2> " + errorMessage, "red");
                    }
                }
            }
            return eat;
