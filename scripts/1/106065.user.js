// ==UserScript==
// @name			Jappy Navigator by Glittergbpics.de Design Gothic
// @namespace		Autor: onkelz889
// @namespace		http://www.jappy.de/user/onkelz889
...
var CurrentScriptVersion = '0.1';
var xmlurl = 'http://userscripts.org/scripts/show/106065';
var downloadurl = 'http://userscripts.org/scripts/source/106065.user.js';
...
// hintergruende
// menuekoepfe
var head_bg_color = GM_getValue('head_bg_color' + UserId, 'url(http://jappynavigator.glitter-pic.de/gothic/header.png)');
// menuepunkte
var body_bg_color = GM_getValue('body_bg_color' + UserId, 'url(http://jappynavigator.glitter-pic.de/gothic/body.png)');
// menuepunkte hover
var body_bg_color_hov = GM_getValue('body_bg_color_hov' + UserId, 'url(http://jappynavigator.glitter-pic.de/gothic/hover.png)');

// schrift
// menuekoepfe
var head_txt_color = GM_getValue('head_txt_color' + UserId, '#FFFAF0');
// menuepunkte
var body_txt_color = GM_getValue('body_txt_color' + UserId, '#FFFAF0');
// menuepunkte hover
var body_txt_color_hov = GM_getValue('body_txt_color_hov' + UserId, 'red');
...
// klapfunktions icons
addGlobalStyle('.oc_cursor { cursor:s-resize; }');


// icons in auswahlliste
var stat_img = "before { content:url(http://jappynavi.netii.net/status";
...
{var newMail = "<object data=\"http://www.jokenet.de/Downloads/Sounds/gotmail.wav\"  type=\"application/x-ms-wmp\"><param name=\"hidden\" value=\"true\"><param name=\"loop\" value=\"false\"><param name=\"autostart\" value=\"true\"><param name=\"volume\" value=\"50\"></object>";}
...
// link 1 name
var jn_quicky_1_nam = GM_getValue("jn_quicky_1_namIn" + UserId , "GB Bilder Hier!" );
// link 1 url
var jn_quicky_1_url = GM_getValue("jn_quicky_1_urlIn" + UserId , "http://glittergbpics.de" );
...
var jn_quicky_6_anz = GM_getValue("jn_quicky_6_anzIn" + UserId , "true" );
// link 6 name
var jn_quicky_6_nam = GM_getValue("jn_quicky_6_namIn" + UserId , "userscripts.org" );
// link 6 url
var jn_quicky_6_url = GM_getValue("jn_quicky_6_urlIn" + UserId , "http://userscripts.org" );
// link 6 ziel (_self, gleiche seite und _blank, neue seite )
var jn_quicky_6_tar = GM_getValue("jn_quicky_6_tarIn" + UserId , "_blank" );
...
// start linkkette 0
var CJappySupport = "<div id=\"cjsb\" class=\"main_point jn_box_shadow\">Jappy-@ Glittergbpics.de</div>";

var CJappyNaviCom = "<a class=\"jn_sb_ic\" id=\"cjnc\" href=\"/comCode/ZXZQ\" target=\"_self\"><span class=\"icComs\"></span></a>";

var CJappyMailto = "<a class=\"jn_sb_ic\" id=\"cjmt\" href=\"/mailbox/new?to=onkelz889\" onclick=\"MessageSystem.compose(null, 'onkelz889');return false;\"><span class=\"icMailNew\"></span></a>";

var CJappyGorgon = "<a class=\"jn_sb_ic\" id=\"cjpg\" href=\"/user/onkelz889/\" onclick=\"return Jpy.popupProfile('onkelz889')\"><span class=\"icBuddyCode\"></span></a>";

var CJappyHome = "<a class=\"jn_sb_ic\" id=\"cjhp\" href=\"http://www.jappy.de/user/onkelz889\" target=\"_blank\"><span class=\"icSt18\"></span></a>";
...
if (JN_MyJappyBlock == "true")
{var Linkkette2 = "<li>"+CJappyMyJappy+"<div class=\"acc-content jn_box_shadow\" id=\"myjpy_block_div\">" + CJappyProfil + CJappyMail + CJappyKalender + CJappyFriends + CJappyBirthday + CJappyHaustier + CJappyPet_1 + CJappyPet_2 +"</div></li>"}
...
var anzeige_1 = "<div id=\"jpy_nav_upd_anz\" class=\"info cf\"><div class=\"icon cf\"><div class=\"text\">Jappy @ Glittergbpics.de<br>Update</div><div class=\"green\"><div class=\"pointer\">&nbsp;</div></div></div>";
var anzeige_2 = "<div class=\"plain\"><div class=\"block\">Aktuelle Version: <b>"+CurrentScriptVersion+"</b> Remote Version: <b>"+neueversion+"</b> Infos siehe Scripthomepage / Scriptcom.";
var anz_btn_inst = "<a href=\""+downloadurl+"\" class=\"inCo\"><span class=\"icAdd\">&nbsp;</span>Update Installieren</a> ";
var anz_btn_hp = "<a href=\"http://userscripts.org/scripts/show/106065\" target=\"_blank\" class=\"inCo\"><span class=\"icSt18\">&nbsp;</span>Script Homepage</a> ";
...
document.getElementById("no").innerHTML = ""+anzeige_1+anzeige_2+"<br><br>"+anz_btn_inst+anz_btn_hp+anz_btn_com+anz_btn_hide+"</div></div></div>";

document.getElementById('jpy_nav_upd_anz_hide').addEventListener('click', function set_upd_anz() {
GM_setValue('upd_anz_hide' , false)
document.getElementById("jpy_nav_upd_anz").setAttribute("style" , "display:none;")
},false);
...
document.getElementById("ov_span").setAttribute('class', 'spClosed oc_cursor');
GM_setValue('overview_oc' + UserId , true);
} else {
document.getElementById("overview_block_div").style.display = "none";
document.getElementById("ov_span").setAttribute('class', 'spOpen oc_cursor');
...
document.getElementById("my_span").setAttribute('class', 'spClosed oc_cursor');
GM_setValue('myjpy_oc' + UserId , true);
} else {
document.getElementById("myjpy_block_div").style.display = "none";
document.getElementById("my_span").setAttribute('class', 'spOpen oc_cursor');
...
document.getElementById("me_span").setAttribute('class', 'spClosed oc_cursor');
GM_setValue('mehr_oc' + UserId , true);
} else {
document.getElementById("mehr_block_div").style.display = "none";
document.getElementById("me_span").setAttribute('class', 'spOpen oc_cursor');
...
document.getElementById("in_span").setAttribute('class', 'spClosed oc_cursor');
GM_setValue('info_oc' + UserId , true);
} else {
document.getElementById("info_block_div").style.display = "none";
document.getElementById("in_span").setAttribute('class', 'spOpen oc_cursor');
...
document.getElementById('cjsb').innerHTML = 'Unsere Com';
},false);
document.getElementById("cjnc").addEventListener("mouseout", function anzeige () {
document.getElementById('cjsb').innerHTML = 'Jappy-@ Glittergbpics.de';
},false);

// mouse over/out mail onkelz889
document.getElementById("cjmt").addEventListener("mouseover", function anzeige () {
document.getElementById('cjsb').innerHTML = 'Mail an onkelz889';
},false);
document.getElementById("cjmt").addEventListener("mouseout", function anzeige () {
document.getElementById('cjsb').innerHTML = 'Jappy-@ Glittergbpics.de';
},false);

// mouse over/out profil onkelz889
document.getElementById("cjpg").addEventListener("mouseover", function anzeige () {
document.getElementById('cjsb').innerHTML = 'Jappy-Profil von onkelz889';
},false);
...
addGlobalStyle('.color_td_30 { display: none;border:1px solid #3b89cb; width:30%; text-align:center; }')
addGlobalStyle('.color_td_35 { display: none;border:1px solid #3b89cb; width:35%; text-align:center; }')
addGlobalStyle('.head_c { display: none;color:#ffffff; background-color:#3b89cb; font-weight:bold; }')
...
//Analytics
var _gaq = _gaq || [];
  _gaq.push(['_setAccount', 'UA-23424809-5']);
...
/*
document.getElementById('ly').setAttribute('style','display:block;')
document.getElementById('ly').innerHTML += "Du bist jetzt <span class='icSt1'>&nbsp;</span>";
*/