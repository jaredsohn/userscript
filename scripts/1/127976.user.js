...
// @description    Reporte TROPA
// ==/UserScript==

var FORM_URL = "https://docs.google.com/spreadsheet/viewform?formkey=dG1EWk5RX19KT01RektNcU44MjZ4eEE6MQ#gid=0";
...
var LOCALE = {
	...
	bg: function() {
		return {
			...
			send_report: "Estas listo para enviar el reporte a TROPA?",
...
var main = function() {
	...
	<a title="Reportar a TROPA" href="javascript:;" id="bs_report_pop_send">Reportar a TROPA</a>                                         \
