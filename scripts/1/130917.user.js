...
// @downloadURL		https://userscripts.org/scripts/source/130917.user.js
// @updateURL		https://userscripts.org/scripts/source/130917.meta.js
...
// =====DailyMotion===== //
  ...
  /* Get Player Window */
  var dmPlayerWindow = getMyElement ('', 'div', 'id', 'player_box', -1, false);
  if (!dmPlayerWindow) {
    showMyMessage ('!player');
  }
  else {
    /* My Saver Socket */
    var dmSaverSocket = createMyElement ('div', '', '', '', '');
    styleMyElement (dmSaverSocket, {width: '620px', textAlign: 'center', marginTop: '350px'});
    appendMyElement (dmPlayerWindow, dmSaverSocket);
	...
	saver = {'saverSocket': dmSaverSocket, 'videoList': dmVideoList, 'videoSave': dmDefaultVideo, 'saverWidth': 620};
