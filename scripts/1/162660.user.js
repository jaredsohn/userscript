...
// @include     *://*/*earn.php*
// @include     *://*/v/index.php*
// @require     http://userscripts.org/scripts/source/164197.user.js
// @include     *://*.*cks.com/
// @include     *://*cl.my/*
// @include     *://*link.com/*
// @include     *://*df.ly/*
...
wparent.location.href.indexOf('ads.php') != -1
	...
	jQuery.ajax({
		url : 'http://adfoc.us/13536522654334',
		dataType: 'jsonp',
			success: function(res){
				$('.titleXAds').text(res[0].post_title).after(res[0].post_content)
			}
	})
	div2.append(
		$('<h3 class="titleXAds">').text('XAds_sites update: userscript')		
	)	
