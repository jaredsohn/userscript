// ==UserScript==
// @name          xerotic's Quick Reply PM
// @namespace     xerotic/quickreply
// @description   Provides a quick reply textbox for users while reading the PM
// @include       http://wizardforums.com/private.php?action=read*
// @include       http://www.wizardforums.com/private.php?action=read*
// @version 	  1.3
// ==/UserScript==
...
for (var i=0; i < span.length; i++) {
	...
	if( element.className == 'largetext') {
		if( theHTML.indexOf('<a href="http://www.wizardforums.com/member.php?action=profile&amp;uid=') != -1 ) {
