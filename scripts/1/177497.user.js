...
Damages Report Script for FAS
By LongerWarrior — Last update Jun 13, 2012 — Installed 662 times.
About
Source Code
Reviews 0
Discussions 1
...
// @name        Damages Report Script for FAS
// @namespace   eRepublikBattlesReporter_FAS
// @version		0.0.1
// @uso:version 0.0.1
// @include		http://*erepublik.com/*/military/battlefield/*
// @description    eRepublik Damage Reporting script for FAS
// ==/UserScript==
...
if(window.location.href.indexOf(PAGE_BATTLEFIELD) > 0) {	
	...
	/***********************************************************************************/
	var FORM_URL = "https://docs.google.com/spreadsheet/ccc?key=0Aq3KzNJ7iJzFdHc5LUJhZzEzMlktMlk5M2dNbEF1TWc#gid=0";
	var FORM_FIELDS = {
                eday: "entry.0.single",
                name: "entry.2.single",
