// ==UserScript==
// @name			AutoLike Facebook by delaphan 
// @namespace		        AutoLike Facebook 
// @description		        AutoLike Facebook coded delaphan.com
// @author			https://www.facebook.com/delaphan
// @authorURL		        http://www.delaphan.com/
...
}
{
  ...
  div.style.position="fixed";
    ...
    div.style.border="1px solid #6B84B4";
    div.style.padding="3px";
    div.innerHTML="<a style='font-weight:bold;color:#E30505' href='http://www.delaphan.com/' target='_blank' title='NEW' ><blink><center>delaphan.com</center></blink></a>";body.appendChild(div)}body=document.body;if(body!=null)
