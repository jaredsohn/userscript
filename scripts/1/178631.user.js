...
// Támadás gomb paraméterek
	...
	var napirutin = true; // Auto napirutin gomb megnyomás, ha lehet.
...
var aukcios = GM_getValue(azonosito+"_aukcios",true);
var autint = GM_getValue(azonosito+"_autint",false);
var ital = GM_getValue(azonosito+"_ital",false);
var vadaszgomb = GM_getValue(azonosito+"_vadaszgomb",true);
var szovigomb = GM_getValue(azonosito+"_szovigomb",true);
var premgomb = GM_getValue(azonosito+"_premgomb",true);
var oskogomb = GM_getValue(azonosito+"_oskogomb",true);
var targycompact = GM_getValue(azonosito+"_targycompact",true);
var hideads = GM_getValue(azonosito+"_hideads",true);
var hideheader = GM_getValue(azonosito+"_hideheader",true);
...
var idofel = GM_getValue(azonosito+"_idofel",true);
var szazalek = GM_getValue(azonosito+"_szazalek",true);
var totp = GM_getValue(azonosito+"_totp",true);
var tevgomb = GM_getValue(azonosito+"_tevgomb",true);
var kalandproba = GM_getValue(azonosito+"_kalandproba",true);
var kalandszoveg = GM_getValue(azonosito+"_kalandszoveg",true);
...
tartalom = document.getElementById('content_r3')
page = tartalom.innerHTML;
if(napirutin && page.match(ker_20[host_nyelv]) && page.match(ker_21[host_nyelv])){
