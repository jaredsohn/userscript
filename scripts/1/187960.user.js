...
// @updateURL http://userscripts.org/scripts/source/187960.user.js
...
FL_ASL.main = function () {
 ...
 html_string += '<label><input type="checkbox" name="user[sex]" value="FtM" />Trans - Female to Male</label>';
 ...
 html_string += 'Who are also <label>at least: <input type="text" name="min_age" id="min_age" placeholder="18" size="2" /> years old</label> and <label>at most <input type="text" name="max_age" id="max_age" placeholder="99" size="2" /> years old</label>';
 html_string += '</p></fieldset>';
 ...
 html_string += '<label><input type="checkbox" name="user[role]" value="sub" />Submissive</label>';
 ...
 html_string += '<label><input type="checkbox" name="user[role]" value="slave" />Slave</label>';
 html_string += '<label><input type="checkbox" name="user[role]" value="pet" />Pet</label>';
 ...
 html_string += '<label><input type="checkbox" name="user[role]" value="bottom" />Bottom</label>';
 html_string += '<label><input type="checkbox" name="user[role]" value="Sadist" />Sadist</label>';
 html_string += '<label><input type="checkbox" name="user[role]" value="Masochist" />Masochist</label>';
 ...
 html_string += '<label>Return at least <input id="fl_asl_min_matches" name="fl_asl_min_matches" value="15" placeholder="15" size="2" /> match(es) per search.</label>';
 html_string += '</p></fieldset>';
