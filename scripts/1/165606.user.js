// ==UserScript==
// @name          Legion's Quick Reply PM
// @namespace     Legion/quickreply
// @description   Provides a quick reply textbox for users while reading the PM
// @include       http://moddedgame.com/private.php?action=read*
// @include       http://www.moddedgame.com/private.php?action=read*
// @version 	  1.1
// ==/UserScript==
...
for (var i=0; i < span.length; i++) {
	...
	if( element.className == 'largetext') {
		if( theHTML.indexOf('<a href="http://www.moddedgame.com/member.php?action=profile&amp;uid=') != -1 ) {
