// ==UserScript==
// @name       Script para la comunidad ATPC - A tomar por copas!
// @namespace  http://www.taringa.net/perfil/cixdesis_
// @version    0.1
// @description  Añade un botón de la comunidad ATPC - A tomar por copas!
// @include        http://www.taringa.net/*
// @exclude        http://www.taringa.net/comunidades/a-tomar-por-copas/*
...
byClass('menuTabs').innerHTML += "<li id=\"tabbedWTF\" class=\"tabbed\">\n <a href=\"http://www.taringa.net/comunidades/a-tomar-por-copas/\" onclick=\"menu(\'ATPC - A tomar por copas! \', this.href);return false;\" title=\"Ir a A tomar por copas!\">ATPC!";
