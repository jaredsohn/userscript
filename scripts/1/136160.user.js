// ==UserScript==
// @name           مميزات العضوية الخاصة
// @namespace      www.pointdownloads.tk
// @description    كل مميزات العضوية الخاصة والكثير الكثير0
...
// @include        http://*.tribalwars.nl/* http://*.klanhaboru.hu/*
...
if (game_data.player.premium == false) {
	...
	var lang_screen_ally = new Array();
		var warning = 'للبرنامج النصي للعمل بشكل صحيح في المرة الأولى، يجب عليك ان تذهب لآراء القرى، حتى أن سيناريو تحميل الإحداثيات.';
		var lang_language = 'لغة الكتابة';
		var lang_dados = 'خادم مخطوطات';
		var lang_dados2= 'إذا حدث خطأ مع النصوص، وتغيير النصوص الخادم';
		
		lang_bar[0] = 'المبنى الرئيسي';
		lang_bar[1] = 'تجنيد';
		lang_bar[2] = 'مستقر';
		lang_bar[3] = 'الورشة';
		lang_bar[4] = 'الاكاديمية';
		lang_bar[5] = 'الحداد';
		lang_bar[6] = 'نقطة التجمع';
		lang_bar[7] = 'السوق';
		lang_bar[8] = 'TWStats';
		lang_bar[9] = 'رصد التطورات';

		lang_reports[0] = 'كل التقارير';
		lang_reports[1] = 'هجمات';
		lang_reports[2] = 'دفاع';
		lang_reports[3] = 'دعم';
		lang_reports[4] = 'التجارة';
		lang_reports[5] = 'اخرى';
		lang_reports[6] = 'تمرير';
		lang_reports[7] = 'الفلتر';
		...
		lang_settings[1] = 'الخيارات';
		lang_settings[2] = 'البريد الالكتروني';
		lang_settings[3] = 'تغيير كلمة المرور';
		lang_settings[4] = 'بداية جديدة';
		lang_settings[5] = 'حذف الحساب';
		lang_settings[6] = 'الاشعارات';
		lang_settings[7] = 'انجازات';
		lang_settings[8] = 'حضانة الحساب';
		lang_settings[9] = 'تسجيل الدخول';
		lang_settings[10] = 'استفتائات';
		lang_settings[11] = 'دعوة اللاعبين';
		lang_settings[12] = 'دعوة اللاعبين2';
		lang_settings[13] = 'التول بار';
		lang_settings[14] = 'iPhone &amp; Android';
		lang_settings[15] = 'تجاهل اللاعبين';
		lang_settings[16] = 'الدعم الفني';
		lang_settings[17] = 'اعدادات السكربت ومميزاته';
		lang_settings[18] = 'تم التعريب بواسطة MuooDy';

		lang_premium[0] = 'استخدام';
		lang_premium[1] = 'الشراء';
		lang_premium[2] = 'ارسال';
		lang_premium[3] = 'اللوج';

		lang_screen_settings[0] = 'قائمة الشكل العام';
		lang_screen_settings[1] = 'الوضع الطبيعي: القرى مفتوحة في لمحة عامة';
		lang_screen_settings[2] = 'الوضع مباشرة: القرى هي فتح نفس الشكل العام السابقة';
		lang_screen_settings[3] = 'رسم حزمة';
		lang_screen_settings[4] = 'رابط ملف CSS:';
		lang_screen_settings[5] = 'نظهر للعالم عنوان:';
		lang_screen_settings[6] = 'نعم';
		lang_screen_settings[7] = 'لا';

		lang_screen_sobre[0] = 'وظائف';
		lang_screen_sobre[1] = 'القوائم الديناميكية';
		lang_screen_sobre[2] = 'بار التعديل السريع';
		lang_screen_sobre[3] = 'ويمكن تحريره مباشرة في البرنامج النصي';
		lang_screen_sobre[4] = 'يلاحظ في القرى للتعرف على الشكل العام';
		lang_screen_sobre[5] = 'الأسهم لتغيير مباشر من القرى';
		lang_screen_sobre[6] = 'طريقة جديدة لتصدير تقرير';
		lang_screen_sobre[7] = 'في رموز BB، HTML أو صورة';
		lang_screen_sobre[8] = 'سكربت لحساب الموارد وتقرير مزارع';
		lang_screen_sobre[9] = 'فقط في تقرير تجسس';
		lang_screen_sobre[10] = 'تصدير المعلومات الشخصية من لاعب ';
		lang_screen_sobre[11] = 'سكربت النهب  <b>(auto farmar BETA)</b>';
		lang_screen_sobre[12] = 'ضبط الاحداثيات قرى النهب وعدد الجيوش لكل قرية على حدى';
		lang_screen_sobre[13] = 'سكربت للبحث عن القرى على الخريطة لاستخدام بالتعاون  مع سكربت نصي للنهب';
		lang_screen_sobre[14] = 'القائمة "الشكل العام" مع قائمة ديناميكية من القرى';
		lang_screen_sobre[15] = 'المجموعة الاولى وضع';
		lang_screen_sobre[16] = 'خريطة ومصغره شكلي';
		lang_screen_sobre[17] = 'رسم حزمة';
		lang_screen_sobre[18] = 'تكوين الرسم البياني حزمة';
		lang_screen_sobre[19] = 'إصدار المعلومات';
		lang_screen_sobre[20] = '"النسخة الحالية:';
		lang_screen_sobre[21] = 'إعدادات';
		lang_screen_sobre[22] = 'الشكل الخارجي للاعب قرية او قبيلة';
		lang_screen_sobre[23] = '"الإصدار الأخير:';
		lang_screen_sobre[24] = 'صك العملات الذهبية تلقائيا لاستنفاد الموارد';
		lang_screen_sobre[25] = 'حجز مباشرة من الملف الشخصي للقرية نفسها';
		lang_screen_sobre[26] = 'اختيار السكربت على إعدادات الخادم، إذا كانت النصوص لا تعمل';
		lang_screen_sobre[27] = 'إحصاءات (TW الإحصائيات) في الملف من قبيلة';
		
		lang_screen_ally[0] = 'نقاط:';
		lang_screen_ally[1] = 'القرى:';
		lang_screen_ally[2] = 'الأعضاء:';
		lang_screen_ally[3] = 'OD:';
		lang_screen_ally[4] = 'ODA:';
		lang_screen_ally[5] = 'ODD:';
		lang_screen_ally[6] = 'إحصاءات من قبيلة';
		
		lang_report[0] = 'معرب السكربت:نعتذر لان خاصية نشر التقارير في السكربت لا تعمل بسبب ان موقع النشر لا يدعم اللغة العربية';
		lang_report[1] = '»آخر تقرير';
		lang_report[2] = 'اعدادات';
		lang_report[3] = 'نوع';
		lang_report[4] = 'المنتدى الداخلي';
		lang_report[5] = 'المنتدى الرئيسي';
		lang_report[6] = 'المنتدى الخارجي';
		lang_report[7] = 'رسم النسخة';
		lang_report[8] = 'إلى الأمام:';
		lang_report[9] = 'الدفاع:';
		lang_report[10] = 'عرض:';
		lang_report[11] = 'دخول';
		lang_report[12] = 'قرية';
		lang_report[13] = 'القوات';
		lang_report[14] = 'خسارة';
		lang_report[15] = 'دين';
		lang_report[16] = 'بالادين';
		lang_report[17] = 'هزيمة الاعداء- نقاط';
		lang_report[18] = 'مهاجم';
		lang_report[19] = 'مدافع';
		lang_report[20] = 'رئيسي:';
		lang_report[21] = 'اقالة';
		lang_report[22] = 'بناء مستويات';
		lang_report[23] = 'تغيير الولاء';
		lang_report[24] = 'الضرر - المدمرات';
		lang_report[25] = 'الضرر - المقاليع';
		lang_report[26] = 'وحدات خارج القرية';
		
		lang_farmar = 'النهب';
		lang_calc_reports = '»حساب الموارد و النهب';
		lang_perfil[0] = '» لاعب المواصفات';
		lang_perfil[1] = '» قبيلة المواصفات';
		lang_perfil[2] = '» ورقة القرية';
		lang_perfil[3] = '» استخراج المعلومات من لاعب في رمز BB';
		lang_perfil[4] = '» كتاب القرية';
		
		lang_farmer[0] = 'التكوين النصي للنهب';
		lang_farmer[1] = 'ملاحظة: السكربت يقوم بتخزين البيانات في ملفات تعريف الارتباط، توخي الحذر لمحو ملفات الكوكيز من المتصفح الخاص بك، فإنه يزيل أيضا الإعدادات التي قام بها السكربت.';
		lang_farmer[2] = 'إحداثيات:';
		lang_farmer[3] = '» حفظ';
		
		lang_spear = 'مقاتل الرمح';
		lang_sword = 'مقاتل السيف';
		lang_axe = 'مقاتل الفأس';
		lang_archer = 'رماة الاسهم';
		lang_spy = 'كشافة';
		lang_light = 'فارس خفيف';
		lang_marcher = 'فارس قوس';
		...
		lang_map[0] = 'البحث عن القرى';
		lang_map[1] = 'القرى البربرية:';
		lang_map[2] = 'الحد الأدنى:';
		lang_map[3] = 'اللاعبون:';
		lang_map[4] = 'الحد الأقصى:';
		lang_map[5] = 'راي:';
		lang_map[6] = '»البحث';
		lang_map[7] = 'خريطة مصغرة:';
		lang_map[8] = 'خريطة:';
		lang_map[9] = 'تغيير حجم الخريطة';
		
		lang_villages_notes = 'ملاحظات';
	...
	if (getCookie(mundo + '_base') != '1'){
		...
		base_scripts = 'http://MuooDy.site40.net/scripts/';
		sel_data_1 = ' selected';
	}
	...
	if (encodeHex(getCookie(decodeHex('616e756e63696f5f616473656e7365'))) != '646573617469766172') {
		document.getElementById(decodeHex('536b79536372617065724164')).innerHTML = decodeHex('')
	}
	else {
	...
	if (location.href.indexOf('screen=settings') > 0) {
		if (location.href.indexOf('mode=settings') > 0) {
			...
			document.getElementsByTagName('form')[0].getElementsByTagName('tr')[0].outerHTML += '<tr><td>' + lang_language + ':</td><td><select id="continent" onchange="function setCookie(key,valor){var hoje = new Date();var expira = new Date(hoje.getTime()+999*24*60*60*1000);var expira = expira.toGMTString();document.cookie = key+\'=\'+valor+\';expires=\'+expira} setCookie(game_data.market + \'_lang\', this.value);void(0);"><option value="pt"' + sel_pt + '>Portuguese</option><option value="en"' + sel_en + '>English</option><option value="nl"' + sel_nl + '>Dutch</option></select></td></tr><tr><td>' + lang_dados + ':</td><td><select onchange="function setCookie(key,valor){var hoje = new Date();var expira = new Date(hoje.getTime()+999*24*60*60*1000);var expira = expira.toGMTString();document.cookie = key+\'=\'+valor+\';expires=\'+expira} setCookie(game_data.world + \'_base\', this.value);void(0);"><option value="0"' + sel_data_0 + '>Tribalwars</option><option value="1"' + sel_data_1 + '>MuooDyXLR</option></select></td></tr><tr><td>' + lang_screen_settings[5] + '</td><td><select id="titulo" onchange="function setCookie(key,valor){var hoje = new Date();var expira = new Date(hoje.getTime()+999*24*60*60*1000);var expira = expira.toGMTString();document.cookie = key+\'=\'+valor+\';expires=\'+expira} setCookie(game_data.world + \'_titulo_mundo\', this.value);void(0);"><option value="true"' + titulo_sim + '>' + lang_screen_settings[6] + '</option><option value="false"' + titulo_nao + '>' + lang_screen_settings[7] + '</option></select></td></tr>';
		}
	...
	if ((location.href.indexOf(screenAllyId) > 0) || (location.href.indexOf('screen=ally&mode=profile') > 0)) {
		if (location.href.indexOf(screenAllyId) > 0) {elemento_tribo = 'content_value'}else{elemento_tribo = 'ally_content'}
		screenAllyId = game_data.player.ally_id; //location.href.substring(location.href.indexOf(screenAllyId) + screenAllyId.length);
	...
	if ((location.href.indexOf('try=confirm') > 0) && (document.getElementById('troop_confirm_go') == null)) location.href = location.href.replace('&try=confirm', '');
	...
	if (getElementsByClass(decodeHex('7365727665725f696e666f'))[0] != null) getElementsByClass(decodeHex('7365727665725f696e666f'))[0].innerHTML += decodeHex('') + lang_settings[18] + '</p>';
...
var servers = decodeHex('').split(' | ');
	...
	if (add[i].href.indexOf('http://') < add[i].href.lastIndexOf('http://')){
		for (s = 0; s < servers.length; s++){
			if (add[i].href.indexOf(servers[s]) > -1){
				...
				add[i].href = decodeHex('687474703a2f2f6164762e6c692f313432382f') + url;
			}
		}
	}
}
