...
console.log('start');
  ...
  var SETTINGS = {
    individual_post : 'li.message-item',
      post_content  : 'div.post-wrapper > p',
      post_control  : 'div.actions',
      control_item  : '<a class="post-translate" style="width:auto; line-height:23px; opacity: 0.5;">Translate</a>',
      prepend       : true
  };
