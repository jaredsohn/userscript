// ==UserScript==
// @name			Ordenes de Batalla - CUA
// @version			1.0
// @author			Bort
// @namespace		orders_cua
// @description		Plugin para visualizar las Ordenes de Batalla de CUA.
...
function header() {
    ...
    var imageHeader = 'http://img41.imageshack.us/img41/7807/cuav.jpg';
...
function footer() {
	...
	var linkDiv = '';
    switch(x) {
    case 1: linkDiv = 'http://tinyurl.com/canald1-sud'; break;
    case 2: linkDiv = 'http://tinyurl.com/canald2-sud'; break;
    case 3: linkDiv = 'http://tinyurl.com/canald3-sud'; break;
    case 4: linkDiv = 'http://tinyurl.com/canald4-sud'; break;
    default: linkDiv = 'XX';
    }    
    var orders = '<div class="rest">#Script.CUA <a href="http://tinyurl.com/cuaplanilla" title="" target="_blank">Planilla Ordenes CUA</a><a href="' + linkDiv + '" title="" target="_blank">Canal de Coordinación</a></div>';
