// ==UserScript==
// @name           Kaskus Mobile Quick Reply 2 by Suwardhana
    ...
    +'<div id="main_cont">'
     ...
     +'<div id="main_content" class="fade">\n'
	   ...
	   +'<div id="submit_cont" style="padding:1px 0 8px 0;">'
        + '<div id="capcay_cont" style="float:left;margin:0 0 0 15px;">'
		+   'capcay:<div id="capcay_img" style="display:inline-block;vertical-align:middle;"></div>' + HtmlUnicodeDecode('&#187;')
		+   '<input id="captcha" name="captcha" maxlength="3" size="3" type="text" class="field rb" style="width:50px;" autocomplete="off" />&nbsp;'
		+ '</div>'
