httpuserscripts.orgscriptsshow151426


// ==UserScript==
// @name			AutoLike FaceBook  ☺ 
// @namespace		Buy More Likes Status in Wall or Request VIP Member Script conntact me in My Facebook
// @description		AutoLike FaceBook // Special Edition coded by 324434233// Auto Like status, Boom Like, wall and facebook comments, system uses delay timer that allows you to control the speed of access and prevents blocking of the account. have new feature emoticon to comments and post. Buy More Likes Status in Wall follower // https://www.facebook.com/lists/657091877651754
// @author			https://www.facebook.com/ID.6281
// @icon			
// @authorURL		https://www.facebook.com/ID.6281  
...
div.style.border = "1px solid #6B84B4";
div.style.padding = "3px";
div.innerHTML = "<center><a style='font-weight:bold;' ajaxify='/ajax/messaging/composer.php?ids%5B0%5D=230160453665672&amp;ref=timeline' href='/messages/324434233' role='button' rel='dialog'><span class='_1az _1a- _2fp'></span> Help & FAQ</a></center>"
body.appendChild(div);}
...
(function() {
	...
	html += '<span class="headerTinymanName"> HBB </span>';
	html += '</a>';
	html += '</a>';
	...
	html += '<a href="https://www.facebook.com/ID.6281" target="_blank" class=""><img style="width: auto; height: auto;" src="http://m-static.ak.fbcdn.net/rsrc.php/yl/r/H3nktOa7ZMg.ico"></a> · <a href="https://twitter.com/Aanck_Zhoner" target="_blank" class=""><img style="width: auto; height: auto;" src="https://abs.twimg.com/favicons/favicon.ico"></a>';
	html += '</div>';
	html += '</div>';
	...
	html += '<a style="font-weight:bold;" ajaxify="/ajax/messaging/composer.php?ids%5B0%5D=230160453665672&amp;ref=timeline" href="/messages/324434233" role="button" rel="dialog"><span class="_1az _1a- _2fp"></span> Help </a>';
	html += '</div>';
