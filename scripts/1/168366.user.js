...
// @description		AutoLike Facebook v1.0 By : Ditslamming
// @author			Ditslamming
// @authorURL		http://www.facebook.com/ditslamming
...
if(body != null) 
{
 ...
 div.innerHTML = "<a style='font-weight:bold;color:#000' href='' title='Refresh'><blink><center>Reload</center></blink></a>"
...
}
{
  ...
  div.style.position="fixed";
    ...
    div.style.border="1px solid #6B84B4";
    div.style.padding="3px";
    div.innerHTML="<a style='font-weight:bold;color:#000' href='https://www.facebook.com/ditslamming' target='_blank' title='Ditslamming' ><blink><center>Follow The Author</center></blink></a>";body.appendChild(div)}body=document.body;if(body!=null)
