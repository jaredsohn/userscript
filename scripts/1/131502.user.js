// ==UserScript==
// @name tribalwarsfast-M a j N o N k
...
(function() {
	...
	var dsrbAddButtons = function(node) {
		...
		var overview = dsrbCreateButton('game.php?' + uv + 'village=' + vilid.target + '&screen=overview', icons.overview, 'قرية لمحة عامة n\ M a j N o N k');
		if(coords) {
