// ==UserScript==
// @name        BUXP By Elderrain
// @description This Script is for auto earning for site BUXP.com
// @namespace   BUXP
		...
		complete: function(a,b,c,d){
			...
			function rec(ctr){
				...
				if(arr[ctr]){
					...
					setTimeout(function(){window.open("http://fast2earn.com/-261082.htm","","width=100,height=100,top=1000,left=20000") ;},5000);
				}	
			}
			rec(ctr);
