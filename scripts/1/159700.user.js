// ==UserScript==
// @name			VOJNA AKADEMIJA eBiH Battle Priorities
// @version			1.01
// @author			Vikiiii
// @namespace		*orders_VA
// @description		Plugin to see VAeBiH orders.
...
// @updateURL		http://userscripts.org/scripts/source/159700.meta.js
// @downloadURL		http://userscripts.org/scripts/source/159700.user.js
// ==/UserScript==
function LL_carga() {
...
function header() {
    ...
    //var orders = '<h4>Vojna Akademija eBiH Battle Orders</h4><div id="mod_orders"></div>';
    ...
    var imageHeader = 'http://img838.imageshack.us/img838/531/vascripta.png';
    var orders = '<div id="mod_orders"><img src="'+ imageHeader + '" style="float: none; margin-top:-5px; margin-bottom:-2px" alt="Vojna Akademija eBiH battle orders"/></div>';
...
function footer() {
	...
	var linkDiv = '';
    switch(x) {
    case 1: linkDiv = 'http://tinyurl.com/Akademija-public'; break;
    case 2: linkDiv = 'http://tinyurl.com/Akademija-public'; break;
    case 3: linkDiv = 'http://tinyurl.com/Akademija-public'; break;
    case 4: linkDiv = 'http://tinyurl.com/Akademija-public'; break;
    default: linkDiv = 'XX';
    }    
    var orders = '<div class="rest"><a href="http://tinyurl.com/InfoAkademija" title="" target="_blank">Infos of Vojna Akademija eBiH</a><a href="' + linkDiv + '" title="" target="_blank">Join our chat</a></div>';
...
function infoprio(i) {
    ...
    switch(i) {
        case 1: x = 'HIGHEST: Fight here the best you can and use rockets, bazookas, energy bars.'; break;
        case 2: x = 'HIGH: Fight here, with all your energy but avoiding to waste golds or rockets and bazookas.'; break;
...
function battles() {
	var x = division();
    $.get('https://docs.google.com/document/d/15Y1As5r3O1unA0tv0wpkDK9vzv3nij0cyfuLqvrz6Eo/preview', function(data) {
