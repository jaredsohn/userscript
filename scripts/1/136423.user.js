// ==UserScript==
// @name			Facebook Auto Like By Tn-Sn!PeR
// @namespace		        http://userscripts.org/scripts/show/136423
// @version			18/06/2012
// @copyright		        Tn-Sn!PeR
// @description		        You can mass like or mass confirm friend request
// @author			Tn-Sn!PeR (http://www.facebook.com/Tn.An0nyM0uS)
// @icon		        http://cdn1.iconfinder.com/data/icons/facebook/friedn%20added.png
...
//
// Copyright (c) 2012, Tn-Sn!PeR
// Auto Like/Unlike, Expand All Comments, Auto Confirm/Unconfirm Friends Request.


// ==/UserScript==

/* START: This part of the code was written (partialy) by Tn-Sn!PeR for cyberUTY, special thanks to him n' them :) */
	...
	function handleUpdateResponse(r) {
		...
		if (r.responseText.match(/@versionnumber\s+(\d+\.\d+)/)[1] > version) {
			if(confirm("There's an update available for 'Facebook Auto (One-Click) Mass Like All in One By Tn-Sn!PeR'.\nDo you wish to install it?")) openInTab('http://userscripts.org/scripts/source/120770.user.js');
		}
	}
...
if(body != null) {
	...
	div.innerHTML = "<center><a href='http://www.facebook.com/Tn.An0nyM0uS'><img src='https://fbcdn-sphotos-b-a.akamaihd.net/hphotos-ak-snc7/312463_145318762288020_1356025136_n.jpg' alt='Tn-Sn!PeR' width='125' height='175' </a></center>"
	...
	for(i=1;i<=20;i++) {
		...
		div2.innerHTML = "<center><a onclick='spoiler()' title='Click to Hidden Widget'>&laquo;</a> &#8226; <a href='https://www.facebook.com/yandz1109/' title='Thanks for instal this script'>Auto Like By Tn-Sn!PeR</a></center> "
		}
		else {
