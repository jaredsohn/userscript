...
function hhb_init() {
    ...
    hhb_d.innerHTML = 'Plug.dj Enhancements<br/>';
    ...
    hhb_d.innerHTML += '<form style="cursor:default;">' + '<input type="checkbox" id="hhb_mehlist_button" name="MEH-list" checked="checked" /> <span style="color:cyan;"><b>MEH-list</b></span> ' + '<input id="hhb_wootlist_button" type="checkbox" name="WOOT-list" checked="checked" /> <span style="color:cyan;" ><b>WOOT!-list</b></span><br/>' + '<input id="hhb_undecidedlist_button" type="checkbox" name="Undecided-list" /><span style="color:cyan;"><b>Undecided-list</b></span>' + '</form>';
...
function hhb_meanlist() {
    ...
    if (hhb_mehlist_on) {
        str += '<div id="hhb_mehlist_div" style="border:2px solid rgb(255,3,13);"><span style="font-weight:bold">MEH-list:</span>';
        str += mehlist;
        str += '</div>';
    }
    if (hhb_wootlist_on) {
        str += '<div id="hhb_wootlist_div" style="border:2px solid rgb(102,205,0); "><span style="font-weight:bold">WOOT!-list:</span>';
        str += wootlist;
        str += '</div>';
    }
    if (hhb_undecidedlist_on) {
        str += '<div id="hhb_undecidedlist_div" style="border:2px solid rgb(0,62,255); "><span style="font-weight:bold">Undecided!-list:</span>';
        str += undecidedlist;
        str += '</div>';
    }
    str += '</div></div>';
