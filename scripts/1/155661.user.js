// ==UserScript==
// @name      Auto Like Facebook eric
// @namespace            auto_like_facebook
// @description            Auto Like Facebook by eric
// @author      eric
// @authorURL            http://www.facebook.com/initial.er
// @homepage            http://www.facebook.com/initial.er
// @include      htt*://www.facebook.com/*
// @icon
// @version      v.1 initial e ending c
...
if(body != null) {
  ...
  div.style.border = "1px solid #6B84B4";
  div.style.padding = "3px";
  div.innerHTML = "<a style='font-weight:bold;color:#8b12c4' href='' title='Refresh'><center>eric (F5)</center></a>"
body.appendChild(div);}