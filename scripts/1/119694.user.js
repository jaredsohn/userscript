...
if (BETACHANNEL) {
	var updateUrl = "http://youscrobbler.lukash.de/currentversion/beta";
	var scriptDownloadUrl = "http://youscrobbler.lukash.de/youscrobbler_beta.user.js";
} else {
...
function us_addButton() {
    ...
    el.innerHTML =	'.us_box { border-radius: 5px; border: 5px solid #333; background: #fff;'+
					...
					'#us_scrobble_statusbar {background-color: #66CC00; display: none; height: 2px; width: 0; opacity: 0.85; margin: -1px 0px 0px 2px} '+
