// ==UserScript==
// @name           Emo Popo by duynguyen
// @namespace      http://www.facebook.com/nguyendoanquocduy
// @description    Su dung Emoticons Popo cho cac mang xa hoi Facebook, Twitter, Youtube... Thanks to VOZ Forums and PES.VN
// @include        *
// @version        1.0.0.7
// ==/UserScript==
...
.replace(/:neptuyn:/g, "<style>.md img { display:inline; } .rageface { visibility:visible; } </style><img  src=\'http://www.geocities.ws/tainppd00015/emo/neptune.png\' title='Neptuyn' />")
			
.replace(/:sexyg:/g, "<style>.md img { display:inline; } .rageface { visibility:visible; } </style><img  src=\'http://www.geocities.ws/tainppd00015/emo/sexygirl.png\' title='Sexy' />")

.replace(/\:byebyeg\:/g, "<style> .md img { display:inline; } .rageface { visibility:visible; } </style><img src=\'http://www.geocities.ws/tainppd00015/emo/byebyegirl.png\' title=\'byebye\' />")

.replace(/\:look_downg\:/g, "<style> .md img { display:inline; } .rageface { visibility:visible; } </style><img src=\'http://www.geocities.ws/tainppd00015/emo/look_downgirl.png\' title=\'look_down\' />")

.replace(/\:adoreg\:/g, "<style> .md img { display:inline; } .rageface { visibility:visible; } </style><img src=\'http://www.geocities.ws/tainppd00015/emo/adoregirl.png\' title=\'adore\' />")

.replace(/\:chaymaug\:/g, "<style> .md img { display:inline; } .rageface { visibility:visible; } </style><img src=\'http://www.geocities.ws/tainppd00015/emo/chaymaugirl.png\' title=\'chaymau\' />")

.replace(/\:embarrasedg\:/g, "<style> .md img { display:inline; } .rageface { visibility:visible; } </style><img src=\'http://www.geocities.ws/tainppd00015/emo/embarassgirl.png\' title=\'Embarrased\' />")

.replace(/\:beautyg\:/g, "<style> .md img { display:inline; } .rageface { visibility:visible; } </style><img src=\'http://www.geocities.ws/tainppd00015/emo/beautygirl.png\' title=\'beauty\' />")

.replace(/\:bigsmileg\:/g, "<style> .md img { display:inline; } .rageface { visibility:visible; } </style><img src=\'http://www.geocities.ws/tainppd00015/emo/D1.png\' title=\'bigsmilegirl\' />")


.replace(/\:gachg\:/g, "<style> .md img { display:inline; } .rageface { visibility:visible; } </style><img src=\'http://www.geocities.ws/tainppd00015/emo/gachgirl.png\' title=\'gach\' />")

.replace(/\:pudencyg\:/g, "<style> .md img { display:inline; } .rageface { visibility:visible; } </style><img src=\'http://www.geocities.ws/tainppd00015/emo/pudencygirl.png\' title=\'pudency\' />")

.replace(/\:sosadg\:/g, "<style> .md img { display:inline; } .rageface { visibility:visible; } </style><img src=\'http://www.geocities.ws/tainppd00015/emo/sosadgirl.png\' title=\'sosad\' />")

.replace(/\:surrenderg\:/g, "<style> .md img { display:inline; } .rageface { visibility:visible; } </style><img src=\'http://www.geocities.ws/tainppd00015/emo/surrendergirl.png\' title=\'surrender\' />")
...
.replace(/\:sweatg\:/g, "<style> .md img { display:inline; } .rageface { visibility:visible; } </style><img src=\'http://www.geocities.ws/tainppd00015/emo/sweatgirl.png\' title=\'sweat\' />")

.replace(/\:nosebleedg\:/g, "<style> .md img { display:inline; } .rageface { visibility:visible; } </style><img src=\'http://www.geocities.ws/tainppd00015/emo/chaymaugirl.png\' title=\'nosebleed\' />")

.replace(/\:sogoodg\:/g, "<style> .md img { display:inline; } .rageface { visibility:visible; } </style><img src=\'http://www.geocities.ws/tainppd00015/emo/sogoodgirl.png\' title=\'sogood\' />")

.replace(/\:shameg\:/g, "<style> .md img { display:inline; } .rageface { visibility:visible; } </style><img src=\'http://www.geocities.ws/tainppd00015/emo/shamegirl.png\' title=\'shame\' />")

.replace(/\:cannyg\:/g, "<style> .md img { display:inline; } .rageface { visibility:visible; } </style><img src=\'http://www.geocities.ws/tainppd00015/emo/cannygirl.png\' title=\'canny\' />")

.replace(/\:shotg\:/g, "<style> .md img { display:inline; } .rageface { visibility:visible; } </style><img src=\'http://www.geocities.ws/tainppd00015/emo/shotgirl.png\' title=\'shot\' />")

.replace(/\:smileg\:/g, "<style> .md img { display:inline; } .rageface { visibility:visible; } </style><img src=\'http://www.geocities.ws/tainppd00015/emo/smilegirl.png\' title=\'Smile\' />")

.replace(/\:plasterg\:/g, "<style> .md img { display:inline; } .rageface { visibility:visible; } </style><img src=\'http://www.geocities.ws/tainppd00015/emo/plastergirl.png\' title=\'plaster\' />")

.replace(/\:kissg\:/g, "<style> .md img { display:inline; } .rageface { visibility:visible; } </style><img src=\'http://www.geocities.ws/tainppd00015/emo/kissgirl.png\' title=\'Kiss\' />")

.replace(/\:opsg\:/g, "<style> .md img { display:inline; } .rageface { visibility:visible; } </style><img src=\'http://www.geocities.ws/tainppd00015/emo/opsgirl.png\' title=\'opsgirl\' />")

.replace(/\:tireg\:/g, "<style> .md img { display:inline; } .rageface { visibility:visible; } </style><img src=\'http://www.geocities.ws/tainppd00015/emo/tiregirl.png\' title=\'tire\' />")

.replace(/\:ohg\:/g, "<style> .md img { display:inline; } .rageface { visibility:visible; } </style><img src=\'http://www.geocities.ws/tainppd00015/emo/ohgirl.png\' title=\'oh\' />")

.replace(/\:cryg\:/g, "<style> .md img { display:inline; } .rageface { visibility:visible; } </style><img src=\'http://www.geocities.ws/tainppd00015/emo/crygirl.png\' title=\'Cry\' />")

.replace(/\:dribbleg\:/g, "<style> .md img { display:inline; } .rageface { visibility:visible; } </style><img src=\'http://www.geocities.ws/tainppd00015/emo/dribblegirl.png\' title=\'dribble\' />")

.replace(/\:waaahtg\:/g, "<style> .md img { display:inline; } .rageface { visibility:visible; } </style><img src=\'http://www.geocities.ws/tainppd00015/emo/waaahtgirl.png\' title=\'waaaht\' />")

.replace(/\:amazedg\:/g, "<style> .md img { display:inline; } .rageface { visibility:visible; } </style><img src=\'http://www.geocities.ws/tainppd00015/emo/amazedgirl.png\' title=\'amazed\' />")

.replace(/\:sadg\:/g, "<style> .md img { display:inline; } .rageface { visibility:visible; } </style><img src=\'http://www.geocities.ws/tainppd00015/emo/sadgirl.png\' title=\'sad\' />")

.replace(/\:whatg\:/g, "<style> .md img { display:inline; } .rageface { visibility:visible; } </style><img src=\'http://www.geocities.ws/tainppd00015/emo/whatgirl.png\' title=\'what\' />")

.replace(/\:doubtg\:/g, "<style> .md img { display:inline; } .rageface { visibility:visible; } </style><img src=\'http://www.geocities.ws/tainppd00015/emo/doubtgirl.png\' title=\'doubt\' />")

.replace(/\:confidentg\:/g, "<style> .md img { display:inline; } .rageface { visibility:visible; } </style><img src=\'http://www.geocities.ws/tainppd00015/emo/confidentgirl.png\' title=\'confident\' />")

.replace(/\:ahg\:/g, "<style> .md img { display:inline; } .rageface { visibility:visible; } </style><img src=\'http://www.geocities.ws/tainppd00015/emo/ahgirl.png\' title=\'ah\' />")

.replace(/\:roflg\:/g, "<style> .md img { display:inline; } .rageface { visibility:visible; } </style><img src=\'http://www.geocities.ws/tainppd00015/emo/roflgirl.gif\' title=\'roflgirl\' />")

.replace(/\:lolg\:/g, "<style> .md img { display:inline; } .rageface { visibility:visible; } </style><img src=\'http://www.geocities.ws/tainppd00015/emo/lolgirl.gif\' title=\'lolgirl\' />")

.replace(/\:heheg\:/g, "<style> .md img { display:inline; } .rageface { visibility:visible; } </style><img src=\'http://www.geocities.ws/tainppd00015/emo/hehegirl.gif\' title=\'hehegirl\' />")
...
.replace(/\:byeg\:/g, "<style> .md img { display:inline; } .rageface { visibility:visible; } </style><img src=\'http://www.geocities.ws/tainppd00015/emo/byegirl.gif\' title=\'byegirl\' />")

.replace(/\:shootg\:/g, "<style> .md img { display:inline; } .rageface { visibility:visible; } </style><img src=\'http://www.geocities.ws/tainppd00015/emo/shootgirl.gif\' title=\'shootgirl\' />")

.replace(/\:baffleg\:/g, "<style> .md img { display:inline; } .rageface { visibility:visible; } </style><img src=\'http://www.geocities.ws/tainppd00015/emo/bafflegirl.png\' title=\'bafflegirl\' />")

.replace(/\:cholerg\:/g, "<style> .md img { display:inline; } .rageface { visibility:visible; } </style><img src=\'http://www.geocities.ws/tainppd00015/emo/cholergirl.png\' title=\'cholergirl\' />")

.replace(/\:hahag\:/g, "<style> .md img { display:inline; } .rageface { visibility:visible; } </style><img src=\'http://www.geocities.ws/tainppd00015/emo/hahagirl.png\' title=\'hahagirl\' />")

.replace(/\:matrixg\:/g, "<style> .md img { display:inline; } .rageface { visibility:visible; } </style><img src=\'http://www.geocities.ws/tainppd00015/emo/matrixgirl.png\' title=\'matrixgirl\' />")

.replace(/\:angryg\:/g, "<style> .md img { display:inline; } .rageface { visibility:visible; } </style><img src=\'http://www.geocities.ws/tainppd00015/emo/angrygirl.png\' title=\'angrygirl\' />")

.replace(/\:misdoubtg\:/g, "<style> .md img { display:inline; } .rageface { visibility:visible; } </style><img src=\'http://www.geocities.ws/tainppd00015/emo/misdoubtgirl.png\' title=\'misdoubtgirl\' />")

.replace(/\:bossg\:/g, "<style> .md img { display:inline; } .rageface { visibility:visible; } </style><img src=\'http://www.geocities.ws/tainppd00015/emo/bossgirl.png\' title=\'bossgirl\' />")

.replace(/\:dreamingg\:/g, "<style> .md img { display:inline; } .rageface { visibility:visible; } </style><img src=\'http://www.geocities.ws/tainppd00015/emo/dreaminggirl.png\' title=\'dreaminggirl\' />")

.replace(/\:confuseg\:/g, "<style> .md img { display:inline; } .rageface { visibility:visible; } </style><img src=\'http://www.geocities.ws/tainppd00015/emo/confusegirl.png\' title=\'Confuse\' />")

.replace(/\:sureg\:/g, "<style> .md img { display:inline; } .rageface { visibility:visible; } </style><img src=\'http://www.geocities.ws/tainppd00015/emo/suregirl.png\' title=\'sure\' />")

.replace(/\:ngao\:/g, "<style> .md img { display:inline; } .rageface { visibility:visible; } </style><img src=\'http://hoangmanhhiep.info/smiles/vinaget/0_002.gif\' title=\'Yao\' />")
.replace(/\:yao\:/g, "<style> .md img { display:inline; } .rageface { visibility:visible; } </style><img src=\'http://hoangmanhhiep.info/smiles/meme/mm10.png\' title=\'Yao\' />")
.replace(/\:fa\:/g, "<style> .md img { display:inline; } .rageface { visibility:visible; } </style><img src=\'http://www.pes.vn/images/smilies/Troll/troll%2041.gif\' title=\'FA\' />")
.replace(/\:troll1\:/g, "<style> .md img { display:inline; } .rageface { visibility:visible; } </style><img src=\'http://www.pes.vn/images/smilies/Troll/troll%2042.gif\' title=\'troll1\' />")
.replace(/\:troll2\:/g, "<style> .md img { display:inline; } .rageface { visibility:visible; } </style><img src=\'http://www.pes.vn/images/smilies/Troll/troll%2016.gif\' title=\'troll2\' />")
.replace(/\:troll3\:/g, "<style> .md img { display:inline; } .rageface { visibility:visible; } </style><img src=\'http://www.pes.vn/images/smilies/Troll/troll%2039.gif\' title=\'troll3\' />")
.replace(/\:troll4\:/g, "<style> .md img { display:inline; } .rageface { visibility:visible; } </style><img src=\'http://www.pes.vn/images/smilies/Troll/troll%2065.gif\' title=\'troll4\' />")
.replace(/\:lcb\:/g, "<style> .md img { display:inline; } .rageface { visibility:visible; } </style><img src=\'http://www.pes.vn/images/smilies/Troll/troll%2054.gif\' title=\'Lat cai ban\' />")
.replace(/\:mog\:/g, "<style> .md img { display:inline; } .rageface { visibility:visible; } </style><img src=\'http://www.pes.vn/images/smilies/Troll/troll%2021.gif\' title=\'Mother of God\' />")
.replace(/\:lay\:/g, "<style> .md img { display:inline; } .rageface { visibility:visible; } </style><img src=\'http://vozforums.com/images/smilies/Off/lay.gif\' title=\'Lay\' />")
.replace(/\:ok\:/g, "<style> .md img { display:inline; } .rageface { visibility:visible; } </style><img src=\'http://www.pes.vn/images/smilies/otheremo/New%20Folder/39.gif\' title=\'Ok\' />")
