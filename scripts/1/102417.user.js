// ==UserScript==
// @name            The West - TW Pro+ [SOM]  [a Hungarian server works only, server title because of a change] (v2.0.1.5)
// @namespace      http://userscripts.org/scripts/show/102417
// @description     Script for thewest: West - TW Pro+ [SOM] [a Hungarian server works only, server title because of a change, edit by Goyo] (v2.0.1.5)
...
// @include         http://userscripts.org/scripts/show/102417
// @version         2.0.1.5
//
...
var twpro_lang = {
	info: ['Zyphir Randrott', 'mailto:zyphir.randrott@gmail.com', 4343, '.w1.'],
		...
		TWPRO_DISABLED: 'Script disabled: script update needed due to source code changes in thewest',
	...
	twpro_langs.fr = {
		...
		TWPRO_DISABLED: "Script d\xE9sactiv\xE9: mise à jour du script nécessaire suite à des changements dans le code source de thewest",
...
//}	
	...
	// colorMe by aka Y. [SOM]
	  ...
	  function init() {
		  ...
		  /*Check for Opera*/
	  //	if (!window.location.href.match(/http:\/\/.+\.thewest\..*\/game\.php.*/i)) {
	  //		return;
	  //	} /*  Language Settings */
