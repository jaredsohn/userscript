// ==UserScript==
// @name        Musty Power Tools 
// @namespace   Musty
// @version        1.0
// @include        *.kingdomsofcamelot.com/*main_src.php*
// @description    Enhancements and bug fixes for Kingdoms of Camelot
// @icon           https://kabam1-a.akamaihd.net/kingdomsofcamelot/fb/e2/src/img/items/70/280.jpg
// ==/UserScript==

var Version = '1.0';

var Title = 'Musty Power Tools';
...
//logit ( 'Options.ptWinPos: '+ inspect (Options.ptWinPos, 5, 1)); 
 ...
 AddMainTabLink('MuStY Tools', eventHideShow, mouseMainTab);
//TestSomething.init ();  
...
Tabs.Options = {
  ...
  init : function (div){
    ...
    try {      
	  ...
	  m+='<TR><TD><INPUT id=ptAllowWinMove type=checkbox /></td><TD>iSARETLENDiGiNDE,Pencereyi Hareket Ettirebilirsiniz..!</td></tr>';
	  m+='<TR><TD><INPUT id=ptHideOnGoto type=checkbox /></td><TD>Harita koordinatları tıklandığında pencere gizle.</td></tr>';
	  m+='<TR><TD><INPUT id=ptEnableFoodWarn type=checkbox /></td><TD>GiDERiNiZ KRiTiK SEViYEYE ULASTIGINDA GELEN iKAZ YAZISI FONU KIRMIZI OLMASI iSTENiRSE';
	  m+='<INPUT id=optFoodHours type=text size=3 value="'+ Options.foodWarnHours +'"> Saat</td></tr>';
	  m+='<TR><TD><INPUT id=ptEnableFoodTower type=checkbox /></td><TD>YiYeCeK İtTiFaK AlArMı (SoN 6 sAaTtE, İtTiFaGa 30dk bİr UyArI vErİr)</td></tr>';
	  m+='<TR><TD><INPUT id=ptEnableWisperAlert type=checkbox /></td><TD>SoHBeTtE fIsIlTıLaRı SeSlİ uYaR</td></tr>';
	  m+='<TR><TD><INPUT id=ptEnableTowerAlert type=checkbox /></td><TD>İtTiFaGa DüŞeN sAlDıRı MeSaJıNı SeSlİ uYaR</td></tr>';
	  ...
	  m+='<TR><TD><INPUT id=togAllRpts type=checkbox /></td><TD>Gelişmiş İttifak Raporları etkinleştirir.</td></tr>';
	  ...
	  m+='<TR><TD><INPUT id=togGmtClock type=checkbox /></td><TD>Camelot Zamanını Gösterir.." </td></tr>';
	  ...
	  m+='<TR><TD><INPUT id=togAtkDelete type=checkbox /></td><TD>Savaş raporu görüntülerken silme düğmesi etkinleştir</td></tr>';
	  m+='<TR><TD><INPUT id=togRptGift type=checkbox /></td><TD>Gelen Hediye Mesajlarını Otomatik Sil!</td></tr>';
...
Tabs.Train = {
  ...
  nextAuto:				null,
  troopOptions:		"<option value='1'>Supply Troop</option><option value='2' selected>Militiaman</option><option value='3'>Scout</option><option value='4'>Pikeman</option><option value='5'>Swordsman</option><option value='6'>Archer</option><option value='7'>Cavalry</option><option value='8'>Heavy Cavalry</option><option value='9'>Supply Wagon</option><option value='10'>Ballista</option><option value='11'>Battering Ram</option><option value='12'>Catapult</option><option value='13'>Bloodthorn</option>",
