// ==UserScript==
// @author		hfskin (via LongerWarrior (source : Angel Vladov))
// @name        Test Reporting Script
// @namespace   eRepublikBattlesReporter_test
// @version		0.0.1
// @uso:version 0.0.1
// @include		http://*erepublik.com/*/military/battlefield/*
// @description    eRepublik test damage reporting script
// ==/UserScript==
...
if(window.location.href.indexOf(PAGE_BATTLEFIELD) > 0) {	
	...
	/***********************************************************************************/
	var FORM_URL = "https://docs.google.com/spreadsheet/viewform?formkey=dFp1cEh6XzgyVDFjMVRVT3d4VXRzcGc6MQ#gid=0";
	var FORM_FIELDS = {
                eday: "entry.1.single",
                name: "entry.2.single",
                round: "entry.4.single",
                damage: "entry.6.single",
                dq6hit: "entry.8.single",
                battle: "entry.10.single",
                wall: "entry.12.single",
                donate: "entry.14.single"
