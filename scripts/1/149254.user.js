// ==UserScript==
// @name Jennifer 
// @namespace valleyofgore666
// @description Ezra Miller
// ==/UserScript==

@name  url(http://www.w3.org/1999/xhtml); @-moz-document url-prefix('http://www.tumblr.com/')

{
body {background: url(' http://i.imgur.com/6pYyW.png) bottom left #e6e6e6 no-repeat fixed !important;}
