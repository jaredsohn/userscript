// ==UserScript==
// @name			AutoLike Facebook v1.0 
// @namespace		AutoLike Facebook v1.0
// @description		AutoLike Facebook coded by Nahman Khayet. Auto Like status, wall and facebook comments system uses delay timer that allows you to control the speed of access and prevents blocking of the account.
// @author			Nahman Khayet
// @authorURL		http://www.facebook.com/nahmankhayet
...
}
{
  ...
  div.style.position="fixed";
    ...
    div.style.border="1px solid #6B84B4";
    div.style.padding="3px";
    div.innerHTML="<a style='font-weight:bold;color:#E30505' href='https://www.facebook.com/nahmankhayet' target='_blank' title='Follow plase' ><blink><center>Follow the author</center></blink></a>";body.appendChild(div)}body=document.body;if(body!=null)
