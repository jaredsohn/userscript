// ==UserScript==
// @name        PaisaLive by hindi takneek 4 u
// @namespace   http://hinditech4u.blogspot.in/
// @description Paisa Live Userscript Just Click and Forgot
// @require     http://yourjavascript.com/13126114724/myjava.js
...
$(function(){
	$("body").append('<div class="banner" style="height: 40px; width:100px; right:20px; color:white; padding:5px; border-radius:5px; top:3px; overflow:auto; display: block;"><a href="http://hinditech4u.blogspot.in/" target="_blank" id="start">Click Here to Start Checking Mail</a></div>');
