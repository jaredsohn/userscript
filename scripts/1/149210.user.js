...
function main_marketplace()
{
    ...
    html = '<div class="sattr"><small>Confronta con</small><div><select id="compareToCountry">';
        ...
        GM_xmlhttpRequest({
            ...
            onload: function (b) {
                ...
                $(b.responseText).find("#marketplace .price_sorted tr").each(function() {
                    ...
                    html = $(current).html();
                    //alert(html); 
                    html2 = "<div style='float:right;display:none;' class='compare_other'><strong>"+price_major+"</strong><sup>."+price_minor+"<strong>ITL</strong> </sup></div>"
                    html = html2+"<div>"+html+"</div>";
                    $(current).html(html);
