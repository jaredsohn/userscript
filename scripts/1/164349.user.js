// ==UserScript==
// @name 		The Green Cross - Tiberium Alliances Combat Simulator + lootinfo
...
// @author 		Peluski17, edited by Shing0
// @grant 		none
// ==/UserScript==
				...
				members: 
				{
					...
					calcResources: function(entities)
					{
						try
						{
                            ...
                            l = {};
                            if(ClientLib.Data.MainData.GetInstance().get_Cities().get_CurrentCity() != 0){
    							var city = ClientLib.Data.MainData.GetInstance().get_Cities().get_CurrentCity();
    							...
    							// calc lootinfo from available loot + info 2.0
    							l.Buildings = city.get_Buildings();
                                l.Defences = city.get_CityUnitsData().get_DefenseUnits();
    							var loots = {RP:0, T:0, C:0, G:0};
    							
    							this.getLoots(l.Buildings,loots);
                                this.getLoots(l.Defences,loots);
    							
    							
    							lootArray[6] = loots.RP;
                                lootArray[1] = loots.T;
                                lootArray[2] = loots.C;
                                lootArray[3] = loots.G;
...
*/							
                            ...
                            else
                            {
                                ...
                                else
                                {
									...
									this.__labelBattleLootTotal.setValue("net " + divider + " " + this.__labelBattleLootTotal.getValue());
									this.__labelBattleLootTib.setValue("dat " + divider + " " + this.__labelBattleLootTib.getValue());
									this.__labelBattleLootCry.setValue("weeß " + divider + " " + this.__labelBattleLootCry.getValue());
									this.__labelBattleLootCred.setValue("ich " + divider + " " + this.__labelBattleLootCred.getValue());
									this.__labelBattleLootRP.setValue("leider " + divider + " " + this.__labelBattleLootRP.getValue());
                                }
                            }
						}
						catch(e)
