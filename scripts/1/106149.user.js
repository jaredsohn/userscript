...
var languages =
{
	en:
	{
		...
		'stopped_attacks' : 'Megszünt támadások: ',
		'no_new_attacks' : 'Nincs új támadás ',
		'changed_attacks' : 'Változás történt. ',
...
var alerts =
{
	0 : '<iframe width="480" height="390" src="http://www.youtube.com/embed/sS76eS34Y0c?autoplay=1" frameborder="0" allowfullscreen></iframe>',
	1 : '<iframe width="480" height="390" src="http://www.youtube.com/embed/O4i_2YTErWA?autoplay=1" frameborder="0" allowfullscreen></iframe>',
	2 : '<iframe width="480" height="390" src="http://www.youtube.com/embed/sS76eS34Y0c?autoplay=1" frameborder="0" allowfullscreen></iframe>',
	3 : '<iframe width="480" height="390" src="http://www.youtube.com/embed/O4i_2YTErWA?autoplay=1" frameborder="0" allowfullscreen></iframe>',
	4 : '<iframe width="480" height="390" src="http://www.youtube.com/embed/sS76eS34Y0c?autoplay=1" frameborder="0" allowfullscreen></iframe>',
	5 : '<iframe width="480" height="390" src="http://www.youtube.com/embed/O4i_2YTErWA?autoplay=1" frameborder="0" allowfullscreen></iframe>',
	6 : '<iframe width="480" height="390" src="http://www.youtube.com/embed/sS76eS34Y0c?autoplay=1" frameborder="0" allowfullscreen></iframe>',
	7 : '<iframe width="480" height="390" src="http://www.youtube.com/embed/O4i_2YTErWA?autoplay=1" frameborder="0" allowfullscreen></iframe>',
	8 : '<iframe width="480" height="390" src="http://www.youtube.com/embed/sS76eS34Y0c?autoplay=1" frameborder="0" allowfullscreen></iframe>',
	9 : '<iframe width="480" height="390" src="http://www.youtube.com/embed/O4i_2YTErWA?autoplay=1" frameborder="0" allowfullscreen></iframe>',
	10 : '<iframe width="480" height="390" src="http://www.youtube.com/embed/sS76eS34Y0c?autoplay=1" frameborder="0" allowfullscreen></iframe>',
};
...
$(document).ready ( function()
{
	if (Ika.view == 'embassyGeneralAttacksToAlly')
	{
		...
		{
			refresh_interval = 136; // 1 perces frissités
		}
