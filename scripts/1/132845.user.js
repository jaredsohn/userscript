// ==UserScript==
// @name           Ikariam Alliance Sorter movil
// @namespace      http://userscripts.org/scripts/show/42797
// @author         Martynius (http://userscripts.org/users/68307) modificado por Alex Corsario
...
function toTowns( cell ) {	return Number( /:\m*(\d+)/.exec( cell.text() )[1] ); }
