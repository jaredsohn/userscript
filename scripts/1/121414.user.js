// ==UserScript==
// @name           Combat Report Auto-Converter (SafeMode)
// @autor          WTF
// @icon           http://www.pablolopezponce.es/projects/crac/icon.png
...
language_ships = {
	...
	cl: { ships: "Barcos", cargo: "Barcos mercantes", ram: "Barco-espolón", ballista: "Barco-ballesta", flame: "Barco-lanza llamas", catapult: "Barco-catapulta", paddle: "Barco-espolón a vapor", mortar: "Barco-mortero", diving: "Submarino", rocket: "Barco lanzamisiles", speed: "Lancha de palas", balloon : "Portaglobos", tender: "Barco de mantenimiento" },
	co: { ships: "Barcos", cargo: "Barcos mercantes", ram: "Barco-espolón", ballista: "Barco-ballesta", flame: "Barco-lanza llamas", catapult: "Barco-catapulta", paddle: "Barco-espolón a vapor", mortar: "Barco-mortero", diving: "Submarino", rocket: "Barco lanzamisiles", speed: "Lancha de palas", balloon : "Portaglobos", tender: "Barco de mantenimiento" },
	...
	es: { ships: "Barcos", cargo: "Barcos mercantes", ram: "Barco-espolón", ballista: "Barco-ballesta", flame: "Barco-lanza llamas", catapult: "Barco-catapulta", paddle: "Barco-espolón a vapor", mortar: "Barco-mortero", diving: "Submarino", rocket: "Barco lanzamisiles", speed: "Lancha de palas", balloon : "Portaglobos", tender: "Barco de mantenimiento" },
	mx: { ships: "Barcos", cargo: "Barcos mercantes", ram: "Barco-espolón", ballista: "Barco-ballesta", flame: "Barco-lanza llamas", catapult: "Barco-catapulta", paddle: "Barco-espolón a vapor", mortar: "Barco-mortero", diving: "Submarino",rocket: "Barco lanzamisiles", speed: "Lancha de palas", balloon : "Portaglobos", tender: "Barco de mantenimiento" },
	pe: { ships: "Barcos", cargo: "Barcos mercantes", ram: "Barco-espolón", ballista: "Barco-ballesta", flame: "Barco-lanza llamas", catapult: "Barco-catapulta", paddle: "Barco-espolón a vapor", mortar: "Barco-mortero", diving: "Submarino", rocket: "Barco lanzamisiles", speed: "Lancha de palas", balloon : "Portaglobos", tender: "Barco de mantenimiento" },
	ve: { ships: "Barcos", cargo: "Barcos mercantes", ram: "Barco-espolón", ballista: "Barco-ballesta", flame: "Barco-lanza llamas", catapult: "Barco-catapulta", paddle: "Barco-espolón a vapor", mortar: "Barco-mortero", diving: "Submarino", rocket: "Barco lanzamisiles", speed: "Lancha de palas", balloon : "Portaglobos", tender: "Barco de mantenimiento" }
};
...
language_units = {
	...
	cl: { units: "Unidades", wall: "Muralla", slinger: "Hondero", swordsman: "Espadachín", phalanx: "Hoplita", archer: "Arquero", marksman: "Fusilero", gyrocopter: "Girocóptero", "steam giant": "Gigante a vapor", bombardier: "Bombardero", ram: "Ariete", catapult: "Catapulta", mortar: "Mortero", doctor: "Médico", cook: "Cocinero", spearmen: "Lancero", barbarian: "Bárbaro" },
	co: { units: "Unidades", wall: "Muralla", slinger: "Hondero", swordsman: "Espadachín", phalanx: "Hoplita", archer: "Arquero", marksman: "Fusilero", gyrocopter: "Girocóptero", "steam giant": "Gigante a vapor", bombardier: "Bombardero", ram: "Ariete", catapult: "Catapulta", mortar: "Mortero", doctor: "Médico", cook: "Cocinero", spearmen: "Lancero", barbarian: "Bárbaro" },
	...
	es: { units: "Unidades", wall: "Muralla", slinger: "Hondero", swordsman: "Espadachín", phalanx: "Hoplita", archer: "Arquero", marksman: "Fusilero", gyrocopter: "Girocóptero", "steam giant": "Gigante a vapor", bombardier: "Bombardero", ram: "Ariete", catapult: "Catapulta", mortar: "Mortero", doctor: "Médico", cook: "Cocinero", spearmen: "Lancero", barbarian: "Bárbaro" },
	mx: { units: "Unidades", wall: "Muralla", slinger: "Hondero", swordsman: "Espadachín", phalanx: "Hoplita", archer: "Arquero", marksman: "Fusilero", gyrocopter: "Girocóptero", "steam giant": "Gigante a vapor", bombardier: "Bombardero", ram: "Ariete", catapult: "Catapulta", mortar: "Mortero", doctor: "Médico", cook: "Cocinero", spearmen: "Lancero", barbarian: "Bárbaro" },
	pe: { units: "Unidades", wall: "Muralla", slinger: "Hondero", swordsman: "Espadachín", phalanx: "Hoplita", archer: "Arquero", marksman: "Fusilero", gyrocopter: "Girocóptero", "steam giant": "Gigante a vapor", bombardier: "Bombardero", ram: "Ariete", catapult: "Catapulta", mortar: "Mortero", doctor: "Médico", cook: "Cocinero", spearmen: "Lancero", barbarian: "Bárbaro" },
	ve: { units: "Unidades", wall: "Muralla", slinger: "Hondero", swordsman: "Espadachín", phalanx: "Hoplita", archer: "Arquero", marksman: "Fusilero", gyrocopter: "Girocóptero", "steam giant": "Gigante a vapor", bombardier: "Bombardero", ram: "Ariete", catapult: "Catapulta", mortar: "Mortero", doctor: "Médico", cook: "Cocinero", spearmen: "Lancero", barbarian: "Bárbaro" }
};
...
function check_version(url) {
    GM_xmlhttpRequest({
        ...
        onload: function(response) { 
            ...
            if(new_version.length>6) {
 				if(confirm('Existe un problema con el servidor de Combat Report Auto-Converter. Pulse Aceptar para ir al hilo del script a ver cual es el problema o cancelar para omitirlo.')) {  
					openInNewTab('http://board.es.ikariam.com/index.php?page=Thread&threadID=129508','Hilo del Script'); 
				} else { 
					updateVersionCheck(); 
				}
            } else {
				if(VERSION!=new_version) { 
					if(confirm('Su script Combat Report Auto-Converter está obsoleto. ¿esea actualizar a la útima versión? (' + new_version + ')')) {  
						openInNewTab('http://userscripts.org/scripts/source/56551.user.js','Actualizar Script'); 
					} else { 
						updateVersionCheck(); 
					}
				} else { 
...
function postToIkariam() { 
	forum_adress_array = {
		ar: ['0','38','44','86','136','161','180','189','197','207','237'],
		cl: ['0','32','65'],
		co: ['0','35','52','108','115'],
		es: ['0','107','108','109','110','111','112','113','121','134','152','195','216','234','260','327','342','365','445','461','474','606','624'],
		mx: ['0','25','48','62','128','137','144','155','191','202'],
		pe: ['0','30','53','78','228'],
		ve: ['0','48','67']
	}
	CRAC_REPORT.info.forumserver = $("div#GF_toolbar li.forum a").attr("href")
	var adress = forum_adress_array[LANG];
	window.open(CRAC_REPORT.info.forumserver + '/index.php?form=ThreadAdd&boardID=' + adress[world]);
}

 function battle_duration(rounds) {
	if(rounds==1) {
		document.getElementById('extraDiv4').innerHTML = document.getElementById('extraDiv4').innerHTML + ' tras una úica ronda de combate';
	} else {
...
function BuildStandardReport() {
	...
	if(/Las siguientes materias primas han sido robadas/.test(document.getElementById('militaryAdvisorReportView').innerHTML)) {
		...
		var loot_crystal = loot3.split('Cristal"></li><li class="value">');
		var loot_crystal3 = 0;
	...
	results += '<br/>';
	results += '<br/>[b][i]Compactado con: [url=http://ika-crac.2ya.com]Combat Report Auto-Converter[/url] v3.0.4 © by [url=http://board.ikariam.es/index.php?page=User&userID=47984]WTF[/url][/i][/b]';
...
function Toplain(text) {
		...
		text = text.replace('[img]http://'+server+'/skin/resources/icon_sulfur.png[/img]','Azufre:');
		text = text.replace('[img]http://'+server+'/skin/resources/icon_citizen.png[/img]','Burgueses:');
		text = text.replace('[b][i]Compactado con: [url=http://board.ikariam.es/index.php?page=Thread&threadID=129508]Combat Report Auto-Converter[/url] v3.0.4 © by [url=http://board.ikariam.es/index.php?page=User&userID=47984]WTF[/url][/i][/b]','Compactado con: Combat Report Auto-Converter v3.0.4 ©  by WTF');
...
function BuildReport() {
	...
	var new_militaryAdvisorReportView =  '<h3 class="header">Compactador</h3><div class="content"><table style="border:none;"><tr><td style="border:none; height:8px;"></td></tr><tr><td style="vertical-align:middle; text-align:center; height:60px; border:none;">Haz click sobre Seleccionar la parte que quieras, pulsa CTRL+C y luego pégala en el foro pulsando CTRL+V';
	...
	new_militaryAdvisorReportView += '</td></tr><tr style="border:none;"><td style="border:none; width:674px; text-align:center;"><button class="button" style="margin-right:40px;" id="CRAC_selectallsubject">Seleccionar asunto</button><button style="margin-right:40px;" class="button" id="CRAC_selectall">Seleccionar contenido</button>';
	...
	if(battle_is_full3==1) {
		if(parseInt(total_lost)<limit) {
			...
			new_militaryAdvisorReportView += '<button class="button" id="CRAC_postToForum">Postear en el foro de Ikariam </button>';
		}
	} else {
...
crac_panel.innerHTML = '<div style="width:46px; height:46px; position: absolute; top:140px; left:13px; z-index:100000000000; background-image:url(data:image/png;base64,%3D%3D);"></div><div class="mainContentBox contentBox01h toggleMenu yui-module yui-overlay yui-panel" id="militaryAdvisorReportView_z" style="visibility: inherit; " ><div id="militaryAdvisorReportView_g" class="hd header mainHeader draggable" style="cursor: move; " ><h3><a href="http://board.ikariam.es/index.php?page=Thread&threadID=129508" target="_blank">Combat Report Auto-Converter</a> v3.0.4  by <a href="http://board.ikariam.es/index.php?page=User&userID=47984" target="_blank">WTF</a></b></h3><div class="back" id="crac_back"></div><div class="close" id="crac_close"></div></div><div style="height: 510px;" class="bd mainContentScroll"><div style="top: 0px;" class="mainContent minimizableContent"><div class="buildingDescription"><h1>Combat Report Auto-Converter</h1></div><div class="contentBox01h">' + militaryAdvisorReportView + '</div></div></div>';
