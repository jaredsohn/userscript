...
// @version			0.9
// @author			UkrFalcon, Zena
// @namespace	    ukr_mod_prio
// @grant
// @require			https://ajax.googleapis.com/ajax/libs/jquery/1.7.2/jquery.min.js
// @require			http://hosting-files.googlecode.com/files/jquery.tipsy.js
// @include			/^http://(www|m)\.erepublik\.com/(en|ua)/?$/
// @updateURL		http://userscripts.org/scripts/source/156089.meta.js
// @downloadURL		http://userscripts.org/scripts/source/156089.user.js
// ==/UserScript==
...
function addHeaders() {    
    ...
    // Divs.    
    $('#battle_listing').prepend('<div class="rest"><img src="http://5.firepic.org/5/images/2012-12/27/o54qnf3ia4r3.jpg" alt=""></div>');
    ...
    $('#battle_listing').prepend('<div id="mod_orders"><img src="http://3.firepic.org/3/images/2012-12/27/6gp51azfrfjn.jpg" style="float: none; margin-top:-5px; margin-bottom:-2px"/></div>');
}
