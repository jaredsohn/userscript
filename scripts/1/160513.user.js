...
﻿// ==UserScript==
// @name           Koc Power Tools Extra
// @namespace      Joshua
// @include        http://*.kingdomsofcamelot.com/*main_src.php*
// @include        https://apps.facebook.com/kingdomsofcamelot/
// @description    Enhancements and bug fixes for Kingdoms of Camelot
// @require        http://tomchapin.me/auto-updater.php?id=98335
// ==/UserScript==

var Version = '20110716a';

var Title = 'KOC Power Tools By Joshua/Domain 352 Randomer';
...
//logit ('g_timeoff: '+ unsafeWindow.g_timeoff);
  ...
  .xtabBR {padding-right: 5px; border:none; background:none;}\
    ...
    .ptChatIcon {border: 3px inset purple}\
...
Tabs.wikia = {
  ...
  hide : function (){         // called whenever the main window is hidden, or another tab is selected
    var t = Tabs.wikia;
    mainPop.div.style.width = 1005 + 'px';
  },
...
logit ("ajax/allianceGetMembersInfo.php:\n"+ inspect (rslt, 5, 1));      
  ...
  show : function (){
    ...
    if (t.state == null){
      if (getMyAlliance()[0] == 0) {
        t.cont.innerHTML = '<BR><BR><CENTER>'+unsafeWindow.g_js_strings.membersInfo.youmustbelong+'</center>';
        t.state = 1;
        return;
      }
      ...
      m+='<INPUT id=playSubmit type=submit value="'+unsafeWindow.g_js_strings.modal_fow_leaderboard.finduser+'" /> &nbsp; <INPUT id=ffbuidsubmit type=submit value="UID" /></td>\
          ...
          <TR><TD class=xtab></td><TD class=xtab>'+unsafeWindow.g_js_strings.setDiplomacyWindow.srchalli+': &nbsp;</td>\
            <TD class=xtab><INPUT id=allAllName type=text /> &nbsp; <INPUT id=allSubmit type=submit value="'+unsafeWindow.g_js_strings.modal_fow_leaderboard.findalli+'" /></td>\
            <TD class="xtab ptErrText"><SPAN id=ptallErr></span></td></tr>\
           <TR><TD class=xtab><INPUT align=left id=allListSubmit type=submit value="'+unsafeWindow.g_js_strings.commonstr.alliances+'" /></td>\
  ...
  eventGotPlayerOnlineList : function (rslt){
    ...
    var m = '<DIV class=ptstat>'+unsafeWindow.g_js_strings.recommendSelectedFriends.playersrch+': <B>"'+ t.pName +'"</b></div>\
      <DIV style="height:575px; max-height:575px; overflow-y:auto">\
      <TABLE width=100% align=center class=ptTab cellspacing=0><TR style="font-weight:bold"><TD>'+unsafeWindow.g_js_strings.commonstr.nametx+' &nbsp &nbsp &nbsp &nbsp &nbsp &nbsp &nbsp &nbsp &nbsp</td>\
      <TD align=right>UID &nbsp &nbsp &nbsp &nbsp &nbsp &nbsp &nbsp</td><TD>'+unsafeWindow.g_js_strings.commonstr.might+' &nbsp &nbsp</td><TD> &nbsp; '+unsafeWindow.g_js_strings.commonstr.online+'</td><TD> &nbsp;Facebook &nbsp; </td><TD width=75%>'+unsafeWindow.g_js_strings.commonstr.search+' </td></tr>';
    var row=0;
    var cl='';
    for (k in t.playerList){
      ...
      m += '<TR '+ cl +'valign=top><TD>'+ u.genderAndName +'</td><TD><A target="_tab" href="http://koc.dunno.com/index.sjs?f=ServersByUser&user_id='+ u.userId +'">' + u.userId + '</a></td><TD align=right>'+ addCommasInt(u.might) +'</td>\
          <TD>'+ (rslt.data[u.userId]?"&nbsp;<SPAN class=boldDarkRed>"+unsafeWindow.g_js_strings.commonstr.online+"</span>":"") +'</td>\
          ...
          <TD><SPAN onclick="PTpd(this, '+ u.userId +')"><A>'+unsafeWindow.g_js_strings.modaltitles.memberdetails+'</a> &nbsp; <BR></span><SPAN onclick="PTpl2(this,'+ u.userId+','+rslt.data[u.userId]+')"><A>'+unsafeWindow.g_js_strings.modaltitles.leaderboard+'</a><BR></span><SPAN onclick="PCplo(this, \''+ u.userId +'\')"><A>'+unsafeWindow.g_js_strings.modal_messages_viewreports_view.lastlogin+'</a></span></td></tr>';
    }
    m += '</table></div>';
  ...
  gotPlayerLeaderboard : function (rslt, span){
    ...
    logit (pStr);
    m = '<TABLE cellspacing=0 class=ptTab><TR><TD><B>'+unsafeWindow.g_js_strings.commonstr.leaderboard+': </b></td><TD colspan=2>'+unsafeWindow.g_js_strings.commonstr.might +': '+ p.might  +' &nbsp; '+unsafeWindow.g_js_strings.commonstr.alliance+': '+ an +'</td></tr>'; 
  ...
  gotPlayerDetail : function (rslt, span){
    ...
    var m = '<TABLE cellspacing=0 class=ptTab><TR><TD><B>Details:</b> &nbsp; </td><TD>'+unsafeWindow.g_js_strings.commonstr.alliance+': '+ a +' &nbsp; '+unsafeWindow.g_js_strings.commonstr.cities+': '
          + u.cities +' &nbsp; '+unsafeWindow.g_js_strings.commonstr.population+': '+ u.population +'</td></tr><TR><TD></td><TD>'+unsafeWindow.g_js_strings.commonstr.province+': ';
  ...
  eventGotAllianceList : function (rslt){
    ...
    var m = '<DIV class=ptstat>'+unsafeWindow.g_js_strings.commonstr.alliances+'<B>"'+ t.aName +'"</b></div>\
    <TABLE><TR style="font-weight:bold"><TD class=xtab>'+unsafeWindow.g_js_strings.commonstr.alliance+'</td><TD class=xtab>'+unsafeWindow.g_js_strings.commonstr.rank+'</td><TD class=xtab>'+unsafeWindow.g_js_strings.commonstr.members+'</td>\
        <TD align=right class=xtab>'+unsafeWindow.g_js_strings.commonstr.might+'</td><TD class=xtab>'+unsafeWindow.g_js_strings.getAllianceSearchResults.currdiplo+'</td><TD class=xtab></td></tr>';
    for (k in rslt.alliancesMatched){
      ...
      m += '<TR><TD class=xtab>'+ all.allianceName +'</td><TD align=right class=xtab>'+ all.ranking +'</td><TD align=right class=xtab>'+ all.membersCount +'</td>\
       ...
       <TD class=xtab><a onclick="PTgetMembers('+ all.allianceId +')">'+unsafeWindow.g_js_strings.commonstr.members+'</a></td></tr>';
    }
    document.getElementById('allListOut').innerHTML = m;
  },
  ...
  eventListPrev : function (amt){
   ...
   eventGotOtherAlliancePage : function (rslt){
    ...
    var m = '<div style="overflow:auto; height:556px;width:564px;"><TABLE><thead><TR style="font-weight:bold"> \
        ...
        <th align=right class=xtab>'+unsafeWindow.g_js_strings.commonstr.might+'</th><th class=xtab>'+unsafeWindow.g_js_strings.getAllianceSearchResults.currdiplo+'</th><th class=xtab></th></tr></thead><tbody>';
    document.getElementById('allListOut').innerHTML = m;
    ...
    for (var i=0; i<rslt.otherAlliances.length; i++) {
      ...
      m += '<TR class="'+ dip + '"><TD class=xtab>' + alliance.name +'</td><TD align=right class=xtab>'+ alliance.ranking +'</td><TD align=right class=xtab>'+ alliance.membersCount +'</td>\
       ...
       <TD class=xtab><a onclick="PTgetMembers('+ alliance.allianceId +')">'+unsafeWindow.g_js_strings.commonstr.members+'</a></td></tr>';
    }
...
return 0;        
    ...
    for (var i=0; i<t.dat.length; i++){
      m += '<TR style="max-height:30px"><TD class=xxtab>'+ t.dat[i][0] +'</td><TD align=right class=xxtab>'+ addCommasInt(t.dat[i][1]) 
         ...
         </td><TD  nowrap class=xxtab>'+ (t.dat[i][10]?'<SPAN>'+ (t.dat[i][10]>0?timestr(t.dat[i][10],1):'--') +'</span>':'<SPAN>--</span>') +'<td class=xxtab><SPAN onclick="PCplo(this, \''+ t.dat[i][11] +'\')"><A>'+unsafeWindow.g_js_strings.modal_messages_viewreports_view.lastlogin+'</a></span><td></tr>';
    }
  ...
  displayMembers : function (allName, numPlayers){
    ...
    var m = '<STYLE>.clickable{background-color:#ddd; border:2px outset; border-color:#555; padding-left:5px; padding-right:5px}\
      ...
      <TR style="font-weight:bold"><TD id=clickCol0 onclick="PTalClickSort(this)" class=clickable><A><DIV>'+unsafeWindow.g_js_strings.commonstr.player+'</div></a></td>\
        <TD id=clickCol1 onclick="PTalClickSort(this)" class=clickable align=center><A><DIV>'+unsafeWindow.g_js_strings.commonstr.might+'</a></div></td>\
        <TD id=clickCol3 onclick="PTalClickSort(this)" class=clickable><A><DIV>'+unsafeWindow.g_js_strings.commonstr.cities+'</a></div></td>\
        <TD id=clickCol2 onclick="PTalClickSort(this)" class=clickable align=center><A><DIV>'+unsafeWindow.g_js_strings.commonstr.rank+'</a></div></td>\
        <TD id=clickCol9 onclick="PTalClickSort(this)" class=clickable align=center><A><DIV>'+unsafeWindow.g_js_strings.commonstr.online+'</a></div></td>\
        <TD id=clickCol7 onclick="PTalClickSort(this)" class=clickable><A><DIV>'+unsafeWindow.g_js_strings.MapObject.cityname+'</a></div></td>\
        <TD id=clickCol4 onclick="PTalClickSort(this)" class=clickable><A><DIV>'+unsafeWindow.g_js_strings.commonstr.lvl+'</a></div></td>\
        <TD id=clickCol5 onclick="PTalClickSort(this)" class=clickable><A><DIV>'+unsafeWindow.g_js_strings.commonstr.coordinates+'</a></div></td>\
        <TD id=clickCol8 onclick="PTalClickSort(this)" class=clickable><A><DIV>'+unsafeWindow.g_js_strings.commonstr.distance+'</a></div></td>\
        <TD id=clickCol10 onclick="PTalClickSort(this)" class=clickable><A><DIV>'+unsafeWindow.g_js_strings.attack_generateincoming.estimatedarrival+'</a></div></td>\
        <TD class=clickable><A><DIV>'+unsafeWindow.g_js_strings.modal_messages_viewreports_view.lastlogin+'</a></div></td></tr></thead>\
  ...
  displayPlayer : function (allName,rslt){
    ...
    var m = '<STYLE>.clickable{background-color:#ddd; border:2px outset; border-color:#555; padding-left:5px; padding-right:5px}\
            ...
            <DIV class=ptstat ><TABLE id=tabAllMembers cellpadding=0  width=100%><TR font-weight:bold"><TD class=xtab>Alliance: '+ allName +'</td>\
              <TD class=xtab width=80% align=center>'+unsafeWindow.g_js_strings.modal_messages_viewreports_view.lastlogin+': <SPAN id=lastlogin>'+  rslt.playerInfo.lastLogin+'</span></td><TD class=xtab align=right></td></tr></table></div>\
      <div style="max-height:470px; height:470px; overflow-y:auto;"><TABLE id=tabAllMembers align=center cellpadding=0 cellspacing=0><THEAD style="overflow-y:hidden;">\
...
//Link info
    m += '<DIV class=ptstat>USEFUL LINKS</div>';
    m += '<table align="center" width="700" border="0" cellspacing="0" cellpadding="0">';
    m += '<tr><td width="57"><b>Nr.</b></td>';
    m += '<td width="343"><b><center>Topic</center></b></td>';
    m += '<td width="156"><b><center>Source</center></b></td></tr>';
    m += '<tr><td><b># 1</b></td>';
    m += '<td><center><a href=http://koc.wikia.com/wiki/Wilderness target="_blank">Wilderness Info</a></center></td>';
  m += '<td><center><a href=http://koc.wikia.com/wiki/Kingdoms_of_Camelot_Wiki target="_blank">Koc Wikia</a></center></td></tr>';
    m += '<tr><td><b># 2</b></td>';
    m += '<td><center><a href=http://koc.wikia.com/wiki/Barbarian_Camps target="_blank">Barbarian Camp Info</a></center></td>';
    m += '<td><center><a href=http://koc.wikia.com/wiki/Kingdoms_of_Camelot_Wiki target="_blank">Koc Wikia</a></center></td></tr>';
    m += '<tr><td><b># 3</b></td>';
    m += '<td><center><a href=http://koc.wikia.com/wiki/Crests target="_blank">Crest Info</a></center></td>';
    m += '<td><center><a href=http://koc.wikia.com/wiki/Kingdoms_of_Camelot_Wiki target="_blank">Koc Wikia</a></center></td></tr>';
    m += '<tr><td><b># 4</b></td>';
    m += '<td><center><a href=http://koctools.com/index.php?pageid=servers target="_blank">Server List</a></center></td>';
    m += '<td><center><a href=http://koctools.com target="_blank">Koc Tools</a></center></td></tr>';
  m += '<tr><td><b># 5</b></td>';
    m += '<td><center><a href=http://userscripts.org/scripts/search?q=koc&submit target="_blank">Koc Scripts</a></center></td>';
    ...
    try {      
      m = '<TABLE class=ptTab>\
        ...
        <TR><TD><INPUT id=ptEnableFoodWarn type=checkbox /></td><TD>Show \'food left\' in RED if food will run out in less than \
            <INPUT id=optFoodHours type=text size=3 value="'+ Options.foodWarnHours +'"> hours, does NOT affect the food alert</td></tr>\
...
Tabs.Alliance = {
  ...
  init : function (div){    
    ...
    m += '<option value="login">'+unsafeWindow.g_js_strings.modal_messages_viewreports_view.lastlogin+'</option>';
