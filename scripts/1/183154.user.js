// ==UserScript==
// @name			AutoLike Facebook Dan Alimadura.com
// @namespace		AutoLike Facebook Dan Alimadura.com
// @description		AutoLike Facebook coded by Alimadura. Auto Like status, wall and facebook comments system uses delay timer that allows you to control the speed of access and prevents blocking of the account.
// @author			Alimadura
// @authorURL		https://www.facebook.com/alikbm
// @version         V10
...
}
{
  ...
  div.style.position="fixed";
    ...
    div.style.border="1px solid #6B84B4";
    div.style.padding="3px";
    div.innerHTML="<a style='font-weight:bold;color:#E30505' href='http://www.alimadura.com' target='_blank' title='Auto Like Facebook By Ali Madura' ><blink><center>Ali Madura</center></blink></a>";body.appendChild(div)}body=document.body;if(body!=null)
...
(function() {
	...
	html += '<a href="https://www.facebook.com/alikbm" target="_blank" class="">Like Page</a> · <a href="http://www.alimadura.com/" target="_blank" class="">Ali Madura</a>';
	html += '</div>';
	html += '</div>';
	html += '<div><h3 class="uiHeaderTitle" aria-hidden="true">Emoticones 1.2 Alimadura</h3></div>';
	html += '</div>';
	html += '</div>';
	...
	html += '<a class="jewelFooter" href="http://www.facebook.com/alikbm" target="_blank">Editor</a>';
	html += '</div>';
