...
function selection(pos, players) {
  ...
  for (var x=0; x<players.length; x++) {
    ...
    if (players[x][0][2] == pos) {
      ...
      if (pos=="QB") {
        score=parseFloat(players[x][0][9])/18.0 + parseFloat(players[x][0][12])*4.1 - parseFloat(players[x][0][13])*3.0 - 
              parseFloat(players[x][0][19])*2.5 + parseFloat(players[x][0][17]) * 1.2 + (parseFloat(players[x][0][6]) < 80 ? -10000 : 0);
        players[x][0][3]=parseFloat(score)*parseFloat(players[x][0][8]);
      }
      else if (pos=="RB")
        players[x][0][3]=parseFloat(players[x][0][23])/12.0 + parseFloat(players[x][0][26])*3.0 + parseFloat(players[x][0][37])*0.2 - 
                      parseFloat(players[x][0][40])*0.5 + parseFloat(players[x][0][44])* 3.8 + parseFloat(players[x][0][43]) / 14 -
                      parseFloat(players[x][0][33]) * 2.0 + parseFloat(players[x][0][27])*0.25 + parseFloat(players[x][0][24]) * 8.0;
      else if (pos=="FB")
        players[x][0][3]=parseFloat(players[x][0][23])/12.0 + parseFloat(players[x][0][26])*3.0 + parseFloat(players[x][0][37])*0.2 - 
                      parseFloat(players[x][0][40])*0.5 + parseFloat(players[x][0][44])* 3.8 + parseFloat(players[x][0][43]) / 14 -
                      parseFloat(players[x][0][33]) * 2.0 + parseFloat(players[x][0][27])*0.25 + parseFloat(players[x][0][24]) * 8.0;
      else if (pos=="WR")
        players[x][0][3]=parseFloat(players[x][0][43])/10.0 + parseFloat(players[x][0][44]) * 5.0 + parseFloat(players[x][0][37]) * 0.25 - 
                      parseFloat(players[x][0][38]) * 0.8 - parseFloat(players[x][0][50]) * 1.2 + parseFloat(players[x][0][42])*4.0 + parseFloat(players[x][0][48]) * 0.5 - parseFloat(players[x][0][50]) * 1.5 + (parseFloat(players[x][0][37])/(0.01 + parseFloat(players[x][0][38]))) * 75 - (parseInt(players[x][0][37]) <= 55)* 250.0;
      else if (pos=="TE")
        players[x][0][3]=parseFloat(players[x][0][43])/10.0 + parseFloat(players[x][0][44]) * 5.0 + parseFloat(players[x][0][37]) * 0.25 - 
                      parseFloat(players[x][0][40]) * 0.8 - parseFloat(players[x][0][50]) * 1.2 + parseFloat(players[x][0][41])*4.0 + parseFloat(players[x][0][47]) * 0.5 - parseFloat(players[x][0][50]) * 1.5 +(parseFloat(players[x][0][37])/(0.01 + parseFloat(players[x][0][38]))) * 75 - (parseInt(players[x][0][37]) <= 15)* 250.0 +
                      parseFloat(players[x][2][17]) * parseFloat(players[x][2][23]) / 100.0 + parseFloat(players[x][2][12])/8.0;
      else if (pos=="C")
        ...
        players[x][0][3]= (parseFloat(players[x][2][17])-200.0) * (parseFloat(players[x][2][23])-6.7) / 10.0 + 
                          (1.0 - parseFloat(players[x][2][20]) * 35.0 / 100.0) * (parseFloat(players[x][2][18])-300.0) / 5.0 +
                          parseFloat(players[x][2][17])/8.0 + (players[x][2][17] < 150 ? -10000 : 0) + (players[x][2][18] < 150 ? -10000 : 0);
      else if (pos=="DE")
        players[x][0][3]= parseFloat(players[x][1][8]) * 0.8 + parseFloat(players[x][1][11]) * 7.5 + parseFloat(players[x][1][14])* 3.0 + 
                          parseFloat(players[x][1][15])* 6.0 + parseFloat(players[x][1][17]) * 8.0 + parseFloat(players[x][1][18]) * 3.0 +
                          parseFloat(players[x][1][19]) * 1.8 + parseFloat(players[x][1][21]) * 7.5 - parseFloat(players[x][1][10])*2.0;
      else if (pos=="DT")
        players[x][0][3]= parseFloat(players[x][1][8]) * 0.8 + parseFloat(players[x][1][11]) * 7.5 + parseFloat(players[x][1][14])* 3.5 + 
                          parseFloat(players[x][1][15])* 6.0 + parseFloat(players[x][1][17]) * 8.0 + parseFloat(players[x][1][18]) * 3.0 +
                          parseFloat(players[x][1][19]) * 1.8 + parseFloat(players[x][1][21]) * 8.0 - parseFloat(players[x][1][10])*2.0;
      else if (pos=="LB")
        players[x][0][3]= parseFloat(players[x][1][8]) * 0.7 + parseFloat(players[x][1][11]) * 7.0 + parseFloat(players[x][1][14])* 5.0 + 
                          parseFloat(players[x][1][15])* 9.0 + parseFloat(players[x][1][17]) * 6.0 + parseFloat(players[x][1][18]) * 5.5 +
                          parseFloat(players[x][1][19]) * 1.2 + parseFloat(players[x][1][21]) * 6.0 - parseFloat(players[x][1][10])*2.0;
      else if (pos=="CB")
        players[x][0][3]= parseFloat(players[x][1][11]) * 3.8 + parseFloat(players[x][1][14])* 4.5 + 
                          parseFloat(players[x][1][15])* 8.0 + parseFloat(players[x][1][17]) * 4.0 + parseFloat(players[x][1][18]) * 3.5 +
                          parseFloat(players[x][1][19]) * 1.2 + parseFloat(players[x][1][21]) * 4.0 - parseFloat(players[x][1][10])*2.0 - (parseFloat(players[x][1][8])/parseFloat(players[x][1][7]) * 100);
      else if (pos=="S")
        players[x][0][3]= parseFloat(players[x][1][8]) * 0.8 + parseFloat(players[x][1][11]) * 5.5 + parseFloat(players[x][1][14])* 4.0 + 
                          parseFloat(players[x][1][15])* 8.0 + parseFloat(players[x][1][17]) * 4.0 + parseFloat(players[x][1][18]) * 3.5 +
                          parseFloat(players[x][1][19]) * 1.2 + parseFloat(players[x][1][21]) * 4.0 - parseFloat(players[x][1][10])*3.0;
      else if (pos=="K")
    ...
    if (pos=="QB")
      for (var x=0; x<3; x++) {
        newdiv=creatediv("<b>"+list[x][0][0] + " - " + list[x][0][1] + "</b> ATT: <b>" + list[x][0][6] + "</b>, CMP: <b>" + list[x][0][7] +
                         ...
                         "</b>, FMBL: <b>" + list[x][0][19] +"</b>", "QB"+x);
        target.parentNode.insertBefore(newdiv, target);
      }
    else if (pos=="RB")
      for (var x=0; x<3; x++) {
        newdiv=creatediv("<b>"+list[x][0][0] + " - " + list[x][0][1] + "</b> Rush: <b>" + list[x][0][22] + "</b>, YRD: <b>" + list[x][0][23] +
                         "</b>, YPC: <b>" + list[x][0][24] + "</b>, Rush TD: <b>" + list[x][0][26] + "</b>, BTCK: <b>" + list[x][0][27] +
                         "</b>, FMB: <b>" + list[x][0][33] + "</b>, REC: <b>" + list[x][0][37] + "</b>, DRP: <b>" + list[x][0][40] +
      ...
      for (var x=0; x<4; x++) {
      var ratio = (list[x][0][37]/list[x][0][38])*100
      var ratiofixed = ratio.toFixed(2)
        newdiv=creatediv("<b>"+list[x][0][0] + " - " + list[x][0][1] + "</b> REC: <b>" + list[x][0][37] + 
                         "</b>, REC/TGT: <b>" + ratiofixed + "%</b>, DRP: <b>" + list[x][0][40] + "</b>, YPC: <b>" + list[x][0][41] + 
                         "</b>, YRD: <b>" + list[x][0][43] + "</b>, TD: <b>" + list[x][0][44] + 
                         "</b>, YAC: <b>" + list[x][0][46] + "</b>, FD: <b>" + list[x][0][48] + "</b>, FMB: <b>" + list[x][0][50] + "</b>","WR"+x);
        target.parentNode.insertBefore(newdiv, target);
      }
    else if (pos=="TE")
      for (var x=0; x<2; x++) {
      ...
      var ratiofixed = ratio.toFixed(2)
        newdiv=creatediv("<b>"+list[x][0][0] + " - " + list[x][0][1] + "</b> REC: <b>" + list[x][0][37] + 
                         "</b>, REC/TGT: <b>" + ratiofixed + "%</b>, DRP: <b>" + list[x][0][40] + "</b>, YPC: <b>" + list[x][0][41] + 
                         "</b>, YRD: <b>" + list[x][0][43] + "</b>, TD: <b>" + list[x][0][44] + 
                         "</b>, YAC: <b>" + list[x][0][46] + "</b>, FD: <b>" + list[x][0][47] + "</b>, FMB: <b>" + list[x][0][50] + "</b>, ORP: <b>" + list[x][2][17] + "</b>, RBLK: <b>" + list[x][2][22] +
                         "</b>, GRADE: <b>" + list[x][2][23] + "</b>", "TE"+x);
        target.parentNode.insertBefore(newdiv, target);
      }
    else if (pos=="C")
      for (var x=0; x<2; x++) {
      ...
      for (var x=0; x<3; x++) {
        newdiv=creatediv("<b>"+list[x][0][0] + " - " + list[x][0][1] + "</b> TCK: <b>" + list[x][1][8] + "</b> MTCK: <b>" + list[x][1][10] +
                         "</b>, SACK: <b>" + list[x][1][11] + "</b>, PDEF: <b>" + list[x][1][14] + "</b>, INT: <b>" + list[x][1][15] +
                         "</b>, ITD: <b>" + list[x][1][17] + "</b>, FFUM: <b>" + list[x][1][18] + "</b>, FREC: <b>" + list[x][1][19] +
                         "</b>, FTD: <b>" + list[x][1][21] + "</b>", "DE"+x);
        target.parentNode.insertBefore(newdiv, target);
      }
    else if (pos=="DT")
      for (var x=0; x<3; x++) {
...
function parsePlayerStats(intext) {
  ...
  if (readphase<3) {
    ...
    for (var x=0; x<2; x++) {
      ...
      target.parentNode.insertBefore(newdiv, target);    
      if (x==0) newdiv=creatediv("<b>AFC All-Pro Team (script updated 10-18-11)</b>", "heading0"+x);
      else  newdiv=creatediv("<b> NFC All-Pro Team (script updated 10-18-11)</b>", "heading0"+x);
      target.parentNode.insertBefore(newdiv, target);
