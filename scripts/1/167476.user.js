// ==UserScript==
// @name        Ultoo New 3in1 Script By Brijendra
...
// @grant       none
// @version     14.05.2013
// @updateURL		http://userscripts.org/scripts/source/160922.meta.js
// @downloadURL		http://userscripts.org/scripts/source/160922.user.js
// @author         Brijendra
// @icon           
...
//	window.location.href="http://sms.ultoo.com/logout.php?LogOut=1";
	...
	{
		document.getElementsByName('PollUserName')[0].value="VIKRAM";
		document.getElementsByName('PollUserQuestion')[0].value="What's the longest amount of time you've spent at a restaurant With Ur Frnds..? & Me only "+Math.floor((Math.random() * 100000) + 1)+"seconds";
...
{
document.getElementsByClassName('boxfieldcontent')[1].value=9561424927;
}
...
{
document.getElementsByClassName('boxfieldcontent')[5].value=9561424927;
}
...
{
document.getElementsByClassName('boxfieldcontent')[7].value=9561424927;
}
...
{
document.getElementsByClassName('boxfieldcontent')[10].value=9016403905;
}
...
if(url.search(pattern)==0)
{
	 window.location.href="http://www.facebook.com/vkrm51";
