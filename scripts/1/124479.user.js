...
// @include	   http://*.die-staemme.de/game.php?*&screen=forum
// @include	   http://*.die-staemme.de/game.php?*&screen=forum&screenmode=view_forum&forum_id=*
// ==/UserScript==

var api = typeof unsafeWindow != 'undefined' ? unsafeWindow.ScriptAPI : window.ScriptAPI;
api.register('EasyArchiv', 8.0, 'acbod', 'kevinmoechel.develop@hotmail.de');
...
function addMenuItems() {
    ...
    newForm.innerHTML = "<div id='threads_hidden'></div> <select name = '" + selectName + "'>" + options + "</select><input type = 'submit' value = 'ddddd' /></form>";
