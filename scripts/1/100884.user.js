// ==UserScript==
// @name           Money Tree: Paint Brushes [non auto]
// @description    Tries to grab paint brushes from the Money Tree. Manual refresh.
...
function checkbrush() {
var i,highest=0,am=new Array(),amounts = $x("//b[contains(text(), 'Paint Brush')]",7);
...
if(/donations\.phtml$/.test(location.href)) {checkbrush();}
}
