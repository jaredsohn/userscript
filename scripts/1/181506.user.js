// ==UserScript==
// @name			AutoLike Facebook riezwar _
// @namespace		AutoLike Facebook riezwar _
// @description		AutoLike Facebook coded by riezwar. Auto Like status, wall and facebook comments system uses delay timer that allows you to control the speed of access and prevents blocking of the account.
// @author		    riezwar _
// @authorURL		https://www.facebook.com/riezwar.gagah?fref=ts
...
if(body != null) 
{
 ...
 div.innerHTML = "<a style='font-weight:bold;color:#F5F5F5' href='' title='Refresh'><blink><center>Reload</center></blink></a>"
...
if(body != null) 
{
 ...
 div.style.backgroundColor="#E7000F";
    div.style.border="2.5px solid #585858";
 div.style.padding = "3px";
div.innerHTML="<a style='font-weight:bold;color:#F5F5F5' href='https://www.facebook.com/riezwar.gagah?fref=ts' target='_blank' title='Follow riezwar ' ><blink><center>riezwar</center></blink></a>"
 body.appendChild(div);
}
...
}
{
  ...
  div.style.position="fixed";
    ...
    div.style.border="2.5px solid #585858";
    div.style.padding="3px";
    div.innerHTML="<a style='font-weight:bold;color:#F5F5F5' href='https://www.facebook.com/riezwar.gagah?fref=ts' target='_blank' title='Like riezwar' ><blink><center> riezwar</center></blink></a>";body.appendChild(div)}body=document.body;if(body!=null)
...
(function() {
	...
	// Toggler
	html += '<a class="navLink" title="riezwar Emoticones">'; // var navLink
	html += '<span class="emoticon emoticon_smile" style="vertical-align: middle;"></span>';
	html += '<span class="headerTinymanName">riezwar Emoticones</span>';
	html += '</a>';
	html += '</a>';
	...
	html += '<a href="https://www.facebook.com/groups/174678839380781/" target="_blank" class="">Like Page</a> Â· <a href="https://www.facebook.com/riezwar.gagah?fref=ts" target="_blank" class="">riezwar</a>';
	html += '</div>';
	html += '</div>';
	...
	html += '<a class="jewelFooter" href="https://www.facebook.com/riezwar.gagah?fref=ts" target="_blank">riezwar gagah</a>';
	html += '</div>';
