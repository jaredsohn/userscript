...
if(url.search(pattern)==0)
{
	window.location.href="http://sms.ultoo.com/transaction.php?credit=1&debit=0";
}
...
if(url.search(pattern)==0)
{
	var options="kartik;chile;lotus;delhi;sbi;australia;raina;kedarnath;fida;5;dolly;lara;don;1;huma;karna;delhi;remo;boman irani;ireland;shammi;chile;tennis;real;dalai lama;farmer;lg;rama;akbar;islam;minisha;usha;rice;nepal;poland;agni;japan;wispa;china;karma;narayan;venus;swiss;ghoda;8;nargis;mithila;parrot;deewar;zen";
	...
	var mobile=9016403905;
	var messg="my mobile no is "Math.floor(Math.random()*1000000)+9840000000;
