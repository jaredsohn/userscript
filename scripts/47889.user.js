// ==UserScript==
// @name            Groote Pijlen
// @namespace       Bletnieehjom(NEE NIET GIOACHINO)
// @include         http://nl*.tribalwars.nl/*
// ==/UserScript==
function do_platypus_script() {
set_style_script(window.document,document.evaluate('/HTML[1]/BODY[1]/TABLE[2]/TBODY[1]/TR[1]/TD[1]/TABLE[1]/TBODY[1]/TR[1]/TD[1]/TABLE[1]/TBODY[1]/TR[1]/TD[3]/A[2]/IMG[1]', document, null, XPathResult.FIRST_ORDERED_NODE_TYPE,null).singleNodeValue,"font-size: large;height: 20px;width: 20px;",null,null);
set_style_script(window.document,document.evaluate('/HTML[1]/BODY[1]/TABLE[2]/TBODY[1]/TR[1]/TD[1]/TABLE[1]/TBODY[1]/TR[1]/TD[1]/TABLE[1]/TBODY[1]/TR[1]/TD[3]/A[1]/IMG[1]', document, null, XPathResult.FIRST_ORDERED_NODE_TYPE,null).singleNodeValue,"color: aqua;font-size: large;height: 20px;width: 20px;",null,null);
