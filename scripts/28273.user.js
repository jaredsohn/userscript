...
function linkInsert()
{
	...
	if(dtest.snapshotItem(0))
	{
		...
		'<tr>'+
		'<td align="center"><a href="build.php?gid=17"><img src="img/un/g/g17.gif" title="انتقل الى السوق" style="margin:0 5px"/></a></td>'+
		'<td align="center"><a href="build.php?gid=19"><img src="img/un/g/g19.gif" title="انتقل الى الثكنة" style="margin:0 5px"/></a></td>'+
		'<td align="center"><a href="allianz.php"><img src="img/un/g/g18.gif" title="النتقل الى التحالف" style="margin:0 5px"/></td>'+
	  '</tr>'+
		'<tr>'+
		'<td align="center"><a href="build.php?gid=20"><img src="img/un/g/g20.gif" title="انتقل الاسطبل" style="margin:0 5px"/></a></td>'+
		'<td align="center"><a href="build.php?gid=16"><img src="img/un/g/g16.gif" title="انتقل الى ساحة البطولة" style="margin:0 5px"/></a></td>'+
		'<td align="center">&nbsp;</td>'+
	  '</tr>'
	'</table>';
