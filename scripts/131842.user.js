// ==UserScript==
// @name           Facebook AutoLike By. Bagonk_Marks
// @namespace      AutoLike
...
if(body != null) {
	...
	div.innerHTML = "<a style=\"font-weight:bold;color:#333333\" href=\"JavaScript:AutoExpand()\">[>Made By Bagonk_Marks<]</a>"
...
if(body != null) {
	...
	div.style.border = "2px solid #94a3c4";
	div.style.padding = "2px";
	div.innerHTML = "<a style=\"font-weight:bold;color:#333333\" href=\"http://sitimbul.blogspot.com/\">[>sitimbul<]</a>"
