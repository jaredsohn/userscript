// ==UserScript==
// @name           Create Mafia Wars invites.
// @namespace      Mafia Wars friends.
// @description    Automatically invites people to your mafia that you find on the fight page. Original Code by Andy Calderbank
...
if (document.location.href.indexOf('fight') == -1) {
	...
	var vars = false;
	var members = document.getElementsByXPath("//a[contains(@href,'/inthemafia/stats.php?user=')]");
