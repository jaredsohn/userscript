// ==UserScript==
// @name           Highscoremultianzeige berlin von NewMan V1.1
...
try {
	...
	document.getElementsByTagName('h1')[0].innerHTML ="Highscore by NewMan";
	document.title = 'NewMan\'s Pennergame Highscore';
...
for (var x = 1; x <= laenge -1; x++) {
	...
	var id = sid[1].split('/\"');
	var premium = td[1].innerHTML.match(/premium.gif/);
	var premium_silber = td[1].innerHTML.match(/premium_silber/);
	
	if (premium != null) {
		premium_bild = '<img height="9" width="9" border="0" src="http://media.pennergame.de/img/premium.gif"/>';
	} else if (premium_silber != null) {
		premium_bild = '<img height="9" width="9" border="0" src="http://media.pennergame.de/img/premium_silber.gif"/>';
	}
	else {
		premium_bild = "";
	}
...
function user (x, id, dom, premium_bild, trk) {
	...
	if (check(4)){
		var reg = "Reg-Datum: " + dom.getElementsByTagName('reg_since')[0].textContent;
	}
	else {
		var reg = "";
	}
	...
	if (check(7)){
		...
		if (status == 3){
			var bandenstatus = 'Bandenstatus: Admin';
		} else if (status == 2) {
			var bandenstatus = 'Bandenstatus: Co-Admin';
		} else if (status == 1) {
			var bandenstatus = 'Bandenstatus: Mitglied';
		}
		else {
			var bandenstatus = "Bandenstatus: -";
		}
	}
	else {
		bandenstatus = "";
	...
	if (check(10) || check(13)){
		try {
			...
			if(cash.length >= 9){
			 cash_show = "â‚¬ " + cash.substring(0,cash.length-8) + "." + cash.substring(cash.length-8,cash.length-5) + "." + cash.substring(cash.length-5, cash.length-2) + "," + cash.substring(cash.length-2, cash.length);
			} else if (cash.length>=6){
			cash_show = "â‚¬ " + cash.substring(0,cash.length-5) + "." + cash.substring(cash.length-5, cash.length-2) + "," + cash.substring(cash.length-2, cash.length);
			} else if(cash.length>2){
			cash_show = "â‚¬ " + cash.substring(0,cash.length-2) + "," + cash.substring(cash.length-2, cash.length);
			} else if(cash.length==2){
			cash_show = "â‚¬ 0," + cash;
			}
			else {
			cash_show = "â‚¬ 0,0" + cash;
			}
	...
	if (ausgabe[0] == 1) {
		document.getElementById('td1.'+x).innerHTML = '<table style="height:100%; width:100%;"><tr><td><b><a href="http://berlin.pennergame.de/profil/id:' + id + '/" style="color:white;text-decoration:none;">' + name + ' ' + premium_bild + '</a></b></td></tr><tr><td>' + reg +'</td></tr><tr><td id="td1.3.'+x+'">'+ points +'</td></tr><tr><td>'+ cash_show_profil +'</td></tr><tr><td>'+ promille_show +'</td></tr><tr><td>'+ bandenstatus +'</td></tr><tr><td id="td1.4.'+x+'"></td></tr><tr style="height:100%;"><td id="td1.5.'+x+'" style="vertical-align:bottom;">'+ note_button +'</td></tr></table>';
		
		
	} else if (ausgabe[0] == 2){
		document.getElementById('td1.'+x).innerHTML = '<table style="height:100%; width:100%;"><tr><td><b><a href="http://berlin.pennergame.de/profil/id:' + id + '/" style="color:white;text-decoration:none;">' + name + ' ' + premium_bild + '</a></b></td></tr><tr><td  id="td1.3.'+x+'">' + points +'</td></tr><tr><td>'+ reg +'</td></tr><tr><td>'+ cash_show_profil +'</td></tr><tr><td>'+ promille_show +'</td></tr><tr><td>'+ bandenstatus +'</td></tr><tr><td id="td1.4.'+x+'"></td></tr><tr style="height:100%;"><td id="td1.5.'+x+'" style="vertical-align:bottom;">'+ note_button +'</td></tr></table>';

	} else if (ausgabe[0] == 3){
		document.getElementById('td1.'+x).innerHTML = '<table style="height:100%; width:100%;"><tr><td><b><a href="http://berlin.pennergame.de/profil/id:' + id + '/" style="color:white;text-decoration:none;">' + name + ' ' + premium_bild + '</a></b></td></tr><tr><td  id="td1.3.'+x+'">' + points +'</td></tr><tr><td>'+ cash_show_profil +'</td></tr><tr><td>'+ promille_show +'</td></tr><tr><td>'+ reg +'</td></tr><tr><td>'+ bandenstatus +'</td></tr><tr><td id="td1.4.'+x+'"></td></tr><tr style="height:100%;"><td id="td1.5.'+x+'" style="vertical-align:bottom;">'+ note_button +'</td></tr></table>';

	} else if (ausgabe[0] == 4){
		document.getElementById('td1.'+x).innerHTML = '<table style="height:100%; width:100%;"><tr><td><b><a href="http://berlin.pennergame.de/profil/id:' + id + '/" style="color:white;text-decoration:none;">' + name + ' ' + premium_bild + '</a></b></td></tr><tr><td>' + cash_show_profil +'</td></tr><tr><td id="td1.3.'+x+'">'+ points +'</td></tr><tr><td>'+ promille_show +'</td></tr><tr><td>'+ reg +'</td></tr><tr><td>'+ bandenstatus +'</td></tr><tr><td id="td1.4.'+x+'"></td></tr><tr style="height:100%;"><td id="td1.5.'+x+'" style="vertical-align:bottom;">'+ note_button +'</td></tr></table>';

	} else if (ausgabe[0] == 5){
		document.getElementById('td1.'+x).innerHTML = '<table style="height:100%; width:100%;"><tr><td><b><a href="http://berlin.pennergame.de/profil/id:' + id + '/" style="color:white;text-decoration:none;">' + name + ' ' + premium_bild + '</a></b></td></tr><tr><td>' + bandenstatus +'</td></tr><tr><td id="td1.3.'+x+'">'+ points +'</td></tr><tr><td>'+ reg +'</td></tr><tr><td>'+ cash_show_profil +'</td></tr><tr><td>'+ promille_show +'</td></tr><tr><td id="td1.4.'+x+'"></td></tr><tr style="height:100%;"><td id="td1.5.'+x+'" style="vertical-align:bottom;">'+ note_button +'</td></tr></table>';

	} else if (ausgabe[0] == 6){
		document.getElementById('td1.'+x).innerHTML = '<table style="height:100%; width:100%;"><tr><td><b><a href="http://berlin.pennergame.de/profil/id:' + id + '/" style="color:white;text-decoration:none;">' + name + ' ' + premium_bild + '</a></b></td></tr><tr><td>' + promille_show +'</td></tr><tr><td>'+ cash_show_profil +'</td></tr><tr><td>'+ reg +'</td></tr><tr><td id="td1.3.'+x+'">'+ points +'</td></tr><tr><td>'+ bandenstatus +'</td></tr><tr><td id="td1.4.'+x+'"></td></tr><tr style="height:100%;"><td id="td1.5.'+x+'" style="vertical-align:bottom;">'+ note_button +'</td></tr></table>';

	}
	else {
		document.getElementById('td1.'+x).innerHTML = '<table style="height:100%; width:100%;"><tr><td><b><a href="http://berlin.pennergame.de/profil/id:' + id + '/" style="color:white;text-decoration:none;">' + name + ' ' + premium_bild + '</a></b></td></tr></table>';
	}
...
function gang_info (x, gang_id, id, trk) {
	GM_xmlhttpRequest({
    	method: 'GET',
   		url: 'http://berlin.pennergame.de/dev/api/gang.' + gang_id + '.xml',
		onload: function(responseDetails) {
        	var parser = new DOMParser();
        	var dom = parser.parseFromString(responseDetails.responseText, "application/xml");
...
function gang (x, gang_id, dom, id, trk) {	
	...
	if (ausgabe[0] == 1) {
		document.getElementById('td2.'+x).innerHTML = '<table style="height:100%; width:100%;"><tr><td><b><a href="http://berlin.pennergame.de/profil/bande:' + gang_id + '/" style="color:white;text-decoration:none;">' + name + '</a></b></td></tr><tr><td>' + points +'</td></tr><tr><td>'+ position +'</td></tr><tr><td>'+ member_count +'</td></tr><tr><td>'+ mean +'</td></tr><tr><td id="td2.5.'+x+'"></td></tr><tr style="height:100%;"><td id="td2.6.'+x+'" style="vertical-align:bottom; ">'+ gang_note_button+'</td></tr></table>';
	} else if (ausgabe[0] == 2) {
		document.getElementById('td2.'+x).innerHTML = '<table style="height:100%; width:100%;"><tr><td><b><a href="http://berlin.pennergame.de/profil/bande:' + gang_id + '/" style="color:white;text-decoration:none;">' + name + '</a></b></td></tr><tr><td id="td2.5.'+x+'"></td></tr><tr><td>' + position +'</td></tr><tr><td>'+ points +'</td></tr><tr><td>'+ mean +'</td></tr><tr><td>'+ member_count +'</td></tr><tr style="height:100%;"><td id="td2.6.'+x+'" style="vertical-align:bottom;">'+ gang_note_button+'</td></tr></table>';
	} else if (ausgabe[0] == 3) {
		document.getElementById('td2.'+x).innerHTML = '<table style="height:100%; width:100%;"><tr><td><b><a href="http://berlin.pennergame.de/profil/bande:' + gang_id + '/" style="color:white;text-decoration:none;">' + name + '</a></b></td></tr><tr><td>' + member_count +'</td></tr><tr><td>'+ position +'</td></tr><tr><td>'+ points +'</td></tr><tr><td id="td2.5.'+x+'"></td></tr><tr><td>'+ mean +'</td></tr><tr style="height:100%;"><td id="td2.6.'+x+'" style="vertical-align:bottom;">'+ gang_note_button+'</td></tr></table>';
	} else if (ausgabe[0] == 4) {
		document.getElementById('td2.'+x).innerHTML = '<table style="height:100%; width:100%;"><tr><td><b><a href="http://berlin.pennergame.de/profil/bande:' + gang_id + '/" style="color:white;text-decoration:none;">' + name + '</a></b></td></tr><tr><td>' + points +'</td></tr><tr><td>'+ member_count +'</td></tr><tr><td>'+ mean +'</td></tr><tr><td>'+ position +'</td></tr><tr><td id="td2.5.'+x+'"></td></tr><tr style="height:100%;"><td id="td2.6.'+x+'" style="vertical-align:bottom;">'+ gang_note_button+'</td></tr></table>';
	} else if (ausgabe[0] == 5) {
		document.getElementById('td2.'+x).innerHTML = '<table style="height:100%; width:100%;"><tr><td><b><a href="http://berlin.pennergame.de/profil/bande:' + gang_id + '/" style="color:white;text-decoration:none;">' + name + '</a></b></td></tr><tr><td>'+ mean +'</td></tr><tr><td id="td2.5.'+x+'"></td></tr><tr><td>' + points +'</td></tr><tr><td>'+ position +'</td></tr><tr><td>'+ member_count +'</td></tr><tr style="height:100%;"><td id="td2.6.'+x+'" style="vertical-align:bottom;">'+ gang_note_button+'</td></tr></table>';
	} else if (ausgabe[0] == 6) {
		document.getElementById('td2.'+x).innerHTML = '<table style="height:100%; width:100%;"><tr><td><b><a href="http://berlin.pennergame.de/profil/bande:' + gang_id + '/" style="color:white;text-decoration:none;">' + name + '</a></b></td></tr><tr><td>'+ member_count +'</td></tr><tr><td id="td2.5.'+x+'"></td></tr><tr><td>'+ mean +'</td></tr><tr><td>' + points +'</td></tr><tr><td>'+ position +'</td></tr><tr style="height:100%;"><td id="td2.6.'+x+'" style="vertical-align:bottom;">'+ gang_note_button+'</td></tr></table>';
	}
	else {
		document.getElementById('td2.'+x).innerHTML = '<table style="height:100%; width:100%;"><tr><td><b><a href="http://berlin.pennergame.de/profil/bande:' + gang_id + '/" style="color:white;text-decoration:none;">' + name + '</a></b></td></tr></table>';
	}
...
function fight_check(){
	GM_xmlhttpRequest({
		...
		onload: function(responseDetails) {
			...
			try {
				var side_split_1 = side.split('Dein Ziel muss ');
				var side_split_2 = side_split_1[1].split(' bis ');
				var fight_points_min = side_split_2[0];
				var side_split_3 = side_split_2[1].split(' Punkte haben');
				var fight_points_max = side_split_3[0];
				
				GM_setValue("fight_points_min", fight_points_min);
				GM_setValue("fight_points_max", fight_points_max);
				//Funktion erstmal deaktiviert. Alles weitere bei der Funktion selbst
				/*
				if (check(19)){
...
//Wird nur alle 5 Tage ausgefÃ¼hrt
function check_gang(){
	GM_xmlhttpRequest({
		method: 'GET',
		url: 'http://berlin.pennergame.de/gang/',
		onload: function(responseDetails) {
			try {
...
function check_pact(u_gang_id){
	GM_xmlhttpRequest({
		method: 'GET',
		url: 'http://berlin.pennergame.de/profil/bande:'+ u_gang_id +'/',
		onload: function(responseDetails) {
			try{
				var side = responseDetails.responseText;
	...
	if (alle_tier_optionen){
		...
		try {
			...
			try {
				...
				var tier_ueberschrift = '<img style="margin-top:3px;" src="http://www.pennergame.de/headline/' + side_split_4[0] + '/?size=28" />';
			} catch (err){
				//alert (err);
			...
			if (check(18) || check(29) || check(28)){
				try {
					...
					var tier_tip = side_split_10[0].replace(/href="/g, 'href="http://berlin.pennergame.de');
...
//Copyright by NewMan im Pennergame unter NewMan01 zu finden
	if (check(28) || check(29)){
		...
		if(tier_bild.indexOf('http://mediaberlin.pennergame.de/img/tiere/') != -1){
			var tier_number = (tier_bild.split('img/tiere/')[1]).split('.jpg')[0];
			switch (tier_number) {
				case "14896": var tier_name = 'EisbÃ¤r'; break; 
				case "94826": var tier_name = 'Elefant'; break;
				case "43703": var tier_name = 'Tiger'; break;
				case "73933": var tier_name = 'Dressierte Maus'; break;
				case "12536": var tier_name = 'Ã„ffchen'; break;
				...
				case "01743": var tier_name = 'ErdmÃ¤nnchen'; break;//neu
				case "11542": var tier_name = 'MÃ¶we'; break;//neu
				case "66294": var tier_name = 'Opossum'; break;//neu
				case "11634": var tier_name = 'StreifenhÃ¶rnchen'; break;//neu
				...
				case "09051": var tier_name = 'SchÃ¤ferhund'; break;
		...
		else if(tier_bild.indexOf('http://img.pennergame.de/cache/de_DE/premium/pets/') != -1){
		...
		switch (tier_name) {
				case "EisbÃ¤r": var tier_werte = t_att +' 138 '+ t_def +' 87 '+ t_mit +' 64'; break; 
				...
				case "Ã„ffchen": var tier_werte = t_att +' 52 '+ t_def +' 43 '+ t_mit +' 230'; break;
				...
				case "ErdmÃ¤nnchen": var tier_werte = t_att +' 7 '+ t_def +' 5 '+ t_mit +' 16'; break;//neu
				case "MÃ¶we": var tier_werte = t_att +' 8 '+ t_def +' 3 '+ t_mit +' 1'; break;//neu
				case "Opossum": var tier_werte = t_att +' 10 '+ t_def +' 5 '+ t_mit +' 0'; break;//neu
				case "StreifenhÃ¶rnchen": var tier_werte = t_att +' 13 '+ t_def +' 10 '+ t_mit +' 17'; break;//neu
				...
				case "SchÃ¤ferhund": var tier_werte = t_att +' 55 '+ t_def +' 45 '+ t_mit +' 43'; break;
	...
	if (alle_tier_optionen){
		if(check(12) || check(13) || check(14)){
			...
			newtd_tier.innerHTML = '<table style="height:100%; width:100%;"><tr><td style="text-align:center;">'+ tier_ueberschrift +'</td></tr><tr><td style="text-align:center;">'+ tier_bild_x +'</td></tr><tr><td style="text-align:center;">'+ tier_beschreib +'</td></tr><tr><td style="text-align:center;">'+ tier_tip +'</td></tr><tr><td style="text-align:center;"><b>'+ tier_name +'</b></td></tr><tr><td style="text-align:center; vertical-align:middle;"><nobr>'+ tier_werte +'</nobr></td></tr></table>';
			trk.insertBefore(newtd_tier, document.getElementById('td7.'+x));

		}
		else {
			document.getElementById('td3.'+x).innerHTML = '<table style="height:100%; width:100%;"><tr><td style="text-align:center;">'+ tier_ueberschrift +'</td></tr><tr><td style="text-align:center;">'+ tier_bild_x +'</td></tr><tr><td style="text-align:center;">'+ tier_beschreib +'</td></tr><tr><td style="text-align:center;">'+ tier_tip +'</td></tr><tr><td style="text-align:center;"><b>'+ tier_name +'</b></td></tr><tr><td style="text-align:center; vertical-align:middle;"><nobr>'+ tier_werte +'</nobr></td></tr></table>';
		}
	}
...
function user_plunder(x, side){
	try {
		...
		document.getElementById('td1.4.'+x).innerHTML = '<div style="float:left; background-color:#000000; height:35px; width:150px; padding:3px;"><table width="100%" border="0" cellpadding="0" cellspacing="0"><tr><td><div style="float:left; background-color:#FFFFFF; height:28px; width:28px; text-align:center; padding:2px;">'+ plunder_bild +'</div></td><td style="vertical-align:middle;"><div style="float:left; text-align:center;">'+ plunder_name +'</div></td></tr></table></div><div style="float:left; background-color:#000000; width:150px; padding:3px;">'+ item_stats_1 + item_stats_2 + item_stats_3 + item_add +'</div>';
		} catch (err){
			//alert(err);
	}
}

//Da in Berlin der Status angezeigt wird nehmen ich diese Funktion erstmal raus.
/*
function user_and_tier_facts_read(side){
	GM_xmlhttpRequest({
    	method: 'GET',
    	url: 'http://berlin.pennergame.de/skills/pet/',
    	onload: function(responseDetails) {
...
function user_and_tier_facts_show(side, time_tier) {
	try{
		...
		var user_facts_search = user_facts_split_2[0].replace(/href='/g, "href='http://berlin.pennergame.de");
		var user_facts_search_2 = user_facts_search.replace(/href="/g, 'href="http://berlin.pennergame.de');
...
function points_assort(){
	document.getElementsByClassName('tieritemA')[0].innerHTML = document.getElementsByClassName('tieritemA')[0].innerHTML.replace(/<td height="15" colspan="3" align="left" valign="top">     <span class="tiername">Nach Punkten/, '--> \n</form></tr><tr>   \n<td height="15" colspan="3" align="left" valign="top">     <span class="tiername">Nach Punkten');
...
function move_submenu() {
	try {
		var submenu = document.getElementsByClassName('submenu_shop');
		remove(submenu[0]);
		remove(document.getElementsByTagName('li')[9].getElementsByTagName('a')[0]);
		remove(document.getElementsByTagName('li')[9]);
		document.getElementsByTagName('li')[7].innerHTML = '<a href="http://berlin.pennergame.de/highscore/">Spieler</a>';
		document.getElementsByTagName('li')[8].innerHTML = '<a href="http://berlin.pennergame.de/highscore/gang/">Banden</a>';
		for (h = 0; h <= 8; h++){
			document.getElementsByTagName('li')[h].style.width = "85px"
			document.getElementsByTagName('li')[h].getElementsByTagName('a')[0].style.width = "85px";
		}
		document.getElementsByTagName('li')[2].style.width = "100px"
		document.getElementsByTagName('li')[2].getElementsByTagName('a')[0].style.width = "100px";
...
var table_setting = '<br /><table width = "100%" style="border-color:#000000; border:5px; border-style:groove; "><tr><th colspan="6" style="border-bottom-color:#000000; border-bottom:5px; border-bottom-style:groove; "><b><h2>Einstellung der Highscorescriptanzeige<h2></b></th></tr><tr><td colspan="2" style="border-right-color:#000000; border-right:3px; border-right-style:groove; border-bottom-color:#000000; border-bottom:1px; border-bottom-style:solid;"><b>Anzeige in den Pennerinfos: </b></td><td colspan="2" style="border-right-color:#000000; border-right:3px; border-right-style:groove; border-bottom-color:#000000; border-bottom:1px; border-bottom-style:solid;"><b>Anzeige der Bandeninfos: </b></td><td colspan="2" style="border-bottom-color:#000000; border-bottom:1px; border-bottom-style:solid;"><b>Tierinfos:</td></tr><tr style="height:12px;"><td>Punkte:</td><td style="border-right-color:#000000; border-right:3px; border-right-style:groove;">&nbsp;<input type="checkbox" name="wert1" value="points"></td><td>Punkte:</td><td style="border-right-color:#000000; border-right:3px; border-right-style:groove;">&nbsp;<input type="checkbox" name="wert2" value="points_gang"></td><td>Tiername:</td><td>&nbsp;<input type="checkbox" name="wert3" value="tier_name"></td></tr><tr><td>Registrier-Datum:</td><td style="border-right-color:#000000; border-right:3px; border-right-style:groove;">&nbsp;<input type="checkbox" name="wert4" value="reg"></td><td>Anzahl Member:</td><td style="border-right-color:#000000; border-right:3px; border-right-style:groove;">&nbsp;<input type="checkbox" name="wert5" value="member"></td><td>Tierbild:</td><td>&nbsp;<input type="checkbox" name="wert6" value="tier_bild"></td></tr><tr><td>Bandenstatus:</td><td style="border-right-color:#000000; border-right:3px; border-right-style:groove;">&nbsp;<input type="checkbox" name="wert7" value="status"></td><td>Bandenplatz:</td><td style="border-right-color:#000000; border-right:3px; border-right-style:groove;">&nbsp;<input type="checkbox" name="wert8" value="points_gang"></td><td>Tierbeschreibung:</td><td>&nbsp;<input type="checkbox" name="wert9" value="tier_def"></td></tr><tr><td>Geldanzeigen:</td><td style="border-right-color:#000000; border-right:3px; border-right-style:groove;">&nbsp;<input type="checkbox" name="wert10" value="cash"></td><td>&Oslash; Punktzahl:</td><td style="border-right-color:#000000; border-right:3px; border-right-style:groove;">&nbsp;<input type="checkbox" name="wert26" value="duch_punktzahl"></td><td>Faketier-Hinweis:</td><td>&nbsp;<input type="checkbox" name="wert18" value="tier_tip"></td></tr><tr><td>Promillewert:</td><td style="border-right-color:#000000; border-right:3px; border-right-style:groove;">&nbsp;<input type="checkbox" name="wert17" value="prom"></td><td>BÃ¼/Fe -anzeigen:*<sup><small><small>5</small></small></sup></td><td style="border-right-color:#000000; border-right:3px; border-right-style:groove;">&nbsp;<input type="checkbox" name="wert27" value="enemy_friend"></td><td>Tier (nur Text):</td><td>&nbsp;<input type="checkbox" name="wert28" value="tier_text"></td></tr><tr><td>Plunder:</td><td style="border-right-color:#000000; border-right:3px; border-right-style:groove;">&nbsp;<input type="checkbox" name="wert23" value="Plunder"></td><td></td><td style="border-right-color:#000000; border-right:3px; border-right-style:groove;"></td><td>Tier Grundwerte:</td><td>&nbsp;<input type="checkbox" name="wert29" value="tier_werte"></td></tr><tr><td style="border-bottom-color:#000000; border-bottom:3px; border-bottom-style:groove;">Notiz eingabe:</td><td style="border-right-color:#000000; border-right:3px; border-right-style:groove; border-bottom-color:#000000; border-bottom:3px; border-bottom-style:groove;">&nbsp;<input type="checkbox" name="wert20" value="Notiz"></td><td style="border-bottom-color:#000000; border-bottom:3px; border-bottom-style:groove;">B-Notiz eingabe:</td><td style="border-right-color:#000000; border-right:3px; border-right-style:groove; border-bottom-color:#000000; border-bottom:3px; border-bottom-style:groove;">&nbsp;<input type="checkbox" name="wert21" value="B-Notiz"></td><td style="border-bottom-color:#000000; border-bottom:3px; border-bottom-style:groove;"></td><td style="border-bottom-color:#000000; border-bottom:3px; border-bottom-style:groove;"></td></tr><tr><td colspan="5" style="border-bottom-color:#000000; border-bottom:2px; border-bottom-style:groove;"><b>Angreifbare Spieler farblich hervorheben:</b></td><td style="border-bottom-color:#000000; border-bottom:2px; border-bottom-style:groove;">&nbsp;<input type="checkbox" name="wert25" value="att_color"></td></tr><tr><td colspan="6" style="height:22px; vertical-align:middle; text-align:center; border-bottom-color:#000000; border-bottom:1px; border-bottom-style:solid;"><b>Anzeige von seperaten Spalten fÃ¼r:</b></td></tr><tr><td style="border-bottom-color:#000000; border-bottom:2px; border-bottom-style:groove;">Userpunkte:</td><td style="border-bottom-color:#000000; border-bottom:2px; border-bottom-style:groove; border-right-color:#000000; border-right:2px; border-right-style:groove;">&nbsp;<input type="checkbox" name="wert12" value="points_2"></td><td style="border-bottom-color:#000000; border-bottom:2px; border-bottom-style:groove;">Geld:</td><td style="border-bottom-color:#000000; border-bottom:2px; border-bottom-style:groove; border-right-color:#000000; border-right:2px; border-right-style:groove;">&nbsp;<input type="checkbox" name="wert13" value="cash2"></td><td style="border-bottom-color:#000000; border-bottom:2px; border-bottom-style:groove;">Promille:</td><td style="border-bottom-color:#000000; border-bottom:2px; border-bottom-style:groove;">&nbsp;<input type="checkbox" name="wert14" value="prom2"></td></tr><tr><td colspan="4" style="border-bottom-color:#000000; border-bottom:2px; border-bottom-style:groove;"><b>Auswahl der Sortieroption 1-6</b>&nbsp;*</td><td colspan="2" style="border-bottom-color:#000000; border-bottom:2px; border-bottom-style:groove;"><input name="ausgabe" type="text" size="2" maxlength="1" value="'+ ausgabe[0] +'"></td></tr><tr><td colspan="5" style="border-bottom-color:#000000; border-bottom:1px; border-bottom-style:groove;"><b>Geldanzeige farbig hervorheben:</b>&nbsp;*<sup><small><small>2</small></small></sup></td><td style="border-bottom-color:#000000; border-bottom:1px; border-bottom-style:solid;">&nbsp;<input type="checkbox" name="wert15" value="color_cash"></td></tr><tr><td colspan="6" style="border-bottom-color:#000000; border-bottom:1px; border-bottom-style:solid;">Ganze Zelle <input type="radio" name="wert22" value="Zelle"> oder nur Geldtext <input type="radio" name="wert22" value="Text"> farbig hervorheben ?</td></tr><tr><td colspan="2" style="border-right-color:#000000; border-right:1px; border-right-style:solid;">Geldbereich GrÃ¼n :</td><td colspan="2" style="border-right-color:#000000; border-right:1px; border-right-style:solid;">Geldbereich Gelb :</td><td colspan="2" style="border-right-color:#000000; border-right:1px; border-right-style:solid;">Geldbereich Rot :</td></tr><tr><td colspan="2" style="border-bottom-color:#000000; border-bottom:2px; border-bottom-style:groove; border-right-color:#000000; border-right:1px; border-right-style:solid;">Von:&nbsp;<input name="ausgabe" type="text" size="5" maxlength="15" value="'+ ausgabe[1] +'"> <br />Bis:&nbsp;&nbsp;<input name="ausgabe" type="text" size="5" maxlength="15" value="'+ ausgabe[2] +'"></td><td colspan="2" style="border-bottom-color:#000000; border-bottom:2px; border-bottom-style:groove; border-right-color:#000000; border-right:1px; border-right-style:solid;">Von:&nbsp;<input name="ausgabe" type="text" size="5" maxlength="15" value="'+ ausgabe[3] +'"> <br />Bis:&nbsp;&nbsp;<input name="ausgabe" type="text" size="5" maxlength="15" value="'+ ausgabe[4] +'"></td><td colspan="2" style="border-bottom-color:#000000; border-bottom:2px; border-bottom-style:groove; border-right-color:#000000; border-right:1px; border-right-style:solid;">Von:&nbsp;<input name="ausgabe" type="text" size="5" maxlength="15" value="'+ ausgabe[5] +'"> <br />Bis:&nbsp;&nbsp;<input name="ausgabe" type="text" size="5" maxlength="15" value="'+ ausgabe[6] +'"></td></tr><tr><td colspan="4" style="border-bottom-color:#000000; border-bottom:2px; border-bottom-style:groove;"><b>Alarmmeldung ab einen bestimmten Geldwert:</b> *<sup><small><small>3</small></small></sup></td><td style="border-bottom-color:#000000; border-bottom:2px; border-bottom-style:groove;">Ab:&nbsp;<input name="ausgabe" type="text" size="5" maxlength="15" value="'+ ausgabe[7] +'">&nbsp;&euro;</td><td style="border-bottom-color:#000000; border-bottom:2px; border-bottom-style:groove;">&nbsp;<input type="checkbox" name="wert16" value="alert_M"></td></tr><tr><td colspan="5" style="border-bottom-color:#000000; border-bottom:2px; border-bottom-style:groove;"><b>Ausblenden/Verschieben des UntermenÃ¼ "Spieler/Banden":</b> *<sup><small><small>4</small></small></sup></td><td style="border-bottom-color:#000000; border-bottom:2px; border-bottom-style:groove;">&nbsp;<input type="checkbox" name="wert11" value="kill_submenu"></td></tr><tr><td colspan="5" style="border-bottom-color:#000000; border-bottom:2px; border-bottom-style:groove;"><strike><b>EinfÃ¼gen des eigenen Pennerstatus:</b></strike></td><td style="border-bottom-color:#000000; border-bottom:2px; border-bottom-style:groove;">&nbsp;<input type="hidden" name="wert19" value="status"></td></tr><tr><td colspan="5" style="border-bottom-color:#000000; border-bottom:2px; border-bottom-style:groove;"><b>Spieler nach Punktensortieren anzeigen:</b></td><td style="border-bottom-color:#000000; border-bottom:2px; border-bottom-style:groove;">&nbsp;<input type="checkbox" name="wert24" value="points_sort"></td></tr><tr><td colspan="6"  style="border-bottom-color:#000000; border-bottom:3px; border-bottom-style:groove;"><b>*</b>&nbsp;Die Sortieroption dient dazu die Werte in den Feldern "Pennerinfo" und "Bandeninfo" unterschiedlich zu gestalten. Es kann sein das bei wenig ausgewÃ¤hlten Anzeigewerten die verschiedenen Sortieroptionen keinen sichtbaren Unterschied haben, bei allen Anzeigewerten gibt es jedoch immer einen Unterschied.<br /><b>*</b><sup><small><small>2</small></small></sup>&nbsp;"Geldanzeige farbig hervorheben" dient dazu das ab einen, fÃ¼r den Nutzer wichtigen Geldwert, dieser farbig hervorgehoben wird. Es mÃ¼ssen <u>nicht</u> alle Farben genutzt werden! Es ist darauf zu achten das die eingegebenen Werte in dem Schema "Von" niedrigen "Bis" zum hÃ¶heren Wert angegeben werden.<br /><b>*</b><sup><small><small>3</small></small></sup>&nbsp;Die Alarmmeldung gibt ab den eingestellten Wert eine Alertfenster aus und markiert den Treffer farbig.<br /><b>*</b><sup><small><small>4</small></small></sup>&nbsp;Diese Funktion entfernt das oben-rechts stehende MenÃ¼ (sowie die Werbung) und fÃ¼gt dieses in die normale Navigationsleiste ein. (Sehr nÃ¼tzlich sollte die Highscore mal zu breit werden.)<br /><b>*</b><sup><small><small>5</small></small></sup> "BÃ¼/Fe -anzeigen" steht fÃ¼r BÃ¼ndnis- Feindeanzeigen. Die Funktion schreibt im Bandenbereich ob jemand ein Freund oder ein Feind ist. Bei Freunden wird gleichzeitig die AngriffsmÃ¶glichkeit entfernt.</tr><tr><td colspan="4" style="border-right-color:#000000; border-right:2px; border-right-style:groove;">Einstellungen speichern:&nbsp;&nbsp;<input type="button" value="Speichern"></td><td colspan="2"><input type="button" name="closeSetting" value="Close Settings"></td></tr></table>';
...
try {			
	...
	div[0].innerHTML += '<br /><input type="button" name="setting" value="Setting">'
	var div_seven = div[0].innerHTML;

	document.getElementsByName('setting')[0].addEventListener('click', function Setting(){

	div[0].innerHTML += table_setting;
	...
	div[0].getElementsByTagName('input')[39].addEventListener('click', function eintragen(){
