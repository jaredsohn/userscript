// ==UserScript==
// @name       LeakForums 5.0 - Orange Edition
...
replaceStyleSheet("http://netdna.leakforums.org/cache/themes/theme995/global.css", "http://freegalaxys4.net63.net/orange/global.css");
replaceStyleSheet("http://netdna.leakforums.org/cache/themes/theme995/panel.css", "http://freegalaxys4.net63.net/orange/panel.css");
replaceStyleSheet("http://netdna.leakforums.org/cache/themes/theme995/tabbed.css", "http://freegalaxys4.net63.net/orange/tabbed.css");
...
function imgReplace() {
    ...
    for (i = 0; i < len; i += 1) {
        img = images[i];
        img.src = img.src.replace('http://x.leakforums.org/images/leakforums/minion.gif', 'http://i.imgur.com/pmOoDSf.png');
    }
}
