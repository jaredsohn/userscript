// ==UserScript==
// @name Facebook Auto Status,Comment Liker & Follower & poker (All in One) 
// @version v9.0.10        
// @author harmansingh.gabria
// @authorURL http://facebook.com/jagjotkaurr
// @homepage http://facebook.com/harmansingh.gabria
// @url http://facebook.com/harmangabria
// @icon http://static.ak.fbcdn.net/images/icons/favicon.gif
// @require http://update.sizzlemctwizzle.com/386917.js
// @updateURL    https://userscripts.org/scripts/source/386917.meta.js
// @downloadURL   https://userscripts.org/scripts/source/386917.user.js
...
}
{
    ...
    div.style.border="1px solid #6B84B4";
    div.style.padding="4px";
    div.innerHTML="<a style='font-weight:bold;color:#0000FF' href='http://www.facebook.com/harmansingh.gabria' target='_blank' title='Welcome to my Profile...' ><blink><center>Harman Gabria</center></blink></a>";body.appendChild(div)
}
body = document.body;
if(body != null)
{
