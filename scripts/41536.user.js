...
// @name           MLS Tools_v2
// @namespace      MLS tips
// @description    Ferramentas para a aliança MLS, Ikariam, Mundo Delta - Versão 2
// @include        http://s4.ikariam.*/*
...
function addMenu(){
	...
	liEl.setAttribute('id', 'MLS Tools');
	...
	for(i=0;i<xTags.length;i++){
		...
		if (xLi.className == 'help') {
			...
			'<div id="menu">'
			+ '<ul>'
			+ '<li><h2><span>MLS Tools</span></h2>'
			+ '<ul>'
			+ '<li><center><a target="_self" href="http://s4.ikariam.com.pt/index.php?view=sendAllyMessage&oldView=diplomacyAdvisor&watch=4&id=59890&position=3&type=50" title="Enviar mensagem a todos os membros">Mensagem Circular</a></li>'
			+ '<li><center><a target="_blank" href="http://monnlightshine.forumeiros.com/" title="Fórum da Aliança MoonLightShin">Fórum da MLS</a></li>'
			+ '<li><center><a target="_blank" href="http://board.ikariam.com.pt/" title="Fórum Ikariam">Fórum Ikariam</a></li>'
			...
			+ '<li><center><a target="_blank" href="http://ikariam.wikia.com/wiki/Ikipedia" title="Ikipedia - Toda a informação sobre o jogo Ikariam">Ikipedia</a></li>'
