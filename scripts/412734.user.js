...
var filterWords = ["MEM", "\\[ENG AUDIO\\]", "XViD\\W\\w*", "AC3\\W\\w*", "DVDRip", "AC3", "TS", "HQ", "\\[NO RAR\\]", "READNFO", "BDRip", "Hive\\]", "DVDScr", "1CDRip", "\\[DDR\\]", "x264", "Feel-Free", "PPVRIP", "IFLIX", "NFO", "LKRG", "\\.", "DVD-RERip", "\\W", "R5", "PPRIP", "NYDIC", "BRRiP", "T0XiCiNK", "befree", "CM8", "NEW\\WHQ\\WVIDEO", "NO\\WRAR", "UNRATED", "BR2DVD", "DD5\\.1", "NL", "Subs", "DMT", "\\(", "\\)"];
...
$("#torrents > table > tbody > tr > td:nth-child(2) > a").each(function (index) {
    ...
    $.get(torrentUrl, function (data) {
        var img = $("div.td:nth-child(2) > img", $(data))
        var link1 = link;
        var index2 = index1;
        if (img.length != 0) {
            img.css({
