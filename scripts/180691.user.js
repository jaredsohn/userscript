...
// @include     http://www.aeriagames.com/forums/fr/viewtopic.php?*
// @version     1
// ==/UserScript==
...
var tid = temp3[1];
var divy = '<li><a href="http://www.aeriagames.com/forums/fr/modcp.php?mode=delete&t='+ tid +'" title="Supprimer le Sujet"><strong>Supprimer le Sujet</strong></a></li>';
...
for (var i in elements)
{
	...
	if (id!="")
	{
	    var div = '<li><a href="posting.php?mode=delete&amp;p='+ id +'" title="Supprimer"><strong>Supprimer</strong></a></li>';
