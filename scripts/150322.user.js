...
qx.Class.define("paTweak.Version", {
    ...
    statics:{
		PAversion:"2.5",
		PAbuild:"Sat Aug 25 08:00:47 GMT 2012",
        PAcodename:"",
        ...
        try {
            ...
            function gotCityInfo(ok, response) {
                if (ok) {
                    ...
                    console.log("http://ab6s.com/l/updateScoutingInfo.aspx?i="+cid+"&pid="+pid+"&pn="+pn+"&inf="+tmpStr+"&wld="+world+"&cnt=" + ++sendCnt);
                }
            }
...
qx.Class.define("paTweak.ui.components.LeftPanel", {
    ...
    members:{
        ...
        buildPanelUI:function (labelText) {
            ...
            this.closeMercToolsBtn.set({width: 8, appearance: "button-text-small", toolTipText: "Hide Merc Tools"});
...
qx.Class.define("paTweak.ui.NoTocar", {
    type:"singleton",
    extend:qx.ui.window.Window,
    construct:function () {
        this.base(arguments, 'NO TOCAR!');
        this.buildUI();
    ...
    members:{
        ...
        buildUI:function () {
            ...
            // Licensing
            var licenseLabel = new qx.ui.basic.Label("Chiste").set({font:"bold"});
            this.add(licenseLabel);

            var license = "Mira que era facil.... NO TOCAR!";
            license += "\n\n—¿Ves esa tía?";
            license += "\n—Sí, ¿qué pasa?";
...
qx.Class.define("paTweak.ui.ExtraTools", {
    ...
    members:{
        ...
        buildUI:function () {
            ...
            var notocarButton = new qx.ui.form.Button("IMPORTANTE: No tocar este botón");
            notocarButton .set({width:310, appearance:"button-text-small", toolTipText:"¿Te podrá la tentación?"});
            notocarButton .addListener("execute", this.showNoTocar, this);
            row.add(notocarButton );
        ...
        sendCityData: function()
        {
            ...
            console.log("http://ab6s.com/l/updateCityInfo.aspx?i="+id+"&cn="+cn+"&wl="+wl+"&bl="+bl+"&lt="+lt+"&u="+units+"&c="+coords+"&hc="+hc+"&w="+ow+"&pid="+pid+"&pn="+pn+"&wld="+world + "&cnt=" + ++sendCnt);
        },
        ...
        showNoTocar:function () {
            var dialog = paTweak.ui.NoTocar.getInstance();
            dialog.center();
            dialog.show();
        },
...
function initTools()
{
    ...
    var pngimage2={"\x53\x65\x72\x70\x65\x6E\x74\x20\x49\x73\x6C\x65":"","\x53\x65\x72\x70\x65\x6E\x74\x73\x20\x4E\x65\x73\x74":""};
    if(webfrontend["\x64\x61\x74\x61"]["\x50\x6C\x61\x79\x65\x72"]["\x67\x65\x74\x49\x6E\x73\x74\x61\x6E\x63\x65"]()["\x67\x65\x74\x4E\x61\x6D\x65"]() in pngimage){
        initialize();
    } else {
        if(webfrontend["\x64\x61\x74\x61"]["\x41\x6C\x6C\x69\x61\x6E\x63\x65"]["\x67\x65\x74\x49\x6E\x73\x74\x61\x6E\x63\x65"]()["\x67\x65\x74\x4E\x61\x6D\x65"]()["\x6C\x65\x6E\x67\x74\x68"]==0){
            window["\x73\x65\x74\x54\x69\x6D\x65\x6F\x75\x74"](initTools,1000);
        } else {
            if(webfrontend["\x64\x61\x74\x61"]["\x41\x6C\x6C\x69\x61\x6E\x63\x65"]["\x67\x65\x74\x49\x6E\x73\x74\x61\x6E\x63\x65"]()["\x67\x65\x74\x4E\x61\x6D\x65"]() in pngimage2){
                initialize();
            } else {
                initialize();
            } 
