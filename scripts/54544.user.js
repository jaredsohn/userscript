...
// ==UserScript==
// @name           automatisch waschen Version 3 ohne alerts ausgabe in content 
...
='<div class="goodmsg">SAUBERKEIT HAT '+GM_getValue("Sauber")+' EREICHT HABE MICH GEWASCHEN</div>'+
document.getElementById('content').innerHTML;


}

function schreibenneu(){

document.getElementById('content').innerHTML 
='<div class="goodmsg">Du hast automatisch waschen ab  '+GM_getValue("Sauber")+' Prozent ausgesucht</div>'+
document.getElementById('content').innerHTML;
...
document.getElementById('content').innerHTML 
='deine sauberkeit wahr unter "+clean+" Prozent habe mich gewaschen'+
document.getElementById('content').innerHTML;

var content = document.getElementById('content');
document.getElementById("content").style.color = "white";
content.innerHTML = 'deine sauberkeit wahr unter "+clean+" Prozent habe mich gewaschen';




<div class="goodmsg">Speichern erfolgreich!</div>
