// ==UserScript==
// @name FA Infocenter Share 1.6
// @author Originally by Pio (Orion), updated by Uncledan (Orion)/Larry Legend (Artemis) - // Taurvi (Artemis)/Sobkou (Orion) - Aeiri (Artemis).
// @namespace pardus.at
// @description Enables to share combat/hack/payment logs and missions bullettin board.
// For use with Pardus Infocenter v1.6+
...
artemis: {name: "Chunkie", password: "Articus"}
}
}
];
