...
// @include		http://ae*.tribalwars.ae/game.php?village=*&screen=barracks*
// @include		http://ae*.tribalwars.ae/game.php?village=*&screen=garage*
// @include		http://ae*.tribalwars.ae/game.php?village=*&screen=garage*
// @include		http://ae*.tribalwars.ae/game.php?village=*&screen=market*
// @include		http://ae*.tribalwars.ae/game.php?village=*&screen=train*
...
function addCaption()
{
  ...
  newTd.innerHTML =("<textarea rows=10 cols=100>  |A|: من اجل ارسال هجوم  	|S|: من اجل كافة القوات 	|D|: من اجل الدعم 	|X|: من اجل موافق |N|:هجوم7000 فأس 3000 خفيف 200 محطمة 	|B|:هجوم7000 فأس 1750 خفيف 1000 قوس 200 محطمة 	|v|:هجوم15000 فأس 1000 محطمة |T|: هجوم تجسس بجندي واحد  	|F|: هجوم وهمي 1 محطمة واحد  	|M|: هجوم وهمي 1 مقلاع واحد  |1|: من اجل الهجوم 1000 رمح نبيل  	|2|: من اجل الهجوم 50 رمح 50 سيف نبيل  	|3|: من اجل الهجوم 100 رمح 200 سيف نبيل  	|0|: عودة الى الصفر  |4|: 200 فارس خفيف مع جاسوس 	|5|:400 فارس خفيف مع جاسوس 	|6|: 600 فارس خفيف مع جاسوس  |7|: 800 فارس خفيف مع جاسوس  	|8|: 1000 فارس خفيف مع جاسوس 	|9|: 1200 فارس خفيف مع جاسوس  |G|: من اجل الهجوم 80 رمح وجاسوس  	|H|: من اجل الهجوم 100 رمح وجاسوس  	|J|: من اجل الهجوم 120 رمح وجاسوس    ");
  newTr.appendChild(newTd.cloneNode(true));
    
  newTd.innerHTML = " مع تحيات محمد القائد &nbsp;";
  newTr.appendChild(newTd.cloneNode(true));
  
  newTd.innerHTML =("</textarea>");
...
if(url.indexOf("try=confirm") != -1 && !document.body.innerHTML.match(/graphic\/big_buildings\/place1\.png/)){
	...
	btn.setAttribute("value","Letzter Befehl");
