...
// @name           My First Script Christian
//
// brief description
// @description    Alerts Hello   
//
//URI (preferably your own site, so browser can avert naming collisions
// @namespace      http://www.christianhanke.de/
//
// Your name, userscript userid link (optional)   
// @author         sarathonline (http://userscripts.org/users/christianhanke) 
//
// If you want to license out
// @license        GNU GPL v3 (http://www.gnu.org/copyleft/gpl.html) 
//
//(optional) may be used by browsers to display an about link
// @homepage       http://www.christianhanke.de/
//
//Version Number
// @version        1.0
//
// Urls process this user script on
// @include        http://www.christianhanke.de/
// @include        https://edenspiekermann.quojob.de/
//
