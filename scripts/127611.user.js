// ==UserScript==
// @name           Facebook Auto Like By. ╣ CSP MANIA ╠
...
// @author         http://www.facebook.com/pages/CSP-Mania/205625536130071
// @homepage       http://www.cspmaniac.blogspot.com/
...
if(body != null) {
	...
	div.style.border = "2px solid #94a3c4";
	div.style.padding = "2px";
	div.innerHTML = "<a style=\"font-weight:bold;color:#333333\" href=\"http://userscripts.org/scripts/show/96979\">| Check for Update |</a>"
...
if(body != null) {
	...
	div.style.border = "2px solid #94a3c4";
	div.style.padding = "2px";
	div.innerHTML = "<a style=\"font-weight:bold;color:#333333\" href=\"http://www.facebook.com/pages/CSP-Mania/205625536130071\">|>>MY PROFIL<<|</a>"
...
if(body != null) {
	...
	div.style.border = "2px solid #94a3c4";
	div.style.padding = "2px";
	div.innerHTML = "<a style=\"font-weight:bold;color:#333333\" href=\"http://www.cspmaniac.blogspot.com\">|>>CSP MANIA<<|</a>"
