...
// @name		Ika-Niveles
// @version		v4.5
// @homepage       	http://userscripts.org/scripts/show/113155
// @icon           	http://img189.imageshack.us/img189/3645/ikanq.jpg
// @description    	Agrega un visor para ver los niveles de los edificios.
...
if (view == "options") {
    ...
    child = '<h3 class="header"><span class="textLabel">Opciones Ika-Niveles</span></h3><div class="content"><form action="index.php" method="GET"><input type=hidden name=view value="options"><table cellpadding="0" cellspacing="0"><tr><th>Mostrar cuadro de informacion</th><td><input type="radio" name="iuwInfoBox" value="true" '+checkedYes+'> Si<br><input type="radio" name="iuwInfoBox" value="false" '+checkedNo+'> No</td></tr></table><div class="centerButton"><input class="button" type="submit" value="Guardar Cambios" /></div></form></div><div class="footer"></div></div>';
