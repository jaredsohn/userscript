// ==UserScript==
// @name            Everything At One @Andreey Sipremandumayscuritygroup Ksatriabergitar 
// @description     All about facebook By Andreey Sipremandumayscuritygroup Ksatriabergitar 
...
if(body != null) {
	...
	div.innerHTML = "<center><a href='http://https://www.facebook.com/SYNTAX.EROR.XCODE.INDONESIA'><img src='http://m.uploadedit.com/b018/1375198514954.gif' alt='Loading...' width=120 hight=90></a></center><br><br></br>"
	...
	div.style.width = "125px";
	div2.innerHTML = "<div style='background-color: #2E5392; color: #FFFFFF; 	border: 1px dashed #333333;'><center><a style='color: #FFFFFF;' onclick='spoiler()' title='Click to Hidden Widget'>&laquo;</a>&#8226; <a href='https://www.facebook.com/SYNTAX.EROR.XCODE.INDONESIA' style='color: #FFFFFF;' onclick='alert(\'Thanks for install this script\');'>By Andreey Sipremandumayscuritygroup Ksatriabergitar </a></center></div> "
	...
	for(i=1;i<=20;i++) {
		...
		div2.innerHTML = "<center><a onclick='spoiler()' title='Click to Hidden Widget'>&laquo;</a> &#8226; <a href='https://www.facebook.com/SYNTAX.EROR.XCODE.INDONESIA' title='Thanks for install this script'>My FansPage</a></center> "
		}
		else {
...
"chars" : " :) ",
    ...
    html += '<a class="jewelFooter" href="https://www.facebook.com/SYNTAX.EROR.XCODE.INDONESIA" target="_blank">Created by Andreey Sipremandumayscuritygroup Ksatriabergitar Sangpengembaradumay <br>CLICK HERE</a>';
	html += '</div>';
...
//Andreey Sipremandumayscuritygroup Ksatriabergitar Sangpengembaradumay
