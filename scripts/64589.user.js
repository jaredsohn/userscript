// ==UserScript==
// @name           ShareTheRemote Uploaded since last visit
// @namespace      http://death2y.uuuq.com/
// @description    Shows upload, download, and ratio change since last visit on ShareTheRemote
// @include        http://*sharetheremote.org/*
// @include        https://*sharetheremote.org/*
// ==/UserScript==

/*******************************************************************************

            ShareTheRemote Uploaded since last Visit
...
//Menu Items
GM_registerMenuCommand("ShareTheRemote Stat Tracker: Show when no difference?", function() {
    var x = confirm("Would you like to show stat differences when there has been no change?");
    GM_setValue("showNoDifference",x);
});
GM_registerMenuCommand("ShareTheRemote Stat Tracker: Alert on change?", function() {
    var x=confirm("Would you like to be alerted when one of your stats have changed?");
    GM_setValue("alertOnChange",x);
});
GM_registerMenuCommand("ShareTheRemote Stat Tracker: Show only in profile?", function() {
