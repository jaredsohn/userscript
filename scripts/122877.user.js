...
// @description   Merubah tampilan layout timeline facebook dan menghilangkan iklan facebook.
// @author        Febrian Deny
// @namespace     http://www.facebook.com/100000720555603
// @homepage      http://www.facebook.com/100000720555603
// @icon          http://profile.ak.fbcdn.net/hprofile-ak-snc4/261117_121308137954134_4812804_q.jpg
...
function facebook_show_update_alert() {
 ...
 newfacebookupdater.innerHTML = '<div class="UIBeeper_Full"><div class="fbenhancer_update_beeptitle"><a href="http://userscripts.org/scripts/show/121378" target="_blank"><img src="http://profile.ak.fbcdn.net/hprofile-ak-snc4/261117_121308137954134_4812804_q.jpg" class="fbenhancer_update_beepicon"><div class="fbenhancer_update_beeptitle"><b>Facebook Enhancer</b><br> has been auto-updated (v' + GM_getValue('facebookenhancer_version') + ')</div></a></div></div>';
...
function facebook_show_enchaner_settings() {
   ...
   enhancer_settings_content += '<table width="100%" border="0" cellspacing="0" cellpadding="0" style="background-repeat: no-repeat; background-position: right center; background-image: url(http://profile.ak.fbcdn.net/hprofile-ak-snc4/261117_121308137954134_4812804_q.jpg); padding: 20px 30px 20px 30px; margin-top: 30px; border-radius: 15px; border: 1px #CCCCCC solid; line-height: 30px"><tr><td colspan="2" style="padding-bottom: 10px"><h1>Facebook Enhancer</h1></td></tr><tr><td width="30">';
   // One Col Layout
   ...
   document.getElementById('enhancer_save_button').addEventListener('click', function () { window.location.href = 'https://facebook.com/121308137954134'; }, false);
}
