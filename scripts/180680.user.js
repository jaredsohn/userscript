// ==UserScript==
// @name        The West - Procura rápida de sets - PT-PT
...
(function(func) {
    ...
    TW_QuickSearch.name = "Procura rápida de sets";
    TW_QuickSearch.gui = {};
    ...
    TW_QuickSearch.findSet = function(id) {
        ...
        if (invItems.length > 0) {
            ...
            var dlg = new west.gui.Dialog("procura de itens", "Nenhum item encontrado.");
            dlg.addButton("ok");
