(function () {
// ==UserScript==
// @name           Penghapus Jejak
// @namespace      http://www.ruifujiwara.co.cc
// @author         Rui Fujiwara
// @description    Menghapus jejak
// @version        3
...
function createButton() {
  ...
  str += '<div id="boxrecent" style="display: none;">\
    ...
    <b>Hapus Jejak</b></a></div>';

  // boxrecentdisabled ; Throw No Recent at all
  str += '<div id="boxrecentdisabled"><b>Tidak Ada Jejak</b></div>';
  ...
  str += '<div id="boxrecentOption" style="padding-top:10px;">\
    ...
    <legend style="text-align: left; padding-left: 3px; padding-right: 3px;">Pilihan :</legend>\
    <span style="display:block; line-height:20px;"><label style="color: gray;"><input id="yod_recent_autoclean" name="yod_autoclean" type="checkbox" style="cursor: pointer; position: relative; top: 3px; margin-right: 5px;">Pembersih Otomatis</label></span>\
    </fieldset>\
