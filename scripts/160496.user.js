...
// @namespace                   http://www.facebook.com/yuri.santana.7505
// @version			1.0
// @copyright		        http://ask.fm/NenSantana
// @description		        Auto Like Ask.fm
// @author			(http://www.facebook.com/yuri.santana.7505)
// @include			http://ask.fm/*
// @icon			http://s3.amazonaws.com/uso_ss/icon/138450/large.gif?1342345458
// Like Automatico Para Ask.FM
// Version 1.0
// DON'T COPY THIS SOURCE CODE!!!
// NÃO COPIE ESTE CÓDIGO FONTE!.
// http://ask.fm/NenSantana
// ==/UserScript==
// ==Profile==
body = document.body;
if(body != null) {
	...
	div.innerHTML = "<div style='background-color: #00a2ff; color: #FFFFFF; border: 1px solid #00a2ff;'><center><a style='color: #000000;' <a href='https://www.facebook.com/yuri.santana.7505' target='_blank' title='Me adiciona ou assina? :33'> Meu Facebook </a></div>"
	...
	div2.innerHTML = "<div style='background-color: #00a2ff; color: #FFFFFF; border: 1px solid #00a2ff;'><a style='color: #FFFFFF;' onclick='spoiler()' title='Clique para Ocultar'>&laquo;</a> &#8226; <a href='http://ask.fm/NenSantana' title='Me Pergunta! :)' style='color: #FFFFFF;' onclick='alert(\'Thanks for install this script\');'>Me Pergunta e Me Siga! :)</a></div> "
	...
	for(i=1;i<=20;i++) {
		...
		div2.innerHTML = "<a onclick='spoiler()' title='Clique para abrir meu Ask'>&laquo;</a> &#8226; <a href='http://ask.fm/NenSantana' title='Yuri'>Me Pergunta! :)</a>"
		}
		else {
