...
// @updateURL   http://userscripts.org/scripts/source/162237.meta.js
// @installURL  http://userscripts.org/scripts/source/162237.user.js
...
(function hideCategories() {
	...
	var i = 0, l = categories.length, cat, unread, label;
	for (; i < l; i += 1) {
		cat = categories[i];
