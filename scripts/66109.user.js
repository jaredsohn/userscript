...
function() 
{
	function Alles() 
	{
	    ...
	    res=confirm("Jste si jisti ze ma skritek vsude zasadit" + producto.toLowerCase()  + "?");
	...
	function randArray(min,max) 
	{
		...
		//Odebrat všechny v náhodném pořadí
