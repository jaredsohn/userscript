...
// ==UserScript==
// @name          Prettify Code
// @namespace     wiki.massgate.net
// @version       0.01
// @description   Helper script to create syntax colored code boxes in the massgate
//                           wic wiki.
// ==/UserScript==
 ...
 * 
 * MAH NOTES START
 * I just added the Greasemonkey header and some code to add the prettyprint
 * class to every pre tag.
 * MAH NOTES END!
 * 
...
for( var i = 0; i < allPre.length; i++ ) {
	thisPre = allPre[i];
	thisPre.className += thisPre.className ? ' prettyprint' : 'prettyprint';
}
