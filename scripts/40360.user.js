...
// @name           VTA Tools_v1
// @namespace      VTA tips
// @description    Ferramentas para a aliança VTA, Ikariam, Mundo ETA - Versão 1
...
function addMenu(){
	...
	for(i=0;i<xTags.length;i++){
		...
		if (xLi.className == 'help') {
			...
			+ '<li><center><a target="_blank" href="http://www.vaitudoabaixo.pt.vu/" title="Fórum da Aliança VTA">Fórum</a></li>'
