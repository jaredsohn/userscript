// ==UserScript==
// @name           Travian Resource bar plus enhanced
// @author         Qusai Abu Hilal قصي أبو هلال
// @copyright      © Qusai Abu Hilal قصي أبو هلال ( Orginally by © Serj_LV).
// @version        5.1.1
...
// @icon           http://www.sabily.org/website/templates/yoo_air/favicon.ico
...
var langs = ['اختيار تلقائي للسان اللعبة \\ Automatic (au)',' خير الألسنة: لسان الضاد (العربية) (ar)', 'English (en)', 'Български (bg)','Bosanski (bs)','Deutsch (de)','فارسی (fa)','Français (fr)','Hrvatski (hr)','Magyar (hu)','Italiano (it)','Polski (pl)','Português (pt)','Română (ro)','Русский (ru)','Српски (sr)','Svenska (sv)','Українська (ua)'];
...
DICT = {
	ar: { // Arabic, Qusai Abu Hilal قصي أبو هلال
		...
		accinfo: "معلومات اللاعب",
		addcur : "أضف الصفحة الحالية إلى قائمة الروابط",
		addnew : "أضف صفحة جديدة إلى قائمة الروابط",
	...
	hu: { // Hungarian language. thx mrzed :)
		...
		notes : "jegyzetek",
		ressav : "nyersanyagokat %-ig feltölteni",
		refresh : "frissít",
