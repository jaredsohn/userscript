// ==UserScript==
// @name           Lg games Counter V5
// @namespace      Landgrab_gamescount5
...
function CountMeAtAll(){
	...
	while(oI = oI.nextSibling){
		...
		else if(sHref == 'http://landgrab.net/landgrab/images/homestar4.png') recent++;
		else if(sHref == 'http://landgrab.net/landgrab/images/homestar5.png') borged++;
		else defeated++; 
		total = defeated + active + unactive + recent + borged;
	}
putHere.innerHTML += '<div style= "color: #60bb54;">' + '<center />'+total+' Games: '+active+'/'+unactive+'/'+defeated+'/'+recent+'/'+borged+' (Active/Inactive/Defeated/Recent/Borged)</center />';
}