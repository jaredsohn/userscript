// ==UserScript==
// @name        Rupeeinbox by !nnocent V!per
// @description Rupeeinbox Userscript Just Click and Forgot
// @require     https://ajax.googleapis.com/ajax/libs/jquery/1.7.0/jquery.min.js
// @include     http://*.Rupeeinbox.com/inbox.asp*
// @include     http://Rupeeinbox.com/inbox.asp*
// @include     http://*.Rupeeinbox.com/inbox.asp
// @grant       GM_addStyle
// @version     1
...
$(function(){
	$("body").append('<div class="banner" style="height: 40px; width:100px; right:20px; color:white; padding:5px; border-radius:5px; top:3px; overflow:auto; display: block;"><a href="http://www.google.com" target="_blank" id="start">Click Here to Start Checking Mail</a></div>');
