 ...
 ********************************************************************************/
// Script information
var Version = ' Daisuke v.1'; // Year, Month, Day, Revision, Maturity (e.g. YYYMMDDa_BETA)
 ...
 ********************************************************************************/
try {
	var checkTop = window.top;
	var checkSelf = window.self;
} catch (e) {
	var checkTop = unsafeWindow.top;
	var checkSelf = unsafeWindow.self;
}
 
if (checkTop === checkSelf) {
	...
	function setGoogleWide() {	
		var iframe = document.getElementById('oz-gadgets-canvas-iframe-659749063556');
		if (!iframe) {
	...
	if (window.location.href.indexOf("facebook") != -1) {
		if (window.location.href.indexOf("rubies") == -1)
			setFacebookWide();
...
var BUTTON_BGCOLOR = '#222';
var JOB_BUTTON_BGCOLOR = '#222';

var IsChrome = navigator.userAgent.toLowerCase().indexOf('chrome') > -1;

var wordArr = ['Doa', 'Tools',];
...
var OptionsDefaults = {
  ...
  objAttack     : {enabled:false, repeatTime:3660, delayMin:5, delayMax:10, levelEnable:[], levelDist:[null,10,10,10,10,10,10,10,10,10,10], deleteObjAttacks:false, stopAttackOnLoss:false, logAttacks:true, maxMarches:10, troops:[], clearAllTargets:false},
  currentTab    : false,
  attackTab     : 0,
  mapTab        : 0,
  jobsTab       : 0,
  ...
  waves         : {enabled:false, iterationMin:5, iterationMax:10, stopOnLoss:true, deleteReports:false, targets:[], runTime:0},
  objStats      : null,
  objMarches    : {},
...
var Styles = '\
    div.' + rndClass['tab_title'] + ' {border:none solid; border-color:#ffffff; font-weight:bold; padding-top:2px; padding-bottom:2px; text-align:center; color:#ffffff; background-color:#525252}\
    div.' + rndStyle['classPrefix'] + 'Subtitle {border:none solid; border-color:#ffffff; font-weight:bold; padding-top:2px; padding-bottom:2px; text-align:center; color:#ffffff; background-color:#222}\
    div.' + rndStyle['classPrefix'] + 'Input {border:none ridge yellow; background-color:#ffffee; padding:3px}\
    div.' + rndStyle['status_ticker'] + ' {border:none ridge black; background-color:#FFFFEE; padding:2px}\
	div.' + rndStyle['status_feedback'] + ' {height: 34px; border:none solid black; background-color:#FF4F8A; padding: 2px 0px 2px 2px; text-align:left; font-weight:bold;}\
    ...
    div#qTip {padding: 3px; border: none solid #777; border-right-width: none; border-bottom-width: 2px; display: none; background: #999; color: #fff; font: bold 9px Verdana, Arial, sans-serif; text-align: left; position: absolute; z-index: 1000}\
    ...
    table tr.' + rndStyle['classPrefix'] + 'TabHdr1 td { background-color:#FFFFEE; font-weight:bold}\
    ...
    table.' + rndStyle['classPrefix'] + 'MainTab tr td   {height:60%; empty-cells:show; padding: 0px 5px 0px 5px;  margin-top:5px; white-space:nowrap; border: none solid; border-style: none none solid none; }\
    table.' + rndStyle['classPrefix'] + 'MainTab tr td.spacer {padding: 0px 3px; border:none; }\
    table.' + rndStyle['classPrefix'] + 'MainTab tr td.sel    {font-weight:bold; font-size:13px; border: none; border-style: solid solid none solid; background-color:#FF3176; cursor:hand; cursor:pointer; padding: 2px;}\
    table.' + rndStyle['classPrefix'] + 'MainTab tr td.notSel {font-weight:bold; font-size:13px; border: none border-style: solid solid none solid; background-color:#222; color:white; border-color:black; cursor:hand; cursor:pointer; padding: 2px;}\
    ...
    .button {cursor:hand; cursor:pointer; border: none solid #006; background: #222; color: white; padding: 2px; font-weight:bold; font-size:13px; border-style: solid solid none solid;}\
//  .button:hover {background: #FF3176; font-weight:bold; font-size:13px; color: black; border-style: solid solid none solid; }\
...
Tabs.Waves = {
	...
	cont : null,
	troopList : [kOgre, kLBM, kBatDrg, kSSDrg, kLavaJaw, kFang, kATrans],
	enabled : false,
	attackTimer : null,
	marchTimer: null,
	attackErrors : 0,
...
//*** Attacks Tab - Stats Sub-tab ***
  tabStats : function (){
    ...
    t.contentType = 3;
    document.getElementById('pbatStats').style.backgroundColor = "#FF3176"; 
 ...
 // Data.options.campAttack {enabled:false, maxDist:7, repeatTime:3660, delayMin:15, delayMax:25, levelEnable:[], levelDist:[]}
  ...
  tabConfigLevels : function (){
    ...
    t.contentType = 0;
    document.getElementById('pbatConfigL').style.backgroundColor = "#FF3176"; 
...
//*** Attacks Tab - Config Sub-Tab ***
  tabConfigGeneral : function (){
    ...
    t.contentType = 1;
    document.getElementById('pbatConfigG').style.backgroundColor = "#FF3176"; 
...
//*** Attacks Tab - Targets Sub-Tab ***
  tabTargets : function (){
    ...
    t.contentType = 2;
    document.getElementById('pbatTargets').style.backgroundColor = "#FF3176"; 
...
//*** Attacks Tab - Maps Sub-tab ***
  tabMaps : function(){
    ...
    t.contentType = 4;
    document.getElementById('pbatMaps').style.backgroundColor = "#FF3176"; 
  ...
  hide : function (){
    ...
    showStuff : function (){
        ...
        m += '<TABLE style="margin-top:3px" width=100%>\
              <TR bgcolor=#BFBFBF align=center><TD style="border-right: 1px solid; border-bottom: 1px solid;"><B>'+ kTroops +'</b></td>\
...
//    researchTimer   : null,
	...
	tabJobInfo : function (){
        ...
        t.contentType = 0;
	    document.getElementById(rndStyle['subtab_info']).style.backgroundColor = "#FF3176"; 
	...
	tabJobTrain : function (){
        ...
        t.contentType = 1;
        document.getElementById(rndStyle['subtab_train']).style.backgroundColor = "#FF3176"; 
	...
	tabJobBuild : function (){
        ...
        t.contentType = 2;
        document.getElementById(rndStyle['subtab_build']).style.backgroundColor = "#FF3176"; 
	...
	tabJobResearch : function (){
        ...
        t.contentType = 3;
        document.getElementById(rndStyle['subtab_research']).style.backgroundColor = "#FF3176"; 
...
//      return;
    ...
    tabTrain : function(){
        ...
        document.getElementById('pbttTrain').style.backgroundColor = "#FF3176"; 
    ...
    tabConfigTrain : function(){
        ...
        document.getElementById('pbttConfigTrain').style.backgroundColor = "#FF3176"; 
        ...
        m += '<DIV class=' + rndStyle['classPrefix'] + 'Subtitle style="background-color:#222;">Troop Cap (Max Troops, 0 = no max)</div><TABLE class=' + rndStyle['classPrefix'] + 'Tab><TR valign=top><TD width=150><TABLE class=' + rndStyle['classPrefix'] + 'Tab>';
        for (tt=0; tt<troopTypes.length; tt++){
            // Use less room in the table layout
            if (tt%3 == 0) m += '<TR>';
            m += '<TD class=' + rndStyle['classPrefix'] + 'TabLeft>'+ Names.troops.byName[troopTypes[tt]][2] +':</td>';
...
function CPopup (prefix, x, y, width, height, enableDrag, onClose) {
  ...
  var m = '<TABLE cellspacing=0 width=100% height=100%>\
           <TR id="'+ rndPopup['bar'] +'" style="background-color: #525252;">\
...
t.state = null; 
    ...
    if (t.state == null){
      t.win.document.body.innerHTML = '<STYLE>pre{margin:0px} hr{margin:3px; height:1px; border:0px; color:#cee; background-color:#cee}</style>\
        ...
        <DIV id=winlogtop style="background-color:#d0d0d0; margin:0px; padding:0px; border:0px solid">\
  ...
  write : function (msg){
    ...
    if (++t.lineNum % 2)    
      te.style.backgroundColor = '#FF377D'; 
    else
