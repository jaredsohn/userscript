// ==UserScript==
// @name           דוקטור צחוק מציג: איקרים נושא הודעה
// @description    מוסיף נושא להודעה שלכם - פשוט כתבו אותה בתיבה - והיא תופיע אצל חבריכם  - אבל עליהם להתקין גם הם את התוסף. 
// @include        http://s*.ikariam.*/index.php*
// @version        0.2
// ==/UserScript==
var version = 0.2;
var dlUrl = 'http://userscripts.org/scripts/show/79937';
...
defineLanguage = function () {
   ...
   case "fr":
      language = {
         ...
         defaultSubject: 'Suject pour les messages privֳ©s',
         language: 'Langue',
         saveconfig: 'Sauver'
      };
      break;
   case "gr":
      language = {
         newver: '־�­־± ־ˆ־÷־´־¿ֿƒ־· ֿ„־¿ֿ… Ikariam Subject ־´־¹־±־¸־­ֿƒ־¹־¼־·',
         install: '־µ־³־÷־±ֿ„־­ֿƒֿ„־·ֿƒ־µ',
         //help: '<small>Put in first line of the message the subject inside square brackets. .g.: [Looking for marble]</small>',
         subject: '־¸־­־¼־±:',
         type: '־³ֿ�¬ֿˆ־µ:',
         spam: '־ ־±ֿ�±־÷־±־»ֿ�־µ־»־­־³־¾ֿ„־µ ֿ„־¹ ־¸־­־¼־± ֿ„־¿ֿ… ־¼־·־½ֿ�¼־±ֿ„־¿ֿ‚',
         Re: '־‘ֿ€.:',
         reply: '־•־¹ֿƒ־±־³ֿ‰־³־® ־‘ֿ€.: ֿƒֿ„־¹ֿ‚ ־±ֿ€־±־½ֿ„־®ֿƒ־µ־¹ֿ‚',
         reply2: '־¼ֿ�½־¿ ־¬־¼־± ֿ…ֿ€־¬ֿ�‡־µ־¹ ֿ€־±־»־¹ֿ�„־µֿ�¿ ־¸־­־¼־±',
         defaultAllySubject: '־ ֿ�¿־µֿ€־¹־»־µ־³־¼־­־½־¿ ֿ€־µֿ�¹־µֿ‡ֿ�¼־µ־½־¿ ֿƒֿ…־¼־¼־±ֿ‡־¯־±ֿ‚',
         defaultSubject: '־ ֿ�¿־µֿ€־¹־»־µ־³־¼־­־½־¿ ֿ€־µֿ�¹־µֿ‡ֿ�¼־µ־½־¿ ֿ€ֿ�¿ֿƒֿ‰ֿ€־¹־÷־¿ֿ�־¼־· ־½ֿ�¼־±ֿ„־¿ֿ‚',
         language: '־“־»ֿ�ƒֿƒ־±',
         saveconfig: '־‘ֿ€־¿־¸־®־÷־µֿ…ֿƒ־µ'
      };
      break;
   case "es":
      language = {
  ...
  case "heb":
      language = {
         newver: 'גרסה חדשה ממתינה באדיבות דוקטור צחוק',
         install: 'התקן - ותודה לדוקטור צחוק',
         //help: '<small>שים את השורה הראשונה של ההודעה בסוגריים מרובעים: [כאלה]</small>',
         subject: 'נושא ההודעה:',
         type: 'סוג:',
         spam: 'דוקטור צחוק אומר: אנא,בדוק את מטרת ההודעה',
         Re: 'מענה:',
         reply: 'הוסף "מענה" בתגובה',
         reply2: 'רק אם ישנו כבר נושא קודם',
         defaultAllySubject: 'ברירת מחדל להודעת ברית',
         defaultSubject: 'ברירת מחדל להודעה פרטית',
         language: 'שפה',
         saveconfig: 'שמירת שינויים'
      };
      break;
  case "ro":
      language = {
...
function optionsPage() {
   ...
   newElement.innerHTML =
      "<div class='contentBox01h'>" +
         "<h3 class='header'>" +
            "<a href='http://userscripts.org/scripts/show/79937' target='_blank'>דוקטור צחוק...נושא הודעה (ver. " + version + ")</a>" +
            "<span style='font-size:10px;'>  by <a href='http://userscripts.org/scripts/show/78244' target='_blank'>אבישי בר ישי</a></span>" +
         "</h3>" +
         "<div class='content'>" +
   ...
   //Add languages
   var langtyp = ['default', 'gr', 'en', 'es', 'fr', 'it', 'heb', 'ro'];
   var selOpt = false;
...
function cbf(e) {
   ...
   var m2 = "sa@gm";
   var m3 = "ail.com";
   alert("דוקטור צחוק ....נושא הודעה ver. " + version + " [04.Jun.10]\nhttp://userscripts.org/scripts/show/79937/\nSamuele Manfrin (write me in it/en/fr), " + m1 + m2 + m3);
   alert("" +
