...
document.getElementsByTagName('html')[0].style.backgroundImage="url('http://www.walldesk.net/pdp/1024/23/01/Pokemon/Pokemon08-.jpg')";
...
document.getElementsByTagName('html')[0].style.backgroundColor="#99FFFF";
document.getElementById('footer').style.backgroundColor="#99FFFF";
document.getElementsByTagName('img')[0].style.marginTop="-51px";

elements = document.getElementsByTagName('a');
for(i=22;i<elements.length;i++){
elements[i].style.color="#99FFFF";
}
for(i=0;i<28;i++){
elements[i].style.color="#99FFFF";
elements[i].style.background="transparent";
