// ==UserScript==
// @name      Photo pop-up + Blue colors + gets rid of ads 2
// @version	1.0
// @author	Adam Booth
// @namespace   
// @description  Makes Facebook blue colors and photos pop up + and removes ads
...
toplogo = "http://i20.photobucket.com/albums/b205/MWBC/blue-greenlogo.jpg";
tophover = toplogo;

/*Turn this line on if you want to have a rollover image for the logo*/
tophover = "http://i20.photobucket.com/albums/b205/MWBC/blue-greenhome.jpg";
...
addGlobalStyle('.tip {font:10px/12px Arial,Helvetica,sans-serif;border:0;padding:3px 3px 1px 3px;visibility:hidden;position:fixed;z-index:100;color:#2ec32e;top:20px;left:90px;background-color:#2ec32e;}');
