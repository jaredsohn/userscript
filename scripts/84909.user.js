// ==UserScript==
// @name           Hádész Haragja
// @description    Jelentés konverter
// @author         llaszlo
...
if(location.href.match(/action=view/)) { 
  ...
  var BerichtTitel = "[quote][b][ally]Hádész Haragja[/ally] Jelentés konverter[/b]  [quote] [player]"+townOwner[0]+"[/player] [b]vs.[/b] [player]"+townOwner[1]+"[/player][/quote]";
  for(var c = 0; c < document.getElementsByTagName('div').length; c++) {
