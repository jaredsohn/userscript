// ==UserScript==
// @name        Earmy Damage Elite
// @author		Peter Denev
// @version		2.05
// @uso:version 2.05
// @include		http://*erepublik.com/*
// @description    eRepublik Reporting Damage Script By Peter Denev
// ==/UserScript==
...
var pd_form_url = "https://spreadsheets.google.com/spreadsheet/viewform?formkey=dHM0U3VVSHJzVXE5V3RUalFIdEpjVFE6MA#gid=136";
//var pd_form_url = "https://spreadsheets.google.com/spreadsheet/viewform?formkey=dEcxYzRrR3JmbWJzTlJaR01Hd0VtUWc6MA#gid=136";
...
if(window.location.href.substr(0, 49) == "http://www.erepublik.com/en/military/battlefield/" | window.location.href.substr(0, 49) == "http://www.erepublik.com/bg/military/battlefield/")
{
	...
	earmy.main = function()
	{
		...
		div.innerHTML = "<br><img src='http://www.studiolan.com/Bulgaria_flag.gif' width='50' height='30'> еБГ Елит<br>скрипт (вер. 2011-08-27)<br> ~ TriEdgeAI & Peter Denev<br><span id=\"earmy_last_report_span\" class=\"earmy_last_report_span\" >&lt;&lt; Последен отчет &gt;&gt;</span><br><span id=\"earmy_last_report_del_span\" class=\"earmy_last_report_span\"  >&lt;&lt; Нулирай последен отчет &gt;&gt;</span>";
