// ==UserScript==
// @name         TW-DB.info Hızlı Aktarım Butonu
// @version      1.2.2
// @description  Bu yeni buton mini haritanın yanında bulunur, script için TW-DB sitesine verilerinizi aktarır
// @author       Oğuzhan ÜNAL
// @namespace    http://userscripts.org/scripts/show/110567
// @updateURL    http://userscripts.org/scripts/source/110567.user.js
...
+'img alt="TW-DB Aktarımı" id="TWDBI_import_button" style="position:absolute;left:2'+(TheWestApi.version=='1.35'?6:2)+'8px;top:-2px;cursor:pointer" title="<'
+'b>TW-DB.info sitesine verilerini aktar<'+'/b>" onclick="wman.open(\'twdbi nominimize noreload\').addTab(\'Lütfen bekleyin...\');jQuery.getScript(\'http://tw-db.info/cache/js/sDoImport_eng.js\');"'
