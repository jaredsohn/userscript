	...
	*/
	...
	(function(fn) {
	  ...
	  TWS.langs.fr_FR = {
		...
		bank : "Banque",
		beeper_sound : "Son: ",
		beeper_set_sound : "Changer",
		chat_title : "Chat",
		changed : "Réussi",
		church : "Eglise",
		default : "Defaut",
		dont_have_hotel: "Tu n'as pas d'hôtel",
		DuelSafer_ally : "Attaque Alliée",
		DuelSafer_ally_text : "Ce joueur est allié, l'attaquer quand même?",
		DuelSafer_already_have : "Déja présent dans les listes Alliances/Villes",
		DuelSafer_found : "Duels Sécurisés",
		DuelSafer_from_alliance : "Alliance: ",
		DuelSafer_from_town : "Ville: ",
		DuelSafer_input_alliance : "Entrer nom de l'alliance:",
		DuelSafer_input_town : "Entrer nom de la ville:",
		DuelSafer_not_found : "Ville/Alliance non trouvée",
		...
		dx_not_found: "Que tchi",
		dx_show_on_map : "Montrer sur la map",
		dx_transit_time : "Arrivée dans:",
		dx_warning : "Ils pourraient te bannir, mais honnetement, on s'en fout ;)",
		dx_what_needed : "Job Recherché",
		enable_beeper : "Activer Beeper",
		enable_beeper_title : "<b>Beeper</b> - alerte sonore pour les chuchos",
		enable_select : "Texte Sélectionnable",
		enable_select_title : "Active la possibilité de surligner le texte",
		enable_town_button : "Active le bouton \"Ville\"",
		enable_town_title : "Permet de prévoir/activer des taches automatiques (dormir à l'hotel, au fort, ouvrir le shériff...",
		forum : "Forum",
		general : "Paramètres",
		listen : "Ecouter",
		have_not_forts : "Pas de forts",
		HealthTL_to : "Temps avant régé PV: ",
		main : "Options",
		market : "Marché",
		need_reload : "La page doit être rafraichie, procéder? ",
		own_saloon : "Propre saloon",
		patches_title : "Patches (Modifications)",
		play_current_sound : "Jouer le son",
		revision_current : "Révision actuelle ",
		revision_new : "Nouvelle révision",
		settings : "Réglages",
		settings_reload : "La majorité des réglages recquièrent rafraichissement",
		sheriff : "Sheriff",
		sleep_in_fort : "Dormir à la caserne",
		sleep_in_hotel : "Dormir à l'hotel",
		switch_on : "Activer",
		to_last_page : "Dernière page",
		town : "Ville",
		update_found : "Nouvelle version de TWSweets disponible",
		update_found_html : "TWSweets a trouvé une nouvelle version du script",
		version_current : "Version actuelle",
		version_new : "Nouvelle version",
		wir_enabler : "Réducteur d'inventaire",
	...
	TWSweets.langs.it_IT = {
	  ...
	  TWS.Config.mainTab = function() {
		var tws_main = $('<div id="tws_main" style="display: block;"></div>');	
			...
			.append(new tw2gui.combobox("tws_changelang").addItem("ru_RU", "Russian").addItem("en_US", "English").addItem("it_IT", "Italian").addItem("fr_FR", "Français").select(TWS.Settings.language).addListener(function(v) { TWS.Core.switchSetting("language", v); TWS.lang = TWS.langs[v]; var need = confirm(TWS.lang.need_reload); need && location.reload(true);}).getMainDiv())
			.appendTo(tws_main);
