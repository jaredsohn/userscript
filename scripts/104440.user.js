...
function needstobesaved(theStr){
  var blackList = new Array('artina', 'tartie', 'finchel', 'faberry', 'faberry 2', 'achele', 'achele 2', 'black metal', 'doctor who', 'cockblockowitz' 'quick', 'mercedes jones' 'quinn fabray', 'dianna agron', 'nigel thornberry', 'thornberry', 'boobs', 'glee rp');
  var whiteList = new Array('puckleberry', 'tike', 'asian fusion', 'chang squared', 'fritters', 'finn hudson', 'mike chang', 'noah puckerman', 'santina', 'brittina', 'tina cohen-chang', 'tina cohen chang' 'shushkowitz');
