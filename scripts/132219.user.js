...
// @version	209
// @author	Professor Hase / Original by Oliezekat
// @description	Modified Ikariam Empire Board for Ikariam 0.5 legacy/mobile layout
...
Version 2.0.9:
- Fixed premium storage capacity for more than 9 days
...
EmpireBoard.ViewIsPremium = function()
	...
	for (featureId in premiumOffers)
		...
		if (this.DOM.Has_ClassName(TDstatus,'active') == true)
            ...
            var regExp = new RegExp("([0-9]|[0-9][0-9]|[0-9][0-9][0-9])\\s+([a-z])", "ig");
