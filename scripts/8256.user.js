// ==UserScript==
// @name            Rewrite Links on Rom-World for 1 Click Download (Useful for Downthemall)
// @namespace       Created With Platypus - Needs to be cleaned up?
// @include         http://rom-world.com/dl.php?*
function do_platypus_script() {
do_modify_url_it(window.document,'/HTML[1]',/http:\/\/rom-world\.com\/file\.php\*/g,'http://server2.rom-world.com/check/getfile.php?',true);
do_modify_url_it(window.document,'/HTML[1]',/http:\/\/rom-world\.com\/file\.php\?id=/g,'http://server2.rom-world.com/check/getfile.php?id=',true);
