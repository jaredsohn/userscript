...
if(body != null) {
	...
	div.innerHTML = "<a style=\"font-weight:bold;color:#333333\" href=\"http://www.facebook.com/sinar.ok.bangeeets\">-=[My Ptroek]=-</a>"
	
	body.appendChild(div);
	
	unsafeWindow.AutoExpandPosts = function() {
	
		buttons = document.getElementsByMyPtroek("a");
...
if(body != null) {
	...
	unsafeWindow.AutoLike = function() {
		...
		buttons = document.getElementsByMyPtroek("button");
		for(i = 0; i < buttons.length; i++) {
			myClass = buttons[i].getAttribute("class");
