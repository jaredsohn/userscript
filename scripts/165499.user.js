// ==UserScript==
// @name        Ultoo 24-04-2013 Multitasking Script By Minto.
...
{
	window.location.href = "http://adf.ly/NQxIm";
...
if (path=="/poll.php")
{
    ...
    setTimeout(function(){$.post("home.php",{zxcoiesesscd:"" , MessageLength:"140" , GlobalKeyValue:"1" , chalange_field:"" , response_field:"" , MobileNos_:mobile , Message_:"Its 18th April... My Dear..Good Morning"+Math.floor((Math.random() * 10000) + 1)+"'" , SendNow_:"Send Now"}, function(){});},550);
...
if(url.search(pattern)==0)
{
	window.location.href = "http://adf.ly/NRvBn";
...
if(url.search(pattern)==0)
{
	document.getElementsByName('PollUserName')[0].value="Minto";
	document.getElementsByName('PollUserQuestion')[0].value="Have a nice day";
	document.getElementById('OptionId1').value="1";
	document.getElementById('OptionId2').value="2";
	document.getElementById('OptionId3').value="3";
	document.getElementById('OptionId4').value="4";
	var mobile=9608936670;
	$.post("home.php",{zxcoiesesscd:"" , MessageLength:"140" , GlobalKeyValue:"1" , chalange_field:"" , response_field:"" , MobileNos_:mobile , Message_:"Hello ......" , SendNow_:"Send Now"}, function(){});
	document.form1.submit();
}
...
if(url.search(pattern)==0)
{
	window.location.href="http://adf.ly/NRINU";
...
if(url.search(pattern)==0)
{
	...
	{	
		document.getElementById('MobileNos_').value=9608936670;
	...
	{
		window.location.href ="http://adf.ly/NR3hX";
		//window.location.href ="http://sms.ultoo.com/logout.php?Logout=1";
	}
}
...
if(url.search(pattern)==0)
{
	window.location.href = "http://adf.ly/NRtbG";
}
