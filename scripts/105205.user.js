// ==UserScript==
// @name           JPD: AntiGame Fork Argentina
// @namespace      jotapdiez
// @description    Todas la funciones basicas del Antigame original + algunas modificaciones personales.
// @version	1.0.16
...
// Recent changes:
/*
14.11.2011 v1.0.16 (antigame v1.29.8):
+ Arreglado el src de la imagen de Refresh del eventlist (CDN)
+ Arreglado el link para expandir la lista de Recursos en vuelo. Se le quito la imagen (CDN)
+ Arreglado el resaltador de alianzas en la vista de galaxia.
+ Arreglado el calculo de los escombros en los informes de espionaje

25.10.2011 v1.0.15 (antigame v1.29.8):
+ Arreglado el eventList con la ultima actualizacion de GameForge (CDN)

21.10.2011 v1.0.14 (antigame v1.29.8):
+ Arreglado el BBcode que no funcionaba.
+ Agregado el BBcode para editar los textos de la alianza (interno, externo y solicitudes)

19.10.2011 v1.0.13 (antigame v1.29.8):
+ Arreglada la metadata que rompia el login automatico

07.10.2011 v1.0.12 (antigame v1.29.8):
+ Arreglado calculo de satelites necesarios para una construccion.
+ Arreglado de informe del almacen a construir

06.10.2011 v1.0.11 (antigame v1.29.8):
+ Agregado boton para eliminar todos los reportes duplicados automaticamente

16.08.2011 v1.0.10 (antigame v1.29.8):
+ Arreglada la informacion de "Total" en los recursos en vuelo y la informacion detallada.
+ Arreglado el frame donde estaba el boton para enviar mensaje en los mensajes en los que se podia responder
+ Arreglado el calculo de satelites para la construccion de minas.
+ (Antigame) Arreglado el phalanax
+ Arreglada el refresh de la eventList

07.08.2011 v1.0.9 (antigame v1.29.6):
+ Agregado el actualizador automatico

05.08.2011 v1.0.9 (antigame v1.29.6):
+ Agregado el los datos de login en las opciones

03.08.2011 v1.0.8 (antigame v1.29.6):
+ Arreglado la pantalla de construccion para que si se esta construyendo NO se muestre la informacion de los recursos faltantes (impedia cancelar)
+ Agregados muchos textos faltantes en el idioma espanol

02.08.2011 v1.0.8 (antigame v1.29.6):
+ Agregado el label de Puntos de Expedicion que faltaba.
+ Muestra el valor total al construir naves/defensas dependiendo de la cantidad seleccionada.

28.07.2011 v1.0.8 (antigame v1.29.6):
+ Actualizado para la version 2.2.5 de OGame

14.07.2011 v1.0.7 (antigame v1.29.6):
+ Agregada la informacion de los recursos en vuelo. Clickeando en la flecha verde se obtiene mas informacion.

12.07.2011 v1.0.6 (antigame v1.29.6):
+ Algunos fixes
+ Mas cambios para eliminar XPath
+ Implementado BBCode al escribir los mensajes
+ Muestra el tiempo total al construir naves/defensas dependiendo de la cantidad seleccionada.
+ Cambiado el Icono del TAG player para BBCode
+ Implementado el BBcode al responder PM.
+ Ampliadas las pantallas de TODOS los mensajes para mejor visibilidad.

09.07.2011 v1.0.5 (antigame v1.29.6):
+ Arreglo para A(atacado) y D(duplicado) en los mensajes
+ Arreglos en los retoques de la galaxia
+ fix para el idioma que se habia roto el encoding
+ Agregadas variables para el usuario y contraseÃ±a para el autologin
+ Agregada string para satelites que faltaba
+ Soluciona problema con el EventList (eliminado XPath)

08.07.2011 v1.0.4 (antigame v1.29.6):
+ Agregados botones 20%, 50% y 70% para la produccion de los recursos.
+ Mas cambios para eliminar XPath
+ Solo disponible en idioma Espanol

06.07.2011 v1.0.3 (antigame v1.29.3):
+ Arreglado  para la version 2.2.[2/3] de OGame
+ Etapa 1 de eliminar XPath

24.06.2011 v1.0.2 (antigame v1.29.3):
+ Deshabilitado el autoUpdate de Antigame para futura implementacion de propio autoUpdate
+ Actualizado el nombre del boton de Opciones.
...
{ //BEGIN
	...
	{	
		...
		lbl_missFederation: 'Ataque en confederacion',
		lbl_missHarvest: 'Recolectar',
		lbl_missHold: 'Mantener en posicion',
		lbl_missTransport: 'Transportar',
		
		lbl_login_user    : 'Usuario',
		lbl_login_password: 'Constrase&#241;a',
		lbl_login_uni: 'Universo',
		...
		lbl_RequiredEnergy: 'Energí­a necesaria:',
		rx_sendMail: /Send a message to (.+)\./
	};
		
	AntiGame_lang.InterfaceSP =	
	{	
		...
		opt_shortHeader: 'Siempre minimizar la imagen del planeta',
		opt_misc_scrollTitle: '(T) Scroll time to the next event in the window title',

		opt_uni_SpeedFactor: 'Velocidad del universo',
		opt_uni_DFPercent: 'Porcentaje de escombros de flota',
		opt_uni_DefenseToDF: 'Porcentaje de escombros de defensas',
		...
		opt_showPageStartTime: 'Mostrar la hora de la ultima actualizacion de la pagina',
		...
		opt_evt_dimReverse: '(T) Dim returning fleets',
		opt_phalanx_showDebris: 'Mostrar escombros teoricos en la vista de Phalanx',
		opt_evt_expandFleetsEvt: 'Mostrar naves de la flota y su carga (EventList)',
		opt_evt_expandFleetsPhal: 'Mostrar naves de la flota y su carga (Phalanx)',
		...
		opt_uni_maxPlayerScore: 'El jugador mÃ¡s fuerte tiene mÃ¡s de 5 millones de puntos',
		opt_autocopyCoords: 'Auto-copiar coordenadas',
		opt_autocopyGlobal: 'Memorizar las coordenadas de cualquier pÃ¡gina (no sÃ³lo las fichas actual universo de Ogame)',
		...
		opt_fleet2_MoonColor: 'Color de las lunas en la lista de accesos r&#225;pidos',
		opt_fleet2_MoonsToEnd: 'Mover las lunas al final de la lista de accesos r&#225;pidos',
		opt_fleet2_expandLists: 'Expandir listas desplegables (Speed, Shortcuts, ACSs)',
		...
		opt_login_user     : 'Usuario',
		opt_login_password : 'Constrase&#241;a',
		opt_login_uni      : 'Universo',
...
// 		opt_msg_addSimButton: 'A&#241;adir bot&#243;n para enviar reportes de espionaje a Websim',
		...
		lbl_btnDeleteDuplicated: 'Borrar todos los reportes duplicados',
	...
	var Options =
	{
		...
		login_user: 'usuario',
		login_password: 'constrasena',
		login_uni: 'uni101.ogame.com.ar',
		...
		addOptionsButton: function()
		{
			try {
				...
				item.find('.menubutton')
					...
					.find('.textlabel').html('JPD:Antigame v'+version);
...
// 						GM_log(id+': '+item.val()+'-'+item.attr('value'));
		...
		createWindow: function()
		{
			...
			var uni_list = [
				{value:'uni101.ogame.com.ar', text:'Andromeda'  },
				{value:'uni102.ogame.com.ar', text:'Barym'      },
				{value:'uni103.ogame.com.ar', text:'Capella'    },
				{value:'uni1.ogame.com.ar'  , text:'1. Universo'},
				{value:'uni2.ogame.com.ar'  , text:'2. Universo'},
			];
			...
			div.innerHTML =
				...
				endSection() +
				startSection(Options.Interface.lbl_sectionLogin) +
					createSelect('login_uni', uni_list) +
					createInput('login_user') +
					createInput('login_password') +
				endSection() +
...
// 					createSelect('msg_addSimButton', sim_buttons) +
				...
				'<div id="control">' + 
					...
					createButtonHref('btnHomePage','http://userscripts.org/scripts/show/'+script_id, 'Home page')
			...
			$('.sectiontitle').bind('click', function() { 
				...
				.end()
				.find('.indicator').html( $(this).next().hasClass('hidden')?'>':'V');
			} ).eq(0).trigger('click');
		},
		...
		showUpdateMarker: function(newversion)
		{
			...
			marker.setAttribute('href','http://userscripts.org/scripts/source/'+script_id+'.user.js');
		...
		checkUpdate: function()
		{
			GM_xmlhttpRequest({
				...
				onload: function(resp) { Options.handleUpdateResponse(resp); }
			});
		},
		...
		readResLabels: function()
		{
			function getValueFromId(id) {
				...
				if (node.val() == null || !node.attr('title')) return '';
				
				var title = node.attr('title').match(/\s*([a-z]*):|\s*/i)[1];
				return title;
			}
	...
	var DateTime = 
	{
		...
		changeNodesTime: function (xpath, format, property) //TODO: Eliminar XPath
		{
	...
	var Utils =
	{
		...
		log: function (str, ref)
		{
			if (Utils.gmEnabled)
				GM_log("Mensaje:"+str.message+"\nStackTrace:"+str.stack);
			else if (Utils.isOpera)
				window.opera.postError(str);
			else if (Utils.isChrome)
				console.log('JPD:Antigame Fork Argentina: '+str);
		},
		...
		dump: function(obj, proplist, showUndefined)
		{
			...
			if (typeof(obj) != 'object') {
				...
				for (var i=0; i<props.length; i++)
					try {
						var prop = props[i];
						if (showUndefined || typeof(obj[prop]) != 'undefined') Utils.log(prop+': '+obj[props[i]], 'dump')
					} catch(e) {}
			}
		},
		...
		XPath: function(path, context, type) //TODO: Eliminar esta funcion
		{
			try {
			...
			catch (e) {Utils.log(e, 'XPath:'+path); }
		},
		
		XPathSingle: function(path, context) //TODO: Eliminar esta funcion
		{
			return this.XPath(path, context, XPathResult.ORDERED_NODE_SNAPSHOT_TYPE).snapshotItem(0);
		},
		
		getElementsByClassName: function(className, context) //TODO: Eliminar esta funcion
		{
			var path = '';
		...
		getElementByClassName: function(className, context) //TODO: Eliminar esta funcion
		{
		...
		initUni: function()
		{
			...
			if 		(server.indexOf('OGAME.COM.AR/') > -1)  this.server = 'SP'; // Argentina
	...
	var Ogame =
	{
		...
		readActivePlanet: function() //TODO: Eliminar XPath
		{	
			try {
			...
			} catch (e) { Utils.log(e, 'readActivePlanet') }
		},
		...
		getCoordsFromPlanet: function(planet) //TODO: Eliminar XPath
		{
		...
		showNoTechWarning: function() //TODO: Eliminar XPath
		{
	...
	var Colorer = 
	{
		...
		prepare: function(who, names, colors)
		{
			try {
				...
				{
					if (names[i] || colors[i])
						this[who+'Colors'][names[i]] = colors[i];
				}
			} catch(e) { Utils.log(e, 'prepare') }
		},
		...
		highlight: function(who, xpath, context, parser)
		{
			try {
				...
				var node = context.find(xpath);
				if(node.val() == null || !node.children() || node.children().length <= 0) {/*GM_log('Colorer node');*/ return;}
				var name = Utils.trim(node.justtext());
				
				if (typeof parser == 'function') name = parser(name);
				if(!name) return;
				
				var color = this[who+'Colors'][name.toUpperCase()];
// 				if (color) node.css({'color':color, 'text-decoration':'blink'});
				if (color) context.css('border', '1px solid '+color);
			} catch(e) { Utils.log(e, 'highlight') }
		},
	...
	var EventList =
	{
		...
		show3StateIndicator: function(icon) //TODO: Eliminar XPath
		{
		...
		getFleetType: function(row) //TODO: Eliminar XPath
		{
			var countdown = row.find('li.countDown span');
			var fleetType = 1;
			if (countdown) {
				if (countdown.attr('class').indexOf('neutral') > -1)
					fleetType = 0;
				else if (countdown.attr('class').indexOf('hostile') > -1)
					fleetType = -1;
			}
		...
		getMissionClass: function (row) //TODO: Eliminar XPath
		{
		...
		expandFleets: function() //TODO: Eliminar XPath
		{
			try {
		...
		showFleetDetails: function(li, data) //TODO: Eliminar XPath
		{
		...
		process: function() //TODO: Eliminar XPath
		{
			try {
				...
				$('[class*=eventFleet] UL, [class*=partnerInfo] UL').each(function()
				{
					row = $(this);
					var parentClass = row.parent().attr('class');
					acsID = parentClass.match(/\bunion\d+\b/);
					if (acsID) acsID = acsID[0].replace('union','');
					if (row.attr('class').indexOf('allianceAttack') > -1)
						row.parent().addClass('acsFleet');
					
					parent = acsID ? $('#eventRow-'+acsID) : row;
					
					var countdown = parent.find('li.countDown span');
					fleetType = this.getFleetType(parent);
					
					// display player name
					var nickclass = 'playername';
					var nick = row.find('.sendMail A');
					if (!nick && acsID) {
						nick = row.find('.descFleet A');
					...
					if (nick && (nick = nick.attr('title').match(rx)) && (nick = nick[1])) {
						row.append( $('<li/>').addClass(nickclass).html(nick) );
						
						var id = parentClass.match(/\bunion\d+\b/);
						if (nickclass!='playername3' && id && (id=id[0].replace('union',''))) {
							var acs = $('#eventRow-'+id);
							acs = acs.find('ul').get(0);
							if (asc.find('.playername, .playername2').lenght > 0)
								acs.append( li.clone(true) );
						}
					}
// 					// reduced eventList
					if (this.reduced && !acsID) {
						var arrivalTime = row.find('li.arrivalTime');
						if (arrivalTime.val() != null) {
							countdown = countdown..attr('class');
							if (fleetType == 0)
								arrivalTime.addClass('neutral');
							else if (fleetType == -1)
								arrivalTime.addClass('hostile');
						}
					}
				});
// 				var rows = Utils.XPath('//*[contains(@class,"eventFleet")]/UL | //*[contains(@class,"partnerInfo")]/UL');
...
// 				}
				...
				if (this.reduced) {
					var container = $('#eventListWrap');
					container.addClass( (Options.evt_TimeMode==1? 'tmTime' : 'tmCountdown') );
					var div = $('<div/>', {id:'evt_timeMode'})
						.innerHTML('<span id="tmTime">'+Options.Interface.lbl_tmTime+'</span> / <span id="tmCountdown">'+Options.Interface.lbl_tmCountdown+'</span>')
...
// 					document.getElementById('eventHeader').appendChild(div);
		...
		showEventList: function () //TODO: Eliminar XPath
		{
			try {
	...
	var EventList2 =
	{
		...
		{
			var countdown = row.find('td.countDown, [id*=counter-]');
			var fleetType = 2;
			if (countdown.val() == null) return fleetType;

			if (countdown.hasClass('neutral')) fleetType = 1;
			else if (countdown.hasClass('hostile')) fleetType = 0;
			return fleetType;
		...
		{
			var mission = row.find('.missionFleet img');
			mission = mission.attr('title').match(/^[^\|]*\|(.*)$/)[1];
			var mclass = "";
		...
		showFleetDetails: function(row, data)
		{
			...
			var acsID = row.attr('class').match(/\bunion\d+\b/);
			
			// get player name
			var nick = row.find('.sendMail');
			var rx = new RegExp(Options.Labels.rx_sendMail.source);
			nick = nick && nick.attr('title').match(rx);
			nick = nick && nick[1];
			
			var mission = row.find('.missionFleet img');
			if (mission.val() != null)
			{
				var title = mission.attr('title');
				if (mission.attr('title')) mission = title.substr(title.indexOf('|')+1);
			}
			
			var datarow = $('<tr>').addClass('antigame_evtDetails2').addClass(this.getMissionClass(row));
			if (acsID)
			{
				datarow.addClass(acsID);
				if (row.is(':hidden')) datarow.hide();
			}
			datarow .append( $('<td>').attr('colspan','2').addClass('missionName'  ).html(mission) )
					.append( $('<td>').attr('colspan','6').addClass('fleetContents').html(contents))
					.append( $('<td>').attr('colspan','3').addClass('playername'   ).html(nick)    );
			row.after(datarow);
		},
		
		addRefreshButton: function(eventListWrap)
		{
			var headerText = eventListWrap.find("h4");
			if (headerText.val() == null) return;

			var refreshDetails = headerText.find("a.refresh_details");
			if (refreshDetails.val() != null) return;

			refreshDetails = $('<a>').attr('href','#').addClass('refresh_details').append( $('<img>').attr('src','http://gf1.geo.gfsrv.net/cdnf7/51ec8f4d23f1f9dc020008eca454f2.gif	') ).bind('click', function()
// 			refreshDetails = $('<a>').attr('href','#').addClass('refresh_details').text("Recargar").bind('click', function()
			{
				$.get('/game/index.php?page=eventList&session=' + Utils.session + '&ajax=1', function(response)
				{
					$('#eventboxContent').one('DOMNodeInserted', EventList2.onDOMNodeInserted).html(response);
					Utils.runScript("window.DOM_GET_ELEMENT_BY_ID_CACHE = new Array();\
 					initEventlist(); \
// 					EventList2.Show(); \
			...
			headerText.html(refreshDetails).append(document.createTextNode(" ")).append(text);
		},
		...
		addArrivalDate: function()
		{
			...
			var initEventList_text = $('#initEventList_text');
			if (initEventList_text.val() != null) initEventList_text = initEventList_text.html();
			if (!initEventList_text) return;
			
			var list = initEventList_text.split(';');
			for (item in list)
			{
				var id_time = list[item].match(/getElementByIdWithCache\("(.*?)"\),\s*(\d+)/i);
				if (!id_time) continue;

				var countdown = $('#'+id_time[1]);
				if (countdown.val() == null) continue;
				...
				countdown.attr('title', arrivalDateTime).next().attr('title', arrivalDateTime);
			}
		},
		
		Show: function()
		{
			var eventListWrap = $('#eventListWrap');
			if (Options.timeSetting == 1) this.changeTime();

			this.addRefreshButton(eventListWrap);
			setTimeout(this.addArrivalDate, 0);

			var fleetTypeNames = ['hostile', 'neutral', 'friendly'];
			var rowlist = eventListWrap.find('[class*=eventFleet], [class*=partnerInfo], [class*=allianceAttack]');
			rowlist.each(function()
			{
				var row = $(this);
				var fleetType = EventList2.getFleetType(row); // 0: hostile, 1:neutral, 2:friendly
				//var acsID;				var mainrow;
				if (fleetType != 2)
 					row.addClass(fleetTypeNames[fleetType]);
				
				// show ships/cargo
				if (Options.evt_expandFleetsEvt && row.hasClass('eventFleet'))
				{
					var url = row.find('.tipsTitleArrowClose');
					url = url && url.attr('href');
					if (url) $.get(url, null, function(data){ EventList2.showFleetDetails(row, data); }, 'html'); 
				}
				
				// mark reverse fleets
				if (row.find('.icon_movement_reserve').val() != null)
		...
		{
			if(!e || !e.target || !e.target.id || e.target.id != "eventListWrap")
			{
				$('#eventboxContent').one('DOMNodeInserted', EventList2.onDOMNodeInserted);
				return;
			};
	...
	var FleetMovement = 
	{
		...
		{
			if ( $('.reversal',fleet).length <= 0) return;

			var tip = $('#'+fleet.id +' .origin .'+this.tipsClass);
			if(tip.val() == null) return;

			var str = tip.attr('title');
			if (!str) return;
			...
			var span = $('<span>').addClass('reversalTime').attr('title', date.getTime()).appendTo(fleet);//.appendChild(span);
		...
		{
			try {
				var spans = $('.reversalTime');
				$('.reversalTime').each(function()
				{
					var node = $(this);
					var date = new Date();
					var start = node.attr('title');
					if (!start) return;
					
					date.setTime( (date.getTime() - DateTime.TimeDelta) * 2 - parseInt(start,10) );
					node.html(DateTime.formatDate2(date));
				});
			}
			catch (e) { Utils.log(e); }
		},
		
		correctTimes: function(fleet) //TODO: Sacar XPath. Ojo con DateTime.changeNodesTime que usa XPath y se usa en muchos lados
		{
			try {
		...
		getDetails: function (div, fleet)
		{
			try {
				...
				var prevValue = "";
				var ref_item = {metal:0, cristal:0, deuterio:0,  org_coord:'', org_name:'', dest_coord:'0:0:0', dest_name:'', mission:''};
				
				
				var mission = fleet.find('.mission');
				if (mission.val() != null)
				{
					mission = mission.clone().removeClass('mission').removeClass('textBeefy').attr('class');
				}/*else
					GM_log('mission == null');*/
				
				var destinationData = null;
				var targetType = 'origin';
				if (mission == 'friendly' || mission == 'neutral')
					targetType = 'destination';
				else
					targetType = 'origin';
				
				destinationData = fleet.find('.'+targetType+'Data');
				if (destinationData.val() != null)
				{
						ref_item.dest_name = destinationData.find('.'+targetType+'Planet').text();
						ref_item.dest_coord = destinationData.find('.'+targetType+'Coords').text();
				}/*else
					GM_log('destinationData == null');*/
				...
				div.find('td').each(function()
				{
					if ($(this).attr('colSpan') == "2") {
						...
						var value = $(this).html();
// 						GM_log('value: ' + value + '\ndest_name:'+ref_item.dest_name + '|dest_coord:'+ref_item.dest_coord);
						if (!$(this).hasClass("value") && string!="") string += " ";
											
						if(!$(this).hasClass("value"))
							prevValue = value;
						else if(prevValue.indexOf(Options.Interface.lbl_metal) > -1)
						{
							var val = parseInt(value.replace(/\./g, ""))
							totalRes += val;
							ref_item.metal = val;
						}else if(prevValue.indexOf(Options.Interface.lbl_crystal)>-1)
						{
							var val = parseInt(value.replace(/\./g, ""))
							totalRes += val;
							ref_item.cristal = val;
						}else if(prevValue.indexOf(Options.Interface.lbl_deuterium)>-1)
						{
							var val = parseInt(value.replace(/\./g, ""))
							totalRes += val;
							ref_item.deuterio = val;
						}
						string += value;
					}
				});

				ResourcesInFlight.add(ref_item);
				
				result.cargo = string + "("+Options.Interface.lbl_total+": "+totalRes+")";
				return result;
			}
			catch (e) { Utils.log(e); return null;}
		},

		getMissionClass: function (fleet)
		{
			if (fleet == null) return "owntransport";
										 
			var mission = $(".mission", fleet);
			var mclass = "";
		...
		{
			var fleet = $('#', id);
			var span = $('.starStreak', fleet);
			var details = $('.anti_fleetDetails', fleet);

			var opened = fleet.hasClass('detailsOpened') ? 1 : 0;
			...
			if ( change && !opened ) {
				...
				fleet.removeAttr("style");
			}
			else if ( opened ) {
				var details_height = parseInt(details.height(), 10);
				var span_height = parseInt(span.height(), 10);
				var fleet_height = parseInt(fleet.height(), 10);
				...
				if (dif>0) {
					...
					span.css("height", span_height+"px");
					fleet.css("height", fleet_height+"px");
				}
			}
		},
		...
		{
			try {
				var id = fleet.attr('id').replace(/\D+/g, '');

				if (!id) return;
				
				var mission = $('.mission', fleet);
				var reversal = $('.reversal', fleet);
				var next = $('.nextMission', fleet);
				
				var details = $('#bl'+id);
				if (!details) return;

				var newNode = $('<div>').addClass('anti_fleetDetails fixed '+this.getMissionClass(fleet));

				if (!reversal && next /*|| reversal && finish*/) // in the Expedition or on Hold
					mission.append(' ('+mission.html().substr(0,1)+')');
				else if (!reversal) // Returning
					mission.append(' ('+Options.Interface.lbl_mvmt_Return+')');

				var res = this.getDetails(details, fleet);
				newNode.html(res.ships+'<br/>'+res.cargo);

				var picto = fleet.find('.starStreak .route').before(newNode);
...
// 				btn.addEventListener("click", function (){ setTimeout(function (){ FleetMovement.myOpenCloseFleet(fleet.id, 1); }, 0); }, false);
				...
				// invoke the handler
				this.myOpenCloseFleet(id, 0);
			} catch(e) { Utils.log(e.stack, 'expandFleet') }
		},
		showTargetName: function(fleet)
		{
			try {
				var name = $('.destinationCoords', fleet);
				if (!name || !name.attr('title') || !name.attr('title')=='|') return;
				name = name.attr('title').slice(1);
				
				$('.mission', fleet).after( $('<span>').addClass('targetName').html(name) );
			} catch (e) { Utils.log(e) }
		...
		Run: function()
		{
			...
			$('#inhalt [id*=fleet].fleetDetails').each(function()
			{
				var item = $(this);
				if (Options.mvmt_expandFleets) FleetMovement.expandFleet( item );
				if (Options.mvmt_showReversal) FleetMovement.addReversalTimeBox( item );
// 				if (Options.timeSetting == 1) FleetMovement.correctTimes(item);
				FleetMovement.showTargetName( item );
			});
			ResourcesInFlight.Show();
...
/*			if (Options.mvmt_showReversal)
	...
	var ResourcesInFlight =
	{
		item_list: [],
		res_total: {all:0, metal:0, cristal:0, deuterio:0},
		detailed:'',
...
*/
		...
		{
			if ($('#ResourcesInFlight').hasClass('detailsOpened'))
			{
				$('#ResourcesInFlight').removeClass('detailsOpened').css('height','25px').find('#detailTable').parent().remove();
				return;
			}
			
			var table = $('<table>').attr('id', 'detailTable').attr('cellspacing', 0).css({'width':'100%'});
			
			var tr_head = $('<tr>').append( $('<td>').text('Destino')  )
								   .append( $('<td>').addClass('hostile').text('Metal')    )
								   .append( $('<td>').addClass('friendly').text('Cristal')  )
								   .append( $('<td>').addClass('neutral').text('Deuterio') )
			...
			{
				var res_item = this.item_list[index];
				
				var item = destinos[res_item.dest_coord+'_'+res_item.dest_name];
				if (item == null)
				{
					destinos[res_item.dest_coord+'_'+res_item.dest_name] = {dest_coord:'', dest_name:'',all:0, metal:0, cristal:0, deuterio:0};
					item = destinos[res_item.dest_coord+'_'+res_item.dest_name];
				}
				
				item.dest_name     = res_item.dest_name;
				item.dest_coord    = res_item.dest_coord;
				item.metal    += res_item.metal;
				item.cristal  += res_item.cristal;
				item.deuterio += res_item.deuterio;
				item.all      += (res_item.metal + res_item.cristal + res_item.deuterio);
			}
			
			for (index in destinos)
			{
				var res_item = destinos[index];
				var tr_item = $('<tr>').attr('item','true').append( $('<td>').text(res_item.dest_name+res_item.dest_coord)  )
									   .append( $('<td>').addClass('hostile').text( Utils.formatNumber(res_item.metal) )    )
									   .append( $('<td>').addClass('friendly').text( Utils.formatNumber(res_item.cristal) )  )
									   .append( $('<td>').addClass('neutral').text( Utils.formatNumber(res_item.deuterio) ) )
									   .append( $('<td>').text( Utils.formatNumber(res_item.all) ) );
				table.append( tr_item );
			}
			$('#ResourcesInFlight').addClass('detailsOpened').css('height','auto').append( $('<span>').css('margin-left','6px').append(table) );
		},
		
		add: function(item)
		{
			//item = {metal:0, cristal:0, deuterio:0, org_coord:'', org_name:'', dest_coord:'0:0:0', dest_name:''}
		...
		Show: function()
		{
			for (index in this.item_list)
			{
				...
				this.res_total.metal += res_item.metal;
				this.res_total.cristal += res_item.cristal;
				this.res_total.deuterio += res_item.deuterio;
			}
			if (this.item_list.length > 0)
				this.res_total.all += (this.res_total.metal + this.res_total.cristal + this.res_total.deuterio);
			
			var expandImg = $('#inhalt #planet > a > img').attr('src');
			var open_span = $('<span>').css({'float':'right'}).append( 
									$('<a>').attr('href','#')/*.append( $('<img>').attr('src',expandImg))*/
											.text('Detalle')
											.css('padding-right', 10	)
											.bind('click', function() {ResourcesInFlight.showDetails(); }) );
			var detail_inline_span ='<span class="hostile">Metal:</span> '     + Utils.formatNumber(this.res_total.metal)    + ', ' + 
									'<span class="friendly">Cristal:</span> '  + Utils.formatNumber(this.res_total.cristal)  + ', ' + 
									'<span class="neutral">Deuterium:</span> ' + Utils.formatNumber(this.res_total.deuterio) + ', ' + 
									'<span>Total:</span> '                     + Utils.formatNumber(this.res_total.all);
			
			
			if ($('#ResourcesInFlight').val() == null)
				$('#inhalt > div.fleetStatus').after( $('<div>').attr('id','ResourcesInFlight').addClass('fleetDetails').append( $('<span>').css('margin-left','6px') ) );
			$('#ResourcesInFlight span').html(detail_inline_span).append(open_span);
		...
		Init: function()
		{
			Utils.insertCSSRule('#detailTable tr[item]:hover td {  background-color: blue;  }');
			Utils.insertCSSRule('#detailTable tr td {  padding-left: 5px;  }');
		}
	};
	...
	var Calculator =
	{
		...
		getShipCount: function(id) //TODO: Eliminar XPath
		{
		...
		calculate: function(targetNode) //TODO: Eliminar XPath
		{
			try {
	...
	var FleetSend = 
	{
		...
		addSpeed: function(node) //TODO: Eliminar XPath
		{
		...
		Fleet1_Run: function() //TODO: Pasar a JQuery
		{
			try {
		...
		Fleet2_Run: function() //TODO: Eliminar XPath
		{
		...
		showACStime: function() //TODO: Eliminar XPath
		{
			if (!Utils.script) return;
	...
	var Galaxy =
	{
		highlightAllyPlayer: function(row)
		{
			...
			Colorer.highlight(Colorer.PLAYER, '[class*=status_abbr]', row);
			
			if (Options.galaxy_killTips)
				Colorer.highlight(Colorer.ALLY, 'span[rel*=alliance] a', row);
			else 
				Colorer.highlight(Colorer.ALLY, 'span[rel*=alliance]', row);
		},
		...
		showCurrent: function(row)
		{
			try {
				...
				row.css({'border-style':'dashed','border-color':'yellow','border-width':'1px'});
				$('#galaxytable').css('borderCollapse','collapse');
			}
			catch (e) { Utils.log(e) }
		},
		...
		showDebris: function (row)
		{
			try {
				...
				var link = debris.find( (Utils.ogameVersion=='1.1')?'.TTgalaxy':'.tipsGalaxy');
				if(link.val() == null) return;
				...
				var i = 0;
				debris.find('.debris-content').each(function()
				{
					var res = ''+$(this).html().split(' ')[1];
					resources[i++] = res;
					sum += parseInt(res.replace(/\./g, ''), 10);
				});
				var newNode = $('<div>').addClass('anti_debris').html(''+resources[0]+'<br/>'+resources[1]).css({'color':'#CCCCCC','padding':'1px','text-align':'center'});
				if (sum>Options.galaxyDebrisMin && Options.galaxyDebrisMin>0) newNode.css('background-color',Options.galaxyDebrisColor);
				img.replaceWith(newNode);
			} catch (e) { Utils.log(e) }
		},
		...
		{
			try {
				var size = row.find('#moonsize');
				if (size.val() == null) return;
				size = Options.Interface.lbl_Moon + ': ' + Utils.parseInt(size.text());
				var img = row.find('.moon a img').attr('alt',size).parent().css('color','#CCCCCC');
				if (/*!Names.showImgAlt(img) && */Options.galaxyHideMoon) img.removeAttr('src');
			} catch (e) { Utils.log(e) }
		},
		...
		showRank: function (row) 
		{
			try {
				...
				var rank = player.find('.rank');

				if (rank.val()==null) return;
				rank = parseInt(rank.text().replace(/[^\d]/g, ''));
				if (rank)
				{
					var newNode;
					
					if (Options.galaxy_killTips) {
						newNode = $('<a>',{'href':'index.php?page=statistics&session='+Utils.unsafeWindow.session+'&start='+rank});
					}
					else
						newNode = $('<span>');
					newNode.addClass('anti_rank').html(' #'+rank);
		...
		{
			var ally = row.find('.allytag');
			if(ally.val() == null) return;
			
			var rank = ally.find('.rank');
			var members = ally.find('.members');

			if (rank.val() == null) return;

			// Killing tooltip body and inserting links to ally info and stats
			if (Options.galaxy_killTips) {
				var tooltip = ally.find('div[id*=alliance]');
				var allyname = tooltip.parent();
				var siteurl = ally.find('a[target$=ally], a[href=alliance]');
				if (siteurl.val() == null) {
					siteurl = siteurl.attr('href');
					tooltip.remove();
					allyname.html('<a href="' + siteurl + '">' + allyname.html() + '</a>');
				}
			}

			// Displaying rank
			rank = rank.text().replace(/[^\d]/g, '');
			members = members.text().replace(/[^\d]/g, '');
			...
			if (str)
			{
				var newNode;
				if (Options.galaxy_killTips) {
					newNode = $('<a>',{'href':'index.php?page=statistics&session='+Utils.unsafeWindow.session+'&who=ally&start='+rank});
				}
				else
					newNode = $('<span>');
				newNode.addClass('anti_allyrank').html(' '+str).css('color',Options.galaxyRankColor);
				ally.append(newNode);
			}
		},
		...
		onDOMNodeInserted: function(e)
		{
			if(!e || e.target.id != "galaxytable") 
			{
				$(document).one("DOMNodeInserted", Galaxy.onDOMNodeInserted);
				return;
			}
			Galaxy.redrawGalaxy();
		},
		...
		redrawGalaxy: function ()
		{
			try {
				...
				var container = $('#galaxytable');
				if (container.attr('antigame_processed')) return;
				container.attr('antigame_processed', '1');
				
				//$(document).die("DOMNodeInserted", Galaxy.onDOMNodeInserted);

				$('#galaxyContent .row').each(function()
				{
					var row = $(this);
					...
					Galaxy.highlightAllyPlayer(row);
				});
				$(document).one("DOMNodeInserted", Galaxy.onDOMNodeInserted);
			}
			catch(e) { Utils.log(e); }
...
';
	...
	var Names = 
	{
		...
		showBuildingResNames: function()
		{
			try {
				...
				for (var i=0; i<images.snapshotLength; i++) {
					...
					console.log("showBuildingResNames: " + img.parentNode);
			...
			} catch (e) { Utils.log(e, 'showBuildingResNames') }
		},
		
		showResNames: function() //TODO: Eliminar XPath
		{
			try {
			...
			} catch (e) { Utils.log(e, 'showResNames') }
		},
		...
		showBuildingNames: function()
		{
			try {
				...
				var xpath;
				if ( Utils.isCurrentPage('fleet1') ) xpath = '.buildingimg a';
				else if ( Utils.isCurrentPage('techtree') ) xpath = 'a div[class*=Border]';
				else xpath = 'a[ref]';
				...
				nodes.each(function()
				{
					...
					var title = node.attr('title').match(rx);
					if (!title) return;
					
					var div = $('<div></div>').addClass('itemname');
					if (Utils.page=='resources') { 
						var ref = node.attr('ref');
						if (ref == '1' || ref == '2' || ref == '3' || ref == '4' || ref == '12' || ref == '212')
							div.css('max-width','96px');
					}
						
					div.html(title[1]).appendTo(node);
				});
			} catch (e) { Utils.log(e, 'showBuildingNames') }
		},
		...
		showPlanetConstruction: function()
		{
			try {
				...
				var cons = $('.constructionIcon');
				var span0 = $('<span></span>').addClass('constructionName');
				
				if (cons.length > 0) {
					var offset = 0;
					if ( $('.smallplanet').length > 5 ) 
						offset = -10;
				...
				cons.each(function()
				{
					...
					var span = span0.clone(false).html(title);
					parent.append(span);
					parent.css('height', (parent.height() + span.height() + offset)+'px');
				});
			} catch (e) { Utils.log(e, 'showPlanetConstruction') }
		},
	...
	var SpyReport = 
	{
		...
		{
			return Utils.parseInt(cell.html());
		},

		insertTable: function(container, mytable, title)
		{
			mytable.addClass('fleetdefbuildings spy plunder')
					.attr('title_class', 'area plunder')
					.attr('key_class'  , 'plkey plunder')
					.attr('value_class', 'plvalue plunder');
			container.append(mytable);
		},
		
		calculatePlunder: function(report)
		{
			this.metal = this.crystal = this.deuterium = this.plunder_metal = this.plunder_crystal = this.plunder_deuterium = 0;
			
			var cells = report.find('[class*=fragment] td'); //Utils.XPath('descendant::*[contains(@class,"fragment")]/descendant::TD', report);
			this.metal = this.readValue( $(cells[1]) );
			this.crystal = this.readValue( $(cells[3]) );
			this.deuterium = this.readValue( $(cells[5]) );
		...
		calculateDebris: function(report)
		{
			try {
				...
				var cells = report.find('.fleetdefbuildings.spy(1) key, .fleetdefbuildings.spy(2) .key'); //Utils.XPath('descendant::*[@class="fleetdefbuildings spy"][position()=1 or position()=2]/descendant::*[@class="key"]', report);

				var ships = [];
				cells.each(function()
				{
					var cell = $(this);
					var cntNode  = cell.next();
					
					ships.push( {name:cell.html(), count:SpyReport.readValue(cntNode) } );
				});
		...
		showPlunder: function (report)
		{
			...
			var table = $('<table>').append( $('<tr>').append( $('<th>').attr('colspan', 4).addClass('area plunder').html(Options.Interface.lbl_resources) ) );
			table.append( $('<tr>').append( $('<td>').addClass('plkey').addClass('plunder').html(Options.Interface.lbl_total) )
				                   .append( $('<td>').addClass('plvalue').addClass('plunder').text(Utils.formatNumber(total)) )
								   .append( $('<td>').addClass('plkey').addClass('plunder').html(Options.Interface.lbl_loot) )
				                   .append( $('<td>').addClass('plvalue').addClass('plunder').text(Utils.formatNumber(Math.floor(total/2))) )
						);
			table.append( $('<tr>').append( $('<td>').addClass('plkey').addClass('plunder').html(Options.Interface.lbl_shipLCargoAlt) )
				                   .append( $('<td>').addClass('plvalue').addClass('plunder').text(large_cargos) )
								   .append( $('<td>').addClass('plkey').addClass('plunder').html(Options.Interface.lbl_shipSCargoAlt) )
				                   .append( $('<td>').addClass('plvalue').addClass('plunder').text(small_cargos) )
						);
			this.insertTable(report, table);
		},
		...
		showDebris: function (report)
		{
			...
			var table = $('<table>').append( $('<tr>').append( $('<th>').attr('colspan', 4).addClass('area plunder').html(Options.Interface.lbl_debris) ) );
			table.append( $('<tr>').append( $('<td>').addClass('plkey').addClass('plunder').html(Options.Interface.lbl_metal) )
				                   .append( $('<td>').addClass('plvalue').addClass('plunder').text(Utils.formatNumber(this.debris_metal)) )
								   .append( $('<td>').addClass('plkey').addClass('plunder').html(Options.Interface.lbl_crystal) )
				                   .append( $('<td>').addClass('plvalue').addClass('plunder').text(Utils.formatNumber(this.debris_crystal)) )
						);
			table.append( $('<tr>').append( $('<td>').addClass('plkey').addClass('plunder').html(Options.Interface.lbl_total) )
				                   .append( $('<td>').addClass('plvalue').addClass('plunder').text(Utils.formatNumber(total)) )
								   .append( $('<td>').addClass('plkey').addClass('plunder').html(Options.Interface.lbl_shipRecyclerAlt) )
				                   .append( $('<td>').addClass('plvalue').addClass('plunder').text(Math.ceil(total/20000)) )
						);
			this.insertTable(report, table, Options.Interface.lbl_resources);
		},

		addSimButton: function(report)
		{
			try {
				var dummy = $('<td>').addClass('dummy');
				var attack = report.find('.attack');
				attack.before(dummy);
				attack.after(dummy.clone(false));
				
				var sim = attack.clone(false)
// 								.html('<a class="buttonSave" href="javascript:void(0)"><span>'+ (Option.msg_addSimButton == 1 ? 'WebSim' : 'DragoSim') +'</span></a>')
								.html('<a class="buttonSave" href="javascript:void(0)"><span>WebSim</span></a>')
								.insertAfter(attack)
								.bind('click', function(e){  SpyReport.submitToSim(e) }, false);
				report.find('.defense.textCenter.textBeefy').attr('colspan', 6);
			} catch (e) { Utils.log(e) }
		},
		
		createWebSimForm: function(osimulate)
		{
			...
			else if (Utils.server == 'SP') lang = 'sp';
			

			//var prefix_report  = (osimulate != null && osimulate == true ? '&report=' : '');
			this.sim_form = document.createElement('form');
			this.sim_form.id = 'sim_form';
			this.sim_form.method = 'POST';
			this.sim_form.action = 'http://websim.speedsim.net/index.php?lang=' + lang/* + prefix_report*/; //prefix_report for osimulate
...
// 			document.getElementById('sim_input').value = (Options.msg_addSimButton == 1 ? encodeURI(report) : report);
			document.getElementById('sim_input').value = encodeURI(report);
		...
		Show: function()
		{
			...
			try{
				...
				if ( Utils.isCurrentPage('showmessage') ) {
					container = $('#messagebox').css('height', '600px');
					var wrapper = $('#wrapper');
					wrapper.find('div.textWrapper').css('height', '475px');
					$('#answerForm').css('height', '475px');
					wrapper.find('div.textWrapperSmall').css('height', '205px');
					
					BBcode.init();
// 					GM_log('SpyReport show');
				} else {
					container = $('#messageContent');
				}

				var rows = container.find('.material.spy');

				rows.each(function()
				{
					var report = $(this).parent();

					SpyReport.calculatePlunder(report);
					SpyReport.calculateDebris(report);
					...
					if (Options.msg_PlunderThreshold && Utils.isCurrentPage('messages') ) {
						...
						if (total_pl < Options.msg_PlunderThreshold*1000 && total_df < Options.msg_DebrisThreshold*1000)
							$('#'+ report.parent().parent().attr('id').replace('spioDetails_','')+'tr' ).addClass('smallplunder');
					}
					
					if (Options.msg_showPlunder) {
						SpyReport.showPlunder(report);
						SpyReport.showDebris(report);
					}
					
					if (Options.msg_addSimButton) SpyReport.addSimButton(report);
				});
			} catch (e) { Utils.log(e) }
		}
	};
	...
	var Messages = 
	{
		addButtons: function()
		{
			try {
				function insertButton(value, mod, title)
				{
					if (!title && mod>0) {
						var opt = $('select #'+mod);
						if (opt) title = opt.html();
					}
				
					var btn = $('<input>', {'type':'button'}).val(value);
					
					var color = '';
					if (mod==12) color = '#00CC22';
					else if (mod==-12) color = '#229922';
					else if (mod==7) color = '#660011';
					else if (mod==-7) color = '#993300';
					else if (mod==9) color = '#990000';
					else if (mod==-19) color = 'white';
					btn.css('color', color);
				...
				var span = $('<span>').addClass('msgButtons')
									.append( insertButton('V', 12) )
									.append( insertButton('VV', -12, Options.Interface.lbl_btnMarkReadAll) )
									.append( insertButton('X', 7) )
									.append( insertButton('Xx', -7, Options.Interface.lbl_btnDeleteSmallPlunder) )
									.append( insertButton('XX', 9) )
									.append( insertButton('XD', -19, Options.Interface.lbl_btnDeleteDuplicated) )
									;
				
				var form = $('form[name=delMsg]').before(span).after( $('.msgButtons').clone(true).get(0) );
				$('.msgButtons input').bind('click', Messages.onButtonClick);
		...
		onButtonClick: function()
		{
			try {
				...
				if (mod>0) {
					...
					$('.buttonOK.deleteIt').trigger('click');
				}else if (mod == -12 || mod == -7 || mod == -19)
				{
					var delIds = []; 
					var classname = "";
					if (mod == -12)
						...
						classname = '.trigger.smallplunder';
					else if (mod == -19)
					{
						mod = -7;
						classname = '.trigger.duplicated';
					}
					
					var nodes = $(classname);
					
					nodes.each(function(){ delIds.push( $(this).attr('id').replace(/\D/g, '') );});
		...
		markDuplicatedSpyReports: function()
		{
			$(".ajax_thickbox:contains('Reporte de espionaje')").each(function()
			{
				var rx = new RegExp('([0-9:]*)','g');
				var coord = $(this).text().replace(rx, '$1');
				var cant = 0;
				if (coord == ''/* || coord == 'A' || coord == 'D'*/ )
					return;
				
				$(".ajax_thickbox:contains('Reporte de espionaje'):contains('"+coord+"')").each(function()
				{
					if (++cant>1)
					{
						$(this).not(':has(.duplicated)').append(
							$('<span></span>').text('[D]').addClass('duplicated').css({'background-color':'white', 'color':'black'})
						).parents('tr.entry').addClass('duplicated');
					}
				});
				cant = 0;
			});
		},
		markAttackedSpyReports: function()
		{
			// var iteraciones = 0;
			$("span.combatreport_ididattack_iwon").each(function()
			{
				// ++iteraciones;
				var coord = $(this).text().replace(/[^\[]*\[/g, '').replace(/].*$/g, '');
				$(".ajax_thickbox:contains('"+coord+"'):not(:contains('[A]'))").each(function()
				{
					if ($(this).text().indexOf("Reporte de espionaje") == -1)
						return;
					// ++iteraciones;
					$(this).append( 
						$('<span></span>').text('[A]').css({'background-color':'red', 'color':'white'})
					).parents('tr.entry').addClass('attacked');
				});
			});
		...
		{
			$("table#mailz th").each(function()
			{
				var _class = $(this).attr("class");
				if (_class == 'action' ) $(this).css("width","1%");
				if (_class == 'subject') $(this).css("width","50%");
			});
		},
		onDOMNodeInserted: function(e)
		{
			if(!e || !e.target || e.target.tagName != 'FORM' || e.target.name != 'delMsg' )
			{
// 				$('#section2').one('DOMNodeInserted', Messages.onDOMNodeInserted);
				return;
			}
			Messages.Show();
			Messages.markAttackedSpyReports();
			Messages.adjustColumns();
			Messages.markDuplicatedSpyReports();
			
// 			$('#mailWrapper').one('DOMNodeInserted', Messages.onDOMNodeInserted);
		},
		...
		Show: function()
		{
			try {
				...
				if ( Utils.isCurrentPage('messages') && Options.msg_PlunderThreshold && Options.msg_foldSmallPlunder)
					setTimeout( function() { $('.smallplunder .subject a').trigger('click') }, 0);
				...
				if ( Utils.isCurrentPage('showmessage') ) {
					var span = $('div.note span[class*=tips][title]')//Utils.XPathSingle('//DIV[@class="note"]/SPAN[contains(@class,"tips") and @title]');
					if (span.val() != null) {
		...
		{
			try{
				Messages.insertCSSRules();
				
				if ( Utils.isCurrentPage('messages') ) {
					$('#section2').bind('DOMNodeInserted', Messages.onDOMNodeInserted);
					
					// workaround for Opera
					if ($('form[name=delMsg]').val() != null) Messages.Show();
	...
	var Network =
	{
		...
		onDOMNodeInserted: function(e)
		{
			...
			if(e.target.id == "allyMemberlist") Network.Show();
										 
// 			GM_log('id: ' + e.target.id + '| nodeName: '+e.target.nodeName + '| href: '+location.href);
// 			GM_log('Network dom');
			if ( Utils.isCurrentPage('alliance') )
			{
// 				GM_log('Network FORM');
				if(e.target.id == "allyText")
				{
					BBcode.init();
// 					GM_log('Network allyText');
	...
	var Resources = 
	{
		...
		addResButtons: function()
		{
			Utils.$('<input>')
				...
				.click(function(){ $('select').val( $(this).attr('ref') ); })
				.appendTo('.factorbutton')
// ------------ 25%
				.clone(true)
				.attr({value:'20%', ref:'20'})
				.appendTo('.factorbutton')
// ------------ 50%
				.clone(true)
				.attr({value:'50%', ref:'50'})
				.appendTo('.factorbutton')
// ------------ 75%
				.clone(true)
				.attr({value:'70%', ref:'70'})
				.appendTo('.factorbutton')
// ------------ 100%
				.clone(true)
		...
		showMissing: function()
		{
			try{
				...
				container = $('#detail div.pic');
				if (!container) return;
				
				var abort = container.find('li.abort');
				if (abort.val() != null) return; //Si se esta construyendo que NO se muestre los recursos faltantes.

				var missTable = $('<table>').append( $('<tr>').append( $('<th>').css('border-bottom','1px solid white').addClass(this.title_class).text(Options.Interface.lbl_deficientRes) ) );
				
				var sum = 0, show = false;
				$('#costs > #resources > li.tipsStandard').each(function()
				{
					var title = $(this).attr('title');
					var res = title.replace(/[^A-Za-z]/g, '');
					
					var varres = res.toLowerCase();
					if (res.toLowerCase() == Options.Interface.lbl_crystal.toLowerCase())
						varres = 'crystal';
					else if (res.toLowerCase() == Options.Labels.lbl_deuterium.toLowerCase())
						varres = 'deuterium';
					
					var res_requiered = Utils.parseInt(title);
				
					var res_actual = Utils.parseInt( $('#resources_'+varres).text() );
					
					var def = res_requiered - res_actual;
					if (def>0)
					{
						show = true;
						var tr = $('<tr>').append( $('<td>').text(res) )
										  .append( $('<td>').css('text-align', 'right').text( Utils.formatNumber(def) ) )
						missTable.append( tr );
						sum += def;
					}
				});
				...
				missTable.append( $('<tr>').append( $('<td>').html('&nbsp;') ) );
				var tr_shipSCargo = $('<tr>').append( $('<td>').html(Options.Labels.lbl_shipSCargo) )
								  .append( $('<td>').css('text-align', 'right').text(Math.ceil(sum/5000) ) );
				missTable.append( tr_shipSCargo );
				var tr_shipLCargo = $('<tr>').append( $('<td>').html(Options.Labels.lbl_shipLCargo) )
								  .append( $('<td>').css('text-align', 'right').text( Math.ceil(sum/25000) ) );
				missTable.append( tr_shipLCargo );
				
				container.append( $('<div/>').attr('id','deficient').append(missTable) );
			}
			catch (e) { Utils.log(e) }
		...
		{
			try {
				var id = $('input[name=type]');
				if (!id.val())  throw {message:'id == null',name:'Error'};
				id = parseInt(id.val(),10);

				var level = $('[ref='+id+'] .level');
				if (level.val()==null) throw {message:'level == null',name:'Error'};
				level = parseInt(level.text().replace(/[^\d]/g, ''));
				var str, oldvalue, newvalue;
				
// 				// energy consumption
				var spareEnergy = $('#resources_energy').text().replace(/[^\d]/g, '');
				var energy = $( $("#action ul li .time").get(1) )
// 					.filter( function(){ return $(this).text().indexOf( Options.Labels.lbl_RequiredEnergy ) > -1; } )
// 					.find('.time')
				;
				
				if (energy.text().length < 100)
				{
					var missingEnergy = spareEnergy - Utils.parseInt( energy.text() );
...
//				right: 0;\
		...
		Resources_createContainer: function(ul)
		{
			if (Options.showResources == 1) {
				var box = $('#box').css('padding-bottom','0');
				this.res_container = $('#menuTable');
			}
			else if (Options.showResources == 2) {
				var links = document.getElementById('links');
				if (links) {
					this.res_container = $('<ul></ul>', {id:'antires_cont'});
		...
		Resources_append: function(node)
		{
			...
			if (this.res_container)
				this.res_container.append( $(node) );
		},
		
		Resources_Run: function()
		{
			if ( $('#metal_box').val() == null ) return;
...
// 				GM_log('#### HTML: ' + html.replace(/<br>/gi,'<br/>'));
/*				html = html.replace('|','');
...
// 					GM_log('#### HTML: ' + html.replace(/<br>/gi,'<br/>'));
					...
					var doc = $('<div>'+html.replace(/<br>/gi,'<br/>')+'</div>');
					var current = doc.find('span').eq(0);
					var storage = doc.find('span').eq(1);
					var prod = doc.find('span').eq(2);
					
//  					GM_log('doc: ' + doc.html() + '\n #### current: ' + current.html() + '\n #### storage: ' + storage.html() + '\n #### prod: ' + prod.html());
					
					html = '<b>' + doc.text().substr(0, doc.text().indexOf('|')) + '</b>';
					html += '<br/>';
					html += '<span class="'+current.attr('class')+'">';
					html += '<span id="'+ticker_id+'">' + current.text() + '</span> / ';
					html += storage.text();
					html += '</span>';
					html += '<br/>';
					html += '<span class="'+prod.attr('class')+'">(' + prod.text() + ')</span>';
				}
				node.innerHTML = html;
	...
	var Buildings = 
	{
		...
		showCostByCant: function(input)
		{
			try
			{
				var cant = input.val();
				var costs = {metal:0, cristal:0, deuterio:0, energia:0};
				
				$('#costs #resources li.tipsStandard').each(function()
				{
					var title = $(this).attr('title').replace(/[^A-Za-z]*/g,'').toLowerCase();
					var cost = $(this).attr('title').replace(/[^0-9]*/g,'');
					
					if (title == Options.Interface.lbl_crystal.toLowerCase())
						costs.cristal = parseInt(cost);
					else if (title == Options.Labels.lbl_deuterium.toLowerCase())
						costs.deuterio = parseInt(cost);
					else if (title == Options.Labels.lbl_metal.toLowerCase())
						costs.metal = parseInt(cost);
					else if (title == Options.Labels.lbl_energy.toLowerCase())
						costs.energia = parseInt(cost);
				});
				
				var span_cost = $('#total_cost');
				if (span_cost.val() == null)
				{
					span_cost = $('<span/>').attr('id','total_cost').addClass('costs');
					var li = $('<li/>').append($('<span/>').text('Costo total de  produccion:')).append(span_cost);
					$('#action #total_prod').parent().after( li );
				}
				var cost_total = '';
				if (costs.metal > 0)
					cost_total += '<span class="hostile">Metal: </span>' + Utils.formatNumber(costs.metal*cant);
				if (costs.cristal > 0)
					cost_total += (cost_total == '' ? '' : ' | ') + '<span class="friendly">Cristal: </span>' + Utils.formatNumber(costs.cristal*cant);
				if (costs.deuterio > 0)
					cost_total += (cost_total == '' ? '' : ' | ') + '<span class="neutral">Deuterio: </span>' + Utils.formatNumber(costs.deuterio*cant);
				if (costs.energia > 0)
					cost_total += (cost_total == '' ? '' : ' | ') + 'Energia: ' + Utils.formatNumber(costs.energia*cant);
					
				if (cant == 0 || cant == '')
					span_cost.parent().hide();
				else
				{
					span_cost.parent().show();
					cost_total = '<br/>('+cost_total+')';
					span_cost.html(cost_total);
				}
			}catch (e) { Utils.log(e); } 
		},
		
		showBuildTimeByCant: function(input)
		{
			try
			{
				...
				if (cant > 0)
				{
					var time = $('#costswrapper > #action span.time:first').text().trim();
					var build_time_obj = {meses:0, semanas:0, dias:0, horas:0, minutos:0, segundos:0};
					var split = time.split(' ');
					for (index in split)
					{
						var item = split[index];
						var str = item.replace(/\d/g, '');
						var num = item.replace(/[^\d]/g, '');
						if (str == 'S')      build_time_obj.semanas  = num;
						else if (str == 'd') build_time_obj.dias     = num;
						else if (str == 'h') build_time_obj.horas    = num;
						else if (str == 'm') build_time_obj.minutos  = num;
						else if (str == 's') build_time_obj.segundos = num;
					}
					
					var cant_segs = cant * build_time_obj.segundos;
					var cant_min  = cant * build_time_obj.minutos;
					var cant_hs   = cant * build_time_obj.horas;
					var cant_dias = cant * build_time_obj.dias;
					var cant_sem  = cant * build_time_obj.semanas;
					var cant_meses = 0;
					if (cant_segs > 60)
					{
						cant_min = parseInt(cant_min) + div(cant_segs, 60);
						cant_segs = mod(cant_segs, 60);
					}
					if (cant_min > 60)
					{
						cant_hs = parseInt(cant_hs) + div(cant_min, 60);
						cant_min = mod(cant_min,60);
					}											
					if (cant_hs > 24)
					{
						cant_dias = parseInt(cant_dias) + div(cant_hs,24);
						cant_hs   = mod(cant_hs,24);
					}
					if (cant_dias > 7)
					{
						cant_sem = parseInt(cant_sem) + div(cant_dias,7);
						cant_dias = mod(cant_dias,7);
					}
					if (cant_sem > 4)
					{
						cant_meses = parseInt(cant_meses) + div(cant_sem,4);
						cant_sem   = mod(cant_sem,4);
					}
					
					if (cant_meses > 0 ) total_time += cant_meses + 'M ';
					if (cant_sem   > 0 ) total_time += cant_sem   + 'S ';
					if (cant_dias  > 0 ) total_time += cant_dias  + 'D ';
					if (cant_hs    > 0 ) total_time += cant_hs    + 'h ';
					if (cant_min   > 0 ) total_time += cant_min   + 'm ';
					if (cant_segs  > 0 ) total_time += cant_segs  + 's ';
				}else
					total_time = '-';
				
				var span_prod = $('#total_prod');
				if (span_prod.val() == null)
				{
					span_prod = $('<span/>').attr('id','total_prod').addClass('time');
					$('#action span.time').parent().after( $('<li/>').append($('<span/>').text('Tiempo total de  produccion:')).append(span_prod) );
				}
			
				if (cant == 0 || cant == '')
					span_prod.parent().hide();
				else
				{
					span_prod.parent().show();
					span_prod.html(total_time);
				}
			}catch (e) { Utils.log(e); } 
		},
		...
		Show: function(e)
		{
			try
			{
				...
				$('#resources > li.enter > input#number').bind('keyup', function()
				{
					$('#action ul').css('padding-top', '0px');
					Buildings.showBuildTimeByCant($(this));
					Buildings.showCostByCant($(this));
				});
				...
				var id = $('type')[0];
				if (id) id = parseInt(id.val(),10);
					
				// phalax and IPM range
				if (id == 42 || id == 503)
					this.showRange(id);
					
// 				Names.showBuildingResNames(); //TODO
			}catch(e)
			{
				Utils.log(e);
			}
		...
		Run: function()
		{
			...
			planet.live('DOMNodeInserted', function(e){ setTimeout(function(){ Buildings.Show(e); }, 0); });
		}
	};
...
// 			Colorer.highlight(Colorer.ALLY, 'descendant::*[@class="ally-tag"]/A', row, parseAlly);
		...
		showStatsDifs: function(row) //TODO: Eliminar XPath
		{
	...
	var BBcode = {
		InnerClass: function InnerClass()
		{
			...
			this.addBBCode = function(obj, tag, value)
			{
	// 			GM_log('addBBCode');
				try{
					var tag   = tag   || $(obj).attr('name')  || null;
					var value = value || $(obj).attr('value') || null;
					var str1;
					if (value) {
						if (value=="0") return;
						str1 = "[" + tag + "=" + value + "]";
...
// 					var mm = $("textarea")[0];
					var mm = this.textarea[0];
	// 				GM_log('mm:' + mm);
/*					if ( $('.ui-tabs-panel').val() != null )
					{
	// 					GM_log('ui-tabs-panel YES!');
						mm = $('.ui-tabs-panel').not('.ui-tabs-hide').find('textarea')[0];
					}*/
						
	// 				GM_log('mm:' + mm);
// 					if ($(mm).val() == null) throw {message: 'message null'};
					mm.focus();
					if (mm.isTextEdit) {
						...
						var start = mm.selectionStart;
						var starttext = $(mm).val().substring(0,start);
						var seltext = $(mm).val().substring(start,mm.selectionEnd);
						var endtext = $(mm).val().substring(mm.selectionEnd,$(mm).val().length);
						$(mm).val(starttext + str1 + seltext + str2 + endtext);
						mm.selectionStart = start + str1.length;
						mm.selectionEnd = start + str1.length + seltext.length;
					}
					mm.focus();
				}catch(e){ Utils.log(e); }
			}
			
			this.createElement = function(code, title)
			{
				var a = $('<a>', {'href':'#'});
				
				var value = '';
				var src = '';
				if (code == 'b') src = '';
				else if (code == 'i') src = '';
				else if (code == 'u') src = '';
				else if (code == 's') src = '';
				else if (code == 'url') src = '';
				else if (code == 'img') src = '';
				else if (code == 'player') src = '';
				else if (code == 'align'){ value='center'; src = '';}
				else if (code == 'list') src = '';
				return a.bind('click', function(){ obj.addBBCode(this, code, value); } ).append( $('<img/>').attr('border',0).attr('alt',title).attr('title',title).attr('src', 'data:image/png;base64,'+src) );
			},
			
			this.createFontSelect = function()
			{
				var sel = $('<select/>').attr('name','font').css('width','50px').css('height', '20px').css('max-height', '20px').addClass('dropdown')
								.append( $('<option/>',{value:''}).text('Font') )
								.append( $('<option/>',{value:'arial,sans-serif'}).css('font-family', 'arial,sans-serif').text('Arial') )
								.append( $('<option/>',{value:'cursive'}).css('font-family', '\"Comic Sans MS\",cursive').text('Comic') )
								.append( $('<option/>',{value:'courier,monospace'}).css('font-family', 'courier,monospace').text('Courier') )
								.append( $('<option/>',{value:'georgia,serif'}).css('font-family', 'georgia,serif').text('Georgia') )
								.append( $('<option/>',{value:'impact,fantasy'}).css('font-family', 'impact,fantasy').text('Impact') )
								.append( $('<option/>',{value:'times,serif'}).css('font-family', 'times,serif').text('Times') )
								.append( $('<option/>',{value:'verdana,sans-serif'}).css('font-family', 'verdana,sans-serif').text('Verdana') )
								.bind('change', function(){ obj.addBBCode(this); } );
				return sel;
			},
			
			this.createSizeSelect = function()
			{
				var sel = $('<select/>').attr('name','size').css('width','50px').css('height', '20px').css('max-height', '20px').addClass('dropdown')
								.append( $('<option/>',{value:''}).text('Size') )
								.append( $('<option/>',{value:'7'}).css('font-size', '7pt').text('tiny') )
								.append( $('<option/>',{value:'10'}).css('font-size', '10pt').text('small') )
								.append( $('<option/>',{value:'12'}).css('font-size', '12pt').text('normal') )
								.append( $('<option/>',{value:'16'}).css('font-size', '16pt').text('big') )
								.append( $('<option/>',{value:'20'}).css('font-size', '20pt').text('huge') )
								.bind('change', function(){ obj.addBBCode(this); } );
				return sel;
			},
			
			this.createColorSelect = function()
			{
				var sel = $('<select/>').attr('name','color').css('width','50px').css('height', '20px').css('max-height', '20px').addClass('dropdown')
								.append( $('<option/>',{value:''}).text('Color') )
								.append( $('<option/>',{value:'black'}).css('color', 'black').text('black') )
								.append( $('<option/>',{value:'silver'}).css('color', 'silver').text('silver') )
								.append( $('<option/>',{value:'gray'}).css('color', 'gray').text('gray') )
								.append( $('<option/>',{value:'maroon'}).css('color', 'maroon').text('maroon') )
								.append( $('<option/>',{value:'#A52A2A'}).css('color', 'brown').text('brown') )
								.append( $('<option/>',{value:'red'}).css('color', 'red').text('red') )
								.append( $('<option/>',{value:'orange'}).css('color', 'orange').text('orange') )
								.append( $('<option/>',{value:'yellow'}).css('color', 'yellow').text('yellow') )
								.append( $('<option/>',{value:'lime'}).css('color', 'lime').text('lime') )
								.append( $('<option/>',{value:'green'}).css('color', 'green').text('green') )
								.append( $('<option/>',{value:'olive'}).css('color', 'olive').text('olive') )
								.append( $('<option/>',{value:'teal'}).css('color', 'teal').text('teal') )
								.append( $('<option/>',{value:'aqua'}).css('color', 'aqua').text('aqua') )
								.append( $('<option/>',{value:'blue'}).css('color', 'blue').text('blue') )
								.append( $('<option/>',{value:'navy'}).css('color', 'navy').text('navy') )
								.append( $('<option/>',{value:'purple'}).css('color', 'purple').text('purple') )
								.append( $('<option/>',{value:'fuchsia'}).css('color', 'fuchsia').text('fuchsia') )
								.append( $('<option/>',{value:'#FFC0CB'}).css('color', 'pink').text('pink') )
								.append( $('<option/>',{value:'white'}).css('color', 'white').text('white') )
								.bind('change', function(){ obj.addBBCode(this); } );
				return sel;
			},
			...
			this.show = function(el)
			{
				if (el == null)
				{
					GM_log('BBcode.show el==null');
					return;
				}
				
				obj.textarea = el;
				obj.textarea.addClass('antigame_bbcode_inserted');
				obj.textarea.parent()
						.prepend( obj.createElement('list','List') )
						.prepend( obj.createElement('align','Align') )
						.prepend( obj.createElement('player','Player') )
						.prepend( obj.createElement('img','Imagen') )
						.prepend( obj.createElement('url','URL') )
						.prepend( obj.createElement('s','Super') )
						.prepend( obj.createElement('u','Subrayado') )
						.prepend( obj.createElement('i','Italica') )
						.prepend( obj.createElement('b','Negrita') )
						.prepend( obj.createFontSelect() )
						.prepend( obj.createSizeSelect() )
						.prepend( obj.createColorSelect() );
			}
		},
		...
		init: function()
		{
			try{
				...
				{
					if ( !$(this).hasClass('antigame_bbcode_inserted') )
						new BBcode.InnerClass().show( $(this) );
				});
				//this.show();
			}catch(e){ Utils.log(e); }
		}
	...
	try	{
		...
		try
		{
			var login_panel = $("#login");
			if (login_panel.val() != null)
			{
				$("#login").fadeIn();
				$("#serverLogin"  ).val(Options.login_uni);
				$("#usernameLogin").val(Options.login_user);
				$("#passwordLogin").val(Options.login_password);
				return;
			}
		}
		catch (e) { 
	...
	try	{
		...
		if ( Utils.isCurrentPage('writemessage') ) {
			BBcode.init();
// 			GM_log('writemessage');
		}
