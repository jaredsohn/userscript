// ==UserScript==
// @name            The Next Web print
// @include         http://thenextweb.com/*/20*/*/
// ==/UserScript==

function do_platypus_script() {
fix_page_it(window.document,'/HTML[1]',null,null,null);
isolate(window.document,document.getElementById('main-content'),null,null,null);
relax(window.document,document.getElementById('main-content'),null,null,null);
...
var platypusplatypuscouldntfi1 = mystrings.GetStringFromName("

platypusplatypuscouldntfi1");
