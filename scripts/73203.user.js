...
unsafeWindow.displayshout = function() {
	if(displayedflag == 0) {
		document.getElementById("shoutframe").innerHTML = '<iframe width="200" border="0" frameborder="0" height="100%" src="http://www5.shoutmix.com/?kade311" style="margin-left:0px;"></iframe>';
		displayedflag = 1;
	}
}
...
document.getElementById("shoutbar").innerHTML ='<div id="shouttab" onclick="showshout()" ondblclick="hideshout()"><a style="height:100%;width:100%;"></a></div>'
	...
	+ '<a style="border-bottom:1px #542C0F dotted; color: #542C0F;" href="http://s1.ikariam.net/index.php?view=diplomacyAdvisor&oldView=diplomacyAdvisor&watch=4">İttifak</a></div>'
