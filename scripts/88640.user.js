// ==UserScript==
// @name           Salesforce - Small Time Zone Map
// @namespace      Platypus
// @include        https://*.salesforce.com/001*
// @include        https://*.salesforce.com/003*
// @include        https://*.salesforce.com/005*
// @include        https://*.salesforce.com/home/*
// @include        https://*.salesforce.com/00Q*
// @include        https://*.salesforce.com/006*

// ==/UserScript==
function do_platypus_script() {
html_insert_it(window.document,document.evaluate('/html/body/div/div[2]/table/tbody/tr/td/div[2]/div[2]/div[2]', document, null, XPathResult.FIRST_ORDERED_NODE_TYPE,null).singleNodeValue,'<a href="http://www.eeph.com/~matthew/world.gif" target="_blank"><IMG BORDER=0 SRC="http://www.eeph.com/~matthew/world.gif" height=100px width=200px>',false,false);
