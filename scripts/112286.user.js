// ==UserScript==
// @name           	BBSpielzeugmann
// @namespace      	Bande:Lunzen mod.Spielzeugmann
// @description    	Erweiterter BB-Code Editor mit Vorschaufunktion und neuen Smylies
...
editor.addSmilie('http://bsmilies.de/blue/standard/biggrin.gif');
editor.addSmilie('http://bsmilies.de/blue/standard/wink.gif');
editor.addSmilie('http://bsmilies.de/blue/standard/mad.gif');
editor.addSmilie('http://bsmilies.de/blue/traurig/frown.gif');
...
editor.addSmilie('http://www.4smileys.com/smileys/halloween-smileys/witch04.gif');
...
editor.addSmilie('http://www.greensmilies.com/smile/smiley_emoticons_barbar.gif');
...
editor.addSmilie('http://www.greensmilies.com/smile/smiley_emoticons_eazy_senseo1b.gif');
editor.lineBreak();
editor.lineBreak();
editor.addSmilie('http://www.greensmilies.com/smile/smiley_emoticons_kaffee6.gif');
...
editor.addSmilie('http://www.greensmilies.com/smile/smiley_emoticons_flucht2.gif');
...
editor.addSmilie('http://www.greensmilies.com/smile/smiley_emoticons_keiner-da.gif');
editor.addSmilie('http://www.greensmilies.com/smile/smiley_emoticons_torte3.gif');
editor.addSmilie('http://www.greensmilies.com/smile/smiley_emoticons_charly_wiegeil.gif');
editor.addSmilie('http://www.greensmilies.com/smile/smiley_emoticons_pfeif2.gif');
...
editor.addSmilie('http://www.greensmilies.com/smile/smiley_emoticons_kolobok_schlagzeuger.gif');
...
editor.addSmilie('http://www.greensmilies.com/smile/smiley_emoticons_eazy_crank.gif');
...
editor.addSmilie('http://www.smilies-and-more.de/pics/kolobok/remake/crazy.gif');
editor.addSmilie('http://www.smilies-and-more.de/pics/longtom/schilder/gutidee.gif');
...
editor.addSmilie('http://img5.dreamies.de/img/673/b/qqqhbf6yqmu.gif');
editor.addSmilie('http://img21.dreamies.de/img/810/b/tcqx3rdhuey.gif');
editor.lineBreak();
editor.lineBreak();
editor.addSmilie('http://www.smilies.4-user.de/include/Babys/smilie_baby_016.gif');
editor.addSmilie('http://info.rtl.de/cf/power/chat/emonics/moonwalk.gif');
...
editor.lineBreak();
editor.lineBreak();
editor.addSmilie('http://www.plauderforum.at/images/smilies/icvcxked.gif');
editor.addSmilie('http://img21.dreamies.de/img/705/b/oc0lmgr380k.gif');
editor.addSmilie('http://img28.dreamies.de/img/53/b/u830e70qtlf.gif');
editor.addSmilie('http://img28.dreamies.de/img/463/b/m5gabgi8gpt.gif');
editor.addSmilie('http://bsmilies.de/tools/schild_4087.png');
editor.addSmilie('http://bsmilies.de/tools/schild_4115.png');
editor.lineBreak();
editor.lineBreak();
editor.addSmilie('http://img30.dreamies.de/img/986/b/g9m8lem5t6n.gif');
editor.addSmilie('http://img17.dreamies.de/img/385/b/5jq1k7jgsxb.gif');
editor.addSmilie('http://img25.dreamies.de/img/364/b/epkupoiri2l.gif');
editor.addSmilie('http://s20.rimg.info/be9f892507df11cc66139da95357cc99.gif');
editor.addSmilie('http://smilies-smilies.de/smilies/lustige_smilies/griiiiinss.gif');
editor.lineBreak();
editor.lineBreak();
editor.addSmilie('http://img22.dreamies.de/img/411/b/dc3xynesk3a.gif');
editor.addSmilie('http://img26.dreamies.de/img/556/b/ekmch221usa.gif');
editor.lineBreak();
editor.lineBreak();
