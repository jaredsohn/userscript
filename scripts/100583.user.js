// ==UserScript==
// @name           MyFreeFarm Anpflanzer
// @namespace      http://s*.wolnifarmerzy.pl/main.php
// @description    MyFreeFarm Anpflanzautomat
...
inp.value=tmin;
inp.id = "inputtmin";
inp.title = "Pflanzautomat: Minimale Klickzeit in ms";
...
inp.value=tmax;
inp.id = "inputtmax";
inp.title = "Pflanzautomat: Maximale Klickzeit in ms";
