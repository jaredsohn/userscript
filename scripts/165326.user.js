// ==UserScript==
// @name           CnC: Tiberium Alliances Info very short for RAR / HED
// @author         TheStriker(OriginalAuthor) modified by AndyPoloCC1
          ...
          onKey : function (ev) {
            ...
            if (inputField != null) {
              ...
              if (ev.altKey && !ev.altGraphKey && !ev.ctrlKey && !ev.shiftKey && s == "Y") {
                ...
                for (var key in apc) {
                  c = apc[key];
                  txt += playername + ": [coords]" + c.get_PosX() + ":" + c.get_PosY() + ":" + c.get_Name() + "[/coords]: ";
                  txt += "B:" + ('0' + c.get_LvlBase().toFixed(2)).slice(-5) + " ";
                  txt += "D:" + ('0' + c.get_LvlDefense().toFixed(2)).slice(-5) + " "; 
                  txt += "O:" + ('0' + c.get_LvlOffense().toFixed(2)).slice(-5) + " ";
