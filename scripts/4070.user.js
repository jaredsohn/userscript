// Asheville-Buncombe Technical Community College Library Lookup
// version 0.1 BETA
// 2006-05-12
//
// Adapted from Josh Staiger's script for Wake County Library
//
...
//
// ==UserScript==
// @name          A-B Tech Library Lookup
// @namespace     
// @description   Alerts you if any editions of the current book you are browsing on Amazon.com are available at the A-B Tech Libary.
// @include       http://*.amazon.*
// @include       http://amazon.*
// ==/UserScript==
...
var libraryName = 'A-B Tech';
var libraryIndex = 'PISBN';
...
function libSearch(isbn, fn) {
    ...
    var libraryLookupUrl = 'http://152.34.132.22/ipac20/ipac.jsp';

    var isbnSearchUrl = libraryLookupUrl+'?term='+isbn+'&index='+libraryIndex;
	...
	url: isbnSearchUrl,
	    ...
	    var isbnLinkPat = new RegExp('href="'+libraryLookupUrl+'\\?.*?(uri=link=.*?)&.*?term='+isbn+'.*?&amp;index='+libraryIndex+'"');
