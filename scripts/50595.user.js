// ==UserScript==
// @name          خريطه الخاصه في قرك-tribalwars-plapl
// @description   خاص في التنقل السريع بين القرى و  صنع خريطه خاصه لي قرك
...
{
	return(
		'&nbsp;<a href="game.php?village=' + id + '&amp;screen=main"><img width=14 height=12 src="graphic/buildings/main.png" title="مركز القريه" alt="" /></A>' +
		'&nbsp;<a href="game.php?village=' + id + '&amp;screen=barracks"><img width=14 height=12 src="graphic/buildings/barracks.png" title="الثكنات" alt="" /></A>' +
		'&nbsp;<a href="game.php?village=' + id + '&amp;screen=stable"><img width=14 height=12 src="graphic/buildings/stable.png" title="الاسطبل" alt="" /></A>' +
		'&nbsp;<a href="game.php?village=' + id + '&amp;screen=garage"><img width=14 height=12 src="graphic/buildings/garage.png" title="الورشه" alt="" /></A>' +
		'&nbsp;<a href="game.php?village=' + id + '&amp;screen=snob"><img width=14 height=12 src="graphic/buildings/snob.png" title="الاكادميه" alt="" /></A>' +
		'&nbsp;<a href="game.php?village=' + id + '&amp;screen=snob&mode=coin"><img width=14 height=12 src="/graphic/gold.png" title="صقل موارد" alt="" /></A>' +

		'&nbsp;<a href="game.php?village=' + id + '&amp;screen=place"><img width=14 height=12 src="graphic/buildings/place.png" title="نقطة تجمع" alt="" /></A>' +
		'&nbsp;<a href="game.php?village=' + id + '&amp;screen=market"><img width=14 height=12 src="graphic/buildings/market.png" title="سوق" alt="" /></A>' +
		'&nbsp;<a href="game.php?village=' + id + '&amp;screen=market&mode=own_offer"><img width=14 height=12 src="graphic/buildings/market.png" title="بيع موارد" alt="" /></A>' +
		'&nbsp;<a href="game.php?village=' + id + '&amp;screen=train"><img width=14 height=12 src="graphic/unit/unit_spear.png" title="تدريب قوات" alt="" /></A>' +
		'&nbsp;<a href="http://www.plapl.com/"><img width=14 height=12 src="http://www.plapl.com/up/Photos/2-28-2010%207-31-54%20PM.png" title="منتديات بلابل" alt="" /></A>'
	);
}
...
function map_link(isForMarket)
{
	return (
		...
		' src="graphic/map/v5.png" title="خريطة قرك" alt="" /></A>&nbsp;'
	);
}
...
function map_div(isForMarket, village_id)
{
	...
	if (vs.length <= 0 || refpart1 == null) {
		...
		if (vs.length <= 0) {
			res += '<p>يرجى زيارة الموقع مرة واحدة في الجمع بين الدراسة لهذا العمل.</p>';
		}
		else {
			res += '<p>خطأ : العنوان غير متوقع</p>';
		}
	...
	res += 'background-image:url(http://www.backgroundlabs.com/backgrounds/40.jpg);border:1px solid #000">';
	res += '<div align=right><a href="javascript:toggle_visibility(\'' + div_name + '\');">&lt;اغلاق الصفحه&gt;</a></div><br>';
	res += '<div align=right><a href="http://www.plapl.com/index.php">&ltمنتديات بلابل&gt;</a></div><br>';
...
if (/screen=/.test(location.href)) {
	...
	if (dci >= 0) {
		...
		var val = prompt(
			"لون القريه في الخريطه :",
			get_village_color(id)
		);
		if (val) {
			if ((val.length != 4 && val.length != 7) || val.substr(0,1) != '#') {
				alert("لون غير صالح يجب ان يكون مكون من ثلاث ارقام مثال#123: '"+val+"'");
			}
			else {
	...
	) {function addCaption()
{
  ...
  newTd.innerHTML = "<p style=margin-top:10px; margin-bottom:0; padding-bottom:0; text-align:center; line-height:0><a target=_blank href=http://www.plapl.com/forum.php><img src=http://feeds.feedburner.com/plapl.2.gif alt=بلابل style=border:0 width=465 height=60></a></p>";
	...
	if (
		...
		if (tbl != null) {
			tbl.innerHTML+='<TR><TD><A HREF="javascript:document.cookie=' +
				...
				village_id +
				'\';location.reload()">تغير لون القريه في الخريطة قرك</A></TD></TR>'
			;
		}
	}
}
