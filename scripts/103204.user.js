// ==UserScript==
  ...
  function heading()
	...
	cell.style.fontWeight='Bold';
		var cellText = document.createTextNode('CLICK FOR PROCESS');
...
var cell = document.createElement('td');
	...
	var cellText = document.createTextNode('SUBMIT AT 7:59:59');
	cell.appendChild(cellText);
	row.appendChild(cell);
if(row1!=''){
...
var tbl     = document.createElement('table');
	...
	cell.setAttribute('align', 'center');
	cell.style.color='white';
	var cellText = document.createTextNode('AUTO SUBMIT AT 7:59:59');
	cell.appendChild(cellText);
	row.appendChild(cell);
	tblBody.appendChild(row);
...
var tbl     = document.createElement('table');
 ...
 elmNewContent0.appendChild(document.createTextNode('MANUAL SUBMIT'));
