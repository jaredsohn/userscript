// ==UserScript==
// @name           Kaynak Kisayollari Turkce
// @namespace      Yramesora
// @description    Bu script ikariam adli oyunda teker teker saat basi ne kadar artacagina bakmanız gerekmeden otomatik olarak üsttteki maden oraninda ve ana sayfadaki gemi resminin yanindaki kutucukta yazar .Yani Size hammaddeleri kisayol ile görme olanagi saglar
// @include        http://*ikariam.net/index.php*
// ==/UserScript==
/*
21:03 5/3/2008 (Gun/Ay/Yil)
Description:
Her saat başı artan maddeleri gösteren yer eklendi ...
...
hTradeGoodsNames['value_crystal'] = 'Cam'; // That's why I cannot just strip the name and I have to create a Hash >o<
