// ==UserScript==
// @name          Airline Manager Autostart All routes
// @author        Ricky87
...
var enableFuelPurchase = true; //Set to "true" (without quotes) to enable the automatic purchase of fuel or "false" otherwise
var fuelPurchaseInterval = 8; //Interval of availability check 
var buyPrice = 400; //Price under of this fuel will be purchased
var fuelThreshold = 1000000; //Fuel under of this will be purchased
var amountToBuy = 5000000; //Amount of fuel (lbs) that will be bought if the current fuel goes under the fuelThreshold
