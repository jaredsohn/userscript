...
// @name             KOC Attack Bot
// @version          1.1
// @namespace        KOC Attack Bot
// @homepage         http://userscripts.org/scripts/show/172575
// @description      Same as the original Kingdoms of Camelot Attack script, but changed some features.
...
var KOCAttack={
	...
	ShowOptionsDialog:function() {
		...
		div.innerHTML="<form><table>"+
			...
			"<input id='KOCAttackEnableLogging' type='checkbox' "+(this.options.enableLogging?'checked':'')+
			"</td></tr>"+
