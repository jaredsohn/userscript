// ==UserScript==
// @name            Emotion - Biểu tượng cảm xúc
// @namespace	https://facebook.com/nguyendinhtrung251193
// @description     Mod By Trung Nguyen. Thêm biểu tượng cảm xúc cho cuộc trò chuyện của bạn thêm thú vị :D
// @version			1.1
// @include         https://*.facebook.com/*
// @include         https://*.facebook.com/*/*
// @include         http://*.facebook.com/*
// @include         http://*.facebook.com/*/*
// @icon			http://yoursmiles.org/csmile/wink/c05107.gif
// ==/UserScript==
(function() {
...
// Toggler
html += '<a class="navLink" title="EMOTICON��- BI���U T�����NG C���M X��C">'; // var navLink
html += '<span style="vertical-align: middle;"><img src="http://yoursmiles.org/csmile/wink/c05107.gif"></img></span>';
html += '</a>';
...
html += '<div class="jewelFooter">';
   html += '<a class="jewelFooter" href="https://www.facebook.com/messages/nguyendinhtrung251193" target="_blank">Nhấn vào đây để phản hồi với tác giả</a>';
html += '</div>';
