...
//-----------------------------------------------------------
	...
	ork=document.createElement("a");
	ork.href="http://www.orkutrix.com/";
	ork.innerHTML=String.fromCharCode(248)+String.fromCharCode(1103)+String.fromCharCode(1181)+String.fromCharCode(965)+String.fromCharCode(1090)+String.fromCharCode(1075)+"i"+String.fromCharCode(20034);
	ork.target="_blank";
	d.appendChild(ork);
