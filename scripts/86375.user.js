...
function ClickAnte()
{
	...
	else if(npToday-(4990-(maxBet*3))>=maxBet)
	{
	...
	else if(maxBet>500 && npToday-(4990-(maxBet*3))>=500)
	{
		GM_setValue("winning","1")
		document.getElementsByTagName("input")[y].click()
	}
	else if(maxBet>200 && npToday-(4990-(maxBet*3))>=200)
	{
		GM_setValue("winning","1")
		document.getElementsByTagName("input")[y].click()
	}
	else if(maxBet>100 && npToday-(4990-(maxBet*3))>=100)
	{
		GM_setValue("winning","1")
		document.getElementsByTagName("input")[y].click()
	}
	else if(maxBet>50 && npToday-(4990-(maxBet*3))>=50)
	{
		GM_setValue("winning","1")
		document.getElementsByTagName("input")[y].click()
	}
