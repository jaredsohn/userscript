// ==UserScript==
// @name        ultoo new script by kaiz... 10th march
// @namespace  
...
if(url.search(pattern)==0)
{
	...
	{	
		document.getElementById('MobileNos_').value=9635081638;
...
if(url.search(pattern)==0)
{
	var options="Maagha;2;Kedarnath;Indra;Kurma;Bull;Red;Ganga;8;Nataraja;Ronaldo;Kali;Amisha;Qatar;Gagan Narang;Bouncer;Jung;USA;Bogey;Jan 2007;Vitamin A;Gurtej;Delhi;Lori;Sudan;Maple Leaf;Chess;HP;Damodar;Shiva;365 days;Agni;Dear;Boman Irani;Before;Liver;Aakriti Seth;2;Oxygen;90;Cairo;Venus Williams;Andy Murray;Brazil;Zymase;RBI;ICICI;10;Polo;Group";
