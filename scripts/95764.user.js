...
// @description    Auto Click Ads On Bux.to. Auto reloads after 2-4mins if no ads are present. By JoeSimmons
...
// 2.6.1 - Fixed background, colorized text.
///////////////////////////////////////////////////////////////////////////////
...
sec.setAttribute("style", "background:url('http://adamgorman.com/images/blank.jpg'); color:#fffff; border:8px ridge #000; padding:5em; position:absolute; top:"+window.innerHeight/3+"px; left:"+window.innerWidth/2+"px; text-align:center;");
...
sec.innerHTML = 'No ads left<br><a style="color:#0505ff;border:0px solid transparent;text-decoration:underline;" href=\'javascript:void(0);\' onClick=\'this.parentNode.style.display="none";\'>Close</a>';
