...
// ==UserScript==
// @name           Task switcher - Plunder-, Eigenheim-, Waffen-, Stadtteilwechsler (Pennergame, Clodogame, Mendigogame. Menelgame, Dossergame, Serserionline, Bumrise, Faveladogame)
// @author         Peter L aus B (http://berlin.pennergame.de/change_please/3471184/)
// @namespace      peter_l_aus_b[Aufgabenwechsler]
// @description    Switches equipment for different tasks | Wechselt die Ausrüstung für verschiedene Aufgaben
// @version        0.2.5
// @version        0.2.4 Added Polish translation by Wime <http://userscripts.org/users/162551>
// @version        0.2.3 Added Spanish translation by glomayol <http://userscripts.org/users/125170>
// @version        0.2.0 You can change your BAC automatically now.
// @version        0.1.1 Added French translation by lordclodo <http://userscripts.org/users/122087>
...
function English() {
	...
	this.NAME_TEXT                = "Title:";
	this.PLUNDER_TEXT             = "Plunder";
	this.HOME_TEXT                = "Home";
	this.WEAPON_TEXT              = "Weapon";
	this.DISTRICT_TEXT            = "District";
	
	this.UNCHANGED_PLUNDER_TEXT   = "keep plunder";
	this.UNCHANGED_HOME_TEXT      = "don't move";
	this.UNCHANGED_WEAPON_TEXT    = "keep weapon";
	this.UNCHANGED_DISTRICT_TEXT  = "dont't move";
	
	this.MISSING_PLUNDER_TEXT     = "Plunder was not found!";
	this.MISSING_HOME_TEXT        = "Home was not found!";
	this.MISSING_WEAPONG_TEXT     = "Weapon was not found!";
	this.MISSING_DISTRICT_TEXT    = "District was not found!";
	
	this.EQUIPMENT_CHANGER_TEXT   = "Tasks";
	this.NEWLINE_TEXT             = "add config line";
	this.NO_CFGS_TEXT             = "no configs, yet";
	this.DO_NOTHING_TEXT          = "skip";
	this.ACCEPT_TEXT              = "Accept changes";
	this.DELETE_TEXT              = "Delete config";
	this.CONFIGURATION_SAVED_TEXT = "Configuration saved.";
	this.STATUS_HEADLINE_TEXT     = "Task switcher";
	this.CLOSE_BUTTON_TEXT        = "close";
	this.UNKN_PLUNDER_ID_HL_TEXT  = "Task switcher";
	this.UNKN_PLUNDER_ID_TEXT     = "You own the plunder you currently hold only once. " +
		"Hence it cannot be equipped automatically.";
	this.SHOW_CONFIGURATIONS_TEXT = "Configurations";
	this.EDIT_CONFIGURATIONS_TEXT = "Edit configurations.";
	
	this.FORFEIT_UNSAVED_CHANGES  = "Any unsaved changes will be lost!";
	this.ADD_NEW_LINE_QUESTION    = "Add new config?"
	this.FINISH_CFG_TEXT          = "Accept configuration";
	this.FINISH_CFG_QUESTION      = "Do you really want to finish the configuration?";
	this.DELETE_LINE_QUESTION     = "Do you really want to delete line of config?";
	
	this.CHANGED_PLUNDER_TEXT     = "Equipted";
	this.CHANGED_HOME_TEXT        = "New home";
	this.CHANGED_WEAPON_TEXT      = "New weapon";
	this.CHANGED_DISTRICT_TEXT    = "New district";
	
	this.CHANGE_PLUNDER_ERROR     = "Plunder remained unchanged!"
	this.CHANGE_HOME_ERROR        = "Home remained unchanged!";
	this.CHANGE_WEAPON_ERROR      = "Weapon remained unchanged!";
	this.CHANGE_DISTRICT_ERROR    = "District remained unchanged!";
	
	this.PERMIL_TEXT              = "Per mil";
	this.CHANGED_PERMIL_TEXT      = "New BAC";
	this.CHANGE_PERMIL_ERROR      = "BAC could not be changed.";
	this.PERMIL_UNCHANGED_TEXT    = "BAC: %1% ‰";
	this.PERMIL_BUY_GOODS         = "Got to buy booze and/or food!";
	this.BROWSER_TOO_OLD          = "You need Firefox 3.5 or higher!";
	this.PERMIL_CLASSES           = {
		"-1": { "name": "don't change", "min": 0.00, "max": 4.00, "higher": false },
		"0":  { "name": "sober",        "min": 0.00, "max": 0.75, "higher": true },
		"1":  { "name": "medium",       "min": 2.50, "max": 3.00, "higher": false },
		"2":  { "name": "lasting",      "min": 2.80, "max": 3.50, "higher": false },
		"3":  { "name": "dead drunk",   "min": 3.50, "max": 4.00, "higher": true }
	};
}
...
/*           Modification begin: */
	var temp = document.getElementById('options');
	var t2 = document.createElement('li');
	t2.style.width = '100px';
	t2.className = 'yeramihi';
	temp.appendChild(t2);
	var crowncap = document.getElementsByClassName("yeramihi")[0];
/*          Modification end:  */
