...
var userGuideHTML = (<div id='ug-top' style="padding:15px;padding-top:5px;">
	...
	<fieldset><legend><b>CONTENTS</b></legend>
		...
		<a style='color:#333399;' href='#ug-gameplay'>GAMEPLAY</a>
			...
			|  <a style='color:#333399;' href='#ug-attack-phase'>Assault Phase</a>
			|  <a style='color:#333399;' href='#ug-advance-phase'>Advance Phase</a>
			|  <a style='color:#333399;' href='#ug-fortify-phase'>Reinforcment Phase</a>
	</fieldset>
	<br/><br/>
		...
		<fieldset><legend id='ug-appearance'><b>Appearance</b></legend>
			...
			<ul>
				...
				<li>
					...
					territory--but only if that territory is assaultable from your own currently selected territory.
				</li>
				<li>
				...
				<li>
					...
					the territory that is under the mouse pointer indicating how many troops are currently selected to deploy,
					advance, or reinforce.  The army counter updates when the increase/decrease troops hotkeys are pressed, or the
				...
				<li>
					...
					"Left-click: Set Alaska as From-Territory. Right-click: reinforce 5 troops from Kamchatka to Alaska".
				</li>
			</ul>
		...
		<fieldset><legend id='ug-confirmations'><b>Confirmations</b></legend>
				...
				<ul>
					<li>
						...
						If set to 'Y', then every time you attempt to deploy troops on a territory, a confirmation message will
					...
					<li>
						...
						If set to 'Y', then every time you attempt to assault an enemy territory, a confirmation message will
						appear with the assaulting territory and the target territory.  This gives you a chance to cancel an
						assault move and try again.
					</li>
					<li>
						<i><b>Confirm Auto-Assault?</b></i>	[ <b>Y</b> or <b>N</b> ] <br/>
						If set to 'Y', then every time you attempt to auto-assault an enemy territory, a confirmation message will
						appear with the assaulting territory and the target territory.  This gives you a chance to cancel an
						auto-assault move try again.
					</li>
					<li>
						<i><b>Confirm Advance?</b></i>		[ <b>Y</b> or <b>N</b> ] <br/>
						If set to 'Y', then every time you attempt advance troops to a conquered territory, a confirmation
					...
					<li>
						<i><b>Confirm Reinforcement?</b></i>		[ <b>Y</b> or <b>N</b> ] <br/>
						If set to 'Y', then every time you attempt to reinforce troops from one territory to another, a
						confirmation message will appear with the number of troops to be reinfoced, the source territory and the
						destination territory.  This gives you a chance to cancel a reinforcement move and try again.
					</li>
					<li>
			...
			to that of the key that was pressed.</b></i>
				<ul>
					<li>
						...
						Reinforcement' during the reinforement phase.
					</li>
					<li>
					...
					<li>
						...
						Changes which mouse buttons are used to deploy troops; either left-click deploys one army and
						right-click deploys the number of troops currently selected in the action menu (or floating army counter),
						or vice-versa.
					</li>
				</ul>
		</fieldset> <!-- end confirmations -->
	...
	<fieldset id='ug-gameplay' style="color:#333399;"><legend><b>GAMEPLAY</b></legend>
		<fieldset><legend id='ug-deploy-phase'><b>Deploy Phase</b></legend>
			<ul>
				<li>
					Mouse over the territory you want to deploy troops on. If the <a href='#ug-appearance'>Show Army
				...
				<li>
					...
					that is configured to deploy only 1 army. Otherwise, once the desired number of troops is selected, click
					the territory to deploy on using the mouse button that is configured to deploy the selected number of troops.
					(You can choose which click deploys 1 army and which click deploys the selected number of troops with the
		...
		<p style='width:100%;text-align:right;'><a href='#ug-top'>[back to top]</a></p>
		<fieldset><legend id='ug-attack-phase'><b>Assault Phase</b></legend>
			<ul>
				<li>
					First select the territory that you want to assault from by clicking on it (either right- or left-click). If
					the <a href='#ug-appearance'>Show From-Territory Marker</a> option is enabled, then a pulsing, red circle
					will appear around the territory, showing that it is now selected as the assaulting territory. If not, then
					you can see which territory is selected as the assaulting territory by looking in the action menu, as usual.
					If the territory clicked does not become the assaulting territory (i.e. the from-territory marker and/or
					action menu does not update), it is probably because that territory is unable to make assaults.
				</li>
				<li>
					Once the assaulting territory is selected, click an enemy territory to assault it. <b>Left-clicking</b> will
				...
				<li>
					...
					enter the minimum number of troops to leave on the assaulting territory (to be sure that the number of troops
				...
				<li>
					<b>Auto-Advance</b>. If the <b>ALT</b> key is held while auto-assaulting, then all remaining troops on the assaulting territory will
					be automatically advanced to the conquered territory.  Works in conjunction with Auto-Assault[x].
				</li>
			</ul>
		...
		<fieldset><legend id='ug-advance-phase'><b>Advance Phase</b></legend>
			<ul>
				<li>
					After conquering an enemy territory, moving the mouse cursor over either the assaulting territory or the 
					...
					troops to advance, then	click on the territory just conquered to advance those troops.
				</li>
				<li>
					Clicking on the territory that was just assaulted <i>from</i> will always advance zero troops.
				</li>
				<li>
		...
		<p style='width:100%;text-align:right;'><a href='#ug-top'>[back to top]</a></p>
		<fieldset><legend id='ug-fortify-phase'><b>Reinforcement Phase</b></legend>
			<ul>
				<li>
					Select the territory that you want to reinforce troops from by <b>left-clicking</b> on it. If
					...
					action menu does not update), it is probably because that territory is unable to be reinforced from.
				</li>
				<li>
					Mouse over the territory you want to reinforce troops to. If the <a href='#ug-appearance'>Show Army
					Counter</a> option is enabled, then a small box will appear next to your cursor letting you know how many
				...
				<li>
					Once the source territory and the desired number of troops are selected, <b>right-click</b> (or hold
					<b>SHIFT</b> while left-clicking) the territory you want to reinforce troops to.
				</li>
				<li>
	...
	switch ( doAction ) {
		...
		case 'Reinforce':
			...
			if ( playerNumber == currentPlayerNumber ) {
				setCursor('pointer')
				if ( userPrefs['showToolTips'] == 'Y' ) {
					t = 'Right-click/Shift-click: Reinforce '+selectedQuantity+' troops from '+fromTerritory+' to '+title
...
function onMapClick(e) {
	...
	switch(doAction) {
		case 'Deploy':
			...
			if ( deployDeferred ) {
				armiesLeftToDeploy        = actionString.split(' ')[2]
				confirmMessage			  = 'Deploy '+armiesLeftToDeploy+' troops on '+toTerritory+'?'
			...
			if ( e.button == 2 ) { //right click
				if ( userPrefs['deploymentClicks'] == 'Left-1 Right-Selected' ) {
					confirmMessage = 'Deploy '+selectQuantity.value+' troops on '+toTerritory+'?'
				} else {
				...
				confirmMessage			= 'Deploy all '+armiesLeftToDeploy+' troops on '+toTerritory+'?'
			} else {
				if ( userPrefs['deploymentClicks'] == 'Left-1 Right-Selected' ) {
					selectQuantity.value	= "1"
					confirmMessage			= 'Deploy 1 army on '+toTerritory+'?'
			...
			// if enemy, set as to_country and continue to attack
				...
				if ( e.button == 2 || e.shiftKey ) {
					...
					if ( e.ctrlKey ) {
						...
						minArmies		= prompt('Enter the minimum number of troops to remain on the assaulting territory:')
		...
		case 'Advance':
			...
			confirmMessage = 'Advance '+numArmies+' troops?'
		break
		case 'Reinforce':
			if ( ! document.getElementById('quantity') ) { wait('off'); return }
			if ( e.button == 2 || e.shiftKey ) {
			...
			if ( fromTerritory == '' || toTerritory == '' ) { wait('off'); return }
			confirmMessage = 'Reinforce '+numArmies+' troops from '+fromTerritory+' to '+toTerritory+'?'
		break
	}
...
function onKeyPress(e) {
	...
	switch ( e.which ) {
		...
		case parseInt(userPrefs['nextGameHotkey']) :
			window.location='http://www.conquerclub.com/player.php?mode=next'
			return
		break
...
unsafeWindow.sendRequest = function(_cmd) {
	...
	if ( _cmd == 'Reinforce' && fortificationType != 'Unlimited' ) {
...
function initialize() {
	...
	crosshairYoffset = (crosshair_h / 2) -tournamentOffset;
	...
	attackFromMarkerYoffset = (attackFromMarker_h / 2) -tournamentOffset;
	...
	fortifyFromMarkerYoffset = (fortifyFromMarker_h / 2) -tournamentOffset;
	...
	advanceFromMarkerYoffset = (advanceFromMarker_h / 2) -tournamentOffset;
	...
	advanceToMarkerYoffset = 11 -tournamentOffset;
	...
	floatingQuantityYoffset = -25 +tournamentOffset;
	...
	sm= createMenuItem(clickableMapMenu, 'confirmationSubMenu', 'mouseover', function(){void(0)}, 'Confirmations...')
		...
		createMenuItem(sm, 'confirmAttack',	     'click', function(){setPref(this)},    'Confirm Assault?',	    userPrefs['confirmAttack'])
		createMenuItem(sm, 'confirmAuto-Attack', 'click', function(){setPref(this)},    'Confirm Auto-Assault?', userPrefs['confirmAuto-Attack'])
		createMenuItem(sm, 'confirmAdvance',	 'click', function(){setPref(this)},    'Confirm Advance?',	    userPrefs['confirmAdvance'])
		createMenuItem(sm, 'confirmFortify',	 'click', function(){setPref(this)},    'Confirm Reinforce?',	    userPrefs['confirmFortify'])
	...
	sm= createMenuItem(clickableMapMenu, 'controlSubMenu', 'mouseover', function(){void(0)}, 'Controls...')
		...
		createMenuItem(sm, 'increaseArmiesHotkey', 'click', function(){setHotkey(this)}, 'Increase Troops: <font style="font-weight:bold;">right-arrow</font> or ',  String.fromCharCode(userPrefs['increaseArmiesHotkey']))
		createMenuItem(sm, 'decreaseArmiesHotkey', 'click', function(){setHotkey(this)}, 'Decrease Troops: <font style="font-weight:bold;">left-arrow </font> or ',  String.fromCharCode(userPrefs['decreaseArmiesHotkey']))
