// ==UserScript==
// @name			HF Scripts - Easy Report Free Money Making Ebooks
// @namespace 		Glassy/hfreportingfreemoneymakingebooks
// @description 	Makes reporting posts/threads in Free Money Making Ebooks section to Glassy MUCH easier.
// @include  		*hackforums.net/showthread.php*
// @version  		1.1.2
// ==/UserScript==

var navBit = document.getElementsByClassName('navigation')[0];
if(navBit.innerHTML.indexOf('<a href="forumdisplay.php?fid=221">Free Money Making Ebooks</a>') != -1) {
