// ==UserScript== 
// @name		Dead Awaken - Send Battle Log to self!
...
// ==/UserScript==
	...
	sendElement.value = "Send Battle Log To Self";
	...
	function send()
	{
		...
		var dp = "msgId=" + "00000" + "&msgSubject=Battle Log&msgText=" + selectedText.toString();
