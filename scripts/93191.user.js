...
// @description    Automatically accept Kingdoms of Camelot gifts on Goswhit240. Provided by the Collectors, #1 on Goswhit240.
				...
				if(claim_gift){
					...
					if(domain_selector && (next_button1 || next_button2)){
						for(var i=0; i<domain_selector.options.length; i++){
							if(domain_selector.options[i].value == "240"){
