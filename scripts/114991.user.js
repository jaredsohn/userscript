// ==UserScript==
// @name   		anonfi-hide
// @namespace  	anonfi-hide
// @description	Hidetys scriptu anon.fi:hin
// @include		http://anon.fi/*
// @include		http://www.anon.fi/*
// @exclude		http://anon.fi/mod.php?/*
// @exclude		http://www.anon.fi/mod.php?/*
// ==/UserScript==
// ==Authors==
//		Wriggle
//		Riksha
//==License==
//	Tee mitä haluat lisenssi :D
//		Senkus teet mitä haluat ei kinosta.
//		
...
function jQueryLoaded() {
	...
	*/
	...
	preparePage = function () {
	    ...
	    ConfigBox += "<center><span class='heading'>Suodata sisältöä</span>";
	    ConfigBox += "<em>Erilliset arvot puolipisteellä, <br> regex vielä toteuttamatta.</em></center>";
	    ConfigBox += "<table border='0'>";
	    ConfigBox += /*"<form>*/"<tr><td>Nimi:    </td><td><input class='filter' id='NameFilter' rows='1' cols='10'/></td></tr>";
	    ConfigBox += "<tr><td width=\"auto\">Trippi:    </td><td><input class='filter' id='TripFilter' rows='1' cols='10'/></td></tr>";
	    ConfigBox += "<tr><td width=\"auto\">Email:   </td><td><input class='filter' id='EmailFilter' rows='1' cols='10'/></td></tr>";
	    ConfigBox += "<tr><td width=\"auto\">Aihe: </td><td><input class='filter' id='SubjectFilter' rows='1' cols='10'/></td></tr>";
	    ConfigBox += "<tr><td width=\"auto\">Viesti: </td><td><input class='filter' id='CommentFilter' rows='1' cols='10'/></td></tr>";
	    ConfigBox += "<tr><td width=\"auto\">Pakotettu nimi:</td><td><input class='filter' id='ForcedName' rows='1' cols='10'/></td></tr>"; /*</form>"; */
	    ConfigBox += "</table>";
	    ConfigBox += "<center><a class='Suodata' href=''>käytä suodatinta</a> (Auotmaattinen F5).</center>";
	    ConfigBox += "</div>";

	    // Another config tab
	    ConfigBox += "<div id='tab2' class='config_section'>";
	    ConfigBox += '<a class="flush" href=""><center>[Flush]</center></a> <br><i>(Poistaa kaikki hidetetyt langut)</i>';
	    ConfigBox += "</div>";

	    // Another config tab
	    ConfigBox += "<div id='tab3' class='config_section'>";
	    ConfigBox += "<marquee>Revoluutio on täällä!</marquee>";
	    ConfigBox += "</div>";
	    ConfigBox += "</div>";
	    ...
	    ConfigBox += "<li><a href='#tab1'>Suodatin</a></li>";
	    ConfigBox += "<li><a href='#tab2'>Flush</a></li>";
	    ConfigBox += "<li><a href='#tab3'>Spudro</a></li>";
	    ConfigBox += "</ul>";
