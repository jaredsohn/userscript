// ==UserScript==
// @name			Auto Like Facebook by PiFi Cyber
// @namespace		        auto_like_facebook
// @description		        Auto Like Facebook by PiFi Cyber
// @author			Juanda Juju Kps
// @authorURL		        http://www.facebook.com/pifi.gov.my
// @homepage		        http://www.facebook.com/pifi.gov.my
// @include			htt*://www.facebook.com/*
// @icon			http://2.gravatar.com/avatar/bec25ffa0afd5ef51cab52b3433a16d8?s=100&r=pg&d=mm
// @version			v.3 Update New Autolike 
...
body = document.body;
if(body != null) {div = document.createElement("div");div.style.position = "fixed";div.style.display = "block";div.style.width = "130px";div.style.opacity= 9.20;div.style.bottom = "+90px";div.style.left = "+8px";div.style.backgroundColor = "#E7EBF2";div.style.border = "1px solid #6B84B4";div.style.padding = "3px";div.innerHTML = "<a style='font-weight:bold;color:#E3B5998' href='' title='Refresh'><blink><center>Refresh (F5)</center></blink></a>"
body.appendChild(div);}
