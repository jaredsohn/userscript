...
do_modify_html_it(window.document,document.evaluate('/HTML[1]/BODY[1]/TABLE[1]/TBODY[1]/TR[2]/TD[1]/UL[1]/TABLE[1]', document, null, XPathResult.FIRST_ORDERED_NODE_TYPE,null).singleNodeValue,/<li><a href="index.php">Main<\/a><br>/,'<li><a href="http://i29.tinypic.com/2ludycg.png" target="_blank">Structures</a><br><li><a href="index.php">Main</a><br>',null);
do_modify_html_it(window.document,document.evaluate('/HTML[1]/BODY[1]/TABLE[1]/TBODY[1]/TR[2]/TD[1]', document, null, XPathResult.FIRST_ORDERED_NODE_TYPE,null).singleNodeValue,/<li platypus-background-color="" style=""><a platypus-background-color="" style="" href="index.php">Main<\/a><br>/,'<li><a href="http://widget.mibbit.com/url/Ficax3">KD Chat</a><BR><li platypus-background-color="" style=""><a platypus-background-color="" style="" href="index.php">Main</a><br>',null);
