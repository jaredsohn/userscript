// ==UserScript==
// @name	[PG] BBCode-Edit new all cities
// @Author	11235813 edit by kingfr3sh
// @namespace	http://userscripts.org/scripts/show/88261
// @description	Erweiterter BB-Code Editor mit Vorschaufunktion + brauchbare Smileys
// @version	2.3 Das Respekt Schild hat wieder Einzug gefunden

// @include	http://*game*/gang/
// @include http://*bumrise*/gang/
// @include http://*game*/messages/write/*
// @include http://*bumrise*/messages/write/*
// @include	http://www.pennergame.de/gang/forum/viewthread*
// @include	http://www.pennergame.de/gang/forum/editpost*
// @exclude	*change*
// ==/UserScript==
...
function add_funcs() {
	...
	editor.addSmilie('http://www.greensmilies.com/smile/smiley_emoticons_klugscheisser.gif');
	...
	editor.addSmilie('http://www.greensmilies.com/smile/smiley_emoticons_charly_willkommen.gif');	
	editor.addSmilie('http://www.smiliemania.de/smilie132/00000726.gif');
	editor.addSmilie('http://www.greensmilies.com/smile/smiley_emoticons_urlaub.gif');
