...
// @description    Filter unwanted websites from Google search results
// @include        http://www.google.*/search*
// ==/UserScript==

/*
  This script was originally created by arnab on userscripts.org. I have made
  several modifications that improve upon his original script. The original
  script can be found here: http://userscripts.org/scripts/show/18527
*/
...
var allDivs = resultsDiv.getElementsByTagName("li");
var removedSites = [];

for (var i = 0; i < allDivs.length; i++)
{
  var s = 0;
  if (allDivs[i].className.indexOf("g") != -1)
  {
...
if (showUnblockBar && removedSites.length > 0)
{
  ...
  newElement.innerHTML = removedSites.length + " item(s) filtered out by Google Filter user script - Click here to show";
