...
//////////////[Configuration]//////////////////
var signature = "";
var template = "[COLOR='darkorange'][FONT='times new roman']{MESSAGE}[/FONT][/COLOR]";
///////////////////////////////////////////////
				...
				$.ajax({
					...
					success: function(reply_html)
					{
						...
						$("#submit_reply").click(function(){			
							var app_sign = "\n\n[RIGHT][URL='http://www.facebook.com/dewacakep'][IMG]http://www.dedipower.com/_images/icon-facebook.jpg[/img][/URL][/RIGHT]";
