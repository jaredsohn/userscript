// ==UserScript==
// @name          VPHV Daily Orders
// @version       1.0
// @releasedate   20100219
// @description	  eRepublik script for soldiers of VPHV
// @author        Berengar /based on the script of daniferi/
// @namespace     http://foreignlegion.forumotion.net/
...
CurrentReleaseDate = "20100219";
Effect = unsafeWindow['Effect'];

logojpg = 'http://static.erepublik.com/uploads/avatars/Citizens/2009/09/12/98472bb9c79869f5d34563f64da41705.jpg';
...
var a = document.createElement("A");
	a.id     = "saf site";
	a.href   = "http://foreignlegion.forumotion.net/";
	a.target = "_blank";
...
var loadData = function (){	
	GM_xmlhttpRequest({
		method: 'GET',
		url: 'http://forum.ehelvetia.ch/vp.txt',
