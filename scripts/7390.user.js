  ...
  //if (GM_getValue('villageDropdown') == null) {
    ...
    $.get(gameURL,
      ...
      function(data) {
        ...
        /* List of Villages */
        var dStart = '<tr><th>Village</th><th>Points</th><th>Resources</th><th>Warehouse</th><th>Farm</th>';
        var dEnd = '</table>';
        ...
        pTable.innerHTML = sDropDown + '</select> - <a href="'+gameURL+'&screen=overview_villages">Villages Overview</a> - <a href="'+gameURL+'&screen=map">Map</a> - <a href="'+gameURL+'&screen=overview">Village overview</a>';
      }
    );
  //}
}
...
newStyles += '.menu ul li a, .menu ul li a:visited {display:block; text-decoration:none; color:#000;width:80px; height:20px; text-align:center; color:#000; border:2px solid #804000; border-left: 0px; border-right: 0px; background:#f1ebdd; line-height:20px; padding: 4px; overflow:hidden;}';
...
newStyles += '.menu ul li:hover ul li a {display:block; background:#f1ebdd; border: 1px solid #804000; border-top: 0; color:#000;}';
...
menuBarTop += '  <ul>';
/* Logout */
menuBarTop += '    <li style="border-left:2px solid #804000"><a class="hide" href="'+gameURL+'&screen=&action=logout&h='+myHash+'">Logout</a></li>';

/* Forum */
menuBarTop += '    <li><a class="hide" href="http://forum.tribalwars.net/index.php">Forum</a></li>';

/* Chat */
menuBarTop += '    <li><a class="hide" href="chat.php">Chat</a></li>';

/* Settings */
menuBarTop += '    <li><a class="hide" href="'+gameURL+'&screen=settings">Settings</a>';
menuBarTop += '    	<ul>';
menuBarTop += '       <li><a href="help.php">Help</a></li>';
menuBarTop += '      	<li><a href="'+gameURL+'&screen=settings&mode=profile">Profile</a></li>';
menuBarTop += '      	<li><a href="'+gameURL+'&screen=settings&mode=email">Email Address</a></li>';
menuBarTop += '      	<li><a href="'+gameURL+'&screen=settings&mode=settings">Settings</a></li>';
menuBarTop += '      	<li><a href="'+gameURL+'&screen=settings&mode=move">Start Over</a></li>';
menuBarTop += '      	<li><a href="'+gameURL+'&screen=settings&mode=delete">Delete Acct</a></li>';
menuBarTop += '      	<li><a href="'+gameURL+'&screen=settings&mode=share">Share Conn.</a></li>';
menuBarTop += '      	<li><a href="'+gameURL+'&screen=settings&mode=vacation">Acct Sitting</a></li>';
menuBarTop += '      	<li><a href="'+gameURL+'&screen=settings&mode=logins">Logins</a></li>';
menuBarTop += '      	<li><a href="'+gameURL+'&screen=settings&mode=change_passwd">Change Pass</a></li>';
menuBarTop += '      	<li><a href="'+gameURL+'&screen=settings&mode=poll">Surveys</a></li>';
menuBarTop += '      	<li><a href="'+gameURL+'&screen=settings&mode=ref">Recruit</a></li>';
menuBarTop += '      	<li><a href="'+gameURL+'&screen=settings">Service Req</a></li>';
menuBarTop += '      </ul>';
menuBarTop += '    </li>';

/* Ranking */
menuBarTop += '    <li><a class="hide" href="'+gameURL+'&screen=ranking">Ranking</a>';
menuBarTop += '    	<ul>';
menuBarTop += '      	<li><a href="'+gameURL+'&screen=ranking&mode=ally">Tribes</a></li>';
menuBarTop += '      	<li><a href="'+gameURL+'&screen=ranking&mode=player">Player</a></li>';
menuBarTop += '      	<li><a href="'+gameURL+'&screen=ranking&mode=con_ally">Cont Tribes</a></li>';
menuBarTop += '      	<li><a href="'+gameURL+'&screen=ranking&mode=con_player">Cont Players</a></li>';
menuBarTop += '      	<li><a href="'+gameURL+'&screen=ranking&mode=kill_player">Oppts Defeated</a></li>';
menuBarTop += '      </ul>';
menuBarTop += '    </li>';
...
/* Tribe */
menuBarTop += '    <li><a class="hide" href="'+gameURL+'&screen=ally">'+newPost+'Tribe</a>';
menuBarTop += '    	<ul>';
menuBarTop += '      	<li><a href="'+gameURL+'&screen=ally&mode=overview">Overview</a></li>';
menuBarTop += '      	<li><a href="'+gameURL+'&screen=ally&mode=profile">Profile</a></li>';
menuBarTop += '      	<li><a href="'+gameURL+'&screen=ally&mode=members">Members</a></li>';
menuBarTop += '      	<li><a href="'+gameURL+'&screen=ally&mode=contracts">Diplomacy</a></li>';
menuBarTop += '      	<li><a href="'+gameURL+'&screen=ally&mode=invite">Invitations</a></li>';
menuBarTop += '      	<li><a href="'+gameURL+'&screen=ally&mode=forum">Forums</a></li>';
menuBarTop += '      </ul>';
menuBarTop += '    </li>';
...
menuBarTop += '    <li><a class="hide" href="'+gameURL+'&screen=report">'+newReport+'Reports</a>';
menuBarTop += '    	<ul>';
menuBarTop += '      	<li><a href="'+gameURL+'&screen=report&mode=all">All Reports</a></li>';
menuBarTop += '      	<li><a href="'+gameURL+'&screen=report&mode=attack">Attacks</a></li>';
menuBarTop += '      	<li><a href="'+gameURL+'&screen=report&mode=defense">Defenses</a></li>';
menuBarTop += '      	<li><a href="'+gameURL+'&screen=report&mode=support">Support</a></li>';
menuBarTop += '      	<li><a href="'+gameURL+'&screen=report&mode=trade">Trade</a></li>';
menuBarTop += '      	<li><a href="'+gameURL+'&screen=report&mode=other">Misc</a></li>';
menuBarTop += '      	<li><a href="'+gameURL+'&screen=report&mode=forwarded">Forwarded</a></li>';
menuBarTop += '      	<li><a href="'+gameURL+'&screen=report&mode=filter">Filter</a></li>';
menuBarTop += '      	<li><a href="'+gameURL+'&screen=report&mode=block">Block Sender</a></li>';
menuBarTop += '      </ul>';
menuBarTop += '    </li>';
...
menuBarTop += '    <li style="border-right:2px solid #804000"><a class="hide" href="'+gameURL+'&screen=mail">'+newMail+'Mail</a>';
menuBarTop += '    	<ul>';
menuBarTop += '      	<li><a href="'+gameURL+'&screen=mail&mode=in">Mail</a></li>';
menuBarTop += '      	<li><a href="'+gameURL+'&screen=mail&mode=mass_out">Circular Mail</a></li>';
menuBarTop += '      	<li><a href="'+gameURL+'&screen=mail&mode=new">Write Msg</a></li>';
menuBarTop += '      	<li><a href="'+gameURL+'&screen=mail&mode=block">Block Sender</a></li>';
menuBarTop += '      </ul>';
menuBarTop += '    </li>';
...
menuBar += '  <ul>';
/* HQ */
menuBar += '    <li style="border-left:2px solid #804000"><a class="hide" href="'+gameURL+'&screen=main"><img src="'+baseURL+'/graphic/buildings/main.png" border="0">&nbsp;HQ</a>';
menuBar += '    	<ul>';
menuBar += '      	<li><a href="'+gameURL+'&screen=main&mode=build">Construct</a></li>';
menuBar += '      	<li><a href="'+gameURL+'&screen=main&mode=destroy">Demolish</a></li>';
menuBar += '      </ul>';
menuBar += '    </li>';

/* Barracks */
menuBar += '    <li><a class="hide" href="'+gameURL+'&screen=barracks"><img src="'+baseURL+'/graphic/buildings/barracks.png" border="0">&nbsp;Barracks</a></li>';

/* Stable */
menuBar += '    <li><a class="hide" href="'+gameURL+'&screen=stable"><img src="'+baseURL+'/graphic/buildings/stable.png" border="0">&nbsp;Stable</a></li>';

/* Workshop */
menuBar += '    <li><a class="hide" href="'+gameURL+'&screen=garage"><img src="'+baseURL+'/graphic/buildings/garage.png" border="0">&nbsp;Workshop</a></li>';

/* Academy */
menuBar += '    <li><a class="hide" href="'+gameURL+'&screen=snob"><img src="'+baseURL+'/graphic/buildings/snob.png" border="0">&nbsp;Academy</a>';
menuBar += '    	<ul>';
...
/* Smithy */
menuBar += '    <li><a class="hide" href="'+gameURL+'&screen=smith"><img src="'+baseURL+'/graphic/buildings/smith.png" border="0">&nbsp;Smithy</a></li>';

/* Rally Point */
menuBar += '    <li><a class="hide" href="'+gameURL+'&screen=place"><img src="'+baseURL+'/graphic/buildings/place.png" border="0">&nbsp;Rally Pt</a>';
menuBar += '    	<ul>';
menuBar += '      	<li><a href="'+gameURL+'&screen=place&mode=command">Commands</a></li>';
menuBar += '      	<li><a href="'+gameURL+'&screen=place&mode=units">Troops</a></li>';
menuBar += '      	<li><a href="'+gameURL+'&screen=place&mode=sim">Simulator</a></li>';
menuBar += '      </ul>';
menuBar += '    </li>';

/* Market */
menuBar += '    <li style="border-right:2px solid #804000"><a class="hide" href="'+gameURL+'&screen=market"><img src="'+baseURL+'/graphic/buildings/market.png" border="0">&nbsp;Market</a>';
menuBar += '    	<ul>';
menuBar += '      	<li><a href="'+gameURL+'&screen=market&mode=send">Send Res.</a></li>';
menuBar += '      	<li><a href="'+gameURL+'&screen=market&mode=own_offer">Your Offers</a></li>';
menuBar += '      	<li><a href="'+gameURL+'&screen=market&mode=other_offer">Other Offers</a></li>';
menuBar += '      	<li><a href="'+gameURL+'&screen=market&mode=traders">Merchants</a></li>';
menuBar += '      </ul>';
menuBar += '    </li>';
menuBar += '  </ul>';
menuBar += '</div>';
...
if (getParam('screen') == 'overview') {
  ...
  wood.innerHTML = wood.innerHTML + ' / <strong>' + (woodAmt * 24) + '</strong> per Day';
  clay.innerHTML = clay.innerHTML + ' / <strong>' + (clayAmt * 24) + '</strong> per Day';
  iron.innerHTML = iron.innerHTML + ' / <strong>' + (ironAmt * 24) + '</strong> per Day';
