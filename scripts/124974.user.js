...
GM_addStyle('.rdbWrapper{float:right;height:20px;width:300px;overflow:hidden;margin-top:-1px;}');
...
function main() {
  ...
  jQuery('#viewer-entries-container').scroll(function() {
      ...
      jQuery('.entry-actions:not(.readability-enabled)').each(function() {
          var share = jQuery('<div class="rdbWrapper" data-show-read="1" data-show-send-to-kindle="1" data-show-print="0" data-show-email="0" data-orientation="0" data-version="1"></div>');
