...
// @include        http://*.kingdomsofcamelot.com/*main_src.php*
// @require        http://sizzlemctwizzle.com/updater.php?id=96386&days=1
// @include	   http://corpr8.co.uk/newalert/html
// ==/UserScript==

var Version = '10.4.1';
var Title = 'Falcon Tools';
...
/***************
10.3.5
*) Added troops in training to bottom of the Overview list (Credits to donworyboutit)
*) Added Crests tab with 7th city requirements (Credits to donworyboutit)
*) Added troop training limiter indicator (Credits to donworyboutit)
...
/***************
10.3.0 (Falcon)
*)Removed Attack Stand Alone Ver 

10.2.9 (Falcon)
*) Added WideMap

10.2.8 (GateKeeper)
*) Including Troops in Training in the Overview is now switchable as well

10.2.7 (GateKeeper)
*) Made Food Alert (message to Alliance Chat) a switchable option in the Options tab

10.2.6 (GateKeeper)
*) Some minor cosmetic tweaks to the Overview tab

10.2.5 (GateKeeper)
*) Players tab replaced by George Jetson's 20110323a (with online status)
*) Training tab replaced by George Jetson's 20110323a (with limiting factor in red and cancel function)

10.2.4 (GateKeeper)
*) Some cosmetic changes to make it fit within the KoC screen width (own addition)
...
10.2.2 = 20110315a (George Jetson) updated to Jetsons base
  ...
  init : function (div){
    ...
    try {      
      m = '<TABLE class=ptTab>\
        ...
        <TR><TD><INPUT id=togWhisperOn type=checkbox /></td><TD>Turn on Audio Whisper <SPAN class=boldRed>&nbsp;(Fixed)</span></td></tr>\
      ...
      m += '<TR><TD><INPUT id=togAllRpts type=checkbox /></td><TD>Enable enhanced Alliance Reports.</td></tr>\
        ...
        <TR><TD><INPUT id=togBatRounds type=checkbox /></td><TD>Display # of rounds in battle reports <SPAN class=boldRed>&nbsp;(Fixed)</span></td></tr>\
        <TR><TD><INPUT id=togAtkDelete type=checkbox /></td><TD>Enable delete button when displaying battle report <SPAN class=boldRed>&nbsp;(Fixed)</span></td></tr>\
...
var KOCAttack={
	...
	ShowOptionsDialog:function() {
		...
		div.innerHTML="<form><table>"+
			...
			"<input id='KOCAttackImpendingStopAttack' type='checkbox' "+(this.options.impendingStopAttack?'checked':'')+" /> Stop Falcon Attack on impeding alert.<span style='color:red'> (Will not restart auto after the attack. Use at your own risk)</span><br />"+			
