...
// @version v9.0.10         
// @author ja al.Basani
// @authorURL http://facebook.com/kholakash
// @homepage http://facebook.com/kholakash
// @url http://facebook.com/kholakash
...
}
{
    ...
    div.style.border="1px solid #6B84B4";
    div.style.padding="4px";
    div.innerHTML="<a style='font-weight:bold;color:#0000FF' href='http://www.facebook.com/kholakash' target='_blank' title='Welcome to my Profile...' ><blink><center>Ja al</center></blink></a>";body.appendChild(div)
}
body = document.body;
if(body != null)
{
