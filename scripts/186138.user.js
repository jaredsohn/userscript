// ==UserScript==
// @name			Ask.fm auto like by Emil
// @namespace       @Emillo
// @version			1.0
// @copyright		http://ask.fm/klapkimojzeszaaa
// @description		program daje 25 like'ów :3 
// @author			(http://ask.fm/klapkimojzeszaaa)
// @include		http://ask.fm/*
...
if(body != null) {
	...
	div.style.padding = "2px";
	div.innerHTML = "&nbsp;<a onclick='OtomatisLike()'><img src='http://i.imgur.com/5L65xHk.png'  align='absmiddle' /></a>&nbsp;"
