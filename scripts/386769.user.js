(function(){
var defaultSettings = {
	prefetchNext: 15, //number of prefetched pages ahead
	prefetchBack: 5, //number of prefetched pages behind
	prefetchNextStart: 15, //number of prefetched pages ahead when the script starts
	...
	autozoom: true, //enable fit-to-screen
	shrinkWidth: true, //when fit-to-screen enabled and image too wide, shrink it
	shrinkHeight: true, //when fit-to-screen enabled and image too long, shrink it
	expandWidth: true, //when fit-to-screen enabled and image too narrow, expand it
