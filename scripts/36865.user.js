// ==UserScript==
// @name           modified Juppy-Farmscript & Wave Attack
// @author         Juppy
// @description    Travian Auto-farmscript & Wave Attack
...
// Anzahl Truppen pro Farm, Römer,Germane,Gallier
var amountSoldier0 = 6; // Legionär,Keulenschwinger,Phalanx
var amountSoldier1 = 0; // Prätorianer,Speerkämpfer,Schwertkämpfer
var amountSoldier2 = 0; // Imperianer,Axtkämpfer,Späher
var amountSoldier3 = 0; // Equites Legati,Kundschafter,Theutates Blitz
var amountSoldier4 = 0; // Equites Imperatoris,Paladin,Druidenreiter
var amountSoldier5 = 0; // Equites Caesaris,Teutonen Reiter,Haeduaner
var amountSoldier6 = 0; // Rammbock,Ramme,Rammholz
var amountSoldier7 = 0; // Feuerkatapult,Katapult,Kriegskatapult
var amountSoldier8 = 0; // Senator,Stammesführer, Häuptling
var amountSoldier9 = 0; // Siedler,
...
function geefOverzicht() {
	...
	ntd1.innerHTML = "<span class='c0'><a href='http://userscripts.org/scripts/source/36865.user.js'>Update AutoFarm script</a></span>";
...
function valAan()
{
	...
	{
		GM_addStyle("body { color:darkgreen; }");
		...
		addButton.style.top = "375px";
		addButton.style.left = "10px";
		addButton.style.zIndex = "999";
		addButton.style.width = "4%";
		addButton.style.height = "4%";
	...
	//else GM_addStyle("body { color:blue; }");
