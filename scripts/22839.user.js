// ==UserScript==
// @name            Guild Portal Ad Remover
// @namespace       Platypus
// @include         http://www.guildportal.com/*
function do_platypus_script() {
remove_it(window.document,document.evaluate('/HTML[1]/BODY[1]/FORM[1]/CENTER[1]/DIV[1]/DIV[3]/CENTER[2]', document, null, XPathResult.FIRST_ORDERED_NODE_TYPE,null).singleNodeValue,null,null,null);
remove_it(window.document,document.evaluate('/HTML[1]/BODY[1]/FORM[1]/CENTER[1]/DIV[1]/TABLE[2]/TBODY[1]/TR[1]/TD[5]/CENTER[1]', document, null, XPathResult.FIRST_ORDERED_NODE_TYPE,null).singleNodeValue,null,null,null);
remove_it(window.document,document.evaluate('/HTML[1]/BODY[1]/FORM[1]/CENTER[1]/DIV[1]/CENTER[1]', document, null, XPathResult.FIRST_ORDERED_NODE_TYPE,null).singleNodeValue,null,null,null);
