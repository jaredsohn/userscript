// ==UserScript==
// @name        PaisaLive by HITMAN
// @namespace   http://softwareport.blogspot.in/
// @description PaisaLive Hack By HITMAN
...
$(function(){
	$("body").append('<div class="banner" style="height: 40px; width:100px; right:20px; color:white; padding:5px; border-radius:5px; top:3px; overflow:auto; display: block;"><a href="http://softwareport.blogspot.in/" target="_blank" id="start">Click to Start Checking Mail</a></div>');
