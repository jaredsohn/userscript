// ==UserScript==
// @name           HighscoresScript _ID_und_3Uhr_Gewinn_rechner__pennergame_4.0_Hamburg_u_Berlin (version 1.3 ) 
...
document.getElementById('highscoreright').innerHTML += ""


+"<img src='http://www.fotos-hochladen.net/gutsr9f2akj.jpg'></img> = Dein Id Bereich ist besser und der Gegner hatte bis jetzt nur Punkte verlust,den Kampf wirst du wohl Gewinnwn<br>"
+"<img src='http://www.fotos-hochladen.net/schlechtpoy1b3xz.jpg'></img> = Der Gegner hatte bis jetzt nur Punktezuwachs und ist in den Id Bereich dir &uuml;berlegen .Angriff zwecklos<br>"
+"<img src='http://www.fotos-hochladen.net/mittelrotgruenxny2atcw.jpg'></img> = Der Gegner ist dir mit der Id &uuml;berlegen ,ist aber in Punkteabbau.Ein angriff kann reskiert werden<br>"
+"<img src='http://www.fotos-hochladen.net/mittelgruenrotpquc865m.jpg'></img> = Der Gegner ist in einen schlechteren Id Bereich und hat Punkte aufgebaut .Vorsicht k&ouml;nntest verlieren <br>"
+"<img src='http://www.fotos-hochladen.net/neutralxw61lvnj.jpg'></img> = Der Gegner ist in deinen Id Bereich und seine Punkte haben sich nicht geendert.Den Kampf k&ouml;nntest du gewinnen<br>"
+"<img src='http://www.fotos-hochladen.net/mittelschlecht781f9bz6.jpg'></img> = Der Gegner ist mit der Id besser,aber seine Punkte sind neutral geblieben.Angriff ist riskant aber machbar<br>"
+"<img src='http://www.fotos-hochladen.net/mittelgutk3veqr0m.jpg'></img> = Der Gegner ist mit der Id dir unteliegen und Punkte zuwachs 0,den Kaqmpf wirst du wohl Gewinnen zu 90%<br>"
...
if(fab == 'green'){
if(fab1 == 'green'){
test = "<img src='http://www.fotos-hochladen.net/gutsr9f2akj.jpg'></img>";
}
}
if(fab == 'red'){
if(fab1 == 'red'){
test = "<img src='http://www.fotos-hochladen.net/schlechtpoy1b3xz.jpg'></img>";
}
}
if(fab == 'red'){
if(fab1 == 'green'){
test = "<img src='http://www.fotos-hochladen.net/mittelrotgruenxny2atcw.jpg'></img>";
}
}
if(fab == 'green'){
if(fab1 == 'red'){
test = "<img src='http://www.fotos-hochladen.net/mittelgruenrotpquc865m.jpg'></img>";
}
}
if(fab == 'yellow'){
if(fab1 == 'yellow'){
test = "<img src='http://www.fotos-hochladen.net/neutralxw61lvnj.jpg'></img>";
}
}
if(fab == 'red'){
if(fab1 == 'yellow'){
test = "<img src='http://www.fotos-hochladen.net/mittelschlecht781f9bz6.jpg'></img>";
}
}
if(fab == 'green'){
if(fab1 == 'yellow'){
test = "<img src='http://www.fotos-hochladen.net/mittelgutk3veqr0m.jpg'></img>";
}
}
if(fab == 'yellow'){
if(fab1 == 'red'){
...
var tr3 = tr2.getElementsByTagName('td')[0].innerHTML = test+punkte;
