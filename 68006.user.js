...
(function () {
	...
	AntiGame_lang.LabelsTW =
	{
		...
		lbl_missDeploy: '調配',
		lbl_missDestroy: '摧毀',
		lbl_missEspionage: '間諜',
		lbl_missExpedition: '探索',
		lbl_missFederation: '聯合攻擊',
		lbl_missHarvest: '回收殘骸廢墟',
		lbl_missHold: '保持原位',
	...
	AntiGame_lang.InterfaceTW =
	{
		...
		opt_showNames: '於圖片上顯示船艦 / 設施 / 研究的名稱',
		...
		opt_showEventList: '於概況畫面顯示未被折疊的事件清單',
		...
		opt_fleet2_checkProbeCapacity: '發送艦隊前檢查探索容量 (第 2 頁)',
		...
		opt_missDeploy: '任務顏色: 調配',
		opt_missDestroy: '任務顏色: 摧毀',
		opt_missEspionage: '任務顏色: 間諜',
		opt_missExpedition: '任務顏色: 探索',
		opt_missFederation: '任務顏色: 聯合攻擊',
		opt_missHarvest: '任務顏色: 回收殘骸廢墟',
		opt_missHold: '任務顏色: 保持原位',
