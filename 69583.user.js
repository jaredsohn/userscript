...
window.storm8 = {“objectiveC”: {“commandData”: {}}, “topBar”: {“data”: {}, “timerData”: {}}};
...
function createTopBarTimer() {
  setTimeout(function() { updateTopBarData(); createTopBarTimer(); }, 1000);
}
...
storm8.widget.PopupDialog = function(elementId, showCallback, userData)
{
    ...
    this.find(“close”).onmousedown = function()
    {
        dialog.hideDialog();
    };
...
storm8.widget.SectionTabs = function(elementId)
{
    ...
    for (var i = 0; i < tabs.length; i++)
    {
        ...
        tabs[i].ontouchend = function()
        {
            ...
            else if (this.childNodes[1].nodeType == 1)
                window.location = this.childNodes[1].href;
