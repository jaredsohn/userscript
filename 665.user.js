...
// ==UserScript==
// @name            Ad Skipper IGN.com
// @namespace       http://docs.g-blog.net/code/greasemonkey
// @description     2005-04-28: Skips interstitial advertisements and disables the content area ads on IGN.com.
...
(function() {
    ...
    var AdSkipper =
    {
        checkPage: function()
        {
            ...
            if (currentURL.match(/^http:\/\/[a-z0-9]+\.ign\.com\//i))
            {
