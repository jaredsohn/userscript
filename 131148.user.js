...
function findRare() {
	...
	wildText = wildText.textContent.trim();
	if (!wildText.match(/Wild (Shiny Latios|Shiny Kyogre|Shiny Kyurem|Shiny Mew|Shiny Mewtwo|Shiny Darkrown|Shiny Keldeo|Shiny Suicune|Shiny Giratina|Shiny Arceus|Shiny Dialga|Shiny Palkia|Shiny Victini|Shiny Uxie|Shiny Azelf|Shiny Mesprit|Shiny Lugia|Shiny Ho-oh|Shiny Entei|Shiny Manaphy|Shiny Phione|Shiny Regirock|Shiny Regice|Shiny Registeel|Shiny Shaymin|Shiny Regigigas|Shiny Suicune|Shiny Raikou|Shiny Terrakion| Shiny Jirachi)/)) {
		moveAround();
		return;
	}
...
function autoBattle() {
	try {
		...
		if (btnBattle) {
			// wait until 4 seconds since last battle
