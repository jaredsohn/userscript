// ==UserScript==
// @author		luckyman, modified by tomasz.frelik (at) enzo.pl, and by quimicefa (at) gmail.com.
...
// si estamos en edificios ..
	...
	for (var i=0;i<need.snapshotLength;i++){
		...
		*/
		...
		resource_div.innerHTML =  "<br>Suficientes recursos en: <span id=timer0>"+t+"</span>"
													 + "<br>Recurso limitante: " + resourceName;
