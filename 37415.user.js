// ==UserScript==
// @author      Riccardo Collina
// @namespace	n.a
// @name	Travian: Coda Costruzione Riki
...
aLangBuildings = ["", "Ξυλοκόπος", "Ορυχείο πηλού", "Ορυχείο σιδήρου", "Αγρόκτημα σιταριού", "� ριονιστήριο", "Φούρνος πηλού", "Χυτήριο σιδήρου", "Μύλος σιταριού", "Φούρνος", "Αποθήκη πρώτων υλών", "Σιταποθήκη", "Οπλοποιείο", "� ανοπλοποιείο", "Χώρος αθλημάτων", "Κεντρικό κτήριο", "� λατεία συγκεντρώσεως", "Αγορά", "� ρεσβεία", "Στρατόπεδο", "Στάβλος", "Εργαστήριο", "Ακαδημία", "Κρυψώνα", "Δημαρχείο", "Μἐγαρο", "� αλάτι", "Θησαυροφυλάκιο", "Εμπορικό γραφείο", "Μεγάλο στρατόπεδο", "Μεγάλος στάβλος", "Τείχος", "Χωματένιο τείχος", "Τείχος με πάσαλους", "Λιθοδόμος", "Ζυθοποιίο", "Άτομο που στήνει παγίδες", "� εριοχή ηρώων", "Μεγάλη αποθήκη", "Μεγάλη σιταποθήκη", "� αγκόσμιο θαύμα"];
aLangTasks = ["Κατασκευή", "Αναβάθμιση", "Επίθεση", "Έρευνα", "Εκπαίδευση","Αποστολή � ρώτων Υλών"];
aLangStrings = ["Κατασκευή Αργότερα", "Αναβάθμιση Αργότερα", "Επίθεση Αργότερα", "Έρευνα Αργότερα", "� ραγραμματισμός Εργασίας Για Αργότερα.", "Ξεκίνησε Κατασκευή", " Επιχειρηθείς Με Άγνωστο Αποτέλεσμα.", "Επίπεδο", " Δεν Μπορεί Να Κατασκευαστεί.", " Δεν Μπορεί Να Αναβαθμιστεί.", "Η Εργασία � ραγραμματίστηκε .", "� αραγωγή:", "Δεν Μπορεί Να � ραγραμματισθεί Αυτή Η Εργασία Τώρα.", "Ο � ραγραμματισμός Εργασίας Δεν Είναι Διαθέσιμος!", "� ραγραμματισμένες Εργασίες", "Διαγραφή", "Αποστολή Αργότερα", "Η Επίθεση Δεν Μπορεί Να � ρογραμματισθεί Επειδή Δεν Επιλέχθηκαν Στρατιώτες.", "Οι Στρατιώτες Στάλθηκαν", "Οι Στρατιώτες Δεν Μπόρεσαν Να Σταλούν", "Ενίσχυσεις", "Επίθεση", "Εισβολή Αρπαγής", "Οι Καταπέλτες Θα Στοχέυσουν Σε", "Τυχαία", "Σε", "ή Μετά", "Δευτερόλεπτα", "Λεπτά", "Ώρες", "Μέρες", "Ανίχνευση � ρώτων Υλών Και Στρατευμάτων", "Ανίχνευση Οχύρωσης Και Στρατευμάτων", "Μακριά", "Η Επίθεση Δεν Μπορεί Να � ρογραμματισθεί Επειδή Δεν Ορίστικαν Συντεταγμένες ή Όνομα Χωριού.", "Σε Θέση.", "Ταξινόμηση Κατά:", "Τύπο ", "Χρόνο ", "Στόχο ", "Επιλογές ", "Χωριό ","Ιστορικό Εργασιών", "Καθαρισμός Ιστορικού", "Ξεκίνησε η έρευνα ", " δεν μπορεί να ερευνηθεί.", "Βελτίωσε αργότερα", "Ανίχνευσε", "Εκπαίδευσε αργότερα", "μονάδες.", "Εκπαίδευσε", "Ξεκίνησε η εκπαίδευση ", " δεν μπορούν να εκπαιδευτούν.", "ή επανέλαβε", "φορές ", "διαφέροντας κατά ", "Καθαρισμός λίστας εργασιών ", "Έχουν αποσταλεί", "� ρόσθεσε αυτήν την εργασία στη λίστα"];
aLangTroops[0] = ["Λεγεωνάριος", "� ραιτωριανός", "Ιμπεριανός", "Equites Legati", "Equites Imperatoris", "Equites Caesaris", "� ολιορκητικός Κριός", "Καταπέλτης Φωτιάς", "Γερουσιαστής", "Άποικος", "Ήρωας"]; //Ρωμαίοι
aLangTroops[1] = ["Μαχητής Με Ρόπαλο", "Μαχητής Με Ακόντιο", "Μαχητής Με Τσεκούρι", "Ανιχνευτής", "� αλατινός", "Τεύτονας Ιππότης", "� ολιορκητικός Κριός", "Καταπέλτης", "Φύλαρχος", "Άποικος", "Ήρωας"]; //Τεύτονες
aLangTroops[2] = ["Φάλανξ", "Μαχητής Με Ξίφος", "Ανιχνευτής", "Αστραπή Του Τουτατή", "Δρουίδης", "Ιδουανός", "� ολιορκητικός Κριός", "� ολεμικός Καταπέλτης", "Αρχηγός", "Άποικος", "Ήρωας"]; //Γαλάτες
}catch(Error){
...
aLangBuildings = ["", "Лісоповал", "Глиняний кар'єр", "Залізна копальня", "Ферма", "Деревообробний завод", "Цегельний завод", "Чавуноливарний завод", "Млин", "Пекарня", "Склад", "Зернова комора", "Кузня зброї", "Кузня обладунків", "Арена", "Головна будівля", "Пункт збору", "� инок", "Посольство", "Казарма", "Стайня", "Майстерня", "Академія", "Схованка", "� атуша", "� езиденція", "Палац", "Скарбниця", "Торгівельна палата", "Велика казарма", "Велика стайня", "Міська стіна", "Земляний вал", "Палісад", "Каменетес", "Пивоварня", "Капканник", "Таверна", "Великий склад", "Велика зернова комора", "Диво світу"];
aLangTasks = ["Побудувати", "� озвинути", "Атакувати", "Дослідити", "Тренувати","Послати ресурси"];
aLangStrings = ["Побудувати пізніше", "� озвинути пізніше", "Атакувати пізніше", "Дослідити пізніше", "Запланувати завдання.", "Ми почали будівництво ", " ми спробували, але результат не визначено.", "рівень", " не може бути побудовано.", " не може бути розвинуто.", "Завдання заплановано.", "Поточне виробництво:", "Мы не можемо планувати цього зараз.", "Запланованого завдання не існує!", "Заплановані завдання", "Видалити", "Відправити пізніше", "Війська не вибрані.", "Ваші війська були відправлені в", "Ваші війська не можуть бути відправлені в", "Підтримка", "Атака", "Набіг", "Какапульти націлені на", "Випадково", "в", "або після закінчення", "секунд", "хвилин", "годин", "днів", "� озвідка ресурсів і військ", "� озвідка військ і оборонних споруд", "Відсутня", "Атака не може бути запланована, оскільки не вказана мета.", "на сайті №.", "Сортувати по:", "тип ", "година ", "мета ", "опції ", "Поселення ", "История завдань","Очистити історію","Мы почали дослідження" , " не может бути досліджено.", "Дослідити пізніше", "Шпигун", "Тренувати пізніше", "війска.", "Тренувати", "Мы почали тренування ", "Не може бути треновано", "або повтор ","раз ","разділенні по ", "Очистити чергу", "Було видалено"];
...
try{
		...
		aLangTroops[1] = ["Pálkar", "Oštepár", "Bojovník so sekerou", "� peh", "Rytier", "Teuton jazdec", "Germánske baranidlo", "Katapult", "Kmenový vodca", "Osadník", "Hrdina"];  //Teutons
		aLangTroops[2] = ["Falanx", "� ermiar", "Sliedic", "Theutates Blesk", "Druid jazdec", "Haeduan", "Drevené baranidlo", "Trebušé", "Nácelník", "Osadník", "Hrdina"];  //Gauls
}catch(Error){
...
try{
  ...
  printMsg("The ba language is not Correct. Check The traduction");
	...
	case "bg": //by NUT
try{
aLangBuildings = ["", "Сечище", "Глинена кариера", "� удник", "Житно поле", "Дъскорезница", "Тухларна", "Леярна", "Мелница", "Пекарна", "Склад", "Хамбар", "Ковачница за брони", "Ковачница за оръжия", "Арена", "Главна сграда", "Сборен пункт", "Пазар", "Посолство", "Казарма", "Конюшня", "� аботилница", "Академия", "Скривалище", "Кмество", "� езиденция", "Дворец", "Съкровищница", "Търговска Палата", "Голяма казарма", "Голяма конюшня", "Градска стена", "Земен насип", "Палисада", "Зидарска гилдия", "Пивоварна", "Трапер", "Таверна", "Голям склад", "Голям хамбар", "Чудо"];
...
aLangBuildings = ["", "伐木场", "黏土矿", "铁矿场", "农场", "木材厂", "� �块厂", "铸� 厂", "磨坊", "面包房", "仓库", "粮仓", "铁� 铺", "军械库", "竞技场", "村中心大楼", "集结点", "市场", "大使馆", "兵营", "马厩", "兵工厂", "� �发所", "山洞", "市政厅", "行宫", "皇宫", "国库", "交易所", "大兵营", "大马厩", "城墙", "土墙", "� �� �", "石� 铺", "酿� 厂", "陷阱机", "英雄园", "大仓库", "大粮仓", "世界奇迹"];
aLangTasks = ["建� ", "升级", "攻击", "� �究", "训练","运送资源"];
aLangStrings = ["预定建� ", "预定升级", "预定攻击", "预定� �究", "将这个任务预定稍后执行.", "开始建�  ", " 开始建� 但结果不明.", "等级", " 不能建� .", " 不能升级.", "任务延迟.", "当前建� :", "现在不能预定这个任务.", "计划不允许!", "已经预定的计划", "� 除", "稍后发送", "没有选择军队.", "� 的军队以出发", "� 的军队没有出发.", "增援", "攻击", "抢夺", "投石车将瞄准", "随机", "计划于", "或 等待", "秒", "分", "时", "日", "侦察敌方现有资源和军队", "侦察敌方防守部署和军队", "不在", "攻击不能计划，� 为没有指定目的地.", "在位置编号.", "分类按照:", "类型 ", "时间 ", "目� � ", "选项 ", "村庄 ", "任务历史记录", "清楚历史记录", "开始� �发 ", " 不能� �发.","稍后升级", "侦察", "稍后训练", "军队.", "训练", "开始训练 ", " 不能训练.","且重复 ","次 ","间隔 ","清空任务 ","已经派遣","任务排队"];
...
try{
		...
		aLangTroops[2] = ["Falanx", "� ermír", "Slídic", "Theutates Blesk", "Druid jezdec", "Haeduan", "Drevené beranidlo", "Válecný katapult", "Nácelník", "Osadník"]; //Gauls
}catch(Error){
...
try{
  ...
  printMsg("The hi language is not Correct. Check The traduction");
	...
	case "hk":  //by Angus
try{
		aLangBuildings = ["", "伐木� �", "泥坑", "鐵礦� �", "農� �", "鋸木� ", "磚� ", "鋼鐵鑄� � ", "麵粉� ", "麵包店" , "倉庫", "穀倉", "鐵� ", "盔甲� ", "競技� �", "村莊大樓", "集結點", "市� �", "大使館", "兵營", "馬棚", "工� �", "� �究院", "山洞", "城鎮廳", "行宮", "皇宮", "寶物庫", "交易所", "大兵營", "大馬棚", "城牆", "土牆", "柵欄", "石� 鋪", "釀� � ", "陷阱機", "英雄宅", "大倉庫", "大穀倉", "世界奇蹟"];
aLangTasks = ["建� ", "升級", "攻擊", "� �發", "訓練", "運送資源"];
aLangStrings = ["� �定建� ", "� �定升級", "� �定攻擊", "� �定� �究", "將這個任務� �定稍後執行.", "開始建� ", "開始建� 但結果不明.", "等級", "不能建� .", "不能升級.", "任務延遲.", "當前建� :", "現在不能� �定這個任務.", "計劃不允許!", "已經� �定的計劃", "刪除", "稍後發送", "沒有選擇軍隊.", "� 的軍隊以出發", "� 的軍隊沒有出發.", "增援", "攻擊", "搶奪", "投石車將瞄準", "隨機", "計劃於", "或等待", "秒", "分", "時", "日", "偵察敵方現有資源和軍隊", "偵察敵方防守部署和軍隊", "不在", "攻擊不能計劃，� 為沒有指定目的地.", "在位置編號.", "分類按照:", "類型", "時間", "目標", "選� �", "村莊", "任務歷史記錄", "清楚歷史記錄", "開始� �發", "不能� �發.","稍後升級", "偵察", "稍後訓練", "軍隊.", "訓練", "開始訓練", "不能訓練.","且重複","次","間隔","清空任務","已經派遣","任務排隊"];
aLangTroops[0] = ["古羅馬步兵", "禁衛兵", "帝國兵", "使者騎士", "帝國騎士", "將軍騎士", "衝撞車", "火焰投石機" , "參議員", "開拓者", "英雄"]; //Romans
aLangTroops[1] = ["棍棒兵", "矛兵", "斧� �兵", "偵察兵", "� 客", "條� �騎士", "衝撞車", "投石機", "司令官", "開拓者", "英雄"]; //Teutons
aLangTroops[2] = ["方陣兵", "劍士", "探路者", "雷法師", "德魯伊騎兵", "海� �聖騎", "衝撞車", "投石機", "族長", "開拓者", "英雄"]; //Gauls
}catch(Error){
...
try{
		aLangBuildings = ["", "Favágó", "Agyagbánya", "Vasércbánya", "Búzafarm", "Fűrészüzem", "Agyagégető", "Vasöntöde", "Malom", "Pékség", "Raktár", "Magtár", "Fegyverkovács", "Páncélkovács", "Gyakorlótér", "Főépület", "Gyülekezőtér", "Piac", "Követség", "Kaszárnya", "Istálló", "Műhely", "Akadémia", "Rejtekhely", "Tanácsháza", "Rezidencia", "Palota", "Kincses Kamra", "Kereskedelmi központ", "Nagy Kaszárnya", "Nagy Istálló", "Kőfal", "Földfal", "Cölöpfal", "Kőfaragó", "Sörfőzde", "Csapdakészítő", "Hősök háza", "Nagy Raktár", "Nagy Magtár", "Világcsoda"];
		aLangTasks = ["Építés", "Szintemelés", "Támadás", "Fejlesztés", "Kiképzés","Küldés"];
		aLangStrings = ["Építés később]", "Szintemelés később]", "Támadás később]", " Fejlesztés később]", "A művelet időzítve későbbre.", "Az építés elkezdődött ", " Megpróbáltam ismeretlen eredménnyel.", "szint", "nem épülhet meg.", " nem lehet szintetemelni.", "Időzítésre került feladat:", " Jelenlegi termelés:", "Jelenleg nem időzíthető", "A feladat időzítés nem elérhető!", "Időzített feladatok:", "Törlés", "Küldés később]", "A támadás nem időzíthető! Nem lettek egységek kiválasztva.", "Az egységeid elküldve", "Az egységek elküldése nem sikerült, ide:", "Támogatás", "Normál támadás", "Rablótámadás", "A katapult(ok) célpontja", "véletlenszerű", "Ekkor:", "vagy késleltetve", "másodperccel", "perccel", "órával", "nappal", "Nyersanyagok és egységek kikémlelése", "Egységek és épületek kikémlelése", "távol", "A támadás nem időzíthető! Nem lett végcél kiválasztva.", "A következő azonosítójú helyen:", "Rendezés:", "típus ", "idő ", "célpont ", "beállítások ", "falu ", "History", "előzmények törlése","[A feladat ütemezése]"];
...
try{
  ...
  printMsg("The se language is not Correct. Check The traduction");
	...
	case "si":  //by SpEkTr
try{
		aLangBuildings = ["", "Gozdar", "Glinokop", "Rudnik železa", "Žitno polje", "Žaga", "Opekarna", "Talilnica železa", "Mlin", "Pekarna", "Skladišce", "Žitnica", "Izdelovalec orožja", "Izdelovalec oklepov", "Vadbišce", "Gradbeni ceh", "Zbirališce", "Tržnica", "Ambasada", "Barake", "Konjušnica", "Izdelovalec oblegovalnih naprav", "Akademija", "� pranja", "Mestna hiša", "Rezidenca", "Palaca", "Zakladnica", "Trgovski center", "Velike barake", "Velika konjušnica", "Mestno obzidje", "Zemljen zid", "Palisada", "Kamnosek", "Brewery", "Postavljalec pasti", "Herojeva rezidenca", "Veliko skladišce", "Velika žitnica", "Wonder"];
...
aLangBuildings = ["", "Bûcherons", "Carrière de terre", "Mine de fer", "Ferme", "Scierie", "Usine de poteries", "Fonderie", "Moulin", "Boulangerie", "Dépôt de ressources", "Silo de céréales", "Armurerie", "Usine d'armures", "Place du tournoi", "Bâtiment principal", "Place de rassemblement", "Place du Marché", "Ambassade", "Caserne", "Ecurie", "Atelier", "Académie", "Cachette", "Hôtel de ville", "Résidence", "Palais", "Chambre du trésor", "Comptoir de commerce", "Grande caserne", "Grande écurie", "Mur d'enceinte", "Mur de terre", "Palissade", "Tailleur de pierre", "Brasserie", "Fabricant de pièges", "Manoir du héros", "Grand dépôt", "Grand silo", "Merveille du monde"]; 
		...
		aLangTroops[1] = ["Combattant au gourdin", "Combattant �  la lance", "Combattant �  la hache", "Eclaireur", "Paladin", "Cavalier teuton", "Bélier", "Catapulte", "Chef de tribu", "Colon", "Heros"];  //Teutons
		aLangTroops[2] = ["Phalange", "Combattant �  l'épée", "Eclaireur", "Eclair de Toutatis", "Cavalier druide", "Hédouin", "Bélier", "Catapulte de guerre", "Chef", "Colon", "Heros"];  //Gauls
}catch(Error){
...
function refreshTaskList(aTasks) {
	...
	for(var i = 0; i < aTasks.length; i++) {
		...
		if(bUseServerTime) {			
			...
			sTime = "<span style='color:#973C05; cursor:pointer;' id='ttq_tasktime_" +i+ "' title='Szerver idő.' ttq_taskid='" +i+ "' >" + sTime + "</span>";
		} else {  //local time
			var oDate = new Date( parseInt(aThisTask[1]) * 1000 );	
			var sTime = "<span style='color:black; cursor:pointer;' id='ttq_tasktime_" +i+ "' title='Helyi idő.' ttq_taskid='" +i+ "' >" + oDate.toLocaleString() + "</span>";
		}			
		...
		switch(aThisTask[0]) {
			...
			case "5": //send Ressource in a delayed time 
				...
				+ "<tr class=\"rbg\"><td colspan=4>" + t("Célállomás:") + listOfParams[4] + " "  + listOfParams[5] +  "|" + listOfParams[6] +"</td></tr>"
				+ "<tr class=\"nbr\">"					    
				...
				+"</tr>	"			
				+"</table>";
				sTaskMoreInfo = "Szállítandó nyersanyagok";
...
function makeHistoryRow(aTask, index, iServerTimeOffset) {
		...
		if(bUseServerTime && iServerTimeOffset != false) {			
			...
			var sTime = oDate.toGMTString();
			sTime = sTime.substring(0, sTime.length - 4);
			sTime = "<span style='color:#973C05; cursor:pointer;' id='ttq_history_tasktime_" +index+ "' title='Szerver idő.' ttq_taskid='" +index+ "' >" + sTime + "</span>";
		} else {  //local time
			var oDate = new Date( parseInt(aTask[1]) * 1000 );	
			var sTime = "<span style='color:black; cursor:pointer;' id='ttq_history_tasktime_" +index+ "' title='Helyi idő.' ttq_taskid='" +index+ "' >" + oDate.toLocaleString() + "</span>";
		}		
...
/**
	Permet de récupérer la réponse �  la deuxième requête et donc de savoir si les marchands
...
function handleTimerForm(oForm) {
		...
		// Calcule de la date de la tâche �  une date précise 
		if(at == '') {
