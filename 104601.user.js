...
lang_pl['Shining body armor']		= 'Blyszczaca zbroja';
lang_pl['Body armor']			= 'Kamizelka kuloodporna';
lang_pl['Nano Fiber Combat Jacket']	= 'Weglowa kamizelka ochronna';
...
lang_si['Shining body armor']		= 'SWAT neprebojni jopic';
lang_si['Body armor']			= 'Jopic Slovenske policije';
lang_si['Nano Fiber Combat Jacket']	= 'Nano fiber bojni jopic';
lang_si['Nomex plated armor']		= 'Nomex neprebojni jopic';
...
lang_cz['magic mushrooms'] 	= 'Houbicky';
lang_cz['hash']			= 'Hašiš';
lang_cz['lsd']			= 'LSD';
lang_cz['ghb']			= 'GHB';
...
lang_cz['Body armor']			= 'Celotelní zbroj';
...
lang_lt['Diaper']			= 'Sauskelnes';
lang_lt['Leather Jacket']		= 'Odinis švarkas';
lang_lt['Shining body armor']		= 'Blizgantys kuno šarvai';
lang_lt['Body armor']			= 'Kuno šarvai';
lang_lt['Nano Fiber Combat Jacket']	= 'Kovinis švarkas';	
lang_lt['Nomex plated armor']		= 'Faru apranga';
...
lang_el['weed']			= '???t?';
lang_el['painkillers']		= '?a?s?p??a';
lang_el['booze']		= '????p?e?µa';
lang_el['magic mushrooms'] 	= '?a??t???a';
lang_el['hash']			= '?as??';
lang_el['lsd']			= 'LSD';
lang_el['ghb']			= 'GHB';
lang_el['ecstacy']		= 'Ecstacy';
lang_el['opium']		= '?p??';
lang_el['amphetamine']		= '?µfetaµ??e?';
lang_el['cocaine']		= '???a???';
lang_el['special k']		= 'Sp?s?a? ?';
lang_el['morphine']		= '???f???';
lang_el['heroin']		= '????a';


lang_el['Diaper']			= '???a';
lang_el['Leather Jacket']		= '??ts??? µp??f??';
lang_el['Shining body armor']		= '?a??p??a a??a??? ?????a';
lang_el['Body armor']			= '??e??sfa??? ??????';
lang_el['Nano Fiber Combat Jacket']	= '?p??f?? µ???? µe ?a??-??e?';
lang_el['Nomex plated armor']		= 'T?????s? Nomex';
...
lang_ru['Diaper']			= '?????????';
lang_ru['Leather Jacket']		= '???????? ??????';
lang_ru['Shining body armor']		= '????????? ??????????';
lang_ru['Body armor']			= '??????????';
lang_ru['Nano Fiber Combat Jacket']	= '?????????? ??????';
lang_ru['Nomex plated armor']		= '????? ?????';
...
lang_tr['Shining body armor']		= 'Parlak Zirh';
lang_tr['Body armor']			= 'Kursun Geçirmez Yelek';
lang_tr['Nano Fiber Combat Jacket']	= 'Nano Fiber Savas Ceketi';
lang_tr['Nomex plated armor']		= 'Nomex kapli zirh';
...
lang_lv['booze']		= 'Šnabis';
lang_lv['magic mushrooms'] 	= 'Magiskas senes';
lang_lv['hash']			= 'Hašs';
lang_lv['lsd']			= 'LSD';
lang_lv['ghb']			= 'GHB';
lang_lv['ecstacy']		= 'Ekstazi tabletes';
lang_lv['opium']		= 'Opijs';
lang_lv['amphetamine']		= 'Amfetamins';
lang_lv['cocaine']		= 'Kokains';
lang_lv['special k']		= 'Specialais K';
lang_lv['morphine']		= 'Vitja';
lang_lv['heroin']		= 'Heroins';


lang_lv['Diaper']			= 'Autini';
lang_lv['Leather Jacket']		= 'Adas jaka';
lang_lv['Shining body armor']		= 'Spidošas kermena brunas';
lang_lv['Body armor']			= 'Kermena brunas';
lang_lv['Nano Fiber Combat Jacket']	= 'Nano škiedru kaujas jaka';
lang_lv['Nomex plated armor']		= 'Nomex plakšnu brunas';
...
lang_sk['booze']		= 'Chlast';
lang_sk['magic mushrooms'] 	= 'Halucinogénne hubicky';
lang_sk['hash']			= 'Hašiš';
lang_sk['lsd']			= 'LSD';
lang_sk['ghb']			= 'GHB';
...
lang_cs['booze']		= 'Pivo';
lang_cs['magic mushrooms'] 	= 'Magicne pecurke';
lang_cs['hash']			= 'Hašiš';
lang_cs['lsd']			= 'LSD';
lang_cs['ghb']			= 'GHB';
...
lang_bg['Diaper']			= '???????';
lang_bg['Leather Jacket']		= '?????? ???';
lang_bg['Shining body armor']		= '??????? ?????';
lang_bg['Body armor']			= '????????????';
lang_bg['Nano Fiber Combat Jacket']	= '???????????? ????? ???';
lang_bg['Nomex plated armor']		= '???? ??????';
   	...
   	this.insertPowerIntoPage = function(profile) {
		...
		if (! menuTableEntries[4]) return null;
      		...
      		var tdSolo = document.importNode(menuTableEntries[4].rows[0].childNodes[1],false);
                tdButton.setAttribute("class","text-align: right; padding-top: 10px;");
		tdButton.innerHTML = '<p>&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;<a href="/robbery.php">===RAMPOK===</a><p>------------------------------<p><a href="/drugdealer.php">=DRUGDEALER=</a>&nbsp;&nbsp;<a href="/equipment.php?section=armours">=RESET=</a><br><a href="/nightlife.php">==DUGEM==</a>&nbsp;&nbsp;<a href="/den.php">==DUKUN==</a><br><a href="/thesquare.php">==PUSKOT=</a><a href="/bank.php">=BANK==</a><br><a href="/armsdealer.php">==WEAPON=</a><a href="/armsdealer.php?section=armors&sub=0">=ARMOR==</a><br><a href="/gangcenter.php">=GENK=</a>&nbsp;&nbsp;<a href="/assault.php">=HAJAR=</a><br><a href="/friends.php">=TEMAN=</a>&nbsp;&nbsp;<a href="/armsdealer.php?section=repair&sub=3">=REPAIR=</a><br><a href="/buildings.php">=GEDUNG=</a>&nbsp;&nbsp;<a href="/hospital.php">=HOSPITAL=</a><br><a href="/msgcenter.php">=PESAN=</a>&nbsp;&nbsp;<a href="/stats.php?page=gangs">=STATGENK=</a><br><a href="/gangcenter.php?action=members&sub=1">=ADDGENK=</a>&nbsp;&nbsp;<a href="/training.php">=TRAINING=</a><br><a href="/businesses.php">=BISNIS=</a>&nbsp;&nbsp;<a href="/docks.php">=PELABUHAN=</a><br><font size="3" color="YELLOW"><b><blink>FOR GENK ROB</blink></b></font>';
...
*/
	...
	this.CheckIfMetadon = function(){
		...
		if (getElementsByClass('statusbox_ok')[0].getElementsByTagName('td')[1].textContent.match('uzaleznienie') == "uzaleznienie")
	...
	this.Operka = function(profile){	
   	...
   	this.populateDrugsValuesAtDealer = function (profile, language) {
		...
		trans = parseInt(getElementsByClass('infotext')[0].rows[0].cells[1].textContent.split('dzis')[1]);
