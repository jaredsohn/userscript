// ==UserScript==
// @name          Ajout de new smileys sur JeuxVideo.Com v0.5.1
// @namespace     Ajout de new smileys sur JeuxVideo.Com v0.5.1
// @description   Petite retouche par DJarkinian
...
var reg=new RegExp("(:hadoken:)", "g");
chaine=chaine.replace(reg,"<img border='0' src='http://wiki.jvflux.com/images/a/ae/hadoken.gif' />");

var reg=new RegExp("(:awesomenoel:)", "g");
chaine=chaine.replace(reg,"<img border='0' src='http://www.cislashack.com/images/awesomenoe.gif' />");

var reg=new RegExp("(:puddi:)", "g");
chaine=chaine.replace(reg,"<img border='0' src='http://www.cislashack.com/images/puddi.gif' />");
