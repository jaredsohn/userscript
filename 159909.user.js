// ==UserScript==
// @name        beautifulbux
// @namespace   beautifulbux
// @include     *://*beautifulbux.com/pages/clickads
// @include     *://*beautifulbux.com/pages/clickadsproc*
...
if(wparent.location.href.indexOf('pages/clickads') != -1 && wparent.location.href.indexOf('pages/clickadsproc') == -1){
	...
	$.each($('.clickads_wrapper1'),function(k,v){
    if($(v).attr('style').indexOf('opacity')>=0){
      $(v).remove()
    }
  })
