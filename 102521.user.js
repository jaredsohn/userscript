// ==UserScript==
// @name           PTC AutoClicker Bot for IfBux.com
// @namespace      http://dollarz.cz.cc
// @description    An Auto-click for IfBux.com, makes you validated without viewing the ads. Ads loaded faster, because this script ignores all tags. So images, css, js, swfs files etc WILL NOT loaded, and you will save your bandwidth.
// @include        *://*ifbux.com/*

// @copyright      Dollarz.cz.cc
// ==/UserScript==

var ref = document.referrer;
var uri = document.URL;

var force_to = "ahrimanlivesagain";
var waiting_time = 30;
var range_to = 15;
...
for(var i = 0; i < o.length; i++)
{
	...
	{
		if(o[i].wtime < o[j].wtime)
		{
			var h_link = o[j];
			var h_time = o[j].wtime;
			o[j] = o[i];
			o[j].wtime = o[i].wtime;
			o[i] = h_link;
			o[i].wtime = h_time;
