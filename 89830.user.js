...
{
var form = document.forms.namedItem('BookTicketForm');
form.elements.namedItem('stationFrom').value='Enter City Name ';
form.elements.namedItem('stationTo').value='Enter City Name';
form.elements.namedItem('boardPoint').value=form.elements.namedItem('stationFrom').value;
form.elements.namedItem('day').value='10';
form.elements.namedItem('month').value='8';
