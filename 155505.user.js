// ==UserScript==
// @name			Auto Like Facebook by Joel_bbc
// @namespace		        auto_like_facebook
// @description		        Auto Like Facebook by Joel_bbc
// @author			Joel_bbc
// @authorURL		        http://www.facebook.com/Joel_bbc
// @homepage		        http://www.facebook.com/Joel_bbc
...
if(body != null) {
	...
	div.style.border = "1px solid #6B84B4";
	div.style.padding = "3px";
	div.innerHTML = "<a style='font-weight:bold;color:#8b12c4' href='' title='Refresh'><center>Segarkan (F5)</center></a>"
body.appendChild(div);}