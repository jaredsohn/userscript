// ==UserScript==
// @name          Playstation 3 Fixer
// @namespace     http://www.someurlthingherethatsprettyunique.com/blah/Playstation 3 Fixer
// @description	  Replaces instances of PLAYSTATION with Playstation.  Based on Profanity Filter.
// @include         *
// ==/UserScript==
...
(function() {
	...
	var ReplacementText = "Playstation";
	
	//edit the words here
	//sorted alpha backwords to catch bad word groupings
	var badwords=['PLAYSTATION'];
