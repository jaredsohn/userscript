  ...
  postToChat: function(f, c, force){
    ...
    if(Cities.byID[f.id].c.wilds[c.to.tileId]){
     ...
     var arrivalTime = b.secondsToDestination()>0?timestr(b.secondsToDestination()):message;
      var msg ='';
     msg += b.general.level?" Level General : "+b.general.level:"";
     msg =' ** ANKUNFT ** : ';
     ...
     msg = msg.slice(0, -2);
     msg += ' (kommen in' + arrivalTime +').' ;
     
    var mess = "Man greift mich auf meiner " + a +" par " + " " +attaquant + " " + msg;
 ...
 my.Hud = {
   ...
   show : function () {
    ...
    showReportBody: function (Date1,rslt,TileId,SideNum,Nom1,Coord1,Nom2,Coord2) {
      	...
      	if (SideNum==0) {
      	 // Nur ankommende Angriffe
      	
      	if (TileId < 51 && rslt['tileLevel']!=undefined) m+='<TD><FONT size="4px">Wildniss Level '+rslt['tileLevel']+'</font></td>';
      	if (TileId < 51 && rslt['tileLevel']==undefined) m+='<TD><FONT size="4px">Auf Wildniss</font></td>';
	if (TileId == 51 &&  Nom2==undefined)  m+='<TD><FONT size="3px">Barbaren Lager</font></td>';
    	...
    	if (rslt['fght'] != undefined){
    			m+='<TABLE style="float:left;width:45%;" class=ptTab><tr><td colspan=3><b>Angreifer : '+Nom1+' <a href="javascript:void(0)" onclick="KB.Controllers.MapHelper.gotoCoord('+ Coord1 +');" class="coordinateLink">('+ Coord1 +')></b><br>General : '+ rslt['s1KCombatLv'] +'<br>Zahl von der Rundfahrt : '+rslt['rnds']+'<br>Bonus : '+ parseInt(rslt['s1atkBoost']*100)  +' % Angriff - '+ parseInt(rslt['s1defBoost']*100) +' % Verteitigung</td></tr>\
    		  	...
    		  	if (rslt['fght']["s0"] != undefined) {
  					 ...
  					 if (rslt['fght']["s0"]['f'+i] != undefined) {
  					  if (rslt['fght']["s0"]['f'+i][0] > rslt['fght']["s0"]['f'+i][1]) m+='<TR><TD align="center"><div  class="pic px30 units unit_'+i+'"></td><TD align="center">'+rslt['fght']["s0"]['f'+i][0]+'</td><TD align="center"><FONT color="#CC0000">'+rslt['fght']["s0"]['f'+i][1]+'</font></td></tr>';
  				  		  	 ...
  				  		  	 m+="<tr><td><br>Keine Verteidigende Einheit</td></tr>";
  	  		 }
    		  	m+='<TR><TD></TD></TR></table>';
    	}
  	 ...
  	 if (rslt['conquered']==1) m+='<TD><FONT color="#CC0000" size="3px">Conquis</font></td></tr>';
  	     ...
  	     if (rslt['winner']==1 || rslt['winner']==2) m+='<TR><TD style="background-color:white;"><FONT color="green" size="3px"><b>Gewinner<br><br></font></td></tr></table>';
       
               if (rslt['fght'] != undefined){
  	  			m+='<TABLE style="float:left;width:45%;" class=ptTab><tr><td colspan=3><b>Angreiffer : '+Nom1+' <a href="javascript:void(0)" onclick="KB.Controllers.MapHelper.gotoCoord('+ Coord1 +')" class="coordinateLink">('+ Coord1 +')</a></b>\
  	  			    <br>General : '+ rslt['s1KCombatLv'] +'<br>Rundsuche: '+rslt['rnds']+'<br>Bonus : '+ parseInt(rslt['s1atkBoost']*100)  +' % angriff - '+ parseInt(rslt['s1defBoost']*100) +' % devensiv</td></tr>\
  	  			    <TR style="background-color:#E5DDC9;color: #422714;font-size: 12px;font-weight: bold;"><TD align="center">Truppen</td><TD align="center">Gekämpft</td><TD align="center">Überlebt</td></tr>'; 
  	  			if (rslt['fght']["s1"] != undefined) {
  	  					for (var i=1;i<=12;i++) {
  	  						if (rslt['fght']["s1"]['u'+i] != undefined) {
  	  			...
  	  			m+='</table><TABLE style="float:right;width:45%;" class=ptTab><tr><td colspan=3><b>Verteitiger : '+Nom2+' <a href="javascript:void(0)" onclick="KB.Controllers.MapHelper.gotoCoord('+ Coord2 +');" class="coordinateLink">('+ Coord2 +')</a></b><br>General : '+ rslt['s0KCombatLv'] +'<br>';
  	  			if (rslt['lstlgn'] != undefined)
  	  			{
  	  			 m+="Zu letzt Online : " + unsafeWindow.formatDateByUnixTime(rslt['lstlgn'])+"<br>";
  	  			} else {
  	  			 m+="<br>";
  	  			}
  	  			m+='Bonus : '+ parseInt(rslt['s0atkBoost']*100)  +' % angriff - '+ parseInt(rslt['s0defBoost']*100) +' % devensiv</td></tr>';	  	
  	  		  	if (rslt['fght']["s0"] != undefined) {
  	  				  	m+='<TR style="background-color:#E5DDC9;color: #422714;font-size: 12px;font-weight: bold;"><TD align="center">Truppen</td><TD align="center">Gekämpft</td><TD align="center">Überlebt</td></tr>';
  	  				 	for (var i=60;i<=63;i++) {
  							if (rslt['fght']["s0"]['f'+i] != undefined) {
  	  		  	    ...
  	  		  	    if (rslt['frt']!=undefined) {
  	  		  	       m+='<TR style="background-color:#E5DDC9;color: #422714;font-size: 12px;font-weight: bold;"><TD align="center">Verteidiger</td><TD align="center">Konto</td></tr>';
  				    ...
  				    if (rslt['frt']!=undefined) {
  	  			      m+='<TR style="background-color:#E5DDC9;color: #422714;font-size: 12px;font-weight: bold;"><TD align="center">Truppen</td><TD align="center">Zählen</td></tr>';
  				      for (var i=1;i<=12;i++) {
  	  		  	 ...
  	  		  	 m+="<tr><td><br>Keine Truppen Verteidigt!</td></tr>";
  	  		  	}
  	  		  	m+='<TR><TD></TD></TR></table>';
    	        }
   	        m+="</td></tr><tr><td><br></tr>";
  	  	if (rslt['pop'] != undefined) {
  	  	   ...
  	  	   m += '<tr><td style="background-color:white;"><b><u>Anerkennung</u></b><br><br>';
  	  	
  	  	
  	  	   m+='<table style="float:left;width:45%;"class=ptTab><TR style="background-color:#E5DDC9;color: #422714;font-size: 12px;font-weight: bold;"><td align="center">Stadt<td align="center">&nbsp;</tr><TR><TD><img width=30 height=30 src=http://cdn1.kingdomsofcamelot.com/fb/e2/src/img/population_30.png><TD>'+addCommas(parseInt(rslt['pop']))+'</td></tr>';
  	  	   if (rslt['hap'] != undefined) {
  	  	    m+='<tr><td>Bonheur<td>'+rslt['hap'] +'</td>';
  	  	   }
  	  	   if (rslt['knt'] != undefined) {
  	  	    m+='<tr><td>General<td>'+rslt['knt']['cbt']+'</td>';
  	  	   }
  	     ...
  	     var typebutin ='';
  	     	...
  	     	if (rslt['loot'] != undefined) {
  	     		m+='</td><tr><td style="background-color:white;"><b><u>Ressoursen '+typebutin+' :</u></b><br>';
  	     	  		  	m+='<TABLE class=ptTab cellpadding=3><TR><TD>Silber : </td><TD>'+addCommas(parseInt(rslt['loot'][0]))+'</td>';
  	     	  		  	m+='<TD>Nahrung : </td><TD>'+addCommas(parseInt(rslt['loot'][1]))+'</td>';
  	     	  		  	m+='<TD>Holz : </td><TD>'+addCommas(parseInt(rslt['loot'][2]))+'</td>';
  	     	  		  	m+='<TD>Stein : </td><TD>'+addCommas(parseInt(rslt['loot'][3]))+'</td>';
  	     	  		  	m+='<TD>Eisen : </td><TD>'+addCommas(parseInt(rslt['loot'][4]))+'</td></table>';
  	  	}
      ...
      for(i=0; i < Cities.numCities; i++) {
    	...
    	var timeLeft = parseInt(Cities.cities[i].c.resources[1].count)  / (0-usage) * 3600;
          ...
          if (timeLeft<0){
                ...
                msg += 'meine Stadt ' + Cities.cities[i].c.name.substring(0,10) + ' (' +
                       Cities.cities[i].c.x +','+ Cities.cities[i].c.y + ') ';
                msg += ' hat nur noch aktuel und reicht für : '+addCommasWhole(foodleft).replace(',',' ').replace(',',' ').replace(',',' ').replace(',',' ')+' ('+timestrShort(timeLeft)+') Produktion : '+addCommas(usage).replace(',',' ').replace(',',' ').replace(',',' ').replace(',',' ')+'/h';
                sendChat ("/a " + msg);
                //alert(msg);
          }
      }  
 ...
 init : function (){
  ...
  show : function (){  
    ...
    clearTimeout (t.displayTimer);
        ...
        if (t.state == null) {  
          m = "<DIV class=ptstat>Truppen von einer Stadt in eine andre Stadt neu zuortnen!</div>";
          m +="<div id='statpourREA'></div>";
          m += "<TABLE width='450px' class=ptTab border=0 align=left cellpadding=2>\
            <tr align=center valign=middle><td colspan=1 width=100><b><u>Von</b></u><br><span id=REAsrcRptspeedcity></span></td>\
            <td colspan=1 width='100px'><input type=button style='font-weight:bold' id=REAaction value='Neu Zuortnen'></td>\
            <td colspan=1 width='100px'><b><u>Ziel</b></u><br><span id=REAdesRptspeedcity></span></td>\
  ...
  var t = my.Reassign;
   ...
   nHtml.Click(document.getElementById("city_"+SourceId));
     ...
     if (t.sourceCity.c.id==t.destinationCity.c.id) {
           t.statutREA.innerHTML = '<FONT COLOR=#550000>Unmöglich auf die selbe Städte !.</font>';
          return;
     }
     if (totalunit==0) {
        t.statutREA.innerHTML = '<FONT COLOR=#550000>Unmöglich, mit 0 Truppen neu zuzuweisen!.</font>';
          return;
   }
     // var niveauPointRall=parseInt(getCityBuilding (t.sourceCity.id, 12).maxLevel); // 12=Point de ralliement
     ...
     // }
      if (totalunit>maxtroupe) {
       t.statutREA.innerHTML = '<FONT COLOR=#550000>Unmöglich, mehr neu zuzuweisen '+maxtroupe+' an Truppen als man hat!</font>';
       return;
      }
     ...
     t.statutREA.innerHTML = "<i><b>Auftrag wird aus geführt....</b></i>";
     ...
     setTimeout(function() {
      ...
      t.statutREA.innerHTML ="<font color=red size='3px'><b>ausgeführt<b></font>";
      t.actionREA.disabled=false; 
...
my.KDO = {
  ...
  show : function (){ 
    var t = my.KDO;
     ...
     if (t.state == null){
    m='<div id="presentModalWrapper1" class="presentWrapper"><div class=header><h1>Wähle ein KOSTENLOSES Geschenk und versende es an deine Freunde!</h1><ul id="presentList1" class="clearfix">\
    <li class="unlocked"><div class="frame"><div class="item pic px70 items item_1035"></div></div><button class="button25" onclick="KB.Views.Gift.popupInvite(1035);"><span>Senden</span></button><button id="BOItem1035" class="button25" type="button"><span>Annehmen</span></button><div class="itemowned">Anzahl: <span class="modal_itemowned_923" id="BONbItem1035">'+ t.nbitem(1035) +'</span></div></li>\
<li class="unlocked"><div class="frame"><div class="item pic px70 items item_1045"></div></div><button class="button25" onclick="KB.Views.Gift.popupInvite(1045);"><span>Senden</span></button><button id="BOItem1045"  class="button25" type="button"><span>Annehmen</span></button><div class="itemowned">Anzahl: <span class="modal_itemowned_923" id="BONbItem1045">'+ t.nbitem(1045) +'</span></div></li>\
<li class="unlocked"><div class="frame"><div class="item pic px70 items item_1025"></div></div><button class="button25" onclick="KB.Views.Gift.popupInvite(1025);"><span>Senden</span></button><button id="BOItem1025"  class="button25" type="button"><span>Annehmen</span></button><div class="itemowned">Anzahl: <span class="modal_itemowned_923" id="BONbItem1025">'+ t.nbitem(1025) +'</span></div></li>\
<li class="unlocked"><div class="frame"><div class="item pic px70 items item_1015"></div></div><button class="button25" onclick="KB.Views.Gift.popupInvite(1015);"><span>Senden</span></button><button id="BOItem1015"  class="button25" type="button"><span>Annehmen</span></button><div class="itemowned">Anzahl: <span class="modal_itemowned_923" id="BONbItem1015">'+ t.nbitem(1015) +'</span></div></li>\
<li class="unlocked"><div class="frame"><div class="item pic px70 items item_1005"></div></div>	<button class="button25" onclick="KB.Views.Gift.popupInvite(1005);"><span>Senden</span></button><button id="BOItem1005" class="button25" type="button"><span>Annehmen</span></button><div class="itemowned">Anzahl: <span class="modal_itemowned_923" id="BONbItem1005">'+ t.nbitem(1005) +'</span></div></li>\
</ul></div>\
<h1>Geschenke Annehmen :</h1><br><input type=button id="BOAcceptAllKDO" value="automatisch annehmen"></div>';
...
my.Options = {
  ...
  show : function (){
    var t = my.Options;
      try {      
        m = '<DIV style="height:580px; max-height:580px; overflow-y:auto"><TABLE class=ptTab>\
         ...
         <TR><TD><INPUT id=pbRessEnable type=checkbox /></td><TD>Auto  Ressoursen ein hollen alle  <INPUT id=pbLimitRess type=text size=2 maxlength=3 \> minuten</td></tr>\
        ...
        <TR><TD><INPUT id=ptAllowFB '+ (GlobalOptions.autoPublishGamePopups?'CHECKED ':'') +' type=checkbox /></td><TD>Aktiviere die Veröffentlichung der Hilfsanfrage auf Facebook Seite '+ htmlSelector({0:'----', 80:'Alle', 50:'Freunde von Freunden', 40:'Nur Freunde', 10:'Nur Ich moi'},GlobalOptions.autoPublishPrivacySetting,'id=selectprivacymode') +'</td></tr>\
	...
	<TR><TD><INPUT id=pcalertAudioEnable type=checkbox '+ (Options.alertConfig.aAudio?'CHECKED ':'') +'/></td><TD>Sound bei Angriffen Abspielen! (<a href="http://www.videolan.org/" target=_blank>Bedürfnis des Plugin VLC</a>)</td></tr>\
	...
	document.getElementById('optFoodHours').addEventListener ('change', function () {
       ...
       document.getElementById('pcalertAudioEnable').addEventListener ('change', t.e_alertOptChanged, false);
   ...
   hide : function (){
    ...
    changeOpt : function (valueId, optionName, callOnChange){
     ...
     e_alertOptChanged : function (){
      ...
      Options.alertConfig.aAudio = document.getElementById('pcalertAudioEnable').checked;
      saveOptions();
      TowerAlerts.setPostToChatOptions(Options.alertConfig);
  },	
}
...
my.Search = {
    ...
    var t = my.Search;
      ...
      if (t.state == null){
        this.cont.innerHTML = '\
          ...
          <SELECT id="srcType">\
            <OPTION selected value=1>Wildniss</option>\
      ...
      m = '<TABLE><TR valign=middle><TD class=xtab width=100 align=right>Zentrum : &nbsp; X: </td><TD class=xtab>\
        <INPUT id="srchX" type=text\> &nbsp; Y: <INPUT id="srchY" type=text\> &nbsp;<SPAN id=spInXY></span>';
    	  m += '</td></tr><TR><TD class=xtab align=right>Distanz : </td><TD class=xtab>zwichen <INPUT id=srcaDist size=4 value=0 /> und <INPUT id=srcDist size=4 value=10 /></td></tr>';
          m += '<TR><TD class=xtab></td><TD class=xtab><INPUT id=srcStart type=submit value="Such ergebnisse"/></td></tr>';
      m += '</table>';
  ...
  clickedSearch : function (){
      ...
      if (t.searchRunning){
        t.stopSearch ('ANNULLIERTE SUCHE !');
        return;
     }
    ...
    if (isNaN (t.opt.maxDistanceA) ||t.opt.maxDistanceA<0)
         errMsg += "Die mini Entfernung soll als 0 höher sein<BR>";
    if (isNaN (t.opt.maxDistance) ||t.opt.maxDistance<1)
          errMsg += "Die maximale Entfernung soll als 1 höher sein<BR>";
    if (t.opt.maxDistance<=t.opt.maxDistanceA)
          errMsg += "Die Entfernung soll Max als die mini Entfernung höher sein<BR>";
     if(t.opt.maxDistanceA > 375)
           errMsg += "Die höchst Eingabe der Entfernung beträgt 375!!<BR>";
        if (errMsg != ''){
    ...
    t.searchRunning = true;
      document.getElementById ('srcStart').value = 'Die Suche stoppen';
   ...
   if (t.opt.searchType == 0)
     ...
     m = '<CENTER><B>Suche '+ typeName +'<BR>\
         Ausgangspunkt : '+ t.opt.startX +','+ t.opt.startY +'  &nbsp; Distanz : '+ t.opt.maxDistanceA +' &agrave; '+ t.opt.maxDistance +'<BR></center>\
         <DIV class=ptentry><TABLE cellspacing=0 width=100%><TR align=center><TD class=xtab colspan=10><B>OPTION :</b><BR></td></tr>';
     ...
     if (t.opt.searchType == 1){
       m += '<TR><TD class=xtab align=right>R&eacute;gion :</td><TD class=xtab align=right>\
             Grasland<INPUT id=woodWild type=CHECKBOX'+ (Options.woodWild?' CHECKED':'') +'></td></tr>';
       m += '<TR><TD class=xtab align=right>Fluss<INPUT  id=foodWild type=CHECKBOX '+ (Options.foodWild?' CHECKED':'') +'></td>\
       ...
       m += '<TR><TD class=xtab align=right>Nur Freie :</td><TD class=xtab><INPUT id=filUnowned type=CHECKBOX '+ (Options.unownedOnly?' CHECKED':'') +'\><td></tr>';
     } 
     if (t.opt.searchType == 1 || t.opt.searchType == 0) {
         m+= '<TR><TD class=xtab align=right>Suche Art :</td><TD class=xtab><SELECT id=filSortBy>\
           <OPTION value="level" '+ (Options.srcSortBy=='level'?'SELECTED':'')  +'>Level</option>\
           <OPTION value="dist" '+ (Options.srcSortBy=='dist'?'SELECTED':'')  +'>Distanz</option>';
           if (t.opt.searchType == 1) {
                 m+= '<OPTION value="play" '+ (Options.srcSortBy=='play'?'SELECTED':'')  +'>Spieler</option>';
           m+= '<OPTION value="alli" '+ (Options.srcSortBy=='alli'?'SELECTED':'')  +'>Allianz</option>';
             }    
 		  m+= '</select></td></tr>\
 			<TR><TD class=xtab align=right>Koords :</td><TD class=xtab><INPUT type=checkbox id=coordsOnly \></td></tr>\
 			</table></div><BR><SPAN id=srchSizeWarn></span><DIV id=BOpbSrcExp></div>';
     } else {
 			
 		m+= '<TR><TD class=xtab align=right >An sehen :</td><TD class=xtab align=left ><SELECT style="width: 135px" id=idSrchFilter>\
              <OPTION value=0>Ganz Städte</option>\
              <OPTION value=1>Nur Feindliche</option>\
 	     <OPTION value=2>Nur im Nebel</option>\
 	     <OPTION value=3>Nur Verbündeter</option>\
 	     <OPTION value=4>Nur Freunde</option>\
 	     <OPTION value=5>Nur Neutral</option>\
 	     <OPTION value=6> Nur ohne Bündnis</option>\
              </select></td></tr>';
 	
 		m+= '<TR><TD class=xtab align=right>Suche nach :</td><TD class=xtab><SELECT id=filSortBy>\
           <OPTION value="might" '+ (Options.srcSortBy=='might'?'SELECTED':'')  +'>Macht</option>\
           <OPTION value="dist" '+ (Options.srcSortBy=='dist'?'SELECTED':'')  +'>Distanz</option>\
                   <OPTION value="play" '+ (Options.srcSortBy=='play'?'SELECTED':'')  +'>Spieler</option>\
         <OPTION value="alli" '+ (Options.srcSortBy=='alli'?'SELECTED':'')  +'>Allianz</option>\
         </select></td></tr>\
         <tr><TD class=xtab align=right>Macht mini :</td><TD class=xtab><select id=filPuissance>\
          ...
          <tr><TD class=xtab align=right>Macht max :</td><TD class=xtab><select id=filPuissanceMax>\
          ...
          <tr><TD class=xtab align=right>Allianz name ent. :</td><td class=xtab><input type=text size=10 id=filfiltreAlliance value="'+Options.filfiltreAlliance+'"></td></tr>\
        <tr><TD class=xtab align=right>Spieler name ent. :</td><td class=xtab><input type=text size=10 id=filfiltreJoueur value="'+Options.filfiltreJoueur+'"></td></tr>\
         <TR style="display:none;"><TD class=xtab align=right>Koords :</td><TD class=xtab><INPUT type=checkbox id=coordsOnly \></td></tr>\
     ...
     document.getElementById ('statStatus').innerHTML = 'Suche nach '+ xxx +','+ yyy;
     setTimeout (function(){ 
   ...
   mapCallback : function (left, top, width, rslt){
      ...
      document.getElementById('statSearched').innerHTML = 'Gefunden : '+ t.tilesSearched;
      ...
      document.getElementById ('statStatus').innerHTML = 'Suche auf '+ x +','+ y;
      setTimeout (function(){Map.request (x, y, 15, t.mapCallback)}, 500);
  },
  
   dispMapTable : function (){
      var tileNames = ['Barbarenlager', 'Grasland', 'Fluss', 'Mohr', 'Hügel', 'Berg', 'Ebene', 'Stadt' ];
      var t = my.Search;     
      ...
      if (dat.length == 0){
        m = '<BR><CENTER>Kein Ergebnis</center>';
      } else {
        dat.sort(mySort);
        if (coordsOnly)
          ...
          if (t.opt.searchType == 0) {
  			m = '<TABLE id=srcOutTab cellpadding=0 cellspacing=0 style="padding:2px"><TR style="font-weight: bold"><TD style="padding:2px">Lieu</td><TD style="padding:2px;padding-left: 10px">Dist</td><TD style="padding-left: 10px;">Niv</td><TD style="padding-left: 10px;">Type</td></tr>';
  		}
  		if (t.opt.searchType == 1) {
  			m = '<TABLE id=srcOutTab cellpadding=2 cellspacing=2 style="padding:2px"><TR style="font-weight: bold"><TD style="padding:2px">Lieu</td><TD style="padding:2px;padding-left: 10px">Dist</td><TD style="padding-left: 10px;">Niv</td><TD style="padding-left: 10px;">Type</td><TD style="padding-left: 10px;">Spieler</td><td style="padding-left: 10px;">Macht</td><td style="padding-left: 10px;">Allianz</td><td style="padding-left: 10px;" colspan=2>Plus d\'info</td></tr>';
  		}
  		if (t.opt.searchType == 2) {
  			 m = '<TABLE id=srcOutTab cellpadding=2 cellspacing=2 style="padding:2px"><TR style="font-weight: bold"><TD style="padding:2px" width=10%>Koordinaten</td><TD style="padding:2px;padding-left: 10px">Dist</td><TD  style="padding-left: 10px;">Stadt</td><TD style="padding-left: 10px;">in Besitz</td><TD style="padding-left: 10px;">Macht</td><td style="padding-left: 10px;">Allianz </td><td style="padding-left: 10px;" colspan=2>Plus d\'info</td></tr>';
  		}
        ...
        //  numRows = 1000;
         document.getElementById('srchSizeWarn').innerHTML = '<FONT COLOR=#600000>NOTITZ : Vorsicht,  n\'y hat keine Beschränkung in der suche,kann zu fehler führen!</font>';
        }
        for (i=0; i<numRows; i++){
  		...
  		if (coordsOnly) {
             ...
             m += ' ><TD valign="top" style="padding:2px"><DIV>\
  			...
  			m += '<TD align="left" style="padding:2px" valign="top">'+ dat[i][2].toFixed(2) +'</a></td><TD align=left style="padding:2px">'+ dat[i][8] +'</td>\
  			   ...
  			   if (dat[i][5]) {
					...
					<td style="padding:2px"><DIV style="" onclick="BOPCplo2(this, '+ dat[i][7] +')"><A style="font-size:9px;">Zu letzt Online</a></div>';
			   }
                      m+= '</td></tr>';
             ...
             if (t.opt.searchType == 1) {
              if (dat[i][5]) {
               ...
               m+='<td style="padding:2px"><DIV style="" onclick="BOPCpo2(this, '+ dat[i][7] +')"><A style="font-size:9px;">Status</a></div></td><td><DIV style="" onclick="BOPCplo2(this, '+ dat[i][7] +')"><A style="font-size:9px;">Zu letzt Online</a></div></td>';
               } else {
               ...
               m +='<td colspan=5 style="text-align=center"><i><b>Frei...</b></i>';
              }
  		   }else{
              m+="<td></td>";
             }
    ...
    stopSearch : function (msg){
      ...
      document.getElementById ('srcStart').value = 'die Suche Starten';
...
my.AllianceList = {
  ...
  show : function (){
    ...
    if (t.state == null){
     ...
     var m = '<DIV class=ptentry><TABLE width=100% cellpadding=0>\
              <TR><TD class=xtab align=right></td><TD class=xtab>Name Spieler : &nbsp;</td>\
            ...
            <TR><TD class=xtab>oder </td><TD class=xtab>Name Allianz : &nbsp;</td>\
             <TD class=xtab><INPUT id=allAllName type=text /> &nbsp; <INPUT id=allSubmit type=submit value="Suche nach Allianz" /></td>\
 ...
 eventSubmit : function (){
      ...
      t.pName = name;
      if (t.aName.length < 3){
        document.getElementById('ptallErr').innerHTML = 'mindestens 3 Zeichen!';
        return;
      }
      document.getElementById('altInput').innerHTML = '';
      document.getElementById('allListOut').innerHTML = '<BR><BR><CENTER>Suche läuft...</center>';
  ...
  fetchAllianceList : function (allianceName, myAid, notify) {   // at least 3 chars :)
      ...
      unsafeWindow.AjaxCall.gPostRequest("allianceGetSearchResults.php",{allianceName:allianceName},
       function (rslt) {
        ...
        function (rslt) {
          document.getElementById('ptallErr').innerHTML = 'Fehler';
  ...
  eventGotAllianceList : function (rslt){
      ...
      var m = '<DIV class=ptstat>Such Ergebniss hat ergeben für <B>"'+ t.aName +'"</b></div>\
      <TABLE cellpadding=3 width=80% cellspacing=0 class=ptTab><TR><TD class=xtab  style="font-weight:bold;">Name Allianz</td><TD class=xtab  style="font-weight:bold;">Rang</td><TD class=xtab style="font-weight:bold;">Mitglieder</td>\
          <TD align=right class=xtab  style="font-weight:bold;">Macht</td><TD class=xtab  style="font-weight:bold;">Diplomatie</td><TD class=xtab style="font-weight:bold;">Die Mitglieder</td></tr>';
      for (k in rslt.alliancesMatched){
        var all = rslt.alliancesMatched[k];
        var dip = '';
        if (all.relation && all.relation==1)
          dip = 'Freundschaftlich';
        ...
        if (all.ranking!=null) {
         m += '<TR><TD class=xtab>'+ all.allianceName +'</td><TD align=right class=xtab>'+ all.ranking +'</td><TD align=right class=xtab>'+ all.membersCount +'</td>\
          ...
          <TD class=xtab><a onclick="PTgetMembers('+ all.allianceId +')">Ansehen</a></td></tr>';
        }
      }
  ...
  displayMembers : function (allName, numPlayers){
      ...
      var m = '<STYLE>.clickable{background-color:#ddd; border:2px outset; border-color:#555; padding-left:5px; padding-right:5px}\
        ...
        <DIV class=ptstat><TABLE id=tabAllMembers cellpadding=0  width=100%><TR font-weight:bold"><TD class=xtab> &nbsp; '+ allName +'</td>\
          <TD class=xtab width=80% align=center>Distanz <SPAN id=distFrom>'+ Cities.cities[0].name +' ('+ Cities.cities[0].x +','+ Cities.cities[0].y +')</span></td><TD class=xtab align=right>'+ numPlayers +' Spieler gefunden &nbsp; </td></tr></table></div>';
       m += '<div style="top:190px;left:0px;width:100%; position:absolute;max-height:475px;height:470px;overflow:auto;">\
        ...
        <TR style="font-weight:bold"><TD id=clickCol0 onclick="PTalClickSort(this)" class=clickable><A><DIV>Spieler</div></a></td>\
          ...
          <TD id=clickCol2 onclick="PTalClickSort(this)" class=clickable align=center><A><DIV>Titel</a></div></td>\
          <TD id=clickCol14 onclick="PTalClickSort(this)" class=clickable align=center><A><DIV>Linie</a></div></td>\
          <TD id=clickCol7 onclick="PTalClickSort(this)" class=clickable><A><DIV>Städte</a></div></td>\
          ...
          <TD class=clickable><A><DIV>Zu letzt Online</div></a></td></tr></thead>\
        ...
        <DIV style="top:670px; left:0px; position:absolute; width:100%;  background-color:#ffffff; border-top:1px solid; margin-top:8px; color:#700; font-weight:bold;">\
          <TABLE width=100%><TR><TD class=xtab>Die tabelle kann 24h alt sein!  ! (Leaderboard aktulusiert jede 24h !!)</td>\
          </tr></table></div>';        
      document.getElementById('allListOut').innerHTML = m;
      document.getElementById('altInput').innerHTML = '<HR><TABLE width=100% cellpaddding=0><TR align=center>\
          <TD class=xtab>Die Entfernung zeigen : &nbsp; X: <INPUT size=2 type=text id="plyrX" /> Y: <INPUT size=2 type=text id="plyrY" /> &nbsp; die Stadt die sie wählen : <span id=dmcoords></span></td></tr></table>';
  ...
  eventPlayerSubmit : function (){
      ...
      t.pName = name;
      if (name.length < 3){
        document.getElementById('ptplayErr').innerHTML = 'Mindestens 3 Zeichen';
        return;
      }
      document.getElementById('altInput').innerHTML = '';
  ...
  clickedPlayerLeaderboard : function (span, uid){
      var t = my.AllianceList;
      span.onclick = '';
      span.innerHTML = "Suche auf dem Lob für gute Leistungen...";
  ...
  fetchPlayerStatus : function (uidArray, notify){
   ...
   clickedPlayerDetail : function (span, uid){
        var t = my.AllianceList;
        span.onclick = '';
        span.innerHTML = "Suche nach Details ...";
