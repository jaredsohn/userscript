// ==UserScript==
// @name			Ask.fm Auto Like by Eselnahu
...
if(body != null) {
	...
	div.innerHTML = "<div style='background-color: #ff0000; color: #FFFFFF; border: 1px solid #fff000;'><center><a style='color: #fff000;' <a href='http://www.facebook.com/nahuel.1233' target='_blank' title=''>Meu Facebook</a></div>"
	...
	div2.innerHTML = "<div style='background-color: #ff0000; color: #FFF000; border: 1px solid #fff000;'><a style='color: #FFF000;' onclick='spoiler()' title='Click Para Ocultar'>&laquo;</a> &#8226; <a href='http://ask.fm/NahuelitDelCap' title='Preguntame :)' style='color: #FFF000;' onclick='alert(\'Thanks for install this script\');'>Ask NahuelitDelCap</a></div> "
	...
	for(i=1;i<=20;i++) {
		...
		div2.innerHTML = "<a onclick='spoiler()' title='Mostrar :) Mi Ask Cara de goma'>&laquo;</a> &#8226; <a href='http://ask.fm/NahuelitDelCap' title=''>Preguntame!</a>"
		}
		else {
