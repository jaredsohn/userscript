// ==UserScript==
// @name           Bandenprofil Extra (Apr.2010)  für Pennergame 4.0 HH B und M from Olixx
// @namespace      from Olixx 
// @description    Zeigt alles wichtige bei euren Gegnern im Bandenprofil an - Zeigt Premiumtiere, Premiumplayer und gelöschte Penner an 
...
GM_xmlhttpRequest({
 ...
 url: ''+link+'/dev/api/user.'+id+'.xml',
        ...
        newtd = newtr.appendChild(document.createElement('td'));
        newtd.setAttribute('style', 'font-weight:bold;text-decoration:underline;text-align:center;width:200px;');
...
if(hausi2 == ''+statics+'shop/de_DE/tiere/94826.jpg'){var petname = 'Elefant';}
      ...
      else if(hausi2 == ''+statics+'shop/de_DE/tiere/43703.jpg'){var petname = 'Tiger';}
      else if(hausi2 == ''+statics+'shop/de_DE/tiere/73953.jpg'){var petname = 'Krokodil';}
      else if(hausi2 == ''+statics+'shop/de_DE/tiere/98962.jpg'){var petname  = "Giraffe";}
      ...
      else if(hausi2 == ''+statics+'shop/de_DE/tiere/73735.jpg'){var petname  = "Katze";}
      ...
      else if(hausi2 == ''+statics+'shop/de_DE/tiere/73684.jpg'){var petname  = "Ratte";}
      ...
      else if(hausi2 == ''+statics+'shop/de_DE/tiere/00001.jpg'){var petname  = "Kakerlake";}
      ...
      else if(hausi2 == ''+statics+'shop/bl_DE/tiere/65384.jpg'){var petname  = "Bisamratte";}
      ...
      else if(hausi2 == ''+statics+'shop/bl_DE/tiere/28463.jpg'){var petname  = "Retriever";}
      ...
      else if(hausi2 == ''+statics+'shop/bl_DE/tiere/13323.jpg'){var petname  = "Riesenschildkr&ouml;te";}
      ...
      else if(hausi2 == ''+statics+'shop/bl_DE/tiere/73933.jpg'){var petname  = "Maus (Geld)";}
      ...
      else if(hausi2 == ''+statics+'shop/mu_DE/tiere/73308.jpg'){var petname  = "Ratte";}
      ...
      else if(hausi2 == ''+statics+'shop/mu_DE/tiere/73735.jpg'){var petname  = "Katze";}
      ...
      else if(hausi2 == ''+statics+'shop/mu_DE/tiere/1337.jpg'){var petname  = "G&auml;mse";}
		else if(hausi2 == ''+statics+'shop/mu_DE/tiere/15240.jpg'){var petname  = "Facke";}
		else if(hausi2 == ''+statics+'shop/mu_DE/tiere/62456.jpg'){var petname  = "Bisamratte";}
		...
		else if(hausi2 == ''+statics+'shop/mu_DE/tiere/98962.jpg'){var petname  = "Giraffe";}
		else if(hausi2 == ''+statics+'shop/mu_DE/tiere/64220.jpg'){var petname  = "Seel&ouml;we";}
		else if(hausi2 == ''+statics+'shop/mu_DE/tiere/73953.jpg'){var petname  = "Krokodil";}
...
var suche = content.search("scht oder vom Spiel verbannt");
		try{
			if (suche != -1) {
				  var location3 = '<div><font style=\"font-size:100%;\"><b>Gel&ouml;scht oder vom Spiel verbannt!</b></font></div>';
		...
		}catch(e){var location3 = '<div><font style=\"font-size:100%;\"><b>Premiumprofiel!</b></font></div>';
}
