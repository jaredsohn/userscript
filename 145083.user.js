...
(function($){
	...
	'zh_tw':{
			'TITLE'					:'',
			'ABOUT'					:'',
			'BTN_ADD_ACCOUNT'		:' Facebook ',
			'BTN_EDT_ACCOUNT'		:' Facebook ',
			'BTN_CLS_ACCOUNT'		:' Facebook ',
			'BTN_EXPORT_ACCOUNT'	:' Facebook ',
			'BTN_IMPORT_ACCOUNT'	:' Facebook ',
			'BTN_SETTING'			:'',
			'BTN_OK'				:'',
			'BTN_CANCEL'			:'',
			'ALT_NAMENULL'			:'',
			...
			'LAB_DEL'				:'',
			'LAB_MOVE'				:'',
			'LAB_VERSION'			:'Facebook  %s ',
			'LAB_NEW_VERSION'		:'%s',
			'LAB_NEW_UPLOAD'		:'%s',
			'ALT_PLZ_KEYPASS'		:'%s',
			'ALT_PLZ_KEYNEWPASS'	:'%s',
			'ALT_PLZ_KEYNEWPASS2'	:'%s',
			'ALT_PASS_SETOVER'		:'%s',
			'ALT_PASS_DIFF'			:'%s',
			'ALT_ERROR'				:'%s',
			'LAB_NEW_UPDATA'		:'',
	        'LAB_CUSTOM_TITLE'      :'',
	        'LAB_USE_CUSTOM_TITLE'  :'',
	        'LAB_SHOW_NAME'         :''
		    },
	'zh_cn': {
			'TITLE'					:'',
