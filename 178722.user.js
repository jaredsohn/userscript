...
// @updateURL   https://userscripts.org/scripts/source/178722.meta.js
// @downloadURL https://userscripts.org/scripts/source/178722.user.js
// @description Through the way of replace SWF player to solve video advertising 
//              andhttp://userscripts.org/scripts/review/178722 black screen
// ==/UserScript==
...
(function() {
	...
	_players: null,
        ...
        get players() {
            if(!this._players) {
                this._players = {
			'youku': 'http://haoutil.googlecode.com/svn/trunk/player/testmod/loader.swf',
