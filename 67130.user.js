// ==UserScript==
// @name		eRepublik Plus in Spanish
// @versión		0.59
// @description	Simplifica las tareas comunes en eRepublik.
// @author		eCitizen CaMiLoSt14
// @namespace	eCitizenCaMiLoSt14
...
// ===============================================================================
// Este software es de donación. Sos bienvenido si querés donar GOLD in-game al
// autor de este script (algo choriado). La cantidad depende únicamente de vos, etc...
// El software se proporciona "TAL CUAL" y sin garantía alguna.
// Úsalo bajo tu responsabilidad. Y a los que no donan, que la chupen...
// ===============================================================================
...
var STRINGS = [	'Swap currencies',
				...
				'Tamaño',
				'Imagen',
				'Daño actual (completo)',
				'Sin armas',
				'Calidad de Arma ',
				'Noticias mas votadas',											//	10
				'Últimas noticias',
				'Noticias militares',
				'Entra por favor',
				'Links rápidos&nbsp;&nbsp;&nbsp;',
				'Traducir todos los comentarios a&nbsp;&nbsp;&nbsp;',
				'Mapa interactivo',
				'Nueva descripción',
				'"Herramientas Third Party" y "Páginas Nacionales y Foros"',
				'Calculador de vitalidad en tu Perfil',
				'Periódicos y Editor de Artículos del Foro',						//	20
				'Muestra la página del Entrenamiento con posibles daños de las diferentes calidades de armas',
				'Filtro del Marcado Laboral ',
				'Mercado monetario "monedas de intercambio" link',
				'Precio unitario de los productos y materias primas',
				'Enviar mensajes y/o ofrecer regalos en la página de Empleados',
				'Guardar Links&nbsp;&nbsp;&nbsp;',
				'Activado',
				'Desactivado',
				'Número de votos',
				...
				'Páginas nacionales y foros',
				'Herramientas eRep+',
				' (Todo) ',
				' Traducir ',
				'Calidad de hospitales en estados sociales',
				'Calculador para la siguiente Medalla "Súper Soldado"',
				'Entrenamientos para la siguiente medalla:\n',								//	40
				'Salarios y precios del mercado en GOLD',
				' Deshacer traducción',
				'Todas las donaciones',
				'Ofrecer un regalo',
				'Enviar mensaje',
				'No puedes darte un regalo a ti mismo.',
				'Luchas',
				'Estadísticas',
				'Estadísticas en Battle Page',
				'Plato\'s hat',												//	50
				'<br/>{0}%: <strong>{2}</strong> ({1} golds)',
				'Extender los combatientes del campo de batalla que se muestran:&nbsp;&nbsp;&nbsp;',
				'Links de "Guerras" en Mis Lugares y Training Grounds',
				'Guerras'
];

// Resources (images, strings, etc...)
var plusImage = '<img src="" style="position:relati\
...
function addThirdPartyTools() {
	var thirdPartyTools = [
		{aname: 'PeeKaBooh',	aid: '1408159',	name: 'eRepublik Plus Original',					url: BASE_URL + 'article/erepublik-plus-grand-tutorial-807662/1/20', img: 'http://static.erepublik.com/uploads/avatars/Newspapers/2009/05/15/81f97d040a2b499d539e0a7f61ce3788_55x55.jpg'},
...
function saveLink(obj, what) {
	...
	if (GM_getValue(cID + 'eR_QL') != undefined)
		...
		lLinks = ['Link 1', '', '', 'Link 2', '', '', 'Link 3', '', '', 'Link 4', '', '', 'Link 5', '', '', 'Link 6', '', '', 'Link 7', '', '', 'Link 8', '', '', 'Support eRep+', BASE_URL + 'citizen/donate/items/2285263', 'false', 'eRepublik Plus', BASE_URL + 'newspaper/erepublik-plus-187657/1', 'false'];
...
function getLink(index, what) {
	...
	if (GM_getValue(cID + 'eR_QL') != undefined)
		...
		lLinks = ['Link 1', '', '', 'Link 2', '', '', 'Link 3', '', '', 'Link 4', '', '', 'Link 5', '', '', 'Link 6', '', '', 'Link 7', '', '', 'Link 8', '', '', 'Soporte eRep+', BASE_URL + 'citizen/donate/items/2285263', 'false', 'eRepublik Plus', BASE_URL + 'newspaper/erepublik-plus-187657/1', 'false'];
