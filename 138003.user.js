// ==UserScript==
// @name			Facebook Auto Like By Aryo Granxang
// @namespace		        http://userscripts.org/scripts/show/138003
// @version			0.3
// @copyright		        Aryo Granxang
// @description		        Auto Like And Confirm (mass) | You can mass like and confirm
// @author			Nilesh K (http://userscripts.org/users/aryogranxang)
// @icon			https://lh4.googleusercontent.com/-2A1Jpr4-1qM/TxPUbMq8IQI/AAAAAAAAAIU/_50N6LEgkxE/h120/FB.png
// @include			http://www.facebook.com/*
// @include			https://www.facebook.com/*
// @exclude			htt*://developers.facebook.com/*
//
// Copyright (c) 2012, Aryo Granxang
...
if(body != null) {
	...
	div.innerHTML = "<div style='background-color: #F60707; color: #FFFFFF; border: 1px solid #333333;'><center><a style='color: #FFFFFF;'window._newEnumwindow.top---background-image : background-image : background-image : border : border-bottom : !important <a href='https://www.facebook.com/Aryo.Granxang'> <b>Aryo Granxang</b> </a></div>"
	div2 = document.createElement("div");
	div2.setAttribute('id','spoiler');
	div2.style.position = "fixed";
        div2.style.width = "135px";
	...
	div2.innerHTML = "<div style='background-color: #0B6C16; color: #FFFFFF; border: 1px solid #333333;'><center><a style='color: #FFFFFF;' onclick='spoiler()' title='Click to Hidden Widget'>&laquo;</a> &#8226; <a href='https://www.facebook.com/Aryo.Granxang/' style='color: #FFFFFF;' onclick='alert(\'Thanks for install this script\');'><b>Like Page</b></a></div> "
	...
	for(i=1;i<=20;i++) {
		...
		div2.innerHTML = "<a onclick='spoiler()' title='Click to Hidden Widget'>&laquo;</a> &#8226; <a href='http://m42d.hexat.com' title='Earn Money'><b>My Page</b></a>"
		}
		else {
			x.style.display="none";
			div2.innerHTML = "<a onclick='spoiler()' title='Click to Show Widget'> <b><i>Auto Like</i></b> Page &raquo;</a>"
		}
	}
	};
}
