// ==UserScript==
// @author		çlkokdslaşdşalsdmas
// @name        şasidlaişsdla
// @namespace  şlşllasldkaşlskd
// @version		0.0.2
// @uso:version 0.0.2
// @include		http://*erepublik.com/*/military/battlefield/*
// @description    dasdasssasdas
// ==/UserScript==
...
if(window.location.href.indexOf(PAGE_BATTLEFIELD) > 0) {	
	...
	/***********************************************************************************/
	var FORM_URL = "https://docs.google.com/spreadsheet/viewform?formkey=dENoVkZ2akx2eUUtMTlTUU9pNVRUdVE6MQ#gid=0";
	var FORM_FIELDS = {
                eday: "entry.0.single",
                name: "entry.2.single",
                round: "entry.4.single",
                damage: "entry.6.single",
                dq6hit: "entry.13.single",
	...
	var LOCALE = {
		...
		tr: function() {
			return {
				...
				send_report: "Rapor Gondermek Istiyor musunuz ?",
	...
	function BattlePage() {
        ...
        var dmg=parseInt($("#total_damage strong").text().replace(/[^\d.]/g, ""))+600; //innerHTML
        ...
        var data = {
                ...
                donate: "http://www.erepublik.com/en/citizen/profile/" + profileUrl.substr(profileUrl.lastIndexOf("/") + 1),
                round: 1,
                version: VERSION
        };
