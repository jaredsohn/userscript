// ==UserScript==
// @name            halit2 senin yaşın kaç
// @description     halit2 salak osman 5 :)
// @author          MrMage
...
if (document.URL.indexOf("game/index.php") > -1)
{
	...
	for (var i = 0; i < as.length; i ++)
	{
			...
			cur_a.parentNode.parentNode.tagName == 'DIV' && cur_a.parentNode.parentNode.parentNode.tagName == 'TD')
		{
			...
			drago_td.innerHTML = '<div align="center"><font color="#FF0000"><a target="_blank" href="http://www.stogame.net/Cr4Forum/index.php?lang=tr" style="color: white">Savas-Raporu</a></font></div>';
