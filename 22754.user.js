...
# // @name           Topic Poster
# // @author         N P
http://www.orkut.com/Profile.aspx?uid=10575856549310519715
# // @description    This script will Post same topic in all joined communities easily, You just need to enter captcha and press enter and it will post topic smoothly. Created by someone else and fixed by prakash.
# // @namespace      www.bestorkuteditor.blogspot.com
#   // @include        http://www.orkut.com/*
# // ==/UserScript==
#
# var subject = "latest Beat Tips using Orkut ";
# var msg = "b][red] all Tips & Tricks & hacking tools ---->www.bestorkuteditor.blogspot.com\n
# [green]all mobile hackes, cheats, cracked apzz ,free net ,clonnig sims--->www.bestorkuteditor.blogspot.com[/green]\n
# [maroon]all computer tweaks,hacks telnet, hacing gmail ,---->www.bestorkuteditor.blogspot.com\n
# [b][blue]Famous blog on hacking abt 1 lack visitors --->www.bestorkuteditor.blogpsot.com[/red][:D]\nhttp://www.orkut.com/Community.aspx?cmm=44443110"
#
#
#
#
...
#       else
#       {
#           alert("for al hacking trix.and hacking tools visit BESTORKUTEDITOR.BLOGSPOT.COM");
#       }
# }
# }, false);