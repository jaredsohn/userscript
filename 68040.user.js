...
var STRINGS = [	'Zamiana walut',
				...
				'Size',
				'Image',
				'Zadawane obrażenia (Max)',
				'Bare handed',
				'Jakość broni ',
				'Najlepiej oceniane wieści',											//	10
				'Najnowsze wieści',
				'Najnowsze wydarzenia',
				'Please enter ',
				'Szybkie linki&nbsp;&nbsp;&nbsp;',
				'Komentarze i artykuły tłumaczone na&nbsp;&nbsp;&nbsp;',
				'Mapa Interaktywna',
				'Dodatkowa informacja o przeglądanych wydarzeniach: najnowsze , najlepiej oceniane, wiadomości wojskowe',
				'"Dodatkowe narzędzia" i "Narodowe strony i fora"',
				'Kalkulator zdrowia na stronie \'Profil\'',
				'Edytor gazet i artykułów na forum',						//	20
				'Na stronie \'Szkolenia\' wyświetlane są zadawane obrażenia w zależności od posiadanej broni',
				'Ułatwione wyszukiwanie ofert pracy na stronie \'Rynek pracy\'',
				'Link "Zamiana walut" na stronie \'Rynek walutowy\'',
				'Wyświetlanie ceny jednostkowej produktów i surowców',
				'Wysyłanie wiadomości i/lub prezentów ze strony \'Firma - Szczegóły pracowników\'',
				'Szybkie linki&nbsp;&nbsp;&nbsp;',
				'Aktywne',
				'Nieaktywne',
				'Nr',
				...
				'Nowe okno',
				'Dodatkowe narzędzia',
				'Narodowe strony i fora',
				'Ustawienia Plus',
				' (Wszystkie) ',
				' Tłumacz ',
				'Wyświetlanie jakości szpitala w dziale \'Społeczeństwo\'',
				'Kalkulator następnego medalu \'Super Żołnierz\'',
				'Ilość treningów do następnego medalu:\n',								//	40
				'Przeliczanie wynagrodzeń i cen produktów rynkowych na Gold',
				' Cofnij tłumaczenie',
				'Wszystkie dotacje',
				'Wyślij prezent',
				'Wyślij wiadomość',
				'Nie możesz wysłać prezentu do siebie.',
				'Walki',
				'Statystyki',
				'Link do statystyk na stronie bitwy',
				'Czapka dla Platona (ten co daje podpowiedzi) - działała tylko w okresie świąt',												//	50
				'<br/>{0}%: <strong>{2}</strong> ({1} golds)',
				'Rozszerzenie pola walki: Ilość wyświetlanych walczących:&nbsp;&nbsp;&nbsp;',
				'Linki do Wojen w \'Moje miejsca\' i \'Szkolenie\'',
				'Wojny'
];
...
function addeRepPlusSettings() {
	...
	eRepPlusSettings.forEach(function(p) {
		...
		if (p.pos == 12) {
			htmlSettings += '<table class="offers"><thead><tr><th style="text-align: center;" width="40">Nr</th><th width="150">Nagłówek</th><th width="300">Link</th><th style="text-align: center" width="120">Nowe okno</th></tr></thead>';
			htmlSettings += '<tbody>';
			for (var i=1; i<=10; i++)
			{
		...
		if (p.pos == 10) {
			htmlSettings += '<input type="button" id="reset_saved_links" value="Resetuj szybkie linki" />';
		}
		htmlSettings += '</div>';
...
function addInteractiveMap() {
	...
	htmlMap += '<span class="vroundbtnh25-end"><span class="vroundbtnh25-core_large"> Mapa interaktywna </span></span></a>';
