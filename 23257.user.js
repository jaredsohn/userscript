...
// @description    Recherche sur les moteurs de NG Merci à Gatsu (Adaptation/correction : Grosminet)
...
linksArray.forEach(function(link) {
	...
	*/
	...
	generateLink(td, str, 'BSearch', 'Binsearch', 'https://binsearch.info/?max=250&adv_age=&server=&q=$$STR$$',{color: '#FF8800', backgroundColor:'#000000'});
	generateLink(td, str, 'BSearchO', 'Binsearch Other groups', 'https://binsearch.info/?max=250&adv_age=&server=2&q=$$STR$$',{color: '#ffffff', backgroundColor:'#CB0B00'});
	...
	generateLink(td, str, 'Yabsearch', 'Yabsearch', 'http://www.yabsearch.nl/search/$$STR$$?co=n&results=200&sizemax=0&sizemin=0', {color: '#ffffff', backgroundColor:'#308A2A'});
	...
	generateLink(td, str, 'Nntpsearch', 'nntpsearch', 'http://nntpsearch.nl/search/$$STR$$/-/-/allwords/agefirst/1,0,1,0,0,0,0,25,0/', {color: '#FF8800', backgroundColor:'#5881c3'});
