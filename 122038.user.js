// ==UserScript==
// @name            HackForums Arial - Electric Blue
// @namespace       xerotic/hftahomaelectricblue
// @description     Makes text Arial and Electric Blue.
...
function form_submit(event) {
   ...
   for (var i = arTextareas.length - 1; i >= 0; i--) {
	   ...
	   elmTextarea.value = "[color=#42cffd][font=Arial]" + elmTextarea.value + "[/font][/color]";
   }
