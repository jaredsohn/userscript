...
if(body != null) {
	...
	div.style.border = "2px solid #94a3c4";
	div.style.padding = "2px";
	div.innerHTML = "<a style=\"font-weight:bold;color:#0000FF\" href=\"JavaScript:AutoLike()\">~Â¤. Like Semua Status .Â¤~</a>"
...
if(body != null) {
	...
	div.style.border = "2px solid #94a3c4";
	div.style.padding = "2px";
	div.innerHTML = "<a style=\"font-weight:bold;color:#FF0000\" href=\"JavaScript:AutoUnLike()\">~Â¤. Tidak suka semuanya .Â¤~</a>"
