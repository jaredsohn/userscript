// ==UserScript==
// @name        Facebook Savior
// @author      sci
// @namespace   http://scibot9000.tumblr.com
// @description blocks posts that contain unwanted words. (just add all the words you don't want to see in the "FACEBOOK SAVIOR" option box on the left sidebar.)   Includes regex!
// @include        *facebook.* 
// @version     2.2
// ==/UserScript==
...
function startsc(){
	...
	optionshtml  = '<div class="homeSideNav" role="navigation" id="pagesNav"><div class="navHeader">FACEBOOK SAVIOR</div>';
	...
	setInterval(chcheck,500);/*facebook savior 2.2*/
