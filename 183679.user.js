// ==UserScript==
// @name          Basecamp Client Collapse (fork)
...
//Minor fork (markp) : 2013-11-21 : changed font colour to black to improve readability
...
for(var i = 0; i < clients.snapshotLength; i++) {
  ...
  client.style.color = "#000"; //Changed font colour from #666 (grey) to #000 (black)
