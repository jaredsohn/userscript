// ==UserScript==
// @name           LoU Suite (ES)
// @description    Various Helpers for Lord Of Ultima (LOU Suite 1.4.1 En Español)
  ...
  function createSuite() {
    ...
    qx.Class.define("louSuite.main", {
      ...
      members: {
        ...
        startScript: function() {
          ...
          btn.set({width: 20, appearance: "button-text-small", toolTipText: "Panel de LoU Suite"});
        ...
        getUnitName: function(id) {
          switch(id){
            case '1':
                return "Guardias de ciudad";
            case '2':
                return "Balistas";
            case '3':
                return "Soldados de asalto";
            case '4':
                return "Guardianes";
            case '5':
                return "Templarios";
    ...
    qx.Class.define("lou_suite.gui.DungeonRaider", {
      ...
      construct: function() {
        ...
        var columnNames = [ "Id", "Info", "Tipo", "Nivel", "Pos", "Ciudad", "Distancia", "Unidades", "Acciones"];
      ...
      members: {
        ...
        onTroopsSent: function (event, v) {
          ...
          switch (code) {
            ...
            case 4: // Not enough units
              message = "No hay suficientes unidades. Prueba a reescanear las ciudades.";
              break;
            case 64: // No more command slots
              message = "Se ha excedido el límite de comandos de la ciudad, usa una ciudad diferente.";
              break;
            default:
        ...
        _createToolBar: function() {
          ...
          var btnViewRegion = new qx.ui.form.Button("Ver región");
          ...
          this.btnUpdateView = new qx.ui.form.Button("Escanear");
          ...
          var btnRecount = new qx.ui.form.Button("Recuento de tropas");
    ...
    qx.Class.define("lou_suite.gui.BossRaider", {
      ...
      construct: function() {
        ...
        bos.gui.SummaryPage.call(this);
        this.setLabel("Planificador de Jefes");
        this.setLayout(new qx.ui.layout.VBox(10));
        this.add(this._createToolBar());    
        this._tableModel = new qx.ui.table.model.Simple();
        var columnNames = [ "Id", "Info", "Tipo", "Nivel", "Pos", "Ciudad", "Distancia", "Unidades", "Acciones"];
        ...
        onTroopsSent: function (event, v) {
          ...
          switch (code) {
            ...
            case 4: // Not enough units
              ...
              break;
            case 64: // No more command slots
              message = "Se ha excedido el número de órdenes de la ciudad, elige otra ciudad.";
              removeBoss = false;
              break;
            default:
