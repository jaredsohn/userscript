...
//
// ==UserScript==
// @name           balkje als premium tribalwars.nl w1,5,10
// @namespace      www.tribalwars.net @description    De vertaalde versie van de Engelse. Zal enkel werken op http://www.tribalwars.nl
// @include        http://nl1*.tribalwars.nl/*
// @include        http://nl5*.tribalwars.nl/*
// @include        http://nl10*.tribalwars.nl/*
// @version        2.0
// ==/UserScript==
...
newShortcut("http://ro5.triburile.ro/graphic/buildings/market.png", "/game.php?village="+VillId+"&screen=market", "Markt")	
	newShortcut("http://ro5.triburile.ro/graphic/buildings/storage.png", "/game.php?village="+VillId+"&screen=map", "Kaart");
tableIdIndex++;
	trIdIndex++;
}
