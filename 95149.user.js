// <![CDATA[
// ==UserScript==
// @name          YouTube High End
// @fullname      YouTube High End
// @description   Pengendali untuk YouTube Player
// @author        Rui Fujiwara
// @version       2011-1-20
// @licence       http://creativecommons.org/licenses/by-rui-fujiwara/3.0/
// @license       (CC) by-Rui-Fujiwara
// @namespace     http://userscripts.org/scripts/show/95149
// @include       http://userscripts.org/scripts/show/95149*
// @include       https://userscripts.org/scripts/show/95149*
...
+"------------------------------------------------------------"
+" This script is under Creative Commons 3.0 License by-Rui-Fujiwara "
+" http://creativecommons.org/licenses/by-Rui-Fujiwara/3.0/          "
+"                                                            "
+" The original name of this script is 'YouTube High End'     "
+" The original author of this script is 'Rui Fujiwara'              "
+" http://userscripts.org/scripts/show/95149                  "
+"------------------------------------------------------------";
...
,en:{lang:'English'
 ...
 //=== Options menu
 ,omenu:'Options'
 ,qual1:'1: Setel download dengan kualitas sama dengan video yang tampil'
 ,qual2:'2: Setel download dengan kualitas video (FLV or MP4)'
 ,qual3:'3: Setel download dengan kualitas MP4 kualitas terbaik'
 ,auto1:'1: Matikan mode putar otomatis'
 ,auto2:'2: Setel putar otomatis sebagai Buffering'
 ,auto3:'3: Setel mode putar otomatis'
 ,ytego:'You&#84;ube Enh&#97;nce&#114; General Options'
 //=== Quality Selector
 ,link0:'Tampilan dengan kualitas rendah (flv)'
 ,link1:'Tampilan dengan kualitas menengah (flv)'
 ,link2:'Tampilan dengan kualitas tinggh (flv)'
 ,link3:'Kualitas Menengah (mp4)'
 ,link4:'Versi Kualitas 720p (mp4)'
 ,link5:'Versi Kualitas 1080p HD (mp4)'
 ,link6:'Versi Kualitas Asli'
 //=== Media Resizer
 ...
 ,sYEUS:'YouTube High End Updater'
 ,gYEUI:'Check YouTube High End update every... (0=disabled)'
...
, es: { lang: 'Espa&#241;ol (1)' // By Juampi_yoel
  ...
  , sYEUS: 'YouTube High End Actualizador'
...
, es2: { lang: 'Espa&#241;ol (2)' // by ScorpioN48
  ...
  , ytego: 'Opciones Generales de YouTube High End'
  //=== Quality Selector
...
, fr: { lang: 'Fran&#231;ais'
  ...
  , sYEUS: 'YouTube High End Updater'
  , gYEUI: 'Tester la mise &#224; jour de YouTube High End tous les... (0=desactiv&#233;)'
  , hYEUI: 'entre 0 et 60'
...
, it: { lang: 'Italiano' // By Roccobot
  ...
  , ytego: 'Impostazioni di YouTube High End'
...
, pl: { lang: 'Polski' // by 'blindrood'
  ...
  , ytego: 'Opcje og&#243;lne YouTube High End'
  //=== Quality Selector
...
, ru: { lang: 'Pycc&#312;&#1080;&#1081;' // by ScriptMaker3
  , dlink: '&#1057;&#1082;&#1072;&#1095;&#1072;&#1090;&#1100;'
  , omenu: '&#1054;&#1087;&#1094;&#1080;&#1080;'
  , ytego: '&#1053;&#1072;&#1089;&#1090;&#1088;&#1086;&#1081;&#1082;&#1080; YouTube High End'
...
, sv: { lang: 'Svenska' // Johan Fredin (Komsip at userscripts.org) komsip@komsip.se
  ...
  , sYEUS: 'YouTube High End-uppdaterare'
  , gYEUI: 'Kolla efter uppdatering f&#246;r YouTube High End var... (0=inaktiverat)'
...
function googleWatch_CSS_remake() {
    ...
    +'.comment .metadata .author { position:absolute; top:4px; white-space:nowrap;margin-left:0px;margin-right:100%;overflow:visible;padding-bottom:0;font-weight:bold;}'
    +'.comment .metadata .time { position:absolute; top:4px; right:320px;white-space:nowrap; color:#999999; }'
    +'.comments-rating-positive,.comments-rating-negative {position:absolute;right:250px;top:1px;white-space:nowrap;}'
...
*** by: BY-attribution (Requirement to acknowledge or credit the author "Rui Fujiwara")                         ***
...
function main5() {
  ...
  if(getValue('HIDE_SCROLLBARS')) { GM_registerMenuCommand("YouTube High End - Show ScrollBar", function() { show_scrollbar(); } ); }
  GM_registerMenuCommand("YouTube High End - Rebind Media Controller", function() { mediacontrollermenu(); } );
