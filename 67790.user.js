...
//SMILEY
for(i=0;i<images.length;i++){if(images[i].src=="http://img1.nettby.no/img/smiley/smiley3.png")
{images[i].src="http://vampbea.devlishdesign.com/buttonz/2008/031108darksmileyhead3.png";}}

for(i=0;i<images.length;i++){if(images[i].src=="http://img1.nettby.no/img/smiley/smiley12.png")
{images[i].src="http://www.freesmileys.org/smileys/smiley-violent008.gif";}}

for(i=0;i<images.length;i++){if(images[i].src=="http://img1.nettby.no/img/smiley/smiley2.png")
{images[i].src="http://www.geocities.com/kloggirl/images/smileys/smiley3.gif";}}

for(i=0;i<images.length;i++){if(images[i].src=="http://img1.nettby.no/img/smiley/smiley4.png")
{images[i].src="http://vampbea.devlishdesign.com/buttonz/2008/031108darksmileyhead6.png";}}

for(i=0;i<images.length;i++){if(images[i].src=="http://img1.nettby.no/img/smiley/smiley5.png")
{images[i].src="http://vampbea.devlishdesign.com/buttonz/2008/031108darksmileyhead4.png";}}

for(i=0;i<images.length;i++){if(images[i].src=="http://img1.nettby.no/img/smiley/smiley1.png")
{images[i].src="http://k41.pbase.com/u35/saggiowrx/upload/23108296.lovesmiley083.gif";}}

for(i=0;i<images.length;i++){if(images[i].src=="http://img1.nettby.no/img/smiley/smiley9.png")
{images[i].src="http://planetsmilies.net/sign-smiley-520.gif";}}

for(i=0;i<images.length;i++){if(images[i].src=="http://img1.nettby.no/img/smiley/smiley17.png")
{images[i].src="http://cache.hyves-static.net/images/smilies/default/smiley_playing.gif";}}
...
for(i=0;i<links.length;i++) {
 if(links[i].innerHTML=="3r3") {
  links[i].innerHTML="Renate";
  links[i].style.color="#333333"; {
  }
 }
}
...
for(i=0;i<links.length;i++) {
 if(links[i].innerHTML=="Bilder av meg") {
  links[i].innerHTML="BILDER AV PELLEEEEE ;)";
  links[i].style.color="#333333"; {
  }
 }
}
...
for(i=0;i<links.length;i++) {
 if(links[i].innerHTML=="Ignorer") {
  links[i].innerHTML="Be di reis :D!";
  links[i].style.color="#333333"; {
  }
 }
}
...
for(i=0;i<links.length;i++) {
 if(links[i].innerHTML=="Debatter") {
  links[i].innerHTML="Politikergrejer";
  links[i].style.color="#333333"; {
  }
 }
}
...
for(i=0;i<links.length;i++) {
 if(links[i].innerHTML=="Skriv ny") {
  links[i].innerHTML="Skriv nye saker";
  links[i].style.color="#333333"; {
  }
 }
}
...
for(i=0;i<links.length;i++) {
 if(links[i].innerHTML=="Innboks") {
  links[i].innerHTML="Motatte brev";
  links[i].style.color="#333333"; {
  }
 }
}
...
for(i=0;i<links.length;i++) {
 if(links[i].innerHTML=="Status") {
  links[i].innerHTML="Den sosiale deln";
  links[i].style.color="#333333"; {
  }
 }
}
...
for(i=0;i<links.length;i++) {
 if(links[i].innerHTML=="Gjestebok") {
  links[i].innerHTML="Bok førr gjæstan";
  links[i].style.color="#333333"; {
  }
 }
}
...
for(i=0;i<links.length;i++) {
 if(links[i].innerHTML=="Arrangementer") {
  links[i].innerHTML="Teng som skjer";
  links[i].style.color="#333333"; {
  }
 }
}
...
for(i=0;i<links.length;i++) {
 if(links[i].innerHTML=="Besøk") {
  links[i].innerHTML="Fer på besøk";
  links[i].style.color="#333333"; {
  }
 }
}
...
for(i=0;i<links.length;i++) {
 if(links[i].innerHTML=="2 nye venner") {
  links[i].innerHTML="2 nye buddya!";
  links[i].style.color="#333333"; {
  }
 }
}
for(i=0;i<links.length;i++) {
 if(links[i].innerHTML=="Nettby Max") {
  links[i].innerHTML="FjortisPower!";
  links[i].style.color="#333333"; {
  }
 }
}
...
nick[i].outerHTML='PELLE MARIUS JENSEN!';
break;}}
...
anchor.appendChild( document.createTextNode( 'CrimZen V3' ) );
