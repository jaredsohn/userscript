            ...
            make_sharelink: function() {
                try {
                    ...
                    switch (city.get_CityFaction()) {
                        ...
                        case 3: /* FOR faction - unseen, but in GAMEDATA */
...
*/
                    ...
                    for (var i=0; i < 20; ++i) {
                        ...
                        for (var j=0; j < 9; ++j) {
                            ...
                            if (spot && spot.BuildingIndex >= 0) {
                                //building = city.m_CityBuildings.m_Buildings.l[spot.BuildingIndex];
                                building = buildings[spot.BuildingIndex];
                                //level = building.m_CurrentLevel;
                                level = building.DetailViewInfo.TechLevel;
                            }
                            ...
                            switch (i > 16 ? 0 : city.GetResourceType(j,i)) {
                                case 0:
                                    if (building) {
                                        var techId = building.DetailViewInfo.TechId;
        ...
        if (!webfrontend.gui.region.RegionCityMenu.prototype.__cncopt_real_showMenu) {
            webfrontend.gui.region.RegionCityMenu.prototype.__cncopt_real_showMenu = 
