// ==UserScript==
// @name            Platypus-underskog.no
// @namespace       Platypus
// @include         http://underskog.no/*
// @include         http://www.underskog.no/*
// ==/UserScript==
function do_platypus_script() {
do_modify_html_it(window.document,document.getElementById('user_menu'),/(\w+), din side/,'Velkommen, $1! Klikk her for å gå til din side.',null);
