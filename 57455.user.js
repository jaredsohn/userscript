// ==UserScript==
// @name           Feuerwache.net nextGen Ereglam's AAO/thafner AAO
...
// @require        121220.user.js
// @require        121239.user.js
...
// ==/UserScript==
var VERSION      = '1.3.03c';
versions['Feuerwache.net nextGen Ereglam\'s AAO'] = VERSION;
/* ******************************************************************************************
ACHTUNG
...
WENN DU DIESEN ABSCHNITT NICHT 100% VERSTANDEN UND BEFOLGT HAST, STELLE DAS GEÄNDERTE SCRIPT NICHT ONLINE!
   ******************************************************************************************/
var USERSCRIPTID = '57455'; // diese Konstante ist anzupassen
// unter welchem URL finde ich Infos über das Script?
var UPDATEURL="http://userscripts.org/scripts/show/"+USERSCRIPTID;
// unter welchem URL finde ich das Script als Installation?
var INSTALLURL="http://userscripts.org/scripts/source/"+USERSCRIPTID+".user.js";
// unter welchem URL finde ich die Metadaten zum Script?
var METAURL="http://userscripts.org/scripts/source/"+USERSCRIPTID+".meta.js";
...
*/
  ...
  //F1
  'Brennt Anhänger'                : {mld: 'F1'                          , storm: false, ab: {FW:  1}, wiki: 'Brennt_Anh%C3%A4nger'},
  ...
  'Feldbrand'                      : {mld: 'F1'                      , storm: false, ab: {FW:  1}, wiki: 'Feldbrand'},
  'Strohballen Brand'              : {mld: 'F1'                      , storm: false, ab: {FW:  1}, wiki: 'Strohballen_Brand'},
...
//F2
  ...
  'Baggerbrand'                    : {mld: 'F2'                          , storm: false, ab: {FW: 30}, wiki: 'Baggerbrand'},
  'Brennender Wohncontainer'       : {mld: 'F2'                          , storm: false, ab: {FW: 30}, wiki: 'Brennender_Wohncontainer'},
  'Brand im Telefonshop'       : {mld: 'F2'                              , storm: false, ab: {FW: 3}, wiki: 'Brand_im_Telefonshop'},    
  'Mähdrescherbrand'               : {mld: 'F2'                          , storm: false, ab: {FW:  5}, wiki: 'M%C3%A4hdrescherbrand'},
...
'Brennende Windmühle'              : {mld: 'F4'                         , storm: false, ab: {FW:  4}, wiki: 'Brennende_Windm%C3%BChle'},
...
//F4 Sonderfahrzeug
  ...
  'Brand in Brauerei'              : {mld: 'F4+GWA,GWL'                  , storm: false, ab: {FW: 11}, wiki: 'Brand_in_Brauerei'},
  'Gas-Explosion'                  : {mld: 'F4+RW'                       , storm: false, ab: {FW: 30}, wiki: 'Gas-Explosion'},
  'Brand nach Schweißarbeiten'     : {mld: 'F4+GWL'                      , storm: false, ab: {FW: 30}, wiki: 'Brand_nach_Schweißarbeiten'},
  'Brand in Polizeistation'        : {mld: 'F4+RW'                       , storm: false, ab: {FW: 20}, wiki: 'Brand_in_Polizeistation'},
...
//F5
  ...
  'Brand in Streichholzfabrik'     : {mld: 'F5'                          , storm: false, ab: {FW:  9}, wiki: 'Brand_in_Streichholzfabrik'},

//F5 Sonderfahrzeug
  'Kinobrand'                      : {mld: 'F5+GTLF'                     , storm: false, ab: {FW: 10}, wiki: 'Kinobrand'},
'Brand in Erholungsbad'            : {mld: 'F5+GWL'                      , storm: false, ab: {FW: 15}, wiki: 'Brand_in_Erholungsbad'}, 
 
//F6
  'Wohnblockbrand'                 : {mld: 'F6'                          , storm: false, ab: {FW: 45}, wiki: 'Wohnblockbrand'},

//F6 Sonderfahrzeug
  'Feuer in Bahnhofshalle'         : {mld: 'F6+GWL'                      , storm: false, ab: {FW: 65}, wiki: 'Feuer_in_Bahnhofshalle'},
...
//F12
 'Ausgedehnter Waldbrand'         : {mld: 'F12'                          , storm: false, ab: {FW: 20}, wiki: 'Ausgedehnter_Waldbrand'},

//F1GSG
  'Schuppenbrand'                  : {mld: 'F1'                          , storm: false, ab: {FW:  4}, wiki: 'Schuppenbrand'},
...
//F3GSG Sonderfahrzeug
  ...
  'Brand in Großwäscherei'         : {mld: 'F3GSG+GWA,DLK'               , storm: false, ab: {FW: 13}, wiki: 'Brand_in_Großwäscherei'},
  'Brand in Hotel'                 : {mld: 'F3GSG+RW,GTLF,GWA,GWL,DLK'      , storm: false, ab: {FW: 13}, wiki: 'Brand_in_Hotel'},
   'Möbelhausbrand'                 : {mld: 'F4+RW,GWL,GWM'                  , storm: false, ab: {BF: 10}, wiki: 'M%C3%B6belhausbrand'},

//F4GSG
  'Feuer im Krankenhaus'           : {mld: 'F4GSG'                       , storm: false, ab: {BF: 40}, wiki: 'Feuer_im_Krankenhaus'},
  'Großbrand in Zuckerfabrik'      : {mld: 'F4GSG'                       , storm: false, ab: {BF: 50}, wiki: 'Großbrand_in_Zuckerfabriks'},

//Feuer Flughafen
  'Brennendes Flugzeug'            : {mld: 'CrashAirport'                , storm: false, ab: {BF: 59}, wiki: 'Brennendes_Flugzeug'},
  'Brand im Tower'                 : {mld: 'F6'                          , storm: false, ab: {FW: 59}, wiki: 'Brand_im_Tower'},
  'Brand im Terminal'              : {mld: 'F6+GWM'                      , storm: false, ab: {FW: 59}, wiki: 'Brand_im_Terminal'},
  'Brand bei Flugzeugbetankung'    : {mld: 'F3+FLF,FLF,GWÖl,GWG,ELW'     , storm: false, ab: {FW: 59}, wiki: 'Brand_bei_Flugzeugbetankung'},

//Feuer Hafen
  'Rauchentwicklung in Kantine'    : {mld: 'F7+GTLF'            , storm: false, ab: {FW: 50}, wiki: 'Rauchentwicklung_in_Kantine'},
  'Feuer in Bootswerft'            : {mld: 'F7+GTLF,GWM'        , storm: false, ab: {FW: 60}, wiki: 'Feuer_in_Bootswerft'},
...
//BahnF1
  ...
  'Brand in Fahrkartenautomat'     : {mld: 'BahnF1'                          , storm: false, ab: {FW: 65}, wiki: 'Brand_in_Fahrkartenautomat'},

//BahnF2
  'Brennende Lokomotive'           : {mld: 'BahnF2'                          , storm: false, ab: {FW: 65}, wiki: 'Brennende_Lokomotive'},

//BahnF3
  'Brennender Güterzug'            : {mld: 'BahnF3GSG'                       , storm: false, ab: {FW: 65}, wiki: 'Brennender_G%C3%BCterzug'      },
  'Feuer im Personenzug'           : {mld: 'BahnF3+GTLF'                     , storm: false, ab: {FW: 65}, wiki: 'Feuer_im_Personenzug'},
'Feuer im Personenzug (Tunnel)'    : {mld: 'BahnF3+HLFS,HLFS'                , storm: false, ab: {FW: 65}, wiki: 'Feuer_im_Personenzug_(Tunnel)'},
  'Brennender Güterzug (Tunnel)'   : {mld: 'BahnF3GSG+HLFS,HLFS'             , storm: false, ab: {FW: 65}, wiki: 'Brennender_G%C3%BCterzug_(Tunnel)'      },

//BahnF4
  'Brennender Güterzug (Bahnhof)'  : {mld: 'BahnF4GSG'                       , storm: false, ab: {FW: 65}, wiki: 'Brennender_G%C3%BCterzug_(Bahnhof)'},
  'Feuer im Personenzug (Bahnhof)' : {mld: 'BahnF4'                          , storm: false, ab: {FW: 65}, wiki: 'Feuer_im_Personenzug_(Bahnhof)'},
...
//FB1
  ...
  'Brand Kreuzfahrtschiff'         : {mld: 'FB1+FLB'                         , storm: false, ab: {FW: 45}, onWater: true, wiki: 'Brand_Kreuzfahrtschiff'},

//Feuer Tagebau
 'Brennender Personenbus'         : {mld: 'F2'                          , storm: false, ab: {FW: 70}, wiki: 'Brennender_Personenbus'},
 'Brennender Muldenkipper'        : {mld: 'F2'                           , storm: false, ab: {FW: 70}, wiki: 'Brennender_Muldenkipper'},
 'Brennendes Förderband'          : {mld: 'F1'                           , storm: false, ab: {FW: 70}, wiki: 'Brennendes_F%C3%B6rderband'},

//Feuer MVA

 'Brand in Altpapier-Lager'       : {mld: 'F5GSG+GTLF'                   , storm: false, ab: {FW: 75}, wiki: 'Brand_in_Altpapier-Lager'},
 'Brand in Müll-Sortieranlage'    : {mld: 'F5GSG'                       , storm: false, ab: {FW: 75}, wiki: 'Brand_in_M%C3%BCll-Sortieranlage'},  
 'Brand in Müll-Bunker'           : {mld: 'F5GSG'                        , storm: false, ab: {FW: 75}, wiki: 'Brand_in_M%C3%BCll-Bunker'},
...
//TH1
  ...
  'Wassereinbruch'                 : {mld: 'TH1'                         , storm: false, ab: {FW: 30}, wiki: 'Wassereinbruch'},
...
//TH1 Sonderfahrzeug
 ...
 'Ölspur'                         : {mld: 'TH1+GWÖl'                     , storm: false, ab: {FW:  5}, wiki: '%C3%96lspur'},
  'Baum auf Auto'                  : {mld: 'TH1+RW'                          , storm: true,  ab: {FW:  9}, wiki: 'Baum_auf_Auto'},
...
'LKW in Brückengeländer'           : {mld: 'TH4+ELW,FwK'                  , storm: false, ab: {FW:  6}, wiki: 'LKW_in_Brückengel%C3%A4nder'},
  'Gerüsteinsturz'                 : {mld: 'TH4+ELW,LF,LF'                , storm: false, ab: {FW: 30}, wiki: 'Ger%C3%BCsteinsturz'},

//TH5 
  'VU mit Straßenbahn'             : {mld: 'TH5'                          , storm: false, ab: {FW: 20}, wiki: 'VU_mit_Strassenbahn'},

//TH6
  'Baukran auf Auto'               : {mld: 'TH6'                          , storm: false, ab: {FW: 15}, wiki: 'Baukran_auf_Auto '},
...
//BahnTH2
  ...
  'Güterzug entgleist (Tunnel)'    : {mld: 'BahnTH2+HLFS,HLFS,GWA'        , storm: false, ab: {FW: 65}, wiki: 'G%C3%BCterzug_entgleist_(Tunnel)'},

//BahnTH3
  'Güterzug entgleist (Bahnhof)'   : {mld: 'BahnTH3'                      , storm: false, ab: {FW: 65}, wiki: 'G%C3%BCterzug_entgleist_(Bahnhof)'},

//BahnTH4
  'Rangierunfall'                  : {mld: 'BahnTH4'                      , storm: false, ab: {FW: 65}, wiki: 'Rangierunfall'},
  'Unfall an Bahnübergang'         : {mld: 'BahnTH4'                      , storm: false, ab: {FW: 65}, wiki: 'Unfall_an_Bahn%C3%BCbergang'},

//Techniche Hilfeleistung Tagebau

'Tagebauarbeiter abgestürzt'     : {mld: 'TH20+RW,DLK'                    , storm: false, ab: {FW: 70}, wiki: 'Tagebauarbeiter_abgest%C3%BCrzt'},
  'Radlader umgekippt'             : {mld: 'TH21'                         , storm: false, ab: {FW: 70}, wiki: 'Radlader_umgekippt'},
  'Muldenkipper abgerutscht'       : {mld: 'TH20+FwK'                     , storm: false, ab: {FW: 70}, wiki: 'Muldenkipper_abgerutscht'},

//Techniche Hilfeleistung MVA

 'Kehrmaschine in Müllbunker'     : {mld: 'TH4+GWH'                           , storm: false, ab: {FW: 75}, wiki: 'Kehrmaschine_in_Müllbunker'},
...
//GSG2
  ...
  'Ammoniakaustritt in Eishalle'   : {mld: 'GSG2+LF,LF,GWA'               , storm: false, ab: {BF:  5}, wiki: 'Ammoniakaustritt_in_Eishalle'},
 'Gasaustritt in Fabrik'          : {mld: 'GSG2+DLK,GWL,LF'               , storm: false, ab: {BF: 20}, wiki: 'Gas-Explosion'},
...
//Gefahrengut Flughafen
  'Beschädigtes Frachtstück'       : {mld: 'GSG1'         , storm: false, ab: {FW: 59}, wiki: 'Beschaedigtes_Frachtstueck'},
...
*/
  ...
  'F11'      :  {txt: 'Feuer, Groß RLT',                 vhc: 'LF,LF,LF,LF/TS,DLK,GTLF,GWL,RW,ELW'},
  'F12'      :  {txt: 'Feuer, Groß L',                   vhc: 'LF,LF,LF,LF/TS,LF,LF,GWL,ELW'},
  ...
  'F5GSG'    :  {txt: 'Feuer, Groß GSG',                 vhc: 'LF,LF,LF,LF/TS,ELW,GWM,GWG,DLK,GWL,GWA'}, 

  'CrashAirport'    :  {txt: 'brennt Flugzeug',          vhc: 'FLF,FLF,FLF,FLF,FLF,FLF,FLF,FLF,RTr,ELW,GWG,GWM,RW,GWÖl'},

  'F1Raff'    :  {txt: 'Feuer, Raffinerie',              vhc: 'LF,LF,LF,LF,ULF,ULF,ULF,ULF,ELW,RW,GWÖl,TUIS'},
  'F2Raff'    :  {txt: 'Feuer, Raffinerie',              vhc: 'LF,LF,LF,LF,ULF,ULF,ULF,ULF,ELW,RW,GWÖl,TUIS,GTLF,GWL,GWM'},
  'F3Raff'    :  {txt: 'Feuer, Raffinerie',              vhc: 'LF,LF,LF,LF,ULF,ULF,ULF,ULF,ELW,RW,GWÖl,TUIS,GTLF,GWL,GWM,GWG,FwK,DLK'},
 
 'BahnF1'      :  {txt: 'Feuer, Bahn Klein',             vhc: 'LF/HLFS'},
 'BahnF2'      :  {txt: 'Feuer, Bahn',                   vhc: 'LF/HLFS,LF/HLFS,ELW,GWL'},
 'BahnF3'      :  {txt: 'Feuer, Bahn  Einsatz RTZ',      vhc: 'ELW,GWL'},
 'BahnF3GSG'   :  {txt: 'Feuer, Bahn  Einsatz RTZ',      vhc: 'ELW,GWG,GWM,GWL,TUIS'},
 'BahnF4'      :  {txt: 'Feuer, Bahnhof',                vhc: 'ELW,LF,LF,LF,LF,GWL,GTLF'},
 'BahnF4GSG'   :  {txt: 'Feuer, Bahnhof',                vhc: 'ELW,LF,LF,LF,LF,GWG,GWM,GWL,GTLF,TUIS'},


 'TH1'         :  {txt: 'TH Klein',                      vhc: 'LF/TS'},
 'TH2'         :  {txt: 'TH Klein',                      vhc: 'LF,LF/TS'},
 'TH3'         :  {txt: 'TH VU',                         vhc: 'LF/TS,RW,GWÖl'},
 'TH4'         :  {txt: 'TH DLK',                        vhc: 'LF/TS,RW,DLK'},
 'TH5'         :  {txt: 'TH Straßenbahn',                vhc: 'LF,LF,LF/TS,RW,GWS,FwK,ELW'},
 'TH6'         :  {txt: 'TH Kran',                       vhc: 'LF/TS,RW,FwK'},
 ...
 'BahnTH3'     :  {txt: 'TH, Bahnhof',                   vhc: 'ELW,LF,LF,LF,LF,GWG,GWM,RW,DLK,TUIS,GWS,FwK,GTLF'},
 'BahnTH4'     :  {txt: 'TH, Bahnhof',                   vhc: 'ELW,LF/HLFS,LF/HLFS,GWÖl,RW,GWS'},


 'TH20'        :  {txt: 'TH Höhenretter',                vhc: 'ELW,LF,LF/TS,GWH'},
 'TH21'        :  {txt: 'TH Tagebau 1',                  vhc: 'ELW,LF,LF/TS,FwK,GWÖl,RW'},
 ...
 'GSG4'       :  {txt: 'Gefahrguteinsatz',               vhc: 'LF,LF,LF/TS,ELW,GWM,GWG,GWA,RW,FwK'},
  ...
  'VGSL'     :  {txt: 'Verbandsgroßschadenslage',        vhc: 'LF,LF,LF,LF,LF,LF,LF,LF,LF,LF,LF,LF,,LF,LF,LF,LF,LF,LF,LF,,LF,,LF,LF,LF,LF,LF,,LF,LF'},
...
'Flugfeldlöschfahrzeug': {id: 19, grp: 'FLF',  speed: 110, trainable: true , regex: /Flugfeldlöschfahrzeug/, wiki: 'Flugfeldl%C3%B6schfahrzeug'},
  ...
  'AB-Einsatzleitung'  : {id: 34, grp: 'ABE',  speed: 54, trainable: false, regex: /AB-Einsatzleitung/, wiki: 'AB-Einsatzleitung'},
...
var FhzGruppeLst = {
  ...
  'ABE' : {text: 'AB-Einsatzleitung',       seq: 27, visible: false, type: 'AB'},
...
var ContainerLst = {
  ...
  'AB-Öl'  : {id:  1, text: 'Ölbekämpfung', actAs: 5, wiki: 'AB-Oel'},
  'AB-Rüst': {id:  2, text: 'Rüstmaterial', actAs: 11, wiki: 'AB-Ruest'},
  'AB-Atemschutz': {id:  3, text: 'Atemschutz', actAs: 10, wiki: 'AB-Atemschutz'},
  'AB-Einsatzleitung': {id:  4, text: 'Einsatzleitung', actAs: 34, wiki: 'AB-Einsatzleitung'},
  'AB-Wasserförderung': {id:  5, text: 'Wasserförderung', actAs: 8, wiki: 'AB-Wasserfoerderung'},
  'AB-Schiene': {id:  6, text: 'Schiene', actAs: 16, wiki: 'AB-Schiene'},
};
...
'global': {
  ...
  averageOnlyVisibleCrew    : {valDef: true,  text: 'Durchschnittsberechnung nur für sichtbares Personal'},
  ...
  highlightWorldColor_3     : {valDef: 'orange', type: OptType.colList, list: ColorLst, text: 'Farbe der Welt 3'},
}},
'eList': {
   text: 'Einsatzliste',
   opt: {
...
'pList': {
  ...
  showCrewAverage        : {valDef: true,  text: 'Durchschnitte berechnen'},
  showTrainingOverview   : {valDef: 'end', type: OptType.list, text: 'Anzeige der Ausbildungsübersicht je Wache',
                            list: {'none': "nicht anzeigen", "begin": "vor den Wachen", "end": "nach den Wachen"}},
...
'school': {
  ...
  defaultTabSortSchool       : {valDef: 'none', type: OptType.list, text: 'Standard-Sortierung',
                                list: {'none': "(unsortiert)", "Name": "Name", "Motivation": "Motivation", "Fähigkeiten": "Fähigkeiten", "Alter": "Alter", "Ausbildung": "Ausbildung", "Status": "Status", "Schicht": "Schicht"}},
  showSchoolAverage          : {valDef: true,  text: 'Durchschnitte berechnen'},
...
'training': {
  ...
  defaultTabSortTraining       : {valDef: 'none', type: OptType.list, text: 'Standard-Sortierung',
                                list: {'none': "(unsortiert)", "Name": "Name", "Motivation": "Motivation", "Fähigkeiten": "Fähigkeiten", "Alter": "Alter", "Ausbildung": "Ausbildung", "Status": "Status", "Schicht": "Schicht"}},
  showTrainingAverage          : {valDef: true,  text: 'Durchschnitte berechnen'},
...
'fInfo': {
  ...
  showVehicleAverage      : {valDef: true,  text: 'Durchschnitte berechnen'},
}},
'wList': {
   text: 'Wachenliste',
   opt: {
...
var locationLst = {
  ...
  'Hafen': {text: 'Hafen', tcol : 'blue', bcol : 'white', from: {x:  98, y: 198}, to: {x: 100, y: 200}},
  'Flughafen': {text: 'Flughafen', tcol : 'white', bcol : 'teal', from: {x:  83, y: 179}, to: {x:  84, y: 180}},
  'Raffinerie': {text: 'Raffinerie', tcol : 'black', bcol : 'darkorange', from: {x:   6, y: 176}, to: {x:   7, y: 176}},
  'BahnlinieW': {text: 'Bahnlinie, westlich', tcol : 'white', bcol : 'purple', from: {x:   1, y: 152}, to: {x:  49, y: 152}},
  'BahnlinieO': {text: 'Bahnlinie, östlich', tcol : 'white', bcol : 'purple', from: {x:  52, y: 152}, to: {x: 100, y: 152}},
  ...
  'Bahnhof': {text: 'Bahnhof', tcol : 'white', bcol : 'purple', from: {x:  50, y: 152}, to: {x:  51, y: 152}},
  'Tagebau': {text: 'Tagebau', tcol : 'white', bcol : 'brown', from: {x:  17, y: 129}, to: {x:  20, y: 132}},
  'Kraftwerk': {text: 'Kohlekraftwerk', from: {x:  25, y: 130}, to: {x:  25, y: 131}},
  'Förderband': {text: 'Förderband', tcol : 'maroon', from: {x:  19, y: 131}, to: {x:  24, y: 131}},
  'MVA'    : {text: 'Müllverbrennungsanlage', tcol : 'darkred', bcol : 'white', from: {x:  88, y: 124}, to: {x:  88, y: 125}},
  'Großbaustelle': {text: 'Großbaustelle', tcol : 'white', bcol : '#000094', from: {x:  76, y:  18}, to: {x:  76, y:  18}},
  // 'normale' Bereiche
  'Sperrgebiet': {text: 'Sperrgebiet', tcol : 'white', bcol : 'red', from: {x:   1, y: 101}, to: {x: 100, y: 121}},
  'Altstadt': {text: 'Altstadt', from: {x:   1, y:   1}, to: {x: 100, y: 100}},
  'Neustadt': {text: 'Neustadt', tcol : 'green', bcol : 'white', from: {x:   1, y: 101}, to: {x: 100, y: 200}},
};
...
var trainingLst = {
  ...
  '{unbekannt}'       : {internal: true, noDisplay: true, cboxid: '', tcol: {light:'', black:''}, bcol: {light:'', black:''}, text: 'unbekannte Ausbildung', ktext: 'uA'},
...
// die Liste wird solange von unten durchsucht, bis ein Wert gefunden wird, der größerer der Motivation des Kameraden ist.
var motivLst = new ValueLstCls({
   '1' : {tcol: '#B22222'},
  '25' : {tcol: '#FF6666'},
  '50' : {tcol: conf.isNewLayout()?'peru':'#FFD700'},
  '75' : {tcol: conf.isNewLayout()?'green':'#66FF66'},
  '89' : {tcol: conf.isNewLayout()?'darkgreen':'#32CD32'},
 '100' : {tcol: conf.isNewLayout()?'teal':'#228B22'}
});

// Syntax: Textfarbe in Mannschaftsübersicht
// die Liste wird solange von unten durchsucht, bis ein Wert gefunden wird, der größerner der Fähigkeit des Kameraden ist.
var abilLst = new ValueLstCls({
   '1' : {tcol: '#B22222'},
  '25' : {tcol: '#FF6666'},
  '50' : {tcol: conf.isNewLayout()?'peru':'#FFD700'},
  '75' : {tcol: conf.isNewLayout()?'green':'#66FF66'},
...
// die Liste wird solange von unten durchsucht, bis ein Wert gefunden wird, der größer als die Mannschaftsstärke der BF ist.
var staffLst = new ValueLstCls({
   '1' : {tcol: 'darkred'},
  '24' : {tcol: 'red'},
  '49' : {tcol: 'brown'},
  '74' : {tcol: 'orange'},
  '84' : {tcol: conf.isNewLayout()?'peru':'yellow'},
  '91' : {tcol: conf.isNewLayout()?'green':'lime'},
 '101' : {tcol: conf.isNewLayout()?'darkgreen':'green'},
});
...
var worlds = {
  1 : {bCol: 'highlightWorldColor_1'},
  2 : {bCol: 'highlightWorldColor_2'},
  3 : {text: 'Speed-Welt', bCol: 'highlightWorldColor_3', premium: true},
};
  ...
  try {
    ...
    (function(iConf) {
      ...
      if (iConf.getOptVal('assignTLF16ToGrpLF') && fhz && fhz.getGrp().getName() !== iConf.specFGrp.lf.getName()) {
        var fGrpOld = fhz.getGrp();
        fhz.setGrp(iConf.specFGrp.lf);
        if (!fGrpOld.hasFhz()) {
          fGrpOld.setVisible(false);
        }
      }
...
function displayStationList() {
  ...
  if (nodeTBody) {
    ...
    if (conf.stationList.getCntCrewBF() > 0) {
      cell.addText(' (');
      if (conf.stationList.getCntCrewBF() != conf.stationList.getCntCrew()) {
        cell.addText(conf.stationList.getCntCrewBF()+': ');
      }
      cell.addText((conf.stationList.getCntCrewBF()*CREDITS_PER_CREW).format(0,'.',',')+' Cr.)');
    }
    nodeTBody.appendChild(row.getDOM());
  }
  ...
  for (var i=0;i<evalTRs.snapshotLength;i++) {
    ...
    if (conf.getOptVal('highlightManning') && station.isBF()) {
      ...
      var staff = staffLst.find(proz);
      if (staff) {
        xPath.getSingle("./a[1]", evalTDs.snapshotItem(columns['Personen']-1)).style.color = staff.tcol;
      };
      if (proz <= 100)
...
function displaySchool(iFirst) {
  ...
  flgs.shift = conf.getOptVal('useShiftColourCodeSchool');
   ...
   function getCount() {
    ...
    if (cnt > maxPupils) {
      alert('In dieser Schule kann man nur '+maxPupils+' Personen gleichzeitig ausbilden!');
    }
    if ($('ereglamInfoTable') && $('ereglamInfoCount')) {
      $('ereglamInfoCount').innerHTML = cnt+'/'+maxPupils;
    }
  }
  ...
  nodeTD = xPath.getSingle("./table[@class='defaultTable']/tbody/tr[contains(./td[1]/text(), 'Maximale')]/td[2]", 'content');
  if (nodeTD) {
    maxPupils = parseInt(nodeTD.innerHTML);
  };
  ...
  if (nodeText) {
    ...
    for (iTxt = 0; iTxt < evalText.snapshotLength; iTxt++) {
      ...
      if (/Diese Personen/.test(nodeText.nodeValue)) {
        ...
        if ($('ereglamInfoTable')) {
          $('ereglamTrainingCnt').innerHTML = evalTRs.snapshotLength+'/'+maxPupils;
        }
        break;
      }
    }
  ...
  for (iTbl = 0; iTbl < evalTables.snapshotLength; iTbl++) {
    ...
    if (conf.getOptVal('showSchoolAverage')) {
      summarizeCrew(nodeTable, columns, flgs);
    }
  }
...
function displayTraining() {
  ...
  flgs.shift = conf.getOptVal('useShiftColourCodeTraining');
   ...
   function getCount(e) {
    ...
    if (cnt > maxPupils) {
      alert('Dieses Übungsgelände kann man nur '+maxPupils+' Personen gleichzeitig ausbilden!');
    }
    if ($('ereglamInfoTable') && $('ereglamInfoCount')) {
      $('ereglamInfoCount').innerHTML = cnt+'/'+maxPupils;
    }
  ...
  if(nodeText) {
    ...
    if (nodeH2) {
      ...
      if ($('ereglamInfoTable') && $('ereglamInfoCount')) {
        $('ereglamInfoCount').innerHTML = evalTRs.snapshotLength+'/'+maxPupils;
      }
    }
  }
  ...
  for (iTbl = 0; iTbl < evalTables.snapshotLength; iTbl++) {
    ...
    if (conf.getOptVal('showTrainingAverage')) {
      summarizeCrew(nodeTable, columns, flgs);
    }
  }
  running = false;
...
function summarizeCrew(iTable, iCols, iFlgs, iLines) {
  var evalTDs,
    evalTRs,
    nodeTFoot = new Element('tfoot'),
    nodeTRFoot = new Element('tr', {'class': 'rowWhite'}),
    nodeTR,
    nodeTD,
    iTR = 0,
    iTD = 0,
    sums = {},
    onlyVisible = conf.getOptVal('averageOnlyVisibleCrew'),
    cntLines = 0;

  if (xPath.getSingle("./tfoot", iTable)) {
    return;
  }

  nodeTFoot.appendChild(nodeTRFoot);

  evalTDs = xPath.getNodes("./thead/tr/th", iTable);
  for (iTD = 0; iTD < evalTDs.snapshotLength; iTD++) {
    nodeTRFoot.appendChild(new Element('td'));
  }
  ...
  evalTRs = xPath.getNodes("./tbody/tr", iTable);
  if (iLines) {
    cntLines = iLines;
  } else if (!onlyVisible) {
    cntLines = evalTRs.snapshotLength;
  }
  for (iTR = 0; iTR < evalTRs.snapshotLength; iTR++) {
    nodeTR = evalTRs.snapshotItem(iTR);

    if (onlyVisible && nodeTR.style.display == 'none') {
      continue;
    }
    ...
    if (iCols['Motivation'] > 0) {
      ...
      if (nodeTD) {
        sums.mot += parseInt(nodeTD.innerHTML, 10);
      }
    }
    ...
    if (iCols['Fähigkeiten'] > 0) {
      ...
      if (nodeTD) {
        sums.abil += parseInt(nodeTD.innerHTML, 10);
      }
    }

    if (iCols['Alter'] > 0) {
      nodeTD = evalTDs.snapshotItem(iCols['Alter'] - 1);
      if (nodeTD) {
        sums.age += parseInt(nodeTD.innerHTML.replace(/Jahre/, '').trim(), 10);
      }
    }

    if (onlyVisible && !iLines) {
      cntLines++;
    }
  }

  if (cntLines > 0) {
    evalTDs = xPath.getNodes("./td", nodeTRFoot);
    evalTDs.snapshotItem(0).appendChild(createText('Durchschnitt'));
    if (iCols['Motivation'] > 0) {
      nodeTD = evalTDs.snapshotItem(iCols['Motivation'] - 1);
      if (nodeTD) {
         nodeTD.appendChild(createText((sums.mot / cntLines).format(2,'.',',') + '%'));
      }
    }
    ...
    if (iCols['Fähigkeiten'] > 0) {
      nodeTD = evalTDs.snapshotItem(iCols['Fähigkeiten'] - 1);
      if (nodeTD) {
         nodeTD.appendChild(createText((sums.abil / cntLines).format(2,'.',',') + '%'));
      }
    }
    ...
    if (iCols['Alter'] > 0) {
      nodeTD = evalTDs.snapshotItem(iCols['Alter'] - 1);
      if (nodeTD) {
         nodeTD.appendChild(createText((sums.age / cntLines).format(2,'.',',') + ' Jahre'));
      }
    }

    highlightCrew(nodeTRFoot, iCols, iFlgs)

    iTable.insertBefore(nodeTFoot, iTable.firstChild.nextSibling.nextSibling);
  }
}
...
function highlightCrew(iNodeTR, iCols, iFlgs) {
  ...
  if (iCols['Motivation'] > 0) {
    ...
    if (iFlgs.motiv && nodeTD) {
      ...
      var motiv = motivLst.find(val);
      if (motiv) {
        nodeTD.style.color = motiv.tcol;
      };
    }
  }
  ...
  if (iCols['Fähigkeiten'] > 0) {
    ...
    if (iFlgs.abil && nodeTD) {
      val = parseInt(nodeTD.innerHTML, 10)
      var abil = abilLst.find(val);
      if (abil) {
        nodeTD.style.color = abil.tcol;
      };
    }
  }
...
function displayVehicle(iFhzNr) {
  ...
  if (nodeTable) {
    ...
    if (conf.getOptVal('showVehicleAverage')) {
      summarizeCrew(nodeTable, columns, flgs);
    }
  }
}
...
function doVehicleRepair(iFhzNr) {
  ...
  var evalTRs = xPath.getNodes("./form/table[@class='defaultTable']/tbody/tr", 'content');
...
function doOverview() {
  ...
  for (iTR = 0; iTR < evalTR.snapshotLength; iTR++) {
    ...
    if (conf.getOptVal('highlightCityExtension')) {
      ...
      if (nodeA) {
        var area = getArea(nodeA.innerHTML);
        if (conf.getOptVal('highlightCityExtension')) {
          if (area.tcol) {
            nodeA.style.color =
            nodeA.parentNode.style.color = area.tcol;
          }
          if (area.bcol) {
            nodeA.style.backgroundColor =
            nodeA.parentNode.style.backgroundColor = area.bcol;
          }
        }
        nodeA.parentNode.title = area.descr;
      }
    }
  }
}
...
function doCall(iNr) {
  ...
  function CntCls(iFGrp) {
    ...
    this.toString = function() {
      return fGrp.toString()+': cnt = '+cnt+'; free = '+free+'; i = '+i;
    }
  }
...
//log.addMsg('item.innerHTML='+item.innerHTML+';\ntmp='+tmp+'; name='+name+'\n');
          }

        };
        fhz = conf.getFhzByID(fhzID);

        if (fhz && fhz.getGrp().getName() === conf.specFGrp.wlf.getName()) {
          if (section === 'free_vehicle') {
...
//log.addMsg(this.getFhz().getName()+' ('+this.getName()+' '+chkbox.id+'): '+(this.checked?'':' not')+' clicked');
      return chkbox.checked;
    };

    this.isSelectable = function() {
      chkbox_disabled = (chkbox.getAttribute('disabled') != null);
//log.addMsg(this.getFhz().getName()+' ('+this.getName()+' '+chkbox.id+'): '+((chkbox.getAttribute('disabled') != undefined)?'':'not ')+ 'found');
      return !chkbox_disabled;
    };
...
//log.addMsg(this.getFhz().getName()+' ('+this.getName()+' '+chkbox.id+'): '+(chkbox.checked?'':' not')+' clicked; "disabled" ='+chkbox.getAttribute('disabled'));
        chkbox.click();
        var evalIPs = xPath.getNodes("./tr/td/input[@real_vehicle_to_user_id='"+chkbox.getAttribute('real_vehicle_to_user_id')+"']", chkbox.parentNode.parentNode.parentNode);
//log.addMsg('evalIPs.snapshotLength = '+evalIPs.snapshotLength+'; '+"./tr/td/input[@real_vehicle_to_user_id='"+chkbox.getAttribute('real_vehicle_to_user_id')+"']");
        if (evalIPs.snapshotLength > 1) {
          for (var iIP = 0; iIP < evalIPs.snapshotLength; iIP++) {
            var nodeIP = evalIPs.snapshotItem(iIP);
            if (!nodeIP.checked) {
              nodeIP.setAttribute('disabled', '');
            }
          }
        }
//log.addMsg(this.getFhz().getName()+' ('+this.getName()+' '+chkbox.id+'): '+(chkbox.checked?'':' not')+' clicked; "disabled" ='+chkbox.getAttribute('disabled'));
...
//log.addMsg(checkNode+' <> '+cnt);
          while (!nodeFound && checkNode) {
            if (checkNode.isClicked() || !checkNode.isSelectable()) {
              checkNode = cnt.getNextItem();
              continue;
            }
            if (checkNode.isSelectable() && (!node || checkNode.getTime().getSeconds() < node.getTime().getSeconds())) {
              node = checkNode;
              nodeFound = true;
            }
            if (!cnt.hasNextItem()) {
...
//log.addMsg(checkNode+' <> '+cnt);
      ...
      if (node && !isVBCall() && conf.getOptVal('limitRTWcall') && node.getFhzGrp().getName() == conf.specFGrp.rtw.getName()) {
  ...
  function clearMarks(iUncheck) {
    var nodes = data.nodes['free_vehicle'];
  ...
  function findFasterUnits() {
    var nodes = data.nodes['driving_vehicle'];
    for (iTD = nodes.length - 1; iTD >= 0; iTD--) {
      var nodeTD = nodes[iTD];
      timeNode = nodeTD.getCurrentTimeCell();
      if (!/(Berechne|Fertig)\.\.\./.test(timeNode.innerHTML.trim())) {
        var fhz = nodeTD.getFhz();
        var time = nodeTD.getTime();
        ...
        for (i = 0; i < nodeLst.length; i++) {
          ...
          if (!node.isClicked() && node.isSelectable() && !node.hasFasterMark() && ((node.getTime().getSeconds() + node.getStationResponseTime()) < time.getSeconds())) {
            node.markAsFaster();
            if (conf.getOptVal('useDottedLine4FasterVeh')) {
              nodeTD.getNode().style.border = '3px dotted ' + conf.getOptVal('fasterVehicleColour');
            } else {
  ...
  // Position in Stadtbereich ermitteln
  var nodeTD = xPath.getSingle("./table[@class='defaultTable']/tbody/tr[contains(./td[1]/text(), 'Position')]/td[2]", 'mission_content');
  var nodeA = xPath.getSingle("./a", nodeTD);
  if (nodeA) {
    area = getArea(nodeA.innerHTML);
  } else {
    area = getArea(nodeTD.innerHTML);
  }
  ...
  for each (section in ['mission_vehicle','driving_vehicle','waiting_vehicle','mission_container']) {
    var evalTRs = xPath.getNodes("./table[@class='defaultTable']/tbody/tr[./td/a]", section);
    for (iTR = 0; iTR < evalTRs.snapshotLength; iTR++) {
      var nodeItem = new NodeCls(evalTRs.snapshotItem(iTR), section);
      var fGrp = nodeItem.getFhzGrp();
      var onRoute = new OnRouteCls(nodeItem);

      data.nodes[section].push(nodeItem);
  ...
  for (iTD = 0; iTD < evalTDs.snapshotLength; iTD++) {
    ...
    data.nodes['free_vehicle'].push(nodeItem);
  ...
  if (nodeTable) {
    ...
    if (evalNEF.snapshotLength > 0 && !area.onWater) {
...
// an Fahrzeugliste anfügen, wenn nicht vorhanden
  ...
  if (!isVGSL()) {
    ...
    var isOnWater = isVBCall()?mld.isOnWater():area.onWater;
		var rtm = isOnWater ? conf.specFGrp.rtb : conf.specFGrp.rtw;

    for (var inj = getInjured(); inj > 0; inj--) {
      fhze.addFhz(rtm);
    }
    if (getInjured() > 0 && !isOnWater && conf.getOptVal('callSurplusRTW')) {
      fhze.addFhz(rtm);
    }
    if (getInjured() >= conf.getOptVal('callNEFWithInjured') && conf.getOptVal('callNEFWithInjured') > 0 && !fhze.contains(conf.specFGrp.nef) && !isOnWater) {
  ...
  if (conf.getOptVal('dispStw')) {
    ...
    if (conf.getOptVal('disableSelectionDueToStorm') && mld.isStorm()) {
      ...
      if (false && mld.getStw().getName() === STW_UNDEF) {
        node.appendChild(new Element('br'));
        var nodeA = new Element('a', {'href': ''});
        nodeA.appendChild(createText('Meldung speichern'));
  ...
  if ((!isVBCall() || isOwnVBCall(main.user)) && (conf.getOptVal('highlightCityExtension') || conf.getOptVal('addLocationDescription'))) {
    ...
    if (node && !node.alt) {
      node.parentNode.title = area.descr;
      if (conf.getOptVal('highlightCityExtension')) {
        if (area.tcol) {
          node.style.color =
          node.parentNode.style.color = area.tcol;
        }
        if (area.bcol) {
          node.style.backgroundColor =
          node.parentNode.style.backgroundColor = area.bcol;
        }
      }
  ...
  if ($('ereglamInfoLocation')) {
    $('ereglamInfoLocation').innerHTML = ((area.otherTown)?'ext. ':'') + area.pos;
  };
  ...
  if (conf.getOptVal('dispStatus')) {
    ...
    if (cntAll > 0) {
      ...
      cell.addText('Status');
      for each(fGrp in conf.fhzGrpList.getList(area.onWater)) {
        if (!fGrp.getVisible() || (conf.getOptVal('limit2neededVehicleGroups') && !(fGrp.isInScope() || data.count.avail.get(fGrp.getName()).getCount() > 0))) {
          continue;
        }
  ...
  '\nPremiumUser     = '+unsafeWindow.user_has_premium+' '+premUser+
...
function doVehicleList() {
  ...
  for (var iTB = 0; iTB < evalTBs.snapshotLength; iTB++) {
    ...
    for (iTR = 0; iTR < evalTRs.snapshotLength; iTR++) {
      ...
      ArrTopKM.push(new Array(IntkmStand,FZLink, evalTDs.snapshotItem(6).innerHTML));
  ...
  if (nodeTBody && conf.getOptVal('listHighLowKm')) {
    ...
    var row = new tableRowCls();
    var cell = row.getNewCell();
    var disp = ArrTopKM.length;
    if (ArrTopKM.length < 5) {
      disp = ArrTopKM.length;
    } else {
      disp = 5 + Math.floor((ArrTopKM.length>50?50:ArrTopKM.length)/10);
    }
    cell.addText('Fahrzeuge mit der höchsten Laufleistung:');
    // Liste
    cell = row.getNewCell();
    ArrTopKM.sort(function s(a,b){return b[0]-a[0];});
    for (var i=0;i<disp;i++) {//Anzahl Elemente in Liste beachten
      cell.addEntityText(ArrTopKM[i][1]);
      cell.addText(" (" + ArrTopKM[i][0].format(0,'.',',') + " km)");
      cell.addEntityText(ArrTopKM[i][2]);
      cell.addChild(new Element('br'));
    }
    nodeTBody.appendChild(row.getDOM());
...
function doCrewLists() {
  ...
  function displayCrew(iTable) {
    ...
    if (conf.getOptVal('showCrewAverage')) {
      summarizeCrew(iTable, columns, flgs);
    }
  ...
  for (var iTable = 0; iTable < evalTables.snapshotLength; iTable++) {
    ...
    if (evalTables.snapshotLength > 1) {
      ...
      if (station) {
        stationArr[stationName].station = station;
      }
      for (train in trainingLst) {
  ...
  if (evalTables.snapshotLength > 1) {
    var showT = conf.getOptVal('showTrainingOverview');
    if (showT != 'none') {
      var nodeH1 = xPath.getSingle("h1[1]", 'content');
      ...
      if (hasBF) {
        ...
        for (train in trainingLst) {
          if (!trainingLst[train].noDisplay) {
        ...
        for (stationName in stationArr) {
          ...
          row = table.getNewBodyRow({'class': 'row'+(rowCnt++)%2});
          if (stationArr[stationName].station) {
            cell = row.getNewCell({'title': stationArr[stationName].station.write()},true);
          } else {
            cell = row.getNewCell({},true);
          }
        ...
        switch(showT) {
          case 'begin':
            nodeH1.parentNode.insertBefore(table.getDOM(), nodeH1);
            break;
          case 'end':
      ...
      for (;iTH < evalTHs.snapshotLength; iTH++) {
        ...
        if (/feuerwachen\/(\d+)$/.test(node.href)) {
          ...
          if (re.test(nodeTH.innerHTML) && station && station.isBF()) {
            ...
            var staff = staffLst.find(proz);
            if (staff) {
              node = new Element('span', {'style': 'color: '+ staff.tcol + ';'});
...
function getArea(pos) {
  var area = {onWater: false, descrArr: []};
  area.pos = pos.trim().replace(/Andere Stadt[\s|  ]*-[\s|  ]*/, '');
  var [posX, posY] = area.pos.split(' - ');
  area.x = parseInt(posX.trim(), 10);
  area.y = parseInt(posY.trim(), 10);
  area.otherTown = (pos != area.pos);
  for (loc in locationLst) {
    if (locationLst[loc].from.x <= area.x && locationLst[loc].from.y <= area.y &&
        locationLst[loc].to.x >= area.x && locationLst[loc].to.y >= area.y) {
      area.descrArr.push(locationLst[loc].text);
      if (locationLst[loc].onWater) {
        area.onWater = true;
      };
      if (locationLst[loc].tcol && !area.tcol) {
        area.tcol = locationLst[loc].tcol;
        if (locationLst[loc].bcol && !area.bcol) {
          area.bcol = locationLst[loc].bcol;
        };
      };
    }
  }
  area.descr = area.descrArr.reverse().join(', ');
  return area;
}
...
function mainCls(iConf) {
  ...
  this.allTownCalls = true; //Einsätze in ganzer Stadt
  ...
  this.init = function() {
    ...
    if (this.townExtent) {
      node = xPath.getSingle("//li[contains(./a/text(), 'Feuerwachen')]/ul/li/a[contains(./@href, '/stadt/neustadt')]", 'root');
      if (node) {
        hrefArr = node.href.split('/');
        switch (hrefArr[hrefArr.length - 1].trim()) {
          case "neustadt":
            this.allTownCalls = false;
            break;
    ...
    if (cnf.getOptVal('adjustMenus') && this.user) {
      ...
      if (!premUser) {
        xPath.getSingle("//li/ul/li[contains(./a/text(), 'Werbeaktion')]", 'root').style.display = 'none';
        xPath.getSingle("//li/ul/li[contains(./a/text(), 'Ausflug')]", 'root').style.display = 'none';
      }
    ...
    if (cnf.getOptVal('showMainInformation') && this.user) {
      ...
      if (cnf.world > 0) {
        var world;
        for (world in worlds) {
          var nodeSpan = new Element('span', {'id':'ereglamWorld'+world, 'style': 'margin-left:2px;margin-right:2px;border:2px solid;border-color:'+((cnf.world == world)?'black white white black;':'white black black white;')});
          nodeSpan.style.color = ((world == cnf.world)?'white':'lightgray');
          if (worlds[world].bCol && (premUser || !worlds[world].premium)) {
            nodeSpan.style.backgroundColor = cnf.getOptVal(worlds[world].bCol);
          };
          addEntityText(nodeSpan, '&nbsp;&nbsp;');
          if (worlds[world].text) {
            nodeSpan.title = worlds[world].text;
          } else {
            nodeSpan.title = 'Welt '+world;
          }
          if ((world == cnf.world) || (!premUser && worlds[world].premium)) {
            nodeSpan.appendChild(createText('W '+world));
            if (!premUser && worlds[world].premium) {
              nodeSpan.title += ': Zugang nur für Premiumspieler';
            }
          } else {
            var nodeA = new Element('a', {'href': 'http://www.feuerwache.net/welten/'+world});
            nodeA.title = 'wechseln zu '+nodeSpan.title;
            nodeA.appendChild(createText('W '+world));
            nodeSpan.appendChild(nodeA);
          }
          addEntityText(nodeSpan, '&nbsp;&nbsp;');
      ...
      if ($('ereglamInfoBox')) {
        ...
        if (this.townExtent) {
          ...
          if (this.allTownCalls) {
            row = table.getNewBodyRow();
            cell = row.getNewCell({'colspan': '2', 'text-align': 'center'}, true);
            cell.addText('alle Einsätze in Neustadt');
          }
  ...
  this.main = function() {
    ...
    if (xPath.getSingle("./h1[text()='Seite nicht gefunden']", 'content')) {
      return;
    }
