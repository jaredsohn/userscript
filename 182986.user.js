// ==UserScript==
// @name	    Proxy Free By DragonCity Version Nouvelle Fenêtre
...
GM_setValue('pfipDropdown', 'US-CO');
...
proxy.innerHTML = '<div style="position: fixed; top: 200px; left: 2%; background: white; padding: 5px"><button id="proxy_it" class="closing" onclick="window.open(\'http://www.proxfree.com/?proxy_it\')"><img src="http://dragoncity17.free.fr/dragon.png" /></button></div>';
