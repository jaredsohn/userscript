...
var pageFunction = function(checkUpdates, updateNeeded) {
	...
	window.ytd = {formats: {
			...
			38: { fmt: 38, quality: { level: 10, recdl: true, description: "Original Definition, 4K"           }, format: "MP4"                                                                                                  , acodec: "AAC"   , vcodec: "H.264"  },
	...
	if (userelem)
	{
		var users = atob("QW5ncnl0aWdlclB8TXlMaXR0bGVQb255MTA4MHB8UGVuc2l2ZXBvbnl8TGl0dGxlcG9ueTIwMTF8SnVua2llc05ld2J8TWVubG9NYXJzZWlsbGVzfEZsdXR0ZXJzaHlwb255fE15bGl0dGxlcG9ueWd1eQ==").split("|");
		for (var i = 0; i < users.length; i ++)
			if (users[i] == userelem.textContent)
			{
				mifplm = true;
