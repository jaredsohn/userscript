// ==UserScript==
// @name           Super Global Emote Alt Text Display
// @namespace      super_global_alttext
// @description    Displays any alt-text from reddit/reddit-style/myglobalponies/mgp-style emotes next to the emote
// @include        http://*/*
// @include        https://*/*
// @match          https://*/*
// @match          http://*/*
...
//Based on Super Reddit Alt-Text display, just now it works EVERYWHERE! :)
//You probably want "My Global Ponies","My Easy Emotes","My Reddit Ponies", and maybe the r/mylittleandysonic1 userscript
//If you're using chrome, I also recommend "TamperMonkey" instead of installing userscripts as extensions :D
...
".GlobalEmoteAltTextDisplay_Text {color: gray; word-wrap: break-word; display:inline-block}\n" +
".GlobalEmoteAltTextDisplay_Text a {color: gray; text-decoration:underline; display:inline-block}\n" +
".mgp-base {display:inline-block !important}\n";
...
function expandMGPEmotes(anchor){
...
function expandChildMDs(elm) {
	...
	//console.log("Scanning mgp elements");
	var mgpElements = document.getElementsByClassName("mgp-base")
    for (var i in mgpElements) {
		//console.log("Found mgp element" + mgpElements[i].tagName + ": " + mgpElements[i].title);
        if (mgpElements[i].tagName == 'A') {
            expandMGPEmotes(mgpElements[i]);
        }
    }
}
