// ==UserScript==
// @name           Помощник фармера (SnP Helper)
// @version        1.04
...
ScriptUpdater.check(51639, '1.04');
// --/ScriptUpdater--
...
function showTotal()
{
		...
		td2 = document.createElement("td");
		 var wareDiv = <>
								<input type="text" style="text-align: right;" size="8"  id="warehouseLevelId" value="0"/>  Например 3 или 1,2,3 для нескольких складов.
							</>;
		...
		td2 = document.createElement("td");
		td2.innerHTML = 'Наслаждайтесь!!  (Kabji Lambda Ikariam.org, перевод на Русский язык VitOS, hakergtr@yandex.ru)';
