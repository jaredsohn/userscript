...
// @name           REOSTools
// @namespace      ikatips
// @description    Herraminetas para la alianza REOS
// @include        http://*ikariam.*/index.php*
// @author         Anonimo Modificado por (MasterChris)
// @version        v2.1.1
// ==/UserScript==
...
+ ' <li><h2>REOS</h2>'
+ '   <ul>'
+ '     <li><center><a target="_blank" href="http://reos.foroactivo.net/forum.htm" title=" Foro de la Alianza REOS ">Foro REOS</a></li>'
+ '     <li><center><a target="_blank" href="http://muriandre.com/ikariam/cdb/" title=" herramientas de ikariam por Conan">Herramientas Ikariam</a></li>'
...
+ '     <li><center><a target="_blank" href="http://www.ika-world.com/es/suche.php?view=suche_stadt&land=es" title=" Busca las ciudades de un jugador ">Buscador de Ciudades</a></li>'
+ '     <li><center><a target="_blank" href="http://hi.muriandre.com/cdb.php" title=" Compactador de batallas para publicarlas en el foro ">Conversor de Batallas</a></li>'
+'</ul>'
+'</DIV>';
