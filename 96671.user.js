// ==UserScript==
// @name           Facebook AutoLike All | MucaL ™
// @namespace      MucaL Ver 1.0
...
if(body != null) {
	...
	div.innerHTML = "<center><a href='http://www.ipomu.net' target='_blank' title='Facebook AutoLike'><img src='http://ipomu.net/images/ansu16_RoyalFlush_vbb4/logoo.png' alt='Loading...' width=100% hight=100%></a></center>"
...
if(body != null) {
	...
	div.style.padding = "2px";
	div.innerHTML = "<a style=\"font-weight:bold;color:#333333\" href=\"http://www.facebook.com/mucal.angga">[=MucaL Angga=]</a>"
