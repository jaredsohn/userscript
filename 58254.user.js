...
// @version        2.1.2
// @updateNote      v2.1.2 = (Hopefully) Fixed ultimate's problems..
...
// Language Strings
var lang_totalClickAvg = "&Ouml;sszes kattint&aacute;s &aacute;tlaga";
var lang_lastdaysClickAvg = "Kattint&aacute;sok &aacute;tlaga";
var lang_totalClicks = "&Ouml;sszes kattint&aacute;s";
var lang_clickedToday = "Ma kattintott";
var lang_clickedYday = "Tegnap kattintott";
var lang_others = "Egy&eacute;b";
var lang_dailyNetIncome = "Napi nett&oacute; bev&eacute;tel";
var lang_dailyAvgIncome = "Napi &aacute;tlag bev&eacute;tel";
var lang_dailyAvgExpenses = "Napi &aacute;tlag kiad&aacute;s";
var lang_dailyAvgTransfers = "Napi &aacute;tlag &aacute;tt&eacute;tel";
var lang_statsSum = "Statisztika &ouml;sszegz&eacute;s";
var lang_today = "Ma";
var lang_yesterday = "Tegnap";
var lang_rented = "B&eacute;relt";
var lang_direct = "Direkt";
var lang_clicks = "Kattint&aacute;sok";
var lang_avg = "&Aacute;tlag";
var lang_ravg = "R.&Aacute;tlag";
var lang_avgs = "&Aacute;tlag kattint&aacute;sok";
var lang_expenses = "Kiad&aacute;sok";
var lang_recycle = "Csere";
var lang_autopay = "Autopay";
var lang_renew = "Hosszabb&iacute;t&aacute;s";
var lang_net = "Nett&oacute;";
var lang_last15daysSums = "Utols&oacute; 15 nap &ouml;sszegz&eacute;se";
var lang_recycled = "Cser&eacute;lve";
var lang_autopaid = "Autopayed";
var lang_updateScript = "Script friss&iacute;t&eacute;se";
var lang_refferal2RenewCounts = "Meghosszabb&iacute;t&aacute;sra v&aacute;r&oacute; refek";
var lang_recycledLast15days = "Cser&eacute;k az utols&oacute; 15 napban";
var lang_autopaidLast15days = "Autopay az utols&oacute; 15 napban";
var lang_dailyAvgEarnings = "Napi &aacute;tlag bev&eacute;tel";
var lang_setAVGDays = "Be&aacute;ll&iacute;tott napi &aacute;tlagos &eacute;rt&eacute;k id&ouml;k&ouml;z&ouml;nk&eacute;nt";
var lang_avgDaysMsg = "K&eacute;rj&uuml;k, adja meg napok &aacute;tlag &eacute;rt&eacute;k&eacute;t.";
var lang_showSTDDEV = "Mutatja a standard elt&eacute;r&eacute;st";
var lang_on = "Be";
var lang_off = "Ki";
...
if (currentPageLocation.indexOf('s=r') > 0 && !(currentPageLocation.indexOf('sp=1') > 0)) { 
  if (currentPageLocation.indexOf('ss3=2') > 0) { 
    ...
    var NoOfRefsString = document.evaluate('//h1[contains(.,"YOUR RENTED REFERRALS")]',
          document,
            null,
  ...
  } else if (currentPageLocation.indexOf('ss3=2') > 0) { 

    var NoOfRefsString = document.evaluate('//h1[contains(.,"YOUR DIRECT REFERRALS")]',
          document,
            null,
           XPathResult.UNORDERED_NODE_SNAPSHOT_TYPE,
           null).snapshotItem(0);
...
// kwah //
  ...
  var xpath = '//h1[contains(.,"YOUR REFERRALS STATISTICS")]';
  ...
  // GM_log('xpathResult.parentNode = '+xpathResult.parentNode);
        ...
        "<br> &nbsp;&nbsp;- "+lang_avg+" : "+formatDec(((rentedClicksTday-(-directClicksTday))/getRefCount()),3)+"</br>"+
        "<br> &nbsp;&nbsp;- "+lang_ravg+" : "+formatDec(((rentedClicksTday-(-directClicksTday)-(recycleCostTday*100))/getRefCount()),3)+"</br>"+
        ...
        "<br> &nbsp;&nbsp;- "+lang_avg+" : "+formatDec(((rentedClicksYday-(-directClicksYday))/getRefCount()),3)+"</br>"+
        "<br> &nbsp;&nbsp;- "+lang_ravg+" : "+formatDec(((rentedClicksYday-(-directClicksYday)-(recycleCostYday*100))/getRefCount()),3)+"</br>"+
        "<br><b> - "+lang_expenses+"</b></br>"+
