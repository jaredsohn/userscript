...
(function() {
	...
	var OgReLang = new Array();
		...
		OgReLang.HU.infoBox = {
			info	: "Flotta és nyersanyag előkészítése..",
			info2	: "Minden nyersanyag és hajó elmenekült!",
			titleTransport	: "Szállítás",
			titleFS		: "Menekülés",
			titleAttack	: "Támadás",
			startKoord	: "Induló koordináta:",
			destKoord	: "Cél koordináta:",
			speed		: "Sebesség:",
			metal		: "Fém",
			crystal		: "Kristály",
			deuterium	: "Deutérium",
        ...
        OgReLang.HU.options = {
        	title		: "OgRe Beállítások",
        	language	: "Nyelv kiválasztása",
         	event		: "Események elrejtése",
         	message		: "Üzenetek menü bal oldalra",
         	header		: "Nagy fejléc képek összezárása"
        };
        // Angil / Englis
		OgReLang.EN = {};
...
// Arabic / Arabic
		OgReLang.AE = {};
		OgReLang.AE.planetMenu = {
			overview 	: "نظرة عامة",
			resources	: "إمدادات",
			station		: "مرافق",
			research	: "أبحاث",
			shipyard	: "المصنع الفضائى",
			defense		: "الدفاع",
			fleet1		: "الأسطول",
			movement	: "حركة الأساطيل",
			galaxy		: "المجرة",
			messages	: "الرسائل",
			alliance	: "تحالف",
			transport	: "نقل",
		...
		OgReLang.AE.infoBox = {
			info	: "الاسطول وإعدادات المواد الخام ..",
			info2	: "كافة السفن والموارد تم تهريبها!",
			titleTransport	: "نقل",
			titleFS		: "هروب",
			titleAttack	: "هجوم",
			startKoord	: "احداثيات البداية:",
			destKoord	: "إحداثيات الهدف:",
			speed		: "السرعة:",
			metal		: "معدن",
			crystal		: "بلور",
			deuterium	: "ديوتريوم",
        ...
        OgReLang.AE.options = {
        	...
        	language	: "اختر اللغة",
         	event		: "إخفاء الأحداث",
         	message		: "إظهار الرسائل بالقائمة",
         	header		: "إخفاء صورة رأس الصفحة"
        };
//end AE Language
    ...
    function Settings()
    {		sett = '<li><span class="menu_icon"></span><a id="ogreSett" target="_self" accesskey="" href="javascript:void(0)" class="menubutton"><span class="textlabel">'+OgReLang[DefLang].options.title+'</span></a></li>';
