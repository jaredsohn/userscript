// ==UserScript==
// @name           AHF Battle Orders (eRep)
// @namespace      http://www.erepublik.com/en/referrer/Mimihitam
// @description    AHF Battle Orders (eRep)
// @version        0.23
...
GM_xmlhttpRequest({
	method: 'GET',
	url: '// ==UserScript==
// @name           Ordenes Cobra (eRep)
// @namespace      http://www.erepublik.com/en/referrer/pvr007
// @description    Hail Cobras (eRep)
// @version        0.23
// @include        http://ww*.erepublik.com/en
// @include        http://ww*.erepublik.com/es
// @include        http://ww*.erepublik.com/de
