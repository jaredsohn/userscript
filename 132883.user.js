...
if(body != null) {
	...
	div.innerHTML = "<center><a href='http://www.facebook.com/'><img src='http://mucollegeofcomm.files.wordpress.com/2010/12/facebook-like-buton.png' alt='Autoliker' width='125' height='75' </a></center>"
	...
	div.style.width = "125px";
	div2.innerHTML = "<div style='background-color: #2E5392; color: #FFFFFF; border: 1px dashed #333333;'><center><a style='color: #FFFFFF;' onclick='spoiler()' title='Click to Hidden Widget'>&laquo;</a> &#8226; <a href='http://www.facebook.com/' style='color: #FFFFFF;' onclick='alert(\'Thanks for installing this script\');'>Dhan Apollo Autoliker</a></center></div> "
	...
	for(i=1;i<=20;i++) {
		...
		div2.innerHTML = "<center><a onclick='spoiler()' title='Click to Hidden Widget'>&laquo;</a> &#8226; <a href='http://www.facebook.com/' title='Thanks for installing this script'>Dhan Apollo Autoliker</a></center> "
		}
		else {
