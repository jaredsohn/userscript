// ==UserScript==
// @name javblog.org sukebei.nyaa.eu scripts
// @namespace ...
// @description javblog.org网站重新排版，浏览图片、搜索相关内容更方便，你懂的
...
// @version 0.5.3
// @updateURL      http://userscripts.org/scripts/show/137746
// @copyright hobby 2014-02-04
// 交流QQ群：273406036 
// 内地用户推荐Chrome + GoAgent(代理) + Proxy SwitchySharp（扩展）的环境下配合使用。
// 0.5.3 更新外链地址imagetwist.com图片的支持
// 0.5.2 修改部分排版问题
// 0.5.1 调整新版部分排版问题
// 0.5.0 针对javblog.org网站重新排版及外链地址图片直接整合，此插件的重要更新！！部分问题将不断改善和更新。
// 0.4.1 修复javblog.org的外链地址的搜索链接和主题名称引用错误问题
// 0.4.0 增加javblog.org的外链地址www.imagebam.com的搜索链接和主题名称
// 0.3.9 新增支持t66y.com网站的相关外链地址的广告弹出窗口移除。
// ==/UserScript==
...
function main() {
	...
	//debugger;
	if (location.href === "http://javblog.org/" || location.href.indexOf('javblog.org/page/') > -1 ||
		location.href.indexOf("http://javblog.org/category") > -1 || location.href.indexOf("javblog.org/?s=") > -1) {
		//TODO:javblog.org
