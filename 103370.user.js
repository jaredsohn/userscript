// ==UserScript==
// @name           Script para la comunidad C.Craperos - T!
// @namespace      cixdesis_
// @description    Añade un botón de la comunidad C.Craperos a Taringa!
// @include        *taringa.net/*
// @exclude        *http://www.taringa.net/comunidades/recomienda-y-recomiendo-unanse-/*
// ==/UserScript==
...
byClass('menuTabs').innerHTML += "<li id=\"tabbedWTF\" class=\"tabbed\">\n <a href=\"http://www.taringa.net/comunidades/recomienda-y-recomiendo-unanse-/\" onclick=\"menu(\'Full Post! \', this.href);return false;\" title=\"Ir a C.Craperos\">C.Craperos <img src=\n\"\" alt=\"\" /></a>\n</li>";
