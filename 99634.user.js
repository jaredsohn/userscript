// ==UserScript==
// @name             CoolAttack - Extra Features!
// @version          0.8.6
// @namespace        CoolAttack-Extra
...
var KOCAttack={
	...
	*/
	...
	SetAttackStatusMessage:function() {
		...
		if(!toggle) {
		    var t=this;
			toggle=this.AddTabLink('Cool Attack');
			if(!toggle) {
				window.setTimeout(function() {
	...
	//	if(autoAttack && autoAttack.cities && autoAttack.cities[t.GetCurrentCityId()]) {
		if(autoAttack) {
			toggle.innerHTML='<span>Cool Attack - On</span>';
		} else {
			toggle.innerHTML='<span>Cool Attack - Off</span>';
		}
	},
