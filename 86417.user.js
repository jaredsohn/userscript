// ==UserScript==
// @name           Chromacity for dAmn - Page JS - BETA - DO NOT DOWNLOAD
// @namespace      nuckchorris0.deviantart.com
// @description    Chromacity for dAmn - Page JS - BETA - DO NOT DOWNLOAD
...
var chromacity = window.chromacity = ({
	...
	apply: function(user,colors,isChromacity){
		if (isChromacity == true && jQuery("#script-status").html().indexOf(".u-"+user) == -1){
			jQuery("#script-status").append(".u-"+user+":after {\n content: \"©\";\n position: absolute;\n right: 0;\n top: 2px;\n }\n");
		}
...
MiddleMan.Event.bind("dAmnChat_recv", "msg", "chromacity_getColor", function(packet){
	...
	if (sub_packet.body.indexOf('&abbr\tcolors:')>-1) {
		...
		window.chromacity.apply(sub_packet.args.from.toLowerCase(),colors,true);
		return packet;
...
jQuery.fn.validHex = function() {
	...
	return this.each(function() {
		...
		if (jQuery.inArray(value, chromacity.colorsBlacklist) == -1){
