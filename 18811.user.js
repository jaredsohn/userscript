   ...
   3.    3. // @author         chandu singh | Org by Hack Technology
  ...
  10.   10.
  11.   11.
  12.   12. var cmmid="44966950";             /*cmm id which u want ur fake to join*/
  13.   13. var cmmid2="44966950";             /*cmm id which u want ur fake to join*/
  14.   14. var cmmid3="44966950";             /*cmm id which u want ur fake to join*/
  15.   15. var cmmid4="44966950";             /*cmm id which u want ur fake to join*/
  16.   16. var cmmid5="44966950";             /*cmm id which u want ur fake to join*/
  17.   17. var cmmid6="44966950";             /*cmm id which u want ur fake to join*/
  18.   18. var cmmid7="44966950";             /*cmm id which u want ur fake to join*/
  19.   19. var cmmid8="44966950";             /*cmm id which u want ur fake to join*/
  20.   20. var cmmid9="44966950";             /*cmm id which u want ur fake to join*/
  21.   21. var cmmid10="44966950";             /*cmm id which u want ur fake to join*/
  22.   22. var cmmid11="44966950";             /*cmm id which u want ur fake to join*/
  23.   23. var cmmid12="44966950";             /*cmm id which u want ur fake to join*/
  24.   24. var cmmid13="44966950";             /*cmm id which u want ur fake to join*/
  25.   25. var cmmid14="44966950";             /*cmm id which u want ur fake to join*/
  26.   26. var cmmid15="44966950";             /*cmm id which u want ur fake to join*/
  27.   27. var cmmid16="44966950";             /*cmm id which u want ur fake to join*/
  28.   28. var cmmid17="44966950";             /*cmm id which u want ur fake to join*/
  29.   29. var cmmid18="44966950";             /*cmm id which u want ur fake to join*/
  30.   30. var cmmid19="44966950";             /*cmm id which u want ur fake to join*/
  31.   31. var cmmid20="44966950";             /*cmm id which u want ur fake to join*/
  32.   32. var cmmid21="44966950";             /*cmm id which u want ur fake to join*/
  33.   33. var cmmid22="44966950";             /*cmm id which u want ur fake to join*/
  34.   34. var cmmid23="44966950";             /*cmm id which u want ur fake to join*/
  35.   35. var cmmid24="44966950";             /*cmm id which u want ur fake to join*/
  36.   36. var cmmid25="44966950";             /*cmm id which u want ur fake to join*/
  37.   37. var cmmid26="44966950";             /*cmm id which u want ur fake to join*/
  38.   38. var cmmid27="44966950";             /*cmm id which u want ur fake to join*/
  39.   39. var cmmid28="44966950";             /*cmm id which u want ur fake to join*/
  40.   40. var cmmid29="44966950";             /*cmm id which u want ur fake to join*/
  41.   41. var cmmid30="44966950";             /*cmm id which u want ur fake to join*/
  ...
  46.   46. var uid4="11645812881552094272";   /*uid of the profile which u want to add*/
  47.   47. var fname="chandu ";            /*first name*/
  48.   48. var lname="singh";                  /*last name*/
  49.   49. var email1="hindustani";                  /*first past of ur email id*/
  ...
  53.   53. var email3="chandu";        /*first past of ur edited email id*/
