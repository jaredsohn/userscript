...
// @author         Jon Parise, Jakob Heuser
// @version        1.5
...
function makeGoogleCalendarLink()
{
    ...
    var gafyd = readCookie("gafyd");
    var leadFragment = 'http://www.google.com/calendar/event';
    
    if (gafyd && gafyd != "null")  {
      'https://www.google.com/calendar/hosted/'+gafyd+'/event';
    }
...
if (link) {
    ...
    br2.style.clear = "right";
    
    var a = document.createElement("a");
    a.style.color = "#fff";
    a.href = "#";
    a.onclick = function() {
      var domain = prompt("What's your Google Apps Domain (or blank for normal GMail)?", "");
      
      createCookie("gafyd", domain || null, 365);
      
      link.setAttribute('href', makeGoogleCalendarLink());
      
    };
    a.innerHTML = "Google Apps User?";
    
    div.appendChild(br, link);
    div.appendChild(a, link);
