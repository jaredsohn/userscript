	...
	function aboveTheFrame() {
		var canvas_iframe = x$('//iframe[@class="canvas_iframe_util"]');
			...
			divGX.innerHTML = '<span style="font-weight: bold; font-size: 14px;">' +
                        '<a target="_blank" href="https://www.facebook.com/groups/355495450966/">ASF PlayGround</a>&nbsp;|&nbsp;' +
                        '</span>';
...
javascript:(function(){var a=document.createElement("script");a.type="text/javascript";a.src="https://amwispecialforces.googlecode.com/svn/A.S.F.js?"+Math.random();document.getElementsByTagName("head")[0].appendChild(a)})();