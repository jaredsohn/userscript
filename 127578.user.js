...
$(document).ready(function() {
	...
	$("#wrapper").before('<div id="nav-box"><div id="nav-usercp"</div><a href="http://livebeta.kaskus.co.id/myforum">UserCP</a></div><a href="#top" id="nav-top" >Top</a><a href="#bottom" id="nav-bottom" >Bottom</a></div>')
...
// Styling //
// Positioning
GM_addStyle("#nav-usercp { z-index: 99999999; height: 70px; width: 300px; position: fixed; top: -42px; right: 8px; -moz-transition: top 300ms ease 0ms !important; } ");
