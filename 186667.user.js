// ==UserScript==
// @name          Conquer Club Map Rank GL fix by Jdsizzleslice
// @namespace     http://userscripts.org/
// @version       1.5.6
// @description   Platinum Medal & Polymorphic Games fix
...
var medname = ["No Medal (0)", "Bronze (1)", "Silver (2)", "Gold (3)", "Platinum (4)"];
var medclass = ["nomedal", "bmedal", "smedal", "gmedal", "pmedal", "omedal"];
var meddivclass = ["nomeddiv", "bmeddiv", "smeddiv", "gmeddiv", "pmeddiv", "omeddiv"];
var medcombo = ["manual", "freestyle", "fog", "speed", "crossmap", "nuclear", "polymorphic"];
var medcombourl = ["&it=M", "&po=F", "&wf=Y", "&tw=Y" , "&sg=Y", "", "&bc=4", "&pl=C"];
...
function endGame(user) {
  ...
  x+= "For crossmaps, the maps shown are those closest to 5 unique defeats. The number in brackets is the number of defeats for those maps.<br /><br />";
  x+= "</td></tr>";
  x+= "</tbody></table>";
...
function createBox(txt, name, options) {
  ...
  style.innerHTML += "#rankBox img {position:relative;top:20px;left:20px;} .rankoptions {width:100px;} .bmedal {font-weight:bold;color:#8C7853} .smedal {font-weight:bold;color:silver} .gmedal {font-weight:bold;color:gold} .pmedal {font-weight:bold;color:#00FFFF} .bmeddiv {background-color:#8C7853;z-index:-100} .smeddiv {background-color:silver;z-index:-100} .gmeddiv {background-color:gold;z-index:-100} .pmeddiv {background-color:#00FFFF;z-index:-100}";
  ...
  style.innerHTML += "#meds td {color:#000;width:1000px;} #meds .pmedal {color:#00FFFF} #meds .bmedal {color:#8C7853} #meds .smedal {color:silver} #meds .gmedal {color:gold} #meds .omedal {color:blue}";
