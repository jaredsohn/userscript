...
troopTarget[0] = [25,-55,1];
troopTarget[1] = [24,-56,1];
troopTarget[2] = [24,-55,1];
...
var soundUrl = "http://www.memoclic.com/medias/sons-wav/2/614.wav";
...
var nodeToAppendNb = "";
var tmIdleReloadExact = (tmIdleReload+Math.floor(tmIdleReload*Math.random()/2));
