...
do_modify_html_it(window.document,document.getElementById('content_gesamt'),/<div id="suche_top"[^°]+title="absenden" type="image"[^<]+<\/a[^<]+<\/div[^<]+<\/form>/i,'',null);

do_modify_html_it(window.document,document.getElementById('content_gesamt'),/<li[^<]+<a[^>]+"index.php\?id=reise">Reise<\/a>/,'',null);

do_modify_html_it(window.document,document.getElementById('content_gesamt'),/<li[^<]+<a[^>]+"index.php\?id=le-monde-diplomatique">[^<]+<\/a>/i,'',null);

do_modify_html_it(window.document,document.getElementById('content_gesamt'),/(<li[^<]+)(<a[^>]+>)Blogs<\/a[^<]+<\/li>/,'<li><a href="http://www.taz.de/digitaz/.archiv/suche">Archiv</a></li><li> <a href="index.php?id=tazarchiv">Bl&#228;ttern</a></li>$1$2Blogs</a></li>',null);

do_modify_html_it(window.document,document.getElementById('content_gesamt'),/index.php\?id=wahrheit/i,'index.php?id=reise">Reise</a> </li><li><a href="index.php?id=le-monde-diplomatique-archiv">LMD</a> </li><li><a href="index.php?id=wahrheit',null);
