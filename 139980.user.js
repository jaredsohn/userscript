...
foundPoke = true;
unsafeWindow.console.info('legends found - ', encounteredPokemon);
}
*/
...
foundPoke = true;
unsafeWindow.console.info('legends Custom found - ', encounteredPokemon);
}
}*/
	...
	for (var i = 0; i < legends.length; i++) {
		if (encounteredPokemon.match(legends[i]) /*&& encounteredPokemon.match(/(Dark |Shiny |Ancient |Mystic )/)*/) {
			foundPoke = true;
			unsafeWindow.console.info('Legendary found - ', encounteredPokemon);
		}
	}
