// ==UserScript==
// @name tribalwars-overview-map-target-linkS-Buttons-plapl.com
...
// -----------------------------------------------------------------------------
//   www.plapl.com  اضافة ازار لي القرى من اجل ارسل الهجمات او تسويط القريه في الخريطه او النضره العامه
// -----------------------------------------------------------------------------
...
(function() {
	...
	var dsrbAddButtons = function(node) {
		...
		var overview = dsrbCreateButton('game.php?' + uv + 'village=' + vilid.target + '&screen=overview', icons.overview, 'نضره عامه لي القريه');
		if(coords) {
			var center = dsrbCreateButton('game.php?' + uv + 'village=' + vilid.own + '&screen=map&x=' + coords[0] + '&y=' + coords[1], icons.center, 'الخريطه');
		}
