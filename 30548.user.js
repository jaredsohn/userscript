...
if(document.location.href.indexOf("CommMsgPost.aspx")>=0)
{
	...
	document.getElementById("subject").value="CANDID CELEB PICTURES";
	document.getElementById("messageBody").value="VERY HOT CELEBS KATRINA PREITY DEEPIKA AND MORE HOT CELEBS
at http://www.pic-palace.blogspot.com/";
