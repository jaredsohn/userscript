// ==UserScript==
// @name           DotDX - FortheGoodofAll with land
// @namespace      tag://kongregate
// @description    Basically yet another dotd script
// @author         SReject, chairmansteve, tsukinomai(Shylight)?, JHunz, wpatter6, MoW, true_heathen, HG, mutikt, PDrifting
// @version        1.0.14
// @date           05.26.2013
// @grant          none
...
// if any1 needs a simple way to calculate damage: atk*4+def+legionpower*5
	...
	window.SRDotDX = {
		version: {major: "1.0.14", minor: "FortheGoodofAll with land"},
		...
		load: function () {
			if (typeof holodeck == 'object' && holodeck.ready && typeof ChatDialogue == 'function' && typeof activateGame == 'function' && typeof document.getElementById('kong_game_ui') != 'null') {
				...
				holodeck.addChatCommand("script", function(deck,text) {
					SRDotDX.gui.FPXdoWork('http://userscripts.org/scripts/show/156729');
					return false;
				});
				holodeck.addChatCommand("update", function(deck,text) {
					...
					d += 'You can check <a href="http://userscripts.org/scripts/show/156729" target="_blank">here</a> to see if your version is most current and update. <br><b>PLEASE REMEMBER TO REFRESH THIS PAGE IF YOU UPDATE</b>';
					SRDotDX.echo(d)
					return false;
				});
