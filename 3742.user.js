// ==UserScript==
// @name		  OGame Slanje reciklera bez komandera
// @namespace	 OGame Slanje reciklera bez komandera
// @description   Harvest
...
tas[i].parentNode.innerHTML = '<a href="#" onclick="doit(8, '+galaxy+', '+system+', '+pos+', 2, 1)">'+ifont+'</a>';
};}})();
