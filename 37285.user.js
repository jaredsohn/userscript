...
function linkInsert()
{
	...
	if(dtest.snapshotItem(0))
	{
		...
		'<tr>'+
		'<td align="center"><a href="build.php?gid=17"><img src="img/un/g/g17.gif" title="accès à votre marché" style="margin:0 5px"/></a></td>'+
		'<td align="center"><a href="build.php?gid=19"><img src="img/un/g/g19.gif" title="Accès à votre caserne" style="margin:0 5px"/></a></td>'+
		'<td align="center"><a href="allianz.php"><img src="img/un/g/g18.gif" title="Accès à votre alliance" style="margin:0 5px"/></td>'+
	  '</tr>'+
		'<tr>'+
		'<td align="center"><a href="build.php?gid=20"><img src="img/un/g/g20.gif" title="Accès à vos écuries" style="margin:0 5px"/></a></td>'+
		'<td align="center"><a href="build.php?gid=16"><img src="img/un/g/g16.gif" title="Accès à votre place de rassemblement" style="margin:0 5px"/></a></td>'+
		'<td align="center"><a href="build.php?gid=21"><img src="img/un/g/g21.gif" title="Accès à votre atelier" style="margin:0 5px"/></a></td>'+
	  '</tr>'
	'</table>';
		...
		document.getElementById('navi_table').innerHTML=document.getElementById('navi_table').innerHTML+'<tr><td align="center"><a href="build.php?gid=12"><img src="img/un/g/g12.gif" title="Accès à votre Armurerie" style="margin:0 5px"/></a></td></tr><tr><td align="center"><a href="build.php?gid=13"><img src="img/un/g/g13.gif" title="Accès à votre usine d\'armure" style="margin:0 5px"/></a></td></tr>'
