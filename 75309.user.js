...
var xTop = 50;
    ...
    if (footer_menu_left)
    {
        ...
        setToolTip('footer_building_gunsmith',  '<b>Zbrojíř</b>');
        setToolTip('footer_building_tailor',    '<b>Krejčí</b>');
        setToolTip('footer_building_general',   '<b>Obchod</b>');
        setToolTip('footer_building_hotel',     '<b>Hotel</b>');
        setToolTip('footer_building_bank',      '<b>Banka</b>');
        setToolTip('footer_building_church',    '<b>Kostel</b>');
        setToolTip('footer_building_mortician', '<b>Funebrák</b>');
        setToolTip('footer_building_cityhall',  '<b>Radnice</b>');
        setToolTip('footer_building_saloon',    '<b>Salon</b>');
        setToolTip('footer_building_sheriff',    '<b>Sherif</b>');
        setToolTip('footer_building_market',    '<b>Trh</b>');
        setToolTip('footer_fingerboard',    '<b>Jít domů</b>');
