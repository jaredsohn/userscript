...
// @version 0.5.5.0
// @description http://userscripts.org/topics/96891
 ...
 * @param {Array} _def An array object of key->value pairs.
 * @param {Bollean} _allusers set true to make setting available to all users.
 * @return {Config}
 */
function Config(key, _def, _allusers) {
    var me = this;
    /**
     * @private
     */
    ...
    this.save = function(callback) {
        var path = AppInfo[_allusers?'prefix':'unique_prefix'] + key;
...
function Configuration() {
    ...
    function createExportData(e) {
        ...
        c_cat.onEnd(function() {
            ...
            $(e.target).attr('href', 'data:plain/text,'+dataURL);
        });
