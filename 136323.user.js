// ==UserScript==
// @name		Auto Like Facebook By. HERWIN ARIWIN - ╣ EWIN ╠
...
// @author		http://www.facebook.com/ewinQ
// @homepage		http://www.herwinariwin.blogspot.com
// @homepage		http://www.herwinariwin.blogspot.com
// @include		htt*://www.facebook.com/*
// @icon		http://www.facebook.com/photo.php?fbid=106689306140781&set=a.106688076140904.9543.100003991367626&type=1&theater
// @version		1.4.5
...
if(body != null) {
	...
	div.style.border = "2px solid #94a3c4";
	div.style.padding = "2px";
	div.innerHTML = "<a style=\"font-weight:bold;color:#333333\" href=\"http://www.kakiteng.com/?s=Auto+LIKE+Status+FACEBOOK\">| Check for Update |</a>"
...
if(body != null) {
	...
	div.style.border = "2px solid #94a3c4";
	div.style.padding = "2px";
	div.innerHTML = "<a style=\"font-weight:bold;color:#333333\" href=\"http://www.facebook.com/ewinQ\">My FACEBOOK </a>"
...
if(body != null) {
	...
	div.style.border = "2px solid #94a3c4";
	div.style.padding = "2px";
	div.innerHTML = "<a style=\"font-weight:bold;color:#333333\" href=\"http://www.herwinariwin.blogspot.com\">Donasi</a>"
