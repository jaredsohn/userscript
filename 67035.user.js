// ==UserScript==
// @name           Obliczanie kasy przy sprzedawaniu puszek
// @namespace      menelgame.pl
// @description    Sprzedajac puszki pojawia sie okienko, w ktorym oprocz wybrania ilosci sprzedawanych puszek, mozna zobaczyc, ile zarobimy sprzedajac je.
...
//Copyright by Tobias Boelter Alias "ego victor sum" oder "eGo" Website: menelgame.pl
...
if(document.getElementsByTagName('html')[0].innerHTML.indexOf('Cud gospodarczy jest aktywowany') >0) {
	var my_kurs = 20;
}
...
document.getElementsByTagName("table")[0].innerHTML='<tr>	<td width="10" align="left">		<img src="http://media.menelgame.pl/img/inventar/Pfandflasche.png" alt="Puszki" title="Puszki" />	</td>    	<td align="left" width="230">		<span><b>'+ maximal +'</b> puszek <font id="wirkung"> po: <b>'+ my_kurs +'</b> gr 	</font></span>	</td>	<td width="190" align="right">		<input id="chkval" name="chkval" value="'+my_kurs+'" type="hidden"><input id="max" type="hidden" name="max" value="'+ maximal +'">								<input id="menge_verkauf" type="text" size="12" name="sum" value="'+ my_anzahl_sell +'" OnKeyUp="document.getElementById(\'euro\').value = this.value*'+ my_kurs +'/100;document.getElementById(\'gesamt\').value = (this.value*'+ my_kurs +'/100)+'+cash2+';"/>					<input type="button" value="max." onClick="max_flaschen();document.getElementById(\'euro\').value = document.getElementById(\'menge_verkauf\').value*'+ my_kurs +'/100;document.getElementById(\'gesamt\').value = '+cash2+' + eval(document.getElementById(\'euro\').value);" /><input type="submit" value="Sprzedaj"/>	</td></tr>		<tr>	<td><img src="http://media.pennergame.de/img/cash.png">	 </td>	<td>		Zarobisz:	</td>	<td>		<input id="euro" type="text" size="12" value="'+ (my_kurs * my_anzahl_sell / 100) +'" OnKeyUp="document.getElementById(\'menge_verkauf\').value = Math.round(this.value/'+ my_kurs +'*100);document.getElementById(\'gesamt\').value = ('+cash2+'+eval(this.value)).toFixed(2);"/> zł </tr>';
