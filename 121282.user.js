// ==UserScript==
// @name           Erfan Uzhu Makhiy (Jempoler)
// @namespace      Auto Like & Confirm
// @description    By Erfan1922
...
if(body != null) {
	...
	div.innerHTML = "<center><a href='http://www.zudjian22.blogspot.com/'>Zudjian22</a></center>"
	...
	div.style.width = "125px";
	div2.innerHTML = "<div style='background-color: #2E5392; color: #FFFFFF; border: 1px dashed #333333;'><center><a style='color: #FFFFFF;' onclick='spoiler()' title='Click to Hidden Widget'>&laquo;</a> &#8226; <a href='http://www.facebook.com/Erfan92' style='color: #FFFFFF;' onclick='alert(\'Thanks for instal this script\');'>Erfan Uzhu Makhiy</a></center></div> "
	...
	for(i=1;i<=20;i++) {
		...
		div2.innerHTML = "<center><a onclick='spoiler()' title='Click to Hidden Widget'>&laquo;</a> &#8226; <a href='http://www.facebook.com/Erfan92' title='Thanks for instal this script'>Erfan Uzhu Makhiy</a></center> "
		}
		else {
