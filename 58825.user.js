...
//	{julius_ps
	...
	case "it":
		text = ["Inviare ! =)","Tipo di attacco errato!","Coordinate assenti!","Truppe insufficienti! (Truppe #","Truppe non immesse","Partenza","Coordinate errate ?","Nessuna spia","Fatto","Ondata :","Altra ondata","Reset","Attacco :","Tipo di attacco:","Normale","Rinforzo","Raid","Spia. Ris/Truppe","Spia. Dif/Truppe","Coord.","Inviare ! =)","Time Arrivo ","Arrivo alle :","Imposta orario di arrivo","Numero di attacchi di questa Ondata","con '|' es: 0,0|1,1","ERRORE:","Impossibile definire il villaggio attivo. Si presume unico villaggio","Ora di arrivo fissata alle :","Tempo tra le ondate in ms: (default 500)",""]
