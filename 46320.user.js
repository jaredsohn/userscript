// GameTrailers.com - EZ Download
// Version 2.4.1 BETA!
// 2012-05-20
// Copyright (c) 2009-2011, Byron Rogers
...
// select "GameTrailers.com - EZ Download", and click Uninstall.
//
// --------------------------------------------------------------------
//
// ==UserScript==
// @name          GameTrailers.com - EZ Download
// @namespace     http://www.Daem0nX.com (ByronRogers@gmail.com)
// @description   Adds menu (bottom right) with support for SD/HD file downloads - trailers, user movies. No longer supports gametrailers tv (gttv) and bonusround.
// @version		  2.4.1
// @notes		  Fixed menu and overlay border radius not working in Firefox 13 beta.<br/>Fixed menu error message using wrong id.<br/>Fixed typo in XHR header.<br/>Upgraded jQuery from 1.6.4 to 1.7.2.<br/>^Changed .live() / .bind() and .unbind() to .on() and .off().
// @include       http://www.gametrailers.com/player/*
// @include       http://www.gametrailers.com/video/*
// @include       http://www.gametrailers.com/user-movie/*
// ==/UserScript==

/********
// Removed for 2.1.0 due to RTMPE (encrypted streams) and time constraints
// @include		  http://www.gametrailers.com/episode/gametrailers-tv/*
// @include		  http://www.gametrailers.com/episode/bonusround/*
********/
...
var scriptName = 'GameTrailers.com - EZ Download';
var scriptId = '46320';
var scriptVersion = '2.4.1';
var scriptUpdateText = 'Fixed menu and overlay border radius not working in Firefox 13 beta.<br/>Fixed menu error message using wrong id.<br/>Fixed typo in XHR header.<br/>Upgraded jQuery from 1.6.4 to 1.7.2.<br/>^Changed .live() / .bind() and .unbind() to .on() and .off().';
// === Stop editing here. ===
...
var debugGM = false;
var isWebkit = false;
var donationLink_paypal = 'https://www.paypal.com/cgi-bin/webscr?cmd=_s-xclick&hosted_button_id=YMU9GMU6Y69D8';
var donationLink_flattr = 'https://flattr.com/thing/412440/GameTrailers-EZ-Download';
...
//Default site icon - http://www.gametrailers.com/favicon.ico
var icon_ico = 'data:image/x-icon;base64,AAABAAQAEBAQAAAAAAAoAQAARgAAABAQAAAAAAAAaAUAAG4BAAAgIBAAAAAAAOgCAADWBgAAICAAAAAAAACoCAAAvgkAACgAAAAQAAAAIAAAAAEABAAAAAAAwAAAAAAAAAAAAAAAAAAAAAAAAAAAAAAAAACAAACAAAAAgIAAgAAAAIAAgACAgAAAwMDAAICAgAAAAP8AAP8AAAD%2F%2FwD%2FAAAA%2FwD%2FAP%2F%2FAAD%2F%2F%2F8AAAAAAAAAAAAAAEREREQAAAAETMzMxEAAAETMzMzMRAAEQAAAwAAEQAQP%2F%2FAA%2FwxAAHcIdwB3DEAA%2Fw%2F%2FAP8MQAD%2FAAAA%2FwAABA%2F%2F%2F%2F%2F%2F%2FwAEwAAAAAAAAARMzMzMzMRAAETMbubMRAAABEzMzMRAAAAARERERAAAAAAAAAAAAAD%2F%2FwAA8A8AAOAHAADAAwAAgAEAAIABAACAAQAAgAEAAIABAACAAQAAgAEAAIABAADAAwAA4AcAAPAPAAD%2F%2FwAAKAAAABAAAAAgAAAAAQAIAAAAAABAAQAAAAAAAAAAAAAAAQAAAAAAAAAAAAAAAIAAAIAAAACAgACAAAAAgACAAICAAADAwMAAwNzAAPDKpgDU8P8AseL%2FAI7U%2FwBrxv8ASLj%2FACWq%2FwAAqv8AAJLcAAB6uQAAYpYAAEpzAAAyUADU4%2F8Ascf%2FAI6r%2FwBrj%2F8ASHP%2FACVX%2FwAAVf8AAEncAAA9uQAAMZYAACVzAAAZUADU1P8AsbH%2FAI6O%2Fw
C5uZZ1boGi4cvrc8J1gwrHEI1euAw47M1xQKswXcuBrEuUO8sVKHVAUCndNID01hrdiZX%2F%2Btb3gQGjxixc2nX%2FBkgS5Hs5QrGXnJIsmlIglCW2UqiAoptQmiFkhcQaY%2FwG4ty0aOJnLrWgsPRwa5x9eONsvF8vuqDfO0HRVXF7p31A0lwLqnUJMzjdGxXRe7euArCFBsDMx3%2F1b%2B24dPb8bPeH%2B43TvtTqfP4XS520SrakOu1RrLlYqUVhSp8e%2FMH%2FwSLypuwkUUAAAAAElFTkSuQmCC';
...
$ljq("#gmmnu").html(""
		+"\n<div id='gmmnu_title' data-title='GameTrailers Download'>GameTrailers Download</div>\n"
		+"<div id='gmmnu_menu'>\n"
		...
		+"</div>\n"
		+"<div id='gmmnu_links_um'>\n"
			+"<div class='header'>User Movie:</div>\n"
			+"<div class='status'>Searching...</div>\n"
			+"<div id='gmmnu_linksfiles_um'></div>\n"
		+"</div>\n"
		+"</div>\n"
		+"<div id='gmmnu_err'>\n"
...
function showError() {
	...
	$ljq("#gmmnu_links_um").hide();
	//Show Err
	$ljq("#gmmnu_err").show();
	$ljq("#gmmnu_err").attr("data-active", "true");
}

function loopfailsafe() {
	$ljq("#gmmnu_err #gmmnu_errmsg").html("This page has hit an infinite loop failsafe. We're investigating the cause which seems to only happen when Javascript is enabled for GameTrailers. Click the Script Homepage icon (above) for up-to-date info.");
	showError();
	GMlog("SDLink: "+SDLink+" HDLink: "+HDLink);
}
...
var trailers = {
  ...
  sd : {
    flv : {name : "Flash", ext : "flv", link : "", size : ""},
    mov : {name : "Quicktime", ext : "mov", link : "", size : ""},
    wmv : {name : "WMV", ext : "wmv", link : "", size : ""},
    mp4 : {name : "MP4 for iPod", ext : "mp4", link : "", size : ""}
  },
  hd : {
    flv : {name : "Flash", ext : "flv", link : "", size : ""},
    mov : {name : "Quicktime", ext : "mov", link : "", size : ""},
...
//GMlog(trailers.sd.mp4.name);
//GMlog(trailers.sd[''+trailers.active.sd+''].name);

var curwindow = window.location.toString();
//alert(curwindow);
try {
pattern = /(http:\/\/.*\.gametrailers.com\/(video|user-movie|episode)\/.*\/)([0-9]{1,99}).*/ig;
matches = curwindow.match(pattern);
//alert(matches);
//alert(matches[0].replace(pattern, "$2"));
Pagebase = matches[0].replace(pattern, "$1");
...
//alert(Pageid);
//alert(Vidtype);
GMlog(Pageid+" : "+Vidtype);
pattern = "";
matches = "";
} catch (e) {
	showError();
	GMlog("curwindow error!");
}

if (Vidtype == 'video') {
	$ljq("#gmmnu_links_sd").show();
	$ljq("#gmmnu_links_hd").show();
} else if (Vidtype == 'user-movie') {
	$ljq("#gmmnu_links_um").show();
} else {
	$ljq("#gmmnu_err").show();
}
...
/*
* Check for SD and HD buttons / pageid
* Determine if on SD or HD page
* Determine if alt quality exists
* Call display
*/
function preTrailerLinks() {	
	GMlog(".hdButton: "+$ljq("span[class='hdButton']").length);
	if ($ljq("span[class='hdButton']").length > 0) {
		var zzBtnLink = $ljq("span[class='hdButton'] a").attr("href");
		var zzBtnType = $ljq("span[class='hdButton'] a img").attr("src");
		//Get ButtonLink
		pattern = /video\/.*?\/([0-9]+)/i;
		matches = zzBtnLink.match(pattern);
		zzBtnLink = matches[0].replace(pattern, "$1");
		GMlog("zzBtnLink: "+zzBtnLink);
		//Get ButtonType
		pattern = /(watchin(SD|HD)btn)/i;
		matches = zzBtnType.match(pattern);
		zzBtnType = matches[0].replace(pattern, "$2");
		GMlog("zzBtnType: "+zzBtnType);
		if (zzBtnType == "SD") {
			//Set SDid to external id
			SDid = zzBtnLink;
    		skipSD = false;
    		GMlog("#SDMovie skipSD false");
    		//Set HDid to current Pageid
			HDid = Pageid;
			skipHD = false;
		}
		if (zzBtnType == "HD") {
			//Set HDid to external id
			HDid = zzBtnLink;
			skipHD = false;
			GMlog("#HDMovie skipHD false");
			//Set SDid to current Pageid
			SDid = Pageid;
			skipSD = false;
		}
	} else {
	...
	GMlog("SDid="+SDid+ " HDid="+HDid);
	GMlog("preTrailerLinks call displayTrailerLinks");
	displayTrailerLinks();
}

/*
* If SDLink or HDLink are blank then request XML for link
* If SDLink or HDLink are not blank then append to menu but remain hidden
* Call filecheck
*/
function displayTrailerLinks() {
  //alert(SDid);
  //alert(skipSD+" : "+skipHD);
  
  if (SDLink == "" && SDid !== "" && !skipSD) {
    //alert("Get SD "+SDid);
    $ljq("#gmmnu_links_sd .status").html("Loading...");
    GMlog("displayTrailerLinks getTrailerLinks SD");
    SDfailsafe = SDfailsafe + 1;
    //GMlog("SDfailsafe: "+SDfailsafe);
    if (SDfailsafe <= 1) {
    	getTrailerLinks(SDid);
    } else {
    	loopfailsafe();
    }
  } else if (HDLink === "" && HDid !== "" && !skipHD) {
    //alert("Get HD "+HDid);
    $ljq("#gmmnu_links_hd .status").html("Loading...");
    GMlog("displayTrailerLinks getTrailerLinks HD");
    HDfailsafe = HDfailsafe + 1;
    //GMlog("HDfailsafe: "+HDfailsafe);
    if (HDfailsafe <= 1) {
    	getTrailerLinks(HDid);
    } else {
    	loopfailsafe();
    }
  } else {
  
	//http://download.gametrailers.com/gt_vault/13638/t_dirt3_vr_gt_mbrg.mov
    //alert("Display");
    //skipSD = true;
    //skipHD = true;
    if (skipSD && skipHD) {
    	GMlog("showError - skipSD and skipHD");
    	showError();
    } else {
      //Display links
		if (!skipSD) {
        ...
        GMlog("menu append SDLink");
	    $ljq("#gmmnu_linksfiles_sd").append(''
			+'<div class="link"><a title="'+ trailers.sd[''+trailers.active.sd+''].name +'"'
			+'href="'+ SDLink +'" '
			+'class="icon_'+trailers.active.sd+'">' + trailers.sd[''+trailers.active.sd+''].name + '</a></div>'
			+'');
		fileCheck("sd", SDLink);
			
		} else {
			$ljq("#gmmnu_links_sd").hide();
			GMlog("displayTrailerLinks #gmmnu_links_sd hide");
		}
		if (!skipHD) {
		//alert("HDLINK "+HDLink);
        //$ljq("#gmmnu_linksfiles_hd").html('');
        
		GMlog("menu append HDLink");
		$ljq("#gmmnu_linksfiles_hd").append(''
			+'<div class="link"><a title="'+ trailers.sd[''+trailers.active.hd+''].name +'"'
			+'href="'+ HDLink +'" '
			+'class="icon_'+trailers.active.hd+'">' + trailers.sd[''+trailers.active.hd+''].name + '</a></div>'
			+'');
		fileCheck("hd", HDLink);
		
		} else {
			$ljq("#gmmnu_links_hd").hide();
			GMlog("displayTrailerLinks #gmmnu_links_hd hide");
		}
	}
  }
}
...
/*
* Get XML file for trailer link
* Call display again after saving value
*/
function getTrailerLinks(val) {
GMlog("getTrailerLinks : http://www.gametrailers.com/neo/?page=xml.mediaplayer.Mediagen&movieId="+val);
GM_xmlhttpRequest({
	method: 'GET',
	url: "http://www.gametrailers.com/neo/?page=xml.mediaplayer.Mediagen&movieId="+val,
	headers: {'User-agent': 'Mozilla/4.0 (compatible) Greasemonkey','Accept': 'text/plain'},
	onload: function(res) {
	if (res.status == "200") {
    var text = res.responseText;
    ...
    GMlog(text);
    //alert(res.status);
    //alert($ljq(text).find("src").text());
    //var validfile = $ljq(text).find("src").text();
    var validfile = text;
    var filebaselink = '';
    var fileext = '';
    //validfile = split.validfile("/");
    //alert(validfile.length);
    //alert(validfile);
    //pattern = /(.*\/(.*)\..*)/ig;
	pattern = /<src>((.*?)\.((mp4|mov|wmv|flv)))<\/src>/i;
	matches = validfile.match(pattern);
	//alert(matches[0].replace(pattern, "$2"));
	validfile = matches[0].replace(pattern, "$3");
	fileext = validfile;
	//filebaselink = matches[0].replace(pattern, "$2");
	filebaselink = matches[0].replace(pattern, "$1");
	GMlog(validfile);
	GMlog(filebaselink);
	if (validfile !== '') {
		validfile = true;
    ...
    if (val === SDid) {
    	//if (res.status == "200") {
			...
			//SDLink = $ljq(text).find("src").text();
			//SDLink = SDLink.replace(".flv", "");
			SDLink = filebaselink;
			GMlog("getTrailerLinks SDLink: "+SDLink);
			trailers.active.sd = fileext;
			GMlog("trailers.active.sd: "+trailers.active.sd);
			if (!validfile) {
				skipSD = true;
				$ljq("#gmmnu_links_sd").hide();	
				//alert("!valid SD");
		...
		//} else {
			//$ljq("#gmmnu_links_sd").hide();
			//GMlog("getTrailerLinks #gmmnu_links_sd hide");
		//}
    } else if (val === HDid) {
    //alert(text);
    	//if (res.status == "200") {
			$ljq("#gmmnu_links_hd .status").html("Parsing...");
			//HDLink = $ljq(text).find("src").text();
			//HDLink = HDLink.replace(".flv", "");
			HDLink = filebaselink;
			GMlog("getTrailerLinks HDLink: "+HDLink);
			trailers.active.hd = fileext;
			GMlog("trailers.active.hd: "+trailers.active.hd);
			if (!validfile) {
				skipHD = true;
				$ljq("#gmmnu_links_hd").hide();	
				//alert("!valid HD");
		...
		//} else {
			//$ljq("#gmmnu_links_hd").hide();
			//GMlog("getTrailerLinks #gmmnu_links_hd hide");
		//}
    }
    //alert(text);
    GMlog("getTrailerLinks call displayTrailerLinks");
    displayTrailerLinks();
	}
	}//200
});
...
function getUserMovieLinks() {
//alert("displayUserVideoLinks");
$ljq("#gmmnu_links_um .status").html('Loading...');
getRemote("http://mosii.gametrailers.com/getmediainfo2.php?umid="+Pageid);
GMlog("http://mosii.gametrailers.com/getmediainfo2.php?umid="+Pageid);
}

function displayUserMovieLinks(val) {
var dlurl, dltitle;
pattern = /umfilename=(.*?)&/ig;
matches = val.match(pattern);
//alert(matches[0].replace(pattern, "$1"));
var umname = matches[0].replace(pattern, "$1").toString();
//alert(umname);
ZZname = umname.split("%2F");
umid = ZZname[0];
umname = ZZname[1];
//alert(umid+"_"+umname);
dlurl = "http://umtrailers.gametrailers.com/gt_usermovies/um_"+umid+"/"+umname+".flv";
	//$ljq("#gmmnu_linksfiles_um").html('');
    $ljq("#gmmnu_linksfiles_um").append(''
    	+'<div class="link"><a title="User Movie" href="'+ dlurl +'" class="icon_flv">User Movie</a></div>'
    	+'');
    fileCheck("um", dlurl);
}

function getRemote(rurl) {
//alert("getURL");
//alert(rurl);
GMlog("getRemote : "+rurl)
//if (rurl != 0) {
GM_xmlhttpRequest({
  method: 'GET',
  url: rurl,
  ...
  onload: function(responseDetails) {
    ...
    if (Vidtype === 'user-movie') {
    //alert("user");
    $ljq("#gmmnu_links_um .status").html('Parsing...');
    displayUserMovieLinks(text);
    }
  }
});
//}
...
/*
* Get file details append to menu link then show
*/
function fileCheck(type, url, wait) {
	var url = $ljq.trim(url);
	//break url - debugging
	//url = url.replace(/\.flv/ig, '1.flv');
	var check = false;
	GMlog("fileCheck : "+url);
	GMlog("skipSD: "+skipSD+" / skipHD: "+skipHD);
	//alert(skipSD+" : "+skipHD);
	//if (((type == 'sd' && !skipSD) || (type == 'hd' && !skipHD) || (type == 'um')) && url !== "") {
	if (url !== "") {
		if (type == 'sd' && !skipSD) { check = true; }
		if (type == 'hd' && !skipHD) { check = true; }
		if (type == 'um') { check = true; }
	}
	if (check) {
	GM_xmlhttpRequest({
    method: "HEAD",
    //url: 'http://flvseek.gametrailers.com/gt_vault/br_402_pt1234_az98_hd.flv',
    url: url,
    headers: {'User-agent': 'Mozilla/4.0 (compatible) Greasemonkey','Accept': 'text/plain'},
    onload: function(res) {
    	//alert(res.status);
    	if (res.status == "200") {
    		...
    		//alert(text);
    		GMlog(text);
			pattern = /.*(Content-Length:\s?([0-9]{1,99}))/ig;
			matches = text.match(pattern);
			//alert(matches[0].replace(pattern, "$2"));
			text = matches[0].replace(pattern, "$2");
			text = Math.round(((text/1024)/1024));
			//alert(text);
			GMlog("size: "+text);
			text = '<span class="size">['+text+'MB]</span>';
			//alert(type+" : "+url+" : "+text);
			$ljq("#gmmnu_linksfiles_"+type+" .link a[href='"+url+"']").append(text);
			$ljq("#gmmnu_links_"+type+" .status").hide();
			$ljq("#gmmnu_linksfiles_"+type+" .link a[href='"+url+"']").css("display","block");
		} else {
			GMlog("fileCheck HIDE : #gmmnu_linksfiles_"+type+" .link a[href='"+url+"']");
			//$ljq("#gmmnu_links_"+type).hide();
			$ljq("#gmmnu_linksfiles_"+type+" .link a[href='"+url+"']").hide();
			//$ljq("#gmmnu_links_"+type+" .status").hide();
			var ext = url.replace(/.*?\./ig, '');
			GMlog("ext : "+ext);
			if (ext === "flv") {
				if (type === "sd") {
					skipSD = true;
				...
				$ljq("#gmmnu_linksfiles_"+type).hide();
			}
		}
		if ($ljq("#gmmnu_linksfiles_sd").css("display") == 'none' && $ljq("#gmmnu_linksfiles_hd").css("display") == 'none') {
			$ljq("#gmmnu_err #gmmnu_errmsg").html("Looks like the files haven't been uploaded yet, check back later.");
			showError();
		}
    return;
    }
...
//
//  > v2.2.0 - GTTV and BonusRound now use RTMPE (encrypted) streams, when found an Error Alert menu will appear.
//    It seems that some older GTTV and BR episodes still offer regular streams.
//  > v2.3.0 - Removed GTTV and BonusRound code.
//

//
// Future
//	Add options screen for settings
//
...
//  Upgraded jQuery from 1.6.4 to 1.7.2.
//    Changed .live() / .bind() and .unbind() to .on() and .off().
//
// 2011-10-15 - 2.4.0
//  Added initial support for Chrome.
//
// 2011-10-09 - 2.3.0
//  Fixed code for Trailer links.
...
//  Removed code for GTTV and BonusRound.
//
// 2011-06-06 - 2.2.4
//  Modified code from requesting XML data to using data in the page.
//  ^Quick fix for the infinite loop.
//
// 2011-06-06 - 2.2.3
//  Added code to catch infinite loop when Javascript is enabled for GameTrailers.
//    Please update immediately.
//  Upgraded jQuery from 1.6 to 1.6.1.
//
// 2011-05-31 - 2.2.2
//  Fixed menu showing frozen status if flv or all files failed to load.
//
// 2011-05-29 - 2.2.1
//  Changed Flattr link.
...
//  Fixed overlay tabs changing the url location.
//  Added some error catching code.
...
//  Removed check for WMV file - new trailers 404 on WMV.
//  Removed GTTV and BonusRound from includes due to encrypted streams and time constraints.
//
// 2010-12-21 - 2.1.0
//  Added Configuration icon and overlay.
//  Fixed debug code for Update and Settings.
//  Improved file size check function.
//    Only checks all files if FLV exists.
//    Hides download link if file doesn't exist.
//  Code clean up for file size checks.
//
// 2010-12-13 - 2.0.0
...
//  Updated GTTV file download code due to GT code changes.
//
// 2010-03-13 - 1.2
//  Recoded portions of the script and code clean up
//  Recoded menu, now shows status of processes
//    Waiting - Waiting for page to load
//    Loading - Loading external data
//    Parsing - Parsing data for links
//  New update notification system
//    Brand new custom GUI
//    Only checks for updates once per 24 hours
//
// 2010-01-30 - 1.1
//  Updated trailer file download code due to GT code changes.
//    Once again able to download without being logged in.
//  Added FLV choice in SD and HD links.
//  Disabled update checker until the new one is ready.
//
// 2009-10-20 - 1.0
//  Updated trailers code due to button changes.
//  Updated parse error alert to be less obtrusive.
//    No longer alert box prompts, it will show in the menu.
//  Added 'episode' support.
//    Added support for gametrailers-tv downloads.
//    Added support for bonusround downloads.
//  Updated code to check for /episode/bonusround/* and /episode/gametrailers-tv/*
//
// 2009-10-05 - 0.9
//  Added support for user movie downloads.
//    Updated code to check for /user-movie/*
//
// 2009-10-02 - 0.8
//  Fixed a parse error that occured when both an HD and SD link were disabled.
//
// 2009-09-24 - 0.7 & 0.7.1 & 0.7.2
//  Fixed / updated version compare in update checker.
//    Now handles multiple decimals for major.minor.build
//  Made other changes and corrections to update checker.
//  Created, found and fixed issue with my changes to the update
//    checker that broke the main script functions
//
// 2009-09-24 - 0.6.1
//  Forgot to update the update alert info.
//
// 2009-09-23 - 0.6
//  Fixed parse error due to change in links
//    Updated code to parse for IDs
//
// 2009-07-27 - 0.5
//	Updated code to check for /player/* and /video/*
//	Added check for SD/HD content
//	  Added separator in menu for content types
//	Added script update checker
//	Added jQuery 1.3.2
//
// 2009-04-12 - 0.4
//      Added support for file type images
//      Added base64 images to save bandwidth
//        Be nice to remote servers =)
//
// 2009-04-10 - 0.3
//      Added support for mp4 download
//
// 2009-04-09 - 0.2 - Initial release
//	Added AppleTrailers menu (bottom right)
//	  Thanks MES - http://manuelseeger.de
//
// 2009-04-08 - 0.1 - Test build
//	Auto expands download link area
//