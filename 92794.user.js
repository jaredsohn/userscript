...
//	delayButton.setAttribute('style','margin-left:4px; margin-top:20px');
...
//{
//	//var element = document.getElementsByClassName("headerAboveSubsection airBackground")[0];
//    //var first = document.getElementsByClassName(" ua_js_yes")[0];
//    var element = document.getElementsByClassName("skipNavigationLink")[0];
//
