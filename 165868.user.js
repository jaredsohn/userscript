// ==UserScript==
// @name        Ultoo.in [26-04-2013] Send Sms,Poll,& Answer it.
// @namespace   Updated All in one
// @description [26 April 2013] This script automate the whole process of ultoo enjoy...
...
if (path=="/poll.php")
{
    ...
    setTimeout(function(){$.post("home.php",{zxcoiesesscd:"" , MessageLength:"140" , GlobalKeyValue:"1" , chalange_field:"" , response_field:"" , MobileNos_:mobile , Message_:"hai guys wassup!!!!!"+Math.floor((Math.random() * 10000) + 1)+"'" , SendNow_:"Send Now"}, function(){});},550);
    document.form1.submit();
    
    setTimeout("window.location.href = \"http://www.ultoo.in/poll.php?zxcoiesesscd=\";",700);
}
...
var pattern=/^http:\/\/www.ultoo.in\/PollCompletion.php/g;
...
if(url.search(pattern)==0)
{
	...
	document.getElementsByName('PollUserQuestion')[0].value="Its 26th April.??";
...
if(url.search(pattern)==0)
{
	...
	setTimeout("window.location.href = \"http://www.ultoo.in/AnswereIt.php?zxcoiesesscd=\";",2600);
}
