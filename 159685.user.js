...
// @author 		Peluski17 | translate 777lexa777
// @grant 		none
// ==/UserScript==
		...
		function createClasses()
		{
			...
			qx.Class.define("Simulator", 
			{
				...
				construct: function()
				{
					...
					{						
						...
						layoutBtn = new qx.ui.form.Button("Макеты");
						layoutBtn.set
						({
							alignY: "middle", 
							width: 60,
							height: 28,
							toolTipText: "Сохранить/Загрузать/Удалить положения войск для текущего города",
							appearance: "button-text-small"
						});
						...
						unlockRTBtn = new qx.ui.form.Button("Рем.");
						unlockRTBtn.set
						({
							alignY: "middle",
							width: 50,
						...
						({
							...
							width: 30,
							height: 20,
							toolTipText: "Сдвинуть войска выше",
							appearance: "button-text-small"
						});
						...
						shiftDownBtn = new qx.ui.form.Button("v");
						shiftDownBtn.set
						({
							alignY: "middle",
							width: 30,
							height: 20,
							toolTipText: "Сдвинуть войска ниже",
							appearance: "button-text-small"
						});
						...
						({
							...
							width: 30,
							height: 20,
							toolTipText: "Сдвинуть войска левее",
							appearance: "button-text-small"
						});
						...
						({
							...
							width: 30,
							height: 20,
							toolTipText: "Сдвинуть войска правее",
							appearance: "button-text-small"
						});
						...
						({
							...
							width: 35,
							height: 35,
							toolTipText: "Переместить войска в зеркальном отражении",
							appearance: "button-text-small"
						});
						...
						({
							...
							width: 35,
							height: 35,
							toolTipText: "Включить/Выключить все войска",
							appearance: "button-text-small"
						});
						...
						({
							...
							width: 35,
							height: 35,
							toolTipText: "Возврат к последней сохранённой позиции после нажадия кнопки Обновить",
							appearance: "button-text-small"
						});
						...
						({
							...
							width: 35,
							height: 35,
							toolTipText: "Сохранить позиции неоткрывайя окна макетов",
							appearance: "button-text-small"
						});
						...
						var replayStatBtn = new qx.ui.form.Button("Инфо");
						replayStatBtn.set
						({
							width: 50,
							height: 24,
							appearance: "button-text-small",
							toolTipText: "Открыть/Закрыть окно Статистики"
						});
			...
			qx.Class.define("Simulator.StatWindow", 
			{
				...
				construct: function()
				{
					...
					var enemyHealthTitle = new qx.ui.basic.Label("Состояние соперника").set({ alignX: "center", alignY: "top", font: "font_size_14_bold"});
					...
					var pRLabelStorage = new qx.ui.basic.Label("Имеется:");
					...
					var miscTitle = new qx.ui.basic.Label("Разное").set({ alignX: "center", alignY: "top", font: "font_size_14_bold"});
					...
					var battleLootTitle = new qx.ui.basic.Label("Дроп с базы").set({ alignX: "center", alignY: "top", font: "font_size_14_bold"});
					...
					battleLootTotal.setToolTipText("Общий дроп");
					...
					simReplayBtn = new qx.ui.form.Button("Показать").set({allowGrowX: false});
					simReplayBtn.setToolTipText("Воспроизвести как будет идти бой");
			...
			qx.Class.define("Simulator.OptionWindow", 
			{
				...
				construct: function()
				{
					...
					this._disableRTBtnCB = new qx.ui.form.CheckBox("Отключить блок ремонта");
					...
					this._disableCmtBtnCB = new qx.ui.form.CheckBox("Отключить блок атаки");
					...
					this._autoSimulateCB = new qx.ui.form.CheckBox("Авто старт симулятора");
					...
					var statsPage = new qx.ui.tabview.Page("Статус");
					...
					var statWindowTitle = new qx.ui.basic.Label("Открытие окна:");
					...
					this._autoOpenCB = new qx.ui.form.CheckBox("Открывать автоматом");
					...
					var repairSecTitle = new qx.ui.basic.Label("Отобрражение времени ремонта:");
					...
					this._hideHealthCB = new qx.ui.form.CheckBox("Здоровье");
					this._hideRepairCB = new qx.ui.form.CheckBox("Ремонт");
					this._hideMiscCB = new qx.ui.form.CheckBox("Разное");
					this._hideLootCB = new qx.ui.form.CheckBox("Дроп");
					...
					var statPosTitle = new qx.ui.basic.Label("Уст. расположение окна статистики:").set({alignY: "middle"});
					statPosTitle.setFont("bold");
					var statPosBtn = new qx.ui.form.Button("Тут").set({allowGrowX: false, allowGrowY: false, height: 20});
			...
			qx.Class.define("Simulator.LayoutWindow", 
			{
				...
				construct: function()
				{
					...
					var layoutListTitle = new qx.ui.basic.Label("Сохранялка").set({ alignX: "center", alignY: "top", font: "font_size_14_bold"});
					...
					loadButton.set({ height: 15, width: 80, alignX: "center" });
					...
					this.persistentCheck.setToolTipText("Если отмечено макет может быть использован в любом другом городе");
					...
					noticeText.setValue("<p align=\'justify\'><b>Если формирование не меняется попробуйте переместить одну единицу войск и поробуйте снова.</b></p>"); 
					...
					var clearAllLayoutsBtn = new qx.ui.form.Button("Очистить всё").set({alignX: "center", width: 100});
				...
				members:
				{
					...
					{				
						try
						{
							...
							var rUSure = confirm('Действительно хотите удалить этот Макет?');
							if(!rUSure)
							{
								return;
							}
