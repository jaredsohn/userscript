...
// @description    Battle Order (eRepublik)
// @version        0.01
...
GM_xmlhttpRequest({
	method: 'GET',
	url: 'http://erepublix.net16.net/battle-order.php',
	...
	onload:function(response){
		...
		var $box_str = 	'	<div class="title">'+
				...
				'	<ul class="tabs">'+
				'		<li id="nationaltab">'+
				'			<a class="on latest_events" id="national">'+
				'				<span>' + company + '</span>'+
				'			</a>'+
				'		</li>'+
				'	</ul>'+
				...
				'						<span style="width: 50px; font-size: 14px; text-align:center;" class="round_btt-core">'+
				'							Serbu !'+
				'						</span>'+
				'					</span>'+
				'				</span>'+
