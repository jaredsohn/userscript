...
(function() {
        ...
        function createMapTweak() {
		    ...
		    obfAllianceName : null,
                    ...
                    initialize : function() {
                        ...
                        this.buttonMap = new qx.ui.form.Button("Harta");
                        this.buttonMap.set({
                            width : 80,
                        ...
                        // The Harta window
                        this.mapBox = new qx.ui.window.Window("Harta");
 ...
 var tt = "https://eaassets-a.akamaihd.net/cncalliancesgame/cdn/data/f202553333fcac7d610cfd0395ee2941.png";
                        var bt = new qx.ui.form.Button("Setari",tt);
                        bt.set({
                            appearance : "button-text-small",
                            toolTipText : "Stabileste filtrele pentru harta"
                        });
                        ...
                        this.settingsWnd.add(makeLbl("- Alege -"), {row:0, column:0});
                        this.settingsWnd.add(makeLbl("Alianta:"), {row:1,column:0});
                        this.settingsWnd.add(this.allianceSelect, {row:1, column:1});
                        this.settingsWnd.add(makeLbl("POI-uri:"), {row:2, column:0});
                        this.settingsWnd.add(this.poiSelect, {row:2, column:1});

                        bt = makeLbl("- Culori -");
                        bt.set({
                            		    value: '<a href="http://www.w3schools.com/html/html_colornames.asp" target="_blank">- Culori -</a>',
                            		    rich : true,
                            		    selectable: true
                            		  });
                        ...
                        this.settingsWnd.add(makeLbl("Teritoriul Aliantei:"), {row:11, column:0});
                        this.settingsWnd.add(makeTxt("allianceTerrainColor"), {row:11, column:1});

                        this.settingsWnd.add(makeLbl("Baze:"), {row:12, column:0});
                        this.settingsWnd.add(makeTxt("baseColor"), {row:12, column:1});

                        this.settingsWnd.add(makeLbl("Campuri:"), {row:13, column:0});
                        this.settingsWnd.add(makeTxt("campColor"), {row:13, column:1});

                        this.settingsWnd.add(makeLbl("Orase:"), {row:14, column:0});
                        this.settingsWnd.add(makeTxt("cityColor"), {row:14, column:1});

                        this.settingsWnd.add(makeLbl("Dusmani:"), {row:15, column:0});
                        this.settingsWnd.add(makeTxt("enemyBaseColor"), {row:15, column:1});

                        this.settingsWnd.add(makeLbl("Outposturi:"), {row:16, column:0});
                        this.settingsWnd.add(makeTxt("outpostColor"), {row:16, column:1});

                        this.settingsWnd.add(makeLbl("Orasul meu:"), {row:17, column:0});
                        this.settingsWnd.add(makeTxt("ownBaseColor"), {row:17, column:1});

                        this.settingsWnd.add(makeLbl("POI-uri:"), {row:18, column:0});
                        this.settingsWnd.add(makeTxt("poiColor"), {row:18, column:1});

                        this.settingsWnd.add(makeLbl("Tunele:"), {row:19, column:0});
                        this.settingsWnd.add(makeTxt("tunnelColor"), {row:19, column:1});

                        var changeColor = new qx.ui.form.Button("Salveaza");
                        changeColor.set({
                            appearance : "button-text-small",
                            toolTipText : "Salveaza lista culorilor"
                        });
