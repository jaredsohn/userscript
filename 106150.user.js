	...
	if (tr[i].className == 'odd' || tr[i].className == 'even') {
		...
		if (Unites_Stats[Quantite[IndiceJavaScript][0]] != 'undefined') {
			...
			if (Pourcent > 105/100 * Unites_Stats[Quantite[IndiceJavaScript][0]]) {
				Color = 'F4D00A';
			} if (Pourcent > 110/100 * Unites_Stats[Quantite[IndiceJavaScript][0]]) {
				Color = 'F4A40A';
				...
				Color = 'C1FB00';
			} if (Pourcent < 90/100 * Unites_Stats[Quantite[IndiceJavaScript][0]]) {
				Color = '88FB00';
			} if (Pourcent < 85/100 * Unites_Stats[Quantite[IndiceJavaScript][0]]) {
				Color = '0F0';
			} if (Pourcent < 81/100 * Unites_Stats[Quantite[IndiceJavaScript][0]] && Pourcent < 105/100 * Unites_Stats[Quantite[IndiceJavaScript][0]]){
				Color = 'FF0';
			}
