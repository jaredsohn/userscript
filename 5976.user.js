// ==UserScript==
// @author         Sujay and Platypus
// @name            GP2fix
// @namespace       n/a
// @description cleans up google to accomodate Googlepedia II
...
smart_remove(window.document,document.evaluate('/HTML[1]/BODY[1]/CENTER[2]/TABLE[1]/TBODY[1]/TR[1]/TD[1]', document, null, XPathResult.FIRST_ORDERED_NODE_TYPE,null).singleNodeValue,null,null,null);
smart_remove(window.document,document.evaluate('/HTML[1]/BODY[1]/CENTER[2]', document, null, XPathResult.FIRST_ORDERED_NODE_TYPE,null).singleNodeValue,null,null,null);
smart_remove(window.document,document.evaluate('/HTML[1]/BODY[1]/DIV[5]/TABLE[1]/TBODY[1]/TR[1]/TD[1]/FONT[1]', document, null, XPathResult.FIRST_ORDERED_NODE_TYPE,null).singleNodeValue,null,null,null);
...
set_style_script(window.document,document.evaluate('/HTML[1]/BODY[1]/TABLE[2]', document, null, XPathResult.FIRST_ORDERED_NODE_TYPE,null).singleNodeValue,"width: 480px;",null,null);
smart_remove(window.document,document.evaluate('/HTML[1]/BODY[1]/TABLE[1]/TBODY[1]/TR[1]/TD[3]/TABLE[1]/TBODY[1]/TR[1]/TD[1]/TABLE[1]/TBODY[1]/TR[1]/TD[1]/FONT[1]/A[3]/SUP[1]/FONT[1]', document, null, XPathResult.FIRST_ORDERED_NODE_TYPE,null).singleNodeValue,null,null,null);
