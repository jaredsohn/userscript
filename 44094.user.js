...
Link Original Image (no new tabs) - (c) 2005-2009 Johannes la Poutre, Matt Hickford
...
Version 1.25.1 (Johannes)
	- added Flickr search results and some more to enabled sites


Version 1.24.1 - 20090312 (Matt Hickford)
	- Links do not open in new tab unless you explicity use middle-click or similar.
...
// @name           Flickr Link Original Images (no new tabs)
