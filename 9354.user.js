// ==UserScript==
// @name            Take Back Google/
// @namespace       Platypus
// @include         http://www.google.com/
function do_platypus_script() {
do_modify_url_it(window.document,document.evaluate('/HTML[1]/BODY[1]/CENTER[1]/SPAN[1]/FONT[1]/B[2]/A[1]', document, null, XPathResult.FIRST_ORDERED_NODE_TYPE,null).singleNodeValue,/http:\/\/www\.google\.com\/intl\/ja\/options\//,'http://www.google.com/intl/en/options/',false);
};{
smart_remove(window.document,document.evaluate('/HTML[1]/BODY[1]/CENTER[1]/IMG[1]', document, null, XPathResult.FIRST_ORDERED_NODE_TYPE,null).singleNodeValue,null,null,null);
html_insert_it(window.document,document.evaluate('/HTML[1]/BODY[1]/CENTER[1]/FORM[1]', document, null, XPathResult.FIRST_ORDERED_NODE_TYPE,null).singleNodeValue,'<br><img src="http://www.google.com/intl/en_ALL/images/logo.gif"/></br><font size="-1"><b style="">¦§Ö</b>&nbsp;&nbsp;&nbsp;&nbsp;<a class="q" href="http://images.google.co.jp/imghp?ie=UTF-8&amp;oe=UTF-8&amp;hl=ja&amp;tab=wi" onclick="return qs(this)">;Ï</a>&nbsp;&nbsp;&nbsp;&nbsp;<a class="q" href="http://news.google.co.jp/nwshp?ie=UTF-8&amp;oe=UTF-8&amp;hl=ja&amp;tab=wn" onclick="return qs(this)">Ëåü¹</a>&nbsp;&nbsp;&nbsp;&nbsp;<a class="q" href="http://maps.google.co.jp/maps?ie=UTF-8&amp;oe=UTF-8&amp;hl=ja&amp;tab=wl" onclick="return qs(this)">0ó</a>&nbsp;&nbsp;&nbsp;&nbsp;<a class="q" href="http://groups.google.co.jp/grphp?ie=UTF-8&amp;oe=UTF-8&amp;hl=ja&amp;tab=wg" onclick="return qs(this)">°ëü×</a>&nbsp;&nbsp;&nbsp;&nbsp;<b><a href="/intl/ja/options/" class="q">more&nbsp;»</a></b></font>',true,false);
do_modify_html_it(window.document,document.evaluate('/HTML[1]/BODY[1]/CENTER[1]/SPAN[1]/FONT[1]/B[1]', document, null, XPathResult.FIRST_ORDERED_NODE_TYPE,null).singleNodeValue,/¦§Ö/,'Web',null);
do_modify_html_it(window.document,document.evaluate('/HTML[1]/BODY[1]/CENTER[1]/SPAN[1]/FONT[1]/A[1]', document, null, XPathResult.FIRST_ORDERED_NODE_TYPE,null).singleNodeValue,/;Ï/,'Images',null);
do_modify_html_it(window.document,document.evaluate('/HTML[1]/BODY[1]/CENTER[1]/SPAN[1]/FONT[1]/A[2]', document, null, XPathResult.FIRST_ORDERED_NODE_TYPE,null).singleNodeValue,/Ëåü¹/,'Groups',null);
do_modify_url_it(window.document,document.evaluate('/HTML[1]/BODY[1]/CENTER[1]/SPAN[1]/FONT[1]/A[1]', document, null, XPathResult.FIRST_ORDERED_NODE_TYPE,null).singleNodeValue,/http:\/\/images\.google\.co\.jp\/imghp\?ie=UTF-8&oe=UTF-8&hl=ja&tab=wi/,'http://images.google.com',false);
do_modify_url_it(window.document,document.evaluate('/HTML[1]/BODY[1]/CENTER[1]/SPAN[1]/FONT[1]/A[2]', document, null, XPathResult.FIRST_ORDERED_NODE_TYPE,null).singleNodeValue,/http:\/\/news\.google\.co\.jp\/nwshp\?ie=UTF-8&oe=UTF-8&hl=ja&tab=wn/,'http://groups.google.com',false);
do_modify_url_it(window.document,document.evaluate('/HTML[1]/BODY[1]/CENTER[1]/SPAN[1]/FONT[1]/A[3]', document, null, XPathResult.FIRST_ORDERED_NODE_TYPE,null).singleNodeValue,/http:\/\/maps\.google\.co\.jp\/maps\?ie=UTF-8&oe=UTF-8&hl=ja&tab=wl/,'http://news.google.com',false);
do_modify_html_it(window.document,document.evaluate('/HTML[1]/BODY[1]/CENTER[1]/SPAN[1]/FONT[1]/A[3]', document, null, XPathResult.FIRST_ORDERED_NODE_TYPE,null).singleNodeValue,/0ó/,'News',null);
do_modify_html_it(window.document,document.evaluate('/HTML[1]/BODY[1]/CENTER[1]/SPAN[1]/FONT[1]/A[4]', document, null, XPathResult.FIRST_ORDERED_NODE_TYPE,null).singleNodeValue,/°ëü×/,'Froogle',null);
do_modify_url_it(window.document,document.evaluate('/HTML[1]/BODY[1]/CENTER[1]/SPAN[1]/FONT[1]/A[4]', document, null, XPathResult.FIRST_ORDERED_NODE_TYPE,null).singleNodeValue,/http:\/\/groups\.google\.co\.jp\/grphp\?ie=UTF-8&oe=UTF-8&hl=ja&tab=wg/,'http://froogle.google.com',false);
smart_remove(window.document,document.getElementById('gbar'),null,null,null);
smart_remove(window.document,document.getElementById('gbarl'),null,null,null);
