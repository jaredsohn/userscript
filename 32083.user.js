...
var htmlQuoteB = "<div style='background: #00FFFF; border: 2px Blue solid; color: gray; font-size: 90%; margin-left: 20px; margin-right: 20px; padding: 2px 3px 2px 3px'>";
var htmlQuoteE = "</div>";
...
var signature = "";
var htmlSignature = newLineFixer + "http://lh6.ggpht.com/dgtppc/SKrM8D6vboI/AAAAAAAAAQI/aPiAo8SUNjo/articunofan.png";
/* /VARS:: Signature */
