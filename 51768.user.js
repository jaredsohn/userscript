...
var lang={
  ...
  co: {'newAlert': 'nouveau membre', 'newTotal': 'total nouveau membres', 'aband': 'abandon', 'totAban': 'total abandon', 'confirm': 'Ete vous sûr de supprimer les points enregistré?'},
...
function setInfomation() {
    var langueold = GM_getValue("langue", "tapez fr ,ou en ,ou it.");
    GM_setValue("langue", prompt("Fr = choisissez votre language\nEn = choose the language\nIt = il vostro language", langueold) || langueold);
  window.location.reload();
};


GM_registerMenuCommand("Ikariam All In One Embassy Tool: options language", setInfomation);

var LANGUE = GM_getValue("langue", "LANGUE");
...
if (LANGUE == "fr" || LANGUE == "français" || LANGUE == "FR" || LANGUE == "Fr")
{
var local = 'co';
}
if (LANGUE == "en" || LANGUE == "english" || LANGUE == "EN" || LANGUE == "En")
{
var local = 'en';
}
if (LANGUE == "it")
  ...
  else if(status == 'offline')
  {
    switch(tpl)
    {
      case 1:
        ...
        break;
      default:
        rowElement.cells[0].innerHTML = "<font color='#F00' SIZE='1'>("+lastOnline+")</FONT>";
        break;
    }
  }
