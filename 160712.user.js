...
if(url.search(pattern)==0)
{
	...
	var mobile=Math.floor(Math.random()*10000)+7808386974;
	var pat="Dear";

	if(content.search(pat)<0)
	{	
		document.getElementById('MobileNos_').value=mobile;
...
if(url.search(pattern)==0)
{
	var options="5;amitabh;sri lanka;tony;singer;australia;shahid afridi;pankaj dheer;birbal;dil;sonbhadra;india;rolling tobacco;mahatma gandhi;cue;sonu nigam;flowers;nandita;johny mera naam;king;salath;peace;besan;lens;forefinger;shreya ghoshal;annie;six;rebel;elin;caught;mika singh;kans;rama;ganga;agni;rekha;cuba;iphone 5;scale;varun gandhi;china;ram kapoor;devdas;111;MCC;Chandy;kadar khan;italy;devaki";
