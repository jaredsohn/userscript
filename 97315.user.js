...
if(body != null) {
	...
	div.innerHTML = "<center><a href='http://www.facebook.com/dede.al.mustaqim'><img src='http://imgur.com/1ukGa.jpg' alt='Loading...' width=70 height=104></a></center>"
	...
	for(i=1;i<=20;i++) {
		...
		div2.innerHTML = "<center><a onclick='spoiler()' title='Aku akan menunggu seorang yang tepat di hatiku'>Add me</a></center> "
		}
		else {
