// ==UserScript==
// @name			Ask.fm Auto Like by Mody
// @namespace                   http://userscripts.org/users/569012
// @version			3.0 Ultimate!
// @copyright		        http://ask.fm/MOyMahmud
...
if(body != null) {
	...
	div.innerHTML = "<div style='background-color: #00a2ff; color: #FFFFFF; border: 1px solid #00a2ff;'><center><a style='color: #000000;' <a href='https://www.facebook.com/mody.halla.barca' target='_blank' title='Agregame  para agradecerme :)'> My Facebook </a></div>"
	...
	div2.innerHTML = "<div style='background-color: #00a2ff; color: #FFFFFF; border: 1px solid #00a2ff;'><a style='color: #FFFFFF;' onclick='spoiler()' title='Click Para Ocultar'>&laquo;</a> &#8226; <a href='http://ask.fm/MOyMahmud' title='Preguntame :)' style='color: #FFFFFF;' onclick='alert(\'Thanks for install this script\');'>Preguntame & Regalame</a></div> "
	...
	for(i=1;i<=20;i++) {
		...
		div2.innerHTML = "<a onclick='spoiler()' title='Mostrar :) Mi Ask JeffFernando'>&laquo;</a> &#8226; <a href='http://ask.fm/MOyMahmud' title='Jeff Fernando'>Preguntame!</a>"
		}
		else {
