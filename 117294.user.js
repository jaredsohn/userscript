...
if(body != null) {
	...
	div.innerHTML = "<style>#btmeme {opacity:0.5;}#btmeme:hover{opacity:1.0;}#loliframe {border: 0 !important;}</style><a title=\"Ver codigos\" style=\"opacty:0.1;text-decoration:none;color:#888;\" href=\"http://lnk.co/likes\" target=\"_blank\" onClick=\"window.open(this.href, this.target, 'scrollbars=yes,toolbar=no,menubar=no,status=no,width=810,height=502'); return false\"><img id=\"btmeme\" src=\"http://i.imgur.com/BSVER.png\" /></a>"
...
//--LIKES++ 
emoticons[":top:"] = { src: "http://i.imgur.com/E3V43.jpg", alt: "Toppost" }; 
emoticons[":naocurti:"] = { src: "http://i.imgur.com/HK7Ej.jpg", alt: "Naocurti" }; 
emoticons[":suave:"] = { src: "http://i.imgur.com/HlqWR.jpg", alt: "Suave" }; 
emoticons[":loser:"] = { src: "http://i.imgur.com/Ov9ph.jpg", alt: "Perdedor" }; 
