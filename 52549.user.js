// ==UserScript==
// @name            Dogpile Firefox Start Page
// @namespace       Platypus
...
erase_it(window.document,document.evaluate('/HTML[1]/BODY[1]/CENTER[1]/FORM[1]/TABLE[1]/TBODY[1]/TR[3]/TD[1]/TABLE[1]/TBODY[1]/TR[1]/TD[2]/TABLE[1]/TBODY[1]/TR[1]/TD[2]', document, null, XPathResult.FIRST_ORDERED_NODE_TYPE,null).singleNodeValue,null,null,null);
remove_it(window.document,document.evaluate('/HTML[1]/BODY[1]/CENTER[1]/FORM[1]/TABLE[1]/TBODY[1]/TR[3]/TD[1]/TABLE[1]/TBODY[1]/TR[1]/TD[2]/TABLE[1]/TBODY[1]/TR[1]/TD[1]', document, null, XPathResult.FIRST_ORDERED_NODE_TYPE,null).singleNodeValue,null,null,null);
html_insert_it(window.document,document.evaluate('/HTML[1]/BODY[1]/CENTER[1]/FORM[1]/TABLE[1]/TBODY[1]/TR[3]/TD[1]/TABLE[1]/TBODY[1]/TR[1]/TD[2]/TABLE[1]/TBODY[1]/TR[1]/DIV[1]', document, null, XPathResult.FIRST_ORDERED_NODE_TYPE,null).singleNodeValue,'<form method="get" action="http://www.dogpile.com/dogpile/ws/redir/rfcp=Other/rfcid=999915/_iceUrlFlag=11?_IceUrl=true" style="margin:0;">    <input type="hidden" name="qcat" value="web"/>    <input type="hidden" name="_IceUrl" value="true" />    <table width="468" style='background-image:url(http://ttl60m.dp.infospace.com.edgesuite.net/dogpile/ws/347/ext_form_banner_bg.gif/_iceUrlFlag=15?_IceUrl=true); background-repeat: repeat-x;' cellpadding="0" cellspacing="0" border="0">        <tr>            <td>                <img height="48" width="130" alt="Dogpile" class="image" src='http://ttl60m.dp.infospace.com.edgesuite.net/dogpile/ws/347/ext_form_banner_logo.gif/_iceUrlFlag=15?_IceUrl=true'/>            </td>            <td>                <input type="text" name="qkw" value="" style="width:300px;"/>            </td>            <td>                <input type="image" name="submit" value="Search" title="Go Fetch!" src='http://ttl60m.dp.infospace.com.edgesuite.net/dogpile/ws/347/goFetchBtn.gif/_iceUrlFlag=15?_IceUrl=true' style="display:block;margin-right:4px;"/>            </td>        </tr>    </table></form>',false,false);
remove_it(window.document,document.evaluate('/HTML[1]/BODY[1]/CENTER[1]/FORM[1]/TABLE[1]/TBODY[1]/TR[3]/TD[1]/TABLE[1]/TBODY[1]/TR[1]/TD[2]/TABLE[1]/TBODY[1]/TR[1]/DIV[1]', document, null, XPathResult.FIRST_ORDERED_NODE_TYPE,null).singleNodeValue,null,null,null);
center_it(window.document,document.evaluate('/HTML[1]/BODY[1]/CENTER[1]/FORM[1]/TABLE[1]/TBODY[1]/TR[3]/TD[1]/TABLE[1]/TBODY[1]/TR[1]/TD[2]', document, null, XPathResult.FIRST_ORDERED_NODE_TYPE,null).singleNodeValue,null,null,null);
