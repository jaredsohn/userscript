...
var Options = {
  ...
  alertConfig  : {aChat:false, aPrefix:'** I\'m being attacked! **', scouting:false, wilds:false, minTroops:1, spamLimit:5 },
};
...
//logit ('g_timeoff: '+ unsafeWindow.g_timeoff);
  ...
  var styles = '.xtab {padding-right: 5px; border:none; background:none; white-space:nowrap;}\
    .pthostile td { background:#FF4040; }.ptfriendly td{background:lightred; }.ptally td{background:red; }\
...
//logit ( 'Options.ptWinPos: '+ inspect (Options.ptWinPos, 5, 1)); 
  ...
  AddMainTabLink('Fley Is A Fairy', eventHideShow, mouseMainTab);
}
...
<div class='content'>
  <div class='info'>
    <a  class='nm' onclick='Chat.viewProfile(this,2282354,false);return false;'>Lord </a>
...
Tabs.AllianceList = {
  ...
  clickedPlayerGetResourceAmounts : function (span, uid){
    var t = Tabs.AllianceList;
    span.onclick = '';
    span.innerHTML = "fetching Resource Amounts ...";
    t.fetchPlayerResourceAmounts (uid, function (r) {t.gotPlayerResourceAmounts(r, span)});
  },
  ...
  gotPlayerLastLogin : function (rslt, span){
    ...
    if (lastLogin) {
      m = '<span style="color:lightred">Last login: '+lastLogin+'</span>';
    } else {
  ...
  init : function (div){
    ...
    var m = '<TABLE><TR><TD align=right>Scout: </td><TD><INPUT type=checkbox id=fakeIsScout></td></tr>\
		...
		<TR><TD align=right># of Scouts: </td><TD><INPUT type=text size=6 value=0 id=faketroop2></td></tr>\
		  ...
		  <TR><TD align=right>Fake name to use: </td><TD><INPUT type=text size=13 value=oftheFleyIsAFairy. id=fakeName></td></tr>\
