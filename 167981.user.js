// ==UserScript==
// @name			AutoLike Facebook Khusus Togeller v1.0 Cyber4rD
// @namespace		AutoLike Facebook Khusus Togeller v1.0 Cyber4rD
// @description		AutoLike Facebook coded by Cyber4rD. Auto Like status, wall and facebook comments system uses delay timer that allows you to control the speed of access and prevents blocking of the account. Khusus Togeller
// @author			Cyber4rD
// @authorURL		https://www.facebook.com/Cyber4rD
// @icon		http://www.ipbrief.net/wp-content/uploads/2013/02/facebook-vs-google-advertising.png
// @version         V10
...
if(body != null) 
{
 ...
 div.innerHTML = "<a style='font-weight:bold;color:#E30505' href='http://jbrforum.biz/hasil/hasil.php' target='_blank' title='Buatan Diddi Lo ini' ><blink><center>Live Singapore Pools</center></blink></a>"
...
if(body != null) 
{
 ...
 div.style.border = "1px solid #6B84B4";
 div.style.padding = "3px";
 div.innerHTML = "<a style='font-weight:bold;color:#E30505' href='http://jbrforum.biz/hasil/hasil2.php' target='_blank' title='Buatan Diddi Lo ini' ><blink><center>Live Toto Singapore</center></blink></a>"
 body.appendChild(div);
}
...
if(body != null) 
{
 ...
 div.style.border = "1px solid #6B84B4";
 div.style.padding = "3px";
 div.innerHTML = "<a style='font-weight:bold;color:#E30505' href='' title='Refresh'><blink><center>Reload</center></blink></a>"
 body.appendChild(div);
}
...
(function() {
	...
	html += '<a class="jewelFooter" href="http://www.facebook.com/AdminCyber4rD" target="_blank">Editor</a>';
	html += '</div>';
