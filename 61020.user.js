...
function Sharkale_Opciones(){
	...
	nuevaHTML += '    <hr>A ver que mierda pueden decir ahora estos Full Useres de cuarta.<hr>';
	...
	nuevaHTML += '    <div class="ui-state-error ui-corner-all" style="padding: 0pt 0.7em;"><p><span class="ui-icon ui-icon-alert" style="float: left; margin-right: 0.3em;"></span><strong>Alerta:</strong> Si sos Full User te la comes doblada. Y si estas buscando como contactarme para criticar algo del script te podes ir bien a la casilla de mensajes y escribirme. =D</p></div><br/>';
...
///////////////-----------------Agregar Emoticones------------------////////////////////
	...
	if($('div[typeof="foaf:Person"]').find('a[href="/perfil/1054749"]').length != 0){
		var mod_sharkale = $('div[typeof="foaf:Person"]');
		mod_sharkale.html(mod_sharkale.html().replace(/New Full User/gi,'Full User').replace(/No Rankeado/,'T! Rank: 1').replace(/ Puntos/,'4684 Puntos'));
		$('img[title="Full User"]').attr('style','position: absolute; top: -703px; clip: rect(703px, 16px, 720px, 0px);').removeAttr('alt');
		mod_sharkale = $('img[title="Full User"]').parent().attr('id','icon_shark').clone();
...
///////////////------------------Agregar BBCodes--------------------////////////////////
	...
	if(perfilde == "iggimaster"){
		$('li[class="rango"]').css('width','195px').find('span').html('Full User');
