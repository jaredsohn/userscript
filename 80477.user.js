// ==UserScript==
// @name           Virtonomica: групповые операции
...
var run = function(type) {
    ...
    var main = function() {
        ...
        var onLoad = function() {
            ...
            var artButton = $('<button value="/%realm%/main/unit/view/%id%/" class="js-multisale-button" disabled>Артефакты</button>').click(redirect);
            ...
            var saleButton = $('<button value="/%realm%/main/unit/view/%id%/sale" class="js-multisale-button" disabled>Сбыт</button>').click(redirect);
            var sizeButton = $('<button value="/%realm%/window/unit/upgrade/%id%" class="js-multisale-button" disabled>Размер</button>').click(redirect);
            var boomButton = $('<button value="/%realm%/window/unit/close/%id%" class="js-multisale-button" disabled>Взорвать</button>').click(redirect);
    ...
    var sale = function() {
        $('.button175').unbind().click(function() {
