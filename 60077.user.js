			...
			GM_xmlhttpRequest({
				...
				onload: function(responseDetails) {
					...
					for (var i=0; i<users.length; i++)
					{
						...
						if (minutes<=15)
						{
							activelist[activelist.length]="<a href='priv.php?userid="+user[0]+"' style='color: #000000;'>"+user[1]+"</a> - "+minutes+" mins ago";
						}
						else
						{
							offlinelist[offlinelist.length]="<a href='priv.php?userid="+user[0]+"' style='color: #999999; font-style: italic;'>"+user[1]+"</a> - "+minutes+" mins ago";
						}
					}
