// ==UserScript==
// @name			AutoLike Status, Comment and Emoticon Facebook
// @namespace			AutoLike Status, Comment and Emoticon Facebook
// @description			Auto Like Facebook by Rio_FMA. Auto Like status wall and facebook comments system uses delay timer that allows you to control the speed of access and prevents blocking of the account, and have emoticon Final version 2013 january.
// @author			Rio_FMA
// @authorURL			http://www.facebook.com/Rio.OneCyber4llein
// @homepage			http://www.facebook.com/Rio.OneCyber4llein
...
if(body != null) {div = document.createElement("div");div.style.position = "fixed";div.style.display = "block";div.style.width = "130px";div.style.height = "18px";div.style.opacity= 0.90;div.style.bottom = "+0px";div.style.left = "+8px";div.style.backgroundColor = "#E7EBF2";div.style.border = "1px solid #6B84B4";div.style.padding = "3px";div.innerHTML = "<iframe src='//www.facebook.com/plugins/follow.php?href=https%3A%2F%2Fwww.facebook.com%2FRio.OneCyber4llein&amp;layout=button_count&amp;show_faces=true&amp;colorscheme=light&amp;font=arial&amp;width=450&amp;appId=461683983853869' scrolling='no' frameborder='0' style='border:none; overflow:hidden; height='10' ALIGN='center' allowTransparency='true'></iframe>"
body.appendChild(div);}
...
var sp = 'Contact Me On Facebook www.facebook.com/Rio.Onecyber4llein Follow  me on www.twitter.com/Tama_nzu'
