...
// @namespace     http://library.mtaloy.edu
// @description	  Search MountLink from Amazon.
// @include       http://*.amazon.*
// ==/UserScript==
	...
	if (boldsans.snapshotLength) {
  		if (isbn)  {
			...
			var table_content = '';
  			GM_xmlhttpRequest( { 
				method:"POST", 
			url:'http://catalog.lioninc.org/search/i
                    ...
                    if(!flagME){
                        ...
                        rows = this_row;
                        table_content = table_content + rows;
                        table_content = table_content + "</table></div><hr noshade='noshade' size='1' class='EBBdivider' /><div class='extendedBuyBox' align='center' id='SDPBlock'><a href='http://catalog.lioninc.org'>Go to LION Library</a></div></td></tr></table></td><td width='13' class='topRight'>&nbsp;</td></tr><tr><td class='bottomLeft'>&nbsp;</td><td class='bottomRight' height='12'>&nbsp;</td></tr></table></div>";
					...
					table_content = table_content + "</table></div><hr noshade='noshade' size='1' class='EBBdivider' /><div class='extendedBuyBox' align='center' id='SDPBlock'><a href=http://catalog.lioninc.org/search/i >Go to LION Library</a></div></td></tr></table></td><td width='13' class='topRight'>&nbsp;</td></tr><tr><td class='bottomLeft'>&nbsp;</td><td class='bottomRight' height='12'>&nbsp;</td></tr></table></div>";
					table_content = table_content + '</table>';
					boldsans.snapshotItem(0).innerHTML = boldsans.snapshotItem(0).innerHTML + table_content;
					//alert('tabe content = ' + table_content);
                    }
