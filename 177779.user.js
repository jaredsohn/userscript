...
$(document).ready(function () {
    ...
    $('a[id^="capsule"]').each(function () {
        ...
        var linkTextPrompt = (linkText.length > 0) ? '[url=' + mturkHome + linkText + '][color=#008000]View this HIT[/color][/url]' : 'Preview not available due to qualifications';
        ...
        template[i] = '[b]Title:[/b] ' + titleText
            + '\r\n[b]Requester:[/b] [url=' + mturkHome + requesterLink + '][color=#008000]' + requesterName + '[/color][/url] [' + requesterID + '] [[url=' + toHome + requesterID + '][color=#008000]TO[/color][/url]]'
            + '\r\n[b]Description:[/b] ' + descriptionText
            + '\r\n[b]Timer:[/b] ' + timeAllottedText
            + '\r\n[b]Reward:[/b] ' + rewardText
            + '\r\n[b]Qualifications:[/b] ' + qualificationsText
            + '\r\n\r\n' + linkTextPrompt
            + '\r\n[right][size="1"][url=https://userscripts.org/scripts/show/175589][color=#008000]Grab this script and help me test it.[/color][/url][/size][/right]';

        $(this).parent().append('<button id="showExport_' + i + '" style="border: none; padding: 0; margin: 0 0 0 10px; background: none; font-size: inherit; color: #008000; cursor: pointer;">[Export]</button>');
        i++;
    });
