// ==UserScript==
// @name           FACEBOOK SUPER SCRIPT By. Nardo
// @namespace      AutoLike
// @namespace   http://code-poet.net/
// @description    SUPER Script terbaru dr Nardo buat Facebooker'S Mania--UPDATE
...
var lang = {
	...
	en : {
		...
		'ConfFacebookSinarLanguage' : 'Language for Sinar Script',
		'ConfFacebookTimestamps' : 'Show Facebook timestamps (eg. "3 hours ago").',
		'ConfFBFTimestamps' : 'Add Sinar Script timestamps after Facebook timestamps (eg. "11:45").',
		'ConfFBFTimestamps24' : 'Show Sinar Script timestamps in 24-hour format.',
		...
		'ConfSectionAbout' : 'About Sinar Script',
		...
		'ConfUpdates' : 'Check Userscripts.org daily for updates to Sinar Script. Or <a href="#" id="fbfUpdateLink" onclick="return false;">check now</a>.',
		...
		'FacebookSinarConflict' : 'Facebook Sinar is now known as Sinar Script.<br /><br />Because of the name change you need to manually uninstall Facebook Sinar from your browser, or the two scripts will conflict with each other.<br /><br />If you are aren\'t sure how to uninstall a userscript, <a %s>click here for instructions</a>.',
		...
		'UpdateAvailable1' : 'An update is available for Sinar Script',
	...
	es : {
		...
		'Close' : 'Cerrar',
		'ConfigureFacebookSinar' : 'ConfiguraciÃ³n de Sinar Script',
		...
		'ConfFacebookSinarLanguage' : 'Lenguaje del Sinar Script',
		'ConfFacebookTimestamps' : 'Mostrar cuanto hace que fue creado (Ejemplo: "Hace 3 horas").',
		'ConfFBFTimestamps24' : 'Mostrar las marcas de tiempo de Sinar Script en formato 24 horas.',
		'ConfFBFTimestamps' : 'AÃ±adir las marcas de tiempo de Sinar Script despuÃ©s de las marcas de tiempo de Facebook (Por ejemplo "11:45").',
		...
		'ConfSectionAbout' : 'Acerca de Sinar Script',
		...
		'ConfUpdates' : 'Revisar Userscripts.org diarimente por si hay actualizaciones en Sinar Script. O <a href="#" id="fbfUpdateLink" onclick="return false;">revisar Ahora</a>.',
		...
		'FacebookSinarConflict' : 'Facebook Sinar ahora se llama Sinar Script.<br /><br />Por el cambio de nombre es necesario desinstalar Facebook Sinar manualmente de su navegador o los dos programas entraran en conflicto.<br /><br />Si no sabe como desinstalar un userscript, <a %s>haga clic aquÃ­ para ver instrucciones</a>.',
		...
		'UpdateAvailable1' : 'Hay una actualizaciÃ³n disponible para Sinar Script',
	...
	fr : {
		...
		'Close' : 'Fermer',
		'ConfigureFacebookSinar' : 'Configurer Sinar Script',
		...
		'ConfFacebookSinarLanguage' : 'Langue de Sinar Script',
		'ConfFacebookTimestamps' : 'Affichage de la datation Facebook (ex. "Il y a 3 heures").',
		'ConfFBFTimestamps' : 'Ajout de la datation Sinar Script apr&egrave;s la datation Facebook (ex. "11:45").',
		'ConfFBFTimestamps24' : 'Affichage de la datation Sinar Script au format 24 heures.',
		...
		'ConfSectionAbout' : 'A propos de Sinar Script',
		...
		'ConfUpdates' : 'V&eacute;rifie quotidiennement si une mise &agrave; jour de Sinar Script est disponible sur Userscripts.org. Ou <a href="#" id="fbfUpdateLink" onclick="return false;">v&eacute;rifier maintenant</a>.',
		...
		'FacebookSinarConflict' : 'Sinar Script est maintenant devenu Sinar Script. A cause du changement de nom, vous aurez besoin de d&eacute;sinstaller manuellement Sinar Script de votre explorateur, ou les deux scripts rentreront en conflit. Si vous n\'&ecirc;tes pas s&ucirc;r de comment faire pour d&eacute;sinstaller un userscript, <a %s>cliquez ici pour la marche &agrave; suivre</a>.',
		...
		'Left' : 'Gauche',
		'ListeningRestarted' : 'Sinar Script s\'est remit \340 l\'\351coute des changements \351ventuels.',
		'ListeningStopped' : 'Sinar Script a arret\351 d\'\352tre \340 l\'\351coute des changements \351ventuels.\nAppuyez sur L (SHIFT + l) pour r\351-activer l\'\351coute',
		...
		'UpdateAvailable1' : 'Une mise &agrave; jour de Sinar Script est disponible',
	...
	it : {
		...
		'Close' : 'Chiudi',
		'ConfigureFacebookSinar' : 'Impostazioni di Sinar Script',
		...
		'ConfFacebookSinarLanguage' : 'Lingua di Sinar Script',
		...
		'ConfSectionAbout' : 'Riguardo di Sinar Script',
		...
		'FacebookSinarConflict' : 'Sinar Script ha cambiato nome in Sinar Script. A causa del cambiamento dovrai disinstallare manualmente Sinar Script dal tuo browser, o i due script andranno in conflitto. Se non sei sicuro di come disinstallare un userscript <a %s>clicca qui per le istruzioni</a>.',
		...
		'UpdateAvailable1' : 'Ãˆ disponibile un update per Sinar Script.',
	...
	de : {
		...
		'Close' : 'SchlieÃŸen',
		'ConfigureFacebookSinar' : 'Sinar Script konfigurieren',
		...
		'ConfFacebookSinarLanguage' : 'Sprache fÃ¼r Sinar Script',
		...
		'ConfUpdates' : 'UÃœberprÃ¼fen Sie Userscripts.org tÃ¤glich auf Updates fÃ¼r Sinar Script. <a href="#" id="fbfUpdateLink" onclick="return false;">Jetzt Ã¼berprÃ¼fen</a>.',
		...
		'Left' : 'Links',
		'ListeningRestarted' : 'Sinar Script reagiert wieder auf Ã„nderungen.',
		'ListeningStopped' : 'Sinar Script reagiert nicht auf Ã„nderungen.\nL (SHIFT + l) drÃ¼cken, um die Reaktion wieder zu aktvieren.',
		...
		'today' : 'heute',
		'UpdateAvailable1' : 'Es gibt ein Update fÃ¼r Sinar Script',
	...
	bg : {
		...
		'ConfigureFacebookSinar' : 'ÐšÐ¾Ð½Ñ„Ð¸Ð³ÑƒÑ€Ð¸Ñ€Ð°Ð½Ðµ Ð½Ð° Sinar Script',
		...
		'ConfFacebookSinarLanguage' : 'Ð•Ð·Ð¸Ðº Ð·Ð° Sinar Script',
		...
		'ConfShortcutList' : '<b>Ð‘ÑŠÑ€Ð·Ð¸ Ð±ÑƒÑ‚Ð¾Ð½Ð¸</b> (Ð³Ð¾Ð»ÐµÐ¼Ð¸/Ð¼Ð°Ð»ÐºÐ¸ Ñ‡ÑƒÐ²ÑÑ‚Ð²Ð¸Ñ‚ÐµÐ»Ð½Ð¸):<br /><br /><i>ÐžÑ‚ ÐºÐ¾Ñ Ð´Ð° Ðµ ÑÑ‚Ñ€Ð°Ð½Ð¸Ñ†Ð°:</i><br />&nbsp;<b>A</b> - ÐÐ»Ð±ÑƒÐ¼Ð¸/ÑÐ½Ð¸Ð¼ÐºÐ¸<br />&nbsp;<b>B</b> - ÐŸÑ€ÐµÐ²ÐºÐ»ÑŽÑ‡Ð²Ð°Ð½Ðµ Ð½Ð° ÑÐ¿Ð¸ÑÑŠÐº ÐŸÑ€Ð¸ÑÑ‚ÐµÐ»Ð¸ Ð½Ð° Ð»Ð¸Ð½Ð¸Ñ<br />&nbsp;<b>C</b> - ÐšÐ¾Ð½Ñ„Ð¸Ð³ÑƒÑ€ÑƒÑ€Ð°Ð½Ðµ Ð½Ð° Sinar Script<br />&nbsp;<b>F</b> - ÐŸÑ€Ð¸ÑÑ‚ÐµÐ»Ð¸<br />&nbsp;<b>H</b> - Ð“Ð»Ð°Ð²Ð½Ð° ÑÑ‚Ñ€Ð°Ð½Ð¸Ñ†Ð°<br />&nbsp;<b>I</b> - Ð’Ñ…Ð¾Ð´ÑÑ‰Ð° ÐºÑƒÑ‚Ð¸Ñ<br />&nbsp;<b>L</b> - Ð Ð°Ð·Ñ€ÐµÑˆÐ°Ð²Ð°Ð½Ðµ/Ð—Ð°Ð±Ñ€Ð°Ð½ÑÐ²Ð°Ð½Ðµ Ð½Ð° Sinar Script Ð´Ð° Ð¿Ñ€Ð¾Ð²ÐµÑ€ÑÐ²Ð° Ð·Ð° Ð¿Ñ€Ð¾Ð¼ÐµÐ½Ð¸ Ð¿Ð¾ ÑÑ‚Ñ€Ð°Ð½Ð¸Ñ†Ð¸Ñ‚Ðµ<br />&nbsp;<b>N</b> - Ð˜Ð·Ð²ÐµÑÑ‚Ð¸Ñ<br />&nbsp;<b>P</b> - ÐŸÑ€Ð¾Ñ„Ð¸Ð»<br />&nbsp;<b>T</b> - ÐŸÑ€ÐµÐ²Ð¾Ð´ Ð½Ð° Ð¼Ð°Ñ€ÐºÐ¸Ñ€Ð°Ð½Ð¸Ñ Ñ‚ÐµÐºÑÑ‚<br />&nbsp;<b>&lt;escape&gt;</b> - Ð—Ð°Ñ‚Ð²Ð°Ñ€ÑÐ½Ðµ Ð½Ð° Ð¸Ð·ÑÐºÐ°Ñ‡Ð°Ñ‰Ð¸ Ð¿Ñ€Ð¾Ð·Ð¾Ñ€Ñ†Ð¸, Ð¾Ñ‚Ð²Ð¾Ñ€ÐµÐ½Ð¸ Ð¾Ñ‚ Sinar Script<br /><br /><i>ÐÐ° Ð·Ð°Ð³Ð»Ð°Ð²Ð½Ð°Ñ‚Ð° ÑÑ‚Ñ€Ð°Ð½Ð¸Ñ†Ð°</i>:<br />&nbsp;<b>f</b> or <b>l</b> - ÐÐ¾Ð²Ð¸Ð½Ð¸ Ð½Ð° Ð¶Ð¸Ð²Ð¾<br />&nbsp;<b>i</b> - ÐŸÑƒÐ±Ð»Ð¸ÐºÐ°Ñ†Ð¸Ð¸<br />&nbsp;<b>n</b> - ÐÐ¾Ð²Ð¸Ð½Ð¸<br />&nbsp;<b>p</b> - Ð¡Ð½Ð¸Ð¼ÐºÐ¸<br />&nbsp;<b>s</b> Ð¸Ð»Ð¸ <b>u</b> - ÐŸÑ€Ð¾Ð¼ÐµÐ½Ð¸ Ð² ÑÑ‚Ð°Ñ‚ÑƒÑÐ°<br /><br /><i>ÐÐ° Ð¿Ñ€Ð¾Ñ„Ð¸Ð»Ð¸Ñ‚Ðµ</i>:<br />&nbsp;<b>i</b> - Ð˜Ð½Ñ„Ð¾<br />&nbsp;<b>p</b> - Ð¡Ð½Ð¸Ð¼ÐºÐ¸<br />&nbsp;<b>w</b> - Ð¡Ñ‚ÐµÐ½Ð°<br />&nbsp;<b>x</b> - ÐšÑƒÑ‚Ð¸Ð¸<br /><br /><i>ÐÐ° ÑÑ‚Ñ€Ð°Ð½Ð¸Ñ†Ð¸ Ñ Ð½Ð°Ð²Ð¸Ð³Ð°Ñ†Ð¸Ñ (Ð¿Ñ€ÐµÐ´Ð¸ÑˆÐ½Ð°, ÑÐ»ÐµÐ´Ð²Ð°Ñ‰Ð° Ð¸ Ñ‚.Ð½.)</i><br />&nbsp;<b>&lt;left arrow&gt;</b> - ÐŸÑ€ÐµÐ´Ð¸ÑˆÐ½Ð°<br />&nbsp;<b>&lt;right arrow&gt;</b> - Ð¡Ð»ÐµÐ´Ð²Ð°Ñ‰Ð°<br />&nbsp;<b>&lt;Shift&gt; + &lt;left arrow&gt;</b> - ÐŸÑŠÑ€Ð²Ð° (ÐºÐ¾Ð³Ð°Ñ‚Ð¾ Ðµ Ð²ÑŠÐ·Ð¼Ð¾Ð¶Ð½Ð¾)<br />&nbsp;<b>&lt;Shift&gt; + &lt;right arrow&gt;</b> - ÐŸÐ¾ÑÐ»ÐµÐ´Ð½Ð° (ÐºÐ¾Ð³Ð°Ñ‚Ð¾ Ðµ Ð²ÑŠÐ·Ð¼Ð¾Ð¶Ð½Ð¾)<br /><br /><i>ÐŸÑ€Ð¸ Ñ€Ð°Ð·Ð³Ð»ÐµÐ¶Ð´Ð°Ð½Ðµ Ð½Ð° Ð°Ð»Ð±ÑƒÐ¼Ð¸/ÑÐ½Ð¸Ð¼ÐºÐ¸:</i><br />&nbsp;<b>a</b> - Ð—Ð°Ñ€ÐµÐ¶Ð´Ð°Ð½Ðµ Ð½Ð° Ð²ÑÐ¸Ñ‡ÐºÐ¸ Ð¿Ñ€ÐµÐ²ÑŽÑ‚Ð° (ÐºÐ¾Ð³Ð°Ñ‚Ð¾ Ðµ Ð²ÑŠÐ·Ð¼Ð¾Ð¶Ð½Ð¾)<br />&nbsp;<b>b</b> - ÐŸÐ¾ÐºÐ°Ð·Ð²Ð°Ð½Ðµ Ð½Ð° Ð³Ð¾Ð»ÐµÐ¼Ð¸ ÑÐ½Ð¸Ð¼ÐºÐ¸<br />&nbsp;<b>c</b> - ÐŸÑ€ÐµÐ³Ð»ÐµÐ´ Ð½Ð° ÐºÐ¾Ð¼ÐµÐ½Ñ‚Ð°Ñ€Ð¸Ñ‚Ðµ<br />&nbsp;<b>k</b> - ÐÐ°Ð·Ð°Ð´ ÐºÑŠÐ¼ Ð°Ð»Ð±ÑƒÐ¼Ð°<br />&nbsp;<b>m</b> - Ð¡Ð½Ð¸Ð¼ÐºÐ¸ Ð½Ð° (Ð½ÑÐºÐ¾Ð¹) Ð¸ Ð¼ÐµÐ½<br /><br /><i>ÐŸÑ€Ð¸ Ñ€Ð°Ð·Ð³Ð»ÐµÐ¶Ð´Ð°Ð½Ðµ Ð½Ð° ÑÐºÐ¾Ñ€Ð¾ÑˆÐ½Ð¸ Ð°Ð»Ð±ÑƒÐ¼Ð¸ Ð¸ ÐºÐ°Ñ‡ÐµÐ½Ð¸/Ñ‚Ð°Ð³Ð½Ð°Ñ‚Ð¸ ÑÐ½Ð¸Ð¼ÐºÐ¸:</i><br />&nbsp;<b>a</b> Ð¸Ð»Ð¸ &nbsp;<b>r</b> - Ð¡ÐºÐ¾Ñ€Ð¾ÑˆÐ½Ð¸ Ð°Ð»Ð±ÑƒÐ¼Ð¸<br />&nbsp;<b>m</b> Ð¸Ð»Ð¸ &nbsp;<b>u</b> - ÐšÐ°Ñ‡Ð²Ð°Ð½Ð¸Ñ Ð¾Ñ‚ Ð¼Ð¾Ð±Ð¸Ð»Ð½Ð¾ ÑƒÑÑ‚Ñ€Ð¾Ð¹ÑÑ‚Ð²Ð¾<br />&nbsp;<b>o</b> - Ð¡Ð½Ð¸Ð¼ÐºÐ¸ Ñ Ð¼ÐµÐ½<br />&nbsp;<b>p</b> - ÐœÐ¾Ð¸ ÑÐ½Ð¸Ð¼ÐºÐ¸<br />&nbsp;<b>t</b> Ð¸Ð»Ð¸ &nbsp;<b>f</b> - Ð¢Ð°Ð³Ð½Ð°Ñ‚Ð¸ Ð¿Ñ€Ð¸ÑÑ‚ÐµÐ»Ð¸',
		...
		'ConfUpdates' : 'ÐŸÑ€Ð¾Ð²ÐµÑ€ÑÐ²Ð°Ð½Ðµ Ð½Ð° Userscripts.org ÐµÐ¶ÐµÐ´Ð½ÐµÐ²Ð½Ð¾ Ð·Ð° ÑŠÐ¿Ð´ÐµÐ¹Ñ‚Ð¸ Ð½Ð° Sinar Script. Ð˜Ð»Ð¸ <a href="#" id="fbfUpdateLink" onclick="return false;">Ð¿Ñ€Ð¾Ð²ÐµÑ€ÐºÐ° ÑÐµÐ³Ð°</a>.',
		...
		'Left' : 'ÐžÑ‚Ð»ÑÐ²Ð¾',
		'ListeningRestarted' : 'Sinar Script Ð²ÑŠÐ·ÑÑ‚Ð°Ð½Ð¾Ð²Ð¸ Ð¿Ñ€Ð¾Ð²ÐµÑ€ÐºÐ¸Ñ‚Ðµ Ð·Ð° Ð¿Ñ€Ð¾Ð¼ÐµÐ½Ð¸.',
		'ListeningStopped' : 'Sinar Script ÑÐ¿Ñ€Ñ Ð¿Ñ€Ð¾Ð²ÐµÑ€ÐºÐ¸Ñ‚Ðµ Ð·Ð° Ð¿Ñ€Ð¾Ð¼ÐµÐ½Ð¸.\nÐÐ°Ñ‚Ð¸ÑÐ½ÐµÑ‚Ðµ L (Shift + l) Ð·Ð° Ð¿Ð¾Ð²Ñ‚Ð¾Ñ€Ð½Ð¾ Ð¿ÑƒÑÐºÐ°Ð½Ðµ',
		...
		'today' : 'Ð´Ð½ÐµÑ',
		'UpdateAvailable1' : 'Ð˜Ð·Ð»ÑÐ·Ð»Ð¾ Ðµ Ð¾Ð±Ð½Ð¾Ð²Ð»ÐµÐ½Ð¸Ðµ Ð½Ð° Sinar Script',
	...
	el : {
		...
		'ConfigureFacebookSinar' : 'Î”Î¹Î±Î¼ÏŒÏÏ†Ï‰ÏƒÎ· Sinar Script',
		...
		'ConfFacebookSinarLanguage' : 'Î“Î»ÏŽÏƒÏƒÎ± Î³Î¹Î± Ï„Î¿ Sinar Script',
		'ConfFacebookTimestamps' : 'Î•Î¼Ï†Î¬Î½Î¹ÏƒÎ· Ï„Î·Ï‚ ÏŽÏÎ±Ï‚ Ï„Î¿Ï… Facebook (Ï€Ï‡. "Î ÏÎ¹Î½ 3 ÏŽÏÎµÏ‚").',
		'ConfFBFTimestamps' : 'Î ÏÎ¿ÏƒÎ¸Î®ÎºÎ· Ï„Î·Ï‚ ÏŽÏÎ±Ï‚ Ï„Î¿Ï… Sinar Script Î¼ÎµÏ„Î¬ Î±Ï€ÏŒ Ï„Î·Î½ ÏŽÏÎ± Ï„Î¿Ï… Facebook (Ï€Ï‡. "11:45").',
		'ConfFBFTimestamps24' : 'Î•Î¼Ï†Î¬Î½Î¹ÏƒÎ· Ï„Î·Ï‚ ÏŽÏÎ±Ï‚ Ï„Î¿Ï… Sinar Script ÏƒÎµ 24-Ï‰ÏÎ· Î¼Î¿ÏÏ†Î®.',
		...
		'ConfSectionAbout' : 'Î£Ï‡ÎµÏ„Î¹ÎºÎ¬ Î¼Îµ Ï„Î¿ Sinar Script',
		...
		'ConfUpdates' : 'ÎˆÎ»ÎµÎ³Ï‡Î¿Ï‚ Userscripts.org ÎºÎ±Î¸Î·Î¼ÎµÏÎ¹Î½Î¬ Î³Î¹Î± ÎºÎ±Î¹Î½Î¿ÏÏÎ³Î¹ÎµÏ‚ ÎµÎ½Î·Î¼ÎµÏÏŽÏƒÎµÎ¹Ï‚ Ï„Î¿Ï… Sinar Script Î® <a href="#" id="fbfUpdateLink" onclick="return false;">Î­Î»ÎµÎ³Ï‡Î¿Ï‚ Ï„ÏŽÏÎ±</a>.',
		...
		'FacebookSinarConflict' : 'Î¤Î¿ FacebookSinar ÎµÎ¯Î½Î±Î¹ Ï€Î»Î­Î¿Î½ Î³Î½Ï‰ÏƒÏ„ÏŒ ÏƒÎ±Î½ Sinar Script. Î›ÏŒÎ³Ï‰ Ï„Î·Ï‚ Î±Î»Î»Î±Î³Î®Ï‚ Ï„Î¿Ï… Î¿Î½ÏŒÎ¼Î±Ï„Î¿Ï‚ Î¸Î± Ï€ÏÎ­Ï€ÎµÎ¹ Î½Î± Î±Ï€ÎµÎ³ÎºÎ±Ï„Î±ÏƒÏ„Î®ÏƒÎµÏ„Îµ Ï‡ÎµÎ¹ÏÎ¿ÎºÎ¯Î½Î·Ï„Î± Ï„Î¿ Sinar Script Î±Ï€ÏŒ Ï„Î¿Î½ Ï€ÎµÏÎ¹Î·Î³Î·Ï„Î® ÏƒÎ±Ï‚, Î´Î¹Î±Ï†Î¿ÏÎµÏ„Î¹ÎºÎ¬ Ï„Î± Î´ÏÎ¿ Ï€ÏÎ¿Î³ÏÎ¬Î¼Î¼Î±Ï„Î± Î¸Î± ÏƒÏ…Î³ÎºÏÎ¿ÏÎ¿Î½Ï„Î±Î¹ Î¼ÎµÏ„Î±Î¾Ï Ï„Î¿Ï…Ï‚. Î•Î¬Î½ Î´ÎµÎ½ ÎµÎ¯ÏƒÎ±ÏƒÏ„Îµ ÏƒÎ¯Î³Î¿Ï…ÏÎ¿Î¹ Î³Î¹Î± Ï„Î¿ Ï€Ï‰Ï‚ Î½Î± Î±Ï€ÎµÎ³ÎºÎ±Ï„Î±ÏƒÏ„Î®ÏƒÎµÏ„Îµ Î­Î½Î± Ï€ÏÏŒÎ³ÏÎ±Î¼Î¼Î± userscript, <a %s>Ï€Î±Ï„Î®ÏƒÏ„Îµ ÎµÎ´ÏŽ Î³Î¹Î± Î¿Î´Î·Î³Î¯ÎµÏ‚</a>.',
		...
		'UpdateAvailable1' : 'Î¥Ï€Î¬ÏÏ‡ÎµÎ¹ ÎºÎ±Î¹Î½Î¿ÏÏÎ³Î¹Î± Î´Î¹Î±Î¸Î­ÏƒÎ¹Î¼Î· Î­ÎºÎ´Î¿ÏƒÎ· Ï„Î¿Ï… Sinar Script',
	...
	sk : {
		...
		'Close' : 'ZavrieÅ¥',
		'ConfigureFacebookSinar' : 'KonfigurovaÅ¥ Sinar Script',
		...
		'ConfFacebookSinarLanguage' : 'Jazyk pre Facebook Sinar',
		'ConfFacebookTimestamps' : 'ZobraziÅ¥ ÄasovÃ© znaÄky Facebooku (t. j. "pred 3 hodinami")',
		'ConfFBFTimestamps' : 'PridaÅ¥ ÄasovÃ© znaÄky skriptu Facebook Sinar za ÄasovÃ© znaÄky Facebooku (t. j. "11:45")',
		'ConfFBFTimestamps24' : 'ZobraziÅ¥ ÄasovÃ© znaÄky skriptu Facebook Sinar v 24-hodinovom formÃ¡te',
		...
		'ConfSectionAbout' : 'ÄŒo je Facebook Sinar',
		...
		'ConfUpdates' : 'Denne na Userscripts.org overovaÅ¥ aktualizÃ¡cie pre Facebook Sinar, prÃ­padne <a href="#" id="fbfUpdateLink" onclick="return false;">skontrolovaÅ¥ teraz</a>.',
		...
		'FacebookSinarConflict' : 'Facebook Sinar sa odteraz nazÃ½va Sinar Script.<br /><br />PretoÅ¾e sa zmenil nÃ¡zov, je potrebnÃ© ruÄne odinÅ¡talovaÅ¥ Facebook Sinar z prehliadaÄa, inak budÃº v konflikte dva skripty medzi sebou navzÃ¡jom.<br /><br />Ak neviete, ako skript odinÅ¡talovaÅ¥, <a %s>kliknutÃ­m sem otvorte pokyny</a>.',
		...
		'UpdateAvailable1' : 'K dispozÃ­cii je aktualizÃ¡cia skriptu Facebook Sinar.',
	...
	nl : {
		...
		'Close' : 'Sluit',
		'ConfigureFacebookSinar' : 'Configureer Sinar Script',
		...
		'ConfFacebookSinarLanguage' : 'Taal voor Sinar Script',
		'ConfFacebookTimestamps' : 'Laat Facebook timestamps zien (bijv. "3 uur geleden").',
		'ConfFBFTimestamps' : 'Sinar Script timestamps toevoegen na Facebook timestamps (bijv. "11:45").',
		'ConfFBFTimestamps24' : 'Laat Sinar Script timestamps zien in 24-uurs formaat.',
		...
		'ConfShortcutList' : '<b>Keyboard Shortucts</b> (case sensitive):<br /><br /><i>From any page:</i><br />&nbsp;<b>A</b> - Albums/photos<br />&nbsp;<b>B</b> - Toggle buddy list (online friends)<br />&nbsp;<b>C</b> - Sinar Script configuration<br />&nbsp;<b>D</b> - Birthdays<br />&nbsp;<b>E</b> - Events<br />&nbsp;<b>F</b> - Friends<br />&nbsp;<b>H</b> - Home page<br />&nbsp;<b>I</b> - Inbox<br />&nbsp;<b>L</b> - Select the logout link (press Enter afterwards to log out)<br />&nbsp;<b>N</b> - Notifications<br />&nbsp;<b>P</b> - Your profile<br />&nbsp;<b>R</b> - Requests<br />&nbsp;<b>S</b> - Jump to the search field<br />&nbsp;<b>T</b> - Translate selected text<br />&nbsp;<b>?</b> - Show Sinar Script debug info<br />&nbsp;<b>&lt;escape&gt;</b> - Close pop-ups created by Sinar Script<br /><br /><i>From the home page (filters)</i>:<br />&nbsp;<b>a</b> - Pages<br />&nbsp;<b>f</b> - Live feed<br />&nbsp;<b>g</b> - Groups<br />&nbsp;<b>l</b> - Links<br />&nbsp;<b>n</b> - News feed<br />&nbsp;<b>p</b> - Photos<br />&nbsp;<b>s</b> or <b>u</b> - Status updates<br />&nbsp;<b>t</b> - Notes<br />&nbsp;<b>v</b> - Videos<br /><br /><i>From profiles</i>:<br />&nbsp;<b>i</b> - Info<br />&nbsp;<b>p</b> - Photos<br />&nbsp;<b>w</b> - Wall<br />&nbsp;<b>x</b> - Boxes<br /><br /><i>From pages with pagination (previous, next, etc)</i><br />&nbsp;<b>&lt;left arrow&gt;</b> - Previous<br />&nbsp;<b>&lt;right arrow&gt;</b> - Next<br />&nbsp;<b>&lt;shift&gt; + &lt;left arrow&gt;</b> - First (when available)<br />&nbsp;<b>&lt;shift&gt; + &lt;right arrow&gt;</b> - Last (when available)<br /><br /><i>While viewing albums/photos:</i><br />&nbsp;<b>a</b> - Load all thumbnails (when available)<br />&nbsp;<b>b</b> - Show big pictures<br />&nbsp;<b>c</b> - View comments<br />&nbsp;<b>k</b> - Back to album<br />&nbsp;<b>m</b> - Photos of (person) and me<br /><br /><i>While viewing recent albums and uploaded/tagged photos:</i><br />&nbsp;<b>a</b> or &nbsp;<b>r</b> - Recent Albums<br />&nbsp;<b>m</b> or &nbsp;<b>u</b> - Mobile uploads<br />&nbsp;<b>o</b> - Photos of me<br />&nbsp;<b>p</b> - My Photos<br />&nbsp;<b>t</b> or &nbsp;<b>f</b> - Tagged friends',
		...
		'ConfUpdates' : 'Check Userscripts.org dagelijks voor updates naar Sinar Script. Of <a href="#" id="fbfUpdateLink" onclick="return false;">check nu</a>.',
		'DownloadVideo' : 'Download Video',
		...
		'today' : 'vandaag',
		'UpdateAvailable1' : 'Een update is beschikbaar voor Sinar Script',
	...
	zh_tw : {
		...
		'Close' : 'é—œé–‰',
		'ConfigureFacebookSinar' : 'è¨­å®š Sinar Script',
		...
		'ConfFacebookSinarLanguage' : 'Sinar Scriptçš„èªžè¨€é¸é …',
		'ConfFacebookTimestamps' : 'é¡¯ç¤ºFacebookåŽŸä¾†çš„æ™‚é–“æˆ³è¨˜ (eg. "3 hours ago").',
		'ConfFBFTimestamps' : 'æ–°å¢žSinar Scriptçš„é¡¯ç¤ºæ™‚é–“æˆ³è¨˜ (eg. "11:45").',
		'ConfFBFTimestamps24' : 'Sinar Scriptçš„æ™‚é–“æˆ³è¨˜æŽ¡ç”¨24å°æ™‚åˆ¶ã€‚',
		...
		'ConfSectionAbout' : 'é—œæ–¼ Sinar Script',
		...
		'ConfShortcutList' : '<b>éµç›¤å¿«æ·éµ</b> (å¤§å°å¯«å€åˆ†):<br /><br /><i>å¾žä»»ä½•é é¢:</i><br />&nbsp;<b>A</b> - ç›¸æœ¬/ç›¸ç‰‡<br />&nbsp;<b>B</b> - åˆ‡æ›å¥½å‹åˆ—è¡¨ (åœ¨ç·šå¥½å‹)<br />&nbsp;<b>C</b> - Sinar Script è¨­ç½®<br />&nbsp;<b>D</b> - ç”Ÿæ—¥<br />&nbsp;<b>E</b> - æ´»å‹•<br />&nbsp;<b>F</b> - æœ‹å‹<br />&nbsp;<b>H</b> - é¦–é <br />&nbsp;<b>I</b> - ä¿¡ç®±<br />&nbsp;<b>L</b> - é¸æ“‡ç™»å‡ºé€£çµ (æŒ‰ä¸‹ç¢ºå®šå¾Œç™»å‡º)<br />&nbsp;<b>N</b> - é€šçŸ¥<br />&nbsp;<b>P</b> - ä½ çš„å€‹äººè³‡æ–™<br />&nbsp;<b>R</b> - è«‹æ±‚<br />&nbsp;<b>S</b> - è·³åˆ°æœç´¢æ¬„ä½<br />&nbsp;<b>T</b> - ç¿»è­¯é¸æ“‡çš„å…§å®¹<br />&nbsp;<b>?</b> - é¡¯ç¤ºSinar Scripté™¤éŒ¯è¨Šæ¯<br />&nbsp;<b>&lt;escape&gt;</b> - ä½¿ç”¨Sinar Scripté—œé–‰å½ˆå‡ºè¦–çª—<br /><br /><i>å¾žé¦–é  (éŽæ¿¾)</i>:<br />&nbsp;<b>a</b> - é é¢<br />&nbsp;<b>f</b> - å³æ™‚å‹•æ…‹<br />&nbsp;<b>g</b> - åœ˜é«”<br />&nbsp;<b>l</b> - é€£çµ<br />&nbsp;<b>n</b> - æ–°çš„å‹•æ…‹<br />&nbsp;<b>p</b> - ç›¸ç‰‡<br />&nbsp;<b>s</b> or <b>u</b> - æ›´æ–°ç‹€æ…‹<br />&nbsp;<b>t</b> - ç­†è¨˜<br />&nbsp;<b>v</b> - å½±ç‰‡<br /><br /><i>å¾žå€‹äººè³‡æ–™</i>:<br />&nbsp;<b>i</b> - ä¿¡æ¯<br />&nbsp;<b>p</b> - ç›¸ç‰‡<br />&nbsp;<b>w</b> - ç‰†<br />&nbsp;<b>x</b> - ç›’å­<br /><br /><i>å¾žç¶²é çš„é ç¢¼ (previous, next, etc)</i><br />&nbsp;<b>&lt;left arrow&gt;</b> - Previous<br />&nbsp;<b>&lt;right arrow&gt;</b> - ä¸‹ä¸€å€‹<br />&nbsp;<b>&lt;shift&gt; + &lt;left arrow&gt;</b> - é¦–å…ˆ (ç•¶å¯ä»¥ä½¿ç”¨)<br />&nbsp;<b>&lt;shift&gt; + &lt;right arrow&gt;</b> - æœ€å¾Œ (ç•¶å¯ä»¥ä½¿ç”¨)<br /><br /><i>ç•¶ç€è¦½ç›¸æœ¬/ç›¸ç‰‡:</i><br />&nbsp;<b>a</b> - è®€å–æ‰€æœ‰ç¸®åœ– (ç•¶å¯ä»¥ä½¿ç”¨)<br />&nbsp;<b>b</b> - é¡¯ç¤ºå¤§å¼µçš„åœ–ç‰‡<br />&nbsp;<b>c</b> - æŸ¥çœ‹ç•™è¨€<br />&nbsp;<b>k</b> - è¿”å›žç›¸æœ¬<br />&nbsp;<b>m</b> - ç…§ç‰‡ (å€‹äºº) å’Œæˆ‘<br /><br /><i>æŸ¥çœ‹æœ€è¿‘ä¸Šå‚³/æ¨™è¨˜çš„ç›¸ç‰‡:</i><br />&nbsp;<b>a</b> or &nbsp;<b>r</b> - æœ€æ–°çš„ç›¸æœ¬<br />&nbsp;<b>m</b> or &nbsp;<b>u</b> - æ‰‹æ©Ÿä¸Šå‚³<br />&nbsp;<b>o</b> - æˆ‘çš„ç›¸ç‰‡<br />&nbsp;<b>p</b> - æˆ‘çš„ç›¸ç‰‡<br />&nbsp;<b>t</b> or &nbsp;<b>f</b> - æ¨™è¨˜çš„æœ‹å‹',
		...
		'ConfUpdates' : 'æª¢æŸ¥ Userscripts.org For Sinar Script çš„æ›´æ–°ã€‚ æˆ–æ˜¯ <a href="#" id="fbfUpdateLink" onclick="return false;">ç«‹å³ç¢ºèª</a>.',
		...
		'FacebookSinarConflict' : 'Facebook Sinarç¾åœ¨æ›´åç‚ºSinar Scriptã€‚<br /><br />ç”±æ–¼æ›´æ”¹åç¨±ï¼Œä½ éœ€è¦æ‰‹å‹•å¾žç€è¦½å™¨ä¸­å¸è¼‰èˆŠçš„Facebook Sinarè…³æœ¬ï¼Œå› ç‚ºå…©å€‹è…³æœ¬æœƒç›¸äº’è¡çªã€‚<br /><br />å¦‚æžœä½ ä¸ç¢ºå®šå¦‚ä½•åŽ»ç§»é™¤è…³æœ¬ï¼Œ <a %s>é»žæ“Šèªªæ˜Žéƒ¨ä»½</a>.',
		...
		'today' : 'today',
		'UpdateAvailable1' : 'Sinar Script æœ‰å¯ç”¨çš„æ›´æ–°ã€‚',
	...
	tr : {
		...
		'Close' : 'Kapat',
		'ConfigureFacebookSinar' : 'Sinar Script\'Ä± YapÄ±landÄ±r',
		...
		'ConfFacebookSinarLanguage' : 'Sinar Script\'Ä±n Dili',
		'ConfFacebookTimestamps' : 'Facebook\'un zaman etiketlerini gÃ¶ster (Ã¶rn. "3 saat Ã¶nce").',
		'ConfFBFTimestamps' : 'Facebook\'un zaman etiketlerinin ardÄ±ndan Sinar Script zaman etiketlerini ekle (Ã¶rn. "11:45").',
		'ConfFBFTimestamps24' : 'Sinar Script zaman etiketlerini 24-saat biÃ§iminde gÃ¶ster',
		...
		'ConfSectionAbout' : 'Sinar Script HakkÄ±nda',
		...
		'ConfUpdates' : 'Sinar Script gÃ¼ncellemeleri iÃ§in her gÃ¼n Userscripts.org\'u ziyaret et. Ya da <a href="#" id="fbfUpdateLink" onclick="return false;">ÅŸimdi kontrol et</a>.',
		...
		'FacebookSinarConflict' : 'Sinar Script\'Ä±n yeni adÄ± artÄ±k Sinar Script. Ä°sim deÄŸiÅŸikliÄŸinden dolayÄ± Sinar Script\'Ä± tarayÄ±cÄ±nÄ±zdan kaldÄ±rmanÄ±z gerekiyor, yoksa bu iki script birbiriyle uyuÅŸmazlÄ±k sorunlarÄ± Ã§Ä±karacaktÄ±r. EÄŸer bir userscript\'i nasÄ±l kaldÄ±racaÄŸÄ±nÄ±zdan emin deÄŸilseniz <a %s>buraya tÄ±klayarak Ã¶ÄŸrenebilirsiniz</a>.',
		...
		'UpdateAvailable1' : 'Sinar Script iÃ§in bir gÃ¼ncelleme mevcut',
	...
	sr_rs : {
		...
		'Close' : 'Ð—Ð°Ñ‚Ð²Ð¾Ñ€Ð¸',
		'ConfigureFacebookSinar' : 'ÐŸÐ¾Ð´ÐµÑÐ¸ Sinar Script',
		...
		'ConfFacebookSinarLanguage' : 'ÐˆÐµÐ·Ð¸Ðº Sinar Script-Ð°',
		'ConfFacebookTimestamps' : 'ÐŸÑ€Ð¸ÐºÐ°Ð¶Ð¸ Ð¤ÐµÑ˜ÑÐ±ÑƒÐº Ð²Ñ€ÐµÐ¼Ðµ (Ð½Ð¿Ñ€. "Ð¿Ñ€Ðµ 3 ÑÐ°Ñ‚Ð°").',
		'ConfFBFTimestamps' : 'Ð”Ð¾Ð´Ð°Ñ˜ Sinar Script Ð²Ñ€ÐµÐ¼Ðµ Ð¿Ð¾ÑÐ»Ðµ Ð¤ÐµÑ˜ÑÐ±ÑƒÐº Ð²Ñ€ÐµÐ¼ÐµÐ½Ð° (Ð½Ð¿Ñ€. "11:45").',
		'ConfFBFTimestamps24' : 'ÐŸÑ€Ð¸ÐºÐ°Ð¶Ð¸ Sinar Script Ð²Ñ€ÐµÐ¼ÐµÐ½Ð° Ñƒ 24-Ñ‡Ð°ÑÐ¾Ð²Ð½Ð¾Ð¼ Ð¾Ð±Ð»Ð¸ÐºÑƒ.',
		...
		'ConfSectionAbout' : 'Ðž Ð´Ð¾Ð´Ð°Ñ‚ÐºÑƒ Sinar Script',
		...
		'ConfShortcutList' : '<b>ÐŸÑ€ÐµÑ‡Ð¸Ñ†Ðµ ÑÐ° Ñ‚Ð°ÑÑ‚Ð°Ñ‚ÑƒÑ€Ðµ</b> (Ñ€Ð°Ð·Ð»Ð¸ÐºÑƒÑ˜Ñƒ ÑÐµ Ð¼Ð°Ð»Ð° Ð¸ Ð²ÐµÐ»Ð¸ÐºÐ° ÑÐ»Ð¾Ð²Ð°):<br /><br /><i>Ð¡Ð° Ð±Ð¸Ð»Ð¾ ÐºÐ¾Ñ˜Ðµ ÑÑ‚Ñ€Ð°Ð½Ð¸Ñ†Ðµ:</i><br /> <b>A</b> - ÐÐ»Ð±ÑƒÐ¼Ð¸/Ñ„Ð¾Ñ‚Ð¾Ð³Ñ€Ð°Ñ„Ð¸Ñ˜Ðµ<br /> <b>B</b> - Ð¡Ð¿Ð¸ÑÐ°Ðº Ð´Ð¾ÑÑ‚ÑƒÐ¿Ð½Ð¸Ñ… Ð¿Ñ€Ð¸Ñ˜Ð°Ñ‚ÐµÑ™Ð°<br /> <b>C</b> - Sinar Script Ð¿Ð¾Ð´ÐµÑˆÐ°Ð²Ð°ÑšÐ°<br /> <b>D</b> - Ð Ð¾Ñ’ÐµÐ½Ð´Ð°Ð½Ð¸<br /> <b>E</b> - Ð”Ð¾Ð³Ð°Ñ’Ð°Ñ˜Ð¸<br /> <b>F</b> - ÐŸÑ€Ð¸Ñ˜Ð°Ñ‚ÐµÑ™Ð¸<br /> <b>H</b> - ÐŸÐ¾Ñ‡ÐµÑ‚Ð½Ð° ÑÑ‚Ñ€Ð°Ð½Ð¸Ñ†Ð°<br /> <b>I</b> - ÐŸÑ€Ð¸Ð¼Ñ™ÐµÐ½Ðµ Ð¿Ð¾Ñ€ÑƒÐºÐµ<br /> <b>K</b> - Ð´Ð¾Ð´Ð°Ñ˜ Ð·Ð°Ð±ÐµÐ»ÐµÑˆÐºÑƒ<br /> <b>L</b> - ÐžÐ·Ð½Ð°Ñ‡Ð¸ Ð²ÐµÐ·Ñƒ Ð·Ð° Ð¾Ð´Ñ˜Ð°Ð²Ñƒ (Ð¿Ñ€Ð¸Ñ‚Ð¸ÑÐ½Ð¸Ñ‚Ðµ Ð•Ð½Ñ‚ÐµÑ€ Ð½Ð°ÐºÐ¾Ð½ Ñ‚Ð¾Ð³Ð° Ð·Ð° Ð¾Ð´Ñ˜Ð°Ð²Ñ™Ð¸Ð²Ð°ÑšÐµ)<br /> <b>N</b> - ÐžÐ±Ð°Ð²ÐµÑˆÑ‚ÐµÑšÐ°<br /> <b>P</b> - ÐŸÑ€Ð¾Ñ„Ð¸Ð»<br /> <b>R</b> - Ð—Ð°Ñ…Ñ‚ÐµÐ²Ð¸<br /> <b>S</b> - ÐŸÑ€ÐµÐ»Ð°Ð·Ð°Ðº Ð½Ð° Ð¿Ð¾Ñ™Ðµ Ð·Ð° Ð¿Ñ€ÐµÑ‚Ñ€Ð°Ð³Ñƒ<br /> <b>T</b> - ÐŸÑ€ÐµÐ²ÐµÐ´Ð¸ Ð¾Ð´Ð°Ð±Ñ€Ð°Ð½Ð¸ Ñ‚ÐµÐºÑÑ‚<br /> <b>?</b> - ÐŸÑ€Ð¸ÐºÐ°Ð¶Ð¸ Ð¸Ð·Ð²ÐµÑˆÑ‚Ð°Ñ˜ Ð¾ Ð³Ñ€ÐµÑˆÑ†Ð¸ Sinar Script-Ð°<br /> <b><escape></b> - Ð—Ð°Ñ‚Ð²Ð¾Ñ€Ð¸ Ð¸ÑÐºÐ°Ñ‡ÑƒÑ›Ðµ Ð¿Ñ€Ð¾Ð·Ð¾Ñ€Ðµ ÐºÐ¾Ñ˜Ðµ Ñ˜Ðµ Ð½Ð°Ð¿Ñ€Ð°Ð²Ð¸Ð¾ Sinar Script<br /><br /><i>Ð¡Ð° Ð¿Ð¾Ñ‡ÐµÑ‚Ð½Ðµ ÑÑ‚Ñ€Ð°Ð½Ð¸Ñ†Ðµ (Ñ„Ð¸Ð»Ñ‚ÐµÑ€Ð¸)</i>:<br /> <b>a</b> - Ð¡Ñ‚Ñ€Ð°Ð½Ð¸Ñ†Ðµ<br /> <b>f</b> - ÐÐ°Ñ˜Ð½Ð¾Ð²Ð¸Ñ˜Ðµ<br /> <b>g</b> - Ð“Ñ€ÑƒÐ¿Ðµ<br /> <b>l</b> - Ð’ÐµÐ·Ðµ<br /> <b>n</b> - ÐÐ¾Ð²Ð¾ÑÑ‚Ð¸<br /> <b>p</b> - Ð¤Ð¾Ñ‚Ð¾Ð³Ñ€Ð°Ñ„Ð¸Ñ˜Ðµ<br /> <b>s</b> Ð¸Ð»Ð¸ <b>u</b> - ÐŸÑ€Ð¾Ð¼ÐµÐ½Ðµ ÑÑ‚Ð°Ñ‚ÑƒÑÐ°<br /> <b>t</b> - Ð‘ÐµÐ»ÐµÑˆÐºÐµ<br /> <b>v</b> - Ð’Ð¸Ð´ÐµÐ¾<br /><br /><i>Ð¡Ð° Ð¿Ñ€Ð¾Ñ„Ð¸Ð»Ð°</i>:<br /> <b>i</b> - Ð˜Ð½Ñ„Ð¾Ñ€Ð¼Ð°Ñ†Ð¸Ñ˜Ðµ<br /> <b>p</b> - Ð¤Ð¾Ñ‚Ð¾Ð³Ñ€Ð°Ñ„Ð¸Ñ˜Ðµ<br /> <b>w</b> - Ð—Ð¸Ð´<br /> <b>x</b> - ÐžÐºÐ²Ð¸Ñ€Ð¸<br /><br /><i>Ð¡Ð° ÑÑ‚Ñ€Ð°Ð½Ð¸Ñ†Ð° ÑÐ° Ð½Ð°Ð±Ñ€Ð°Ñ˜Ð°ÑšÐµÐ¼ (Ð¿Ñ€ÐµÑ‚Ñ…Ð¾Ð´Ð½Ð°, ÑÐ»ÐµÐ´Ñ›Ð°, Ð¸Ñ‚Ð´.)</i><br /> <b><ÑÑ‚Ñ€ÐµÐ»Ð¸Ñ†Ð° Ð»ÐµÐ²Ð¾></b> - ÐŸÑ€ÐµÑ‚Ñ…Ð¾Ð´Ð½Ð°<br /> <b><ÑÑ‚Ñ€ÐµÐ»Ð¸Ñ†Ð° Ð´ÐµÑÐ½Ð¾></b> - Ð¡Ð»ÐµÐ´ÐµÑ›Ð°<br /> <b><ÑˆÐ¸Ñ„Ñ‚> + <ÑÑ‚Ñ€ÐµÐ»Ð¸Ñ†Ð° Ð»ÐµÐ²Ð¾></b> - ÐŸÑ€Ð²Ð° (Ð°ÐºÐ¾ Ñ˜Ðµ Ð´Ð¾ÑÑ‚ÑƒÐ¿Ð½Ð¾)<br /> <b><ÑˆÐ¸Ñ„Ñ‚> + <ÑÑ‚Ñ€ÐµÐ»Ð¸Ñ†Ð° Ð´ÐµÑÐ½Ð¾></b> - ÐŸÐ¾ÑÐ»ÐµÐ´ÑšÐ° (Ð°ÐºÐ¾ Ñ˜Ðµ Ð´Ð¾ÑÑ‚ÑƒÐ¿Ð½Ð¾)<br /><br /><i>ÐŸÑ€Ð¸Ð»Ð¸ÐºÐ¾Ð¼ Ð¿Ñ€ÐµÐ³Ð»ÐµÐ´Ð°Ð²Ð°ÑšÐ° Ð°Ð»Ð±ÑƒÐ¼Ð°/Ñ„Ð¾Ñ‚Ð¾Ð³Ñ€Ð°Ñ„Ð¸Ñ˜Ð°:</i><br /> <b>a</b> - Ð£Ñ‡Ð¸Ñ‚Ð°Ñ˜ ÑÐ²Ðµ ÑÐ»Ð¸Ñ‡Ð¸Ñ†Ðµ (Ð°ÐºÐ¾ Ñ˜Ðµ Ð´Ð¾ÑÑ‚ÑƒÐ¿Ð½Ð¾)<br /> <b>b</b> - ÐŸÑ€Ð¸ÐºÐ°Ð¶Ð¸ Ð²ÐµÐ»Ð¸ÐºÐµ ÑÐ»Ð¸ÐºÐµ<br /> <b>c</b> - ÐŸÑ€Ð¸ÐºÐ°Ð¶Ð¸ ÐºÐ¾Ð¼ÐµÐ½Ñ‚Ð°Ñ€Ðµ<br /> <b>k</b> - ÐÐ°Ð·Ð°Ð´ Ð½Ð° Ð°Ð»Ð±ÑƒÐ¼<br /> <b>m</b> - Ð¤Ð¾Ñ‚Ð¾Ð³Ñ€Ð°Ñ„Ð¸Ñ˜Ðµ ÑÐ° (ÐºÐ¾Ñ€Ð¸ÑÐ½Ð¸ÐºÐ¾Ð¼) Ð¸ ÑÐ° Ð¼Ð½Ð¾Ð¼<br /><br /><i>ÐŸÑ€Ð¸ Ð¿Ñ€ÐµÐ³Ð»ÐµÐ´Ð°Ð²Ð°ÑšÑƒ ÑÐºÐ¾Ñ€Ð°ÑˆÑšÐ¸Ñ… Ð°Ð»Ð±ÑƒÐ¼Ð° Ð¸ Ð¿Ð¾ÑÑ‚Ð°Ð²Ñ™ÐµÐ½Ð¸Ñ…/Ð¾Ð·Ð½Ð°Ñ‡ÐµÐ½Ð¸Ñ… Ñ„Ð¾Ñ‚Ð¾Ð³Ñ€Ð°Ñ„Ð¸Ñ˜Ð°:</i><br /> <b>a</b> Ð¸Ð»Ð¸  <b>r</b> - Ð¡ÐºÐ¾Ñ€Ð°ÑˆÑšÐ¸ Ð°Ð»Ð±ÑƒÐ¼Ð¸<br /> <b>m</b> Ð¸Ð»Ð¸  <b>u</b> - ÐŸÐ¾ÑÑ‚Ð°Ð²Ñ™ÐµÐ½Ð¾ Ð¿Ñ€ÐµÐºÐ¾ Ð¼Ð¾Ð±Ð¸Ð»Ð½Ð¾Ð³ Ñ‚ÐµÐ»ÐµÑ„Ð¾Ð½Ð°<br /> <b>o</b> - Ð¤Ð¾Ñ‚Ð¾Ð³Ñ€Ð°Ñ„Ð¸Ñ˜Ðµ Ð½Ð° ÐºÐ¾Ñ˜Ð¸Ð¼Ð° ÑÐ°Ð¼ Ñ˜Ð°<br /> <b>p</b> - ÐœÐ¾Ñ˜Ðµ Ñ„Ð¾Ñ‚Ð¾Ð³Ñ€Ð°Ñ„Ð¸Ñ˜Ðµ<br /> <b>t</b> Ð¸Ð»Ð¸  <b>f</b> - ÐžÐ·Ð½Ð°Ñ‡ÐµÐ½Ð¸ Ð¿Ñ€Ð¸Ñ˜Ð°Ñ‚ÐµÑ™Ð¸',
		...
		'ConfUpdates' : 'Ð¡Ð²Ð°ÐºÐ¾Ð´Ð½ÐµÐ²Ð½Ð¾ Ð¿Ñ€Ð¾Ð²ÐµÑ€Ð°Ð²Ð°Ñ˜ Userscripts.org Ð·Ð° Ð½Ð°Ð´Ð¾Ð³Ñ€Ð°Ð´ÑšÐµ Sinar Script-Ð°. Ð˜Ð»Ð¸ <a href="#" id="fbfUpdateLink" onclick="return false;">Ð¿Ñ€Ð¾Ð²ÐµÑ€Ð¸ ÑÐ°Ð´Ð°</a>.',
		...
		'FacebookSinarConflict' : 'Sinar Script ÑÐµ ÑÐ°Ð´Ð° Ð·Ð¾Ð²Ðµ Sinar Script. Ð—Ð±Ð¾Ð³ Ð¿Ñ€Ð¾Ð¼ÐµÐ½Ðµ Ð¸Ð¼ÐµÐ½Ð° Ð¼Ð¾Ñ€Ð°Ñ›ÐµÑ‚Ðµ Ñ€ÑƒÑ‡Ð½Ð¾ Ð´Ð° ÑƒÐºÐ»Ð¾Ð½Ð¸Ñ‚Ðµ Sinar Script Ð¸Ð· ÑÐ²Ð¾Ð³ Ð¿Ñ€ÐµÐ³Ð»ÐµÐ´Ð°Ñ‡Ð° Ð´Ð° Ð½Ðµ Ð±Ð¸ Ð´Ð¾ÑˆÐ»Ð¾ Ð´Ð¾ Ð¾Ð¼ÐµÑ‚Ð°ÑšÐ° Ð¸Ð·Ð¼ÐµÑ’Ñƒ Ð¾Ð²Ðµ Ð´Ð²Ðµ ÑÐºÑ€Ð¸Ð¿Ñ‚Ðµ. ÐÐºÐ¾ Ð½Ð¸ÑÑ‚Ðµ ÑÐ¸Ð³ÑƒÑ€Ð½Ð¸ ÐºÐ°ÐºÐ¾ Ð´Ð° ÑƒÐºÐ»Ð¾Ð½Ð¸Ñ‚Ðµ ÑÐºÑ€Ð¸Ð¿Ñ‚Ñƒ, <a %s>ÐºÐ»Ð¸ÐºÐ½Ð¸Ñ‚Ðµ Ð¾Ð²Ð´Ðµ Ð·Ð° ÑƒÐ¿ÑƒÑ‚ÑÑ‚Ð²Ð¾</a>.',
		...
		'UpdateAvailable1' : 'Ð”Ð¾ÑÑ‚ÑƒÐ¿Ð½Ðµ ÑÑƒ Ð½Ð°Ð´Ð¾Ð³Ñ€Ð°Ð´ÑšÐµ Ð·Ð° Sinar Script',
	...
	sr : {
		...
		'Close' : 'Zatvori',
		'ConfigureFacebookSinar' : 'Podesi Sinar Script',
		...
		'ConfFacebookSinarLanguage' : 'Jezik Sinar Script-a',
		'ConfFacebookTimestamps' : 'PrikaÅ¾i Fejsbuk vreme (npr. "pre 3 sata").',
		'ConfFBFTimestamps' : 'Dodaj Sinar Script vreme posle Fejsbuk vremena (npr. "11:45").',
		'ConfFBFTimestamps24' : 'PrikaÅ¾i Sinar Script vremena u 24-Äasovnom obliku.',
		...
		'ConfSectionAbout' : 'O dodatku Sinar Script',
		...
		'ConfUpdates' : 'Svakodnevno proveravaj Userscripts.org za nadogradnje Sinar Script-a. Ili <a href="#" id="fbfUpdateLink" onclick="return false;">proveri sada</a>.',
		...
		'FacebookSinarConflict' : 'Sinar Script se sada zove Sinar Script. Zbog promene imena moraÄ‡ete ruÄno da uklonite Sinar Script iz svog pregledaÄa da ne bi doÅ¡lo do ometanja izmeÄ‘u ove dve skripte. Ako niste sigurni kako da uklonite skriptu, <a %s>kliknite ovde za uputstvo</a>.',
		...
		'UpdateAvailable1' : 'Dostupne su nadogradnje za Sinar Script',
	...
	da : {
		...
		'Close' : 'Luk',
		'ConfigureFacebookSinar' : 'KonfigurÃ©r Sinar Script',
		...
		'ConfFacebookSinarLanguage' : 'Sprog i Sinar Script',
		'ConfFacebookTimestamps' : 'Vis Facebook tidsstempler (f.eks. "3 timer sider").',
		'ConfFBFTimestamps' : 'TilfÃ¸j Sinar Script tidsstempler efter Facebook tidsstempler (f.eks. "11:45").',
		'ConfFBFTimestamps24' : 'Vis Sinar Script tidsstempler i 24 timers format.',
		...
		'ConfSectionAbout' : 'Omkring Sinar Script',
		...
		'ConfUpdates' : 'UndersÃ¸g Userscripts.org dagligt for opdateringer til Sinar Script. Eller <a href="#" id="fbfUpdateLink" onclick="return false;">undersÃ¸g nu</a>.',
		...
		'FacebookSinarConflict' : 'Sinar Script vil fremover hedde Sinar Script. PÃ¥ grund af navneskiftet, skal du manuelt afinstallere Sinar Script fra dine browsere, da de to scripts ellers vil komme i konflikt med hinanden. Hvis du er usikker pÃ¥ hvordan man afinstallerer et Userscript, sÃ¥ <a %s>tryk her for instruktioner</a>.',
		'fullAlbumLoaded' : 'Hele albummet hentet',
		'Left' : 'Venstre',
		'ListeningRestarted' : 'Sinar Script lytter efter Ã¦ndringer igen.',
		'ListeningStopped' : 'Sinar Script er stoppet med at lytte efter Ã¦ndringer.\nTryk L (SHIFT + l) for at starte igen',
		...
		'today' : 'i dag',
		'UpdateAvailable1' : 'En opdatering er tilgÃ¦ngelig til Sinar Script',
	...
	cs : {
		...
		'Close' : 'ZavÅ™Ã­t',
		'ConfigureFacebookSinar' : 'NastavenÃ­ - Sinar Script',
		...
		'ConfFBFTimestamps' : 'PÅ™idat ÄasovÃ© znaÄky skriptu Sinar Script za ÄasovÃ© znaÄky Facebooku (t. j. "11:45")',
		'ConfFBFTimestamps24' : 'Zobrazit ÄasovÃ© znaÄny skriptu Sinar Script v 24-hodinovÃ©m formÃ¡tÄ›',
		...
		'ConfShortcutList' : '<b>KlÃ¡vesovÃ© zkratky</b> (rozliÅ¡ujÃ­ se malÃ¡/velkÃ¡ pÃ­smena):<br /><br /><i>Z libovolnÃ© strÃ¡nky:</i><br />&nbsp;<b>A</b> - Alba/fotky<br />&nbsp;<b>B</b> - PÅ™epnout seznam pÅ™Ã¡tel (online pÅ™Ã¡tel)<br />&nbsp;<b>C</b> - Konfigurace skriptu Sinar Script<br />&nbsp;<b>D</b> - Narozeniny<br />&nbsp;<b>E</b> - UdÃ¡losti<br />&nbsp;<b>F</b> - PÅ™Ã¡telÃ©<br />&nbsp;<b>H</b> - DomÅ¯<br />&nbsp;<b>I</b> - PÅ™ijatÃ© zprÃ¡vy<br />&nbsp;<b>K</b> - PÅ™idej zÃ¡loÅ¾ku<br />&nbsp;<b>L</b> - OdhlÃ¡Å¡enÃ­ (po odhlÃ¡Å¡enÃ­ stisknÄ›te Enter)<br />&nbsp;<b>N</b> - UpozornÄ›nÃ­<br />&nbsp;<b>P</b> - VÃ¡Å¡ profil<br />&nbsp;<b>R</b> - Å½Ã¡dosti<br />&nbsp;<b>S</b> - PÅ™eskoÄit na pole Hledat<br />&nbsp;<b>T</b> - PÅ™eloÅ¾it vybranÃ½ text<br />&nbsp;<b>?</b> - Zobrazit informace o ladÄ›nÃ­ skriptu Sinar Script<br />&nbsp;<b>&lt;escape&gt;</b> - ZavÅ™Ã­t kontextovÃ¡ okna vytvoÅ™enÃ© skriptem Sinar Script<br /><br /><i>Ze strÃ¡nky DomÅ¯ (filtry)</i>:<br />&nbsp;<b>a</b> - StrÃ¡nky<br />&nbsp;<b>f</b> - Aktuality<br />&nbsp;<b>g</b> - Skupiny<br />&nbsp;<b>l</b> - Odkazy<br />&nbsp;<b>n</b> - Novinky<br />&nbsp;<b>p</b> - Fotky<br />&nbsp;<b>s</b> nebo <b>u</b> - Co dÄ›lajÃ­ ostatnÃ­<br />&nbsp;<b>t</b> - PoznÃ¡mky<br />&nbsp;<b>v</b> - Videa<br /><br /><i>Z profilÅ¯</i>:<br />&nbsp;<b>i</b> - Informace<br />&nbsp;<b>p</b> - Fotky<br />&nbsp;<b>w</b> - ZeÄ<br />&nbsp;<b>x</b> - Kontejner<br /><br /><i>Ze strÃ¡nek s navigacÃ­ (dozadu, dopredu atd.)</i><br />&nbsp;<b>&lt;levÃ¡ Å¡ipka&gt;</b> - PÅ™edchozÃ­<br />&nbsp;<b>&lt;pravÃ¡ Å¡ipka&gt;</b> - NÃ¡sledujÃ­cÃ­<br />&nbsp;<b>&lt;shift&gt; + &lt;levÃ¡ Å¡ipka&gt;</b> - PrvnÃ­ (pokud je dispozici)<br />&nbsp;<b>&lt;shift&gt; + &lt;pravÃ¡ Å¡ipka&gt;</b> - PoslednÃ­ (pokud je k dispozici)<br /><br /><i>PÅ™i prohlÃ­Å¾enÃ­ alb/fotek:</i><br />&nbsp;<b>a</b> - NaÄÃ­tat vÅ¡echny miniatury (pokud je k dispozici)<br />&nbsp;<b>b</b> - Zobrazit velkÃ© obrÃ¡zky<br />&nbsp;<b>c</b> - Zobrazit komentÃ¡Å™e<br />&nbsp;<b>k</b> - ZpÄ›t do alba<br />&nbsp;<b>m</b> - Fotky (osoby) a moje<br /><br /><i>PÅ™i prohlÃ­Å¾enÃ­ nejnovÄ›jÅ¡Ã­ch alb a nahranÃ½ch/oznaÄenÃ½ch fotek:</i><br />&nbsp;<b>a</b> nebo &nbsp;<b>r</b> - NejnovÄ›jÅ¡Ã­ alba<br />&nbsp;<b>m</b> nebo &nbsp;<b>u</b> - NahranÃ© z mobilu<br />&nbsp;<b>o</b> - Fotky mÃ© osoby<br />&nbsp;<b>p</b> - MÃ© fotky<br />&nbsp;<b>t</b> nebo &nbsp;<b>f</b> - OznaÄenÃ­ pÅ™Ã¡telÃ©',
		...
		'ConfUpdates' : 'DennÄ› na Userscripts.org ovÄ›Å™ovat aktualizace pro Sinar Script, pÅ™Ã­padnÄ› <a href="#" id="fbfUpdateLink" onclick="return false;">zkontrolovat nynÃ­</a>.',
		...
		'FacebookSinarConflict' : 'Facebook Fifex je nynÃ­ znÃ¡m jako Sinar Script.<br /><br />ProtoÅ¾e se zmÄ›nilo jmÃ©no, musÃ­te manuÃ¡lnÄ› odinstalovat Facebook Sinar z vaÅ¡eho prohlÃ­Å¾eÄe.<br /><br />Pokud si nevÃ­te jak na to <a %s>pokraÄujte zde</a>.',
	...
	mk : {
		...
		'Close' : 'Ð—Ð°Ñ‚Ð²Ð¾Ñ€Ð¸',
		'ConfigureFacebookSinar' : 'ÐšÐ¾Ð½Ñ„Ð¸Ð³ÑƒÑ€Ð¸Ñ€Ð°Ñ˜ Ð³Ð¾ Sinar Script',
		...
		'ConfFacebookSinarLanguage' : 'ÐˆÐ°Ð·Ð¸Ðº Ð·Ð° Sinar Script',
		'ConfFacebookTimestamps' : 'ÐŸÑ€Ð¸ÐºÐ°Ð¶Ð¸ Facebook Ð¼Ð°Ñ€ÐºÐµÑ€ Ð·Ð° Ð²Ñ€ÐµÐ¼ÐµÑ‚Ð¾ (eg. "3 Ñ‡Ð°ÑÐ° ÑÑ‚Ð°Ñ€Ð¾").',
		'ConfFBFTimestamps' : 'Ð”Ð¾Ð´Ð°Ð´Ð¸ Sinar Script Ð¼Ð°Ñ€ÐºÐµÑ€ Ð·Ð° Ð²Ñ€ÐµÐ¼ÐµÑ‚Ð¾ Ð¿Ð¾ Facebook Ð¼Ð°Ñ€ÐºÐµÑ€Ð¾Ñ‚ Ð·Ð° Ð²Ñ€ÐµÐ¼Ðµ (eg. "11:45").',
		'ConfFBFTimestamps24' : 'ÐŸÑ€Ð¸ÐºÐ°Ð¶Ð¸ Sinar Script Ð¼Ð°Ñ€ÐºÐµÑ€ Ð·Ð° Ð²Ñ€ÐµÐ¼Ðµ Ð²Ð¾ 24-Ñ‡Ð°ÑÐ¾Ð²ÐµÐ½ Ñ„Ð¾Ñ€Ð¼Ð°Ñ‚.',
		...
		'ConfSectionAbout' : 'Ð—Ð° Sinar Script',
		...
		'ConfShortcutList' : '<b>ÐšÑ€Ð°Ñ‚ÐµÐ½ÐºÐ¸ Ð·Ð° Ñ‚Ð°ÑÑ‚Ð°Ñ‚ÑƒÑ€Ð°</b> (case sensitive):<br /><br /><i>ÐžÐ´ ÑÐµÐºÐ¾Ñ˜Ð° ÑÑ‚Ñ€Ð°Ð½Ð¸Ñ†Ð°:</i><br />&nbsp;<b>A</b> - Albums/photos<br />&nbsp;<b>B</b> - Ð’ÐºÐ»ÑƒÑ‡Ð¸ ÐºÐ¾Ñ€Ð¸ÑÐ½Ð¸Ñ†Ð¸ (Ð²ÐºÐ»ÑƒÑ‡ÐµÐ½Ð¸ Ð¿Ñ€Ð¸Ñ˜Ð°Ñ‚ÐµÐ»Ð¸)<br />&nbsp;<b>C</b> - Sinar Script ÐšÐ¾Ð½Ñ„Ð¸Ð³ÑƒÑ€Ð°Ñ†Ð¸Ñ˜Ð°<br />&nbsp;<b>D</b> - Ð Ð¾Ð´ÐµÐ½Ð´ÐµÐ½Ð¸<br />&nbsp;<b>E</b> - ÐÐ°ÑÑ‚Ð°Ð½Ð¸<br />&nbsp;<b>F</b> - ÐŸÑ€Ð¸Ñ˜Ð°Ñ‚ÐµÐ»Ð¸<br />&nbsp;<b>H</b> - ÐŸÐ¾Ñ‡ÐµÑ‚Ð½Ð° ÑÑ‚Ñ€Ð°Ð½Ð¸Ñ†Ð°<br />&nbsp;<b>I</b> - Ð¡Ð°Ð½Ð´Ð°Ñ‡Ðµ<br />&nbsp;<b>K</b> - Add Bookmark<br />&nbsp;<b>L</b> - Select the logout link (press Enter afterwards to log out)<br />&nbsp;<b>N</b> - Notifications<br />&nbsp;<b>P</b> - Your profile<br />&nbsp;<b>R</b> - Requests<br />&nbsp;<b>S</b> - Jump to the search field<br />&nbsp;<b>T</b> - Translate selected text<br />&nbsp;<b>?</b> - Show Sinar Script debug info<br />&nbsp;<b>&lt;escape&gt;</b> - Close pop-ups created by Sinar Script<br /><br /><i>From the home page (filters)</i>:<br />&nbsp;<b>a</b> - Pages<br />&nbsp;<b>f</b> - Live feed<br />&nbsp;<b>g</b> - Groups<br />&nbsp;<b>l</b> - Links<br />&nbsp;<b>n</b> - News feed<br />&nbsp;<b>p</b> - Photos<br />&nbsp;<b>s</b> or <b>u</b> - Status updates<br />&nbsp;<b>t</b> - Notes<br />&nbsp;<b>v</b> - Videos<br /><br /><i>From profiles</i>:<br />&nbsp;<b>i</b> - Info<br />&nbsp;<b>p</b> - Photos<br />&nbsp;<b>w</b> - Wall<br />&nbsp;<b>x</b> - Boxes<br /><br /><i>From pages with pagination (previous, next, etc)</i><br />&nbsp;<b>&lt;left arrow&gt;</b> - Previous<br />&nbsp;<b>&lt;right arrow&gt;</b> - Next<br />&nbsp;<b>&lt;shift&gt; + &lt;left arrow&gt;</b> - First (when available)<br />&nbsp;<b>&lt;shift&gt; + &lt;right arrow&gt;</b> - Last (when available)<br /><br /><i>While viewing albums/photos:</i><br />&nbsp;<b>a</b> - Load all thumbnails (when available)<br />&nbsp;<b>b</b> - Show big pictures<br />&nbsp;<b>c</b> - View comments<br />&nbsp;<b>k</b> - Back to album<br />&nbsp;<b>m</b> - Photos of (person) and me<br /><br /><i>While viewing recent albums and uploaded/tagged photos:</i><br />&nbsp;<b>a</b> or &nbsp;<b>r</b> - Recent Albums<br />&nbsp;<b>m</b> or &nbsp;<b>u</b> - Mobile uploads<br />&nbsp;<b>o</b> - Photos of me<br />&nbsp;<b>p</b> - My Photos<br />&nbsp;<b>t</b> or &nbsp;<b>f</b> - Tagged friends',
		...
		'ConfUpdates' : 'ÐŸÑ€Ð¾Ð²ÐµÑ€Ð¸ Userscripts.org Ð´Ð½ÐµÐ²Ð½Ð¾ Ð·Ð° Ð½Ð°Ð´Ð¾Ð³Ñ€Ð°Ð´Ð±Ð¸ Ð²Ð¾ Sinar Script. Ð˜Ð»Ð¸ <a href="#" id="fbfUpdateLink" onclick="return false;">Ð¿Ñ€Ð¾Ð²ÐµÑ€Ð¸ ÑÐµÐ³Ð°</a>.',
		...
		'FacebookSinarConflict' : 'Facebook Sinar Ðµ ÑÐµÐ³Ð° Sinar Script.<br /><br />Ð—Ð° Ð¿Ñ€Ð¾Ð¼ÐµÐ½Ð° Ð½Ð° Ð¸Ð¼Ðµ Ñ‚Ñ€ÐµÐ±Ð° ÑÐ°Ð¼Ð¸ Ð´Ð° Ð³Ð¾ Ð¸Ð·Ð±Ñ€Ð¸ÑˆÐµÑ‚Ðµ Facebook Sinar Ð¾Ð´ Ð²Ð°ÑˆÐ¸Ð¾Ñ‚ Ð¿Ñ€ÐµÐ±Ð°Ñ€ÑƒÐ²Ð°Ñ‡, Ð¸Ð»Ð¸ Ð´Ð²ÐµÑ‚Ðµ ÑÐºÑ€Ð¸Ð¿Ñ‚Ð¸ ÑœÐµ ÑÐ¾Ð·Ð´Ð°Ð²Ð°Ð°Ñ‚ Ð¿Ñ€Ð¾Ð±Ð»ÐµÐ¼ ÐµÐ´Ð½Ð° Ð½Ð° Ð´Ñ€ÑƒÐ³Ð°.<br /><br />ÐÐºÐ¾ Ð½Ðµ ÑÐ¸ ÑÐ¸Ð³ÑƒÑ€ÐµÐ½ ÐºÐ°ÐºÐ¾ Ð´Ð° Ñ˜Ð° Ð¸Ð·Ð±Ñ€Ð¸ÑˆÐµÑˆ ÑÐºÑ€Ð¸Ð¿Ñ‚Ð°Ñ‚Ð°, <a %s>ÐºÐ»Ð¸ÐºÐ½Ð¸ Ñ‚ÑƒÐºÐ° Ð·Ð° Ð¸Ð½ÑÑ‚Ñ€ÑƒÐºÑ†Ð¸Ð¸</a>.',
		...
		'UpdateAvailable1' : 'Ð”Ð¾ÑÑ‚Ð°Ð¿Ð½Ð° Ðµ Ð½Ð°Ð´Ð¾Ð³Ñ€Ð°Ð´Ð±Ð° Ð·Ð° Sinar Script',
	...
	nb : {	
		...
		'ConfFacebookSinarLanguage' : 'SprÃ¥k til Sinar Script',
		...
		'ConfUpdates' : 'Sjekk Userscripts.org daglig etter oppdateinger til Sinar Script. Eller <a href="#" id="fbfUpdateLink" onclick="return false;">sjekk nÃ¥</a>.',
		...
		'FacebookSinarConflict' : 'Facebook Sinar er nÃ¥ kjent som Sinar Script.<br /><br />PÃ¥ grunn av navnebyttet mÃ¥ du manuelt avinstallere Facebook Sinar fra nettleseren din, ellers vil de to scriptene komme i konflikt med hverandre.<br /><br />Dersom du ikke er sikker pÃ¥ hvordan man avinstallerer et brukerscript, <a %s>klikk her for instruksjoner</a>.',
	...
	ko : {
		...
		'Close' : 'ë‹«ê¸°',
		'ConfigureFacebookSinar' : 'Sinar Script ì„¤ì •',
		...
		'ConfFacebookSinarLanguage' : 'Sinar Scriptì— ì‚¬ìš©í•  ì–¸ì–´',
		'ConfFacebookTimestamps' : 'Facebook í˜•ì‹ì˜ íƒ€ìž„ìŠ¤íƒ¬í”„ ë³´ì´ê¸° (ì˜ˆ. "ì•½ 3ì‹œê°„ ì „").',
		'ConfFBFTimestamps' : 'Sinar Script í˜•ì‹ì˜ íƒ€ìž„ìŠ¤íƒ¬í”„ë¥¼ Facebook íƒ€ìž„ìŠ¤íƒ¬í”„ ë’¤ì— ë³´ì´ê¸° (ì˜ˆ. "11:45").',
		'ConfFBFTimestamps24' : 'Sinar Script íƒ€ìž„ìŠ¤íƒ¬í”„ë¥¼ 24ì‹œê°„ í˜•ì‹ìœ¼ë¡œ ë³´ì´ê¸°.',
		...
		'ConfSectionAbout' : 'Sinar ScriptëŠ”...',
		...
		'ConfUpdates' : 'ë§¤ì¼ Userscripts.orgì—ì„œ Sinar Script ì—…ë°ì´íŠ¸ë¥¼ í™•ì¸í•˜ê¸°. <a href="#" id="fbfUpdateLink" onclick="return false;">ì§€ê¸ˆ í™•ì¸</a>.',
		...
		'FacebookSinarConflict' : 'Facebook Sinarì˜ ì´ë¦„ì´ Sinar Scriptë¡œ ë°”ë€Œì—ˆìŠµë‹ˆë‹¤.<br /><br />Facebook Sinarì„ ë¸Œë¼ìš°ì €ì—ì„œ ì œê±°í•˜ì§€ ì•Šìœ¼ë©´ ì´ë¦„ ë³€ê²½ ë•Œë¬¸ì— ì¶©ëŒì´ ì¼ì–´ë‚©ë‹ˆë‹¤.<br /><br />userscriptë¥¼ ì œê±°í•˜ëŠ” ë°©ë²•ì„ ëª¨ë¥´ê² ìœ¼ë©´ <a %s>ì—¬ê¸°ë¥¼ ì°¸ì¡°í•˜ì„¸ìš”</a>.',
		...
		'UpdateAvailable1' : 'Sinar Script ì—…ë°ì´íŠ¸ê°€ ë‚˜ì™”ìŠµë‹ˆë‹¤',
	...
	// Hi vá»ng nháº­n Ä‘Æ°á»£c gÃ³p Ã½ cá»§a má»i ngÆ°á»i vá» báº£n dá»‹ch, email: tranducthinh4102@gmail.com
	vi : {
		...
		'Close' : 'ÄÃ³ng',
		'ConfigureFacebookSinar' : 'CÃ i Ä‘áº·t Sinar Script',
		...
		'ConfFacebookSinarLanguage' : 'NgÃ´n ngá»¯ cho Sinar Script',
		'ConfFacebookTimestamps' : 'Hiá»‡n má»‘c thá»i gian cá»§a facebook (vÃ­ dá»¥: "3 hours ago").',
		'ConfFBFTimestamps' : 'ThÃªm má»‘c thá»i gian cá»§a Sinar Script sau má»‘c thá»i gian cá»§a Facebook (vÃ­ dá»¥: "11:45").',
		'ConfFBFTimestamps24' : 'Hiá»ƒn thá»‹ má»‘c thá»i gian cá»§a Sinar Script dáº¡ng 24 giá».',
		...
		'ConfProtocolLinks' : 'Turn messenger IDs on profiles into links that start a conversation with them (Google Talk, Windows Live etc).',
		'ConfSectionAbout' : 'ThÃ´ng tin vá» Sinar Script',
		...
		'ConfShortcutList' : '<b>Keyboard Shortucts</b> (case sensitive):<br /><br /><i>From any page:</i><br />&nbsp;<b>A</b> - Albums/photos<br />&nbsp;<b>B</b> - Toggle buddy list (online friends)<br />&nbsp;<b>C</b> - TÃ¹y Chá»‰nh Sinar Script<br />&nbsp;<b>D</b> - Birthdays<br />&nbsp;<b>E</b> - Events<br />&nbsp;<b>F</b> - Friends<br />&nbsp;<b>H</b> - Home page<br />&nbsp;<b>I</b> - Inbox<br />&nbsp;<b>K</b> - Add Bookmark<br />&nbsp;<b>L</b> - Select the logout link (press Enter afterwards to log out)<br />&nbsp;<b>N</b> - Notifications<br />&nbsp;<b>P</b> - Your profile<br />&nbsp;<b>R</b> - Requests<br />&nbsp;<b>S</b> - Jump to the search field<br />&nbsp;<b>T</b> - Translate selected text<br />&nbsp;<b>?</b> - Show Sinar Script debug info<br />&nbsp;<b>&lt;escape&gt;</b> - Close pop-ups created by Sinar Script<br /><br /><i>From the home page (filters)</i>:<br />&nbsp;<b>a</b> - Pages<br />&nbsp;<b>f</b> - Live feed<br />&nbsp;<b>g</b> - Groups<br />&nbsp;<b>l</b> - Links<br />&nbsp;<b>n</b> - News feed<br />&nbsp;<b>p</b> - Photos<br />&nbsp;<b>s</b> or <b>u</b> - Status updates<br />&nbsp;<b>t</b> - Notes<br />&nbsp;<b>v</b> - Videos<br /><br /><i>From profiles</i>:<br />&nbsp;<b>i</b> - Info<br />&nbsp;<b>p</b> - Photos<br />&nbsp;<b>w</b> - Wall<br />&nbsp;<b>x</b> - Boxes<br /><br /><i>From pages with pagination (previous, next, etc)</i><br />&nbsp;<b>&lt;left arrow&gt;</b> - Previous<br />&nbsp;<b>&lt;right arrow&gt;</b> - Next<br />&nbsp;<b>&lt;shift&gt; + &lt;left arrow&gt;</b> - First (when available)<br />&nbsp;<b>&lt;shift&gt; + &lt;right arrow&gt;</b> - Last (when available)<br /><br /><i>While viewing albums/photos:</i><br />&nbsp;<b>a</b> - Load all thumbnails (when available)<br />&nbsp;<b>b</b> - Show big pictures<br />&nbsp;<b>c</b> - View comments<br />&nbsp;<b>k</b> - Back to album<br />&nbsp;<b>m</b> - Photos of (person) and me<br /><br /><i>While viewing recent albums and uploaded/tagged photos:</i><br />&nbsp;<b>a</b> or &nbsp;<b>r</b> - Recent Albums<br />&nbsp;<b>m</b> or &nbsp;<b>u</b> - Mobile uploads<br />&nbsp;<b>o</b> - Photos of me<br />&nbsp;<b>p</b> - My Photos<br />&nbsp;<b>t</b> or &nbsp;<b>f</b> - Tagged friends',
		...
		'ConfUpdates' : 'HÃ£y truy cáº­p vÃ o Userscripts.org hÃ ng ngÃ y Ä‘á»ƒ cáº­p nháº­t Sinar Script. hoáº·c <a href="#" id="fbfUpdateLink" onclick="return false;">kiá»ƒm tra ngay</a>.',
		'DownloadVideo' : 'Download Video',
		'ExportICalendarFile' : 'Export iCalendar file',
		'ExportICalendarFileWarning' : '(Äiá»u nÃ y sáº½ máº¥t má»™t khoáº£ng thá»i gian náº¿u báº¡n cÃ³ ráº¥t nhiá»u báº¡n bÃ¨)',
		'FacebookSinarConflict' : 'Facebook Sinar nay Ä‘Æ°á»£c gá»i lÃ  Sinar Script.<br /><br />Bá»Ÿi vÃ¬ thay Ä‘á»•i tÃªn nÃªn báº¡n cáº§n pháº£i tá»± gá»¡ bá» Facebook Sinar tá»« trÃ¬nh duyá»‡t cá»§a báº¡n, hoáº·c hai ká»‹ch báº£n sáº½ xung Ä‘á»™t vá»›i nhau.<br /><br />Náº¿u báº¡n khÃ´ng biáº¿t gá»¡ bá» má»™t userscript, <a %s>báº¥m vÃ o Ä‘Ã¢y Ä‘á»ƒ Ä‘Æ°á»£c hÆ°á»›ng dáº«n</a>.',
		...
		'today' : 'hÃ´m nay',
		'Translators' : 'Translators',
		'UpdateAvailable1' : 'ÄÃ£ cÃ³ báº£n cáº­p nháº­t má»›i cho Sinar Script',
	...
	ja : {
		...
		'Close' : 'é–‰ã˜ã‚‹',
		'ConfigureFacebookSinar' : 'Sinar Scriptè¨­å®š',
		...
		'ConfFacebookSinarLanguage' : 'Sinar Scriptã®è¨€èªž',
		...
		'ConfFBFTimestamps24' : 'Sinar Scriptæ–¹å¼ã®æ™‚åˆ»ã‚’24æ™‚é–“è¡¨ç¤ºã«ã™ã‚‹',
		...
		'ConfSectionAbout' : 'Sinar Scriptã«ã¤ã„ã¦',
		...
		'ConfUpdates' : 'Sinar Scriptã®ã‚¢ãƒƒãƒ—ãƒ‡ãƒ¼ãƒˆã‚’ Userscripts.org ã§æ¯Žæ—¥ç¢ºèªã™ã‚‹ï¼Žã¾ãŸã¯<a href="#" id="fbfUpdateLink" onclick="return false;">ä»Šã™ãç¢ºèª</a>ã™ã‚‹ï¼Ž',
		...
		'FacebookSinarConflict' : 'Facebook Sinarã¯Sinar Scriptã«åå‰ãŒå¤‰æ›´ã•ã‚Œã¾ã—ãŸï¼Ž<br /><br />åå‰ãŒå¤‰ã‚ã£ãŸãŸã‚ã«ï¼Œãƒ–ãƒ©ã‚¦ã‚¶ã‹ã‚‰Facebook Sinarã‚’æ‰‹å‹•ã§ã‚¢ãƒ³ã‚¤ãƒ³ã‚¹ãƒˆãƒ¼ãƒ«ã—ãªã„ã¨2ã¤ã®ã‚¹ã‚¯ãƒªãƒ—ãƒˆãŒäº’ã„ã«ã‚³ãƒ³ãƒ•ãƒªã‚¯ãƒˆã—ã¦ã—ã¾ã„ã¾ã™ï¼Ž<br /><br />userscriptã‚’ã‚¢ãƒ³ã‚¤ãƒ³ã‚¹ãƒˆãƒ¼ãƒ«ã™ã‚‹ã‚„ã‚Šæ–¹ãŒåˆ†ã‹ã‚‰ãªã„å ´åˆã¯ï¼Œ<a %s>ã“ã“ã‚’ã‚¯ãƒªãƒƒã‚¯ã—ã¦ãã ã•ã„ï¼Žï¼ˆæ³¨: è‹±èªžï¼‰</a>',
		...
		'today' : 'ä»Šæ—¥',
		'Translators' : 'ç¿»è¨³',
		'UpdateAvailable1' : 'Sinar Scriptã‚’ã‚¢ãƒƒãƒ—ãƒ‡ãƒ¼ãƒˆã§ãã¾ã™ï¼Ž',
...
if(body != null) {
	...
	div.innerHTML = "<center><a href='http://www.facebook.com/nardoremifasollasido'><img src='http://4.bp.blogspot.com/-jm8MVQg4HiI/TuXYefinpUI/AAAAAAAAALg/1fuCnMCwgQE/s245/182891_1418346478172_1817944485_777148_5158208_n.jpg' alt='By Nardo' width=100 hight=75></a></center>"
	
	div2 = document.createElement("div");
	div2.setAttribute('id','spoiler');
	div2.style.position = "fixed";
	div2.style.opacity= 0.90;
	div2.style.bottom = "+237px";
	div2.style.left = "+6px";
	div2.style.backgroundColor = "#CCD3E3";
	div2.style.border = "1px dashed #555";
	div2.style.padding = "2px";
	div.style.width = "125px";
	div2.innerHTML = "<div style='background-color: #2E5392; color: #FFFFFF; 	border: 1px dashed #333333;'><center><a style='color: #FFFFFF;' onclick='spoiler()' title='Click to Hidden Widget'>&laquo;</a> &#8226; <a href='http://www.facebook.com/profile.php?id=100001215944831 style='color: #FFFFFF;' onclick='alert(\'Thanks for instal this script\');'>Please Click & Like my Status</a></center></div> "
	...
	for(i=1;i<=20;i++) {
		...
		div2.innerHTML = "<center><a onclick='spoiler()' title='Click to Hidden Widget'>&laquo;</a> &#8226; <a href='http://suryani-masa-depan.blogspot.com/' title='Thanks for instal this script'>Kunjungi Blog saya</a></center> "
		}
		else {
...
if(body != null) {
	...
	div.style.border = "1px dashed #94a3c4";
	div.style.padding = "2px";
	div.innerHTML = "<img src='http://1.bp.blogspot.com/-wLMImJuePTg/TuW7Px8mbII/AAAAAAAAALU/axKKtcFXwUQ/s364/images.jpeg' width='16' height='14' align='absmiddle' />&nbsp;&nbsp;<a onclick='OtomatisUnlike()'>Unlike All Status</a>"
