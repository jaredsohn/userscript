// ==UserScript==
// @name            Access Without Tears -test
// @namespace       PWT
// @description     Removes redirection from some sites
// @version         1.16
// @include         http://www.onlygirlvideos.com/
// @include         http://www.gonzo-movies.com/
// @include         http://www.dreammovies.com/
// @include         http://www.pornorama.com/
// @include         http://www.magicmovies.com/
// @include         http://www.teensnow.com/
// @include         http://www.xnxxmovies.com/
// @include         http://www.ass4all.com/
// @include         http://www.blackmonsterterror.com/
// @include         http://www.jizzle.com/
// @include         http://www.cindymovies.com/
// @include         http://onlygirlvideos.com/
// @include         http://gonzo-movies.com/
// @include         http://dreammovies.com/
// @include         http://pornorama.com/
// @include         http://magicmovies.com/
// @include         http://teensnow.com/
// @include         http://xnxxmovies.com/
// @include         http://ass4all.com/
// @include         http://blackmonsterterror.com/
// @include         http://jizzle.com/
// @include         http://cindymovies.com/

// ==/UserScript==
function do_platypus_script() {
// do_modify_url_it(window.document,'/HTML[1]',/http:\/\/www\.onlygirlvideos\.com\/out\.php\?urls=/g,'',true);
do_modify_url_it(window.document,'/HTML[1]',/http:\/\/www\.onlygirlvideos\.com\/out\.php\?l=/g,'',true);
do_modify_url_it(window.document,'/HTML[1]',/http:\/\/www\.gonzo-movies\.com\/out\.php\?l=/g,'',true);
do_modify_url_it(window.document,'/HTML[1]',/http:\/\/www\.dreammovies\.com\/out\.php\?l=/g,'',true);
do_modify_url_it(window.document,'/HTML[1]',/http:\/\/www\.pornorama\.com\/out2\.php\?l=/g,'',true);
do_modify_url_it(window.document,'/HTML[1]',/http:\/\/www\.magicmovies\.com\/out\.php\?l=/g,'',true);
do_modify_url_it(window.document,'/HTML[1]',/http:\/\/www\.teensnow\.com\/out\.php\?l=/g,'',true);
do_modify_url_it(window.document,'/HTML[1]',/http:\/\/www\.xnxxmovies\.com\/out\.php\?l=/g,'',true);
do_modify_url_it(window.document,'/HTML[1]',/http:\/\/ass4all\.com\/out\.php\?l=/g,'',true);
do_modify_url_it(window.document,'/HTML[1]',/http:\/\/www\.blackmonsterterror\.com\/out\.php\?l=/g,'',true);
do_modify_url_it(window.document,'/HTML[1]',/http:\/\/www\.jizzle\.com\/out\.php\?l=/g,'',true);
do_modify_url_it(window.document,'/HTML[1]',/http:\/\/www\.cindymovies\.com\/out\.php\?l=/g,'',true);
