...
// @name           LUEbar 2.0 WoodLL Edition
// @namespace      categoryfilter
// @description    Makes the userbar less shitty, more woody.
...
//not here.
addGlobalStyle(' body { margin-top: 32px; }  #p-cactions { top: 4em;} #p-logo { top: 32px;} .body { margin-top: 40px; } #navbar, #navbar ul {  padding: 0;  margin: 0;  list-style: none; font-size: 9pt; font-family: "Arial",sans-serif; line-height: 14px;} #navbar a:link { text-decoration: none; color: #DDE3EB; } #navbar a:hover { text-decoration: none; color: #DDE3EB; background-color: rgba(123, 123, 123, 0.6); } #navbar a:visited { text-decoration: none; color: #DDE3EB; } #navbar a:active { text-decoration: none; color: #DDE3EB; }  #navbar li:hover ul {  display: block; }  #navbar {  top: 0px;  left: 0px;  width: 100%;  height: 30px;  position: fixed;  background-color: rgba(180, 180, 180, 0.7);  z-index: 50; border-left: 3px solid #cacaca; boder-right: 3px solid #cacaca; }  #navbar a {  display: block;  padding: 2px 0px; }  #navbar li { width:200px;  margin: 4px 0px 0px 6px;  border: 2px solid rgba(123, 123, 123, 0.9);  float: left;  text-align: center;  font-weight: bold; }  #navbar li ul {  display: none;  position: absolute;  width:200px;  background-color: rgba(168, 168, 168, 0.65);  margin-top: 2px;  margin-left: -2px;  border-left: 2px solid rgba(123, 123, 123, 0.9);  border-bottom: 2px solid rgba(123, 123, 123, 0.9);  border-right: 2px solid rgba(123, 123, 123, 0.9);  z-index: 50; }  #navbar li ul li {  width:200px;  position: relative;  margin: 0px;  border: none;  text-align: left; } #navbar li ul li a {  padding: 2px 4px; }  #navbar li .divider {  border-bottom: 2px solid rgba(123, 123, 123, 0.9); }  div.userbar {  top: 30px;  left: 0px;  width: 100%;  padding: 2px 0px;  position: fixed; z-index: 0; } #centernav { width:1300px; margin:0 auto; }');
