...
// @description    Added new features to Transport++ Bot
// ==/UserScript==
...
Tabs.transport = {
  ...
  check:false,
    ...
    init: function(div){
	  ...
	  m += '<TD width=55px align=right><INPUT id=pbshipFoodMin type=checkbox unchecked=true\>Min</td>';
      ...
      m += '<TD width=55px align=right><INPUT id=pbshipWoodMin type=checkbox unchecked=true\>Min</td>';
      ...
      m += '<TD width=55px align=right><INPUT id=pbshipStoneMin type=checkbox unchecked=true\>Min</td>';
      ...
      m += '<TD width=55px align=right><INPUT id=pbshipOreMin type=checkbox unchecked=true\>Min</td>';
	  ...
	  m += '<TD width=55px align=right><INPUT id=pbshipAstoneMin type=checkbox unchecked=true\>Min</td>';
      ...
      m += '<TD width=55px align=right><INPUT id=pbshipGoldMin type=checkbox unchecked=true\>Min</td>';
     ...
     document.getElementById('pbminwagons').addEventListener('keyup', function(){
      ...
      document.getElementById('pbshipFoodMin').addEventListener('click', function(){
          if (document.getElementById('pbshipFoodMin').checked==false) {
              document.getElementById('pbtargetamountFood').disabled = true;
              document.getElementById('pbshipFood').disabled = false;
          }
          else {
            document.getElementById('pbtargetamountFood').disabled = false;
			document.getElementById('pbshipFood').checked = false;
			document.getElementById('pbshipFood').disabled = true;
          }
      },false); 
      document.getElementById('pbshipFood').addEventListener('click', function(){
          if (document.getElementById('pbshipFood').checked==false) {
              document.getElementById('pbtargetamountFood').disabled = true;
			  document.getElementById('pbshipFoodMin').disabled = false;
          }
          else {
            document.getElementById('pbtargetamountFood').disabled = false;
			document.getElementById('pbshipFoodMin').disabled = true;
          }
      },false);  
      
	  document.getElementById('pbshipWoodMin').addEventListener('click', function(){
          if (document.getElementById('pbshipWoodMin').checked==false) {
              document.getElementById('pbtargetamountWood').disabled = true;
              document.getElementById('pbshipWood').disabled = false;
          }
          else {
            document.getElementById('pbtargetamountWood').disabled = false;
			document.getElementById('pbshipWood').checked = false;
			document.getElementById('pbshipWood').disabled = true;
          }
      },false); 
	  document.getElementById('pbshipWood').addEventListener('click', function(){
          if (document.getElementById('pbshipWood').checked==false) {
              document.getElementById('pbtargetamountWood').disabled = true;
			  document.getElementById('pbshipWoodMin').disabled = false;
          }
          else {
            document.getElementById('pbtargetamountWood').disabled = false;
			document.getElementById('pbshipWoodMin').disabled = true;
          }
      },false);
	  
	  document.getElementById('pbshipStoneMin').addEventListener('click', function(){
          if (document.getElementById('pbshipStoneMin').checked==false) {
              document.getElementById('pbtargetamountStone').disabled = true;
              document.getElementById('pbshipStone').disabled = false;
          }
          else {
            document.getElementById('pbtargetamountStone').disabled = false;
			document.getElementById('pbshipStone').checked = false;
			document.getElementById('pbshipStone').disabled = true;
          }
      },false); 
      document.getElementById('pbshipStone').addEventListener('click', function(){
          if (document.getElementById('pbshipStone').checked==false) {
              document.getElementById('pbtargetamountStone').disabled = true;
			  document.getElementById('pbshipStoneMin').disabled = false;
          }
          else {
            document.getElementById('pbtargetamountStone').disabled = false;
			document.getElementById('pbshipStoneMin').disabled = true;
          }
      },false);
	  
      document.getElementById('pbshipOreMin').addEventListener('click', function(){
          if (document.getElementById('pbshipOreMin').checked==false) {
              document.getElementById('pbtargetamountOre').disabled = true;
              document.getElementById('pbshipOre').disabled = false;
          }
          else {
            document.getElementById('pbtargetamountOre').disabled = false;
			document.getElementById('pbshipOre').checked = false;
			document.getElementById('pbshipOre').disabled = true;
          }
      },false); 
	  document.getElementById('pbshipOre').addEventListener('click', function(){
          if (document.getElementById('pbshipOre').checked==false) {
              document.getElementById('pbtargetamountOre').disabled = true;
			  document.getElementById('pbshipOreMin').disabled = false;
          }
          else {
            document.getElementById('pbtargetamountOre').disabled = false;
			document.getElementById('pbshipOreMin').disabled = true;
          }
      },false);
	  
	  document.getElementById('pbshipAstoneMin').addEventListener('click', function(){
          if (document.getElementById('pbshipAstoneMin').checked==false) {
              document.getElementById('pbtargetamountAstone').disabled = true;
              document.getElementById('pbshipAstone').disabled = false;
          }
          else {
            document.getElementById('pbtargetamountAstone').disabled = false;
			document.getElementById('pbshipAstone').checked = false;
			document.getElementById('pbshipAstone').disabled = true;
          }
      },false); 
	  document.getElementById('pbshipAstone').addEventListener('click', function(){
          if (document.getElementById('pbshipAstone').checked==false) {
              document.getElementById('pbtargetamountAstone').disabled = true;
			  document.getElementById('pbshipAstoneMin').disabled = false;
          }
          else {
            document.getElementById('pbtargetamountAstone').disabled = false;
			document.getElementById('pbshipAstoneMin').disabled = true;
          } 
      },false);

      document.getElementById('pbshipGoldMin').addEventListener('click', function(){
          if (document.getElementById('pbshipGoldMin').checked==false) {
              document.getElementById('pbtargetamountGold').disabled = true;
              document.getElementById('pbshipGold').disabled = false;
          }
          else {
            document.getElementById('pbtargetamountGold').disabled = false;
			document.getElementById('pbshipGold').checked = false;
			document.getElementById('pbshipGold').disabled = true;
          }
      },false); 	  
      document.getElementById('pbshipGold').addEventListener('click', function(){
          if (document.getElementById('pbshipGold').checked==false) {
              document.getElementById('pbtargetamountGold').disabled = true;
			  document.getElementById('pbshipGoldMin').disabled = false;
          }
          else {
            document.getElementById('pbtargetamountGold').disabled = false;
			document.getElementById('pbshipGoldMin').disabled = true;
          }
      },false);
 ...
 e_tradeRoutes: function(){
	...
	addTradeRoute: function () {
		...
		// Minsend Erweiterung
		var ship_FoodMin = document.getElementById('pbshipFoodMin').checked;
		var ship_WoodMin = document.getElementById('pbshipWoodMin').checked;
		var ship_StoneMin = document.getElementById('pbshipStoneMin').checked;
		var ship_OreMin = document.getElementById('pbshipOreMin').checked;
		var ship_AstoneMin = document.getElementById('pbshipAstoneMin').checked;
		var ship_GoldMin = document.getElementById('pbshipGoldMin').checked;
		...
		if (valid == true) {
			...
			lTR.push({
				...
				TroopType:   	    TroopType,
				route_state: 		"true",
				route_single_send: 	"false",
				ship_FoodMin: 		ship_FoodMin,
				ship_WoodMin:		ship_WoodMin,
				ship_StoneMin:		ship_StoneMin,
				ship_OreMin:		ship_OreMin,
				ship_AstoneMin:		ship_AstoneMin,
				ship_GoldMin:		ship_GoldMin
			});
		}
	...
	showTradeRoutes: function () {
		...
		t.popTradeRoutes = new CPopup('pbShowTrade', 0, 0, 750, 900, true, function() {clearTimeout (1000);});
		var m = '<DIV style="max-height:860px; height:860px; overflow-y:auto"><TABLE align=center cellpadding=0 cellspacing=0 width=100% class="pbTab" id="pbRoutesQueue">';       
...
saveTradeRoutes: function(){
	...
	testfunction: function (queueId){
		var t = Tabs.transport;
		var r = t.tradeRoutes;
		r[queueId].route_state = document.getElementById('TradeStatus'+queueId).checked;
	
        var serverID = getServerId();
        GM_setValue('tradeRoutes_' + Seed.player['name'] + '_'+ serverID, JSON2.stringify(t.tradeRoutes));
	},
	
	route_single_send_function: function (queueId){
		var t = Tabs.transport;
		var r = t.tradeRoutes;
		r[queueId].route_single_send = document.getElementById('route_single_send'+queueId).checked;
	    ...
	    var m= '<TABLE id=paintRoutes class=pbTab>'; 
			for (var i=0;i<(r.length);i++) {
			  citynameTo = null;
				...
				m +='<TR><TD width=20px>'+(i+1)+'</td><TD width=155px>From:&nbsp;&nbsp;'+ cityname +'</TD><TD width=155px>To:&nbsp;&nbsp;'+ TO +'</td><TD width=155px><INPUT id=TradeStatus'+i+' type=checkbox onclick="wintestfunction('+i+')"/>&nbsp;Enable Route</td>';
				
				m +='<TD><INPUT id=route_single_send'+i+' type=checkbox onclick="winroute_single_send_function('+i+')"\>&nbsp;Single Send</td>';         
	...
	for (var i=0;i<(r.length);i++) {
		document.getElementById('TradeStatus'+i).checked = r[i].route_state;
		document.getElementById('route_single_send'+i).checked = r[i].route_single_send;
		}

		unsafeWindow.traceEdit = t.editQueueElement;
		unsafeWindow.traceDelete = t.cancelQueueElement;
		unsafeWindow.wintestfunction = t.testfunction;
		unsafeWindow.winroute_single_send_function = t.route_single_send_function;
	    },
	 ...
	 editQueueElement: function(queueId){
       ...
       for (var i=0;i<Types.length;i++){
		 ...
		 n += '<TD width=50px align=center><INPUT id=pbbship'+Types[i]+'Min type=checkbox>Min</td>';
	   ...
	   // fÃ¼r minsend
	   document.getElementById('pbbshipfoodMin').checked = r[queueId].ship_FoodMin;
       document.getElementById('pbbshipwoodMin').checked = r[queueId].ship_WoodMin;
       document.getElementById('pbbshipstoneMin').checked = r[queueId].ship_StoneMin;
       document.getElementById('pbbshipironMin').checked = r[queueId].ship_OreMin;
	   document.getElementById('pbbshipaetherstoneMin').checked = r[queueId].ship_AstoneMin;
       document.getElementById('pbbshipgoldMin').checked = r[queueId].ship_GoldMin;
       ...
       document.getElementById('Save').addEventListener('click', function(){
			...
			//fÃ¼r minsend
			r[queueId].ship_FoodMin = document.getElementById('pbbshipfoodMin').checked;
            r[queueId].ship_WoodMin = document.getElementById('pbbshipwoodMin').checked;
            r[queueId].ship_StoneMin = document.getElementById('pbbshipstoneMin').checked;
            r[queueId].ship_OreMin = document.getElementById('pbbshipironMin').checked;
			r[queueId].ship_AstoneMin = document.getElementById('pbbshipaetherstoneMin').checked;
            r[queueId].ship_GoldMin = document.getElementById('pbbshipgoldMin').checked;
  ...
  doTrades: function(count){
	...
	var params = unsafeWindow.Object.clone(unsafeWindow.g_ajaxparams);
		...
		// Zielstadt aus Koordinaren ermitteln
		for (var y=0; y< Seed.cities.length;y++) {
			if ( parseInt(Seed.cities[y][2]) == xcoord && parseInt(Seed.cities[y][3]) == ycoord) var cityIDto = 'city' + Seed.cities[y][0];
		}
		
		// actionLog('cityIDto:'+cityIDto);

		//wert ermitteln bei Min-Belegung
		var ship_FoodMin = t.tradeRoutes[count]["ship_FoodMin"];
    	var ship_WoodMin = t.tradeRoutes[count]["ship_WoodMin"];
    	var ship_StoneMin = t.tradeRoutes[count]["ship_StoneMin"];
    	var ship_OreMin = t.tradeRoutes[count]["ship_OreMin"];
		var ship_AstoneMin = t.tradeRoutes[count]["ship_AstoneMin"];
    	var ship_GoldMin = t.tradeRoutes[count]["ship_GoldMin"];
		
		// neue Variablen fÃ¼r Zielstadt
		if (cityIDto!=undefined){
			var cityTOmax_Food = parseIntNan(Seed.resources[cityIDto]['rec1'][0] / 3600);
			var cityTOmax_Wood = parseIntNan(Seed.resources[cityIDto]['rec2'][0] / 3600);
			var cityTOmax_Stone = parseIntNan(Seed.resources[cityIDto]['rec3'][0] / 3600);
			var cityTOmax_Ore = parseIntNan(Seed.resources[cityIDto]['rec4'][0] / 3600);
			var cityTOmax_Astone = parseIntNan(Seed.resources[cityIDto]['rec5'][0]);
			var cityTOmax_Gold = parseIntNan(Seed.citystats[cityIDto]['gold']);
		};	
		
		if (ship_FoodMin==true) {
			carry_Food = parseIntNan(target_Food - cityTOmax_Food);
			if (carry_Food < 0) carry_Food = 0;
		};
		if (ship_WoodMin==true) {
			carry_Wood = parseIntNan(target_Wood - cityTOmax_Wood);
			if (carry_Wood < 0) carry_Wood = 0;
		};
		if (ship_StoneMin==true) {
			carry_Stone = parseIntNan(target_Stone - cityTOmax_Stone);
			if (carry_Stone < 0) carry_Stone = 0;
		};
		if (ship_OreMin==true) {
			carry_Ore = parseIntNan(target_Ore - cityTOmax_Ore);
			if (carry_Ore < 0) carry_Ore = 0;
		};
		if (ship_AstoneMin==true) {
			carry_Astone = parseIntNan(target_Astone - cityTOmax_Astone);
			if (carry_Astone < 0) carry_Astone = 0;
		};
		if (ship_GoldMin==true) {
			carry_Gold = parseIntNan(target_Gold - cityTOmax_Gold);
			if (carry_Gold < 0) carry_Gold = 0;
		};
		
	
		// actionLog('target_Food:'+target_Food+'   cityTOmax_Food:'+cityTOmax_Food);
		// actionLog('target_Wood:'+target_Wood+'   cityTOmax_Wood:'+cityTOmax_Wood);
		// actionLog('target_Stone:'+target_Stone+'   cityTOmax_Stone:'+cityTOmax_Stone);
		// actionLog('target_Ore:'+target_Ore+'   cityTOmax_Ore:'+cityTOmax_Ore);
		// actionLog('target_Astone:'+target_Astone+'   cityTOmax_Astone:'+cityTOmax_Astone);
		// actionLog('target_Gold:'+target_Gold+'   cityTOmax_Gold:'+cityTOmax_Gold);
		// actionLog(':'+carry_Food+':'+carry_Wood+':'+carry_Stone+':'+carry_Ore+':'+carry_Astone+':'+carry_Gold);
		
		// Originalcode = notwenig wenn die Transportmenge vorgegeben ist und kleiner der mÃ¶glichen Menge ist
		...
		//actionLog('Transportieren:'+carry_Ore+'         cityTOmax_Ore:'+cityTOmax_Ore+'   '+ship_FoodMin+ship_OreMin+'     target_Ore:'+target_Ore);
      ...
      case 'unt12': params.u12 = wagons_needed;break;
         ...
         new AjaxRequest(unsafeWindow.g_ajaxpath + "ajax/march.php" + unsafeWindow.g_ajaxsuffix, {
				  ...
				  if(r[count].route_single_send){				  
						r[count].route_state = false;
						document.getElementById('TradeStatus'+count).checked = false;
						t.saveTradeRoutes();
