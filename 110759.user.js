...
function letsJQuery() { 
	...
	$('textarea').css('font-family', 'Lucida Grande').css('font-size', '12px');
	$("input[name='cancel']").after(' <a style="font-size:12px;" href="http://page-flip.com'+ str_replace("%2F", "/", gup('path'))+'" target="_blank">View page</a>');
}