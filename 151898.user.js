// ==UserScript==
// @author   	 ThomasRed (source : Angel Vladov). Modifications by MC46
// @name    	T4L-ReportScript
// @namespace   T4L-ReportScript
// @version   	 2.7
// @uso:version 2.7
// @include   	 http://*erepublik.com/*/military/battlefield/*
// @description	T4L-ReportScript
// ==/UserScript==
...
if(window.location.href.indexOf(PAGE_BATTLEFIELD) > 0) {    
    ...
    /***********************************************************************************/
    var FORM_URL = "https://docs.google.com/spreadsheet/viewform?formkey=dFoxYXpYZHd6UEtRM0t0NHFmSXU5ZWc6MQ";
    var FORM_FIELDS = {
   			  eday: "entry.0.single",
            	name: "entry.1.single",
   			 UM:  "entry.2.single",
            	...
            	DO: "entry.5.single",
            	dq7hit: "entry.6.single",
            	battle: "entry.7.single",
            	wall: "entry.8.single",
            	donate: "entry.9.single"
            	/*version: "entry.10.single"*/
    	};
    ...
    var LOCALE = {
   	 en:function() {
   		 return {
   			 ...
   			 send_report: "Vuoi mandare un report?",
   			 button_send: "Invia Report",
   			 round_end: "Il round è finito. Vuoi mandare un report??",
   			 damage: "Danni",
   			 DO_satus: "Stato DO",
   			 report: "Report!",
   			 report_title: "Manda Report!",
   			 report_failed: "Errore sconosciuto. Per favore riprova a mandare un report."
   		 };
   	 },
   	 bg: function() {
   		 return {
    ...
    function BattlePage() {
    	...
    	var dmgq7hit=Math.floor(Math.floor((parseInt(rankl)+5)*(parseFloat(str)+400)*0.005)*3);
