// ==UserScript==
// @name           Feuerwache.net Ereglam's AAO und Tools
// @namespace      http://userscripts.org/users/ereglam
// @copyright      2010+, Ereglam (http://userscripts.org/users/Ereglam {385078})
...
var USERSCRIPTID="116761"; // diese Konstante ist anzupassen
/* ******************************************************************************************
  H I N W E I S !!
...
*/
  ...
  'Auffahrunfall'                  : {stwDef: 'TH'                          , storm: false, wiki: 'Auffahrunfall'                 , ab: {FW:  4}},
  'Baum auf Auto'                  : {stwDef: 'TH1+GWÖl'                    , storm: true,  wiki: 'Baum_auf_Auto'                 , ab: {FW:  9}},
  'Baum auf Dach'                  : {stwDef: 'TH1+DLK'                     , storm: true,  wiki: 'Baum_auf_Dach'                 , ab: {FW:  8}},
  'Baum auf Straße'                : {stwDef: 'TH'                          , storm: true,  wiki: 'Baum_auf_Stra%C3%9Fe'          , ab: {FW:  1}},
  'Brand in KFZ-Werkstatt'         : {stwDef: 'F2+ELW,FwK'                  , storm: false, wiki: 'Brand_in_KFZ-Werkstatt'        , ab: {FW: 15}},
  'Brand in Schule'                : {stwDef: 'F4L+GWA'                     , storm: false, wiki: 'Brand_in_Schule'               , ab: {FW:  5}},
  'Brand in Spedition'             : {stwDef: 'F4G+DLK|TUIS'                , storm: false, wiki: 'Brand_in_Spedition'            , ab: {FW:  5}},
  'Brand in Sporthalle'            : {stwDef: 'F4+GWA,GWL'                  , storm: false, wiki: 'Brand_in_Sporthalle'           , ab: {FW: 40}},
  'Brand im Sägewerk'              : {stwDef: 'F4+GWA,GWL'                  , storm: false, wiki: 'Brand_im_S%C3%A4gewerk'        , ab: {FW: 40}},
  'Brand im Supermarkt'            : {stwDef: 'F3L+FwK'                     , storm: false, wiki: 'Brand_im_Supermarkt'           , ab: {FW:  4}},
  'Brennende Bäume'                : {stwDef: 'F2'                          , storm: false, wiki: 'Brennende_B%C3%A4ume'          , ab: {FW:  2}},
  'Brennende Telefonzelle'         : {stwDef: 'F1'                          , storm: false, wiki: 'Brennende_Telefonzelle'        , ab: {FW:  1}},
  'Brennender LKW'                 : {stwDef: 'F1|ELW,TUIS'                 , storm: false, wiki: 'Brennender_LKW'                , ab: {FW:  1}},
  'Brennender PKW'                 : {stwDef: 'F1'                          , storm: false, wiki: 'Brennender_PKW'                , ab: {FW:  1}},
  'Brennendes Gras'                : {stwDef: 'F1'                          , storm: false, wiki: 'Brennendes_Gras'               , ab: {FW:  1}},
  'Chemieunfall (an Schule)'       : {stwDef: 'GSG'                         , storm: false, wiki: 'Chemieunfall_(an_Schule)'      , ab: {BF:  2}},
  'Chlorgas Alarm (Schwimmbad)'    : {stwDef: 'GSG+RW'                      , storm: false, wiki: 'Chlorgas_Alarm_(Schwimmbad)'   , ab: {BF:  3}},
  'Container Brand'                : {stwDef: 'F1'                          , storm: false, wiki: 'Containerbrand'                , ab: {FW:  1}},
  'Dachstuhlbrand'                 : {stwDef: 'F2L+LF/HLFS|ELW'             , storm: false, wiki: 'Dachstuhlbrand'                , ab: {FW:  3}},
  'Fahrstuhl - Türöffnung'         : {stwDef: 'TH1'                         , storm: false, wiki: 'Fahrstuhl-T%C3%BCr%C3%B6ffnung', ab: {FW: 15}},
  'Fettbrand in Pommesbude'        : {stwDef: 'F2+TLF'                      , storm: false, wiki: 'Fettbrand_in_Pommesbude'       , ab: {FW:  3}},
  'Feuer im Altenheim'             : {stwDef: 'F4L+GWA'                     , storm: false, wiki: 'Feuer_im_Altenheim'            , ab: {FW:  6}},
  'Feuer im Laubhaufen'            : {stwDef: 'F1'                          , storm: false, wiki: 'Feuer_im_Laubhaufen'           , ab: {FW:  1}},
  'Gartenlaubenbrand'              : {stwDef: 'F1'                          , storm: false, wiki: 'Gartenlaubenbrand'             , ab: {FW:  1}},
  'Gastronomiebrand'               : {stwDef: 'F3'                          , storm: false, wiki: 'Gastronomiebrand'              , ab: {FW:  8}},
  'Kellerbrand'                    : {stwDef: 'F2'                          , storm: false, wiki: 'Kellerbrand'                   , ab: {FW:  3}},
  'Keller unter Wasser'            : {stwDef: 'TH'                          , storm: true,  wiki: 'Keller_unter_Wasser'           , ab: {FW:  2}},
  'Kinobrand'                      : {stwDef: 'F4L+TLF,GWA|LF/HLFS'         , storm: false, wiki: 'Kinobrand'                     , ab: {FW: 10}},
  'Motorrad-Brand'                 : {stwDef: 'F1'                          , storm: false, wiki: 'Motorradbrand'                 , ab: {FW:  1}},
  'Mülleimer Brand'                : {stwDef: 'F1'                          , storm: false, wiki: 'M%C3%BClleimerbrand'           , ab: {FW:  1}},
  'Scheunenbrand'                  : {stwDef: 'F3+GWL'                      , storm: false, wiki: 'Scheunenbrand'                 , ab: {FW: 30}},
  'Schornsteinbrand'               : {stwDef: 'F2L'                         , storm: false, wiki: 'Schornsteinbrand'              , ab: {FW:  3}},
  'Silobrand'                      : {stwDef: 'F2+LF/HLFS'                       , storm: false, wiki: 'Silobrand'                     , ab: {FW: 20}},
  'Sperrmüllbrand'                 : {stwDef: 'F1'                          , storm: false, wiki: 'Sperrm%C3%BCllbrand'           , ab: {FW:  1}},
  'Strohballen Brand'              : {stwDef: 'F2+GWL'                      , storm: false, wiki: 'Strohballen_Brand'             , ab: {FW:  1}},
  'Traktorbrand'                   : {stwDef: 'F1'                          , storm: false, wiki: 'Traktorbrand'                  , ab: {FW:  1}},
  'Verkehrsunfall'                 : {stwDef: 'TH1+GWÖl'                    , storm: false, wiki: 'Verkehrsunfall'                , ab: {FW:  4}},
  'Wohnblockbrand'                 : {stwDef: 'F4+LF/HLFS,GWA|LF/HLFS,LF/HLFS', storm: false, wiki: 'Wohnblockbrand'                , ab: {FW: 45}},
  'Wohnungsbrand'                  : {stwDef: 'F2+LF/HLFS|ELW'              , storm: false, wiki: 'Wohnungsbrand'                 , ab: {FW:  2}},
// neue Einsatztypen (chronologisch, neuste unten (ab 28.12.2009)
  'Gewerbebrand'                   : {stwDef: 'F4L+GWA,RW'                  , storm: false, wiki: 'Gewerbebrand'                  , ab: {FW: 35}},
  'Feldbrand'                      : {stwDef: 'F1+GWL'                      , storm: false, wiki: 'Feldbrand'                     , ab: {FW:  1}},
  'Brand im Baumarkt'              : {stwDef: 'F3G+GWA'                     , storm: false, wiki: 'Brand_im_Baumarkt'             , ab: {BF: 20}},
// Einsätze neu ab 22.01.2010
  'Brennender Sicherungskasten'    : {stwDef: 'F1'                          , storm: false, wiki: 'Brennender_Sicherungskasten'   , ab: {FW:  1}},
  'Schuppenbrand'                  : {stwDef: 'F2+GWG,GWM'                  , storm: false, wiki: 'Schuppenbrand'                 , ab: {FW:  4}},
  'Brennende S-Bahn'               : {stwDef: 'F2+GWS'                      , storm: false, wiki: 'Brennende_S-Bahn'              , ab: {FW: 20}},
//neu ab 08.03.2010
  'Wohnwagenbrand'                 : {stwDef: 'F1'                          , storm: false, wiki: 'Wohnwagenbrand'                , ab: {FW:  1}},
  'Brand in Briefkasten'           : {stwDef: 'F1'                          , storm: false, wiki: 'Brand_in_Briefkasten'          , ab: {FW:  1}},
  'Kleiner Waldbrand'              : {stwDef: 'F2|GWL'                      , storm: false, wiki: 'Kleiner_Waldbrand'             , ab: {FW:  1}},
  'Brennender Müllwagen'           : {stwDef: 'F1'                          , storm: false, wiki: 'Brennender_M%C3%BCllwagen'     , ab: {FW:  1}},
  'Ölspur'                         : {stwDef: 'TH+GWÖl'                     , storm: false, wiki: '%C3%96lspur'                   , ab: {FW:  5}},
  'Brand in Zugdepot'              : {stwDef: 'F3L+RW,GWL,GWA,GWS|LF/HLFS'  , storm: false, wiki: 'Brand_in_Zugdepot'             , ab: {FW: 10}},
  'Brand in Autohaus'              : {stwDef: 'F4L+GWA,GWM'                 , storm: false, wiki: 'Brand_in_Autohaus'             , ab: {FW: 10}},
  'Brand in Druckerei'             : {stwDef: 'F4L+GWA,GWL,RW'              , storm: false, wiki: 'Brand_in_Druckerei'            , ab: {BF: 20}},
  'Brand in Lackfabrik'            : {stwDef: 'GSG2'                        , storm: false, wiki: 'Brand_in_Lackfabrik'           , ab: {FW: 25}},
  'Person im Fluss'                : {stwDef: 'THW'                         , storm: false, wiki: 'Person_im_Fluss'               , ab: {BF: 25}},
// neu ab 29.03.2010
  'Brand im Casino'                : {stwDef: 'F4L+LF/HLFS,TLF,GWA,GWL|LF/HLFS,LF/HLFS,LF/HLFS', storm: false, wiki: 'Brand_in_Casino'               , ab: {FW: 50}},
  'Brand in Reifenlager'           : {stwDef: 'GSG+GWL|LF/HLFS,LF/HLFS'     , storm: false, wiki: 'Brand_in_Reifenlager'          , ab: {FW: 20}},
  'Trocknerbrand'                  : {stwDef: 'F1|LF/HLFS'                  , storm: false, wiki: 'Trocknerbrand'                 , ab: {FW:  1}},
// neu ab 23.04.2010
  'Brennendes Gebüsch'             : {stwDef: 'F1'                          , storm: false, wiki: 'Brennendes_Geb%C3%BCsch'       , ab: {FW:  1}},
  'Kioskbrand'                     : {stwDef: 'F1'                          , storm: false, wiki: 'Kioskbrand'                    , ab: {FW:  2}},
  'Garagenbrand'                   : {stwDef: 'F2+TLF'                      , storm: false, wiki: 'Garagenbrand'                  , ab: {FW:  4}},
  'Mähdrescherbrand'               : {stwDef: 'F2+TLF'                      , storm: false, wiki: 'M%C3%A4hdrescherbrand'         , ab: {FW:  5}},
  'Kaminbrand'                     : {stwDef: 'F2L'                         , storm: false, wiki: 'Kaminbrand'                    , ab: {FW:  5}},
  'PKW in Fluss'                   : {stwDef: 'THW+RW,FwK'                  , storm: false, wiki: 'PKW_in_Fluss'                  , ab: {FW: 15}},
  'Brand in Schloss'               : {stwDef: 'F3L'                         , storm: false, wiki: 'Brand_in_Schloss'              , ab: {FW: 20}},
  'Brand in Kühlhaus'              : {stwDef: 'GSG+DLK,GWL|LF/HLFS,LF/HLFS' , storm: false, wiki: 'Brand_in_K%C3%BChlhaus'        , ab: {FW: 20}},
  'Feuer im Krankenhaus'           : {stwDef: 'F4G+DLK,GWA|LF/HLFS,LF/HLFS,LF/HLFS', storm: false, wiki: 'Feuer_im_Krankenhaus'          , ab: {BF: 40}},
  'Brand in Kletterhalle'          : {stwDef: 'F3L+GWL'                     , storm: false, wiki: 'Brand_in_Kletterhalle'         , ab: {BF: 45}},
// neu ab 23.08.2010
  'Grasnarbenbrand'                : {stwDef: 'F1|FLF'                      , storm: false, wiki: 'Grasnarbenbrand'               , ab: {FW: 59}},
// neu ab 01.09.2010
  'Brennendes Flugzeug'            : {stwDef: 'Crash|FLF,FLF'               , storm: false, wiki: 'Brennendes_Flugzeug'           , ab: {FW: 59}},
// neu ab 22.10.2010
  'Brand in Industriepark'         : {stwDef: 'VGSL'                        , storm: false, wiki: 'Brand_in_Industriepark'        , ab: {MG:  3}}, //Verbandsgroßschadenslage
// neu ab 27.10.2010
  'Brand in Eishalle'              : {stwDef: 'TH2+LF/HLFS,TLF,ELW,DLK,GWL' , storm: false, wiki: 'Brand_in_Eishalle'             , ab: {FW:  5}},
  'Brand in Gärtnerei'             : {stwDef: 'GSG+DLK'                     , storm: false, wiki: 'Brand_in_G%C3%A4rtnerei'       , ab: {FW:  8}},
  'Brand in Metzgerei'             : {stwDef: 'F3+DLK,GWL'                  , storm: false, wiki: 'Brand_in_Metzgerei'            , ab: {BF:  2}},
// neu ab 19.11.2010
  'Feuer auf Boot (Klein)'         : {stwDef: 'FB1'                         , storm: false, wiki: 'Feuer_auf_Boot_(Klein)'        , ab: {BF: 30}, onWater: true},
// neu ab 28.11.2010
  'Feuer auf Boot (Mittel)'        : {stwDef: 'FB1+FLB'                     , storm: false, wiki: 'Feuer_auf_Boot_(Mittel)'       , ab: {BF: 30}, onWater: true},
// neu ab 13.12.2010
  'Gabelstapler im Hafenbecken'    : {stwDef: 'THW+LF/HLFS,RW,FwK'          , storm: false, wiki: 'Gabelstapler_im_Hafenbecken'   , ab: {FW: 40}},
// neu ab 24.12.2010
  'Verletztentransport'            : {stwDef: 'RD'                          , storm: false, wiki: 'Verletztentransport'           , ab: {FW: 50}},
// neu ab 05.01.2011
  'Brand in Gemeindehaus'          : {stwDef: 'F2'                          , storm: false, wiki: 'Brand_in_Gemeindehaus'         , ab: {FW:  3}},
  'Maschinenbrand'                 : {stwDef: 'F3+GWL'                      , storm: false, wiki: 'Maschinenbrand'                , ab: {FW:  5}},
  'Brand in Steinbruch'            : {stwDef: 'VGSL'                        , storm: false, wiki: 'Brand_in_Steinbruch'           , ab: {MG:  3}}, //Verbandsgroßschadenslage
// neu ab 15.04.2011
  'Tankbrand'                      : {stwDef: 'F5+RW,GWÖl,TUIS|LF/HLFS,LF/HLFS', storm: false, wiki: 'Tankbrand'                     , ab: {FW: 64}},
  'Brennt Tanklager'               : {stwDef: 'F5G+DLK,GWÖl,FwK,TUIS|LF/HLFS,LF/HLFS,ULF', storm: false, wiki: 'Brennt_Tanklager'              , ab: {FW: 64}},
  'Brand in Raffinerie'            : {stwDef: 'F5G+DLK,FwK,TUIS|LF/HLFS,LF/HLFS,ULF', storm: false, wiki: 'Brand_in_Raffinerie' , ab: {FW: 64}},
// neu ab 12.05.2011
  'Unfall mit Gefahrgut-Transport' : {stwDef: 'THGG|TUIS'                   , storm: false, wiki: 'Unfall_mit_Gefahrgut-Transport', ab: {FW: 40, BF: 2}},
  'Gefahrstoff-Austritt in Firma'  : {stwDef: 'GSG+GWA,GWL|LF/HLFS,TUIS'    , storm: false, wiki: 'Gefahrstoff-Austritt_in_Firma' , ab: {FW: 40, BF: 2}},
// neu ab 26.06.2011
  'Brand in Betankungsanlage'      : {stwDef: 'F5G+GWA|ULF'                 , storm: false, wiki: 'Brand_in_Betankungsanlage'     , ab: {FW: 64}},
  'Küchenbrand'                    : {stwDef: 'F1'                          , storm: false, wiki: 'K%C3%BCchenbrand'              , ab: {FW:  2}},
  'Türöffnung'                     : {stwDef: 'TÖff'                        , storm: false, wiki: 'T%C3%BCr%C3%B6ffnung'          , ab: {FW:  2}},
  'Waldbrand'                      : {stwDef: 'F3L+GWL'                     , storm: false, wiki: 'Waldbrand'                     , ab: {FW: 20}},
  'VU mit Straßenbahn'             : {stwDef: 'TH3+GWS,FwK|LF/HLFS'         , storm: false, wiki: 'VU_mit_Strassenbahn'           , ab: {FW: 20}},
// neu ab 22.07.2011
  'Kleintier in Not'               : {stwDef: 'TH'                          , storm: false, wiki: 'Kleintier_in_Not'              , ab: {FW:  2}},
  'Brennendes Bus-Häuschen'        : {stwDef: 'F1'                          , storm: false, wiki: 'Brennendes Bus-H%C3%A4uschen'  , ab: {FW:  3}},
  'Person in Schacht'              : {stwDef: 'TH'                          , storm: false, wiki: 'Person_in_Schacht'             , ab: {FW:  3}},
  'Auslaufende Betriebsstoffe'     : {stwDef: 'TH+GWÖl'                     , storm: false, wiki: 'Auslaufende_Betriebsstoffe'    , ab: {FW:  4}},
// neu ab 24.12.2011
  'Brennender Güterzug'            : {stwDef: 'F1S+ELW,GWG,GWM,GWL,TUIS'    , storm: false, wiki: 'Brennender_G%C3%BCterzug'      , ab: {FW: 65}},
  'Feuer im Personenzug'           : {stwDef: 'F1S+ELW,GWL,TLF'             , storm: false, wiki: 'Feuer_im_Personenzug'          , ab: {FW: 65}},
  'Güterzug entgleist'             : {stwDef: 'THS+ELW,DLK,RW,GWS,GWG,GWM,TUIS', storm: false, wiki: 'G%C3%BCterzug_entgleist'   , ab: {FW: 65}},
  'Brand am Bahndamm'              : {stwDef: 'F2'                          , storm: false, wiki: 'Brand_am_Bahndamm'             , ab: {FW: 65}},
  'Baum auf Schiene'               : {stwDef: 'THS'                         , storm: true,  wiki: 'Baum_auf_Schiene'              , ab: {FW: 65}},
  'RTZ-Einsatz'                    : {stwDef: 'RTZ'                         , storm: false, wiki: 'RTZ-Einsatz'                   , ab: {FW: 65}},

// besondere Einsätze, nur zu bestimmten Jahreszeiten
  'Brand-Weihnachtsbaum in Kirche' : {stwDef: 'F3L'                         , storm: false, wiki: 'Brand-Weihnachtsbaum_in_Kirche', ab: {FW:  6}},
  'Brand auf Weihnachtsmarkt'      : {stwDef: 'F1'                          , storm: false, wiki: 'Brand_auf_Weihnachtsmarkt'     , ab: {FW:  3}},
};
...
*/
  ...
  'undef'    :  {txtDef: 'unbekanntes Einsatzstichwort',    vhcDef: 'LF/HLFS/TS'},
// zu undef = unbekannten Einsatzen wird per Default ein LF/HLFS/TS geschickt
  'F1'       :  {txtDef: 'Feuer, klein',                    vhcDef: 'LF/HLFS/TS/T16/TLF/FLF'},
  'F2'       :  {txtDef: 'Feuer, mittelklein',              vhcDef: 'LF/HLFS,LF/HLFS/TS/T16'},
  'F3'       :  {txtDef: 'Feuer, mittelgroß',               vhcDef: 'LF/HLFS,LF/HLFS,LF/HLFS/TS/T16,ELW'},
  'F4'       :  {txtDef: 'Feuer, groß',                     vhcDef: 'LF/HLFS,LF/HLFS,LF/HLFS,LF/HLFS/TS/T16,ELW'},
  'F5'       :  {txtDef: 'Großbrand',                       vhcDef: 'LF/HLFS,LF/HLFS,LF/HLFS,LF/HLFS,LF/HLFS/TS/T16,ELW'},
  'F2L'      :  {txtDef: 'Feuer, mittelklein, Leiter',      vhcDef: 'LF/HLFS,LF/HLFS/TS/T16,DLK'},
  'F3L'      :  {txtDef: 'Feuer, mittelgroß, Leiter',       vhcDef: 'LF/HLFS,LF/HLFS,LF/HLFS/TS/T16,ELW,DLK'},
  'F4L'      :  {txtDef: 'Feuer, groß, Leiter',             vhcDef: 'LF/HLFS,LF/HLFS,LF/HLFS,LF/HLFS/TS/T16,ELW,DLK'},
  'F5L'      :  {txtDef: 'Großbrand, Leiter',               vhcDef: 'LF/HLFS,LF/HLFS,LF/HLFS,LF/HLFS,LF/HLFS/TS/T16,ELW,DLK'},
  'F3G'      :  {txtDef: 'Feuer, mittelgroß, Gefahrgut',    vhcDef: 'LF/HLFS,LF/HLFS,LF/HLFS,LF/HLFS/TS/T16,ELW,RW,GWM,GWG'},
  'F4G'      :  {txtDef: 'Feuer, groß, Gefahrgut',          vhcDef: 'LF/HLFS,LF/HLFS,LF/HLFS,LF/HLFS/TS/T16,ELW,RW,TLF,GWL,GWM,GWG'},
  'F5G'      :  {txtDef: 'Großbrand, Gefahrgut',            vhcDef: 'LF/HLFS,LF/HLFS,LF/HLFS,LF/HLFS,LF/HLFS/TS/T16,ELW,RW,TLF,GWL,GWM,GWG,ULF'},
  'F1S'      :  {txtDef: 'Feuer, klein, Bahn',              vhcDef: 'LF/HLFS/TS/T16/HLFS'},
  'TÖff'     :  {txtDef: 'Türöffnung',                      vhcDef: 'LF/HLFS/TS/T16'},
  'TH'       :  {txtDef: 'einf. techn. Hilfeleistung',      vhcDef: 'LF/HLFS/TS/T16'},
  'TH1'      :  {txtDef: 'techn. Hilfeleistung',            vhcDef: 'RW,LF/HLFS/TS/T16'},
  'TH2'      :  {txtDef: 'erw. techn. Hilfeleistung',       vhcDef: 'RW,LF/HLFS,LF/HLFS/TS/T16'},
  'TH3'      :  {txtDef: 'große techn. Hilfeleistung',      vhcDef: 'ELW,RW,LF/HLFS,LF/HLFS,LF/HLFS/TS/T16'},
  'THW'      :  {txtDef: 'techn. Hilfel. - Wasserrettung',  vhcDef: 'LF/HLFS/TS/T16,GWT'},
  'THGG'     :  {txtDef: 'techn. Hilfel. - Gefahrgut',      vhcDef: 'LF/HLFS,LF/HLFS/TS/T16,RW,FwK,GWA,GWG,GWM,ELW'},
  'THS'      :  {txtDef: 'einf. techn. Hilfel., Bahn',      vhcDef: 'LF/HLFS/TS'},
  'RTZ'      :  {txtDef: 'Rettungszug',                     vhcDef: 'LF/HLFS,LF/HLFS,LF/HLFS,LF/HLFS'},
  'GSG'      :  {txtDef: 'Gefahrguteinsatz',                vhcDef: 'LF/HLFS,LF/HLFS,LF/HLFS/TS/T16,ELW,GWM,GWG'},
  'GSG2'     :  {txtDef: 'erw. Gefahrguteinsatz',           vhcDef: 'LF/HLFS,LF/HLFS,LF/HLFS,LF/HLFS/TS/T16,ELW,GWM,GWG,DLK,GWA'},
  'GfAus'    :  {txtDef: 'Gefahrstoffaustritt',             vhcDef: 'TUIS'},
  'VGSL'     :  {txtDef: 'Verbandsgroßschadenslage',        vhcDef: 'LF/HLFS,LF/HLFS,LF/HLFS,LF/HLFS,LF/HLFS,LF/HLFS,LF/HLFS,LF/HLFS/TS/T16'},
  'Crash'    :  {txtDef: 'brennt Flugzeug',                 vhcDef: 'FLF,FLF,FLF,FLF,FLF,FLF/LF/HLFS/TS/T16,RTr,ELW,GWG,GWM,RW,GWÖl'},
...
*/
  ...
  'TLF 16/25'          : {vehGrp: 'T16',  speed: 55, groupVeh: false, trainable: false, regex: /TLF 16\/25/,                    wiki: 'TLF_16/25'},
  ...
  'ULF mit Löscharm'   : {vehGrp: 'ULF',  speed: 40, groupVeh: false, trainable: false, regex: /ULF mit Löscharm|ULF/,              wiki: 'ULF_mit_L%C3%B6scharm'},
...
var NachforderungenArr = {
  ...
  'T16' : {text: 'Tanklöschfahrzeug 16/25', regex: /TLF 16\/25/                                 , ab: {FW:  7}},
  'TLF' : {text: 'Tanklöschfahrzeug 20/40', regex: /TLF 20\/40 - SL/                            , ab: {FW:  7}},
  ...
  'ULF' : {text: 'Universallöschfahrzeug',  regex: /ULF mit Löscharm|ULF/                       , ab: {FW: 64}},
  ...
  'FLB' : {text: 'Feuerlöschboot',          regex: /Feuerlöschboot/                             , ab: {BF: 30, ext: true}, onWater: true}, //ab 30 BF und 2 Stadtteil
  'RTB' : {text: 'Rettungsboot',            regex: /Rettungsboot/                               , ab: {BF: 50, ext: true}, onWater: true}, //ab 50 BF und 2 Stadtteil
  'HLFS': {text: 'Hilfel.löschfahrzeug-Schiene', regex: /HLF 24\/14-S/                          , ab: {FW:  1}},
  'LF'  : {text: 'Löschgruppenfahrzeug',    regex: /Kleinlöschfahrzeug|LF 8|LF 10\/6|LF 20\/16|HLF 10\/6|HLF 20\/16/ , ab: {FW:  1}},
  'HLF' : {text: 'Hilfeleistungslöschfahrzeug', regex: /HLF 10\/6|HLF 20\/16/                   , ab: {FW:  1}},
  'KLF' : {text: 'Kleinlöschfahrzeug',      regex: /Kleinlöschfahrzeug/                         , ab: {FW:  1}},
...
var settingsArr = {
  ...
  reducedSelectionVehicle    : {valDef: 'LF/HLFS/TS', group: 'global', type: 'STR', length: 10, valChkFunc: checkRedSelVhc, text: 'Fahrzeug(e) für Unwettermodus'},
...
var trainingArr = {
  ...
  '2-Wege-Führerschein': {regex: /2-Wege-Führerschein/, cboxid: 'education_type_8', tcol: {light:'darkgreen', black:'lightgreen'}, bcol: {light:'darkgreen', black:'lightgreen'}},
  'Rettungszug'       : {regex: /Rettungszug/,       cboxid: 'education_type_9', tcol: {light:'orange', black:'orange'}, bcol: {light:'orange', black:'orange'}},
}
...
function main()
{
  ...
  { msgArea = createElement('div',
                            {'style': 'color: white;',
                             'id'   : 'msgArea'});
    var nodeContainer = getByID('container');
    if (!nodeContainer)
    { window.setTimeout(main, 50);
      return;
    }
    nodeContainer.insertBefore(msgArea, getByID('navigation_top').nextSibling);
  }
  if (nodeUpdInfo && nodeUpdInfo != '')
  { msgArea.appendChild(nodeUpdInfo);
    AddKonfigEventlisteners();
  }
  if (!getByID('newScriptInfo'))
  { USERSCRIPTID="121568";
    UPDATEURL="http://userscripts.org/scripts/show/"+USERSCRIPTID;
    INSTALLURL="http://userscripts.org/scripts/source/"+USERSCRIPTID+".user.js";
    var nodeDiv = createElement('div',
                                {'style': 'color: white; font-weight: bold;',
                                 'id'   : 'newScriptInfo',
                                 'class': 'form_info'});
    nodeDiv.appendChild(createText('Es gibt nun ein neu entwickeltes Script: '));
    var nodeA = createElement('a',
                              {'href'  : UPDATEURL,
                               'target': '_blank'});
    nodeA.appendChild(createText("nextGen Ereglam's AAO"));
    nodeDiv.appendChild(nodeA);
    nodeDiv.appendChild(createElement('br'));

    nodeDiv.appendChild(createText('direkt '));
    ...
    nodeDiv.appendChild(createElement('br'));
    nodeDiv.appendChild(createElement('br'));
    var nodeSpan = createElement('span', {'style': 'color: red'});
    nodeSpan.appendChild(createText('HINWEIS'));
    nodeDiv.appendChild(nodeSpan);
    nodeDiv.appendChild(createElement('br'));
    nodeDiv.appendChild(createText('Dieses Script wird nicht mehr weiterentwickelt!'));
    nodeDiv.appendChild(createElement('br'));
    nodeDiv.appendChild(createText('Bitte dieses Script im Affenkopfmenü (Greasemonkey) deaktivieren!'));
    msgArea.appendChild(nodeDiv);
  }
...
function doTraining()
{ var nodeText = getXPath("./div[@class='form_info']/text()[contains(../text(), 'Auf dem Gelände')]", getByID('content'), XPType.FIRST_ORDERED).singleNodeValue;
  if(nodeText)
  { // Teilnehmer zählen
    var evalTRs = getXPath("./table[@class='defaultTable' and descendant::thead/tr/th/text()='Name']/tbody/tr", getByID('content'), XPType.SNAPSHOT_ORDERED);
    // Textknoten zum Eintragen der Anzahl finden
    var nodeH2 = getXPath("./h2[1]", getByID('content'), XPType.FIRST_ORDERED).singleNodeValue;
    if (nodeH2)
...
function bearbeiteEinsatzseite()
{
  ...
  { Einsatz.style.color = 'blue';
    Einsatz.style.fontWeight = 'bold';
  }
  if (settingsArr.highlightOrder.value && order == Einsatzstichwort)
