...
// @version        2.1.9 RUS
// @author         Panavia | Translation 777lexa777
// ==/UserScript==
      ...
      qx.Class.define("webfrontend.gui.PlayArea.FormationSaver", {
        ...
        members: {
          ...
          init: function() {          
            ...
            var labelTitle = new qx.ui.basic.Label("<b>Сейвер</b>");
            ...
            buttonSave = new qx.ui.form.Button("Сохранить");
            buttonSave.set({width: 70, appearance: "button-text-small", toolTipText: "Сохранить формацию", allowGrowX:false});
          ...
          update: function() {
            ...
            for(var id in formations[cityID][ownCityID]) {
              if(id != 0) {
                ...
                labelDelete.set({width: 10, allowGrowX:false, rich: true, toolTipText: "Удалить " + formation.n});
          ...
          save: function() {
            try {
              ...
              newFormation.n = "Тип " + formations[cityID][ownCityID][0];
