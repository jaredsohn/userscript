// ==UserScript==
// @name           Поруке наслов (ћирилица)
// @namespace      Наслов
// @description    Додаје наслов у ваше поруке
// @version        0.3
// @include        http://s*.ikariam.*/index.php*
// ==/UserScript==
//
// ---- урађено за икариам рс ----
...
function insertSubjectTextbox () {
   ...
   if (allyMessage[1]!=null) {
      ...
      + "<option value='Долазећи/Одлазећи Напад'>Одлазећи/Долазећи Напад</option>"
 ...
 //     + "<option value='War Announcement'>War Announcement</option>"
        ...
        + "<option value='Извештаји борбе'>Извештаји борбе</option>"
