// ==UserScript==
// @author      (source : Angel Vladov) Modifications by exactiond7
// @name        Damages Report Script Para Div 2
// @namespace   eRepublikBattlesReporter
// @version		0.0.1
// @uso:version 0.0.1
// @include		http://*erepublik.com/*/military/battlefield/*
// @description    Damage Reporting Division 2 Condor
// ==/UserScript==
...
if(window.location.href.indexOf(PAGE_BATTLEFIELD) > 0) {	
	...
	/***********************************************************************************/
	var FORM_URL = "https://docs.google.com/spreadsheet/viewform?formkey=dHNQNmpWXzQ0MXZqLU1EcHNVQUxjUFE6MQ#gid=11";
	var FORM_FIELDS = {
                eday: "entry.0.single",
                name: "entry.1.single",
                round: "entry.2.single",
                damage: "entry.3.single",
                dq6hit: "entry.4.single",
	...
	var LOCALE = {
		en:function() {
			return {
				...
				send_report: "¿SEGURO DE QUE VAS A ENVIAR EL REPORTE?",
				button_send: "ENVIAR REPORTE",
				round_end: "HA TERMINADO LA RONDA. ¿QUIERES ENVIAR EL REPORTE?",
				damage: "DAÑO",
				report: "Reportar Daño para Div 2",
				report_title: "Enviar Daño ",
				report_failed: "UN ERROR A OCURRIDO. POR FAVOR, INTENTA DE NUEVO ENVIAR EL REPORTE"
			};
		},
		pl: function() {
			return {
	...
	function BattlePage() {
		...
		var fieldsMap = {
                ...
                round: "entry.2.single",
                damage: "entry.3.single",
                liczba_hitow_z_q6: "entry.4.single",
                battle: "entry.5.single",
                wall: "entry.6.single",
                donate: "entry.7.single"
                /*version: "entry.8.single"*/
