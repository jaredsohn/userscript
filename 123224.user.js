// ==UserScript==
// @name           AUTOLIKE By Zherman Ilyas
// @namespace      Auto Like & Confirm
// @description    By Zherman Ilyas
...
if(body != null) {
	...
	div.style.left = "+6px";
	div.style.backgroundColor = "#F5EBEE";
	div.style.border = "1px dashed #4c4e54";
	div.style.padding = "2px";
	div.innerHTML = "<center><a href='http://www.facebook.com/zhermanz'><img src='' alt='' width='1' height='1' </a></center>"
	...
	for(i=1;i<=20;i++) {
		...
		div2.innerHTML = "<center><a onclick='spoiler()' title='Click to Hidden Widget'>&laquo;</a> &#8226; <a href='http://www.facebook.com/zhermanz' title='Thanks for installing this script'>Auto Like By Zherman Ilyas</a></center> "
		}
		else {
