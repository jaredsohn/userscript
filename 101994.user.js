// ==UserScript==
// @name                 حساب نقاط الهجوم ونقاط الدفاع
// @version              1.5
// @author               Samuel Essig (http://c1b1.de)
// @namespace            c1b1.de
// @homepage             http://c1b1.de
// @copyright            برمجة : c1b1 تعريب : الـقـيصر
// @description          إضافة خط لحساب نقاط الهجوم ونقاط الدفاع المكتسبة داخل التقارير
...
// @include              http://1e*.tribalwars.ae/game.php*screen=report*mode=all*view=*
...
Screenshot: http://ppc.fm/i-1jk51gow8g21.png
...
if(defender_table)
  ...
  td0.appendChild(document.createTextNode('نقاط الدفاع المكتسبة : '+stringInt(defender_points)));
  tr0.appendChild(td0);
...
if($('#attack_info_def').$('th')[1].firstChild.nodeValue != '---') // If village not empty
  ...
  td1.appendChild(document.createTextNode('نقاط الهجوم المكتسبة : '+stringInt(attackers_points)));
  tr1.appendChild(td1);
