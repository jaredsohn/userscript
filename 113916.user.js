...
// // Default: 5 - 180
var hornTimeDelayMin = 15;
var hornTimeDelayMax = 35;
...
function embedTimer(targetPage)
{
	if (showTimerInPage)
	{
		...
		if (headerElement)
		{
			...
			showPreferenceSpan = undefined;
			showPreferenceLinkDiv = undefined;
