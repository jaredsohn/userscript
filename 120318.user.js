// ==UserScript==
// @name           Gudariak Ordenes
// @namespace      www.erepublik.com
// @description    Ordenes para Gudariak (eRepublik)
// @version        0.2.0
// @include        http://www*.erepublik.com/en
// @include        http://www*.erepublik.com/es
// @include        http://www*.erepublik.com/es?unitPost=*
// @include        http://www*.erepublik.com/en?unitPost=*
// @include        http://www*.erepublik.com/es?viewPost=*
...
GM_xmlhttpRequest({
	method: 'GET',
	url: 'http://dl.dropbox.com/u/42924522/Script/default.xml',
	onload:function(response){
		...
		var earmy = $('#earmy');
		earmy.append('<div class="title"><h1 style="padding-bottom: 5px;"><embed class=\"sIFR-flash\" height=\"28\" width=\"250\" src=\"/flash/delicious.swf\" quality=\"best\" flashvars=\"txt=Gudariak&&textcolor=#737373&hovercolor=null&linkcolor=null&w=250&h=28\" wmode=\"opaque\" bgcolor=\"null\" sifr=\"true\" type=\"application/x-shockwave-flash\" style=\"width: 250px; height: 28px;\"/><span class=\"sIFR-alternate\"> </span></h1></div>');

		earmy.append('<ul  style="float: left;" class="tabs">'
				+'<li id="ordenes"><a class="on" href="#"><span style="width: 100px;">Comunicados</span></a></li>'
				+'<li id="foro"><a target="_BLANK" href="http://uner.all-up.com/forum"><span style="width: 100px;">Foro Gudariak</span></a></li>'
				+'<li id="irc" class="last"><a target="_BLANK" href="http://goo.gl/lDnMW"><span style="width: 100px;">IRC</span></a></li>'
				+'<li id="MU Gudariak"><a target="_BLANK" href="http://www.erepublik.com/es/main/group-show/387"><span style="width: 100px;">MU Gudariak</span></a></li>'
				+'<li id="Obra Militar" class="last"><a target="_BLANK" href="http://uner.all-up.com/f47-obra-militar"><span style="width: 100px;">Obra Militar</span></a></li>'
				+'<li id="UN" class="last"><a target="_BLANK" href="http://www.erepublik.com/es/party/unio-nacionalista-3432/1"><span style="width: 100px;">Unió Nacionalista</span></a></li>'
				+'</ul>');
		...
		$('a.confirm').click(function() {
			...
			if ($(this).hasClass('No Leido')) { //la sube
				var ocultas=GM_getValue('ocultas','({})');
				ocultas=eval(ocultas);
				delete ocultas[$(this).parent().attr('infid')];
				GM_setValue('ocultas',ocultas.toSource());

				$(this).html('Marcar como Leido').removeClass('No Leido').addClass('Leido');
				...
				$(this).html('Marcar como No Leido').removeClass('Leido').addClass('No Leido');
