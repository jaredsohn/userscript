...
(
    function(){
        ...
        if (document.getElementById("button_bar")) {
            ...
            addlInfo = document.evaluate("//a[contains(@id, 'photo_gne_button_add_to_faves')]", document, null, XPathResult.UNORDERED_NODE_SNAPSHOT_TYPE, null).snapshotItem(0).parentNode;
