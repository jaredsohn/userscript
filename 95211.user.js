...
var trad={main:'',barracks:'',academy:'',docks:'',market:'',place:'',temple:'',wall:'',sim:'',storage:'',lumber:'',stone:'',iron:'',hide:''};
var language=[];
...
eval('trad.hide=translation.'+lang+'.hide');
...
$(document).ready(function(){
	...
	//Extern Tools
		...
		$('#gt_gs').append('<span style="font-size:10px;text-decoration:underline;">Egyeb eszkozok</span>');
		$('#gt_gs').append('<div style="text-align:left;"><a href="http://www.grepostats.com/">Grepostats</a> (<a href="'+gt_gs_player+'" target="_blank">Jatekos</a>, <a href="'+gt_gs_ally+'" target="_blank">Szovetseg</a>)</div>');
	...
	//BBCodes
		...
		$('#message_bbcodes').append('<a title="en" href="#" id="gt_bb_player"><span style="float: left; background: url(&quot;/images-1/game/bbcodes.png&quot;) no-repeat scroll -88px 0px transparent; padding-left: 0px; padding-bottom: 0px; margin-right: 4px; width: 21px; height: 21px;"></span></a>');
		$('#message_bbcodes').append('<a title="Szovetsegem" href="#" id="gt_bb_ally"><span style="float: left; background: url(&quot;/images-1/game/bbcodes.png&quot;) no-repeat scroll -110px 0px transparent; padding-left: 0px; padding-bottom: 0px; margin-right: 4px; width: 21px; height: 21px;"></span></a>');
		$('#message_bbcodes').append('<a title="Varosom" href="#" id="gt_bb_town"><span style="float: left; background: url(&quot;/images-1/game/bbcodes.png&quot;) no-repeat scroll -132px 0px transparent; padding-left: 0px; padding-bottom: 0px; margin-right: 4px; width: 21px; height: 21px;"></span></a>');
		$('#message_bbcodes').append('<a class="button"  href="#" style="float:left;position:relative;top:-2px;" id="gt_bb_init"><span class="left"></span><span class="middle">Tiszta lap</span><span class="right"></span><span style="clear:both;"></span></a>');
	...
	//Navigation
		//General Stuff
			...
			$('#links ul').append('<li><a id="w_pref" style="font-size:10px;font-weight:bold;">Beallitasok</a><span style="color:#FFCC66;"> | </span><a id="w_help" style="font-size:10px;font-weight:bold;">Sugó</a></li>');
			$('#links ul').append('<li id="w_toggle"><a style="font-size:10px;font-weight:bold;">Elrejt/Mutat</a></li>');
	...
	//Widgets
		//Language Widget
			...
			$('#widget_lang').append('Nyelv: '+language[lang]);
		...
		//Buildings Widget
			...
			$('#widget_buildings').append('<div style="text-align:center;font-size:12px;margin-bottom:4px;">epuletek</div>');
			//Links
				...
				$('#widget_buildings').append('<a href="building_wall?town_id='+town+'">'+trad.wall+'</a> - <a href="building_place?town_id='+town+'">'+trad.place+'</a> - <a href="building_hide?town_id='+town+'">'+trad.hide+'</a><br />');
