// ==UserScript==
// @name          Plemiona BB-Codes Beta 1.0
...
// ==/UserScript==
      ...
      function CambiaForo() {
      	...
      	var xhtml = "<table class='bbcodearea'> " +
		    ...
		    '          |'+
      		    '	<a tabindex="13" href="javascript:insertBB(\'b\','+random+');"><img src="http://www.webtips.pl/public/style_images/webtips/rte_icons/bold.png" alt="Pogrubienie" title="Pogrubienie"/></a>' +
      		    ...
      		    '	<a tabindex="17" href="javascript:insertBB(\'url\','+random+');"><img src="http://tnij.org/a60l" alt="URL" title="URL"/></a>' +
                    '	<a tabindex="18" href="javascript:insertBB(\'img\','+random+');"><img src="http://images50.fotosik.pl/321/d2b62db7a20f6416.png" alt="Obraz" title="Obraz"/></a>' +
        ...
        "</p>    " +
        "<p>    " +
        ' <a href="javascript:insertBB(\'beczy\','+random+');"><img src="http://www.gadu-gadu.pl/images/emots/beczy.gif" alt="Beczy" title="Beczy"/></a> ' +
        ' <a href="javascript:insertBB(\'oczko\','+random+');"><img src="http://www.gadu-gadu.pl/images/emots/oczko.gif" alt="Oczko" title="Oczko"/></a> ' +
        ' <a href="javascript:insertBB(\'smutny\','+random+');"><img src="http://www.gadu-gadu.pl/images/emots/smutny2.gif" alt="Smutny" title="Smutny"/></a> ' +
        ' <a href="javascript:insertBB(\'rotfl\','+random+');"><img src="http://www.gadu-gadu.pl/images/emots/rotfl.gif" alt="Rotfl" title="Rotfl"/></a> ' +
        ' <a href="javascript:insertBB(\'fuck\','+random+');"><img src="http://www.gadu-gadu.pl/images/emots/spadaj.gif" alt="Fuck" title="Fuck"/></a> ' +
        ' <a href="javascript:insertBB(\'lol\','+random+');"><img src="http://tnij.org/a601" alt="LoL" title="LoL"/></a> ' +
        ' <a href="javascript:insertBB(\'niee\','+random+');"><img src="http://www.gadu-gadu.pl/images/emots/nie.gif" alt="Niee" title="Niee"/></a> ' +
      	...
      	NuevaFuncionTW("insertBB", function(insertType, ident){
      			...
      			switch (insertType) {
      				...
      				case 'img':
      					...
      					break;
                                case 'beczy':
					txtinsertBefore = "[img]http://www.gadu-gadu.pl/images/emots/beczy.gif[/img]";
					txtinsertAfter = " ";
					insertButton = 'V';
					break;
				case 'oczko':
					txtinsertBefore = "[img]http://www.gadu-gadu.pl/images/emots/oczko.gif[/img]";
					txtinsertAfter = " ";
					insertButton = 'V';
					break;
				case 'smutny':
					txtinsertBefore = "[img]http://www.gadu-gadu.pl/images/emots/smutny2.gif[/img]";
					txtinsertAfter = " ";
					insertButton = 'A';
					break;
				case 'rotfl':
					txtinsertBefore = "[img]http://www.gadu-gadu.pl/images/emots/rotfl.gif[/img]";
					txtinsertAfter = " ";
					insertButton = 'V';
					break;
				case 'fuck':
					txtinsertBefore = "[img]http://www.gadu-gadu.pl/images/emots/spadaj.gif[/img]";
					txtinsertAfter = " ";
					insertButton = 'V';
					break;
				case 'lol':
