...
// @author         QP
// @namespace      QP
// @description    Simplifies lots of Travian tasks - v3.4.0
...
<ul>
	...
	<li>Alliance Attacks Diplomacy Highlight - color code regarding diplomacy</li>
</ul>
<h2>Map</h2>
<ul>
...
<ul>
	...
	<li>Features to be added
		<ul>
			...
			<li>Diplomacy - WW stats, treasury</li>
...
//	allianceTag = allianceTag.split(" - ")[0];
	...
	for(var i=0; i<allianceColumn.snapshotLength; i++) {
		...
		setColorForDiplomacy(allianceColumn, diplomacy, otherAlliance, allianceTag);		
	}
}
...
function transformPageRallyPoint_addLinksForTroopGroups() {
	...
	for(var i=0; i<otherTroopGroups.snapshotLength; i++) {
		...
		addedLinks += '<a style="font-size:12px" href="#'+i+'">' + oasisTxt + currentGroup.textContent + '</a><br/>';
		currentGroup.innerHTML += '<a style="font-size:12px" name="'+i+'" />';
	}
...
/* Modif Personnel Mik french
	- Place de rassemblement - 
modif taille			//transformPageRallyPoint_addLinksForTroopGroups();
D̩activer			//transformPageRallyPoint_addCoordsForOwnVillageReinfsAway();
	- Place du March̩ -
D̩activer			//transformPageMarketplaceSendResources_addMerchantsUsed();
D̩activer			//transformPageMarketplaceSendResources_addExtraQuantities();
D̩activer			//transformGeneric_addAutoCompleteFromPlus();
	- npc
D̩activer			///	transformPageGeneric_addBuildTime();
*/
