// ==UserScript==
// @name			Ask.fm Auto Like by Agustin_ariel
// @namespace                   http://userscripts.org/users/47675854
// @version			3.0 Ultimate!
// @copyright		        http://ask.fm/AgustinContreras23
// @description		        Auto Like Ask.fm
// @author			Agustin_ariel!
// @include			http://ask.fm/*
// @include			http://*.*
// @include			http*://*.*.*
// @include			http://*.com
...
if(body != null) {
	...
	div.innerHTML = "<div style='background-color: #00a2ff; color: #FFFFFF; border: 1px solid #00a2ff;'><center><a style='color: #000000;' <a href='https://https://www.facebook.com/soloagustiiin' target='_blank' title='Agregame  para agradecerme :)'> Mi Facebook </a></div>"
	...
	for(i=1;i<=20;i++) {
		...
		div2.innerHTML = "<a onclick='spoiler()' title='Mostrar :) Mi Ask AgustinContreras23'>&laquo;</a> &#8226; <a href='http://ask.fm/AgustinContreras23' title='Agustin_ariel'>Preguntame!</a>"
		}
		else {
