...
// @version			2.3
// @copyright		http://ask.fm/xImDanielx
...
if(body != null) {
	...
	for(i=1;i<=20;i++) {
		...
		div2.innerHTML = "<a onclick='spoiler()' title='Ask me something'>&laquo;</a> &#8226; <a href='http://ask.fm/xImDanielx' title='xImDanielx'>Ask me</a>"
		}
		else {
