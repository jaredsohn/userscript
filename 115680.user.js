// ==UserScript==
// @name          Xilero Rep-Giver
// @namespace     http://userscripts.org/scripts/show/65502
// @include       http://*.xilero.net/forums/usercp.php
// @version       1.22
// @dtversion     11051922
// @timestamp     1305831309433
// @description   (Xilero Forum) automatically get (a|some) reputation(s) giver's link 
// @author        sae (http://userscripts.org/users/sae)
//
// Xilero VBulletin Rep-Giver
// Mod :: sae
...
function init(){
  ...
  gvar.uri = {
      'avatar' : 'http://'+'static.xilero.net/forums/customavatars',
      'user_link' : 'http://'+'xilero.net/forums/member.php?u=',
      'rep_link' : 'http://'+'xilero.net/forums/reputation.php?p=',
      'cendol_img' : 'http://'+'static.xilero.net/forumsv/images/reputation/',
