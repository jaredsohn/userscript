...
var SCRIPT = {
	name: 'STEEL v1.0',
	namespace: 'crohllf',
	source: 'http://userscripts.org/scripts/show/123361',
	identifier: 'http://userscripts.org/scripts/source/123361.user.js',
	meta: 'http://userscripts.org/scripts/source/123361.meta.js',
	version: '1.0',
	date: '2012-01-16',
};

var threadURL = 'http://goallineblitz.com/game/forum_thread.pl?thread_id=4836971';
var postId = '44689729';
// Debug location, top of page 2:
// var threadURL = 'http://goallineblitz.com/game/forum_thread.pl?thread_id=4836971&page=2';
// var postId = '44689729';
var forumAccessURL = 'http://goallineblitz.com/game/forum_private_access.pl?forum_id=11890';
...
var list = {
	...
	waitlist: {
		member: {},
		title: 'Former STEEL Members',
		style: 'color: LightGoldenrodYellow; background-color: black; padding: 0px 3px 0px 3px;',
		agentTitle: function(id, name) { return 'Former STEEL Member'; },
		forumAccess: 0,
	},
	hitlist: {
		member: {},
...
//						data.html(data.html().replace(n + '</a>', n + '</a> (real name: ' + realName.replace('(banned)', '<b><i>(banned)</i></b>') + ')'));
			...
			$.each(names, function(id, name) {
				if (!(id = parseInt(id))) return;
					...
					++nonMemberAddicts;
					$('#fam_list_family a[href$="/new_message.pl?to=' + id + '"]').after(') (<a href="/game/forum_private_access.pl?forum_id=11890&action=Invite&user_name=' + escape(name) + '"><b style="color: #008787;">invite</b></a>');
				} else if (list.apprentice.member[id]) {
					$('#fam_list_apprentice a[href$="/new_message.pl?to=' + id + '"]').after(') (<a href="/game/forum_private_access.pl?forum_id=11890&action=Invite&user_name=' + escape(name) + '"><b style="color: #008787;">invite</b></a>');
				} else if (list.waitlist.member[id]) {
					$('#fam_list_waitlist a[href$="/new_message.pl?to=' + id + '"]').after(') (<a href="/game/forum_private_access.pl?forum_id=11890&action=Invite&user_name=' + escape(name) + '"><b style="color: #008787;">invite</b></a>');
				} else if (list[idToList[id]].forumAccess == 1) {
					$('#post_content_' + postId + ' a[href$="/new_message.pl?to=' + id + '"]').after(') (<a href="/game/forum_private_access.pl?forum_id=11890&action=Invite&user_name=' + escape(name) + '"><b style="color: #008787;">invite</b></a>');
				}
			});
			var prefix = ' (';
			...
			statusMsg += ')';
			if (nonMemberAddicts) {
				statusMsg += ', ' + nonMemberAddicts + ' STEEL FACTION member has left the building';
			}
