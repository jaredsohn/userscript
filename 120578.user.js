...
function changes()
{
	var code=prompt("Youtube video id");
...
if (main) {
	...
	infobar.innerHTML=infobar.innerHTML + '<marquee scrollamount="2" behavior="alternate"><span style="color:green">Įjungta</span></marquee>';
...
buttonnode.addEventListener('click', off, false);
	...
	{
			infobar.innerHTML=infobar.innerHTML + '<marquee scrollamount="2" behavior="alternate"><span style="color:red">Išjungtas</span></marquee>';
			var buttonnode= document.createElement('div');
...
function playsound2()
{
    ...
    '<iframe width="448" height="55" name="sound" id="sound" frameborder="0" scrolling="no" src="http://www.youtube.com/v/'+sound+'&autoplay=1&loop=1"></iframe> ' +

    '</p></div>';
document.title = "*****Puola*****";
  ...
  if (xmlhttp.readyState==4 && xmlhttp.status==200)
	...
	adres=adress[l];
			if (adres && r!=null) 
			{
				...
				newElement.id="text";
				newElement.innerHTML="<div style='color:red;'><blink><b>Puolimas<b></blink></div>";
			...
			var newElement;
				newElement = document.createElement('div');
				newElement.id="text";
			//	newElement.innerHTML="<div style='color:green;'>...</div>";
    			adres.parentNode.insertBefore(newElement, adres.nextSibling);
			}
