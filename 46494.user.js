...
for (var i=0; i< 17;i++){
    if(i<16){
    BBCodes[12+i] = new BBCode(DSBuildingsNamesDEArray[i],"/graphic/buildings/"+DSBuildingsNamesArray[i]+".png",DSBuildingsNamesDEArray[i],'[img]http://www.die-staemme.de/graphic/buildings/'+DSBuildingsNamesArray[i]+'.png[/img]'+DSBuildingsNamesDEArray[i]+' ','');
    }else{
    BBCodes[12+i] = new BBCode(DSBuildingsNamesDEArray[i],"/graphic/"+DSBuildingsNamesArray[i]+".png",DSBuildingsNamesDEArray[i],'[img]http://www.die-staemme.de/graphic/'+DSBuildingsNamesArray[i]+'.png[/img]'+DSBuildingsNamesDEArray[i]+' ','');
    }
...
butt.innerHTML += '</div><div>';
for (var i=0; i< 12;i++){
    BBCodes[29+i] = new BBCode(DSUnitsNamesArray[i],"/graphic/unit/unit_"+DSUnitsNamesArray[i]+".png",DSUnitsNamesDEArray[i],'[img]http://www.die-staemme.de/graphic/unit/unit_'+DSUnitsNamesArray[i]+'.png[/img][b] ',' [/b]'+DSUnitsNamesDEArray[i]);
...
for (var i=0; i< 4;i++){
    BBCodes[41+i] = new BBCode(DSResNamesArray[i],"/graphic/"+DSResNamesArray[i]+".png",DSResNamesArray[4+i],'[img]http://www.die-staemme.de/graphic/'+DSResNamesArray[i]+'.png[/img][b] ',' [/b]'+DSResNamesArray[4+i]);
